...
MR_def_label(ssdb__execute_ssdb_format_param_3_0,4)
	...
	MR_sv(1) = ((MR_Integer) MR_tfield(0, MR_tempr2, 0) & (MR_Integer) 1);
	MR_sv(2) = (((MR_Integer) MR_tfield(0, MR_tempr2, 0) >> (MR_Integer) 1) & (MR_Integer) 1);
	MR_sv(3) = (((MR_Integer) MR_tfield(0, MR_tempr2, 0) >> (MR_Integer) 2) & (MR_Integer) 1);
	MR_sv(4) = (((MR_Integer) MR_tfield(0, MR_tempr2, 0) >> (MR_Integer) 3) & (MR_Integer) 1);
	MR_sv(5) = (((MR_Integer) MR_tfield(0, MR_tempr2, 0) >> (MR_Integer) 4) & (MR_Integer) 1);
	MR_sv(6) = (((MR_Integer) MR_tfield(0, MR_tempr2, 0) >> (MR_Integer) 5) & (MR_Integer) 1);
	MR_sv(7) = (((MR_Integer) MR_tfield(0, MR_tempr2, 0) >> (MR_Integer) 6) & (MR_Integer) 1);
