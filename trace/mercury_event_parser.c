...
#line 107 "mercury_event_parser.c"
...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_TOKEN_EVENT = 3,                /* TOKEN_EVENT  */
  YYSYMBOL_TOKEN_SET = 4,                  /* TOKEN_SET  */
  YYSYMBOL_TOKEN_IMPURE = 5,               /* TOKEN_IMPURE  */
  YYSYMBOL_TOKEN_FUNCTION = 6,             /* TOKEN_FUNCTION  */
  YYSYMBOL_TOKEN_SYNTHESIZED = 7,          /* TOKEN_SYNTHESIZED  */
  YYSYMBOL_TOKEN_BY = 8,                   /* TOKEN_BY  */
  YYSYMBOL_TOKEN_LPAREN = 9,               /* TOKEN_LPAREN  */
  YYSYMBOL_TOKEN_RPAREN = 10,              /* TOKEN_RPAREN  */
  YYSYMBOL_TOKEN_COLON = 11,               /* TOKEN_COLON  */
  YYSYMBOL_TOKEN_COMMA = 12,               /* TOKEN_COMMA  */
  YYSYMBOL_TOKEN_ID = 13,                  /* TOKEN_ID  */
  YYSYMBOL_TOKEN_SYM = 14,                 /* TOKEN_SYM  */
  YYSYMBOL_GARBAGE = 15,                   /* GARBAGE  */
  YYSYMBOL_YYACCEPT = 16,                  /* $accept  */
  YYSYMBOL_file = 17,                      /* file  */
  YYSYMBOL_events = 18,                    /* events  */
  YYSYMBOL_event = 19,                     /* event  */
  YYSYMBOL_maybe_attrs = 20,               /* maybe_attrs  */
  YYSYMBOL_attrs = 21,                     /* attrs  */
  YYSYMBOL_attr = 22,                      /* attr  */
  YYSYMBOL_type = 23,                      /* type  */
  YYSYMBOL_term = 24,                      /* term  */
  YYSYMBOL_terms = 25,                     /* terms  */
  YYSYMBOL_flat_term = 26,                 /* flat_term  */
  YYSYMBOL_ids = 27,                       /* ids  */
  YYSYMBOL_sym = 28                        /* sym  */
};
...
{
       0,    82,    82,    94,   101,   106,   117,   120,   123,   129,
     137,   146,   153,   160,   167,   176,   182,   190,   196,   204,
     210,   218,   224,   232,   236
};
#endif
...
{
  "\"end of file\"", "error", "\"invalid token\"", "TOKEN_EVENT",
  "TOKEN_SET", "TOKEN_IMPURE", "TOKEN_FUNCTION", "TOKEN_SYNTHESIZED",
  "TOKEN_BY", "TOKEN_LPAREN", "TOKEN_RPAREN", "TOKEN_COLON", "TOKEN_COMMA",
  "TOKEN_ID", "TOKEN_SYM", "GARBAGE", "$accept", "file", "events", "event",
  "maybe_attrs", "attrs", "attr", "type", "term", "terms", "flat_term",
  "ids", "sym", YY_NULLPTR
};
...
{
       1,     2,     5,    -6,   -18,     7,    -2,   -18,     7,     3,
     -18,     0,     4,     6,   -18,     8,    -5,   -18,     0,    11,
     -18,   -18,   -18,   -18,    12,     9,   -18,   -18,    13,   -11,
      10,    14,    15,    18,   -18,   -11,   -18,    16,   -18,    19,
      20,    16,   -18,   -18
};
...
static const yytype_int8 yydefact[] =
{
       0,     0,     0,     0,     1,     4,     0,     2,     4,     0,
       3,     7,     0,     0,     6,     9,     0,     5,     0,     0,
      12,    23,    24,    10,    11,    15,     8,    13,     0,     0,
       0,    18,     0,    19,    14,     0,    16,     0,    17,    22,
       0,     0,    20,    21
};
...
{
      19,    20,    21,    22,     1,     4,     3,     5,    21,    22,
       6,     9,    11,    12,    26,    16,    17,    27,    29,    28,
      18,    30,    38,    33,    43,    36,    35,    37,     0,    39,
      42,    41,    10,    24
};

static const yytype_int8 yycheck[] =
{
       5,     6,    13,    14,     3,     0,     4,    13,    13,    14,
       3,    13,     9,    13,    18,    11,    10,     6,     9,     7,
      12,     8,    35,    13,    41,    10,    12,     9,    -1,    13,
      10,    12,     8,    16
};
...
{
       0,     3,    17,     4,     0,    13,     3,    18,    19,    13,
      18,     9,    13,    20,    21,    22,    11,    10,    12,     5,
       6,    13,    14,    23,    24,    28,    21,     6,     7,     9,
       8,    24,    25,    13,    26,    12,    10,     9,    25,    13,
      27,    12,    10,    27
};
...
yyreduce:
  ...
  switch (yyn)
    {
  case 2: /* file: TOKEN_EVENT TOKEN_SET TOKEN_ID events  */
#line 83 "mercury_event_parser.y"
                {
...
#line 1144 "mercury_event_parser.c"
    break;

  case 3: /* events: event events  */
#line 95 "mercury_event_parser.y"
                {
...
#line 1154 "mercury_event_parser.c"
    break;

  case 4: /* events: %empty  */
#line 101 "mercury_event_parser.y"
                {
                    (yyval.Uevents) = NULL;
                }
#line 1162 "mercury_event_parser.c"
    break;

  case 5: /* event: TOKEN_EVENT TOKEN_ID TOKEN_LPAREN maybe_attrs TOKEN_RPAREN  */
#line 107 "mercury_event_parser.y"
                {
...
#line 1175 "mercury_event_parser.c"
    break;

  case 6: /* maybe_attrs: attrs  */
#line 118 "mercury_event_parser.y"
                { (yyval.Uattrs) = (yyvsp[0].Uattrs); }
#line 1181 "mercury_event_parser.c"
    break;

  case 7: /* maybe_attrs: %empty  */
#line 120 "mercury_event_parser.y"
                { (yyval.Uattrs) = NULL; }
#line 1187 "mercury_event_parser.c"
    break;

  case 8: /* attrs: attr TOKEN_COMMA attrs  */
#line 124 "mercury_event_parser.y"
                {
...
#line 1197 "mercury_event_parser.c"
    break;

  case 9: /* attrs: attr  */
#line 130 "mercury_event_parser.y"
                {
                    (yyval.Uattrs) = MR_NEW(struct MR_EventAttrs_Struct);
                    (yyval.Uattrs)->MR_attrs_head = (yyvsp[0].Uattr);
                    (yyval.Uattrs)->MR_attrs_tail = NULL;
                }
#line 1207 "mercury_event_parser.c"
    break;

  case 10: /* attr: TOKEN_ID TOKEN_COLON type  */
#line 138 "mercury_event_parser.y"
                {
...
#line 1218 "mercury_event_parser.c"
    break;

  case 11: /* type: term  */
#line 147 "mercury_event_parser.y"
                {
...
#line 1229 "mercury_event_parser.c"
    break;

  case 12: /* type: TOKEN_FUNCTION  */
#line 154 "mercury_event_parser.y"
                {
                    (yyval.Utype) = MR_NEW(struct MR_EventAttrType_Struct);
                    (yyval.Utype)->MR_type_kind = MR_EVENT_ATTR_PURE_FUNCTION;
                    (yyval.Utype)->MR_type_term = NULL;
                    (yyval.Utype)->MR_type_synth_call = NULL;
                }
#line 1240 "mercury_event_parser.c"
    break;

  case 13: /* type: TOKEN_IMPURE TOKEN_FUNCTION  */
#line 161 "mercury_event_parser.y"
                {
                    (yyval.Utype) = MR_NEW(struct MR_EventAttrType_Struct);
                    (yyval.Utype)->MR_type_kind = MR_EVENT_ATTR_IMPURE_FUNCTION;
                    (yyval.Utype)->MR_type_term = NULL;
                    (yyval.Utype)->MR_type_synth_call = NULL;
                }
#line 1251 "mercury_event_parser.c"
    break;

  case 14: /* type: term TOKEN_SYNTHESIZED TOKEN_BY flat_term  */
#line 168 "mercury_event_parser.y"
                {
                    (yyval.Utype) = MR_NEW(struct MR_EventAttrType_Struct);
...
#line 1262 "mercury_event_parser.c"
    break;

  case 15: /* term: sym  */
#line 177 "mercury_event_parser.y"
                {
                    (yyval.Uterm) = MR_NEW(struct MR_CTerm_Struct);
                    (yyval.Uterm)->MR_term_functor = (yyvsp[0].Uid);
                    (yyval.Uterm)->MR_term_args = NULL;
                }
#line 1272 "mercury_event_parser.c"
    break;

  case 16: /* term: sym TOKEN_LPAREN terms TOKEN_RPAREN  */
#line 183 "mercury_event_parser.y"
                {
                    (yyval.Uterm) = MR_NEW(struct MR_CTerm_Struct);
                    (yyval.Uterm)->MR_term_functor = (yyvsp[-3].Uid);
                    (yyval.Uterm)->MR_term_args = (yyvsp[-1].Uargs);
                }
#line 1282 "mercury_event_parser.c"
    break;

  case 17: /* terms: term TOKEN_COMMA terms  */
#line 191 "mercury_event_parser.y"
                {
                    (yyval.Uargs) = MR_NEW(struct MR_CArgs_Struct);
                    (yyval.Uargs)->MR_args_head = (yyvsp[-2].Uterm);
                    (yyval.Uargs)->MR_args_tail = (yyvsp[0].Uargs);
                }
#line 1292 "mercury_event_parser.c"
    break;

  case 18: /* terms: term  */
#line 197 "mercury_event_parser.y"
                {
                    (yyval.Uargs) = MR_NEW(struct MR_CArgs_Struct);
                    (yyval.Uargs)->MR_args_head = (yyvsp[0].Uterm);
                    (yyval.Uargs)->MR_args_tail = NULL;
                }
#line 1302 "mercury_event_parser.c"
    break;

  case 19: /* flat_term: TOKEN_ID  */
#line 205 "mercury_event_parser.y"
                {
...
#line 1312 "mercury_event_parser.c"
    break;

  case 20: /* flat_term: TOKEN_ID TOKEN_LPAREN ids TOKEN_RPAREN  */
#line 211 "mercury_event_parser.y"
                {
                    (yyval.Uflatterm) = MR_NEW(struct MR_FlatTerm_Struct);
                    (yyval.Uflatterm)->MR_flat_term_functor = (yyvsp[-3].Uid);
                    (yyval.Uflatterm)->MR_flat_term_args = (yyvsp[-1].Uflatargs);
                }
#line 1322 "mercury_event_parser.c"
    break;

  case 21: /* ids: TOKEN_ID TOKEN_COMMA ids  */
#line 219 "mercury_event_parser.y"
                {
...
#line 1332 "mercury_event_parser.c"
    break;

  case 22: /* ids: TOKEN_ID  */
#line 225 "mercury_event_parser.y"
                {
                    (yyval.Uflatargs) = MR_NEW(struct MR_FlatArgs_Struct);
                    (yyval.Uflatargs)->MR_flat_args_head = (yyvsp[0].Uid);
                    (yyval.Uflatargs)->MR_flat_args_tail = NULL;
                }
#line 1342 "mercury_event_parser.c"
    break;

  case 23: /* sym: TOKEN_ID  */
#line 233 "mercury_event_parser.y"
                {
                    (yyval.Uid) = (yyvsp[0].Uid);
                }
#line 1350 "mercury_event_parser.c"
    break;

  case 24: /* sym: TOKEN_SYM  */
#line 237 "mercury_event_parser.y"
                {
                    (yyval.Uid) = (yyvsp[0].Uid);
                }
#line 1358 "mercury_event_parser.c"
    break;


#line 1362 "mercury_event_parser.c"
...
#line 242 "mercury_event_parser.y"
