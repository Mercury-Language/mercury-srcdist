...
# 
# Copyright (C) 1999, 2001, 2002, 2010 The University of Melbourne
#
...
Provides:     mercury 
Requires:     gcc make
Source:       ftp.mercury.cs.mu.oz.au:/pub/mercury/mercury-compiler-10.04.2.tar.gz
...
%prep
%setup -n mercury-compiler-10.04.2
