...
Provides:     mercury 
Requires:     gcc make
Source:       ftp.mercury.cs.mu.oz.au:/pub/mercury/beta-releases/rotd/mercury-compiler-rotd-2011-08-03.tar.gz
...
%prep
%setup -n mercury-compiler-rotd-2011-08-03
