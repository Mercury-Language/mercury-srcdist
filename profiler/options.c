...
MR_decl_label7(options__options_help_2_0, 42,43,44,45,46,47,48)
...
MR_def_label(options__long_option_2_0,14)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if ((strcmp((char *) (MR_Word *) MR_r1, MR_string_const("snapshots-brief", 15)) != 0)) {
...
MR_def_label(options__long_option_2_0,17)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if ((strcmp((char *) (MR_Word *) MR_r1, MR_string_const("snapshots-by-type", 17)) != 0)) {
...
MR_def_label(options__special_handler_4_0,3)
	...
	MR_tempr1 = MR_r3;
	MR_r3 = (MR_Integer) 9;
	MR_r4 = (MR_Word) MR_TAG_COMMON(3,1,5);
	MR_r5 = MR_tempr1;
	}
	MR_np_call_localret_ent(map__set_4_0,
		options__special_handler_4_0_i25);
...
MR_BEGIN_MODULE(options_module4)
	...
	MR_init_label7(options__options_help_2_0,42,43,44,45,46,47,48)
MR_BEGIN_CODE
...
MR_def_label(options__options_help_2_0,35)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_string_const("\t--snapshots-file <file>\n", 25);
	MR_np_call_localret_ent(io__write_string_3_0,
...
MR_def_label(options__options_help_2_0,37)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_string_const("\t-T, --snapshots-by-type\n", 25);
	MR_np_call_localret_ent(io__write_string_3_0,
		options__options_help_2_0_i38);
MR_def_label(options__options_help_2_0,38)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_string_const("\t\tGroup results by type.\n", 25);
	MR_np_call_localret_ent(io__write_string_3_0,
		options__options_help_2_0_i39);
MR_def_label(options__options_help_2_0,39)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_string_const("\t-b, --snapshots-brief\n", 23);
	MR_np_call_localret_ent(io__write_string_3_0,
...
MR_def_label(options__options_help_2_0,41)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_string_const("\t-r, --snapshots-include-runtime\n", 33);
	MR_np_call_localret_ent(io__write_string_3_0,
