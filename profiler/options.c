    ...
    case (MR_Integer) 4:
      {
        ...
        if (succeeded)
        {
          WhatToProfile_5 = ((MR_String) ((MR_hl_field(3, HeadVar__2_2, 1))));
          ...
          {
            MR_Word Var_11;
            MR_Word STATE_VARIABLE_OptionTable_1_12;
            ...
            mercury__map__set_4_p_0((MR_Word) (&options__options__type_ctor_info_option_0), (MR_Word) (&mercury__getopt__getopt__type_ctor_info_option_data_0), ((MR_Box) ((MR_Integer) 9)), ((MR_Box) (Var_11)), STATE_VARIABLE_OptionTable_0_3, &STATE_VARIABLE_OptionTable_1_12);
            {
              MR_Word base;
              base = (MR_Word) MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL);
              *HeadVar__4_4 = base;
              MR_hl_field(0, base, 0) = ((MR_Box) (STATE_VARIABLE_OptionTable_1_12));
            }
          }
          else
