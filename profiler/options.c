...
{
  {
    ...
    if ((((MR_Unsigned) ((MR_Integer) ((MR_Unsigned) HeadVar__1_1 - (MR_Unsigned) 67))) <= ((MR_Unsigned) 51)))
      if ((((options_scalar_common_3[0])[(((MR_Integer) ((MR_Unsigned) HeadVar__1_1 - (MR_Unsigned) 67)) >> 5)]) & (((MR_Integer) 1 << ((((MR_Integer) ((MR_Unsigned) HeadVar__1_1 - (MR_Unsigned) 67)) & (MR_Integer) 31))))))
      {
        *HeadVar__2_2 = ((&options_vector_common_2[0 + (MR_Integer) ((MR_Unsigned) HeadVar__1_1 - (MR_Unsigned) 67)]))->options__vector_common_type_2_0__vct_2_f_0;
        succeeded = MR_TRUE;
      }
      else
        succeeded = MR_FALSE;
