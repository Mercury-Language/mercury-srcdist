      ...
      case (MR_Integer) 7:
        {
          ...
          mercury__map__set_4_p_0((MR_Word) (&options__options__type_ctor_info_option_0), (MR_Word) (&mercury__getopt__getopt__type_ctor_info_option_data_0), ((MR_Box) ((MR_Integer) 9)), ((MR_Box) (MR_mkword(MR_mktag(3), &options_scalar_common_5[5]))), STATE_VARIABLE_OptionTable_0_3, &STATE_VARIABLE_OptionTable_25);
          {
            MR_Word base;
            base = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL);
            *HeadVar__4_4 = base;
      ...
      case (MR_Integer) 6:
        {
          ...
          mercury__map__set_4_p_0((MR_Word) (&options__options__type_ctor_info_option_0), (MR_Word) (&mercury__getopt__getopt__type_ctor_info_option_data_0), ((MR_Box) ((MR_Integer) 9)), ((MR_Box) (MR_mkword(MR_mktag(3), &options_scalar_common_5[6]))), STATE_VARIABLE_OptionTable_0_3, &STATE_VARIABLE_OptionTable_17);
          {
            MR_Word base;
            base = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL);
            *HeadVar__4_4 = base;
      ...
      case (MR_Integer) 5:
        {
          ...
          mercury__map__set_4_p_0((MR_Word) (&options__options__type_ctor_info_option_0), (MR_Word) (&mercury__getopt__getopt__type_ctor_info_option_data_0), ((MR_Box) ((MR_Integer) 9)), ((MR_Box) (MR_mkword(MR_mktag(3), &options_scalar_common_5[0]))), STATE_VARIABLE_OptionTable_0_3, &STATE_VARIABLE_OptionTable_33);
          {
            MR_Word base;
            base = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL);
            *HeadVar__4_4 = base;
...
{
  {
    ...
    if ((((MR_Unsigned) (MR_Integer) ((MR_Unsigned) HeadVar__1_1 - (MR_Unsigned) (MR_Integer) 67)) <= ((MR_Unsigned) (MR_Integer) 51)))
      if ((((options_scalar_common_3[0])[(((MR_Integer) ((MR_Unsigned) HeadVar__1_1 - (MR_Unsigned) (MR_Integer) 67)) >> (MR_Integer) 5)]) & (((MR_Integer) 1 << ((((MR_Integer) ((MR_Unsigned) HeadVar__1_1 - (MR_Unsigned) (MR_Integer) 67)) & (MR_Integer) 31))))))
      {
        *HeadVar__2_2 = ((&options_vector_common_2[0 + (MR_Integer) ((MR_Unsigned) HeadVar__1_1 - (MR_Unsigned) (MR_Integer) 67)]))->options__vector_common_type_2_0__vct_2_f_0;
        succeeded = MR_TRUE;
      }
      else
        succeeded = MR_FALSE;
