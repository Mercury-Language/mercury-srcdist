...
static /* final */ const MR_Box options_scalar_common_3[59][2] = {
  ...
  /* row 8 */
  {
    ...
    ((MR_Box) (MR_mkword(MR_mktag(1), &options_scalar_common_3[7])))
  },
  /* row 9 */
  {
    ((MR_Box) ((MR_String) "\t\tOutput progress messages at each stage.\n")),
    ((MR_Box) (MR_mkword(MR_mktag(1), &options_scalar_common_3[8])))
  },
  /* row 10 */
  {
    ((MR_Box) ((MR_String) "\t-v, --verbose\n")),
    ((MR_Box) (MR_mkword(MR_mktag(1), &options_scalar_common_3[9])))
  },
  /* row 11 */
  {
    ((MR_Box) ((MR_String) "Verbosity Options:\n")),
    ((MR_Box) (MR_mkword(MR_mktag(1), &options_scalar_common_3[10])))
  },
  /* row 12 */
  {
    ((MR_Box) ((MR_String) "\n")),
    ((MR_Box) (MR_mkword(MR_mktag(1), &options_scalar_common_3[11])))
  },
  /* row 13 */
  {
    ((MR_Box) ((MR_String) "\t\tprofile. These are excluded by default.\n")),
    ((MR_Box) (MR_mkword(MR_mktag(1), &options_scalar_common_3[12])))
  },
  /* row 14 */
  {
    ((MR_Box) ((MR_String) "\t\tInclude internal Mercury runtime structures in the\n")),
    ((MR_Box) (MR_mkword(MR_mktag(1), &options_scalar_common_3[13])))
  },
  /* row 15 */
  {
    ((MR_Box) ((MR_String) "\t-r, --snapshots-include-runtime\n")),
    ((MR_Box) (MR_mkword(MR_mktag(1), &options_scalar_common_3[14])))
  },
  /* row 16 */
  {
    ((MR_Box) ((MR_String) "\t\tGenerate a brief profile.\n")),
    ((MR_Box) (MR_mkword(MR_mktag(1), &options_scalar_common_3[15])))
  },
  /* row 17 */
  {
    ((MR_Box) ((MR_String) "\t-b, --snapshots-brief\n")),
    ((MR_Box) (MR_mkword(MR_mktag(1), &options_scalar_common_3[16])))
  },
  /* row 18 */
  {
    ((MR_Box) ((MR_String) "\t\tGroup results by type.\n")),
    ((MR_Box) (MR_mkword(MR_mktag(1), &options_scalar_common_3[17])))
  },
  /* row 19 */
  {
    ((MR_Box) ((MR_String) "\t-T, --snapshots-by-type\n")),
    ((MR_Box) (MR_mkword(MR_mktag(1), &options_scalar_common_3[18])))
  },
  /* row 20 */
  {
    ((MR_Box) ((MR_String) "\t\tName of the snapshots file. Usually \140Prof.Snapshots\'.\n")),
    ((MR_Box) (MR_mkword(MR_mktag(1), &options_scalar_common_3[19])))
  },
  /* row 21 */
  {
    ((MR_Box) ((MR_String) "\t--snapshots-file <file>\n")),
    ((MR_Box) (MR_mkword(MR_mktag(1), &options_scalar_common_3[20])))
  },
  /* row 22 */
  {
    ((MR_Box) ((MR_String) "\t\tThis overrides other profiler modes.\n")),
    ((MR_Box) (MR_mkword(MR_mktag(1), &options_scalar_common_3[21])))
  },
  /* row 23 */
  {
    ((MR_Box) ((MR_String) "\t\t\140benchmarking.report_memory_attribution\' was called.\n")),
    ((MR_Box) (MR_mkword(MR_mktag(1), &options_scalar_common_3[22])))
  },
  /* row 24 */
  {
    ((MR_Box) ((MR_String) "\t\tShow summary of heap objects at the times\n")),
    ((MR_Box) (MR_mkword(MR_mktag(1), &options_scalar_common_3[23])))
  },
  /* row 25 */
  {
    ((MR_Box) ((MR_String) "\t-s, --snapshots\n")),
    ((MR_Box) (MR_mkword(MR_mktag(1), &options_scalar_common_3[24])))
  },
  /* row 26 */
  {
    ((MR_Box) ((MR_String) "Snapshot options:\n")),
    ((MR_Box) (MR_mkword(MR_mktag(1), &options_scalar_common_3[25])))
  },
  /* row 27 */
  {
    ((MR_Box) ((MR_String) "\n")),
    ((MR_Box) (MR_mkword(MR_mktag(1), &options_scalar_common_3[26])))
  },
  /* row 28 */
  {
    ((MR_Box) ((MR_String) "\t\tthe library modules.\n")),
    ((MR_Box) (MR_mkword(MR_mktag(1), &options_scalar_common_3[27])))
  },
  /* row 29 */
  {
    ((MR_Box) ((MR_String) "\t\tName of the file which contains the call graph for\n")),
    ((MR_Box) (MR_mkword(MR_mktag(1), &options_scalar_common_3[28])))
  },
  /* row 30 */
  {
    ((MR_Box) ((MR_String) "\t-L <file>, --library-callgraph <file>\n")),
    ((MR_Box) (MR_mkword(MR_mktag(1), &options_scalar_common_3[29])))
  },
  /* row 31 */
  {
    ((MR_Box) ((MR_String) "\t\tName of the call-pair file. Usually \140Prof.CallPair\'.\n")),
    ((MR_Box) (MR_mkword(MR_mktag(1), &options_scalar_common_3[30])))
  },
  /* row 32 */
  {
    ((MR_Box) ((MR_String) "\t-P <file>, --call-pair-file <file>\n")),
    ((MR_Box) (MR_mkword(MR_mktag(1), &options_scalar_common_3[31])))
  },
  /* row 33 */
  {
    ((MR_Box) ((MR_String) "\t\tName of the declaration file. Usually \140Prof.Decl\'.\n")),
    ((MR_Box) (MR_mkword(MR_mktag(1), &options_scalar_common_3[32])))
  },
  /* row 34 */
  {
    ((MR_Box) ((MR_String) "\t-D <file>, --declaration-file <file>\n")),
    ((MR_Box) (MR_mkword(MR_mktag(1), &options_scalar_common_3[33])))
  },
  /* row 35 */
  {
    ((MR_Box) ((MR_String) "\t\t\140Prof.MemoryWords\', or \140Prof.MemoryCells\'.\n")),
    ((MR_Box) (MR_mkword(MR_mktag(1), &options_scalar_common_3[34])))
  },
  /* row 36 */
  {
    ((MR_Box) ((MR_String) "\t\tName of the count file. Usually \140Prof.Counts\',\n")),
    ((MR_Box) (MR_mkword(MR_mktag(1), &options_scalar_common_3[35])))
  },
  /* row 37 */
  {
    ((MR_Box) ((MR_String) "\t-C <file>, --count-file <file>\n")),
    ((MR_Box) (MR_mkword(MR_mktag(1), &options_scalar_common_3[36])))
  },
  /* row 38 */
  {
    ((MR_Box) ((MR_String) "Filename Options:\n")),
    ((MR_Box) (MR_mkword(MR_mktag(1), &options_scalar_common_3[37])))
  },
  /* row 39 */
  {
    ((MR_Box) ((MR_String) "\n")),
    ((MR_Box) (MR_mkword(MR_mktag(1), &options_scalar_common_3[38])))
  },
  /* row 40 */
  {
    ((MR_Box) ((MR_String) "\t\tOutput the mangled predicate and function names.\n")),
    ((MR_Box) (MR_mkword(MR_mktag(1), &options_scalar_common_3[39])))
  },
  /* row 41 */
  {
    ((MR_Box) ((MR_String) "\t--no-demangle\n")),
    ((MR_Box) (MR_mkword(MR_mktag(1), &options_scalar_common_3[40])))
  },
  /* row 42 */
  {
    ((MR_Box) ((MR_String) "\t\tSame as \140--profile time\'.\n")),
    ((MR_Box) (MR_mkword(MR_mktag(1), &options_scalar_common_3[41])))
  },
  /* row 43 */
  {
    ((MR_Box) ((MR_String) "\t-t\n")),
    ((MR_Box) (MR_mkword(MR_mktag(1), &options_scalar_common_3[42])))
  },
  /* row 44 */
  {
    ((MR_Box) ((MR_String) "\t\tSame as \140--profile memory-cells\'.\n")),
    ((MR_Box) (MR_mkword(MR_mktag(1), &options_scalar_common_3[43])))
  },
  /* row 45 */
  {
    ((MR_Box) ((MR_String) "\t-M\n")),
    ((MR_Box) (MR_mkword(MR_mktag(1), &options_scalar_common_3[44])))
  },
  /* row 46 */
  {
    ((MR_Box) ((MR_String) "\t\tSame as \140--profile memory-words\'\n")),
    ((MR_Box) (MR_mkword(MR_mktag(1), &options_scalar_common_3[45])))
  },
  /* row 47 */
  {
    ((MR_Box) ((MR_String) "\t-m\n")),
    ((MR_Box) (MR_mkword(MR_mktag(1), &options_scalar_common_3[46])))
  },
  /* row 48 */
  {
    ((MR_Box) ((MR_String) "\t\tnumber of memory allocations (regardless of size).\n")),
    ((MR_Box) (MR_mkword(MR_mktag(1), &options_scalar_common_3[47])))
  },
  /* row 49 */
  {
    ((MR_Box) ((MR_String) "\t\tSelect what to profile: time, amount of memory allocated, or\n")),
    ((MR_Box) (MR_mkword(MR_mktag(1), &options_scalar_common_3[48])))
  },
  /* row 50 */
  {
    ((MR_Box) ((MR_String) "\t-p, --profile {time, memory-words, memory-cells}\n")),
    ((MR_Box) (MR_mkword(MR_mktag(1), &options_scalar_common_3[49])))
  },
  /* row 51 */
  {
    ((MR_Box) ((MR_String) "\t\tBuild the call graph dynamically.\n")),
    ((MR_Box) (MR_mkword(MR_mktag(1), &options_scalar_common_3[50])))
  },
  /* row 52 */
  {
    ((MR_Box) ((MR_String) "\t-d, --use-dynamic\n")),
    ((MR_Box) (MR_mkword(MR_mktag(1), &options_scalar_common_3[51])))
  },
  /* row 53 */
  {
    ((MR_Box) ((MR_String) "\t\tInclude the call graph profile.\n")),
    ((MR_Box) (MR_mkword(MR_mktag(1), &options_scalar_common_3[52])))
  },
  /* row 54 */
  {
    ((MR_Box) ((MR_String) "\t-c, --call-graph\n")),
    ((MR_Box) (MR_mkword(MR_mktag(1), &options_scalar_common_3[53])))
  },
  /* row 55 */
  {
    ((MR_Box) ((MR_String) "Profiler Options:\n")),
    ((MR_Box) (MR_mkword(MR_mktag(1), &options_scalar_common_3[54])))
  },
  /* row 56 */
  {
    ((MR_Box) ((MR_String) "\n")),
    ((MR_Box) (MR_mkword(MR_mktag(1), &options_scalar_common_3[55])))
  },
  /* row 57 */
  {
    ((MR_Box) ((MR_String) "\t\tPrint this usage message.\n")),
    ((MR_Box) (MR_mkword(MR_mktag(1), &options_scalar_common_3[56])))
  },
  /* row 58 */
  {
    ((MR_Box) ((MR_String) "-h, --help\n")),
    ((MR_Box) (MR_mkword(MR_mktag(1), &options_scalar_common_3[57])))
  },
};
...
{
  mercury__io__write_strings_4_p_0(OutputStream_4, (MR_Word) (MR_mkword(MR_mktag(1), &options_scalar_common_3[58])));
}
      ...
      case (MR_Integer) 4:
        {
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              ...
              *HeadVar__4_4 = (MR_Word) (MR_mkword(MR_mktag(1), &options_scalar_common_2[2]));
            succeeded = MR_TRUE;
          }
        }
        break;
      case (MR_Integer) 7:
        {
          ...
          mercury__map__set_4_p_0((MR_Word) (&options__options__type_ctor_info_option_0), (MR_Word) (&mercury__getopt__getopt__type_ctor_info_option_data_0), ((MR_Box) ((MR_Integer) 9)), ((MR_Box) (MR_mkword(MR_mktag(3), &options_scalar_common_3[5]))), STATE_VARIABLE_OptionTable_0_3, &STATE_VARIABLE_OptionTable_25);
          {
            MR_Word base;
            base = (MR_Word) MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL);
            *HeadVar__4_4 = base;
      ...
      case (MR_Integer) 6:
        {
          ...
          mercury__map__set_4_p_0((MR_Word) (&options__options__type_ctor_info_option_0), (MR_Word) (&mercury__getopt__getopt__type_ctor_info_option_data_0), ((MR_Box) ((MR_Integer) 9)), ((MR_Box) (MR_mkword(MR_mktag(3), &options_scalar_common_3[6]))), STATE_VARIABLE_OptionTable_0_3, &STATE_VARIABLE_OptionTable_17);
          {
            MR_Word base;
            base = (MR_Word) MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL);
            *HeadVar__4_4 = base;
      ...
      case (MR_Integer) 5:
        {
          ...
          mercury__map__set_4_p_0((MR_Word) (&options__options__type_ctor_info_option_0), (MR_Word) (&mercury__getopt__getopt__type_ctor_info_option_data_0), ((MR_Box) ((MR_Integer) 9)), ((MR_Box) (MR_mkword(MR_mktag(3), &options_scalar_common_3[0]))), STATE_VARIABLE_OptionTable_0_3, &STATE_VARIABLE_OptionTable_33);
          {
            MR_Word base;
            base = (MR_Word) MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL);
            *HeadVar__4_4 = base;
