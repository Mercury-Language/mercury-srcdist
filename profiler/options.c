      ...
      case (MR_Integer) 4:
        {
          ...
          if (options__succeeded)
          {
            ...
            if (options__succeeded)
            {
              MR_Word options__Var_11;
              MR_Word options__STATE_VARIABLE_OptionTable_12_12;

              {
                options__Var_11 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), options__Var_11, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 0));
                MR_hl_field(MR_mktag(3), options__Var_11, 1) = ((MR_Box) (options__CountFile_8));
              }
              {
                mercury__map__set_4_p_0((MR_Word) &options__options__type_ctor_info_option_0, (MR_Word) &mercury__getopt__getopt__type_ctor_info_option_data_0, ((MR_Box) ((MR_Integer) 9)), ((MR_Box) (options__Var_11)), options__STATE_VARIABLE_OptionTable_0_3, &options__STATE_VARIABLE_OptionTable_12_12);
              }
              {
                MR_Word base;
