...
static /* final */ const MR_Box options_scalar_common_2[59][2];

static /* final */ const MR_Integer options_scalar_common_4[1][2];

static /* final */ const MR_Box options_scalar_common_5[3][1];


/* sealed */ struct options__vector_common_type_3_0_s {
  const MR_Word options__vector_common_type_3_0__vct_3_f_0;
};

static /* final */ const struct options__vector_common_type_3_0_s options_vector_common_3[72];
...
static /* final */ const MR_Box options_scalar_common_2[59][2] = {
  ...
  /* row 1 */
  {
    ...
    ((MR_Box) (MR_mkword(MR_mktag(1), &options_scalar_common_2[0])))
  },
  /* row 2 */
  {
    ((MR_Box) ((MR_String) "\t\tOutput progress messages at each stage.\n")),
    ((MR_Box) (MR_mkword(MR_mktag(1), &options_scalar_common_2[1])))
  },
  /* row 3 */
  {
    ((MR_Box) ((MR_String) "\t-v, --verbose\n")),
    ((MR_Box) (MR_mkword(MR_mktag(1), &options_scalar_common_2[2])))
  },
  /* row 4 */
  {
    ((MR_Box) ((MR_String) "Verbosity Options:\n")),
    ((MR_Box) (MR_mkword(MR_mktag(1), &options_scalar_common_2[3])))
  },
  /* row 5 */
  {
    ((MR_Box) ((MR_String) "\n")),
    ((MR_Box) (MR_mkword(MR_mktag(1), &options_scalar_common_2[4])))
  },
  /* row 6 */
  {
    ((MR_Box) ((MR_String) "\t\tprofile. These are excluded by default.\n")),
    ((MR_Box) (MR_mkword(MR_mktag(1), &options_scalar_common_2[5])))
  },
  /* row 7 */
  {
    ((MR_Box) ((MR_String) "\t\tInclude internal Mercury runtime structures in the\n")),
    ((MR_Box) (MR_mkword(MR_mktag(1), &options_scalar_common_2[6])))
  },
  /* row 8 */
  {
    ((MR_Box) ((MR_String) "\t-r, --snapshots-include-runtime\n")),
    ((MR_Box) (MR_mkword(MR_mktag(1), &options_scalar_common_2[7])))
  },
  /* row 9 */
  {
    ((MR_Box) ((MR_String) "\t\tGenerate a brief profile.\n")),
    ((MR_Box) (MR_mkword(MR_mktag(1), &options_scalar_common_2[8])))
  },
  /* row 10 */
  {
    ((MR_Box) ((MR_String) "\t-b, --snapshots-brief\n")),
    ((MR_Box) (MR_mkword(MR_mktag(1), &options_scalar_common_2[9])))
  },
  /* row 11 */
  {
    ((MR_Box) ((MR_String) "\t\tGroup results by type.\n")),
    ((MR_Box) (MR_mkword(MR_mktag(1), &options_scalar_common_2[10])))
  },
  /* row 12 */
  {
    ((MR_Box) ((MR_String) "\t-T, --snapshots-by-type\n")),
    ((MR_Box) (MR_mkword(MR_mktag(1), &options_scalar_common_2[11])))
  },
  /* row 13 */
  {
    ((MR_Box) ((MR_String) "\t\tName of the snapshots file. Usually \140Prof.Snapshots\'.\n")),
    ((MR_Box) (MR_mkword(MR_mktag(1), &options_scalar_common_2[12])))
  },
  /* row 14 */
  {
    ((MR_Box) ((MR_String) "\t--snapshots-file <file>\n")),
    ((MR_Box) (MR_mkword(MR_mktag(1), &options_scalar_common_2[13])))
  },
  /* row 15 */
  {
    ((MR_Box) ((MR_String) "\t\tThis overrides other profiler modes.\n")),
    ((MR_Box) (MR_mkword(MR_mktag(1), &options_scalar_common_2[14])))
  },
  /* row 16 */
  {
    ((MR_Box) ((MR_String) "\t\t\140benchmarking.report_memory_attribution\' was called.\n")),
    ((MR_Box) (MR_mkword(MR_mktag(1), &options_scalar_common_2[15])))
  },
  /* row 17 */
  {
    ((MR_Box) ((MR_String) "\t\tShow summary of heap objects at the times\n")),
    ((MR_Box) (MR_mkword(MR_mktag(1), &options_scalar_common_2[16])))
  },
  /* row 18 */
  {
    ((MR_Box) ((MR_String) "\t-s, --snapshots\n")),
    ((MR_Box) (MR_mkword(MR_mktag(1), &options_scalar_common_2[17])))
  },
  /* row 19 */
  {
    ((MR_Box) ((MR_String) "Snapshot options:\n")),
    ((MR_Box) (MR_mkword(MR_mktag(1), &options_scalar_common_2[18])))
  },
  /* row 20 */
  {
    ((MR_Box) ((MR_String) "\n")),
    ((MR_Box) (MR_mkword(MR_mktag(1), &options_scalar_common_2[19])))
  },
  /* row 21 */
  {
    ((MR_Box) ((MR_String) "\t\tthe library modules.\n")),
    ((MR_Box) (MR_mkword(MR_mktag(1), &options_scalar_common_2[20])))
  },
  /* row 22 */
  {
    ((MR_Box) ((MR_String) "\t\tName of the file which contains the call graph for\n")),
    ((MR_Box) (MR_mkword(MR_mktag(1), &options_scalar_common_2[21])))
  },
  /* row 23 */
  {
    ((MR_Box) ((MR_String) "\t-L <file>, --library-callgraph <file>\n")),
    ((MR_Box) (MR_mkword(MR_mktag(1), &options_scalar_common_2[22])))
  },
  /* row 24 */
  {
    ((MR_Box) ((MR_String) "\t\tName of the call-pair file. Usually \140Prof.CallPair\'.\n")),
    ((MR_Box) (MR_mkword(MR_mktag(1), &options_scalar_common_2[23])))
  },
  /* row 25 */
  {
    ((MR_Box) ((MR_String) "\t-P <file>, --call-pair-file <file>\n")),
    ((MR_Box) (MR_mkword(MR_mktag(1), &options_scalar_common_2[24])))
  },
  /* row 26 */
  {
    ((MR_Box) ((MR_String) "\t\tName of the declaration file. Usually \140Prof.Decl\'.\n")),
    ((MR_Box) (MR_mkword(MR_mktag(1), &options_scalar_common_2[25])))
  },
  /* row 27 */
  {
    ((MR_Box) ((MR_String) "\t-D <file>, --declaration-file <file>\n")),
    ((MR_Box) (MR_mkword(MR_mktag(1), &options_scalar_common_2[26])))
  },
  /* row 28 */
  {
    ((MR_Box) ((MR_String) "\t\t\140Prof.MemoryWords\', or \140Prof.MemoryCells\'.\n")),
    ((MR_Box) (MR_mkword(MR_mktag(1), &options_scalar_common_2[27])))
  },
  /* row 29 */
  {
    ((MR_Box) ((MR_String) "\t\tName of the count file. Usually \140Prof.Counts\',\n")),
    ((MR_Box) (MR_mkword(MR_mktag(1), &options_scalar_common_2[28])))
  },
  /* row 30 */
  {
    ((MR_Box) ((MR_String) "\t-C <file>, --count-file <file>\n")),
    ((MR_Box) (MR_mkword(MR_mktag(1), &options_scalar_common_2[29])))
  },
  /* row 31 */
  {
    ((MR_Box) ((MR_String) "Filename Options:\n")),
    ((MR_Box) (MR_mkword(MR_mktag(1), &options_scalar_common_2[30])))
  },
  /* row 32 */
  {
    ((MR_Box) ((MR_String) "\n")),
    ((MR_Box) (MR_mkword(MR_mktag(1), &options_scalar_common_2[31])))
  },
  /* row 33 */
  {
    ((MR_Box) ((MR_String) "\t\tOutput the mangled predicate and function names.\n")),
    ((MR_Box) (MR_mkword(MR_mktag(1), &options_scalar_common_2[32])))
  },
  /* row 34 */
  {
    ((MR_Box) ((MR_String) "\t--no-demangle\n")),
    ((MR_Box) (MR_mkword(MR_mktag(1), &options_scalar_common_2[33])))
  },
  /* row 35 */
  {
    ((MR_Box) ((MR_String) "\t\tSame as \140--profile time\'.\n")),
    ((MR_Box) (MR_mkword(MR_mktag(1), &options_scalar_common_2[34])))
  },
  /* row 36 */
  {
    ((MR_Box) ((MR_String) "\t-t\n")),
    ((MR_Box) (MR_mkword(MR_mktag(1), &options_scalar_common_2[35])))
  },
  /* row 37 */
  {
    ((MR_Box) ((MR_String) "\t\tSame as \140--profile memory-cells\'.\n")),
    ((MR_Box) (MR_mkword(MR_mktag(1), &options_scalar_common_2[36])))
  },
  /* row 38 */
  {
    ((MR_Box) ((MR_String) "\t-M\n")),
    ((MR_Box) (MR_mkword(MR_mktag(1), &options_scalar_common_2[37])))
  },
  /* row 39 */
  {
    ((MR_Box) ((MR_String) "\t\tSame as \140--profile memory-words\'\n")),
    ((MR_Box) (MR_mkword(MR_mktag(1), &options_scalar_common_2[38])))
  },
  /* row 40 */
  {
    ((MR_Box) ((MR_String) "\t-m\n")),
    ((MR_Box) (MR_mkword(MR_mktag(1), &options_scalar_common_2[39])))
  },
  /* row 41 */
  {
    ((MR_Box) ((MR_String) "\t\tnumber of memory allocations (regardless of size).\n")),
    ((MR_Box) (MR_mkword(MR_mktag(1), &options_scalar_common_2[40])))
  },
  /* row 42 */
  {
    ((MR_Box) ((MR_String) "\t\tSelect what to profile: time, amount of memory allocated, or\n")),
    ((MR_Box) (MR_mkword(MR_mktag(1), &options_scalar_common_2[41])))
  },
  /* row 43 */
  {
    ((MR_Box) ((MR_String) "\t-p, --profile {time, memory-words, memory-cells}\n")),
    ((MR_Box) (MR_mkword(MR_mktag(1), &options_scalar_common_2[42])))
  },
  /* row 44 */
  {
    ((MR_Box) ((MR_String) "\t\tBuild the call graph dynamically.\n")),
    ((MR_Box) (MR_mkword(MR_mktag(1), &options_scalar_common_2[43])))
  },
  /* row 45 */
  {
    ((MR_Box) ((MR_String) "\t-d, --use-dynamic\n")),
    ((MR_Box) (MR_mkword(MR_mktag(1), &options_scalar_common_2[44])))
  },
  /* row 46 */
  {
    ((MR_Box) ((MR_String) "\t\tInclude the call graph profile.\n")),
    ((MR_Box) (MR_mkword(MR_mktag(1), &options_scalar_common_2[45])))
  },
  /* row 47 */
  {
    ((MR_Box) ((MR_String) "\t-c, --call-graph\n")),
    ((MR_Box) (MR_mkword(MR_mktag(1), &options_scalar_common_2[46])))
  },
  /* row 48 */
  {
    ((MR_Box) ((MR_String) "Profiler Options:\n")),
    ((MR_Box) (MR_mkword(MR_mktag(1), &options_scalar_common_2[47])))
  },
  /* row 49 */
  {
    ((MR_Box) ((MR_String) "\n")),
    ((MR_Box) (MR_mkword(MR_mktag(1), &options_scalar_common_2[48])))
  },
  /* row 50 */
  {
    ((MR_Box) ((MR_String) "\t\tPrint this usage message.\n")),
    ((MR_Box) (MR_mkword(MR_mktag(1), &options_scalar_common_2[49])))
  },
  /* row 51 */
  {
    ((MR_Box) ((MR_String) "-h, --help\n")),
    ((MR_Box) (MR_mkword(MR_mktag(1), &options_scalar_common_2[50])))
  },
  /* row 52 */
  {
    ((MR_Box) ((MR_Unsigned) 0U)),
...
static /* final */ const struct options__vector_common_type_6_0_s options_vector_common_6[20] = {
  ...
  {
    (MR_Integer) 0,
    (MR_Word) (MR_mkword(MR_mktag(1), &options_scalar_common_5[0]))
  },
  /* row 1 */
  {
    (MR_Integer) 1,
  ...
  {
    (MR_Integer) 9,
    (MR_Word) (MR_mkword(MR_mktag(3), &options_scalar_common_2[52]))
  },
  /* row 9 */
  {
    (MR_Integer) 10,
    (MR_Word) (MR_mkword(MR_mktag(3), &options_scalar_common_2[53]))
  },
  /* row 10 */
  {
    (MR_Integer) 11,
    (MR_Word) (MR_mkword(MR_mktag(3), &options_scalar_common_2[54]))
  },
  /* row 11 */
  {
    (MR_Integer) 12,
    (MR_Word) (MR_mkword(MR_mktag(3), &options_scalar_common_2[55]))
  },
  /* row 12 */
  {
    (MR_Integer) 8,
    (MR_Word) (MR_mkword(MR_mktag(1), &options_scalar_common_5[1]))
  },
  /* row 13 */
  {
    (MR_Integer) 13,
  ...
  {
    (MR_Integer) 14,
    (MR_Word) (MR_mkword(MR_mktag(3), &options_scalar_common_2[56]))
  },
  /* row 15 */
  {
    (MR_Integer) 15,
...
{
  mercury__io__write_strings_4_p_0(OutputStream_4, (MR_Word) (MR_mkword(MR_mktag(1), &options_scalar_common_2[51])));
}
      ...
      case (MR_Integer) 4:
        {
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              ...
              *HeadVar__4_4 = (MR_Word) (MR_mkword(MR_mktag(1), &options_scalar_common_5[2]));
            succeeded = MR_TRUE;
          }
        }
        break;
      case (MR_Integer) 7:
        {
          ...
          mercury__map__set_4_p_0((MR_Word) (&options__options__type_ctor_info_option_0), (MR_Word) (&mercury__getopt__getopt__type_ctor_info_option_data_0), ((MR_Box) ((MR_Integer) 9)), ((MR_Box) (MR_mkword(MR_mktag(3), &options_scalar_common_2[57]))), STATE_VARIABLE_OptionTable_0_3, &STATE_VARIABLE_OptionTable_25);
          {
            MR_Word base;
            base = (MR_Word) MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL);
            *HeadVar__4_4 = base;
            MR_hl_field(MR_mktag(0), base, 0) = ((MR_Box) (STATE_VARIABLE_OptionTable_25));
          }
          succeeded = MR_TRUE;
        }
        break;
      case (MR_Integer) 6:
        {
          ...
          mercury__map__set_4_p_0((MR_Word) (&options__options__type_ctor_info_option_0), (MR_Word) (&mercury__getopt__getopt__type_ctor_info_option_data_0), ((MR_Box) ((MR_Integer) 9)), ((MR_Box) (MR_mkword(MR_mktag(3), &options_scalar_common_2[58]))), STATE_VARIABLE_OptionTable_0_3, &STATE_VARIABLE_OptionTable_17);
          {
            MR_Word base;
            base = (MR_Word) MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL);
            *HeadVar__4_4 = base;
            MR_hl_field(MR_mktag(0), base, 0) = ((MR_Box) (STATE_VARIABLE_OptionTable_17));
          }
          succeeded = MR_TRUE;
        }
        break;
      case (MR_Integer) 5:
        {
          ...
          mercury__map__set_4_p_0((MR_Word) (&options__options__type_ctor_info_option_0), (MR_Word) (&mercury__getopt__getopt__type_ctor_info_option_data_0), ((MR_Box) ((MR_Integer) 9)), ((MR_Box) (MR_mkword(MR_mktag(3), &options_scalar_common_2[52]))), STATE_VARIABLE_OptionTable_0_3, &STATE_VARIABLE_OptionTable_33);
          {
            MR_Word base;
            base = (MR_Word) MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL);
            *HeadVar__4_4 = base;
            MR_hl_field(MR_mktag(0), base, 0) = ((MR_Box) (STATE_VARIABLE_OptionTable_33));
          }
          succeeded = MR_TRUE;
        }
        break;
...
{
  {
...

    {
      ...
      else
      {
        ...
        ;
        *HeadVar__2_2 = ((&options_vector_common_3[52 + case_num_0]))->options__vector_common_type_3_0__vct_3_f_0;
        succeeded = MR_TRUE;
      }
    }
    return succeeded;
...
{
  {
    ...
    if ((((MR_Unsigned) ((MR_Integer) ((MR_Unsigned) HeadVar__1_1 - (MR_Unsigned) 67))) <= ((MR_Unsigned) 51)))
      if ((((options_scalar_common_4[0])[(((MR_Integer) ((MR_Unsigned) HeadVar__1_1 - (MR_Unsigned) 67)) >> 5)]) & (((MR_Integer) 1 << ((((MR_Integer) ((MR_Unsigned) HeadVar__1_1 - (MR_Unsigned) 67)) & (MR_Integer) 31))))))
      {
        *HeadVar__2_2 = ((&options_vector_common_3[0 + (MR_Integer) ((MR_Unsigned) HeadVar__1_1 - (MR_Unsigned) 67)]))->options__vector_common_type_3_0__vct_3_f_0;
        succeeded = MR_TRUE;
      }
      else
        succeeded = MR_FALSE;
