...
static const struct mercury_type_3 mercury_vector_common_3_0[20] =
{
{
0,
MR_TAG_COMMON(1,1,0)
...
MR_def_label(options__special_handler_4_0,3)
	...
	MR_tempr1 = MR_r3;
	MR_r3 = (MR_Integer) 9;
	MR_r4 = (MR_Word) MR_TAG_COMMON(3,2,5);
	MR_r5 = MR_tempr1;
	}
	MR_np_call_localret_ent(map__set_4_0,
		options__special_handler_4_0_i25);
MR_def_label(options__special_handler_4_0,15)
	...
	MR_tempr1 = MR_r3;
	MR_r3 = (MR_Integer) 9;
	MR_r4 = (MR_Word) MR_TAG_COMMON(3,2,6);
	MR_r5 = MR_tempr1;
	}
	MR_np_call_localret_ent(map__set_4_0,
		options__special_handler_4_0_i25);
MR_def_label(options__special_handler_4_0,19)
	...
	MR_tempr1 = MR_r3;
	MR_r3 = (MR_Integer) 9;
	MR_r4 = (MR_Word) MR_TAG_COMMON(3,2,0);
	MR_r5 = MR_tempr1;
	}
	MR_np_call_localret_ent(map__set_4_0,
		options__special_handler_4_0_i25);
...
void mercury__options__write_out_proc_statics(FILE *deep_fp, FILE *procrep_fp)
{
	MR_write_out_module_proc_reps_start(procrep_fp, &mercury_data__module_layout__options);
