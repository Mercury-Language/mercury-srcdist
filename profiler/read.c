    ...
    if (read__succeeded)
      *read__WhatToProfile_4 = read__WhatToProfile0_7;
    else
      {
        ...
        {
          read__V_13_13 = mercury__string__f_43_43_2_f_0((MR_String) "Invalid input: WhatToProfile = ", read__Str_6);
        }
        {
    ...
    if (read__succeeded)
      *read__Float_4 = read__Float0_7;
    else
      {
        ...
        {
          read__V_13_13 = mercury__string__f_43_43_2_f_0((MR_String) "Invalid input: not a float ", read__FloatStr_6);
        }
        {
    ...
    if (read__succeeded)
      *read__Int_4 = read__Int0_7;
    else
      {
        ...
        {
          read__V_13_13 = mercury__string__f_43_43_2_f_0((MR_String) "Invalid input: not an integer ", read__IntStr_6);
        }
        {
