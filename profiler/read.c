  ...
  MR_String * String_6)
{
  ...
  switch (MR_tag((MR_Word) WordResult_8)) {
    ...
    case (MR_Integer) 1:
      {
        MR_Word CharList_9 = ((MR_Word) ((MR_hl_field(1, WordResult_8, 0))));
    ...
    case (MR_Integer) 2:
      {
        MR_Word Error_10 = ((MR_Word) ((MR_hl_field(2, WordResult_8, 0))));
        MR_String Var_17;
  ...
  MR_String * LabelName_6)
{
  ...
  switch (MR_tag((MR_Word) WordResult_9)) {
    ...
    case (MR_Integer) 1:
      {
        MR_Word CharList0_10 = ((MR_Word) ((MR_hl_field(1, WordResult_9, 0))));
    ...
    case (MR_Integer) 2:
      {
        MR_Word Error_12 = ((MR_Word) ((MR_hl_field(2, WordResult_9, 0))));
        MR_String Var_21;
  ...
  MR_Integer * LabelAddr_6)
{
  ...
  switch (MR_tag((MR_Word) WordResult_8)) {
    ...
    case (MR_Integer) 2:
      {
        MR_Word Error_13 = ((MR_Word) ((MR_hl_field(2, WordResult_8, 0))));
        MR_String Var_24;
  ...
  MR_Word * MaybeLabelName_6)
{
  ...
  switch (MR_tag((MR_Word) WordResult_9)) {
    ...
    case (MR_Integer) 2:
      {
        MR_Word Error_13 = ((MR_Word) ((MR_hl_field(2, WordResult_9, 0))));
        MR_String Var_20;
