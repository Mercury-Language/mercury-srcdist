...
#endif
MR_decl_label10(read__maybe_read_label_addr_3_0, 2,4,6,8,7,12,11,5,18,19)
MR_decl_label9(read__maybe_read_label_name_3_0, 2,3,5,7,21,9,6,13,14)
MR_decl_label5(read__read_float_3_0, 2,5,7,8,10)
MR_decl_label5(read__read_int_3_0, 2,5,3,7,8)
MR_decl_label10(read__read_label_addr_3_0, 2,5,7,6,10,9,4,15,17,18)
MR_decl_label8(read__read_label_name_3_0, 2,3,6,5,10,12,13,4)
MR_decl_label5(read__read_string_3_0, 2,4,6,8,9)
...
MR_BEGIN_MODULE(read_module0)
	...
	MR_init_label10(read__maybe_read_label_addr_3_0,2,4,6,8,7,12,11,5,18,19)
MR_BEGIN_CODE
...
MR_def_label(read__maybe_read_label_addr_3_0,2)
	...
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
		MR_GOTO_LAB(read__maybe_read_label_addr_3_0_i4);
	}
	MR_r1 = (MR_Word) MR_tbmkword(0, 0);
	MR_decr_sp_and_return(2);
MR_def_label(read__maybe_read_label_addr_3_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_def_label(read__maybe_read_label_addr_3_0,18)
	...
	MR_np_call_localret_ent(fn__f_115_116_114_105_110_103_95_95_43_43_2_0,
		read__maybe_read_label_addr_3_0_i19);
MR_def_label(read__maybe_read_label_addr_3_0,19)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_succip_word = MR_sv(2);
	MR_decr_sp(2);
	MR_np_tailcall_ent(require__error_1_0);
...
MR_BEGIN_MODULE(read_module1)
	...
	MR_init_label9(read__maybe_read_label_name_3_0,2,3,5,7,21,9,6,13,14)
MR_BEGIN_CODE
...
MR_def_label(read__maybe_read_label_name_3_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
		MR_GOTO_LAB(read__maybe_read_label_name_3_0_i5);
	}
	MR_r1 = (MR_Word) MR_tbmkword(0, 0);
	MR_decr_sp_and_return(2);
MR_def_label(read__maybe_read_label_name_3_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_r1,1)) {
...
MR_def_label(read__maybe_read_label_name_3_0,21)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_def_label(read__maybe_read_label_name_3_0,9)
	...
	MR_np_call_localret_ent(demangle__demangle_2_0,
		read__maybe_read_label_name_3_0_i21);
...
MR_def_label(read__maybe_read_label_name_3_0,13)
	...
	MR_np_call_localret_ent(fn__f_115_116_114_105_110_103_95_95_43_43_2_0,
		read__maybe_read_label_name_3_0_i14);
MR_def_label(read__maybe_read_label_name_3_0,14)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_succip_word = MR_sv(2);
	MR_decr_sp(2);
	MR_np_tailcall_ent(require__error_1_0);
...
MR_BEGIN_MODULE(read_module2)
	...
	MR_init_label10(read__read_label_addr_3_0,2,5,7,6,10,9,4,15,17,18)
MR_BEGIN_CODE
...
MR_def_label(read__read_label_addr_3_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_r1,1)) {
		MR_GOTO_LAB(read__read_label_addr_3_0_i4);
	}
	MR_r1 = MR_tfield(1, MR_r1, 0);
	MR_np_call_localret_ent(string__from_char_list_2_0,
		read__read_label_addr_3_0_i5);
...
MR_def_label(read__read_label_addr_3_0,6)
	...
	MR_r2 = MR_sv(1);
	MR_np_call_localret_ent(string__base_string_to_int_3_0,
		read__read_label_addr_3_0_i10);
MR_def_label(read__read_label_addr_3_0,10)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(read__read_label_addr_3_0_i9);
	}
	MR_r1 = MR_r2;
	MR_decr_sp_and_return(2);
MR_def_label(read__read_label_addr_3_0,9)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_string_const("maybe_read_label_addr: Label address not hexadecimal or integer\n", 64);
	MR_succip_word = MR_sv(2);
	MR_decr_sp(2);
	MR_np_tailcall_ent(require__error_1_0);
MR_def_label(read__read_label_addr_3_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
...
MR_BEGIN_MODULE(read_module3)
	...
	MR_init_label8(read__read_label_name_3_0,2,3,6,5,10,12,13,4)
MR_BEGIN_CODE
...
MR_def_label(read__read_label_name_3_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_r1,1)) {
		MR_GOTO_LAB(read__read_label_name_3_0_i5);
	}
	MR_r1 = MR_tfield(1, MR_r1, 0);
	MR_np_call_localret_ent(string__from_char_list_2_0,
		read__read_label_name_3_0_i6);
...
MR_def_label(read__read_label_name_3_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
		MR_GOTO_LAB(read__read_label_name_3_0_i10);
	}
	MR_r1 = (MR_Word) MR_string_const("read_label_name: EOF reached", 28);
	MR_succip_word = MR_sv(2);
	MR_decr_sp(2);
	MR_np_tailcall_ent(require__error_1_0);
MR_def_label(read__read_label_name_3_0,10)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_tfield(2, MR_r1, 0);
	MR_np_call_localret_ent(fn__io__error_message_1_0,
...
MR_BEGIN_MODULE(read_module4)
	...
	MR_init_label5(read__read_string_3_0,2,4,6,8,9)
MR_BEGIN_CODE
...
MR_def_label(read__read_string_3_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_r1,1)) {
		MR_GOTO_LAB(read__read_string_3_0_i4);
	}
	MR_r1 = MR_tfield(1, MR_r1, 0);
	MR_succip_word = MR_sv(1);
	MR_decr_sp(1);
	MR_np_tailcall_ent(string__from_char_list_2_0);
MR_def_label(read__read_string_3_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
...
MR_BEGIN_MODULE(read_module6)
	...
	MR_init_label5(read__read_float_3_0,2,5,7,8,10)
MR_BEGIN_CODE
...
MR_def_label(read__read_float_3_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_r1) {
		MR_GOTO_LAB(read__read_float_3_0_i10);
	}
	MR_r1 = MR_sv(1);
	{
	MR_Word MR_tempr1;
...
MR_def_label(read__read_float_3_0,8)
	...
	MR_decr_sp(2);
	MR_np_tailcall_ent(require__error_1_0);
MR_def_label(read__read_float_3_0,10)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(2);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
...
void mercury__read__init_threadscope_string_table(void);
#endif
...
void mercury__read__write_out_proc_statics(FILE *deep_fp, FILE *procrep_fp)
{
	MR_write_out_module_proc_reps_start(procrep_fp, &mercury_data__module_layout__read);
