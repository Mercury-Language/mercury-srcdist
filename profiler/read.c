...
#endif
MR_decl_label8(read__maybe_read_label_addr_3_0, 2,5,6,7,9,10,12,11)
MR_decl_label2(read__maybe_read_label_addr_3_0, 16,15)
MR_decl_label8(read__maybe_read_label_name_3_0, 2,3,6,7,8,10,11,21)
MR_decl_label1(read__maybe_read_label_name_3_0, 13)
MR_decl_label5(read__read_float_3_0, 2,5,3,7,8)
MR_decl_label5(read__read_int_3_0, 2,5,3,7,8)
MR_decl_label8(read__read_label_addr_3_0, 2,6,7,8,10,11,13,12)
MR_decl_label2(read__read_label_addr_3_0, 16,15)
MR_decl_label8(read__read_label_name_3_0, 2,3,7,8,9,11,12,4)
MR_decl_label5(read__read_string_3_0, 2,6,7,8,10)
...
MR_BEGIN_MODULE(read_module0)
	...
	MR_init_label8(read__maybe_read_label_addr_3_0,2,5,6,7,9,10,12,11)
	MR_init_label2(read__maybe_read_label_addr_3_0,16,15)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(read_module1)
	...
	MR_init_label8(read__maybe_read_label_name_3_0,2,3,6,7,8,10,11,21)
	MR_init_label1(read__maybe_read_label_name_3_0,13)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(read_module2)
	...
	MR_init_label8(read__read_label_addr_3_0,2,6,7,8,10,11,13,12)
	MR_init_label2(read__read_label_addr_3_0,16,15)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(read_module3)
	...
	MR_init_label8(read__read_label_name_3_0,2,3,7,8,9,11,12,4)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(read_module4)
	...
	MR_init_label5(read__read_string_3_0,2,6,7,8,10)
MR_BEGIN_CODE
