...
{
  {
    ...
    else
    {
      ...
      Var_12 = mercury__string__f_43_43_2_f_0((MR_String) "Invalid input: WhatToProfile = ", Str_6);
      {
        mercury__require__unexpected_2_p_0((MR_String) "predicate \140read.read_what_to_profile\'/3", Var_12);
        return;
      }
    }
  }
...
{
  {
    ...
    else
    {
      ...
      Var_12 = mercury__string__f_43_43_2_f_0((MR_String) "Invalid input: not a float ", FloatStr_6);
      {
        mercury__require__unexpected_2_p_0((MR_String) "predicate \140read.read_float\'/3", Var_12);
        return;
      }
    }
  }
...
{
  {
    ...
    else
    {
      ...
      Var_12 = mercury__string__f_43_43_2_f_0((MR_String) "Invalid input: not an integer ", IntStr_6);
      {
        mercury__require__unexpected_2_p_0((MR_String) "predicate \140read.read_int\'/3", Var_12);
        return;
      }
    }
  }
...
{
  {
    ...
    switch (MR_tag((MR_Word) WordResult_6)) {
      ...
      case (MR_Integer) 0:
        {
          mercury__require__unexpected_2_p_0((MR_String) "predicate \140read.read_string\'/3", (MR_String) "EOF reached");
          return;
        }
        break;
      case (MR_Integer) 1:
      ...
      case (MR_Integer) 2:
        {
          ...
          Var_13 = mercury__io__error_message_1_f_0(Error_8);
          {
            mercury__require__unexpected_2_p_0((MR_String) "predicate \140read.read_string\'/3", Var_13);
            return;
          }
        }
        break;
...
{
  {
    ...
    switch (MR_tag((MR_Word) WordResult_7)) {
      ...
      case (MR_Integer) 0:
        {
          mercury__require__unexpected_2_p_0((MR_String) "predicate \140read.read_label_name\'/3", (MR_String) "EOF reached");
          return;
        }
        break;
      case (MR_Integer) 1:
      ...
      case (MR_Integer) 2:
        {
          ...
          {
            mercury__require__unexpected_2_p_0((MR_String) "predicate \140read.read_label_name\'/3", Var_17);
            return;
          }
        }
        break;
...
{
  {
    ...
    switch (MR_tag((MR_Word) WordResult_6)) {
      ...
      case (MR_Integer) 0:
        {
          mercury__require__unexpected_2_p_0((MR_String) "predicate \140read.read_label_addr\'/3", (MR_String) "EOF reached");
          return;
        }
        break;
      case (MR_Integer) 1:
          ...
          else
          {
            ...
            if (succeeded)
              *LabelAddr_4 = LabelAddrHex_10;
              ...
              {
                mercury__require__unexpected_2_p_0((MR_String) "predicate \140read.read_label_addr\'/3", (MR_String) "Label address not hexadecimal or integer");
                return;
              }
          }
        }
      ...
      case (MR_Integer) 2:
        {
          ...
          Var_16 = mercury__io__error_message_1_f_0(Error_11);
          {
            mercury__require__unexpected_2_p_0((MR_String) "predicate \140read.read_label_addr\'/3", Var_16);
            return;
          }
        }
        break;
...
{
  {
    ...
    switch (MR_tag((MR_Word) WordResult_7)) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        *MaybeLabelName_4 = (MR_Word) ((MR_Unsigned) 0U);
        break;
      case (MR_Integer) 1:
        {
          MR_Word CharList0_8 = ((MR_Word) ((MR_hl_field(MR_mktag(1), WordResult_7, (MR_Integer) 0))));
      ...
      case (MR_Integer) 2:
        {
          ...
          {
            mercury__require__unexpected_2_p_0((MR_String) "predicate \140read.maybe_read_label_name\'/3", Var_18);
            return;
          }
        }
        break;
...
{
  {
    ...
    switch (MR_tag((MR_Word) WordResult_6)) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        *MaybeLabelAddr_4 = (MR_Word) ((MR_Unsigned) 0U);
        break;
      case (MR_Integer) 1:
        {
          MR_Word CharList_7 = ((MR_Word) ((MR_hl_field(MR_mktag(1), WordResult_6, (MR_Integer) 0))));
          ...
          else
          {
            ...
            if (succeeded)
              ...
              {
                mercury__require__unexpected_2_p_0((MR_String) "predicate \140read.maybe_read_label_addr\'/3", (MR_String) "Label address not hexadecimal or integer");
                return;
              }
          }
        }
      ...
      case (MR_Integer) 2:
        {
          ...
          Var_16 = mercury__io__error_message_1_f_0(Error_11);
          {
            mercury__require__unexpected_2_p_0((MR_String) "predicate \140read.maybe_read_label_addr\'/3", Var_16);
            return;
          }
        }
        break;
