...
{
  {
    ...
    switch (MR_tag((MR_Word) WordResult_8)) {
      ...
      case (MR_Integer) 1:
        {
          MR_Word CharList_9 = ((MR_Word) ((MR_hl_field(MR_mktag(1), WordResult_8, (MR_Integer) 0))));
      ...
      case (MR_Integer) 2:
        {
          MR_Word Error_10 = ((MR_Word) ((MR_hl_field(MR_mktag(2), WordResult_8, (MR_Integer) 0))));
          MR_String Var_15;

          Var_15 = mercury__io__error_message_1_f_0(Error_10);
          {
            mercury__require__unexpected_2_p_0((MR_String) "predicate \140read.read_string\'/4", Var_15);
            return;
          }
        }
        break;
...
{
  {
    ...
    switch (MR_tag((MR_Word) WordResult_9)) {
      ...
      case (MR_Integer) 1:
        {
          MR_Word CharList0_10 = ((MR_Word) ((MR_hl_field(MR_mktag(1), WordResult_9, (MR_Integer) 0))));
      ...
      case (MR_Integer) 2:
        {
          MR_Word Error_12 = ((MR_Word) ((MR_hl_field(MR_mktag(2), WordResult_9, (MR_Integer) 0))));
          MR_String Var_19;

          Var_19 = mercury__io__error_message_1_f_0(Error_12);
          {
            mercury__require__unexpected_2_p_0((MR_String) "predicate \140read.read_label_name\'/4", Var_19);
            return;
          }
        }
        break;
...
{
  {
    ...
    switch (MR_tag((MR_Word) WordResult_8)) {
      ...
      case (MR_Integer) 2:
        {
          MR_Word Error_13 = ((MR_Word) ((MR_hl_field(MR_mktag(2), WordResult_8, (MR_Integer) 0))));
          MR_String Var_18;

          Var_18 = mercury__io__error_message_1_f_0(Error_13);
          {
            mercury__require__unexpected_2_p_0((MR_String) "predicate \140read.read_label_addr\'/4", Var_18);
            return;
          }
        }
        break;
...
{
  {
    ...
    switch (MR_tag((MR_Word) WordResult_9)) {
            ...
            case (MR_Integer) 0:
              {
                ...
                *MaybeLabelName_6 = base;
                MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (MangledLabelName_11));
              }
              break;
            case (MR_Integer) 1:
              {
                ...
                demangle__demangle_2_p_0(MangledLabelName_11, &LabelName_12);
                {
                  ...
                  base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                  *MaybeLabelName_6 = base;
                  MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (LabelName_12));
                }
              }
              break;
          }
      ...
      case (MR_Integer) 2:
        {
          MR_Word Error_13 = ((MR_Word) ((MR_hl_field(MR_mktag(2), WordResult_9, (MR_Integer) 0))));
          MR_String Var_20;
          ...
          if (succeeded)
            {
              ...
              *MaybeLabelAddr_6 = base;
              MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (LabelAddr_11));
            }
          else
          {
            MR_Integer LabelAddrHex_12;
            ...
            if (succeeded)
              {
                ...
                base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                *MaybeLabelAddr_6 = base;
                MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (LabelAddrHex_12));
              }
            else
              {
      ...
      case (MR_Integer) 2:
        {
          ...
          Var_18 = mercury__io__error_message_1_f_0(Error_13);
          {
            mercury__require__unexpected_2_p_0((MR_String) "predicate \140read.maybe_read_label_addr\'/4", Var_18);
            return;
          }
        }
        break;
