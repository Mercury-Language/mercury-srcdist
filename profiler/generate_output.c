...
MR_decl_label8(generate_output__process_prof_node_children_2_4_0, 34,3,4,5,7,6,9,10)
MR_decl_label8(generate_output__process_prof_node_children_2_4_0, 11,12,13,14,15,16,17,19)
MR_decl_label2(generate_output__process_prof_node_children_2_4_0, 21,22)
MR_decl_label8(generate_output__process_prof_node_list_7_0, 18,3,5,6,7,8,4,9)
MR_decl_label8(generate_output__process_prof_node_parents_3_7_0, 26,3,4,6,5,8,9,10)
MR_decl_label2(generate_output__process_prof_node_parents_3_7_0, 12,14)
MR_decl_label7(generate_output__remove_child_cycle_members_5_0, 34,4,6,9,8,5,12)
MR_decl_label7(generate_output__remove_cycle_members_7_0, 34,4,6,9,8,5,12)
...
MR_BEGIN_MODULE(generate_output_module1)
	...
	MR_init_label7(generate_output__remove_cycle_members_7_0,34,4,6,9,8,5,12)
MR_BEGIN_CODE
...
MR_def_static(generate_output__remove_cycle_members_7_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
		MR_GOTO_LAB(generate_output__remove_cycle_members_7_0_i34);
	}
	MR_r1 = MR_r4;
	MR_r2 = (MR_Word) MR_tbmkword(0, 0);
	MR_r3 = (MR_Word) MR_tbmkword(0, 0);
	MR_proceed();
MR_def_label(generate_output__remove_cycle_members_7_0,34)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(8);
...
MR_BEGIN_MODULE(generate_output_module3)
	...
	MR_init_label8(generate_output__process_prof_node_parents_3_7_0,26,3,4,6,5,8,9,10)
	MR_init_label2(generate_output__process_prof_node_parents_3_7_0,12,14)
MR_BEGIN_CODE
...
MR_def_label(generate_output__process_prof_node_parents_3_7_0,26)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
...
MR_def_label(generate_output__process_prof_node_parents_3_7_0,14)
	...
	MR_GOTO_LAB(generate_output__process_prof_node_parents_3_7_0_i26);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_thread_engine_base
#endif
...
MR_BEGIN_MODULE(generate_output_module4)
	...
	MR_init_label7(generate_output__remove_child_cycle_members_5_0,34,4,6,9,8,5,12)
MR_BEGIN_CODE
...
MR_def_static(generate_output__remove_child_cycle_members_5_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
		MR_GOTO_LAB(generate_output__remove_child_cycle_members_5_0_i34);
	}
	MR_r1 = (MR_Word) MR_tbmkword(0, 0);
	MR_r2 = (MR_Word) MR_tbmkword(0, 0);
	MR_proceed();
MR_def_label(generate_output__remove_child_cycle_members_5_0,34)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(7);
...
MR_BEGIN_MODULE(generate_output_module5)
	...
	MR_init_label8(generate_output__process_prof_node_children_2_4_0,34,3,4,5,7,6,9,10)
	MR_init_label8(generate_output__process_prof_node_children_2_4_0,11,12,13,14,15,16,17,19)
	MR_init_label2(generate_output__process_prof_node_children_2_4_0,21,22)
MR_BEGIN_CODE
...
MR_def_label(generate_output__process_prof_node_children_2_4_0,34)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
...
MR_def_label(generate_output__process_prof_node_children_2_4_0,22)
	...
	MR_GOTO_LAB(generate_output__process_prof_node_children_2_4_0_i34);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_thread_engine_base
#endif
