...
{
  {
    ...
    TypeCtorInfo_6_41 = (MR_Word) &mercury__builtin__builtin__type_ctor_info_string_0;
    mercury__map__init_1_p_0(TypeCtorInfo_6_41, (MR_Word) &output_prof_info__output_prof_info__type_ctor_info_output_prof_0, &InfoMap_38);
    mercury__rbtree__init_1_p_0((MR_Word) &mercury__builtin__builtin__type_ctor_info_float_0, TypeCtorInfo_6_41, &CallTree_39);
    mercury__rbtree__init_1_p_0((MR_Word) &generate_output__generate_output__type_ctor_info_flat_key_0, TypeCtorInfo_6_41, &FlatTree_40);
    {
    ...
    CallList0_23 = mercury__rbtree__values_1_f_0((MR_Word) &mercury__builtin__builtin__type_ctor_info_float_0, TypeCtorInfo_35_35, CallTree_21);
    FlatList0_24 = mercury__rbtree__values_1_f_0((MR_Word) &generate_output__generate_output__type_ctor_info_flat_key_0, TypeCtorInfo_35_35, FlatTree_22);
    TypeCtorInfo_9_50 = (MR_Word) &mercury__builtin__builtin__type_ctor_info_string_0;
    mercury__list__reverse_2_p_0(TypeCtorInfo_9_50, CallList0_23, &CallList_25);
    Var_49 = mercury__map__init_0_f_0(TypeCtorInfo_9_50, (MR_Word) &mercury__builtin__builtin__type_ctor_info_int_0);
    generate_output__assign_index_numbers_2_4_p_0(CallList_25, (MR_Integer) 1, Var_49, IndexMap_7);
    FlatList_26 = mercury__list__reverse_1_f_0(TypeCtorInfo_35_35, FlatList0_24);
    {
      MR_Word base;
  ...
  MR_Word * STATE_VARIABLE_IndexMap_4)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      {
        MR_Word next_value_of_HeadVar__1_1 = Xs0_10;
        MR_Integer next_value_of_N_2 = Var_16;
        MR_Word next_value_of_STATE_VARIABLE_IndexMap_0_3 = STATE_VARIABLE_IndexMap_15_15;
  ...
  MR_Word * STATE_VARIABLE_OutputProf_5)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      /* direct tailcall eliminated */
      {
        MR_Word next_value_of_HeadVar__1_1 = PNs_17;
        MR_Word next_value_of_STATE_VARIABLE_OutputProf_0_4 = STATE_VARIABLE_OutputProf_30_30;
...
{
  {
    ...
    if (succeeded)
    {
      ...
      succeeded = (ParentList_28 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
      if (succeeded)
        succeeded = (ChildList_29 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
      if (succeeded)
        *STATE_VARIABLE_OutputProf_10 = STATE_VARIABLE_OutputProf_0_9;
      else
      {
        MR_Word TypeCtorInfo_52_59;
        ...
        if ((Parents_72 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
          OutputParentList_42 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
        else
        {
          MR_Word TypeCtorInfo_21_88 = (MR_Word) &mercury__builtin__builtin__type_ctor_info_int_0;
          MR_Word TypeCtorInfo_22_89 = (MR_Word) &output_prof_info__output_prof_info__type_ctor_info_parent_0;
          MR_Word Output0_85;
          MR_Word Output_86;

          mercury__rbtree__init_1_p_0(TypeCtorInfo_21_88, TypeCtorInfo_22_89, &Output0_85);
          ...
          mercury__rbtree__values_2_p_0(TypeCtorInfo_21_88, TypeCtorInfo_22_89, Output_86, &OutputParentList_42);
        }
        ...
        TypeCtorInfo_52_59 = (MR_Word) &mercury__builtin__builtin__type_ctor_info_string_0;
        mercury__map__det_insert_4_p_0(TypeCtorInfo_52_59, (MR_Word) &output_prof_info__output_prof_info__type_ctor_info_output_prof_0, ((MR_Box) (LabelName_24)), ((MR_Box) (OutputProfNode_46)), InfoMap0_33, &InfoMap_47);
        mercury__rbtree__insert_duplicate_4_p_0((MR_Word) &mercury__builtin__builtin__type_ctor_info_float_0, TypeCtorInfo_52_59, MR_box_float(DescPercentage_38), ((MR_Box) (LabelName_24)), CallTree0_34, &CallTree_48);
        {
        ...
        mercury__rbtree__insert_duplicate_4_p_0((MR_Word) &generate_output__generate_output__type_ctor_info_flat_key_0, TypeCtorInfo_52_59, ((MR_Box) (Var_57)), ((MR_Box) (LabelName_24)), FlatTree0_35, &FlatTree_49);
        {
          MR_Word base;
          base = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL);
  ...
  MR_Word * HeadVar__6_6)
{
  ...
  else
  {
    ...
    TypeCtorInfo_22_22 = (MR_Word) &output_prof_info__output_prof_info__type_ctor_info_child_0;
    mercury__rbtree__init_1_p_0(TypeCtorInfo_21_21, TypeCtorInfo_22_22, &Output0_18);
    generate_output__process_prof_node_children_2_4_p_0(Children_17, Prof_4, Output0_18, &Output_19);
    mercury__rbtree__values_2_p_0(TypeCtorInfo_21_21, TypeCtorInfo_22_22, Output_19, HeadVar__5_5);
  }
}
  ...
  while (MR_TRUE)
  {
    /* tailcall optimized into a loop */
    {
      ...
      else
      {
        ...
        /* direct tailcall eliminated */
        {
          MR_Word next_value_of_HeadVar__1_1 = PNs_10;
          MR_Word next_value_of_STATE_VARIABLE_Output_0_3 = STATE_VARIABLE_Output_40_40;
  ...
  while (MR_TRUE)
  {
    /* tailcall optimized into a loop */
    {
      ...
      else
      {
        ...
        /* direct tailcall eliminated */
        {
          MR_Word next_value_of_HeadVar__1_1 = PNs_16;
          MR_Word next_value_of_STATE_VARIABLE_Output_0_6 = STATE_VARIABLE_Output_33_33;
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          MR_Word OC0_23;
          MR_Word Parent_24;
          MR_Integer STATE_VARIABLE_TotalCalls_28_28 = (STATE_VARIABLE_TotalCalls_0_4 - Calls_21);
