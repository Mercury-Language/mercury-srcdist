...
MR_decl_label5(__Compare___generate_output__profiling_0_0, 3,2,5,9,38)
...
MR_STRING_CTOR_ADDR,
MR_CTOR0_ADDR(output_prof_info, output_prof)
}
},
{
{
MR_CTOR_ADDR(rbtree, rbtree, 2),
MR_FLOAT_CTOR_ADDR,
MR_STRING_CTOR_ADDR
}
},
...
{
MR_CTOR_ADDR(rbtree, rbtree, 2),
MR_CTOR0_ADDR(generate_output, flat_key),
MR_STRING_CTOR_ADDR
}
},
};
...
const MR_DuArgLocn mercury_data_generate_output__field_locns_flat_key_0_0[] = {
	{ 0, 0, -1 },
	{ 2, 0, 0 },
};
...
static const MR_DuFunctorDesc mercury_data_generate_output__du_functor_desc_flat_key_0_0 = {
	...
	NULL,
	mercury_data_generate_output__field_locns_flat_key_0_0,
	NULL
};
...
MR_def_label(generate_output__process_prof_node_parents_3_7_0,9)
	...
	* (MR_Float *) &(MR_tfield(0, MR_tempr1, 2)) = (MR_tempf2 * (MR_Float) 0.0000000000000000);
	MR_tempf3 = MR_float_from_dword_ptr(&MR_sv(4));
	* (MR_Float *) &(MR_tfield(0, MR_tempr1, 4)) = (MR_tempf3 * (MR_Float) 0.0000000000000000);
	MR_tempr4 = MR_sv(11);
...
MR_def_label(generate_output__process_prof_node_parents_3_7_0,13)
	...
	MR_tempf2 = MR_float_from_dword_ptr(&MR_sv(2));
	MR_tempf3 = MR_f(1);
	* (MR_Float *) &(MR_tfield(0, MR_tempr1, 2)) = (MR_tempf2 * MR_tempf3);
	MR_tempf4 = MR_float_from_dword_ptr(&MR_sv(4));
	* (MR_Float *) &(MR_tfield(0, MR_tempr1, 4)) = (MR_tempf4 * MR_tempf3);
	MR_tempr5 = MR_sv(11);
...
MR_def_label(generate_output__process_prof_node_parents_3_7_0,16)
	...
	MR_f(3) = MR_float_from_dword_ptr(&MR_sv(6));
	MR_r2 = MR_sv(7);
	MR_r3 = MR_tempr1;
...
MR_def_label(generate_output__process_prof_node_children_2_4_0,14)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	* (MR_Float *) &MR_sv(12) = (MR_f(1) + MR_float_from_dword_ptr(&MR_sv(12)));
	MR_r1 = MR_sv(5);
	MR_np_call_localret_ent(fn__float__float_1_0,
...
MR_def_label(generate_output__process_prof_node_children_2_4_0,17)
	...
	MR_Float MR_tempf1;
	MR_tempf1 = MR_f(1);
	MR_f(1) = MR_float_from_dword_ptr(&MR_sv(17));
	MR_f(2) = MR_tempf1;
	}
	MR_np_call_localret_ent(fn__f_102_108_111_97_116_95_95_47_2_0,
...
MR_def_label(generate_output__process_prof_node_children_2_4_0,21)
	...
	MR_tempf4 = MR_float_from_dword_ptr(&MR_sv(15));
	* (MR_Float *) &(MR_tfield(0, MR_tempr1, 2)) = ((MR_tempf2 * MR_tempf3) * MR_tempf4);
	MR_tempf5 = MR_float_from_dword_ptr(&MR_sv(12));
	* (MR_Float *) &(MR_tfield(0, MR_tempr1, 4)) = ((MR_tempf5 * MR_tempf3) * MR_tempf4);
	MR_tempr6 = MR_sv(5);
...
MR_def_label(generate_output__process_prof_node_4_0,13)
	...
	* (MR_Float *) &MR_sv(12) = (MR_Float) 0.0000000000000000;
	MR_f(3) = MR_float_from_dword_ptr(&MR_sv(14));
	MR_tempf2 = MR_f(1);
	* (MR_Float *) &MR_sv(14) = (MR_tempf2 * MR_tempf1);
	* (MR_Float *) &MR_sv(17) = ((MR_tempf2 + MR_f(3)) * MR_tempf1);
...
MR_def_label(generate_output__process_prof_node_4_0,14)
	...
	* (MR_Float *) &MR_sv(20) = MR_f(1);
	MR_f(1) = (MR_f(1) + MR_float_from_dword_ptr(&MR_sv(14)));
	MR_f(2) = MR_float_from_dword_ptr(&MR_sv(23));
	MR_np_call_localret_ent(fn__f_102_108_111_97_116_95_95_47_2_0,
...
MR_def_label(generate_output__process_prof_node_4_0,16)
	...
	{
	MR_Float MR_tempf1;
	MR_tempf1 = MR_float_from_dword_ptr(&MR_sv(23));
	* (MR_Float *) &MR_sv(23) = (MR_f(1) * (MR_Float) 100.00000000000000);
...
MR_def_label(generate_output__process_prof_node_4_0,17)
	...
	MR_Float MR_tempf1, MR_tempf2, MR_tempf3;
	MR_tempf1 = MR_float_from_dword_ptr(&MR_sv(12));
	* (MR_Float *) &MR_sv(12) = (MR_f(1) * (MR_Float) 100.00000000000000);
	MR_tempf2 = MR_float_from_dword_ptr(&MR_sv(14));
	MR_tempf3 = MR_float_from_dword_ptr(&MR_sv(20));
	* (MR_Float *) &MR_sv(14) = (MR_tempf3 * MR_tempf1);
	* (MR_Float *) &MR_sv(17) = ((MR_tempf3 + MR_tempf2) * MR_tempf1);
	}
...
MR_def_label(generate_output__process_prof_node_4_0,23)
	...
	MR_f(3) = MR_float_from_dword_ptr(&MR_sv(27));
	MR_r2 = MR_sv(1);
	MR_r3 = MR_tempr1;
	}
...
MR_def_label(generate_output__process_prof_node_4_0,26)
	...
	MR_tempf2 = MR_float_from_dword_ptr(&MR_sv(23));
	* (MR_Float *) &(MR_tfield(0, MR_tempr1, 2)) = MR_tempf2;
	MR_tempf3 = MR_float_from_dword_ptr(&MR_sv(12));
	* (MR_Float *) &(MR_tfield(0, MR_tempr1, 4)) = MR_tempf3;
	MR_tempf4 = MR_float_from_dword_ptr(&MR_sv(14));
	* (MR_Float *) &(MR_tfield(0, MR_tempr1, 6)) = MR_tempf4;
	MR_tempf5 = MR_float_from_dword_ptr(&MR_sv(17));
	* (MR_Float *) &(MR_tfield(0, MR_tempr1, 8)) = MR_tempf5;
	MR_tfield(0, MR_tempr1, 10) = MR_sv(5);
	MR_tfield(0, MR_tempr1, 11) = MR_sv(6);
	MR_tfield(0, MR_tempr1, 12) = MR_sv(24);
...
MR_def_label(generate_output__process_prof_node_4_0,29)
	...
	MR_r3 = MR_tempr1;
	MR_tempf2 = MR_float_from_dword_ptr(&MR_sv(12));
...
MR_BEGIN_MODULE(generate_output_module14)
	...
	MR_init_label5(__Compare___generate_output__profiling_0_0,3,2,5,9,38)
MR_BEGIN_CODE
...
MR_def_label(__Compare___generate_output__profiling_0_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___generate_output__profiling_0_0_i38);
	}
	MR_r1 = (MR_Word) MR_TAG_COMMON(0,0,1);
	MR_r2 = MR_sv(1);
	MR_r3 = MR_sv(3);
...
MR_def_label(__Compare___generate_output__profiling_0_0,38)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(5);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
...
void mercury__generate_output__write_out_proc_statics(FILE *deep_fp, FILE *procrep_fp)
{
	MR_write_out_module_proc_reps_start(procrep_fp, &mercury_data__module_layout__generate_output);
