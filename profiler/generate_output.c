...
#line 28 "generate_output.c"
#line 536 "../library/io.int"
#include "time.mh"

#line 32 "generate_output.c"
#line 537 "../library/io.int"
#include "string.mh"

#line 36 "generate_output.c"
#line 31 "../library/bitmap.int2"
#include "bitmap.mh"

#line 40 "generate_output.c"
#line 33 "../library/array.int2"
#include "array.mh"

#line 44 "generate_output.c"
#line 45 "generate_output.c"
#include "generate_output.mh"

#line 48 "generate_output.c"
#line 49 "generate_output.c"
#ifndef GENERATE_OUTPUT_DECL_GUARD
#define GENERATE_OUTPUT_DECL_GUARD

#line 53 "generate_output.c"
#line 54 "generate_output.c"

#endif
#line 57 "generate_output.c"
...
MR_decl_label10(generate_output__generate_prof_output_5_0, 2,3,4,5,6,7,9,10,11,12)
MR_decl_label3(generate_output__generate_prof_output_5_0, 13,14,15)
MR_decl_label10(generate_output__process_prof_node_4_0, 2,5,6,7,37,8,11,12,13,14)
MR_decl_label10(generate_output__process_prof_node_4_0, 16,17,18,19,20,22,23,24,25,21)
MR_decl_label4(generate_output__process_prof_node_4_0, 26,28,29,31)
MR_decl_label5(generate_output__process_prof_node_children_6_0, 18,4,5,6,7)
MR_decl_label10(generate_output__process_prof_node_children_2_4_0, 35,3,4,5,7,6,9,10,11,12)
MR_decl_label8(generate_output__process_prof_node_children_2_4_0, 13,14,15,16,17,19,21,23)
MR_decl_label8(generate_output__process_prof_node_list_7_0, 18,3,5,6,7,8,4,9)
MR_decl_label10(generate_output__process_prof_node_parents_3_7_0, 28,3,4,6,5,8,9,10,13,16)
MR_decl_label7(generate_output__remove_child_cycle_members_5_0, 41,4,6,9,8,5,15)
MR_decl_label7(generate_output__remove_cycle_members_7_0, 41,4,6,9,8,5,15)
...
MR_BEGIN_MODULE(generate_output_module0)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__fn__generate_output__construct_name_1_0);
...
MR_BEGIN_MODULE(generate_output_module1)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__generate_output__remove_cycle_members_7_0);
	MR_init_label7(generate_output__remove_cycle_members_7_0,41,4,6,9,8,5,15)
MR_BEGIN_CODE
...
MR_def_static(generate_output__remove_cycle_members_7_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
		MR_GOTO_LAB(generate_output__remove_cycle_members_7_0_i41);
	}
	MR_r1 = MR_r4;
	MR_r2 = (MR_Word) MR_tbmkword(0, 0);
	MR_r3 = (MR_Word) MR_tbmkword(0, 0);
	MR_proceed();
MR_def_label(generate_output__remove_cycle_members_7_0,41)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(8);
...
MR_BEGIN_MODULE(generate_output_module2)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__fn__generate_output__checked_float_divide_2_0);
...
MR_BEGIN_MODULE(generate_output_module3)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__generate_output__process_prof_node_parents_3_7_0);
	MR_init_label10(generate_output__process_prof_node_parents_3_7_0,28,3,4,6,5,8,9,10,13,16)
MR_BEGIN_CODE
...
MR_def_label(generate_output__process_prof_node_parents_3_7_0,9)
	...
	MR_tfield(0, MR_tempr1, 2) = MR_float_to_word((MR_float_from_dword_ptr(&MR_sv(2)) * (MR_Float) 0.0000000000000000));
	MR_tfield(0, MR_tempr1, 3) = MR_float_to_word((MR_float_from_dword_ptr(&MR_sv(4)) * (MR_Float) 0.0000000000000000));
	MR_tempr2 = MR_sv(11);
...
MR_def_label(generate_output__process_prof_node_parents_3_7_0,13)
	...
	MR_tfield(0, MR_tempr1, 0) = MR_sv(10);
	MR_tfield(0, MR_tempr1, 1) = MR_sv(12);
	MR_tfield(0, MR_tempr1, 2) = MR_float_to_word((MR_float_from_dword_ptr(&MR_sv(2)) * MR_word_to_float(MR_r1)));
	MR_tfield(0, MR_tempr1, 3) = MR_float_to_word((MR_float_from_dword_ptr(&MR_sv(4)) * MR_word_to_float(MR_r1)));
	MR_tempr2 = MR_sv(11);
	MR_tfield(0, MR_tempr1, 4) = MR_tempr2;
	MR_r5 = MR_sv(8);
	MR_r3 = MR_tempr2;
...
MR_def_label(generate_output__process_prof_node_parents_3_7_0,16)
	...
	MR_r3 = MR_float_to_word(MR_float_from_dword_ptr(&MR_sv(4)));
	MR_r4 = MR_float_to_word(MR_float_from_dword_ptr(&MR_sv(6)));
	MR_r5 = MR_sv(7);
	MR_r6 = MR_tempr1;
...
MR_BEGIN_MODULE(generate_output_module4)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__generate_output__remove_child_cycle_members_5_0);
	MR_init_label7(generate_output__remove_child_cycle_members_5_0,41,4,6,9,8,5,15)
MR_BEGIN_CODE
...
MR_def_static(generate_output__remove_child_cycle_members_5_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
		MR_GOTO_LAB(generate_output__remove_child_cycle_members_5_0_i41);
	}
	MR_r1 = (MR_Word) MR_tbmkword(0, 0);
	MR_r2 = (MR_Word) MR_tbmkword(0, 0);
	MR_proceed();
MR_def_label(generate_output__remove_child_cycle_members_5_0,41)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(7);
...
MR_BEGIN_MODULE(generate_output_module5)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__generate_output__process_prof_node_children_2_4_0);
	MR_init_label10(generate_output__process_prof_node_children_2_4_0,35,3,4,5,7,6,9,10,11,12)
	MR_init_label8(generate_output__process_prof_node_children_2_4_0,13,14,15,16,17,19,21,23)
MR_BEGIN_CODE
...
MR_def_label(generate_output__process_prof_node_children_2_4_0,14)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	* (MR_Float *) &MR_sv(12) = (MR_word_to_float(MR_r1) + MR_float_from_dword_ptr(&MR_sv(12)));
	MR_r1 = MR_sv(5);
	MR_np_call_localret_ent(fn__float__float_1_0,
...
MR_def_label(generate_output__process_prof_node_children_2_4_0,16)
	...
	MR_r1 = MR_sv(13);
	* (MR_Float *) &MR_sv(15) = (MR_Float) 0.0000000000000000;
	MR_np_call_localret_ent(fn__float__float_1_0,
...
MR_def_label(generate_output__process_prof_node_children_2_4_0,17)
	...
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
	MR_r1 = MR_float_to_word(MR_float_from_dword_ptr(&MR_sv(17)));
	MR_r2 = MR_tempr1;
	}
	MR_np_call_localret_ent(fn__f_102_108_111_97_116_95_95_47_2_0,
...
MR_def_label(generate_output__process_prof_node_children_2_4_0,21)
	...
	MR_tempf2 = MR_float_from_dword_ptr(&MR_sv(7));
	MR_tempf3 = MR_float_from_dword_ptr(&MR_sv(15));
	MR_tfield(0, MR_tempr1, 2) = MR_float_to_word(((MR_word_to_float(MR_r1) * MR_tempf2) * MR_tempf3));
	MR_tfield(0, MR_tempr1, 3) = MR_float_to_word(((MR_float_from_dword_ptr(&MR_sv(12)) * MR_tempf2) * MR_tempf3));
	MR_tempr4 = MR_sv(5);
...
MR_BEGIN_MODULE(generate_output_module6)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__generate_output__process_prof_node_children_6_0);
	MR_init_label5(generate_output__process_prof_node_children_6_0,18,4,5,6,7)
MR_BEGIN_CODE
...
MR_def_static(generate_output__process_prof_node_children_6_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
		MR_GOTO_LAB(generate_output__process_prof_node_children_6_0_i18);
	}
	MR_r1 = (MR_Word) MR_tbmkword(0, 0);
	MR_r2 = (MR_Word) MR_tbmkword(0, 0);
	MR_proceed();
MR_def_label(generate_output__process_prof_node_children_6_0,18)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(6);
...
MR_BEGIN_MODULE(generate_output_module7)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__generate_output__process_prof_node_4_0);
	MR_init_label10(generate_output__process_prof_node_4_0,2,5,6,7,37,8,11,12,13,14)
	MR_init_label10(generate_output__process_prof_node_4_0,16,17,18,19,20,22,23,24,25,21)
	MR_init_label4(generate_output__process_prof_node_4_0,26,28,29,31)
MR_BEGIN_CODE
...
MR_def_label(generate_output__process_prof_node_4_0,6)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	* (MR_Float *) &MR_sv(23) = MR_word_to_float(MR_r1);
	MR_r1 = MR_sv(21);
...
MR_def_label(generate_output__process_prof_node_4_0,8)
	...
	MR_sv(3) = MR_r2;
	MR_sv(10) = MR_r3;
	* (MR_Float *) &MR_sv(14) = MR_word_to_float(MR_r4);
	MR_sv(15) = MR_r5;
	MR_sv(4) = MR_r6;
	MR_sv(5) = MR_r7;
	MR_sv(6) = MR_r8;
...
MR_def_label(generate_output__process_prof_node_4_0,13)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if ((MR_float_from_dword_ptr(&MR_sv(23)) != (MR_Float) 0.0000000000000000)) {
	...
	* (MR_Float *) &MR_sv(20) = MR_tempf1;
	MR_r1 = MR_sv(15);
	MR_r4 = MR_sv(5);
	* (MR_Float *) &MR_sv(23) = (MR_Float) 0.0000000000000000;
	MR_tempr2 = MR_float_to_word(MR_float_from_dword_ptr(&MR_sv(12)));
	MR_r5 = MR_tempr2;
	* (MR_Float *) &MR_sv(12) = (MR_Float) 0.0000000000000000;
	MR_r6 = MR_float_to_word(MR_float_from_dword_ptr(&MR_sv(14)));
	* (MR_Float *) &MR_sv(14) = (MR_tempf1 * MR_word_to_float(MR_tempr2));
	* (MR_Float *) &MR_sv(17) = ((MR_tempf1 + MR_word_to_float(MR_r6)) * MR_word_to_float(MR_tempr2));
...
MR_def_label(generate_output__process_prof_node_4_0,14)
	...
	* (MR_Float *) &MR_sv(20) = MR_word_to_float(MR_r1);
	MR_r1 = MR_float_to_word((MR_word_to_float(MR_r1) + MR_float_from_dword_ptr(&MR_sv(14))));
	MR_r2 = MR_float_to_word(MR_float_from_dword_ptr(&MR_sv(23)));
	MR_np_call_localret_ent(fn__f_102_108_111_97_116_95_95_47_2_0,
...
MR_def_label(generate_output__process_prof_node_4_0,16)
	...
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_float_to_word(MR_float_from_dword_ptr(&MR_sv(23)));
	* (MR_Float *) &MR_sv(23) = (MR_word_to_float(MR_r1) * (MR_Float) 100.00000000000000);
	MR_r1 = MR_float_to_word(MR_float_from_dword_ptr(&MR_sv(20)));
	MR_r2 = MR_tempr1;
	}
	MR_np_call_localret_ent(fn__f_102_108_111_97_116_95_95_47_2_0,
...
MR_def_label(generate_output__process_prof_node_4_0,17)
	...
	MR_r4 = MR_sv(5);
	MR_tempr2 = MR_float_to_word(MR_float_from_dword_ptr(&MR_sv(12)));
	* (MR_Float *) &MR_sv(12) = (MR_word_to_float(MR_tempr1) * (MR_Float) 100.00000000000000);
	MR_tempr1 = MR_float_to_word(MR_float_from_dword_ptr(&MR_sv(14)));
	MR_tempf3 = MR_float_from_dword_ptr(&MR_sv(20));
	* (MR_Float *) &MR_sv(14) = (MR_tempf3 * MR_word_to_float(MR_tempr2));
	* (MR_Float *) &MR_sv(17) = ((MR_tempf3 + MR_word_to_float(MR_tempr1)) * MR_word_to_float(MR_tempr2));
	}
...
MR_def_label(generate_output__process_prof_node_4_0,22)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	* (MR_Float *) &MR_sv(27) = MR_word_to_float(MR_r1);
	MR_sv(28) = (MR_Word) MR_INT_CTOR_ADDR;
	MR_sv(29) = (MR_Word) MR_CTOR0_ADDR(output_prof_info, parent);
	MR_r1 = MR_sv(28);
	MR_r2 = MR_sv(29);
	MR_np_call_localret_ent(rbtree__init_1_0,
...
MR_def_label(generate_output__process_prof_node_4_0,23)
	...
	MR_r3 = MR_float_to_word(MR_float_from_dword_ptr(&MR_sv(17)));
	MR_r4 = MR_float_to_word(MR_float_from_dword_ptr(&MR_sv(27)));
	MR_r5 = MR_sv(1);
	MR_r6 = MR_tempr1;
	}
...
MR_def_label(generate_output__process_prof_node_4_0,26)
	...
	MR_tfield(0, MR_tempr1, 2) = MR_float_to_word(MR_float_from_dword_ptr(&MR_sv(23)));
	MR_tfield(0, MR_tempr1, 3) = MR_float_to_word(MR_float_from_dword_ptr(&MR_sv(12)));
	MR_tfield(0, MR_tempr1, 4) = MR_float_to_word(MR_float_from_dword_ptr(&MR_sv(14)));
	MR_tfield(0, MR_tempr1, 5) = MR_float_to_word(MR_float_from_dword_ptr(&MR_sv(17)));
...
MR_def_label(generate_output__process_prof_node_4_0,28)
	...
	MR_r2 = MR_sv(24);
	MR_r3 = MR_float_to_word(MR_float_from_dword_ptr(&MR_sv(23)));
	MR_r4 = MR_sv(2);
	MR_r5 = MR_sv(8);
	MR_np_call_localret_ent(rbtree__insert_duplicate_4_0,
...
MR_def_label(generate_output__process_prof_node_4_0,29)
	...
	MR_r3 = MR_tempr1;
	MR_tfield(0, MR_tempr1, 0) = MR_float_to_word(MR_float_from_dword_ptr(&MR_sv(12)));
...
MR_BEGIN_MODULE(generate_output_module8)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__generate_output__process_prof_node_list_7_0);
...
MR_BEGIN_MODULE(generate_output_module9)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__generate_output__assign_index_numbers_2_4_0);
...
MR_BEGIN_MODULE(generate_output_module10)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__generate_output__generate_prof_output_5_0);
	MR_init_label10(generate_output__generate_prof_output_5_0,2,3,4,5,6,7,9,10,11,12)
	MR_init_label3(generate_output__generate_prof_output_5_0,13,14,15)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(generate_output_module11)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury____Unify___generate_output__flat_key_0_0);
...
MR_BEGIN_MODULE(generate_output_module12)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury____Compare___generate_output__flat_key_0_0);
...
MR_BEGIN_MODULE(generate_output_module13)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury____Unify___generate_output__profiling_0_0);
...
MR_BEGIN_MODULE(generate_output_module14)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury____Compare___generate_output__profiling_0_0);
...
void mercury__generate_output__init_threadscope_string_table(void);
#endif
