...
MR_decl_label3(generate_output__assign_index_numbers_2_4_0, 11,4,3)
MR_decl_label8(generate_output__generate_prof_output_5_0, 2,3,4,5,6,7,8,9)
MR_decl_label5(generate_output__generate_prof_output_5_0, 10,11,12,13,14)
MR_decl_label8(generate_output__process_prof_node_4_0, 2,5,6,7,34,8,11,12)
MR_decl_label8(generate_output__process_prof_node_4_0, 13,14,16,17,18,19,20,22)
MR_decl_label8(generate_output__process_prof_node_4_0, 23,24,25,21,26,27,28,29)
MR_decl_label5(generate_output__process_prof_node_children_6_0, 15,4,5,6,7)
MR_decl_label8(generate_output__process_prof_node_children_2_4_0, 37,4,5,7,6,9,10,11)
MR_decl_label8(generate_output__process_prof_node_children_2_4_0, 12,13,14,15,16,17,19,21)
MR_decl_label2(generate_output__process_prof_node_children_2_4_0, 22,3)
MR_decl_label8(generate_output__process_prof_node_list_7_0, 20,5,6,7,8,4,9,3)
MR_decl_label8(generate_output__process_prof_node_parents_3_7_0, 29,4,6,5,8,9,10,12)
MR_decl_label2(generate_output__process_prof_node_parents_3_7_0, 14,3)
MR_decl_label7(generate_output__remove_child_cycle_members_5_0, 4,6,9,8,5,12,3)
MR_decl_label7(generate_output__remove_cycle_members_7_0, 4,6,9,8,5,12,3)
MR_decl_label1(fn__generate_output__checked_float_divide_2_0, 13)
MR_decl_label3(fn__generate_output__construct_name_1_0, 4,5,3)
MR_decl_label1(__Unify___generate_output__flat_key_0_0, 1)
MR_decl_label3(__Unify___generate_output__profiling_0_0, 2,4,1)
MR_decl_label2(__Compare___generate_output__flat_key_0_0, 3,7)
MR_decl_label3(__Compare___generate_output__profiling_0_0, 3,7,12)
...
MR_BEGIN_MODULE(generate_output_module0)
	...
	MR_init_label3(fn__generate_output__construct_name_1_0,4,5,3)
MR_BEGIN_CODE
...
MR_def_static(fn__generate_output__construct_name_1_0)
	...
	if (MR_LTAGS_TEST(MR_r1,0,0)) {
		MR_GOTO_LAB(fn__generate_output__construct_name_1_0_i3);
	}
	MR_incr_sp(2);
...
MR_def_label(fn__generate_output__construct_name_1_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_BEGIN_MODULE(generate_output_module1)
	...
	MR_init_label7(generate_output__remove_cycle_members_7_0,4,6,9,8,5,12,3)
MR_BEGIN_CODE
...
MR_def_static(generate_output__remove_cycle_members_7_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TEST(MR_r1,0,0)) {
		MR_GOTO_LAB(generate_output__remove_cycle_members_7_0_i3);
	}
	MR_incr_sp(8);
...
MR_def_label(generate_output__remove_cycle_members_7_0,8)
	...
	MR_r4 = MR_sv(3);
	MR_np_localcall_lab(generate_output__remove_cycle_members_7_0,
		generate_output__remove_cycle_members_7_0_i12);
MR_def_label(generate_output__remove_cycle_members_7_0,5)
	...
	MR_np_localcall_lab(generate_output__remove_cycle_members_7_0,
		generate_output__remove_cycle_members_7_0_i12);
MR_def_label(generate_output__remove_cycle_members_7_0,12)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
...
MR_def_label(generate_output__remove_cycle_members_7_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_r4;
...
MR_BEGIN_MODULE(generate_output_module3)
	...
	MR_init_label8(generate_output__process_prof_node_parents_3_7_0,29,4,6,5,8,9,10,12)
	MR_init_label2(generate_output__process_prof_node_parents_3_7_0,14,3)
MR_BEGIN_CODE
...
MR_def_label(generate_output__process_prof_node_parents_3_7_0,29)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TEST(MR_r1,0,0)) {
...
MR_def_label(generate_output__process_prof_node_parents_3_7_0,9)
	...
	MR_np_call_localret_ent(rbtree__insert_duplicate_4_0,
		generate_output__process_prof_node_parents_3_7_0_i14);
MR_def_label(generate_output__process_prof_node_parents_3_7_0,10)
	...
	MR_np_call_localret_ent(fn__f_102_108_111_97_116_95_95_47_2_0,
		generate_output__process_prof_node_parents_3_7_0_i12);
MR_def_label(generate_output__process_prof_node_parents_3_7_0,12)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tag_alloc_heap(MR_tempr1, 0, (MR_Integer) 5);
	...
	MR_tfield(0, MR_tempr1, 0) = MR_sv(7);
	MR_tfield(0, MR_tempr1, 1) = MR_sv(9);
	MR_tfield(0, MR_tempr1, 2) = MR_float_to_word((MR_word_to_float(MR_sv(1)) * MR_word_to_float(MR_r1)));
	MR_tfield(0, MR_tempr1, 3) = MR_float_to_word((MR_word_to_float(MR_sv(2)) * MR_word_to_float(MR_r1)));
	MR_tempr2 = MR_sv(8);
	MR_tfield(0, MR_tempr1, 4) = MR_tempr2;
	MR_r3 = MR_sv(5);
	MR_r4 = MR_tempr2;
	...
	MR_np_call_localret_ent(rbtree__insert_duplicate_4_0,
		generate_output__process_prof_node_parents_3_7_0_i14);
MR_def_label(generate_output__process_prof_node_parents_3_7_0,14)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r6 = MR_r1;
	MR_r1 = MR_sv(6);
	MR_r2 = MR_sv(1);
	...
	MR_GOTO_LAB(generate_output__process_prof_node_parents_3_7_0_i29);
...
MR_BEGIN_MODULE(generate_output_module4)
	...
	MR_init_label7(generate_output__remove_child_cycle_members_5_0,4,6,9,8,5,12,3)
MR_BEGIN_CODE
...
MR_def_static(generate_output__remove_child_cycle_members_5_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TEST(MR_r1,0,0)) {
		MR_GOTO_LAB(generate_output__remove_child_cycle_members_5_0_i3);
	}
	MR_incr_sp(7);
...
MR_def_label(generate_output__remove_child_cycle_members_5_0,8)
	...
	MR_r3 = MR_sv(2);
	MR_np_localcall_lab(generate_output__remove_child_cycle_members_5_0,
		generate_output__remove_child_cycle_members_5_0_i12);
MR_def_label(generate_output__remove_child_cycle_members_5_0,5)
	...
	MR_np_localcall_lab(generate_output__remove_child_cycle_members_5_0,
		generate_output__remove_child_cycle_members_5_0_i12);
MR_def_label(generate_output__remove_child_cycle_members_5_0,12)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 2);
...
MR_def_label(generate_output__remove_child_cycle_members_5_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_BEGIN_MODULE(generate_output_module5)
	...
	MR_init_label8(generate_output__process_prof_node_children_2_4_0,37,4,5,7,6,9,10,11)
	MR_init_label8(generate_output__process_prof_node_children_2_4_0,12,13,14,15,16,17,19,21)
	MR_init_label2(generate_output__process_prof_node_children_2_4_0,22,3)
MR_BEGIN_CODE
...
MR_def_label(generate_output__process_prof_node_children_2_4_0,37)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TEST(MR_r1,0,0)) {
...
MR_def_label(generate_output__process_prof_node_children_2_4_0,21)
	...
	MR_np_call_localret_ent(rbtree__insert_duplicate_4_0,
		generate_output__process_prof_node_children_2_4_0_i22);
MR_def_label(generate_output__process_prof_node_children_2_4_0,22)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r3 = MR_r1;
	MR_r1 = MR_sv(3);
	MR_r2 = MR_sv(1);
	MR_succip_word = MR_sv(12);
	MR_GOTO_LAB(generate_output__process_prof_node_children_2_4_0_i37);
...
MR_BEGIN_MODULE(generate_output_module7)
	...
	MR_init_label8(generate_output__process_prof_node_4_0,2,5,6,7,34,8,11,12)
	MR_init_label8(generate_output__process_prof_node_4_0,13,14,16,17,18,19,20,22)
	MR_init_label8(generate_output__process_prof_node_4_0,23,24,25,21,26,27,28,29)
MR_BEGIN_CODE
...
MR_def_label(generate_output__process_prof_node_4_0,2)
	...
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(generate_output__process_prof_node_4_0_i34);
	}
	MR_r1 = MR_sv(2);
	MR_np_call_localret_ent(prof_info__prof_get_entire_7_0,
...
MR_def_label(generate_output__process_prof_node_4_0,34)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(3);
...
MR_def_label(generate_output__process_prof_node_4_0,26)
	...
	MR_np_call_localret_ent(map__det_insert_4_0,
		generate_output__process_prof_node_4_0_i27);
MR_def_label(generate_output__process_prof_node_4_0,27)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r4 = MR_sv(1);
	MR_sv(1) = MR_r1;
...
MR_BEGIN_MODULE(generate_output_module8)
	...
	MR_init_label8(generate_output__process_prof_node_list_7_0,20,5,6,7,8,4,9,3)
MR_BEGIN_CODE
...
MR_def_label(generate_output__process_prof_node_list_7_0,20)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TEST(MR_r1,0,0)) {
...
MR_def_label(generate_output__process_prof_node_list_7_0,9)
	...
	MR_GOTO_LAB(generate_output__process_prof_node_list_7_0_i20);
...
MR_BEGIN_MODULE(generate_output_module9)
	...
	MR_init_label3(generate_output__assign_index_numbers_2_4_0,11,4,3)
MR_BEGIN_CODE
...
MR_def_label(generate_output__assign_index_numbers_2_4_0,11)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TEST(MR_r1,0,0)) {
...
MR_def_label(generate_output__assign_index_numbers_2_4_0,4)
	...
	MR_GOTO_LAB(generate_output__assign_index_numbers_2_4_0_i11);
...
MR_BEGIN_MODULE(generate_output_module10)
	...
	MR_init_label8(generate_output__generate_prof_output_5_0,2,3,4,5,6,7,8,9)
	MR_init_label5(generate_output__generate_prof_output_5_0,10,11,12,13,14)
MR_BEGIN_CODE
...
MR_def_label(generate_output__generate_prof_output_5_0,7)
	...
	MR_np_call_localret_ent(generate_output__process_prof_node_list_7_0,
		generate_output__generate_prof_output_5_0_i8);
MR_def_label(generate_output__generate_prof_output_5_0,8)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_BEGIN_MODULE(generate_output_module11)
	...
	MR_init_label1(__Unify___generate_output__flat_key_0_0,1)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(generate_output_module12)
	...
	MR_init_label2(__Compare___generate_output__flat_key_0_0,3,7)
MR_BEGIN_CODE
...
MR_def_static(__Compare___generate_output__flat_key_0_0)
	...
	MR_np_call_localret_ent(private_builtin__builtin_compare_float_3_0,
		__Compare___generate_output__flat_key_0_0_i3);
MR_def_label(__Compare___generate_output__flat_key_0_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___generate_output__flat_key_0_0_i7);
	}
	MR_r1 = MR_sv(1);
	MR_r2 = MR_sv(2);
	MR_succip_word = MR_sv(3);
...
MR_def_label(__Compare___generate_output__flat_key_0_0,7)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(3);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
...
MR_BEGIN_MODULE(generate_output_module13)
	...
	MR_init_label3(__Unify___generate_output__profiling_0_0,2,4,1)
MR_BEGIN_CODE
...
MR_def_static(__Unify___generate_output__profiling_0_0)
	...
	MR_np_call_localret_ent(__Unify___tree234__tree234_2_0,
		__Unify___generate_output__profiling_0_0_i2);
MR_def_label(__Unify___generate_output__profiling_0_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
...
MR_BEGIN_MODULE(generate_output_module14)
	...
	MR_init_label3(__Compare___generate_output__profiling_0_0,3,7,12)
MR_BEGIN_CODE
...
MR_def_static(__Compare___generate_output__profiling_0_0)
	...
	MR_np_call_localret_ent(__Compare___tree234__tree234_2_0,
		__Compare___generate_output__profiling_0_0_i3);
MR_def_label(__Compare___generate_output__profiling_0_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___generate_output__profiling_0_0_i12);
	}
	MR_r1 = (MR_Word) MR_FLOAT_CTOR_ADDR;
	MR_r2 = (MR_Word) MR_STRING_CTOR_ADDR;
	MR_r3 = MR_sv(1);
	...
	MR_np_call_localret_ent(__Compare___rbtree__rbtree_2_0,
		__Compare___generate_output__profiling_0_0_i7);
MR_def_label(__Compare___generate_output__profiling_0_0,7)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___generate_output__profiling_0_0_i12);
	}
...
MR_def_label(__Compare___generate_output__profiling_0_0,12)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
void mercury__generate_output__write_out_proc_statics(FILE *fp);
#endif
