  ...
  MR_Word HeadVar__2_2)
{
  ...
  else
  {
    ...
    if (succeeded)
    {
      TypeInfo__12_12 = (MR_Word) (&generate_output_scalar_common_1[1]);
      succeeded = mercury__builtin__unify_2_p_0(TypeInfo__12_12, ((MR_Box) (ArgX2_5)), ((MR_Box) (ArgY2_6)));
      if (succeeded)
      {
        TypeInfo__13_13 = (MR_Word) (&generate_output_scalar_common_1[2]);
  ...
  MR_Word * Output_10)
{
  ...
  Var_47 = mercury__map__init_0_f_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0));
  generate_output__assign_index_numbers_2_4_p_0(CallList_27, (MR_Integer) 1, Var_47, IndexMap_9);
  ...
  MR_Word * STATE_VARIABLE_OutputProf_10)
{
  ...
  if (succeeded)
  {
    ...
    {
      MR_Word InfoMap0_27 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_OutputProf_0_9, (MR_Integer) 0))));
      MR_Word CallTree0_28 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_OutputProf_0_9, (MR_Integer) 1))));
      MR_Word FlatTree0_29 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_OutputProf_0_9, (MR_Integer) 2))));
      MR_String Name_30;
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(0), OutputProfNode_40, 0) = ((MR_Box) (Name_30));
        MR_hl_field(MR_mktag(0), OutputProfNode_40, 1) = ((MR_Box) (CycleNum_19));
        MR_hl_field(MR_mktag(0), OutputProfNode_40, 2) = MR_box_float(DescPercentage_32);
        MR_hl_field(MR_mktag(0), OutputProfNode_40, 3) = MR_box_float(FlatPercentage_33);
        MR_hl_field(MR_mktag(0), OutputProfNode_40, 4) = MR_box_float(SelfTime_34);
        MR_hl_field(MR_mktag(0), OutputProfNode_40, 5) = MR_box_float(DescTime_35);
        MR_hl_field(MR_mktag(0), OutputProfNode_40, 6) = ((MR_Box) (TotalCalls_24));
        MR_hl_field(MR_mktag(0), OutputProfNode_40, 7) = ((MR_Box) (SelfCalls_25));
        MR_hl_field(MR_mktag(0), OutputProfNode_40, 8) = ((MR_Box) (OutputParentList_36));
        MR_hl_field(MR_mktag(0), OutputProfNode_40, 9) = ((MR_Box) (OutputChildList_38));
        MR_hl_field(MR_mktag(0), OutputProfNode_40, 10) = ((MR_Box) (OutputCycleParentList_37));
        MR_hl_field(MR_mktag(0), OutputProfNode_40, 11) = ((MR_Box) (OutputCycleChildList_39));
      }
      ...
      mercury__rbtree__insert_duplicate_4_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_float_0), (MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), MR_box_float(DescPercentage_32), ((MR_Box) (LabelName_18)), CallTree0_28, &CallTree_42);
      {
        ...
        MR_hl_field(MR_mktag(0), Var_51, 0) = MR_box_float(FlatPercentage_33);
        MR_hl_field(MR_mktag(0), Var_51, 1) = ((MR_Box) (TotalCalls_24));
      }
      mercury__rbtree__insert_duplicate_4_p_0((MR_Word) (&generate_output__generate_output__type_ctor_info_flat_key_0), (MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), ((MR_Box) (Var_51)), ((MR_Box) (LabelName_18)), FlatTree0_29, &FlatTree_43);
      {
        ...
        *STATE_VARIABLE_OutputProf_10 = base;
        MR_hl_field(MR_mktag(0), base, 0) = ((MR_Box) (InfoMap_41));
        MR_hl_field(MR_mktag(0), base, 1) = ((MR_Box) (CallTree_42));
        MR_hl_field(MR_mktag(0), base, 2) = ((MR_Box) (FlatTree_43));
      }
    }
  }
  else
