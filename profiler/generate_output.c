  ...
  MR_Word * Output_10)
{
  ...
  mercury__rbtree__init_1_p_0((MR_Word) (&generate_output__generate_output__type_ctor_info_flat_key_0), (MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), &FlatTree_40);
  {
    ...
    MR_hl_field(MR_mktag(0), OutputProf0_20, 0) = ((MR_Box) (InfoMap_38));
    MR_hl_field(MR_mktag(0), OutputProf0_20, 1) = ((MR_Box) (CallTree_39));
    MR_hl_field(MR_mktag(0), OutputProf0_20, 2) = ((MR_Box) (FlatTree_40));
  }
