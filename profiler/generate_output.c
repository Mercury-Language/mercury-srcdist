  ...
  MR_Word * Output_10)
{
  ...
  mercury__map__init_1_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&output_prof_info__output_prof_info__type_ctor_info_output_prof_0), &InfoMap_39);
  mercury__rbtree__init_1_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_float_0), (MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), &CallTree_40);
  mercury__rbtree__init_1_p_0((MR_Word) (&generate_output__generate_output__type_ctor_info_flat_key_0), (MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), &FlatTree_41);
  {
    OutputProf0_20 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(MR_mktag(0), OutputProf0_20, 0) = ((MR_Box) (InfoMap_39));
    MR_hl_field(MR_mktag(0), OutputProf0_20, 1) = ((MR_Box) (CallTree_40));
    MR_hl_field(MR_mktag(0), OutputProf0_20, 2) = ((MR_Box) (FlatTree_41));
  }
  ...
  InfoMap_22 = ((MR_Word) ((MR_hl_field(MR_mktag(0), OutputProf_21, (MR_Integer) 0))));
  CallTree_23 = ((MR_Word) ((MR_hl_field(MR_mktag(0), OutputProf_21, (MR_Integer) 1))));
  FlatTree_24 = ((MR_Word) ((MR_hl_field(MR_mktag(0), OutputProf_21, (MR_Integer) 2))));
  ...
  Var_50 = mercury__map__init_0_f_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0));
  generate_output__assign_index_numbers_2_4_p_0(CallList_27, (MR_Integer) 1, Var_50, IndexMap_9);
  FlatList_28 = mercury__list__reverse_1_f_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), FlatList0_26);
  {
    ...
    *Output_10 = base;
    MR_hl_field(MR_mktag(0), base, 0) = ((MR_Box) (InfoMap_22));
    MR_hl_field(MR_mktag(0), base, 1) = ((MR_Box) (CallList_27));
    MR_hl_field(MR_mktag(0), base, 2) = ((MR_Box) (FlatList_28));
  }
}
  ...
  MR_Word * STATE_VARIABLE_OutputProf_6)
{
  while (MR_TRUE)
  {
    ...
    {
      MR_Word PN_19 = ((MR_Word) ((MR_hl_field(MR_mktag(1), HeadVar__2_2, (MR_Integer) 0))));
      MR_Word PNs_20 = ((MR_Word) ((MR_hl_field(MR_mktag(1), HeadVar__2_2, (MR_Integer) 1))));
  ...
  MR_Word * STATE_VARIABLE_OutputProf_10)
{
  ...
  {
    MR_Float Scale_16;
    MR_Integer IntTotalCounts_18;
    MR_Word CycleMap_21;
    MR_Float TotalCounts_22;
    MR_String LabelName_23;
    MR_Integer CycleNum_24;
    MR_Integer Initial_25;
    MR_Float Prop_26;
    MR_Word ParentList_27;
    MR_Word ChildList_28;
    MR_Integer TotalCalls_29;
    MR_Integer SelfCalls_30;
    MR_Word NameList_31;
    MR_String _Units_17;
    MR_Word Var_19;
    MR_Word Var_20;

    prof_info__prof_get_entire_7_p_0(Prof_6, &Scale_16, &_Units_17, &IntTotalCounts_18, &Var_19, &Var_20, &CycleMap_21);
    TotalCounts_22 = mercury__float__float_1_f_0(IntTotalCounts_18);
    prof_info__prof_node_get_entire_pred_10_p_0(ProfNode_5, &LabelName_23, &CycleNum_24, &Initial_25, &Prop_26, &ParentList_27, &ChildList_28, &TotalCalls_29, &SelfCalls_30, &NameList_31);
    succeeded = (ParentList_27 == (MR_Word) ((MR_Unsigned) 0U));
    if (succeeded)
      succeeded = (ChildList_28 == (MR_Word) ((MR_Unsigned) 0U));
    if (succeeded)
      *STATE_VARIABLE_OutputProf_10 = STATE_VARIABLE_OutputProf_0_9;
    else
    {
      MR_Word InfoMap0_32 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_OutputProf_0_9, (MR_Integer) 0))));
      MR_Word CallTree0_33 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_OutputProf_0_9, (MR_Integer) 1))));
      MR_Word FlatTree0_34 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_OutputProf_0_9, (MR_Integer) 2))));
      MR_String Name_35;
      MR_Float InitialFloat_36;
      MR_Float DescPercentage_37;
      MR_Float FlatPercentage_38;
      MR_Float SelfTime_39;
      MR_Float DescTime_40;
      MR_Word OutputParentList_41;
      MR_Word OutputCycleParentList_42;
      MR_Word OutputChildList_43;
      MR_Word OutputCycleChildList_44;
      MR_Word OutputProfNode_45;
      MR_Word InfoMap_46;
      MR_Word CallTree_47;
      MR_Word FlatTree_48;
      MR_String Var_49;
      MR_Float Var_55;
      MR_Word Var_56;
      MR_Integer TotalCalls_69;
      MR_Word Parents_70;
      MR_Float FltTotalCalls_71;

      Var_49 = generate_output__construct_name_1_f_0(NameList_31);
      Name_35 = mercury__string__f_43_43_2_f_0(LabelName_23, Var_49);
      InitialFloat_36 = mercury__float__float_1_f_0(Initial_25);
      succeeded = (TotalCounts_22 == ((MR_Float) 0.0000000000000000));
      if (succeeded)
      {
        DescPercentage_37 = (MR_Float) 0.0000000000000000;
        FlatPercentage_38 = (MR_Float) 0.0000000000000000;
      }
      else
      {
        MR_Float Var_50;
        MR_Float Var_51 = (InitialFloat_36 + Prop_26);
        MR_Float Var_53;

        Var_50 = mercury__float__f_slash_2_f_0(Var_51, TotalCounts_22);
        DescPercentage_37 = (Var_50 * ((MR_Float) 100.00000000000000));
        Var_53 = mercury__float__f_slash_2_f_0(InitialFloat_36, TotalCounts_22);
        FlatPercentage_38 = (Var_53 * ((MR_Float) 100.00000000000000));
      }
      SelfTime_39 = (InitialFloat_36 * Scale_16);
      Var_55 = (InitialFloat_36 + Prop_26);
      DescTime_40 = (Var_55 * Scale_16);
      generate_output__remove_cycle_members_7_p_0(ParentList_27, CycleNum_24, CycleMap_21, TotalCalls_29, &TotalCalls_69, &Parents_70, &OutputCycleParentList_42);
      FltTotalCalls_71 = mercury__float__float_1_f_0(TotalCalls_69);
      if ((Parents_70 == (MR_Word) ((MR_Unsigned) 0U)))
        OutputParentList_41 = (MR_Word) ((MR_Unsigned) 0U);
      else
      {
        MR_Word Output0_83;
        MR_Word Output_84;

        mercury__rbtree__init_1_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0), (MR_Word) (&output_prof_info__output_prof_info__type_ctor_info_parent_0), &Output0_83);
        generate_output__process_prof_node_parents_3_7_p_0(Parents_70, SelfTime_39, DescTime_40, FltTotalCalls_71, CycleMap_21, Output0_83, &Output_84);
        mercury__rbtree__values_2_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0), (MR_Word) (&output_prof_info__output_prof_info__type_ctor_info_parent_0), Output_84, &OutputParentList_41);
      }
      generate_output__process_prof_node_children_6_p_0(ChildList_28, CycleNum_24, CycleMap_21, Prof_6, &OutputChildList_43, &OutputCycleChildList_44);
      {
        OutputProfNode_45 = (MR_Word) MR_new_object(MR_Word, (12 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), OutputProfNode_45, 0) = ((MR_Box) (Name_35));
        MR_hl_field(MR_mktag(0), OutputProfNode_45, 1) = ((MR_Box) (CycleNum_24));
        MR_hl_field(MR_mktag(0), OutputProfNode_45, 2) = MR_box_float(DescPercentage_37);
        MR_hl_field(MR_mktag(0), OutputProfNode_45, 3) = MR_box_float(FlatPercentage_38);
        MR_hl_field(MR_mktag(0), OutputProfNode_45, 4) = MR_box_float(SelfTime_39);
        MR_hl_field(MR_mktag(0), OutputProfNode_45, 5) = MR_box_float(DescTime_40);
        MR_hl_field(MR_mktag(0), OutputProfNode_45, 6) = ((MR_Box) (TotalCalls_29));
        MR_hl_field(MR_mktag(0), OutputProfNode_45, 7) = ((MR_Box) (SelfCalls_30));
        MR_hl_field(MR_mktag(0), OutputProfNode_45, 8) = ((MR_Box) (OutputParentList_41));
        MR_hl_field(MR_mktag(0), OutputProfNode_45, 9) = ((MR_Box) (OutputChildList_43));
        MR_hl_field(MR_mktag(0), OutputProfNode_45, 10) = ((MR_Box) (OutputCycleParentList_42));
        MR_hl_field(MR_mktag(0), OutputProfNode_45, 11) = ((MR_Box) (OutputCycleChildList_44));
      }
      mercury__map__det_insert_4_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&output_prof_info__output_prof_info__type_ctor_info_output_prof_0), ((MR_Box) (LabelName_23)), ((MR_Box) (OutputProfNode_45)), InfoMap0_32, &InfoMap_46);
      mercury__rbtree__insert_duplicate_4_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_float_0), (MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), MR_box_float(DescPercentage_37), ((MR_Box) (LabelName_23)), CallTree0_33, &CallTree_47);
      {
        Var_56 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), Var_56, 0) = MR_box_float(FlatPercentage_38);
        MR_hl_field(MR_mktag(0), Var_56, 1) = ((MR_Box) (TotalCalls_29));
      }
      mercury__rbtree__insert_duplicate_4_p_0((MR_Word) (&generate_output__generate_output__type_ctor_info_flat_key_0), (MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), ((MR_Box) (Var_56)), ((MR_Box) (LabelName_23)), FlatTree0_34, &FlatTree_48);
      {
        MR_Word base;
        base = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
        *STATE_VARIABLE_OutputProf_10 = base;
        MR_hl_field(MR_mktag(0), base, 0) = ((MR_Box) (InfoMap_46));
        MR_hl_field(MR_mktag(0), base, 1) = ((MR_Box) (CallTree_47));
        MR_hl_field(MR_mktag(0), base, 2) = ((MR_Box) (FlatTree_48));
      }
    }
  }
  else
