...
{
  {
    ...
    {
      MR_Word generate_output__ArgX1_4 = ((MR_Word) (MR_hl_field(MR_mktag(0), generate_output__HeadVar__2_2, (MR_Integer) 0)));
      MR_Word generate_output__ArgY1_5 = ((MR_Word) (MR_hl_field(MR_mktag(0), generate_output__HeadVar__3_3, (MR_Integer) 0)));
      MR_Word generate_output__ArgX2_6 = ((MR_Word) (MR_hl_field(MR_mktag(0), generate_output__HeadVar__2_2, (MR_Integer) 1)));
      MR_Word generate_output__ArgY2_7 = ((MR_Word) (MR_hl_field(MR_mktag(0), generate_output__HeadVar__3_3, (MR_Integer) 1)));
      MR_Word generate_output__ArgX3_8 = ((MR_Word) (MR_hl_field(MR_mktag(0), generate_output__HeadVar__2_2, (MR_Integer) 2)));
      MR_Word generate_output__ArgY3_9 = ((MR_Word) (MR_hl_field(MR_mktag(0), generate_output__HeadVar__3_3, (MR_Integer) 2)));
      MR_Word generate_output__Var_10;

      {
        mercury__builtin__compare_3_p_0((MR_Word) &generate_output_scalar_common_1[0], &generate_output__Var_10, ((MR_Box) (generate_output__ArgX1_4)), ((MR_Box) (generate_output__ArgY1_5)));
      }
      generate_output__succeeded = (generate_output__Var_10 == (MR_Integer) 0);
      generate_output__succeeded = !(generate_output__succeeded);
      if (generate_output__succeeded)
        *generate_output__HeadVar__1_1 = generate_output__Var_10;
      else
      {
        MR_Word generate_output__Var_11;

        {
          mercury__builtin__compare_3_p_0((MR_Word) &generate_output_scalar_common_1[1], &generate_output__Var_11, ((MR_Box) (generate_output__ArgX2_6)), ((MR_Box) (generate_output__ArgY2_7)));
        }
        generate_output__succeeded = (generate_output__Var_11 == (MR_Integer) 0);
        generate_output__succeeded = !(generate_output__succeeded);
        if (generate_output__succeeded)
          *generate_output__HeadVar__1_1 = generate_output__Var_11;
        else
        {
          {
            mercury__builtin__compare_3_p_0((MR_Word) &generate_output_scalar_common_1[2], generate_output__HeadVar__1_1, ((MR_Box) (generate_output__ArgX3_8)), ((MR_Box) (generate_output__ArgY3_9)));
          }
        }
      }
    }
...
{
  {
    ...
    else
    {
      ...
      MR_Word generate_output__ArgX1_3 = ((MR_Word) (MR_hl_field(MR_mktag(0), generate_output__HeadVar__1_1, (MR_Integer) 0)));
      MR_Word generate_output__ArgY1_4 = ((MR_Word) (MR_hl_field(MR_mktag(0), generate_output__HeadVar__2_2, (MR_Integer) 0)));
      MR_Word generate_output__ArgX2_5 = ((MR_Word) (MR_hl_field(MR_mktag(0), generate_output__HeadVar__1_1, (MR_Integer) 1)));
      MR_Word generate_output__ArgY2_6 = ((MR_Word) (MR_hl_field(MR_mktag(0), generate_output__HeadVar__2_2, (MR_Integer) 1)));
      MR_Word generate_output__ArgX3_7 = ((MR_Word) (MR_hl_field(MR_mktag(0), generate_output__HeadVar__1_1, (MR_Integer) 2)));
      MR_Word generate_output__ArgY3_8 = ((MR_Word) (MR_hl_field(MR_mktag(0), generate_output__HeadVar__2_2, (MR_Integer) 2)));

      {
        generate_output__succeeded = mercury__builtin__unify_2_p_0((MR_Word) &generate_output_scalar_common_1[0], ((MR_Box) (generate_output__ArgX1_3)), ((MR_Box) (generate_output__ArgY1_4)));
      }
      if (generate_output__succeeded)
      {
        generate_output__TypeInfo_12_12 = (MR_Word) &generate_output_scalar_common_1[1];
        {
          generate_output__succeeded = mercury__builtin__unify_2_p_0(generate_output__TypeInfo_12_12, ((MR_Box) (generate_output__ArgX2_5)), ((MR_Box) (generate_output__ArgY2_6)));
        }
        if (generate_output__succeeded)
        {
          generate_output__TypeInfo_13_13 = (MR_Word) &generate_output_scalar_common_1[2];
          {
            generate_output__succeeded = mercury__builtin__unify_2_p_0(generate_output__TypeInfo_13_13, ((MR_Box) (generate_output__ArgX3_7)), ((MR_Box) (generate_output__ArgY3_8)));
          }
        }
      }
    }
...
{
  {
    ...
    {
      MR_Float generate_output__ArgX1_4 = MR_unbox_float((MR_hl_field(MR_mktag(0), generate_output__HeadVar__2_2, (MR_Integer) 0)));
      MR_Float generate_output__ArgY1_5 = MR_unbox_float((MR_hl_field(MR_mktag(0), generate_output__HeadVar__3_3, (MR_Integer) 0)));
      MR_Integer generate_output__ArgX2_6 = ((MR_Integer) (MR_hl_field(MR_mktag(0), generate_output__HeadVar__2_2, (MR_Integer) 1)));
      MR_Integer generate_output__ArgY2_7 = ((MR_Integer) (MR_hl_field(MR_mktag(0), generate_output__HeadVar__3_3, (MR_Integer) 1)));
      MR_Word generate_output__Var_8;

      {
        mercury__private_builtin__builtin_compare_float_3_p_0(&generate_output__Var_8, generate_output__ArgX1_4, generate_output__ArgY1_5);
      }
      generate_output__succeeded = (generate_output__Var_8 == (MR_Integer) 0);
      generate_output__succeeded = !(generate_output__succeeded);
      if (generate_output__succeeded)
        *generate_output__HeadVar__1_1 = generate_output__Var_8;
      else
        {
          mercury__private_builtin__builtin_compare_int_3_p_0(generate_output__HeadVar__1_1, generate_output__ArgX2_6, generate_output__ArgY2_7);
        }
    }
  }
}
...
{
  {
    ...
    {
      MR_Float generate_output__ArgX1_3 = MR_unbox_float((MR_hl_field(MR_mktag(0), generate_output__HeadVar__1_1, (MR_Integer) 0)));
      MR_Float generate_output__ArgY1_4 = MR_unbox_float((MR_hl_field(MR_mktag(0), generate_output__HeadVar__2_2, (MR_Integer) 0)));
      MR_Integer generate_output__ArgX2_5 = ((MR_Integer) (MR_hl_field(MR_mktag(0), generate_output__HeadVar__1_1, (MR_Integer) 1)));
      MR_Integer generate_output__ArgY2_6 = ((MR_Integer) (MR_hl_field(MR_mktag(0), generate_output__HeadVar__2_2, (MR_Integer) 1)));

      generate_output__succeeded = (generate_output__ArgX1_3 == generate_output__ArgY1_4);
      if (generate_output__succeeded)
        generate_output__succeeded = (generate_output__ArgX2_5 == generate_output__ArgY2_6);
    }
    return generate_output__succeeded;
  }
}
...
{
  {
    ...
    MR_Word generate_output__Var_49;
    MR_Float generate_output__Var_11;
    MR_String generate_output__Var_12;
    MR_Integer generate_output___IntTotalCounts_13;
    MR_Word generate_output__Var_14;
    MR_Word generate_output__Var_16;

    {
      globals__io_lookup_bool_option_4_p_0((MR_Integer) 1, &generate_output__VeryVerbose_10);
    }
    {
      prof_info__prof_get_entire_7_p_0(generate_output__Prof_6, &generate_output__Var_11, &generate_output__Var_12, &generate_output___IntTotalCounts_13, &generate_output__Var_14, &generate_output__ProfNodeMap_15, &generate_output__Var_16);
    }
    {
    ...
    {
      generate_output__Var_49 = mercury__map__init_0_f_0(generate_output__TypeCtorInfo_9_50, (MR_Word) &mercury__builtin__builtin__type_ctor_info_int_0);
    }
    {
      generate_output__assign_index_numbers_2_4_p_0(generate_output__CallList_25, (MR_Integer) 1, generate_output__Var_49, generate_output__IndexMap_7);
    }
    {
  ...
  MR_Word * generate_output__STATE_VARIABLE_IndexMap_4)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      MR_Integer generate_output__Var_16;
      ...
      generate_output__Var_16 = (generate_output__N_2 + (MR_Integer) 1);
      /* direct tailcall eliminated */
      {
        MR_Word generate_output__next_value_of_HeadVar__1_1 = generate_output__Xs0_10;
        MR_Integer generate_output__next_value_of_N_2 = generate_output__Var_16;
        MR_Word generate_output__next_value_of_STATE_VARIABLE_IndexMap_0_3 = generate_output__STATE_VARIABLE_IndexMap_15_15;

        generate_output__STATE_VARIABLE_IndexMap_0_3 = generate_output__next_value_of_STATE_VARIABLE_IndexMap_0_3;
        generate_output__N_2 = generate_output__next_value_of_N_2;
        generate_output__HeadVar__1_1 = generate_output__next_value_of_HeadVar__1_1;
      }
      continue;
    }
    break;
  ...
  MR_Word * generate_output__STATE_VARIABLE_OutputProf_5)
{
  while (MR_TRUE)
  {
    ...
    else
    {
        ...
        case (MR_Integer) 1:
          {
            ...
            MR_String generate_output__Var_27;

            {
              prof_info__prof_node_get_pred_name_2_p_0(generate_output__PN_16, &generate_output__LabelName_22);
            }
            {
              generate_output__Var_27 = mercury__string__f_43_43_2_f_0((MR_String) "\n\t% Processing ", generate_output__LabelName_22);
            }
            {
              mercury__io__write_string_3_p_0(generate_output__Var_27);
            }
          }
          break;
      }
      ...
      /* direct tailcall eliminated */
      {
        MR_Word generate_output__next_value_of_HeadVar__1_1 = generate_output__PNs_17;
        MR_Word generate_output__next_value_of_STATE_VARIABLE_OutputProf_0_4 = generate_output__STATE_VARIABLE_OutputProf_30_30;

        generate_output__STATE_VARIABLE_OutputProf_0_4 = generate_output__next_value_of_STATE_VARIABLE_OutputProf_0_4;
        generate_output__HeadVar__1_1 = generate_output__next_value_of_HeadVar__1_1;
      }
      continue;
    }
...
{
  {
    ...
    if (generate_output__succeeded)
    {
      ...
      MR_Word generate_output__Var_20;
      MR_Word generate_output__Var_21;

      {
        prof_info__prof_get_entire_7_p_0(generate_output__Prof_6, &generate_output__Scale_17, &generate_output___Units_18, &generate_output__IntTotalCounts_19, &generate_output__Var_20, &generate_output__Var_21, &generate_output__CycleMap_22);
      }
      {
      ...
      else
      {
        ...
        MR_String generate_output__Var_50;
        MR_Float generate_output__Var_56;
        MR_Word generate_output__Var_57;
        MR_Integer generate_output__TotalCalls_71;
        MR_Word generate_output__Parents_72;
        MR_Float generate_output__FltTotalCalls_73;

        {
          generate_output__Var_50 = generate_output__construct_name_1_f_0(generate_output__NameList_32);
        }
        {
          generate_output__Name_36 = mercury__string__f_43_43_2_f_0(generate_output__LabelName_24, generate_output__Var_50);
        }
        {
        ...
        {
          MR_Float generate_output__Var_51;
          MR_Float generate_output__Var_52 = (generate_output__InitialFloat_37 + generate_output__Prop_27);
          MR_Float generate_output__Var_54;

          {
            generate_output__Var_51 = mercury__float__f_slash_2_f_0(generate_output__Var_52, generate_output__TotalCounts_23);
          }
          generate_output__DescPercentage_38 = (generate_output__Var_51 * ((MR_Float) 100.00000000000000));
          {
            generate_output__Var_54 = mercury__float__f_slash_2_f_0(generate_output__InitialFloat_37, generate_output__TotalCounts_23);
          }
          generate_output__FlatPercentage_39 = (generate_output__Var_54 * ((MR_Float) 100.00000000000000));
        }
        generate_output__SelfTime_40 = (generate_output__InitialFloat_37 * generate_output__Scale_17);
        generate_output__Var_56 = (generate_output__InitialFloat_37 + generate_output__Prop_27);
        generate_output__DescTime_41 = (generate_output__Var_56 * generate_output__Scale_17);
        {
        ...
        {
          generate_output__Var_57 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), generate_output__Var_57, 0) = MR_box_float(generate_output__FlatPercentage_39);
          MR_hl_field(MR_mktag(0), generate_output__Var_57, 1) = ((MR_Box) (generate_output__TotalCalls_30));
        }
        {
          mercury__rbtree__insert_duplicate_4_p_0((MR_Word) &generate_output__generate_output__type_ctor_info_flat_key_0, generate_output__TypeCtorInfo_52_59, ((MR_Box) (generate_output__Var_57)), ((MR_Box) (generate_output__LabelName_24)), generate_output__FlatTree0_35, &generate_output__FlatTree_49);
        }
        {
          MR_Word base;
          base = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL);
  ...
  while (MR_TRUE)
  {
    /* tailcall optimized into a loop */
    {
      ...
      else
      {
        ...
        MR_Float generate_output__Var_36;
        MR_Float generate_output__Var_37;
        MR_Float generate_output__Var_38;
        MR_Float generate_output__Var_39;
        MR_Word generate_output__STATE_VARIABLE_Output_40_40;
        MR_String generate_output___Units_16;
        MR_Integer generate_output__Var_17;
        ...
        {
          prof_info__prof_get_entire_7_p_0(generate_output__Prof_2, &generate_output__Scale_15, &generate_output___Units_16, &generate_output__Var_17, &generate_output__AddrMap_18, &generate_output__ProfNodeMap_19, &generate_output__CycleMap_20);
        }
        {
        ...
        {
          generate_output__Var_36 = mercury__float__float_1_f_0(generate_output__Initial_24);
        }
        generate_output__CurrentCount_27 = (generate_output__Var_36 + generate_output__Prop_25);
        {
          generate_output__Var_37 = mercury__float__float_1_f_0(generate_output__Calls_14);
        }
        {
          generate_output__Var_38 = mercury__float__float_1_f_0(generate_output__TotalCalls_26);
        }
        generate_output__succeeded = (generate_output__Var_38 == ((MR_Float) 0.0000000000000000));
        if (generate_output__succeeded)
          generate_output__Proportion_28 = (MR_Float) 0.0000000000000000;
        else
          {
            generate_output__Proportion_28 = mercury__float__f_slash_2_f_0(generate_output__Var_37, generate_output__Var_38);
          }
        {
          generate_output__Var_39 = mercury__float__float_1_f_0(generate_output__Initial_24);
        }
        generate_output__SelfTime_29 = (generate_output__Var_39 * generate_output__Scale_15);
        ...
        /* direct tailcall eliminated */
        {
          MR_Word generate_output__next_value_of_HeadVar__1_1 = generate_output__PNs_10;
          MR_Word generate_output__next_value_of_STATE_VARIABLE_Output_0_3 = generate_output__STATE_VARIABLE_Output_40_40;

          generate_output__STATE_VARIABLE_Output_0_3 = generate_output__next_value_of_STATE_VARIABLE_Output_0_3;
          generate_output__HeadVar__1_1 = generate_output__next_value_of_HeadVar__1_1;
        }
        continue;
      }
  ...
  while (MR_TRUE)
  {
    /* tailcall optimized into a loop */
    {
      ...
      else
      {
        ...
        MR_Float generate_output__Var_32;
        ...
        {
          generate_output__Var_32 = mercury__float__float_1_f_0(generate_output__Calls_23);
        }
        ...
        if (generate_output__succeeded)
          ...
          {
            generate_output__Proportion_26 = mercury__float__f_slash_2_f_0(generate_output__Var_32, generate_output__TotalCalls_4);
          }
        ...
        /* direct tailcall eliminated */
        {
          MR_Word generate_output__next_value_of_HeadVar__1_1 = generate_output__PNs_16;
          MR_Word generate_output__next_value_of_STATE_VARIABLE_Output_0_6 = generate_output__STATE_VARIABLE_Output_33_33;

          generate_output__STATE_VARIABLE_Output_0_6 = generate_output__next_value_of_STATE_VARIABLE_Output_0_6;
          generate_output__HeadVar__1_1 = generate_output__next_value_of_HeadVar__1_1;
        }
        continue;
      }
