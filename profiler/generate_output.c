...
MR_def_label(generate_output__process_prof_node_children_2_4_0,14)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(9) = MR_float_to_word((MR_word_to_float(MR_r1) + MR_word_to_float(MR_sv(9))));
	MR_r1 = MR_sv(5);
	MR_np_call_localret_ent(fn__float__float_1_0,
...
MR_def_label(generate_output__process_prof_node_children_2_4_0,16)
	...
	MR_r1 = MR_sv(10);
	MR_sv(10) = (MR_Word) &mercury_float_const_0pt0000000000000000;
	MR_np_call_localret_ent(fn__float__float_1_0,
...
MR_def_label(generate_output__process_prof_node_children_2_4_0,21)
	...
	MR_tfield(0, MR_tempr1, 3) = MR_float_to_word(((MR_word_to_float(MR_sv(9)) * MR_word_to_float(MR_tempr2)) * MR_word_to_float(MR_tempr3)));
	MR_tempr4 = MR_sv(5);
...
MR_def_label(generate_output__process_prof_node_4_0,13)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if ((MR_word_to_float(MR_sv(15)) != (MR_Float) 0.0000000000000000)) {
	...
	MR_r1 = MR_sv(13);
	MR_r4 = MR_sv(5);
	MR_sv(15) = (MR_Word) &mercury_float_const_0pt0000000000000000;
	MR_tempr2 = MR_sv(11);
	MR_r5 = MR_tempr2;
	MR_sv(11) = (MR_Word) &mercury_float_const_0pt0000000000000000;
	MR_r6 = MR_sv(12);
	MR_sv(12) = MR_float_to_word((MR_word_to_float(MR_tempr1) * MR_word_to_float(MR_tempr2)));
	MR_sv(13) = MR_float_to_word(((MR_word_to_float(MR_tempr1) + MR_word_to_float(MR_r6)) * MR_word_to_float(MR_tempr2)));
	MR_GOTO_LAB(generate_output__process_prof_node_4_0_i18);
	}
MR_def_label(generate_output__process_prof_node_4_0,14)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(14) = MR_r1;
	MR_r1 = MR_float_to_word((MR_word_to_float(MR_r1) + MR_word_to_float(MR_sv(12))));
	MR_r2 = MR_sv(15);
	MR_np_call_localret_ent(fn__f_102_108_111_97_116_95_95_47_2_0,
...
MR_def_label(generate_output__process_prof_node_4_0,16)
	...
	MR_Word MR_tempr1;
	MR_tempr1 = MR_sv(15);
	MR_sv(15) = MR_float_to_word((MR_word_to_float(MR_r1) * (MR_Float) 100.00000000000000));
	MR_r1 = MR_sv(14);
	MR_r2 = MR_tempr1;
	}
	MR_np_call_localret_ent(fn__f_102_108_111_97_116_95_95_47_2_0,
...
MR_def_label(generate_output__process_prof_node_4_0,17)
	...
	MR_r4 = MR_sv(5);
	MR_tempr2 = MR_sv(11);
	MR_sv(11) = MR_float_to_word((MR_word_to_float(MR_tempr1) * (MR_Float) 100.00000000000000));
	MR_tempr1 = MR_sv(12);
	MR_tempr3 = MR_sv(14);
	MR_sv(12) = MR_float_to_word((MR_word_to_float(MR_tempr3) * MR_word_to_float(MR_tempr2)));
	MR_sv(13) = MR_float_to_word(((MR_word_to_float(MR_tempr3) + MR_word_to_float(MR_tempr1)) * MR_word_to_float(MR_tempr2)));
	}
