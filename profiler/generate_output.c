  ...
  MR_Word * Output_10)
{
  ...
  mercury__map__init_1_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&output_prof_info__output_prof_info__type_ctor_info_output_prof_0), &InfoMap_40);
  mercury__rbtree__init_1_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_float_0), (MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), &CallTree_41);
  mercury__rbtree__init_1_p_0((MR_Word) (&generate_output__generate_output__type_ctor_info_flat_key_0), (MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), &FlatTree_42);
  {
    OutputProf0_20 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(MR_mktag(0), OutputProf0_20, 0) = ((MR_Box) (InfoMap_40));
    MR_hl_field(MR_mktag(0), OutputProf0_20, 1) = ((MR_Box) (CallTree_41));
    MR_hl_field(MR_mktag(0), OutputProf0_20, 2) = ((MR_Box) (FlatTree_42));
  }
  ...
  Var_51 = mercury__map__init_0_f_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0));
  generate_output__assign_index_numbers_2_4_p_0(CallList_27, (MR_Integer) 1, Var_51, IndexMap_9);
  ...
  MR_Word * STATE_VARIABLE_OutputProf_10)
{
  ...
  if (succeeded)
  {
    ...
    else
    {
      ...
      MR_Float Var_55;
      MR_Word Var_56;
      MR_Integer TotalCalls_70;
      MR_Word Parents_71;
      MR_Float FltTotalCalls_72;
      ...
      generate_output__remove_cycle_members_7_p_0(ParentList_27, CycleNum_24, CycleMap_21, TotalCalls_29, &TotalCalls_70, &Parents_71, &OutputCycleParentList_42);
      FltTotalCalls_72 = mercury__float__float_1_f_0(TotalCalls_70);
      if ((Parents_71 == (MR_Word) ((MR_Unsigned) 0U)))
      ...
      else
      {
        ...
        mercury__rbtree__init_1_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0), (MR_Word) (&output_prof_info__output_prof_info__type_ctor_info_parent_0), &Output0_84);
        generate_output__process_prof_node_parents_3_7_p_0(Parents_71, SelfTime_39, DescTime_40, FltTotalCalls_72, CycleMap_21, Output0_84, &Output_85);
        mercury__rbtree__values_2_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0), (MR_Word) (&output_prof_info__output_prof_info__type_ctor_info_parent_0), Output_85, &OutputParentList_41);
      }
