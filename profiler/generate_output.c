...
{
  {
    ...
    if (succeeded)
    {
      ...
      succeeded = (ParentList_28 == (MR_Word) ((MR_Integer) 0));
      if (succeeded)
        succeeded = (ChildList_29 == (MR_Word) ((MR_Integer) 0));
      if (succeeded)
      ...
      else
      {
        ...
        if ((Parents_72 == (MR_Word) ((MR_Integer) 0)))
          OutputParentList_42 = (MR_Word) ((MR_Integer) 0);
        else
        {
          MR_Word Output0_85;
          MR_Word Output_86;
