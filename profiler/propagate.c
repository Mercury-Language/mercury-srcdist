  ...
  MR_Word * STATE_VARIABLE_Prof_16)
{
  ...
  propagate__identify_cycles_2_10_p_0(DfsRev_24, (MR_Integer) 1, InvG_25, Var_27, (MR_Word) ((MR_Unsigned) 0U), &ATSort_11, Var_29, &PredToCycleMap_22, Var_30, &CycleToPredsMap_23);
  {
    ...
    MR_hl_field(MR_mktag(0), CycleInfo_12, 0) = ((MR_Box) (PredToCycleMap_22));
    MR_hl_field(MR_mktag(0), CycleInfo_12, 1) = ((MR_Box) (CycleToPredsMap_23));
  }
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          else
          {
            ...
            C_106 = ((MR_String) ((MR_hl_field(MR_mktag(1), CyclePreds_17, (MR_Integer) 0))));
            Cs_107 = ((MR_Word) ((MR_hl_field(MR_mktag(1), CyclePreds_17, (MR_Integer) 1))));
            ...
            propagate__add_to_parent_map_8_p_0(ParentList_112, CyclePreds_17, (MR_Integer) 0, &TotalCalls1_113, (MR_Integer) 0, &SelfCalls1_114, Var_84, &STATE_VARIABLE_ParentMap_43_123);
          ...
          NameStr_48 = mercury__string__f_43_43_2_f_0((MR_String) "< cycle ", Var_73);
          {
            ...
            MR_hl_field(MR_mktag(0), Var_89, 0) = ((MR_Box) (&propagate_scalar_common_5[0]));
            MR_hl_field(MR_mktag(0), Var_89, 1) = ((MR_Box) (propagate__propagate_counts_2_5_p_0_1));
            MR_hl_field(MR_mktag(0), Var_89, 2) = ((MR_Box) ((MR_Integer) 2));
            MR_hl_field(MR_mktag(0), Var_89, 3) = ((MR_Box) (AddrDeclMap_3));
            MR_hl_field(MR_mktag(0), Var_89, 4) = ((MR_Box) (STATE_VARIABLE_ProfNodeMap_0_4));
          }
          ...
          SelfCounts_49 = ((MR_Integer) (conv2_SelfCounts_49));
          {
            ...
            MR_hl_field(MR_mktag(0), Var_93, 0) = ((MR_Box) (&propagate_scalar_common_5[1]));
            MR_hl_field(MR_mktag(0), Var_93, 1) = ((MR_Box) (propagate__propagate_counts_2_5_p_0_2));
            MR_hl_field(MR_mktag(0), Var_93, 2) = ((MR_Box) ((MR_Integer) 2));
            MR_hl_field(MR_mktag(0), Var_93, 3) = ((MR_Box) (AddrDeclMap_3));
            MR_hl_field(MR_mktag(0), Var_93, 4) = ((MR_Box) (STATE_VARIABLE_ProfNodeMap_0_4));
          }
          ...
          P_128 = ((MR_String) ((MR_hl_field(MR_mktag(1), CyclePreds_17, (MR_Integer) 0))));
          Ps_129 = ((MR_Word) ((MR_hl_field(MR_mktag(1), CyclePreds_17, (MR_Integer) 1))));
          ...
          {
            CycleList_51 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), CycleList_51, 0) = ((MR_Box) (PredInfo_134));
            MR_hl_field(MR_mktag(1), CycleList_51, 1) = ((MR_Box) (CycleList0_133));
          }
    ...
    else
    {
      ...
      else
      {
        ...
        else
        {
          ...
          propagate__add_to_cycle_map_6_p_0(Var_60, CycleNum_35, STATE_VARIABLE_PredToCycleMap_23_74, &STATE_VARIABLE_PredToCycleMap_49_49, STATE_VARIABLE_CycleToPredsMap_24_75, &STATE_VARIABLE_CycleToPredsMap_50_50);
        }
      }
