...
{
  {
    ...
    propagate__identify_cycles_2_10_p_0(DfsRev_27, (MR_Integer) 1, InvG_28, Var_30, (MR_Word) ((MR_Integer) 0), &ATSort_11, Var_32, &PredToCycleMap_25, Var_33, &CycleToPredsMap_26);
    {
...
{
  {
    ...
    if ((Preds_6 == (MR_Word) ((MR_Integer) 0)))
    {
      {
  ...
  MR_Word * STATE_VARIABLE_CycleToPredsMap_10)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      if ((DfsRev_33 == (MR_Word) ((MR_Integer) 0)))
      {
        {
