  ...
  MR_Word * STATE_VARIABLE_ProfNodeMap_22)
{
  ...
  else
  {
    ...
    Var_66 = mercury__map__init_0_f_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0));
    C_103 = ((MR_String) ((MR_hl_field(MR_mktag(1), Preds_6, (MR_Integer) 0))));
    Cs_104 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Preds_6, (MR_Integer) 1))));
    prof_info__get_prof_node_4_p_0(C_103, AddrMap_8, STATE_VARIABLE_ProfNodeMap_0_21, &ProfNode_111);
    prof_info__prof_node_get_parent_list_2_p_0(ProfNode_111, &ParentList_112);
    propagate__add_to_parent_map_8_p_0(ParentList_112, Preds_6, (MR_Integer) 0, &TotalCalls1_113, (MR_Integer) 0, &SelfCalls1_114, Var_66, &STATE_VARIABLE_ParentMap_43_123);
    ...
    propagate__build_parent_map_2_10_p_0(Cs_104, Preds_6, AddrMap_8, STATE_VARIABLE_ProfNodeMap_0_21, STATE_VARIABLE_TotalCalls_44_124, &Total_10, STATE_VARIABLE_SelfCalls_45_125, &Recursive_11, STATE_VARIABLE_ParentMap_43_123, &ParentMap_49);
  }
  ...
  mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&propagate_scalar_common_3[0]), Cycle_7, &Var_34);
  ...
  NameStr_13 = mercury__string__f_43_43_2_f_0((MR_String) "< cycle ", Var_41);
  {
    ...
    MR_hl_field(MR_mktag(0), Var_73, 0) = ((MR_Box) (&propagate_scalar_common_5[0]));
    MR_hl_field(MR_mktag(0), Var_73, 1) = ((MR_Box) (propagate__process_cycle_5_p_0_1));
    MR_hl_field(MR_mktag(0), Var_73, 2) = ((MR_Box) ((MR_Integer) 2));
    MR_hl_field(MR_mktag(0), Var_73, 3) = ((MR_Box) (AddrMap_8));
    MR_hl_field(MR_mktag(0), Var_73, 4) = ((MR_Box) (STATE_VARIABLE_ProfNodeMap_0_21));
  }
  mercury__list__foldl_4_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0), Var_73, Preds_6, ((MR_Box) ((MR_Integer) 0)), &conv1_SelfCounts_14);
  SelfCounts_14 = ((MR_Integer) (conv1_SelfCounts_14));
  {
    Var_84 = (MR_Word) MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(MR_mktag(0), Var_84, 0) = ((MR_Box) (&propagate_scalar_common_5[1]));
    MR_hl_field(MR_mktag(0), Var_84, 1) = ((MR_Box) (propagate__process_cycle_5_p_0_2));
    MR_hl_field(MR_mktag(0), Var_84, 2) = ((MR_Box) ((MR_Integer) 2));
    MR_hl_field(MR_mktag(0), Var_84, 3) = ((MR_Box) (AddrMap_8));
    MR_hl_field(MR_mktag(0), Var_84, 4) = ((MR_Box) (STATE_VARIABLE_ProfNodeMap_0_21));
  }
  mercury__list__foldl_4_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&mercury__builtin__builtin__type_ctor_info_float_0), Var_84, Preds_6, MR_box_float((MR_Float) 0.0000000000000000), &conv3_PropCounts_15);
  PropCounts_15 = MR_unbox_float(conv3_PropCounts_15);
  P_131 = ((MR_String) ((MR_hl_field(MR_mktag(1), Preds_6, (MR_Integer) 0))));
  Ps_132 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Preds_6, (MR_Integer) 1))));
  propagate__f_85_110_117_115_101_100_65_114_103_115_95_95_112_114_101_100_95_95_98_117_105_108_100_95_99_121_99_108_101_95_108_105_115_116_95_95_91_50_44_32_51_93_95_48_4_p_0(Ps_132, &CycleList0_136);
  prof_info__pred_info_init_3_p_0(P_131, (MR_Integer) 0, &PredInfo_137);
  {
    CycleList_16 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(MR_mktag(1), CycleList_16, 0) = ((MR_Box) (PredInfo_137));
    MR_hl_field(MR_mktag(1), CycleList_16, 1) = ((MR_Box) (CycleList0_136));
  }
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      else
      {
        ...
        {
          MR_Word STATE_VARIABLE_PredToCycleMap_23_81;
          MR_Word STATE_VARIABLE_CycleToPredsMap_24_82;

          CycleNum_35 = (MR_Integer) ((MR_Unsigned) CycleNum0_2 + (MR_Unsigned) 1);
          mercury__map__det_insert_4_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0), ((MR_Box) (Var_64)), ((MR_Box) (CycleNum_35)), STATE_VARIABLE_PredToCycleMap_0_7, &STATE_VARIABLE_PredToCycleMap_23_81);
          mercury__multi_map__set_4_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0), (MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), ((MR_Box) (CycleNum_35)), ((MR_Box) (Var_64)), STATE_VARIABLE_CycleToPredsMap_0_9, &STATE_VARIABLE_CycleToPredsMap_24_82);
          propagate__add_to_cycle_map_6_p_0(Var_63, CycleNum_35, STATE_VARIABLE_PredToCycleMap_23_81, &STATE_VARIABLE_PredToCycleMap_52_52, STATE_VARIABLE_CycleToPredsMap_24_82, &STATE_VARIABLE_CycleToPredsMap_53_53);
        }
      }
