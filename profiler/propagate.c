...
MR_decl_label1(propagate__IntroducedFrom__pred__process_cycle__268__1_4_0, 2)
...
MR_decl_label10(propagate__identify_cycles_2_10_0, 37,3,4,6,10,11,12,13,8,7)
MR_decl_label2(propagate__identify_cycles_2_10_0, 15,16)
MR_decl_label10(propagate__process_cycle_5_0, 4,5,6,7,8,3,2,10,11,12)
MR_decl_label10(propagate__process_cycle_5_0, 13,14,16,19,20,21,23,24,25,26)
MR_decl_label10(propagate__propagate_counts_5_0, 2,3,4,5,6,7,8,9,11,12)
MR_decl_label2(propagate__propagate_counts_5_0, 13,14)
...
MR_decl_label4(__Compare___propagate__cycle_info_0_0, 3,2,5,27)
...
MR_decl_static(propagate__IntroducedFrom__pred__process_cycle__268__1_4_0)
...
static const MR_UserClosureId
mercury_data__closure_layout__propagate__process_cycle_5_0_3;
extern const MR_TypeCtorInfo_Struct mercury_data_private_builtin__type_ctor_info_float_box_0;
static const struct mercury_type_5 mercury_common_5[1] =
{
{
{
(MR_Word *) &mercury_data__closure_layout__propagate__process_cycle_5_0_3,
(MR_Word *) (MR_Integer) 0
},
4,
{
...
MR_BEGIN_MODULE(propagate_module1)
	...
	MR_init_label10(propagate__identify_cycles_2_10_0,37,3,4,6,10,11,12,13,8,7)
	MR_init_label2(propagate__identify_cycles_2_10_0,15,16)
MR_BEGIN_CODE
...
MR_def_label(propagate__identify_cycles_2_10_0,37)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
...
MR_def_label(propagate__identify_cycles_2_10_0,6)
	...
	if (MR_LTAGS_TEST(MR_r1,0,0)) {
		MR_GOTO_LAB(propagate__identify_cycles_2_10_0_i8);
	}
...
MR_def_label(propagate__identify_cycles_2_10_0,16)
	...
	MR_GOTO_LAB(propagate__identify_cycles_2_10_0_i37);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_thread_engine_base
#endif
...
MR_def_label(propagate__propagate_counts_3_6_0,6)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	* (MR_Float *) &MR_sv(10) = (MR_f(1) * MR_float_from_dword_ptr(&MR_sv(2)));
	MR_r1 = MR_sv(8);
	MR_r2 = MR_sv(5);
	MR_r3 = MR_sv(6);
	MR_np_call_localret_ent(prof_info__get_prof_node_4_0,
...
MR_def_label(propagate__propagate_counts_3_6_0,8)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_f(1) = (MR_f(1) + MR_float_from_dword_ptr(&MR_sv(10)));
	MR_r1 = MR_sv(11);
...
MR_BEGIN_MODULE(propagate_module8)
	...
	MR_init_label10(propagate__process_cycle_5_0,13,14,16,19,20,21,23,24,25,26)
MR_BEGIN_CODE
...
MR_def_label(propagate__process_cycle_5_0,16)
	...
	MR_tfield(0, MR_tempr2, 1) = (MR_Word) MR_ENTRY_AP(propagate__IntroducedFrom__pred__process_cycle__268__1_4_0);
...
MR_def_label(propagate__process_cycle_5_0,20)
	...
	MR_np_call_localret_ent(prof_info__pred_info_init_3_0,
		propagate__process_cycle_5_0_i21);
MR_def_label(propagate__process_cycle_5_0,21)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
...
MR_def_label(propagate__process_cycle_5_0,23)
	...
	MR_r2 = ((MR_Integer) 0 - (MR_Integer) MR_sv(9));
	MR_r3 = MR_tempr1;
	MR_r4 = MR_sv(12);
	}
...
MR_def_label(propagate__process_cycle_5_0,25)
	...
	* (MR_Float *) &MR_sv(11) = MR_f(1);
	MR_r1 = MR_sv(5);
	MR_np_call_localret_ent(fn__float__float_1_0,
		propagate__process_cycle_5_0_i26);
MR_def_label(propagate__process_cycle_5_0,26)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(3);
...
MR_def_label(propagate__propagate_counts_2_5_0,21)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	* (MR_Float *) &MR_sv(8) = (MR_f(1) + MR_float_from_dword_ptr(&MR_sv(11)));
	MR_r1 = MR_sv(6);
	MR_np_call_localret_ent(fn__float__float_1_0,
...
MR_BEGIN_MODULE(propagate_module10)
	...
	MR_init_label10(propagate__propagate_counts_5_0,2,3,4,5,6,7,8,9,11,12)
	MR_init_label2(propagate__propagate_counts_5_0,13,14)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(propagate_module14)
	...
	MR_init_label4(__Compare___propagate__cycle_info_0_0,3,2,5,27)
MR_BEGIN_CODE
...
MR_def_label(__Compare___propagate__cycle_info_0_0,5)
	...
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___propagate__cycle_info_0_0_i27);
	}
	MR_r1 = (MR_Word) MR_TAG_COMMON(0,1,1);
	MR_r2 = MR_sv(1);
	MR_r3 = MR_sv(2);
...
MR_def_label(__Compare___propagate__cycle_info_0_0,27)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(3);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
...
MR_BEGIN_MODULE(propagate_module21)
	MR_init_entry1(propagate__IntroducedFrom__pred__process_cycle__268__1_4_0);
	MR_INIT_PROC_LAYOUT_ADDR(mercury__propagate__IntroducedFrom__pred__process_cycle__268__1_4_0);
	MR_init_label1(propagate__IntroducedFrom__pred__process_cycle__268__1_4_0,2)
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'IntroducedFrom__pred__process_cycle__268__1'/4 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(propagate__IntroducedFrom__pred__process_cycle__268__1_4_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(1);
	...
	MR_set_prof_ho_caller_proc(MR_ENTRY_AP(propagate__IntroducedFrom__pred__process_cycle__268__1_4_0));
	MR_noprof_call_localret(MR_ENTRY(mercury__do_call_closure_compact),
		mercury__propagate__IntroducedFrom__pred__process_cycle__268__1_4_0_i2);
MR_def_label(propagate__IntroducedFrom__pred__process_cycle__268__1_4_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
void mercury__propagate__write_out_proc_statics(FILE *deep_fp, FILE *procrep_fp)
{
	MR_write_out_module_proc_reps_start(procrep_fp, &mercury_data__module_layout__propagate);
