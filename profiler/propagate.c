...
{
  {
    ...
    else
    {
      ...
      STATE_VARIABLE_TotalCalls_44_124 = (MR_Integer) ((MR_Unsigned) (MR_Integer) 0 + (MR_Unsigned) TotalCalls1_113);
      STATE_VARIABLE_SelfCalls_45_125 = (MR_Integer) ((MR_Unsigned) (MR_Integer) 0 + (MR_Unsigned) SelfCalls1_114);
