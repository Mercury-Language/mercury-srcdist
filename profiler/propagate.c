  ...
  MR_Word * STATE_VARIABLE_Prof_16)
{
  ...
  MR_Word PredToCycleMap_24;
  MR_Word CycleToPredsMap_25;
  MR_Word DfsRev_26;
  MR_Word InvG_27;
  MR_Word Var_29;
  MR_Word Var_31;
  MR_Word Var_32;
  MR_Word AssocList_41;
  ...
  mercury__digraph__dfsrev_2_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), CallGraph_6, &DfsRev_26);
  mercury__digraph__inverse_2_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), CallGraph_6, &InvG_27);
  Var_29 = mercury__sparse_bitset__init_0_f_0((MR_Word) (&propagate_scalar_common_1[0]));
  Var_31 = mercury__map__init_0_f_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0));
  Var_32 = mercury__multi_map__init_0_f_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0), (MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0));
  propagate__identify_cycles_2_10_p_0(DfsRev_26, (MR_Integer) 1, InvG_27, Var_29, (MR_Word) ((MR_Unsigned) 0U), &ATSort_11, Var_31, &PredToCycleMap_24, Var_32, &CycleToPredsMap_25);
  {
    CycleInfo_12 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(MR_mktag(0), CycleInfo_12, 0) = ((MR_Box) (PredToCycleMap_24));
    MR_hl_field(MR_mktag(0), CycleInfo_12, 1) = ((MR_Box) (CycleToPredsMap_25));
  }
  AssocList_41 = mercury__multi_map__to_assoc_list_1_f_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0), (MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), CycleToPredsMap_25);
  propagate__update_cycles_2_4_p_0(AssocList_41, AddrDeclMap_9, ProfNodeMap0_10, &ProfNodeMap1_13);
  ...
  MR_Word * STATE_VARIABLE_ProfNodeMap_22)
{
  ...
  MR_String Var_33;
  MR_String Var_40;
  MR_Word ParentMap_48;
  MR_Word ParentAssocList_49;
  MR_Word Var_72;
  MR_Word Var_83;
  MR_String P_127;
  MR_Word Ps_128;
  MR_Word CycleList0_132;
  MR_Word PredInfo_133;
  ...
  else
  {
    ...
    MR_String C_102;
    MR_Word Cs_103;
    MR_Word ProfNode_110;
    MR_Word ParentList_111;
    MR_Integer TotalCalls1_112;
    MR_Integer SelfCalls1_113;
    MR_Word STATE_VARIABLE_ParentMap_43_122;
    MR_Integer STATE_VARIABLE_TotalCalls_44_123;
    MR_Integer STATE_VARIABLE_SelfCalls_45_124;
    ...
    C_102 = ((MR_String) ((MR_hl_field(MR_mktag(1), Preds_6, (MR_Integer) 0))));
    Cs_103 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Preds_6, (MR_Integer) 1))));
    prof_info__get_prof_node_4_p_0(C_102, AddrMap_8, STATE_VARIABLE_ProfNodeMap_0_21, &ProfNode_110);
    prof_info__prof_node_get_parent_list_2_p_0(ProfNode_110, &ParentList_111);
    propagate__add_to_parent_map_8_p_0(ParentList_111, Preds_6, (MR_Integer) 0, &TotalCalls1_112, (MR_Integer) 0, &SelfCalls1_113, Var_65, &STATE_VARIABLE_ParentMap_43_122);
    STATE_VARIABLE_TotalCalls_44_123 = (MR_Integer) ((MR_Unsigned) 0 + (MR_Unsigned) TotalCalls1_112);
    STATE_VARIABLE_SelfCalls_45_124 = (MR_Integer) ((MR_Unsigned) 0 + (MR_Unsigned) SelfCalls1_113);
    propagate__build_parent_map_2_10_p_0(Cs_103, Preds_6, AddrMap_8, STATE_VARIABLE_ProfNodeMap_0_21, STATE_VARIABLE_TotalCalls_44_123, &Total_10, STATE_VARIABLE_SelfCalls_45_124, &Recursive_11, STATE_VARIABLE_ParentMap_43_122, &ParentMap_48);
  }
  mercury__map__to_assoc_list_2_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0), ParentMap_48, &ParentAssocList_49);
  ParentList_12 = propagate__assoc_list_to_pred_info_list_1_f_0(ParentAssocList_49);
  mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&propagate_scalar_common_3[0]), Cycle_7, &Var_33);
  Var_40 = mercury__string__f_43_43_2_f_0(Var_33, (MR_String) " as a whole >");
  NameStr_13 = mercury__string__f_43_43_2_f_0((MR_String) "< cycle ", Var_40);
  {
    Var_72 = (MR_Word) MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(MR_mktag(0), Var_72, 0) = ((MR_Box) (&propagate_scalar_common_5[0]));
    MR_hl_field(MR_mktag(0), Var_72, 1) = ((MR_Box) (propagate__process_cycle_5_p_0_1));
    MR_hl_field(MR_mktag(0), Var_72, 2) = ((MR_Box) ((MR_Integer) 2));
    MR_hl_field(MR_mktag(0), Var_72, 3) = ((MR_Box) (AddrMap_8));
    MR_hl_field(MR_mktag(0), Var_72, 4) = ((MR_Box) (STATE_VARIABLE_ProfNodeMap_0_21));
  }
  mercury__list__foldl_4_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0), Var_72, Preds_6, ((MR_Box) ((MR_Integer) 0)), &conv1_SelfCounts_14);
  SelfCounts_14 = ((MR_Integer) (conv1_SelfCounts_14));
  {
    Var_83 = (MR_Word) MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(MR_mktag(0), Var_83, 0) = ((MR_Box) (&propagate_scalar_common_5[1]));
    MR_hl_field(MR_mktag(0), Var_83, 1) = ((MR_Box) (propagate__process_cycle_5_p_0_2));
    MR_hl_field(MR_mktag(0), Var_83, 2) = ((MR_Box) ((MR_Integer) 2));
    MR_hl_field(MR_mktag(0), Var_83, 3) = ((MR_Box) (AddrMap_8));
    MR_hl_field(MR_mktag(0), Var_83, 4) = ((MR_Box) (STATE_VARIABLE_ProfNodeMap_0_21));
  }
  mercury__list__foldl_4_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&mercury__builtin__builtin__type_ctor_info_float_0), Var_83, Preds_6, MR_box_float((MR_Float) 0.0000000000000000), &conv3_PropCounts_15);
  PropCounts_15 = MR_unbox_float(conv3_PropCounts_15);
  P_127 = ((MR_String) ((MR_hl_field(MR_mktag(1), Preds_6, (MR_Integer) 0))));
  Ps_128 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Preds_6, (MR_Integer) 1))));
  propagate__f_85_110_117_115_101_100_65_114_103_115_95_95_112_114_101_100_95_95_98_117_105_108_100_95_99_121_99_108_101_95_108_105_115_116_95_95_91_50_44_32_51_93_95_48_4_p_0(Ps_128, &CycleList0_132);
  prof_info__pred_info_init_3_p_0(P_127, (MR_Integer) 0, &PredInfo_133);
  {
    CycleList_16 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(MR_mktag(1), CycleList_16, 0) = ((MR_Box) (PredInfo_133));
    MR_hl_field(MR_mktag(1), CycleList_16, 1) = ((MR_Box) (CycleList0_132));
  }
  ...
  Address_18 = (MR_Integer) ((MR_Unsigned) 0 - (MR_Unsigned) Cycle_7);
  ...
  MR_Box * wrapper_arg_2)
{
  ...
  propagate__IntroducedFrom__pred__identify_cycles_2__107__1_3_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) (wrapper_arg_1)), &conv0_HeadVar__3_57);
  ...
  MR_Word * STATE_VARIABLE_CycleToPredsMap_10)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      {
        MR_Word Var_60 = ((MR_Word) ((MR_hl_field(MR_mktag(1), DfsRev_33, (MR_Integer) 1))));
        MR_String Var_61 = ((MR_String) ((MR_hl_field(MR_mktag(1), DfsRev_33, (MR_Integer) 0))));
        ...
        {
          MR_Word STATE_VARIABLE_PredToCycleMap_23_78;
          MR_Word STATE_VARIABLE_CycleToPredsMap_24_79;

          CycleNum_35 = (MR_Integer) ((MR_Unsigned) CycleNum0_2 + (MR_Unsigned) 1);
          mercury__map__det_insert_4_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0), ((MR_Box) (Var_61)), ((MR_Box) (CycleNum_35)), STATE_VARIABLE_PredToCycleMap_0_7, &STATE_VARIABLE_PredToCycleMap_23_78);
          mercury__multi_map__set_4_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0), (MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), ((MR_Box) (CycleNum_35)), ((MR_Box) (Var_61)), STATE_VARIABLE_CycleToPredsMap_0_9, &STATE_VARIABLE_CycleToPredsMap_24_79);
          propagate__add_to_cycle_map_6_p_0(Var_60, CycleNum_35, STATE_VARIABLE_PredToCycleMap_23_78, &STATE_VARIABLE_PredToCycleMap_52_52, STATE_VARIABLE_CycleToPredsMap_24_79, &STATE_VARIABLE_CycleToPredsMap_53_53);
        }
      }
