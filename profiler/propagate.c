...
MR_def_label(propagate__propagate_counts_3_6_0,6)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	* (MR_Float *) &MR_sv(10) = (MR_word_to_float(MR_r1) * MR_float_from_dword_ptr(&MR_sv(2)));
	MR_r1 = MR_sv(8);
	MR_r2 = MR_sv(5);
	MR_r3 = MR_sv(6);
	MR_np_call_localret_ent(prof_info__get_prof_node_4_0,
...
MR_def_label(propagate__propagate_counts_3_6_0,8)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_float_to_word((MR_word_to_float(MR_r1) + MR_float_from_dword_ptr(&MR_sv(10))));
	MR_r2 = MR_sv(11);
...
MR_def_label(propagate__process_cycle_5_0,25)
	...
	MR_tempr1 = MR_r1;
	MR_r1 = MR_sv(3);
	MR_r2 = MR_float_to_word((MR_word_to_float(MR_tempr1) + MR_float_from_dword_ptr(&MR_sv(8))));
	MR_r3 = MR_float_to_word(MR_float_from_dword_ptr(&MR_sv(11)));
	MR_r4 = MR_sv(1);
	MR_r5 = MR_sv(13);
	MR_succip_word = MR_sv(15);
	MR_decr_sp(15);
...
MR_def_label(propagate__propagate_counts_2_5_0,21)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	* (MR_Float *) &MR_sv(8) = (MR_word_to_float(MR_r1) + MR_float_from_dword_ptr(&MR_sv(11)));
	MR_r1 = MR_sv(6);
	MR_np_call_localret_ent(fn__float__float_1_0,
...
MR_def_static(propagate__accumulate_propagated_counts_5_0)
	...
	MR_incr_sp(3);
	MR_sv(3) = (MR_Word) MR_succip;
	* (MR_Float *) &MR_sv(2) = MR_word_to_float(MR_r4);
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tempr1 = MR_r1;
	MR_r1 = MR_r3;
