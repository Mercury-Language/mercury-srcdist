...
MR_decl_label3(__Unify___propagate__cycle_info_0_0, 4,8,1)
MR_decl_label4(__Compare___propagate__cycle_info_0_0, 3,2,5,21)
...
MR_BEGIN_MODULE(propagate_module13)
	...
	MR_init_label3(__Unify___propagate__cycle_info_0_0,4,8,1)
MR_BEGIN_CODE
...
MR_def_static(__Unify___propagate__cycle_info_0_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if ((MR_r1 == MR_r2)) {
		MR_GOTO_LAB(__Unify___propagate__cycle_info_0_0_i8);
	}
	MR_incr_sp(3);
	MR_sv(3) = (MR_Word) MR_succip;
	MR_sv(1) = MR_r1;
...
MR_def_label(__Unify___propagate__cycle_info_0_0,8)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_TRUE;
	MR_proceed();
...
MR_BEGIN_MODULE(propagate_module14)
	...
	MR_init_label4(__Compare___propagate__cycle_info_0_0,3,2,5,21)
MR_BEGIN_CODE
...
MR_def_label(__Compare___propagate__cycle_info_0_0,5)
	...
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___propagate__cycle_info_0_0_i21);
	}
	MR_r1 = (MR_Word) MR_INT_CTOR_ADDR;
	MR_r2 = (MR_Word) MR_TAG_COMMON(0,0,1);
	MR_r3 = MR_sv(1);
...
MR_def_label(__Compare___propagate__cycle_info_0_0,21)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(3);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
