  ...
  MR_Word * STATE_VARIABLE_ProfNodeMap_22)
{
  ...
  P_128 = ((MR_String) ((MR_hl_field(MR_mktag(1), Preds_6, (MR_Integer) 0))));
  Ps_129 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Preds_6, (MR_Integer) 1))));
  ...
  prof_info__pred_info_init_3_p_0(P_128, (MR_Integer) 0, &PredInfo_134);
  {
    ...
    MR_hl_field(MR_mktag(1), CycleList_16, 0) = ((MR_Box) (PredInfo_134));
    MR_hl_field(MR_mktag(1), CycleList_16, 1) = ((MR_Box) (CycleList0_133));
  }
