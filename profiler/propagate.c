...
{
  {
    ...
    if (propagate__succeeded)
      *propagate__HeadVar__1_1 = (MR_Integer) 0;
      ...
      {
        MR_Word propagate__Var_4 = ((MR_Word) (MR_hl_field(MR_mktag(0), propagate__HeadVar__2_2, (MR_Integer) 0)));
        MR_Word propagate__Var_5 = ((MR_Word) (MR_hl_field(MR_mktag(0), propagate__HeadVar__2_2, (MR_Integer) 1)));
        MR_Word propagate__Var_6 = ((MR_Word) (MR_hl_field(MR_mktag(0), propagate__HeadVar__3_3, (MR_Integer) 0)));
        MR_Word propagate__Var_7 = ((MR_Word) (MR_hl_field(MR_mktag(0), propagate__HeadVar__3_3, (MR_Integer) 1)));
        MR_Word propagate__Var_8;

        {
          mercury__builtin__compare_3_p_0((MR_Word) &propagate_scalar_common_2[0], &propagate__Var_8, ((MR_Box) (propagate__Var_4)), ((MR_Box) (propagate__Var_6)));
        }
        ...
        if (propagate__succeeded)
          *propagate__HeadVar__1_1 = propagate__Var_8;
          ...
          {
            {
              mercury__builtin__compare_3_p_0((MR_Word) &propagate_scalar_common_2[1], propagate__HeadVar__1_1, ((MR_Box) (propagate__Var_5)), ((MR_Box) (propagate__Var_7)));
            }
          }
      }
  }
...
{
  {
    ...
    if (propagate__succeeded)
    ...
    else
      {
        ...
        MR_Word propagate__Var_3 = ((MR_Word) (MR_hl_field(MR_mktag(0), propagate__HeadVar__1_1, (MR_Integer) 0)));
        MR_Word propagate__Var_4 = ((MR_Word) (MR_hl_field(MR_mktag(0), propagate__HeadVar__1_1, (MR_Integer) 1)));
        MR_Word propagate__Var_5 = ((MR_Word) (MR_hl_field(MR_mktag(0), propagate__HeadVar__2_2, (MR_Integer) 0)));
        MR_Word propagate__Var_6 = ((MR_Word) (MR_hl_field(MR_mktag(0), propagate__HeadVar__2_2, (MR_Integer) 1)));

        {
          propagate__succeeded = mercury__builtin__unify_2_p_0((MR_Word) &propagate_scalar_common_2[0], ((MR_Box) (propagate__Var_3)), ((MR_Box) (propagate__Var_5)));
        }
        if (propagate__succeeded)
          {
            propagate__TypeInfo_10_10 = (MR_Word) &propagate_scalar_common_2[1];
            {
              propagate__succeeded = mercury__builtin__unify_2_p_0(propagate__TypeInfo_10_10, ((MR_Box) (propagate__Var_4)), ((MR_Box) (propagate__Var_6)));
            }
          }
      }
    return propagate__succeeded;
