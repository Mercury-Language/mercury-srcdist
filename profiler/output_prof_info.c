    ...
    if (((MR_tag((MR_Word) HeadVar__2_2)) == (MR_Integer) 1))
    {
      ...
      if (((MR_tag((MR_Word) HeadVar__3_3)) == (MR_Integer) 1))
      {
        ...
        else
        {
          ...
          mercury__private_builtin__builtin_compare_int_3_p_0(&SubResult2_86, Var_137, ArgY2_85);
            ...
            else
            {
              ...
              else
              {
                ...
                else
                {
                  ...
                  mercury__private_builtin__builtin_compare_int_3_p_0(&SubResult6_98, Var_133, ArgY6_97);
                  succeeded = (SubResult6_98 != (MR_Integer) 0);
                  if (succeeded)
                  ...
                  else
                  {
                    ...
                    mercury__private_builtin__builtin_compare_int_3_p_0(&SubResult7_101, Var_132, ArgY7_100);
                    succeeded = (SubResult7_101 != (MR_Integer) 0);
                    if (succeeded)
    ...
    else
    {
      ...
      else
      {
        ...
        else
        {
          ...
          mercury__private_builtin__builtin_compare_int_3_p_0(&SubResult2_9, Var_149, ArgY2_8);
          succeeded = (SubResult2_9 != (MR_Integer) 0);
          if (succeeded)
            *HeadVar__1_1 = SubResult2_9;
          else
              ...
              else
              {
                ...
                else
                {
                  ...
                  else
                  {
                    ...
                    mercury__private_builtin__builtin_compare_int_3_p_0(&SubResult7_24, Var_144, ArgY7_23);
                    ...
                    else
                    {
                      ...
                      mercury__private_builtin__builtin_compare_int_3_p_0(&SubResult8_27, Var_143, ArgY8_26);
