...
MR_decl_label5(__Compare___output_prof_info__output_0_0, 3,2,5,9,38)
...
MR_decl_label5(__Compare___output_prof_info__output_prof_0_0, 80,84,88,92,253)
...
MR_BEGIN_MODULE(output_prof_info_module3)
	...
	MR_init_label5(__Compare___output_prof_info__output_0_0,3,2,5,9,38)
MR_BEGIN_CODE
...
MR_def_label(__Compare___output_prof_info__output_0_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___output_prof_info__output_0_0_i38);
	}
	MR_r1 = (MR_Word) MR_TAG_COMMON(0,1,0);
	MR_r2 = MR_sv(1);
	MR_r3 = MR_sv(3);
...
MR_def_label(__Compare___output_prof_info__output_0_0,38)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(5);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
...
MR_define_entry(mercury____Unify___output_prof_info__output_prof_0_0);
	...
	MR_tempr3 = MR_tempr1;
	MR_sv(5) = MR_tfield(1, MR_tempr3, 11);
	MR_tempr4 = MR_tempr2;
	MR_sv(6) = MR_tfield(1, MR_tempr4, 11);
...
MR_BEGIN_MODULE(output_prof_info_module5)
	...
	MR_init_label5(__Compare___output_prof_info__output_prof_0_0,80,84,88,92,253)
MR_BEGIN_CODE
...
MR_def_label(__Compare___output_prof_info__output_prof_0_0,9)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___output_prof_info__output_prof_0_0_i253);
	}
	MR_r1 = MR_sv(28);
	MR_r2 = MR_sv(1);
	MR_np_call_localret_ent(private_builtin__builtin_compare_int_3_0,
...
MR_def_label(__Compare___output_prof_info__output_prof_0_0,92)
	...
	MR_decr_sp(39);
	MR_np_tailcall_ent(builtin__compare_3_0);
MR_def_label(__Compare___output_prof_info__output_prof_0_0,253)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(39);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
...
void mercury__output_prof_info__write_out_proc_statics(FILE *deep_fp, FILE *procrep_fp)
{
	MR_write_out_module_proc_reps_start(procrep_fp, &mercury_data__module_layout__output_prof_info);
