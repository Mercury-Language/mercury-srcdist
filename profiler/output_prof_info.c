...
MR_decl_label8(__Compare___output_prof_info__output_prof_0_0, 33,37,7,5,50,52,56,60)
MR_decl_label8(__Compare___output_prof_info__output_prof_0_0, 64,68,72,76,80,84,88,92)
...
MR_define_entry(mercury____Unify___output_prof_info__output_prof_0_0);
	...
	MR_tempr3 = MR_ctfield(1, MR_tempr1, 4);
	MR_tempr4 = MR_ctfield(1, MR_tempr2, 4);
	if ((MR_word_to_float(MR_tempr3) != MR_word_to_float(MR_tempr4))) {
		MR_GOTO_LAB(__Unify___output_prof_info__output_prof_0_0_i1);
	}
	MR_tempr3 = MR_ctfield(1, MR_tempr1, 5);
	MR_tempr4 = MR_ctfield(1, MR_tempr2, 5);
	if ((MR_tempr3 != MR_tempr4)) {
		MR_GOTO_LAB(__Unify___output_prof_info__output_prof_0_0_i1);
	}
	MR_tempr3 = MR_ctfield(1, MR_tempr1, 6);
	MR_tempr4 = MR_ctfield(1, MR_tempr2, 6);
	if ((MR_tempr3 != MR_tempr4)) {
		MR_GOTO_LAB(__Unify___output_prof_info__output_prof_0_0_i1);
	}
	MR_tempr3 = MR_tempr1;
	MR_sv(1) = MR_ctfield(1, MR_tempr3, 8);
	MR_tempr4 = MR_tempr2;
	MR_sv(2) = MR_ctfield(1, MR_tempr4, 8);
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(output_prof_info, parent);
	MR_r2 = MR_ctfield(1, MR_tempr3, 7);
	MR_r3 = MR_ctfield(1, MR_tempr4, 7);
	}
	MR_np_call_localret_ent(__Unify___list__list_1_0,
...
MR_def_label(__Unify___output_prof_info__output_prof_0_0,5)
	...
	MR_sv(3) = MR_ctfield(0, MR_tempr1, 11);
	MR_sv(4) = MR_ctfield(0, MR_tempr2, 9);
	MR_sv(5) = MR_ctfield(0, MR_tempr2, 10);
	MR_sv(6) = MR_ctfield(0, MR_tempr2, 11);
...
MR_BEGIN_MODULE(output_prof_info_module5)
	...
	MR_init_label8(__Compare___output_prof_info__output_prof_0_0,33,37,7,5,50,52,56,60)
	MR_init_label8(__Compare___output_prof_info__output_prof_0_0,64,68,72,76,80,84,88,92)
