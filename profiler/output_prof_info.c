...
MR_define_entry(mercury____Unify___output_prof_info__output_prof_0_0);
	...
	MR_tempr3 = MR_tempr1;
	MR_sv(7) = MR_tfield(1, MR_tempr3, 8);
	MR_tempr4 = MR_tempr2;
	MR_sv(5) = MR_tfield(1, MR_tempr4, 8);
...
MR_def_label(__Compare___output_prof_info__output_prof_0_0,2)
	...
	* (MR_Float *) &MR_sv(27) = MR_word_to_float(MR_tfield(1, MR_tempr3, 2));
	* (MR_Float *) &MR_sv(24) = MR_word_to_float(MR_tfield(1, MR_tempr3, 3));
	* (MR_Float *) &MR_sv(21) = MR_word_to_float(MR_tfield(1, MR_tempr3, 4));
	MR_sv(18) = MR_tfield(1, MR_tempr3, 5);
	MR_sv(17) = MR_tfield(1, MR_tempr3, 6);
	MR_sv(16) = MR_tfield(1, MR_tempr3, 7);
	MR_sv(15) = MR_tfield(1, MR_tempr3, 8);
	MR_tempr4 = MR_sv(2);
	MR_sv(14) = MR_tfield(1, MR_tempr4, 8);
	MR_sv(13) = MR_tfield(1, MR_tempr4, 7);
	MR_sv(12) = MR_tfield(1, MR_tempr4, 6);
	MR_sv(9) = MR_tfield(1, MR_tempr4, 5);
	* (MR_Float *) &MR_sv(8) = MR_word_to_float(MR_tfield(1, MR_tempr4, 4));
...
MR_def_label(__Compare___output_prof_info__output_prof_0_0,13)
	...
	MR_r1 = MR_float_to_word(MR_float_from_dword_ptr(&MR_sv(27)));
...
MR_def_label(__Compare___output_prof_info__output_prof_0_0,17)
	...
	MR_r1 = MR_float_to_word(MR_float_from_dword_ptr(&MR_sv(24)));
...
MR_def_label(__Compare___output_prof_info__output_prof_0_0,21)
	...
	MR_r1 = MR_float_to_word(MR_float_from_dword_ptr(&MR_sv(21)));
...
MR_def_label(__Compare___output_prof_info__output_prof_0_0,50)
	...
	* (MR_Float *) &MR_sv(37) = MR_word_to_float(MR_tfield(0, MR_tempr3, 2));
	* (MR_Float *) &MR_sv(35) = MR_word_to_float(MR_tfield(0, MR_tempr3, 3));
	* (MR_Float *) &MR_sv(33) = MR_word_to_float(MR_tfield(0, MR_tempr3, 4));
	* (MR_Float *) &MR_sv(31) = MR_word_to_float(MR_tfield(0, MR_tempr3, 5));
	MR_sv(29) = MR_tfield(0, MR_tempr3, 6);
	MR_sv(28) = MR_tfield(0, MR_tempr3, 7);
	MR_sv(25) = MR_tfield(0, MR_tempr3, 8);
	MR_sv(22) = MR_tfield(0, MR_tempr3, 9);
	MR_sv(19) = MR_tfield(0, MR_tempr3, 10);
	MR_sv(18) = MR_tfield(0, MR_tempr3, 11);
	MR_tempr4 = MR_sv(2);
	MR_sv(17) = MR_tfield(0, MR_tempr4, 11);
	MR_sv(16) = MR_tfield(0, MR_tempr4, 10);
	MR_sv(15) = MR_tfield(0, MR_tempr4, 9);
	MR_sv(14) = MR_tfield(0, MR_tempr4, 8);
	MR_sv(13) = MR_tfield(0, MR_tempr4, 7);
	MR_sv(12) = MR_tfield(0, MR_tempr4, 6);
	* (MR_Float *) &MR_sv(11) = MR_word_to_float(MR_tfield(0, MR_tempr4, 5));
...
MR_def_label(__Compare___output_prof_info__output_prof_0_0,56)
	...
	MR_r1 = MR_float_to_word(MR_float_from_dword_ptr(&MR_sv(37)));
	MR_r2 = MR_float_to_word(MR_float_from_dword_ptr(&MR_sv(4)));
	MR_np_call_localret_ent(private_builtin__builtin_compare_float_3_0,
...
MR_def_label(__Compare___output_prof_info__output_prof_0_0,64)
	...
	MR_r1 = MR_float_to_word(MR_float_from_dword_ptr(&MR_sv(33)));
	MR_r2 = MR_float_to_word(MR_float_from_dword_ptr(&MR_sv(8)));
	MR_np_call_localret_ent(private_builtin__builtin_compare_float_3_0,
...
MR_def_label(__Compare___output_prof_info__output_prof_0_0,68)
	...
	MR_r1 = MR_float_to_word(MR_float_from_dword_ptr(&MR_sv(31)));
	MR_r2 = MR_float_to_word(MR_float_from_dword_ptr(&MR_sv(11)));
	MR_np_call_localret_ent(private_builtin__builtin_compare_float_3_0,
...
MR_def_label(__Compare___output_prof_info__parent_0_0,2)
	...
	* (MR_Float *) &MR_sv(12) = MR_word_to_float(MR_tfield(0, MR_tempr3, 3));
	* (MR_Float *) &MR_sv(10) = MR_word_to_float(MR_tfield(0, MR_tempr3, 2));
