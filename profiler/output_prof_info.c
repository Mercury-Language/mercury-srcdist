  ...
  MR_Word HeadVar__2_2)
{
  ...
  else
  {
    ...
    if (succeeded)
    {
      TypeInfo__12_12 = (MR_Word) (&output_prof_info_scalar_common_1[2]);
      succeeded = mercury__builtin__unify_2_p_0(TypeInfo__12_12, ((MR_Box) (ArgX2_5)), ((MR_Box) (ArgY2_6)));
      if (succeeded)
      {
        TypeInfo__13_13 = (MR_Word) (&output_prof_info_scalar_common_1[2]);
            ...
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                ...
                if (succeeded)
                {
                  ...
                  if (succeeded)
                  {
                    TypeInfo__47_47 = (MR_Word) (&output_prof_info_scalar_common_1[0]);
                    succeeded = mercury__builtin__unify_2_p_0(TypeInfo__47_47, ((MR_Box) (ArgX8_41)), ((MR_Box) (ArgY8_42)));
                    if (succeeded)
                    {
                      TypeInfo__48_48 = (MR_Word) (&output_prof_info_scalar_common_1[1]);
                      succeeded = mercury__builtin__unify_2_p_0(TypeInfo__48_48, ((MR_Box) (ArgX9_43)), ((MR_Box) (ArgY9_44)));
                    }
                  }
                }
              }
              ...
              if (succeeded)
              {
                ...
                if (succeeded)
                {
                  ...
                  if (succeeded)
                  {
                    ...
                    if (succeeded)
                    {
                      TypeInfo__49_49 = (MR_Word) (&output_prof_info_scalar_common_1[0]);
                      succeeded = mercury__builtin__unify_2_p_0(TypeInfo__49_49, ((MR_Box) (ArgX9_19)), ((MR_Box) (ArgY9_20)));
                      if (succeeded)
                      {
                        TypeInfo__50_50 = (MR_Word) (&output_prof_info_scalar_common_1[1]);
                        succeeded = mercury__builtin__unify_2_p_0(TypeInfo__50_50, ((MR_Box) (ArgX10_21)), ((MR_Box) (ArgY10_22)));
                        if (succeeded)
                        {
                          TypeInfo__51_51 = (MR_Word) (&output_prof_info_scalar_common_1[0]);
                          succeeded = mercury__builtin__unify_2_p_0(TypeInfo__51_51, ((MR_Box) (ArgX11_23)), ((MR_Box) (ArgY11_24)));
                          if (succeeded)
                          {
                            TypeInfo__52_52 = (MR_Word) (&output_prof_info_scalar_common_1[1]);
                            succeeded = mercury__builtin__unify_2_p_0(TypeInfo__52_52, ((MR_Box) (ArgX12_25)), ((MR_Box) (ArgY12_26)));
                          }
                        }
                      }
                    }
