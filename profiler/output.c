...
MR_decl_label10(output__flat_profile_6_0, 44,4,5,7,6,9,10,11,12,13)
MR_decl_label4(output__flat_profile_6_0, 14,18,35,46)
...
MR_def_label(output__output_formatted_prof_node_5_0,6)
	...
	MR_tag_alloc_heap(MR_r2, 1, (MR_Integer) 2);
	MR_tfield(1, MR_r2, 0) = MR_r1;
	MR_tfield(1, MR_r2, 1) = (MR_Word) MR_TAG_COMMON(1,3,1);
	MR_tag_alloc_heap(MR_r1, 1, (MR_Integer) 2);
...
MR_BEGIN_MODULE(output_module11)
	...
	MR_init_label10(output__flat_profile_6_0,44,4,5,7,6,9,10,11,12,13)
	MR_init_label4(output__flat_profile_6_0,14,18,35,46)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(output_module16)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__output__IntroducedFrom__pred__output_formatted_cycle_parent_list__281__1_4_0);
...
MR_BEGIN_MODULE(output_module17)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__output__IntroducedFrom__pred__output_formatted_child_list__329__1_4_0);
