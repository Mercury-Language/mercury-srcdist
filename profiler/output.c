...
MR_decl_label8(output__call_graph_headers_2_0, 42,43,44,45,46,47,48,49)
MR_decl_label8(output__call_graph_headers_2_0, 50,51,52,53,54,55,56,57)
MR_decl_label8(output__call_graph_headers_2_0, 58,59,60,61,62,63,64,65)
MR_decl_label8(output__call_graph_headers_2_0, 66,67,68,69,70,71,72,73)
MR_decl_label7(output__call_graph_headers_2_0, 74,75,76,77,80,81,82)
MR_decl_label8(output__flat_headers_2_0, 2,3,4,5,6,7,8,9)
MR_decl_label8(output__flat_headers_2_0, 10,11,12,13,14,15,16,17)
MR_decl_label8(output__flat_headers_2_0, 18,19,20,21,22,23,24,25)
MR_decl_label8(output__flat_headers_2_0, 26,27,28,29,30,31,32,33)
MR_decl_label6(output__flat_headers_2_0, 34,35,36,37,38,39)
...
MR_decl_label8(output__output_profile_4_0, 2,3,4,5,6,7,8,11)
MR_decl_label5(output__output_profile_4_0, 9,13,14,15,16)
...
MR_BEGIN_MODULE(output_module2)
	...
	MR_init_label8(output__call_graph_headers_2_0,42,43,44,45,46,47,48,49)
	MR_init_label8(output__call_graph_headers_2_0,50,51,52,53,54,55,56,57)
	MR_init_label8(output__call_graph_headers_2_0,58,59,60,61,62,63,64,65)
	MR_init_label8(output__call_graph_headers_2_0,66,67,68,69,70,71,72,73)
	MR_init_label7(output__call_graph_headers_2_0,74,75,76,77,80,81,82)
MR_BEGIN_CODE
...
MR_def_label(output__output_formatted_prof_node_5_0,34)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(5) = (MR_Word) MR_CTOR0_ADDR(output_prof_info, parent);
	MR_r1 = MR_sv(5);
	MR_r2 = MR_sv(10);
...
MR_BEGIN_MODULE(output_module10)
	...
	MR_init_label8(output__flat_headers_2_0,18,19,20,21,22,23,24,25)
	MR_init_label8(output__flat_headers_2_0,26,27,28,29,30,31,32,33)
	MR_init_label6(output__flat_headers_2_0,34,35,36,37,38,39)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(output_module13)
	...
	MR_init_label8(output__output_profile_4_0,2,3,4,5,6,7,8,11)
	MR_init_label5(output__output_profile_4_0,9,13,14,15,16)
MR_BEGIN_CODE
...
/*-------------------------------------------------------------------------*/
/* code for 'IntroducedFrom__pred__output_formatted_cycle_parent_list__281__1'/4 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
...
/*-------------------------------------------------------------------------*/
/* code for 'IntroducedFrom__pred__output_formatted_child_list__329__1'/4 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
