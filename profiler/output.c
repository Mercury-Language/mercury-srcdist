...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(3), Var_37, 1) = ((MR_Box) (Name_15));
    }
    {
...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(3), Var_30, 1) = ((MR_Box) (Name_14));
    }
    {
...
{
  {
    ...
    Var_50 = mercury__string__f_43_43_2_f_0((MR_String) "calls\t\tthe number of times this ", (MR_String) "procedure was called.\n\n");
    ...
    Var_78 = mercury__string__f_43_43_2_f_0((MR_String) "name\t\tthe name of the procedure ", (MR_String) "followed by its index number.\n\n");
...
{
  {
    ...
    Var_101 = mercury__string__f_43_43_2_f_0((MR_String) "total\t\tthe number of times this procedure ", (MR_String) "is called by its parents.\n\n");
    ...
    Var_133 = mercury__string__f_43_43_2_f_0((MR_String) "total*\t\tthe number of times this child ", (MR_String) "is called by all procedures.\n\n");
