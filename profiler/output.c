...
MR_def_label(output__output_formatted_parent_list_5_0,41)
	...
	* (MR_Float *) &MR_sv(7) = MR_float_from_dword_ptr(&MR_tfield(0, MR_tempr1, 4));
	* (MR_Float *) &MR_sv(5) = MR_float_from_dword_ptr(&MR_tfield(0, MR_tempr1, 2));
...
MR_def_label(output__output_formatted_parent_list_5_0,13)
	...
	MR_Float MR_tempf1, MR_tempf2, MR_tempf3, MR_tempf4, MR_tempf5, MR_tempf6, MR_tempf7, MR_tempf8, MR_tempf9;
	MR_tag_alloc_heap(MR_tempr1, 0, (MR_Integer) 2);
	MR_tempf8 = MR_float_from_dword_ptr(&MR_sv(5));
	* (MR_Float *) &(MR_tfield(0, MR_tempr1, 0)) = MR_tempf8;
	MR_tag_alloc_heap(MR_tempr2, 0, (MR_Integer) 2);
	MR_tempf9 = MR_float_from_dword_ptr(&MR_sv(7));
	* (MR_Float *) &(MR_tfield(0, MR_tempr2, 0)) = MR_tempf9;
...
MR_def_static(output__output_formatted_prof_node_5_0)
	...
	* (MR_Float *) &MR_sv(15) = MR_float_from_dword_ptr(&MR_tfield(0, MR_tempr1, 2));
	* (MR_Float *) &MR_sv(18) = MR_float_from_dword_ptr(&MR_tfield(0, MR_tempr1, 6));
	* (MR_Float *) &MR_sv(4) = MR_float_from_dword_ptr(&MR_tfield(0, MR_tempr1, 8));
	MR_sv(5) = MR_tfield(0, MR_tempr1, 10);
	MR_sv(6) = MR_tfield(0, MR_tempr1, 11);
	MR_sv(7) = MR_tfield(0, MR_tempr1, 12);
	MR_sv(8) = MR_tfield(0, MR_tempr1, 13);
	MR_sv(9) = MR_tfield(0, MR_tempr1, 14);
	MR_sv(10) = MR_tfield(0, MR_tempr1, 15);
	}
...
MR_def_label(output__output_formatted_prof_node_5_0,17)
	...
	{
	MR_Word MR_tempr1, MR_tempr2, MR_tempr3, MR_tempr4, MR_tempr5, MR_tempr6, MR_tempr7;
	MR_Float MR_tempf1, MR_tempf2, MR_tempf3, MR_tempf4, MR_tempf5, MR_tempf6, MR_tempf7, MR_tempf8, MR_tempf9, MR_tempf10;
	MR_tag_alloc_heap(MR_tempr1, 2, (MR_Integer) 1);
	MR_tfield(2, MR_tempr1, 0) = MR_sv(12);
	MR_tag_alloc_heap(MR_tempr2, 0, (MR_Integer) 2);
	MR_tempf8 = MR_float_from_dword_ptr(&MR_sv(15));
	* (MR_Float *) &(MR_tfield(0, MR_tempr2, 0)) = MR_tempf8;
	MR_tag_alloc_heap(MR_tempr3, 0, (MR_Integer) 2);
	MR_tempf9 = MR_float_from_dword_ptr(&MR_sv(18));
	* (MR_Float *) &(MR_tfield(0, MR_tempr3, 0)) = MR_tempf9;
	MR_tag_alloc_heap(MR_tempr4, 0, (MR_Integer) 2);
	MR_tempf10 = MR_float_from_dword_ptr(&MR_sv(4));
	* (MR_Float *) &(MR_tfield(0, MR_tempr4, 0)) = MR_tempf10;
...
MR_def_label(output__flat_profile_6_0,5)
	...
	* (MR_Float *) &MR_sv(6) = MR_float_from_dword_ptr(&MR_tfield(0, MR_r2, 4));
	* (MR_Float *) &MR_sv(8) = MR_float_from_dword_ptr(&MR_tfield(0, MR_r2, 6));
	* (MR_Float *) &MR_sv(10) = MR_float_from_dword_ptr(&MR_tfield(0, MR_r2, 8));
...
MR_def_label(output__flat_profile_6_0,10)
	...
	* (MR_Float *) &MR_sv(16) = (MR_float_from_dword_ptr(&MR_sv(22)) + MR_f(1));
	MR_sv(11) = ((MR_Integer) MR_sv(12) + (MR_Integer) MR_sv(11));
	MR_tempf2 = MR_float_from_dword_ptr(&MR_sv(8));
	* (MR_Float *) &MR_sv(14) = (MR_tempf1 + MR_tempf2);
	MR_f(1) = MR_tempf2;
	MR_f(2) = MR_float_from_dword_ptr(&MR_sv(16));
	}
...
MR_def_label(output__flat_profile_6_0,11)
	...
	MR_tempf1 = MR_float_from_dword_ptr(&MR_sv(16));
	* (MR_Float *) &MR_sv(16) = MR_f(1);
	MR_f(1) = MR_float_from_dword_ptr(&MR_sv(10));
	MR_f(2) = MR_tempf1;
	}
	MR_np_call_localret_ent(fn__generate_output__checked_float_divide_2_0,
...
MR_def_label(output__flat_profile_6_0,12)
	...
	* (MR_Float *) &MR_sv(19) = ((MR_Float) 1000.0000000000000 * MR_f(1));
	MR_r1 = MR_sv(17);
	MR_r2 = MR_sv(4);
	MR_np_call_localret_ent(fn__output__construct_name_2_0,
...
MR_def_label(output__flat_profile_6_0,18)
	...
	MR_Float MR_tempf1, MR_tempf2, MR_tempf3, MR_tempf4, MR_tempf5, MR_tempf6, MR_tempf7, MR_tempf8, MR_tempf9, MR_tempf10, MR_tempf11, MR_tempf12, MR_tempf13, MR_tempf14;
	MR_tag_alloc_heap(MR_tempr1, 0, (MR_Integer) 2);
	MR_tempf10 = MR_float_from_dword_ptr(&MR_sv(6));
	* (MR_Float *) &(MR_tfield(0, MR_tempr1, 0)) = MR_tempf10;
	MR_tag_alloc_heap(MR_tempr2, 0, (MR_Integer) 2);
	MR_tempf11 = MR_float_from_dword_ptr(&MR_sv(14));
	* (MR_Float *) &(MR_tfield(0, MR_tempr2, 0)) = MR_tempf11;
	MR_tag_alloc_heap(MR_tempr3, 0, (MR_Integer) 2);
	MR_tempf12 = MR_float_from_dword_ptr(&MR_sv(8));
	* (MR_Float *) &(MR_tfield(0, MR_tempr3, 0)) = MR_tempf12;
	MR_tag_alloc_heap(MR_tempr4, 1, (MR_Integer) 1);
	MR_tfield(1, MR_tempr4, 0) = MR_sv(11);
	MR_tag_alloc_heap(MR_tempr5, 0, (MR_Integer) 2);
	MR_tempf13 = MR_float_from_dword_ptr(&MR_sv(16));
	* (MR_Float *) &(MR_tfield(0, MR_tempr5, 0)) = MR_tempf13;
	MR_tag_alloc_heap(MR_tempr6, 0, (MR_Integer) 2);
	MR_tempf14 = MR_float_from_dword_ptr(&MR_sv(19));
	* (MR_Float *) &(MR_tfield(0, MR_tempr6, 0)) = MR_tempf14;
...
MR_def_label(output__flat_profile_6_0,35)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(3);
	MR_f(1) = MR_float_from_dword_ptr(&MR_sv(14));
	MR_r2 = MR_sv(1);
	MR_r3 = MR_sv(2);
...
MR_def_static(output__IntroducedFrom__pred__output_formatted_child_list__330__1_4_0)
	...
	* (MR_Float *) &MR_sv(5) = MR_float_from_dword_ptr(&MR_tfield(0, MR_r2, 4));
	* (MR_Float *) &MR_sv(3) = MR_float_from_dword_ptr(&MR_tfield(0, MR_r2, 2));
	MR_r5 = MR_tfield(0, MR_r2, 1);
	MR_r6 = MR_tfield(0, MR_r2, 0);
	if (MR_INT_NE(MR_r5,0)) {
...
MR_def_label(output__IntroducedFrom__pred__output_formatted_child_list__330__1_4_0,11)
	...
	MR_Float MR_tempf1, MR_tempf2, MR_tempf3, MR_tempf4, MR_tempf5, MR_tempf6, MR_tempf7, MR_tempf8, MR_tempf9;
	MR_tag_alloc_heap(MR_tempr1, 0, (MR_Integer) 2);
	MR_tempf8 = MR_float_from_dword_ptr(&MR_sv(3));
	* (MR_Float *) &(MR_tfield(0, MR_tempr1, 0)) = MR_tempf8;
	MR_tag_alloc_heap(MR_tempr2, 0, (MR_Integer) 2);
	MR_tempf9 = MR_float_from_dword_ptr(&MR_sv(5));
	* (MR_Float *) &(MR_tfield(0, MR_tempr2, 0)) = MR_tempf9;
	MR_tag_alloc_heap(MR_tempr3, 1, (MR_Integer) 1);
...
void mercury__output__write_out_proc_statics(FILE *deep_fp, FILE *procrep_fp)
{
	MR_write_out_module_proc_reps_start(procrep_fp, &mercury_data__module_layout__output);
