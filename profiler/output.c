...
MR_decl_label8(output__flat_profile_6_0, 25,4,5,7,6,9,10,11)
MR_decl_label6(output__flat_profile_6_0, 12,13,14,15,16,27)
MR_decl_label3(output__output_alphabet_listing_2_3_0, 12,3,5)
MR_decl_label6(output__output_call_graph_5_0, 13,4,5,6,7,15)
MR_decl_label8(output__output_formatted_cycle_child_list_4_0, 19,4,6,7,8,9,10,21)
MR_decl_label8(output__output_formatted_parent_list_5_0, 19,4,6,7,8,9,10,21)
...
MR_BEGIN_MODULE(output_module5)
	...
	MR_init_label8(output__output_formatted_parent_list_5_0,19,4,6,7,8,9,10,21)
MR_BEGIN_CODE
...
MR_def_label(output__output_formatted_parent_list_5_0,19)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_def_label(output__output_formatted_parent_list_5_0,10)
	...
	MR_GOTO_LAB(output__output_formatted_parent_list_5_0_i19);
...
MR_BEGIN_MODULE(output_module6)
	...
	MR_init_label8(output__output_formatted_cycle_child_list_4_0,19,4,6,7,8,9,10,21)
MR_BEGIN_CODE
...
MR_def_label(output__output_formatted_cycle_child_list_4_0,19)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TEST(MR_r1,0,0)) {
...
MR_def_label(output__output_formatted_cycle_child_list_4_0,10)
	...
	MR_GOTO_LAB(output__output_formatted_cycle_child_list_4_0_i19);
...
MR_BEGIN_MODULE(output_module11)
	...
	MR_init_label8(output__flat_profile_6_0,25,4,5,7,6,9,10,11)
	MR_init_label6(output__flat_profile_6_0,12,13,14,15,16,27)
MR_BEGIN_CODE
...
MR_def_static(output__flat_profile_6_0)
	...
	MR_incr_sp(14);
	MR_sv(14) = (MR_Word) MR_succip;
MR_def_label(output__flat_profile_6_0,25)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TEST(MR_r1,0,0)) {
...
MR_def_label(output__flat_profile_6_0,16)
	...
	MR_r4 = MR_sv(3);
	MR_succip_word = MR_sv(14);
	MR_GOTO_LAB(output__flat_profile_6_0_i25);
...
MR_BEGIN_MODULE(output_module12)
	...
	MR_init_label3(output__output_alphabet_listing_2_3_0,12,3,5)
MR_BEGIN_CODE
...
MR_def_label(output__output_alphabet_listing_2_3_0,3)
	...
	MR_np_call_localret_ent(io__format_4_0,
		output__output_alphabet_listing_2_3_0_i5);
MR_def_label(output__output_alphabet_listing_2_3_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(1);
	MR_succip_word = MR_sv(2);
