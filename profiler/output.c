  ...
  MR_Word LambdaHeadVar__1_23)
{
  ...
  else
  {
    ...
    mercury__string__int_to_string_2_p_0(CycleNum_12, &CycleStr_48);
    {
      ...
      MR_hl_field(MR_mktag(1), Var_52, 0) = ((MR_Box) (CycleStr_48));
      MR_hl_field(MR_mktag(1), Var_52, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &output_scalar_common_2[1])));
    }
    {
      Var_50 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), Var_50, 0) = ((MR_Box) ((MR_String) "  <cycle "));
      MR_hl_field(MR_mktag(1), Var_50, 1) = ((MR_Box) (Var_52));
    }
    {
      Var_49 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), Var_49, 0) = ((MR_Box) (LabelName_11));
  ...
  MR_Word LambdaHeadVar__1_22)
{
  ...
  else
  {
    ...
    mercury__string__int_to_string_2_p_0(CycleNum_12, &CycleStr_41);
    {
      ...
      MR_hl_field(MR_mktag(1), Var_45, 0) = ((MR_Box) (CycleStr_41));
      MR_hl_field(MR_mktag(1), Var_45, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &output_scalar_common_2[1])));
    }
    {
      Var_43 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), Var_43, 0) = ((MR_Box) ((MR_String) "  <cycle "));
      MR_hl_field(MR_mktag(1), Var_43, 1) = ((MR_Box) (Var_45));
    }
    {
      Var_42 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), Var_42, 0) = ((MR_Box) (LabelName_11));
  ...
  MR_Word IndexMap_8)
{
  ...
  mercury__io__write_string_4_p_0(OutputStream_6, (MR_String) "\n\n\nalphabetic listing:\n\n");
  IndexList_39 = mercury__map__to_assoc_list_1_f_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0), IndexMap_8);
  output__output_alphabet_listing_2_4_p_0(OutputStream_6, IndexList_39);
}
  ...
  while (MR_TRUE)
  {
    ...
    if (!((HeadVar__2_2 == (MR_Word) ((MR_Unsigned) 0U))))
    {
      ...
      else
      {
        ...
        mercury__string__int_to_string_2_p_0(CycleNum_17, &CycleStr_61);
        {
          Var_65 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), Var_65, 0) = ((MR_Box) (CycleStr_61));
          MR_hl_field(MR_mktag(1), Var_65, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &output_scalar_common_2[1])));
        }
        {
        ...
        {
          Var_62 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), Var_62, 0) = ((MR_Box) (LabelName_16));
          MR_hl_field(MR_mktag(1), Var_62, 1) = ((MR_Box) (Var_63));
        }
        mercury__string__append_list_2_p_0(Var_62, &Name_22);
      }
