...
{
  {
    ...
    else
    {
      ...
      mercury__string__int_to_string_2_p_0(output__CycleNum_10, &output__CycleStr_67);
      {
        ...
        MR_hl_field(MR_mktag(1), output__Var_71, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &output_scalar_common_4[0])));
      }
      {
  ...
  while (MR_TRUE)
  {
    ...
    if (!((output__HeadVar__1_1 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))))))
    {
      ...
      mercury__string__int_to_string_2_p_0(output__Index_20, &output__IndexStr0_50);
      {
        ...
        MR_hl_field(MR_mktag(1), output__Var_61, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &output_scalar_common_4[1])));
      }
      {
...
{
  {
    ...
    mercury__string__int_to_string_2_p_0(output__Index_7, &output__IndexStr0_32);
    {
      ...
      MR_hl_field(MR_mktag(1), output__Var_45, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &output_scalar_common_4[1])));
    }
    {
...
{
  {
...

    {
      ...
      MR_hl_field(MR_mktag(0), output__Var_20, 0) = ((MR_Box) (&output_scalar_common_3[1]));
      ...
      if (!((output__HeadVar__1_1 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))))))
      {
        ...
        else
        {
          ...
          mercury__string__int_to_string_2_p_0(output__CycleNum_14, &output__CycleStr_61);
          {
            ...
            MR_hl_field(MR_mktag(1), output__Var_65, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &output_scalar_common_4[0])));
          }
          {
...
{
  {
    ...
    else
    {
      ...
      mercury__string__int_to_string_2_p_0(output__CycleNum_5, &output__CycleStr_7);
      {
        ...
        MR_hl_field(MR_mktag(1), output__Var_11, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &output_scalar_common_4[0])));
      }
      {
...
{
  {
...

    {
      ...
      MR_hl_field(MR_mktag(0), output__Var_18, 0) = ((MR_Box) (&output_scalar_common_3[0]));
