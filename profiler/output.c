...
MR_def_label(output__output_formatted_parent_list_5_0,13)
	...
	MR_tfield(2, MR_tempr5, 0) = MR_sv(7);
...
MR_def_label(output__output_formatted_prof_node_5_0,55)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(10) = (MR_Word) MR_CTOR0_ADDR(output_prof_info, child);
	MR_r1 = MR_sv(10);
	MR_r2 = MR_sv(6);
	MR_np_call_localret_ent(list__sort_2_0,
...
MR_def_label(output__flat_profile_6_0,10)
	...
	MR_Word MR_tempr1, MR_tempr2;
	MR_tempr1 = MR_sv(10);
	MR_sv(10) = MR_float_to_word((MR_word_to_float(MR_sv(13)) + MR_word_to_float(MR_r1)));
	MR_sv(8) = ((MR_Integer) MR_sv(9) + (MR_Integer) MR_sv(8));
	MR_tempr2 = MR_sv(6);
	MR_sv(9) = MR_float_to_word((MR_word_to_float(MR_tempr1) + MR_word_to_float(MR_tempr2)));
	MR_r1 = MR_tempr2;
	MR_r2 = MR_sv(10);
	}
...
MR_def_label(output__flat_profile_6_0,12)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(10) = MR_float_to_word(((MR_Float) 1000.0000000000000 * MR_word_to_float(MR_sv(10))));
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_sv(11);
	MR_sv(11) = MR_float_to_word(((MR_Float) 1000.0000000000000 * MR_word_to_float(MR_r1)));
	MR_r1 = MR_tempr1;
	MR_r2 = MR_sv(4);
	}
	MR_np_call_localret_ent(fn__output__construct_name_2_0,
...
MR_def_label(output__flat_profile_6_0,18)
	...
	MR_tfield(0, MR_tempr6, 0) = MR_sv(11);
...
MR_def_label(output__IntroducedFrom__pred__output_formatted_child_list__330__1_4_0,11)
	...
	MR_tag_alloc_heap(MR_tempr5, 2, (MR_Integer) 1);
	MR_tfield(2, MR_tempr5, 0) = MR_sv(6);
	MR_tag_alloc_heap(MR_tempr6, 1, (MR_Integer) 1);
	MR_tfield(1, MR_tempr6, 0) = MR_r1;
	MR_tag_alloc_heap(MR_tempr7, 1, (MR_Integer) 2);
	MR_tfield(1, MR_tempr7, 0) = MR_tempr6;
