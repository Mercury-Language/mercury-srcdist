...
{
  {
    ...
    else
    {
      ...
      else
      {
        ...
        if (succeeded)
        {
          MaybeModule_16 = (MR_Word) ((MR_Integer) 0);
          succeeded = MR_TRUE;
        }
        else
        {
...
{
  {
    ...
    switch (Category_6) {
      ...
      case (MR_Integer) 3:
        {
          if ((MaybeModule_7 == (MR_Word) ((MR_Integer) 0)))
          {
            MR_String Var_144;
            MR_String Var_151;
            MR_String Var_153;
...
{
  {
    ...
    if (succeeded)
    {
      ...
      {
        ModeNum1_6 = Int_4;
        MaybeInternalLabelNum0_7 = (MR_Word) ((MR_Integer) 0);
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                succeeded = (Category0_20 == (MR_Word) ((MR_Integer) 12));
                if (succeeded)
                {
        ...
        else
        {
          ...
          else
          {
            ...
            if (succeeded)
            {
              ...
              MaybeInternalLabelNum_13 = (MR_Word) ((MR_Integer) 0);
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          if ((MaybeModule0_19 == (MR_Word) ((MR_Integer) 0)))
          {
            MaybeModule_21 = (MR_Word) ((MR_Integer) 0);
            succeeded = MR_TRUE;
          }
          else
          {
...
{
  {
    ...
    if (succeeded)
    {
      ...
      *Category0_6 = (MR_Word) ((MR_Integer) 4);
      succeeded = MR_TRUE;
    }
    else
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          *Category0_6 = (MR_Word) ((MR_Integer) 8);
          succeeded = MR_TRUE;
        }
      }
      else
      {
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            ...
            *Category0_6 = (MR_Word) ((MR_Integer) 0);
            succeeded = MR_TRUE;
          }
        }
        else
        {
          *Category0_6 = (MR_Word) ((MR_Integer) 12);
...
{
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        {
          MaybeInternalLabelNum_6 = (MR_Word) ((MR_Integer) 0);
          ModeNum0_7 = Int_5;
            ...
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                ...
                if (succeeded)
                {
                  ...
                  Category0_9 = (MR_Word) ((MR_Integer) 4);
                  succeeded = MR_TRUE;
                }
                else
                {
                  ...
                  if (succeeded)
                  {
                    ...
                    if (succeeded)
                    {
                      ...
                      Category0_9 = (MR_Word) ((MR_Integer) 8);
                      succeeded = MR_TRUE;
                    }
                  }
                  else
                  {
                    ...
                    if (succeeded)
                    {
                      ...
                      if (succeeded)
                      {
                        ...
                        Category0_9 = (MR_Word) ((MR_Integer) 0);
                        succeeded = MR_TRUE;
                      }
                    }
                    else
                    {
                      Category0_9 = (MR_Word) ((MR_Integer) 12);
                ...
                if (succeeded)
                {
                  ...
                  if (succeeded)
                  {
                    ...
                    if (succeeded)
                    {
                      succeeded = (Category0_9 == (MR_Word) ((MR_Integer) 12));
                      succeeded = !(succeeded);
                    }
                    if (succeeded)
                    {
...
{
  {
    ...
    {
      *MaybeModule_5 = (MR_Word) ((MR_Integer) 0);
...
{
  {
    ...
    if ((HigherOrder_17 == (MR_Word) ((MR_Integer) 0)))
      HOStr_29 = (MR_String) "";
    else
    {
    ...
    if ((UnusedArgs_18 == (MR_Word) ((MR_Integer) 0)))
      UAStr_32 = (MR_String) "";
    else
    {
    ...
    if ((MaybeInternalLabelNum_19 == (MR_Word) ((MR_Integer) 0)))
...
{
  {
    ...
    if (succeeded)
    {
      ...
      IntroducedPredType0_11 = (MR_Word) ((MR_Integer) 0);
      succeeded = MR_TRUE;
    }
    else
    {
      ...
      if (succeeded)
      {
        ...
        IntroducedPredType0_11 = (MR_Word) ((MR_Integer) 4);
        succeeded = MR_TRUE;
      }
      else
      {
        ...
        if (succeeded)
        {
          ...
          IntroducedPredType0_11 = (MR_Word) ((MR_Integer) 8);
          succeeded = MR_TRUE;
        }
        else
        {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        else
        {
          ...
          MPredName_14 = (MR_Word) ((MR_Integer) 0);
        }
        ...
        {
          *Category_8 = (MR_Word) ((MR_Integer) 12);
...
{
  {
    ...
    {
      *HigherOrder_6 = (MR_Word) ((MR_Integer) 0);
...
{
  {
    ...
    else
    {
      ...
      {
        *UnusedArgs_6 = (MR_Word) ((MR_Integer) 0);
        *ModeNum_8 = ModeNum0_7;
        *STATE_VARIABLE_Str_12 = STATE_VARIABLE_Str_0_11;
      }
    }
