  ...
  MR_String * Name_4)
{
  ...
  if (succeeded)
  {
    ...
    if (succeeded)
    {
      ...
      {
        MaybeInternalLabelNum0_21 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(1, MaybeInternalLabelNum0_21, 0) = ((MR_Box) (Int_18));
      }
    }
    else
    {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ModeNum2_26 = ((MR_Integer) ((MR_hl_field(1, MaybeInternalLabelNum0_21, (MR_Integer) 0))));
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          STATE_VARIABLE_Str_48_60 = STATE_VARIABLE_Str_15_74;
          {
            ...
            MR_hl_field(0, Var_75, 0) = ((MR_Box) (ModeNum2_26));
            MR_hl_field(0, Var_75, 1) = ((MR_Box) ((MR_Integer) 0));
          }
          {
            UnusedArgs_28 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(1, UnusedArgs_28, 0) = ((MR_Box) (Var_75));
          }
        ...
        else
        {
          ...
          if (succeeded)
          {
            ...
            STATE_VARIABLE_Str_48_60 = STATE_VARIABLE_Str_21_80;
            {
              ...
              MR_hl_field(0, Var_81, 0) = ((MR_Box) (ModeNum2_26));
              MR_hl_field(0, Var_81, 1) = ((MR_Box) ((MR_Integer) 1));
            }
            {
              UnusedArgs_28 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(1, UnusedArgs_28, 0) = ((MR_Box) (Var_81));
            }
        ...
        if (succeeded)
        {
          ...
          {
            HigherOrder_30 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(1, HigherOrder_30, 0) = ((MR_Box) (HO_Num_85));
          }
        }
        else
        {
        ...
        if (succeeded)
        {
          Var_63 = (MR_Word) (MR_mkword(1, &demangle_scalar_common_1[10]));
            ...
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                ...
                if (succeeded)
                {
                  ...
                  {
                    MR_String ModuleName0_36 = ((MR_String) ((MR_hl_field(1, MaybeModule0_33, (MR_Integer) 0))));
                    ...
                    {
                      {
                        MaybeModule_35 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                        MR_hl_field(1, MaybeModule_35, 0) = ((MR_Box) (ModuleName_37));
                      }
                      succeeded = MR_TRUE;
                    }
                  }
  ...
  MR_String * STATE_VARIABLE_Str_12)
{
  ...
  demangle__remove_maybe_module_prefix_4_p_0(&MaybeModule0_5, (MR_Word) (MR_mkword(1, &demangle_scalar_common_1[14])), STATE_VARIABLE_Str_16_16, &STATE_VARIABLE_Str_18_18);
