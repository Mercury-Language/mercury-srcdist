      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            ...
            {
              Digit_48 = ((&demangle_vector_common_3[60 + (MR_Integer) ((MR_Unsigned) Char_54 - (MR_Unsigned) 48)]))->demangle__vector_common_type_3_0__vct_3_f_0;
              succeeded = MR_TRUE;
            }
            else
              succeeded = MR_FALSE;
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          {
            Digit_53 = ((&demangle_vector_common_3[50 + (MR_Integer) ((MR_Unsigned) Char_59 - (MR_Unsigned) 48)]))->demangle__vector_common_type_3_0__vct_3_f_0;
            succeeded = MR_TRUE;
          }
          else
            succeeded = MR_FALSE;
  ...
  MR_String * STATE_VARIABLE_Str_7)
{
  ...
  if (succeeded)
  {
    ...
    {
      Digit_17 = ((&demangle_vector_common_3[40 + (MR_Integer) ((MR_Unsigned) Char_23 - (MR_Unsigned) 48)]))->demangle__vector_common_type_3_0__vct_3_f_0;
      succeeded = MR_TRUE;
    }
    else
      succeeded = MR_FALSE;
      ...
      if (succeeded)
      {
        ...
        else
        {
          ...
          if (succeeded)
          {
            ...
            {
              Digit_72 = ((&demangle_vector_common_3[20 + (MR_Integer) ((MR_Unsigned) Char_78 - (MR_Unsigned) 48)]))->demangle__vector_common_type_3_0__vct_3_f_0;
              succeeded = MR_TRUE;
            }
            else
              succeeded = MR_FALSE;
              ...
              if (succeeded)
              {
                ...
                if (succeeded)
                {
                  ...
                  if (succeeded)
                  {
                    ...
                    {
                      Digit_83 = ((&demangle_vector_common_3[30 + (MR_Integer) ((MR_Unsigned) Char_89 - (MR_Unsigned) 48)]))->demangle__vector_common_type_3_0__vct_3_f_0;
                      succeeded = MR_TRUE;
                    }
                    else
                      succeeded = MR_FALSE;
  ...
  MR_String * STATE_VARIABLE_Str_11)
{
  while (MR_TRUE)
  {
    ...
    if (succeeded)
    {
      ...
      {
        Next_8 = ((&demangle_vector_common_3[10 + (MR_Integer) ((MR_Unsigned) Char_19 - (MR_Unsigned) 48)]))->demangle__vector_common_type_3_0__vct_3_f_0;
        succeeded = MR_TRUE;
      }
      else
        succeeded = MR_FALSE;
