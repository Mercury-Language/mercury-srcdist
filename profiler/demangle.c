...
MR_decl_label8(demangle__demangle_proc_hl_2_0, 3,2,6,9,11,8,14,16)
MR_decl_label8(demangle__demangle_proc_hl_2_0, 15,19,18,22,24,26,23,31)
MR_decl_label8(demangle__demangle_proc_hl_2_0, 33,34,38,35,53,54,59,56)
MR_decl_label8(demangle__demangle_proc_hl_2_0, 61,63,67,70,71,74,76,77)
MR_decl_label2(demangle__demangle_proc_hl_2_0, 78,1)
...
MR_BEGIN_MODULE(demangle_module13)
	...
	MR_init_label8(demangle__demangle_proc_hl_2_0,3,2,6,9,11,8,14,16)
	MR_init_label8(demangle__demangle_proc_hl_2_0,15,19,18,22,24,26,23,31)
	MR_init_label8(demangle__demangle_proc_hl_2_0,33,34,38,35,53,54,59,56)
	MR_init_label8(demangle__demangle_proc_hl_2_0,61,63,67,70,71,74,76,77)
	MR_init_label2(demangle__demangle_proc_hl_2_0,78,1)
MR_BEGIN_CODE
...
MR_def_label(demangle__demangle_proc_hl_2_0,15)
	...
	MR_np_call_localret_ent(string__remove_suffix_3_0,
		demangle__demangle_proc_hl_2_0_i19);
MR_def_label(demangle__demangle_proc_hl_2_0,19)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(demangle__demangle_proc_hl_2_0_i18);
	}
...
MR_def_label(demangle__demangle_proc_hl_2_0,24)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(demangle__demangle_proc_hl_2_0_i23);
	}
	MR_r1 = MR_r2;
	MR_np_call_localret_ent(demangle__remove_trailing_int_3_0,
...
MR_def_label(demangle__demangle_proc_hl_2_0,26)
	...
	MR_np_call_localret_ent(string__remove_suffix_3_0,
		demangle__demangle_proc_hl_2_0_i31);
MR_def_label(demangle__demangle_proc_hl_2_0,23)
	...
	MR_np_call_localret_ent(string__remove_suffix_3_0,
		demangle__demangle_proc_hl_2_0_i31);
MR_def_label(demangle__demangle_proc_hl_2_0,31)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(demangle__demangle_proc_hl_2_0_i1);
	}
...
MR_def_label(demangle__demangle_proc_hl_2_0,34)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TEST(MR_sv(2),0,0)) {
		MR_GOTO_LAB(demangle__demangle_proc_hl_2_0_i35);
	}
	if (MR_INT_NE(MR_sv(4),0)) {
		MR_GOTO_LAB(demangle__demangle_proc_hl_2_0_i35);
	}
...
MR_def_label(demangle__demangle_proc_hl_2_0,35)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(6) = MR_r1;
	MR_sv(7) = MR_r2;
	MR_r2 = MR_r3;
...
MR_def_label(demangle__demangle_proc_hl_2_0,54)
	...
	if (MR_LTAGS_TEST(MR_r2,0,3)) {
		MR_GOTO_LAB(demangle__demangle_proc_hl_2_0_i56);
	}
	MR_sv(9) = MR_r2;
	MR_r1 = (MR_Word) MR_string_const("__", 2);
	MR_r2 = MR_r3;
...
MR_def_label(demangle__demangle_proc_hl_2_0,59)
	...
	MR_r1 = MR_r2;
	MR_GOTO_LAB(demangle__demangle_proc_hl_2_0_i61);
MR_def_label(demangle__demangle_proc_hl_2_0,56)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(9) = MR_r2;
	MR_r1 = MR_r3;
MR_def_label(demangle__demangle_proc_hl_2_0,61)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_sv(4),0)) {
		MR_GOTO_LAB(demangle__demangle_proc_hl_2_0_i63);
	}
...
MR_def_label(demangle__demangle_proc_hl_2_0,67)
	...
	if (MR_LTAGS_TESTR(MR_sv(8),0,0)) {
		MR_GOTO_LAB(demangle__demangle_proc_hl_2_0_i70);
	}
	MR_r1 = MR_sv(9);
...
MR_def_label(demangle__demangle_proc_hl_2_0,70)
	...
	MR_np_call_localret_ent(demangle__fix_mangled_ascii_2_0,
		demangle__demangle_proc_hl_2_0_i71);
MR_def_label(demangle__demangle_proc_hl_2_0,71)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(demangle__demangle_proc_hl_2_0_i1);
	}
...
MR_def_label(demangle__demangle_proc_hl_2_0,76)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_np_call_localret_ent(string__append_list_2_0,
		demangle__demangle_proc_hl_2_0_i77);
MR_def_label(demangle__demangle_proc_hl_2_0,77)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
