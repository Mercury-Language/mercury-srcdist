              ...
              case (MR_Integer) 1:
                {
                  ...
                  else
                  {
                    ...
                    mercury__private_builtin__builtin_compare_int_3_p_0(&SubResult2_41, Var_55, ArgY2_40);
                    ...
                    else
                    {
                      ...
                      mercury__private_builtin__builtin_compare_int_3_p_0(&SubResult3_44, Var_54, ArgY3_43);
...
{
  {
    ...
    else
    {
      ...
      else
      {
        ...
        succeeded = ((MR_tag((MR_Word) MaybeModule0_15)) == (MR_Integer) 1);
        if (succeeded)
        {
      ...
      case (MR_Integer) 0:
        {
          ...
          succeeded = ((MR_tag((MR_Word) MaybeModule_7)) == (MR_Integer) 1);
          if (succeeded)
          {
    ...
    if (succeeded)
    {
      ...
      else
      {
        ...
        else
        {
          ...
          {
            Arity_11 = ModeNum1_6;
            succeeded = ((MR_tag((MR_Word) MaybeInternalLabelNum0_7)) == (MR_Integer) 1);
            if (succeeded)
            {
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              ...
              succeeded = ((MR_tag((MR_Word) UnusedArgs_14)) == (MR_Integer) 1);
              if (succeeded)
              {
                {
                  MR_Integer Var_118;
              ...
              if (succeeded)
              {
                ...
                if (succeeded)
                {
                  ...
                  if (succeeded)
                  {
                    ...
                    succeeded = ((MR_tag((MR_Word) UnusedArgs_10)) == (MR_Integer) 1);
                    if (succeeded)
                    {
                    ...
                    if (succeeded)
                    {
                      ...
                      else
                      {
                        ...
                        if (succeeded)
                        {
                          ...
                          succeeded = ((MR_tag((MR_Word) MaybeModule_15)) == (MR_Integer) 1);
                          if (succeeded)
                          {
...
{
  {
    ...
    else
    {
      ...
      if ((env).demangle__remove_maybe_module_prefix_4_p_0_env_0__succeeded)
      {
        ...
        (env).demangle__remove_maybe_module_prefix_4_p_0_env_0__succeeded = ((MR_tag((MR_Word) Var_20)) == (MR_Integer) 1);
        if ((env).demangle__remove_maybe_module_prefix_4_p_0_env_0__succeeded)
        {
...
{
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        succeeded = ((MR_tag((MR_Word) MPredName_14)) == (MR_Integer) 1);
        if (succeeded)
        {
