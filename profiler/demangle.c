  ...
  MR_String * STATE_VARIABLE_Str_12)
{
  ...
  {
    MR_String STATE_VARIABLE_Str_8_55;

    HighLevel_4 = (MR_Integer) 1;
    succeeded = mercury__string__remove_prefix_3_p_0((MR_String) "mercury__", STATE_VARIABLE_Str_0_11, &STATE_VARIABLE_Str_8_55);
    if (succeeded)
      STATE_VARIABLE_Str_16_16 = STATE_VARIABLE_Str_8_55;
    else
              ...
              if (succeeded)
              {
                ...
                if (succeeded)
                {
                  ...
                  if (succeeded)
                  {
                    ...
                    {
                      Var_81 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
                      MR_hl_field(MR_mktag(0), Var_81, 0) = ((MR_Box) (ModeNum0_7));
                    ...
                    }
                    {
                      ...
                      MR_hl_field(MR_mktag(1), UnusedArgs_10, 0) = ((MR_Box) (Var_81));
                    }
                  ...
                  else
                  {
                    ...
                    if (succeeded)
                    {
                      ...
                      STATE_VARIABLE_Str_40_40 = STATE_VARIABLE_Str_21_86;
                      {
                        ...
                        MR_hl_field(MR_mktag(0), Var_87, 0) = ((MR_Box) (ModeNum0_7));
                        MR_hl_field(MR_mktag(0), Var_87, 1) = ((MR_Box) ((MR_Integer) 1));
                      }
                      {
                        UnusedArgs_10 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                        MR_hl_field(MR_mktag(1), UnusedArgs_10, 0) = ((MR_Box) (Var_87));
                      }
                  ...
                  if (succeeded)
                  {
                    STATE_VARIABLE_Str_41_41 = STATE_VARIABLE_Str_15_94;
                    {
                      ...
                      MR_hl_field(MR_mktag(1), HigherOrder_12, 0) = ((MR_Box) (HO_Num_91));
                    }
                  }
                  else
                  {
