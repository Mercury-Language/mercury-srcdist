...
{
  {
    ...
    Len1_21 = (MR_Integer) ((MR_Unsigned) Len_20 - (MR_Unsigned) (MR_Integer) 1);
    succeeded = mercury__string__index_3_p_0(String0_5, Len1_21, &Char_16);
    if (succeeded)
    {
      mercury__string__left_3_p_0(String0_5, Len1_21, &String1_8);
      if ((((MR_Unsigned) (MR_Integer) ((MR_Unsigned) Char_16 - (MR_Unsigned) (MR_Integer) 48)) <= ((MR_Unsigned) (MR_Integer) 9)))
      {
        Digit_7 = ((&demangle_vector_common_2[0 + (MR_Integer) ((MR_Unsigned) Char_16 - (MR_Unsigned) (MR_Integer) 48)]))->demangle__vector_common_type_2_0__vct_2_f_0;
        succeeded = MR_TRUE;
      }
      else
        succeeded = MR_FALSE;
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          MR_Integer Var_11 = (MR_Integer) ((MR_Unsigned) Rest_9 * (MR_Unsigned) (MR_Integer) 10);
