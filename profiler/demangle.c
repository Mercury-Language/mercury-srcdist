  ...
  MR_String * STATE_VARIABLE_Str_5)
{
  ...
  MR_String STATE_VARIABLE_Str_8_81;
  ...
  succeeded = mercury__string__remove_prefix_3_p_0((MR_String) "mercury__", STATE_VARIABLE_Str_0_4, &STATE_VARIABLE_Str_8_81);
  if (succeeded)
    STATE_VARIABLE_Str_31_38 = STATE_VARIABLE_Str_8_81;
  else
  ...
  if (succeeded)
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        MR_Integer ModeNum3_150;
        MR_String STATE_VARIABLE_Str_43_152;
        MR_String STATE_VARIABLE_Str_47_153;
        MR_String STATE_VARIABLE_Str_48_154;
        MR_String STATE_VARIABLE_Str_50_155;
        MR_String STATE_VARIABLE_Str_52_156;
        MR_String STATE_VARIABLE_Str_65_157;

        PredOrFunc_17 = (MR_String) "predicate";
        succeeded = mercury__string__remove_suffix_3_p_0(STATE_VARIABLE_Str_40_47, (MR_String) "_", &STATE_VARIABLE_Str_43_152);
        if (succeeded)
        {
          succeeded = demangle__remove_trailing_int_3_p_0(&Arity_20, STATE_VARIABLE_Str_43_152, &STATE_VARIABLE_Str_45_52);
          if (succeeded)
          {
            MaybeInternalLabelNum_22 = MaybeInternalLabelNum0_16;
            succeeded = mercury__string__remove_suffix_3_p_0(STATE_VARIABLE_Str_45_52, Var_53, &STATE_VARIABLE_Str_47_153);
            if (succeeded)
            {
              demangle__demangle_unused_args_5_p_0(&UnusedArgs_23, ModeNum1_15, &ModeNum3_150, STATE_VARIABLE_Str_47_153, &STATE_VARIABLE_Str_48_154);
              demangle__demangle_higher_order_5_p_0(&HigherOrder_25, ModeNum3_150, &ModeNum_26, STATE_VARIABLE_Str_48_154, &STATE_VARIABLE_Str_50_155);
              demangle__remove_maybe_module_prefix_4_p_0(&MaybeModule0_28, Var_58, STATE_VARIABLE_Str_50_155, &STATE_VARIABLE_Str_52_156);
              succeeded = demangle__handle_compiler_generated_pred_4_p_0(ModeNum_26, &Category0_29, STATE_VARIABLE_Str_52_156, &STATE_VARIABLE_Str_65_157);
              if (succeeded)
              {
                succeeded = (Category0_29 == (MR_Word) ((MR_Unsigned) 12U));
                if (succeeded)
                {
                  STATE_VARIABLE_Str_67_74 = STATE_VARIABLE_Str_65_157;
                  succeeded = MR_TRUE;
                }
                else
                  succeeded = mercury__string__remove_prefix_3_p_0((MR_String) "__", STATE_VARIABLE_Str_65_157, &STATE_VARIABLE_Str_67_74);
                if (succeeded)
                  succeeded = (Category0_29 == (MR_Word) ((MR_Unsigned) 12U));
              }
            }
      ...
      {
        MR_Integer ModeNum2_130;
        MR_Integer ModeNum3_131;
        MR_String STATE_VARIABLE_Str_45_137;
        MR_String STATE_VARIABLE_Str_47_138;
        MR_String STATE_VARIABLE_Str_48_139;
        MR_String STATE_VARIABLE_Str_49_140;
        MR_String STATE_VARIABLE_Str_50_141;
        MR_String STATE_VARIABLE_Str_52_142;
        MR_String STATE_VARIABLE_Str_65_143;
        MR_Integer Arity0_118;
        MR_String STATE_VARIABLE_Str_44_121;
        MR_String STATE_VARIABLE_Str_43_117;

        PredOrFunc_17 = (MR_String) "predicate";
        succeeded = mercury__string__remove_suffix_3_p_0(STATE_VARIABLE_Str_36_43, (MR_String) "_", &STATE_VARIABLE_Str_43_117);
        if (succeeded)
          succeeded = demangle__remove_trailing_int_3_p_0(&Arity0_118, STATE_VARIABLE_Str_43_117, &STATE_VARIABLE_Str_44_121);
        if (succeeded)
        {
          STATE_VARIABLE_Str_45_137 = STATE_VARIABLE_Str_44_121;
          Arity_20 = Arity0_118;
          ModeNum2_130 = ModeNum1_15;
          MaybeInternalLabelNum_22 = MaybeInternalLabelNum0_16;
          succeeded = MR_TRUE;
        }
        else
        {
          ...
          if (succeeded)
          {
            ModeNum2_130 = ((MR_Integer) ((MR_hl_field(MR_mktag(1), MaybeInternalLabelNum0_16, (MR_Integer) 0))));
            MaybeInternalLabelNum_22 = (MR_Word) ((MR_Unsigned) 0U);
            STATE_VARIABLE_Str_45_137 = STATE_VARIABLE_Str_36_43;
            succeeded = MR_TRUE;
          }
        }
        if (succeeded)
        {
          succeeded = mercury__string__remove_suffix_3_p_0(STATE_VARIABLE_Str_45_137, Var_53, &STATE_VARIABLE_Str_47_138);
          if (succeeded)
          {
            demangle__demangle_unused_args_5_p_0(&UnusedArgs_23, ModeNum2_130, &ModeNum3_131, STATE_VARIABLE_Str_47_138, &STATE_VARIABLE_Str_48_139);
            demangle__demangle_higher_order_5_p_0(&HigherOrder_25, ModeNum3_131, &ModeNum_26, STATE_VARIABLE_Str_48_139, &STATE_VARIABLE_Str_49_140);
            succeeded = (UnusedArgs_23 != (MR_Word) ((MR_Unsigned) 0U));
            if (succeeded)
            {
              MR_Integer Var_123;

              succeeded = demangle__remove_trailing_int_3_p_0(&Var_123, STATE_VARIABLE_Str_49_140, &STATE_VARIABLE_Str_50_141);
              if (succeeded)
                succeeded = (Arity_20 == Var_123);
            }
            else
            {
              STATE_VARIABLE_Str_50_141 = STATE_VARIABLE_Str_49_140;
              succeeded = MR_TRUE;
            }
            if (succeeded)
            {
              demangle__remove_maybe_module_prefix_4_p_0(&MaybeModule0_28, Var_58, STATE_VARIABLE_Str_50_141, &STATE_VARIABLE_Str_52_142);
              succeeded = demangle__handle_compiler_generated_pred_4_p_0(ModeNum_26, &Category0_29, STATE_VARIABLE_Str_52_142, &STATE_VARIABLE_Str_65_143);
              if (succeeded)
              {
                succeeded = (Category0_29 == (MR_Word) ((MR_Unsigned) 12U));
                if (succeeded)
                {
                  STATE_VARIABLE_Str_67_74 = STATE_VARIABLE_Str_65_143;
                  succeeded = MR_TRUE;
                }
                else
                  succeeded = mercury__string__remove_prefix_3_p_0((MR_String) "__", STATE_VARIABLE_Str_65_143, &STATE_VARIABLE_Str_67_74);
                if (succeeded)
                  succeeded = (Category0_29 != (MR_Word) ((MR_Unsigned) 12U));
              }
            }
  ...
  MR_String * STATE_VARIABLE_Str_12)
{
  ...
  {
    MR_String STATE_VARIABLE_Str_8_59;

    HighLevel_4 = (MR_Integer) 1;
    succeeded = mercury__string__remove_prefix_3_p_0((MR_String) "mercury__", STATE_VARIABLE_Str_0_11, &STATE_VARIABLE_Str_8_59);
    if (succeeded)
      STATE_VARIABLE_Str_16_16 = STATE_VARIABLE_Str_8_59;
    else
  ...
  MR_String * STATE_VARIABLE_Str_21)
{
  ...
  MR_String Var_28;
  MR_String STATE_VARIABLE_Str_11_89;
  MR_String Var_88;
  MR_String _Str_18;
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              Var_88 = (MR_String) "__Unify__";
              succeeded = mercury__string__remove_prefix_3_p_0(Var_88, STATE_VARIABLE_Str_37_37, &STATE_VARIABLE_Str_11_89);
              if (succeeded)
              {
                STATE_VARIABLE_Str_38_38 = STATE_VARIABLE_Str_11_89;
                Category0_9 = (MR_Word) ((MR_Unsigned) 4U);
                succeeded = MR_TRUE;
              }
              else
              {
                MR_String STATE_VARIABLE_Str_13_91;

                succeeded = mercury__string__remove_prefix_3_p_0((MR_String) "__Compare__", STATE_VARIABLE_Str_37_37, &STATE_VARIABLE_Str_13_91);
                if (succeeded)
                {
                  succeeded = (ModeNum0_7 == (MR_Integer) 0);
                  if (succeeded)
                  {
                    STATE_VARIABLE_Str_38_38 = STATE_VARIABLE_Str_13_91;
                ...
                {
                  MR_String STATE_VARIABLE_Str_15_93;

                  succeeded = mercury__string__remove_prefix_3_p_0((MR_String) "__Index__", STATE_VARIABLE_Str_37_37, &STATE_VARIABLE_Str_15_93);
                  if (succeeded)
                  {
                    succeeded = (ModeNum0_7 == (MR_Integer) 0);
                    if (succeeded)
                    {
                      STATE_VARIABLE_Str_38_38 = STATE_VARIABLE_Str_15_93;
