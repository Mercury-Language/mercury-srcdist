...
MR_decl_label4(__Compare___globals__globals_0_0, 3,2,5,27)
...
MR_BEGIN_MODULE(globals_module22)
	...
	MR_init_label4(__Compare___globals__globals_0_0,3,2,5,27)
MR_BEGIN_CODE
...
MR_def_label(__Compare___globals__globals_0_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___globals__globals_0_0_i27);
	}
	MR_r1 = (MR_Word) MR_TAG_COMMON(0,0,0);
	MR_r2 = MR_sv(1);
	MR_r3 = MR_sv(2);
...
MR_def_label(__Compare___globals__globals_0_0,27)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(3);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
