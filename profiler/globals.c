...
#line 162 "globals.m"
void 
globals__user_init_pred_52_0(void)
#line 162 "globals.m"
{
#line 162 "globals.m"
...
#undef MR_PROC_LABEL
  ...
  Var_33 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Globals0_8, (MR_Integer) 0))) & (MR_Integer) 7);
  {
    Globals_11 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(MR_mktag(0), Globals_11, 0) = (MR_Box) ((MR_Unsigned) (Var_33));
...
{
  MR_Word Var_9 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_Globals_0_6, (MR_Integer) 0))) & (MR_Integer) 7);

  {
    MR_Word base;
    base = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
    *STATE_VARIABLE_Globals_7 = base;
    MR_hl_field(MR_mktag(0), base, 0) = (MR_Box) ((MR_Unsigned) (Var_9));
