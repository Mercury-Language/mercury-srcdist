...
#undef MR_PROC_LABEL
  ...
  Var_4 = mercury__map__init_0_f_0((MR_Word) (&options__options__type_ctor_info_option_0), (MR_Word) (&mercury__getopt__getopt__type_ctor_info_option_data_0));
  {
    X_1 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(MR_mktag(0), X_1, 0) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 3));
    MR_hl_field(MR_mktag(0), X_1, 1) = ((MR_Box) (Var_4));
  }
{
#define MR_PROC_LABEL globals__initialise_mutable_profiler_globals_0_p_0
...
#undef MR_PROC_LABEL
  ...
  Var_30 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Globals0_8, (MR_Integer) 0))) & (MR_Integer) 7);
  {
    Globals_11 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(MR_mktag(0), Globals_11, 0) = (MR_Box) ((MR_Unsigned) (Var_30));
...
{
  MR_Word Var_8 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_Globals_0_6, (MR_Integer) 0))) & (MR_Integer) 7);

  {
    MR_Word base;
    base = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
    *STATE_VARIABLE_Globals_7 = base;
    MR_hl_field(MR_mktag(0), base, 0) = (MR_Box) ((MR_Unsigned) (Var_8));
...
globals__set_what_to_profile_3_p_0(
  ...
  MR_Word * STATE_VARIABLE_Globals_7)
{
  MR_Word Var_9 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_Globals_0_6, (MR_Integer) 1))));
