...
MR_decl_label1(globals__io_init_3_0, 3)
...
MR_decl_label6(globals__io_set_option_4_0, 2,4,3,7,8,10)
...
MR_decl_label6(globals__what_to_profile_2_0, 3,4,5,6,7,1)
MR_decl_label5(globals__what_to_profile_2_1, 3,4,5,6,7)
MR_decl_label2(__Unify___globals__globals_0_0, 6,1)
MR_decl_label4(__Compare___globals__globals_0_0, 3,2,5,21)
...
static const MR_EnumFunctorDesc mercury_data_globals__enum_functor_desc_what_to_profile_0_5 = {
	"real_time",
	5
};
...
const MR_EnumFunctorDescPtr mercury_data_globals__enum_value_ordered_what_to_profile_0[] = {
	...
	&mercury_data_globals__enum_functor_desc_what_to_profile_0_5
};
...
MR_BEGIN_MODULE(globals_module0)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__globals__what_to_profile_2_0);
	MR_init_label6(globals__what_to_profile_2_0,3,4,5,6,7,1)
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'what_to_profile'/2 mode 0 */
...
MR_define_entry(mercury__globals__what_to_profile_2_0);
	...
	if ((strcmp((char *) (MR_Word *) MR_r1, MR_string_const("real-time", 9)) != 0)) {
...
MR_def_label(globals__what_to_profile_2_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if ((strcmp((char *) (MR_Word *) MR_r1, MR_string_const("user-time", 9)) != 0)) {
...
MR_def_label(globals__what_to_profile_2_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if ((strcmp((char *) (MR_Word *) MR_r1, MR_string_const("memory-cells", 12)) != 0)) {
...
MR_def_label(globals__what_to_profile_2_0,6)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if ((strcmp((char *) (MR_Word *) MR_r1, MR_string_const("memory-words", 12)) != 0)) {
		MR_GOTO_LAB(globals__what_to_profile_2_0_i7);
	}
	MR_r2 = (MR_Integer) 0;
	MR_r1 = MR_TRUE;
	MR_proceed();
MR_def_label(globals__what_to_profile_2_0,7)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if ((strcmp((char *) (MR_Word *) MR_r1, MR_string_const("user-plus-system-time", 21)) != 0)) {
...
MR_BEGIN_MODULE(globals_module1)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__globals__what_to_profile_2_1);
	MR_init_label5(globals__what_to_profile_2_1,3,4,5,6,7)
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'what_to_profile'/2 mode 1 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_define_entry(mercury__globals__what_to_profile_2_1);
	...
	if (MR_INT_NE(MR_r1,1)) {
		MR_GOTO_LAB(globals__what_to_profile_2_1_i3);
	}
	MR_r1 = (MR_Word) MR_string_const("memory-cells", 12);
	MR_proceed();
MR_def_label(globals__what_to_profile_2_1,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,2)) {
		MR_GOTO_LAB(globals__what_to_profile_2_1_i4);
	}
	MR_r1 = (MR_Word) MR_string_const("snapshots", 9);
	MR_proceed();
MR_def_label(globals__what_to_profile_2_1,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(globals__what_to_profile_2_1_i5);
	}
	MR_r1 = (MR_Word) MR_string_const("memory-words", 12);
	MR_proceed();
MR_def_label(globals__what_to_profile_2_1,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,5)) {
		MR_GOTO_LAB(globals__what_to_profile_2_1_i6);
	}
	MR_r1 = (MR_Word) MR_string_const("real-time", 9);
	MR_proceed();
MR_def_label(globals__what_to_profile_2_1,6)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,3)) {
		MR_GOTO_LAB(globals__what_to_profile_2_1_i7);
	}
	MR_r1 = (MR_Word) MR_string_const("user-plus-system-time", 21);
	MR_proceed();
MR_def_label(globals__what_to_profile_2_1,7)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_string_const("user-time", 9);
	MR_proceed();
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_thread_engine_base
...
MR_BEGIN_MODULE(globals_module2)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__globals__init_2_0);
MR_BEGIN_CODE
...
MR_define_entry(mercury__globals__init_2_0);
	...
	MR_tfield(0, MR_r2, 0) = (MR_Integer) 3;
...
MR_BEGIN_MODULE(globals_module3)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__globals__get_what_to_profile_2_0);
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'get_what_to_profile'/2 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
...
MR_BEGIN_MODULE(globals_module4)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__globals__get_options_2_0);
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(globals_module5)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__globals__set_what_to_profile_3_0);
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'set_what_to_profile'/3 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
...
MR_BEGIN_MODULE(globals_module6)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__globals__set_options_3_0);
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(globals_module7)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__globals__lookup_option_3_0);
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(globals_module8)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__globals__lookup_bool_option_3_0);
...
MR_BEGIN_MODULE(globals_module9)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__globals__lookup_int_option_3_0);
...
MR_BEGIN_MODULE(globals_module10)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__globals__lookup_string_option_3_0);
...
MR_BEGIN_MODULE(globals_module11)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__globals__lookup_accumulating_option_3_0);
...
MR_BEGIN_MODULE(globals_module12)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__globals__io_set_globals_3_0);
	MR_init_label1(globals__io_set_globals_3_0,2)
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'io_set_globals'/3 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
...
MR_BEGIN_MODULE(globals_module13)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__globals__io_init_3_0);
	MR_init_label1(globals__io_init_3_0,3)
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'io_init'/3 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_define_entry(mercury__globals__io_init_3_0);
	...
	MR_np_call_localret_ent(univ__type_to_univ_2_0,
		globals__io_init_3_0_i3);
MR_def_label(globals__io_init_3_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_succip_word = MR_sv(1);
	MR_decr_sp(1);
	MR_np_tailcall_ent(io__set_globals_3_0);
...
MR_BEGIN_MODULE(globals_module14)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__globals__io_get_globals_3_0);
	MR_init_label3(globals__io_get_globals_3_0,2,4,3)
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'io_get_globals'/3 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
...
MR_BEGIN_MODULE(globals_module15)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__globals__io_lookup_option_4_0);
	MR_init_label4(globals__io_lookup_option_4_0,2,4,3,7)
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'io_lookup_option'/4 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
...
MR_BEGIN_MODULE(globals_module16)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__globals__io_set_option_4_0);
	MR_init_label6(globals__io_set_option_4_0,2,4,3,7,8,10)
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'io_set_option'/4 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
...
MR_def_label(globals__io_set_option_4_0,8)
	...
	MR_np_call_localret_ent(univ__type_to_univ_2_0,
		globals__io_set_option_4_0_i10);
MR_def_label(globals__io_set_option_4_0,10)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_BEGIN_MODULE(globals_module17)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__globals__io_lookup_bool_option_4_0);
	MR_init_label4(globals__io_lookup_bool_option_4_0,2,4,3,7)
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'io_lookup_bool_option'/4 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
...
MR_BEGIN_MODULE(globals_module18)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__globals__io_lookup_int_option_4_0);
	MR_init_label4(globals__io_lookup_int_option_4_0,2,4,3,7)
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'io_lookup_int_option'/4 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
...
MR_BEGIN_MODULE(globals_module19)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__globals__io_lookup_string_option_4_0);
	MR_init_label4(globals__io_lookup_string_option_4_0,2,4,3,7)
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'io_lookup_string_option'/4 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
...
MR_BEGIN_MODULE(globals_module20)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__globals__io_lookup_accumulating_option_4_0);
	MR_init_label4(globals__io_lookup_accumulating_option_4_0,2,4,3,7)
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'io_lookup_accumulating_option'/4 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
...
MR_BEGIN_MODULE(globals_module21)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury____Unify___globals__globals_0_0);
	MR_init_label2(__Unify___globals__globals_0_0,6,1)
MR_BEGIN_CODE
...
MR_define_entry(mercury____Unify___globals__globals_0_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if ((MR_r1 == MR_r2)) {
		MR_GOTO_LAB(__Unify___globals__globals_0_0_i6);
	}
	MR_incr_sp(3);
	MR_sv(3) = (MR_Word) MR_succip;
	{
...
MR_def_label(__Unify___globals__globals_0_0,6)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_TRUE;
	MR_proceed();
...
MR_BEGIN_MODULE(globals_module22)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury____Compare___globals__globals_0_0);
	MR_init_label4(__Compare___globals__globals_0_0,3,2,5,21)
MR_BEGIN_CODE
...
MR_define_entry(mercury____Compare___globals__globals_0_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if ((MR_r1 == MR_r2)) {
		MR_GOTO_LAB(__Compare___globals__globals_0_0_i3);
	}
	MR_incr_sp(3);
	MR_sv(3) = (MR_Word) MR_succip;
	MR_sv(1) = MR_r1;
	MR_sv(2) = MR_r2;
	MR_GOTO_LAB(__Compare___globals__globals_0_0_i2);
MR_def_label(__Compare___globals__globals_0_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Integer) 0;
	MR_proceed();
MR_def_label(__Compare___globals__globals_0_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	...
	MR_np_call_localret_ent(private_builtin__builtin_compare_int_3_0,
		__Compare___globals__globals_0_0_i5);
MR_def_label(__Compare___globals__globals_0_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___globals__globals_0_0_i21);
	}
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(options, option);
	MR_r2 = (MR_Word) MR_CTOR0_ADDR(getopt, option_data);
	MR_r3 = MR_sv(1);
...
MR_def_label(__Compare___globals__globals_0_0,21)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(3);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
...
MR_BEGIN_MODULE(globals_module23)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury____Unify___globals__what_to_profile_0_0);
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(globals_module24)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury____Compare___globals__what_to_profile_0_0);
MR_BEGIN_CODE
...
void mercury__globals__write_out_proc_statics(FILE *deep_fp, FILE *procrep_fp);
#endif
#ifdef MR_RECORD_TERM_SIZES
void mercury__globals__init_complexity_procs(void);
#endif
#ifdef MR_THREADSCOPE
void mercury__globals__init_threadscope_string_table(void);
#endif
...
void mercury__globals__write_out_proc_statics(FILE *deep_fp, FILE *procrep_fp)
{
	MR_write_out_module_proc_reps_start(procrep_fp, &mercury_data__module_common_layout__globals);
