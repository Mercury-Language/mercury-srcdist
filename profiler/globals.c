...
{
  {
    ...
    Var_28 = ((MR_Word) (MR_hl_field(MR_mktag(0), Globals0_8, (MR_Integer) 0)));
    ...
    Var_31 = ((MR_Word) (MR_hl_field(MR_mktag(0), Globals0_8, (MR_Integer) 0)));
    Var_32 = ((MR_Word) (MR_hl_field(MR_mktag(0), Globals0_8, (MR_Integer) 1)));
    {
      Globals_11 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), Globals_11, 0) = ((MR_Box) (Var_31));
...
{
  {
    ...
    Var_25 = ((MR_Word) (MR_hl_field(MR_mktag(0), Globals_8, (MR_Integer) 0)));
...
{
  {
...

    {
      ...
      MR_hl_field(MR_mktag(0), Globals_6, 0) = ((MR_Box) ((MR_Integer) 3));
...
{
  {
    ...
    MR_Word Var_19 = ((MR_Word) (MR_hl_field(MR_mktag(0), Globals_4, (MR_Integer) 0)));
...
{
  {
    ...
    MR_Word Var_17 = ((MR_Word) (MR_hl_field(MR_mktag(0), Globals_4, (MR_Integer) 0)));
    MR_Box conv0_OptionData_7;
    MR_String String_8;
...
{
  {
    ...
    MR_Word Var_11 = ((MR_Word) (MR_hl_field(MR_mktag(0), Globals_4, (MR_Integer) 0)));
...
{
  {
    MR_Word Var_6 = ((MR_Word) (MR_hl_field(MR_mktag(0), Globals_5, (MR_Integer) 0)));
...
{
  {
...

    {
      ...
      base = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
      *HeadVar__3_3 = base;
      MR_hl_field(MR_mktag(0), base, 0) = ((MR_Box) (WhatToProfile_4));
