...
#undef MR_PROC_LABEL
  ...
  Var_3 = mercury__map__init_0_f_0((MR_Word) (&options__options__type_ctor_info_option_0), (MR_Word) (&mercury__getopt__getopt__type_ctor_info_option_data_0));
  {
    ...
    MR_hl_field(MR_mktag(0), X_1, 1) = ((MR_Box) (Var_3));
  }
{
#define MR_PROC_LABEL globals__initialise_mutable_profiler_globals_0_p_0
...
#undef MR_PROC_LABEL
  ...
  Var_18 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Globals0_8, (MR_Integer) 0))) & (MR_Integer) 7);
  {
    Globals_11 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(MR_mktag(0), Globals_11, 0) = (MR_Box) ((MR_Unsigned) (Var_18));
  ...
  MR_Word * Value_6)
{
  ...
  MR_Word OptionTable_12 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Globals_4, (MR_Integer) 1))));
  ...
  MR_String * Value_6)
{
  MR_bool succeeded;
  MR_Word OptionData_7;
  MR_Word OptionTable_10 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Globals_4, (MR_Integer) 1))));
  MR_Box conv0_OptionData_7;
  MR_String String_8;
