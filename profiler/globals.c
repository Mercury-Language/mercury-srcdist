  ...
  MR_Word HeadVar__2_2)
{
  ...
  else
  {
    ...
    if (succeeded)
    {
      TypeInfo__9_9 = (MR_Word) (&globals_scalar_common_1[0]);
...
#undef MR_PROC_LABEL
  ...
  Var_19 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Globals0_8, (MR_Integer) 0))) & (MR_Integer) 7);
  {
    Globals_11 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(MR_mktag(0), Globals_11, 0) = (MR_Box) ((MR_Unsigned) (Var_19));
