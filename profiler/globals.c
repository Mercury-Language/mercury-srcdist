...
{
  {
    ...
    succeeded = ((((MR_tag((MR_Word) OptionData_7)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(MR_mktag(3), OptionData_7, (MR_Integer) 0)))) == (MR_Integer) 3)));
    if (succeeded)
    {
    ...
    else
    {
      ...
      Var_9 = mercury__string__f_43_43_2_f_0((MR_String) "globals.lookup_accumulating_option: ", (MR_String) "invalid accumulating option");
      {
...
{
  {
    ...
    OptionData_7 = ((MR_Word) (conv0_OptionData_7));
    succeeded = ((((MR_tag((MR_Word) OptionData_7)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(MR_mktag(3), OptionData_7, (MR_Integer) 0)))) == (MR_Integer) 0)));
    if (succeeded)
    {
