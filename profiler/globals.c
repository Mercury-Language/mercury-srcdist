...
{
  {
    ...
    if (globals__succeeded)
      *globals__HeadVar__1_1 = (MR_Integer) 0;
      ...
      {
        MR_Word globals__Var_4 = ((MR_Word) (MR_hl_field(MR_mktag(0), globals__HeadVar__2_2, (MR_Integer) 0)));
        MR_Word globals__Var_5 = ((MR_Word) (MR_hl_field(MR_mktag(0), globals__HeadVar__2_2, (MR_Integer) 1)));
        MR_Word globals__Var_6 = ((MR_Word) (MR_hl_field(MR_mktag(0), globals__HeadVar__3_3, (MR_Integer) 0)));
        MR_Word globals__Var_7 = ((MR_Word) (MR_hl_field(MR_mktag(0), globals__HeadVar__3_3, (MR_Integer) 1)));
        MR_Word globals__Var_8;
        MR_Integer globals__Var_13 = (MR_Integer) globals__Var_4;
        MR_Integer globals__Var_14 = (MR_Integer) globals__Var_6;
        ...
        if (globals__succeeded)
          *globals__HeadVar__1_1 = globals__Var_8;
          ...
          {
            {
              mercury__builtin__compare_3_p_0((MR_Word) &globals_scalar_common_1[0], globals__HeadVar__1_1, ((MR_Box) (globals__Var_5)), ((MR_Box) (globals__Var_7)));
            }
          }
      }
  }
...
{
  {
    ...
    if (globals__succeeded)
    ...
    else
      {
        ...
        MR_Word globals__Var_3 = ((MR_Word) (MR_hl_field(MR_mktag(0), globals__HeadVar__1_1, (MR_Integer) 0)));
        MR_Word globals__Var_4 = ((MR_Word) (MR_hl_field(MR_mktag(0), globals__HeadVar__1_1, (MR_Integer) 1)));
        MR_Word globals__Var_5 = ((MR_Word) (MR_hl_field(MR_mktag(0), globals__HeadVar__2_2, (MR_Integer) 0)));
        MR_Word globals__Var_6 = ((MR_Word) (MR_hl_field(MR_mktag(0), globals__HeadVar__2_2, (MR_Integer) 1)));

        globals__succeeded = (globals__Var_3 == globals__Var_5);
        if (globals__succeeded)
          {
            globals__TypeInfo_9_9 = (MR_Word) &globals_scalar_common_1[0];
            {
              globals__succeeded = mercury__builtin__unify_2_p_0(globals__TypeInfo_9_9, ((MR_Box) (globals__Var_4)), ((MR_Box) (globals__Var_6)));
            }
          }
      }
    return globals__succeeded;
