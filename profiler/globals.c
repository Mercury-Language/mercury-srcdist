...
{
  {
    ...
    packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Globals0_8, (MR_Integer) 0)));
    ...
    packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Globals0_8, (MR_Integer) 0)));
    {
      Globals_11 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), Globals_11, 0) = (MR_Box) (packed_args_1);
...
{
  {
    ...
    packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Globals_8, (MR_Integer) 0)));
...
{
  {
    ...
    {
      Globals_6 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
...
{
  {
    ...
    MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Globals_4, (MR_Integer) 0)));
...
{
  {
    ...
    if (succeeded)
    {
      packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), OptionData_7, (MR_Integer) 0)));
...
{
  {
    MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Globals_5, (MR_Integer) 0)));
...
{
  {
    MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Globals_3, (MR_Integer) 0)));
