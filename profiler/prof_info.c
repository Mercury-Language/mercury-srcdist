...
MR_decl_label1(__Unify___prof_info__pred_info_0_0, 1)
MR_decl_label3(__Unify___prof_info__prof_0_0, 2,4,1)
MR_decl_label5(__Unify___prof_info__prof_node_0_0, 5,7,3,12,1)
MR_decl_label2(__Compare___prof_info__pred_info_0_0, 3,7)
MR_decl_label6(__Compare___prof_info__prof_0_0, 3,7,11,15,19,27)
MR_decl_label8(__Compare___prof_info__prof_node_0_0, 7,11,15,19,23,27,31,35)
MR_decl_label8(__Compare___prof_info__prof_node_0_0, 5,3,157,50,54,58,62,66)
MR_decl_label2(__Compare___prof_info__prof_node_0_0, 70,154)
...
MR_def_label(prof_info__prof_node_get_entire_cycle_8_0,3)
	...
	MR_r7 = MR_ctfield(1, MR_tempr1, 6);
	MR_proceed();
	}
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
...
MR_def_label(prof_info__prof_node_set_cycle_num_3_0,3)
	...
	MR_tfield(1, MR_tempr1, 6) = MR_ctfield(1, MR_tempr2, 6);
	MR_r1 = MR_tempr1;
	MR_proceed();
	}
#ifdef MR_maybe_local_thread_engine_base
...
MR_define_entry(mercury__prof_info__prof_node_concat_to_parent_4_0);
	...
	MR_tempr3 = MR_r3;
	MR_tfield(1, MR_tempr2, 1) = MR_ctfield(0, MR_tempr3, 4);
...
MR_define_entry(mercury__prof_info__prof_node_concat_to_child_4_0);
	...
	MR_tfield(1, MR_tempr2, 0) = MR_tempr1;
	MR_tempr3 = MR_r3;
	MR_tfield(1, MR_tempr2, 1) = MR_ctfield(0, MR_tempr3, 5);
	MR_tag_alloc_heap(MR_r1, 0, (MR_Integer) 9);
	MR_tfield(0, MR_r1, 0) = MR_ctfield(0, MR_tempr3, 0);
	MR_tfield(0, MR_r1, 1) = MR_ctfield(0, MR_tempr3, 1);
	MR_tfield(0, MR_r1, 2) = MR_ctfield(0, MR_tempr3, 2);
...
MR_def_label(prof_info__prof_node_concat_to_member_4_0,3)
	...
	MR_tfield(1, MR_tempr2, 0) = MR_tempr1;
	MR_tempr3 = MR_r3;
	MR_tfield(1, MR_tempr2, 1) = MR_ctfield(1, MR_tempr3, 4);
	MR_tag_alloc_heap(MR_r1, 1, (MR_Integer) 7);
	MR_tfield(1, MR_r1, 0) = MR_ctfield(1, MR_tempr3, 0);
	MR_tfield(1, MR_r1, 1) = MR_ctfield(1, MR_tempr3, 1);
	MR_tfield(1, MR_r1, 2) = MR_ctfield(1, MR_tempr3, 2);
	MR_tfield(1, MR_r1, 3) = MR_ctfield(1, MR_tempr3, 3);
	MR_tfield(1, MR_r1, 4) = MR_tempr2;
	MR_tfield(1, MR_r1, 5) = MR_ctfield(1, MR_tempr3, 5);
	MR_tfield(1, MR_r1, 6) = MR_ctfield(1, MR_tempr3, 6);
	MR_proceed();
	}
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
...
MR_BEGIN_MODULE(prof_info_module38)
	...
	MR_init_label1(__Unify___prof_info__pred_info_0_0,1)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(prof_info_module39)
	...
	MR_init_label2(__Compare___prof_info__pred_info_0_0,3,7)
MR_BEGIN_CODE
...
MR_define_entry(mercury____Compare___prof_info__pred_info_0_0);
	...
	MR_np_call_localret_ent(private_builtin__builtin_compare_string_3_0,
		__Compare___prof_info__pred_info_0_0_i3);
MR_def_label(__Compare___prof_info__pred_info_0_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___prof_info__pred_info_0_0_i7);
	}
	MR_r1 = MR_sv(1);
	MR_r2 = MR_sv(2);
	MR_succip_word = MR_sv(3);
...
MR_def_label(__Compare___prof_info__pred_info_0_0,7)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_BEGIN_MODULE(prof_info_module40)
	...
	MR_init_label3(__Unify___prof_info__prof_0_0,2,4,1)
MR_BEGIN_CODE
...
MR_define_entry(mercury____Unify___prof_info__prof_0_0);
	...
	MR_np_call_localret_ent(__Unify___tree234__tree234_2_0,
		__Unify___prof_info__prof_0_0_i2);
MR_def_label(__Unify___prof_info__prof_0_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(__Unify___prof_info__prof_0_0_i1);
	}
...
MR_BEGIN_MODULE(prof_info_module41)
	...
	MR_init_label6(__Compare___prof_info__prof_0_0,3,7,11,15,19,27)
MR_BEGIN_CODE
...
MR_define_entry(mercury____Compare___prof_info__prof_0_0);
	...
	MR_np_call_localret_ent(private_builtin__builtin_compare_float_3_0,
		__Compare___prof_info__prof_0_0_i3);
MR_def_label(__Compare___prof_info__prof_0_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___prof_info__prof_0_0_i27);
	}
	MR_r1 = MR_sv(1);
	MR_r2 = MR_sv(6);
	MR_np_call_localret_ent(private_builtin__builtin_compare_string_3_0,
		__Compare___prof_info__prof_0_0_i7);
MR_def_label(__Compare___prof_info__prof_0_0,7)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___prof_info__prof_0_0_i27);
	}
	...
	MR_np_call_localret_ent(private_builtin__builtin_compare_int_3_0,
		__Compare___prof_info__prof_0_0_i11);
MR_def_label(__Compare___prof_info__prof_0_0,11)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___prof_info__prof_0_0_i27);
	}
	...
	MR_np_call_localret_ent(__Compare___tree234__tree234_2_0,
		__Compare___prof_info__prof_0_0_i15);
MR_def_label(__Compare___prof_info__prof_0_0,15)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___prof_info__prof_0_0_i27);
	}
	...
	MR_r4 = MR_sv(9);
	MR_np_call_localret_ent(__Compare___tree234__tree234_2_0,
		__Compare___prof_info__prof_0_0_i19);
MR_def_label(__Compare___prof_info__prof_0_0,19)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___prof_info__prof_0_0_i27);
	}
	...
	MR_decr_sp(11);
	MR_np_tailcall_ent(__Compare___tree234__tree234_2_0);
MR_def_label(__Compare___prof_info__prof_0_0,27)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_BEGIN_MODULE(prof_info_module42)
	...
	MR_init_label5(__Unify___prof_info__prof_node_0_0,5,7,3,12,1)
MR_BEGIN_CODE
...
MR_define_entry(mercury____Unify___prof_info__prof_node_0_0);
	...
	if (MR_PTAG_TESTR(MR_r1,0)) {
		MR_GOTO_LAB(__Unify___prof_info__prof_node_0_0_i3);
	}
	if (MR_PTAG_TESTR(MR_r2,0)) {
	...
	MR_np_call_localret_ent(__Unify___list__list_1_0,
		__Unify___prof_info__prof_node_0_0_i5);
...
MR_def_label(__Unify___prof_info__prof_node_0_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	...
	MR_sv(1) = MR_ctfield(1, MR_r1, 5);
	MR_sv(2) = MR_ctfield(1, MR_r1, 6);
	MR_sv(3) = MR_ctfield(1, MR_tempr3, 5);
	MR_sv(4) = MR_ctfield(1, MR_tempr3, 6);
	MR_tempr1 = MR_r1;
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(prof_info, pred_info);
	MR_tempr2 = MR_tempr3;
	MR_r2 = MR_ctfield(1, MR_tempr1, 4);
	MR_r3 = MR_ctfield(1, MR_tempr2, 4);
	}
	MR_np_call_localret_ent(__Unify___list__list_1_0,
...
MR_BEGIN_MODULE(prof_info_module43)
	...
	MR_init_label8(__Compare___prof_info__prof_node_0_0,7,11,15,19,23,27,31,35)
	MR_init_label8(__Compare___prof_info__prof_node_0_0,5,3,157,50,54,58,62,66)
	MR_init_label2(__Compare___prof_info__prof_node_0_0,70,154)
MR_BEGIN_CODE
...
MR_define_entry(mercury____Compare___prof_info__prof_node_0_0);
	...
	MR_np_call_localret_ent(private_builtin__builtin_compare_string_3_0,
		__Compare___prof_info__prof_node_0_0_i7);
MR_def_label(__Compare___prof_info__prof_node_0_0,7)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___prof_info__prof_node_0_0_i154);
	}
	MR_r1 = MR_sv(16);
	MR_r2 = MR_sv(1);
	MR_np_call_localret_ent(private_builtin__builtin_compare_int_3_0,
		__Compare___prof_info__prof_node_0_0_i11);
MR_def_label(__Compare___prof_info__prof_node_0_0,11)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___prof_info__prof_node_0_0_i154);
	}
	...
	MR_r2 = MR_sv(2);
	MR_np_call_localret_ent(private_builtin__builtin_compare_int_3_0,
		__Compare___prof_info__prof_node_0_0_i15);
MR_def_label(__Compare___prof_info__prof_node_0_0,15)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___prof_info__prof_node_0_0_i154);
	}
	...
	MR_r2 = MR_sv(3);
	MR_np_call_localret_ent(private_builtin__builtin_compare_float_3_0,
		__Compare___prof_info__prof_node_0_0_i19);
MR_def_label(__Compare___prof_info__prof_node_0_0,19)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___prof_info__prof_node_0_0_i154);
	}
	...
	MR_np_call_localret_ent(__Compare___list__list_1_0,
		__Compare___prof_info__prof_node_0_0_i23);
MR_def_label(__Compare___prof_info__prof_node_0_0,23)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___prof_info__prof_node_0_0_i154);
	}
	...
	MR_r3 = MR_sv(5);
	MR_np_call_localret_ent(__Compare___list__list_1_0,
		__Compare___prof_info__prof_node_0_0_i27);
MR_def_label(__Compare___prof_info__prof_node_0_0,27)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___prof_info__prof_node_0_0_i154);
	}
	...
	MR_r2 = MR_sv(6);
	MR_np_call_localret_ent(private_builtin__builtin_compare_int_3_0,
		__Compare___prof_info__prof_node_0_0_i31);
MR_def_label(__Compare___prof_info__prof_node_0_0,31)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___prof_info__prof_node_0_0_i154);
	}
	...
	MR_r2 = MR_sv(7);
	MR_np_call_localret_ent(private_builtin__builtin_compare_int_3_0,
		__Compare___prof_info__prof_node_0_0_i35);
MR_def_label(__Compare___prof_info__prof_node_0_0,35)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___prof_info__prof_node_0_0_i154);
	}
...
MR_def_label(__Compare___prof_info__prof_node_0_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_r2,0)) {
		MR_GOTO_LAB(__Compare___prof_info__prof_node_0_0_i157);
	}
	MR_r1 = (MR_Integer) 2;
	MR_proceed();
MR_def_label(__Compare___prof_info__prof_node_0_0,157)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(17);
	MR_sv(17) = (MR_Word) MR_succip;
	MR_sv(12) = MR_ctfield(1, MR_r1, 1);
	MR_sv(11) = MR_ctfield(1, MR_r1, 2);
...
MR_def_label(__Compare___prof_info__prof_node_0_0,70)
	...
	MR_decr_sp(17);
	MR_np_tailcall_ent(private_builtin__builtin_compare_int_3_0);
MR_def_label(__Compare___prof_info__prof_node_0_0,154)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
void mercury__prof_info__write_out_proc_statics(FILE *fp);
#endif
