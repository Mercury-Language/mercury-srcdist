  ...
  MR_Word HeadVar__3_3)
{
  ...
  if (((MR_tag((MR_Word) HeadVar__2_2)) == (MR_Integer) 1))
  {
    ...
    if (((MR_tag((MR_Word) HeadVar__3_3)) == (MR_Integer) 1))
    {
      ...
      MR_Integer ArgY2_66 = ((MR_Integer) ((MR_hl_field(MR_mktag(1), HeadVar__3_3, (MR_Integer) 1))));
      MR_Integer ArgY3_69 = ((MR_Integer) ((MR_hl_field(MR_mktag(1), HeadVar__3_3, (MR_Integer) 2))));
      MR_Float ArgY4_72 = MR_unbox_float((MR_hl_field(MR_mktag(1), HeadVar__3_3, (MR_Integer) 3)));
      MR_Word ArgY5_75 = ((MR_Word) ((MR_hl_field(MR_mktag(1), HeadVar__3_3, (MR_Integer) 4))));
      MR_Integer ArgY6_78 = ((MR_Integer) ((MR_hl_field(MR_mktag(1), HeadVar__3_3, (MR_Integer) 5))));
      MR_Integer ArgY7_81 = ((MR_Integer) ((MR_hl_field(MR_mktag(1), HeadVar__3_3, (MR_Integer) 6))));
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              TypeInfo__37_37 = (MR_Word) (&prof_info_scalar_common_2[0]);
              succeeded = mercury__builtin__unify_2_p_0(TypeInfo__37_37, ((MR_Box) (ArgX5_29)), ((MR_Box) (ArgY5_30)));
              if (succeeded)
              {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              TypeInfo__38_38 = (MR_Word) (&prof_info_scalar_common_2[0]);
              succeeded = mercury__builtin__unify_2_p_0(TypeInfo__38_38, ((MR_Box) (ArgX5_11)), ((MR_Box) (ArgY5_12)));
              if (succeeded)
              {
                TypeInfo__39_39 = (MR_Word) (&prof_info_scalar_common_2[0]);
                ...
                if (succeeded)
                {
                  ...
                  if (succeeded)
                  {
                    ...
                    if (succeeded)
                    {
                      TypeInfo__40_40 = (MR_Word) (&prof_info_scalar_common_2[1]);
                      succeeded = mercury__builtin__unify_2_p_0(TypeInfo__40_40, ((MR_Box) (ArgX9_19)), ((MR_Box) (ArgY9_20)));
                    }
                  }
                }
              }
  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          TypeInfo__17_17 = (MR_Word) (&prof_info_scalar_common_1[0]);
          succeeded = mercury__builtin__unify_2_p_0(TypeInfo__17_17, ((MR_Box) (ArgX4_9)), ((MR_Box) (ArgY4_10)));
          if (succeeded)
          {
            TypeInfo__18_18 = (MR_Word) (&prof_info_scalar_common_1[1]);
            succeeded = mercury__builtin__unify_2_p_0(TypeInfo__18_18, ((MR_Box) (ArgX5_11)), ((MR_Box) (ArgY5_12)));
            if (succeeded)
            {
              TypeInfo__19_19 = (MR_Word) (&prof_info_scalar_common_1[0]);
              succeeded = mercury__builtin__unify_2_p_0(TypeInfo__19_19, ((MR_Box) (ArgX6_13)), ((MR_Box) (ArgY6_14)));
            }
          }
        }
      }
...
prof_info__pred_info_get_counts_2_p_0(
  ...
  MR_Integer * X_4)
{
  *X_4 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), Pred_3, (MR_Integer) 1))));
}
...
prof_info__pred_info_get_pred_name_2_p_0(
  ...
  MR_String * X_4)
{
  *X_4 = ((MR_String) ((MR_hl_field(MR_mktag(0), Pred_3, (MR_Integer) 0))));
}
...
{
  MR_Float Var_9 = MR_unbox_float((MR_hl_field(MR_mktag(0), STATE_VARIABLE_Prof_0_6, (MR_Integer) 0)));
  MR_String Var_10 = ((MR_String) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_Prof_0_6, (MR_Integer) 1))));
  MR_Integer Var_11 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_Prof_0_6, (MR_Integer) 2))));
  MR_Word Var_12 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_Prof_0_6, (MR_Integer) 3))));
  MR_Word Var_13 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_Prof_0_6, (MR_Integer) 4))));

  {
    MR_Word base;
    base = (MR_Word) MR_new_object(MR_Word, (6 * sizeof(MR_Word)), NULL, NULL);
    *STATE_VARIABLE_Prof_7 = base;
    MR_hl_field(MR_mktag(0), base, 0) = MR_box_float(Var_9);
  ...
  MR_Word * STATE_VARIABLE_Prof_7)
{
  ...
  MR_Integer Var_11 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_Prof_0_6, (MR_Integer) 2))));
  MR_Word Var_12 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_Prof_0_6, (MR_Integer) 3))));
  MR_Word Var_14 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_Prof_0_6, (MR_Integer) 5))));
...
prof_info__prof_get_profnodemap_2_p_0(
  ...
  MR_Word * X_4)
{
  *X_4 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Prof_3, (MR_Integer) 4))));
}
...
prof_info__prof_get_addrdeclmap_2_p_0(
  ...
  MR_Word * X_4)
{
  *X_4 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Prof_3, (MR_Integer) 3))));
}
  ...
  MR_Integer G_15)
{
  ...
  {
    HeadVar__8_8 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (7 * sizeof(MR_Word)), NULL, NULL));
  ...
  MR_String PredName_3)
{
...

  {
    ...
    MR_hl_field(MR_mktag(0), HeadVar__2_2, 8) = ((MR_Box) ((MR_Unsigned) 0U));
  }
  return HeadVar__2_2;
}
