...
MR_define_entry(mercury____Unify___prof_info__prof_node_0_0);
	...
	MR_sv(7) = MR_tfield(1, MR_tempr4, 5);
	MR_sv(8) = MR_tfield(1, MR_tempr4, 6);
...
MR_def_label(__Compare___prof_info__prof_node_0_0,2)
	...
	* (MR_Float *) &MR_sv(13) = MR_word_to_float(MR_tfield(1, MR_tempr5, 3));
	MR_sv(10) = MR_tfield(1, MR_tempr5, 4);
	MR_sv(9) = MR_tfield(1, MR_tempr5, 5);
	MR_sv(8) = MR_tfield(1, MR_tempr5, 6);
	MR_tempr6 = MR_sv(2);
	MR_sv(7) = MR_tfield(1, MR_tempr6, 6);
	MR_sv(6) = MR_tfield(1, MR_tempr6, 5);
	MR_sv(5) = MR_tfield(1, MR_tempr6, 4);
	* (MR_Float *) &MR_sv(4) = MR_word_to_float(MR_tfield(1, MR_tempr6, 3));
...
MR_def_label(__Compare___prof_info__prof_node_0_0,40)
	...
	* (MR_Float *) &MR_sv(18) = MR_word_to_float(MR_tfield(0, MR_tempr5, 3));
	MR_sv(16) = MR_tfield(0, MR_tempr5, 4);
	MR_sv(15) = MR_tfield(0, MR_tempr5, 5);
	MR_sv(14) = MR_tfield(0, MR_tempr5, 6);
	MR_sv(11) = MR_tfield(0, MR_tempr5, 7);
	MR_sv(10) = MR_tfield(0, MR_tempr5, 8);
	MR_tempr6 = MR_sv(2);
	...
	* (MR_Float *) &MR_sv(4) = MR_word_to_float(MR_tfield(0, MR_tempr6, 3));
	MR_tempr1 = MR_tfield(0, MR_tempr6, 2);
	MR_tempr2 = MR_tfield(0, MR_tempr6, 1);
	MR_tempr3 = MR_tempr5;
	MR_sv(1) = MR_tempr2;
