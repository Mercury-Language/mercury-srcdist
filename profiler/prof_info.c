...
MR_define_entry(mercury__prof_info__prof_node_concat_to_parent_4_0);
	...
	MR_tempr4 = MR_r3;
	MR_tfield(1, MR_tempr2, 1) = MR_ctfield(0, MR_tempr4, 4);
...
MR_define_entry(mercury__prof_info__prof_node_concat_to_child_4_0);
	...
	MR_tfield(1, MR_tempr2, 0) = MR_tempr1;
	MR_tempr4 = MR_r3;
	MR_tfield(1, MR_tempr2, 1) = MR_ctfield(0, MR_tempr4, 5);
	MR_tag_alloc_heap(MR_tempr3, 0, (MR_Integer) 9);
	MR_r1 = MR_tempr3;
	MR_tfield(0, MR_tempr3, 0) = MR_ctfield(0, MR_tempr4, 0);
	MR_tfield(0, MR_tempr3, 1) = MR_ctfield(0, MR_tempr4, 1);
...
MR_define_entry(mercury__prof_info__prof_node_concat_to_member_4_0);
	...
	MR_tfield(1, MR_tempr2, 0) = MR_tempr1;
	MR_tempr4 = MR_r3;
	MR_tfield(1, MR_tempr2, 1) = MR_ctfield(1, MR_tempr4, 4);
	MR_tag_alloc_heap(MR_tempr3, 1, (MR_Integer) 7);
	MR_r1 = MR_tempr3;
	MR_tfield(1, MR_tempr3, 0) = MR_ctfield(1, MR_tempr4, 0);
	MR_tfield(1, MR_tempr3, 1) = MR_ctfield(1, MR_tempr4, 1);
	MR_tfield(1, MR_tempr3, 2) = MR_ctfield(1, MR_tempr4, 2);
	MR_tfield(1, MR_tempr3, 3) = MR_ctfield(1, MR_tempr4, 3);
	MR_tfield(1, MR_tempr3, 4) = MR_tempr2;
	MR_tfield(1, MR_tempr3, 5) = MR_ctfield(1, MR_tempr4, 5);
	MR_tfield(1, MR_tempr3, 6) = MR_ctfield(1, MR_tempr4, 6);
	MR_proceed();
	}
