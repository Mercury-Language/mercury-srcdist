...
MR_decl_label8(__Compare___prof_info__prof_node_0_0, 7,5,40,42,46,50,54,58)
MR_decl_label4(__Compare___prof_info__prof_node_0_0, 62,66,70,162)
...
MR_define_entry(mercury____Unify___prof_info__prof_node_0_0);
	...
	MR_tempr4 = MR_ctfield(1, MR_tempr2, 2);
	if ((MR_tempr3 != MR_tempr4)) {
		MR_GOTO_LAB(__Unify___prof_info__prof_node_0_0_i1);
	}
	MR_tempr3 = MR_ctfield(1, MR_tempr1, 3);
	MR_tempr4 = MR_ctfield(1, MR_tempr2, 3);
	if ((MR_word_to_float(MR_tempr3) != MR_word_to_float(MR_tempr4))) {
		MR_GOTO_LAB(__Unify___prof_info__prof_node_0_0_i1);
	}
	MR_tempr3 = MR_tempr1;
	...
	MR_tempr4 = MR_tempr2;
	MR_sv(2) = MR_ctfield(1, MR_tempr3, 6);
	MR_sv(3) = MR_ctfield(1, MR_tempr4, 5);
	MR_sv(4) = MR_ctfield(1, MR_tempr4, 6);
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(prof_info, pred_info);
	MR_r2 = MR_ctfield(1, MR_tempr3, 4);
	MR_r3 = MR_ctfield(1, MR_tempr4, 4);
	}
...
MR_BEGIN_MODULE(prof_info_module43)
	...
	MR_init_label8(__Compare___prof_info__prof_node_0_0,7,5,40,42,46,50,54,58)
	MR_init_label4(__Compare___prof_info__prof_node_0_0,62,66,70,162)
MR_BEGIN_CODE
