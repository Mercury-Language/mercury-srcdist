  ...
  MR_Word Args_4)
{
  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      MR_String Package_46;
      MR_String _FullArch_45;

      mercury__library__version_2_p_0(&Version_44, &_FullArch_45);
      ...
      Package_46 = mercury__library__package_version_0_f_0();
      succeeded = (strcmp(Package_46, (MR_String) "") == 0);
      if (succeeded)
        mercury__io__nl_3_p_0(StdOut_7);
      else
      {
        mercury__io__write_string_4_p_0(StdOut_7, (MR_String) " (");
        mercury__io__write_string_4_p_0(StdOut_7, Package_46);
        mercury__io__write_string_4_p_0(StdOut_7, (MR_String) ")\n");
      }
      mercury__io__write_strings_4_p_0(StdOut_7, (MR_Word) (MR_mkword(1, &mercury_profile_scalar_common_2[14])));
    }
    else
    {
      ...
      switch (Snapshots_8) {
        ...
        case (MR_Integer) 0:
          {
            MR_Word Verbose_65;
            MR_Word ProgressStream_66;
            MR_Word Prof0_67;
            MR_Word CallGraph0_68;
            MR_Word CallGraphOpt_69;
            MR_Word Prof_71;
            MR_Word IndexMap_72;
            MR_Word ProfilerOutput_73;
            MR_Word StdOut_74;

            mercury__io__stderr_stream_3_p_0(&ProgressStream_66);
            globals__io_lookup_bool_option_4_p_0((MR_Integer) 0, &Verbose_65);
            options__maybe_write_string_5_p_0(ProgressStream_66, Verbose_65, (MR_String) "% Processing input files...");
            process_file__process_profiling_data_files_6_p_0(ProgressStream_66, ProgressStream_66, &Prof0_67, &CallGraph0_68);
            options__maybe_write_string_5_p_0(ProgressStream_66, Verbose_65, (MR_String) " done\n");
            globals__io_lookup_bool_option_4_p_0((MR_Integer) 3, &CallGraphOpt_69);
            switch (CallGraphOpt_69) {
              default: /*NOTREACHED*/ MR_assert(0);
              case (MR_Integer) 0:
                Prof_71 = Prof0_67;
                break;
              case (MR_Integer) 1:
                {
                  MR_Word CallGraph_70;

                  options__maybe_write_string_5_p_0(ProgressStream_66, Verbose_65, (MR_String) "% Building call graph...");
                  call_graph__build_call_graph_6_p_0(ProgressStream_66, Args_4, CallGraph0_68, &CallGraph_70);
                  options__maybe_write_string_5_p_0(ProgressStream_66, Verbose_65, (MR_String) " done\n");
                  options__maybe_write_string_5_p_0(ProgressStream_66, Verbose_65, (MR_String) "% Propagating counts...");
                  propagate__propagate_counts_5_p_0(CallGraph_70, Prof0_67, &Prof_71);
                  options__maybe_write_string_5_p_0(ProgressStream_66, Verbose_65, (MR_String) " done\n");
                }
                break;
            }
            options__maybe_write_string_5_p_0(ProgressStream_66, Verbose_65, (MR_String) "% Generating output...");
            generate_output__generate_prof_output_6_p_0(ProgressStream_66, Prof_71, &IndexMap_72, &ProfilerOutput_73);
            options__maybe_write_string_5_p_0(ProgressStream_66, Verbose_65, (MR_String) " done\n");
            mercury__io__stdout_stream_3_p_0(&StdOut_74);
            output__output_profile_5_p_0(StdOut_74, ProfilerOutput_73, IndexMap_72);
          }
          break;
        case (MR_Integer) 1:
