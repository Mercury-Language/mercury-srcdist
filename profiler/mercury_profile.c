...
main_2_p_0(void)
{
  ...
  if (((MR_tag((MR_Word) GetoptResult_7)) == (MR_Integer) 1))
  {
    ...
    }
    {
      ...
      MR_hl_field(1, Var_66, 0) = ((MR_Box) ((MR_String) "Copyright (C) 2013-2022 The Mercury team\n"));
    ...
    case (MR_Integer) 1:
      {
        ...
        {
          Var_70 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(1, Var_70, 0) = ((MR_Box) ((MR_String) "Copyright (C) 2013-2022 The Mercury team\n\n"));
