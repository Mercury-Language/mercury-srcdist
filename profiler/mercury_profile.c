...
MR_decl_label3(mercury_profile__long_usage_2_0, 2,3,10)
...
MR_def_label(mercury_profile__usage_error_3_0,12)
	...
	MR_tfield(1, MR_tempr1, 1) = MR_tempr2;
	MR_tag_alloc_heap(MR_tempr2, 1, (MR_Integer) 2);
	MR_tfield(1, MR_tempr2, 0) = (MR_Word) MR_string_const("Copyright (C) 1995-2013 The University of Melbourne\n", 52);
	MR_tfield(1, MR_tempr2, 1) = MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 2);
...
MR_BEGIN_MODULE(mercury_profile_module1)
	...
	MR_init_label3(mercury_profile__long_usage_2_0,2,3,10)
MR_BEGIN_CODE
...
MR_def_label(mercury_profile__long_usage_2_0,3)
	...
	MR_tfield(1, MR_tempr2, 1) = MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 2);
	MR_tfield(1, MR_tempr1, 0) = (MR_Word) MR_string_const("Copyright (C) 1995-2013 The University of Melbourne\n\n", 53);
	MR_tfield(1, MR_tempr1, 1) = MR_tempr2;
	MR_tag_alloc_heap(MR_tempr2, 1, (MR_Integer) 2);
	...
	MR_np_call_localret_ent(io__write_strings_3_0,
		mercury_profile__long_usage_2_0_i10);
MR_def_label(mercury_profile__long_usage_2_0,10)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
void mercury__mercury_profile__write_out_proc_statics(FILE *deep_fp, FILE *procrep_fp)
{
	MR_write_out_module_proc_reps_start(procrep_fp, &mercury_data__module_layout__mercury_profile);
