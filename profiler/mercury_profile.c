...
MR_decl_label3(mercury_profile__long_usage_2_0, 2,3,4)
MR_decl_label7(main_2_0, 2,3,6,7,11,13,5)
MR_decl_label8(mercury_profile__main_2_4_0, 4,5,6,7,10,11,12,13)
MR_decl_label8(mercury_profile__main_2_4_0, 15,16,17,18,19,20,21,14)
MR_decl_label7(mercury_profile__main_2_4_0, 22,23,24,25,44,45,3)
MR_decl_label7(mercury_profile__usage_error_3_0, 2,3,4,5,6,7,8)
MR_decl_static(mercury_profile__usage_error_3_0)
MR_decl_static(mercury_profile__long_usage_2_0)
MR_decl_static(mercury_profile__main_2_4_0)
...
MR_BEGIN_MODULE(mercury_profile_module0)
	...
	MR_init_label7(mercury_profile__usage_error_3_0,2,3,4,5,6,7,8)
MR_BEGIN_CODE
...
MR_def_label(mercury_profile__usage_error_3_0,3)
	...
	MR_np_call_localret_ent(io__write_strings_4_0,
		mercury_profile__usage_error_3_0_i4);
MR_def_label(mercury_profile__usage_error_3_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Integer) 1;
	MR_np_call_localret_ent(io__set_exit_status_3_0,
		mercury_profile__usage_error_3_0_i5);
MR_def_label(mercury_profile__usage_error_3_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_string_const("mprof", 5);
	MR_np_call_localret_ent(io__progname_base_4_0,
		mercury_profile__usage_error_3_0_i6);
MR_def_label(mercury_profile__usage_error_3_0,6)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(1) = MR_r1;
	MR_np_call_localret_ent(io__stderr_stream_3_0,
		mercury_profile__usage_error_3_0_i7);
MR_def_label(mercury_profile__usage_error_3_0,7)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(2) = MR_r1;
...
MR_def_label(mercury_profile__usage_error_3_0,8)
	...
	MR_tfield(1, MR_tempr1, 1) = MR_tempr2;
	MR_tag_alloc_heap(MR_tempr2, 1, (MR_Integer) 2);
	MR_tfield(1, MR_tempr2, 0) = (MR_Word) MR_string_const("Copyright (C) 1995-2007 The University of Melbourne\n", 52);
	MR_tfield(1, MR_tempr2, 1) = MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 2);
	...
	MR_r2 = MR_tempr4;
	MR_tfield(1, MR_tempr4, 0) = (MR_Word) MR_string_const("Mercury Profiler, version ", 26);
...
MR_BEGIN_MODULE(mercury_profile_module1)
	...
	MR_init_label3(mercury_profile__long_usage_2_0,2,3,4)
MR_BEGIN_CODE
...
MR_def_label(mercury_profile__long_usage_2_0,3)
	...
	MR_tfield(1, MR_tempr2, 1) = MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 2);
	MR_tfield(1, MR_tempr1, 0) = (MR_Word) MR_string_const("Copyright (C) 1995-2007 The University of Melbourne\n\n", 53);
	MR_tfield(1, MR_tempr1, 1) = MR_tempr2;
	MR_tag_alloc_heap(MR_tempr2, 1, (MR_Integer) 2);
	...
	MR_tag_alloc_heap(MR_tempr3, 1, (MR_Integer) 2);
	MR_r1 = MR_tempr3;
	MR_tfield(1, MR_tempr3, 0) = (MR_Word) MR_string_const("Mercury Profiler, version ", 26);
	MR_tfield(1, MR_tempr3, 1) = MR_tempr1;
	}
	MR_np_call_localret_ent(io__write_strings_3_0,
		mercury_profile__long_usage_2_0_i4);
MR_def_label(mercury_profile__long_usage_2_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_BEGIN_MODULE(mercury_profile_module2)
	MR_init_entry1(mercury_profile__main_2_4_0);
	MR_init_label8(mercury_profile__main_2_4_0,4,5,6,7,10,11,12,13)
	MR_init_label8(mercury_profile__main_2_4_0,15,16,17,18,19,20,21,14)
	MR_init_label7(mercury_profile__main_2_4_0,22,23,24,25,44,45,3)
MR_BEGIN_CODE
	...
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(mercury_profile__main_2_4_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
		MR_GOTO_LAB(mercury_profile__main_2_4_0_i3);
	}
	MR_incr_sp(7);
	MR_sv(7) = (MR_Word) MR_succip;
	MR_sv(1) = MR_r2;
	MR_np_call_localret_ent(io__stderr_stream_3_0,
		mercury_profile__main_2_4_0_i4);
MR_def_label(mercury_profile__main_2_4_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_np_call_localret_ent(io__set_output_stream_4_0,
		mercury_profile__main_2_4_0_i5);
MR_def_label(mercury_profile__main_2_4_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(2) = MR_r1;
	MR_r1 = (MR_Integer) 3;
	MR_np_call_localret_ent(globals__io_lookup_bool_option_4_0,
		mercury_profile__main_2_4_0_i6);
MR_def_label(mercury_profile__main_2_4_0,6)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(3) = MR_r1;
	MR_r1 = (MR_Integer) 13;
	MR_np_call_localret_ent(globals__io_lookup_bool_option_4_0,
		mercury_profile__main_2_4_0_i7);
MR_def_label(mercury_profile__main_2_4_0,7)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(mercury_profile__main_2_4_0_i45);
	}
	MR_r1 = (MR_Integer) 0;
	MR_np_call_localret_ent(globals__io_lookup_bool_option_4_0,
		mercury_profile__main_2_4_0_i10);
MR_def_label(mercury_profile__main_2_4_0,10)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(4) = MR_r1;
	MR_r2 = (MR_Word) MR_string_const("% Processing input files...", 27);
	MR_np_call_localret_ent(options__maybe_write_string_4_0,
		mercury_profile__main_2_4_0_i11);
MR_def_label(mercury_profile__main_2_4_0,11)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_np_call_localret_ent(process_file__process_profiling_data_files_4_0,
		mercury_profile__main_2_4_0_i12);
MR_def_label(mercury_profile__main_2_4_0,12)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(5) = MR_r1;
	MR_sv(6) = MR_r2;
	MR_r1 = MR_sv(4);
	...
	MR_np_call_localret_ent(options__maybe_write_string_4_0,
		mercury_profile__main_2_4_0_i13);
MR_def_label(mercury_profile__main_2_4_0,13)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_sv(3),0)) {
		MR_GOTO_LAB(mercury_profile__main_2_4_0_i15);
	}
	MR_r1 = MR_sv(4);
	MR_sv(1) = MR_sv(5);
	MR_r2 = (MR_Word) MR_string_const("% Generating output...", 22);
	MR_GOTO_LAB(mercury_profile__main_2_4_0_i14);
MR_def_label(mercury_profile__main_2_4_0,15)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(4);
	MR_r2 = (MR_Word) MR_string_const("% Building call graph...", 24);
	MR_np_call_localret_ent(options__maybe_write_string_4_0,
		mercury_profile__main_2_4_0_i16);
MR_def_label(mercury_profile__main_2_4_0,16)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(1);
	MR_r2 = MR_sv(6);
	MR_np_call_localret_ent(call_graph__build_call_graph_5_0,
		mercury_profile__main_2_4_0_i17);
MR_def_label(mercury_profile__main_2_4_0,17)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(1) = MR_r1;
	MR_r1 = MR_sv(4);
	MR_r2 = (MR_Word) MR_string_const(" done\n", 6);
	MR_np_call_localret_ent(options__maybe_write_string_4_0,
		mercury_profile__main_2_4_0_i18);
MR_def_label(mercury_profile__main_2_4_0,18)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(4);
	MR_r2 = (MR_Word) MR_string_const("% Propagating counts...", 23);
	MR_np_call_localret_ent(options__maybe_write_string_4_0,
		mercury_profile__main_2_4_0_i19);
MR_def_label(mercury_profile__main_2_4_0,19)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(1);
	MR_r2 = MR_sv(5);
	MR_np_call_localret_ent(propagate__propagate_counts_5_0,
		mercury_profile__main_2_4_0_i20);
MR_def_label(mercury_profile__main_2_4_0,20)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(1) = MR_r1;
	MR_r1 = MR_sv(4);
	MR_r2 = (MR_Word) MR_string_const(" done\n", 6);
	MR_np_call_localret_ent(options__maybe_write_string_4_0,
		mercury_profile__main_2_4_0_i21);
MR_def_label(mercury_profile__main_2_4_0,21)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(4);
	MR_r2 = (MR_Word) MR_string_const("% Generating output...", 22);
MR_def_label(mercury_profile__main_2_4_0,14)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(4) = MR_r1;
	MR_np_call_localret_ent(options__maybe_write_string_4_0,
		mercury_profile__main_2_4_0_i22);
MR_def_label(mercury_profile__main_2_4_0,22)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(1);
	MR_np_call_localret_ent(generate_output__generate_prof_output_5_0,
		mercury_profile__main_2_4_0_i23);
MR_def_label(mercury_profile__main_2_4_0,23)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(1) = MR_r1;
	MR_sv(3) = MR_r2;
	MR_r1 = MR_sv(4);
	MR_r2 = (MR_Word) MR_string_const(" done\n", 6);
	MR_np_call_localret_ent(options__maybe_write_string_4_0,
		mercury_profile__main_2_4_0_i24);
MR_def_label(mercury_profile__main_2_4_0,24)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(2);
	MR_np_call_localret_ent(io__set_output_stream_4_0,
		mercury_profile__main_2_4_0_i25);
MR_def_label(mercury_profile__main_2_4_0,25)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(3);
	MR_r2 = MR_sv(1);
	MR_np_call_localret_ent(output__output_profile_4_0,
		mercury_profile__main_2_4_0_i44);
MR_def_label(mercury_profile__main_2_4_0,44)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_succip_word = MR_sv(7);
	MR_decr_sp(7);
	MR_np_tailcall_ent(io__nl_2_0);
MR_def_label(mercury_profile__main_2_4_0,45)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_succip_word = MR_sv(7);
	MR_decr_sp(7);
	MR_np_tailcall_ent(mercury_profile__long_usage_2_0);
MR_def_label(mercury_profile__main_2_4_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_BEGIN_MODULE(mercury_profile_module3)
	...
	MR_init_label7(main_2_0,2,3,6,7,11,13,5)
MR_BEGIN_CODE
...
MR_def_label(main_2_0,13)
	...
	MR_succip_word = MR_sv(2);
	MR_decr_sp(2);
	MR_np_tailcall_ent(mercury_profile__main_2_4_0);
