...
main_2_p_0(void)
{
  ...
  if (((MR_tag((MR_Word) GetoptResult_7)) == (MR_Integer) 1))
  {
    ...
    mercury__io__progname_base_4_p_0((MR_String) "mercury_profile", &ProgName_33);
    mercury__io__stderr_stream_3_p_0(&StdErr_34);
    mercury__io__write_string_4_p_0(StdErr_34, ProgName_33);
    mercury__io__write_string_4_p_0(StdErr_34, (MR_String) ": ");
    mercury__io__write_string_4_p_0(StdErr_34, ErrorMessage_9);
    mercury__io__write_string_4_p_0(StdErr_34, (MR_String) "\n");
    mercury__io__set_exit_status_3_p_0((MR_Integer) 1);
    mercury__io__progname_base_4_p_0((MR_String) "mprof", &ProgName_52);
    mercury__library__version_2_p_0(&Version_53, &Fullarch_54);
    {
      Var_76 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), Var_76, 0) = ((MR_Box) (ProgName_52));
      MR_hl_field(MR_mktag(1), Var_76, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &mercury_profile_scalar_common_2[0])));
    }
    {
      Var_74 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), Var_74, 0) = ((MR_Box) ((MR_String) "Use \140"));
      MR_hl_field(MR_mktag(1), Var_74, 1) = ((MR_Box) (Var_76));
    }
    {
      Var_72 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), Var_72, 0) = ((MR_Box) ((MR_String) " [<options>] [<files>]\n"));
      MR_hl_field(MR_mktag(1), Var_72, 1) = ((MR_Box) (Var_74));
    }
    {
      Var_71 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), Var_71, 0) = ((MR_Box) (ProgName_52));
      MR_hl_field(MR_mktag(1), Var_71, 1) = ((MR_Box) (Var_72));
    }
    {
      Var_69 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), Var_69, 0) = ((MR_Box) ((MR_String) "Usage: "));
      MR_hl_field(MR_mktag(1), Var_69, 1) = ((MR_Box) (Var_71));
    }
    {
      Var_67 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), Var_67, 0) = ((MR_Box) ((MR_String) "Copyright (C) 2013-2022 The Mercury team\n"));
      MR_hl_field(MR_mktag(1), Var_67, 1) = ((MR_Box) (Var_69));
    }
    {
      Var_65 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), Var_65, 0) = ((MR_Box) ((MR_String) "Copyright (C) 1995-2012 The University of Melbourne\n"));
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), Var_62, 0) = ((MR_Box) (Fullarch_54));
      MR_hl_field(MR_mktag(1), Var_62, 1) = ((MR_Box) (Var_63));
    }
    {
      Var_60 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), Var_60, 0) = ((MR_Box) ((MR_String) ", on "));
      MR_hl_field(MR_mktag(1), Var_60, 1) = ((MR_Box) (Var_62));
    }
    {
      Var_59 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), Var_59, 0) = ((MR_Box) (Version_53));
      MR_hl_field(MR_mktag(1), Var_59, 1) = ((MR_Box) (Var_60));
    }
    {
      Var_57 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), Var_57, 0) = ((MR_Box) ((MR_String) "mprof - Mercury profiler, version "));
      MR_hl_field(MR_mktag(1), Var_57, 1) = ((MR_Box) (Var_59));
    }
    mercury__io__write_strings_4_p_0(StdErr_34, Var_57);
  }
  else
  {
    MR_Word OptionTable0_10 = ((MR_Word) ((MR_hl_field(MR_mktag(0), GetoptResult_7, (MR_Integer) 0))));
    MR_Word VeryVerbose_80;

    globals__io_init_3_p_0(OptionTable0_10);
    globals__io_lookup_bool_option_4_p_0((MR_Integer) 1, &VeryVerbose_80);
    switch (VeryVerbose_80) {
          ...
          case (MR_Integer) 0:
            {
              ...
              MR_Word Prof0_19;
              MR_Word CallGraph0_20;
              MR_Word CallGraphOpt_21;
              MR_Word Prof_23;
              MR_Word IndexMap_24;
              MR_Word ProfilerOutput_25;
              MR_Word StdOut_26;

              mercury__io__stderr_stream_3_p_0(&ProgressStream_18);
              globals__io_lookup_bool_option_4_p_0((MR_Integer) 0, &Verbose_17);
              options__maybe_write_string_5_p_0(ProgressStream_18, Verbose_17, (MR_String) "% Processing input files...");
              process_file__process_profiling_data_files_6_p_0(ProgressStream_18, ProgressStream_18, &Prof0_19, &CallGraph0_20);
              options__maybe_write_string_5_p_0(ProgressStream_18, Verbose_17, (MR_String) " done\n");
              globals__io_lookup_bool_option_4_p_0((MR_Integer) 3, &CallGraphOpt_21);
              switch (CallGraphOpt_21) {
                default: /*NOTREACHED*/ MR_assert(0);
                case (MR_Integer) 0:
                  Prof_23 = Prof0_19;
                  break;
                case (MR_Integer) 1:
                  {
                    MR_Word CallGraph_22;

                    options__maybe_write_string_5_p_0(ProgressStream_18, Verbose_17, (MR_String) "% Building call graph...");
                    call_graph__build_call_graph_6_p_0(ProgressStream_18, Args_4, CallGraph0_20, &CallGraph_22);
                    options__maybe_write_string_5_p_0(ProgressStream_18, Verbose_17, (MR_String) " done\n");
                    options__maybe_write_string_5_p_0(ProgressStream_18, Verbose_17, (MR_String) "% Propagating counts...");
                    propagate__propagate_counts_5_p_0(CallGraph_22, Prof0_19, &Prof_23);
                    options__maybe_write_string_5_p_0(ProgressStream_18, Verbose_17, (MR_String) " done\n");
                  }
                  break;
              }
              options__maybe_write_string_5_p_0(ProgressStream_18, Verbose_17, (MR_String) "% Generating output...");
              generate_output__generate_prof_output_6_p_0(ProgressStream_18, Prof_23, &IndexMap_24, &ProfilerOutput_25);
              options__maybe_write_string_5_p_0(ProgressStream_18, Verbose_17, (MR_String) " done\n");
              mercury__io__stdout_stream_3_p_0(&StdOut_26);
              output__output_profile_5_p_0(StdOut_26, ProfilerOutput_25, IndexMap_24);
            }
            break;
          case (MR_Integer) 1:
    ...
    case (MR_Integer) 1:
      {
        ...
        mercury__io__progname_base_4_p_0((MR_String) "mprof", &ProgName_53);
        mercury__library__version_2_p_0(&Version_54, &Fullarch_55);
        {
          Var_73 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), Var_73, 0) = ((MR_Box) (ProgName_53));
          MR_hl_field(MR_mktag(1), Var_73, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &mercury_profile_scalar_common_2[17])));
        }
        {
          Var_71 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), Var_71, 0) = ((MR_Box) ((MR_String) "Usage: "));
          MR_hl_field(MR_mktag(1), Var_71, 1) = ((MR_Box) (Var_73));
        }
        {
          Var_69 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), Var_69, 0) = ((MR_Box) ((MR_String) "Copyright (C) 2013-2022 The Mercury team\n\n"));
          MR_hl_field(MR_mktag(1), Var_69, 1) = ((MR_Box) (Var_71));
        }
        {
          Var_67 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), Var_67, 0) = ((MR_Box) ((MR_String) "Copyright (C) 1995-2012 The University of Melbourne\n"));
          MR_hl_field(MR_mktag(1), Var_67, 1) = ((MR_Box) (Var_69));
        }
        {
          Var_65 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(1), Var_64, 0) = ((MR_Box) (Fullarch_55));
          MR_hl_field(MR_mktag(1), Var_64, 1) = ((MR_Box) (Var_65));
        }
        {
          Var_62 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), Var_62, 0) = ((MR_Box) ((MR_String) ", on "));
          MR_hl_field(MR_mktag(1), Var_62, 1) = ((MR_Box) (Var_64));
        }
        {
          Var_61 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), Var_61, 0) = ((MR_Box) (Version_54));
          MR_hl_field(MR_mktag(1), Var_61, 1) = ((MR_Box) (Var_62));
        }
        {
          Var_58 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), Var_58, 0) = ((MR_Box) ((MR_String) "Name: mprof - Mercury profiler, version "));
          MR_hl_field(MR_mktag(1), Var_58, 1) = ((MR_Box) (Var_61));
        }
        mercury__io__write_strings_4_p_0(StdOut_8, Var_58);
