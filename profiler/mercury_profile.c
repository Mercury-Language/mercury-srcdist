...
static /* final */ const MR_Box mercury_profile_scalar_common_2[18][2] = {
  ...
  /* row   3 */
  {
    ...
    ((MR_Box) (MR_mkword(1, &mercury_profile_scalar_common_2[2])))
  },
  /* row   4 */
  {
  ...
  /* row   7 */
  {
    ...
    ((MR_Box) (MR_mkword(1, &mercury_profile_scalar_common_2[6])))
  },
  /* row   8 */
  {
  ...
  /* row  13 */
  {
    ...
    ((MR_Box) (MR_mkword(1, &mercury_profile_scalar_common_2[12])))
  },
  /* row  14 */
  {
  ...
  /* row  15 */
  {
    ...
    ((MR_Box) (MR_mkword(1, &mercury_profile_scalar_common_2[14])))
  },
  /* row  16 */
  {
    ((MR_Box) ((MR_String) "\n")),
    ((MR_Box) (MR_mkword(1, &mercury_profile_scalar_common_2[15])))
  },
  /* row  17 */
  {
    ((MR_Box) ((MR_String) " [<options>] [<files>]\n")),
    ((MR_Box) (MR_mkword(1, &mercury_profile_scalar_common_2[16])))
  },
};
...
main_2_p_0(void)
{
  ...
  if (((MR_tag((MR_Word) GetoptResult_7)) == (MR_Integer) 1))
  {
    ...
    mercury__library__version_2_p_0(&Version_52, &Fullarch_53);
    {
      ...
      MR_hl_field(1, Var_75, 0) = ((MR_Box) (ProgName_51));
      MR_hl_field(1, Var_75, 1) = ((MR_Box) (MR_mkword(1, &mercury_profile_scalar_common_2[0])));
    }
    {
      Var_73 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(1, Var_73, 0) = ((MR_Box) ((MR_String) "Use \140"));
      MR_hl_field(1, Var_73, 1) = ((MR_Box) (Var_75));
    }
    {
      Var_71 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(1, Var_71, 0) = ((MR_Box) ((MR_String) " [<options>] [<files>]\n"));
      MR_hl_field(1, Var_71, 1) = ((MR_Box) (Var_73));
    }
    {
      Var_70 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(1, Var_70, 0) = ((MR_Box) (ProgName_51));
      MR_hl_field(1, Var_70, 1) = ((MR_Box) (Var_71));
    }
    {
      Var_68 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(1, Var_68, 0) = ((MR_Box) ((MR_String) "Usage: "));
      MR_hl_field(1, Var_68, 1) = ((MR_Box) (Var_70));
    }
    {
      Var_66 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(1, Var_66, 0) = ((MR_Box) ((MR_String) "Copyright (C) 2013-2023 The Mercury team\n"));
      MR_hl_field(1, Var_66, 1) = ((MR_Box) (Var_68));
    }
    {
      Var_64 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(1, Var_64, 0) = ((MR_Box) ((MR_String) "Copyright (C) 1995-2012 The University of Melbourne\n"));
    ...
    }
    {
      ...
      MR_hl_field(1, Var_61, 0) = ((MR_Box) (Fullarch_53));
      MR_hl_field(1, Var_61, 1) = ((MR_Box) (Var_62));
    }
    {
      Var_59 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(1, Var_59, 0) = ((MR_Box) ((MR_String) ", on "));
      MR_hl_field(1, Var_59, 1) = ((MR_Box) (Var_61));
    }
    {
      Var_58 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(1, Var_58, 0) = ((MR_Box) (Version_52));
      MR_hl_field(1, Var_58, 1) = ((MR_Box) (Var_59));
    }
    {
      Var_56 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(1, Var_56, 0) = ((MR_Box) ((MR_String) "mprof - Mercury profiler, version "));
      MR_hl_field(1, Var_56, 1) = ((MR_Box) (Var_58));
    }
    mercury__io__write_strings_4_p_0(StdErr_33, Var_56);
  }
  else
  {
    MR_Word OptionTable0_10 = ((MR_Word) ((MR_hl_field(0, GetoptResult_7, (MR_Integer) 0))));
    MR_Word VeryVerbose_79;

    globals__io_init_3_p_0(OptionTable0_10);
    globals__io_lookup_bool_option_4_p_0((MR_Integer) 1, &VeryVerbose_79);
    switch (VeryVerbose_79) {
          ...
          case (MR_Integer) 0:
            {
              ...
              MR_Word Prof0_20;
              MR_Word CallGraph0_21;
              MR_Word CallGraphOpt_22;
              MR_Word Prof_24;
              MR_Word IndexMap_25;
              MR_Word ProfilerOutput_26;
              MR_Word StdOut_27;

              mercury__io__stderr_stream_3_p_0(&ProgressStream_19);
              globals__io_lookup_bool_option_4_p_0((MR_Integer) 0, &Verbose_18);
              options__maybe_write_string_5_p_0(ProgressStream_19, Verbose_18, (MR_String) "% Processing input files...");
              process_file__process_profiling_data_files_6_p_0(ProgressStream_19, ProgressStream_19, &Prof0_20, &CallGraph0_21);
              options__maybe_write_string_5_p_0(ProgressStream_19, Verbose_18, (MR_String) " done\n");
              globals__io_lookup_bool_option_4_p_0((MR_Integer) 3, &CallGraphOpt_22);
              switch (CallGraphOpt_22) {
                default: /*NOTREACHED*/ MR_assert(0);
                case (MR_Integer) 0:
                  Prof_24 = Prof0_20;
                  break;
                case (MR_Integer) 1:
                  {
                    MR_Word CallGraph_23;

                    options__maybe_write_string_5_p_0(ProgressStream_19, Verbose_18, (MR_String) "% Building call graph...");
                    call_graph__build_call_graph_6_p_0(ProgressStream_19, Args_4, CallGraph0_21, &CallGraph_23);
                    options__maybe_write_string_5_p_0(ProgressStream_19, Verbose_18, (MR_String) " done\n");
                    options__maybe_write_string_5_p_0(ProgressStream_19, Verbose_18, (MR_String) "% Propagating counts...");
                    propagate__propagate_counts_5_p_0(CallGraph_23, Prof0_20, &Prof_24);
                    options__maybe_write_string_5_p_0(ProgressStream_19, Verbose_18, (MR_String) " done\n");
                  }
                  break;
              }
              options__maybe_write_string_5_p_0(ProgressStream_19, Verbose_18, (MR_String) "% Generating output...");
              generate_output__generate_prof_output_6_p_0(ProgressStream_19, Prof_24, &IndexMap_25, &ProfilerOutput_26);
              options__maybe_write_string_5_p_0(ProgressStream_19, Verbose_18, (MR_String) " done\n");
              mercury__io__stdout_stream_3_p_0(&StdOut_27);
              output__output_profile_5_p_0(StdOut_27, ProfilerOutput_26, IndexMap_25);
            }
            break;
          case (MR_Integer) 1:
    ...
    case (MR_Integer) 1:
      {
        ...
        MR_String Version_55;
        MR_String Fullarch_56;
        MR_Word Var_59;
        MR_Word Var_62;
        MR_Word Var_63;
        MR_Word Var_65;
        ...
        mercury__io__progname_base_4_p_0((MR_String) "mprof", &ProgName_54);
        mercury__library__version_2_p_0(&Version_55, &Fullarch_56);
        {
          Var_74 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(1, Var_74, 0) = ((MR_Box) (ProgName_54));
          MR_hl_field(1, Var_74, 1) = ((MR_Box) (MR_mkword(1, &mercury_profile_scalar_common_2[17])));
        }
        {
          Var_72 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(1, Var_72, 0) = ((MR_Box) ((MR_String) "Usage: "));
          MR_hl_field(1, Var_72, 1) = ((MR_Box) (Var_74));
        }
        {
          Var_70 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(1, Var_70, 0) = ((MR_Box) ((MR_String) "Copyright (C) 2013-2023 The Mercury team\n\n"));
          MR_hl_field(1, Var_70, 1) = ((MR_Box) (Var_72));
        }
        {
          Var_68 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(1, Var_68, 0) = ((MR_Box) ((MR_String) "Copyright (C) 1995-2012 The University of Melbourne\n"));
          MR_hl_field(1, Var_68, 1) = ((MR_Box) (Var_70));
        }
        {
          Var_66 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(1, Var_66, 0) = ((MR_Box) ((MR_String) "\n"));
          MR_hl_field(1, Var_66, 1) = ((MR_Box) (Var_68));
        }
        {
          Var_65 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(1, Var_65, 0) = ((MR_Box) (Fullarch_56));
          MR_hl_field(1, Var_65, 1) = ((MR_Box) (Var_66));
        }
        {
          Var_63 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(1, Var_63, 0) = ((MR_Box) ((MR_String) ", on "));
          MR_hl_field(1, Var_63, 1) = ((MR_Box) (Var_65));
        }
        {
          Var_62 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(1, Var_62, 0) = ((MR_Box) (Version_55));
          MR_hl_field(1, Var_62, 1) = ((MR_Box) (Var_63));
        }
        {
          Var_59 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(1, Var_59, 0) = ((MR_Box) ((MR_String) "Name: mprof - Mercury profiler, version "));
          MR_hl_field(1, Var_59, 1) = ((MR_Box) (Var_62));
        }
        mercury__io__write_strings_4_p_0(StdOut_8, Var_59);
