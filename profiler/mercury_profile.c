...
static /* final */ const MR_Box mercury_profile_scalar_common_3[4][5];
...
main_2_p_0(void)
{
  ...
  mercury__getopt__process_options_4_p_0((MR_Word) (&options__options__type_ctor_info_option_0), (MR_Word) (MR_mkword(3, &mercury_profile_scalar_common_3[3])), Args0_4, &Args_6, &GetoptResult_7);
              ...
              case (MR_Integer) 1:
                {
                  ...
                  propagate__propagate_counts_3_p_0(CallGraph_69, Prof0_66, &Prof_70);
                  options__maybe_write_string_5_p_0(ProgressStream_65, Verbose_64, (MR_String) " done\n");
                }
                break;
            }
