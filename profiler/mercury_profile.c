...
{
  {
    ...
    if (((MR_tag((MR_Word) Result0_7)) == (MR_mktag((MR_Integer) 1))))
    {
...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), Var_22, 0) = ((MR_Box) ((MR_String) "Copyright (C) 2013-2018 The Mercury team\n\n"));
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), Var_11, 0) = ((MR_Box) ((MR_String) "Mercury Profiler, version "));
...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), Var_45, 0) = ((MR_Box) ((MR_String) "Copyright (C) 2013-2018 The Mercury team\n"));
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), Var_34, 0) = ((MR_Box) ((MR_String) "Mercury Profiler, version "));
