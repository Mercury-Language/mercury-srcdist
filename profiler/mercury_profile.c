...
main_2_p_0(void)
{
  ...
  if (((MR_tag((MR_Word) GetoptResult_7)) == (MR_Integer) 1))
  {
    ...
    mercury__library__version_2_p_0(&Version_72, &FullArch_73);
    mercury__io__write_string_4_p_0(StdErr_33, (MR_String) "Mercury profiler, version ");
    mercury__io__write_string_4_p_0(StdErr_33, Version_72);
    mercury__io__write_string_4_p_0(StdErr_33, (MR_String) ", on ");
    mercury__io__write_string_4_p_0(StdErr_33, FullArch_73);
    mercury__io__write_string_4_p_0(StdErr_33, (MR_String) "\n");
    mercury__io__write_strings_4_p_0(StdErr_33, (MR_Word) (MR_mkword(1, &mercury_profile_scalar_common_2[14])));
  ...
  else
  {
    ...
    MR_Word VeryVerbose_89;

    globals__io_init_3_p_0(OptionTable0_10);
    globals__io_lookup_bool_option_4_p_0((MR_Integer) 1, &VeryVerbose_89);
    switch (VeryVerbose_89) {
  ...
  MR_Word Args_4)
{
  ...
  if (succeeded)
  {
    ...
    MR_String Version_23;
    MR_String FullArch_24;
    MR_Word Var_35;
    MR_Word Var_38;

    mercury__io__progname_base_4_p_0((MR_String) "mprof", &ProgName_22);
    mercury__library__version_2_p_0(&Version_23, &FullArch_24);
    mercury__io__write_string_4_p_0(StdOut_7, (MR_String) "Name: mprof - Mercury profiler, version ");
    mercury__io__write_string_4_p_0(StdOut_7, Version_23);
    mercury__io__write_string_4_p_0(StdOut_7, (MR_String) ", on ");
    mercury__io__write_string_4_p_0(StdOut_7, FullArch_24);
    ...
    mercury__io__write_strings_4_p_0(StdOut_7, (MR_Word) (MR_mkword(1, &mercury_profile_scalar_common_2[14])));
    {
      ...
      MR_hl_field(1, Var_38, 0) = ((MR_Box) (ProgName_22));
      MR_hl_field(1, Var_38, 1) = ((MR_Box) (MR_mkword(1, &mercury_profile_scalar_common_2[2])));
    }
    {
      Var_35 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(1, Var_35, 0) = ((MR_Box) ((MR_String) "Usage: "));
      MR_hl_field(1, Var_35, 1) = ((MR_Box) (Var_38));
    }
    mercury__io__write_strings_4_p_0(StdOut_7, Var_35);
  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      mercury__io__write_string_4_p_0(StdOut_7, Version_58);
      mercury__io__write_string_4_p_0(StdOut_7, (MR_String) ", on ");
      mercury__io__write_string_4_p_0(StdOut_7, FullArch_59);
      mercury__io__write_string_4_p_0(StdOut_7, (MR_String) "\n");
      mercury__io__write_strings_4_p_0(StdOut_7, (MR_Word) (MR_mkword(1, &mercury_profile_scalar_common_2[14])));
    }
    else
    {
      ...
      switch (Snapshots_8) {
        default: /*NOTREACHED*/ MR_assert(0);
        case (MR_Integer) 0:
          mercury_profile__main_3_3_p_0(Args_4);
          break;
        case (MR_Integer) 1:
  ...
  MR_Word Args_4)
{
  ...
  MR_Word Prof0_9;
  MR_Word CallGraph0_10;
  MR_Word CallGraphOpt_11;
  MR_Word Prof_13;
  MR_Word IndexMap_14;
  MR_Word ProfilerOutput_15;
  MR_Word StdOut_16;

  mercury__io__stderr_stream_3_p_0(&ProgressStream_8);
  globals__io_lookup_bool_option_4_p_0((MR_Integer) 0, &Verbose_7);
  options__maybe_write_string_5_p_0(ProgressStream_8, Verbose_7, (MR_String) "% Processing input files...");
  process_file__process_profiling_data_files_6_p_0(ProgressStream_8, ProgressStream_8, &Prof0_9, &CallGraph0_10);
  options__maybe_write_string_5_p_0(ProgressStream_8, Verbose_7, (MR_String) " done\n");
  globals__io_lookup_bool_option_4_p_0((MR_Integer) 3, &CallGraphOpt_11);
  switch (CallGraphOpt_11) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 0:
      Prof_13 = Prof0_9;
      break;
    case (MR_Integer) 1:
      {
        MR_Word CallGraph_12;

        options__maybe_write_string_5_p_0(ProgressStream_8, Verbose_7, (MR_String) "% Building call graph...");
        call_graph__build_call_graph_6_p_0(ProgressStream_8, Args_4, CallGraph0_10, &CallGraph_12);
        options__maybe_write_string_5_p_0(ProgressStream_8, Verbose_7, (MR_String) " done\n");
        options__maybe_write_string_5_p_0(ProgressStream_8, Verbose_7, (MR_String) "% Propagating counts...");
        propagate__propagate_counts_5_p_0(CallGraph_12, Prof0_9, &Prof_13);
        options__maybe_write_string_5_p_0(ProgressStream_8, Verbose_7, (MR_String) " done\n");
      }
      break;
  }
  options__maybe_write_string_5_p_0(ProgressStream_8, Verbose_7, (MR_String) "% Generating output...");
  generate_output__generate_prof_output_6_p_0(ProgressStream_8, Prof_13, &IndexMap_14, &ProfilerOutput_15);
  options__maybe_write_string_5_p_0(ProgressStream_8, Verbose_7, (MR_String) " done\n");
  mercury__io__stdout_stream_3_p_0(&StdOut_16);
  output__output_profile_5_p_0(StdOut_16, ProfilerOutput_15, IndexMap_14);
}
