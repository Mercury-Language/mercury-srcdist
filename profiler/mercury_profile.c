...
{
  {
    ...
    if (((MR_tag((MR_Word) GetoptResult_7)) == (MR_Integer) 1))
    {
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(1), Var_77, 0) = ((MR_Box) ((MR_String) "Copyright (C) 2013-2023 The Mercury team\n"));
...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), Var_24, 0) = ((MR_Box) ((MR_String) "Copyright (C) 2013-2023 The Mercury team\n\n"));
