          ...
          case (MR_Integer) 0:
            {
              ...
              MR_Word Prof0_23;
              MR_Word CallGraph0_24;
              MR_Word CallGraphOpt_25;
              MR_Word Prof_27;
              MR_Word IndexMap_28;
              MR_Word ProfilerOutput_29;
              MR_Word StdOut_30;

              mercury__io__stderr_stream_3_p_0(&ProgressStream_22);
              globals__io_lookup_bool_option_4_p_0((MR_Integer) 0, &Verbose_21);
              options__maybe_write_string_5_p_0(ProgressStream_22, Verbose_21, (MR_String) "% Processing input files...");
              process_file__process_profiling_data_files_6_p_0(ProgressStream_22, ProgressStream_22, &Prof0_23, &CallGraph0_24);
              options__maybe_write_string_5_p_0(ProgressStream_22, Verbose_21, (MR_String) " done\n");
              globals__io_lookup_bool_option_4_p_0((MR_Integer) 3, &CallGraphOpt_25);
              switch (CallGraphOpt_25) {
                default: /*NOTREACHED*/ MR_assert(0);
                case (MR_Integer) 0:
                  Prof_27 = Prof0_23;
                  break;
                case (MR_Integer) 1:
                  {
                    MR_Word CallGraph_26;

                    options__maybe_write_string_5_p_0(ProgressStream_22, Verbose_21, (MR_String) "% Building call graph...");
                    call_graph__build_call_graph_6_p_0(ProgressStream_22, Args_4, CallGraph0_24, &CallGraph_26);
                    options__maybe_write_string_5_p_0(ProgressStream_22, Verbose_21, (MR_String) " done\n");
                    options__maybe_write_string_5_p_0(ProgressStream_22, Verbose_21, (MR_String) "% Propagating counts...");
                    propagate__propagate_counts_5_p_0(CallGraph_26, Prof0_23, &Prof_27);
                    options__maybe_write_string_5_p_0(ProgressStream_22, Verbose_21, (MR_String) " done\n");
                  }
                  break;
              }
              options__maybe_write_string_5_p_0(ProgressStream_22, Verbose_21, (MR_String) "% Generating output...");
              generate_output__generate_prof_output_6_p_0(ProgressStream_22, Prof_27, &IndexMap_28, &ProfilerOutput_29);
              options__maybe_write_string_5_p_0(ProgressStream_22, Verbose_21, (MR_String) " done\n");
              mercury__io__stdout_stream_3_p_0(&StdOut_30);
              output__output_profile_5_p_0(StdOut_30, ProfilerOutput_29, IndexMap_28);
            }
            break;
          case (MR_Integer) 1:
    ...
    case (MR_Integer) 1:
      {
        ...
        mercury__library__version_2_p_0(&Version_62, &Fullarch_63);
        {
          Var_81 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), Var_81, 0) = ((MR_Box) (ProgName_61));
          MR_hl_field(MR_mktag(1), Var_81, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &mercury_profile_scalar_common_2[17])));
        }
        {
          Var_79 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), Var_79, 0) = ((MR_Box) ((MR_String) "Usage: "));
        ...
        {
          Var_66 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), Var_66, 0) = ((MR_Box) ((MR_String) "Name: mprof - Mercury profiler, version "));
          MR_hl_field(MR_mktag(1), Var_66, 1) = ((MR_Box) (Var_69));
        }
        mercury__io__write_strings_4_p_0(StdOut_8, Var_66);
