...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), Var_22, 0) = ((MR_Box) ((MR_String) "Copyright (C) 2013-2017 The Mercury team\n\n"));
...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), Var_45, 0) = ((MR_Box) ((MR_String) "Copyright (C) 2013-2017 The Mercury team\n"));
