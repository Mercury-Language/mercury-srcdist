...
static /* final */ const MR_Box mercury_profile_scalar_common_1[18][2];
...
{
  {
    ...
    if (((MR_tag((MR_Word) GetoptResult_7)) == (MR_Integer) 1))
    {
      ...
      mercury__library__version_2_p_0(&Version_62, &Fullarch_63);
      {
        ...
        MR_hl_field(MR_mktag(1), Var_86, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &mercury_profile_scalar_common_1[17])));
      }
      {
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(1), Var_77, 0) = ((MR_Box) ((MR_String) "Copyright (C) 2013-2021 The Mercury team\n"));
...
{
  {
    ...
    mercury__library__version_2_p_0(&Version_7, &Fullarch_8);
    {
      ...
      MR_hl_field(MR_mktag(1), Var_28, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &mercury_profile_scalar_common_1[16])));
    }
    {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), Var_24, 0) = ((MR_Box) ((MR_String) "Copyright (C) 2013-2021 The Mercury team\n\n"));
