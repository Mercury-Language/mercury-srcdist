...
main_2_p_0(void)
{
  ...
  if (((MR_tag((MR_Word) GetoptResult_7)) == (MR_Integer) 1))
  {
    ...
    mercury__library__version_2_p_0(&Version_72, &_FullArch_73);
  ...
  else
  {
    ...
    globals__io_lookup_bool_option_4_p_0((MR_Integer) 1, &VeryVerbose_84);
    switch (VeryVerbose_84) {
  ...
  MR_Word Args_4)
{
  ...
  if (succeeded)
  {
    ...
    MR_Word Var_33;
    MR_Word Var_36;
    MR_String _FullArch_24;

    mercury__io__progname_base_4_p_0((MR_String) "mprof", &ProgName_22);
    mercury__library__version_2_p_0(&Version_23, &_FullArch_24);
    ...
    mercury__io__write_strings_4_p_0(StdOut_7, (MR_Word) (MR_mkword(1, &mercury_profile_scalar_common_2[14])));
    {
      ...
      MR_hl_field(1, Var_36, 0) = ((MR_Box) (ProgName_22));
      MR_hl_field(1, Var_36, 1) = ((MR_Box) (MR_mkword(1, &mercury_profile_scalar_common_2[2])));
    }
    {
      Var_33 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(1, Var_33, 0) = ((MR_Box) ((MR_String) "Usage: "));
      MR_hl_field(1, Var_33, 1) = ((MR_Box) (Var_36));
    }
    mercury__io__write_strings_4_p_0(StdOut_7, Var_33);
  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      MR_String _FullArch_54;

      mercury__library__version_2_p_0(&Version_53, &_FullArch_54);
      mercury__io__write_string_4_p_0(StdOut_7, (MR_String) "Mercury profiler, version ");
      mercury__io__write_string_4_p_0(StdOut_7, Version_53);
      mercury__io__write_string_4_p_0(StdOut_7, (MR_String) "\n");
      mercury__io__write_strings_4_p_0(StdOut_7, (MR_Word) (MR_mkword(1, &mercury_profile_scalar_common_2[14])));
    }
    else
    {
      ...
      switch (Snapshots_8) {
        ...
        case (MR_Integer) 0:
          {
            MR_Word Verbose_66;
            MR_Word ProgressStream_67;
            MR_Word Prof0_68;
            MR_Word CallGraph0_69;
            MR_Word CallGraphOpt_70;
            MR_Word Prof_72;
            MR_Word IndexMap_73;
            MR_Word ProfilerOutput_74;
            MR_Word StdOut_75;

            mercury__io__stderr_stream_3_p_0(&ProgressStream_67);
            globals__io_lookup_bool_option_4_p_0((MR_Integer) 0, &Verbose_66);
            options__maybe_write_string_5_p_0(ProgressStream_67, Verbose_66, (MR_String) "% Processing input files...");
            process_file__process_profiling_data_files_6_p_0(ProgressStream_67, ProgressStream_67, &Prof0_68, &CallGraph0_69);
            options__maybe_write_string_5_p_0(ProgressStream_67, Verbose_66, (MR_String) " done\n");
            globals__io_lookup_bool_option_4_p_0((MR_Integer) 3, &CallGraphOpt_70);
            switch (CallGraphOpt_70) {
              default: /*NOTREACHED*/ MR_assert(0);
              case (MR_Integer) 0:
                Prof_72 = Prof0_68;
                break;
              case (MR_Integer) 1:
                {
                  MR_Word CallGraph_71;

                  options__maybe_write_string_5_p_0(ProgressStream_67, Verbose_66, (MR_String) "% Building call graph...");
                  call_graph__build_call_graph_6_p_0(ProgressStream_67, Args_4, CallGraph0_69, &CallGraph_71);
                  options__maybe_write_string_5_p_0(ProgressStream_67, Verbose_66, (MR_String) " done\n");
                  options__maybe_write_string_5_p_0(ProgressStream_67, Verbose_66, (MR_String) "% Propagating counts...");
                  propagate__propagate_counts_5_p_0(CallGraph_71, Prof0_68, &Prof_72);
                  options__maybe_write_string_5_p_0(ProgressStream_67, Verbose_66, (MR_String) " done\n");
                }
                break;
            }
            options__maybe_write_string_5_p_0(ProgressStream_67, Verbose_66, (MR_String) "% Generating output...");
            generate_output__generate_prof_output_6_p_0(ProgressStream_67, Prof_72, &IndexMap_73, &ProfilerOutput_74);
            options__maybe_write_string_5_p_0(ProgressStream_67, Verbose_66, (MR_String) " done\n");
            mercury__io__stdout_stream_3_p_0(&StdOut_75);
            output__output_profile_5_p_0(StdOut_75, ProfilerOutput_74, IndexMap_73);
          }
          break;
        case (MR_Integer) 1:
