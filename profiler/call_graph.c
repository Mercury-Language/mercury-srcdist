...
{
  {
    ...
    if ((call_graph__Result_11 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
    ...
    else
      {
        ...
        MR_Word call_graph__Var_26;
        MR_Word call_graph__Var_29;
        MR_Word call_graph__Var_30;
        MR_Word call_graph__Var_32;
        ...
        {
          call_graph__Var_32 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), call_graph__Var_32, 0) = ((MR_Box) (call_graph__ErrorMsg_13));
          MR_hl_field(MR_mktag(1), call_graph__Var_32, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &call_graph_scalar_common_1[1])));
        }
        {
          call_graph__Var_30 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), call_graph__Var_30, 0) = ((MR_Box) ((MR_String) "\': "));
          MR_hl_field(MR_mktag(1), call_graph__Var_30, 1) = ((MR_Box) (call_graph__Var_32));
        }
        {
          call_graph__Var_29 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), call_graph__Var_29, 0) = ((MR_Box) (call_graph__File_8));
          MR_hl_field(MR_mktag(1), call_graph__Var_29, 1) = ((MR_Box) (call_graph__Var_30));
        }
        {
          call_graph__Var_26 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), call_graph__Var_26, 0) = ((MR_Box) ((MR_String) "mprof: error opening file \140"));
          MR_hl_field(MR_mktag(1), call_graph__Var_26, 1) = ((MR_Box) (call_graph__Var_29));
        }
        {
          mercury__io__write_strings_4_p_0(call_graph__StdErr_14, call_graph__Var_26);
        }
  ...
  while (MR_TRUE)
    {
      /* tailcall optimized into a loop */
      {
        ...
        if ((call_graph__MaybeLabelName_7 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
          *call_graph__STATE_VARIABLE_StaticCallGraph_13 = call_graph__STATE_VARIABLE_StaticCallGraph_0_12;
        else
          {
            ...
            MR_String call_graph__CallerLabel_8 = ((MR_String) (MR_hl_field(MR_mktag(1), call_graph__MaybeLabelName_7, (MR_Integer) 0)));
            ...
            {
              MR_Word call_graph__next_value_of_STATE_VARIABLE_StaticCallGraph_0_12 = call_graph__STATE_VARIABLE_StaticCallGraph_18_18;

              call_graph__STATE_VARIABLE_StaticCallGraph_0_12 = call_graph__next_value_of_STATE_VARIABLE_StaticCallGraph_0_12;
            }
            continue;
          }
      }
      ...
      case (MR_Integer) 0:
        {
          ...
          {
            call_graph__Var_29 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL);
            MR_hl_field(MR_mktag(0), call_graph__Var_29, 0) = ((MR_Box) (&call_graph_scalar_common_2[0]));
            MR_hl_field(MR_mktag(0), call_graph__Var_29, 1) = ((MR_Box) (call_graph__build_call_graph_5_p_0_1));
            MR_hl_field(MR_mktag(0), call_graph__Var_29, 2) = ((MR_Box) (MR_Word) ((MR_Integer) 1));
            MR_hl_field(MR_mktag(0), call_graph__Var_29, 3) = ((MR_Box) (call_graph__VeryVerbose_10));
          }
          {
            mercury__list__foldl2_6_p_2((MR_Word) &mercury__builtin__builtin__type_ctor_info_string_0, (MR_Word) &call_graph_scalar_common_1[0], (MR_Word) &mercury__io__io__type_ctor_info_state_0, call_graph__Var_29, call_graph__Args_6, ((MR_Box) (call_graph__STATE_VARIABLE_StaticCallGraph_0_11)), &call_graph__conv2_STATE_VARIABLE_StaticCallGraph_12, ((MR_Box) ((MR_Integer) 0)), &call_graph__conv1_STATE_VARIABLE_IO_14);
          }
