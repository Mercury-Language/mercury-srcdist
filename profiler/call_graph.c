  ...
  MR_Word * STATE_VARIABLE_StaticCallGraph_19)
{
  ...
  {
    MR_Word Error_15 = ((MR_Word) ((MR_hl_field(1, Result_13, 0))));
  ...
  MR_Word * STATE_VARIABLE_StaticCallGraph_15)
{
  while (MR_TRUE)
  {
    ...
    {
      MR_String CallerLabel_10 = ((MR_String) ((MR_hl_field(1, MaybeLabelName_9, 0))));
      MR_String CalleeLabel_11;
      MR_Word CallerKey_12;
      MR_Word CalleeKey_13;
      MR_Word STATE_VARIABLE_StaticCallGraph_1_20;
      ...
      mercury__digraph__add_edge_4_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), CallerKey_12, CalleeKey_13, STATE_VARIABLE_StaticCallGraph_0_14, &STATE_VARIABLE_StaticCallGraph_1_20);
      // direct tailcall eliminated
      ;
      next_value_of_STATE_VARIABLE_StaticCallGraph_0_14 = STATE_VARIABLE_StaticCallGraph_1_20;
  ...
  MR_Box * wrapper_arg_5)
{
  ...
  call_graph__process_prof_file_7_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) ((MR_hl_field(0, closure, 4)))), ((MR_String) (wrapper_arg_1)), ((MR_Word) (wrapper_arg_2)), &conv0_STATE_VARIABLE_StaticCallGraph_19);
    ...
    case (MR_Integer) 0:
      {
...

        {
          ...
          MR_hl_field(0, Var_21, 0) = ((MR_Box) (&call_graph_scalar_common_2[0]));
          MR_hl_field(0, Var_21, 1) = ((MR_Box) (call_graph__build_call_graph_6_p_0_1));
          MR_hl_field(0, Var_21, 2) = ((MR_Box) ((MR_Integer) 2));
          MR_hl_field(0, Var_21, 3) = ((MR_Box) (ProgressStream_7));
          MR_hl_field(0, Var_21, 4) = ((MR_Box) (VeryVerbose_12));
        }
        mercury__list__foldl2_6_p_2((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&call_graph_scalar_common_1[0]), (MR_Word) (&mercury__io__io__type_ctor_info_state_0), Var_21, Args_8, ((MR_Box) (STATE_VARIABLE_StaticCallGraph_0_13)), &conv2_STATE_VARIABLE_StaticCallGraph_14, ((MR_Box) ((MR_Integer) 0)), &conv1_STATE_VARIABLE_IO_16);
