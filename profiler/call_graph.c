    ...
    case (MR_Integer) 0:
      {
...

        {
          ...
          MR_hl_field(MR_mktag(0), Var_30, 0) = ((MR_Box) (&call_graph_scalar_common_2[0]));
          MR_hl_field(MR_mktag(0), Var_30, 1) = ((MR_Box) (call_graph__build_call_graph_6_p_0_1));
          MR_hl_field(MR_mktag(0), Var_30, 2) = ((MR_Box) ((MR_Integer) 2));
          MR_hl_field(MR_mktag(0), Var_30, 3) = ((MR_Box) (ProgressStream_7));
          MR_hl_field(MR_mktag(0), Var_30, 4) = ((MR_Box) (VeryVerbose_12));
        }
        mercury__list__foldl2_6_p_2((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&call_graph_scalar_common_1[0]), (MR_Word) (&mercury__io__io__type_ctor_info_state_0), Var_30, Args_8, ((MR_Box) (STATE_VARIABLE_StaticCallGraph_0_13)), &conv2_STATE_VARIABLE_StaticCallGraph_14, ((MR_Box) ((MR_Integer) 0)), &conv1_STATE_VARIABLE_IO_16);
