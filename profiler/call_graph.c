  ...
  MR_Word * STATE_VARIABLE_StaticCallGraph_19)
{
  ...
  {
    MR_Word Error_15 = ((MR_Word) ((MR_hl_field(1, Result_13, (MR_Integer) 0))));
  ...
  MR_Word * STATE_VARIABLE_StaticCallGraph_15)
{
  while (MR_TRUE)
  {
    ...
    {
      MR_String CallerLabel_10 = ((MR_String) ((MR_hl_field(1, MaybeLabelName_9, (MR_Integer) 0))));
  ...
  MR_Box * wrapper_arg_5)
{
  ...
  call_graph__process_prof_file_7_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 4)))), ((MR_String) (wrapper_arg_1)), ((MR_Word) (wrapper_arg_2)), &conv0_STATE_VARIABLE_StaticCallGraph_19);
