    ...
    case (MR_Integer) 0:
      {
...

        {
          ...
          MR_hl_field(MR_mktag(0), Var_21, 0) = ((MR_Box) (&call_graph_scalar_common_2[0]));
          MR_hl_field(MR_mktag(0), Var_21, 1) = ((MR_Box) (call_graph__build_call_graph_6_p_0_1));
          MR_hl_field(MR_mktag(0), Var_21, 2) = ((MR_Box) ((MR_Integer) 2));
          MR_hl_field(MR_mktag(0), Var_21, 3) = ((MR_Box) (ProgressStream_7));
          MR_hl_field(MR_mktag(0), Var_21, 4) = ((MR_Box) (VeryVerbose_12));
        }
