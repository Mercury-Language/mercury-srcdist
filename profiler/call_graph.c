...
{
  {
    ...
    if ((Result_11 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
    {
  ...
  MR_Word * STATE_VARIABLE_StaticCallGraph_13)
{
  while (MR_TRUE)
  {
    /* tailcall optimized into a loop */
    {
      ...
      if ((MaybeLabelName_7 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
      ...
      else
      {
        ...
        mercury__digraph__lookup_key_3_p_0(TypeCtorInfo_21_21, STATE_VARIABLE_StaticCallGraph_0_12, ((MR_Box) (CallerLabel_8)), &CallerKey_10);
        mercury__digraph__lookup_key_3_p_0(TypeCtorInfo_21_21, STATE_VARIABLE_StaticCallGraph_0_12, ((MR_Box) (CalleeLabel_9)), &CalleeKey_11);
        mercury__digraph__add_edge_4_p_0(TypeCtorInfo_21_21, CallerKey_10, CalleeKey_11, STATE_VARIABLE_StaticCallGraph_0_12, &STATE_VARIABLE_StaticCallGraph_18_18);
        /* direct tailcall eliminated */
        {
          MR_Word next_value_of_STATE_VARIABLE_StaticCallGraph_0_12 = STATE_VARIABLE_StaticCallGraph_18_18;
