...
#endif
MR_decl_label6(process_file__lookup_addr_6_0, 3,2,5,6,7,8)
...
MR_decl_label8(process_file__process_addr_2_6_0, 24,2,5,7,9,10,11,6)
MR_decl_label2(process_file__process_addr_2_6_0, 12,4)
MR_decl_label8(process_file__process_addr_decl_2_6_0, 36,2,5,6,7,9,8,12)
MR_decl_label8(process_file__process_addr_decl_2_6_0, 11,14,15,16,17,19,20,4)
...
MR_decl_label8(process_file__process_addr_pair_2_9_0, 50,2,5,6,8,7,10,11)
MR_decl_label8(process_file__process_addr_pair_2_9_0, 12,13,14,15,16,17,18,19)
MR_decl_label8(process_file__process_addr_pair_2_9_0, 21,22,20,24,26,28,29,30)
MR_decl_label2(process_file__process_addr_pair_2_9_0, 31,4)
...
MR_BEGIN_MODULE(process_file_module0)
	...
	MR_init_label6(process_file__lookup_addr_6_0,3,2,5,6,7,8)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(process_file_module1)
	...
	MR_init_label8(process_file__process_addr_decl_2_6_0,36,2,5,6,7,9,8,12)
	MR_init_label8(process_file__process_addr_decl_2_6_0,11,14,15,16,17,19,20,4)
MR_BEGIN_CODE
...
MR_def_label(process_file__process_addr_decl_2_6_0,36)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(3) = MR_r1;
	MR_sv(4) = MR_r2;
...
MR_def_label(process_file__process_addr_decl_2_6_0,9)
	...
	MR_GOTO_LAB(process_file__process_addr_decl_2_6_0_i36);
...
MR_BEGIN_MODULE(process_file_module2)
	...
	MR_init_label8(process_file__process_addr_2_6_0,24,2,5,7,9,10,11,6)
	MR_init_label2(process_file__process_addr_2_6_0,12,4)
MR_BEGIN_CODE
...
MR_def_label(process_file__process_addr_2_6_0,24)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(4) = MR_r1;
	MR_sv(5) = MR_r2;
	MR_np_call_localret_ent(read__maybe_read_label_addr_3_0,
...
MR_def_label(process_file__process_addr_2_6_0,11)
	...
	MR_GOTO_LAB(process_file__process_addr_2_6_0_i24);
...
MR_BEGIN_MODULE(process_file_module4)
	...
	MR_init_label8(process_file__process_addr_pair_2_9_0,50,2,5,6,8,7,10,11)
	MR_init_label8(process_file__process_addr_pair_2_9_0,12,13,14,15,16,17,18,19)
	MR_init_label8(process_file__process_addr_pair_2_9_0,21,22,20,24,26,28,29,30)
	MR_init_label2(process_file__process_addr_pair_2_9_0,31,4)
MR_BEGIN_CODE
...
MR_def_label(process_file__process_addr_pair_2_9_0,50)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(1) = MR_r1;
	MR_sv(8) = MR_r2;
	MR_sv(5) = MR_r3;
...
MR_def_label(process_file__process_addr_pair_2_9_0,8)
	...
	MR_sv(5) = MR_r2;
	MR_r2 = MR_sv(6);
	MR_GOTO_LAB(process_file__process_addr_pair_2_9_0_i14);
...
MR_def_label(process_file__process_addr_pair_2_9_0,19)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if ((MR_sv(3) == MR_sv(2))) {
		MR_GOTO_LAB(process_file__process_addr_pair_2_9_0_i20);
	}
	MR_sv(2) = MR_r1;
	MR_r1 = MR_sv(6);
...
MR_def_label(process_file__process_addr_pair_2_9_0,26)
	...
	if (MR_INT_NE(MR_sv(1),0)) {
		MR_GOTO_LAB(process_file__process_addr_pair_2_9_0_i28);
	}
	MR_r3 = MR_r1;
	MR_r1 = MR_sv(1);
	MR_r4 = MR_sv(10);
	...
	MR_GOTO_LAB(process_file__process_addr_pair_2_9_0_i50);
MR_def_label(process_file__process_addr_pair_2_9_0,28)
	...
	MR_np_call_localret_ent(svrelation__add_element_4_0,
		process_file__process_addr_pair_2_9_0_i29);
...
void mercury__process_file__write_out_proc_statics(FILE *fp);
#endif
