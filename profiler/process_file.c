...
MR_decl_label8(process_file__process_addr_2_6_0, 27,2,4,5,7,9,10,11)
MR_decl_label5(process_file__process_addr_2_6_0, 6,12,13,14,15)
MR_decl_label8(process_file__process_addr_decl_2_6_0, 37,2,4,5,6,7,9,8)
MR_decl_label8(process_file__process_addr_decl_2_6_0, 12,11,14,15,16,17,18,20)
MR_decl_label1(process_file__process_addr_decl_2_6_0, 21)
...
MR_decl_label8(process_file__process_addr_pair_2_9_0, 51,2,4,5,6,8,7,10)
MR_decl_label8(process_file__process_addr_pair_2_9_0, 11,12,13,14,15,16,17,18)
MR_decl_label8(process_file__process_addr_pair_2_9_0, 19,20,22,23,21,25,27,29)
MR_decl_label3(process_file__process_addr_pair_2_9_0, 30,31,32)
...
MR_BEGIN_MODULE(process_file_module1)
	...
	MR_init_label8(process_file__process_addr_decl_2_6_0,37,2,4,5,6,7,9,8)
	MR_init_label8(process_file__process_addr_decl_2_6_0,12,11,14,15,16,17,18,20)
	MR_init_label1(process_file__process_addr_decl_2_6_0,21)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(process_file_module2)
	...
	MR_init_label8(process_file__process_addr_2_6_0,27,2,4,5,7,9,10,11)
	MR_init_label5(process_file__process_addr_2_6_0,6,12,13,14,15)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(process_file_module4)
	...
	MR_init_label8(process_file__process_addr_pair_2_9_0,51,2,4,5,6,8,7,10)
	MR_init_label8(process_file__process_addr_pair_2_9_0,11,12,13,14,15,16,17,18)
	MR_init_label8(process_file__process_addr_pair_2_9_0,19,20,22,23,21,25,27,29)
	MR_init_label3(process_file__process_addr_pair_2_9_0,30,31,32)
MR_BEGIN_CODE
...
MR_def_label(process_file__process_addr_pair_2_9_0,19)
	...
	MR_tempr1 = MR_sv(9);
	MR_sv(9) = (MR_Word) MR_CTOR0_ADDR(prof_info, prof_node);
	MR_tempr2 = MR_r1;
	MR_r1 = MR_sv(9);
	MR_r2 = MR_sv(2);
	MR_r3 = MR_tempr2;
