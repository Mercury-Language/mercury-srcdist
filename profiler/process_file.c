    ...
    if ((process_file__Result_71 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
      {
        ...
        MR_Word process_file__Var_84;
        MR_Word process_file__Var_85;

        {
          process_file__Var_84 = mercury__map__init_0_f_0((MR_Word) &mercury__builtin__builtin__type_ctor_info_string_0, process_file__TypeCtorInfo_29_89);
        }
        {
          process_file__Var_85 = mercury__map__init_0_f_0(process_file__TypeCtorInfo_29_89, (MR_Word) &prof_info__prof_info__type_ctor_info_prof_node_0);
        }
        {
          process_file__process_addr_decl_2_6_p_0(process_file__Var_84, &process_file__AddrDeclMap0_13, process_file__Var_85, &process_file__ProfNodeMap0_14);
        }
        {
    ...
    else
      {
        ...
        MR_String process_file__Var_78;
        MR_String process_file__Var_79;
        MR_String process_file__Var_81;
        MR_String process_file__Var_82;

        {
          process_file__Var_82 = mercury__io__error_message_1_f_0(process_file__Error_72);
        }
        {
          process_file__Var_81 = mercury__string__f_43_43_2_f_0(process_file__Var_82, (MR_String) "\n");
        }
        {
          process_file__Var_79 = mercury__string__f_43_43_2_f_0((MR_String) "\': ", process_file__Var_81);
        }
        {
          process_file__Var_78 = mercury__string__f_43_43_2_f_0(process_file__DeclFile_70, process_file__Var_79);
        }
        {
          process_file__ErrorStr_73 = mercury__string__f_43_43_2_f_0((MR_String) "error opening declaration file \140", process_file__Var_78);
        }
        {
...
{
  {
    ...
    if ((process_file__Result_14 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
      {
        MR_Word process_file__Var_35;

        {
          process_file__Var_35 = mercury__digraph__init_0_f_0((MR_Word) &mercury__builtin__builtin__type_ctor_info_string_0);
        }
        {
          process_file__process_addr_pair_2_9_p_0(process_file__Dynamic_12, process_file__Var_35, process_file__DynamicCallGraph_10, process_file__STATE_VARIABLE_ProfNodeMap_0_17, process_file__STATE_VARIABLE_ProfNodeMap_18, process_file__STATE_VARIABLE_AddrDecl_0_19, process_file__STATE_VARIABLE_AddrDecl_20);
        }
        {
          mercury__io__seen_2_p_0();
        }
    ...
    else
      {
        ...
        MR_String process_file__Var_29;
        MR_String process_file__Var_30;
        MR_String process_file__Var_32;
        MR_String process_file__Var_33;

        {
          process_file__Var_33 = mercury__io__error_message_1_f_0(process_file__Error_15);
        }
        {
          process_file__Var_32 = mercury__string__f_43_43_2_f_0(process_file__Var_33, (MR_String) "\n");
        }
        {
          process_file__Var_30 = mercury__string__f_43_43_2_f_0((MR_String) "\': ", process_file__Var_32);
        }
        {
          process_file__Var_29 = mercury__string__f_43_43_2_f_0(process_file__PairFile_13, process_file__Var_30);
        }
        {
          process_file__ErrorStr_16 = mercury__string__f_43_43_2_f_0((MR_String) "error opening pair file \140", process_file__Var_29);
        }
        {
        ...
        else
          {
            ...
            if (process_file__succeeded)
            ...
            else
              {
                ...
                {
                  mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) &process_file_scalar_common_1[0], process_file__CallerAddr_16, &process_file__Var_78);
                }
                {
                  process_file__Str_66 = mercury__string__f_43_43_2_f_0((MR_String) "unknown__", process_file__Var_78);
                }
                {
            ...
            {
              MR_Word process_file__next_value_of_STATE_VARIABLE_DynamicCallGraph_0_30 = process_file__STATE_VARIABLE_DynamicCallGraph_49_49;
              MR_Word process_file__next_value_of_STATE_VARIABLE_ProfNodeMap_0_32 = process_file__STATE_VARIABLE_ProfNodeMap_46_46;
              MR_Word process_file__next_value_of_STATE_VARIABLE_AddrDecl_0_34 = process_file__STATE_VARIABLE_AddrDecl_43_43;

              process_file__STATE_VARIABLE_AddrDecl_0_34 = process_file__next_value_of_STATE_VARIABLE_AddrDecl_0_34;
              process_file__STATE_VARIABLE_ProfNodeMap_0_32 = process_file__next_value_of_STATE_VARIABLE_ProfNodeMap_0_32;
              process_file__STATE_VARIABLE_DynamicCallGraph_0_30 = process_file__next_value_of_STATE_VARIABLE_DynamicCallGraph_0_30;
            }
            continue;
          }
      }
...
{
  {
    ...
    if (process_file__succeeded)
    ...
    else
      {
        ...
        MR_String process_file__Var_28;

        {
          mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) &process_file_scalar_common_1[0], process_file__Addr_7, &process_file__Var_28);
        }
        {
          process_file__Str_12 = mercury__string__f_43_43_2_f_0((MR_String) "unknown__", process_file__Var_28);
        }
        {
        ...
        if ((process_file__MaybeLabelAddr_10 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
        ...
        else
          {
            ...
            if (process_file__succeeded)
              ...
              {
                MR_String process_file__Var_44;

                {
                  mercury__io__write_string_3_p_0((MR_String) "\nWarning address ");
                }
                {
                  mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) &process_file_scalar_common_1[0], process_file__LabelAddr_11, &process_file__Var_44);
                }
                {
                  mercury__io__write_string_3_p_0(process_file__Var_44);
                }
                {
            ...
            /* direct tailcall eliminated */
            {
              MR_Integer process_file__next_value_of_STATE_VARIABLE_TotalCounts_0_17 = process_file__STATE_VARIABLE_TotalCounts_26_26;
              MR_Word process_file__next_value_of_STATE_VARIABLE_ProfNodeMap_0_19 = process_file__STATE_VARIABLE_ProfNodeMap_25_25;

              process_file__STATE_VARIABLE_ProfNodeMap_0_19 = process_file__next_value_of_STATE_VARIABLE_ProfNodeMap_0_19;
              process_file__STATE_VARIABLE_TotalCounts_0_17 = process_file__next_value_of_STATE_VARIABLE_TotalCounts_0_17;
            }
            continue;
          }
      }
      ...
      /* tailcall optimized into a loop */
      {
        ...
        if ((process_file__MaybeLabelAddr_10 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
        ...
        else
          {
            ...
            else
              {
                ...
                if (process_file__succeeded)
                ...
                else
                  {
                    ...
                    MR_String process_file__Var_57;

                    {
                      mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) &process_file_scalar_common_1[0], process_file__LabelAddr_11, &process_file__Var_57);
                    }
                    {
                      process_file__Str_45 = mercury__string__f_43_43_2_f_0((MR_String) "unknown__", process_file__Var_57);
                    }
                    {
            ...
            /* direct tailcall eliminated */
            {
              MR_Word process_file__next_value_of_STATE_VARIABLE_AddrDecl_0_16 = process_file__STATE_VARIABLE_AddrDecl_26_26;
              MR_Word process_file__next_value_of_STATE_VARIABLE_ProfNodeMap_0_18 = process_file__STATE_VARIABLE_ProfNodeMap_28_28;

              process_file__STATE_VARIABLE_ProfNodeMap_0_18 = process_file__next_value_of_STATE_VARIABLE_ProfNodeMap_0_18;
              process_file__STATE_VARIABLE_AddrDecl_0_16 = process_file__next_value_of_STATE_VARIABLE_AddrDecl_0_16;
            }
            continue;
          }
      }
