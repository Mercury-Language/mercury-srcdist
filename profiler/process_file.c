  ...
  MR_Word * DynamicCallGraph_10)
{
  ...
  {
    MR_Word Error_71 = ((MR_Word) ((MR_hl_field(MR_mktag(1), DeclResult_69, (MR_Integer) 0))));
  ...
  {
    MR_Word DeclFileStream_70 = ((MR_Word) ((MR_hl_field(MR_mktag(0), DeclResult_69, (MR_Integer) 0))));
    MR_Word Var_76;
    MR_Word Var_77;
