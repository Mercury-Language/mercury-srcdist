...
#line 27 "process_file.c"
#line 542 "../library/io.int"
#include "string.mh"

#line 31 "process_file.c"
#line 29 "../library/bitmap.int2"
#include "bitmap.mh"

#line 35 "process_file.c"
#line 28 "../library/time.int2"
#include "time.mh"

#line 39 "process_file.c"
#line 31 "../library/array.int2"
#include "array.mh"

#line 43 "process_file.c"
#line 44 "process_file.c"
#include "process_file.mh"

#line 47 "process_file.c"
#line 48 "process_file.c"
#ifndef PROCESS_FILE_DECL_GUARD
#define PROCESS_FILE_DECL_GUARD

#line 52 "process_file.c"
#line 53 "process_file.c"

#endif
#line 56 "process_file.c"
...
#endif
MR_decl_label6(process_file__lookup_addr_6_0, 3,2,7,8,9,10)
MR_decl_label8(process_file__process_addr_8_0, 2,3,6,7,8,9,10,5)
MR_decl_label8(process_file__process_addr_8_0, 11,12,13,14,15,16,17,18)
MR_decl_label8(process_file__process_addr_2_6_0, 26,2,4,5,7,9,10,11)
MR_decl_label2(process_file__process_addr_2_6_0, 6,14)
MR_decl_label8(process_file__process_addr_decl_2_6_0, 38,2,4,5,6,7,9,8)
MR_decl_label8(process_file__process_addr_decl_2_6_0, 12,11,16,17,18,19,21,22)
MR_decl_label8(process_file__process_addr_pair_7_0, 2,3,4,7,8,9,6,10)
MR_decl_label4(process_file__process_addr_pair_7_0, 11,12,13,14)
MR_decl_label8(process_file__process_addr_pair_2_9_0, 52,2,4,5,6,8,7,12)
MR_decl_label8(process_file__process_addr_pair_2_9_0, 13,14,15,16,17,18,19,20)
MR_decl_label8(process_file__process_addr_pair_2_9_0, 21,23,24,22,26,28,30,31)
MR_decl_label2(process_file__process_addr_pair_2_9_0, 32,33)
MR_decl_label8(process_file__process_profiling_data_files_4_0, 2,3,4,5,6,7,8,9)
MR_decl_label8(process_file__process_profiling_data_files_4_0, 10,11,14,15,16,17,13,18)
MR_decl_label8(process_file__process_profiling_data_files_4_0, 19,20,21,22,12,24,25,26)
MR_decl_label8(process_file__process_profiling_data_files_4_0, 27,28,29,30,31,32,33,34)
MR_decl_label5(process_file__process_profiling_data_files_4_0, 35,36,37,38,39)
...
MR_BEGIN_MODULE(process_file_module0)
	...
	MR_init_label6(process_file__lookup_addr_6_0,3,2,7,8,9,10)
MR_BEGIN_CODE
...
MR_def_label(process_file__lookup_addr_6_0,2)
	...
	MR_r1 = (MR_Word) MR_string_const("unknown__%d", 11);
	}
...
MR_def_label(process_file__lookup_addr_6_0,9)
	...
	MR_np_call_localret_ent(svmap__det_insert_4_0,
		process_file__lookup_addr_6_0_i10);
MR_def_label(process_file__lookup_addr_6_0,10)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
...
MR_BEGIN_MODULE(process_file_module1)
	...
	MR_init_label8(process_file__process_addr_decl_2_6_0,38,2,4,5,6,7,9,8)
	MR_init_label8(process_file__process_addr_decl_2_6_0,12,11,16,17,18,19,21,22)
MR_BEGIN_CODE
...
MR_def_label(process_file__process_addr_decl_2_6_0,38)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(3) = MR_r1;
	MR_sv(4) = MR_r2;
...
MR_def_label(process_file__process_addr_decl_2_6_0,9)
	...
	MR_GOTO_LAB(process_file__process_addr_decl_2_6_0_i38);
...
MR_def_label(process_file__process_addr_decl_2_6_0,18)
	...
	MR_r5 = MR_sv(5);
	MR_np_call_localret_ent(svmap__det_insert_4_0,
		process_file__process_addr_decl_2_6_0_i19);
MR_def_label(process_file__process_addr_decl_2_6_0,19)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
...
MR_def_label(process_file__process_addr_decl_2_6_0,21)
	...
	MR_np_call_localret_ent(f_115_118_109_97_112_95_95_84_121_112_101_83_112_101_99_79_102_95_95_112_114_101_100_95_95_100_101_116_95_117_112_100_97_116_101_95_95_91_75_32_61_32_105_110_116_93_95_48_95_49_4_0,
		process_file__process_addr_decl_2_6_0_i22);
MR_def_label(process_file__process_addr_decl_2_6_0,22)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
...
MR_BEGIN_MODULE(process_file_module2)
	...
	MR_init_label8(process_file__process_addr_2_6_0,26,2,4,5,7,9,10,11)
	MR_init_label2(process_file__process_addr_2_6_0,6,14)
MR_BEGIN_CODE
...
MR_def_label(process_file__process_addr_2_6_0,26)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(4) = MR_r1;
	MR_sv(5) = MR_r2;
	MR_np_call_localret_ent(read__maybe_read_label_addr_3_0,
...
MR_def_label(process_file__process_addr_2_6_0,11)
	...
	MR_GOTO_LAB(process_file__process_addr_2_6_0_i26);
	}
...
MR_BEGIN_MODULE(process_file_module3)
	...
	MR_init_label8(process_file__process_addr_8_0,2,3,6,7,8,9,10,5)
	MR_init_label8(process_file__process_addr_8_0,11,12,13,14,15,16,17,18)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(process_file_module4)
	...
	MR_init_label8(process_file__process_addr_pair_2_9_0,52,2,4,5,6,8,7,12)
	MR_init_label8(process_file__process_addr_pair_2_9_0,13,14,15,16,17,18,19,20)
	MR_init_label8(process_file__process_addr_pair_2_9_0,21,23,24,22,26,28,30,31)
	MR_init_label2(process_file__process_addr_pair_2_9_0,32,33)
MR_BEGIN_CODE
...
MR_def_label(process_file__process_addr_pair_2_9_0,52)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(1) = MR_r1;
	MR_sv(8) = MR_r2;
	MR_sv(5) = MR_r3;
...
MR_def_label(process_file__process_addr_pair_2_9_0,8)
	...
	MR_r3 = MR_r4;
	MR_r2 = MR_sv(6);
	MR_GOTO_LAB(process_file__process_addr_pair_2_9_0_i16);
...
MR_def_label(process_file__process_addr_pair_2_9_0,14)
	...
	MR_np_call_localret_ent(svmap__det_insert_4_0,
		process_file__process_addr_pair_2_9_0_i15);
...
MR_def_label(process_file__process_addr_pair_2_9_0,20)
	...
	MR_np_call_localret_ent(f_115_118_109_97_112_95_95_84_121_112_101_83_112_101_99_79_102_95_95_112_114_101_100_95_95_115_101_116_95_95_91_75_32_61_32_105_110_116_93_95_48_95_49_4_0,
		process_file__process_addr_pair_2_9_0_i21);
MR_def_label(process_file__process_addr_pair_2_9_0,21)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if ((MR_sv(3) == MR_sv(2))) {
		MR_GOTO_LAB(process_file__process_addr_pair_2_9_0_i22);
	}
	MR_sv(2) = MR_r1;
	MR_r1 = MR_sv(6);
...
MR_def_label(process_file__process_addr_pair_2_9_0,23)
	...
	MR_np_call_localret_ent(prof_info__prof_node_set_total_calls_3_0,
		process_file__process_addr_pair_2_9_0_i24);
MR_def_label(process_file__process_addr_pair_2_9_0,24)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
	...
	MR_np_call_localret_ent(prof_info__prof_node_concat_to_parent_4_0,
		process_file__process_addr_pair_2_9_0_i26);
MR_def_label(process_file__process_addr_pair_2_9_0,22)
	...
	MR_np_call_localret_ent(prof_info__prof_node_set_self_calls_3_0,
		process_file__process_addr_pair_2_9_0_i26);
MR_def_label(process_file__process_addr_pair_2_9_0,26)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_sv(3);
	MR_r3 = MR_r1;
	MR_r4 = MR_sv(2);
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(prof_info, prof_node);
	MR_np_call_localret_ent(f_115_118_109_97_112_95_95_84_121_112_101_83_112_101_99_79_102_95_95_112_114_101_100_95_95_115_101_116_95_95_91_75_32_61_32_105_110_116_93_95_48_95_49_4_0,
		process_file__process_addr_pair_2_9_0_i28);
MR_def_label(process_file__process_addr_pair_2_9_0,28)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_sv(1),0)) {
		MR_GOTO_LAB(process_file__process_addr_pair_2_9_0_i30);
	}
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
	...
	MR_GOTO_LAB(process_file__process_addr_pair_2_9_0_i52);
	}
...
MR_def_label(process_file__process_addr_pair_2_9_0,32)
	...
	MR_np_call_localret_ent(digraph__add_edge_4_0,
		process_file__process_addr_pair_2_9_0_i33);
MR_def_label(process_file__process_addr_pair_2_9_0,33)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
...
MR_BEGIN_MODULE(process_file_module5)
	...
	MR_init_label8(process_file__process_addr_pair_7_0,2,3,4,7,8,9,6,10)
	MR_init_label4(process_file__process_addr_pair_7_0,11,12,13,14)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(process_file_module6)
	...
	MR_init_label8(process_file__process_profiling_data_files_4_0,2,3,4,5,6,7,8,9)
	MR_init_label8(process_file__process_profiling_data_files_4_0,10,11,14,15,16,17,13,18)
	MR_init_label8(process_file__process_profiling_data_files_4_0,19,20,21,22,12,24,25,26)
	MR_init_label8(process_file__process_profiling_data_files_4_0,27,28,29,30,31,32,33,34)
	MR_init_label5(process_file__process_profiling_data_files_4_0,35,36,37,38,39)
MR_BEGIN_CODE
