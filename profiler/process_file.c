...
MR_def_label(process_file__process_addr_2_6_0,11)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_r1;
	MR_r1 = ((MR_Integer) MR_sv(3) + (MR_Integer) MR_sv(1));
	MR_succip_word = MR_sv(6);
	MR_GOTO_LAB(process_file__process_addr_2_6_0_i27);
MR_def_label(process_file__process_addr_2_6_0,6)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_sv(5);
	MR_sv(5) = (MR_Word) MR_string_const(" not found!  Ignoring address and continuing computation.\n", 58);
	MR_r1 = MR_r2;
	MR_np_call_localret_ent(fn__string__int_to_string_1_0,
...
MR_def_label(process_file__process_addr_8_0,10)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_sv(2);
	MR_r3 = MR_float_to_word(MR_float_from_dword_ptr(&MR_sv(5)));
	MR_r4 = MR_sv(6);
	MR_r5 = MR_sv(1);
	MR_r1 = MR_sv(7);
...
MR_def_label(process_file__process_addr_pair_2_9_0,22)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = ((MR_Integer) MR_r1 + (MR_Integer) MR_sv(10));
	MR_r2 = MR_sv(5);
...
MR_def_label(process_file__process_profiling_data_files_4_0,28)
	...
	MR_sv(9) = MR_r1;
	MR_sv(3) = MR_r2;
	* (MR_Float *) &MR_sv(5) = MR_word_to_float(MR_r3);
	MR_sv(6) = MR_r4;
	MR_sv(7) = MR_r5;
	MR_r1 = MR_sv(8);
	MR_r2 = (MR_Word) MR_string_const(" done.\n", 7);
