        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              ...
              {
                MR_String Type_19;
                MR_Word Var_28 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Options_6, (MR_Integer) 0))) & (MR_Integer) 1);
                MR_String Var_33;
                MR_Integer Var_35;
                MR_String Var_66;
                MR_String Var_67;
                ...
                if (succeeded)
                {
                  ...
                  Var_33 = (MR_String) "unknown";
                  Var_35 = (MR_Integer) 0;
                  RecalcSize_18 = (MR_Integer) 0;
                  {
                    AllocSite_17 = (MR_Word) MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL);
                    MR_hl_field(MR_mktag(0), AllocSite_17, 0) = ((MR_Box) (Var_33));
                    MR_hl_field(MR_mktag(0), AllocSite_17, 1) = ((MR_Box) (Type_19));
                    MR_hl_field(MR_mktag(0), AllocSite_17, 2) = ((MR_Box) (Var_33));
                    MR_hl_field(MR_mktag(0), AllocSite_17, 3) = ((MR_Box) (Var_35));
      ...
      case (MR_Integer) 1:
        {
          ...
          if (succeeded)
          {
            ...
            mercury__map__det_insert_4_p_0((MR_Word) (&snapshots__snapshots__type_ctor_info_alloc_id_0), (MR_Word) (&snapshots__snapshots__type_ctor_info_alloc_site_0), ((MR_Box) (Var_46)), ((MR_Box) (AllocSite_38)), STATE_VARIABLE_AllocSiteMap_0_12, &STATE_VARIABLE_AllocSiteMap_17_17);
          }
          else
            {
