                      ...
                      if (succeeded)
                      {
                        ...
                        if (succeeded)
                        {
                          ...
                          if (succeeded)
                          {
                            ...
                            if (succeeded)
                            {
                              TypeCtorInfo_55_71 = (MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0);
                              succeeded = mercury__list__index1_3_p_0(TypeCtorInfo_55_71, SizeMap_11, WordsPerCell_36, &conv1_SizeMapWords_37);
                              if (succeeded)
                              {
