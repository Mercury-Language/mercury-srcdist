...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(0), Options_10, 0) = (MR_Box) (((((MR_Unsigned) (MajorAxis_9) << (MR_Integer) 3)) | (((((MR_Unsigned) (Brief_6) << (MR_Integer) 2)) | (((((MR_Unsigned) (RecalcSize_7) << (MR_Integer) 1)) | (MR_Unsigned) (InclRuntime_8)))))));
    }
