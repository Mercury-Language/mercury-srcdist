  ...
  MR_Word Options_6)
{
  ...
  mercury__string__format__format_string_component_width_noprec_4_p_0((MR_Word) (&snapshots_scalar_common_3[0]), (MR_Integer) 7, (MR_String) "cells", &Var_32);
  mercury__io__write_string_4_p_0(OutputStream_5, Var_32);
  mercury__string__format__format_string_component_width_noprec_4_p_0((MR_Word) (&snapshots_scalar_common_3[0]), (MR_Integer) 17, (MR_String) "words", &Var_41);
  mercury__io__write_string_4_p_0(OutputStream_5, Var_41);
  mercury__string__format__format_string_component_width_noprec_4_p_0((MR_Word) (&snapshots_scalar_common_3[0]), (MR_Integer) 14, (MR_String) "cumul", &Var_50);
  ...
  MR_Word * Groups_6)
{
  ...
  else
  {
    ...
    snapshots__LCMC__pred__make_groups__1_3_p_0(Compare_4, Rest_10, AddrRestGroups_38);
  }
}
      ...
      case (MR_Integer) 1:
        {
          ...
          else
          {
            ...
            if (succeeded)
            {
              ...
              snapshots__LCMC__pred__read_and_parse_snapshot__1_7_p_0(InputStream_8, Options_9, AllocSiteMap_10, SizeMap_11, AddrRestCounts_29);
            }
            else
            {
              // direct tailcall eliminated
            ...
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                ...
                if (succeeded)
                  ...
                  AllocSite_17 = (MR_Word) (&snapshots_scalar_common_4[0]);
              ...
              if ((strcmp(IdStr_11, (MR_String) "runtime") == 0))
              {
                ...
                if (succeeded)
                {
                  ...
                  Var_73 = (MR_Word) (&snapshots_scalar_common_3[0]);
              ...
              if ((strcmp(IdStr_11, (MR_String) "unknown") == 0))
              {
                ...
                mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&snapshots_scalar_common_3[0]), NumWords0_15, &Var_57);
