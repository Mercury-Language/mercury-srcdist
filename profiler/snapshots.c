  ...
  MR_Integer * STATE_VARIABLE_CumulWords_31)
{
  ...
  *STATE_VARIABLE_CumulWords_31 = (MR_Integer) ((MR_Unsigned) STATE_VARIABLE_CumulWords_0_30 + (MR_Unsigned) NumWords_18);
  ...
  if (!(succeeded))
  {
    ...
    MR_String RightLabel_26;
    MR_Char Star_27;
    MR_String Var_79 = ((MR_String) ((MR_hl_field(MR_mktag(0), AllocSite_19, (MR_Integer) 1))));
    MR_String Var_80 = ((MR_String) ((MR_hl_field(MR_mktag(0), AllocSite_19, (MR_Integer) 0))));
    MR_String Var_82;
    MR_String Var_90;
    MR_String Var_101;
    MR_String Var_114;
  ...
  MR_Word Grouped_8)
{
  ...
  MR_String Var_64;
  MR_String Var_73;
  MR_Word MajorAxis_85 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Options_7, (MR_Integer) 0))) >> 3)) & (MR_Integer) 1);
      ...
      case (MR_Integer) 1:
        {
          ...
          if (succeeded)
          {
            ...
            Var_26 = mercury__string__words_1_f_0(Line_11);
            succeeded = (Var_26 != (MR_Word) ((MR_Unsigned) 0U));
            if (succeeded)
            {
              Var_27 = ((MR_String) ((MR_hl_field(MR_mktag(1), Var_26, (MR_Integer) 0))));
              Words_24 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Var_26, (MR_Integer) 1))));
              succeeded = (strcmp(Var_27, (MR_String) "size_map") == 0);
              if (succeeded)
              {
                Var_28 = (MR_Word) (&snapshots_scalar_common_1[1]);
                TypeCtorInfo_14_31 = (MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0);
                TypeCtorInfo_15_32 = (MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0);
                succeeded = mercury__list__map_3_p_2(TypeCtorInfo_14_31, TypeCtorInfo_15_32, Var_28, Words_24, &Ints_25);
              }
            }
            if (succeeded)
              *SizeMap_8 = Ints_25;
