      ...
      case (MR_Integer) 1:
        {
          ...
          if (succeeded)
          {
            ...
            MR_Word AllocCounts_45;
            MR_Word MajorAxis_46;
            MR_Word Groups_47;
            MR_Word Compare_55;
            ...
            mercury__io__write_string_4_p_0(OutputStream_9, (MR_String) " ------\n");
            snapshots__read_and_parse_snapshot_7_p_0(InputStream_8, Options_10, AllocSiteMap_11, SizeMap_12, &AllocCounts_45);
            MajorAxis_46 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Options_10, (MR_Integer) 0))) >> 3)) & (MR_Integer) 1);
            switch (MajorAxis_46) {
              default: /*NOTREACHED*/ MR_assert(0);
              case (MR_Integer) 0:
            ...
            mercury__list__sort_3_p_0((MR_Word) (&snapshots__snapshots__type_ctor_info_alloc_site_counts_0), Compare_55, AllocCounts_45, &SortedCounts_56);
            snapshots__make_groups_3_p_0(Compare_55, SortedCounts_56, &Groups_57);
            mercury__list__sort_3_p_0((MR_Word) (&snapshots__snapshots__type_ctor_info_group_0), (MR_Word) (&snapshots_scalar_common_1[9]), Groups_57, &Groups_47);
            snapshots__output_snapshot_5_p_0(OutputStream_9, Options_10, Groups_47);
