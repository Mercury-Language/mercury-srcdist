...
struct var_value_names__vector_common_type_1_0_s {
...
struct var_value_names__vector_common_type_2_0_s {
...
struct var_value_names__vector_common_type_3_0_s {
...

  {
    ...
    switch (MR_nth_code_unit(HeadVar__1_1, 0)) {
      ...
      case (MR_Integer) 102:
        ...
        break;
      case (MR_Integer) 103:
        if (MR_offset_strn_eq(1, 3, HeadVar__1_1, (MR_String) "gcc_"))
          switch (MR_nth_code_unit(HeadVar__1_1, 4)) {
            case (MR_Integer) 103:
              if (MR_offset_strn_eq(5, 5, HeadVar__1_1, (MR_String) "gcc_gotos_"))
              ...
              break;
            case (MR_Integer) 108:
              if (MR_offset_strn_eq(5, 6, HeadVar__1_1, (MR_String) "gcc_labels_"))
              ...
              break;
            case (MR_Integer) 114:
              if (MR_offset_strn_eq(5, 4, HeadVar__1_1, (MR_String) "gcc_regs_"))
      ...
      case (MR_Integer) 108:
        switch (MR_nth_code_unit(HeadVar__1_1, 1)) {
          case (MR_Integer) 108:
            ...
            break;
          case (MR_Integer) 111:
            if (MR_offset_strn_eq(2, 11, HeadVar__1_1, (MR_String) "low_tag_bits_"))
              switch (MR_nth_code_unit(HeadVar__1_1, 13)) {
                case (MR_Integer) 97:
                  if (MR_offset_strn_eq(14, 5, HeadVar__1_1, (MR_String) "low_tag_bits_avail_"))
                  ...
                  break;
                case (MR_Integer) 117:
                  if (MR_offset_strn_eq(14, 3, HeadVar__1_1, (MR_String) "low_tag_bits_use_"))
          ...
          case (MR_Integer) 109:
            switch (MR_nth_code_unit(HeadVar__1_1, 2)) {
              case (MR_Integer) 95:
                switch (MR_nth_code_unit(HeadVar__1_1, 3)) {
                  case (MR_Integer) 111:
                    if (MR_offset_strn_eq(4, 8, HeadVar__1_1, (MR_String) "mm_own_stack"))
                    ...
                    break;
                  case (MR_Integer) 115:
                    if (MR_offset_strn_eq(4, 9, HeadVar__1_1, (MR_String) "mm_stack_copy"))
                      switch (MR_nth_code_unit(HeadVar__1_1, 13)) {
                        case (MR_Integer) 0:
            ...
            break;
          case (MR_Integer) 112:
            if (MR_offset_strn_eq(2, 4, HeadVar__1_1, (MR_String) "mprof_"))
              ...
              case (MR_Integer) 95:
                switch (MR_nth_code_unit(HeadVar__1_1, 3)) {
                  ...
                  case (MR_Integer) 109:
                    switch (MR_nth_code_unit(HeadVar__1_1, 4)) {
                      ...
                      case (MR_Integer) 109:
                        ...
                        break;
                      case (MR_Integer) 112:
                        if (MR_offset_strn_eq(5, 4, HeadVar__1_1, (MR_String) "no_mprof_"))
                          switch (MR_nth_code_unit(HeadVar__1_1, 9)) {
                            case (MR_Integer) 99:
                  ...
                  case (MR_Integer) 112:
                    ...
                    break;
                  case (MR_Integer) 114:
                    if (MR_offset_strn_eq(4, 3, HeadVar__1_1, (MR_String) "no_rbmm"))
      ...
      case (MR_Integer) 115:
        switch (MR_nth_code_unit(HeadVar__1_1, 1)) {
          case (MR_Integer) 105:
            if (MR_offset_strn_eq(2, 13, HeadVar__1_1, (MR_String) "size_of_double_"))
      ...
      case (MR_Integer) 116:
        switch (MR_nth_code_unit(HeadVar__1_1, 1)) {
          case (MR_Integer) 97:
            if (MR_offset_strn_eq(2, 5, HeadVar__1_1, (MR_String) "target_"))
              switch (MR_nth_code_unit(HeadVar__1_1, 7)) {
                case (MR_Integer) 100:
            ...
            break;
          case (MR_Integer) 101:
            if (MR_offset_strn_eq(2, 13, HeadVar__1_1, (MR_String) "term_size_prof_"))
              switch (MR_nth_code_unit(HeadVar__1_1, 15)) {
                case (MR_Integer) 99:
        ...
        break;
      case (MR_Integer) 117:
        if (MR_offset_strn_eq(1, 7, HeadVar__1_1, (MR_String) "unboxed_"))
          switch (MR_nth_code_unit(HeadVar__1_1, 8)) {
            case (MR_Integer) 100:
...

  {
    ...
    switch (MR_nth_code_unit(HeadVar__1_1, 0)) {
      ...
      case (MR_Integer) 103:
        ...
        break;
      case (MR_Integer) 108:
        if (MR_offset_strn_eq(1, 12, HeadVar__1_1, (MR_String) "low_tag_bits_"))
          switch (MR_nth_code_unit(HeadVar__1_1, 13)) {
            case (MR_Integer) 97:
      ...
      case (MR_Integer) 109:
        switch (MR_nth_code_unit(HeadVar__1_1, 1)) {
          case (MR_Integer) 101:
            if (MR_offset_strn_eq(2, 2, HeadVar__1_1, (MR_String) "merc"))
              switch (MR_nth_code_unit(HeadVar__1_1, 4)) {
                case (MR_Integer) 95:
      ...
      case (MR_Integer) 112:
        ...
        break;
      case (MR_Integer) 114:
        if (MR_offset_strn_eq(1, 3, HeadVar__1_1, (MR_String) "rbmm"))
          switch (MR_nth_code_unit(HeadVar__1_1, 4)) {
            case (MR_Integer) 0:
              case_num_0 = (MR_Integer) 17;
              break;
      ...
      case (MR_Integer) 116:
        switch (MR_nth_code_unit(HeadVar__1_1, 1)) {
          case (MR_Integer) 97:
            if (MR_offset_strn_eq(2, 4, HeadVar__1_1, (MR_String) "target"))
              switch (MR_nth_code_unit(HeadVar__1_1, 6)) {
                case (MR_Integer) 0:
                  case_num_0 = (MR_Integer) 24;
                  break;
