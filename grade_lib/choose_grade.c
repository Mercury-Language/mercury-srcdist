...
main_2_p_0(void)
{
  ...
  if ((BadArgLines_10 == (MR_Word) ((MR_Unsigned) 0U)))
  {
    ...
    Var_42 = grade_lib__grade_solver__soln_to_str_2_f_0((MR_String) "", Soln_16);
    mercury__io__write_string_3_p_0(Var_42);
    if (!(((MR_tag((MR_Word) Soln_16)) == (MR_Integer) 0)))
    {
      MR_Word SuccMap_18 = ((MR_Word) ((MR_hl_field(1, Soln_16, (MR_Integer) 0))));
  ...
  MR_Word * STATE_VARIABLE_SolverInfo_5)
{
  while (MR_TRUE)
  {
    ...
    {
      MR_String Arg_12 = ((MR_String) ((MR_hl_field(1, HeadVar__1_1, (MR_Integer) 0))));
      ...
      if (succeeded)
      {
        VarNamePrime_20 = ((MR_String) ((MR_hl_field(1, NeqComponents_19, (MR_Integer) 0))));
        Var_43 = ((MR_Word) ((MR_hl_field(1, NeqComponents_19, (MR_Integer) 1))));
        succeeded = (Var_43 != (MR_Word) ((MR_Unsigned) 0U));
        if (succeeded)
        {
          ValueNamePrime_21 = ((MR_String) ((MR_hl_field(1, Var_43, (MR_Integer) 0))));
      ...
      else
      {
        ...
        if (succeeded)
        {
          VarName_23 = ((MR_String) ((MR_hl_field(1, EqComponents_25, (MR_Integer) 0))));
          Var_46 = ((MR_Word) ((MR_hl_field(1, EqComponents_25, (MR_Integer) 1))));
          succeeded = (Var_46 != (MR_Word) ((MR_Unsigned) 0U));
          if (succeeded)
          {
            ValueName_24 = ((MR_String) ((MR_hl_field(1, Var_46, (MR_Integer) 0))));
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          VarId_32 = ((MR_Word) ((MR_hl_field(1, MaybeVarId_27, (MR_Integer) 0))));
          succeeded = (MaybeValueId_30 != (MR_Word) ((MR_Unsigned) 0U));
          if (succeeded)
            ValueId_33 = ((MR_Word) ((MR_hl_field(1, MaybeValueId_30, (MR_Integer) 0))));
        }
        if (succeeded)
        {
          ...
          {
            MR_String Msg_36 = ((MR_String) ((MR_hl_field(1, MaybeError_34, (MR_Integer) 0))));
