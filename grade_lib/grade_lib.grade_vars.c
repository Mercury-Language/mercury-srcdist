...
static const MR_EnumFunctorDescPtr grade_lib__grade_vars__grade_lib__grade_vars__enum_ordinal_ordered_grade_var_trail_segments_0[2];
...
const MR_TypeCtorInfo_Struct grade_lib__grade_vars__grade_lib__grade_vars__type_ctor_info_grade_var_trail_segments_0 = {
  ...
  {     grade_lib__grade_vars__grade_lib__grade_vars__enum_ordinal_ordered_grade_var_trail_segments_0 },
  (MR_Integer) 2,
  UINT16_C(12),
