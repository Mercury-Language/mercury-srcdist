    ...
    case (MR_Integer) 0:
      {
        ...
        switch (WhichGradeString_4) {
          ...
          case (MR_Integer) 1:
            {
              MR_Word GradeComponents_247;

              {
                GradeComponents_247 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(1), GradeComponents_247, 0) = ((MR_Box) (BaseStr_8));
                MR_hl_field(MR_mktag(1), GradeComponents_247, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &grade_lib__grade_string_scalar_common_2[16])));
              }
              GradeStr_6 = mercury__string__join_list_2_f_0((MR_String) "_", GradeComponents_247);
            }
            break;
          case (MR_Integer) 0:
            {
...

              {
                ...
                MR_hl_field(MR_mktag(1), GradeComponents_250, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &grade_lib__grade_string_scalar_common_2[15])));
              }
              GradeStr_6 = mercury__string__join_list_2_f_0((MR_String) ".", GradeComponents_250);
            }
            break;
        }
      }
          ...
          case (MR_Integer) 0:
            {
              ...
              GradeComponents_240 = mercury__list__f_43_43_2_f_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), BinaryCompatStrs_158, Var_63);
            }
            break;
          case (MR_Integer) 1:
            {
              ...
              GradeComponents_240 = mercury__list__f_43_43_2_f_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), Var_55, TargetDebugStrs_207);
            }
            break;
          case (MR_Integer) 2:
            {
              ...
              GradeComponents_240 = mercury__list__f_43_43_2_f_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), Var_53, TargetDebugStrs_207);
            }
            break;
        }
        switch (WhichGradeString_4) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 1:
            GradeStr_6 = mercury__string__join_list_2_f_0((MR_String) "_", GradeComponents_240);
            break;
          case (MR_Integer) 0:
