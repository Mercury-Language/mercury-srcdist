    ...
    case (MR_Integer) 0:
      {
        ...
        switch (WhichGradeString_4) {
          ...
          case (MR_Integer) 1:
            {
              MR_Word GradeComponents_213;

              {
                GradeComponents_213 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(1, GradeComponents_213, 0) = ((MR_Box) (BaseStr_8));
                MR_hl_field(1, GradeComponents_213, 1) = ((MR_Box) (MR_mkword(1, &grade_lib__grade_string_scalar_common_2[16])));
              }
              GradeStr_6 = mercury__string__join_list_2_f_0((MR_String) "_", GradeComponents_213);
            }
            break;
          case (MR_Integer) 0:
            {
              ...
              {
                GradeComponents_216 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(1, GradeComponents_216, 0) = ((MR_Box) (BaseStr_8));
                MR_hl_field(1, GradeComponents_216, 1) = ((MR_Box) (MR_mkword(1, &grade_lib__grade_string_scalar_common_2[15])));
              }
          ...
          case (MR_Integer) 2:
            {
              ...
              ThreadSafeStrs_23 = grade_lib__grade_string__thread_safe_to_strs_2_f_0(Var_87, (MR_Integer) 1);
              MinimalModelStrs_24 = (MR_Word) ((MR_Unsigned) 0U);
          ...
          case (MR_Integer) 0:
            {
              ...
              if (((MR_tag((MR_Word) MLDSCThreadSafe_48)) == (MR_Integer) 0))
              {
                ...
                ThreadSafeStrs_160 = grade_lib__grade_string__thread_safe_to_strs_2_f_0((MR_Word) ((MR_Unsigned) 0U), (MR_Integer) 0);
              ...
              GradeComponents_206 = mercury__list__f_43_43_2_f_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), BinaryCompatStrs_157, Var_116);
            }
            break;
          case (MR_Integer) 1:
            {
              ...
              GradeComponents_206 = mercury__list__f_43_43_2_f_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), Var_127, TargetDebugStrs_47);
            }
            break;
          case (MR_Integer) 2:
            {
              ...
              GradeComponents_206 = mercury__list__f_43_43_2_f_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), Var_129, TargetDebugStrs_47);
            }
            break;
        }
        switch (WhichGradeString_4) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 1:
            GradeStr_6 = mercury__string__join_list_2_f_0((MR_String) "_", GradeComponents_206);
            break;
          case (MR_Integer) 0:
            GradeStr_6 = mercury__string__join_list_2_f_0((MR_String) ".", GradeComponents_206);
            break;
        }
      }
      break;
