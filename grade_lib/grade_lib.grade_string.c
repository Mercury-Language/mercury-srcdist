    ...
    case (MR_Integer) 0:
      {
        ...
        switch (WhichGradeString_4) {
          ...
          case (MR_Integer) 0:
            {
              MR_Word GradeComponents_230;

              {
                GradeComponents_230 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(1, GradeComponents_230, 0) = ((MR_Box) (BaseStr_8));
                MR_hl_field(1, GradeComponents_230, 1) = ((MR_Box) (MR_mkword(1, &grade_lib__grade_string_scalar_common_2[15])));
              }
              GradeStr_6 = mercury__string__join_list_2_f_0((MR_String) ".", GradeComponents_230);
            }
            break;
        }
      }
