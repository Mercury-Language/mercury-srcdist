...

  {
    ...
    switch (MR_nth_code_unit(ComponentStr_4, 0)) {
      ...
      case (MR_Integer) 100:
        ...
        break;
      case (MR_Integer) 101:
        if (MR_offset_streq(1, ComponentStr_4, (MR_String) "exts"))
      ...
      case (MR_Integer) 116:
        switch (MR_nth_code_unit(ComponentStr_4, 1)) {
          case (MR_Integer) 104:
            ...
            break;
          case (MR_Integer) 114:
            if (MR_offset_streq(2, ComponentStr_4, (MR_String) "tr"))
    ...
    case (MR_Integer) 0:
      {
        ...
        switch (WhichGradeString_4) {
          ...
          case (MR_Integer) 1:
            {
              MR_Word GradeComponents_226;

              {
                GradeComponents_226 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(1), GradeComponents_226, 0) = ((MR_Box) (BaseStr_8));
                MR_hl_field(MR_mktag(1), GradeComponents_226, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &grade_lib__grade_string_scalar_common_2[16])));
              }
              GradeStr_6 = mercury__string__join_list_2_f_0((MR_String) "_", GradeComponents_226);
            }
            break;
          case (MR_Integer) 0:
            {
              MR_Word GradeComponents_229;

              {
                GradeComponents_229 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(1), GradeComponents_229, 0) = ((MR_Box) (BaseStr_8));
                MR_hl_field(MR_mktag(1), GradeComponents_229, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &grade_lib__grade_string_scalar_common_2[15])));
              }
              GradeStr_6 = mercury__string__join_list_2_f_0((MR_String) ".", GradeComponents_229);
            }
            break;
        }
      }
          ...
          case (MR_Integer) 1:
            {
              ...
              GcStrs_27 = grade_lib__grade_string__gc_to_strs_1_f_0(Gc_135);
          ...
          case (MR_Integer) 0:
            {
              ...
              GradeComponents_219 = mercury__list__f_43_43_2_f_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), BinaryCompatStrs_158, Var_63);
            }
            break;
          case (MR_Integer) 1:
            {
              ...
              GradeComponents_219 = mercury__list__f_43_43_2_f_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), Var_55, TargetDebugStrs_207);
            }
            break;
          case (MR_Integer) 2:
            {
              ...
              GradeComponents_219 = mercury__list__f_43_43_2_f_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), Var_53, TargetDebugStrs_207);
            }
            break;
        }
        switch (WhichGradeString_4) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 1:
            GradeStr_6 = mercury__string__join_list_2_f_0((MR_String) "_", GradeComponents_219);
            break;
          case (MR_Integer) 0:
            GradeStr_6 = mercury__string__join_list_2_f_0((MR_String) ".", GradeComponents_219);
            break;
        }
      }
      break;
