...
static /* final */ const struct grade_lib__grade_string__vector_common_type_5_0_s grade_lib__grade_string_vector_common_5[40];
            ...
            case (MR_Integer) 1:
              {
                ...
                {
                  GradeComponents_240 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                  MR_hl_field(MR_mktag(1), GradeComponents_240, 0) = ((MR_Box) (BaseStr_8));
                  MR_hl_field(MR_mktag(1), GradeComponents_240, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &grade_lib__grade_string_scalar_common_2[2])));
                }
            ...
            case (MR_Integer) 0:
              {
                ...
                {
                  GradeComponents_243 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                  MR_hl_field(MR_mktag(1), GradeComponents_243, 0) = ((MR_Box) (BaseStr_8));
                  MR_hl_field(MR_mktag(1), GradeComponents_243, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &grade_lib__grade_string_scalar_common_2[1])));
                }
      ...
      case (MR_Integer) 1:
        {
            ...
            case (MR_Integer) 0:
              {
                ...
                switch (TermSizeProf_21) {
                  default: /*NOTREACHED*/ MR_assert(0);
                  case (MR_Integer) 1:
                    TermSizeProfStrs_32 = (MR_Word) (MR_mkword(MR_mktag(1), &grade_lib__grade_string_scalar_common_2[78]));
                    break;
                  case (MR_Integer) 0:
            ...
            case (MR_Integer) 1:
              {
                ...
                switch (MinModelKind_38) {
                  ...
                  case (MR_Integer) 3:
                    ...
                    break;
                  case (MR_Integer) 0:
                    MinimalModelStrs_25 = (MR_Word) (MR_mkword(MR_mktag(1), &grade_lib__grade_string_scalar_common_2[86]));
                    break;
                  case (MR_Integer) 1:
                    MinimalModelStrs_25 = (MR_Word) (MR_mkword(MR_mktag(1), &grade_lib__grade_string_scalar_common_2[87]));
                    break;
                }
                switch (LLDSMMGc_39) {
                  default: /*NOTREACHED*/ MR_assert(0);
            ...
            case (MR_Integer) 2:
              {
                ...
                switch (TScopeProf_41) {
                  ...
                  case (MR_Integer) 0:
                    ...
                    break;
                  case (MR_Integer) 1:
                    TScopeProfStrs_37 = (MR_Word) (MR_mkword(MR_mktag(1), &grade_lib__grade_string_scalar_common_2[88]));
                    break;
                }
              }
              break;
          ...
          switch (StackLen_11) {
            default: /*NOTREACHED*/ MR_assert(0);
            case (MR_Integer) 2:
              StackLenStrs_42 = (MR_Word) (MR_mkword(MR_mktag(1), &grade_lib__grade_string_scalar_common_2[89]));
              break;
            case (MR_Integer) 1:
          ...
          GradeComponents_226 = mercury__list__f_43_43_2_f_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), BinaryCompatStrs_17, Var_110);
          switch (WhichGradeString_4) {
            default: /*NOTREACHED*/ MR_assert(0);
            case (MR_Integer) 1:
            ...
            case (MR_Integer) 0:
              {
                ...
                Var_65 = mercury__list__f_43_43_2_f_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (MR_mkword(MR_mktag(1), &grade_lib__grade_string_scalar_common_2[91])), Var_68);
                GradeComponents_233 = mercury__list__f_43_43_2_f_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), BinaryCompatStrs_160, Var_65);
              }
              break;
            case (MR_Integer) 1:
              {
                ...
                GradeComponents_233 = mercury__list__f_43_43_2_f_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), Var_57, TargetDebugStrs_209);
              }
              break;
            case (MR_Integer) 2:
              {
                ...
                GradeComponents_233 = mercury__list__f_43_43_2_f_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), Var_55, TargetDebugStrs_209);
              }
              break;
          }
          switch (WhichGradeString_4) {
            default: /*NOTREACHED*/ MR_assert(0);
            case (MR_Integer) 1:
              GradeStr_6 = mercury__string__join_list_2_f_0((MR_String) "_", GradeComponents_233);
              break;
            case (MR_Integer) 0:
              GradeStr_6 = mercury__string__join_list_2_f_0((MR_String) ".", GradeComponents_233);
              break;
          }
        }
        break;
...
{
  {
    ...
    switch (HeadVar__1_1) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 1:
        HeadVar__2_2 = (MR_Word) (MR_mkword(MR_mktag(1), &grade_lib__grade_string_scalar_common_2[77]));
        break;
      case (MR_Integer) 0:
      ...
      case (MR_Integer) 1:
        switch (HeadVar__2_2) {
          ...
          case (MR_Integer) 0:
            ...
            break;
          case (MR_Integer) 1:
            HeadVar__3_3 = (MR_Word) (MR_mkword(MR_mktag(1), &grade_lib__grade_string_scalar_common_2[71]));
            break;
        }
        break;
      case (MR_Integer) 0:
...
{
  {
    ...
    switch (HeadVar__1_1) {
      ...
      case (MR_Integer) 0:
        ...
        break;
      case (MR_Integer) 1:
        HeadVar__2_2 = (MR_Word) (MR_mkword(MR_mktag(1), &grade_lib__grade_string_scalar_common_2[70]));
        break;
    }
    return HeadVar__2_2;
  }
