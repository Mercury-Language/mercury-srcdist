...
static /* final */ const struct grade_lib__grade_string__vector_common_type_5_0_s grade_lib__grade_string_vector_common_5[4] = {
  /* row 0 */   {     (MR_Word) (MR_mkword(MR_mktag(1), &grade_lib__grade_string_scalar_common_2[86])) },
  /* row 1 */   {     (MR_Word) (MR_mkword(MR_mktag(1), &grade_lib__grade_string_scalar_common_2[87])) },
  /* row 2 */   {     (MR_Word) (MR_mkword(MR_mktag(1), &grade_lib__grade_string_scalar_common_2[84])) },
  /* row 3 */   {     (MR_Word) (MR_mkword(MR_mktag(1), &grade_lib__grade_string_scalar_common_2[85])) },
};
