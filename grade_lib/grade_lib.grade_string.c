    ...
    case (MR_Integer) 0:
      {
        ...
        switch (WhichGradeString_4) {
          ...
          case (MR_Integer) 1:
            {
              GradeComponents_9 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(1, GradeComponents_9, 0) = ((MR_Box) (BaseStr_8));
              MR_hl_field(1, GradeComponents_9, 1) = ((MR_Box) (MR_mkword(1, &grade_lib__grade_string_scalar_common_2[16])));
            }
            break;
          case (MR_Integer) 0:
            {
              GradeComponents_9 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(1, GradeComponents_9, 0) = ((MR_Box) (BaseStr_8));
              MR_hl_field(1, GradeComponents_9, 1) = ((MR_Box) (MR_mkword(1, &grade_lib__grade_string_scalar_common_2[15])));
            }
            break;
        }
      }
                    ...
                    case (MR_Integer) 1:
                      {
                        ...
                        Var_61 = mercury__string__f_43_43_2_f_0((MR_String) "profdeep", Var_63);
                        {
                          ...
                          MR_hl_field(1, LLDSPerfProfStrs_28, 1) = ((MR_Box) ((MR_Unsigned) 0U));
                        }
                      }
                      break;
                  }
          ...
          case (MR_Integer) 0:
            {
              ...
              GradeComponents_9 = mercury__list__f_43_43_2_f_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), BinaryCompatStrs_157, Var_116);
            }
            break;
          case (MR_Integer) 1:
            {
              ...
              GradeComponents_9 = mercury__list__f_43_43_2_f_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), Var_127, TargetDebugStrs_47);
            }
            break;
          case (MR_Integer) 2:
            {
              ...
              GradeComponents_9 = mercury__list__f_43_43_2_f_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), Var_129, TargetDebugStrs_47);
            }
            break;
        }
      }
