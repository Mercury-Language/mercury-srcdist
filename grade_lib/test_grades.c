  ...
  MR_Word * STATE_VARIABLE_RelSolveCountStats_10)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      {
        MR_Word TestSetSpecHead_57 = ((MR_Word) ((MR_hl_field(MR_mktag(1), HeadVar__5_5, (MR_Integer) 0))));
        MR_Word TestSetSpecTail_58 = ((MR_Word) ((MR_hl_field(MR_mktag(1), HeadVar__5_5, (MR_Integer) 1))));
        MR_Word VarId_59 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), TestSetSpecHead_57, (MR_Integer) 0))) & (MR_Integer) 31);
        MR_Word ValueIds_60 = ((MR_Word) ((MR_hl_field(MR_mktag(0), TestSetSpecHead_57, (MR_Integer) 1))));
  ...
  MR_Word * STATE_VARIABLE_RelSolveCountStats_34)
{
  ...
  TotalNumLabelSteps0_117 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_AbsSolveCountStats_0_31, (MR_Integer) 0))));
  TotalNumPasses0_118 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_AbsSolveCountStats_0_31, (MR_Integer) 1))));
  TotalNumReqTests0_119 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_AbsSolveCountStats_0_31, (MR_Integer) 2))));
  NumTests0_120 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_AbsSolveCountStats_0_31, (MR_Integer) 3))));
  ...
  NumTests_21 = (MR_Integer) ((MR_Unsigned) NumTests0_120 + (MR_Unsigned) 1);
  {
    ...
    *STATE_VARIABLE_AbsSolveCountStats_32 = base;
    MR_hl_field(MR_mktag(0), base, 0) = ((MR_Box) (TotalNumLabelSteps_124));
    MR_hl_field(MR_mktag(0), base, 1) = ((MR_Box) (TotalNumPasses_125));
    MR_hl_field(MR_mktag(0), base, 2) = ((MR_Box) (TotalNumReqTests_126));
  ...
  Var_146 = mercury__string__f_43_43_2_f_0((MR_String) "Test ", Var_144);
  TestSeqStr_129 = mercury__string__f_43_43_2_f_0((MR_String) "", Var_146);
  ...
  TestComponentStrs_131 = mercury__list__map_2_f_0((MR_Word) (&test_grades__test_grades__type_ctor_info_test_component_0), (MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&test_grades_scalar_common_4[2]), TestSpecComponents_130);
  {
    ...
    MR_hl_field(MR_mktag(1), Var_133, 0) = ((MR_Box) (TestSeqStr_129));
    MR_hl_field(MR_mktag(1), Var_133, 1) = ((MR_Box) (TestComponentStrs_131));
  }
