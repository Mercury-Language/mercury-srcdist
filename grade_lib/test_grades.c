...
{
  {
    ...
    MR_Word Var_161;
    MR_Word STATE_VARIABLE_AbsSolveCountStats_35_162;
    MR_Word STATE_VARIABLE_RelSolveCountStats_36_163;
    MR_Word TestSpec_205;
    MR_Word TestSpecs_206;
    MR_Word Var_216;
    MR_Word STATE_VARIABLE_AbsSolveCountStats_35_217;
    MR_Word STATE_VARIABLE_RelSolveCountStats_36_218;
    ...
    TestSpec_150 = test_grades__broad_test_set_spec_0_f_0();
    Var_122 = test_grades__llds_test_set_spec_0_f_0();
    {
      TestSpecs_151 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), TestSpecs_151, 0) = ((MR_Box) (Var_122));
      MR_hl_field(MR_mktag(1), TestSpecs_151, 1) = ((MR_Box) ((MR_Unsigned) 0U));
    }
    Var_161 = mercury__cord__init_0_f_0((MR_Word) (&test_grades__test_grades__type_ctor_info_test_component_0));
    if ((TestSpec_150 == (MR_Word) ((MR_Unsigned) 0U)))
      test_grades__run_test_9_p_0(SolverInfo0_6, InstalledSets_34, Var_161, (MR_Word) (&test_grades_scalar_common_4[0]), &STATE_VARIABLE_AbsSolveCountStats_35_162, (MR_Word) (&test_grades_scalar_common_4[0]), &STATE_VARIABLE_RelSolveCountStats_36_163);
    else
    {
      MR_Word TestSetSpecHead_182 = ((MR_Word) ((MR_hl_field(MR_mktag(1), TestSpec_150, (MR_Integer) 0))));
      MR_Word TestSetSpecTail_183 = ((MR_Word) ((MR_hl_field(MR_mktag(1), TestSpec_150, (MR_Integer) 1))));
      MR_Word VarId_184 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), TestSetSpecHead_182, (MR_Integer) 0))) & (MR_Integer) 31);
      MR_Word ValueIds_185 = ((MR_Word) ((MR_hl_field(MR_mktag(0), TestSetSpecHead_182, (MR_Integer) 1))));

      test_grades__run_alternatives_for_var_12_p_0(SolverInfo0_6, InstalledSets_34, VarId_184, ValueIds_185, TestSetSpecTail_183, Var_161, (MR_Word) (&test_grades_scalar_common_4[0]), &STATE_VARIABLE_AbsSolveCountStats_35_162, (MR_Word) (&test_grades_scalar_common_4[0]), &STATE_VARIABLE_RelSolveCountStats_36_163);
    }
    TestSpec_205 = ((MR_Word) ((MR_hl_field(MR_mktag(1), TestSpecs_151, (MR_Integer) 0))));
    TestSpecs_206 = ((MR_Word) ((MR_hl_field(MR_mktag(1), TestSpecs_151, (MR_Integer) 1))));
    Var_216 = mercury__cord__init_0_f_0((MR_Word) (&test_grades__test_grades__type_ctor_info_test_component_0));
    if ((TestSpec_205 == (MR_Word) ((MR_Unsigned) 0U)))
      test_grades__run_test_9_p_0(SolverInfo0_6, InstalledSets_34, Var_216, STATE_VARIABLE_AbsSolveCountStats_35_162, &STATE_VARIABLE_AbsSolveCountStats_35_217, STATE_VARIABLE_RelSolveCountStats_36_163, &STATE_VARIABLE_RelSolveCountStats_36_218);
    else
    {
      MR_Word TestSetSpecHead_237 = ((MR_Word) ((MR_hl_field(MR_mktag(1), TestSpec_205, (MR_Integer) 0))));
      MR_Word TestSetSpecTail_238 = ((MR_Word) ((MR_hl_field(MR_mktag(1), TestSpec_205, (MR_Integer) 1))));
      MR_Word VarId_239 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), TestSetSpecHead_237, (MR_Integer) 0))) & (MR_Integer) 31);
      MR_Word ValueIds_240 = ((MR_Word) ((MR_hl_field(MR_mktag(0), TestSetSpecHead_237, (MR_Integer) 1))));

      test_grades__run_alternatives_for_var_12_p_0(SolverInfo0_6, InstalledSets_34, VarId_239, ValueIds_240, TestSetSpecTail_238, Var_216, STATE_VARIABLE_AbsSolveCountStats_35_162, &STATE_VARIABLE_AbsSolveCountStats_35_217, STATE_VARIABLE_RelSolveCountStats_36_163, &STATE_VARIABLE_RelSolveCountStats_36_218);
    }
    test_grades__run_test_sets_9_p_0(SolverInfo0_6, InstalledSets_34, TestSpecs_206, STATE_VARIABLE_AbsSolveCountStats_35_217, &AbsSolveCountStats_38, STATE_VARIABLE_RelSolveCountStats_36_218, &RelSolveCountStats_39);
