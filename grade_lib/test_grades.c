  ...
  MR_Word * STATE_VARIABLE_RelSolveCountStats_22)
{
  ...
  TotalNumLabelSteps0_58 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_RelSolveCountStats_0_21, (MR_Integer) 0))));
  TotalNumPasses0_59 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_RelSolveCountStats_0_21, (MR_Integer) 1))));
  TotalNumReqTests0_60 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_RelSolveCountStats_0_21, (MR_Integer) 2))));
  NumTests0_61 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_RelSolveCountStats_0_21, (MR_Integer) 3))));
  NumLabelSteps_62 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), CommitSolveCounts_13, (MR_Integer) 0))));
  NumPasses_63 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), CommitSolveCounts_13, (MR_Integer) 1))));
  NumReqTests_64 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), CommitSolveCounts_13, (MR_Integer) 2))));
  ...
  NumTests_68 = (MR_Integer) ((MR_Unsigned) NumTests0_61 + (MR_Unsigned) 1);
  {
    ...
    *STATE_VARIABLE_RelSolveCountStats_22 = base;
    MR_hl_field(MR_mktag(0), base, 0) = ((MR_Box) (TotalNumLabelSteps_65));
    MR_hl_field(MR_mktag(0), base, 1) = ((MR_Box) (TotalNumPasses_66));
    MR_hl_field(MR_mktag(0), base, 2) = ((MR_Box) (TotalNumReqTests_67));
    MR_hl_field(MR_mktag(0), base, 3) = ((MR_Box) (NumTests_68));
  }
