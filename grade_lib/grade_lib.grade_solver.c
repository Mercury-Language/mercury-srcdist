  ...
  MR_Box closure_arg)
{
  ...
  succeeded = grade_lib__grade_solver__IntroducedFrom__pred__solver_var_to_str__937__1_2_p_0(((MR_Integer) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Integer) ((MR_hl_field(0, closure, (MR_Integer) 4)))));
  return succeeded;
}
  ...
  MR_Word * STATE_VARIABLE_SolveCounts_28)
{
  while (MR_TRUE)
  {
    MR_Integer NumPasses0_11 = ((MR_Integer) ((MR_hl_field(0, STATE_VARIABLE_SolveCounts_0_27, (MR_Integer) 1))));
    MR_Integer NumReqTests0_12 = ((MR_Integer) ((MR_hl_field(0, STATE_VARIABLE_SolveCounts_0_27, (MR_Integer) 2))));
    ...
    MR_Integer Var_30;
    MR_Word STATE_VARIABLE_SolveCounts_32_32;
    MR_Word STATE_VARIABLE_SolverVarMap_34_34;
    MR_Integer Var_57;
    ...
    Var_57 = ((MR_Integer) ((MR_hl_field(0, STATE_VARIABLE_SolveCounts_0_27, (MR_Integer) 0))));
    {
      STATE_VARIABLE_SolveCounts_32_32 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(0, STATE_VARIABLE_SolveCounts_32_32, 0) = ((MR_Box) (Var_57));
      MR_hl_field(0, STATE_VARIABLE_SolveCounts_32_32, 1) = ((MR_Box) (NumPasses_13));
      MR_hl_field(0, STATE_VARIABLE_SolveCounts_32_32, 2) = ((MR_Box) (NumReqTests_14));
    }
    grade_lib__grade_solver__propagate_pass_9_p_0(Requirements0_7, (MR_Word) ((MR_Unsigned) 0U), &RevRequirements1_15, STATE_VARIABLE_SolverVarMap_0_25, &STATE_VARIABLE_SolverVarMap_34_34, (MR_Integer) 0, &Changed_16, (MR_Integer) 0, &FoundFailure_17);
      ...
      case (MR_Integer) 1:
        {
          ...
          *STATE_VARIABLE_SolverVarMap_26 = STATE_VARIABLE_SolverVarMap_34_34;
          *STATE_VARIABLE_SolveCounts_28 = STATE_VARIABLE_SolveCounts_32_32;
        }
        break;
      case (MR_Integer) 0:
        switch (Changed_16) {
          ...
          case (MR_Integer) 1:
            {
              ...
              MR_Word next_value_of_STATE_VARIABLE_SolverVarMap_0_25 = STATE_VARIABLE_SolverVarMap_34_34;
              MR_Word next_value_of_STATE_VARIABLE_SolveCounts_0_27 = STATE_VARIABLE_SolveCounts_32_32;
  ...
  MR_Word * STATE_VARIABLE_FoundFailure_9)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      MR_Word STATE_VARIABLE_SolverVarMap_99_99;
      MR_Word STATE_VARIABLE_Changed_100_100;
      MR_Word STATE_VARIABLE_FoundFailure_101_101;
      MR_Word STATE_VARIABLE_RevRequirements_156_156;
      ...
      IfCntAll_38 = ((MR_Integer) ((MR_hl_field(0, IfVar0_37, (MR_Integer) 0))));
      IfCntPoss0_39 = ((MR_Integer) ((MR_hl_field(0, IfVar0_37, (MR_Integer) 1))));
      IfValues0_40 = ((MR_Word) ((MR_hl_field(0, IfVar0_37, (MR_Integer) 2))));
      ...
      if (succeeded)
      {
        ...
        ThenCntAll_42 = ((MR_Integer) ((MR_hl_field(0, ThenVar0_41, (MR_Integer) 0))));
        ThenCntPoss0_43 = ((MR_Integer) ((MR_hl_field(0, ThenVar0_41, (MR_Integer) 1))));
        ThenValues0_44 = ((MR_Word) ((MR_hl_field(0, ThenVar0_41, (MR_Integer) 2))));
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              ...
              mercury__map__det_update_4_p_0((MR_Word) (&grade_lib__grade_spec__grade_lib__grade_spec__type_ctor_info_solver_var_id_0), (MR_Word) (&grade_lib__grade_state__grade_lib__grade_state__type_ctor_info_solver_var_0), ((MR_Box) (ThenVarId_32)), ((MR_Box) (ThenVar_53)), STATE_VARIABLE_SolverVarMap_0_4, &STATE_VARIABLE_SolverVarMap_99_99);
              STATE_VARIABLE_Changed_100_100 = (MR_Integer) 1;
              succeeded = (ThenCntPoss_47 == (MR_Integer) 0);
              if (succeeded)
                STATE_VARIABLE_FoundFailure_101_101 = (MR_Integer) 1;
              else
                STATE_VARIABLE_FoundFailure_101_101 = STATE_VARIABLE_FoundFailure_0_8;
            }
            else
            {
              STATE_VARIABLE_FoundFailure_101_101 = STATE_VARIABLE_FoundFailure_0_8;
              STATE_VARIABLE_Changed_100_100 = STATE_VARIABLE_Changed_0_6;
              STATE_VARIABLE_SolverVarMap_99_99 = STATE_VARIABLE_SolverVarMap_0_4;
            }
          }
          else
          {
        ...
        else
        {
          ...
          mercury__map__det_update_4_p_0((MR_Word) (&grade_lib__grade_spec__grade_lib__grade_spec__type_ctor_info_solver_var_id_0), (MR_Word) (&grade_lib__grade_state__grade_lib__grade_state__type_ctor_info_solver_var_0), ((MR_Box) (IfVarId_30)), ((MR_Box) (IfVar_59)), STATE_VARIABLE_SolverVarMap_0_4, &STATE_VARIABLE_SolverVarMap_99_99);
          STATE_VARIABLE_Changed_100_100 = (MR_Integer) 1;
        ...
        switch (KeepReq_45) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 0:
            STATE_VARIABLE_RevRequirements_156_156 = STATE_VARIABLE_RevRequirements_0_2;
            break;
          case (MR_Integer) 1:
            {
              STATE_VARIABLE_RevRequirements_156_156 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(1, STATE_VARIABLE_RevRequirements_156_156, 0) = ((MR_Box) (Requirement_22));
              MR_hl_field(1, STATE_VARIABLE_RevRequirements_156_156, 1) = ((MR_Box) (STATE_VARIABLE_RevRequirements_0_2));
            }
            break;
        }
      }
      ...
      next_value_of_STATE_VARIABLE_RevRequirements_0_2 = STATE_VARIABLE_RevRequirements_156_156;
      next_value_of_STATE_VARIABLE_SolverVarMap_0_4 = STATE_VARIABLE_SolverVarMap_99_99;
      next_value_of_STATE_VARIABLE_Changed_0_6 = STATE_VARIABLE_Changed_100_100;
      next_value_of_STATE_VARIABLE_FoundFailure_0_8 = STATE_VARIABLE_FoundFailure_101_101;
      HeadVar__1_1 = next_value_of_HeadVar__1_1;
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = grade_lib__grade_solver__IntroducedFrom__pred__restrict_possibilities_to__514__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 4)))));
  return succeeded;
}
