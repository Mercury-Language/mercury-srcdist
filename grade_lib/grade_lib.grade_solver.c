  ...
  MR_Word * Soln_14)
{
  while (MR_TRUE)
  {
    ...
    if ((ZeroCntVarIds_36 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      ...
      {
        MR_Integer NumLabelSteps0_16 = ((MR_Integer) ((MR_hl_field(0, STATE_VARIABLE_SolveCounts_25_25, 0))));
        ...
        MR_Integer Var_31 = ((MR_Integer) ((MR_hl_field(0, STATE_VARIABLE_SolveCounts_25_25, 1))));
        MR_Integer Var_32 = ((MR_Integer) ((MR_hl_field(0, STATE_VARIABLE_SolveCounts_25_25, 2))));
