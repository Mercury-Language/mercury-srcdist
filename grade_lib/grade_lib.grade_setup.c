  ...
  MR_Word * STATE_VARIABLE_SolverInfo_22)
{
  ...
  MR_Word SolverVarSpecs_38;
  MR_Word SolverVarPriorityCord_39;
  MR_Word Var_40;
  MR_Word Var_41;
  MR_Word RequirementSpecs_46;
  MR_Word BadRequirements_47;
  MR_Word SolverVarMap0_62;
  MR_Word SolverVarMap0_75;
  MR_Word SolverVarMap0_88;
  MR_Word SolverVarMap_89;
  MR_Word Var_67;
  MR_Word Var_68;
  MR_Word Var_80;
  MR_Word Var_81;
  ...
  SolverVarSpecs_38 = grade_lib__grade_spec__init_solver_var_specs_1_f_0(SpecsVersion_4);
  Var_40 = mercury__map__init_0_f_0((MR_Word) (&grade_lib__grade_spec__grade_lib__grade_spec__type_ctor_info_solver_var_id_0), (MR_Word) (&grade_lib__grade_state__grade_lib__grade_state__type_ctor_info_solver_var_0));
  Var_41 = mercury__cord__init_0_f_0((MR_Word) (&grade_lib__grade_spec__grade_lib__grade_spec__type_ctor_info_solver_var_id_0));
  grade_lib__grade_setup__init_solver_vars_5_p_0(SolverVarSpecs_38, Var_40, &SolverVarMap0_62, Var_41, &SolverVarPriorityCord_39);
  SolverVarPriority_8 = mercury__cord__to_list_1_f_0((MR_Word) (&grade_lib__grade_spec__grade_lib__grade_spec__type_ctor_info_solver_var_id_0), SolverVarPriorityCord_39);
  RequirementSpecs_46 = grade_lib__grade_spec__init_requirement_specs_0_f_0();
  grade_lib__grade_setup__convert_and_check_requirements_5_p_0((MR_Integer) 0, SolverVarMap0_62, RequirementSpecs_46, &Requirements_9, &BadRequirements_47);
  if (!((BadRequirements_47 == (MR_Word) ((MR_Unsigned) 0U))))
  {
    mercury__io__write_3_p_0((MR_Word) (&grade_lib__grade_setup_scalar_common_1[0]), ((MR_Box) (BadRequirements_47)));
    {
  ...
  }
  {
    ...
    MR_hl_field(MR_mktag(0), STATE_VARIABLE_SolverInfo_23_23, 2) = ((MR_Box) (SolverVarMap0_62));
  }
  ...
  grade_lib__grade_setup__assign_var_in_map_5_p_0((MR_Word) ((MR_Unsigned) 0U), (MR_Integer) 0, GccRegsAvailValue_16, SolverVarMap0_62, &SolverVarMap0_75);
  Var_67 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_SolverInfo_23_23, (MR_Integer) 0))));
  Var_68 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_SolverInfo_23_23, (MR_Integer) 1))));
  {
    STATE_VARIABLE_SolverInfo_25_25 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(MR_mktag(0), STATE_VARIABLE_SolverInfo_25_25, 0) = ((MR_Box) (Var_67));
    MR_hl_field(MR_mktag(0), STATE_VARIABLE_SolverInfo_25_25, 1) = ((MR_Box) (Var_68));
    MR_hl_field(MR_mktag(0), STATE_VARIABLE_SolverInfo_25_25, 2) = ((MR_Box) (SolverVarMap0_75));
  }
  grade_lib__grade_setup__assign_var_in_map_5_p_0((MR_Word) ((MR_Unsigned) 0U), (MR_Integer) 1, GccGotosAvailValue_17, SolverVarMap0_75, &SolverVarMap0_88);
  Var_80 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_SolverInfo_25_25, (MR_Integer) 0))));
  Var_81 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_SolverInfo_25_25, (MR_Integer) 1))));
  {
    STATE_VARIABLE_SolverInfo_27_27 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(MR_mktag(0), STATE_VARIABLE_SolverInfo_27_27, 0) = ((MR_Box) (Var_80));
    MR_hl_field(MR_mktag(0), STATE_VARIABLE_SolverInfo_27_27, 1) = ((MR_Box) (Var_81));
    MR_hl_field(MR_mktag(0), STATE_VARIABLE_SolverInfo_27_27, 2) = ((MR_Box) (SolverVarMap0_88));
  }
  grade_lib__grade_setup__assign_var_in_map_5_p_0((MR_Word) ((MR_Unsigned) 0U), (MR_Integer) 2, GccLabelsAvailValue_18, SolverVarMap0_88, &SolverVarMap_89);
  Var_93 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_SolverInfo_27_27, (MR_Integer) 0))));
  Var_94 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_SolverInfo_27_27, (MR_Integer) 1))));
  {
    STATE_VARIABLE_SolverInfo_29_29 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(MR_mktag(0), STATE_VARIABLE_SolverInfo_29_29, 0) = ((MR_Box) (Var_93));
    MR_hl_field(MR_mktag(0), STATE_VARIABLE_SolverInfo_29_29, 1) = ((MR_Box) (Var_94));
    MR_hl_field(MR_mktag(0), STATE_VARIABLE_SolverInfo_29_29, 2) = ((MR_Box) (SolverVarMap_89));
  }
  ...
  MR_Word * HeadVar__5_5)
{
  ...
  else
  {
    ...
    MR_Word VarValues_53;
    MR_Word SearchSet_54;
    MR_Word ValueId_55;
    MR_Word Set_56;
    MR_Word Var_57;
    MR_Box conv0_SolverVar_35;
    MR_Box conv2_SolverVar_50;
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        TypeCtorInfo_15_58 = (MR_Word) (&grade_lib__grade_spec__grade_lib__grade_spec__type_ctor_info_solver_var_id_0);
        TypeCtorInfo_16_59 = (MR_Word) (&grade_lib__grade_state__grade_lib__grade_state__type_ctor_info_solver_var_0);
        succeeded = mercury__map__search_3_p_0(TypeCtorInfo_15_58, TypeCtorInfo_16_59, HeadVar__2_2, ((MR_Box) (ThenVar_19)), &conv2_SolverVar_50);
        if (succeeded)
        {
          SolverVar_50 = ((MR_Word) (conv2_SolverVar_50));
          succeeded = MR_TRUE;
        }
        if (succeeded)
        {
          VarValues_53 = ((MR_Word) ((MR_hl_field(MR_mktag(0), SolverVar_50, (MR_Integer) 2))));
          TypeCtorInfo_17_60 = (MR_Word) (&grade_lib__grade_spec__grade_lib__grade_spec__type_ctor_info_solver_var_value_id_0);
          mercury__set__list_to_set_2_p_0(TypeCtorInfo_17_60, ThenValues_20, &SearchSet_54);
          TypeCtorInfo_18_61 = (MR_Word) (&grade_lib__grade_state__grade_lib__grade_state__type_ctor_info_solver_var_value_0);
          Var_57 = (MR_Word) (&grade_lib__grade_setup_scalar_common_4[1]);
          ValueId_55 = mercury__list__map_2_f_0(TypeCtorInfo_18_61, TypeCtorInfo_17_60, Var_57, VarValues_53);
          mercury__set__list_to_set_2_p_0(TypeCtorInfo_17_60, ValueId_55, &Set_56);
          succeeded = mercury__set__subset_2_p_0(TypeCtorInfo_17_60, SearchSet_54, Set_56);
          if (succeeded)
          {
  ...
  MR_Word * STATE_VARIABLE_SolverInfo_11)
{
  ...
  Var_15 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_SolverInfo_0_10, (MR_Integer) 0))));
  Var_16 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_SolverInfo_0_10, (MR_Integer) 1))));
  {
    MR_Word base;
    base = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
