...
static const MR_EnumFunctorDescPtr grade_lib__grade_setup__grade_lib__grade_setup__enum_value_ordered_autoconf_gcc_gotos_avail_0[2];
...
static const MR_EnumFunctorDescPtr grade_lib__grade_setup__grade_lib__grade_setup__enum_value_ordered_autoconf_gcc_labels_avail_0[2];
...
static const MR_EnumFunctorDescPtr grade_lib__grade_setup__grade_lib__grade_setup__enum_value_ordered_autoconf_gcc_regs_avail_0[2];
...
static const MR_EnumFunctorDescPtr grade_lib__grade_setup__grade_lib__grade_setup__enum_value_ordered_autoconf_low_tag_bits_avail_0[3];
...
static const MR_EnumFunctorDescPtr grade_lib__grade_setup__grade_lib__grade_setup__enum_value_ordered_autoconf_merc_file_0[2];
...
static const MR_EnumFunctorDescPtr grade_lib__grade_setup__grade_lib__grade_setup__enum_value_ordered_autoconf_size_of_double_0[2];
...
static const MR_EnumFunctorDescPtr grade_lib__grade_setup__grade_lib__grade_setup__enum_value_ordered_solver_var_set_to_0[2];
...
static void MR_CALL 
grade_lib__grade_setup__assign_autoconf_var_4_p_0(
  MR_Word VarId_5,
  MR_Word ValueId_6,
  MR_Word STATE_VARIABLE_SolverInfo_0_10,
  MR_Word * STATE_VARIABLE_SolverInfo_11);

static void MR_CALL 
grade_lib__grade_setup__set_solver_var_in_map_9_p_0(
  ...
  MR_Word STATE_VARIABLE_SolverVarMap_0_33,
  MR_Word * STATE_VARIABLE_SolverVarMap_34);
...
const MR_TypeCtorInfo_Struct grade_lib__grade_setup__grade_lib__grade_setup__type_ctor_info_autoconf_gcc_gotos_avail_0 = {
  ...
  {     grade_lib__grade_setup__grade_lib__grade_setup__enum_value_ordered_autoconf_gcc_gotos_avail_0 },
  (MR_Integer) 2,
  UINT16_C(4),
...
const MR_TypeCtorInfo_Struct grade_lib__grade_setup__grade_lib__grade_setup__type_ctor_info_autoconf_gcc_labels_avail_0 = {
  ...
  {     grade_lib__grade_setup__grade_lib__grade_setup__enum_value_ordered_autoconf_gcc_labels_avail_0 },
  (MR_Integer) 2,
  UINT16_C(4),
...
const MR_TypeCtorInfo_Struct grade_lib__grade_setup__grade_lib__grade_setup__type_ctor_info_autoconf_gcc_regs_avail_0 = {
  ...
  {     grade_lib__grade_setup__grade_lib__grade_setup__enum_value_ordered_autoconf_gcc_regs_avail_0 },
  (MR_Integer) 2,
  UINT16_C(4),
...
const MR_TypeCtorInfo_Struct grade_lib__grade_setup__grade_lib__grade_setup__type_ctor_info_autoconf_low_tag_bits_avail_0 = {
  ...
  {     grade_lib__grade_setup__grade_lib__grade_setup__enum_value_ordered_autoconf_low_tag_bits_avail_0 },
  (MR_Integer) 3,
  UINT16_C(4),
...
const MR_TypeCtorInfo_Struct grade_lib__grade_setup__grade_lib__grade_setup__type_ctor_info_autoconf_merc_file_0 = {
  ...
  {     grade_lib__grade_setup__grade_lib__grade_setup__enum_value_ordered_autoconf_merc_file_0 },
  (MR_Integer) 2,
  UINT16_C(4),
...
const MR_TypeCtorInfo_Struct grade_lib__grade_setup__grade_lib__grade_setup__type_ctor_info_autoconf_size_of_double_0 = {
  ...
  {     grade_lib__grade_setup__grade_lib__grade_setup__enum_value_ordered_autoconf_size_of_double_0 },
  (MR_Integer) 2,
  UINT16_C(4),
...
const MR_TypeCtorInfo_Struct grade_lib__grade_setup__grade_lib__grade_setup__type_ctor_info_solver_var_set_to_0 = {
  ...
  {     grade_lib__grade_setup__grade_lib__grade_setup__enum_value_ordered_solver_var_set_to_0 },
  (MR_Integer) 2,
  UINT16_C(4),
...
{
  {
    MR_bool succeeded = (HeadVar__1_32 == HeadVar__2_38);
...
{
  {
    ...
    grade_lib__grade_setup__set_solver_var_in_map_9_p_0(VarName_10, ValueName_11, VarId_12, ValueId_13, SetTo_14, WhyNot_15, MaybeError_16, SolverVarMap0_18, &SolverVarMap_19);
    Var_25 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_SolverInfo_0_20, (MR_Integer) 0))));
    Var_26 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_SolverInfo_0_20, (MR_Integer) 1))));
    {
      MR_Word base;
...
{
  {
    ...
    MR_Word SolverVarSpecs_39;
    MR_Word SolverVarPriorityCord_40;
    MR_Word Var_41;
    MR_Word Var_42;
    MR_Word RequirementSpecs_47;
    MR_Word BadRequirements_48;
    MR_Word SolverVarMap0_63;
    MR_Word SolverVarMap0_77;
    MR_Word SolverVarMap_78;
    MR_Word Var_69;
    MR_Word Var_70;
    MR_Word Var_83;
    MR_Word Var_84;

    SolverVarSpecs_39 = grade_lib__grade_spec__init_solver_var_specs_1_f_0(SpecsVersion_4);
    Var_41 = mercury__map__init_0_f_0((MR_Word) (&grade_lib__grade_spec__grade_lib__grade_spec__type_ctor_info_solver_var_id_0), (MR_Word) (&grade_lib__grade_state__grade_lib__grade_state__type_ctor_info_solver_var_0));
    Var_42 = mercury__cord__init_0_f_0((MR_Word) (&grade_lib__grade_spec__grade_lib__grade_spec__type_ctor_info_solver_var_id_0));
    grade_lib__grade_setup__init_solver_vars_5_p_0(SolverVarSpecs_39, Var_41, &SolverVarMap0_63, Var_42, &SolverVarPriorityCord_40);
    SolverVarPriority_8 = mercury__cord__to_list_1_f_0((MR_Word) (&grade_lib__grade_spec__grade_lib__grade_spec__type_ctor_info_solver_var_id_0), SolverVarPriorityCord_40);
    RequirementSpecs_47 = grade_lib__grade_spec__init_requirement_specs_0_f_0();
    grade_lib__grade_setup__convert_and_check_requirements_5_p_0((MR_Integer) 0, SolverVarMap0_63, RequirementSpecs_47, &Requirements_9, &BadRequirements_48);
    if (!((BadRequirements_48 == (MR_Word) ((MR_Unsigned) 0U))))
    {
      mercury__io__write_3_p_0((MR_Word) (&grade_lib__grade_setup_scalar_common_1[0]), ((MR_Box) (BadRequirements_48)));
      {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(0), STATE_VARIABLE_SolverInfo_23_23, 2) = ((MR_Box) (SolverVarMap0_63));
    }
    ...
    grade_lib__grade_setup__assign_var_in_map_5_p_0((MR_Word) ((MR_Unsigned) 0U), (MR_Integer) 0, GccRegsAvailValue_16, SolverVarMap0_63, &SolverVarMap0_77);
    Var_69 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_SolverInfo_23_23, (MR_Integer) 0))));
    Var_70 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_SolverInfo_23_23, (MR_Integer) 1))));
    {
      STATE_VARIABLE_SolverInfo_25_25 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), STATE_VARIABLE_SolverInfo_25_25, 0) = ((MR_Box) (Var_69));
      MR_hl_field(MR_mktag(0), STATE_VARIABLE_SolverInfo_25_25, 1) = ((MR_Box) (Var_70));
      MR_hl_field(MR_mktag(0), STATE_VARIABLE_SolverInfo_25_25, 2) = ((MR_Box) (SolverVarMap0_77));
    }
    grade_lib__grade_setup__assign_var_in_map_5_p_0((MR_Word) ((MR_Unsigned) 0U), (MR_Integer) 1, GccGotosAvailValue_17, SolverVarMap0_77, &SolverVarMap_78);
    Var_83 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_SolverInfo_25_25, (MR_Integer) 0))));
    Var_84 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_SolverInfo_25_25, (MR_Integer) 1))));
    {
      STATE_VARIABLE_SolverInfo_27_27 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), STATE_VARIABLE_SolverInfo_27_27, 0) = ((MR_Box) (Var_83));
      MR_hl_field(MR_mktag(0), STATE_VARIABLE_SolverInfo_27_27, 1) = ((MR_Box) (Var_84));
      MR_hl_field(MR_mktag(0), STATE_VARIABLE_SolverInfo_27_27, 2) = ((MR_Box) (SolverVarMap_78));
    }
    grade_lib__grade_setup__assign_autoconf_var_4_p_0((MR_Integer) 2, GccLabelsAvailValue_18, STATE_VARIABLE_SolverInfo_27_27, &STATE_VARIABLE_SolverInfo_29_29);
    grade_lib__grade_setup__assign_autoconf_var_4_p_0((MR_Integer) 3, LowTagBitsAvailValue_19, STATE_VARIABLE_SolverInfo_29_29, &STATE_VARIABLE_SolverInfo_31_31);
    grade_lib__grade_setup__assign_autoconf_var_4_p_0((MR_Integer) 4, SizeOfDoubleValue_20, STATE_VARIABLE_SolverInfo_31_31, &STATE_VARIABLE_SolverInfo_33_33);
    grade_lib__grade_setup__assign_autoconf_var_4_p_0((MR_Integer) 5, MercFileValue_21, STATE_VARIABLE_SolverInfo_33_33, STATE_VARIABLE_SolverInfo_22);
  }
}
...
{
  {
    ...
    else
    {
      ...
      MR_Word TypeCtorInfo_15_60;
      MR_Word TypeCtorInfo_16_61;
      MR_Word TypeCtorInfo_17_62;
      MR_Word TypeCtorInfo_18_63;
      MR_Word Var_30;
      MR_Word SolverVar_35;
      MR_Word VarValues_38;
      MR_Word SearchSet_39;
      MR_Word ValueId_40;
      MR_Word Set_41;
      MR_Word Var_42;
      MR_Word SolverVar_52;
      MR_Word VarValues_55;
      MR_Word SearchSet_56;
      MR_Word ValueId_57;
      MR_Word Set_58;
      MR_Word Var_59;
      MR_Box conv0_SolverVar_35;
      MR_Box conv2_SolverVar_52;
      ...
      succeeded = mercury__map__search_3_p_0((MR_Word) (&grade_lib__grade_spec__grade_lib__grade_spec__type_ctor_info_solver_var_id_0), (MR_Word) (&grade_lib__grade_state__grade_lib__grade_state__type_ctor_info_solver_var_0), HeadVar__2_2, ((MR_Box) (IfVar_17)), &conv0_SolverVar_35);
      if (succeeded)
      {
        SolverVar_35 = ((MR_Word) (conv0_SolverVar_35));
        succeeded = MR_TRUE;
      }
      if (succeeded)
      {
        VarValues_38 = ((MR_Word) ((MR_hl_field(MR_mktag(0), SolverVar_35, (MR_Integer) 2))));
        TypeCtorInfo_17_45 = (MR_Word) (&grade_lib__grade_spec__grade_lib__grade_spec__type_ctor_info_solver_var_value_id_0);
        mercury__set__list_to_set_2_p_0(TypeCtorInfo_17_45, Var_30, &SearchSet_39);
        TypeCtorInfo_18_46 = (MR_Word) (&grade_lib__grade_state__grade_lib__grade_state__type_ctor_info_solver_var_value_0);
        Var_42 = (MR_Word) (&grade_lib__grade_setup_scalar_common_4[0]);
        ValueId_40 = mercury__list__map_2_f_0(TypeCtorInfo_18_46, TypeCtorInfo_17_45, Var_42, VarValues_38);
        mercury__set__list_to_set_2_p_0(TypeCtorInfo_17_45, ValueId_40, &Set_41);
        succeeded = mercury__set__subset_2_p_0(TypeCtorInfo_17_45, SearchSet_39, Set_41);
        if (succeeded)
        {
          TypeCtorInfo_15_60 = (MR_Word) (&grade_lib__grade_spec__grade_lib__grade_spec__type_ctor_info_solver_var_id_0);
          TypeCtorInfo_16_61 = (MR_Word) (&grade_lib__grade_state__grade_lib__grade_state__type_ctor_info_solver_var_0);
          succeeded = mercury__map__search_3_p_0(TypeCtorInfo_15_60, TypeCtorInfo_16_61, HeadVar__2_2, ((MR_Box) (ThenVar_19)), &conv2_SolverVar_52);
          if (succeeded)
          {
            SolverVar_52 = ((MR_Word) (conv2_SolverVar_52));
            succeeded = MR_TRUE;
          }
          if (succeeded)
          {
            VarValues_55 = ((MR_Word) ((MR_hl_field(MR_mktag(0), SolverVar_52, (MR_Integer) 2))));
            TypeCtorInfo_17_62 = (MR_Word) (&grade_lib__grade_spec__grade_lib__grade_spec__type_ctor_info_solver_var_value_id_0);
            mercury__set__list_to_set_2_p_0(TypeCtorInfo_17_62, ThenValues_20, &SearchSet_56);
            TypeCtorInfo_18_63 = (MR_Word) (&grade_lib__grade_state__grade_lib__grade_state__type_ctor_info_solver_var_value_0);
            Var_59 = (MR_Word) (&grade_lib__grade_setup_scalar_common_4[1]);
            ValueId_57 = mercury__list__map_2_f_0(TypeCtorInfo_18_63, TypeCtorInfo_17_62, Var_59, VarValues_55);
            mercury__set__list_to_set_2_p_0(TypeCtorInfo_17_62, ValueId_57, &Set_58);
            succeeded = mercury__set__subset_2_p_0(TypeCtorInfo_17_62, SearchSet_56, Set_58);
            if (succeeded)
            {
...
{
  {
    MR_Word SolverVarMap0_8 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_SolverInfo_0_10, (MR_Integer) 2))));
    MR_Word SolverVarMap_9;
    MR_Word Var_16;
    MR_Word Var_17;

    grade_lib__grade_setup__assign_var_in_map_5_p_0((MR_Word) ((MR_Unsigned) 0U), VarId_5, ValueId_6, SolverVarMap0_8, &SolverVarMap_9);
    Var_16 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_SolverInfo_0_10, (MR_Integer) 0))));
    Var_17 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_SolverInfo_0_10, (MR_Integer) 1))));
    {
      MR_Word base;
      base = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
      *STATE_VARIABLE_SolverInfo_11 = base;
      MR_hl_field(MR_mktag(0), base, 0) = ((MR_Box) (Var_16));
      MR_hl_field(MR_mktag(0), base, 1) = ((MR_Box) (Var_17));
      MR_hl_field(MR_mktag(0), base, 2) = ((MR_Box) (SolverVarMap_9));
    }
  }
}
...
{
  {
    ...
    grade_lib__grade_setup__set_solver_var_in_map_9_p_0(VarName_10, ValueName_11, VarId_7, ValueId_8, (MR_Integer) 1, WhyNot_6, &MaybeError_12, STATE_VARIABLE_SolverMap_0_14, STATE_VARIABLE_SolverMap_15);
...
{
  {
    MR_Word SolverVar0_18;
    MR_Integer CntAll_19;
    MR_Integer CntPoss0_20;
    MR_Word Values0_21;
    MR_Word OldPossibles_22;
    MR_Word Values_23;
    MR_Box conv0_SolverVar0_18;

    mercury__map__lookup_3_p_0((MR_Word) (&grade_lib__grade_spec__grade_lib__grade_spec__type_ctor_info_solver_var_id_0), (MR_Word) (&grade_lib__grade_state__grade_lib__grade_state__type_ctor_info_solver_var_0), STATE_VARIABLE_SolverVarMap_0_33, ((MR_Box) (VarId_12)), &conv0_SolverVar0_18);
    SolverVar0_18 = ((MR_Word) (conv0_SolverVar0_18));
    CntAll_19 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), SolverVar0_18, (MR_Integer) 0))));
    CntPoss0_20 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), SolverVar0_18, (MR_Integer) 1))));
    Values0_21 = ((MR_Word) ((MR_hl_field(MR_mktag(0), SolverVar0_18, (MR_Integer) 2))));
    switch (SetTo_14) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        grade_lib__grade_setup__set_value_to_false_6_p_0(ValueId_13, WhyNot_15, (MR_Word) ((MR_Unsigned) 0U), &OldPossibles_22, Values0_21, &Values_23);
        break;
      case (MR_Integer) 1:
        grade_lib__grade_setup__set_value_to_true_6_p_0(ValueId_13, WhyNot_15, (MR_Word) ((MR_Unsigned) 0U), &OldPossibles_22, Values0_21, &Values_23);
        break;
    }
    if ((OldPossibles_22 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      MR_String Msg_24;
      MR_String Var_85;
      MR_String Var_87;
      ...
      Var_85 = mercury__string__f_43_43_2_f_0(ValueName_11, (MR_String) "\n");
      Var_87 = mercury__string__f_43_43_2_f_0((MR_String) " has no value named ", Var_85);
      Var_88 = mercury__string__f_43_43_2_f_0(VarName_10, Var_87);
      Msg_24 = mercury__string__f_43_43_2_f_0((MR_String) "solver variable ", Var_88);
      {
        MR_Word base;
      ...
      *STATE_VARIABLE_SolverVarMap_34 = STATE_VARIABLE_SolverVarMap_0_33;
    }
    else
    {
      MR_Word Var_73 = ((MR_Word) ((MR_hl_field(MR_mktag(1), OldPossibles_22, (MR_Integer) 1))));
      MR_Word Var_74 = ((MR_Word) ((MR_hl_field(MR_mktag(1), OldPossibles_22, (MR_Integer) 0))));
      ...
      if ((Var_73 == (MR_Word) ((MR_Unsigned) 0U)))
        switch (SetTo_14) {
          ...
          case (MR_Integer) 0:
            ...
            {
              MR_Integer CntPoss_62;
              MR_Word SolverVar_63;

              *MaybeError_16 = (MR_Word) ((MR_Unsigned) 0U);
              CntPoss_62 = (MR_Integer) ((MR_Unsigned) CntPoss0_20 - (MR_Unsigned) 1);
              {
                SolverVar_63 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
                MR_hl_field(MR_mktag(0), SolverVar_63, 0) = ((MR_Box) (CntAll_19));
                MR_hl_field(MR_mktag(0), SolverVar_63, 1) = ((MR_Box) (CntPoss_62));
                MR_hl_field(MR_mktag(0), SolverVar_63, 2) = ((MR_Box) (Values_23));
              }
              mercury__map__det_update_4_p_0((MR_Word) (&grade_lib__grade_spec__grade_lib__grade_spec__type_ctor_info_solver_var_id_0), (MR_Word) (&grade_lib__grade_state__grade_lib__grade_state__type_ctor_info_solver_var_0), ((MR_Box) (VarId_12)), ((MR_Box) (SolverVar_63)), STATE_VARIABLE_SolverVarMap_0_33, STATE_VARIABLE_SolverVarMap_34);
            }
            else
            {
              *MaybeError_16 = (MR_Word) ((MR_Unsigned) 0U);
          ...
          case (MR_Integer) 1:
            if ((Var_74 == (MR_Word) ((MR_Unsigned) 0U)))
            {
              MR_Word SolverVar_27;

              *MaybeError_16 = (MR_Word) ((MR_Unsigned) 0U);
              {
                SolverVar_27 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
                MR_hl_field(MR_mktag(0), SolverVar_27, 0) = ((MR_Box) (CntAll_19));
                MR_hl_field(MR_mktag(0), SolverVar_27, 1) = ((MR_Box) ((MR_Integer) 1));
                MR_hl_field(MR_mktag(0), SolverVar_27, 2) = ((MR_Box) (Values_23));
              }
              mercury__map__det_update_4_p_0((MR_Word) (&grade_lib__grade_spec__grade_lib__grade_spec__type_ctor_info_solver_var_id_0), (MR_Word) (&grade_lib__grade_state__grade_lib__grade_state__type_ctor_info_solver_var_0), ((MR_Box) (VarId_12)), ((MR_Box) (SolverVar_27)), STATE_VARIABLE_SolverVarMap_0_33, STATE_VARIABLE_SolverVarMap_34);
            }
            else
            {
              MR_String Msg_59;
              ...
              Var_82 = mercury__string__f_43_43_2_f_0(VarName_10, (MR_String) "\n");
              Msg_59 = mercury__string__f_43_43_2_f_0((MR_String) "inconsistent settings for solver variable ", Var_82);
              {
                MR_Word base;
                base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                *MaybeError_16 = base;
                MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (Msg_59));
              }
              *STATE_VARIABLE_SolverVarMap_34 = STATE_VARIABLE_SolverVarMap_0_33;
            }
            break;
      ...
      else
      {
        ...
        Var_76 = mercury__string__f_43_43_2_f_0(ValueName_11, (MR_String) "\n");
        Var_78 = mercury__string__f_43_43_2_f_0((MR_String) " has more than one copy of value ", Var_76);
        Var_79 = mercury__string__f_43_43_2_f_0(VarName_10, Var_78);
        Msg_70 = mercury__string__f_43_43_2_f_0((MR_String) "solver var ", Var_79);
        {
          mercury__require__unexpected_2_p_0((MR_String) "predicate \140grade_lib.grade_setup.set_solver_var_in_map\'/9", Msg_70);
          return;
        }
      }
    }
