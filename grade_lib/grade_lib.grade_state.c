...
static const MR_EnumFunctorDescPtr grade_lib__grade_state__grade_lib__grade_state__enum_value_ordered_req_dir_0[2];
...
const MR_TypeCtorInfo_Struct grade_lib__grade_state__grade_lib__grade_state__type_ctor_info_req_dir_0 = {
  ...
  {     grade_lib__grade_state__grade_lib__grade_state__enum_value_ordered_req_dir_0 },
  (MR_Integer) 2,
  UINT16_C(4),
