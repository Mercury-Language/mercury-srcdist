  ...
  MR_Word HeadVar__2_2)
{
  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        TypeInfo__11_11 = (MR_Word) (&grade_lib__grade_state_scalar_common_1[3]);
  ...
  MR_Word HeadVar__2_2)
{
  ...
  else
  {
    ...
    if (succeeded)
    {
      TypeInfo__12_12 = (MR_Word) (&grade_lib__grade_state_scalar_common_1[2]);
      succeeded = mercury__builtin__unify_2_p_0(TypeInfo__12_12, ((MR_Box) (ArgX2_5)), ((MR_Box) (ArgY2_6)));
      if (succeeded)
      {
        TypeInfo__13_13 = (MR_Word) (&grade_lib__grade_state_scalar_common_2[0]);
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              TypeInfo__17_17 = (MR_Word) (&grade_lib__grade_state_scalar_common_1[0]);
