  ...
  else
  {
    ...
    else
    {
      ...
      Var_59 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_IncompleteParallelisation_23_23, (MR_Integer) 9))));
      {
        ...
        MR_hl_field(MR_mktag(0), STATE_VARIABLE_IncompleteParallelisation_28_28, 0) = ((MR_Box) (Var_50));
        MR_hl_field(MR_mktag(0), STATE_VARIABLE_IncompleteParallelisation_28_28, 1) = ((MR_Box) (Var_51));
        MR_hl_field(MR_mktag(0), STATE_VARIABLE_IncompleteParallelisation_28_28, 2) = ((MR_Box) (Var_52));
        MR_hl_field(MR_mktag(0), STATE_VARIABLE_IncompleteParallelisation_28_28, 3) = ((MR_Box) (LastScheduledGoal_21));
        MR_hl_field(MR_mktag(0), STATE_VARIABLE_IncompleteParallelisation_28_28, 4) = ((MR_Box) (Var_54));
        MR_hl_field(MR_mktag(0), STATE_VARIABLE_IncompleteParallelisation_28_28, 5) = ((MR_Box) (Var_55));
        MR_hl_field(MR_mktag(0), STATE_VARIABLE_IncompleteParallelisation_28_28, 6) = ((MR_Box) (Var_56));
        MR_hl_field(MR_mktag(0), STATE_VARIABLE_IncompleteParallelisation_28_28, 7) = ((MR_Box) (Var_57));
        MR_hl_field(MR_mktag(0), STATE_VARIABLE_IncompleteParallelisation_28_28, 8) = ((MR_Box) (Var_58));
        MR_hl_field(MR_mktag(0), STATE_VARIABLE_IncompleteParallelisation_28_28, 9) = ((MR_Box) (Var_59));
      }
    }
  }
    ...
    case (MR_Integer) 1:
      {
        ...
        {
          MaybeBranchesLimit_52 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
  ...
  MR_Word * STATE_VARIABLE_Messages_27)
{
  ...
  Graph0_61 = mercury__digraph__init_0_f_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0));
  Var_65 = mercury__map__init_0_f_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0), (MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0));
  mdprof_fb__automatic_parallelism__autopar_find_best_par__build_dependency_graph_for_conjuncts_6_p_0(Goals_6, (MR_Integer) 1, Var_65, &_VarDepMap_62, Graph0_61, &Graph_63);
  Var_66 = mercury__digraph__tc_1_f_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0), Graph_63);
  {
    DependencyGraphs_11 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(MR_mktag(0), DependencyGraphs_11, 0) = ((MR_Box) (Graph_63));
    MR_hl_field(MR_mktag(0), DependencyGraphs_11, 1) = ((MR_Box) (Var_66));
  }
  ...
  if (succeeded)
  {
    ...
    succeeded = mercury__list__last_2_p_0(TypeCtorInfo_47_47, OtherIndexes_14, &conv1_LastCostlyGoalIndexPrime_15);
    if (succeeded)
    {
    ...
    case (MR_Integer) 0:
      {
        ...
        Var_36 = ((MR_Word) ((MR_hl_field(MR_mktag(0), FirstCostlyGoal_21, (MR_Integer) 2))));
        Cost_22 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_36, (MR_Integer) 4))));
