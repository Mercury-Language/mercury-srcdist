  ...
  else
  {
    ...
    else
    {
      ...
      LastScheduledGoal_21 = (MR_Integer) ((MR_Unsigned) Var_31 - (MR_Unsigned) 1);
      {
        ...
        MR_hl_field(MR_mktag(0), STATE_VARIABLE_IncompleteParallelisation_33_33, 0) = ((MR_Box) (GoalsArray_63));
        MR_hl_field(MR_mktag(0), STATE_VARIABLE_IncompleteParallelisation_33_33, 1) = ((MR_Box) (FirstParGoal_64));
        MR_hl_field(MR_mktag(0), STATE_VARIABLE_IncompleteParallelisation_33_33, 2) = ((MR_Box) (LastParGoal_65));
        MR_hl_field(MR_mktag(0), STATE_VARIABLE_IncompleteParallelisation_33_33, 3) = ((MR_Box) (LastScheduledGoal_21));
        MR_hl_field(MR_mktag(0), STATE_VARIABLE_IncompleteParallelisation_33_33, 4) = ((MR_Box) ((MR_Unsigned) 0U));
        MR_hl_field(MR_mktag(0), STATE_VARIABLE_IncompleteParallelisation_33_33, 5) = ((MR_Box) (NumCalls_66));
        MR_hl_field(MR_mktag(0), STATE_VARIABLE_IncompleteParallelisation_33_33, 6) = ((MR_Box) (DependencyGraphs_67));
        MR_hl_field(MR_mktag(0), STATE_VARIABLE_IncompleteParallelisation_33_33, 7) = ((MR_Box) ((MR_Unsigned) 0U));
        MR_hl_field(MR_mktag(0), STATE_VARIABLE_IncompleteParallelisation_33_33, 8) = ((MR_Box) ((MR_Unsigned) 0U));
        MR_hl_field(MR_mktag(0), STATE_VARIABLE_IncompleteParallelisation_33_33, 9) = ((MR_Box) ((MR_Word) ((MR_Unsigned) 0U)));
      }
    }
  }
