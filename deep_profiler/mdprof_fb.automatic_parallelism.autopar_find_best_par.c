  ...
  MR_Word * STATE_VARIABLE_Messages_17)
{
  ...
  if (succeeded)
  {
    ...
    TypeCtorInfo_47_84 = (MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0);
    succeeded = mercury__list__last_2_p_0(TypeCtorInfo_47_84, OtherIndexes_54, &conv1_LastCostlyGoalIndexPrime_55);
    if (succeeded)
    {
