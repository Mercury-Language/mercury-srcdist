...
static const MR_EnumFunctorDescPtr mdprof_fb__automatic_parallelism__autopar_find_best_par__mdprof_fb__automatic_parallelism__autopar_find_best_par__enum_value_ordered_maybe_add_choice_point_0[2];
...
const MR_TypeCtorInfo_Struct mdprof_fb__automatic_parallelism__autopar_find_best_par__mdprof_fb__automatic_parallelism__autopar_find_best_par__type_ctor_info_maybe_add_choice_point_0 = {
  ...
  {     mdprof_fb__automatic_parallelism__autopar_find_best_par__mdprof_fb__automatic_parallelism__autopar_find_best_par__enum_value_ordered_maybe_add_choice_point_0 },
  (MR_Integer) 2,
  UINT16_C(4),
...
{
  {
    ...
    mdprof_fb__automatic_parallelism__autopar_find_best_par__generate_parallelisations_loop_8_p_0(Info_5, Algorithm_6, STATE_VARIABLE_GoalGroups_25_25, STATE_VARIABLE_IncompleteParallelisation_28_28, (MR_Word) ((MR_Unsigned) 0U), &STATE_VARIABLE_MaybeBestSolns_42_42, (MR_Word) (&mdprof_fb__automatic_parallelism__autopar_find_best_par_scalar_common_3[0]), &FinalProfile_9);
...
{
  {
    ...
    succeeded = (ParalleliseDepConjs_16 == (MR_Word) ((MR_Unsigned) 0U));
    if (succeeded)
      succeeded = (IsDependent_17 != (MR_Word) ((MR_Unsigned) 0U));
    succeeded = !(succeeded);
    if (succeeded)
    {
      MR_Float Cost_9;
      ...
      if ((MaybeCostData_47 == (MR_Word) ((MR_Unsigned) 0U)))
        {
      ...
      Var_67 = MR_unbox_float((MR_hl_field(MR_mktag(0), FullMetrics_50, (MR_Integer) 2)));
      Var_69 = mdbcomp__feedback__automatic_parallelism__parallel_exec_metrics_get_overheads_1_f_0(FullMetrics_50);
      Var_68 = (Var_69 * ((MR_Float) 2.0000000000000000));
      Cost_9 = (Var_67 + Var_68);
      {
        MR_Word base;
  ...
  MR_Word * MaybeBestParallelisation_10)
{
  while (MR_TRUE)
  {
    ...
    ;
    {
      ...
      MR_hl_field(MR_mktag(0), Var_52, 0) = ((MR_Box) (&mdprof_fb__automatic_parallelism__autopar_find_best_par_scalar_common_5[1]));
    ...
    if ((EqualBestSolns_20 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      ...
      if ((ParalleliseDepConjs_25 == (MR_Word) ((MR_Unsigned) 0U)))
      {
...

        {
          ...
          MR_hl_field(MR_mktag(0), Var_78, 11) = ((MR_Box) (MR_mkword(MR_mktag(1), &mdprof_fb__automatic_parallelism__autopar_find_best_par_scalar_common_6[0])));
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      mercury__digraph__add_vertex_4_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0), ((MR_Box) (HeadVar__2_2)), &ThisConjKey_39, STATE_VARIABLE_Graph_0_5, &STATE_VARIABLE_Graph_28_50);
      {
        ...
        MR_hl_field(MR_mktag(0), MaybeAddEdge_40, 0) = ((MR_Box) (&mdprof_fb__automatic_parallelism__autopar_find_best_par_scalar_common_4[0]));
      ...
      ProducedVars_45 = ((MR_Word) ((MR_hl_field(MR_mktag(0), InstMapInfo_37, (MR_Integer) 3))));
      {
        ...
        MR_hl_field(MR_mktag(0), InsertThisConjAsProducer_46, 0) = ((MR_Box) (&mdprof_fb__automatic_parallelism__autopar_find_best_par_scalar_common_5[0]));
