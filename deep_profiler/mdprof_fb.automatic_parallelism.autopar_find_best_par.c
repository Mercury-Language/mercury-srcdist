...
{
  {
    ...
    if (((MR_tag((MR_Word) HeadVar__2_2)) == (MR_Integer) 1))
    {
      ...
      if (((MR_tag((MR_Word) HeadVar__3_3)) == (MR_Integer) 1))
      {
        ...
        mercury__private_builtin__builtin_compare_int_3_p_0(&SubResult1_21, Var_35, ArgY1_20);
        ...
        else
        {
          ...
          mercury__private_builtin__builtin_compare_int_3_p_0(&SubResult2_24, Var_34, ArgY2_23);
    ...
    else
    {
      ...
      else
      {
        ...
        mercury__private_builtin__builtin_compare_int_3_p_0(&SubResult1_6, Var_37, ArgY1_5);
        succeeded = (SubResult1_6 != (MR_Integer) 0);
        if (succeeded)
          *HeadVar__1_1 = SubResult1_6;
        else
  ...
  MR_Word * STATE_VARIABLE_Profile_8)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      succeeded = ((MR_tag((MR_Word) MaybeNextBest0_48)) == (MR_Integer) 1);
      if (succeeded)
      {
...
{
  {
    MR_bool succeeded = ((MR_tag((MR_Word) Algorithm_3)) == (MR_Integer) 1);
...
{
  {
    ...
    succeeded = ((MR_tag((MR_Word) CostlyGoalsIndexes_12)) == (MR_Integer) 1);
    if (succeeded)
    {
