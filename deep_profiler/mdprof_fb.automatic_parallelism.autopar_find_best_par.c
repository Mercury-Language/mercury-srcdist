...
{
  {
    ...
    if (succeeded)
    {
      MR_Word TypeCtorInfo_75_75 = (MR_Word) &mercury__builtin__builtin__type_ctor_info_int_0;
      MR_Word DepConjKey_27;

      mercury__digraph__lookup_key_3_p_0(TypeCtorInfo_75_75, LambdaHeadVar__2_40, ((MR_Box) (DepConj_26)), &DepConjKey_27);
      mercury__digraph__add_edge_4_p_0(TypeCtorInfo_75_75, DepConjKey_27, ThisConjKey_21, LambdaHeadVar__2_40, LambdaHeadVar__3_41);
    }
    else
...
{
  {
    ...
    else
    {
      ...
      else
      {
        ...
        Var_28 = (Index_19 + Num_20);
        LastScheduledGoal_22 = (Var_28 - (MR_Integer) 1);
  ...
  while (MR_TRUE)
  {
    /* tailcall optimized into a loop */
    {
      ...
      else
      {
        ...
        LastScheduledGoal_38 = (LastScheduledGoal0_34 + Num_36);
...
{
  {
    ...
    if (succeeded)
      ...
      else
      {
        ...
        if (succeeded)
        {
          MR_Integer Var_23 = (Var_86 + (MR_Integer) 1);
        ...
        {
          MR_Integer Var_27 = (Var_87 + (MR_Integer) 1);
...
{
  {
    ...
    if (succeeded)
    {
      ...
      else
      {
        ...
        NumIncompleteTests_7 = (Var_8 + Var_10);
    ...
    /* tailcall optimized into a loop */
    {
      ...
      if ((EqualBestSolns_19 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
      {
        ...
        if ((ParalleliseDepConjs_24 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
        {
          ...
          /* direct tailcall eliminated */
          {
            MR_Word next_value_of_Info_6 = UpdatedInfo_26;
  ...
  MR_Word * STATE_VARIABLE_Messages_26)
{
  {
    MR_bool succeeded;
    MR_Word TypeInfo_47_47 = (MR_Word) &mdprof_fb__automatic_parallelism__autopar_find_best_par_scalar_common_1[0];
    ...
    conv0_GoalsArray_10 = mercury__array__from_list_1_f_0(TypeInfo_47_47, Goals_6);
    GoalsArray_10 = (MR_ArrayPtr) conv0_GoalsArray_10;
    TypeCtorInfo_11_68 = (MR_Word) &mercury__builtin__builtin__type_ctor_info_int_0;
    Graph0_62 = mercury__digraph__init_0_f_0(TypeCtorInfo_11_68);
    Var_66 = mercury__map__init_0_f_0(TypeCtorInfo_11_68, TypeCtorInfo_11_68);
    ...
    Var_67 = mercury__digraph__tc_1_f_0(TypeCtorInfo_11_68, Graph_64);
    {
      ...
      case (MR_Integer) 0:
        {
          ...
          conv2_FirstCostlyGoal_21 = mercury__array__lookup_2_f_0(TypeInfo_47_47, (MR_ArrayPtr) GoalsArray_10, FirstCostlyGoalIndex_16);
  ...
  while (MR_TRUE)
  {
    /* tailcall optimized into a loop */
    {
      ...
      if (succeeded)
      {
        ...
        Var_16 = (Index_9 + (MR_Integer) 1);
        /* direct tailcall eliminated */
        {
          MR_Integer next_value_of_Index_9 = Var_16;
          MR_Word next_value_of_STATE_VARIABLE_Acc_0_13 = STATE_VARIABLE_Acc_15_15;
  ...
  MR_Word * STATE_VARIABLE_Graph_6)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      mercury__digraph__add_vertex_4_p_0(TypeCtorInfo_73_73, ((MR_Box) (HeadVar__2_2)), &ThisConjKey_21, STATE_VARIABLE_Graph_0_5, &STATE_VARIABLE_Graph_38_38);
      {
      ...
      Var_42 = mercury__set__to_sorted_list_1_f_0(TypeCtorInfo_73_73, RefedVars_20);
      mercury__list__foldl_4_p_0(TypeCtorInfo_73_73, (MR_Word) &mdprof_fb__automatic_parallelism__autopar_find_best_par_scalar_common_1[3], MaybeAddEdge_22, Var_42, ((MR_Box) (STATE_VARIABLE_Graph_38_38)), &conv1_STATE_VARIABLE_Graph_43_43);
      ...
      mercury__set__fold_4_p_0(TypeCtorInfo_73_73, (MR_Word) &mdprof_fb__automatic_parallelism__autopar_find_best_par_scalar_common_2[0], InsertForConjNum_29, InstVars_28, ((MR_Box) (STATE_VARIABLE_VarDepMap_0_3)), &conv3_STATE_VARIABLE_VarDepMap_47_47);
      STATE_VARIABLE_VarDepMap_47_47 = ((MR_Word) conv3_STATE_VARIABLE_VarDepMap_47_47);
      Var_48 = (HeadVar__2_2 + (MR_Integer) 1);
      /* direct tailcall eliminated */
      {
        MR_Word next_value_of_HeadVar__1_1 = PGs_15;
        MR_Integer next_value_of_HeadVar__2_2 = Var_48;
        MR_Word next_value_of_STATE_VARIABLE_VarDepMap_0_3 = STATE_VARIABLE_VarDepMap_47_47;
        MR_Word next_value_of_STATE_VARIABLE_Graph_0_5 = STATE_VARIABLE_Graph_43_43;
