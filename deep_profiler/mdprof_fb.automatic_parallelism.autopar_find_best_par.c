  ...
  MR_Word * STATE_VARIABLE_Messages_17)
{
  ...
  Var_23 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Info_7, (MR_Integer) 2))));
  Algorithm0_19 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_23, (MR_Integer) 12))));
  switch (MR_tag((MR_Word) Algorithm0_19)) {
    ...
    case (MR_Integer) 1:
      {
        MR_Integer BranchesLimit_20 = ((MR_Integer) ((MR_hl_field(MR_mktag(1), Algorithm0_19, (MR_Integer) 0))));
        MR_Word MaybeBranchesLimit_48;

        {
          MaybeBranchesLimit_48 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), MaybeBranchesLimit_48, 0) = ((MR_Box) (BranchesLimit_20));
        }
        {
          Algorithm_13 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), Algorithm_13, 0) = ((MR_Box) (MaybeBranchesLimit_48));
        }
      }
      break;
    case (MR_Integer) 2:
      {
        MR_Integer SizeLimit_22 = ((MR_Integer) ((MR_hl_field(MR_mktag(2), Algorithm0_19, (MR_Integer) 0))));
  ...
  Var_92 = mercury__digraph__tc_1_f_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0), Graph_89);
  {
    ...
    MR_hl_field(MR_mktag(0), DependencyGraphs_50, 0) = ((MR_Box) (Graph_89));
    MR_hl_field(MR_mktag(0), DependencyGraphs_50, 1) = ((MR_Box) (Var_92));
  }
  ...
  if (succeeded)
  {
    FirstCostlyGoalIndexPrime_52 = ((MR_Integer) ((MR_hl_field(MR_mktag(1), CostlyGoalsIndexes_51, (MR_Integer) 0))));
    OtherIndexes_53 = ((MR_Word) ((MR_hl_field(MR_mktag(1), CostlyGoalsIndexes_51, (MR_Integer) 1))));
    TypeCtorInfo_47_83 = (MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0);
    succeeded = mercury__list__last_2_p_0(TypeCtorInfo_47_83, OtherIndexes_53, &conv1_LastCostlyGoalIndexPrime_54);
    if (succeeded)
    {
    ...
    case (MR_Integer) 0:
      {
        ...
        Var_72 = ((MR_Word) ((MR_hl_field(MR_mktag(0), FirstCostlyGoal_60, (MR_Integer) 2))));
        Cost_61 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_72, (MR_Integer) 4))));
        NumCalls_62 = measurements__goal_cost_get_calls_1_f_0(Cost_61);
        {
          ...
          MR_hl_field(MR_mktag(0), GoalsForParallelisation_63, 0) = ((MR_Box) (GoalsArray_49));
          MR_hl_field(MR_mktag(0), GoalsForParallelisation_63, 1) = ((MR_Box) (FirstCostlyGoalIndex_55));
          MR_hl_field(MR_mktag(0), GoalsForParallelisation_63, 2) = ((MR_Box) (LastCostlyGoalIndex_56));
          MR_hl_field(MR_mktag(0), GoalsForParallelisation_63, 3) = ((MR_Box) (GoalGroups_59));
          MR_hl_field(MR_mktag(0), GoalsForParallelisation_63, 4) = ((MR_Box) (DependencyGraphs_50));
          MR_hl_field(MR_mktag(0), GoalsForParallelisation_63, 5) = ((MR_Box) (CostlyGoalsIndexes_51));
          MR_hl_field(MR_mktag(0), GoalsForParallelisation_63, 6) = ((MR_Box) (NumCalls_62));
        }
        {
          MaybePreprocessedGoals_14 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), MaybePreprocessedGoals_14, 0) = ((MR_Box) (GoalsForParallelisation_63));
        }
    ...
    case (MR_Integer) 1:
      {
        ...
        {
          Msg_64 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(3), Msg_64, 0) = ((MR_Box) ((MR_Unsigned) 3U));
          MR_hl_field(MR_mktag(3), Msg_64, 1) = (MR_Box) ((MR_Unsigned) (Detism_57));
        }
