...
{
  {
    ...
    if ((STATE_VARIABLE_GoalGroups_25_25 == (MR_Word) ((MR_Integer) 0)))
    {
      {
    ...
    mdprof_fb__automatic_parallelism__autopar_find_best_par__generate_parallelisations_loop_8_p_0(Info_5, Algorithm_6, STATE_VARIABLE_GoalGroups_27_27, STATE_VARIABLE_IncompleteParallelisation_30_30, (MR_Word) ((MR_Integer) 0), &STATE_VARIABLE_MaybeBestSolns_46_46, (MR_Word) (&mdprof_fb__automatic_parallelism__autopar_find_best_par_scalar_common_3[0]), &FinalProfile_9);
    if ((STATE_VARIABLE_MaybeBestSolns_46_46 == (MR_Word) ((MR_Integer) 0)))
      EqualBestSolns_8 = (MR_Word) ((MR_Integer) 0);
    else
...
{
  {
    ...
    succeeded = (ParalleliseDepConjs_16 == (MR_Word) ((MR_Integer) 0));
    if (succeeded)
    {
      succeeded = (IsDependent_17 == (MR_Word) ((MR_Integer) 0));
      succeeded = !(succeeded);
    }
    succeeded = !(succeeded);
    if (succeeded)
    {
      ...
      if ((MaybeCostData_47 == (MR_Word) ((MR_Integer) 0)))
      {
        {
      ...
      *MaybeCost_7 = (MR_Word) ((MR_Integer) 0);
  }
}
...
{
  {
    ...
    if (succeeded)
      if ((MaybeBestSolns_9 == (MR_Word) ((MR_Integer) 0)))
      {
        MR_Integer Var_31;
...
{
  {
    ...
    succeeded = (ParalleliseDepConjs_6 == (MR_Word) ((MR_Integer) 0));
    if (succeeded)
    {
      succeeded = (IsDependent_7 == (MR_Word) ((MR_Integer) 0));
      succeeded = !(succeeded);
    }
    succeeded = !(succeeded);
    return succeeded;
...
{
  {
    ...
    if ((MaybeBestSolns0_7 == (MR_Word) ((MR_Integer) 0)))
    {
      MR_Word Var_30;
      MR_Integer Var_33;
...
{
  {
    ...
    if ((MaybeCostData_5 == (MR_Word) ((MR_Integer) 0)))
    {
      mercury__require__unexpected_3_p_0((MR_String) "mdprof_fb.automatic_parallelism.autopar_find_best_par", (MR_String) "function \140mdprof_fb.automatic_parallelism.autopar_find_best_par.incomplete_parallelisation_cost\'/1", (MR_String) "incomplete parallelisation has no cost data");
    }
    else
...
{
  {
    ...
    if (succeeded)
    {
      ...
      if ((MaybeLimit_5 == (MR_Word) ((MR_Integer) 0)))
        succeeded = MR_TRUE;
      else
      {
...
{
  {
      ...
      case (MR_Integer) 0:
        switch (MR_unmkbody(Algorithm0_23)) {
          ...
          case (MR_Integer) 0:
            ...
            break;
          case (MR_Integer) 1:
            Algorithm_13 = (MR_Word) ((MR_Integer) 0);
            break;
        }
        break;
      case (MR_Integer) 1:
    ...
    if ((MaybePreprocessedGoals_14 == (MR_Word) ((MR_Integer) 0)))
      *MaybeBestParallelisation_10 = (MR_Word) ((MR_Integer) 0);
    else
    {
  ...
  MR_Word * MaybeBestParallelisation_10)
{
  while (MR_TRUE)
  {
    ...
    if ((EqualBestSolns_19 == (MR_Word) ((MR_Integer) 0)))
    {
      ...
      if ((ParalleliseDepConjs_24 == (MR_Word) ((MR_Integer) 0)))
      {
...
{
  {
    ...
    if ((MaybeCostData_7 == (MR_Word) ((MR_Integer) 0)))
    {
      {
...
{
  {
    ...
    else
    {
      ...
      if ((IsDependent0_7 == (MR_Word) ((MR_Integer) 0)))
      {
      ...
      case (MR_Integer) 0:
        {
          ...
          mdprof_fb__automatic_parallelism__autopar_find_best_par__foldl_sub_array__ho1_6_p_0(GoalsArray_10, FirstCostlyGoalIndex_16, LastCostlyGoalIndex_17, (MR_Word) ((MR_Integer) 0), &RevGoalGroups_19);
      ...
      case (MR_Integer) 1:
        {
          ...
          *MaybeGoalsForParallelisation_7 = (MR_Word) ((MR_Integer) 0);
          {
