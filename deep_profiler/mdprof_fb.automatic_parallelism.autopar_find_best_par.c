...
static /* final */ const MR_Box mdprof_fb__automatic_parallelism__autopar_find_best_par_scalar_common_1[11][2] = {
  ...
  {
    ((MR_Box) (&mercury__list__list__type_ctor_info_list_1)),
    ((MR_Box) (&mdprof_fb__automatic_parallelism__autopar_find_best_par_scalar_common_1[8]))
  },
  /* row 10 */
  {
...
{
  {
    ...
    else
    {
      ...
      else
      {
        ...
        mercury__builtin__compare_3_p_0((MR_Word) (&mdprof_fb__automatic_parallelism__autopar_find_best_par_scalar_common_1[10]), HeadVar__1_1, ((MR_Box) (Var_11)), ((MR_Box) (ArgY1_5)));
      }
    }
  }
}
...
{
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        TypeInfo_9_9 = (MR_Word) (&mdprof_fb__automatic_parallelism__autopar_find_best_par_scalar_common_1[10]);
...
{
  {
    ...
    else
    {
      ...
      mercury__builtin__compare_3_p_0((MR_Word) (&mdprof_fb__automatic_parallelism__autopar_find_best_par_scalar_common_1[7]), &SubResult1_6, ((MR_Box) (ArgX1_4)), ((MR_Box) (ArgY1_5)));
      ...
      else
      {
        ...
        mercury__builtin__compare_3_p_0((MR_Word) (&mdprof_fb__automatic_parallelism__autopar_find_best_par_scalar_common_1[9]), &SubResult2_9, ((MR_Box) (ArgX2_7)), ((MR_Box) (ArgY2_8)));
        ...
        else
        {
          ...
          mercury__builtin__compare_3_p_0((MR_Word) (&mdprof_fb__automatic_parallelism__autopar_find_best_par_scalar_common_1[7]), &SubResult3_12, ((MR_Box) (ArgX3_10)), ((MR_Box) (ArgY3_11)));
...
{
  {
    ...
    else
    {
      ...
      succeeded = mercury__builtin__unify_2_p_0((MR_Word) (&mdprof_fb__automatic_parallelism__autopar_find_best_par_scalar_common_1[7]), ((MR_Box) (ArgX1_3)), ((MR_Box) (ArgY1_4)));
      if (succeeded)
      {
        TypeInfo_16_16 = (MR_Word) (&mdprof_fb__automatic_parallelism__autopar_find_best_par_scalar_common_1[9]);
        succeeded = mercury__builtin__unify_2_p_0(TypeInfo_16_16, ((MR_Box) (ArgX2_5)), ((MR_Box) (ArgY2_6)));
        if (succeeded)
        {
          TypeInfo_17_17 = (MR_Word) (&mdprof_fb__automatic_parallelism__autopar_find_best_par_scalar_common_1[7]);
...
{
  {
    ...
    else
    {
      ...
      mercury__builtin__compare_3_p_0((MR_Word) (&mdprof_fb__automatic_parallelism__autopar_find_best_par_scalar_common_1[5]), &SubResult1_6, ((MR_Box) (ArgX1_4)), ((MR_Box) (ArgY1_5)));
      succeeded = (SubResult1_6 != (MR_Integer) 0);
      if (succeeded)
        *HeadVar__1_1 = SubResult1_6;
      else
          ...
          else
          {
            ...
            else
            {
              ...
              else
              {
                ...
                mercury__builtin__compare_3_p_0((MR_Word) (&mdprof_fb__automatic_parallelism__autopar_find_best_par_scalar_common_1[6]), &SubResult6_21, ((MR_Box) (ArgX6_19)), ((MR_Box) (ArgY6_20)));
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                TypeInfo_22_22 = (MR_Word) (&mdprof_fb__automatic_parallelism__autopar_find_best_par_scalar_common_1[6]);
...
{
  {
    ...
    else
    {
      ...
      else
      {
        ...
        if (((MR_tag((MR_Word) Var_66)) == (MR_Integer) 1))
        {
    ...
    mdprof_fb__automatic_parallelism__autopar_find_best_par__generate_parallelisations_loop_8_p_0(Info_5, Algorithm_6, STATE_VARIABLE_GoalGroups_27_27, STATE_VARIABLE_IncompleteParallelisation_30_30, (MR_Word) ((MR_Unsigned) 0U), &STATE_VARIABLE_MaybeBestSolns_46_46, (MR_Word) (&mdprof_fb__automatic_parallelism__autopar_find_best_par_scalar_common_3[0]), &FinalProfile_9);
    if ((STATE_VARIABLE_MaybeBestSolns_46_46 == (MR_Word) ((MR_Unsigned) 0U)))
          ...
          *MaybeGoalsForParallelisation_7 = (MR_Word) ((MR_Unsigned) 0U);
          {
            ...
            MR_hl_field(MR_mktag(3), Var_33, 1) = (MR_Box) ((MR_Unsigned) (Detism_18));
          }
