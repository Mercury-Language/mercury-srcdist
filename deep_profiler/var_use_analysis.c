          ...
          case (MR_Integer) 2:
            {
              ...
              }
              {
                ...
                MR_hl_field(MR_mktag(0), Var_83, 0) = ((MR_Box) (&var_use_analysis_scalar_common_9[1]));
                MR_hl_field(MR_mktag(0), Var_83, 1) = ((MR_Box) (var_use_analysis__goal_rec_prob_6_p_0_2));
                MR_hl_field(MR_mktag(0), Var_83, 2) = ((MR_Box) ((MR_Integer) 1));
                MR_hl_field(MR_mktag(0), Var_83, 3) = ((MR_Box) (Step_59));
              }
              mercury__list__filter_map_3_p_0((MR_Word) (&var_use_analysis_scalar_common_2[4]), (MR_Word) (&var_use_analysis_scalar_common_2[4]), Var_83, RecCalls_8, &SubGoalRecCalls_60);
