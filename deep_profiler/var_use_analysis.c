  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      else
      {
        ...
        MR_Word RecursionType_101 = ((MR_Word) ((MR_hl_field(0, RecursionReport_18, 1))));
          ...
          case (MR_Integer) 1:
            {
              ...
              else
              {
                ...
                MR_Word Var_70 = ((MR_Word) ((MR_hl_field(0, MaybeVarUseInfo0_84, 0))));
                MR_Word Var_73;

                UseTime0_65 = MR_unbox_float((MR_hl_field(0, Var_70, 0)));
                ProcTime0_66 = MR_unbox_float((MR_hl_field(0, Var_70, 1)));
                UseType_67 = ((MR_Unsigned) ((MR_hl_field(0, Var_70, 2))) & (MR_Integer) 3);
            ...
            case (MR_Integer) 2:
              {
                ...
                MR_Word SubGoal_135 = ((MR_Word) ((MR_hl_field(3, GoalExpr_12, 1))));
            ...
            case (MR_Integer) 2:
              {
                ...
                MR_Word SubGoal_116 = ((MR_Word) ((MR_hl_field(3, GoalExpr_12, 1))));
