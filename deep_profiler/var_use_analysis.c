...
MR_def_label(var_use_analysis__var_first_use_13_0,6)
	...
	MR_tfield(0, MR_r1, 2) = MR_tfield(0, MR_sv(12), 2);
	MR_decr_sp_and_return(13);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_thread_engine_base
...
MR_def_static(var_use_analysis__IntroducedFrom__pred__call_var_first_use__805__1_7_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_mkframe("pred var_use_analysis.IntroducedFrom__pred__call_var_first_use__805__1/7-0", 4,
