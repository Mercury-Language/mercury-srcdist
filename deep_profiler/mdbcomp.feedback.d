...
mdbcomp.feedback.s_date : feedback.m
	$(MCG) $(ALL_GRADEFLAGS) $(ALL_MCGFLAGS) --target-code-only mdbcomp.feedback $(ERR_REDIRECT)
mdbcomp.feedback.pic_s_date : feedback.m
	$(MCG) $(ALL_GRADEFLAGS) $(ALL_MCGFLAGS) --target-code-only --pic \
		--cflags "$(GCCFLAGS_FOR_PIC)" mdbcomp.feedback $(ERR_REDIRECT)
endif # TARGET_ASM
mdbcomp.feedback.il_date : feedback.m
	$(MCG) $(ALL_GRADEFLAGS) $(ALL_MCGFLAGS) --il-only mdbcomp.feedback $(ERR_REDIRECT)
