...
mdbcomp.trace_counts.module_dep : mdbcomp.trace_counts.java
  else
...
mdbcomp.trace_counts.s_date : trace_counts.m
	$(MCG) $(ALL_GRADEFLAGS) $(ALL_MCGFLAGS) --target-code-only trace_counts.m $(ERR_REDIRECT)
mdbcomp.trace_counts.pic_s_date : trace_counts.m
	$(MCG) $(ALL_GRADEFLAGS) $(ALL_MCGFLAGS) --target-code-only --pic \
		--cflags "$(GCCFLAGS_FOR_PIC)" trace_counts.m $(ERR_REDIRECT)
endif # TARGET_ASM
