  ...
  MR_Word * mdprof_test__HeadVar__2_2)
{
  {
    MR_bool mdprof_test__succeeded;
    MR_Integer mdprof_test__slot_0 = ((MR_hash_string5(mdprof_test__HeadVar__1_1)) & (MR_Integer) 63);
    MR_String mdprof_test__str_1 = ((&mdprof_test_vector_common_6[0 + mdprof_test__slot_0]))->mdprof_test__vector_common_type_6_0__vct_6_f_0;
