...
static void MR_CALL 
mdprof_test__verify_profile_6_p_0_1(
  MR_Box closure_arg,
  MR_Box wrapper_arg_1,
  MR_Box wrapper_arg_2,
...
static void MR_CALL 
mdprof_test__verify_profile_6_p_0(
  MR_Word ErrorStream_7,
  MR_String ProgName_8,
  MR_Word Args0_9,
  MR_Word Options_10);
...
static /* final */ const MR_Box mdprof_test_scalar_common_4[1][9];

static /* final */ const MR_Box mdprof_test_scalar_common_5[3][5];
...
static /* final */ const MR_Box mdprof_test_scalar_common_1[5][3] = {
  ...
  /* row 1 */
  {
    ((MR_Box) (&mdprof_test_scalar_common_5[0])),
    ((MR_Box) (main_2_p_0_1)),
    ((MR_Box) ((MR_Integer) 0))
  },
  /* row 2 */
  {
    ((MR_Box) (&mdprof_test_scalar_common_5[1])),
    ((MR_Box) (main_2_p_0_2)),
    ((MR_Box) ((MR_Integer) 0))
  },
  /* row 3 */
  {
    ((MR_Box) (&mdprof_test_scalar_common_5[2])),
    ((MR_Box) (main_2_p_0_4)),
    ((MR_Box) ((MR_Integer) 0))
  },
  /* row 4 */
    ...
    else
    {
      ...
      switch (Help_11) {
        ...
        case (MR_Integer) 0:
          ...
          break;
        case (MR_Integer) 1:
          mdprof_test__write_help_message_4_p_0(StdOut_8, ProgName_4);
          break;
      }
      switch (Version_12) {
        default: /*NOTREACHED*/ MR_assert(0);
        ...
        case (MR_Integer) 1:
          {
            ...
            mercury__io__write_string_4_p_0(StdOut_8, (MR_String) ": Mercury deep profiler\n");
            mercury__io__write_string_4_p_0(StdOut_8, (MR_String) "version: ");
            mercury__io__write_string_4_p_0(StdOut_8, Version_60);
            mercury__io__write_string_4_p_0(StdOut_8, (MR_String) ", on ");
            mercury__io__write_string_4_p_0(StdOut_8, Fullarch_61);
            mercury__io__write_string_4_p_0(StdOut_8, (MR_String) ".\n");
          }
          break;
      }
      ...
      if (succeeded)
        switch (Verify_13) {
          ...
          case (MR_Integer) 0:
            ...
            break;
          case (MR_Integer) 1:
            mdprof_test__verify_profile_6_p_0(StdErr_9, ProgName_4, Args_6, Options_10);
            break;
        }
    }
  }
...
{
  {
    ...
    if ((Args0_9 == (MR_Word) ((MR_Unsigned) 0U)))
      Args_12 = (MR_Word) (MR_mkword(MR_mktag(1), &mdprof_test_scalar_common_2[0]));
    else
      Args_12 = Args0_9;
    {
      Var_19 = (MR_Word) MR_new_object(MR_Word, (6 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), Var_19, 0) = ((MR_Box) (&mdprof_test_scalar_common_4[0]));
      MR_hl_field(MR_mktag(0), Var_19, 1) = ((MR_Box) (mdprof_test__verify_profile_6_p_0_1));
      MR_hl_field(MR_mktag(0), Var_19, 2) = ((MR_Box) ((MR_Integer) 3));
      MR_hl_field(MR_mktag(0), Var_19, 3) = ((MR_Box) (ErrorStream_7));
      MR_hl_field(MR_mktag(0), Var_19, 4) = ((MR_Box) (ProgName_8));
      MR_hl_field(MR_mktag(0), Var_19, 5) = ((MR_Box) (Options_10));
    }
    mercury__list__foldl_4_p_2((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&mercury__io__io__type_ctor_info_state_0), Var_19, Args_12, ((MR_Box) ((MR_Integer) 0)), &conv0_STATE_VARIABLE_IO_16);
  }
}
