...
#line 877 "mdprof_test.c"
static const MR_Integer mdprof_test__mdprof_test__functor_number_map_options_0[1] = {
  (MR_Integer) 0
};

#line 882 "mdprof_test.c"
