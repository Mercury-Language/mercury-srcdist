...
{
  {
    ...
    startup__read_and_startup_10_p_0((MR_String) "dummy_server", ScriptName_12, FileName_8, Canonical_10, (MR_Word) ((MR_Unsigned) 0U), (MR_Word) ((MR_Unsigned) 0U), Var_22, &Res_13);
    if (((MR_tag((MR_Word) Res_13)) == (MR_Integer) 1))
    {
...
{
  {
    ...
    {
      MR_Word Error_12 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MaybeOptions_7, (MR_Integer) 0))));
      MR_String Msg_13;

      Msg_13 = mercury__getopt__option_error_to_string_1_f_0((MR_Word) (&mdprof_test__mdprof_test__type_ctor_info_option_0), Error_12);
      mercury__io__set_exit_status_3_p_0((MR_Integer) 1);
      mercury__io__write_string_3_p_0(ProgName_4);
      mercury__io__write_string_3_p_0((MR_String) ": error parsing options: ");
      mercury__io__write_string_3_p_0(Msg_13);
      mercury__io__write_string_3_p_0((MR_String) "\n");
    }
    else
    {
        ...
        case (MR_Integer) 1:
          {
            ...
            mercury__io__write_string_3_p_0(Version_55);
            mercury__io__write_string_3_p_0((MR_String) ", on ");
            mercury__io__write_string_3_p_0(Fullarch_56);
            mercury__io__write_string_3_p_0((MR_String) ".\n");
          }
          break;
      }
          ...
          case (MR_Integer) 1:
            {
              MR_Word Args_84;
              MR_Word Var_89;
              MR_Box conv4_STATE_VARIABLE_IO_15;

              if ((Args_6 == (MR_Word) ((MR_Unsigned) 0U)))
                Args_84 = (MR_Word) (MR_mkword(MR_mktag(1), &mdprof_test_scalar_common_4[0]));
              else
                Args_84 = Args_6;
              {
                Var_89 = (MR_Word) MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL);
                MR_hl_field(MR_mktag(0), Var_89, 0) = ((MR_Box) (&mdprof_test_scalar_common_5[0]));
                MR_hl_field(MR_mktag(0), Var_89, 1) = ((MR_Box) (main_2_p_0_5));
                MR_hl_field(MR_mktag(0), Var_89, 2) = ((MR_Box) ((MR_Integer) 2));
                MR_hl_field(MR_mktag(0), Var_89, 3) = ((MR_Box) (ProgName_4));
                MR_hl_field(MR_mktag(0), Var_89, 4) = ((MR_Box) (Options_8));
              }
              mercury__list__foldl_4_p_2((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&mercury__io__io__type_ctor_info_state_0), Var_89, Args_84, ((MR_Box) ((MR_Integer) 0)), &conv4_STATE_VARIABLE_IO_15);
            }
            break;
        }
    }
...
{
  {
    ...
    if (succeeded)
    {
      ...
      switch (Verbose_12) {
        default: /*NOTREACHED*/ MR_assert(0);
        case (MR_Integer) 0:
          MaybeOutput_18 = (MR_Word) ((MR_Unsigned) 0U);
          break;
        case (MR_Integer) 1:
          {
            MR_Word Stdout_19;
            ...
            {
              MaybeOutput_18 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
      ...
      if (((MR_tag((MR_Word) StartupResult_20)) == (MR_Integer) 1))
      {
...
{
  {
    ...
    Var_48 = mercury__string__f_43_43_2_f_0((MR_String) "--recursion-types-histogram\n", (MR_String) "\t\t\tRun the recursion types histogram query\n");
    Var_46 = mercury__string__f_43_43_2_f_0((MR_String) "\t\t\tRun the procrep coverage query on every static procedure\n", Var_48);
    Var_44 = mercury__string__f_43_43_2_f_0((MR_String) "--procrep-coverage\n", Var_46);
    Var_42 = mercury__string__f_43_43_2_f_0((MR_String) "\t\t\tDon\'t compress the resulting files, this speeds the test.\n", Var_44);
    Var_40 = mercury__string__f_43_43_2_f_0((MR_String) "--no-compress\n", Var_42);
    Var_38 = mercury__string__f_43_43_2_f_0((MR_String) "\t\t\tPut the generated web pages into <dirname>.\n", Var_40);
    Var_36 = mercury__string__f_43_43_2_f_0((MR_String) "--test-dir <dirname>\n", Var_38);
    Var_34 = mercury__string__f_43_43_2_f_0((MR_String) "You may also specify the following options:.\n", Var_36);
    Var_32 = mercury__string__f_43_43_2_f_0((MR_String) "\n", Var_34);
    Var_30 = mercury__string__f_43_43_2_f_0((MR_String) "\t\t\tdata file.\n", Var_32);
    Var_28 = mercury__string__f_43_43_2_f_0((MR_String) "\t\t\tVerify that <filename> is a well-formed deep profiling\n", Var_30);
    Var_26 = mercury__string__f_43_43_2_f_0((MR_String) "--verify-profile\n", Var_28);
    Var_24 = mercury__string__f_43_43_2_f_0((MR_String) "\t\t\tpossible web pages of the popular types.\n", Var_26);
    Var_22 = mercury__string__f_43_43_2_f_0((MR_String) "--test      Test the deep profiler, generating all\n", Var_24);
    Var_20 = mercury__string__f_43_43_2_f_0((MR_String) "--verbose   Generate progress messages during startup.\n", Var_22);
    Var_18 = mercury__string__f_43_43_2_f_0((MR_String) "--version   Report the program\'s version number.\n", Var_20);
    Var_16 = mercury__string__f_43_43_2_f_0((MR_String) "--help      Generate this help message.\n", Var_18);
    Var_14 = mercury__string__f_43_43_2_f_0((MR_String) "You should specify one of the following options:\n", Var_16);
    Var_12 = mercury__string__f_43_43_2_f_0((MR_String) "<filename> must name a deep profiling data file.\n", Var_14);
