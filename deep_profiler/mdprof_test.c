...
static void MR_CALL 
mdprof_test__test_cliques_7_p_0(
  MR_Integer Cur_8,
  MR_Integer Max_9,
  MR_Word Options_10,
  MR_Word Pref_11,
  ...
  while (MR_TRUE)
  {
    ...
    if (succeeded)
    {
...

      {
        ...
        MR_hl_field(3, Var_17, 0) = ((MR_Box) ((MR_Unsigned) 2U));
        MR_hl_field(3, Var_17, 1) = ((MR_Box) (Var_18));
      }
      query__try_exec_4_p_0(Var_17, Pref_11, Deep_12, &HTML_14);
      mdprof_test__write_test_html_6_p_0(Options_10, (MR_String) "proc", Cur_8, HTML_14);
  ...
  MR_Word Deep_12)
{
  while (MR_TRUE)
  {
    ...
    if (succeeded)
    {
      ...
      query__try_exec_4_p_0(Var_17, Pref_11, Deep_12, &HTML_14);
      mdprof_test__write_test_html_6_p_0(Options_10, (MR_String) "clique", Cur_8, HTML_14);
      Var_21 = (MR_Integer) ((MR_Unsigned) Cur_8 + (MR_Unsigned) 1);
      // direct tailcall eliminated
      ;
      next_value_of_Cur_8 = Var_21;
  ...
  MR_String FileName_10)
{
  ...
  {
    MR_String Error_17 = ((MR_String) ((MR_hl_field(1, Res_15, 0))));
  ...
  MR_Box * wrapper_arg_3)
{
  ...
  mdprof_test__verify_profile_2_6_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_String) ((MR_hl_field(0, closure, 4)))), ((MR_Word) ((MR_hl_field(0, closure, 5)))), ((MR_String) (wrapper_arg_1)));
}
...
main_2_p_0(void)
{
  ...
  {
    MR_Word Error_14 = ((MR_Word) ((MR_hl_field(1, MaybeOptions_7, 0))));
    MR_String Msg_15;
  ...
  {
    MR_Word Options_10 = ((MR_Word) ((MR_hl_field(0, MaybeOptions_7, 0))));
    MR_Word Help_11;
    MR_Word Version_12;
    MR_Word Verify_13;
  ...
  MR_Word Options_10)
{
  ...
  if (succeeded)
  {
    FileName_12 = ((MR_String) ((MR_hl_field(1, Args_9, 0))));
    Var_28 = ((MR_Word) ((MR_hl_field(1, Args_9, 1))));
  ...
  if (succeeded)
  {
    ...
    {
      MR_String Error_25 = ((MR_String) ((MR_hl_field(1, StartupResult_22, 0))));
    ...
    {
      MR_Word Deep_23 = ((MR_Word) ((MR_hl_field(0, StartupResult_22, 0))));
      MR_Word Test_24;
    ...
    case (MR_Integer) 1:
      {
        ...
        MR_ArrayPtr Var_29 = ((MR_ArrayPtr) ((MR_hl_field(0, Deep_7, 8))));
    ...
    case (MR_Integer) 1:
      {
        ...
        MR_ArrayPtr Var_33 = ((MR_ArrayPtr) ((MR_hl_field(0, Deep_7, 6))));
  ...
  MR_String HTML_10)
{
  ...
  {
    MR_Word Err_23 = ((MR_Word) ((MR_hl_field(1, Res_18, 0))));
    MR_String ErrMsg_24;
  ...
  {
    MR_Word Stream_19 = ((MR_Word) ((MR_hl_field(0, Res_18, 0))));
    MR_Word Compress_20;
