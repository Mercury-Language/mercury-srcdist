...
static /* final */ const struct mdprof_test__vector_common_type_7_0_s mdprof_test_vector_common_7[13] = {
  ...
  {
    (MR_Integer) 0,
    (MR_Word) (MR_mkword(MR_mktag(1), &mdprof_test_scalar_common_3[1]))
  },
  /* row   1 */
  {
    (MR_Integer) 3,
  ...
  {
    (MR_Integer) 1,
    (MR_Word) (MR_mkword(MR_mktag(3), &mdprof_test_scalar_common_2[1]))
  },
  /* row   3 */
  {
    (MR_Integer) 2,
  ...
  {
    (MR_Integer) 6,
    (MR_Word) (MR_mkword(MR_mktag(3), &mdprof_test_scalar_common_2[2]))
  },
  /* row   7 */
  {
    (MR_Integer) 7,
  ...
  MR_String FileName_10)
{
  ...
  {
    MR_String Error_17 = ((MR_String) ((MR_hl_field(MR_mktag(1), Res_15, (MR_Integer) 0))));
  ...
  MR_Box * wrapper_arg_3)
{
  ...
  mdprof_test__verify_profile_2_6_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_String) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 5)))), ((MR_String) (wrapper_arg_1)));
}
...
main_2_p_0(void)
{
  ...
  {
    MR_Word Error_14 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MaybeOptions_7, (MR_Integer) 0))));
    MR_String Msg_15;
      ...
      case (MR_Integer) 1:
        {
          ...
          Var_96 = mercury__string__f_43_43_2_f_0((MR_String) "--recursion-types-histogram\n", (MR_String) "\t\t\tRun the recursion types histogram query\n");
          Var_94 = mercury__string__f_43_43_2_f_0((MR_String) "\t\t\tRun the procrep coverage query on every static procedure\n", Var_96);
          Var_92 = mercury__string__f_43_43_2_f_0((MR_String) "--procrep-coverage\n", Var_94);
          Var_90 = mercury__string__f_43_43_2_f_0((MR_String) "\t\t\tDon\'t compress the resulting files, this speeds the test.\n", Var_92);
          Var_88 = mercury__string__f_43_43_2_f_0((MR_String) "--no-compress\n", Var_90);
          Var_86 = mercury__string__f_43_43_2_f_0((MR_String) "\t\t\tPut the generated web pages into <dirname>.\n", Var_88);
          Var_84 = mercury__string__f_43_43_2_f_0((MR_String) "--test-dir <dirname>\n", Var_86);
          Var_82 = mercury__string__f_43_43_2_f_0((MR_String) "You may also specify the following options:.\n", Var_84);
          Var_80 = mercury__string__f_43_43_2_f_0((MR_String) "\n", Var_82);
          Var_78 = mercury__string__f_43_43_2_f_0((MR_String) "\t\t\tdata file.\n", Var_80);
          Var_76 = mercury__string__f_43_43_2_f_0((MR_String) "\t\t\tVerify that <filename> is a well-formed deep profiling\n", Var_78);
          Var_74 = mercury__string__f_43_43_2_f_0((MR_String) "--verify-profile\n", Var_76);
          Var_72 = mercury__string__f_43_43_2_f_0((MR_String) "\t\t\tpossible web pages of the popular types.\n", Var_74);
          Var_70 = mercury__string__f_43_43_2_f_0((MR_String) "--test      Test the deep profiler, generating all\n", Var_72);
          Var_68 = mercury__string__f_43_43_2_f_0((MR_String) "--verbose   Generate progress messages during startup.\n", Var_70);
          Var_66 = mercury__string__f_43_43_2_f_0((MR_String) "--version   Report the program\'s version number.\n", Var_68);
          Var_64 = mercury__string__f_43_43_2_f_0((MR_String) "--help      Generate this help message.\n", Var_66);
          Var_62 = mercury__string__f_43_43_2_f_0((MR_String) "You should specify one of the following options:\n", Var_64);
          Var_60 = mercury__string__f_43_43_2_f_0((MR_String) "<filename> must name a deep profiling data file.\n", Var_62);
          mercury__io__write_string_4_p_0(StdOut_8, Var_60);
        }
        break;
    }
    switch (Version_12) {
        ...
        case (MR_Integer) 1:
          {
            ...
            if ((Args_6 == (MR_Word) ((MR_Unsigned) 0U)))
              Args_103 = (MR_Word) (MR_mkword(MR_mktag(1), &mdprof_test_scalar_common_2[0]));
            else
              Args_103 = Args_6;
            {
              Var_104 = (MR_Word) MR_new_object(MR_Word, (6 * sizeof(MR_Word)), NULL, NULL);
              MR_hl_field(MR_mktag(0), Var_104, 0) = ((MR_Box) (&mdprof_test_scalar_common_5[0]));
              MR_hl_field(MR_mktag(0), Var_104, 1) = ((MR_Box) (main_2_p_0_5));
              MR_hl_field(MR_mktag(0), Var_104, 2) = ((MR_Box) ((MR_Integer) 3));
              MR_hl_field(MR_mktag(0), Var_104, 3) = ((MR_Box) (StdErr_9));
              MR_hl_field(MR_mktag(0), Var_104, 4) = ((MR_Box) (ProgName_4));
              MR_hl_field(MR_mktag(0), Var_104, 5) = ((MR_Box) (Options_10));
            }
  ...
  MR_Word Options_10)
{
  ...
  if (succeeded)
  {
    FileName_12 = ((MR_String) ((MR_hl_field(MR_mktag(1), Args_9, (MR_Integer) 0))));
  ...
  if (succeeded)
  {
      ...
      case (MR_Integer) 1:
        {
          ...
          {
            MaybeOutput_20 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), MaybeOutput_20, 0) = ((MR_Box) (Stdout_21));
          }
        }
        break;
    }
    ...
    {
      MR_String Error_25 = ((MR_String) ((MR_hl_field(MR_mktag(1), StartupResult_22, (MR_Integer) 0))));
    ...
    {
      MR_Word Deep_23 = ((MR_Word) ((MR_hl_field(MR_mktag(0), StartupResult_22, (MR_Integer) 0))));
      MR_Word Test_24;
        ...
        case (MR_Integer) 1:
          {
            ...
            Var_49 = query__default_preferences_1_f_0(Deep_23);
            mdprof_test__test_server_5_p_0(Var_49, Deep_23, Options_10);
          }
          break;
      }
    }
  ...
  MR_Word Options_8)
{
  ...
  Var_100 = mercury__string__f_43_43_2_f_0((MR_String) " || mkdir -p ", DirName_10);
  Var_101 = mercury__string__f_43_43_2_f_0(DirName_10, Var_100);
  Cmd_11 = mercury__string__f_43_43_2_f_0((MR_String) "test -d ", Var_101);
  ...
  MR_String HTML_10)
{
  ...
  mercury__string__format__format_signed_int_component_width_noprec_4_p_0((MR_Word) (&mdprof_test_scalar_common_3[0]), (MR_Integer) 4, Bunch_12, &Var_68);
  ...
  mercury__string__format__format_signed_int_component_width_noprec_4_p_0((MR_Word) (&mdprof_test_scalar_common_3[0]), (MR_Integer) 6, Num_9, &Var_86);
  ...
  MR_String ProgName_6)
{
  ...
  Var_52 = mercury__string__f_43_43_2_f_0((MR_String) "--recursion-types-histogram\n", (MR_String) "\t\t\tRun the recursion types histogram query\n");
  Var_50 = mercury__string__f_43_43_2_f_0((MR_String) "\t\t\tRun the procrep coverage query on every static procedure\n", Var_52);
  Var_48 = mercury__string__f_43_43_2_f_0((MR_String) "--procrep-coverage\n", Var_50);
  Var_46 = mercury__string__f_43_43_2_f_0((MR_String) "\t\t\tDon\'t compress the resulting files, this speeds the test.\n", Var_48);
  Var_44 = mercury__string__f_43_43_2_f_0((MR_String) "--no-compress\n", Var_46);
  Var_42 = mercury__string__f_43_43_2_f_0((MR_String) "\t\t\tPut the generated web pages into <dirname>.\n", Var_44);
  Var_40 = mercury__string__f_43_43_2_f_0((MR_String) "--test-dir <dirname>\n", Var_42);
  Var_38 = mercury__string__f_43_43_2_f_0((MR_String) "You may also specify the following options:.\n", Var_40);
  Var_36 = mercury__string__f_43_43_2_f_0((MR_String) "\n", Var_38);
  Var_34 = mercury__string__f_43_43_2_f_0((MR_String) "\t\t\tdata file.\n", Var_36);
  Var_32 = mercury__string__f_43_43_2_f_0((MR_String) "\t\t\tVerify that <filename> is a well-formed deep profiling\n", Var_34);
  Var_30 = mercury__string__f_43_43_2_f_0((MR_String) "--verify-profile\n", Var_32);
  Var_28 = mercury__string__f_43_43_2_f_0((MR_String) "\t\t\tpossible web pages of the popular types.\n", Var_30);
  Var_26 = mercury__string__f_43_43_2_f_0((MR_String) "--test      Test the deep profiler, generating all\n", Var_28);
  Var_24 = mercury__string__f_43_43_2_f_0((MR_String) "--verbose   Generate progress messages during startup.\n", Var_26);
  Var_22 = mercury__string__f_43_43_2_f_0((MR_String) "--version   Report the program\'s version number.\n", Var_24);
  Var_20 = mercury__string__f_43_43_2_f_0((MR_String) "--help      Generate this help message.\n", Var_22);
  Var_18 = mercury__string__f_43_43_2_f_0((MR_String) "You should specify one of the following options:\n", Var_20);
  Var_15 = mercury__string__f_43_43_2_f_0((MR_String) "<filename> must name a deep profiling data file.\n", Var_18);
  mercury__io__write_string_4_p_0(OutputStream_5, Var_15);
}
