      ...
      case (MR_Integer) 1:
        {
          ...
          Var_94 = mercury__string__f_43_43_2_f_0((MR_String) "--recursion-types-histogram\n", (MR_String) "\t\t\tRun the recursion types histogram query\n");
          Var_92 = mercury__string__f_43_43_2_f_0((MR_String) "\t\t\tRun the procrep coverage query on every static procedure\n", Var_94);
          Var_90 = mercury__string__f_43_43_2_f_0((MR_String) "--procrep-coverage\n", Var_92);
          Var_88 = mercury__string__f_43_43_2_f_0((MR_String) "\t\t\tDon\'t compress the resulting files, this speeds the test.\n", Var_90);
          Var_86 = mercury__string__f_43_43_2_f_0((MR_String) "--no-compress\n", Var_88);
          Var_84 = mercury__string__f_43_43_2_f_0((MR_String) "\t\t\tPut the generated web pages into <dirname>.\n", Var_86);
          Var_82 = mercury__string__f_43_43_2_f_0((MR_String) "--test-dir <dirname>\n", Var_84);
          Var_80 = mercury__string__f_43_43_2_f_0((MR_String) "You may also specify the following options:.\n", Var_82);
          Var_78 = mercury__string__f_43_43_2_f_0((MR_String) "\n", Var_80);
          Var_76 = mercury__string__f_43_43_2_f_0((MR_String) "\t\t\tdata file.\n", Var_78);
          Var_74 = mercury__string__f_43_43_2_f_0((MR_String) "\t\t\tVerify that <filename> is a well-formed deep profiling\n", Var_76);
          Var_72 = mercury__string__f_43_43_2_f_0((MR_String) "--verify-profile\n", Var_74);
          Var_70 = mercury__string__f_43_43_2_f_0((MR_String) "\t\t\tpossible web pages of the popular types.\n", Var_72);
          Var_68 = mercury__string__f_43_43_2_f_0((MR_String) "--test      Test the deep profiler, generating all\n", Var_70);
          Var_66 = mercury__string__f_43_43_2_f_0((MR_String) "--verbose   Generate progress messages during startup.\n", Var_68);
          Var_64 = mercury__string__f_43_43_2_f_0((MR_String) "--version   Report the program\'s version number.\n", Var_66);
          Var_62 = mercury__string__f_43_43_2_f_0((MR_String) "--help      Generate this help message.\n", Var_64);
          Var_60 = mercury__string__f_43_43_2_f_0((MR_String) "You should specify one of the following options:\n", Var_62);
          Var_58 = mercury__string__f_43_43_2_f_0((MR_String) "<filename> must name a deep profiling data file.\n", Var_60);
          mercury__io__write_string_4_p_0(StdOut_8, Var_58);
        }
        break;
    }
    switch (Version_12) {
        ...
        case (MR_Integer) 1:
          {
            ...
            if ((Args_6 == (MR_Word) ((MR_Unsigned) 0U)))
              Args_101 = (MR_Word) (MR_mkword(MR_mktag(1), &mdprof_test_scalar_common_2[0]));
            else
              Args_101 = Args_6;
            {
              Var_102 = (MR_Word) MR_new_object(MR_Word, (6 * sizeof(MR_Word)), NULL, NULL);
              MR_hl_field(MR_mktag(0), Var_102, 0) = ((MR_Box) (&mdprof_test_scalar_common_5[0]));
              MR_hl_field(MR_mktag(0), Var_102, 1) = ((MR_Box) (main_2_p_0_5));
              MR_hl_field(MR_mktag(0), Var_102, 2) = ((MR_Box) ((MR_Integer) 3));
              MR_hl_field(MR_mktag(0), Var_102, 3) = ((MR_Box) (StdErr_9));
              MR_hl_field(MR_mktag(0), Var_102, 4) = ((MR_Box) (ProgName_4));
              MR_hl_field(MR_mktag(0), Var_102, 5) = ((MR_Box) (Options_10));
            }
            mercury__list__foldl_4_p_2((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&mercury__io__io__type_ctor_info_state_0), Var_102, Args_101, ((MR_Box) ((MR_Integer) 0)), &conv4_STATE_VARIABLE_IO_17);
          }
          break;
      }
  }
