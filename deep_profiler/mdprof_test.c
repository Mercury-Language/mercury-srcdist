...
{
  {
    ...
    succeeded = mdprof_test__f_85_110_117_115_101_100_65_114_103_115_95_95_112_114_101_100_95_95_95_95_85_110_105_102_121_95_95_95_109_100_112_114_111_102_95_116_101_115_116_95_95_111_112_116_105_111_110_115_95_48_95_95_91_49_44_32_50_93_95_48_2_p_0();
    return succeeded;
  }
}
...
{
  {
    MR_Word Canonical_10;
    MR_String ScriptName_12;
    MR_Word Res_13;
    MR_Word Var_22;

    mercury__getopt__lookup_bool_option_3_p_0((MR_Word) &mdprof_test__mdprof_test__type_ctor_info_option_0, Options_7, ((MR_Box) ((MR_Integer) 0)), &Canonical_10);
    conf__script_name_3_p_0(&ScriptName_12);
    Var_22 = dump__default_dump_options_0_f_0();
    startup__read_and_startup_10_p_0((MR_String) "dummy_server", ScriptName_12, FileName_8, Canonical_10, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), Var_22, &Res_13);
    if (((MR_tag((MR_Word) Res_13)) == (MR_mktag((MR_Integer) 1))))
    {
      MR_String Error_15 = ((MR_String) (MR_hl_field(MR_mktag(1), Res_13, (MR_Integer) 0)));
      ...
      mercury__io__write_string_3_p_0(Error_15);
      mercury__io__write_string_3_p_0((MR_String) "\n");
    }
    else
    {
...
{
  {
    ...
    mdprof_test__verify_profile_2_5_p_0(((MR_String) (MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3))), ((MR_Word) (MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4))), ((MR_String) wrapper_arg_1));
  }
}
...
{
  {
    ...
    TypeCtorInfo_44_44 = (MR_Word) &mdprof_test__mdprof_test__type_ctor_info_option_0;
    mercury__getopt__process_options_4_p_0(TypeCtorInfo_44_44, (MR_Word) MR_mkword(MR_mktag(2), &mdprof_test_scalar_common_1[4]), Args0_5, &Args_6, &MaybeOptions_7);
    if (((MR_tag((MR_Word) MaybeOptions_7)) == (MR_mktag((MR_Integer) 1))))
    {
      MR_String Msg_12 = ((MR_String) (MR_hl_field(MR_mktag(1), MaybeOptions_7, (MR_Integer) 0)));
    ...
    {
      MR_Word Options_8 = ((MR_Word) (MR_hl_field(MR_mktag(0), MaybeOptions_7, (MR_Integer) 0)));
      MR_Word Help_9;
      MR_Word Version_10;
      MR_Word Verify_11;

      mercury__getopt__lookup_bool_option_3_p_0(TypeCtorInfo_44_44, Options_8, ((MR_Box) ((MR_Integer) 4)), &Help_9);
      mercury__getopt__lookup_bool_option_3_p_0(TypeCtorInfo_44_44, Options_8, ((MR_Box) ((MR_Integer) 8)), &Version_10);
      mercury__getopt__lookup_bool_option_3_p_0(TypeCtorInfo_44_44, Options_8, ((MR_Box) ((MR_Integer) 9)), &Verify_11);
      switch (Help_9) {
        ...
        case (MR_Integer) 0:
          ...
          break;
        case (MR_Integer) 1:
          mdprof_test__write_help_message_3_p_0(ProgName_4);
          break;
      }
      switch (Version_10) {
        default: /*NOTREACHED*/ MR_assert(0);
        ...
        case (MR_Integer) 1:
          {
            ...
            mercury__io__write_string_3_p_0(Version_54);
            mercury__io__write_string_3_p_0((MR_String) ", on ");
            mercury__io__write_string_3_p_0(Fullarch_55);
            mercury__io__write_string_3_p_0((MR_String) ".\n");
          }
          break;
      }
      succeeded = (Help_9 == (MR_Integer) 0);
      if (succeeded)
        succeeded = (Version_10 == (MR_Integer) 0);
      if (succeeded)
        switch (Verify_11) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 0:
            mdprof_test__main2_5_p_0(ProgName_4, Args_6, Options_8);
            break;
          case (MR_Integer) 1:
            {
              MR_Word Args_83;
              ...
              {
                Args_83 = (MR_Word) MR_mkword(MR_mktag(1), &mdprof_test_scalar_common_4[0]);
              }
              else
                Args_83 = Args_6;
              {
                Var_88 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 5 * sizeof(MR_Word)), NULL, NULL);
                MR_hl_field(MR_mktag(0), Var_88, 0) = ((MR_Box) (&mdprof_test_scalar_common_5[0]));
                MR_hl_field(MR_mktag(0), Var_88, 1) = ((MR_Box) (main_2_p_0_5));
                MR_hl_field(MR_mktag(0), Var_88, 2) = ((MR_Box) (MR_Word) ((MR_Integer) 2));
                MR_hl_field(MR_mktag(0), Var_88, 3) = ((MR_Box) (ProgName_4));
                MR_hl_field(MR_mktag(0), Var_88, 4) = ((MR_Box) (Options_8));
              }
              mercury__list__foldl_4_p_2((MR_Word) &mercury__builtin__builtin__type_ctor_info_string_0, (MR_Word) &mercury__io__io__type_ctor_info_state_0, Var_88, Args_83, ((MR_Box) ((MR_Integer) 0)), &conv4_STATE_VARIABLE_IO_14);
            }
            break;
        }
      else
...
{
  {
    ...
    if (succeeded)
    {
      FileName_10 = ((MR_String) (MR_hl_field(MR_mktag(1), Args_7, (MR_Integer) 0)));
      Var_26 = ((MR_Word) (MR_hl_field(MR_mktag(1), Args_7, (MR_Integer) 1)));
      succeeded = (Var_26 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
    }
    if (succeeded)
    {
      MR_Word TypeCtorInfo_52_52 = (MR_Word) &mdprof_test__mdprof_test__type_ctor_info_option_0;
      MR_Word Canonical_11;
      MR_Word Verbose_12;
      MR_Word DumpStages_13;
      MR_Word DumpArrayOptionsStr_14;
      MR_Word DumpOptions_15;
      MR_String Machine_16;
      MR_String ScriptName_17;
      MR_Word MaybeOutput_18;
      MR_Word StartupResult_20;

      mercury__getopt__lookup_bool_option_3_p_0(TypeCtorInfo_52_52, Options_8, ((MR_Box) ((MR_Integer) 0)), &Canonical_11);
      mercury__getopt__lookup_bool_option_3_p_0(TypeCtorInfo_52_52, Options_8, ((MR_Box) ((MR_Integer) 7)), &Verbose_12);
      mercury__getopt__lookup_accumulating_option_3_p_0(TypeCtorInfo_52_52, Options_8, ((MR_Box) ((MR_Integer) 1)), &DumpStages_13);
      mercury__getopt__lookup_accumulating_option_3_p_0(TypeCtorInfo_52_52, Options_8, ((MR_Box) ((MR_Integer) 2)), &DumpArrayOptionsStr_14);
      dump__dump_array_options_to_dump_options_2_p_0(DumpArrayOptionsStr_14, &DumpOptions_15);
      conf__server_name_port_3_p_0(&Machine_16);
      conf__script_name_3_p_0(&ScriptName_17);
      switch (Verbose_12) {
        default: /*NOTREACHED*/ MR_assert(0);
        case (MR_Integer) 0:
          MaybeOutput_18 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
          break;
        case (MR_Integer) 1:
          {
            MR_Word Stdout_19;
            ...
            {
              MaybeOutput_18 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), MaybeOutput_18, 0) = ((MR_Box) (Stdout_19));
            }
          }
          break;
      }
      startup__read_and_startup_10_p_0(Machine_16, ScriptName_17, FileName_10, Canonical_11, MaybeOutput_18, DumpStages_13, DumpOptions_15, &StartupResult_20);
      if (((MR_tag((MR_Word) StartupResult_20)) == (MR_mktag((MR_Integer) 1))))
      {
        MR_String Error_23 = ((MR_String) (MR_hl_field(MR_mktag(1), StartupResult_20, (MR_Integer) 0)));
        ...
        mercury__io__write_string_3_p_0((MR_String) ": ");
        mercury__io__write_string_3_p_0(Error_23);
        mercury__io__write_string_3_p_0((MR_String) "\n");
      }
      else
      {
        MR_Word Deep_21 = ((MR_Word) (MR_hl_field(MR_mktag(0), StartupResult_20, (MR_Integer) 0)));
        MR_Word Test_22;

        mercury__getopt__lookup_bool_option_3_p_0(TypeCtorInfo_52_52, Options_8, ((MR_Box) ((MR_Integer) 5)), &Test_22);
        switch (Test_22) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 0:
            {
          ...
          case (MR_Integer) 1:
            {
              ...
              Var_47 = query__default_preferences_1_f_0(Deep_21);
              mdprof_test__test_server_5_p_0(Var_47, Deep_21, Options_8);
            }
            break;
        }
      }
    ...
    {
      mercury__io__set_exit_status_3_p_0((MR_Integer) 1);
      mdprof_test__write_help_message_3_p_0(ProgName_6);
    }
  }
}
...
{
  {
    MR_Word TypeCtorInfo_94_94 = (MR_Word) &mdprof_test__mdprof_test__type_ctor_info_option_0;
    ...
    mercury__getopt__lookup_string_option_3_p_0(TypeCtorInfo_94_94, Options_8, ((MR_Box) ((MR_Integer) 6)), &DirName_10);
    Var_98 = mercury__string__f_43_43_2_f_0((MR_String) " || mkdir -p ", DirName_10);
    Var_99 = mercury__string__f_43_43_2_f_0(DirName_10, Var_98);
    Cmd_11 = mercury__string__f_43_43_2_f_0((MR_String) "test -d ", Var_99);
    mercury__io__call_system_4_p_0(Cmd_11, &Var_12);
    mercury__getopt__lookup_bool_option_3_p_0(TypeCtorInfo_94_94, Options_8, ((MR_Box) ((MR_Integer) 10)), &StaticProcrepCoverage_13);
      ...
      case (MR_Integer) 1:
        {
          ...
          MR_ArrayPtr Var_29 = ((MR_ArrayPtr) (MR_hl_field(MR_mktag(0), Deep_7, (MR_Integer) 8)));
          MR_Word Var_38 = ((MR_Word) (MR_hl_field(MR_mktag(0), Deep_7, (MR_Integer) 0)));
          MR_String Var_39 = ((MR_String) (MR_hl_field(MR_mktag(0), Deep_7, (MR_Integer) 1)));
          MR_String Var_40 = ((MR_String) (MR_hl_field(MR_mktag(0), Deep_7, (MR_Integer) 2)));
          MR_String Var_41 = ((MR_String) (MR_hl_field(MR_mktag(0), Deep_7, (MR_Integer) 3)));
          MR_Word Var_42 = ((MR_Word) (MR_hl_field(MR_mktag(0), Deep_7, (MR_Integer) 4)));
          MR_ArrayPtr Var_43 = ((MR_ArrayPtr) (MR_hl_field(MR_mktag(0), Deep_7, (MR_Integer) 5)));
          MR_ArrayPtr Var_44 = ((MR_ArrayPtr) (MR_hl_field(MR_mktag(0), Deep_7, (MR_Integer) 6)));
          MR_ArrayPtr Var_45 = ((MR_ArrayPtr) (MR_hl_field(MR_mktag(0), Deep_7, (MR_Integer) 7)));
          MR_ArrayPtr Var_46 = ((MR_ArrayPtr) (MR_hl_field(MR_mktag(0), Deep_7, (MR_Integer) 9)));
          MR_ArrayPtr Var_47 = ((MR_ArrayPtr) (MR_hl_field(MR_mktag(0), Deep_7, (MR_Integer) 10)));
          MR_ArrayPtr Var_48 = ((MR_ArrayPtr) (MR_hl_field(MR_mktag(0), Deep_7, (MR_Integer) 11)));
          MR_ArrayPtr Var_49 = ((MR_ArrayPtr) (MR_hl_field(MR_mktag(0), Deep_7, (MR_Integer) 12)));
          MR_ArrayPtr Var_50 = ((MR_ArrayPtr) (MR_hl_field(MR_mktag(0), Deep_7, (MR_Integer) 13)));
          MR_ArrayPtr Var_51 = ((MR_ArrayPtr) (MR_hl_field(MR_mktag(0), Deep_7, (MR_Integer) 14)));
          MR_ArrayPtr Var_52 = ((MR_ArrayPtr) (MR_hl_field(MR_mktag(0), Deep_7, (MR_Integer) 15)));
          MR_ArrayPtr Var_53 = ((MR_ArrayPtr) (MR_hl_field(MR_mktag(0), Deep_7, (MR_Integer) 16)));
          MR_ArrayPtr Var_54 = ((MR_ArrayPtr) (MR_hl_field(MR_mktag(0), Deep_7, (MR_Integer) 17)));
          MR_ArrayPtr Var_55 = ((MR_ArrayPtr) (MR_hl_field(MR_mktag(0), Deep_7, (MR_Integer) 18)));
          MR_ArrayPtr Var_56 = ((MR_ArrayPtr) (MR_hl_field(MR_mktag(0), Deep_7, (MR_Integer) 19)));
          MR_ArrayPtr Var_57 = ((MR_ArrayPtr) (MR_hl_field(MR_mktag(0), Deep_7, (MR_Integer) 20)));
          MR_ArrayPtr Var_58 = ((MR_ArrayPtr) (MR_hl_field(MR_mktag(0), Deep_7, (MR_Integer) 21)));
          MR_ArrayPtr Var_59 = ((MR_ArrayPtr) (MR_hl_field(MR_mktag(0), Deep_7, (MR_Integer) 22)));
          MR_ArrayPtr Var_60 = ((MR_ArrayPtr) (MR_hl_field(MR_mktag(0), Deep_7, (MR_Integer) 23)));
          MR_ArrayPtr Var_61 = ((MR_ArrayPtr) (MR_hl_field(MR_mktag(0), Deep_7, (MR_Integer) 24)));
          MR_Word Var_62 = ((MR_Word) (MR_hl_field(MR_mktag(0), Deep_7, (MR_Integer) 25)));
          MR_Word Var_63 = ((MR_Word) (MR_hl_field(MR_mktag(0), Deep_7, (MR_Integer) 26)));
          MR_Word Var_64 = ((MR_Word) (MR_hl_field(MR_mktag(0), Deep_7, (MR_Integer) 27)));
          MR_Word Var_65 = ((MR_Word) (MR_hl_field(MR_mktag(0), Deep_7, (MR_Integer) 28)));
    ...
    mercury__getopt__lookup_bool_option_3_p_0(TypeCtorInfo_94_94, Options_8, ((MR_Box) ((MR_Integer) 11)), &DynamicProcrepCoverage_15);
      ...
      case (MR_Integer) 1:
        {
          ...
          MR_ArrayPtr Var_33 = ((MR_ArrayPtr) (MR_hl_field(MR_mktag(0), Deep_7, (MR_Integer) 6)));
          MR_Word Var_66 = ((MR_Word) (MR_hl_field(MR_mktag(0), Deep_7, (MR_Integer) 0)));
          MR_String Var_67 = ((MR_String) (MR_hl_field(MR_mktag(0), Deep_7, (MR_Integer) 1)));
          MR_String Var_68 = ((MR_String) (MR_hl_field(MR_mktag(0), Deep_7, (MR_Integer) 2)));
          MR_String Var_69 = ((MR_String) (MR_hl_field(MR_mktag(0), Deep_7, (MR_Integer) 3)));
          MR_Word Var_70 = ((MR_Word) (MR_hl_field(MR_mktag(0), Deep_7, (MR_Integer) 4)));
          MR_ArrayPtr Var_71 = ((MR_ArrayPtr) (MR_hl_field(MR_mktag(0), Deep_7, (MR_Integer) 5)));
          MR_ArrayPtr Var_72 = ((MR_ArrayPtr) (MR_hl_field(MR_mktag(0), Deep_7, (MR_Integer) 7)));
          MR_ArrayPtr Var_73 = ((MR_ArrayPtr) (MR_hl_field(MR_mktag(0), Deep_7, (MR_Integer) 8)));
          MR_ArrayPtr Var_74 = ((MR_ArrayPtr) (MR_hl_field(MR_mktag(0), Deep_7, (MR_Integer) 9)));
          MR_ArrayPtr Var_75 = ((MR_ArrayPtr) (MR_hl_field(MR_mktag(0), Deep_7, (MR_Integer) 10)));
          MR_ArrayPtr Var_76 = ((MR_ArrayPtr) (MR_hl_field(MR_mktag(0), Deep_7, (MR_Integer) 11)));
          MR_ArrayPtr Var_77 = ((MR_ArrayPtr) (MR_hl_field(MR_mktag(0), Deep_7, (MR_Integer) 12)));
          MR_ArrayPtr Var_78 = ((MR_ArrayPtr) (MR_hl_field(MR_mktag(0), Deep_7, (MR_Integer) 13)));
          MR_ArrayPtr Var_79 = ((MR_ArrayPtr) (MR_hl_field(MR_mktag(0), Deep_7, (MR_Integer) 14)));
          MR_ArrayPtr Var_80 = ((MR_ArrayPtr) (MR_hl_field(MR_mktag(0), Deep_7, (MR_Integer) 15)));
          MR_ArrayPtr Var_81 = ((MR_ArrayPtr) (MR_hl_field(MR_mktag(0), Deep_7, (MR_Integer) 16)));
          MR_ArrayPtr Var_82 = ((MR_ArrayPtr) (MR_hl_field(MR_mktag(0), Deep_7, (MR_Integer) 17)));
          MR_ArrayPtr Var_83 = ((MR_ArrayPtr) (MR_hl_field(MR_mktag(0), Deep_7, (MR_Integer) 18)));
          MR_ArrayPtr Var_84 = ((MR_ArrayPtr) (MR_hl_field(MR_mktag(0), Deep_7, (MR_Integer) 19)));
          MR_ArrayPtr Var_85 = ((MR_ArrayPtr) (MR_hl_field(MR_mktag(0), Deep_7, (MR_Integer) 20)));
          MR_ArrayPtr Var_86 = ((MR_ArrayPtr) (MR_hl_field(MR_mktag(0), Deep_7, (MR_Integer) 21)));
          MR_ArrayPtr Var_87 = ((MR_ArrayPtr) (MR_hl_field(MR_mktag(0), Deep_7, (MR_Integer) 22)));
          MR_ArrayPtr Var_88 = ((MR_ArrayPtr) (MR_hl_field(MR_mktag(0), Deep_7, (MR_Integer) 23)));
          MR_ArrayPtr Var_89 = ((MR_ArrayPtr) (MR_hl_field(MR_mktag(0), Deep_7, (MR_Integer) 24)));
          MR_Word Var_90 = ((MR_Word) (MR_hl_field(MR_mktag(0), Deep_7, (MR_Integer) 25)));
          MR_Word Var_91 = ((MR_Word) (MR_hl_field(MR_mktag(0), Deep_7, (MR_Integer) 26)));
          MR_Word Var_92 = ((MR_Word) (MR_hl_field(MR_mktag(0), Deep_7, (MR_Integer) 27)));
          MR_Word Var_93 = ((MR_Word) (MR_hl_field(MR_mktag(0), Deep_7, (MR_Integer) 28)));
    ...
    mercury__getopt__lookup_bool_option_3_p_0(TypeCtorInfo_94_94, Options_8, ((MR_Box) ((MR_Integer) 12)), &RecTypesHistogram_17);
...
{
  {
    ...
    query__try_exec_4_p_0((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 3)), Pref_6, Deep_7, &HTML_10);
  ...
  MR_Word Options_12)
{
  while (MR_TRUE)
  {
    ...
    if (succeeded)
    {
      ...
      Var_21 = (MR_Integer) ((MR_Unsigned) Cur_8 + (MR_Unsigned) (MR_Integer) 1);
...
{
  {
    ...
    MR_Word Res_18;
    MR_Integer Var_27 = (MR_Integer) ((MR_Unsigned) Num_9 - (MR_Unsigned) (MR_Integer) 1);
    MR_String Var_68;
    MR_Word Var_74;
    MR_String Var_77;
    MR_String Var_78;
    ...
    TypeCtorInfo_67_67 = (MR_Word) &mdprof_test__mdprof_test__type_ctor_info_option_0;
    mercury__getopt__lookup_string_option_3_p_0(TypeCtorInfo_67_67, Options_7, ((MR_Box) ((MR_Integer) 6)), &DirName_13);
    Var_74 = (MR_Word) &mdprof_test_scalar_common_2[0];
    mercury__string__format__format_signed_int_component_width_noprec_4_p_0(Var_74, (MR_Integer) 4, Bunch_12, &Var_68);
    Var_77 = mercury__string__f_43_43_2_f_0((MR_String) "_", Var_68);
    Var_78 = mercury__string__f_43_43_2_f_0(BaseName_8, Var_77);
    Var_80 = mercury__string__f_43_43_2_f_0((MR_String) "/", Var_78);
    BunchName_14 = mercury__string__f_43_43_2_f_0(DirName_13, Var_80);
    Var_40 = (MR_Integer) ((MR_Unsigned) Num_9 - (MR_Unsigned) (MR_Integer) 1);
    ...
    if (succeeded)
    {
      ...
      Var_82 = mercury__string__f_43_43_2_f_0((MR_String) " || mkdir -p ", BunchName_14);
      Var_83 = mercury__string__f_43_43_2_f_0(BunchName_14, Var_82);
      Cmd_15 = mercury__string__f_43_43_2_f_0((MR_String) "test -d ", Var_83);
      mercury__io__call_system_4_p_0(Cmd_15, &Var_16);
    }
    else
    {
    }
    mercury__string__format__format_signed_int_component_width_noprec_4_p_0(Var_74, (MR_Integer) 6, Num_9, &Var_86);
    Var_94 = mercury__string__f_43_43_2_f_0(Var_86, (MR_String) ".html");
    Var_96 = mercury__string__f_43_43_2_f_0((MR_String) "_", Var_94);
    Var_97 = mercury__string__f_43_43_2_f_0(BaseName_8, Var_96);
    Var_99 = mercury__string__f_43_43_2_f_0((MR_String) "/", Var_97);
    FileName_17 = mercury__string__f_43_43_2_f_0(BunchName_14, Var_99);
    mercury__io__open_output_4_p_0(FileName_17, &Res_18);
    if (((MR_tag((MR_Word) Res_18)) == (MR_mktag((MR_Integer) 1))))
    {
      MR_Word Err_23 = ((MR_Word) (MR_hl_field(MR_mktag(1), Res_18, (MR_Integer) 0)));
      MR_String ErrMsg_24;
    ...
    {
      MR_Word Stream_19 = ((MR_Word) (MR_hl_field(MR_mktag(0), Res_18, (MR_Integer) 0)));
      MR_Word Compress_20;

      mercury__io__write_string_4_p_0(Stream_19, HTML_10);
      mercury__io__close_output_3_p_0(Stream_19);
      mercury__getopt__lookup_bool_option_3_p_0(TypeCtorInfo_67_67, Options_7, ((MR_Box) ((MR_Integer) 3)), &Compress_20);
      switch (Compress_20) {
        default: /*NOTREACHED*/ MR_assert(0);
        case (MR_Integer) 0:
          {
        ...
        case (MR_Integer) 1:
          {
            ...
            mercury__io__call_system_4_p_0(GzipCmd_21, &Var_22);
          }
          break;
      }
    }
