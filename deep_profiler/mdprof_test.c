...
MR_decl_label3(mdprof_test__defaults_2_0, 11,12,13)
MR_decl_label8(mdprof_test__long_2_0, 3,16,5,6,7,8,9,10)
MR_decl_label4(mdprof_test__long_2_0, 11,12,13,14)
MR_decl_label8(main_2_0, 2,3,8,11,10,17,18,19)
MR_decl_label8(main_2_0, 21,24,25,26,27,28,29,30)
MR_decl_label8(main_2_0, 31,32,33,34,35,36,37,38)
MR_decl_label5(main_2_0, 20,41,39,46,9)
MR_decl_label8(mdprof_test__main2_5_0, 5,6,7,8,9,10,11,13)
MR_decl_label8(mdprof_test__main2_5_0, 14,16,19,18,25,28,29,2)
MR_decl_label2(mdprof_test__main2_5_0, 31,33)
MR_decl_label5(mdprof_test__short_2_0, 3,4,5,6,1)
MR_decl_label8(mdprof_test__test_cliques_7_0, 58,4,5,12,14,19,20,13)
MR_decl_label8(mdprof_test__test_cliques_7_0, 31,32,35,36,39,40,34,41)
MR_decl_label2(mdprof_test__test_cliques_7_0, 60,61)
MR_decl_label8(mdprof_test__test_procs_7_0, 58,4,5,12,14,19,20,13)
MR_decl_label8(mdprof_test__test_procs_7_0, 31,32,35,36,39,40,34,41)
MR_decl_label2(mdprof_test__test_procs_7_0, 60,61)
MR_decl_label5(mdprof_test__test_server_5_0, 5,6,8,9,10)
MR_decl_label1(mdprof_test__verify_profile_5_0, 3)
MR_decl_label6(mdprof_test__verify_profile_2_5_0, 2,3,5,6,9,7)
MR_decl_label8(mdprof_test__write_help_message_3_0, 4,5,6,7,8,9,10,11)
MR_decl_label6(mdprof_test__write_help_message_3_0, 12,13,14,15,16,17)
...
MR_BEGIN_MODULE(mdprof_test_module0)
	...
	MR_init_label8(mdprof_test__write_help_message_3_0,4,5,6,7,8,9,10,11)
	MR_init_label6(mdprof_test__write_help_message_3_0,12,13,14,15,16,17)
MR_BEGIN_CODE
...
MR_def_label(mdprof_test__write_help_message_3_0,15)
	...
	MR_r2 = (MR_Word) MR_tbmkword(0, 0);
	MR_np_call_localret_ent(io__format_4_0,
		mdprof_test__write_help_message_3_0_i16);
MR_def_label(mdprof_test__write_help_message_3_0,16)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_string_const("--test-dir <dirname>\n", 21);
	MR_r2 = (MR_Word) MR_tbmkword(0, 0);
	MR_np_call_localret_ent(io__format_4_0,
		mdprof_test__write_help_message_3_0_i17);
MR_def_label(mdprof_test__write_help_message_3_0,17)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_BEGIN_MODULE(mdprof_test_module1)
	...
	MR_init_label8(mdprof_test__test_cliques_7_0,58,4,5,12,14,19,20,13)
	MR_init_label8(mdprof_test__test_cliques_7_0,31,32,35,36,39,40,34,41)
	MR_init_label2(mdprof_test__test_cliques_7_0,60,61)
MR_BEGIN_CODE
...
MR_def_label(mdprof_test__test_cliques_7_0,58)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (((MR_Integer) MR_r1 > (MR_Integer) MR_r2)) {
		MR_GOTO_LAB(mdprof_test__test_cliques_7_0_i61);
	}
	{
...
MR_def_label(mdprof_test__test_cliques_7_0,12)
	...
	MR_np_call_localret_ent(fn__int__rem_2_0,
		mdprof_test__test_cliques_7_0_i14);
MR_def_label(mdprof_test__test_cliques_7_0,14)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(mdprof_test__test_cliques_7_0_i13);
	}
	{
...
MR_def_label(mdprof_test__test_cliques_7_0,20)
	...
	MR_np_call_localret_ent(string__format_3_0,
		mdprof_test__test_cliques_7_0_i31);
MR_def_label(mdprof_test__test_cliques_7_0,13)
	...
	MR_np_call_localret_ent(string__format_3_0,
		mdprof_test__test_cliques_7_0_i31);
MR_def_label(mdprof_test__test_cliques_7_0,31)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(7) = MR_r1;
	MR_np_call_localret_ent(io__open_output_4_0,
		mdprof_test__test_cliques_7_0_i32);
MR_def_label(mdprof_test__test_cliques_7_0,32)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_r1,0)) {
		MR_GOTO_LAB(mdprof_test__test_cliques_7_0_i34);
	}
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_sv(6);
	...
	MR_np_call_localret_ent(io__write_string_4_0,
		mdprof_test__test_cliques_7_0_i35);
MR_def_label(mdprof_test__test_cliques_7_0,35)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(6);
	MR_np_call_localret_ent(io__close_output_3_0,
		mdprof_test__test_cliques_7_0_i36);
MR_def_label(mdprof_test__test_cliques_7_0,36)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tag_alloc_heap(MR_tempr1, 2, (MR_Integer) 1);
...
MR_def_label(mdprof_test__test_cliques_7_0,39)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_np_call_localret_ent(io__call_system_4_0,
		mdprof_test__test_cliques_7_0_i40);
MR_def_label(mdprof_test__test_cliques_7_0,40)
	...
	MR_GOTO_LAB(mdprof_test__test_cliques_7_0_i58);
MR_def_label(mdprof_test__test_cliques_7_0,34)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_ctfield(1, MR_r1, 0);
	MR_np_call_localret_ent(io__error_message_2_0,
		mdprof_test__test_cliques_7_0_i41);
MR_def_label(mdprof_test__test_cliques_7_0,41)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_np_call_localret_ent(require__error_1_0,
		mdprof_test__test_cliques_7_0_i60);
MR_def_label(mdprof_test__test_cliques_7_0,60)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_succip_word = MR_sv(9);
	MR_GOTO_LAB(mdprof_test__test_cliques_7_0_i58);
MR_def_label(mdprof_test__test_cliques_7_0,61)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_BEGIN_MODULE(mdprof_test_module2)
	...
	MR_init_label8(mdprof_test__test_procs_7_0,58,4,5,12,14,19,20,13)
	MR_init_label8(mdprof_test__test_procs_7_0,31,32,35,36,39,40,34,41)
	MR_init_label2(mdprof_test__test_procs_7_0,60,61)
MR_BEGIN_CODE
...
MR_def_static(mdprof_test__test_procs_7_0)
	...
	MR_incr_sp(9);
	MR_sv(9) = (MR_Word) MR_succip;
MR_def_label(mdprof_test__test_procs_7_0,58)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (((MR_Integer) MR_r1 > (MR_Integer) MR_r2)) {
		MR_GOTO_LAB(mdprof_test__test_procs_7_0_i61);
	}
	{
	MR_Word MR_tempr1, MR_tempr2, MR_tempr3, MR_tempr4;
	MR_tag_alloc_heap(MR_tempr1, 3, (MR_Integer) 2);
...
MR_def_label(mdprof_test__test_procs_7_0,12)
	...
	MR_r2 = (MR_Integer) 1000;
	MR_np_call_localret_ent(fn__int__rem_2_0,
		mdprof_test__test_procs_7_0_i14);
MR_def_label(mdprof_test__test_procs_7_0,14)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(mdprof_test__test_procs_7_0_i13);
	}
	{
	MR_Word MR_tempr1, MR_tempr2, MR_tempr3;
	MR_tag_alloc_heap(MR_tempr1, 2, (MR_Integer) 1);
...
MR_def_label(mdprof_test__test_procs_7_0,20)
	...
	MR_np_call_localret_ent(string__format_3_0,
		mdprof_test__test_procs_7_0_i31);
MR_def_label(mdprof_test__test_procs_7_0,13)
	...
	MR_np_call_localret_ent(string__format_3_0,
		mdprof_test__test_procs_7_0_i31);
MR_def_label(mdprof_test__test_procs_7_0,31)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(7) = MR_r1;
	MR_np_call_localret_ent(io__open_output_4_0,
		mdprof_test__test_procs_7_0_i32);
MR_def_label(mdprof_test__test_procs_7_0,32)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_r1,0)) {
		MR_GOTO_LAB(mdprof_test__test_procs_7_0_i34);
	}
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_sv(6);
	...
	MR_np_call_localret_ent(io__write_string_4_0,
		mdprof_test__test_procs_7_0_i35);
MR_def_label(mdprof_test__test_procs_7_0,35)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(6);
	MR_np_call_localret_ent(io__close_output_3_0,
		mdprof_test__test_procs_7_0_i36);
MR_def_label(mdprof_test__test_procs_7_0,36)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tag_alloc_heap(MR_tempr1, 2, (MR_Integer) 1);
...
MR_def_label(mdprof_test__test_procs_7_0,39)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_np_call_localret_ent(io__call_system_4_0,
		mdprof_test__test_procs_7_0_i40);
MR_def_label(mdprof_test__test_procs_7_0,40)
	...
	MR_r1 = ((MR_Integer) MR_sv(1) + (MR_Integer) 1);
	MR_succip_word = MR_sv(9);
	MR_GOTO_LAB(mdprof_test__test_procs_7_0_i58);
MR_def_label(mdprof_test__test_procs_7_0,34)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_ctfield(1, MR_r1, 0);
	MR_np_call_localret_ent(io__error_message_2_0,
		mdprof_test__test_procs_7_0_i41);
MR_def_label(mdprof_test__test_procs_7_0,41)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_np_call_localret_ent(require__error_1_0,
		mdprof_test__test_procs_7_0_i60);
MR_def_label(mdprof_test__test_procs_7_0,60)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_succip_word = MR_sv(9);
	MR_GOTO_LAB(mdprof_test__test_procs_7_0_i58);
MR_def_label(mdprof_test__test_procs_7_0,61)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(9);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
...
MR_BEGIN_MODULE(mdprof_test_module3)
	...
	MR_init_label5(mdprof_test__test_server_5_0,5,6,8,9,10)
MR_BEGIN_CODE
...
MR_def_label(mdprof_test__test_server_5_0,6)
	...
	MR_np_call_localret_ent(array__max_2_0,
		mdprof_test__test_server_5_0_i8);
MR_def_label(mdprof_test__test_server_5_0,8)
	...
	MR_np_call_localret_ent(mdprof_test__test_cliques_7_0,
		mdprof_test__test_server_5_0_i9);
...
MR_BEGIN_MODULE(mdprof_test_module4)
	...
	MR_init_label8(mdprof_test__main2_5_0,5,6,7,8,9,10,11,13)
	MR_init_label8(mdprof_test__main2_5_0,14,16,19,18,25,28,29,2)
	MR_init_label2(mdprof_test__main2_5_0,31,33)
MR_BEGIN_CODE
...
MR_def_label(mdprof_test__main2_5_0,25)
	...
	MR_np_call_localret_ent(getopt__lookup_string_option_3_0,
		mdprof_test__main2_5_0_i28);
MR_def_label(mdprof_test__main2_5_0,28)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(2) = MR_r1;
	MR_r1 = MR_sv(1);
...
MR_BEGIN_MODULE(mdprof_test_module7)
	...
	MR_init_label8(main_2_0,2,3,8,11,10,17,18,19)
	MR_init_label8(main_2_0,21,24,25,26,27,28,29,30)
	MR_init_label8(main_2_0,31,32,33,34,35,36,37,38)
	MR_init_label5(main_2_0,20,41,39,46,9)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(mdprof_test_module8)
	...
	MR_init_label6(mdprof_test__verify_profile_2_5_0,2,3,5,6,9,7)
MR_BEGIN_CODE
...
MR_def_label(mdprof_test__verify_profile_2_5_0,5)
	...
	MR_np_call_localret_ent(startup__read_and_startup_10_0,
		mdprof_test__verify_profile_2_5_0_i6);
MR_def_label(mdprof_test__verify_profile_2_5_0,6)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_r1,1)) {
		MR_GOTO_LAB(mdprof_test__verify_profile_2_5_0_i7);
	}
	MR_sv(2) = MR_ctfield(1, MR_r1, 0);
	MR_r1 = (MR_Integer) 1;
	MR_np_call_localret_ent(io__set_exit_status_3_0,
...
MR_BEGIN_MODULE(mdprof_test_module11)
	...
	MR_init_label3(mdprof_test__defaults_2_0,11,12,13)
MR_BEGIN_CODE
...
MR_def_static(mdprof_test__defaults_2_0)
	...
	MR_mkframe("pred mdprof_test.defaults/2-0", 1,
		MR_LABEL_AP(mdprof_test__defaults_2_0_i11));
	{
	MR_Word MR_tempr1;
	MR_tempr1 = (MR_Word) &MR_tfield(0, (MR_Word *) &mercury_vector_common_10_0, 0);
	MR_fv(1) = (MR_Integer) 2;
	MR_r1 = MR_ctfield(0, MR_tempr1, 0);
	MR_r2 = MR_ctfield(0, MR_tempr1, 1);
	MR_succeed();
	}
MR_def_label(mdprof_test__defaults_2_0,11)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r3 = MR_fv(1);
	if (MR_INT_GE(MR_r3,16)) {
		MR_GOTO_LAB(mdprof_test__defaults_2_0_i12);
	}
