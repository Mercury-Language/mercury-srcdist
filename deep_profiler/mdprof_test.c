...
{
  {
    ...
    startup__read_and_startup_10_p_0((MR_String) "dummy_server", ScriptName_12, FileName_8, Canonical_10, (MR_Word) ((MR_Integer) 0), (MR_Word) ((MR_Integer) 0), Var_22, &Res_13);
...
{
  {
    ...
    if (succeeded)
    {
      ...
      switch (Verbose_12) {
        default: /*NOTREACHED*/ MR_assert(0);
        case (MR_Integer) 0:
          MaybeOutput_18 = (MR_Word) ((MR_Integer) 0);
          break;
        case (MR_Integer) 1:
          {
            MR_Word Stdout_19;
...
{
  {
    ...
    query__try_exec_4_p_0((MR_Word) ((MR_Integer) 12), Pref_6, Deep_7, &HTML_10);
