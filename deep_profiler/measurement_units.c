...
MR_decl_label3(fn__measurement_units__probable_1_0, 15,13,16)
...
MR_BEGIN_MODULE(measurement_units_module14)
	...
	MR_init_label3(fn__measurement_units__probable_1_0,15,13,16)
MR_BEGIN_CODE
...
MR_define_entry(mercury__fn__measurement_units__probable_1_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if ((MR_word_to_float(MR_r1) > (MR_Float) 1.0000000000000000)) {
		MR_GOTO_LAB(fn__measurement_units__probable_1_0_i15);
	}
	if ((MR_word_to_float(MR_r1) >= (MR_Float) 0.0000000000000000)) {
		MR_GOTO_LAB(fn__measurement_units__probable_1_0_i16);
	}
MR_def_label(fn__measurement_units__probable_1_0,15)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(2);
	MR_sv(2) = (MR_Word) MR_succip;
	{
	...
	MR_np_call_localret_ent(fn__string__format_2_0,
		fn__measurement_units__probable_1_0_i13);
MR_def_label(fn__measurement_units__probable_1_0,13)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_succip_word = MR_sv(2);
	MR_decr_sp(2);
	MR_np_tailcall_ent(require__error_1_0);
