...
{
  {
    ...
    if (succeeded)
    {
      ...
      mercury__list__reverse_2_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_character_0), Chars0_27, &RevChars0_28);
      Var_30 = measurement_units__add_commas_1_f_0(RevChars0_28);
      Var_29 = mercury__list__reverse_1_f_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_character_0), Var_30);
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        mercury__list__reverse_2_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_character_0), Chars0_34, &RevChars0_35);
        Var_37 = measurement_units__add_commas_1_f_0(RevChars0_35);
        Var_36 = mercury__list__reverse_1_f_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_character_0), Var_37);
