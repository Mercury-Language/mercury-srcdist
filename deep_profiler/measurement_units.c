...
{
  {
    ...
    {
      MR_Float measurement_units__ArgX1_4 = MR_unbox_float((MR_Box) measurement_units__HeadVar__2_2);
      MR_Float measurement_units__ArgY1_5 = MR_unbox_float((MR_Box) measurement_units__HeadVar__3_3);

      {
        mercury__private_builtin__builtin_compare_float_3_p_0(measurement_units__HeadVar__1_1, measurement_units__ArgX1_4, measurement_units__ArgY1_5);
      }
    }
  }
}
...
{
  {
    ...
    {
      MR_Float measurement_units__ArgX1_3 = MR_unbox_float((MR_Box) measurement_units__HeadVar__1_1);
      MR_Float measurement_units__ArgY1_4 = MR_unbox_float((MR_Box) measurement_units__HeadVar__2_2);

      measurement_units__succeeded = (measurement_units__ArgX1_3 == measurement_units__ArgY1_4);
    }
    return measurement_units__succeeded;
  }
}
...
{
  {
    ...
    {
      MR_Float measurement_units__ArgX1_4 = MR_unbox_float((MR_hl_field(MR_mktag(0), measurement_units__HeadVar__2_2, (MR_Integer) 0)));
      MR_Float measurement_units__ArgY1_5 = MR_unbox_float((MR_hl_field(MR_mktag(0), measurement_units__HeadVar__3_3, (MR_Integer) 0)));
      MR_Integer measurement_units__ArgX2_6 = ((MR_Integer) (MR_hl_field(MR_mktag(0), measurement_units__HeadVar__2_2, (MR_Integer) 1)));
      MR_Integer measurement_units__ArgY2_7 = ((MR_Integer) (MR_hl_field(MR_mktag(0), measurement_units__HeadVar__3_3, (MR_Integer) 1)));
      MR_Word measurement_units__Var_8;

      {
        mercury__private_builtin__builtin_compare_float_3_p_0(&measurement_units__Var_8, measurement_units__ArgX1_4, measurement_units__ArgY1_5);
      }
      measurement_units__succeeded = (measurement_units__Var_8 == (MR_Integer) 0);
      measurement_units__succeeded = !(measurement_units__succeeded);
      if (measurement_units__succeeded)
        *measurement_units__HeadVar__1_1 = measurement_units__Var_8;
      else
        {
          mercury__private_builtin__builtin_compare_int_3_p_0(measurement_units__HeadVar__1_1, measurement_units__ArgX2_6, measurement_units__ArgY2_7);
        }
    }
  }
}
...
{
  {
    ...
    {
      MR_Float measurement_units__ArgX1_3 = MR_unbox_float((MR_hl_field(MR_mktag(0), measurement_units__HeadVar__1_1, (MR_Integer) 0)));
      MR_Float measurement_units__ArgY1_4 = MR_unbox_float((MR_hl_field(MR_mktag(0), measurement_units__HeadVar__2_2, (MR_Integer) 0)));
      MR_Integer measurement_units__ArgX2_5 = ((MR_Integer) (MR_hl_field(MR_mktag(0), measurement_units__HeadVar__1_1, (MR_Integer) 1)));
      MR_Integer measurement_units__ArgY2_6 = ((MR_Integer) (MR_hl_field(MR_mktag(0), measurement_units__HeadVar__2_2, (MR_Integer) 1)));

      measurement_units__succeeded = (measurement_units__ArgX1_3 == measurement_units__ArgY1_4);
      if (measurement_units__succeeded)
        measurement_units__succeeded = (measurement_units__ArgX2_5 == measurement_units__ArgY2_6);
    }
    return measurement_units__succeeded;
  }
}
...
{
  {
    ...
    MR_Word measurement_units__Var_10;
    MR_Word measurement_units__Var_11;
    ...
    {
      measurement_units__Var_11 = measurement_units__add_commas_1_f_0(measurement_units__RevChars0_9);
    }
    {
      measurement_units__Var_10 = mercury__list__reverse_1_f_0(measurement_units__TypeCtorInfo_9_12, measurement_units__Var_11);
    }
    {
      mercury__string__from_char_list_2_p_0(measurement_units__Var_10, &measurement_units__Str_4);
    }
  ...
  MR_Float measurement_units__B_5)
{
  {
    MR_Float measurement_units__HeadVar__3_3;
    MR_Float measurement_units__Var_6;
    MR_Float measurement_units__Var_7 = (((MR_Float) 1.0000000000000000) - measurement_units__A_4);
    MR_Float measurement_units__Var_8 = (((MR_Float) 1.0000000000000000) - measurement_units__B_5);

    measurement_units__Var_6 = (measurement_units__Var_7 * measurement_units__Var_8);
    measurement_units__HeadVar__3_3 = (((MR_Float) 1.0000000000000000) - measurement_units__Var_6);
    return measurement_units__HeadVar__3_3;
  }
}
...
{
  {
    ...
    MR_Float measurement_units__Prob_2 = measurement_units__Prob_3;
    MR_Float measurement_units__Var_5;

    if (measurement_units__succeeded)
    {
      measurement_units__Var_5 = (MR_Float) 0.0000000000000000;
      measurement_units__succeeded = (measurement_units__Prob_3 >= measurement_units__Var_5);
    }
    if (measurement_units__succeeded)
    {
    }
    ...
    {
      MR_String measurement_units__Var_6;
      MR_String measurement_units__Var_12;
      MR_String measurement_units__Var_20;

      {
        mercury__string__format__format_float_component_nowidth_noprec_4_p_0((MR_Word) &measurement_units_scalar_common_2[0], (MR_Integer) 2, measurement_units__Prob_3, &measurement_units__Var_12);
      }
      {
        measurement_units__Var_20 = mercury__string__f_43_43_2_f_0(measurement_units__Var_12, (MR_String) " out of range 0.0 to 1.0 inclusive");
      }
      {
        measurement_units__Var_6 = mercury__string__f_43_43_2_f_0((MR_String) "Probability ", measurement_units__Var_20);
      }
      {
        mercury__require__error_1_p_0(measurement_units__Var_6);
      }
    }
    return measurement_units__Prob_2;
  }
...
{
  {
    ...
    if (measurement_units__succeeded)
    {
      MR_Float measurement_units__Var_9;
      MR_String measurement_units__Var_38;

      {
        measurement_units__Var_9 = mercury__float__f_slash_2_f_0(measurement_units__F_3, (MR_Float) 9.9999999999999998e-13);
      }
      {
        mercury__string__format__format_float_component_nowidth_prec_5_p_0((MR_Word) &measurement_units_scalar_common_2[0], (MR_Integer) 1, (MR_Integer) 2, measurement_units__Var_9, &measurement_units__Var_38);
      }
      {
        measurement_units__String_4 = mercury__string__f_43_43_2_f_0(measurement_units__Var_38, (MR_String) "ps");
      }
    }
    else
    {
      ...
      if (measurement_units__succeeded)
      {
        MR_Float measurement_units__Var_16;
        MR_String measurement_units__Var_48;

        {
          measurement_units__Var_16 = mercury__float__f_slash_2_f_0(measurement_units__F_3, (MR_Float) 1.0000000000000001e-09);
        }
        {
          mercury__string__format__format_float_component_nowidth_prec_5_p_0((MR_Word) &measurement_units_scalar_common_2[0], (MR_Integer) 1, (MR_Integer) 2, measurement_units__Var_16, &measurement_units__Var_48);
        }
        {
          measurement_units__String_4 = mercury__string__f_43_43_2_f_0(measurement_units__Var_48, (MR_String) "ns");
        }
      }
      else
      {
        ...
        if (measurement_units__succeeded)
        {
          MR_Float measurement_units__Var_23;
          MR_String measurement_units__Var_58;

          {
            measurement_units__Var_23 = mercury__float__f_slash_2_f_0(measurement_units__F_3, (MR_Float) 9.9999999999999995e-07);
          }
          {
            mercury__string__format__format_float_component_nowidth_prec_5_p_0((MR_Word) &measurement_units_scalar_common_2[0], (MR_Integer) 1, (MR_Integer) 2, measurement_units__Var_23, &measurement_units__Var_58);
          }
          {
            measurement_units__String_4 = mercury__string__f_43_43_2_f_0(measurement_units__Var_58, (MR_String) "us");
          }
        }
        else
        {
          ...
          if (measurement_units__succeeded)
          {
            MR_Float measurement_units__Var_30;
            MR_String measurement_units__Var_68;

            {
              measurement_units__Var_30 = mercury__float__f_slash_2_f_0(measurement_units__F_3, (MR_Float) 0.0010000000000000000);
            }
            {
              mercury__string__format__format_float_component_nowidth_prec_5_p_0((MR_Word) &measurement_units_scalar_common_2[0], (MR_Integer) 1, (MR_Integer) 2, measurement_units__Var_30, &measurement_units__Var_68);
            }
            {
              measurement_units__String_4 = mercury__string__f_43_43_2_f_0(measurement_units__Var_68, (MR_String) "ms");
            }
          }
          else
          {
            MR_String measurement_units__Var_78;

            {
              mercury__string__format__format_float_component_nowidth_prec_5_p_0((MR_Word) &measurement_units_scalar_common_2[0], (MR_Integer) 1, (MR_Integer) 2, measurement_units__F_3, &measurement_units__Var_78);
            }
            {
              measurement_units__String_4 = mercury__string__f_43_43_2_f_0(measurement_units__Var_78, (MR_String) "s");
            }
          }
        }
      }
...
{
  {
    ...
    {
      MR_Float measurement_units__Var_7;

      {
        measurement_units__Var_7 = mercury__float__float_1_f_0(measurement_units__Calls_5);
      }
      {
        measurement_units__TimePerCall_6 = mercury__float__f_slash_2_f_0(measurement_units__Time_4, measurement_units__Var_7);
      }
    }
...
{
  {
    ...
    MR_Float measurement_units__Var_9;
    MR_Float measurement_units__Var_10;
    MR_Float measurement_units__Var_11;

    {
      measurement_units__Var_9 = mercury__float__float_1_f_0(measurement_units__TicksPerSec_5);
    }
    {
      measurement_units__SecPerTick_7 = mercury__float__f_slash_2_f_0((MR_Float) 1.0000000000000000, measurement_units__Var_9);
    }
    {
      measurement_units__Var_11 = mercury__float__float_1_f_0(measurement_units__Ticks_4);
    }
    measurement_units__Var_10 = (measurement_units__Var_11 * measurement_units__SecPerTick_7);
    measurement_units__Time_6 = (MR_Word) MR_box_float(measurement_units__Var_10);
...
{
  {
    ...
    {
      measurement_units__Var_7 = mercury__float__float_1_f_0((MR_Integer) 100);
    }
    measurement_units__Var_5 = (measurement_units__P_4 * measurement_units__Var_7);
    {
      measurement_units__Var_6 = mercury__float__float_1_f_0(measurement_units__Threshold_3);
    }
    measurement_units__succeeded = (measurement_units__Var_5 >= measurement_units__Var_6);
    return measurement_units__succeeded;
  }
}
...
{
  {
    ...
    MR_Float measurement_units__Var_8 = (measurement_units__P_3 * ((MR_Float) 100.00000000000000));

    {
      mercury__string__format__format_float_component_nowidth_prec_5_p_0((MR_Word) &measurement_units_scalar_common_2[0], (MR_Integer) 2, (MR_Integer) 2, measurement_units__Var_8, &measurement_units__String_4);
    }
    return measurement_units__String_4;
  }
}
...
{
  {
    ...
    {
      measurement_units__Var_11 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 5 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), measurement_units__Var_11, 0) = ((MR_Box) (&measurement_units_scalar_common_1[0]));
      MR_hl_field(MR_mktag(0), measurement_units__Var_11, 1) = ((MR_Box) (measurement_units__compare_memory_3_p_0_1));
      MR_hl_field(MR_mktag(0), measurement_units__Var_11, 2) = ((MR_Box) (MR_Word) ((MR_Integer) 2));
      MR_hl_field(MR_mktag(0), measurement_units__Var_11, 3) = ((MR_Box) (measurement_units__WordSizeA_8));
      MR_hl_field(MR_mktag(0), measurement_units__Var_11, 4) = ((MR_Box) (measurement_units__WordSizeB_10));
    }
    {
      mercury__require__require_2_p_0(measurement_units__Var_11, (MR_String) "compare_memory: word size mismatch");
    }
    {
...
{
  {
    ...
    MR_Integer measurement_units__Var_13 = ((MR_Integer) (MR_hl_field(MR_mktag(0), measurement_units__HeadVar__1_1, (MR_Integer) 1)));
    MR_Float measurement_units__Var_14 = MR_unbox_float((MR_hl_field(MR_mktag(0), measurement_units__HeadVar__1_1, (MR_Integer) 0)));

    switch (measurement_units__HeadVar__2_2) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 1:
        {
          MR_Float measurement_units__Var_8;
          MR_Float measurement_units__Var_9;
          MR_String measurement_units__Format_18;
          MR_String measurement_units__Var_20;
          MR_String measurement_units__Var_21;

          {
            measurement_units__Var_9 = mercury__float__float_1_f_0(measurement_units__Var_13);
          }
          measurement_units__Var_8 = (measurement_units__Var_14 * measurement_units__Var_9);
          {
            measurement_units__Var_21 = mercury__string__string_1_f_0((MR_Word) &mercury__builtin__builtin__type_ctor_info_int_0, ((MR_Box) (measurement_units__Decimals_3)));
          }
          {
            measurement_units__Var_20 = mercury__string__f_43_43_2_f_0(measurement_units__Var_21, (MR_String) "f");
          }
          {
            measurement_units__Format_18 = mercury__string__f_43_43_2_f_0((MR_String) "%.", measurement_units__Var_20);
          }
          {
            measurement_units__HeadVar__4_4 = measurement_units__decimal_fraction_2_f_0(measurement_units__Format_18, measurement_units__Var_8);
          }
        }
        break;
      case (MR_Integer) 0:
        {
          ...
          MR_String measurement_units__Var_29;
          MR_String measurement_units__Var_30;

          {
            measurement_units__Var_30 = mercury__string__string_1_f_0((MR_Word) &mercury__builtin__builtin__type_ctor_info_int_0, ((MR_Box) (measurement_units__Decimals_3)));
          }
          {
            measurement_units__Var_29 = mercury__string__f_43_43_2_f_0(measurement_units__Var_30, (MR_String) "f");
          }
          {
            measurement_units__Format_27 = mercury__string__f_43_43_2_f_0((MR_String) "%.", measurement_units__Var_29);
          }
          {
            measurement_units__HeadVar__4_4 = measurement_units__decimal_fraction_2_f_0(measurement_units__Format_27, measurement_units__Var_14);
          }
        }
        break;
    }
...
{
  {
    ...
    MR_Word measurement_units__Var_12;
    MR_Word measurement_units__Var_13;
    MR_String measurement_units__WholeString0_9;
    MR_String measurement_units__FractionString_10;
    MR_Word measurement_units__Var_16;
    MR_Word measurement_units__Var_17;

    {
      measurement_units__Var_13 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), measurement_units__Var_13, 0) = MR_box_float(measurement_units__Measure_5);
    }
    {
      measurement_units__Var_12 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), measurement_units__Var_12, 0) = ((MR_Box) (measurement_units__Var_13));
      MR_hl_field(MR_mktag(1), measurement_units__Var_12, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
    }
    {
      mercury__string__format_3_p_0(measurement_units__Format_4, measurement_units__Var_12, &measurement_units__Str0_7);
    }
    {
    ...
    if (measurement_units__succeeded)
    {
      ...
      measurement_units__Var_16 = ((MR_Word) (MR_hl_field(MR_mktag(1), measurement_units__SubStrings_8, (MR_Integer) 1)));
      measurement_units__succeeded = ((MR_tag((MR_Word) measurement_units__Var_16)) == (MR_mktag((MR_Integer) 1)));
      if (measurement_units__succeeded)
      {
        measurement_units__FractionString_10 = ((MR_String) (MR_hl_field(MR_mktag(1), measurement_units__Var_16, (MR_Integer) 0)));
        measurement_units__Var_17 = ((MR_Word) (MR_hl_field(MR_mktag(1), measurement_units__Var_16, (MR_Integer) 1)));
        measurement_units__succeeded = (measurement_units__Var_17 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
      }
    }
    if (measurement_units__succeeded)
    {
      ...
      MR_String measurement_units__Var_18;
      MR_Word measurement_units__Chars0_27;
      MR_Word measurement_units__RevChars0_28;
      MR_Word measurement_units__Var_29;
      MR_Word measurement_units__Var_30;
      ...
      {
        measurement_units__Var_30 = measurement_units__add_commas_1_f_0(measurement_units__RevChars0_28);
      }
      {
        measurement_units__Var_29 = mercury__list__reverse_1_f_0(measurement_units__TypeCtorInfo_9_31, measurement_units__Var_30);
      }
      {
        mercury__string__from_char_list_2_p_0(measurement_units__Var_29, &measurement_units__WholeString_11);
      }
      {
        measurement_units__Var_18 = mercury__string__f_43_43_2_f_0((MR_String) ".", measurement_units__FractionString_10);
      }
      {
        measurement_units__Representation_6 = mercury__string__f_43_43_2_f_0(measurement_units__WholeString_11, measurement_units__Var_18);
      }
    }
    else
    {
      MR_String measurement_units__WholeString_24;
      MR_Word measurement_units__Var_20;

      measurement_units__succeeded = ((MR_tag((MR_Word) measurement_units__SubStrings_8)) == (MR_mktag((MR_Integer) 1)));
      if (measurement_units__succeeded)
      {
        measurement_units__WholeString_24 = ((MR_String) (MR_hl_field(MR_mktag(1), measurement_units__SubStrings_8, (MR_Integer) 0)));
        measurement_units__Var_20 = ((MR_Word) (MR_hl_field(MR_mktag(1), measurement_units__SubStrings_8, (MR_Integer) 1)));
        measurement_units__succeeded = (measurement_units__Var_20 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
      }
      if (measurement_units__succeeded)
      {
        ...
        MR_Word measurement_units__Var_36;
        MR_Word measurement_units__Var_37;
        ...
        {
          measurement_units__Var_37 = measurement_units__add_commas_1_f_0(measurement_units__RevChars0_35);
        }
        {
          measurement_units__Var_36 = mercury__list__reverse_1_f_0(measurement_units__TypeCtorInfo_9_38, measurement_units__Var_37);
        }
        {
          mercury__string__from_char_list_2_p_0(measurement_units__Var_36, &measurement_units__Representation_6);
        }
      }
      else
      {
...
{
  {
    ...
    {
      MR_Word measurement_units__Var_35 = ((MR_Word) (MR_hl_field(MR_mktag(1), measurement_units__HeadVar__1_1, (MR_Integer) 1)));
      MR_Char measurement_units__Var_36 = ((MR_Char) (MR_Word) (MR_hl_field(MR_mktag(1), measurement_units__HeadVar__1_1, (MR_Integer) 0)));

      if ((measurement_units__Var_35 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
      {
        {
          measurement_units__HeadVar__2_2 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), measurement_units__HeadVar__2_2, 0) = ((MR_Box) (MR_Word) (measurement_units__Var_36));
          MR_hl_field(MR_mktag(1), measurement_units__HeadVar__2_2, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
        }
      }
      else
      {
        MR_Word measurement_units__Var_37 = ((MR_Word) (MR_hl_field(MR_mktag(1), measurement_units__Var_35, (MR_Integer) 1)));
        MR_Char measurement_units__Var_38 = ((MR_Char) (MR_Word) (MR_hl_field(MR_mktag(1), measurement_units__Var_35, (MR_Integer) 0)));

        if ((measurement_units__Var_37 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
        {
          MR_Word measurement_units__Var_10;

          {
            measurement_units__Var_10 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), measurement_units__Var_10, 0) = ((MR_Box) (MR_Word) (measurement_units__Var_38));
            MR_hl_field(MR_mktag(1), measurement_units__Var_10, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
          }
          {
            measurement_units__HeadVar__2_2 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), measurement_units__HeadVar__2_2, 0) = ((MR_Box) (MR_Word) (measurement_units__Var_36));
            MR_hl_field(MR_mktag(1), measurement_units__HeadVar__2_2, 1) = ((MR_Box) (measurement_units__Var_10));
          }
        }
        else
        {
          MR_Word measurement_units__Var_39 = ((MR_Word) (MR_hl_field(MR_mktag(1), measurement_units__Var_37, (MR_Integer) 1)));
          MR_Char measurement_units__Var_40 = ((MR_Char) (MR_Word) (MR_hl_field(MR_mktag(1), measurement_units__Var_37, (MR_Integer) 0)));

          if ((measurement_units__Var_39 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
          {
            MR_Word measurement_units__Var_18;
            MR_Word measurement_units__Var_19;

            {
              measurement_units__Var_19 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), measurement_units__Var_19, 0) = ((MR_Box) (MR_Word) (measurement_units__Var_40));
              MR_hl_field(MR_mktag(1), measurement_units__Var_19, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
            }
            {
              measurement_units__Var_18 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), measurement_units__Var_18, 0) = ((MR_Box) (MR_Word) (measurement_units__Var_38));
              MR_hl_field(MR_mktag(1), measurement_units__Var_18, 1) = ((MR_Box) (measurement_units__Var_19));
            }
            {
              measurement_units__HeadVar__2_2 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), measurement_units__HeadVar__2_2, 0) = ((MR_Box) (MR_Word) (measurement_units__Var_36));
              MR_hl_field(MR_mktag(1), measurement_units__HeadVar__2_2, 1) = ((MR_Box) (measurement_units__Var_18));
            }
          }
          else
          {
            MR_Word measurement_units__Var_29;
            MR_Word measurement_units__Var_30;
            MR_Word measurement_units__Var_31;
            MR_Word measurement_units__Var_33;

            {
              measurement_units__Var_33 = measurement_units__add_commas_1_f_0(measurement_units__Var_39);
            }
            {
              measurement_units__Var_31 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), measurement_units__Var_31, 0) = ((MR_Box) (MR_Word) ((MR_Char) 44));
              MR_hl_field(MR_mktag(1), measurement_units__Var_31, 1) = ((MR_Box) (measurement_units__Var_33));
            }
            {
              measurement_units__Var_30 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), measurement_units__Var_30, 0) = ((MR_Box) (MR_Word) (measurement_units__Var_40));
              MR_hl_field(MR_mktag(1), measurement_units__Var_30, 1) = ((MR_Box) (measurement_units__Var_31));
            }
            {
              measurement_units__Var_29 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), measurement_units__Var_29, 0) = ((MR_Box) (MR_Word) (measurement_units__Var_38));
              MR_hl_field(MR_mktag(1), measurement_units__Var_29, 1) = ((MR_Box) (measurement_units__Var_30));
            }
            {
              measurement_units__HeadVar__2_2 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), measurement_units__HeadVar__2_2, 0) = ((MR_Box) (MR_Word) (measurement_units__Var_36));
              MR_hl_field(MR_mktag(1), measurement_units__HeadVar__2_2, 1) = ((MR_Box) (measurement_units__Var_29));
            }
          }
        }
      }
...
{
  {
    ...
    else
    {
      ...
      {
        measurement_units__Var_9 = mercury__float__float_1_f_0(measurement_units__Denom_6);
      }
      {
        measurement_units__Var_8 = mercury__float__f_slash_2_f_0(measurement_units__Nom_4, measurement_units__Var_9);
      }
      {
        measurement_units__HeadVar__3_3 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), measurement_units__HeadVar__3_3, 0) = MR_box_float(measurement_units__Var_8);
        MR_hl_field(MR_mktag(0), measurement_units__HeadVar__3_3, 1) = ((MR_Box) (measurement_units__BPW_5));
      }
    }
    return measurement_units__HeadVar__3_3;
