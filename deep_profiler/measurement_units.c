...
{
  {
    ...
    HeadVar__2_2 = measurement_units__decimal_fraction_2_f_0((MR_String) "%.4f", Measure_3);
    return HeadVar__2_2;
  }
}
...
{
  {
    ...
    HeadVar__2_2 = measurement_units__decimal_fraction_2_f_0((MR_String) "%.2f", Measure_3);
    return HeadVar__2_2;
  }
}
...
{
  {
    ...
    HeadVar__2_2 = measurement_units__decimal_fraction_2_f_0((MR_String) "%.1f", Measure_3);
    return HeadVar__2_2;
  }
}
...
{
  {
    ...
    mercury__string__to_char_list_2_p_0(Str0_5, &Chars0_8);
    TypeCtorInfo_9_12 = (MR_Word) &mercury__builtin__builtin__type_ctor_info_character_0;
    mercury__list__reverse_2_p_0(TypeCtorInfo_9_12, Chars0_8, &RevChars0_9);
    Var_11 = measurement_units__add_commas_1_f_0(RevChars0_9);
    Var_10 = mercury__list__reverse_1_f_0(TypeCtorInfo_9_12, Var_11);
    mercury__string__from_char_list_2_p_0(Var_10, &Str_4);
    return Str_4;
  }
}
...
{
  {
    ...
    if (!(succeeded))
    {
      ...
      mercury__string__format__format_float_component_nowidth_noprec_4_p_0((MR_Word) &measurement_units_scalar_common_2[0], (MR_Integer) 2, Prob_3, &Var_12);
...
{
  {
    ...
    if (succeeded)
    {
      ...
      mercury__string__format__format_float_component_nowidth_prec_5_p_0((MR_Word) &measurement_units_scalar_common_2[0], (MR_Integer) 1, (MR_Integer) 2, Var_9, &Var_38);
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        mercury__string__format__format_float_component_nowidth_prec_5_p_0((MR_Word) &measurement_units_scalar_common_2[0], (MR_Integer) 1, (MR_Integer) 2, Var_16, &Var_48);
      ...
      else
      {
        ...
        if (succeeded)
        {
          ...
          mercury__string__format__format_float_component_nowidth_prec_5_p_0((MR_Word) &measurement_units_scalar_common_2[0], (MR_Integer) 1, (MR_Integer) 2, Var_23, &Var_58);
        ...
        else
        {
          ...
          if (succeeded)
          {
            ...
            mercury__string__format__format_float_component_nowidth_prec_5_p_0((MR_Word) &measurement_units_scalar_common_2[0], (MR_Integer) 1, (MR_Integer) 2, Var_30, &Var_68);
          ...
          else
          {
            ...
            mercury__string__format__format_float_component_nowidth_prec_5_p_0((MR_Word) &measurement_units_scalar_common_2[0], (MR_Integer) 1, (MR_Integer) 2, F_3, &Var_78);
...
{
  {
    ...
    mercury__string__format__format_float_component_nowidth_prec_5_p_0((MR_Word) &measurement_units_scalar_common_2[0], (MR_Integer) 2, (MR_Integer) 2, Var_8, &String_4);
    return String_4;
  }
}
...
{
  {
    ...
    succeeded = measurement_units__IntroducedFrom__pred__compare_memory__200__1_2_p_0(((MR_Integer) (MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3))), ((MR_Integer) (MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4))));
    return succeeded;
  }
}
  ...
  MR_Word * Result_6)
{
  {
    MR_bool succeeded;
    MR_Float WordsA_7 = MR_unbox_float((MR_hl_field(MR_mktag(0), MemoryA_4, (MR_Integer) 0)));
    MR_Integer WordSizeA_8 = ((MR_Integer) (MR_hl_field(MR_mktag(0), MemoryA_4, (MR_Integer) 1)));
    MR_Float WordsB_9 = MR_unbox_float((MR_hl_field(MR_mktag(0), MemoryB_5, (MR_Integer) 0)));
    MR_Integer WordSizeB_10 = ((MR_Integer) (MR_hl_field(MR_mktag(0), MemoryB_5, (MR_Integer) 1)));
    MR_Word Var_11;

    {
      Var_11 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 5 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), Var_11, 0) = ((MR_Box) (&measurement_units_scalar_common_1[0]));
      MR_hl_field(MR_mktag(0), Var_11, 1) = ((MR_Box) (measurement_units__compare_memory_3_p_0_1));
      MR_hl_field(MR_mktag(0), Var_11, 2) = ((MR_Box) (MR_Word) ((MR_Integer) 2));
      MR_hl_field(MR_mktag(0), Var_11, 3) = ((MR_Box) (WordSizeA_8));
      MR_hl_field(MR_mktag(0), Var_11, 4) = ((MR_Box) (WordSizeB_10));
    }
...
measurement_units__format_memory_3_f_0(
  MR_Word HeadVar__1_1,
  MR_Word HeadVar__2_2,
  MR_Integer Decimals_3)
{
  {
    MR_String HeadVar__4_4;
    MR_Integer Var_13 = ((MR_Integer) (MR_hl_field(MR_mktag(0), HeadVar__1_1, (MR_Integer) 1)));
    MR_Float Var_14 = MR_unbox_float((MR_hl_field(MR_mktag(0), HeadVar__1_1, (MR_Integer) 0)));
      ...
      case (MR_Integer) 1:
        {
          ...
          Var_8 = (Var_14 * Var_9);
          Var_21 = mercury__string__string_1_f_0((MR_Word) &mercury__builtin__builtin__type_ctor_info_int_0, ((MR_Box) (Decimals_3)));
          Var_20 = mercury__string__f_43_43_2_f_0(Var_21, (MR_String) "f");
          Format_18 = mercury__string__f_43_43_2_f_0((MR_String) "%.", Var_20);
          HeadVar__4_4 = measurement_units__decimal_fraction_2_f_0(Format_18, Var_8);
        }
        break;
      case (MR_Integer) 0:
        {
          ...
          Var_30 = mercury__string__string_1_f_0((MR_Word) &mercury__builtin__builtin__type_ctor_info_int_0, ((MR_Box) (Decimals_3)));
          Var_29 = mercury__string__f_43_43_2_f_0(Var_30, (MR_String) "f");
          Format_27 = mercury__string__f_43_43_2_f_0((MR_String) "%.", Var_29);
          HeadVar__4_4 = measurement_units__decimal_fraction_2_f_0(Format_27, Var_14);
        }
        break;
    }
    return HeadVar__4_4;
  ...
  MR_Float Measure_5)
{
  {
    MR_bool succeeded;
    MR_String Representation_6;
    MR_String Str0_7;
    MR_Word SubStrings_8;
    MR_Word Var_12;
    MR_Word Var_13;
    MR_String WholeString0_9;
    MR_String FractionString_10;
    MR_Word Var_16;
    MR_Word Var_17;

    {
      Var_13 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), Var_13, 0) = MR_box_float(Measure_5);
    }
    {
    ...
    mercury__string__format_3_p_0(Format_4, Var_12, &Str0_7);
    SubStrings_8 = mercury__string__split_at_char_2_f_0((MR_Char) 46, Str0_7);
    succeeded = ((MR_tag((MR_Word) SubStrings_8)) == (MR_mktag((MR_Integer) 1)));
    if (succeeded)
    {
      WholeString0_9 = ((MR_String) (MR_hl_field(MR_mktag(1), SubStrings_8, (MR_Integer) 0)));
      Var_16 = ((MR_Word) (MR_hl_field(MR_mktag(1), SubStrings_8, (MR_Integer) 1)));
      succeeded = ((MR_tag((MR_Word) Var_16)) == (MR_mktag((MR_Integer) 1)));
      if (succeeded)
      {
        FractionString_10 = ((MR_String) (MR_hl_field(MR_mktag(1), Var_16, (MR_Integer) 0)));
    ...
    if (succeeded)
    {
      MR_Word TypeCtorInfo_9_31;
      MR_String WholeString_11;
      MR_String Var_18;
      MR_Word Chars0_27;
      MR_Word RevChars0_28;
      MR_Word Var_29;
      MR_Word Var_30;

      mercury__string__to_char_list_2_p_0(WholeString0_9, &Chars0_27);
      TypeCtorInfo_9_31 = (MR_Word) &mercury__builtin__builtin__type_ctor_info_character_0;
      mercury__list__reverse_2_p_0(TypeCtorInfo_9_31, Chars0_27, &RevChars0_28);
      Var_30 = measurement_units__add_commas_1_f_0(RevChars0_28);
      Var_29 = mercury__list__reverse_1_f_0(TypeCtorInfo_9_31, Var_30);
      mercury__string__from_char_list_2_p_0(Var_29, &WholeString_11);
      Var_18 = mercury__string__f_43_43_2_f_0((MR_String) ".", FractionString_10);
      Representation_6 = mercury__string__f_43_43_2_f_0(WholeString_11, Var_18);
    }
    else
    {
      MR_String WholeString_24;
      MR_Word Var_20;

      succeeded = ((MR_tag((MR_Word) SubStrings_8)) == (MR_mktag((MR_Integer) 1)));
      if (succeeded)
      {
        WholeString_24 = ((MR_String) (MR_hl_field(MR_mktag(1), SubStrings_8, (MR_Integer) 0)));
        Var_20 = ((MR_Word) (MR_hl_field(MR_mktag(1), SubStrings_8, (MR_Integer) 1)));
        succeeded = (Var_20 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
      }
      if (succeeded)
      {
        MR_Word TypeCtorInfo_9_38;
        MR_Word Chars0_34;
        MR_Word RevChars0_35;
        MR_Word Var_36;
        MR_Word Var_37;

        mercury__string__to_char_list_2_p_0(WholeString_24, &Chars0_34);
        TypeCtorInfo_9_38 = (MR_Word) &mercury__builtin__builtin__type_ctor_info_character_0;
        mercury__list__reverse_2_p_0(TypeCtorInfo_9_38, Chars0_34, &RevChars0_35);
        Var_37 = measurement_units__add_commas_1_f_0(RevChars0_35);
        Var_36 = mercury__list__reverse_1_f_0(TypeCtorInfo_9_38, Var_37);
        mercury__string__from_char_list_2_p_0(Var_36, &Representation_6);
      }
      else
      {
...
{
  {
    ...
    else
    {
      ...
      MR_Char Var_36 = ((MR_Char) (MR_Word) (MR_hl_field(MR_mktag(1), HeadVar__1_1, (MR_Integer) 0)));
      ...
      {
        {
          ...
          MR_hl_field(MR_mktag(1), HeadVar__2_2, 0) = ((MR_Box) (MR_Word) (Var_36));
          MR_hl_field(MR_mktag(1), HeadVar__2_2, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
        }
      }
      else
      {
        MR_Word Var_37 = ((MR_Word) (MR_hl_field(MR_mktag(1), Var_35, (MR_Integer) 1)));
        MR_Char Var_38 = ((MR_Char) (MR_Word) (MR_hl_field(MR_mktag(1), Var_35, (MR_Integer) 0)));

        if ((Var_37 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
        {
          MR_Word Var_10;

          {
            Var_10 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), Var_10, 0) = ((MR_Box) (MR_Word) (Var_38));
            MR_hl_field(MR_mktag(1), Var_10, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
          }
          {
            HeadVar__2_2 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), HeadVar__2_2, 0) = ((MR_Box) (MR_Word) (Var_36));
            MR_hl_field(MR_mktag(1), HeadVar__2_2, 1) = ((MR_Box) (Var_10));
          }
        }
        else
        {
          MR_Word Var_39 = ((MR_Word) (MR_hl_field(MR_mktag(1), Var_37, (MR_Integer) 1)));
          MR_Char Var_40 = ((MR_Char) (MR_Word) (MR_hl_field(MR_mktag(1), Var_37, (MR_Integer) 0)));

          if ((Var_39 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
          {
            MR_Word Var_18;
            MR_Word Var_19;

            {
              ...
              MR_hl_field(MR_mktag(1), Var_19, 0) = ((MR_Box) (MR_Word) (Var_40));
            ...
            }
            {
              ...
              MR_hl_field(MR_mktag(1), Var_18, 0) = ((MR_Box) (MR_Word) (Var_38));
          ...
          else
          {
            ...
            Var_33 = measurement_units__add_commas_1_f_0(Var_39);
            {
              ...
              MR_hl_field(MR_mktag(1), Var_31, 0) = ((MR_Box) (MR_Word) ((MR_Char) 44));
            ...
            }
            {
              ...
              MR_hl_field(MR_mktag(1), Var_30, 0) = ((MR_Box) (MR_Word) (Var_40));
            ...
            }
            {
              ...
              MR_hl_field(MR_mktag(1), Var_29, 0) = ((MR_Box) (MR_Word) (Var_38));
              MR_hl_field(MR_mktag(1), Var_29, 1) = ((MR_Box) (Var_30));
            }
            {
              HeadVar__2_2 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), HeadVar__2_2, 0) = ((MR_Box) (MR_Word) (Var_36));
              MR_hl_field(MR_mktag(1), HeadVar__2_2, 1) = ((MR_Box) (Var_29));
            }
          }
        }
      }
...
{
  {
    ...
    MR_Word HeadVar__3_3;
    MR_Float Nom_4 = MR_unbox_float((MR_hl_field(MR_mktag(0), HeadVar__1_1, (MR_Integer) 0)));
    MR_Integer BPW_5 = ((MR_Integer) (MR_hl_field(MR_mktag(0), HeadVar__1_1, (MR_Integer) 1)));

    if (succeeded)
    {
      {
        HeadVar__3_3 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), HeadVar__3_3, 0) = MR_box_float((MR_Float) 0.0000000000000000);
        MR_hl_field(MR_mktag(0), HeadVar__3_3, 1) = ((MR_Box) (BPW_5));
      }
    }
    else
    {
      ...
      {
        HeadVar__3_3 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), HeadVar__3_3, 0) = MR_box_float(Var_8);
        MR_hl_field(MR_mktag(0), HeadVar__3_3, 1) = ((MR_Box) (BPW_5));
      }
    }
    return HeadVar__3_3;
...
{
  {
    ...
    {
      HeadVar__3_3 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), HeadVar__3_3, 0) = MR_box_float(WordsF_6);
      MR_hl_field(MR_mktag(0), HeadVar__3_3, 1) = ((MR_Box) (BytesPerWord_5));
    }
    return HeadVar__3_3;
  }
}
