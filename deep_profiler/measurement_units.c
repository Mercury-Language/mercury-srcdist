...
MR_define_entry(mercury__fn__f_109_101_97_115_117_114_101_109_101_110_116_95_117_110_105_116_115_95_95_47_2_0);
	...
	* (MR_Float *) &MR_sv(2) = MR_word_to_float(MR_tfield(0, MR_r1, 0));
...
MR_def_label(fn__f_109_101_97_115_117_114_101_109_101_110_116_95_117_110_105_116_115_95_95_47_2_0,5)
	...
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
	MR_r1 = MR_float_to_word(MR_float_from_dword_ptr(&MR_sv(2)));
	MR_r2 = MR_tempr1;
	}
...
MR_define_entry(mercury__fn__measurement_units__format_memory_3_0);
	...
	MR_sv(1) = MR_r3;
	* (MR_Float *) &MR_sv(5) = MR_word_to_float(MR_tfield(0, MR_r1, 0));
	MR_r1 = MR_tfield(0, MR_r1, 1);
	MR_np_call_localret_ent(fn__float__float_1_0,
		fn__measurement_units__format_memory_3_0_i4);
MR_def_label(fn__measurement_units__format_memory_3_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	* (MR_Float *) &MR_sv(3) = (MR_float_from_dword_ptr(&MR_sv(5)) * MR_word_to_float(MR_r1));
...
MR_def_label(fn__measurement_units__format_memory_3_0,7)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_float_to_word(MR_float_from_dword_ptr(&MR_sv(3)));
...
MR_def_label(fn__measurement_units__format_memory_3_0,11)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_float_to_word(MR_float_from_dword_ptr(&MR_sv(5)));
	MR_succip_word = MR_sv(6);
	MR_decr_sp(6);
	MR_np_tailcall_ent(fn__measurement_units__decimal_fraction_2_0);
#ifdef MR_maybe_local_thread_engine_base
...
MR_define_entry(mercury__measurement_units__compare_memory_3_0);
	...
	* (MR_Float *) &MR_sv(2) = MR_word_to_float(MR_tfield(0, MR_r1, 0));
	* (MR_Float *) &MR_sv(4) = MR_word_to_float(MR_tfield(0, MR_r2, 0));
	MR_r1 = MR_tempr1;
...
MR_def_label(measurement_units__compare_memory_3_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_float_to_word(MR_float_from_dword_ptr(&MR_sv(2)));
	MR_r2 = MR_float_to_word(MR_float_from_dword_ptr(&MR_sv(4)));
...
MR_def_label(measurement_units__percent_at_or_above_threshold_2_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	* (MR_Float *) &MR_sv(5) = (MR_float_from_dword_ptr(&MR_sv(2)) * MR_word_to_float(MR_r1));
	MR_r1 = MR_sv(3);
	MR_np_call_localret_ent(fn__float__float_1_0,
...
MR_def_label(measurement_units__percent_at_or_above_threshold_2_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_float_from_dword_ptr(&MR_sv(5)) >= MR_word_to_float(MR_r1));
...
MR_def_label(fn__measurement_units__ticks_to_time_2_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_float_to_word((MR_word_to_float(MR_r1) * MR_float_from_dword_ptr(&MR_sv(3))));
	MR_decr_sp_and_return(4);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_thread_engine_base
...
MR_define_entry(mercury__fn__measurement_units__or_2_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_float_to_word(((MR_Float) 1.0000000000000000 - (((MR_Float) 1.0000000000000000 - MR_word_to_float(MR_r1)) * ((MR_Float) 1.0000000000000000 - MR_word_to_float(MR_r2)))));
	MR_proceed();
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_thread_engine_base
