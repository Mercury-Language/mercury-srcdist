...
measurement_units__IntroducedFrom__pred__compare_memory__212__1_2_p_0(
...
static const MR_DuFunctorDescPtr measurement_units__measurement_units__du_stag_ordered_memory_0_0[1] = { &measurement_units__measurement_units__du_functor_desc_memory_0_0 };
...
static const MR_DuFunctorDescPtr measurement_units__measurement_units__du_name_ordered_memory_0[1] = { &measurement_units__measurement_units__du_functor_desc_memory_0_0 };

static const MR_Integer measurement_units__measurement_units__functor_number_map_memory_0[1] = { (MR_Integer) 0 };
...
static const MR_Integer measurement_units__measurement_units__functor_number_map_percent_0[1] = { (MR_Integer) 0 };
...
static const MR_Integer measurement_units__measurement_units__functor_number_map_time_0[1] = { (MR_Integer) 0 };
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = measurement_units__IntroducedFrom__pred__compare_memory__212__1_2_p_0(((MR_Integer) ((MR_hl_field(0, closure, 3)))), ((MR_Integer) ((MR_hl_field(0, closure, 4)))));
  return succeeded;
}
...
{
  MR_bool succeeded;
  MR_Float WordsA_7 = MR_unbox_float((MR_hl_field(0, MemoryA_4, 0)));
  MR_Integer WordSizeA_8 = ((MR_Integer) ((MR_hl_field(0, MemoryA_4, 1))));
  MR_Float WordsB_9 = MR_unbox_float((MR_hl_field(0, MemoryB_5, 0)));
  MR_Integer WordSizeB_10 = ((MR_Integer) ((MR_hl_field(0, MemoryB_5, 1))));
  MR_Word Var_11;
  ...
  MR_Word Decimals_3)
{
  ...
  MR_Integer Var_13 = ((MR_Integer) ((MR_hl_field(0, HeadVar__1_1, 1))));
  MR_Float Var_14 = MR_unbox_float((MR_hl_field(0, HeadVar__1_1, 0)));
  ...
  MR_String Str0_3)
{
  ...
  if (succeeded)
  {
    WholeString0_6 = ((MR_String) ((MR_hl_field(1, SubStrings_5, 0))));
    Var_10 = ((MR_Word) ((MR_hl_field(1, SubStrings_5, 1))));
    succeeded = (Var_10 != (MR_Word) ((MR_Unsigned) 0U));
    if (succeeded)
    {
      FractionString_7 = ((MR_String) ((MR_hl_field(1, Var_10, 0))));
  ...
  else
  {
    ...
    if (succeeded)
    {
      WholeString_17 = ((MR_String) ((MR_hl_field(1, SubStrings_5, 0))));
      Var_14 = ((MR_Word) ((MR_hl_field(1, SubStrings_5, 1))));
  ...
  MR_Word HeadVar__1_1)
{
  ...
  else
  {
    ...
    MR_Char Var_36 = ((MR_Char) (MR_Word) (MR_hl_field(1, HeadVar__1_1, 0)));
    ...
    {
      MR_Word Var_37 = ((MR_Word) ((MR_hl_field(1, Var_35, 1))));
      MR_Char Var_38 = ((MR_Char) (MR_Word) (MR_hl_field(1, Var_35, 0)));
      ...
      {
        MR_Word Var_39 = ((MR_Word) ((MR_hl_field(1, Var_37, 1))));
        MR_Char Var_40 = ((MR_Char) (MR_Word) (MR_hl_field(1, Var_37, 0)));
  ...
  MR_Integer Denom_6)
{
  ...
  MR_Word HeadVar__3_3;
  MR_Float Nom_4 = MR_unbox_float((MR_hl_field(0, HeadVar__1_1, 0)));
  MR_Integer BPW_5 = ((MR_Integer) ((MR_hl_field(0, HeadVar__1_1, 1))));
