...
{
  {
    ...
    if (measurement_units__succeeded)
      *measurement_units__HeadVar__1_1 = (MR_Integer) 0;
      ...
      {
        MR_Float measurement_units__Var_4 = MR_unbox_float((MR_Box) measurement_units__HeadVar__2_2);
        MR_Float measurement_units__Var_5 = MR_unbox_float((MR_Box) measurement_units__HeadVar__3_3);

        {
          mercury__private_builtin__builtin_compare_float_3_p_0(measurement_units__HeadVar__1_1, measurement_units__Var_4, measurement_units__Var_5);
        }
      }
  }
}
...
{
  {
    ...
    if (measurement_units__succeeded)
      ...
      {
        MR_Float measurement_units__Var_3 = MR_unbox_float((MR_Box) measurement_units__HeadVar__1_1);
        MR_Float measurement_units__Var_4 = MR_unbox_float((MR_Box) measurement_units__HeadVar__2_2);

        measurement_units__succeeded = (measurement_units__Var_3 == measurement_units__Var_4);
      }
    return measurement_units__succeeded;
  }
}
...
{
  {
    ...
    if (measurement_units__succeeded)
      *measurement_units__HeadVar__1_1 = (MR_Integer) 0;
      ...
      {
        MR_Float measurement_units__Var_4 = MR_unbox_float((MR_hl_field(MR_mktag(0), measurement_units__HeadVar__2_2, (MR_Integer) 0)));
        MR_Integer measurement_units__Var_5 = ((MR_Integer) (MR_hl_field(MR_mktag(0), measurement_units__HeadVar__2_2, (MR_Integer) 1)));
        MR_Float measurement_units__Var_6 = MR_unbox_float((MR_hl_field(MR_mktag(0), measurement_units__HeadVar__3_3, (MR_Integer) 0)));
        MR_Integer measurement_units__Var_7 = ((MR_Integer) (MR_hl_field(MR_mktag(0), measurement_units__HeadVar__3_3, (MR_Integer) 1)));
        MR_Word measurement_units__Var_8;

        {
          mercury__private_builtin__builtin_compare_float_3_p_0(&measurement_units__Var_8, measurement_units__Var_4, measurement_units__Var_6);
        }
        ...
        if (measurement_units__succeeded)
          *measurement_units__HeadVar__1_1 = measurement_units__Var_8;
          ...
          {
            mercury__private_builtin__builtin_compare_int_3_p_0(measurement_units__HeadVar__1_1, measurement_units__Var_5, measurement_units__Var_7);
          }
      }
  }
}
...
{
  {
    ...
    if (measurement_units__succeeded)
      ...
      {
        MR_Float measurement_units__Var_3 = MR_unbox_float((MR_hl_field(MR_mktag(0), measurement_units__HeadVar__1_1, (MR_Integer) 0)));
        MR_Integer measurement_units__Var_4 = ((MR_Integer) (MR_hl_field(MR_mktag(0), measurement_units__HeadVar__1_1, (MR_Integer) 1)));
        MR_Float measurement_units__Var_5 = MR_unbox_float((MR_hl_field(MR_mktag(0), measurement_units__HeadVar__2_2, (MR_Integer) 0)));
        MR_Integer measurement_units__Var_6 = ((MR_Integer) (MR_hl_field(MR_mktag(0), measurement_units__HeadVar__2_2, (MR_Integer) 1)));

        measurement_units__succeeded = (measurement_units__Var_3 == measurement_units__Var_5);
        if (measurement_units__succeeded)
          measurement_units__succeeded = (measurement_units__Var_4 == measurement_units__Var_6);
      }
    return measurement_units__succeeded;
  }
}
