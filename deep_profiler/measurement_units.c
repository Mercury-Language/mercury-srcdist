  ...
  MR_Box closure_arg)
{
  ...
  succeeded = measurement_units__IntroducedFrom__pred__compare_memory__212__1_2_p_0(((MR_Integer) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Integer) ((MR_hl_field(0, closure, (MR_Integer) 4)))));
  return succeeded;
}
