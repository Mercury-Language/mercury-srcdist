...
{
  {
    ...
    mercury__list__reverse_2_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_character_0), Chars0_8, &RevChars0_9);
    Var_11 = measurement_units__add_commas_1_f_0(RevChars0_9);
    Var_10 = mercury__list__reverse_1_f_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_character_0), Var_11);
...
{
  {
    ...
    succeeded = (SubStrings_8 != (MR_Word) ((MR_Unsigned) 0U));
    if (succeeded)
    {
    ...
    if (succeeded)
    {
      ...
      MR_String Var_18;
      MR_Word Chars0_26;
      MR_Word RevChars0_27;
      MR_Word Var_28;
      MR_Word Var_29;

      mercury__string__to_char_list_2_p_0(WholeString0_9, &Chars0_26);
      mercury__list__reverse_2_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_character_0), Chars0_26, &RevChars0_27);
      Var_29 = measurement_units__add_commas_1_f_0(RevChars0_27);
      Var_28 = mercury__list__reverse_1_f_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_character_0), Var_29);
      mercury__string__from_char_list_2_p_0(Var_28, &WholeString_11);
    ...
    {
      MR_String WholeString_23;
      MR_Word Var_20;

      succeeded = (SubStrings_8 != (MR_Word) ((MR_Unsigned) 0U));
      if (succeeded)
      {
        WholeString_23 = ((MR_String) ((MR_hl_field(MR_mktag(1), SubStrings_8, (MR_Integer) 0))));
      ...
      {
        MR_Word Chars0_33;
        MR_Word RevChars0_34;
        MR_Word Var_35;
        MR_Word Var_36;

        mercury__string__to_char_list_2_p_0(WholeString_23, &Chars0_33);
        mercury__list__reverse_2_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_character_0), Chars0_33, &RevChars0_34);
        Var_36 = measurement_units__add_commas_1_f_0(RevChars0_34);
        Var_35 = mercury__list__reverse_1_f_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_character_0), Var_36);
        mercury__string__from_char_list_2_p_0(Var_35, &Representation_6);
      }
      else
        mercury__require__unexpected_2_p_0((MR_String) "function \140measurement_units.decimal_fraction\'/2", (MR_String) "didn\'t split on decimal point properly");
    }
