...
static /* final */ const struct mdprof_create_feedback__vector_common_type_7_0_s mdprof_create_feedback_vector_common_7[21] = {
  ...
  {
    (MR_Integer) 0,
    (MR_Word) (MR_mkword(MR_mktag(1), &mdprof_create_feedback_scalar_common_2[3]))
  },
  /* row 1 */
  {
    (MR_Integer) 2,
...
{
  {
    ...
    {
      MR_Word Error_22 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MaybeOptions_7, (MR_Integer) 0))));
      MR_String Msg_23;
      MR_String Var_85;
      MR_String Var_94;

      Msg_23 = mercury__getopt__option_error_to_string_1_f_0((MR_Word) (&mdprof_create_feedback__mdprof_create_feedback__type_ctor_info_option_0), Error_22);
    ...
    else
    {
      ...
      else
      {
        ...
        {
          MR_Word Var_72 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Args_6, (MR_Integer) 1))));
          MR_String Var_73 = ((MR_String) ((MR_hl_field(MR_mktag(1), Args_6, (MR_Integer) 0))));
          ...
          {
            MR_Word Var_74 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Var_72, (MR_Integer) 1))));
            MR_String Var_75 = ((MR_String) ((MR_hl_field(MR_mktag(1), Var_72, (MR_Integer) 0))));
            ...
            if ((Var_74 == (MR_Word) ((MR_Unsigned) 0U)))
            {
              ...
              switch (FoundError_15) {
                ...
                case (MR_Integer) 1:
                  ...
                  break;
                case (MR_Integer) 0:
                  mdprof_create_feedback__generate_requested_feedback_7_p_0(ProgName_4, Options_10, Var_73, Var_75, RequestedFeedbackInfo_16);
                  break;
              }
            }
            else
...
{
  {
    ...
    switch (HeadVar__1_1) {
      ...
      case (MR_Integer) 1:
        ...
        {
          *HeadVar__3_3 = (MR_Word) (MR_mkword(MR_mktag(1), &mdprof_create_feedback_scalar_common_2[2]));
          succeeded = MR_TRUE;
        }
        else
          succeeded = MR_FALSE;
