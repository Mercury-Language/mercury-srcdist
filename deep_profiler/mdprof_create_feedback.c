...
{
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        *Algorithm_6 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 1));
        succeeded = MR_TRUE;
      }
      else
      {
        ...
        else
        {
          ...
          else
          {
            ...
            if (succeeded)
            {
              *Algorithm_6 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
              succeeded = MR_TRUE;
            }
          }
        }
...
{
  {
    ...
    TypeCtorInfo_64_64 = (MR_Word) &mdprof_create_feedback__mdprof_create_feedback__type_ctor_info_option_0;
    mercury__getopt__process_options_4_p_0(TypeCtorInfo_64_64, (MR_Word) MR_mkword(MR_mktag(2), &mdprof_create_feedback_scalar_common_4[4]), Args0_5, &Args_6, &MaybeOptions_7);
    mercury__io__stderr_stream_3_p_0(&Stderr_8);
    if (((MR_tag((MR_Word) MaybeOptions_7)) == (MR_mktag((MR_Integer) 1))))
    {
      MR_String Msg_22 = ((MR_String) (MR_hl_field(MR_mktag(1), MaybeOptions_7, (MR_Integer) 0)));
      MR_String Var_84;
      MR_String Var_93;
    ...
    else
    {
      ...
      mdprof_create_feedback__post_process_options_5_p_0(ProgName_4, Options0_9, &Options_10);
      mercury__getopt__lookup_bool_option_3_p_0(TypeCtorInfo_64_64, Options_10, ((MR_Box) ((MR_Integer) 0)), &Help_11);
      mercury__getopt__lookup_bool_option_3_p_0(TypeCtorInfo_64_64, Options_10, ((MR_Box) ((MR_Integer) 1)), &Version_12);
      succeeded = (Version_12 == (MR_Integer) 1);
      if (succeeded)
        mdprof_create_feedback__write_version_message_3_p_0(ProgName_4);
      else
      {
        succeeded = (Help_11 == (MR_Integer) 1);
        if (succeeded)
          mdprof_create_feedback__write_help_message_3_p_0(ProgName_4);
        else
        ...
        {
          MR_Word Var_71 = ((MR_Word) (MR_hl_field(MR_mktag(1), Args_6, (MR_Integer) 1)));
          MR_String Var_72 = ((MR_String) (MR_hl_field(MR_mktag(1), Args_6, (MR_Integer) 0)));

          if ((Var_71 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
          {
            mdprof_create_feedback__write_help_message_3_p_0(ProgName_4);
            mercury__io__set_exit_status_3_p_0((MR_Integer) 1);
          }
          ...
          {
            MR_Word Var_73 = ((MR_Word) (MR_hl_field(MR_mktag(1), Var_71, (MR_Integer) 1)));
            MR_String Var_74 = ((MR_String) (MR_hl_field(MR_mktag(1), Var_71, (MR_Integer) 0)));

            if ((Var_73 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
            {
              MR_Word FoundError_15;
              MR_Word RequestedFeedbackInfo_16;

              mdprof_create_feedback__get_feedback_requests_6_p_0(ProgName_4, Options_10, &FoundError_15, &RequestedFeedbackInfo_16);
              switch (FoundError_15) {
                ...
                case (MR_Integer) 1:
                  ...
                  break;
                case (MR_Integer) 0:
                  mdprof_create_feedback__generate_requested_feedback_7_p_0(ProgName_4, Options_10, Var_72, Var_74, RequestedFeedbackInfo_16);
                  break;
              }
            }
            else
...
{
  {
    ...
    TypeCtorInfo_117_117 = (MR_Word) &mdprof_create_feedback__mdprof_create_feedback__type_ctor_info_option_0;
    mercury__getopt__lookup_bool_option_3_p_0(TypeCtorInfo_117_117, Options_8, ((MR_Box) ((MR_Integer) 5)), &CandidateParallelConjunctions_13);
    switch (CandidateParallelConjunctions_13) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        {
          MaybeAutoParOpts_41 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
      ...
      case (MR_Integer) 1:
        {
          ...
          mercury__getopt__lookup_string_option_3_p_0(TypeCtorInfo_117_117, Options_8, ((MR_Box) ((MR_Integer) 7)), &DesiredParallelismStr_14);
          ...
          mercury__getopt__lookup_string_option_3_p_0(TypeCtorInfo_117_117, Options_8, ((MR_Box) ((MR_Integer) 17)), &SpeedupThresholdStr_17);
          ...
          mercury__getopt__lookup_bool_option_3_p_0(TypeCtorInfo_117_117, Options_8, ((MR_Box) ((MR_Integer) 8)), &IntermoduleVarUse_20);
          mercury__getopt__lookup_int_option_3_p_0(TypeCtorInfo_117_117, Options_8, ((MR_Box) ((MR_Integer) 9)), &SparkingCost_21);
          mercury__getopt__lookup_int_option_3_p_0(TypeCtorInfo_117_117, Options_8, ((MR_Box) ((MR_Integer) 10)), &SparkingDelay_22);
          mercury__getopt__lookup_int_option_3_p_0(TypeCtorInfo_117_117, Options_8, ((MR_Box) ((MR_Integer) 11)), &BarrierCost_23);
          mercury__getopt__lookup_int_option_3_p_0(TypeCtorInfo_117_117, Options_8, ((MR_Box) ((MR_Integer) 12)), &FutureSignalCost_24);
          mercury__getopt__lookup_int_option_3_p_0(TypeCtorInfo_117_117, Options_8, ((MR_Box) ((MR_Integer) 13)), &FutureWaitCost_25);
          mercury__getopt__lookup_int_option_3_p_0(TypeCtorInfo_117_117, Options_8, ((MR_Box) ((MR_Integer) 14)), &ContextWakeupDelay_26);
          mercury__getopt__lookup_int_option_3_p_0(TypeCtorInfo_117_117, Options_8, ((MR_Box) ((MR_Integer) 15)), &CPCCliqueThreshold_27);
          mercury__getopt__lookup_int_option_3_p_0(TypeCtorInfo_117_117, Options_8, ((MR_Box) ((MR_Integer) 16)), &CPCCallSiteThreshold_28);
          mercury__getopt__lookup_bool_option_3_p_0(TypeCtorInfo_117_117, Options_8, ((MR_Box) ((MR_Integer) 18)), &AllowDepConjs_29);
          mercury__getopt__lookup_string_option_3_p_0(TypeCtorInfo_117_117, Options_8, ((MR_Box) ((MR_Integer) 19)), &SpeedupAlgString_30);
          ...
          else
          {
            ...
            SpeedupAlg_32 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
          }
          mercury__getopt__lookup_string_option_3_p_0(TypeCtorInfo_117_117, Options_8, ((MR_Box) ((MR_Integer) 20)), &AlgForFindingBestParStr_33);
          mdprof_create_feedback__parse_best_par_algorithm_2_p_0(AlgForFindingBestParStr_33, &MaybeAlgForFindingBestPar_34);
          if (((MR_tag((MR_Word) MaybeAlgForFindingBestPar_34)) == (MR_mktag((MR_Integer) 1))))
          {
            MR_Word MaybeMessage_36 = ((MR_Word) (MR_hl_field(MR_mktag(1), MaybeAlgForFindingBestPar_34, (MR_Integer) 0)));
            MR_Integer _Line_37 = ((MR_Integer) (MR_hl_field(MR_mktag(1), MaybeAlgForFindingBestPar_34, (MR_Integer) 1)));
            MR_Integer _Col_38 = ((MR_Integer) (MR_hl_field(MR_mktag(1), MaybeAlgForFindingBestPar_34, (MR_Integer) 2)));

            if ((MaybeMessage_36 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
            {
              mercury__io__write_string_4_p_0(Stderr_12, ProgName_7);
              mercury__io__write_string_4_p_0(Stderr_12, (MR_String) ": error: ");
            ...
            *STATE_VARIABLE_Error_42 = (MR_Integer) 1;
            AlgForFindingBestPar_35 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 1));
          }
          else
          {
          ...
          {
            AutoParOpts_40 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 13 * sizeof(MR_Word)), NULL, NULL);
            MR_hl_field(MR_mktag(0), AutoParOpts_40, 0) = MR_box_float(DesiredParallelism_16);
            MR_hl_field(MR_mktag(0), AutoParOpts_40, 1) = ((MR_Box) (IntermoduleVarUse_20));
          ...
          {
            MaybeAutoParOpts_41 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
...
{
  {
    ...
    switch (HeadVar__1_1) {
      ...
      case (MR_Integer) 1:
        ...
        {
          *HeadVar__3_3 = (MR_Word) MR_mkword(MR_mktag(1), &mdprof_create_feedback_scalar_common_2[3]);
          succeeded = MR_TRUE;
        }
        else
        if ((strcmp(HeadVar__2_2, (MR_String) "overlap") == 0))
        {
          *HeadVar__3_3 = (MR_Word) MR_mkword(MR_mktag(1), &mdprof_create_feedback_scalar_common_2[4]);
          succeeded = MR_TRUE;
        }
        else
          succeeded = MR_FALSE;
  ...
  MR_Word * STATE_VARIABLE_Options_13)
{
  {
    MR_bool succeeded;
    MR_Word TypeCtorInfo_44_44 = (MR_Word) &mdprof_create_feedback__mdprof_create_feedback__type_ctor_info_option_0;
    MR_Integer VerbosityLevel_9;
    MR_Word Stderr_10;
    MR_Word ImplicitParallelism_11;
    MR_Word STATE_VARIABLE_Options_26_26;

    mercury__getopt__lookup_int_option_3_p_0(TypeCtorInfo_44_44, STATE_VARIABLE_Options_0_12, ((MR_Box) ((MR_Integer) 2)), &VerbosityLevel_9);
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        mercury__map__set_4_p_0((MR_Word) &mdprof_create_feedback__mdprof_create_feedback__type_ctor_info_option_0, (MR_Word) &mercury__getopt__getopt__type_ctor_info_option_data_0, ((MR_Box) ((MR_Integer) 2)), ((MR_Box) (MR_mkword(MR_mktag(2), &mdprof_create_feedback_scalar_common_2[1]))), STATE_VARIABLE_Options_0_12, &STATE_VARIABLE_Options_26_26);
      }
      else
        STATE_VARIABLE_Options_26_26 = STATE_VARIABLE_Options_0_12;
    }
    message__set_verbosity_level_3_p_0(VerbosityLevel_9);
    mercury__getopt__lookup_bool_option_3_p_0(TypeCtorInfo_44_44, STATE_VARIABLE_Options_26_26, ((MR_Box) ((MR_Integer) 6)), &ImplicitParallelism_11);
    switch (ImplicitParallelism_11) {
      ...
      case (MR_Integer) 1:
        {
          mercury__map__set_4_p_0((MR_Word) &mdprof_create_feedback__mdprof_create_feedback__type_ctor_info_option_0, (MR_Word) &mercury__getopt__getopt__type_ctor_info_option_data_0, ((MR_Box) ((MR_Integer) 5)), ((MR_Box) (MR_mkword(MR_mktag(1), &mdprof_create_feedback_scalar_common_2[2]))), STATE_VARIABLE_Options_26_26, STATE_VARIABLE_Options_13);
        }
        break;
    }
  }
...
{
  {
    ...
    Var_17 = mercury__string__f_43_43_2_f_0(ProgName_4, (MR_String) " [<options>] <profdatafile> <feedbackfile>\n    This command generates feedback information from profiling data.\n\n    The first argument must name a deep profili" "ng data file such as Deep.data.\n    The second argument should be the name of the file into which this command\n    should put the feedback information it genera" "tes.\n\n    You may specify the following general options:\n\n    -h --help       Generate this help message.\n    -V --version    Report the program\'s version numbe" "r.\n    -v --verbosity  <0-4>\n                    Generate messages. The higher the argument, the more\n                    verbose the program becomes. 2 is reco" "mmended and the\n                    default.\n    --debug-read-profile\n                    Generate debugging messages when reading the deep profile\n            " "        and creating the deep structure.\n    --report        Print a report about the feedback information after any\n                    processing has been don" "e.\n\n    The following options select sets of feedback information useful\n    for particular compiler optimizations:\n\n    --implicit-parallelism\n                " "Generate information that the compiler can use for automatic\n                parallelization.\n    --desired-parallelism <value>\n                The amount of de" "sired parallelism for implicit parallelism,\n                which must be a floating point number above 1.0.\n                Note: This option is currently igno" "red.\n    --implicit-parallelism-intermodule-var-use\n                Assume that the compiler will be able to push signals and waits\n                for futures " "across module boundaries.\n    --ipar-sparking-cost <value>\n                The cost of creating a spark, measured in the deep profiler\'s\n                call se" "quence counts.\n    --ipar-sparking-delay <value>\n                The time taken from the time a spark is created until the spark\n                is executed by " "another processor, assuming that there is a free\n                processor.\n    --ipar-barrier-cost <value>\n                The cost of executing the barrier co" "de at the end of each\n                parallel conjunct.\n    --ipar-future-signal-cost <value>\n                The cost of the signal() call for the producer of" " a shared\n                variable, measured in the profiler\'s call sequence counts.\n    --ipar-future-wait-cost <value>\n                The cost of the wait() " "call for the consumer of a shared\n                variable, measured in the profiler\'s call sequence counts.\n    --ipar-context-wakeup-delay <value>\n           " "     The time taken for a context to resume execution after being\n                placed on the run queue. This is used to estimate the impact\n                o" "f blocking of a context\'s execution, it is measured in the\n                profiler\'s call sequence counts.\n    --ipar-clique-cost-threshold <value>\n           " "     The cost threshold for cliques to be considered for implicit\n                parallelism, measured on the profiler\'s call sequence counts.\n    --ipar-call-" "site-cost-threshold <value>\n                The cost of a call site to be considered for parallelism\n                against another call site.\n    --no-ipar-de" "p-conjs\n                Disable parallelisation of dependent conjunctions.\n    --ipar-speedup-alg <alg>\n                Choose the algorithm that is used to est" "imate the speedup for\n                dependent calculations. The available algorithms are:\n                    overlap: Compute the overlap between dependent\n " "                     conjunctions.\n                    num_vars: Use the number of shared variables as a proxy for\n                      the amount of overlap a" "vailable.\n                    naive: Ignore dependencies.\n                The default is overlap.\n    --ipar-speedup-threshold <value>\n                The thres" "hold that a speedup ratio must meet before the\n                feedback tool will accept a parallelization. It must be\n                a floating point number, " "which must be at least 1.0.\n                If it is e.g. 1.02, then the feedback tool will ignore\n                parallelizations that promise less than a 2% " "local speedup.\n    --ipar-best-par-alg <alg>\n                Select which algorithm to use to find the best way to\n                parallelise a conjunction. Th" "e available algorithms are:\n                    greedy: A greedy algorithm with a linear time complexity.\n                    complete: A complete algorithm wit" "h a branch and bound\n                      search. This can be slow for problems larger than 50\n                      conjuncts, since it has an exponential com" "plexity.\n                    complete-size(N): As above exept that it takes a single\n                      parameter, N. If a conjunction has more than N\n      " "                conjuncts, then the greedy algorithm will be used.\n                    complete-branches(N): The same as the complete algorithm,\n               " "       except that it allows at most N branches to be created\n                      during the search. Once N branches have been created,\n                      " "a greedy search is used on each open branch.\n                The default is complete-branches(1000).\n\n    The following options select specific types of feedbac" "k information\n    and parameterise them:\n\n    --candidate-parallel-conjunctions\n                Produce a list of candidate parallel conjunctions for implicit\n " "               parallelism. This option uses the implicit parallelism\n                settings above.\n\n");
...
{
  {
    ...
    if ((MaybeParallelize_15 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
    {
    ...
    {
      MR_Word TypeCtorInfo_122_122 = (MR_Word) &mdprof_create_feedback__mdprof_create_feedback__type_ctor_info_option_0;
      MR_Word DebugReadProfile_17;
      MR_Word Report_18;
      MR_Word MaybeDeep_19;

      mercury__getopt__lookup_bool_option_3_p_0(TypeCtorInfo_122_122, Options_9, ((MR_Box) ((MR_Integer) 3)), &DebugReadProfile_17);
      mercury__getopt__lookup_bool_option_3_p_0(TypeCtorInfo_122_122, Options_9, ((MR_Box) ((MR_Integer) 4)), &Report_18);
      mdprof_create_feedback__read_deep_file_5_p_0(InputFileName_10, DebugReadProfile_17, &MaybeDeep_19);
      if (((MR_tag((MR_Word) MaybeDeep_19)) == (MR_mktag((MR_Integer) 1))))
      {
        MR_String Error_84 = ((MR_String) (MR_hl_field(MR_mktag(1), MaybeDeep_19, (MR_Integer) 0)));
        ...
        mercury__io__write_string_4_p_0(Stderr_14, Error_84);
        mercury__io__write_string_4_p_0(Stderr_14, (MR_String) "\n");
      }
      else
      {
        ...
        if (((MR_tag((MR_Word) MaybeProgRep_21)) == (MR_mktag((MR_Integer) 1))))
        {
          MR_String Error_83 = ((MR_String) (MR_hl_field(MR_mktag(1), MaybeProgRep_21, (MR_Integer) 0)));

          mercury__io__set_exit_status_3_p_0((MR_Integer) 1);
          mercury__io__write_string_4_p_0(Stderr_14, ProgName_8);
          mercury__io__write_string_4_p_0(Stderr_14, (MR_String) ": ");
          mercury__io__write_string_4_p_0(Stderr_14, Error_83);
          mercury__io__write_string_4_p_0(Stderr_14, (MR_String) "\n");
        }
        else
        {
          ...
          MR_Word Var_64 = ((MR_Word) (MR_hl_field(MR_mktag(0), Deep_20, (MR_Integer) 0)));
          MR_String Var_85 = ((MR_String) (MR_hl_field(MR_mktag(0), Deep_20, (MR_Integer) 1)));
          MR_String Var_86 = ((MR_String) (MR_hl_field(MR_mktag(0), Deep_20, (MR_Integer) 2)));
          MR_String Var_87 = ((MR_String) (MR_hl_field(MR_mktag(0), Deep_20, (MR_Integer) 3)));
          MR_Word Var_88 = ((MR_Word) (MR_hl_field(MR_mktag(0), Deep_20, (MR_Integer) 4)));
          MR_ArrayPtr Var_89 = ((MR_ArrayPtr) (MR_hl_field(MR_mktag(0), Deep_20, (MR_Integer) 5)));
          MR_ArrayPtr Var_90 = ((MR_ArrayPtr) (MR_hl_field(MR_mktag(0), Deep_20, (MR_Integer) 6)));
          MR_ArrayPtr Var_91 = ((MR_ArrayPtr) (MR_hl_field(MR_mktag(0), Deep_20, (MR_Integer) 7)));
          MR_ArrayPtr Var_92 = ((MR_ArrayPtr) (MR_hl_field(MR_mktag(0), Deep_20, (MR_Integer) 8)));
          MR_ArrayPtr Var_93 = ((MR_ArrayPtr) (MR_hl_field(MR_mktag(0), Deep_20, (MR_Integer) 9)));
          MR_ArrayPtr Var_94 = ((MR_ArrayPtr) (MR_hl_field(MR_mktag(0), Deep_20, (MR_Integer) 10)));
          MR_ArrayPtr Var_95 = ((MR_ArrayPtr) (MR_hl_field(MR_mktag(0), Deep_20, (MR_Integer) 11)));
          MR_ArrayPtr Var_96 = ((MR_ArrayPtr) (MR_hl_field(MR_mktag(0), Deep_20, (MR_Integer) 12)));
          MR_ArrayPtr Var_97 = ((MR_ArrayPtr) (MR_hl_field(MR_mktag(0), Deep_20, (MR_Integer) 13)));
          MR_ArrayPtr Var_98 = ((MR_ArrayPtr) (MR_hl_field(MR_mktag(0), Deep_20, (MR_Integer) 14)));
          MR_ArrayPtr Var_99 = ((MR_ArrayPtr) (MR_hl_field(MR_mktag(0), Deep_20, (MR_Integer) 15)));
          MR_ArrayPtr Var_100 = ((MR_ArrayPtr) (MR_hl_field(MR_mktag(0), Deep_20, (MR_Integer) 16)));
          MR_ArrayPtr Var_101 = ((MR_ArrayPtr) (MR_hl_field(MR_mktag(0), Deep_20, (MR_Integer) 17)));
          MR_ArrayPtr Var_102 = ((MR_ArrayPtr) (MR_hl_field(MR_mktag(0), Deep_20, (MR_Integer) 18)));
          MR_ArrayPtr Var_103 = ((MR_ArrayPtr) (MR_hl_field(MR_mktag(0), Deep_20, (MR_Integer) 19)));
          MR_ArrayPtr Var_104 = ((MR_ArrayPtr) (MR_hl_field(MR_mktag(0), Deep_20, (MR_Integer) 20)));
          MR_ArrayPtr Var_105 = ((MR_ArrayPtr) (MR_hl_field(MR_mktag(0), Deep_20, (MR_Integer) 21)));
          MR_ArrayPtr Var_106 = ((MR_ArrayPtr) (MR_hl_field(MR_mktag(0), Deep_20, (MR_Integer) 22)));
          MR_ArrayPtr Var_107 = ((MR_ArrayPtr) (MR_hl_field(MR_mktag(0), Deep_20, (MR_Integer) 23)));
          MR_ArrayPtr Var_108 = ((MR_ArrayPtr) (MR_hl_field(MR_mktag(0), Deep_20, (MR_Integer) 24)));
          MR_Word Var_109 = ((MR_Word) (MR_hl_field(MR_mktag(0), Deep_20, (MR_Integer) 25)));
          MR_Word Var_110 = ((MR_Word) (MR_hl_field(MR_mktag(0), Deep_20, (MR_Integer) 26)));
          MR_Word Var_111 = ((MR_Word) (MR_hl_field(MR_mktag(0), Deep_20, (MR_Integer) 27)));
          MR_Word Var_112 = ((MR_Word) (MR_hl_field(MR_mktag(0), Deep_20, (MR_Integer) 28)));
          MR_Integer Var_113;
          MR_Integer Var_114;
          MR_Integer Var_115;
          MR_Integer Var_116;
          ...
          ProfiledProgramName_23 = ((MR_String) (MR_hl_field(MR_mktag(0), Var_64, (MR_Integer) 0)));
          Var_113 = ((MR_Integer) (MR_hl_field(MR_mktag(0), Var_64, (MR_Integer) 1)));
          Var_114 = ((MR_Integer) (MR_hl_field(MR_mktag(0), Var_64, (MR_Integer) 2)));
          Var_115 = ((MR_Integer) (MR_hl_field(MR_mktag(0), Var_64, (MR_Integer) 3)));
          Var_116 = ((MR_Integer) (MR_hl_field(MR_mktag(0), Var_64, (MR_Integer) 4)));
          Var_117 = ((MR_Integer) (MR_hl_field(MR_mktag(0), Var_64, (MR_Integer) 5)));
          Var_118 = ((MR_Integer) (MR_hl_field(MR_mktag(0), Var_64, (MR_Integer) 6)));
          Var_119 = ((MR_Integer) (MR_hl_field(MR_mktag(0), Var_64, (MR_Integer) 7)));
          Var_120 = ((MR_Integer) (MR_hl_field(MR_mktag(0), Var_64, (MR_Integer) 8)));
          Var_121 = ((MR_Word) (MR_hl_field(MR_mktag(0), Var_64, (MR_Integer) 9)));
          mdbcomp__feedback__read_or_create_feedback_file_5_p_0(OutputFileName_11, ProfiledProgramName_23, &FeedbackReadResult_24);
          if (((MR_tag((MR_Word) FeedbackReadResult_24)) == (MR_mktag((MR_Integer) 1))))
          {
            MR_Word FeedbackReadError_31 = ((MR_Word) (MR_hl_field(MR_mktag(1), FeedbackReadResult_24, (MR_Integer) 0)));
            MR_String Message_32;

            mdbcomp__feedback__feedback_read_error_message_string_3_p_0(OutputFileName_11, FeedbackReadError_31, &Message_32);
            mercury__io__write_string_4_p_0(Stderr_14, Message_32);
            mercury__io__set_exit_status_3_p_0((MR_Integer) 1);
          }
          else
          {
            ...
            switch (Report_18) {
              ...
              case (MR_Integer) 0:
                ...
                break;
              case (MR_Integer) 1:
                mdprof_fb__automatic_parallelism__autopar_reports__print_feedback_report_3_p_0(Feedback_27);
                break;
            }
            mdbcomp__feedback__write_feedback_file_5_p_0(OutputFileName_11, Feedback_27, &WriteResult_28);
            switch (MR_tag((MR_Word) WriteResult_28)) {
              default: /*NOTREACHED*/ MR_assert(0);
              case (MR_Integer) 0:
                {
                }
              ...
              case (MR_Integer) 1:
                {
                  MR_Word Error_29 = ((MR_Word) (MR_hl_field(MR_mktag(1), WriteResult_28, (MR_Integer) 0)));
                  MR_String ErrorMessage_30;

                  mercury__io__error_message_2_p_0(Error_29, &ErrorMessage_30);
                  mercury__io__write_string_4_p_0(Stderr_14, ProgName_8);
                  mercury__io__write_string_4_p_0(Stderr_14, (MR_String) ": ");
                  mercury__io__write_string_4_p_0(Stderr_14, OutputFileName_11);
                  mercury__io__write_string_4_p_0(Stderr_14, (MR_String) ": ");
                  mercury__io__write_string_4_p_0(Stderr_14, ErrorMessage_30);
                  mercury__io__write_string_4_p_0(Stderr_14, (MR_String) "\n");
                  mercury__io__set_exit_status_3_p_0((MR_Integer) 1);
                }
                break;
              case (MR_Integer) 2:
                {
                  MR_Word Error_123 = ((MR_Word) (MR_hl_field(MR_mktag(2), WriteResult_28, (MR_Integer) 0)));
                  MR_String ErrorMessage_124;

                  mercury__io__error_message_2_p_0(Error_123, &ErrorMessage_124);
                  mercury__io__write_string_4_p_0(Stderr_14, ProgName_8);
                  mercury__io__write_string_4_p_0(Stderr_14, (MR_String) ": ");
                  mercury__io__write_string_4_p_0(Stderr_14, OutputFileName_11);
                  mercury__io__write_string_4_p_0(Stderr_14, (MR_String) ": ");
                  mercury__io__write_string_4_p_0(Stderr_14, ErrorMessage_124);
                  mercury__io__write_string_4_p_0(Stderr_14, (MR_String) "\n");
                  mercury__io__set_exit_status_3_p_0((MR_Integer) 1);
                }
                break;
...
{
  {
    ...
    if ((MaybeAutoParOpts_10 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
    {
...
{
  {
    ...
    switch (Debug_7) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        MaybeOutput_13 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
        break;
      case (MR_Integer) 1:
        {
          MR_Word Stdout_12;
          ...
          {
            MaybeOutput_13 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), MaybeOutput_13, 0) = ((MR_Box) (Stdout_12));
          }
        }
        break;
    }
    startup__read_and_startup_default_deep_options_9_p_0((MR_String) "DummyServer", (MR_String) "DummyScript", Input_6, (MR_Integer) 0, MaybeOutput_13, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), MaybeDeep_8);
  }
}
