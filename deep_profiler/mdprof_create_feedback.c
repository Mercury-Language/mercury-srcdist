...
static const struct mercury_type_6 mercury_vector_common_6_0[21] =
{
{
0,
MR_TAG_COMMON(1,0,0)
...
MR_def_label(mdprof_create_feedback__post_process_options_5_0,18)
	...
	MR_r2 = (MR_Word) MR_CTOR0_ADDR(getopt, option_data);
	MR_r3 = (MR_Integer) 5;
	MR_r4 = (MR_Word) MR_TAG_COMMON(1,0,2);
	MR_r5 = MR_sv(3);
...
MR_def_label(mdprof_create_feedback__get_feedback_requests_6_0,9)
	...
	* (MR_Float *) &MR_sv(4) = MR_word_to_float(MR_r2);
	MR_r2 = MR_sv(14);
...
MR_def_label(mdprof_create_feedback__get_feedback_requests_6_0,21)
	...
	* (MR_Float *) &MR_sv(18) = MR_word_to_float(MR_r2);
	MR_r2 = MR_sv(14);
	MR_sv(19) = MR_sv(16);
	MR_r3 = (MR_Integer) 8;
	MR_r1 = MR_sv(20);
...
MR_def_label(mdprof_create_feedback__get_feedback_requests_6_0,59)
	...
	MR_tfield(0, MR_tempr1, 0) = MR_float_to_word(MR_float_from_dword_ptr(&MR_sv(4)));
	...
	MR_tfield(0, MR_tempr1, 10) = MR_float_to_word(MR_float_from_dword_ptr(&MR_sv(18)));
	MR_tfield(0, MR_tempr1, 11) = MR_sv(14);
	MR_tfield(0, MR_tempr1, 12) = (MR_Word) MR_tbmkword(0, 1);
...
MR_def_label(mdprof_create_feedback__get_feedback_requests_6_0,53)
	...
	MR_tfield(0, MR_tempr1, 10) = MR_float_to_word(MR_float_from_dword_ptr(&MR_sv(18)));
	MR_tfield(0, MR_tempr1, 11) = MR_sv(14);
	MR_tfield(0, MR_tempr1, 12) = MR_tfield(0, MR_r1, 0);
	MR_tag_alloc_heap(MR_tempr2, 1, (MR_Integer) 1);
	MR_tfield(1, MR_tempr2, 0) = MR_tempr1;
	MR_r2 = MR_tempr2;
	MR_r1 = MR_sv(19);
...
MR_def_static(__Unify___mdprof_create_feedback__requested_feedback_info_0_0)
	...
	MR_sv(1) = MR_r1;
	MR_sv(2) = MR_r2;
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(mdbcomp__feedback__automatic_parallelism, candidate_par_conjunctions_params);
	MR_r2 = MR_sv(1);
	MR_r3 = MR_sv(2);
	MR_decr_sp(3);
