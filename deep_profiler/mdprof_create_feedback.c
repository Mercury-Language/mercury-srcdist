...
{
  {
    ...
    startup__read_and_startup_default_deep_options_9_p_0((MR_String) "DummyServer", (MR_String) "DummyScript", Input_6, (MR_Integer) 0, MaybeOutput_13, (MR_Word) ((MR_Unsigned) 0U), MaybeDeep_8);
  }
}
