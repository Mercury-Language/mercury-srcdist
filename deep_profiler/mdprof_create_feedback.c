...
static /* final */ const MR_Box mdprof_create_feedback_scalar_common_2[11][1];
...
static /* final */ const struct mdprof_create_feedback__vector_common_type_7_0_s mdprof_create_feedback_vector_common_7[21] = {
  ...
  {
    (MR_Integer) 0,
    (MR_Word) MR_mkword(MR_mktag(1), &mdprof_create_feedback_scalar_common_2[5])
  },
  /* row 1 */
  {
    (MR_Integer) 2,
    (MR_Word) MR_mkword(MR_mktag(2), &mdprof_create_feedback_scalar_common_2[6])
  },
  /* row 2 */
  {
    (MR_Integer) 1,
  ...
  {
    (MR_Integer) 9,
    (MR_Word) MR_mkword(MR_mktag(2), &mdprof_create_feedback_scalar_common_2[7])
  },
  /* row 10 */
  {
    (MR_Integer) 10,
    (MR_Word) MR_mkword(MR_mktag(2), &mdprof_create_feedback_scalar_common_2[8])
  },
  /* row 11 */
  {
    (MR_Integer) 11,
  ...
  {
    (MR_Integer) 13,
    (MR_Word) MR_mkword(MR_mktag(2), &mdprof_create_feedback_scalar_common_2[9])
  },
  /* row 14 */
  {
    (MR_Integer) 14,
  ...
  {
    (MR_Integer) 15,
    (MR_Word) MR_mkword(MR_mktag(2), &mdprof_create_feedback_scalar_common_2[10])
  },
  /* row 16 */
  {
    (MR_Integer) 16,
  ...
  {
    (MR_Integer) 18,
    (MR_Word) MR_mkword(MR_mktag(1), &mdprof_create_feedback_scalar_common_2[2])
  },
  /* row 18 */
  {
    (MR_Integer) 17,
...
{
  {
    ...
    if (mdprof_create_feedback__succeeded)
      *mdprof_create_feedback__HeadVar__1_1 = (MR_Integer) 0;
      ...
      {
        MR_Word mdprof_create_feedback__ArgX1_4 = (MR_Word) mdprof_create_feedback__HeadVar__2_2;
        MR_Word mdprof_create_feedback__ArgY1_5 = (MR_Word) mdprof_create_feedback__HeadVar__3_3;

        {
          mercury__builtin__compare_3_p_0((MR_Word) &mdprof_create_feedback_scalar_common_1[0], mdprof_create_feedback__HeadVar__1_1, ((MR_Box) (mdprof_create_feedback__ArgX1_4)), ((MR_Box) (mdprof_create_feedback__ArgY1_5)));
        }
      }
  }
}
...
{
  {
    ...
    if (mdprof_create_feedback__succeeded)
      ...
      {
        MR_Word mdprof_create_feedback__ArgX1_3 = (MR_Word) mdprof_create_feedback__HeadVar__1_1;
        MR_Word mdprof_create_feedback__ArgY1_4 = (MR_Word) mdprof_create_feedback__HeadVar__2_2;

        {
          mdprof_create_feedback__succeeded = mercury__builtin__unify_2_p_0((MR_Word) &mdprof_create_feedback_scalar_common_1[0], ((MR_Box) (mdprof_create_feedback__ArgX1_3)), ((MR_Box) (mdprof_create_feedback__ArgY1_4)));
        }
      }
    return mdprof_create_feedback__succeeded;
  }
...
{
  {
    ...
    MR_String mdprof_create_feedback__Var_18;
    MR_String mdprof_create_feedback__Var_19;
    ...
    if (mdprof_create_feedback__succeeded)
      {
        mdprof_create_feedback__Var_18 = (MR_String) "abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789_";
        mdprof_create_feedback__Var_19 = (MR_String) "greedy";
        {
          mdprof_create_feedback__succeeded = mercury__parsing_utils__keyword_6_p_0(mdprof_create_feedback__Var_18, mdprof_create_feedback__Var_19, mdprof_create_feedback__Src_5, mdprof_create_feedback__STATE_VARIABLE_PS_17_17, &mdprof_create_feedback__STATE_VARIABLE_PS_20_20);
        }
        if (mdprof_create_feedback__succeeded)
          {
        ...
        else
          {
            ...
            MR_String mdprof_create_feedback__Var_24;
            MR_String mdprof_create_feedback__Var_25;
            MR_Word mdprof_create_feedback__Var_26;
            MR_Integer mdprof_create_feedback__Var_28;
            ...
            if (mdprof_create_feedback__succeeded)
              {
                mdprof_create_feedback__Var_24 = (MR_String) "(";
                mdprof_create_feedback__Var_25 = (MR_String) ")";
                mdprof_create_feedback__Var_26 = (MR_Word) &mdprof_create_feedback_scalar_common_4[5];
                mdprof_create_feedback__TypeCtorInfo_46_46 = (MR_Word) &mercury__builtin__builtin__type_ctor_info_int_0;
                {
                  mdprof_create_feedback__succeeded = mercury__parsing_utils__brackets_7_p_0(mdprof_create_feedback__TypeCtorInfo_46_46, mdprof_create_feedback__Var_24, mdprof_create_feedback__Var_25, mdprof_create_feedback__Var_26, mdprof_create_feedback__Src_5, &mdprof_create_feedback__conv2_N_11, mdprof_create_feedback__STATE_VARIABLE_PS_23_23, &mdprof_create_feedback__STATE_VARIABLE_PS_27_27);
                }
                if (mdprof_create_feedback__succeeded)
                  {
                ...
                if (mdprof_create_feedback__succeeded)
                  {
                    mdprof_create_feedback__Var_28 = (MR_Integer) 0;
                    mdprof_create_feedback__succeeded = (mdprof_create_feedback__N_11 >= mdprof_create_feedback__Var_28);
                  }
              }
            if (mdprof_create_feedback__succeeded)
              {
            ...
            else
              {
                ...
                MR_String mdprof_create_feedback__Var_32;
                MR_String mdprof_create_feedback__Var_33;
                MR_Word mdprof_create_feedback__Var_34;
                MR_Integer mdprof_create_feedback__Var_36;
                ...
                if (mdprof_create_feedback__succeeded)
                  {
                    mdprof_create_feedback__Var_32 = (MR_String) "(";
                    mdprof_create_feedback__Var_33 = (MR_String) ")";
                    mdprof_create_feedback__Var_34 = (MR_Word) &mdprof_create_feedback_scalar_common_4[6];
                    mdprof_create_feedback__TypeCtorInfo_51_51 = (MR_Word) &mercury__builtin__builtin__type_ctor_info_int_0;
                    {
                      mdprof_create_feedback__succeeded = mercury__parsing_utils__brackets_7_p_0(mdprof_create_feedback__TypeCtorInfo_51_51, mdprof_create_feedback__Var_32, mdprof_create_feedback__Var_33, mdprof_create_feedback__Var_34, mdprof_create_feedback__Src_5, &mdprof_create_feedback__conv5_N_41, mdprof_create_feedback__STATE_VARIABLE_PS_31_31, &mdprof_create_feedback__STATE_VARIABLE_PS_35_35);
                    }
                    if (mdprof_create_feedback__succeeded)
                      {
                    ...
                    if (mdprof_create_feedback__succeeded)
                      {
                        mdprof_create_feedback__Var_36 = (MR_Integer) 0;
                        mdprof_create_feedback__succeeded = (mdprof_create_feedback__N_41 >= mdprof_create_feedback__Var_36);
                      }
                  }
                if (mdprof_create_feedback__succeeded)
                  {
...
{
  {
...

    {
      ...
      do
        {
          *mdprof_create_feedback__HeadVar__1_1 = ((&mdprof_create_feedback_vector_common_7[0 + mdprof_create_feedback__slot_0]))->mdprof_create_feedback__vector_common_type_7_0__vct_7_f_0;
          *mdprof_create_feedback__HeadVar__2_2 = ((&mdprof_create_feedback_vector_common_7[0 + mdprof_create_feedback__slot_0]))->mdprof_create_feedback__vector_common_type_7_0__vct_7_f_1;
          {
...

    {
      ...
      if ((mdprof_create_feedback__case_num_0 < (MR_Integer) 0))
      ...
      else
        {
          ...
          *mdprof_create_feedback__HeadVar__2_2 = ((&mdprof_create_feedback_vector_common_6[0 + mdprof_create_feedback__case_num_0]))->mdprof_create_feedback__vector_common_type_6_0__vct_6_f_0;
          mdprof_create_feedback__succeeded = MR_TRUE;
        }
    }
    return mdprof_create_feedback__succeeded;
...
{
  {
    ...
    {
      mercury__getopt__process_options_4_p_0(mdprof_create_feedback__TypeCtorInfo_64_64, (MR_Word) MR_mkword(MR_mktag(2), &mdprof_create_feedback_scalar_common_4[4]), mdprof_create_feedback__Args0_5, &mdprof_create_feedback__Args_6, &mdprof_create_feedback__MaybeOptions_7);
    }
    {
        ...
        if (mdprof_create_feedback__succeeded)
        ...
        else
          {
            ...
            if ((mdprof_create_feedback__Args_6 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
              ...
              {
                MR_Word mdprof_create_feedback__Var_71 = ((MR_Word) (MR_hl_field(MR_mktag(1), mdprof_create_feedback__Args_6, (MR_Integer) 1)));
                MR_String mdprof_create_feedback__Var_72 = ((MR_String) (MR_hl_field(MR_mktag(1), mdprof_create_feedback__Args_6, (MR_Integer) 0)));

                if ((mdprof_create_feedback__Var_71 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
                  {
                    {
                      mdprof_create_feedback__write_help_message_3_p_0(mdprof_create_feedback__ProgName_4);
                    }
                  ...
                  {
                    MR_Word mdprof_create_feedback__Var_73 = ((MR_Word) (MR_hl_field(MR_mktag(1), mdprof_create_feedback__Var_71, (MR_Integer) 1)));
                    MR_String mdprof_create_feedback__Var_74 = ((MR_String) (MR_hl_field(MR_mktag(1), mdprof_create_feedback__Var_71, (MR_Integer) 0)));

                    if ((mdprof_create_feedback__Var_73 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
                      {
                        ...
                        switch (mdprof_create_feedback__FoundError_15) {
                          ...
                          case (MR_Integer) 0:
                            {
                              mdprof_create_feedback__generate_requested_feedback_7_p_0(mdprof_create_feedback__ProgName_4, mdprof_create_feedback__Options_10, mdprof_create_feedback__Var_72, mdprof_create_feedback__Var_74, mdprof_create_feedback__RequestedFeedbackInfo_16);
                            }
                            break;
                        }
                      }
      ...
      case (MR_Integer) 1:
        {
          ...
          if (mdprof_create_feedback__succeeded)
            {
              ...
              if (mdprof_create_feedback__succeeded)
                ...
                {
                  {
                    mercury__io__write_string_4_p_0(mdprof_create_feedback__Stderr_12, mdprof_create_feedback__ProgName_7);
                  }
                  {
          ...
          if (mdprof_create_feedback__succeeded)
          ...
          else
            {
              ...
              {
                mercury__io__write_string_4_p_0(mdprof_create_feedback__Stderr_12, mdprof_create_feedback__SpeedupAlgString_30);
              }
              {
              ...
              if ((mdprof_create_feedback__MaybeMessage_36 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
                {
                  ...
                  {
                    mercury__io__write_string_4_p_0(mdprof_create_feedback__Stderr_12, mdprof_create_feedback__AlgForFindingBestParStr_33);
                  }
                  {
              ...
              else
                {
                  ...
                  {
                    mercury__io__write_string_4_p_0(mdprof_create_feedback__Stderr_12, mdprof_create_feedback__Message_39);
                  }
                  {
    ...
    switch (mdprof_create_feedback__HeadVar__1_1) {
      ...
      case (MR_Integer) 1:
        if ((strcmp(mdprof_create_feedback__HeadVar__2_2, (MR_String) "naive") == 0))
          {
            *mdprof_create_feedback__HeadVar__3_3 = (MR_Word) MR_mkword(MR_mktag(1), &mdprof_create_feedback_scalar_common_2[3]);
            mdprof_create_feedback__succeeded = MR_TRUE;
          }
        else
        if ((strcmp(mdprof_create_feedback__HeadVar__2_2, (MR_String) "overlap") == 0))
          {
            *mdprof_create_feedback__HeadVar__3_3 = (MR_Word) MR_mkword(MR_mktag(1), &mdprof_create_feedback_scalar_common_2[4]);
            mdprof_create_feedback__succeeded = MR_TRUE;
          }
        else
          mdprof_create_feedback__succeeded = MR_FALSE;
...
{
  {
    ...
    {
      mercury__parsing_utils__parse_3_p_0((MR_Word) &mdbcomp__feedback__automatic_parallelism__mdbcomp__feedback__automatic_parallelism__type_ctor_info_alg_for_finding_best_par_0, mdprof_create_feedback__String_3, (MR_Word) &mdprof_create_feedback_scalar_common_4[0], mdprof_create_feedback__Result_4);
    }
  }
}
...
{
  {
    ...
    if (mdprof_create_feedback__succeeded)
      {
        {
          mercury__io__write_string_4_p_0(mdprof_create_feedback__Stderr_10, mdprof_create_feedback__ProgName_6);
        }
        {
        ...
        {
          mercury__map__set_4_p_0((MR_Word) &mdprof_create_feedback__mdprof_create_feedback__type_ctor_info_option_0, (MR_Word) &mercury__getopt__getopt__type_ctor_info_option_data_0, ((MR_Box) ((MR_Integer) 2)), ((MR_Box) (MR_mkword(MR_mktag(2), &mdprof_create_feedback_scalar_common_2[0]))), mdprof_create_feedback__STATE_VARIABLE_Options_0_12, &mdprof_create_feedback__STATE_VARIABLE_Options_26_26);
        }
      }
    else
      {
        ...
        if (mdprof_create_feedback__succeeded)
          {
            ...
            {
              mercury__map__set_4_p_0((MR_Word) &mdprof_create_feedback__mdprof_create_feedback__type_ctor_info_option_0, (MR_Word) &mercury__getopt__getopt__type_ctor_info_option_data_0, ((MR_Box) ((MR_Integer) 2)), ((MR_Box) (MR_mkword(MR_mktag(2), &mdprof_create_feedback_scalar_common_2[1]))), mdprof_create_feedback__STATE_VARIABLE_Options_0_12, &mdprof_create_feedback__STATE_VARIABLE_Options_26_26);
            }
          }
        else
    ...
    switch (mdprof_create_feedback__ImplicitParallelism_11) {
      ...
      case (MR_Integer) 1:
        {
          {
            mercury__map__set_4_p_0((MR_Word) &mdprof_create_feedback__mdprof_create_feedback__type_ctor_info_option_0, (MR_Word) &mercury__getopt__getopt__type_ctor_info_option_data_0, ((MR_Box) ((MR_Integer) 5)), ((MR_Box) (MR_mkword(MR_mktag(1), &mdprof_create_feedback_scalar_common_2[2]))), mdprof_create_feedback__STATE_VARIABLE_Options_26_26, mdprof_create_feedback__STATE_VARIABLE_Options_13);
          }
        }
        break;
    }
...
{
  {
    ...
    {
      mercury__io__write_string_3_p_0(mdprof_create_feedback__ProgName_4);
    }
    {
    ...
    {
      mercury__io__write_string_3_p_0(mdprof_create_feedback__Version_6);
    }
    {
      mercury__io__write_string_3_p_0((MR_String) ", on ");
    }
    {
      mercury__io__write_string_3_p_0(mdprof_create_feedback__Fullarch_7);
    }
    {
  ...
  MR_String mdprof_create_feedback__ProgName_4)
{
  {
    MR_bool mdprof_create_feedback__succeeded;
    MR_String mdprof_create_feedback__Var_8;
    MR_String mdprof_create_feedback__Var_17;

    {
      mdprof_create_feedback__Var_17 = mercury__string__f_43_43_2_f_0(mdprof_create_feedback__ProgName_4, (MR_String) " [<options>] <profdatafile> <feedbackfile>\n    This command generates feedback information from profiling data.\n\n    The first argument must name a deep profili" "ng data file such as Deep.data.\n    The second argument should be the name of the file into which this command\n    should put the feedback information it genera" "tes.\n\n    You may specify the following general options:\n\n    -h --help       Generate this help message.\n    -V --version    Report the program\'s version numbe" "r.\n    -v --verbosity  <0-4>\n                    Generate messages. The higher the argument, the more\n                    verbose the program becomes. 2 is reco" "mmended and the\n                    default.\n    --debug-read-profile\n                    Generate debugging messages when reading the deep profile\n            " "        and creating the deep structure.\n    --report        Print a report about the feedback information after any\n                    processing has been don" "e.\n\n    The following options select sets of feedback information useful\n    for particular compiler optimizations:\n\n    --implicit-parallelism\n                " "Generate information that the compiler can use for automatic\n                parallelization.\n    --desired-parallelism <value>\n                The amount of de" "sired parallelism for implicit parallelism,\n                which must be a floating point number above 1.0.\n                Note: This option is currently igno" "red.\n    --implicit-parallelism-intermodule-var-use\n                Assume that the compiler will be able to push signals and waits\n                for futures " "across module boundaries.\n    --ipar-sparking-cost <value>\n                The cost of creating a spark, measured in the deep profiler\'s\n                call se" "quence counts.\n    --ipar-sparking-delay <value>\n                The time taken from the time a spark is created until the spark\n                is executed by " "another processor, assuming that there is a free\n                processor.\n    --ipar-barrier-cost <value>\n                The cost of executing the barrier co" "de at the end of each\n                parallel conjunct.\n    --ipar-future-signal-cost <value>\n                The cost of the signal() call for the producer of" " a shared\n                variable, measured in the profiler\'s call sequence counts.\n    --ipar-future-wait-cost <value>\n                The cost of the wait() " "call for the consumer of a shared\n                variable, measured in the profiler\'s call sequence counts.\n    --ipar-context-wakeup-delay <value>\n           " "     The time taken for a context to resume execution after being\n                placed on the run queue. This is used to estimate the impact\n                o" "f blocking of a context\'s execution, it is measured in the\n                profiler\'s call sequence counts.\n    --ipar-clique-cost-threshold <value>\n           " "     The cost threshold for cliques to be considered for implicit\n                parallelism, measured on the profiler\'s call sequence counts.\n    --ipar-call-" "site-cost-threshold <value>\n                The cost of a call site to be considered for parallelism\n                against another call site.\n    --no-ipar-de" "p-conjs\n                Disable parallelisation of dependent conjunctions.\n    --ipar-speedup-alg <alg>\n                Choose the algorithm that is used to est" "imate the speedup for\n                dependent calculations. The available algorithms are:\n                    overlap: Compute the overlap between dependent\n " "                     conjunctions.\n                    num_vars: Use the number of shared variables as a proxy for\n                      the amount of overlap a" "vailable.\n                    naive: Ignore dependencies.\n                The default is overlap.\n    --ipar-speedup-threshold <value>\n                The thres" "hold that a speedup ratio must meet before the\n                feedback tool will accept a parallelization. It must be\n                a floating point number, " "which must be at least 1.0.\n                If it is e.g. 1.02, then the feedback tool will ignore\n                parallelizations that promise less than a 2% " "local speedup.\n    --ipar-best-par-alg <alg>\n                Select which algorithm to use to find the best way to\n                parallelise a conjunction. Th" "e available algorithms are:\n                    greedy: A greedy algorithm with a linear time complexity.\n                    complete: A complete algorithm wit" "h a branch and bound\n                      search. This can be slow for problems larger than 50\n                      conjuncts, since it has an exponential com" "plexity.\n                    complete-size(N): As above exept that it takes a single\n                      parameter, N. If a conjunction has more than N\n      " "                conjuncts, then the greedy algorithm will be used.\n                    complete-branches(N): The same as the complete algorithm,\n               " "       except that it allows at most N branches to be created\n                      during the search. Once N branches have been created,\n                      " "a greedy search is used on each open branch.\n                The default is complete-branches(1000).\n\n    The following options select specific types of feedbac" "k information\n    and parameterise them:\n\n    --candidate-parallel-conjunctions\n                Produce a list of candidate parallel conjunctions for implicit\n " "               parallelism. This option uses the implicit parallelism\n                settings above.\n\n");
    }
    {
      mdprof_create_feedback__Var_8 = mercury__string__f_43_43_2_f_0((MR_String) "Usage: ", mdprof_create_feedback__Var_17);
    }
    {
      mercury__io__write_string_3_p_0(mdprof_create_feedback__Var_8);
    }
  }
}
...
{
  {
    ...
    if ((mdprof_create_feedback__MaybeParallelize_15 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
      {
        {
          mercury__io__write_string_4_p_0(mdprof_create_feedback__Stderr_14, mdprof_create_feedback__ProgName_8);
        }
        {
        ...
        if (((MR_tag((MR_Word) mdprof_create_feedback__MaybeDeep_19)) == (MR_mktag((MR_Integer) 1))))
          {
            ...
            {
              mercury__io__write_string_4_p_0(mdprof_create_feedback__Stderr_14, mdprof_create_feedback__InputFileName_10);
            }
            {
              mercury__io__write_string_4_p_0(mdprof_create_feedback__Stderr_14, (MR_String) ": ");
            }
            {
              mercury__io__write_string_4_p_0(mdprof_create_feedback__Stderr_14, mdprof_create_feedback__Error_84);
            }
            {
              mercury__io__write_string_4_p_0(mdprof_create_feedback__Stderr_14, (MR_String) "\n");
            }
            ...
            if (((MR_tag((MR_Word) mdprof_create_feedback__MaybeProgRep_21)) == (MR_mktag((MR_Integer) 1))))
              {
                ...
                {
                  mercury__io__write_string_4_p_0(mdprof_create_feedback__Stderr_14, mdprof_create_feedback__Error_83);
                }
                {
                  mercury__io__write_string_4_p_0(mdprof_create_feedback__Stderr_14, (MR_String) "\n");
                }
            ...
            else
              {
                ...
                MR_Word mdprof_create_feedback__Var_64 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdprof_create_feedback__Deep_20, (MR_Integer) 0)));
                MR_String mdprof_create_feedback__Var_85 = ((MR_String) (MR_hl_field(MR_mktag(0), mdprof_create_feedback__Deep_20, (MR_Integer) 1)));
                MR_String mdprof_create_feedback__Var_86 = ((MR_String) (MR_hl_field(MR_mktag(0), mdprof_create_feedback__Deep_20, (MR_Integer) 2)));
                MR_String mdprof_create_feedback__Var_87 = ((MR_String) (MR_hl_field(MR_mktag(0), mdprof_create_feedback__Deep_20, (MR_Integer) 3)));
                MR_Word mdprof_create_feedback__Var_88 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdprof_create_feedback__Deep_20, (MR_Integer) 4)));
                MR_ArrayPtr mdprof_create_feedback__Var_89 = ((MR_ArrayPtr) (MR_hl_field(MR_mktag(0), mdprof_create_feedback__Deep_20, (MR_Integer) 5)));
                MR_ArrayPtr mdprof_create_feedback__Var_90 = ((MR_ArrayPtr) (MR_hl_field(MR_mktag(0), mdprof_create_feedback__Deep_20, (MR_Integer) 6)));
                MR_ArrayPtr mdprof_create_feedback__Var_91 = ((MR_ArrayPtr) (MR_hl_field(MR_mktag(0), mdprof_create_feedback__Deep_20, (MR_Integer) 7)));
                MR_ArrayPtr mdprof_create_feedback__Var_92 = ((MR_ArrayPtr) (MR_hl_field(MR_mktag(0), mdprof_create_feedback__Deep_20, (MR_Integer) 8)));
                MR_ArrayPtr mdprof_create_feedback__Var_93 = ((MR_ArrayPtr) (MR_hl_field(MR_mktag(0), mdprof_create_feedback__Deep_20, (MR_Integer) 9)));
                MR_ArrayPtr mdprof_create_feedback__Var_94 = ((MR_ArrayPtr) (MR_hl_field(MR_mktag(0), mdprof_create_feedback__Deep_20, (MR_Integer) 10)));
                MR_ArrayPtr mdprof_create_feedback__Var_95 = ((MR_ArrayPtr) (MR_hl_field(MR_mktag(0), mdprof_create_feedback__Deep_20, (MR_Integer) 11)));
                MR_ArrayPtr mdprof_create_feedback__Var_96 = ((MR_ArrayPtr) (MR_hl_field(MR_mktag(0), mdprof_create_feedback__Deep_20, (MR_Integer) 12)));
                MR_ArrayPtr mdprof_create_feedback__Var_97 = ((MR_ArrayPtr) (MR_hl_field(MR_mktag(0), mdprof_create_feedback__Deep_20, (MR_Integer) 13)));
                MR_ArrayPtr mdprof_create_feedback__Var_98 = ((MR_ArrayPtr) (MR_hl_field(MR_mktag(0), mdprof_create_feedback__Deep_20, (MR_Integer) 14)));
                MR_ArrayPtr mdprof_create_feedback__Var_99 = ((MR_ArrayPtr) (MR_hl_field(MR_mktag(0), mdprof_create_feedback__Deep_20, (MR_Integer) 15)));
                MR_ArrayPtr mdprof_create_feedback__Var_100 = ((MR_ArrayPtr) (MR_hl_field(MR_mktag(0), mdprof_create_feedback__Deep_20, (MR_Integer) 16)));
                MR_ArrayPtr mdprof_create_feedback__Var_101 = ((MR_ArrayPtr) (MR_hl_field(MR_mktag(0), mdprof_create_feedback__Deep_20, (MR_Integer) 17)));
                MR_ArrayPtr mdprof_create_feedback__Var_102 = ((MR_ArrayPtr) (MR_hl_field(MR_mktag(0), mdprof_create_feedback__Deep_20, (MR_Integer) 18)));
                MR_ArrayPtr mdprof_create_feedback__Var_103 = ((MR_ArrayPtr) (MR_hl_field(MR_mktag(0), mdprof_create_feedback__Deep_20, (MR_Integer) 19)));
                MR_ArrayPtr mdprof_create_feedback__Var_104 = ((MR_ArrayPtr) (MR_hl_field(MR_mktag(0), mdprof_create_feedback__Deep_20, (MR_Integer) 20)));
                MR_ArrayPtr mdprof_create_feedback__Var_105 = ((MR_ArrayPtr) (MR_hl_field(MR_mktag(0), mdprof_create_feedback__Deep_20, (MR_Integer) 21)));
                MR_ArrayPtr mdprof_create_feedback__Var_106 = ((MR_ArrayPtr) (MR_hl_field(MR_mktag(0), mdprof_create_feedback__Deep_20, (MR_Integer) 22)));
                MR_ArrayPtr mdprof_create_feedback__Var_107 = ((MR_ArrayPtr) (MR_hl_field(MR_mktag(0), mdprof_create_feedback__Deep_20, (MR_Integer) 23)));
                MR_ArrayPtr mdprof_create_feedback__Var_108 = ((MR_ArrayPtr) (MR_hl_field(MR_mktag(0), mdprof_create_feedback__Deep_20, (MR_Integer) 24)));
                MR_Word mdprof_create_feedback__Var_109 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdprof_create_feedback__Deep_20, (MR_Integer) 25)));
                MR_Word mdprof_create_feedback__Var_110 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdprof_create_feedback__Deep_20, (MR_Integer) 26)));
                MR_Word mdprof_create_feedback__Var_111 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdprof_create_feedback__Deep_20, (MR_Integer) 27)));
                MR_Word mdprof_create_feedback__Var_112 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdprof_create_feedback__Deep_20, (MR_Integer) 28)));
                MR_Integer mdprof_create_feedback__Var_113;
                MR_Integer mdprof_create_feedback__Var_114;
                MR_Integer mdprof_create_feedback__Var_115;
                MR_Integer mdprof_create_feedback__Var_116;
                MR_Integer mdprof_create_feedback__Var_117;
                MR_Integer mdprof_create_feedback__Var_118;
                MR_Integer mdprof_create_feedback__Var_119;
                MR_Integer mdprof_create_feedback__Var_120;
                MR_Word mdprof_create_feedback__Var_121;

                mdprof_create_feedback__ProfiledProgramName_23 = ((MR_String) (MR_hl_field(MR_mktag(0), mdprof_create_feedback__Var_64, (MR_Integer) 0)));
                mdprof_create_feedback__Var_113 = ((MR_Integer) (MR_hl_field(MR_mktag(0), mdprof_create_feedback__Var_64, (MR_Integer) 1)));
                mdprof_create_feedback__Var_114 = ((MR_Integer) (MR_hl_field(MR_mktag(0), mdprof_create_feedback__Var_64, (MR_Integer) 2)));
                mdprof_create_feedback__Var_115 = ((MR_Integer) (MR_hl_field(MR_mktag(0), mdprof_create_feedback__Var_64, (MR_Integer) 3)));
                mdprof_create_feedback__Var_116 = ((MR_Integer) (MR_hl_field(MR_mktag(0), mdprof_create_feedback__Var_64, (MR_Integer) 4)));
                mdprof_create_feedback__Var_117 = ((MR_Integer) (MR_hl_field(MR_mktag(0), mdprof_create_feedback__Var_64, (MR_Integer) 5)));
                mdprof_create_feedback__Var_118 = ((MR_Integer) (MR_hl_field(MR_mktag(0), mdprof_create_feedback__Var_64, (MR_Integer) 6)));
                mdprof_create_feedback__Var_119 = ((MR_Integer) (MR_hl_field(MR_mktag(0), mdprof_create_feedback__Var_64, (MR_Integer) 7)));
                mdprof_create_feedback__Var_120 = ((MR_Integer) (MR_hl_field(MR_mktag(0), mdprof_create_feedback__Var_64, (MR_Integer) 8)));
                mdprof_create_feedback__Var_121 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdprof_create_feedback__Var_64, (MR_Integer) 9)));
                {
                      ...
                      case (MR_Integer) 1:
                        {
                          ...
                          {
                            mercury__io__write_string_4_p_0(mdprof_create_feedback__Stderr_14, mdprof_create_feedback__OutputFileName_11);
                          }
                          {
                            mercury__io__write_string_4_p_0(mdprof_create_feedback__Stderr_14, (MR_String) ": ");
                          }
                          {
                            mercury__io__write_string_4_p_0(mdprof_create_feedback__Stderr_14, mdprof_create_feedback__ErrorMessage_30);
                          }
                          {
                            mercury__io__write_string_4_p_0(mdprof_create_feedback__Stderr_14, (MR_String) "\n");
                          }
                      ...
                      case (MR_Integer) 2:
                        {
                          ...
                          {
                            mercury__io__write_string_4_p_0(mdprof_create_feedback__Stderr_14, mdprof_create_feedback__ErrorMessage_124);
                          }
                          {
                            mercury__io__write_string_4_p_0(mdprof_create_feedback__Stderr_14, (MR_String) "\n");
                          }
