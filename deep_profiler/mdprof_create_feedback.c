...
struct mdprof_create_feedback__vector_common_type_6_0_s {
...
struct mdprof_create_feedback__vector_common_type_7_0_s {
...
static /* final */ const struct mdprof_create_feedback__vector_common_type_7_0_s mdprof_create_feedback_vector_common_7[21] = {
  ...
  {
    (MR_Integer) 0,
    (MR_Word) (MR_mkword(1, &mdprof_create_feedback_scalar_common_2[0]))
  },
  /* row   1 */
  {
    (MR_Integer) 2,
    (MR_Word) (MR_mkword(2, &mdprof_create_feedback_scalar_common_2[1]))
  },
  /* row   2 */
  {
    (MR_Integer) 1,
  ...
  {
    (MR_Integer) 7,
    (MR_Word) (MR_mkword(3, &mdprof_create_feedback_scalar_common_1[1]))
  },
  /* row   8 */
  {
    (MR_Integer) 8,
  ...
  {
    (MR_Integer) 9,
    (MR_Word) (MR_mkword(2, &mdprof_create_feedback_scalar_common_2[2]))
  },
  /* row  10 */
  {
    (MR_Integer) 10,
    (MR_Word) (MR_mkword(2, &mdprof_create_feedback_scalar_common_2[3]))
  },
  /* row  11 */
  {
    (MR_Integer) 11,
  ...
  {
    (MR_Integer) 13,
    (MR_Word) (MR_mkword(2, &mdprof_create_feedback_scalar_common_2[4]))
  },
  /* row  14 */
  {
    (MR_Integer) 14,
  ...
  {
    (MR_Integer) 15,
    (MR_Word) (MR_mkword(2, &mdprof_create_feedback_scalar_common_2[5]))
  },
  /* row  16 */
  {
    (MR_Integer) 16,
  ...
  {
    (MR_Integer) 18,
    (MR_Word) (MR_mkword(1, &mdprof_create_feedback_scalar_common_2[6]))
  },
  /* row  18 */
  {
    (MR_Integer) 17,
    (MR_Word) (MR_mkword(3, &mdprof_create_feedback_scalar_common_1[2]))
  },
  /* row  19 */
  {
    (MR_Integer) 19,
    (MR_Word) (MR_mkword(3, &mdprof_create_feedback_scalar_common_1[3]))
  },
  /* row  20 */
  {
    (MR_Integer) 20,
    (MR_Word) (MR_mkword(3, &mdprof_create_feedback_scalar_common_1[4]))
  },
};
...
static const MR_Integer mdprof_create_feedback__mdprof_create_feedback__functor_number_map_requested_feedback_info_0[1] = { (MR_Integer) 0 };
...
{
  MR_bool succeeded;
  MR_Integer STATE_VARIABLE_PS_1_17;
  MR_Integer STATE_VARIABLE_PS_7_39;
  MR_Integer STATE_VARIABLE_PS_2_20;
  MR_String Var_18;
  MR_String Var_19;

  succeeded = mercury__parsing_utils__whitespace_4_p_0(Src_5, STATE_VARIABLE_PS_0_15, &STATE_VARIABLE_PS_1_17);
  if (succeeded)
  {
    Var_18 = (MR_String) "abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789_";
    Var_19 = (MR_String) "greedy";
    succeeded = mercury__parsing_utils__keyword_6_p_0(Var_18, Var_19, Src_5, STATE_VARIABLE_PS_1_17, &STATE_VARIABLE_PS_2_20);
    if (succeeded)
    {
      STATE_VARIABLE_PS_7_39 = STATE_VARIABLE_PS_2_20;
    ...
    {
      MR_Integer N_11;
      MR_Integer STATE_VARIABLE_PS_4_27;
      MR_Word TypeCtorInfo_46_46;
      MR_Integer STATE_VARIABLE_PS_3_23;
      MR_String Var_24;
      MR_String Var_25;
      MR_Word Var_26;
      MR_Integer Var_28;
      ...
      succeeded = mercury__parsing_utils__keyword_6_p_0((MR_String) "abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789_", (MR_String) "complete-branches", Src_5, STATE_VARIABLE_PS_1_17, &STATE_VARIABLE_PS_3_23);
      if (succeeded)
      {
        Var_24 = (MR_String) "(";
        Var_25 = (MR_String) ")";
        ...
        succeeded = mercury__parsing_utils__brackets_7_p_0(TypeCtorInfo_46_46, Var_24, Var_25, Var_26, Src_5, &conv2_N_11, STATE_VARIABLE_PS_3_23, &STATE_VARIABLE_PS_4_27);
        if (succeeded)
        {
      ...
      if (succeeded)
      {
        STATE_VARIABLE_PS_7_39 = STATE_VARIABLE_PS_4_27;
        {
          MR_Word base;
          base = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
          *Algorithm_6 = base;
          MR_hl_field(1, base, 0) = ((MR_Box) (N_11));
        }
        succeeded = MR_TRUE;
      }
      else
      {
        MR_Integer STATE_VARIABLE_PS_6_35;
        MR_Integer N_41;
        MR_Word TypeCtorInfo_51_51;
        MR_Integer STATE_VARIABLE_PS_5_31;
        MR_String Var_32;
        MR_String Var_33;
        MR_Word Var_34;
        MR_Integer Var_36;
        ...
        succeeded = mercury__parsing_utils__keyword_6_p_0((MR_String) "abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789_", (MR_String) "complete-size", Src_5, STATE_VARIABLE_PS_1_17, &STATE_VARIABLE_PS_5_31);
        if (succeeded)
        {
          Var_32 = (MR_String) "(";
          Var_33 = (MR_String) ")";
          ...
          succeeded = mercury__parsing_utils__brackets_7_p_0(TypeCtorInfo_51_51, Var_32, Var_33, Var_34, Src_5, &conv5_N_41, STATE_VARIABLE_PS_5_31, &STATE_VARIABLE_PS_6_35);
          if (succeeded)
          {
        ...
        if (succeeded)
        {
          STATE_VARIABLE_PS_7_39 = STATE_VARIABLE_PS_6_35;
          {
            MR_Word base;
            base = (MR_Word) MR_mkword(2, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
            *Algorithm_6 = base;
            MR_hl_field(2, base, 0) = ((MR_Box) (N_41));
          }
          succeeded = MR_TRUE;
        }
        else
        {
          succeeded = mercury__parsing_utils__keyword_6_p_0((MR_String) "abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789_", (MR_String) "complete", Src_5, STATE_VARIABLE_PS_1_17, &STATE_VARIABLE_PS_7_39);
          if (succeeded)
          {
    ...
    if (succeeded)
      succeeded = mercury__parsing_utils__eof_4_p_0(Src_5, STATE_VARIABLE_PS_7_39, STATE_VARIABLE_PS_16);
  }
  return succeeded;
}
...

  {
    ...
    switch (MR_nth_code_unit(HeadVar__1_1, 0)) {
      ...
      case (MR_Integer) 105:
        switch (MR_nth_code_unit(HeadVar__1_1, 1)) {
          case (MR_Integer) 109:
            if (MR_offset_strn_eq(2, 18, HeadVar__1_1, (MR_String) "implicit-parallelism"))
                ...
                case (MR_Integer) 45:
                  switch (MR_nth_code_unit(HeadVar__1_1, 21)) {
                    ...
                    case (MR_Integer) 99:
                      ...
                      break;
                    case (MR_Integer) 100:
                      if (MR_offset_strn_eq(22, 21, HeadVar__1_1, (MR_String) "implicit-parallelism-dependant-conjunctions"))
                      ...
                      break;
                    case (MR_Integer) 102:
                      if (MR_offset_strn_eq(22, 6, HeadVar__1_1, (MR_String) "implicit-parallelism-future-"))
                      ...
                      switch (MR_nth_code_unit(HeadVar__1_1, 22)) {
                        case (MR_Integer) 112:
                          switch (MR_nth_code_unit(HeadVar__1_1, 23)) {
                            case (MR_Integer) 97:
                              if (MR_offset_strn_eq(24, 6, HeadVar__1_1, (MR_String) "implicit-parallelism-sparking-"))
            ...
            break;
          case (MR_Integer) 112:
            if (MR_offset_strn_eq(2, 3, HeadVar__1_1, (MR_String) "ipar-"))
              switch (MR_nth_code_unit(HeadVar__1_1, 5)) {
                ...
                case (MR_Integer) 100:
                  ...
                  break;
                case (MR_Integer) 102:
                  if (MR_offset_strn_eq(6, 6, HeadVar__1_1, (MR_String) "ipar-future-"))
                  ...
                  switch (MR_nth_code_unit(HeadVar__1_1, 6)) {
                    case (MR_Integer) 112:
                      switch (MR_nth_code_unit(HeadVar__1_1, 7)) {
                        case (MR_Integer) 97:
                          if (MR_offset_strn_eq(8, 6, HeadVar__1_1, (MR_String) "ipar-sparking-"))
                          ...
                          break;
                        case (MR_Integer) 101:
                          if (MR_offset_strn_eq(8, 5, HeadVar__1_1, (MR_String) "ipar-speedup-"))
...
main_2_p_0(void)
{
  ...
  mercury__getopt__process_options_4_p_0((MR_Word) (&mdprof_create_feedback__mdprof_create_feedback__type_ctor_info_option_0), (MR_Word) (MR_mkword(2, &mdprof_create_feedback_scalar_common_4[4])), Args0_5, &Args_6, &MaybeOptions_7);
  ...
  {
    MR_Word Error_23 = ((MR_Word) ((MR_hl_field(1, MaybeOptions_7, 0))));
    MR_String Msg_24;
    MR_String Var_82;
    MR_String Var_88;
  ...
  else
  {
    ...
    else
    {
      ...
      {
        MR_Word Var_73 = ((MR_Word) ((MR_hl_field(1, Args_6, 1))));
        MR_String Var_74 = ((MR_String) ((MR_hl_field(1, Args_6, 0))));
        ...
        {
          MR_Word Var_75 = ((MR_Word) ((MR_hl_field(1, Var_73, 1))));
          MR_String Var_76 = ((MR_String) ((MR_hl_field(1, Var_73, 0))));
          ...
          if ((Var_75 == (MR_Word) ((MR_Unsigned) 0U)))
          {
            ...
            switch (FoundError_16) {
              ...
              case (MR_Integer) 1:
                ...
                break;
              case (MR_Integer) 0:
                mdprof_create_feedback__generate_requested_feedback_7_p_0(ProgName_4, Options_11, Var_74, Var_76, RequestedFeedbackInfo_17);
                break;
            }
          }
          else
    ...
    case (MR_Integer) 1:
      {
        ...
        MR_Word STATE_VARIABLE_Error_2_55;
        MR_Word STATE_VARIABLE_Error_4_69;
        MR_Word STATE_VARIABLE_Error_6_94;
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
            STATE_VARIABLE_Error_2_55 = (MR_Integer) 0;
          else
          {
            ...
            STATE_VARIABLE_Error_2_55 = (MR_Integer) 1;
          }
        }
        else
        {
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
            STATE_VARIABLE_Error_4_69 = STATE_VARIABLE_Error_2_55;
          else
          {
            mercury__io__write_string_4_p_0(StdErr_12, ProgName_7);
            mercury__io__write_string_4_p_0(StdErr_12, (MR_String) ": error: speedup threshold should be >= 1.\n");
            STATE_VARIABLE_Error_4_69 = (MR_Integer) 1;
          }
        }
        else
        {
        ...
        if (succeeded)
        {
          ...
          STATE_VARIABLE_Error_6_94 = STATE_VARIABLE_Error_4_69;
        }
        else
        {
          mercury__io__write_string_4_p_0(StdErr_12, ProgName_7);
          ...
          STATE_VARIABLE_Error_6_94 = (MR_Integer) 1;
        ...
        {
          MR_Word MaybeMessage_36 = ((MR_Word) ((MR_hl_field(1, MaybeAlgForFindingBestPar_34, 0))));
          ...
          {
            MR_String Message_39 = ((MR_String) ((MR_hl_field(1, MaybeMessage_36, 0))));
        ...
        {
          AlgForFindingBestPar_35 = ((MR_Word) ((MR_hl_field(0, MaybeAlgForFindingBestPar_34, 0))));
          *STATE_VARIABLE_Error_42 = STATE_VARIABLE_Error_6_94;
        }
        {
          AutoParOpts_40 = (MR_Word) MR_new_object(MR_Word, (13 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(0, AutoParOpts_40, 0) = MR_box_float(DesiredParallelism_16);
          MR_hl_field(0, AutoParOpts_40, 1) = (MR_Box) ((MR_Unsigned) (IntermoduleVarUse_20));
          MR_hl_field(0, AutoParOpts_40, 2) = ((MR_Box) (SparkingCost_21));
          MR_hl_field(0, AutoParOpts_40, 3) = ((MR_Box) (SparkingDelay_22));
          MR_hl_field(0, AutoParOpts_40, 4) = ((MR_Box) (BarrierCost_23));
          MR_hl_field(0, AutoParOpts_40, 5) = ((MR_Box) (FutureSignalCost_24));
          MR_hl_field(0, AutoParOpts_40, 6) = ((MR_Box) (FutureWaitCost_25));
          MR_hl_field(0, AutoParOpts_40, 7) = ((MR_Box) (ContextWakeupDelay_26));
          MR_hl_field(0, AutoParOpts_40, 8) = ((MR_Box) (CPCCliqueThreshold_27));
          MR_hl_field(0, AutoParOpts_40, 9) = ((MR_Box) (CPCCallSiteThreshold_28));
          MR_hl_field(0, AutoParOpts_40, 10) = MR_box_float(SpeedupThreshold_19);
          MR_hl_field(0, AutoParOpts_40, 11) = ((MR_Box) (SpeedupAlg_32));
          MR_hl_field(0, AutoParOpts_40, 12) = ((MR_Box) (AlgForFindingBestPar_35));
        }
        {
          MaybeAutoParOpts_41 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(1, MaybeAutoParOpts_41, 0) = ((MR_Box) (AutoParOpts_40));
        }
      }
      break;
  }
  ...
  MR_Word * HeadVar__3_3)
{
  ...
  switch (HeadVar__1_1) {
    ...
    case (MR_Integer) 1:
      ...
      {
        *HeadVar__3_3 = (MR_Word) (MR_mkword(1, &mdprof_create_feedback_scalar_common_2[0]));
        succeeded = MR_TRUE;
      }
      else
      if ((strcmp(HeadVar__2_2, (MR_String) "overlap") == 0))
      {
        *HeadVar__3_3 = (MR_Word) (MR_mkword(1, &mdprof_create_feedback_scalar_common_2[6]));
        succeeded = MR_TRUE;
      }
      else
        succeeded = MR_FALSE;
  ...
  MR_String ProgName_6)
{
  ...
  Var_16 = mercury__string__f_43_43_2_f_0(ProgName_6, (MR_String) " [<options>] <profdatafile> <feedbackfile>\n    This command generates feedback information from profiling data.\n\n    The first argument must name a deep profili" "ng data file such as Deep.data.\n    The second argument should be the name of the file into which this command\n    should put the feedback information it genera" "tes.\n\n    You may specify the following general options:\n\n    -h --help       Generate this help message.\n    -V --version    Report the program\'s version numbe" "r.\n    -v --verbosity  <0-4>\n                    Generate messages. The higher the argument, the more\n                    verbose the program becomes. 2 is reco" "mmended and the\n                    default.\n    --debug-read-profile\n                    Generate debugging messages when reading the deep profile\n            " "        and creating the deep structure.\n    --report        Print a report about the feedback information after any\n                    processing has been don" "e.\n\n    The following options select sets of feedback information useful\n    for particular compiler optimizations:\n\n    --implicit-parallelism\n                " "Generate information that the compiler can use for automatic\n                parallelization.\n    --desired-parallelism <value>\n                The amount of de" "sired parallelism for implicit parallelism,\n                which must be a floating point number above 1.0.\n                Note: This option is currently igno" "red.\n    --implicit-parallelism-intermodule-var-use\n                Assume that the compiler will be able to push signals and waits\n                for futures " "across module boundaries.\n    --ipar-sparking-cost <value>\n                The cost of creating a spark, measured in the deep profiler\'s\n                call se" "quence counts.\n    --ipar-sparking-delay <value>\n                The time taken from the time a spark is created until the spark\n                is executed by " "another processor, assuming that there is a free\n                processor.\n    --ipar-barrier-cost <value>\n                The cost of executing the barrier co" "de at the end of each\n                parallel conjunct.\n    --ipar-future-signal-cost <value>\n                The cost of the signal() call for the producer of" " a shared\n                variable, measured in the profiler\'s call sequence counts.\n    --ipar-future-wait-cost <value>\n                The cost of the wait() " "call for the consumer of a shared\n                variable, measured in the profiler\'s call sequence counts.\n    --ipar-context-wakeup-delay <value>\n           " "     The time taken for a context to resume execution after being\n                placed on the run queue. This is used to estimate the impact\n                o" "f blocking of a context\'s execution, it is measured in the\n                profiler\'s call sequence counts.\n    --ipar-clique-cost-threshold <value>\n           " "     The cost threshold for cliques to be considered for implicit\n                parallelism, measured on the profiler\'s call sequence counts.\n    --ipar-call-" "site-cost-threshold <value>\n                The cost of a call site to be considered for parallelism\n                against another call site.\n    --no-ipar-de" "p-conjs\n                Disable parallelisation of dependent conjunctions.\n    --ipar-speedup-alg <alg>\n                Choose the algorithm that is used to est" "imate the speedup for\n                dependent calculations. The available algorithms are:\n                    overlap: Compute the overlap between dependent\n " "                     conjunctions.\n                    num_vars: Use the number of shared variables as a proxy for\n                      the amount of overlap a" "vailable.\n                    naive: Ignore dependencies.\n                The default is overlap.\n    --ipar-speedup-threshold <value>\n                The thres" "hold that a speedup ratio must meet before the\n                feedback tool will accept a parallelization. It must be\n                a floating point number, " "which must be at least 1.0.\n                If it is e.g. 1.02, then the feedback tool will ignore\n                parallelizations that promise less than a 2% " "local speedup.\n    --ipar-best-par-alg <alg>\n                Select which algorithm to use to find the best way to\n                parallelise a conjunction. Th" "e available algorithms are:\n                    greedy: A greedy algorithm with a linear time complexity.\n                    complete: A complete algorithm wit" "h a branch and bound\n                      search. This can be slow for problems larger than 50\n                      conjuncts, since it has an exponential com" "plexity.\n                    complete-size(N): As above exept that it takes a single\n                      parameter, N. If a conjunction has more than N\n      " "                conjuncts, then the greedy algorithm will be used.\n                    complete-branches(N): The same as the complete algorithm,\n               " "       except that it allows at most N branches to be created\n                      during the search. Once N branches have been created,\n                      " "a greedy search is used on each open branch.\n                The default is complete-branches(1000).\n\n    The following options select specific types of feedbac" "k information\n    and parameterise them:\n\n    --candidate-parallel-conjunctions\n                Produce a list of candidate parallel conjunctions for implicit\n " "               parallelism. This option uses the implicit parallelism\n                settings above.\n\n");
  ...
  MR_Word RequestedFeedbackInfo_12)
{
  ...
  else
  {
    ...
    {
      MR_String Error_86 = ((MR_String) ((MR_hl_field(1, MaybeDeep_19, 0))));
    ...
    {
      MR_Word Deep_20 = ((MR_Word) ((MR_hl_field(0, MaybeDeep_19, 0))));
      ...
      {
        MR_String Error_85 = ((MR_String) ((MR_hl_field(1, MaybeProgRep_21, 0))));
      ...
      else
      {
        ...
        MR_Word Var_40 = ((MR_Word) ((MR_hl_field(0, Deep_20, 0))));

        ProfiledProgramName_23 = ((MR_String) ((MR_hl_field(0, Var_40, 0))));
        mdbcomp__feedback__feedback_info__read_or_create_feedback_file_5_p_0(OutputFileName_11, ProfiledProgramName_23, &FeedbackReadResult_24);
        if (((MR_tag((MR_Word) FeedbackReadResult_24)) == (MR_Integer) 1))
        {
          MR_Word FeedbackReadError_32 = ((MR_Word) ((MR_hl_field(1, FeedbackReadResult_24, 0))));
          MR_String Message_33;

          mdbcomp__feedback__feedback_info__feedback_read_error_message_string_3_p_0(OutputFileName_11, FeedbackReadError_32, &Message_33);
          mercury__io__write_string_4_p_0(StdErr_14, Message_33);
          mercury__io__set_exit_status_3_p_0((MR_Integer) 1);
        }
        else
        {
          MR_Word Feedback0_25 = ((MR_Word) ((MR_hl_field(0, FeedbackReadResult_24, 0))));
          MR_Word Messages_26;
          MR_Word Feedback_27;
          ...
          mdbcomp__feedback__feedback_info__write_feedback_file_5_p_0(OutputFileName_11, Feedback_27, &WriteResult_29);
          switch (MR_tag((MR_Word) WriteResult_29)) {
            ...
            case (MR_Integer) 1:
              {
                MR_Word Error_30 = ((MR_Word) ((MR_hl_field(1, WriteResult_29, 0))));
            ...
            case (MR_Integer) 2:
              {
                MR_Word Error_149 = ((MR_Word) ((MR_hl_field(2, WriteResult_29, 0))));
                MR_String ErrorMessage_150;

                mercury__io__error_message_2_p_0(Error_149, &ErrorMessage_150);
                mercury__io__write_string_4_p_0(StdErr_14, ProgName_8);
                mercury__io__write_string_4_p_0(StdErr_14, (MR_String) ": ");
                mercury__io__write_string_4_p_0(StdErr_14, OutputFileName_11);
                mercury__io__write_string_4_p_0(StdErr_14, (MR_String) ": ");
                mercury__io__write_string_4_p_0(StdErr_14, ErrorMessage_150);
                mercury__io__write_string_4_p_0(StdErr_14, (MR_String) "\n");
                mercury__io__set_exit_status_3_p_0((MR_Integer) 1);
              }
              break;
  ...
  MR_Word * STATE_VARIABLE_Feedback_13)
{
  ...
  {
    MR_Word AutoParOpts_11 = ((MR_Word) ((MR_hl_field(1, MaybeAutoParOpts_10, 0))));
    ...
    case (MR_Integer) 1:
      {
        ...
        {
          MaybeOutput_13 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(1, MaybeOutput_13, 0) = ((MR_Box) (Stdout_12));
        }
      }
      break;
  }
