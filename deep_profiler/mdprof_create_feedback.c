...
{
  {
    ...
    if (mdprof_create_feedback__succeeded)
      *mdprof_create_feedback__HeadVar__1_1 = (MR_Integer) 0;
      ...
      {
        MR_Word mdprof_create_feedback__Var_4 = (MR_Word) mdprof_create_feedback__HeadVar__2_2;
        MR_Word mdprof_create_feedback__Var_5 = (MR_Word) mdprof_create_feedback__HeadVar__3_3;

        {
          mercury__builtin__compare_3_p_0((MR_Word) &mdprof_create_feedback_scalar_common_1[0], mdprof_create_feedback__HeadVar__1_1, ((MR_Box) (mdprof_create_feedback__Var_4)), ((MR_Box) (mdprof_create_feedback__Var_5)));
        }
      }
  }
}
...
{
  {
    ...
    if (mdprof_create_feedback__succeeded)
      ...
      {
        MR_Word mdprof_create_feedback__Var_3 = (MR_Word) mdprof_create_feedback__HeadVar__1_1;
        MR_Word mdprof_create_feedback__Var_4 = (MR_Word) mdprof_create_feedback__HeadVar__2_2;

        {
          mdprof_create_feedback__succeeded = mercury__builtin__unify_2_p_0((MR_Word) &mdprof_create_feedback_scalar_common_1[0], ((MR_Box) (mdprof_create_feedback__Var_3)), ((MR_Box) (mdprof_create_feedback__Var_4)));
        }
      }
    return mdprof_create_feedback__succeeded;
  }
