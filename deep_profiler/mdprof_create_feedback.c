...
MR_def_label(mdprof_create_feedback__get_feedback_requests_6_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(2) = MR_r1;
	MR_sv(17) = (MR_Word) MR_CTOR0_ADDR(mdprof_create_feedback, option);
	MR_r1 = MR_sv(17);
	MR_r2 = MR_sv(13);
	MR_r3 = (MR_Integer) 5;
	MR_np_call_localret_ent(getopt__lookup_bool_option_3_0,
...
MR_def_label(mdprof_create_feedback__get_feedback_requests_6_0,16)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_sv(13);
	MR_sv(3) = (MR_Word) &mercury_float_const_1pt0000000000000000;
	MR_sv(15) = (MR_Integer) 1;
	MR_r3 = (MR_Integer) 17;
	MR_r1 = MR_sv(17);
...
MR_def_label(mdprof_create_feedback__get_feedback_requests_6_0,28)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_sv(13);
	MR_sv(15) = (MR_Word) &mercury_float_const_1pt0000000000000000;
	MR_sv(16) = (MR_Integer) 1;
	MR_r3 = (MR_Integer) 8;
	MR_r1 = MR_sv(17);
