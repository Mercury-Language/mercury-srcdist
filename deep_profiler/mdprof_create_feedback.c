...
{
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        *Algorithm_6 = (MR_Word) ((MR_Integer) 4);
        succeeded = MR_TRUE;
      }
      else
      {
        ...
        else
        {
          ...
          else
          {
            ...
            if (succeeded)
            {
              *Algorithm_6 = (MR_Word) ((MR_Integer) 0);
              succeeded = MR_TRUE;
            }
          }
        }
...
{
  {
    ...
    else
    {
      ...
      else
      {
        ...
        if ((Args_6 == (MR_Word) ((MR_Integer) 0)))
        {
          mdprof_create_feedback__write_help_message_3_p_0(ProgName_4);
          mercury__io__set_exit_status_3_p_0((MR_Integer) 1);
        }
        else
        {
          ...
          if ((Var_71 == (MR_Word) ((MR_Integer) 0)))
          {
            mdprof_create_feedback__write_help_message_3_p_0(ProgName_4);
            mercury__io__set_exit_status_3_p_0((MR_Integer) 1);
          }
          else
          {
            ...
            if ((Var_73 == (MR_Word) ((MR_Integer) 0)))
            {
...
{
  {
    ...
    switch (CandidateParallelConjunctions_13) {
      ...
      case (MR_Integer) 0:
        {
          MaybeAutoParOpts_41 = (MR_Word) ((MR_Integer) 0);
      ...
      case (MR_Integer) 1:
        {
          ...
          else
          {
            ...
            SpeedupAlg_32 = (MR_Word) ((MR_Integer) 0);
          }
          ...
          if (((MR_tag((MR_Word) MaybeAlgForFindingBestPar_34)) == (MR_mktag((MR_Integer) 1))))
          {
            ...
            if ((MaybeMessage_36 == (MR_Word) ((MR_Integer) 0)))
            {
              mercury__io__write_string_4_p_0(Stderr_12, ProgName_7);
              mercury__io__write_string_4_p_0(Stderr_12, (MR_String) ": error: ");
            ...
            *STATE_VARIABLE_Error_42 = (MR_Integer) 1;
            AlgForFindingBestPar_35 = (MR_Word) ((MR_Integer) 4);
          }
          else
          {
...
{
  {
    ...
    if ((MaybeParallelize_15 == (MR_Word) ((MR_Integer) 0)))
    {
...
{
  {
    ...
    if ((MaybeAutoParOpts_10 == (MR_Word) ((MR_Integer) 0)))
    {
...
{
  {
    ...
    switch (Debug_7) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        MaybeOutput_13 = (MR_Word) ((MR_Integer) 0);
        break;
      case (MR_Integer) 1:
        {
          MR_Word Stdout_12;
    ...
    startup__read_and_startup_default_deep_options_9_p_0((MR_String) "DummyServer", (MR_String) "DummyScript", Input_6, (MR_Integer) 0, MaybeOutput_13, (MR_Word) ((MR_Integer) 0), MaybeDeep_8);
  }
}
