...
static /* final */ const MR_Box mdprof_create_feedback_scalar_common_5[11][1];

static /* final */ const MR_Box mdprof_create_feedback_scalar_common_7[2][7];


/* sealed */ struct mdprof_create_feedback__vector_common_type_4_0_s {
  const MR_Word mdprof_create_feedback__vector_common_type_4_0__vct_4_f_0;
};

static /* final */ const struct mdprof_create_feedback__vector_common_type_4_0_s mdprof_create_feedback_vector_common_4[35];
...
static /* final */ const struct mdprof_create_feedback__vector_common_type_6_0_s mdprof_create_feedback_vector_common_6[21] = {
  ...
  {
    (MR_Integer) 0,
    (MR_Word) MR_mkword(MR_mktag(1), &mdprof_create_feedback_scalar_common_5[0])
  },
  /* row 1 */
  {
    (MR_Integer) 2,
    (MR_Word) MR_mkword(MR_mktag(2), &mdprof_create_feedback_scalar_common_5[1])
  },
  /* row 2 */
  {
    (MR_Integer) 1,
  ...
  {
    (MR_Integer) 9,
    (MR_Word) MR_mkword(MR_mktag(2), &mdprof_create_feedback_scalar_common_5[2])
  },
  /* row 10 */
  {
    (MR_Integer) 10,
    (MR_Word) MR_mkword(MR_mktag(2), &mdprof_create_feedback_scalar_common_5[3])
  },
  /* row 11 */
  {
    (MR_Integer) 11,
  ...
  {
    (MR_Integer) 13,
    (MR_Word) MR_mkword(MR_mktag(2), &mdprof_create_feedback_scalar_common_5[4])
  },
  /* row 14 */
  {
    (MR_Integer) 14,
  ...
  {
    (MR_Integer) 15,
    (MR_Word) MR_mkword(MR_mktag(2), &mdprof_create_feedback_scalar_common_5[5])
  },
  /* row 16 */
  {
    (MR_Integer) 16,
  ...
  {
    (MR_Integer) 18,
    (MR_Word) MR_mkword(MR_mktag(1), &mdprof_create_feedback_scalar_common_5[6])
  },
  /* row 18 */
  {
    (MR_Integer) 17,
    ...
    switch (mdprof_create_feedback__HeadVar__1_1) {
      ...
      case (MR_Integer) 1:
        if ((strcmp(mdprof_create_feedback__HeadVar__2_2, (MR_String) "naive") == 0))
          {
            *mdprof_create_feedback__HeadVar__3_3 = (MR_Word) MR_mkword(MR_mktag(1), &mdprof_create_feedback_scalar_common_5[9]);
            mdprof_create_feedback__succeeded = MR_TRUE;
          }
        else
        if ((strcmp(mdprof_create_feedback__HeadVar__2_2, (MR_String) "overlap") == 0))
          {
            *mdprof_create_feedback__HeadVar__3_3 = (MR_Word) MR_mkword(MR_mktag(1), &mdprof_create_feedback_scalar_common_5[10]);
            mdprof_create_feedback__succeeded = MR_TRUE;
          }
        else
            ...
            if (mdprof_create_feedback__succeeded)
              {
                ...
                mdprof_create_feedback__Var_26 = (MR_Word) &mdprof_create_feedback_scalar_common_3[5];
                ...
                if (mdprof_create_feedback__succeeded)
                  {
                    ...
                    mdprof_create_feedback__Var_34 = (MR_Word) &mdprof_create_feedback_scalar_common_3[6];
...
{
  {
        ...
        if (mdprof_create_feedback__succeeded)
          {
            ...
            {
              mercury__map__set_4_p_0((MR_Word) &mdprof_create_feedback__mdprof_create_feedback__type_ctor_info_option_0, (MR_Word) &mercury__getopt__getopt__type_ctor_info_option_data_0, ((MR_Box) ((MR_Integer) 2)), ((MR_Box) (MR_mkword(MR_mktag(2), &mdprof_create_feedback_scalar_common_5[8]))), mdprof_create_feedback__STATE_VARIABLE_Options_0_12, &mdprof_create_feedback__STATE_VARIABLE_Options_26_26);
            }
          }
        else
    ...
    switch (mdprof_create_feedback__ImplicitParallelism_11) {
      ...
      case (MR_Integer) 1:
        {
          {
            mercury__map__set_4_p_0((MR_Word) &mdprof_create_feedback__mdprof_create_feedback__type_ctor_info_option_0, (MR_Word) &mercury__getopt__getopt__type_ctor_info_option_data_0, ((MR_Box) ((MR_Integer) 5)), ((MR_Box) (MR_mkword(MR_mktag(1), &mdprof_create_feedback_scalar_common_5[6]))), mdprof_create_feedback__STATE_VARIABLE_Options_26_26, mdprof_create_feedback__STATE_VARIABLE_Options_13);
          }
        }
        break;
    }
...

    {
      ...
      if ((mdprof_create_feedback__case_num_0 < (MR_Integer) 0))
      ...
      else
        {
          ...
          *mdprof_create_feedback__HeadVar__2_2 = ((&mdprof_create_feedback_vector_common_4[0 + mdprof_create_feedback__case_num_0]))->mdprof_create_feedback__vector_common_type_4_0__vct_4_f_0;
          mdprof_create_feedback__succeeded = MR_TRUE;
        }
    }
    return mdprof_create_feedback__succeeded;
