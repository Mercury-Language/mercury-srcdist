...
main_2_p_0(void)
{
  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      mercury__map__set_4_p_0((MR_Word) (&mdprof_create_feedback__mdprof_create_feedback__type_ctor_info_option_0), (MR_Word) (&mercury__getopt__getopt__type_ctor_info_option_data_0), ((MR_Box) ((MR_Integer) 2)), ((MR_Box) (MR_mkword(MR_mktag(2), &mdprof_create_feedback_scalar_common_2[7]))), Options0_10, &STATE_VARIABLE_Options_26_103);
    }
    else
    {
      ...
      if (succeeded)
      {
        ...
        mercury__map__set_4_p_0((MR_Word) (&mdprof_create_feedback__mdprof_create_feedback__type_ctor_info_option_0), (MR_Word) (&mercury__getopt__getopt__type_ctor_info_option_data_0), ((MR_Box) ((MR_Integer) 2)), ((MR_Box) (MR_mkword(MR_mktag(2), &mdprof_create_feedback_scalar_common_2[8]))), Options0_10, &STATE_VARIABLE_Options_26_103);
      }
      else
    ...
    switch (ImplicitParallelism_92) {
      ...
      case (MR_Integer) 0:
        ...
        break;
      case (MR_Integer) 1:
        mercury__map__set_4_p_0((MR_Word) (&mdprof_create_feedback__mdprof_create_feedback__type_ctor_info_option_0), (MR_Word) (&mercury__getopt__getopt__type_ctor_info_option_data_0), ((MR_Box) ((MR_Integer) 5)), ((MR_Box) (MR_mkword(MR_mktag(1), &mdprof_create_feedback_scalar_common_2[6]))), STATE_VARIABLE_Options_26_103, &Options_11);
        break;
    }
    ...
    else
    {
      ...
      {
        MR_Word Var_73 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Args_6, (MR_Integer) 1))));
        MR_String Var_74 = ((MR_String) ((MR_hl_field(MR_mktag(1), Args_6, (MR_Integer) 0))));
        ...
        {
          MR_Word Var_75 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Var_73, (MR_Integer) 1))));
          MR_String Var_76 = ((MR_String) ((MR_hl_field(MR_mktag(1), Var_73, (MR_Integer) 0))));
  ...
  else
  {
    ...
    else
    {
      ...
      else
      {
        ...
        MR_Word Var_40 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Deep_20, (MR_Integer) 0))));

        ProfiledProgramName_23 = ((MR_String) ((MR_hl_field(MR_mktag(0), Var_40, (MR_Integer) 0))));
