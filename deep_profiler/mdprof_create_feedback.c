  ...
  if (succeeded)
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        TypeCtorInfo__46_46 = (MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0);
        succeeded = mercury__parsing_utils__brackets_7_p_0(TypeCtorInfo__46_46, Var_24, Var_25, Var_26, Src_5, &conv2_N_11, STATE_VARIABLE_PS_23_23, &STATE_VARIABLE_PS_27_27);
        if (succeeded)
        {
      ...
      else
      {
        ...
        if (succeeded)
        {
          ...
          TypeCtorInfo__51_51 = (MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0);
          succeeded = mercury__parsing_utils__brackets_7_p_0(TypeCtorInfo__51_51, Var_32, Var_33, Var_34, Src_5, &conv5_N_41, STATE_VARIABLE_PS_31_31, &STATE_VARIABLE_PS_35_35);
          if (succeeded)
          {
...
main_2_p_0(void)
{
  ...
  else
  {
    ...
    MR_Word Help_12;
    MR_Word Version_13;
    MR_Integer VerbosityLevel_91;
    MR_Word StdErr_92;
    MR_Word ImplicitParallelism_93;
    MR_Word STATE_VARIABLE_Options_26_104;

    mercury__getopt__lookup_int_option_3_p_0((MR_Word) (&mdprof_create_feedback__mdprof_create_feedback__type_ctor_info_option_0), Options0_10, ((MR_Box) ((MR_Integer) 2)), &VerbosityLevel_91);
    mercury__io__stderr_stream_3_p_0(&StdErr_92);
    succeeded = (VerbosityLevel_91 < (MR_Integer) 0);
    if (succeeded)
    {
      mercury__io__write_string_4_p_0(StdErr_92, ProgName_4);
      mercury__io__write_string_4_p_0(StdErr_92, (MR_String) ": warning: verbosity level should not be negative.\n");
      mercury__map__set_4_p_0((MR_Word) (&mdprof_create_feedback__mdprof_create_feedback__type_ctor_info_option_0), (MR_Word) (&mercury__getopt__getopt__type_ctor_info_option_data_0), ((MR_Box) ((MR_Integer) 2)), ((MR_Box) (MR_mkword(MR_mktag(2), &mdprof_create_feedback_scalar_common_2[7]))), Options0_10, &STATE_VARIABLE_Options_26_104);
    }
    else
    {
      succeeded = (VerbosityLevel_91 > (MR_Integer) 4);
      if (succeeded)
      {
        mercury__io__write_string_4_p_0(StdErr_92, ProgName_4);
        mercury__io__write_string_4_p_0(StdErr_92, (MR_String) ": warning: verbosity level should not exceed 4.\n");
        mercury__map__set_4_p_0((MR_Word) (&mdprof_create_feedback__mdprof_create_feedback__type_ctor_info_option_0), (MR_Word) (&mercury__getopt__getopt__type_ctor_info_option_data_0), ((MR_Box) ((MR_Integer) 2)), ((MR_Box) (MR_mkword(MR_mktag(2), &mdprof_create_feedback_scalar_common_2[8]))), Options0_10, &STATE_VARIABLE_Options_26_104);
      }
      else
        STATE_VARIABLE_Options_26_104 = Options0_10;
    }
    message__set_verbosity_level_3_p_0(VerbosityLevel_91);
    mercury__getopt__lookup_bool_option_3_p_0((MR_Word) (&mdprof_create_feedback__mdprof_create_feedback__type_ctor_info_option_0), STATE_VARIABLE_Options_26_104, ((MR_Box) ((MR_Integer) 6)), &ImplicitParallelism_93);
    switch (ImplicitParallelism_93) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        Options_11 = STATE_VARIABLE_Options_26_104;
        break;
      case (MR_Integer) 1:
        mercury__map__set_4_p_0((MR_Word) (&mdprof_create_feedback__mdprof_create_feedback__type_ctor_info_option_0), (MR_Word) (&mercury__getopt__getopt__type_ctor_info_option_data_0), ((MR_Box) ((MR_Integer) 5)), ((MR_Box) (MR_mkword(MR_mktag(1), &mdprof_create_feedback_scalar_common_2[6]))), STATE_VARIABLE_Options_26_104, &Options_11);
        break;
    }
