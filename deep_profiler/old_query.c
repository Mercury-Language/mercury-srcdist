...
MR_decl_label8(fn__old_query__generate_modules_page_3_0, 2,3,5,6,9,12,13,14)
MR_decl_label8(fn__old_query__generate_modules_page_3_0, 17,18,19,20,21,22,23,24)
MR_decl_label3(fn__old_query__generate_modules_page_3_0, 25,26,27)
...
MR_def_label(old_query__clique_to_html_6_0,14)
	...
	MR_tfield(0, MR_tempr3, 1) = (MR_Word) MR_CTOR0_ADDR(profile, clique_ptr);
	MR_r5 = MR_sv(8);
	MR_sv(2) = (MR_Word) MR_CTOR0_ADDR(profile, clique_ptr);
	MR_r2 = (MR_Word) MR_STRING_CTOR_ADDR;
	}
...
MR_BEGIN_MODULE(old_query_module24)
	...
	MR_init_label8(fn__old_query__generate_modules_page_3_0,2,3,5,6,9,12,13,14)
	MR_init_label8(fn__old_query__generate_modules_page_3_0,17,18,19,20,21,22,23,24)
	MR_init_label3(fn__old_query__generate_modules_page_3_0,25,26,27)
MR_BEGIN_CODE
