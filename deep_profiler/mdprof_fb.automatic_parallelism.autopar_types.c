...
{
  {
    ...
    if (succeeded)
    {
      ...
      mercury__list__foldl_4_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0), (MR_Word) (&mdprof_fb__automatic_parallelism__autopar_types_scalar_common_1[3]), Var_16, SharedVars_9, ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))), &conv1_Productions_12);
      ...
      mercury__list__foldl_4_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0), (MR_Word) (&mdprof_fb__automatic_parallelism__autopar_types_scalar_common_1[3]), Var_19, SharedVars_9, ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))), &conv3_Consumptions_13);
...
{
  {
    ...
    mercury__array__fetch_items_4_p_0((MR_Word) (&mdprof_fb__automatic_parallelism__autopar_types_scalar_common_1[0]), (MR_ArrayPtr) (Goals_5), Var_8, Var_9, &GoalsAfter_4);
    return GoalsAfter_4;
  }
}
