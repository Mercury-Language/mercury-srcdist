          ...
          case (MR_Integer) 1:
            {
              ...
              mercury__builtin__compare_3_p_0((MR_Word) (&mdprof_fb__automatic_parallelism__autopar_types_scalar_common_1[16]), &SubResult1_6, ((MR_Box) (ArgX1_4)), ((MR_Box) (ArgY1_5)));
              succeeded = (SubResult1_6 != (MR_Integer) 0);
              if (succeeded)
                *HeadVar__1_1 = SubResult1_6;
              else
                mercury__builtin__compare_3_p_0((MR_Word) (&mdprof_fb__automatic_parallelism__autopar_types_scalar_common_1[9]), HeadVar__1_1, ((MR_Box) (ArgX2_7)), ((MR_Box) (ArgY2_8)));
            }
            break;
        }
        break;
      ...
      case (MR_Integer) 1:
        {
          ...
          if (succeeded)
          {
            ...
            TypeInfo_11_11 = (MR_Word) (&mdprof_fb__automatic_parallelism__autopar_types_scalar_common_1[16]);
            succeeded = mercury__builtin__unify_2_p_0(TypeInfo_11_11, ((MR_Box) (ArgX1_3)), ((MR_Box) (ArgY1_4)));
            if (succeeded)
            {
              TypeInfo_12_12 = (MR_Word) (&mdprof_fb__automatic_parallelism__autopar_types_scalar_common_1[9]);
  ...
  MR_Word HeadVar__3_3)
{
  ...
  else
  {
    ...
    mdprof_fb__automatic_parallelism__autopar_types____Compare____parallel_execution_overlap_0_0(&SubResult1_6, ArgX1_4, ArgY1_5);
    succeeded = (SubResult1_6 != (MR_Integer) 0);
    if (succeeded)
      *HeadVar__1_1 = SubResult1_6;
    else
    {
      ...
      mdprof_fb__automatic_parallelism__autopar_types____Compare____dependent_conjunct_execution_0_0(&SubResult2_9, ArgX2_7, ArgY2_8);
      succeeded = (SubResult2_9 != (MR_Integer) 0);
      if (succeeded)
        *HeadVar__1_1 = SubResult2_9;
      else
        mercury__builtin__compare_3_p_0((MR_Word) (&mdprof_fb__automatic_parallelism__autopar_types_scalar_common_1[2]), HeadVar__1_1, ((MR_Box) (ArgX3_10)), ((MR_Box) (ArgY3_11)));
    }
  }
}
  ...
  MR_Word HeadVar__2_2)
{
  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      succeeded = mdprof_fb__automatic_parallelism__autopar_types____Unify____parallel_execution_overlap_0_0(ArgX1_3, ArgY1_4);
      if (succeeded)
      {
        succeeded = mdprof_fb__automatic_parallelism__autopar_types____Unify____dependent_conjunct_execution_0_0(ArgX2_5, ArgY2_6);
        if (succeeded)
        {
  ...
  MR_Word * STATE_VARIABLE_List_12)
{
  ...
  if (succeeded)
  {
    MR_Float UseTime_10 = MR_unbox_float((MR_hl_field(0, Use_9, 0)));
    MR_Word Var_14;
  ...
  MR_Box * wrapper_arg_3)
{
  ...
  mdprof_fb__automatic_parallelism__autopar_types__build_var_use_list_4_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Integer) (wrapper_arg_1)), ((MR_Word) (wrapper_arg_2)), &conv2_STATE_VARIABLE_List_12);
  ...
  MR_Box * wrapper_arg_3)
{
  ...
  mdprof_fb__automatic_parallelism__autopar_types__build_var_use_list_4_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Integer) (wrapper_arg_1)), ((MR_Word) (wrapper_arg_2)), &conv0_STATE_VARIABLE_List_12);
  ...
  MR_Word * PG_6)
{
  ...
  if (succeeded)
  {
    ...
    Var_21 = ((MR_Word) ((MR_hl_field(0, PGD_5, 7))));
    {
  ...
  MR_Word Incomplete_3)
{
  ...
  MR_Word Var_8;
  MR_Word Var_9;
  MR_ArrayPtr Goals_18 = ((MR_ArrayPtr) ((MR_hl_field(0, Incomplete_3, 0))));
  MR_Integer Start_19 = ((MR_Integer) ((MR_hl_field(0, Incomplete_3, 1))));
  MR_Integer Last_20 = ((MR_Integer) ((MR_hl_field(0, Incomplete_3, 3))));
  MR_Word LastGoalsRev0_21 = ((MR_Word) ((MR_hl_field(0, Incomplete_3, 4))));
  ...
  MR_Word Incomplete_3)
{
  ...
  MR_Integer LastParGoal_4 = ((MR_Integer) ((MR_hl_field(0, Incomplete_3, 2))));
  MR_Integer FirstParGoal_5 = ((MR_Integer) ((MR_hl_field(0, Incomplete_3, 1))));
  ...
  MR_Word Incomplete_3)
{
  MR_Integer HeadVar__2_2;
  MR_Integer Var_4;
  MR_Word Var_5 = ((MR_Word) ((MR_hl_field(0, Incomplete_3, 4))));
...
{
  MR_Integer HeadVar__2_2;
  MR_ArrayPtr Var_4 = ((MR_ArrayPtr) ((MR_hl_field(0, Incomplete_3, 0))));
...
{
  MR_Word ParConjs_4;
  MR_ArrayPtr Goals_5 = ((MR_ArrayPtr) ((MR_hl_field(0, Incomplete_3, 0))));
  MR_Integer Start_6 = ((MR_Integer) ((MR_hl_field(0, Incomplete_3, 1))));
  MR_Integer Last_7 = ((MR_Integer) ((MR_hl_field(0, Incomplete_3, 3))));
  MR_Word LastGoalsRev0_8 = ((MR_Word) ((MR_hl_field(0, Incomplete_3, 4))));
  ...
  MR_Word * HeadVar__4_4)
{
  ...
  {
    MR_Integer Last_9 = ((MR_Integer) ((MR_hl_field(1, HeadVar__3_3, 0))));
    MR_Word Lasts_10 = ((MR_Word) ((MR_hl_field(1, HeadVar__3_3, 1))));
    MR_Word Conj_11;
    MR_Word Conjs_12;
    MR_Word Goals_13;
  ...
  MR_Word Parallelisation_3)
{
  ...
  MR_ArrayPtr Goals_5 = ((MR_ArrayPtr) ((MR_hl_field(0, Parallelisation_3, 0))));
  MR_Integer LastParGoalIndex_6 = ((MR_Integer) ((MR_hl_field(0, Parallelisation_3, 2))));
  ...
  MR_Word Parallelisation_3)
{
  ...
  MR_ArrayPtr Goals_5 = ((MR_ArrayPtr) ((MR_hl_field(0, Parallelisation_3, 0))));
  MR_Integer FirstParGoalIndex_6 = ((MR_Integer) ((MR_hl_field(0, Parallelisation_3, 1))));
  ...
  MR_Word * HeadVar__3_3)
{
  ...
  else
  {
    ...
    Var_13 = ((MR_Word) ((MR_hl_field(0, Goal_5, 2))));
    CostAboveThreshold_16 = ((MR_Unsigned) ((MR_hl_field(0, Var_13, 5))) & (MR_Integer) 1);
...
mdprof_fb__automatic_parallelism__autopar_types__identify_costly_goal_2_p_0(
  ...
  MR_Word * Costly_4)
{
  MR_Word CostAboveThreshold_5 = ((MR_Unsigned) ((MR_hl_field(0, Annotation_3, 5))) & (MR_Integer) 1);
  ...
  MR_Word * STATE_VARIABLE_Consumed_13)
{
  ...
  MR_Word Var_14 = ((MR_Word) ((MR_hl_field(0, Conj_6, 2))));
  MR_Word Var_16;
  MR_Word Var_18;

  InstMapInfo_9 = ((MR_Word) ((MR_hl_field(0, Var_14, 1))));
  Var_16 = ((MR_Word) ((MR_hl_field(0, InstMapInfo_9, 3))));
  *STATE_VARIABLE_Produced_11 = mercury__set__union_2_f_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0), STATE_VARIABLE_Produced_0_10, Var_16);
  Var_18 = ((MR_Word) ((MR_hl_field(0, InstMapInfo_9, 2))));
  ...
  MR_Box * wrapper_arg_2)
{
  ...
  mdprof_fb__automatic_parallelism__autopar_types__pard_goal_detail_annon_to_pard_goal_annon_3_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) (wrapper_arg_1)), &conv0_PG_6);
...
{
  MR_Word IsDependent_6 = ((MR_Word) ((MR_hl_field(0, CPC_4, 3))));
  ...
  if ((IsDependent_6 == (MR_Word) ((MR_Unsigned) 0U)))
    ...
    SharedVars_7 = ((MR_Word) ((MR_hl_field(1, IsDependent_6, 0))));
  {
