...
{
  {
    ...
    succeeded = (FirstGoalAfter_8 >= NumGoals_7);
    if (succeeded)
      GoalsAfter_4 = (MR_Word) ((MR_Unsigned) 0U);
    else
    {
      MR_Integer Var_10 = (MR_Integer) ((MR_Unsigned) NumGoals_7 - (MR_Unsigned) 1);
...
{
  {
    ...
    succeeded = (LastGoalBefore_7 < (MR_Integer) 0);
    if (succeeded)
      GoalsBefore_4 = (MR_Word) ((MR_Unsigned) 0U);
    else
    {
