...
{
  {
    ...
    if (succeeded)
    {
      ...
      mercury__list__foldl_4_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0), (MR_Word) (&mdprof_fb__automatic_parallelism__autopar_types_scalar_common_1[3]), Var_16, SharedVars_9, ((MR_Box) ((MR_Integer) 0)), &conv1_Productions_12);
      ...
      mercury__list__foldl_4_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0), (MR_Word) (&mdprof_fb__automatic_parallelism__autopar_types_scalar_common_1[3]), Var_19, SharedVars_9, ((MR_Box) ((MR_Integer) 0)), &conv3_Consumptions_13);
      Consumptions_13 = ((MR_Word) (conv3_Consumptions_13));
    }
    else
    {
      Productions_12 = (MR_Word) ((MR_Integer) 0);
      Consumptions_13 = (MR_Word) ((MR_Integer) 0);
    }
    {
      MR_Word base;
...
{
  {
    ...
    if ((IsDependent_6 == (MR_Word) ((MR_Integer) 0)))
    {
