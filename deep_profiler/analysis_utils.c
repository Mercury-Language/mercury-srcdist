...
struct analysis_utils__build_recursive_call_site_counts_map_5_p_0_env_0_s {
  ...
  MR_Word analysis_utils__build_recursive_call_site_counts_map_5_p_0_env_0__TypeCtorInfo__45_45;
  ...
  void * env_ptr_arg)
{
  ...
  (env_ptr)->analysis_utils__build_recursive_call_site_counts_map_5_p_0_env_0__TypeCtorInfo__45_45 = (MR_Word) (&profile__profile__type_ctor_info_clique_ptr_0);
    ...
    else
    {
      ...
      if ((env).analysis_utils__build_recursive_call_site_counts_map_5_p_0_env_0__succeeded)
      {
        ...
        if ((env).analysis_utils__build_recursive_call_site_counts_map_5_p_0_env_0__succeeded)
        {
          ...
          profile__deep_lookup_csd_own_3_p_0(Deep_6, CSDPtr_11, &Own_51);
          Count_83 = measurements__calls_1_f_0(Own_51);
          profile__deep_lookup_clique_maybe_child_3_p_0(Deep_6, CSDPtr_11, &MaybeCallee_13);
        }
        else
        {
          Count_83 = (MR_Integer) 0;
        ...
        {
          MR_Word Var_54 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MaybeCallee_13, (MR_Integer) 0))));

          (env).analysis_utils__build_recursive_call_site_counts_map_5_p_0_env_0__succeeded = mercury__builtin__unify_2_p_0((MR_Word) (&profile__profile__type_ctor_info_clique_ptr_0), ((MR_Box) ((env).analysis_utils__build_recursive_call_site_counts_map_5_p_0_env_0__CliquePtr_7)), ((MR_Box) (Var_54)));
        }
        if ((env).analysis_utils__build_recursive_call_site_counts_map_5_p_0_env_0__succeeded)
        {
          MR_Word CSS_67;
          ...
          Var_63 = ((MR_Word) ((MR_hl_field(MR_mktag(0), CSS_67, (MR_Integer) 0))));
          Var_64 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), CSS_67, (MR_Integer) 1))));
          Var_65 = ((MR_Word) ((MR_hl_field(MR_mktag(0), CSS_67, (MR_Integer) 2))));
          Var_66 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), CSS_67, (MR_Integer) 3))));
          RevGoalPath_68 = ((MR_Word) ((MR_hl_field(MR_mktag(0), CSS_67, (MR_Integer) 4))));
          mercury__map__det_insert_4_p_0((MR_Word) (&mdbcomp__goal_path__mdbcomp__goal_path__type_ctor_info_reverse_goal_path_0), (MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0), ((MR_Box) (RevGoalPath_68)), ((MR_Box) (Count_83)), STATE_VARIABLE_Map_0_21, STATE_VARIABLE_Map_22);
        }
        else
          *STATE_VARIABLE_Map_22 = STATE_VARIABLE_Map_0_21;
      }
