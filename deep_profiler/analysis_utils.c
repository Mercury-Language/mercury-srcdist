    ...
    else
      {
        ...
        if (analysis_utils__succeeded)
        ...
        else
          {
            ...
            MR_Word analysis_utils__V_84_84;
            MR_Word analysis_utils__V_85_85;
            MR_Box analysis_utils__conv1_CallCountsMap_19;
            ...
            {
              analysis_utils__V_84_84 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 5 * sizeof(MR_Word)), NULL, NULL);
              MR_hl_field(MR_mktag(0), analysis_utils__V_84_84, 0) = ((MR_Box) (&analysis_utils_scalar_common_5[1]));
              MR_hl_field(MR_mktag(0), analysis_utils__V_84_84, 1) = ((MR_Box) (analysis_utils__build_recursive_call_site_cost_map_6_p_0_1));
              MR_hl_field(MR_mktag(0), analysis_utils__V_84_84, 2) = ((MR_Box) (MR_Word) ((MR_Integer) 2));
              MR_hl_field(MR_mktag(0), analysis_utils__V_84_84, 3) = ((MR_Box) (analysis_utils__Deep_7));
              MR_hl_field(MR_mktag(0), analysis_utils__V_84_84, 4) = ((MR_Box) (analysis_utils__CliquePtr_8));
            }
            {
              analysis_utils__V_85_85 = mercury__map__init_0_f_0((MR_Word) &mdbcomp__goal_path__mdbcomp__goal_path__type_ctor_info_reverse_goal_path_0, (MR_Word) &mercury__builtin__builtin__type_ctor_info_int_0);
            }
            {
              mercury__list__foldl_4_p_0((MR_Word) &analysis_utils_scalar_common_2[0], (MR_Word) &analysis_utils_scalar_common_2[1], analysis_utils__V_84_84, analysis_utils__SiteSlots_83, ((MR_Box) (analysis_utils__V_85_85)), &analysis_utils__conv1_CallCountsMap_19);
            }
            analysis_utils__CallCountsMap_19 = ((MR_Word) analysis_utils__conv1_CallCountsMap_19);
            {
              analysis_utils__V_41_41 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 5 * sizeof(MR_Word)), NULL, NULL);
