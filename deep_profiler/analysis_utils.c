...
MR_decl_label10(analysis_utils__build_recursive_call_site_counts_map_5_0, 5,7,9,14,16,17,15,13,20,3)
MR_decl_label10(analysis_utils__build_recursive_call_site_counts_map_5_0, 25,29,31,32,33,28,34,39,37,41)
MR_decl_label2(analysis_utils__build_recursive_call_site_counts_map_5_0, 36,23)
MR_decl_label10(analysis_utils__build_static_call_site_cost_and_callee_map_4_0, 2,3,4,5,6,7,8,9,10,12)
MR_decl_label10(analysis_utils__build_static_call_site_cost_and_callee_map_4_0, 11,15,14,19,18,23,22,27,26,31)
...
MR_BEGIN_MODULE(analysis_utils_module2)
	...
	MR_init_label10(analysis_utils__build_static_call_site_cost_and_callee_map_4_0,11,15,14,19,18,23,22,27,26,31)
MR_BEGIN_CODE
...
MR_def_label(analysis_utils__build_static_call_site_cost_and_callee_map_4_0,14)
	...
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(profile, proc_static_ptr);
	MR_np_call_localret_ent(fn__set__init_0_0,
		analysis_utils__build_static_call_site_cost_and_callee_map_4_0_i19);
MR_def_label(analysis_utils__build_static_call_site_cost_and_callee_map_4_0,19)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 0, (MR_Integer) 4);
...
MR_def_label(analysis_utils__build_static_call_site_cost_and_callee_map_4_0,18)
	...
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(profile, proc_static_ptr);
	MR_np_call_localret_ent(fn__set__init_0_0,
		analysis_utils__build_static_call_site_cost_and_callee_map_4_0_i23);
...
MR_def_label(analysis_utils__build_recursive_call_site_cost_map_6_0,3)
	...
	* (MR_Float *) &MR_sv(5) = MR_word_to_float(MR_tfield(1, MR_tempr1, 2));
	MR_sv(1) = MR_r1;
	MR_sv(2) = MR_r2;
	MR_sv(3) = MR_r3;
...
MR_def_label(analysis_utils__build_recursive_call_site_cost_map_6_0,17)
	...
	MR_tfield(0, MR_tempr1, 2) = (MR_Integer) 2;
	MR_tfield(0, MR_tempr1, 3) = MR_float_to_word(MR_float_from_dword_ptr(&MR_sv(5)));
...
MR_BEGIN_MODULE(analysis_utils_module10)
	...
	MR_init_label10(analysis_utils__build_recursive_call_site_counts_map_5_0,5,7,9,14,16,17,15,13,20,3)
	MR_init_label10(analysis_utils__build_recursive_call_site_counts_map_5_0,25,29,31,32,33,28,34,39,37,41)
	MR_init_label2(analysis_utils__build_recursive_call_site_counts_map_5_0,36,23)
MR_BEGIN_CODE
...
MR_def_label(analysis_utils__build_recursive_call_site_counts_map_5_0,15)
	...
	MR_np_call_localret_ent(profile__deep_lookup_call_site_statics_3_0,
		analysis_utils__build_recursive_call_site_counts_map_5_0_i20);
...
MR_def_label(analysis_utils__build_recursive_call_site_counts_map_5_0,20)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
...
MR_def_static(fn__analysis_utils__IntroducedFrom__func__build_recursive_call_site_cost_map__272__1_3_0)
	...
	MR_incr_sp(6);
	MR_sv(6) = (MR_Word) MR_succip;
	* (MR_Float *) &MR_sv(5) = MR_word_to_float(MR_r1);
	MR_sv(1) = MR_r2;
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r3;
