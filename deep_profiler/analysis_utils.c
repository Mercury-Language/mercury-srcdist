  ...
  void * env_ptr_arg)
{
  ...
  {
    MR_Word Var_48 = ((MR_Word) ((MR_hl_field(MR_mktag(1), (env_ptr)->analysis_utils__build_recursive_call_site_counts_map_5_p_0_env_0__MaybeCallee_28, (MR_Integer) 0))));
  ...
  (env).analysis_utils__build_recursive_call_site_counts_map_5_p_0_env_0__CliquePtr_7 = CliquePtr_7;
  {
    ...
    if (((MR_tag((MR_Word) CSDSlot_9)) == (MR_Integer) 1))
    {
      ...
      if ((env).analysis_utils__build_recursive_call_site_counts_map_5_p_0_env_0__succeeded)
      {
        ...
        Var_29 = ((MR_Word) ((MR_hl_field(MR_mktag(0), CSS_19, (MR_Integer) 0))));
        Var_30 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), CSS_19, (MR_Integer) 1))));
        Var_31 = ((MR_Word) ((MR_hl_field(MR_mktag(0), CSS_19, (MR_Integer) 2))));
        Var_32 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), CSS_19, (MR_Integer) 3))));
    ...
    else
    {
      ...
      if ((env).analysis_utils__build_recursive_call_site_counts_map_5_p_0_env_0__succeeded)
      {
        ...
        if ((env).analysis_utils__build_recursive_call_site_counts_map_5_p_0_env_0__succeeded)
        {
          ...
          profile__deep_lookup_csd_own_3_p_0(Deep_6, CSDPtr_11, &Own_53);
          Count_85 = measurements__calls_1_f_0(Own_53);
        ...
        {
          MR_Word Var_56 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MaybeCallee_13, (MR_Integer) 0))));

          (env).analysis_utils__build_recursive_call_site_counts_map_5_p_0_env_0__succeeded = mercury__builtin__unify_2_p_0((MR_Word) (&profile__profile__type_ctor_info_clique_ptr_0), ((MR_Box) ((env).analysis_utils__build_recursive_call_site_counts_map_5_p_0_env_0__CliquePtr_7)), ((MR_Box) (Var_56)));
        }
        if ((env).analysis_utils__build_recursive_call_site_counts_map_5_p_0_env_0__succeeded)
        {
          MR_Word CSS_69;
          MR_Word RevGoalPath_70;
          MR_Word Var_65;
          MR_Integer Var_66;
          MR_Word Var_67;
          MR_Integer Var_68;

          profile__deep_lookup_call_site_statics_3_p_0(Deep_6, CSSPtr_8, &CSS_69);
          Var_65 = ((MR_Word) ((MR_hl_field(MR_mktag(0), CSS_69, (MR_Integer) 0))));
          Var_66 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), CSS_69, (MR_Integer) 1))));
          Var_67 = ((MR_Word) ((MR_hl_field(MR_mktag(0), CSS_69, (MR_Integer) 2))));
          Var_68 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), CSS_69, (MR_Integer) 3))));
          RevGoalPath_70 = ((MR_Word) ((MR_hl_field(MR_mktag(0), CSS_69, (MR_Integer) 4))));
          mercury__map__det_insert_4_p_0((MR_Word) (&mdbcomp__goal_path__mdbcomp__goal_path__type_ctor_info_reverse_goal_path_0), (MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0), ((MR_Box) (RevGoalPath_70)), ((MR_Box) (Count_85)), STATE_VARIABLE_Map_0_21, STATE_VARIABLE_Map_22);
        }
        else
          *STATE_VARIABLE_Map_22 = STATE_VARIABLE_Map_0_21;
      }
  ...
  MR_Box wrapper_arg_1)
{
  ...
  conv2_LambdaHeadVar__2_42 = analysis_utils__IntroducedFrom__func__build_recursive_call_site_cost_map__271__2_3_f_0(MR_unbox_float((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))), ((MR_Integer) (wrapper_arg_1)));
        ...
        else
        {
          ...
          else
          {
            ...
            CallCountsMap_19 = ((MR_Word) (conv1_CallCountsMap_19));
            {
              ...
              MR_hl_field(MR_mktag(0), Var_40, 0) = ((MR_Box) (&analysis_utils_scalar_common_6[0]));
              MR_hl_field(MR_mktag(0), Var_40, 1) = ((MR_Box) (analysis_utils__build_recursive_call_site_cost_map_6_p_1_2));
              MR_hl_field(MR_mktag(0), Var_40, 2) = ((MR_Box) ((MR_Integer) 2));
              MR_hl_field(MR_mktag(0), Var_40, 3) = MR_box_float(MaxDepth_15);
              MR_hl_field(MR_mktag(0), Var_40, 4) = ((MR_Box) (CostFn_17));
            }
  ...
  MR_Box wrapper_arg_1)
{
  ...
  conv2_LambdaHeadVar__2_42 = analysis_utils__IntroducedFrom__func__build_recursive_call_site_cost_map__271__1_3_f_0(MR_unbox_float((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))), ((MR_Integer) (wrapper_arg_1)));
  wrapper_arg_2 = ((MR_Box) (conv2_LambdaHeadVar__2_42));
  return wrapper_arg_2;
}
  ...
  else
  {
    ...
    else
    {
      ...
      analysis_utils__proc_dynamic_paired_call_site_slots_3_p_0(Deep_7, PDPtr_9, &SiteSlots_76);
      {
        Var_77 = (MR_Word) MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), Var_77, 0) = ((MR_Box) (&analysis_utils_scalar_common_5[1]));
        MR_hl_field(MR_mktag(0), Var_77, 1) = ((MR_Box) (analysis_utils__build_recursive_call_site_cost_map_6_p_0_1));
        MR_hl_field(MR_mktag(0), Var_77, 2) = ((MR_Box) ((MR_Integer) 2));
        MR_hl_field(MR_mktag(0), Var_77, 3) = ((MR_Box) (Deep_7));
        MR_hl_field(MR_mktag(0), Var_77, 4) = ((MR_Box) (CliquePtr_8));
      }
      ...
      CallCountsMap_19 = ((MR_Word) (conv1_CallCountsMap_19));
      {
        Var_40 = (MR_Word) MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), Var_40, 0) = ((MR_Box) (&analysis_utils_scalar_common_6[0]));
        MR_hl_field(MR_mktag(0), Var_40, 1) = ((MR_Box) (analysis_utils__build_recursive_call_site_cost_map_6_p_0_2));
        MR_hl_field(MR_mktag(0), Var_40, 2) = ((MR_Box) ((MR_Integer) 2));
        MR_hl_field(MR_mktag(0), Var_40, 3) = MR_box_float(MaxDepth_15);
        MR_hl_field(MR_mktag(0), Var_40, 4) = ((MR_Box) (CostFn_17));
      }
  ...
  MR_Word * STATE_VARIABLE_CallSitesMap_26)
{
  ...
  if (((MR_tag((MR_Word) Slot_7)) == (MR_Integer) 1))
  {
    ...
    mercury__array__to_list_2_p_0((MR_Word) (&profile__profile__type_ctor_info_call_site_dynamic_ptr_0), (MR_ArrayPtr) (CSDPtrsArray_17), &CSDPtrs_18);
    {
      ...
      MR_hl_field(MR_mktag(0), Var_35, 0) = ((MR_Box) (&analysis_utils_scalar_common_5[0]));
      MR_hl_field(MR_mktag(0), Var_35, 1) = ((MR_Box) (analysis_utils__build_dynamic_call_site_cost_and_callee_map_4_p_0_1));
      MR_hl_field(MR_mktag(0), Var_35, 2) = ((MR_Box) ((MR_Integer) 1));
      MR_hl_field(MR_mktag(0), Var_35, 3) = ((MR_Box) (Deep_5));
    }
