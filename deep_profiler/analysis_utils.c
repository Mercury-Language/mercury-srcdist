...
#line 247 "analysis_utils.c"
static MR_bool MR_CALL 
analysis_utils____Unify____cost_and_callees_0_0_10001(
#line 250 "analysis_utils.c"
  MR_Box analysis_utils__wrapper_arg_1,
#line 252 "analysis_utils.c"
  MR_Box analysis_utils__wrapper_arg_2);

#line 255 "analysis_utils.c"
static void MR_CALL 
analysis_utils____Compare____cost_and_callees_0_0_10001(
#line 258 "analysis_utils.c"
  MR_Box * analysis_utils__wrapper_arg_1,
#line 260 "analysis_utils.c"
  MR_Box analysis_utils__wrapper_arg_2,
#line 262 "analysis_utils.c"
  MR_Box analysis_utils__wrapper_arg_3);

#line 265 "analysis_utils.c"
static MR_bool MR_CALL 
analysis_utils____Unify____higher_order_0_0_10001(
#line 268 "analysis_utils.c"
  MR_Box analysis_utils__wrapper_arg_1,
#line 270 "analysis_utils.c"
  MR_Box analysis_utils__wrapper_arg_2);

#line 273 "analysis_utils.c"
static void MR_CALL 
analysis_utils____Compare____higher_order_0_0_10001(
#line 276 "analysis_utils.c"
  MR_Box * analysis_utils__wrapper_arg_1,
#line 278 "analysis_utils.c"
  MR_Box analysis_utils__wrapper_arg_2,
...
#line 800 "analysis_utils.c"
static const MR_DuFunctorDescPtr analysis_utils__analysis_utils__du_name_ordered_cost_and_callees_1[1] = {
  &analysis_utils__analysis_utils__du_functor_desc_cost_and_callees_1_0
};

#line 805 "analysis_utils.c"
static const MR_Integer analysis_utils__analysis_utils__functor_number_map_cost_and_callees_1[1] = {
  (MR_Integer) 0
};

#line 810 "analysis_utils.c"
...
{
#line 920 "analysis_utils.c"
  {
#line 922 "analysis_utils.c"
...
{
#line 948 "analysis_utils.c"
  {
#line 950 "analysis_utils.c"
...
{
#line 976 "analysis_utils.c"
  {
#line 978 "analysis_utils.c"
    MR_bool analysis_utils__succeeded;
...
static void MR_CALL 
analysis_utils____Compare____cost_and_callees_1_0_10001(
#line 996 "analysis_utils.c"
  MR_Box analysis_utils__wrapper_arg_1,
#line 998 "analysis_utils.c"
  MR_Box * analysis_utils__wrapper_arg_2,
...
{
#line 1006 "analysis_utils.c"
  {
#line 1008 "analysis_utils.c"
    MR_Word analysis_utils__conv0_HeadVar__1_1;
...
{
#line 1032 "analysis_utils.c"
  {
#line 1034 "analysis_utils.c"
    MR_bool analysis_utils__succeeded;
...
{
#line 1060 "analysis_utils.c"
  {
#line 1062 "analysis_utils.c"
    MR_Word analysis_utils__conv0_HeadVar__1_1;
...
{
#line 1086 "analysis_utils.c"
  {
#line 1088 "analysis_utils.c"
    MR_bool analysis_utils__succeeded;
...
{
#line 1114 "analysis_utils.c"
  {
#line 1116 "analysis_utils.c"
    MR_Word analysis_utils__conv0_HeadVar__1_1;

#line 1119 "analysis_utils.c"
    {
#line 1121 "analysis_utils.c"
...
#line 1124 "analysis_utils.c"
    *analysis_utils__wrapper_arg_1 = ((MR_Box) (analysis_utils__conv0_HeadVar__1_1));
#line 1126 "analysis_utils.c"
  }
#line 1128 "analysis_utils.c"
}
...
#line 69 "analysis_utils.m"
{
#line 1345 "analysis_utils.c"
  {
#line 1347 "analysis_utils.c"
    MR_bool analysis_utils__succeeded = (analysis_utils__HeadVar__2_1 == analysis_utils__HeadVar__2_2);

#line 1350 "analysis_utils.c"
    return analysis_utils__succeeded;
#line 1352 "analysis_utils.c"
  }
#line 69 "analysis_utils.m"
}
...
#line 55 "analysis_utils.m"
              {
#line 1552 "analysis_utils.c"
                {
#line 1554 "analysis_utils.c"
...
#line 2179 "analysis_utils.c"
            }
#line 2181 "analysis_utils.c"
          else
...
#line 2199 "analysis_utils.c"
          if ((analysis_utils__env).analysis_utils__build_recursive_call_site_counts_map_5_p_0_env_0__succeeded)
#line 2201 "analysis_utils.c"
            {
#line 2203 "analysis_utils.c"
              MR_Word analysis_utils__MaybeCallee_13;
#line 2205 "analysis_utils.c"
...
#line 2265 "analysis_utils.c"
              if ((analysis_utils__env).analysis_utils__build_recursive_call_site_counts_map_5_p_0_env_0__succeeded)
#line 2267 "analysis_utils.c"
                {
#line 2269 "analysis_utils.c"
                  MR_Word analysis_utils__CSS_71;
#line 2271 "analysis_utils.c"
...
#line 2304 "analysis_utils.c"
                }
#line 2306 "analysis_utils.c"
              else
#line 367 "analysis_utils.m"
                *analysis_utils__STATE_VARIABLE_Map_22 = analysis_utils__STATE_VARIABLE_Map_0_21;
#line 2310 "analysis_utils.c"
            }
#line 2312 "analysis_utils.c"
          else
#line 367 "analysis_utils.m"
            *analysis_utils__STATE_VARIABLE_Map_22 = analysis_utils__STATE_VARIABLE_Map_0_21;
#line 2316 "analysis_utils.c"
        }
#line 332 "analysis_utils.m"
    }
#line 327 "analysis_utils.m"
...
#line 4145 "analysis_utils.c"
      }
#line 4147 "analysis_utils.c"
    else
#line 4149 "analysis_utils.c"
      if ((analysis_utils__KindAndCallee_13 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 1)))))
#line 4151 "analysis_utils.c"
        {
#line 249 "analysis_utils.m"
          {
#line 249 "analysis_utils.m"
...
#line 4158 "analysis_utils.c"
        }
#line 4160 "analysis_utils.c"
      else
#line 4162 "analysis_utils.c"
        if ((analysis_utils__KindAndCallee_13 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 2)))))
#line 4164 "analysis_utils.c"
          {
#line 249 "analysis_utils.m"
            {
#line 249 "analysis_utils.m"
...
#line 4171 "analysis_utils.c"
          }
#line 4173 "analysis_utils.c"
        else
#line 4175 "analysis_utils.c"
          if ((analysis_utils__KindAndCallee_13 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
#line 4177 "analysis_utils.c"
            {
#line 249 "analysis_utils.m"
              {
#line 249 "analysis_utils.m"
...
#line 4184 "analysis_utils.c"
            }
#line 4186 "analysis_utils.c"
          else
#line 4188 "analysis_utils.c"
            {
#line 4190 "analysis_utils.c"
              MR_Word analysis_utils__Callee_16 = ((MR_Word) (MR_hl_field(MR_mktag(1), analysis_utils__KindAndCallee_13, (MR_Integer) 0)));
#line 4192 "analysis_utils.c"
              MR_Word analysis_utils__V_27_27;
