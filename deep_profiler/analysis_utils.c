  ...
  (env).analysis_utils__build_recursive_call_site_counts_map_5_p_0_env_0__CliquePtr_7 = CliquePtr_7;
  {
    ...
    else
    {
      ...
      if ((env).analysis_utils__build_recursive_call_site_counts_map_5_p_0_env_0__succeeded)
      {
        ...
        {
          MR_Word Var_52 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MaybeCallee_13, (MR_Integer) 0))));
        ...
        if ((env).analysis_utils__build_recursive_call_site_counts_map_5_p_0_env_0__succeeded)
        {
          ...
          Var_61 = ((MR_Word) ((MR_hl_field(MR_mktag(0), CSS_65, (MR_Integer) 0))));
          Var_62 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), CSS_65, (MR_Integer) 1))));
          Var_63 = ((MR_Word) ((MR_hl_field(MR_mktag(0), CSS_65, (MR_Integer) 2))));
          Var_64 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), CSS_65, (MR_Integer) 3))));
          RevGoalPath_66 = ((MR_Word) ((MR_hl_field(MR_mktag(0), CSS_65, (MR_Integer) 4))));
        ...
        else
        {
          ...
          else
          {
            ...
            analysis_utils__proc_dynamic_paired_call_site_slots_3_p_0(Deep_7, PDPtr_9, &SiteSlots_72);
            {
              ...
              MR_hl_field(MR_mktag(0), Var_73, 0) = ((MR_Box) (&analysis_utils_scalar_common_5[1]));
              MR_hl_field(MR_mktag(0), Var_73, 1) = ((MR_Box) (analysis_utils__build_recursive_call_site_cost_map_6_p_1_1));
              MR_hl_field(MR_mktag(0), Var_73, 2) = ((MR_Box) ((MR_Integer) 2));
              MR_hl_field(MR_mktag(0), Var_73, 3) = ((MR_Box) (Deep_7));
              MR_hl_field(MR_mktag(0), Var_73, 4) = ((MR_Box) (CliquePtr_8));
            }
  ...
  else
  {
    ...
    else
    {
      ...
      analysis_utils__proc_dynamic_paired_call_site_slots_3_p_0(Deep_7, PDPtr_9, &SiteSlots_72);
      {
        Var_73 = (MR_Word) MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), Var_73, 0) = ((MR_Box) (&analysis_utils_scalar_common_5[1]));
        MR_hl_field(MR_mktag(0), Var_73, 1) = ((MR_Box) (analysis_utils__build_recursive_call_site_cost_map_6_p_0_1));
        MR_hl_field(MR_mktag(0), Var_73, 2) = ((MR_Box) ((MR_Integer) 2));
        MR_hl_field(MR_mktag(0), Var_73, 3) = ((MR_Box) (Deep_7));
        MR_hl_field(MR_mktag(0), Var_73, 4) = ((MR_Box) (CliquePtr_8));
      }
