  ...
  MR_Box wrapper_arg_1)
{
  ...
  conv2_LambdaHeadVar__2_42 = analysis_utils__IntroducedFrom__func__build_recursive_call_site_cost_map__272__2_3_f_0(MR_unbox_float((MR_hl_field(0, closure, 3))), ((MR_Word) ((MR_hl_field(0, closure, 4)))), ((MR_Integer) (wrapper_arg_1)));
  ...
  switch (MR_tag((MR_Word) RecursionType_10)) {
    ...
    case (MR_Integer) 3:
      switch (((MR_Integer) ((MR_hl_field(3, RecursionType_10, 0))))) {
        ...
        case (MR_Integer) 2:
          {
            MR_Word Errors_37 = ((MR_Word) ((MR_hl_field(3, RecursionType_10, 1))));
            MR_String Error_74;
  ...
  MR_Box wrapper_arg_1)
{
  ...
  conv2_LambdaHeadVar__2_42 = analysis_utils__IntroducedFrom__func__build_recursive_call_site_cost_map__272__1_3_f_0(MR_unbox_float((MR_hl_field(0, closure, 3))), ((MR_Word) ((MR_hl_field(0, closure, 4)))), ((MR_Integer) (wrapper_arg_1)));
  wrapper_arg_2 = ((MR_Box) (conv2_LambdaHeadVar__2_42));
  return wrapper_arg_2;
}
  ...
  MR_Box * wrapper_arg_4)
{
  ...
  analysis_utils__call_site_dynamic_get_callee_and_costs_5_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) (wrapper_arg_1)), &conv2_HeadVar__3_3, &conv1_Own_9, &conv0_Inherit_10);
  ...
  MR_Word * Inherit_10)
{
  ...
  MR_Word CSD_11;
  MR_Word PDPtr_12;
  MR_ArrayPtr Var_13 = ((MR_ArrayPtr) ((MR_hl_field(0, Deep_6, 5))));
  MR_ArrayPtr Var_14;
  MR_ArrayPtr Var_15;

  profile__lookup_call_site_dynamics_3_p_0(Var_13, CSDPtr_7, &CSD_11);
  Var_14 = ((MR_ArrayPtr) ((MR_hl_field(0, Deep_6, 18))));
