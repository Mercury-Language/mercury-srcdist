...
static void MR_CALL 
analysis_utils__get_recursive_calls_and_counts_4_p_0_1(
#line 323 "analysis_utils.m"
  MR_Box analysis_utils__closure_arg,
#line 323 "analysis_utils.m"
  MR_Box analysis_utils__wrapper_arg_1,
...
#line 318 "analysis_utils.m"
static void MR_CALL 
analysis_utils__get_recursive_calls_and_counts_4_p_0(
#line 318 "analysis_utils.m"
  MR_Word analysis_utils__Deep_5,
#line 318 "analysis_utils.m"
  MR_Word analysis_utils__CliquePtr_6,
#line 318 "analysis_utils.m"
  MR_Word analysis_utils__PDPtr_7,
#line 318 "analysis_utils.m"
  MR_Word * analysis_utils__CallCountsMap_8);

#line 193 "analysis_utils.m"
static void MR_CALL 
...
#line 682 "analysis_utils.c"
static const MR_PseudoTypeInfo analysis_utils__analysis_utils__field_types_callee_0_0[2] = {
  (MR_PseudoTypeInfo) &profile__profile__type_ctor_info_clique_ptr_0,
  (MR_PseudoTypeInfo) &profile__profile__type_ctor_info_call_site_dynamic_ptr_0
};

#line 688 "analysis_utils.c"
static const MR_ConstString analysis_utils__analysis_utils__field_names_callee_0_0[2] = {
  (MR_String) "c_clique",
  (MR_String) "c_csd"
};

#line 694 "analysis_utils.c"
static const MR_DuFunctorDesc analysis_utils__analysis_utils__du_functor_desc_callee_0_0 = {
  (MR_String) "callee",
  (MR_Integer) 2,
  (MR_Integer) 0,
...
#line 723 "analysis_utils.c"
static const MR_DuFunctorDescPtr analysis_utils__analysis_utils__du_name_ordered_callee_0[1] = {
  &analysis_utils__analysis_utils__du_functor_desc_callee_0_0
};

#line 728 "analysis_utils.c"
static const MR_Integer analysis_utils__analysis_utils__functor_number_map_callee_0[1] = {
  (MR_Integer) 0
};

#line 733 "analysis_utils.c"
...
#line 803 "analysis_utils.c"
static const MR_DuFunctorDescPtr analysis_utils__analysis_utils__du_name_ordered_cost_and_callees_1[1] = {
  &analysis_utils__analysis_utils__du_functor_desc_cost_and_callees_1_0
};

#line 808 "analysis_utils.c"
static const MR_Integer analysis_utils__analysis_utils__functor_number_map_cost_and_callees_1[1] = {
  (MR_Integer) 0
};

#line 813 "analysis_utils.c"
...
#line 855 "analysis_utils.c"
static const MR_EnumFunctorDesc analysis_utils__analysis_utils__enum_functor_desc_higher_order_0_0 = {
  (MR_String) "first_order_call",
  (MR_Integer) 0
};

#line 861 "analysis_utils.c"
static const MR_EnumFunctorDesc analysis_utils__analysis_utils__enum_functor_desc_higher_order_0_1 = {
  (MR_String) "higher_order_call",
  (MR_Integer) 1
};

#line 867 "analysis_utils.c"
static const MR_EnumFunctorDescPtr analysis_utils__analysis_utils__enum_value_ordered_higher_order_0[2] = {
...
#line 873 "analysis_utils.c"
static const MR_EnumFunctorDescPtr analysis_utils__analysis_utils__enum_name_ordered_higher_order_0[2] = {
  &analysis_utils__analysis_utils__enum_functor_desc_higher_order_0_0,
  &analysis_utils__analysis_utils__enum_functor_desc_higher_order_0_1
};

#line 879 "analysis_utils.c"
static const MR_Integer analysis_utils__analysis_utils__functor_number_map_higher_order_0[2] = {
  (MR_Integer) 0,
  (MR_Integer) 1
};

#line 885 "analysis_utils.c"
...
static MR_bool MR_CALL 
analysis_utils____Unify____callee_0_0_10001(
#line 905 "analysis_utils.c"
  MR_Box analysis_utils__wrapper_arg_1,
#line 907 "analysis_utils.c"
  MR_Box analysis_utils__wrapper_arg_2)
...
#line 923 "analysis_utils.c"
  }
#line 925 "analysis_utils.c"
}
...
#line 951 "analysis_utils.c"
  }
#line 953 "analysis_utils.c"
}
...
#line 977 "analysis_utils.c"
    return analysis_utils__succeeded;
#line 979 "analysis_utils.c"
  }
#line 981 "analysis_utils.c"
}
...
#line 989 "analysis_utils.c"
  MR_Box * analysis_utils__wrapper_arg_2,
#line 991 "analysis_utils.c"
  MR_Box analysis_utils__wrapper_arg_3,
#line 993 "analysis_utils.c"
  MR_Box analysis_utils__wrapper_arg_4)
...
#line 1009 "analysis_utils.c"
  }
#line 1011 "analysis_utils.c"
}
...
#line 1033 "analysis_utils.c"
    return analysis_utils__succeeded;
#line 1035 "analysis_utils.c"
  }
#line 1037 "analysis_utils.c"
}
...
#line 1061 "analysis_utils.c"
    *analysis_utils__wrapper_arg_1 = ((MR_Box) (analysis_utils__conv0_HeadVar__1_1));
#line 1063 "analysis_utils.c"
  }
#line 1065 "analysis_utils.c"
}
...
#line 1087 "analysis_utils.c"
    return analysis_utils__succeeded;
#line 1089 "analysis_utils.c"
  }
#line 1091 "analysis_utils.c"
}
...
#line 1115 "analysis_utils.c"
    *analysis_utils__wrapper_arg_1 = ((MR_Box) (analysis_utils__conv0_HeadVar__1_1));
#line 1117 "analysis_utils.c"
  }
#line 1119 "analysis_utils.c"
}
...
#line 275 "analysis_utils.m"
    {
#line 275 "analysis_utils.m"
      analysis_utils__V_45_45 = mercury__float__float_1_f_0(analysis_utils__LambdaHeadVar__1_42);
    }
#line 275 "analysis_utils.m"
    {
#line 275 "analysis_utils.m"
...
#line 273 "analysis_utils.m"
    {
#line 273 "analysis_utils.m"
      analysis_utils__V_46_46 = mercury__float__float_1_f_0(analysis_utils__LambdaHeadVar__1_42);
    }
#line 274 "analysis_utils.m"
...
#line 273 "analysis_utils.m"
    {
#line 273 "analysis_utils.m"
      analysis_utils__LambdaHeadVar__2_43 = measurements__build_cs_cost_csq_percall_2_f_0(analysis_utils__V_46_46, analysis_utils__V_47_47);
    }
#line 271 "analysis_utils.m"
...
#line 1339 "analysis_utils.c"
    return analysis_utils__succeeded;
#line 1341 "analysis_utils.c"
  }
#line 69 "analysis_utils.m"
}
...
#line 1524 "analysis_utils.c"
        {
#line 1526 "analysis_utils.c"
...
#line 55 "analysis_utils.m"
          {
#line 1533 "analysis_utils.c"
            analysis_utils__succeeded = (analysis_utils__V_4_4 == analysis_utils__V_8_8);
#line 55 "analysis_utils.m"
            if (analysis_utils__succeeded)
#line 55 "analysis_utils.m"
              {
#line 1539 "analysis_utils.c"
                {
#line 1541 "analysis_utils.c"
...
#line 2154 "analysis_utils.c"
            }
#line 2156 "analysis_utils.c"
          else
#line 366 "analysis_utils.m"
            *analysis_utils__STATE_VARIABLE_Map_22 = analysis_utils__STATE_VARIABLE_Map_0_21;
#line 2160 "analysis_utils.c"
        }
#line 2162 "analysis_utils.c"
      else
#line 2164 "analysis_utils.c"
        {
#line 2166 "analysis_utils.c"
          MR_Word analysis_utils__CSDPtr_11 = ((MR_Word) (MR_hl_field(MR_mktag(0), analysis_utils__CSDSlot_9, (MR_Integer) 0)));

#line 334 "analysis_utils.m"
          {
#line 334 "analysis_utils.m"
...
#line 2174 "analysis_utils.c"
          if ((analysis_utils__env).analysis_utils__build_recursive_call_site_counts_map_5_p_0_env_0__succeeded)
#line 2176 "analysis_utils.c"
            {
...
#line 2240 "analysis_utils.c"
              if ((analysis_utils__env).analysis_utils__build_recursive_call_site_counts_map_5_p_0_env_0__succeeded)
#line 2242 "analysis_utils.c"
                {
#line 2244 "analysis_utils.c"
                  MR_Word analysis_utils__CSS_71;
#line 2246 "analysis_utils.c"
...
#line 2277 "analysis_utils.c"
                }
#line 2279 "analysis_utils.c"
              else
#line 366 "analysis_utils.m"
                *analysis_utils__STATE_VARIABLE_Map_22 = analysis_utils__STATE_VARIABLE_Map_0_21;
#line 2283 "analysis_utils.c"
            }
#line 2285 "analysis_utils.c"
          else
#line 366 "analysis_utils.m"
            *analysis_utils__STATE_VARIABLE_Map_22 = analysis_utils__STATE_VARIABLE_Map_0_21;
#line 2289 "analysis_utils.c"
        }
#line 331 "analysis_utils.m"
    }
#line 326 "analysis_utils.m"
...
#line 318 "analysis_utils.m"
{
#line 321 "analysis_utils.m"
  {
#line 321 "analysis_utils.m"
    MR_bool analysis_utils__succeeded;
#line 321 "analysis_utils.m"
    MR_Word analysis_utils__SiteSlots_9;
#line 321 "analysis_utils.m"
    MR_Word analysis_utils__V_10_10;
#line 321 "analysis_utils.m"
    MR_Word analysis_utils__V_11_11;
#line 323 "analysis_utils.m"
    MR_Box analysis_utils__conv1_CallCountsMap_8;

#line 322 "analysis_utils.m"
    {
#line 322 "analysis_utils.m"
      analysis_utils__proc_dynamic_paired_call_site_slots_3_p_0(analysis_utils__Deep_5, analysis_utils__PDPtr_7, &analysis_utils__SiteSlots_9);
    }
#line 323 "analysis_utils.m"
    {
#line 323 "analysis_utils.m"
      analysis_utils__V_10_10 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 5 * sizeof(MR_Word)), NULL, NULL);
#line 323 "analysis_utils.m"
      MR_hl_field(MR_mktag(0), analysis_utils__V_10_10, 0) = ((MR_Box) (&analysis_utils_scalar_common_5[1]));
#line 323 "analysis_utils.m"
      MR_hl_field(MR_mktag(0), analysis_utils__V_10_10, 1) = ((MR_Box) (analysis_utils__get_recursive_calls_and_counts_4_p_0_1));
#line 323 "analysis_utils.m"
      MR_hl_field(MR_mktag(0), analysis_utils__V_10_10, 2) = ((MR_Box) (MR_Word) ((MR_Integer) 2));
#line 323 "analysis_utils.m"
      MR_hl_field(MR_mktag(0), analysis_utils__V_10_10, 3) = ((MR_Box) (analysis_utils__Deep_5));
#line 323 "analysis_utils.m"
      MR_hl_field(MR_mktag(0), analysis_utils__V_10_10, 4) = ((MR_Box) (analysis_utils__CliquePtr_6));
#line 323 "analysis_utils.m"
    }
#line 324 "analysis_utils.m"
    {
#line 324 "analysis_utils.m"
      analysis_utils__V_11_11 = mercury__map__init_0_f_0((MR_Word) &mdbcomp__goal_path__mdbcomp__goal_path__type_ctor_info_reverse_goal_path_0, (MR_Word) &mercury__builtin__builtin__type_ctor_info_int_0);
    }
#line 323 "analysis_utils.m"
    {
#line 323 "analysis_utils.m"
      mercury__list__foldl_4_p_0((MR_Word) &analysis_utils_scalar_common_2[0], (MR_Word) &analysis_utils_scalar_common_2[1], analysis_utils__V_10_10, analysis_utils__SiteSlots_9, ((MR_Box) (analysis_utils__V_11_11)), &analysis_utils__conv1_CallCountsMap_8);
    }
#line 323 "analysis_utils.m"
    *analysis_utils__CallCountsMap_8 = ((MR_Word) analysis_utils__conv1_CallCountsMap_8);
#line 321 "analysis_utils.m"
  }
#line 318 "analysis_utils.m"
}
...
#line 271 "analysis_utils.m"
    MR_Box analysis_utils__closure = analysis_utils__closure_arg;
#line 271 "analysis_utils.m"
    MR_Word analysis_utils__conv0_LambdaHeadVar__2_43;

#line 271 "analysis_utils.m"
    {
#line 271 "analysis_utils.m"
      analysis_utils__conv0_LambdaHeadVar__2_43 = analysis_utils__IntroducedFrom__func__build_recursive_call_site_cost_map__271__1_3_f_0(MR_unbox_float((MR_hl_field(MR_mktag(0), analysis_utils__closure, (MR_Integer) 3))), ((MR_Word) (MR_hl_field(MR_mktag(0), analysis_utils__closure, (MR_Integer) 4))), ((MR_Integer) analysis_utils__wrapper_arg_1));
    }
#line 271 "analysis_utils.m"
    analysis_utils__wrapper_arg_2 = ((MR_Box) (analysis_utils__conv0_LambdaHeadVar__2_43));
#line 271 "analysis_utils.m"
    return analysis_utils__wrapper_arg_2;
#line 271 "analysis_utils.m"
  }
...
#line 269 "analysis_utils.m"
            {
#line 269 "analysis_utils.m"
              analysis_utils__get_recursive_calls_and_counts_4_p_0(analysis_utils__Deep_7, analysis_utils__CliquePtr_8, analysis_utils__PDPtr_9, &analysis_utils__CallCountsMap_19);
            }
#line 271 "analysis_utils.m"
            {
#line 271 "analysis_utils.m"
...
#line 271 "analysis_utils.m"
              MR_hl_field(MR_mktag(0), analysis_utils__V_41_41, 0) = ((MR_Box) (&analysis_utils_scalar_common_6[0]));
#line 271 "analysis_utils.m"
              MR_hl_field(MR_mktag(0), analysis_utils__V_41_41, 1) = ((MR_Box) (analysis_utils__build_recursive_call_site_cost_map_6_p_0_1));
#line 271 "analysis_utils.m"
              MR_hl_field(MR_mktag(0), analysis_utils__V_41_41, 2) = ((MR_Box) (MR_Word) ((MR_Integer) 2));
#line 271 "analysis_utils.m"
              MR_hl_field(MR_mktag(0), analysis_utils__V_41_41, 3) = MR_box_float(analysis_utils__MaxDepth_15);
...
#line 4341 "analysis_utils.c"
            }
#line 4343 "analysis_utils.c"
            break;
...
#line 4354 "analysis_utils.c"
            }
#line 4356 "analysis_utils.c"
            break;
...
#line 4367 "analysis_utils.c"
            }
#line 4369 "analysis_utils.c"
            break;
#line 4371 "analysis_utils.c"
        }
#line 4373 "analysis_utils.c"
        break;
#line 4375 "analysis_utils.c"
      case (MR_Integer) 1:
#line 4377 "analysis_utils.c"
        {
#line 4379 "analysis_utils.c"
          MR_Word analysis_utils__Callee_16 = ((MR_Word) (MR_hl_field(MR_mktag(1), analysis_utils__KindAndCallee_13, (MR_Integer) 0)));
#line 4381 "analysis_utils.c"
          MR_Word analysis_utils__V_27_27;
#line 225 "analysis_utils.m"
          MR_String analysis_utils__V_47_47 = ((MR_String) (MR_hl_field(MR_mktag(1), analysis_utils__KindAndCallee_13, (MR_Integer) 1)));

#line 245 "analysis_utils.m"
          {
#line 245 "analysis_utils.m"
...
#line 4401 "analysis_utils.c"
        }
#line 4403 "analysis_utils.c"
        break;
#line 4405 "analysis_utils.c"
    }
#line 250 "analysis_utils.m"
    {
#line 250 "analysis_utils.m"
