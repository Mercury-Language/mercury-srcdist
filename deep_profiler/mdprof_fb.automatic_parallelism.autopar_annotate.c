  ...
  MR_Word * STATE_VARIABLE_InstMapArray_8)
{
  ...
  else
  {
    ...
    MR_Word Goal_25 = ((MR_Word) ((MR_hl_field(0, Case_15, (MR_Integer) 2))));
    MR_Word HeadDetism_26 = ((MR_Unsigned) ((MR_hl_field(0, Goal_25, (MR_Integer) 1))) & (MR_Integer) 7);
  ...
  MR_Word * STATE_VARIABLE_InstMapArray_8)
{
  ...
  {
    MR_Word Disj_15 = ((MR_Word) ((MR_hl_field(1, HeadVar__1_1, (MR_Integer) 0))));
    MR_Word Disjs_16 = ((MR_Word) ((MR_hl_field(1, HeadVar__1_1, (MR_Integer) 1))));
    MR_Word HeadDetism_23 = ((MR_Unsigned) ((MR_hl_field(0, Disj_15, (MR_Integer) 1))) & (MR_Integer) 7);
  ...
  MR_Word * STATE_VARIABLE_InstMapArray_8)
{
  ...
  {
    MR_Word Conj_15 = ((MR_Word) ((MR_hl_field(1, HeadVar__1_1, (MR_Integer) 0))));
    MR_Word Conjs_16 = ((MR_Word) ((MR_hl_field(1, HeadVar__1_1, (MR_Integer) 1))));
...
{
  MR_bool succeeded;
  MR_Word GoalExpr_15 = ((MR_Word) ((MR_hl_field(0, Goal_9, (MR_Integer) 0))));
  MR_Word GoalId_17 = ((MR_Word) ((MR_hl_field(0, Goal_9, (MR_Integer) 2))));
  MR_Word InstMapInfo_38;
  MR_Word STATE_VARIABLE_InstMapArray_44_44;

  switch (MR_tag((MR_Word) GoalExpr_15)) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 0:
      {
        MR_Word Conjs_19 = ((MR_Word) ((MR_hl_field(0, GoalExpr_15, (MR_Integer) 0))));

        mdprof_fb__automatic_parallelism__autopar_annotate__conj_annotate_with_instmap_8_p_0(Conjs_19, SeenDuplicateInstantiation_10, ConsumedVars_11, BoundVars_12, STATE_VARIABLE_InstMap_0_39, STATE_VARIABLE_InstMap_40, STATE_VARIABLE_InstMapArray_0_41, &STATE_VARIABLE_InstMapArray_44_44);
      }
      break;
    case (MR_Integer) 1:
      {
        MR_Word Disjs_20 = ((MR_Word) ((MR_hl_field(1, GoalExpr_15, (MR_Integer) 0))));

        mdprof_fb__automatic_parallelism__autopar_annotate__disj_annotate_with_instmap_8_p_0(Disjs_20, SeenDuplicateInstantiation_10, ConsumedVars_11, BoundVars_12, STATE_VARIABLE_InstMap_0_39, STATE_VARIABLE_InstMap_40, STATE_VARIABLE_InstMapArray_0_41, &STATE_VARIABLE_InstMapArray_44_44);
      }
      break;
    case (MR_Integer) 2:
      {
        MR_Integer Var_21 = ((MR_Integer) ((MR_hl_field(2, GoalExpr_15, (MR_Integer) 0))));
        MR_Word Cases_23 = ((MR_Word) ((MR_hl_field(2, GoalExpr_15, (MR_Integer) 2))));
        MR_Word ConsumedVars0_24;

        mdprof_fb__automatic_parallelism__autopar_annotate__switch_annotate_with_instmap_8_p_0(Cases_23, SeenDuplicateInstantiation_10, &ConsumedVars0_24, BoundVars_12, STATE_VARIABLE_InstMap_0_39, STATE_VARIABLE_InstMap_40, STATE_VARIABLE_InstMapArray_0_41, &STATE_VARIABLE_InstMapArray_44_44);
    ...
    case (MR_Integer) 3:
      switch (((MR_Integer) ((MR_hl_field(3, GoalExpr_15, (MR_Integer) 0))))) {
        ...
        case (MR_Integer) 0:
          {
            MR_Word Cond_25 = ((MR_Word) ((MR_hl_field(3, GoalExpr_15, (MR_Integer) 1))));
            MR_Word Then_26 = ((MR_Word) ((MR_hl_field(3, GoalExpr_15, (MR_Integer) 2))));
            MR_Word Else_27 = ((MR_Word) ((MR_hl_field(3, GoalExpr_15, (MR_Integer) 3))));
            ...
            MR_Word STATE_VARIABLE_InstMapArray_37_76;
            MR_Word STATE_VARIABLE_InstMapArray_38_77;
            MR_Word _BoundVarsCond_63;

            mdprof_fb__automatic_parallelism__autopar_annotate__goal_annotate_with_instmap_8_p_0(Cond_25, &SeenDuplicateInstantiationCond_61, &ConsumedVarsCond_62, &_BoundVarsCond_63, STATE_VARIABLE_InstMap_0_39, &InstMapAfterCond_64, STATE_VARIABLE_InstMapArray_0_41, &STATE_VARIABLE_InstMapArray_37_76);
            mdprof_fb__automatic_parallelism__autopar_annotate__goal_annotate_with_instmap_8_p_0(Then_26, &SeenDuplicateInstantiationThen_65, &ConsumedVarsThen_66, &BoundVarsThen_67, InstMapAfterCond_64, &InstMapAfterThen_68, STATE_VARIABLE_InstMapArray_37_76, &STATE_VARIABLE_InstMapArray_38_77);
            mdprof_fb__automatic_parallelism__autopar_annotate__goal_annotate_with_instmap_8_p_0(Else_27, &SeenDuplicateInstantiationElse_69, &ConsumedVarsElse_70, &BoundVarsElse_71, STATE_VARIABLE_InstMap_0_39, &InstMapAfterElse_72, STATE_VARIABLE_InstMapArray_38_77, &STATE_VARIABLE_InstMapArray_44_44);
            ...
            ThenDetism_74 = ((MR_Unsigned) ((MR_hl_field(0, Then_26, (MR_Integer) 1))) & (MR_Integer) 7);
            ElseDetism_75 = ((MR_Unsigned) ((MR_hl_field(0, Else_27, (MR_Integer) 1))) & (MR_Integer) 7);
        ...
        case (MR_Integer) 1:
          {
            MR_Word Subgoal_56 = ((MR_Word) ((MR_hl_field(3, GoalExpr_15, (MR_Integer) 1))));
            MR_Word Var_30;
            MR_Word _InstMap_31;

            mdprof_fb__automatic_parallelism__autopar_annotate__goal_annotate_with_instmap_8_p_0(Subgoal_56, SeenDuplicateInstantiation_10, ConsumedVars_11, &Var_30, STATE_VARIABLE_InstMap_0_39, &_InstMap_31, STATE_VARIABLE_InstMapArray_0_41, &STATE_VARIABLE_InstMapArray_44_44);
        ...
        case (MR_Integer) 2:
          {
            MR_Word Subgoal_28 = ((MR_Word) ((MR_hl_field(3, GoalExpr_15, (MR_Integer) 1))));

            mdprof_fb__automatic_parallelism__autopar_annotate__goal_annotate_with_instmap_8_p_0(Subgoal_28, SeenDuplicateInstantiation_10, ConsumedVars_11, BoundVars_12, STATE_VARIABLE_InstMap_0_39, STATE_VARIABLE_InstMap_40, STATE_VARIABLE_InstMapArray_0_41, &STATE_VARIABLE_InstMapArray_44_44);
          }
          break;
        case (MR_Integer) 3:
          {
            MR_Word BoundVarsList_34 = ((MR_Word) ((MR_hl_field(3, GoalExpr_15, (MR_Integer) 3))));
            MR_Word AtomicGoal_35 = ((MR_Word) ((MR_hl_field(3, GoalExpr_15, (MR_Integer) 4))));
            MR_Word Vars_36;
            ...
            *BoundVars_12 = mercury__set__list_to_set_1_f_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0), BoundVarsList_34);
            ...
            STATE_VARIABLE_InstMapArray_44_44 = STATE_VARIABLE_InstMapArray_0_41;
          }
          break;
      }
      break;
  ...
  mdbcomp__goal_path__update_goal_attribute_4_p_0((MR_Word) (&mdprof_fb__automatic_parallelism__autopar_types__mdprof_fb__automatic_parallelism__autopar_types__type_ctor_info_inst_map_info_0), GoalId_17, ((MR_Box) (InstMapInfo_38)), STATE_VARIABLE_InstMapArray_44_44, STATE_VARIABLE_InstMapArray_42);
}
