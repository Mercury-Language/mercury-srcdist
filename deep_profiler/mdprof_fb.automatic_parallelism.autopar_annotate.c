...
{
  {
    ...
    packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Then_12, (MR_Integer) 1)));
    ThenDetism_33 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Then_12, (MR_Integer) 1))) & (MR_Integer) 7);
    packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Else_13, (MR_Integer) 1)));
  ...
  MR_Word * STATE_VARIABLE_InstMapArray_8)
{
  ...
  else
  {
    ...
    MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Goal_25, (MR_Integer) 1)));
  ...
  MR_Word * STATE_VARIABLE_InstMapArray_8)
{
  ...
  else
  {
    ...
    MR_Word STATE_VARIABLE_InstMapArray_37_37;
    MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Disj_15, (MR_Integer) 1)));
      ...
      case (MR_Integer) 2:
        {
          ...
          MR_Unsigned packed_args_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), GoalExpr_15, (MR_Integer) 1)));
          ...
          case (MR_Integer) 2:
            {
              ...
              MR_Unsigned packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), GoalExpr_15, (MR_Integer) 2)));
