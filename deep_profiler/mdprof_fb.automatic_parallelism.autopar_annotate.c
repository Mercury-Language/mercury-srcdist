...
MR_def_label(mdprof_fb__automatic_parallelism__autopar_annotate__switch_annotate_with_instmap_8_0,3)
	...
	MR_sv(7) = MR_r2;
	MR_sv(9) = MR_tfield(1, MR_r1, 1);
	MR_sv(2) = MR_tfield(0, MR_tfield(0, MR_tfield(1, MR_r1, 0), 2), 1);
...
void mercury__mdprof_fb__automatic_parallelism__autopar_annotate__write_out_proc_statics(FILE *deep_fp, FILE *procrep_fp)
{
	MR_write_out_module_proc_reps_start(procrep_fp, &mercury_data__module_layout__mdprof_fb__automatic_parallelism__autopar_annotate);
