  ...
  MR_Word * Success_6)
{
  ...
  mercury__io__call_system__call_system_4_p_0(MakeToServerPipeCmd_10, &ToServerRes_12);
  mercury__io__call_system__call_system_4_p_0(MakeFromServerPipeCmd_11, &FromServerRes_13);
  ...
  else
  {
    ...
    mercury__io__file__remove_file_4_p_0(ToServerPipe_8, &Var_14);
    mercury__io__file__remove_file_4_p_0(FromServerPipe_9, &Var_15);
...
#undef MR_PROC_LABEL
	ResCode_66  = ResCode;
        ...
        else
        {
          ...
          {
            MR_Word ChildHasParent_105 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(1), (MR_Word) (MR_mkword(MR_mktag(1), &mdprof_cgi_scalar_common_3[2])), (MR_Integer) 0))) & (MR_Integer) 1);
            MR_Word MaybeDebugStream_111;
            MR_Integer TimeOut_112;
            MR_Word Canonical_113;

            switch (ChildHasParent_105) {
              default: /*NOTREACHED*/ MR_assert(0);
              case (MR_Integer) 1:
                {
                  timeout__release_lock_4_p_0(Debug_20, MutexFile_14);
  ...
  MR_Word Deep0_18)
{
  while (MR_TRUE)
  {
    ...
    if ((MaybeStartupStream_14 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      ...
      if (succeeded)
      {
        ...
        else
        {
          ...
          Pref0_457 = query__solidify_preference_2_f_0(Deep_26, PrefInd0_24);
          query__try_exec_4_p_0(Cmd_28, Pref0_457, Deep_26, &HTML_31);
        }
      }
      else
      {
    ...
    else
    {
      ...
      MR_String Var_346;
      MR_Word Cmd0_363;
      MR_Word PrefInd0_364;
      MR_String HTML_369;
      MR_String ResponseFileName_370;
      MR_Word ResponseRes_371;
      MR_Word ResponseStream_372;
      MR_String Var_378;

      mercury__io__write_string_4_p_0(StartupStream0_22, (MR_String) "server loop query ");
      mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&mdprof_cgi_scalar_common_3[1]), QueryNum_20, &Var_193);
      ...
      Cmd0_363 = ((MR_Word) ((MR_hl_field(MR_mktag(0), CmdPref0_21, (MR_Integer) 0))));
      PrefInd0_364 = ((MR_Word) ((MR_hl_field(MR_mktag(0), CmdPref0_21, (MR_Integer) 1))));
      succeeded = (Cmd0_363 == (MR_Word) ((MR_Unsigned) 4U));
      if (succeeded)
      {
        ...
        if (((MR_tag((MR_Word) MaybeDeep_244)) == (MR_Integer) 1))
        {
          ...
          HTML_369 = ((MR_String) ((MR_hl_field(MR_mktag(1), MaybeDeep_244, (MR_Integer) 0))));
          Deep_26 = Deep0_18;
          Cmd_28 = (MR_Word) ((MR_Unsigned) 0U);
          Pref0_368 = query__solidify_preference_2_f_0(Deep_26, PrefInd0_364);
        }
        else
        {
          MR_Word Pref0_463;
          ...
          Cmd_28 = (MR_Word) ((MR_Unsigned) 8U);
          Pref0_463 = query__solidify_preference_2_f_0(Deep_26, PrefInd0_364);
          query__try_exec_4_p_0(Cmd_28, Pref0_463, Deep_26, &HTML_369);
        }
      }
      else
      {
        ...
        Deep_26 = Deep0_18;
        Cmd_28 = Cmd0_363;
        Pref0_460 = query__solidify_preference_2_f_0(Deep_26, PrefInd0_364);
        query__try_exec_4_p_0(Cmd_28, Pref0_460, Deep_26, &HTML_369);
      }
      Var_378 = ((MR_String) ((MR_hl_field(MR_mktag(0), Deep0_18, (MR_Integer) 3))));
      ResponseFileName_370 = interface__response_file_name_2_f_0(Var_378, QueryNum_20);
      mercury__io__open_output_4_p_0(ResponseFileName_370, &ResponseRes_371);
      if (((MR_tag((MR_Word) ResponseRes_371)) == (MR_Integer) 1))
        {
          mercury__require__error_1_p_0((MR_String) "cannot open response file");
          return;
        }
      else
        ResponseStream_372 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ResponseRes_371, (MR_Integer) 0))));
      mercury__io__write_string_4_p_0(ResponseStream_372, HTML_369);
      mercury__io__close_output_3_p_0(ResponseStream_372);
      interface__send_string_5_p_0(FromServerPipe_12, Debug_15, ResponseFileName_370);
      mercury__io__write_string_4_p_0(StartupStream0_22, (MR_String) "query ");
      mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&mdprof_cgi_scalar_common_3[1]), QueryNum_20, &Var_346);
      mercury__io__write_string_4_p_0(StartupStream0_22, Var_346);
      mercury__io__write_string_4_p_0(StartupStream0_22, (MR_String) " output:\n");
      mercury__io__write_string_4_p_0(StartupStream0_22, HTML_369);
      mercury__io__write_string_4_p_0(StartupStream0_22, (MR_String) "\n");
      mercury__io__flush_output_3_p_0(StartupStream0_22);
    }
