  ...
  MR_Word Deep0_18)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      mercury__io__write_4_p_0((MR_Word) (&mdprof_cgi__mdprof_cgi__type_ctor_info_cmd_pref_0), StartupStream1_36, ((MR_Box) (CmdPref0_21)));
      ...
      succeeded = (Cmd0_333 == (MR_Word) ((MR_Unsigned) 4U));
      if (succeeded)
      {
      ...
      if (((MR_tag((MR_Word) ResponseRes_341)) == (MR_Integer) 1))
        {
          mercury__require__error_1_p_0((MR_String) "cannot open response file");
          return;
        }
      ...
      mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&mdprof_cgi_scalar_common_3[0]), QueryNum_20, &Var_200);
