        ...
        case (MR_Integer) 1:
          {
            ...
            switch (MR_tag((MR_Word) mdprof_cgi__HeadVar__3_3)) {
              ...
              case (MR_Integer) 1:
                {
                  MR_Word mdprof_cgi__Var_5 = ((MR_Word) (MR_hl_field(MR_mktag(1), mdprof_cgi__HeadVar__3_3, (MR_Integer) 0)));
                  MR_Integer mdprof_cgi__Var_14 = (MR_Integer) mdprof_cgi__Var_13;
                  MR_Integer mdprof_cgi__Var_15 = (MR_Integer) mdprof_cgi__Var_5;
...
{
  {
    ...
    if (mdprof_cgi__succeeded)
      ...
      switch (MR_tag((MR_Word) mdprof_cgi__HeadVar__1_1)) {
        ...
        case (MR_Integer) 1:
          {
            MR_Word mdprof_cgi__Var_3 = ((MR_Word) (MR_hl_field(MR_mktag(1), mdprof_cgi__HeadVar__1_1, (MR_Integer) 0)));
            MR_Word mdprof_cgi__Var_4;

            mdprof_cgi__succeeded = ((MR_tag((MR_Word) mdprof_cgi__HeadVar__2_2)) == (MR_mktag((MR_Integer) 1)));
            if (mdprof_cgi__succeeded)
              {
                mdprof_cgi__Var_4 = ((MR_Word) (MR_hl_field(MR_mktag(1), mdprof_cgi__HeadVar__2_2, (MR_Integer) 0)));
                mdprof_cgi__succeeded = (mdprof_cgi__Var_3 == mdprof_cgi__Var_4);
              }
          }
          break;
      }
...
{
  {
    ...
    if (mdprof_cgi__succeeded)
      *mdprof_cgi__HeadVar__1_1 = (MR_Integer) 0;
      ...
      {
        MR_Word mdprof_cgi__Var_4 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdprof_cgi__HeadVar__2_2, (MR_Integer) 0)));
        MR_Word mdprof_cgi__Var_5 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdprof_cgi__HeadVar__2_2, (MR_Integer) 1)));
        MR_Word mdprof_cgi__Var_6 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdprof_cgi__HeadVar__3_3, (MR_Integer) 0)));
        MR_Word mdprof_cgi__Var_7 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdprof_cgi__HeadVar__3_3, (MR_Integer) 1)));
        MR_Word mdprof_cgi__Var_8;

        {
          query____Compare____cmd_0_0(&mdprof_cgi__Var_8, mdprof_cgi__Var_4, mdprof_cgi__Var_6);
        }
        ...
        if (mdprof_cgi__succeeded)
          *mdprof_cgi__HeadVar__1_1 = mdprof_cgi__Var_8;
          ...
          {
            query____Compare____preferences_indication_0_0(mdprof_cgi__HeadVar__1_1, mdprof_cgi__Var_5, mdprof_cgi__Var_7);
          }
      }
  }
}
...
{
  {
    ...
    if (mdprof_cgi__succeeded)
      ...
      {
        MR_Word mdprof_cgi__Var_3 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdprof_cgi__HeadVar__1_1, (MR_Integer) 0)));
        MR_Word mdprof_cgi__Var_4 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdprof_cgi__HeadVar__1_1, (MR_Integer) 1)));
        MR_Word mdprof_cgi__Var_5 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdprof_cgi__HeadVar__2_2, (MR_Integer) 0)));
        MR_Word mdprof_cgi__Var_6 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdprof_cgi__HeadVar__2_2, (MR_Integer) 1)));

        {
          mdprof_cgi__succeeded = query____Unify____cmd_0_0(mdprof_cgi__Var_3, mdprof_cgi__Var_5);
        }
        if (mdprof_cgi__succeeded)
          {
            mdprof_cgi__succeeded = query____Unify____preferences_indication_0_0(mdprof_cgi__Var_4, mdprof_cgi__Var_6);
          }
      }
    return mdprof_cgi__succeeded;
  }
      ...
      /* tailcall optimized into a loop */
      {
        ...
        if ((mdprof_cgi__MaybeStartupStream_14 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
        ...
        else
          {
            ...
            mdprof_cgi__Var_195 = (MR_Word) &mdprof_cgi_scalar_common_4[2];
            {
    ...
    if (mdprof_cgi__succeeded)
      {
        ...
        if (mdprof_cgi__succeeded)
          {
            mdprof_cgi__Var_15 = (MR_Word) MR_mkword(MR_mktag(2), &mdprof_cgi_scalar_common_4[0]);
          }
        else
          {
...
{
  {
    ...
    if ((mdprof_cgi__MaybeQueryString_4 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
    ...
    else
      {
        ...
        {
          mercury__getopt__process_options_4_p_0((MR_Word) &mdprof_cgi__mdprof_cgi__type_ctor_info_option_0, (MR_Word) MR_mkword(MR_mktag(2), &mdprof_cgi_scalar_common_2[4]), (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), &mdprof_cgi__Var_6, &mdprof_cgi__MaybeOptions_7);
        }
