...
#line 63 "mdprof_cgi.c"
#line 64 "mdprof_cgi.c"

#endif
#line 67 "mdprof_cgi.c"
...
static const struct mercury_type_7 mercury_vector_common_7_0[];
...
MR_decl_label2(__Unify___mdprof_cgi__detach_process_result_0_0, 4,1)
MR_decl_label6(__Compare___mdprof_cgi__detach_process_result_0_0, 22,5,24,4,26,16)
...
MR_BEGIN_MODULE(mdprof_cgi_module16)
	...
	MR_init_label2(__Unify___mdprof_cgi__detach_process_result_0_0,4,1)
MR_BEGIN_CODE
...
MR_def_static(__Unify___mdprof_cgi__detach_process_result_0_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_r1,0)) {
		MR_GOTO_LAB(__Unify___mdprof_cgi__detach_process_result_0_0_i4);
	}
	MR_r1 = (MR_r2 == MR_r1);
	MR_proceed();
MR_def_label(__Unify___mdprof_cgi__detach_process_result_0_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_BEGIN_MODULE(mdprof_cgi_module17)
	...
	MR_init_label6(__Compare___mdprof_cgi__detach_process_result_0_0,22,5,24,4,26,16)
MR_BEGIN_CODE
...
MR_def_static(__Compare___mdprof_cgi__detach_process_result_0_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___mdprof_cgi__detach_process_result_0_0_i4);
	}
	if (MR_INT_NE(MR_unmkbody(MR_r1),0)) {
		MR_GOTO_LAB(__Compare___mdprof_cgi__detach_process_result_0_0_i5);
	}
	if (MR_PTAG_TESTR(MR_r2,0)) {
		MR_GOTO_LAB(__Compare___mdprof_cgi__detach_process_result_0_0_i24);
	}
	if (MR_INT_NE(MR_unmkbody(MR_r2),0)) {
		MR_GOTO_LAB(__Compare___mdprof_cgi__detach_process_result_0_0_i26);
	}
MR_def_label(__Compare___mdprof_cgi__detach_process_result_0_0,22)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Integer) 0;
	MR_proceed();
MR_def_label(__Compare___mdprof_cgi__detach_process_result_0_0,5)
	...
	if (MR_INT_NE(MR_unmkbody(MR_r2),0)) {
		MR_GOTO_LAB(__Compare___mdprof_cgi__detach_process_result_0_0_i22);
	}
MR_def_label(__Compare___mdprof_cgi__detach_process_result_0_0,24)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Integer) 2;
	MR_proceed();
MR_def_label(__Compare___mdprof_cgi__detach_process_result_0_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_r2,0)) {
		MR_GOTO_LAB(__Compare___mdprof_cgi__detach_process_result_0_0_i16);
	}
MR_def_label(__Compare___mdprof_cgi__detach_process_result_0_0,26)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Integer) 1;
	MR_proceed();
MR_def_label(__Compare___mdprof_cgi__detach_process_result_0_0,16)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_ctfield(1, MR_r1, 0);
...
void mercury__mdprof_cgi__write_out_proc_statics(FILE *fp);
#endif
