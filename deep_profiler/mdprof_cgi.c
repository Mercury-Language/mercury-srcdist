...
#line 77 "mdprof_cgi.c"

#endif
#line 80 "mdprof_cgi.c"
...
MR_decl_label10(mdprof_cgi__long_2_0, 13,14,15,16,17,18,19,20,21,1)
...
MR_decl_label10(mdprof_cgi__process_args_5_0, 5,6,7,8,9,10,11,14,16,18)
MR_decl_label9(mdprof_cgi__process_args_5_0, 20,22,2,31,32,33,34,35,36)
...
static const struct mercury_type_6 mercury_vector_common_6_0[20] =
{
{
0,
MR_TAG_COMMON(1,1,1)
...
MR_BEGIN_MODULE(mdprof_cgi_module9)
	...
	MR_init_label10(mdprof_cgi__process_args_5_0,5,6,7,8,9,10,11,14,16,18)
	MR_init_label9(mdprof_cgi__process_args_5_0,20,22,2,31,32,33,34,35,36)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(mdprof_cgi_module13)
	...
	MR_init_label10(mdprof_cgi__long_2_0,13,14,15,16,17,18,19,20,21,1)
MR_BEGIN_CODE
...
MR_def_label(mdprof_cgi__long_2_0,20)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if ((strcmp((char *) (MR_Word *) MR_r1, MR_string_const("procrep-coverage", 16)) != 0)) {
		MR_GOTO_LAB(mdprof_cgi__long_2_0_i21);
	}
	MR_r2 = (MR_Integer) 11;
	MR_r1 = MR_TRUE;
	MR_proceed();
