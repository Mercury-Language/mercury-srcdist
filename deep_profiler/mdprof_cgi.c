...
{
  {
    ...
    if ((MaybeQueryString_4 == (MR_Word) ((MR_Integer) 0)))
    ...
    else
    {
      ...
      mercury__getopt__process_options_4_p_0((MR_Word) (&mdprof_cgi__mdprof_cgi__type_ctor_info_option_0), (MR_Word) (MR_mkword(MR_mktag(2), &mdprof_cgi_scalar_common_2[8])), (MR_Word) ((MR_Integer) 0), &Var_6, &MaybeOptions_7);
      ...
      if ((MaybeDeepQuery_10 == (MR_Word) ((MR_Integer) 0)))
      {
      ...
      else
      {
        ...
        if ((MaybeCmd_12 == (MR_Word) ((MR_Integer) 0)))
...
{
  {
    MR_bool succeeded = ((MR_tag((MR_Word) Args_7)) == (MR_Integer) 1);
          ...
          else
          {
            ...
            else
            {
              ...
              if (succeeded)
                ...
                Var_15 = (MR_Word) ((MR_Integer) 8);
            }
          }
        }
      }
      mdprof_cgi__process_query_6_p_0(Var_15, DeepFileName_10, (MR_Word) ((MR_Integer) 0), Options_8);
    }
    else
    {
      mercury__io__set_exit_status_3_p_0((MR_Integer) 1);
...
{
  {
    MR_bool succeeded = (Cmd0_7 == (MR_Word) ((MR_Integer) 4));
    MR_Word Cmd_12;
    MR_Word PrefInd_14;
    ...
    if (succeeded)
      Cmd_12 = (MR_Word) ((MR_Integer) 8);
    else
      Cmd_12 = Cmd0_7;
    if ((MaybePref_9 == (MR_Word) ((MR_Integer) 0)))
      PrefInd_14 = (MR_Word) ((MR_Integer) 0);
    else
    {
...
{
  {
    ...
    switch (RecordStartup_28) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        MaybeStartupStream_31 = (MR_Word) ((MR_Integer) 0);
        break;
      case (MR_Integer) 1:
        {
    ...
    startup__read_and_startup_default_deep_options_9_p_0(Machine_23, ScriptName_24, FileName_14, Canonical_25, MaybeStartupStream_31, (MR_Word) ((MR_Integer) 0), &StartupResult_33);
    ...
    else
    {
      ...
      if (!((MaybeStartupStream_31 == (MR_Word) ((MR_Integer) 0))))
      {
      ...
      case (MR_Integer) 0:
        {
          ...
          switch (RecordLoop_19) {
            default: /*NOTREACHED*/ MR_assert(0);
            case (MR_Integer) 0:
              MaybeDebugStream_28 = (MR_Word) ((MR_Integer) 0);
              break;
            case (MR_Integer) 1:
          ...
          else
          {
            ...
            else
            {
              ...
              switch (RecordLoop_19) {
                default: /*NOTREACHED*/ MR_assert(0);
                case (MR_Integer) 0:
                  MaybeDebugStream_111 = (MR_Word) ((MR_Integer) 0);
                  break;
                case (MR_Integer) 1:
  ...
  MR_Word Deep0_18)
{
  while (MR_TRUE)
  {
    ...
    QueryNum_20 = (MR_Integer) ((MR_Unsigned) QueryNum0_17 + (MR_Unsigned) (MR_Integer) 1);
    ...
    if ((MaybeStartupStream_14 == (MR_Word) ((MR_Integer) 0)))
    {
      ...
      succeeded = (Cmd0_23 == (MR_Word) ((MR_Integer) 4));
      if (succeeded)
      {
        ...
        startup__read_and_startup_default_deep_options_9_p_0(Var_51, Var_74, Var_75, Canonical_16, MaybeStartupStream_14, (MR_Word) ((MR_Integer) 0), &MaybeDeep_25);
    ...
    else
    {
      ...
      succeeded = (Cmd0_333 == (MR_Word) ((MR_Integer) 4));
      if (succeeded)
      {
        ...
        startup__read_and_startup_default_deep_options_9_p_0(Var_241, Var_244, Var_245, Canonical_16, MaybeStartupStream_14, (MR_Word) ((MR_Integer) 0), &MaybeDeep_239);
    ...
    succeeded = (Cmd_28 == (MR_Word) ((MR_Integer) 0));
    if (succeeded)
      timeout__delete_cleanup_files_2_p_0();
    else
    {
            ...
            case (MR_Integer) 1:
              {
                ...
                if ((MaybeQuery_12 == (MR_Word) ((MR_Integer) 0)))
                {
            ...
            case (MR_Integer) 1:
              {
                ...
                if ((MaybeCmd1_16 == (MR_Word) ((MR_Integer) 0)))
                {
            ...
            case (MR_Integer) 1:
              {
                ...
                if ((MaybePref_18 == (MR_Word) ((MR_Integer) 0)))
                {
