...
#undef MR_PROC_LABEL
	ResCode_65  = ResCode;
        ...
        succeeded = (ResCode_65 < (MR_Integer) 0);
        if (succeeded)
        {
        ...
        else
        {
          ...
          {
            MR_Word ChildHasParent_104 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(1), (MR_Word) (MR_mkword(MR_mktag(1), &mdprof_cgi_scalar_common_3[2])), (MR_Integer) 0))) & (MR_Integer) 1);
            MR_Word MaybeDebugStream_110;
            MR_Integer TimeOut_111;
            MR_Word Canonical_112;

            switch (ChildHasParent_104) {
              default: /*NOTREACHED*/ MR_assert(0);
              case (MR_Integer) 1:
                {
                  timeout__release_lock_4_p_0(Debug_20, MutexFile_14);
              ...
              case (MR_Integer) 0:
                {
                  ...
                  MR_Word StdOut_72;
                  MR_Word StdErr_73;
                  MR_Word BinaryStdIn_74;
                  MR_Word BinaryStdOut_75;

                  timeout__unregister_file_for_cleanup_3_p_0(MutexFile_14);
                  timeout__unregister_file_for_cleanup_3_p_0(WantFile_15);
                  mercury__io__stdin_stream_3_p_0(&StdIn_71);
                  mercury__io__close_input_3_p_0(StdIn_71);
                  mercury__io__stdout_stream_3_p_0(&StdOut_72);
                  mercury__io__close_output_3_p_0(StdOut_72);
                  mercury__io__stderr_stream_3_p_0(&StdErr_73);
                  mercury__io__close_output_3_p_0(StdErr_73);
                  mercury__io__binary_input_stream_3_p_0(&BinaryStdIn_74);
                  mercury__io__close_binary_input_3_p_0(BinaryStdIn_74);
                  mercury__io__binary_output_stream_3_p_0(&BinaryStdOut_75);
                  mercury__io__close_binary_output_3_p_0(BinaryStdOut_75);
                }
                break;
            }
            switch (RecordLoop_19) {
              default: /*NOTREACHED*/ MR_assert(0);
              case (MR_Integer) 0:
                MaybeDebugStream_110 = (MR_Word) ((MR_Unsigned) 0U);
                break;
              case (MR_Integer) 1:
                MaybeDebugStream_110 = MaybeStartupStream_13;
                break;
            }
            mercury__getopt__lookup_int_option_3_p_0((MR_Word) (&mdprof_cgi__mdprof_cgi__type_ctor_info_option_0), Options_10, ((MR_Box) ((MR_Integer) 16)), &TimeOut_111);
            mercury__getopt__lookup_bool_option_3_p_0((MR_Word) (&mdprof_cgi__mdprof_cgi__type_ctor_info_option_0), Options_10, ((MR_Box) ((MR_Integer) 0)), &Canonical_112);
            mdprof_cgi__server_loop_10_p_0(ToServerPipe_11, FromServerPipe_12, TimeOut_111, MaybeDebugStream_110, Debug_20, Canonical_112, (MR_Integer) 0, Deep_16);
          }
        }
      }
      break;
