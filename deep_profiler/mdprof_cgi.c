  ...
  MR_Word OutputStream_6)
{
  ...
  else
  {
    ...
    switch (Version_16) {
      ...
      case (MR_Integer) 1:
        {
          MR_String Version_86;
          MR_String Fullarch_87;

          mercury__library__version_2_p_0(&Version_86, &Fullarch_87);
          mercury__io__write_string_4_p_0(OutputStream_6, ProgName_8);
          ...
          mercury__io__write_string_4_p_0(OutputStream_6, Version_86);
          mercury__io__write_string_4_p_0(OutputStream_6, (MR_String) ", on ");
          mercury__io__write_string_4_p_0(OutputStream_6, Fullarch_87);
          mercury__io__write_string_4_p_0(OutputStream_6, (MR_String) ".\n");
        }
        break;
    }
  ...
  MR_Word Options_22)
{
  ...
  else
  {
    ...
    switch (ServerProcess_28) {
      ...
      case (MR_Integer) 1:
        {
          MR_String ToServerPipe_90;
          MR_String FromServerPipe_91;
          MR_String MakeToServerPipeCmd_92;
          MR_String MakeFromServerPipeCmd_93;
          MR_Word ToServerRes_94;
          MR_Word FromServerRes_95;
          MR_Integer Var_100;
          MR_Integer Var_101;

          ToServerPipe_90 = interface__to_server_pipe_name_1_f_0(FileName_16);
          FromServerPipe_91 = interface__from_server_pipe_name_1_f_0(FileName_16);
          MakeToServerPipeCmd_92 = conf__make_pipe_cmd_1_f_0(ToServerPipe_90);
          MakeFromServerPipeCmd_93 = conf__make_pipe_cmd_1_f_0(FromServerPipe_91);
          mercury__io__call_system__call_system_4_p_0(MakeToServerPipeCmd_92, &ToServerRes_94);
          mercury__io__call_system__call_system_4_p_0(MakeFromServerPipeCmd_93, &FromServerRes_95);
          succeeded = ((MR_tag((MR_Word) ToServerRes_94)) == (MR_Integer) 0);
          if (succeeded)
          {
            Var_100 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), ToServerRes_94, (MR_Integer) 0))));
            succeeded = (Var_100 == (MR_Integer) 0);
            if (succeeded)
            {
              succeeded = ((MR_tag((MR_Word) FromServerRes_95)) == (MR_Integer) 0);
              if (succeeded)
              {
                Var_101 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), FromServerRes_95, (MR_Integer) 0))));
          ...
          if (succeeded)
          {
            timeout__register_file_for_cleanup_3_p_0(ToServerPipe_90);
            timeout__register_file_for_cleanup_3_p_0(FromServerPipe_91);
            mercury__io__write_string_4_p_0(OutputStream_13, HTML_38);
          ...
          else
          {
            ...
            mercury__io__file__remove_file_4_p_0(ToServerPipe_90, &Var_96);
            mercury__io__file__remove_file_4_p_0(FromServerPipe_91, &Var_97);
            timeout__release_lock_4_p_0(Debug_29, MutexFile_20);
            timeout__remove_want_file_3_p_0(WantFile_21);
            mercury__io__set_exit_status_3_p_0((MR_Integer) 1);
