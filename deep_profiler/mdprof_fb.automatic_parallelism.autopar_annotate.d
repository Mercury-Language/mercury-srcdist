...
ifeq ($(TARGET_ASM),yes)
mdprof_fb.automatic_parallelism.autopar_annotate.mh mdprof_fb.automatic_parallelism.autopar_annotate.mih : mdprof_fb.automatic_parallelism.autopar_annotate.s
else
...
ifeq ($(TARGET_ASM),yes)
mdprof_fb.automatic_parallelism.autopar_annotate.module_dep : mdprof_fb.automatic_parallelism.autopar_annotate.s
else
...
ifeq ($(TARGET_ASM),yes)
mdprof_fb.automatic_parallelism.autopar_annotate.s_date : autopar_annotate.m
	$(MCG) $(ALL_GRADEFLAGS) $(ALL_MCGFLAGS) --target-code-only mdprof_fb.automatic_parallelism.autopar_annotate $(ERR_REDIRECT)
mdprof_fb.automatic_parallelism.autopar_annotate.pic_s_date : autopar_annotate.m
	$(MCG) $(ALL_GRADEFLAGS) $(ALL_MCGFLAGS) --target-code-only --pic \
		--cflags "$(GCCFLAGS_FOR_PIC)" mdprof_fb.automatic_parallelism.autopar_annotate $(ERR_REDIRECT)
endif # TARGET_ASM
