...
{
  {
    ...
    if (((MR_tag((MR_Word) MaybeStream_10)) == (MR_mktag((MR_Integer) 1))))
      ExcludeContents_14 = (MR_Word) ((MR_Integer) 0);
    else
    {
      MR_Word InputStream_11 = ((MR_Word) ((MR_hl_field(MR_mktag(0), MaybeStream_10, (MR_Integer) 0))));
      MR_Word MaybeSpecs_12;

      exclude__read_exclude_lines_6_p_0(FileName_6, InputStream_11, (MR_Word) ((MR_Integer) 0), &MaybeSpecs_12);
      ...
      else
      {
        ...
        if ((InvalidSpecs_28 == (MR_Word) ((MR_Integer) 0)))
        {
          {
            ...
            MR_hl_field(MR_mktag(2), ExcludeContents_14, 1) = ((MR_Box) ((MR_Integer) 0));
          }
        }
        else
        if ((ValidSpecs_27 == (MR_Word) ((MR_Integer) 0)))
        {
          MR_String Msg1_58;
          MR_String Msg_60;
          MR_String Var_75;
