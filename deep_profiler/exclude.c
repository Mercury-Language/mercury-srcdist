  ...
  else
  {
    ...
    else
    {
      ...
      if ((ValidSpecs_26 == (MR_Word) ((MR_Unsigned) 0U)))
      {
        ...
        Var_74 = mercury__string__f_43_43_2_f_0(FileName_6, (MR_String) " contains only unrecognized module names.");
        Msg1_57 = mercury__string__f_43_43_2_f_0((MR_String) "Error: file ", Var_74);
      ...
      else
      {
        ...
        Var_68 = mercury__string__f_43_43_2_f_0(BadNames_35, (MR_String) ".");
        Var_70 = mercury__string__f_43_43_2_f_0((MR_String) " contains unrecognized module names: ", Var_68);
        Var_71 = mercury__string__f_43_43_2_f_0(FileName_6, Var_70);
        Msg1_36 = mercury__string__f_43_43_2_f_0((MR_String) "Warning: ", Var_71);
