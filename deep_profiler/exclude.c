...
{
  {
    ...
    if (exclude__succeeded)
      *exclude__HeadVar__1_1 = (MR_Integer) 0;
      ...
      {
        MR_String exclude__ArgX1_4 = ((MR_String) (MR_hl_field(MR_mktag(0), exclude__HeadVar__2_2, (MR_Integer) 0)));
        MR_String exclude__ArgY1_5 = ((MR_String) (MR_hl_field(MR_mktag(0), exclude__HeadVar__3_3, (MR_Integer) 0)));
        MR_Word exclude__ArgX2_6 = ((MR_Word) (MR_hl_field(MR_mktag(0), exclude__HeadVar__2_2, (MR_Integer) 1)));
        MR_Word exclude__ArgY2_7 = ((MR_Word) (MR_hl_field(MR_mktag(0), exclude__HeadVar__3_3, (MR_Integer) 1)));
        MR_Word exclude__Var_8;

        {
          mercury__private_builtin__builtin_compare_string_3_p_0(&exclude__Var_8, exclude__ArgX1_4, exclude__ArgY1_5);
        }
        exclude__succeeded = (exclude__Var_8 == (MR_Integer) 0);
        exclude__succeeded = !(exclude__succeeded);
        if (exclude__succeeded)
          *exclude__HeadVar__1_1 = exclude__Var_8;
        else
          {
            MR_Integer exclude__Var_13 = (MR_Integer) exclude__ArgX2_6;
            MR_Integer exclude__Var_14 = (MR_Integer) exclude__ArgY2_7;

            {
              mercury__private_builtin__builtin_compare_int_3_p_0(exclude__HeadVar__1_1, exclude__Var_13, exclude__Var_14);
            }
          }
      }
  }
...
{
  {
    ...
    if (exclude__succeeded)
      ...
      {
        MR_String exclude__ArgX1_3 = ((MR_String) (MR_hl_field(MR_mktag(0), exclude__HeadVar__1_1, (MR_Integer) 0)));
        MR_String exclude__ArgY1_4 = ((MR_String) (MR_hl_field(MR_mktag(0), exclude__HeadVar__2_2, (MR_Integer) 0)));
        MR_Word exclude__ArgX2_5 = ((MR_Word) (MR_hl_field(MR_mktag(0), exclude__HeadVar__1_1, (MR_Integer) 1)));
        MR_Word exclude__ArgY2_6 = ((MR_Word) (MR_hl_field(MR_mktag(0), exclude__HeadVar__2_2, (MR_Integer) 1)));

        exclude__succeeded = (strcmp(exclude__ArgX1_3, exclude__ArgY1_4) == 0);
        if (exclude__succeeded)
          exclude__succeeded = (exclude__ArgX2_5 == exclude__ArgY2_6);
      }
    return exclude__succeeded;
  }
}
    ...
    else
      {
        ...
        if (exclude__succeeded)
          *exclude__HeadVar__1_1 = exclude__Var_8;
          ...
          {
            exclude____Compare____exclude_contents_0_0(exclude__HeadVar__1_1, exclude__ArgX2_6, exclude__ArgY2_7);
          }
      }
  }
}
...
{
  {
    ...
    if (exclude__succeeded)
    ...
    else
      {
        ...
        if (exclude__succeeded)
          {
            exclude__succeeded = exclude____Unify____exclude_contents_0_0(exclude__ArgX2_5, exclude__ArgY2_6);
          }
      }
    return exclude__succeeded;
  }
    ...
    if (exclude__succeeded)
      *exclude__HeadVar__1_1 = (MR_Integer) 0;
      ...
      switch (MR_tag((MR_Word) exclude__HeadVar__2_2)) {
        ...
        case (MR_Integer) 1:
          {
            MR_String exclude__Var_30 = ((MR_String) (MR_hl_field(MR_mktag(1), exclude__HeadVar__2_2, (MR_Integer) 0)));
            ...
            switch (MR_tag((MR_Word) exclude__HeadVar__3_3)) {
              ...
              case (MR_Integer) 1:
                {
                  MR_String exclude__ArgY1_9 = ((MR_String) (MR_hl_field(MR_mktag(1), exclude__HeadVar__3_3, (MR_Integer) 0)));

                  {
                    mercury__private_builtin__builtin_compare_string_3_p_0(exclude__HeadVar__1_1, exclude__Var_30, exclude__ArgY1_9);
                  }
                }
                break;
              case (MR_Integer) 2:
        ...
        case (MR_Integer) 2:
          {
            MR_Word exclude__Var_28 = ((MR_Word) (MR_hl_field(MR_mktag(2), exclude__HeadVar__2_2, (MR_Integer) 1)));
            MR_Word exclude__Var_29 = ((MR_Word) (MR_hl_field(MR_mktag(2), exclude__HeadVar__2_2, (MR_Integer) 0)));
            ...
            switch (MR_tag((MR_Word) exclude__HeadVar__3_3)) {
              ...
              case (MR_Integer) 2:
                {
                  MR_Word exclude__ArgY1_19 = ((MR_Word) (MR_hl_field(MR_mktag(2), exclude__HeadVar__3_3, (MR_Integer) 0)));
                  MR_Word exclude__ArgY2_21 = ((MR_Word) (MR_hl_field(MR_mktag(2), exclude__HeadVar__3_3, (MR_Integer) 1)));
                  MR_Word exclude__Var_22;

                  {
                    mercury__builtin__compare_3_p_0((MR_Word) &exclude_scalar_common_1[0], &exclude__Var_22, ((MR_Box) (exclude__Var_29)), ((MR_Box) (exclude__ArgY1_19)));
                  }
                  exclude__succeeded = (exclude__Var_22 == (MR_Integer) 0);
                  exclude__succeeded = !(exclude__succeeded);
                  if (exclude__succeeded)
                    *exclude__HeadVar__1_1 = exclude__Var_22;
                  else
                    {
                      {
                        mercury__builtin__compare_3_p_0((MR_Word) &exclude_scalar_common_1[1], exclude__HeadVar__1_1, ((MR_Box) (exclude__Var_28)), ((MR_Box) (exclude__ArgY2_21)));
                      }
                    }
                }
                break;
...
{
  {
    ...
    if (exclude__succeeded)
      ...
      switch (MR_tag((MR_Word) exclude__HeadVar__1_1)) {
        ...
        case (MR_Integer) 1:
          {
            MR_String exclude__ArgX1_5 = ((MR_String) (MR_hl_field(MR_mktag(1), exclude__HeadVar__1_1, (MR_Integer) 0)));
            MR_String exclude__ArgY1_6;

            exclude__succeeded = ((MR_tag((MR_Word) exclude__HeadVar__2_2)) == (MR_mktag((MR_Integer) 1)));
            if (exclude__succeeded)
              {
                exclude__ArgY1_6 = ((MR_String) (MR_hl_field(MR_mktag(1), exclude__HeadVar__2_2, (MR_Integer) 0)));
                exclude__succeeded = (strcmp(exclude__ArgX1_5, exclude__ArgY1_6) == 0);
              }
          }
          break;
        case (MR_Integer) 2:
          {
            ...
            MR_Word exclude__ArgX1_7 = ((MR_Word) (MR_hl_field(MR_mktag(2), exclude__HeadVar__1_1, (MR_Integer) 0)));
            MR_Word exclude__ArgY1_8;
            MR_Word exclude__ArgX2_9 = ((MR_Word) (MR_hl_field(MR_mktag(2), exclude__HeadVar__1_1, (MR_Integer) 1)));
            MR_Word exclude__ArgY2_10;

            exclude__succeeded = ((MR_tag((MR_Word) exclude__HeadVar__2_2)) == (MR_mktag((MR_Integer) 2)));
            if (exclude__succeeded)
              {
                exclude__ArgY1_8 = ((MR_Word) (MR_hl_field(MR_mktag(2), exclude__HeadVar__2_2, (MR_Integer) 0)));
                exclude__ArgY2_10 = ((MR_Word) (MR_hl_field(MR_mktag(2), exclude__HeadVar__2_2, (MR_Integer) 1)));
                exclude__TypeInfo_13_13 = (MR_Word) &exclude_scalar_common_1[0];
                {
                  exclude__succeeded = mercury__builtin__unify_2_p_0(exclude__TypeInfo_13_13, ((MR_Box) (exclude__ArgX1_7)), ((MR_Box) (exclude__ArgY1_8)));
                }
                if (exclude__succeeded)
                  {
                    exclude__TypeInfo_14_14 = (MR_Word) &exclude_scalar_common_1[1];
                    {
                      exclude__succeeded = mercury__builtin__unify_2_p_0(exclude__TypeInfo_14_14, ((MR_Box) (exclude__ArgX2_9)), ((MR_Box) (exclude__ArgY2_10)));
                    }
                  }
              }
          }
...
{
  {
    ...
    MR_Word exclude__Var_4 = ((MR_Word) (MR_hl_field(MR_mktag(0), exclude__HeadVar__1_1, (MR_Integer) 1)));
  ...
  MR_Word exclude__Spec_4)
{
  {
    MR_bool exclude__succeeded;
    MR_String exclude__Var_6 = ((MR_String) (MR_hl_field(MR_mktag(0), exclude__Spec_4, (MR_Integer) 0)));
    MR_Word exclude__Var_10 = ((MR_Word) (MR_hl_field(MR_mktag(0), exclude__Spec_4, (MR_Integer) 1)));
    MR_Word exclude__Var_5;
    MR_Box exclude__conv0_Var_5;

    {
      exclude__succeeded = mercury__map__search_3_p_0((MR_Word) &mercury__builtin__builtin__type_ctor_info_string_0, (MR_Word) &profile__profile__type_ctor_info_module_data_0, exclude__ModuleDataMap_3, ((MR_Box) (exclude__Var_6)), &exclude__conv0_Var_5);
    }
    if (exclude__succeeded)
      {
        exclude__Var_5 = ((MR_Word) exclude__conv0_Var_5);
        exclude__succeeded = MR_TRUE;
      }
    return exclude__succeeded;
  }
...
{
  {
    ...
    (exclude__env_ptr)->exclude__apply_contour_exclusion_4_f_0_env_0__Var_47 = ((MR_String) (MR_hl_field(MR_mktag(0), (exclude__env_ptr)->exclude__apply_contour_exclusion_4_f_0_env_0__ExclSpec_15, (MR_Integer) 0)));
    ...
    (exclude__env_ptr)->exclude__apply_contour_exclusion_4_f_0_env_0__succeeded = (strcmp((exclude__env_ptr)->exclude__apply_contour_exclusion_4_f_0_env_0__ModuleName_14, (exclude__env_ptr)->exclude__apply_contour_exclusion_4_f_0_env_0__Var_47) == 0);
    if ((exclude__env_ptr)->exclude__apply_contour_exclusion_4_f_0_env_0__succeeded)
      {
        switch ((exclude__env_ptr)->exclude__apply_contour_exclusion_4_f_0_env_0__ExclType_16) {
          ...
          case (MR_Integer) 1:
            {
              MR_Word exclude__Var_19 = ((MR_Word) (MR_hl_field(MR_mktag(0), (exclude__env_ptr)->exclude__apply_contour_exclusion_4_f_0_env_0__PS_13, (MR_Integer) 7)));
              MR_Word exclude__Var_35 = ((MR_Word) (MR_hl_field(MR_mktag(0), (exclude__env_ptr)->exclude__apply_contour_exclusion_4_f_0_env_0__PS_13, (MR_Integer) 0)));
              MR_String exclude__Var_36 = ((MR_String) (MR_hl_field(MR_mktag(0), (exclude__env_ptr)->exclude__apply_contour_exclusion_4_f_0_env_0__PS_13, (MR_Integer) 1)));
              MR_String exclude__Var_37 = ((MR_String) (MR_hl_field(MR_mktag(0), (exclude__env_ptr)->exclude__apply_contour_exclusion_4_f_0_env_0__PS_13, (MR_Integer) 2)));
              MR_String exclude__Var_38 = ((MR_String) (MR_hl_field(MR_mktag(0), (exclude__env_ptr)->exclude__apply_contour_exclusion_4_f_0_env_0__PS_13, (MR_Integer) 3)));
              MR_String exclude__Var_39 = ((MR_String) (MR_hl_field(MR_mktag(0), (exclude__env_ptr)->exclude__apply_contour_exclusion_4_f_0_env_0__PS_13, (MR_Integer) 4)));
              MR_String exclude__Var_40 = ((MR_String) (MR_hl_field(MR_mktag(0), (exclude__env_ptr)->exclude__apply_contour_exclusion_4_f_0_env_0__PS_13, (MR_Integer) 5)));
              MR_Integer exclude__Var_41 = ((MR_Integer) (MR_hl_field(MR_mktag(0), (exclude__env_ptr)->exclude__apply_contour_exclusion_4_f_0_env_0__PS_13, (MR_Integer) 6)));
              MR_ArrayPtr exclude__Var_42 = ((MR_ArrayPtr) (MR_hl_field(MR_mktag(0), (exclude__env_ptr)->exclude__apply_contour_exclusion_4_f_0_env_0__PS_13, (MR_Integer) 8)));
              MR_ArrayPtr exclude__Var_43 = ((MR_ArrayPtr) (MR_hl_field(MR_mktag(0), (exclude__env_ptr)->exclude__apply_contour_exclusion_4_f_0_env_0__PS_13, (MR_Integer) 9)));
              MR_Word exclude__Var_44 = ((MR_Word) (MR_hl_field(MR_mktag(0), (exclude__env_ptr)->exclude__apply_contour_exclusion_4_f_0_env_0__PS_13, (MR_Integer) 10)));
              MR_Word exclude__Var_45 = ((MR_Word) (MR_hl_field(MR_mktag(0), (exclude__env_ptr)->exclude__apply_contour_exclusion_4_f_0_env_0__PS_13, (MR_Integer) 11)));

              (exclude__env_ptr)->exclude__apply_contour_exclusion_4_f_0_env_0__succeeded = (exclude__Var_19 == (MR_Integer) 0);
            }
            break;
        }
        if ((exclude__env_ptr)->exclude__apply_contour_exclusion_4_f_0_env_0__succeeded)
          ...
          if ((exclude__env).exclude__apply_contour_exclusion_4_f_0_env_0__succeeded)
            {
              ...
              MR_Word exclude__Var_20;
              MR_Word exclude__Var_21;
              MR_ArrayPtr exclude__Var_22;
              MR_Word exclude__Var_23;
              MR_Word exclude__Var_24;
              MR_String exclude__Var_25;
              MR_String exclude__Var_26;
              MR_String exclude__Var_27;
              MR_String exclude__Var_28;
              MR_Integer exclude__Var_29;
              MR_Word exclude__Var_30;
              MR_ArrayPtr exclude__Var_31;
              MR_ArrayPtr exclude__Var_32;
              MR_Word exclude__Var_33;
              MR_Word exclude__Var_34;
              ...
              exclude__Var_20 = ((MR_Word) (MR_hl_field(MR_mktag(0), exclude__CSD_9, (MR_Integer) 1)));
              exclude__Var_21 = ((MR_Word) (MR_hl_field(MR_mktag(0), exclude__CSD_9, (MR_Integer) 2)));
              {
              ...
              exclude__Var_22 = ((MR_ArrayPtr) (MR_hl_field(MR_mktag(0), exclude__PD_11, (MR_Integer) 1)));
              exclude__Var_23 = ((MR_Word) (MR_hl_field(MR_mktag(0), exclude__PD_11, (MR_Integer) 2)));
              {
              ...
              exclude__Var_24 = ((MR_Word) (MR_hl_field(MR_mktag(0), (exclude__env).exclude__apply_contour_exclusion_4_f_0_env_0__PS_13, (MR_Integer) 0)));
              ...
              exclude__Var_25 = ((MR_String) (MR_hl_field(MR_mktag(0), (exclude__env).exclude__apply_contour_exclusion_4_f_0_env_0__PS_13, (MR_Integer) 2)));
              exclude__Var_26 = ((MR_String) (MR_hl_field(MR_mktag(0), (exclude__env).exclude__apply_contour_exclusion_4_f_0_env_0__PS_13, (MR_Integer) 3)));
              exclude__Var_27 = ((MR_String) (MR_hl_field(MR_mktag(0), (exclude__env).exclude__apply_contour_exclusion_4_f_0_env_0__PS_13, (MR_Integer) 4)));
              exclude__Var_28 = ((MR_String) (MR_hl_field(MR_mktag(0), (exclude__env).exclude__apply_contour_exclusion_4_f_0_env_0__PS_13, (MR_Integer) 5)));
              exclude__Var_29 = ((MR_Integer) (MR_hl_field(MR_mktag(0), (exclude__env).exclude__apply_contour_exclusion_4_f_0_env_0__PS_13, (MR_Integer) 6)));
              exclude__Var_30 = ((MR_Word) (MR_hl_field(MR_mktag(0), (exclude__env).exclude__apply_contour_exclusion_4_f_0_env_0__PS_13, (MR_Integer) 7)));
              exclude__Var_31 = ((MR_ArrayPtr) (MR_hl_field(MR_mktag(0), (exclude__env).exclude__apply_contour_exclusion_4_f_0_env_0__PS_13, (MR_Integer) 8)));
              exclude__Var_32 = ((MR_ArrayPtr) (MR_hl_field(MR_mktag(0), (exclude__env).exclude__apply_contour_exclusion_4_f_0_env_0__PS_13, (MR_Integer) 9)));
              exclude__Var_33 = ((MR_Word) (MR_hl_field(MR_mktag(0), (exclude__env).exclude__apply_contour_exclusion_4_f_0_env_0__PS_13, (MR_Integer) 10)));
              exclude__Var_34 = ((MR_Word) (MR_hl_field(MR_mktag(0), (exclude__env).exclude__apply_contour_exclusion_4_f_0_env_0__PS_13, (MR_Integer) 11)));
              {
              ...
              if ((exclude__env).exclude__apply_contour_exclusion_4_f_0_env_0__succeeded)
                {
                  ...
                  {
                    MR_Word exclude__next_value_of_CSDPtr0_7 = exclude__EntryCSDPtr_18;

                    exclude__CSDPtr0_7 = exclude__next_value_of_CSDPtr0_7;
                  }
                  continue;
                }
              else
    ...
    else
      {
        ...
        if (((MR_tag((MR_Word) exclude__MaybeSpecs_12)) == (MR_mktag((MR_Integer) 1))))
        ...
        else
          {
            ...
            MR_Word exclude__Var_40;

            {
              exclude__Var_40 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL);
              MR_hl_field(MR_mktag(0), exclude__Var_40, 0) = ((MR_Box) (&exclude_scalar_common_4[0]));
              MR_hl_field(MR_mktag(0), exclude__Var_40, 1) = ((MR_Box) (exclude__read_exclude_file_5_p_0_1));
              MR_hl_field(MR_mktag(0), exclude__Var_40, 2) = ((MR_Box) (MR_Word) ((MR_Integer) 1));
              MR_hl_field(MR_mktag(0), exclude__Var_40, 3) = ((MR_Box) (exclude__ModuleDataMap_7));
            }
            exclude__TypeCtorInfo_46_64 = (MR_Word) &exclude__exclude__type_ctor_info_exclude_spec_0;
            {
              mercury__list__filter_4_p_0(exclude__TypeCtorInfo_46_64, exclude__Var_40, exclude__Specs_13, &exclude__ValidSpecs_27, &exclude__InvalidSpecs_28);
            }
            {
            ...
            if ((exclude__ValidSpecs_27 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
              {
                ...
                MR_String exclude__Var_75;

                {
                  exclude__Var_75 = mercury__string__f_43_43_2_f_0(exclude__FileName_6, (MR_String) " contains only unrecognized module names.");
                }
                {
                  exclude__Msg1_58 = mercury__string__f_43_43_2_f_0((MR_String) "Error: file ", exclude__Var_75);
                }
                {
            ...
            else
              {
                ...
                MR_String exclude__Var_69;
                MR_String exclude__Var_71;
                MR_String exclude__Var_72;

                {
                  exclude__InvalidModuleNames_35 = mercury__list__map_2_f_0(exclude__TypeCtorInfo_46_64, (MR_Word) &mercury__builtin__builtin__type_ctor_info_string_0, (MR_Word) &exclude_scalar_common_3[1], exclude__InvalidSpecs_28);
                }
                {
                  exclude__BadNames_36 = mercury__string__join_list_2_f_0((MR_String) ", ", exclude__InvalidModuleNames_35);
                }
                {
                  exclude__Var_69 = mercury__string__f_43_43_2_f_0(exclude__BadNames_36, (MR_String) ".");
                }
                {
                  exclude__Var_71 = mercury__string__f_43_43_2_f_0((MR_String) " contains unrecognized module names: ", exclude__Var_69);
                }
                {
                  exclude__Var_72 = mercury__string__f_43_43_2_f_0(exclude__FileName_6, exclude__Var_71);
                }
                {
                  exclude__Msg1_37 = mercury__string__f_43_43_2_f_0((MR_String) "Warning: ", exclude__Var_72);
                }
                {
              ...
              if (exclude__succeeded)
                {
                  ...
                  exclude__Var_29 = ((MR_Word) (MR_hl_field(MR_mktag(1), exclude__Words_16, (MR_Integer) 1)));
                  exclude__succeeded = ((MR_tag((MR_Word) exclude__Var_29)) == (MR_mktag((MR_Integer) 1)));
                  if (exclude__succeeded)
                    {
                      exclude__ModuleName_18 = ((MR_String) (MR_hl_field(MR_mktag(1), exclude__Var_29, (MR_Integer) 0)));
                      exclude__Var_30 = ((MR_Word) (MR_hl_field(MR_mktag(1), exclude__Var_29, (MR_Integer) 1)));
                      exclude__succeeded = (exclude__Var_30 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
                      if (exclude__succeeded)
                        {
              ...
              if (exclude__succeeded)
                {
                  ...
                  /* direct tailcall eliminated */
                  {
                    MR_Word exclude__next_value_of_RevSpecs0_9 = exclude__RevSpecs1_21;

                    exclude__RevSpecs0_9 = exclude__next_value_of_RevSpecs0_9;
                  }
                  continue;
                }
              else
                {
                  ...
                  MR_String exclude__Var_41;
                  MR_String exclude__Var_42;

                  {
                    exclude__Var_41 = mercury__string__f_43_43_2_f_0((MR_String) " contains badly formatted line: ", exclude__Line_15);
                  }
                  {
                    exclude__Var_42 = mercury__string__f_43_43_2_f_0(exclude__FileName_7, exclude__Var_41);
                  }
                  {
                    exclude__Msg_22 = mercury__string__f_43_43_2_f_0((MR_String) "file ", exclude__Var_42);
                  }
                  {
                    MR_Word base;
