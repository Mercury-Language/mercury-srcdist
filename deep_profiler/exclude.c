      ...
      case (MR_Integer) 2:
        {
          ...
          if (succeeded)
          {
            ...
            TypeInfo__13_13 = (MR_Word) (&exclude_scalar_common_1[0]);
            succeeded = mercury__builtin__unify_2_p_0(TypeInfo__13_13, ((MR_Box) (ArgX1_7)), ((MR_Box) (ArgY1_8)));
            if (succeeded)
            {
              TypeInfo__14_14 = (MR_Word) (&exclude_scalar_common_1[1]);
  ...
  else
  {
    ...
    else
    {
...

      {
        ...
        MR_hl_field(MR_mktag(0), Var_31, 0) = ((MR_Box) (&exclude_scalar_common_4[0]));
        MR_hl_field(MR_mktag(0), Var_31, 1) = ((MR_Box) (exclude__read_exclude_file_5_p_0_1));
        MR_hl_field(MR_mktag(0), Var_31, 2) = ((MR_Box) ((MR_Integer) 1));
        MR_hl_field(MR_mktag(0), Var_31, 3) = ((MR_Box) (ModuleDataMap_7));
      }
      ...
      if ((InvalidSpecs_23 == (MR_Word) ((MR_Unsigned) 0U)))
        {
          ...
          MR_hl_field(MR_mktag(2), ExcludeContents_14, 0) = ((MR_Box) (ModuleSpecs_24));
      ...
      if ((ValidSpecs_22 == (MR_Word) ((MR_Unsigned) 0U)))
      {
        ...
        {
          ExcludeContents_14 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), ExcludeContents_14, 0) = ((MR_Box) (Msg_41));
        }
      }
      else
      {
        ...
        {
          MaybeErrorMsg_38 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), MaybeErrorMsg_38, 0) = ((MR_Box) (Msg_30));
        }
        {
          ExcludeContents_14 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(2), ExcludeContents_14, 0) = ((MR_Box) (ModuleSpecs_24));
          MR_hl_field(MR_mktag(2), ExcludeContents_14, 1) = ((MR_Box) (MaybeErrorMsg_38));
        }
      }
    }
  }
