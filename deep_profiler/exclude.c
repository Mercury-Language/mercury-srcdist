  ...
  MR_Word * ExcludeFile_8)
{
  ...
  else
  {
    ...
    else
    {
      ...
      MR_Word ValidSpecs_26;
      MR_Word InvalidSpecs_27;
      MR_Word ModuleSpecs_28;
      MR_Word Var_39;

      {
        Var_39 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), Var_39, 0) = ((MR_Box) (&exclude_scalar_common_4[0]));
        MR_hl_field(MR_mktag(0), Var_39, 1) = ((MR_Box) (exclude__read_exclude_file_5_p_0_1));
        MR_hl_field(MR_mktag(0), Var_39, 2) = ((MR_Box) ((MR_Integer) 1));
        MR_hl_field(MR_mktag(0), Var_39, 3) = ((MR_Box) (ModuleDataMap_7));
      }
      mercury__list__filter_4_p_0((MR_Word) (&exclude__exclude__type_ctor_info_exclude_spec_0), Var_39, Specs_13, &ValidSpecs_26, &InvalidSpecs_27);
      mercury__set__list_to_set_2_p_0((MR_Word) (&exclude__exclude__type_ctor_info_exclude_spec_0), ValidSpecs_26, &ModuleSpecs_28);
      if ((InvalidSpecs_27 == (MR_Word) ((MR_Unsigned) 0U)))
        {
          ExcludeContents_14 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(2), ExcludeContents_14, 0) = ((MR_Box) (ModuleSpecs_28));
          MR_hl_field(MR_mktag(2), ExcludeContents_14, 1) = ((MR_Box) ((MR_Unsigned) 0U));
        }
      else
      if ((ValidSpecs_26 == (MR_Word) ((MR_Unsigned) 0U)))
      {
        MR_String Msg1_57;
        MR_String Msg2_58;
        MR_String Msg_59;
        ...
        Var_72 = mercury__string__f_43_43_2_f_0(FileName_6, (MR_String) " contains only unrecognized module names.");
        Msg1_57 = mercury__string__f_43_43_2_f_0((MR_String) "Error: file ", Var_72);
        Msg2_58 = mercury__string__f_43_43_2_f_0((MR_String) "These modules either do not exist ", (MR_String) "or have no deep profiled procedures.");
        Msg_59 = mercury__string__f_43_43_2_f_0(Msg1_57, Msg2_58);
        {
          ExcludeContents_14 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), ExcludeContents_14, 0) = ((MR_Box) (Msg_59));
        }
      }
      else
      {
        MR_Word InvalidModuleNames_34;
        MR_String BadNames_35;
        MR_String Msg1_36;
        MR_String Msg2_37;
        MR_String Msg_38;
        MR_Word MaybeErrorMsg_56;
        MR_String Var_66;
        MR_String Var_68;
        MR_String Var_69;

        InvalidModuleNames_34 = mercury__list__map_2_f_0((MR_Word) (&exclude__exclude__type_ctor_info_exclude_spec_0), (MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&exclude_scalar_common_3[1]), InvalidSpecs_27);
        BadNames_35 = mercury__string__join_list_2_f_0((MR_String) ", ", InvalidModuleNames_34);
        Var_66 = mercury__string__f_43_43_2_f_0(BadNames_35, (MR_String) ".");
        Var_68 = mercury__string__f_43_43_2_f_0((MR_String) " contains unrecognized module names: ", Var_66);
        Var_69 = mercury__string__f_43_43_2_f_0(FileName_6, Var_68);
        Msg1_36 = mercury__string__f_43_43_2_f_0((MR_String) "Warning: ", Var_69);
        Msg2_37 = mercury__string__f_43_43_2_f_0((MR_String) "These modules either do not exist ", (MR_String) "or have no deep profiled procedures.");
        Msg_38 = mercury__string__f_43_43_2_f_0(Msg1_36, Msg2_37);
        {
          MaybeErrorMsg_56 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), MaybeErrorMsg_56, 0) = ((MR_Box) (Msg_38));
        }
        {
          ExcludeContents_14 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(2), ExcludeContents_14, 0) = ((MR_Box) (ModuleSpecs_28));
          MR_hl_field(MR_mktag(2), ExcludeContents_14, 1) = ((MR_Box) (MaybeErrorMsg_56));
        }
      }
    }
  }
