    ...
    else
    {
      ...
      if (succeeded)
        *HeadVar__1_1 = Var_8;
        ...
        exclude____Compare____exclude_contents_0_0(HeadVar__1_1, ArgX2_6, ArgY2_7);
    }
  }
}
              ...
              case (MR_Integer) 2:
                {
                  ...
                  mercury__builtin__compare_3_p_0((MR_Word) &exclude_scalar_common_1[0], &Var_22, ((MR_Box) (Var_29)), ((MR_Box) (ArgY1_19)));
                  ...
                  {
                    mercury__builtin__compare_3_p_0((MR_Word) &exclude_scalar_common_1[1], HeadVar__1_1, ((MR_Box) (Var_28)), ((MR_Box) (ArgY2_21)));
                  }
                }
                break;
            }
...
{
  {
    ...
    MR_Word Var_10 = ((MR_Word) (MR_hl_field(MR_mktag(0), Spec_4, (MR_Integer) 1)));
    MR_Word Var_5;
    MR_Box conv0_Var_5;
...
{
  {
    ...
    (env_ptr)->exclude__apply_contour_exclusion_4_f_0_env_0__ExclType_16 = ((MR_Word) (MR_hl_field(MR_mktag(0), (env_ptr)->exclude__apply_contour_exclusion_4_f_0_env_0__ExclSpec_15, (MR_Integer) 1)));
    ...
    if ((env_ptr)->exclude__apply_contour_exclusion_4_f_0_env_0__succeeded)
    {
      switch ((env_ptr)->exclude__apply_contour_exclusion_4_f_0_env_0__ExclType_16) {
        ...
        case (MR_Integer) 1:
          {
            MR_Word Var_19 = ((MR_Word) (MR_hl_field(MR_mktag(0), (env_ptr)->exclude__apply_contour_exclusion_4_f_0_env_0__PS_13, (MR_Integer) 7)));
            ...
            MR_Word Var_45 = ((MR_Word) (MR_hl_field(MR_mktag(0), (env_ptr)->exclude__apply_contour_exclusion_4_f_0_env_0__PS_13, (MR_Integer) 11)));
    ...
    while (MR_TRUE)
    {
      /* tailcall optimized into a loop */
      {
        ...
        if ((env).exclude__apply_contour_exclusion_4_f_0_env_0__succeeded)
        {
          ...
          Var_30 = ((MR_Word) (MR_hl_field(MR_mktag(0), (env).exclude__apply_contour_exclusion_4_f_0_env_0__PS_13, (MR_Integer) 7)));
          ...
          Var_34 = ((MR_Word) (MR_hl_field(MR_mktag(0), (env).exclude__apply_contour_exclusion_4_f_0_env_0__PS_13, (MR_Integer) 11)));
          ...
          if ((env).exclude__apply_contour_exclusion_4_f_0_env_0__succeeded)
          {
            ...
            {
              MR_Word next_value_of_CSDPtr0_7 = EntryCSDPtr_18;
...
{
  {
    ...
    if (((MR_tag((MR_Word) MaybeStream_10)) == (MR_mktag((MR_Integer) 1))))
      ExcludeContents_14 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
    else
    {
      MR_Word InputStream_11 = ((MR_Word) (MR_hl_field(MR_mktag(0), MaybeStream_10, (MR_Integer) 0)));
      MR_Word MaybeSpecs_12;

      exclude__read_exclude_lines_6_p_0(FileName_6, InputStream_11, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), &MaybeSpecs_12);
      mercury__io__close_input_3_p_0(InputStream_11);
      if (((MR_tag((MR_Word) MaybeSpecs_12)) == (MR_mktag((MR_Integer) 1))))
      {
        MR_String Msg_15 = ((MR_String) (MR_hl_field(MR_mktag(1), MaybeSpecs_12, (MR_Integer) 0)));

        {
          ExcludeContents_14 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), ExcludeContents_14, 0) = ((MR_Box) (Msg_15));
        }
      }
      else
      {
        MR_Word TypeCtorInfo_46_64;
        ...
        TypeCtorInfo_46_64 = (MR_Word) &exclude__exclude__type_ctor_info_exclude_spec_0;
        mercury__list__filter_4_p_0(TypeCtorInfo_46_64, Var_40, Specs_13, &ValidSpecs_27, &InvalidSpecs_28);
        mercury__set__list_to_set_2_p_0(TypeCtorInfo_46_64, ValidSpecs_27, &ModuleSpecs_29);
        if ((InvalidSpecs_28 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
        {
          {
            ExcludeContents_14 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(2), ExcludeContents_14, 0) = ((MR_Box) (ModuleSpecs_29));
            MR_hl_field(MR_mktag(2), ExcludeContents_14, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
          }
        }
        else
        if ((ValidSpecs_27 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
        {
          MR_String Msg1_58;
          MR_String Msg_60;
          MR_String Var_75;
          ...
          Msg_60 = mercury__string__f_43_43_2_f_0(Msg1_58, (MR_String) "These modules either do not exist or have no deep profiled procedures.");
          {
            ExcludeContents_14 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
        ...
        else
        {
          ...
          InvalidModuleNames_35 = mercury__list__map_2_f_0(TypeCtorInfo_46_64, (MR_Word) &mercury__builtin__builtin__type_ctor_info_string_0, (MR_Word) &exclude_scalar_common_3[1], InvalidSpecs_28);
          ...
          Msg_39 = mercury__string__f_43_43_2_f_0(Msg1_37, (MR_String) "These modules either do not exist or have no deep profiled procedures.");
          {
            MaybeErrorMsg_57 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
        ...
        case (MR_Integer) 1:
          {
            ...
            succeeded = ((MR_tag((MR_Word) Words_16)) == (MR_mktag((MR_Integer) 1)));
            if (succeeded)
            {
            ...
            if (succeeded)
            {
              ...
              {
                Spec_20 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
                MR_hl_field(MR_mktag(0), Spec_20, 0) = ((MR_Box) (ModuleName_18));
                MR_hl_field(MR_mktag(0), Spec_20, 1) = ((MR_Box) (ExclType_19));
              }
              {
                RevSpecs1_21 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(1), RevSpecs1_21, 0) = ((MR_Box) (Spec_20));
                MR_hl_field(MR_mktag(1), RevSpecs1_21, 1) = ((MR_Box) (RevSpecs0_9));
              }
              /* direct tailcall eliminated */
              {
                MR_Word next_value_of_RevSpecs0_9 = RevSpecs1_21;
