...
MR_decl_label1(__Unify___exclude__exclude_spec_0_0, 1)
MR_decl_label2(__Compare___exclude__exclude_spec_0_0, 3,7)
...
MR_BEGIN_MODULE(exclude_module7)
	...
	MR_init_label1(__Unify___exclude__exclude_spec_0_0,1)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(exclude_module8)
	...
	MR_init_label2(__Compare___exclude__exclude_spec_0_0,3,7)
MR_BEGIN_CODE
...
MR_define_entry(mercury____Compare___exclude__exclude_spec_0_0);
	...
	MR_np_call_localret_ent(private_builtin__builtin_compare_string_3_0,
		__Compare___exclude__exclude_spec_0_0_i3);
MR_def_label(__Compare___exclude__exclude_spec_0_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___exclude__exclude_spec_0_0_i7);
	}
	MR_r1 = MR_sv(1);
	MR_r2 = MR_sv(2);
...
MR_def_label(__Compare___exclude__exclude_spec_0_0,7)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
