...
{
  {
    ...
    if (exclude__succeeded)
      *exclude__HeadVar__1_1 = (MR_Integer) 0;
      ...
      {
        MR_String exclude__Var_4 = ((MR_String) (MR_hl_field(MR_mktag(0), exclude__HeadVar__2_2, (MR_Integer) 0)));
        MR_Word exclude__Var_5 = ((MR_Word) (MR_hl_field(MR_mktag(0), exclude__HeadVar__2_2, (MR_Integer) 1)));
        MR_String exclude__Var_6 = ((MR_String) (MR_hl_field(MR_mktag(0), exclude__HeadVar__3_3, (MR_Integer) 0)));
        MR_Word exclude__Var_7 = ((MR_Word) (MR_hl_field(MR_mktag(0), exclude__HeadVar__3_3, (MR_Integer) 1)));
        MR_Word exclude__Var_8;

        {
          mercury__private_builtin__builtin_compare_string_3_p_0(&exclude__Var_8, exclude__Var_4, exclude__Var_6);
        }
        ...
        if (exclude__succeeded)
          *exclude__HeadVar__1_1 = exclude__Var_8;
          ...
          {
            MR_Integer exclude__Var_13 = (MR_Integer) exclude__Var_5;
            MR_Integer exclude__Var_14 = (MR_Integer) exclude__Var_7;
...
{
  {
    ...
    if (exclude__succeeded)
      ...
      {
        MR_String exclude__Var_3 = ((MR_String) (MR_hl_field(MR_mktag(0), exclude__HeadVar__1_1, (MR_Integer) 0)));
        MR_Word exclude__Var_4 = ((MR_Word) (MR_hl_field(MR_mktag(0), exclude__HeadVar__1_1, (MR_Integer) 1)));
        MR_String exclude__Var_5 = ((MR_String) (MR_hl_field(MR_mktag(0), exclude__HeadVar__2_2, (MR_Integer) 0)));
        MR_Word exclude__Var_6 = ((MR_Word) (MR_hl_field(MR_mktag(0), exclude__HeadVar__2_2, (MR_Integer) 1)));

        exclude__succeeded = (strcmp(exclude__Var_3, exclude__Var_5) == 0);
        if (exclude__succeeded)
          exclude__succeeded = (exclude__Var_4 == exclude__Var_6);
      }
    return exclude__succeeded;
  }
}
    ...
    else
      {
        ...
        if (exclude__succeeded)
          *exclude__HeadVar__1_1 = exclude__Var_8;
          ...
          {
            exclude____Compare____exclude_contents_0_0(exclude__HeadVar__1_1, exclude__Var_5, exclude__Var_7);
          }
      }
  }
}
...
{
  {
    ...
    if (exclude__succeeded)
    ...
    else
      {
        ...
        if (exclude__succeeded)
          {
            exclude__succeeded = exclude____Unify____exclude_contents_0_0(exclude__Var_4, exclude__Var_6);
          }
      }
    return exclude__succeeded;
  }
        ...
        case (MR_Integer) 1:
          {
            ...
            switch (MR_tag((MR_Word) exclude__HeadVar__3_3)) {
              ...
              case (MR_Integer) 1:
                {
                  MR_String exclude__Var_9 = ((MR_String) (MR_hl_field(MR_mktag(1), exclude__HeadVar__3_3, (MR_Integer) 0)));

                  {
                    mercury__private_builtin__builtin_compare_string_3_p_0(exclude__HeadVar__1_1, exclude__Var_30, exclude__Var_9);
                  }
                }
                break;
              case (MR_Integer) 2:
        ...
        case (MR_Integer) 2:
          {
            ...
            switch (MR_tag((MR_Word) exclude__HeadVar__3_3)) {
              ...
              case (MR_Integer) 2:
                {
                  MR_Word exclude__Var_20 = ((MR_Word) (MR_hl_field(MR_mktag(2), exclude__HeadVar__3_3, (MR_Integer) 0)));
                  MR_Word exclude__Var_21 = ((MR_Word) (MR_hl_field(MR_mktag(2), exclude__HeadVar__3_3, (MR_Integer) 1)));
                  MR_Word exclude__Var_22;

                  {
                    mercury__builtin__compare_3_p_0((MR_Word) &exclude_scalar_common_1[0], &exclude__Var_22, ((MR_Box) (exclude__Var_29)), ((MR_Box) (exclude__Var_20)));
                  }
                  ...
                  if (exclude__succeeded)
                    *exclude__HeadVar__1_1 = exclude__Var_22;
                    ...
                    {
                      {
                        mercury__builtin__compare_3_p_0((MR_Word) &exclude_scalar_common_1[1], exclude__HeadVar__1_1, ((MR_Box) (exclude__Var_28)), ((MR_Box) (exclude__Var_21)));
                      }
                    }
                }
                break;
...
{
  {
    ...
    if (exclude__succeeded)
      ...
      switch (MR_tag((MR_Word) exclude__HeadVar__1_1)) {
        ...
        case (MR_Integer) 1:
          {
            MR_String exclude__Var_5 = ((MR_String) (MR_hl_field(MR_mktag(1), exclude__HeadVar__1_1, (MR_Integer) 0)));
            MR_String exclude__Var_6;

            exclude__succeeded = ((MR_tag((MR_Word) exclude__HeadVar__2_2)) == (MR_mktag((MR_Integer) 1)));
            if (exclude__succeeded)
              {
                exclude__Var_6 = ((MR_String) (MR_hl_field(MR_mktag(1), exclude__HeadVar__2_2, (MR_Integer) 0)));
                exclude__succeeded = (strcmp(exclude__Var_5, exclude__Var_6) == 0);
              }
          }
          break;
        case (MR_Integer) 2:
          {
            ...
            MR_Word exclude__Var_7 = ((MR_Word) (MR_hl_field(MR_mktag(2), exclude__HeadVar__1_1, (MR_Integer) 0)));
            MR_Word exclude__Var_8 = ((MR_Word) (MR_hl_field(MR_mktag(2), exclude__HeadVar__1_1, (MR_Integer) 1)));
            MR_Word exclude__Var_9;
            MR_Word exclude__Var_10;

            exclude__succeeded = ((MR_tag((MR_Word) exclude__HeadVar__2_2)) == (MR_mktag((MR_Integer) 2)));
            if (exclude__succeeded)
              {
                exclude__Var_9 = ((MR_Word) (MR_hl_field(MR_mktag(2), exclude__HeadVar__2_2, (MR_Integer) 0)));
                exclude__Var_10 = ((MR_Word) (MR_hl_field(MR_mktag(2), exclude__HeadVar__2_2, (MR_Integer) 1)));
                exclude__TypeInfo_13_13 = (MR_Word) &exclude_scalar_common_1[0];
                {
                  exclude__succeeded = mercury__builtin__unify_2_p_0(exclude__TypeInfo_13_13, ((MR_Box) (exclude__Var_7)), ((MR_Box) (exclude__Var_9)));
                }
                if (exclude__succeeded)
                  {
                    exclude__TypeInfo_14_14 = (MR_Word) &exclude_scalar_common_1[1];
                    {
                      exclude__succeeded = mercury__builtin__unify_2_p_0(exclude__TypeInfo_14_14, ((MR_Box) (exclude__Var_8)), ((MR_Box) (exclude__Var_10)));
                    }
                  }
              }
          }
