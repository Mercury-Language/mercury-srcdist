...
{
  {
    ...
    MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Spec_4, (MR_Integer) 1)));
    MR_Box conv0_Var_5;
...
{
  {
...

    {
      ...
      packed_args_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), (env_ptr)->exclude__apply_contour_exclusion_4_f_0_env_0__ExclSpec_15, (MR_Integer) 1)));
          ...
          case (MR_Integer) 1:
            {
              ...
              MR_Unsigned packed_args_3 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), (env_ptr)->exclude__apply_contour_exclusion_4_f_0_env_0__PS_13, (MR_Integer) 7)));
              MR_Unsigned packed_args_4 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), (env_ptr)->exclude__apply_contour_exclusion_4_f_0_env_0__PS_13, (MR_Integer) 11)));
...
{
  {
    ...
    while (MR_TRUE)
    {
      ...
      if ((env).exclude__apply_contour_exclusion_4_f_0_env_0__succeeded)
      {
        ...
        packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), (env).exclude__apply_contour_exclusion_4_f_0_env_0__PS_13, (MR_Integer) 7)));
        ...
        packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), (env).exclude__apply_contour_exclusion_4_f_0_env_0__PS_13, (MR_Integer) 11)));
