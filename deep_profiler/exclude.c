...
MR_decl_label10(exclude__read_exclude_lines_6_0, 66,2,9,11,13,16,21,20,14,26)
MR_decl_label4(exclude__read_exclude_lines_6_0, 27,28,6,7)
...
MR_decl_label5(__Unify___exclude__exclude_contents_0_0, 12,6,8,16,1)
MR_decl_label2(__Unify___exclude__exclude_file_0_0, 6,1)
MR_decl_label2(__Unify___exclude__exclude_spec_0_0, 4,1)
MR_decl_label8(__Compare___exclude__exclude_contents_0_0, 50,25,29,28,12,15,17,35)
...
MR_BEGIN_MODULE(exclude_module0)
	...
	MR_init_label10(exclude__read_exclude_lines_6_0,66,2,9,11,13,16,21,20,14,26)
	MR_init_label4(exclude__read_exclude_lines_6_0,27,28,6,7)
MR_BEGIN_CODE
...
MR_def_label(exclude__read_exclude_lines_6_0,66)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(1) = MR_r1;
	MR_sv(2) = MR_r2;
	MR_sv(3) = MR_r3;
...
MR_def_label(exclude__read_exclude_lines_6_0,13)
	...
	MR_np_call_localret_ent(fn__string__words_separator_2_0,
		exclude__read_exclude_lines_6_0_i16);
MR_def_label(exclude__read_exclude_lines_6_0,16)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TEST(MR_r1,0,0)) {
		MR_GOTO_LAB(exclude__read_exclude_lines_6_0_i14);
	}
	{
	MR_Word MR_tempr1;
...
MR_def_label(exclude__read_exclude_lines_6_0,20)
	...
	MR_GOTO_LAB(exclude__read_exclude_lines_6_0_i66);
	}
MR_def_label(exclude__read_exclude_lines_6_0,14)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_def_label(exclude__read_exclude_lines_6_0,27)
	...
	MR_np_call_localret_ent(fn__f_115_116_114_105_110_103_95_95_43_43_2_0,
		exclude__read_exclude_lines_6_0_i28);
MR_def_label(exclude__read_exclude_lines_6_0,28)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_BEGIN_MODULE(exclude_module5)
	...
	MR_init_label5(__Unify___exclude__exclude_contents_0_0,12,6,8,16,1)
MR_BEGIN_CODE
...
MR_define_entry(mercury____Unify___exclude__exclude_contents_0_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if ((MR_r1 == MR_r2)) {
		MR_GOTO_LAB(__Unify___exclude__exclude_contents_0_0_i16);
	}
	MR_incr_sp(3);
	...
	if ((MR_r1 == MR_mktag((MR_Integer) 1))) {
		MR_GOTO_LAB(__Unify___exclude__exclude_contents_0_0_i12);
	}
	MR_r1 = (MR_sv(2) == MR_tempr1);
	MR_decr_sp(3);
	MR_proceed();
	}
MR_def_label(__Unify___exclude__exclude_contents_0_0,12)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_def_label(__Unify___exclude__exclude_contents_0_0,16)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_TRUE;
	MR_proceed();
...
MR_BEGIN_MODULE(exclude_module6)
	...
	MR_init_label8(__Compare___exclude__exclude_contents_0_0,50,25,29,28,12,15,17,35)
MR_BEGIN_CODE
...
MR_define_entry(mercury____Compare___exclude__exclude_contents_0_0);
	...
	MR_sv(3) = (MR_Word) MR_succip;
	if ((MR_r1 == MR_r2)) {
		MR_GOTO_LAB(__Compare___exclude__exclude_contents_0_0_i50);
	}
	MR_sv(1) = MR_r1;
	MR_sv(2) = MR_r2;
	MR_r2 = MR_tag(MR_sv(1));
	if ((MR_r2 == MR_mktag((MR_Integer) 2))) {
		MR_GOTO_LAB(__Compare___exclude__exclude_contents_0_0_i12);
	}
	if ((MR_r2 == MR_mktag((MR_Integer) 1))) {
		MR_GOTO_LAB(__Compare___exclude__exclude_contents_0_0_i25);
	}
	MR_r2 = MR_tag(MR_sv(2));
	if ((MR_r2 == MR_mktag((MR_Integer) 2))) {
		MR_GOTO_LAB(__Compare___exclude__exclude_contents_0_0_i28);
	}
	if ((MR_r2 == MR_mktag((MR_Integer) 1))) {
		MR_GOTO_LAB(__Compare___exclude__exclude_contents_0_0_i28);
	}
MR_def_label(__Compare___exclude__exclude_contents_0_0,50)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Integer) 0;
	MR_decr_sp_and_return(3);
MR_def_label(__Compare___exclude__exclude_contents_0_0,25)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_tag(MR_sv(2));
	if ((MR_r2 == MR_mktag((MR_Integer) 2))) {
		MR_GOTO_LAB(__Compare___exclude__exclude_contents_0_0_i28);
	...
	if ((MR_r2 == MR_mktag((MR_Integer) 1))) {
		MR_GOTO_LAB(__Compare___exclude__exclude_contents_0_0_i29);
	}
	MR_r1 = (MR_Integer) 2;
	MR_decr_sp_and_return(3);
MR_def_label(__Compare___exclude__exclude_contents_0_0,29)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_def_label(__Compare___exclude__exclude_contents_0_0,28)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Integer) 1;
	MR_decr_sp_and_return(3);
MR_def_label(__Compare___exclude__exclude_contents_0_0,12)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_tag(MR_sv(2));
	if ((MR_r2 == MR_mktag((MR_Integer) 2))) {
		MR_GOTO_LAB(__Compare___exclude__exclude_contents_0_0_i15);
	}
	MR_r1 = (MR_Integer) 2;
	MR_decr_sp_and_return(3);
MR_def_label(__Compare___exclude__exclude_contents_0_0,15)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	...
	MR_np_call_localret_ent(__Compare___set_ordlist__set_ordlist_1_0,
		__Compare___exclude__exclude_contents_0_0_i17);
MR_def_label(__Compare___exclude__exclude_contents_0_0,17)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___exclude__exclude_contents_0_0_i35);
	}
	MR_r1 = (MR_Word) MR_STRING_CTOR_ADDR;
	MR_r2 = MR_sv(2);
	MR_r3 = MR_sv(1);
...
MR_def_label(__Compare___exclude__exclude_contents_0_0,35)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(3);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
