...
{
  {
    ...
    TypeCtorInfo_70_70 = (MR_Word) &mdprof_report_feedback__mdprof_report_feedback__type_ctor_info_option_0;
    mercury__getopt__process_options_4_p_0(TypeCtorInfo_70_70, (MR_Word) MR_mkword(MR_mktag(2), &mdprof_report_feedback_scalar_common_3[3]), Args0_5, &Args_6, &MaybeOptions_7);
    ...
    else
    {
      ...
      mercury__getopt__lookup_bool_option_3_p_0(TypeCtorInfo_70_70, Options_10, ((MR_Box) ((MR_Integer) 0)), &Help_11);
      mercury__getopt__lookup_bool_option_3_p_0(TypeCtorInfo_70_70, Options_10, ((MR_Box) ((MR_Integer) 1)), &Version_12);
      ...
      else
      {
        ...
        else
        {
          ...
          if ((Var_75 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
          {
            MR_Word FeedbackResult_14;

            mdbcomp__feedback__read_feedback_file_5_p_0(Var_76, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), &FeedbackResult_14);
            if (((MR_tag((MR_Word) FeedbackResult_14)) == (MR_mktag((MR_Integer) 1))))
            {
