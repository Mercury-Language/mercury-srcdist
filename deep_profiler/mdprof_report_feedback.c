...
main_2_p_0(void)
{
  ...
  else
  {
    ...
    mdprof_report_feedback__post_process_options_5_p_0(ProgName_4, Options0_10, &Options_11);
  ...
  MR_Word * STATE_VARIABLE_Options_12)
{
  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      mercury__map__set_4_p_0((MR_Word) (&mdprof_report_feedback__mdprof_report_feedback__type_ctor_info_option_0), (MR_Word) (&mercury__getopt__getopt__type_ctor_info_option_data_0), ((MR_Box) ((MR_Integer) 2)), ((MR_Box) (MR_mkword(MR_mktag(2), &mdprof_report_feedback_scalar_common_1[3]))), STATE_VARIABLE_Options_0_11, STATE_VARIABLE_Options_12);
    }
    else
