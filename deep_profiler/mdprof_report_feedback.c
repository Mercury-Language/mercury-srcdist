...
main_2_p_0(void)
{
  ...
  else
  {
    ...
    MR_Word Help_12;
    MR_Word Version_13;
    MR_Integer VerbosityLevel_96;
    MR_Word StdErr_97;

    mercury__getopt__lookup_int_option_3_p_0((MR_Word) (&mdprof_report_feedback__mdprof_report_feedback__type_ctor_info_option_0), Options0_10, ((MR_Box) ((MR_Integer) 2)), &VerbosityLevel_96);
    mercury__io__stderr_stream_3_p_0(&StdErr_97);
    succeeded = (VerbosityLevel_96 < (MR_Integer) 0);
    if (succeeded)
    {
      mercury__io__write_string_4_p_0(StdErr_97, ProgName_4);
      mercury__io__write_string_4_p_0(StdErr_97, (MR_String) ": warning: verbosity level should not be negative.\n");
    ...
    {
      succeeded = (VerbosityLevel_96 > (MR_Integer) 4);
      if (succeeded)
      {
        mercury__io__write_string_4_p_0(StdErr_97, ProgName_4);
        mercury__io__write_string_4_p_0(StdErr_97, (MR_String) ": warning: verbosity level should not exceed 4.\n");
    ...
    else
    {
      ...
      {
        MR_Word Var_76 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Args_6, (MR_Integer) 1))));
        MR_String Var_77 = ((MR_String) ((MR_hl_field(MR_mktag(1), Args_6, (MR_Integer) 0))));

        if ((Var_76 == (MR_Word) ((MR_Unsigned) 0U)))
        {
          MR_Word FeedbackResult_15;

          mdbcomp__feedback__read_feedback_file_5_p_0(Var_77, (MR_Word) ((MR_Unsigned) 0U), &FeedbackResult_15);
          if (((MR_tag((MR_Word) FeedbackResult_15)) == (MR_Integer) 1))
          {
            ...
            mdbcomp__feedback__feedback_read_error_message_string_3_p_0(Var_77, FeedbackError_17, &Message_18);
            mercury__io__write_string_4_p_0(StdErr_9, ProgName_4);
            mercury__io__write_string_4_p_0(StdErr_9, (MR_String) ": ");
