...
{
  {
    ...
    {
      mercury__getopt__process_options_4_p_0(mdprof_report_feedback__TypeCtorInfo_70_70, (MR_Word) MR_mkword(MR_mktag(2), &mdprof_report_feedback_scalar_common_3[3]), mdprof_report_feedback__Args0_5, &mdprof_report_feedback__Args_6, &mdprof_report_feedback__MaybeOptions_7);
    }
    {
        ...
        if (mdprof_report_feedback__succeeded)
        ...
        else
          {
            ...
            if ((mdprof_report_feedback__Args_6 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
              ...
              {
                MR_Word mdprof_report_feedback__Var_75 = ((MR_Word) (MR_hl_field(MR_mktag(1), mdprof_report_feedback__Args_6, (MR_Integer) 1)));
                MR_String mdprof_report_feedback__Var_76 = ((MR_String) (MR_hl_field(MR_mktag(1), mdprof_report_feedback__Args_6, (MR_Integer) 0)));

                if ((mdprof_report_feedback__Var_75 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
                  {
                    MR_Word mdprof_report_feedback__FeedbackResult_14;

                    {
                      mdbcomp__feedback__read_feedback_file_5_p_0(mdprof_report_feedback__Var_76, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), &mdprof_report_feedback__FeedbackResult_14);
                    }
                    if (((MR_tag((MR_Word) mdprof_report_feedback__FeedbackResult_14)) == (MR_mktag((MR_Integer) 1))))
                      {
                        ...
                        {
                          mdbcomp__feedback__feedback_read_error_message_string_3_p_0(mdprof_report_feedback__Var_76, mdprof_report_feedback__FeedbackError_16, &mdprof_report_feedback__Message_17);
                        }
                        {
                          mercury__io__write_string_4_p_0(mdprof_report_feedback__Stderr_8, mdprof_report_feedback__ProgName_4);
                        }
    ...
    if (mdprof_report_feedback__succeeded)
      {
        ...
        {
          mercury__map__set_4_p_0((MR_Word) &mdprof_report_feedback__mdprof_report_feedback__type_ctor_info_option_0, (MR_Word) &mercury__getopt__getopt__type_ctor_info_option_data_0, ((MR_Box) ((MR_Integer) 2)), ((MR_Box) (MR_mkword(MR_mktag(2), &mdprof_report_feedback_scalar_common_1[0]))), mdprof_report_feedback__STATE_VARIABLE_Options_0_11, mdprof_report_feedback__STATE_VARIABLE_Options_12);
        }
      }
    else
      {
        ...
        if (mdprof_report_feedback__succeeded)
          {
            ...
            {
              mercury__map__set_4_p_0((MR_Word) &mdprof_report_feedback__mdprof_report_feedback__type_ctor_info_option_0, (MR_Word) &mercury__getopt__getopt__type_ctor_info_option_data_0, ((MR_Box) ((MR_Integer) 2)), ((MR_Box) (MR_mkword(MR_mktag(2), &mdprof_report_feedback_scalar_common_1[1]))), mdprof_report_feedback__STATE_VARIABLE_Options_0_11, mdprof_report_feedback__STATE_VARIABLE_Options_12);
            }
          }
        else
  ...
  MR_String mdprof_report_feedback__ProgName_4)
{
  {
    MR_bool mdprof_report_feedback__succeeded;
    MR_String mdprof_report_feedback__Var_8;
    MR_String mdprof_report_feedback__Var_17;

    {
      mdprof_report_feedback__Var_17 = mercury__string__f_43_43_2_f_0(mdprof_report_feedback__ProgName_4, (MR_String) " [options] <feedbackfile>\n    This command outputs a report that shows the contents of the named\n    feedback file in a human-readable form.\n\n    You may specif" "y the following general options:\n\n    -h --help       Generate this help message.\n    -V --version    Report the program\'s version number.\n    -v --verbosity  <" "0-4>\n                    Generate messages. The higher the argument, the more\n                    verbose the program becomes. 2 is recommended, and\n           " "         is the default.\n");
    }
    {
      mdprof_report_feedback__Var_8 = mercury__string__f_43_43_2_f_0((MR_String) "Usage: ", mdprof_report_feedback__Var_17);
    }
    {
      mercury__io__write_string_3_p_0(mdprof_report_feedback__Var_8);
    }
  }
}
