...
main_2_p_0(void)
{
  ...
  {
    MR_Word Error_22 = ((MR_Word) ((MR_hl_field(1, MaybeOptions_7, 0))));
    MR_String Msg_23;
    MR_String Var_89;
    MR_String Var_95;
  ...
  else
  {
    ...
    else
    {
      ...
      {
        MR_Word Var_77 = ((MR_Word) ((MR_hl_field(1, Args_6, 1))));
        MR_String Var_78 = ((MR_String) ((MR_hl_field(1, Args_6, 0))));

        if ((Var_77 == (MR_Word) ((MR_Unsigned) 0U)))
        {
          MR_Word FeedbackResult_15;

          mdbcomp__feedback__feedback_info__read_feedback_file_5_p_0(Var_78, (MR_Word) ((MR_Unsigned) 0U), &FeedbackResult_15);
          if (((MR_tag((MR_Word) FeedbackResult_15)) == (MR_Integer) 1))
          {
            MR_Word FeedbackError_17 = ((MR_Word) ((MR_hl_field(1, FeedbackResult_15, 0))));
            MR_String Message_18;

            mdbcomp__feedback__feedback_info__feedback_read_error_message_string_3_p_0(Var_78, FeedbackError_17, &Message_18);
            mercury__io__write_string_4_p_0(StdErr_9, ProgName_4);
            mercury__io__write_string_4_p_0(StdErr_9, (MR_String) ": ");
          ...
          {
            MR_Word Feedback_16 = ((MR_Word) ((MR_hl_field(0, FeedbackResult_15, 0))));
