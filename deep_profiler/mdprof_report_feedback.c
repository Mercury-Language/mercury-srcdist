...
{
  {
    ...
    {
      MR_Word Error_21 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MaybeOptions_7, (MR_Integer) 0))));
      MR_String Msg_22;

      Msg_22 = mercury__getopt__option_error_to_string_1_f_0((MR_Word) (&mdprof_report_feedback__mdprof_report_feedback__type_ctor_info_option_0), Error_21);
      ...
      else
      {
        ...
        else
        {
          ...
          if ((Var_76 == (MR_Word) ((MR_Unsigned) 0U)))
          {
            ...
            mdbcomp__feedback__read_feedback_file_5_p_0(Var_77, (MR_Word) ((MR_Unsigned) 0U), &FeedbackResult_14);
            if (((MR_tag((MR_Word) FeedbackResult_14)) == (MR_Integer) 1))
            {
              ...
              mdbcomp__feedback__feedback_read_error_message_string_3_p_0(Var_77, FeedbackError_16, &Message_17);
              mercury__io__write_string_4_p_0(Stderr_8, ProgName_4);
              mercury__io__write_string_4_p_0(Stderr_8, (MR_String) ": ");
