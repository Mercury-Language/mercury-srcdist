...
static /* final */ const struct mdprof_report_feedback__vector_common_type_4_0_s mdprof_report_feedback_vector_common_4[3] = {
  ...
  {
    (MR_Integer) 0,
    (MR_Word) (MR_mkword(MR_mktag(1), &mdprof_report_feedback_scalar_common_1[0]))
  },
  /* row   1 */
  {
    (MR_Integer) 2,
    (MR_Word) (MR_mkword(MR_mktag(2), &mdprof_report_feedback_scalar_common_1[1]))
  },
  /* row   2 */
  {
    (MR_Integer) 1,
...
main_2_p_0(void)
{
  ...
  else
  {
    ...
    MR_Word Help_12;
    MR_Word Version_13;
    MR_Integer VerbosityLevel_98;
    MR_Word StdErr_99;

    mercury__getopt__lookup_int_option_3_p_0((MR_Word) (&mdprof_report_feedback__mdprof_report_feedback__type_ctor_info_option_0), Options0_10, ((MR_Box) ((MR_Integer) 2)), &VerbosityLevel_98);
    mercury__io__stderr_stream_3_p_0(&StdErr_99);
    succeeded = (VerbosityLevel_98 < (MR_Integer) 0);
    if (succeeded)
    {
      mercury__io__write_string_4_p_0(StdErr_99, ProgName_4);
      mercury__io__write_string_4_p_0(StdErr_99, (MR_String) ": warning: verbosity level should not be negative.\n");
      mercury__map__set_4_p_0((MR_Word) (&mdprof_report_feedback__mdprof_report_feedback__type_ctor_info_option_0), (MR_Word) (&mercury__getopt__getopt__type_ctor_info_option_data_0), ((MR_Box) ((MR_Integer) 2)), ((MR_Box) (MR_mkword(MR_mktag(2), &mdprof_report_feedback_scalar_common_1[2]))), Options0_10, &Options_11);
    }
    else
    {
      succeeded = (VerbosityLevel_98 > (MR_Integer) 4);
      if (succeeded)
      {
        mercury__io__write_string_4_p_0(StdErr_99, ProgName_4);
        mercury__io__write_string_4_p_0(StdErr_99, (MR_String) ": warning: verbosity level should not exceed 4.\n");
        mercury__map__set_4_p_0((MR_Word) (&mdprof_report_feedback__mdprof_report_feedback__type_ctor_info_option_0), (MR_Word) (&mercury__getopt__getopt__type_ctor_info_option_data_0), ((MR_Box) ((MR_Integer) 2)), ((MR_Box) (MR_mkword(MR_mktag(2), &mdprof_report_feedback_scalar_common_1[3]))), Options0_10, &Options_11);
      }
      else
    ...
    else
    {
      ...
      {
        MR_Word Var_78 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Args_6, (MR_Integer) 1))));
        MR_String Var_79 = ((MR_String) ((MR_hl_field(MR_mktag(1), Args_6, (MR_Integer) 0))));

        if ((Var_78 == (MR_Word) ((MR_Unsigned) 0U)))
        {
          MR_Word FeedbackResult_15;

          mdbcomp__feedback__read_feedback_file_5_p_0(Var_79, (MR_Word) ((MR_Unsigned) 0U), &FeedbackResult_15);
          if (((MR_tag((MR_Word) FeedbackResult_15)) == (MR_Integer) 1))
          {
            MR_Word FeedbackError_17 = ((MR_Word) ((MR_hl_field(MR_mktag(1), FeedbackResult_15, (MR_Integer) 0))));
            MR_String Message_18;

            mdbcomp__feedback__feedback_read_error_message_string_3_p_0(Var_79, FeedbackError_17, &Message_18);
            mercury__io__write_string_4_p_0(StdErr_9, ProgName_4);
            mercury__io__write_string_4_p_0(StdErr_9, (MR_String) ": ");
          ...
          {
            MR_Word Feedback_16 = ((MR_Word) ((MR_hl_field(MR_mktag(0), FeedbackResult_15, (MR_Integer) 0))));
