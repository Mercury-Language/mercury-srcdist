...
#endif
MR_decl_label4(array_util__array_foldl_6_0, 12,3,4,2)
MR_decl_label3(array_util__array_foldl_6_2, 3,4,2)
MR_decl_label4(array_util__array_foldl2_8_0, 12,3,4,2)
MR_decl_label3(array_util__array_foldl2_8_2, 3,4,2)
MR_decl_label1(array_util__array_foldl2_from_1_6_0, 2)
MR_decl_label1(array_util__array_foldl2_from_1_6_2, 2)
MR_decl_label1(array_util__array_foldl_from_0_4_0, 2)
MR_decl_label1(array_util__array_foldl_from_0_4_2, 2)
MR_decl_label1(array_util__array_foldl_from_1_4_0, 2)
MR_decl_label1(array_util__array_foldl_from_1_4_2, 2)
MR_decl_label3(array_util__array_list_foldl_4_0, 11,4,3)
MR_decl_label3(array_util__array_list_foldl2_6_0, 11,4,3)
...
MR_BEGIN_MODULE(array_util_module1)
	...
	MR_init_label4(array_util__array_foldl_6_0,12,3,4,2)
MR_BEGIN_CODE
...
MR_def_label(array_util__array_foldl_6_0,12)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (((MR_Integer) MR_r3 > (MR_Integer) MR_r4)) {
		MR_GOTO_LAB(array_util__array_foldl_6_0_i2);
	}
	MR_sv(1) = MR_r3;
	MR_sv(2) = MR_r4;
	MR_sv(3) = MR_r5;
	...
	MR_np_call_localret_ent(array__lookup_3_0,
		array_util__array_foldl_6_0_i3);
MR_def_label(array_util__array_foldl_6_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r3 = MR_r1;
	MR_r1 = MR_sv(3);
	MR_r2 = MR_sv(1);
	MR_r4 = MR_sv(5);
	MR_set_prof_ho_caller_proc(MR_ENTRY_AP(array_util__array_foldl_6_0));
	MR_noprof_call_localret(MR_ENTRY(mercury__do_call_closure_3),
		mercury__array_util__array_foldl_6_0_i4);
MR_def_label(array_util__array_foldl_6_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r7 = MR_r1;
	MR_r1 = MR_sv(6);
	MR_r2 = MR_sv(7);
	...
	MR_GOTO_LAB(array_util__array_foldl_6_0_i12);
MR_def_label(array_util__array_foldl_6_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_r7;
...
MR_define_entry(mercury__array_util__array_foldl_6_1);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_np_tailcall_ent(array_util__array_foldl_6_0);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_thread_engine_base
#endif
...
MR_def_label(array_util__array_foldl_6_2,4)
	...
	MR_succip_word = MR_sv(8);
	MR_decr_sp(8);
	MR_np_tailcall_ent(array_util__array_foldl_6_1);
...
MR_BEGIN_MODULE(array_util_module6)
	...
	MR_init_label1(array_util__array_foldl_from_1_4_2,2)
MR_BEGIN_CODE
...
MR_def_label(array_util__array_foldl_from_1_4_2,2)
	...
	MR_succip_word = MR_sv(6);
	MR_decr_sp(6);
	MR_np_tailcall_ent(array_util__array_foldl_6_2);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_thread_engine_base
#endif
...
MR_define_entry(mercury__array_util__array_foldl_from_0_4_1);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_np_tailcall_ent(array_util__array_foldl_from_0_4_0);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_thread_engine_base
#endif
...
MR_BEGIN_MODULE(array_util_module9)
	...
	MR_init_label1(array_util__array_foldl_from_0_4_2,2)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(array_util_module10)
	...
	MR_init_label4(array_util__array_foldl2_8_0,12,3,4,2)
MR_BEGIN_CODE
...
MR_def_label(array_util__array_foldl2_8_0,12)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (((MR_Integer) MR_r4 > (MR_Integer) MR_r5)) {
		MR_GOTO_LAB(array_util__array_foldl2_8_0_i2);
	}
	{
	...
	MR_np_call_localret_ent(array__lookup_3_0,
		array_util__array_foldl2_8_0_i3);
MR_def_label(array_util__array_foldl2_8_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r3 = MR_r1;
	MR_r1 = MR_sv(3);
	MR_r2 = MR_sv(1);
	MR_r4 = MR_sv(5);
	MR_r5 = MR_sv(6);
	MR_set_prof_ho_caller_proc(MR_ENTRY_AP(array_util__array_foldl2_8_0));
	MR_noprof_call_localret(MR_ENTRY(mercury__do_call_closure_4),
		mercury__array_util__array_foldl2_8_0_i4);
MR_def_label(array_util__array_foldl2_8_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r8 = MR_r1;
	MR_r1 = MR_sv(7);
	MR_r9 = MR_r2;
	...
	MR_GOTO_LAB(array_util__array_foldl2_8_0_i12);
MR_def_label(array_util__array_foldl2_8_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_r8;
	MR_r2 = MR_r9;
...
MR_define_entry(mercury__array_util__array_foldl2_8_1);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_np_tailcall_ent(array_util__array_foldl2_8_0);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_thread_engine_base
#endif
...
MR_def_label(array_util__array_foldl2_8_2,4)
	...
	MR_succip_word = MR_sv(10);
	MR_decr_sp(10);
	MR_np_tailcall_ent(array_util__array_foldl2_8_1);
...
MR_define_entry(mercury__array_util__array_foldl2_from_1_6_1);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_np_tailcall_ent(array_util__array_foldl2_from_1_6_0);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_thread_engine_base
#endif
...
MR_BEGIN_MODULE(array_util_module17)
	...
	MR_init_label1(array_util__array_foldl2_from_1_6_2,2)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(array_util_module20)
	...
	MR_init_label3(array_util__array_list_foldl_4_0,11,4,3)
MR_BEGIN_CODE
...
MR_def_label(array_util__array_list_foldl_4_0,11)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_def_label(array_util__array_list_foldl_4_0,4)
	...
	MR_GOTO_LAB(array_util__array_list_foldl_4_0_i11);
...
MR_BEGIN_MODULE(array_util_module21)
	...
	MR_init_label3(array_util__array_list_foldl2_6_0,11,4,3)
MR_BEGIN_CODE
...
MR_define_entry(mercury__array_util__array_list_foldl2_6_0);
	...
	MR_incr_sp(6);
	MR_sv(6) = (MR_Word) MR_succip;
MR_def_label(array_util__array_list_foldl2_6_0,11)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_def_label(array_util__array_list_foldl2_6_0,4)
	...
	MR_r5 = MR_sv(2);
	MR_succip_word = MR_sv(6);
	MR_GOTO_LAB(array_util__array_list_foldl2_6_0_i11);
...
void mercury__array_util__write_out_proc_statics(FILE *fp);
#endif
