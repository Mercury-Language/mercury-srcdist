...
{
  {
    ...
    MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Var_16, (MR_Integer) 1)));
    MR_Unsigned packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Var_16, (MR_Integer) 3)));
                ...
                case ((int) MR_deep_item_call_site_static):
                  {
                    ...
                    else
                    {
                      ...
                      {
                        STATE_VARIABLE_InitDeep_51_63 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 6 * sizeof(MR_Word)), NULL, NULL);
                ...
                case ((int) MR_deep_item_proc_dynamic):
                  {
                    ...
                    else
                    {
                      ...
                      {
                        STATE_VARIABLE_InitDeep_51_57 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 6 * sizeof(MR_Word)), NULL, NULL);
                ...
                case ((int) MR_deep_item_proc_static):
                  {
                    ...
                    else
                    {
                      ...
                      {
                        STATE_VARIABLE_InitDeep_51_69 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 6 * sizeof(MR_Word)), NULL, NULL);
...
{
  {
    ...
    if (((MR_tag((MR_Word) ProcLabel_4)) == (MR_Integer) 0))
    {
      ...
      MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), ProcLabel_4, (MR_Integer) 0)));
...
{
  {
    ...
    MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Var_25, (MR_Integer) 1)));
