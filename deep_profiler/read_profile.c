...
#line 77 "read_profile.c"

#endif
#line 80 "read_profile.c"
...
MR_decl_label10(read_profile__read_nodes_4_0, 95,2,4,7,6,11,15,17,19,14)
MR_decl_label10(read_profile__read_nodes_4_0, 23,26,22,29,32,34,36,31,39,41)
MR_decl_label5(read_profile__read_nodes_4_0, 43,9,46,47,106)
...
MR_BEGIN_MODULE(read_profile_module19)
	...
	MR_init_label10(read_profile__read_nodes_4_0,95,2,4,7,6,11,15,17,19,14)
	MR_init_label10(read_profile__read_nodes_4_0,23,26,22,29,32,34,36,31,39,41)
	MR_init_label5(read_profile__read_nodes_4_0,43,9,46,47,106)
MR_BEGIN_CODE
...
MR_def_static(read_profile__read_nodes_4_0)
	...
	MR_incr_sp(3);
	MR_sv(3) = (MR_Word) MR_succip;
MR_def_label(read_profile__read_nodes_4_0,95)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(2) = MR_r1;
	MR_np_call_localret_ent(io__read_byte_3_0,
...
MR_def_label(read_profile__read_nodes_4_0,17)
	...
	MR_np_call_localret_ent(read_profile__deep_insert_4_0,
		read_profile__read_nodes_4_0_i19);
MR_def_label(read_profile__read_nodes_4_0,19)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
...
MR_def_label(read_profile__read_nodes_4_0,23)
	...
	MR_np_call_localret_ent(read_profile__deep_insert_4_0,
		read_profile__read_nodes_4_0_i26);
...
MR_def_label(read_profile__read_nodes_4_0,22)
	...
	if (((MR_Integer) MR_r2 != ((MR_Integer) MR_deep_item_end))) {
		MR_GOTO_LAB(read_profile__read_nodes_4_0_i29);
	}
	MR_tag_alloc_heap(MR_r1, 0, (MR_Integer) 1);
	MR_tfield(0, MR_r1, 0) = MR_sv(2);
	MR_decr_sp_and_return(3);
...
MR_def_label(read_profile__read_nodes_4_0,32)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_r1,1)) {
		MR_GOTO_LAB(read_profile__read_nodes_4_0_i34);
	}
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 1);
...
MR_def_label(read_profile__read_nodes_4_0,34)
	...
	MR_np_call_localret_ent(read_profile__deep_insert_4_0,
		read_profile__read_nodes_4_0_i36);
...
MR_def_label(read_profile__read_nodes_4_0,31)
	...
	MR_np_call_localret_ent(read_profile__read_proc_static_3_0,
		read_profile__read_nodes_4_0_i39);
MR_def_label(read_profile__read_nodes_4_0,39)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_r1,1)) {
		MR_GOTO_LAB(read_profile__read_nodes_4_0_i41);
	}
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 1);
...
MR_def_label(read_profile__read_nodes_4_0,41)
	...
	MR_np_call_localret_ent(read_profile__deep_insert_4_0,
		read_profile__read_nodes_4_0_i43);
...
MR_def_label(read_profile__read_nodes_4_0,9)
	...
	MR_np_call_localret_ent(fn__string__int_to_string_1_0,
		read_profile__read_nodes_4_0_i46);
MR_def_label(read_profile__read_nodes_4_0,46)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
...
MR_def_label(read_profile__read_nodes_4_0,47)
	...
	MR_tfield(1, MR_r2, 0) = MR_r1;
	MR_r1 = MR_r2;
MR_def_label(read_profile__read_nodes_4_0,106)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(3);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
