    ...
    else
      {
        ...
        if (read_profile__succeeded)
        ...
        else
          {
            ...
            {
              mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) &read_profile_scalar_common_9[2], read_profile__Byte_7, &read_profile__Var_40);
            }
            {
    ...
    else
      {
        ...
        if (read_profile__succeeded)
        ...
        else
          {
            ...
            {
              mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) &read_profile_scalar_common_9[2], read_profile__Byte_7, &read_profile__Var_26);
            }
            {
    ...
    if (((MR_tag((MR_Word) read_profile__MaybePDHeader_13)) == (MR_mktag((MR_Integer) 1))))
    ...
    else
      {
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(0), read_profile__Var_45, 4) = ((MR_Box) (&read_profile_scalar_common_4[43]));
        }
        {
          io_combinator__maybe_error_sequence_2_6_p_0((MR_Word) &read_profile_scalar_common_1[3], (MR_Word) &read_profile_scalar_common_1[4], (MR_Word) &read_profile_scalar_common_2[1], read_profile__Var_44, read_profile__Var_45, (MR_Word) &read_profile_scalar_common_4[44], &read_profile__MaybeCPsAndSlots_20);
        }
    ...
    if (read_profile__succeeded)
      {
        ...
        *read_profile__Chars_5 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
        {
          mercury__list__take_while_3_p_0((MR_Word) &mercury__builtin__builtin__type_ctor_info_character_0, (MR_Word) &read_profile_scalar_common_4[40], read_profile__SpecInfo0_7, &read_profile__SpecInfo_8);
        }
        {
...
{
  {
...

    {
      ...
      MR_hl_field(MR_mktag(0), read_profile__Var_21, 0) = ((MR_Box) (&read_profile_scalar_common_10[2]));
    ...
    else
      {
        ...
        if (read_profile__succeeded)
        ...
        else
          {
            ...
            {
              mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) &read_profile_scalar_common_9[2], read_profile__Byte_7, &read_profile__Var_23);
            }
            {
      ...
      case (MR_Integer) 1:
        {
          ...
          if (read_profile__succeeded)
          ...
          else
            {
              ...
              {
                mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) &read_profile_scalar_common_9[2], read_profile__Byte_12, &read_profile__Var_146);
              }
              {
...
{
  {
    ...
    if (read_profile__succeeded)
    ...
    else
      {
        ...
        {
          mercury__string__format__format_unsigned_int_component_nowidth_noprec_4_p_0((MR_Word) &read_profile_scalar_common_9[2], (MR_Integer) 2, read_profile__FlagsInt_3, &read_profile__Var_35);
        }
        {
    ...
    if (((MR_tag((MR_Word) read_profile__MaybeFlags_25)) == (MR_mktag((MR_Integer) 1))))
      *read_profile__MaybeInitDeep_24 = (MR_Word) read_profile__MaybeFlags_25;
    else
      {
        ...
        {
          read_profile__conv3_Var_46 = mercury__array__init_2_f_0((MR_Word) &profile__profile__type_ctor_info_call_site_static_0, read_profile__Var_47, ((MR_Box) (&read_profile_scalar_common_5[1])));
        }
