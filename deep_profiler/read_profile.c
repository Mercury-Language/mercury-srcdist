...
MR_decl_label8(read_profile__read_call_site_slot_3_0, 2,7,11,9,15,14,19,22)
MR_decl_label4(read_profile__read_call_site_slot_3_0, 23,5,25,3)
...
MR_decl_label8(read_profile__read_nodes_4_0, 84,2,37,38,5,8,12,15)
MR_decl_label8(read_profile__read_nodes_4_0, 11,18,21,17,23,25,28,24)
MR_decl_label5(read_profile__read_nodes_4_0, 30,33,32,6,35)
...
MR_decl_static(read_profile__IntroducedFrom__pred__read_proc_dynamic__557__1_4_0)
MR_decl_static(read_profile__IntroducedFrom__pred__read_n_byte_string__936__1_2_0)
...
{
MR_COMMON(1,0),
MR_ENTRY_AP(read_profile__IntroducedFrom__pred__read_n_byte_string__936__1_2_0),
0
},
{
MR_COMMON(7,0),
...
{
MR_COMMON(4,4),
MR_ENTRY_AP(read_profile__IntroducedFrom__pred__read_proc_dynamic__557__1_4_0),
0
},
{
MR_COMMON(14,0),
...
MR_def_label(read_profile__read_deep_id_string_3_0,10)
	...
	if ((strcmp((char *)MR_r1, (char *)(MR_Word) MR_string_const("Mercury deep profiler data version 4\n", 37)) != 0)) {
...
MR_BEGIN_MODULE(read_profile_module19)
	...
	MR_init_label8(read_profile__read_nodes_4_0,84,2,37,38,5,8,12,15)
	MR_init_label8(read_profile__read_nodes_4_0,11,18,21,17,23,25,28,24)
	MR_init_label5(read_profile__read_nodes_4_0,30,33,32,6,35)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(read_profile_module27)
	...
	MR_init_label8(read_profile__read_call_site_slot_3_0,2,7,11,9,15,14,19,22)
	MR_init_label4(read_profile__read_call_site_slot_3_0,23,5,25,3)
MR_BEGIN_CODE
...
MR_def_label(read_profile__read_call_site_slot_3_0,7)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(read_profile__read_call_site_slot_3_0_i5);
	}
	if (((MR_Integer) MR_r2 != ((MR_Integer) MR_callsite_normal_call))) {
		MR_GOTO_LAB(read_profile__read_call_site_slot_3_0_i9);
	}
...
MR_def_label(read_profile__read_call_site_slot_3_0,9)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	...
	if (((MR_Integer) MR_r2 != ((MR_Integer) MR_callsite_method_call))) {
		MR_GOTO_LAB(read_profile__read_call_site_slot_3_0_i14);
	}
MR_def_label(read_profile__read_call_site_slot_3_0,15)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(1) = (MR_Integer) 0;
	MR_r1 = (MR_Word) MR_tbmkword(0, 0);
	MR_np_call_localret_ent(read_profile__read_multi_call_site_csdis_2_4_0,
		read_profile__read_call_site_slot_3_0_i19);
MR_def_label(read_profile__read_call_site_slot_3_0,14)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_def_label(read_profile__read_call_site_slot_3_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tempr1 = MR_sv(1);
...
MR_BEGIN_MODULE(read_profile_module44)
	MR_init_entry1(read_profile__IntroducedFrom__pred__read_proc_dynamic__557__1_4_0);
MR_BEGIN_CODE
	...
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(read_profile__IntroducedFrom__pred__read_proc_dynamic__557__1_4_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 0, (MR_Integer) 3);
...
MR_BEGIN_MODULE(read_profile_module45)
	MR_init_entry1(read_profile__IntroducedFrom__pred__read_n_byte_string__936__1_2_0);
MR_BEGIN_CODE
	...
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(read_profile__IntroducedFrom__pred__read_n_byte_string__936__1_2_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
