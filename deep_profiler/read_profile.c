  ...
  MR_ArrayPtr * A_8)
{
  ...
  else
  {
...

    {
      ...
      MR_hl_field(MR_mktag(0), TypeInfo__14_14, 0) = ((MR_Box) (&mercury__array__array__type_ctor_info_array_1));
      MR_hl_field(MR_mktag(0), TypeInfo__14_14, 1) = ((MR_Box) (TypeInfo_for_T_12));
    }
    conv0_Var_11 = array_util__u_1_f_0(TypeInfo__14_14, ((MR_Box) (A0_5)));
