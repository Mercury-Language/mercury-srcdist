...
read_profile__read_nodes_3_5_p_0(
  MR_Integer Depth_6,
  MR_Word STATE_VARIABLE_InitDeep_0_36,
  MR_Word * MaybeInitDeep_8);

static void MR_CALL 
read_profile__read_nodes_2_5_p_0(
  MR_Integer Depth_6,
  MR_Word STATE_VARIABLE_InitDeep_0_10,
  MR_Word * MaybeInitDeep_8);
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      else
      {
        ...
        {
          MR_Integer next_value_of_BytesLeft_7 = Var_21;
          MR_Integer next_value_of_Num0_8 = Num1_14;
          MR_Integer next_value_of_ShiftBy_9 = Var_22;
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      else
      {
        ...
        /* direct tailcall eliminated */
        {
          MR_Integer next_value_of_N_7 = Var_19;
          MR_Word next_value_of_RevItems0_9 = Var_20;
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      else
      {
        ...
        /* direct tailcall eliminated */
        {
          MR_Integer next_value_of_N_6 = Var_17;
          MR_Word next_value_of_RevBytes0_7 = Var_18;
    ...
    else
    {
      ...
      else
      {
        ...
        else
        {
          ...
          /* direct tailcall eliminated */
          {
            MR_Word next_value_of_CSDIs0_5 = Var_24;
      ...
      case (MR_Integer) 1:
        {
                  ...
                  if (((MR_tag((MR_Word) MaybeCSD_14)) == (MR_mktag((MR_Integer) 1))))
                  {
...

                    {
                      ...
                      *MaybeInitDeep_8 = base;
                      MR_hl_field(MR_mktag(2), base, 0) = ((MR_Box) (Error_19));
                    }
                  }
                  else
                  {
                    ...
                    read_profile__read_nodes_2_5_p_0(Depth_6, STATE_VARIABLE_InitDeep_51_51, MaybeInitDeep_8);
                  }
                }
                break;
              case ((int) MR_deep_item_call_site_static):
                {
                  ...
                  if (((MR_tag((MR_Word) MaybeCSS_25)) == (MR_mktag((MR_Integer) 1))))
                  {
...

                    {
                      ...
                      base = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
                      *MaybeInitDeep_8 = base;
                      MR_hl_field(MR_mktag(2), base, 0) = ((MR_Box) (Error_69));
                    }
                  }
                  else
                  {
                    ...
                    read_profile__read_nodes_2_5_p_0(Depth_6, STATE_VARIABLE_InitDeep_51_67, MaybeInitDeep_8);
                  }
                }
                break;
              ...
              case ((int) MR_deep_item_proc_dynamic):
                {
                  ...
                  if (((MR_tag((MR_Word) MaybePD_20)) == (MR_mktag((MR_Integer) 1))))
                  {
...

                    {
                      ...
                      base = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
                      *MaybeInitDeep_8 = base;
                      MR_hl_field(MR_mktag(2), base, 0) = ((MR_Box) (Error_61));
                    }
                  }
                  else
                  {
                    ...
                    read_profile__read_nodes_2_5_p_0(Depth_6, STATE_VARIABLE_InitDeep_51_59, MaybeInitDeep_8);
                  }
                }
                break;
              case ((int) MR_deep_item_proc_static):
                {
                  ...
                  if (((MR_tag((MR_Word) MaybePS_30)) == (MR_mktag((MR_Integer) 1))))
                  {
...

                    {
                      ...
                      base = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
                      *MaybeInitDeep_8 = base;
                      MR_hl_field(MR_mktag(2), base, 0) = ((MR_Box) (Error_77));
                    }
                  }
                  else
                  {
                    ...
                    read_profile__read_nodes_2_5_p_0(Depth_6, STATE_VARIABLE_InitDeep_51_75, MaybeInitDeep_8);
                  }
                }
                break;
            }
          else
          {
            ...
            Msg_35 = mercury__string__f_43_43_2_f_0((MR_String) "unexpected token ", Var_146);
            {
              ...
              base = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
              *MaybeInitDeep_8 = base;
              MR_hl_field(MR_mktag(2), base, 0) = ((MR_Box) (Msg_35));
            }
          }
        }
        break;
      case (MR_Integer) 2:
        {
          ...
          mercury__io__error_message_2_p_0(Error_90, &Msg_91);
          {
            ...
            base = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
            *MaybeInitDeep_8 = base;
            MR_hl_field(MR_mktag(2), base, 0) = ((MR_Box) (Msg_91));
          }
        }
        break;
    }
...
{
  {
    ...
    else
    {
      ...
      read_profile__read_nodes_3_5_p_0(Var_14, STATE_VARIABLE_InitDeep_0_10, MaybeInitDeep_8);
    }
  }
}
