  ...
  MR_Word * MaybeStr_6)
{
  ...
  else
  {
    ...
    {
      MR_Word MaybeRevNBytes_70;

      read_profile__read_n_bytes_acc_6_p_0(InputStream_5, Length_9, (MR_Word) ((MR_Unsigned) 0U), &MaybeRevNBytes_70);
      if (((MR_tag((MR_Word) MaybeRevNBytes_70)) == (MR_Integer) 1))
        *MaybeStr_6 = (MR_Word) (MaybeRevNBytes_70);
      else
      {
        MR_Word Bytes_40;
        MR_Word RevBytes_71 = ((MR_Word) ((MR_hl_field(MR_mktag(0), MaybeRevNBytes_70, (MR_Integer) 0))));
        MR_Word Chars_43;

        mercury__list__reverse_2_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0), RevBytes_71, &Bytes_40);
