...
{
  {
    ...
    else
    {
      ...
      mercury__string__format__format_cast_int_to_uint_2_p_0(FlagsInt_3, &Var_35);
      mercury__string__format__format_uint_component_nowidth_noprec_4_p_0((MR_Word) (&read_profile_scalar_common_6[2]), (MR_Integer) 2, Var_35, &Var_36);
