...
MR_def_label(create_report__gather_getters_setters_4_0,25)
	...
	if (((MR_tag(MR_r2) == MR_mktag((MR_Integer) 0)) || (MR_tag(MR_r2) == MR_mktag((MR_Integer) 1)))) {
...
MR_def_label(create_report__gather_getters_setters_4_0,28)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (((MR_tag(MR_r2) == MR_mktag((MR_Integer) 0)) || (MR_tag(MR_r2) == MR_mktag((MR_Integer) 2)))) {
