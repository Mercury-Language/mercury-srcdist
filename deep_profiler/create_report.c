  ...
  MR_Word * STATE_VARIABLE_Desc_20)
{
  ...
  CalleeProcDesc_16 = create_report__describe_proc_2_f_0(Deep_8, CalleePSPtr_13);
  {
    ...
    MR_hl_field(MR_mktag(1), Var_22, 0) = ((MR_Box) (CalleeDesc_15));
  }
  ...
  MR_Word * STATE_VARIABLE_ActionCliquePtrs_12)
{
  ...
  MR_Word Var_14;
  MR_Word CallSites_21 = ((MR_Word) ((MR_hl_field(MR_mktag(0), FirstPDReport_9, (MR_Integer) 1))));
  MR_Word Var_22;
  ...
  {
    Var_22 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(MR_mktag(0), Var_22, 0) = ((MR_Box) (&create_report_scalar_common_4[12]));
    MR_hl_field(MR_mktag(0), Var_22, 1) = ((MR_Box) (create_report__find_start_of_action_clique_proc_4_p_0_1));
    MR_hl_field(MR_mktag(0), Var_22, 2) = ((MR_Box) ((MR_Integer) 1));
    MR_hl_field(MR_mktag(0), Var_22, 3) = ((MR_Box) (Percent_5));
  }
