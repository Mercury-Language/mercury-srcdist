...
{
  {
    ...
    else
    {
...

      {
        ...
        MR_hl_field(MR_mktag(0), Ordering_18, 1) = (MR_Box) (((((MR_Unsigned) (((MR_Box) (CostKind_9))) << (MR_Integer) 2)) | (((((MR_Unsigned) (((MR_Box) (InclDesc_13))) << (MR_Integer) 1)) | (MR_Unsigned) (((MR_Box) (Scope_14)))))));
      }
      {
