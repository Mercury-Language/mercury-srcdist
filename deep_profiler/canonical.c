...
MR_decl_label7(f_99_97_110_111_110_105_99_97_108_95_95_85_110_117_115_101_100_65_114_103_115_95_95_112_114_101_100_95_95_99_111_109_112_108_101_116_101_95_99_108_105_113_117_101_95_95_91_50_93_95_48_5_0, 14,2,3,4,5,6,8)
...
MR_decl_label6(canonical__lookup_multi_sites_3_0, 20,4,7,6,5,9)
MR_decl_label5(canonical__lookup_normal_sites_3_0, 19,4,6,5,8)
...
MR_decl_label8(canonical__merge_clique_6_0, 3,32,6,7,8,9,11,12)
MR_decl_label2(canonical__merge_clique_6_0, 13,14)
...
MR_decl_label4(canonical__merge_proc_dynamics_8_0, 12,13,14,5)
MR_decl_label1(canonical__merge_proc_dynamics_ignore_chosen_7_0, 2)
MR_decl_label2(canonical__record_csd_redirect_4_0, 2,3)
MR_decl_label7(canonical__record_csd_redirect_2_4_0, 19,3,4,7,8,5,10)
MR_decl_label2(canonical__record_pd_redirect_4_0, 2,3)
MR_decl_label7(canonical__record_pd_redirect_2_4_0, 19,3,4,7,8,5,10)
...
MR_BEGIN_MODULE(canonical_module0)
	...
	MR_init_label8(canonical__merge_clique_6_0,3,32,6,7,8,9,11,12)
	MR_init_label2(canonical__merge_clique_6_0,13,14)
MR_BEGIN_CODE
...
MR_def_label(canonical__merge_clique_6_0,3)
	...
	if (MR_LTAGS_TESTR(MR_tempr1,0,0)) {
		MR_GOTO_LAB(canonical__merge_clique_6_0_i32);
	}
	MR_r1 = MR_r3;
	MR_r2 = MR_r4;
	MR_proceed();
	}
MR_def_label(canonical__merge_clique_6_0,32)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(6);
...
MR_def_label(canonical__merge_clique_6_0,8)
	...
	MR_np_call_localret_ent(list__filter_3_0,
		canonical__merge_clique_6_0_i9);
MR_def_label(canonical__merge_clique_6_0,9)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
		MR_GOTO_LAB(canonical__merge_clique_6_0_i11);
	}
	MR_r1 = MR_sv(3);
	MR_r2 = MR_sv(4);
...
MR_def_label(canonical__merge_clique_6_0,13)
	...
	MR_np_call_localret_ent(list__filter_3_0,
		canonical__merge_clique_6_0_i14);
MR_def_label(canonical__merge_clique_6_0,14)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
...
MR_BEGIN_MODULE(canonical_module6)
	...
	MR_init_label5(canonical__lookup_normal_sites_3_0,19,4,6,5,8)
MR_BEGIN_CODE
...
MR_def_static(canonical__lookup_normal_sites_3_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
		MR_GOTO_LAB(canonical__lookup_normal_sites_3_0_i19);
	}
	MR_r1 = (MR_Word) MR_tbmkword(0, 0);
	MR_proceed();
MR_def_label(canonical__lookup_normal_sites_3_0,19)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(3);
	MR_sv(3) = (MR_Word) MR_succip;
	MR_sv(1) = MR_r2;
...
MR_BEGIN_MODULE(canonical_module7)
	...
	MR_init_label6(canonical__lookup_multi_sites_3_0,20,4,7,6,5,9)
MR_BEGIN_CODE
...
MR_def_static(canonical__lookup_multi_sites_3_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
		MR_GOTO_LAB(canonical__lookup_multi_sites_3_0_i20);
	}
	MR_r1 = (MR_Word) MR_tbmkword(0, 0);
	MR_proceed();
MR_def_label(canonical__lookup_multi_sites_3_0,20)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(3);
	MR_sv(3) = (MR_Word) MR_succip;
	MR_sv(1) = MR_r2;
...
MR_BEGIN_MODULE(canonical_module13)
	...
	MR_init_label7(canonical__record_csd_redirect_2_4_0,19,3,4,7,8,5,10)
MR_BEGIN_CODE
...
MR_def_static(canonical__record_csd_redirect_2_4_0)
	...
	MR_incr_sp(6);
	MR_sv(6) = (MR_Word) MR_succip;
MR_def_label(canonical__record_csd_redirect_2_4_0,19)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
...
MR_def_label(canonical__record_csd_redirect_2_4_0,10)
	...
	MR_r3 = MR_tempr1;
	MR_succip_word = MR_sv(6);
	MR_GOTO_LAB(canonical__record_csd_redirect_2_4_0_i19);
	}
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_thread_engine_base
...
MR_BEGIN_MODULE(canonical_module16)
	...
	MR_init_label7(canonical__record_pd_redirect_2_4_0,19,3,4,7,8,5,10)
MR_BEGIN_CODE
...
MR_def_static(canonical__record_pd_redirect_2_4_0)
	...
	MR_incr_sp(6);
	MR_sv(6) = (MR_Word) MR_succip;
MR_def_label(canonical__record_pd_redirect_2_4_0,19)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
...
MR_def_label(canonical__record_pd_redirect_2_4_0,10)
	...
	MR_r3 = MR_tempr1;
	MR_succip_word = MR_sv(6);
	MR_GOTO_LAB(canonical__record_pd_redirect_2_4_0_i19);
	}
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_thread_engine_base
...
MR_BEGIN_MODULE(canonical_module18)
	...
	MR_init_label4(canonical__merge_proc_dynamics_8_0,12,13,14,5)
MR_BEGIN_CODE
...
MR_def_label(canonical__merge_proc_dynamics_8_0,3)
	...
	if (MR_LTAGS_TEST(MR_sv(3),0,0)) {
		MR_GOTO_LAB(canonical__merge_proc_dynamics_8_0_i5);
	}
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_sv(3);
...
MR_BEGIN_MODULE(canonical_module42)
	...
	MR_init_label7(f_99_97_110_111_110_105_99_97_108_95_95_85_110_117_115_101_100_65_114_103_115_95_95_112_114_101_100_95_95_99_111_109_112_108_101_116_101_95_99_108_105_113_117_101_95_95_91_50_93_95_48_5_0,14,2,3,4,5,6,8)
MR_BEGIN_CODE
