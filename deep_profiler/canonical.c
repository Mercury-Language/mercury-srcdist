  ...
  while (MR_TRUE)
    {
      /* tailcall optimized into a loop */
      {
        ...
        {
          mercury__list__foldl_4_p_0(canonical__TypeInfo_21_21, (MR_Word) &canonical_scalar_common_1[1], (MR_Word) &canonical_scalar_common_2[9], canonical__PDsList0_10, ((MR_Box) (canonical__Var_16)), &canonical__conv1_Clique0_11);
        }
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(0), canonical__Var_38, 0) = ((MR_Box) (&canonical_scalar_common_6[1]));
...
{
  {
    ...
    if (canonical__succeeded)
      *canonical__HeadVar__1_1 = (MR_Integer) 0;
      ...
      {
        MR_ArrayPtr canonical__Var_4 = ((MR_ArrayPtr) (MR_hl_field(MR_mktag(0), canonical__HeadVar__2_2, (MR_Integer) 0)));
        MR_ArrayPtr canonical__Var_5 = ((MR_ArrayPtr) (MR_hl_field(MR_mktag(0), canonical__HeadVar__2_2, (MR_Integer) 1)));
        MR_ArrayPtr canonical__Var_6 = ((MR_ArrayPtr) (MR_hl_field(MR_mktag(0), canonical__HeadVar__3_3, (MR_Integer) 0)));
        MR_ArrayPtr canonical__Var_7 = ((MR_ArrayPtr) (MR_hl_field(MR_mktag(0), canonical__HeadVar__3_3, (MR_Integer) 1)));
        MR_Word canonical__Var_8;

        {
          mercury__builtin__compare_3_p_0((MR_Word) &canonical_scalar_common_1[7], &canonical__Var_8, ((MR_Box) (canonical__Var_4)), ((MR_Box) (canonical__Var_6)));
        }
        ...
        if (canonical__succeeded)
          *canonical__HeadVar__1_1 = canonical__Var_8;
          ...
          {
            {
              mercury__builtin__compare_3_p_0((MR_Word) &canonical_scalar_common_1[6], canonical__HeadVar__1_1, ((MR_Box) (canonical__Var_5)), ((MR_Box) (canonical__Var_7)));
            }
          }
      }
  }
...
{
  {
    ...
    if (canonical__succeeded)
    ...
    else
      {
        ...
        MR_ArrayPtr canonical__Var_3 = ((MR_ArrayPtr) (MR_hl_field(MR_mktag(0), canonical__HeadVar__1_1, (MR_Integer) 0)));
        MR_ArrayPtr canonical__Var_4 = ((MR_ArrayPtr) (MR_hl_field(MR_mktag(0), canonical__HeadVar__1_1, (MR_Integer) 1)));
        MR_ArrayPtr canonical__Var_5 = ((MR_ArrayPtr) (MR_hl_field(MR_mktag(0), canonical__HeadVar__2_2, (MR_Integer) 0)));
        MR_ArrayPtr canonical__Var_6 = ((MR_ArrayPtr) (MR_hl_field(MR_mktag(0), canonical__HeadVar__2_2, (MR_Integer) 1)));

        {
          canonical__succeeded = mercury__array____Unify____array_1_0((MR_Word) &profile__profile__type_ctor_info_call_site_dynamic_ptr_0, (MR_ArrayPtr) canonical__Var_3, (MR_ArrayPtr) canonical__Var_5);
        }
        if (canonical__succeeded)
          {
            canonical__TypeCtorInfo_10_10 = (MR_Word) &profile__profile__type_ctor_info_proc_dynamic_ptr_0;
            {
              canonical__succeeded = mercury__array____Unify____array_1_0(canonical__TypeCtorInfo_10_10, (MR_ArrayPtr) canonical__Var_4, (MR_ArrayPtr) canonical__Var_6);
            }
          }
      }
    return canonical__succeeded;
    ...
    if (canonical__succeeded)
      *canonical__HeadVar__1_1 = (MR_Integer) 0;
    else
      {
        ...
        {
          mercury__builtin__compare_3_p_0((MR_Word) &canonical_scalar_common_1[8], &canonical__Var_8, ((MR_Box) (canonical__Var_4)), ((MR_Box) (canonical__Var_6)));
        }
        canonical__succeeded = (canonical__Var_8 == (MR_Integer) 0);
        canonical__succeeded = !(canonical__succeeded);
        if (canonical__succeeded)
          *canonical__HeadVar__1_1 = canonical__Var_8;
          ...
          {
            {
              mercury__builtin__compare_3_p_0((MR_Word) &canonical_scalar_common_1[9], canonical__HeadVar__1_1, ((MR_Box) (canonical__Var_5)), ((MR_Box) (canonical__Var_7)));
            }
          }
      }
  }
...
{
  {
    ...
    if (canonical__succeeded)
    ...
    else
      {
        ...
        {
          canonical__succeeded = mercury__array____Unify____array_1_0((MR_Word) &canonical_scalar_common_1[0], (MR_ArrayPtr) canonical__Var_3, (MR_ArrayPtr) canonical__Var_5);
        }
        if (canonical__succeeded)
          {
...
{
  {
    ...
    {
      canonical__Var_12 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), canonical__Var_12, 0) = ((MR_Box) (&canonical_scalar_common_3[8]));
...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(0), canonical__Var_26, 0) = ((MR_Box) (&canonical_scalar_common_3[7]));
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(0), canonical__Var_28, 0) = ((MR_Box) (&canonical_scalar_common_4[2]));
...
{
  {
...

    {
      ...
      MR_hl_field(MR_mktag(0), canonical__Var_35, 0) = ((MR_Box) (&canonical_scalar_common_3[5]));
    ...
    if (canonical__succeeded)
      {
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(0), canonical__Var_46, 0) = ((MR_Box) (&canonical_scalar_common_3[7]));
    ...
    else
      {
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(0), canonical__Var_122, 0) = ((MR_Box) (&canonical_scalar_common_3[7]));
            ...
            if (((MR_tag((MR_Word) canonical__PrimeSite0_20)) == (MR_mktag((MR_Integer) 1))))
              {
                ...
                }
                {
                  ...
                  MR_hl_field(MR_mktag(0), canonical__Var_69, 0) = ((MR_Box) (&canonical_scalar_common_4[1]));
    ...
    else
      {
        ...
        *canonical__ChosenPDPtr_12 = ((MR_Word) (MR_hl_field(MR_mktag(1), canonical__ValidPDPtrs_16, (MR_Integer) 0)));
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(0), canonical__Var_41, 0) = ((MR_Box) (&canonical_scalar_common_3[4]));
    ...
    if ((canonical__ValidPDPtrs_31 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
    ...
    else
      {
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(0), canonical__Var_52, 0) = ((MR_Box) (&canonical_scalar_common_3[4]));
                ...
                if (canonical__succeeded)
                ...
                else
                  {
                    ...
                    }
                    {
                      ...
                      MR_hl_field(MR_mktag(0), canonical__Var_40, 0) = ((MR_Box) (&canonical_scalar_common_4[0]));
    ...
    if (canonical__succeeded)
      {
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(0), canonical__Var_25, 0) = ((MR_Box) (&canonical_scalar_common_3[2]));
                ...
                if ((canonical__Var_73 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
                ...
                else
                  {
                    ...
                    }
                    {
                      ...
                      MR_hl_field(MR_mktag(0), canonical__Var_50, 0) = ((MR_Box) (&canonical_scalar_common_4[0]));
                    ...
                    if ((canonical__ToMergePDsList1_42 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
                    ...
                    else
                      {
                        ...
                        }
                        {
                          ...
                          MR_hl_field(MR_mktag(0), canonical__Var_53, 0) = ((MR_Box) (&canonical_scalar_common_6[0]));
...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(0), canonical__Var_72, 0) = ((MR_Box) (&canonical_scalar_common_3[0]));
    ...
    canonical__CSDs1_61 = (MR_ArrayPtr) canonical__conv6_CSDs1_61;
    {
      ...
      MR_hl_field(MR_mktag(0), canonical__Var_74, 0) = ((MR_Box) (&canonical_scalar_common_3[1]));
