...
MR_decl_label2(__Unify___canonical__merge_info_0_0, 2,1)
MR_decl_label2(__Unify___canonical__redirect_0_0, 2,1)
MR_decl_label2(__Compare___canonical__merge_info_0_0, 3,7)
MR_decl_label2(__Compare___canonical__redirect_0_0, 3,7)
...
MR_BEGIN_MODULE(canonical_module34)
	...
	MR_init_label2(__Unify___canonical__merge_info_0_0,2,1)
MR_BEGIN_CODE
...
MR_def_static(__Unify___canonical__merge_info_0_0)
	...
	MR_np_call_localret_ent(__Unify___array__array_1_0,
		__Unify___canonical__merge_info_0_0_i2);
MR_def_label(__Unify___canonical__merge_info_0_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
...
MR_BEGIN_MODULE(canonical_module35)
	...
	MR_init_label2(__Compare___canonical__merge_info_0_0,3,7)
MR_BEGIN_CODE
...
MR_def_static(__Compare___canonical__merge_info_0_0)
	...
	MR_np_call_localret_ent(__Compare___array__array_1_0,
		__Compare___canonical__merge_info_0_0_i3);
MR_def_label(__Compare___canonical__merge_info_0_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___canonical__merge_info_0_0_i7);
	}
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(profile, clique_ptr);
	MR_r2 = MR_sv(1);
	MR_r3 = MR_sv(2);
...
MR_def_label(__Compare___canonical__merge_info_0_0,7)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(3);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
...
MR_BEGIN_MODULE(canonical_module36)
	...
	MR_init_label2(__Unify___canonical__redirect_0_0,2,1)
MR_BEGIN_CODE
...
MR_def_static(__Unify___canonical__redirect_0_0)
	...
	MR_np_call_localret_ent(__Unify___array__array_1_0,
		__Unify___canonical__redirect_0_0_i2);
MR_def_label(__Unify___canonical__redirect_0_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
...
MR_BEGIN_MODULE(canonical_module37)
	...
	MR_init_label2(__Compare___canonical__redirect_0_0,3,7)
MR_BEGIN_CODE
...
MR_def_static(__Compare___canonical__redirect_0_0)
	...
	MR_np_call_localret_ent(__Compare___array__array_1_0,
		__Compare___canonical__redirect_0_0_i3);
MR_def_label(__Compare___canonical__redirect_0_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___canonical__redirect_0_0_i7);
	}
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(profile, proc_dynamic_ptr);
	MR_r2 = MR_sv(1);
	MR_r3 = MR_sv(2);
	...
	MR_decr_sp(3);
	MR_np_tailcall_ent(__Compare___array__array_1_0);
MR_def_label(__Compare___canonical__redirect_0_0,7)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(3);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
