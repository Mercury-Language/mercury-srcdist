...
MR_decl_label10(canonical__compact_dynamics_5_0, 3,4,6,7,11,12,15,16,17,18)
MR_decl_label1(canonical__compact_dynamics_5_0, 19)
...
MR_decl_label10(canonical__merge_cliques_6_0, 42,3,5,7,9,12,13,15,17,18)
...
MR_decl_label9(canonical__merge_proc_dynamic_slots_11_0, 27,3,6,7,8,5,11,13,2)
...
MR_BEGIN_MODULE(canonical_module0)
	...
	MR_init_label10(canonical__merge_cliques_6_0,42,3,5,7,9,12,13,15,17,18)
...
MR_BEGIN_MODULE(canonical_module3)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__canonical__compact_dynamics_5_0);
	MR_init_label10(canonical__compact_dynamics_5_0,3,4,6,7,11,12,15,16,17,18)
	MR_init_label1(canonical__compact_dynamics_5_0,19)
MR_BEGIN_CODE
...
MR_def_label(canonical__complete_clique_slots_9_0,7)
	...
	MR_tfield(0, MR_tempr1, 2) = (MR_Integer) 1;
	MR_tfield(0, MR_tempr1, 3) = MR_tfield(0, MR_sv(2), 2);
	MR_r3 = MR_r1;
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(profile, call_site_dynamic_ptr);
...
MR_BEGIN_MODULE(canonical_module18)
	...
	MR_init_label9(canonical__merge_proc_dynamic_slots_11_0,27,3,6,7,8,5,11,13,2)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(canonical_module37)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__canonical__IntroducedFrom__pred__complete_clique__132__1_3_0);
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(canonical_module38)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__canonical__IntroducedFrom__pred__merge_proc_dynamics__241__1_2_0);
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(canonical_module39)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__canonical__IntroducedFrom__pred__merge_call_site_dynamics_2__416__1_2_0);
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(canonical_module40)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__canonical__IntroducedFrom__pred__merge_call_site_dynamics_2__421__1_2_0);
MR_BEGIN_CODE
