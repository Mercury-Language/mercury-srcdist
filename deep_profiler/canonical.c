...
{
  {
    ...
    if ((ValidCSDPtrs_34 == (MR_Word) ((MR_Unsigned) 0U)))
    {
    ...
    else
    {
      ...
      if ((LaterCSDPtrs_36 == (MR_Word) ((MR_Unsigned) 0U)))
      {
...
{
  {
    ...
    if ((ValidPDPtrs_31 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      {
  ...
  while (MR_TRUE)
  {
    ...
    if (succeeded)
    {
      ...
      if (((MR_tag((MR_Word) PrimeSite0_20)) == (MR_Integer) 1))
      {
        ...
        MR_Word Var_69;
        MR_Word Var_70;
        MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), PrimeSite0_20, (MR_Integer) 0)));
        ...
        mercury__list__foldl3_8_p_0((MR_Word) (&canonical_scalar_common_1[4]), (MR_Word) (&canonical_scalar_common_1[4]), (MR_Word) (&profile__profile__type_ctor_info_initial_deep_0), (MR_Word) (&canonical__canonical__type_ctor_info_redirect_0), Var_70, CSDPtrsClusters_67, ((MR_Box) ((MR_Unsigned) 0U)), &conv8_PrimeCSDPtrList_26, ((MR_Box) (STATE_VARIABLE_InitDeep_0_30)), &conv7_STATE_VARIABLE_InitDeep_39_39, ((MR_Box) (STATE_VARIABLE_Redirect_0_32)), &conv6_STATE_VARIABLE_Redirect_40_40);
        ...
        PrimeCSDPtrArray_27 = (MR_ArrayPtr) (conv9_PrimeCSDPtrArray_27);
        {
          ...
          MR_hl_field(MR_mktag(1), Var_37, 0) = (MR_Box) (packed_args_0);
...
{
  {
    ...
    if ((ValidCSDPtrs_41 == (MR_Word) ((MR_Unsigned) 0U)))
    {
    ...
    else
    {
      ...
      *PrimeCSDPtr_18 = ((MR_Word) ((MR_hl_field(MR_mktag(1), ValidCSDPtrs_41, (MR_Integer) 0))));
      ...
      if ((LaterCSDPtrs_43 == (MR_Word) ((MR_Unsigned) 0U)))
      {
...
{
  {
    ...
    succeeded = ((MR_tag((MR_Word) PDPtrs_11)) == (MR_Integer) 1);
    if (succeeded)
    {
    ...
    if (succeeded)
    {
      ...
      packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), PS_17, (MR_Integer) 7)));
      Var_30 = ((MR_ArrayPtr) ((MR_hl_field(MR_mktag(0), PS_17, (MR_Integer) 8))));
      packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), PS_17, (MR_Integer) 11)));
      Var_26 = mercury__array__max_1_f_0((MR_Word) (&profile__profile__type_ctor_info_call_site_static_ptr_0), (MR_ArrayPtr) (Var_30));
      packed_args_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), PS_17, (MR_Integer) 7)));
      Var_27 = ((MR_ArrayPtr) ((MR_hl_field(MR_mktag(0), PS_17, (MR_Integer) 8))));
      packed_args_3 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), PS_17, (MR_Integer) 11)));
    ...
    else
    {
      ...
      else
      {
        ...
        else
        {
          ...
          if ((ToMergePDsList1_42 == (MR_Word) ((MR_Unsigned) 0U)))
          {
            STATE_VARIABLE_InitDeep_23_23 = STATE_VARIABLE_InitDeep_0_3;
            STATE_VARIABLE_Redirect_24_24 = STATE_VARIABLE_Redirect_0_5;
          }
