...
MR_decl_label8(canonical__complete_clique_slots_9_0, 53,3,4,7,5,9,10,12)
MR_decl_label8(canonical__complete_clique_slots_9_0, 13,15,16,17,20,19,22,25)
MR_decl_label4(canonical__complete_clique_slots_9_0, 23,27,31,2)
...
MR_decl_label8(canonical__merge_call_site_dynamics_2_8_0, 3,4,7,10,11,13,15,18)
MR_decl_label8(canonical__merge_call_site_dynamics_2_8_0, 19,5,22,23,25,27,30,31)
MR_decl_label4(canonical__merge_call_site_dynamics_2_8_0, 33,34,36,37)
MR_decl_label6(canonical__merge_call_site_dynamics_descendants_8_0, 2,3,5,7,10,12)
MR_decl_label8(canonical__merge_cliques_6_0, 42,3,5,7,9,12,13,15)
MR_decl_label5(canonical__merge_cliques_6_0, 17,18,19,21,23)
...
MR_BEGIN_MODULE(canonical_module0)
	...
	MR_init_label8(canonical__merge_cliques_6_0,42,3,5,7,9,12,13,15)
	MR_init_label5(canonical__merge_cliques_6_0,17,18,19,21,23)
MR_BEGIN_CODE
...
MR_def_label(canonical__merge_cliques_6_0,42)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_def_label(canonical__merge_cliques_6_0,3)
	...
	MR_GOTO_LAB(canonical__merge_cliques_6_0_i42);
...
/*-------------------------------------------------------------------------*/
/* code for 'compact_dynamics'/5 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(canonical__compact_dynamics_5_0)
	...
	MR_sv(11) = (MR_Word) MR_CTOR1_ADDR(array, array);
	MR_tempr1 = MR_tempr2;
...
MR_def_label(canonical__compact_dynamics_5_0,7)
	...
	MR_tempr3 = MR_sv(6);
	MR_sv(6) = MR_tempr1;
	MR_sv(12) = (MR_Word) MR_CTOR0_ADDR(profile, call_site_dynamic);
...
MR_def_label(canonical__compact_dynamics_5_0,12)
	...
	MR_tempr2 = MR_sv(7);
	MR_sv(7) = MR_tempr1;
	MR_sv(10) = (MR_Word) MR_CTOR0_ADDR(profile, proc_dynamic);
...
MR_BEGIN_MODULE(canonical_module7)
	...
	MR_init_label8(canonical__complete_clique_slots_9_0,53,3,4,7,5,9,10,12)
	MR_init_label8(canonical__complete_clique_slots_9_0,13,15,16,17,20,19,22,25)
	MR_init_label4(canonical__complete_clique_slots_9_0,23,27,31,2)
MR_BEGIN_CODE
...
MR_def_label(canonical__complete_clique_slots_9_0,27)
	...
	MR_tfield(0, MR_tempr3, 1) = (MR_Word) MR_CTOR0_ADDR(profile, proc_static_ptr);
...
MR_BEGIN_MODULE(canonical_module21)
	...
	MR_init_label8(canonical__merge_call_site_dynamics_2_8_0,3,4,7,10,11,13,15,18)
	MR_init_label8(canonical__merge_call_site_dynamics_2_8_0,19,5,22,23,25,27,30,31)
	MR_init_label4(canonical__merge_call_site_dynamics_2_8_0,33,34,36,37)
MR_BEGIN_CODE
...
MR_def_label(canonical__merge_call_site_dynamics_descendants_8_0,3)
	...
	MR_tempr2 = MR_sv(2);
	MR_sv(2) = MR_r1;
	MR_sv(3) = (MR_Word) MR_CTOR0_ADDR(profile, call_site_dynamic);
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(profile, call_site_dynamic_ptr);
	MR_r2 = MR_sv(3);
	MR_r4 = MR_tempr2;
	}
...
/*-------------------------------------------------------------------------*/
/* code for 'IntroducedFrom__pred__complete_clique__132__1'/3 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
...
/*-------------------------------------------------------------------------*/
/* code for 'IntroducedFrom__pred__merge_proc_dynamics__241__1'/2 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
...
/*-------------------------------------------------------------------------*/
/* code for 'IntroducedFrom__pred__merge_call_site_dynamics_2__416__1'/2 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
...
/*-------------------------------------------------------------------------*/
/* code for 'IntroducedFrom__pred__merge_call_site_dynamics_2__421__1'/2 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
