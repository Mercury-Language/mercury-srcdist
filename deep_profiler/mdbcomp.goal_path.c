  ...
  MR_Word * HeadVar__4_4)
{
  ...
  }
  {
    ...
    MR_hl_field(MR_mktag(0), TypeInfo_13_13, 0) = ((MR_Box) (&mercury__maybe__maybe__type_ctor_info_maybe_1));
          ...
          {
            {
              ...
              *Step_4 = base;
              MR_hl_field(MR_mktag(2), base, 0) = ((MR_Box) (N_8));
            }
            succeeded = MR_TRUE;
          }
        }
          ...
          {
            {
              ...
              *Step_4 = base;
              ...
              MR_hl_field(MR_mktag(3), base, 1) = ((MR_Box) (N_21));
            }
            succeeded = MR_TRUE;
          }
        }
      ...
      case (MR_Char) 115:
        {
          ...
          if (succeeded)
          {
            NStr_11 = ((MR_String) ((MR_hl_field(MR_mktag(1), Var_14, (MR_Integer) 0))));
            Var_17 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Var_14, (MR_Integer) 1))));
            succeeded = (Var_17 != (MR_Word) ((MR_Unsigned) 0U));
            if (succeeded)
            {
              MStr_12 = ((MR_String) ((MR_hl_field(MR_mktag(1), Var_17, (MR_Integer) 0))));
              ...
              if (succeeded)
              {
                ...
                if (succeeded)
                {
                  ...
                  else
                  {
                    ...
                    {
                      {
                        MaybeM_10 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                        MR_hl_field(MR_mktag(1), MaybeM_10, 0) = ((MR_Box) (M_13));
                      }
                      succeeded = MR_TRUE;
                    }
                  }
                  ...
                  {
                    {
                      ...
                      *Step_4 = base;
                      ...
                      MR_hl_field(MR_mktag(3), base, 1) = ((MR_Box) (N_9));
                      MR_hl_field(MR_mktag(3), base, 2) = ((MR_Box) (MaybeM_10));
                    }
                    succeeded = MR_TRUE;
                  }
                }
    ...
    switch (MR_tag((MR_Word) Step0_4)) {
      ...
      case (MR_Integer) 3:
        switch (((MR_Integer) ((MR_hl_field(MR_mktag(3), Step0_4, (MR_Integer) 0))))) {
          ...
          case (MR_Integer) 0:
            {
              MR_Integer N_11 = ((MR_Integer) ((MR_hl_field(MR_mktag(3), Step0_4, (MR_Integer) 1))));

              {
                ...
                MR_hl_field(MR_mktag(3), Step_6, 1) = ((MR_Box) (N_11));
