            ...
            case (MR_Integer) 1:
              {
                ...
                MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Step_4, (MR_Integer) 1)));
            ...
            case (MR_Integer) 1:
              {
                ...
                MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Step_3, (MR_Integer) 1)));
