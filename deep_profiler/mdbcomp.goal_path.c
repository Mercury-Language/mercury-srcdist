...
{
  {
    ...
    if ((MaybeAttr_7 == (MR_Word) ((MR_Integer) 0)))
    {
...
{
  {
    ...
    conv0_Var_4 = mercury__array__init_2_f_0(TypeInfo_10_10, Var_5, ((MR_Box) ((MR_Integer) 0)));
  ...
  MR_Word GoalIdB_6)
{
  while (MR_TRUE)
  {
    ...
    if (!(succeeded))
    {
      ...
      succeeded = ((MR_tag((MR_Word) GoalContainingB_7)) == (MR_Integer) 1);
      if (succeeded)
      {
  ...
  MR_Word * STATE_VARIABLE_ReverseGoalPathBiMap_3)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      if ((ContainingGoal_11 == (MR_Word) ((MR_Integer) 0)))
        GoalReversePath_12 = (MR_Word) ((MR_Integer) 0);
      else
      {
...
{
  {
    ...
    mdbcomp__goal_path__rgp_to_fgp_2_3_p_0(RevGoalPath_7, (MR_Word) ((MR_Integer) 0), &GoalPath_6);
    return GoalPath_6;
  }
}
...
{
  {
    ...
    if ((ContainingGoal_7 == (MR_Word) ((MR_Integer) 0)))
      GoalPath_6 = (MR_Word) ((MR_Integer) 0);
    else
    {
            ...
            case (MR_Integer) 0:
              {
                ...
                if ((Var_42 == (MR_Word) ((MR_Integer) 0)))
                {
                  MR_String Var_31;
                  MR_String Var_32;
        ...
        case (MR_Char) 115:
          {
            ...
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                ...
                succeeded = (Var_21 == (MR_Word) ((MR_Integer) 0));
                if (succeeded)
                {
                  ...
                  if (succeeded)
                  {
                    ...
                    if (succeeded)
                    {
                      MaybeM_13 = (MR_Word) ((MR_Integer) 0);
                      succeeded = MR_TRUE;
                    }
                    else
                    {
          ...
          case (MR_Integer) 0:
            {
...

              {
                ...
                MR_hl_field(MR_mktag(3), Step_6, 2) = ((MR_Box) ((MR_Integer) 0));
              }
            }
            break;
          case (MR_Integer) 1:
...
{
  {
    mdbcomp__goal_path__fgp_to_rgp_2_3_p_0(ForwardGoalPath_3, (MR_Word) ((MR_Integer) 0), ReverseGoalPath_4);
  }
}
...
{
  {
    mdbcomp__goal_path__rgp_to_fgp_2_3_p_0(ReverseGoalPath_3, (MR_Word) ((MR_Integer) 0), ForwardGoalPath_4);
  }
}
...
{
  {
    ...
    mdbcomp__goal_path__rgp_to_fgp_2_3_p_0(RevPathA_4, (MR_Word) ((MR_Integer) 0), &PathA_7);
    mdbcomp__goal_path__rgp_to_fgp_2_3_p_0(RevPathB_5, (MR_Word) ((MR_Integer) 0), &PathB_8);
    succeeded = mdbcomp__goal_path__goal_path_inside_relative_3_p_0(PathA_7, PathB_8, &RelativePath_9);
    if (succeeded)
    {
      Var_18 = (MR_Word) ((MR_Integer) 0);
...
{
  {
    ...
    mdbcomp__goal_path__rgp_to_fgp_2_3_p_0(RevPathA_3, (MR_Word) ((MR_Integer) 0), &PathA_9);
    mdbcomp__goal_path__rgp_to_fgp_2_3_p_0(RevPathB_4, (MR_Word) ((MR_Integer) 0), &PathB_10);
    succeeded = mdbcomp__goal_path__goal_path_inside_relative_3_p_0(PathA_9, PathB_10, &RelativePath_11);
    if (succeeded)
    {
      Var_20 = (MR_Word) ((MR_Integer) 0);
...
{
  {
    MR_bool succeeded = ((MR_tag((MR_Word) GoalPath_3)) == (MR_Integer) 1);
    ...
    {
      {
        ...
        MR_hl_field(MR_mktag(1), HeadVar__3_3, 1) = ((MR_Box) ((MR_Integer) 0));
      }
    }
    else
    {
