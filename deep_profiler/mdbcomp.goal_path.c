...
mdbcomp__goal_path__IntroducedFrom__pred__goal_path_step_from_string__552__1_2_p_0(
  ...
  MR_Word * HeadVar__4_4)
{
...

  {
    ...
    MR_hl_field(1, Var_10, 0) = Value_6;
  }
  {
  ...
  mercury__array__set_4_p_0(TypeInfo_13_13, Index_5, ((MR_Box) (Var_10)), (MR_ArrayPtr) (STATE_VARIABLE_Array_0_8), &conv0_STATE_VARIABLE_Array_9);
  ...
  MR_Box Default_5)
{
  ...
  Var_7 = (MR_Integer) ((MR_Unsigned) LastGoalIdNum_4 + (MR_Unsigned) 1);
  {
    ...
    MR_hl_field(1, Var_9, 0) = Default_5;
  }
  ...
  MR_Box wrapper_arg_1)
{
  ...
  succeeded = mdbcomp__goal_path__IntroducedFrom__pred__goal_path_step_from_string__552__1_2_p_0(((MR_Char) (MR_Word) (MR_hl_field(0, closure, (MR_Integer) 3))), ((MR_Char) (MR_Word) wrapper_arg_1));
  return succeeded;
}
