  ...
  MR_Box wrapper_arg_1)
{
  ...
  succeeded = mdbcomp__goal_path__IntroducedFrom__pred__goal_path_step_from_string__566__1_2_p_0(((MR_Char) (MR_Word) (MR_hl_field(0, closure, 3))), ((MR_Char) (MR_Word) wrapper_arg_1));
  return succeeded;
}
