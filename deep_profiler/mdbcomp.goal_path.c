...
{
  {
    ...
    else
    {
      ...
      else
      {
        ...
        mercury__private_builtin__builtin_compare_int_3_p_0(&SubResult1_10, Var_19, Var_20);
        succeeded = (SubResult1_10 != (MR_Integer) 0);
        if (succeeded)
          *HeadVar__1_1 = SubResult1_10;
        else
                      ...
                      case (MR_Integer) 0:
                        {
                          ...
                          mercury__private_builtin__builtin_compare_int_3_p_0(&SubResult1_48, Var_162, ArgY1_47);
