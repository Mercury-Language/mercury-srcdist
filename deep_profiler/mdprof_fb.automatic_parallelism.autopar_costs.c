...
MR_decl_label4(mdprof_fb__automatic_parallelism__autopar_costs__atomic_goal_build_use_map_7_0, 2,6,4,11)
...
MR_decl_label8(fn__mdprof_fb__automatic_parallelism__autopar_costs__compute_var_use_lazy_5_0, 2,4,6,3,10,11,13,17)
...
MR_def_label(mdprof_fb__automatic_parallelism__autopar_costs__disj_calc_cost_3_0,36)
	...
	MR_r1 = MR_tfield(0, MR_tfield(0, MR_sv(2), 2), 3);
...
MR_BEGIN_MODULE(mdprof_fb__automatic_parallelism__autopar_costs_module4)
	...
	MR_init_label4(mdprof_fb__automatic_parallelism__autopar_costs__atomic_goal_build_use_map_7_0,2,6,4,11)
MR_BEGIN_CODE
...
MR_def_label(mdprof_fb__automatic_parallelism__autopar_costs__atomic_goal_build_use_map_7_0,2)
	...
	* (MR_Float *) &(MR_tfield(0, MR_r2, 2)) = (MR_Float) 1.0000000000000000;
	...
	MR_np_call_localret_ent(fn__lazy__val_1_0,
		mdprof_fb__automatic_parallelism__autopar_costs__atomic_goal_build_use_map_7_0_i11);
...
MR_def_label(mdprof_fb__automatic_parallelism__autopar_costs__atomic_goal_build_use_map_7_0,4)
	...
	MR_np_call_localret_ent(fn__lazy__delay_1_0,
		mdprof_fb__automatic_parallelism__autopar_costs__atomic_goal_build_use_map_7_0_i11);
MR_def_label(mdprof_fb__automatic_parallelism__autopar_costs__atomic_goal_build_use_map_7_0,11)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_sv(4);
	MR_r3 = MR_r1;
	MR_r4 = MR_sv(5);
...
MR_def_label(mdprof_fb__automatic_parallelism__autopar_costs__recursion_type_get_interesting_parallelisation_depth_2_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_f(1) = (MR_Float) 2.0000000000000000;
	MR_np_call_localret_ent(fn__measurements__recursion_depth_from_float_1_0,
		mdprof_fb__automatic_parallelism__autopar_costs__recursion_type_get_interesting_parallelisation_depth_2_0_i6);
...
MR_BEGIN_MODULE(mdprof_fb__automatic_parallelism__autopar_costs_module8)
	...
	MR_init_label8(fn__mdprof_fb__automatic_parallelism__autopar_costs__compute_var_use_lazy_5_0,2,4,6,3,10,11,13,17)
MR_BEGIN_CODE
...
MR_def_static(fn__mdprof_fb__automatic_parallelism__autopar_costs__compute_var_use_lazy_5_0)
	...
	MR_np_call_localret_ent(map__lookup_3_0,
		fn__mdprof_fb__automatic_parallelism__autopar_costs__compute_var_use_lazy_5_0_i2);
MR_def_label(fn__mdprof_fb__automatic_parallelism__autopar_costs__compute_var_use_lazy_5_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_sv(6);
	...
	MR_np_call_localret_ent(analysis_utils__cost_and_callees_is_recursive_2_0,
		fn__mdprof_fb__automatic_parallelism__autopar_costs__compute_var_use_lazy_5_0_i4);
MR_def_label(fn__mdprof_fb__automatic_parallelism__autopar_costs__compute_var_use_lazy_5_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(fn__mdprof_fb__automatic_parallelism__autopar_costs__compute_var_use_lazy_5_0_i3);
	}
	MR_r1 = MR_sv(7);
	...
	MR_np_call_localret_ent(map__search_3_0,
		fn__mdprof_fb__automatic_parallelism__autopar_costs__compute_var_use_lazy_5_0_i6);
MR_def_label(fn__mdprof_fb__automatic_parallelism__autopar_costs__compute_var_use_lazy_5_0,6)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(fn__mdprof_fb__automatic_parallelism__autopar_costs__compute_var_use_lazy_5_0_i3);
	}
	...
	MR_r2 = MR_tempr1;
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(var_use_analysis, var_use_info);
	MR_GOTO_LAB(fn__mdprof_fb__automatic_parallelism__autopar_costs__compute_var_use_lazy_5_0_i10);
	}
...
MR_def_label(fn__mdprof_fb__automatic_parallelism__autopar_costs__compute_var_use_lazy_5_0,10)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(1) = MR_r1;
	MR_np_call_localret_ent(solutions__solutions_2_0,
		fn__mdprof_fb__automatic_parallelism__autopar_costs__compute_var_use_lazy_5_0_i11);
MR_def_label(fn__mdprof_fb__automatic_parallelism__autopar_costs__compute_var_use_lazy_5_0,11)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_sv(5),1)) {
		MR_GOTO_LAB(fn__mdprof_fb__automatic_parallelism__autopar_costs__compute_var_use_lazy_5_0_i13);
	}
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
...
MR_def_label(fn__mdprof_fb__automatic_parallelism__autopar_costs__compute_var_use_lazy_5_0,13)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_tfield(1, MR_r1, 1);
	if (MR_LTAGS_TESTR(MR_tempr1,0,0)) {
		MR_GOTO_LAB(fn__mdprof_fb__automatic_parallelism__autopar_costs__compute_var_use_lazy_5_0_i17);
	}
	MR_r1 = MR_tfield(1, MR_r1, 0);
	MR_decr_sp_and_return(8);
	}
MR_def_label(fn__mdprof_fb__automatic_parallelism__autopar_costs__compute_var_use_lazy_5_0,17)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_def_static(mdprof_fb__automatic_parallelism__autopar_costs__compute_var_use_lazy_arg_7_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_mkframe("pred mdprof_fb.automatic_parallelism.autopar_costs.compute_var_use_lazy_arg/7-0", 9,
		MR_ENTRY(MR_do_fail));
	MR_fv(1) = MR_r1;
	MR_fv(7) = MR_r2;
	MR_fv(4) = MR_r3;
...
MR_def_label(mdprof_fb__automatic_parallelism__autopar_costs__compute_var_use_lazy_arg_7_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (((MR_Float) 0.0000000000000000 >= MR_f(1))) {
...
MR_def_label(mdprof_fb__automatic_parallelism__autopar_costs__compute_var_use_lazy_arg_7_0,13)
	...
	MR_r4 = MR_tempr1;
	MR_r5 = MR_fv(3);
	MR_f(1) = MR_float_from_dword_ptr(&MR_fv(6));
	MR_r6 = MR_fv(9);
	}
...
MR_def_label(mdprof_fb__automatic_parallelism__autopar_costs__compute_var_use_lazy_arg_7_0,4)
	...
	* (MR_Float *) &(MR_tfield(0, MR_r1, 0)) = (MR_Float) 0.0000000000000000;
	...
	MR_Word MR_tempr1, MR_tempr2;
	MR_Float MR_tempf1;
	MR_tempf1 = MR_float_from_dword_ptr(&MR_fv(6));
...
void mercury__mdprof_fb__automatic_parallelism__autopar_costs__write_out_proc_statics(FILE *deep_fp, FILE *procrep_fp)
{
	MR_write_out_module_proc_reps_start(procrep_fp, &mercury_data__module_layout__mdprof_fb__automatic_parallelism__autopar_costs);
