...
{
  {
    ...
    else
    {
      ...
      packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), CostAndCallee_14, (MR_Integer) 3)));
    }
...
{
  {
    ...
    if (succeeded)
    {
      ...
      if ((ArgNums_16 == (MR_Word) ((MR_Unsigned) 0U)))
      {
        ...
        if (succeeded)
        {
...

          {
            ...
            MR_hl_field(MR_mktag(0), Var_29, 2) = (MR_Box) ((MR_Unsigned) (VarUseType_13));
          }
          {
            MR_Word base;
      ...
      else
      {
        ...
        MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), CostAndCallee_11, (MR_Integer) 3)));
          ...
          case (MR_Integer) 0:
            {
              ...
              MR_Unsigned packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), CostAndCallee_11, (MR_Integer) 3)));
  ...
  MR_Word * HeadVar__3_3)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), CurEarliest_1, (MR_Integer) 2)));
      MR_Unsigned packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), HeadVarUse_6, (MR_Integer) 2)));
...
{
  {
    ...
    MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Var_18, (MR_Integer) 1)));
      ...
      case (MR_Integer) 0:
        {
          ...
          {
            MR_Unsigned packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Var_29, (MR_Integer) 0)));
...
{
  {
    ...
    if ((IsCall_14 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(0), Var_22, 2) = (MR_Box) ((MR_Unsigned) (VarUseType_11));
      }
...
{
  {
    ...
    MR_Word Var_16;
    MR_Word Var_17;
    MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Cond_5, (MR_Integer) 1)));
    ...
    packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Var_15, (MR_Integer) 5)));
    packed_args_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Then_6, (MR_Integer) 1)));
    Var_16 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Then_6, (MR_Integer) 2))));
    ThenCost_10 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_16, (MR_Integer) 4))));
    packed_args_3 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Var_16, (MR_Integer) 5)));
    packed_args_4 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Else_7, (MR_Integer) 1)));
    Var_17 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Else_7, (MR_Integer) 2))));
    ElseCost_11 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_17, (MR_Integer) 4))));
    packed_args_5 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Var_17, (MR_Integer) 5)));
...
{
  {
    ...
    else
    {
      ...
      else
      {
        ...
        packed_args_3 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Var_17, (MR_Integer) 5)));
...
{
  {
    ...
    else
    {
      ...
      MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Disjunct_5, (MR_Integer) 1)));
      MR_Unsigned packed_args_1;
      ...
      else
      {
        ...
        packed_args_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Disjunct_5, (MR_Integer) 1)));
        ...
        packed_args_3 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Var_14, (MR_Integer) 5)));
...
{
  {
    ...
    else
    {
      ...
      packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Var_18, (MR_Integer) 5)));
      ...
      else
      {
        ...
        packed_args_3 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Var_19, (MR_Integer) 5)));
...
{
  {
    ...
    else
    {
      ...
      MR_Word Var_14;
      MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Conjunct_5, (MR_Integer) 1)));
      MR_Unsigned packed_args_1;
      MR_Unsigned packed_args_2;
      MR_Unsigned packed_args_3;
      ...
      packed_args_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Conjunct_5, (MR_Integer) 1)));
