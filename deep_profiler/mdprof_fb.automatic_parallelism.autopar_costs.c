  ...
  MR_Word VarUseType_11)
{
  ...
  if (succeeded)
  {
    ...
    TypeCtorInfo__71_71 = (MR_Word) (&measurements__measurements__type_ctor_info_cs_cost_csq_0);
    succeeded = mercury__map__search_3_p_0((MR_Word) (&mdbcomp__goal_path__mdbcomp__goal_path__type_ctor_info_reverse_goal_path_0), TypeCtorInfo__71_71, Var_24, ((MR_Box) (RevGoalPath_8)), &conv1_RecCost_15);
    if (succeeded)
    {
  ...
  if (succeeded)
  {
    ...
    if ((ArgNums_16 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      ...
      else
      {
        ...
        Var_33 = mercury__string__f_43_43_2_f_0((MR_String) "Var use type most be consumption if ", (MR_String) "\\+ member(Var, Args)");
        {
          mercury__require__unexpected_2_p_0((MR_String) "predicate \140mdprof_fb.automatic_parallelism.autopar_costs.compute_var_use_lazy_arg\'/7", Var_33);
          return;
        }
      }
    }
        ...
        case (MR_Integer) 0:
          {
            ...
            MR_Word Var_36 = ((MR_Word) ((MR_hl_field(MR_mktag(0), CostAndCallee_11, (MR_Integer) 2))));
            MR_Box conv0_CalleePrime_21;

            succeeded = mercury__set__is_singleton_2_p_0((MR_Word) (&analysis_utils__analysis_utils__type_ctor_info_callee_0), Var_36, &conv0_CalleePrime_21);
            if (succeeded)
            {
            ...
            mdprof_fb__automatic_parallelism__autopar_costs__recursion_type_get_interesting_parallelisation_depth_2_p_1(RecursionType_24, &MaybeCurDepth_25);
            {
              ...
              MR_hl_field(MR_mktag(0), Var_39, 0) = ((MR_Box) (&mdprof_fb__automatic_parallelism__autopar_costs_scalar_common_3[0]));
              MR_hl_field(MR_mktag(0), Var_39, 1) = ((MR_Box) (mdprof_fb__automatic_parallelism__autopar_costs__compute_var_use_lazy_arg_7_p_0_1));
              MR_hl_field(MR_mktag(0), Var_39, 2) = ((MR_Box) ((MR_Integer) 6));
              MR_hl_field(MR_mktag(0), Var_39, 3) = ((MR_Box) (Info_8));
              MR_hl_field(MR_mktag(0), Var_39, 4) = ((MR_Box) (RecursionType_24));
              MR_hl_field(MR_mktag(0), Var_39, 5) = ((MR_Box) (MaybeCurDepth_25));
              MR_hl_field(MR_mktag(0), Var_39, 6) = ((MR_Box) (VarUseType_13));
              MR_hl_field(MR_mktag(0), Var_39, 7) = MR_box_float(CostPercall_15);
              MR_hl_field(MR_mktag(0), Var_39, 8) = ((MR_Box) (CSDPtr_23));
            }
            mercury__list__map_3_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0), (MR_Word) (&var_use_analysis__var_use_analysis__type_ctor_info_var_use_info_0), Var_39, ArgNums_16, &Uses0_26);
