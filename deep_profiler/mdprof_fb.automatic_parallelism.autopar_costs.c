...
{
  {
    ...
    mercury__map__lookup_3_p_0((MR_Word) (&mdbcomp__goal_path__mdbcomp__goal_path__type_ctor_info_reverse_goal_path_0), (MR_Word) (&mdprof_fb__automatic_parallelism__autopar_costs_scalar_common_1[1]), Var_39, ((MR_Box) (RevGoalPath_8)), &conv0_CostAndCallee_14);
    ...
    if (succeeded)
    {
      ...
      succeeded = mercury__map__search_3_p_0((MR_Word) (&mdbcomp__goal_path__mdbcomp__goal_path__type_ctor_info_reverse_goal_path_0), TypeCtorInfo_74_74, Var_24, ((MR_Box) (RevGoalPath_8)), &conv1_RecCost_15);
      if (succeeded)
      {
          ...
          case (MR_Integer) 0:
            {
              ...
              mercury__list__map_3_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0), (MR_Word) (&var_use_analysis__var_use_analysis__type_ctor_info_var_use_info_0), Var_41, ArgNums_16, &Uses0_26);
