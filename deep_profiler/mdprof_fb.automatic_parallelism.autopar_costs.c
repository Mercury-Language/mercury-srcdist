...
{
  {
    ...
    switch (VarUseType_11) {
      ...
      case (MR_Integer) 1:
        if ((Uses_17 == (MR_Word) ((MR_Integer) 0)))
        {
...
{
  {
    ...
    if (succeeded)
    {
      ...
      if ((ArgNums_16 == (MR_Word) ((MR_Integer) 0)))
      {
  ...
  MR_Word * MaybeDepth_4)
{
  switch (MR_tag((MR_Word) RecursionType_3)) {
    ...
    case (MR_Integer) 1:
      ...
      break;
    case (MR_Integer) 2:
      *MaybeDepth_4 = (MR_Word) ((MR_Integer) 0);
      break;
    case (MR_Integer) 3:
      *MaybeDepth_4 = (MR_Word) ((MR_Integer) 0);
      break;
...
mdprof_fb__automatic_parallelism__autopar_costs__recursion_type_get_interesting_parallelisation_depth_2_p_0(
  ...
  MR_Word * MaybeDepth_4)
{
  if ((RecursionType_3 == (MR_Word) ((MR_Integer) 0)))
  {
    MR_Word Var_17;
...
{
  {
    ...
    switch (IntermoduleVarUse_5) {
      ...
      case (MR_Integer) 0:
        ...
        break;
      case (MR_Integer) 1:
        *FollowCallsAcrossModules_4 = (MR_Word) ((MR_Integer) 0);
        break;
    }
  }
}
...
{
  {
    ...
    if ((IsCall_14 == (MR_Word) ((MR_Integer) 0)))
    {
