  ...
  MR_String * String_4)
{
  if (((MR_tag((MR_Word) ProcLabel_3)) == (MR_mktag((MR_Integer) 0))))
  {
    ...
    mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&program_representation_utils_scalar_common_5[0]), Mode_10, &Var_68);
    Var_76 = mercury__string__f_43_43_2_f_0((MR_String) "-", Var_68);
    mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&program_representation_utils_scalar_common_5[0]), Arity_9, &Var_77);
  ...
  else
  {
    ...
    mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&program_representation_utils_scalar_common_5[0]), Mode_42, &Var_43);
    Var_51 = mercury__string__f_43_43_2_f_0((MR_String) "-", Var_43);
    mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&program_representation_utils_scalar_common_5[0]), Arity_41, &Var_52);
