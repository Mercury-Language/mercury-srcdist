...
{
  {
    ...
    if (program_representation_utils__succeeded)
      *program_representation_utils__HeadVar__1_1 = (MR_Integer) 0;
      ...
      {
        MR_Word program_representation_utils__Var_4 = ((MR_Word) (MR_hl_field(MR_mktag(0), program_representation_utils__HeadVar__2_2, (MR_Integer) 0)));
        MR_Word program_representation_utils__Var_5 = ((MR_Word) (MR_hl_field(MR_mktag(0), program_representation_utils__HeadVar__2_2, (MR_Integer) 1)));
        MR_Word program_representation_utils__Var_6 = ((MR_Word) (MR_hl_field(MR_mktag(0), program_representation_utils__HeadVar__3_3, (MR_Integer) 0)));
        MR_Word program_representation_utils__Var_7 = ((MR_Word) (MR_hl_field(MR_mktag(0), program_representation_utils__HeadVar__3_3, (MR_Integer) 1)));
        MR_Word program_representation_utils__Var_8;

        {
          mercury__private_builtin__builtin_compare_pred_3_p_0(&program_representation_utils__Var_8, (MR_Word) program_representation_utils__Var_4, (MR_Word) program_representation_utils__Var_6);
        }
        ...
        if (program_representation_utils__succeeded)
          *program_representation_utils__HeadVar__1_1 = program_representation_utils__Var_8;
          ...
          {
            {
              mercury__builtin__compare_3_p_0((MR_Word) &program_representation_utils_scalar_common_2[3], program_representation_utils__HeadVar__1_1, ((MR_Box) (program_representation_utils__Var_5)), ((MR_Box) (program_representation_utils__Var_7)));
            }
          }
      }
  }
...
{
  {
    ...
    if (program_representation_utils__succeeded)
    ...
    else
      {
        ...
        MR_Word program_representation_utils__Var_3 = ((MR_Word) (MR_hl_field(MR_mktag(0), program_representation_utils__HeadVar__1_1, (MR_Integer) 0)));
        MR_Word program_representation_utils__Var_4 = ((MR_Word) (MR_hl_field(MR_mktag(0), program_representation_utils__HeadVar__1_1, (MR_Integer) 1)));
        MR_Word program_representation_utils__Var_5 = ((MR_Word) (MR_hl_field(MR_mktag(0), program_representation_utils__HeadVar__2_2, (MR_Integer) 0)));
        MR_Word program_representation_utils__Var_6 = ((MR_Word) (MR_hl_field(MR_mktag(0), program_representation_utils__HeadVar__2_2, (MR_Integer) 1)));

        {
          program_representation_utils__succeeded = mercury__private_builtin__builtin_unify_pred_2_p_0((MR_Word) program_representation_utils__Var_3, (MR_Word) program_representation_utils__Var_5);
        }
        if (program_representation_utils__succeeded)
          {
            program_representation_utils__TypeInfo_11_11 = (MR_Word) &program_representation_utils_scalar_common_2[3];
            {
              program_representation_utils__succeeded = mercury__builtin__unify_2_p_0(program_representation_utils__TypeInfo_11_11, ((MR_Box) (program_representation_utils__Var_4)), ((MR_Box) (program_representation_utils__Var_6)));
            }
          }
      }
    return program_representation_utils__succeeded;
...
{
  {
    ...
    if (program_representation_utils__succeeded)
      *program_representation_utils__HeadVar__1_1 = (MR_Integer) 0;
      ...
      {
        MR_Word program_representation_utils__Var_4 = (MR_Word) program_representation_utils__HeadVar__2_2;
        MR_Word program_representation_utils__Var_5 = (MR_Word) program_representation_utils__HeadVar__3_3;

        {
          mercury__builtin__compare_3_p_0((MR_Word) &program_representation_utils_scalar_common_1[3], program_representation_utils__HeadVar__1_1, ((MR_Box) (program_representation_utils__Var_4)), ((MR_Box) (program_representation_utils__Var_5)));
        }
      }
  }
}
...
{
  {
    ...
    if (program_representation_utils__succeeded)
      ...
      {
        MR_Word program_representation_utils__Var_3 = (MR_Word) program_representation_utils__HeadVar__1_1;
        MR_Word program_representation_utils__Var_4 = (MR_Word) program_representation_utils__HeadVar__2_2;

        {
          program_representation_utils__succeeded = mercury__builtin__unify_2_p_0((MR_Word) &program_representation_utils_scalar_common_1[3], ((MR_Box) (program_representation_utils__Var_3)), ((MR_Box) (program_representation_utils__Var_4)));
        }
      }
    return program_representation_utils__succeeded;
  }
    ...
    if (program_representation_utils__succeeded)
      *program_representation_utils__HeadVar__1_1 = (MR_Integer) 0;
    else
      {
        ...
        {
          mercury__builtin__compare_3_p_0((MR_Word) &program_representation_utils_scalar_common_2[1], &program_representation_utils__Var_8, ((MR_Box) (program_representation_utils__Var_4)), ((MR_Box) (program_representation_utils__Var_6)));
        }
        program_representation_utils__succeeded = (program_representation_utils__Var_8 == (MR_Integer) 0);
        program_representation_utils__succeeded = !(program_representation_utils__succeeded);
        if (program_representation_utils__succeeded)
          *program_representation_utils__HeadVar__1_1 = program_representation_utils__Var_8;
          ...
          {
            {
              mercury__builtin__compare_3_p_0((MR_Word) &program_representation_utils_scalar_common_2[2], program_representation_utils__HeadVar__1_1, ((MR_Box) (program_representation_utils__Var_5)), ((MR_Box) (program_representation_utils__Var_7)));
            }
          }
      }
  }
...
{
  {
    ...
    if (program_representation_utils__succeeded)
    ...
    else
      {
        ...
        {
          program_representation_utils__succeeded = mercury__builtin__unify_2_p_0((MR_Word) &program_representation_utils_scalar_common_2[1], ((MR_Box) (program_representation_utils__Var_3)), ((MR_Box) (program_representation_utils__Var_5)));
        }
        if (program_representation_utils__succeeded)
          {
            program_representation_utils__TypeInfo_10_10 = (MR_Word) &program_representation_utils_scalar_common_2[2];
            {
              program_representation_utils__succeeded = mercury__builtin__unify_2_p_0(program_representation_utils__TypeInfo_10_10, ((MR_Box) (program_representation_utils__Var_4)), ((MR_Box) (program_representation_utils__Var_6)));
            }
          }
      }
    return program_representation_utils__succeeded;
    ...
    else
      {
        ...
        if ((program_representation_utils__HeadVar__3_3 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
          *program_representation_utils__HeadVar__1_1 = (MR_Integer) 1;
          ...
          {
            MR_Word program_representation_utils__Var_5 = ((MR_Word) (MR_hl_field(MR_mktag(1), program_representation_utils__HeadVar__3_3, (MR_Integer) 0)));

            {
              mercury__builtin__compare_3_p_0((MR_Word) &program_representation_utils_scalar_common_1[8], program_representation_utils__HeadVar__1_1, ((MR_Box) (program_representation_utils__Var_11)), ((MR_Box) (program_representation_utils__Var_5)));
            }
          }
      }
  }
...
{
  {
    ...
    if ((program_representation_utils__HeadVar__1_1 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
    ...
    else
      {
        ...
        MR_Word program_representation_utils__Var_3 = ((MR_Word) (MR_hl_field(MR_mktag(1), program_representation_utils__HeadVar__1_1, (MR_Integer) 0)));
        ...
        if (program_representation_utils__succeeded)
          {
            program_representation_utils__Var_4 = ((MR_Word) (MR_hl_field(MR_mktag(1), program_representation_utils__HeadVar__2_2, (MR_Integer) 0)));
            program_representation_utils__TypeInfo_9_9 = (MR_Word) &program_representation_utils_scalar_common_1[8];
            {
              program_representation_utils__succeeded = mercury__builtin__unify_2_p_0(program_representation_utils__TypeInfo_9_9, ((MR_Box) (program_representation_utils__Var_3)), ((MR_Box) (program_representation_utils__Var_4)));
            }
          }
      }
    return program_representation_utils__succeeded;
      ...
      case (MR_Integer) 0:
        {
...

          {
            ...
            MR_hl_field(MR_mktag(0), program_representation_utils__Var_82, 0) = ((MR_Box) (&program_representation_utils_scalar_common_11[0]));
            ...
            MR_hl_field(MR_mktag(0), program_representation_utils__Var_82, 4) = ((MR_Box) (&program_representation_utils_scalar_common_2[19]));
      ...
      case (MR_Integer) 1:
        {
...

          {
            ...
            MR_hl_field(MR_mktag(0), program_representation_utils__Var_75, 0) = ((MR_Box) (&program_representation_utils_scalar_common_11[0]));
            ...
            MR_hl_field(MR_mktag(0), program_representation_utils__Var_75, 4) = ((MR_Box) (&program_representation_utils_scalar_common_2[20]));
      ...
      case (MR_Integer) 2:
        {
...

          {
            ...
            MR_hl_field(MR_mktag(0), program_representation_utils__Var_71, 0) = ((MR_Box) (&program_representation_utils_scalar_common_12[0]));
          ...
          case (MR_Integer) 6:
            {
              ...
              {
                mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) &program_representation_utils_scalar_common_8[0], program_representation_utils__MethodNumber_26, &program_representation_utils__Var_262);
              }
              {
...
{
  {
    ...
    {
      mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) &program_representation_utils_scalar_common_8[0], program_representation_utils__Arity_8, &program_representation_utils__Var_19);
    }
    {
    ...
    if ((program_representation_utils__HeadVar__5_5 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
    ...
    else
      {
        ...
        program_representation_utils__Var_36 = (program_representation_utils__HeadVar__2_2 + (MR_Integer) 1);
        {
          ...
          MR_hl_field(MR_mktag(0), program_representation_utils__Var_35, 0) = ((MR_Box) (&program_representation_utils_scalar_common_3[7]));
...
{
  {
    ...
    {
      program_representation_utils__Var_12 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), program_representation_utils__Var_12, 0) = ((MR_Box) (&program_representation_utils_scalar_common_6[1]));
...
{
  {
    ...
    {
      program_representation_utils__Var_12 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), program_representation_utils__Var_12, 0) = ((MR_Box) (&program_representation_utils_scalar_common_9[0]));
...
{
  {
    ...
    {
      mercury__list__foldl_4_p_0((MR_Word) &mdbcomp__program_representation__mdbcomp__program_representation__type_ctor_info_head_var_rep_0, (MR_Word) &program_representation_utils__program_representation_utils__type_ctor_info_inst_map_0, (MR_Word) &program_representation_utils_scalar_common_2[8], program_representation_utils__HeadVars_5, ((MR_Box) (program_representation_utils__Var_7)), &program_representation_utils__conv1_InstMap_4);
    }
    ...
    if (program_representation_utils__succeeded)
    ...
    else
      {
...

        {
          ...
          MR_hl_field(MR_mktag(0), program_representation_utils__Var_158, 0) = ((MR_Box) (&program_representation_utils_scalar_common_3[2]));
    ...
    if (((MR_tag((MR_Word) program_representation_utils__ProcLabel_3)) == (MR_mktag((MR_Integer) 0))))
      {
        ...
        program_representation_utils__Var_74 = (MR_Word) &program_representation_utils_scalar_common_8[0];
        {
    ...
    else
      {
        ...
        MR_Word program_representation_utils__Var_49 = (MR_Word) &program_representation_utils_scalar_common_8[0];
...
{
  {
...

    {
      ...
      MR_hl_field(MR_mktag(0), program_representation_utils__Var_5, 0) = ((MR_Box) (&program_representation_utils_scalar_common_3[1]));
      ...
      *program_representation_utils__Strings_4 = program_representation_utils__MainStrings_28;
    else
      {
...

        {
          ...
          MR_hl_field(MR_mktag(0), program_representation_utils__Var_45, 0) = ((MR_Box) (&program_representation_utils_scalar_common_6[0]));
      ...
      *program_representation_utils__Strings_6 = program_representation_utils__MainStrings_24;
    else
      {
...

        {
          ...
          MR_hl_field(MR_mktag(0), program_representation_utils__Var_41, 0) = ((MR_Box) (&program_representation_utils_scalar_common_6[0]));
