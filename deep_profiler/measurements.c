      ...
      case (MR_Integer) 2:
        {
          ...
          {
            Cost_13 = (MR_Word) MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL);
              ...
              case (MR_Integer) 2:
                {
                  ...
                  {
                    Cost_23 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
            ...
            case (MR_Integer) 2:
              {
                ...
                {
                  Cost_16 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
            ...
            case (MR_Integer) 2:
              {
                ...
                {
                  Cost_30 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
