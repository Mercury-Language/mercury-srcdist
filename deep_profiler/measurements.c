...
MR_decl_label8(fn__measurements__add_inherit_to_own_2_0, 3,4,5,6,7,8,2,13)
MR_decl_label2(fn__measurements__add_inherit_to_own_2_0, 14,15)
MR_decl_label4(fn__measurements__add_own_to_inherit_2_0, 3,5,7,9)
MR_decl_label8(fn__measurements__add_own_to_own_2_0, 5,6,12,13,14,15,16,17)
MR_decl_label8(fn__measurements__add_own_to_own_2_0, 11,22,23,24,25,26,27,28)
MR_decl_label4(fn__measurements__add_own_to_own_2_0, 29,30,31,32)
...
MR_decl_label8(fn__measurements__own_to_string_1_0, 3,4,5,6,7,8,9,10)
MR_decl_label8(fn__measurements__own_to_string_1_0, 11,12,13,14,15,16,17,18)
MR_decl_label8(fn__measurements__own_to_string_1_0, 19,20,21,22,23,24,25,26)
MR_decl_label8(fn__measurements__own_to_string_1_0, 28,29,30,31,32,33,34,35)
MR_decl_label8(fn__measurements__own_to_string_1_0, 36,37,38,39,40,41,42,44)
MR_decl_label8(fn__measurements__own_to_string_1_0, 45,46,47,48,49,50,51,52)
MR_decl_label8(fn__measurements__own_to_string_1_0, 53,54,57,58,59,60,61,62)
MR_decl_label3(fn__measurements__own_to_string_1_0, 63,64,65)
...
MR_decl_label8(__Compare___measurements__own_prof_info_0_0, 3,5,9,13,17,21,25,29)
MR_decl_label8(__Compare___measurements__own_prof_info_0_0, 33,51,54,56,60,64,68,82)
MR_decl_label8(__Compare___measurements__own_prof_info_0_0, 86,88,92,96,103,108,112,113)
MR_decl_label3(__Compare___measurements__own_prof_info_0_0, 115,119,250)
...
MR_define_entry(mercury__fn__measurements__add_inherit_to_inherit_2_0);
	...
	MR_tempr2 = MR_r1;
	MR_tempr3 = MR_r2;
	MR_tfield(0, MR_tempr1, 0) = ((MR_Integer) MR_ctfield(0, MR_tempr2, 0) + (MR_Integer) MR_ctfield(0, MR_tempr3, 0));
...
MR_def_label(fn__measurements__add_own_to_inherit_2_0,3)
	...
	MR_tempr2 = MR_r1;
	MR_tempr3 = MR_r2;
	MR_tfield(0, MR_tempr1, 0) = ((MR_Integer) MR_ctfield(0, MR_tempr2, 4) + (MR_Integer) MR_ctfield(0, MR_tempr3, 0));
	MR_tfield(0, MR_tempr1, 1) = ((MR_Integer) MR_ctfield(0, MR_tempr2, 5) + (MR_Integer) MR_ctfield(0, MR_tempr3, 1));
	MR_tfield(0, MR_tempr1, 2) = ((MR_Integer) MR_ctfield(0, MR_tempr2, 6) + (MR_Integer) MR_ctfield(0, MR_tempr3, 2));
	MR_tfield(0, MR_tempr1, 3) = ((MR_Integer) MR_ctfield(0, MR_tempr2, 7) + (MR_Integer) MR_ctfield(0, MR_tempr3, 3));
	MR_r1 = MR_tempr1;
	MR_proceed();
	}
MR_def_label(fn__measurements__add_own_to_inherit_2_0,5)
	...
	MR_tempr2 = MR_r1;
	MR_tempr3 = MR_r2;
	MR_tfield(0, MR_tempr1, 0) = ((MR_Integer) MR_ctfield(1, MR_tempr2, 1) + (MR_Integer) MR_ctfield(0, MR_tempr3, 0));
	MR_tfield(0, MR_tempr1, 1) = ((MR_Integer) MR_ctfield(1, MR_tempr2, 2) + (MR_Integer) MR_ctfield(0, MR_tempr3, 1));
	MR_tfield(0, MR_tempr1, 2) = ((MR_Integer) MR_ctfield(1, MR_tempr2, 3) + (MR_Integer) MR_ctfield(0, MR_tempr3, 2));
	MR_tfield(0, MR_tempr1, 3) = ((MR_Integer) MR_ctfield(1, MR_tempr2, 4) + (MR_Integer) MR_ctfield(0, MR_tempr3, 3));
	MR_r1 = MR_tempr1;
	MR_proceed();
	}
MR_def_label(fn__measurements__add_own_to_inherit_2_0,7)
	...
	MR_tempr3 = MR_r1;
	MR_tfield(0, MR_tempr1, 1) = ((MR_Integer) MR_ctfield(2, MR_tempr3, 1) + (MR_Integer) MR_ctfield(0, MR_tempr2, 1));
	MR_tfield(0, MR_tempr1, 2) = ((MR_Integer) MR_ctfield(2, MR_tempr3, 2) + (MR_Integer) MR_ctfield(0, MR_tempr2, 2));
	MR_tfield(0, MR_tempr1, 3) = ((MR_Integer) MR_ctfield(2, MR_tempr3, 3) + (MR_Integer) MR_ctfield(0, MR_tempr2, 3));
	MR_r1 = MR_tempr1;
	MR_proceed();
	}
...
MR_def_label(fn__measurements__subtract_own_from_inherit_2_0,3)
	...
	MR_tempr2 = MR_r2;
	MR_tempr3 = MR_r1;
	MR_tfield(0, MR_tempr1, 0) = ((MR_Integer) MR_ctfield(0, MR_tempr2, 0) - (MR_Integer) MR_ctfield(0, MR_tempr3, 4));
	MR_tfield(0, MR_tempr1, 1) = ((MR_Integer) MR_ctfield(0, MR_tempr2, 1) - (MR_Integer) MR_ctfield(0, MR_tempr3, 5));
	MR_tfield(0, MR_tempr1, 2) = ((MR_Integer) MR_ctfield(0, MR_tempr2, 2) - (MR_Integer) MR_ctfield(0, MR_tempr3, 6));
	MR_tfield(0, MR_tempr1, 3) = ((MR_Integer) MR_ctfield(0, MR_tempr2, 3) - (MR_Integer) MR_ctfield(0, MR_tempr3, 7));
	MR_r1 = MR_tempr1;
	MR_proceed();
	}
MR_def_label(fn__measurements__subtract_own_from_inherit_2_0,5)
	...
	MR_tempr2 = MR_r2;
	MR_tempr3 = MR_r1;
	MR_tfield(0, MR_tempr1, 0) = ((MR_Integer) MR_ctfield(0, MR_tempr2, 0) - (MR_Integer) MR_ctfield(1, MR_tempr3, 1));
	MR_tfield(0, MR_tempr1, 1) = ((MR_Integer) MR_ctfield(0, MR_tempr2, 1) - (MR_Integer) MR_ctfield(1, MR_tempr3, 2));
	MR_tfield(0, MR_tempr1, 2) = ((MR_Integer) MR_ctfield(0, MR_tempr2, 2) - (MR_Integer) MR_ctfield(1, MR_tempr3, 3));
	MR_tfield(0, MR_tempr1, 3) = ((MR_Integer) MR_ctfield(0, MR_tempr2, 3) - (MR_Integer) MR_ctfield(1, MR_tempr3, 4));
	MR_r1 = MR_tempr1;
	MR_proceed();
	}
MR_def_label(fn__measurements__subtract_own_from_inherit_2_0,7)
	...
	MR_tempr3 = MR_r1;
	MR_tfield(0, MR_tempr1, 1) = ((MR_Integer) MR_ctfield(0, MR_tempr2, 1) - (MR_Integer) MR_ctfield(2, MR_tempr3, 1));
	MR_tfield(0, MR_tempr1, 2) = ((MR_Integer) MR_ctfield(0, MR_tempr2, 2) - (MR_Integer) MR_ctfield(2, MR_tempr3, 2));
	MR_tfield(0, MR_tempr1, 3) = ((MR_Integer) MR_ctfield(0, MR_tempr2, 3) - (MR_Integer) MR_ctfield(2, MR_tempr3, 3));
	MR_r1 = MR_tempr1;
	MR_proceed();
	}
...
MR_BEGIN_MODULE(measurements_module22)
	...
	MR_init_label8(fn__measurements__add_inherit_to_own_2_0,3,4,5,6,7,8,2,13)
	MR_init_label2(fn__measurements__add_inherit_to_own_2_0,14,15)
MR_BEGIN_CODE
...
MR_def_label(fn__measurements__add_inherit_to_own_2_0,3)
	...
	MR_sv(7) = ((MR_Integer) MR_ctfield(0, MR_tempr1, 0) + (MR_Integer) MR_ctfield(0, MR_tempr2, 4));
...
MR_def_label(fn__measurements__add_inherit_to_own_2_0,4)
	...
	MR_sv(7) = ((MR_Integer) MR_ctfield(0, MR_tempr1, 0) + (MR_Integer) MR_ctfield(1, MR_tempr2, 1));
	MR_sv(8) = MR_ctfield(0, MR_tempr1, 1);
	MR_GOTO_LAB(fn__measurements__add_inherit_to_own_2_0_i2);
	}
...
MR_BEGIN_MODULE(measurements_module23)
	...
	MR_init_label8(fn__measurements__add_own_to_own_2_0,5,6,12,13,14,15,16,17)
	MR_init_label8(fn__measurements__add_own_to_own_2_0,11,22,23,24,25,26,27,28)
	MR_init_label4(fn__measurements__add_own_to_own_2_0,29,30,31,32)
MR_BEGIN_CODE
...
MR_def_label(fn__measurements__add_own_to_own_2_0,6)
	...
	MR_tempr1 = MR_r2;
	MR_r1 = MR_tempr1;
	MR_sv(3) = MR_const_mask_field(MR_tempr1, 0);
	MR_sv(4) = MR_const_mask_field(MR_tempr1, 1);
	MR_COMPUTED_GOTO((MR_Unsigned) MR_tag(MR_sv(1)),
		MR_LABEL_AP(fn__measurements__add_own_to_own_2_0_i12) MR_AND
		MR_LABEL_AP(fn__measurements__add_own_to_own_2_0_i13) MR_AND
		MR_LABEL_AP(fn__measurements__add_own_to_own_2_0_i14) MR_AND
...
MR_def_label(fn__measurements__add_own_to_own_2_0,13)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(3) = ((MR_Integer) MR_ctfield(1, MR_sv(1), 0) + (MR_Integer) MR_sv(3));
...
MR_def_label(fn__measurements__compress_profile_1_0,22)
	...
	MR_Word MR_tempr1, MR_tempr2;
	MR_tempr2 = MR_r1;
	MR_r2 = MR_ctfield(1, MR_tempr2, 4);
...
MR_def_label(fn__measurements__compress_profile_1_0,32)
	...
	MR_tfield(3, MR_tempr1, 1) = (MR_Integer) 0;
	MR_tfield(3, MR_tempr1, 2) = MR_ctfield(2, MR_tempr2, 1);
	MR_r1 = MR_tempr1;
	MR_proceed();
	}
...
MR_BEGIN_MODULE(measurements_module28)
	...
	MR_init_label8(fn__measurements__own_to_string_1_0,3,4,5,6,7,8,9,10)
	MR_init_label8(fn__measurements__own_to_string_1_0,11,12,13,14,15,16,17,18)
	MR_init_label8(fn__measurements__own_to_string_1_0,19,20,21,22,23,24,25,26)
	MR_init_label8(fn__measurements__own_to_string_1_0,28,29,30,31,32,33,34,35)
	MR_init_label8(fn__measurements__own_to_string_1_0,36,37,38,39,40,41,42,44)
	MR_init_label8(fn__measurements__own_to_string_1_0,45,46,47,48,49,50,51,52)
	MR_init_label8(fn__measurements__own_to_string_1_0,53,54,57,58,59,60,61,62)
	MR_init_label3(fn__measurements__own_to_string_1_0,63,64,65)
MR_BEGIN_CODE
...
MR_define_entry(mercury__fn__measurements__proc_cost_get_total_1_0);
	...
	MR_r1 = ((MR_Integer) MR_ctfield(0, MR_r1, 0) + (MR_Integer) MR_ctfield(0, MR_r1, 1));
	MR_np_call_localret_ent(fn__float__float_1_0,
...
MR_def_label(fn__measurements__proc_cost_get_total_1_0,2)
	...
	MR_r1 = MR_float_to_word((MR_word_to_float(MR_r1) * MR_word_to_float(MR_ctfield(0, MR_sv(1), 0))));
	MR_decr_sp_and_return(2);
...
MR_define_entry(mercury__fn__measurements__cs_cost_get_total_1_0);
	...
	MR_r1 = MR_float_to_word((MR_word_to_float(MR_ctfield(0, MR_r1, 0)) * MR_word_to_float(MR_ctfield(0, MR_tempr1, 0))));
	MR_proceed();
	}
...
MR_def_label(measurements__cs_cost_to_proc_cost_3_0,3)
	...
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 1);
	MR_tempr3 = MR_sv(1);
	MR_tfield(1, MR_tempr1, 0) = MR_float_to_word(((MR_word_to_float(MR_tempr3) * MR_word_to_float(MR_ctfield(0, MR_sv(2), 0))) - ((MR_Float) 1.0000000000000000 * MR_word_to_float(MR_tempr3))));
	MR_tag_alloc_heap(MR_tempr2, 0, (MR_Integer) 3);
	MR_tfield(0, MR_tempr2, 0) = MR_sv(4);
	MR_tfield(0, MR_tempr2, 1) = ((MR_Integer) MR_sv(3) - (MR_Integer) MR_r1);
	MR_tfield(0, MR_tempr2, 2) = MR_tempr1;
	MR_r1 = MR_tempr2;
...
MR_def_label(measurements__cs_cost_to_proc_cost_3_0,5)
	...
	MR_Word MR_tempr1, MR_tempr2;
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 1);
	MR_tfield(1, MR_tempr1, 0) = MR_float_to_word((MR_word_to_float(MR_ctfield(1, MR_sv(2), 0)) - ((MR_Float) 1.0000000000000000 * MR_word_to_float(MR_sv(1)))));
	MR_tag_alloc_heap(MR_tempr2, 0, (MR_Integer) 3);
	MR_tfield(0, MR_tempr2, 0) = MR_sv(4);
	MR_tfield(0, MR_tempr2, 1) = ((MR_Integer) MR_sv(3) - (MR_Integer) MR_r1);
	MR_tfield(0, MR_tempr2, 2) = MR_tempr1;
...
MR_def_label(__Unify___measurements__own_prof_info_0_0,9)
	...
	MR_r1 = MR_ctfield(2, MR_tempr2, 3);
...
MR_BEGIN_MODULE(measurements_module52)
	...
	MR_init_label8(__Compare___measurements__own_prof_info_0_0,3,5,9,13,17,21,25,29)
	MR_init_label8(__Compare___measurements__own_prof_info_0_0,33,51,54,56,60,64,68,82)
	MR_init_label8(__Compare___measurements__own_prof_info_0_0,86,88,92,96,103,108,112,113)
	MR_init_label3(__Compare___measurements__own_prof_info_0_0,115,119,250)
MR_BEGIN_CODE
