...
MR_decl_label4(measurements__weighted_average_3_0, 3,5,6,4)
...
MR_def_label(fn__measurements__build_cs_cost_csq_2_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_tag_alloc_heap(MR_r2, 1, (MR_Integer) 1);
	MR_tfield(1, MR_r2, 0) = MR_float_to_word(MR_float_from_dword_ptr(&MR_sv(2)));
	{
	MR_Word MR_tempr1;
...
MR_def_label(measurements__cs_cost_to_proc_cost_3_0,3)
	...
	MR_tfield(1, MR_r2, 0) = MR_float_to_word(((MR_tempf2 * MR_word_to_float(MR_tfield(0, MR_sv(3), 0))) - ((MR_Float) 1.0000000000000000 * MR_tempf2)));
...
MR_def_label(measurements__cs_cost_to_proc_cost_3_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_tag_alloc_heap(MR_r2, 1, (MR_Integer) 1);
	MR_tfield(1, MR_r2, 0) = MR_float_to_word((MR_word_to_float(MR_tfield(1, MR_sv(3), 0)) - ((MR_Float) 1.0000000000000000 * MR_float_from_dword_ptr(&MR_sv(2)))));
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 0, (MR_Integer) 3);
	MR_tfield(0, MR_tempr1, 0) = MR_sv(5);
...
MR_def_label(fn__measurements__cs_cost_per_proc_call_2_0,3)
	...
	* (MR_Float *) &MR_sv(6) = MR_word_to_float(MR_tfield(0, MR_sv(4), 0));
	MR_r1 = MR_sv(3);
	MR_np_call_localret_ent(fn__float__float_1_0,
...
MR_def_label(fn__measurements__cs_cost_per_proc_call_2_0,7)
	...
	MR_tfield(0, MR_r1, 0) = MR_float_to_word(MR_float_from_dword_ptr(&MR_sv(2)));
	MR_tfield(0, MR_r1, 1) = MR_r2;
	MR_decr_sp_and_return(7);
MR_def_label(fn__measurements__cs_cost_per_proc_call_2_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	* (MR_Float *) &MR_sv(2) = MR_word_to_float(MR_r1);
	* (MR_Float *) &MR_sv(6) = MR_word_to_float(MR_tfield(1, MR_sv(4), 0));
	MR_r1 = MR_sv(3);
	MR_np_call_localret_ent(fn__float__float_1_0,
...
MR_def_label(fn__measurements__call_goal_cost_1_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_tag_alloc_heap(MR_r2, 2, (MR_Integer) 2);
	MR_tfield(2, MR_r2, 0) = MR_tfield(0, MR_sv(1), 1);
	MR_tfield(2, MR_r2, 1) = MR_r1;
	MR_r1 = MR_r2;
	MR_decr_sp_and_return(2);
#ifdef MR_maybe_local_thread_engine_base
...
MR_def_label(fn__measurements__add_goal_costs_seq_2_0,11)
	...
	MR_r2 = MR_r1;
	MR_r1 = MR_sv(4);
	* (MR_Float *) &MR_sv(6) = (MR_word_to_float(MR_r2) * MR_word_to_float(MR_tfield(0, MR_sv(3), 0)));
	MR_np_call_localret_ent(fn__float__float_1_0,
		fn__measurements__add_goal_costs_seq_2_0_i14);
MR_def_label(fn__measurements__add_goal_costs_seq_2_0,13)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(4);
	* (MR_Float *) &MR_sv(6) = MR_word_to_float(MR_tfield(1, MR_sv(3), 0));
	MR_np_call_localret_ent(fn__float__float_1_0,
		fn__measurements__add_goal_costs_seq_2_0_i14);
MR_def_label(fn__measurements__add_goal_costs_seq_2_0,14)
	...
	MR_r4 = MR_tempr1;
	MR_tfield(1, MR_tempr1, 0) = MR_float_to_word((MR_float_from_dword_ptr(&MR_sv(6)) + (MR_word_to_float(MR_r1) * MR_word_to_float(MR_tfield(0, MR_sv(1), 0)))));
...
MR_def_label(fn__measurements__add_goal_costs_seq_2_0,16)
	...
	MR_Word MR_tempr1, MR_tempr2;
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 1);
	MR_tfield(1, MR_tempr1, 0) = MR_float_to_word((MR_float_from_dword_ptr(&MR_sv(6)) + MR_word_to_float(MR_tfield(1, MR_sv(1), 0))));
	MR_tag_alloc_heap(MR_tempr2, 2, (MR_Integer) 2);
	MR_tfield(2, MR_tempr2, 0) = MR_tempr1;
	MR_tfield(2, MR_tempr2, 1) = MR_sv(2);
	MR_r1 = MR_tempr2;
...
MR_def_label(fn__measurements__add_goal_costs_seq_2_0,30)
	...
	MR_tag_alloc_heap(MR_r2, 1, (MR_Integer) 1);
	MR_tfield(1, MR_r2, 0) = MR_float_to_word((MR_word_to_float(MR_r1) * MR_word_to_float(MR_tfield(0, MR_sv(1), 0))));
...
MR_def_label(fn__measurements__add_goal_costs_branch_3_0,18)
	...
	MR_r2 = MR_float_to_word((MR_float_from_dword_ptr(&MR_sv(5)) * MR_word_to_float(MR_tfield(0, MR_sv(2), 0))));
...
MR_def_label(fn__measurements__add_goal_costs_branch_3_0,19)
	...
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 1);
	MR_r4 = MR_tempr1;
	MR_tfield(1, MR_tempr1, 0) = MR_float_to_word((MR_word_to_float(MR_r2) + (MR_word_to_float(MR_r1) * MR_word_to_float(MR_tfield(0, MR_sv(3), 0)))));
	MR_tag_alloc_heap(MR_r1, 2, (MR_Integer) 2);
	MR_tfield(2, MR_r1, 0) = MR_tempr1;
	MR_tempr2 = MR_sv(7);
	MR_tempr3 = MR_sv(6);
	MR_tfield(2, MR_r1, 1) = ((MR_Integer) MR_tempr2 + (MR_Integer) MR_tempr3);
...
MR_def_label(fn__measurements__add_goal_costs_branch_3_0,22)
	...
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 1);
	MR_r4 = MR_tempr1;
	MR_tfield(1, MR_tempr1, 0) = MR_float_to_word((MR_word_to_float(MR_r2) + MR_word_to_float(MR_tfield(1, MR_sv(3), 0))));
	MR_tag_alloc_heap(MR_r1, 2, (MR_Integer) 2);
	MR_tfield(2, MR_r1, 0) = MR_tempr1;
	MR_tempr2 = MR_sv(7);
	MR_tempr3 = MR_sv(6);
...
MR_def_label(measurements__recursion_depth_descend_2_0,18)
	...
	MR_Word MR_tempr1, MR_tempr2;
	MR_tag_alloc_heap(MR_tempr1, 0, (MR_Integer) 1);
	MR_tfield(0, MR_tempr1, 0) = MR_float_to_word((MR_word_to_float(MR_r1) - (MR_Float) 1.0000000000000000));
...
MR_define_entry(mercury__fn__measurements__init_parallel_exec_metrics_incomplete_6_0);
	...
	MR_r4 = MR_tfield(0, MR_r1, 5);
	MR_r5 = MR_tfield(0, MR_r1, 4);
	MR_r8 = MR_tfield(0, MR_r1, 3);
	MR_r9 = MR_tfield(0, MR_r1, 2);
	MR_r10 = MR_tfield(0, MR_r1, 1);
	MR_r11 = MR_tfield(0, MR_r1, 0);
	if ((MR_word_to_float(MR_r6) != (MR_Float) 0.0000000000000000)) {
		MR_GOTO_LAB(fn__measurements__init_parallel_exec_metrics_incomplete_6_0_i5);
	}
	if ((MR_word_to_float(MR_r3) != (MR_Float) 0.0000000000000000)) {
		MR_GOTO_LAB(fn__measurements__init_parallel_exec_metrics_incomplete_6_0_i5);
	}
...
MR_def_label(fn__measurements__init_parallel_exec_metrics_incomplete_6_0,3)
	...
	MR_r8 = MR_tempr1;
	MR_tfield(1, MR_tempr1, 0) = MR_tfield(1, MR_r7, 0);
...
MR_def_label(fn__measurements__parallel_exec_metrics_internal_get_par_time_3_0,14)
	...
	* (MR_Float *) &MR_sv(4) = MR_word_to_float(MR_r2);
	...
	MR_sv(1) = MR_tempr1;
	MR_sv(2) = MR_tfield(1, MR_r1, 0);
	* (MR_Float *) &MR_sv(6) = (MR_word_to_float(MR_tfield(1, MR_r1, 4)) + MR_word_to_float(MR_tfield(1, MR_r1, 5)));
...
MR_def_label(fn__measurements__parallel_exec_metrics_internal_get_par_time_3_0,4)
	...
	* (MR_Float *) &MR_sv(4) = (MR_float_from_dword_ptr(&MR_sv(6)) + (MR_word_to_float(MR_tempr1) * MR_word_to_float(MR_r1)));
	MR_r1 = MR_sv(2);
	MR_r2 = MR_tempr1;
...
MR_def_label(fn__measurements__parallel_exec_metrics_internal_get_seq_time_1_0,4)
	...
	while (1) {
	MR_incr_sp(2);
	* (MR_Float *) &MR_sv(2) = MR_word_to_float(MR_tfield(1, MR_r1, 3));
	MR_r1 = MR_tfield(1, MR_r1, 0);
	if (MR_PTAG_TESTR(MR_r1,0))
		continue;
	MR_r1 = MR_tfield(0, MR_r1, 0);
...
MR_def_label(fn__measurements__parallel_exec_metrics_internal_get_seq_time_1_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	while (1) {
	MR_r1 = MR_float_to_word((MR_word_to_float(MR_r1) + MR_float_from_dword_ptr(&MR_sv(2))));
	MR_decr_sp(2);
...
MR_def_label(fn__measurements__pem_get_future_dead_time_1_0,4)
	...
	while (1) {
	MR_incr_sp(2);
	* (MR_Float *) &MR_sv(2) = MR_word_to_float(MR_tfield(1, MR_r1, 5));
	MR_r1 = MR_tfield(1, MR_r1, 0);
	if (MR_PTAG_TESTR(MR_r1,0))
		continue;
	MR_r1 = (MR_Word) &mercury_float_const_0pt0000000000000000;
...
MR_def_label(fn__measurements__pem_get_signal_costs_1_0,4)
	...
	while (1) {
	MR_incr_sp(2);
	* (MR_Float *) &MR_sv(2) = MR_word_to_float(MR_tfield(1, MR_r1, 1));
	MR_r1 = MR_tfield(1, MR_r1, 0);
	if (MR_PTAG_TESTR(MR_r1,0))
		continue;
	MR_r1 = MR_tfield(0, MR_r1, 2);
...
MR_def_label(fn__measurements__pem_get_wait_costs_1_0,4)
	...
	while (1) {
	MR_incr_sp(2);
	* (MR_Float *) &MR_sv(2) = MR_word_to_float(MR_tfield(1, MR_r1, 2));
	MR_r1 = MR_tfield(1, MR_r1, 0);
	if (MR_PTAG_TESTR(MR_r1,0))
		continue;
	MR_r1 = (MR_Word) &mercury_float_const_0pt0000000000000000;
...
MR_define_entry(mercury__fn__measurements__finalise_parallel_exec_metrics_1_0);
	...
	MR_sv(1) = MR_tfield(0, MR_r1, 2);
	* (MR_Float *) &MR_sv(12) = MR_word_to_float(MR_tfield(0, MR_r1, 3));
	* (MR_Float *) &MR_sv(15) = MR_word_to_float(MR_tfield(0, MR_r1, 4));
	* (MR_Float *) &MR_sv(17) = MR_word_to_float(MR_tfield(0, MR_r1, 5));
	* (MR_Float *) &MR_sv(4) = MR_word_to_float(MR_tfield(0, MR_r1, 6));
	MR_r2 = MR_r1;
	MR_r1 = MR_tfield(1, MR_tempr1, 0);
	* (MR_Float *) &MR_sv(6) = (MR_word_to_float(MR_tfield(0, MR_r2, 0)) + MR_word_to_float(MR_tfield(0, MR_r2, 1)));
...
MR_def_label(fn__measurements__finalise_parallel_exec_metrics_1_0,6)
	...
	* (MR_Float *) &MR_sv(19) = (MR_word_to_float(MR_r1) + MR_float_from_dword_ptr(&MR_sv(6)));
	MR_r1 = MR_sv(2);
...
MR_def_label(fn__measurements__finalise_parallel_exec_metrics_1_0,7)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	* (MR_Float *) &MR_sv(8) = (MR_word_to_float(MR_r1) + MR_float_from_dword_ptr(&MR_sv(6)));
	MR_r1 = MR_sv(2);
...
MR_def_label(fn__measurements__finalise_parallel_exec_metrics_1_0,8)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_float_to_word((MR_float_from_dword_ptr(&MR_sv(10)) - MR_word_to_float(MR_r1)));
	if ((MR_word_to_float(MR_r2) <= (MR_Float) 0.0000000000000000)) {
	...
	* (MR_Float *) &MR_sv(4) = MR_word_to_float(MR_r2);
	* (MR_Float *) &MR_sv(6) = (MR_float_from_dword_ptr(&MR_sv(19)) + MR_word_to_float(MR_r3));
...
MR_def_label(fn__measurements__finalise_parallel_exec_metrics_1_0,13)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	* (MR_Float *) &MR_sv(15) = (MR_word_to_float(MR_r1) * MR_float_from_dword_ptr(&MR_sv(17)));
	MR_r1 = MR_sv(2);
...
MR_def_label(fn__measurements__finalise_parallel_exec_metrics_1_0,15)
	...
	MR_tfield(0, MR_r2, 1) = MR_float_to_word(MR_float_from_dword_ptr(&MR_sv(8)));
	MR_tfield(0, MR_r2, 2) = MR_float_to_word(MR_float_from_dword_ptr(&MR_sv(6)));
	MR_tfield(0, MR_r2, 3) = MR_float_to_word(MR_float_from_dword_ptr(&MR_sv(12)));
	MR_tfield(0, MR_r2, 4) = MR_float_to_word(MR_float_from_dword_ptr(&MR_sv(15)));
	MR_tfield(0, MR_r2, 5) = MR_float_to_word(MR_float_from_dword_ptr(&MR_sv(17)));
	MR_tfield(0, MR_r2, 6) = MR_r1;
	MR_tfield(0, MR_r2, 7) = MR_float_to_word(MR_float_from_dword_ptr(&MR_sv(4)));
	MR_tfield(0, MR_r2, 8) = MR_float_to_word(MR_float_from_dword_ptr(&MR_sv(10)));
	MR_r1 = MR_r2;
...
MR_BEGIN_MODULE(measurements_module78)
	...
	MR_init_label4(measurements__weighted_average_3_0,3,5,6,4)
MR_BEGIN_CODE
...
MR_define_entry(mercury__measurements__weighted_average_3_0);
	...
	MR_np_call_localret_ent(list__foldl2_corresponding_7_0,
		measurements__weighted_average_3_0_i3);
MR_def_label(measurements__weighted_average_3_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	* (MR_Float *) &MR_sv(2) = MR_word_to_float(MR_r1);
	* (MR_Float *) &MR_sv(4) = MR_word_to_float(MR_r2);
	MR_r1 = MR_r2;
	MR_np_call_localret_ent(fn__float__abs_1_0,
		measurements__weighted_average_3_0_i5);
...
MR_def_label(measurements__weighted_average_3_0,6)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if ((MR_float_from_dword_ptr(&MR_sv(6)) >= MR_word_to_float(MR_r1))) {
		MR_GOTO_LAB(measurements__weighted_average_3_0_i4);
	}
	MR_r1 = (MR_Word) &mercury_float_const_0pt0000000000000000;
	MR_decr_sp_and_return(7);
...
MR_def_label(__Compare___measurements__parallel_exec_metrics_incomplete_0_0,2)
	...
	MR_Word MR_tempr1, MR_tempr2, MR_tempr3, MR_tempr4;
	MR_tempr3 = MR_sv(4);
	MR_sv(25) = MR_tfield(0, MR_tempr3, 7);
	* (MR_Float *) &MR_sv(24) = MR_word_to_float(MR_tfield(0, MR_tempr3, 6));
	* (MR_Float *) &MR_sv(22) = MR_word_to_float(MR_tfield(0, MR_tempr3, 5));
	* (MR_Float *) &MR_sv(20) = MR_word_to_float(MR_tfield(0, MR_tempr3, 4));
	* (MR_Float *) &MR_sv(18) = MR_word_to_float(MR_tfield(0, MR_tempr3, 3));
	MR_sv(16) = MR_tfield(0, MR_tempr3, 2);
	* (MR_Float *) &MR_sv(15) = MR_word_to_float(MR_tfield(0, MR_tempr3, 1));
	MR_tempr4 = MR_sv(1);
	MR_sv(13) = MR_tfield(0, MR_tempr4, 7);
	* (MR_Float *) &MR_sv(12) = MR_word_to_float(MR_tfield(0, MR_tempr4, 6));
	* (MR_Float *) &MR_sv(10) = MR_word_to_float(MR_tfield(0, MR_tempr4, 5));
...
MR_def_label(__Compare___measurements__parallel_exec_metrics_incomplete_0_0,13)
	...
	MR_r1 = MR_float_to_word(MR_float_from_dword_ptr(&MR_sv(6)));
	MR_r2 = MR_float_to_word(MR_float_from_dword_ptr(&MR_sv(18)));
	MR_np_call_localret_ent(private_builtin__builtin_compare_float_3_0,
...
MR_def_static(__Unify___measurements__parallel_exec_metrics_internal_0_0)
	...
	* (MR_Float *) &MR_sv(3) = MR_word_to_float(MR_tfield(1, MR_tempr1, 1));
	* (MR_Float *) &MR_sv(6) = MR_word_to_float(MR_tfield(1, MR_tempr1, 2));
	* (MR_Float *) &MR_sv(8) = MR_word_to_float(MR_tfield(1, MR_tempr1, 3));
	* (MR_Float *) &MR_sv(10) = MR_word_to_float(MR_tfield(1, MR_tempr1, 4));
	* (MR_Float *) &MR_sv(12) = MR_word_to_float(MR_tfield(1, MR_tempr1, 5));
	* (MR_Float *) &MR_sv(14) = MR_word_to_float(MR_tfield(1, MR_tempr2, 1));
	* (MR_Float *) &MR_sv(16) = MR_word_to_float(MR_tfield(1, MR_tempr2, 2));
	* (MR_Float *) &MR_sv(18) = MR_word_to_float(MR_tfield(1, MR_tempr2, 3));
	* (MR_Float *) &MR_sv(20) = MR_word_to_float(MR_tfield(1, MR_tempr2, 4));
	* (MR_Float *) &MR_sv(22) = MR_word_to_float(MR_tfield(1, MR_tempr2, 5));
	MR_r1 = MR_tfield(1, MR_tempr1, 0);
	MR_r2 = MR_tfield(1, MR_tempr2, 0);
	}
...
MR_def_label(__Compare___measurements__parallel_exec_metrics_internal_0_0,2)
	...
	MR_Word MR_tempr1, MR_tempr2;
	MR_tempr1 = MR_sv(1);
	* (MR_Float *) &MR_sv(22) = MR_word_to_float(MR_tfield(1, MR_tempr1, 1));
	* (MR_Float *) &MR_sv(20) = MR_word_to_float(MR_tfield(1, MR_tempr1, 2));
	* (MR_Float *) &MR_sv(18) = MR_word_to_float(MR_tfield(1, MR_tempr1, 3));
	* (MR_Float *) &MR_sv(16) = MR_word_to_float(MR_tfield(1, MR_tempr1, 4));
	* (MR_Float *) &MR_sv(14) = MR_word_to_float(MR_tfield(1, MR_tempr1, 5));
	MR_tempr2 = MR_sv(4);
	* (MR_Float *) &MR_sv(12) = MR_word_to_float(MR_tfield(1, MR_tempr2, 5));
	* (MR_Float *) &MR_sv(10) = MR_word_to_float(MR_tfield(1, MR_tempr2, 4));
	* (MR_Float *) &MR_sv(8) = MR_word_to_float(MR_tfield(1, MR_tempr2, 3));
	* (MR_Float *) &MR_sv(6) = MR_word_to_float(MR_tfield(1, MR_tempr2, 2));
	* (MR_Float *) &MR_sv(3) = MR_word_to_float(MR_tfield(1, MR_tempr2, 1));
	MR_r1 = MR_tfield(1, MR_tempr1, 0);
	MR_r2 = MR_tfield(1, MR_tempr2, 0);
	}
...
MR_def_label(__Compare___measurements__parallel_exec_metrics_internal_0_0,21)
	...
	MR_r2 = MR_float_to_word(MR_float_from_dword_ptr(&MR_sv(10)));
	MR_np_call_localret_ent(private_builtin__builtin_compare_float_3_0,
...
MR_def_label(__Compare___measurements__parallel_exec_metrics_internal_0_0,25)
	...
	MR_r2 = MR_float_to_word(MR_float_from_dword_ptr(&MR_sv(12)));
...
MR_def_label(__Compare___measurements__parallel_exec_metrics_internal_0_0,35)
	...
	MR_Word MR_tempr1, MR_tempr2;
	MR_tempr1 = MR_sv(1);
	* (MR_Float *) &MR_sv(10) = MR_word_to_float(MR_tfield(0, MR_tempr1, 1));
