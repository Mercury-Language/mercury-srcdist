...
{
  {
    ...
    Var_33 = (MR_Integer) ((MR_Unsigned) NumConjuncts_15 - (MR_Unsigned) (MR_Integer) 1);
...
{
  {
    ...
    *HeadVar__2_2 = (MR_Word) (MR_box_float(Var_4));
    ...
    if (!(succeeded))
    {
      ...
      mercury__string__format__format_float_component_nowidth_noprec_4_p_0((MR_Word) (&measurements_scalar_common_6[1]), (MR_Integer) 2, Var_12, &Var_15);
...
{
  {
    ...
    else
    {
              ...
              case (MR_Integer) 2:
                {
                  ...
                  MR_Word Cost_22;
                  MR_Float Sum_29;
                  MR_Float CostTotalA_30;
                  MR_Float CostTotalB_31;
                  ...
                  {
                    MR_Float PC_35 = MR_unbox_float((MR_hl_field(MR_mktag(0), CostA_12, (MR_Integer) 0)));

                    CostTotalA_30 = (Var_14 * PC_35);
                  }
                  else
                    CostTotalA_30 = MR_unbox_float((MR_hl_field(MR_mktag(1), CostA_12, (MR_Integer) 0)));
                  if (((MR_tag((MR_Word) CostB_13)) == (MR_Integer) 0))
                  {
                    MR_Float PC_39 = MR_unbox_float((MR_hl_field(MR_mktag(0), CostB_13, (MR_Integer) 0)));

                    CostTotalB_31 = (Var_15 * PC_39);
                  }
                  else
                    CostTotalB_31 = MR_unbox_float((MR_hl_field(MR_mktag(1), CostB_13, (MR_Integer) 0)));
                  Sum_29 = (CostTotalA_30 + CostTotalB_31);
                  {
                    Cost_22 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(MR_mktag(1), Cost_22, 0) = MR_box_float(Sum_29);
                  }
      ...
      Calls_43 = (MR_Integer) ((MR_Unsigned) CallsA_9 + (MR_Unsigned) CallsB_10);
      succeeded = (Calls_43 == TotalCalls_5);
      if (!(succeeded))
      {
...
{
  {
    ...
    switch (MR_tag((MR_Word) HeadVar__1_1)) {
      ...
      case (MR_Integer) 1:
        {
          MR_Integer Var_41 = ((MR_Integer) ((MR_hl_field(MR_mktag(1), HeadVar__1_1, (MR_Integer) 0))));
            ...
            case (MR_Integer) 2:
              {
                ...
                {
                  MR_Float PC_53 = MR_unbox_float((MR_hl_field(MR_mktag(0), CostB_14, (MR_Integer) 0)));

                  CostTotal_17 = (Var_18 * PC_53);
                }
                else
      ...
      case (MR_Integer) 2:
        {
          MR_Integer Var_39 = ((MR_Integer) ((MR_hl_field(MR_mktag(2), HeadVar__1_1, (MR_Integer) 1))));
          MR_Word Var_40 = ((MR_Word) ((MR_hl_field(MR_mktag(2), HeadVar__1_1, (MR_Integer) 0))));
            ...
            case (MR_Integer) 2:
              {
                ...
                Var_34 = mercury__float__float_1_f_0(Var_39);
                if (((MR_tag((MR_Word) Var_40)) == (MR_Integer) 0))
                {
                  MR_Float PC_45 = MR_unbox_float((MR_hl_field(MR_mktag(0), Var_40, (MR_Integer) 0)));

                  Var_33 = (Var_34 * PC_45);
                }
                else
                  Var_33 = MR_unbox_float((MR_hl_field(MR_mktag(1), Var_40, (MR_Integer) 0)));
                Var_36 = mercury__float__float_1_f_0(CallsB_29);
                if (((MR_tag((MR_Word) CostB_28)) == (MR_Integer) 0))
                {
                  MR_Float PC_49 = MR_unbox_float((MR_hl_field(MR_mktag(0), CostB_28, (MR_Integer) 0)));
                ...
                }
                {
                  ...
                  MR_hl_field(MR_mktag(2), HeadVar__3_3, 1) = ((MR_Box) (Var_39));
                }
