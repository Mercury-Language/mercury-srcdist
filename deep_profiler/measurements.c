            ...
            else
            {
              ...
              else
              {
                ...
                else
                {
                  ...
                  {
                    mercury__builtin__compare_3_p_0((MR_Word) (&measurements_scalar_common_1[2]), HeadVar__1_1, ((MR_Box) (ArgX8_25)), ((MR_Box) (ArgY8_26)));
                  }
                }
              }
            }
            ...
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                ...
                if (succeeded)
                {
                  ...
                  if (succeeded)
                  {
                    TypeInfo_21_21 = (MR_Word) (&measurements_scalar_common_1[2]);
...
{
  {
    ...
    mercury__builtin__compare_3_p_0((MR_Word) (&measurements_scalar_common_1[1]), HeadVar__1_1, ((MR_Box) (Cast_HeadVar1_4)), ((MR_Box) (Cast_HeadVar2_5)));
  }
}
...
{
  {
    ...
    succeeded = mercury__builtin__unify_2_p_0((MR_Word) (&measurements_scalar_common_1[1]), ((MR_Box) (Cast_HeadVar1_3)), ((MR_Box) (Cast_HeadVar2_4)));
    return succeeded;
  }
}
