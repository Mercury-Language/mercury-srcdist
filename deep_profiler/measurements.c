...
MR_def_label(fn__measurements__add_goal_costs_seq_2_0,11)
	...
	MR_r2 = MR_r1;
	MR_r1 = MR_sv(2);
	MR_sv(2) = MR_float_to_word((MR_word_to_float(MR_r2) * MR_word_to_float(MR_tfield(0, MR_sv(4), 0))));
	MR_np_call_localret_ent(fn__float__float_1_0,
...
MR_def_label(fn__measurements__add_goal_costs_seq_2_0,14)
	...
	MR_r4 = MR_tempr1;
	MR_tfield(1, MR_tempr1, 0) = MR_float_to_word((MR_word_to_float(MR_sv(2)) + (MR_word_to_float(MR_r1) * MR_word_to_float(MR_tfield(0, MR_sv(1), 0)))));
...
MR_def_label(fn__measurements__add_goal_costs_seq_2_0,16)
	...
	MR_Word MR_tempr1, MR_tempr2;
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 1);
	MR_tfield(1, MR_tempr1, 0) = MR_float_to_word((MR_word_to_float(MR_sv(2)) + MR_word_to_float(MR_tfield(1, MR_sv(1), 0))));
	MR_tag_alloc_heap(MR_tempr2, 2, (MR_Integer) 2);
	MR_tfield(2, MR_tempr2, 0) = MR_tempr1;
	MR_tfield(2, MR_tempr2, 1) = MR_sv(3);
	MR_r1 = MR_tempr2;
...
MR_def_label(fn__measurements__parallel_exec_metrics_internal_get_par_time_3_0,4)
	...
	MR_Word MR_tempr1;
	MR_tempr1 = MR_sv(1);
	MR_sv(1) = MR_float_to_word((MR_word_to_float(MR_sv(4)) + (MR_word_to_float(MR_tempr1) * MR_word_to_float(MR_r1))));
	MR_r1 = MR_sv(3);
	MR_r2 = MR_tempr1;
...
MR_define_entry(mercury__fn__measurements__finalise_parallel_exec_metrics_1_0);
	...
	MR_sv(7) = MR_float_to_word((MR_word_to_float(MR_tfield(0, MR_r2, 0)) + MR_word_to_float(MR_tfield(0, MR_r2, 1))));
...
MR_def_label(fn__measurements__finalise_parallel_exec_metrics_1_0,6)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(8) = MR_r1;
	MR_sv(10) = MR_float_to_word((MR_word_to_float(MR_r1) + MR_word_to_float(MR_sv(7))));
	MR_r1 = MR_sv(6);
...
MR_def_label(fn__measurements__finalise_parallel_exec_metrics_1_0,7)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(9) = MR_float_to_word((MR_word_to_float(MR_r1) + MR_word_to_float(MR_sv(7))));
	MR_r1 = MR_sv(6);
...
MR_def_label(fn__measurements__finalise_parallel_exec_metrics_1_0,8)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_float_to_word((MR_word_to_float(MR_sv(8)) - MR_word_to_float(MR_r1)));
	if ((MR_word_to_float(MR_r2) <= (MR_Float) 0.0000000000000000)) {
	...
	MR_r3 = MR_sv(5);
	MR_sv(5) = MR_r2;
	MR_sv(7) = MR_float_to_word((MR_word_to_float(MR_sv(10)) + MR_word_to_float(MR_r3)));
...
MR_def_label(fn__measurements__finalise_parallel_exec_metrics_1_0,9)
	...
	MR_r1 = MR_sv(6);
	MR_sv(5) = MR_r2;
	MR_sv(7) = MR_float_to_word((MR_word_to_float(MR_sv(10)) + (MR_Float) 0.0000000000000000));
...
MR_def_label(fn__measurements__finalise_parallel_exec_metrics_1_0,12)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(2) = MR_float_to_word((MR_word_to_float(MR_r1) * MR_word_to_float(MR_sv(2))));
	MR_r1 = MR_sv(3);
	MR_np_call_localret_ent(fn__float__float_1_0,
...
MR_def_label(fn__measurements__finalise_parallel_exec_metrics_1_0,13)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(3) = MR_float_to_word((MR_word_to_float(MR_r1) * MR_word_to_float(MR_sv(4))));
	MR_r1 = MR_sv(6);
