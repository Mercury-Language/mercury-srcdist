      ...
      case (MR_Integer) 2:
        {
          ...
          if (succeeded)
          {
            ...
            {
              MR_Float ArgX1_13 = MR_unbox_float((MR_hl_field(0, ArgX1_7, (MR_Integer) 0)));
              MR_Float ArgY1_14;

              succeeded = ((MR_tag((MR_Word) ArgY1_8)) == (MR_Integer) 0);
              if (succeeded)
              {
                ArgY1_14 = MR_unbox_float((MR_hl_field(0, ArgY1_8, (MR_Integer) 0)));
                succeeded = (ArgX1_13 == ArgY1_14);
              }
            }
            else
            {
              MR_Float ArgX1_15 = MR_unbox_float((MR_hl_field(1, ArgX1_7, (MR_Integer) 0)));
              MR_Float ArgY1_16;

              succeeded = ((MR_tag((MR_Word) ArgY1_8)) == (MR_Integer) 1);
              if (succeeded)
              {
                ArgY1_16 = MR_unbox_float((MR_hl_field(1, ArgY1_8, (MR_Integer) 0)));
