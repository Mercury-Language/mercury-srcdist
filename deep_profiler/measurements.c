...
{
  {
    ...
    if ((MaybeInternal_12 == (MR_Word) ((MR_Integer) 0)))
    {
...
{
  {
...

    {
      ...
      MR_hl_field(MR_mktag(0), HeadVar__8_8, 7) = ((MR_Box) ((MR_Integer) 0));
    }
    return HeadVar__8_8;
  }
}
...
{
  {
    ...
    if ((MaybeInternal0_15 == (MR_Word) ((MR_Integer) 0)))
    {
      {
