    ...
    else
    {
      ...
      else
      {
        ...
        else
        {
          ...
          if (((MR_tag((MR_Word) ArgX3_8)) == (MR_Integer) 0))
          {
            MR_Float Var_29 = MR_unbox_float((MR_hl_field(MR_mktag(0), ArgX3_8, (MR_Integer) 0)));

            if (((MR_tag((MR_Word) ArgY3_9)) == (MR_Integer) 0))
            {
...
{
  {
    ...
    else
    {
      ...
      else
      {
        ...
        if (((MR_tag((MR_Word) ArgX2_6)) == (MR_Integer) 0))
        {
          MR_Float Var_25 = MR_unbox_float((MR_hl_field(MR_mktag(0), ArgX2_6, (MR_Integer) 0)));

          if (((MR_tag((MR_Word) ArgY2_7)) == (MR_Integer) 0))
          {
      ...
      case (MR_Integer) 2:
        {
          ...
          if (((MR_tag((MR_Word) Cost0_10)) == (MR_Integer) 0))
            ...
            case (MR_Integer) 2:
              {
                ...
                if (((MR_tag((MR_Word) CostB_14)) == (MR_Integer) 0))
                {
            ...
            case (MR_Integer) 2:
              {
                ...
                if (((MR_tag((MR_Word) Var_41)) == (MR_Integer) 0))
                {
                ...
                if (((MR_tag((MR_Word) CostB_28)) == (MR_Integer) 0))
                {
