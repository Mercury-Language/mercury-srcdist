...
MR_def_label(fn__measurements__add_goal_costs_seq_2_0,11)
	...
	MR_r2 = MR_r1;
	MR_r1 = MR_sv(4);
	MR_sv(4) = MR_float_to_word((MR_word_to_float(MR_r2) * MR_word_to_float(MR_tfield(0, MR_sv(3), 0))));
	MR_np_call_localret_ent(fn__float__float_1_0,
...
MR_def_label(fn__measurements__add_goal_costs_seq_2_0,14)
	...
	MR_r4 = MR_tempr1;
	MR_tfield(1, MR_tempr1, 0) = MR_float_to_word((MR_word_to_float(MR_sv(4)) + (MR_word_to_float(MR_r1) * MR_word_to_float(MR_tfield(0, MR_sv(1), 0)))));
...
MR_def_label(fn__measurements__add_goal_costs_seq_2_0,16)
	...
	MR_Word MR_tempr1, MR_tempr2;
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 1);
	MR_tfield(1, MR_tempr1, 0) = MR_float_to_word((MR_word_to_float(MR_sv(4)) + MR_word_to_float(MR_tfield(1, MR_sv(1), 0))));
	MR_tag_alloc_heap(MR_tempr2, 2, (MR_Integer) 2);
	MR_tfield(2, MR_tempr2, 0) = MR_tempr1;
	MR_tfield(2, MR_tempr2, 1) = MR_sv(2);
	MR_r1 = MR_tempr2;
...
MR_def_label(fn__measurements__add_goal_costs_branch_3_0,18)
	...
	MR_r2 = MR_float_to_word((MR_word_to_float(MR_sv(4)) * MR_word_to_float(MR_tfield(0, MR_sv(2), 0))));
...
MR_def_label(fn__measurements__parallel_exec_metrics_internal_get_par_time_3_0,14)
	...
	MR_sv(1) = MR_tempr1;
	MR_sv(2) = MR_tfield(1, MR_r1, 0);
	MR_sv(4) = MR_float_to_word((MR_word_to_float(MR_tfield(1, MR_r1, 4)) + MR_word_to_float(MR_tfield(1, MR_r1, 5))));
...
MR_def_label(fn__measurements__parallel_exec_metrics_internal_get_par_time_3_0,4)
	...
	MR_Word MR_tempr1;
	MR_tempr1 = MR_sv(3);
	MR_sv(3) = MR_float_to_word((MR_word_to_float(MR_sv(4)) + (MR_word_to_float(MR_tempr1) * MR_word_to_float(MR_r1))));
	MR_r1 = MR_sv(2);
	MR_r2 = MR_tempr1;
...
MR_define_entry(mercury__fn__measurements__finalise_parallel_exec_metrics_1_0);
	...
	MR_sv(4) = MR_float_to_word((MR_word_to_float(MR_tfield(0, MR_r2, 0)) + MR_word_to_float(MR_tfield(0, MR_r2, 1))));
...
MR_def_label(fn__measurements__finalise_parallel_exec_metrics_1_0,6)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(6) = MR_r1;
	MR_sv(10) = MR_float_to_word((MR_word_to_float(MR_r1) + MR_word_to_float(MR_sv(4))));
	MR_r1 = MR_sv(2);
...
MR_def_label(fn__measurements__finalise_parallel_exec_metrics_1_0,8)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_float_to_word((MR_word_to_float(MR_sv(6)) - MR_word_to_float(MR_r1)));
	if ((MR_word_to_float(MR_r2) <= (MR_Float) 0.0000000000000000)) {
	...
	MR_r3 = MR_sv(3);
	MR_sv(3) = MR_r2;
	MR_sv(4) = MR_float_to_word((MR_word_to_float(MR_sv(10)) + MR_word_to_float(MR_r3)));
...
MR_def_label(fn__measurements__finalise_parallel_exec_metrics_1_0,9)
	...
	MR_r1 = MR_sv(2);
	MR_sv(3) = MR_r2;
	MR_sv(4) = MR_float_to_word((MR_word_to_float(MR_sv(10)) + (MR_Float) 0.0000000000000000));
...
MR_def_label(fn__measurements__finalise_parallel_exec_metrics_1_0,12)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(7) = MR_float_to_word((MR_word_to_float(MR_r1) * MR_word_to_float(MR_sv(7))));
	MR_r1 = MR_sv(8);
	MR_np_call_localret_ent(fn__float__float_1_0,
...
MR_def_label(fn__measurements__finalise_parallel_exec_metrics_1_0,13)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(8) = MR_float_to_word((MR_word_to_float(MR_r1) * MR_word_to_float(MR_sv(9))));
	MR_r1 = MR_sv(2);
...
MR_def_static(__Unify___measurements__parallel_exec_metrics_internal_0_0)
	...
	MR_sv(9) = MR_tfield(1, MR_tempr4, 4);
	MR_sv(10) = MR_tfield(1, MR_tempr4, 5);
	MR_r1 = MR_tfield(1, MR_tempr3, 0);
	MR_r2 = MR_tfield(1, MR_tempr4, 0);
	}
...
MR_def_label(__Unify___measurements__parallel_exec_metrics_internal_0_0,7)
	...
	if ((MR_word_to_float(MR_sv(1)) != MR_word_to_float(MR_sv(6)))) {
		MR_GOTO_LAB(__Unify___measurements__parallel_exec_metrics_internal_0_0_i1);
	}
	if ((MR_word_to_float(MR_sv(2)) != MR_word_to_float(MR_sv(7)))) {
		MR_GOTO_LAB(__Unify___measurements__parallel_exec_metrics_internal_0_0_i1);
	}
	...
	MR_r1 = (MR_word_to_float(MR_sv(5)) == MR_word_to_float(MR_sv(10)));
	MR_decr_sp_and_return(11);
