            ...
            case (MR_Integer) 2:
              {
                ...
                {
                  MR_Float Percall_51 = MR_unbox_float((MR_hl_field(MR_mktag(0), CostB_9, (MR_Integer) 0)));

                  CostTotal_11 = (Var_21 * Percall_51);
                }
                else
            ...
            case (MR_Integer) 2:
              {
                ...
                {
                  MR_Float Percall_43 = MR_unbox_float((MR_hl_field(MR_mktag(0), CostA_13, (MR_Integer) 0)));

                  Var_15 = (Var_16 * Percall_43);
                }
                else
                ...
                {
                  MR_Float Percall_47 = MR_unbox_float((MR_hl_field(MR_mktag(0), CostB_25, (MR_Integer) 0)));

                  Var_17 = (Var_18 * Percall_47);
                }
                else
