  ...
  MR_Word B_7)
{
  ...
  else
  {
            ...
            case (MR_Integer) 2:
              {
                ...
                MR_Word Cost_22;
                MR_Float Sum_27;
                MR_Float CostTotalA_28;
                MR_Float CostTotalB_29;
                ...
                {
                  MR_Float Percall_33 = MR_unbox_float((MR_hl_field(MR_mktag(0), CostA_12, (MR_Integer) 0)));

                  CostTotalA_28 = (Var_16 * Percall_33);
                }
                else
                  CostTotalA_28 = MR_unbox_float((MR_hl_field(MR_mktag(1), CostA_12, (MR_Integer) 0)));
                if (((MR_tag((MR_Word) CostB_13)) == (MR_Integer) 0))
                {
                  MR_Float Percall_37 = MR_unbox_float((MR_hl_field(MR_mktag(0), CostB_13, (MR_Integer) 0)));

                  CostTotalB_29 = (Var_17 * Percall_37);
                }
                else
                  CostTotalB_29 = MR_unbox_float((MR_hl_field(MR_mktag(1), CostB_13, (MR_Integer) 0)));
                Sum_27 = (CostTotalA_28 + CostTotalB_29);
                {
                  Cost_22 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                  MR_hl_field(MR_mktag(1), Cost_22, 0) = MR_box_float(Sum_27);
                }
    ...
    Calls_41 = (MR_Integer) ((MR_Unsigned) CallsA_9 + (MR_Unsigned) CallsB_10);
    succeeded = (Calls_41 == TotalCalls_5);
    if (!(succeeded))
