...
MR_decl_label4(measurements__is_inactive_1_0, 3,10,12,1)
...
MR_BEGIN_MODULE(measurements_module29)
	...
	MR_init_label4(measurements__is_inactive_1_0,3,10,12,1)
MR_BEGIN_CODE
...
MR_define_entry(mercury__measurements__is_inactive_1_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_COMPUTED_GOTO((MR_Unsigned) MR_tag(MR_r1),
		MR_LABEL_AP(measurements__is_inactive_1_0_i3) MR_AND
		MR_LABEL_AP(measurements__is_inactive_1_0_i10) MR_AND
		MR_LABEL_AP(measurements__is_inactive_1_0_i10) MR_AND
		MR_LABEL_AP(measurements__is_inactive_1_0_i12));
MR_def_label(measurements__is_inactive_1_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tempr2 = MR_r1;
...
MR_def_label(measurements__is_inactive_1_0,10)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
...
MR_def_label(measurements__is_inactive_1_0,12)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tempr2 = MR_r1;
