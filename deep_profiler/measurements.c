...
static void MR_CALL 
measurements__IntroducedFrom__pred__add_coverage_arrays__938__1_4_p_0(
...
{
  {
    ...
    measurements__IntroducedFrom__pred__add_coverage_arrays__938__1_4_p_0(((MR_Integer) (wrapper_arg_1)), ((MR_Integer) (wrapper_arg_2)), ((MR_ArrayPtr) (wrapper_arg_3)), &conv1_LambdaHeadVar__4_22);
              ...
              case (MR_Integer) 2:
                {
                  ...
                  {
                    MR_Float Percall_35 = MR_unbox_float((MR_hl_field(MR_mktag(0), CostA_12, (MR_Integer) 0)));

                    CostTotalA_30 = (Var_14 * Percall_35);
                  }
                  else
                    CostTotalA_30 = MR_unbox_float((MR_hl_field(MR_mktag(1), CostA_12, (MR_Integer) 0)));
                  if (((MR_tag((MR_Word) CostB_13)) == (MR_Integer) 0))
                  {
                    MR_Float Percall_39 = MR_unbox_float((MR_hl_field(MR_mktag(0), CostB_13, (MR_Integer) 0)));

                    CostTotalB_31 = (Var_15 * Percall_39);
                  }
                  else
            ...
            case (MR_Integer) 2:
              {
                ...
                {
                  MR_Float Percall_53 = MR_unbox_float((MR_hl_field(MR_mktag(0), CostB_14, (MR_Integer) 0)));

                  CostTotal_17 = (Var_18 * Percall_53);
                }
                else
            ...
            case (MR_Integer) 2:
              {
                ...
                {
                  MR_Float Percall_45 = MR_unbox_float((MR_hl_field(MR_mktag(0), Var_40, (MR_Integer) 0)));

                  Var_33 = (Var_34 * Percall_45);
                }
                else
                ...
                {
                  MR_Float Percall_49 = MR_unbox_float((MR_hl_field(MR_mktag(0), CostB_28, (MR_Integer) 0)));

                  Var_35 = (Var_36 * Percall_49);
                }
                else
