...
MR_def_label(branch_and_bound__test_incomplete_solution_2_0,8)
	...
	MR_tempr1 = MR_sv(3);
	MR_sv(3) = MR_r1;
	* (MR_Float *) &MR_sv(6) = MR_word_to_float(MR_tfield(1, MR_sv(2), 1));
	MR_r1 = MR_sv(4);
	MR_r2 = MR_tempr1;
	}
...
MR_def_label(branch_and_bound__test_incomplete_solution_2_0,9)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if ((MR_word_to_float(MR_r1) > MR_float_from_dword_ptr(&MR_sv(6)))) {
...
MR_def_label(branch_and_bound__test_complete_solution_2_0,5)
	...
	MR_tfield(1, MR_tempr2, 1) = MR_float_to_word(MR_float_from_dword_ptr(&MR_sv(7)));
...
MR_def_label(branch_and_bound__test_complete_solution_2_0,9)
	...
	if ((MR_float_from_dword_ptr(&MR_sv(7)) >= MR_word_to_float(MR_r4))) {
...
MR_def_label(__Unify___branch_and_bound__best_solutions_1_0,5)
	...
	* (MR_Float *) &MR_sv(3) = MR_word_to_float(MR_tfield(1, MR_tempr1, 1));
	MR_tempr2 = MR_sv(4);
	* (MR_Float *) &MR_sv(6) = MR_word_to_float(MR_tfield(1, MR_tempr2, 1));
	MR_r1 = MR_sv(7);
...
MR_def_label(__Compare___branch_and_bound__best_solutions_1_0,9)
	...
	MR_Word MR_tempr1, MR_tempr2;
	MR_tempr1 = MR_sv(1);
	* (MR_Float *) &MR_sv(7) = MR_word_to_float(MR_tfield(1, MR_tempr1, 1));
	MR_tempr2 = MR_sv(5);
