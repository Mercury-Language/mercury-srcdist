...
const MR_DuArgLocn mercury_data_branch_and_bound__field_locns_best_solutions_1_1[] = {
	{ 0, 0, 0 },
	{ 1, 0, -1 },
};
...
static const MR_DuFunctorDesc mercury_data_branch_and_bound__du_functor_desc_best_solutions_1_1 = {
	...
	mercury_data_branch_and_bound__field_locns_best_solutions_1_1,
	NULL
};
...
MR_def_label(branch_and_bound__test_incomplete_solution_2_0,9)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if ((MR_f(1) > MR_float_from_dword_ptr(&MR_sv(6)))) {
...
MR_def_label(branch_and_bound__test_complete_solution_2_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(3) = MR_r1;
	MR_sv(9) = (MR_Word) MR_CTOR0_ADDR(branch_and_bound, bnb_profile);
	MR_r1 = MR_sv(9);
	MR_r2 = MR_sv(2);
	MR_np_call_localret_ent(mutvar__get_mutvar_2_0,
...
MR_def_label(branch_and_bound__test_complete_solution_2_0,5)
	...
	* (MR_Float *) &(MR_tfield(1, MR_tempr2, 1)) = MR_tempf4;
...
MR_def_label(branch_and_bound__test_complete_solution_2_0,9)
	...
	MR_tempr4 = MR_sv(3);
	MR_f(1) = MR_float_from_dword_ptr(&MR_tfield(1, MR_tempr4, 1));
	...
	MR_r3 = MR_tempr2;
	MR_tfield(1, MR_tempr2, 0) = MR_tempr1;
	MR_tempf5 = MR_float_from_dword_ptr(&MR_sv(7));
	* (MR_Float *) &(MR_tfield(1, MR_tempr2, 1)) = MR_tempf5;
	MR_tag_alloc_heap(MR_tempr3, 0, (MR_Integer) 8);
	MR_sv(4) = MR_tempr3;
	MR_tfield(0, MR_tempr3, 0) = MR_tfield(0, MR_r1, 0);
	MR_tfield(0, MR_tempr3, 1) = MR_tfield(0, MR_r1, 1);
