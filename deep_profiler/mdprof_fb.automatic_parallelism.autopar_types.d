...
ifeq ($(TARGET_ASM),yes)
mdprof_fb.automatic_parallelism.autopar_types.mh mdprof_fb.automatic_parallelism.autopar_types.mih : mdprof_fb.automatic_parallelism.autopar_types.s
else
...
ifeq ($(TARGET_ASM),yes)
mdprof_fb.automatic_parallelism.autopar_types.module_dep : mdprof_fb.automatic_parallelism.autopar_types.s
else
...
ifeq ($(TARGET_ASM),yes)
mdprof_fb.automatic_parallelism.autopar_types.s_date : autopar_types.m
	$(MCG) $(ALL_GRADEFLAGS) $(ALL_MCGFLAGS) --target-code-only mdprof_fb.automatic_parallelism.autopar_types $(ERR_REDIRECT)
mdprof_fb.automatic_parallelism.autopar_types.pic_s_date : autopar_types.m
	$(MCG) $(ALL_GRADEFLAGS) $(ALL_MCGFLAGS) --target-code-only --pic \
		--cflags "$(GCCFLAGS_FOR_PIC)" mdprof_fb.automatic_parallelism.autopar_types $(ERR_REDIRECT)
endif # TARGET_ASM
