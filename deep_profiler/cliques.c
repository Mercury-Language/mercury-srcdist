  ...
  MR_Word HeadVar__2_2)
{
  ...
  else
  {
    ...
    if (succeeded)
    {
      TypeInfo__9_9 = (MR_Word) (&cliques_scalar_common_1[0]);
      succeeded = mercury__array____Unify____array_1_0(TypeInfo__9_9, (MR_ArrayPtr) (ArgX2_5), (MR_ArrayPtr) (ArgY2_6));
    }
  }
  return succeeded;
}
  ...
  MR_Word * Cliques_4)
{
  ...
  MR_ArrayPtr Visit_9;
  MR_Word Cliques0_10;
  MR_Integer Size_42 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), Graph_3, (MR_Integer) 0))));
  MR_Word NodeList_44;
  ...
  MR_Word * InvGraph_8)
{
  while (MR_TRUE)
  {
    ...
    if (succeeded)
    {
      ...
      MR_Integer Var_13;
      MR_ArrayPtr Array_17 = ((MR_ArrayPtr) ((MR_hl_field(MR_mktag(0), Graph_6, (MR_Integer) 1))));
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      else
      {
        ...
        Array_65 = ((MR_ArrayPtr) ((MR_hl_field(MR_mktag(0), HeadVar__2_2, (MR_Integer) 1))));
