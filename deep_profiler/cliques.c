...
{
  {
    ...
    MR_ArrayPtr Visit_9;
    MR_Word Cliques0_10;
    MR_Integer Size_44 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), Graph_3, (MR_Integer) 0))));
    MR_Word NodeList_46;
    MR_ArrayPtr Visit_47;
    MR_Word InvGraph0_52;
    MR_Integer Size_53;
    MR_ArrayPtr Array_55;
    MR_Word Var_58;
    MR_ArrayPtr conv0_Array_55;

    cliques__mklist_3_p_0(Size_44, (MR_Word) ((MR_Unsigned) 0U), &NodeList_46);
    Visit_47 = dense_bitset__init_0_f_0();
    cliques__dfs_graph_2_5_p_0(NodeList_46, Graph_3, Visit_47, (MR_Word) ((MR_Unsigned) 0U), &Dfs_7);
    Var_58 = mercury__set__init_0_f_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0));
    mercury__array__init_3_p_0((MR_Word) (&cliques_scalar_common_1[0]), (MR_Integer) 16, ((MR_Box) (Var_58)), &conv0_Array_55);
    Array_55 = (MR_ArrayPtr) (conv0_Array_55);
    {
      InvGraph0_52 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), InvGraph0_52, 0) = ((MR_Box) ((MR_Integer) 1));
      MR_hl_field(MR_mktag(0), InvGraph0_52, 1) = ((MR_Box) (Array_55));
    }
    Size_53 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), Graph_3, (MR_Integer) 0))));
    cliques__inverse_2_4_p_0(Size_53, Graph_3, InvGraph0_52, &InvGraph_8);
    ...
    else
    {
      ...
      else
      {
...

        {
          ...
          MR_hl_field(MR_mktag(1), Var_44, 0) = ((MR_Box) (Node_11));
        ...
        {
          STATE_VARIABLE_Cliques_56_56 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), STATE_VARIABLE_Cliques_56_56, 0) = ((MR_Box) (Clique_19));
          MR_hl_field(MR_mktag(1), STATE_VARIABLE_Cliques_56_56, 1) = ((MR_Box) (STATE_VARIABLE_Cliques_0_4));
        }
      }
      // direct tailcall eliminated
      ;
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      else
      {
        ...
        MR_Word Dfs1_23;
        MR_Word Dfs2_24;
        MR_ArrayPtr Array_67;
        MR_Word next_value_of_HeadVar__1_1;
        MR_ArrayPtr next_value_of_HeadVar__3_3;
        MR_Word next_value_of_HeadVar__4_4;

        Visit1_19 = dense_bitset__insert_2_f_0(HeadVar__3_3, Node_10);
        Array_67 = ((MR_ArrayPtr) ((MR_hl_field(MR_mktag(0), HeadVar__2_2, (MR_Integer) 1))));
        succeeded = mercury__array__in_bounds_2_p_0((MR_Word) (&cliques_scalar_common_1[0]), (MR_ArrayPtr) (Array_67), Node_10);
        if (succeeded)
        {
          MR_Box conv0_Succ_20;

          mercury__array__lookup_3_p_0((MR_Word) (&cliques_scalar_common_1[0]), (MR_ArrayPtr) (Array_67), Node_10, &conv0_Succ_20);
        ...
        {
          Dfs2_24 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), Dfs2_24, 0) = ((MR_Box) (Node_10));
          MR_hl_field(MR_mktag(1), Dfs2_24, 1) = ((MR_Box) (Dfs1_23));
        }
        // direct tailcall eliminated
        ;
