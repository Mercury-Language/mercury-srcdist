...
MR_decl_label8(cliques__add_arc_4_0, 27,4,6,7,9,10,11,12)
MR_decl_label5(cliques__add_arc_4_0, 2,15,17,18,19)
MR_decl_label3(cliques__add_arcs_to_4_0, 10,3,4)
MR_decl_label8(cliques__dfs_6_0, 35,3,6,4,9,12,10,15)
MR_decl_label2(cliques__dfs_6_0, 17,18)
...
MR_BEGIN_MODULE(cliques_module1)
	...
	MR_init_label8(cliques__add_arc_4_0,27,4,6,7,9,10,11,12)
	MR_init_label5(cliques__add_arc_4_0,2,15,17,18,19)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(cliques_module2)
	...
	MR_init_label8(cliques__dfs_6_0,35,3,6,4,9,12,10,15)
	MR_init_label2(cliques__dfs_6_0,17,18)
MR_BEGIN_CODE
