  ...
  MR_Word * InvGraph_8)
{
  while (MR_TRUE)
  {
    ...
    if (succeeded)
    {
      ...
      Var_13 = (MR_Integer) ((MR_Unsigned) To_5 - (MR_Unsigned) (MR_Integer) 1);
      // direct tailcall eliminated
  ...
  MR_Word * STATE_VARIABLE_Cliques_5)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      next_value_of_HeadVar__3_3 = STATE_VARIABLE_Visited_39_39;
      next_value_of_STATE_VARIABLE_Cliques_0_4 = STATE_VARIABLE_Cliques_49_49;
      HeadVar__1_1 = next_value_of_HeadVar__1_1;
      HeadVar__3_3 = next_value_of_HeadVar__3_3;
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      else
      {
        ...
        next_value_of_HeadVar__3_3 = Visit2_21;
        next_value_of_HeadVar__4_4 = Dfs2_23;
        HeadVar__1_1 = next_value_of_HeadVar__1_1;
        HeadVar__3_3 = next_value_of_HeadVar__3_3;
        HeadVar__4_4 = next_value_of_HeadVar__4_4;
        continue;
  ...
  MR_Word * Graph_9)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      Var_17 = (MR_Integer) ((MR_Unsigned) Size_22 * (MR_Unsigned) (MR_Integer) 2);
