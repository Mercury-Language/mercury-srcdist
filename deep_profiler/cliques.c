...
{
  {
    ...
    if (cliques__succeeded)
      *cliques__HeadVar__1_1 = (MR_Integer) 0;
      ...
      {
        MR_Integer cliques__ArgX1_4 = ((MR_Integer) (MR_hl_field(MR_mktag(0), cliques__HeadVar__2_2, (MR_Integer) 0)));
        MR_Integer cliques__ArgY1_5 = ((MR_Integer) (MR_hl_field(MR_mktag(0), cliques__HeadVar__3_3, (MR_Integer) 0)));
        MR_ArrayPtr cliques__ArgX2_6 = ((MR_ArrayPtr) (MR_hl_field(MR_mktag(0), cliques__HeadVar__2_2, (MR_Integer) 1)));
        MR_ArrayPtr cliques__ArgY2_7 = ((MR_ArrayPtr) (MR_hl_field(MR_mktag(0), cliques__HeadVar__3_3, (MR_Integer) 1)));
        MR_Word cliques__Var_8;

        {
          mercury__private_builtin__builtin_compare_int_3_p_0(&cliques__Var_8, cliques__ArgX1_4, cliques__ArgY1_5);
        }
        cliques__succeeded = (cliques__Var_8 == (MR_Integer) 0);
        cliques__succeeded = !(cliques__succeeded);
        if (cliques__succeeded)
          *cliques__HeadVar__1_1 = cliques__Var_8;
        else
          {
            {
              mercury__builtin__compare_3_p_0((MR_Word) &cliques_scalar_common_1[1], cliques__HeadVar__1_1, ((MR_Box) (cliques__ArgX2_6)), ((MR_Box) (cliques__ArgY2_7)));
            }
          }
      }
  }
...
{
  {
    ...
    if (cliques__succeeded)
    ...
    else
      {
        ...
        MR_Integer cliques__ArgX1_3 = ((MR_Integer) (MR_hl_field(MR_mktag(0), cliques__HeadVar__1_1, (MR_Integer) 0)));
        MR_Integer cliques__ArgY1_4 = ((MR_Integer) (MR_hl_field(MR_mktag(0), cliques__HeadVar__2_2, (MR_Integer) 0)));
        MR_ArrayPtr cliques__ArgX2_5 = ((MR_ArrayPtr) (MR_hl_field(MR_mktag(0), cliques__HeadVar__1_1, (MR_Integer) 1)));
        MR_ArrayPtr cliques__ArgY2_6 = ((MR_ArrayPtr) (MR_hl_field(MR_mktag(0), cliques__HeadVar__2_2, (MR_Integer) 1)));

        cliques__succeeded = (cliques__ArgX1_3 == cliques__ArgY1_4);
        if (cliques__succeeded)
          {
            cliques__TypeInfo_9_9 = (MR_Word) &cliques_scalar_common_1[0];
            {
              cliques__succeeded = mercury__array____Unify____array_1_0(cliques__TypeInfo_9_9, (MR_ArrayPtr) cliques__ArgX2_5, (MR_ArrayPtr) cliques__ArgY2_6);
            }
          }
      }
    return cliques__succeeded;
...
{
  {
    ...
    {
      cliques__Var_54 = mercury__set__init_0_f_0((MR_Word) &mercury__builtin__builtin__type_ctor_info_int_0);
    }
    {
      mercury__array__init_3_p_0((MR_Word) &cliques_scalar_common_1[0], (MR_Integer) 16, ((MR_Box) (cliques__Var_54)), &cliques__conv0_Array_51);
    }
        ...
        if ((cliques__HeadVar__1_1 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
          *cliques__L_3 = cliques__HeadVar__2_2;
        else
          {
            ...
            MR_Word cliques__Var_9;

            {
              cliques__Var_9 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), cliques__Var_9, 0) = cliques__X_5;
              MR_hl_field(MR_mktag(1), cliques__Var_9, 1) = ((MR_Box) (cliques__HeadVar__2_2));
            }
            /* direct tailcall eliminated */
            {
              MR_Word cliques__next_value_of_HeadVar__1_1 = cliques__Xs_6;
              MR_Word cliques__next_value_of_HeadVar__2_2 = cliques__Var_9;

              cliques__HeadVar__2_2 = cliques__next_value_of_HeadVar__2_2;
              cliques__HeadVar__1_1 = cliques__next_value_of_HeadVar__1_1;
            }
            continue;
          }
      }
        ...
        if (cliques__succeeded)
          {
            ...
            cliques__Var_13 = (cliques__To_5 - (MR_Integer) 1);
            /* direct tailcall eliminated */
            {
              MR_Integer cliques__next_value_of_To_5 = cliques__Var_13;
              MR_Word cliques__next_value_of_InvGraph0_7 = cliques__InvGraph1_11;

              cliques__InvGraph0_7 = cliques__next_value_of_InvGraph0_7;
              cliques__To_5 = cliques__next_value_of_To_5;
            }
            continue;
          }
        else
        ...
        if ((cliques__HeadVar__1_1 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
          *cliques__Graph_4 = cliques__HeadVar__3_3;
        else
          {
            ...
            /* direct tailcall eliminated */
            {
              MR_Word cliques__next_value_of_HeadVar__1_1 = cliques__FromList_8;
              MR_Word cliques__next_value_of_HeadVar__3_3 = cliques__Graph1_12;

              cliques__HeadVar__3_3 = cliques__next_value_of_HeadVar__3_3;
              cliques__HeadVar__1_1 = cliques__next_value_of_HeadVar__1_1;
            }
            continue;
          }
        ...
        if ((cliques__HeadVar__1_1 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
          *cliques__Dfs_5 = cliques__HeadVar__4_4;
        else
          {
            ...
            MR_Word cliques__Var_17;

            {
              cliques__Var_17 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), cliques__Var_17, 0) = ((MR_Box) (cliques__Node_9));
              MR_hl_field(MR_mktag(1), cliques__Var_17, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
            }
            {
              cliques__dfs_6_p_0(cliques__Var_17, cliques__HeadVar__2_2, cliques__HeadVar__3_3, cliques__HeadVar__4_4, &cliques__Visit_15, &cliques__Dfs1_16);
            }
            /* direct tailcall eliminated */
            {
              MR_Word cliques__next_value_of_HeadVar__1_1 = cliques__Nodes_10;
              MR_ArrayPtr cliques__next_value_of_HeadVar__3_3 = cliques__Visit_15;
              MR_Word cliques__next_value_of_HeadVar__4_4 = cliques__Dfs1_16;

              cliques__HeadVar__4_4 = cliques__next_value_of_HeadVar__4_4;
              cliques__HeadVar__3_3 = cliques__next_value_of_HeadVar__3_3;
              cliques__HeadVar__1_1 = cliques__next_value_of_HeadVar__1_1;
            }
            continue;
        ...
        else
          {
            ...
            if (cliques__succeeded)
            ...
            else
              {
                ...
                MR_Word cliques__Var_37;

                {
                  cliques__Var_37 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                  MR_hl_field(MR_mktag(1), cliques__Var_37, 0) = ((MR_Box) (cliques__Node_11));
                  MR_hl_field(MR_mktag(1), cliques__Var_37, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
                }
                {
                  cliques__dfs_6_p_0(cliques__Var_37, cliques__HeadVar__2_2, cliques__HeadVar__3_3, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), &cliques__STATE_VARIABLE_Visited_39_39, &cliques__CliqueList_17);
                }
                {
            ...
            /* direct tailcall eliminated */
            {
              MR_Word cliques__next_value_of_HeadVar__1_1 = cliques__Nodes_12;
              MR_ArrayPtr cliques__next_value_of_HeadVar__3_3 = cliques__STATE_VARIABLE_Visited_39_39;
              MR_Word cliques__next_value_of_STATE_VARIABLE_Cliques_0_4 = cliques__STATE_VARIABLE_Cliques_49_49;

              cliques__STATE_VARIABLE_Cliques_0_4 = cliques__next_value_of_STATE_VARIABLE_Cliques_0_4;
              cliques__HeadVar__3_3 = cliques__next_value_of_HeadVar__3_3;
              cliques__HeadVar__1_1 = cliques__next_value_of_HeadVar__1_1;
            }
            continue;
            ...
            if (cliques__succeeded)
              {
                /* direct tailcall eliminated */
                {
                  MR_Word cliques__next_value_of_HeadVar__1_1 = cliques__Nodes_11;
            ...
            else
              {
                ...
                {
                  MR_Word cliques__next_value_of_HeadVar__1_1 = cliques__Nodes_11;
                  MR_ArrayPtr cliques__next_value_of_HeadVar__3_3 = cliques__Visit2_21;
                  MR_Word cliques__next_value_of_HeadVar__4_4 = cliques__Dfs2_23;
        ...
        if (cliques__succeeded)
          *cliques__Acc_6 = cliques__Acc0_5;
        else
          {
            ...
            cliques__Var_9 = (cliques__N_4 - (MR_Integer) 1);
            /* direct tailcall eliminated */
            {
              MR_Integer cliques__next_value_of_N_4 = cliques__Var_9;
              MR_Word cliques__next_value_of_Acc0_5 = cliques__Acc1_7;

              cliques__Acc0_5 = cliques__next_value_of_Acc0_5;
              cliques__N_4 = cliques__next_value_of_N_4;
            }
            continue;
          }
      }
        ...
        if (cliques__succeeded)
          {
            ...
            MR_ArrayPtr cliques__Var_15;
            MR_Integer cliques__Var_16;
            MR_Box cliques__conv0_Tos0_10;
            MR_Box cliques__conv1_Var_15;
            ...
            {
              cliques__conv1_Var_15 = array_util__u_1_f_0((MR_Word) &cliques_scalar_common_1[1], ((MR_Box) (cliques__Array0_6)));
            }
            cliques__Var_15 = ((MR_ArrayPtr) cliques__conv1_Var_15);
            {
              mercury__array__set_4_p_0(cliques__TypeInfo_24_24, cliques__From_7, ((MR_Box) (cliques__Tos_11)), (MR_ArrayPtr) cliques__Var_15, &cliques__conv2_Array_12);
            }
            cliques__Array_12 = (MR_ArrayPtr) cliques__conv2_Array_12;
            {
              cliques__Var_16 = mercury__int__max_2_f_0(cliques__From_7, cliques__To_8);
            }
            {
              cliques__Size_13 = mercury__int__max_2_f_0(cliques__Var_16, cliques__Size0_5);
            }
            {
              MR_Word base;
        ...
        else
          {
            ...
            MR_Integer cliques__Var_17;
            MR_Word cliques__Var_18;
            MR_ArrayPtr cliques__Var_19;
            MR_Word cliques__Var_21;
            MR_Integer cliques__Size_22;
            MR_Box cliques__conv3_Var_19;
            ...
            cliques__Var_17 = (cliques__Size_22 * (MR_Integer) 2);
            {
              cliques__Var_18 = mercury__set__init_0_f_0((MR_Word) &mercury__builtin__builtin__type_ctor_info_int_0);
            }
            {
              cliques__conv3_Var_19 = array_util__u_1_f_0((MR_Word) &cliques_scalar_common_1[1], ((MR_Box) (cliques__Array0_6)));
            }
            cliques__Var_19 = ((MR_ArrayPtr) cliques__conv3_Var_19);
            {
              mercury__array__resize_4_p_0(cliques__TypeInfo_27_27, cliques__Var_17, ((MR_Box) (cliques__Var_18)), (MR_ArrayPtr) cliques__Var_19, &cliques__conv4_Array1_14);
            }
            cliques__Array1_14 = (MR_ArrayPtr) cliques__conv4_Array1_14;
            {
              cliques__Var_21 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
              MR_hl_field(MR_mktag(0), cliques__Var_21, 0) = ((MR_Box) (cliques__Size0_5));
              MR_hl_field(MR_mktag(0), cliques__Var_21, 1) = ((MR_Box) (cliques__Array1_14));
            }
            /* direct tailcall eliminated */
            {
              MR_Word cliques__next_value_of_HeadVar__1_1 = cliques__Var_21;
...
{
  {
    ...
    MR_Word cliques__Var_5;
    MR_ArrayPtr cliques__conv0_Array_2;

    {
      cliques__Var_5 = mercury__set__init_0_f_0((MR_Word) &mercury__builtin__builtin__type_ctor_info_int_0);
    }
    {
      mercury__array__init_3_p_0((MR_Word) &cliques_scalar_common_1[0], (MR_Integer) 16, ((MR_Box) (cliques__Var_5)), &cliques__conv0_Array_2);
    }
