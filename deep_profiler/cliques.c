...
{
  {
    ...
    if (cliques__succeeded)
      *cliques__HeadVar__1_1 = (MR_Integer) 0;
      ...
      {
        MR_Integer cliques__Var_4 = ((MR_Integer) (MR_hl_field(MR_mktag(0), cliques__HeadVar__2_2, (MR_Integer) 0)));
        MR_ArrayPtr cliques__Var_5 = ((MR_ArrayPtr) (MR_hl_field(MR_mktag(0), cliques__HeadVar__2_2, (MR_Integer) 1)));
        MR_Integer cliques__Var_6 = ((MR_Integer) (MR_hl_field(MR_mktag(0), cliques__HeadVar__3_3, (MR_Integer) 0)));
        MR_ArrayPtr cliques__Var_7 = ((MR_ArrayPtr) (MR_hl_field(MR_mktag(0), cliques__HeadVar__3_3, (MR_Integer) 1)));
        MR_Word cliques__Var_8;

        {
          mercury__private_builtin__builtin_compare_int_3_p_0(&cliques__Var_8, cliques__Var_4, cliques__Var_6);
        }
        ...
        if (cliques__succeeded)
          *cliques__HeadVar__1_1 = cliques__Var_8;
          ...
          {
            {
              mercury__builtin__compare_3_p_0((MR_Word) &cliques_scalar_common_1[1], cliques__HeadVar__1_1, ((MR_Box) (cliques__Var_5)), ((MR_Box) (cliques__Var_7)));
            }
          }
      }
  }
...
{
  {
    ...
    if (cliques__succeeded)
    ...
    else
      {
        ...
        MR_Integer cliques__Var_3 = ((MR_Integer) (MR_hl_field(MR_mktag(0), cliques__HeadVar__1_1, (MR_Integer) 0)));
        MR_ArrayPtr cliques__Var_4 = ((MR_ArrayPtr) (MR_hl_field(MR_mktag(0), cliques__HeadVar__1_1, (MR_Integer) 1)));
        MR_Integer cliques__Var_5 = ((MR_Integer) (MR_hl_field(MR_mktag(0), cliques__HeadVar__2_2, (MR_Integer) 0)));
        MR_ArrayPtr cliques__Var_6 = ((MR_ArrayPtr) (MR_hl_field(MR_mktag(0), cliques__HeadVar__2_2, (MR_Integer) 1)));

        cliques__succeeded = (cliques__Var_3 == cliques__Var_5);
        if (cliques__succeeded)
          {
            cliques__TypeInfo_9_9 = (MR_Word) &cliques_scalar_common_1[0];
            {
              cliques__succeeded = mercury__array____Unify____array_1_0(cliques__TypeInfo_9_9, (MR_ArrayPtr) cliques__Var_4, (MR_ArrayPtr) cliques__Var_6);
            }
          }
      }
    return cliques__succeeded;
