...
MR_decl_label8(cliques__dfs_6_0, 33,3,6,4,9,11,10,14)
MR_decl_label2(cliques__dfs_6_0, 16,17)
MR_decl_label3(cliques__dfs_graph_2_5_0, 10,3,4)
...
MR_decl_label6(cliques__tsort_5_0, 21,3,6,4,8,9)
MR_decl_label2(__Unify___cliques__graph_0_0, 6,1)
MR_decl_label4(__Compare___cliques__graph_0_0, 3,2,5,21)
...
MR_BEGIN_MODULE(cliques_module2)
	...
	MR_init_label8(cliques__dfs_6_0,33,3,6,4,9,11,10,14)
	MR_init_label2(cliques__dfs_6_0,16,17)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(cliques_module3)
	...
	MR_init_label6(cliques__tsort_5_0,21,3,6,4,8,9)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(cliques_module5)
	...
	MR_init_label3(cliques__dfs_graph_2_5_0,10,3,4)
MR_BEGIN_CODE
...
MR_def_label(cliques__dfs_graph_2_5_0,10)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
...
MR_def_label(cliques__dfs_graph_2_5_0,4)
	...
	MR_GOTO_LAB(cliques__dfs_graph_2_5_0_i10);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_thread_engine_base
#endif
...
MR_BEGIN_MODULE(cliques_module10)
	...
	MR_init_label4(__Compare___cliques__graph_0_0,3,2,5,21)
MR_BEGIN_CODE
...
MR_def_label(__Compare___cliques__graph_0_0,5)
	...
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___cliques__graph_0_0_i21);
	}
	MR_r1 = (MR_Word) MR_TAG_COMMON(0,0,0);
	MR_r2 = MR_sv(1);
	MR_r3 = MR_sv(2);
...
MR_def_label(__Compare___cliques__graph_0_0,21)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(3);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
