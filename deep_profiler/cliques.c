...
{
  {
    ...
    else
    {
      ...
      {
        mercury__builtin__compare_3_p_0((MR_Word) &cliques_scalar_common_1[1], HeadVar__1_1, ((MR_Box) (ArgX2_6)), ((MR_Box) (ArgY2_7)));
      }
    }
  }
}
...
{
  {
    ...
    MR_ArrayPtr Visit_8;
    MR_Word Cliques0_9;
    MR_Integer Size_40 = ((MR_Integer) (MR_hl_field(MR_mktag(0), Graph_3, (MR_Integer) 0)));
    MR_Word NodeList_42;
    MR_ArrayPtr Visit_43;
    MR_Word InvGraph0_48;
    MR_Integer Size_49;
    MR_ArrayPtr Array_51;
    MR_Word Var_54;
    MR_ArrayPtr _Array_41 = ((MR_ArrayPtr) (MR_hl_field(MR_mktag(0), Graph_3, (MR_Integer) 1)));
    MR_ArrayPtr conv0_Array_51;
    MR_ArrayPtr _Array_50;

    cliques__mklist_3_p_0(Size_40, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), &NodeList_42);
    Visit_43 = dense_bitset__init_0_f_0();
    cliques__dfs_graph_2_5_p_0(NodeList_42, Graph_3, Visit_43, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), &Dfs_6);
    ...
    {
      InvGraph0_48 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), InvGraph0_48, 0) = ((MR_Box) ((MR_Integer) 1));
      MR_hl_field(MR_mktag(0), InvGraph0_48, 1) = ((MR_Box) (Array_51));
    }
    Size_49 = ((MR_Integer) (MR_hl_field(MR_mktag(0), Graph_3, (MR_Integer) 0)));
    _Array_50 = ((MR_ArrayPtr) (MR_hl_field(MR_mktag(0), Graph_3, (MR_Integer) 1)));
    cliques__inverse_2_4_p_0(Size_49, Graph_3, InvGraph0_48, &InvGraph_7);
    Visit_8 = dense_bitset__init_0_f_0();
    cliques__tsort_5_p_0(Dfs_6, InvGraph_7, Visit_8, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), &Cliques0_9);
    cliques__f_85_110_117_115_101_100_65_114_103_115_95_95_112_114_101_100_95_95_114_101_118_101_114_115_101_95_95_91_49_93_95_48_3_p_0(Cliques0_9, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), Cliques_4);
  }
}
  ...
  MR_Word * InvGraph_8)
{
  while (MR_TRUE)
  {
    ...
    if (succeeded)
    {
      ...
      MR_Integer Var_13;
      MR_ArrayPtr Array_19 = ((MR_ArrayPtr) (MR_hl_field(MR_mktag(0), Graph_6, (MR_Integer) 1)));
      MR_Integer _Size_18 = ((MR_Integer) (MR_hl_field(MR_mktag(0), Graph_6, (MR_Integer) 0)));

      succeeded = mercury__array__in_bounds_2_p_0((MR_Word) &cliques_scalar_common_1[0], (MR_ArrayPtr) Array_19, To_5);
      if (succeeded)
      {
        MR_Box conv0_Froms_9;

        mercury__array__lookup_3_p_0((MR_Word) &cliques_scalar_common_1[0], (MR_ArrayPtr) Array_19, To_5, &conv0_Froms_9);
      ...
      Var_13 = (To_5 - (MR_Integer) 1);
      /* direct tailcall eliminated */
      {
        MR_Integer next_value_of_To_5 = Var_13;
        MR_Word next_value_of_InvGraph0_7 = InvGraph1_11;
  ...
  MR_Word * Graph_4)
{
  while (MR_TRUE)
  {
    ...
    {
      MR_Integer From_7 = ((MR_Integer) (MR_hl_field(MR_mktag(1), HeadVar__1_1, (MR_Integer) 0)));
      MR_Word FromList_8 = ((MR_Word) (MR_hl_field(MR_mktag(1), HeadVar__1_1, (MR_Integer) 1)));
      MR_Word Graph1_12;

      cliques__add_arc_4_p_0(HeadVar__3_3, From_7, To_2, &Graph1_12);
      /* direct tailcall eliminated */
      {
        MR_Word next_value_of_HeadVar__1_1 = FromList_8;
        MR_Word next_value_of_HeadVar__3_3 = Graph1_12;
  ...
  MR_Word * Dfs_5)
{
  while (MR_TRUE)
  {
    ...
    {
      MR_Integer Node_9 = ((MR_Integer) (MR_hl_field(MR_mktag(1), HeadVar__1_1, (MR_Integer) 0)));
...

      {
        ...
        MR_hl_field(MR_mktag(1), Var_17, 0) = ((MR_Box) (Node_9));
      ...
      /* direct tailcall eliminated */
      {
        MR_Word next_value_of_HeadVar__1_1 = Nodes_10;
        MR_ArrayPtr next_value_of_HeadVar__3_3 = Visit_15;
        MR_Word next_value_of_HeadVar__4_4 = Dfs1_16;
  ...
  MR_Word * STATE_VARIABLE_Cliques_5)
{
  while (MR_TRUE)
  {
    ...
    {
      MR_Integer Node_11 = ((MR_Integer) (MR_hl_field(MR_mktag(1), HeadVar__1_1, (MR_Integer) 0)));
      MR_Word Nodes_12 = ((MR_Word) (MR_hl_field(MR_mktag(1), HeadVar__1_1, (MR_Integer) 1)));
      MR_ArrayPtr STATE_VARIABLE_Visited_39_39;
      MR_Word STATE_VARIABLE_Cliques_49_49;

      succeeded = dense_bitset__member_2_p_0(Node_11, HeadVar__3_3);
      if (succeeded)
      {
        STATE_VARIABLE_Cliques_49_49 = STATE_VARIABLE_Cliques_0_4;
        STATE_VARIABLE_Visited_39_39 = HeadVar__3_3;
      }
      else
      {
        MR_Word CliqueList_17;
        MR_Word Clique_18;
        MR_Word Var_37;

        {
          Var_37 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), Var_37, 0) = ((MR_Box) (Node_11));
          MR_hl_field(MR_mktag(1), Var_37, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
        }
        cliques__dfs_6_p_0(Var_37, HeadVar__2_2, HeadVar__3_3, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), &STATE_VARIABLE_Visited_39_39, &CliqueList_17);
        mercury__set__list_to_set_2_p_0((MR_Word) &mercury__builtin__builtin__type_ctor_info_int_0, CliqueList_17, &Clique_18);
        {
          STATE_VARIABLE_Cliques_49_49 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), STATE_VARIABLE_Cliques_49_49, 0) = ((MR_Box) (Clique_18));
          MR_hl_field(MR_mktag(1), STATE_VARIABLE_Cliques_49_49, 1) = ((MR_Box) (STATE_VARIABLE_Cliques_0_4));
        }
      }
      /* direct tailcall eliminated */
      {
        MR_Word next_value_of_HeadVar__1_1 = Nodes_12;
        MR_ArrayPtr next_value_of_HeadVar__3_3 = STATE_VARIABLE_Visited_39_39;
        MR_Word next_value_of_STATE_VARIABLE_Cliques_0_4 = STATE_VARIABLE_Cliques_49_49;
  ...
  MR_Word * Dfs_6)
{
  while (MR_TRUE)
  {
    ...
    {
      MR_Integer Node_10 = ((MR_Integer) (MR_hl_field(MR_mktag(1), HeadVar__1_1, (MR_Integer) 0)));
      MR_Word Nodes_11 = ((MR_Word) (MR_hl_field(MR_mktag(1), HeadVar__1_1, (MR_Integer) 1)));
      ...
      {
        MR_ArrayPtr Visit1_18;
        MR_Word Succ_19;
        MR_Word SuccList_20;
        MR_ArrayPtr Visit2_21;
        MR_Word Dfs1_22;
        MR_Word Dfs2_23;
        MR_ArrayPtr Array_38;
        MR_Integer _Size_37;

        Visit1_18 = dense_bitset__insert_2_f_0(HeadVar__3_3, Node_10);
        _Size_37 = ((MR_Integer) (MR_hl_field(MR_mktag(0), HeadVar__2_2, (MR_Integer) 0)));
        Array_38 = ((MR_ArrayPtr) (MR_hl_field(MR_mktag(0), HeadVar__2_2, (MR_Integer) 1)));
        succeeded = mercury__array__in_bounds_2_p_0((MR_Word) &cliques_scalar_common_1[0], (MR_ArrayPtr) Array_38, Node_10);
        if (succeeded)
        {
          MR_Box conv0_Succ_19;

          mercury__array__lookup_3_p_0((MR_Word) &cliques_scalar_common_1[0], (MR_ArrayPtr) Array_38, Node_10, &conv0_Succ_19);
          Succ_19 = ((MR_Word) conv0_Succ_19);
        }
        else
        {
          Succ_19 = mercury__set__init_0_f_0((MR_Word) &mercury__builtin__builtin__type_ctor_info_int_0);
        }
        mercury__set__to_sorted_list_2_p_0((MR_Word) &mercury__builtin__builtin__type_ctor_info_int_0, Succ_19, &SuccList_20);
        cliques__dfs_6_p_0(SuccList_20, HeadVar__2_2, Visit1_18, HeadVar__4_4, &Visit2_21, &Dfs1_22);
        {
          Dfs2_23 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), Dfs2_23, 0) = ((MR_Box) (Node_10));
          MR_hl_field(MR_mktag(1), Dfs2_23, 1) = ((MR_Box) (Dfs1_22));
        }
        /* direct tailcall eliminated */
        {
          MR_Word next_value_of_HeadVar__1_1 = Nodes_11;
          MR_ArrayPtr next_value_of_HeadVar__3_3 = Visit2_21;
          MR_Word next_value_of_HeadVar__4_4 = Dfs2_23;
  ...
  MR_Word * Acc_6)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      {
        Acc1_7 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), Acc1_7, 0) = ((MR_Box) (N_4));
        MR_hl_field(MR_mktag(1), Acc1_7, 1) = ((MR_Box) (Acc0_5));
      }
      Var_9 = (N_4 - (MR_Integer) 1);
      /* direct tailcall eliminated */
      {
        MR_Integer next_value_of_N_4 = Var_9;
        MR_Word next_value_of_Acc0_5 = Acc1_7;
  ...
  MR_Word * Graph_9)
{
  ...
  {
    MR_bool succeeded;
    MR_Integer Size0_5 = ((MR_Integer) (MR_hl_field(MR_mktag(0), HeadVar__1_1, (MR_Integer) 0)));
    MR_ArrayPtr Array0_6 = ((MR_ArrayPtr) (MR_hl_field(MR_mktag(0), HeadVar__1_1, (MR_Integer) 1)));

    /* setup for tailcalls optimized into a loop */
    succeeded = mercury__array__in_bounds_2_p_0((MR_Word) &cliques_scalar_common_1[0], (MR_ArrayPtr) Array0_6, From_7);
    if (succeeded)
    {
      MR_Word TypeInfo_24_24 = (MR_Word) &cliques_scalar_common_1[0];
      MR_Word Tos0_10;
      MR_Word Tos_11;
      ...
      mercury__array__lookup_3_p_0(TypeInfo_24_24, (MR_ArrayPtr) Array0_6, From_7, &conv0_Tos0_10);
      ...
      mercury__array__set_4_p_0(TypeInfo_24_24, From_7, ((MR_Box) (Tos_11)), (MR_ArrayPtr) Var_15, &conv2_Array_12);
      ...
      Size_13 = mercury__int__max_2_f_0(Var_16, Size0_5);
      {
        ...
        *Graph_9 = base;
        ...
        MR_hl_field(MR_mktag(0), base, 1) = ((MR_Box) (Array_12));
      }
    }
    else
    {
      MR_Word TypeInfo_27_27 = (MR_Word) &cliques_scalar_common_1[0];
      ...
      mercury__array__size_2_p_0(TypeInfo_27_27, (MR_ArrayPtr) Array0_6, &Size_22);
      Var_17 = (Size_22 * (MR_Integer) 2);
      ...
      mercury__array__resize_4_p_0(TypeInfo_27_27, Var_17, ((MR_Box) (Var_18)), (MR_ArrayPtr) Var_19, &conv4_Array1_14);
      Array1_14 = (MR_ArrayPtr) conv4_Array1_14;
      {
        Var_21 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), Var_21, 0) = ((MR_Box) (Size0_5));
        MR_hl_field(MR_mktag(0), Var_21, 1) = ((MR_Box) (Array1_14));
      }
      /* direct tailcall eliminated */
      {
...
{
  {
    ...
    Array_2 = (MR_ArrayPtr) conv0_Array_2;
    {
      ...
      *HeadVar__1_1 = base;
      ...
      MR_hl_field(MR_mktag(0), base, 1) = ((MR_Box) (Array_2));
    }
  }
}
