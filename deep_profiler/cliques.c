...
MR_decl_label10(cliques__add_arc_4_0, 30,4,6,7,9,10,11,12,2,15)
MR_decl_label3(cliques__add_arc_4_0, 16,18,19)
MR_decl_label3(cliques__add_arcs_to_4_0, 10,3,4)
MR_decl_label10(cliques__dfs_6_0, 41,3,6,4,9,12,10,15,17,18)
MR_decl_label3(cliques__dfs_graph_2_5_0, 14,3,5)
MR_decl_label2(cliques__init_1_0, 2,4)
MR_decl_label7(cliques__inverse_2_4_0, 27,5,3,8,10,11,2)
...
MR_decl_label4(__Compare___cliques__graph_0_0, 3,2,5,28)
...
MR_BEGIN_MODULE(cliques_module1)
	...
	MR_init_label10(cliques__add_arc_4_0,30,4,6,7,9,10,11,12,2,15)
	MR_init_label3(cliques__add_arc_4_0,16,18,19)
MR_BEGIN_CODE
...
MR_def_label(cliques__add_arc_4_0,30)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
...
MR_def_label(cliques__add_arc_4_0,15)
	...
	MR_r1 = (MR_Word) MR_INT_CTOR_ADDR;
	MR_np_call_localret_ent(fn__set__init_0_0,
		cliques__add_arc_4_0_i16);
MR_def_label(cliques__add_arc_4_0,16)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_sv(4);
...
MR_def_label(cliques__add_arc_4_0,19)
	...
	MR_GOTO_LAB(cliques__add_arc_4_0_i30);
	}
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_thread_engine_base
...
MR_BEGIN_MODULE(cliques_module2)
	...
	MR_init_label10(cliques__dfs_6_0,41,3,6,4,9,12,10,15,17,18)
MR_BEGIN_CODE
...
MR_def_label(cliques__dfs_6_0,41)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_def_label(cliques__dfs_6_0,6)
	...
	MR_GOTO_LAB(cliques__dfs_6_0_i41);
...
MR_BEGIN_MODULE(cliques_module7)
	...
	MR_init_label7(cliques__inverse_2_4_0,27,5,3,8,10,11,2)
MR_BEGIN_CODE
...
MR_def_static(cliques__inverse_2_4_0)
	...
	MR_incr_sp(6);
	MR_sv(6) = (MR_Word) MR_succip;
MR_def_label(cliques__inverse_2_4_0,27)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_def_label(cliques__inverse_2_4_0,11)
	...
	MR_r3 = MR_tempr1;
	MR_succip_word = MR_sv(6);
	MR_GOTO_LAB(cliques__inverse_2_4_0_i27);
	}
...
MR_BEGIN_MODULE(cliques_module10)
	...
	MR_init_label4(__Compare___cliques__graph_0_0,3,2,5,28)
MR_BEGIN_CODE
...
MR_def_label(__Compare___cliques__graph_0_0,5)
	...
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___cliques__graph_0_0_i28);
	}
	MR_r1 = (MR_Word) MR_TAG_COMMON(0,0,0);
	MR_r2 = MR_sv(1);
	MR_r3 = MR_sv(2);
...
MR_def_label(__Compare___cliques__graph_0_0,28)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(3);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
