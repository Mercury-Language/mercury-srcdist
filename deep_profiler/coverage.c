...
{
  {
    ...
    else
    {
      ...
      MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Goal_8, (MR_Integer) 1)));
...
{
  {
    ...
    packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Var_19, (MR_Integer) 4)));
  ...
  MR_Word * STATE_VARIABLE_Array_8)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Disj_18, (MR_Integer) 1)));
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      else
      {
        ...
        MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Goal_35, (MR_Integer) 1)));
...
{
  {
    ...
    MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Cond_10, (MR_Integer) 1)));
          ...
          case (MR_Integer) 0:
            {
              ...
              MR_Unsigned packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Then_11, (MR_Integer) 1)));
      ...
      case (MR_Integer) 2:
        {
          ...
          MR_Unsigned packed_word_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Else_12, (MR_Integer) 1)));
              ...
              case (MR_Integer) 0:
                {
                  ...
                  MR_Unsigned packed_word_4 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Else_12, (MR_Integer) 1)));
                        ...
                        case (MR_Integer) 0:
                          {
                            ...
                            MR_Unsigned packed_word_5 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Else_12, (MR_Integer) 1)));
                    ...
                    case (MR_Integer) 0:
                      {
                        ...
                        MR_Unsigned packed_word_3 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Else_12, (MR_Integer) 1)));
...
{
  {
    ...
    MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Goal_7, (MR_Integer) 1)));
      ...
      case (MR_Integer) 2:
        {
          ...
          MR_Unsigned packed_word_4 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), GoalExpr_12, (MR_Integer) 1)));
          ...
          case (MR_Integer) 2:
            {
              ...
              MR_Unsigned packed_word_3 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), GoalExpr_12, (MR_Integer) 2)));
                    ...
                    case (MR_Integer) 7:
                      {
                        ...
                        {
                          TypeInfo_168_168 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
                        ...
                        if (succeeded)
                        {
                          ...
                          MR_Word Var_81;
                          MR_Word Var_83;
                          MR_Unsigned packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Cost_42, (MR_Integer) 3)));
                          ...
                          packed_word_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Cost_42, (MR_Integer) 3)));
