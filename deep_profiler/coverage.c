      ...
      case (MR_Integer) 1:
        {
...

          {
            ...
            MR_hl_field(MR_mktag(0), Var_82, 0) = ((MR_Box) (&coverage_scalar_common_4[0]));
          ...
          mercury__list__foldl_4_p_0((MR_Word) (&coverage_scalar_common_1[0]), (MR_Word) (&coverage_scalar_common_1[2]), Var_82, Cases_8, ((MR_Box) (MR_mkword(MR_mktag(1), &coverage_scalar_common_5[0]))), &conv1_MaybeSum_79);
                    ...
                    case (MR_Integer) 7:
                      {
                        ...
                        if (succeeded)
                        {
                          ...
                          Var_84 = coverage__before_coverage_1_f_0(Calls_43);
                          {
                            ...
                            MR_hl_field(MR_mktag(0), Var_82, 0) = ((MR_Box) (&coverage_scalar_common_3[1]));
