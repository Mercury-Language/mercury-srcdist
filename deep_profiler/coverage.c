  ...
  MR_Word HeadVar__2_91)
{
  ...
  succeeded = coverage____Unify____coverage_before_0_0(Before_9, HeadVar__2_91);
  return succeeded;
}
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
        ...
        case (MR_Integer) 0:
          switch (MR_unmkbody(Before0_4)) {
            ...
            case (MR_Integer) 0:
              {
                MR_Word CP_50;
                MR_Word Var_54 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Info_2, (MR_Integer) 3))));
                MR_Box conv1_CP_50;

                succeeded = mercury__map__search_3_p_0((MR_Word) (&mdbcomp__goal_path__mdbcomp__goal_path__type_ctor_info_reverse_goal_path_0), (MR_Word) (&coverage__coverage__type_ctor_info_coverage_point_0), Var_54, ((MR_Box) (DisjRevGoalPath_25)), &conv1_CP_50);
                if (succeeded)
                {
                  CP_50 = ((MR_Word) (conv1_CP_50));
                  succeeded = MR_TRUE;
                }
                if (succeeded)
                {
                  MR_Integer ExecCount_51 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), CP_50, (MR_Integer) 0))));

                  succeeded = (ExecCount_51 == (MR_Integer) 0);
                  if (succeeded)
                    Before_27 = (MR_Word) ((MR_Unsigned) 4U);
                  else
                    {
                      Before_27 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                      MR_hl_field(MR_mktag(1), Before_27, 0) = ((MR_Box) (ExecCount_51));
                    }
                }
                else
      ...
      switch (MR_tag((MR_Word) STATE_VARIABLE_SumAfter_0_5)) {
          ...
          switch (MR_unmkbody(STATE_VARIABLE_SumAfter_0_5)) {
            ...
            case (MR_Integer) 1:
              switch (MR_tag((MR_Word) After_28)) {
                ...
                case (MR_Integer) 1:
                  {
                    MR_Integer ExecCount_73 = ((MR_Integer) ((MR_hl_field(MR_mktag(1), After_28, (MR_Integer) 0))));

                    {
                      STATE_VARIABLE_SumAfter_36_36 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                      MR_hl_field(MR_mktag(1), STATE_VARIABLE_SumAfter_36_36, 0) = ((MR_Box) (ExecCount_73));
                    }
                  }
                  break;
              }
        ...
        case (MR_Integer) 1:
          {
            MR_Integer SumExecCount_66 = ((MR_Integer) ((MR_hl_field(MR_mktag(1), STATE_VARIABLE_SumAfter_0_5, (MR_Integer) 0))));
            ...
            switch (MR_tag((MR_Word) After_28)) {
              ...
              case (MR_Integer) 1:
                {
                  MR_Integer ExecCount_67 = ((MR_Integer) ((MR_hl_field(MR_mktag(1), After_28, (MR_Integer) 0))));
                  MR_Integer Var_69 = (MR_Integer) ((MR_Unsigned) SumExecCount_66 + (MR_Unsigned) ExecCount_67);

                  {
                    STATE_VARIABLE_SumAfter_36_36 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(MR_mktag(1), STATE_VARIABLE_SumAfter_36_36, 0) = ((MR_Box) (Var_69));
                  }
                }
                break;
            }
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      else
      {
        ...
        Var_68 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Info_2, (MR_Integer) 3))));
        succeeded = mercury__map__search_3_p_0((MR_Word) (&mdbcomp__goal_path__mdbcomp__goal_path__type_ctor_info_reverse_goal_path_0), (MR_Word) (&coverage__coverage__type_ctor_info_coverage_point_0), Var_68, ((MR_Box) (RevCaseGoalPath_34)), &conv1_CP_64);
        if (succeeded)
        {
          CP_64 = ((MR_Word) (conv1_CP_64));
          succeeded = MR_TRUE;
        }
        if (succeeded)
        {
          MR_Integer ExecCount_65 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), CP_64, (MR_Integer) 0))));

          succeeded = (ExecCount_65 == (MR_Integer) 0);
          if (succeeded)
            BeforeCase_33 = (MR_Word) ((MR_Unsigned) 4U);
          else
            {
              BeforeCase_33 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), BeforeCase_33, 0) = ((MR_Box) (ExecCount_65));
            }
        }
        else
      ...
      switch (MR_tag((MR_Word) STATE_VARIABLE_SumBefore_0_5)) {
          ...
          switch (MR_unmkbody(STATE_VARIABLE_SumBefore_0_5)) {
            ...
            case (MR_Integer) 1:
              switch (MR_tag((MR_Word) BeforeCase_33)) {
                ...
                case (MR_Integer) 1:
                  {
                    MR_Integer ExecCount_87 = ((MR_Integer) ((MR_hl_field(MR_mktag(1), BeforeCase_33, (MR_Integer) 0))));

                    {
                      STATE_VARIABLE_SumBefore_49_49 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                      MR_hl_field(MR_mktag(1), STATE_VARIABLE_SumBefore_49_49, 0) = ((MR_Box) (ExecCount_87));
                    }
                  }
                  break;
              }
        ...
        case (MR_Integer) 1:
          {
            MR_Integer SumExecCount_80 = ((MR_Integer) ((MR_hl_field(MR_mktag(1), STATE_VARIABLE_SumBefore_0_5, (MR_Integer) 0))));
            ...
            switch (MR_tag((MR_Word) BeforeCase_33)) {
              ...
              case (MR_Integer) 1:
                {
                  MR_Integer ExecCount_81 = ((MR_Integer) ((MR_hl_field(MR_mktag(1), BeforeCase_33, (MR_Integer) 0))));
                  MR_Integer Var_83 = (MR_Integer) ((MR_Unsigned) SumExecCount_80 + (MR_Unsigned) ExecCount_81);

                  {
                    STATE_VARIABLE_SumBefore_49_49 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(MR_mktag(1), STATE_VARIABLE_SumBefore_49_49, 0) = ((MR_Box) (Var_83));
                  }
                }
                break;
            }
  ...
  while (MR_TRUE)
  {
    ...
    if ((HeadVar__1_1 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      switch (MR_tag((MR_Word) Before_3)) {
        ...
        case (MR_Integer) 1:
          {
            MR_Integer Count_27 = ((MR_Integer) ((MR_hl_field(MR_mktag(1), Before_3, (MR_Integer) 0))));

            succeeded = (Count_27 == (MR_Integer) 0);
            if (succeeded)
              *After_4 = (MR_Word) ((MR_Unsigned) 4U);
            else
              {
                ...
                base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                *After_4 = base;
                MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (Count_27));
              }
          }
          break;
      }
    ...
    else
    {
      ...
      switch (MR_tag((MR_Word) CoverageAfterHead_19)) {
        ...
        case (MR_Integer) 1:
          {
            MR_Integer ExecCount_31 = ((MR_Integer) ((MR_hl_field(MR_mktag(1), CoverageAfterHead_19, (MR_Integer) 0))));

            {
              CoverageBeforeTail_20 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), CoverageBeforeTail_20, 0) = ((MR_Box) (ExecCount_31));
            }
          }
          break;
      }
    ...
    case (MR_Integer) 1:
      {
        MR_Word MaybeSum_79;
        MR_Word Var_82;
        MR_Box conv1_MaybeSum_79;

        {
          Var_82 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), Var_82, 0) = ((MR_Box) (&coverage_scalar_common_5[0]));
          MR_hl_field(MR_mktag(0), Var_82, 1) = ((MR_Box) (coverage__switch_annotate_coverage_7_p_0_1));
          MR_hl_field(MR_mktag(0), Var_82, 2) = ((MR_Box) ((MR_Integer) 1));
          MR_hl_field(MR_mktag(0), Var_82, 3) = ((MR_Box) (*STATE_VARIABLE_Array_20));
        }
        mercury__list__foldl_4_p_0((MR_Word) (&coverage_scalar_common_1[0]), (MR_Word) (&coverage_scalar_common_1[2]), Var_82, Cases_8, ((MR_Box) (MR_mkword(MR_mktag(1), &coverage_scalar_common_3[0]))), &conv1_MaybeSum_79);
        MaybeSum_79 = ((MR_Word) (conv1_MaybeSum_79));
        if ((MaybeSum_79 == (MR_Word) ((MR_Unsigned) 0U)))
          Result_18 = (MR_Integer) 1;
        else
        {
          MR_Integer SumA_80 = ((MR_Integer) ((MR_hl_field(MR_mktag(1), MaybeSum_79, (MR_Integer) 0))));
          ...
          switch (MR_tag((MR_Word) Before_11)) {
            ...
            case (MR_Integer) 0:
              switch (MR_unmkbody(Before_11)) {
                ...
                case (MR_Integer) 1:
                  {
                    succeeded = (SumA_80 == (MR_Integer) 0);
                    if (succeeded)
                      Result_18 = (MR_Integer) 1;
                    else
            ...
            case (MR_Integer) 1:
              {
                MR_Integer SumB_81 = ((MR_Integer) ((MR_hl_field(MR_mktag(1), Before_11, (MR_Integer) 0))));

                succeeded = (SumA_80 == SumB_81);
                if (succeeded)
                  Result_18 = (MR_Integer) 1;
                else
                  Result_18 = (MR_Integer) 0;
  ...
  switch (Detism_4) {
    ...
    case (MR_Integer) 7:
      switch (MR_tag((MR_Word) Coverage_3)) {
        ...
        case (MR_Integer) 1:
          {
            MR_Integer Exit_32 = ((MR_Integer) ((MR_hl_field(MR_mktag(1), Coverage_3, (MR_Integer) 0))));

            succeeded = (Exit_32 == (MR_Integer) 0);
          }
          break;
        case (MR_Integer) 2:
          {
        ...
        case (MR_Integer) 3:
          switch (((MR_Integer) ((MR_hl_field(MR_mktag(3), Coverage_3, (MR_Integer) 0))))) {
            ...
            case (MR_Integer) 1:
              {
                MR_Integer Exit_31 = ((MR_Integer) ((MR_hl_field(MR_mktag(3), Coverage_3, (MR_Integer) 1))));

                succeeded = (Exit_31 == (MR_Integer) 0);
              }
              break;
          }
          break;
          ...
          case (MR_Integer) 1:
            {
              ...
              MR_Integer Var_11 = (MR_Integer) ((MR_Unsigned) SumExecCount_6 + (MR_Unsigned) ExecCount_7);
