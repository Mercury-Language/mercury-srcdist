                  ...
                  case (MR_Integer) 7:
                    {
...

                      {
                        ...
                        MR_hl_field(MR_mktag(0), TypeInfo_167_167, 0) = ((MR_Box) (&analysis_utils__analysis_utils__type_ctor_info_cost_and_callees_1));
                        MR_hl_field(MR_mktag(0), TypeInfo_167_167, 1) = ((MR_Box) (TypeInfo_for_Callee_163));
                      }
                      succeeded = mercury__map__search_3_p_0((MR_Word) (&mdbcomp__goal_path__mdbcomp__goal_path__type_ctor_info_reverse_goal_path_0), TypeInfo_167_167, Var_79, ((MR_Box) (RevGoalPath_15)), &conv1_Cost_42);
                      if (succeeded)
                      {
