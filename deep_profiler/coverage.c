  ...
  while (MR_TRUE)
  {
    ...
    else
    {
        ...
        case (MR_Integer) 0:
          switch (MR_unmkbody(Before0_4)) {
            ...
            case (MR_Integer) 0:
              {
                MR_Word CP_47;
                MR_Word Var_51 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Info_2, (MR_Integer) 3))));
                MR_Box conv1_CP_47;
                ...
                if (succeeded)
                {
                  MR_Integer ExecCount_48 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), CP_47, (MR_Integer) 0))));
                  ...
                  if (succeeded)
                  ...
                  else
                    {
                      ...
                      MR_hl_field(MR_mktag(1), Before_27, 0) = ((MR_Box) (ExecCount_48));
                    }
                }
                else
      ...
      switch (MR_tag((MR_Word) STATE_VARIABLE_SumAfter_0_5)) {
                ...
                case (MR_Integer) 1:
                  {
...

                    {
                      ...
                      MR_hl_field(MR_mktag(1), STATE_VARIABLE_SumAfter_36_36, 0) = ((MR_Box) (ExecCount_61));
                    }
                  }
                  break;
              }
        ...
        case (MR_Integer) 1:
          {
            MR_Integer SumExecCount_58 = ((MR_Integer) ((MR_hl_field(MR_mktag(1), STATE_VARIABLE_SumAfter_0_5, (MR_Integer) 0))));
            ...
            switch (MR_tag((MR_Word) After_28)) {
              ...
              case (MR_Integer) 1:
                {
                  MR_Integer ExecCount_59 = ((MR_Integer) ((MR_hl_field(MR_mktag(1), After_28, (MR_Integer) 0))));
                  MR_Integer Var_60 = (MR_Integer) ((MR_Unsigned) SumExecCount_58 + (MR_Unsigned) ExecCount_59);

                  {
                    STATE_VARIABLE_SumAfter_36_36 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(MR_mktag(1), STATE_VARIABLE_SumAfter_36_36, 0) = ((MR_Box) (Var_60));
                  }
                }
                break;
            }
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      else
      {
        ...
        Var_64 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Info_2, (MR_Integer) 3))));
        ...
        if (succeeded)
        {
          MR_Integer ExecCount_61 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), CP_60, (MR_Integer) 0))));
          ...
          if (succeeded)
            ...
            {
              BeforeCase_33 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), BeforeCase_33, 0) = ((MR_Box) (ExecCount_61));
            }
        }
        else
      ...
      switch (MR_tag((MR_Word) STATE_VARIABLE_SumBefore_0_5)) {
          ...
          switch (MR_unmkbody(STATE_VARIABLE_SumBefore_0_5)) {
            ...
            case (MR_Integer) 1:
              switch (MR_tag((MR_Word) BeforeCase_33)) {
                ...
                case (MR_Integer) 1:
                  {
                    MR_Integer ExecCount_74 = ((MR_Integer) ((MR_hl_field(MR_mktag(1), BeforeCase_33, (MR_Integer) 0))));

                    {
                      STATE_VARIABLE_SumBefore_49_49 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                      MR_hl_field(MR_mktag(1), STATE_VARIABLE_SumBefore_49_49, 0) = ((MR_Box) (ExecCount_74));
                    }
                  }
                  break;
              }
        ...
        case (MR_Integer) 1:
          {
            MR_Integer SumExecCount_71 = ((MR_Integer) ((MR_hl_field(MR_mktag(1), STATE_VARIABLE_SumBefore_0_5, (MR_Integer) 0))));
            ...
            switch (MR_tag((MR_Word) BeforeCase_33)) {
              ...
              case (MR_Integer) 1:
                {
                  MR_Integer ExecCount_72 = ((MR_Integer) ((MR_hl_field(MR_mktag(1), BeforeCase_33, (MR_Integer) 0))));
                  MR_Integer Var_73 = (MR_Integer) ((MR_Unsigned) SumExecCount_71 + (MR_Unsigned) ExecCount_72);

                  {
                    STATE_VARIABLE_SumBefore_49_49 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(MR_mktag(1), STATE_VARIABLE_SumBefore_49_49, 0) = ((MR_Box) (Var_73));
                  }
                }
                break;
            }
      ...
      switch (MR_tag((MR_Word) STATE_VARIABLE_SumAfter_0_7)) {
          ...
          switch (MR_unmkbody(STATE_VARIABLE_SumAfter_0_7)) {
            ...
            case (MR_Integer) 1:
              switch (MR_tag((MR_Word) AfterCase_38)) {
                ...
                case (MR_Integer) 1:
                  {
                    MR_Integer ExecCount_78 = ((MR_Integer) ((MR_hl_field(MR_mktag(1), AfterCase_38, (MR_Integer) 0))));

                    {
                      STATE_VARIABLE_SumAfter_50_50 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                      MR_hl_field(MR_mktag(1), STATE_VARIABLE_SumAfter_50_50, 0) = ((MR_Box) (ExecCount_78));
                    }
                  }
                  break;
              }
        ...
        case (MR_Integer) 1:
          {
            MR_Integer SumExecCount_75 = ((MR_Integer) ((MR_hl_field(MR_mktag(1), STATE_VARIABLE_SumAfter_0_7, (MR_Integer) 0))));
            ...
            switch (MR_tag((MR_Word) AfterCase_38)) {
              ...
              case (MR_Integer) 1:
                {
                  MR_Integer ExecCount_76 = ((MR_Integer) ((MR_hl_field(MR_mktag(1), AfterCase_38, (MR_Integer) 0))));
                  MR_Integer Var_77 = (MR_Integer) ((MR_Unsigned) SumExecCount_75 + (MR_Unsigned) ExecCount_76);

                  {
                    STATE_VARIABLE_SumAfter_50_50 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(MR_mktag(1), STATE_VARIABLE_SumAfter_50_50, 0) = ((MR_Box) (Var_77));
                  }
                }
                break;
            }
  ...
  while (MR_TRUE)
  {
    ...
    if ((HeadVar__1_1 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      switch (MR_tag((MR_Word) Before_3)) {
        ...
        case (MR_Integer) 1:
          {
            MR_Integer Count_25 = ((MR_Integer) ((MR_hl_field(MR_mktag(1), Before_3, (MR_Integer) 0))));
            ...
            if (succeeded)
              *After_4 = (MR_Word) ((MR_Unsigned) 4U);
            else
              {
                ...
                base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                *After_4 = base;
                MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (Count_25));
              }
          }
          break;
      }
    ...
    else
    {
      ...
      switch (MR_tag((MR_Word) CoverageAfterHead_19)) {
        ...
        case (MR_Integer) 1:
          {
            MR_Integer ExecCount_26 = ((MR_Integer) ((MR_hl_field(MR_mktag(1), CoverageAfterHead_19, (MR_Integer) 0))));

            {
              CoverageBeforeTail_20 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), CoverageBeforeTail_20, 0) = ((MR_Box) (ExecCount_26));
            }
          }
          break;
      }
