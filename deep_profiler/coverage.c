              ...
              case (MR_Integer) 2:
                {
                  ...
                  mercury__private_builtin__builtin_compare_int_3_p_0(&SubResult1_34, Var_73, ArgY1_33);
                  succeeded = (SubResult1_34 != (MR_Integer) 0);
                  if (succeeded)
                    *HeadVar__1_1 = SubResult1_34;
                  else
                    mercury__private_builtin__builtin_compare_int_3_p_0(HeadVar__1_1, Var_72, ArgY2_36);
                }
                break;
              case (MR_Integer) 3:
                switch (((MR_Integer) ((MR_hl_field(MR_mktag(3), HeadVar__3_3, (MR_Integer) 0))))) {
