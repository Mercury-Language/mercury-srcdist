                    ...
                    case (MR_Integer) 1:
                      {
                        ...
                        MR_Integer Var_142 = (MR_Integer) ((MR_Unsigned) BeforeCount_141 - (MR_Unsigned) (MR_Integer) 0);
              ...
              switch (MR_tag((MR_Word) Before_15)) {
                ...
                case (MR_Integer) 0:
                  switch (MR_unmkbody(Before_15)) {
                    ...
                    case (MR_Integer) 1:
                      {
                        MR_Integer Var_140 = (MR_Integer) ((MR_Unsigned) (MR_Integer) 0 - (MR_Unsigned) BeforeThenCount_28);
