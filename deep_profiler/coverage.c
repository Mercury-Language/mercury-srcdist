...
coverage__ite_annotate_coverage_9_p_0(
  MR_Word TypeInfo_for_Callee_129,
  MR_Word Cond_10,
  MR_Word Then_11,
  MR_Word Else_12,
  MR_Word Info_13,
  ...
  MR_Word HeadVar__2_84)
{
  ...
  MR_Integer CastY_176 = (MR_Integer) (HeadVar__2_84);
  ...
  if (succeeded)
    ...
    switch (MR_tag((MR_Word) Before_9)) {
          ...
          case (MR_Integer) 0:
            {
              ...
              MR_Integer CastY_170 = (MR_Integer) (HeadVar__2_84);
          ...
          case (MR_Integer) 1:
            {
              ...
              MR_Integer CastY_172 = (MR_Integer) (HeadVar__2_84);
      ...
      case (MR_Integer) 1:
        {
          MR_Integer ArgX1_173 = ((MR_Integer) ((MR_hl_field(MR_mktag(1), Before_9, (MR_Integer) 0))));
          MR_Integer ArgY1_174;

          succeeded = ((MR_tag((MR_Word) HeadVar__2_84)) == (MR_Integer) 1);
          if (succeeded)
          {
            ArgY1_174 = ((MR_Integer) ((MR_hl_field(MR_mktag(1), HeadVar__2_84, (MR_Integer) 0))));
  ...
  else
  {
    ...
    else
    {
...

      {
        ...
        MR_hl_field(MR_mktag(0), TypeInfo__24_24, 0) = ((MR_Box) (&analysis_utils__analysis_utils__type_ctor_info_cost_and_callees_1));
        MR_hl_field(MR_mktag(0), TypeInfo__24_24, 1) = ((MR_Box) (TypeInfo_for_Callee_20));
      }
      mercury__tree234____Compare____tree234_2_0((MR_Word) (&mdbcomp__goal_path__mdbcomp__goal_path__type_ctor_info_reverse_goal_path_0), TypeInfo__24_24, &SubResult2_9, ArgX2_7, ArgY2_8);
  ...
  MR_Word HeadVar__2_2)
{
  ...
  else
  {
    ...
    if (succeeded)
    {
      TypeCtorInfo__17_17 = (MR_Word) (&mdbcomp__goal_path__mdbcomp__goal_path__type_ctor_info_reverse_goal_path_0);
      TypeCtorInfo__18_18 = (MR_Word) (&analysis_utils__analysis_utils__type_ctor_info_cost_and_callees_1);
      {
        TypeInfo__19_19 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), TypeInfo__19_19, 0) = ((MR_Box) (TypeCtorInfo__18_18));
        MR_hl_field(MR_mktag(0), TypeInfo__19_19, 1) = ((MR_Box) (TypeInfo_for_Callee_15));
      }
      succeeded = mercury__tree234____Unify____tree234_2_0(TypeCtorInfo__17_17, TypeInfo__19_19, ArgX2_5, ArgY2_6);
      if (succeeded)
      {
        TypeInfo__22_22 = (MR_Word) (&coverage_scalar_common_2[0]);
        succeeded = mercury__builtin__unify_2_p_0(TypeInfo__22_22, ((MR_Box) (ArgX3_7)), ((MR_Box) (ArgY3_8)));
        if (succeeded)
        {
          TypeInfo__23_23 = (MR_Word) (&coverage_scalar_common_2[0]);
          succeeded = mercury__builtin__unify_2_p_0(TypeInfo__23_23, ((MR_Box) (ArgX4_9)), ((MR_Box) (ArgY4_10)));
          if (succeeded)
          {
            TypeInfo__24_24 = (MR_Word) (&coverage_scalar_common_2[1]);
            succeeded = mercury__builtin__unify_2_p_0(TypeInfo__24_24, ((MR_Box) (ArgX5_11)), ((MR_Box) (ArgY5_12)));
          }
        }
      }
    }
  ...
  MR_Word * CoverageArray_18)
{
    ...
    }
  {
    ...
    MR_hl_field(MR_mktag(0), Var_26, 0) = ((MR_Box) (&coverage_scalar_common_4[2]));
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
        ...
        case (MR_Integer) 0:
          switch (MR_unmkbody(Before0_4)) {
            ...
            case (MR_Integer) 0:
              {
                MR_Word CP_49;
                MR_Word Var_53 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Info_2, (MR_Integer) 3))));
                MR_Box conv1_CP_49;

                succeeded = mercury__map__search_3_p_0((MR_Word) (&mdbcomp__goal_path__mdbcomp__goal_path__type_ctor_info_reverse_goal_path_0), (MR_Word) (&coverage__coverage__type_ctor_info_coverage_point_0), Var_53, ((MR_Box) (DisjRevGoalPath_25)), &conv1_CP_49);
                if (succeeded)
                {
                  CP_49 = ((MR_Word) (conv1_CP_49));
                  succeeded = MR_TRUE;
                }
                if (succeeded)
                {
                  MR_Integer ExecCount_50 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), CP_49, (MR_Integer) 0))));

                  succeeded = (ExecCount_50 == (MR_Integer) 0);
                  if (succeeded)
                    Before_27 = (MR_Word) ((MR_Unsigned) 4U);
                  else
                    {
                      Before_27 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                      MR_hl_field(MR_mktag(1), Before_27, 0) = ((MR_Box) (ExecCount_50));
                    }
                }
                else
      ...
      switch (MR_tag((MR_Word) STATE_VARIABLE_SumAfter_0_5)) {
          ...
          switch (MR_unmkbody(STATE_VARIABLE_SumAfter_0_5)) {
            ...
            case (MR_Integer) 1:
              switch (MR_tag((MR_Word) After_28)) {
                ...
                case (MR_Integer) 1:
                  {
                    MR_Integer ExecCount_63 = ((MR_Integer) ((MR_hl_field(MR_mktag(1), After_28, (MR_Integer) 0))));

                    {
                      STATE_VARIABLE_SumAfter_36_36 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                      MR_hl_field(MR_mktag(1), STATE_VARIABLE_SumAfter_36_36, 0) = ((MR_Box) (ExecCount_63));
                    }
                  }
                  break;
              }
        ...
        case (MR_Integer) 1:
          {
            MR_Integer SumExecCount_60 = ((MR_Integer) ((MR_hl_field(MR_mktag(1), STATE_VARIABLE_SumAfter_0_5, (MR_Integer) 0))));
            ...
            switch (MR_tag((MR_Word) After_28)) {
              ...
              case (MR_Integer) 1:
                {
                  MR_Integer ExecCount_61 = ((MR_Integer) ((MR_hl_field(MR_mktag(1), After_28, (MR_Integer) 0))));
                  MR_Integer Var_62 = (MR_Integer) ((MR_Unsigned) SumExecCount_60 + (MR_Unsigned) ExecCount_61);

                  {
                    STATE_VARIABLE_SumAfter_36_36 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(MR_mktag(1), STATE_VARIABLE_SumAfter_36_36, 0) = ((MR_Box) (Var_62));
                  }
                }
                break;
            }
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      else
      {
        ...
        Var_67 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Info_2, (MR_Integer) 3))));
        succeeded = mercury__map__search_3_p_0((MR_Word) (&mdbcomp__goal_path__mdbcomp__goal_path__type_ctor_info_reverse_goal_path_0), (MR_Word) (&coverage__coverage__type_ctor_info_coverage_point_0), Var_67, ((MR_Box) (RevCaseGoalPath_34)), &conv1_CP_63);
        if (succeeded)
        {
          CP_63 = ((MR_Word) (conv1_CP_63));
          succeeded = MR_TRUE;
        }
        if (succeeded)
        {
          MR_Integer ExecCount_64 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), CP_63, (MR_Integer) 0))));

          succeeded = (ExecCount_64 == (MR_Integer) 0);
          if (succeeded)
            BeforeCase_33 = (MR_Word) ((MR_Unsigned) 4U);
          else
            {
              BeforeCase_33 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), BeforeCase_33, 0) = ((MR_Box) (ExecCount_64));
            }
        }
        else
      ...
      switch (MR_tag((MR_Word) STATE_VARIABLE_SumBefore_0_5)) {
          ...
          switch (MR_unmkbody(STATE_VARIABLE_SumBefore_0_5)) {
            ...
            case (MR_Integer) 1:
              switch (MR_tag((MR_Word) BeforeCase_33)) {
                ...
                case (MR_Integer) 1:
                  {
                    MR_Integer ExecCount_77 = ((MR_Integer) ((MR_hl_field(MR_mktag(1), BeforeCase_33, (MR_Integer) 0))));

                    {
                      STATE_VARIABLE_SumBefore_49_49 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                      MR_hl_field(MR_mktag(1), STATE_VARIABLE_SumBefore_49_49, 0) = ((MR_Box) (ExecCount_77));
                    }
                  }
                  break;
              }
        ...
        case (MR_Integer) 1:
          {
            MR_Integer SumExecCount_74 = ((MR_Integer) ((MR_hl_field(MR_mktag(1), STATE_VARIABLE_SumBefore_0_5, (MR_Integer) 0))));
            ...
            switch (MR_tag((MR_Word) BeforeCase_33)) {
              ...
              case (MR_Integer) 1:
                {
                  MR_Integer ExecCount_75 = ((MR_Integer) ((MR_hl_field(MR_mktag(1), BeforeCase_33, (MR_Integer) 0))));
                  MR_Integer Var_76 = (MR_Integer) ((MR_Unsigned) SumExecCount_74 + (MR_Unsigned) ExecCount_75);

                  {
                    STATE_VARIABLE_SumBefore_49_49 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(MR_mktag(1), STATE_VARIABLE_SumBefore_49_49, 0) = ((MR_Box) (Var_76));
                  }
                }
                break;
            }
      ...
      switch (MR_tag((MR_Word) STATE_VARIABLE_SumAfter_0_7)) {
          ...
          switch (MR_unmkbody(STATE_VARIABLE_SumAfter_0_7)) {
            ...
            case (MR_Integer) 1:
              switch (MR_tag((MR_Word) AfterCase_38)) {
                ...
                case (MR_Integer) 1:
                  {
                    MR_Integer ExecCount_81 = ((MR_Integer) ((MR_hl_field(MR_mktag(1), AfterCase_38, (MR_Integer) 0))));

                    {
                      STATE_VARIABLE_SumAfter_50_50 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                      MR_hl_field(MR_mktag(1), STATE_VARIABLE_SumAfter_50_50, 0) = ((MR_Box) (ExecCount_81));
                    }
                  }
                  break;
              }
        ...
        case (MR_Integer) 1:
          {
            MR_Integer SumExecCount_78 = ((MR_Integer) ((MR_hl_field(MR_mktag(1), STATE_VARIABLE_SumAfter_0_7, (MR_Integer) 0))));
            ...
            switch (MR_tag((MR_Word) AfterCase_38)) {
              ...
              case (MR_Integer) 1:
                {
                  MR_Integer ExecCount_79 = ((MR_Integer) ((MR_hl_field(MR_mktag(1), AfterCase_38, (MR_Integer) 0))));
                  MR_Integer Var_80 = (MR_Integer) ((MR_Unsigned) SumExecCount_78 + (MR_Unsigned) ExecCount_79);

                  {
                    STATE_VARIABLE_SumAfter_50_50 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(MR_mktag(1), STATE_VARIABLE_SumAfter_50_50, 0) = ((MR_Box) (Var_80));
                  }
                }
                break;
            }
  ...
  while (MR_TRUE)
  {
    ...
    if ((HeadVar__1_1 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      switch (MR_tag((MR_Word) Before_3)) {
        ...
        case (MR_Integer) 1:
          {
            MR_Integer Count_26 = ((MR_Integer) ((MR_hl_field(MR_mktag(1), Before_3, (MR_Integer) 0))));

            succeeded = (Count_26 == (MR_Integer) 0);
            if (succeeded)
              *After_4 = (MR_Word) ((MR_Unsigned) 4U);
            else
              {
                ...
                base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                *After_4 = base;
                MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (Count_26));
              }
          }
          break;
      }
    ...
    else
    {
      ...
      switch (MR_tag((MR_Word) CoverageAfterHead_19)) {
        ...
        case (MR_Integer) 1:
          {
            MR_Integer ExecCount_27 = ((MR_Integer) ((MR_hl_field(MR_mktag(1), CoverageAfterHead_19, (MR_Integer) 0))));

            {
              CoverageBeforeTail_20 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), CoverageBeforeTail_20, 0) = ((MR_Box) (ExecCount_27));
            }
          }
          break;
      }
  ...
  MR_Word * STATE_VARIABLE_Array_37)
{
  ...
  coverage__goal_annotate_coverage_6_p_0(TypeInfo_for_Callee_129, Cond_10, Info_13, Before_15, &AfterCond_20, STATE_VARIABLE_Array_0_36, &STATE_VARIABLE_Array_38_38);
        ...
        case (MR_Integer) 0:
          {
            ...
            MR_Word Var_39 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Then_11, (MR_Integer) 2))));
    ...
    case (MR_Integer) 2:
      {
        ...
        MR_Word Var_43 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Else_12, (MR_Integer) 2))));
        MR_Box conv1_RevElseGoalPath_26;

        conv1_RevElseGoalPath_26 = mercury__map__lookup_2_f_0((MR_Word) (&mdbcomp__goal_path__mdbcomp__goal_path__type_ctor_info_goal_id_0), (MR_Word) (&mdbcomp__goal_path__mdbcomp__goal_path__type_ctor_info_reverse_goal_path_0), GoalPathMap_19, ((MR_Box) (Var_43)));
            ...
            case (MR_Integer) 0:
              {
                ...
                conv3_RevElseGoalPath_109 = mercury__map__lookup_2_f_0((MR_Word) (&mdbcomp__goal_path__mdbcomp__goal_path__type_ctor_info_goal_id_0), (MR_Word) (&mdbcomp__goal_path__mdbcomp__goal_path__type_ctor_info_reverse_goal_path_0), GoalPathMap_19, ((MR_Box) (Var_40)));
              ...
              switch (MR_tag((MR_Word) Before_15)) {
                ...
                case (MR_Integer) 0:
                  switch (MR_unmkbody(Before_15)) {
                    ...
                    case (MR_Integer) 0:
                      {
                        MR_Word Var_147 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Else_12, (MR_Integer) 2))));
                        MR_Word RevElseGoalPath_148;
                        MR_Box conv4_RevElseGoalPath_148;

                        conv4_RevElseGoalPath_148 = mercury__map__lookup_2_f_0((MR_Word) (&mdbcomp__goal_path__mdbcomp__goal_path__type_ctor_info_goal_id_0), (MR_Word) (&mdbcomp__goal_path__mdbcomp__goal_path__type_ctor_info_reverse_goal_path_0), GoalPathMap_19, ((MR_Box) (Var_147)));
                        RevElseGoalPath_148 = ((MR_Word) (conv4_RevElseGoalPath_148));
                        coverage__f_85_110_117_115_101_100_65_114_103_115_95_95_112_114_101_100_95_95_103_101_116_95_98_114_97_110_99_104_95_115_116_97_114_116_95_99_111_118_101_114_97_103_101_95_95_91_49_93_95_48_3_p_0(Info_13, RevElseGoalPath_148, &BeforeElse_27);
                      }
                      break;
                    case (MR_Integer) 1:
                ...
                case (MR_Integer) 1:
                  {
                    MR_Integer BeforeCount_143 = ((MR_Integer) ((MR_hl_field(MR_mktag(1), Before_15, (MR_Integer) 0))));
                    MR_Integer Var_144 = (MR_Integer) ((MR_Unsigned) BeforeCount_143 - (MR_Unsigned) 0);

                    BeforeElse_27 = coverage__before_coverage_1_f_0(Var_144);
                  }
                  break;
              }
              break;
            ...
            switch (MR_tag((MR_Word) Before_15)) {
              ...
              case (MR_Integer) 0:
                switch (MR_unmkbody(Before_15)) {
                  ...
                  case (MR_Integer) 0:
                    {
                      MR_Word Var_41 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Else_12, (MR_Integer) 2))));
                      MR_Word RevElseGoalPath_106;
                      MR_Box conv2_RevElseGoalPath_106;

                      conv2_RevElseGoalPath_106 = mercury__map__lookup_2_f_0((MR_Word) (&mdbcomp__goal_path__mdbcomp__goal_path__type_ctor_info_goal_id_0), (MR_Word) (&mdbcomp__goal_path__mdbcomp__goal_path__type_ctor_info_reverse_goal_path_0), GoalPathMap_19, ((MR_Box) (Var_41)));
                  ...
                  case (MR_Integer) 1:
                    {
                      MR_Integer Var_142 = (MR_Integer) ((MR_Unsigned) 0 - (MR_Unsigned) BeforeThenCount_28);
              ...
              case (MR_Integer) 1:
                {
                  ...
                  MR_Integer Var_42 = (MR_Integer) ((MR_Unsigned) BeforeCount_29 - (MR_Unsigned) BeforeThenCount_28);

                  BeforeElse_27 = coverage__before_coverage_1_f_0(Var_42);
                }
                break;
            }
          }
  ...
  coverage__goal_annotate_coverage_6_p_0(TypeInfo_for_Callee_129, Then_11, Info_13, BeforeThen_23, &AfterThen_32, STATE_VARIABLE_Array_38_38, &STATE_VARIABLE_Array_65_65);
  coverage__goal_annotate_coverage_6_p_0(TypeInfo_for_Callee_129, Else_12, Info_13, BeforeElse_27, &AfterElse_33, STATE_VARIABLE_Array_65_65, STATE_VARIABLE_Array_37);
  switch (MR_tag((MR_Word) AfterThen_32)) {
      ...
      switch (MR_unmkbody(AfterThen_32)) {
        ...
        case (MR_Integer) 1:
          switch (MR_tag((MR_Word) AfterElse_33)) {
            ...
            case (MR_Integer) 1:
              {
                MR_Integer AfterElseExecCount_112 = ((MR_Integer) ((MR_hl_field(MR_mktag(1), AfterElse_33, (MR_Integer) 0))));
    ...
    case (MR_Integer) 1:
      {
        MR_Integer AfterThenExecCount_34 = ((MR_Integer) ((MR_hl_field(MR_mktag(1), AfterThen_32, (MR_Integer) 0))));
        ...
        switch (MR_tag((MR_Word) AfterElse_33)) {
          ...
          case (MR_Integer) 1:
            {
              MR_Integer AfterElseExecCount_35 = ((MR_Integer) ((MR_hl_field(MR_mktag(1), AfterElse_33, (MR_Integer) 0))));
  ...
  if (!(succeeded))
  {
    ...
    Var_186 = mercury__string__f_43_43_2_f_0(Var_104, (MR_String) "\n");
    Var_188 = mercury__string__f_43_43_2_f_0((MR_String) "\n\tGoalPath: ", Var_186);
    Var_189 = mercury__string__f_43_43_2_f_0(Var_101, Var_188);
    Var_191 = mercury__string__f_43_43_2_f_0((MR_String) " ", Var_189);
    Var_192 = mercury__string__f_43_43_2_f_0(Var_98, Var_191);
    Var_194 = mercury__string__f_43_43_2_f_0((MR_String) "\n\tElse: ", Var_192);
    Var_195 = mercury__string__f_43_43_2_f_0(Var_95, Var_194);
    Var_197 = mercury__string__f_43_43_2_f_0((MR_String) " ", Var_195);
    Var_198 = mercury__string__f_43_43_2_f_0(Var_92, Var_197);
    Var_200 = mercury__string__f_43_43_2_f_0((MR_String) "\n\tThen: ", Var_198);
    Var_201 = mercury__string__f_43_43_2_f_0(Var_89, Var_200);
    Var_203 = mercury__string__f_43_43_2_f_0((MR_String) " ", Var_201);
    Var_204 = mercury__string__f_43_43_2_f_0(Var_86, Var_203);
    Var_206 = mercury__string__f_43_43_2_f_0((MR_String) "\n\tCond: ", Var_204);
    Var_207 = mercury__string__f_43_43_2_f_0(Var_83, Var_206);
    Var_209 = mercury__string__f_43_43_2_f_0((MR_String) " ", Var_207);
    Var_210 = mercury__string__f_43_43_2_f_0(Var_80, Var_209);
  ...
  MR_Word * STATE_VARIABLE_Array_20)
{
  ...
  switch (MR_tag((MR_Word) SumAfter_17)) {
    ...
    case (MR_Integer) 1:
      {
        MR_Integer C_72 = ((MR_Integer) ((MR_hl_field(MR_mktag(1), SumAfter_17, (MR_Integer) 0))));
        ...
        if (succeeded)
          *After_12 = (MR_Word) ((MR_Unsigned) 4U);
        else
          {
            ...
            base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
            *After_12 = base;
            MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (C_72));
          }
      }
      break;
  }
    ...
    case (MR_Integer) 1:
      {
...

        {
          ...
          MR_hl_field(MR_mktag(0), Var_76, 0) = ((MR_Box) (&coverage_scalar_common_5[0]));
          MR_hl_field(MR_mktag(0), Var_76, 1) = ((MR_Box) (coverage__switch_annotate_coverage_7_p_0_1));
          MR_hl_field(MR_mktag(0), Var_76, 2) = ((MR_Box) ((MR_Integer) 1));
          MR_hl_field(MR_mktag(0), Var_76, 3) = ((MR_Box) (*STATE_VARIABLE_Array_20));
        }
        mercury__list__foldl_4_p_0((MR_Word) (&coverage_scalar_common_1[0]), (MR_Word) (&coverage_scalar_common_1[2]), Var_76, Cases_8, ((MR_Box) (MR_mkword(MR_mktag(1), &coverage_scalar_common_3[0]))), &conv1_MaybeSum_73);
        MaybeSum_73 = ((MR_Word) (conv1_MaybeSum_73));
        if ((MaybeSum_73 == (MR_Word) ((MR_Unsigned) 0U)))
          Result_18 = (MR_Integer) 1;
        else
        {
          MR_Integer SumA_74 = ((MR_Integer) ((MR_hl_field(MR_mktag(1), MaybeSum_73, (MR_Integer) 0))));
          ...
          switch (MR_tag((MR_Word) Before_11)) {
            ...
            case (MR_Integer) 1:
              {
                MR_Integer SumB_75 = ((MR_Integer) ((MR_hl_field(MR_mktag(1), Before_11, (MR_Integer) 0))));
  ...
  MR_Word * STATE_VARIABLE_Array_77)
{
  ...
  MR_Word Var_78 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Info_8, (MR_Integer) 4))));
    ...
    case (MR_Integer) 0:
      {
        ...
        coverage__conj_annotate_coverage_6_p_0(TypeInfo_for_Callee_163, Conjs_16, Info_8, Before_9, &After0_17, STATE_VARIABLE_Array_0_76, &STATE_VARIABLE_Array_95_95);
      }
      break;
    case (MR_Integer) 1:
      {
    ...
    case (MR_Integer) 2:
      {
        ...
        coverage__switch_annotate_coverage_7_p_0(TypeInfo_for_Callee_163, Cases_23, Info_8, CanFail_22, Before_9, &After0_17, STATE_VARIABLE_Array_0_76, &STATE_VARIABLE_Array_95_95);
      }
      break;
    case (MR_Integer) 3:
        ...
        case (MR_Integer) 0:
          {
            ...
            coverage__ite_annotate_coverage_9_p_0(TypeInfo_for_Callee_163, Cond_24, Then_25, Else_26, Info_8, RevGoalPath_15, Before_9, &After0_17, STATE_VARIABLE_Array_0_76, &STATE_VARIABLE_Array_95_95);
          }
          break;
        case (MR_Integer) 1:
          {
            ...
            coverage__negation_annotate_coverage_6_p_0(TypeInfo_for_Callee_163, NegGoal_27, Info_8, Before_9, &After0_17, STATE_VARIABLE_Array_0_76, &STATE_VARIABLE_Array_95_95);
          }
          break;
        case (MR_Integer) 2:
          {
            ...
            coverage__scope_annotate_coverage_7_p_0(TypeInfo_for_Callee_163, ScopedGoal_28, Info_8, MaybeCut_29, Before_9, &After0_17, STATE_VARIABLE_Array_0_76, &STATE_VARIABLE_Array_95_95);
          }
          break;
        case (MR_Integer) 3:
          {
              ...
              case (MR_Integer) 3:
                switch (((MR_Integer) ((MR_hl_field(MR_mktag(3), AtomicGoal_33, (MR_Integer) 0))))) {
                  ...
                  case (MR_Integer) 7:
                    {
                      MR_Word Cost_42;
                      MR_Word TypeInfo__167_167;
                      MR_Word Var_79 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Info_8, (MR_Integer) 1))));
                      MR_Box conv1_Cost_42;

                      {
                        TypeInfo__167_167 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
                        MR_hl_field(MR_mktag(0), TypeInfo__167_167, 0) = ((MR_Box) (&analysis_utils__analysis_utils__type_ctor_info_cost_and_callees_1));
                        MR_hl_field(MR_mktag(0), TypeInfo__167_167, 1) = ((MR_Box) (TypeInfo_for_Callee_163));
                      }
                      succeeded = mercury__map__search_3_p_0((MR_Word) (&mdbcomp__goal_path__mdbcomp__goal_path__type_ctor_info_reverse_goal_path_0), TypeInfo__167_167, Var_79, ((MR_Box) (RevGoalPath_15)), &conv1_Cost_42);
                      if (succeeded)
                      {
                      ...
                      if (succeeded)
                      {
                        ...
                        MR_Integer Exits_44;
                        MR_Float Var_80;
                        MR_Word Var_81 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Cost_42, (MR_Integer) 0))));
                        MR_Word Var_82;
                        MR_Word Var_84;

                        Var_80 = measurements__cs_cost_get_calls_1_f_0(Var_81);
                        Calls_43 = mercury__float__round_to_int_1_f_0(Var_80);
                        Exits_44 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), Cost_42, (MR_Integer) 1))));
                        Var_84 = coverage__before_coverage_1_f_0(Calls_43);
                        {
                          Var_82 = (MR_Word) MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL);
                          MR_hl_field(MR_mktag(0), Var_82, 0) = ((MR_Box) (&coverage_scalar_common_4[1]));
                          MR_hl_field(MR_mktag(0), Var_82, 1) = ((MR_Box) (coverage__goal_annotate_coverage_6_p_0_1));
                          MR_hl_field(MR_mktag(0), Var_82, 2) = ((MR_Box) ((MR_Integer) 2));
                          MR_hl_field(MR_mktag(0), Var_82, 3) = ((MR_Box) (Before_9));
                          MR_hl_field(MR_mktag(0), Var_82, 4) = ((MR_Box) (Var_84));
                        }
                        mercury__require__require_2_p_0(Var_82, (MR_String) "Coverage before call doesn\'t match calls port on call site");
                      ...
                      else
                      {
                        ...
                        {
                          mercury__require__unexpected_2_p_0((MR_String) "predicate \140coverage.goal_annotate_coverage\'/6", Var_86);
                          return;
                        }
                      }
                    }
            ...
            STATE_VARIABLE_Array_95_95 = STATE_VARIABLE_Array_0_76;
          }
          break;
      }
      break;
  ...
  mdbcomp__goal_path__update_goal_attribute_4_p_0((MR_Word) (&coverage__coverage__type_ctor_info_coverage_info_0), GoalId_14, ((MR_Box) (GoalCoverage_73)), STATE_VARIABLE_Array_95_95, STATE_VARIABLE_Array_77);
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = coverage__IntroducedFrom__pred__after_count_from_either_source__1160__1_2_p_0(((MR_Integer) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Integer) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))));
  return succeeded;
}
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = coverage__IntroducedFrom__pred__after_count_from_either_source__1149__1_2_p_0(((MR_Integer) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Integer) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))));
  return succeeded;
}
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = coverage__IntroducedFrom__pred__after_count_from_either_source__1144__1_2_p_0(((MR_Integer) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Integer) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))));
  return succeeded;
}
            ...
            case (MR_Integer) 1:
              {
...

                {
                  ...
                  MR_hl_field(MR_mktag(0), Var_10, 0) = ((MR_Box) (&coverage_scalar_common_4[0]));
              ...
              case (MR_Integer) 1:
                {
...

                  {
                    ...
                    MR_hl_field(MR_mktag(0), Var_13, 0) = ((MR_Box) (&coverage_scalar_common_4[0]));
          ...
          case (MR_Integer) 1:
            {
...

              {
                ...
                MR_hl_field(MR_mktag(0), Var_16, 0) = ((MR_Box) (&coverage_scalar_common_4[0]));
  ...
  switch (Detism_4) {
    ...
    case (MR_Integer) 0:
      switch (MR_tag((MR_Word) Before_5)) {
        ...
        case (MR_Integer) 1:
          {
            MR_Integer Count_7 = ((MR_Integer) ((MR_hl_field(MR_mktag(1), Before_5, (MR_Integer) 0))));
            ...
            if (succeeded)
              *After_6 = (MR_Word) ((MR_Unsigned) 4U);
            else
              {
                ...
                base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                *After_6 = base;
                MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (Count_7));
              }
          }
          break;
      }
  ...
  switch (Detism_4) {
    ...
    case (MR_Integer) 0:
      switch (MR_tag((MR_Word) Coverage_3)) {
        ...
        case (MR_Integer) 2:
          {
            MR_Integer Entry_7 = ((MR_Integer) ((MR_hl_field(MR_mktag(2), Coverage_3, (MR_Integer) 0))));
            MR_Integer Exit_8 = ((MR_Integer) ((MR_hl_field(MR_mktag(2), Coverage_3, (MR_Integer) 1))));
    ...
    case (MR_Integer) 1:
      switch (MR_tag((MR_Word) Coverage_3)) {
        ...
        case (MR_Integer) 2:
          {
            MR_Integer Entry_21 = ((MR_Integer) ((MR_hl_field(MR_mktag(2), Coverage_3, (MR_Integer) 0))));
            MR_Integer Exit_22 = ((MR_Integer) ((MR_hl_field(MR_mktag(2), Coverage_3, (MR_Integer) 1))));
    ...
    case (MR_Integer) 7:
      switch (MR_tag((MR_Word) Coverage_3)) {
        ...
        case (MR_Integer) 1:
          {
            MR_Integer Exit_25 = ((MR_Integer) ((MR_hl_field(MR_mktag(1), Coverage_3, (MR_Integer) 0))));
        ...
        case (MR_Integer) 2:
          {
            MR_Integer Exit_23 = ((MR_Integer) ((MR_hl_field(MR_mktag(2), Coverage_3, (MR_Integer) 1))));
        ...
        case (MR_Integer) 3:
          switch (((MR_Integer) ((MR_hl_field(MR_mktag(3), Coverage_3, (MR_Integer) 0))))) {
            ...
            case (MR_Integer) 1:
              {
                MR_Integer Exit_24 = ((MR_Integer) ((MR_hl_field(MR_mktag(3), Coverage_3, (MR_Integer) 1))));
