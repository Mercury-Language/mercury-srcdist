                  ...
                  switch (MR_tag((MR_Word) Before_15)) {
                    ...
                    case (MR_Integer) 0:
                      switch (MR_unmkbody(Before_15)) {
                        ...
                        case (MR_Integer) 1:
                          {
                            BeforeElse_27 = coverage__before_coverage_1_f_0((MR_Integer) ((MR_Unsigned) (MR_Integer) 0 - (MR_Unsigned) (MR_Integer) 0));
                          }
                          break;
                      }
                      break;
                    case (MR_Integer) 1:
                      {
                        ...
                        MR_Integer Var_143 = (MR_Integer) ((MR_Unsigned) BeforeCount_142 - (MR_Unsigned) (MR_Integer) 0);
              ...
              switch (MR_tag((MR_Word) Before_15)) {
                ...
                case (MR_Integer) 0:
                  switch (MR_unmkbody(Before_15)) {
                    ...
                    case (MR_Integer) 1:
                      {
                        MR_Integer Var_141 = (MR_Integer) ((MR_Unsigned) (MR_Integer) 0 - (MR_Unsigned) BeforeThenCount_28);
  ...
  MR_Word * STATE_VARIABLE_CoveragePoints_17)
{
  while (MR_TRUE)
  {
    ...
    if (succeeded)
    {
      ...
      Var_20 = (MR_Integer) ((MR_Unsigned) Num_7 + (MR_Unsigned) (MR_Integer) 1);
      // direct tailcall eliminated
