              ...
              case (MR_Integer) 1:
                {
                  ...
                  MR_Integer Var_71 = (MR_Integer) ((MR_Unsigned) SumExecCount_68 + (MR_Unsigned) ExecCount_69);

                  {
                    STATE_VARIABLE_SumAfter_36_36 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(MR_mktag(1), STATE_VARIABLE_SumAfter_36_36, 0) = ((MR_Box) (Var_71));
                  }
                }
                break;
            }
              ...
              case (MR_Integer) 1:
                {
                  ...
                  MR_Integer Var_86 = (MR_Integer) ((MR_Unsigned) SumExecCount_83 + (MR_Unsigned) ExecCount_84);

                  {
                    STATE_VARIABLE_SumBefore_49_49 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(MR_mktag(1), STATE_VARIABLE_SumBefore_49_49, 0) = ((MR_Box) (Var_86));
                  }
                }
                break;
            }
