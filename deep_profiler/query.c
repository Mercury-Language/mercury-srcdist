          ...
          case (MR_Integer) 1:
            {
              ...
              packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Var_7, (MR_Integer) 6)));
              ...
              Var_20 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_7, (MR_Integer) 8))));
              {
                ...
                MR_hl_field(MR_mktag(0), Pref_6, 6) = (MR_Box) (packed_args_1);
...
{
  {
    ...
    MR_Unsigned packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Pref_3, (MR_Integer) 6)));
