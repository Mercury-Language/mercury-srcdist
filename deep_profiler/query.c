    ...
    switch (MR_tag((MR_Word) HeadVar__2_2)) {
      ...
      case (MR_Integer) 1:
        switch (MR_tag((MR_Word) HeadVar__3_3)) {
          ...
          case (MR_Integer) 1:
            {
              MR_Word ArgX1_4 = ((((MR_Unsigned) ((MR_hl_field(1, HeadVar__2_2, (MR_Integer) 0))) >> 2)) & (MR_Integer) 7);
              MR_Word ArgY1_5 = ((((MR_Unsigned) ((MR_hl_field(1, HeadVar__3_3, (MR_Integer) 0))) >> 2)) & (MR_Integer) 7);
              MR_Word ArgX2_7 = ((((MR_Unsigned) ((MR_hl_field(1, HeadVar__2_2, (MR_Integer) 0))) >> 1)) & (MR_Integer) 1);
              MR_Word ArgY2_8 = ((((MR_Unsigned) ((MR_hl_field(1, HeadVar__3_3, (MR_Integer) 0))) >> 1)) & (MR_Integer) 1);
              MR_Word ArgX3_10 = ((MR_Unsigned) ((MR_hl_field(1, HeadVar__2_2, (MR_Integer) 0))) & (MR_Integer) 1);
              MR_Word ArgY3_11 = ((MR_Unsigned) ((MR_hl_field(1, HeadVar__3_3, (MR_Integer) 0))) & (MR_Integer) 1);
              MR_Word SubResult1_6;
    ...
    switch (MR_tag((MR_Word) HeadVar__2_2)) {
      ...
      case (MR_Integer) 1:
        switch (MR_tag((MR_Word) HeadVar__3_3)) {
          ...
          case (MR_Integer) 1:
            {
              MR_Float ArgX1_9 = MR_unbox_float((MR_hl_field(1, HeadVar__2_2, (MR_Integer) 0)));
              MR_Float ArgY1_10 = MR_unbox_float((MR_hl_field(1, HeadVar__3_3, (MR_Integer) 0)));
      ...
      case (MR_Integer) 2:
        switch (MR_tag((MR_Word) HeadVar__3_3)) {
          ...
          case (MR_Integer) 2:
            {
              MR_Float ArgX1_11 = MR_unbox_float((MR_hl_field(2, HeadVar__2_2, (MR_Integer) 0)));
              MR_Float ArgY1_12 = MR_unbox_float((MR_hl_field(2, HeadVar__3_3, (MR_Integer) 0)));
