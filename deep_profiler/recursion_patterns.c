    ...
    case (MR_Integer) 2:
      {
        ...
        {
          MR_Word STATE_VARIABLE_Errors_11_88 = ((MR_Word) ((MR_hl_field(1, STATE_VARIABLE_RecursionData_34_34, 2))));
          ...
          Var_90 = ((MR_Word) ((MR_hl_field(1, STATE_VARIABLE_RecursionData_34_34, 0))));
          Var_91 = ((MR_Integer) ((MR_hl_field(1, STATE_VARIABLE_RecursionData_34_34, 1))));
          {
            MR_Word base;
            base = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
