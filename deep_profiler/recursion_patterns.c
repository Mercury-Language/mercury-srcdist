  ...
  MR_Word * MaybeReport_4)
{
  ...
  if ((MaybeProgRepResult_5 == (MR_Word) ((MR_Unsigned) 0U)))
  {
    ...
    Var_12 = mercury__string__f_43_43_2_f_0((MR_String) "There is no readable ", (MR_String) "procedure representation information file.");
    {
      MR_Word base;
      base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
      *MaybeReport_4 = base;
  ...
  else
  {
    ...
    else
    {
      ...
      mercury__array__size_2_p_0((MR_Word) (&profile__profile__type_ctor_info_clique_ptr_0), (MR_ArrayPtr) (Var_33), &NumCliques_9);
      {
        ...
        MR_hl_field(MR_mktag(0), Var_21, 0) = ((MR_Box) (&recursion_patterns_scalar_common_7[1]));
        MR_hl_field(MR_mktag(0), Var_21, 1) = ((MR_Box) (recursion_patterns__create_recursion_types_frequency_report_2_p_0_1));
        MR_hl_field(MR_mktag(0), Var_21, 2) = ((MR_Box) ((MR_Integer) 1));
        MR_hl_field(MR_mktag(0), Var_21, 3) = ((MR_Box) (Deep_3));
      }
          ...
          case (MR_Integer) 1:
            {
...

              {
                ...
                MR_hl_field(MR_mktag(1), Var_43, 0) = ((MR_Box) (RevGoalPath_6));
                MR_hl_field(MR_mktag(1), Var_43, 1) = ((MR_Box) ((MR_Unsigned) 12U));
              }
        ...
        case (MR_Integer) 7:
          {
            ...
            if (succeeded)
            {
              ...
              Var_56 = measurement_units__certain_0_f_0();
              {
                ...
                MR_hl_field(MR_mktag(0), Var_54, 0) = MR_box_float((MR_Float) 0.0000000000000000);
                MR_hl_field(MR_mktag(0), Var_54, 1) = MR_box_float(Var_56);
              }
              {
                RecursionLevel_33 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
                MR_hl_field(MR_mktag(0), RecursionLevel_33, 0) = ((MR_Box) ((MR_Integer) 1));
                MR_hl_field(MR_mktag(0), RecursionLevel_33, 1) = ((MR_Box) (Var_54));
              }
            }
            else
            {
              MR_Float CostPercall_46;
              MR_Word Var_57 = ((MR_Word) ((MR_hl_field(MR_mktag(0), CostAndCallees_45, (MR_Integer) 0))));
              MR_Word Var_59;
              MR_Float Var_60;
              ...
              {
                Var_59 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
                MR_hl_field(MR_mktag(0), Var_59, 0) = MR_box_float(CostPercall_46);
                MR_hl_field(MR_mktag(0), Var_59, 1) = MR_box_float(Var_60);
              }
              {
                RecursionLevel_33 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
                MR_hl_field(MR_mktag(0), RecursionLevel_33, 0) = ((MR_Box) ((MR_Integer) 0));
                MR_hl_field(MR_mktag(0), RecursionLevel_33, 1) = ((MR_Box) (Var_59));
              }
            }
          }
          break;
