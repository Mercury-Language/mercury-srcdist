...
{
  {
    ...
    if (!((MaybeProgressStream_11 == (MR_Word) ((MR_Unsigned) 0U))))
    {
      ...
      mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&recursion_patterns_scalar_common_3[0]), CliqueNum_13, &Var_175);
    ...
    if (((MR_tag((MR_Word) MaybeCliqueRecursionReport_14)) == (MR_Integer) 1))
    {
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(1), SimpleTypes_17, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &recursion_patterns_scalar_common_2[6])));
      }
    }
    else
    {
