    ...
    if ((mdprof_fb__automatic_parallelism__autopar_reports__Productions_9 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
    ...
    else
      {
...

        {
          ...
          MR_hl_field(MR_mktag(0), mdprof_fb__automatic_parallelism__autopar_reports__Var_42, 0) = ((MR_Box) (&mdprof_fb__automatic_parallelism__autopar_reports_scalar_common_3[4]));
    ...
    if ((mdprof_fb__automatic_parallelism__autopar_reports__Consumptions_10 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
    ...
    else
      {
...

        {
          ...
          MR_hl_field(MR_mktag(0), mdprof_fb__automatic_parallelism__autopar_reports__Var_61, 0) = ((MR_Box) (&mdprof_fb__automatic_parallelism__autopar_reports_scalar_common_3[4]));
        ...
        if ((mdprof_fb__automatic_parallelism__autopar_reports__HeadVar__4_4 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
        ...
        else
          {
...

            {
              ...
              MR_hl_field(MR_mktag(0), mdprof_fb__automatic_parallelism__autopar_reports__Var_32, 0) = ((MR_Box) (&mdprof_fb__automatic_parallelism__autopar_reports_scalar_common_2[9]));
                ...
                if ((mdprof_fb__automatic_parallelism__autopar_reports__GoalsTail_28 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
                  {
...

                    {
                      ...
                      MR_hl_field(MR_mktag(0), mdprof_fb__automatic_parallelism__autopar_reports__Var_52, 0) = ((MR_Box) (&mdprof_fb__automatic_parallelism__autopar_reports_scalar_common_2[7]));
...
{
  {
    ...
    MR_Word mdprof_fb__automatic_parallelism__autopar_reports__Var_37 = (MR_Word) &mdprof_fb__automatic_parallelism__autopar_reports_scalar_common_4[0];
...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(0), mdprof_fb__automatic_parallelism__autopar_reports__Var_14, 0) = ((MR_Box) (&mdprof_fb__automatic_parallelism__autopar_reports_scalar_common_3[2]));
      ...
      case (MR_Integer) 1:
        {
          ...
          {
            mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) &mdprof_fb__automatic_parallelism__autopar_reports_scalar_common_4[0], mdprof_fb__automatic_parallelism__autopar_reports__N_5, &mdprof_fb__automatic_parallelism__autopar_reports__Var_26);
          }
          {
      ...
      case (MR_Integer) 2:
        {
          ...
          {
            mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) &mdprof_fb__automatic_parallelism__autopar_reports_scalar_common_4[0], mdprof_fb__automatic_parallelism__autopar_reports__N_14, &mdprof_fb__automatic_parallelism__autopar_reports__Var_16);
          }
          {
...
{
  {
    ...
    mdprof_fb__automatic_parallelism__autopar_reports__Var_117 = (MR_Word) &mdprof_fb__automatic_parallelism__autopar_reports_scalar_common_4[0];
    {
...
{
  {
    ...
    if ((mdprof_fb__automatic_parallelism__autopar_reports__IsDependent_10 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
    ...
    else
      {
...

        {
          ...
          MR_hl_field(MR_mktag(0), mdprof_fb__automatic_parallelism__autopar_reports__Var_57, 0) = ((MR_Box) (&mdprof_fb__automatic_parallelism__autopar_reports_scalar_common_3[0]));
    ...
    if ((mdprof_fb__automatic_parallelism__autopar_reports__MaybePushGoal_8 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
    ...
    else
      {
        ...
        MR_Word mdprof_fb__automatic_parallelism__autopar_reports__Var_205 = (MR_Word) &mdprof_fb__automatic_parallelism__autopar_reports_scalar_common_4[0];
        ...
        {
          mdprof_fb__automatic_parallelism__autopar_reports__TailPushGoalStrs_45 = mercury__list__map_2_f_0(mdprof_fb__automatic_parallelism__autopar_reports__TypeCtorInfo_192_192, mdprof_fb__automatic_parallelism__autopar_reports__TypeCtorInfo_192_192, (MR_Word) &mdprof_fb__automatic_parallelism__autopar_reports_scalar_common_2[2], mdprof_fb__automatic_parallelism__autopar_reports__PushedGoalPathStrs_41);
        }
        {
