  ...
  MR_Float LambdaHeadVar__2_50)
{
  ...
  MR_Float Var_52;
  MR_Word Var_53 = ((MR_Word) ((MR_hl_field(MR_mktag(0), LambdaHeadVar__1_49, (MR_Integer) 2))));

  Var_52 = MR_unbox_float((MR_hl_field(MR_mktag(0), Var_53, (MR_Integer) 0)));
  ...
  MR_String LambdaHeadVar__1_21)
{
...

  {
    ...
    MR_hl_field(MR_mktag(3), Var_25, 1) = ((MR_Box) (LambdaHeadVar__1_21));
  }
  {
  ...
  MR_Integer * STATE_VARIABLE_NumConjs_11)
{
  ...
  *STATE_VARIABLE_NumConjs_11 = (MR_Integer) ((MR_Unsigned) STATE_VARIABLE_NumConjs_0_10 + (MR_Unsigned) Var_13);
}
  ...
  MR_String LambdaHeadVar__1_76)
{
...

  {
    ...
    MR_hl_field(MR_mktag(3), Var_80, 1) = ((MR_Box) (LambdaHeadVar__1_76));
  }
  {
  ...
  MR_Word * HeadVar__3_3)
{
  ...
  MR_Word CostAboveThreshold_8 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), HeadVar__2_2, (MR_Integer) 1))) & (MR_Integer) 1);
  ...
  if ((Productions_9 == (MR_Word) ((MR_Unsigned) 0U)))
  ...
  else
  {
    ...
    mercury__list__map_3_p_0((MR_Word) (&mdprof_fb__automatic_parallelism__autopar_reports_scalar_common_2[1]), (MR_Word) (&mdprof_fb__automatic_parallelism__autopar_reports_scalar_common_1[2]), Var_42, Productions_9, &Lines_41);
    Var_45 = mercury__string__f_43_43_2_f_0((MR_String) "Productions", (MR_String) ":");
    Var_44 = mercury__cord__singleton_1_f_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), ((MR_Box) (Var_45)));
    Var_43 = mercury__cord__singleton_1_f_0((MR_Word) (&mdprof_fb__automatic_parallelism__autopar_reports_scalar_common_1[2]), ((MR_Box) (Var_44)));
    Var_47 = mercury__cord__from_list_1_f_0((MR_Word) (&mdprof_fb__automatic_parallelism__autopar_reports_scalar_common_1[2]), Lines_41);
    ProductionsReport_13 = mercury__cord__f_43_43_2_f_0((MR_Word) (&mdprof_fb__automatic_parallelism__autopar_reports_scalar_common_1[2]), Var_43, Var_47);
  }
  if ((Consumptions_10 == (MR_Word) ((MR_Unsigned) 0U)))
  ...
  else
  {
    ...
    mercury__list__map_3_p_0((MR_Word) (&mdprof_fb__automatic_parallelism__autopar_reports_scalar_common_2[1]), (MR_Word) (&mdprof_fb__automatic_parallelism__autopar_reports_scalar_common_1[2]), Var_61, Consumptions_10, &Lines_60);
    Var_64 = mercury__string__f_43_43_2_f_0((MR_String) "Consumptions", (MR_String) ":");
    Var_63 = mercury__cord__singleton_1_f_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), ((MR_Box) (Var_64)));
    Var_62 = mercury__cord__singleton_1_f_0((MR_Word) (&mdprof_fb__automatic_parallelism__autopar_reports_scalar_common_1[2]), ((MR_Box) (Var_63)));
    Var_66 = mercury__cord__from_list_1_f_0((MR_Word) (&mdprof_fb__automatic_parallelism__autopar_reports_scalar_common_1[2]), Lines_60);
    ConsumptionsReport_14 = mercury__cord__f_43_43_2_f_0((MR_Word) (&mdprof_fb__automatic_parallelism__autopar_reports_scalar_common_1[2]), Var_62, Var_66);
  }
  Var_25 = mercury__cord__singleton_1_f_0((MR_Word) (&mdprof_fb__automatic_parallelism__autopar_reports_scalar_common_1[2]), ((MR_Box) (CostLine_12)));
  Var_26 = mercury__cord__f_43_43_2_f_0((MR_Word) (&mdprof_fb__automatic_parallelism__autopar_reports_scalar_common_1[2]), ProductionsReport_13, ConsumptionsReport_14);
  *HeadVar__3_3 = mercury__cord__f_43_43_2_f_0((MR_Word) (&mdprof_fb__automatic_parallelism__autopar_reports_scalar_common_1[2]), Var_25, Var_26);
}
    ...
    else
    {
      ...
      else
      {
...

        {
          ...
          MR_hl_field(MR_mktag(1), Var_43, 0) = ((MR_Box) (HeadVar__4_4));
        }
        {
          RevInnerGoalPath_29 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), RevInnerGoalPath_29, 0) = ((MR_Box) (HeadVar__3_3));
          MR_hl_field(MR_mktag(1), RevInnerGoalPath_29, 1) = ((MR_Box) (Var_43));
        }
        if ((GoalsTail_28 == (MR_Word) ((MR_Unsigned) 0U)))
        {
...

          {
            ...
            MR_hl_field(MR_mktag(0), Var_44, 0) = ((MR_Box) (&mdprof_fb__automatic_parallelism__autopar_reports_scalar_common_2[5]));
            MR_hl_field(MR_mktag(0), Var_44, 1) = ((MR_Box) (HeadVar__1_1));
          }
        ...
        else
        {
          ...
          mdprof_fb__automatic_parallelism__autopar_reports__format_sequential_conjunction_7_p_0(HeadVar__1_1, Var_55, RevInnerGoalPath_29, Goals_26, Cost_33, (MR_Integer) 1, &ConjReport_30);
        }
      }
  ...
  MR_Box wrapper_arg_1)
{
  ...
  conv0_HeadVar__2_47 = mdprof_fb__automatic_parallelism__autopar_reports__IntroducedFrom__func__format_sequential_conjuncts__388__1_1_f_0(((MR_Word) (wrapper_arg_1)));
  ...
  MR_Word FeedbackInfo_6)
{
  ...
  {
    MR_Word CandidateParConjs_11 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MaybeCandidateParConjs_9, (MR_Integer) 0))));
    ...
    {
      STATE_VARIABLE_RevReports_20_20 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), STATE_VARIABLE_RevReports_20_20, 0) = ((MR_Box) (CandidateParConjsReport_12));
      MR_hl_field(MR_mktag(1), STATE_VARIABLE_RevReports_20_20, 1) = ((MR_Box) ((MR_Unsigned) 0U));
    }
  }
  ...
  MR_String * Report_4)
{
  ...
  IntermoduleVarUse_10 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Parameters_5, (MR_Integer) 1))) & (MR_Integer) 1);
  ...
  {
    MR_Word SpeedupAlg_25 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(1), ParalleliseDepConjs_20, (MR_Integer) 0))) & (MR_Integer) 1);
