...
{
  {
    ...
    MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), LambdaHeadVar__1_43, (MR_Integer) 1)));
    MR_Unsigned packed_word_1;

    Var_46 = MR_unbox_float((MR_hl_field(MR_mktag(0), Var_47, (MR_Integer) 0)));
    packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Var_47, (MR_Integer) 1)));
...
{
  {
    ...
    STATE_VARIABLE_ConjNum_169_169 = (MR_Integer) ((MR_Unsigned) STATE_VARIABLE_ConjNum_161_161 + (MR_Unsigned) (MR_Integer) 1);
    ...
    else
    {
      ...
      else
      {
        ...
        if ((GoalsTail_28 == (MR_Word) ((MR_Unsigned) 0U)))
        {
          ...
          Var_53 = (MR_Integer) ((MR_Unsigned) Indent_2 + (MR_Unsigned) (MR_Integer) 1);
        ...
        else
        {
          ...
          Var_49 = (MR_Integer) ((MR_Unsigned) Indent_2 + (MR_Unsigned) (MR_Integer) 1);
      ...
      ConjNum_38 = (MR_Integer) ((MR_Unsigned) HeadVar__4_4 + (MR_Unsigned) (MR_Integer) 1);
  ...
  MR_Word * STATE_VARIABLE_Report_8)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      STATE_VARIABLE_ConjNum_37_37 = (MR_Integer) ((MR_Unsigned) STATE_VARIABLE_ConjNum_0_5 + (MR_Unsigned) (MR_Integer) 1);
...
{
  {
    ...
    if ((MaybeCandidateParConjs_7 == (MR_Word) ((MR_Unsigned) 0U)))
      STATE_VARIABLE_RevReports_18_18 = (MR_Word) ((MR_Unsigned) 0U);
    else
    {
      ...
      {
        STATE_VARIABLE_RevReports_18_18 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), STATE_VARIABLE_RevReports_18_18, 0) = ((MR_Box) (CandidateParConjsReport_10));
        MR_hl_field(MR_mktag(1), STATE_VARIABLE_RevReports_18_18, 1) = ((MR_Box) ((MR_Unsigned) 0U));
      }
    }
    ...
    if ((Reports_11 == (MR_Word) ((MR_Unsigned) 0U)))
...
{
  {
    ...
    packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Parameters_5, (MR_Integer) 1)));
    ...
    else
    {
      ...
      MR_Unsigned packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), ParalleliseDepConjs_20, (MR_Integer) 0)));
