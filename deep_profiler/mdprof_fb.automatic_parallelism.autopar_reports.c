  ...
  MR_Word * STATE_VARIABLE_Report_7)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      {
        MR_Integer next_value_of_HeadVar__4_4 = ConjNum_38;
        MR_Word next_value_of_HeadVar__5_5 = Conjs_24;
        MR_Word next_value_of_STATE_VARIABLE_Report_0_6 = STATE_VARIABLE_Report_59_59;
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      else
      {
        ...
        /* direct tailcall eliminated */
        {
          MR_Word next_value_of_HeadVar__4_4 = Conjs_22;
          MR_Integer next_value_of_STATE_VARIABLE_ConjNum_0_5 = STATE_VARIABLE_ConjNum_37_37;
          MR_Word next_value_of_STATE_VARIABLE_Report_0_7 = STATE_VARIABLE_Report_39_39;
