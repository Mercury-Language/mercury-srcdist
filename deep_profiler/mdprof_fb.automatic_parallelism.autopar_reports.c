...
MR_decl_label10(mdprof_fb__automatic_parallelism__autopar_reports__format_parallel_conjuncts_7_0, 55,4,5,3,12,20,21,8,7,23)
MR_decl_label4(mdprof_fb__automatic_parallelism__autopar_reports__format_parallel_conjuncts_7_0, 25,26,27,28)
...
MR_BEGIN_MODULE(mdprof_fb__automatic_parallelism__autopar_reports_module3)
	...
	MR_init_label10(mdprof_fb__automatic_parallelism__autopar_reports__format_parallel_conjuncts_7_0,55,4,5,3,12,20,21,8,7,23)
	MR_init_label4(mdprof_fb__automatic_parallelism__autopar_reports__format_parallel_conjuncts_7_0,25,26,27,28)
MR_BEGIN_CODE
...
MR_def_static(mdprof_fb__automatic_parallelism__autopar_reports__format_parallel_conjuncts_7_0)
	...
	MR_incr_sp(9);
	MR_sv(9) = (MR_Word) MR_succip;
MR_def_label(mdprof_fb__automatic_parallelism__autopar_reports__format_parallel_conjuncts_7_0,55)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_def_label(mdprof_fb__automatic_parallelism__autopar_reports__format_parallel_conjuncts_7_0,3)
	...
	MR_tfield(0, MR_tempr4, 0) = (MR_Word) MR_TAG_COMMON(0,1,2);
...
MR_def_label(mdprof_fb__automatic_parallelism__autopar_reports__format_parallel_conjuncts_7_0,7)
	...
	MR_sv(6) = MR_r1;
	MR_np_call_localret_ent(fn__f_99_111_114_100_95_95_43_43_2_0,
		mdprof_fb__automatic_parallelism__autopar_reports__format_parallel_conjuncts_7_0_i23);
MR_def_label(mdprof_fb__automatic_parallelism__autopar_reports__format_parallel_conjuncts_7_0,23)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_sv(5),0,0)) {
		MR_GOTO_LAB(mdprof_fb__automatic_parallelism__autopar_reports__format_parallel_conjuncts_7_0_i25);
	}
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
	...
	MR_r6 = MR_tempr1;
	MR_succip_word = MR_sv(9);
	MR_GOTO_LAB(mdprof_fb__automatic_parallelism__autopar_reports__format_parallel_conjuncts_7_0_i55);
	}
...
MR_def_label(mdprof_fb__automatic_parallelism__autopar_reports__format_parallel_conjuncts_7_0,27)
	...
	MR_np_call_localret_ent(fn__cord__snoc_2_0,
		mdprof_fb__automatic_parallelism__autopar_reports__format_parallel_conjuncts_7_0_i28);
MR_def_label(mdprof_fb__automatic_parallelism__autopar_reports__format_parallel_conjuncts_7_0,28)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
...
MR_def_static(mdprof_fb__automatic_parallelism__autopar_reports__create_feedback_autopar_report_3_0)
	...
	MR_sv(18) = MR_r1;
	MR_sv(1) = MR_r2;
	MR_sv(19) = (MR_Word) MR_TAG_COMMON(0,7,1);
	MR_r1 = MR_sv(19);
	MR_np_call_localret_ent(fn__list__length_1_0,
...
MR_def_label(mdprof_fb__automatic_parallelism__autopar_reports__ClassMethod_for_program_representation_utils__goal_annotation____mdbcomp__feedback__automatic_parallelism__pard_goal_annotation__arity0______program_representation_utils__print_goal_annotation_to_strings_3_3_0,10)
	...
	MR_sv(2) = MR_r1;
	MR_sv(3) = (MR_Word) MR_TAG_COMMON(0,2,6);
	MR_r1 = MR_sv(3);
	MR_np_call_localret_ent(fn__cord__empty_0_0,
