...
mdbcomp.rtti_access.date0 : rtti_access.m
	$(MCPI) $(ALL_GRADEFLAGS) $(ALL_MCPIFLAGS) rtti_access.m
mdbcomp.rtti_access.date : rtti_access.m
	$(MCI) $(ALL_GRADEFLAGS) $(ALL_MCIFLAGS) rtti_access.m
mdbcomp.rtti_access.date3 : rtti_access.m
	$(MCSI) $(ALL_GRADEFLAGS) $(ALL_MCSIFLAGS) rtti_access.m
mdbcomp.rtti_access.optdate : rtti_access.m
	$(MCOI) $(ALL_GRADEFLAGS) $(ALL_MCOIFLAGS) rtti_access.m
mdbcomp.rtti_access.trans_opt_date : rtti_access.m
	$(MCTOI) $(ALL_GRADEFLAGS) $(ALL_MCTOIFLAGS) rtti_access.m
mdbcomp.rtti_access.c_date : rtti_access.m
	$(MCG) $(ALL_GRADEFLAGS) $(ALL_MCGFLAGS) rtti_access.m $(ERR_REDIRECT)
ifeq ($(TARGET_ASM),yes)
mdbcomp.rtti_access.s_date : rtti_access.m
	$(MCG) $(ALL_GRADEFLAGS) $(ALL_MCGFLAGS) --target-code-only rtti_access.m $(ERR_REDIRECT)
mdbcomp.rtti_access.pic_s_date : rtti_access.m
	$(MCG) $(ALL_GRADEFLAGS) $(ALL_MCGFLAGS) --target-code-only --pic \
		--cflags "$(GCCFLAGS_FOR_PIC)" rtti_access.m $(ERR_REDIRECT)
endif # TARGET_ASM
mdbcomp.rtti_access.il_date : rtti_access.m
	$(MCG) $(ALL_GRADEFLAGS) $(ALL_MCGFLAGS) --il-only rtti_access.m $(ERR_REDIRECT)
mdbcomp.rtti_access.java_date : rtti_access.m
	$(MCG) $(ALL_GRADEFLAGS) $(ALL_MCGFLAGS) --java-only rtti_access.m $(ERR_REDIRECT)
