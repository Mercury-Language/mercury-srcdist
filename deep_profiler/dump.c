...
MR_decl_label9(dump__dump_call_site_kind_and_callee_3_0, 42,10,11,12,13,38,5,7,16)
...
MR_def_label(dump__dump_initial_deep_4_0,3)
	...
	MR_tfield(0, MR_tempr1, 2) = (MR_Integer) 1;
	MR_tempr2 = MR_r1;
	MR_tfield(0, MR_tempr1, 3) = MR_tfield(0, MR_tempr2, 5);
	MR_tempr3 = MR_r2;
	MR_sv(1) = MR_tempr3;
	MR_sv(2) = MR_tfield(0, MR_tempr2, 0);
	MR_sv(3) = MR_tfield(0, MR_tempr2, 1);
...
MR_def_static(dump__dump_deep_rev_links_3_0)
	...
	MR_tempr1 = MR_r1;
	MR_sv(1) = MR_tempr1;
	MR_sv(2) = MR_tfield(0, MR_tempr1, 13);
...
MR_def_static(dump__dump_deep_prop_measurements_3_0)
	...
	MR_tempr1 = MR_r1;
	MR_sv(1) = MR_tempr1;
	MR_sv(2) = MR_tfield(0, MR_tempr1, 16);
	MR_sv(3) = MR_tfield(0, MR_tempr1, 17);
...
MR_BEGIN_MODULE(dump_module27)
	...
	MR_init_label9(dump__dump_call_site_kind_and_callee_3_0,42,10,11,12,13,38,5,7,16)
MR_BEGIN_CODE
