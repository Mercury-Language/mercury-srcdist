...
MR_define_entry(mercury__dump__dump_initial_deep_4_0);
	...
	MR_sv(8) = ((MR_Integer) MR_tfield(0, MR_r2, 2) & (MR_Integer) 1);
...
MR_def_label(dump__dump_initial_deep_4_0,3)
	...
	MR_sv(8) = ((MR_Integer) MR_tfield(0, MR_r2, 2) & (MR_Integer) 1);
	MR_sv(11) = (MR_Word) MR_CTOR0_ADDR(profile, proc_static_ptr);
	MR_r1 = MR_sv(11);
	}
...
MR_def_label(dump__dump_deep_cliques_3_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(2) = MR_tfield(0, MR_sv(1), 10);
...
MR_def_label(dump__dump_deep_cliques_3_0,10)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(2) = MR_tfield(0, MR_sv(1), 11);
...
MR_def_label(dump__dump_deep_cliques_3_0,14)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(1) = MR_tfield(0, MR_sv(1), 12);
...
MR_def_label(dump__dump_deep_rev_links_3_0,6)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(2) = MR_tfield(0, MR_sv(1), 14);
...
MR_def_label(dump__dump_deep_rev_links_3_0,10)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(1) = MR_tfield(0, MR_sv(1), 15);
...
MR_def_static(dump__dump_deep_prop_measurements_3_0)
	...
	MR_sv(1) = MR_r1;
	MR_sv(2) = MR_tfield(0, MR_r1, 16);
	MR_sv(3) = MR_tfield(0, MR_r1, 17);
...
MR_def_label(dump__dump_deep_prop_measurements_3_0,7)
	...
	MR_sv(3) = MR_tfield(0, MR_tempr1, 18);
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(profile, call_site_dynamic);
	MR_r2 = MR_sv(2);
	}
	MR_np_call_localret_ent(fn__array__max_1_0,
...
MR_def_label(dump__dump_deep_prop_measurements_3_0,13)
	...
	MR_Word MR_tempr1;
	MR_tempr1 = MR_sv(1);
	MR_sv(2) = MR_tfield(0, MR_tempr1, 19);
	MR_sv(3) = MR_tfield(0, MR_tempr1, 20);
	MR_r1 = MR_sv(5);
	MR_r2 = MR_sv(2);
	}
	MR_np_call_localret_ent(fn__array__max_1_0,
...
MR_def_label(dump__dump_deep_prop_measurements_3_0,19)
	...
	MR_Word MR_tempr1;
	MR_tempr1 = MR_sv(1);
	MR_sv(1) = MR_tfield(0, MR_tempr1, 21);
	MR_sv(2) = MR_tfield(0, MR_tempr1, 22);
	MR_r1 = MR_sv(5);
	MR_r2 = MR_sv(1);
	}
	MR_np_call_localret_ent(fn__array__max_1_0,
...
MR_def_label(dump__dump_proc_dynamic_5_0,2)
	...
	MR_r1 = MR_sv(1);
	MR_sv(1) = MR_r2;
	MR_sv(5) = (MR_Word) MR_string_const("UNKNOWN_PS", 10);
	MR_np_call_localret_ent(fn__string__int_to_string_1_0,
