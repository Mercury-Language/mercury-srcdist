...
MR_decl_label3(__Unify___dump__restriction_0_0, 27,5,1)
MR_decl_label5(__Compare___dump__restriction_0_0, 5,3,39,9,36)
...
MR_BEGIN_MODULE(dump_module35)
	...
	MR_init_label3(__Unify___dump__restriction_0_0,27,5,1)
MR_BEGIN_CODE
...
MR_def_static(__Unify___dump__restriction_0_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
		MR_GOTO_LAB(__Unify___dump__restriction_0_0_i27);
	}
	MR_r1 = (MR_r2 == MR_r1);
	MR_proceed();
MR_def_label(__Unify___dump__restriction_0_0,27)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(3);
	MR_sv(3) = (MR_Word) MR_succip;
	if (MR_LTAGS_TEST(MR_r2,0,0)) {
	...
	MR_np_call_localret_ent(__Unify___list__list_1_0,
		__Unify___dump__restriction_0_0_i5);
...
MR_BEGIN_MODULE(dump_module36)
	...
	MR_init_label5(__Compare___dump__restriction_0_0,5,3,39,9,36)
MR_BEGIN_CODE
...
MR_def_static(__Compare___dump__restriction_0_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
		MR_GOTO_LAB(__Compare___dump__restriction_0_0_i3);
	}
...
MR_def_label(__Compare___dump__restriction_0_0,5)
	...
	MR_r1 = (MR_Integer) 1;
	MR_proceed();
MR_def_label(__Compare___dump__restriction_0_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r2,0,0)) {
		MR_GOTO_LAB(__Compare___dump__restriction_0_0_i39);
	}
	MR_r1 = (MR_Integer) 2;
	MR_proceed();
MR_def_label(__Compare___dump__restriction_0_0,39)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(3);
	MR_sv(3) = (MR_Word) MR_succip;
	...
	MR_np_call_localret_ent(__Compare___list__list_1_0,
		__Compare___dump__restriction_0_0_i9);
MR_def_label(__Compare___dump__restriction_0_0,9)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___dump__restriction_0_0_i36);
	}
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(profile, call_site_static_ptr);
	MR_r2 = MR_sv(2);
	MR_r3 = MR_sv(1);
...
MR_def_label(__Compare___dump__restriction_0_0,36)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(3);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
