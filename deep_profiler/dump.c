  ...
  if (!((CalleeList_10 == (MR_Word) ((MR_Unsigned) 0U))))
  {
    ...
    else
    {
      ...
      mercury__io__write_string_4_p_0(OutputStream_6, (MR_String) " calls several procedures:\n");
      {
        ...
        MR_hl_field(MR_mktag(0), Var_31, 0) = ((MR_Box) (&dump_scalar_common_5[10]));
        MR_hl_field(MR_mktag(0), Var_31, 1) = ((MR_Box) (dump__dump_call_site_calls_5_p_0_1));
        MR_hl_field(MR_mktag(0), Var_31, 2) = ((MR_Box) ((MR_Integer) 2));
        MR_hl_field(MR_mktag(0), Var_31, 3) = ((MR_Box) (OutputStream_6));
        MR_hl_field(MR_mktag(0), Var_31, 4) = ((MR_Box) ((MR_String) "\t"));
      }
  ...
  if (succeeded)
  {
    ...
    if ((MaybeCoveragePoints_24 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      ...
      mercury__io__write_string_4_p_0(OutputStream_7, (MR_String) "\tCoverage counts not present in proc static\n");
      {
        ...
        MR_hl_field(MR_mktag(0), Var_82, 0) = ((MR_Box) (&dump_scalar_common_5[9]));
        MR_hl_field(MR_mktag(0), Var_82, 1) = ((MR_Box) (dump__dump_proc_static_6_p_0_2));
        MR_hl_field(MR_mktag(0), Var_82, 2) = ((MR_Box) ((MR_Integer) 1));
        MR_hl_field(MR_mktag(0), Var_82, 3) = ((MR_Box) (OutputStream_7));
      }
    ...
    else
    {
      ...
      coverage__coverage_point_arrays_to_list_3_p_0(CoveragePointInfos_23, CoveragePointsArray_28, &CoveragePoints_29);
      {
        ...
        MR_hl_field(MR_mktag(0), Var_77, 0) = ((MR_Box) (&dump_scalar_common_6[3]));
        MR_hl_field(MR_mktag(0), Var_77, 1) = ((MR_Box) (dump__dump_proc_static_6_p_0_3));
        MR_hl_field(MR_mktag(0), Var_77, 2) = ((MR_Box) ((MR_Integer) 1));
        MR_hl_field(MR_mktag(0), Var_77, 3) = ((MR_Box) (OutputStream_7));
      }
