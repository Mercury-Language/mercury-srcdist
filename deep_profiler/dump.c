...
{
  {
    ...
    mercury__io__write_string_3_p_0((MR_String) "\n");
    *STATE_VARIABLE_Num_15 = (STATE_VARIABLE_Num_0_14 + (MR_Integer) 1);
  }
}
  ...
  while (MR_TRUE)
  {
    /* tailcall optimized into a loop */
    {
      ...
      if (succeeded)
      {
        ...
        Var_18 = (Cur_7 + (MR_Integer) 1);
        /* direct tailcall eliminated */
        {
          MR_Integer next_value_of_Cur_7 = Var_18;
  ...
  while (MR_TRUE)
  {
    /* tailcall optimized into a loop */
    {
      ...
      if (succeeded)
      {
        ...
        Var_19 = (Cur_7 + (MR_Integer) 1);
        /* direct tailcall eliminated */
        {
          MR_Integer next_value_of_Cur_7 = Var_19;
