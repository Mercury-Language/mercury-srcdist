  ...
  else
  {
    ...
    switch (NeedsHelp_10) {
      ...
      case (MR_Integer) 0:
        ...
        {
          MR_Word ArrayOptionStrs_69;
          MR_Word RestrictBool_70;
          MR_Word Restrict_71;
          MR_Word DumpOptions0_72;
          MR_Word Var_76;
          MR_Word Var_79;
          MR_Unsigned packed_word_1;
          MR_Word ArrayOptions_73;

          mercury__getopt__lookup_accumulating_option_3_p_0((MR_Word) (&mdprof_dump__mdprof_dump__type_ctor_info_option_0), Options_9, ((MR_Box) ((MR_Integer) 1)), &ArrayOptionStrs_69);
          mercury__getopt__lookup_bool_option_3_p_0((MR_Word) (&mdprof_dump__mdprof_dump__type_ctor_info_option_0), Options_9, ((MR_Box) ((MR_Integer) 2)), &RestrictBool_70);
          switch (RestrictBool_70) {
            default: /*NOTREACHED*/ MR_assert(0);
            case (MR_Integer) 0:
              Restrict_71 = (MR_Integer) 1;
              break;
            case (MR_Integer) 1:
              Restrict_71 = (MR_Integer) 0;
              break;
          }
          Var_76 = dump__default_dump_options_0_f_0();
          Var_79 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_76, (MR_Integer) 1))));
          packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Var_76, (MR_Integer) 2)));
          {
            DumpOptions0_72 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
            MR_hl_field(MR_mktag(0), DumpOptions0_72, 0) = (MR_Box) ((MR_Unsigned) (Restrict_71));
            MR_hl_field(MR_mktag(0), DumpOptions0_72, 1) = ((MR_Box) (Var_79));
            MR_hl_field(MR_mktag(0), DumpOptions0_72, 2) = (MR_Box) (packed_word_1);
          }
          succeeded = dump__dump_array_options_2_p_0(ArrayOptionStrs_69, &ArrayOptions_73);
          if (succeeded)
          {
            MR_Word DumpOptions_13;
            MR_Word Var_84 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), DumpOptions0_72, (MR_Integer) 0))) & (MR_Integer) 1);
            MR_Unsigned packed_word_3 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), DumpOptions0_72, (MR_Integer) 2)));

            {
              DumpOptions_13 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
              MR_hl_field(MR_mktag(0), DumpOptions_13, 0) = (MR_Box) ((MR_Unsigned) (Var_84));
              MR_hl_field(MR_mktag(0), DumpOptions_13, 1) = ((MR_Box) (ArrayOptions_73));
