...
static /* final */ const struct mdprof_dump__vector_common_type_5_0_s mdprof_dump_vector_common_5[3] = {
  ...
  {
    (MR_Integer) 0,
    (MR_Word) (MR_mkword(MR_mktag(1), &mdprof_dump_scalar_common_2[0]))
  },
  /* row   1 */
  {
    (MR_Integer) 1,
    (MR_Word) (MR_mkword(MR_mktag(3), &mdprof_dump_scalar_common_3[0]))
  },
  /* row   2 */
  {
    (MR_Integer) 2,
...
main_2_p_0(void)
{
  ...
  mercury__getopt__process_options_4_p_0((MR_Word) (&mdprof_dump__mdprof_dump__type_ctor_info_option_0), (MR_Word) (MR_mkword(MR_mktag(2), &mdprof_dump_scalar_common_1[4])), Args0_5, &Args_7, &MaybeOptions_8);
  if (((MR_tag((MR_Word) MaybeOptions_8)) == (MR_Integer) 1))
  {
    MR_Word Error_17 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MaybeOptions_8, (MR_Integer) 0))));
    MR_String Msg_18;
    MR_Word StdErr_19;
  ...
  else
  {
    ...
    switch (NeedsHelp_10) {
      ...
      case (MR_Integer) 0:
        ...
        {
          MR_Word ArrayOptionStrs_67;
          MR_Word RestrictBool_68;
          MR_Word Restrict_69;
          MR_Word DumpOptions0_70;
          MR_Word Var_74;
          MR_Word Var_77;
          MR_Unsigned packed_word_1;
          MR_Word ArrayOptions_71;

          mercury__getopt__lookup_accumulating_option_3_p_0((MR_Word) (&mdprof_dump__mdprof_dump__type_ctor_info_option_0), Options_9, ((MR_Box) ((MR_Integer) 1)), &ArrayOptionStrs_67);
          mercury__getopt__lookup_bool_option_3_p_0((MR_Word) (&mdprof_dump__mdprof_dump__type_ctor_info_option_0), Options_9, ((MR_Box) ((MR_Integer) 2)), &RestrictBool_68);
          switch (RestrictBool_68) {
            default: /*NOTREACHED*/ MR_assert(0);
            case (MR_Integer) 0:
              Restrict_69 = (MR_Integer) 1;
              break;
            case (MR_Integer) 1:
              Restrict_69 = (MR_Integer) 0;
              break;
          }
          Var_74 = dump__default_dump_options_0_f_0();
          Var_77 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_74, (MR_Integer) 1))));
          packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Var_74, (MR_Integer) 2)));
          {
            DumpOptions0_70 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
            MR_hl_field(MR_mktag(0), DumpOptions0_70, 0) = (MR_Box) ((MR_Unsigned) (Restrict_69));
            MR_hl_field(MR_mktag(0), DumpOptions0_70, 1) = ((MR_Box) (Var_77));
            MR_hl_field(MR_mktag(0), DumpOptions0_70, 2) = (MR_Box) (packed_word_1);
          }
          succeeded = dump__dump_array_options_2_p_0(ArrayOptionStrs_67, &ArrayOptions_71);
          if (succeeded)
          {
            MR_Word DumpOptions_13;
            MR_Word MaybeInitialDeep_89;
            MR_Word Var_82 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), DumpOptions0_70, (MR_Integer) 0))) & (MR_Integer) 1);
            MR_Unsigned packed_word_3 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), DumpOptions0_70, (MR_Integer) 2)));

            {
              DumpOptions_13 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
              MR_hl_field(MR_mktag(0), DumpOptions_13, 0) = (MR_Box) ((MR_Unsigned) (Var_82));
              MR_hl_field(MR_mktag(0), DumpOptions_13, 1) = ((MR_Box) (ArrayOptions_71));
              MR_hl_field(MR_mktag(0), DumpOptions_13, 2) = (MR_Box) (packed_word_3);
            }
            read_profile__read_call_graph_4_p_0((MR_String) "Deep.data", &MaybeInitialDeep_89);
            if (((MR_tag((MR_Word) MaybeInitialDeep_89)) == (MR_Integer) 1))
            {
              MR_String Msg_92 = ((MR_String) ((MR_hl_field(MR_mktag(1), MaybeInitialDeep_89, (MR_Integer) 0))));
              MR_Word StdErr_93;

              mercury__io__stderr_stream_3_p_0(&StdErr_93);
              mercury__io__write_string_4_p_0(StdErr_93, (MR_String) "Cannot read ");
              mercury__io__write_string_4_p_0(StdErr_93, (MR_String) "Deep.data");
              mercury__io__write_string_4_p_0(StdErr_93, (MR_String) ": ");
              mercury__io__write_string_4_p_0(StdErr_93, Msg_92);
              mercury__io__write_string_4_p_0(StdErr_93, (MR_String) "\n");
            }
            else
            {
              MR_Word InitialDeep_90 = ((MR_Word) ((MR_hl_field(MR_mktag(0), MaybeInitialDeep_89, (MR_Integer) 0))));
              MR_Word StdOut_91;

              mercury__io__stdout_stream_3_p_0(&StdOut_91);
              dump__dump_initial_deep_5_p_0(InitialDeep_90, DumpOptions_13, StdOut_91);
            }
          }
          else
        ...
        {
          MR_Word Var_60 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Args_7, (MR_Integer) 1))));
          MR_String Var_61 = ((MR_String) ((MR_hl_field(MR_mktag(1), Args_7, (MR_Integer) 0))));

          if ((Var_60 == (MR_Word) ((MR_Unsigned) 0U)))
          {
            MR_Word MaybeDumpOptions_55;

            mdprof_dump__make_dump_options_2_p_0(Options_9, &MaybeDumpOptions_55);
            if ((MaybeDumpOptions_55 == (MR_Word) ((MR_Unsigned) 0U)))
              mdprof_dump__usage_3_p_0(ProgName_4);
            else
            {
              MR_Word DumpOptions_52 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MaybeDumpOptions_55, (MR_Integer) 0))));

              mdprof_dump__main_2_4_p_0(DumpOptions_52, Var_61);
            }
          }
          else
            mdprof_dump__usage_3_p_0(ProgName_4);
  ...
  MR_String ProgName_4)
{
  ...
  Var_62 = mercury__string__f_43_43_2_f_0((MR_String) "\t-D prop\n", (MR_String) "\t\tDump propagated measurement information.\n");
  Var_60 = mercury__string__f_43_43_2_f_0((MR_String) "\t\tDump reverse links.\n", Var_62);
  Var_58 = mercury__string__f_43_43_2_f_0((MR_String) "\t-D rev\n", Var_60);
  Var_56 = mercury__string__f_43_43_2_f_0((MR_String) "\t\tDump information about cliques.\n", Var_58);
  Var_54 = mercury__string__f_43_43_2_f_0((MR_String) "\t-D clique\n", Var_56);
  Var_52 = mercury__string__f_43_43_2_f_0((MR_String) "\nThe following options are unimplemented.\n", Var_54);
  Var_50 = mercury__string__f_43_43_2_f_0((MR_String) "\t\tDump proc statics.\n", Var_52);
  Var_48 = mercury__string__f_43_43_2_f_0((MR_String) "\t-D ps\n", Var_50);
  Var_46 = mercury__string__f_43_43_2_f_0((MR_String) "\t\tDump call-site statics.\n", Var_48);
  Var_44 = mercury__string__f_43_43_2_f_0((MR_String) "\t-D css\n", Var_46);
  Var_42 = mercury__string__f_43_43_2_f_0((MR_String) "\t\tDump proc dynamics.\n", Var_44);
  Var_40 = mercury__string__f_43_43_2_f_0((MR_String) "\t-D pd\n", Var_42);
  Var_38 = mercury__string__f_43_43_2_f_0((MR_String) "\t\tDump call-site dynamics.\n", Var_40);
  Var_36 = mercury__string__f_43_43_2_f_0((MR_String) "\t-D csd\n", Var_38);
  Var_34 = mercury__string__f_43_43_2_f_0((MR_String) "\t\tDump all arrays, (default).\n", Var_36);
  Var_32 = mercury__string__f_43_43_2_f_0((MR_String) "\t-D all\n", Var_34);
  Var_30 = mercury__string__f_43_43_2_f_0((MR_String) "\t\tnot referenced from the proc dynamics\n", Var_32);
  Var_28 = mercury__string__f_43_43_2_f_0((MR_String) "\t\tDo not dump proc and call-site statics that are\n", Var_30);
  Var_26 = mercury__string__f_43_43_2_f_0((MR_String) "\t-r, --restrict\n", Var_28);
  Var_24 = mercury__string__f_43_43_2_f_0((MR_String) "\t\tDisplay this message.\n", Var_26);
  Var_22 = mercury__string__f_43_43_2_f_0((MR_String) "\t-h, --help\n", Var_24);
  ...
  MR_Word * MaybeDumpOptions_4)
{
  ...
  packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Var_12, (MR_Integer) 2)));
  {
    DumpOptions0_8 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(MR_mktag(0), DumpOptions0_8, 0) = (MR_Box) ((MR_Unsigned) (Restrict_7));
    MR_hl_field(MR_mktag(0), DumpOptions0_8, 1) = ((MR_Box) (Var_15));
    MR_hl_field(MR_mktag(0), DumpOptions0_8, 2) = (MR_Box) (packed_word_1);
  }
  succeeded = dump__dump_array_options_2_p_0(ArrayOptionStrs_5, &ArrayOptions_9);
  if (succeeded)
  {
    MR_Word Var_13;
    MR_Word Var_20 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), DumpOptions0_8, (MR_Integer) 0))) & (MR_Integer) 1);
    MR_Unsigned packed_word_3 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), DumpOptions0_8, (MR_Integer) 2)));

    {
      Var_13 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), Var_13, 0) = (MR_Box) ((MR_Unsigned) (Var_20));
      MR_hl_field(MR_mktag(0), Var_13, 1) = ((MR_Box) (ArrayOptions_9));
      MR_hl_field(MR_mktag(0), Var_13, 2) = (MR_Box) (packed_word_3);
    }
    {
      MR_Word base;
  ...
  MR_String FileName_6)
{
  ...
  {
    MR_String Msg_11 = ((MR_String) ((MR_hl_field(MR_mktag(1), MaybeInitialDeep_8, (MR_Integer) 0))));
    MR_Word StdErr_12;
