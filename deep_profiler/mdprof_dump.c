...
static /* final */ const MR_Box mdprof_dump_scalar_common_1[1][1];

static /* final */ const MR_Box mdprof_dump_scalar_common_2[1][2];

static /* final */ const MR_Box mdprof_dump_scalar_common_3[3][5];

static /* final */ const MR_Box mdprof_dump_scalar_common_4[4][3];
...
static /* final */ const MR_Box mdprof_dump_scalar_common_4[4][3] = {
  /* row   0 */
  {
    ((MR_Box) (&mdprof_dump_scalar_common_3[0])),
    ((MR_Box) (main_2_p_0_1)),
    ((MR_Box) ((MR_Integer) 0))
  },
  /* row   1 */
  {
    ((MR_Box) (&mdprof_dump_scalar_common_3[1])),
    ((MR_Box) (main_2_p_0_2)),
    ((MR_Box) ((MR_Integer) 0))
  },
  /* row   2 */
  {
    ((MR_Box) (&mdprof_dump_scalar_common_3[2])),
    ((MR_Box) (main_2_p_0_4)),
    ((MR_Box) ((MR_Integer) 0))
  },
  /* row   3 */
...
static /* final */ const struct mdprof_dump__vector_common_type_5_0_s mdprof_dump_vector_common_5[3] = {
  ...
  {
    (MR_Integer) 0,
    (MR_Word) (MR_mkword(1, &mdprof_dump_scalar_common_1[0]))
  },
  /* row   1 */
  {
    (MR_Integer) 1,
    (MR_Word) (MR_mkword(3, &mdprof_dump_scalar_common_2[0]))
  },
  /* row   2 */
  {
    (MR_Integer) 2,
...
main_2_p_0(void)
{
  ...
  mercury__getopt__process_options_4_p_0((MR_Word) (&mdprof_dump__mdprof_dump__type_ctor_info_option_0), (MR_Word) (MR_mkword(2, &mdprof_dump_scalar_common_4[3])), Args0_5, &Args_7, &MaybeOptions_8);
  if (((MR_tag((MR_Word) MaybeOptions_8)) == (MR_Integer) 1))
  {
    MR_Word Error_17 = ((MR_Word) ((MR_hl_field(1, MaybeOptions_8, 0))));
    MR_String Msg_18;
    MR_Word StdErr_19;
  ...
  {
    MR_Word Options_9 = ((MR_Word) ((MR_hl_field(0, MaybeOptions_8, 0))));
    ...
    switch (NeedsHelp_10) {
      ...
      case (MR_Integer) 0:
        if ((Args_7 == (MR_Word) ((MR_Unsigned) 0U)))
        {
          ...
          Var_76 = ((MR_Word) ((MR_hl_field(0, Var_73, 1))));
          packed_word_0 = (MR_Unsigned) ((MR_hl_field(0, Var_73, 2)));
          {
            ...
            MR_hl_field(0, DumpOptions0_69, 2) = (MR_Box) (packed_word_0);
          }
          ...
          if (succeeded)
          {
            ...
            MR_Word Var_81 = ((MR_Unsigned) ((MR_hl_field(0, DumpOptions0_69, 0))) & (MR_Integer) 1);
            MR_Unsigned packed_word_2 = (MR_Unsigned) ((MR_hl_field(0, DumpOptions0_69, 2)));

            {
              ...
              MR_hl_field(0, DumpOptions_13, 2) = (MR_Box) (packed_word_2);
            }
            ...
            {
              MR_String Msg_91 = ((MR_String) ((MR_hl_field(1, MaybeInitialDeep_88, 0))));
              MR_Word StdErr_92;
            ...
            {
              MR_Word InitialDeep_89 = ((MR_Word) ((MR_hl_field(0, MaybeInitialDeep_88, 0))));
              MR_Word StdOut_90;
        ...
        {
          MR_Word Var_59 = ((MR_Word) ((MR_hl_field(1, Args_7, 1))));
          MR_String Var_60 = ((MR_String) ((MR_hl_field(1, Args_7, 0))));
          ...
          if ((Var_59 == (MR_Word) ((MR_Unsigned) 0U)))
          {
            ...
            {
              MR_Word DumpOptions_51 = ((MR_Word) ((MR_hl_field(1, MaybeDumpOptions_54, 0))));
  ...
  MR_Word * MaybeDumpOptions_4)
{
  ...
  Var_15 = ((MR_Word) ((MR_hl_field(0, Var_12, 1))));
  packed_word_0 = (MR_Unsigned) ((MR_hl_field(0, Var_12, 2)));
  {
    ...
    MR_hl_field(0, DumpOptions0_8, 2) = (MR_Box) (packed_word_0);
  }
  succeeded = dump__dump_array_options_2_p_0(ArrayOptionStrs_5, &ArrayOptions_9);
  if (succeeded)
  {
    MR_Word Var_13;
    MR_Word Var_20 = ((MR_Unsigned) ((MR_hl_field(0, DumpOptions0_8, 0))) & (MR_Integer) 1);
    MR_Unsigned packed_word_2 = (MR_Unsigned) ((MR_hl_field(0, DumpOptions0_8, 2)));

    {
      ...
      MR_hl_field(0, Var_13, 2) = (MR_Box) (packed_word_2);
    }
    {
      MR_Word base;
  ...
  MR_String FileName_6)
{
  ...
  {
    MR_String Msg_11 = ((MR_String) ((MR_hl_field(1, MaybeInitialDeep_8, 0))));
    MR_Word StdErr_12;
  ...
  {
    MR_Word InitialDeep_9 = ((MR_Word) ((MR_hl_field(0, MaybeInitialDeep_8, 0))));
    MR_Word StdOut_10;
