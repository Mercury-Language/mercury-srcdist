    ...
    switch (NeedsHelp_10) {
      ...
      case (MR_Integer) 0:
        if ((Args_7 == (MR_Word) ((MR_Unsigned) 0U)))
        {
          ...
          packed_word_0 = (MR_Unsigned) ((MR_hl_field(0, Var_73, (MR_Integer) 2)));
          {
          ...
          if (succeeded)
          {
            ...
            MR_Unsigned packed_word_2 = (MR_Unsigned) ((MR_hl_field(0, DumpOptions0_69, (MR_Integer) 2)));
  ...
  MR_Word * MaybeDumpOptions_4)
{
  ...
  packed_word_0 = (MR_Unsigned) ((MR_hl_field(0, Var_12, (MR_Integer) 2)));
  {
  ...
  if (succeeded)
  {
    ...
    MR_Unsigned packed_word_2 = (MR_Unsigned) ((MR_hl_field(0, DumpOptions0_8, (MR_Integer) 2)));
