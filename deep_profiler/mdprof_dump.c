    ...
    switch (NeedsHelp_10) {
      ...
      case (MR_Integer) 0:
        if ((Args_7 == (MR_Word) ((MR_Unsigned) 0U)))
        {
          ...
          Var_76 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_73, (MR_Integer) 1))));
          packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Var_73, (MR_Integer) 2)));
          {
            ...
            MR_hl_field(MR_mktag(0), DumpOptions0_69, 0) = (MR_Box) ((MR_Unsigned) (Restrict_68));
            MR_hl_field(MR_mktag(0), DumpOptions0_69, 1) = ((MR_Box) (Var_76));
            MR_hl_field(MR_mktag(0), DumpOptions0_69, 2) = (MR_Box) (packed_word_1);
          }
          ...
          if (succeeded)
          {
            ...
            MR_Word Var_81 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), DumpOptions0_69, (MR_Integer) 0))) & (MR_Integer) 1);
            MR_Unsigned packed_word_3 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), DumpOptions0_69, (MR_Integer) 2)));

            {
              DumpOptions_13 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
              MR_hl_field(MR_mktag(0), DumpOptions_13, 0) = (MR_Box) ((MR_Unsigned) (Var_81));
              MR_hl_field(MR_mktag(0), DumpOptions_13, 1) = ((MR_Box) (ArrayOptions_70));
            ...
            {
              MR_String Msg_91 = ((MR_String) ((MR_hl_field(MR_mktag(1), MaybeInitialDeep_88, (MR_Integer) 0))));
              MR_Word StdErr_92;
            ...
            {
              MR_Word InitialDeep_89 = ((MR_Word) ((MR_hl_field(MR_mktag(0), MaybeInitialDeep_88, (MR_Integer) 0))));
              MR_Word StdOut_90;
