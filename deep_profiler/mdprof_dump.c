      ...
      switch (NeedsHelp_10) {
        ...
        case (MR_Integer) 0:
          if ((Args_7 == (MR_Word) ((MR_Unsigned) 0U)))
          {
            ...
            packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Var_75, (MR_Integer) 0)));
            ...
            if (succeeded)
            {
              ...
              MR_Unsigned packed_word_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), DumpOptions0_71, (MR_Integer) 0)));
...
{
  {
    ...
    packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Var_12, (MR_Integer) 0)));
    ...
    if (succeeded)
    {
      ...
      MR_Unsigned packed_word_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), DumpOptions0_8, (MR_Integer) 0)));
