  ...
  else
  {
    ...
    switch (NeedsHelp_10) {
      ...
      case (MR_Integer) 0:
        ...
        {
          MR_Word ArrayOptionStrs_64;
          MR_Word RestrictBool_65;
          MR_Word Restrict_66;
          MR_Word DumpOptions0_67;
          MR_Word Var_71;
          MR_Word Var_74;
          MR_Unsigned packed_word_1;
          MR_Word ArrayOptions_68;

          mercury__getopt__lookup_accumulating_option_3_p_0((MR_Word) (&mdprof_dump__mdprof_dump__type_ctor_info_option_0), Options_9, ((MR_Box) ((MR_Integer) 1)), &ArrayOptionStrs_64);
          mercury__getopt__lookup_bool_option_3_p_0((MR_Word) (&mdprof_dump__mdprof_dump__type_ctor_info_option_0), Options_9, ((MR_Box) ((MR_Integer) 2)), &RestrictBool_65);
          switch (RestrictBool_65) {
            default: /*NOTREACHED*/ MR_assert(0);
            case (MR_Integer) 0:
              Restrict_66 = (MR_Integer) 1;
              break;
            case (MR_Integer) 1:
              Restrict_66 = (MR_Integer) 0;
              break;
          }
          Var_71 = dump__default_dump_options_0_f_0();
          Var_74 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_71, (MR_Integer) 1))));
          packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Var_71, (MR_Integer) 2)));
          {
            DumpOptions0_67 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
            MR_hl_field(MR_mktag(0), DumpOptions0_67, 0) = (MR_Box) ((MR_Unsigned) (Restrict_66));
            MR_hl_field(MR_mktag(0), DumpOptions0_67, 1) = ((MR_Box) (Var_74));
            MR_hl_field(MR_mktag(0), DumpOptions0_67, 2) = (MR_Box) (packed_word_1);
          }
          succeeded = dump__dump_array_options_2_p_0(ArrayOptionStrs_64, &ArrayOptions_68);
          if (succeeded)
          {
            MR_Word DumpOptions_13;
            MR_Word MaybeInitialDeep_86;
            MR_Word Var_79 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), DumpOptions0_67, (MR_Integer) 0))) & (MR_Integer) 1);
            MR_Unsigned packed_word_3 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), DumpOptions0_67, (MR_Integer) 2)));

            {
              DumpOptions_13 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
              MR_hl_field(MR_mktag(0), DumpOptions_13, 0) = (MR_Box) ((MR_Unsigned) (Var_79));
              MR_hl_field(MR_mktag(0), DumpOptions_13, 1) = ((MR_Box) (ArrayOptions_68));
              MR_hl_field(MR_mktag(0), DumpOptions_13, 2) = (MR_Box) (packed_word_3);
            }
            read_profile__read_call_graph_4_p_0((MR_String) "Deep.data", &MaybeInitialDeep_86);
            if (((MR_tag((MR_Word) MaybeInitialDeep_86)) == (MR_Integer) 1))
            {
              MR_String Msg_89 = ((MR_String) ((MR_hl_field(MR_mktag(1), MaybeInitialDeep_86, (MR_Integer) 0))));
              MR_Word StdErr_90;

              mercury__io__stderr_stream_3_p_0(&StdErr_90);
              mercury__io__write_string_4_p_0(StdErr_90, (MR_String) "Cannot read ");
              mercury__io__write_string_4_p_0(StdErr_90, (MR_String) "Deep.data");
              mercury__io__write_string_4_p_0(StdErr_90, (MR_String) ": ");
              mercury__io__write_string_4_p_0(StdErr_90, Msg_89);
              mercury__io__write_string_4_p_0(StdErr_90, (MR_String) "\n");
            }
            else
            {
              MR_Word InitialDeep_87 = ((MR_Word) ((MR_hl_field(MR_mktag(0), MaybeInitialDeep_86, (MR_Integer) 0))));
              MR_Word StdOut_88;

              mercury__io__stdout_stream_3_p_0(&StdOut_88);
              dump__dump_initial_deep_5_p_0(InitialDeep_87, DumpOptions_13, StdOut_88);
            }
          }
          else
        ...
        {
          MR_Word Var_57 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Args_7, (MR_Integer) 1))));
          MR_String Var_58 = ((MR_String) ((MR_hl_field(MR_mktag(1), Args_7, (MR_Integer) 0))));

          if ((Var_57 == (MR_Word) ((MR_Unsigned) 0U)))
          {
            MR_Word MaybeDumpOptions_52;

            mdprof_dump__make_dump_options_2_p_0(Options_9, &MaybeDumpOptions_52);
            if ((MaybeDumpOptions_52 == (MR_Word) ((MR_Unsigned) 0U)))
              mdprof_dump__usage_3_p_0(ProgName_4);
            else
            {
              MR_Word DumpOptions_49 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MaybeDumpOptions_52, (MR_Integer) 0))));

              mdprof_dump__main_2_4_p_0(DumpOptions_49, Var_58);
            }
          }
          else
            mdprof_dump__usage_3_p_0(ProgName_4);
