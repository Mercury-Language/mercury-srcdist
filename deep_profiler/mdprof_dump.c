      ...
      switch (NeedsHelp_10) {
        ...
        case (MR_Integer) 0:
          if ((Args_7 == (MR_Word) ((MR_Unsigned) 0U)))
          {
            ...
            packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Var_75, (MR_Integer) 0)));
            Var_78 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_75, (MR_Integer) 1))));
            packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Var_75, (MR_Integer) 2)));
            {
              DumpOptions0_71 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL);
              MR_hl_field(MR_mktag(0), DumpOptions0_71, 0) = (MR_Box) ((MR_Unsigned) (((MR_Box) (Restrict_70))));
              MR_hl_field(MR_mktag(0), DumpOptions0_71, 1) = ((MR_Box) (Var_78));
              MR_hl_field(MR_mktag(0), DumpOptions0_71, 2) = (MR_Box) (packed_args_1);
            }
            succeeded = dump__dump_array_options_2_p_0(ArrayOptionStrs_68, &ArrayOptions_72);
            if (succeeded)
            {
              MR_Word DumpOptions_13;
              MR_Unsigned packed_args_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), DumpOptions0_71, (MR_Integer) 0)));
              MR_Unsigned packed_args_3 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), DumpOptions0_71, (MR_Integer) 2)));

              {
                DumpOptions_13 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL);
                MR_hl_field(MR_mktag(0), DumpOptions_13, 0) = (MR_Box) (packed_args_2);
                MR_hl_field(MR_mktag(0), DumpOptions_13, 1) = ((MR_Box) (ArrayOptions_72));
                MR_hl_field(MR_mktag(0), DumpOptions_13, 2) = (MR_Box) (packed_args_3);
              }
...
{
  {
    ...
    packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Var_12, (MR_Integer) 0)));
    Var_15 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_12, (MR_Integer) 1))));
    packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Var_12, (MR_Integer) 2)));
    {
      DumpOptions0_8 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), DumpOptions0_8, 0) = (MR_Box) ((MR_Unsigned) (((MR_Box) (Restrict_7))));
      MR_hl_field(MR_mktag(0), DumpOptions0_8, 1) = ((MR_Box) (Var_15));
      MR_hl_field(MR_mktag(0), DumpOptions0_8, 2) = (MR_Box) (packed_args_1);
    }
    succeeded = dump__dump_array_options_2_p_0(ArrayOptionStrs_5, &ArrayOptions_9);
    if (succeeded)
    {
      MR_Word Var_13;
      MR_Unsigned packed_args_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), DumpOptions0_8, (MR_Integer) 0)));
      MR_Unsigned packed_args_3 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), DumpOptions0_8, (MR_Integer) 2)));

      {
        Var_13 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), Var_13, 0) = (MR_Box) (packed_args_2);
        MR_hl_field(MR_mktag(0), Var_13, 1) = ((MR_Box) (ArrayOptions_9));
        MR_hl_field(MR_mktag(0), Var_13, 2) = (MR_Box) (packed_args_3);
      }
      {
        MR_Word base;
