      ...
      switch (NeedsHelp_10) {
        ...
        case (MR_Integer) 0:
          if ((Args_7 == (MR_Word) ((MR_Integer) 0)))
          {
            ...
            packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Var_75, (MR_Integer) 2)));
            {
              ...
              MR_hl_field(MR_mktag(0), DumpOptions0_71, 2) = (MR_Box) (packed_args_0);
            }
            ...
            if (succeeded)
            {
              ...
              MR_Unsigned packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), DumpOptions0_71, (MR_Integer) 2)));

              {
                ...
                MR_hl_field(MR_mktag(0), DumpOptions_13, 2) = (MR_Box) (packed_args_1);
              }
          ...
          else
          {
            ...
            if ((Var_59 == (MR_Word) ((MR_Integer) 0)))
            {
              ...
              if ((MaybeDumpOptions_54 == (MR_Word) ((MR_Integer) 0)))
                mdprof_dump__usage_3_p_0(ProgName_4);
              else
              {
...
{
  {
    ...
    packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Var_12, (MR_Integer) 2)));
    {
      ...
      MR_hl_field(MR_mktag(0), DumpOptions0_8, 2) = (MR_Box) (packed_args_0);
    }
    ...
    if (succeeded)
    {
      ...
      MR_Unsigned packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), DumpOptions0_8, (MR_Integer) 2)));

      {
        ...
        MR_hl_field(MR_mktag(0), Var_13, 2) = (MR_Box) (packed_args_1);
      }
      {
        MR_Word base;
      ...
      *MaybeDumpOptions_4 = (MR_Word) ((MR_Integer) 0);
  }
}
