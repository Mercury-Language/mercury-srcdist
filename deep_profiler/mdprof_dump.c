      ...
      switch (NeedsHelp_10) {
        ...
        case (MR_Integer) 0:
          if ((Args_7 == (MR_Word) ((MR_Unsigned) 0U)))
          {
            ...
            mercury__getopt__lookup_accumulating_option_3_p_0((MR_Word) (&mdprof_dump__mdprof_dump__type_ctor_info_option_0), Options_9, ((MR_Box) ((MR_Integer) 1)), &ArrayOptionStrs_68);
            mercury__getopt__lookup_bool_option_3_p_0((MR_Word) (&mdprof_dump__mdprof_dump__type_ctor_info_option_0), Options_9, ((MR_Box) ((MR_Integer) 2)), &RestrictBool_69);
            ...
            packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Var_75, (MR_Integer) 2)));
            {
              DumpOptions0_71 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
              MR_hl_field(MR_mktag(0), DumpOptions0_71, 0) = (MR_Box) ((MR_Unsigned) (Restrict_70));
              MR_hl_field(MR_mktag(0), DumpOptions0_71, 1) = ((MR_Box) (Var_78));
              MR_hl_field(MR_mktag(0), DumpOptions0_71, 2) = (MR_Box) (packed_word_1);
            }
            succeeded = dump__dump_array_options_2_p_0(ArrayOptionStrs_68, &ArrayOptions_72);
            if (succeeded)
            {
              MR_Word DumpOptions_13;
              MR_Word Var_83 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), DumpOptions0_71, (MR_Integer) 0))) & (MR_Integer) 1);
              MR_Unsigned packed_word_3 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), DumpOptions0_71, (MR_Integer) 2)));

              {
                DumpOptions_13 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
                MR_hl_field(MR_mktag(0), DumpOptions_13, 0) = (MR_Box) ((MR_Unsigned) (Var_83));
