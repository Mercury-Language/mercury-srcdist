...
static void MR_CALL 
mdbcomp__read_trace_counts__read_trace_counts_setup_5_p_0(
  MR_Word InputStream_6,
  MR_Word STATE_VARIABLE_TraceCounts_0_15,
  MR_Word * STATE_VARIABLE_TraceCounts_16);

static void MR_CALL 
mdbcomp__read_trace_counts__read_proc_trace_counts_9_p_0(
...
static void MR_CALL 
mdbcomp__read_trace_counts__read_proc_trace_counts_2_7_p_0(
...
static void MR_CALL 
mdbcomp__read_trace_counts__read_trace_counts_file_4_p_0_1(
  MR_Box closure_arg,
...
static /* final */ const struct mdbcomp__read_trace_counts__vector_common_type_5_0_s mdbcomp__read_trace_counts_vector_common_5[4];
  ...
  MR_Word HeadVar__2_2)
{
  ...
  if (((MR_tag((MR_Word) HeadVar__1_1)) == (MR_Integer) 1))
  {
    ...
    if (succeeded)
    {
      ...
      succeeded = mdbcomp__read_trace_counts____Unify____read_trace_counts_error_0_0(ArgX1_7, ArgY1_8);
    }
  }
  else
  {
    ...
    case (MR_Integer) 1:
      {
        ...
        mdbcomp__read_trace_counts__read_proc_trace_counts_9_p_0(InputStream_6, LineNumber_9, Line_11, (MR_Word) (&mdbcomp__read_trace_counts_scalar_common_3[4]), (MR_String) "", STATE_VARIABLE_TraceCounts_0_15, STATE_VARIABLE_TraceCounts_16);
      }
      break;
    case (MR_Integer) 2:
      {
  ...
  MR_Word * tscc_output_ptr_1_STATE_VARIABLE_TraceCounts_58)
{
  ...
  // The code for TSCC PROC 1: pred mdbcomp.read_trace_counts.read_proc_trace_counts/9-0.
  ;
  ...
  ;
  ;
  // proc 1 in TSCC: pred mdbcomp.read_trace_counts.read_proc_trace_counts/9-0
  ;
  // proc 2 in TSCC: pred mdbcomp.read_trace_counts.read_proc_trace_counts_2/7-0
  ;
  ;
  goto top_of_proc_1;
top_of_proc_1:;
              ...
              if (succeeded)
              {
                ...
                if (succeeded)
                {
                  ...
                  do
                  {
                    ...
                    result_3 = MR_strcmp(TokenName_19, ((&mdbcomp__read_trace_counts_vector_common_5[0 + mid_2]))->mdbcomp__read_trace_counts__vector_common_type_5_0__vct_5_f_0);
  ...
  MR_Word * tscc_output_ptr_1_STATE_VARIABLE_TraceCounts_58)
{
  ...
  // The code for TSCC PROC 2: pred mdbcomp.read_trace_counts.read_proc_trace_counts_2/7-0.
  ;
  // Setup for mutual tailcalls optimized into a loop.
  ;
  // The mutually recursive procedures are:
  ...
  MR_Box * wrapper_arg_3)
{
  ...
  mdbcomp__read_trace_counts__read_trace_counts_setup_5_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) ((MR_hl_field(0, closure, 4)))), &conv0_STATE_VARIABLE_TraceCounts_16);
...
{
  MR_bool succeeded;
  MR_String ActualFileName_17;
  MR_String GzipCmd_18;
  MR_Word Result_19;
  MR_String BaseName_15;

  succeeded = mercury__string__remove_suffix_3_p_0(FileName_5, (MR_String) ".gz", &BaseName_15);
  if (succeeded)
  {
    MR_String Var_27;
    MR_Word _UnzipResult_16;

    Var_27 = mercury__string__f_43_43_2_f_0((MR_String) "gunzip ", FileName_5);
    mercury__io__call_system__call_system_4_p_0(Var_27, &_UnzipResult_16);
    ActualFileName_17 = BaseName_15;
    GzipCmd_18 = mercury__string__f_43_43_2_f_0((MR_String) "gzip ", BaseName_15);
  }
  else
  {
    ActualFileName_17 = FileName_5;
    GzipCmd_18 = (MR_String) "";
  }
  mercury__io__open_input_4_p_0(ActualFileName_17, &Result_19);
  if (((MR_tag((MR_Word) Result_19)) == (MR_Integer) 1))
  {
    MR_Word ReadTCError_11;
    MR_String ErrorMsg_12;
    MR_Word IOError_24 = ((MR_Word) ((MR_hl_field(1, Result_19, 0))));

    {
      ReadTCError_11 = (MR_Word) MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(0, ReadTCError_11, 0) = ((MR_Box) (IOError_24));
    }
    ErrorMsg_12 = mdbcomp__read_trace_counts__read_trace_counts_error_to_str_2_f_0(FileName_5, ReadTCError_11);
    {
      MR_Word base;
      base = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
      *Result_6 = base;
      MR_hl_field(1, base, 0) = ((MR_Box) (ErrorMsg_12));
    }
  }
  else
  {
    MR_Word FileStream_20 = ((MR_Word) ((MR_hl_field(0, Result_19, 0))));
    MR_Word IdReadResult_21;
    MR_String FirstLine_22;
    MR_String Var_33;
    MR_String Var_38;

    mercury__io__read_line_as_string_4_p_0(FileStream_20, &IdReadResult_21);
    succeeded = ((MR_tag((MR_Word) IdReadResult_21)) == (MR_Integer) 1);
    if (succeeded)
    {
      FirstLine_22 = ((MR_String) ((MR_hl_field(1, IdReadResult_21, 0))));
      Var_33 = mercury__string__rstrip_1_f_0(FirstLine_22);
      Var_38 = mdbcomp__trace_counts__trace_count_file_id_0_f_0();
      succeeded = (strcmp(Var_33, Var_38) == 0);
    }
    if (succeeded)
    {
      MR_Word ReadTCResult_71;
      MR_Word FileTypeResult_39;

      mercury__io__read_4_p_0((MR_Word) (&mdbcomp__trace_counts__mdbcomp__trace_counts__type_ctor_info_trace_count_file_type_0), FileStream_20, &FileTypeResult_39);
      switch (MR_tag((MR_Word) FileTypeResult_39)) {
        default: /*NOTREACHED*/ MR_assert(0);
        case (MR_Integer) 0:
        case (MR_Integer) 2:
          ReadTCResult_71 = (MR_Word) (MR_mkword(1, &mdbcomp__read_trace_counts_scalar_common_3[3]));
          break;
        case (MR_Integer) 1:
          {
            MR_Word FileType_40 = ((MR_Word) ((MR_hl_field(1, FileTypeResult_39, 0))));
            MR_Word NewlineResult_41;
            MR_String Var_51;

            mercury__io__read_line_as_string_4_p_0(FileStream_20, &NewlineResult_41);
            succeeded = ((MR_tag((MR_Word) NewlineResult_41)) == (MR_Integer) 1);
            if (succeeded)
            {
              Var_51 = ((MR_String) ((MR_hl_field(1, NewlineResult_41, 0))));
            ...
            if (succeeded)
            {
              ...
              Var_53 = mercury__map__init_0_f_0((MR_Word) (&mdbcomp__trace_counts__mdbcomp__trace_counts__type_ctor_info_proc_label_in_context_0), (MR_Word) (&mdbcomp__read_trace_counts_scalar_common_1[0]));
              {
                Var_52 = (MR_Word) MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL);
                MR_hl_field(0, Var_52, 0) = ((MR_Box) (&mdbcomp__read_trace_counts_scalar_common_4[0]));
                MR_hl_field(0, Var_52, 1) = ((MR_Box) (mdbcomp__read_trace_counts__read_trace_counts_file_4_p_0_1));
                MR_hl_field(0, Var_52, 2) = ((MR_Box) ((MR_Integer) 2));
                MR_hl_field(0, Var_52, 3) = ((MR_Box) (FileStream_20));
                MR_hl_field(0, Var_52, 4) = ((MR_Box) (Var_53));
              }
              mercury__exception__try_io_4_p_0((MR_Word) (&mdbcomp__read_trace_counts_scalar_common_1[1]), Var_52, &Result_42);
              if (((MR_tag((MR_Word) Result_42)) == (MR_Integer) 2))
              {
                MR_Word Exception_44 = ((MR_Word) ((MR_hl_field(2, Result_42, 0))));
                MR_Word ReadError_46;
                MR_Word IOError_45;
                MR_Box conv1_IOError_45;

                succeeded = mercury__univ__univ_1_f_2((MR_Word) (&mercury__io__io__type_ctor_info_error_0), &conv1_IOError_45, Exception_44);
                if (succeeded)
                {
                  IOError_45 = ((MR_Word) (conv1_IOError_45));
                  succeeded = MR_TRUE;
                }
                if (succeeded)
                  {
                    ReadError_46 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(1, ReadError_46, 0) = ((MR_Box) (IOError_45));
                  }
                else
                {
                  MR_String Message_47;
                  MR_Box conv2_Message_47;

                  succeeded = mercury__univ__univ_1_f_2((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), &conv2_Message_47, Exception_44);
                  if (succeeded)
                  {
                    Message_47 = ((MR_String) (conv2_Message_47));
                    succeeded = MR_TRUE;
                  }
                  if (succeeded)
                    {
                      ReadError_46 = (MR_Word) MR_mkword(3, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                      MR_hl_field(3, ReadError_46, 0) = ((MR_Box) (Message_47));
                    }
                  else
                  {
                    MR_String Error_48;
                    ...
                    succeeded = mercury__univ__univ_1_f_2((MR_Word) (&mdbcomp__read_trace_counts__mdbcomp__read_trace_counts__type_ctor_info_trace_count_syntax_error_0), &conv3_Var_54, Exception_44);
                    if (succeeded)
                    {
                    ...
                    if (succeeded)
                    {
                      Error_48 = (MR_String) (Var_54);
                      succeeded = MR_TRUE;
                    }
                    if (succeeded)
                      {
                        ReadError_46 = (MR_Word) MR_mkword(2, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                        MR_hl_field(2, ReadError_46, 0) = ((MR_Box) (Error_48));
                      }
                    else
                    {
                      MR_String Var_56;
                      ...
                      Var_58 = mercury__string__string_1_f_0((MR_Word) (&mercury__univ__univ__type_ctor_info_univ_0), ((MR_Box) (Exception_44)));
                      Var_56 = mercury__string__f_43_43_2_f_0((MR_String) "unexpected exception type: ", Var_58);
                      {
                        mercury__require__unexpected_2_p_0((MR_String) "predicate \140mdbcomp.read_trace_counts.read_trace_counts_from_stream\'/4", Var_56);
                        return;
                      }
                    }
                  }
                ...
                {
                  ReadTCResult_71 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                  MR_hl_field(1, ReadTCResult_71, 0) = ((MR_Box) (ReadError_46));
                }
              }
              else
              {
                MR_Word TraceCounts_43 = ((MR_Word) ((MR_hl_field(1, Result_42, 0))));

                {
                  ReadTCResult_71 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
                  MR_hl_field(0, ReadTCResult_71, 0) = ((MR_Box) (FileType_40));
                  MR_hl_field(0, ReadTCResult_71, 1) = ((MR_Box) (TraceCounts_43));
                }
              }
            }
            else
      ...
      if (((MR_tag((MR_Word) ReadTCResult_71)) == (MR_Integer) 1))
      {
        MR_Word ReadTCError_67 = ((MR_Word) ((MR_hl_field(1, ReadTCResult_71, 0))));
        MR_String ErrorMsg_68;

        ErrorMsg_68 = mdbcomp__read_trace_counts__read_trace_counts_error_to_str_2_f_0(FileName_5, ReadTCError_67);
        {
          MR_Word base;
          base = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
          *Result_6 = base;
          MR_hl_field(1, base, 0) = ((MR_Box) (ErrorMsg_68));
        }
      }
      else
      {
        MR_Word FileType_9 = ((MR_Word) ((MR_hl_field(0, ReadTCResult_71, 0))));
        MR_Word TraceCount_10 = ((MR_Word) ((MR_hl_field(0, ReadTCResult_71, 1))));
    ...
    {
      MR_Word ReadTCError_74 = ((MR_Word) ((MR_hl_field(1, (MR_Word) (MR_mkword(1, &mdbcomp__read_trace_counts_scalar_common_3[1])), 0))));
      MR_String ErrorMsg_75;

      ErrorMsg_75 = mdbcomp__read_trace_counts__read_trace_counts_error_to_str_2_f_0(FileName_5, ReadTCError_74);
      {
        MR_Word base;
        base = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
        *Result_6 = base;
        MR_hl_field(1, base, 0) = ((MR_Box) (ErrorMsg_75));
      }
    }
    mercury__io__close_input_3_p_0(FileStream_20);
  }
  succeeded = (strcmp(GzipCmd_18, (MR_String) "") == 0);
  if (!(succeeded))
  {
    MR_Word _ZipResult_25;

    mercury__io__call_system__call_system_4_p_0(GzipCmd_18, &_ZipResult_25);
  }
}
