  ...
  MR_Word * BottomUpPDPtrCliqueList_4)
{
  ...
  cliques__init_1_p_0(&Graph0_14);
  {
    ...
    MR_hl_field(MR_mktag(0), Var_15, 0) = ((MR_Box) (&callgraph_scalar_common_4[0]));
    MR_hl_field(MR_mktag(0), Var_15, 1) = ((MR_Box) (callgraph__find_cliques_2_p_0_1));
    MR_hl_field(MR_mktag(0), Var_15, 2) = ((MR_Box) ((MR_Integer) 1));
    MR_hl_field(MR_mktag(0), Var_15, 3) = ((MR_Box) (InitDeep_3));
  }
  Var_16 = ((MR_ArrayPtr) ((MR_hl_field(MR_mktag(0), InitDeep_3, (MR_Integer) 3))));
    ...
    if (succeeded)
      ...
      else
      {
        ...
        mercury__list__map_3_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0), (MR_Word) (&profile__profile__type_ctor_info_proc_dynamic_ptr_0), (MR_Word) (&callgraph_scalar_common_3[0]), PDIList_26, &PDPtrList_25);
        {
          ...
          MR_hl_field(MR_mktag(1), STATE_VARIABLE_A_18_18, 0) = ((MR_Box) (PDPtrList_25));
