...
MR_decl_label3(callgraph__make_clique_indexes_4_0, 2,3,5)
...
MR_BEGIN_MODULE(callgraph_module1)
	...
	MR_init_label3(callgraph__make_clique_indexes_4_0,2,3,5)
MR_BEGIN_CODE
...
MR_def_label(callgraph__make_clique_indexes_4_0,3)
	...
	MR_np_call_localret_ent(array_util__array_foldl_from_1_4_1,
		callgraph__make_clique_indexes_4_0_i5);
MR_def_label(callgraph__make_clique_indexes_4_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
...
void mercury__callgraph__write_out_proc_statics(FILE *deep_fp, FILE *procrep_fp)
{
	MR_write_out_module_proc_reps_start(procrep_fp, &mercury_data__module_layout__callgraph);
