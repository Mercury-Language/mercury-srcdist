  ...
  MR_Word * STATE_VARIABLE_Graph_15)
{
  if (((MR_tag((MR_Word) CallSiteSlot_8)) == (MR_mktag((MR_Integer) 1))))
  {
    ...
    mercury__list__foldl_4_p_0((MR_Word) (&profile__profile__type_ctor_info_call_site_dynamic_ptr_0), (MR_Word) (&cliques__cliques__type_ctor_info_graph_0), Var_16, CSDPtrs_13, ((MR_Box) (STATE_VARIABLE_Graph_0_14)), &conv1_STATE_VARIABLE_Graph_15);
  ...
  while (MR_TRUE)
  {
    ...
    if (succeeded)
      ...
      else
      {
        ...
        mercury__set__to_sorted_list_2_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0), X_11, &PDIList_31);
        mercury__list__map_3_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0), (MR_Word) (&profile__profile__type_ctor_info_proc_dynamic_ptr_0), (MR_Word) (&callgraph_scalar_common_3[0]), PDIList_31, &PDPtrList_28);
        {
