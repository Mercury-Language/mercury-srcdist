...
{
  {
    ...
    callgraph__index_clique_member_4_p_0(((MR_Integer) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) (wrapper_arg_1)), ((MR_ArrayPtr) (wrapper_arg_2)), &conv0_STATE_VARIABLE_CliqueIndex_12);
...
{
  {
    ...
    callgraph__add_csd_arcs_5_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Integer) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))), ((MR_Word) (wrapper_arg_1)), ((MR_Word) (wrapper_arg_2)), &conv0_STATE_VARIABLE_Graph_17);
...
{
  {
    ...
    if (succeeded)
    {
      ...
      MR_Word ToPDPtr_12;
      MR_Integer ToPDI_13;
      MR_ArrayPtr Var_19 = ((MR_ArrayPtr) ((MR_hl_field(MR_mktag(0), InitDeep_6, (MR_Integer) 2))));
      MR_Box conv0_CSD_11;
