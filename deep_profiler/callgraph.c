  ...
  MR_Word * STATE_VARIABLE_Graph_15)
{
  if (((MR_tag((MR_Word) CallSiteSlot_8)) == (MR_Integer) 1))
  {
    ...
    mercury__array__to_list_2_p_0((MR_Word) (&profile__profile__type_ctor_info_call_site_dynamic_ptr_0), (MR_ArrayPtr) (CSDPtrArray_12), &CSDPtrs_13);
    {
      ...
      MR_hl_field(MR_mktag(0), Var_17, 0) = ((MR_Box) (&callgraph_scalar_common_4[2]));
      MR_hl_field(MR_mktag(0), Var_17, 1) = ((MR_Box) (callgraph__add_call_site_arcs_5_p_0_1));
      MR_hl_field(MR_mktag(0), Var_17, 2) = ((MR_Box) ((MR_Integer) 2));
      MR_hl_field(MR_mktag(0), Var_17, 3) = ((MR_Box) (InitDeep_6));
      MR_hl_field(MR_mktag(0), Var_17, 4) = ((MR_Box) (FromPDI_7));
    }
