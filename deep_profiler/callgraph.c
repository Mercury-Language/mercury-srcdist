...
{
  {
...

    {
      ...
      MR_hl_field(MR_mktag(0), callgraph__Var_10, 0) = ((MR_Box) (&callgraph_scalar_common_3[1]));
    ...
    if (((MR_tag((MR_Word) callgraph__CallSiteSlot_8)) == (MR_mktag((MR_Integer) 1))))
      {
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(0), callgraph__Var_16, 0) = ((MR_Box) (&callgraph_scalar_common_2[2]));
...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(0), callgraph__Var_14, 0) = ((MR_Box) (&callgraph_scalar_common_2[1]));
...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(0), callgraph__Var_17, 0) = ((MR_Box) (&callgraph_scalar_common_2[0]));
