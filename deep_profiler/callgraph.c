  ...
  MR_Word * STATE_VARIABLE_Graph_15)
{
  if (((MR_tag((MR_Word) CallSiteSlot_8)) == (MR_Integer) 1))
  {
    ...
    MR_Word CSDPtrs_13;
    MR_Word Var_16;
    MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), CallSiteSlot_8, (MR_Integer) 0)));
  ...
  while (MR_TRUE)
  {
    ...
    if (succeeded)
      ...
      else
      {
        ...
        {
          STATE_VARIABLE_A_18_18 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
