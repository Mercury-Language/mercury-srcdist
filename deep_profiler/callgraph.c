...
{
  {
    ...
    callgraph__foldl__ho1_4_p_0(TopDownPDICliqueList_6, (MR_Word) ((MR_Integer) 0), BottomUpPDPtrCliqueList_4);
  }
}
  ...
  MR_Word * STATE_VARIABLE_A_12)
{
  while (MR_TRUE)
  {
    ...
    if ((STATE_VARIABLE_L_14_14 == (MR_Word) ((MR_Integer) 0)))
  ...
  MR_Word * STATE_VARIABLE_A_15)
{
  while (MR_TRUE)
  {
    ...
    ;
    if (succeeded)
      if ((STATE_VARIABLE_Xs_0_12 == (MR_Word) ((MR_Integer) 0)))
      {
