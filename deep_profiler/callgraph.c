...
MR_decl_label2(callgraph__accumulate_pdptr_lists_3_0, 2,4)
...
MR_BEGIN_MODULE(callgraph_module2)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__callgraph__accumulate_pdptr_lists_3_0);
	MR_init_label2(callgraph__accumulate_pdptr_lists_3_0,2,4)
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'accumulate_pdptr_lists'/3 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
...
MR_def_label(callgraph__accumulate_pdptr_lists_3_0,2)
	...
	MR_np_call_localret_ent(list__map_3_0,
		callgraph__accumulate_pdptr_lists_3_0_i4);
MR_def_label(callgraph__accumulate_pdptr_lists_3_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
