...
{
  {
    ...
    MR_Word callgraph__Var_14 = (MR_Word) callgraph__CliqueNum_5;
    MR_ArrayPtr callgraph__conv0_STATE_VARIABLE_CliqueIndex_11;

    mercury__array__set_4_p_0((MR_Word) &profile__profile__type_ctor_info_clique_ptr_0, callgraph__PDI_8, ((MR_Box) (callgraph__Var_14)), (MR_ArrayPtr) callgraph__STATE_VARIABLE_CliqueIndex_0_10, &callgraph__conv0_STATE_VARIABLE_CliqueIndex_11);
...
{
  {
    MR_Word callgraph__Var_10;
    MR_ArrayPtr callgraph__conv1_STATE_VARIABLE_CliqueIndex_9;

    {
      callgraph__Var_10 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), callgraph__Var_10, 0) = ((MR_Box) (&callgraph_scalar_common_5[1]));
      MR_hl_field(MR_mktag(0), callgraph__Var_10, 1) = ((MR_Box) (callgraph__index_clique_4_p_0_1));
      MR_hl_field(MR_mktag(0), callgraph__Var_10, 2) = ((MR_Box) (MR_Word) ((MR_Integer) 1));
      MR_hl_field(MR_mktag(0), callgraph__Var_10, 3) = ((MR_Box) (callgraph__CliqueNum_5));
    }
    array_util__array_list_foldl_4_p_0((MR_Word) &profile__profile__type_ctor_info_proc_dynamic_ptr_0, (MR_Word) &profile__profile__type_ctor_info_clique_ptr_0, callgraph__Var_10, callgraph__CliqueMembers_6, (MR_ArrayPtr) callgraph__STATE_VARIABLE_CliqueIndex_0_8, &callgraph__conv1_STATE_VARIABLE_CliqueIndex_9);
  ...
  MR_Word * callgraph__STATE_VARIABLE_Graph_15)
{
  if (((MR_tag((MR_Word) callgraph__CallSiteSlot_8)) == (MR_mktag((MR_Integer) 1))))
  {
    ...
    MR_Word callgraph__Var_16;
    MR_Word callgraph__Var_11 = ((MR_Word) (MR_hl_field(MR_mktag(1), callgraph__CallSiteSlot_8, (MR_Integer) 0)));
    ...
    {
      callgraph__Var_16 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 5 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), callgraph__Var_16, 0) = ((MR_Box) (&callgraph_scalar_common_4[2]));
      MR_hl_field(MR_mktag(0), callgraph__Var_16, 1) = ((MR_Box) (callgraph__add_call_site_arcs_5_p_0_1));
      MR_hl_field(MR_mktag(0), callgraph__Var_16, 2) = ((MR_Box) (MR_Word) ((MR_Integer) 2));
      MR_hl_field(MR_mktag(0), callgraph__Var_16, 3) = ((MR_Box) (callgraph__InitDeep_6));
      MR_hl_field(MR_mktag(0), callgraph__Var_16, 4) = ((MR_Box) (callgraph__FromPDI_7));
    }
    mercury__list__foldl_4_p_0(callgraph__TypeCtorInfo_19_19, (MR_Word) &cliques__cliques__type_ctor_info_graph_0, callgraph__Var_16, callgraph__CSDPtrs_13, ((MR_Box) (callgraph__STATE_VARIABLE_Graph_0_14)), &callgraph__conv1_STATE_VARIABLE_Graph_15);
...
{
  {
    ...
    if (callgraph__succeeded)
    {
      ...
      MR_ArrayPtr callgraph__Var_18 = ((MR_ArrayPtr) (MR_hl_field(MR_mktag(0), callgraph__InitDeep_6, (MR_Integer) 2)));
      MR_Word callgraph__Var_22 = ((MR_Word) (MR_hl_field(MR_mktag(0), callgraph__InitDeep_6, (MR_Integer) 0)));
      MR_Word callgraph__Var_23 = ((MR_Word) (MR_hl_field(MR_mktag(0), callgraph__InitDeep_6, (MR_Integer) 1)));
      MR_ArrayPtr callgraph__Var_24 = ((MR_ArrayPtr) (MR_hl_field(MR_mktag(0), callgraph__InitDeep_6, (MR_Integer) 3)));
      MR_ArrayPtr callgraph__Var_25 = ((MR_ArrayPtr) (MR_hl_field(MR_mktag(0), callgraph__InitDeep_6, (MR_Integer) 4)));
      MR_ArrayPtr callgraph__Var_26 = ((MR_ArrayPtr) (MR_hl_field(MR_mktag(0), callgraph__InitDeep_6, (MR_Integer) 5)));
      MR_Box callgraph__conv0_CSD_11;
      MR_Word callgraph__Var_27;
      MR_Word callgraph__Var_28;

      mercury__array__lookup_3_p_0((MR_Word) &profile__profile__type_ctor_info_call_site_dynamic_0, (MR_ArrayPtr) callgraph__Var_18, callgraph__CSDI_10, &callgraph__conv0_CSD_11);
      callgraph__CSD_11 = ((MR_Word) callgraph__conv0_CSD_11);
      callgraph__Var_27 = ((MR_Word) (MR_hl_field(MR_mktag(0), callgraph__CSD_11, (MR_Integer) 0)));
      callgraph__ToPDPtr_12 = ((MR_Word) (MR_hl_field(MR_mktag(0), callgraph__CSD_11, (MR_Integer) 1)));
      callgraph__Var_28 = ((MR_Word) (MR_hl_field(MR_mktag(0), callgraph__CSD_11, (MR_Integer) 2)));
...
{
  {
    ...
    MR_Word callgraph__Var_14;
    MR_Word callgraph__Var_16 = ((MR_Word) (MR_hl_field(MR_mktag(0), callgraph__PD_8, (MR_Integer) 0)));
    MR_Word callgraph__Var_17 = ((MR_Word) (MR_hl_field(MR_mktag(0), callgraph__PD_8, (MR_Integer) 2)));
    ...
    {
      callgraph__Var_14 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 5 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), callgraph__Var_14, 0) = ((MR_Box) (&callgraph_scalar_common_4[1]));
      MR_hl_field(MR_mktag(0), callgraph__Var_14, 1) = ((MR_Box) (callgraph__add_pd_arcs_5_p_0_1));
      MR_hl_field(MR_mktag(0), callgraph__Var_14, 2) = ((MR_Box) (MR_Word) ((MR_Integer) 2));
      MR_hl_field(MR_mktag(0), callgraph__Var_14, 3) = ((MR_Box) (callgraph__InitDeep_6));
      MR_hl_field(MR_mktag(0), callgraph__Var_14, 4) = ((MR_Box) (callgraph__PDI_7));
    }
    mercury__list__foldl_4_p_0(callgraph__TypeCtorInfo_18_18, (MR_Word) &cliques__cliques__type_ctor_info_graph_0, callgraph__Var_14, callgraph__CallSiteRefList_11, ((MR_Box) (callgraph__STATE_VARIABLE_Graph_0_12)), &callgraph__conv1_STATE_VARIABLE_Graph_13);
...
{
  {
    ...
    *callgraph__Cliques_7 = (MR_ArrayPtr) callgraph__conv0_Cliques_7;
    ...
    array_util__array_foldl_from_1_4_p_1(callgraph__TypeInfo_13_13, (MR_Word) &callgraph_scalar_common_1[1], (MR_Word) &callgraph_scalar_common_3[1], (MR_ArrayPtr) *callgraph__Cliques_7, ((MR_Box) (callgraph__CliqueIndex0_9)), &callgraph__conv3_CliqueIndex_8);
...
{
  {
    ...
    MR_Word callgraph__Var_17;
    MR_ArrayPtr callgraph__Var_18;
    MR_Word callgraph__Var_19;
    MR_Word callgraph__Var_20;
    MR_ArrayPtr callgraph__Var_21;
    MR_ArrayPtr callgraph__Var_22;
    MR_ArrayPtr callgraph__Var_23;
    MR_Box callgraph__conv1_Graph_5;

    cliques__init_1_p_0(&callgraph__Graph0_16);
    {
      callgraph__Var_17 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), callgraph__Var_17, 0) = ((MR_Box) (&callgraph_scalar_common_4[0]));
      MR_hl_field(MR_mktag(0), callgraph__Var_17, 1) = ((MR_Box) (callgraph__find_cliques_2_p_0_1));
      MR_hl_field(MR_mktag(0), callgraph__Var_17, 2) = ((MR_Box) (MR_Word) ((MR_Integer) 1));
      MR_hl_field(MR_mktag(0), callgraph__Var_17, 3) = ((MR_Box) (callgraph__InitDeep_3));
    }
    callgraph__Var_19 = ((MR_Word) (MR_hl_field(MR_mktag(0), callgraph__InitDeep_3, (MR_Integer) 0)));
    callgraph__Var_20 = ((MR_Word) (MR_hl_field(MR_mktag(0), callgraph__InitDeep_3, (MR_Integer) 1)));
    callgraph__Var_21 = ((MR_ArrayPtr) (MR_hl_field(MR_mktag(0), callgraph__InitDeep_3, (MR_Integer) 2)));
    callgraph__Var_18 = ((MR_ArrayPtr) (MR_hl_field(MR_mktag(0), callgraph__InitDeep_3, (MR_Integer) 3)));
    callgraph__Var_22 = ((MR_ArrayPtr) (MR_hl_field(MR_mktag(0), callgraph__InitDeep_3, (MR_Integer) 4)));
    callgraph__Var_23 = ((MR_ArrayPtr) (MR_hl_field(MR_mktag(0), callgraph__InitDeep_3, (MR_Integer) 5)));
    array_util__array_foldl_from_1_4_p_1((MR_Word) &profile__profile__type_ctor_info_proc_dynamic_0, (MR_Word) &cliques__cliques__type_ctor_info_graph_0, callgraph__Var_17, (MR_ArrayPtr) callgraph__Var_18, ((MR_Box) (callgraph__Graph0_16)), &callgraph__conv1_Graph_5);
  ...
  while (MR_TRUE)
  {
    /* tailcall optimized into a loop */
    {
      ...
      else
      {
        ...
        {
          MR_Word callgraph__next_value_of_STATE_VARIABLE_L_0_10 = callgraph__STATE_VARIABLE_L_14_14;
          MR_Word callgraph__next_value_of_STATE_VARIABLE_A_0_11 = callgraph__STATE_VARIABLE_A_15_15;

          callgraph__STATE_VARIABLE_L_0_10 = callgraph__next_value_of_STATE_VARIABLE_L_0_10;
          callgraph__STATE_VARIABLE_A_0_11 = callgraph__next_value_of_STATE_VARIABLE_A_0_11;
        }
        continue;
      }
    }
    ...
    /* tailcall optimized into a loop */
    {
      ...
      if (callgraph__succeeded)
        ...
        else
        {
          ...
          mercury__list__map_3_p_0(callgraph__TypeCtorInfo_7_33, (MR_Word) &profile__profile__type_ctor_info_proc_dynamic_ptr_0, (MR_Word) &callgraph_scalar_common_3[0], callgraph__PDIList_31, &callgraph__PDPtrList_28);
          {
          ...
          callgraph__Var_19 = (callgraph__Depth_7 - (MR_Integer) 1);
          /* direct tailcall eliminated */
          {
            MR_Integer callgraph__next_value_of_Depth_7 = callgraph__Var_19;
            MR_Word callgraph__next_value_of_STATE_VARIABLE_Xs_0_12 = callgraph__STATE_VARIABLE_Xs_17_17;
            MR_Word callgraph__next_value_of_STATE_VARIABLE_A_0_14 = callgraph__STATE_VARIABLE_A_18_18;

            callgraph__Depth_7 = callgraph__next_value_of_Depth_7;
            callgraph__STATE_VARIABLE_Xs_0_12 = callgraph__next_value_of_STATE_VARIABLE_Xs_0_12;
            callgraph__STATE_VARIABLE_A_0_14 = callgraph__next_value_of_STATE_VARIABLE_A_0_14;
          }
          continue;
        }
      else
