...
#line 66 "html_format.c"

#endif
#line 69 "html_format.c"
...
MR_def_static(fn__html_format__init_format_info_2_0)
	...
	MR_tfield(0, MR_tempr1, 0) = MR_tfield(0, MR_r2, 2);
	...
	MR_tfield(0, MR_tempr1, 4) = MR_tfield(0, MR_r1, 3);
	MR_r1 = MR_tempr1;
	MR_proceed();
	}
#ifdef MR_maybe_local_thread_engine_base
...
MR_def_static(fn__html_format__link_to_html_2_0)
	...
	MR_tfield(0, MR_tempr2, 1) = MR_tfield(0, MR_r1, 4);
...
MR_def_label(fn__html_format__table_data_to_html_2_0,12)
	...
	MR_tfield(0, MR_r2, 1) = MR_tfield(0, MR_r1, 4);
...
MR_def_static(html_format__table_data_to_th_html_6_0)
	...
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tempr1 = (MR_Word) &MR_tfield(0, (MR_Word *) &mercury_vector_common_9_1, (MR_Integer) MR_r2);
	MR_tempr2 = MR_r2;
	MR_r2 = MR_r4;
