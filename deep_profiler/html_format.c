...
{
  {
...

    {
      ...
      (env_ptr)->html_format__item_to_html_7_p_0_env_0__succeeded = ((((MR_tag((MR_Word) (env_ptr)->html_format__item_to_html_7_p_0_env_0__ListItem_45)) == (MR_Integer) 3)) && ((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), (env_ptr)->html_format__item_to_html_7_p_0_env_0__ListItem_45, (MR_Integer) 0))) == (MR_Integer) 5)));
