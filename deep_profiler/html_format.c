...
MR_def_static(fn__html_format__default_style_control_map_0_0)
	...
	MR_sv(6) = (MR_Word) MR_TAG_COMMON(1,1,10);
	MR_sv(17) = (MR_Word) MR_string_const("table.plain", 11);
	MR_sv(18) = (MR_Word) MR_TAG_COMMON(1,1,8);
	MR_sv(19) = (MR_Word) MR_string_const("table.boxed", 11);
	MR_sv(20) = (MR_Word) MR_TAG_COMMON(1,1,7);
...
MR_def_label(html_format__update_style_control_map_7_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(6) = (MR_Word) MR_string_const("background", 10);
	...
	MR_r2 = MR_sv(3);
	MR_sv(1) = MR_r1;
	MR_sv(7) = (MR_Word) MR_string_const("LightGrey", 9);
	MR_r3 = MR_sv(5);
...
MR_def_label(html_format__update_style_control_map_7_0,3)
	...
	MR_r2 = MR_sv(3);
	MR_sv(1) = MR_r1;
	MR_sv(7) = (MR_Word) MR_string_const("White", 5);
	MR_r3 = MR_sv(5);
