...
{
  {
    ...
    if (((MR_tag((MR_Word) ColumnTitles_23)) == (MR_mktag((MR_Integer) 1))))
    {
      ...
      *STATE_VARIABLE_NumRows_33 = (MR_Integer) 1;
      ...
      Var_46 = (MR_Integer) ((MR_Unsigned) Var_48 - (MR_Unsigned) (MR_Integer) 1);
...
{
  {
    ...
    *STATE_VARIABLE_HeaderGroupNumber_18 = (MR_Integer) ((MR_Unsigned) STATE_VARIABLE_HeaderGroupNumber_0_17 + (MR_Unsigned) (MR_Integer) 1);
  }
}
...
{
  {
    ...
    switch (MR_tag((MR_Word) Cell_13)) {
      ...
      case (MR_Integer) 0:
        {
          *STATE_VARIABLE_ColumnNum_30 = (MR_Integer) ((MR_Unsigned) STATE_VARIABLE_ColumnNum_0_29 + (MR_Unsigned) (MR_Integer) 1);
      ...
      case (MR_Integer) 2:
        {
          ...
          *STATE_VARIABLE_ColumnNum_30 = (MR_Integer) ((MR_Unsigned) STATE_VARIABLE_ColumnNum_0_29 + (MR_Unsigned) Span_108);
