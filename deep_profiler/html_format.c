...
{
  {
    ...
    Var_94 = mercury__string__f_43_43_2_f_0((MR_String) "<!DOCTYPE HTML PUBLIC \"-//W3C//DTD HTML 4.01//EN\"\n", (MR_String) "\"http://www.w3.org/TR/html4/strict.dtd\">\n");
    Var_37 = mercury__cord__singleton_1_f_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), ((MR_Box) (Var_94)));
