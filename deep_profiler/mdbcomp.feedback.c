...
MR_decl_label8(mdbcomp__feedback__get_feedback_data_2_0, 3,2,4,9,7,12,13,14)
MR_decl_label7(mdbcomp__feedback__get_feedback_data_2_0, 15,16,17,18,19,6,1)
MR_decl_label1(mdbcomp__feedback__put_feedback_data_3_0, 3)
MR_decl_label8(mdbcomp__feedback__read_error_message_string_3_0, 15,6,12,8,9,10,11,3)
MR_decl_label4(mdbcomp__feedback__read_error_message_string_3_0, 5,14,19,20)
...
MR_decl_label8(mdbcomp__feedback__write_feedback_file_2_6_0, 2,3,4,5,6,7,8,10)
MR_decl_label1(mdbcomp__feedback__write_feedback_file_2_6_0, 11)
...
MR_decl_label8(__Compare___mdbcomp__feedback__feedback_data_0_0, 3,2,9,13,7,5,20,22)
MR_decl_label3(__Compare___mdbcomp__feedback__feedback_data_0_0, 26,30,82)
...
MR_BEGIN_MODULE(mdbcomp__feedback_module1)
	...
	MR_init_label8(mdbcomp__feedback__get_feedback_data_2_0,3,2,4,9,7,12,13,14)
	MR_init_label7(mdbcomp__feedback__get_feedback_data_2_0,15,16,17,18,19,6,1)
MR_BEGIN_CODE
...
MR_def_label(mdbcomp__feedback__get_feedback_data_2_0,9)
	...
	MR_tempr3 = MR_ctfield(1, MR_tempr4, 3);
...
MR_BEGIN_MODULE(mdbcomp__feedback_module3)
	...
	MR_init_label8(mdbcomp__feedback__read_error_message_string_3_0,15,6,12,8,9,10,11,3)
	MR_init_label4(mdbcomp__feedback__read_error_message_string_3_0,5,14,19,20)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(mdbcomp__feedback_module8)
	...
	MR_init_label8(mdbcomp__feedback__write_feedback_file_2_6_0,2,3,4,5,6,7,8,10)
	MR_init_label1(mdbcomp__feedback__write_feedback_file_2_6_0,11)
MR_BEGIN_CODE
...
MR_def_label(__Unify___mdbcomp__feedback__feedback_data_0_0,5)
	...
	MR_r2 = MR_ctfield(1, MR_tempr3, 3);
...
MR_BEGIN_MODULE(mdbcomp__feedback_module16)
	...
	MR_init_label8(__Compare___mdbcomp__feedback__feedback_data_0_0,3,2,9,13,7,5,20,22)
	MR_init_label3(__Compare___mdbcomp__feedback__feedback_data_0_0,26,30,82)
MR_BEGIN_CODE
