...
extern const MR_TypeCtorInfo_Struct
	mercury_data_mdbcomp__feedback__type_ctor_info_candidate_par_conjunct_0,
...
MR_decl_label4(__Unify___mdbcomp__feedback__candidate_par_conjunct_0_0, 5,8,10,1)
MR_decl_label5(__Unify___mdbcomp__feedback__candidate_par_conjunction_0_0, 4,6,8,10,1)
MR_decl_label3(__Unify___mdbcomp__feedback__conjuncts_are_dependant_0_0, 12,5,1)
...
MR_decl_label5(__Compare___mdbcomp__feedback__candidate_par_conjunct_0_0, 3,2,6,11,31)
MR_decl_label7(__Compare___mdbcomp__feedback__candidate_par_conjunction_0_0, 3,2,5,9,13,17,45)
MR_decl_label4(__Compare___mdbcomp__feedback__conjuncts_are_dependant_0_0, 18,7,5,9)
...
MR_def_extern_entry(__Unify___mdbcomp__feedback__candidate_par_conjunct_0_0)
MR_def_extern_entry(__Compare___mdbcomp__feedback__candidate_par_conjunct_0_0)
...
const MR_PseudoTypeInfo mercury_data_mdbcomp__feedback__field_types_candidate_par_conjunct_0_0[] = {
...
const MR_ConstString mercury_data_mdbcomp__feedback__field_names_candidate_par_conjunct_0_0[] = {
	"callee",
	"vars",
	"cost_percall"
};

static const MR_DuFunctorDesc mercury_data_mdbcomp__feedback__du_functor_desc_candidate_par_conjunct_0_0 = {
	...
	-1,
	0,
	(MR_PseudoTypeInfo *) mercury_data_mdbcomp__feedback__field_types_candidate_par_conjunct_0_0,
	mercury_data_mdbcomp__feedback__field_names_candidate_par_conjunct_0_0,
	NULL
};

const MR_DuFunctorDescPtr mercury_data_mdbcomp__feedback__du_stag_ordered_candidate_par_conjunct_0_0[] = {
	&mercury_data_mdbcomp__feedback__du_functor_desc_candidate_par_conjunct_0_0

};

const MR_DuPtagLayout mercury_data_mdbcomp__feedback__du_ptag_ordered_candidate_par_conjunct_0[] = {
	{ 1, MR_SECTAG_NONE,
	mercury_data_mdbcomp__feedback__du_stag_ordered_candidate_par_conjunct_0_0 }

};

const MR_DuFunctorDescPtr mercury_data_mdbcomp__feedback__du_name_ordered_candidate_par_conjunct_0[] = {
	&mercury_data_mdbcomp__feedback__du_functor_desc_candidate_par_conjunct_0_0
};

const MR_Integer mercury_data_mdbcomp__feedback__functor_number_map_candidate_par_conjunct_0[] = {
	0 };
	
const MR_TypeCtorInfo_Struct mercury_data_mdbcomp__feedback__type_ctor_info_candidate_par_conjunct_0 = {
	0,
	13,
	1,
	MR_TYPECTOR_REP_DU,
	MR_MAYBE_STATIC_CODE(MR_ENTRY_AP(__Unify___mdbcomp__feedback__candidate_par_conjunct_0_0)),
	MR_MAYBE_STATIC_CODE(MR_ENTRY_AP(__Compare___mdbcomp__feedback__candidate_par_conjunct_0_0)),
	"mdbcomp.feedback",
	"candidate_par_conjunct",
	{ (void *)mercury_data_mdbcomp__feedback__du_name_ordered_candidate_par_conjunct_0 },
	{ (void *)mercury_data_mdbcomp__feedback__du_ptag_ordered_candidate_par_conjunct_0 },
	1,
	4,
	mercury_data_mdbcomp__feedback__functor_number_map_candidate_par_conjunct_0
};
extern const MR_TypeCtorInfo_Struct mercury_data_mdbcomp__feedback__type_ctor_info_candidate_par_conjunct_0;
...
const MR_PseudoTypeInfo mercury_data_mdbcomp__feedback__field_types_candidate_par_conjunction_0_0[] = {
	...
	(MR_PseudoTypeInfo) &mercury_data_mdbcomp__feedback__type_ctor_info_candidate_par_conjunct_0,
	(MR_PseudoTypeInfo) &mercury_data_mdbcomp__feedback__type_ctor_info_candidate_par_conjunct_0,
...
const MR_PseudoTypeInfo mercury_data_mdbcomp__feedback__field_types_conjuncts_are_dependant_0_0[] = {
	(MR_PseudoTypeInfo) &mercury_data_set_ordlist__ti_set_ordlist_1builtin__type_ctor_info_int_0
};

const MR_ConstString mercury_data_mdbcomp__feedback__field_names_conjuncts_are_dependant_0_0[] = {
	"dependant_vars"
};

static const MR_DuFunctorDesc mercury_data_mdbcomp__feedback__du_functor_desc_conjuncts_are_dependant_0_0 = {
	...
	-1,
	0,
	(MR_PseudoTypeInfo *) mercury_data_mdbcomp__feedback__field_types_conjuncts_are_dependant_0_0,
	mercury_data_mdbcomp__feedback__field_names_conjuncts_are_dependant_0_0,
	NULL
};

static const MR_DuFunctorDesc mercury_data_mdbcomp__feedback__du_functor_desc_conjuncts_are_dependant_0_1 = {
...
const MR_DuFunctorDescPtr mercury_data_mdbcomp__feedback__du_stag_ordered_conjuncts_are_dependant_0_0[] = {
	&mercury_data_mdbcomp__feedback__du_functor_desc_conjuncts_are_dependant_0_1

};

const MR_DuFunctorDescPtr mercury_data_mdbcomp__feedback__du_stag_ordered_conjuncts_are_dependant_0_1[] = {
	&mercury_data_mdbcomp__feedback__du_functor_desc_conjuncts_are_dependant_0_0

};

const MR_DuPtagLayout mercury_data_mdbcomp__feedback__du_ptag_ordered_conjuncts_are_dependant_0[] = {
	{ 1, MR_SECTAG_LOCAL,
	mercury_data_mdbcomp__feedback__du_stag_ordered_conjuncts_are_dependant_0_0 },
	{ 1, MR_SECTAG_NONE,
	mercury_data_mdbcomp__feedback__du_stag_ordered_conjuncts_are_dependant_0_1 }

};

const MR_DuFunctorDescPtr mercury_data_mdbcomp__feedback__du_name_ordered_conjuncts_are_dependant_0[] = {
	&mercury_data_mdbcomp__feedback__du_functor_desc_conjuncts_are_dependant_0_0,
	&mercury_data_mdbcomp__feedback__du_functor_desc_conjuncts_are_dependant_0_1
};
...
const MR_TypeCtorInfo_Struct mercury_data_mdbcomp__feedback__type_ctor_info_conjuncts_are_dependant_0 = {
	...
	"mdbcomp.feedback",
	"conjuncts_are_dependant",
	{ (void *)mercury_data_mdbcomp__feedback__du_name_ordered_conjuncts_are_dependant_0 },
	{ (void *)mercury_data_mdbcomp__feedback__du_ptag_ordered_conjuncts_are_dependant_0 },
	2,
	4,
...
MR_def_label(mdbcomp__feedback__get_feedback_data_2_0,9)
	...
	MR_tempr3 = MR_tfield(1, MR_tempr4, 3);
	MR_tfield(1, MR_tempr5, 3) = MR_tempr3;
	MR_sv(1) = MR_tempr4;
	MR_succip_word = MR_sv(3);
	MR_decr_sp(3);
	MR_r1 = MR_TRUE;
...
MR_def_label(mdbcomp__feedback__read_feedback_file_4_0,9)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_string_const("4", 1);
...
MR_def_label(mdbcomp__feedback__write_feedback_file_2_6_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(1);
	MR_r2 = (MR_Word) MR_string_const("4", 1);
	MR_np_call_localret_ent(io__write_string_4_0,
...
MR_BEGIN_MODULE(mdbcomp__feedback_module9)
	MR_init_entry1(__Unify___mdbcomp__feedback__candidate_par_conjunct_0_0);
	MR_INIT_PROC_LAYOUT_ADDR(mercury____Unify___mdbcomp__feedback__candidate_par_conjunct_0_0);
	MR_init_label4(__Unify___mdbcomp__feedback__candidate_par_conjunct_0_0,5,8,10,1)
MR_BEGIN_CODE
...
/* code for '__Unify__'/2 mode 0 */
	...
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_define_entry(mercury____Unify___mdbcomp__feedback__candidate_par_conjunct_0_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if ((MR_r1 == MR_r2)) {
		MR_GOTO_LAB(__Unify___mdbcomp__feedback__candidate_par_conjunct_0_0_i10);
	}
	MR_incr_sp(5);
	...
	MR_np_call_localret_ent(__Unify___maybe__maybe_1_0,
		__Unify___mdbcomp__feedback__candidate_par_conjunct_0_0_i5);
MR_def_label(__Unify___mdbcomp__feedback__candidate_par_conjunct_0_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(__Unify___mdbcomp__feedback__candidate_par_conjunct_0_0_i1);
	}
	MR_r1 = (MR_Word) MR_TAG_COMMON(0,1,1);
	MR_r2 = MR_sv(1);
	MR_r3 = MR_sv(3);
	MR_np_call_localret_ent(__Unify___list__list_1_0,
		__Unify___mdbcomp__feedback__candidate_par_conjunct_0_0_i8);
MR_def_label(__Unify___mdbcomp__feedback__candidate_par_conjunct_0_0,8)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(__Unify___mdbcomp__feedback__candidate_par_conjunct_0_0_i1);
	}
...
MR_def_label(__Unify___mdbcomp__feedback__candidate_par_conjunct_0_0,10)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_TRUE;
	MR_proceed();
MR_def_label(__Unify___mdbcomp__feedback__candidate_par_conjunct_0_0,1)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_FALSE;
	MR_decr_sp_and_return(5);
#ifdef MR_maybe_local_thread_engine_base
...
MR_BEGIN_MODULE(mdbcomp__feedback_module10)
	MR_init_entry1(__Compare___mdbcomp__feedback__candidate_par_conjunct_0_0);
	MR_INIT_PROC_LAYOUT_ADDR(mercury____Compare___mdbcomp__feedback__candidate_par_conjunct_0_0);
	MR_init_label5(__Compare___mdbcomp__feedback__candidate_par_conjunct_0_0,3,2,6,11,31)
MR_BEGIN_CODE
...
/* code for '__Compare__'/3 mode 0 */
	...
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_define_entry(mercury____Compare___mdbcomp__feedback__candidate_par_conjunct_0_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if ((MR_r1 == MR_r2)) {
		MR_GOTO_LAB(__Compare___mdbcomp__feedback__candidate_par_conjunct_0_0_i3);
	}
	MR_incr_sp(5);
	MR_sv(5) = (MR_Word) MR_succip;
	MR_sv(1) = MR_r1;
	MR_sv(2) = MR_r2;
	MR_GOTO_LAB(__Compare___mdbcomp__feedback__candidate_par_conjunct_0_0_i2);
MR_def_label(__Compare___mdbcomp__feedback__candidate_par_conjunct_0_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Integer) 0;
	MR_proceed();
MR_def_label(__Compare___mdbcomp__feedback__candidate_par_conjunct_0_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	...
	MR_np_call_localret_ent(__Compare___maybe__maybe_1_0,
		__Compare___mdbcomp__feedback__candidate_par_conjunct_0_0_i6);
MR_def_label(__Compare___mdbcomp__feedback__candidate_par_conjunct_0_0,6)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___mdbcomp__feedback__candidate_par_conjunct_0_0_i31);
	}
	MR_r1 = (MR_Word) MR_TAG_COMMON(0,1,1);
	MR_r2 = MR_sv(1);
	MR_r3 = MR_sv(3);
	MR_np_call_localret_ent(__Compare___list__list_1_0,
		__Compare___mdbcomp__feedback__candidate_par_conjunct_0_0_i11);
MR_def_label(__Compare___mdbcomp__feedback__candidate_par_conjunct_0_0,11)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___mdbcomp__feedback__candidate_par_conjunct_0_0_i31);
	}
...
MR_def_label(__Compare___mdbcomp__feedback__candidate_par_conjunct_0_0,31)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(5);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
...
MR_BEGIN_MODULE(mdbcomp__feedback_module11)
	...
	MR_init_label5(__Unify___mdbcomp__feedback__candidate_par_conjunction_0_0,4,6,8,10,1)
MR_BEGIN_CODE
...
MR_define_entry(mercury____Unify___mdbcomp__feedback__candidate_par_conjunction_0_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if ((MR_r1 == MR_r2)) {
		MR_GOTO_LAB(__Unify___mdbcomp__feedback__candidate_par_conjunction_0_0_i10);
	}
	MR_incr_sp(7);
	...
	MR_np_call_localret_ent(__Unify___mdbcomp__feedback__candidate_par_conjunct_0_0,
...
MR_def_label(__Unify___mdbcomp__feedback__candidate_par_conjunction_0_0,4)
	...
	MR_r2 = MR_sv(4);
	MR_np_call_localret_ent(__Unify___mdbcomp__feedback__candidate_par_conjunct_0_0,
		__Unify___mdbcomp__feedback__candidate_par_conjunction_0_0_i6);
MR_def_label(__Unify___mdbcomp__feedback__candidate_par_conjunction_0_0,6)
	...
	MR_r1 = MR_sv(2);
	MR_r2 = MR_sv(5);
	MR_np_call_localret_ent(__Unify___mdbcomp__feedback__conjuncts_are_dependant_0_0,
		__Unify___mdbcomp__feedback__candidate_par_conjunction_0_0_i8);
MR_def_label(__Unify___mdbcomp__feedback__candidate_par_conjunction_0_0,8)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(__Unify___mdbcomp__feedback__candidate_par_conjunction_0_0_i1);
	}
...
MR_def_label(__Unify___mdbcomp__feedback__candidate_par_conjunction_0_0,10)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_TRUE;
	MR_proceed();
...
MR_def_label(__Compare___mdbcomp__feedback__candidate_par_conjunction_0_0,5)
	...
	MR_r1 = MR_sv(1);
	MR_r2 = MR_sv(5);
	MR_np_call_localret_ent(__Compare___mdbcomp__feedback__candidate_par_conjunct_0_0,
...
MR_def_label(__Compare___mdbcomp__feedback__candidate_par_conjunction_0_0,13)
	...
	MR_r1 = MR_sv(3);
	MR_r2 = MR_sv(7);
	MR_np_call_localret_ent(__Compare___mdbcomp__feedback__conjuncts_are_dependant_0_0,
...
MR_BEGIN_MODULE(mdbcomp__feedback_module13)
	...
	MR_init_label3(__Unify___mdbcomp__feedback__conjuncts_are_dependant_0_0,12,5,1)
MR_BEGIN_CODE
...
MR_define_entry(mercury____Unify___mdbcomp__feedback__conjuncts_are_dependant_0_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if ((MR_r1 == MR_r2)) {
		MR_GOTO_LAB(__Unify___mdbcomp__feedback__conjuncts_are_dependant_0_0_i12);
	}
	MR_incr_sp(3);
	MR_sv(3) = (MR_Word) MR_succip;
	{
	...
	if (MR_LTAGS_TESTR(MR_tempr1,0,0)) {
		MR_GOTO_LAB(__Unify___mdbcomp__feedback__conjuncts_are_dependant_0_0_i5);
	}
	MR_r1 = (MR_sv(2) == MR_tempr1);
	MR_decr_sp(3);
	MR_proceed();
	}
MR_def_label(__Unify___mdbcomp__feedback__conjuncts_are_dependant_0_0,12)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_TRUE;
	MR_proceed();
MR_def_label(__Unify___mdbcomp__feedback__conjuncts_are_dependant_0_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TEST(MR_sv(2),0,0)) {
		MR_GOTO_LAB(__Unify___mdbcomp__feedback__conjuncts_are_dependant_0_0_i1);
	}
	MR_r1 = (MR_Word) MR_INT_CTOR_ADDR;
...
MR_def_label(__Unify___mdbcomp__feedback__conjuncts_are_dependant_0_0,1)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_FALSE;
	MR_decr_sp_and_return(3);
#ifdef MR_maybe_local_thread_engine_base
...
MR_BEGIN_MODULE(mdbcomp__feedback_module14)
	...
	MR_init_label4(__Compare___mdbcomp__feedback__conjuncts_are_dependant_0_0,18,7,5,9)
MR_BEGIN_CODE
...
MR_define_entry(mercury____Compare___mdbcomp__feedback__conjuncts_are_dependant_0_0);
	...
	MR_sv(3) = (MR_Word) MR_succip;
	if ((MR_r1 == MR_r2)) {
		MR_GOTO_LAB(__Compare___mdbcomp__feedback__conjuncts_are_dependant_0_0_i18);
	}
	MR_sv(1) = MR_r1;
	MR_sv(2) = MR_r2;
	if (MR_LTAGS_TESTR(MR_sv(1),0,0)) {
		MR_GOTO_LAB(__Compare___mdbcomp__feedback__conjuncts_are_dependant_0_0_i5);
	}
	if (MR_LTAGS_TESTR(MR_sv(2),0,0)) {
		MR_GOTO_LAB(__Compare___mdbcomp__feedback__conjuncts_are_dependant_0_0_i7);
	}
MR_def_label(__Compare___mdbcomp__feedback__conjuncts_are_dependant_0_0,18)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Integer) 0;
	MR_decr_sp_and_return(3);
MR_def_label(__Compare___mdbcomp__feedback__conjuncts_are_dependant_0_0,7)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Integer) 2;
	MR_decr_sp_and_return(3);
MR_def_label(__Compare___mdbcomp__feedback__conjuncts_are_dependant_0_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_sv(2),0,0)) {
		MR_GOTO_LAB(__Compare___mdbcomp__feedback__conjuncts_are_dependant_0_0_i9);
	}
	MR_r1 = (MR_Integer) 1;
	MR_decr_sp_and_return(3);
MR_def_label(__Compare___mdbcomp__feedback__conjuncts_are_dependant_0_0,9)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_INT_CTOR_ADDR;
	MR_r2 = MR_tfield(1, MR_sv(1), 0);
	MR_r3 = MR_tfield(1, MR_sv(2), 0);
...
MR_def_label(f_109_100_98_99_111_109_112_95_95_102_101_101_100_98_97_99_107_95_95_85_110_117_115_101_100_65_114_103_115_95_95_112_114_101_100_95_95_114_101_97_100_95_100_97_116_97_95_95_91_50_93_95_48_5_0,7)
	...
	MR_tempr2 = MR_r1;
	MR_tfield(3, MR_tempr1, 0) = MR_tfield(2, MR_tempr2, 0);
	MR_tfield(3, MR_tempr1, 1) = MR_tfield(2, MR_tempr2, 1);
	MR_tag_alloc_heap(MR_r1, 1, (MR_Integer) 1);
	MR_tfield(1, MR_r1, 0) = MR_tempr1;
	MR_decr_sp_and_return(4);
	}
...
void mercury__mdbcomp__feedback__init(void)
{
	...
	MR_INIT_TYPE_CTOR_INFO(
		mercury_data_mdbcomp__feedback__type_ctor_info_candidate_par_conjunct_0,
		mdbcomp__feedback__candidate_par_conjunct_0_0);
	MR_INIT_TYPE_CTOR_INFO(
		mercury_data_mdbcomp__feedback__type_ctor_info_candidate_par_conjunction_0,
