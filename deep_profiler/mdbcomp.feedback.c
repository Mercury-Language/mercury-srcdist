...
{
  MR_String ProfiledProgramName_8 = ((MR_String) ((MR_hl_field(0, FeedbackInfo_6, 0))));
  MR_Word MaybeCandidateParallelConjs_9 = ((MR_Word) ((MR_hl_field(0, FeedbackInfo_6, 1))));
  ...
  {
    MR_Word Candidates_11 = ((MR_Word) ((MR_hl_field(1, MaybeCandidateParallelConjs_9, 0))));
  ...
  MR_Word * Result_8)
{
  ...
  {
    MR_String ActualProfiledProgram_11 = ((MR_String) ((MR_hl_field(0, MaybeActualProfiledProgram_7, 0))));
    ...
    switch (MR_tag((MR_Word) ReadResult_12)) {
      ...
      case (MR_Integer) 1:
        {
          MR_Word Components_13 = ((MR_Word) ((MR_hl_field(1, ReadResult_12, 0))));
          MR_Word Info0_14;
      ...
      case (MR_Integer) 2:
        {
          MR_Integer Line_15 = ((MR_Integer) ((MR_hl_field(2, ReadResult_12, 1))));
          MR_Word Var_20;
          MR_String Error_21 = ((MR_String) ((MR_hl_field(2, ReadResult_12, 0))));
  ...
  MR_Word * MaybeActualProfiledProgram_10)
{
  ...
  if ((STATE_VARIABLE_MaybeError_0_17 == (MR_Word) ((MR_Unsigned) 0U)))
  {
    ...
    switch (MR_tag((MR_Word) LineResult_13)) {
      ...
      case (MR_Integer) 1:
        {
          MR_String String_14 = ((MR_String) ((MR_hl_field(1, LineResult_13, 0))));
          ...
          {
            MR_String ExpectedProfiledProgram_16 = ((MR_String) ((MR_hl_field(1, MaybeExpectedProfiledProgram_8, 0))));
      ...
      case (MR_Integer) 2:
        {
          MR_Word Var_23;
          MR_Word Error_24 = ((MR_Word) ((MR_hl_field(2, LineResult_13, 0))));
  ...
  {
    MR_Word Error_12 = ((MR_Word) ((MR_hl_field(1, STATE_VARIABLE_MaybeError_0_17, 0))));
  ...
  MR_Word * STATE_VARIABLE_MaybeError_18)
{
  ...
  if ((STATE_VARIABLE_MaybeError_0_17 == (MR_Word) ((MR_Unsigned) 0U)))
  {
    ...
    switch (MR_tag((MR_Word) LineResult_14)) {
      ...
      case (MR_Integer) 1:
        {
          MR_String Line_15 = ((MR_String) ((MR_hl_field(1, LineResult_14, 0))));
      ...
      case (MR_Integer) 2:
        {
          MR_Word Error_16 = ((MR_Word) ((MR_hl_field(2, LineResult_14, 0))));
          MR_Word Var_28;
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = mdbcomp__feedback__IntroducedFrom__pred__replace_feedback_candidate_parallel_conjunctions__296__1_2_p_0(((MR_String) ((MR_hl_field(0, closure, 3)))), ((MR_String) ((MR_hl_field(0, closure, 4)))));
  return succeeded;
}
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = mdbcomp__feedback__IntroducedFrom__pred__add_feedback_candidate_parallel_conjunctions__290__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) ((MR_hl_field(0, closure, 4)))));
  return succeeded;
}
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = mdbcomp__feedback__IntroducedFrom__pred__add_feedback_candidate_parallel_conjunctions__288__1_2_p_0(((MR_String) ((MR_hl_field(0, closure, 3)))), ((MR_String) ((MR_hl_field(0, closure, 4)))));
  return succeeded;
}
