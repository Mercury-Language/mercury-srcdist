  ...
  MR_Word FeedbackInfo_6)
{
  ...
  MR_Word STATE_VARIABLE_RevComponents_2_28;
  ...
  if ((MaybeCandidateParallelConjs_9 == (MR_Word) ((MR_Unsigned) 0U)))
    STATE_VARIABLE_RevComponents_2_28 = (MR_Word) ((MR_Unsigned) 0U);
  else
  {
    ...
    {
      STATE_VARIABLE_RevComponents_2_28 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(1, STATE_VARIABLE_RevComponents_2_28, 0) = ((MR_Box) (CandComponent_12));
      MR_hl_field(1, STATE_VARIABLE_RevComponents_2_28, 1) = ((MR_Box) ((MR_Unsigned) 0U));
    }
  }
  mercury__list__reverse_2_p_0((MR_Word) (&mdbcomp__feedback__mdbcomp__feedback__type_ctor_info_feedback_component_wrapper_0), STATE_VARIABLE_RevComponents_2_28, &Components_13);
  ...
  MR_Word * ResultFeedbackInfo_8)
{
  ...
  else
  {
    ...
    MR_Word STATE_VARIABLE_MaybeError_2_21;
    MR_Word STATE_VARIABLE_MaybeError_3_25;

    mdbcomp__feedback__read_check_line_7_p_0(PathStream_11, (MR_String) "Mercury Compiler Feedback", (MR_Word) ((MR_Unsigned) 4U), (MR_Word) ((MR_Unsigned) 0U), &STATE_VARIABLE_MaybeError_2_21);
    mdbcomp__feedback__read_check_line_7_p_0(PathStream_11, (MR_String) "19", (MR_Word) (MR_mkword(3, &mdbcomp__feedback_scalar_common_1[6])), STATE_VARIABLE_MaybeError_2_21, &STATE_VARIABLE_MaybeError_3_25);
    mdbcomp__feedback__read_profiled_program_name_6_p_0(PathStream_11, MaybeExpectedProfiledProgramName_7, STATE_VARIABLE_MaybeError_3_25, &MaybeActualProfiledProgram_13);
...
mdbcomp__feedback__read_profiled_program_name_6_p_0(
  ...
  MR_Word MaybeError0_9,
  MR_Word * MaybeActualProfiledProgram_10)
{
  MR_bool succeeded;

  if ((MaybeError0_9 == (MR_Word) ((MR_Unsigned) 0U)))
  {
    ...
    switch (MR_tag((MR_Word) LineResult_13)) {
          ...
          else
          {
            ...
            else
            {
...

              {
                ...
                MR_hl_field(3, Var_20, 1) = ((MR_Box) (ExpectedProfiledProgram_16));
                MR_hl_field(3, Var_20, 2) = ((MR_Box) (ActualProfiledProgram_15));
              }
              {
                MR_Word base;
                base = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
      ...
      case (MR_Integer) 2:
        {
          MR_Word Var_22;
          MR_Word Error_23 = ((MR_Word) ((MR_hl_field(2, LineResult_13, 0))));

          {
            Var_22 = (MR_Word) MR_mkword(2, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(2, Var_22, 0) = ((MR_Box) (Error_23));
          }
          {
            MR_Word base;
            base = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
  ...
  {
    MR_Word Error_12 = ((MR_Word) ((MR_hl_field(1, MaybeError0_9, 0))));
