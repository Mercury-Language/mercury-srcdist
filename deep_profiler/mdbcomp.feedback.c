...
mdbcomp__feedback__IntroducedFrom__pred__replace_feedback_candidate_parallel_conjunctions__296__1_2_p_0(
  MR_String ProfiledProgramName_5,
  MR_String HeadVar__2_13);

static MR_bool MR_CALL 
mdbcomp__feedback__IntroducedFrom__pred__add_feedback_candidate_parallel_conjunctions__290__1_2_p_0(
  MR_Word HeadVar__1_17,
  MR_Word HeadVar__2_18);

static MR_bool MR_CALL 
mdbcomp__feedback__IntroducedFrom__pred__add_feedback_candidate_parallel_conjunctions__288__1_2_p_0(
  MR_String ProfiledProgramName_5,
  MR_String HeadVar__2_13);
...
static /* final */ const MR_Box mdbcomp__feedback_scalar_common_3[2][1];
...
static /* final */ const MR_Box mdbcomp__feedback_scalar_common_3[2][1] = {
  ...
  /* row   1 */
  { ((MR_Box) (MR_mkword(3, &mdbcomp__feedback_scalar_common_1[5]))) },
};
...
static const MR_Integer mdbcomp__feedback__mdbcomp__feedback__functor_number_map_feedback_component_wrapper_0[1] = { (MR_Integer) 0 };
...
static const MR_DuFunctorDescPtr mdbcomp__feedback__mdbcomp__feedback__du_stag_ordered_feedback_info_0_0[1] = { &mdbcomp__feedback__mdbcomp__feedback__du_functor_desc_feedback_info_0_0 };
...
static const MR_DuFunctorDescPtr mdbcomp__feedback__mdbcomp__feedback__du_name_ordered_feedback_info_0[1] = { &mdbcomp__feedback__mdbcomp__feedback__du_functor_desc_feedback_info_0_0 };

static const MR_Integer mdbcomp__feedback__mdbcomp__feedback__functor_number_map_feedback_info_0[1] = { (MR_Integer) 0 };
...
static const MR_DuFunctorDescPtr mdbcomp__feedback__mdbcomp__feedback__du_stag_ordered_feedback_info_candidate_parallel_conjunctions_0_0[1] = { &mdbcomp__feedback__mdbcomp__feedback__du_functor_desc_feedback_info_candidate_parallel_conjunctions_0_0 };
...
static const MR_DuFunctorDescPtr mdbcomp__feedback__mdbcomp__feedback__du_name_ordered_feedback_info_candidate_parallel_conjunctions_0[1] = { &mdbcomp__feedback__mdbcomp__feedback__du_functor_desc_feedback_info_candidate_parallel_conjunctions_0_0 };

static const MR_Integer mdbcomp__feedback__mdbcomp__feedback__functor_number_map_feedback_info_candidate_parallel_conjunctions_0[1] = { (MR_Integer) 0 };
...
static const MR_PseudoTypeInfo mdbcomp__feedback__mdbcomp__feedback__field_types_feedback_read_error_0_0[1] = { (MR_PseudoTypeInfo) (&mercury__io__io__type_ctor_info_error_0) };
...
static const MR_PseudoTypeInfo mdbcomp__feedback__mdbcomp__feedback__field_types_feedback_read_error_0_1[1] = { (MR_PseudoTypeInfo) (&mercury__io__io__type_ctor_info_error_0) };
...
static const MR_PseudoTypeInfo mdbcomp__feedback__mdbcomp__feedback__field_types_feedback_read_error_0_4[1] = { (MR_PseudoTypeInfo) (&mercury__builtin__builtin__type_ctor_info_string_0) };
...
static const MR_PseudoTypeInfo mdbcomp__feedback__mdbcomp__feedback__field_types_feedback_read_error_0_7[1] = { (MR_PseudoTypeInfo) (&mercury__builtin__builtin__type_ctor_info_string_0) };

static const MR_ConstString mdbcomp__feedback__mdbcomp__feedback__field_names_feedback_read_error_0_7[1] = { (MR_String) "fre_component_name" };
...
static const MR_DuFunctorDescPtr mdbcomp__feedback__mdbcomp__feedback__du_stag_ordered_feedback_read_error_0_1[1] = { &mdbcomp__feedback__mdbcomp__feedback__du_functor_desc_feedback_read_error_0_0 };

static const MR_DuFunctorDescPtr mdbcomp__feedback__mdbcomp__feedback__du_stag_ordered_feedback_read_error_0_2[1] = { &mdbcomp__feedback__mdbcomp__feedback__du_functor_desc_feedback_read_error_0_1 };
...
static const MR_PseudoTypeInfo mdbcomp__feedback__mdbcomp__feedback__field_types_feedback_write_result_0_1[1] = { (MR_PseudoTypeInfo) (&mercury__io__io__type_ctor_info_error_0) };
...
static const MR_PseudoTypeInfo mdbcomp__feedback__mdbcomp__feedback__field_types_feedback_write_result_0_2[1] = { (MR_PseudoTypeInfo) (&mercury__io__io__type_ctor_info_error_0) };
...
static const MR_DuFunctorDescPtr mdbcomp__feedback__mdbcomp__feedback__du_stag_ordered_feedback_write_result_0_0[1] = { &mdbcomp__feedback__mdbcomp__feedback__du_functor_desc_feedback_write_result_0_0 };

static const MR_DuFunctorDescPtr mdbcomp__feedback__mdbcomp__feedback__du_stag_ordered_feedback_write_result_0_1[1] = { &mdbcomp__feedback__mdbcomp__feedback__du_functor_desc_feedback_write_result_0_1 };

static const MR_DuFunctorDescPtr mdbcomp__feedback__mdbcomp__feedback__du_stag_ordered_feedback_write_result_0_2[1] = { &mdbcomp__feedback__mdbcomp__feedback__du_functor_desc_feedback_write_result_0_2 };
  ...
  if (succeeded)
    *HeadVar__1_1 = (MR_Integer) 0;
    ...
    switch (MR_tag((MR_Word) HeadVar__2_2)) {
      ...
      case (MR_Integer) 1:
        {
          MR_Word Var_147 = ((MR_Word) ((MR_hl_field(1, HeadVar__2_2, (MR_Integer) 0))));
      ...
      case (MR_Integer) 2:
        {
          MR_Word Var_150 = ((MR_Word) ((MR_hl_field(2, HeadVar__2_2, (MR_Integer) 0))));
      ...
      case (MR_Integer) 3:
        switch (((MR_Integer) ((MR_hl_field(3, HeadVar__2_2, (MR_Integer) 0))))) {
          ...
          case (MR_Integer) 0:
            {
              MR_Integer Var_148 = ((MR_Integer) ((MR_hl_field(3, HeadVar__2_2, (MR_Integer) 2))));
              MR_String Var_149 = ((MR_String) ((MR_hl_field(3, HeadVar__2_2, (MR_Integer) 1))));
                    ...
                    case (MR_Integer) 0:
                      {
                        ...
                        MR_Integer ArgY2_46 = ((MR_Integer) ((MR_hl_field(3, HeadVar__3_3, (MR_Integer) 2))));
          ...
          case (MR_Integer) 1:
            {
              MR_String Var_146 = ((MR_String) ((MR_hl_field(3, HeadVar__2_2, (MR_Integer) 1))));
              ...
              switch (MR_tag((MR_Word) HeadVar__3_3)) {
                ...
                case (MR_Integer) 3:
                  switch (((MR_Integer) ((MR_hl_field(3, HeadVar__3_3, (MR_Integer) 0))))) {
                    ...
                    case (MR_Integer) 1:
                      {
                        MR_String ArgY1_78 = ((MR_String) ((MR_hl_field(3, HeadVar__3_3, (MR_Integer) 1))));
          ...
          case (MR_Integer) 2:
            {
              MR_String Var_144 = ((MR_String) ((MR_hl_field(3, HeadVar__2_2, (MR_Integer) 2))));
              MR_String Var_145 = ((MR_String) ((MR_hl_field(3, HeadVar__2_2, (MR_Integer) 1))));
              ...
              switch (MR_tag((MR_Word) HeadVar__3_3)) {
                ...
                case (MR_Integer) 3:
                  switch (((MR_Integer) ((MR_hl_field(3, HeadVar__3_3, (MR_Integer) 0))))) {
                    ...
                    case (MR_Integer) 2:
                      {
                        MR_String ArgY1_111 = ((MR_String) ((MR_hl_field(3, HeadVar__3_3, (MR_Integer) 1))));
                        MR_String ArgY2_114 = ((MR_String) ((MR_hl_field(3, HeadVar__3_3, (MR_Integer) 2))));
          ...
          case (MR_Integer) 3:
            {
              MR_String Var_151 = ((MR_String) ((MR_hl_field(3, HeadVar__2_2, (MR_Integer) 1))));
          ...
          case (MR_Integer) 2:
            {
              ...
              MR_String ArgY1_18;
              MR_String ArgX2_19 = ((MR_String) ((MR_hl_field(3, HeadVar__1_1, (MR_Integer) 2))));
              MR_String ArgY2_20;
              ...
              if (succeeded)
              {
                ...
                ArgY2_20 = ((MR_String) ((MR_hl_field(3, HeadVar__2_2, (MR_Integer) 2))));
  ...
  MR_Word * Result_8)
{
  ...
  {
    MR_Word ErrorCode_12 = ((MR_Word) ((MR_hl_field(1, PathResult_10, (MR_Integer) 0))));
  ...
  {
    MR_Word PathStream_11 = ((MR_Word) ((MR_hl_field(0, PathResult_10, (MR_Integer) 0))));

    mdbcomp__feedback__actually_write_feedback_file_4_p_0(PathStream_11, Feedback_7);
...
void MR_CALL 
mdbcomp__feedback__actually_write_feedback_file_4_p_0(
  MR_Word Stream_5,
  MR_Word FeedbackInfo_6)
{
  MR_String ProfiledProgramName_8 = ((MR_String) ((MR_hl_field(0, FeedbackInfo_6, (MR_Integer) 0))));
  MR_Word MaybeCandidateParallelConjs_9 = ((MR_Word) ((MR_hl_field(0, FeedbackInfo_6, (MR_Integer) 1))));
  MR_Word Components_13;
  MR_Word STATE_VARIABLE_RevComponents_28_28;

  mercury__io__write_string_4_p_0(Stream_5, (MR_String) "Mercury Compiler Feedback");
  mercury__io__write_string_4_p_0(Stream_5, (MR_String) "\n");
  mercury__io__write_string_4_p_0(Stream_5, (MR_String) "19");
  mercury__io__write_string_4_p_0(Stream_5, (MR_String) "\n");
  mercury__io__write_string_4_p_0(Stream_5, ProfiledProgramName_8);
  mercury__io__write_string_4_p_0(Stream_5, (MR_String) "\n");
  if ((MaybeCandidateParallelConjs_9 == (MR_Word) ((MR_Unsigned) 0U)))
    STATE_VARIABLE_RevComponents_28_28 = (MR_Word) ((MR_Unsigned) 0U);
  else
  {
    MR_Word Candidates_11 = ((MR_Word) ((MR_hl_field(1, MaybeCandidateParallelConjs_9, (MR_Integer) 0))));
    MR_Word CandComponent_12 = (MR_Word) (Candidates_11);

    {
      STATE_VARIABLE_RevComponents_28_28 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(1, STATE_VARIABLE_RevComponents_28_28, 0) = ((MR_Box) (CandComponent_12));
      MR_hl_field(1, STATE_VARIABLE_RevComponents_28_28, 1) = ((MR_Box) ((MR_Unsigned) 0U));
    }
  }
  mercury__list__reverse_2_p_0((MR_Word) (&mdbcomp__feedback__mdbcomp__feedback__type_ctor_info_feedback_component_wrapper_0), STATE_VARIABLE_RevComponents_28_28, &Components_13);
  mercury__io__write_4_p_0((MR_Word) (&mdbcomp__feedback_scalar_common_1[1]), Stream_5, ((MR_Box) (Components_13)));
  mercury__io__write_string_4_p_0(Stream_5, (MR_String) ".\n");
}
  ...
  MR_Word * FeedbackResult_8)
{
  ...
  {
    MR_Word Error_12 = ((MR_Word) ((MR_hl_field(1, ReadResult_10, (MR_Integer) 0))));
  ...
  MR_Word * ResultFeedbackInfo_8)
{
  ...
  if (((MR_tag((MR_Word) PathResult_10)) == (MR_Integer) 1))
  {
    MR_Word ErrorCode_14 = ((MR_Word) ((MR_hl_field(1, PathResult_10, (MR_Integer) 0))));
    MR_Word Var_31;
  ...
  else
  {
    ...
    MR_Word STATE_VARIABLE_MaybeError_21_21;
    MR_Word STATE_VARIABLE_MaybeError_25_25;

    mdbcomp__feedback__read_check_line_7_p_0(PathStream_11, (MR_String) "Mercury Compiler Feedback", (MR_Word) ((MR_Unsigned) 4U), (MR_Word) ((MR_Unsigned) 0U), &STATE_VARIABLE_MaybeError_21_21);
    mdbcomp__feedback__read_check_line_7_p_0(PathStream_11, (MR_String) "19", (MR_Word) (MR_mkword(3, &mdbcomp__feedback_scalar_common_1[6])), STATE_VARIABLE_MaybeError_21_21, &STATE_VARIABLE_MaybeError_25_25);
    mdbcomp__feedback__read_profiled_program_name_6_p_0(PathStream_11, MaybeExpectedProfiledProgramName_7, STATE_VARIABLE_MaybeError_25_25, &MaybeActualProfiledProgram_13);
    mdbcomp__feedback__read_all_feedback_data_5_p_0(PathStream_11, MaybeActualProfiledProgram_13, ResultFeedbackInfo_8);
...
mdbcomp__feedback__read_all_feedback_data_5_p_0(
  MR_Word Stream_6,
  MR_Word MaybeActualProfiledProgram_7,
  MR_Word * Result_8)
{
  if (((MR_tag((MR_Word) MaybeActualProfiledProgram_7)) == (MR_Integer) 1))
    *Result_8 = (MR_Word) (MaybeActualProfiledProgram_7);
  else
  {
    MR_String ActualProfiledProgram_11 = ((MR_String) ((MR_hl_field(0, MaybeActualProfiledProgram_7, (MR_Integer) 0))));
    MR_Word ReadResult_12;

    mercury__io__read_4_p_0((MR_Word) (&mdbcomp__feedback_scalar_common_1[1]), Stream_6, &ReadResult_12);
    switch (MR_tag((MR_Word) ReadResult_12)) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        *Result_8 = (MR_Word) (MR_mkword(1, &mdbcomp__feedback_scalar_common_3[0]));
        break;
      case (MR_Integer) 1:
        {
          MR_Word Components_13 = ((MR_Word) ((MR_hl_field(1, ReadResult_12, (MR_Integer) 0))));
          MR_Word Info0_14;

          {
            Info0_14 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
            MR_hl_field(0, Info0_14, 0) = ((MR_Box) (ActualProfiledProgram_11));
            MR_hl_field(0, Info0_14, 1) = ((MR_Box) ((MR_Unsigned) 0U));
          }
          mdbcomp__feedback__add_feedback_components_3_p_0(Components_13, Info0_14, Result_8);
        }
        break;
      case (MR_Integer) 2:
        {
          MR_Integer Line_15 = ((MR_Integer) ((MR_hl_field(2, ReadResult_12, (MR_Integer) 1))));
          MR_Word Var_20;
          MR_String Error_21 = ((MR_String) ((MR_hl_field(2, ReadResult_12, (MR_Integer) 0))));

          {
            Var_20 = (MR_Word) MR_mkword(3, MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(3, Var_20, 0) = ((MR_Box) ((MR_Unsigned) 0U));
            MR_hl_field(3, Var_20, 1) = ((MR_Box) (Error_21));
            MR_hl_field(3, Var_20, 2) = ((MR_Box) (Line_15));
          }
          {
            MR_Word base;
            base = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
  ...
  MR_Word * Result_3)
{
  while (MR_TRUE)
  {
    ...
    {
      MR_Word Wrapper_7 = ((MR_Word) ((MR_hl_field(1, HeadVar__1_1, (MR_Integer) 0))));
      MR_Word Wrappers_8 = ((MR_Word) ((MR_hl_field(1, HeadVar__1_1, (MR_Integer) 1))));
      MR_Word Candidates_11 = (MR_Word) (Wrapper_7);
      MR_Word MaybeCandidates0_12 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_Info_0_2, (MR_Integer) 1))));
      MR_String Var_19 = ((MR_String) ((MR_hl_field(0, STATE_VARIABLE_Info_0_2, (MR_Integer) 0))));
      ...
      if ((MaybeCandidates0_12 == (MR_Word) ((MR_Unsigned) 0U)))
      {
        ...
        {
          STATE_VARIABLE_Info_15_15 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(0, STATE_VARIABLE_Info_15_15, 0) = ((MR_Box) (Var_19));
          MR_hl_field(0, STATE_VARIABLE_Info_15_15, 1) = ((MR_Box) (Var_16));
        }
        // direct tailcall eliminated
        ;
        next_value_of_HeadVar__1_1 = Wrappers_8;
        next_value_of_STATE_VARIABLE_Info_0_2 = STATE_VARIABLE_Info_15_15;
        HeadVar__1_1 = next_value_of_HeadVar__1_1;
        STATE_VARIABLE_Info_0_2 = next_value_of_STATE_VARIABLE_Info_0_2;
        continue;
      }
      else
        *Result_3 = (MR_Word) (MR_mkword(1, &mdbcomp__feedback_scalar_common_3[1]));
    }
    break;
  }
}
...
mdbcomp__feedback__read_profiled_program_name_6_p_0(
  MR_Word Stream_7,
  MR_Word MaybeExpectedProfiledProgram_8,
  MR_Word STATE_VARIABLE_MaybeError_0_17,
  MR_Word * MaybeActualProfiledProgram_10)
{
  MR_bool succeeded;

  if ((STATE_VARIABLE_MaybeError_0_17 == (MR_Word) ((MR_Unsigned) 0U)))
  {
    MR_Word LineResult_13;

    mercury__io__read_line_as_string_4_p_0(Stream_7, &LineResult_13);
    switch (MR_tag((MR_Word) LineResult_13)) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        *MaybeActualProfiledProgram_10 = (MR_Word) (MR_mkword(1, &mdbcomp__feedback_scalar_common_3[0]));
        break;
      case (MR_Integer) 1:
        {
          MR_String String_14 = ((MR_String) ((MR_hl_field(1, LineResult_13, (MR_Integer) 0))));
          MR_String ActualProfiledProgram_15;

          ActualProfiledProgram_15 = mercury__string__strip_1_f_0(String_14);
          if ((MaybeExpectedProfiledProgram_8 == (MR_Word) ((MR_Unsigned) 0U)))
            {
              MR_Word base;
              base = (MR_Word) MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL);
              *MaybeActualProfiledProgram_10 = base;
              MR_hl_field(0, base, 0) = ((MR_Box) (ActualProfiledProgram_15));
            }
          else
          {
            MR_String ExpectedProfiledProgram_16 = ((MR_String) ((MR_hl_field(1, MaybeExpectedProfiledProgram_8, (MR_Integer) 0))));

            succeeded = (strcmp(ActualProfiledProgram_15, ExpectedProfiledProgram_16) == 0);
            if (succeeded)
              {
                MR_Word base;
                base = (MR_Word) MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL);
            ...
            else
            {
...

              {
                ...
                MR_hl_field(3, Var_21, 1) = ((MR_Box) (ExpectedProfiledProgram_16));
                MR_hl_field(3, Var_21, 2) = ((MR_Box) (ActualProfiledProgram_15));
              }
              {
                MR_Word base;
                base = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
      ...
      case (MR_Integer) 2:
        {
          MR_Word Var_23;
          MR_Word Error_24 = ((MR_Word) ((MR_hl_field(2, LineResult_13, (MR_Integer) 0))));

          {
            Var_23 = (MR_Word) MR_mkword(2, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(2, Var_23, 0) = ((MR_Box) (Error_24));
          }
          {
            MR_Word base;
            base = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
  ...
  {
    MR_Word Error_12 = ((MR_Word) ((MR_hl_field(1, STATE_VARIABLE_MaybeError_0_17, (MR_Integer) 0))));
...
mdbcomp__feedback__read_check_line_7_p_0(
  MR_Word Stream_8,
  MR_String TestLine_9,
  MR_Word NotMatchError_10,
  MR_Word STATE_VARIABLE_MaybeError_0_17,
  MR_Word * STATE_VARIABLE_MaybeError_18)
{
  ...
  if ((STATE_VARIABLE_MaybeError_0_17 == (MR_Word) ((MR_Unsigned) 0U)))
  {
    ...
    mercury__io__read_line_as_string_4_p_0(Stream_8, &LineResult_14);
    switch (MR_tag((MR_Word) LineResult_14)) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        *STATE_VARIABLE_MaybeError_18 = (MR_Word) (MR_mkword(1, &mdbcomp__feedback_scalar_common_3[0]));
        break;
      case (MR_Integer) 1:
        {
          MR_String Line_15 = ((MR_String) ((MR_hl_field(1, LineResult_14, (MR_Integer) 0))));

          succeeded = (strcmp(Line_15, TestLine_9) == 0);
          if (!(succeeded))
          {
            MR_String Var_30;

            Var_30 = mercury__string__f_43_43_2_f_0(TestLine_9, (MR_String) "\n");
            succeeded = (strcmp(Line_15, Var_30) == 0);
          }
          if (succeeded)
            *STATE_VARIABLE_MaybeError_18 = (MR_Word) ((MR_Unsigned) 0U);
          else
            {
              MR_Word base;
              base = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
              *STATE_VARIABLE_MaybeError_18 = base;
              MR_hl_field(1, base, 0) = ((MR_Box) (NotMatchError_10));
            }
        }
        break;
      case (MR_Integer) 2:
        {
          MR_Word Error_16 = ((MR_Word) ((MR_hl_field(2, LineResult_14, (MR_Integer) 0))));
          MR_Word Var_28;

          {
            Var_28 = (MR_Word) MR_mkword(2, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(2, Var_28, 0) = ((MR_Box) (Error_16));
          }
          {
            MR_Word base;
            base = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
  ...
  MR_String * Message_6)
{
  ...
  switch (MR_tag((MR_Word) Error_5)) {
    ...
    case (MR_Integer) 1:
      {
        MR_Word Code_7 = ((MR_Word) ((MR_hl_field(1, Error_5, (MR_Integer) 0))));
    ...
    case (MR_Integer) 2:
      {
        MR_Word Code_39 = ((MR_Word) ((MR_hl_field(2, Error_5, (MR_Integer) 0))));

        mercury__io__error_message_2_p_0(Code_39, &MessagePart_8);
      }
      break;
    case (MR_Integer) 3:
      switch (((MR_Integer) ((MR_hl_field(3, Error_5, (MR_Integer) 0))))) {
        default: /*NOTREACHED*/ MR_assert(0);
        case (MR_Integer) 0:
          {
            MR_String ParseMessage_9 = ((MR_String) ((MR_hl_field(3, Error_5, (MR_Integer) 1))));
            MR_Integer Line_10 = ((MR_Integer) ((MR_hl_field(3, Error_5, (MR_Integer) 2))));
            MR_String Var_14;
            MR_String Var_16;
        ...
        case (MR_Integer) 1:
          {
            MR_String Expected_11 = ((MR_String) ((MR_hl_field(3, Error_5, (MR_Integer) 1))));
        ...
        case (MR_Integer) 2:
          {
            MR_String Got_12 = ((MR_String) ((MR_hl_field(3, Error_5, (MR_Integer) 2))));
            MR_String Var_19;
            MR_String Var_21;
            MR_String Expected_37 = ((MR_String) ((MR_hl_field(3, Error_5, (MR_Integer) 1))));
            MR_String Var_41;
            MR_String Var_43;
            MR_String Var_44;
        ...
        case (MR_Integer) 3:
          {
            MR_String ComponentName_13 = ((MR_String) ((MR_hl_field(3, Error_5, (MR_Integer) 1))));
            MR_String Var_29;
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = mdbcomp__feedback__IntroducedFrom__pred__replace_feedback_candidate_parallel_conjunctions__296__1_2_p_0(((MR_String) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_String) ((MR_hl_field(0, closure, (MR_Integer) 4)))));
  return succeeded;
}
  ...
  MR_Word * STATE_VARIABLE_Info_9)
{
  MR_bool succeeded;
  MR_Word Var_10;
  MR_String Var_13 = ((MR_String) ((MR_hl_field(0, STATE_VARIABLE_Info_0_8, (MR_Integer) 0))));
  MR_Word Var_15;
  MR_String Var_17;

  {
    Var_10 = (MR_Word) MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(0, Var_10, 0) = ((MR_Box) (&mdbcomp__feedback_scalar_common_4[0]));
    MR_hl_field(0, Var_10, 1) = ((MR_Box) (mdbcomp__feedback__replace_feedback_candidate_parallel_conjunctions_4_p_0_1));
  ...
  Var_17 = ((MR_String) ((MR_hl_field(0, STATE_VARIABLE_Info_0_8, (MR_Integer) 0))));
  {
    MR_Word base;
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = mdbcomp__feedback__IntroducedFrom__pred__add_feedback_candidate_parallel_conjunctions__290__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 4)))));
  return succeeded;
}
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = mdbcomp__feedback__IntroducedFrom__pred__add_feedback_candidate_parallel_conjunctions__288__1_2_p_0(((MR_String) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_String) ((MR_hl_field(0, closure, (MR_Integer) 4)))));
  return succeeded;
}
  ...
  MR_Word * STATE_VARIABLE_Info_9)
{
...

  {
    Var_10 = (MR_Word) MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(0, Var_10, 0) = ((MR_Box) (&mdbcomp__feedback_scalar_common_4[0]));
    MR_hl_field(0, Var_10, 1) = ((MR_Box) (mdbcomp__feedback__add_feedback_candidate_parallel_conjunctions_4_p_0_1));
    MR_hl_field(0, Var_10, 2) = ((MR_Box) ((MR_Integer) 2));
    MR_hl_field(0, Var_10, 3) = ((MR_Box) (ProfiledProgramName_5));
    MR_hl_field(0, Var_10, 4) = ((MR_Box) (Var_13));
  }
  ...
  Var_17 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_Info_0_8, (MR_Integer) 1))));
  {
    Var_14 = (MR_Word) MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(0, Var_14, 0) = ((MR_Box) (&mdbcomp__feedback_scalar_common_4[1]));
    MR_hl_field(0, Var_14, 1) = ((MR_Box) (mdbcomp__feedback__add_feedback_candidate_parallel_conjunctions_4_p_0_2));
  ...
  Var_23 = ((MR_String) ((MR_hl_field(0, STATE_VARIABLE_Info_0_8, (MR_Integer) 0))));
  {
    MR_Word base;
    base = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
    *STATE_VARIABLE_Info_9 = base;
...
{
  *ProfiledProgramName_5 = ((MR_String) ((MR_hl_field(0, Info_4, (MR_Integer) 0))));
  *MaybeCandidateParallelConjs_6 = ((MR_Word) ((MR_hl_field(0, Info_4, (MR_Integer) 1))));
}
...
mdbcomp__feedback__get_feedback_candidate_parallel_conjunctions_1_f_0(
  MR_Word Info_3)
{
  MR_Word HeadVar__2_2 = ((MR_Word) ((MR_hl_field(0, Info_3, (MR_Integer) 1))));
...
mdbcomp__feedback__get_feedback_profiled_program_name_1_f_0(
  MR_Word Info_3)
{
  MR_String HeadVar__2_2 = ((MR_String) ((MR_hl_field(0, Info_3, (MR_Integer) 0))));
