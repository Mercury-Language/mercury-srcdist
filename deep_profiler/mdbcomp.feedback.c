...
MR_decl_label5(mdbcomp__feedback__read_data_5_0, 2,4,6,9,11)
...
MR_decl_label9(mdbcomp__feedback__write_feedback_file_2_6_0, 2,3,4,5,6,7,8,9,10)
MR_decl_label1(fn__mdbcomp__feedback__init_feedback_info_1_0, 2)
MR_decl_label4(__Unify___mdbcomp__feedback__feedback_data_0_0, 20,5,10,1)
...
MR_decl_label9(__Compare___mdbcomp__feedback__feedback_data_0_0, 3,2,9,13,7,5,20,22,77)
MR_decl_label4(__Compare___mdbcomp__feedback__feedback_info_0_0, 3,2,5,27)
...
MR_BEGIN_MODULE(mdbcomp__feedback_module18)
	...
	MR_init_label5(mdbcomp__feedback__read_data_5_0,2,4,6,9,11)
MR_BEGIN_CODE
...
MR_define_entry(mercury__mdbcomp__feedback__read_data_5_0);
	...
	MR_np_call_localret_ent(io__read_4_0,
		mdbcomp__feedback__read_data_5_0_i2);
MR_def_label(mdbcomp__feedback__read_data_5_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
		MR_GOTO_LAB(mdbcomp__feedback__read_data_5_0_i4);
	}
	MR_r1 = (MR_Word) MR_TAG_COMMON(1,4,0);
	MR_decr_sp_and_return(4);
MR_def_label(mdbcomp__feedback__read_data_5_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_r1,2)) {
		MR_GOTO_LAB(mdbcomp__feedback__read_data_5_0_i6);
	}
	{
	MR_Word MR_tempr1;
...
MR_def_label(mdbcomp__feedback__read_data_5_0,6)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	...
	MR_r2 = MR_sv(3);
	MR_np_call_localret_ent(fn__map__init_0_0,
		mdbcomp__feedback__read_data_5_0_i9);
MR_def_label(mdbcomp__feedback__read_data_5_0,9)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
	...
	MR_np_call_localret_ent(list__foldl_4_0,
		mdbcomp__feedback__read_data_5_0_i11);
MR_def_label(mdbcomp__feedback__read_data_5_0,11)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 0, (MR_Integer) 2);
...
MR_BEGIN_MODULE(mdbcomp__feedback_module21)
	...
	MR_init_label9(mdbcomp__feedback__write_feedback_file_2_6_0,2,3,4,5,6,7,8,9,10)
MR_BEGIN_CODE
...
MR_def_label(mdbcomp__feedback__write_feedback_file_2_6_0,8)
	...
	MR_np_call_localret_ent(io__write_4_0,
		mdbcomp__feedback__write_feedback_file_2_6_0_i9);
MR_def_label(mdbcomp__feedback__write_feedback_file_2_6_0,9)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(1);
	MR_r2 = (MR_Word) MR_string_const(".\n", 2);
	MR_np_call_localret_ent(io__write_string_4_0,
...
MR_BEGIN_MODULE(mdbcomp__feedback_module22)
	...
	MR_init_label4(__Unify___mdbcomp__feedback__feedback_data_0_0,20,5,10,1)
MR_BEGIN_CODE
...
MR_define_entry(mercury____Unify___mdbcomp__feedback__feedback_data_0_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if ((MR_r1 == MR_r2)) {
		MR_GOTO_LAB(__Unify___mdbcomp__feedback__feedback_data_0_0_i20);
	}
	MR_incr_sp(3);
	MR_sv(3) = (MR_Word) MR_succip;
	{
...
MR_def_label(__Unify___mdbcomp__feedback__feedback_data_0_0,20)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_TRUE;
	MR_proceed();
...
MR_BEGIN_MODULE(mdbcomp__feedback_module23)
	...
	MR_init_label9(__Compare___mdbcomp__feedback__feedback_data_0_0,3,2,9,13,7,5,20,22,77)
MR_BEGIN_CODE
...
MR_def_label(__Compare___mdbcomp__feedback__feedback_data_0_0,9)
	...
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___mdbcomp__feedback__feedback_data_0_0_i77);
	}
	MR_r1 = MR_sv(3);
	MR_r2 = MR_sv(1);
	MR_np_call_localret_ent(private_builtin__builtin_compare_int_3_0,
...
MR_def_label(__Compare___mdbcomp__feedback__feedback_data_0_0,22)
	...
	MR_decr_sp(5);
	MR_np_tailcall_ent(builtin__compare_3_0);
MR_def_label(__Compare___mdbcomp__feedback__feedback_data_0_0,77)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(5);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
...
MR_BEGIN_MODULE(mdbcomp__feedback_module25)
	...
	MR_init_label4(__Compare___mdbcomp__feedback__feedback_info_0_0,3,2,5,27)
MR_BEGIN_CODE
...
MR_def_label(__Compare___mdbcomp__feedback__feedback_info_0_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___mdbcomp__feedback__feedback_info_0_0_i27);
	}
	MR_r1 = (MR_Word) MR_TAG_COMMON(0,1,0);
	MR_r2 = MR_sv(1);
	MR_r3 = MR_sv(2);
	...
	MR_decr_sp(3);
	MR_np_tailcall_ent(builtin__compare_3_0);
MR_def_label(__Compare___mdbcomp__feedback__feedback_info_0_0,27)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(3);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
