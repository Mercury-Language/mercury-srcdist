...
MR_decl_label10(__Compare___profile__deep_0_0, 82,86,90,94,98,103,108,112,116,322)
...
MR_BEGIN_MODULE(profile_module137)
	...
	MR_init_label10(__Compare___profile__deep_0_0,82,86,90,94,98,103,108,112,116,322)
MR_BEGIN_CODE
...
MR_def_label(__Compare___profile__deep_0_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___profile__deep_0_0_i322);
	}
	MR_r1 = MR_sv(1);
	MR_r2 = MR_sv(28);
...
MR_def_label(__Compare___profile__deep_0_0,322)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(55);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
