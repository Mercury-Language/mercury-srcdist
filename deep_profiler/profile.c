            ...
            else
            {
              ...
              else
              {
                ...
                else
                {
                  ...
                  mercury__private_builtin__builtin_compare_int_3_p_0(&SubResult7_24, ArgX7_22, ArgY7_23);
                  ...
                  else
                  {
                    ...
                    mercury__private_builtin__builtin_compare_int_3_p_0(&SubResult8_27, Var_53, Var_54);
...
{
  {
    ...
    else
    {
      ...
      else
      {
        ...
        mercury__private_builtin__builtin_compare_int_3_p_0(&SubResult2_9, Var_29, Var_30);
        succeeded = (SubResult2_9 != (MR_Integer) 0);
        if (succeeded)
          *HeadVar__1_1 = SubResult2_9;
        else
        ...
        else
        {
          ...
          else
          {
            ...
            else
            {
              ...
              mercury__private_builtin__builtin_compare_int_3_p_0(&SubResult5_18, Var_121, Var_122);
              succeeded = (SubResult5_18 != (MR_Integer) 0);
              if (succeeded)
                *HeadVar__1_1 = SubResult5_18;
              else
        ...
        else
        {
          ...
          else
          {
            ...
            else
            {
              ...
              mercury__private_builtin__builtin_compare_int_3_p_0(&SubResult5_18, ArgX5_16, ArgY5_17);
              succeeded = (SubResult5_18 != (MR_Integer) 0);
              if (succeeded)
                *HeadVar__1_1 = SubResult5_18;
              else
              {
                ...
                else
                {
                  ...
                  else
                  {
                    ...
                    mercury__private_builtin__builtin_compare_int_3_p_0(&SubResult8_27, ArgX8_25, ArgY8_26);
                    succeeded = (SubResult8_27 != (MR_Integer) 0);
                    if (succeeded)
                      *HeadVar__1_1 = SubResult8_27;
                    else
                    {
                      ...
                      mercury__private_builtin__builtin_compare_int_3_p_0(&SubResult9_30, ArgX9_28, ArgY9_29);
                      succeeded = (SubResult9_30 != (MR_Integer) 0);
                      if (succeeded)
                        *HeadVar__1_1 = SubResult9_30;
                      else
...
{
  {
    ...
    if (((MR_tag((MR_Word) HeadVar__2_2)) == (MR_Integer) 1))
    {
      ...
      if (((MR_tag((MR_Word) HeadVar__3_3)) == (MR_Integer) 1))
      {
        ...
        mercury__private_builtin__builtin_compare_int_3_p_0(&SubResult1_14, Var_25, Var_26);
