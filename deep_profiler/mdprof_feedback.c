...
MR_decl_label8(mdprof_feedback__check_options_2_0, 2,4,6,7,3,8,10,11)
MR_decl_label8(mdprof_feedback__check_options_2_0, 14,13,12,16,18,19,9,22)
MR_decl_label8(mdprof_feedback__check_options_2_0, 24,26,28,27,30,32,33,34)
MR_decl_label2(mdprof_feedback__check_options_2_0, 35,36)
MR_decl_label2(mdprof_feedback__check_verbosity_option_2_0, 2,1)
MR_decl_label3(mdprof_feedback__defaults_2_0, 15,16,17)
MR_decl_label8(mdprof_feedback__long_2_0, 3,20,5,6,7,8,9,10)
MR_decl_label8(mdprof_feedback__long_2_0, 11,12,13,14,15,16,17,18)
MR_decl_label8(main_2_0, 2,3,4,9,12,11,19,20)
MR_decl_label8(main_2_0, 21,22,97,25,33,34,36,39)
MR_decl_label8(main_2_0, 38,47,50,51,49,53,54,67)
MR_decl_label8(main_2_0, 68,73,74,58,59,64,65,29)
...
"mdprof_feedback.m",
108,
"d1;c12;d1;c8;e;e;t;c2;d1;c3;d1;c7;"
};
...
MR_BEGIN_MODULE(mdprof_feedback_module4)
	...
	MR_init_label8(mdprof_feedback__check_options_2_0,2,4,6,7,3,8,10,11)
	MR_init_label8(mdprof_feedback__check_options_2_0,14,13,12,16,18,19,9,22)
	MR_init_label8(mdprof_feedback__check_options_2_0,24,26,28,27,30,32,33,34)
	MR_init_label2(mdprof_feedback__check_options_2_0,35,36)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(mdprof_feedback_module6)
	...
	MR_init_label8(main_2_0,2,3,4,9,12,11,19,20)
	MR_init_label8(main_2_0,21,22,97,25,33,34,36,39)
	MR_init_label8(main_2_0,38,47,50,51,49,53,54,67)
	MR_init_label8(main_2_0,68,73,74,58,59,64,65,29)
MR_BEGIN_CODE
...
MR_def_label(main_2_0,39)
	...
	MR_r1 = MR_sv(2);
	MR_r2 = (MR_Word) MR_string_const("%s: error reading %s: %s\n", 25);
	MR_succip_word = MR_sv(7);
	MR_decr_sp(7);
...
MR_BEGIN_MODULE(mdprof_feedback_module8)
	...
	MR_init_label8(mdprof_feedback__long_2_0,3,20,5,6,7,8,9,10)
	MR_init_label8(mdprof_feedback__long_2_0,11,12,13,14,15,16,17,18)
MR_BEGIN_CODE
