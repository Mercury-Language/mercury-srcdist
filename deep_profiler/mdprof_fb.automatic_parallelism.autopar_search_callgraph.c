    ...
    if (((MR_tag((MR_Word) mdprof_fb__automatic_parallelism__autopar_search_callgraph__TryResult_32)) == (MR_mktag((MR_Integer) 2))))
      {
        ...
        {
          mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) &mdprof_fb__automatic_parallelism__autopar_search_callgraph_scalar_common_6[0], mdprof_fb__automatic_parallelism__autopar_search_callgraph__PDId_24, &mdprof_fb__automatic_parallelism__autopar_search_callgraph__Var_73);
        }
        {
...
{
  {
    ...
    if ((mdprof_fb__automatic_parallelism__autopar_search_callgraph__MaybeFirstPDPtr_13 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
      {
        ...
        if (mdprof_fb__automatic_parallelism__autopar_search_callgraph__succeeded)
        ...
        else
          {
            ...
            {
              mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) &mdprof_fb__automatic_parallelism__autopar_search_callgraph_scalar_common_6[0], mdprof_fb__automatic_parallelism__autopar_search_callgraph__CliqueNum_18, &mdprof_fb__automatic_parallelism__autopar_search_callgraph__Var_124);
            }
            {
      ...
      }
    {
      ...
      MR_hl_field(MR_mktag(0), mdprof_fb__automatic_parallelism__autopar_search_callgraph__Var_43, 0) = ((MR_Box) (&mdprof_fb__automatic_parallelism__autopar_search_callgraph_scalar_common_7[0]));
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(0), mdprof_fb__automatic_parallelism__autopar_search_callgraph__Var_49, 0) = ((MR_Box) (&mdprof_fb__automatic_parallelism__autopar_search_callgraph_scalar_common_7[1]));
    ...
    {
      mercury__list__foldl_4_p_0(mdprof_fb__automatic_parallelism__autopar_search_callgraph__TypeInfo_89_89, mdprof_fb__automatic_parallelism__autopar_search_callgraph__TypeInfo_89_89, (MR_Word) &mdprof_fb__automatic_parallelism__autopar_search_callgraph_scalar_common_4[3], mdprof_fb__automatic_parallelism__autopar_search_callgraph__CSCandidateLists_30, ((MR_Box) (mdprof_fb__automatic_parallelism__autopar_search_callgraph__Var_52)), &mdprof_fb__automatic_parallelism__autopar_search_callgraph__conv11_CSCandidates_32);
    }
