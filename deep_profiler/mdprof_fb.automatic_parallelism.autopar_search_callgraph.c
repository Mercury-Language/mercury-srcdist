...
mdprof_fb__automatic_parallelism__autopar_search_callgraph__IntroducedFrom__pred__update_parallelism_available__330__1_3_p_0(
  ...
  MR_Word * HeadVar__3_22)
{
  mdprof_fb__automatic_parallelism__autopar_search_callgraph__update_parallelism_available_conj_3_p_0((MR_Word) (&mdprof_fb__automatic_parallelism__autopar_search_callgraph_scalar_common_1[0]), HeadVar__1_20, HeadVar__2_21, HeadVar__3_22);
}
  ...
  else
  {
    ...
    else
    {
      ...
      analysis_utils__proc_dynamic_paired_call_site_slots_3_p_0(Deep_9, PDPtr_10, &Slots_39);
      {
        ...
        MR_hl_field(MR_mktag(0), Var_71, 0) = ((MR_Box) (&mdprof_fb__automatic_parallelism__autopar_search_callgraph_scalar_common_8[4]));
...
{
  MR_bool succeeded;
  MR_Word Var_47 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_Callee_0_20, (MR_Integer) 0))));
  MR_Integer Var_49 = (MR_Integer) (CliquePtr_10);
  MR_Integer Var_50 = (MR_Integer) (Var_47);

  succeeded = (Var_49 != Var_50);
  if (succeeded)
  {
    MR_Word Var_70 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_Callee_0_20, (MR_Integer) 2))));
    MR_Integer Threshold_53 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), Opts_8, (MR_Integer) 8))));
    MR_Word Cost_54 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_Callee_0_20, (MR_Integer) 1))));
    MR_Float Var_55;
    MR_Float Var_56;

    Var_55 = measurements__cs_cost_get_percall_1_f_0(Cost_54);
    Var_56 = mercury__float__float_1_f_0(Threshold_53);
    succeeded = (Var_55 >= Var_56);
    if (succeeded)
    {
      MR_Word STATE_VARIABLE_Callee_21_21;
      MR_Word ProcConjs_78;
      MR_Box conv0_ProcConjs_78;

      succeeded = mercury__map__search_3_p_0((MR_Word) (&mdbcomp__program_representation__mdbcomp__program_representation__type_ctor_info_string_proc_label_0), (MR_Word) (&mdprof_fb__automatic_parallelism__autopar_search_callgraph_scalar_common_1[1]), CliqueCandidates_11, ((MR_Box) (Var_70)), &conv0_ProcConjs_78);
      if (succeeded)
      {
        ProcConjs_78 = ((MR_Word) (conv0_ProcConjs_78));
        succeeded = MR_TRUE;
      }
      if (succeeded)
      {
        MR_Word Conjs_79 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ProcConjs_78, (MR_Integer) 2))));
        MR_Box conv2_STATE_VARIABLE_Callee_21_21;

        mercury__list__foldl_4_p_0((MR_Word) (&mdprof_fb__automatic_parallelism__autopar_search_callgraph_scalar_common_1[6]), (MR_Word) (&mdprof_fb__automatic_parallelism__autopar_search_callgraph__mdprof_fb__automatic_parallelism__autopar_search_callgraph__type_ctor_info_candidate_child_clique_0), (MR_Word) (&mdprof_fb__automatic_parallelism__autopar_search_callgraph_scalar_common_2[9]), Conjs_79, ((MR_Box) (STATE_VARIABLE_Callee_0_20)), &conv2_STATE_VARIABLE_Callee_21_21);
      ...
      succeeded = mdprof_fb__automatic_parallelism__autopar_search_callgraph__exceeded_parallelism_2_p_0(Opts_8, STATE_VARIABLE_Callee_21_21);
      succeeded = !(succeeded);
      if (succeeded)
      {
