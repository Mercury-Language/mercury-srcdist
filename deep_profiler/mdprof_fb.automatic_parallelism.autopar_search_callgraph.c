    ...
    else
    {
      ...
      else
      {
        ...
        else
        {
          ...
          mercury__list__foldl2_6_p_0(TypeCtorInfo_146_146, TypeInfo_147_147, TypeInfo_147_147, (MR_Word) &mdprof_fb__automatic_parallelism__autopar_search_callgraph_scalar_common_2[14], CoveragePoints_44, ((MR_Box) (Var_81)), &conv5_SolnsCoveragePointMap_45, ((MR_Box) (Var_82)), &conv4_BranchCoveragePointMap_46);
...
{
  {
    ...
    mercury__map__union_4_p_1(TypeInfo_101_101, TypeCtorInfo_100_100, (MR_Word) &mdprof_fb__automatic_parallelism__autopar_search_callgraph_scalar_common_2[7], CliqueCandidates_26, CSCandidates_32, Candidates_11);
