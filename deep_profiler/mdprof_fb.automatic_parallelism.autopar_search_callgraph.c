    ...
    if (((MR_tag((MR_Word) mdprof_fb__automatic_parallelism__autopar_search_callgraph__TryResult_32)) == (MR_mktag((MR_Integer) 2))))
      {
        ...
        {
          mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) &mdprof_fb__automatic_parallelism__autopar_search_callgraph_scalar_common_6[0], mdprof_fb__automatic_parallelism__autopar_search_callgraph__PDId_24, &mdprof_fb__automatic_parallelism__autopar_search_callgraph__V_73_73);
        }
        {
        ...
        {
          mercury__io__write_string_4_p_0(mdprof_fb__automatic_parallelism__autopar_search_callgraph__V_36_36, mdprof_fb__automatic_parallelism__autopar_search_callgraph__ProcName_27);
        }
        {
          mercury__io__write_string_4_p_0(mdprof_fb__automatic_parallelism__autopar_search_callgraph__V_36_36, (MR_String) ")\n");
        }
