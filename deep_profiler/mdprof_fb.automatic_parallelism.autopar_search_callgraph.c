  ...
  MR_Word * Messages_14)
{
  ...
  if (succeeded)
  {
    ...
    if (succeeded)
    {
      ...
      Parallelism_83 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_Callee_21_21, 4))));
      succeeded = measurements__exceeded_desired_parallelism_2_p_0(Var_53, Parallelism_83);
      succeeded = !(succeeded);
      if (succeeded)
      {
        MR_Word Parallelism_18 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_Callee_21_21, 4))));
        MR_Word ChildCliquePtr_19 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_Callee_21_21, 0))));
