...
static const struct mercury_type_1 mercury_common_1[72] =
{
{
MR_COMMON(0,0),
...
MR_def_label(top_procs__find_threshold_value_predicate_4_0,3)
	...
	MR_r1 = (MR_Integer) 0;
	MR_r2 = (MR_Word) MR_TAG_COMMON(0,1,62);
	MR_proceed();
MR_def_label(top_procs__find_threshold_value_predicate_4_0,10)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Integer) 0;
	MR_r2 = (MR_Word) MR_TAG_COMMON(0,1,63);
	MR_proceed();
MR_def_label(top_procs__find_threshold_value_predicate_4_0,8)
	...
	MR_r1 = (MR_Integer) 1;
	MR_r2 = (MR_Word) MR_TAG_COMMON(0,1,64);
	MR_proceed();
MR_def_label(top_procs__find_threshold_value_predicate_4_0,15)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Integer) 1;
	MR_r2 = (MR_Word) MR_TAG_COMMON(0,1,65);
	MR_proceed();
...
MR_def_label(top_procs__find_threshold_value_predicate_4_0,20)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Integer) 0;
	MR_r2 = (MR_Word) MR_TAG_COMMON(0,1,67);
	MR_proceed();
MR_def_label(top_procs__find_threshold_value_predicate_4_0,18)
	...
	MR_r1 = (MR_Integer) 1;
	MR_r2 = (MR_Word) MR_TAG_COMMON(0,1,68);
	MR_proceed();
MR_def_label(top_procs__find_threshold_value_predicate_4_0,25)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Integer) 1;
	MR_r2 = (MR_Word) MR_TAG_COMMON(0,1,69);
	MR_proceed();
MR_def_label(top_procs__find_threshold_value_predicate_4_0,23)
	...
	MR_r1 = (MR_Integer) 1;
	MR_r2 = (MR_Word) MR_TAG_COMMON(0,1,70);
	MR_proceed();
MR_def_label(top_procs__find_threshold_value_predicate_4_0,29)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Integer) 1;
	MR_r2 = (MR_Word) MR_TAG_COMMON(0,1,71);
	MR_proceed();
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_thread_engine_base
...
MR_def_label(fn__top_procs__find_top_procs_5_0,8)
	...
	MR_tfield(0, MR_r2, 0) = (MR_Word) MR_COMMON(0,24);
...
MR_def_label(fn__top_procs__find_top_procs_5_0,32)
	...
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 0, (MR_Integer) 6);
	MR_tfield(0, MR_tempr1, 0) = (MR_Word) MR_COMMON(0,26);
