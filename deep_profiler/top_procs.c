...
MR_decl_static(top_procs__IntroducedFrom__pred__find_top_procs__120__1_4_0)
...
MR_def_label(fn__top_procs__find_top_procs_5_0,33)
	...
	MR_tfield(0, MR_tempr1, 1) = (MR_Word) MR_ENTRY_AP(top_procs__IntroducedFrom__pred__find_top_procs__120__1_4_0);
	MR_tfield(0, MR_tempr1, 2) = (MR_Integer) 3;
	MR_tfield(0, MR_tempr1, 3) = MR_sv(4);
...
MR_BEGIN_MODULE(top_procs_module81)
	MR_init_entry1(top_procs__IntroducedFrom__pred__find_top_procs__120__1_4_0);
MR_BEGIN_CODE
	...
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(top_procs__IntroducedFrom__pred__find_top_procs__120__1_4_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tempr1 = MR_r1;
	...
	MR_r2 = MR_tempr1;
	MR_r3 = MR_tempr2;
	MR_set_prof_ho_caller_proc(MR_ENTRY_AP(top_procs__IntroducedFrom__pred__find_top_procs__120__1_4_0));
	MR_np_tailcall_ent(do_call_closure_3);
	}
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
