...
MR_def_label(fn__top_procs__find_top_procs_5_0,14)
	...
	MR_tempr1 = MR_sv(6);
	MR_sv(6) = MR_r1;
	* (MR_Float *) &MR_sv(9) = MR_word_to_float(MR_tfield(1, MR_sv(1), 0));
	MR_r1 = MR_tempr1;
	MR_r2 = MR_sv(7);
	}
...
MR_def_label(fn__top_procs__find_top_procs_5_0,25)
	...
	MR_tfield(0, MR_tempr1, 4) = MR_float_to_word(MR_float_from_dword_ptr(&MR_sv(9)));
...
MR_def_label(fn__top_procs__find_top_procs_5_0,22)
	...
	MR_tempr1 = MR_sv(6);
	MR_sv(6) = MR_r1;
	* (MR_Float *) &MR_sv(9) = MR_word_to_float(MR_tfield(2, MR_sv(1), 0));
	MR_r1 = MR_tempr1;
	MR_r2 = MR_sv(7);
	}
...
MR_def_label(top_procs__threshold_value_ps_time_self_3_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_word_to_float(MR_r1) > MR_float_from_dword_ptr(&MR_sv(2)));
	MR_decr_sp_and_return(3);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_thread_engine_base
...
MR_def_label(top_procs__threshold_percent_ps_time_self_3_0,8)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	* (MR_Float *) &MR_sv(6) = ((MR_Float) 100.00000000000000 * MR_word_to_float(MR_r1));
	MR_r1 = MR_sv(4);
	MR_np_call_localret_ent(fn__float__float_1_0,
		top_procs__threshold_percent_ps_time_self_3_0_i9);
MR_def_label(top_procs__threshold_percent_ps_time_self_3_0,9)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_float_to_word((MR_float_from_dword_ptr(&MR_sv(2)) * MR_word_to_float(MR_r1)));
	MR_r1 = (MR_float_from_dword_ptr(&MR_sv(6)) > MR_word_to_float(MR_r2));
...
MR_def_label(top_procs__threshold_percent_ps_time_both_3_0,11)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_float_to_word((MR_float_from_dword_ptr(&MR_sv(2)) * MR_word_to_float(MR_r1)));
	MR_r1 = (MR_float_from_dword_ptr(&MR_sv(7)) > MR_word_to_float(MR_r2));
