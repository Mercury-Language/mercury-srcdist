...
MR_def_label(fn__top_procs__compare_ps_time_both_percall_3_0,11)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_sv(4);
	MR_sv(4) = ((MR_Integer) MR_sv(5) + (MR_Integer) MR_r1);
...
MR_def_label(top_procs__threshold_percent_ps_time_self_3_0,9)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_float_to_word((MR_word_to_float(MR_sv(1)) * MR_word_to_float(MR_r1)));
	MR_r1 = (MR_word_to_float(MR_sv(3)) > MR_word_to_float(MR_r2));
	MR_decr_sp_and_return(4);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_thread_engine_base
...
MR_def_label(top_procs__threshold_percent_ps_time_both_3_0,10)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_sv(4);
	MR_sv(4) = MR_float_to_word(((MR_Float) 100.00000000000000 * MR_word_to_float(MR_r1)));
	MR_r1 = MR_r2;
	MR_np_call_localret_ent(fn__float__float_1_0,
...
MR_def_label(top_procs__threshold_percent_ps_time_both_3_0,11)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_float_to_word((MR_word_to_float(MR_sv(1)) * MR_word_to_float(MR_r1)));
	MR_r1 = (MR_word_to_float(MR_sv(4)) > MR_word_to_float(MR_r2));
