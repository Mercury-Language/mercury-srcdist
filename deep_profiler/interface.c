      ...
      case (MR_Integer) 1:
        {
          ...
          else
          {
...

            {
              ...
              MR_hl_field(MR_mktag(0), TypeInfo__60_60, 0) = ((MR_Box) (&mercury__io__io__type_ctor_info_read_result_1));
              MR_hl_field(MR_mktag(0), TypeInfo__60_60, 1) = ((MR_Box) (TypeInfo_for_T_58));
            }
            mercury__io__write_4_p_0(TypeInfo__60_60, DebugStream_18, ((MR_Box) (ReadRes_12)));
