...
MR_decl_label8(interface__recv_string_5_0, 2,5,7,8,11,6,13,39)
MR_decl_label8(interface__recv_string_5_0, 15,16,20,21,18,23,4,30)
MR_decl_label1(interface__recv_string_5_0, 35)
MR_decl_label8(interface__recv_term_5_0, 2,5,9,14,16,6,19,46)
MR_decl_label8(interface__recv_term_5_0, 21,22,26,27,24,29,4,36)
MR_decl_label1(interface__recv_term_5_0, 41)
MR_decl_label8(interface__send_string_5_0, 2,5,4,7,12,3,16,19)
MR_decl_label4(interface__send_string_5_0, 18,21,26,14)
MR_decl_label8(interface__send_term_5_0, 2,5,6,4,8,13,3,17)
MR_decl_label6(interface__send_term_5_0, 20,21,19,23,28,15)
...
{
{
MR_string_const("/tmp/.send_term", 15)
},
{
MR_string_const("/tmp/.send_string", 17)
},
{
MR_string_const("/tmp/.recv_term", 15)
},
{
MR_string_const("/tmp/.recv_string", 17)
},
};
...
MR_BEGIN_MODULE(interface_module9)
	...
	MR_init_label8(interface__send_term_5_0,2,5,6,4,8,13,3,17)
	MR_init_label6(interface__send_term_5_0,20,21,19,23,28,15)
MR_BEGIN_CODE
...
MR_def_label(interface__send_term_5_0,8)
	...
	MR_r1 = (MR_Word) MR_string_const("send_term: couldn\'t open pipe %s: %s", 36);
	}
	MR_np_call_localret_ent(string__format_3_0,
		interface__send_term_5_0_i13);
...
MR_def_label(interface__send_term_5_0,3)
	...
	if (MR_INT_EQ(MR_sv(2),0)) {
		MR_GOTO_LAB(interface__send_term_5_0_i15);
	}
	MR_sv(1) = (MR_Word) MR_string_const("/tmp/.send_term", 15);
	MR_r1 = MR_sv(1);
	MR_np_call_localret_ent(io__open_output_4_0,
		interface__send_term_5_0_i17);
MR_def_label(interface__send_term_5_0,17)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_r1,0)) {
		MR_GOTO_LAB(interface__send_term_5_0_i19);
	}
	MR_sv(1) = MR_ctfield(0, MR_r1, 0);
	MR_r1 = MR_sv(4);
	MR_r2 = MR_sv(1);
	MR_r3 = MR_sv(3);
	MR_np_call_localret_ent(io__write_4_0,
		interface__send_term_5_0_i20);
MR_def_label(interface__send_term_5_0,20)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(1);
	MR_r2 = (MR_Word) MR_string_const(".\n", 2);
	MR_np_call_localret_ent(io__write_string_4_0,
...
MR_def_label(interface__send_term_5_0,23)
	...
	MR_tag_alloc_heap(MR_tempr3, 1, (MR_Integer) 2);
	MR_r2 = MR_tempr3;
	MR_tfield(1, MR_tempr3, 0) = (MR_Word) MR_TAG_COMMON(2,0,0);
	MR_tfield(1, MR_tempr3, 1) = MR_tempr2;
	MR_r1 = (MR_Word) MR_string_const("send_term: couldn\'t open debug file %s: %s", 42);
	}
	MR_np_call_localret_ent(string__format_3_0,
		interface__send_term_5_0_i28);
MR_def_label(interface__send_term_5_0,28)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_succip_word = MR_sv(5);
	MR_decr_sp(5);
...
MR_BEGIN_MODULE(interface_module10)
	...
	MR_init_label8(interface__send_string_5_0,2,5,4,7,12,3,16,19)
	MR_init_label4(interface__send_string_5_0,18,21,26,14)
MR_BEGIN_CODE
...
MR_def_label(interface__send_string_5_0,7)
	...
	MR_np_call_localret_ent(string__format_3_0,
		interface__send_string_5_0_i12);
...
MR_def_label(interface__send_string_5_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_EQ(MR_sv(2),0)) {
		MR_GOTO_LAB(interface__send_string_5_0_i14);
	}
	MR_sv(1) = (MR_Word) MR_string_const("/tmp/.send_string", 17);
	MR_r1 = MR_sv(1);
	MR_np_call_localret_ent(io__open_output_4_0,
		interface__send_string_5_0_i16);
MR_def_label(interface__send_string_5_0,16)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_r1,0)) {
		MR_GOTO_LAB(interface__send_string_5_0_i18);
	}
	MR_sv(1) = MR_ctfield(0, MR_r1, 0);
	MR_r1 = MR_sv(1);
	MR_r2 = MR_sv(3);
...
MR_def_label(interface__send_string_5_0,19)
	...
	MR_decr_sp(4);
	MR_np_tailcall_ent(io__close_output_3_0);
MR_def_label(interface__send_string_5_0,18)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_ctfield(1, MR_r1, 0);
	MR_np_call_localret_ent(io__error_message_2_0,
...
MR_def_label(interface__send_string_5_0,21)
	...
	MR_tag_alloc_heap(MR_tempr3, 1, (MR_Integer) 2);
	MR_r2 = MR_tempr3;
	MR_tfield(1, MR_tempr3, 0) = (MR_Word) MR_TAG_COMMON(2,0,1);
	MR_tfield(1, MR_tempr3, 1) = MR_tempr2;
	MR_r1 = (MR_Word) MR_string_const("send_term: couldn\'t open debug file %s: %s", 42);
	}
	MR_np_call_localret_ent(string__format_3_0,
		interface__send_string_5_0_i26);
MR_def_label(interface__send_string_5_0,26)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_succip_word = MR_sv(4);
	MR_decr_sp(4);
	MR_np_tailcall_ent(require__error_1_0);
...
MR_BEGIN_MODULE(interface_module11)
	...
	MR_init_label8(interface__recv_term_5_0,2,5,9,14,16,6,19,46)
	MR_init_label8(interface__recv_term_5_0,21,22,26,27,24,29,4,36)
	MR_init_label1(interface__recv_term_5_0,41)
MR_BEGIN_CODE
...
MR_def_label(interface__recv_term_5_0,5)
	...
	if ((MR_tempr1 == MR_mktag((MR_Integer) 1))) {
		MR_GOTO_LAB(interface__recv_term_5_0_i16);
	}
...
MR_def_label(interface__recv_term_5_0,9)
	...
	MR_tag_alloc_heap(MR_tempr2, 2, (MR_Integer) 1);
	MR_tfield(2, MR_tempr2, 0) = MR_ctfield(2, MR_tempr4, 0);
	MR_tag_alloc_heap(MR_tempr3, 1, (MR_Integer) 2);
	MR_tfield(1, MR_tempr3, 0) = MR_tempr2;
	MR_tfield(1, MR_tempr3, 1) = (MR_Word) MR_tbmkword(0, 0);
	MR_tag_alloc_heap(MR_tempr2, 1, (MR_Integer) 2);
	...
	MR_sv(3) = MR_tempr4;
	MR_r1 = (MR_Word) MR_string_const("recv_term: read failed at line %d: %s", 37);
	MR_r2 = MR_tempr2;
	}
	MR_np_call_localret_ent(string__format_3_0,
		interface__recv_term_5_0_i14);
...
MR_def_label(interface__recv_term_5_0,19)
	...
	if (MR_INT_NE(MR_sv(2),0)) {
		MR_GOTO_LAB(interface__recv_term_5_0_i21);
	}
MR_def_label(interface__recv_term_5_0,46)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(1);
	MR_decr_sp_and_return(5);
MR_def_label(interface__recv_term_5_0,21)
	...
	MR_r1 = MR_sv(2);
	MR_np_call_localret_ent(io__open_output_4_0,
		interface__recv_term_5_0_i22);
MR_def_label(interface__recv_term_5_0,22)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_r1,0)) {
		MR_GOTO_LAB(interface__recv_term_5_0_i24);
	}
	{
	MR_Word MR_tempr1;
...
MR_def_label(interface__recv_term_5_0,26)
	...
	MR_r2 = (MR_Word) MR_string_const(".\n", 2);
	MR_np_call_localret_ent(io__write_string_4_0,
		interface__recv_term_5_0_i27);
MR_def_label(interface__recv_term_5_0,27)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(2);
	MR_np_call_localret_ent(io__close_output_3_0,
		interface__recv_term_5_0_i46);
MR_def_label(interface__recv_term_5_0,24)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_ctfield(1, MR_r1, 0);
	MR_np_call_localret_ent(io__error_message_2_0,
...
MR_def_label(interface__recv_term_5_0,29)
	...
	MR_tfield(1, MR_tempr3, 1) = MR_tempr2;
	MR_r1 = (MR_Word) MR_string_const("recv_term: couldn\'t open debug file %s: %s", 42);
	}
	MR_np_call_localret_ent(string__format_3_0,
...
MR_def_label(interface__recv_term_5_0,36)
	...
	MR_tfield(1, MR_tempr4, 0) = MR_tempr1;
	MR_tfield(1, MR_tempr4, 1) = MR_tempr3;
	MR_r1 = (MR_Word) MR_string_const("recv_term: couldn\'t open pipe %s: %s", 36);
	}
	MR_np_call_localret_ent(string__format_3_0,
		interface__recv_term_5_0_i41);
...
MR_BEGIN_MODULE(interface_module12)
	...
	MR_init_label8(interface__recv_string_5_0,2,5,7,8,11,6,13,39)
	MR_init_label8(interface__recv_string_5_0,15,16,20,21,18,23,4,30)
	MR_init_label1(interface__recv_string_5_0,35)
MR_BEGIN_CODE
...
MR_def_label(interface__recv_string_5_0,8)
	...
	MR_tfield(1, MR_tempr2, 0) = MR_tempr1;
	MR_tfield(1, MR_tempr2, 1) = (MR_Word) MR_tbmkword(0, 0);
	MR_r1 = (MR_Word) MR_string_const("recv_string: read failed: %s", 28);
	}
	MR_np_call_localret_ent(string__format_3_0,
...
MR_def_label(interface__recv_string_5_0,13)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_sv(2),0)) {
		MR_GOTO_LAB(interface__recv_string_5_0_i15);
	}
MR_def_label(interface__recv_string_5_0,39)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(1);
	MR_decr_sp_and_return(4);
...
MR_def_label(interface__recv_string_5_0,16)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_r1,0)) {
		MR_GOTO_LAB(interface__recv_string_5_0_i18);
	}
	MR_sv(2) = MR_ctfield(0, MR_r1, 0);
	...
	MR_r3 = MR_sv(3);
	MR_np_call_localret_ent(io__write_4_0,
		interface__recv_string_5_0_i20);
MR_def_label(interface__recv_string_5_0,20)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(2);
	MR_r2 = (MR_Word) MR_string_const(".\n", 2);
	MR_np_call_localret_ent(io__write_string_4_0,
...
MR_def_label(interface__recv_string_5_0,21)
	...
	MR_r1 = MR_sv(2);
	MR_np_call_localret_ent(io__close_output_3_0,
		interface__recv_string_5_0_i39);
...
MR_def_label(interface__recv_string_5_0,23)
	...
	MR_tfield(1, MR_tempr3, 1) = MR_tempr2;
	MR_r1 = (MR_Word) MR_string_const("recv_string: couldn\'t open debug file %s: %s", 44);
	}
	MR_np_call_localret_ent(string__format_3_0,
		interface__recv_string_5_0_i35);
MR_def_label(interface__recv_string_5_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_ctfield(1, MR_r1, 0);
	MR_np_call_localret_ent(io__error_message_2_0,
		interface__recv_string_5_0_i30);
MR_def_label(interface__recv_string_5_0,30)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2, MR_tempr3, MR_tempr4;
	MR_tag_alloc_heap(MR_tempr1, 2, (MR_Integer) 1);
	...
	MR_tfield(1, MR_tempr4, 0) = MR_tempr1;
	MR_tfield(1, MR_tempr4, 1) = MR_tempr3;
	MR_r1 = (MR_Word) MR_string_const("recv_string: couldn\'t open pipe %s: %s", 38);
	}
	MR_np_call_localret_ent(string__format_3_0,
		interface__recv_string_5_0_i35);
MR_def_label(interface__recv_string_5_0,35)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_succip_word = MR_sv(4);
	MR_decr_sp(4);
	MR_np_tailcall_ent(require__error_1_0);
