...
MR_decl_label8(interface__recv_string_5_0, 2,5,7,8,9,6,11,33)
MR_decl_label8(interface__recv_string_5_0, 13,14,18,19,16,21,22,23)
MR_decl_label5(interface__recv_string_5_0, 4,26,27,28,29)
MR_decl_label8(interface__recv_term_5_0, 2,5,15,9,10,11,12,13)
MR_decl_label8(interface__recv_term_5_0, 6,18,41,20,21,25,26,23)
MR_decl_label8(interface__recv_term_5_0, 28,29,30,4,33,34,35,36)
MR_decl_label8(interface__send_string_5_0, 2,5,4,7,8,9,10,3)
MR_decl_label8(interface__send_string_5_0, 14,17,16,19,20,21,22,12)
MR_decl_label8(interface__send_term_5_0, 2,5,6,4,8,9,10,11)
MR_decl_label8(interface__send_term_5_0, 3,15,18,19,17,21,22,23)
MR_decl_label2(interface__send_term_5_0, 24,13)
...
MR_BEGIN_MODULE(interface_module9)
	...
	MR_init_label8(interface__send_term_5_0,2,5,6,4,8,9,10,11)
	MR_init_label8(interface__send_term_5_0,3,15,18,19,17,21,22,23)
	MR_init_label2(interface__send_term_5_0,24,13)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(interface_module10)
	...
	MR_init_label8(interface__send_string_5_0,2,5,4,7,8,9,10,3)
	MR_init_label8(interface__send_string_5_0,14,17,16,19,20,21,22,12)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(interface_module11)
	...
	MR_init_label8(interface__recv_term_5_0,2,5,15,9,10,11,12,13)
	MR_init_label8(interface__recv_term_5_0,6,18,41,20,21,25,26,23)
	MR_init_label8(interface__recv_term_5_0,28,29,30,4,33,34,35,36)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(interface_module12)
	...
	MR_init_label8(interface__recv_string_5_0,2,5,7,8,9,6,11,33)
	MR_init_label8(interface__recv_string_5_0,13,14,18,19,16,21,22,23)
	MR_init_label5(interface__recv_string_5_0,4,26,27,28,29)
MR_BEGIN_CODE
