    ...
    if (((MR_tag((MR_Word) interface__FromPipeRes_10)) == (MR_mktag((MR_Integer) 1))))
      {
        ...
        {
          interface__V_65_65 = mercury__string__f_43_43_2_f_0((MR_String) ": ", interface__FromPipeErrorMsg_24);
        }
        {
          interface__V_66_66 = mercury__string__f_43_43_2_f_0(interface__FromPipeName_6, interface__V_65_65);
        }
        {
          interface__FromPipeMsg_25 = mercury__string__f_43_43_2_f_0((MR_String) "couldn\'t open pipe ", interface__V_66_66);
        }
        {
              ...
              if (((MR_tag((MR_Word) interface__DebugRes_18)) == (MR_mktag((MR_Integer) 1))))
                {
                  ...
                  {
                    interface__V_61_61 = mercury__string__f_43_43_2_f_0((MR_String) ": ", interface__DebugErrorMsg_21);
                  }
                  {
                    interface__V_62_62 = mercury__string__f_43_43_2_f_0((MR_String) "/tmp/.recv_string", interface__V_61_61);
                  }
                  {
                    interface__DebugMsg_22 = mercury__string__f_43_43_2_f_0((MR_String) "couldn\'t open debug file ", interface__V_62_62);
                  }
                  {
    ...
    if (((MR_tag((MR_Word) interface__FromPipeRes_10)) == (MR_mktag((MR_Integer) 1))))
      {
        ...
        MR_String interface__V_82_82;

        {
          mercury__io__error_message_2_p_0(interface__FromPipeError_22, &interface__FromPipeErrorMsg_23);
        }
        {
          interface__V_81_81 = mercury__string__f_43_43_2_f_0((MR_String) ": ", interface__FromPipeErrorMsg_23);
        }
        {
          interface__V_82_82 = mercury__string__f_43_43_2_f_0(interface__FromPipeName_6, interface__V_81_81);
        }
        {
          interface__FromPipeMsg_24 = mercury__string__f_43_43_2_f_0((MR_String) "couldn\'t open pipe ", interface__V_82_82);
        }
        {
          ...
          case (MR_Integer) 2:
            {
              ...
              {
                mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) &interface_scalar_common_2[0], interface__ReadErrorLineNumber_14, &interface__V_67_67);
              }
              {
                interface__V_74_74 = mercury__string__f_43_43_2_f_0(interface__V_67_67, interface__V_66_66);
              }
              {
                interface__ReadMsg_15 = mercury__string__f_43_43_2_f_0((MR_String) "read failed at line ", interface__V_74_74);
              }
              {
              ...
              if (((MR_tag((MR_Word) interface__DebugRes_17)) == (MR_mktag((MR_Integer) 1))))
                {
                  ...
                  MR_String interface__V_78_78;

                  {
                    mercury__io__error_message_2_p_0(interface__DebugError_19, &interface__DebugErrorMsg_20);
                  }
                  {
                    interface__V_77_77 = mercury__string__f_43_43_2_f_0((MR_String) ": ", interface__DebugErrorMsg_20);
                  }
                  {
                    interface__V_78_78 = mercury__string__f_43_43_2_f_0((MR_String) "/tmp/.recv_term", interface__V_77_77);
                  }
                  {
                    interface__DebugMsg_21 = mercury__string__f_43_43_2_f_0((MR_String) "couldn\'t open debug file ", interface__V_78_78);
                  }
                  {
    ...
    if (((MR_tag((MR_Word) interface__ToPipeRes_10)) == (MR_mktag((MR_Integer) 1))))
      {
        ...
        {
          interface__ToPipeMsg_14 = mercury__string__f_43_43_2_f_0((MR_String) "couldn\'t open pipe ", interface__V_47_47);
        }
        {
          ...
          if (((MR_tag((MR_Word) interface__DebugRes_16)) == (MR_mktag((MR_Integer) 1))))
            {
              ...
              {
                interface__V_50_50 = mercury__string__f_43_43_2_f_0((MR_String) ": ", interface__DebugErrorMsg_19);
              }
              {
                interface__V_51_51 = mercury__string__f_43_43_2_f_0((MR_String) "/tmp/.send_string", interface__V_50_50);
              }
              {
                interface__DebugMsg_20 = mercury__string__f_43_43_2_f_0((MR_String) "couldn\'t open debug file ", interface__V_51_51);
              }
              {
    ...
    if (((MR_tag((MR_Word) interface__ToPipeRes_10)) == (MR_mktag((MR_Integer) 1))))
      {
        ...
        {
          interface__ToPipeMsg_14 = mercury__string__f_43_43_2_f_0((MR_String) "couldn\'t open pipe ", interface__V_52_52);
        }
        {
          ...
          if (((MR_tag((MR_Word) interface__DebugRes_16)) == (MR_mktag((MR_Integer) 1))))
            {
              ...
              MR_String interface__V_56_56;

              {
                mercury__io__error_message_2_p_0(interface__DebugError_18, &interface__DebugErrorMsg_19);
              }
              {
                interface__V_55_55 = mercury__string__f_43_43_2_f_0((MR_String) ": ", interface__DebugErrorMsg_19);
              }
              {
                interface__V_56_56 = mercury__string__f_43_43_2_f_0((MR_String) "/tmp/.send_term", interface__V_55_55);
              }
              {
                interface__DebugMsg_20 = mercury__string__f_43_43_2_f_0((MR_String) "couldn\'t open debug file ", interface__V_56_56);
              }
              {
