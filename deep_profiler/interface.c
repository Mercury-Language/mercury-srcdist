  ...
  MR_String * Resp_8)
{
  ...
  {
    MR_Word FromPipeError_23 = ((MR_Word) ((MR_hl_field(1, FromPipeRes_10, 0))));
  ...
  {
    MR_Word FromStream_11 = ((MR_Word) ((MR_hl_field(0, FromPipeRes_10, 0))));
    MR_Word ReadRes_12;

    mercury__io__read_file_as_string_4_p_0(FromStream_11, &ReadRes_12);
    if (((MR_tag((MR_Word) ReadRes_12)) == (MR_Integer) 1))
    {
      MR_Word ReadError_14 = ((MR_Word) ((MR_hl_field(1, ReadRes_12, 1))));
      ...
      *Resp_8 = ((MR_String) ((MR_hl_field(0, ReadRes_12, 0))));
      ...
      case (MR_Integer) 1:
        {
          ...
          {
            MR_Word DebugError_20 = ((MR_Word) ((MR_hl_field(1, DebugRes_18, 0))));
          ...
          {
            MR_Word DebugStream_19 = ((MR_Word) ((MR_hl_field(0, DebugRes_18, 0))));
  ...
  MR_Box * Resp_8)
{
  ...
  if (((MR_tag((MR_Word) FromPipeRes_10)) == (MR_Integer) 1))
  {
    MR_Word FromPipeError_22 = ((MR_Word) ((MR_hl_field(1, FromPipeRes_10, 0))));
  ...
  else
  {
    ...
    switch (MR_tag((MR_Word) ReadRes_12)) {
      ...
      case (MR_Integer) 0:
        ...
        break;
      case (MR_Integer) 1:
        *Resp_8 = (MR_hl_field(1, ReadRes_12, 0));
        break;
      case (MR_Integer) 2:
        {
          MR_String ReadErrorMsg_13 = ((MR_String) ((MR_hl_field(2, ReadRes_12, 0))));
          MR_Integer ReadErrorLineNumber_14 = ((MR_Integer) ((MR_hl_field(2, ReadRes_12, 1))));
      ...
      case (MR_Integer) 1:
        {
          ...
          {
            MR_Word DebugError_19 = ((MR_Word) ((MR_hl_field(1, DebugRes_17, 0))));
          ...
          else
          {
            ...
            MR_Word DebugStream_18 = ((MR_Word) ((MR_hl_field(0, DebugRes_17, 0))));
  ...
  MR_String Data_8)
{
  ...
  {
    MR_Word ToPipeError_12 = ((MR_Word) ((MR_hl_field(1, ToPipeRes_10, 0))));
  ...
  {
    MR_Word ToStream_11 = ((MR_Word) ((MR_hl_field(0, ToPipeRes_10, 0))));
    ...
    case (MR_Integer) 1:
      {
        ...
        {
          MR_Word DebugError_18 = ((MR_Word) ((MR_hl_field(1, DebugRes_16, 0))));
        ...
        {
          MR_Word DebugStream_17 = ((MR_Word) ((MR_hl_field(0, DebugRes_16, 0))));
  ...
  MR_Word HeadVar__1_1)
{
  ...
  {
    MR_Char First_3 = ((MR_Char) (MR_Word) (MR_hl_field(1, HeadVar__1_1, 0)));
