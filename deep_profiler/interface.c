...
{
  {
    ...
    if (((MR_tag((MR_Word) FromPipeRes_10)) == (MR_mktag((MR_Integer) 1))))
    {
      ...
      Var_65 = mercury__string__f_43_43_2_f_0((MR_String) ": ", FromPipeErrorMsg_24);
      Var_66 = mercury__string__f_43_43_2_f_0(FromPipeName_6, Var_65);
      FromPipeMsg_25 = mercury__string__f_43_43_2_f_0((MR_String) "couldn\'t open pipe ", Var_66);
      {
        mercury__require__unexpected_3_p_0((MR_String) "interface", (MR_String) "predicate \140interface.recv_string\'/5", FromPipeMsg_25);
        return;
      }
    }
    else
    {
      ...
      if (((MR_tag((MR_Word) ReadRes_12)) == (MR_mktag((MR_Integer) 1))))
      {
        MR_Word ReadError_14 = ((MR_Word) (MR_hl_field(MR_mktag(1), ReadRes_12, (MR_Integer) 1)));
        MR_String ReadErrorMsg_15;
        MR_String ReadMsg_16;
        MR_String Var_13 = ((MR_String) (MR_hl_field(MR_mktag(1), ReadRes_12, (MR_Integer) 0)));
        ...
        {
          mercury__require__unexpected_3_p_0((MR_String) "interface", (MR_String) "predicate \140interface.recv_string\'/5", ReadMsg_16);
          return;
        }
      }
      else
        ...
        case (MR_Integer) 1:
          {
            ...
            if (((MR_tag((MR_Word) DebugRes_18)) == (MR_mktag((MR_Integer) 1))))
            {
              ...
              Var_61 = mercury__string__f_43_43_2_f_0((MR_String) ": ", DebugErrorMsg_21);
              Var_62 = mercury__string__f_43_43_2_f_0((MR_String) "/tmp/.recv_string", Var_61);
              DebugMsg_22 = mercury__string__f_43_43_2_f_0((MR_String) "couldn\'t open debug file ", Var_62);
              {
                mercury__require__unexpected_3_p_0((MR_String) "interface", (MR_String) "predicate \140interface.recv_string\'/5", DebugMsg_22);
                return;
              }
            }
            else
...
{
  {
    ...
    if (((MR_tag((MR_Word) FromPipeRes_10)) == (MR_mktag((MR_Integer) 1))))
    {
      ...
      Var_81 = mercury__string__f_43_43_2_f_0((MR_String) ": ", FromPipeErrorMsg_23);
      Var_82 = mercury__string__f_43_43_2_f_0(FromPipeName_6, Var_81);
      FromPipeMsg_24 = mercury__string__f_43_43_2_f_0((MR_String) "couldn\'t open pipe ", Var_82);
      {
        mercury__require__unexpected_3_p_0((MR_String) "interface", (MR_String) "predicate \140interface.recv_term\'/5", FromPipeMsg_24);
        return;
      }
    }
    else
    {
      ...
      mercury__io__read_4_p_0(TypeInfo_for_T_62, FromStream_11, &ReadRes_12);
        ...
        case (MR_Integer) 2:
          {
            ...
            Var_66 = mercury__string__f_43_43_2_f_0((MR_String) ": ", ReadErrorMsg_13);
            mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) &interface_scalar_common_2[0], ReadErrorLineNumber_14, &Var_67);
            Var_74 = mercury__string__f_43_43_2_f_0(Var_67, Var_66);
            ReadMsg_15 = mercury__string__f_43_43_2_f_0((MR_String) "read failed at line ", Var_74);
            {
              mercury__require__unexpected_3_p_0((MR_String) "interface", (MR_String) "predicate \140interface.recv_term\'/5", ReadMsg_15);
              return;
            }
          }
          break;
        ...
        case (MR_Integer) 1:
          {
            ...
            if (((MR_tag((MR_Word) DebugRes_17)) == (MR_mktag((MR_Integer) 1))))
            {
              ...
              Var_77 = mercury__string__f_43_43_2_f_0((MR_String) ": ", DebugErrorMsg_20);
              Var_78 = mercury__string__f_43_43_2_f_0((MR_String) "/tmp/.recv_term", Var_77);
              DebugMsg_21 = mercury__string__f_43_43_2_f_0((MR_String) "couldn\'t open debug file ", Var_78);
              {
                mercury__require__unexpected_3_p_0((MR_String) "interface", (MR_String) "predicate \140interface.recv_term\'/5", DebugMsg_21);
                return;
              }
            }
            else
            {
...

              {
                ...
                MR_hl_field(MR_mktag(0), TypeInfo_64_64, 0) = ((MR_Box) (&mercury__io__io__type_ctor_info_read_result_1));
                MR_hl_field(MR_mktag(0), TypeInfo_64_64, 1) = ((MR_Box) (TypeInfo_for_T_62));
              }
              mercury__io__write_4_p_0(TypeInfo_64_64, DebugStream_18, ((MR_Box) (ReadRes_12)));
...
{
  {
    ...
    if (((MR_tag((MR_Word) ToPipeRes_10)) == (MR_mktag((MR_Integer) 1))))
    {
      ...
      Var_46 = mercury__string__f_43_43_2_f_0((MR_String) ": ", ToPipeErrorMsg_13);
      Var_47 = mercury__string__f_43_43_2_f_0(ToPipeName_6, Var_46);
      ToPipeMsg_14 = mercury__string__f_43_43_2_f_0((MR_String) "couldn\'t open pipe ", Var_47);
      {
        mercury__require__unexpected_3_p_0((MR_String) "interface", (MR_String) "predicate \140interface.send_string\'/5", ToPipeMsg_14);
        return;
      }
    }
    else
      ...
      case (MR_Integer) 1:
        {
          ...
          if (((MR_tag((MR_Word) DebugRes_16)) == (MR_mktag((MR_Integer) 1))))
          {
            ...
            Var_50 = mercury__string__f_43_43_2_f_0((MR_String) ": ", DebugErrorMsg_19);
            Var_51 = mercury__string__f_43_43_2_f_0((MR_String) "/tmp/.send_string", Var_50);
            DebugMsg_20 = mercury__string__f_43_43_2_f_0((MR_String) "couldn\'t open debug file ", Var_51);
            {
              mercury__require__unexpected_3_p_0((MR_String) "interface", (MR_String) "predicate \140interface.send_string\'/5", DebugMsg_20);
              return;
            }
          }
          else
...
{
  {
    ...
    if (((MR_tag((MR_Word) ToPipeRes_10)) == (MR_mktag((MR_Integer) 1))))
    {
      ...
      mercury__io__error_message_2_p_0(ToPipeError_12, &ToPipeErrorMsg_13);
      Var_51 = mercury__string__f_43_43_2_f_0((MR_String) ": ", ToPipeErrorMsg_13);
      Var_52 = mercury__string__f_43_43_2_f_0(ToPipeName_6, Var_51);
      ToPipeMsg_14 = mercury__string__f_43_43_2_f_0((MR_String) "couldn\'t open pipe ", Var_52);
      {
        mercury__require__unexpected_3_p_0((MR_String) "interface", (MR_String) "predicate \140interface.send_term\'/5", ToPipeMsg_14);
        return;
      }
    }
    else
    {
      ...
      mercury__io__write_4_p_0(TypeInfo_for_T_49, ToStream_11, Data_8);
      ...
      case (MR_Integer) 1:
        {
          ...
          if (((MR_tag((MR_Word) DebugRes_16)) == (MR_mktag((MR_Integer) 1))))
          {
            ...
            mercury__io__error_message_2_p_0(DebugError_18, &DebugErrorMsg_19);
            Var_55 = mercury__string__f_43_43_2_f_0((MR_String) ": ", DebugErrorMsg_19);
            Var_56 = mercury__string__f_43_43_2_f_0((MR_String) "/tmp/.send_term", Var_55);
            DebugMsg_20 = mercury__string__f_43_43_2_f_0((MR_String) "couldn\'t open debug file ", Var_56);
            {
              mercury__require__unexpected_3_p_0((MR_String) "interface", (MR_String) "predicate \140interface.send_term\'/5", DebugMsg_20);
              return;
            }
          }
          else
          {
            ...
            mercury__io__write_4_p_0(TypeInfo_for_T_49, DebugStream_17, Data_8);
