...
MR_decl_label10(interface__recv_string_5_0, 2,5,7,8,9,6,11,32,13,14)
MR_decl_label10(interface__recv_string_5_0, 17,18,16,20,21,22,4,25,26,27)
MR_decl_label1(interface__recv_string_5_0, 28)
MR_decl_label10(interface__recv_term_5_0, 2,5,7,8,10,11,12,13,6,15)
MR_decl_label10(interface__recv_term_5_0, 38,17,18,22,23,20,25,26,27,4)
MR_decl_label4(interface__recv_term_5_0, 30,31,32,33)
...
MR_def_label(fn__interface__filename_mangle_2_1_0,16)
	...
	MR_tfield(1, MR_r2, 0) = (MR_Integer) 46;
...
MR_def_label(fn__interface__filename_mangle_2_1_0,4)
	...
	MR_tag_alloc_heap(MR_r2, 1, (MR_Integer) 2);
	MR_tfield(1, MR_r2, 0) = (MR_Integer) 58;
	MR_tfield(1, MR_r2, 1) = MR_r1;
	MR_tag_alloc_heap(MR_r1, 1, (MR_Integer) 2);
	MR_tfield(1, MR_r1, 0) = (MR_Integer) 58;
	MR_tfield(1, MR_r1, 1) = MR_r2;
...
MR_def_label(interface__send_term_5_0,3)
	...
	MR_sv(3) = (MR_Word) MR_string_const("/tmp/.send_term", 15);
	MR_r1 = MR_sv(3);
	MR_np_call_localret_ent(io__open_output_4_0,
...
MR_def_label(interface__send_string_5_0,3)
	...
	MR_sv(3) = (MR_Word) MR_string_const("/tmp/.send_string", 17);
	MR_r1 = MR_sv(3);
	MR_np_call_localret_ent(io__open_output_4_0,
...
MR_BEGIN_MODULE(interface_module11)
	...
	MR_init_label10(interface__recv_term_5_0,2,5,7,8,10,11,12,13,6,15)
	MR_init_label10(interface__recv_term_5_0,38,17,18,22,23,20,25,26,27,4)
	MR_init_label4(interface__recv_term_5_0,30,31,32,33)
MR_BEGIN_CODE
...
MR_def_label(interface__recv_term_5_0,5)
	...
	if (MR_PTAG_TESTR(MR_r1,1)) {
		MR_GOTO_LAB(interface__recv_term_5_0_i7);
	}
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_sv(1);
...
MR_def_label(interface__recv_term_5_0,7)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
...
MR_def_label(interface__recv_term_5_0,38)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(1);
	MR_decr_sp_and_return(6);
MR_def_label(interface__recv_term_5_0,17)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(4) = (MR_Word) MR_string_const("/tmp/.recv_term", 15);
	MR_r1 = MR_sv(4);
	MR_np_call_localret_ent(io__open_output_4_0,
...
MR_def_label(interface__recv_term_5_0,22)
	...
	MR_r2 = (MR_Word) MR_string_const(".\n", 2);
	MR_np_call_localret_ent(io__write_string_4_0,
		interface__recv_term_5_0_i23);
MR_def_label(interface__recv_term_5_0,23)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(4);
	MR_np_call_localret_ent(io__close_output_3_0,
		interface__recv_term_5_0_i38);
...
MR_def_label(interface__recv_term_5_0,30)
	...
	MR_np_call_localret_ent(fn__f_115_116_114_105_110_103_95_95_43_43_2_0,
		interface__recv_term_5_0_i31);
MR_def_label(interface__recv_term_5_0,31)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
	...
	MR_np_call_localret_ent(fn__f_115_116_114_105_110_103_95_95_43_43_2_0,
		interface__recv_term_5_0_i32);
MR_def_label(interface__recv_term_5_0,32)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
...
MR_BEGIN_MODULE(interface_module12)
	...
	MR_init_label10(interface__recv_string_5_0,2,5,7,8,9,6,11,32,13,14)
	MR_init_label10(interface__recv_string_5_0,17,18,16,20,21,22,4,25,26,27)
	MR_init_label1(interface__recv_string_5_0,28)
MR_BEGIN_CODE
...
MR_def_label(interface__recv_string_5_0,32)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(1);
	MR_decr_sp_and_return(4);
MR_def_label(interface__recv_string_5_0,13)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(3) = (MR_Word) MR_string_const("/tmp/.recv_string", 17);
	MR_r1 = MR_sv(3);
	MR_np_call_localret_ent(io__open_output_4_0,
...
MR_def_label(interface__recv_string_5_0,18)
	...
	MR_r1 = MR_sv(3);
	MR_np_call_localret_ent(io__close_output_3_0,
		interface__recv_string_5_0_i32);
...
void mercury__interface__init_threadscope_string_table(void);
#endif
...
void mercury__interface__write_out_proc_statics(FILE *deep_fp, FILE *procrep_fp)
{
	MR_write_out_module_proc_reps_start(procrep_fp, &mercury_data__module_layout__interface);
