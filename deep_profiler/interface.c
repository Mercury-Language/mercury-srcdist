...
MR_decl_label8(interface__recv_string_5_0, 2,5,7,6,9,23,11,12)
MR_decl_label4(interface__recv_string_5_0, 16,17,14,4)
MR_decl_label8(interface__recv_term_5_0, 2,5,9,11,6,14,29,16)
MR_decl_label5(interface__recv_term_5_0, 17,21,22,19,4)
...
MR_BEGIN_MODULE(interface_module11)
	...
	MR_init_label8(interface__recv_term_5_0,2,5,9,11,6,14,29,16)
	MR_init_label5(interface__recv_term_5_0,17,21,22,19,4)
MR_BEGIN_CODE
...
MR_def_label(interface__recv_term_5_0,5)
	...
	if ((MR_tempr1 == MR_mktag((MR_Integer) 1))) {
		MR_GOTO_LAB(interface__recv_term_5_0_i11);
	}
...
MR_def_label(interface__recv_term_5_0,17)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_r1,0)) {
		MR_GOTO_LAB(interface__recv_term_5_0_i19);
	}
	{
	MR_Word MR_tempr1;
...
MR_BEGIN_MODULE(interface_module12)
	...
	MR_init_label8(interface__recv_string_5_0,2,5,7,6,9,23,11,12)
	MR_init_label4(interface__recv_string_5_0,16,17,14,4)
MR_BEGIN_CODE
