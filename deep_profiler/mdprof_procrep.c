...
{
  {
    ...
    TypeCtorInfo_59_59 = (MR_Word) &mdprof_procrep__mdprof_procrep__type_ctor_info_option_0;
    mercury__getopt__process_options_4_p_0(TypeCtorInfo_59_59, (MR_Word) MR_mkword(MR_mktag(2), &mdprof_procrep_scalar_common_3[3]), Args0_5, &Args_6, &MaybeOptions_7);
    ...
    else
    {
      ...
      mercury__getopt__lookup_string_option_3_p_0(TypeCtorInfo_59_59, Options_10, ((MR_Box) ((MR_Integer) 0)), &FileName_11);
      mdbcomp__program_representation__read_prog_rep_file_4_p_0(FileName_11, &ProgRepRes_12);
      if (((MR_tag((MR_Word) ProgRepRes_12)) == (MR_mktag((MR_Integer) 1))))
      {
