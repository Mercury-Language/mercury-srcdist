    ...
    else
    {
      ...
      if ((Args_6 == (MR_Word) ((MR_Unsigned) 0U)))
      {
...

        {
          ...
          MR_hl_field(MR_mktag(0), Var_79, 0) = ((MR_Box) (&mdprof_procrep_scalar_common_4[0]));
          MR_hl_field(MR_mktag(0), Var_79, 1) = ((MR_Box) (main_2_p_0_5));
          MR_hl_field(MR_mktag(0), Var_79, 2) = ((MR_Box) ((MR_Integer) 1));
          MR_hl_field(MR_mktag(0), Var_79, 3) = ((MR_Box) (StdOut_19));
        }
      ...
      else
      {
...

        {
          ...
          MR_hl_field(MR_mktag(0), Var_80, 0) = ((MR_Box) (&mdprof_procrep_scalar_common_4[1]));
          MR_hl_field(MR_mktag(0), Var_80, 1) = ((MR_Box) (main_2_p_0_6));
          MR_hl_field(MR_mktag(0), Var_80, 2) = ((MR_Box) ((MR_Integer) 2));
          MR_hl_field(MR_mktag(0), Var_80, 3) = ((MR_Box) (StdOut_19));
          MR_hl_field(MR_mktag(0), Var_80, 4) = ((MR_Box) (ModuleReps_15));
        }
