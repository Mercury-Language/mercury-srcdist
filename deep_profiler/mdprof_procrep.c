  ...
  MR_String LambdaHeadVar__1_19)
{
  ...
  if (succeeded)
  {
    ...
    program_representation_utils__print_module_to_strings_2_p_0(ModuleRep_33, &Strings_46);
    Var_48 = mercury__cord__list_1_f_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), Strings_46);
    Var_47 = mercury__string__append_list_1_f_0(Var_48);
  ...
  MR_Word LambdaHeadVar__2_25)
{
  ...
  program_representation_utils__print_module_to_strings_2_p_0(LambdaHeadVar__2_25, &Strings_28);
  Var_30 = mercury__cord__list_1_f_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), Strings_28);
  Var_29 = mercury__string__append_list_1_f_0(Var_30);
...
main_2_p_0(void)
{
  ...
  if (((MR_tag((MR_Word) MaybeOptions_7)) == (MR_Integer) 1))
  {
    ...
    Var_80 = mercury__string__f_43_43_2_f_0(ProgName_4, (MR_String) " [-f procrepfilename] [module1, module2, ...]\n");
    Var_48 = mercury__string__f_43_43_2_f_0((MR_String) "Usage: ", Var_80);
    ...
    else
    {
      ...
      if ((Args_6 == (MR_Word) ((MR_Unsigned) 0U)))
      {
...

        {
          ...
          MR_hl_field(MR_mktag(0), Var_84, 0) = ((MR_Box) (&mdprof_procrep_scalar_common_4[0]));
          MR_hl_field(MR_mktag(0), Var_84, 1) = ((MR_Box) (main_2_p_0_5));
          MR_hl_field(MR_mktag(0), Var_84, 2) = ((MR_Box) ((MR_Integer) 1));
          MR_hl_field(MR_mktag(0), Var_84, 3) = ((MR_Box) (StdOut_19));
        }
        mercury__map__foldl_4_p_2((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&mdprof_procrep_scalar_common_1[0]), (MR_Word) (&mercury__io__io__type_ctor_info_state_0), Var_84, ModuleReps_15, ((MR_Box) ((MR_Integer) 0)), &conv4_STATE_VARIABLE_IO_21);
      }
      else
      {
        MR_Word Var_83;
...

        {
          ...
          MR_hl_field(MR_mktag(0), Var_83, 0) = ((MR_Box) (&mdprof_procrep_scalar_common_4[1]));
          MR_hl_field(MR_mktag(0), Var_83, 1) = ((MR_Box) (main_2_p_0_6));
          MR_hl_field(MR_mktag(0), Var_83, 2) = ((MR_Box) ((MR_Integer) 2));
          MR_hl_field(MR_mktag(0), Var_83, 3) = ((MR_Box) (StdOut_19));
          MR_hl_field(MR_mktag(0), Var_83, 4) = ((MR_Box) (ModuleReps_15));
        }
        mercury__list__foldl_4_p_2((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&mercury__io__io__type_ctor_info_state_0), Var_83, Args_6, ((MR_Box) ((MR_Integer) 0)), &conv5_STATE_VARIABLE_IO_21);
      }
    }
  }
}
