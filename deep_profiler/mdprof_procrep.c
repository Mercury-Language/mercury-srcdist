  ...
  MR_String LambdaHeadVar__1_19)
{
  ...
  if (succeeded)
  {
    ...
    program_representation_utils__print_module_to_strings_2_p_0(ModuleRep_33, &Strings_53);
    Var_56 = mercury__cord__list_1_f_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), Strings_53);
    Var_54 = mercury__string__append_list_1_f_0(Var_56);
    mercury__io__write_string_4_p_0(OutputStream_6, Var_54);
  }
}
  ...
  MR_Word LambdaHeadVar__2_25)
{
  ...
  program_representation_utils__print_module_to_strings_2_p_0(LambdaHeadVar__2_25, &Strings_53);
  Var_56 = mercury__cord__list_1_f_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), Strings_53);
  Var_54 = mercury__string__append_list_1_f_0(Var_56);
  mercury__io__write_string_4_p_0(OutputStream_6, Var_54);
}
