...
/* sealed */ struct mdbcomp__vector_common_type_1_0_s {
...
mdbcomp__mercury_mdbcomp_module_1_p_0(
  MR_String mdbcomp__HeadVar__1_1)
{
  {
    MR_bool mdbcomp__succeeded;
    MR_Integer mdbcomp__slot_0;
    MR_String mdbcomp__str_1;

    /* hashed string simple lookup switch */
    /* compute the hash value of the input string */
    mdbcomp__slot_0 = ((MR_hash_string4(mdbcomp__HeadVar__1_1)) & (MR_Integer) 31);
    /* hash chain loop */
    do
      {
        /* lookup the string for this hash slot */
        mdbcomp__str_1 = ((&mdbcomp_vector_common_1[0 + mdbcomp__slot_0]))->mdbcomp__vector_common_type_1_0__vct_1_f_0;
        /* did we find a match? */
        if ((((mdbcomp__str_1 != NULL)) && ((strcmp(mdbcomp__str_1, mdbcomp__HeadVar__1_1) == 0))))
          {
            /* we found a match; look up the results */
            mdbcomp__succeeded = MR_TRUE;
        ...
        else
          {
            ...
            mdbcomp__slot_0 = ((&mdbcomp_vector_common_1[0 + mdbcomp__slot_0]))->mdbcomp__vector_common_type_1_0__vct_1_f_1;
          }
      }
    while ((mdbcomp__slot_0 >= (MR_Integer) 0));
    mdbcomp__succeeded = MR_FALSE;
  label_0:;
    return mdbcomp__succeeded;
  }
}
