...
mdbcomp.program_representation.module_dep : mercury/mdbcomp_/program_representation.java
  else
...
mdbcomp.program_representation.s_date : program_representation.m
	$(MCG) $(ALL_GRADEFLAGS) $(ALL_MCGFLAGS) --target-code-only program_representation.m $(ERR_REDIRECT)
mdbcomp.program_representation.pic_s_date : program_representation.m
	$(MCG) $(ALL_GRADEFLAGS) $(ALL_MCGFLAGS) --target-code-only --pic \
		--cflags "$(GCCFLAGS_FOR_PIC)" program_representation.m $(ERR_REDIRECT)
endif # TARGET_ASM
mdbcomp.program_representation.il_date : program_representation.m
	$(MCG) $(ALL_GRADEFLAGS) $(ALL_MCGFLAGS) --il-only program_representation.m $(ERR_REDIRECT)
