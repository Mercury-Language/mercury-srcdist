  ...
  MR_ArrayPtr * STATE_VARIABLE_CallSiteStatics_20)
{
  while (MR_TRUE)
  {
    ...
    if (succeeded)
    {
      ...
      MR_Word Var_22;
      MR_Word Var_26;
      MR_ArrayPtr STATE_VARIABLE_CallSiteStatics_29_29;
      MR_Integer Var_30;
      ...
      profile__update_call_site_statics_4_p_0(CSSPtr_10, CSS_18, STATE_VARIABLE_CallSiteStatics_0_19, &STATE_VARIABLE_CallSiteStatics_29_29);
      Var_30 = (MR_Integer) ((MR_Unsigned) SlotNum_6 - (MR_Unsigned) 1);
      // direct tailcall eliminated
      ;
      next_value_of_SlotNum_6 = Var_30;
      next_value_of_STATE_VARIABLE_CallSiteStatics_0_19 = STATE_VARIABLE_CallSiteStatics_29_29;
