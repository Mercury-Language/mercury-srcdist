...
MR_def_static(startup__summarize_call_site_dynamics_2_0)
	...
	MR_sv(1) = MR_tfield(0, MR_r1, 22);
	MR_sv(2) = MR_r1;
	MR_sv(4) = MR_tfield(0, MR_r1, 5);
	MR_sv(5) = (MR_Word) MR_CTOR0_ADDR(measurements, own_prof_info);
	MR_r1 = MR_sv(5);
	MR_r2 = MR_tfield(0, MR_sv(2), 21);
	}
	MR_np_call_localret_ent(fn__array__copy_1_0,
...
MR_def_label(startup__startup_11_0,94)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_tag_alloc_heap(MR_r2, 1, (MR_Integer) 1);
	MR_tfield(1, MR_r2, 0) = MR_sv(25);
	MR_tag_alloc_heap(MR_sv(25), 1, (MR_Integer) 1);
	MR_tfield(1, MR_sv(25), 0) = MR_r2;
	MR_r1 = MR_sv(3);
	MR_GOTO_LAB(startup__startup_11_0_i85);
...
MR_def_label(startup__startup_11_0,147)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(16) = MR_r1;
	MR_sv(33) = MR_tfield(0, MR_tfield(0, MR_sv(9), 9), 3);
	MR_r1 = MR_sv(5);
	MR_r2 = (MR_Word) MR_string_const("% Done.\n", 8);
	MR_np_call_localret_ent(startup__maybe_report_msg_4_0,
...
MR_def_label(startup__startup_11_0,149)
	...
	MR_tfield(0, MR_tempr1, 27) = MR_sv(26);
	MR_tfield(0, MR_tempr1, 28) = MR_sv(25);
	MR_r1 = MR_sv(35);
...
MR_def_label(startup__startup_11_0,160)
	...
	MR_tfield(0, MR_tempr2, 6) = MR_sv(12);
	MR_tfield(0, MR_tempr2, 7) = MR_sv(8);
	...
	MR_tfield(0, MR_tempr2, 15) = MR_sv(4);
	...
	MR_tfield(0, MR_tempr2, 25) = MR_sv(13);
	MR_tfield(0, MR_tempr2, 26) = MR_tempr1;
	MR_tfield(0, MR_tempr2, 27) = MR_sv(26);
	MR_tfield(0, MR_tempr2, 28) = MR_sv(25);
	MR_r1 = MR_sv(35);
	MR_r2 = (MR_Word) MR_CTOR0_ADDR(profile, deep);
...
MR_def_label(startup__record_csd_containers_zeroed_pss_6_0,2)
	...
	MR_sv(3) = (MR_Word) MR_TAG_COMMON(0,0,29);
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
