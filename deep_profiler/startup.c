  ...
  MR_Word * Result_18)
{
  ...
  {
    MR_Word OutputStream_52 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MaybeOutputStream_15, (MR_Integer) 0))));

    mercury__io__write_string_4_p_0(OutputStream_52, (MR_String) "% Reading graph data...\n");
    mercury__io__flush_output_3_p_0(OutputStream_52);
    read_profile__read_call_graph_4_p_0(DataFileName_13, &DataFileResult_20);
    mercury__io__write_string_4_p_0(OutputStream_52, (MR_String) "% Done.\n");
    mercury__io__flush_output_3_p_0(OutputStream_52);
  }
