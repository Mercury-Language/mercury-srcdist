                ...
                case (MR_Integer) 2:
                  {
                    ...
                    if (succeeded)
                    {
                      ...
                      mercury__private_builtin__builtin_compare_int_3_p_0(&SubResult1_17, ArgX1_15, ArgY1_16);
                      succeeded = (SubResult1_17 != (MR_Integer) 0);
                      if (succeeded)
                        Var_6 = SubResult1_17;
                      else
                        mercury__private_builtin__builtin_compare_int_3_p_0(&Var_6, ArgX2_18, ArgY2_19);
                      succeeded = MR_TRUE;
                    }
                  }
                  break;
