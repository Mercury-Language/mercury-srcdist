...
MR_def_label(message__message_to_string_2_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(((((MR_Integer) MR_sv(2) == (MR_Integer) MR_tbmkword(0, 5)) || ((MR_tag(MR_sv(2)) == MR_mktag((MR_Integer) 3)) && ((MR_Integer) MR_tfield(3, MR_sv(2), 0) == (MR_Integer) 7))) || ((MR_Integer) MR_sv(2) == (MR_Integer) MR_tbmkword(0, 4))))) {
...
MR_def_label(message__message_to_string_2_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(((((((MR_Integer) MR_sv(2) == (MR_Integer) MR_tbmkword(0, 0)) || (MR_tag(MR_sv(2)) == MR_mktag((MR_Integer) 1))) || ((MR_tag(MR_sv(2)) == MR_mktag((MR_Integer) 3)) && ((MR_Integer) MR_tfield(3, MR_sv(2), 0) == (MR_Integer) 0))) || ((MR_Integer) MR_sv(2) == (MR_Integer) MR_tbmkword(0, 1))) || (MR_tag(MR_sv(2)) == MR_mktag((MR_Integer) 2))))) {
...
MR_def_label(message__message_to_string_2_0,6)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!((((((MR_Integer) MR_sv(2) == (MR_Integer) MR_tbmkword(0, 2)) || ((MR_tag(MR_sv(2)) == MR_mktag((MR_Integer) 3)) && ((MR_Integer) MR_tfield(3, MR_sv(2), 0) == (MR_Integer) 3))) || ((MR_tag(MR_sv(2)) == MR_mktag((MR_Integer) 3)) && ((MR_Integer) MR_tfield(3, MR_sv(2), 0) == (MR_Integer) 1))) || ((MR_tag(MR_sv(2)) == MR_mktag((MR_Integer) 3)) && ((MR_Integer) MR_tfield(3, MR_sv(2), 0) == (MR_Integer) 2))))) {
...
void mercury__message__write_out_proc_statics(FILE *deep_fp, FILE *procrep_fp)
{
	MR_write_out_module_proc_reps_start(procrep_fp, &mercury_data__module_layout__message);
