...
MR_decl_label8(message__message_to_string_2_0, 2,92,56,66,69,95,77,78)
MR_decl_label8(message__message_to_string_2_0, 4,7,14,21,28,35,42,49)
MR_decl_label1(message__message_to_string_2_0, 85)
...
MR_decl_label5(__Unify___message__program_location_0_0, 5,7,9,19,1)
...
MR_decl_label8(__Compare___message__program_location_0_0, 3,2,5,7,13,55,15,16)
...
{
MR_string_const("extra proc dynamnics for a clique proc are not currenty handled.", 64)
},
{
MR_string_const("Info", 4)
},
{
MR_string_const("Found candidate conjunction", 27)
},
{
MR_string_const("Notice", 6)
},
{
MR_string_const("Parallelising call pairs that have more than one dependant variable is not yet supported.", 89)
},
{
MR_string_const("Two callpairs are difficult to parallelise because they are not adjacent", 72)
},
{
MR_string_const("Parallelising expensive call goals with cheap call goals between them is not supported", 86)
},
{
MR_string_const("Parallelising call goals with non-atomic goals between them is not supported", 76)
},
{
MR_string_const("Warning", 7)
},
{
MR_string_const("Could not look up proc defn, perhaps this procedure is built-in", 63)
},
};
...
MR_BEGIN_MODULE(message_module2)
	...
	MR_init_label8(message__message_to_string_2_0,2,92,56,66,69,95,77,78)
	MR_init_label8(message__message_to_string_2_0,4,7,14,21,28,35,42,49)
	MR_init_label1(message__message_to_string_2_0,85)
MR_BEGIN_CODE
...
MR_def_label(message__message_to_string_2_0,2)
	...
	MR_COMPUTED_GOTO((MR_Unsigned) MR_tag(MR_sv(1)),
		MR_LABEL_AP(message__message_to_string_2_0_i92) MR_AND
		MR_LABEL_AP(message__message_to_string_2_0_i56) MR_AND
		MR_LABEL_AP(message__message_to_string_2_0_i66) MR_AND
		MR_LABEL_AP(message__message_to_string_2_0_i95));
MR_def_label(message__message_to_string_2_0,92)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_COMPUTED_GOTO((MR_Unsigned) MR_unmkbody(MR_sv(1)),
		MR_LABEL_AP(message__message_to_string_2_0_i21) MR_AND
		MR_LABEL_AP(message__message_to_string_2_0_i35) MR_AND
		MR_LABEL_AP(message__message_to_string_2_0_i42) MR_AND
		MR_LABEL_AP(message__message_to_string_2_0_i49) MR_AND
		MR_LABEL_AP(message__message_to_string_2_0_i28) MR_AND
		MR_LABEL_AP(message__message_to_string_2_0_i85) MR_AND
		MR_LABEL_AP(message__message_to_string_2_0_i14));
MR_def_label(message__message_to_string_2_0,56)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
	...
	MR_sv(1) = MR_r1;
	MR_r1 = (MR_Word) MR_string_const("%d conjunctions not parallelised: Seen duplicate instantiations", 63);
	}
	MR_np_call_localret_ent(string__format_3_0,
		message__message_to_string_2_0_i69);
MR_def_label(message__message_to_string_2_0,66)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 1);
	MR_tfield(1, MR_tempr1, 0) = MR_ctfield(2, MR_sv(1), 0);
	MR_tag_alloc_heap(MR_tempr2, 1, (MR_Integer) 2);
	MR_r2 = MR_tempr2;
	MR_tfield(1, MR_tempr2, 0) = MR_tempr1;
	MR_tfield(1, MR_tempr2, 1) = (MR_Word) MR_tbmkword(0, 0);
	MR_sv(1) = MR_r1;
	MR_r1 = (MR_Word) MR_string_const("%d potential call pairs not parallelised in this conjunction", 60);
	}
	MR_np_call_localret_ent(string__format_3_0,
		message__message_to_string_2_0_i69);
MR_def_label(message__message_to_string_2_0,69)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	...
	MR_r2 = MR_tempr4;
	MR_tfield(1, MR_tempr4, 0) = (MR_Word) MR_TAG_COMMON(2,1,4);
	MR_tfield(1, MR_tempr4, 1) = MR_tempr2;
	MR_r1 = (MR_Word) MR_string_const("%s: In %s: %s", 13);
	MR_succip_word = MR_sv(2);
	MR_decr_sp(2);
	MR_np_tailcall_ent(string__format_3_0);
	}
MR_def_label(message__message_to_string_2_0,95)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	...
	MR_np_call_localret_ent(fn__f_115_116_114_105_110_103_95_95_43_43_2_0,
		message__message_to_string_2_0_i77);
MR_def_label(message__message_to_string_2_0,77)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
	...
	MR_np_call_localret_ent(fn__f_115_116_114_105_110_103_95_95_43_43_2_0,
		message__message_to_string_2_0_i78);
MR_def_label(message__message_to_string_2_0,78)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2, MR_tempr3, MR_tempr4;
	MR_tag_alloc_heap(MR_tempr1, 2, (MR_Integer) 1);
	...
	MR_tag_alloc_heap(MR_tempr4, 1, (MR_Integer) 2);
	MR_r2 = MR_tempr4;
	MR_tfield(1, MR_tempr4, 0) = (MR_Word) MR_TAG_COMMON(2,1,9);
	MR_tfield(1, MR_tempr4, 1) = MR_tempr2;
	MR_r1 = (MR_Word) MR_string_const("%s: In %s: %s", 13);
	MR_succip_word = MR_sv(2);
	MR_decr_sp(2);
...
MR_def_label(message__message_to_string_2_0,4)
	...
	MR_tfield(1, MR_tempr2, 1) = (MR_Word) MR_tbmkword(0, 0);
	MR_sv(1) = MR_r1;
	MR_r1 = (MR_Word) MR_string_const("Error generating coverage procedure report: %s", 46);
	}
	MR_np_call_localret_ent(string__format_3_0,
		message__message_to_string_2_0_i7);
MR_def_label(message__message_to_string_2_0,7)
	...
	MR_tag_alloc_heap(MR_tempr4, 1, (MR_Integer) 2);
	MR_r2 = MR_tempr4;
	MR_tfield(1, MR_tempr4, 0) = (MR_Word) MR_TAG_COMMON(2,1,0);
	MR_tfield(1, MR_tempr4, 1) = MR_tempr2;
	MR_r1 = (MR_Word) MR_string_const("%s: In %s: %s", 13);
	MR_succip_word = MR_sv(2);
	MR_decr_sp(2);
...
MR_def_label(message__message_to_string_2_0,14)
	...
	MR_tag_alloc_heap(MR_tempr3, 1, (MR_Integer) 2);
	MR_r2 = MR_tempr3;
	MR_tfield(1, MR_tempr3, 0) = (MR_Word) MR_TAG_COMMON(2,1,0);
...
MR_def_label(message__message_to_string_2_0,21)
	...
	MR_tag_alloc_heap(MR_tempr3, 1, (MR_Integer) 2);
	MR_r2 = MR_tempr3;
	MR_tfield(1, MR_tempr3, 0) = (MR_Word) MR_TAG_COMMON(2,1,2);
	MR_tfield(1, MR_tempr3, 1) = MR_tempr2;
	MR_r1 = (MR_Word) MR_string_const("%s: In %s: %s", 13);
	MR_succip_word = MR_sv(2);
	MR_decr_sp(2);
...
MR_def_label(message__message_to_string_2_0,28)
	...
	MR_tag_alloc_heap(MR_tempr3, 1, (MR_Integer) 2);
	MR_r2 = MR_tempr3;
	MR_tfield(1, MR_tempr3, 0) = (MR_Word) MR_TAG_COMMON(2,1,4);
	MR_tfield(1, MR_tempr3, 1) = MR_tempr2;
	MR_r1 = (MR_Word) MR_string_const("%s: In %s: %s", 13);
	MR_succip_word = MR_sv(2);
	MR_decr_sp(2);
...
MR_def_label(message__message_to_string_2_0,42)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2, MR_tempr3;
	MR_tag_alloc_heap(MR_tempr1, 2, (MR_Integer) 1);
...
MR_def_label(message__message_to_string_2_0,49)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2, MR_tempr3;
	MR_tag_alloc_heap(MR_tempr1, 2, (MR_Integer) 1);
...
MR_def_label(message__message_to_string_2_0,85)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2, MR_tempr3;
	MR_tag_alloc_heap(MR_tempr1, 2, (MR_Integer) 1);
	...
	MR_tag_alloc_heap(MR_tempr2, 1, (MR_Integer) 2);
	MR_tfield(1, MR_tempr2, 0) = MR_tempr1;
	MR_tfield(1, MR_tempr2, 1) = (MR_Word) MR_TAG_COMMON(1,2,6);
	MR_tag_alloc_heap(MR_tempr3, 1, (MR_Integer) 2);
	MR_r2 = MR_tempr3;
	MR_tfield(1, MR_tempr3, 0) = (MR_Word) MR_TAG_COMMON(2,1,9);
	MR_tfield(1, MR_tempr3, 1) = MR_tempr2;
	MR_r1 = (MR_Word) MR_string_const("%s: In %s: %s", 13);
	MR_succip_word = MR_sv(2);
	MR_decr_sp(2);
...
MR_BEGIN_MODULE(message_module10)
	...
	MR_init_label5(__Unify___message__program_location_0_0,5,7,9,19,1)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(message_module11)
	...
	MR_init_label8(__Compare___message__program_location_0_0,3,2,5,7,13,55,15,16)
...
MR_def_label(__Compare___message__program_location_0_0,2)
	...
	if ((MR_tempr1 == MR_mktag((MR_Integer) 1))) {
		MR_GOTO_LAB(__Compare___message__program_location_0_0_i15);
	}
	if ((MR_tempr1 == MR_mktag((MR_Integer) 2))) {
		MR_GOTO_LAB(__Compare___message__program_location_0_0_i15);
	}
