  ...
  MR_Word MessageType_3)
{
  ...
  switch (MR_tag((MR_Word) MessageType_3)) {
    ...
    case (MR_Integer) 2:
      {
        MR_Integer Num_62 = ((MR_Integer) ((MR_hl_field(2, MessageType_3, 0))));
        MR_String Var_121;
        MR_String Var_128;

        mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&message_scalar_common_1[0]), Num_62, &Var_121);
    ...
    case (MR_Integer) 3:
      switch (((MR_Integer) ((MR_hl_field(3, MessageType_3, 0))))) {
        ...
        case (MR_Integer) 0:
          {
            MR_Integer Num_67 = ((MR_Integer) ((MR_hl_field(3, MessageType_3, 1))));
            MR_String Var_111;
            MR_String Var_118;

            mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&message_scalar_common_1[0]), Num_67, &Var_111);
        ...
        case (MR_Integer) 3:
          {
            ...
            Var_42 = mercury__string__string_1_f_0((MR_Word) (&mdbcomp__program_representation__mdbcomp__program_representation__type_ctor_info_detism_rep_0), ((MR_Box) (Detism_11)));
            Var_108 = mercury__string__f_43_43_2_f_0(Var_42, (MR_String) " goals amongst goals above the parallelisation overhead.");
        ...
        case (MR_Integer) 4:
          {
            ...
            Var_47 = mercury__string__f_43_43_2_f_0(Msg_12, (MR_String) "\n  falling back to some other method");
            String_5 = mercury__string__f_43_43_2_f_0((MR_String) "Cannot compute procrep coverage annotation: ", Var_47);
          }
          break;
        case (MR_Integer) 5:
          {
