            ...
            if (message__succeeded)
              {
                ...
                {
                  message__succeeded = mdbcomp__program_representation____Unify____string_proc_label_0_0(message__V_3_3, message__V_4_4);
                }
              }
          }
          break;
            ...
            if (message__succeeded)
              {
                ...
                if (message__succeeded)
                  {
                    message__succeeded = mdbcomp__goal_path____Unify____reverse_goal_path_0_0(message__V_6_6, message__V_8_8);
                  }
              }
          }
          break;
...
{
  {
    ...
    if (message__succeeded)
    ...
    else
      {
        ...
        if (message__succeeded)
          {
            message__succeeded = message____Unify____message_type_0_0(message__V_4_4, message__V_6_6);
          }
      }
    return message__succeeded;
  }
      ...
      case (MR_Integer) 1:
        {
          ...
          MR_String message__V_131_131;
          MR_String message__V_138_138;

          {
            mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) &message_scalar_common_2[0], message__Num_6, &message__V_131_131);
          }
          {
            message__V_138_138 = mercury__string__f_43_43_2_f_0(message__V_131_131, (MR_String) " conjuncts above callsite threshold");
          }
          {
            message__String_5 = mercury__string__f_43_43_2_f_0((MR_String) "Found ", message__V_138_138);
          }
        }
        break;
      case (MR_Integer) 2:
        {
          ...
          MR_String message__V_118_118;

          {
            mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) &message_scalar_common_2[0], message__Num_62, &message__V_111_111);
          }
          {
            message__V_118_118 = mercury__string__f_43_43_2_f_0(message__V_111_111, (MR_String) " partitions, this may reduce parallelism");
          }
          {
            message__String_5 = mercury__string__f_43_43_2_f_0((MR_String) "Split conjunction into ", message__V_118_118);
          }
        }
        break;
      case (MR_Integer) 3:
          ...
          case (MR_Integer) 0:
            {
              ...
              MR_String message__V_121_121;
              MR_String message__V_128_128;

              {
                mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) &message_scalar_common_2[0], message__Num_57, &message__V_121_121);
              }
              {
                message__V_128_128 = mercury__string__f_43_43_2_f_0(message__V_121_121, (MR_String) " conjunctions with a positive speedup due to parallelisation");
              }
              {
                message__String_5 = mercury__string__f_43_43_2_f_0((MR_String) "Found ", message__V_128_128);
              }
            }
            break;
          case (MR_Integer) 1:
            {
              ...
              MR_String message__V_100_100;

              {
                mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) &message_scalar_common_2[0], message__CandidateConjuncts_8, &message__V_100_100);
              }
              {
                message__String_5 = mercury__string__f_43_43_2_f_0(message__V_100_100, (MR_String) " conjunctions not parallelised: Seen duplicate instantiations");
              }
            }
            break;
          case (MR_Integer) 2:
            {
              ...
              MR_Word message__V_86_86 = (MR_Word) &message_scalar_common_2[0];
              MR_String message__V_87_87;
              MR_String message__V_89_89;
              MR_String message__V_90_90;
              MR_String message__V_97_97;

              {
                mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0(message__V_86_86, message__NumCalls_10, &message__V_80_80);
              }
              {
                message__V_87_87 = mercury__string__f_43_43_2_f_0(message__V_80_80, (MR_String) " costly calls and cannot be parallelised");
              }
              {
                message__V_89_89 = mercury__string__f_43_43_2_f_0((MR_String) " has only ", message__V_87_87);
              }
              {
                mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0(message__V_86_86, message__PartNum_9, &message__V_90_90);
              }
              {
                message__V_97_97 = mercury__string__f_43_43_2_f_0(message__V_90_90, message__V_89_89);
              }
              {
                message__String_5 = mercury__string__f_43_43_2_f_0((MR_String) "Partition ", message__V_97_97);
              }
            }
            break;
          case (MR_Integer) 3:
            {
              ...
              {
                message__V_108_108 = mercury__string__f_43_43_2_f_0(message__V_32_32, (MR_String) " goals amongst goals above the parallelisation overhead.");
              }
              {
                message__String_5 = mercury__string__f_43_43_2_f_0((MR_String) "There are ", message__V_108_108);
              }
            }
            break;
          case (MR_Integer) 4:
