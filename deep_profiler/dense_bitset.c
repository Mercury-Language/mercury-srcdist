  ...
  MR_ArrayPtr * C_6)
{
  ...
  mercury__array__max_2_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0), (MR_ArrayPtr) (A_4), &Max_18);
  dense_bitset__foldl1__ho2_6_p_0((MR_Integer) 0, Max_18, A_4, B_5, C_6);
}
