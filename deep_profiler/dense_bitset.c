  ...
  while (MR_TRUE)
  {
    /* tailcall optimized into a loop */
    {
      ...
      if (succeeded)
      {
        ...
        {
          MR_Integer next_value_of_Min_7 = Var_16;
  ...
  while (MR_TRUE)
  {
    /* tailcall optimized into a loop */
    {
      ...
      if (succeeded)
      {
        ...
        /* direct tailcall eliminated */
        {
          MR_Integer next_value_of_B_7 = Var_23;
          MR_Box next_value_of_STATE_VARIABLE_Acc_0_14 = STATE_VARIABLE_Acc_22_22;
  ...
  while (MR_TRUE)
  {
    /* tailcall optimized into a loop */
    {
      ...
      if (succeeded)
      {
        ...
        {
          MR_Integer next_value_of_Min_7 = Var_16;
          MR_ArrayPtr next_value_of_STATE_VARIABLE_Acc_0_12 = STATE_VARIABLE_Acc_15_15;
  ...
  while (MR_TRUE)
  {
    /* tailcall optimized into a loop */
    {
      ...
      if (succeeded)
      {
        ...
        {
          MR_Integer next_value_of_B_7 = Var_23;
          MR_ArrayPtr next_value_of_STATE_VARIABLE_Acc_0_14 = STATE_VARIABLE_Acc_22_22;
  ...
  while (MR_TRUE)
  {
    /* tailcall optimized into a loop */
    {
      ...
      if (succeeded)
      {
        ...
        /* direct tailcall eliminated */
        {
          MR_ArrayPtr next_value_of_A0_4 = A1_8;
