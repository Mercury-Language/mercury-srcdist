  ...
  MR_Box * STATE_VARIABLE_Acc_13)
{
  while (MR_TRUE)
  {
    ...
    if (succeeded)
    {
      ...
      Var_16 = (MR_Integer) ((MR_Unsigned) Min_7 + (MR_Unsigned) (MR_Integer) 1);
  ...
  MR_Box * STATE_VARIABLE_Acc_15)
{
  while (MR_TRUE)
  {
    ...
    if (succeeded)
    {
      ...
      {
        MR_Integer I_13;
        MR_Integer Var_20 = (MR_Integer) ((MR_Unsigned) W_8 * (MR_Unsigned) (MR_Integer) 32);
      ...
      Var_23 = (MR_Integer) ((MR_Unsigned) B_7 + (MR_Unsigned) (MR_Integer) 1);
      // direct tailcall eliminated
      ;
...
{
  {
    ...
    mercury__array__max_2_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0), (MR_ArrayPtr) (A0_4), &Max_7);
    succeeded = (I_5 > Max_7);
    if (succeeded)
      A_6 = A0_4;
    else
    {
      ...
      if (succeeded)
      {
        ...
        mercury__array__lookup_3_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0), (MR_ArrayPtr) (A0_4), Var_11, &conv0_Word0_8);
        Word0_8 = ((MR_Integer) (conv0_Word0_8));
        Var_22 = (I_5 & (MR_Integer) 31);
        Var_13 = mercury__int__f_60_60_2_f_0((MR_Integer) 1, Var_22);
        Var_12 = ~(Var_13);
        Word_9 = (Word0_8 & Var_12);
        Var_14 = mercury__int__f_47_47_2_f_0(I_5, (MR_Integer) 32);
        mercury__array__set_4_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0), Var_14, ((MR_Box) (Word_9)), (MR_ArrayPtr) (A0_4), &conv1_A_6);
        A_6 = (MR_ArrayPtr) (conv1_A_6);
      }
      else
      {
        mercury__require__unexpected_2_p_0((MR_String) "function \140dense_bitset.delete\'/2", (MR_String) "cannot use indexes < 0");
      }
    }
    return A_6;
  }
  ...
  MR_Integer I_5)
{
  while (MR_TRUE)
  {
    ...
    if (succeeded)
    {
      MR_ArrayPtr A1_8;
      MR_Integer Var_12;
      MR_Integer Var_14 = (MR_Integer) ((MR_Unsigned) Max_7 + (MR_Unsigned) (MR_Integer) 1);
      MR_ArrayPtr conv0_A1_8;
      MR_ArrayPtr next_value_of_A0_4;

      Var_12 = (MR_Integer) ((MR_Unsigned) Var_14 * (MR_Unsigned) (MR_Integer) 2);
      mercury__array__resize_4_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0), Var_12, ((MR_Box) ((MR_Integer) 0)), (MR_ArrayPtr) (A0_4), &conv0_A1_8);
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        mercury__array__lookup_3_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0), (MR_ArrayPtr) (A0_4), Var_18, &conv1_Word0_9);
        Word0_9 = ((MR_Integer) (conv1_Word0_9));
        Var_30 = (I_5 & (MR_Integer) 31);
        Var_19 = mercury__int__f_60_60_2_f_0((MR_Integer) 1, Var_30);
        Word_10 = (Word0_9 | Var_19);
        Var_20 = mercury__int__f_47_47_2_f_0(I_5, (MR_Integer) 32);
        mercury__array__set_4_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0), Var_20, ((MR_Box) (Word_10)), (MR_ArrayPtr) (A0_4), &conv2_A_6);
        A_6 = (MR_ArrayPtr) (conv2_A_6);
      }
      else
      {
        mercury__require__unexpected_2_p_0((MR_String) "function \140dense_bitset.insert\'/2", (MR_String) "cannot use indexes < 0");
      }
    }
    return A_6;
    break;
