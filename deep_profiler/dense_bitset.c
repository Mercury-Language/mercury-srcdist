...
MR_decl_label8(fn__dense_bitset__insert_2_0, 25,2,4,5,3,8,9,10)
MR_decl_label2(fn__dense_bitset__insert_2_0, 11,7)
...
MR_BEGIN_MODULE(dense_bitset_module2)
	...
	MR_init_label8(fn__dense_bitset__insert_2_0,25,2,4,5,3,8,9,10)
	MR_init_label2(fn__dense_bitset__insert_2_0,11,7)
MR_BEGIN_CODE
...
MR_def_label(fn__dense_bitset__insert_2_0,4)
	...
	MR_r1 = (MR_Word) MR_INT_CTOR_ADDR;
	MR_r2 = MR_sv(1);
	MR_r3 = (((MR_Integer) MR_sv(3) + (MR_Integer) 1) * (MR_Integer) 2);
	MR_r4 = (MR_Integer) 0;
...
MR_def_label(fn__dense_bitset__insert_2_0,9)
	...
	MR_sv(3) = MR_r1;
	MR_r1 = (MR_Integer) 1;
	MR_r2 = ((MR_Integer) MR_sv(2) & (MR_Integer) 31);
	MR_np_call_localret_ent(fn__f_105_110_116_95_95_60_60_2_0,
...
MR_def_label(fn__dense_bitset__insert_2_0,10)
	...
	MR_tempr1 = MR_r1;
	MR_r1 = MR_sv(2);
	MR_sv(2) = ((MR_Integer) MR_sv(3) | (MR_Integer) MR_tempr1);
	MR_r2 = (MR_Integer) 32;
	}
	MR_np_call_localret_ent(fn__f_105_110_116_95_95_47_47_2_0,
...
MR_def_label(fn__dense_bitset__insert_2_0,7)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_string_const("insert: cannot use indexes < 0", 30);
	MR_succip_word = MR_sv(4);
	MR_decr_sp(4);
...
MR_def_label(fn__dense_bitset__delete_2_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_string_const("delete: cannot use indexes < 0", 30);
	MR_succip_word = MR_sv(4);
	MR_decr_sp(4);
	MR_np_tailcall_ent(require__error_1_0);
#ifdef MR_maybe_local_thread_engine_base
...
void mercury__dense_bitset__write_out_proc_statics(FILE *fp);
#endif
