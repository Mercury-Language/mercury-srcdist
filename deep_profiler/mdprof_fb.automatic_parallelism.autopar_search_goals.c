  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      else
      {
        ...
        message__append_message_4_p_0(Location_40, (MR_Word) (MR_mkword(3, &mdprof_fb__automatic_parallelism__autopar_search_goals_scalar_common_1[12])), STATE_VARIABLE_Messages_3_63, &HeadMessages_20);
  ...
  MR_Word * MaybeCandidate_12)
{
  ...
  if ((*MaybeCandidate_12 == (MR_Word) ((MR_Unsigned) 0U)))
    *STATE_VARIABLE_Messages_17 = STATE_VARIABLE_Messages_3_22;
    ...
    message__append_message_4_p_0(Location_15, (MR_Word) (MR_mkword(3, &mdprof_fb__automatic_parallelism__autopar_search_goals_scalar_common_1[12])), STATE_VARIABLE_Messages_3_22, STATE_VARIABLE_Messages_17);
}
