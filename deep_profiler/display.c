        ...
        case (MR_Integer) 1:
          {
            ...
            if (succeeded)
            {
              ...
              TypeInfo__13_13 = (MR_Word) (&display_scalar_common_1[8]);
  ...
  MR_Word HeadVar__2_2)
{
  ...
  if (((MR_tag((MR_Word) HeadVar__1_1)) == (MR_Integer) 1))
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        TypeInfo__11_11 = (MR_Word) (&display_scalar_common_1[7]);
    ...
    switch (MR_tag((MR_Word) HeadVar__2_2)) {
      ...
      case (MR_Integer) 3:
        switch (((MR_Integer) ((MR_hl_field(MR_mktag(3), HeadVar__2_2, (MR_Integer) 0))))) {
          ...
          case (MR_Integer) 1:
            {
              MR_Word Var_182 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(3), HeadVar__2_2, (MR_Integer) 2))) & (MR_Integer) 1);
              MR_Word Var_183 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(3), HeadVar__2_2, (MR_Integer) 2))) >> 1)) & (MR_Integer) 1);
                    ...
                    case (MR_Integer) 1:
                      {
                        ...
                        MR_Word ArgY2_74 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(3), HeadVar__3_3, (MR_Integer) 2))) >> 1)) & (MR_Integer) 1);
                        MR_Word ArgY3_77 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(3), HeadVar__3_3, (MR_Integer) 2))) & (MR_Integer) 1);
          ...
          case (MR_Integer) 1:
            {
              ...
              MR_Word ArgY1_10;
              MR_Word ArgX2_11 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(3), HeadVar__1_1, (MR_Integer) 2))) >> 1)) & (MR_Integer) 1);
              MR_Word ArgY2_12;
              MR_Word ArgX3_13 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(3), HeadVar__1_1, (MR_Integer) 2))) & (MR_Integer) 1);
              MR_Word ArgY3_14;
              ...
              if (succeeded)
              {
                ...
                ArgY2_12 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(3), HeadVar__2_2, (MR_Integer) 2))) >> 1)) & (MR_Integer) 1);
                ArgY3_14 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(3), HeadVar__2_2, (MR_Integer) 2))) & (MR_Integer) 1);
            ...
            case (MR_Integer) 3:
              {
                ...
                if (succeeded)
                {
                  ...
                  if (succeeded)
                  {
                    TypeInfo__27_27 = (MR_Word) (&display_scalar_common_1[2]);
                    succeeded = mercury__builtin__unify_2_p_0(TypeInfo__27_27, ((MR_Box) (ArgX2_15)), ((MR_Box) (ArgY2_16)));
                    if (succeeded)
                    {
                      TypeInfo__28_28 = (MR_Word) (&display_scalar_common_1[3]);
                      succeeded = mercury__builtin__unify_2_p_0(TypeInfo__28_28, ((MR_Box) (ArgX3_17)), ((MR_Box) (ArgY3_18)));
                    }
                  }
                }
              }
  ...
  MR_Word HeadVar__2_2)
{
  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        TypeInfo__13_13 = (MR_Word) (&display_scalar_common_1[4]);
        succeeded = mercury__builtin__unify_2_p_0(TypeInfo__13_13, ((MR_Box) (ArgX3_7)), ((MR_Box) (ArgY3_8)));
        if (succeeded)
        {
          TypeInfo__14_14 = (MR_Word) (&display_scalar_common_1[5]);
  ...
  MR_Word HeadVar__2_2)
{
  ...
  else
  {
    ...
    if (succeeded)
    {
      TypeInfo__10_10 = (MR_Word) (&display_scalar_common_1[3]);
  ...
  MR_Word HeadVar__2_2)
{
  ...
  else
  {
    ...
    if (succeeded)
    {
      TypeInfo__14_14 = (MR_Word) (&display_scalar_common_1[1]);
