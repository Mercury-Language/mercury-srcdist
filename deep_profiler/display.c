...
MR_decl_label10(__Unify___display__display_item_0_0, 119,5,6,8,10,14,20,18,24,59)
MR_decl_label2(__Unify___display__display_item_0_0, 28,1)
...
MR_decl_label10(__Compare___display__display_item_0_0, 518,198,7,8,9,10,11,12,13,5)
...
MR_decl_label10(__Compare___display__display_item_0_0, 93,94,95,96,97,98,99,91,103,104)
MR_decl_label9(__Compare___display__display_item_0_0, 105,191,106,107,108,109,195,110,592)
...
MR_BEGIN_MODULE(display_module10)
	...
	MR_init_label10(__Unify___display__display_item_0_0,119,5,6,8,10,14,20,18,24,59)
	MR_init_label2(__Unify___display__display_item_0_0,28,1)
MR_BEGIN_CODE
...
MR_def_label(__Unify___display__display_item_0_0,14)
	...
	MR_np_call_localret_ent(__Unify___maybe__maybe_1_0,
		__Unify___display__display_item_0_0_i20);
...
MR_def_label(__Unify___display__display_item_0_0,24)
	...
	if (MR_RTAGS_TESTR(MR_sv(1),3,3)) {
		MR_GOTO_LAB(__Unify___display__display_item_0_0_i28);
	}
...
MR_BEGIN_MODULE(display_module11)
	...
	MR_init_label10(__Compare___display__display_item_0_0,518,198,7,8,9,10,11,12,13,5)
	...
	MR_init_label10(__Compare___display__display_item_0_0,93,94,95,96,97,98,99,91,103,104)
	MR_init_label9(__Compare___display__display_item_0_0,105,191,106,107,108,109,195,110,592)
MR_BEGIN_CODE
...
MR_def_label(__Compare___display__display_item_0_0,518)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if ((MR_r1 == MR_r2)) {
...
MR_def_label(__Compare___display__display_item_0_0,41)
	...
	MR_r2 = MR_tfield(3, MR_sv(2), 1);
	MR_succip_word = MR_sv(5);
	MR_GOTO_LAB(__Compare___display__display_item_0_0_i518);
...
MR_def_label(__Compare___display__display_item_0_0,68)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___display__display_item_0_0_i592);
	}
	MR_r1 = (MR_Word) MR_STRING_CTOR_ADDR;
	MR_r2 = MR_sv(4);
	MR_r3 = MR_sv(1);
...
MR_def_label(__Compare___display__display_item_0_0,109)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_RTAGS_TESTR(MR_sv(2),3,3)) {
		MR_GOTO_LAB(__Compare___display__display_item_0_0_i110);
	}
MR_def_label(__Compare___display__display_item_0_0,195)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Integer) 2;
	MR_decr_sp_and_return(5);
MR_def_label(__Compare___display__display_item_0_0,110)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_tfield(3, MR_sv(1), 1);
	MR_r2 = MR_tfield(3, MR_sv(2), 1);
	MR_succip_word = MR_sv(5);
	MR_decr_sp(5);
	MR_np_tailcall_ent(private_builtin__builtin_compare_string_3_0);
MR_def_label(__Compare___display__display_item_0_0,592)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(5);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
