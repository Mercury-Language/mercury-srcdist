...
MR_decl_label8(__Unify___display__display_item_0_0, 17,5,26,33,7,11,13,18)
MR_decl_label4(__Unify___display__display_item_0_0, 22,28,34,1)
MR_decl_label2(__Unify___display__pseudo_link_0_0, 4,1)
MR_decl_label3(__Unify___display__table_0_0, 4,8,1)
MR_decl_label5(__Unify___display__table_cell_0_0, 5,10,12,16,1)
MR_decl_label8(__Unify___display__table_data_0_0, 9,11,13,34,5,17,19,21)
MR_decl_label4(__Unify___display__table_data_0_0, 25,27,35,1)
...
MR_decl_label4(__Unify___display__table_row_0_0, 5,9,16,1)
...
MR_decl_label8(__Compare___display__display_item_0_0, 60,65,5,104,112,137,20,35)
MR_decl_label8(__Compare___display__display_item_0_0, 39,41,45,74,80,89,96,99)
MR_decl_label4(__Compare___display__display_item_0_0, 119,126,128,138)
MR_decl_label4(__Compare___display__pseudo_link_0_0, 3,2,5,21)
MR_decl_label6(__Compare___display__table_0_0, 3,2,5,9,13,37)
MR_decl_label8(__Compare___display__table_cell_0_0, 50,5,7,20,54,22,24,26)
MR_decl_label1(__Compare___display__table_cell_0_0, 35)
MR_decl_label8(__Compare___display__table_data_0_0, 3,20,35,39,50,55,138,5)
MR_decl_label8(__Compare___display__table_data_0_0, 7,65,73,77,90,97,105,113)
MR_decl_label5(__Compare___display__table_data_0_0, 115,120,128,129,209)
...
MR_decl_label7(__Compare___display__table_row_0_0, 44,5,46,7,13,39,16)
...
MR_BEGIN_MODULE(display_module10)
	...
	MR_init_label8(__Unify___display__display_item_0_0,17,5,26,33,7,11,13,18)
	MR_init_label4(__Unify___display__display_item_0_0,22,28,34,1)
MR_BEGIN_CODE
...
MR_define_entry(mercury____Unify___display__display_item_0_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if ((MR_r1 == MR_r2)) {
		MR_GOTO_LAB(__Unify___display__display_item_0_0_i34);
	}
	MR_incr_sp(3);
	MR_sv(3) = (MR_Word) MR_succip;
	MR_sv(1) = MR_r1;
	...
	MR_COMPUTED_GOTO((MR_Unsigned) MR_tag(MR_sv(1)),
		...
		MR_LABEL_AP(__Unify___display__display_item_0_0_i5) MR_AND
		MR_LABEL_AP(__Unify___display__display_item_0_0_i26) MR_AND
		MR_LABEL_AP(__Unify___display__display_item_0_0_i33));
...
MR_def_label(__Unify___display__display_item_0_0,33)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_COMPUTED_GOTO((MR_Unsigned) MR_ctfield(3, MR_sv(1), 0),
		MR_LABEL_AP(__Unify___display__display_item_0_0_i7) MR_AND
		MR_LABEL_AP(__Unify___display__display_item_0_0_i18) MR_AND
		MR_LABEL_AP(__Unify___display__display_item_0_0_i11) MR_AND
		MR_LABEL_AP(__Unify___display__display_item_0_0_i22) MR_AND
		MR_LABEL_AP(__Unify___display__display_item_0_0_i28));
MR_def_label(__Unify___display__display_item_0_0,7)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_def_label(__Unify___display__display_item_0_0,11)
	...
	MR_np_call_localret_ent(__Unify___maybe__maybe_1_0,
		__Unify___display__display_item_0_0_i13);
MR_def_label(__Unify___display__display_item_0_0,13)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(__Unify___display__display_item_0_0_i1);
	}
...
MR_def_label(__Unify___display__display_item_0_0,28)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_def_label(__Unify___display__display_item_0_0,34)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_TRUE;
	MR_proceed();
...
MR_BEGIN_MODULE(display_module11)
	...
	MR_init_label8(__Compare___display__display_item_0_0,60,65,5,104,112,137,20,35)
	MR_init_label8(__Compare___display__display_item_0_0,39,41,45,74,80,89,96,99)
	MR_init_label4(__Compare___display__display_item_0_0,119,126,128,138)
MR_BEGIN_CODE
...
MR_define_entry(mercury____Compare___display__display_item_0_0);
	...
	MR_sv(2) = MR_r2;
	MR_COMPUTED_GOTO((MR_Unsigned) MR_tag(MR_sv(1)),
		MR_LABEL_AP(__Compare___display__display_item_0_0_i60) MR_AND
		MR_LABEL_AP(__Compare___display__display_item_0_0_i5) MR_AND
		MR_LABEL_AP(__Compare___display__display_item_0_0_i104) MR_AND
		MR_LABEL_AP(__Compare___display__display_item_0_0_i137));
MR_def_label(__Compare___display__display_item_0_0,60)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_COMPUTED_GOTO((MR_Unsigned) MR_tag(MR_sv(2)),
		MR_LABEL_AP(__Compare___display__display_item_0_0_i65) MR_AND
		MR_LABEL_AP(__Compare___display__display_item_0_0_i126) MR_AND
		MR_LABEL_AP(__Compare___display__display_item_0_0_i126) MR_AND
		MR_LABEL_AP(__Compare___display__display_item_0_0_i99));
...
MR_def_label(__Compare___display__display_item_0_0,5)
	...
	if (MR_INT_EQ(MR_tag(MR_sv(2)),1)) {
		MR_GOTO_LAB(__Compare___display__display_item_0_0_i112);
	}
	MR_GOTO_LAB(__Compare___display__display_item_0_0_i99);
MR_def_label(__Compare___display__display_item_0_0,104)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_COMPUTED_GOTO((MR_Unsigned) MR_tag(MR_sv(2)),
		MR_LABEL_AP(__Compare___display__display_item_0_0_i99) MR_AND
		MR_LABEL_AP(__Compare___display__display_item_0_0_i126) MR_AND
		MR_LABEL_AP(__Compare___display__display_item_0_0_i112) MR_AND
		MR_LABEL_AP(__Compare___display__display_item_0_0_i99));
MR_def_label(__Compare___display__display_item_0_0,112)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	...
	MR_decr_sp(5);
	MR_np_tailcall_ent(private_builtin__builtin_compare_string_3_0);
MR_def_label(__Compare___display__display_item_0_0,137)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_COMPUTED_GOTO((MR_Unsigned) MR_ctfield(3, MR_sv(1), 0),
		MR_LABEL_AP(__Compare___display__display_item_0_0_i20) MR_AND
		MR_LABEL_AP(__Compare___display__display_item_0_0_i74) MR_AND
		MR_LABEL_AP(__Compare___display__display_item_0_0_i35) MR_AND
		MR_LABEL_AP(__Compare___display__display_item_0_0_i89) MR_AND
		MR_LABEL_AP(__Compare___display__display_item_0_0_i119));
MR_def_label(__Compare___display__display_item_0_0,20)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_tag(MR_sv(2)),3)) {
		MR_GOTO_LAB(__Compare___display__display_item_0_0_i126);
	}
...
MR_def_label(__Compare___display__display_item_0_0,35)
	...
	MR_COMPUTED_GOTO((MR_Unsigned) MR_ctfield(3, MR_sv(2), 0),
		MR_LABEL_AP(__Compare___display__display_item_0_0_i126) MR_AND
		MR_LABEL_AP(__Compare___display__display_item_0_0_i126) MR_AND
		MR_LABEL_AP(__Compare___display__display_item_0_0_i39) MR_AND
		MR_LABEL_AP(__Compare___display__display_item_0_0_i99) MR_AND
		MR_LABEL_AP(__Compare___display__display_item_0_0_i99));
MR_def_label(__Compare___display__display_item_0_0,39)
	...
	MR_np_call_localret_ent(private_builtin__builtin_compare_int_3_0,
		__Compare___display__display_item_0_0_i41);
MR_def_label(__Compare___display__display_item_0_0,41)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___display__display_item_0_0_i138);
	}
	MR_r1 = (MR_Word) MR_STRING_CTOR_ADDR;
	MR_r2 = MR_sv(4);
	MR_r3 = MR_sv(1);
	MR_np_call_localret_ent(__Compare___maybe__maybe_1_0,
		__Compare___display__display_item_0_0_i45);
MR_def_label(__Compare___display__display_item_0_0,45)
	...
	MR_decr_sp(5);
	MR_np_tailcall_ent(__Compare___list__list_1_0);
MR_def_label(__Compare___display__display_item_0_0,74)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_tag(MR_sv(2)),3)) {
		MR_GOTO_LAB(__Compare___display__display_item_0_0_i126);
	}
	MR_COMPUTED_GOTO((MR_Unsigned) MR_ctfield(3, MR_sv(2), 0),
		MR_LABEL_AP(__Compare___display__display_item_0_0_i126) MR_AND
		MR_LABEL_AP(__Compare___display__display_item_0_0_i80) MR_AND
		MR_LABEL_AP(__Compare___display__display_item_0_0_i99) MR_AND
		MR_LABEL_AP(__Compare___display__display_item_0_0_i99) MR_AND
		MR_LABEL_AP(__Compare___display__display_item_0_0_i99));
...
MR_def_label(__Compare___display__display_item_0_0,89)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_tag(MR_sv(2)),3)) {
		MR_GOTO_LAB(__Compare___display__display_item_0_0_i126);
	}
	MR_COMPUTED_GOTO((MR_Unsigned) MR_ctfield(3, MR_sv(2), 0),
		...
		MR_LABEL_AP(__Compare___display__display_item_0_0_i126) MR_AND
		MR_LABEL_AP(__Compare___display__display_item_0_0_i126) MR_AND
		MR_LABEL_AP(__Compare___display__display_item_0_0_i96) MR_AND
		MR_LABEL_AP(__Compare___display__display_item_0_0_i99));
...
MR_def_label(__Compare___display__display_item_0_0,99)
	...
	MR_r1 = (MR_Integer) 1;
	MR_decr_sp_and_return(5);
MR_def_label(__Compare___display__display_item_0_0,119)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_tag(MR_sv(2)),3)) {
		MR_GOTO_LAB(__Compare___display__display_item_0_0_i126);
	}
	if (MR_INT_EQ(MR_ctfield(3, MR_sv(2), 0),4)) {
		MR_GOTO_LAB(__Compare___display__display_item_0_0_i128);
	}
MR_def_label(__Compare___display__display_item_0_0,126)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Integer) 2;
	MR_decr_sp_and_return(5);
MR_def_label(__Compare___display__display_item_0_0,128)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_ctfield(3, MR_sv(1), 1);
	MR_r2 = MR_ctfield(3, MR_sv(2), 1);
	MR_succip_word = MR_sv(5);
	MR_decr_sp(5);
	MR_np_tailcall_ent(private_builtin__builtin_compare_string_3_0);
MR_def_label(__Compare___display__display_item_0_0,138)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(5);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
...
MR_BEGIN_MODULE(display_module22)
	...
	MR_init_label5(__Unify___display__table_cell_0_0,5,10,12,16,1)
MR_BEGIN_CODE
...
MR_define_entry(mercury____Unify___display__table_cell_0_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if ((MR_r1 == MR_r2)) {
		MR_GOTO_LAB(__Unify___display__table_cell_0_0_i16);
	}
	MR_incr_sp(3);
	MR_sv(3) = (MR_Word) MR_succip;
	{
	...
	if ((MR_tempr2 == MR_mktag((MR_Integer) 2))) {
		MR_GOTO_LAB(__Unify___display__table_cell_0_0_i10);
	}
...
MR_def_label(__Unify___display__table_cell_0_0,10)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_sv(2),2)) {
		MR_GOTO_LAB(__Unify___display__table_cell_0_0_i1);
	}
	...
	MR_np_call_localret_ent(__Unify___display__table_data_0_0,
		__Unify___display__table_cell_0_0_i12);
MR_def_label(__Unify___display__table_cell_0_0,12)
	...
	MR_decr_sp_and_return(3);
MR_def_label(__Unify___display__table_cell_0_0,16)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_TRUE;
	MR_proceed();
...
MR_BEGIN_MODULE(display_module23)
	...
	MR_init_label8(__Compare___display__table_cell_0_0,50,5,7,20,54,22,24,26)
	MR_init_label1(__Compare___display__table_cell_0_0,35)
MR_BEGIN_CODE
...
MR_define_entry(mercury____Compare___display__table_cell_0_0);
	...
	MR_sv(3) = (MR_Word) MR_succip;
	if ((MR_r1 == MR_r2)) {
		MR_GOTO_LAB(__Compare___display__table_cell_0_0_i50);
	}
	MR_sv(1) = MR_r1;
	MR_sv(2) = MR_r2;
	{
	...
	if ((MR_tempr1 == MR_mktag((MR_Integer) 2))) {
		MR_GOTO_LAB(__Compare___display__table_cell_0_0_i20);
	}
	...
	if ((MR_tempr1 == MR_mktag((MR_Integer) 2))) {
		MR_GOTO_LAB(__Compare___display__table_cell_0_0_i22);
	}
	if ((MR_tempr1 == MR_mktag((MR_Integer) 1))) {
		MR_GOTO_LAB(__Compare___display__table_cell_0_0_i22);
	}
	}
MR_def_label(__Compare___display__table_cell_0_0,50)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Integer) 0;
	MR_decr_sp_and_return(3);
MR_def_label(__Compare___display__table_cell_0_0,5)
	...
	MR_tempr1 = MR_tag(MR_sv(2));
	if ((MR_tempr1 == MR_mktag((MR_Integer) 2))) {
		MR_GOTO_LAB(__Compare___display__table_cell_0_0_i54);
	}
	if ((MR_tempr1 == MR_mktag((MR_Integer) 1))) {
...
MR_def_label(__Compare___display__table_cell_0_0,20)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_tag(MR_sv(2));
	if ((MR_tempr1 == MR_mktag((MR_Integer) 2))) {
		MR_GOTO_LAB(__Compare___display__table_cell_0_0_i24);
	}
	if ((MR_tempr1 == MR_mktag((MR_Integer) 1))) {
		MR_GOTO_LAB(__Compare___display__table_cell_0_0_i22);
	}
	}
MR_def_label(__Compare___display__table_cell_0_0,54)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Integer) 1;
	MR_decr_sp_and_return(3);
MR_def_label(__Compare___display__table_cell_0_0,22)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Integer) 2;
	MR_decr_sp_and_return(3);
MR_def_label(__Compare___display__table_cell_0_0,24)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2, MR_tempr3, MR_tempr4, MR_tempr5, MR_tempr6;
	MR_tempr5 = MR_sv(1);
	...
	MR_np_call_localret_ent(__Compare___display__table_data_0_0,
		__Compare___display__table_cell_0_0_i26);
MR_def_label(__Compare___display__table_cell_0_0,26)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___display__table_cell_0_0_i35);
	}
	MR_r1 = MR_sv(2);
	MR_r2 = MR_sv(1);
	MR_succip_word = MR_sv(3);
	MR_decr_sp(3);
	MR_np_tailcall_ent(private_builtin__builtin_compare_int_3_0);
MR_def_label(__Compare___display__table_cell_0_0,35)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(3);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
...
MR_BEGIN_MODULE(display_module30)
	...
	MR_init_label8(__Unify___display__table_data_0_0,9,11,13,34,5,17,19,21)
	MR_init_label4(__Unify___display__table_data_0_0,25,27,35,1)
MR_BEGIN_CODE
...
MR_define_entry(mercury____Unify___display__table_data_0_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if ((MR_r1 == MR_r2)) {
		MR_GOTO_LAB(__Unify___display__table_data_0_0_i35);
	}
	MR_incr_sp(5);
	MR_sv(5) = (MR_Word) MR_succip;
	MR_sv(1) = MR_r1;
	...
	MR_COMPUTED_GOTO((MR_Unsigned) MR_tag(MR_sv(1)),
		...
		MR_LABEL_AP(__Unify___display__table_data_0_0_i11) MR_AND
		MR_LABEL_AP(__Unify___display__table_data_0_0_i13) MR_AND
		MR_LABEL_AP(__Unify___display__table_data_0_0_i34));
...
MR_def_label(__Unify___display__table_data_0_0,13)
	...
	MR_decr_sp(5);
	MR_np_tailcall_ent(__Unify___display__deep_link_0_0);
MR_def_label(__Unify___display__table_data_0_0,34)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_COMPUTED_GOTO((MR_Unsigned) MR_ctfield(3, MR_sv(1), 0),
		MR_LABEL_AP(__Unify___display__table_data_0_0_i17) MR_AND
		MR_LABEL_AP(__Unify___display__table_data_0_0_i21) MR_AND
		MR_LABEL_AP(__Unify___display__table_data_0_0_i25) MR_AND
		MR_LABEL_AP(__Unify___display__table_data_0_0_i5) MR_AND
		MR_LABEL_AP(__Unify___display__table_data_0_0_i27));
...
MR_def_label(__Unify___display__table_data_0_0,27)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_RTAGS_TESTR(MR_sv(2),3,4)) {
		MR_GOTO_LAB(__Unify___display__table_data_0_0_i1);
	}
...
MR_def_label(__Unify___display__table_data_0_0,35)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_TRUE;
	MR_proceed();
...
MR_BEGIN_MODULE(display_module31)
	...
	MR_init_label8(__Compare___display__table_data_0_0,3,20,35,39,50,55,138,5)
	MR_init_label8(__Compare___display__table_data_0_0,7,65,73,77,90,97,105,113)
	MR_init_label5(__Compare___display__table_data_0_0,115,120,128,129,209)
MR_BEGIN_CODE
...
MR_define_entry(mercury____Compare___display__table_data_0_0);
	...
	MR_sv(2) = MR_r2;
	MR_COMPUTED_GOTO((MR_Unsigned) MR_tag(MR_sv(1)),
		MR_LABEL_AP(__Compare___display__table_data_0_0_i20) MR_AND
		MR_LABEL_AP(__Compare___display__table_data_0_0_i35) MR_AND
		MR_LABEL_AP(__Compare___display__table_data_0_0_i50) MR_AND
		MR_LABEL_AP(__Compare___display__table_data_0_0_i138));
...
MR_def_label(__Compare___display__table_data_0_0,20)
	...
	if (MR_INT_NE(MR_tag(MR_sv(2)),0)) {
		MR_GOTO_LAB(__Compare___display__table_data_0_0_i115);
	}
...
MR_def_label(__Compare___display__table_data_0_0,35)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_COMPUTED_GOTO((MR_Unsigned) MR_tag(MR_sv(2)),
		MR_LABEL_AP(__Compare___display__table_data_0_0_i128) MR_AND
		MR_LABEL_AP(__Compare___display__table_data_0_0_i39) MR_AND
		MR_LABEL_AP(__Compare___display__table_data_0_0_i115) MR_AND
		MR_LABEL_AP(__Compare___display__table_data_0_0_i115));
...
MR_def_label(__Compare___display__table_data_0_0,50)
	...
	MR_COMPUTED_GOTO((MR_Unsigned) MR_tag(MR_sv(2)),
		MR_LABEL_AP(__Compare___display__table_data_0_0_i128) MR_AND
		MR_LABEL_AP(__Compare___display__table_data_0_0_i128) MR_AND
		MR_LABEL_AP(__Compare___display__table_data_0_0_i55) MR_AND
		MR_LABEL_AP(__Compare___display__table_data_0_0_i115));
MR_def_label(__Compare___display__table_data_0_0,55)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_ctfield(2, MR_sv(1), 0);
	MR_r2 = MR_ctfield(2, MR_sv(2), 0);
	MR_succip_word = MR_sv(5);
	MR_decr_sp(5);
	MR_np_tailcall_ent(__Compare___display__deep_link_0_0);
MR_def_label(__Compare___display__table_data_0_0,138)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_COMPUTED_GOTO((MR_Unsigned) MR_ctfield(3, MR_sv(1), 0),
		MR_LABEL_AP(__Compare___display__table_data_0_0_i65) MR_AND
		MR_LABEL_AP(__Compare___display__table_data_0_0_i90) MR_AND
		MR_LABEL_AP(__Compare___display__table_data_0_0_i105) MR_AND
		MR_LABEL_AP(__Compare___display__table_data_0_0_i5) MR_AND
		MR_LABEL_AP(__Compare___display__table_data_0_0_i120));
MR_def_label(__Compare___display__table_data_0_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_tag(MR_sv(2)),3)) {
		MR_GOTO_LAB(__Compare___display__table_data_0_0_i128);
	}
	MR_COMPUTED_GOTO((MR_Unsigned) MR_ctfield(3, MR_sv(2), 0),
		MR_LABEL_AP(__Compare___display__table_data_0_0_i128) MR_AND
		MR_LABEL_AP(__Compare___display__table_data_0_0_i128) MR_AND
...
MR_def_label(__Compare___display__table_data_0_0,65)
	...
	MR_np_call_localret_ent(__Compare___measurement_units__memory_0_0,
		__Compare___display__table_data_0_0_i73);
MR_def_label(__Compare___display__table_data_0_0,73)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___display__table_data_0_0_i209);
	}
	MR_r1 = MR_sv(4);
	MR_r2 = MR_sv(1);
	MR_np_call_localret_ent(private_builtin__builtin_compare_int_3_0,
		__Compare___display__table_data_0_0_i77);
...
MR_def_label(__Compare___display__table_data_0_0,90)
	...
	MR_COMPUTED_GOTO((MR_Unsigned) MR_ctfield(3, MR_sv(2), 0),
		MR_LABEL_AP(__Compare___display__table_data_0_0_i128) MR_AND
		MR_LABEL_AP(__Compare___display__table_data_0_0_i97) MR_AND
		MR_LABEL_AP(__Compare___display__table_data_0_0_i115) MR_AND
		MR_LABEL_AP(__Compare___display__table_data_0_0_i115) MR_AND
		MR_LABEL_AP(__Compare___display__table_data_0_0_i115));
MR_def_label(__Compare___display__table_data_0_0,97)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_ctfield(3, MR_sv(1), 1);
	MR_r2 = MR_ctfield(3, MR_sv(2), 1);
	MR_succip_word = MR_sv(5);
...
MR_def_label(__Compare___display__table_data_0_0,105)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_tag(MR_sv(2)),3)) {
		MR_GOTO_LAB(__Compare___display__table_data_0_0_i128);
	}
	MR_COMPUTED_GOTO((MR_Unsigned) MR_ctfield(3, MR_sv(2), 0),
		MR_LABEL_AP(__Compare___display__table_data_0_0_i128) MR_AND
		MR_LABEL_AP(__Compare___display__table_data_0_0_i128) MR_AND
		MR_LABEL_AP(__Compare___display__table_data_0_0_i113) MR_AND
		MR_LABEL_AP(__Compare___display__table_data_0_0_i115) MR_AND
		MR_LABEL_AP(__Compare___display__table_data_0_0_i115));
MR_def_label(__Compare___display__table_data_0_0,113)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_ctfield(3, MR_sv(1), 1);
	MR_r2 = MR_ctfield(3, MR_sv(2), 1);
	MR_succip_word = MR_sv(5);
	MR_decr_sp(5);
	MR_np_tailcall_ent(private_builtin__builtin_compare_string_3_0);
MR_def_label(__Compare___display__table_data_0_0,115)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Integer) 1;
	MR_decr_sp_and_return(5);
MR_def_label(__Compare___display__table_data_0_0,120)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_tag(MR_sv(2)),3)) {
		MR_GOTO_LAB(__Compare___display__table_data_0_0_i128);
	}
	if (MR_INT_EQ(MR_ctfield(3, MR_sv(2), 0),4)) {
		MR_GOTO_LAB(__Compare___display__table_data_0_0_i129);
	}
MR_def_label(__Compare___display__table_data_0_0,128)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Integer) 2;
	MR_decr_sp_and_return(5);
MR_def_label(__Compare___display__table_data_0_0,129)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_ctfield(3, MR_sv(1), 1);
	MR_r2 = MR_ctfield(3, MR_sv(2), 1);
	MR_succip_word = MR_sv(5);
...
MR_def_label(__Compare___display__table_data_0_0,209)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(5);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
...
MR_BEGIN_MODULE(display_module38)
	...
	MR_init_label4(__Unify___display__table_row_0_0,5,9,16,1)
MR_BEGIN_CODE
...
MR_define_entry(mercury____Unify___display__table_row_0_0);
	...
	MR_tempr2 = MR_tag(MR_tempr1);
	if ((MR_tempr2 == MR_mktag((MR_Integer) 2))) {
		MR_GOTO_LAB(__Unify___display__table_row_0_0_i9);
	}
	if ((MR_tempr2 == MR_mktag((MR_Integer) 1))) {
...
MR_def_label(__Unify___display__table_row_0_0,5)
	...
	MR_decr_sp(3);
	MR_np_tailcall_ent(__Unify___list__list_1_0);
MR_def_label(__Unify___display__table_row_0_0,9)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_sv(2),2)) {
		MR_GOTO_LAB(__Unify___display__table_row_0_0_i1);
	}
...
MR_BEGIN_MODULE(display_module39)
	...
	MR_init_label7(__Compare___display__table_row_0_0,44,5,46,7,13,39,16)
MR_BEGIN_CODE
...
MR_define_entry(mercury____Compare___display__table_row_0_0);
	...
	MR_sv(3) = (MR_Word) MR_succip;
	if ((MR_r1 == MR_r2)) {
		MR_GOTO_LAB(__Compare___display__table_row_0_0_i44);
	}
	MR_sv(1) = MR_r1;
	MR_sv(2) = MR_r2;
	{
	...
	MR_tempr1 = MR_tag(MR_sv(1));
	if ((MR_tempr1 == MR_mktag((MR_Integer) 2))) {
		MR_GOTO_LAB(__Compare___display__table_row_0_0_i13);
	}
	if ((MR_tempr1 == MR_mktag((MR_Integer) 1))) {
	...
	MR_tempr1 = MR_tag(MR_sv(2));
	if ((MR_tempr1 == MR_mktag((MR_Integer) 2))) {
		MR_GOTO_LAB(__Compare___display__table_row_0_0_i46);
	}
	if ((MR_tempr1 == MR_mktag((MR_Integer) 1))) {
		MR_GOTO_LAB(__Compare___display__table_row_0_0_i39);
	}
	}
MR_def_label(__Compare___display__table_row_0_0,44)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Integer) 0;
	MR_decr_sp_and_return(3);
...
MR_def_label(__Compare___display__table_row_0_0,46)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Integer) 1;
	MR_decr_sp_and_return(3);
MR_def_label(__Compare___display__table_row_0_0,7)
	...
	MR_decr_sp(3);
	MR_np_tailcall_ent(__Compare___list__list_1_0);
MR_def_label(__Compare___display__table_row_0_0,13)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_tag(MR_sv(2));
...
MR_def_label(__Compare___display__table_row_0_0,39)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Integer) 2;
	MR_decr_sp_and_return(3);
