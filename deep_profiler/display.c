...
{
  {
    ...
    else
    {
      ...
      else
      {
        ...
        mercury__private_builtin__builtin_compare_int_3_p_0(&SubResult2_9, Var_17, Var_18);
              ...
              case (MR_Integer) 2:
                {
                  ...
                  if (succeeded)
                    *HeadVar__1_1 = SubResult1_15;
                    ...
                    mercury__private_builtin__builtin_compare_int_3_p_0(HeadVar__1_1, Var_29, ArgY2_17);
                }
                break;
            }
          }
                      ...
                      case (MR_Integer) 1:
                        {
                          ...
                          else
                          {
                            ...
                            mercury__private_builtin__builtin_compare_int_3_p_0(&SubResult2_75, Var_188, Var_189);
                            succeeded = (SubResult2_75 != (MR_Integer) 0);
                            if (succeeded)
                              *HeadVar__1_1 = SubResult2_75;
                            else
                              mercury__private_builtin__builtin_compare_int_3_p_0(HeadVar__1_1, Var_182, ArgY3_77);
                          }
                        }
                        break;
                      case (MR_Integer) 2:
                      ...
                      case (MR_Integer) 3:
                        {
                          ...
                          mercury__private_builtin__builtin_compare_int_3_p_0(&SubResult1_111, Var_208, Var_209);
