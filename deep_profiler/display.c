...
MR_decl_label10(__Unify___display__display_item_0_0, 157,5,6,10,14,18,22,20,26,59)
...
MR_decl_label6(__Unify___display__table_row_0_0, 64,5,6,26,10,1)
MR_decl_label4(__Compare___display__attr_string_0_0, 3,2,5,27)
MR_decl_label6(__Compare___display__deep_link_0_0, 3,2,5,9,13,49)
MR_decl_label4(__Compare___display__display_0_0, 3,2,5,27)
MR_decl_label10(__Compare___display__display_item_0_0, 594,198,7,8,9,10,11,12,13,5)
...
MR_decl_label9(__Compare___display__display_item_0_0, 104,105,191,106,107,108,109,195,667)
MR_decl_label4(__Compare___display__pseudo_link_0_0, 3,2,5,21)
MR_decl_label6(__Compare___display__table_0_0, 3,2,5,9,13,49)
...
MR_decl_label7(__Compare___display__table_header_group_columns_0_0, 3,2,9,7,5,15,55)
MR_decl_label10(__Compare___display__table_row_0_0, 111,46,7,8,5,12,13,10,18,19)
MR_decl_label6(__Compare___display__table_row_0_0, 16,23,42,24,43,25)
...
{
MR_LIST_CTOR_ADDR,
MR_CTOR0_ADDR(display, str_attr)
}
},
{
{
...
{
MR_CTOR1_ADDR(maybe, maybe),
MR_CTOR0_ADDR(display, table_header)
}
},
{
{
...
const MR_PseudoTypeInfo mercury_data_display__field_types_table_row_0_3[] = {
	(MR_PseudoTypeInfo) &mercury_data_display__type_ctor_info_table_row_0
};

const MR_ConstString mercury_data_display__field_names_table_row_0_3[] = {
	"tdr_row"
};

static const MR_DuFunctorDesc mercury_data_display__du_functor_desc_table_row_0_3 = {
	"table_developer_row",
	1,
	0,
	MR_SECTAG_NONE,
	...
	-1,
	3,
	(MR_PseudoTypeInfo *) mercury_data_display__field_types_table_row_0_3,
	mercury_data_display__field_names_table_row_0_3,
	NULL,
	NULL
};
...
const MR_DuFunctorDescPtr mercury_data_display__du_stag_ordered_table_row_0_3[] = {
	&mercury_data_display__du_functor_desc_table_row_0_3
...
const MR_DuPtagLayout mercury_data_display__du_ptag_ordered_table_row_0[] = {
	...
	{ 1, MR_SECTAG_NONE,
	mercury_data_display__du_stag_ordered_table_row_0_3 }
...
MR_BEGIN_MODULE(display_module5)
	...
	MR_init_label4(__Compare___display__attr_string_0_0,3,2,5,27)
MR_BEGIN_CODE
...
MR_def_label(__Compare___display__attr_string_0_0,5)
	...
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___display__attr_string_0_0_i27);
	}
	MR_r1 = MR_sv(1);
	MR_r2 = MR_sv(2);
...
MR_def_label(__Compare___display__attr_string_0_0,27)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(3);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
...
MR_BEGIN_MODULE(display_module7)
	...
	MR_init_label6(__Compare___display__deep_link_0_0,3,2,5,9,13,49)
MR_BEGIN_CODE
...
MR_def_label(__Compare___display__deep_link_0_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___display__deep_link_0_0_i49);
	}
	MR_r1 = (MR_Word) MR_TAG_COMMON(0,0,1);
	MR_r2 = MR_sv(1);
	MR_r3 = MR_sv(4);
...
MR_def_label(__Compare___display__deep_link_0_0,49)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(7);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
...
MR_BEGIN_MODULE(display_module9)
	...
	MR_init_label4(__Compare___display__display_0_0,3,2,5,27)
MR_BEGIN_CODE
...
MR_def_label(__Compare___display__display_0_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___display__display_0_0_i27);
	}
	MR_r1 = (MR_Word) MR_TAG_COMMON(0,0,3);
	MR_r2 = MR_sv(1);
	MR_r3 = MR_sv(2);
...
MR_def_label(__Compare___display__display_0_0,27)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(3);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
...
MR_BEGIN_MODULE(display_module10)
	...
	MR_init_label10(__Unify___display__display_item_0_0,157,5,6,10,14,18,22,20,26,59)
...
MR_define_entry(mercury____Unify___display__display_item_0_0);
	...
	MR_incr_sp(3);
	MR_sv(3) = (MR_Word) MR_succip;
MR_def_label(__Unify___display__display_item_0_0,157)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if ((MR_r1 == MR_r2)) {
...
MR_def_label(__Unify___display__display_item_0_0,10)
	...
	MR_succip_word = MR_sv(3);
	MR_GOTO_LAB(__Unify___display__display_item_0_0_i157);
...
MR_BEGIN_MODULE(display_module11)
	...
	MR_init_label10(__Compare___display__display_item_0_0,594,198,7,8,9,10,11,12,13,5)
	...
	MR_init_label9(__Compare___display__display_item_0_0,104,105,191,106,107,108,109,195,667)
MR_BEGIN_CODE
...
MR_def_label(__Compare___display__display_item_0_0,594)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if ((MR_r1 == MR_r2)) {
...
MR_def_label(__Compare___display__display_item_0_0,41)
	...
	MR_r2 = MR_tfield(3, MR_sv(2), 1);
	MR_succip_word = MR_sv(5);
	MR_GOTO_LAB(__Compare___display__display_item_0_0_i594);
...
MR_def_label(__Compare___display__display_item_0_0,68)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___display__display_item_0_0_i667);
	}
	MR_r1 = (MR_Word) MR_TAG_COMMON(0,0,2);
	MR_r2 = MR_sv(4);
	MR_r3 = MR_sv(1);
...
MR_def_label(__Compare___display__display_item_0_0,195)
	...
	MR_r1 = (MR_Integer) 2;
	MR_decr_sp_and_return(5);
MR_def_label(__Compare___display__display_item_0_0,667)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(5);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
...
MR_BEGIN_MODULE(display_module21)
	...
	MR_init_label6(__Compare___display__table_0_0,3,2,5,9,13,49)
MR_BEGIN_CODE
...
MR_def_label(__Compare___display__table_0_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___display__table_0_0_i49);
	}
	MR_r1 = MR_sv(1);
	MR_r2 = MR_sv(4);
	MR_np_call_localret_ent(private_builtin__builtin_compare_int_3_0,
...
MR_def_label(__Compare___display__table_0_0,13)
	...
	MR_decr_sp(7);
	MR_np_tailcall_ent(builtin__compare_3_0);
MR_def_label(__Compare___display__table_0_0,49)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(7);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
...
MR_BEGIN_MODULE(display_module37)
	...
	MR_init_label7(__Compare___display__table_header_group_columns_0_0,3,2,9,7,5,15,55)
MR_BEGIN_CODE
...
MR_def_label(__Compare___display__table_header_group_columns_0_0,9)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___display__table_header_group_columns_0_0_i55);
	}
	MR_r1 = (MR_Word) MR_TAG_COMMON(0,0,7);
	MR_r2 = MR_sv(2);
	MR_r3 = MR_sv(1);
...
MR_def_label(__Compare___display__table_header_group_columns_0_0,15)
	...
	MR_decr_sp(3);
	MR_np_tailcall_ent(__Compare___display__table_data_0_0);
MR_def_label(__Compare___display__table_header_group_columns_0_0,55)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(3);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
...
MR_BEGIN_MODULE(display_module38)
	...
	MR_init_label6(__Unify___display__table_row_0_0,64,5,6,26,10,1)
MR_BEGIN_CODE
...
MR_define_entry(mercury____Unify___display__table_row_0_0);
	...
	MR_incr_sp(3);
	MR_sv(3) = (MR_Word) MR_succip;
MR_def_label(__Unify___display__table_row_0_0,64)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if ((MR_r1 == MR_r2)) {
		MR_GOTO_LAB(__Unify___display__table_row_0_0_i26);
	}
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
...
MR_def_label(__Unify___display__table_row_0_0,5)
	...
	MR_GOTO_LAB(__Unify___display__table_row_0_0_i64);
MR_def_label(__Unify___display__table_row_0_0,6)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_sv(1),1)) {
		MR_GOTO_LAB(__Unify___display__table_row_0_0_i10);
	}
	if (MR_PTAG_TESTR(MR_sv(2),1)) {
		MR_GOTO_LAB(__Unify___display__table_row_0_0_i1);
	}
	...
	MR_decr_sp(3);
	MR_np_tailcall_ent(builtin__unify_2_0);
MR_def_label(__Unify___display__table_row_0_0,26)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_TRUE;
	MR_decr_sp_and_return(3);
MR_def_label(__Unify___display__table_row_0_0,10)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_sv(2),2)) {
		MR_GOTO_LAB(__Unify___display__table_row_0_0_i1);
	}
...
MR_BEGIN_MODULE(display_module39)
	...
	MR_init_label10(__Compare___display__table_row_0_0,111,46,7,8,5,12,13,10,18,19)
	MR_init_label6(__Compare___display__table_row_0_0,16,23,42,24,43,25)
MR_BEGIN_CODE
...
MR_define_entry(mercury____Compare___display__table_row_0_0);
	...
	MR_incr_sp(3);
	MR_sv(3) = (MR_Word) MR_succip;
MR_def_label(__Compare___display__table_row_0_0,111)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if ((MR_r1 == MR_r2)) {
...
MR_def_label(__Compare___display__table_row_0_0,7)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_sv(2),3)) {
		MR_GOTO_LAB(__Compare___display__table_row_0_0_i8);
	}
	MR_r1 = (MR_Integer) 1;
	MR_decr_sp_and_return(3);
MR_def_label(__Compare___display__table_row_0_0,8)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_sv(2),1)) {
		MR_GOTO_LAB(__Compare___display__table_row_0_0_i42);
	}
	MR_r1 = (MR_Integer) 2;
	MR_decr_sp_and_return(3);
MR_def_label(__Compare___display__table_row_0_0,5)
	...
	if (MR_LTAGS_TESTR(MR_sv(2),0,0)) {
		MR_GOTO_LAB(__Compare___display__table_row_0_0_i12);
	}
	MR_r1 = (MR_Integer) 2;
	MR_decr_sp_and_return(3);
MR_def_label(__Compare___display__table_row_0_0,12)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_sv(2),3)) {
	...
	MR_r1 = MR_tfield(3, MR_sv(1), 0);
	MR_r2 = MR_tfield(3, MR_sv(2), 0);
	MR_GOTO_LAB(__Compare___display__table_row_0_0_i111);
MR_def_label(__Compare___display__table_row_0_0,13)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_sv(2),1)) {
		MR_GOTO_LAB(__Compare___display__table_row_0_0_i43);
	}
	MR_r1 = (MR_Integer) 2;
	MR_decr_sp_and_return(3);
MR_def_label(__Compare___display__table_row_0_0,10)
	...
	if (MR_LTAGS_TESTR(MR_sv(2),0,0)) {
		MR_GOTO_LAB(__Compare___display__table_row_0_0_i18);
	}
	MR_r1 = (MR_Integer) 1;
	MR_decr_sp_and_return(3);
MR_def_label(__Compare___display__table_row_0_0,18)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_sv(2),3)) {
		MR_GOTO_LAB(__Compare___display__table_row_0_0_i19);
	}
	MR_r1 = (MR_Integer) 1;
	MR_decr_sp_and_return(3);
MR_def_label(__Compare___display__table_row_0_0,19)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_sv(2),1)) {
		MR_GOTO_LAB(__Compare___display__table_row_0_0_i42);
	}
...
MR_def_label(__Compare___display__table_row_0_0,16)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_sv(2),0,0)) {
		MR_GOTO_LAB(__Compare___display__table_row_0_0_i23);
	}
	MR_r1 = (MR_Integer) 2;
	MR_decr_sp_and_return(3);
MR_def_label(__Compare___display__table_row_0_0,23)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_sv(2),3)) {
		MR_GOTO_LAB(__Compare___display__table_row_0_0_i24);
	}
MR_def_label(__Compare___display__table_row_0_0,42)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Integer) 1;
	MR_decr_sp_and_return(3);
MR_def_label(__Compare___display__table_row_0_0,24)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_sv(2),1)) {
		MR_GOTO_LAB(__Compare___display__table_row_0_0_i25);
	}
MR_def_label(__Compare___display__table_row_0_0,43)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Integer) 2;
	MR_decr_sp_and_return(3);
MR_def_label(__Compare___display__table_row_0_0,25)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_tfield(2, MR_sv(1), 0);
	MR_r2 = MR_tfield(2, MR_sv(2), 0);
	MR_succip_word = MR_sv(3);
...
void mercury__display__write_out_proc_statics(FILE *deep_fp, FILE *procrep_fp)
{
	MR_write_out_module_proc_reps_start(procrep_fp, &mercury_data__module_layout__display);
