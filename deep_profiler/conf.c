  ...
  MR_String * Machine_4)
{
  ...
  if ((MaybeServerName_19 == (MR_Word) ((MR_Unsigned) 0U)))
  {
    ...
    mercury__io__file__make_temp_file_3_p_0(&TmpFileResult_27);
...
#undef MR_PROC_LABEL
	HostnameCmd_29  = Hostname;
      ...
      mercury__io__call_system__call_system_4_p_0(ServerRedirectCmd_30, &Res1_31);
      ...
      else
      {
        ...
        if (succeeded)
        {
          ...
          mercury__io__file__remove_file_4_p_0(TmpFile_28, &Var_41);
        }
        else
          {
            mercury__require__unexpected_2_p_0((MR_String) "predicate \140conf.server_name_2\'/3", (MR_String) "cannot execute cmd to find the server\'s name");
