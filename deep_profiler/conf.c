...
{
  {
    ...
    mercury__io__get_environment_var_4_p_0((MR_String) "SCRIPT_NAME", &MaybeScriptName_6);
    if ((MaybeScriptName_6 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
...
{
  {
    ...
    mercury__io__get_environment_var_4_p_0((MR_String) "SERVER_NAME", &MaybeServerName_19);
    if ((MaybeServerName_19 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
    {
      MR_Word TmpFileResult_27;

      mercury__io__make_temp_file_3_p_0(&TmpFileResult_27);
      if (((MR_tag((MR_Word) TmpFileResult_27)) == (MR_mktag((MR_Integer) 1))))
      {
        {
      ...
      {
        MR_String TmpFile_28 = ((MR_String) (MR_hl_field(MR_mktag(0), TmpFileResult_27, (MR_Integer) 0)));
        MR_String HostnameCmd_29;
        MR_String ServerRedirectCmd_30;
        MR_Word Res1_31;
        MR_String Var_76;
...
#define MR_PROC_LABEL conf__server_name_port_3_p_0
    ...
    Hostname = (MR_String) (MR_Integer) MR_HOSTNAMECMD;
		...
		;}
#undef MR_PROC_LABEL
	 HostnameCmd_29  = Hostname;
}
        Var_76 = mercury__string__f_43_43_2_f_0((MR_String) " > ", TmpFile_28);
        ServerRedirectCmd_30 = mercury__string__f_43_43_2_f_0(HostnameCmd_29, Var_76);
        mercury__io__call_system_4_p_0(ServerRedirectCmd_30, &Res1_31);
        if (((MR_tag((MR_Word) Res1_31)) == (MR_mktag((MR_Integer) 1))))
        {
          {
        ...
        {
          MR_Integer ResCode_32 = ((MR_Integer) (MR_hl_field(MR_mktag(0), Res1_31, (MR_Integer) 0)));

          succeeded = (ResCode_32 == (MR_Integer) 0);
          if (succeeded)
          {
            MR_Word TmpRes_33;
            MR_Word Var_41;

            mercury__io__open_input_4_p_0(TmpFile_28, &TmpRes_33);
            if (((MR_tag((MR_Word) TmpRes_33)) == (MR_mktag((MR_Integer) 1))))
            {
              {
            ...
            {
              MR_Word TmpStream_34 = ((MR_Word) (MR_hl_field(MR_mktag(0), TmpRes_33, (MR_Integer) 0)));
              MR_Word TmpReadRes_35;

              mercury__io__read_file_as_string_4_p_0(TmpStream_34, &TmpReadRes_35);
              if (((MR_tag((MR_Word) TmpReadRes_35)) == (MR_mktag((MR_Integer) 1))))
              {
                {
              ...
              {
                MR_String ServerNameNl_36 = ((MR_String) (MR_hl_field(MR_mktag(0), TmpReadRes_35, (MR_Integer) 0)));
                MR_String ServerNamePrime_37;

                succeeded = mercury__string__remove_suffix_3_p_0(ServerNameNl_36, (MR_String) "\n", &ServerNamePrime_37);
                if (succeeded)
                  ServerName_6 = ServerNamePrime_37;
                else
                {
                  {
              ...
              mercury__io__close_input_3_p_0(TmpStream_34);
            }
            mercury__io__remove_file_4_p_0(TmpFile_28, &Var_41);
          }
          else
          {
            {
    ...
    mercury__io__get_environment_var_4_p_0((MR_String) "SERVER_PORT", &MaybeServerPort_7);
    if ((MaybeServerPort_7 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
...
#undef MR_PROC_LABEL
    ...
    else
    {
      ...
      Var_16 = mercury__string__f_43_43_2_f_0((MR_String) " ", PipeName_3);
      Cmd_4 = mercury__string__f_43_43_2_f_0(CmdName_5, Var_16);
    }
    return Cmd_4;
  }
}
