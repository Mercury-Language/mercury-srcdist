  ...
  MR_String * Machine_4)
{
  ...
  if ((MaybeServerName_15 == (MR_Word) ((MR_Unsigned) 0U)))
  {
    ...
    {
      MR_String TmpFile_19 = ((MR_String) ((MR_hl_field(MR_mktag(0), TmpFileResult_18, (MR_Integer) 0))));
...
#undef MR_PROC_LABEL
	HostnameCmd_20  = Hostname;
      ...
      {
        MR_Integer ResCode_23 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), Res1_22, (MR_Integer) 0))));
        ...
        if (succeeded)
        {
          ...
          {
            MR_Word TmpStream_25 = ((MR_Word) ((MR_hl_field(MR_mktag(0), TmpRes_24, (MR_Integer) 0))));
            ...
            {
              MR_String ServerNameNl_27 = ((MR_String) ((MR_hl_field(MR_mktag(0), TmpReadRes_26, (MR_Integer) 0))));
    ...
    ServerName_6 = ((MR_String) ((MR_hl_field(MR_mktag(1), MaybeServerName_15, (MR_Integer) 0))));
