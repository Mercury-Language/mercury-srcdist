...
{
  {
    ...
    if ((MaybeServerName_19 == (MR_Word) ((MR_Integer) 0)))
    {
      ...
      if (((MR_tag((MR_Word) TmpFileResult_27)) == (MR_Integer) 1))
      {
        {
...
#undef MR_PROC_LABEL
	 HostnameCmd_29  = Hostname;
        ...
        if (((MR_tag((MR_Word) Res1_31)) == (MR_Integer) 1))
        {
          {
        ...
        else
        {
          ...
          if (succeeded)
          {
            ...
            if (((MR_tag((MR_Word) TmpRes_33)) == (MR_Integer) 1))
            {
              {
            ...
            else
            {
              ...
              if (((MR_tag((MR_Word) TmpReadRes_35)) == (MR_Integer) 1))
              {
                {
