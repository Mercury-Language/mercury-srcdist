...
#undef MR_PROC_LABEL
	 conf__HostnameCmd_29  = Hostname;
            ...
            {
              conf__V_76_76 = mercury__string__f_43_43_2_f_0((MR_String) " > ", conf__TmpFile_28);
            }
            {
              conf__ServerRedirectCmd_30 = mercury__string__f_43_43_2_f_0(conf__HostnameCmd_29, conf__V_76_76);
            }
            {
                ...
                if (conf__succeeded)
                  {
                    ...
                    {
                      mercury__io__remove_file_4_p_0(conf__TmpFile_28, &conf__V_41_41);
                    }
                  }
                else
                  {
...
#undef MR_PROC_LABEL
    ...
    if (conf__succeeded)
      ...
      {
        MR_String conf__V_16_16;

        {
          conf__V_16_16 = mercury__string__f_43_43_2_f_0((MR_String) " ", conf__PipeName_3);
        }
        {
          conf__Cmd_4 = mercury__string__f_43_43_2_f_0(conf__CmdName_5, conf__V_16_16);
        }
      }
    return conf__Cmd_4;
  }
