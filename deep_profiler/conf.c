...
MR_decl_label8(conf__server_name_port_3_0, 2,5,10,11,16,19,23,22)
MR_decl_label8(conf__server_name_port_3_0, 21,20,28,18,17,30,14,13)
MR_decl_label5(conf__server_name_port_3_0, 4,3,34,36,37)
...
MR_BEGIN_MODULE(conf_module3)
	...
	MR_init_label8(conf__server_name_port_3_0,2,5,10,11,16,19,23,22)
	MR_init_label8(conf__server_name_port_3_0,21,20,28,18,17,30,14,13)
	MR_init_label5(conf__server_name_port_3_0,4,3,34,36,37)
MR_BEGIN_CODE
...
#undef	MR_PROC_LABEL
	...
	MR_np_call_localret_ent(fn__string__format_2_0,
		conf__server_name_port_3_0_i10);
...
MR_def_label(conf__server_name_port_3_0,11)
	...
	if (MR_PTAG_TESTR(MR_r1,0)) {
		MR_GOTO_LAB(conf__server_name_port_3_0_i13);
	}
	MR_r3 = MR_ctfield(0, MR_r1, 0);
	if (MR_INT_NE(MR_r3,0)) {
		MR_GOTO_LAB(conf__server_name_port_3_0_i14);
	}
	MR_r1 = MR_sv(2);
...
MR_def_label(conf__server_name_port_3_0,16)
	...
	MR_np_call_localret_ent(io__read_file_as_string_4_0,
		conf__server_name_port_3_0_i19);
MR_def_label(conf__server_name_port_3_0,19)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_r1,0)) {
		MR_GOTO_LAB(conf__server_name_port_3_0_i21);
	}
...
MR_def_label(conf__server_name_port_3_0,23)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(conf__server_name_port_3_0_i22);
	}
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_sv(1);
	...
	MR_np_call_localret_ent(io__close_input_3_0,
		conf__server_name_port_3_0_i28);
MR_def_label(conf__server_name_port_3_0,22)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_string_const("malformed server name", 21);
	MR_np_call_localret_ent(require__error_1_0,
		conf__server_name_port_3_0_i20);
MR_def_label(conf__server_name_port_3_0,21)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_def_label(conf__server_name_port_3_0,20)
	...
	MR_np_call_localret_ent(io__close_input_3_0,
		conf__server_name_port_3_0_i28);
MR_def_label(conf__server_name_port_3_0,28)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(2);
	MR_np_call_localret_ent(io__remove_file_4_0,
		conf__server_name_port_3_0_i30);
...
MR_def_label(conf__server_name_port_3_0,17)
	...
	MR_np_call_localret_ent(io__remove_file_4_0,
		conf__server_name_port_3_0_i30);
MR_def_label(conf__server_name_port_3_0,30)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_def_label(conf__server_name_port_3_0,34)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
		MR_GOTO_LAB(conf__server_name_port_3_0_i36);
	}
	MR_r1 = MR_sv(1);
	MR_decr_sp_and_return(3);
MR_def_label(conf__server_name_port_3_0,36)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
	...
	MR_np_call_localret_ent(fn__f_115_116_114_105_110_103_95_95_43_43_2_0,
		conf__server_name_port_3_0_i37);
MR_def_label(conf__server_name_port_3_0,37)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
