...
MR_decl_label2(__Unify___mdbcomp__feedback__automatic_parallelism__candidate_par_conjunctions_params_0_0, 6,1)
...
MR_decl_label4(__Compare___mdbcomp__feedback__automatic_parallelism__candidate_par_conjunctions_params_0_0, 37,41,45,101)
...
MR_decl_static(mdbcomp__feedback__automatic_parallelism__IntroducedFrom__pred__convert_candidate_par_conjunction__404__1_6_0)
...
static const MR_EnumFunctorDesc mercury_data_mdbcomp__feedback__automatic_parallelism__enum_functor_desc_parallelise_dep_conjs_0_0 = {
	"parallelise_dep_conjs_overlap",
	0
};

static const MR_EnumFunctorDesc mercury_data_mdbcomp__feedback__automatic_parallelism__enum_functor_desc_parallelise_dep_conjs_0_1 = {
	"parallelise_dep_conjs_num_vars",
	1
};

static const MR_EnumFunctorDesc mercury_data_mdbcomp__feedback__automatic_parallelism__enum_functor_desc_parallelise_dep_conjs_0_2 = {
	"parallelise_dep_conjs_naive",
	2
};

static const MR_EnumFunctorDesc mercury_data_mdbcomp__feedback__automatic_parallelism__enum_functor_desc_parallelise_dep_conjs_0_3 = {
	"do_not_parallelise_dep_conjs",
	3
};

const MR_EnumFunctorDescPtr mercury_data_mdbcomp__feedback__automatic_parallelism__enum_value_ordered_parallelise_dep_conjs_0[] = {
	&mercury_data_mdbcomp__feedback__automatic_parallelism__enum_functor_desc_parallelise_dep_conjs_0_0,
	&mercury_data_mdbcomp__feedback__automatic_parallelism__enum_functor_desc_parallelise_dep_conjs_0_1,
	&mercury_data_mdbcomp__feedback__automatic_parallelism__enum_functor_desc_parallelise_dep_conjs_0_2,
	&mercury_data_mdbcomp__feedback__automatic_parallelism__enum_functor_desc_parallelise_dep_conjs_0_3
};

const MR_EnumFunctorDescPtr mercury_data_mdbcomp__feedback__automatic_parallelism__enum_name_ordered_parallelise_dep_conjs_0[] = {
	&mercury_data_mdbcomp__feedback__automatic_parallelism__enum_functor_desc_parallelise_dep_conjs_0_3,
	&mercury_data_mdbcomp__feedback__automatic_parallelism__enum_functor_desc_parallelise_dep_conjs_0_2,
	&mercury_data_mdbcomp__feedback__automatic_parallelism__enum_functor_desc_parallelise_dep_conjs_0_1,
	&mercury_data_mdbcomp__feedback__automatic_parallelism__enum_functor_desc_parallelise_dep_conjs_0_0
...
const MR_TypeCtorInfo_Struct mercury_data_mdbcomp__feedback__automatic_parallelism__type_ctor_info_parallelise_dep_conjs_0 = {
	...
	{ (void *)mercury_data_mdbcomp__feedback__automatic_parallelism__enum_name_ordered_parallelise_dep_conjs_0 },
	{ (void *)mercury_data_mdbcomp__feedback__automatic_parallelism__enum_value_ordered_parallelise_dep_conjs_0 },
	4,
	4,
...
"mdbcomp.feedback.automatic_parallelism",
"mdbcomp.feedback.automatic_parallelism",
"lambda_feedback_automatic_parallelism_m_404",
6,
0
},
"mdbcomp.feedback.automatic_parallelism",
...
MR_define_entry(mercury__mdbcomp__feedback__automatic_parallelism__convert_candidate_par_conjunction_3_0);
	...
	MR_tfield(0, MR_tempr1, 1) = (MR_Word) MR_ENTRY_AP(mdbcomp__feedback__automatic_parallelism__IntroducedFrom__pred__convert_candidate_par_conjunction__404__1_6_0);
...
MR_define_entry(mercury____Unify___mdbcomp__feedback__automatic_parallelism__candidate_par_conjunction_1_0);
	...
	MR_sv(15) = MR_tfield(0, MR_tempr4, 8);
...
MR_def_label(__Unify___mdbcomp__feedback__automatic_parallelism__candidate_par_conjunction_1_0,13)
	...
	if ((MR_word_to_float(MR_sv(7)) != MR_word_to_float(MR_sv(15)))) {
		MR_GOTO_LAB(__Unify___mdbcomp__feedback__automatic_parallelism__candidate_par_conjunction_1_0_i1);
	}
	MR_r1 = MR_sv(8);
	MR_r2 = MR_sv(16);
...
MR_BEGIN_MODULE(mdbcomp__feedback__automatic_parallelism_module13)
	...
	MR_init_label2(__Unify___mdbcomp__feedback__automatic_parallelism__candidate_par_conjunctions_params_0_0,6,1)
MR_BEGIN_CODE
...
MR_define_entry(mercury____Unify___mdbcomp__feedback__automatic_parallelism__candidate_par_conjunctions_params_0_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if ((MR_r1 == MR_r2)) {
		MR_GOTO_LAB(__Unify___mdbcomp__feedback__automatic_parallelism__candidate_par_conjunctions_params_0_0_i6);
	}
	MR_incr_sp(3);
	MR_sv(3) = (MR_Word) MR_succip;
	{
...
MR_def_label(__Unify___mdbcomp__feedback__automatic_parallelism__candidate_par_conjunctions_params_0_0,6)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_TRUE;
	MR_proceed();
...
MR_BEGIN_MODULE(mdbcomp__feedback__automatic_parallelism_module14)
	...
	MR_init_label4(__Compare___mdbcomp__feedback__automatic_parallelism__candidate_par_conjunctions_params_0_0,37,41,45,101)
MR_BEGIN_CODE
...
MR_def_label(__Compare___mdbcomp__feedback__automatic_parallelism__candidate_par_conjunctions_params_0_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___mdbcomp__feedback__automatic_parallelism__candidate_par_conjunctions_params_0_0_i101);
	}
	MR_r1 = MR_sv(1);
	MR_r2 = MR_sv(12);
	MR_np_call_localret_ent(private_builtin__builtin_compare_int_3_0,
...
MR_def_label(__Compare___mdbcomp__feedback__automatic_parallelism__candidate_par_conjunctions_params_0_0,101)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_BEGIN_MODULE(mdbcomp__feedback__automatic_parallelism_module37)
	MR_init_entry1(mdbcomp__feedback__automatic_parallelism__IntroducedFrom__pred__convert_candidate_par_conjunction__404__1_6_0);
	MR_INIT_PROC_LAYOUT_ADDR(mercury__mdbcomp__feedback__automatic_parallelism__IntroducedFrom__pred__convert_candidate_par_conjunction__404__1_6_0);
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'IntroducedFrom__pred__convert_candidate_par_conjunction__404__1'/6 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(mdbcomp__feedback__automatic_parallelism__IntroducedFrom__pred__convert_candidate_par_conjunction__404__1_6_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_r3;
	MR_r2 = MR_r4;
	MR_r3 = MR_r5;
	MR_set_prof_ho_caller_proc(MR_ENTRY_AP(mdbcomp__feedback__automatic_parallelism__IntroducedFrom__pred__convert_candidate_par_conjunction__404__1_6_0));
