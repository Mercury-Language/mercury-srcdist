...
{
  {
    ...
    else
    {
      ...
      else
      {
        ...
        mercury__builtin__compare_3_p_0((MR_Word) (&mdbcomp__feedback__automatic_parallelism_scalar_common_1[6]), &SubResult2_9, ((MR_Box) (ArgX2_7)), ((MR_Box) (ArgY2_8)));
...
{
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        TypeInfo_26_26 = (MR_Word) (&mdbcomp__feedback__automatic_parallelism_scalar_common_1[6]);
...
{
  {
    ...
    else
    {
      ...
      else
      {
        ...
        mercury__builtin__compare_3_p_0((MR_Word) (&mdbcomp__feedback__automatic_parallelism_scalar_common_1[5]), &SubResult2_9, ((MR_Box) (ArgX2_7)), ((MR_Box) (ArgY2_8)));
        succeeded = (SubResult2_9 != (MR_Integer) 0);
        if (succeeded)
          *HeadVar__1_1 = SubResult2_9;
        else
...
{
  {
    ...
    mercury__builtin__compare_3_p_0((MR_Word) (&mdbcomp__feedback__automatic_parallelism_scalar_common_1[4]), HeadVar__1_1, ((MR_Box) (Cast_HeadVar1_4)), ((MR_Box) (Cast_HeadVar2_5)));
  }
}
...
{
  {
    ...
    else
    {
      ...
      else
      {
        ...
        mercury__builtin__compare_3_p_0((MR_Word) (&mdbcomp__feedback__automatic_parallelism_scalar_common_1[3]), HeadVar__1_1, ((MR_Box) (Var_11)), ((MR_Box) (ArgY1_5)));
      }
    }
  }
}
...
{
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        TypeInfo_9_9 = (MR_Word) (&mdbcomp__feedback__automatic_parallelism_scalar_common_1[3]);
    ...
    else
    {
      ...
      else
      {
        ...
        else
        {
          ...
          mercury__builtin__compare_3_p_0((MR_Word) (&mdbcomp__feedback__automatic_parallelism_scalar_common_1[1]), &SubResult3_12, ((MR_Box) (ArgX3_10)), ((MR_Box) (ArgY3_11)));
          succeeded = (SubResult3_12 != (MR_Integer) 0);
          if (succeeded)
            *HeadVar__1_1 = SubResult3_12;
          else
          {
            mercury__builtin__compare_3_p_0((MR_Word) (&mdbcomp__feedback__automatic_parallelism_scalar_common_1[1]), HeadVar__1_1, ((MR_Box) (ArgX4_13)), ((MR_Box) (ArgY4_14)));
          }
        }
      }
    }
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            TypeInfo_14_14 = (MR_Word) (&mdbcomp__feedback__automatic_parallelism_scalar_common_1[1]);
    ...
    else
    {
      ...
      else
      {
        ...
        else
        {
          ...
          {
            mercury__builtin__compare_3_p_0((MR_Word) (&mdbcomp__feedback__automatic_parallelism_scalar_common_1[0]), HeadVar__1_1, ((MR_Box) (ArgX4_13)), ((MR_Box) (ArgY4_14)));
          }
        }
      }
    }
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            TypeInfo_13_13 = (MR_Word) (&mdbcomp__feedback__automatic_parallelism_scalar_common_1[0]);
