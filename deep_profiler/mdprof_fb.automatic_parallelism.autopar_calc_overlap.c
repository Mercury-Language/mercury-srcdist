  ...
  MR_Float * STATE_VARIABLE_DeadTime_6)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      /* direct tailcall eliminated */
      {
        MR_Word next_value_of_HeadVar__1_1 = Executions_16;
        MR_Float next_value_of_LastStop_2 = Stop_15;
        MR_Float next_value_of_STATE_VARIABLE_Time_0_3 = STATE_VARIABLE_Time_25_25;
        MR_Float next_value_of_STATE_VARIABLE_DeadTime_0_5 = STATE_VARIABLE_DeadTime_27_27;
