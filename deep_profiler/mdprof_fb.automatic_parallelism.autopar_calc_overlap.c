...
{
  {
    ...
    if ((HeadVar__1_1 == (MR_Word) ((MR_Integer) 0)))
      ...
      else
      {
        ...
        mdprof_fb__automatic_parallelism__autopar_calc_overlap__merge_consumptions_and_productions_3_p_0((MR_Word) ((MR_Integer) 0), Prods0_6, &Prods_7);
        {
          MR_Word base;
    ...
    else
    {
      ...
      if ((HeadVar__2_2 == (MR_Word) ((MR_Integer) 0)))
      {
        ...
        mdprof_fb__automatic_parallelism__autopar_calc_overlap__merge_consumptions_and_productions_3_p_0(Var_34, (MR_Word) ((MR_Integer) 0), &Cons_15);
        {
          MR_Word base;
          base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
          *HeadVar__3_3 = base;
...
{
  {
    ...
    if ((STATE_VARIABLE_Executions_0_19 == (MR_Word) ((MR_Integer) 0)))
    {
      {
  ...
  MR_Word * STATE_VARIABLE_Executions_16)
{
  while (MR_TRUE)
  {
    ...
    ;
    if ((STATE_VARIABLE_Executions_0_15 == (MR_Word) ((MR_Integer) 0)))
    {
      {
...
{
  {
    ...
    if ((Algorithm_21 == (MR_Word) ((MR_Integer) 0)))
    {
      MR_Word Var_75;
      MR_Float Var_76;
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(1), Execution_46, 1) = ((MR_Box) ((MR_Integer) 0));
      }
...
{
  {
    ...
    Var_51 = mercury__map__init_0_f_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0), (MR_Word) (&mercury__builtin__builtin__type_ctor_info_float_0));
    {
      ...
      MR_hl_field(MR_mktag(0), CostData0_23, 1) = ((MR_Box) ((MR_Integer) 0));
...
{
  {
    ...
    if ((MaybeCost_14 == (MR_Word) ((MR_Integer) 0)))
    {
      MR_Word Goals_16;
      MR_Word Var_20;
