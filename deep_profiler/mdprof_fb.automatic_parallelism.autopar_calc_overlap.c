  ...
  MR_Word * STATE_VARIABLE_Map_12)
{
  ...
  switch (UseType_25) {
    ...
    case (MR_Integer) 2:
      {
        MR_Word Var_33;
        MR_Word Var_34 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Goal_7, (MR_Integer) 2))));

        Var_33 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_34, (MR_Integer) 4))));
        UseTime_26 = measurements__goal_cost_get_percall_1_f_0(Var_33);
      }
      break;
    case (MR_Integer) 0:
      UseTime_26 = Var_53;
