  ...
  MR_Word * HeadVar__4_4)
{
  ...
  switch (UseType_13) {
    ...
    case (MR_Integer) 2:
      {
        MR_Word Var_21;
        MR_Word Var_22 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Goal_6, (MR_Integer) 2))));
  ...
  MR_Word * STATE_VARIABLE_Map_12)
{
  ...
  switch (UseType_19) {
    ...
    case (MR_Integer) 2:
      {
        MR_Word Var_27;
        MR_Word Var_28 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Goal_7, (MR_Integer) 2))));

        Var_27 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_28, (MR_Integer) 4))));
  ...
  MR_Word * STATE_VARIABLE_ConsumptionsMap_34)
{
  ...
  if (((MR_tag((MR_Word) SeqEventTime_17)) == (MR_Integer) 0))
  {
    ...
    *STATE_VARIABLE_PrevSeqConsumeTime_26 = MR_unbox_float((MR_hl_field(MR_mktag(0), SeqEventTime_17, (MR_Integer) 0)));
    ...
    Var_47 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Info_14, (MR_Integer) 2))));
    Var_46 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), Var_47, (MR_Integer) 6))));
    ...
    if (succeeded)
    {
      MR_Float Var_48;
      MR_Integer Var_49;
      MR_Word Var_50 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Info_14, (MR_Integer) 2))));
      MR_Word Var_51;

      Var_49 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), Var_50, (MR_Integer) 7))));
      ...
      *STATE_VARIABLE_PrevParConsumeTime_28 = (ParConsTime0_41 + Var_48);
      {
        ...
        MR_hl_field(MR_mktag(0), Var_51, 0) = MR_box_float(STATE_VARIABLE_ResumeTime_0_29);
        MR_hl_field(MR_mktag(0), Var_51, 1) = MR_box_float(ParConsTimeNotBlocked_40);
      }
      {
        MR_Word base;
        base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
  ...
  MR_Word * STATE_VARIABLE_Metrics_62)
{
  ...
  if ((Algorithm_21 == (MR_Word) ((MR_Unsigned) 0U)))
  {
    ...
    Var_95 = (StartTime_34 + CostB_24);
    {
      ...
      MR_hl_field(MR_mktag(0), Var_94, 0) = MR_box_float(StartTime_34);
      MR_hl_field(MR_mktag(0), Var_94, 1) = MR_box_float(Var_95);
    }
    {
      Execution_46 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), Execution_46, 0) = ((MR_Box) (Var_94));
      ...
      case (MR_Integer) 1:
        {
          ...
          mercury__list__reverse_2_p_0((MR_Word) (&mdprof_fb__automatic_parallelism__autopar_calc_overlap_scalar_common_2[0]), ConsumptionsAndProductionsList0_38, &ConsumptionsAndProductionsList_39);
          {
            ...
            MR_hl_field(MR_mktag(0), Var_78, 0) = ((MR_Box) (&mdprof_fb__automatic_parallelism__autopar_calc_overlap_scalar_common_6[0]));
            MR_hl_field(MR_mktag(0), Var_78, 1) = ((MR_Box) (mdprof_fb__automatic_parallelism__autopar_calc_overlap__calculate_parallel_cost_step_12_p_0_3));
            MR_hl_field(MR_mktag(0), Var_78, 2) = ((MR_Box) ((MR_Integer) 2));
            MR_hl_field(MR_mktag(0), Var_78, 3) = ((MR_Box) (Info_13));
            MR_hl_field(MR_mktag(0), Var_78, 4) = ((MR_Box) (STATE_VARIABLE_ProductionsMap_0_57));
          }
          ...
          CostBParElapsed_47 = (LastParConsumeTime_41 + Var_83);
          {
            ...
            MR_hl_field(MR_mktag(0), Var_84, 0) = MR_box_float(LastResumeTime_42);
            MR_hl_field(MR_mktag(0), Var_84, 1) = MR_box_float(CostBParElapsed_47);
          }
          {
            RevExecution_45 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), RevExecution_45, 0) = ((MR_Box) (Var_84));
          ...
          Var_87 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Info_13, (MR_Integer) 2))));
          Var_86 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), Var_87, (MR_Integer) 5))));
          ...
          Var_90 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), Var_91, (MR_Integer) 6))));
