...
MR_decl_label10(mdprof_fb__automatic_parallelism__autopar_calc_overlap__calculate_parallel_cost_step_12_0, 15,16,18,19,17,25,26,28,32,35)
MR_decl_label9(mdprof_fb__automatic_parallelism__autopar_calc_overlap__calculate_parallel_cost_step_12_0, 36,37,38,39,40,21,43,44,49)
...
MR_BEGIN_MODULE(mdprof_fb__automatic_parallelism__autopar_calc_overlap_module3)
	...
	MR_init_label10(mdprof_fb__automatic_parallelism__autopar_calc_overlap__calculate_parallel_cost_step_12_0,15,16,18,19,17,25,26,28,32,35)
	MR_init_label9(mdprof_fb__automatic_parallelism__autopar_calc_overlap__calculate_parallel_cost_step_12_0,36,37,38,39,40,21,43,44,49)
MR_BEGIN_CODE
...
MR_def_static(mdprof_fb__automatic_parallelism__autopar_calc_overlap__calculate_parallel_cost_step_12_0)
	...
	MR_sv(3) = MR_r3;
	MR_sv(4) = MR_r4;
	MR_sv(5) = MR_tfield(0, MR_tfield(0, MR_r1, 2), 10);
	MR_sv(10) = MR_r5;
	MR_sv(11) = MR_r6;
	MR_sv(12) = MR_r7;
	{
...
MR_def_label(mdprof_fb__automatic_parallelism__autopar_calc_overlap__calculate_parallel_cost_step_12_0,17)
	...
	MR_np_call_localret_ent(list__foldl4_10_0,
		mdprof_fb__automatic_parallelism__autopar_calc_overlap__calculate_parallel_cost_step_12_0_i25);
MR_def_label(mdprof_fb__automatic_parallelism__autopar_calc_overlap__calculate_parallel_cost_step_12_0,25)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(17);
	MR_r2 = MR_r4;
	MR_np_call_localret_ent(list__reverse_2_0,
		mdprof_fb__automatic_parallelism__autopar_calc_overlap__calculate_parallel_cost_step_12_0_i26);
MR_def_label(mdprof_fb__automatic_parallelism__autopar_calc_overlap__calculate_parallel_cost_step_12_0,26)
	...
	MR_np_call_localret_ent(fn__map__init_0_0,
		mdprof_fb__automatic_parallelism__autopar_calc_overlap__calculate_parallel_cost_step_12_0_i28);
...
MR_def_label(mdprof_fb__automatic_parallelism__autopar_calc_overlap__calculate_parallel_cost_step_12_0,37)
	...
	MR_np_call_localret_ent(fn__set__count_1_0,
		mdprof_fb__automatic_parallelism__autopar_calc_overlap__calculate_parallel_cost_step_12_0_i38);
MR_def_label(mdprof_fb__automatic_parallelism__autopar_calc_overlap__calculate_parallel_cost_step_12_0,38)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = ((MR_Integer) MR_sv(9) * (MR_Integer) MR_r1);
	MR_np_call_localret_ent(fn__float__float_1_0,
