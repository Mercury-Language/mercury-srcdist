    ...
    if (((MR_tag((MR_Word) mdprof_fb__automatic_parallelism__autopar_calc_overlap__HeadVar__2_2)) == (MR_mktag((MR_Integer) 0))))
      {
        ...
        if (((MR_tag((MR_Word) mdprof_fb__automatic_parallelism__autopar_calc_overlap__HeadVar__3_3)) == (MR_mktag((MR_Integer) 0))))
          {
            MR_Float mdprof_fb__automatic_parallelism__autopar_calc_overlap__Var_5 = MR_unbox_float((MR_hl_field(MR_mktag(0), mdprof_fb__automatic_parallelism__autopar_calc_overlap__HeadVar__3_3, (MR_Integer) 0)));

            {
              mercury__private_builtin__builtin_compare_float_3_p_0(mdprof_fb__automatic_parallelism__autopar_calc_overlap__HeadVar__1_1, mdprof_fb__automatic_parallelism__autopar_calc_overlap__Var_16, mdprof_fb__automatic_parallelism__autopar_calc_overlap__Var_5);
            }
          }
        else
    ...
    else
      {
        ...
        if (((MR_tag((MR_Word) mdprof_fb__automatic_parallelism__autopar_calc_overlap__HeadVar__3_3)) == (MR_mktag((MR_Integer) 0))))
          *mdprof_fb__automatic_parallelism__autopar_calc_overlap__HeadVar__1_1 = (MR_Integer) 2;
          ...
          {
            MR_Float mdprof_fb__automatic_parallelism__autopar_calc_overlap__Var_11 = MR_unbox_float((MR_hl_field(MR_mktag(1), mdprof_fb__automatic_parallelism__autopar_calc_overlap__HeadVar__3_3, (MR_Integer) 0)));

            {
              mercury__private_builtin__builtin_compare_float_3_p_0(mdprof_fb__automatic_parallelism__autopar_calc_overlap__HeadVar__1_1, mdprof_fb__automatic_parallelism__autopar_calc_overlap__Var_17, mdprof_fb__automatic_parallelism__autopar_calc_overlap__Var_11);
            }
          }
      }
  }
...
{
  {
    ...
    if (((MR_tag((MR_Word) mdprof_fb__automatic_parallelism__autopar_calc_overlap__HeadVar__1_1)) == (MR_mktag((MR_Integer) 0))))
      {
        MR_Float mdprof_fb__automatic_parallelism__autopar_calc_overlap__Var_3 = MR_unbox_float((MR_hl_field(MR_mktag(0), mdprof_fb__automatic_parallelism__autopar_calc_overlap__HeadVar__1_1, (MR_Integer) 0)));
        MR_Float mdprof_fb__automatic_parallelism__autopar_calc_overlap__Var_4;
        ...
        if (mdprof_fb__automatic_parallelism__autopar_calc_overlap__succeeded)
          {
            mdprof_fb__automatic_parallelism__autopar_calc_overlap__Var_4 = MR_unbox_float((MR_hl_field(MR_mktag(0), mdprof_fb__automatic_parallelism__autopar_calc_overlap__HeadVar__2_2, (MR_Integer) 0)));
            mdprof_fb__automatic_parallelism__autopar_calc_overlap__succeeded = (mdprof_fb__automatic_parallelism__autopar_calc_overlap__Var_3 == mdprof_fb__automatic_parallelism__autopar_calc_overlap__Var_4);
          }
      }
    else
      {
        MR_Float mdprof_fb__automatic_parallelism__autopar_calc_overlap__Var_5 = MR_unbox_float((MR_hl_field(MR_mktag(1), mdprof_fb__automatic_parallelism__autopar_calc_overlap__HeadVar__1_1, (MR_Integer) 0)));
        MR_Float mdprof_fb__automatic_parallelism__autopar_calc_overlap__Var_6;
        ...
        if (mdprof_fb__automatic_parallelism__autopar_calc_overlap__succeeded)
          {
            mdprof_fb__automatic_parallelism__autopar_calc_overlap__Var_6 = MR_unbox_float((MR_hl_field(MR_mktag(1), mdprof_fb__automatic_parallelism__autopar_calc_overlap__HeadVar__2_2, (MR_Integer) 0)));
            mdprof_fb__automatic_parallelism__autopar_calc_overlap__succeeded = (mdprof_fb__automatic_parallelism__autopar_calc_overlap__Var_5 == mdprof_fb__automatic_parallelism__autopar_calc_overlap__Var_6);
          }
      }
    return mdprof_fb__automatic_parallelism__autopar_calc_overlap__succeeded;
  }
