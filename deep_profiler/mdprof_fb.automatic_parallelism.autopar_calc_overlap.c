  ...
  MR_Word * STATE_VARIABLE_Map_12)
{
  ...
  MR_Float UseTime_20;
  MR_Float Var_47;
  MR_Word Var_67 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Goal_7, (MR_Integer) 2))));
  MR_Box conv0_LazyUse_17;
  MR_Box conv1_Use_18;

  Map_16 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_67, (MR_Integer) 6))));
  ...
  Var_47 = MR_unbox_float((MR_hl_field(MR_mktag(0), Use_18, (MR_Integer) 0)));
  UseType_19 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Use_18, (MR_Integer) 2))) & (MR_Integer) 3);
  switch (UseType_19) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 1:
      {
    ...
    case (MR_Integer) 2:
      {
        MR_Word Var_23;
        MR_Word Var_24 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Goal_7, (MR_Integer) 2))));

        Var_23 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_24, (MR_Integer) 4))));
        UseTime_20 = measurements__goal_cost_get_percall_1_f_0(Var_23);
      }
      break;
    case (MR_Integer) 0:
      UseTime_20 = Var_47;
