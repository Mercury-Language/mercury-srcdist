  ...
  MR_Word HeadVar__3_3)
{
  ...
  {
    MR_Float ArgX1_6 = MR_unbox_float((MR_hl_field(1, HeadVar__2_2, (MR_Integer) 0)));
    MR_Float ArgY1_7 = MR_unbox_float((MR_hl_field(1, HeadVar__3_3, (MR_Integer) 0)));
  ...
  MR_Box * wrapper_arg_11)
{
  ...
  mdprof_fb__automatic_parallelism__autopar_calc_overlap__calculate_dependent_parallel_cost_13_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 4)))), ((MR_Word) (wrapper_arg_1)), MR_unbox_float(wrapper_arg_2), &conv16_STATE_VARIABLE_PrevSeqConsumeTime_26, MR_unbox_float(wrapper_arg_4), &conv15_STATE_VARIABLE_PrevParConsumeTime_28, MR_unbox_float(wrapper_arg_6), &conv14_STATE_VARIABLE_ResumeTime_30, ((MR_Word) (wrapper_arg_8)), &conv13_STATE_VARIABLE_RevExecution_32, ((MR_Word) (wrapper_arg_10)), &conv12_STATE_VARIABLE_ConsumptionsMap_34);
