  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        mercury__string__format__format_float_component_nowidth_noprec_4_p_0((MR_Word) (&mdprof_fb__automatic_parallelism__autopar_calc_overlap_scalar_common_7[0]), (MR_Integer) 2, Start_11, &Var_40);
        Var_48 = mercury__string__f_43_43_2_f_0(Var_40, (MR_String) ".");
        Var_50 = mercury__string__f_43_43_2_f_0((MR_String) ", Start: ", Var_48);
        mercury__string__format__format_float_component_nowidth_noprec_4_p_0((MR_Word) (&mdprof_fb__automatic_parallelism__autopar_calc_overlap_scalar_common_7[0]), (MR_Integer) 2, STATE_VARIABLE_Time_18_18, &Var_51);
