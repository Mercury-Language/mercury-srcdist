  ...
  MR_Word * STATE_VARIABLE_ConsumptionsMap_34)
{
  ...
  else
  {
    ...
    *STATE_VARIABLE_PrevSeqConsumeTime_26 = MR_unbox_float((MR_hl_field(MR_mktag(1), SeqEventTime_17, (MR_Integer) 0)));
    Var_61 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Info_14, (MR_Integer) 2))));
    Var_60 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), Var_61, (MR_Integer) 5))));
    SignalCost_58 = mercury__float__float_1_f_0(Var_60);
    Var_63 = ((*STATE_VARIABLE_PrevSeqConsumeTime_26) - STATE_VARIABLE_PrevSeqConsumeTime_0_25);
    Var_62 = (STATE_VARIABLE_PrevParConsumeTime_0_27 + Var_63);
    *STATE_VARIABLE_PrevParConsumeTime_28 = (Var_62 + SignalCost_58);
