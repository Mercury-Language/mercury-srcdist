...
MR_decl_label10(mdprof_fb__automatic_parallelism__autopar_calc_overlap__calculate_parallel_cost_step_12_0, 15,16,18,19,17,21,26,35,36,38)
MR_decl_label10(mdprof_fb__automatic_parallelism__autopar_calc_overlap__calculate_parallel_cost_step_12_0, 43,46,47,48,49,50,51,30,54,55)
MR_decl_label1(mdprof_fb__automatic_parallelism__autopar_calc_overlap__calculate_parallel_cost_step_12_0, 61)
...
MR_BEGIN_MODULE(mdprof_fb__automatic_parallelism__autopar_calc_overlap_module3)
	...
	MR_init_label10(mdprof_fb__automatic_parallelism__autopar_calc_overlap__calculate_parallel_cost_step_12_0,15,16,18,19,17,21,26,35,36,38)
	MR_init_label10(mdprof_fb__automatic_parallelism__autopar_calc_overlap__calculate_parallel_cost_step_12_0,43,46,47,48,49,50,51,30,54,55)
	MR_init_label1(mdprof_fb__automatic_parallelism__autopar_calc_overlap__calculate_parallel_cost_step_12_0,61)
MR_BEGIN_CODE
...
MR_def_label(mdprof_fb__automatic_parallelism__autopar_calc_overlap__calculate_parallel_cost_step_12_0,17)
	...
	* (MR_Float *) &MR_sv(20) = (MR_tempf4 + MR_f(1));
	...
	MR_np_call_localret_ent(fn__map__init_0_0,
		mdprof_fb__automatic_parallelism__autopar_calc_overlap__calculate_parallel_cost_step_12_0_i54);
...
MR_def_label(mdprof_fb__automatic_parallelism__autopar_calc_overlap__calculate_parallel_cost_step_12_0,38)
	...
	MR_r7 = MR_tempr4;
	MR_tfield(0, MR_tempr4, 0) = (MR_Word) MR_COMMON(10,0);
	MR_tfield(0, MR_tempr4, 1) = (MR_Word) MR_ENTRY_AP(mdprof_fb__automatic_parallelism__autopar_calc_overlap__IntroducedFrom__pred__calculate_parallel_cost_step__184__1_12_0);
...
MR_def_label(mdprof_fb__automatic_parallelism__autopar_calc_overlap__calculate_parallel_cost_step_12_0,49)
	...
	MR_r1 = ((MR_Integer) MR_sv(11) * (MR_Integer) MR_r1);
	MR_np_call_localret_ent(fn__float__float_1_0,
		mdprof_fb__automatic_parallelism__autopar_calc_overlap__calculate_parallel_cost_step_12_0_i50);
MR_def_label(mdprof_fb__automatic_parallelism__autopar_calc_overlap__calculate_parallel_cost_step_12_0,50)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	* (MR_Float *) &MR_sv(13) = MR_f(1);
	MR_r1 = MR_sv(10);
...
MR_def_label(mdprof_fb__automatic_parallelism__autopar_calc_overlap__calculate_parallel_cost_step_12_0,51)
	...
	MR_np_call_localret_ent(fn__measurements__init_parallel_exec_metrics_incomplete_6_0,
		mdprof_fb__automatic_parallelism__autopar_calc_overlap__calculate_parallel_cost_step_12_0_i55);
MR_def_label(mdprof_fb__automatic_parallelism__autopar_calc_overlap__calculate_parallel_cost_step_12_0,30)
	...
	* (MR_Float *) &MR_sv(20) = (MR_tempf4 + MR_f(1));
	...
	MR_np_call_localret_ent(fn__map__init_0_0,
		mdprof_fb__automatic_parallelism__autopar_calc_overlap__calculate_parallel_cost_step_12_0_i54);
MR_def_label(mdprof_fb__automatic_parallelism__autopar_calc_overlap__calculate_parallel_cost_step_12_0,54)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_f(3) = MR_float_from_dword_ptr(&MR_sv(3));
	MR_sv(9) = MR_r1;
	MR_f(1) = (MR_Float) 0.0000000000000000;
	...
	MR_np_call_localret_ent(fn__measurements__init_parallel_exec_metrics_incomplete_6_0,
		mdprof_fb__automatic_parallelism__autopar_calc_overlap__calculate_parallel_cost_step_12_0_i55);
MR_def_label(mdprof_fb__automatic_parallelism__autopar_calc_overlap__calculate_parallel_cost_step_12_0,55)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	...
	MR_r5 = MR_tempr5;
	MR_tfield(0, MR_tempr5, 0) = (MR_Word) MR_COMMON(11,1);
	MR_tfield(0, MR_tempr5, 1) = (MR_Word) MR_ENTRY_AP(mdprof_fb__automatic_parallelism__autopar_calc_overlap__IntroducedFrom__pred__calculate_parallel_cost_step__226__1_8_0);
	...
	MR_np_call_localret_ent(list__foldl3_8_0,
		mdprof_fb__automatic_parallelism__autopar_calc_overlap__calculate_parallel_cost_step_12_0_i61);
MR_def_label(mdprof_fb__automatic_parallelism__autopar_calc_overlap__calculate_parallel_cost_step_12_0,61)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2, MR_tempr3;
	MR_tag_alloc_heap(MR_tempr1, 0, (MR_Integer) 3);
...
MR_def_label(mdprof_fb__automatic_parallelism__autopar_calc_overlap__get_consumptions_and_productions_list_9_0,2)
	...
	MR_sv(11) = (MR_Word) MR_TAG_COMMON(0,4,6);
	MR_r1 = MR_sv(9);
	MR_r2 = MR_sv(11);
	MR_r4 = MR_sv(4);
	}
