  ...
  MR_Word * After_10)
{
  while (MR_TRUE)
  {
    ...
    if (succeeded)
    {
      Char_6 = ((MR_Char) (MR_Word) (MR_hl_field(1, HeadVar__1_1, (MR_Integer) 0)));
      Chars_7 = ((MR_Word) ((MR_hl_field(1, HeadVar__1_1, (MR_Integer) 1))));
      ...
      else
      {
        ...
        {
          STATE_VARIABLE_BeforeRev_13_13 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(1, STATE_VARIABLE_BeforeRev_13_13, 0) = ((MR_Box) (MR_Word) (Char_6));
          MR_hl_field(1, STATE_VARIABLE_BeforeRev_13_13, 1) = ((MR_Box) (STATE_VARIABLE_BeforeRev_0_11));
        }
