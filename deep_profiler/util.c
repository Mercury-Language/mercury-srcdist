...
{
  {
    ...
    succeeded = util__find_split_char_2_5_p_0(Chars_4, SplitChar_5, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), &BeforeRev_17, &After_8);
    if (succeeded)
    {
    ...
    /* tailcall optimized into a loop */
    {
      ...
      if (succeeded)
      {
        ...
        else
        {
          ...
          {
            STATE_VARIABLE_BeforeRev_13_13 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
          ...
          {
            MR_Word next_value_of_HeadVar__1_1 = Chars_7;
            MR_Word next_value_of_STATE_VARIABLE_BeforeRev_0_11 = STATE_VARIABLE_BeforeRev_13_13;
