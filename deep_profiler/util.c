...
MR_decl_label6(util__split_2_3_0, 3,5,6,7,2,8)
...
MR_BEGIN_MODULE(util_module1)
	...
	MR_init_label6(util__split_2_3_0,3,5,6,7,2,8)
MR_BEGIN_CODE
...
MR_def_label(util__split_2_3_0,2)
	...
	MR_r1 = MR_sv(1);
	MR_np_call_localret_ent(string__from_char_list_2_0,
		util__split_2_3_0_i8);
MR_def_label(util__split_2_3_0,8)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 2);
...
void mercury__util__write_out_proc_statics(FILE *deep_fp, FILE *procrep_fp)
{
	MR_write_out_module_proc_reps_start(procrep_fp, &mercury_data__module_common_layout__util);
