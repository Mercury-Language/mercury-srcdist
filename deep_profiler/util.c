  ...
  MR_Word * PieceStrs_6)
{
  ...
  if (succeeded)
  {
    TypeCtorInfo__11_15 = (MR_Word) (&mercury__builtin__builtin__type_ctor_info_character_0);
    mercury__list__reverse_2_p_0(TypeCtorInfo__11_15, BeforeRev_13, &Before_7);
    succeeded = MR_TRUE;
  }
  if (succeeded)
  {
