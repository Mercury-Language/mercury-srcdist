...
MR_define_entry(mercury____Unify___report__inheritable_perf_0_0);
	...
	* (MR_Float *) &MR_sv(6) = MR_word_to_float(MR_tfield(0, MR_tempr3, 6));
	MR_sv(7) = MR_tfield(0, MR_tempr3, 7);
	MR_sv(8) = MR_tfield(0, MR_tempr3, 8);
	* (MR_Float *) &MR_sv(10) = MR_word_to_float(MR_tfield(0, MR_tempr3, 9));
	MR_sv(11) = MR_tfield(0, MR_tempr3, 10);
	MR_sv(12) = MR_tfield(0, MR_tempr3, 11);
	MR_sv(13) = MR_tfield(0, MR_tempr3, 12);
	...
	* (MR_Float *) &MR_sv(19) = MR_word_to_float(MR_tfield(0, MR_tempr4, 6));
	MR_sv(20) = MR_tfield(0, MR_tempr4, 7);
	MR_sv(21) = MR_tfield(0, MR_tempr4, 8);
	* (MR_Float *) &MR_sv(23) = MR_word_to_float(MR_tfield(0, MR_tempr4, 9));
	MR_sv(24) = MR_tfield(0, MR_tempr4, 10);
	MR_sv(25) = MR_tfield(0, MR_tempr4, 11);
	MR_sv(26) = MR_tfield(0, MR_tempr4, 12);
	MR_r1 = MR_tfield(0, MR_tempr3, 1);
	MR_r2 = MR_tfield(0, MR_tempr4, 1);
	}
...
MR_def_label(__Compare___report__inheritable_perf_0_0,2)
	...
	* (MR_Float *) &MR_sv(25) = MR_word_to_float(MR_tfield(0, MR_tempr5, 9));
	MR_sv(23) = MR_tfield(0, MR_tempr5, 8);
	MR_sv(22) = MR_tfield(0, MR_tempr5, 7);
	* (MR_Float *) &MR_sv(21) = MR_word_to_float(MR_tfield(0, MR_tempr5, 6));
	...
	* (MR_Float *) &MR_sv(11) = MR_word_to_float(MR_tfield(0, MR_tempr6, 9));
	MR_sv(9) = MR_tfield(0, MR_tempr6, 8);
	MR_sv(8) = MR_tfield(0, MR_tempr6, 7);
	* (MR_Float *) &MR_sv(7) = MR_word_to_float(MR_tfield(0, MR_tempr6, 6));
	MR_sv(5) = MR_tfield(0, MR_tempr6, 5);
	MR_sv(4) = MR_tfield(0, MR_tempr6, 4);
	MR_sv(3) = MR_tfield(0, MR_tempr6, 3);
	MR_tempr1 = MR_tfield(0, MR_tempr6, 2);
...
MR_def_label(__Compare___report__inheritable_perf_0_0,37)
	...
	MR_r2 = MR_float_to_word(MR_float_from_dword_ptr(&MR_sv(25)));
	MR_np_call_localret_ent(private_builtin__builtin_compare_float_3_0,
...
MR_def_label(__Compare___report__recursion_level_report_0_0,2)
	...
	MR_Word MR_tempr1, MR_tempr2, MR_tempr3, MR_tempr4;
	MR_tempr3 = MR_sv(2);
	* (MR_Float *) &MR_sv(15) = MR_word_to_float(MR_tfield(0, MR_tempr3, 4));
	* (MR_Float *) &MR_sv(13) = MR_word_to_float(MR_tfield(0, MR_tempr3, 3));
	* (MR_Float *) &MR_sv(11) = MR_word_to_float(MR_tfield(0, MR_tempr3, 2));
	MR_sv(9) = MR_tfield(0, MR_tempr3, 1);
	MR_tempr4 = MR_sv(1);
	* (MR_Float *) &MR_sv(8) = MR_word_to_float(MR_tfield(0, MR_tempr4, 4));
	* (MR_Float *) &MR_sv(6) = MR_word_to_float(MR_tfield(0, MR_tempr4, 3));
...
MR_def_label(__Compare___report__recursion_level_report_0_0,9)
	...
	MR_r2 = MR_float_to_word(MR_float_from_dword_ptr(&MR_sv(11)));
	MR_np_call_localret_ent(private_builtin__builtin_compare_float_3_0,
...
MR_def_label(__Compare___report__recursion_level_report_0_0,13)
	...
	MR_r2 = MR_float_to_word(MR_float_from_dword_ptr(&MR_sv(13)));
	MR_np_call_localret_ent(private_builtin__builtin_compare_float_3_0,
...
MR_def_label(__Compare___report__recursion_level_report_0_0,17)
	...
	MR_r2 = MR_float_to_word(MR_float_from_dword_ptr(&MR_sv(15)));
...
MR_def_label(__Unify___report__recursion_type_0_0,6)
	...
	* (MR_Float *) &MR_sv(13) = MR_word_to_float(MR_tfield(1, MR_tempr1, 2));
	* (MR_Float *) &MR_sv(2) = MR_word_to_float(MR_tfield(1, MR_tempr1, 3));
	MR_sv(3) = MR_tfield(1, MR_tempr1, 4);
	MR_tempr2 = MR_sv(11);
	MR_sv(4) = MR_tfield(1, MR_tempr2, 1);
	* (MR_Float *) &MR_sv(6) = MR_word_to_float(MR_tfield(1, MR_tempr2, 2));
	* (MR_Float *) &MR_sv(8) = MR_word_to_float(MR_tfield(1, MR_tempr2, 3));
...
MR_def_label(__Compare___report__recursion_type_0_0,28)
	...
	* (MR_Float *) &MR_sv(12) = MR_word_to_float(MR_tfield(1, MR_tempr3, 2));
	* (MR_Float *) &MR_sv(10) = MR_word_to_float(MR_tfield(1, MR_tempr3, 3));
	MR_sv(8) = MR_tfield(1, MR_tempr3, 4);
	MR_tempr4 = MR_sv(2);
	MR_sv(7) = MR_tfield(1, MR_tempr4, 4);
	* (MR_Float *) &MR_sv(6) = MR_word_to_float(MR_tfield(1, MR_tempr4, 3));
	* (MR_Float *) &MR_sv(4) = MR_word_to_float(MR_tfield(1, MR_tempr4, 2));
...
MR_def_label(__Compare___report__recursion_type_0_0,39)
	...
	MR_r2 = MR_float_to_word(MR_float_from_dword_ptr(&MR_sv(6)));
	MR_np_call_localret_ent(private_builtin__builtin_compare_float_3_0,
