...
main_2_p_0(void)
{
  ...
  {
    MR_Word GetoptError_15 = ((MR_Word) ((MR_hl_field(1, GetoptResult_8, 0))));
  ...
  else
  {
    ...
    else
    {
      ...
      {
        MR_Word Var_64 = ((MR_Word) ((MR_hl_field(1, Args_7, 1))));
        MR_String Var_65 = ((MR_String) ((MR_hl_field(1, Args_7, 0))));
  ...
  MR_String FileName_8)
{
  ...
  MR_String SortStr_19;
  MR_Word Zero_20;
  MR_String SliceStr_21;
  MR_String Problem_22;

  mercury__getopt__lookup_string_option_3_p_0((MR_Word) (&mslice__mslice__type_ctor_info_option_0), OptionTable_7, ((MR_Box) ((MR_Integer) 2)), &SortStr0_10);
  ...
  succeeded = mercury__string__contains_char_2_p_0(SortStr0_10, (MR_Char) 122);
  if (succeeded)
  {
    mercury__string__replace_all_4_p_0(SortStr0_10, (MR_String) "z", (MR_String) "", &SortStr_19);
    Zero_20 = (MR_Integer) 1;
  }
  else
  {
    SortStr_19 = SortStr0_10;
    Zero_20 = (MR_Integer) 0;
  }
  mdbcomp__slice_and_dice__read_slice_to_string_12_p_0(FileName_8, Zero_20, SortStr_19, MaxRow_11, MaybeMaxNameColumnWidth_16, MaybeMaxPathColumnWidth_17, MaybeMaxFileColumnWidth_18, Module_15, &SliceStr_21, &Problem_22);
  succeeded = (strcmp(Problem_22, (MR_String) "") == 0);
  if (succeeded)
    mercury__io__write_string_4_p_0(StdOutStream_6, SliceStr_21);
  else
  {
