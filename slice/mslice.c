...
{
  {
    ...
    else
    {
      ...
      if ((Args_7 == (MR_Word) ((MR_Unsigned) 0U)))
      {
        ...
        Var_71 = mercury__string__f_43_43_2_f_0((MR_String) "Usage: mslice [-s sortspec] [-m module] [-l N] [-n N] [-p N] [-f N] ", (MR_String) "filename\n");
        mercury__io__write_string_4_p_0(StdOutStream_4, Var_71);
      }
      else
      {
        ...
        else
        {
          ...
          Var_79 = mercury__string__f_43_43_2_f_0((MR_String) "Usage: mslice [-s sortspec] [-m module] [-l N] [-n N] [-p N] [-f N] ", (MR_String) "filename\n");
