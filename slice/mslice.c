...
{
  {
    ...
    if ((((MR_Unsigned) ((MR_Integer) ((MR_Unsigned) HeadVar__1_1 - (MR_Unsigned) 102))) <= ((MR_Unsigned) 13)))
      ...
      {
        *HeadVar__2_2 = ((&mslice_vector_common_3[0 + (MR_Integer) ((MR_Unsigned) HeadVar__1_1 - (MR_Unsigned) 102)]))->mslice__vector_common_type_3_0__vct_3_f_0;
        succeeded = MR_TRUE;
      }
      else
        succeeded = MR_FALSE;
...
{
  {
    ...
    else
    {
      ...
      if ((Args_7 == (MR_Word) ((MR_Unsigned) 0U)))
      {
        ...
        Var_65 = mercury__string__f_43_43_2_f_0((MR_String) "Usage: mslice [-s sortspec] [-m module] [-l N] [-n N] [-p N] [-f N] ", (MR_String) "filename\n");
        mercury__io__write_string_4_p_0(StdOutStream_4, Var_65);
      }
      else
      {
        ...
        else
        {
          ...
          Var_73 = mercury__string__f_43_43_2_f_0((MR_String) "Usage: mslice [-s sortspec] [-m module] [-l N] [-n N] [-p N] [-f N] ", (MR_String) "filename\n");
          mercury__io__write_string_4_p_0(StdOutStream_4, Var_73);
        }
      }
    }
  }
