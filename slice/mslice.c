    ...
    if (((MR_tag((MR_Word) mslice__GetoptResult_8)) == (MR_mktag((MR_Integer) 1))))
    ...
    else
      {
        ...
        if ((mslice__Args_7 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
          ...
          {
            MR_Word mslice__V_59_59 = ((MR_Word) (MR_hl_field(MR_mktag(1), mslice__Args_7, (MR_Integer) 1)));
            MR_String mslice__V_60_60 = ((MR_String) (MR_hl_field(MR_mktag(1), mslice__Args_7, (MR_Integer) 0)));

            if ((mslice__V_59_59 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
              {
                ...
                {
                  mdbcomp__slice_and_dice__read_slice_to_string_11_p_0(mslice__V_60_60, mslice__SortStr_11, mslice__MaxRow_12, mslice__MaybeMaxPredColumn_17, mslice__MaybeMaxPathColumn_18, mslice__MaybeMaxFileColumn_19, mslice__Module_16, &mslice__SliceStr_20, &mslice__Problem_21);
                }
