...
MR_def_static(mslice__short_option_2_0)
	...
	{
	MR_Word MR_tempr1;
	MR_tempr1 = (MR_Word) (MR_Word *) &MR_tfield(0, (MR_Word *) &mercury_vector_common_3_0, ((MR_Integer) MR_r1 - (MR_Integer) 102));
...
MR_def_static(mslice__option_default_2_0)
	...
	{
	MR_Word MR_tempr1;
	MR_tempr1 = (MR_Word) (MR_Word *) &MR_tfield(0, (MR_Word *) &mercury_vector_common_5_0, (MR_Integer) 0);
...
MR_def_label(mslice__option_default_2_0,4)
	...
	{
	MR_Word MR_tempr1;
	MR_tempr1 = (MR_Word) (MR_Word *) &MR_tfield(0, (MR_Word *) &mercury_vector_common_5_0, MR_r3);
	MR_r1 = MR_ctfield(0, MR_tempr1, 0);
	MR_r2 = MR_ctfield(0, MR_tempr1, 1);
	MR_succeed();
	}
