...
static /* final */ const struct mslice__vector_common_type_7_0_s mslice_vector_common_7[6] = {
  ...
  {
    (MR_Integer) 0,
    (MR_Word) (MR_mkword(3, &mslice_scalar_common_2[0]))
  },
  /* row   1 */
  {
    (MR_Integer) 1,
    (MR_Word) (MR_mkword(2, &mslice_scalar_common_3[0]))
  },
  /* row   2 */
  {
    (MR_Integer) 2,
  ...
  {
    (MR_Integer) 5,
    (MR_Word) (MR_mkword(3, &mslice_scalar_common_2[1]))
  },
};
...
main_2_p_0(void)
{
  ...
  {
    MR_Word GetoptError_25 = ((MR_Word) ((MR_hl_field(1, GetoptResult_8, (MR_Integer) 0))));
  ...
  else
  {
    ...
    {
      MR_Word Var_63 = ((MR_Word) ((MR_hl_field(1, Args_7, (MR_Integer) 1))));
      MR_String Var_64 = ((MR_String) ((MR_hl_field(1, Args_7, (MR_Integer) 0))));
      ...
      if ((Var_63 == (MR_Word) ((MR_Unsigned) 0U)))
      {
        ...
        if (succeeded)
          ...
          {
            MaybeMaxPredColumn_17 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(1, MaybeMaxPredColumn_17, 0) = ((MR_Box) (MaxPredColumn_13));
          }
        ...
        if (succeeded)
          ...
          {
            MaybeMaxPathColumn_18 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(1, MaybeMaxPathColumn_18, 0) = ((MR_Box) (MaxPathColumn_14));
          }
        ...
        if (succeeded)
          ...
          {
            MaybeMaxFileColumn_19 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(1, MaybeMaxFileColumn_19, 0) = ((MR_Box) (MaxFileColumn_15));
          }
