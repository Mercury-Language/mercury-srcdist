  ...
  MR_Word * mslice__HeadVar__2_2)
{
  {
    MR_bool mslice__succeeded;
    MR_Integer mslice__lo_0 = (MR_Integer) 0;
    MR_Integer mslice__hi_1 = (MR_Integer) 5;
...
main_2_p_0(void)
{
  {
    MR_bool mslice__succeeded;
    MR_Word mslice__TypeCtorInfo_58_58;
    MR_Word mslice__StdOutStream_4;
    MR_Word mslice__Args0_5;
    MR_Word mslice__Args_7;
    MR_Word mslice__GetoptResult_8;

    mercury__io__stdout_stream_3_p_0(&mslice__StdOutStream_4);
    mdbcomp__shared_utilities__unlimit_stack_2_p_0();
    mercury__io__command_line_arguments_3_p_0(&mslice__Args0_5);
    mslice__TypeCtorInfo_58_58 = (MR_Word) &mslice__mslice__type_ctor_info_option_0;
    mercury__getopt__process_options_4_p_0(mslice__TypeCtorInfo_58_58, (MR_Word) MR_mkword(MR_mktag(2), &mslice_scalar_common_1[4]), mslice__Args0_5, &mslice__Args_7, &mslice__GetoptResult_8);
    if (((MR_tag((MR_Word) mslice__GetoptResult_8)) == (MR_mktag((MR_Integer) 1))))
    {
      MR_String mslice__GetoptErrorMsg_25 = ((MR_String) (MR_hl_field(MR_mktag(1), mslice__GetoptResult_8, (MR_Integer) 0)));

      mercury__io__write_string_4_p_0(mslice__StdOutStream_4, mslice__GetoptErrorMsg_25);
      mercury__io__nl_3_p_0(mslice__StdOutStream_4);
    }
    else
    {
      MR_Word mslice__OptionTable_9 = ((MR_Word) (MR_hl_field(MR_mktag(0), mslice__GetoptResult_8, (MR_Integer) 0)));

      if ((mslice__Args_7 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
      {
        mercury__io__write_string_4_p_0(mslice__StdOutStream_4, (MR_String) "Usage: mslice [-s sortspec] [-m module] [-l N] [-n N] [-p N] [-f N] filename\n");
      }
      else
      {
        MR_Word mslice__Var_59 = ((MR_Word) (MR_hl_field(MR_mktag(1), mslice__Args_7, (MR_Integer) 1)));
        MR_String mslice__Var_60 = ((MR_String) (MR_hl_field(MR_mktag(1), mslice__Args_7, (MR_Integer) 0)));

        if ((mslice__Var_59 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
        {
          MR_String mslice__SortStr_11;
          MR_Integer mslice__MaxRow_12;
          MR_Integer mslice__MaxPredColumn_13;
          MR_Integer mslice__MaxPathColumn_14;
          MR_Integer mslice__MaxFileColumn_15;
          MR_String mslice__Module_16;
          MR_Word mslice__MaybeMaxPredColumn_17;
          MR_Word mslice__MaybeMaxPathColumn_18;
          MR_Word mslice__MaybeMaxFileColumn_19;
          MR_String mslice__SliceStr_20;
          MR_String mslice__Problem_21;

          mercury__getopt__lookup_string_option_3_p_0(mslice__TypeCtorInfo_58_58, mslice__OptionTable_9, ((MR_Box) ((MR_Integer) 0)), &mslice__SortStr_11);
          mercury__getopt__lookup_int_option_3_p_0(mslice__TypeCtorInfo_58_58, mslice__OptionTable_9, ((MR_Box) ((MR_Integer) 1)), &mslice__MaxRow_12);
          mercury__getopt__lookup_int_option_3_p_0(mslice__TypeCtorInfo_58_58, mslice__OptionTable_9, ((MR_Box) ((MR_Integer) 2)), &mslice__MaxPredColumn_13);
          mercury__getopt__lookup_int_option_3_p_0(mslice__TypeCtorInfo_58_58, mslice__OptionTable_9, ((MR_Box) ((MR_Integer) 3)), &mslice__MaxPathColumn_14);
          mercury__getopt__lookup_int_option_3_p_0(mslice__TypeCtorInfo_58_58, mslice__OptionTable_9, ((MR_Box) ((MR_Integer) 4)), &mslice__MaxFileColumn_15);
          mercury__getopt__lookup_string_option_3_p_0(mslice__TypeCtorInfo_58_58, mslice__OptionTable_9, ((MR_Box) ((MR_Integer) 5)), &mslice__Module_16);
          mslice__succeeded = (mslice__MaxPredColumn_13 == (MR_Integer) 0);
          if (mslice__succeeded)
            mslice__MaybeMaxPredColumn_17 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
          else
            {
              mslice__MaybeMaxPredColumn_17 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), mslice__MaybeMaxPredColumn_17, 0) = ((MR_Box) (mslice__MaxPredColumn_13));
            }
          mslice__succeeded = (mslice__MaxPathColumn_14 == (MR_Integer) 0);
          if (mslice__succeeded)
            mslice__MaybeMaxPathColumn_18 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
          else
            {
              mslice__MaybeMaxPathColumn_18 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), mslice__MaybeMaxPathColumn_18, 0) = ((MR_Box) (mslice__MaxPathColumn_14));
            }
          mslice__succeeded = (mslice__MaxFileColumn_15 == (MR_Integer) 0);
          if (mslice__succeeded)
            mslice__MaybeMaxFileColumn_19 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
          else
            {
              mslice__MaybeMaxFileColumn_19 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), mslice__MaybeMaxFileColumn_19, 0) = ((MR_Box) (mslice__MaxFileColumn_15));
            }
          mdbcomp__slice_and_dice__read_slice_to_string_11_p_0(mslice__Var_60, mslice__SortStr_11, mslice__MaxRow_12, mslice__MaybeMaxPredColumn_17, mslice__MaybeMaxPathColumn_18, mslice__MaybeMaxFileColumn_19, mslice__Module_16, &mslice__SliceStr_20, &mslice__Problem_21);
          mslice__succeeded = (strcmp(mslice__Problem_21, (MR_String) "") == 0);
          if (mslice__succeeded)
            mercury__io__write_string_4_p_0(mslice__StdOutStream_4, mslice__SliceStr_20);
          else
          {
            mercury__io__write_string_4_p_0(mslice__StdOutStream_4, mslice__Problem_21);
            mercury__io__nl_3_p_0(mslice__StdOutStream_4);
