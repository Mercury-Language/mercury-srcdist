...
main_2_p_0(void)
{
  ...
  else
  {
    ...
    {
      MR_Word Var_61 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Args_7, (MR_Integer) 1))));
      MR_String Var_62 = ((MR_String) ((MR_hl_field(MR_mktag(1), Args_7, (MR_Integer) 0))));
      ...
      if ((Var_61 == (MR_Word) ((MR_Unsigned) 0U)))
      {
        ...
        mdbcomp__slice_and_dice__read_slice_to_string_11_p_0(Var_62, SortStr_11, MaxRow_12, MaybeMaxPredColumn_17, MaybeMaxPathColumn_18, MaybeMaxFileColumn_19, Module_16, &SliceStr_20, &Problem_21);
      ...
      else
      {
        ...
        Var_68 = mercury__string__f_43_43_2_f_0((MR_String) "Usage: mslice [-s sortspec] [-m module] [-l N] [-n N] [-p N] [-f N] ", (MR_String) "filename\n");
        mercury__io__write_string_4_p_0(StdOutStream_4, Var_68);
      }
    }
  }
}
