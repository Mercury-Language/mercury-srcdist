...
{
  {
    ...
    do
    {
      ...
      result_3 = MR_strcmp(HeadVar__1_1, ((&mslice_vector_common_4[0 + mid_2]))->mslice__vector_common_type_4_0__vct_4_f_0);
      if ((result_3 == (MR_Integer) 0))
      {
        *HeadVar__2_2 = ((&mslice_vector_common_4[0 + mid_2]))->mslice__vector_common_type_4_0__vct_4_f_1;
        succeeded = MR_TRUE;
...
{
  {
    ...
    if ((((MR_Unsigned) (HeadVar__1_1 - (MR_Integer) 102)) <= ((MR_Unsigned) (MR_Integer) 13)))
      if (((MR_Integer) 9665 & (((MR_Integer) 1 << ((HeadVar__1_1 - (MR_Integer) 102))))))
      {
        *HeadVar__2_2 = ((&mslice_vector_common_3[0 + (HeadVar__1_1 - (MR_Integer) 102)]))->mslice__vector_common_type_3_0__vct_3_f_0;
        succeeded = MR_TRUE;
      }
      else
        succeeded = MR_FALSE;
...
{
  {
    ...
    TypeCtorInfo_58_58 = (MR_Word) &mslice__mslice__type_ctor_info_option_0;
    mercury__getopt__process_options_4_p_0(TypeCtorInfo_58_58, (MR_Word) MR_mkword(MR_mktag(2), &mslice_scalar_common_1[4]), Args0_5, &Args_7, &GetoptResult_8);
    if (((MR_tag((MR_Word) GetoptResult_8)) == (MR_mktag((MR_Integer) 1))))
    {
      MR_String GetoptErrorMsg_25 = ((MR_String) (MR_hl_field(MR_mktag(1), GetoptResult_8, (MR_Integer) 0)));
    ...
    else
    {
      ...
      {
        mercury__io__write_string_4_p_0(StdOutStream_4, (MR_String) "Usage: mslice [-s sortspec] [-m module] [-l N] [-n N] [-p N] [-f N] filename\n");
      }
      else
      {
        ...
        if ((Var_59 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
        {
          ...
          mercury__getopt__lookup_string_option_3_p_0(TypeCtorInfo_58_58, OptionTable_9, ((MR_Box) ((MR_Integer) 0)), &SortStr_11);
          mercury__getopt__lookup_int_option_3_p_0(TypeCtorInfo_58_58, OptionTable_9, ((MR_Box) ((MR_Integer) 1)), &MaxRow_12);
          mercury__getopt__lookup_int_option_3_p_0(TypeCtorInfo_58_58, OptionTable_9, ((MR_Box) ((MR_Integer) 2)), &MaxPredColumn_13);
          mercury__getopt__lookup_int_option_3_p_0(TypeCtorInfo_58_58, OptionTable_9, ((MR_Box) ((MR_Integer) 3)), &MaxPathColumn_14);
          mercury__getopt__lookup_int_option_3_p_0(TypeCtorInfo_58_58, OptionTable_9, ((MR_Box) ((MR_Integer) 4)), &MaxFileColumn_15);
          mercury__getopt__lookup_string_option_3_p_0(TypeCtorInfo_58_58, OptionTable_9, ((MR_Box) ((MR_Integer) 5)), &Module_16);
          succeeded = (MaxPredColumn_13 == (MR_Integer) 0);
          if (succeeded)
            MaybeMaxPredColumn_17 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
          else
            {
              MaybeMaxPredColumn_17 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), MaybeMaxPredColumn_17, 0) = ((MR_Box) (MaxPredColumn_13));
            }
          succeeded = (MaxPathColumn_14 == (MR_Integer) 0);
          if (succeeded)
            MaybeMaxPathColumn_18 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
          else
            {
              MaybeMaxPathColumn_18 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), MaybeMaxPathColumn_18, 0) = ((MR_Box) (MaxPathColumn_14));
            }
          succeeded = (MaxFileColumn_15 == (MR_Integer) 0);
          if (succeeded)
            MaybeMaxFileColumn_19 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
          else
            {
              MaybeMaxFileColumn_19 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), MaybeMaxFileColumn_19, 0) = ((MR_Box) (MaxFileColumn_15));
            }
          mdbcomp__slice_and_dice__read_slice_to_string_11_p_0(Var_60, SortStr_11, MaxRow_12, MaybeMaxPredColumn_17, MaybeMaxPathColumn_18, MaybeMaxFileColumn_19, Module_16, &SliceStr_20, &Problem_21);
