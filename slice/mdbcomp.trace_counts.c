      ...
      case (MR_Integer) 0:
        {
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              TypeInfo__18_18 = (MR_Word) (&mdbcomp__trace_counts_scalar_common_1[1]);
  ...
  MR_Word HeadVar__2_2)
{
  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        TypeInfo__11_11 = (MR_Word) (&mdbcomp__trace_counts_scalar_common_1[1]);
        ...
        case (MR_Integer) 1:
          {
            ...
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                TypeInfo__15_15 = (MR_Word) (&mdbcomp__trace_counts_scalar_common_4[0]);
