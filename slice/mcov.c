...
MR_decl_label8(mcov__collect_proc_infos_counts_5_0, 28,3,4,6,5,9,13,30)
MR_decl_label3(mcov__collect_zero_count_local_labels_3_0, 10,3,4)
...
MR_BEGIN_MODULE(mcov_module0)
	...
	MR_init_label8(mcov__collect_proc_infos_counts_5_0,28,3,4,6,5,9,13,30)
MR_BEGIN_CODE
...
MR_def_label(mcov__collect_proc_infos_counts_5_0,9)
	...
	if (MR_LTAGS_TEST(MR_sv(6),0,0)) {
		MR_GOTO_LAB(mcov__collect_proc_infos_counts_5_0_i30);
	}
	{
...
MR_def_label(mcov__collect_proc_infos_counts_5_0,13)
	...
	MR_r1 = MR_sv(3);
	MR_r3 = MR_sv(1);
MR_def_label(mcov__collect_proc_infos_counts_5_0,30)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_BEGIN_MODULE(mcov_module1)
	...
	MR_init_label3(mcov__collect_zero_count_local_labels_3_0,10,3,4)
MR_BEGIN_CODE
...
MR_def_label(mcov__collect_zero_count_local_labels_3_0,10)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
...
MR_def_label(mcov__collect_zero_count_local_labels_3_0,4)
	...
	MR_GOTO_LAB(mcov__collect_zero_count_local_labels_3_0_i10);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_thread_engine_base
#endif
...
MR_def_static(mcov__proc_process_path_port_count_6_0)
	...
	MR_Word MR_tempr1, MR_tempr2, MR_tempr3;
	MR_tempr3 = MR_r2;
	MR_sv(2) = ((MR_Integer) MR_r4 + (MR_Integer) MR_ctfield(0, MR_tempr3, 1));
	...
	MR_tfield(0, MR_tempr2, 1) = (MR_Word) MR_ENTRY_AP(mcov__IntroducedFrom__pred__proc_process_path_port_count__223__1_2_0);
