  ...
  else
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        MR_String Version_64;
        MR_String Package_66;
        MR_String _FullArch_65;

        mercury__io__stdout_stream_3_p_0(&StdOutStream_30);
        mercury__library__version_2_p_0(&Version_64, &_FullArch_65);
        mercury__io__write_string_4_p_0(StdOutStream_30, (MR_String) "Mercury Coverage Testing Tool, version ");
        mercury__io__write_string_4_p_0(StdOutStream_30, Version_64);
        Package_66 = mercury__library__package_version_0_f_0();
        succeeded = (strcmp(Package_66, (MR_String) "") == 0);
        if (succeeded)
          mercury__io__nl_3_p_0(StdOutStream_30);
        else
        {
          mercury__io__write_string_4_p_0(StdOutStream_30, (MR_String) " (");
          mercury__io__write_string_4_p_0(StdOutStream_30, Package_66);
          mercury__io__write_string_4_p_0(StdOutStream_30, (MR_String) ")\n");
        }
  ...
  MR_Word Args_6)
{
  ...
  else
  {
    ...
    else
    {
      ...
      mercury__io__stderr_stream_3_p_0(&Stderr_95);
      mercury__io__write_string_4_p_0(Stderr_95, ReadErrorMsg_18);
      mercury__io__write_string_4_p_0(Stderr_95, (MR_String) "\n");
      mercury__io__set_exit_status_3_p_0((MR_Integer) 1);
    }
  }
}
