...
static /* final */ const MR_Box mcov_scalar_common_5[1][6];

static /* final */ const MR_Box mcov_scalar_common_6[2][7];
...
{
  {
    ...
    MR_Word mcov__V_65_65 = ((MR_Word) (MR_hl_field(MR_mktag(0), mcov__HeadVar__2_49, (MR_Integer) 1)));
    MR_String mcov__V_67_67 = ((MR_String) (MR_hl_field(MR_mktag(0), mcov__ProcLabelInContext_64, (MR_Integer) 1)));
    MR_Word mcov__V_68_68 = ((MR_Word) (MR_hl_field(MR_mktag(0), mcov__ProcLabelInContext_64, (MR_Integer) 2)));
      ...
      /* tailcall optimized into a loop */
      {
        ...
        if ((mcov__HeadVar__2_2 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
        ...
        else
          {
            ...
            {
              MR_Word mcov__HeadVar__2__tmp_copy_2 = mcov__Strs_11;

              mcov__HeadVar__2_2 = mcov__HeadVar__2__tmp_copy_2;
            }
            continue;
          }
      }
...
{
  {
    ...
    mcov__Str_85 = ((MR_String) (MR_hl_field(MR_mktag(1), mcov__V_31_31, (MR_Integer) 0)));
    mcov__Strs_86 = ((MR_Word) (MR_hl_field(MR_mktag(1), mcov__V_31_31, (MR_Integer) 1)));
    {
      mercury__io__write_string_4_p_0(mcov__OutStream_4, (MR_String) "\t");
    }
    {
...
{
  {
    ...
    {
      mcov__V_33_33 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), mcov__V_33_33, 0) = ((MR_Box) (mcov__ProgName_6));
      MR_hl_field(MR_mktag(1), mcov__V_33_33, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &mcov_scalar_common_2[25])));
    }
    {
      mcov__V_31_31 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), mcov__V_31_31, 0) = ((MR_Box) ((MR_String) "Use \140"));
      MR_hl_field(MR_mktag(1), mcov__V_31_31, 1) = ((MR_Box) (mcov__V_33_33));
    }
    {
      mcov__V_29_29 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), mcov__V_29_29, 0) = ((MR_Box) ((MR_String) " [<options>] [<files>]\n"));
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), mcov__V_28_28, 0) = ((MR_Box) (mcov__ProgName_6));
      MR_hl_field(MR_mktag(1), mcov__V_28_28, 1) = ((MR_Box) (mcov__V_29_29));
    }
    {
      mcov__V_26_26 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), mcov__V_26_26, 0) = ((MR_Box) ((MR_String) "Usage: "));
      MR_hl_field(MR_mktag(1), mcov__V_26_26, 1) = ((MR_Box) (mcov__V_28_28));
    }
    {
      mcov__V_24_24 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), mcov__V_24_24, 0) = ((MR_Box) ((MR_String) "Copyright (C) 2015-2016 The Mercury team\n"));
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), mcov__V_22_22, 0) = ((MR_Box) ((MR_String) "Copyright (C) 2006-2007, 2010-2012 The University of Melbourne\n"));
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), mcov__V_20_20, 0) = ((MR_Box) ((MR_String) ".\n"));
      MR_hl_field(MR_mktag(1), mcov__V_20_20, 1) = ((MR_Box) (mcov__V_22_22));
    }
    {
      mcov__V_19_19 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), mcov__V_19_19, 0) = ((MR_Box) (mcov__FullArch_8));
      MR_hl_field(MR_mktag(1), mcov__V_19_19, 1) = ((MR_Box) (mcov__V_20_20));
    }
    {
      mcov__V_17_17 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), mcov__V_17_17, 0) = ((MR_Box) ((MR_String) ", on "));
      MR_hl_field(MR_mktag(1), mcov__V_17_17, 1) = ((MR_Box) (mcov__V_19_19));
    }
    {
      mcov__V_16_16 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), mcov__V_16_16, 0) = ((MR_Box) (mcov__Version_7));
      MR_hl_field(MR_mktag(1), mcov__V_16_16, 1) = ((MR_Box) (mcov__V_17_17));
    }
    {
      mcov__V_13_13 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), mcov__V_13_13, 0) = ((MR_Box) ((MR_String) "Mercury Coverage Testing Tool, version "));
      MR_hl_field(MR_mktag(1), mcov__V_13_13, 1) = ((MR_Box) (mcov__V_16_16));
    }
    {
      mercury__io__write_strings_4_p_0(mcov__OutStream_4, mcov__V_13_13);
    }
  }
}
    ...
    if (((MR_tag((MR_Word) mcov__ProcLabel_6)) == (MR_mktag((MR_Integer) 0))))
      {
        ...
        mcov__V_51_51 = (MR_Word) &mcov_scalar_common_8[0];
        {
          mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0(mcov__V_51_51, mcov__Arity_12, &mcov__V_45_45);
        }
        {
          mercury__io__write_string_4_p_0(mcov__OutStream_5, mcov__V_45_45);
        }
        {
          mercury__io__write_string_4_p_0(mcov__OutStream_5, (MR_String) "-");
        }
        {
          mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0(mcov__V_51_51, mcov__Mode_13, &mcov__V_54_54);
        }
        {
          mercury__io__write_string_4_p_0(mcov__OutStream_5, mcov__V_54_54);
        }
      }
    else
      {
...
{
  {
    ...
    {
      mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) &mcov_scalar_common_8[0], mcov__LineNumber_9, &mcov__V_37_37);
    }
    {
      mercury__io__write_string_4_p_0(mcov__OutStream_5, mcov__V_37_37);
    }
    {
      mercury__io__write_string_4_p_0(mcov__OutStream_5, (MR_String) ": ");
    }
      ...
      case (MR_Integer) 0:
        {
          ...
          {
            mdbcomp__trace_counts__string_to_trace_port_2_p_1(&mcov__PortStr_48, mcov__Port_46);
          }
          {
      ...
      case (MR_Integer) 1:
        {
          ...
          {
            mercury__io__write_strings_4_p_0(mcov__OutStream_5, mcov__V_57_57);
          }
        }
        break;
      case (MR_Integer) 2:
        {
          ...
          MR_Word mcov__V_72_72;
          MR_Word mcov__V_74_74;
          MR_Word mcov__V_76_76;
          MR_String mcov__V_77_77;

          {
            mdbcomp__trace_counts__string_to_trace_port_2_p_1(&mcov__PortStr_69, mcov__Port_66);
          }
          {
            mcov__V_77_77 = mdbcomp__goal_path__rev_goal_path_to_string_1_f_0(mcov__Path_67);
          }
          {
            mcov__V_76_76 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), mcov__V_76_76, 0) = ((MR_Box) (mcov__V_77_77));
            MR_hl_field(MR_mktag(1), mcov__V_76_76, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &mcov_scalar_common_2[24])));
          }
          {
            mcov__V_74_74 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), mcov__V_74_74, 0) = ((MR_Box) ((MR_String) " <"));
            MR_hl_field(MR_mktag(1), mcov__V_74_74, 1) = ((MR_Box) (mcov__V_76_76));
          }
          {
            mcov__V_72_72 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), mcov__V_72_72, 0) = ((MR_Box) (mcov__PortStr_69));
            MR_hl_field(MR_mktag(1), mcov__V_72_72, 1) = ((MR_Box) (mcov__V_74_74));
          }
          {
            mercury__io__write_strings_4_p_0(mcov__OutStream_5, mcov__V_72_72);
          }
        }
        break;
    }
...
{
  {
    ...
    mcov__V_39_39 = (MR_Word) &mcov_scalar_common_8[0];
    {
      mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0(mcov__V_39_39, mcov__LineNumber_9, &mcov__V_33_33);
    }
    {
      mercury__io__write_string_4_p_0(mcov__OutStream_5, mcov__V_33_33);
    }
    {
      mercury__io__write_string_4_p_0(mcov__OutStream_5, (MR_String) ": ");
    }
    if (((MR_tag((MR_Word) mcov__ProcLabel_10)) == (MR_mktag((MR_Integer) 0))))
      {
        ...
        {
          mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0(mcov__V_39_39, mcov__Arity_50, &mcov__V_81_81);
        }
        {
          mercury__io__write_string_4_p_0(mcov__OutStream_5, mcov__V_81_81);
        }
        {
          mercury__io__write_string_4_p_0(mcov__OutStream_5, (MR_String) "-");
        }
        {
          mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0(mcov__V_39_39, mcov__Mode_51, &mcov__V_90_90);
        }
        {
          mercury__io__write_string_4_p_0(mcov__OutStream_5, mcov__V_90_90);
        }
      }
    else
      {
...
{
  {
    ...
    if ((mcov__RestrictToModules_9 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
          ...
          case (MR_Integer) 0:
            switch (mcov__IgnoreMdbcomp_14) {
              ...
              case (MR_Integer) 1:
                {
                  {
                    mercury__list__negated_filter_3_p_0((MR_Word) &mcov_scalar_common_1[1], (MR_Word) &mcov_scalar_common_1[9], mcov__TraceCounts0_12, &mcov__TraceCounts_15);
                  }
                }
                break;
            }
          ...
          case (MR_Integer) 1:
            switch (mcov__IgnoreMdbcomp_14) {
              ...
              case (MR_Integer) 0:
                {
                  {
                    mercury__list__negated_filter_3_p_0((MR_Word) &mcov_scalar_common_1[1], (MR_Word) &mcov_scalar_common_1[10], mcov__TraceCounts0_12, &mcov__TraceCounts_15);
                  }
                }
                break;
              case (MR_Integer) 1:
                {
                  {
                    mercury__list__negated_filter_3_p_0((MR_Word) &mcov_scalar_common_1[1], (MR_Word) &mcov_scalar_common_1[11], mcov__TraceCounts0_12, &mcov__TraceCounts_15);
                  }
                }
                break;
            }
    ...
    else
      {
        ...
        {
          mcov__V_24_24 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), mcov__V_24_24, 0) = ((MR_Box) (&mcov_scalar_common_3[4]));
          MR_hl_field(MR_mktag(0), mcov__V_24_24, 1) = ((MR_Box) (mcov__write_coverage_test_6_p_0_4));
          MR_hl_field(MR_mktag(0), mcov__V_24_24, 2) = ((MR_Box) (MR_Word) ((MR_Integer) 1));
          MR_hl_field(MR_mktag(0), mcov__V_24_24, 3) = ((MR_Box) (mcov__Modules_16));
        }
        {
          mercury__list__filter_3_p_0((MR_Word) &mcov_scalar_common_1[1], mcov__V_24_24, mcov__TraceCounts0_12, &mcov__TraceCounts_15);
        }
      }
    {
      ...
      case (MR_Integer) 0:
        {
          ...
          MR_Word mcov__V_69_69;
          MR_Word mcov__V_70_70;
          MR_Box mcov__conv1_STATE_VARIABLE_IO_23;

          {
            mcov__V_68_68 = mercury__map__init_0_f_0(mcov__TypeCtorInfo_11_71, mcov__TypeCtorInfo_12_72);
          }
          mcov__TypeCtorInfo_13_73 = (MR_Word) &mercury__builtin__builtin__type_ctor_info_int_0;
          {
            mcov__V_69_69 = mercury__map__init_0_f_0(mcov__TypeCtorInfo_11_71, mcov__TypeCtorInfo_13_73);
          }
          {
            mcov__collect_proc_infos_counts_5_p_0(mcov__TraceCounts_15, mcov__V_68_68, &mcov__ProcInfoMap_65, mcov__V_69_69, &mcov__CountMap_66);
          }
          {
            mercury__map__to_assoc_list_2_p_0(mcov__TypeCtorInfo_11_71, mcov__TypeCtorInfo_13_73, mcov__CountMap_66, &mcov__CountList_67);
          }
          {
            mcov__V_70_70 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL);
            MR_hl_field(MR_mktag(0), mcov__V_70_70, 0) = ((MR_Box) (&mcov_scalar_common_5[0]));
            MR_hl_field(MR_mktag(0), mcov__V_70_70, 1) = ((MR_Box) (mcov__write_coverage_test_6_p_0_5));
            MR_hl_field(MR_mktag(0), mcov__V_70_70, 2) = ((MR_Box) (MR_Word) ((MR_Integer) 1));
            MR_hl_field(MR_mktag(0), mcov__V_70_70, 3) = ((MR_Box) (mcov__ProcInfoMap_65));
          }
          {
            mercury__list__filter_map_3_p_0((MR_Word) &mcov_scalar_common_1[2], mcov__TypeCtorInfo_12_72, mcov__V_70_70, mcov__CountList_67, &mcov__ZeroCountProcs_18);
          }
          ...
          {
            mcov__V_38_38 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL);
            MR_hl_field(MR_mktag(0), mcov__V_38_38, 0) = ((MR_Box) (&mcov_scalar_common_6[0]));
            MR_hl_field(MR_mktag(0), mcov__V_38_38, 1) = ((MR_Box) (mcov__write_coverage_test_6_p_0_6));
            MR_hl_field(MR_mktag(0), mcov__V_38_38, 2) = ((MR_Box) (MR_Word) ((MR_Integer) 1));
            MR_hl_field(MR_mktag(0), mcov__V_38_38, 3) = ((MR_Box) (mcov__OutStream_7));
          }
          {
            mercury__list__foldl_4_p_2(mcov__TypeCtorInfo_53_53, (MR_Word) &mercury__io__io__type_ctor_info_state_0, mcov__V_38_38, mcov__SortedZeroCountProcs_19, ((MR_Box) ((MR_Integer) 0)), &mcov__conv1_STATE_VARIABLE_IO_23);
          }
        }
        break;
      case (MR_Integer) 1:
        {
          ...
          {
            mcov__V_34_34 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL);
            MR_hl_field(MR_mktag(0), mcov__V_34_34, 0) = ((MR_Box) (&mcov_scalar_common_6[1]));
            MR_hl_field(MR_mktag(0), mcov__V_34_34, 1) = ((MR_Box) (mcov__write_coverage_test_6_p_0_7));
            MR_hl_field(MR_mktag(0), mcov__V_34_34, 2) = ((MR_Box) (MR_Word) ((MR_Integer) 1));
            MR_hl_field(MR_mktag(0), mcov__V_34_34, 3) = ((MR_Box) (mcov__OutStream_7));
          }
          {
            mercury__list__foldl_4_p_2(mcov__TypeCtorInfo_58_58, (MR_Word) &mercury__io__io__type_ctor_info_state_0, mcov__V_34_34, mcov__SortedZeroCountLabels_21, ((MR_Box) ((MR_Integer) 0)), &mcov__conv2_STATE_VARIABLE_IO_23);
          }
        }
        break;
    }
        ...
        if ((mcov__MaybeReadError_16 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
          {
            ...
            if (mcov__succeeded)
              {
                mcov__V_39_39 = ((MR_Word) (MR_hl_field(MR_mktag(1), mcov__FileTypeList_18, (MR_Integer) 0)));
                mcov__V_40_40 = ((MR_Word) (MR_hl_field(MR_mktag(1), mcov__FileTypeList_18, (MR_Integer) 1)));
                mcov__succeeded = (mcov__V_40_40 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
                if (mcov__succeeded)
                  {
                    mcov__succeeded = ((MR_tag((MR_Word) mcov__V_39_39)) == (MR_mktag((MR_Integer) 0)));
                    if (mcov__succeeded)
                      mcov__BaseType_19 = (MR_Word) MR_body(((MR_Word) mcov__V_39_39), (MR_Integer) 0);
                  }
              }
            if (mcov__succeeded)
              {
            ...
            if ((mcov__Modules_22 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
            ...
            else
              {
                ...
                {
                  mcov__V_47_47 = mercury__set__list_to_set_1_f_0(mcov__TypeCtorInfo_66_66, mcov__ModuleSyms_26);
                }
                {
                  mcov__RestrictToModules_23 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
                  MR_hl_field(MR_mktag(1), mcov__RestrictToModules_23, 0) = ((MR_Box) (mcov__V_47_47));
                }
              }
            {
...
{
  {
    ...
    {
      mercury__getopt_io__process_options_6_p_0(mcov__TypeCtorInfo_31_31, (MR_Word) MR_mkword(MR_mktag(2), &mcov_scalar_common_1[7]), mcov__Args0_4, &mcov__Args_6, &mcov__GetoptResult_7);
    }
    if (((MR_tag((MR_Word) mcov__GetoptResult_7)) == (MR_mktag((MR_Integer) 1))))
    ...
    else
      {
        ...
        {
          mercury__getopt_io__lookup_bool_option_3_p_0(mcov__TypeCtorInfo_31_31, mcov__OptionTable_8, ((MR_Box) ((MR_Integer) 0)), &mcov__V_32_32);
        }
        mcov__succeeded = ((MR_Integer) 1 == mcov__V_32_32);
        if (mcov__succeeded)
          {
