...
main_2_p_0(void)
{
  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      MR_String _FullArch_51;

      mercury__io__stdout_stream_3_p_0(&StdOutStream_9);
      mercury__library__version_2_p_0(&Version_50, &_FullArch_51);
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        MR_String Version_73;
        MR_String _FullArch_74;

        mercury__io__stdout_stream_3_p_0(&StdOutStream_30);
        mercury__library__version_2_p_0(&Version_73, &_FullArch_74);
        mercury__io__write_string_4_p_0(StdOutStream_30, (MR_String) "Mercury Coverage Testing Tool, version ");
        mercury__io__write_string_4_p_0(StdOutStream_30, Version_73);
  ...
  MR_Word Args_6)
{
  ...
  if ((Args_6 == (MR_Word) ((MR_Unsigned) 0U)))
  {
    ...
    MR_String _FullArch_97;

    mercury__io__progname_base_4_p_0((MR_String) "mcov", &ProgName_75);
    mercury__library__version_2_p_0(&Version_96, &_FullArch_97);
  ...
  else
  {
    ...
    else
    {
      ...
      mercury__io__stderr_stream_3_p_0(&Stderr_108);
      mercury__io__write_string_4_p_0(Stderr_108, ReadErrorMsg_18);
      mercury__io__write_string_4_p_0(Stderr_108, (MR_String) "\n");
      mercury__io__set_exit_status_3_p_0((MR_Integer) 1);
    }
  }
}
