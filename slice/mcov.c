...
{
  {
    ...
    if (mcov__succeeded)
      *mcov__HeadVar__1_1 = (MR_Integer) 0;
      ...
      {
        MR_String mcov__Var_4 = ((MR_String) (MR_hl_field(MR_mktag(0), mcov__HeadVar__2_2, (MR_Integer) 0)));
        MR_Integer mcov__Var_5 = ((MR_Integer) (MR_hl_field(MR_mktag(0), mcov__HeadVar__2_2, (MR_Integer) 1)));
        MR_Word mcov__Var_6 = ((MR_Word) (MR_hl_field(MR_mktag(0), mcov__HeadVar__2_2, (MR_Integer) 2)));
        MR_String mcov__Var_7 = ((MR_String) (MR_hl_field(MR_mktag(0), mcov__HeadVar__3_3, (MR_Integer) 0)));
        MR_Integer mcov__Var_8 = ((MR_Integer) (MR_hl_field(MR_mktag(0), mcov__HeadVar__3_3, (MR_Integer) 1)));
        MR_Word mcov__Var_9 = ((MR_Word) (MR_hl_field(MR_mktag(0), mcov__HeadVar__3_3, (MR_Integer) 2)));
        MR_Word mcov__Var_10;

        {
          mercury__private_builtin__builtin_compare_string_3_p_0(&mcov__Var_10, mcov__Var_4, mcov__Var_7);
        }
        ...
        if (mcov__succeeded)
          *mcov__HeadVar__1_1 = mcov__Var_10;
        else
          {
            ...
            {
              mercury__private_builtin__builtin_compare_int_3_p_0(&mcov__Var_11, mcov__Var_5, mcov__Var_8);
            }
            ...
            if (mcov__succeeded)
              *mcov__HeadVar__1_1 = mcov__Var_11;
              ...
              {
                mdbcomp__prim_data____Compare____proc_label_0_0(mcov__HeadVar__1_1, mcov__Var_6, mcov__Var_9);
              }
          }
      }
  }
...
{
  {
    ...
    if (mcov__succeeded)
      ...
      {
        MR_String mcov__Var_3 = ((MR_String) (MR_hl_field(MR_mktag(0), mcov__HeadVar__1_1, (MR_Integer) 0)));
        MR_Integer mcov__Var_4 = ((MR_Integer) (MR_hl_field(MR_mktag(0), mcov__HeadVar__1_1, (MR_Integer) 1)));
        MR_Word mcov__Var_5 = ((MR_Word) (MR_hl_field(MR_mktag(0), mcov__HeadVar__1_1, (MR_Integer) 2)));
        MR_String mcov__Var_6 = ((MR_String) (MR_hl_field(MR_mktag(0), mcov__HeadVar__2_2, (MR_Integer) 0)));
        MR_Integer mcov__Var_7 = ((MR_Integer) (MR_hl_field(MR_mktag(0), mcov__HeadVar__2_2, (MR_Integer) 1)));
        MR_Word mcov__Var_8 = ((MR_Word) (MR_hl_field(MR_mktag(0), mcov__HeadVar__2_2, (MR_Integer) 2)));

        mcov__succeeded = (strcmp(mcov__Var_3, mcov__Var_6) == 0);
        if (mcov__succeeded)
          {
            mcov__succeeded = (mcov__Var_4 == mcov__Var_7);
            if (mcov__succeeded)
              {
                mcov__succeeded = mdbcomp__prim_data____Unify____proc_label_0_0(mcov__Var_5, mcov__Var_8);
              }
          }
      }
    return mcov__succeeded;
    ...
    else
      {
        ...
        if ((mcov__HeadVar__3_3 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
          *mcov__HeadVar__1_1 = (MR_Integer) 2;
          ...
          {
            MR_Word mcov__Var_7 = ((MR_Word) (MR_hl_field(MR_mktag(1), mcov__HeadVar__3_3, (MR_Integer) 0)));

            {
              mercury__builtin__compare_3_p_0((MR_Word) &mcov_scalar_common_2[2], mcov__HeadVar__1_1, ((MR_Box) (mcov__Var_11)), ((MR_Box) (mcov__Var_7)));
            }
          }
      }
  }
...
{
  {
    ...
    if ((mcov__HeadVar__1_1 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
    ...
    else
      {
        ...
        MR_Word mcov__Var_5 = ((MR_Word) (MR_hl_field(MR_mktag(1), mcov__HeadVar__1_1, (MR_Integer) 0)));
        MR_Word mcov__Var_6;

        mcov__succeeded = ((MR_tag((MR_Word) mcov__HeadVar__2_2)) == (MR_mktag((MR_Integer) 1)));
        if (mcov__succeeded)
          {
            mcov__Var_6 = ((MR_Word) (MR_hl_field(MR_mktag(1), mcov__HeadVar__2_2, (MR_Integer) 0)));
            mcov__TypeInfo_9_9 = (MR_Word) &mcov_scalar_common_2[2];
            {
              mcov__succeeded = mercury__builtin__unify_2_p_0(mcov__TypeInfo_9_9, ((MR_Box) (mcov__Var_5)), ((MR_Box) (mcov__Var_6)));
            }
          }
      }
    return mcov__succeeded;
    ...
    if (mcov__succeeded)
      *mcov__HeadVar__1_1 = (MR_Integer) 0;
    else
      {
        ...
        MR_Integer mcov__Var_5 = ((MR_Integer) (MR_hl_field(MR_mktag(0), mcov__HeadVar__2_2, (MR_Integer) 1)));
        MR_Word mcov__Var_6 = ((MR_Word) (MR_hl_field(MR_mktag(0), mcov__HeadVar__2_2, (MR_Integer) 2)));
        MR_Word mcov__Var_7 = ((MR_Word) (MR_hl_field(MR_mktag(0), mcov__HeadVar__2_2, (MR_Integer) 3)));
        MR_String mcov__Var_8 = ((MR_String) (MR_hl_field(MR_mktag(0), mcov__HeadVar__3_3, (MR_Integer) 0)));
        MR_Integer mcov__Var_9 = ((MR_Integer) (MR_hl_field(MR_mktag(0), mcov__HeadVar__3_3, (MR_Integer) 1)));
        MR_Word mcov__Var_10 = ((MR_Word) (MR_hl_field(MR_mktag(0), mcov__HeadVar__3_3, (MR_Integer) 2)));
        MR_Word mcov__Var_11 = ((MR_Word) (MR_hl_field(MR_mktag(0), mcov__HeadVar__3_3, (MR_Integer) 3)));
        MR_Word mcov__Var_12;

        {
          mercury__private_builtin__builtin_compare_string_3_p_0(&mcov__Var_12, mcov__Var_4, mcov__Var_8);
        }
        ...
        if (mcov__succeeded)
          *mcov__HeadVar__1_1 = mcov__Var_12;
        else
          {
            ...
            {
              mercury__private_builtin__builtin_compare_int_3_p_0(&mcov__Var_13, mcov__Var_5, mcov__Var_9);
            }
            ...
            if (mcov__succeeded)
              *mcov__HeadVar__1_1 = mcov__Var_13;
            else
              {
                ...
                {
                  mdbcomp__prim_data____Compare____proc_label_0_0(&mcov__Var_14, mcov__Var_6, mcov__Var_10);
                }
                ...
                if (mcov__succeeded)
                  *mcov__HeadVar__1_1 = mcov__Var_14;
                  ...
                  {
                    mdbcomp__trace_counts____Compare____path_port_0_0(mcov__HeadVar__1_1, mcov__Var_7, mcov__Var_11);
                  }
              }
          }
      }
...
{
  {
    ...
    if (mcov__succeeded)
    ...
    else
      {
        ...
        MR_Integer mcov__Var_4 = ((MR_Integer) (MR_hl_field(MR_mktag(0), mcov__HeadVar__1_1, (MR_Integer) 1)));
        MR_Word mcov__Var_5 = ((MR_Word) (MR_hl_field(MR_mktag(0), mcov__HeadVar__1_1, (MR_Integer) 2)));
        MR_Word mcov__Var_6 = ((MR_Word) (MR_hl_field(MR_mktag(0), mcov__HeadVar__1_1, (MR_Integer) 3)));
        MR_String mcov__Var_7 = ((MR_String) (MR_hl_field(MR_mktag(0), mcov__HeadVar__2_2, (MR_Integer) 0)));
        MR_Integer mcov__Var_8 = ((MR_Integer) (MR_hl_field(MR_mktag(0), mcov__HeadVar__2_2, (MR_Integer) 1)));
        MR_Word mcov__Var_9 = ((MR_Word) (MR_hl_field(MR_mktag(0), mcov__HeadVar__2_2, (MR_Integer) 2)));
        MR_Word mcov__Var_10 = ((MR_Word) (MR_hl_field(MR_mktag(0), mcov__HeadVar__2_2, (MR_Integer) 3)));

        mcov__succeeded = (strcmp(mcov__Var_3, mcov__Var_7) == 0);
        if (mcov__succeeded)
          {
            mcov__succeeded = (mcov__Var_4 == mcov__Var_8);
            if (mcov__succeeded)
              {
                {
                  mcov__succeeded = mdbcomp__prim_data____Unify____proc_label_0_0(mcov__Var_5, mcov__Var_9);
                }
                if (mcov__succeeded)
                  {
                    mcov__succeeded = mdbcomp__trace_counts____Unify____path_port_0_0(mcov__Var_6, mcov__Var_10);
                  }
              }
          }
      }
...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), mcov__Var_33, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &mcov_scalar_common_2[25])));
    }
    {
      ...
      case (MR_Integer) 1:
        {
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(1), mcov__Var_60, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &mcov_scalar_common_2[24])));
          }
          {
      ...
      case (MR_Integer) 2:
        {
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(1), mcov__Var_76, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &mcov_scalar_common_2[24])));
          }
          {
          ...
          *mcov__STATE_VARIABLE_ZeroLabelInfos_3 = mcov__STATE_VARIABLE_ZeroLabelInfos_0_2;
        else
          {
...

            {
              ...
              MR_hl_field(MR_mktag(0), mcov__Var_17, 0) = ((MR_Box) (&mcov_scalar_common_7[1]));
    ...
    if (mcov__succeeded)
      {
...

        {
          ...
          MR_hl_field(MR_mktag(0), mcov__Var_20, 0) = ((MR_Box) (&mcov_scalar_common_3[5]));
    ...
    if ((mcov__RestrictToModules_9 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
    ...
    else
      {
...

        {
          ...
          MR_hl_field(MR_mktag(0), mcov__Var_24, 0) = ((MR_Box) (&mcov_scalar_common_3[4]));
      ...
      case (MR_Integer) 0:
        {
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(0), mcov__Var_70, 0) = ((MR_Box) (&mcov_scalar_common_5[0]));
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(0), mcov__Var_38, 0) = ((MR_Box) (&mcov_scalar_common_6[0]));
      ...
      case (MR_Integer) 1:
        {
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(0), mcov__Var_34, 0) = ((MR_Box) (&mcov_scalar_common_6[1]));
