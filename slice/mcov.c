      ...
      case (MR_Integer) 0:
        {
          ...
          MR_Unsigned packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), PathPort_11, (MR_Integer) 0)));
      ...
      case (MR_Integer) 2:
        {
          ...
          MR_Word Var_76;
          MR_String Var_77;
          MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), PathPort_11, (MR_Integer) 0)));
  ...
  MR_Word ProcLabel_6)
{
  if (((MR_tag((MR_Word) ProcLabel_6)) == (MR_Integer) 0))
  {
    ...
    MR_String Var_45;
    MR_String Var_54;
    MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), ProcLabel_6, (MR_Integer) 1)));
...
{
  {
    ...
    if (((MR_tag((MR_Word) ProcLabel_10)) == (MR_Integer) 0))
    {
      ...
      MR_String Var_81;
      MR_String Var_90;
      MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), ProcLabel_10, (MR_Integer) 1)));
...
{
  {
    ...
    if (succeeded)
    {
      if (((MR_tag((MR_Word) ProcLabel_7)) == (MR_Integer) 0))
      {
        ...
        MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), ProcLabel_7, (MR_Integer) 1)));
      ...
      else
      {
        ...
        MR_Unsigned packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), ProcLabel_7, (MR_Integer) 1)));
...
{
  {
    ...
    if (succeeded)
    {
      if (((MR_tag((MR_Word) ProcLabel_5)) == (MR_Integer) 0))
      {
        ...
        MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), ProcLabel_5, (MR_Integer) 1)));
      ...
      else
      {
        ...
        MR_Unsigned packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), ProcLabel_5, (MR_Integer) 1)));
...
{
  {
    ...
    *STATE_VARIABLE_Count_17 = (MR_Integer) ((MR_Unsigned) STATE_VARIABLE_Count_0_16 + (MR_Unsigned) CurCount_12);
    ...
    if (succeeded)
    {
      packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), PathPort_7, (MR_Integer) 0)));
    ...
    else
    {
      ...
      if ((MaybeReadError_16 == (MR_Word) ((MR_Unsigned) 0U)))
      {
        ...
        if (succeeded)
        {
          ...
          MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), BaseType_19, (MR_Integer) 0)));
        ...
        else
        {
          ...
          {
            RestrictToModules_23 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
