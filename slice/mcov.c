  ...
  MR_Word * mcov__HeadVar__2_2)
{
  {
    MR_bool mcov__succeeded;
    MR_Integer mcov__slot_0 = ((MR_hash_string4(mcov__HeadVar__1_1)) & (MR_Integer) 63);
    MR_String mcov__str_1 = ((&mcov_vector_common_9[0 + mcov__slot_0]))->mcov__vector_common_type_9_0__vct_9_f_0;
