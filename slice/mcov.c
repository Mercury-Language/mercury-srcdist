  ...
  else
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        MR_String Package_65;

        mercury__io__stdout_stream_3_p_0(&StdOutStream_30);
        Version_64 = mercury__library__mercury_version_0_f_0();
        ...
        Package_65 = mercury__library__package_version_0_f_0();
        succeeded = (strcmp(Package_65, (MR_String) "") == 0);
        if (succeeded)
          mercury__io__nl_3_p_0(StdOutStream_30);
        else
        {
          mercury__io__write_string_4_p_0(StdOutStream_30, (MR_String) " (");
          mercury__io__write_string_4_p_0(StdOutStream_30, Package_65);
          mercury__io__write_string_4_p_0(StdOutStream_30, (MR_String) ")\n");
        }
