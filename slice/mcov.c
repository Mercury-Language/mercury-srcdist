...
mcov__IntroducedFrom__pred__proc_process_path_port_count__308__1_2_p_0(
  MR_Word STATE_VARIABLE_MaybeCallInfo_0_14,
  MR_Word HeadVar__2_22);

static MR_bool MR_CALL 
mcov__IntroducedFrom__pred__write_coverage_test__217__1_2_p_0(
  MR_Word Modules_16,
...
static /* final */ const MR_Box mcov_scalar_common_2[31][2];
...
static /* final */ const MR_Box mcov_scalar_common_2[31][2] = {
  ...
  /* row   6 */
  {
    ...
    ((MR_Box) (MR_mkword(1, &mcov_scalar_common_2[5])))
  },
  /* row   7 */
  {
  ...
  /* row  27 */
  {
    ((MR_Box) ((MR_String) "Copyright (C) 2014-2016, 2020-2023 The Mercury team\n")),
    ((MR_Box) ((MR_Unsigned) 0U))
  },
  /* row  28 */
  {
...
static /* final */ const struct mcov__vector_common_type_10_0_s mcov_vector_common_10[9] = {
  ...
  {
    (MR_Integer) 4,
    (MR_Word) (MR_mkword(3, &mcov_scalar_common_2[29]))
  },
  /* row   5 */
  {
    (MR_Integer) 5,
    (MR_Word) (MR_mkword(3, &mcov_scalar_common_2[30]))
  },
  /* row   6 */
  {
    (MR_Integer) 6,
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = mcov__IntroducedFrom__pred__proc_process_path_port_count__308__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 4)))));
  return succeeded;
}
...
main_2_p_0(void)
{
  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      MR_String Version_50;
      MR_String FullArch_51;

      mercury__io__stdout_stream_3_p_0(&StdOutStream_9);
      mercury__library__version_2_p_0(&Version_50, &FullArch_51);
      mercury__io__write_string_4_p_0(StdOutStream_9, (MR_String) "Name: mcov - Mercury Coverage Testing Tool, version ");
      mercury__io__write_string_4_p_0(StdOutStream_9, Version_50);
      mercury__io__write_string_4_p_0(StdOutStream_9, (MR_String) ", on ");
      mercury__io__write_string_4_p_0(StdOutStream_9, FullArch_51);
      mercury__io__write_string_4_p_0(StdOutStream_9, (MR_String) "\n");
      mercury__io__write_strings_4_p_0(StdOutStream_9, (MR_Word) (MR_mkword(1, &mcov_scalar_common_2[28])));
      ...
      mercury__io__write_prefixed_lines_5_p_0(StdOutStream_9, (MR_String) "\t", (MR_Word) (MR_mkword(1, &mcov_scalar_common_2[26])));
    }
    else
    {
      MR_Word Var_39;
      ...
      if (succeeded)
      {
        ...
        mercury__io__write_string_4_p_0(StdOutStream_30, Version_78);
        mercury__io__write_string_4_p_0(StdOutStream_30, (MR_String) ", on ");
        mercury__io__write_string_4_p_0(StdOutStream_30, FullArch_79);
        mercury__io__write_string_4_p_0(StdOutStream_30, (MR_String) "\n");
        mercury__io__write_strings_4_p_0(StdOutStream_30, (MR_Word) (MR_mkword(1, &mcov_scalar_common_2[28])));
      }
      else
  ...
  MR_Word Args_6)
{
  ...
  if ((Args_6 == (MR_Word) ((MR_Unsigned) 0U)))
  {
    ...
    MR_String Version_96;
    MR_String FullArch_97;

    mercury__io__progname_base_4_p_0((MR_String) "mcov", &ProgName_75);
    mercury__library__version_2_p_0(&Version_96, &FullArch_97);
    mercury__io__write_string_4_p_0(StdOutStream_8, (MR_String) "Mercury Coverage Testing Tool, version ");
    mercury__io__write_string_4_p_0(StdOutStream_8, Version_96);
    mercury__io__write_string_4_p_0(StdOutStream_8, (MR_String) ", on ");
    mercury__io__write_string_4_p_0(StdOutStream_8, FullArch_97);
    mercury__io__write_string_4_p_0(StdOutStream_8, (MR_String) "\n");
    mercury__io__write_strings_4_p_0(StdOutStream_8, (MR_Word) (MR_mkword(1, &mcov_scalar_common_2[28])));
    mercury__io__write_string_4_p_0(StdOutStream_8, (MR_String) "Usage: ");
    mercury__io__write_string_4_p_0(StdOutStream_8, ProgName_75);
    mercury__io__write_string_4_p_0(StdOutStream_8, (MR_String) " [<options>] [<files>]\n");
    mercury__io__write_string_4_p_0(StdOutStream_8, (MR_String) "Use \140");
    mercury__io__write_string_4_p_0(StdOutStream_8, ProgName_75);
    mercury__io__write_string_4_p_0(StdOutStream_8, (MR_String) " --help\' for more information.\n");
  }
  else
  {
    MR_Word Verbose_12;
    ...
    else
    {
      ...
      mcov__write_error_message_3_p_0(ReadErrorMsg_18);
    }
  }
}
  ...
  MR_String Msg_4)
{
  ...
  mercury__io__write_string_4_p_0(Stderr_6, Msg_4);
  mercury__io__write_string_4_p_0(Stderr_6, (MR_String) "\n");
  mercury__io__set_exit_status_3_p_0((MR_Integer) 1);
}
  ...
  MR_Box wrapper_arg_1)
{
  ...
  succeeded = mcov__IntroducedFrom__pred__write_coverage_test__217__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) (wrapper_arg_1)));
  return succeeded;
}
