  ...
  MR_Box closure_arg)
{
  ...
  succeeded = mcov__IntroducedFrom__pred__proc_process_path_port_count__309__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) ((MR_hl_field(0, closure, 4)))));
  return succeeded;
}
  ...
  MR_Box wrapper_arg_1)
{
  ...
  succeeded = mcov__IntroducedFrom__pred__write_coverage_test__218__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) (wrapper_arg_1)));
  return succeeded;
}
