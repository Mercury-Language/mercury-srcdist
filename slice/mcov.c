...
{
  {
    ...
    else
    {
      ...
      if ((MaybeReadError_16 == (MR_Word) ((MR_Integer) 0)))
      {
        ...
        if ((Modules_22 == (MR_Word) ((MR_Integer) 0)))
          RestrictToModules_23 = (MR_Word) ((MR_Integer) 0);
        else
        {
...
{
  {
    ...
    if ((RestrictToModules_9 == (MR_Word) ((MR_Integer) 0)))
    {
      ...
      case (MR_Integer) 1:
        {
          ...
          mcov__collect_zero_count_local_labels_3_p_0(TraceCounts_15, (MR_Word) ((MR_Integer) 0), &ZeroCountLabels_20);
  ...
  MR_Word * STATE_VARIABLE_CountMap_5)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      if ((MaybeCallInfo_21 == (MR_Word) ((MR_Integer) 0)))
