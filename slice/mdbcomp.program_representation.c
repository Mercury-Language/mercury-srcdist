...
MR_define_entry(mercury__mdbcomp__program_representation__determinism_representation_2_1);
	...
	{
	MR_Word MR_tempr1;
	MR_tempr1 = (MR_Word) &MR_tfield(0, (MR_Word *) &mercury_vector_common_7_1, (MR_Integer) MR_r1);
...
MR_define_entry(mercury__fn__mdbcomp__program_representation__goal_type_to_byte_1_0);
	...
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tempr1 = (MR_Word) &MR_tfield(0, (MR_Word *) &mercury_vector_common_7_2, (MR_Integer) MR_r1);
	MR_tempr2 = MR_r1;
	MR_r1 = MR_ctfield(0, MR_tempr1, 0);
	MR_proceed();
	}
...
MR_define_entry(mercury__mdbcomp__program_representation__byte_to_goal_type_2_0);
	...
	{
	MR_Word MR_tempr1;
	MR_tempr1 = (MR_Word) &MR_tfield(0, (MR_Word *) &mercury_vector_common_7_3, ((MR_Integer) MR_r1 - (MR_Integer) 1));
	MR_r2 = MR_ctfield(0, MR_tempr1, 0);
	MR_r1 = MR_TRUE;
	MR_proceed();
	}
