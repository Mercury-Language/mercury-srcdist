...
#line 53 "mdbcomp.program_representation.c"
...
static const struct mercury_type_7 mercury_vector_common_7_1[];

static const struct mercury_type_7 mercury_vector_common_7_2[];

static const struct mercury_type_7 mercury_vector_common_7_3[];
...
MR_decl_label8(mdbcomp__program_representation__no_type_info_builtin_3_0, 3,87,5,6,11,16,21,26)
MR_decl_label8(mdbcomp__program_representation__no_type_info_builtin_3_0, 31,36,41,46,51,56,61,66)
MR_decl_label4(mdbcomp__program_representation__no_type_info_builtin_3_0, 71,76,81,83)
...
MR_decl_label8(mdbcomp__program_representation__path_step_from_string_2_0, 17,21,19,24,28,30,23,32)
MR_decl_label1(mdbcomp__program_representation__path_step_from_string_2_0, 1)
...
MR_decl_label1(fn__mdbcomp__program_representation__byte_to_goal_type_1_0, 1)
MR_decl_label3(fn__mdbcomp__program_representation__goal_generates_internal_event_1_0, 7,13,8)
MR_decl_label8(fn__mdbcomp__program_representation__goal_path_step_to_string_1_0, 4,5,6,7,8,9,10,50)
MR_decl_label8(fn__mdbcomp__program_representation__goal_path_step_to_string_1_0, 12,13,51,16,17,19,21,22)
MR_decl_label5(fn__mdbcomp__program_representation__goal_path_step_to_string_1_0, 23,24,25,20,28)
...
MR_decl_label3(__Unify___mdbcomp__program_representation__arg_pos_0_0, 6,4,1)
MR_decl_label1(__Unify___mdbcomp__program_representation__atomic_goal_id_0_0, 1)
MR_decl_label8(__Unify___mdbcomp__program_representation__atomic_goal_rep_0_0, 4,8,12,16,17,21,23,25)
MR_decl_label7(__Unify___mdbcomp__program_representation__atomic_goal_rep_0_0, 27,31,35,39,43,47,1)
MR_decl_label6(__Unify___mdbcomp__program_representation__goal_path_step_0_0, 10,11,13,15,16,1)
MR_decl_label8(__Unify___mdbcomp__program_representation__goal_rep_0_0, 4,8,12,16,34,29,31,25)
MR_decl_label4(__Unify___mdbcomp__program_representation__goal_rep_0_0, 17,19,21,1)
MR_decl_label2(__Unify___mdbcomp__program_representation__proc_rep_0_0, 2,1)
MR_decl_label5(__Compare___mdbcomp__program_representation__arg_pos_0_0, 24,10,4,28,9)
MR_decl_label3(__Compare___mdbcomp__program_representation__atomic_goal_id_0_0, 3,7,12)
MR_decl_label8(__Compare___mdbcomp__program_representation__atomic_goal_rep_0_0, 4,9,13,32,527,38,42,60)
MR_decl_label8(__Compare___mdbcomp__program_representation__atomic_goal_rep_0_0, 528,67,71,88,89,98,102,117)
MR_decl_label8(__Compare___mdbcomp__program_representation__atomic_goal_rep_0_0, 530,127,140,531,151,163,532,175)
MR_decl_label8(__Compare___mdbcomp__program_representation__atomic_goal_rep_0_0, 186,197,204,534,218,227,535,242)
MR_decl_label8(__Compare___mdbcomp__program_representation__atomic_goal_rep_0_0, 246,255,536,271,275,283,537,300)
MR_decl_label7(__Compare___mdbcomp__program_representation__atomic_goal_rep_0_0, 304,310,311,326,539,329,525)
MR_decl_label8(__Compare___mdbcomp__program_representation__goal_path_step_0_0, 4,5,8,17,19,22,31,33)
MR_decl_label8(__Compare___mdbcomp__program_representation__goal_path_step_0_0, 36,45,47,50,59,61,64,73)
MR_decl_label8(__Compare___mdbcomp__program_representation__goal_path_step_0_0, 75,78,84,87,89,185,104,115)
MR_decl_label8(__Compare___mdbcomp__program_representation__goal_path_step_0_0, 119,132,135,120,142,151,165,152)
MR_decl_label1(__Compare___mdbcomp__program_representation__goal_path_step_0_0, 235)
MR_decl_label8(__Compare___mdbcomp__program_representation__goal_rep_0_0, 4,11,15,22,26,31,33,37)
MR_decl_label8(__Compare___mdbcomp__program_representation__goal_rep_0_0, 96,100,104,108,70,79,81,59)
MR_decl_label8(__Compare___mdbcomp__program_representation__goal_rep_0_0, 67,38,43,44,144,45,47,51)
MR_decl_label1(__Compare___mdbcomp__program_representation__goal_rep_0_0, 286)
MR_decl_label2(__Compare___mdbcomp__program_representation__proc_rep_0_0, 3,7)
...
MR_def_extern_entry(fn__mdbcomp__program_representation__byte_to_goal_type_1_0)
...
MR_decl_static(mdbcomp__program_representation__IntroducedFrom__pred__path_step_from_string_2__478__1_2_0)
...
{
MR_COMMON(4,4),
MR_ENTRY_AP(mdbcomp__program_representation__IntroducedFrom__pred__path_step_from_string_2__478__1_2_0),
1,
45
},
};
...
"mdbcomp.program_representation",
"mdbcomp.program_representation",
"lambda_program_representation_m_478",
2,
0
},
"mdbcomp.program_representation",
...
MR_BEGIN_MODULE(mdbcomp__program_representation_module0)
	...
	MR_init_label8(mdbcomp__program_representation__no_type_info_builtin_3_0,3,87,5,6,11,16,21,26)
	MR_init_label8(mdbcomp__program_representation__no_type_info_builtin_3_0,31,36,41,46,51,56,61,66)
	MR_init_label4(mdbcomp__program_representation__no_type_info_builtin_3_0,71,76,81,83)
MR_BEGIN_CODE
...
MR_def_label(mdbcomp__program_representation__no_type_info_builtin_3_0,3)
	...
	break; } /* end while */
MR_def_label(mdbcomp__program_representation__no_type_info_builtin_3_0,87)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_FALSE;
	MR_proceed();
MR_def_label(mdbcomp__program_representation__no_type_info_builtin_3_0,5)
	...
	MR_COMPUTED_GOTO((MR_Unsigned) MR_r4,
		...
		MR_LABEL_AP(mdbcomp__program_representation__no_type_info_builtin_3_0_i87) MR_AND
		...
		MR_LABEL_AP(mdbcomp__program_representation__no_type_info_builtin_3_0_i81));
MR_def_label(mdbcomp__program_representation__no_type_info_builtin_3_0,6)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r3,3)) {
		MR_GOTO_LAB(mdbcomp__program_representation__no_type_info_builtin_3_0_i87);
	}
	MR_incr_sp(2);
	MR_sv(2) = (MR_Word) MR_succip;
	MR_sv(1) = MR_r1;
	MR_np_call_localret_ent(fn__mdbcomp__prim_data__mercury_private_builtin_module_0_0,
		mdbcomp__program_representation__no_type_info_builtin_3_0_i83);
...
MR_BEGIN_MODULE(mdbcomp__program_representation_module9)
	...
	MR_init_label8(mdbcomp__program_representation__path_step_from_string_2_0,17,21,19,24,28,30,23,32)
	MR_init_label1(mdbcomp__program_representation__path_step_from_string_2_0,1)
MR_BEGIN_CODE
...
MR_def_label(mdbcomp__program_representation__path_step_from_string_2_0,28)
	...
	MR_sv(1) = MR_r2;
	MR_np_call_localret_ent(string__to_int_2_0,
		mdbcomp__program_representation__path_step_from_string_2_0_i30);
...
MR_def_label(mdbcomp__program_representation__path_step_from_string_2_0,23)
	...
	if (MR_INT_NE(MR_r2,116)) {
		MR_GOTO_LAB(mdbcomp__program_representation__path_step_from_string_2_0_i32);
	}
	if ((strcmp((char *)MR_r3, (char *)(MR_Word) MR_string_const("", 0)) != 0)) {
		MR_GOTO_LAB(mdbcomp__program_representation__path_step_from_string_2_0_i1);
	}
...
MR_BEGIN_MODULE(mdbcomp__program_representation_module17)
	MR_init_entry1(fn__mdbcomp__program_representation__byte_to_goal_type_1_0);
	MR_init_label1(fn__mdbcomp__program_representation__byte_to_goal_type_1_0,1)
MR_BEGIN_CODE
	...
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_define_entry(mercury__fn__mdbcomp__program_representation__byte_to_goal_type_1_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(((MR_Unsigned) ((MR_Integer) MR_r1 - (MR_Integer) 1) <= 18))) {
		MR_GOTO_LAB(fn__mdbcomp__program_representation__byte_to_goal_type_1_0_i1);
	}
	{
	MR_Word MR_tempr1;
...
MR_def_label(fn__mdbcomp__program_representation__byte_to_goal_type_1_0,1)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_FALSE;
	MR_proceed();
#ifdef MR_maybe_local_thread_engine_base
...
MR_BEGIN_MODULE(mdbcomp__program_representation_module20)
	...
	MR_init_label8(fn__mdbcomp__program_representation__goal_path_step_to_string_1_0,4,5,6,7,8,9,10,50)
	MR_init_label8(fn__mdbcomp__program_representation__goal_path_step_to_string_1_0,12,13,51,16,17,19,21,22)
	MR_init_label5(fn__mdbcomp__program_representation__goal_path_step_to_string_1_0,23,24,25,20,28)
MR_BEGIN_CODE
...
MR_def_static(fn__mdbcomp__program_representation__goal_path_step_to_string_1_0)
	...
	MR_COMPUTED_GOTO((MR_Unsigned) MR_tag(MR_r1),
		...
		MR_LABEL_AP(fn__mdbcomp__program_representation__goal_path_step_to_string_1_0_i50) MR_AND
		MR_LABEL_AP(fn__mdbcomp__program_representation__goal_path_step_to_string_1_0_i51) MR_AND
...
MR_def_label(fn__mdbcomp__program_representation__goal_path_step_to_string_1_0,10)
	...
	MR_proceed();
MR_def_label(fn__mdbcomp__program_representation__goal_path_step_to_string_1_0,50)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(2);
	MR_sv(2) = (MR_Word) MR_succip;
	MR_r1 = MR_ctfield(1, MR_r1, 0);
...
MR_def_label(fn__mdbcomp__program_representation__goal_path_step_to_string_1_0,51)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(2);
	MR_sv(2) = (MR_Word) MR_succip;
...
MR_def_label(fn__mdbcomp__program_representation__goal_path_step_to_string_1_0,19)
	...
	MR_np_call_localret_ent(fn__string__int_to_string_1_0,
		fn__mdbcomp__program_representation__goal_path_step_to_string_1_0_i21);
MR_def_label(fn__mdbcomp__program_representation__goal_path_step_to_string_1_0,21)
	...
	MR_np_call_localret_ent(fn__string__int_to_string_1_0,
		fn__mdbcomp__program_representation__goal_path_step_to_string_1_0_i22);
...
MR_def_label(fn__mdbcomp__program_representation__goal_path_step_to_string_1_0,23)
	...
	MR_np_call_localret_ent(fn__f_115_116_114_105_110_103_95_95_43_43_2_0,
		fn__mdbcomp__program_representation__goal_path_step_to_string_1_0_i24);
MR_def_label(fn__mdbcomp__program_representation__goal_path_step_to_string_1_0,24)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_r1;
	MR_r1 = MR_sv(1);
	MR_np_call_localret_ent(fn__f_115_116_114_105_110_103_95_95_43_43_2_0,
		fn__mdbcomp__program_representation__goal_path_step_to_string_1_0_i25);
MR_def_label(fn__mdbcomp__program_representation__goal_path_step_to_string_1_0,25)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_r1;
...
MR_def_label(fn__mdbcomp__program_representation__goal_path_step_to_string_1_0,20)
	...
	if (MR_INT_NE(MR_tempr1,0)) {
		MR_GOTO_LAB(fn__mdbcomp__program_representation__goal_path_step_to_string_1_0_i28);
	}
...
MR_BEGIN_MODULE(mdbcomp__program_representation_module21)
	...
	MR_init_label3(__Unify___mdbcomp__program_representation__arg_pos_0_0,6,4,1)
MR_BEGIN_CODE
...
MR_define_entry(mercury____Unify___mdbcomp__program_representation__arg_pos_0_0);
	...
	if (MR_PTAG_TEST(MR_r1,1)) {
		MR_GOTO_LAB(__Unify___mdbcomp__program_representation__arg_pos_0_0_i4);
	}
...
MR_def_label(__Unify___mdbcomp__program_representation__arg_pos_0_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_BEGIN_MODULE(mdbcomp__program_representation_module22)
	...
	MR_init_label5(__Compare___mdbcomp__program_representation__arg_pos_0_0,24,10,4,28,9)
MR_BEGIN_CODE
...
MR_define_entry(mercury____Compare___mdbcomp__program_representation__arg_pos_0_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TEST(MR_r1,1)) {
		MR_GOTO_LAB(__Compare___mdbcomp__program_representation__arg_pos_0_0_i4);
	}
	if (MR_PTAG_TEST(MR_r1,2)) {
...
MR_def_label(__Compare___mdbcomp__program_representation__arg_pos_0_0,24)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_def_label(__Compare___mdbcomp__program_representation__arg_pos_0_0,10)
	...
	if (MR_PTAG_TEST(MR_r2,2)) {
		MR_GOTO_LAB(__Compare___mdbcomp__program_representation__arg_pos_0_0_i24);
	}
	MR_r1 = (MR_Integer) 2;
	MR_proceed();
MR_def_label(__Compare___mdbcomp__program_representation__arg_pos_0_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TEST(MR_r2,1)) {
		MR_GOTO_LAB(__Compare___mdbcomp__program_representation__arg_pos_0_0_i24);
	}
...
MR_BEGIN_MODULE(mdbcomp__program_representation_module23)
	...
	MR_init_label1(__Unify___mdbcomp__program_representation__atomic_goal_id_0_0,1)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(mdbcomp__program_representation_module24)
	...
	MR_init_label3(__Compare___mdbcomp__program_representation__atomic_goal_id_0_0,3,7,12)
MR_BEGIN_CODE
...
MR_define_entry(mercury____Compare___mdbcomp__program_representation__atomic_goal_id_0_0);
	...
	MR_np_call_localret_ent(private_builtin__builtin_compare_string_3_0,
		__Compare___mdbcomp__program_representation__atomic_goal_id_0_0_i3);
MR_def_label(__Compare___mdbcomp__program_representation__atomic_goal_id_0_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___mdbcomp__program_representation__atomic_goal_id_0_0_i12);
	}
	MR_r1 = MR_sv(1);
	MR_r2 = MR_sv(3);
	MR_np_call_localret_ent(private_builtin__builtin_compare_string_3_0,
		__Compare___mdbcomp__program_representation__atomic_goal_id_0_0_i7);
MR_def_label(__Compare___mdbcomp__program_representation__atomic_goal_id_0_0,7)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___mdbcomp__program_representation__atomic_goal_id_0_0_i12);
	}
	...
	MR_decr_sp(5);
	MR_np_tailcall_ent(private_builtin__builtin_compare_int_3_0);
MR_def_label(__Compare___mdbcomp__program_representation__atomic_goal_id_0_0,12)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_BEGIN_MODULE(mdbcomp__program_representation_module25)
	...
	MR_init_label8(__Unify___mdbcomp__program_representation__atomic_goal_rep_0_0,4,8,12,16,17,21,23,25)
	MR_init_label7(__Unify___mdbcomp__program_representation__atomic_goal_rep_0_0,27,31,35,39,43,47,1)
MR_BEGIN_CODE
...
MR_define_entry(mercury____Unify___mdbcomp__program_representation__atomic_goal_rep_0_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_COMPUTED_GOTO((MR_Unsigned) MR_tag(MR_r1),
		MR_LABEL_AP(__Unify___mdbcomp__program_representation__atomic_goal_rep_0_0_i4) MR_AND
		MR_LABEL_AP(__Unify___mdbcomp__program_representation__atomic_goal_rep_0_0_i8) MR_AND
		MR_LABEL_AP(__Unify___mdbcomp__program_representation__atomic_goal_rep_0_0_i12) MR_AND
		MR_LABEL_AP(__Unify___mdbcomp__program_representation__atomic_goal_rep_0_0_i16));
MR_def_label(__Unify___mdbcomp__program_representation__atomic_goal_rep_0_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_r2,0)) {
...
MR_def_label(__Unify___mdbcomp__program_representation__atomic_goal_rep_0_0,8)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_r2,1)) {
		MR_GOTO_LAB(__Unify___mdbcomp__program_representation__atomic_goal_rep_0_0_i1);
	}
...
MR_def_label(__Unify___mdbcomp__program_representation__atomic_goal_rep_0_0,12)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_r2,2)) {
		MR_GOTO_LAB(__Unify___mdbcomp__program_representation__atomic_goal_rep_0_0_i1);
	}
...
MR_def_label(__Unify___mdbcomp__program_representation__atomic_goal_rep_0_0,16)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_COMPUTED_GOTO((MR_Unsigned) MR_ctfield(3, MR_r1, 0),
		MR_LABEL_AP(__Unify___mdbcomp__program_representation__atomic_goal_rep_0_0_i17) MR_AND
		MR_LABEL_AP(__Unify___mdbcomp__program_representation__atomic_goal_rep_0_0_i21) MR_AND
		...
		MR_LABEL_AP(__Unify___mdbcomp__program_representation__atomic_goal_rep_0_0_i31) MR_AND
		MR_LABEL_AP(__Unify___mdbcomp__program_representation__atomic_goal_rep_0_0_i35) MR_AND
		MR_LABEL_AP(__Unify___mdbcomp__program_representation__atomic_goal_rep_0_0_i39) MR_AND
		MR_LABEL_AP(__Unify___mdbcomp__program_representation__atomic_goal_rep_0_0_i43) MR_AND
		MR_LABEL_AP(__Unify___mdbcomp__program_representation__atomic_goal_rep_0_0_i47));
...
MR_BEGIN_MODULE(mdbcomp__program_representation_module26)
	...
	MR_init_label8(__Compare___mdbcomp__program_representation__atomic_goal_rep_0_0,4,9,13,32,527,38,42,60)
	MR_init_label8(__Compare___mdbcomp__program_representation__atomic_goal_rep_0_0,528,67,71,88,89,98,102,117)
	MR_init_label8(__Compare___mdbcomp__program_representation__atomic_goal_rep_0_0,530,127,140,531,151,163,532,175)
	MR_init_label8(__Compare___mdbcomp__program_representation__atomic_goal_rep_0_0,186,197,204,534,218,227,535,242)
	MR_init_label8(__Compare___mdbcomp__program_representation__atomic_goal_rep_0_0,246,255,536,271,275,283,537,300)
	MR_init_label7(__Compare___mdbcomp__program_representation__atomic_goal_rep_0_0,304,310,311,326,539,329,525)
MR_BEGIN_CODE
...
MR_define_entry(mercury____Compare___mdbcomp__program_representation__atomic_goal_rep_0_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_COMPUTED_GOTO((MR_Unsigned) MR_tag(MR_r1),
		MR_LABEL_AP(__Compare___mdbcomp__program_representation__atomic_goal_rep_0_0_i4) MR_AND
		MR_LABEL_AP(__Compare___mdbcomp__program_representation__atomic_goal_rep_0_0_i32) MR_AND
		MR_LABEL_AP(__Compare___mdbcomp__program_representation__atomic_goal_rep_0_0_i60) MR_AND
		MR_LABEL_AP(__Compare___mdbcomp__program_representation__atomic_goal_rep_0_0_i88));
MR_def_label(__Compare___mdbcomp__program_representation__atomic_goal_rep_0_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_tag(MR_r2),0)) {
		MR_GOTO_LAB(__Compare___mdbcomp__program_representation__atomic_goal_rep_0_0_i310);
	}
	MR_incr_sp(5);
	MR_sv(5) = (MR_Word) MR_succip;
...
MR_def_label(__Compare___mdbcomp__program_representation__atomic_goal_rep_0_0,9)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___mdbcomp__program_representation__atomic_goal_rep_0_0_i525);
	}
	MR_r1 = MR_sv(4);
	MR_r2 = MR_sv(1);
	MR_np_call_localret_ent(private_builtin__builtin_compare_string_3_0,
...
MR_def_label(__Compare___mdbcomp__program_representation__atomic_goal_rep_0_0,32)
	...
	MR_COMPUTED_GOTO((MR_Unsigned) MR_tag(MR_r2),
		MR_LABEL_AP(__Compare___mdbcomp__program_representation__atomic_goal_rep_0_0_i326) MR_AND
		MR_LABEL_AP(__Compare___mdbcomp__program_representation__atomic_goal_rep_0_0_i527) MR_AND
		MR_LABEL_AP(__Compare___mdbcomp__program_representation__atomic_goal_rep_0_0_i310) MR_AND
		MR_LABEL_AP(__Compare___mdbcomp__program_representation__atomic_goal_rep_0_0_i310));
MR_def_label(__Compare___mdbcomp__program_representation__atomic_goal_rep_0_0,527)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(5);
	MR_sv(5) = (MR_Word) MR_succip;
	...
	MR_np_call_localret_ent(private_builtin__builtin_compare_int_3_0,
		__Compare___mdbcomp__program_representation__atomic_goal_rep_0_0_i38);
MR_def_label(__Compare___mdbcomp__program_representation__atomic_goal_rep_0_0,38)
	...
	MR_r2 = MR_sv(1);
	MR_np_call_localret_ent(private_builtin__builtin_compare_string_3_0,
		__Compare___mdbcomp__program_representation__atomic_goal_rep_0_0_i42);
MR_def_label(__Compare___mdbcomp__program_representation__atomic_goal_rep_0_0,42)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___mdbcomp__program_representation__atomic_goal_rep_0_0_i525);
	}
...
MR_def_label(__Compare___mdbcomp__program_representation__atomic_goal_rep_0_0,60)
	...
	MR_COMPUTED_GOTO((MR_Unsigned) MR_tag(MR_r2),
		MR_LABEL_AP(__Compare___mdbcomp__program_representation__atomic_goal_rep_0_0_i326) MR_AND
		MR_LABEL_AP(__Compare___mdbcomp__program_representation__atomic_goal_rep_0_0_i326) MR_AND
		MR_LABEL_AP(__Compare___mdbcomp__program_representation__atomic_goal_rep_0_0_i528) MR_AND
		MR_LABEL_AP(__Compare___mdbcomp__program_representation__atomic_goal_rep_0_0_i310));
MR_def_label(__Compare___mdbcomp__program_representation__atomic_goal_rep_0_0,528)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(5);
	MR_sv(5) = (MR_Word) MR_succip;
	...
	MR_np_call_localret_ent(private_builtin__builtin_compare_int_3_0,
		__Compare___mdbcomp__program_representation__atomic_goal_rep_0_0_i67);
MR_def_label(__Compare___mdbcomp__program_representation__atomic_goal_rep_0_0,67)
	...
	MR_r2 = MR_sv(1);
	MR_np_call_localret_ent(private_builtin__builtin_compare_string_3_0,
		__Compare___mdbcomp__program_representation__atomic_goal_rep_0_0_i71);
...
MR_def_label(__Compare___mdbcomp__program_representation__atomic_goal_rep_0_0,88)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_COMPUTED_GOTO((MR_Unsigned) MR_ctfield(3, MR_r1, 0),
		MR_LABEL_AP(__Compare___mdbcomp__program_representation__atomic_goal_rep_0_0_i89) MR_AND
		MR_LABEL_AP(__Compare___mdbcomp__program_representation__atomic_goal_rep_0_0_i117) MR_AND
		MR_LABEL_AP(__Compare___mdbcomp__program_representation__atomic_goal_rep_0_0_i140) MR_AND
		MR_LABEL_AP(__Compare___mdbcomp__program_representation__atomic_goal_rep_0_0_i163) MR_AND
		MR_LABEL_AP(__Compare___mdbcomp__program_representation__atomic_goal_rep_0_0_i186) MR_AND
		MR_LABEL_AP(__Compare___mdbcomp__program_representation__atomic_goal_rep_0_0_i204) MR_AND
		MR_LABEL_AP(__Compare___mdbcomp__program_representation__atomic_goal_rep_0_0_i227) MR_AND
		MR_LABEL_AP(__Compare___mdbcomp__program_representation__atomic_goal_rep_0_0_i255) MR_AND
		MR_LABEL_AP(__Compare___mdbcomp__program_representation__atomic_goal_rep_0_0_i283) MR_AND
		MR_LABEL_AP(__Compare___mdbcomp__program_representation__atomic_goal_rep_0_0_i311));
MR_def_label(__Compare___mdbcomp__program_representation__atomic_goal_rep_0_0,89)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_tag(MR_r2),3)) {
		MR_GOTO_LAB(__Compare___mdbcomp__program_representation__atomic_goal_rep_0_0_i326);
	}
	...
	MR_np_call_localret_ent(private_builtin__builtin_compare_int_3_0,
		__Compare___mdbcomp__program_representation__atomic_goal_rep_0_0_i98);
MR_def_label(__Compare___mdbcomp__program_representation__atomic_goal_rep_0_0,98)
	...
	MR_r2 = MR_sv(1);
	MR_np_call_localret_ent(private_builtin__builtin_compare_string_3_0,
		__Compare___mdbcomp__program_representation__atomic_goal_rep_0_0_i102);
MR_def_label(__Compare___mdbcomp__program_representation__atomic_goal_rep_0_0,102)
	...
	MR_decr_sp(5);
	MR_np_tailcall_ent(__Compare___list__list_1_0);
MR_def_label(__Compare___mdbcomp__program_representation__atomic_goal_rep_0_0,117)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_tag(MR_r2),3)) {
		MR_GOTO_LAB(__Compare___mdbcomp__program_representation__atomic_goal_rep_0_0_i326);
	}
	MR_COMPUTED_GOTO((MR_Unsigned) MR_ctfield(3, MR_r2, 0),
		MR_LABEL_AP(__Compare___mdbcomp__program_representation__atomic_goal_rep_0_0_i326) MR_AND
		MR_LABEL_AP(__Compare___mdbcomp__program_representation__atomic_goal_rep_0_0_i530) MR_AND
		MR_LABEL_AP(__Compare___mdbcomp__program_representation__atomic_goal_rep_0_0_i310) MR_AND
		MR_LABEL_AP(__Compare___mdbcomp__program_representation__atomic_goal_rep_0_0_i310) MR_AND
		MR_LABEL_AP(__Compare___mdbcomp__program_representation__atomic_goal_rep_0_0_i310) MR_AND
		MR_LABEL_AP(__Compare___mdbcomp__program_representation__atomic_goal_rep_0_0_i310) MR_AND
		...
		MR_LABEL_AP(__Compare___mdbcomp__program_representation__atomic_goal_rep_0_0_i310) MR_AND
		MR_LABEL_AP(__Compare___mdbcomp__program_representation__atomic_goal_rep_0_0_i310));
MR_def_label(__Compare___mdbcomp__program_representation__atomic_goal_rep_0_0,530)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(5);
	MR_sv(5) = (MR_Word) MR_succip;
	MR_sv(2) = MR_ctfield(3, MR_r1, 2);
	...
	MR_r2 = MR_ctfield(3, MR_r2, 1);
	MR_np_call_localret_ent(private_builtin__builtin_compare_int_3_0,
		__Compare___mdbcomp__program_representation__atomic_goal_rep_0_0_i127);
...
MR_def_label(__Compare___mdbcomp__program_representation__atomic_goal_rep_0_0,140)
	...
	MR_COMPUTED_GOTO((MR_Unsigned) MR_ctfield(3, MR_r2, 0),
		MR_LABEL_AP(__Compare___mdbcomp__program_representation__atomic_goal_rep_0_0_i326) MR_AND
		MR_LABEL_AP(__Compare___mdbcomp__program_representation__atomic_goal_rep_0_0_i326) MR_AND
		MR_LABEL_AP(__Compare___mdbcomp__program_representation__atomic_goal_rep_0_0_i531) MR_AND
		MR_LABEL_AP(__Compare___mdbcomp__program_representation__atomic_goal_rep_0_0_i310) MR_AND
		MR_LABEL_AP(__Compare___mdbcomp__program_representation__atomic_goal_rep_0_0_i310) MR_AND
		MR_LABEL_AP(__Compare___mdbcomp__program_representation__atomic_goal_rep_0_0_i310) MR_AND
		MR_LABEL_AP(__Compare___mdbcomp__program_representation__atomic_goal_rep_0_0_i310) MR_AND
		...
		MR_LABEL_AP(__Compare___mdbcomp__program_representation__atomic_goal_rep_0_0_i310) MR_AND
		MR_LABEL_AP(__Compare___mdbcomp__program_representation__atomic_goal_rep_0_0_i310));
MR_def_label(__Compare___mdbcomp__program_representation__atomic_goal_rep_0_0,531)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(5);
	MR_sv(5) = (MR_Word) MR_succip;
	MR_sv(2) = MR_ctfield(3, MR_r1, 2);
	...
	MR_r2 = MR_ctfield(3, MR_r2, 1);
	MR_np_call_localret_ent(private_builtin__builtin_compare_int_3_0,
		__Compare___mdbcomp__program_representation__atomic_goal_rep_0_0_i151);
...
MR_def_label(__Compare___mdbcomp__program_representation__atomic_goal_rep_0_0,163)
	...
	MR_COMPUTED_GOTO((MR_Unsigned) MR_ctfield(3, MR_r2, 0),
		...
		MR_LABEL_AP(__Compare___mdbcomp__program_representation__atomic_goal_rep_0_0_i326) MR_AND
		MR_LABEL_AP(__Compare___mdbcomp__program_representation__atomic_goal_rep_0_0_i326) MR_AND
		MR_LABEL_AP(__Compare___mdbcomp__program_representation__atomic_goal_rep_0_0_i532) MR_AND
		MR_LABEL_AP(__Compare___mdbcomp__program_representation__atomic_goal_rep_0_0_i310) MR_AND
		MR_LABEL_AP(__Compare___mdbcomp__program_representation__atomic_goal_rep_0_0_i310) MR_AND
		MR_LABEL_AP(__Compare___mdbcomp__program_representation__atomic_goal_rep_0_0_i310) MR_AND
		MR_LABEL_AP(__Compare___mdbcomp__program_representation__atomic_goal_rep_0_0_i310) MR_AND
		MR_LABEL_AP(__Compare___mdbcomp__program_representation__atomic_goal_rep_0_0_i310) MR_AND
		MR_LABEL_AP(__Compare___mdbcomp__program_representation__atomic_goal_rep_0_0_i310));
MR_def_label(__Compare___mdbcomp__program_representation__atomic_goal_rep_0_0,532)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(5);
	MR_sv(5) = (MR_Word) MR_succip;
	MR_sv(2) = MR_ctfield(3, MR_r1, 2);
	...
	MR_r2 = MR_ctfield(3, MR_r2, 1);
	MR_np_call_localret_ent(private_builtin__builtin_compare_int_3_0,
		__Compare___mdbcomp__program_representation__atomic_goal_rep_0_0_i175);
...
MR_def_label(__Compare___mdbcomp__program_representation__atomic_goal_rep_0_0,186)
	...
	MR_COMPUTED_GOTO((MR_Unsigned) MR_ctfield(3, MR_r2, 0),
		...
		MR_LABEL_AP(__Compare___mdbcomp__program_representation__atomic_goal_rep_0_0_i326) MR_AND
		MR_LABEL_AP(__Compare___mdbcomp__program_representation__atomic_goal_rep_0_0_i326) MR_AND
		MR_LABEL_AP(__Compare___mdbcomp__program_representation__atomic_goal_rep_0_0_i197) MR_AND
		MR_LABEL_AP(__Compare___mdbcomp__program_representation__atomic_goal_rep_0_0_i310) MR_AND
		MR_LABEL_AP(__Compare___mdbcomp__program_representation__atomic_goal_rep_0_0_i310) MR_AND
		MR_LABEL_AP(__Compare___mdbcomp__program_representation__atomic_goal_rep_0_0_i310) MR_AND
		MR_LABEL_AP(__Compare___mdbcomp__program_representation__atomic_goal_rep_0_0_i310) MR_AND
...
MR_def_label(__Compare___mdbcomp__program_representation__atomic_goal_rep_0_0,204)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_tag(MR_r2),3)) {
		MR_GOTO_LAB(__Compare___mdbcomp__program_representation__atomic_goal_rep_0_0_i326);
	}
	MR_COMPUTED_GOTO((MR_Unsigned) MR_ctfield(3, MR_r2, 0),
		...
		MR_LABEL_AP(__Compare___mdbcomp__program_representation__atomic_goal_rep_0_0_i326) MR_AND
		MR_LABEL_AP(__Compare___mdbcomp__program_representation__atomic_goal_rep_0_0_i326) MR_AND
		MR_LABEL_AP(__Compare___mdbcomp__program_representation__atomic_goal_rep_0_0_i534) MR_AND
		MR_LABEL_AP(__Compare___mdbcomp__program_representation__atomic_goal_rep_0_0_i310) MR_AND
		MR_LABEL_AP(__Compare___mdbcomp__program_representation__atomic_goal_rep_0_0_i310) MR_AND
		MR_LABEL_AP(__Compare___mdbcomp__program_representation__atomic_goal_rep_0_0_i310) MR_AND
		MR_LABEL_AP(__Compare___mdbcomp__program_representation__atomic_goal_rep_0_0_i310));
MR_def_label(__Compare___mdbcomp__program_representation__atomic_goal_rep_0_0,534)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(5);
	MR_sv(5) = (MR_Word) MR_succip;
	MR_sv(2) = MR_ctfield(3, MR_r1, 2);
	...
	MR_r2 = MR_ctfield(3, MR_r2, 1);
	MR_np_call_localret_ent(private_builtin__builtin_compare_int_3_0,
		__Compare___mdbcomp__program_representation__atomic_goal_rep_0_0_i218);
...
MR_def_label(__Compare___mdbcomp__program_representation__atomic_goal_rep_0_0,227)
	...
	MR_COMPUTED_GOTO((MR_Unsigned) MR_ctfield(3, MR_r2, 0),
		...
		MR_LABEL_AP(__Compare___mdbcomp__program_representation__atomic_goal_rep_0_0_i326) MR_AND
		MR_LABEL_AP(__Compare___mdbcomp__program_representation__atomic_goal_rep_0_0_i326) MR_AND
		MR_LABEL_AP(__Compare___mdbcomp__program_representation__atomic_goal_rep_0_0_i535) MR_AND
		MR_LABEL_AP(__Compare___mdbcomp__program_representation__atomic_goal_rep_0_0_i310) MR_AND
		MR_LABEL_AP(__Compare___mdbcomp__program_representation__atomic_goal_rep_0_0_i310) MR_AND
		MR_LABEL_AP(__Compare___mdbcomp__program_representation__atomic_goal_rep_0_0_i310));
MR_def_label(__Compare___mdbcomp__program_representation__atomic_goal_rep_0_0,535)
	...
	MR_np_call_localret_ent(private_builtin__builtin_compare_int_3_0,
		__Compare___mdbcomp__program_representation__atomic_goal_rep_0_0_i242);
MR_def_label(__Compare___mdbcomp__program_representation__atomic_goal_rep_0_0,242)
	...
	MR_r2 = MR_sv(1);
	MR_np_call_localret_ent(private_builtin__builtin_compare_int_3_0,
		__Compare___mdbcomp__program_representation__atomic_goal_rep_0_0_i246);
...
MR_def_label(__Compare___mdbcomp__program_representation__atomic_goal_rep_0_0,255)
	...
	MR_COMPUTED_GOTO((MR_Unsigned) MR_ctfield(3, MR_r2, 0),
		...
		MR_LABEL_AP(__Compare___mdbcomp__program_representation__atomic_goal_rep_0_0_i326) MR_AND
		MR_LABEL_AP(__Compare___mdbcomp__program_representation__atomic_goal_rep_0_0_i326) MR_AND
		MR_LABEL_AP(__Compare___mdbcomp__program_representation__atomic_goal_rep_0_0_i536) MR_AND
		MR_LABEL_AP(__Compare___mdbcomp__program_representation__atomic_goal_rep_0_0_i310) MR_AND
		MR_LABEL_AP(__Compare___mdbcomp__program_representation__atomic_goal_rep_0_0_i310));
MR_def_label(__Compare___mdbcomp__program_representation__atomic_goal_rep_0_0,536)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(5);
	MR_sv(5) = (MR_Word) MR_succip;
	MR_sv(4) = MR_ctfield(3, MR_r1, 2);
	...
	MR_np_call_localret_ent(private_builtin__builtin_compare_string_3_0,
		__Compare___mdbcomp__program_representation__atomic_goal_rep_0_0_i271);
MR_def_label(__Compare___mdbcomp__program_representation__atomic_goal_rep_0_0,271)
	...
	MR_r2 = MR_sv(1);
	MR_np_call_localret_ent(private_builtin__builtin_compare_string_3_0,
		__Compare___mdbcomp__program_representation__atomic_goal_rep_0_0_i275);
MR_def_label(__Compare___mdbcomp__program_representation__atomic_goal_rep_0_0,275)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___mdbcomp__program_representation__atomic_goal_rep_0_0_i525);
	}
...
MR_def_label(__Compare___mdbcomp__program_representation__atomic_goal_rep_0_0,283)
	...
	MR_COMPUTED_GOTO((MR_Unsigned) MR_ctfield(3, MR_r2, 0),
		...
		MR_LABEL_AP(__Compare___mdbcomp__program_representation__atomic_goal_rep_0_0_i326) MR_AND
		MR_LABEL_AP(__Compare___mdbcomp__program_representation__atomic_goal_rep_0_0_i326) MR_AND
		MR_LABEL_AP(__Compare___mdbcomp__program_representation__atomic_goal_rep_0_0_i537) MR_AND
		MR_LABEL_AP(__Compare___mdbcomp__program_representation__atomic_goal_rep_0_0_i310));
MR_def_label(__Compare___mdbcomp__program_representation__atomic_goal_rep_0_0,537)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(5);
	MR_sv(5) = (MR_Word) MR_succip;
	MR_sv(4) = MR_ctfield(3, MR_r1, 2);
	...
	MR_np_call_localret_ent(private_builtin__builtin_compare_string_3_0,
		__Compare___mdbcomp__program_representation__atomic_goal_rep_0_0_i300);
MR_def_label(__Compare___mdbcomp__program_representation__atomic_goal_rep_0_0,300)
	...
	MR_r2 = MR_sv(1);
	MR_np_call_localret_ent(private_builtin__builtin_compare_string_3_0,
		__Compare___mdbcomp__program_representation__atomic_goal_rep_0_0_i304);
MR_def_label(__Compare___mdbcomp__program_representation__atomic_goal_rep_0_0,304)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___mdbcomp__program_representation__atomic_goal_rep_0_0_i525);
	}
	...
	MR_decr_sp(5);
	MR_np_tailcall_ent(__Compare___list__list_1_0);
MR_def_label(__Compare___mdbcomp__program_representation__atomic_goal_rep_0_0,310)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Integer) 1;
	MR_proceed();
MR_def_label(__Compare___mdbcomp__program_representation__atomic_goal_rep_0_0,311)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_tag(MR_r2),3)) {
		MR_GOTO_LAB(__Compare___mdbcomp__program_representation__atomic_goal_rep_0_0_i326);
	}
	if (MR_INT_EQ(MR_ctfield(3, MR_r2, 0),9)) {
		MR_GOTO_LAB(__Compare___mdbcomp__program_representation__atomic_goal_rep_0_0_i539);
	}
MR_def_label(__Compare___mdbcomp__program_representation__atomic_goal_rep_0_0,326)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Integer) 2;
	MR_proceed();
MR_def_label(__Compare___mdbcomp__program_representation__atomic_goal_rep_0_0,539)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(5);
	MR_sv(5) = (MR_Word) MR_succip;
	MR_sv(2) = MR_ctfield(3, MR_r1, 2);
	...
	MR_r2 = MR_ctfield(3, MR_r2, 1);
	MR_np_call_localret_ent(private_builtin__builtin_compare_string_3_0,
		__Compare___mdbcomp__program_representation__atomic_goal_rep_0_0_i329);
MR_def_label(__Compare___mdbcomp__program_representation__atomic_goal_rep_0_0,329)
	...
	MR_decr_sp(5);
	MR_np_tailcall_ent(__Compare___list__list_1_0);
MR_def_label(__Compare___mdbcomp__program_representation__atomic_goal_rep_0_0,525)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(5);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
...
MR_BEGIN_MODULE(mdbcomp__program_representation_module37)
	...
	MR_init_label6(__Unify___mdbcomp__program_representation__goal_path_step_0_0,10,11,13,15,16,1)
MR_BEGIN_CODE
...
MR_define_entry(mercury____Unify___mdbcomp__program_representation__goal_path_step_0_0);
	...
	MR_COMPUTED_GOTO((MR_Unsigned) MR_tag(MR_r1),
		...
		MR_LABEL_AP(__Unify___mdbcomp__program_representation__goal_path_step_0_0_i11) MR_AND
		MR_LABEL_AP(__Unify___mdbcomp__program_representation__goal_path_step_0_0_i13) MR_AND
		MR_LABEL_AP(__Unify___mdbcomp__program_representation__goal_path_step_0_0_i15));
MR_def_label(__Unify___mdbcomp__program_representation__goal_path_step_0_0,10)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_r2 == MR_r1);
	MR_proceed();
MR_def_label(__Unify___mdbcomp__program_representation__goal_path_step_0_0,11)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_r2,1)) {
...
MR_def_label(__Unify___mdbcomp__program_representation__goal_path_step_0_0,15)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_ctfield(3, MR_r1, 0),0)) {
		MR_GOTO_LAB(__Unify___mdbcomp__program_representation__goal_path_step_0_0_i16);
	}
	if (MR_RTAGS_TESTR(MR_r2,3,0)) {
		MR_GOTO_LAB(__Unify___mdbcomp__program_representation__goal_path_step_0_0_i1);
	}
...
MR_def_label(__Unify___mdbcomp__program_representation__goal_path_step_0_0,16)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_RTAGS_TESTR(MR_r2,3,1)) {
		MR_GOTO_LAB(__Unify___mdbcomp__program_representation__goal_path_step_0_0_i1);
	}
...
MR_BEGIN_MODULE(mdbcomp__program_representation_module38)
	...
	MR_init_label8(__Compare___mdbcomp__program_representation__goal_path_step_0_0,4,5,8,17,19,22,31,33)
	MR_init_label8(__Compare___mdbcomp__program_representation__goal_path_step_0_0,36,45,47,50,59,61,64,73)
	MR_init_label8(__Compare___mdbcomp__program_representation__goal_path_step_0_0,75,78,84,87,89,185,104,115)
	MR_init_label8(__Compare___mdbcomp__program_representation__goal_path_step_0_0,119,132,135,120,142,151,165,152)
	MR_init_label1(__Compare___mdbcomp__program_representation__goal_path_step_0_0,235)
MR_BEGIN_CODE
...
MR_define_entry(mercury____Compare___mdbcomp__program_representation__goal_path_step_0_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_COMPUTED_GOTO((MR_Unsigned) MR_tag(MR_r1),
		MR_LABEL_AP(__Compare___mdbcomp__program_representation__goal_path_step_0_0_i4) MR_AND
		MR_LABEL_AP(__Compare___mdbcomp__program_representation__goal_path_step_0_0_i89) MR_AND
		MR_LABEL_AP(__Compare___mdbcomp__program_representation__goal_path_step_0_0_i104) MR_AND
		MR_LABEL_AP(__Compare___mdbcomp__program_representation__goal_path_step_0_0_i119));
MR_def_label(__Compare___mdbcomp__program_representation__goal_path_step_0_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_COMPUTED_GOTO((MR_Unsigned) MR_unmkbody(MR_r1),
		...
		MR_LABEL_AP(__Compare___mdbcomp__program_representation__goal_path_step_0_0_i33) MR_AND
		MR_LABEL_AP(__Compare___mdbcomp__program_representation__goal_path_step_0_0_i47) MR_AND
...
MR_def_label(__Compare___mdbcomp__program_representation__goal_path_step_0_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_COMPUTED_GOTO((MR_Unsigned) MR_tag(MR_r2),
		MR_LABEL_AP(__Compare___mdbcomp__program_representation__goal_path_step_0_0_i8) MR_AND
		MR_LABEL_AP(__Compare___mdbcomp__program_representation__goal_path_step_0_0_i165) MR_AND
		MR_LABEL_AP(__Compare___mdbcomp__program_representation__goal_path_step_0_0_i165) MR_AND
		MR_LABEL_AP(__Compare___mdbcomp__program_representation__goal_path_step_0_0_i17));
MR_def_label(__Compare___mdbcomp__program_representation__goal_path_step_0_0,8)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_EQ(MR_unmkbody(MR_r2),0)) {
		MR_GOTO_LAB(__Compare___mdbcomp__program_representation__goal_path_step_0_0_i84);
	}
	MR_GOTO_LAB(__Compare___mdbcomp__program_representation__goal_path_step_0_0_i185);
MR_def_label(__Compare___mdbcomp__program_representation__goal_path_step_0_0,17)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_ctfield(3, MR_r2, 0),0)) {
		MR_GOTO_LAB(__Compare___mdbcomp__program_representation__goal_path_step_0_0_i185);
	}
...
MR_def_label(__Compare___mdbcomp__program_representation__goal_path_step_0_0,19)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_COMPUTED_GOTO((MR_Unsigned) MR_tag(MR_r2),
		MR_LABEL_AP(__Compare___mdbcomp__program_representation__goal_path_step_0_0_i22) MR_AND
		MR_LABEL_AP(__Compare___mdbcomp__program_representation__goal_path_step_0_0_i165) MR_AND
		MR_LABEL_AP(__Compare___mdbcomp__program_representation__goal_path_step_0_0_i165) MR_AND
		MR_LABEL_AP(__Compare___mdbcomp__program_representation__goal_path_step_0_0_i31));
MR_def_label(__Compare___mdbcomp__program_representation__goal_path_step_0_0,22)
	...
	MR_COMPUTED_GOTO((MR_Unsigned) MR_unmkbody(MR_r2),
		MR_LABEL_AP(__Compare___mdbcomp__program_representation__goal_path_step_0_0_i165) MR_AND
		MR_LABEL_AP(__Compare___mdbcomp__program_representation__goal_path_step_0_0_i84) MR_AND
		MR_LABEL_AP(__Compare___mdbcomp__program_representation__goal_path_step_0_0_i185) MR_AND
		MR_LABEL_AP(__Compare___mdbcomp__program_representation__goal_path_step_0_0_i185) MR_AND
		MR_LABEL_AP(__Compare___mdbcomp__program_representation__goal_path_step_0_0_i185) MR_AND
		MR_LABEL_AP(__Compare___mdbcomp__program_representation__goal_path_step_0_0_i185));
MR_def_label(__Compare___mdbcomp__program_representation__goal_path_step_0_0,31)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_ctfield(3, MR_r2, 0),0)) {
		MR_GOTO_LAB(__Compare___mdbcomp__program_representation__goal_path_step_0_0_i185);
	}
...
MR_def_label(__Compare___mdbcomp__program_representation__goal_path_step_0_0,33)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_COMPUTED_GOTO((MR_Unsigned) MR_tag(MR_r2),
		MR_LABEL_AP(__Compare___mdbcomp__program_representation__goal_path_step_0_0_i36) MR_AND
		MR_LABEL_AP(__Compare___mdbcomp__program_representation__goal_path_step_0_0_i165) MR_AND
		MR_LABEL_AP(__Compare___mdbcomp__program_representation__goal_path_step_0_0_i165) MR_AND
		MR_LABEL_AP(__Compare___mdbcomp__program_representation__goal_path_step_0_0_i45));
MR_def_label(__Compare___mdbcomp__program_representation__goal_path_step_0_0,36)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_COMPUTED_GOTO((MR_Unsigned) MR_unmkbody(MR_r2),
		MR_LABEL_AP(__Compare___mdbcomp__program_representation__goal_path_step_0_0_i165) MR_AND
		MR_LABEL_AP(__Compare___mdbcomp__program_representation__goal_path_step_0_0_i165) MR_AND
		...
		MR_LABEL_AP(__Compare___mdbcomp__program_representation__goal_path_step_0_0_i185) MR_AND
		MR_LABEL_AP(__Compare___mdbcomp__program_representation__goal_path_step_0_0_i185));
MR_def_label(__Compare___mdbcomp__program_representation__goal_path_step_0_0,45)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_ctfield(3, MR_r2, 0),0)) {
		MR_GOTO_LAB(__Compare___mdbcomp__program_representation__goal_path_step_0_0_i185);
	}
...
MR_def_label(__Compare___mdbcomp__program_representation__goal_path_step_0_0,47)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_COMPUTED_GOTO((MR_Unsigned) MR_tag(MR_r2),
		MR_LABEL_AP(__Compare___mdbcomp__program_representation__goal_path_step_0_0_i50) MR_AND
		MR_LABEL_AP(__Compare___mdbcomp__program_representation__goal_path_step_0_0_i165) MR_AND
		MR_LABEL_AP(__Compare___mdbcomp__program_representation__goal_path_step_0_0_i165) MR_AND
		MR_LABEL_AP(__Compare___mdbcomp__program_representation__goal_path_step_0_0_i59));
MR_def_label(__Compare___mdbcomp__program_representation__goal_path_step_0_0,50)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_COMPUTED_GOTO((MR_Unsigned) MR_unmkbody(MR_r2),
		MR_LABEL_AP(__Compare___mdbcomp__program_representation__goal_path_step_0_0_i165) MR_AND
		MR_LABEL_AP(__Compare___mdbcomp__program_representation__goal_path_step_0_0_i165) MR_AND
		...
		MR_LABEL_AP(__Compare___mdbcomp__program_representation__goal_path_step_0_0_i185) MR_AND
		MR_LABEL_AP(__Compare___mdbcomp__program_representation__goal_path_step_0_0_i185));
MR_def_label(__Compare___mdbcomp__program_representation__goal_path_step_0_0,59)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_ctfield(3, MR_r2, 0),0)) {
		MR_GOTO_LAB(__Compare___mdbcomp__program_representation__goal_path_step_0_0_i185);
	}
...
MR_def_label(__Compare___mdbcomp__program_representation__goal_path_step_0_0,61)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_COMPUTED_GOTO((MR_Unsigned) MR_tag(MR_r2),
		MR_LABEL_AP(__Compare___mdbcomp__program_representation__goal_path_step_0_0_i64) MR_AND
		MR_LABEL_AP(__Compare___mdbcomp__program_representation__goal_path_step_0_0_i165) MR_AND
		MR_LABEL_AP(__Compare___mdbcomp__program_representation__goal_path_step_0_0_i165) MR_AND
		MR_LABEL_AP(__Compare___mdbcomp__program_representation__goal_path_step_0_0_i73));
MR_def_label(__Compare___mdbcomp__program_representation__goal_path_step_0_0,64)
	...
	MR_COMPUTED_GOTO((MR_Unsigned) MR_unmkbody(MR_r2),
		...
		MR_LABEL_AP(__Compare___mdbcomp__program_representation__goal_path_step_0_0_i84) MR_AND
		MR_LABEL_AP(__Compare___mdbcomp__program_representation__goal_path_step_0_0_i185));
MR_def_label(__Compare___mdbcomp__program_representation__goal_path_step_0_0,73)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_ctfield(3, MR_r2, 0),0)) {
		MR_GOTO_LAB(__Compare___mdbcomp__program_representation__goal_path_step_0_0_i165);
	}
	MR_r1 = (MR_Integer) 2;
	MR_proceed();
MR_def_label(__Compare___mdbcomp__program_representation__goal_path_step_0_0,75)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_COMPUTED_GOTO((MR_Unsigned) MR_tag(MR_r2),
		MR_LABEL_AP(__Compare___mdbcomp__program_representation__goal_path_step_0_0_i78) MR_AND
		MR_LABEL_AP(__Compare___mdbcomp__program_representation__goal_path_step_0_0_i165) MR_AND
		MR_LABEL_AP(__Compare___mdbcomp__program_representation__goal_path_step_0_0_i165) MR_AND
		MR_LABEL_AP(__Compare___mdbcomp__program_representation__goal_path_step_0_0_i87));
MR_def_label(__Compare___mdbcomp__program_representation__goal_path_step_0_0,78)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_unmkbody(MR_r2),5)) {
		MR_GOTO_LAB(__Compare___mdbcomp__program_representation__goal_path_step_0_0_i165);
	}
MR_def_label(__Compare___mdbcomp__program_representation__goal_path_step_0_0,84)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Integer) 0;
	MR_proceed();
MR_def_label(__Compare___mdbcomp__program_representation__goal_path_step_0_0,87)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_ctfield(3, MR_r2, 0),0)) {
		MR_GOTO_LAB(__Compare___mdbcomp__program_representation__goal_path_step_0_0_i165);
	}
...
MR_def_label(__Compare___mdbcomp__program_representation__goal_path_step_0_0,89)
	...
	if (MR_INT_EQ(MR_tag(MR_r2),1)) {
		MR_GOTO_LAB(__Compare___mdbcomp__program_representation__goal_path_step_0_0_i115);
	}
MR_def_label(__Compare___mdbcomp__program_representation__goal_path_step_0_0,185)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Integer) 1;
	MR_proceed();
MR_def_label(__Compare___mdbcomp__program_representation__goal_path_step_0_0,104)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_COMPUTED_GOTO((MR_Unsigned) MR_tag(MR_r2),
		MR_LABEL_AP(__Compare___mdbcomp__program_representation__goal_path_step_0_0_i185) MR_AND
		MR_LABEL_AP(__Compare___mdbcomp__program_representation__goal_path_step_0_0_i165) MR_AND
		MR_LABEL_AP(__Compare___mdbcomp__program_representation__goal_path_step_0_0_i115) MR_AND
		MR_LABEL_AP(__Compare___mdbcomp__program_representation__goal_path_step_0_0_i185));
MR_def_label(__Compare___mdbcomp__program_representation__goal_path_step_0_0,115)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_const_mask_field(MR_r1, 0);
	MR_r2 = MR_const_mask_field(MR_r2, 0);
	MR_np_tailcall_ent(private_builtin__builtin_compare_int_3_0);
MR_def_label(__Compare___mdbcomp__program_representation__goal_path_step_0_0,119)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_ctfield(3, MR_r1, 0),0)) {
		MR_GOTO_LAB(__Compare___mdbcomp__program_representation__goal_path_step_0_0_i120);
	}
	MR_COMPUTED_GOTO((MR_Unsigned) MR_tag(MR_r2),
		MR_LABEL_AP(__Compare___mdbcomp__program_representation__goal_path_step_0_0_i185) MR_AND
		MR_LABEL_AP(__Compare___mdbcomp__program_representation__goal_path_step_0_0_i165) MR_AND
		MR_LABEL_AP(__Compare___mdbcomp__program_representation__goal_path_step_0_0_i165) MR_AND
		MR_LABEL_AP(__Compare___mdbcomp__program_representation__goal_path_step_0_0_i132));
MR_def_label(__Compare___mdbcomp__program_representation__goal_path_step_0_0,132)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_ctfield(3, MR_r2, 0),0)) {
		MR_GOTO_LAB(__Compare___mdbcomp__program_representation__goal_path_step_0_0_i185);
	}
	...
	MR_r2 = MR_ctfield(3, MR_r2, 1);
	MR_np_call_localret_ent(private_builtin__builtin_compare_int_3_0,
		__Compare___mdbcomp__program_representation__goal_path_step_0_0_i135);
MR_def_label(__Compare___mdbcomp__program_representation__goal_path_step_0_0,135)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___mdbcomp__program_representation__goal_path_step_0_0_i235);
	}
	MR_r1 = MR_sv(2);
	MR_r2 = MR_sv(1);
	...
	MR_decr_sp(3);
	MR_np_tailcall_ent(private_builtin__builtin_compare_int_3_0);
MR_def_label(__Compare___mdbcomp__program_representation__goal_path_step_0_0,120)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_COMPUTED_GOTO((MR_Unsigned) MR_tag(MR_r2),
		MR_LABEL_AP(__Compare___mdbcomp__program_representation__goal_path_step_0_0_i142) MR_AND
		MR_LABEL_AP(__Compare___mdbcomp__program_representation__goal_path_step_0_0_i165) MR_AND
		MR_LABEL_AP(__Compare___mdbcomp__program_representation__goal_path_step_0_0_i165) MR_AND
		MR_LABEL_AP(__Compare___mdbcomp__program_representation__goal_path_step_0_0_i151));
MR_def_label(__Compare___mdbcomp__program_representation__goal_path_step_0_0,142)
	...
	MR_COMPUTED_GOTO((MR_Unsigned) MR_unmkbody(MR_r2),
		...
		MR_LABEL_AP(__Compare___mdbcomp__program_representation__goal_path_step_0_0_i185) MR_AND
		MR_LABEL_AP(__Compare___mdbcomp__program_representation__goal_path_step_0_0_i185));
MR_def_label(__Compare___mdbcomp__program_representation__goal_path_step_0_0,151)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_ctfield(3, MR_r2, 0),0)) {
		MR_GOTO_LAB(__Compare___mdbcomp__program_representation__goal_path_step_0_0_i152);
	}
MR_def_label(__Compare___mdbcomp__program_representation__goal_path_step_0_0,165)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Integer) 2;
	MR_proceed();
MR_def_label(__Compare___mdbcomp__program_representation__goal_path_step_0_0,152)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_ctfield(3, MR_r1, 1);
	MR_r2 = MR_ctfield(3, MR_r2, 1);
	MR_np_tailcall_ent(private_builtin__builtin_compare_int_3_0);
MR_def_label(__Compare___mdbcomp__program_representation__goal_path_step_0_0,235)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(3);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
...
MR_BEGIN_MODULE(mdbcomp__program_representation_module41)
	...
	MR_init_label8(__Unify___mdbcomp__program_representation__goal_rep_0_0,4,8,12,16,34,29,31,25)
	MR_init_label4(__Unify___mdbcomp__program_representation__goal_rep_0_0,17,19,21,1)
MR_BEGIN_CODE
...
MR_define_entry(mercury____Unify___mdbcomp__program_representation__goal_rep_0_0);
	...
	MR_sv(5) = (MR_Word) MR_succip;
	MR_COMPUTED_GOTO((MR_Unsigned) MR_tag(MR_r1),
		MR_LABEL_AP(__Unify___mdbcomp__program_representation__goal_rep_0_0_i4) MR_AND
		MR_LABEL_AP(__Unify___mdbcomp__program_representation__goal_rep_0_0_i8) MR_AND
		MR_LABEL_AP(__Unify___mdbcomp__program_representation__goal_rep_0_0_i12) MR_AND
		MR_LABEL_AP(__Unify___mdbcomp__program_representation__goal_rep_0_0_i16));
MR_def_label(__Unify___mdbcomp__program_representation__goal_rep_0_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_r2,0)) {
...
MR_def_label(__Unify___mdbcomp__program_representation__goal_rep_0_0,8)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_r2,1)) {
		MR_GOTO_LAB(__Unify___mdbcomp__program_representation__goal_rep_0_0_i1);
	}
...
MR_def_label(__Unify___mdbcomp__program_representation__goal_rep_0_0,12)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_r2,2)) {
		MR_GOTO_LAB(__Unify___mdbcomp__program_representation__goal_rep_0_0_i1);
	}
...
MR_def_label(__Unify___mdbcomp__program_representation__goal_rep_0_0,16)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_EQ(MR_ctfield(3, MR_r1, 0),0)) {
		MR_GOTO_LAB(__Unify___mdbcomp__program_representation__goal_rep_0_0_i17);
	}
	if (MR_INT_EQ(MR_ctfield(3, MR_r1, 0),1)) {
		MR_GOTO_LAB(__Unify___mdbcomp__program_representation__goal_rep_0_0_i25);
	}
	if (MR_INT_EQ(MR_ctfield(3, MR_r1, 0),2)) {
		MR_GOTO_LAB(__Unify___mdbcomp__program_representation__goal_rep_0_0_i29);
	}
	if (MR_RTAGS_TESTR(MR_r2,3,3)) {
		MR_GOTO_LAB(__Unify___mdbcomp__program_representation__goal_rep_0_0_i1);
	}
	...
	MR_np_call_localret_ent(__Unify___list__list_1_0,
		__Unify___mdbcomp__program_representation__goal_rep_0_0_i34);
MR_def_label(__Unify___mdbcomp__program_representation__goal_rep_0_0,34)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(__Unify___mdbcomp__program_representation__goal_rep_0_0_i1);
	}
...
MR_def_label(__Unify___mdbcomp__program_representation__goal_rep_0_0,29)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_RTAGS_TESTR(MR_r2,3,2)) {
		MR_GOTO_LAB(__Unify___mdbcomp__program_representation__goal_rep_0_0_i1);
	}
	...
	MR_np_localcall_lab(__Unify___mdbcomp__program_representation__goal_rep_0_0,
		__Unify___mdbcomp__program_representation__goal_rep_0_0_i31);
MR_def_label(__Unify___mdbcomp__program_representation__goal_rep_0_0,31)
	...
	MR_decr_sp_and_return(5);
MR_def_label(__Unify___mdbcomp__program_representation__goal_rep_0_0,25)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_RTAGS_TESTR(MR_r2,3,1)) {
		MR_GOTO_LAB(__Unify___mdbcomp__program_representation__goal_rep_0_0_i1);
	}
	...
	MR_COMPUTED_GOTO((MR_Unsigned) MR_tag(MR_r1),
		...
		MR_LABEL_AP(__Unify___mdbcomp__program_representation__goal_rep_0_0_i12) MR_AND
		MR_LABEL_AP(__Unify___mdbcomp__program_representation__goal_rep_0_0_i16));
MR_def_label(__Unify___mdbcomp__program_representation__goal_rep_0_0,17)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_RTAGS_TESTR(MR_r2,3,0)) {
		MR_GOTO_LAB(__Unify___mdbcomp__program_representation__goal_rep_0_0_i1);
	}
	...
	MR_np_localcall_lab(__Unify___mdbcomp__program_representation__goal_rep_0_0,
		__Unify___mdbcomp__program_representation__goal_rep_0_0_i19);
...
MR_BEGIN_MODULE(mdbcomp__program_representation_module42)
	...
	MR_init_label8(__Compare___mdbcomp__program_representation__goal_rep_0_0,4,11,15,22,26,31,33,37)
	MR_init_label8(__Compare___mdbcomp__program_representation__goal_rep_0_0,96,100,104,108,70,79,81,59)
	MR_init_label8(__Compare___mdbcomp__program_representation__goal_rep_0_0,67,38,43,44,144,45,47,51)
	MR_init_label1(__Compare___mdbcomp__program_representation__goal_rep_0_0,286)
MR_BEGIN_CODE
...
MR_define_entry(mercury____Compare___mdbcomp__program_representation__goal_rep_0_0);
	...
	MR_COMPUTED_GOTO((MR_Unsigned) MR_tag(MR_r1),
		MR_LABEL_AP(__Compare___mdbcomp__program_representation__goal_rep_0_0_i4) MR_AND
		MR_LABEL_AP(__Compare___mdbcomp__program_representation__goal_rep_0_0_i15) MR_AND
		MR_LABEL_AP(__Compare___mdbcomp__program_representation__goal_rep_0_0_i26) MR_AND
		MR_LABEL_AP(__Compare___mdbcomp__program_representation__goal_rep_0_0_i37));
MR_def_label(__Compare___mdbcomp__program_representation__goal_rep_0_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_COMPUTED_GOTO((MR_Unsigned) MR_tag(MR_r2),
		MR_LABEL_AP(__Compare___mdbcomp__program_representation__goal_rep_0_0_i31) MR_AND
		MR_LABEL_AP(__Compare___mdbcomp__program_representation__goal_rep_0_0_i144) MR_AND
		MR_LABEL_AP(__Compare___mdbcomp__program_representation__goal_rep_0_0_i144) MR_AND
		MR_LABEL_AP(__Compare___mdbcomp__program_representation__goal_rep_0_0_i11));
MR_def_label(__Compare___mdbcomp__program_representation__goal_rep_0_0,11)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_EQ(MR_ctfield(3, MR_r2, 0),0)) {
		MR_GOTO_LAB(__Compare___mdbcomp__program_representation__goal_rep_0_0_i144);
	}
...
MR_def_label(__Compare___mdbcomp__program_representation__goal_rep_0_0,15)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_COMPUTED_GOTO((MR_Unsigned) MR_tag(MR_r2),
		MR_LABEL_AP(__Compare___mdbcomp__program_representation__goal_rep_0_0_i43) MR_AND
		MR_LABEL_AP(__Compare___mdbcomp__program_representation__goal_rep_0_0_i31) MR_AND
		MR_LABEL_AP(__Compare___mdbcomp__program_representation__goal_rep_0_0_i144) MR_AND
		MR_LABEL_AP(__Compare___mdbcomp__program_representation__goal_rep_0_0_i22));
MR_def_label(__Compare___mdbcomp__program_representation__goal_rep_0_0,22)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_EQ(MR_ctfield(3, MR_r2, 0),0)) {
		MR_GOTO_LAB(__Compare___mdbcomp__program_representation__goal_rep_0_0_i144);
	}
	...
	MR_r1 = (MR_Integer) 1;
	MR_decr_sp_and_return(9);
MR_def_label(__Compare___mdbcomp__program_representation__goal_rep_0_0,26)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_COMPUTED_GOTO((MR_Unsigned) MR_tag(MR_r2),
		MR_LABEL_AP(__Compare___mdbcomp__program_representation__goal_rep_0_0_i43) MR_AND
		MR_LABEL_AP(__Compare___mdbcomp__program_representation__goal_rep_0_0_i43) MR_AND
		MR_LABEL_AP(__Compare___mdbcomp__program_representation__goal_rep_0_0_i31) MR_AND
		MR_LABEL_AP(__Compare___mdbcomp__program_representation__goal_rep_0_0_i33));
MR_def_label(__Compare___mdbcomp__program_representation__goal_rep_0_0,31)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tempr1 = MR_r1;
...
MR_def_label(__Compare___mdbcomp__program_representation__goal_rep_0_0,33)
	...
	MR_r1 = (MR_Integer) 1;
	MR_decr_sp_and_return(9);
MR_def_label(__Compare___mdbcomp__program_representation__goal_rep_0_0,37)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_EQ(MR_ctfield(3, MR_r1, 0),0)) {
		MR_GOTO_LAB(__Compare___mdbcomp__program_representation__goal_rep_0_0_i38);
	}
	if (MR_INT_EQ(MR_ctfield(3, MR_r1, 0),1)) {
		MR_GOTO_LAB(__Compare___mdbcomp__program_representation__goal_rep_0_0_i59);
	}
	if (MR_INT_EQ(MR_ctfield(3, MR_r1, 0),2)) {
		MR_GOTO_LAB(__Compare___mdbcomp__program_representation__goal_rep_0_0_i70);
	}
	if (MR_INT_NE(MR_tag(MR_r2),3)) {
		MR_GOTO_LAB(__Compare___mdbcomp__program_representation__goal_rep_0_0_i43);
	}
	if (MR_INT_EQ(MR_ctfield(3, MR_r2, 0),0)) {
		MR_GOTO_LAB(__Compare___mdbcomp__program_representation__goal_rep_0_0_i43);
	}
	...
	MR_np_call_localret_ent(private_builtin__builtin_compare_int_3_0,
		__Compare___mdbcomp__program_representation__goal_rep_0_0_i96);
MR_def_label(__Compare___mdbcomp__program_representation__goal_rep_0_0,96)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___mdbcomp__program_representation__goal_rep_0_0_i286);
	}
	MR_r1 = MR_sv(8);
	MR_r2 = MR_sv(1);
	MR_np_call_localret_ent(private_builtin__builtin_compare_string_3_0,
		__Compare___mdbcomp__program_representation__goal_rep_0_0_i100);
MR_def_label(__Compare___mdbcomp__program_representation__goal_rep_0_0,100)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___mdbcomp__program_representation__goal_rep_0_0_i286);
	}
	...
	MR_r2 = MR_sv(2);
	MR_np_call_localret_ent(private_builtin__builtin_compare_int_3_0,
		__Compare___mdbcomp__program_representation__goal_rep_0_0_i104);
MR_def_label(__Compare___mdbcomp__program_representation__goal_rep_0_0,104)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___mdbcomp__program_representation__goal_rep_0_0_i286);
	}
	...
	MR_np_call_localret_ent(__Compare___list__list_1_0,
		__Compare___mdbcomp__program_representation__goal_rep_0_0_i108);
MR_def_label(__Compare___mdbcomp__program_representation__goal_rep_0_0,108)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___mdbcomp__program_representation__goal_rep_0_0_i286);
	}
...
MR_def_label(__Compare___mdbcomp__program_representation__goal_rep_0_0,70)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_tag(MR_r2),3)) {
		MR_GOTO_LAB(__Compare___mdbcomp__program_representation__goal_rep_0_0_i43);
	}
	...
	if (MR_INT_EQ(MR_ctfield(3, MR_r2, 0),2)) {
		MR_GOTO_LAB(__Compare___mdbcomp__program_representation__goal_rep_0_0_i79);
	}
	MR_r1 = (MR_Integer) 1;
	MR_decr_sp_and_return(9);
MR_def_label(__Compare___mdbcomp__program_representation__goal_rep_0_0,79)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(2) = MR_ctfield(3, MR_r1, 2);
	MR_sv(1) = MR_ctfield(3, MR_r2, 2);
	MR_r1 = MR_ctfield(3, MR_r1, 1);
	...
	MR_np_localcall_lab(__Compare___mdbcomp__program_representation__goal_rep_0_0,
		__Compare___mdbcomp__program_representation__goal_rep_0_0_i81);
MR_def_label(__Compare___mdbcomp__program_representation__goal_rep_0_0,81)
	...
	MR_decr_sp(9);
	MR_np_tailcall_ent(private_builtin__builtin_compare_int_3_0);
MR_def_label(__Compare___mdbcomp__program_representation__goal_rep_0_0,59)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_tag(MR_r2),3)) {
		MR_GOTO_LAB(__Compare___mdbcomp__program_representation__goal_rep_0_0_i43);
	}
...
MR_def_label(__Compare___mdbcomp__program_representation__goal_rep_0_0,67)
	...
	MR_COMPUTED_GOTO((MR_Unsigned) MR_tag(MR_r1),
		...
		MR_LABEL_AP(__Compare___mdbcomp__program_representation__goal_rep_0_0_i26) MR_AND
		MR_LABEL_AP(__Compare___mdbcomp__program_representation__goal_rep_0_0_i37));
MR_def_label(__Compare___mdbcomp__program_representation__goal_rep_0_0,38)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_EQ(MR_tag(MR_r2),3)) {
		MR_GOTO_LAB(__Compare___mdbcomp__program_representation__goal_rep_0_0_i44);
	}
MR_def_label(__Compare___mdbcomp__program_representation__goal_rep_0_0,43)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Integer) 2;
	MR_decr_sp_and_return(9);
...
MR_def_label(__Compare___mdbcomp__program_representation__goal_rep_0_0,144)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Integer) 1;
	MR_decr_sp_and_return(9);
MR_def_label(__Compare___mdbcomp__program_representation__goal_rep_0_0,45)
	...
	MR_np_localcall_lab(__Compare___mdbcomp__program_representation__goal_rep_0_0,
		__Compare___mdbcomp__program_representation__goal_rep_0_0_i47);
MR_def_label(__Compare___mdbcomp__program_representation__goal_rep_0_0,47)
	...
	MR_r2 = MR_sv(1);
	MR_np_localcall_lab(__Compare___mdbcomp__program_representation__goal_rep_0_0,
		__Compare___mdbcomp__program_representation__goal_rep_0_0_i51);
MR_def_label(__Compare___mdbcomp__program_representation__goal_rep_0_0,51)
	...
	MR_COMPUTED_GOTO((MR_Unsigned) MR_tag(MR_r1),
		...
		MR_LABEL_AP(__Compare___mdbcomp__program_representation__goal_rep_0_0_i26) MR_AND
		MR_LABEL_AP(__Compare___mdbcomp__program_representation__goal_rep_0_0_i37));
MR_def_label(__Compare___mdbcomp__program_representation__goal_rep_0_0,286)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(9);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
...
MR_BEGIN_MODULE(mdbcomp__program_representation_module45)
	...
	MR_init_label2(__Unify___mdbcomp__program_representation__proc_rep_0_0,2,1)
MR_BEGIN_CODE
...
MR_define_entry(mercury____Unify___mdbcomp__program_representation__proc_rep_0_0);
	...
	MR_np_call_localret_ent(__Unify___list__list_1_0,
		__Unify___mdbcomp__program_representation__proc_rep_0_0_i2);
MR_def_label(__Unify___mdbcomp__program_representation__proc_rep_0_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
...
MR_BEGIN_MODULE(mdbcomp__program_representation_module46)
	...
	MR_init_label2(__Compare___mdbcomp__program_representation__proc_rep_0_0,3,7)
MR_BEGIN_CODE
...
MR_define_entry(mercury____Compare___mdbcomp__program_representation__proc_rep_0_0);
	...
	MR_np_call_localret_ent(__Compare___list__list_1_0,
		__Compare___mdbcomp__program_representation__proc_rep_0_0_i3);
MR_def_label(__Compare___mdbcomp__program_representation__proc_rep_0_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___mdbcomp__program_representation__proc_rep_0_0_i7);
	}
	MR_r1 = MR_sv(1);
	MR_r2 = MR_sv(2);
	MR_succip_word = MR_sv(3);
...
MR_def_label(__Compare___mdbcomp__program_representation__proc_rep_0_0,7)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(3);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
...
MR_BEGIN_MODULE(mdbcomp__program_representation_module53)
	MR_init_entry1(mdbcomp__program_representation__IntroducedFrom__pred__path_step_from_string_2__478__1_2_0);
MR_BEGIN_CODE
	...
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(mdbcomp__program_representation__IntroducedFrom__pred__path_step_from_string_2__478__1_2_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_r1 == MR_r2);
	MR_proceed();
#ifdef MR_maybe_local_thread_engine_base
