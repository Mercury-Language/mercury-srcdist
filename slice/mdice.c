...
main_2_p_0(void)
{
  ...
  else
  {
    ...
    if ((Args_7 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      ...
      Var_74 = mercury__string__f_43_43_2_f_0((MR_String) "Usage: mdice [-s sortspec] [-m module] [-l N] [-n N] [-p N] [-f N] ", (MR_String) "passfile failfile\n");
      mercury__io__write_string_4_p_0(StdOutStream_4, Var_74);
    }
    else
    {
      ...
      if ((Var_68 == (MR_Word) ((MR_Unsigned) 0U)))
      {
        ...
        Var_77 = mercury__string__f_43_43_2_f_0((MR_String) "Usage: mdice [-s sortspec] [-m module] [-l N] [-n N] [-p N] [-f N] ", (MR_String) "passfile failfile\n");
        mercury__io__write_string_4_p_0(StdOutStream_4, Var_77);
      }
      else
      {
        MR_Word Var_70 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Var_68, (MR_Integer) 1))));
        MR_String Var_71 = ((MR_String) ((MR_hl_field(MR_mktag(1), Var_68, (MR_Integer) 0))));
        ...
        if ((Var_70 == (MR_Word) ((MR_Unsigned) 0U)))
        {
          ...
          mdbcomp__slice_and_dice__read_dice_to_string_12_p_0(Var_69, Var_71, SortStr_13, MaxRow_15, MaybeMaxPredColumn_19, MaybeMaxPathColumn_20, MaybeMaxFileColumn_21, Module_14, &DiceStr_22, &Problem_23);
