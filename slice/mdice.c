...
{
  {
    ...
    if ((((MR_Unsigned) (HeadVar__1_1 - (MR_Integer) 102)) <= ((MR_Unsigned) (MR_Integer) 13)))
      ...
      {
        *HeadVar__2_2 = ((&mdice_vector_common_3[0 + (HeadVar__1_1 - (MR_Integer) 102)]))->mdice__vector_common_type_3_0__vct_3_f_0;
        succeeded = MR_TRUE;
      }
      else
        succeeded = MR_FALSE;
...
{
  {
    ...
    TypeCtorInfo_65_65 = (MR_Word) &mdice__mdice__type_ctor_info_option_0;
    mercury__getopt__process_options_4_p_0(TypeCtorInfo_65_65, (MR_Word) MR_mkword(MR_mktag(2), &mdice_scalar_common_1[4]), Args0_5, &Args_7, &GetoptResult_8);
      ...
      else
      {
        ...
        else
        {
          ...
          if ((Var_68 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
          {
            ...
            mercury__getopt__lookup_string_option_3_p_0(TypeCtorInfo_65_65, OptionTable_9, ((MR_Box) ((MR_Integer) 0)), &SortStr_13);
            mercury__getopt__lookup_string_option_3_p_0(TypeCtorInfo_65_65, OptionTable_9, ((MR_Box) ((MR_Integer) 5)), &Module_14);
            mercury__getopt__lookup_int_option_3_p_0(TypeCtorInfo_65_65, OptionTable_9, ((MR_Box) ((MR_Integer) 1)), &MaxRow_15);
            mercury__getopt__lookup_int_option_3_p_0(TypeCtorInfo_65_65, OptionTable_9, ((MR_Box) ((MR_Integer) 2)), &MaxPredColumn_16);
            mercury__getopt__lookup_int_option_3_p_0(TypeCtorInfo_65_65, OptionTable_9, ((MR_Box) ((MR_Integer) 3)), &MaxPathColumn_17);
            mercury__getopt__lookup_int_option_3_p_0(TypeCtorInfo_65_65, OptionTable_9, ((MR_Box) ((MR_Integer) 4)), &MaxFileColumn_18);
            succeeded = (MaxPredColumn_16 == (MR_Integer) 0);
            if (succeeded)
              MaybeMaxPredColumn_19 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
            else
              {
            ...
            if (succeeded)
              MaybeMaxPathColumn_20 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
            else
              {
            ...
            if (succeeded)
              MaybeMaxFileColumn_21 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
            else
              {
