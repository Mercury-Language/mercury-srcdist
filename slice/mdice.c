      ...
      else
      {
        ...
        else
        {
          ...
          else
          {
            ...
            Var_90 = mercury__string__f_43_43_2_f_0((MR_String) "Usage: mdice [-s sortspec] [-m module] [-l N] [-n N] [-p N] [-f N] ", (MR_String) "passfile failfile\n");
            mercury__io__write_string_4_p_0(StdOutStream_4, Var_90);
          }
        }
      }
    }
