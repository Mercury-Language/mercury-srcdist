  ...
  MR_Word * mdice__HeadVar__2_2)
{
  {
    MR_bool mdice__succeeded;
    MR_Integer mdice__lo_0 = (MR_Integer) 0;
    MR_Integer mdice__hi_1 = (MR_Integer) 5;
...
{
  {
    ...
    else
    {
      ...
      {
        MR_Word mdice__Var_66 = ((MR_Word) (MR_hl_field(MR_mktag(1), mdice__Args_7, (MR_Integer) 1)));
        MR_String mdice__Var_67 = ((MR_String) (MR_hl_field(MR_mktag(1), mdice__Args_7, (MR_Integer) 0)));

        if ((mdice__Var_66 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
        {
          mercury__io__write_string_4_p_0(mdice__StdOutStream_4, (MR_String) "Usage: mdice [-s sortspec] [-m module] [-l N] [-n N] [-p N] [-f N] passfile failfile\n");
        }
        else
        {
          MR_Word mdice__Var_68 = ((MR_Word) (MR_hl_field(MR_mktag(1), mdice__Var_66, (MR_Integer) 1)));
          MR_String mdice__Var_69 = ((MR_String) (MR_hl_field(MR_mktag(1), mdice__Var_66, (MR_Integer) 0)));

          if ((mdice__Var_68 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
          {
            ...
            mdbcomp__slice_and_dice__read_dice_to_string_12_p_0(mdice__Var_67, mdice__Var_69, mdice__SortStr_13, mdice__MaxRow_15, mdice__MaybeMaxPredColumn_19, mdice__MaybeMaxPathColumn_20, mdice__MaybeMaxFileColumn_21, mdice__Module_14, &mdice__DiceStr_22, &mdice__Problem_23);
