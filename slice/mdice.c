...
MR_decl_label8(main_2_0, 2,3,7,10,14,15,16,17)
MR_decl_label8(main_2_0, 18,19,20,22,23,25,26,29)
MR_decl_label6(main_2_0, 30,33,34,13,5,38)
MR_decl_label3(mdice__option_default_2_0, 2,3,4)
MR_decl_label1(mdice__short_option_2_0, 1)
MR_decl_static(mdice__usage_2_0)
...
MR_BEGIN_MODULE(mdice_module0)
	MR_init_entry1(mdice__usage_2_0);
MR_BEGIN_CODE
...
#endif
MR_def_static(mdice__usage_2_0)
...
MR_BEGIN_MODULE(mdice_module1)
	...
	MR_init_label8(main_2_0,2,3,7,10,14,15,16,17)
	MR_init_label8(main_2_0,18,19,20,22,23,25,26,29)
	MR_init_label6(main_2_0,30,33,34,13,5,38)
MR_BEGIN_CODE
...
MR_def_label(main_2_0,13)
	...
	MR_succip_word = MR_sv(8);
	MR_decr_sp(8);
	MR_np_tailcall_ent(mdice__usage_2_0);
...
MR_BEGIN_MODULE(mdice_module2)
	...
	MR_init_label1(mdice__short_option_2_0,1)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(mdice_module4)
	...
	MR_init_label3(mdice__option_default_2_0,2,3,4)
MR_BEGIN_CODE
...
MR_def_static(mdice__option_default_2_0)
	...
	MR_mkframe("pred mdice.option_default/2-0", 1,
		MR_LABEL_AP(mdice__option_default_2_0_i2));
	{
	MR_Word MR_tempr1;
...
MR_def_label(mdice__option_default_2_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r3 = MR_fv(1);
	if (MR_INT_GE(MR_r3,10)) {
		MR_GOTO_LAB(mdice__option_default_2_0_i3);
	}
	MR_fv(1) = ((MR_Integer) MR_fv(1) + (MR_Integer) 2);
	MR_GOTO_LAB(mdice__option_default_2_0_i4);
MR_def_label(mdice__option_default_2_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_redoip_slot_word(MR_curfr) = (MR_Word) MR_ENTRY(MR_do_fail);
MR_def_label(mdice__option_default_2_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
...
void mercury__mdice__write_out_proc_statics(FILE *fp);
#endif
