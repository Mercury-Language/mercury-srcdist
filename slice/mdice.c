...
/* sealed */ struct mdice__vector_common_type_6_0_s {
...
static /* final */ const struct mdice__vector_common_type_7_0_s mdice_vector_common_7[6] = {
  ...
  {
    (MR_Integer) 0,
    (MR_Word) (MR_mkword(MR_mktag(3), &mdice_scalar_common_2[0]))
  },
  /* row 1 */
  {
    (MR_Integer) 1,
    (MR_Word) (MR_mkword(MR_mktag(2), &mdice_scalar_common_3[0]))
  },
  /* row 2 */
  {
    (MR_Integer) 2,
    (MR_Word) (MR_mkword(MR_mktag(2), &mdice_scalar_common_3[1]))
  },
  /* row 3 */
  {
    (MR_Integer) 3,
    (MR_Word) (MR_mkword(MR_mktag(2), &mdice_scalar_common_3[2]))
  },
  /* row 4 */
  {
    (MR_Integer) 4,
    (MR_Word) (MR_mkword(MR_mktag(2), &mdice_scalar_common_3[3]))
  },
  /* row 5 */
  {
    (MR_Integer) 5,
    (MR_Word) (MR_mkword(MR_mktag(3), &mdice_scalar_common_2[1]))
  },
};
...
{
  {
    ...
    {
      MR_Word GetoptError_28 = ((MR_Word) ((MR_hl_field(MR_mktag(1), GetoptResult_8, (MR_Integer) 0))));
    ...
    else
    {
      ...
      if ((Args_7 == (MR_Word) ((MR_Unsigned) 0U)))
      {
        ...
        Var_80 = mercury__string__f_43_43_2_f_0((MR_String) "Usage: mdice [-s sortspec] [-m module] [-l N] [-n N] [-p N] [-f N] ", (MR_String) "passfile failfile\n");
        mercury__io__write_string_4_p_0(StdOutStream_4, Var_80);
      }
      else
      {
        MR_Word Var_70 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Args_7, (MR_Integer) 1))));
        MR_String Var_71 = ((MR_String) ((MR_hl_field(MR_mktag(1), Args_7, (MR_Integer) 0))));

        if ((Var_70 == (MR_Word) ((MR_Unsigned) 0U)))
        {
          MR_String Var_88;

          Var_88 = mercury__string__f_43_43_2_f_0((MR_String) "Usage: mdice [-s sortspec] [-m module] [-l N] [-n N] [-p N] [-f N] ", (MR_String) "passfile failfile\n");
          mercury__io__write_string_4_p_0(StdOutStream_4, Var_88);
        }
        else
        {
          MR_Word Var_72 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Var_70, (MR_Integer) 1))));
          MR_String Var_73 = ((MR_String) ((MR_hl_field(MR_mktag(1), Var_70, (MR_Integer) 0))));
          ...
          if ((Var_72 == (MR_Word) ((MR_Unsigned) 0U)))
          {
            ...
            if (succeeded)
              ...
              {
                MaybeMaxPredColumn_19 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
            ...
            if (succeeded)
              ...
              {
                MaybeMaxPathColumn_20 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
            ...
            if (succeeded)
              ...
              {
                MaybeMaxFileColumn_21 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
            ...
            mdice__usage_3_p_0(StdOutStream_4);
        }
      }
    }
  }
...
{
  {
    ...
    Var_8 = mercury__string__f_43_43_2_f_0((MR_String) "Usage: mdice [-s sortspec] [-m module] [-l N] [-n N] [-p N] [-f N] ", (MR_String) "passfile failfile\n");
    mercury__io__write_string_4_p_0(OutStream_4, Var_8);
  }
}
