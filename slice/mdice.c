...
MR_decl_label10(main_2_0, 2,3,8,11,10,14,58,17,21,22)
MR_decl_label10(main_2_0, 23,24,25,26,27,30,31,34,35,39)
MR_decl_label3(main_2_0, 40,43,44)
...
MR_BEGIN_MODULE(mdice_module0)
	...
	MR_init_label10(main_2_0,2,3,8,11,10,14,58,17,21,22)
	MR_init_label10(main_2_0,23,24,25,26,27,30,31,34,35,39)
	MR_init_label3(main_2_0,40,43,44)
MR_BEGIN_CODE
...
MR_def_label(main_2_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(1) = (MR_Word) MR_CTOR0_ADDR(mdice, option);
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
	MR_r1 = MR_sv(1);
...
void mercury__mdice__write_out_proc_statics(FILE *deep_fp, FILE *procrep_fp)
{
	MR_write_out_module_proc_reps_start(procrep_fp, &mercury_data__module_layout__mdice);
