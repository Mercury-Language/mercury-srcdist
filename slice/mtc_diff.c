...
{
  {
    ...
    succeeded = mtc_diff__f_85_110_117_115_101_100_65_114_103_115_95_95_112_114_101_100_95_95_95_95_85_110_105_102_121_95_95_95_109_116_99_95_100_105_102_102_95_95_111_112_116_105_111_110_95_48_95_95_91_49_44_32_50_93_95_48_2_p_0();
    return succeeded;
  }
}
...
{
  {
    *HeadVar__2_2 = (MR_Word) MR_mkword(MR_mktag(3), &mtc_diff_scalar_common_3[0]);
    cont(cont_env_ptr);
  }
}
...
{
  {
    ...
    TypeCtorInfo_71_71 = (MR_Word) &mtc_diff__mtc_diff__type_ctor_info_option_0;
    mercury__getopt__process_options_4_p_0(TypeCtorInfo_71_71, (MR_Word) MR_mkword(MR_mktag(2), &mtc_diff_scalar_common_1[4]), Args0_6, &Args_8, &GetoptResult_9);
    if (((MR_tag((MR_Word) GetoptResult_9)) == (MR_mktag((MR_Integer) 1))))
    {
      MR_String GetoptErrorMsg_29 = ((MR_String) (MR_hl_field(MR_mktag(1), GetoptResult_9, (MR_Integer) 0)));
    ...
    else
    {
      ...
      mercury__getopt__lookup_string_option_3_p_0(TypeCtorInfo_71_71, OptionTable_10, ((MR_Box) ((MR_Integer) 0)), &OutputFile_11);
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          Arg1_12 = ((MR_String) (MR_hl_field(MR_mktag(1), Args_8, (MR_Integer) 0)));
          Var_42 = ((MR_Word) (MR_hl_field(MR_mktag(1), Args_8, (MR_Integer) 1)));
          succeeded = ((MR_tag((MR_Word) Var_42)) == (MR_mktag((MR_Integer) 1)));
          if (succeeded)
          {
            Arg2_13 = ((MR_String) (MR_hl_field(MR_mktag(1), Var_42, (MR_Integer) 0)));
      ...
      if (succeeded)
      {
        ...
        if (((MR_tag((MR_Word) MaybeTraceCounts1_14)) == (MR_mktag((MR_Integer) 1))))
        {
          MR_String Msg1_17 = ((MR_String) (MR_hl_field(MR_mktag(1), MaybeTraceCounts1_14, (MR_Integer) 0)));
        ...
        if (((MR_tag((MR_Word) MaybeTraceCounts2_18)) == (MR_mktag((MR_Integer) 1))))
        {
          MR_String Msg2_21 = ((MR_String) (MR_hl_field(MR_mktag(1), MaybeTraceCounts2_18, (MR_Integer) 0)));
        ...
        succeeded = ((MR_tag((MR_Word) MaybeTraceCounts1_14)) == (MR_mktag((MR_Integer) 0)));
        if (succeeded)
        {
          Type1_22 = ((MR_Word) (MR_hl_field(MR_mktag(0), MaybeTraceCounts1_14, (MR_Integer) 0)));
          TraceCounts1_23 = ((MR_Word) (MR_hl_field(MR_mktag(0), MaybeTraceCounts1_14, (MR_Integer) 1)));
          succeeded = ((MR_tag((MR_Word) MaybeTraceCounts2_18)) == (MR_mktag((MR_Integer) 0)));
          if (succeeded)
          {
            Type2_24 = ((MR_Word) (MR_hl_field(MR_mktag(0), MaybeTraceCounts2_18, (MR_Integer) 0)));
            TraceCounts2_25 = ((MR_Word) (MR_hl_field(MR_mktag(0), MaybeTraceCounts2_18, (MR_Integer) 1)));
          }
        }
        if (succeeded)
        {
          ...
          mdbcomp__trace_counts__diff_trace_counts_3_p_0(TraceCounts1_23, TraceCounts2_25, &TraceCounts_26);
          {
            ...
            MR_hl_field(MR_mktag(2), Var_50, 0) = ((MR_Box) (Type1_22));
            MR_hl_field(MR_mktag(2), Var_50, 1) = ((MR_Box) (Type2_24));
          }
          mdbcomp__trace_counts__write_trace_counts_to_file_6_p_0(Var_50, TraceCounts_26, OutputFile_11, &WriteResult_27);
          if (!((WriteResult_27 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))))))
          {
            MR_Word WriteErrorMsg_28 = ((MR_Word) (MR_hl_field(MR_mktag(1), WriteResult_27, (MR_Integer) 0)));
            MR_String Var_52;
            MR_String Var_55;
            MR_String Var_57;
            MR_String Var_58;
            ...
            Var_62 = mercury__string__string_1_f_0((MR_Word) &mercury__io__io__type_ctor_info_error_0, ((MR_Box) (WriteErrorMsg_28)));
            Var_60 = mercury__string__f_43_43_2_f_0((MR_String) ": ", Var_62);
            Var_58 = mercury__string__f_43_43_2_f_0((MR_String) "\'", Var_60);
            Var_57 = mercury__string__f_43_43_2_f_0(OutputFile_11, Var_58);
            Var_55 = mercury__string__f_43_43_2_f_0((MR_String) "file \140", Var_57);
            Var_52 = mercury__string__f_43_43_2_f_0((MR_String) "Error writing to ", Var_55);
            mercury__io__write_string_4_p_0(StdErrStream_5, Var_52);
            mercury__io__nl_3_p_0(StdErrStream_5);
          }
        }
        else
