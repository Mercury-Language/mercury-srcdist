...
{
  {
    ...
    mercury__getopt__process_options_4_p_0((MR_Word) (&mtc_diff__mtc_diff__type_ctor_info_option_0), (MR_Word) (MR_mkword(MR_mktag(2), &mtc_diff_scalar_common_1[4])), Args0_6, &Args_8, &GetoptResult_9);
