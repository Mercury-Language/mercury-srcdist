  ...
  MR_Word Args_8)
{
  ...
  if (succeeded)
  {
    ...
    if (succeeded)
    {
      Arg1_11 = ((MR_String) ((MR_hl_field(1, Args_8, 0))));
      Var_31 = ((MR_Word) ((MR_hl_field(1, Args_8, 1))));
      succeeded = (Var_31 != (MR_Word) ((MR_Unsigned) 0U));
      if (succeeded)
      {
        Arg2_12 = ((MR_String) ((MR_hl_field(1, Var_31, 0))));
  ...
  if (succeeded)
  {
    ...
    mdbcomp__read_trace_counts__read_trace_counts_file_4_p_0(Arg1_11, &MaybeTraceCounts1_13);
    if (((MR_tag((MR_Word) MaybeTraceCounts1_13)) == (MR_Integer) 1))
    {
      MR_String Msg1_16 = ((MR_String) ((MR_hl_field(1, MaybeTraceCounts1_13, 0))));

      mercury__io__write_string_4_p_0(StdErrStream_6, Msg1_16);
      mercury__io__nl_3_p_0(StdErrStream_6);
    }
    mdbcomp__read_trace_counts__read_trace_counts_file_4_p_0(Arg2_12, &MaybeTraceCounts2_17);
    if (((MR_tag((MR_Word) MaybeTraceCounts2_17)) == (MR_Integer) 1))
    {
      MR_String Msg2_20 = ((MR_String) ((MR_hl_field(1, MaybeTraceCounts2_17, 0))));
    ...
    if (succeeded)
    {
      Type1_21 = ((MR_Word) ((MR_hl_field(0, MaybeTraceCounts1_13, 0))));
      TraceCounts1_22 = ((MR_Word) ((MR_hl_field(0, MaybeTraceCounts1_13, 1))));
      succeeded = ((MR_tag((MR_Word) MaybeTraceCounts2_17)) == (MR_Integer) 0);
      if (succeeded)
      {
        Type2_23 = ((MR_Word) ((MR_hl_field(0, MaybeTraceCounts2_17, 0))));
        TraceCounts2_24 = ((MR_Word) ((MR_hl_field(0, MaybeTraceCounts2_17, 1))));
      }
    }
    if (succeeded)
    {
      ...
      mdbcomp__write_trace_counts__write_trace_counts_to_file_6_p_0(Var_44, TraceCounts_25, OutputFile_10, &WriteResult_26);
      if (!((WriteResult_26 == (MR_Word) ((MR_Unsigned) 0U))))
      {
        MR_Word WriteErrorMsg_27 = ((MR_Word) ((MR_hl_field(1, WriteResult_26, 0))));
        MR_String Var_52;
