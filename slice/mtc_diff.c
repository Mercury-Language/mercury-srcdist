...
{
  {
    ...
    {
      MR_Word GetoptError_29 = ((MR_Word) ((MR_hl_field(MR_mktag(1), GetoptResult_9, (MR_Integer) 0))));
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          Var_46 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Args_8, (MR_Integer) 1))));
          succeeded = (Var_46 != (MR_Word) ((MR_Unsigned) 0U));
          if (succeeded)
          {
            Arg2_13 = ((MR_String) ((MR_hl_field(MR_mktag(1), Var_46, (MR_Integer) 0))));
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          mdbcomp__trace_counts__diff_trace_counts_3_p_0(TraceCounts1_23, TraceCounts2_25, &TraceCounts_26);
          {
            ...
            MR_hl_field(MR_mktag(2), Var_54, 0) = ((MR_Box) (Type1_22));
            MR_hl_field(MR_mktag(2), Var_54, 1) = ((MR_Box) (Type2_24));
          }
          mdbcomp__trace_counts__write_trace_counts_to_file_6_p_0(Var_54, TraceCounts_26, OutputFile_11, &WriteResult_27);
          if (!((WriteResult_27 == (MR_Word) ((MR_Unsigned) 0U))))
          {
            ...
            Var_66 = mercury__string__string_1_f_0((MR_Word) (&mercury__io__io__type_ctor_info_error_0), ((MR_Box) (WriteErrorMsg_28)));
            Var_64 = mercury__string__f_43_43_2_f_0((MR_String) ": ", Var_66);
            Var_62 = mercury__string__f_43_43_2_f_0((MR_String) "\'", Var_64);
            Var_61 = mercury__string__f_43_43_2_f_0(OutputFile_11, Var_62);
            Var_59 = mercury__string__f_43_43_2_f_0((MR_String) "file \140", Var_61);
            Var_56 = mercury__string__f_43_43_2_f_0((MR_String) "Error writing to ", Var_59);
            mercury__io__write_string_4_p_0(StdErrStream_5, Var_56);
            mercury__io__nl_3_p_0(StdErrStream_5);
          }
        }
      }
