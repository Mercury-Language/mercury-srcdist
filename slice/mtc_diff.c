...
MR_decl_label8(main_2_0, 2,3,6,13,14,16,17,18)
MR_decl_label8(main_2_0, 19,21,22,20,27,28,31,32)
MR_decl_label8(main_2_0, 33,34,35,36,37,7,5,42)
MR_decl_label1(main_2_0, 4)
...
MR_BEGIN_MODULE(mtc_diff_module0)
	...
	MR_init_label8(main_2_0,2,3,6,13,14,16,17,18)
	MR_init_label8(main_2_0,19,21,22,20,27,28,31,32)
	MR_init_label8(main_2_0,33,34,35,36,37,7,5,42)
	MR_init_label1(main_2_0,4)
MR_BEGIN_CODE
...
void mercury__mtc_diff__write_out_proc_statics(FILE *fp);
#endif
