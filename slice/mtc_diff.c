  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        Var_41 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Args_8, (MR_Integer) 1))));
        succeeded = (Var_41 != (MR_Word) ((MR_Unsigned) 0U));
        if (succeeded)
        {
          Arg2_13 = ((MR_String) ((MR_hl_field(MR_mktag(1), Var_41, (MR_Integer) 0))));
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        mdbcomp__trace_counts__diff_trace_counts_3_p_0(TraceCounts1_23, TraceCounts2_25, &TraceCounts_26);
        {
          ...
          MR_hl_field(MR_mktag(2), Var_49, 0) = ((MR_Box) (Type1_22));
          MR_hl_field(MR_mktag(2), Var_49, 1) = ((MR_Box) (Type2_24));
        }
