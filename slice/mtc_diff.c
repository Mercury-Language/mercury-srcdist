...
{
  {
    ...
    if (((MR_tag((MR_Word) mtc_diff__GetoptResult_9)) == (MR_mktag((MR_Integer) 1))))
    ...
    else
      {
        ...
        MR_Word mtc_diff__Var_42;
        MR_Word mtc_diff__Var_43;
            ...
            if (mtc_diff__succeeded)
              {
                ...
                mtc_diff__Var_42 = ((MR_Word) (MR_hl_field(MR_mktag(1), mtc_diff__Args_8, (MR_Integer) 1)));
                mtc_diff__succeeded = ((MR_tag((MR_Word) mtc_diff__Var_42)) == (MR_mktag((MR_Integer) 1)));
                if (mtc_diff__succeeded)
                  {
                    mtc_diff__Arg2_13 = ((MR_String) (MR_hl_field(MR_mktag(1), mtc_diff__Var_42, (MR_Integer) 0)));
                    mtc_diff__Var_43 = ((MR_Word) (MR_hl_field(MR_mktag(1), mtc_diff__Var_42, (MR_Integer) 1)));
                    mtc_diff__succeeded = (mtc_diff__Var_43 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
                  }
              }
          }
        if (mtc_diff__succeeded)
            ...
            if (mtc_diff__succeeded)
              {
                ...
                {
                  mtc_diff__Var_50 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                  MR_hl_field(MR_mktag(2), mtc_diff__Var_50, 0) = ((MR_Box) (mtc_diff__Type1_22));
                  MR_hl_field(MR_mktag(2), mtc_diff__Var_50, 1) = ((MR_Box) (mtc_diff__Type2_24));
                }
                {
                  mdbcomp__trace_counts__write_trace_counts_to_file_6_p_0(mtc_diff__Var_50, mtc_diff__TraceCounts_26, mtc_diff__OutputFile_11, &mtc_diff__WriteResult_27);
                }
                if ((mtc_diff__WriteResult_27 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
                ...
                else
                  {
                    ...
                    MR_String mtc_diff__Var_52;
                    MR_String mtc_diff__Var_55;
                    MR_String mtc_diff__Var_57;
                    MR_String mtc_diff__Var_58;
                    MR_String mtc_diff__Var_60;
                    MR_String mtc_diff__Var_62;

                    {
                      mtc_diff__Var_62 = mercury__string__string_1_f_0((MR_Word) &mercury__io__io__type_ctor_info_error_0, ((MR_Box) (mtc_diff__WriteErrorMsg_28)));
                    }
                    {
                      mtc_diff__Var_60 = mercury__string__f_43_43_2_f_0((MR_String) ": ", mtc_diff__Var_62);
                    }
                    {
                      mtc_diff__Var_58 = mercury__string__f_43_43_2_f_0((MR_String) "\'", mtc_diff__Var_60);
                    }
                    {
                      mtc_diff__Var_57 = mercury__string__f_43_43_2_f_0(mtc_diff__OutputFile_11, mtc_diff__Var_58);
                    }
                    {
                      mtc_diff__Var_55 = mercury__string__f_43_43_2_f_0((MR_String) "file \140", mtc_diff__Var_57);
                    }
                    {
                      mtc_diff__Var_52 = mercury__string__f_43_43_2_f_0((MR_String) "Error writing to ", mtc_diff__Var_55);
                    }
                    {
                      mercury__io__write_string_4_p_0(mtc_diff__StdErrStream_5, mtc_diff__Var_52);
                    }
                    {
                      mercury__io__nl_3_p_0(mtc_diff__StdErrStream_5);
                    }
