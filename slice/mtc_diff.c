...
static const MR_EnumFunctorDescPtr mtc_diff__mtc_diff__enum_ordinal_ordered_option_0[1] = { &mtc_diff__mtc_diff__enum_functor_desc_option_0_0 };

static const MR_EnumFunctorDescPtr mtc_diff__mtc_diff__enum_name_ordered_option_0[1] = { &mtc_diff__mtc_diff__enum_functor_desc_option_0_0 };

static const MR_Integer mtc_diff__mtc_diff__functor_number_map_option_0[1] = { (MR_Integer) 0 };
