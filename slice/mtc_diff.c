...
MR_decl_label10(main_2_0, 2,3,8,11,10,13,20,21,24,25)
MR_decl_label10(main_2_0, 23,26,29,28,27,34,36,39,40,41)
MR_decl_label6(main_2_0, 42,43,44,45,14,9)
...
MR_BEGIN_MODULE(mtc_diff_module0)
	...
	MR_init_label10(main_2_0,2,3,8,11,10,13,20,21,24,25)
	MR_init_label10(main_2_0,23,26,29,28,27,34,36,39,40,41)
	MR_init_label6(main_2_0,42,43,44,45,14,9)
MR_BEGIN_CODE
...
void mercury__mtc_diff__write_out_proc_statics(FILE *deep_fp, FILE *procrep_fp)
{
	MR_write_out_module_proc_reps_start(procrep_fp, &mercury_data__module_layout__mtc_diff);
