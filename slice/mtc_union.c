  ...
  MR_Word Args_10)
{
  ...
  if (succeeded)
  {
    ...
    if ((MaybeReadError_20 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      ...
      {
        MR_Word WriteErrorMsg_24 = ((MR_Word) ((MR_hl_field(1, WriteResult_23, (MR_Integer) 0))));
        MR_String Var_45;
    ...
    {
      MR_String ReadErrorMsg_21 = ((MR_String) ((MR_hl_field(1, MaybeReadError_20, (MR_Integer) 0))));
