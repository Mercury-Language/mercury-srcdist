...
{
  {
    ...
    TypeCtorInfo_59_59 = (MR_Word) &mtc_union__mtc_union__type_ctor_info_option_0;
    mercury__getopt__process_options_4_p_0(TypeCtorInfo_59_59, (MR_Word) MR_mkword(MR_mktag(2), &mtc_union_scalar_common_1[4]), Args0_6, &Args_8, &GetoptResult_9);
    if (((MR_tag((MR_Word) GetoptResult_9)) == (MR_mktag((MR_Integer) 1))))
    {
    ...
    else
    {
      ...
      mercury__getopt__lookup_string_option_3_p_0(TypeCtorInfo_59_59, OptionTable_10, ((MR_Box) ((MR_Integer) 0)), &OutputFile_11);
      succeeded = ((MR_tag((MR_Word) Args_8)) == (MR_mktag((MR_Integer) 1)));
      if (succeeded)
      {
        Var_12 = ((MR_String) (MR_hl_field(MR_mktag(1), Args_8, (MR_Integer) 0)));
        Var_13 = ((MR_Word) (MR_hl_field(MR_mktag(1), Args_8, (MR_Integer) 1)));
      ...
      if (succeeded)
      {
        ...
        mercury__getopt__lookup_bool_option_3_p_0(TypeCtorInfo_59_59, OptionTable_10, ((MR_Box) ((MR_Integer) 1)), &Verbose_14);
        ...
        if ((MaybeReadError_18 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
        {
          MR_Word Type_20;
          ...
          {
            Type_20 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
          ...
          if (!((WriteResult_21 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))))))
          {
