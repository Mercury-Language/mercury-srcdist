...
{
  {
    ...
    {
      MR_Word GetoptError_23 = ((MR_Word) ((MR_hl_field(MR_mktag(1), GetoptResult_9, (MR_Integer) 0))));
      MR_String GetoptErrorMsg_24;

      GetoptErrorMsg_24 = mercury__getopt__option_error_to_string_1_f_0((MR_Word) (&mtc_union__mtc_union__type_ctor_info_option_0), GetoptError_23);
      mercury__io__write_string_4_p_0(StdOutStream_4, GetoptErrorMsg_24);
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        if ((MaybeReadError_18 == (MR_Word) ((MR_Unsigned) 0U)))
        {
          ...
          Var_42 = mercury__set__to_sorted_list_1_f_0((MR_Word) (&mdbcomp__trace_counts__mdbcomp__trace_counts__type_ctor_info_trace_count_file_type_0), Kinds_16);
          {
            ...
            MR_hl_field(MR_mktag(1), Type_20, 1) = ((MR_Box) (Var_42));
          }
          ...
          if (!((WriteResult_21 == (MR_Word) ((MR_Unsigned) 0U))))
          {
            ...
            Var_52 = mercury__string__string_1_f_0((MR_Word) (&mercury__io__io__type_ctor_info_error_0), ((MR_Box) (WriteErrorMsg_22)));
            Var_50 = mercury__string__f_43_43_2_f_0((MR_String) ": ", Var_52);
            Var_48 = mercury__string__f_43_43_2_f_0((MR_String) "\'", Var_50);
            Var_47 = mercury__string__f_43_43_2_f_0(OutputFile_11, Var_48);
            Var_44 = mercury__string__f_43_43_2_f_0((MR_String) "Error writing to file \140", Var_47);
            mercury__io__write_string_4_p_0(StdErrStream_5, Var_44);
