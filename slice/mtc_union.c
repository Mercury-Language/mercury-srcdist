...
{
  {
    ...
    if (((MR_tag((MR_Word) mtc_union__GetoptResult_9)) == (MR_mktag((MR_Integer) 1))))
    ...
    else
      {
        ...
        MR_String mtc_union__V_12_12;
        MR_Word mtc_union__V_13_13;
        ...
        if (mtc_union__succeeded)
          {
            mtc_union__V_12_12 = ((MR_String) (MR_hl_field(MR_mktag(1), mtc_union__Args_8, (MR_Integer) 0)));
            mtc_union__V_13_13 = ((MR_Word) (MR_hl_field(MR_mktag(1), mtc_union__Args_8, (MR_Integer) 1)));
            ...
            if ((mtc_union__MaybeReadError_18 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
              {
                ...
                MR_Word mtc_union__V_38_38;

                {
                  mtc_union__V_38_38 = mercury__set__to_sorted_list_1_f_0((MR_Word) &mdbcomp__trace_counts__mdbcomp__trace_counts__type_ctor_info_trace_count_file_type_0, mtc_union__Kinds_16);
                }
                {
                  ...
                  MR_hl_field(MR_mktag(1), mtc_union__Type_20, 1) = ((MR_Box) (mtc_union__V_38_38));
                }
                {
                ...
                if ((mtc_union__WriteResult_21 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
                ...
                else
                  {
                    ...
                    {
                      mtc_union__V_48_48 = mercury__string__string_1_f_0((MR_Word) &mercury__io__io__type_ctor_info_error_0, ((MR_Box) (mtc_union__WriteErrorMsg_22)));
                    }
                    {
                    ...
                    {
                      mtc_union__V_43_43 = mercury__string__f_43_43_2_f_0(mtc_union__OutputFile_11, mtc_union__V_44_44);
                    }
                    {
                      mtc_union__V_40_40 = mercury__string__f_43_43_2_f_0((MR_String) "Error writing to file \140", mtc_union__V_43_43);
                    }
                    {
                      mercury__io__write_string_4_p_0(mtc_union__StdErrStream_5, mtc_union__V_40_40);
                    }
                    {
