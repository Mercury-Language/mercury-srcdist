  ...
  MR_Word Args_10)
{
  ...
  if (succeeded)
  {
    ...
    mdbcomp__trace_counts__read_and_union_trace_counts_8_p_0(ShowProgress_16, Args_10, &NumTests_17, &Kinds_18, &TraceCounts_19, &MaybeReadError_20);
    if ((MaybeReadError_20 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      ...
      mdbcomp__trace_counts__write_trace_counts_to_file_6_p_0(Type_22, TraceCounts_19, OutputFile_12, &WriteResult_23);
