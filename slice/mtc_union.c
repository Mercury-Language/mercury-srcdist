...
static const MR_EnumFunctorDesc mtc_union__mtc_union__enum_functor_desc_option_0_2;

static const MR_EnumFunctorDesc mtc_union__mtc_union__enum_functor_desc_option_0_3;

static const MR_EnumFunctorDescPtr mtc_union__mtc_union__enum_ordinal_ordered_option_0[4];

static const MR_EnumFunctorDescPtr mtc_union__mtc_union__enum_name_ordered_option_0[4];

static const MR_Integer mtc_union__mtc_union__functor_number_map_option_0[4];
...
static void MR_CALL 
mtc_union__compute_and_output_union_6_p_0(
  MR_Word StdOutStream_7,
  MR_Word StdErrStream_8,
...
static /* final */ const MR_Box mtc_union_scalar_common_2[17][2];
...
struct mtc_union__vector_common_type_5_0_s {
  const MR_String mtc_union__vector_common_type_5_0__vct_5_f_0;
  const MR_Word mtc_union__vector_common_type_5_0__vct_5_f_1;
};

static /* final */ const struct mtc_union__vector_common_type_5_0_s mtc_union_vector_common_5[5];

struct mtc_union__vector_common_type_6_0_s {
  const MR_Word mtc_union__vector_common_type_6_0__vct_6_f_0;
  const MR_Word mtc_union__vector_common_type_6_0__vct_6_f_1;
};

static /* final */ const struct mtc_union__vector_common_type_6_0_s mtc_union_vector_common_6[4];
...
static /* final */ const MR_Box mtc_union_scalar_common_2[17][2] = {
  ...
  /* row   2 */
  {
    ((MR_Box) ((MR_String) " [<options>] -o <outputfile> <files>...\n")),
  ...
  /* row   4 */
  {
    ((MR_Box) ((MR_String) "\140mtc_union\' combines multiple trace count files into a single trace")),
    ((MR_Box) (MR_mkword(1, &mtc_union_scalar_common_2[3])))
  },
  /* row   5 */
  {
  ...
  /* row   6 */
  {
    ((MR_Box) ((MR_String) "\tWrite the union of the input trace counts to the specified file.")),
    ((MR_Box) ((MR_Unsigned) 0U))
  },
  /* row   7 */
  {
    ((MR_Box) ((MR_String) "-o <file>, --output-file <file>")),
    ((MR_Box) (MR_mkword(1, &mtc_union_scalar_common_2[6])))
  },
  /* row   8 */
  {
    ((MR_Box) ((MR_String) "\tPrint the name of each trace count file as it is added to the union")),
    ((MR_Box) (MR_mkword(1, &mtc_union_scalar_common_2[7])))
  },
  /* row   9 */
  {
    ((MR_Box) ((MR_String) "-v, --verbose")),
    ((MR_Box) (MR_mkword(1, &mtc_union_scalar_common_2[8])))
  },
  /* row  10 */
  {
    ((MR_Box) ((MR_String) "\tPrint version information.")),
    ((MR_Box) (MR_mkword(1, &mtc_union_scalar_common_2[9])))
  },
  /* row  11 */
  {
    ((MR_Box) ((MR_String) "--version")),
    ((MR_Box) (MR_mkword(1, &mtc_union_scalar_common_2[10])))
  },
  /* row  12 */
  {
    ((MR_Box) ((MR_String) "\tPrint this usage message.")),
    ((MR_Box) (MR_mkword(1, &mtc_union_scalar_common_2[11])))
  },
  /* row  13 */
  {
    ((MR_Box) ((MR_String) "-\?, -h, --help")),
    ((MR_Box) (MR_mkword(1, &mtc_union_scalar_common_2[12])))
  },
  /* row  14 */
  {
    ((MR_Box) ((MR_String) "Copyright (C) 2013-2026 The Mercury team\n")),
    ((MR_Box) ((MR_Unsigned) 0U))
  },
  /* row  15 */
  {
    ((MR_Box) ((MR_String) "Copyright (C) 2005-2012 The University of Melbourne\n")),
    ((MR_Box) (MR_mkword(1, &mtc_union_scalar_common_2[14])))
  },
  /* row  16 */
  {
...
static /* final */ const struct mtc_union__vector_common_type_6_0_s mtc_union_vector_common_6[4] = {
  ...
  {
    (MR_Integer) 2,
    (MR_Word) (MR_mkword(3, &mtc_union_scalar_common_2[16]))
  },
  /* row   3 */
  {
    (MR_Integer) 3,
...
static const MR_EnumFunctorDescPtr mtc_union__mtc_union__enum_ordinal_ordered_option_0[4] = {
  ...
  &mtc_union__mtc_union__enum_functor_desc_option_0_2,
  &mtc_union__mtc_union__enum_functor_desc_option_0_3
};
  ...
  void * cont_env_ptr)
{
  ...
  do
  {
    *HeadVar__1_1 = ((&mtc_union_vector_common_6[0 + slot_0]))->mtc_union__vector_common_type_6_0__vct_6_f_0;
    *HeadVar__2_2 = ((&mtc_union_vector_common_6[0 + slot_0]))->mtc_union__vector_common_type_6_0__vct_6_f_1;
    cont(cont_env_ptr);
  ...
  MR_Word * HeadVar__2_2)
{
  ...
  do
  {
    ...
    result_3 = MR_strcmp(HeadVar__1_1, ((&mtc_union_vector_common_5[0 + mid_2]))->mtc_union__vector_common_type_5_0__vct_5_f_0);
    if ((result_3 == (MR_Integer) 0))
    {
      *HeadVar__2_2 = ((&mtc_union_vector_common_5[0 + mid_2]))->mtc_union__vector_common_type_5_0__vct_5_f_1;
      succeeded = MR_TRUE;
...
main_2_p_0(void)
{
  ...
  {
    MR_Word GetoptError_11 = ((MR_Word) ((MR_hl_field(1, GetoptResult_9, 0))));
    MR_String GetoptErrorMsg_12;

    GetoptErrorMsg_12 = mercury__getopt__option_error_to_string_1_f_0((MR_Word) (&mtc_union__mtc_union__type_ctor_info_option_0), GetoptError_11);
  ...
  {
    MR_Word OptionTable_10 = ((MR_Word) ((MR_hl_field(0, GetoptResult_9, 0))));
    MR_Word Var_42;

    mercury__getopt__lookup_bool_option_3_p_0((MR_Word) (&mtc_union__mtc_union__type_ctor_info_option_0), OptionTable_10, ((MR_Box) ((MR_Integer) 0)), &Var_42);
    ...
    if (succeeded)
    {
      ...
      mercury__io__progname_base_4_p_0((MR_String) "mtc_union", &ProgName_46);
      mercury__io__write_string_4_p_0(StdOutStream_4, (MR_String) "Name: mtc_union - Mercury trace count union\n");
      mercury__io__write_strings_4_p_0(StdOutStream_4, (MR_Word) (MR_mkword(1, &mtc_union_scalar_common_2[15])));
      {
        Var_55 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(1, Var_55, 0) = ((MR_Box) (ProgName_46));
        MR_hl_field(1, Var_55, 1) = ((MR_Box) (MR_mkword(1, &mtc_union_scalar_common_2[2])));
      }
      {
      ...
      mercury__io__write_prefixed_lines_5_p_0(StdOutStream_4, (MR_String) "\t", (MR_Word) (MR_mkword(1, &mtc_union_scalar_common_2[4])));
      mercury__io__write_string_4_p_0(StdOutStream_4, (MR_String) "\nArguments:\n");
      mercury__io__write_prefixed_lines_5_p_0(StdOutStream_4, (MR_String) "\t", (MR_Word) (MR_mkword(1, &mtc_union_scalar_common_2[5])));
      mercury__io__write_string_4_p_0(StdOutStream_4, (MR_String) "\nOptions:\n");
      mercury__io__write_prefixed_lines_5_p_0(StdOutStream_4, (MR_String) "\t", (MR_Word) (MR_mkword(1, &mtc_union_scalar_common_2[13])));
    }
    else
    {
      MR_Word Var_43;

      mercury__getopt__lookup_bool_option_3_p_0((MR_Word) (&mtc_union__mtc_union__type_ctor_info_option_0), OptionTable_10, ((MR_Box) ((MR_Integer) 1)), &Var_43);
      ...
      if (succeeded)
      {
        ...
        mercury__io__write_string_4_p_0(StdOutStream_4, (MR_String) "Mercury trace count union, version ");
        ...
        mtc_union__compute_and_output_union_6_p_0(StdOutStream_4, StdErrStream_5, OptionTable_10, Args_8);
    }
  }
}
...
{
  MR_bool succeeded;
  MR_String OutputFile_12;

  mercury__getopt__lookup_string_option_3_p_0((MR_Word) (&mtc_union__mtc_union__type_ctor_info_option_0), OptionTable_9, ((MR_Box) ((MR_Integer) 2)), &OutputFile_12);
  succeeded = (Args_10 != (MR_Word) ((MR_Unsigned) 0U));
  if (succeeded)
  {
    succeeded = (strcmp(OutputFile_12, (MR_String) "") == 0);
    succeeded = !(succeeded);
  }
  if (succeeded)
  {
    MR_Word Verbose_15;
    MR_Word ShowProgress_16;
    MR_Integer NumTests_17;
    MR_Word Kinds_18;
    MR_Word TraceCounts_19;
    MR_Word MaybeReadError_20;

    mercury__getopt__lookup_bool_option_3_p_0((MR_Word) (&mtc_union__mtc_union__type_ctor_info_option_0), OptionTable_9, ((MR_Box) ((MR_Integer) 3)), &Verbose_15);
    switch (Verbose_15) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        ShowProgress_16 = (MR_Word) ((MR_Unsigned) 0U);
        break;
      case (MR_Integer) 1:
        {
          ShowProgress_16 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(1, ShowProgress_16, 0) = ((MR_Box) (StdOutStream_7));
        }
        break;
    }
    mdbcomp__read_trace_counts__read_and_union_trace_counts_8_p_0(ShowProgress_16, Args_10, &NumTests_17, &Kinds_18, &TraceCounts_19, &MaybeReadError_20);
    if ((MaybeReadError_20 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      MR_Word Type_22;
      MR_Word WriteResult_23;
      MR_Word Var_37;

      Var_37 = mercury__set__to_sorted_list_1_f_0((MR_Word) (&mdbcomp__trace_counts__mdbcomp__trace_counts__type_ctor_info_trace_count_file_type_0), Kinds_18);
      {
        Type_22 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(1, Type_22, 0) = ((MR_Box) (NumTests_17));
        MR_hl_field(1, Type_22, 1) = ((MR_Box) (Var_37));
      }
      mdbcomp__write_trace_counts__write_trace_counts_to_file_6_p_0(Type_22, TraceCounts_19, OutputFile_12, &WriteResult_23);
      if (!((WriteResult_23 == (MR_Word) ((MR_Unsigned) 0U))))
      {
        MR_Word WriteErrorMsg_24 = ((MR_Word) ((MR_hl_field(1, WriteResult_23, 0))));
        MR_String Var_45;

        Var_45 = mercury__io__error_message_1_f_0(WriteErrorMsg_24);
        mercury__io__write_string_4_p_0(StdErrStream_8, (MR_String) "Error writing to file \140");
        mercury__io__write_string_4_p_0(StdErrStream_8, OutputFile_12);
        mercury__io__write_string_4_p_0(StdErrStream_8, (MR_String) "\': ");
        mercury__io__write_string_4_p_0(StdErrStream_8, Var_45);
        mercury__io__write_string_4_p_0(StdErrStream_8, (MR_String) "\n");
        mercury__io__set_exit_status_3_p_0((MR_Integer) 1);
      }
    }
    ...
    {
      MR_String ReadErrorMsg_21 = ((MR_String) ((MR_hl_field(1, MaybeReadError_20, 0))));

      mercury__io__write_string_4_p_0(StdErrStream_8, ReadErrorMsg_21);
      mercury__io__write_string_4_p_0(StdErrStream_8, (MR_String) "\n");
      mercury__io__set_exit_status_3_p_0((MR_Integer) 1);
    }
  }
  else
  {
    ...
    mercury__io__progname_base_4_p_0((MR_String) "mtc_union", &ProgName_62);
    mercury__io__write_string_4_p_0(StdErrStream_8, (MR_String) "Usage: ");
    mercury__io__write_string_4_p_0(StdErrStream_8, ProgName_62);
    mercury__io__write_string_4_p_0(StdErrStream_8, (MR_String) " [<options>] -o <outputfile> <file>...]\n");
    mercury__io__write_string_4_p_0(StdErrStream_8, (MR_String) "Use \140");
    mercury__io__write_string_4_p_0(StdErrStream_8, ProgName_62);
    mercury__io__write_string_4_p_0(StdErrStream_8, (MR_String) " --help\' for more information.\n");
    mercury__io__set_exit_status_3_p_0((MR_Integer) 1);
  }
}
