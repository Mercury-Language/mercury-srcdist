...
static /* final */ const struct mtc_union__vector_common_type_5_0_s mtc_union_vector_common_5[2] = {
  ...
  {
    (MR_Integer) 1,
    (MR_Word) (MR_mkword(MR_mktag(1), &mtc_union_scalar_common_3[0]))
  },
};
...
main_2_p_0(void)
{
  ...
  {
    MR_Word GetoptError_24 = ((MR_Word) ((MR_hl_field(MR_mktag(1), GetoptResult_9, (MR_Integer) 0))));
  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      switch (Verbose_14) {
        ...
        case (MR_Integer) 1:
          {
            ShowProgress_15 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), ShowProgress_15, 0) = ((MR_Box) (StdOutStream_4));
          }
          break;
      }
      ...
      if ((MaybeReadError_19 == (MR_Word) ((MR_Unsigned) 0U)))
      {
        ...
        Var_43 = mercury__set__to_sorted_list_1_f_0((MR_Word) (&mdbcomp__trace_counts__mdbcomp__trace_counts__type_ctor_info_trace_count_file_type_0), Kinds_17);
        {
          Type_21 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), Type_21, 0) = ((MR_Box) (NumTests_16));
          MR_hl_field(MR_mktag(1), Type_21, 1) = ((MR_Box) (Var_43));
        }
        ...
        {
          MR_Word WriteErrorMsg_23 = ((MR_Word) ((MR_hl_field(MR_mktag(1), WriteResult_22, (MR_Integer) 0))));
          MR_String Var_45;
          MR_String Var_48;
          MR_String Var_49;
          MR_String Var_51;
          ...
          Var_53 = mercury__string__string_1_f_0((MR_Word) (&mercury__io__io__type_ctor_info_error_0), ((MR_Box) (WriteErrorMsg_23)));
          Var_51 = mercury__string__f_43_43_2_f_0((MR_String) ": ", Var_53);
          Var_49 = mercury__string__f_43_43_2_f_0((MR_String) "\'", Var_51);
          Var_48 = mercury__string__f_43_43_2_f_0(OutputFile_11, Var_49);
          Var_45 = mercury__string__f_43_43_2_f_0((MR_String) "Error writing to file \140", Var_48);
          mercury__io__write_string_4_p_0(StdErrStream_5, Var_45);
          mercury__io__nl_3_p_0(StdErrStream_5);
        }
      }
      else
      {
        MR_String ReadErrorMsg_20 = ((MR_String) ((MR_hl_field(MR_mktag(1), MaybeReadError_19, (MR_Integer) 0))));
