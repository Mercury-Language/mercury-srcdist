...
MR_decl_label8(main_2_0, 2,7,10,9,12,17,18,19)
MR_decl_label8(main_2_0, 22,24,27,28,29,30,31,32)
MR_decl_label4(main_2_0, 21,35,13,8)
...
MR_BEGIN_MODULE(mtc_union_module0)
	...
	MR_init_label8(main_2_0,2,7,10,9,12,17,18,19)
	MR_init_label8(main_2_0,22,24,27,28,29,30,31,32)
	MR_init_label4(main_2_0,21,35,13,8)
MR_BEGIN_CODE
