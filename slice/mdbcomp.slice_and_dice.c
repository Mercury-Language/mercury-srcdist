...
{
  {
    ...
    if (((MR_tag((MR_Word) ProcLabel_3)) == (MR_Integer) 0))
    {
      ...
      switch (PredOrFunc_6) {
        ...
        case (MR_Integer) 1:
          {
            MR_Integer Var_29 = (MR_Integer) ((MR_Unsigned) Arity_9 - (MR_Unsigned) 1);
  ...
  while (MR_TRUE)
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
          Result0_11 = (MR_Integer) 1;
        else
        {
          succeeded = (Var_14 > Var_15);
          if (succeeded)
            Result0_11 = (MR_Integer) 2;
          else
            Result0_11 = (MR_Integer) 0;
        }
      }
      else
      {
