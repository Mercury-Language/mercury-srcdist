...
{
  {
    ...
    if (((MR_tag((MR_Word) ProcLabel_3)) == (MR_mktag((MR_Integer) 0))))
    {
      ...
      switch (PredOrFunc_6) {
        ...
        case (MR_Integer) 1:
          {
            MR_Integer Var_29 = (MR_Integer) ((MR_Unsigned) Arity_9 - (MR_Unsigned) (MR_Integer) 1);
              ...
              else
              {
                ...
                else
                {
                  ...
                  if (succeeded)
                  {
                    ...
                    Diff1_12 = (MR_Integer) ((MR_Unsigned) Var_34 - (MR_Unsigned) Var_135);
                    ...
                    Diff2_13 = (MR_Integer) ((MR_Unsigned) Var_36 - (MR_Unsigned) Var_145);
                  ...
                  else
                  {
                    ...
                    if (succeeded)
                    {
                      ...
                      Diff1_48 = (MR_Integer) ((MR_Unsigned) Var_38 - (MR_Unsigned) Var_155);
                      ...
                      Diff2_49 = (MR_Integer) ((MR_Unsigned) Var_40 - (MR_Unsigned) Var_165);
