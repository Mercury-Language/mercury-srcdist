...
{
  {
    ...
    mercury__map__to_assoc_list_2_p_0((MR_Word) (&mdbcomp__trace_counts__mdbcomp__trace_counts__type_ctor_info_path_port_0), (MR_Word) (&mdbcomp__slice_and_dice__mdbcomp__slice_and_dice__type_ctor_info_dice_exec_count_0), ProcDice_6, &ProcExecCounts_8);
    {
      ...
      MR_hl_field(MR_mktag(0), Var_12, 0) = ((MR_Box) (&mdbcomp__slice_and_dice_scalar_common_10[4]));
...
{
  {
    ...
    {
      Var_12 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), Var_12, 0) = ((MR_Box) (&mdbcomp__slice_and_dice_scalar_common_10[3]));
...
{
  {
...

    {
      ...
      MR_hl_field(MR_mktag(0), Var_19, 0) = ((MR_Box) (&mdbcomp__slice_and_dice_scalar_common_4[5]));
...
{
  {
    ...
    if (succeeded)
    {
...

      {
        ...
        MR_hl_field(MR_mktag(0), Var_17, 0) = ((MR_Box) (&mdbcomp__slice_and_dice_scalar_common_5[1]));
    ...
    else
    {
      ...
      {
        Var_19 = (MR_Word) MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), Var_19, 0) = ((MR_Box) (&mdbcomp__slice_and_dice_scalar_common_5[1]));
...
{
  {
...

    {
      ...
      MR_hl_field(MR_mktag(0), Var_17, 0) = ((MR_Box) (&mdbcomp__slice_and_dice_scalar_common_10[2]));
...
{
  {
    ...
    if (succeeded)
    {
...

      {
        ...
        MR_hl_field(MR_mktag(0), Var_15, 0) = ((MR_Box) (&mdbcomp__slice_and_dice_scalar_common_8[1]));
    ...
    else
    {
      ...
      {
        Var_17 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), Var_17, 0) = ((MR_Box) (&mdbcomp__slice_and_dice_scalar_common_8[1]));
      ...
      else
      {
        ...
        else
        {
...

          {
            ...
            MR_hl_field(MR_mktag(0), Var_37, 0) = ((MR_Box) (&mdbcomp__slice_and_dice_scalar_common_6[5]));
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(0), Var_38, 0) = ((MR_Box) (&mdbcomp__slice_and_dice_scalar_common_4[4]));
    ...
    if (succeeded)
    {
      ...
      else
      {
        ...
        else
        {
          ...
          {
            Var_37 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
            MR_hl_field(MR_mktag(0), Var_37, 0) = ((MR_Box) (&mdbcomp__slice_and_dice_scalar_common_6[4]));
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(0), Var_40, 0) = ((MR_Box) (&mdbcomp__slice_and_dice_scalar_common_4[2]));
