...
MR_decl_label5(__Compare___mdbcomp__slice_and_dice__dice_0_0, 3,2,5,9,29)
...
MR_decl_label4(__Compare___mdbcomp__slice_and_dice__slice_0_0, 3,2,5,21)
...
MR_BEGIN_MODULE(mdbcomp__slice_and_dice_module36)
	...
	MR_init_label5(__Compare___mdbcomp__slice_and_dice__dice_0_0,3,2,5,9,29)
MR_BEGIN_CODE
...
MR_def_label(__Compare___mdbcomp__slice_and_dice__dice_0_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___mdbcomp__slice_and_dice__dice_0_0_i29);
	}
	MR_r1 = MR_sv(1);
	MR_r2 = MR_sv(3);
	MR_np_call_localret_ent(private_builtin__builtin_compare_int_3_0,
...
MR_def_label(__Compare___mdbcomp__slice_and_dice__dice_0_0,29)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(5);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
...
MR_BEGIN_MODULE(mdbcomp__slice_and_dice_module48)
	...
	MR_init_label4(__Compare___mdbcomp__slice_and_dice__slice_0_0,3,2,5,21)
MR_BEGIN_CODE
...
MR_def_label(__Compare___mdbcomp__slice_and_dice__slice_0_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___mdbcomp__slice_and_dice__slice_0_0_i21);
	}
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(mdbcomp__prim_data, proc_label);
	MR_r2 = (MR_Word) MR_TAG_COMMON(0,0,0);
	MR_r3 = MR_sv(1);
	...
	MR_decr_sp(3);
	MR_np_tailcall_ent(__Compare___tree234__tree234_2_0);
MR_def_label(__Compare___mdbcomp__slice_and_dice__slice_0_0,21)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(3);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
