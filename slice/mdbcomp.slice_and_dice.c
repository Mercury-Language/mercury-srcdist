...
MR_def_static(mdbcomp__slice_and_dice__slice_add_trace_count_3_0)
	...
	MR_tempr3 = MR_r1;
	MR_tfield(0, MR_tempr1, 2) = ((MR_Integer) MR_tfield(0, MR_tempr2, 2) + (MR_Integer) MR_tfield(0, MR_tempr3, 1));
	MR_tfield(0, MR_tempr1, 3) = ((MR_Integer) MR_tfield(0, MR_tempr2, 3) + (MR_Integer) MR_tfield(0, MR_tempr3, 2));
	MR_r1 = MR_tempr1;
	MR_proceed();
	}
#ifdef MR_maybe_local_thread_engine_base
...
MR_def_static(mdbcomp__slice_and_dice__dice_add_trace_count_4_0)
	...
	MR_tempr3 = MR_r2;
	MR_tfield(0, MR_tempr1, 4) = ((MR_Integer) MR_tfield(0, MR_tempr2, 4) + (MR_Integer) MR_tfield(0, MR_tempr3, 1));
	MR_tfield(0, MR_tempr1, 5) = ((MR_Integer) MR_tfield(0, MR_tempr2, 5) + (MR_Integer) MR_tfield(0, MR_tempr3, 2));
	MR_proceed();
	}
...
MR_def_static(mdbcomp__slice_and_dice__slice_label_count_is_zero_1_0)
	...
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_tfield(0, MR_tfield(0, MR_r1, 2), 2);
...
MR_BEGIN_MODULE(mdbcomp__slice_and_dice_module57)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__mdbcomp__slice_and_dice__IntroducedFrom__pred__format_slice_label_counts__551__1_2_0);
MR_BEGIN_CODE
