...
mdbcomp__slice_and_dice__IntroducedFrom__pred__format_slice_label_counts__623__1_2_p_0(
  ...
  MR_Word * Result_8)
{
  while (MR_TRUE)
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        Var_44 = mercury__string__length_1_f_0(SortStrTail_10);
        Var_45 = (MR_Integer) 0;
  ...
  MR_Word * Result_8)
{
  while (MR_TRUE)
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        Var_22 = mercury__string__length_1_f_0(SortStrTail_10);
        Var_23 = (MR_Integer) 0;
...
{
  {
    ...
    succeeded = mdbcomp__slice_and_dice__IntroducedFrom__pred__format_slice_label_counts__623__1_2_p_0(((MR_Integer) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Integer) (wrapper_arg_1)));
    return succeeded;
  }
}
