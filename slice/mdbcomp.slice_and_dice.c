  ...
  MR_Box wrapper_arg_1)
{
  ...
  succeeded = mdbcomp__slice_and_dice__IntroducedFrom__pred__format_slice_label_counts__634__1_2_p_0(((MR_Integer) ((MR_hl_field(0, closure, 3)))), ((MR_Integer) (wrapper_arg_1)));
  return succeeded;
}
