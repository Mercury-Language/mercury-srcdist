    ...
    else
    {
      ...
      else
      {
        ...
        if (((MR_tag((MR_Word) MaybeInfo0_13)) == (MR_Integer) 1))
        {
          ...
          MR_String Var_57;
          MR_String Var_59;
          MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), LineInfoError_15, (MR_Integer) 2)));
  ...
  MR_Word * HeadVar__4_4)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Mark_8, (MR_Integer) 0)));
      ...
      switch (Type_13) {
        ...
        case (MR_Integer) 0:
          ...
          else
          {
            ...
            MR_Unsigned packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Mark_32, (MR_Integer) 0)));
