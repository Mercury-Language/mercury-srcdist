      ...
      case (MR_Integer) 1:
        {
          ...
          if ((Result0_14 == (MR_Word) ((MR_Integer) 0)))
...
{
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        if ((MaybeLineInfo_20 == (MR_Word) ((MR_Integer) 0)))
        {
      ...
      else
      {
        ...
        if (((MR_tag((MR_Word) MaybeLineInfoErr_22)) == (MR_mktag((MR_Integer) 1))))
        {
          ...
          mercury__map__det_insert_4_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&mfilterjavac_scalar_common_1[1]), ((MR_Box) (Filename_16)), ((MR_Box) ((MR_Integer) 0)), STATE_VARIABLE_Cache_0_26, STATE_VARIABLE_Cache_27);
          {
            MR_Word base;
            base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
            *Result_8 = base;
...
{
  {
    ...
    else
    {
      ...
      mfilterjavac__read_line_marks_6_p_0(FileStream_9, (MR_Integer) 1, (MR_Word) ((MR_Integer) 0), &MaybeMarksRev_10);
      ...
      else
      {
        ...
        mfilterjavac__create_line_info_4_p_0(Marks_12, Filename_5, (MR_Word) ((MR_Integer) 0), &MaybeInfo0_13);
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      switch (Type_13) {
        default: /*NOTREACHED*/ MR_assert(0);
        case (MR_Integer) 0:
          if ((Marks0_9 == (MR_Word) ((MR_Integer) 0)))
          {
            MR_Word Var_28;
