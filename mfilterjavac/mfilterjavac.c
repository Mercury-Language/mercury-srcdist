  ...
  if (succeeded)
  {
    ...
    if (succeeded)
    {
      ...
      else
      {
        ...
        MR_String MerFileName_55;
        MR_Integer MerLineNo_56;
        MR_String Rest_57;
        MR_String Var_68;
        MR_String Var_70;
        MR_String Var_71;
        ...
        mfilterjavac__line_info_translate_5_p_0(LineInfo_21, Filename_16, LineNo_19, &MerFileName_55, &MerLineNo_56);
        Rest_57 = mercury__string__join_list_2_f_0((MR_String) " ", OtherPartsA_14);
        Var_68 = mercury__string__f_43_43_2_f_0(Rest_57, (MR_String) "\n");
        Var_70 = mercury__string__f_43_43_2_f_0((MR_String) ": ", Var_68);
        mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&mfilterjavac_scalar_common_3[0]), MerLineNo_56, &Var_71);
        Var_78 = mercury__string__f_43_43_2_f_0(Var_71, Var_70);
        Var_80 = mercury__string__f_43_43_2_f_0((MR_String) ":", Var_78);
        *STATE_VARIABLE_Line_25 = mercury__string__f_43_43_2_f_0(MerFileName_55, Var_80);
        *Result_8 = (MR_Word) ((MR_Unsigned) 0U);
      }
    ...
    else
    {
      ...
      else
      {
...

        {
          ...
          MR_hl_field(MR_mktag(1), Var_37, 0) = ((MR_Box) (LineInfo_42));
        }
        ...
        case (MR_Integer) 0:
          if ((Marks0_9 == (MR_Word) ((MR_Unsigned) 0U)))
          {
...

            {
              ...
              MR_hl_field(MR_mktag(0), Var_24, 2) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 1));
            }
            {
              MR_Word base;
              base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
        ...
        case (MR_Integer) 1:
          {
...

            {
              ...
              MR_hl_field(MR_mktag(0), Var_28, 2) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 0));
            }
            {
              MR_Word base;
              base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
      ...
      case (MR_Integer) 1:
        {
          ...
          if (succeeded)
          {
            Var_30 = ((MR_String) ((MR_hl_field(MR_mktag(1), Parts_14, (MR_Integer) 0))));
            Var_31 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Parts_14, (MR_Integer) 1))));
            ...
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                Marker_15 = ((MR_String) ((MR_hl_field(MR_mktag(1), Var_31, (MR_Integer) 0))));
                Var_32 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Var_31, (MR_Integer) 1))));
                succeeded = (Var_32 != (MR_Word) ((MR_Unsigned) 0U));
                if (succeeded)
                {
                  PathLine_16 = ((MR_String) ((MR_hl_field(MR_mktag(1), Var_32, (MR_Integer) 0))));
                  Var_33 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Var_32, (MR_Integer) 1))));
                  succeeded = (Var_33 == (MR_Word) ((MR_Unsigned) 0U));
                  if (succeeded)
                  {
                    ...
                    if (succeeded)
                    {
                      ...
                      if (succeeded)
                      {
                        ...
                        Var_35 = ((MR_Word) ((MR_hl_field(MR_mktag(1), PartsB_18, (MR_Integer) 1))));
                        succeeded = (Var_35 != (MR_Word) ((MR_Unsigned) 0U));
                        if (succeeded)
                        {
                          MerLineNoStr_20 = ((MR_String) ((MR_hl_field(MR_mktag(1), Var_35, (MR_Integer) 0))));
