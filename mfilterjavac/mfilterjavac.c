...
{
  {
    ...
    succeeded = ((MR_tag((MR_Word) PartsA_12)) == (MR_Integer) 1);
    if (succeeded)
    {
      ...
      succeeded = ((MR_tag((MR_Word) PartsAA_15)) == (MR_Integer) 1);
      if (succeeded)
      {
      ...
      case (MR_Integer) 1:
        {
          ...
          succeeded = ((MR_tag((MR_Word) Parts_14)) == (MR_Integer) 1);
          if (succeeded)
          {
                ...
                if (succeeded)
                {
                  ...
                  if (succeeded)
                  {
                    ...
                    if (succeeded)
                    {
                      ...
                      succeeded = ((MR_tag((MR_Word) PartsB_18)) == (MR_Integer) 1);
                      if (succeeded)
                      {
