  ...
  MR_Word STATE_VARIABLE_Cache_0_21)
{
  ...
  switch (MR_tag((MR_Word) IOResult_12)) {
    ...
    case (MR_Integer) 1:
      {
        MR_String Line0_13 = ((MR_String) ((MR_hl_field(1, IOResult_12, 0))));
        MR_Word Result0_14;
        MR_String Line_15;
        ...
        {
          MR_String Error_17 = ((MR_String) ((MR_hl_field(1, Result0_14, 0))));
    ...
    case (MR_Integer) 2:
      {
        ...
        MR_String Var_32;
        MR_Word Error_34 = ((MR_Word) ((MR_hl_field(2, IOResult_12, 0))));
        MR_String Var_36;
  ...
  MR_Word * MaybeInfo_6)
{
  ...
  {
    MR_Word FileStream_9 = ((MR_Word) ((MR_hl_field(0, Res_8, 0))));
    ...
    {
      MR_String Msg_20 = ((MR_String) ((MR_hl_field(1, MaybeMarksRev_10, 0))));
      MR_String Var_39;
      MR_String Var_61;
    ...
    {
      MR_Word MarksRev_11 = ((MR_Word) ((MR_hl_field(0, MaybeMarksRev_10, 0))));
      MR_Word Marks_12;
  ...
  MR_Word * HeadVar__4_4)
{
  while (MR_TRUE)
  {
    ...
    {
      MR_Word Mark_8 = ((MR_Word) ((MR_hl_field(1, HeadVar__1_1, 0))));
      MR_Word Marks0_9 = ((MR_Word) ((MR_hl_field(1, HeadVar__1_1, 1))));
      MR_Word Type_13 = ((MR_Unsigned) ((MR_hl_field(0, Mark_8, 0))) & (MR_Integer) 1);
      MR_String MerFile_14 = ((MR_String) ((MR_hl_field(0, Mark_8, 1))));
      MR_Integer JavaLineNo_15 = ((MR_Integer) ((MR_hl_field(0, Mark_8, 2))));
      MR_Integer MerLineNo_16 = ((MR_Integer) ((MR_hl_field(0, Mark_8, 3))));
  ...
  MR_Word * MaybeMarks_10)
{
  while (MR_TRUE)
  {
    ...
    switch (MR_tag((MR_Word) Result_12)) {
      ...
      case (MR_Integer) 1:
        {
          MR_String Line_13 = ((MR_String) ((MR_hl_field(1, Result_12, 0))));
          MR_Word Parts_14;
          MR_Word Marks_23;
          MR_String Var_29;
          MR_Integer Var_37;
          ...
          if (succeeded)
          {
            Var_30 = ((MR_String) ((MR_hl_field(1, Parts_14, 0))));
            Var_31 = ((MR_Word) ((MR_hl_field(1, Parts_14, 1))));
            ...
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                Marker_15 = ((MR_String) ((MR_hl_field(1, Var_31, 0))));
                Var_32 = ((MR_Word) ((MR_hl_field(1, Var_31, 1))));
                succeeded = (Var_32 != (MR_Word) ((MR_Unsigned) 0U));
                if (succeeded)
                {
                  PathLine_16 = ((MR_String) ((MR_hl_field(1, Var_32, 0))));
                  Var_33 = ((MR_Word) ((MR_hl_field(1, Var_32, 1))));
                  succeeded = (Var_33 == (MR_Word) ((MR_Unsigned) 0U));
                  if (succeeded)
                  {
                    ...
                    if (succeeded)
                    {
                      ...
                      if (succeeded)
                      {
                        MerFile_19 = ((MR_String) ((MR_hl_field(1, PartsB_18, 0))));
                        Var_35 = ((MR_Word) ((MR_hl_field(1, PartsB_18, 1))));
                        succeeded = (Var_35 != (MR_Word) ((MR_Unsigned) 0U));
                        if (succeeded)
                        {
                          MerLineNoStr_20 = ((MR_String) ((MR_hl_field(1, Var_35, 0))));
      ...
      case (MR_Integer) 2:
        {
          MR_Word Error_24 = ((MR_Word) ((MR_hl_field(2, Result_12, 0))));
          MR_String Var_40;
