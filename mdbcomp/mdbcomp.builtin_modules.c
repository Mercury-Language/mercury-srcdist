...
mdbcomp__builtin_modules__is_mdbcomp_module_name_1_p_0(
  MR_Word mdbcomp__builtin_modules__ModuleName_2)
{
  {
    MR_bool mdbcomp__builtin_modules__succeeded;
    MR_String mdbcomp__builtin_modules__Name_3;

    {
      mdbcomp__builtin_modules__Name_3 = mdbcomp__sym_name__sym_name_to_string_1_f_0(mdbcomp__builtin_modules__ModuleName_2);
    }
    {
      mdbcomp__builtin_modules__succeeded = mdbcomp__mercury_mdbcomp_module_1_p_0(mdbcomp__builtin_modules__Name_3);
    }
...
{
  {
    ...
    {
      mdbcomp__builtin_modules__succeeded = mercury__library__mercury_std_library_module_1_p_0(*mdbcomp__builtin_modules__Name_4);
    }
    return mdbcomp__builtin_modules__succeeded;
  }
}
            ...
            if (!(mdbcomp__builtin_modules__succeeded))
              {
                ...
                if (!(mdbcomp__builtin_modules__succeeded))
                  {
                    {
                      mdbcomp__builtin_modules__succeeded = mdbcomp__sym_name____Unify____sym_name_0_0(mdbcomp__builtin_modules__Module_2, (MR_Word) &mdbcomp__builtin_modules_scalar_common_1[10]);
                    }
                  }
              }
          }
