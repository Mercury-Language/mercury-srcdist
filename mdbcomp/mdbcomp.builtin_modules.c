...
static /* final */ const MR_Box mdbcomp__builtin_modules_scalar_common_2[13][2] = {
  ...
  /* row 11 */
  {
    ...
    ((MR_Box) (MR_mkword(MR_mktag(1), &mdbcomp__builtin_modules_scalar_common_2[10])))
  },
  /* row 12 */
  {
    ((MR_Box) (&mdbcomp__builtin_modules_scalar_common_1[0])),
    ((MR_Box) (MR_mkword(MR_mktag(1), &mdbcomp__builtin_modules_scalar_common_2[11])))
  },
};
...
{
  return (MR_Word) (MR_mkword(MR_mktag(1), &mdbcomp__builtin_modules_scalar_common_2[1]));
}

MR_Word MR_CALL 
mdbcomp__builtin_modules__mercury_string_format_module_0_f_0(void)
{
  return (MR_Word) (MR_mkword(MR_mktag(1), &mdbcomp__builtin_modules_scalar_common_2[0]));
}
