...
MR_decl_label3(fn__mdbcomp__prim_data__insert_module_qualifier_2_0, 7,8,2)
...
MR_decl_label2(fn__mdbcomp__prim_data__sym_name_to_string_sep_2_0, 16,4)
...
MR_BEGIN_MODULE(mdbcomp__prim_data_module8)
	...
	MR_init_label3(fn__mdbcomp__prim_data__insert_module_qualifier_2_0,7,8,2)
MR_BEGIN_CODE
...
MR_define_entry(mercury__fn__mdbcomp__prim_data__insert_module_qualifier_2_0);
	...
	MR_r4 = (MR_Word) MR_sp;
MR_def_label(fn__mdbcomp__prim_data__insert_module_qualifier_2_0,7)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	while (1) {
	MR_incr_sp(1);
	...
	break; } /* end while */
MR_def_label(fn__mdbcomp__prim_data__insert_module_qualifier_2_0,8)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	while (1) {
	{
	MR_Word MR_tempr1;
...
MR_BEGIN_MODULE(mdbcomp__prim_data_module11)
	...
	MR_init_label2(fn__mdbcomp__prim_data__sym_name_to_string_sep_2_0,16,4)
MR_BEGIN_CODE
...
MR_define_entry(mercury__fn__mdbcomp__prim_data__sym_name_to_string_sep_2_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_r1,0)) {
		MR_GOTO_LAB(fn__mdbcomp__prim_data__sym_name_to_string_sep_2_0_i16);
	}
	MR_r1 = MR_ctfield(0, MR_r1, 0);
	MR_proceed();
MR_def_label(fn__mdbcomp__prim_data__sym_name_to_string_sep_2_0,16)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(3);
