    ...
    if (((MR_tag((MR_Word) HeadVar__2_2)) == (MR_Integer) 0))
    {
      ...
      if (((MR_tag((MR_Word) HeadVar__3_3)) == (MR_Integer) 0))
      {
        ...
        else
        {
          ...
          mercury__private_builtin__builtin_compare_int_3_p_0(&SubResult2_9, Var_88, Var_89);
          ...
          else
          {
            ...
            else
            {
              ...
              else
              {
                ...
                mercury__private_builtin__builtin_compare_int_3_p_0(&SubResult5_18, Var_77, ArgY5_17);
                succeeded = (SubResult5_18 != (MR_Integer) 0);
                if (succeeded)
                  *HeadVar__1_1 = SubResult5_18;
                else
                  mercury__private_builtin__builtin_compare_int_3_p_0(HeadVar__1_1, Var_76, ArgY6_20);
              }
            }
          }
        }
    ...
    else
    {
      ...
      else
      {
        ...
        else
        {
          ...
          mercury__private_builtin__builtin_compare_int_3_p_0(&SubResult2_50, Var_90, Var_91);
          ...
          else
          {
            ...
            else
            {
              ...
              else
              {
                ...
                mercury__private_builtin__builtin_compare_int_3_p_0(&SubResult5_59, Var_83, ArgY5_58);
                succeeded = (SubResult5_59 != (MR_Integer) 0);
                if (succeeded)
                  *HeadVar__1_1 = SubResult5_59;
                else
                  mercury__private_builtin__builtin_compare_int_3_p_0(HeadVar__1_1, Var_82, ArgY6_61);
              }
            }
          }
        }
