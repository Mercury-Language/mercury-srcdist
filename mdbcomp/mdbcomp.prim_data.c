...
MR_decl_label2(fn__mdbcomp__prim_data__sym_name_to_list_1_0, 15,5)
...
static const MR_EnumFunctorDesc mercury_data_mdbcomp__prim_data__enum_functor_desc_trace_port_0_17 = {
	"port_user",
	17
};
...
const MR_EnumFunctorDescPtr mercury_data_mdbcomp__prim_data__enum_value_ordered_trace_port_0[] = {
	...
	&mercury_data_mdbcomp__prim_data__enum_functor_desc_trace_port_0_17
};
...
MR_BEGIN_MODULE(mdbcomp__prim_data_module13)
	...
	MR_init_label2(fn__mdbcomp__prim_data__sym_name_to_list_1_0,15,5)
MR_BEGIN_CODE
...
MR_define_entry(mercury__fn__mdbcomp__prim_data__sym_name_to_list_1_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_r1,0)) {
		MR_GOTO_LAB(fn__mdbcomp__prim_data__sym_name_to_list_1_0_i15);
	}
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 2);
...
MR_def_label(fn__mdbcomp__prim_data__sym_name_to_list_1_0,15)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(2);
