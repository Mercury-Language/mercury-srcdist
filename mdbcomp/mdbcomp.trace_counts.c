      ...
      else
      {
        ...
        else
        {
          ...
          if (succeeded)
          {
            ...
            succeeded = mercury__map__remove_4_p_0((MR_Word) (&mdbcomp__trace_counts__mdbcomp__trace_counts__type_ctor_info_proc_label_in_context_0), (MR_Word) (&mdbcomp__trace_counts_scalar_common_1[0]), ((MR_Box) (ProcLabelInContext_53)), &conv0_ProbeCounts_54, STATE_VARIABLE_TraceCounts_0_57, &STATE_VARIABLE_TraceCounts_3_104);
            if (succeeded)
            {
      ...
      case (MR_Integer) 1:
        {
          ...
          else
          {
            ...
            mercury__map__det_insert_4_p_0((MR_Word) (&mdbcomp__trace_counts__mdbcomp__trace_counts__type_ctor_info_proc_label_in_context_0), (MR_Word) (&mdbcomp__trace_counts_scalar_common_1[0]), ((MR_Box) (ProcLabelInContext_9)), ((MR_Box) (ProcCounts0_10)), STATE_VARIABLE_TraceCounts_0_24, &STATE_VARIABLE_TraceCounts_2_31);
