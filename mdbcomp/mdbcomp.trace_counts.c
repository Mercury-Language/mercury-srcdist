...
MR_decl_label8(mdbcomp__trace_counts__read_proc_trace_counts_8_0, 29,34,35,32,24,47,51,60)
MR_decl_label8(mdbcomp__trace_counts__read_proc_trace_counts_8_0, 55,67,46,72,70,74,5,84)
MR_decl_label2(mdbcomp__trace_counts__read_proc_trace_counts_8_0, 85,86)
MR_decl_label8(mdbcomp__trace_counts__read_proc_trace_counts_2_6_0, 37,2,9,12,15,10,18,19)
MR_decl_label1(mdbcomp__trace_counts__read_proc_trace_counts_2_6_0, 7)
...
MR_decl_label8(mdbcomp__trace_counts__read_trace_counts_from_cur_stream_3_0, 2,7,12,15,19,18,23,22)
MR_decl_label7(mdbcomp__trace_counts__read_trace_counts_from_cur_stream_3_0, 27,26,30,31,32,17,4)
MR_decl_label7(mdbcomp__trace_counts__read_trace_counts_list_5_0, 2,5,6,7,8,4,12)
MR_decl_label8(mdbcomp__trace_counts__read_trace_counts_list_stream_8_0, 89,2,13,14,15,20,21,18)
MR_decl_label8(mdbcomp__trace_counts__read_trace_counts_list_stream_8_0, 22,37,40,41,50,51,52,24)
MR_decl_label8(mdbcomp__trace_counts__read_trace_counts_list_stream_8_0, 25,26,27,58,44,45,46,47)
MR_decl_label8(mdbcomp__trace_counts__read_trace_counts_list_stream_8_0, 48,30,31,32,33,34,6,7)
MR_decl_label4(mdbcomp__trace_counts__read_trace_counts_list_stream_8_0, 8,9,10,11)
...
MR_decl_label8(mdbcomp__trace_counts__write_path_port_count_4_0, 19,20,21,22,23,35,36,37)
MR_decl_label7(mdbcomp__trace_counts__write_path_port_count_4_0, 38,39,3,4,5,6,7)
...
MR_decl_label8(fn__mdbcomp__trace_counts__sum_trace_count_file_type_2_0, 8,10,22,29,32,34,35,36)
MR_decl_label7(fn__mdbcomp__trace_counts__sum_trace_count_file_type_2_0, 37,41,44,46,49,50,51)
...
MR_decl_label8(__Compare___mdbcomp__trace_counts__path_port_0_0, 3,2,18,26,30,5,56,10)
...
MR_decl_label8(__Compare___mdbcomp__trace_counts__trace_count_file_type_0_0, 95,3,2,9,18,21,26,62)
MR_decl_label4(__Compare___mdbcomp__trace_counts__trace_count_file_type_0_0, 29,30,32,103)
...
MR_BEGIN_MODULE(mdbcomp__trace_counts_module1)
	...
	MR_init_label8(fn__mdbcomp__trace_counts__sum_trace_count_file_type_2_0,8,10,22,29,32,34,35,36)
	MR_init_label7(fn__mdbcomp__trace_counts__sum_trace_count_file_type_2_0,37,41,44,46,49,50,51)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(mdbcomp__trace_counts_module7)
	...
	MR_init_label8(mdbcomp__trace_counts__read_trace_counts_list_stream_8_0,89,2,13,14,15,20,21,18)
	MR_init_label8(mdbcomp__trace_counts__read_trace_counts_list_stream_8_0,22,37,40,41,50,51,52,24)
	MR_init_label8(mdbcomp__trace_counts__read_trace_counts_list_stream_8_0,25,26,27,58,44,45,46,47)
	MR_init_label8(mdbcomp__trace_counts__read_trace_counts_list_stream_8_0,48,30,31,32,33,34,6,7)
	MR_init_label4(mdbcomp__trace_counts__read_trace_counts_list_stream_8_0,8,9,10,11)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(mdbcomp__trace_counts_module23)
	...
	MR_init_label8(mdbcomp__trace_counts__read_trace_counts_from_cur_stream_3_0,2,7,12,15,19,18,23,22)
	MR_init_label7(mdbcomp__trace_counts__read_trace_counts_from_cur_stream_3_0,27,26,30,31,32,17,4)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(mdbcomp__trace_counts_module25)
	...
	MR_init_label8(mdbcomp__trace_counts__read_proc_trace_counts_8_0,29,34,35,32,24,47,51,60)
	MR_init_label8(mdbcomp__trace_counts__read_proc_trace_counts_8_0,55,67,46,72,70,74,5,84)
	MR_init_label2(mdbcomp__trace_counts__read_proc_trace_counts_8_0,85,86)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(mdbcomp__trace_counts_module26)
	...
	MR_init_label8(mdbcomp__trace_counts__read_proc_trace_counts_2_6_0,37,2,9,12,15,10,18,19)
	MR_init_label1(mdbcomp__trace_counts__read_proc_trace_counts_2_6_0,7)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(mdbcomp__trace_counts_module29)
	...
	MR_init_label8(mdbcomp__trace_counts__write_path_port_count_4_0,19,20,21,22,23,35,36,37)
	MR_init_label7(mdbcomp__trace_counts__write_path_port_count_4_0,38,39,3,4,5,6,7)
MR_BEGIN_CODE
...
MR_define_entry(mercury____Unify___mdbcomp__trace_counts__path_port_0_0);
	...
	MR_tempr3 = MR_ctfield(2, MR_tempr1, 0);
...
MR_BEGIN_MODULE(mdbcomp__trace_counts_module38)
	...
	MR_init_label8(__Compare___mdbcomp__trace_counts__path_port_0_0,3,2,18,26,30,5,56,10)
...
MR_def_label(__Unify___mdbcomp__trace_counts__trace_count_file_type_0_0,57)
	...
	MR_tempr4 = MR_tempr2;
	MR_sv(2) = MR_ctfield(2, MR_tempr4, 1);
	MR_r1 = MR_ctfield(2, MR_tempr3, 0);
	MR_r2 = MR_ctfield(2, MR_tempr4, 0);
	}
...
MR_BEGIN_MODULE(mdbcomp__trace_counts_module48)
	...
	MR_init_label8(__Compare___mdbcomp__trace_counts__trace_count_file_type_0_0,95,3,2,9,18,21,26,62)
	MR_init_label4(__Compare___mdbcomp__trace_counts__trace_count_file_type_0_0,29,30,32,103)
MR_BEGIN_CODE
