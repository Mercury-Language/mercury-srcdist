  ...
  top_of_proc_1:;
    {
      ...
      succeeded = ((MR_tag((MR_Word) TokenList_15)) == (MR_Integer) 1);
      if (succeeded)
      {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          succeeded = ((MR_tag((MR_Word) TokenListRest_19)) == (MR_Integer) 1);
          if (succeeded)
          {
        ...
        else
        {
          ...
          else
          {
            ...
            if (succeeded)
            {
              ...
              succeeded = ((MR_tag((MR_Word) Var_156)) == (MR_Integer) 1);
              if (succeeded)
              {
...
{
  {
    MR_bool succeeded = ((((MR_tag((MR_Word) Token_3)) == (MR_Integer) 3)) && ((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), Token_3, (MR_Integer) 0))) == (MR_Integer) 0)));
    MR_Word Integer_5;
    MR_Word Var_6;
    MR_Word Var_7;
    MR_Word Var_8;
...
{
  {
    ...
    succeeded = ((MR_tag((MR_Word) Words_11)) == (MR_Integer) 1);
    if (succeeded)
    {
...
{
  {
    MR_bool succeeded = ((MR_tag((MR_Word) TraceCountsList_3)) == (MR_Integer) 1);
