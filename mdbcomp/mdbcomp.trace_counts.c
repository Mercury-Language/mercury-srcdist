...
MR_def_label(fn__mdbcomp__trace_counts__sum_trace_count_file_type_2_0,41)
	...
	MR_tempr4 = MR_r1;
	MR_sv(1) = ((MR_Integer) MR_tfield(1, MR_tempr4, 0) + (MR_Integer) 1);
	MR_tempr1 = MR_tempr4;
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(mdbcomp__trace_counts, trace_count_file_type);
	MR_tempr2 = MR_tempr3;
...
MR_def_label(fn__mdbcomp__trace_counts__sum_trace_count_file_type_2_0,46)
	...
	MR_Word MR_tempr1, MR_tempr2, MR_tempr3;
	MR_tempr3 = MR_r1;
	MR_sv(1) = ((MR_Integer) MR_tfield(1, MR_tempr3, 0) + (MR_Integer) 1);
	MR_tempr1 = MR_tempr3;
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(mdbcomp__trace_counts, trace_count_file_type);
	MR_tempr2 = MR_r2;
	MR_r2 = MR_tfield(1, MR_tempr1, 1);
...
MR_def_label(fn__mdbcomp__trace_counts__sum_trace_count_file_type_2_0,49)
	...
	MR_tempr3 = MR_r1;
	MR_tempr4 = MR_r2;
	MR_sv(1) = ((MR_Integer) MR_tfield(1, MR_tempr3, 0) + (MR_Integer) MR_tfield(1, MR_tempr4, 0));
...
MR_def_static(fn__mdbcomp__trace_counts__sum_counts_on_line_2_0)
	...
	MR_tfield(0, MR_tempr1, 0) = MR_tfield(0, MR_tempr2, 0);
	MR_tempr3 = MR_r2;
	MR_tfield(0, MR_tempr1, 1) = ((MR_Integer) MR_tfield(0, MR_tempr2, 1) + (MR_Integer) MR_tfield(0, MR_tempr3, 1));
	MR_tfield(0, MR_tempr1, 2) = ((MR_Integer) MR_tfield(0, MR_tempr2, 2) + (MR_Integer) MR_tfield(0, MR_tempr3, 2));
	MR_r1 = MR_tempr1;
	MR_proceed();
	}
#ifdef MR_maybe_local_thread_engine_base
...
MR_def_label(mdbcomp__trace_counts__read_proc_trace_counts_8_0,47)
	...
	MR_tfield(0, MR_tempr2, 3) = MR_tfield(1, MR_r6, 0);
	MR_tfield(0, MR_tempr2, 4) = MR_tfield(3, MR_tempr1, 1);
	MR_tfield(0, MR_tempr2, 5) = MR_tfield(3, MR_r8, 1);
	MR_r1 = MR_tempr2;
	MR_r4 = MR_sv(5);
	MR_GOTO_LAB(mdbcomp__trace_counts__read_proc_trace_counts_8_0_i46);
	}
