  ...
  top_of_proc_1:;
    {
      ...
      MR_Word * STATE_VARIABLE_TraceCounts_56 = tscc_output_1_STATE_VARIABLE_TraceCounts_56;
      MR_bool succeeded;
  ...
  top_of_proc_2:;
    {
      ...
      MR_Word * STATE_VARIABLE_TraceCounts_23 = tscc_output_1_STATE_VARIABLE_TraceCounts_56;
      MR_bool succeeded;
      MR_Word Result_11;
