  ...
  MR_String * STATE_VARIABLE_CurFileName_23)
{
  ...
  if (((MR_tag((MR_Word) ProcLabel_18)) == (MR_Integer) 0))
  {
...

    {
      ...
      MR_hl_field(MR_mktag(0), Var_71, 0) = ((MR_Box) (&mdbcomp__trace_counts_scalar_common_3[2]));
      MR_hl_field(MR_mktag(0), Var_71, 1) = ((MR_Box) (mdbcomp__trace_counts__write_proc_label_and_file_trace_counts_9_p_0_1));
      MR_hl_field(MR_mktag(0), Var_71, 2) = ((MR_Box) ((MR_Integer) 2));
      MR_hl_field(MR_mktag(0), Var_71, 3) = ((MR_Box) (ModuleNameSym_16));
      MR_hl_field(MR_mktag(0), Var_71, 4) = ((MR_Box) (DefModuleSym_59));
    }
    mercury__require__require_2_p_0(Var_71, (MR_String) "write_proc_label_and_check: module mismatch");
  }
  else
    {
        ...
        case (MR_Integer) 1:
          {
            ...
            if (succeeded)
            {
              Var_51 = ((MR_String) ((MR_hl_field(MR_mktag(1), NewlineResult_40, (MR_Integer) 0))));
              succeeded = (strcmp(Var_51, (MR_String) "\n") == 0);
            }
            if (succeeded)
            {
              MR_Word Result_41;
              ...
              Var_54 = mercury__map__init_0_f_0((MR_Word) (&mdbcomp__trace_counts__mdbcomp__trace_counts__type_ctor_info_proc_label_in_context_0), (MR_Word) (&mdbcomp__trace_counts_scalar_common_1[0]));
              {
                Var_52 = (MR_Word) MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL);
                MR_hl_field(MR_mktag(0), Var_52, 0) = ((MR_Box) (&mdbcomp__trace_counts_scalar_common_7[1]));
                MR_hl_field(MR_mktag(0), Var_52, 1) = ((MR_Box) (mdbcomp__trace_counts__read_trace_counts_4_p_0_1));
                MR_hl_field(MR_mktag(0), Var_52, 2) = ((MR_Box) ((MR_Integer) 2));
                MR_hl_field(MR_mktag(0), Var_52, 3) = ((MR_Box) (FileStream_13));
                MR_hl_field(MR_mktag(0), Var_52, 4) = ((MR_Box) (Var_54));
              }
              mercury__exception__try_io_4_p_0((MR_Word) (&mdbcomp__trace_counts_scalar_common_1[1]), Var_52, &Result_41);
              if (((MR_tag((MR_Word) Result_41)) == (MR_Integer) 2))
              {
                ...
                else
                {
                  ...
                  else
                  {
                    ...
                    succeeded = mercury__univ__univ_1_f_2((MR_Word) (&mdbcomp__trace_counts__mdbcomp__trace_counts__type_ctor_info_trace_count_syntax_error_0), &conv3_Var_55, Exception_43);
                    if (succeeded)
                    {
                    ...
                    else
                    {
                      ...
                      Var_59 = mercury__string__string_1_f_0((MR_Word) (&mercury__univ__univ__type_ctor_info_univ_0), ((MR_Box) (Exception_43)));
                      Var_57 = mercury__string__f_43_43_2_f_0((MR_String) "unexpected exception type: ", Var_59);
                      {
                        mercury__require__unexpected_2_p_0((MR_String) "predicate \140mdbcomp.trace_counts.read_trace_counts_from_stream\'/4", Var_57);
                        return;
                      }
                    }
                  }
