  ...
  MR_Word * STATE_VARIABLE_TraceCounts_17)
{
  ...
  if (succeeded)
  {
    Var_22 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ProcLabel_10, (MR_Integer) 0))));
  ...
  MR_String * STATE_VARIABLE_CurFileName_23)
{
  ...
  {
    MR_Word DefModuleSym_52 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ProcLabel_18, (MR_Integer) 0))));
    MR_Word Var_59;

    {
      Var_59 = (MR_Word) MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), Var_59, 0) = ((MR_Box) (&mdbcomp__trace_counts_scalar_common_3[2]));
      MR_hl_field(MR_mktag(0), Var_59, 1) = ((MR_Box) (mdbcomp__trace_counts__write_proc_label_and_file_trace_counts_9_p_0_1));
      MR_hl_field(MR_mktag(0), Var_59, 2) = ((MR_Box) ((MR_Integer) 2));
      MR_hl_field(MR_mktag(0), Var_59, 3) = ((MR_Box) (ModuleNameSym_16));
      MR_hl_field(MR_mktag(0), Var_59, 4) = ((MR_Box) (DefModuleSym_52));
    }
    mercury__require__require_2_p_0(Var_59, (MR_String) "write_proc_label_and_check: module mismatch");
  }
  else
    {
  ...
  MR_Word * STATE_VARIABLE_ProcTraceCounts_13)
{
  ...
  if (succeeded)
  {
    ...
    MR_Integer LineNumber1_20 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), LineNoCountA_8, (MR_Integer) 0))));
    MR_Integer Count1_21 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), LineNoCountA_8, (MR_Integer) 1))));
    MR_Integer Count2_24 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), LineNoCountB_10, (MR_Integer) 1))));
...

    {
      ...
      MR_hl_field(MR_mktag(0), LineNoCount_11, 0) = ((MR_Box) (LineNumber1_20));
      MR_hl_field(MR_mktag(0), LineNoCount_11, 1) = ((MR_Box) (Var_26));
  ...
  MR_Word * STATE_VARIABLE_TraceCounts_13)
{
  ...
  if (succeeded)
  {
...

    {
      ...
      MR_hl_field(MR_mktag(0), Var_20, 0) = ((MR_Box) (&mdbcomp__trace_counts_scalar_common_7[3]));
      MR_hl_field(MR_mktag(0), Var_20, 1) = ((MR_Box) (mdbcomp__trace_counts__diff_trace_counts_acc_5_p_0_1));
      MR_hl_field(MR_mktag(0), Var_20, 2) = ((MR_Box) ((MR_Integer) 1));
      MR_hl_field(MR_mktag(0), Var_20, 3) = ((MR_Box) (ProcTraceCountsB_10));
    }
  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      switch (MR_tag((MR_Word) FileTypeResult_32)) {
        ...
        case (MR_Integer) 1:
          {
            MR_Word FileType_33 = ((MR_Word) ((MR_hl_field(MR_mktag(1), FileTypeResult_32, (MR_Integer) 0))));
            ...
            if (succeeded)
            {
              Var_43 = ((MR_String) ((MR_hl_field(MR_mktag(1), NewlineResult_34, (MR_Integer) 0))));
            ...
            if (succeeded)
            {
              ...
              Var_45 = mercury__map__init_0_f_0((MR_Word) (&mdbcomp__trace_counts__mdbcomp__trace_counts__type_ctor_info_proc_label_in_context_0), (MR_Word) (&mdbcomp__trace_counts_scalar_common_1[0]));
              {
                ...
                MR_hl_field(MR_mktag(0), Var_44, 0) = ((MR_Box) (&mdbcomp__trace_counts_scalar_common_7[1]));
                MR_hl_field(MR_mktag(0), Var_44, 1) = ((MR_Box) (mdbcomp__trace_counts__read_trace_counts_4_p_0_1));
                MR_hl_field(MR_mktag(0), Var_44, 2) = ((MR_Box) ((MR_Integer) 2));
                MR_hl_field(MR_mktag(0), Var_44, 3) = ((MR_Box) (FileStream_13));
                MR_hl_field(MR_mktag(0), Var_44, 4) = ((MR_Box) (Var_45));
              }
              ...
              {
                MR_Word Exception_37 = ((MR_Word) ((MR_hl_field(MR_mktag(2), Result_35, (MR_Integer) 0))));
                MR_Word IOError_38;
                ...
                if (succeeded)
                  {
                    ...
                    *ReadResult_6 = base;
                    ...
                    MR_hl_field(MR_mktag(3), base, 1) = ((MR_Box) (IOError_38));
                  }
                else
                {
                  ...
                  if (succeeded)
                    {
                      ...
                      *ReadResult_6 = base;
                      MR_hl_field(MR_mktag(2), base, 0) = ((MR_Box) (Message_39));
                    }
                  else
                  {
                    MR_String Error_40;
              ...
              {
                MR_Word TraceCounts_36 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Result_35, (MR_Integer) 0))));

                {
                  MR_Word base;
                  base = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
                  *ReadResult_6 = base;
                  MR_hl_field(MR_mktag(0), base, 0) = ((MR_Box) (FileType_33));
                  MR_hl_field(MR_mktag(0), base, 1) = ((MR_Box) (TraceCounts_36));
                }
              }
            }
            else
