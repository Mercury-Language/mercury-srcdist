  ...
  MR_String * STATE_VARIABLE_CurFileName_23)
{
  ...
  if (((MR_tag((MR_Word) ProcLabel_18)) == (MR_Integer) 0))
  {
...

    {
      ...
      MR_hl_field(MR_mktag(0), Var_58, 0) = ((MR_Box) (&mdbcomp__trace_counts_scalar_common_3[2]));
      MR_hl_field(MR_mktag(0), Var_58, 1) = ((MR_Box) (mdbcomp__trace_counts__write_proc_label_and_file_trace_counts_9_p_0_1));
      MR_hl_field(MR_mktag(0), Var_58, 2) = ((MR_Box) ((MR_Integer) 2));
      MR_hl_field(MR_mktag(0), Var_58, 3) = ((MR_Box) (ModuleNameSym_16));
      MR_hl_field(MR_mktag(0), Var_58, 4) = ((MR_Box) (DefModuleSym_52));
    }
                ...
                if (succeeded)
                {
                  ...
                  else
                  {
                    ...
                    else
                    {
                      ...
                      MR_Word Var_78 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Var_80, (MR_Integer) 1))));
                          ...
                          if (succeeded)
                          {
                            ...
                            else
                            {
                              ...
                              else
                              {
                                ...
                                MR_Word Var_93 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Var_95, (MR_Integer) 1))));
