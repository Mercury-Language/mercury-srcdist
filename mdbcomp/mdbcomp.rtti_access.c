...
{
  {
    ...
    if (succeeded)
    {
      ...
      {
        {
          BytesPrime_5 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
...
#undef MR_PROC_LABEL
	 ...
	 STATE_VARIABLE_Pos_18_18  = Pos;
        ...
        if (succeeded)
        {
          ...
          {
            STATE_VARIABLE_RevChars_19_19 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
	 ...
	 STATE_VARIABLE_Pos_15_15  = Pos;
      ...
      if (succeeded)
      {
        ...
        else
        {
          ...
          {
            STATE_VARIABLE_RevChars_17_17 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
...
{
  {
    ...
    {
      MR_Unsigned packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), HeadVar__1_1, (MR_Integer) 1)));
