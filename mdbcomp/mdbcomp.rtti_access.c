...
;}
#line 365 "mdbcomp.rtti_access.c"
...
;}
#line 400 "mdbcomp.rtti_access.c"
...
#line 196 "rtti_access.m"
    ...
    GoalPath = (MR_String) MR_label_goal_path(Label);
;}
#line 444 "mdbcomp.rtti_access.c"
	MR_r1 = (MR_Word) GoalPath;
#undef	MR_PROC_LABEL
	}
	MR_proceed();
...
#line 221 "rtti_access.m"
    ...
    Port = Label->MR_sll_port;
;}
#line 519 "mdbcomp.rtti_access.c"
	MR_r2 = Port;
#undef	MR_PROC_LABEL
	}
	{
...
;}
#line 588 "mdbcomp.rtti_access.c"
...
;}
#line 1155 "mdbcomp.rtti_access.c"
...
#line 465 "rtti_access.m"
    ...
    Layouts = list;
;}
#line 1272 "mdbcomp.rtti_access.c"
	MR_r1 = Layouts;
#undef	MR_PROC_LABEL
	}
	MR_proceed();
...
;}
#line 1307 "mdbcomp.rtti_access.c"
	MR_r1 = (MR_Word) ProcLayout;
#undef	MR_PROC_LABEL
	}
	MR_proceed();
...
#endif
;}
#line 1345 "mdbcomp.rtti_access.c"
...
;}
#line 1389 "mdbcomp.rtti_access.c"
...
#line 625 "rtti_access.m"
    ...
    Size = ModuleCommonLayout->MR_mlc_string_table_size;
;}
#line 1474 "mdbcomp.rtti_access.c"
...
;}
#line 1527 "mdbcomp.rtti_access.c"
	MR_r1 = (MR_Word) Str;
#undef	MR_PROC_LABEL
	}
	MR_proceed();
...
;}
#line 1579 "mdbcomp.rtti_access.c"
	MR_r1 = (MR_Word) Str;
#undef	MR_PROC_LABEL
	}
	MR_proceed();
...
#define	MR_PROC_LABEL	mercury__mdbcomp__rtti_access__read_byte_2_4_0
	...
	Pos0 = MR_r2;
{
#line 665 "rtti_access.m"

    Value = ByteCode[Pos0];
    Pos = Pos0 + 1;
;}
#line 1619 "mdbcomp.rtti_access.c"
	MR_r1 = Value;
	MR_r2 = Pos;
#undef	MR_PROC_LABEL
	}
...
#line 665 "rtti_access.m"
    ...
    Pos = Pos0 + 1;
;}
#line 1668 "mdbcomp.rtti_access.c"
	MR_r2 = Value;
	MR_r3 = Pos;
#undef	MR_PROC_LABEL
	}
...
#define	MR_PROC_LABEL	mercury__mdbcomp__rtti_access__read_short_2_4_0
	...
	Pos0 = MR_r2;
{
#line 680 "rtti_access.m"

    Value = (ByteCode[Pos0] << 8) + ByteCode[Pos0+1];
    Pos = Pos0 + 2;
;}
#line 1714 "mdbcomp.rtti_access.c"
	MR_r1 = Value;
	MR_r2 = Pos;
#undef	MR_PROC_LABEL
	}
...
#line 680 "rtti_access.m"
    ...
    Pos = Pos0 + 2;
;}
#line 1763 "mdbcomp.rtti_access.c"
	MR_r2 = Value;
	MR_r3 = Pos;
#undef	MR_PROC_LABEL
	}
...
#line 695 "rtti_access.m"
    ...
    Pos = Pos0 + 4;
;}
#line 1860 "mdbcomp.rtti_access.c"
	MR_r2 = Value;
	MR_r3 = Pos;
#undef	MR_PROC_LABEL
	}
...
#line 665 "rtti_access.m"
    ...
    Pos = Pos0 + 1;
;}
#line 1920 "mdbcomp.rtti_access.c"
	MR_tempr2 = Value;
	MR_tempr1 = Pos;
#undef	MR_PROC_LABEL
	}
...
#line 695 "rtti_access.m"
    ...
    Pos = Pos0 + 4;
;}
#line 2028 "mdbcomp.rtti_access.c"
	MR_tempr1 = Value;
	MR_r3 = Pos;
#undef	MR_PROC_LABEL
	}
...
;}
#line 2058 "mdbcomp.rtti_access.c"
	MR_r2 = (MR_Word) Str;
#undef	MR_PROC_LABEL
	}
	MR_r1 = MR_TRUE;
...
#line 665 "rtti_access.m"
    ...
    Pos = Pos0 + 1;
;}
#line 2117 "mdbcomp.rtti_access.c"
	MR_tempr2 = Value;
	MR_tempr1 = Pos;
#undef	MR_PROC_LABEL
	}
...
#line 665 "rtti_access.m"
    ...
    Pos = Pos0 + 1;
;}
#line 2275 "mdbcomp.rtti_access.c"
	MR_tempr2 = Value;
	MR_tempr1 = Pos;
#undef	MR_PROC_LABEL
	}
...
;}
#line 2472 "mdbcomp.rtti_access.c"
...
#line 770 "rtti_access.m"
    ...
    StringTableChars = (MR_ConstString) buf;
;}
#line 2983 "mdbcomp.rtti_access.c"
	MR_r1 = (MR_Word) StringTableChars;
#undef	MR_PROC_LABEL
	}
	MR_proceed();
