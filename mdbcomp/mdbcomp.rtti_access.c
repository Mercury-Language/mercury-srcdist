  ...
  MR_Integer * STATE_VARIABLE_Pos_16)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      MR_Integer Var_20;
      MR_Integer Var_23;
      MR_Box Bytes_24 = ((MR_Box) ((MR_hl_field(MR_mktag(0), ByteCode_7, (MR_Integer) 0))));
      MR_Integer Size_25 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), ByteCode_7, (MR_Integer) 1))));
  ...
  MR_Integer * STATE_VARIABLE_Pos_12)
{
  ...
  MR_Box Bytes_13 = ((MR_Box) ((MR_hl_field(MR_mktag(0), ByteCode_6, (MR_Integer) 0))));
  MR_Integer Size_14 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), ByteCode_6, (MR_Integer) 1))));
...
#undef MR_PROC_LABEL
	...
	*STATE_VARIABLE_Pos_12  = Pos;
    ...
    StringTableChars_17 = ((MR_Box) ((MR_hl_field(MR_mktag(0), StringTable_7, (MR_Integer) 0))));
    Size_18 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), StringTable_7, (MR_Integer) 1))));
{
#define MR_PROC_LABEL mdbcomp__rtti_access__read_string_via_offset_5_p_0
  ...
  MR_Integer * STATE_VARIABLE_Pos_13)
{
  while (MR_TRUE)
  {
    ...
    MR_Integer Var_17;
    MR_Integer Var_18;
    MR_Box Bytes_21 = ((MR_Box) ((MR_hl_field(MR_mktag(0), ByteCode_6, (MR_Integer) 0))));
    MR_Integer Size_22 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), ByteCode_6, (MR_Integer) 1))));
