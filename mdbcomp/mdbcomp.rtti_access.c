...
extern const MR_TypeCtorInfo_Struct
	...
	mercury_data_mdbcomp__rtti_access__type_ctor_info_module_layout_0,
...
MR_decl_label1(mdbcomp__rtti_access__containing_module_layout_2_0, 1)
MR_decl_label1(mdbcomp__rtti_access__encode_byte_2_0, 1)
MR_decl_label1(mdbcomp__rtti_access__encode_byte_det_2_0, 2)
MR_decl_label4(mdbcomp__rtti_access__encode_int32_2_0, 3,5,7,1)
MR_decl_label2(mdbcomp__rtti_access__encode_int32_det_2_0, 3,2)
MR_decl_label6(mdbcomp__rtti_access__encode_len_string_2_0, 2,5,4,8,9,11)
MR_decl_label3(mdbcomp__rtti_access__encode_num_2_0, 2,4,1)
MR_decl_label3(mdbcomp__rtti_access__encode_num_2_3_0, 12,2,4)
MR_decl_label2(mdbcomp__rtti_access__encode_num_det_2_0, 3,2)
MR_decl_label2(mdbcomp__rtti_access__encode_short_2_0, 3,1)
MR_decl_label2(mdbcomp__rtti_access__encode_short_det_2_0, 3,2)
...
MR_decl_label1(mdbcomp__rtti_access__read_string_via_offset_5_0, 1)
MR_decl_label2(fn__mdbcomp__rtti_access__encode_int32_func_1_0, 3,2)
MR_decl_label2(fn__mdbcomp__rtti_access__encode_num_func_1_0, 3,2)
MR_decl_label2(fn__mdbcomp__rtti_access__encode_short_func_1_0, 3,2)
...
MR_def_extern_entry(mdbcomp__rtti_access__containing_module_layout_2_0)
MR_decl_static(mdbcomp__rtti_access__module_string_table_components_3_0)
MR_def_extern_entry(fn__mdbcomp__rtti_access__module_string_table_1_0)
MR_decl_static(fn__mdbcomp__rtti_access__lookup_string_table_2_3_0)
...
MR_def_extern_entry(mdbcomp__rtti_access__encode_byte_2_0)
MR_def_extern_entry(mdbcomp__rtti_access__encode_byte_det_2_0)
MR_def_extern_entry(fn__mdbcomp__rtti_access__encode_byte_func_1_0)
MR_def_extern_entry(mdbcomp__rtti_access__encode_short_2_0)
MR_def_extern_entry(mdbcomp__rtti_access__encode_short_det_2_0)
MR_def_extern_entry(fn__mdbcomp__rtti_access__encode_short_func_1_0)
MR_def_extern_entry(mdbcomp__rtti_access__encode_int32_2_0)
MR_def_extern_entry(mdbcomp__rtti_access__encode_int32_det_2_0)
MR_def_extern_entry(fn__mdbcomp__rtti_access__encode_int32_func_1_0)
MR_decl_static(mdbcomp__rtti_access__encode_num_2_3_0)
MR_def_extern_entry(mdbcomp__rtti_access__encode_num_2_0)
MR_def_extern_entry(mdbcomp__rtti_access__encode_num_det_2_0)
MR_def_extern_entry(fn__mdbcomp__rtti_access__encode_num_func_1_0)
MR_def_extern_entry(mdbcomp__rtti_access__encode_len_string_2_0)
MR_def_extern_entry(fn__mdbcomp__rtti_access__encode_len_string_func_1_0)
...
MR_def_extern_entry(__Unify___mdbcomp__rtti_access__module_layout_0_0)
MR_def_extern_entry(__Compare___mdbcomp__rtti_access__module_layout_0_0)
...
mercury_data__closure_layout__mdbcomp__rtti_access__encode_len_string_2_0_1;
extern const MR_TypeCtorInfo_Struct mercury_data_builtin__type_ctor_info_character_0;
extern const MR_TypeCtorInfo_Struct mercury_data_builtin__type_ctor_info_int_0;
static const struct mercury_type_0 mercury_common_0[1] =
{
{
(MR_Word *) &mercury_data__closure_layout__mdbcomp__rtti_access__encode_len_string_2_0_1,
...
const MR_TypeCtorInfo_Struct mercury_data_mdbcomp__rtti_access__type_ctor_info_module_layout_0 = {
	0,
	15,
	-1,
	MR_TYPECTOR_REP_STABLE_FOREIGN,
	MR_MAYBE_STATIC_CODE(MR_ENTRY_AP(__Unify___mdbcomp__rtti_access__module_layout_0_0)),
	MR_MAYBE_STATIC_CODE(MR_ENTRY_AP(__Compare___mdbcomp__rtti_access__module_layout_0_0)),
	"mdbcomp.rtti_access",
	"module_layout",
	{ 0 },
	{ 0 },
...
;}
#line 464 "mdbcomp.rtti_access.c"
...
;}
#line 499 "mdbcomp.rtti_access.c"
...
#line 219 "rtti_access.m"
    ...
    GoalPath = (MR_String) MR_label_goal_path(Label);
;}
#line 543 "mdbcomp.rtti_access.c"
	MR_r1 = (MR_Word) GoalPath;
#undef	MR_PROC_LABEL
	}
	MR_proceed();
...
;}
#line 578 "mdbcomp.rtti_access.c"
	MR_r1 = Port;
#undef	MR_PROC_LABEL
	}
	MR_proceed();
...
#line 244 "rtti_access.m"
    ...
    Port = Label->MR_sll_port;
;}
#line 618 "mdbcomp.rtti_access.c"
	MR_r2 = Port;
#undef	MR_PROC_LABEL
	}
	{
...
#line 219 "rtti_access.m"
    ...
    GoalPath = (MR_String) MR_label_goal_path(Label);
;}
#line 632 "mdbcomp.rtti_access.c"
	MR_r1 = (MR_Word) GoalPath;
#undef	MR_PROC_LABEL
	}
	MR_sv(1) = MR_r2;
...
;}
#line 687 "mdbcomp.rtti_access.c"
...
;}
#line 738 "mdbcomp.rtti_access.c"
...
;}
#line 850 "mdbcomp.rtti_access.c"
	MR_r1 = PredOrFunc;
...
;}
#line 902 "mdbcomp.rtti_access.c"
...
#line 308 "rtti_access.m"
    ...
    ModeNum    = proc_id->MR_uci_mode;
;}
#line 935 "mdbcomp.rtti_access.c"
...
MR_def_label(fn__mdbcomp__rtti_access__get_proc_label_from_layout_1_0,6)
	...
	MR_tempr2 = MR_sv(3);
	MR_tempr3 = MR_sv(4);
	MR_r1 = (MR_Word) MR_string_const("mdbcomp.rtti_access", 19);
	MR_r2 = (MR_Word) MR_string_const("function \140mdbcomp.rtti_access.get_proc_label_from_layout\'/1", 59);
	MR_r3 = (MR_Word) MR_string_const("bad special_pred_id", 19);
	}
...
#line 330 "rtti_access.m"
    ...
    ModeNum    = proc_id->MR_user_mode;
;}
#line 1027 "mdbcomp.rtti_access.c"
	MR_r2 = PredOrFunc;
...
;}
#line 1254 "mdbcomp.rtti_access.c"
...
#line 488 "rtti_access.m"
    ...
    Layouts = list;
;}
#line 1371 "mdbcomp.rtti_access.c"
	MR_r1 = Layouts;
#undef	MR_PROC_LABEL
	}
	MR_proceed();
...
;}
#line 1406 "mdbcomp.rtti_access.c"
	MR_r1 = (MR_Word) ProcLayout;
#undef	MR_PROC_LABEL
	}
	MR_proceed();
...
#endif
;}
#line 1444 "mdbcomp.rtti_access.c"
...
MR_BEGIN_MODULE(mdbcomp__rtti_access_module15)
	MR_init_entry1(mdbcomp__rtti_access__containing_module_layout_2_0);
	MR_INIT_PROC_LAYOUT_ADDR(mercury__mdbcomp__rtti_access__containing_module_layout_2_0);
	MR_init_label1(mdbcomp__rtti_access__containing_module_layout_2_0,1)
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'containing_module_layout'/2 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_define_entry(mercury__mdbcomp__rtti_access__containing_module_layout_2_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	const MR_ProcLayout *	ProcLayout;
	const MR_ModuleLayout *	ModuleLayout;
#define	MR_PROC_LABEL	mercury__mdbcomp__rtti_access__containing_module_layout_2_0
	MR_bool MercurySuccessIndicator;
#undef SUCCESS_INDICATOR
#define SUCCESS_INDICATOR MercurySuccessIndicator
	ProcLayout = (const MR_ProcLayout *) MR_r1;
...
;}
#line 1488 "mdbcomp.rtti_access.c"
if (!MercurySuccessIndicator) MR_GOTO_LAB(mdbcomp__rtti_access__containing_module_layout_2_0_i1);
	MR_r2 = (MR_Word) ModuleLayout;
#undef SUCCESS_INDICATOR
#define SUCCESS_INDICATOR MR_r1
#undef	MR_PROC_LABEL
	}
	MR_r1 = MR_TRUE;
	MR_proceed();
MR_def_label(mdbcomp__rtti_access__containing_module_layout_2_0,1)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_FALSE;
	MR_proceed();
#ifdef MR_maybe_local_thread_engine_base
...
#define	MR_PROC_LABEL	mercury__mdbcomp__rtti_access__module_string_table_components_3_0
	ModuleLayout = (const MR_ModuleLayout *) MR_r1;
{
...
;}
#line 1533 "mdbcomp.rtti_access.c"
...
MR_BEGIN_MODULE(mdbcomp__rtti_access_module17)
	MR_init_entry1(fn__mdbcomp__rtti_access__module_string_table_1_0);
	MR_INIT_PROC_LAYOUT_ADDR(mercury__fn__mdbcomp__rtti_access__module_string_table_1_0);
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'module_string_table'/2 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_define_entry(mercury__fn__mdbcomp__rtti_access__module_string_table_1_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	{
	...
	MR_ConstString	StringTableChars;
	MR_Integer	Size;
#define	MR_PROC_LABEL	mercury__fn__mdbcomp__rtti_access__module_string_table_1_0
	ModuleLayout = (const MR_ModuleLayout *) MR_r1;
{
#line 647 "rtti_access.m"
    ...
    Size = ModuleLayout->MR_ml_string_table_size;
;}
#line 1573 "mdbcomp.rtti_access.c"
...
MR_BEGIN_MODULE(mdbcomp__rtti_access_module18)
	MR_init_entry1(fn__mdbcomp__rtti_access__lookup_string_table_2_3_0);
	MR_INIT_PROC_LAYOUT_ADDR(mercury__fn__mdbcomp__rtti_access__lookup_string_table_2_3_0);
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'lookup_string_table_2'/4 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(fn__mdbcomp__rtti_access__lookup_string_table_2_3_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_ConstString	StringTableChars;
	...
	MR_Integer	NameCode;
	MR_String	Str;
#define	MR_PROC_LABEL	mercury__fn__mdbcomp__rtti_access__lookup_string_table_2_3_0
	StringTableChars = (MR_ConstString) MR_r1;
	StringTableSize = MR_r2;
	NameCode = MR_r3;
{
...
;}
#line 1626 "mdbcomp.rtti_access.c"
	MR_r1 = (MR_Word) Str;
#undef	MR_PROC_LABEL
	}
	MR_proceed();
...
;}
#line 1678 "mdbcomp.rtti_access.c"
	MR_r1 = (MR_Word) Str;
#undef	MR_PROC_LABEL
	}
	MR_proceed();
...
#line 687 "rtti_access.m"
    ...
    Pos = Pos0 + 1;
;}
#line 1718 "mdbcomp.rtti_access.c"
	MR_r1 = Value;
	MR_r2 = Pos;
#undef	MR_PROC_LABEL
	}
...
#line 687 "rtti_access.m"
    ...
    Pos = Pos0 + 1;
;}
#line 1767 "mdbcomp.rtti_access.c"
	MR_r2 = Value;
	MR_r3 = Pos;
#undef	MR_PROC_LABEL
	}
...
#line 702 "rtti_access.m"
    ...
    Pos = Pos0 + 2;
;}
#line 1813 "mdbcomp.rtti_access.c"
	MR_r1 = Value;
	MR_r2 = Pos;
#undef	MR_PROC_LABEL
	}
...
#line 702 "rtti_access.m"
    ...
    Pos = Pos0 + 2;
;}
#line 1862 "mdbcomp.rtti_access.c"
	MR_r2 = Value;
	MR_r3 = Pos;
#undef	MR_PROC_LABEL
	}
...
#line 717 "rtti_access.m"
    ...
    Pos = Pos0 + 4;
;}
#line 1909 "mdbcomp.rtti_access.c"
	MR_r1 = Value;
	MR_r2 = Pos;
#undef	MR_PROC_LABEL
	}
...
#line 717 "rtti_access.m"
    ...
    Pos = Pos0 + 4;
;}
#line 1959 "mdbcomp.rtti_access.c"
	MR_r2 = Value;
	MR_r3 = Pos;
#undef	MR_PROC_LABEL
	}
...
#line 687 "rtti_access.m"
    ...
    Pos = Pos0 + 1;
;}
#line 2019 "mdbcomp.rtti_access.c"
	MR_tempr2 = Value;
	MR_tempr1 = Pos;
#undef	MR_PROC_LABEL
	}
...
MR_BEGIN_MODULE(mdbcomp__rtti_access_module28)
	...
	MR_init_label1(mdbcomp__rtti_access__read_string_via_offset_5_0,1)
MR_BEGIN_CODE
...
#line 717 "rtti_access.m"
    ...
    Pos = Pos0 + 4;
;}
#line 2127 "mdbcomp.rtti_access.c"
	MR_tempr1 = Value;
	MR_r3 = Pos;
#undef	MR_PROC_LABEL
	}
	...
	MR_String	Str;
#define	MR_PROC_LABEL	mercury__mdbcomp__rtti_access__read_string_via_offset_5_0
	StringTableChars = (MR_ConstString) MR_tempr2;
	StringTableSize = MR_tempr3;
	NameCode = MR_tempr1;
{
#line 662 "rtti_access.m"
...
;}
#line 2157 "mdbcomp.rtti_access.c"
	MR_r2 = (MR_Word) Str;
#undef	MR_PROC_LABEL
	}
	MR_r1 = MR_TRUE;
...
#line 687 "rtti_access.m"
    ...
    Pos = Pos0 + 1;
;}
#line 2216 "mdbcomp.rtti_access.c"
	MR_tempr2 = Value;
	MR_tempr1 = Pos;
#undef	MR_PROC_LABEL
	}
...
#line 687 "rtti_access.m"
    ...
    Pos = Pos0 + 1;
;}
#line 2374 "mdbcomp.rtti_access.c"
	MR_tempr2 = Value;
	MR_tempr1 = Pos;
#undef	MR_PROC_LABEL
	}
...
;}
#line 2571 "mdbcomp.rtti_access.c"
...
MR_BEGIN_MODULE(mdbcomp__rtti_access_module35)
	MR_init_entry1(mdbcomp__rtti_access__encode_byte_2_0);
	MR_INIT_PROC_LAYOUT_ADDR(mercury__mdbcomp__rtti_access__encode_byte_2_0);
	MR_init_label1(mdbcomp__rtti_access__encode_byte_2_0,1)
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'encode_byte'/2 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_define_entry(mercury__mdbcomp__rtti_access__encode_byte_2_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_LT(MR_r1,0)) {
		MR_GOTO_LAB(mdbcomp__rtti_access__encode_byte_2_0_i1);
	}
	if (MR_INT_GE(MR_r1,128)) {
		MR_GOTO_LAB(mdbcomp__rtti_access__encode_byte_2_0_i1);
	}
	...
	MR_r1 = MR_TRUE;
	MR_proceed();
MR_def_label(mdbcomp__rtti_access__encode_byte_2_0,1)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_FALSE;
	MR_proceed();
#ifdef MR_maybe_local_thread_engine_base
...
MR_BEGIN_MODULE(mdbcomp__rtti_access_module36)
	MR_init_entry1(mdbcomp__rtti_access__encode_byte_det_2_0);
	MR_INIT_PROC_LAYOUT_ADDR(mercury__mdbcomp__rtti_access__encode_byte_det_2_0);
	MR_init_label1(mdbcomp__rtti_access__encode_byte_det_2_0,2)
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'encode_byte_det'/2 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_define_entry(mercury__mdbcomp__rtti_access__encode_byte_det_2_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_LT(MR_r1,0)) {
		MR_GOTO_LAB(mdbcomp__rtti_access__encode_byte_det_2_0_i2);
	}
	if (MR_INT_GE(MR_r1,128)) {
		MR_GOTO_LAB(mdbcomp__rtti_access__encode_byte_det_2_0_i2);
	}
	...
	MR_r1 = MR_r2;
	MR_proceed();
MR_def_label(mdbcomp__rtti_access__encode_byte_det_2_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_string_const("mdbcomp.rtti_access", 19);
	MR_r2 = (MR_Word) MR_string_const("predicate \140mdbcomp.rtti_access.encode_byte_det\'/2", 49);
	MR_r3 = (MR_Word) MR_string_const("encode_byte failed", 18);
...
MR_BEGIN_MODULE(mdbcomp__rtti_access_module37)
	MR_init_entry1(fn__mdbcomp__rtti_access__encode_byte_func_1_0);
	MR_INIT_PROC_LAYOUT_ADDR(mercury__fn__mdbcomp__rtti_access__encode_byte_func_1_0);
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'encode_byte_func'/2 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_define_entry(mercury__fn__mdbcomp__rtti_access__encode_byte_func_1_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_np_tailcall_ent(mdbcomp__rtti_access__encode_byte_det_2_0);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_thread_engine_base
#endif
...
MR_BEGIN_MODULE(mdbcomp__rtti_access_module38)
	MR_init_entry1(mdbcomp__rtti_access__encode_short_2_0);
	MR_INIT_PROC_LAYOUT_ADDR(mercury__mdbcomp__rtti_access__encode_short_2_0);
	MR_init_label2(mdbcomp__rtti_access__encode_short_2_0,3,1)
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'encode_short'/2 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_define_entry(mercury__mdbcomp__rtti_access__encode_short_2_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(2);
	MR_sv(2) = (MR_Word) MR_succip;
	if (MR_INT_LT(MR_r1,0)) {
		MR_GOTO_LAB(mdbcomp__rtti_access__encode_short_2_0_i1);
	}
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 2);
	MR_sv(1) = MR_tempr1;
	MR_tfield(1, MR_tempr1, 0) = ((MR_Integer) MR_r1 & (MR_Integer) 255);
	MR_tfield(1, MR_tempr1, 1) = (MR_Word) MR_tbmkword(0, 0);
	MR_r2 = (MR_Integer) 256;
	}
	MR_np_call_localret_ent(fn__f_105_110_116_95_95_47_2_0,
		mdbcomp__rtti_access__encode_short_2_0_i3);
MR_def_label(mdbcomp__rtti_access__encode_short_2_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_GE(MR_r1,128)) {
		MR_GOTO_LAB(mdbcomp__rtti_access__encode_short_2_0_i1);
	}
	...
	MR_r1 = MR_TRUE;
	MR_proceed();
MR_def_label(mdbcomp__rtti_access__encode_short_2_0,1)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_succip_word = MR_sv(2);
	MR_decr_sp(2);
	MR_r1 = MR_FALSE;
...
MR_BEGIN_MODULE(mdbcomp__rtti_access_module39)
	MR_init_entry1(mdbcomp__rtti_access__encode_short_det_2_0);
	MR_INIT_PROC_LAYOUT_ADDR(mercury__mdbcomp__rtti_access__encode_short_det_2_0);
	MR_init_label2(mdbcomp__rtti_access__encode_short_det_2_0,3,2)
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'encode_short_det'/2 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_define_entry(mercury__mdbcomp__rtti_access__encode_short_det_2_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(1);
	MR_sv(1) = (MR_Word) MR_succip;
	MR_np_call_localret_ent(mdbcomp__rtti_access__encode_short_2_0,
		mdbcomp__rtti_access__encode_short_det_2_0_i3);
MR_def_label(mdbcomp__rtti_access__encode_short_det_2_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(mdbcomp__rtti_access__encode_short_det_2_0_i2);
	}
	MR_r1 = MR_r2;
	MR_decr_sp_and_return(1);
MR_def_label(mdbcomp__rtti_access__encode_short_det_2_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_string_const("mdbcomp.rtti_access", 19);
	MR_r2 = (MR_Word) MR_string_const("predicate \140mdbcomp.rtti_access.encode_short_det\'/2", 50);
	MR_r3 = (MR_Word) MR_string_const("encode_short failed", 19);
...
MR_BEGIN_MODULE(mdbcomp__rtti_access_module40)
	MR_init_entry1(fn__mdbcomp__rtti_access__encode_short_func_1_0);
	MR_INIT_PROC_LAYOUT_ADDR(mercury__fn__mdbcomp__rtti_access__encode_short_func_1_0);
	MR_init_label2(fn__mdbcomp__rtti_access__encode_short_func_1_0,3,2)
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'encode_short_func'/2 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_define_entry(mercury__fn__mdbcomp__rtti_access__encode_short_func_1_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(1);
	MR_sv(1) = (MR_Word) MR_succip;
	MR_np_call_localret_ent(mdbcomp__rtti_access__encode_short_2_0,
		fn__mdbcomp__rtti_access__encode_short_func_1_0_i3);
MR_def_label(fn__mdbcomp__rtti_access__encode_short_func_1_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(fn__mdbcomp__rtti_access__encode_short_func_1_0_i2);
	}
	MR_r1 = MR_r2;
	MR_decr_sp_and_return(1);
MR_def_label(fn__mdbcomp__rtti_access__encode_short_func_1_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_string_const("mdbcomp.rtti_access", 19);
	MR_r2 = (MR_Word) MR_string_const("predicate \140mdbcomp.rtti_access.encode_short_det\'/2", 50);
	MR_r3 = (MR_Word) MR_string_const("encode_short failed", 19);
...
MR_BEGIN_MODULE(mdbcomp__rtti_access_module41)
	MR_init_entry1(mdbcomp__rtti_access__encode_int32_2_0);
	MR_INIT_PROC_LAYOUT_ADDR(mercury__mdbcomp__rtti_access__encode_int32_2_0);
	MR_init_label4(mdbcomp__rtti_access__encode_int32_2_0,3,5,7,1)
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'encode_int32'/2 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_define_entry(mercury__mdbcomp__rtti_access__encode_int32_2_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(2);
	MR_sv(2) = (MR_Word) MR_succip;
	if (MR_INT_LT(MR_r1,0)) {
		MR_GOTO_LAB(mdbcomp__rtti_access__encode_int32_2_0_i1);
	}
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 2);
	...
	MR_np_call_localret_ent(fn__f_105_110_116_95_95_47_2_0,
		mdbcomp__rtti_access__encode_int32_2_0_i3);
MR_def_label(mdbcomp__rtti_access__encode_int32_2_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 2);
	...
	MR_np_call_localret_ent(fn__f_105_110_116_95_95_47_2_0,
		mdbcomp__rtti_access__encode_int32_2_0_i5);
MR_def_label(mdbcomp__rtti_access__encode_int32_2_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 2);
	...
	MR_np_call_localret_ent(fn__f_105_110_116_95_95_47_2_0,
		mdbcomp__rtti_access__encode_int32_2_0_i7);
MR_def_label(mdbcomp__rtti_access__encode_int32_2_0,7)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_GE(MR_r1,128)) {
		MR_GOTO_LAB(mdbcomp__rtti_access__encode_int32_2_0_i1);
	}
	...
	MR_r1 = MR_TRUE;
	MR_proceed();
MR_def_label(mdbcomp__rtti_access__encode_int32_2_0,1)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_succip_word = MR_sv(2);
	MR_decr_sp(2);
	MR_r1 = MR_FALSE;
...
MR_BEGIN_MODULE(mdbcomp__rtti_access_module42)
	MR_init_entry1(mdbcomp__rtti_access__encode_int32_det_2_0);
	MR_INIT_PROC_LAYOUT_ADDR(mercury__mdbcomp__rtti_access__encode_int32_det_2_0);
	MR_init_label2(mdbcomp__rtti_access__encode_int32_det_2_0,3,2)
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'encode_int32_det'/2 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_define_entry(mercury__mdbcomp__rtti_access__encode_int32_det_2_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(1);
	MR_sv(1) = (MR_Word) MR_succip;
	MR_np_call_localret_ent(mdbcomp__rtti_access__encode_int32_2_0,
		mdbcomp__rtti_access__encode_int32_det_2_0_i3);
MR_def_label(mdbcomp__rtti_access__encode_int32_det_2_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(mdbcomp__rtti_access__encode_int32_det_2_0_i2);
	}
	MR_r1 = MR_r2;
	MR_decr_sp_and_return(1);
MR_def_label(mdbcomp__rtti_access__encode_int32_det_2_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_string_const("mdbcomp.rtti_access", 19);
	MR_r2 = (MR_Word) MR_string_const("predicate \140mdbcomp.rtti_access.encode_int32_det\'/2", 50);
	MR_r3 = (MR_Word) MR_string_const("encode_int32 failed", 19);
	MR_succip_word = MR_sv(1);
	MR_decr_sp(1);
	MR_np_tailcall_ent(require__unexpected_3_0);
#ifdef MR_maybe_local_thread_engine_base
...
MR_BEGIN_MODULE(mdbcomp__rtti_access_module43)
	MR_init_entry1(fn__mdbcomp__rtti_access__encode_int32_func_1_0);
	MR_INIT_PROC_LAYOUT_ADDR(mercury__fn__mdbcomp__rtti_access__encode_int32_func_1_0);
	MR_init_label2(fn__mdbcomp__rtti_access__encode_int32_func_1_0,3,2)
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'encode_int32_func'/2 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_define_entry(mercury__fn__mdbcomp__rtti_access__encode_int32_func_1_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(1);
	MR_sv(1) = (MR_Word) MR_succip;
	MR_np_call_localret_ent(mdbcomp__rtti_access__encode_int32_2_0,
		fn__mdbcomp__rtti_access__encode_int32_func_1_0_i3);
MR_def_label(fn__mdbcomp__rtti_access__encode_int32_func_1_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(fn__mdbcomp__rtti_access__encode_int32_func_1_0_i2);
	}
	MR_r1 = MR_r2;
	MR_decr_sp_and_return(1);
MR_def_label(fn__mdbcomp__rtti_access__encode_int32_func_1_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_string_const("mdbcomp.rtti_access", 19);
	MR_r2 = (MR_Word) MR_string_const("predicate \140mdbcomp.rtti_access.encode_int32_det\'/2", 50);
	MR_r3 = (MR_Word) MR_string_const("encode_int32 failed", 19);
...
MR_BEGIN_MODULE(mdbcomp__rtti_access_module44)
	MR_init_entry1(mdbcomp__rtti_access__encode_num_2_3_0);
	MR_INIT_PROC_LAYOUT_ADDR(mercury__mdbcomp__rtti_access__encode_num_2_3_0);
	MR_init_label3(mdbcomp__rtti_access__encode_num_2_3_0,12,2,4)
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'encode_num_2'/3 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(mdbcomp__rtti_access__encode_num_2_3_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(3);
	MR_sv(3) = (MR_Word) MR_succip;
MR_def_label(mdbcomp__rtti_access__encode_num_2_3_0,12)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(mdbcomp__rtti_access__encode_num_2_3_0_i2);
	}
	MR_r1 = MR_r2;
	MR_decr_sp_and_return(3);
MR_def_label(mdbcomp__rtti_access__encode_num_2_3_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(1) = MR_r2;
	MR_sv(2) = (((MR_Integer) MR_r1 & (MR_Integer) 127) | (MR_Integer) 128);
	MR_r2 = (MR_Integer) 128;
	MR_np_call_localret_ent(fn__f_105_110_116_95_95_47_2_0,
		mdbcomp__rtti_access__encode_num_2_3_0_i4);
MR_def_label(mdbcomp__rtti_access__encode_num_2_3_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_tag_alloc_heap(MR_r2, 1, (MR_Integer) 2);
	MR_tfield(1, MR_r2, 0) = MR_sv(2);
	MR_tfield(1, MR_r2, 1) = MR_sv(1);
	MR_succip_word = MR_sv(3);
	MR_GOTO_LAB(mdbcomp__rtti_access__encode_num_2_3_0_i12);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_thread_engine_base
#endif
...
MR_BEGIN_MODULE(mdbcomp__rtti_access_module45)
	MR_init_entry1(mdbcomp__rtti_access__encode_num_2_0);
	MR_INIT_PROC_LAYOUT_ADDR(mercury__mdbcomp__rtti_access__encode_num_2_0);
	MR_init_label3(mdbcomp__rtti_access__encode_num_2_0,2,4,1)
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'encode_num'/2 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_define_entry(mercury__mdbcomp__rtti_access__encode_num_2_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_LT(MR_r1,0)) {
		MR_GOTO_LAB(mdbcomp__rtti_access__encode_num_2_0_i1);
	}
	MR_incr_sp(2);
	MR_sv(2) = (MR_Word) MR_succip;
	MR_sv(1) = ((MR_Integer) MR_r1 & (MR_Integer) 127);
	MR_r2 = (MR_Integer) 128;
	MR_np_call_localret_ent(fn__f_105_110_116_95_95_47_2_0,
		mdbcomp__rtti_access__encode_num_2_0_i2);
MR_def_label(mdbcomp__rtti_access__encode_num_2_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_tag_alloc_heap(MR_r2, 1, (MR_Integer) 2);
	MR_tfield(1, MR_r2, 0) = MR_sv(1);
	MR_tfield(1, MR_r2, 1) = (MR_Word) MR_tbmkword(0, 0);
	MR_np_call_localret_ent(mdbcomp__rtti_access__encode_num_2_3_0,
		mdbcomp__rtti_access__encode_num_2_0_i4);
MR_def_label(mdbcomp__rtti_access__encode_num_2_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_r1;
	MR_r1 = MR_TRUE;
	MR_decr_sp_and_return(2);
MR_def_label(mdbcomp__rtti_access__encode_num_2_0,1)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_FALSE;
	MR_proceed();
#ifdef MR_maybe_local_thread_engine_base
...
MR_BEGIN_MODULE(mdbcomp__rtti_access_module46)
	MR_init_entry1(mdbcomp__rtti_access__encode_num_det_2_0);
	MR_INIT_PROC_LAYOUT_ADDR(mercury__mdbcomp__rtti_access__encode_num_det_2_0);
	MR_init_label2(mdbcomp__rtti_access__encode_num_det_2_0,3,2)
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'encode_num_det'/2 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_define_entry(mercury__mdbcomp__rtti_access__encode_num_det_2_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(1);
	MR_sv(1) = (MR_Word) MR_succip;
	MR_np_call_localret_ent(mdbcomp__rtti_access__encode_num_2_0,
		mdbcomp__rtti_access__encode_num_det_2_0_i3);
MR_def_label(mdbcomp__rtti_access__encode_num_det_2_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(mdbcomp__rtti_access__encode_num_det_2_0_i2);
	}
	MR_r1 = MR_r2;
	MR_decr_sp_and_return(1);
MR_def_label(mdbcomp__rtti_access__encode_num_det_2_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_string_const("mdbcomp.rtti_access", 19);
	MR_r2 = (MR_Word) MR_string_const("predicate \140mdbcomp.rtti_access.encode_num_det\'/2", 48);
	MR_r3 = (MR_Word) MR_string_const("encode_num failed", 17);
	MR_succip_word = MR_sv(1);
	MR_decr_sp(1);
	MR_np_tailcall_ent(require__unexpected_3_0);
#ifdef MR_maybe_local_thread_engine_base
...
MR_BEGIN_MODULE(mdbcomp__rtti_access_module47)
	MR_init_entry1(fn__mdbcomp__rtti_access__encode_num_func_1_0);
	MR_INIT_PROC_LAYOUT_ADDR(mercury__fn__mdbcomp__rtti_access__encode_num_func_1_0);
	MR_init_label2(fn__mdbcomp__rtti_access__encode_num_func_1_0,3,2)
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'encode_num_func'/2 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_define_entry(mercury__fn__mdbcomp__rtti_access__encode_num_func_1_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(1);
	MR_sv(1) = (MR_Word) MR_succip;
	MR_np_call_localret_ent(mdbcomp__rtti_access__encode_num_2_0,
		fn__mdbcomp__rtti_access__encode_num_func_1_0_i3);
MR_def_label(fn__mdbcomp__rtti_access__encode_num_func_1_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(fn__mdbcomp__rtti_access__encode_num_func_1_0_i2);
	}
	MR_r1 = MR_r2;
	MR_decr_sp_and_return(1);
MR_def_label(fn__mdbcomp__rtti_access__encode_num_func_1_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_string_const("mdbcomp.rtti_access", 19);
	MR_r2 = (MR_Word) MR_string_const("predicate \140mdbcomp.rtti_access.encode_num_det\'/2", 48);
	MR_r3 = (MR_Word) MR_string_const("encode_num failed", 17);
...
MR_BEGIN_MODULE(mdbcomp__rtti_access_module48)
	MR_init_entry1(mdbcomp__rtti_access__encode_len_string_2_0);
	MR_INIT_PROC_LAYOUT_ADDR(mercury__mdbcomp__rtti_access__encode_len_string_2_0);
	MR_init_label6(mdbcomp__rtti_access__encode_len_string_2_0,2,5,4,8,9,11)
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'encode_len_string'/2 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_define_entry(mercury__mdbcomp__rtti_access__encode_len_string_2_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(3);
	MR_sv(3) = (MR_Word) MR_succip;
	MR_sv(1) = MR_r1;
	MR_np_call_localret_ent(string__length_2_0,
		mdbcomp__rtti_access__encode_len_string_2_0_i2);
MR_def_label(mdbcomp__rtti_access__encode_len_string_2_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_np_call_localret_ent(mdbcomp__rtti_access__encode_num_2_0,
		mdbcomp__rtti_access__encode_len_string_2_0_i5);
MR_def_label(mdbcomp__rtti_access__encode_len_string_2_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(mdbcomp__rtti_access__encode_len_string_2_0_i4);
	}
	MR_r1 = MR_sv(1);
	MR_sv(1) = MR_r2;
	MR_np_call_localret_ent(string__to_char_list_2_0,
		mdbcomp__rtti_access__encode_len_string_2_0_i9);
MR_def_label(mdbcomp__rtti_access__encode_len_string_2_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_string_const("mdbcomp.rtti_access", 19);
	MR_r2 = (MR_Word) MR_string_const("predicate \140mdbcomp.rtti_access.encode_num_det\'/2", 48);
	MR_r3 = (MR_Word) MR_string_const("encode_num failed", 17);
	MR_np_call_localret_ent(require__unexpected_3_0,
		mdbcomp__rtti_access__encode_len_string_2_0_i8);
MR_def_label(mdbcomp__rtti_access__encode_len_string_2_0,8)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_np_call_localret_ent(string__to_char_list_2_0,
		mdbcomp__rtti_access__encode_len_string_2_0_i9);
MR_def_label(mdbcomp__rtti_access__encode_len_string_2_0,9)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	...
	MR_np_call_localret_ent(fn__list__map_2_0,
		mdbcomp__rtti_access__encode_len_string_2_0_i11);
MR_def_label(mdbcomp__rtti_access__encode_len_string_2_0,11)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
...
MR_BEGIN_MODULE(mdbcomp__rtti_access_module49)
	MR_init_entry1(fn__mdbcomp__rtti_access__encode_len_string_func_1_0);
	MR_INIT_PROC_LAYOUT_ADDR(mercury__fn__mdbcomp__rtti_access__encode_len_string_func_1_0);
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'encode_len_string_func'/2 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_define_entry(mercury__fn__mdbcomp__rtti_access__encode_len_string_func_1_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_np_tailcall_ent(mdbcomp__rtti_access__encode_len_string_2_0);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_thread_engine_base
#endif
...
MR_BEGIN_MODULE(mdbcomp__rtti_access_module50)
...
MR_BEGIN_MODULE(mdbcomp__rtti_access_module51)
...
MR_BEGIN_MODULE(mdbcomp__rtti_access_module52)
...
MR_BEGIN_MODULE(mdbcomp__rtti_access_module53)
...
MR_BEGIN_MODULE(mdbcomp__rtti_access_module54)
...
MR_BEGIN_MODULE(mdbcomp__rtti_access_module55)
...
MR_BEGIN_MODULE(mdbcomp__rtti_access_module56)
	MR_init_entry1(__Unify___mdbcomp__rtti_access__module_layout_0_0);
	MR_INIT_PROC_LAYOUT_ADDR(mercury____Unify___mdbcomp__rtti_access__module_layout_0_0);
MR_BEGIN_CODE
...
/* code for '__Unify__'/2 mode 0 */
	...
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_define_entry(mercury____Unify___mdbcomp__rtti_access__module_layout_0_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_np_tailcall_ent(__Unify___builtin__c_pointer_0_0);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
...
MR_BEGIN_MODULE(mdbcomp__rtti_access_module57)
	MR_init_entry1(__Compare___mdbcomp__rtti_access__module_layout_0_0);
	MR_INIT_PROC_LAYOUT_ADDR(mercury____Compare___mdbcomp__rtti_access__module_layout_0_0);
MR_BEGIN_CODE
...
/* code for '__Compare__'/3 mode 0 */
	...
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_define_entry(mercury____Compare___mdbcomp__rtti_access__module_layout_0_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_np_tailcall_ent(__Compare___builtin__c_pointer_0_0);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
...
MR_BEGIN_MODULE(mdbcomp__rtti_access_module58)
...
MR_BEGIN_MODULE(mdbcomp__rtti_access_module59)
...
MR_BEGIN_MODULE(mdbcomp__rtti_access_module60)
...
MR_BEGIN_MODULE(mdbcomp__rtti_access_module61)
...
MR_BEGIN_MODULE(mdbcomp__rtti_access_module62)
...
MR_BEGIN_MODULE(mdbcomp__rtti_access_module63)
...
MR_BEGIN_MODULE(mdbcomp__rtti_access_module64)
...
#line 792 "rtti_access.m"
    ...
    StringTableChars = (MR_ConstString) buf;
;}
#line 3742 "mdbcomp.rtti_access.c"
	MR_r1 = (MR_Word) StringTableChars;
#undef	MR_PROC_LABEL
	}
	MR_proceed();
...
static void mercury__mdbcomp__rtti_access_maybe_bunch_1(void)
{
	...
	mdbcomp__rtti_access_module50();
	mdbcomp__rtti_access_module51();
	mdbcomp__rtti_access_module52();
	mdbcomp__rtti_access_module53();
	mdbcomp__rtti_access_module54();
	mdbcomp__rtti_access_module55();
	mdbcomp__rtti_access_module56();
	mdbcomp__rtti_access_module57();
	mdbcomp__rtti_access_module58();
	mdbcomp__rtti_access_module59();
	mdbcomp__rtti_access_module60();
	mdbcomp__rtti_access_module61();
	mdbcomp__rtti_access_module62();
	mdbcomp__rtti_access_module63();
	mdbcomp__rtti_access_module64();
}
...
void mercury__mdbcomp__rtti_access__init(void)
{
	...
	MR_INIT_TYPE_CTOR_INFO(
		mercury_data_mdbcomp__rtti_access__type_ctor_info_module_layout_0,
		mdbcomp__rtti_access__module_layout_0_0);
	MR_INIT_TYPE_CTOR_INFO(
		mercury_data_mdbcomp__rtti_access__type_ctor_info_proc_layout_0,
...
void mercury__mdbcomp__rtti_access__write_out_proc_statics(FILE *deep_fp, FILE *procrep_fp)
{
	MR_write_out_module_proc_reps_start(procrep_fp, &mercury_data__module_layout__mdbcomp__rtti_access);
