      ...
      {
        {
          ...
          MR_hl_field(MR_mktag(1), BytesPrime_5, 1) = ((MR_Box) ((MR_Unsigned) 0U));
        }
        succeeded = MR_TRUE;
      }
    }
...
{
  {
    ...
    {
      MR_Unsigned packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), HeadVar__1_1, (MR_Integer) 1)));
...
#undef MR_PROC_LABEL
	 ...
	 ModeNum_10  = ModeNum;
      ...
      SymTypeModule_16 = mdbcomp__sym_name__string_to_sym_name_1_f_0(TypeModule_6);
      {
        ...
        MR_hl_field(MR_mktag(1), ProcLabel_4, 1) = (MR_Box) ((MR_Unsigned) (SpecialId_14));
...
#undef MR_PROC_LABEL
	 ...
	 ModeNum_25  = ModeNum;
      ...
      SymDeclModule_20 = mdbcomp__sym_name__string_to_sym_name_1_f_0(DeclModule_18);
      {
        ...
        MR_hl_field(MR_mktag(0), ProcLabel_4, 1) = (MR_Box) ((MR_Unsigned) (PredOrFunc_17));
