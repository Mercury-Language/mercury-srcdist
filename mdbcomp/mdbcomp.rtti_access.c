...
{
  {
    ...
    if (mdbcomp__rtti_access__succeeded)
      *mdbcomp__rtti_access__HeadVar__1_1 = (MR_Integer) 0;
      ...
      {
        MR_Box mdbcomp__rtti_access__Var_4 = ((MR_Box) (MR_hl_field(MR_mktag(0), mdbcomp__rtti_access__HeadVar__2_2, (MR_Integer) 0)));
        MR_Integer mdbcomp__rtti_access__Var_5 = ((MR_Integer) (MR_hl_field(MR_mktag(0), mdbcomp__rtti_access__HeadVar__2_2, (MR_Integer) 1)));
        MR_Box mdbcomp__rtti_access__Var_6 = ((MR_Box) (MR_hl_field(MR_mktag(0), mdbcomp__rtti_access__HeadVar__3_3, (MR_Integer) 0)));
        MR_Integer mdbcomp__rtti_access__Var_7 = ((MR_Integer) (MR_hl_field(MR_mktag(0), mdbcomp__rtti_access__HeadVar__3_3, (MR_Integer) 1)));
        MR_Word mdbcomp__rtti_access__Var_8;
        MR_Word mdbcomp__rtti_access__Cast_HeadVar1_13 = (MR_Word) mdbcomp__rtti_access__Var_4;
        MR_Word mdbcomp__rtti_access__Cast_HeadVar2_14 = (MR_Word) mdbcomp__rtti_access__Var_6;
        ...
        if (mdbcomp__rtti_access__succeeded)
          *mdbcomp__rtti_access__HeadVar__1_1 = mdbcomp__rtti_access__Var_8;
          ...
          {
            mercury__private_builtin__builtin_compare_int_3_p_0(mdbcomp__rtti_access__HeadVar__1_1, mdbcomp__rtti_access__Var_5, mdbcomp__rtti_access__Var_7);
          }
      }
  }
}
...
{
  {
    ...
    if (mdbcomp__rtti_access__succeeded)
      ...
      {
        MR_Box mdbcomp__rtti_access__Var_3 = ((MR_Box) (MR_hl_field(MR_mktag(0), mdbcomp__rtti_access__HeadVar__1_1, (MR_Integer) 0)));
        MR_Integer mdbcomp__rtti_access__Var_4 = ((MR_Integer) (MR_hl_field(MR_mktag(0), mdbcomp__rtti_access__HeadVar__1_1, (MR_Integer) 1)));
        MR_Box mdbcomp__rtti_access__Var_5 = ((MR_Box) (MR_hl_field(MR_mktag(0), mdbcomp__rtti_access__HeadVar__2_2, (MR_Integer) 0)));
        MR_Integer mdbcomp__rtti_access__Var_6 = ((MR_Integer) (MR_hl_field(MR_mktag(0), mdbcomp__rtti_access__HeadVar__2_2, (MR_Integer) 1)));
        MR_Word mdbcomp__rtti_access__Cast_HeadVar1_9 = (MR_Word) mdbcomp__rtti_access__Var_3;
        MR_Word mdbcomp__rtti_access__Cast_HeadVar2_10 = (MR_Word) mdbcomp__rtti_access__Var_5;
        ...
        if (mdbcomp__rtti_access__succeeded)
          mdbcomp__rtti_access__succeeded = (mdbcomp__rtti_access__Var_4 == mdbcomp__rtti_access__Var_6);
      }
    return mdbcomp__rtti_access__succeeded;
  }
}
