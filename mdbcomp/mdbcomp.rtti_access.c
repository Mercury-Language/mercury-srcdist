...
{
  {
    ...
    if (mdbcomp__rtti_access__succeeded)
      *mdbcomp__rtti_access__HeadVar__1_1 = (MR_Integer) 0;
      ...
      {
        MR_Box mdbcomp__rtti_access__ArgX1_4 = ((MR_Box) (MR_hl_field(MR_mktag(0), mdbcomp__rtti_access__HeadVar__2_2, (MR_Integer) 0)));
        MR_Box mdbcomp__rtti_access__ArgY1_5 = ((MR_Box) (MR_hl_field(MR_mktag(0), mdbcomp__rtti_access__HeadVar__3_3, (MR_Integer) 0)));
        MR_Integer mdbcomp__rtti_access__ArgX2_6 = ((MR_Integer) (MR_hl_field(MR_mktag(0), mdbcomp__rtti_access__HeadVar__2_2, (MR_Integer) 1)));
        MR_Integer mdbcomp__rtti_access__ArgY2_7 = ((MR_Integer) (MR_hl_field(MR_mktag(0), mdbcomp__rtti_access__HeadVar__3_3, (MR_Integer) 1)));
        MR_Word mdbcomp__rtti_access__Var_8;
        MR_Word mdbcomp__rtti_access__Cast_HeadVar1_13 = (MR_Word) mdbcomp__rtti_access__ArgX1_4;
        MR_Word mdbcomp__rtti_access__Cast_HeadVar2_14 = (MR_Word) mdbcomp__rtti_access__ArgY1_5;

        {
          mercury__builtin____Compare____c_pointer_0_0(&mdbcomp__rtti_access__Var_8, mdbcomp__rtti_access__Cast_HeadVar1_13, mdbcomp__rtti_access__Cast_HeadVar2_14);
        }
        mdbcomp__rtti_access__succeeded = (mdbcomp__rtti_access__Var_8 == (MR_Integer) 0);
        mdbcomp__rtti_access__succeeded = !(mdbcomp__rtti_access__succeeded);
        if (mdbcomp__rtti_access__succeeded)
          *mdbcomp__rtti_access__HeadVar__1_1 = mdbcomp__rtti_access__Var_8;
        else
          {
            mercury__private_builtin__builtin_compare_int_3_p_0(mdbcomp__rtti_access__HeadVar__1_1, mdbcomp__rtti_access__ArgX2_6, mdbcomp__rtti_access__ArgY2_7);
          }
      }
  }
}
...
{
  {
    ...
    if (mdbcomp__rtti_access__succeeded)
      ...
      {
        MR_Box mdbcomp__rtti_access__ArgX1_3 = ((MR_Box) (MR_hl_field(MR_mktag(0), mdbcomp__rtti_access__HeadVar__1_1, (MR_Integer) 0)));
        MR_Box mdbcomp__rtti_access__ArgY1_4 = ((MR_Box) (MR_hl_field(MR_mktag(0), mdbcomp__rtti_access__HeadVar__2_2, (MR_Integer) 0)));
        MR_Integer mdbcomp__rtti_access__ArgX2_5 = ((MR_Integer) (MR_hl_field(MR_mktag(0), mdbcomp__rtti_access__HeadVar__1_1, (MR_Integer) 1)));
        MR_Integer mdbcomp__rtti_access__ArgY2_6 = ((MR_Integer) (MR_hl_field(MR_mktag(0), mdbcomp__rtti_access__HeadVar__2_2, (MR_Integer) 1)));
        MR_Word mdbcomp__rtti_access__Cast_HeadVar1_9 = (MR_Word) mdbcomp__rtti_access__ArgX1_3;
        MR_Word mdbcomp__rtti_access__Cast_HeadVar2_10 = (MR_Word) mdbcomp__rtti_access__ArgY1_4;
        ...
        if (mdbcomp__rtti_access__succeeded)
          mdbcomp__rtti_access__succeeded = (mdbcomp__rtti_access__ArgX2_5 == mdbcomp__rtti_access__ArgY2_6);
      }
    return mdbcomp__rtti_access__succeeded;
  }
}
...
{
  {
    ...
    MR_Integer mdbcomp__rtti_access__Var_8;
    MR_Integer mdbcomp__rtti_access__Var_9;
    MR_Word mdbcomp__rtti_access__Var_10;
    MR_Word mdbcomp__rtti_access__Var_11;

    if (mdbcomp__rtti_access__succeeded)
      {
        mdbcomp__rtti_access__Var_8 = (MR_Integer) 127;
        mdbcomp__rtti_access__LastByte_5 = (mdbcomp__rtti_access__Num_3 & mdbcomp__rtti_access__Var_8);
        mdbcomp__rtti_access__Var_9 = (MR_Integer) 128;
        {
          mdbcomp__rtti_access__NextNum_6 = mercury__int__f_slash_2_f_0(mdbcomp__rtti_access__Num_3, mdbcomp__rtti_access__Var_9);
        }
        mdbcomp__rtti_access__Var_11 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
        {
          mdbcomp__rtti_access__Var_10 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), mdbcomp__rtti_access__Var_10, 0) = ((MR_Box) (mdbcomp__rtti_access__LastByte_5));
          MR_hl_field(MR_mktag(1), mdbcomp__rtti_access__Var_10, 1) = ((MR_Box) (mdbcomp__rtti_access__Var_11));
        }
        {
          mdbcomp__rtti_access__encode_num_2_3_p_0(mdbcomp__rtti_access__NextNum_6, mdbcomp__rtti_access__Var_10, mdbcomp__rtti_access__Bytes_4);
        }
        mdbcomp__rtti_access__succeeded = MR_TRUE;
      }
    return mdbcomp__rtti_access__succeeded;
        ...
        if (mdbcomp__rtti_access__succeeded)
          *mdbcomp__rtti_access__Bytes_6 = mdbcomp__rtti_access__RestBytes_5;
        else
          {
            ...
            MR_Integer mdbcomp__rtti_access__Var_9 = (mdbcomp__rtti_access__Num_4 & (MR_Integer) 127);
            MR_Word mdbcomp__rtti_access__Var_13;

            mdbcomp__rtti_access__CurByte_7 = (mdbcomp__rtti_access__Var_9 | (MR_Integer) 128);
            {
              mdbcomp__rtti_access__NextNum_8 = mercury__int__f_slash_2_f_0(mdbcomp__rtti_access__Num_4, (MR_Integer) 128);
            }
            {
              mdbcomp__rtti_access__Var_13 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), mdbcomp__rtti_access__Var_13, 0) = ((MR_Box) (mdbcomp__rtti_access__CurByte_7));
              MR_hl_field(MR_mktag(1), mdbcomp__rtti_access__Var_13, 1) = ((MR_Box) (mdbcomp__rtti_access__RestBytes_5));
            }
            /* direct tailcall eliminated */
            {
              MR_Integer mdbcomp__rtti_access__next_value_of_Num_4 = mdbcomp__rtti_access__NextNum_8;
              MR_Word mdbcomp__rtti_access__next_value_of_RestBytes_5 = mdbcomp__rtti_access__Var_13;

              mdbcomp__rtti_access__RestBytes_5 = mdbcomp__rtti_access__next_value_of_RestBytes_5;
              mdbcomp__rtti_access__Num_4 = mdbcomp__rtti_access__next_value_of_Num_4;
            }
            continue;
          }
      }
...
{
  {
    ...
    MR_Word mdbcomp__rtti_access__Var_10;
    MR_Word mdbcomp__rtti_access__Var_11;
    MR_Word mdbcomp__rtti_access__Var_12;
    MR_Integer mdbcomp__rtti_access__Var_15;
    MR_Integer mdbcomp__rtti_access__Var_16;
    MR_Integer mdbcomp__rtti_access__Var_17;
    MR_Integer mdbcomp__rtti_access__Var_18;
    MR_Integer mdbcomp__rtti_access__Var_19;
    MR_Integer mdbcomp__rtti_access__Var_20;
    MR_Integer mdbcomp__rtti_access__Var_21;

    if (mdbcomp__rtti_access__succeeded)
      {
        mdbcomp__rtti_access__Var_15 = (MR_Integer) 255;
        mdbcomp__rtti_access__Byte4_7 = (mdbcomp__rtti_access__Int32_3 & mdbcomp__rtti_access__Var_15);
        mdbcomp__rtti_access__Var_16 = (MR_Integer) 256;
        {
          mdbcomp__rtti_access__Var_12 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), mdbcomp__rtti_access__Var_12, 0) = ((MR_Box) (mdbcomp__rtti_access__Byte4_7));
          MR_hl_field(MR_mktag(1), mdbcomp__rtti_access__Var_12, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
        }
        {
          mdbcomp__rtti_access__Bytes123_8 = mercury__int__f_slash_2_f_0(mdbcomp__rtti_access__Int32_3, mdbcomp__rtti_access__Var_16);
        }
        mdbcomp__rtti_access__Var_17 = (MR_Integer) 255;
        mdbcomp__rtti_access__Byte3_6 = (mdbcomp__rtti_access__Bytes123_8 & mdbcomp__rtti_access__Var_17);
        mdbcomp__rtti_access__Var_18 = (MR_Integer) 256;
        {
          mdbcomp__rtti_access__Var_11 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), mdbcomp__rtti_access__Var_11, 0) = ((MR_Box) (mdbcomp__rtti_access__Byte3_6));
          MR_hl_field(MR_mktag(1), mdbcomp__rtti_access__Var_11, 1) = ((MR_Box) (mdbcomp__rtti_access__Var_12));
        }
        {
          mdbcomp__rtti_access__Bytes12_9 = mercury__int__f_slash_2_f_0(mdbcomp__rtti_access__Bytes123_8, mdbcomp__rtti_access__Var_18);
        }
        mdbcomp__rtti_access__Var_19 = (MR_Integer) 255;
        mdbcomp__rtti_access__Byte2_5 = (mdbcomp__rtti_access__Bytes12_9 & mdbcomp__rtti_access__Var_19);
        mdbcomp__rtti_access__Var_20 = (MR_Integer) 256;
        {
          mdbcomp__rtti_access__Var_10 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), mdbcomp__rtti_access__Var_10, 0) = ((MR_Box) (mdbcomp__rtti_access__Byte2_5));
          MR_hl_field(MR_mktag(1), mdbcomp__rtti_access__Var_10, 1) = ((MR_Box) (mdbcomp__rtti_access__Var_11));
        }
        {
          mdbcomp__rtti_access__Byte1_4 = mercury__int__f_slash_2_f_0(mdbcomp__rtti_access__Bytes12_9, mdbcomp__rtti_access__Var_20);
        }
        mdbcomp__rtti_access__Var_21 = (MR_Integer) 128;
        mdbcomp__rtti_access__succeeded = (mdbcomp__rtti_access__Byte1_4 < mdbcomp__rtti_access__Var_21);
        if (mdbcomp__rtti_access__succeeded)
          {
            {
              MR_Word base;
              ...
              *mdbcomp__rtti_access__HeadVar__2_2 = base;
              ...
              MR_hl_field(MR_mktag(1), base, 1) = ((MR_Box) (mdbcomp__rtti_access__Var_10));
            }
            mdbcomp__rtti_access__succeeded = MR_TRUE;
          }
      }
...
{
  {
    ...
    MR_Integer mdbcomp__rtti_access__Byte1_4;
    MR_Integer mdbcomp__rtti_access__Byte2_5;
    MR_Word mdbcomp__rtti_access__Var_6;
    MR_Integer mdbcomp__rtti_access__Var_9;
    MR_Integer mdbcomp__rtti_access__Var_10;
    MR_Integer mdbcomp__rtti_access__Var_11;

    if (mdbcomp__rtti_access__succeeded)
      {
        mdbcomp__rtti_access__Var_9 = (MR_Integer) 255;
        mdbcomp__rtti_access__Byte2_5 = (mdbcomp__rtti_access__Short_3 & mdbcomp__rtti_access__Var_9);
        mdbcomp__rtti_access__Var_10 = (MR_Integer) 256;
        {
          mdbcomp__rtti_access__Var_6 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), mdbcomp__rtti_access__Var_6, 0) = ((MR_Box) (mdbcomp__rtti_access__Byte2_5));
          MR_hl_field(MR_mktag(1), mdbcomp__rtti_access__Var_6, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
        }
        {
          mdbcomp__rtti_access__Byte1_4 = mercury__int__f_slash_2_f_0(mdbcomp__rtti_access__Short_3, mdbcomp__rtti_access__Var_10);
        }
        mdbcomp__rtti_access__Var_11 = (MR_Integer) 128;
        mdbcomp__rtti_access__succeeded = (mdbcomp__rtti_access__Byte1_4 < mdbcomp__rtti_access__Var_11);
        if (mdbcomp__rtti_access__succeeded)
          {
            {
              MR_Word base;
              ...
              *mdbcomp__rtti_access__HeadVar__2_2 = base;
              MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (mdbcomp__rtti_access__Byte1_4));
              MR_hl_field(MR_mktag(1), base, 1) = ((MR_Box) (mdbcomp__rtti_access__Var_6));
            }
            mdbcomp__rtti_access__succeeded = MR_TRUE;
          }
      }
...
{
  {
    ...
    if (mdbcomp__rtti_access__succeeded)
      {
        mdbcomp__rtti_access__Var_11 = (MR_Integer) 128;
        mdbcomp__rtti_access__succeeded = (mdbcomp__rtti_access__Byte_3 < mdbcomp__rtti_access__Var_11);
        if (mdbcomp__rtti_access__succeeded)
          {
            {
  ...
  MR_Word * mdbcomp__rtti_access__HeadVar__2_2)
{
  {
    MR_bool mdbcomp__rtti_access__succeeded = (mdbcomp__rtti_access__Byte_3 >= (MR_Integer) 0);
    MR_Integer mdbcomp__rtti_access__Var_6;

    if (mdbcomp__rtti_access__succeeded)
      {
        mdbcomp__rtti_access__Var_6 = (MR_Integer) 128;
        mdbcomp__rtti_access__succeeded = (mdbcomp__rtti_access__Byte_3 < mdbcomp__rtti_access__Var_6);
        if (mdbcomp__rtti_access__succeeded)
          {
            {
              MR_Word base;
    ...
    if (mdbcomp__rtti_access__succeeded)
      {
        ...
        mdbcomp__rtti_access__Var_15 = (mdbcomp__rtti_access__STATE_VARIABLE_Pos_14_14 + mdbcomp__rtti_access__Size_8);
        mdbcomp__rtti_access__succeeded = (mdbcomp__rtti_access__Var_15 <= mdbcomp__rtti_access__NumBytes_10);
        if (mdbcomp__rtti_access__succeeded)
          {
{
...
{
  {
    ...
    if (mdbcomp__rtti_access__succeeded)
      {
        mdbcomp__rtti_access__Var_13 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
        {
          mdbcomp__rtti_access__succeeded = mdbcomp__rtti_access__read_len_string_2_6_p_0(mdbcomp__rtti_access__ByteCode_5, mdbcomp__rtti_access__Length_8, mdbcomp__rtti_access__Var_13, &mdbcomp__rtti_access__RevChars_9, mdbcomp__rtti_access__STATE_VARIABLE_Pos_12_12, mdbcomp__rtti_access__STATE_VARIABLE_Pos_11);
        }
        if (mdbcomp__rtti_access__succeeded)
          {
            {
      ...
      /* tailcall optimized into a loop */
      {
        ...
        if (mdbcomp__rtti_access__succeeded)
        ...
        else
          {
            ...
            MR_Integer mdbcomp__rtti_access__Var_20;
            MR_Integer mdbcomp__rtti_access__Var_23;
            ...
            MR_Integer mdbcomp__rtti_access__Var_31 = (mdbcomp__rtti_access__STATE_VARIABLE_Pos_0_15 + (MR_Integer) 1);

            mdbcomp__rtti_access__succeeded = (mdbcomp__rtti_access__Var_31 <= mdbcomp__rtti_access__Size_30);
            if (mdbcomp__rtti_access__succeeded)
              {
{
...
#undef MR_PROC_LABEL
	 ...
	 mdbcomp__rtti_access__STATE_VARIABLE_Pos_18_18  = Pos;
                ...
                if (mdbcomp__rtti_access__succeeded)
                  {
                    mdbcomp__rtti_access__Var_23 = (MR_Integer) 1;
                    mdbcomp__rtti_access__Var_20 = (mdbcomp__rtti_access__N_8 - mdbcomp__rtti_access__Var_23);
                    {
                    ...
                    /* direct tailcall eliminated */
                    {
                      MR_Integer mdbcomp__rtti_access__next_value_of_N_8 = mdbcomp__rtti_access__Var_20;
                      MR_Word mdbcomp__rtti_access__next_value_of_STATE_VARIABLE_RevChars_0_13 = mdbcomp__rtti_access__STATE_VARIABLE_RevChars_19_19;
                      MR_Integer mdbcomp__rtti_access__next_value_of_STATE_VARIABLE_Pos_0_15 = mdbcomp__rtti_access__STATE_VARIABLE_Pos_18_18;

                      mdbcomp__rtti_access__STATE_VARIABLE_Pos_0_15 = mdbcomp__rtti_access__next_value_of_STATE_VARIABLE_Pos_0_15;
                      mdbcomp__rtti_access__STATE_VARIABLE_RevChars_0_13 = mdbcomp__rtti_access__next_value_of_STATE_VARIABLE_RevChars_0_13;
                      mdbcomp__rtti_access__N_8 = mdbcomp__rtti_access__next_value_of_N_8;
                    }
                    continue;
                  }
              }
  ...
  while (MR_TRUE)
    {
      /* tailcall optimized into a loop */
      {
        ...
        MR_Integer mdbcomp__rtti_access__Var_27 = (mdbcomp__rtti_access__STATE_VARIABLE_Pos_0_13 + (MR_Integer) 1);

        mdbcomp__rtti_access__succeeded = (mdbcomp__rtti_access__Var_27 <= mdbcomp__rtti_access__Size_26);
        if (mdbcomp__rtti_access__succeeded)
          {
{
            ...
            if (mdbcomp__rtti_access__succeeded)
              {
                ...
                if (mdbcomp__rtti_access__succeeded)
                ...
                else
                  {
                    ...
                    /* direct tailcall eliminated */
                    {
                      MR_Word mdbcomp__rtti_access__next_value_of_STATE_VARIABLE_RevChars_0_11 = mdbcomp__rtti_access__STATE_VARIABLE_RevChars_17_17;
                      MR_Integer mdbcomp__rtti_access__next_value_of_STATE_VARIABLE_Pos_0_13 = mdbcomp__rtti_access__STATE_VARIABLE_Pos_15_15;

                      mdbcomp__rtti_access__STATE_VARIABLE_Pos_0_13 = mdbcomp__rtti_access__next_value_of_STATE_VARIABLE_Pos_0_13;
                      mdbcomp__rtti_access__STATE_VARIABLE_RevChars_0_11 = mdbcomp__rtti_access__next_value_of_STATE_VARIABLE_RevChars_0_11;
                    }
                    continue;
                  }
              }
...
{
  {
    ...
    MR_Integer mdbcomp__rtti_access__Var_21 = (mdbcomp__rtti_access__STATE_VARIABLE_Pos_0_11 + (MR_Integer) 4);
    MR_Box mdbcomp__rtti_access__StringTableChars_27;
    MR_Integer mdbcomp__rtti_access__Size_28;

    mdbcomp__rtti_access__succeeded = (mdbcomp__rtti_access__Var_21 <= mdbcomp__rtti_access__Size_20);
    if (mdbcomp__rtti_access__succeeded)
      {
{
  ...
  while (MR_TRUE)
    {
      /* tailcall optimized into a loop */
      {
        ...
        MR_Integer mdbcomp__rtti_access__Var_29 = (mdbcomp__rtti_access__STATE_VARIABLE_Pos_0_12 + (MR_Integer) 1);
        MR_Integer mdbcomp__rtti_access__Var_19;
        MR_Integer mdbcomp__rtti_access__Var_20;

        mdbcomp__rtti_access__succeeded = (mdbcomp__rtti_access__Var_29 <= mdbcomp__rtti_access__Size_28);
        if (mdbcomp__rtti_access__succeeded)
          {
{
...
#undef MR_PROC_LABEL
	 ...
	 mdbcomp__rtti_access__STATE_VARIABLE_Pos_14_14  = Pos;
            ...
            mdbcomp__rtti_access__Var_16 = (MR_Integer) 7;
            {
              mdbcomp__rtti_access__Var_15 = mercury__int__f_60_60_2_f_0(mdbcomp__rtti_access__Num0_7, mdbcomp__rtti_access__Var_16);
            }
            mdbcomp__rtti_access__Var_18 = (MR_Integer) 127;
            mdbcomp__rtti_access__Var_17 = (mdbcomp__rtti_access__Byte_10 & mdbcomp__rtti_access__Var_18);
            mdbcomp__rtti_access__Num1_11 = (mdbcomp__rtti_access__Var_15 | mdbcomp__rtti_access__Var_17);
            mdbcomp__rtti_access__Var_20 = (MR_Integer) 128;
            mdbcomp__rtti_access__Var_19 = (mdbcomp__rtti_access__Byte_10 & mdbcomp__rtti_access__Var_20);
            mdbcomp__rtti_access__succeeded = (mdbcomp__rtti_access__Var_19 == (MR_Integer) 0);
            if (mdbcomp__rtti_access__succeeded)
              {
            ...
            else
              {
                /* direct tailcall eliminated */
                {
                  MR_Integer mdbcomp__rtti_access__next_value_of_Num0_7 = mdbcomp__rtti_access__Num1_11;
                  MR_Integer mdbcomp__rtti_access__next_value_of_STATE_VARIABLE_Pos_0_12 = mdbcomp__rtti_access__STATE_VARIABLE_Pos_14_14;

                  mdbcomp__rtti_access__STATE_VARIABLE_Pos_0_12 = mdbcomp__rtti_access__next_value_of_STATE_VARIABLE_Pos_0_12;
                  mdbcomp__rtti_access__Num0_7 = mdbcomp__rtti_access__next_value_of_Num0_7;
                }
                continue;
              }
          }
...
{
  {
    ...
    MR_Integer mdbcomp__rtti_access__Var_12 = (mdbcomp__rtti_access__STATE_VARIABLE_Pos_0_10 + (MR_Integer) 4);

    mdbcomp__rtti_access__succeeded = (mdbcomp__rtti_access__Var_12 <= mdbcomp__rtti_access__Size_9);
    if (mdbcomp__rtti_access__succeeded)
      {
{
...
{
  {
    ...
    MR_Box mdbcomp__rtti_access__Bytes_8 = ((MR_Box) (MR_hl_field(MR_mktag(0), mdbcomp__rtti_access__ByteCode_5, (MR_Integer) 0)));
    MR_Integer mdbcomp__rtti_access__Size_9 = ((MR_Integer) (MR_hl_field(MR_mktag(0), mdbcomp__rtti_access__ByteCode_5, (MR_Integer) 1)));
    MR_Integer mdbcomp__rtti_access__Var_12 = (mdbcomp__rtti_access__STATE_VARIABLE_Pos_0_10 + (MR_Integer) 2);
...
{
  {
    ...
    MR_Box mdbcomp__rtti_access__Bytes_8 = ((MR_Box) (MR_hl_field(MR_mktag(0), mdbcomp__rtti_access__ByteCode_5, (MR_Integer) 0)));
    MR_Integer mdbcomp__rtti_access__Size_9 = ((MR_Integer) (MR_hl_field(MR_mktag(0), mdbcomp__rtti_access__ByteCode_5, (MR_Integer) 1)));
    MR_Integer mdbcomp__rtti_access__Var_12 = (mdbcomp__rtti_access__STATE_VARIABLE_Pos_0_10 + (MR_Integer) 1);
...
{
  {
    ...
    if (((MR_tag((MR_Word) mdbcomp__rtti_access__HeadVar__1_1)) == (MR_mktag((MR_Integer) 0))))
      {
        MR_Word mdbcomp__rtti_access__Var_3 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdbcomp__rtti_access__HeadVar__1_1, (MR_Integer) 0)));
        MR_Word mdbcomp__rtti_access__Var_4 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdbcomp__rtti_access__HeadVar__1_1, (MR_Integer) 1)));
        MR_Word mdbcomp__rtti_access__Var_5 = ((MR_Word) (MR_hl_field(MR_mktag(0), mdbcomp__rtti_access__HeadVar__1_1, (MR_Integer) 2)));
        MR_Integer mdbcomp__rtti_access__Var_7;
        MR_Integer mdbcomp__rtti_access__Var_8;

        mdbcomp__rtti_access__ProcName_2 = ((MR_String) (MR_hl_field(MR_mktag(0), mdbcomp__rtti_access__HeadVar__1_1, (MR_Integer) 3)));
        mdbcomp__rtti_access__Var_7 = ((MR_Integer) (MR_hl_field(MR_mktag(0), mdbcomp__rtti_access__HeadVar__1_1, (MR_Integer) 4)));
        mdbcomp__rtti_access__Var_8 = ((MR_Integer) (MR_hl_field(MR_mktag(0), mdbcomp__rtti_access__HeadVar__1_1, (MR_Integer) 5)));
      }
    else
      {
        MR_Word mdbcomp__rtti_access__Var_9 = ((MR_Word) (MR_hl_field(MR_mktag(1), mdbcomp__rtti_access__HeadVar__1_1, (MR_Integer) 0)));
        MR_Word mdbcomp__rtti_access__Var_10 = ((MR_Word) (MR_hl_field(MR_mktag(1), mdbcomp__rtti_access__HeadVar__1_1, (MR_Integer) 1)));
        MR_Word mdbcomp__rtti_access__Var_11 = ((MR_Word) (MR_hl_field(MR_mktag(1), mdbcomp__rtti_access__HeadVar__1_1, (MR_Integer) 2)));
        MR_Integer mdbcomp__rtti_access__Var_13;
        MR_Integer mdbcomp__rtti_access__Var_14;

        mdbcomp__rtti_access__ProcName_2 = ((MR_String) (MR_hl_field(MR_mktag(1), mdbcomp__rtti_access__HeadVar__1_1, (MR_Integer) 3)));
        mdbcomp__rtti_access__Var_13 = ((MR_Integer) (MR_hl_field(MR_mktag(1), mdbcomp__rtti_access__HeadVar__1_1, (MR_Integer) 4)));
        mdbcomp__rtti_access__Var_14 = ((MR_Integer) (MR_hl_field(MR_mktag(1), mdbcomp__rtti_access__HeadVar__1_1, (MR_Integer) 5)));
      }
    ...
    if (mdbcomp__rtti_access__succeeded)
      {
        ...
        MR_String mdbcomp__rtti_access__Var_12;
        MR_Integer mdbcomp__rtti_access__Var_13;
...
#undef MR_PROC_LABEL
	 ...
	 mdbcomp__rtti_access__ModeNum_10  = ModeNum;
        ...
        {
          mdbcomp__rtti_access__succeeded = mdbcomp__prim_data__special_pred_name_arity_4_p_2(&mdbcomp__rtti_access__SpecialIdPrime_11, &mdbcomp__rtti_access__Var_12, mdbcomp__rtti_access__PredName_8, &mdbcomp__rtti_access__Var_13);
        }
        if (mdbcomp__rtti_access__succeeded)
    ...
    else
      {
        ...
        MR_String mdbcomp__rtti_access__DefModule_23;
        MR_String mdbcomp__rtti_access__PredName_24;
        MR_Integer mdbcomp__rtti_access__ModeNum_25;
        MR_Word mdbcomp__rtti_access__SymDefModule_26;
...
#undef MR_PROC_LABEL
	 ...
	 mdbcomp__rtti_access__DefModule_23  = DefModule;
	 mdbcomp__rtti_access__PredName_24  = PredName;
	 mdbcomp__rtti_access__Arity_19  = Arity;
	 mdbcomp__rtti_access__ModeNum_25  = ModeNum;
}
        {
          mdbcomp__rtti_access__SymDefModule_26 = mdbcomp__sym_name__string_to_sym_name_1_f_0(mdbcomp__rtti_access__DefModule_23);
        }
        {
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(0), mdbcomp__rtti_access__ProcLabel_4, 0) = ((MR_Box) (mdbcomp__rtti_access__SymDefModule_26));
          ...
          MR_hl_field(MR_mktag(0), mdbcomp__rtti_access__ProcLabel_4, 3) = ((MR_Box) (mdbcomp__rtti_access__PredName_24));
          MR_hl_field(MR_mktag(0), mdbcomp__rtti_access__ProcLabel_4, 4) = ((MR_Box) (mdbcomp__rtti_access__Arity_19));
          MR_hl_field(MR_mktag(0), mdbcomp__rtti_access__ProcLabel_4, 5) = ((MR_Box) (mdbcomp__rtti_access__ModeNum_25));
        }
      }
