  ...
  MR_Integer * STATE_VARIABLE_Pos_14)
{
  while (MR_TRUE)
  {
    ...
    MR_Box Bytes_23 = ((MR_Box) ((MR_hl_field(MR_mktag(0), ByteCode_6, (MR_Integer) 0))));
    MR_Integer Size_24 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), ByteCode_6, (MR_Integer) 1))));
    MR_Integer Var_25 = (MR_Integer) ((MR_Unsigned) STATE_VARIABLE_Pos_0_13 + (MR_Unsigned) 1);

    // setup for model_semi tailcalls optimized into a loop
    ;
    succeeded = (Var_25 <= Size_24);
    if (succeeded)
    {
{
#define MR_PROC_LABEL mdbcomp__rtti_access__read_line_2_5_p_0
	...
	ByteCode = (const MR_uint_least8_t *)Bytes_23 ;
  ...
  MR_Integer * STATE_VARIABLE_Pos_12)
{
  ...
  MR_Box Bytes_18 = ((MR_Box) ((MR_hl_field(MR_mktag(0), ByteCode_6, (MR_Integer) 0))));
  MR_Integer Size_19 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), ByteCode_6, (MR_Integer) 1))));
  MR_Integer Var_20 = (MR_Integer) ((MR_Unsigned) STATE_VARIABLE_Pos_0_11 + (MR_Unsigned) 4);
  MR_Box StringTableChars_25;
  MR_Integer Size_26;
...
#undef MR_PROC_LABEL
	...
	*STATE_VARIABLE_Pos_12  = Pos;
    ...
    StringTableChars_25 = ((MR_Box) ((MR_hl_field(MR_mktag(0), StringTable_7, (MR_Integer) 0))));
    Size_26 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), StringTable_7, (MR_Integer) 1))));
{
#define MR_PROC_LABEL mdbcomp__rtti_access__read_string_via_offset_5_p_0
	...
	StringTableChars = (MR_ConstString)StringTableChars_25 ;
	StringTableSize = Size_26 ;
	NameCode = Offset_10 ;
		{
  ...
  MR_Integer * STATE_VARIABLE_Pos_13)
{
  while (MR_TRUE)
  {
    ...
    MR_Integer Var_17;
    MR_Integer Var_18;
    MR_Box Bytes_26 = ((MR_Box) ((MR_hl_field(MR_mktag(0), ByteCode_6, (MR_Integer) 0))));
    MR_Integer Size_27 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), ByteCode_6, (MR_Integer) 1))));
    MR_Integer Var_28 = (MR_Integer) ((MR_Unsigned) STATE_VARIABLE_Pos_0_12 + (MR_Unsigned) 1);
    MR_Integer Var_19;
    MR_Integer Var_20;

    // setup for model_semi tailcalls optimized into a loop
    ;
    succeeded = (Var_28 <= Size_27);
    if (succeeded)
    {
{
#define MR_PROC_LABEL mdbcomp__rtti_access__read_num_2_5_p_0
	...
	ByteCode = (const MR_uint_least8_t *)Bytes_26 ;
