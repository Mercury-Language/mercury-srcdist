  ...
  MR_Integer * STATE_VARIABLE_Pos_16)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      MR_Integer Var_31 = (MR_Integer) ((MR_Unsigned) STATE_VARIABLE_Pos_0_15 + (MR_Unsigned) 1);
  ...
  MR_Integer * STATE_VARIABLE_Pos_14)
{
  while (MR_TRUE)
  {
    ...
    MR_Integer Var_27 = (MR_Integer) ((MR_Unsigned) STATE_VARIABLE_Pos_0_13 + (MR_Unsigned) 1);
...
{
  {
    ...
    MR_Integer Var_21 = (MR_Integer) ((MR_Unsigned) STATE_VARIABLE_Pos_0_11 + (MR_Unsigned) 4);
  ...
  MR_Integer * STATE_VARIABLE_Pos_13)
{
  while (MR_TRUE)
  {
    ...
    MR_Integer Var_29 = (MR_Integer) ((MR_Unsigned) STATE_VARIABLE_Pos_0_12 + (MR_Unsigned) 1);
    MR_Integer Var_19;
    MR_Integer Var_20;
