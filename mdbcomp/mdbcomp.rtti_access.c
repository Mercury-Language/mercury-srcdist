...
;}
#line 247 "mdbcomp.rtti_access.c"
	MR_r1 = Port;
#undef	MR_PROC_LABEL
	}
	MR_proceed();
...
#line 116 "rtti_access.m"
    ...
    Port = Label->MR_sll_port;
;}
#line 287 "mdbcomp.rtti_access.c"
	MR_tempr1 = Port;
#undef	MR_PROC_LABEL
	}
	{
...
#line 91 "rtti_access.m"
    ...
    GoalPath = (MR_String) MR_label_goal_path(Label);
;}
#line 301 "mdbcomp.rtti_access.c"
	MR_r1 = (MR_Word) GoalPath;
#undef	MR_PROC_LABEL
	}
	MR_sv(1) = MR_tempr1;
...
;}
#line 372 "mdbcomp.rtti_access.c"
...
;}
#line 420 "mdbcomp.rtti_access.c"
...
#line 179 "rtti_access.m"
    ...
    ModeNum    = proc_id->MR_uci_mode;
;}
#line 607 "mdbcomp.rtti_access.c"
