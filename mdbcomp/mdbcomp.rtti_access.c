...
{
  {
    ...
    else
    {
      ...
      mercury__builtin____Compare____c_pointer_0_0(&Var_8, Cast_HeadVar1_13, Cast_HeadVar2_14);
...
{
  {
    MR_Word TypeInfo_for_Offset_7;
    MR_Word TypeInfo_for_Size_8;
...
{
  {
    ...
    MR_Word Chars_7;
    MR_Word CharBytes_8;
    MR_Word BytesPrime_16;

    mercury__string__length_2_p_0(String_3, &Length_5);
    succeeded = mdbcomp__rtti_access__encode_num_2_p_0(Length_5, &BytesPrime_16);
    if (succeeded)
      LengthBytes_6 = BytesPrime_16;
    else
    {
      {
    ...
    CharBytes_8 = mercury__list__map_2_f_0((MR_Word) &mercury__builtin__builtin__type_ctor_info_character_0, TypeCtorInfo_11_11, (MR_Word) &mdbcomp__rtti_access_scalar_common_2[0], Chars_7);
    *Bytes_4 = mercury__list__f_43_43_2_f_0(TypeCtorInfo_11_11, LengthBytes_6, CharBytes_8);
  }
}
...
{
  {
    MR_bool succeeded;
    MR_Word Bytes_4;
    MR_Word BytesPrime_7;

    succeeded = mdbcomp__rtti_access__encode_num_2_p_0(Num_3, &BytesPrime_7);
    if (succeeded)
      Bytes_4 = BytesPrime_7;
    else
    {
      mercury__require__unexpected_2_p_0((MR_String) "predicate \140mdbcomp.rtti_access.encode_num_det\'/2", (MR_String) "encode_num failed");
    }
...
{
  {
    ...
    if (succeeded)
    {
      ...
      Var_11 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
      {
        ...
        MR_hl_field(MR_mktag(1), Var_10, 0) = ((MR_Box) (LastByte_5));
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      NextNum_8 = mercury__int__f_slash_2_f_0(Num_4, (MR_Integer) 128);
      {
        ...
        MR_hl_field(MR_mktag(1), Var_13, 0) = ((MR_Box) (CurByte_7));
        MR_hl_field(MR_mktag(1), Var_13, 1) = ((MR_Box) (RestBytes_5));
      }
      /* direct tailcall eliminated */
      {
        MR_Integer next_value_of_Num_4 = NextNum_8;
        MR_Word next_value_of_RestBytes_5 = Var_13;
...
{
  {
    ...
    succeeded = mdbcomp__rtti_access__encode_int32_2_p_0(Int32_3, &BytesPrime_7);
    if (succeeded)
      Bytes_4 = BytesPrime_7;
    else
    {
...
{
  {
    ...
    if (succeeded)
    {
      ...
      Var_16 = (MR_Integer) 256;
      {
        ...
        MR_hl_field(MR_mktag(1), Var_12, 0) = ((MR_Box) (Byte4_7));
      ...
      Var_18 = (MR_Integer) 256;
      {
        ...
        MR_hl_field(MR_mktag(1), Var_11, 0) = ((MR_Box) (Byte3_6));
      ...
      {
        Var_10 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), Var_10, 0) = ((MR_Box) (Byte2_5));
        MR_hl_field(MR_mktag(1), Var_10, 1) = ((MR_Box) (Var_11));
      }
      ...
      {
        {
          ...
          *HeadVar__2_2 = base;
          MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (Byte1_4));
...
{
  {
    ...
    succeeded = mdbcomp__rtti_access__encode_short_2_p_0(Short_3, &BytesPrime_7);
    if (succeeded)
      Bytes_4 = BytesPrime_7;
    else
    {
...
{
  {
    ...
    if (succeeded)
    {
      ...
      Var_10 = (MR_Integer) 256;
      {
        ...
        MR_hl_field(MR_mktag(1), Var_6, 0) = ((MR_Box) (Byte2_5));
      ...
      {
        {
          ...
          *HeadVar__2_2 = base;
          MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (Byte1_4));
          MR_hl_field(MR_mktag(1), base, 1) = ((MR_Box) (Var_6));
        }
        succeeded = MR_TRUE;
      }
    }
...
{
  {
    ...
    {
      Var_11 = (MR_Integer) 128;
      succeeded = (Byte_3 < Var_11);
      if (succeeded)
      {
        {
          BytesPrime_5 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), BytesPrime_5, 0) = ((MR_Box) (Byte_3));
          MR_hl_field(MR_mktag(1), BytesPrime_5, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
        }
        succeeded = MR_TRUE;
      }
    }
      ...
      {
        {
          ...
          base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
          *HeadVar__2_2 = base;
          MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (Byte_3));
...
{
  {
    ...
    if (succeeded)
    {
      Bytes_9 = ((MR_Box) (MR_hl_field(MR_mktag(0), ByteCode_5, (MR_Integer) 0)));
      NumBytes_10 = ((MR_Integer) (MR_hl_field(MR_mktag(0), ByteCode_5, (MR_Integer) 1)));
      Var_15 = (STATE_VARIABLE_Pos_14_14 + Size_8);
...
#undef MR_PROC_LABEL
	 StringTableChars_11  = (MR_Box) StringTableChars;
        ...
        *STATE_VARIABLE_Pos_13 = (STATE_VARIABLE_Pos_14_14 + Size_8);
        {
          MR_Word base;
          base = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
          *StringTable_6 = base;
          MR_hl_field(MR_mktag(0), base, 0) = ((MR_Box) (StringTableChars_11));
          MR_hl_field(MR_mktag(0), base, 1) = ((MR_Box) (Size_8));
        }
        succeeded = MR_TRUE;
      }
    }
  ...
  MR_Integer * STATE_VARIABLE_Pos_16)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      MR_Integer Var_20;
      MR_Integer Var_23;
      MR_Box Bytes_29 = ((MR_Box) (MR_hl_field(MR_mktag(0), ByteCode_7, (MR_Integer) 0)));
      MR_Integer Size_30 = ((MR_Integer) (MR_hl_field(MR_mktag(0), ByteCode_7, (MR_Integer) 1)));
      MR_Integer Var_31 = (STATE_VARIABLE_Pos_0_15 + (MR_Integer) 1);

      succeeded = (Var_31 <= Size_30);
      if (succeeded)
      {
{
#define MR_PROC_LABEL mdbcomp__rtti_access__read_len_string_2_6_p_0
	...
	ByteCode = (const MR_uint_least8_t *) Bytes_29 ;
...
#undef MR_PROC_LABEL
	 ...
	 STATE_VARIABLE_Pos_18_18  = Pos;
        ...
        if (succeeded)
        {
          ...
          Var_20 = (N_8 - Var_23);
          {
            STATE_VARIABLE_RevChars_19_19 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), STATE_VARIABLE_RevChars_19_19, 0) = ((MR_Box) (MR_Word) (Char_12));
            MR_hl_field(MR_mktag(1), STATE_VARIABLE_RevChars_19_19, 1) = ((MR_Box) (STATE_VARIABLE_RevChars_0_13));
          }
          /* direct tailcall eliminated */
          {
            MR_Integer next_value_of_N_8 = Var_20;
            MR_Word next_value_of_STATE_VARIABLE_RevChars_0_13 = STATE_VARIABLE_RevChars_19_19;
            MR_Integer next_value_of_STATE_VARIABLE_Pos_0_15 = STATE_VARIABLE_Pos_18_18;
...
{
  {
    ...
    succeeded = mdbcomp__rtti_access__read_line_2_5_p_0(ByteCode_5, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), &RevChars_8, STATE_VARIABLE_Pos_0_9, STATE_VARIABLE_Pos_10);
    if (succeeded)
    {
  ...
  MR_Integer * STATE_VARIABLE_Pos_14)
{
  while (MR_TRUE)
  {
    ...
    MR_Box Bytes_25 = ((MR_Box) (MR_hl_field(MR_mktag(0), ByteCode_6, (MR_Integer) 0)));
    MR_Integer Size_26 = ((MR_Integer) (MR_hl_field(MR_mktag(0), ByteCode_6, (MR_Integer) 1)));
    MR_Integer Var_27 = (STATE_VARIABLE_Pos_0_13 + (MR_Integer) 1);

    /* setup for tailcalls optimized into a loop */
    succeeded = (Var_27 <= Size_26);
    if (succeeded)
    {
{
#define MR_PROC_LABEL mdbcomp__rtti_access__read_line_2_5_p_0
	...
	ByteCode = (const MR_uint_least8_t *) Bytes_25 ;
	 ...
	 STATE_VARIABLE_Pos_15_15  = Pos;
      ...
      if (succeeded)
      {
        ...
        {
          {
            ...
            *STATE_VARIABLE_RevChars_12 = base;
            ...
            MR_hl_field(MR_mktag(1), base, 1) = ((MR_Box) (STATE_VARIABLE_RevChars_0_11));
          }
        ...
        else
        {
          ...
          {
            STATE_VARIABLE_RevChars_17_17 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), STATE_VARIABLE_RevChars_17_17, 0) = ((MR_Box) (MR_Word) (Char_10));
            MR_hl_field(MR_mktag(1), STATE_VARIABLE_RevChars_17_17, 1) = ((MR_Box) (STATE_VARIABLE_RevChars_0_11));
          }
          /* direct tailcall eliminated */
          {
            MR_Word next_value_of_STATE_VARIABLE_RevChars_0_11 = STATE_VARIABLE_RevChars_17_17;
            MR_Integer next_value_of_STATE_VARIABLE_Pos_0_13 = STATE_VARIABLE_Pos_15_15;
...
{
  {
    ...
    MR_Box Bytes_19 = ((MR_Box) (MR_hl_field(MR_mktag(0), ByteCode_6, (MR_Integer) 0)));
    MR_Integer Size_20 = ((MR_Integer) (MR_hl_field(MR_mktag(0), ByteCode_6, (MR_Integer) 1)));
    MR_Integer Var_21 = (STATE_VARIABLE_Pos_0_11 + (MR_Integer) 4);
    MR_Box StringTableChars_27;
    MR_Integer Size_28;

    succeeded = (Var_21 <= Size_20);
    if (succeeded)
    {
{
#define MR_PROC_LABEL mdbcomp__rtti_access__read_string_via_offset_5_p_0
	...
	ByteCode = (const MR_uint_least8_t *) Bytes_19 ;
...
#undef MR_PROC_LABEL
	 ...
	 *STATE_VARIABLE_Pos_12  = Pos;
      ...
      StringTableChars_27 = ((MR_Box) (MR_hl_field(MR_mktag(0), StringTable_7, (MR_Integer) 0)));
      Size_28 = ((MR_Integer) (MR_hl_field(MR_mktag(0), StringTable_7, (MR_Integer) 1)));
{
#define MR_PROC_LABEL mdbcomp__rtti_access__read_string_via_offset_5_p_0
	...
	StringTableChars = (MR_ConstString) StringTableChars_27 ;
	StringTableSize =  Size_28 ;
	NameCode =  Offset_10 ;
		{
  ...
  MR_Integer * STATE_VARIABLE_Pos_13)
{
  while (MR_TRUE)
  {
    ...
    MR_Integer Var_17;
    MR_Integer Var_18;
    MR_Box Bytes_27 = ((MR_Box) (MR_hl_field(MR_mktag(0), ByteCode_6, (MR_Integer) 0)));
    MR_Integer Size_28 = ((MR_Integer) (MR_hl_field(MR_mktag(0), ByteCode_6, (MR_Integer) 1)));
    MR_Integer Var_29 = (STATE_VARIABLE_Pos_0_12 + (MR_Integer) 1);
    MR_Integer Var_19;
    MR_Integer Var_20;

    /* setup for tailcalls optimized into a loop */
    succeeded = (Var_29 <= Size_28);
    if (succeeded)
    {
{
#define MR_PROC_LABEL mdbcomp__rtti_access__read_num_2_5_p_0
	...
	ByteCode = (const MR_uint_least8_t *) Bytes_27 ;
  ...
  MR_Integer * STATE_VARIABLE_Pos_11)
{
  {
    MR_bool succeeded;
    MR_Box Bytes_8 = ((MR_Box) (MR_hl_field(MR_mktag(0), ByteCode_5, (MR_Integer) 0)));
    MR_Integer Size_9 = ((MR_Integer) (MR_hl_field(MR_mktag(0), ByteCode_5, (MR_Integer) 1)));
    MR_Integer Var_12 = (STATE_VARIABLE_Pos_0_10 + (MR_Integer) 4);
...
{
  {
    ...
    MR_Box Bytes_8 = ((MR_Box) (MR_hl_field(MR_mktag(0), ByteCode_5, (MR_Integer) 0)));
    MR_Integer Size_9 = ((MR_Integer) (MR_hl_field(MR_mktag(0), ByteCode_5, (MR_Integer) 1)));
    MR_Integer Var_12 = (STATE_VARIABLE_Pos_0_10 + (MR_Integer) 2);
...
{
  {
    ...
    MR_Box Bytes_8 = ((MR_Box) (MR_hl_field(MR_mktag(0), ByteCode_5, (MR_Integer) 0)));
    MR_Integer Size_9 = ((MR_Integer) (MR_hl_field(MR_mktag(0), ByteCode_5, (MR_Integer) 1)));
    MR_Integer Var_12 = (STATE_VARIABLE_Pos_0_10 + (MR_Integer) 1);
  ...
  MR_Integer NameCode_5)
{
  {
    MR_String Str_6;
    MR_Box StringTableChars_7 = ((MR_Box) (MR_hl_field(MR_mktag(0), StringTable_4, (MR_Integer) 0)));
    MR_Integer Size_8 = ((MR_Integer) (MR_hl_field(MR_mktag(0), StringTable_4, (MR_Integer) 1)));
...
#undef MR_PROC_LABEL
    ...
    {
      StringTable_4 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), StringTable_4, 0) = ((MR_Box) (StringTableChars_5));
      MR_hl_field(MR_mktag(0), StringTable_4, 1) = ((MR_Box) (Size_6));
    }
...
{
  {
    ...
    if (((MR_tag((MR_Word) HeadVar__1_1)) == (MR_mktag((MR_Integer) 0))))
    {
      ...
      ProcName_2 = ((MR_String) (MR_hl_field(MR_mktag(0), HeadVar__1_1, (MR_Integer) 3)));
      Var_7 = ((MR_Integer) (MR_hl_field(MR_mktag(0), HeadVar__1_1, (MR_Integer) 4)));
      Var_8 = ((MR_Integer) (MR_hl_field(MR_mktag(0), HeadVar__1_1, (MR_Integer) 5)));
    }
    else
    {
      MR_Word Var_9 = ((MR_Word) (MR_hl_field(MR_mktag(1), HeadVar__1_1, (MR_Integer) 0)));
      MR_Word Var_10 = ((MR_Word) (MR_hl_field(MR_mktag(1), HeadVar__1_1, (MR_Integer) 1)));
      MR_Word Var_11 = ((MR_Word) (MR_hl_field(MR_mktag(1), HeadVar__1_1, (MR_Integer) 2)));
      MR_Integer Var_13;
      MR_Integer Var_14;

      ProcName_2 = ((MR_String) (MR_hl_field(MR_mktag(1), HeadVar__1_1, (MR_Integer) 3)));
      Var_13 = ((MR_Integer) (MR_hl_field(MR_mktag(1), HeadVar__1_1, (MR_Integer) 4)));
      Var_14 = ((MR_Integer) (MR_hl_field(MR_mktag(1), HeadVar__1_1, (MR_Integer) 5)));
    }
    return ProcName_2;
  }
}
...
#undef MR_PROC_LABEL
	 ...
	 ModeNum_10  = ModeNum;
      ...
      SymTypeModule_16 = mdbcomp__sym_name__string_to_sym_name_1_f_0(TypeModule_6);
      {
        ...
        MR_hl_field(MR_mktag(1), ProcLabel_4, 0) = ((MR_Box) (SymDefModule_15));
        MR_hl_field(MR_mktag(1), ProcLabel_4, 1) = ((MR_Box) (SpecialId_14));
        MR_hl_field(MR_mktag(1), ProcLabel_4, 2) = ((MR_Box) (SymTypeModule_16));
        MR_hl_field(MR_mktag(1), ProcLabel_4, 3) = ((MR_Box) (TypeName_5));
        MR_hl_field(MR_mktag(1), ProcLabel_4, 4) = ((MR_Box) (TypeArity_9));
        MR_hl_field(MR_mktag(1), ProcLabel_4, 5) = ((MR_Box) (ModeNum_10));
      }
    }
    else
    {
...
#undef MR_PROC_LABEL
	 ...
	 ModeNum_25  = ModeNum;
      ...
      SymDeclModule_20 = mdbcomp__sym_name__string_to_sym_name_1_f_0(DeclModule_18);
      {
        ...
        MR_hl_field(MR_mktag(0), ProcLabel_4, 0) = ((MR_Box) (SymDefModule_26));
        MR_hl_field(MR_mktag(0), ProcLabel_4, 1) = ((MR_Box) (PredOrFunc_17));
        MR_hl_field(MR_mktag(0), ProcLabel_4, 2) = ((MR_Box) (SymDeclModule_20));
        MR_hl_field(MR_mktag(0), ProcLabel_4, 3) = ((MR_Box) (PredName_24));
        MR_hl_field(MR_mktag(0), ProcLabel_4, 4) = ((MR_Box) (Arity_19));
        MR_hl_field(MR_mktag(0), ProcLabel_4, 5) = ((MR_Box) (ModeNum_25));
      }
    }
    return ProcLabel_4;
  }
...
{
  {
    ...
    {
      MR_Box Label_3 = ((MR_Box) (MR_hl_field(MR_mktag(1), HeadVar__1_1, (MR_Integer) 0)));
