...
#line 193 "rtti_access.m"
    ...
    GoalPath = (MR_String) MR_label_goal_path(Label);
;}
#line 446 "mdbcomp.rtti_access.c"
	MR_r1 = (MR_Word) GoalPath;
#undef	MR_PROC_LABEL
	}
	MR_proceed();
...
#line 193 "rtti_access.m"
    ...
    GoalPath = (MR_String) MR_label_goal_path(Label);
;}
#line 538 "mdbcomp.rtti_access.c"
	MR_r1 = (MR_Word) GoalPath;
#undef	MR_PROC_LABEL
	}
	MR_sv(1) = MR_tempr1;
...
;}
#line 645 "mdbcomp.rtti_access.c"
...
;}
#line 1164 "mdbcomp.rtti_access.c"
...
#line 454 "rtti_access.m"
    ...
    Layouts = list;
;}
#line 1281 "mdbcomp.rtti_access.c"
	MR_r1 = Layouts;
#undef	MR_PROC_LABEL
	}
	MR_proceed();
...
;}
#line 1316 "mdbcomp.rtti_access.c"
	MR_r1 = (MR_Word) ProcLayout;
#undef	MR_PROC_LABEL
	}
	MR_proceed();
...
#endif
;}
#line 1354 "mdbcomp.rtti_access.c"
...
;}
#line 1398 "mdbcomp.rtti_access.c"
...
;}
#line 1443 "mdbcomp.rtti_access.c"
...
#line 597 "rtti_access.m"
    ...
    Size = ModuleCommonLayout->MR_mlc_string_table_size;
;}
#line 1483 "mdbcomp.rtti_access.c"
...
;}
#line 1526 "mdbcomp.rtti_access.c"
	MR_r1 = (MR_Word) Str;
#undef	MR_PROC_LABEL
	}
	MR_proceed();
...
#line 618 "rtti_access.m"
    ...
    MR_make_aligned_string(Str, StringTableChars + StartOffset);
;}
#line 1575 "mdbcomp.rtti_access.c"
	MR_r1 = (MR_Word) Str;
#undef	MR_PROC_LABEL
	}
	MR_proceed();
...
#line 634 "rtti_access.m"
    ...
    Pos = Pos0 + 1;
;}
#line 1669 "mdbcomp.rtti_access.c"
	MR_r2 = Value;
	MR_r3 = Pos;
#undef	MR_PROC_LABEL
	}
...
#line 649 "rtti_access.m"
    ...
    Pos = Pos0 + 2;
;}
#line 1715 "mdbcomp.rtti_access.c"
	MR_r1 = Value;
	MR_r2 = Pos;
#undef	MR_PROC_LABEL
	}
...
#line 649 "rtti_access.m"
    ...
    Pos = Pos0 + 2;
;}
#line 1765 "mdbcomp.rtti_access.c"
	MR_r2 = Value;
	MR_r3 = Pos;
#undef	MR_PROC_LABEL
	}
...
#line 664 "rtti_access.m"
    ...
    Pos = Pos0 + 4;
;}
#line 1812 "mdbcomp.rtti_access.c"
	MR_r1 = Value;
	MR_r2 = Pos;
#undef	MR_PROC_LABEL
	}
...
#line 664 "rtti_access.m"
    ...
    Pos = Pos0 + 4;
;}
#line 1863 "mdbcomp.rtti_access.c"
	MR_r2 = Value;
	MR_r3 = Pos;
#undef	MR_PROC_LABEL
	}
...
#line 664 "rtti_access.m"
    ...
    Pos = Pos0 + 4;
;}
#line 2034 "mdbcomp.rtti_access.c"
	MR_tempr2 = Value;
	MR_tempr1 = Pos;
#undef	MR_PROC_LABEL
	}
...
#line 634 "rtti_access.m"
    ...
    Pos = Pos0 + 1;
;}
#line 2104 "mdbcomp.rtti_access.c"
	MR_tempr2 = Value;
	MR_tempr1 = Pos;
#undef	MR_PROC_LABEL
	}
...
#line 634 "rtti_access.m"
    ...
    Pos = Pos0 + 1;
;}
#line 2263 "mdbcomp.rtti_access.c"
	MR_tempr2 = Value;
	MR_tempr1 = Pos;
#undef	MR_PROC_LABEL
	}
...
;}
#line 2460 "mdbcomp.rtti_access.c"
	MR_tempr1 = (MR_Word) StringTableChars;
#undef	MR_PROC_LABEL
	}
...
#line 739 "rtti_access.m"
    ...
    StringTableChars = (MR_ConstString) buf;
;}
#line 2971 "mdbcomp.rtti_access.c"
	MR_r1 = (MR_Word) StringTableChars;
#undef	MR_PROC_LABEL
	}
	MR_proceed();
