...
#line 62 "mdbcomp.rtti_access.c"

#endif
#line 65 "mdbcomp.rtti_access.c"
...
;}
#line 368 "mdbcomp.rtti_access.c"
...
;}
#line 403 "mdbcomp.rtti_access.c"
...
#line 193 "rtti_access.m"
    ...
    GoalPath = (MR_String) MR_label_goal_path(Label);
;}
#line 447 "mdbcomp.rtti_access.c"
	MR_r1 = (MR_Word) GoalPath;
#undef	MR_PROC_LABEL
	}
	MR_proceed();
...
#line 218 "rtti_access.m"
    ...
    Port = Label->MR_sll_port;
;}
#line 522 "mdbcomp.rtti_access.c"
	MR_r2 = Port;
#undef	MR_PROC_LABEL
	}
	{
...
#line 193 "rtti_access.m"
    ...
    GoalPath = (MR_String) MR_label_goal_path(Label);
;}
#line 536 "mdbcomp.rtti_access.c"
	MR_r1 = (MR_Word) GoalPath;
#undef	MR_PROC_LABEL
	}
	MR_sv(1) = MR_r2;
...
;}
#line 1149 "mdbcomp.rtti_access.c"
...
#line 454 "rtti_access.m"
    ...
    Layouts = list;
;}
#line 1266 "mdbcomp.rtti_access.c"
	MR_r1 = Layouts;
#undef	MR_PROC_LABEL
	}
	MR_proceed();
...
;}
#line 1301 "mdbcomp.rtti_access.c"
	MR_r1 = (MR_Word) ProcLayout;
#undef	MR_PROC_LABEL
	}
	MR_proceed();
...
#endif
;}
#line 1339 "mdbcomp.rtti_access.c"
...
;}
#line 1383 "mdbcomp.rtti_access.c"
...
;}
#line 1428 "mdbcomp.rtti_access.c"
...
#line 597 "rtti_access.m"
    ...
    Size = ModuleCommonLayout->MR_mlc_string_table_size;
;}
#line 1468 "mdbcomp.rtti_access.c"
...
;}
#line 1510 "mdbcomp.rtti_access.c"
	MR_r1 = (MR_Word) Str;
#undef	MR_PROC_LABEL
	}
	MR_proceed();
...
#line 618 "rtti_access.m"
    ...
    MR_make_aligned_string(Str, StringTableChars + StartOffset);
;}
#line 1558 "mdbcomp.rtti_access.c"
	MR_r1 = (MR_Word) Str;
#undef	MR_PROC_LABEL
	}
	MR_proceed();
...
#line 634 "rtti_access.m"
    ...
    Pos = Pos0 + 1;
;}
#line 1651 "mdbcomp.rtti_access.c"
	MR_r2 = Value;
	MR_r3 = Pos;
#undef	MR_PROC_LABEL
	}
...
#line 649 "rtti_access.m"
    ...
    Pos = Pos0 + 2;
;}
#line 1697 "mdbcomp.rtti_access.c"
	MR_r1 = Value;
	MR_r2 = Pos;
#undef	MR_PROC_LABEL
	}
...
#line 649 "rtti_access.m"
    ...
    Pos = Pos0 + 2;
;}
#line 1746 "mdbcomp.rtti_access.c"
	MR_r2 = Value;
	MR_r3 = Pos;
#undef	MR_PROC_LABEL
	}
...
#line 664 "rtti_access.m"
    ...
    Pos = Pos0 + 4;
;}
#line 1793 "mdbcomp.rtti_access.c"
	MR_r1 = Value;
	MR_r2 = Pos;
#undef	MR_PROC_LABEL
	}
...
#line 634 "rtti_access.m"
    ...
    Pos = Pos0 + 1;
;}
#line 1903 "mdbcomp.rtti_access.c"
	MR_tempr2 = Value;
	MR_tempr1 = Pos;
#undef	MR_PROC_LABEL
	}
...
#line 664 "rtti_access.m"
    ...
    Pos = Pos0 + 4;
;}
#line 2013 "mdbcomp.rtti_access.c"
	MR_tempr2 = Value;
	MR_tempr1 = Pos;
#undef	MR_PROC_LABEL
	}
...
#line 634 "rtti_access.m"
    ...
    Pos = Pos0 + 1;
;}
#line 2082 "mdbcomp.rtti_access.c"
	MR_tempr2 = Value;
	MR_tempr1 = Pos;
#undef	MR_PROC_LABEL
	}
...
#line 634 "rtti_access.m"
    ...
    Pos = Pos0 + 1;
;}
#line 2240 "mdbcomp.rtti_access.c"
	MR_tempr2 = Value;
	MR_tempr1 = Pos;
#undef	MR_PROC_LABEL
	}
...
;}
#line 2437 "mdbcomp.rtti_access.c"
...
#line 739 "rtti_access.m"
    ...
    StringTableChars = (MR_ConstString) buf;
;}
#line 2948 "mdbcomp.rtti_access.c"
	MR_r1 = (MR_Word) StringTableChars;
#undef	MR_PROC_LABEL
	}
	MR_proceed();
