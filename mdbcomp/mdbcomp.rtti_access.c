...
MR_decl_label4(mdbcomp__rtti_access__read_len_string_2_6_0, 22,2,3,1)
MR_decl_label3(mdbcomp__rtti_access__read_line_4_0, 2,4,1)
MR_decl_label4(mdbcomp__rtti_access__read_line_2_5_0, 23,2,4,1)
...
;}
#line 1146 "mdbcomp.rtti_access.c"
...
#line 458 "rtti_access.m"
    ...
    Layouts = list;
;}
#line 1260 "mdbcomp.rtti_access.c"
	MR_r1 = Layouts;
#undef	MR_PROC_LABEL
	}
	MR_proceed();
...
;}
#line 1292 "mdbcomp.rtti_access.c"
	MR_r1 = (MR_Word) ProcLayout;
#undef	MR_PROC_LABEL
	}
	MR_proceed();
...
;}
#line 1368 "mdbcomp.rtti_access.c"
...
#line 594 "rtti_access.m"
    ...
    Size = ModuleCommonLayout->MR_mlc_string_table_size;
;}
#line 1447 "mdbcomp.rtti_access.c"
...
;}
#line 1486 "mdbcomp.rtti_access.c"
	MR_r1 = (MR_Word) Str;
#undef	MR_PROC_LABEL
	}
	MR_proceed();
...
#line 615 "rtti_access.m"
    ...
    MR_make_aligned_string(Str, StringTableChars + StartOffset);
;}
#line 1531 "mdbcomp.rtti_access.c"
	MR_r1 = (MR_Word) Str;
#undef	MR_PROC_LABEL
	}
	MR_proceed();
...
#define	MR_PROC_LABEL	mercury__mdbcomp__rtti_access__read_byte_2_4_0
	...
	Pos0 = MR_r2;
{
#line 631 "rtti_access.m"

    Value = ByteCode[Pos0];
    Pos = Pos0 + 1;
;}
#line 1572 "mdbcomp.rtti_access.c"
	MR_r1 = Value;
	MR_r2 = Pos;
#undef	MR_PROC_LABEL
	}
...
#line 631 "rtti_access.m"
    ...
    Pos = Pos0 + 1;
;}
#line 1618 "mdbcomp.rtti_access.c"
	MR_r2 = Value;
	MR_r3 = Pos;
#undef	MR_PROC_LABEL
	}
...
#define	MR_PROC_LABEL	mercury__mdbcomp__rtti_access__read_short_2_4_0
	...
	Pos0 = MR_r2;
{
#line 646 "rtti_access.m"

    Value = (ByteCode[Pos0] << 8) + ByteCode[Pos0+1];
    Pos = Pos0 + 2;
;}
#line 1661 "mdbcomp.rtti_access.c"
	MR_r1 = Value;
	MR_r2 = Pos;
#undef	MR_PROC_LABEL
	}
...
#line 661 "rtti_access.m"
    ...
    Pos = Pos0 + 4;
;}
#line 1798 "mdbcomp.rtti_access.c"
	MR_r2 = Value;
	MR_r3 = Pos;
#undef	MR_PROC_LABEL
	}
...
#line 631 "rtti_access.m"
    ...
    Pos = Pos0 + 1;
;}
#line 1855 "mdbcomp.rtti_access.c"
	MR_tempr2 = Value;
	MR_tempr1 = Pos;
#undef	MR_PROC_LABEL
	}
...
#line 661 "rtti_access.m"
    ...
    Pos = Pos0 + 4;
;}
#line 1955 "mdbcomp.rtti_access.c"
	MR_tempr2 = Value;
	MR_tempr1 = Pos;
#undef	MR_PROC_LABEL
	}
...
MR_BEGIN_MODULE(mdbcomp__rtti_access_module29)
	...
	MR_init_label4(mdbcomp__rtti_access__read_line_2_5_0,23,2,4,1)
MR_BEGIN_CODE
...
MR_def_static(mdbcomp__rtti_access__read_line_2_5_0)
	...
	MR_incr_sp(4);
	MR_sv(4) = (MR_Word) MR_succip;
MR_def_label(mdbcomp__rtti_access__read_line_2_5_0,23)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r4 = ((MR_Integer) MR_r3 + (MR_Integer) 1);
	MR_r5 = MR_ctfield(0, MR_r1, 1);
	if (((MR_Integer) MR_r4 > (MR_Integer) MR_r5)) {
...
#line 631 "rtti_access.m"
    ...
    Pos = Pos0 + 1;
;}
#line 2021 "mdbcomp.rtti_access.c"
	MR_tempr2 = Value;
	MR_tempr1 = Pos;
#undef	MR_PROC_LABEL
	}
...
MR_def_label(mdbcomp__rtti_access__read_line_2_5_0,4)
	...
	MR_r3 = MR_sv(3);
	MR_succip_word = MR_sv(4);
	MR_GOTO_LAB(mdbcomp__rtti_access__read_line_2_5_0_i23);
	}
...
MR_BEGIN_MODULE(mdbcomp__rtti_access_module31)
	...
	MR_init_label4(mdbcomp__rtti_access__read_len_string_2_6_0,22,2,3,1)
MR_BEGIN_CODE
...
MR_def_label(mdbcomp__rtti_access__read_len_string_2_6_0,22)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
#line 631 "rtti_access.m"
    ...
    Pos = Pos0 + 1;
;}
#line 2169 "mdbcomp.rtti_access.c"
	MR_tempr2 = Value;
	MR_tempr1 = Pos;
#undef	MR_PROC_LABEL
	}
...
MR_def_label(mdbcomp__rtti_access__read_len_string_2_6_0,3)
	...
	MR_GOTO_LAB(mdbcomp__rtti_access__read_len_string_2_6_0_i22);
	}
...
;}
#line 2345 "mdbcomp.rtti_access.c"
	MR_tempr1 = (MR_Word) StringTableChars;
#undef	MR_PROC_LABEL
	}
...
#line 736 "rtti_access.m"
    ...
    StringTableChars = (MR_ConstString) buf;
;}
#line 2811 "mdbcomp.rtti_access.c"
	MR_r1 = (MR_Word) StringTableChars;
#undef	MR_PROC_LABEL
	}
	MR_proceed();
