...
;}
#line 364 "mdbcomp.rtti_access.c"
...
;}
#line 399 "mdbcomp.rtti_access.c"
...
#line 196 "rtti_access.m"
    ...
    GoalPath = (MR_String) MR_label_goal_path(Label);
;}
#line 443 "mdbcomp.rtti_access.c"
	MR_r1 = (MR_Word) GoalPath;
#undef	MR_PROC_LABEL
	}
	MR_proceed();
...
;}
#line 478 "mdbcomp.rtti_access.c"
	MR_r1 = Port;
#undef	MR_PROC_LABEL
	}
	MR_proceed();
...
#line 221 "rtti_access.m"
    ...
    Port = Label->MR_sll_port;
;}
#line 518 "mdbcomp.rtti_access.c"
	MR_r2 = Port;
#undef	MR_PROC_LABEL
	}
	{
...
;}
#line 587 "mdbcomp.rtti_access.c"
...
;}
#line 695 "mdbcomp.rtti_access.c"
...
;}
#line 1145 "mdbcomp.rtti_access.c"
...
#line 458 "rtti_access.m"
    ...
    Layouts = list;
;}
#line 1262 "mdbcomp.rtti_access.c"
	MR_r1 = Layouts;
#undef	MR_PROC_LABEL
	}
	MR_proceed();
...
;}
#line 1297 "mdbcomp.rtti_access.c"
	MR_r1 = (MR_Word) ProcLayout;
#undef	MR_PROC_LABEL
	}
	MR_proceed();
...
#endif
;}
#line 1335 "mdbcomp.rtti_access.c"
...
;}
#line 1379 "mdbcomp.rtti_access.c"
...
;}
#line 1424 "mdbcomp.rtti_access.c"
...
#line 618 "rtti_access.m"
    ...
    Size = ModuleCommonLayout->MR_mlc_string_table_size;
;}
#line 1464 "mdbcomp.rtti_access.c"
...
;}
#line 1506 "mdbcomp.rtti_access.c"
	MR_r1 = (MR_Word) Str;
#undef	MR_PROC_LABEL
	}
	MR_proceed();
...
#line 639 "rtti_access.m"
    ...
    MR_make_aligned_string(Str, StringTableChars + StartOffset);
;}
#line 1554 "mdbcomp.rtti_access.c"
	MR_r1 = (MR_Word) Str;
#undef	MR_PROC_LABEL
	}
	MR_proceed();
...
#line 655 "rtti_access.m"
    ...
    Pos = Pos0 + 1;
;}
#line 1598 "mdbcomp.rtti_access.c"
	MR_r1 = Value;
	MR_r2 = Pos;
#undef	MR_PROC_LABEL
	}
...
#line 655 "rtti_access.m"
    ...
    Pos = Pos0 + 1;
;}
#line 1647 "mdbcomp.rtti_access.c"
	MR_r2 = Value;
	MR_r3 = Pos;
#undef	MR_PROC_LABEL
	}
...
#line 670 "rtti_access.m"
    ...
    Pos = Pos0 + 2;
;}
#line 1742 "mdbcomp.rtti_access.c"
	MR_r2 = Value;
	MR_r3 = Pos;
#undef	MR_PROC_LABEL
	}
...
#line 685 "rtti_access.m"
    ...
    Pos = Pos0 + 4;
;}
#line 1789 "mdbcomp.rtti_access.c"
	MR_r1 = Value;
	MR_r2 = Pos;
#undef	MR_PROC_LABEL
	}
...
#line 685 "rtti_access.m"
    ...
    Pos = Pos0 + 4;
;}
#line 1839 "mdbcomp.rtti_access.c"
	MR_r2 = Value;
	MR_r3 = Pos;
#undef	MR_PROC_LABEL
	}
...
#line 655 "rtti_access.m"
    ...
    Pos = Pos0 + 1;
;}
#line 1899 "mdbcomp.rtti_access.c"
	MR_tempr2 = Value;
	MR_tempr1 = Pos;
#undef	MR_PROC_LABEL
	}
...
#line 685 "rtti_access.m"
    ...
    Pos = Pos0 + 4;
;}
#line 2009 "mdbcomp.rtti_access.c"
	MR_tempr2 = Value;
	MR_tempr1 = Pos;
#undef	MR_PROC_LABEL
	}
...
#line 655 "rtti_access.m"
    ...
    Pos = Pos0 + 1;
;}
#line 2078 "mdbcomp.rtti_access.c"
	MR_tempr2 = Value;
	MR_tempr1 = Pos;
#undef	MR_PROC_LABEL
	}
...
#line 655 "rtti_access.m"
    ...
    Pos = Pos0 + 1;
;}
#line 2236 "mdbcomp.rtti_access.c"
	MR_tempr2 = Value;
	MR_tempr1 = Pos;
#undef	MR_PROC_LABEL
	}
...
;}
#line 2433 "mdbcomp.rtti_access.c"
...
#line 760 "rtti_access.m"
    ...
    StringTableChars = (MR_ConstString) buf;
;}
#line 2944 "mdbcomp.rtti_access.c"
	MR_r1 = (MR_Word) StringTableChars;
#undef	MR_PROC_LABEL
	}
	MR_proceed();
