...
{
  {
    ...
    if (succeeded)
    {
      ...
      Var_10 = (MR_Integer) 256;
      {
        ...
        MR_hl_field(MR_mktag(1), Var_6, 1) = ((MR_Box) ((MR_Integer) 0));
      }
      ...
      {
        {
          ...
          MR_hl_field(MR_mktag(1), BytesPrime_5, 1) = ((MR_Box) ((MR_Integer) 0));
        }
        succeeded = MR_TRUE;
      }
    }
...
{
  {
    ...
    succeeded = mdbcomp__rtti_access__read_line_2_5_p_0(ByteCode_5, (MR_Word) ((MR_Integer) 0), &RevChars_8, STATE_VARIABLE_Pos_0_9, STATE_VARIABLE_Pos_10);
    if (succeeded)
    {
