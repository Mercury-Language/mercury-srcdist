...
;}
#line 367 "mdbcomp.rtti_access.c"
...
;}
#line 402 "mdbcomp.rtti_access.c"
...
#line 193 "rtti_access.m"
    ...
    GoalPath = (MR_String) MR_label_goal_path(Label);
;}
#line 448 "mdbcomp.rtti_access.c"
	MR_r1 = (MR_Word) GoalPath;
#undef	MR_PROC_LABEL
	}
	MR_proceed();
...
;}
#line 484 "mdbcomp.rtti_access.c"
	MR_r1 = Port;
#undef	MR_PROC_LABEL
	}
	MR_proceed();
...
#line 218 "rtti_access.m"
    ...
    Port = Label->MR_sll_port;
;}
#line 526 "mdbcomp.rtti_access.c"
	MR_tempr1 = Port;
#undef	MR_PROC_LABEL
	}
	{
...
;}
#line 647 "mdbcomp.rtti_access.c"
...
;}
#line 1166 "mdbcomp.rtti_access.c"
...
#line 454 "rtti_access.m"
    ...
    Layouts = list;
;}
#line 1283 "mdbcomp.rtti_access.c"
	MR_r1 = Layouts;
#undef	MR_PROC_LABEL
	}
	MR_proceed();
...
;}
#line 1318 "mdbcomp.rtti_access.c"
	MR_r1 = (MR_Word) ProcLayout;
#undef	MR_PROC_LABEL
	}
	MR_proceed();
...
#endif
;}
#line 1356 "mdbcomp.rtti_access.c"
...
;}
#line 1400 "mdbcomp.rtti_access.c"
...
#line 597 "rtti_access.m"
    ...
    Size = ModuleCommonLayout->MR_mlc_string_table_size;
;}
#line 1485 "mdbcomp.rtti_access.c"
...
;}
#line 1528 "mdbcomp.rtti_access.c"
	MR_r1 = (MR_Word) Str;
#undef	MR_PROC_LABEL
	}
	MR_proceed();
...
#define	MR_PROC_LABEL	mercury__mdbcomp__rtti_access__read_byte_2_4_0
	...
	Pos0 = MR_r2;
{
#line 634 "rtti_access.m"

    Value = ByteCode[Pos0];
    Pos = Pos0 + 1;
;}
#line 1621 "mdbcomp.rtti_access.c"
	MR_r1 = Value;
	MR_r2 = Pos;
#undef	MR_PROC_LABEL
	}
...
#line 634 "rtti_access.m"
    ...
    Pos = Pos0 + 1;
;}
#line 1671 "mdbcomp.rtti_access.c"
	MR_r2 = Value;
	MR_r3 = Pos;
#undef	MR_PROC_LABEL
	}
...
#line 649 "rtti_access.m"
    ...
    Pos = Pos0 + 2;
;}
#line 1717 "mdbcomp.rtti_access.c"
	MR_r1 = Value;
	MR_r2 = Pos;
#undef	MR_PROC_LABEL
	}
...
#line 664 "rtti_access.m"
    ...
    Pos = Pos0 + 4;
;}
#line 1814 "mdbcomp.rtti_access.c"
	MR_r1 = Value;
	MR_r2 = Pos;
#undef	MR_PROC_LABEL
	}
...
#line 664 "rtti_access.m"
    ...
    Pos = Pos0 + 4;
;}
#line 1865 "mdbcomp.rtti_access.c"
	MR_r2 = Value;
	MR_r3 = Pos;
#undef	MR_PROC_LABEL
	}
...
#line 634 "rtti_access.m"
    ...
    Pos = Pos0 + 1;
;}
#line 1926 "mdbcomp.rtti_access.c"
	MR_tempr2 = Value;
	MR_tempr1 = Pos;
#undef	MR_PROC_LABEL
	}
...
#line 664 "rtti_access.m"
    ...
    Pos = Pos0 + 4;
;}
#line 2036 "mdbcomp.rtti_access.c"
	MR_tempr2 = Value;
	MR_tempr1 = Pos;
#undef	MR_PROC_LABEL
	}
...
#line 634 "rtti_access.m"
    ...
    Pos = Pos0 + 1;
;}
#line 2106 "mdbcomp.rtti_access.c"
	MR_tempr2 = Value;
	MR_tempr1 = Pos;
#undef	MR_PROC_LABEL
	}
...
#line 634 "rtti_access.m"
    ...
    Pos = Pos0 + 1;
;}
#line 2265 "mdbcomp.rtti_access.c"
	MR_tempr2 = Value;
	MR_tempr1 = Pos;
#undef	MR_PROC_LABEL
	}
...
;}
#line 2462 "mdbcomp.rtti_access.c"
	MR_tempr1 = (MR_Word) StringTableChars;
#undef	MR_PROC_LABEL
	}
...
#line 739 "rtti_access.m"
    ...
    StringTableChars = (MR_ConstString) buf;
;}
#line 2973 "mdbcomp.rtti_access.c"
	MR_r1 = (MR_Word) StringTableChars;
#undef	MR_PROC_LABEL
	}
	MR_proceed();
