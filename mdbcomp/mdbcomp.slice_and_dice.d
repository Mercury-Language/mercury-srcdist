...
mdbcomp.slice_and_dice.module_dep : mercury/mdbcomp_/slice_and_dice.java
  else
...
mdbcomp.slice_and_dice.s_date : slice_and_dice.m
	$(MCG) $(ALL_GRADEFLAGS) $(ALL_MCGFLAGS) --target-code-only mdbcomp.slice_and_dice $(ERR_REDIRECT)
mdbcomp.slice_and_dice.pic_s_date : slice_and_dice.m
	$(MCG) $(ALL_GRADEFLAGS) $(ALL_MCGFLAGS) --target-code-only --pic \
		--cflags "$(GCCFLAGS_FOR_PIC)" mdbcomp.slice_and_dice $(ERR_REDIRECT)
endif # TARGET_ASM
mdbcomp.slice_and_dice.il_date : slice_and_dice.m
	$(MCG) $(ALL_GRADEFLAGS) $(ALL_MCGFLAGS) --il-only mdbcomp.slice_and_dice $(ERR_REDIRECT)
