...
{
  {
    ...
    conv1_HeadVar__4_4 = mercury__list__foldl_3_f_0((MR_Word) &transform_hlds__ctgc__livedata__transform_hlds__ctgc__livedata__type_ctor_info_livedata_0, (MR_Word) &transform_hlds__ctgc__livedata__transform_hlds__ctgc__livedata__type_ctor_info_livedata_0, Var_8, LiveDataList_7, ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))));
