...
MR_decl_label3(transform_hlds__ctgc__livedata__nodes_are_not_live_4_0, 7,11,1)
MR_decl_label8(fn__transform_hlds__ctgc__livedata__livedata_add_liveness_5_0, 4,20,2,8,6,11,14,16)
MR_decl_label1(fn__transform_hlds__ctgc__livedata__livedata_add_liveness_5_0, 17)
MR_decl_label2(fn__transform_hlds__ctgc__livedata__livedata_get_datastructs_1_0, 5,4)
MR_decl_label8(fn__transform_hlds__ctgc__livedata__livedata_init_at_goal_4_0, 2,3,4,5,6,10,8,14)
MR_decl_label3(fn__transform_hlds__ctgc__livedata__livedata_init_at_goal_4_0, 12,17,18)
MR_decl_label1(fn__transform_hlds__ctgc__livedata__livedata_init_from_vars_1_0, 2)
MR_decl_label4(fn__transform_hlds__ctgc__livedata__livedata_least_upper_bound_4_0, 4,9,38,10)
MR_decl_label4(fn__transform_hlds__ctgc__livedata__livedata_project_2_0, 5,27,6,8)
MR_decl_label3(__Unify___transform_hlds__ctgc__livedata__livedata_0_0, 6,18,1)
MR_decl_label5(__Compare___transform_hlds__ctgc__livedata__livedata_0_0, 26,7,14,6,18)
...
MR_def_extern_entry(transform_hlds__ctgc__livedata__nodes_are_not_live_4_0)
...
MR_BEGIN_MODULE(transform_hlds__ctgc__livedata_module1)
	...
	MR_init_label1(fn__transform_hlds__ctgc__livedata__livedata_init_from_vars_1_0,2)
MR_BEGIN_CODE
...
MR_define_entry(mercury__fn__transform_hlds__ctgc__livedata__livedata_init_from_vars_1_0);
	...
	MR_np_call_localret_ent(fn__list__map_2_0,
		fn__transform_hlds__ctgc__livedata__livedata_init_from_vars_1_0_i2);
MR_def_label(fn__transform_hlds__ctgc__livedata__livedata_init_from_vars_1_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
...
MR_BEGIN_MODULE(transform_hlds__ctgc__livedata_module7)
	...
	MR_init_label4(fn__transform_hlds__ctgc__livedata__livedata_least_upper_bound_4_0,4,9,38,10)
MR_BEGIN_CODE
...
MR_define_entry(mercury__fn__transform_hlds__ctgc__livedata__livedata_least_upper_bound_4_0);
	...
	if (MR_INT_NE(MR_unmkbody(MR_r3),0)) {
		MR_GOTO_LAB(fn__transform_hlds__ctgc__livedata__livedata_least_upper_bound_4_0_i9);
	}
	MR_r1 = MR_r4;
	MR_proceed();
MR_def_label(fn__transform_hlds__ctgc__livedata__livedata_least_upper_bound_4_0,4)
	...
	if (MR_PTAG_TESTR(MR_r4,0)) {
		MR_GOTO_LAB(fn__transform_hlds__ctgc__livedata__livedata_least_upper_bound_4_0_i38);
	}
	...
	MR_r1 = MR_r3;
	MR_proceed();
MR_def_label(fn__transform_hlds__ctgc__livedata__livedata_least_upper_bound_4_0,9)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_tbmkword(0, 1);
	MR_proceed();
MR_def_label(fn__transform_hlds__ctgc__livedata__livedata_least_upper_bound_4_0,38)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(1);
	MR_sv(1) = (MR_Word) MR_succip;
	...
	MR_np_call_localret_ent(fn__transform_hlds__ctgc__datastruct__datastruct_lists_least_upper_bound_4_0,
		fn__transform_hlds__ctgc__livedata__livedata_least_upper_bound_4_0_i10);
...
MR_define_entry(mercury__fn__transform_hlds__ctgc__livedata__livedata_least_upper_bound_list_3_0);
	...
	MR_r2 = (MR_Word) MR_CTOR0_ADDR(transform_hlds__ctgc__livedata, livedata);
	MR_r4 = MR_r3;
	MR_r3 = MR_tempr1;
...
MR_BEGIN_MODULE(transform_hlds__ctgc__livedata_module11)
	...
	MR_init_label4(fn__transform_hlds__ctgc__livedata__livedata_project_2_0,5,27,6,8)
MR_BEGIN_CODE
...
MR_define_entry(mercury__fn__transform_hlds__ctgc__livedata__livedata_project_2_0);
	...
	if (MR_PTAG_TESTR(MR_r2,0)) {
		MR_GOTO_LAB(fn__transform_hlds__ctgc__livedata__livedata_project_2_0_i27);
	}
	if (MR_INT_NE(MR_unmkbody(MR_r2),0)) {
		MR_GOTO_LAB(fn__transform_hlds__ctgc__livedata__livedata_project_2_0_i5);
	}
	MR_r1 = (MR_Word) MR_tbmkword(0, 0);
	MR_proceed();
MR_def_label(fn__transform_hlds__ctgc__livedata__livedata_project_2_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_tbmkword(0, 1);
	MR_proceed();
MR_def_label(fn__transform_hlds__ctgc__livedata__livedata_project_2_0,27)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(1);
	MR_sv(1) = (MR_Word) MR_succip;
	{
...
MR_BEGIN_MODULE(transform_hlds__ctgc__livedata_module12)
	...
	MR_init_label8(fn__transform_hlds__ctgc__livedata__livedata_init_at_goal_4_0,2,3,4,5,6,10,8,14)
	MR_init_label3(fn__transform_hlds__ctgc__livedata__livedata_init_at_goal_4_0,12,17,18)
MR_BEGIN_CODE
...
MR_def_label(fn__transform_hlds__ctgc__livedata__livedata_init_at_goal_4_0,3)
	...
	MR_np_call_localret_ent(fn__f_115_101_116_95_95_84_121_112_101_83_112_101_99_79_102_95_95_112_114_101_100_95_111_114_95_102_117_110_99_95_95_117_110_105_111_110_95_95_91_84_32_61_32_118_97_114_40_86_95_50_41_93_95_48_95_49_2_0,
		fn__transform_hlds__ctgc__livedata__livedata_init_at_goal_4_0_i4);
MR_def_label(fn__transform_hlds__ctgc__livedata__livedata_init_at_goal_4_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_r1;
	MR_r1 = MR_sv(5);
...
MR_def_label(fn__transform_hlds__ctgc__livedata__livedata_init_at_goal_4_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
		MR_GOTO_LAB(fn__transform_hlds__ctgc__livedata__livedata_init_at_goal_4_0_i6);
	}
	MR_r1 = (MR_Word) MR_tbmkword(0, 0);
...
MR_def_label(fn__transform_hlds__ctgc__livedata__livedata_init_at_goal_4_0,6)
	...
	MR_np_call_localret_ent(transform_hlds__ctgc__structure_sharing__domain__sharing_as_is_top_1_0,
		fn__transform_hlds__ctgc__livedata__livedata_init_at_goal_4_0_i10);
MR_def_label(fn__transform_hlds__ctgc__livedata__livedata_init_at_goal_4_0,10)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(fn__transform_hlds__ctgc__livedata__livedata_init_at_goal_4_0_i8);
	}
	MR_r1 = (MR_Word) MR_tbmkword(0, 1);
	MR_decr_sp_and_return(6);
MR_def_label(fn__transform_hlds__ctgc__livedata__livedata_init_at_goal_4_0,8)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(3);
	MR_r1 = MR_sv(4);
	MR_np_call_localret_ent(transform_hlds__ctgc__structure_sharing__domain__sharing_as_is_bottom_1_0,
		fn__transform_hlds__ctgc__livedata__livedata_init_at_goal_4_0_i14);
MR_def_label(fn__transform_hlds__ctgc__livedata__livedata_init_at_goal_4_0,14)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(fn__transform_hlds__ctgc__livedata__livedata_init_at_goal_4_0_i12);
	}
	MR_r1 = MR_sv(5);
	MR_r2 = (MR_Word) MR_CTOR0_ADDR(parse_tree__prog_data, datastruct);
...
MR_def_label(fn__transform_hlds__ctgc__livedata__livedata_init_at_goal_4_0,12)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(3);
	MR_r4 = MR_r1;
	MR_r1 = MR_sv(5);
	...
	MR_np_call_localret_ent(fn__list__map_2_0,
		fn__transform_hlds__ctgc__livedata__livedata_init_at_goal_4_0_i17);
MR_def_label(fn__transform_hlds__ctgc__livedata__livedata_init_at_goal_4_0,17)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r4 = MR_r1;
	MR_r1 = MR_sv(1);
	MR_r2 = MR_sv(2);
...
MR_BEGIN_MODULE(transform_hlds__ctgc__livedata_module13)
	...
	MR_init_label8(fn__transform_hlds__ctgc__livedata__livedata_add_liveness_5_0,4,20,2,8,6,11,14,16)
	MR_init_label1(fn__transform_hlds__ctgc__livedata__livedata_add_liveness_5_0,17)
MR_BEGIN_CODE
...
MR_def_label(fn__transform_hlds__ctgc__livedata__livedata_add_liveness_5_0,20)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_tbmkword(0, 1);
	MR_decr_sp_and_return(6);
...
MR_def_label(fn__transform_hlds__ctgc__livedata__livedata_add_liveness_5_0,6)
	...
	MR_np_call_localret_ent(fn__transform_hlds__ctgc__structure_sharing__domain__extend_datastructs_4_0,
		fn__transform_hlds__ctgc__livedata__livedata_add_liveness_5_0_i11);
MR_def_label(fn__transform_hlds__ctgc__livedata__livedata_add_liveness_5_0,11)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 1);
	...
	if (MR_PTAG_TESTR(MR_tempr2,0)) {
		MR_GOTO_LAB(fn__transform_hlds__ctgc__livedata__livedata_add_liveness_5_0_i14);
	}
	if (MR_INT_NE(MR_unmkbody(MR_tempr2),0)) {
		MR_GOTO_LAB(fn__transform_hlds__ctgc__livedata__livedata_add_liveness_5_0_i20);
	}
	MR_r1 = MR_tempr1;
	MR_decr_sp_and_return(6);
	}
MR_def_label(fn__transform_hlds__ctgc__livedata__livedata_add_liveness_5_0,14)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(3) = MR_r1;
	MR_r1 = MR_sv(1);
	MR_r2 = MR_sv(2);
	MR_r3 = MR_sv(4);
	MR_r4 = MR_ctfield(1, MR_sv(5), 0);
	MR_np_call_localret_ent(fn__transform_hlds__ctgc__structure_sharing__domain__extend_datastructs_4_0,
		fn__transform_hlds__ctgc__livedata__livedata_add_liveness_5_0_i16);
...
MR_BEGIN_MODULE(transform_hlds__ctgc__livedata_module14)
	MR_init_entry1(transform_hlds__ctgc__livedata__nodes_are_not_live_4_0);
	MR_init_label3(transform_hlds__ctgc__livedata__nodes_are_not_live_4_0,7,11,1)
MR_BEGIN_CODE
	...
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_define_entry(mercury__transform_hlds__ctgc__livedata__nodes_are_not_live_4_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(1);
	MR_sv(1) = (MR_Word) MR_succip;
	if (MR_LTAGS_TEST(MR_r4,0,0)) {
		MR_GOTO_LAB(transform_hlds__ctgc__livedata__nodes_are_not_live_4_0_i11);
	}
	if (MR_PTAG_TESTR(MR_r4,1)) {
		MR_GOTO_LAB(transform_hlds__ctgc__livedata__nodes_are_not_live_4_0_i1);
	}
	MR_r4 = MR_ctfield(1, MR_r4, 0);
	MR_np_call_localret_ent(transform_hlds__ctgc__datastruct__datastructs_subsumed_by_list_4_0,
		transform_hlds__ctgc__livedata__nodes_are_not_live_4_0_i7);
MR_def_label(transform_hlds__ctgc__livedata__nodes_are_not_live_4_0,7)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_r1) {
		MR_GOTO_LAB(transform_hlds__ctgc__livedata__nodes_are_not_live_4_0_i1);
	}
MR_def_label(transform_hlds__ctgc__livedata__nodes_are_not_live_4_0,11)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_succip_word = MR_sv(1);
	MR_decr_sp(1);
	MR_r1 = MR_TRUE;
	MR_proceed();
MR_def_label(transform_hlds__ctgc__livedata__nodes_are_not_live_4_0,1)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_succip_word = MR_sv(1);
	MR_decr_sp(1);
	MR_r1 = MR_FALSE;
...
MR_BEGIN_MODULE(transform_hlds__ctgc__livedata_module16)
	...
	MR_init_label3(__Unify___transform_hlds__ctgc__livedata__livedata_0_0,6,18,1)
MR_BEGIN_CODE
...
MR_define_entry(mercury____Unify___transform_hlds__ctgc__livedata__livedata_0_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if ((MR_r1 == MR_r2)) {
		MR_GOTO_LAB(__Unify___transform_hlds__ctgc__livedata__livedata_0_0_i18);
	}
	MR_incr_sp(3);
...
MR_def_label(__Unify___transform_hlds__ctgc__livedata__livedata_0_0,18)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_TRUE;
	MR_proceed();
...
MR_BEGIN_MODULE(transform_hlds__ctgc__livedata_module17)
	...
	MR_init_label5(__Compare___transform_hlds__ctgc__livedata__livedata_0_0,26,7,14,6,18)
MR_BEGIN_CODE
...
MR_define_entry(mercury____Compare___transform_hlds__ctgc__livedata__livedata_0_0);
	...
	MR_sv(3) = (MR_Word) MR_succip;
	if ((MR_r1 == MR_r2)) {
		MR_GOTO_LAB(__Compare___transform_hlds__ctgc__livedata__livedata_0_0_i26);
	}
	MR_sv(1) = MR_r1;
	MR_sv(2) = MR_r2;
	{
	...
	if (MR_PTAG_TESTR(MR_tempr1,0)) {
		MR_GOTO_LAB(__Compare___transform_hlds__ctgc__livedata__livedata_0_0_i6);
	}
	if (MR_INT_NE(MR_unmkbody(MR_tempr1),0)) {
		MR_GOTO_LAB(__Compare___transform_hlds__ctgc__livedata__livedata_0_0_i7);
	}
	MR_tempr2 = MR_sv(2);
	if (MR_PTAG_TESTR(MR_tempr2,0)) {
...
MR_def_label(__Compare___transform_hlds__ctgc__livedata__livedata_0_0,26)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Integer) 0;
	MR_decr_sp_and_return(3);
MR_def_label(__Compare___transform_hlds__ctgc__livedata__livedata_0_0,7)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_sv(2);
...
MR_def_label(__Compare___transform_hlds__ctgc__livedata__livedata_0_0,14)
	...
	MR_r1 = (MR_Integer) 1;
	MR_decr_sp_and_return(3);
MR_def_label(__Compare___transform_hlds__ctgc__livedata__livedata_0_0,6)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r3 = MR_sv(2);
	if (MR_PTAG_TESTR(MR_r3,0)) {
		MR_GOTO_LAB(__Compare___transform_hlds__ctgc__livedata__livedata_0_0_i18);
	}
	MR_r1 = (MR_Integer) 2;
	MR_decr_sp_and_return(3);
MR_def_label(__Compare___transform_hlds__ctgc__livedata__livedata_0_0,18)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(parse_tree__prog_data, datastruct);
...
void mercury__transform_hlds__ctgc__livedata__write_out_proc_statics(FILE *fp);
#endif
