...
MR_decl_label10(transform_hlds__ctgc__livedata__one_of_vars_is_live_5_0, 3,6,4,11,13,15,16,19,17,23)
MR_decl_label1(transform_hlds__ctgc__livedata__one_of_vars_is_live_5_0, 25)
...
MR_decl_label10(fn__transform_hlds__ctgc__livedata__livedata_init_at_goal_4_0, 2,3,4,5,6,10,8,14,17,12)
MR_decl_label6(fn__transform_hlds__ctgc__livedata__livedata_init_at_goal_4_0, 19,23,25,26,27,21)
MR_decl_label1(fn__transform_hlds__ctgc__livedata__livedata_init_from_vars_1_0, 3)
...
MR_decl_static(transform_hlds__ctgc__livedata__IntroducedFrom__pred__one_of_vars_is_live_ordered__344__1_5_0)
...
MR_BEGIN_MODULE(transform_hlds__ctgc__livedata_module1)
	...
	MR_init_label1(fn__transform_hlds__ctgc__livedata__livedata_init_from_vars_1_0,3)
MR_BEGIN_CODE
...
MR_define_entry(mercury__fn__transform_hlds__ctgc__livedata__livedata_init_from_vars_1_0);
	...
	MR_np_call_localret_ent(fn__list__map_2_0,
		fn__transform_hlds__ctgc__livedata__livedata_init_from_vars_1_0_i3);
MR_def_label(fn__transform_hlds__ctgc__livedata__livedata_init_from_vars_1_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_BEGIN_MODULE(transform_hlds__ctgc__livedata_module12)
	...
	MR_init_label10(fn__transform_hlds__ctgc__livedata__livedata_init_at_goal_4_0,2,3,4,5,6,10,8,14,17,12)
	MR_init_label6(fn__transform_hlds__ctgc__livedata__livedata_init_at_goal_4_0,19,23,25,26,27,21)
MR_BEGIN_CODE
...
MR_def_label(fn__transform_hlds__ctgc__livedata__livedata_init_at_goal_4_0,12)
	...
	MR_np_call_localret_ent(fn__transform_hlds__ctgc__structure_sharing__domain__to_structure_sharing_domain_1_0,
		fn__transform_hlds__ctgc__livedata__livedata_init_at_goal_4_0_i19);
MR_def_label(fn__transform_hlds__ctgc__livedata__livedata_init_at_goal_4_0,19)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_r1,1)) {
		MR_GOTO_LAB(fn__transform_hlds__ctgc__livedata__livedata_init_at_goal_4_0_i21);
	}
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_sv(2);
	...
	MR_np_call_localret_ent(fn__list__map_2_0,
		fn__transform_hlds__ctgc__livedata__livedata_init_at_goal_4_0_i23);
MR_def_label(fn__transform_hlds__ctgc__livedata__livedata_init_at_goal_4_0,23)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	...
	MR_np_call_localret_ent(list__map_3_0,
		fn__transform_hlds__ctgc__livedata__livedata_init_at_goal_4_0_i25);
MR_def_label(fn__transform_hlds__ctgc__livedata__livedata_init_at_goal_4_0,25)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
...
MR_def_label(fn__transform_hlds__ctgc__livedata__livedata_init_at_goal_4_0,26)
	...
	MR_np_call_localret_ent(fn__f_108_105_115_116_95_95_43_43_2_0,
		fn__transform_hlds__ctgc__livedata__livedata_init_at_goal_4_0_i27);
MR_def_label(fn__transform_hlds__ctgc__livedata__livedata_init_at_goal_4_0,27)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
...
MR_def_label(fn__transform_hlds__ctgc__livedata__livedata_init_at_goal_4_0,21)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_BEGIN_MODULE(transform_hlds__ctgc__livedata_module16)
	...
	MR_init_label10(transform_hlds__ctgc__livedata__one_of_vars_is_live_5_0,3,6,4,11,13,15,16,19,17,23)
	MR_init_label1(transform_hlds__ctgc__livedata__one_of_vars_is_live_5_0,25)
MR_BEGIN_CODE
...
MR_def_label(transform_hlds__ctgc__livedata__one_of_vars_is_live_5_0,6)
	...
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(parse_tree__prog_data, datastruct);
	MR_GOTO_LAB(transform_hlds__ctgc__livedata__one_of_vars_is_live_5_0_i15);
	}
MR_def_label(transform_hlds__ctgc__livedata__one_of_vars_is_live_5_0,4)
	...
	MR_np_call_localret_ent(list__filter_map_3_0,
		transform_hlds__ctgc__livedata__one_of_vars_is_live_5_0_i11);
MR_def_label(transform_hlds__ctgc__livedata__one_of_vars_is_live_5_0,11)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tag_alloc_heap(MR_tempr1, 0, (MR_Integer) 6);
	...
	MR_tfield(0, MR_tempr1, 1) = (MR_Word) MR_ENTRY_AP(transform_hlds__ctgc__livedata__IntroducedFrom__pred__one_of_vars_is_live_ordered__344__1_5_0);
	MR_tfield(0, MR_tempr1, 2) = (MR_Integer) 3;
	MR_tfield(0, MR_tempr1, 3) = MR_sv(1);
	MR_tfield(0, MR_tempr1, 4) = MR_sv(2);
	...
	MR_np_call_localret_ent(list__map_3_0,
		transform_hlds__ctgc__livedata__one_of_vars_is_live_5_0_i13);
MR_def_label(transform_hlds__ctgc__livedata__one_of_vars_is_live_5_0,13)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_tag_alloc_heap(MR_r2, 0, (MR_Integer) 4);
	...
	MR_sv(7) = MR_tfield(0, MR_r2, 3);
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(parse_tree__prog_data, datastruct);
MR_def_label(transform_hlds__ctgc__livedata__one_of_vars_is_live_5_0,15)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(4) = MR_r1;
	MR_np_call_localret_ent(list__filter_3_0,
		transform_hlds__ctgc__livedata__one_of_vars_is_live_5_0_i16);
MR_def_label(transform_hlds__ctgc__livedata__one_of_vars_is_live_5_0,16)
	...
	MR_r3 = MR_sv(8);
	MR_np_call_localret_ent(list__filter_3_0,
		transform_hlds__ctgc__livedata__one_of_vars_is_live_5_0_i19);
MR_def_label(transform_hlds__ctgc__livedata__one_of_vars_is_live_5_0,19)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TEST(MR_r1,0,0)) {
		MR_GOTO_LAB(transform_hlds__ctgc__livedata__one_of_vars_is_live_5_0_i17);
	}
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 2);
...
MR_def_label(transform_hlds__ctgc__livedata__one_of_vars_is_live_5_0,17)
	...
	MR_np_call_localret_ent(list__filter_map_3_0,
		transform_hlds__ctgc__livedata__one_of_vars_is_live_5_0_i23);
MR_def_label(transform_hlds__ctgc__livedata__one_of_vars_is_live_5_0,23)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tag_alloc_heap(MR_tempr1, 0, (MR_Integer) 6);
...
MR_BEGIN_MODULE(transform_hlds__ctgc__livedata_module21)
	MR_init_entry1(transform_hlds__ctgc__livedata__IntroducedFrom__pred__one_of_vars_is_live_ordered__344__1_5_0);
	MR_INIT_PROC_LAYOUT_ADDR(mercury__transform_hlds__ctgc__livedata__IntroducedFrom__pred__one_of_vars_is_live_ordered__344__1_5_0);
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'IntroducedFrom__pred__one_of_vars_is_live_ordered__344__1'/5 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(transform_hlds__ctgc__livedata__IntroducedFrom__pred__one_of_vars_is_live_ordered__344__1_5_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r3;
...
void mercury__transform_hlds__ctgc__livedata__write_out_proc_statics(FILE *deep_fp, FILE *procrep_fp)
{
	MR_write_out_module_proc_reps_start(procrep_fp, &mercury_data__module_layout__transform_hlds__ctgc__livedata);
