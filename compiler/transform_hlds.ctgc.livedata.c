      ...
      case (MR_Integer) 1:
        {
          ...
          {
            mercury__list__filter_3_p_0((MR_Word) &parse_tree__prog_data_pragma__parse_tree__prog_data_pragma__type_ctor_info_datastruct_0, transform_hlds__ctgc__livedata__V_11_11, transform_hlds__ctgc__livedata__Data_7, &transform_hlds__ctgc__livedata__FilteredData_8);
          }
    ...
    if (((MR_tag((MR_Word) transform_hlds__ctgc__livedata__LiveData_3)) == (MR_mktag((MR_Integer) 1))))
      {
        ...
        {
          transform_hlds__ctgc__livedata__succeeded = mercury__list__member_2_p_0((MR_Word) &parse_tree__prog_data_pragma__parse_tree__prog_data_pragma__type_ctor_info_datastruct_0, ((MR_Box) (transform_hlds__ctgc__livedata__V_5_5)), transform_hlds__ctgc__livedata__Data_8);
        }
      }
    else
      transform_hlds__ctgc__livedata__succeeded = MR_FALSE;
