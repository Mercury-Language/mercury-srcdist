...
MR_decl_label10(fn__transform_hlds__ctgc__livedata__livedata_init_at_goal_4_0, 2,3,4,5,6,10,8,14,18,12)
MR_decl_label6(fn__transform_hlds__ctgc__livedata__livedata_init_at_goal_4_0, 20,25,29,30,31,22)
...
MR_BEGIN_MODULE(transform_hlds__ctgc__livedata_module12)
	...
	MR_init_label10(fn__transform_hlds__ctgc__livedata__livedata_init_at_goal_4_0,2,3,4,5,6,10,8,14,18,12)
	MR_init_label6(fn__transform_hlds__ctgc__livedata__livedata_init_at_goal_4_0,20,25,29,30,31,22)
MR_BEGIN_CODE
...
MR_def_label(fn__transform_hlds__ctgc__livedata__livedata_init_at_goal_4_0,20)
	...
	MR_sv(3) = (MR_Word) MR_CTOR0_ADDR(parse_tree__prog_data, datastruct);
	MR_r1 = (MR_Word) MR_TAG_COMMON(0,0,0);
	MR_r2 = MR_sv(3);
