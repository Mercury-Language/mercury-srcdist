...
{
  {
    ...
    succeeded = ((MR_tag((MR_Word) FY_List_25)) == (MR_Integer) 1);
    if (succeeded)
    {
      {
        ...
        MR_hl_field(MR_mktag(1), L1_11, 1) = ((MR_Box) ((MR_Integer) 0));
      }
    }
    else
    {
    ...
    succeeded = ((MR_tag((MR_Word) FY_List_54)) == (MR_Integer) 1);
    if (succeeded)
    {
      {
        ...
        MR_hl_field(MR_mktag(1), L2_15, 1) = ((MR_Box) ((MR_Integer) 0));
      }
    }
    else
    {
...
{
  {
    ...
    if (succeeded)
      LiveData_12 = (MR_Word) ((MR_Integer) 4);
    else
    {
...
{
  {
    ...
    succeeded = (Lu_13 == (MR_Word) ((MR_Integer) 0));
    if (succeeded)
      LiveData_10 = (MR_Word) ((MR_Integer) 0);
    else
    {
      succeeded = transform_hlds__ctgc__structure_sharing__domain__sharing_as_is_top_1_p_0(SharingAs_9);
      if (succeeded)
        LiveData_10 = (MR_Word) ((MR_Integer) 4);
      else
      {
            ...
            case (MR_Integer) 1:
              {
                ...
                LIVE1_35 = mercury__list__map_2_f_0((MR_Word) (&transform_hlds__ctgc__livedata_scalar_common_1[0]), (MR_Word) (&parse_tree__prog_data_pragma__parse_tree__prog_data_pragma__type_ctor_info_datastruct_0), (MR_Word) (&transform_hlds__ctgc__livedata_scalar_common_2[3]), Lu_13);
                {
                ...
                Var_38 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__prog_data_pragma__parse_tree__prog_data_pragma__type_ctor_info_datastruct_0), LIVE1_35, LIVE2_36);
                {
                  LiveData_10 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
    ...
    switch (MR_tag((MR_Word) LiveData_5)) {
      ...
      case (MR_Integer) 0:
        switch (MR_unmkbody(LiveData_5)) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 0:
            ProjectedLiveData_6 = (MR_Word) ((MR_Integer) 0);
            break;
          case (MR_Integer) 1:
            ProjectedLiveData_6 = (MR_Word) ((MR_Integer) 4);
            break;
        }
        break;
      case (MR_Integer) 1:
        {
          ...
          if ((FilteredData_8 == (MR_Word) ((MR_Integer) 0)))
            ProjectedLiveData_6 = (MR_Word) ((MR_Integer) 0);
          else
            {
...
{
  {
    ...
    if (succeeded)
      if ((LiveData_7 == (MR_Word) ((MR_Integer) 4)))
        succeeded = MR_TRUE;
      else
...
{
  {
    ...
    if ((LiveData_3 == (MR_Word) ((MR_Integer) 4)))
      succeeded = MR_TRUE;
    else
...
{
  {
    ...
    conv1_HeadVar__4_4 = mercury__list__foldl_3_f_0((MR_Word) (&transform_hlds__ctgc__livedata__transform_hlds__ctgc__livedata__type_ctor_info_livedata_0), (MR_Word) (&transform_hlds__ctgc__livedata__transform_hlds__ctgc__livedata__type_ctor_info_livedata_0), Var_8, LiveDataList_7, ((MR_Box) ((MR_Integer) 0)));
...
{
  {
    MR_bool succeeded = (HeadVar__1_1 == (MR_Word) ((MR_Integer) 4));
