...
MR_decl_label2(__Unify___transform_hlds__ctgc__livedata__livedata_0_0, 4,1)
MR_decl_label5(__Compare___transform_hlds__ctgc__livedata__livedata_0_0, 22,5,12,4,16)
...
MR_BEGIN_MODULE(transform_hlds__ctgc__livedata_module16)
	...
	MR_init_label2(__Unify___transform_hlds__ctgc__livedata__livedata_0_0,4,1)
MR_BEGIN_CODE
...
MR_define_entry(mercury____Unify___transform_hlds__ctgc__livedata__livedata_0_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_r1,0)) {
		MR_GOTO_LAB(__Unify___transform_hlds__ctgc__livedata__livedata_0_0_i4);
	}
	MR_r1 = (MR_r2 == MR_r1);
	MR_proceed();
MR_def_label(__Unify___transform_hlds__ctgc__livedata__livedata_0_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_BEGIN_MODULE(transform_hlds__ctgc__livedata_module17)
	...
	MR_init_label5(__Compare___transform_hlds__ctgc__livedata__livedata_0_0,22,5,12,4,16)
MR_BEGIN_CODE
...
MR_define_entry(mercury____Compare___transform_hlds__ctgc__livedata__livedata_0_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___transform_hlds__ctgc__livedata__livedata_0_0_i4);
	}
	if (MR_INT_NE(MR_unmkbody(MR_r1),0)) {
...
MR_def_label(__Compare___transform_hlds__ctgc__livedata__livedata_0_0,22)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Integer) 0;
	MR_proceed();
MR_def_label(__Compare___transform_hlds__ctgc__livedata__livedata_0_0,5)
	...
	if (MR_INT_NE(MR_unmkbody(MR_r2),0)) {
		MR_GOTO_LAB(__Compare___transform_hlds__ctgc__livedata__livedata_0_0_i22);
	}
	MR_r1 = (MR_Integer) 2;
	MR_proceed();
MR_def_label(__Compare___transform_hlds__ctgc__livedata__livedata_0_0,12)
	...
	MR_r1 = (MR_Integer) 1;
	MR_proceed();
MR_def_label(__Compare___transform_hlds__ctgc__livedata__livedata_0_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_r2,0)) {
		MR_GOTO_LAB(__Compare___transform_hlds__ctgc__livedata__livedata_0_0_i16);
	}
	MR_r1 = (MR_Integer) 2;
	MR_proceed();
MR_def_label(__Compare___transform_hlds__ctgc__livedata__livedata_0_0,16)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tempr1 = MR_r1;
