            ...
            case (MR_Integer) 1:
              {
                ...
                MR_Word LIVE2_35;
                MR_Word Var_37;
                MR_Word DatastructsLists_47;
                MR_Word Var_48;

                LIVE1_34 = mercury__list__map_2_f_0((MR_Word) (&transform_hlds__ctgc__livedata_scalar_common_1[0]), (MR_Word) (&parse_tree__prog_data_pragma__parse_tree__prog_data_pragma__type_ctor_info_datastruct_0), (MR_Word) (&transform_hlds__ctgc__livedata_scalar_common_2[3]), Lu_13);
                {
                  Var_48 = (MR_Word) MR_new_object(MR_Word, (6 * sizeof(MR_Word)), NULL, NULL);
                  MR_hl_field(MR_mktag(0), Var_48, 0) = ((MR_Box) (&transform_hlds__ctgc__livedata_scalar_common_5[1]));
                  MR_hl_field(MR_mktag(0), Var_48, 1) = ((MR_Box) (transform_hlds__ctgc__livedata__livedata_init_at_goal_4_f_0_3));
                  MR_hl_field(MR_mktag(0), Var_48, 2) = ((MR_Box) ((MR_Integer) 3));
                  MR_hl_field(MR_mktag(0), Var_48, 3) = ((MR_Box) (ModuleInfo_6));
                  MR_hl_field(MR_mktag(0), Var_48, 4) = ((MR_Box) (ProcInfo_7));
                  MR_hl_field(MR_mktag(0), Var_48, 5) = ((MR_Box) (LIVE1_34));
                }
                mercury__list__map_3_p_0((MR_Word) (&transform_hlds__ctgc__livedata_scalar_common_2[0]), (MR_Word) (&transform_hlds__ctgc__livedata_scalar_common_1[1]), Var_48, SharingPairs_15, &DatastructsLists_47);
                mercury__list__condense_2_p_0((MR_Word) (&parse_tree__prog_data_pragma__parse_tree__prog_data_pragma__type_ctor_info_datastruct_0), DatastructsLists_47, &LIVE2_35);
                Var_37 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__prog_data_pragma__parse_tree__prog_data_pragma__type_ctor_info_datastruct_0), LIVE1_34, LIVE2_35);
                {
                  LiveData_10 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                  MR_hl_field(MR_mktag(1), LiveData_10, 0) = ((MR_Box) (Var_37));
                }
              }
              break;
            case (MR_Integer) 2:
