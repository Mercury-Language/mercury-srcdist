...
static /* final */ const MR_Box parse_tree__error_type_util_scalar_common_2[7][3] = {
  ...
  /* row   6 */
  {
    ...
    ((MR_Box) (parse_tree__error_type_util__type_pieces_5_f_0_1)),
    ((MR_Box) ((MR_Integer) 0))
  },
};
  ...
  MR_Box wrapper_arg_1)
{
  MR_Box wrapper_arg_2;
  MR_Box closure = closure_arg;
  MR_Word conv1_Pieces_12;

  conv1_Pieces_12 = parse_tree__error_type_util__type_pieces_5_f_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) ((MR_hl_field(0, closure, 4)))), ((MR_Word) ((MR_hl_field(0, closure, 5)))), ((MR_Word) ((MR_hl_field(0, closure, 6)))), ((MR_Word) (wrapper_arg_1)));
  wrapper_arg_2 = ((MR_Box) (conv1_Pieces_12));
  return wrapper_arg_2;
}
  ...
  MR_Box wrapper_arg_1)
{
  MR_Box wrapper_arg_2;
  MR_Box closure = closure_arg;
  MR_String conv0_Name_4;

  conv0_Name_4 = parse_tree__error_type_util__maybe_quote_name_1_f_0(((MR_String) (wrapper_arg_1)));
  wrapper_arg_2 = ((MR_Box) (conv0_Name_4));
  return wrapper_arg_2;
}
    ...
    switch (MR_tag((MR_Word) Type_11)) {
      ...
      case (MR_Integer) 0:
        {
          ...
          TVarStr_17 = parse_tree__parse_tree_out_term__mercury_var_to_string_vs_3_f_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_tvar_type_0), TVarSet_7, VarNamePrint_9, TVar_15);
          {
            ...
            MR_hl_field(2, Var_38, 0) = ((MR_Box) (TVarStr_17));
          }
          {
      ...
      case (MR_Integer) 1:
        {
          ...
          MR_Word ArgTypes_21 = ((MR_Word) ((MR_hl_field(1, Type_11, 1))));
          ...
          if ((ArgTypes_21 == (MR_Word) ((MR_Unsigned) 0U)))
            {
              Pieces_12 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(1, Pieces_12, 0) = ((MR_Box) (Var_42));
              MR_hl_field(1, Pieces_12, 1) = ((MR_Box) (SuffixPieces_10));
            }
          else
          {
            MR_Word ArgTypePiecesList_33;
            MR_Word Var_61;
            MR_Word Var_63;
            MR_Word Var_64;
            MR_Word Var_65;

            {
              ...
              MR_hl_field(0, Var_61, 0) = ((MR_Box) (&parse_tree__error_type_util_scalar_common_4[0]));
              MR_hl_field(0, Var_61, 1) = ((MR_Box) (parse_tree__error_type_util__type_pieces_5_f_0_2));
              MR_hl_field(0, Var_61, 2) = ((MR_Box) ((MR_Integer) 4));
              MR_hl_field(0, Var_61, 3) = ((MR_Box) (TVarSet_7));
              MR_hl_field(0, Var_61, 4) = ((MR_Box) (InstVarSet_8));
              MR_hl_field(0, Var_61, 5) = ((MR_Box) (VarNamePrint_9));
              MR_hl_field(0, Var_61, 6) = ((MR_Box) ((MR_Unsigned) 0U));
            }
            ArgTypePiecesList_33 = mercury__list__map_2_f_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0), (MR_Word) (&parse_tree__error_type_util_scalar_common_1[1]), Var_61, ArgTypes_21);
            Var_64 = parse_tree__error_spec__pieces_list_to_line_pieces_1_f_0(ArgTypePiecesList_33);
            Var_65 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), (MR_Word) (MR_mkword(1, &parse_tree__error_type_util_scalar_common_1[8])), SuffixPieces_10);
            Var_63 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), Var_64, Var_65);
            Pieces_12 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), NonConstL_28, Var_63);
          }
        }
        break;
      case (MR_Integer) 2:
        {
          ...
          parse_tree__prog_data__builtin_type_name_2_p_0(BuiltinType_18, &BuiltinTypeStr_19);
          {
            ...
            MR_hl_field(2, Var_39, 0) = ((MR_Box) (BuiltinTypeStr_19));
          }
          {
            Pieces_12 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      ...
      case (MR_Integer) 3:
        switch (((MR_Integer) ((MR_hl_field(3, Type_11, 0))))) {
          ...
          case (MR_Integer) 0:
            {
              MR_Word ArgTypes_97 = ((MR_Word) ((MR_hl_field(3, Type_11, 1))));

              if ((ArgTypes_97 == (MR_Word) ((MR_Unsigned) 0U)))
                {
                  Pieces_12 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              ...
              else
              {
...

                {
                  ...
                  MR_hl_field(0, Var_79, 0) = ((MR_Box) (&parse_tree__error_type_util_scalar_common_4[0]));
                  MR_hl_field(0, Var_79, 1) = ((MR_Box) (parse_tree__error_type_util__type_pieces_5_f_0_3));
                  MR_hl_field(0, Var_79, 2) = ((MR_Box) ((MR_Integer) 4));
                  MR_hl_field(0, Var_79, 3) = ((MR_Box) (TVarSet_7));
                  MR_hl_field(0, Var_79, 4) = ((MR_Box) (InstVarSet_8));
                  MR_hl_field(0, Var_79, 5) = ((MR_Box) (VarNamePrint_9));
                  MR_hl_field(0, Var_79, 6) = ((MR_Box) ((MR_Unsigned) 0U));
                }
                ArgTypePiecesList_78 = mercury__list__map_2_f_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0), (MR_Word) (&parse_tree__error_type_util_scalar_common_1[1]), Var_79, ArgTypes_97);
                Var_82 = parse_tree__error_spec__pieces_list_to_line_pieces_1_f_0(ArgTypePiecesList_78);
                Var_83 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), (MR_Word) (MR_mkword(1, &parse_tree__error_type_util_scalar_common_1[11])), SuffixPieces_10);
                Var_81 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), Var_82, Var_83);
                Pieces_12 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), (MR_Word) (MR_mkword(1, &parse_tree__error_type_util_scalar_common_1[10])), Var_81);
              }
            }
            break;
          case (MR_Integer) 1:
