    ...
    switch (MR_tag((MR_Word) Type_11)) {
      ...
      case (MR_Integer) 1:
        {
          ...
          MR_Word Var_43;
          MR_Word ArgTypes_114 = ((MR_Word) ((MR_hl_field(1, Type_11, (MR_Integer) 1))));
          MR_String Const_115;
          MR_Word NonConstL_116;
          ...
          Const_115 = mercury__string__join_list_2_f_0((MR_String) ".", TypeCtorNameList_25);
          {
            Var_43 = (MR_Word) MR_mkword(2, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(2, Var_43, 0) = ((MR_Box) (Const_115));
          }
          {
            NonConstL_116 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(1, NonConstL_116, 0) = ((MR_Box) (Var_43));
            MR_hl_field(1, NonConstL_116, 1) = ((MR_Box) (MR_mkword(1, &parse_tree__error_type_util_scalar_common_1[9])));
          }
          if ((ArgTypes_114 == (MR_Word) ((MR_Unsigned) 0U)))
            {
              Pieces_12 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          ...
          else
          {
...

            {
              ...
              MR_hl_field(0, Var_96, 0) = ((MR_Box) (&parse_tree__error_type_util_scalar_common_4[0]));
              MR_hl_field(0, Var_96, 1) = ((MR_Box) (parse_tree__error_type_util__type_pieces_5_f_0_3));
              MR_hl_field(0, Var_96, 2) = ((MR_Box) ((MR_Integer) 4));
              MR_hl_field(0, Var_96, 3) = ((MR_Box) (TVarSet_7));
              MR_hl_field(0, Var_96, 4) = ((MR_Box) (InstVarSet_8));
              MR_hl_field(0, Var_96, 5) = ((MR_Box) (VarNamePrint_9));
              MR_hl_field(0, Var_96, 6) = ((MR_Box) ((MR_Unsigned) 0U));
            }
            ArgTypePiecesList_95 = mercury__list__map_2_f_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0), (MR_Word) (&parse_tree__error_type_util_scalar_common_1[1]), Var_96, ArgTypes_114);
            Var_99 = parse_tree__error_spec__component_list_to_line_pieces_2_f_0(ArgTypePiecesList_95, (MR_Word) (MR_mkword(1, &parse_tree__error_type_util_scalar_common_1[8])));
            Var_98 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), Var_99, SuffixPieces_10);
            Pieces_12 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), NonConstL_116, Var_98);
          }
        }
        break;
      case (MR_Integer) 2:
      ...
      case (MR_Integer) 3:
        switch (((MR_Integer) ((MR_hl_field(3, Type_11, (MR_Integer) 0))))) {
          ...
          case (MR_Integer) 0:
            {
              MR_Word ArgTypes_155 = ((MR_Word) ((MR_hl_field(3, Type_11, (MR_Integer) 1))));

              if ((ArgTypes_155 == (MR_Word) ((MR_Unsigned) 0U)))
                {
                  Pieces_12 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              ...
              else
              {
...

                {
                  ...
                  MR_hl_field(0, Var_137, 0) = ((MR_Box) (&parse_tree__error_type_util_scalar_common_4[0]));
                  MR_hl_field(0, Var_137, 1) = ((MR_Box) (parse_tree__error_type_util__type_pieces_5_f_0_4));
                  MR_hl_field(0, Var_137, 2) = ((MR_Box) ((MR_Integer) 4));
                  MR_hl_field(0, Var_137, 3) = ((MR_Box) (TVarSet_7));
                  MR_hl_field(0, Var_137, 4) = ((MR_Box) (InstVarSet_8));
                  MR_hl_field(0, Var_137, 5) = ((MR_Box) (VarNamePrint_9));
                  MR_hl_field(0, Var_137, 6) = ((MR_Box) ((MR_Unsigned) 0U));
                }
                ArgTypePiecesList_136 = mercury__list__map_2_f_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0), (MR_Word) (&parse_tree__error_type_util_scalar_common_1[1]), Var_137, ArgTypes_155);
                Var_140 = parse_tree__error_spec__component_list_to_line_pieces_2_f_0(ArgTypePiecesList_136, (MR_Word) (MR_mkword(1, &parse_tree__error_type_util_scalar_common_1[11])));
                Var_139 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), Var_140, SuffixPieces_10);
                Pieces_12 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), (MR_Word) (MR_mkword(1, &parse_tree__error_type_util_scalar_common_1[10])), Var_139);
              }
            }
            break;
          case (MR_Integer) 1:
          ...
          case (MR_Integer) 2:
            {
              ...
              MR_Word Var_61;
              MR_Word TVar_76 = ((MR_Word) ((MR_hl_field(3, Type_11, (MR_Integer) 1))));

              Const_27 = parse_tree__parse_tree_out_term__mercury_var_to_string_vs_3_f_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_tvar_type_0), TVarSet_7, VarNamePrint_9, TVar_76);
              {
              ...
              else
              {
                ...
                Var_75 = parse_tree__error_spec__component_list_to_line_pieces_2_f_0(ArgTypePiecesList_34, (MR_Word) (MR_mkword(1, &parse_tree__error_type_util_scalar_common_1[8])));
                Var_74 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), Var_75, SuffixPieces_10);
  ...
  MR_Word HigherOrderType_11)
{
  ...
  else
  {
    ...
    PorFStr_25 = parse_tree__parse_tree_out_misc__pred_or_func_to_full_str_1_f_0(PorF_13);
    HOPorF_26 = ((MR_Unsigned) ((MR_hl_field(0, PredInstInfo_24, (MR_Integer) 0))) & (MR_Integer) 1);
    ArgModes_27 = ((MR_Word) ((MR_hl_field(0, PredInstInfo_24, (MR_Integer) 1))));
    Detism_29 = ((MR_Unsigned) ((MR_hl_field(0, PredInstInfo_24, (MR_Integer) 3))) & (MR_Integer) 7);
    ...
    else
    {
      ...
      HOPorFStr_30 = parse_tree__parse_tree_out_misc__pred_or_func_to_full_str_1_f_0(HOPorF_26);
      {
      ...
      }
      {
        ...
        MR_hl_field(1, PorFMismatchPieces_22, 0) = ((MR_Box) ((MR_Unsigned) 8U));
    ...
    else
    {
      ...
      }
      {
        ...
        MR_hl_field(1, ArityMismatchPieces_23, 0) = ((MR_Box) ((MR_Unsigned) 8U));
  ...
  switch (PorF_13) {
    ...
    case (MR_Integer) 1:
      ...
      {
        MR_Word Var_181 = ((MR_Word) ((MR_hl_field(1, ArgPiecesList_18, (MR_Integer) 1))));
        MR_Word Var_182 = ((MR_Word) ((MR_hl_field(1, ArgPiecesList_18, (MR_Integer) 0))));
        ...
        if ((Var_181 == (MR_Word) ((MR_Unsigned) 0U)))
        {
          ...
          Var_134 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), Var_182, FuncResultSuffixPieces_20);
          Var_133 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), FuncResultPrefixPieces_19, Var_134);
          PorFArgBlockPieces_34 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), (MR_Word) (MR_mkword(1, &parse_tree__error_type_util_scalar_common_1[31])), Var_133);
        }
        else
        {
          ...
          Var_145 = parse_tree__error_spec__component_list_to_line_pieces_2_f_0(FuncArgPiecesList_41, (MR_Word) (MR_mkword(1, &parse_tree__error_type_util_scalar_common_1[8])));
          ...
          Var_151 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), (MR_Word) (MR_mkword(1, &parse_tree__error_type_util_scalar_common_1[30])), Var_156);
          Var_144 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), Var_145, Var_151);
          PorFArgBlockPieces_34 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), (MR_Word) (MR_mkword(1, &parse_tree__error_type_util_scalar_common_1[32])), Var_144);
        }
      }
      break;
    case (MR_Integer) 0:
      if ((ArgPiecesList_18 == (MR_Word) ((MR_Unsigned) 0U)))
        PorFArgBlockPieces_34 = (MR_Word) (MR_mkword(1, &parse_tree__error_type_util_scalar_common_1[33]));
      else
      {
        MR_Word Var_117;

        Var_117 = parse_tree__error_spec__component_list_to_line_pieces_2_f_0(ArgPiecesList_18, (MR_Word) (MR_mkword(1, &parse_tree__error_type_util_scalar_common_1[8])));
        PorFArgBlockPieces_34 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), (MR_Word) (MR_mkword(1, &parse_tree__error_type_util_scalar_common_1[34])), Var_117);
      }
      break;
  }
