...
{
  {
    ...
    else
    {
      ...
      MR_Word IntFileKind_35 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), IntSectionKind_9, (MR_Integer) 1))) >> 4)) & (MR_Integer) 3);
      MR_Word ImportLocn_36 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), IntSectionKind_9, (MR_Integer) 1))) >> 2)) & (MR_Integer) 3);
