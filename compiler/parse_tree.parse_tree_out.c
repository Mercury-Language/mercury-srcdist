...
{
  {
    ...
    else
    {
      ...
      MR_Word _UnconstrainedQVars_18;
      MR_Word _ConstrainedQVars_19;

      Constraints_14 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ExistConstraints_16, (MR_Integer) 1))));
      _UnconstrainedQVars_18 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ExistConstraints_16, (MR_Integer) 2))));
      _ConstrainedQVars_19 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ExistConstraints_16, (MR_Integer) 3))));
    ...
    if (succeeded)
    {
      BraceWrap_20 = (MR_Integer) 1;
      mercury__io__write_string_3_p_0((MR_String) "{ ");
    }
    else
      BraceWrap_20 = (MR_Integer) 0;
    if ((Args_10 == (MR_Word) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
    {
      ...
      {
        Var_31 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), Var_31, 0) = ((MR_Box) (Name_13));
      }
      parse_tree__mercury_to_mercury__mercury_output_bracketed_sym_name_3_p_0(Var_31);
      mercury__io__write_string_3_p_0((MR_String) " ");
    }
    else
    {
      MR_Word Arg_21 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Args_10, (MR_Integer) 0))));
      MR_Word Rest_22 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Args_10, (MR_Integer) 1))));
      MR_Word Var_35;
      MR_Word Name_56;
      MR_Word Type_57;
      MR_Word _Context_58;
      ...
      {
        Var_35 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), Var_35, 0) = ((MR_Box) (Name_13));
      }
      parse_tree__mercury_to_mercury__mercury_output_sym_name_3_p_0(Var_35);
      mercury__io__write_string_3_p_0((MR_String) "(");
      Name_56 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Arg_21, (MR_Integer) 0))));
      Type_57 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Arg_21, (MR_Integer) 1))));
      _Context_58 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Arg_21, (MR_Integer) 2))));
      if (!((Name_56 == (MR_Word) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))))))
      {
        MR_Word FieldName_65 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Name_56, (MR_Integer) 0))));
        MR_Word Name_67 = ((MR_Word) ((MR_hl_field(MR_mktag(0), FieldName_65, (MR_Integer) 0))));
        MR_Word _Ctxt_68 = ((MR_Word) ((MR_hl_field(MR_mktag(0), FieldName_65, (MR_Integer) 1))));

        parse_tree__mercury_to_mercury__mercury_output_bracketed_sym_name_3_p_0(Name_67);
        mercury__io__write_string_3_p_0((MR_String) " :: ");
      }
      parse_tree__mercury_to_mercury__mercury_output_type_5_p_0(TypeVarSet_5, (MR_Integer) 0, Type_57);
      parse_tree__parse_tree_out__mercury_output_remaining_ctor_args_4_p_0(TypeVarSet_5, Rest_22);
      mercury__io__write_string_3_p_0((MR_String) ")");
    }
    switch (BraceWrap_20) {
      default: /*NOTREACHED*/ MR_assert(0);
    ...
    Var_45 = (MR_Integer) 0;
    Var_46 = (MR_String) "=>";
    TypeClassInfo_for_output_50 = (MR_Word) (&parse_tree__parse_tree_out_scalar_common_1[1]);
    parse_tree__mercury_to_mercury__mercury_format_prog_constraint_list_6_p_0(TypeClassInfo_for_output_50, TypeVarSet_5, Var_45, Var_46, Constraints_14, ((MR_Box) ((MR_Integer) 0)), &conv0_STATE_VARIABLE_IO_47_47);
    switch (ParenWrap_15) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        {
