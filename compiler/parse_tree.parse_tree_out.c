  ...
  MR_Word ItemInstDefn_8)
{
  ...
  else
  {
    ...
    succeeded = mercury__list__all_true_2_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&parse_tree__parse_tree_out_scalar_common_2[7]), Names_108);
    if (succeeded)
    {
