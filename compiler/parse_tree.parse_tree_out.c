...
{
  {
    ...
    parse_tree__prog_out__write_sym_name_arity_3_p_0(((MR_Word) (wrapper_arg_1)));
  }
}
      ...
      case (MR_Integer) 2:
        {
          ...
          mercury__io__write_list_5_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_sym_name_arity_0), SymNameAndArities_20, (MR_String) ", ", (MR_Word) (&parse_tree__parse_tree_out_scalar_common_2[8]));
          mercury__io__write_string_3_p_0((MR_String) "])");
        }
        break;
      case (MR_Integer) 3:
