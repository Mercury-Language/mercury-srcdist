...
MR_def_label(bytecode_backend__bytecode__output_args_3_0,109)
	...
	MR_tfield(0, MR_r2, 1) = (MR_Word) MR_ENTRY_AP(bytecode_backend__bytecode__IntroducedFrom__pred__output_args__266__1_2_0);
...
MR_def_static(bytecode_backend__bytecode__debug_binop_3_0)
	...
	MR_r1 = (MR_Word) MR_string_const("&", 1);
	MR_np_call_localret_ent(io__write_string_3_0,
		bytecode_backend__bytecode__debug_binop_3_0_i42);
