...
struct bytecode_backend__bytecode__vector_common_type_3_0_s {
  const MR_Integer bytecode_backend__bytecode__vector_common_type_3_0__vct_3_f_0;
};

static /* final */ const struct bytecode_backend__bytecode__vector_common_type_3_0_s bytecode_backend__bytecode_vector_common_3[198];

struct bytecode_backend__bytecode__vector_common_type_5_0_s {
  const MR_String bytecode_backend__bytecode__vector_common_type_5_0__vct_5_f_0;
};

static /* final */ const struct bytecode_backend__bytecode__vector_common_type_5_0_s bytecode_backend__bytecode_vector_common_5[198];
...
static /* final */ const struct bytecode_backend__bytecode__vector_common_type_3_0_s bytecode_backend__bytecode_vector_common_3[198] = {
  ...
  /* row 158 */   { (MR_Integer) 191 },
  /* row 159 */   { (MR_Integer) 193 },
  /* row 160 */   { (MR_Integer) 195 },
  /* row 161 */   { (MR_Integer) 197 },
  /* row 162 */   { (MR_Integer) 199 },
  /* row 163 */   { (MR_Integer) 201 },
  /* row 164 */   { (MR_Integer) 203 },
  /* row 165 */   { (MR_Integer) 205 },
  /* row 166 */   { (MR_Integer) 207 },
  /* row 167 */   { (MR_Integer) 209 },
  /* row 168 */   { (MR_Integer) 6 },
  /* row 169 */   { (MR_Integer) 60 },
  /* row 170 */   { (MR_Integer) 76 },
  /* row 171 */   { (MR_Integer) 92 },
  /* row 172 */   { (MR_Integer) 108 },
  /* row 173 */   { (MR_Integer) 124 },
  /* row 174 */   { (MR_Integer) 140 },
  /* row 175 */   { (MR_Integer) 156 },
  /* row 176 */   { (MR_Integer) 172 },
  /* row 177 */   { (MR_Integer) 188 },
  /* row 178 */   { (MR_Integer) 192 },
  /* row 179 */   { (MR_Integer) 194 },
  /* row 180 */   { (MR_Integer) 196 },
  /* row 181 */   { (MR_Integer) 198 },
  /* row 182 */   { (MR_Integer) 200 },
  /* row 183 */   { (MR_Integer) 202 },
  /* row 184 */   { (MR_Integer) 204 },
  /* row 185 */   { (MR_Integer) 206 },
  /* row 186 */   { (MR_Integer) 208 },
  /* row 187 */   { (MR_Integer) 210 },
  /* row 188 */   { (MR_Integer) 6 },
  /* row 189 */   { (MR_Integer) 14 },
  /* row 190 */   { (MR_Integer) 15 },
  /* row 191 */   { (MR_Integer) 16 },
  /* row 192 */   { (MR_Integer) 17 },
  /* row 193 */   { (MR_Integer) 18 },
  /* row 194 */   { (MR_Integer) 19 },
  /* row 195 */   { (MR_Integer) 20 },
  /* row 196 */   { (MR_Integer) 21 },
  /* row 197 */   { (MR_Integer) 22 },
};
...
static /* final */ const struct bytecode_backend__bytecode__vector_common_type_5_0_s bytecode_backend__bytecode_vector_common_5[198] = {
  ...
  /* row 158 */   { (MR_String) "<<u" },
  /* row 159 */   { (MR_String) "<<u(uint)" },
  /* row 160 */   { (MR_String) "<<u(int8)" },
  /* row 161 */   { (MR_String) "<<u(uint8)" },
  /* row 162 */   { (MR_String) "<<u(int16)" },
  /* row 163 */   { (MR_String) "<<u(uint16)" },
  /* row 164 */   { (MR_String) "<<u(int32)" },
  /* row 165 */   { (MR_String) "<<u(uint32)" },
  /* row 166 */   { (MR_String) "<<u(int64)" },
  /* row 167 */   { (MR_String) "<<u(uint64)" },
  /* row 168 */   { (MR_String) ">>" },
  /* row 169 */   { (MR_String) ">>(uint)" },
  /* row 170 */   { (MR_String) ">>(int8)" },
  /* row 171 */   { (MR_String) ">>(uint8)" },
  /* row 172 */   { (MR_String) ">>(int16)" },
  /* row 173 */   { (MR_String) ">>(uint16)" },
  /* row 174 */   { (MR_String) ">>(int32)" },
  /* row 175 */   { (MR_String) ">>(uint32)" },
  /* row 176 */   { (MR_String) ">>(int64)" },
  /* row 177 */   { (MR_String) ">>(uint64)" },
  /* row 178 */   { (MR_String) ">>u" },
  /* row 179 */   { (MR_String) ">>u(uint)" },
  /* row 180 */   { (MR_String) ">>u(int8)" },
  /* row 181 */   { (MR_String) ">>u(uint8)" },
  /* row 182 */   { (MR_String) ">>u(int16)" },
  /* row 183 */   { (MR_String) ">>u(uint16)" },
  /* row 184 */   { (MR_String) ">>u(int32)" },
  /* row 185 */   { (MR_String) ">>u(uint32)" },
  /* row 186 */   { (MR_String) ">>u(int64)" },
  /* row 187 */   { (MR_String) ">>u(uint64)" },
  /* row 188 */   { (MR_String) "bitwise_complement(int)" },
  /* row 189 */   { (MR_String) "bitwise_complement(uint)" },
  /* row 190 */   { (MR_String) "bitwise_complement(int8)" },
  /* row 191 */   { (MR_String) "bitwise_complement(uint8)" },
  /* row 192 */   { (MR_String) "bitwise_complement(int16)" },
  /* row 193 */   { (MR_String) "bitwise_complement(uint16)" },
  /* row 194 */   { (MR_String) "bitwise_complement(int32)" },
  /* row 195 */   { (MR_String) "bitwise_complement(uint32)" },
  /* row 196 */   { (MR_String) "bitwise_complement(int64)" },
  /* row 197 */   { (MR_String) "bitwise_complement(uint64)" },
};
  ...
  MR_Word ByteCodes_6)
{
  ...
  {
    MR_Word FileStream_9 = ((MR_Word) ((MR_hl_field(0, Result_8, (MR_Integer) 0))));
  ...
  MR_Word HeadVar__1_1)
{
  while (MR_TRUE)
  {
    ...
    {
      MR_Word ByteCode_7 = ((MR_Word) ((MR_hl_field(1, HeadVar__1_1, (MR_Integer) 0))));
      MR_Word ByteCodes_8 = ((MR_Word) ((MR_hl_field(1, HeadVar__1_1, (MR_Integer) 1))));
      MR_String Debug_10;
      ...
      switch (MR_tag((MR_Word) ByteCode_7)) {
        ...
        case (MR_Integer) 2:
          ...
          break;
        case (MR_Integer) 3:
          switch (((MR_Integer) ((MR_hl_field(3, ByteCode_7, (MR_Integer) 0))))) {
            default: /*NOTREACHED*/ MR_assert(0);
            case (MR_Integer) 0:
      ...
      mercury__io__write_string_3_p_0(Debug_10);
  ...
  MR_Word HeadVar__1_1)
{
  switch (MR_tag((MR_Word) HeadVar__1_1)) {
    ...
    case (MR_Integer) 1:
      {
        MR_String PredId_4 = ((MR_String) ((MR_hl_field(1, HeadVar__1_1, (MR_Integer) 0))));
        MR_Integer PredArity_5 = ((MR_Integer) ((MR_hl_field(1, HeadVar__1_1, (MR_Integer) 1))));
        MR_Integer IsFunc_6 = ((MR_Integer) ((MR_hl_field(1, HeadVar__1_1, (MR_Integer) 2))));
        MR_Integer ProcsCount_7 = ((MR_Integer) ((MR_hl_field(1, HeadVar__1_1, (MR_Integer) 3))));
    ...
    case (MR_Integer) 2:
      {
        MR_Integer ProcId_18 = ((MR_Integer) ((MR_hl_field(2, HeadVar__1_1, (MR_Integer) 0))));
        MR_Word Detism_19 = ((MR_Unsigned) ((MR_hl_field(2, HeadVar__1_1, (MR_Integer) 1))) & (MR_Integer) 7);
        MR_Integer LabelCount_20 = ((MR_Integer) ((MR_hl_field(2, HeadVar__1_1, (MR_Integer) 2))));
        MR_Integer LabelId_21 = ((MR_Integer) ((MR_hl_field(2, HeadVar__1_1, (MR_Integer) 3))));
        MR_Integer TempCount_22 = ((MR_Integer) ((MR_hl_field(2, HeadVar__1_1, (MR_Integer) 4))));
        MR_Word Vars_23 = ((MR_Word) ((MR_hl_field(2, HeadVar__1_1, (MR_Integer) 5))));
    ...
    case (MR_Integer) 3:
      switch (((MR_Integer) ((MR_hl_field(3, HeadVar__1_1, (MR_Integer) 0))))) {
        ...
        case (MR_Integer) 0:
          {
            MR_Integer LabelId_38 = ((MR_Integer) ((MR_hl_field(3, HeadVar__1_1, (MR_Integer) 1))));
        ...
        case (MR_Integer) 1:
          {
            MR_Integer LabelId_43 = ((MR_Integer) ((MR_hl_field(3, HeadVar__1_1, (MR_Integer) 1))));
        ...
        case (MR_Integer) 2:
          {
            MR_Integer LabelId_51 = ((MR_Integer) ((MR_hl_field(3, HeadVar__1_1, (MR_Integer) 1))));
        ...
        case (MR_Integer) 3:
          {
            MR_Integer LabelId_56 = ((MR_Integer) ((MR_hl_field(3, HeadVar__1_1, (MR_Integer) 1))));
        ...
        case (MR_Integer) 4:
          {
            MR_Integer Var_61 = ((MR_Integer) ((MR_hl_field(3, HeadVar__1_1, (MR_Integer) 1))));
            MR_Integer LabelId_62 = ((MR_Integer) ((MR_hl_field(3, HeadVar__1_1, (MR_Integer) 2))));
        ...
        case (MR_Integer) 5:
          {
            MR_Word MainConsId_71 = ((MR_Word) ((MR_hl_field(3, HeadVar__1_1, (MR_Integer) 1))));
            MR_Word OtherConsIds_72 = ((MR_Word) ((MR_hl_field(3, HeadVar__1_1, (MR_Integer) 2))));
            MR_Integer NextLabelId_73 = ((MR_Integer) ((MR_hl_field(3, HeadVar__1_1, (MR_Integer) 3))));
        ...
        case (MR_Integer) 6:
          {
            MR_Integer LabelId_81 = ((MR_Integer) ((MR_hl_field(3, HeadVar__1_1, (MR_Integer) 1))));
        ...
        case (MR_Integer) 7:
          {
            MR_Integer ElseLabelId_86 = ((MR_Integer) ((MR_hl_field(3, HeadVar__1_1, (MR_Integer) 1))));
            MR_Integer FollowLabelId_87 = ((MR_Integer) ((MR_hl_field(3, HeadVar__1_1, (MR_Integer) 2))));
            MR_Integer FramePtrTemp_88 = ((MR_Integer) ((MR_hl_field(3, HeadVar__1_1, (MR_Integer) 3))));
        ...
        case (MR_Integer) 8:
          {
            MR_Integer FramePtrTemp_95 = ((MR_Integer) ((MR_hl_field(3, HeadVar__1_1, (MR_Integer) 1))));
        ...
        case (MR_Integer) 9:
          {
            MR_Integer FollowLabelId_100 = ((MR_Integer) ((MR_hl_field(3, HeadVar__1_1, (MR_Integer) 1))));
        ...
        case (MR_Integer) 10:
          {
            MR_Integer FramePtrTemp_105 = ((MR_Integer) ((MR_hl_field(3, HeadVar__1_1, (MR_Integer) 1))));
        ...
        case (MR_Integer) 11:
          {
            MR_Integer FramePtrTemp_113 = ((MR_Integer) ((MR_hl_field(3, HeadVar__1_1, (MR_Integer) 1))));
            MR_Integer LabelId_114 = ((MR_Integer) ((MR_hl_field(3, HeadVar__1_1, (MR_Integer) 2))));
        ...
        case (MR_Integer) 12:
          {
            MR_Integer FramePtrTemp_120 = ((MR_Integer) ((MR_hl_field(3, HeadVar__1_1, (MR_Integer) 1))));
        ...
        case (MR_Integer) 13:
          {
            MR_Integer Temp_128 = ((MR_Integer) ((MR_hl_field(3, HeadVar__1_1, (MR_Integer) 1))));
        ...
        case (MR_Integer) 14:
          {
            MR_Integer Temp_133 = ((MR_Integer) ((MR_hl_field(3, HeadVar__1_1, (MR_Integer) 1))));
        ...
        case (MR_Integer) 15:
          {
            MR_Integer Var1_138 = ((MR_Integer) ((MR_hl_field(3, HeadVar__1_1, (MR_Integer) 1))));
            MR_Integer Var2_139 = ((MR_Integer) ((MR_hl_field(3, HeadVar__1_1, (MR_Integer) 2))));
        ...
        case (MR_Integer) 16:
          {
            MR_Integer Var1_145 = ((MR_Integer) ((MR_hl_field(3, HeadVar__1_1, (MR_Integer) 1))));
            MR_Integer Var2_146 = ((MR_Integer) ((MR_hl_field(3, HeadVar__1_1, (MR_Integer) 2))));
            MR_Word TestId_147 = ((MR_Unsigned) ((MR_hl_field(3, HeadVar__1_1, (MR_Integer) 3))) & (MR_Integer) 7);
        ...
        case (MR_Integer) 17:
          {
            MR_Integer Var_154 = ((MR_Integer) ((MR_hl_field(3, HeadVar__1_1, (MR_Integer) 1))));
            MR_Word ConsId_155 = ((MR_Word) ((MR_hl_field(3, HeadVar__1_1, (MR_Integer) 2))));
            MR_Word Vars_156 = ((MR_Word) ((MR_hl_field(3, HeadVar__1_1, (MR_Integer) 3))));
        ...
        case (MR_Integer) 18:
          {
            MR_Integer Var_165 = ((MR_Integer) ((MR_hl_field(3, HeadVar__1_1, (MR_Integer) 1))));
            MR_Word ConsId_166 = ((MR_Word) ((MR_hl_field(3, HeadVar__1_1, (MR_Integer) 2))));
            MR_Word Vars_167 = ((MR_Word) ((MR_hl_field(3, HeadVar__1_1, (MR_Integer) 3))));
        ...
        case (MR_Integer) 19:
          {
            MR_Integer Var_176 = ((MR_Integer) ((MR_hl_field(3, HeadVar__1_1, (MR_Integer) 1))));
            MR_Word ConsId_177 = ((MR_Word) ((MR_hl_field(3, HeadVar__1_1, (MR_Integer) 2))));
            MR_Word VarDirs_178 = ((MR_Word) ((MR_hl_field(3, HeadVar__1_1, (MR_Integer) 3))));
        ...
        case (MR_Integer) 20:
          {
            MR_Integer Var_187 = ((MR_Integer) ((MR_hl_field(3, HeadVar__1_1, (MR_Integer) 1))));
            MR_Word ConsId_188 = ((MR_Word) ((MR_hl_field(3, HeadVar__1_1, (MR_Integer) 2))));
            MR_Word VarDirs_189 = ((MR_Word) ((MR_hl_field(3, HeadVar__1_1, (MR_Integer) 3))));
        ...
        case (MR_Integer) 21:
          {
            MR_Integer RegNum_199 = ((MR_Integer) ((MR_hl_field(3, HeadVar__1_1, (MR_Integer) 2))));
            MR_Integer Var_200 = ((MR_Integer) ((MR_hl_field(3, HeadVar__1_1, (MR_Integer) 3))));
        ...
        case (MR_Integer) 22:
          {
            MR_Integer RegNum_207 = ((MR_Integer) ((MR_hl_field(3, HeadVar__1_1, (MR_Integer) 2))));
            MR_Integer Var_208 = ((MR_Integer) ((MR_hl_field(3, HeadVar__1_1, (MR_Integer) 3))));
        ...
        case (MR_Integer) 23:
          {
            MR_Word ModuleId_214 = ((MR_Word) ((MR_hl_field(3, HeadVar__1_1, (MR_Integer) 1))));
            MR_String PredId_215 = ((MR_String) ((MR_hl_field(3, HeadVar__1_1, (MR_Integer) 2))));
            MR_Integer Arity_216 = ((MR_Integer) ((MR_hl_field(3, HeadVar__1_1, (MR_Integer) 3))));
            MR_Integer IsFunc_217 = ((MR_Integer) ((MR_hl_field(3, HeadVar__1_1, (MR_Integer) 4))));
            MR_Integer ProcId_218 = ((MR_Integer) ((MR_hl_field(3, HeadVar__1_1, (MR_Integer) 5))));
        ...
        case (MR_Integer) 24:
          {
            MR_Integer PredVar_227 = ((MR_Integer) ((MR_hl_field(3, HeadVar__1_1, (MR_Integer) 1))));
            MR_Integer InVarCount_228 = ((MR_Integer) ((MR_hl_field(3, HeadVar__1_1, (MR_Integer) 2))));
            MR_Integer OutVarCount_229 = ((MR_Integer) ((MR_hl_field(3, HeadVar__1_1, (MR_Integer) 3))));
            MR_Word Detism_230 = ((MR_Unsigned) ((MR_hl_field(3, HeadVar__1_1, (MR_Integer) 4))) & (MR_Integer) 7);
        ...
        case (MR_Integer) 25:
          {
            MR_Word Binop_238 = ((MR_Word) ((MR_hl_field(3, HeadVar__1_1, (MR_Integer) 1))));
            MR_Word Var1_239 = ((MR_Word) ((MR_hl_field(3, HeadVar__1_1, (MR_Integer) 2))));
            MR_Word Var2_240 = ((MR_Word) ((MR_hl_field(3, HeadVar__1_1, (MR_Integer) 3))));
            MR_Integer Var3_241 = ((MR_Integer) ((MR_hl_field(3, HeadVar__1_1, (MR_Integer) 4))));
        ...
        case (MR_Integer) 26:
          {
            MR_Word Unop_249 = ((MR_Word) ((MR_hl_field(3, HeadVar__1_1, (MR_Integer) 1))));
            MR_Word Var1_250 = ((MR_Word) ((MR_hl_field(3, HeadVar__1_1, (MR_Integer) 2))));
            MR_Integer Var2_251 = ((MR_Integer) ((MR_hl_field(3, HeadVar__1_1, (MR_Integer) 3))));
        ...
        case (MR_Integer) 27:
          {
            MR_Word Binop_258 = ((MR_Word) ((MR_hl_field(3, HeadVar__1_1, (MR_Integer) 1))));
            MR_Word Var1_259 = ((MR_Word) ((MR_hl_field(3, HeadVar__1_1, (MR_Integer) 2))));
            MR_Word Var2_260 = ((MR_Word) ((MR_hl_field(3, HeadVar__1_1, (MR_Integer) 3))));
        ...
        case (MR_Integer) 28:
          {
            MR_Word Unop_267 = ((MR_Word) ((MR_hl_field(3, HeadVar__1_1, (MR_Integer) 1))));
            MR_Word Var1_268 = ((MR_Word) ((MR_hl_field(3, HeadVar__1_1, (MR_Integer) 2))));
        ...
        case (MR_Integer) 29:
          {
            MR_Integer Line_283 = ((MR_Integer) ((MR_hl_field(3, HeadVar__1_1, (MR_Integer) 1))));
  ...
  MR_Word Unop_4)
{
  ...
  switch (MR_tag((MR_Word) Unop_4)) {
    ...
    case (MR_Integer) 1:
      {
        MR_Word Var_19 = ((MR_Unsigned) ((MR_hl_field(1, Unop_4, (MR_Integer) 0))) & (MR_Integer) 15);

        Debug_6 = ((&bytecode_backend__bytecode_vector_common_5[188 + Var_19]))->bytecode_backend__bytecode__vector_common_type_5_0__vct_5_f_0;
      }
      break;
  }
    ...
    case (MR_Integer) 1:
      {
        ...
        *HeadVar__2_2 = ((&bytecode_backend__bytecode_vector_common_5[48 + Var_229]))->bytecode_backend__bytecode__vector_common_type_5_0__vct_5_f_0;
      }
      break;
    case (MR_Integer) 2:
      {
        ...
        *HeadVar__2_2 = ((&bytecode_backend__bytecode_vector_common_5[128 + Var_237]))->bytecode_backend__bytecode__vector_common_type_5_0__vct_5_f_0;
      }
      break;
    case (MR_Integer) 3:
      switch (((MR_Integer) ((MR_hl_field(3, HeadVar__1_1, (MR_Integer) 0))))) {
        ...
        case (MR_Integer) 0:
          {
            ...
            *HeadVar__2_2 = ((&bytecode_backend__bytecode_vector_common_5[118 + Var_236]))->bytecode_backend__bytecode__vector_common_type_5_0__vct_5_f_0;
          }
          break;
        case (MR_Integer) 1:
          {
            ...
            *HeadVar__2_2 = ((&bytecode_backend__bytecode_vector_common_5[58 + Var_230]))->bytecode_backend__bytecode__vector_common_type_5_0__vct_5_f_0;
          }
          break;
        case (MR_Integer) 2:
          {
            ...
            *HeadVar__2_2 = ((&bytecode_backend__bytecode_vector_common_5[108 + Var_235]))->bytecode_backend__bytecode__vector_common_type_5_0__vct_5_f_0;
          }
          break;
        case (MR_Integer) 3:
          {
            ...
            switch (Var_239) {
              default: /*NOTREACHED*/ MR_assert(0);
              case (MR_Integer) 0:
                *HeadVar__2_2 = ((&bytecode_backend__bytecode_vector_common_5[148 + Var_240]))->bytecode_backend__bytecode__vector_common_type_5_0__vct_5_f_0;
                break;
              case (MR_Integer) 1:
                *HeadVar__2_2 = ((&bytecode_backend__bytecode_vector_common_5[158 + Var_240]))->bytecode_backend__bytecode__vector_common_type_5_0__vct_5_f_0;
                break;
            }
          }
          break;
        case (MR_Integer) 4:
          {
            ...
            switch (Var_241) {
              default: /*NOTREACHED*/ MR_assert(0);
              case (MR_Integer) 0:
                *HeadVar__2_2 = ((&bytecode_backend__bytecode_vector_common_5[168 + Var_242]))->bytecode_backend__bytecode__vector_common_type_5_0__vct_5_f_0;
                break;
              case (MR_Integer) 1:
                *HeadVar__2_2 = ((&bytecode_backend__bytecode_vector_common_5[178 + Var_242]))->bytecode_backend__bytecode__vector_common_type_5_0__vct_5_f_0;
                break;
            }
          }
          break;
        case (MR_Integer) 5:
          {
            ...
            *HeadVar__2_2 = ((&bytecode_backend__bytecode_vector_common_5[8 + Var_225]))->bytecode_backend__bytecode__vector_common_type_5_0__vct_5_f_0;
          }
          break;
        case (MR_Integer) 6:
          {
            ...
            *HeadVar__2_2 = ((&bytecode_backend__bytecode_vector_common_5[18 + Var_226]))->bytecode_backend__bytecode__vector_common_type_5_0__vct_5_f_0;
          }
          break;
        case (MR_Integer) 7:
          {
            ...
            *HeadVar__2_2 = ((&bytecode_backend__bytecode_vector_common_5[28 + Var_227]))->bytecode_backend__bytecode__vector_common_type_5_0__vct_5_f_0;
          }
          break;
        case (MR_Integer) 8:
          {
            ...
            *HeadVar__2_2 = ((&bytecode_backend__bytecode_vector_common_5[38 + Var_228]))->bytecode_backend__bytecode__vector_common_type_5_0__vct_5_f_0;
          }
          break;
        case (MR_Integer) 9:
          {
            ...
            *HeadVar__2_2 = ((&bytecode_backend__bytecode_vector_common_5[138 + Var_238]))->bytecode_backend__bytecode__vector_common_type_5_0__vct_5_f_0;
          }
          break;
        case (MR_Integer) 10:
        ...
        case (MR_Integer) 12:
          {
            ...
            *HeadVar__2_2 = ((&bytecode_backend__bytecode_vector_common_5[98 + Var_234]))->bytecode_backend__bytecode__vector_common_type_5_0__vct_5_f_0;
          }
          break;
        case (MR_Integer) 13:
          {
            ...
            *HeadVar__2_2 = ((&bytecode_backend__bytecode_vector_common_5[78 + Var_232]))->bytecode_backend__bytecode__vector_common_type_5_0__vct_5_f_0;
          }
          break;
        case (MR_Integer) 14:
          {
            ...
            *HeadVar__2_2 = ((&bytecode_backend__bytecode_vector_common_5[88 + Var_233]))->bytecode_backend__bytecode__vector_common_type_5_0__vct_5_f_0;
          }
          break;
        case (MR_Integer) 15:
          {
            ...
            *HeadVar__2_2 = ((&bytecode_backend__bytecode_vector_common_5[68 + Var_231]))->bytecode_backend__bytecode__vector_common_type_5_0__vct_5_f_0;
          }
          break;
      }
      break;
  ...
  MR_Word HeadVar__1_1)
{
  switch (MR_tag((MR_Word) HeadVar__1_1)) {
    ...
    case (MR_Integer) 1:
      {
        MR_Word ModuleId_4 = ((MR_Word) ((MR_hl_field(1, HeadVar__1_1, (MR_Integer) 0))));
        MR_String Functor_5 = ((MR_String) ((MR_hl_field(1, HeadVar__1_1, (MR_Integer) 1))));
        MR_Integer Arity_6 = ((MR_Integer) ((MR_hl_field(1, HeadVar__1_1, (MR_Integer) 2))));
        MR_Word Tag_7 = ((MR_Word) ((MR_hl_field(1, HeadVar__1_1, (MR_Integer) 3))));

        mercury__io__write_string_3_p_0((MR_String) "functor");
        mercury__io__write_char_3_p_0((MR_Char) 32);
    ...
    case (MR_Integer) 2:
      {
        MR_Integer IntVal_17 = ((MR_Integer) ((MR_hl_field(2, HeadVar__1_1, (MR_Integer) 0))));
    ...
    case (MR_Integer) 3:
      switch (((MR_Integer) ((MR_hl_field(3, HeadVar__1_1, (MR_Integer) 0))))) {
        ...
        case (MR_Integer) 0:
          {
            MR_String StringVal_24 = ((MR_String) ((MR_hl_field(3, HeadVar__1_1, (MR_Integer) 1))));
        ...
        case (MR_Integer) 1:
          {
            MR_Float FloatVal_31 = MR_unbox_float((MR_hl_field(3, HeadVar__1_1, (MR_Integer) 1)));
        ...
        case (MR_Integer) 2:
          {
            MR_Char Char_82 = ((MR_Char) (MR_Word) (MR_hl_field(3, HeadVar__1_1, (MR_Integer) 1)));
            MR_String String_84;
            MR_Word Var_89;

            mercury__io__write_string_3_p_0((MR_String) "char_const");
            mercury__io__write_char_3_p_0((MR_Char) 32);
            {
              Var_89 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(1, Var_89, 0) = ((MR_Box) (MR_Word) (Char_82));
        ...
        case (MR_Integer) 3:
          {
            MR_Word ModuleId_38 = ((MR_Word) ((MR_hl_field(3, HeadVar__1_1, (MR_Integer) 1))));
            MR_String PredId_39 = ((MR_String) ((MR_hl_field(3, HeadVar__1_1, (MR_Integer) 2))));
            MR_Integer Arity_40 = ((MR_Integer) ((MR_hl_field(3, HeadVar__1_1, (MR_Integer) 3))));
            MR_Integer IsFunc_41 = ((MR_Integer) ((MR_hl_field(3, HeadVar__1_1, (MR_Integer) 4))));
            MR_Integer ProcId_42 = ((MR_Integer) ((MR_hl_field(3, HeadVar__1_1, (MR_Integer) 5))));

            bytecode_backend__bytecode__debug_string_3_p_0((MR_String) "pred_const");
            bytecode_backend__bytecode__debug_sym_name_3_p_0(ModuleId_38);
        ...
        case (MR_Integer) 4:
          {
            MR_Word ModuleId_53 = ((MR_Word) ((MR_hl_field(3, HeadVar__1_1, (MR_Integer) 1))));
            MR_String TypeName_54 = ((MR_String) ((MR_hl_field(3, HeadVar__1_1, (MR_Integer) 2))));
            MR_Integer TypeArity_55 = ((MR_Integer) ((MR_hl_field(3, HeadVar__1_1, (MR_Integer) 3))));

            bytecode_backend__bytecode__debug_string_3_p_0((MR_String) "type_ctor_info_const");
            bytecode_backend__bytecode__debug_sym_name_3_p_0(ModuleId_53);
        ...
        case (MR_Integer) 5:
          {
            MR_Word ModuleId_64 = ((MR_Word) ((MR_hl_field(3, HeadVar__1_1, (MR_Integer) 1))));
            MR_Word ClassName_65;
            MR_Integer ClassArity_66;
            MR_String Instance_67 = ((MR_String) ((MR_hl_field(3, HeadVar__1_1, (MR_Integer) 3))));
            MR_Word Var_71 = ((MR_Word) ((MR_hl_field(3, HeadVar__1_1, (MR_Integer) 2))));

            ClassName_65 = ((MR_Word) ((MR_hl_field(0, Var_71, (MR_Integer) 0))));
            ClassArity_66 = ((MR_Integer) ((MR_hl_field(0, Var_71, (MR_Integer) 1))));
            mercury__io__write_string_3_p_0((MR_String) "base_typeclass_info_const");
            mercury__io__write_char_3_p_0((MR_Char) 32);
            bytecode_backend__bytecode__debug_sym_name_3_p_0(ModuleId_64);
            mercury__io__write_string_3_p_0((MR_String) "class_id");
            mercury__io__write_char_3_p_0((MR_Char) 32);
            bytecode_backend__bytecode__debug_sym_name_3_p_0(ClassName_65);
            mercury__io__write_string_3_p_0((MR_String) "/");
            mercury__io__write_char_3_p_0((MR_Char) 32);
            mercury__io__write_int_3_p_0(ClassArity_66);
            mercury__io__write_char_3_p_0((MR_Char) 32);
            mercury__io__write_string_3_p_0(Instance_67);
            mercury__io__write_char_3_p_0((MR_Char) 32);
          }
          break;
      }
  ...
  MR_String Str_4)
{
  ...
  backend_libs__c_util__output_quoted_string_c_4_p_0(Stream_6, Str_4);
  ...
  MR_Word HeadVar__1_1)
{
  switch (MR_tag((MR_Word) HeadVar__1_1)) {
    ...
    case (MR_Integer) 1:
      {
        MR_Integer Primary_4 = ((MR_Integer) ((MR_hl_field(1, HeadVar__1_1, (MR_Integer) 0))));

        mercury__io__write_string_3_p_0((MR_String) "unshared_tag");
        mercury__io__write_char_3_p_0((MR_Char) 32);
        mercury__io__write_int_3_p_0(Primary_4);
        mercury__io__write_char_3_p_0((MR_Char) 32);
      }
      break;
    case (MR_Integer) 2:
      {
        MR_Integer Primary_11 = ((MR_Integer) ((MR_hl_field(2, HeadVar__1_1, (MR_Integer) 0))));
        MR_Integer Secondary_12 = ((MR_Integer) ((MR_hl_field(2, HeadVar__1_1, (MR_Integer) 1))));

        mercury__io__write_string_3_p_0((MR_String) "shared_remote_tag");
        mercury__io__write_char_3_p_0((MR_Char) 32);
        mercury__io__write_int_3_p_0(Primary_11);
        mercury__io__write_char_3_p_0((MR_Char) 32);
        mercury__io__write_int_3_p_0(Secondary_12);
        mercury__io__write_char_3_p_0((MR_Char) 32);
      }
      break;
    case (MR_Integer) 3:
      switch (((MR_Integer) ((MR_hl_field(3, HeadVar__1_1, (MR_Integer) 0))))) {
        ...
        case (MR_Integer) 0:
          {
            MR_Integer Primary_20 = ((MR_Integer) ((MR_hl_field(3, HeadVar__1_1, (MR_Integer) 1))));
            MR_Integer Secondary_21 = ((MR_Integer) ((MR_hl_field(3, HeadVar__1_1, (MR_Integer) 2))));
        ...
        case (MR_Integer) 1:
          {
            MR_Integer Enum_29 = ((MR_Integer) ((MR_hl_field(3, HeadVar__1_1, (MR_Integer) 1))));
  ...
  MR_Word HeadVar__1_1)
{
  ...
  {
    MR_Word Module_11 = ((MR_Word) ((MR_hl_field(1, HeadVar__1_1, (MR_Integer) 0))));
    MR_String Val_12 = ((MR_String) ((MR_hl_field(1, HeadVar__1_1, (MR_Integer) 1))));
  ...
  {
    MR_String Val_4 = ((MR_String) ((MR_hl_field(0, HeadVar__1_1, (MR_Integer) 0))));
  ...
  MR_Word HeadVar__1_1)
{
  while (MR_TRUE)
  {
    ...
    if (!((HeadVar__1_1 == (MR_Word) ((MR_Unsigned) 0U))))
    {
      MR_Integer Var_7;
      MR_Word Dir_8;
      MR_Word VarDirs_9 = ((MR_Word) ((MR_hl_field(1, HeadVar__1_1, (MR_Integer) 1))));
      MR_Word Var_13 = ((MR_Word) ((MR_hl_field(1, HeadVar__1_1, (MR_Integer) 0))));
      MR_Word next_value_of_HeadVar__1_1;

      Var_7 = ((MR_Integer) ((MR_hl_field(0, Var_13, (MR_Integer) 0))));
      Dir_8 = ((MR_Word) ((MR_hl_field(0, Var_13, (MR_Integer) 1))));
  ...
  MR_Word HeadVar__1_1)
{
  while (MR_TRUE)
  {
    ...
    if (!((HeadVar__1_1 == (MR_Word) ((MR_Unsigned) 0U))))
    {
      MR_Integer Var_7 = ((MR_Integer) ((MR_hl_field(1, HeadVar__1_1, (MR_Integer) 0))));
  ...
  MR_Word HeadVar__1_1)
{
  switch (MR_tag((MR_Word) HeadVar__1_1)) {
    ...
    case (MR_Integer) 0:
      {
        MR_Integer Var_4 = ((MR_Integer) ((MR_hl_field(0, HeadVar__1_1, (MR_Integer) 0))));
    ...
    case (MR_Integer) 1:
      {
        MR_Integer IntVal_11 = ((MR_Integer) ((MR_hl_field(1, HeadVar__1_1, (MR_Integer) 0))));
    ...
    case (MR_Integer) 2:
      {
        MR_Float FloatVal_81 = MR_unbox_float((MR_hl_field(2, HeadVar__1_1, (MR_Integer) 0)));

        mercury__io__write_string_3_p_0((MR_String) "float");
        mercury__io__write_char_3_p_0((MR_Char) 32);
        mercury__io__write_float_3_p_0(FloatVal_81);
        mercury__io__write_char_3_p_0((MR_Char) 32);
      }
      break;
    case (MR_Integer) 3:
      switch (((MR_Integer) ((MR_hl_field(3, HeadVar__1_1, (MR_Integer) 0))))) {
        ...
        case (MR_Integer) 0:
          {
            MR_Unsigned UIntVal_18 = ((MR_Unsigned) ((MR_hl_field(3, HeadVar__1_1, (MR_Integer) 1))));
        ...
        case (MR_Integer) 1:
          {
            int8_t Int8Val_25 = ((int8_t) (MR_Word) (MR_hl_field(3, HeadVar__1_1, (MR_Integer) 1)));

            mercury__io__write_string_3_p_0((MR_String) "int8");
            mercury__io__write_char_3_p_0((MR_Char) 32);
            mercury__io__write_int8_3_p_0(Int8Val_25);
            mercury__io__write_char_3_p_0((MR_Char) 32);
          }
          break;
        case (MR_Integer) 2:
          {
            uint8_t UInt8Val_32 = ((uint8_t) (MR_Word) (MR_hl_field(3, HeadVar__1_1, (MR_Integer) 1)));
        ...
        case (MR_Integer) 3:
          {
            int16_t Int16Val_39 = ((int16_t) (MR_Word) (MR_hl_field(3, HeadVar__1_1, (MR_Integer) 1)));

            mercury__io__write_string_3_p_0((MR_String) "int16");
            mercury__io__write_char_3_p_0((MR_Char) 32);
            mercury__io__write_int16_3_p_0(Int16Val_39);
            mercury__io__write_char_3_p_0((MR_Char) 32);
          }
          break;
        case (MR_Integer) 4:
          {
            uint16_t UInt16Val_46 = ((uint16_t) (MR_Word) (MR_hl_field(3, HeadVar__1_1, (MR_Integer) 1)));

            mercury__io__write_string_3_p_0((MR_String) "uint16");
            mercury__io__write_char_3_p_0((MR_Char) 32);
            mercury__io__write_uint16_3_p_0(UInt16Val_46);
            mercury__io__write_char_3_p_0((MR_Char) 32);
          }
          break;
        case (MR_Integer) 5:
          {
            int32_t Int32Val_53 = ((int32_t) (MR_Word) (MR_hl_field(3, HeadVar__1_1, (MR_Integer) 1)));

            mercury__io__write_string_3_p_0((MR_String) "int32");
            mercury__io__write_char_3_p_0((MR_Char) 32);
            mercury__io__write_int32_3_p_0(Int32Val_53);
            mercury__io__write_char_3_p_0((MR_Char) 32);
          }
          break;
        case (MR_Integer) 6:
          {
            uint32_t UInt32Val_60 = ((uint32_t) (MR_Word) (MR_hl_field(3, HeadVar__1_1, (MR_Integer) 1)));

            mercury__io__write_string_3_p_0((MR_String) "uint32");
            mercury__io__write_char_3_p_0((MR_Char) 32);
            mercury__io__write_uint32_3_p_0(UInt32Val_60);
            mercury__io__write_char_3_p_0((MR_Char) 32);
          }
          break;
        case (MR_Integer) 7:
          {
            int64_t Int64Val_67 = MR_unbox_int64((MR_hl_field(3, HeadVar__1_1, (MR_Integer) 1)));

            mercury__io__write_string_3_p_0((MR_String) "int64");
            mercury__io__write_char_3_p_0((MR_Char) 32);
            mercury__io__write_int64_3_p_0(Int64Val_67);
            mercury__io__write_char_3_p_0((MR_Char) 32);
          }
          break;
        case (MR_Integer) 8:
          {
            uint64_t UInt64Val_74 = MR_unbox_uint64((MR_hl_field(3, HeadVar__1_1, (MR_Integer) 1)));

            mercury__io__write_string_3_p_0((MR_String) "uint64");
            mercury__io__write_char_3_p_0((MR_Char) 32);
  ...
  MR_Word HeadVar__1_1)
{
  while (MR_TRUE)
  {
    ...
    if (!((HeadVar__1_1 == (MR_Word) ((MR_Unsigned) 0U))))
    {
      ...
      MR_Word Vars_8 = ((MR_Word) ((MR_hl_field(1, HeadVar__1_1, (MR_Integer) 1))));
      MR_String Name_13 = ((MR_String) ((MR_hl_field(0, Var_7, (MR_Integer) 0))));
      MR_Word next_value_of_HeadVar__1_1;

      mercury__io__write_string_3_p_0(Name_13);
      mercury__io__write_char_3_p_0((MR_Char) 32);
      // direct tailcall eliminated
      ;
      next_value_of_HeadVar__1_1 = Vars_8;
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = bytecode_backend__bytecode__IntroducedFrom__pred__output_args__275__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 4)))));
  return succeeded;
}
  ...
  switch (MR_tag((MR_Word) HeadVar__1_1)) {
    ...
    case (MR_Integer) 1:
      {
        ...
        MR_Integer PredArity_5 = ((MR_Integer) ((MR_hl_field(1, HeadVar__1_1, (MR_Integer) 1))));
        MR_Integer IsFunc_6 = ((MR_Integer) ((MR_hl_field(1, HeadVar__1_1, (MR_Integer) 2))));
        MR_Integer ProcCount_7 = ((MR_Integer) ((MR_hl_field(1, HeadVar__1_1, (MR_Integer) 3))));
    ...
    case (MR_Integer) 3:
      switch (((MR_Integer) ((MR_hl_field(3, HeadVar__1_1, (MR_Integer) 0))))) {
        ...
        case (MR_Integer) 5:
          {
            ...
            bytecode_backend__bytecode__output_cons_id_3_p_0(MainConsId_71);
            {
              ...
              MR_hl_field(0, Var_78, 0) = ((MR_Box) (&bytecode_backend__bytecode_scalar_common_4[0]));
              MR_hl_field(0, Var_78, 1) = ((MR_Box) (bytecode_backend__bytecode__output_args_3_p_0_1));
              MR_hl_field(0, Var_78, 2) = ((MR_Box) ((MR_Integer) 2));
              MR_hl_field(0, Var_78, 3) = ((MR_Box) (OtherConsIds_72));
        ...
        case (MR_Integer) 6:
          {
            MR_Integer LabelId_83 = ((MR_Integer) ((MR_hl_field(3, HeadVar__1_1, (MR_Integer) 1))));
        ...
        case (MR_Integer) 7:
          {
            MR_Integer ElseLabelId_88 = ((MR_Integer) ((MR_hl_field(3, HeadVar__1_1, (MR_Integer) 1))));
            MR_Integer FollowLabelId_89 = ((MR_Integer) ((MR_hl_field(3, HeadVar__1_1, (MR_Integer) 2))));
            MR_Integer FramePtrTemp_90 = ((MR_Integer) ((MR_hl_field(3, HeadVar__1_1, (MR_Integer) 3))));
        ...
        case (MR_Integer) 8:
          {
            MR_Integer FramePtrTemp_97 = ((MR_Integer) ((MR_hl_field(3, HeadVar__1_1, (MR_Integer) 1))));
        ...
        case (MR_Integer) 9:
          {
            MR_Integer FollowLabelId_102 = ((MR_Integer) ((MR_hl_field(3, HeadVar__1_1, (MR_Integer) 1))));
        ...
        case (MR_Integer) 10:
          {
            MR_Integer FramePtrTemp_107 = ((MR_Integer) ((MR_hl_field(3, HeadVar__1_1, (MR_Integer) 1))));
        ...
        case (MR_Integer) 11:
          {
            MR_Integer FramePtrTemp_115 = ((MR_Integer) ((MR_hl_field(3, HeadVar__1_1, (MR_Integer) 1))));
            MR_Integer LabelId_116 = ((MR_Integer) ((MR_hl_field(3, HeadVar__1_1, (MR_Integer) 2))));
        ...
        case (MR_Integer) 12:
          {
            MR_Integer FramePtrTemp_122 = ((MR_Integer) ((MR_hl_field(3, HeadVar__1_1, (MR_Integer) 1))));
        ...
        case (MR_Integer) 13:
          {
            MR_Integer Temp_130 = ((MR_Integer) ((MR_hl_field(3, HeadVar__1_1, (MR_Integer) 1))));
        ...
        case (MR_Integer) 14:
          {
            MR_Integer Temp_135 = ((MR_Integer) ((MR_hl_field(3, HeadVar__1_1, (MR_Integer) 1))));
        ...
        case (MR_Integer) 15:
          {
            MR_Integer Var1_140 = ((MR_Integer) ((MR_hl_field(3, HeadVar__1_1, (MR_Integer) 1))));
            MR_Integer Var2_141 = ((MR_Integer) ((MR_hl_field(3, HeadVar__1_1, (MR_Integer) 2))));
        ...
        case (MR_Integer) 16:
          {
            MR_Integer Var1_147 = ((MR_Integer) ((MR_hl_field(3, HeadVar__1_1, (MR_Integer) 1))));
            MR_Integer Var2_148 = ((MR_Integer) ((MR_hl_field(3, HeadVar__1_1, (MR_Integer) 2))));
            MR_Word TestId_149 = ((MR_Unsigned) ((MR_hl_field(3, HeadVar__1_1, (MR_Integer) 3))) & (MR_Integer) 7);
        ...
        case (MR_Integer) 17:
          {
            MR_Integer Var_156 = ((MR_Integer) ((MR_hl_field(3, HeadVar__1_1, (MR_Integer) 1))));
            MR_Word ConsId_157 = ((MR_Word) ((MR_hl_field(3, HeadVar__1_1, (MR_Integer) 2))));
            MR_Word Vars_158 = ((MR_Word) ((MR_hl_field(3, HeadVar__1_1, (MR_Integer) 3))));
        ...
        case (MR_Integer) 18:
          {
            MR_Integer Var_167 = ((MR_Integer) ((MR_hl_field(3, HeadVar__1_1, (MR_Integer) 1))));
            MR_Word ConsId_168 = ((MR_Word) ((MR_hl_field(3, HeadVar__1_1, (MR_Integer) 2))));
            MR_Word Vars_169 = ((MR_Word) ((MR_hl_field(3, HeadVar__1_1, (MR_Integer) 3))));
        ...
        case (MR_Integer) 19:
          {
            MR_Integer Var_178 = ((MR_Integer) ((MR_hl_field(3, HeadVar__1_1, (MR_Integer) 1))));
            MR_Word ConsId_179 = ((MR_Word) ((MR_hl_field(3, HeadVar__1_1, (MR_Integer) 2))));
            MR_Word VarDirs_180 = ((MR_Word) ((MR_hl_field(3, HeadVar__1_1, (MR_Integer) 3))));
        ...
        case (MR_Integer) 20:
          {
            MR_Integer Var_189 = ((MR_Integer) ((MR_hl_field(3, HeadVar__1_1, (MR_Integer) 1))));
            MR_Word ConsId_190 = ((MR_Word) ((MR_hl_field(3, HeadVar__1_1, (MR_Integer) 2))));
            MR_Word VarDirs_191 = ((MR_Word) ((MR_hl_field(3, HeadVar__1_1, (MR_Integer) 3))));
        ...
        case (MR_Integer) 21:
          {
            MR_Integer RegNum_201 = ((MR_Integer) ((MR_hl_field(3, HeadVar__1_1, (MR_Integer) 2))));
            MR_Integer Var_202 = ((MR_Integer) ((MR_hl_field(3, HeadVar__1_1, (MR_Integer) 3))));
        ...
        case (MR_Integer) 22:
          {
            MR_Integer RegNum_209 = ((MR_Integer) ((MR_hl_field(3, HeadVar__1_1, (MR_Integer) 2))));
            MR_Integer Var_210 = ((MR_Integer) ((MR_hl_field(3, HeadVar__1_1, (MR_Integer) 3))));
        ...
        case (MR_Integer) 23:
          {
            MR_Word ModuleId_216 = ((MR_Word) ((MR_hl_field(3, HeadVar__1_1, (MR_Integer) 1))));
            MR_String PredId_217 = ((MR_String) ((MR_hl_field(3, HeadVar__1_1, (MR_Integer) 2))));
            MR_Integer Arity_218 = ((MR_Integer) ((MR_hl_field(3, HeadVar__1_1, (MR_Integer) 3))));
            MR_Integer IsFunc_219 = ((MR_Integer) ((MR_hl_field(3, HeadVar__1_1, (MR_Integer) 4))));
            MR_Integer ProcId_220 = ((MR_Integer) ((MR_hl_field(3, HeadVar__1_1, (MR_Integer) 5))));
        ...
        case (MR_Integer) 24:
          {
            MR_Integer PredVar_229 = ((MR_Integer) ((MR_hl_field(3, HeadVar__1_1, (MR_Integer) 1))));
            MR_Integer InVarCount_230 = ((MR_Integer) ((MR_hl_field(3, HeadVar__1_1, (MR_Integer) 2))));
            MR_Integer OutVarCount_231 = ((MR_Integer) ((MR_hl_field(3, HeadVar__1_1, (MR_Integer) 3))));
            MR_Word Detism_232 = ((MR_Unsigned) ((MR_hl_field(3, HeadVar__1_1, (MR_Integer) 4))) & (MR_Integer) 7);
        ...
        case (MR_Integer) 25:
          {
            MR_Word Binop_240 = ((MR_Word) ((MR_hl_field(3, HeadVar__1_1, (MR_Integer) 1))));
            MR_Word Var1_241 = ((MR_Word) ((MR_hl_field(3, HeadVar__1_1, (MR_Integer) 2))));
            MR_Word Var2_242 = ((MR_Word) ((MR_hl_field(3, HeadVar__1_1, (MR_Integer) 3))));
            MR_Integer Var3_243 = ((MR_Integer) ((MR_hl_field(3, HeadVar__1_1, (MR_Integer) 4))));
        ...
        case (MR_Integer) 26:
          {
            MR_Word Unop_251 = ((MR_Word) ((MR_hl_field(3, HeadVar__1_1, (MR_Integer) 1))));
            MR_Word Var1_252 = ((MR_Word) ((MR_hl_field(3, HeadVar__1_1, (MR_Integer) 2))));
            MR_Integer Var2_253 = ((MR_Integer) ((MR_hl_field(3, HeadVar__1_1, (MR_Integer) 3))));
        ...
        case (MR_Integer) 27:
          {
            MR_Word Binop_260 = ((MR_Word) ((MR_hl_field(3, HeadVar__1_1, (MR_Integer) 1))));
            MR_Word Var1_261 = ((MR_Word) ((MR_hl_field(3, HeadVar__1_1, (MR_Integer) 2))));
            MR_Word Var2_262 = ((MR_Word) ((MR_hl_field(3, HeadVar__1_1, (MR_Integer) 3))));
        ...
        case (MR_Integer) 28:
          {
            MR_Word Unop_269 = ((MR_Word) ((MR_hl_field(3, HeadVar__1_1, (MR_Integer) 1))));
            MR_Word Var1_270 = ((MR_Word) ((MR_hl_field(3, HeadVar__1_1, (MR_Integer) 2))));
        ...
        case (MR_Integer) 29:
          {
            MR_Integer Line_285 = ((MR_Integer) ((MR_hl_field(3, HeadVar__1_1, (MR_Integer) 1))));
    ...
    case (MR_Integer) 1:
      {
        ...
        Code_6 = ((&bytecode_backend__bytecode_vector_common_3[188 + Var_19]))->bytecode_backend__bytecode__vector_common_type_3_0__vct_3_f_0;
      }
      break;
  }
    ...
    case (MR_Integer) 1:
      {
        ...
        *HeadVar__2_2 = ((&bytecode_backend__bytecode_vector_common_3[48 + Var_229]))->bytecode_backend__bytecode__vector_common_type_3_0__vct_3_f_0;
      }
      break;
    case (MR_Integer) 2:
      {
        ...
        *HeadVar__2_2 = ((&bytecode_backend__bytecode_vector_common_3[128 + Var_237]))->bytecode_backend__bytecode__vector_common_type_3_0__vct_3_f_0;
      }
      break;
    case (MR_Integer) 3:
      switch (((MR_Integer) ((MR_hl_field(3, HeadVar__1_1, (MR_Integer) 0))))) {
        ...
        case (MR_Integer) 0:
          {
            ...
            *HeadVar__2_2 = ((&bytecode_backend__bytecode_vector_common_3[118 + Var_236]))->bytecode_backend__bytecode__vector_common_type_3_0__vct_3_f_0;
          }
          break;
        case (MR_Integer) 1:
          {
            ...
            *HeadVar__2_2 = ((&bytecode_backend__bytecode_vector_common_3[58 + Var_230]))->bytecode_backend__bytecode__vector_common_type_3_0__vct_3_f_0;
          }
          break;
        case (MR_Integer) 2:
          {
            ...
            *HeadVar__2_2 = ((&bytecode_backend__bytecode_vector_common_3[108 + Var_235]))->bytecode_backend__bytecode__vector_common_type_3_0__vct_3_f_0;
          }
          break;
        case (MR_Integer) 3:
          {
            ...
            switch (Var_239) {
              default: /*NOTREACHED*/ MR_assert(0);
              case (MR_Integer) 0:
                *HeadVar__2_2 = ((&bytecode_backend__bytecode_vector_common_3[148 + Var_240]))->bytecode_backend__bytecode__vector_common_type_3_0__vct_3_f_0;
                break;
              case (MR_Integer) 1:
                *HeadVar__2_2 = ((&bytecode_backend__bytecode_vector_common_3[158 + Var_240]))->bytecode_backend__bytecode__vector_common_type_3_0__vct_3_f_0;
                break;
            }
          }
          break;
        case (MR_Integer) 4:
          {
            ...
            switch (Var_241) {
              default: /*NOTREACHED*/ MR_assert(0);
              case (MR_Integer) 0:
                *HeadVar__2_2 = ((&bytecode_backend__bytecode_vector_common_3[168 + Var_242]))->bytecode_backend__bytecode__vector_common_type_3_0__vct_3_f_0;
                break;
              case (MR_Integer) 1:
                *HeadVar__2_2 = ((&bytecode_backend__bytecode_vector_common_3[178 + Var_242]))->bytecode_backend__bytecode__vector_common_type_3_0__vct_3_f_0;
                break;
            }
          }
          break;
        case (MR_Integer) 5:
          {
            ...
            *HeadVar__2_2 = ((&bytecode_backend__bytecode_vector_common_3[8 + Var_225]))->bytecode_backend__bytecode__vector_common_type_3_0__vct_3_f_0;
          }
          break;
        case (MR_Integer) 6:
          {
            ...
            *HeadVar__2_2 = ((&bytecode_backend__bytecode_vector_common_3[18 + Var_226]))->bytecode_backend__bytecode__vector_common_type_3_0__vct_3_f_0;
          }
          break;
        case (MR_Integer) 7:
          {
            ...
            *HeadVar__2_2 = ((&bytecode_backend__bytecode_vector_common_3[28 + Var_227]))->bytecode_backend__bytecode__vector_common_type_3_0__vct_3_f_0;
          }
          break;
        case (MR_Integer) 8:
          {
            ...
            *HeadVar__2_2 = ((&bytecode_backend__bytecode_vector_common_3[38 + Var_228]))->bytecode_backend__bytecode__vector_common_type_3_0__vct_3_f_0;
          }
          break;
        case (MR_Integer) 9:
          {
            ...
            *HeadVar__2_2 = ((&bytecode_backend__bytecode_vector_common_3[138 + Var_238]))->bytecode_backend__bytecode__vector_common_type_3_0__vct_3_f_0;
          }
          break;
        case (MR_Integer) 10:
          *HeadVar__2_2 = (MR_Integer) 14;
        ...
        case (MR_Integer) 12:
          {
            ...
            *HeadVar__2_2 = ((&bytecode_backend__bytecode_vector_common_3[98 + Var_234]))->bytecode_backend__bytecode__vector_common_type_3_0__vct_3_f_0;
          }
          break;
        case (MR_Integer) 13:
          {
            ...
            *HeadVar__2_2 = ((&bytecode_backend__bytecode_vector_common_3[78 + Var_232]))->bytecode_backend__bytecode__vector_common_type_3_0__vct_3_f_0;
          }
          break;
        case (MR_Integer) 14:
          {
            ...
            *HeadVar__2_2 = ((&bytecode_backend__bytecode_vector_common_3[88 + Var_233]))->bytecode_backend__bytecode__vector_common_type_3_0__vct_3_f_0;
          }
          break;
        case (MR_Integer) 15:
          {
            ...
            *HeadVar__2_2 = ((&bytecode_backend__bytecode_vector_common_3[68 + Var_231]))->bytecode_backend__bytecode__vector_common_type_3_0__vct_3_f_0;
          }
          break;
      }
      break;
  ...
  switch (MR_tag((MR_Word) HeadVar__1_1)) {
        ...
        case (MR_Integer) 0:
          {
            ...
            Var_86 = mercury__string__f_43_43_2_f_0((MR_String) "bytecode for type_info_cell_constructor ", (MR_String) "not yet implemented.");
            {
              mercury__require__sorry_2_p_0((MR_String) "predicate \140bytecode_backend.bytecode.output_cons_id\'/3", Var_86);
              return;
            }
          }
          break;
        case (MR_Integer) 1:
          {
            ...
            Var_95 = mercury__string__f_43_43_2_f_0((MR_String) "bytecode for typeclass_info_cell_constructor ", (MR_String) "not yet implemented.");
            {
              mercury__require__sorry_2_p_0((MR_String) "predicate \140bytecode_backend.bytecode.output_cons_id\'/3", Var_95);
              return;
            }
          }
          break;
    ...
    case (MR_Integer) 1:
      {
        ...
        Var_99 = mdbcomp__sym_name__sym_name_to_string_1_f_0(ModuleId_4);
        backend_libs__bytecode_data__output_string_3_p_0(Var_99);
    ...
    case (MR_Integer) 3:
      switch (((MR_Integer) ((MR_hl_field(3, HeadVar__1_1, (MR_Integer) 0))))) {
        ...
        case (MR_Integer) 2:
          {
            MR_Char Char_64 = ((MR_Char) (MR_Word) (MR_hl_field(3, HeadVar__1_1, (MR_Integer) 1)));
            MR_Integer Byte_66;
        ...
        case (MR_Integer) 3:
          {
            ...
            Var_100 = mdbcomp__sym_name__sym_name_to_string_1_f_0(ModuleId_38);
            backend_libs__bytecode_data__output_string_3_p_0(Var_100);
            backend_libs__bytecode_data__output_string_3_p_0(PredId_39);
            backend_libs__bytecode_data__output_short_3_p_0(Arity_40);
            switch (IsFunc_41) {
              default:
                succeeded = MR_FALSE;
                break;
            ...
            if (succeeded)
              backend_libs__bytecode_data__output_byte_3_p_0(IsFunc_41);
            else
              {
            ...
            backend_libs__bytecode_data__output_byte_3_p_0(ProcId_42);
          }
          break;
        case (MR_Integer) 4:
          {
            ...
            Var_103 = mdbcomp__sym_name__sym_name_to_string_1_f_0(ModuleId_53);
            backend_libs__bytecode_data__output_string_3_p_0(Var_103);
  ...
  MR_Word HeadVar__1_1)
{
  switch (MR_tag((MR_Word) HeadVar__1_1)) {
    ...
    case (MR_Integer) 2:
      {
        MR_Float FloatVal_18 = MR_unbox_float((MR_hl_field(2, HeadVar__1_1, (MR_Integer) 0)));
  ...
  MR_Word HeadVar__1_1)
{
  while (MR_TRUE)
  {
    ...
    if (!((HeadVar__1_1 == (MR_Word) ((MR_Unsigned) 0U))))
    {
      ...
      backend_libs__bytecode_data__output_string_3_p_0(Name_13);
      // direct tailcall eliminated
      ;
      next_value_of_HeadVar__1_1 = Vars_8;
      HeadVar__1_1 = next_value_of_HeadVar__1_1;
