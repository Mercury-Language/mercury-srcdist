...
MR_decl_label8(bytecode_backend__bytecode__debug_binop_3_0, 37,38,39,40,41,42,4,43)
...
MR_decl_label7(bytecode_backend__bytecode__output_binop_3_0, 37,38,39,40,41,42,4)
...
MR_BEGIN_MODULE(bytecode_backend__bytecode_module17)
	...
	MR_init_label7(bytecode_backend__bytecode__output_binop_3_0,37,38,39,40,41,42,4)
MR_BEGIN_CODE
...
MR_def_static(bytecode_backend__bytecode__output_binop_3_0)
	...
	MR_COMPUTED_GOTO((MR_Unsigned) MR_unmkbody(MR_r1),
		...
		MR_LABEL_AP(bytecode_backend__bytecode__output_binop_3_0_i42));
...
MR_BEGIN_MODULE(bytecode_backend__bytecode_module43)
	...
	MR_init_label8(bytecode_backend__bytecode__debug_binop_3_0,37,38,39,40,41,42,4,43)
MR_BEGIN_CODE
...
MR_def_static(bytecode_backend__bytecode__debug_binop_3_0)
	...
	MR_COMPUTED_GOTO((MR_Unsigned) MR_unmkbody(MR_r1),
		...
		MR_LABEL_AP(bytecode_backend__bytecode__debug_binop_3_0_i42));
...
MR_def_static(bytecode_backend__bytecode__debug_unop_3_0)
	...
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tempr1 = (MR_Word) &MR_tfield(0, (MR_Word *) &mercury_vector_common_2_1, (MR_Integer) MR_r1);
	MR_tempr2 = MR_r1;
	MR_r1 = MR_ctfield(0, MR_tempr1, 0);
	}
	MR_np_call_localret_ent(io__write_string_3_0,
