  ...
  MR_Word HeadVar__1_1)
{
  while (MR_TRUE)
  {
    ...
    if (!((HeadVar__1_1 == (MR_Word) ((MR_Unsigned) 0U))))
    {
      ...
      MR_Word Vars_8 = ((MR_Word) ((MR_hl_field(MR_mktag(1), HeadVar__1_1, (MR_Integer) 1))));
      MR_String Name_15 = ((MR_String) ((MR_hl_field(MR_mktag(0), Var_7, (MR_Integer) 0))));
      MR_Word next_value_of_HeadVar__1_1;

      mercury__io__write_string_3_p_0(Name_15);
      mercury__io__write_char_3_p_0((MR_Char) 32);
      // direct tailcall eliminated
      ;
      next_value_of_HeadVar__1_1 = Vars_8;
  ...
  MR_Word HeadVar__1_1)
{
  while (MR_TRUE)
  {
    ...
    if (!((HeadVar__1_1 == (MR_Word) ((MR_Unsigned) 0U))))
    {
      ...
      backend_libs__bytecode_data__output_string_3_p_0(Name_15);
      // direct tailcall eliminated
      ;
      next_value_of_HeadVar__1_1 = Vars_8;
      HeadVar__1_1 = next_value_of_HeadVar__1_1;
