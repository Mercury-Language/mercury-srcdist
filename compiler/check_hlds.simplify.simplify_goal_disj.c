  ...
  MR_Word * STATE_VARIABLE_Info_39)
{
  ...
  {
    MR_Word Var_55 = ((MR_Word) ((MR_hl_field(1, Disjuncts_21, (MR_Integer) 1))));
    MR_Word Var_56 = ((MR_Word) ((MR_hl_field(1, Disjuncts_21, (MR_Integer) 0))));

    if ((Var_55 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      MR_Word Goal1_25 = ((MR_Word) ((MR_hl_field(0, Var_56, (MR_Integer) 0))));
      MR_Word GoalInfo1_26 = ((MR_Word) ((MR_hl_field(0, Var_56, (MR_Integer) 1))));
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          {
            MR_Word Var_132 = ((MR_Word) ((MR_hl_field(1, Procs_48, (MR_Integer) 1))));
