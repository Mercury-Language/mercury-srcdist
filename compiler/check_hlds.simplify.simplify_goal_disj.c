  ...
  MR_Word * STATE_VARIABLE_Info_10)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      MR_Word STATE_VARIABLE_Info_3_125;
      MR_Word STATE_VARIABLE_PostBranchInstMaps_1_126;
      MR_Word _Common1_32;
      MR_Word Detism_36;
      MR_Word MaxSolns_38;
      MR_Word _CanFail_37;
      ...
      if (succeeded)
      {
        MR_Word STATE_VARIABLE_Info_2_121;
        MR_Word Var_70;
        MR_Word Var_68;
        MR_Word Var_69;
        ...
        if (succeeded)
        {
          ...
          }
          {
            ...
            MR_hl_field(3, Spec_56, 1) = (MR_Box) (((((MR_Unsigned) ((MR_Integer) 203) << 1)) | (MR_Unsigned) ((MR_Integer) 1)));
          ...
          check_hlds__simplify__simplify_info__simplify_info_add_message_3_p_0(Spec_56, STATE_VARIABLE_Info_1_67, &STATE_VARIABLE_Info_2_121);
        }
        else
          STATE_VARIABLE_Info_2_121 = STATE_VARIABLE_Info_1_67;
        {
        ...
        if (!(succeeded))
        {
          ...
          check_hlds__simplify__simplify_info__simplify_info_get_fully_strict_2_p_0(STATE_VARIABLE_Info_2_121, &Var_139);
        ...
        if (succeeded)
        {
          ...
          check_hlds__simplify__simplify_info__simplify_info_get_deleted_call_callees_2_p_0(STATE_VARIABLE_Info_2_121, &DeletedCallCallees0_58);
          ...
          check_hlds__simplify__simplify_info__simplify_info_set_deleted_call_callees_3_p_0(DeletedCallCallees_60, STATE_VARIABLE_Info_2_121, &STATE_VARIABLE_Info_3_125);
          RevGoals1_61 = HeadVar__2_2;
          STATE_VARIABLE_PostBranchInstMaps_1_126 = STATE_VARIABLE_PostBranchInstMaps_0_7;
        }
        else
        {
          ...
          {
            STATE_VARIABLE_PostBranchInstMaps_1_126 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(1, STATE_VARIABLE_PostBranchInstMaps_1_126, 0) = ((MR_Box) (InstMapDelta_62));
            MR_hl_field(1, STATE_VARIABLE_PostBranchInstMaps_1_126, 1) = ((MR_Box) (STATE_VARIABLE_PostBranchInstMaps_0_7));
          }
          STATE_VARIABLE_Info_3_125 = STATE_VARIABLE_Info_2_121;
        }
      }
      else
      {
        ...
        {
          STATE_VARIABLE_PostBranchInstMaps_1_126 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(1, STATE_VARIABLE_PostBranchInstMaps_1_126, 0) = ((MR_Box) (InstMapDelta_130));
          MR_hl_field(1, STATE_VARIABLE_PostBranchInstMaps_1_126, 1) = ((MR_Box) (STATE_VARIABLE_PostBranchInstMaps_0_7));
        }
        STATE_VARIABLE_Info_3_125 = STATE_VARIABLE_Info_1_67;
      }
      // direct tailcall eliminated
      ;
      next_value_of_HeadVar__1_1 = Goals0_23;
      next_value_of_HeadVar__2_2 = RevGoals1_61;
      next_value_of_STATE_VARIABLE_PostBranchInstMaps_0_7 = STATE_VARIABLE_PostBranchInstMaps_1_126;
      next_value_of_STATE_VARIABLE_Info_0_9 = STATE_VARIABLE_Info_3_125;
