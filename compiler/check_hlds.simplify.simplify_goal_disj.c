...
{
  {
    ...
    check_hlds__simplify__simplify_info__simplify_info_get_module_info_2_p_0(STATE_VARIABLE_Info_0_29, &ModuleInfo_13);
    {
      ...
      MR_hl_field(MR_mktag(0), Var_31, 0) = ((MR_Box) (&check_hlds__simplify__simplify_goal_disj_scalar_common_3[0]));
    ...
    mercury__list__filter_map_3_p_0((MR_Word) (&check_hlds__simplify__simplify_goal_disj_scalar_common_2[0]), (MR_Word) (&check_hlds__simplify__simplify_goal_disj_scalar_common_1[0]), Var_31, InstMapDeltaChanges_12, &ProblemPartialVars_14);
    ...
    else
    {
      ...
      else
      {
        ...
        if (succeeded)
        {
          ...
          mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&check_hlds__simplify__simplify_goal_disj_scalar_common_4[0]), LambdaLineNum_20, &Var_122);
        ...
        else
        {
          ...
          mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&check_hlds__simplify__simplify_goal_disj_scalar_common_4[0]), LambdaLineNum_20, &Var_130);
      ...
      check_hlds__simplify__simplify_info__simplify_info_get_varset_2_p_0(STATE_VARIABLE_Info_0_29, &VarSet_21);
      {
        ...
        MR_hl_field(MR_mktag(0), Var_42, 0) = ((MR_Box) (&check_hlds__simplify__simplify_goal_disj_scalar_common_5[0]));
      ...
      mercury__list__map_3_p_0((MR_Word) (&check_hlds__simplify__simplify_goal_disj_scalar_common_1[0]), (MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), Var_42, ProblemPartialVars_14, &ProblemPartialVarNames_22);
      ...
      conv2_Var_51 = parse_tree__error_util__choose_number_3_f_0((MR_Word) (&check_hlds__simplify__simplify_goal_disj_scalar_common_1[0]), (MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), ProblemPartialVars_14, ((MR_Box) ((MR_String) "variable")), ((MR_Box) ((MR_String) "variables")));
      ...
      conv3_Var_65 = parse_tree__error_util__choose_number_3_f_0((MR_Word) (&check_hlds__simplify__simplify_goal_disj_scalar_common_1[0]), (MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), ProblemPartialVars_14, ((MR_Box) ((MR_String) "Since the memory cell of this variable\n                    is allocated *before* the disjunction,")), ((MR_Box) ((MR_String) "Since the memory cells of these variables\n                    are allocated *before* the disjunction,")));
      ...
      conv4_Var_76 = parse_tree__error_util__choose_number_3_f_0((MR_Word) (&check_hlds__simplify__simplify_goal_disj_scalar_common_1[0]), (MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), ProblemPartialVars_14, ((MR_Box) ((MR_String) "for this variable")), ((MR_Box) ((MR_String) "for each of these variables")));
      ...
      Var_56 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_format_component_0), (MR_Word) (MR_mkword(MR_mktag(1), &check_hlds__simplify__simplify_goal_disj_scalar_common_1[3])), Var_63);
      Var_55 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_format_component_0), ProblemPartialVarPieces_23, Var_56);
      Pieces_25 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_format_component_0), Var_43, Var_55);
      {
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(1), Msg_26, 1) = ((MR_Box) (Var_105));
      }
      {
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(0), Spec_28, 0) = ((MR_Box) ((MR_Unsigned) 4U));
        MR_hl_field(MR_mktag(0), Spec_28, 1) = ((MR_Box) (MR_mkword(MR_mktag(2), &check_hlds__simplify__simplify_goal_disj_scalar_common_4[1])));
