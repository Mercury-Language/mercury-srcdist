    ...
    else
    {
      ...
      else
      {
        ...
        else
        {
          ...
          if (succeeded)
          {
            packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), NestedContext0_15, (MR_Integer) 0)));
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          succeeded = ((((MR_tag((MR_Word) Var_56)) == (MR_Integer) 3)) && ((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), Var_56, (MR_Integer) 0))) == (MR_Integer) 3)));
          if (succeeded)
          {
          ...
          if (succeeded)
          {
            packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), HeadVar__4_4, (MR_Integer) 0)));
          ...
          STATE_VARIABLE_Info_81_81 = STATE_VARIABLE_Info_55_55;
        {
          ...
          succeeded = ((((MR_tag((MR_Word) Var_83)) == (MR_Integer) 3)) && ((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), Var_83, (MR_Integer) 0))) == (MR_Integer) 3)));
          if (succeeded)
          {
