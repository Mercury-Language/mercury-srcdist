...
{
  {
    ...
    else
    {
      ...
      else
      {
        ...
        succeeded = hlds__hlds_goal__goal_info_has_feature_2_p_0(GoalInfo0_13, (MR_Integer) 15);
        if (succeeded)
        {
  ...
  while (MR_TRUE)
  {
    /* tailcall optimized into a loop */
    {
      ...
      else
      {
        ...
        {
          MR_Word next_value_of_HeadVar__1_1 = Goals0_23;
          MR_Word next_value_of_HeadVar__2_2 = RevGoals1_49;
          MR_Word next_value_of_STATE_VARIABLE_PostBranchInstMaps_0_7 = STATE_VARIABLE_PostBranchInstMaps_86_86;
          MR_Word next_value_of_STATE_VARIABLE_Info_0_9 = STATE_VARIABLE_Info_85_85;
