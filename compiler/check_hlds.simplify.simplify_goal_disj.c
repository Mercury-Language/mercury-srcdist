    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          {
            MR_Word Var_140 = ((MR_Word) ((MR_hl_field(1, Procs_48, 1))));
        ...
        {
          MR_Word Var_122 = ((MR_Word) ((MR_hl_field(0, Goal0_22, 0))));
          MR_Word Var_123;

          succeeded = ((((MR_tag((MR_Word) Var_122)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(3, Var_122, 0)))) == (MR_Integer) 3)));
          if (succeeded)
          {
            Var_123 = ((MR_Word) ((MR_hl_field(3, Var_122, 1))));
