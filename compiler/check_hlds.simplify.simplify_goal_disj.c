      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          else
          {
            ...
            else
            {
              ...
              }
              {
                ...
                MR_hl_field(MR_mktag(3), Var_91, 0) = ((MR_Box) ((MR_Unsigned) 23U));
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(2), Spec_56, 3) = ((MR_Box) (MR_mkword(MR_mktag(2), &check_hlds__simplify__simplify_goal_disj_scalar_common_3[1])));
