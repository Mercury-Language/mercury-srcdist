  ...
  else
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&check_hlds__simplify__simplify_goal_disj_scalar_common_3[0]), LambdaLineNum_21, &Var_126);
        ProcStr_18 = mercury__string__f_43_43_2_f_0((MR_String) "the lambda expression at line ", Var_126);
      }
      else
      {
        MR_String Var_134;
        ...
        mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&check_hlds__simplify__simplify_goal_disj_scalar_common_3[0]), LambdaLineNum_21, &Var_134);
        Var_142 = mercury__string__f_43_43_2_f_0((MR_String) " at line ", Var_134);
        Var_143 = mercury__string__f_43_43_2_f_0(LambdaFileName_20, Var_142);
        ProcStr_18 = mercury__string__f_43_43_2_f_0((MR_String) "the lambda expression in ", Var_143);
      }
    }
    {
