...
static /* final */ const MR_Box check_hlds__simplify__simplify_goal_disj_scalar_common_1[18][2];

static /* final */ const MR_Box check_hlds__simplify__simplify_goal_disj_scalar_common_2[1][3];

static /* final */ const MR_Box check_hlds__simplify__simplify_goal_disj_scalar_common_3[1][7];

static /* final */ const MR_Box check_hlds__simplify__simplify_goal_disj_scalar_common_4[3][1];
...
check_hlds__simplify__simplify_goal_disj__IntroducedFrom__pred__warn_about_any_problem_partial_vars__184__1_3_p_0(
  ...
  MR_String * HeadVar__3_113)
{
  mercury__varset__lookup_name_3_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), VarSet_21, HeadVar__2_112, HeadVar__3_113);
}
    ...
    else
    {
      ...
      else
      {
        ...
        else
        {
          ...
          if (succeeded)
          {
            Var_46 = ((MR_Word) ((MR_hl_field(MR_mktag(0), NestedContext0_15, (MR_Integer) 1))));
  ...
  MR_Word * STATE_VARIABLE_Info_10)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      MR_Word GoalInfo_34;
      MR_Word Purity_35;
      MR_Word RevGoals1_47;
      MR_Word STATE_VARIABLE_Info_53_53;
      MR_Word STATE_VARIABLE_Info_76_76;
      MR_Word STATE_VARIABLE_PostBranchInstMaps_77_77;
      MR_Word _Common1_32;
      MR_Word Detism_36;
      MR_Word MaxSolns_38;
      MR_Word _CanFail_37;
      ...
      check_hlds__simplify__simplify_goal__simplify_goal_8_p_0(Goal0_22, &Goal_31, HeadVar__4_4, HeadVar__5_5, HeadVar__6_6, &_Common1_32, STATE_VARIABLE_Info_0_9, &STATE_VARIABLE_Info_53_53);
      ...
      if (succeeded)
      {
        ...
        succeeded = check_hlds__simplify__simplify_info__simplify_do_warn_simple_code_1_p_0(STATE_VARIABLE_Info_53_53);
        if (succeeded)
        {
          Var_54 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Goal0_22, (MR_Integer) 0))));
          succeeded = ((((MR_tag((MR_Word) Var_54)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(MR_mktag(3), Var_54, (MR_Integer) 0)))) == (MR_Integer) 3)));
          if (succeeded)
          {
          ...
          if (succeeded)
          {
            Var_56 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), HeadVar__4_4, (MR_Integer) 0))) & (MR_Integer) 1);
        ...
        if (succeeded)
        {
          ...
          Context_40 = hlds__hlds_goal__goal_info_get_context_1_f_0(GoalInfo_34);
          {
            ...
            MR_hl_field(MR_mktag(0), Var_70, 0) = ((MR_Box) (Context_40));
            MR_hl_field(MR_mktag(0), Var_70, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &check_hlds__simplify__simplify_goal_disj_scalar_common_1[7])));
          }
          {
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(2), Spec_42, 0) = ((MR_Box) ((MR_String) "predicate \140check_hlds.simplify.simplify_goal_disj.simplify_disj\'/10"));
            MR_hl_field(MR_mktag(2), Spec_42, 1) = (MR_Box) (((((MR_Unsigned) ((MR_Integer) 26) << 1)) | (MR_Unsigned) ((MR_Integer) 1)));
            MR_hl_field(MR_mktag(2), Spec_42, 2) = ((MR_Box) ((MR_Unsigned) 4U));
            MR_hl_field(MR_mktag(2), Spec_42, 3) = ((MR_Box) (MR_mkword(MR_mktag(2), &check_hlds__simplify__simplify_goal_disj_scalar_common_4[2])));
            MR_hl_field(MR_mktag(2), Spec_42, 4) = ((MR_Box) (Var_69));
          }
          check_hlds__simplify__simplify_info__simplify_info_add_message_3_p_0(Spec_42, STATE_VARIABLE_Info_53_53, &STATE_VARIABLE_Info_72_72);
        }
        else
          STATE_VARIABLE_Info_72_72 = STATE_VARIABLE_Info_53_53;
        {
          MR_Word Var_74 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Goal0_22, (MR_Integer) 0))));
          MR_Word Var_75;

          succeeded = ((((MR_tag((MR_Word) Var_74)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(MR_mktag(3), Var_74, (MR_Integer) 0)))) == (MR_Integer) 3)));
          if (succeeded)
          {
            Var_75 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Var_74, (MR_Integer) 1))));
        ...
        if (!(succeeded))
        {
          ...
          check_hlds__simplify__simplify_info__simplify_info_get_fully_strict_2_p_0(STATE_VARIABLE_Info_72_72, &Var_86);
          succeeded = ((MR_Integer) 0 == Var_86);
        }
        if (succeeded)
        {
          MR_Word DeletedCallCallees0_44;
          MR_Word SubGoalCalledProcs_45;
          MR_Word DeletedCallCallees_46;

          check_hlds__simplify__simplify_info__simplify_info_get_deleted_call_callees_2_p_0(STATE_VARIABLE_Info_72_72, &DeletedCallCallees0_44);
          SubGoalCalledProcs_45 = hlds__goal_util__goal_proc_refs_1_f_0(Goal_31);
          mercury__set__union_3_p_0((MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_proc_id_0), SubGoalCalledProcs_45, DeletedCallCallees0_44, &DeletedCallCallees_46);
          check_hlds__simplify__simplify_info__simplify_info_set_deleted_call_callees_3_p_0(DeletedCallCallees_46, STATE_VARIABLE_Info_72_72, &STATE_VARIABLE_Info_76_76);
          RevGoals1_47 = HeadVar__2_2;
          STATE_VARIABLE_PostBranchInstMaps_77_77 = STATE_VARIABLE_PostBranchInstMaps_0_7;
        }
        else
        {
          ...
          {
            RevGoals1_47 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), RevGoals1_47, 0) = ((MR_Box) (Goal_31));
            MR_hl_field(MR_mktag(1), RevGoals1_47, 1) = ((MR_Box) (HeadVar__2_2));
          }
          InstMapDelta_48 = hlds__hlds_goal__goal_info_get_instmap_delta_1_f_0(GoalInfo_34);
          {
            STATE_VARIABLE_PostBranchInstMaps_77_77 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), STATE_VARIABLE_PostBranchInstMaps_77_77, 0) = ((MR_Box) (InstMapDelta_48));
            MR_hl_field(MR_mktag(1), STATE_VARIABLE_PostBranchInstMaps_77_77, 1) = ((MR_Box) (STATE_VARIABLE_PostBranchInstMaps_0_7));
          }
      ...
      else
      {
        ...
        InstMapDelta_81 = hlds__hlds_goal__goal_info_get_instmap_delta_1_f_0(GoalInfo_34);
        {
          STATE_VARIABLE_PostBranchInstMaps_77_77 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), STATE_VARIABLE_PostBranchInstMaps_77_77, 0) = ((MR_Box) (InstMapDelta_81));
          MR_hl_field(MR_mktag(1), STATE_VARIABLE_PostBranchInstMaps_77_77, 1) = ((MR_Box) (STATE_VARIABLE_PostBranchInstMaps_0_7));
        }
        STATE_VARIABLE_Info_76_76 = STATE_VARIABLE_Info_53_53;
      }
      // direct tailcall eliminated
      ;
      next_value_of_HeadVar__1_1 = Goals0_23;
      next_value_of_HeadVar__2_2 = RevGoals1_47;
      next_value_of_STATE_VARIABLE_PostBranchInstMaps_0_7 = STATE_VARIABLE_PostBranchInstMaps_77_77;
      next_value_of_STATE_VARIABLE_Info_0_9 = STATE_VARIABLE_Info_76_76;
...
{
  {
    ...
    MR_String conv1_HeadVar__3_113;

    check_hlds__simplify__simplify_goal_disj__IntroducedFrom__pred__warn_about_any_problem_partial_vars__184__1_3_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) (wrapper_arg_1)), &conv1_HeadVar__3_113);
    *wrapper_arg_2 = ((MR_Box) (conv1_HeadVar__3_113));
  }
}
...
{
  {
    ...
    check_hlds__simplify__simplify_info__simplify_info_get_module_info_2_p_0(STATE_VARIABLE_Info_0_27, &ModuleInfo_13);
    {
      ...
      MR_hl_field(MR_mktag(0), Var_29, 0) = ((MR_Box) (&check_hlds__simplify__simplify_goal_disj_scalar_common_3[0]));
    ...
    else
    {
      ...
      else
      {
        ...
        if (succeeded)
        {
          ...
          mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&check_hlds__simplify__simplify_goal_disj_scalar_common_4[0]), LambdaLineNum_20, &Var_117);
          ProcStr_17 = mercury__string__f_43_43_2_f_0((MR_String) "the lambda expression at line ", Var_117);
        }
        else
        {
          MR_String Var_125;
          ...
          mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&check_hlds__simplify__simplify_goal_disj_scalar_common_4[0]), LambdaLineNum_20, &Var_125);
          Var_133 = mercury__string__f_43_43_2_f_0((MR_String) " at line ", Var_125);
          Var_134 = mercury__string__f_43_43_2_f_0(LambdaFileName_19, Var_133);
          ProcStr_17 = mercury__string__f_43_43_2_f_0((MR_String) "the lambda expression in ", Var_134);
        }
      }
      check_hlds__simplify__simplify_info__simplify_info_get_varset_2_p_0(STATE_VARIABLE_Info_0_27, &VarSet_21);
      {
        ...
        MR_hl_field(MR_mktag(0), Var_40, 3) = ((MR_Box) (VarSet_21));
      }
      mercury__list__map_3_p_0((MR_Word) (&check_hlds__simplify__simplify_goal_disj_scalar_common_1[0]), (MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), Var_40, ProblemPartialVars_14, &ProblemPartialVarNames_22);
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(1), Var_44, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &check_hlds__simplify__simplify_goal_disj_scalar_common_1[9])));
        MR_hl_field(MR_mktag(1), Var_44, 1) = ((MR_Box) (Var_47));
      }
      {
        Var_41 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), Var_41, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &check_hlds__simplify__simplify_goal_disj_scalar_common_1[8])));
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(1), Var_95, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &check_hlds__simplify__simplify_goal_disj_scalar_common_1[3])));
      }
      {
        Var_92 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), Var_92, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &check_hlds__simplify__simplify_goal_disj_scalar_common_1[17])));
        MR_hl_field(MR_mktag(1), Var_92, 1) = ((MR_Box) (Var_95));
      }
      {
        Var_89 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), Var_89, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &check_hlds__simplify__simplify_goal_disj_scalar_common_1[16])));
        MR_hl_field(MR_mktag(1), Var_89, 1) = ((MR_Box) (Var_92));
      }
      {
        Var_86 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), Var_86, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &check_hlds__simplify__simplify_goal_disj_scalar_common_1[15])));
        MR_hl_field(MR_mktag(1), Var_86, 1) = ((MR_Box) (Var_89));
      }
      {
        Var_83 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), Var_83, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &check_hlds__simplify__simplify_goal_disj_scalar_common_1[14])));
        MR_hl_field(MR_mktag(1), Var_83, 1) = ((MR_Box) (Var_86));
      }
      {
        Var_80 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), Var_80, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &check_hlds__simplify__simplify_goal_disj_scalar_common_1[13])));
        MR_hl_field(MR_mktag(1), Var_80, 1) = ((MR_Box) (Var_83));
      }
      {
        Var_77 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), Var_77, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &check_hlds__simplify__simplify_goal_disj_scalar_common_1[12])));
      ...
      {
        Var_69 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), Var_69, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &check_hlds__simplify__simplify_goal_disj_scalar_common_1[11])));
        MR_hl_field(MR_mktag(1), Var_69, 1) = ((MR_Box) (Var_72));
      }
      {
        Var_66 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), Var_66, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &check_hlds__simplify__simplify_goal_disj_scalar_common_1[10])));
      ...
      Var_54 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_format_component_0), (MR_Word) (MR_mkword(MR_mktag(1), &check_hlds__simplify__simplify_goal_disj_scalar_common_1[3])), Var_61);
      ...
      Pieces_25 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_format_component_0), Var_41, Var_53);
      {
        ...
        MR_hl_field(MR_mktag(1), Spec_26, 2) = ((MR_Box) (MR_mkword(MR_mktag(2), &check_hlds__simplify__simplify_goal_disj_scalar_common_4[1])));
