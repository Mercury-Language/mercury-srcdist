    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          else
          {
            ...
            else
            {
              ...
              }
              {
                ...
                MR_hl_field(3, Var_94, 0) = ((MR_Box) ((MR_Unsigned) 27U));
          ...
          Var_112 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_format_component_0), (MR_Word) (MR_mkword(1, &check_hlds__simplify__simplify_goal_disj_scalar_common_1[17])), ModePieces_50);
          {
  ...
  MR_Word * STATE_VARIABLE_Info_28)
{
  ...
  else
  {
    ...
    Var_54 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_format_component_0), (MR_Word) (MR_mkword(1, &check_hlds__simplify__simplify_goal_disj_scalar_common_1[5])), Var_61);
