      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          }
          {
            ...
            MR_hl_field(3, Spec_56, 3) = ((MR_Box) (MR_mkword(2, &check_hlds__simplify__simplify_goal_disj_scalar_common_3[1])));
  ...
  MR_Word * STATE_VARIABLE_Info_28)
{
  ...
  else
  {
    ...
    Pieces_25 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), Var_41, Var_53);
    {
      ...
      MR_hl_field(1, Spec_26, 2) = ((MR_Box) (MR_mkword(2, &check_hlds__simplify__simplify_goal_disj_scalar_common_3[1])));
