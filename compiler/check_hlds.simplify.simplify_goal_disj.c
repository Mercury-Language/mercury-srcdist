...
static /* final */ const MR_Box check_hlds__simplify__simplify_goal_disj_scalar_common_2[2][3];

static /* final */ const MR_Box check_hlds__simplify__simplify_goal_disj_scalar_common_3[1][7];

static /* final */ const MR_Box check_hlds__simplify__simplify_goal_disj_scalar_common_4[4][1];
...
static /* final */ const MR_Box check_hlds__simplify__simplify_goal_disj_scalar_common_1[21][2] = {
  ...
  /* row 18 */
  {
    ((MR_Box) (&check_hlds__simplify__simplify_goal_disj_scalar_common_4[2])),
    ((MR_Box) ((MR_Unsigned) 0U))
  },
  /* row 19 */
  {
...
check_hlds__simplify__simplify_goal_disj__IntroducedFrom__pred__warn_about_any_problem_partial_vars__184__1_3_p_0(
  ...
  MR_String * HeadVar__3_112)
{
  mercury__varset__lookup_name_3_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), VarSet_21, HeadVar__2_111, HeadVar__3_112);
}
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          succeeded = ((((MR_tag((MR_Word) Var_56)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(MR_mktag(3), Var_56, (MR_Integer) 0)))) == (MR_Integer) 3)));
          if (succeeded)
          {
          ...
          if (succeeded)
          {
            Var_58 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), HeadVar__4_4, (MR_Integer) 0))) & (MR_Integer) 1);
        ...
        if (succeeded)
        {
          ...
          Context_40 = hlds__hlds_goal__goal_info_get_context_1_f_0(GoalInfo_34);
          {
            ...
            MR_hl_field(MR_mktag(1), Msg_42, 0) = ((MR_Box) (Context_40));
            MR_hl_field(MR_mktag(1), Msg_42, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &check_hlds__simplify__simplify_goal_disj_scalar_common_1[20])));
          }
          {
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(0), Spec_44, 0) = ((MR_Box) (MR_mkword(MR_mktag(1), &check_hlds__simplify__simplify_goal_disj_scalar_common_2[1])));
            MR_hl_field(MR_mktag(0), Spec_44, 1) = ((MR_Box) (MR_mkword(MR_mktag(2), &check_hlds__simplify__simplify_goal_disj_scalar_common_4[3])));
          ...
          STATE_VARIABLE_Info_81_81 = STATE_VARIABLE_Info_55_55;
        {
          ...
          succeeded = ((((MR_tag((MR_Word) Var_83)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(MR_mktag(3), Var_83, (MR_Integer) 0)))) == (MR_Integer) 3)));
          if (succeeded)
          {
        ...
        else
        {
          ...
          {
            RevGoals1_49 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          ...
          {
            STATE_VARIABLE_PostBranchInstMaps_86_86 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
...
{
  {
    ...
    MR_String conv1_HeadVar__3_112;

    check_hlds__simplify__simplify_goal_disj__IntroducedFrom__pred__warn_about_any_problem_partial_vars__184__1_3_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) (wrapper_arg_1)), &conv1_HeadVar__3_112);
    *wrapper_arg_2 = ((MR_Box) (conv1_HeadVar__3_112));
  }
}
    ...
    else
    {
      ...
      else
      {
        ...
        if (succeeded)
        {
          ...
          mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&check_hlds__simplify__simplify_goal_disj_scalar_common_4[0]), LambdaLineNum_20, &Var_116);
        ...
        else
        {
          ...
          mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&check_hlds__simplify__simplify_goal_disj_scalar_common_4[0]), LambdaLineNum_20, &Var_124);
      ...
      Pieces_25 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_format_component_0), Var_41, Var_53);
      {
        ...
        MR_hl_field(MR_mktag(1), Spec_26, 0) = ((MR_Box) ((MR_Unsigned) 4U));
        MR_hl_field(MR_mktag(1), Spec_26, 1) = ((MR_Box) (MR_mkword(MR_mktag(2), &check_hlds__simplify__simplify_goal_disj_scalar_common_4[1])));
        MR_hl_field(MR_mktag(1), Spec_26, 2) = ((MR_Box) (Context_24));
