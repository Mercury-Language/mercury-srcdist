...
{
  {
    ...
    else
    {
      ...
      if ((Disjuncts_9 == (MR_Word) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
        *Goal_3 = Disjunct_8;
      else
      {
        ...
        MR_Word Var_39;
        MR_Word _CondGoal_15 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Disjunct_8, (MR_Integer) 0))));
        MR_Word _RestGoal_19;
        ...
        _RestGoal_19 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Rest_18, (MR_Integer) 0))));
        ...
        hlds__hlds_goal__goal_info_set_determinism_3_p_0(Detism_37, NewGoalInfo1_27, &NewGoalInfo_38);
        {
          ...
          MR_hl_field(MR_mktag(3), Var_39, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
