  ...
  MR_Word * STATE_VARIABLE_Info_39)
{
  ...
  if ((Disjuncts_21 == (MR_Word) ((MR_Unsigned) 0U)))
  {
    ...
    Var_51 = hlds__make_goal__fail_goal_with_context_1_f_0(Context_23);
    ...
    *GoalInfo_14 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_51, (MR_Integer) 1))));
    STATE_VARIABLE_Info_50_50 = STATE_VARIABLE_Info_42_42;
  }
  else
  {
    MR_Word Var_57 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Disjuncts_21, (MR_Integer) 1))));
    MR_Word Var_58 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Disjuncts_21, (MR_Integer) 0))));

    if ((Var_57 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      MR_Word Goal1_25 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_58, (MR_Integer) 0))));
      MR_Word GoalInfo1_26 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_58, (MR_Integer) 1))));

      check_hlds__simplify__simplify_goal__simplify_maybe_wrap_goal_7_p_0(GoalInfo0_13, GoalInfo1_26, Goal1_25, GoalExpr_12, GoalInfo_14, STATE_VARIABLE_Info_42_42, &STATE_VARIABLE_Info_50_50);
    }
    else
    {
      {
      ...
      else
      {
        ...
        check_hlds__simplify__simplify_info__simplify_info_get_var_types_2_p_0(STATE_VARIABLE_Info_42_42, &VarTypes_32);
        {
          ...
          MR_hl_field(MR_mktag(0), Var_45, 0) = ((MR_Box) (VarTypes_32));
        }
        hlds__instmap__merge_instmap_deltas_7_p_0(Var_45, NonLocals_31, InstMap0_16, InstMapDeltas_22, &NewDelta_33, ModuleInfo1_30, &ModuleInfo2_34);
        check_hlds__simplify__simplify_info__simplify_info_set_module_info_3_p_0(ModuleInfo2_34, STATE_VARIABLE_Info_42_42, &STATE_VARIABLE_Info_46_46);
        hlds__hlds_goal__goal_info_set_instmap_delta_3_p_0(NewDelta_33, GoalInfo0_13, GoalInfo_14);
        succeeded = check_hlds__simplify__simplify_info__simplify_do_after_front_end_1_p_0(STATE_VARIABLE_Info_46_46);
        if (succeeded)
        {
          Var_47 = ((MR_Word) ((MR_hl_field(MR_mktag(0), NestedContext0_15, (MR_Integer) 1))));
          succeeded = (Var_47 != (MR_Word) ((MR_Unsigned) 0U));
          if (succeeded)
            Innermost_35 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Var_47, (MR_Integer) 0))));
        }
        if (succeeded)
          check_hlds__simplify__simplify_goal_disj__warn_about_any_problem_partial_vars_6_p_0(Innermost_35, GoalInfo0_13, InstMap0_16, NewDelta_33, STATE_VARIABLE_Info_46_46, &STATE_VARIABLE_Info_50_50);
        else
  ...
  *Common_18 = Common0_17;
  ...
  if (succeeded)
    *STATE_VARIABLE_Info_39 = STATE_VARIABLE_Info_50_50;
  else
  {
    MR_Word STATE_VARIABLE_Info_52_52;

    check_hlds__simplify__simplify_info__simplify_info_set_rerun_quant_instmap_delta_2_p_0(STATE_VARIABLE_Info_50_50, &STATE_VARIABLE_Info_52_52);
          ...
          else
          {
            ...
            else
            {
              ...
              }
              {
                ...
                MR_hl_field(MR_mktag(1), Var_90, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &check_hlds__simplify__simplify_goal_disj_scalar_common_1[23])));
              }
              {
                Var_87 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(1), Var_87, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &check_hlds__simplify__simplify_goal_disj_scalar_common_1[20])));
                MR_hl_field(MR_mktag(1), Var_87, 1) = ((MR_Box) (Var_90));
              }
              {
                Var_84 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(1), Var_84, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &check_hlds__simplify__simplify_goal_disj_scalar_common_1[19])));
  ...
  else
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&check_hlds__simplify__simplify_goal_disj_scalar_common_3[0]), LambdaLineNum_20, &Var_117);
      ...
      else
      {
        ...
        mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&check_hlds__simplify__simplify_goal_disj_scalar_common_3[0]), LambdaLineNum_20, &Var_125);
