  ...
  MR_Word * Var_9)
{
  ...
  *Var_9 = ((MR_Word) ((MR_hl_field(0, HeadVar__4_4, 0))));
  ...
  else
  {
    ...
    {
      succeeded = hlds__inst_match__inst_matches_final_4_p_0(ModuleInfo_6, Type_11, FinalInst_10, InitInst_12);
      if (succeeded)
        succeeded = MR_FALSE;
      else
        succeeded = MR_TRUE;
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          mercury__map__to_assoc_list_2_p_0((MR_Word) (&hlds__pred_proc_id__hlds__pred_proc_id__type_ctor_info_proc_id_0), (MR_Word) (&hlds__hlds_proc__hlds__hlds_proc__type_ctor_info_proc_info_0), ProcTable_47, &Procs_48);
          ...
          else
          {
            ...
            else
            {
              ...
              Var_88 = hlds__pred_proc_id__proc_id_to_int_1_f_0(ProcId_45);
          ...
          Var_116 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), MainPieces_41, ModePieces_50);
          {
            ...
            MR_hl_field(0, Spec_56, 1) = ((MR_Box) (MR_mkword(1, &check_hlds__simplify__simplify_goal_disj_scalar_common_3[3])));
        ...
        if (succeeded)
        {
          ...
          mercury__set__union_3_p_0((MR_Word) (&hlds__pred_proc_id__hlds__pred_proc_id__type_ctor_info_pred_proc_id_0), SubGoalCalledProcs_59, DeletedCallCallees0_58, &DeletedCallCallees_60);
  ...
  MR_Word * STATE_VARIABLE_Info_28)
{
  ...
  else
  {
    ...
    Pieces_25 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), (MR_Word) (MR_mkword(1, &check_hlds__simplify__simplify_goal_disj_scalar_common_1[4])), Var_51);
    {
      ...
      MR_hl_field(0, Spec_26, 1) = ((MR_Box) (MR_mkword(1, &check_hlds__simplify__simplify_goal_disj_scalar_common_3[1])));
