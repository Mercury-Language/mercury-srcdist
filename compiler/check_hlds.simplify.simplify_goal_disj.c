  ...
  MR_Word * STATE_VARIABLE_Info_39)
{
  ...
  {
    MR_Word Var_55 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Disjuncts_21, (MR_Integer) 1))));
    MR_Word Var_56 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Disjuncts_21, (MR_Integer) 0))));

    if ((Var_55 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      MR_Word Goal1_25 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_56, (MR_Integer) 0))));
      MR_Word GoalInfo1_26 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_56, (MR_Integer) 1))));
    ...
    else
    {
      ...
      else
      {
        ...
        if (succeeded)
        {
          Var_49 = ((MR_Word) ((MR_hl_field(MR_mktag(0), NestedContext0_15, (MR_Integer) 1))));
          succeeded = (Var_49 != (MR_Word) ((MR_Unsigned) 0U));
          if (succeeded)
            Innermost_35 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Var_49, (MR_Integer) 0))));
        }
        if (succeeded)
