...
{
  {
    ...
    else
    {
      ...
      if ((Disjuncts_9 == (MR_Word) ((MR_Integer) 0)))
        *Goal_3 = Disjunct_8;
      else
      {
        ...
        hlds__hlds_goal__goal_info_set_determinism_3_p_0(Detism_37, NewGoalInfo1_27, &NewGoalInfo_38);
        {
          ...
          MR_hl_field(MR_mktag(3), Var_39, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 6));
...
{
  {
    ...
    check_hlds__simplify__simplify_goal_disj__simplify_disj_10_p_0(Disjuncts0_20, (MR_Word) ((MR_Integer) 0), &Disjuncts_21, NestedContext0_15, InstMap0_16, Common0_17, (MR_Word) ((MR_Integer) 0), &InstMapDeltas_22, STATE_VARIABLE_Info_0_38, &STATE_VARIABLE_Info_42_42);
    if ((Disjuncts_21 == (MR_Word) ((MR_Integer) 0)))
    {
      MR_Word Context_23;
      MR_Word Var_50;
      ...
      if (succeeded)
      {
          ...
          STATE_VARIABLE_Info_81_81 = STATE_VARIABLE_Info_55_55;
        {
          ...
          if (succeeded)
          {
            ...
            succeeded = (Var_84 == (MR_Word) ((MR_Integer) 0));
          }
        }
        if (!(succeeded))
        {
...
{
  {
    ...
    if ((ProblemPartialVars_14 == (MR_Word) ((MR_Integer) 0)))
    ...
    else
    {
      ...
      if ((Innermost_7 == (MR_Word) ((MR_Integer) 0)))
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(0), Spec_28, 0) = ((MR_Box) ((MR_Integer) 4));
