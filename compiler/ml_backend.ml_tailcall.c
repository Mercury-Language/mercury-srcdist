...
static MR_bool MR_CALL 
ml_backend__ml_tailcall__IntroducedFrom__pred__mark_tailcalls_in_stmt__441__1_2_p_0(
                ...
                if (ml_backend__ml_tailcall__succeeded)
                  *ml_backend__ml_tailcall__STATE_VARIABLE_InBodyInfo_43 = ml_backend__ml_tailcall__STATE_VARIABLE_InBodyInfo_0_42;
                else
                  {
                    ...
                    {
                      hlds__mark_tail_calls__add_message_for_nontail_recursive_call_6_p_0(ml_backend__ml_tailcall__SimpleCallId_39, ml_backend__ml_tailcall__ProcId_27, ml_backend__ml_tailcall__WarnOrError_15, ml_backend__ml_tailcall__V_45_45, ml_backend__ml_tailcall__Specs0_40, &ml_backend__ml_tailcall__Specs_41);
                    }
...
{
  {
    ...
    {
      ml_backend__ml_tailcall__succeeded = ml_backend__ml_tailcall__IntroducedFrom__pred__mark_tailcalls_in_stmt__441__1_2_p_0(((MR_Word) (MR_hl_field(MR_mktag(0), ml_backend__ml_tailcall__closure, (MR_Integer) 3))), ((MR_Word) ml_backend__ml_tailcall__wrapper_arg_1));
    }
    return ml_backend__ml_tailcall__succeeded;
  }
}
