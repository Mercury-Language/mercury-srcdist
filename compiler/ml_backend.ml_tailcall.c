...
ml_backend__ml_tailcall__mark_tailcalls_in_function_defn_7_p_0(
  ...
  MR_Word ml_backend__ml_tailcall__STATE_VARIABLE_Specs_0_39,
  MR_Word * ml_backend__ml_tailcall__STATE_VARIABLE_Specs_40);
...
{
  {
    ...
    if ((ml_backend__ml_tailcall__FuncBody0_19 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
    {
      ...
      *ml_backend__ml_tailcall__STATE_VARIABLE_Specs_40 = ml_backend__ml_tailcall__STATE_VARIABLE_Specs_0_39;
    }
    else
    {
      ...
      MR_Word ml_backend__ml_tailcall__STATE_VARIABLE_Specs_43_43;
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(0), ml_backend__ml_tailcall__InBodyInfo0_30, 0) = ((MR_Box) ((MR_Integer) 0));
        MR_hl_field(MR_mktag(0), ml_backend__ml_tailcall__InBodyInfo0_30, 1) = ((MR_Box) (ml_backend__ml_tailcall__STATE_VARIABLE_Specs_0_39));
      }
      ...
      ml_backend__ml_tailcall__STATE_VARIABLE_Specs_43_43 = ((MR_Word) (MR_hl_field(MR_mktag(0), ml_backend__ml_tailcall__InBodyInfo_33, (MR_Integer) 1)));
      {
      ...
      if ((ml_backend__ml_tailcall__MaybePredProcId_17 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
        *ml_backend__ml_tailcall__STATE_VARIABLE_Specs_40 = ml_backend__ml_tailcall__STATE_VARIABLE_Specs_43_43;
      else
      {
        MR_Word ml_backend__ml_tailcall__PredProcId_36 = ((MR_Word) (MR_hl_field(MR_mktag(1), ml_backend__ml_tailcall__MaybePredProcId_17, (MR_Integer) 0)));
        MR_Word ml_backend__ml_tailcall__PredInfo_37;
        MR_Word ml_backend__ml_tailcall__ProcInfo_38;

        hlds__hlds_module__module_info_pred_proc_info_4_p_0(ml_backend__ml_tailcall__ModuleInfo_8, ml_backend__ml_tailcall__PredProcId_36, &ml_backend__ml_tailcall__PredInfo_37, &ml_backend__ml_tailcall__ProcInfo_38);
        hlds__mark_tail_calls__maybe_report_no_tail_or_nontail_recursive_calls_5_p_0(ml_backend__ml_tailcall__PredInfo_37, ml_backend__ml_tailcall__ProcInfo_38, ml_backend__ml_tailcall__FoundRecCall_34, ml_backend__ml_tailcall__STATE_VARIABLE_Specs_43_43, ml_backend__ml_tailcall__STATE_VARIABLE_Specs_40);
      }
    }
  }
}
...
{
  {
    ...
    ml_backend__ml_tailcall__succeeded = ml_backend__ml_tailcall__IntroducedFrom__pred__mark_tailcalls_in_stmt__360__1_2_p_0(((MR_Word) (MR_hl_field(MR_mktag(0), ml_backend__ml_tailcall__closure, (MR_Integer) 3))), ((MR_Word) ml_backend__ml_tailcall__wrapper_arg_1));
    return ml_backend__ml_tailcall__succeeded;
  }
}
...
{
  {
    ...
    if (ml_backend__ml_tailcall__succeeded)
    {
...

      {
        ...
        MR_hl_field(MR_mktag(0), ml_backend__ml_tailcall__STATE_VARIABLE_InBodyInfo_29_29, 0) = ((MR_Box) ((MR_Integer) 1));
