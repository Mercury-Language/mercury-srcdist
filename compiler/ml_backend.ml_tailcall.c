...
MR_decl_label6(ml_backend__ml_tailcall__mark_tailcalls_in_defn_2_0, 5,7,3,14,16,42)
MR_decl_label2(ml_backend__ml_tailcall__mark_tailcalls_in_function_body_4_0, 15,4)
...
MR_decl_label3(ml_backend__ml_tailcall__report_nontailcall_warning_4_0, 6,15,32)
MR_decl_label10(fn__ml_backend__ml_tailcall__check_const_2_0, 8,11,10,14,17,3,25,24,28,31)
MR_decl_label7(fn__ml_backend__ml_tailcall__check_const_2_0, 30,33,35,37,27,39,22)
MR_decl_label9(fn__ml_backend__ml_tailcall__check_lval_2_0, 66,8,11,10,14,17,7,19,5)
MR_decl_label10(fn__ml_backend__ml_tailcall__check_rval_2_0, 50,3,4,8,23,7,6,12,14,16)
...
{
MR_LIST_CTOR_ADDR,
MR_CTOR0_ADDR(ml_backend__ml_tailcall, local_defns)
}
},
{
{
...
MR_BEGIN_MODULE(ml_backend__ml_tailcall_module4)
	...
	MR_init_label10(fn__ml_backend__ml_tailcall__check_const_2_0,8,11,10,14,17,3,25,24,28,31)
	MR_init_label7(fn__ml_backend__ml_tailcall__check_const_2_0,30,33,35,37,27,39,22)
MR_BEGIN_CODE
...
MR_def_static(fn__ml_backend__ml_tailcall__check_const_2_0)
	...
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_tfield(0, MR_body((MR_Integer) MR_r1, (MR_Integer) 1), 1);
	if (MR_PTAG_TESTR(MR_tempr1,1)) {
	...
	MR_sv(1) = MR_body((MR_Integer) MR_tempr1, (MR_Integer) 1);
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(ml_backend__ml_tailcall, local_defns);
	}
	MR_np_call_localret_ent(list__member_2_1,
		fn__ml_backend__ml_tailcall__check_const_2_0_i8);
MR_def_label(fn__ml_backend__ml_tailcall__check_const_2_0,8)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_r1,1)) {
		MR_GOTO_LAB(fn__ml_backend__ml_tailcall__check_const_2_0_i10);
	}
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
	...
	MR_np_call_localret_ent(list__member_2_1,
		fn__ml_backend__ml_tailcall__check_const_2_0_i11);
...
MR_def_label(fn__ml_backend__ml_tailcall__check_const_2_0,3)
	...
	MR_r3 = MR_tempr1;
	if (MR_PTAG_TESTR(MR_tempr1,1)) {
		MR_GOTO_LAB(fn__ml_backend__ml_tailcall__check_const_2_0_i25);
	}
...
MR_def_label(fn__ml_backend__ml_tailcall__check_const_2_0,25)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_def_label(fn__ml_backend__ml_tailcall__check_const_2_0,31)
	...
	MR_np_call_localret_ent(__Unify___ml_backend__mlds__mlds_pred_label_0_0,
		fn__ml_backend__ml_tailcall__check_const_2_0_i35);
...
MR_def_label(fn__ml_backend__ml_tailcall__check_const_2_0,33)
	...
	MR_np_call_localret_ent(__Unify___ml_backend__mlds__mlds_pred_label_0_0,
		fn__ml_backend__ml_tailcall__check_const_2_0_i35);
MR_def_label(fn__ml_backend__ml_tailcall__check_const_2_0,35)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO(MR_ENTRY(MR_do_redo));
	}
...
MR_BEGIN_MODULE(ml_backend__ml_tailcall_module5)
	...
	MR_init_label10(fn__ml_backend__ml_tailcall__check_rval_2_0,50,3,4,8,23,7,6,12,14,16)
MR_BEGIN_CODE
...
MR_def_label(fn__ml_backend__ml_tailcall__check_rval_2_0,4)
	...
	MR_np_localcall_lab(fn__ml_backend__ml_tailcall__check_rval_2_0,
		fn__ml_backend__ml_tailcall__check_rval_2_0_i8);
MR_def_label(fn__ml_backend__ml_tailcall__check_rval_2_0,8)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(fn__ml_backend__ml_tailcall__check_rval_2_0_i7);
	}
MR_def_label(fn__ml_backend__ml_tailcall__check_rval_2_0,23)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Integer) 0;
	MR_decr_sp_and_return(3);
MR_def_label(fn__ml_backend__ml_tailcall__check_rval_2_0,7)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(2);
	MR_r2 = MR_sv(1);
	MR_succip_word = MR_sv(3);
...
MR_def_label(fn__ml_backend__ml_tailcall__check_rval_2_0,6)
	...
	if (MR_RTAGS_TESTR(MR_r1,3,0)) {
		MR_GOTO_LAB(fn__ml_backend__ml_tailcall__check_rval_2_0_i12);
	}
...
MR_def_label(fn__ml_backend__ml_tailcall__check_rval_2_0,16)
	...
	if (MR_RTAGS_TESTR(MR_r1,3,4)) {
		MR_GOTO_LAB(fn__ml_backend__ml_tailcall__check_rval_2_0_i23);
	}
	MR_r1 = MR_tfield(3, MR_r1, 2);
	MR_succip_word = MR_sv(3);
	MR_GOTO_LAB(fn__ml_backend__ml_tailcall__check_rval_2_0_i50);
...
MR_def_static(ml_backend__ml_tailcall__mark_tailcalls_in_default_4_0)
	...
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_body((MR_Integer) MR_r3, (MR_Integer) 1);
...
MR_BEGIN_MODULE(ml_backend__ml_tailcall_module14)
	...
	MR_init_label2(ml_backend__ml_tailcall__mark_tailcalls_in_function_body_4_0,15,4)
MR_BEGIN_CODE
...
MR_def_static(ml_backend__ml_tailcall__mark_tailcalls_in_function_body_4_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r3,0,0)) {
		MR_GOTO_LAB(ml_backend__ml_tailcall__mark_tailcalls_in_function_body_4_0_i15);
	}
	MR_r1 = (MR_Word) MR_tbmkword(0, 0);
	MR_proceed();
MR_def_label(ml_backend__ml_tailcall__mark_tailcalls_in_function_body_4_0,15)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(1);
	MR_sv(1) = (MR_Word) MR_succip;
	MR_r3 = MR_body((MR_Integer) MR_r3, (MR_Integer) 1);
	MR_np_call_localret_ent(ml_backend__ml_tailcall__mark_tailcalls_in_statement_4_0,
...
MR_BEGIN_MODULE(ml_backend__ml_tailcall_module15)
	...
	MR_init_label6(ml_backend__ml_tailcall__mark_tailcalls_in_defn_2_0,5,7,3,14,16,42)
MR_BEGIN_CODE
...
MR_def_label(ml_backend__ml_tailcall__mark_tailcalls_in_defn_2_0,3)
	...
	if (MR_PTAG_TEST(MR_r5,1)) {
		MR_GOTO_LAB(ml_backend__ml_tailcall__mark_tailcalls_in_defn_2_0_i42);
	}
	MR_incr_sp(10);
	MR_sv(10) = (MR_Word) MR_succip;
	{
	...
	if (MR_LTAGS_TESTR(MR_tempr1,0,0)) {
		MR_GOTO_LAB(ml_backend__ml_tailcall__mark_tailcalls_in_defn_2_0_i14);
	}
	MR_sv(1) = MR_tfield(0, MR_r1, 0);
	MR_sv(2) = MR_tfield(0, MR_r1, 1);
	MR_sv(3) = MR_tfield(0, MR_r1, 2);
	...
	MR_np_call_localret_ent(ml_backend__ml_tailcall__mark_tailcalls_in_function_body_4_0,
		ml_backend__ml_tailcall__mark_tailcalls_in_defn_2_0_i16);
MR_def_label(ml_backend__ml_tailcall__mark_tailcalls_in_defn_2_0,14)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(1) = MR_tfield(0, MR_r1, 0);
	MR_sv(2) = MR_tfield(0, MR_r1, 1);
	MR_sv(3) = MR_tfield(0, MR_r1, 2);
...
MR_def_label(ml_backend__ml_tailcall__mark_tailcalls_in_defn_2_0,42)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_proceed();
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
...
MR_def_label(ml_backend__ml_tailcall__nontailcall_in_defn_3_0,2)
	...
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_tfield(2, MR_r3, 2);
	MR_r4 = MR_tempr1;
	if (MR_LTAGS_TEST(MR_tempr1,0,0)) {
		MR_GOTO(MR_ENTRY(MR_do_fail));
	}
	MR_fv(2) = MR_r1;
	MR_fv(3) = MR_tfield(0, MR_r2, 0);
...
MR_def_label(ml_backend__ml_tailcall__nontailcall_in_defn_3_0,11)
	...
	MR_tag_alloc_heap(MR_fv(5), 1, (MR_Integer) 1);
	MR_tfield(1, MR_fv(5), 0) = MR_tfield(1, MR_tempr4, 1);
	MR_tempr5 = MR_r1;
	MR_r1 = MR_fv(2);
	MR_fv(4) = MR_tfield(0, MR_tempr5, 1);
	MR_tempr5 = MR_tfield(1, MR_tempr4, 0);
	MR_fv(6) = MR_tfield(0, MR_tempr5, 2);
	MR_fv(7) = MR_tfield(0, MR_tempr5, 1);
...
MR_def_label(ml_backend__ml_tailcall__nontailcall_in_defn_3_0,17)
	...
	MR_tempr1 = MR_r1;
	MR_r1 = MR_fv(2);
	MR_fv(4) = MR_tfield(0, MR_tempr1, 1);
	MR_fv(5) = (MR_Word) MR_tbmkword(0, 0);
	MR_tempr1 = MR_tfield(0, MR_r4, 0);
	MR_fv(6) = MR_tfield(0, MR_tempr1, 2);
...
MR_def_label(ml_backend__ml_tailcall__nontailcall_in_defn_3_0,19)
	...
	if (MR_INT_NE(MR_fv(7),0)) {
		MR_GOTO(MR_ENTRY(MR_do_redo));
	}
	if (MR_PTAG_TESTR(MR_fv(3),2)) {
		MR_GOTO(MR_ENTRY(MR_do_redo));
	}
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tempr1 = MR_fv(6);
	MR_fv(6) = MR_tfield(0, MR_tempr1, 0);
	MR_fv(7) = MR_tfield(0, MR_tempr1, 1);
	MR_tempr2 = MR_fv(3);
	MR_fv(1) = MR_tfield(2, MR_tempr2, 1);
...
MR_def_label(ml_backend__ml_tailcall__nontailcall_in_defn_3_0,25)
	...
	MR_tfield(0, MR_r1, 1) = MR_fv(7);
	MR_tfield(0, MR_r1, 2) = MR_fv(4);
	MR_succeed();
...
MR_BEGIN_MODULE(ml_backend__ml_tailcall_module18)
	...
	MR_init_label3(ml_backend__ml_tailcall__report_nontailcall_warning_4_0,6,15,32)
MR_BEGIN_CODE
...
MR_def_static(ml_backend__ml_tailcall__report_nontailcall_warning_4_0)
	...
	if (MR_PTAG_TEST(MR_tempr1,1)) {
		MR_GOTO_LAB(ml_backend__ml_tailcall__report_nontailcall_warning_4_0_i32);
	}
	MR_incr_sp(4);
	MR_sv(4) = (MR_Word) MR_succip;
...
MR_def_label(ml_backend__ml_tailcall__report_nontailcall_warning_4_0,6)
	...
	MR_tag_alloc_heap(MR_r2, 1, (MR_Integer) 2);
	MR_tfield(1, MR_r2, 0) = (MR_Word) MR_TAG_COMMON(3,1,2);
	...
	MR_np_call_localret_ent(fn__ml_backend__mlds__mlds_get_prog_context_1_0,
		ml_backend__ml_tailcall__report_nontailcall_warning_4_0_i15);
...
MR_def_label(ml_backend__ml_tailcall__report_nontailcall_warning_4_0,32)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_proceed();
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
...
void mercury__ml_backend__ml_tailcall__init_threadscope_string_table(void);
#endif
...
void mercury__ml_backend__ml_tailcall__write_out_proc_statics(FILE *deep_fp, FILE *procrep_fp)
{
	MR_write_out_module_proc_reps_start(procrep_fp, &mercury_data__module_layout__ml_backend__ml_tailcall);
