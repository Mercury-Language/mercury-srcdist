...
MR_decl_label3(fn__ml_backend__ml_tailcall__mark_tailcalls_in_cases_3_0, 13,4,5)
...
MR_decl_label5(fn__ml_backend__ml_tailcall__mark_tailcalls_in_statements_3_0, 24,4,6,7,10)
...
MR_BEGIN_MODULE(ml_backend__ml_tailcall_module7)
	...
	MR_init_label5(fn__ml_backend__ml_tailcall__mark_tailcalls_in_statements_3_0,24,4,6,7,10)
MR_BEGIN_CODE
...
MR_def_static(fn__ml_backend__ml_tailcall__mark_tailcalls_in_statements_3_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
		MR_GOTO_LAB(fn__ml_backend__ml_tailcall__mark_tailcalls_in_statements_3_0_i24);
	}
	MR_r1 = (MR_Word) MR_tbmkword(0, 0);
	MR_proceed();
MR_def_label(fn__ml_backend__ml_tailcall__mark_tailcalls_in_statements_3_0,24)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(4);
	MR_sv(4) = (MR_Word) MR_succip;
	MR_sv(1) = MR_r2;
...
MR_def_label(fn__ml_backend__ml_tailcall__mark_tailcalls_in_stmt_3_0,34)
	...
	MR_tfield(3, MR_tempr1, 6) = (MR_Integer) 1;
	MR_decr_sp_and_return(8);
	}
...
MR_BEGIN_MODULE(ml_backend__ml_tailcall_module10)
	...
	MR_init_label3(fn__ml_backend__ml_tailcall__mark_tailcalls_in_cases_3_0,13,4,5)
MR_BEGIN_CODE
...
MR_def_static(fn__ml_backend__ml_tailcall__mark_tailcalls_in_cases_3_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
		MR_GOTO_LAB(fn__ml_backend__ml_tailcall__mark_tailcalls_in_cases_3_0_i13);
	}
	MR_r1 = (MR_Word) MR_tbmkword(0, 0);
	MR_proceed();
MR_def_label(fn__ml_backend__ml_tailcall__mark_tailcalls_in_cases_3_0,13)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(4);
	MR_sv(4) = (MR_Word) MR_succip;
	MR_sv(1) = MR_r2;
...
MR_def_label(ml_backend__ml_tailcall__nontailcall_in_defn_3_0,4)
	...
	MR_r3 = MR_tempr3;
	if (MR_RTAGS_TESTR(MR_tempr3,3,3)) {
		MR_GOTO(MR_ENTRY(MR_do_redo));
	}
...
MR_def_label(ml_backend__ml_tailcall__nontailcall_in_defn_3_0,17)
	...
	MR_r1 = MR_tempr1;
	MR_tfield(0, MR_tempr1, 0) = MR_fv(5);
	MR_tfield(0, MR_tempr1, 1) = MR_fv(6);
	MR_tfield(0, MR_tempr1, 2) = MR_fv(3);
	MR_succeed();
	}
...
MR_def_label(ml_backend__ml_tailcall__report_nontailcall_warning_4_0,5)
	...
	MR_tfield(0, MR_tempr3, 1) = (MR_Word) MR_tbmkword(0, 11);
