            ...
            if ((ml_backend__ml_tailcall__env_ptr)->ml_backend__ml_tailcall__check_const_3_f_0_env_0__succeeded)
              {
                ...
                if ((ml_backend__ml_tailcall__env_ptr)->ml_backend__ml_tailcall__check_const_3_f_0_env_0__succeeded)
                  {
                    (ml_backend__ml_tailcall__env_ptr)->ml_backend__ml_tailcall__check_const_3_f_0_env_0__TypeInfo_23_47 = (MR_Word) &ml_backend__ml_tailcall_scalar_common_1[15];
                    {
    ...
    if (((MR_tag((MR_Word) ml_backend__ml_tailcall__PredLabel_7)) == (MR_mktag((MR_Integer) 1))))
    ...
    else
      {
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(0), ml_backend__ml_tailcall__V_60_60, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 18))));
                    ...
                    *ml_backend__ml_tailcall__Warnings_8 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
                  else
                    {
                      ...
                      }
                      {
                        ...
                        MR_hl_field(MR_mktag(0), ml_backend__ml_tailcall__NonRecursiveSpec_29, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 18))));
