...
static /* final */ const MR_Box hlds__pred_name_scalar_common_1[13][3];
...
static /* final */ const struct hlds__pred_name__vector_common_type_6_0_s hlds__pred_name_vector_common_6[33];
          ...
          case (MR_Integer) 1:
            {
              ...
              MR_Integer SeqNo_20 = ((MR_Integer) ((MR_hl_field(MR_mktag(1), OriginUser_7, (MR_Integer) 2))));
              MR_String Var_21;
              ...
              if (succeeded)
              {
                ...
                succeeded = (SeqNo_20 > (MR_Integer) 1);
                if (succeeded)
                {
                  MR_String Var_74;
                  MR_String Var_82;
                  ...
                  mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&hlds__pred_name_scalar_common_3[0]), SeqNo_20, &Var_86);
