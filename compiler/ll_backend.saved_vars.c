  ...
  MR_Word HeadVar__2_2)
{
  ...
  else
  {
    ...
    if (succeeded)
    {
      TypeCtorInfo__14_14 = (MR_Word) (&parse_tree__vartypes__parse_tree__vartypes__type_ctor_info_vartypes_0);
      succeeded = mercury__builtin__unify_2_p_0(TypeCtorInfo__14_14, ((MR_Box) (ArgX2_5)), ((MR_Box) (ArgY2_6)));
      if (succeeded)
      {
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_38)
{
  ...
  hlds__hlds_pred__proc_info_get_varset_vartypes_3_p_0(STATE_VARIABLE_ProcInfo_0_35, &Varset0_15, &VarTypes0_16);
  ...
  check_hlds__recompute_instmap_deltas__recompute_instmap_delta_8_p_0((MR_Integer) 1, VarTypes_28, InstVarSet_31, InstMap0_30, Goal2_26, &Goal_32, STATE_VARIABLE_ModuleInfo_0_37, STATE_VARIABLE_ModuleInfo_38);
  hlds__hlds_pred__proc_info_set_goal_3_p_0(Goal_32, STATE_VARIABLE_ProcInfo_0_35, &STATE_VARIABLE_ProcInfo_69_69);
  hlds__hlds_pred__proc_info_set_varset_vartypes_4_p_0(Varset_27, VarTypes_28, STATE_VARIABLE_ProcInfo_69_69, &STATE_VARIABLE_ProcInfo_70_70);
  hlds__hlds_pred__proc_info_set_rtti_varmaps_3_p_0(RttiVarMaps_29, STATE_VARIABLE_ProcInfo_70_70, STATE_VARIABLE_ProcInfo_36);
}
  ...
  MR_Word * STATE_VARIABLE_SlotInfo_20)
{
  ...
  if (succeeded)
  {
    ...
    MR_Word Varset0_25 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_SlotInfo_0_19, (MR_Integer) 0))));
    MR_Word VarTypes0_26 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_SlotInfo_0_19, (MR_Integer) 1))));
    MR_Word RttiVarMaps0_27 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_SlotInfo_0_19, (MR_Integer) 2))));
    MR_Word TypeInfoLiveness_28 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_SlotInfo_0_19, (MR_Integer) 3))) & (MR_Integer) 1);
    MR_Word Varset_29;
    MR_Word Type_30;
    MR_Word VarTypes_31;
    ...
    mercury__varset__new_var_3_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), &NewVar_15, Varset0_25, &Varset_29);
    {
      Var_34 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), Var_34, 0) = ((MR_Box) (Var_10));
      MR_hl_field(MR_mktag(0), Var_34, 1) = ((MR_Box) (NewVar_15));
    }
    {
    ...
    mercury__map__from_assoc_list_2_p_0((MR_Word) (&ll_backend__saved_vars_scalar_common_1[0]), (MR_Word) (&ll_backend__saved_vars_scalar_common_1[0]), Var_33, &Subst_16);
    parse_tree__vartypes__lookup_var_type_3_p_0(VarTypes0_26, Var_10, &Type_30);
    parse_tree__vartypes__add_var_type_4_p_0(NewVar_15, Type_30, VarTypes0_26, &VarTypes_31);
    hlds__hlds_rtti__rtti_var_info_duplicate_4_p_0(Var_10, NewVar_15, RttiVarMaps0_27, &RttiVarMaps_32);
    {
      STATE_VARIABLE_SlotInfo_21_21 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), STATE_VARIABLE_SlotInfo_21_21, 0) = ((MR_Box) (Varset_29));
      MR_hl_field(MR_mktag(0), STATE_VARIABLE_SlotInfo_21_21, 1) = ((MR_Box) (VarTypes_31));
      MR_hl_field(MR_mktag(0), STATE_VARIABLE_SlotInfo_21_21, 2) = ((MR_Box) (RttiVarMaps_32));
      MR_hl_field(MR_mktag(0), STATE_VARIABLE_SlotInfo_21_21, 3) = (MR_Box) ((MR_Unsigned) (TypeInfoLiveness_28));
    }
      ...
      if ((env).ll_backend__saved_vars__saved_vars_in_conj_5_p_0_env_0__succeeded)
      {
        ...
        if ((env).ll_backend__saved_vars__saved_vars_in_conj_5_p_0_env_0__succeeded)
        {
          ...
          if ((env).ll_backend__saved_vars__saved_vars_in_conj_5_p_0_env_0__succeeded)
          {
            ...
            if ((env).ll_backend__saved_vars__saved_vars_in_conj_5_p_0_env_0__succeeded)
            {
              Var_51 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_SlotInfo_0_4, (MR_Integer) 0))));
              VarTypes_52 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_SlotInfo_0_4, (MR_Integer) 1))));
              Var_53 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_SlotInfo_0_4, (MR_Integer) 2))));
              packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_SlotInfo_0_4, (MR_Integer) 3)));
              TypeInfoLiveness_54 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_SlotInfo_0_4, (MR_Integer) 3))) & (MR_Integer) 1);
              (env).ll_backend__saved_vars__saved_vars_in_conj_5_p_0_env_0__succeeded = (TypeInfoLiveness_54 == (MR_Integer) 1);
              if ((env).ll_backend__saved_vars__saved_vars_in_conj_5_p_0_env_0__succeeded)
              {
                parse_tree__vartypes__lookup_var_type_3_p_0(VarTypes_52, Var_21, &Type_55);
                (env).ll_backend__saved_vars__saved_vars_in_conj_5_p_0_env_0__succeeded = parse_tree__builtin_lib_types__type_is_type_info_or_ctor_type_1_p_0(Type_55);
              }
              (env).ll_backend__saved_vars__saved_vars_in_conj_5_p_0_env_0__succeeded = !((env).ll_backend__saved_vars__saved_vars_in_conj_5_p_0_env_0__succeeded);
              if ((env).ll_backend__saved_vars__saved_vars_in_conj_5_p_0_env_0__succeeded)
              {
  ...
  MR_Word * STATE_VARIABLE_SlotInfo_6)
{
  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      MR_Word Varset0_35 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_SlotInfo_0_5, (MR_Integer) 0))));
      MR_Word VarTypes0_36 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_SlotInfo_0_5, (MR_Integer) 1))));
      MR_Word RttiVarMaps0_37 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_SlotInfo_0_5, (MR_Integer) 2))));
      MR_Word TypeInfoLiveness_38 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_SlotInfo_0_5, (MR_Integer) 3))) & (MR_Integer) 1);
      MR_Word Varset_39;
      MR_Word Type_40;
      MR_Word VarTypes_41;
      ...
      MR_Word Conj1_51;
      MR_Word Conj_52;
      MR_Word STATE_VARIABLE_SlotInfo_19_53;

      mercury__varset__new_var_3_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), &NewVar_29, Varset0_35, &Varset_39);
      {
        Var_44 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), Var_44, 0) = ((MR_Box) (HeadVar__4_4));
        MR_hl_field(MR_mktag(0), Var_44, 1) = ((MR_Box) (NewVar_29));
      }
      {
      ...
      mercury__map__from_assoc_list_2_p_0((MR_Word) (&ll_backend__saved_vars_scalar_common_1[0]), (MR_Word) (&ll_backend__saved_vars_scalar_common_1[0]), Var_43, &Subst_30);
      parse_tree__vartypes__lookup_var_type_3_p_0(VarTypes0_36, HeadVar__4_4, &Type_40);
      parse_tree__vartypes__add_var_type_4_p_0(NewVar_29, Type_40, VarTypes0_36, &VarTypes_41);
      hlds__hlds_rtti__rtti_var_info_duplicate_4_p_0(HeadVar__4_4, NewVar_29, RttiVarMaps0_37, &RttiVarMaps_42);
      {
        STATE_VARIABLE_SlotInfo_21_33 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), STATE_VARIABLE_SlotInfo_21_33, 0) = ((MR_Box) (Varset_39));
        MR_hl_field(MR_mktag(0), STATE_VARIABLE_SlotInfo_21_33, 1) = ((MR_Box) (VarTypes_41));
        MR_hl_field(MR_mktag(0), STATE_VARIABLE_SlotInfo_21_33, 2) = ((MR_Box) (RttiVarMaps_42));
        MR_hl_field(MR_mktag(0), STATE_VARIABLE_SlotInfo_21_33, 3) = (MR_Box) ((MR_Unsigned) (TypeInfoLiveness_38));
      }
      ...
      ll_backend__saved_vars__saved_vars_in_goal_4_p_0(Goal1_32, &Goal1_48, STATE_VARIABLE_SlotInfo_21_33, &STATE_VARIABLE_SlotInfo_19_53);
      GoalInfo1_50 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Goal1_48, (MR_Integer) 1))));
      hlds__hlds_goal__goal_to_conj_list_2_p_0(Goal1_48, &Conj1_51);
      ll_backend__saved_vars__saved_vars_delay_goal_7_p_0(Conj1_51, &Conj_52, NewConstruct_31, NewVar_29, (MR_Integer) 0, STATE_VARIABLE_SlotInfo_19_53, &STATE_VARIABLE_SlotInfo_25_25);
      hlds__hlds_goal__conj_list_to_goal_3_p_0(Conj_52, GoalInfo1_50, &Goal_22);
    }
    else
  ...
  MR_Word * STATE_VARIABLE_SlotInfo_6)
{
  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      MR_Word Varset0_31 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_SlotInfo_0_5, (MR_Integer) 0))));
      MR_Word VarTypes0_32 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_SlotInfo_0_5, (MR_Integer) 1))));
      MR_Word RttiVarMaps0_33 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_SlotInfo_0_5, (MR_Integer) 2))));
      MR_Word TypeInfoLiveness_34 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_SlotInfo_0_5, (MR_Integer) 3))) & (MR_Integer) 1);
      MR_Word Varset_35;
      MR_Word Type_36;
      MR_Word VarTypes_37;
      ...
      MR_Word Conj1_47;
      MR_Word Conj_48;
      MR_Word STATE_VARIABLE_SlotInfo_19_49;

      mercury__varset__new_var_3_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), &NewVar_25, Varset0_31, &Varset_35);
      {
        Var_40 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), Var_40, 0) = ((MR_Box) (HeadVar__4_4));
        MR_hl_field(MR_mktag(0), Var_40, 1) = ((MR_Box) (NewVar_25));
      }
      {
      ...
      mercury__map__from_assoc_list_2_p_0((MR_Word) (&ll_backend__saved_vars_scalar_common_1[0]), (MR_Word) (&ll_backend__saved_vars_scalar_common_1[0]), Var_39, &Subst_26);
      parse_tree__vartypes__lookup_var_type_3_p_0(VarTypes0_32, HeadVar__4_4, &Type_36);
      parse_tree__vartypes__add_var_type_4_p_0(NewVar_25, Type_36, VarTypes0_32, &VarTypes_37);
      hlds__hlds_rtti__rtti_var_info_duplicate_4_p_0(HeadVar__4_4, NewVar_25, RttiVarMaps0_33, &RttiVarMaps_38);
      {
        STATE_VARIABLE_SlotInfo_21_29 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), STATE_VARIABLE_SlotInfo_21_29, 0) = ((MR_Box) (Varset_35));
        MR_hl_field(MR_mktag(0), STATE_VARIABLE_SlotInfo_21_29, 1) = ((MR_Box) (VarTypes_37));
        MR_hl_field(MR_mktag(0), STATE_VARIABLE_SlotInfo_21_29, 2) = ((MR_Box) (RttiVarMaps_38));
        MR_hl_field(MR_mktag(0), STATE_VARIABLE_SlotInfo_21_29, 3) = (MR_Box) ((MR_Unsigned) (TypeInfoLiveness_34));
      }
      ...
      ll_backend__saved_vars__saved_vars_in_goal_4_p_0(Goal1_28, &Goal1_44, STATE_VARIABLE_SlotInfo_21_29, &STATE_VARIABLE_SlotInfo_19_49);
      GoalInfo1_46 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Goal1_44, (MR_Integer) 1))));
      hlds__hlds_goal__goal_to_conj_list_2_p_0(Goal1_44, &Conj1_47);
      ll_backend__saved_vars__saved_vars_delay_goal_7_p_0(Conj1_47, &Conj_48, NewConstruct_27, NewVar_25, (MR_Integer) 0, STATE_VARIABLE_SlotInfo_19_49, &STATE_VARIABLE_SlotInfo_21_21);
      hlds__hlds_goal__conj_list_to_goal_3_p_0(Conj_48, GoalInfo1_46, &Goal_14);
    }
    else
  ...
  MR_Word * STATE_VARIABLE_SlotInfo_19)
{
  ...
  parse_tree__vartypes__lookup_var_type_3_p_0(VarTypes0_11, Var_6, &Type_15);
  parse_tree__vartypes__add_var_type_4_p_0(*NewVar_7, Type_15, VarTypes0_11, &VarTypes_16);
