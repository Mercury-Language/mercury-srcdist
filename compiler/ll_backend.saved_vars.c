                    ...
                    case (MR_Integer) 1:
                      {
                        ...
                        ll_backend__saved_vars__push_into_goals_rename_6_p_0(Conj0_55, &Conj_56, Construct_3, HeadVar__4_4, STATE_VARIABLE_SlotInfo_0_6, &STATE_VARIABLE_SlotInfo_104_104);
                        {
                          ...
                          MR_hl_field(MR_mktag(3), Var_105, 1) = ((MR_Box) (ConjType_54));
              ...
              case (MR_Integer) 4:
                {
                  ...
                  else
                  {
                    ...
                    ll_backend__saved_vars__push_into_cases_rename_6_p_0(Cases0_69, &Cases_70, Construct_3, HeadVar__4_4, STATE_VARIABLE_SlotInfo_0_6, &STATE_VARIABLE_SlotInfo_90_90);
                    {
                      ...
                      MR_hl_field(MR_mktag(3), Var_91, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 4));
                      MR_hl_field(MR_mktag(3), Var_91, 1) = ((MR_Box) (SwitchVar_67));
                      MR_hl_field(MR_mktag(3), Var_91, 2) = ((MR_Box) (CF_68));
      ...
      else
      {
        ...
        if ((env).ll_backend__saved_vars__saved_vars_in_conj_5_p_0_env_0__succeeded)
        {
          ...
          if ((env).ll_backend__saved_vars__saved_vars_in_conj_5_p_0_env_0__succeeded)
          {
            ...
            (env).ll_backend__saved_vars__saved_vars_in_conj_5_p_0_env_0__succeeded = (Var_40 == (MR_Word) ((MR_Integer) 0));
            if ((env).ll_backend__saved_vars__saved_vars_in_conj_5_p_0_env_0__succeeded)
            {
                ...
                case (MR_Integer) 1:
                  {
                    ...
                    ll_backend__saved_vars__saved_vars_in_independent_goals_4_p_0(Goals0_11, &Goals_71, STATE_VARIABLE_SlotInfo_0_56, STATE_VARIABLE_SlotInfo_57);
                    {
                      ...
                      MR_hl_field(MR_mktag(3), Var_69, 1) = ((MR_Box) (ConjType_10));
          ...
          case (MR_Integer) 4:
            {
              ...
              ll_backend__saved_vars__saved_vars_in_switch_4_p_0(Cases0_19, &Cases_20, STATE_VARIABLE_SlotInfo_0_56, STATE_VARIABLE_SlotInfo_57);
              {
                ...
                MR_hl_field(MR_mktag(3), GoalExpr_75, 2) = ((MR_Box) (CanFail_18));
          ...
          case (MR_Integer) 5:
            {
              ...
              if (succeeded)
              {
                Var_60 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Reason_28, (MR_Integer) 2))));
      ...
      switch (MR_tag((MR_Word) GoalExpr_7)) {
        ...
        case (MR_Integer) 3:
          switch (((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), GoalExpr_7, (MR_Integer) 0)))) {
            ...
            case (MR_Integer) 2:
              {
                MR_Word Var_89 = ((MR_Word) ((MR_hl_field(MR_mktag(3), GoalExpr_7, (MR_Integer) 1))));
                ...
                switch (MR_tag((MR_Word) Reason_41)) {
                  ...
                  case (MR_Integer) 3:
                    switch (((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), Reason_41, (MR_Integer) 0)))) {
                      ...
                      case (MR_Integer) 6:
                        {
                          MR_Word Var_90 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Reason_41, (MR_Integer) 2))));
