  ...
  MR_Word * STATE_VARIABLE_SlotInfo_20)
{
  ...
  if (succeeded)
  {
    ...
    parse_tree__vartypes__lookup_var_type_3_p_0(VarTypes0_32, Var_10, &Type_36);
    parse_tree__vartypes__add_var_type_4_p_0(NewVar_15, Type_36, VarTypes0_32, &VarTypes_37);
        ...
        if ((env).ll_backend__saved_vars__saved_vars_in_conj_5_p_0_env_0__succeeded)
        {
          ...
          if ((env).ll_backend__saved_vars__saved_vars_in_conj_5_p_0_env_0__succeeded)
          {
            ...
            if ((env).ll_backend__saved_vars__saved_vars_in_conj_5_p_0_env_0__succeeded)
            {
              ...
              if ((env).ll_backend__saved_vars__saved_vars_in_conj_5_p_0_env_0__succeeded)
              {
                parse_tree__vartypes__lookup_var_type_3_p_0(VarTypes_54, Var_21, &Type_57);
  ...
  MR_Word * STATE_VARIABLE_SlotInfo_6)
{
  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      MR_Word Varset0_50 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_SlotInfo_0_5, (MR_Integer) 0))));
      MR_Word VarTypes0_51 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_SlotInfo_0_5, (MR_Integer) 1))));
      MR_Word RttiVarMaps0_52 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_SlotInfo_0_5, (MR_Integer) 2))));
      MR_Word TypeInfoLiveness_53 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_SlotInfo_0_5, (MR_Integer) 3))) & (MR_Integer) 1);
      MR_Word Varset_54;
      MR_Word Type_55;
      MR_Word VarTypes_56;
      ...
      MR_Word Conj1_74;
      MR_Word Conj_75;
      MR_Word STATE_VARIABLE_SlotInfo_19_76;

      mercury__varset__new_var_3_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), &NewVar_36, Varset0_50, &Varset_54);
      {
        Var_59 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), Var_59, 0) = ((MR_Box) (HeadVar__4_4));
        MR_hl_field(MR_mktag(0), Var_59, 1) = ((MR_Box) (NewVar_36));
      }
      {
      ...
      mercury__map__from_assoc_list_2_p_0((MR_Word) (&ll_backend__saved_vars_scalar_common_1[0]), (MR_Word) (&ll_backend__saved_vars_scalar_common_1[0]), Var_58, &Subst_37);
      parse_tree__vartypes__lookup_var_type_3_p_0(VarTypes0_51, HeadVar__4_4, &Type_55);
      parse_tree__vartypes__add_var_type_4_p_0(NewVar_36, Type_55, VarTypes0_51, &VarTypes_56);
      hlds__hlds_rtti__rtti_var_info_duplicate_4_p_0(HeadVar__4_4, NewVar_36, RttiVarMaps0_52, &RttiVarMaps_57);
      {
        STATE_VARIABLE_SlotInfo_21_40 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), STATE_VARIABLE_SlotInfo_21_40, 0) = ((MR_Box) (Varset_54));
        MR_hl_field(MR_mktag(0), STATE_VARIABLE_SlotInfo_21_40, 1) = ((MR_Box) (VarTypes_56));
        MR_hl_field(MR_mktag(0), STATE_VARIABLE_SlotInfo_21_40, 2) = ((MR_Box) (RttiVarMaps_57));
        MR_hl_field(MR_mktag(0), STATE_VARIABLE_SlotInfo_21_40, 3) = (MR_Box) ((MR_Unsigned) (TypeInfoLiveness_53));
      }
      ...
      ll_backend__saved_vars__saved_vars_in_goal_4_p_0(Goal1_39, &Goal1_71, STATE_VARIABLE_SlotInfo_21_40, &STATE_VARIABLE_SlotInfo_19_76);
      GoalInfo1_73 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Goal1_71, (MR_Integer) 1))));
      hlds__hlds_goal__goal_to_conj_list_2_p_0(Goal1_71, &Conj1_74);
      ll_backend__saved_vars__saved_vars_delay_goal_7_p_0(Conj1_74, &Conj_75, NewConstruct_38, NewVar_36, (MR_Integer) 0, STATE_VARIABLE_SlotInfo_19_76, &STATE_VARIABLE_SlotInfo_25_25);
      hlds__hlds_goal__conj_list_to_goal_3_p_0(Conj_75, GoalInfo1_73, &Goal_22);
    }
    else
  ...
  MR_Word * STATE_VARIABLE_SlotInfo_6)
{
  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      MR_Word Varset0_46 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_SlotInfo_0_5, (MR_Integer) 0))));
      MR_Word VarTypes0_47 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_SlotInfo_0_5, (MR_Integer) 1))));
      MR_Word RttiVarMaps0_48 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_SlotInfo_0_5, (MR_Integer) 2))));
      MR_Word TypeInfoLiveness_49 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_SlotInfo_0_5, (MR_Integer) 3))) & (MR_Integer) 1);
      MR_Word Varset_50;
      MR_Word Type_51;
      MR_Word VarTypes_52;
      ...
      MR_Word Var_55;
      MR_Word Goal1_67;
      MR_Word GoalInfo1_69;
      MR_Word Conj1_70;
      MR_Word Conj_71;
      MR_Word STATE_VARIABLE_SlotInfo_19_72;

      mercury__varset__new_var_3_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), &NewVar_32, Varset0_46, &Varset_50);
      {
        Var_55 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), Var_55, 0) = ((MR_Box) (HeadVar__4_4));
        MR_hl_field(MR_mktag(0), Var_55, 1) = ((MR_Box) (NewVar_32));
      }
      {
      ...
      mercury__map__from_assoc_list_2_p_0((MR_Word) (&ll_backend__saved_vars_scalar_common_1[0]), (MR_Word) (&ll_backend__saved_vars_scalar_common_1[0]), Var_54, &Subst_33);
      parse_tree__vartypes__lookup_var_type_3_p_0(VarTypes0_47, HeadVar__4_4, &Type_51);
      parse_tree__vartypes__add_var_type_4_p_0(NewVar_32, Type_51, VarTypes0_47, &VarTypes_52);
      hlds__hlds_rtti__rtti_var_info_duplicate_4_p_0(HeadVar__4_4, NewVar_32, RttiVarMaps0_48, &RttiVarMaps_53);
      {
        STATE_VARIABLE_SlotInfo_21_36 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), STATE_VARIABLE_SlotInfo_21_36, 0) = ((MR_Box) (Varset_50));
        MR_hl_field(MR_mktag(0), STATE_VARIABLE_SlotInfo_21_36, 1) = ((MR_Box) (VarTypes_52));
        MR_hl_field(MR_mktag(0), STATE_VARIABLE_SlotInfo_21_36, 2) = ((MR_Box) (RttiVarMaps_53));
        MR_hl_field(MR_mktag(0), STATE_VARIABLE_SlotInfo_21_36, 3) = (MR_Box) ((MR_Unsigned) (TypeInfoLiveness_49));
      }
      ...
      ll_backend__saved_vars__saved_vars_in_goal_4_p_0(Goal1_35, &Goal1_67, STATE_VARIABLE_SlotInfo_21_36, &STATE_VARIABLE_SlotInfo_19_72);
      GoalInfo1_69 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Goal1_67, (MR_Integer) 1))));
      hlds__hlds_goal__goal_to_conj_list_2_p_0(Goal1_67, &Conj1_70);
      ll_backend__saved_vars__saved_vars_delay_goal_7_p_0(Conj1_70, &Conj_71, NewConstruct_34, NewVar_32, (MR_Integer) 0, STATE_VARIABLE_SlotInfo_19_72, &STATE_VARIABLE_SlotInfo_21_21);
      hlds__hlds_goal__conj_list_to_goal_3_p_0(Conj_71, GoalInfo1_69, &Goal_14);
    }
    else
