...
{
  {
    ...
    else
    {
      ...
      else
      {
        ...
        mercury__builtin__compare_3_p_0((MR_Word) &ll_backend__saved_vars_scalar_common_2[0], &Var_13, ((MR_Box) (ArgX2_6)), ((MR_Box) (ArgY2_7)));
...
{
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        TypeInfo_14_14 = (MR_Word) &ll_backend__saved_vars_scalar_common_2[0];
                    ...
                    case (MR_Integer) 0:
                      {
                        ...
                        {
                          MR_Word next_value_of_HeadVar__1_1 = Goals1_140;
...
{
  {
    ...
    if (((MR_Integer) 8380418 & (((MR_Integer) 1 << (env_ptr)->ll_backend__saved_vars__saved_vars_in_conj_5_p_0_env_0__Feature_28))))
    {
    ...
    while (MR_TRUE)
    {
      ...
      else
      {
        ...
        if ((env).ll_backend__saved_vars__saved_vars_in_conj_5_p_0_env_0__succeeded)
        {
          ...
          /* direct tailcall eliminated */
          {
            MR_Word next_value_of_HeadVar__1_1 = Goals2_35;
            MR_Word next_value_of_STATE_VARIABLE_SlotInfo_0_4 = STATE_VARIABLE_SlotInfo_43_43;
