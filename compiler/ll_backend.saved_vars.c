  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_35)
{
  ...
  hlds__hlds_pred__proc_info_get_rtti_varmaps_2_p_0(STATE_VARIABLE_ProcInfo_0_32, &RttiVarMaps0_16);
  {
    ...
    MR_hl_field(0, SlotInfo0_17, 0) = ((MR_Box) (VarTable0_15));
    MR_hl_field(0, SlotInfo0_17, 1) = ((MR_Box) (RttiVarMaps0_16));
    MR_hl_field(0, SlotInfo0_17, 2) = (MR_Box) ((MR_Unsigned) (TypeInfoLiveness_13));
  }
  ll_backend__saved_vars__saved_vars_in_goal_4_p_0(Goal0_14, &Goal1_18, SlotInfo0_17, &SlotInfo_19);
  VarTable1_20 = ((MR_Word) ((MR_hl_field(0, SlotInfo_19, (MR_Integer) 0))));
  RttiVarMaps1_21 = ((MR_Word) ((MR_hl_field(0, SlotInfo_19, (MR_Integer) 1))));
    ...
    switch (MR_tag((MR_Word) GoalExpr_7)) {
      ...
      case (MR_Integer) 3:
        switch (((MR_Integer) ((MR_hl_field(3, GoalExpr_7, (MR_Integer) 0))))) {
          ...
          case (MR_Integer) 2:
            {
              MR_Word Var_89 = ((MR_Unsigned) ((MR_hl_field(3, GoalExpr_7, (MR_Integer) 1))) & (MR_Integer) 1);
          ...
          case (MR_Integer) 4:
            {
              MR_Word SwitchVar_67 = ((MR_Word) ((MR_hl_field(3, GoalExpr_7, (MR_Integer) 1))));
              ...
              switch (MR_tag((MR_Word) Reason_41)) {
                ...
                case (MR_Integer) 3:
                  switch (((MR_Integer) ((MR_hl_field(3, Reason_41, (MR_Integer) 0))))) {
                    ...
                    case (MR_Integer) 6:
                      {
                        MR_Word Var_90 = ((MR_Unsigned) ((MR_hl_field(3, Reason_41, (MR_Integer) 2))) & (MR_Integer) 3);
