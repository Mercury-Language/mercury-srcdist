...
{
  {
    ...
    packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), SlotInfo_20, (MR_Integer) 3)));
...
{
  {
    ...
    if (succeeded)
    {
      ...
      MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_SlotInfo_0_19, (MR_Integer) 3)));
              ...
              case (MR_Integer) 2:
                {
                  ...
                  MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Goal0Expr_23, (MR_Integer) 1)));
              ...
              case (MR_Integer) 4:
                {
                  ...
                  MR_Unsigned packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Goal0Expr_23, (MR_Integer) 2)));
...
{
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_SlotInfo_0_5, (MR_Integer) 3)));
...
{
  {
    ...
    MR_Word Var_20;
    MR_Word Var_21;
    MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_SlotInfo_0_18, (MR_Integer) 3)));
            ...
            case (MR_Integer) 4:
              {
                ...
                MR_Unsigned packed_word_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), GoalExpr_7, (MR_Integer) 2)));
                      ...
                      case (MR_Integer) 6:
                        {
                          ...
                          MR_Unsigned packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Reason_41, (MR_Integer) 2)));
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Unif_11, (MR_Integer) 5)));
