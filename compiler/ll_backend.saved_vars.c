  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_35)
{
  ...
  MR_Word SlotInfo0_17;
  MR_Word Goal1_18;
  MR_Word SlotInfo_19;
  MR_Word VarTable1_20;
  MR_Word RttiVarMaps1_21;
  MR_Word HeadVars_22;
  MR_Word Goal2_24;
  MR_Word VarTable_25;
  ...
  MR_Word _Warnings_23;

  hlds__passes_aux__write_proc_progress_message_6_p_0(STATE_VARIABLE_ModuleInfo_0_34, (MR_String) "Minimizing saved vars in", PredId_6, ProcId_7);
  hlds__hlds_module__module_info_get_globals_2_p_0(STATE_VARIABLE_ModuleInfo_0_34, &Globals_11);
  hlds__hlds_module__module_info_pred_info_3_p_0(STATE_VARIABLE_ModuleInfo_0_34, PredId_6, &PredInfo_12);
  hlds__hlds_pred__body_should_use_typeinfo_liveness_3_p_0(PredInfo_12, Globals_11, &TypeInfoLiveness_13);
  hlds__hlds_pred__proc_info_get_goal_2_p_0(STATE_VARIABLE_ProcInfo_0_32, &Goal0_14);
  hlds__hlds_pred__proc_info_get_var_table_3_p_0(STATE_VARIABLE_ModuleInfo_0_34, STATE_VARIABLE_ProcInfo_0_32, &VarTable0_15);
  hlds__hlds_pred__proc_info_get_rtti_varmaps_2_p_0(STATE_VARIABLE_ProcInfo_0_32, &RttiVarMaps0_16);
  {
    SlotInfo0_17 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(MR_mktag(0), SlotInfo0_17, 0) = ((MR_Box) (VarTable0_15));
    MR_hl_field(MR_mktag(0), SlotInfo0_17, 1) = ((MR_Box) (RttiVarMaps0_16));
    MR_hl_field(MR_mktag(0), SlotInfo0_17, 2) = (MR_Box) ((MR_Unsigned) (TypeInfoLiveness_13));
  }
  ll_backend__saved_vars__saved_vars_in_goal_4_p_0(Goal0_14, &Goal1_18, SlotInfo0_17, &SlotInfo_19);
  VarTable1_20 = ((MR_Word) ((MR_hl_field(MR_mktag(0), SlotInfo_19, (MR_Integer) 0))));
  RttiVarMaps1_21 = ((MR_Word) ((MR_hl_field(MR_mktag(0), SlotInfo_19, (MR_Integer) 1))));
  hlds__hlds_pred__proc_info_get_headvars_2_p_0(STATE_VARIABLE_ProcInfo_0_32, &HeadVars_22);
  hlds__quantification__implicitly_quantify_clause_body_general_vt_9_p_0((MR_Integer) 1, HeadVars_22, &_Warnings_23, Goal1_18, &Goal2_24, VarTable1_20, &VarTable_25, RttiVarMaps1_21, &RttiVarMaps_26);
  hlds__hlds_pred__proc_info_get_initial_instmap_3_p_0(STATE_VARIABLE_ModuleInfo_0_34, STATE_VARIABLE_ProcInfo_0_32, &InstMap0_27);
  hlds__hlds_pred__proc_info_get_inst_varset_2_p_0(STATE_VARIABLE_ProcInfo_0_32, &InstVarSet_28);
  check_hlds__recompute_instmap_deltas__recompute_instmap_delta_8_p_0((MR_Integer) 1, VarTable_25, InstVarSet_28, InstMap0_27, Goal2_24, &Goal_29, STATE_VARIABLE_ModuleInfo_0_34, STATE_VARIABLE_ModuleInfo_35);
  hlds__hlds_pred__proc_info_set_goal_3_p_0(Goal_29, STATE_VARIABLE_ProcInfo_0_32, &STATE_VARIABLE_ProcInfo_66_66);
  hlds__hlds_pred__proc_info_set_var_table_3_p_0(VarTable_25, STATE_VARIABLE_ProcInfo_66_66, &STATE_VARIABLE_ProcInfo_67_67);
  hlds__hlds_pred__proc_info_set_rtti_varmaps_3_p_0(RttiVarMaps_26, STATE_VARIABLE_ProcInfo_67_67, STATE_VARIABLE_ProcInfo_33);
}
  ...
  MR_Word * STATE_VARIABLE_SlotInfo_20)
{
  ...
  if (succeeded)
  {
    ...
    MR_Word VarTable0_29 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_SlotInfo_0_19, (MR_Integer) 0))));
    MR_Word RttiVarMaps0_30 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_SlotInfo_0_19, (MR_Integer) 1))));
    MR_Word TypeInfoLiveness_31 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_SlotInfo_0_19, (MR_Integer) 2))) & (MR_Integer) 1);
    MR_Word Entry0_32;
    MR_Word Type_34;
    MR_Word IsDummy_35;
    MR_Word Entry_36;
    ...
    MR_Word Conj1_54;
    MR_Word Conj_55;
    MR_Word STATE_VARIABLE_SlotInfo_19_56;

    parse_tree__var_table__lookup_var_entry_3_p_0(VarTable0_29, Var_10, &Entry0_32);
    Type_34 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Entry0_32, (MR_Integer) 1))));
    IsDummy_35 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Entry0_32, (MR_Integer) 2))) & (MR_Integer) 1);
    {
      Entry_36 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), Entry_36, 0) = ((MR_Box) ((MR_String) ""));
      MR_hl_field(MR_mktag(0), Entry_36, 1) = ((MR_Box) (Type_34));
      MR_hl_field(MR_mktag(0), Entry_36, 2) = (MR_Box) ((MR_Unsigned) (IsDummy_35));
    }
    parse_tree__var_table__add_var_entry_4_p_0(Entry_36, &NewVar_15, VarTable0_29, &VarTable_37);
    {
      Var_41 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), Var_41, 0) = ((MR_Box) (Var_10));
      MR_hl_field(MR_mktag(0), Var_41, 1) = ((MR_Box) (NewVar_15));
    }
    {
    ...
    mercury__map__from_assoc_list_2_p_0((MR_Word) (&ll_backend__saved_vars_scalar_common_1[0]), (MR_Word) (&ll_backend__saved_vars_scalar_common_1[0]), Var_40, &Subst_16);
    hlds__hlds_rtti__rtti_var_info_duplicate_4_p_0(Var_10, NewVar_15, RttiVarMaps0_30, &RttiVarMaps_38);
    {
      STATE_VARIABLE_SlotInfo_21_21 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), STATE_VARIABLE_SlotInfo_21_21, 0) = ((MR_Box) (VarTable_37));
      MR_hl_field(MR_mktag(0), STATE_VARIABLE_SlotInfo_21_21, 1) = ((MR_Box) (RttiVarMaps_38));
      MR_hl_field(MR_mktag(0), STATE_VARIABLE_SlotInfo_21_21, 2) = (MR_Box) ((MR_Unsigned) (TypeInfoLiveness_31));
    }
    ...
    ll_backend__saved_vars__saved_vars_in_goal_4_p_0(Goal1_18, &Goal1_51, STATE_VARIABLE_SlotInfo_21_21, &STATE_VARIABLE_SlotInfo_19_56);
    GoalInfo1_53 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Goal1_51, (MR_Integer) 1))));
    hlds__hlds_goal__goal_to_conj_list_2_p_0(Goal1_51, &Conj1_54);
    ll_backend__saved_vars__saved_vars_delay_goal_7_p_0(Conj1_54, &Conj_55, NewConstruct_17, NewVar_15, (MR_Integer) 0, STATE_VARIABLE_SlotInfo_19_56, STATE_VARIABLE_SlotInfo_20);
    hlds__hlds_goal__conj_list_to_goal_3_p_0(Conj_55, GoalInfo1_53, Goal_8);
  }
  else
          ...
          case (MR_Integer) 0:
            {
              ...
              Var_103 = (MR_Word) ((MR_Word) (NegGoal_64));
              {
                ...
                MR_hl_field(MR_mktag(0), Goal1_152, 0) = ((MR_Box) (Var_103));
          ...
          case (MR_Integer) 1:
            {
              ...
              ll_backend__saved_vars__saved_vars_delay_goal_7_p_0(Goals0_17, &Goals1_35, Construct_3, HeadVar__4_4, IsNonLocal_5, STATE_VARIABLE_SlotInfo_81_81, STATE_VARIABLE_SlotInfo_7);
              {
                ...
                MR_hl_field(MR_mktag(1), Var_83, 0) = ((MR_Box) (Goal1_34));
                MR_hl_field(MR_mktag(1), Var_83, 1) = ((MR_Box) (Goals1_35));
              }
              {
                MR_Word base;
                base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          ...
          case (MR_Integer) 2:
            {
              ...
              ll_backend__saved_vars__saved_vars_delay_goal_7_p_0(Goals0_17, &Goals1_126, Construct_3, HeadVar__4_4, IsNonLocal_5, STATE_VARIABLE_SlotInfo_84_84, STATE_VARIABLE_SlotInfo_7);
              {
                ...
                MR_hl_field(MR_mktag(1), Var_86, 0) = ((MR_Box) (Goal1_125));
                MR_hl_field(MR_mktag(1), Var_86, 1) = ((MR_Box) (Goals1_126));
              }
              {
                MR_Word base;
                base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              ...
              case (MR_Integer) 0:
                {
                  ...
                  ll_backend__saved_vars__saved_vars_delay_goal_7_p_0(Goals0_17, &Goals1_132, Construct_3, HeadVar__4_4, IsNonLocal_5, STATE_VARIABLE_SlotInfo_87_87, STATE_VARIABLE_SlotInfo_7);
                  {
                    ...
                    MR_hl_field(MR_mktag(1), Var_89, 0) = ((MR_Box) (Goal1_131));
                    MR_hl_field(MR_mktag(1), Var_89, 1) = ((MR_Box) (Goals1_132));
                  }
                  {
                    MR_Word base;
                    base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              ...
              case (MR_Integer) 1:
                {
                  ...
                  ll_backend__saved_vars__saved_vars_delay_goal_7_p_0(Goals0_17, &Goals1_138, Construct_3, HeadVar__4_4, IsNonLocal_5, STATE_VARIABLE_SlotInfo_90_90, STATE_VARIABLE_SlotInfo_7);
                  {
                    ...
                    MR_hl_field(MR_mktag(1), Var_92, 0) = ((MR_Box) (Goal1_137));
                    MR_hl_field(MR_mktag(1), Var_92, 1) = ((MR_Box) (Goals1_138));
                  }
                  {
                    MR_Word base;
                    base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                    ...
                    case (MR_Integer) 1:
                      {
                        ...
                        ll_backend__saved_vars__push_into_goals_rename_6_p_0(Conj0_55, &Conj_56, Construct_3, HeadVar__4_4, STATE_VARIABLE_SlotInfo_0_6, &STATE_VARIABLE_SlotInfo_94_94);
                        {
                          ...
                          MR_hl_field(MR_mktag(3), Var_95, 1) = (MR_Box) ((MR_Unsigned) (ConjType_54));
                          MR_hl_field(MR_mktag(3), Var_95, 2) = ((MR_Box) (Conj_56));
                        }
                        {
                          Goal1_140 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
                          MR_hl_field(MR_mktag(0), Goal1_140, 0) = ((MR_Box) (Var_95));
              ...
              case (MR_Integer) 3:
                {
                  ...
                  ll_backend__saved_vars__push_into_goals_rename_6_p_0(Disjuncts0_65, &Disjuncts_66, Construct_3, HeadVar__4_4, STATE_VARIABLE_SlotInfo_0_6, &STATE_VARIABLE_SlotInfo_105_105);
                  {
                    ...
                    MR_hl_field(MR_mktag(3), Var_106, 1) = ((MR_Box) (Disjuncts_66));
                  }
                  {
                    Goal1_155 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
                    MR_hl_field(MR_mktag(0), Goal1_155, 0) = ((MR_Box) (Var_106));
              ...
              case (MR_Integer) 4:
                {
                  ...
                  if (succeeded)
                  {
                    ...
                    ll_backend__saved_vars__saved_vars_delay_goal_7_p_0(Goals0_17, &Goals1_157, Construct_3, HeadVar__4_4, IsNonLocal_5, STATE_VARIABLE_SlotInfo_0_6, STATE_VARIABLE_SlotInfo_7);
                    {
                      ...
                      MR_hl_field(MR_mktag(1), Var_109, 0) = ((MR_Box) (Goal0_16));
                      MR_hl_field(MR_mktag(1), Var_109, 1) = ((MR_Box) (Goals1_157));
                    }
                    {
                      MR_Word base;
                      base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                  ...
                  else
                  {
                    ...
                    ll_backend__saved_vars__push_into_cases_rename_6_p_0(Cases0_69, &Cases_70, Construct_3, HeadVar__4_4, STATE_VARIABLE_SlotInfo_0_6, &STATE_VARIABLE_SlotInfo_110_110);
                    {
                      ...
                      MR_hl_field(MR_mktag(3), Var_111, 1) = ((MR_Box) (SwitchVar_67));
                      MR_hl_field(MR_mktag(3), Var_111, 2) = (MR_Box) ((MR_Unsigned) (CF_68));
                      MR_hl_field(MR_mktag(3), Var_111, 3) = ((MR_Box) (Cases_70));
                    }
                    {
                      Goal1_158 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
                      MR_hl_field(MR_mktag(0), Goal1_158, 0) = ((MR_Box) (Var_111));
              ...
              case (MR_Integer) 5:
                {
                  ...
                  ll_backend__saved_vars__push_into_goal_6_p_0(SomeGoal1_60, &SomeGoal_61, NewConstruct_147, NewVar_59, STATE_VARIABLE_SlotInfo_97_97, &STATE_VARIABLE_SlotInfo_98_98);
                  {
                    ...
                    MR_hl_field(MR_mktag(3), Var_99, 1) = ((MR_Box) (Reason_57));
                    MR_hl_field(MR_mktag(3), Var_99, 2) = ((MR_Box) (SomeGoal_61));
                  }
                  {
                    Goal1_148 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
                    MR_hl_field(MR_mktag(0), Goal1_148, 0) = ((MR_Box) (Var_99));
              ...
              case (MR_Integer) 6:
                {
                  ...
                  {
                    Var_116 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(MR_mktag(3), Var_116, 0) = ((MR_Box) ((MR_Unsigned) 6U));
                    MR_hl_field(MR_mktag(3), Var_116, 1) = ((MR_Box) (V_71));
                    MR_hl_field(MR_mktag(3), Var_116, 2) = ((MR_Box) (Cond_75));
                    MR_hl_field(MR_mktag(3), Var_116, 3) = ((MR_Box) (Then_76));
                    MR_hl_field(MR_mktag(3), Var_116, 4) = ((MR_Box) (Else_77));
                  }
                  {
                    Goal1_164 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
                    MR_hl_field(MR_mktag(0), Goal1_164, 0) = ((MR_Box) (Var_116));
      ...
      if ((env).ll_backend__saved_vars__saved_vars_in_conj_5_p_0_env_0__succeeded)
      {
        ...
        if ((env).ll_backend__saved_vars__saved_vars_in_conj_5_p_0_env_0__succeeded)
        {
          ...
          if ((env).ll_backend__saved_vars__saved_vars_in_conj_5_p_0_env_0__succeeded)
          {
            ...
            if ((env).ll_backend__saved_vars__saved_vars_in_conj_5_p_0_env_0__succeeded)
            {
              VarTable_53 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_SlotInfo_0_4, (MR_Integer) 0))));
              Var_54 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_SlotInfo_0_4, (MR_Integer) 1))));
              packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_SlotInfo_0_4, (MR_Integer) 2)));
              TypeInfoLiveness_55 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_SlotInfo_0_4, (MR_Integer) 2))) & (MR_Integer) 1);
              (env).ll_backend__saved_vars__saved_vars_in_conj_5_p_0_env_0__succeeded = (TypeInfoLiveness_55 == (MR_Integer) 1);
              if ((env).ll_backend__saved_vars__saved_vars_in_conj_5_p_0_env_0__succeeded)
              {
                parse_tree__var_table__lookup_var_type_3_p_0(VarTable_53, Var_21, &Type_56);
                (env).ll_backend__saved_vars__saved_vars_in_conj_5_p_0_env_0__succeeded = parse_tree__builtin_lib_types__type_is_type_info_or_ctor_type_1_p_0(Type_56);
              }
              (env).ll_backend__saved_vars__saved_vars_in_conj_5_p_0_env_0__succeeded = !((env).ll_backend__saved_vars__saved_vars_in_conj_5_p_0_env_0__succeeded);
              if ((env).ll_backend__saved_vars__saved_vars_in_conj_5_p_0_env_0__succeeded)
              {
  ...
  MR_Word * STATE_VARIABLE_SlotInfo_6)
{
  ...
  else
  {
    ...
    MR_Word GoalInfo0_34 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Goal0_21, (MR_Integer) 1))));
    MR_Word NonLocals_35;

    NonLocals_35 = hlds__hlds_goal__goal_info_get_nonlocals_1_f_0(GoalInfo0_34);
    succeeded = parse_tree__set_of_var__member_2_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), NonLocals_35, HeadVar__4_4);
    if (succeeded)
    {
      MR_Word NewVar_36;
      MR_Word Subst_37;
      MR_Word NewConstruct_38;
      MR_Word Goal1_39;
      MR_Word STATE_VARIABLE_SlotInfo_21_40;
      MR_Word VarTable0_48 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_SlotInfo_0_5, (MR_Integer) 0))));
      MR_Word RttiVarMaps0_49 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_SlotInfo_0_5, (MR_Integer) 1))));
      MR_Word TypeInfoLiveness_50 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_SlotInfo_0_5, (MR_Integer) 2))) & (MR_Integer) 1);
      MR_Word Entry0_51;
      MR_Word Type_53;
      MR_Word IsDummy_54;
      MR_Word Entry_55;
      ...
      MR_Word Var_60;
      MR_Word Goal1_70;
      MR_Word GoalInfo1_72;
      MR_Word Conj1_73;
      MR_Word Conj_74;
      MR_Word STATE_VARIABLE_SlotInfo_19_75;

      parse_tree__var_table__lookup_var_entry_3_p_0(VarTable0_48, HeadVar__4_4, &Entry0_51);
      Type_53 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Entry0_51, (MR_Integer) 1))));
      IsDummy_54 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Entry0_51, (MR_Integer) 2))) & (MR_Integer) 1);
      {
        Entry_55 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), Entry_55, 0) = ((MR_Box) ((MR_String) ""));
        MR_hl_field(MR_mktag(0), Entry_55, 1) = ((MR_Box) (Type_53));
        MR_hl_field(MR_mktag(0), Entry_55, 2) = (MR_Box) ((MR_Unsigned) (IsDummy_54));
      }
      parse_tree__var_table__add_var_entry_4_p_0(Entry_55, &NewVar_36, VarTable0_48, &VarTable_56);
      {
        Var_60 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), Var_60, 0) = ((MR_Box) (HeadVar__4_4));
        MR_hl_field(MR_mktag(0), Var_60, 1) = ((MR_Box) (NewVar_36));
      }
      {
      ...
      mercury__map__from_assoc_list_2_p_0((MR_Word) (&ll_backend__saved_vars_scalar_common_1[0]), (MR_Word) (&ll_backend__saved_vars_scalar_common_1[0]), Var_59, &Subst_37);
      hlds__hlds_rtti__rtti_var_info_duplicate_4_p_0(HeadVar__4_4, NewVar_36, RttiVarMaps0_49, &RttiVarMaps_57);
      {
        STATE_VARIABLE_SlotInfo_21_40 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), STATE_VARIABLE_SlotInfo_21_40, 0) = ((MR_Box) (VarTable_56));
        MR_hl_field(MR_mktag(0), STATE_VARIABLE_SlotInfo_21_40, 1) = ((MR_Box) (RttiVarMaps_57));
        MR_hl_field(MR_mktag(0), STATE_VARIABLE_SlotInfo_21_40, 2) = (MR_Box) ((MR_Unsigned) (TypeInfoLiveness_50));
      }
      hlds__hlds_goal__rename_some_vars_in_goal_3_p_0(Subst_37, HeadVar__3_3, &NewConstruct_38);
      hlds__hlds_goal__rename_some_vars_in_goal_3_p_0(Subst_37, Goal0_21, &Goal1_39);
      ll_backend__saved_vars__saved_vars_in_goal_4_p_0(Goal1_39, &Goal1_70, STATE_VARIABLE_SlotInfo_21_40, &STATE_VARIABLE_SlotInfo_19_75);
      GoalInfo1_72 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Goal1_70, (MR_Integer) 1))));
      hlds__hlds_goal__goal_to_conj_list_2_p_0(Goal1_70, &Conj1_73);
      ll_backend__saved_vars__saved_vars_delay_goal_7_p_0(Conj1_73, &Conj_74, NewConstruct_38, NewVar_36, (MR_Integer) 0, STATE_VARIABLE_SlotInfo_19_75, &STATE_VARIABLE_SlotInfo_25_25);
      hlds__hlds_goal__conj_list_to_goal_3_p_0(Conj_74, GoalInfo1_72, &Goal_22);
    }
    else
  ...
  MR_Word * STATE_VARIABLE_SlotInfo_6)
{
  ...
  else
  {
    ...
    MR_Word Goals_15;
    MR_Word STATE_VARIABLE_SlotInfo_21_21;
    MR_Word GoalInfo0_30 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Goal0_12, (MR_Integer) 1))));
    MR_Word NonLocals_31;

    NonLocals_31 = hlds__hlds_goal__goal_info_get_nonlocals_1_f_0(GoalInfo0_30);
    succeeded = parse_tree__set_of_var__member_2_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), NonLocals_31, HeadVar__4_4);
    if (succeeded)
    {
      MR_Word NewVar_32;
      MR_Word Subst_33;
      MR_Word NewConstruct_34;
      MR_Word Goal1_35;
      MR_Word STATE_VARIABLE_SlotInfo_21_36;
      MR_Word VarTable0_44 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_SlotInfo_0_5, (MR_Integer) 0))));
      MR_Word RttiVarMaps0_45 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_SlotInfo_0_5, (MR_Integer) 1))));
      MR_Word TypeInfoLiveness_46 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_SlotInfo_0_5, (MR_Integer) 2))) & (MR_Integer) 1);
      MR_Word Entry0_47;
      MR_Word Type_49;
      MR_Word IsDummy_50;
      MR_Word Entry_51;
      ...
      MR_Word Var_56;
      MR_Word Goal1_66;
      MR_Word GoalInfo1_68;
      MR_Word Conj1_69;
      MR_Word Conj_70;
      MR_Word STATE_VARIABLE_SlotInfo_19_71;

      parse_tree__var_table__lookup_var_entry_3_p_0(VarTable0_44, HeadVar__4_4, &Entry0_47);
      Type_49 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Entry0_47, (MR_Integer) 1))));
      IsDummy_50 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Entry0_47, (MR_Integer) 2))) & (MR_Integer) 1);
      {
        Entry_51 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), Entry_51, 0) = ((MR_Box) ((MR_String) ""));
        MR_hl_field(MR_mktag(0), Entry_51, 1) = ((MR_Box) (Type_49));
        MR_hl_field(MR_mktag(0), Entry_51, 2) = (MR_Box) ((MR_Unsigned) (IsDummy_50));
      }
      parse_tree__var_table__add_var_entry_4_p_0(Entry_51, &NewVar_32, VarTable0_44, &VarTable_52);
      {
        Var_56 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), Var_56, 0) = ((MR_Box) (HeadVar__4_4));
        MR_hl_field(MR_mktag(0), Var_56, 1) = ((MR_Box) (NewVar_32));
      }
      {
      ...
      mercury__map__from_assoc_list_2_p_0((MR_Word) (&ll_backend__saved_vars_scalar_common_1[0]), (MR_Word) (&ll_backend__saved_vars_scalar_common_1[0]), Var_55, &Subst_33);
      hlds__hlds_rtti__rtti_var_info_duplicate_4_p_0(HeadVar__4_4, NewVar_32, RttiVarMaps0_45, &RttiVarMaps_53);
      {
        STATE_VARIABLE_SlotInfo_21_36 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), STATE_VARIABLE_SlotInfo_21_36, 0) = ((MR_Box) (VarTable_52));
        MR_hl_field(MR_mktag(0), STATE_VARIABLE_SlotInfo_21_36, 1) = ((MR_Box) (RttiVarMaps_53));
        MR_hl_field(MR_mktag(0), STATE_VARIABLE_SlotInfo_21_36, 2) = (MR_Box) ((MR_Unsigned) (TypeInfoLiveness_46));
      }
      hlds__hlds_goal__rename_some_vars_in_goal_3_p_0(Subst_33, HeadVar__3_3, &NewConstruct_34);
      hlds__hlds_goal__rename_some_vars_in_goal_3_p_0(Subst_33, Goal0_12, &Goal1_35);
      ll_backend__saved_vars__saved_vars_in_goal_4_p_0(Goal1_35, &Goal1_66, STATE_VARIABLE_SlotInfo_21_36, &STATE_VARIABLE_SlotInfo_19_71);
      GoalInfo1_68 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Goal1_66, (MR_Integer) 1))));
      hlds__hlds_goal__goal_to_conj_list_2_p_0(Goal1_66, &Conj1_69);
      ll_backend__saved_vars__saved_vars_delay_goal_7_p_0(Conj1_69, &Conj_70, NewConstruct_34, NewVar_32, (MR_Integer) 0, STATE_VARIABLE_SlotInfo_19_71, &STATE_VARIABLE_SlotInfo_21_21);
      hlds__hlds_goal__conj_list_to_goal_3_p_0(Conj_70, GoalInfo1_68, &Goal_14);
    }
    else
              ...
              case (MR_Integer) 1:
                {
                  ...
                  ll_backend__saved_vars__saved_vars_in_independent_goals_4_p_0(Goals0_11, &Goals_71, STATE_VARIABLE_SlotInfo_0_56, STATE_VARIABLE_SlotInfo_57);
                  {
                    ...
                    MR_hl_field(MR_mktag(3), Var_60, 1) = (MR_Box) ((MR_Unsigned) (ConjType_10));
                    MR_hl_field(MR_mktag(3), Var_60, 2) = ((MR_Box) (Goals_71));
                  }
                  {
                    MR_Word base;
                    base = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
        ...
        case (MR_Integer) 5:
          {
            ...
            if (succeeded)
            {
              Var_67 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(3), Reason_28, (MR_Integer) 2))) & (MR_Integer) 3);
...
ll_backend__saved_vars__saved_vars_rename_var_5_p_0(
  ...
  MR_Word * STATE_VARIABLE_SlotInfo_21)
{
  MR_Word VarTable0_10 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_SlotInfo_0_20, (MR_Integer) 0))));
  MR_Word RttiVarMaps0_11 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_SlotInfo_0_20, (MR_Integer) 1))));
  MR_Word TypeInfoLiveness_12 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_SlotInfo_0_20, (MR_Integer) 2))) & (MR_Integer) 1);
  MR_Word Entry0_13;
  MR_Word Type_15;
  MR_Word IsDummy_16;
  MR_Word Entry_17;
  ...
  Type_15 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Entry0_13, (MR_Integer) 1))));
  IsDummy_16 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Entry0_13, (MR_Integer) 2))) & (MR_Integer) 1);
  {
    Entry_17 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(MR_mktag(0), Entry_17, 0) = ((MR_Box) ((MR_String) ""));
    MR_hl_field(MR_mktag(0), Entry_17, 1) = ((MR_Box) (Type_15));
  ...
  parse_tree__var_table__add_var_entry_4_p_0(Entry_17, NewVar_7, VarTable0_10, &VarTable_18);
  {
    ...
    MR_hl_field(MR_mktag(0), Var_24, 0) = ((MR_Box) (Var_6));
    MR_hl_field(MR_mktag(0), Var_24, 1) = ((MR_Box) (*NewVar_7));
  }
  {
  ...
  hlds__hlds_rtti__rtti_var_info_duplicate_4_p_0(Var_6, *NewVar_7, RttiVarMaps0_11, &RttiVarMaps_19);
  {
    ...
    *STATE_VARIABLE_SlotInfo_21 = base;
    MR_hl_field(MR_mktag(0), base, 0) = ((MR_Box) (VarTable_18));
    MR_hl_field(MR_mktag(0), base, 1) = ((MR_Box) (RttiVarMaps_19));
    MR_hl_field(MR_mktag(0), base, 2) = (MR_Box) ((MR_Unsigned) (TypeInfoLiveness_12));
  }
}
