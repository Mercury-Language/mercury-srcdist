...
{
  {
    ...
    packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), SlotInfo_20, (MR_Integer) 3)));
...
{
  {
    ...
    if (succeeded)
    {
      ...
      MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_SlotInfo_0_19, (MR_Integer) 3)));
      ...
      hlds__hlds_rtti__rtti_var_info_duplicate_4_p_0(Var_10, NewVar_15, RttiVarMaps0_33, &RttiVarMaps_38);
      {
        ...
        MR_hl_field(MR_mktag(0), STATE_VARIABLE_SlotInfo_21_21, 3) = (MR_Box) (packed_args_0);
      }
          ...
          case (MR_Integer) 0:
            {
              ...
              Var_98 = (MR_Word) (MR_mkword(MR_mktag(0), (MR_Word) (NegGoal_64)));
              {
                Goal1_152 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
              ...
              case (MR_Integer) 2:
                {
                  ...
                  MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Goal0Expr_23, (MR_Integer) 1)));
                    ...
                    case (MR_Integer) 1:
                      {
                        ...
                        ll_backend__saved_vars__push_into_goals_rename_6_p_0(Conj0_55, &Conj_56, Construct_3, HeadVar__4_4, STATE_VARIABLE_SlotInfo_0_6, &STATE_VARIABLE_SlotInfo_104_104);
                        {
                          ...
                          MR_hl_field(MR_mktag(3), Var_105, 1) = (MR_Box) (packed_args_0);
                          MR_hl_field(MR_mktag(3), Var_105, 2) = ((MR_Box) (Conj_56));
                        }
                        {
                          Goal1_140 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
              ...
              case (MR_Integer) 3:
                {
                  ...
                  {
                    Goal1_155 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
              ...
              case (MR_Integer) 4:
                {
                  ...
                  MR_Unsigned packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Goal0Expr_23, (MR_Integer) 2)));
                  ...
                  else
                  {
                    ...
                    {
                      Var_91 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL));
                      MR_hl_field(MR_mktag(3), Var_91, 0) = ((MR_Box) ((MR_Unsigned) 4U));
                      MR_hl_field(MR_mktag(3), Var_91, 1) = ((MR_Box) (SwitchVar_67));
                      MR_hl_field(MR_mktag(3), Var_91, 2) = (MR_Box) (packed_args_1);
                      MR_hl_field(MR_mktag(3), Var_91, 3) = ((MR_Box) (Cases_70));
                    }
                    {
                      Goal1_158 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
              ...
              case (MR_Integer) 5:
                {
                  ...
                  {
                    Goal1_148 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
              ...
              case (MR_Integer) 6:
                {
                  ...
                  {
                    Var_86 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 5 * sizeof(MR_Word)), NULL, NULL));
                  ...
                  {
                    Goal1_164 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
...
{
  {
    ...
    if (((MR_Unsigned) 33538050U & (((MR_Integer) 1 << (env_ptr)->ll_backend__saved_vars__saved_vars_in_conj_5_p_0_env_0__Feature_28))))
    {
      ...
      else
      {
        ...
        if ((env).ll_backend__saved_vars__saved_vars_in_conj_5_p_0_env_0__succeeded)
        {
          ...
          if ((env).ll_backend__saved_vars__saved_vars_in_conj_5_p_0_env_0__succeeded)
          {
            ...
            packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Unif_18, (MR_Integer) 5)));
            ...
            if ((env).ll_backend__saved_vars__saved_vars_in_conj_5_p_0_env_0__succeeded)
            {
              ...
              if ((env).ll_backend__saved_vars__saved_vars_in_conj_5_p_0_env_0__succeeded)
              {
                ...
                packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_SlotInfo_0_4, (MR_Integer) 3)));
                ...
                if ((env).ll_backend__saved_vars__saved_vars_in_conj_5_p_0_env_0__succeeded)
                {
                  ...
                  (env).ll_backend__saved_vars__saved_vars_in_conj_5_p_0_env_0__succeeded = ((MR_tag((MR_Word) OtherGoals_30)) == (MR_Integer) 1);
                  if ((env).ll_backend__saved_vars__saved_vars_in_conj_5_p_0_env_0__succeeded)
                  {
...
{
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_SlotInfo_0_5, (MR_Integer) 3)));
        ...
        hlds__hlds_rtti__rtti_var_info_duplicate_4_p_0(HeadVar__4_4, NewVar_37, RttiVarMaps0_53, &RttiVarMaps_58);
        {
          ...
          MR_hl_field(MR_mktag(0), STATE_VARIABLE_SlotInfo_21_41, 3) = (MR_Box) (packed_args_0);
        }
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        hlds__hlds_rtti__rtti_var_info_duplicate_4_p_0(HeadVar__4_4, NewVar_33, RttiVarMaps0_49, &RttiVarMaps_54);
        {
          ...
          MR_hl_field(MR_mktag(0), STATE_VARIABLE_SlotInfo_21_37, 3) = (MR_Box) (packed_args_0);
        }
      ...
      case (MR_Integer) 0:
        {
          ...
          GoalExpr_74 = (MR_Word) (MR_mkword(MR_mktag(0), (MR_Word) (NegGoal_16)));
          {
            MR_Word base;
                ...
                case (MR_Integer) 1:
                  {
                    ...
                    ll_backend__saved_vars__saved_vars_in_independent_goals_4_p_0(Goals0_11, &Goals_71, STATE_VARIABLE_SlotInfo_0_56, STATE_VARIABLE_SlotInfo_57);
                    {
                      ...
                      MR_hl_field(MR_mktag(3), Var_69, 1) = (MR_Box) (packed_args_0);
          ...
          case (MR_Integer) 4:
            {
              ...
              ll_backend__saved_vars__saved_vars_in_switch_4_p_0(Cases0_19, &Cases_20, STATE_VARIABLE_SlotInfo_0_56, STATE_VARIABLE_SlotInfo_57);
              {
                ...
                MR_hl_field(MR_mktag(3), GoalExpr_75, 2) = (MR_Box) (packed_args_2);
...
{
  {
    ...
    MR_Word Var_20;
    MR_Word Var_21;
    MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_SlotInfo_0_18, (MR_Integer) 3)));
            ...
            case (MR_Integer) 4:
              {
                ...
                MR_Unsigned packed_args_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), GoalExpr_7, (MR_Integer) 2)));
                      ...
                      case (MR_Integer) 6:
                        {
                          ...
                          MR_Unsigned packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Reason_41, (MR_Integer) 2)));
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Unif_11, (MR_Integer) 5)));
