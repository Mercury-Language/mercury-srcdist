...
{
  {
    ...
    hlds__passes_aux__write_proc_progress_message_6_p_0((MR_String) "% Minimizing saved vars in ", PredId_6, ProcId_7, STATE_VARIABLE_ModuleInfo_0_37);
    ...
    check_hlds__mode_util__recompute_instmap_delta_8_p_0((MR_Integer) 1, Goal2_26, &Goal_32, VarTypes_28, InstVarSet_31, InstMap0_30, STATE_VARIABLE_ModuleInfo_0_37, STATE_VARIABLE_ModuleInfo_38);
