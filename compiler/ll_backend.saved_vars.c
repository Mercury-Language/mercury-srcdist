  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_38)
{
  ...
  hlds__hlds_pred__proc_info_set_varset_vartypes_4_p_0(Varset_27, VarTypes_28, STATE_VARIABLE_ProcInfo_66_66, &STATE_VARIABLE_ProcInfo_67_67);
  hlds__hlds_pred__proc_info_set_rtti_varmaps_3_p_0(RttiVarMaps_29, STATE_VARIABLE_ProcInfo_67_67, STATE_VARIABLE_ProcInfo_36);
}
  ...
  MR_Word * STATE_VARIABLE_SlotInfo_6)
{
  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      hlds__vartypes__lookup_var_type_3_p_0(VarTypes0_51, HeadVar__4_4, &Type_55);
      hlds__vartypes__add_var_type_4_p_0(NewVar_36, Type_55, VarTypes0_51, &VarTypes_56);
  ...
  MR_Word * STATE_VARIABLE_SlotInfo_6)
{
  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      hlds__vartypes__lookup_var_type_3_p_0(VarTypes0_47, HeadVar__4_4, &Type_51);
      hlds__vartypes__add_var_type_4_p_0(NewVar_32, Type_51, VarTypes0_47, &VarTypes_52);
