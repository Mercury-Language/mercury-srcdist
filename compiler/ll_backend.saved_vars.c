  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_38)
{
  ...
  hlds__hlds_pred__proc_info_set_goal_3_p_0(Goal_32, STATE_VARIABLE_ProcInfo_0_35, &STATE_VARIABLE_ProcInfo_1_68);
  hlds__hlds_pred__proc_info_set_var_table_3_p_0(VarTable_28, STATE_VARIABLE_ProcInfo_1_68, &STATE_VARIABLE_ProcInfo_2_69);
  hlds__hlds_pred__proc_info_set_rtti_varmaps_3_p_0(RttiVarMaps_29, STATE_VARIABLE_ProcInfo_2_69, STATE_VARIABLE_ProcInfo_36);
}
