...
top_level.optdate top_level.trans_opt_date top_level.err top_level.c_date top_level.s_date top_level.pic_s_date top_level.il_date top_level.java_date : top_level.m top_level.int0 \
	analysis.int \
	backend_libs.int \
	builtin.int \
...
ifeq ($(TARGET_ASM),yes)
top_level.mh top_level.mih : top_level.s
else
top_level.mh top_level.mih : top_level.c
endif

ifeq ($(TARGET_ASM),yes)
top_level.module_dep : top_level.s
else
 ifeq ($(findstring il,$(GRADE)),il)
top_level.module_dep : top_level.il
  ifeq ($(findstring java,$(GRADE)),java)
top_level.module_dep : mercury/top_level.java
  else
