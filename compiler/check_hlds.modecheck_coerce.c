...
{
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        hlds__vartypes__lookup_var_type_3_p_0(VarTypes_20, X_16, &TypeX_21);
        hlds__vartypes__lookup_var_type_3_p_0(VarTypes_20, Y_17, &TypeY_22);
...
{
  {
    ...
    else
    {
      ...
      else
      {
        ...
        hlds__vartypes__add_var_type_4_p_0(YPrime_37, TypeY_15, VarTypes0_83, &VarTypes_86);
