    ...
    switch (MR_tag((MR_Word) InstX_17)) {
      ...
      case (MR_Integer) 3:
        switch (((MR_Integer) ((MR_hl_field(3, InstX_17, (MR_Integer) 0))))) {
          ...
          case (MR_Integer) 0:
            {
              MR_Word UniqX_22 = ((MR_Unsigned) ((MR_hl_field(3, InstX_17, (MR_Integer) 1))) & (MR_Integer) 7);
              MR_Word FunctorsX_24 = ((MR_Word) ((MR_hl_field(3, InstX_17, (MR_Integer) 3))));
              ...
              if ((BadConsIds_63 == (MR_Word) ((MR_Unsigned) 0U)))
                if ((MaybeError0_64 == (MR_Word) ((MR_Unsigned) 0U)))
                {
                  ...
                  {
                    InstY_67 = (MR_Word) MR_mkword(3, MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(3, InstY_67, 0) = ((MR_Box) ((MR_Unsigned) 0U));
                    MR_hl_field(3, InstY_67, 1) = (MR_Box) ((MR_Unsigned) (UniqY_65));
                    MR_hl_field(3, InstY_67, 2) = ((MR_Box) (MR_mkword(1, &check_hlds__modecheck_coerce_scalar_common_4[0])));
                    MR_hl_field(3, InstY_67, 3) = ((MR_Box) (FunctorsY_62));
                  }
                  {
                    MR_Word base;
                    base = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                    *Res_18 = base;
                    MR_hl_field(1, base, 0) = ((MR_Box) (InstY_67));
                  }
                }
                else
                {
                  MR_Word Error_68 = ((MR_Word) ((MR_hl_field(1, MaybeError0_64, (MR_Integer) 0))));
              ...
              else
              {
                ...
                mercury__list__reverse_2_p_0((MR_Word) (&check_hlds__mode_errors__check_hlds__mode_errors__type_ctor_info_coerce_error_term_path_step_0), RevTermPath0_13, &TermPath_71);
                {
                  ...
                  MR_hl_field(2, Reason_72, 0) = ((MR_Box) (BadConsIds_63));
                }
                {
                  Error_74 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
                  MR_hl_field(0, Error_74, 0) = ((MR_Box) (TermPath_71));
                  MR_hl_field(0, Error_74, 1) = ((MR_Box) (TypeX_14));
                  MR_hl_field(0, Error_74, 2) = ((MR_Box) (TypeY_15));
                  MR_hl_field(0, Error_74, 3) = ((MR_Box) (Reason_72));
                }
          ...
          case (MR_Integer) 1:
            {
              MR_Word HOInstInfoX_25 = ((MR_Word) ((MR_hl_field(3, InstX_17, (MR_Integer) 2))));
              MR_Word UniqX_53 = ((MR_Unsigned) ((MR_hl_field(3, InstX_17, (MR_Integer) 1))) & (MR_Integer) 7);
              ...
              else
              {
                ...
                {
                  InstY_28 = (MR_Word) MR_mkword(3, MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
                  MR_hl_field(3, InstY_28, 0) = ((MR_Box) ((MR_Unsigned) 1U));
                  MR_hl_field(3, InstY_28, 1) = (MR_Box) ((MR_Unsigned) (UniqY_27));
                  MR_hl_field(3, InstY_28, 2) = ((MR_Box) (HOInstInfoX_25));
                }
                {
                  MR_Word base;
                  base = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
          ...
          case (MR_Integer) 3:
            {
              MR_Word InstVars_30 = ((MR_Word) ((MR_hl_field(3, InstX_17, (MR_Integer) 1))));
              MR_Word SubInstX_31 = ((MR_Word) ((MR_hl_field(3, InstX_17, (MR_Integer) 2))));
              MR_Word SubRes_32;
              ...
              {
                MR_Word SubInstY_33 = ((MR_Word) ((MR_hl_field(1, SubRes_32, (MR_Integer) 0))));
                MR_Word InstY_55;

                {
                  InstY_55 = (MR_Word) MR_mkword(3, MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
                  MR_hl_field(3, InstY_55, 0) = ((MR_Box) ((MR_Unsigned) 3U));
                  MR_hl_field(3, InstY_55, 1) = ((MR_Box) (InstVars_30));
                  MR_hl_field(3, InstY_55, 2) = ((MR_Box) (SubInstY_33));
                }
                {
                  MR_Word base;
                  base = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
          ...
          case (MR_Integer) 4:
            {
              MR_Word InstNameX_35 = ((MR_Word) ((MR_hl_field(3, InstX_17, (MR_Integer) 1))));
              MR_Word ExpandedInsts1_36;
              MR_Word Var_48;

              {
                Var_48 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
                MR_hl_field(0, Var_48, 0) = ((MR_Box) (InstNameX_35));
                MR_hl_field(0, Var_48, 1) = ((MR_Box) (TypeX_14));
              }
              ...
              else
              {
                ...
                if (succeeded)
                {
                  ...
                  else
                  {
                    ...
                    {
                      Reason_39 = (MR_Word) MR_mkword(3, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                      MR_hl_field(3, Reason_39, 0) = ((MR_Box) (InstX_17));
                    }
                    {
                      Error_59 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
                      MR_hl_field(0, Error_59, 0) = ((MR_Box) (TermPath_38));
                      MR_hl_field(0, Error_59, 1) = ((MR_Box) (TypeX_14));
                      MR_hl_field(0, Error_59, 2) = ((MR_Box) (TypeY_15));
                      MR_hl_field(0, Error_59, 3) = ((MR_Box) (Reason_39));
                    }
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = check_hlds__modecheck_coerce__IntroducedFrom__pred__modecheck_coerce_from_bound_make_bound_functor__504__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 4)))));
  return succeeded;
}
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = check_hlds__modecheck_coerce__IntroducedFrom__pred__modecheck_coerce_from_bound_make_bound_functor__502__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 4)))));
  return succeeded;
}
  ...
  MR_Word * MaybeInstY_18)
{
  ...
  if (succeeded)
  {
    ...
    {
      InstY_20 = (MR_Word) MR_mkword(3, MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(3, InstY_20, 0) = ((MR_Box) ((MR_Unsigned) 1U));
      MR_hl_field(3, InstY_20, 1) = (MR_Box) ((MR_Unsigned) (UniqY_19));
      MR_hl_field(3, InstY_20, 2) = ((MR_Box) ((MR_Unsigned) 0U));
    }
    {
      MR_Word base;
      base = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
    ...
    if (succeeded)
    {
      ...
      UniqY_24 = check_hlds__modecheck_coerce__uniqueness_for_coerce_result_2_f_0(LiveX_11, UniqX_12);
      {
        ...
        *InstY_16 = base;
        ...
        MR_hl_field(3, base, 1) = (MR_Box) ((MR_Unsigned) (UniqY_24));
        MR_hl_field(3, base, 2) = ((MR_Box) (MR_mkword(1, &check_hlds__modecheck_coerce_scalar_common_4[0])));
        MR_hl_field(3, base, 3) = ((MR_Box) (FunctorsY_23));
      }
    }
    else
      {
  ...
  else
  {
    ...
    }
    {
      ...
      *InstY_16 = base;
      ...
      MR_hl_field(3, base, 1) = (MR_Box) ((MR_Unsigned) (UniqY_18));
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = check_hlds__modecheck_coerce__IntroducedFrom__pred__get_bound_functor_cons_and_arg_types__593__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 4)))));
  return succeeded;
}
