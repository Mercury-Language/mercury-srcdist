...
{
  {
    ...
    if (succeeded)
    {
      ...
      {
        MR_String Name_69 = ((MR_String) ((MR_hl_field(MR_mktag(1), SymName0_59, (MR_Integer) 1))));

        {
          ...
          MR_hl_field(MR_mktag(1), SymName_63, 1) = ((MR_Box) (Name_69));
        }
      }
      else
        ...
        case (MR_Integer) 1:
          {
            ...
            MR_Word TypeCtor_74;
            MR_Word TypeArgs_75;
            MR_Word ConsTable_76;
            MR_Word ConsDefn_77;
            MR_Word TypeParams_80;
            MR_Word CtorArgs_83;
            MR_Word CtorArgTypes0_85;

            succeeded = ((MR_tag((MR_Word) TypeY_11)) == (MR_Integer) 1);
            if (succeeded)
            {
              succeeded = parse_tree__prog_type__type_to_ctor_and_args_3_p_0(TypeX_10, &TypeCtor_74, &TypeArgs_75);
              if (succeeded)
              {
                hlds__hlds_module__module_info_get_cons_table_2_p_0(ModuleInfo_9, &ConsTable_76);
                succeeded = hlds__hlds_cons__search_cons_table_of_type_ctor_4_p_0(ConsTable_76, TypeCtor_74, ConsIdX_12, &ConsDefn_77);
                if (succeeded)
                {
                  TypeParams_80 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ConsDefn_77, (MR_Integer) 2))));
                  CtorArgs_83 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ConsDefn_77, (MR_Integer) 5))));
                  parse_tree__prog_data__get_ctor_arg_types_2_p_0(CtorArgs_83, &CtorArgTypes0_85);
                  if ((TypeParams_80 == (MR_Word) ((MR_Unsigned) 0U)))
                    *ArgTypesX_14 = CtorArgTypes0_85;
                  else
                  {
                    MR_Word Subst_88;

                    mercury__map__from_corresponding_lists_3_p_0((MR_Word) (&check_hlds__modecheck_coerce_scalar_common_2[0]), (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0), TypeParams_80, TypeArgs_75, &Subst_88);
                    parse_tree__prog_type_subst__apply_subst_to_type_list_3_p_0(Subst_88, CtorArgTypes0_85, ArgTypesX_14);
                  }
