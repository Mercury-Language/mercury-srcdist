  ...
  MR_Word HeadVar__2_76)
{
  ...
  succeeded = mercury__builtin__unify_2_p_0((MR_Word) (&check_hlds__modecheck_coerce_scalar_common_2[0]), ((MR_Box) (ArgInstsX_25)), ((MR_Box) (HeadVar__2_76)));
  return succeeded;
}
  ...
  MR_Word HeadVar__3_3)
{
  ...
  else
  {
    ...
    mercury__builtin__compare_3_p_0((MR_Word) (&check_hlds__modecheck_coerce_scalar_common_2[5]), &SubResult1_6, ((MR_Box) (ArgX1_4)), ((MR_Box) (ArgY1_5)));
  ...
  MR_Word HeadVar__3_3)
{
  ...
  if (((MR_tag((MR_Word) HeadVar__2_2)) == (MR_Integer) 0))
    if (((MR_tag((MR_Word) HeadVar__3_3)) == (MR_Integer) 0))
    {
      ...
      check_hlds__mode_errors____Compare____coerce_error_0_0(HeadVar__1_1, ArgX1_6, ArgY1_7);
    }
    else
      *HeadVar__1_1 = (MR_Integer) 2;
  else
          ...
          case (MR_Integer) 2:
            {
              ...
              parse_tree__prog_data____Compare____cons_id_0_0(HeadVar__1_1, ArgX1_6, ArgY1_7);
            }
            break;
        }
        break;
  ...
  if (succeeded)
  {
    ...
    if (succeeded)
    {
      ...
      else
      {
        ...
        ModeError_29 = (MR_Word) ((MR_Word) (Error_28));
  ...
  MR_Word * STATE_VARIABLE_ModeInfo_45)
{
  ...
  if (((MR_tag((MR_Word) MaybeFinalInstY_28)) == (MR_Integer) 0))
  {
    ...
    MR_Word ModeError_42 = (MR_Word) ((MR_Word) (Error_41));
        ...
        case (MR_Integer) 0:
          {
            ...
            if (succeeded)
            {
              Var_62 = (MR_String) "predicate \140check_hlds.modecheck_coerce.compare_types_nonvar\'/5";
              Var_63 = (MR_String) "type_variable";
              {
                mercury__require__unexpected_2_p_0(Var_62, Var_63);
                return;
              }
              succeeded = MR_TRUE;
            }
        ...
        case (MR_Integer) 2:
          {
            ...
            if (succeeded)
            {
              Var_72 = ((MR_Word) ((MR_hl_field(2, TypeY_16, (MR_Integer) 0))));
              succeeded = parse_tree__prog_data____Unify____builtin_type_0_0(BuiltinType_39, Var_72);
            }
          }
          break;
        case (MR_Integer) 3:
          switch (((MR_Integer) ((MR_hl_field(3, TypeX_15, (MR_Integer) 0))))) {
            ...
            case (MR_Integer) 0:
              {
                ...
                MR_Word ArgsA_67 = ((MR_Word) ((MR_hl_field(3, TypeX_15, (MR_Integer) 1))));
                MR_Word ArgsB_68;
                MR_Word Var_73;
                ...
                if (succeeded)
                {
                  ArgsB_68 = ((MR_Word) ((MR_hl_field(3, TypeY_16, (MR_Integer) 1))));
                  Var_73 = ((MR_Word) ((MR_hl_field(3, TypeY_16, (MR_Integer) 2))));
                  succeeded = parse_tree__prog_data____Unify____kind_0_0(Kind_52, Var_73);
                  if (succeeded)
                    succeeded = check_hlds__modecheck_coerce__compare_types_corresponding_5_p_0(TypeTable_32, TVarSet_11, (MR_Integer) 1, ArgsA_67, ArgsB_68);
                }
              }
              break;
            case (MR_Integer) 1:
              {
                ...
                MR_Word Var_64;
                MR_Word ArgsA_69 = ((MR_Word) ((MR_hl_field(3, TypeX_15, (MR_Integer) 2))));
                MR_Word ArgsB_70;
                MR_Word Var_74;
                MR_Word Var_75;
                ...
                if (succeeded)
                {
                  Var_74 = ((MR_Unsigned) ((MR_hl_field(3, TypeY_16, (MR_Integer) 1))) & (MR_Integer) 1);
                  ArgsB_70 = ((MR_Word) ((MR_hl_field(3, TypeY_16, (MR_Integer) 2))));
                  Var_75 = ((MR_Unsigned) ((MR_hl_field(3, TypeY_16, (MR_Integer) 4))) & (MR_Integer) 3);
                  succeeded = (PredOrFunc_53 == Var_74);
                  if (succeeded)
                  {
                    succeeded = (Purity_55 == Var_75);
                    if (succeeded)
                    {
                      Var_64 = (MR_Integer) 0;
                      succeeded = check_hlds__modecheck_coerce__compare_types_corresponding_5_p_0(TypeTable_32, TVarSet_11, Var_64, ArgsA_69, ArgsB_70);
                    }
                  }
                }
              }
            ...
            case (MR_Integer) 3:
              {
                MR_Word TypeA1_60 = ((MR_Word) ((MR_hl_field(3, TypeX_15, (MR_Integer) 1))));
                MR_Word TypeB1_61;
                MR_Word Kind_71 = ((MR_Word) ((MR_hl_field(3, TypeX_15, (MR_Integer) 2))));
                MR_Word Var_76;

                succeeded = ((((MR_tag((MR_Word) TypeY_16)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(3, TypeY_16, (MR_Integer) 0)))) == (MR_Integer) 3)));
                if (succeeded)
                {
                  TypeB1_61 = ((MR_Word) ((MR_hl_field(3, TypeY_16, (MR_Integer) 1))));
                  Var_76 = ((MR_Word) ((MR_hl_field(3, TypeY_16, (MR_Integer) 2))));
                  succeeded = parse_tree__prog_data____Unify____kind_0_0(Kind_71, Var_76);
                  if (succeeded)
                    succeeded = check_hlds__modecheck_coerce__compare_types_5_p_0(TypeTable_32, TVarSet_11, (MR_Integer) 1, TypeA1_60, TypeB1_61);
                }
              }
              break;
          }
