...
check_hlds__modecheck_coerce__IntroducedFrom__pred__get_bound_functor_cons_and_arg_types__602__1_2_p_0(
  MR_Word TypeX_8,
  MR_Word TypeY_9);

static MR_bool MR_CALL 
check_hlds__modecheck_coerce__IntroducedFrom__pred__modecheck_coerce_from_bound_make_bound_functor__513__1_2_p_0(
  MR_Word ArgInstsX_25,
  MR_Word HeadVar__2_82);

static MR_bool MR_CALL 
check_hlds__modecheck_coerce__IntroducedFrom__pred__modecheck_coerce_from_bound_make_bound_functor__511__1_2_p_0(
  MR_Word TypeX_17,
  MR_Word TypeY_18);
...
check_hlds__modecheck_coerce__modecheck_coerce_from_bound_make_bound_functor_12_p_0(
  ...
  MR_Word STATE_VARIABLE_MaybeError_0_72,
  MR_Word * STATE_VARIABLE_MaybeError_73);
...
static /* final */ const MR_Box check_hlds__modecheck_coerce_scalar_common_3[3][5];
...
{
  {
    ...
    succeeded = mercury__builtin__unify_2_p_0((MR_Word) (&check_hlds__modecheck_coerce_scalar_common_2[0]), ((MR_Box) (ArgInstsX_25)), ((MR_Box) (HeadVar__2_82)));
    return succeeded;
  }
}
      ...
      case (MR_Integer) 0:
        switch (MR_unmkbody(InstX_17)) {
          ...
          case (MR_Integer) 0:
            ...
            break;
          case (MR_Integer) 1:
            *Res_18 = (MR_Word) (MR_mkword(MR_mktag(1), &check_hlds__modecheck_coerce_scalar_common_5[0]));
            break;
        }
        break;
      case (MR_Integer) 1:
    ...
    if (succeeded)
      {
        ...
        *MaybeArgInstsY_22 = base;
        MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (ArgInstsX_21));
      }
    else
    {
...
{
  {
    ...
    succeeded = check_hlds__modecheck_coerce__IntroducedFrom__pred__modecheck_coerce_from_bound_make_bound_functor__513__1_2_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))));
    return succeeded;
  }
}
...
{
  {
    ...
    succeeded = check_hlds__modecheck_coerce__IntroducedFrom__pred__modecheck_coerce_from_bound_make_bound_functor__511__1_2_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))));
    return succeeded;
  }
}
                    ...
                    case (MR_Integer) 0:
                      {
                        ...
                        mercury__list__reverse_2_p_0((MR_Word) (&check_hlds__mode_errors__check_hlds__mode_errors__type_ctor_info_coerce_error_term_path_step_0), RevTermPath0_16, &TermPath_92);
                        {
                          Reason_93 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                          MR_hl_field(MR_mktag(1), Reason_93, 0) = ((MR_Box) (InstX_20));
                        }
                        {
                          Error_91 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
                          MR_hl_field(MR_mktag(0), Error_91, 0) = ((MR_Box) (TermPath_92));
                          MR_hl_field(MR_mktag(0), Error_91, 1) = ((MR_Box) (TypeX_17));
                          MR_hl_field(MR_mktag(0), Error_91, 2) = ((MR_Box) (TypeY_18));
                          MR_hl_field(MR_mktag(0), Error_91, 3) = ((MR_Box) (Reason_93));
                        }
                        check_hlds__modecheck_coerce__maybe_keep_error_3_p_0(Error_91, STATE_VARIABLE_MaybeError_0_72, STATE_VARIABLE_MaybeError_73);
                    ...
                    case (MR_Integer) 1:
                      {
                        ...
                        *STATE_VARIABLE_MaybeError_73 = STATE_VARIABLE_MaybeError_0_72;
                      }
                      break;
                  }
                  break;
                case (MR_Integer) 1:
                  {
                    ...
                    mercury__list__length_2_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_inst_0), ArgInstsX_25, &Var_112);
                    succeeded = (Arity_33 == Var_112);
                    if (succeeded)
                    {
                      ...
                      if (((MR_tag((MR_Word) MaybeArgInstsY_34)) == (MR_Integer) 0))
                      {
                        ...
                        check_hlds__modecheck_coerce__maybe_keep_error_3_p_0(Error_37, STATE_VARIABLE_MaybeError_0_72, STATE_VARIABLE_MaybeError_73);
                        *MaybeFunctorY_22 = (MR_Word) ((MR_Unsigned) 0U);
                      }
                      else
                      {
                    ...
                    else
                    {
                      ...
                      {
                        Error_90 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
                        MR_hl_field(MR_mktag(0), Error_90, 0) = ((MR_Box) (TermPath_38));
                        MR_hl_field(MR_mktag(0), Error_90, 1) = ((MR_Box) (TypeX_17));
                        MR_hl_field(MR_mktag(0), Error_90, 2) = ((MR_Box) (TypeY_18));
                        MR_hl_field(MR_mktag(0), Error_90, 3) = ((MR_Box) (Reason_39));
                      }
                      check_hlds__modecheck_coerce__maybe_keep_error_3_p_0(Error_90, STATE_VARIABLE_MaybeError_0_72, STATE_VARIABLE_MaybeError_73);
                      *MaybeFunctorY_22 = (MR_Word) ((MR_Unsigned) 0U);
                    }
                  }
                  break;
          ...
          case (MR_Integer) 17:
            {
              ...
              if (succeeded)
              {
...

                {
                  ...
                  MR_hl_field(MR_mktag(0), Var_76, 0) = ((MR_Box) (&check_hlds__modecheck_coerce_scalar_common_3[1]));
                  MR_hl_field(MR_mktag(0), Var_76, 1) = ((MR_Box) (check_hlds__modecheck_coerce__modecheck_coerce_from_bound_make_bound_functor_12_p_0_1));
                  MR_hl_field(MR_mktag(0), Var_76, 2) = ((MR_Box) ((MR_Integer) 2));
                  MR_hl_field(MR_mktag(0), Var_76, 3) = ((MR_Box) (TypeX_17));
                  MR_hl_field(MR_mktag(0), Var_76, 4) = ((MR_Box) (TypeY_18));
                }
                mercury__require__expect_3_p_0(Var_76, (MR_String) "predicate \140check_hlds.modecheck_coerce.modecheck_coerce_from_bound_make_bound_functor\'/12", (MR_String) "coercion between different builtin types");
                {
                  Var_79 = (MR_Word) MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL);
                  MR_hl_field(MR_mktag(0), Var_79, 0) = ((MR_Box) (&check_hlds__modecheck_coerce_scalar_common_3[2]));
                  MR_hl_field(MR_mktag(0), Var_79, 1) = ((MR_Box) (check_hlds__modecheck_coerce__modecheck_coerce_from_bound_make_bound_functor_12_p_0_2));
                  MR_hl_field(MR_mktag(0), Var_79, 2) = ((MR_Box) ((MR_Integer) 2));
                  MR_hl_field(MR_mktag(0), Var_79, 3) = ((MR_Box) (ArgInstsX_25));
                  MR_hl_field(MR_mktag(0), Var_79, 4) = ((MR_Box) ((MR_Unsigned) 0U));
                }
                mercury__require__expect_3_p_0(Var_79, (MR_String) "predicate \140check_hlds.modecheck_coerce.modecheck_coerce_from_bound_make_bound_functor\'/12", (MR_String) "bound functor literal has arguments");
              ...
              else
              {
                ...
                mercury__list__reverse_2_p_0((MR_Word) (&check_hlds__mode_errors__check_hlds__mode_errors__type_ctor_info_coerce_error_term_path_step_0), RevTermPath0_16, &TermPath_96);
                {
                  Reason_97 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                  MR_hl_field(MR_mktag(1), Reason_97, 0) = ((MR_Box) (InstX_20));
                }
                {
                  Error_95 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
                  MR_hl_field(MR_mktag(0), Error_95, 0) = ((MR_Box) (TermPath_96));
                  MR_hl_field(MR_mktag(0), Error_95, 1) = ((MR_Box) (TypeX_17));
                  MR_hl_field(MR_mktag(0), Error_95, 2) = ((MR_Box) (TypeY_18));
                  MR_hl_field(MR_mktag(0), Error_95, 3) = ((MR_Box) (Reason_97));
                }
                check_hlds__modecheck_coerce__maybe_keep_error_3_p_0(Error_95, STATE_VARIABLE_MaybeError_0_72, STATE_VARIABLE_MaybeError_73);
                *MaybeFunctorY_22 = (MR_Word) ((MR_Unsigned) 0U);
              }
            }
            break;
    ...
    if ((BadConsIds_24 == (MR_Word) ((MR_Unsigned) 0U)))
      if ((MaybeError0_25 == (MR_Word) ((MR_Unsigned) 0U)))
      {
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(3), InstY_28, 2) = ((MR_Box) (MR_mkword(MR_mktag(1), &check_hlds__modecheck_coerce_scalar_common_3[0])));
...
{
  {
    ...
    succeeded = check_hlds__modecheck_coerce__IntroducedFrom__pred__get_bound_functor_cons_and_arg_types__602__1_2_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))));
    return succeeded;
  }
}
      ...
      case (MR_Integer) 2:
        {
...

          {
            ...
            MR_hl_field(MR_mktag(0), Var_46, 0) = ((MR_Box) (&check_hlds__modecheck_coerce_scalar_common_3[1]));
