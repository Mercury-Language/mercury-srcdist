        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            ...
            else
            {
              ...
              parse_tree__prog_type_subst__apply_subst_to_types_3_p_0(Subst_95, CtorArgTypes0_92, &ArgTypesX_17);
            }
            succeeded = MR_TRUE;
          }
        }
            ...
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                ...
                else
                {
                  ...
                  parse_tree__prog_type_subst__apply_subst_to_types_3_p_0(Subst_114, CtorArgTypes0_111, &ArgTypesY_21);
                }
                succeeded = MR_TRUE;
              }
            }
