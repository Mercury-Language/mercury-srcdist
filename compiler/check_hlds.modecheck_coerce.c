...
{
  {
    ...
    else
    {
      ...
      succeeded = check_hlds__inst_util__abstractly_unify_inst_8_p_0(BothLive_25, InstX_16, Var_47, (MR_Integer) 0, &UnifyInstX_30, &_Det_31, ModuleInfo0_11, &ModuleInfo1_32);
      if (succeeded)
      {
          ...
          case (MR_Integer) 4:
            {
              ...
              if (succeeded)
              {
                ...
                check_hlds__mode_util__inst_lookup_3_p_0(ModuleInfo_10, InstNameX_35, &InstX1_37);
