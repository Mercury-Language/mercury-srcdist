  ...
  MR_Word * Res_18)
{
  while (MR_TRUE)
  {
    ...
    switch (MR_tag((MR_Word) InstX_17)) {
      ...
      case (MR_Integer) 1:
        {
          MR_Word HOInstInfoX_25 = ((MR_Word) ((MR_hl_field(1, InstX_17, (MR_Integer) 1))));
          MR_Word UniqX_53 = ((MR_Unsigned) ((MR_hl_field(1, InstX_17, (MR_Integer) 0))) & (MR_Integer) 7);
          ...
          else
          {
            ...
            {
              InstY_28 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(1, InstY_28, 0) = (MR_Box) ((MR_Unsigned) (UniqY_27));
              MR_hl_field(1, InstY_28, 1) = ((MR_Box) (HOInstInfoX_25));
            }
            {
              MR_Word base;
      ...
      case (MR_Integer) 2:
        {
          MR_Word UniqX_22 = ((MR_Unsigned) ((MR_hl_field(2, InstX_17, (MR_Integer) 0))) & (MR_Integer) 7);
          MR_Word FunctorsX_24 = ((MR_Word) ((MR_hl_field(2, InstX_17, (MR_Integer) 2))));
          ...
          if ((BadConsIds_63 == (MR_Word) ((MR_Unsigned) 0U)))
            if ((MaybeError0_64 == (MR_Word) ((MR_Unsigned) 0U)))
            {
              ...
              {
                InstY_67 = (MR_Word) MR_mkword(2, MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(2, InstY_67, 0) = (MR_Box) ((MR_Unsigned) (UniqY_65));
                MR_hl_field(2, InstY_67, 1) = ((MR_Box) (MR_mkword(1, &check_hlds__modecheck_coerce_scalar_common_4[0])));
                MR_hl_field(2, InstY_67, 2) = ((MR_Box) (FunctorsY_62));
              }
              {
                MR_Word base;
                base = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
