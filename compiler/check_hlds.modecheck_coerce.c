  ...
  MR_Word * STATE_VARIABLE_ModeInfo_31)
{
  ...
  if (succeeded)
  {
    ...
    if (succeeded)
    {
      ...
      succeeded = hlds__inst_test__inst_is_ground_3_p_0(ModuleInfo0_19, TypeX_21, InstX_23);
      if (succeeded)
      {
        succeeded = hlds__inst_test__inst_is_clobbered_2_p_0(ModuleInfo0_19, InstX_23);
        succeeded = !(succeeded);
      }
      if (succeeded)
      {
  ...
  MR_Word * STATE_VARIABLE_ModeInfo_46)
{
  ...
  else
  {
    ...
    succeeded = hlds__inst_test__inst_is_free_2_p_0(ModuleInfo_34, InstY_17);
    if (succeeded)
    {
      MR_Word ModeY_37;
      MR_Word Var_56;
  ...
  MR_Word * Result_12)
{
  ...
  ModuleName_75 = hlds__type_util__type_ctor_module_1_f_0(TypeCtorY_13);
