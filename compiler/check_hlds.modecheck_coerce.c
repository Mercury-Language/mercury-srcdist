  ...
  MR_Word * STATE_VARIABLE_ModeInfo_45)
{
  ...
  else
  {
    ...
    else
    {
      ...
      MR_Word VarIsDummy_84;
      MR_Word VarEntry_85;
      MR_Word VarTable0_86;
      MR_Word VarTable_87;

      check_hlds__mode_info__mode_info_get_module_info_2_p_0(STATE_VARIABLE_ModeInfo_52_52, &ModuleInfo_83);
      VarIsDummy_84 = check_hlds__type_util__is_type_a_dummy_2_f_0(ModuleInfo_83, TypeY_15);
      {
        VarEntry_85 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), VarEntry_85, 0) = ((MR_Box) ((MR_String) ""));
        MR_hl_field(MR_mktag(0), VarEntry_85, 1) = ((MR_Box) (TypeY_15));
        MR_hl_field(MR_mktag(0), VarEntry_85, 2) = (MR_Box) ((MR_Unsigned) (VarIsDummy_84));
      }
      check_hlds__mode_info__mode_info_get_var_table_2_p_0(STATE_VARIABLE_ModeInfo_52_52, &VarTable0_86);
      parse_tree__var_table__add_var_entry_4_p_0(VarEntry_85, &YPrime_37, VarTable0_86, &VarTable_87);
      check_hlds__mode_info__mode_info_set_var_table_3_p_0(VarTable_87, STATE_VARIABLE_ModeInfo_52_52, &STATE_VARIABLE_ModeInfo_62_62);
        ...
        case (MR_Integer) 8:
          {
            ...
            if (succeeded)
            {
...

              {
                ...
                MR_hl_field(MR_mktag(0), Var_71, 0) = ((MR_Box) (&check_hlds__modecheck_coerce_scalar_common_4[1]));
                MR_hl_field(MR_mktag(0), Var_71, 1) = ((MR_Box) (check_hlds__modecheck_coerce__modecheck_coerce_from_bound_make_bound_functor_12_p_0_1));
                MR_hl_field(MR_mktag(0), Var_71, 2) = ((MR_Box) ((MR_Integer) 2));
                MR_hl_field(MR_mktag(0), Var_71, 3) = ((MR_Box) (TypeX_17));
                MR_hl_field(MR_mktag(0), Var_71, 4) = ((MR_Box) (TypeY_18));
              }
              mercury__require__expect_3_p_0(Var_71, (MR_String) "predicate \140check_hlds.modecheck_coerce.modecheck_coerce_from_bound_make_bound_functor\'/12", (MR_String) "coercion between different builtin types");
              {
                Var_74 = (MR_Word) MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL);
                MR_hl_field(MR_mktag(0), Var_74, 0) = ((MR_Box) (&check_hlds__modecheck_coerce_scalar_common_4[2]));
                MR_hl_field(MR_mktag(0), Var_74, 1) = ((MR_Box) (check_hlds__modecheck_coerce__modecheck_coerce_from_bound_make_bound_functor_12_p_0_2));
                MR_hl_field(MR_mktag(0), Var_74, 2) = ((MR_Box) ((MR_Integer) 2));
                MR_hl_field(MR_mktag(0), Var_74, 3) = ((MR_Box) (ArgInstsX_25));
                MR_hl_field(MR_mktag(0), Var_74, 4) = ((MR_Box) ((MR_Unsigned) 0U));
              }
              mercury__require__expect_3_p_0(Var_74, (MR_String) "predicate \140check_hlds.modecheck_coerce.modecheck_coerce_from_bound_make_bound_functor\'/12", (MR_String) "bound functor literal has arguments");
      ...
      case (MR_Integer) 0:
        {
          ...
          if (succeeded)
          {
            Var_50 = (MR_String) "predicate \140check_hlds.modecheck_coerce.compare_types_nonvar\'/5";
            Var_51 = (MR_String) "type_variable";
            mercury__require__unexpected_2_p_0(Var_50, Var_51);
            succeeded = MR_TRUE;
          }
        }
        break;
            ...
            case (MR_Integer) 0:
              {
                ...
                if (succeeded)
                {
                  Var_55 = (MR_String) "predicate \140check_hlds.modecheck_coerce.compare_types_nonvar\'/5";
