  ...
  MR_Word * STATE_VARIABLE_ModeInfo_46)
{
  ...
  else
  {
    ...
    else
    {
      ...
      check_hlds__mode_info__mode_info_get_var_table_2_p_0(STATE_VARIABLE_ModeInfo_53_53, &VarTable0_79);
      hlds__var_table_hlds__create_fresh_var_5_p_0(ModuleInfo_78, TypeY_15, &YPrime_38, VarTable0_79, &VarTable_80);
      check_hlds__mode_info__mode_info_set_var_table_3_p_0(VarTable_80, STATE_VARIABLE_ModeInfo_53_53, &STATE_VARIABLE_ModeInfo_63_63);
