  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(1), Var_59, 0) = ((MR_Box) (ModeY_36));
        MR_hl_field(MR_mktag(1), Var_59, 1) = ((MR_Box) ((MR_Unsigned) 0U));
      }
      {
        Var_58 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), Var_58, 0) = ((MR_Box) (ModeX_35));
    ...
    else
    {
      ...
      VarIsDummy_78 = check_hlds__type_util__is_type_a_dummy_2_f_0(ModuleInfo_77, TypeY_15);
      {
        ...
        MR_hl_field(MR_mktag(0), VarEntry_79, 0) = ((MR_Box) ((MR_String) ""));
        MR_hl_field(MR_mktag(0), VarEntry_79, 1) = ((MR_Box) (TypeY_15));
        MR_hl_field(MR_mktag(0), VarEntry_79, 2) = (MR_Box) ((MR_Unsigned) (VarIsDummy_78));
      }
      ...
      check_hlds__modecheck_unify__create_var_var_unification_5_p_0(Y_13, YPrime_37, TypeY_15, STATE_VARIABLE_ModeInfo_62_62, &ExtraGoal_38);
      {
        ...
        MR_hl_field(MR_mktag(1), Var_64, 0) = ((MR_Box) (ExtraGoal_38));
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(1), ExtraGoals_39, 1) = ((MR_Box) (Var_64));
      }
          ...
          case (MR_Integer) 4:
            {
...

              {
                ...
                MR_hl_field(MR_mktag(0), Var_48, 0) = ((MR_Box) (InstNameX_35));
                MR_hl_field(MR_mktag(0), Var_48, 1) = ((MR_Box) (TypeX_14));
              }
              succeeded = mercury__set__insert_new_3_p_0((MR_Word) (&check_hlds__modecheck_coerce_scalar_common_1[0]), ((MR_Box) (Var_48)), ExpandedInsts0_16, &ExpandedInsts1_36);
              if (succeeded)
              {
                MR_Word InstX1_37;
          ...
          case (MR_Integer) 8:
            {
              ...
              if (succeeded)
              {
...

                {
                  ...
                  MR_hl_field(MR_mktag(0), Var_52, 0) = ((MR_Box) (&check_hlds__modecheck_coerce_scalar_common_4[1]));
                  MR_hl_field(MR_mktag(0), Var_52, 1) = ((MR_Box) (check_hlds__modecheck_coerce__modecheck_coerce_from_bound_make_bound_functors_13_p_0_1));
                  MR_hl_field(MR_mktag(0), Var_52, 2) = ((MR_Box) ((MR_Integer) 2));
                  MR_hl_field(MR_mktag(0), Var_52, 3) = ((MR_Box) (TypeX_18));
                  MR_hl_field(MR_mktag(0), Var_52, 4) = ((MR_Box) (TypeY_19));
                }
                mercury__require__expect_3_p_0(Var_52, (MR_String) "predicate \140check_hlds.modecheck_coerce.modecheck_coerce_from_bound_make_bound_functor\'/12", (MR_String) "coercion between different builtin types");
                {
                  ...
                  MR_hl_field(MR_mktag(0), Var_55, 0) = ((MR_Box) (&check_hlds__modecheck_coerce_scalar_common_4[2]));
                  MR_hl_field(MR_mktag(0), Var_55, 1) = ((MR_Box) (check_hlds__modecheck_coerce__modecheck_coerce_from_bound_make_bound_functors_13_p_0_2));
                  MR_hl_field(MR_mktag(0), Var_55, 2) = ((MR_Box) ((MR_Integer) 2));
                  MR_hl_field(MR_mktag(0), Var_55, 3) = ((MR_Box) (ArgInstsX_37));
    ...
    case (MR_Integer) 2:
      {
...

        {
          ...
          MR_hl_field(MR_mktag(0), Var_50, 0) = ((MR_Box) (&check_hlds__modecheck_coerce_scalar_common_4[1]));
          MR_hl_field(MR_mktag(0), Var_50, 1) = ((MR_Box) (check_hlds__modecheck_coerce__get_bound_functor_cons_and_arg_types_6_p_0_1));
          MR_hl_field(MR_mktag(0), Var_50, 2) = ((MR_Box) ((MR_Integer) 2));
          MR_hl_field(MR_mktag(0), Var_50, 3) = ((MR_Box) (TypeX_8));
          MR_hl_field(MR_mktag(0), Var_50, 4) = ((MR_Box) (TypeY_9));
        }
        ...
        case (MR_Integer) 0:
          {
            ...
            MR_Word Var_46 = ((MR_Word) ((MR_hl_field(MR_mktag(3), ConsIdX_10, (MR_Integer) 1))));
            MR_String Var_47;
            MR_Integer Var_73;
