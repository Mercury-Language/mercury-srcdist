...
{
  {
    ...
    {
      MR_Word Var_16 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), HeadVar__2_2, (MR_Integer) 0))) & (MR_Integer) 1);
      ...
      if (((MR_tag((MR_Word) HeadVar__3_3)) == (MR_Integer) 0))
      {
        ...
        mercury__private_builtin__builtin_compare_int_3_p_0(HeadVar__1_1, Var_18, Var_19);
      }
      else
    ...
    else
    {
      ...
      else
      {
        ...
        MR_String Var_20 = (MR_String) (Var_17);
        MR_String Var_21 = (MR_String) (ArgY1_11);

        mercury__private_builtin__builtin_compare_string_3_p_0(HeadVar__1_1, Var_20, Var_21);
      }
    }
  }
}
...
{
  {
    ...
    Year_5 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), Var_4, (MR_Integer) 0))));
    Month_6 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), Var_4, (MR_Integer) 1))));
    MD_7 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), Var_4, (MR_Integer) 2))));
    Hrs_8 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), Var_4, (MR_Integer) 3))));
    Min_9 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), Var_4, (MR_Integer) 4))));
    Sec_10 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), Var_4, (MR_Integer) 5))));
    YD_11 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), Var_4, (MR_Integer) 6))));
    WD_12 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), Var_4, (MR_Integer) 7))));
    DST_13 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_4, (MR_Integer) 8))));
    if ((DST_13 == (MR_Word) ((MR_Unsigned) 0U)))
      Var_15 = (MR_Integer) -1;
    else
    {
      MR_Word DST_18 = ((MR_Word) ((MR_hl_field(MR_mktag(1), DST_13, (MR_Integer) 0))));
