...
#line 169 "libs.timestamp.c"
static const MR_Integer libs__timestamp__libs__timestamp__functor_number_map_timestamp_0[1] = {
  (MR_Integer) 0
};

#line 174 "libs.timestamp.c"
static const MR_NotagFunctorDesc libs__timestamp__libs__timestamp__notag_functor_desc_timestamp_0 = {
  (MR_String) "timestamp",
...
#line 202 "libs.timestamp.c"
static MR_bool MR_CALL 
libs__timestamp____Unify____timestamp_0_0_10001(
#line 205 "libs.timestamp.c"
  MR_Box libs__timestamp__wrapper_arg_1,
#line 207 "libs.timestamp.c"
  MR_Box libs__timestamp__wrapper_arg_2)
#line 209 "libs.timestamp.c"
{
#line 211 "libs.timestamp.c"
  {
#line 213 "libs.timestamp.c"
    MR_bool libs__timestamp__succeeded;

#line 216 "libs.timestamp.c"
    {
#line 218 "libs.timestamp.c"
...
#line 223 "libs.timestamp.c"
  }
#line 225 "libs.timestamp.c"
}

#line 228 "libs.timestamp.c"
static void MR_CALL 
libs__timestamp____Compare____timestamp_0_0_10001(
#line 231 "libs.timestamp.c"
  MR_Box * libs__timestamp__wrapper_arg_1,
#line 233 "libs.timestamp.c"
  MR_Box libs__timestamp__wrapper_arg_2,
#line 235 "libs.timestamp.c"
  MR_Box libs__timestamp__wrapper_arg_3)
#line 237 "libs.timestamp.c"
{
#line 239 "libs.timestamp.c"
  {
#line 241 "libs.timestamp.c"
    MR_Word libs__timestamp__conv0_HeadVar__1_1;

#line 244 "libs.timestamp.c"
    {
#line 246 "libs.timestamp.c"
...
#line 147 "timestamp.m"
          libs__timestamp__V_15_15 = (MR_Integer) 1;
#line 146 "timestamp.m"
        else
#line 149 "timestamp.m"
