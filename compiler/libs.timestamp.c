...
MR_decl_entry(fn__string__unsafe_between_3_0);
...
MR_def_label(fn__libs__timestamp__string_to_timestamp_1_0,6)
	...
	MR_r2 = (MR_Integer) 0;
	MR_r3 = (MR_Integer) 4;
	MR_np_call_localret_ent(fn__string__unsafe_between_3_0,
...
void mercury__libs__timestamp__write_out_proc_statics(FILE *deep_fp, FILE *procrep_fp)
{
	MR_write_out_module_proc_reps_start(procrep_fp, &mercury_data__module_layout__libs__timestamp);
