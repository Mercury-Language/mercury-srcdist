...
{
  {
    ...
    if (libs__timestamp__succeeded)
      *libs__timestamp__HeadVar__1_1 = (MR_Integer) 0;
      ...
      {
        MR_String libs__timestamp__Var_4 = (MR_String) libs__timestamp__HeadVar__2_2;
        MR_String libs__timestamp__Var_5 = (MR_String) libs__timestamp__HeadVar__3_3;

        {
          mercury__private_builtin__builtin_compare_string_3_p_0(libs__timestamp__HeadVar__1_1, libs__timestamp__Var_4, libs__timestamp__Var_5);
        }
      }
  }
}
...
{
  {
    ...
    if (libs__timestamp__succeeded)
      ...
      {
        MR_String libs__timestamp__Var_3 = (MR_String) libs__timestamp__HeadVar__1_1;
        MR_String libs__timestamp__Var_4 = (MR_String) libs__timestamp__HeadVar__2_2;

        libs__timestamp__succeeded = (strcmp(libs__timestamp__Var_3, libs__timestamp__Var_4) == 0);
      }
    return libs__timestamp__succeeded;
  }
}
    ...
    if (((MR_tag((MR_Word) libs__timestamp__HeadVar__2_2)) == (MR_mktag((MR_Integer) 0))))
      {
        ...
        if (((MR_tag((MR_Word) libs__timestamp__HeadVar__3_3)) == (MR_mktag((MR_Integer) 0))))
          {
            MR_Word libs__timestamp__Var_5 = ((MR_Word) (MR_hl_field(MR_mktag(0), libs__timestamp__HeadVar__3_3, (MR_Integer) 0)));
            MR_Integer libs__timestamp__Var_18 = (MR_Integer) libs__timestamp__Var_16;
            MR_Integer libs__timestamp__Var_19 = (MR_Integer) libs__timestamp__Var_5;
    ...
    else
      {
        ...
        if (((MR_tag((MR_Word) libs__timestamp__HeadVar__3_3)) == (MR_mktag((MR_Integer) 0))))
          *libs__timestamp__HeadVar__1_1 = (MR_Integer) 2;
          ...
          {
            MR_Word libs__timestamp__Var_11 = ((MR_Word) (MR_hl_field(MR_mktag(1), libs__timestamp__HeadVar__3_3, (MR_Integer) 0)));
            MR_String libs__timestamp__Var_20 = (MR_String) libs__timestamp__Var_17;
            MR_String libs__timestamp__Var_21 = (MR_String) libs__timestamp__Var_11;
...
{
  {
    ...
    if (((MR_tag((MR_Word) libs__timestamp__HeadVar__1_1)) == (MR_mktag((MR_Integer) 0))))
      {
        MR_Word libs__timestamp__Var_3 = ((MR_Word) (MR_hl_field(MR_mktag(0), libs__timestamp__HeadVar__1_1, (MR_Integer) 0)));
        ...
        if (libs__timestamp__succeeded)
          {
            libs__timestamp__Var_4 = ((MR_Word) (MR_hl_field(MR_mktag(0), libs__timestamp__HeadVar__2_2, (MR_Integer) 0)));
            libs__timestamp__succeeded = (libs__timestamp__Var_3 == libs__timestamp__Var_4);
          }
      }
    else
      {
        MR_Word libs__timestamp__Var_5 = ((MR_Word) (MR_hl_field(MR_mktag(1), libs__timestamp__HeadVar__1_1, (MR_Integer) 0)));
        MR_Word libs__timestamp__Var_6;
        ...
        if (libs__timestamp__succeeded)
          {
            libs__timestamp__Var_6 = ((MR_Word) (MR_hl_field(MR_mktag(1), libs__timestamp__HeadVar__2_2, (MR_Integer) 0)));
            libs__timestamp__CastX_11 = (MR_Integer) libs__timestamp__Var_5;
            libs__timestamp__CastY_12 = (MR_Integer) libs__timestamp__Var_6;
            libs__timestamp__succeeded = (libs__timestamp__CastX_11 == libs__timestamp__CastY_12);
            if (libs__timestamp__succeeded)
              libs__timestamp__succeeded = MR_TRUE;
            else
              {
                MR_String libs__timestamp__Var_9 = (MR_String) libs__timestamp__Var_5;
                MR_String libs__timestamp__Var_10 = (MR_String) libs__timestamp__Var_6;

                libs__timestamp__succeeded = (strcmp(libs__timestamp__Var_9, libs__timestamp__Var_10) == 0);
              }
          }
      }
    return libs__timestamp__succeeded;
