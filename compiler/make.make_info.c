...
static /* final */ const MR_Box make__make_info_scalar_common_2[8][3];
                                            ...
                                            else
                                            {
                                              ...
                                              if (succeeded)
                                                *HeadVar__1_1 = SubResult22_69;
                                                ...
                                                mercury__builtin__compare_3_p_0((MR_Word) (&make__make_info_scalar_common_2[5]), HeadVar__1_1, ((MR_Box) (ArgX23_70)), ((MR_Box) (ArgY23_71)));
                                            }
                                          }
                                        }
                                      }
  ...
  MR_Word HeadVar__3_3)
{
  ...
  else
  {
    ...
    mercury__builtin__compare_3_p_0((MR_Word) (&make__make_info_scalar_common_2[6]), &SubResult1_6, ((MR_Box) (ArgX1_4)), ((MR_Box) (ArgY1_5)));
    succeeded = (SubResult1_6 != (MR_Integer) 0);
    if (succeeded)
      *HeadVar__1_1 = SubResult1_6;
    else
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              TypeInfo_55_55 = (MR_Word) (&make__make_info_scalar_common_1[1]);
              ...
              if (succeeded)
              {
                ...
                if (succeeded)
                {
                  ...
                  if (succeeded)
                  {
                    TypeInfo_56_56 = (MR_Word) (&make__make_info_scalar_common_2[2]);
                    ...
                    if (succeeded)
                    {
                      ...
                      if (succeeded)
                      {
                        TypeInfo_58_58 = (MR_Word) (&make__make_info_scalar_common_2[3]);
                        ...
                        if (succeeded)
                        {
                          ...
                          if (succeeded)
                          {
                            ...
                            if (succeeded)
                            {
                              TypeInfo_59_59 = (MR_Word) (&make__make_info_scalar_common_2[4]);
                              ...
                              if (succeeded)
                              {
                                ...
                                if (succeeded)
                                {
                                  TypeInfo_61_61 = (MR_Word) (&make__make_info_scalar_common_1[3]);
                                  ...
                                  if (succeeded)
                                  {
                                    ...
                                    if (succeeded)
                                    {
                                      TypeCtorInfo_63_63 = (MR_Word) (&make__prereqs_cache__make__prereqs_cache__type_ctor_info_module_to_module_set_cache_0);
                                      succeeded = mercury__builtin__unify_2_p_0(TypeCtorInfo_63_63, ((MR_Box) (ArgX18_37)), ((MR_Box) (ArgY18_38)));
                                      if (succeeded)
                                      {
                                        TypeCtorInfo_64_64 = (MR_Word) (&make__prereqs_cache__make__prereqs_cache__type_ctor_info_module_to_module_set_cache_0);
                                        ...
                                        if (succeeded)
                                        {
                                          ...
                                          if (succeeded)
                                          {
                                            ...
                                            if (succeeded)
                                            {
                                              TypeCtorInfo_67_67 = (MR_Word) (&make__prereqs_cache__make__prereqs_cache__type_ctor_info_module_to_target_id_set_cache_0);
                                              succeeded = mercury__builtin__unify_2_p_0(TypeCtorInfo_67_67, ((MR_Box) (ArgX22_45)), ((MR_Box) (ArgY22_46)));
                                              if (succeeded)
                                              {
                                                TypeInfo_68_68 = (MR_Word) (&make__make_info_scalar_common_2[5]);
  ...
  MR_Word HeadVar__2_2)
{
  ...
  else
  {
    ...
    succeeded = mercury__builtin__unify_2_p_0((MR_Word) (&make__make_info_scalar_common_2[6]), ((MR_Box) (ArgX1_3)), ((MR_Box) (ArgY1_4)));
    if (succeeded)
    {
  ...
  MR_Word TargetStatusMap_23)
{
  ...
  Var_35 = make__prereqs_cache__init_module_to_target_id_set_cache_0_f_0();
