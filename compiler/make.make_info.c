...
static const MR_FA_TypeInfo_Struct1 make__make_info__maybe__ti_maybe_1mdbcomp__sym_name__type_ctor_info_sym_name_0;
...
static const MR_PseudoTypeInfo make__make_info__make__make_info__field_types_make_info_0_0[21] = {
  ...
  (MR_PseudoTypeInfo) (&make__make_info__maybe__ti_maybe_1mdbcomp__sym_name__type_ctor_info_sym_name_0),
...
{
  {
    ...
    else
    {
      ...
      else
      {
        ...
        parse_tree__module_imports____Compare____module_dep_info_0_0(HeadVar__1_1, Var_11, ArgY1_7);
      }
    }
  }
}
...
{
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        succeeded = parse_tree__module_imports____Unify____module_dep_info_0_0(ArgX1_5, ArgY1_6);
      }
    }
    return succeeded;
  }
