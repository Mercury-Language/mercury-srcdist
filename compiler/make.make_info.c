                                      ...
                                      else
                                      {
                                        ...
                                        else
                                        {
                                          ...
                                          else
                                          {
                                            ...
                                            mercury__builtin__compare_3_p_0((MR_Word) (&make__make_info_scalar_common_1[7]), &SubResult21_66, ((MR_Box) (ArgX21_64)), ((MR_Box) (ArgY21_65)));
                                    ...
                                    if (succeeded)
                                    {
                                      ...
                                      if (succeeded)
                                      {
                                        ...
                                        if (succeeded)
                                        {
                                          ...
                                          if (succeeded)
                                          {
                                            TypeInfo_66_66 = (MR_Word) (&make__make_info_scalar_common_1[7]);
  ...
  MR_Word DepStatusMap_21)
{
  ...
  Var_33 = make__deps_cache__init_cached_transitive_dependencies_0_f_0();
