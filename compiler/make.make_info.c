  ...
  MR_Word HeadVar__3_3)
{
  ...
  else
  {
    ...
    else
    {
      ...
      libs__globals____Compare____maybe_stdlib_grades_0_0(&SubResult2_9, ArgX2_7, ArgY2_8);
  ...
  MR_Word HeadVar__2_2)
{
  ...
  else
  {
    ...
    if (succeeded)
    {
      succeeded = libs__globals____Unify____maybe_stdlib_grades_0_0(ArgX2_5, ArgY2_6);
      if (succeeded)
      {
  ...
  MR_Word DepStatusMap_23)
{
  ...
  Var_37 = make__deps_cache__init_trans_deps_cache_0_f_0();
  {
    ...
    MR_hl_field(0, MakeInfo_24, 1) = ((MR_Box) (MaybeStdLibGrades_14));
