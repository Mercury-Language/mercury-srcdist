...
static const MR_PseudoTypeInfo make__make_info__make__make_info__field_types_linked_target_file_0_0[2] = {
  ...
  (MR_PseudoTypeInfo) (&backend_libs__link_target_util__backend_libs__link_target_util__type_ctor_info_linked_target_type_0)
};
...
static const MR_PseudoTypeInfo make__make_info__make__make_info__field_types_target_type_0_1[1] = { (MR_PseudoTypeInfo) (&backend_libs__link_target_util__backend_libs__link_target_util__type_ctor_info_linked_target_type_0) };
