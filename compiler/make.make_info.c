  ...
  MR_Word TargetStatusMap_23)
{
  ...
  mercury__map__init_1_p_0((MR_Word) (&make__index_set__make__index_set__type_ctor_info_module_index_0), (MR_Word) (&make__make_info__make__make_info__type_ctor_info_is_src_local_0), &SrcCurDirMap_30);
