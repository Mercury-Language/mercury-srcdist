...
{
  {
...

    {
      ...
      MR_hl_field(MR_mktag(0), Var_46, 0) = ((MR_Box) (LambdaHeadVar__1_44));
      MR_hl_field(MR_mktag(0), Var_46, 1) = ((MR_Box) (LambdaHeadVar__1_44));
    }
    {
      ...
      MR_hl_field(MR_mktag(0), Var_48, 1) = ((MR_Box) (LambdaHeadVar__1_44));
    }
    {
      MR_Word base;
...
{
  {
    ...
    MR_Word SwitchCanFail0_21 = ((MR_Word) (MR_hl_field(MR_mktag(3), GoalExpr0_11, (MR_Integer) 2)));
    ...
    if (succeeded)
    {
      ...
      {
        MaybeInstConsIds_33 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
    ...
    {
      Cases1_31 = Cases0_22;
      MaybeInstConsIds_33 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
      STATE_VARIABLE_Info_73_73 = STATE_VARIABLE_Info_0_71;
    }
    check_hlds__simplify__simplify_goal_switch__simplify_switch_cases_15_p_0(Var_20, Cases1_31, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), &RevCases_37, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), &RevInstMapDeltas_38, (MR_Integer) 0, &SeenNonGroundTerm_39, SwitchCanFail0_21, &SwitchCanFail_40, NestedContext0_15, InstMap0_16, Common0_17, STATE_VARIABLE_Info_73_73, &STATE_VARIABLE_Info_77_77);
    TypeCtorInfo_117_117 = (MR_Word) &hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_case_0;
    mercury__list__reverse_2_p_0(TypeCtorInfo_117_117, RevCases_37, &Cases_41);
    if ((Cases_41 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
    {
      MR_Word Context_42;
      MR_Integer Var_97;
      MR_Word Var_99;
    ...
    else
    {
      ...
      if ((Var_136 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
      {
        ...
        if ((Var_139 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
        {
          ...
          if (succeeded)
          {
            succeeded = ((MR_tag((MR_Word) MaybeInstConsIds_33)) == (MR_mktag((MR_Integer) 1)));
            if (succeeded)
            {
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
...

              {
                ...
                *GoalExpr_12 = base;
                ...
                MR_hl_field(MR_mktag(3), base, 2) = ((MR_Box) (SwitchCanFail_40));
            ...
            else
            {
              ...
              {
                GoalList_53 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
    ...
    *Common_18 = Common0_17;
    mercury__list__length_2_p_0(TypeCtorInfo_117_117, Cases0_22, &Cases0Length_69);
    mercury__list__length_2_p_0(TypeCtorInfo_117_117, Cases_41, &CasesLength_70);
...
{
  {
    ...
    check_hlds__simplify__simplify_goal_switch__IntroducedFrom__pred__create_test_unification__288__1_2_p_0(((MR_Word) wrapper_arg_1), &conv0_LambdaHeadVar__2_45);
...
{
  {
    ...
    mercury__varset__new_vars_4_p_0(TypeCtorInfo_64_64, ConsArity_10, &ArgVars_16, VarSet0_14, &VarSet_17);
    ...
    mercury__list__map_3_p_0((MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_inst_0, (MR_Word) &hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_unify_mode_0, (MR_Word) &check_hlds__simplify__simplify_goal_switch_scalar_common_2[0], ArgInsts_25, &ArgUnifyModes_29);
    {
      ...
      MR_hl_field(MR_mktag(0), Var_50, 0) = ((MR_Box) (Inst0_22));
      MR_hl_field(MR_mktag(0), Var_50, 1) = ((MR_Box) (Inst0_22));
    }
    {
      UnifyMode_30 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), UnifyMode_30, 0) = ((MR_Box) (Var_50));
      MR_hl_field(MR_mktag(0), UnifyMode_30, 1) = ((MR_Box) (Var_50));
    }
    {
      Unification_32 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 6 * sizeof(MR_Word)), NULL, NULL));
      ...
      MR_hl_field(MR_mktag(1), Unification_32, 4) = ((MR_Box) ((MR_Integer) 0));
      MR_hl_field(MR_mktag(1), Unification_32, 5) = ((MR_Box) ((MR_Integer) 1));
    }
    {
      Var_58 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), Var_58, 0) = ((MR_Box) (ConsId_9));
      MR_hl_field(MR_mktag(1), Var_58, 1) = ((MR_Box) ((MR_Integer) 0));
      MR_hl_field(MR_mktag(1), Var_58, 2) = ((MR_Box) (ArgVars_16));
    }
    {
      ExtraGoalExpr_33 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 5 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), ExtraGoalExpr_33, 0) = ((MR_Box) (Var_8));
      MR_hl_field(MR_mktag(1), ExtraGoalExpr_33, 1) = ((MR_Box) (Var_58));
    ...
    NonLocals_34 = parse_tree__set_of_var__make_singleton_1_f_0(TypeCtorInfo_64_64, Var_8);
  ...
  MR_Word * STATE_VARIABLE_Info_15)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      Var_56 = ((MR_Word) (MR_hl_field(MR_mktag(0), Goal_54, (MR_Integer) 1)));
      succeeded = ((((MR_tag((MR_Word) Var_79)) == (MR_mktag((MR_Integer) 3)))) && (((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), Var_79, (MR_Integer) 0)))) == (MR_Integer) 3)));
      if (succeeded)
      {
      ...
      else
      {
        ...
        {
          Case_57 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL);
        ...
        succeeded = ((((MR_tag((MR_Word) GoalExpr_58)) == (MR_mktag((MR_Integer) 3)))) && (((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), GoalExpr_58, (MR_Integer) 0)))) == (MR_Integer) 5)));
        if (succeeded)
        {
          Reason_60 = ((MR_Word) (MR_hl_field(MR_mktag(3), GoalExpr_58, (MR_Integer) 1)));
          Var_61 = ((MR_Word) (MR_hl_field(MR_mktag(3), GoalExpr_58, (MR_Integer) 2)));
          ...
          if (succeeded)
          {
            Var_62 = ((MR_Word) (MR_hl_field(MR_mktag(3), Reason_60, (MR_Integer) 1)));
            Var_82 = ((MR_Word) (MR_hl_field(MR_mktag(3), Reason_60, (MR_Integer) 2)));
        ...
        {
          STATE_VARIABLE_RevInstMapDeltas_85_85 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
        ...
        {
          STATE_VARIABLE_RevCases_86_86 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      ...
      {
        MR_Word next_value_of_HeadVar__2_2 = Cases0_37;
        MR_Word next_value_of_STATE_VARIABLE_RevCases_0_3 = STATE_VARIABLE_RevCases_86_86;
        MR_Word next_value_of_STATE_VARIABLE_RevInstMapDeltas_0_5 = STATE_VARIABLE_RevInstMapDeltas_85_85;
        MR_Word next_value_of_STATE_VARIABLE_SeenNonGroundTerm_0_7 = STATE_VARIABLE_SeenNonGroundTerm_83_83;
        MR_Word next_value_of_STATE_VARIABLE_CanFail_0_9 = STATE_VARIABLE_CanFail_81_81;
        MR_Word next_value_of_STATE_VARIABLE_Info_0_14 = STATE_VARIABLE_Info_84_84;
