...
static void MR_CALL 
check_hlds__simplify__simplify_goal_switch__IntroducedFrom__pred__create_test_unification__289__1_2_p_0(
...
{
  {
    ...
    *Common_18 = Common0_17;
    ...
    else
    {
      ...
      check_hlds__simplify__simplify_info__simplify_info_set_rerun_quant_instmap_delta_2_p_0(STATE_VARIABLE_Info_98_98, &STATE_VARIABLE_Info_100_100);
...
{
  {
    ...
    check_hlds__simplify__simplify_goal_switch__IntroducedFrom__pred__create_test_unification__289__1_2_p_0(((MR_Word) (wrapper_arg_1)), &conv0_LambdaHeadVar__2_44);
