...
static void MR_CALL 
check_hlds__simplify__simplify_goal_switch__IntroducedFrom__pred__create_test_unification__290__1_2_p_0(
  MR_Word LambdaHeadVar__1_48,
  MR_Word * LambdaHeadVar__2_49);

static void MR_CALL 
check_hlds__simplify__simplify_goal_switch__IntroducedFrom__pred__create_test_unification__274__1_3_p_0(
  ...
  MR_Word * STATE_VARIABLE_Info_72)
{
  ...
  if (succeeded)
  {
    ...
    {
      MaybeInstConsIds_33 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(1, MaybeInstConsIds_33, 0) = ((MR_Box) (SortedConsIds_30));
    }
  ...
  {
    MR_Word Var_128 = ((MR_Word) ((MR_hl_field(1, Cases_41, (MR_Integer) 1))));
    MR_Word Var_129 = ((MR_Word) ((MR_hl_field(1, Cases_41, (MR_Integer) 0))));

    if ((Var_128 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      MR_Word Var_130 = ((MR_Word) ((MR_hl_field(0, Var_129, (MR_Integer) 2))));
      MR_Word Var_131 = ((MR_Word) ((MR_hl_field(0, Var_129, (MR_Integer) 1))));
      MR_Word Var_132 = ((MR_Word) ((MR_hl_field(0, Var_129, (MR_Integer) 0))));
      ...
      if ((Var_131 == (MR_Word) ((MR_Unsigned) 0U)))
      {
        ...
        MainConsIdArity_45 = parse_tree__prog_util__cons_id_arity_1_f_0(Var_132);
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            Var_84 = ((MR_Word) ((MR_hl_field(1, MaybeInstConsIds_33, (MR_Integer) 0))));
            succeeded = (Var_84 != (MR_Word) ((MR_Unsigned) 0U));
            if (succeeded)
            {
              Var_111 = ((MR_Word) ((MR_hl_field(1, Var_84, (MR_Integer) 0))));
              Var_85 = ((MR_Word) ((MR_hl_field(1, Var_84, (MR_Integer) 1))));
              succeeded = parse_tree__prog_data____Unify____cons_id_0_0(Var_132, Var_111);
              if (succeeded)
        ...
        if (succeeded)
        {
          ...
          succeeded = check_hlds__type_util__cons_id_is_existq_cons_3_p_0(ModuleInfo1_47, Type_46, Var_132);
          if (succeeded)
          {
...

            {
              ...
              *GoalExpr_12 = base;
              ...
              MR_hl_field(3, base, 3) = ((MR_Box) (Cases_41));
            }
            NonLocals_48 = hlds__hlds_goal__goal_info_get_nonlocals_1_f_0(GoalInfo0_13);
            hlds__instmap__merge_instmap_deltas_7_p_0(VarTable_25, NonLocals_48, InstMap0_16, RevInstMapDeltas_38, &NewDelta_49, ModuleInfo1_47, &ModuleInfo2_50);
            check_hlds__simplify__simplify_info__simplify_info_set_module_info_3_p_0(ModuleInfo2_50, STATE_VARIABLE_Info_77_77, &STATE_VARIABLE_Info_86_86);
          ...
          else
          {
            ...
            check_hlds__simplify__simplify_goal_switch__create_test_unification_7_p_0(Var_20, Var_132, MainConsIdArity_45, &UnifyGoal_51, InstMap0_16, STATE_VARIABLE_Info_77_77, &STATE_VARIABLE_Info_87_87);
            hlds__hlds_goal__goal_to_conj_list_2_p_0(Var_130, &SingleGoalConj_52);
            {
              GoalList_53 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(1, GoalList_53, 0) = ((MR_Box) (UnifyGoal_51));
              MR_hl_field(1, GoalList_53, 1) = ((MR_Box) (SingleGoalConj_52));
            }
            ...
            hlds__instmap__instmap_delta_bind_var_to_functor_8_p_0(Var_20, Type_46, Var_132, InstMap0_16, InstMapDelta0_55, &InstMapDelta_56, ModuleInfo1_47, &ModuleInfo_57);
            check_hlds__simplify__simplify_info__simplify_info_set_module_info_3_p_0(ModuleInfo_57, STATE_VARIABLE_Info_87_87, &STATE_VARIABLE_Info_88_88);
            ...
            check_hlds__simplify__simplify_info__simplify_info_set_rerun_quant_instmap_delta_2_p_0(STATE_VARIABLE_Info_88_88, &STATE_VARIABLE_Info_86_86);
            {
              MR_Word base;
              ...
              *GoalExpr_12 = base;
              ...
              MR_hl_field(3, base, 2) = ((MR_Box) (GoalList_53));
            }
          }
        }
        else
        {
          *GoalExpr_12 = ((MR_Word) ((MR_hl_field(0, Var_130, (MR_Integer) 0))));
          *GoalInfo_14 = ((MR_Word) ((MR_hl_field(0, Var_130, (MR_Integer) 1))));
          STATE_VARIABLE_Info_86_86 = STATE_VARIABLE_Info_77_77;
        }
        Var_92 = transform_hlds__pd_cost__cost_of_eliminate_switch_0_f_0();
        check_hlds__simplify__simplify_info__simplify_info_incr_cost_delta_3_p_0(Var_92, STATE_VARIABLE_Info_86_86, &STATE_VARIABLE_Info_79_79);
      }
      else
      {
        {
        ...
        else
        {
          ...
          hlds__instmap__merge_instmap_deltas_7_p_0(VarTable_25, NonLocals_104, InstMap0_16, RevInstMapDeltas_38, &NewDelta_105, ModuleInfo1_103, &ModuleInfo2_106);
          check_hlds__simplify__simplify_info__simplify_info_set_module_info_3_p_0(ModuleInfo2_106, STATE_VARIABLE_Info_77_77, &STATE_VARIABLE_Info_79_79);
    ...
    else
    {
      ...
      {
        MR_Word ModuleInfo1_114;
        MR_Word NonLocals_115;
        MR_Word NewDelta_116;
        MR_Word ModuleInfo2_117;

        check_hlds__simplify__simplify_info__simplify_info_get_module_info_2_p_0(STATE_VARIABLE_Info_77_77, &ModuleInfo1_114);
        NonLocals_115 = hlds__hlds_goal__goal_info_get_nonlocals_1_f_0(GoalInfo0_13);
        hlds__instmap__merge_instmap_deltas_7_p_0(VarTable_25, NonLocals_115, InstMap0_16, RevInstMapDeltas_38, &NewDelta_116, ModuleInfo1_114, &ModuleInfo2_117);
        check_hlds__simplify__simplify_info__simplify_info_set_module_info_3_p_0(ModuleInfo2_117, STATE_VARIABLE_Info_77_77, &STATE_VARIABLE_Info_79_79);
        hlds__hlds_goal__goal_info_set_instmap_delta_3_p_0(NewDelta_116, GoalInfo0_13, GoalInfo_14);
      }
    }
  }
  *Common_18 = Common0_17;
  ...
  else
  {
    ...
    check_hlds__simplify__simplify_info__simplify_info_set_rerun_quant_instmap_delta_2_p_0(STATE_VARIABLE_Info_79_79, &STATE_VARIABLE_Info_100_100);
    check_hlds__simplify__simplify_info__simplify_info_set_rerun_det_2_p_0(STATE_VARIABLE_Info_100_100, STATE_VARIABLE_Info_72);
  }
}
  ...
  MR_Box * wrapper_arg_2)
{
  ...
  check_hlds__simplify__simplify_goal_switch__IntroducedFrom__pred__create_test_unification__290__1_2_p_0(((MR_Word) (wrapper_arg_1)), &conv4_LambdaHeadVar__2_49);
  ...
  MR_Box * wrapper_arg_2)
{
  ...
  check_hlds__simplify__simplify_goal_switch__IntroducedFrom__pred__create_test_unification__274__1_3_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) (wrapper_arg_1)), &conv0_LambdaHeadVar__2_42);
    ...
    else
    {
      ...
      else
      {
        ...
        check_hlds__simplify__simplify_info__simplify_info_set_module_info_3_p_0(ModuleInfo_66, STATE_VARIABLE_Info_78_78, &STATE_VARIABLE_Info_84_84);
        {
          ...
          MR_hl_field(1, STATE_VARIABLE_RevInstMapDeltas_85_85, 1) = ((MR_Box) (STATE_VARIABLE_RevInstMapDeltas_0_5));
        }
        {
          ...
          MR_hl_field(1, STATE_VARIABLE_RevCases_86_86, 1) = ((MR_Box) (STATE_VARIABLE_RevCases_0_3));
        }
