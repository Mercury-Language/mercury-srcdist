...
{
  {
    ...
    MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), GoalExpr0_11, (MR_Integer) 2)));
...
{
  {
    ...
    {
      Unification_32 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 5 * sizeof(MR_Word)), NULL, NULL));
      ...
      MR_hl_field(MR_mktag(1), Unification_32, 4) = (MR_Box) (((((MR_Unsigned) ((MR_Integer) 0) << (MR_Integer) 1)) | (MR_Unsigned) ((MR_Integer) 1)));
    }
    {
    ...
    else
    {
      ...
      else
      {
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Reason_60, (MR_Integer) 2)));
