...
static void MR_CALL 
check_hlds__simplify__simplify_goal_switch__IntroducedFrom__pred__create_test_unification__342__1_2_p_0(
  MR_Word LambdaHeadVar__1_45,
  MR_Word * LambdaHeadVar__2_46);

static void MR_CALL 
check_hlds__simplify__simplify_goal_switch__IntroducedFrom__pred__create_test_unification__332__1_3_p_0(
  ...
  MR_Word * STATE_VARIABLE_Info_78)
{
  ...
  succeeded = check_hlds__inst_test__inst_is_bound_to_functors_3_p_0(ModuleInfo0_23, VarInst_24, &BoundFunctors_26);
  if (succeeded)
  {
    MR_Word VarType_27;
    ...
    check_hlds__simplify__simplify_info__simplify_info_set_deleted_call_callees_3_p_0(DeletedCallCallees_37, STATE_VARIABLE_Info_0_77, &STATE_VARIABLE_Info_79_79);
  }
  else
  {
    Cases1_32 = Cases0_22;
    MaybeInstConsIds_34 = (MR_Word) ((MR_Unsigned) 0U);
    STATE_VARIABLE_Info_79_79 = STATE_VARIABLE_Info_0_77;
  }
  check_hlds__simplify__simplify_goal_switch__simplify_switch_cases_15_p_0(Var_20, Cases1_32, NestedContext0_15, InstMap0_16, Common0_17, (MR_Word) ((MR_Unsigned) 0U), &RevCases_38, (MR_Word) ((MR_Unsigned) 0U), &RevInstMapDeltas_39, SwitchCanFail0_21, &SwitchCanFail_40, (MR_Integer) 0, &SeenNonGroundTerm_41, STATE_VARIABLE_Info_79_79, &STATE_VARIABLE_Info_83_83);
  ...
  if ((Cases_42 == (MR_Word) ((MR_Unsigned) 0U)))
  {
    ...
    check_hlds__simplify__simplify_info__simplify_info_incr_cost_delta_3_p_0(Var_84, STATE_VARIABLE_Info_83_83, &STATE_VARIABLE_Info_85_85);
    ...
    *GoalExpr_12 = ((MR_Word) ((MR_hl_field(0, Var_86, (MR_Integer) 0))));
    *GoalInfo_14 = ((MR_Word) ((MR_hl_field(0, Var_86, (MR_Integer) 1))));
  }
  else
  {
    MR_Word Var_114 = ((MR_Word) ((MR_hl_field(1, Cases_42, (MR_Integer) 1))));
    MR_Word Var_115 = ((MR_Word) ((MR_hl_field(1, Cases_42, (MR_Integer) 0))));

    if ((Var_114 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      MR_Word MainConsId_45 = ((MR_Word) ((MR_hl_field(0, Var_115, (MR_Integer) 0))));
      MR_Word OtherConsIds_46 = ((MR_Word) ((MR_hl_field(0, Var_115, (MR_Integer) 1))));
      MR_Word SingleGoal_47 = ((MR_Word) ((MR_hl_field(0, Var_115, (MR_Integer) 2))));
      ...
      if ((OtherConsIds_46 == (MR_Word) ((MR_Unsigned) 0U)))
      {
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            Var_88 = ((MR_Word) ((MR_hl_field(1, MaybeInstConsIds_34, (MR_Integer) 0))));
            succeeded = (Var_88 != (MR_Word) ((MR_Unsigned) 0U));
            if (succeeded)
            {
              Var_113 = ((MR_Word) ((MR_hl_field(1, Var_88, (MR_Integer) 0))));
        ...
        if (succeeded)
        {
          ...
          check_hlds__simplify__simplify_info__simplify_info_get_module_info_2_p_0(STATE_VARIABLE_Info_83_83, &ModuleInfo1_50);
          succeeded = ((MR_tag((MR_Word) MainConsId_45)) == (MR_Integer) 1);
          if (succeeded)
          {
            MainDuCtor_51 = (MR_Word) (MR_body((MR_Word) (MainConsId_45), (MR_Integer) 1));
            succeeded = check_hlds__type_util__cons_id_is_existq_cons_3_p_0(ModuleInfo1_50, Type_49, MainDuCtor_51);
          }
          if (succeeded)
          {
            ...
            check_hlds__simplify__simplify_info__simplify_info_set_module_info_3_p_0(ModuleInfo2_54, STATE_VARIABLE_Info_83_83, &STATE_VARIABLE_Info_90_90);
          ...
          else
          {
            ...
            check_hlds__simplify__simplify_goal_switch__create_test_unification_7_p_0(Var_20, MainConsId_45, MainConsIdArity_48, &UnifyGoal_55, InstMap0_16, STATE_VARIABLE_Info_83_83, &STATE_VARIABLE_Info_91_91);
            ...
            check_hlds__simplify__simplify_info__simplify_info_set_module_info_3_p_0(ModuleInfo_61, STATE_VARIABLE_Info_91_91, &STATE_VARIABLE_Info_92_92);
            ...
            check_hlds__simplify__simplify_info__simplify_info_set_rerun_quant_instmap_delta_2_p_0(STATE_VARIABLE_Info_92_92, &STATE_VARIABLE_Info_90_90);
            {
              MR_Word base;
        ...
        else
        {
          ...
          *GoalInfo_14 = ((MR_Word) ((MR_hl_field(0, SingleGoal_47, (MR_Integer) 1))));
          STATE_VARIABLE_Info_90_90 = STATE_VARIABLE_Info_83_83;
        }
        Var_96 = transform_hlds__pd_cost__cost_of_eliminate_switch_0_f_0();
        check_hlds__simplify__simplify_info__simplify_info_incr_cost_delta_3_p_0(Var_96, STATE_VARIABLE_Info_90_90, &STATE_VARIABLE_Info_85_85);
      }
      else
      {
        {
        ...
        check_hlds__simplify__simplify_goal_switch__update_switch_goal_info_8_p_0(VarTable_25, InstMap0_16, RevInstMapDeltas_39, SeenNonGroundTerm_41, GoalInfo0_13, GoalInfo_14, STATE_VARIABLE_Info_83_83, &STATE_VARIABLE_Info_85_85);
      }
    }
    else
    {
      ...
      check_hlds__simplify__simplify_goal_switch__update_switch_goal_info_8_p_0(VarTable_25, InstMap0_16, RevInstMapDeltas_39, SeenNonGroundTerm_41, GoalInfo0_13, GoalInfo_14, STATE_VARIABLE_Info_83_83, &STATE_VARIABLE_Info_100_100);
      SwitchArms0_71 = ((MR_Word) ((MR_hl_field(0, NestedContext0_15, (MR_Integer) 3))));
      ...
      if (succeeded)
      {
        ...
        check_hlds__simplify__simplify_info__simplify_info_get_switch_arms_to_split_2_p_0(STATE_VARIABLE_Info_100_100, &ToSplit0_73);
        ...
        check_hlds__simplify__simplify_info__simplify_info_set_switch_arms_to_split_3_p_0(ToSplit_74, STATE_VARIABLE_Info_100_100, &STATE_VARIABLE_Info_85_85);
      }
      else
        STATE_VARIABLE_Info_85_85 = STATE_VARIABLE_Info_100_100;
    }
  }
  *Common_18 = Common0_17;
  ...
  if (succeeded)
    *STATE_VARIABLE_Info_78 = STATE_VARIABLE_Info_85_85;
  else
  {
    MR_Word STATE_VARIABLE_Info_102_102;

    check_hlds__simplify__simplify_info__simplify_info_set_rerun_quant_instmap_delta_2_p_0(STATE_VARIABLE_Info_85_85, &STATE_VARIABLE_Info_102_102);
    check_hlds__simplify__simplify_info__simplify_info_set_rerun_det_2_p_0(STATE_VARIABLE_Info_102_102, STATE_VARIABLE_Info_78);
  }
}
  ...
  MR_Box * wrapper_arg_2)
{
  ...
  check_hlds__simplify__simplify_goal_switch__IntroducedFrom__pred__create_test_unification__342__1_2_p_0(((MR_Word) (wrapper_arg_1)), &conv4_LambdaHeadVar__2_46);
  ...
  MR_Box * wrapper_arg_2)
{
  ...
  check_hlds__simplify__simplify_goal_switch__IntroducedFrom__pred__create_test_unification__332__1_3_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) (wrapper_arg_1)), &conv0_LambdaHeadVar__2_41);
