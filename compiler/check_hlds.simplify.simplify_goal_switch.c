...
static void MR_CALL 
check_hlds__simplify__simplify_goal_switch__IntroducedFrom__pred__create_test_unification__340__1_2_p_0(
  ...
  MR_Word * STATE_VARIABLE_Info_78)
{
  ...
  if (succeeded)
  {
    ...
    mercury__set__union_3_p_0((MR_Word) (&hlds__pred_proc_id__hlds__pred_proc_id__type_ctor_info_pred_proc_id_0), SubGoalCalledProcs_36, DeletedCallCallees0_35, &DeletedCallCallees_37);
      ...
      if ((OtherConsIds_46 == (MR_Word) ((MR_Unsigned) 0U)))
      {
        ...
        if (succeeded)
        {
          ...
          else
          {
            ...
            hlds__goal_list_util__goal_to_conj_list_2_p_0(SingleGoal_47, &SingleGoalConj_56);
            {
            ...
            hlds__goal_list_util__goal_list_purity_2_p_0(GoalList_57, &Purity_64);
  ...
  MR_Box * wrapper_arg_2)
{
  ...
  check_hlds__simplify__simplify_goal_switch__IntroducedFrom__pred__create_test_unification__340__1_2_p_0(((MR_Word) (wrapper_arg_1)), &conv0_LambdaHeadVar__2_38);
