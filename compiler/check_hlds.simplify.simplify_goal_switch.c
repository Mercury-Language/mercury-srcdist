...
static void MR_CALL 
check_hlds__simplify__simplify_goal_switch__IntroducedFrom__pred__create_test_unification__338__1_2_p_0(
  ...
  MR_Box * wrapper_arg_2)
{
  ...
  check_hlds__simplify__simplify_goal_switch__IntroducedFrom__pred__create_test_unification__338__1_2_p_0(((MR_Word) (wrapper_arg_1)), &conv0_LambdaHeadVar__2_38);
  ...
  MR_Word * STATE_VARIABLE_Info_35)
{
  ...
  check_hlds__inst_lookup__inst_expand_3_p_0(ModuleInfo_15, Inst0_20, &Inst1_21);
