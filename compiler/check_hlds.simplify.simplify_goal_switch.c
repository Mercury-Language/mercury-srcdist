...
{
  {
    ...
    {
      check_hlds__simplify__simplify_goal_switch__IntroducedFrom__pred__create_test_unification__289__1_2_p_0(((MR_Word) check_hlds__simplify__simplify_goal_switch__wrapper_arg_1), &check_hlds__simplify__simplify_goal_switch__conv0_LambdaHeadVar__2_45);
    }
    ...
    if (check_hlds__simplify__simplify_goal_switch__succeeded)
      {
        ...
        {
          check_hlds__simplify__simplify_goal_switch__SubGoalCalledProcs_35 = hlds__goal_util__goals_callees_1_f_0(check_hlds__simplify__simplify_goal_switch__UnreachableCaseGoals_32);
        }
        {
