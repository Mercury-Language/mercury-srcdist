  ...
  MR_Word * STATE_VARIABLE_Info_72)
{
  ...
  if ((Cases_41 == (MR_Word) ((MR_Unsigned) 0U)))
  {
    ...
    Var_99 = transform_hlds__pd_cost__cost_of_eliminate_switch_0_f_0();
    check_hlds__simplify__simplify_info__simplify_info_incr_cost_delta_3_p_0(Var_99, STATE_VARIABLE_Info_77_77, &STATE_VARIABLE_Info_100_100);
    Context_42 = hlds__hlds_goal__goal_info_get_context_1_f_0(GoalInfo0_13);
    Var_101 = hlds__make_goal__fail_goal_with_context_1_f_0(Context_42);
    *GoalExpr_12 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_101, (MR_Integer) 0))));
    *GoalInfo_14 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_101, (MR_Integer) 1))));
  }
  else
  {
    ...
    if ((Var_133 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      ...
      if ((Var_136 == (MR_Word) ((MR_Unsigned) 0U)))
      {
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            Var_88 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MaybeInstConsIds_33, (MR_Integer) 0))));
            succeeded = (Var_88 != (MR_Word) ((MR_Unsigned) 0U));
            if (succeeded)
            {
              Var_113 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Var_88, (MR_Integer) 0))));
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            ...
            NonLocals_48 = hlds__hlds_goal__goal_info_get_nonlocals_1_f_0(GoalInfo0_13);
            {
              ...
              MR_hl_field(MR_mktag(1), Var_90, 0) = ((MR_Box) (VarTable_25));
            }
            hlds__instmap__merge_instmap_deltas_7_p_0(Var_90, NonLocals_48, InstMap0_16, RevInstMapDeltas_38, &NewDelta_49, ModuleInfo1_47, &ModuleInfo2_50);
            check_hlds__simplify__simplify_info__simplify_info_set_module_info_3_p_0(ModuleInfo2_50, STATE_VARIABLE_Info_77_77, &STATE_VARIABLE_Info_91_91);
          ...
          else
          {
            ...
            check_hlds__simplify__simplify_goal_switch__create_test_unification_7_p_0(Var_20, Var_137, MainConsIdArity_45, &UnifyGoal_51, InstMap0_16, STATE_VARIABLE_Info_77_77, &STATE_VARIABLE_Info_92_92);
            ...
            check_hlds__simplify__simplify_info__simplify_info_set_module_info_3_p_0(ModuleInfo_57, STATE_VARIABLE_Info_92_92, &STATE_VARIABLE_Info_93_93);
            ...
            check_hlds__simplify__simplify_info__simplify_info_set_rerun_quant_instmap_delta_2_p_0(STATE_VARIABLE_Info_93_93, &STATE_VARIABLE_Info_91_91);
            {
              MR_Word base;
        ...
        else
        {
          ...
          *GoalInfo_14 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_135, (MR_Integer) 1))));
          STATE_VARIABLE_Info_91_91 = STATE_VARIABLE_Info_77_77;
        }
        Var_97 = transform_hlds__pd_cost__cost_of_eliminate_switch_0_f_0();
        check_hlds__simplify__simplify_info__simplify_info_incr_cost_delta_3_p_0(Var_97, STATE_VARIABLE_Info_91_91, &STATE_VARIABLE_Info_100_100);
      }
      else
      {
        {
        ...
        if (succeeded)
        {
          *GoalInfo_14 = GoalInfo0_13;
          STATE_VARIABLE_Info_100_100 = STATE_VARIABLE_Info_77_77;
        }
        else
        {
          MR_Word Var_83;
          ...
          NonLocals_106 = hlds__hlds_goal__goal_info_get_nonlocals_1_f_0(GoalInfo0_13);
          {
            ...
            MR_hl_field(MR_mktag(1), Var_83, 0) = ((MR_Box) (VarTable_25));
          }
          hlds__instmap__merge_instmap_deltas_7_p_0(Var_83, NonLocals_106, InstMap0_16, RevInstMapDeltas_38, &NewDelta_107, ModuleInfo1_105, &ModuleInfo2_108);
          check_hlds__simplify__simplify_info__simplify_info_set_module_info_3_p_0(ModuleInfo2_108, STATE_VARIABLE_Info_77_77, &STATE_VARIABLE_Info_100_100);
    ...
    else
    {
      ...
      else
      {
        ...
        check_hlds__simplify__simplify_info__simplify_info_set_module_info_3_p_0(ModuleInfo2_120, STATE_VARIABLE_Info_77_77, &STATE_VARIABLE_Info_100_100);
  ...
  *Common_18 = Common0_17;
  ...
  if (succeeded)
    *STATE_VARIABLE_Info_72 = STATE_VARIABLE_Info_100_100;
  else
  {
    MR_Word STATE_VARIABLE_Info_102_102;

    check_hlds__simplify__simplify_info__simplify_info_set_rerun_quant_instmap_delta_2_p_0(STATE_VARIABLE_Info_100_100, &STATE_VARIABLE_Info_102_102);
