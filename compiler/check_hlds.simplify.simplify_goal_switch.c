    ...
    else
    {
      ...
      if ((Var_136 == (MR_Word) ((MR_Integer) 0)))
      {
        ...
        if ((Var_139 == (MR_Word) ((MR_Integer) 0)))
        {
          ...
          if (succeeded)
          {
            succeeded = ((MR_tag((MR_Word) MaybeInstConsIds_33)) == (MR_Integer) 1);
            if (succeeded)
            {
  ...
  MR_Word * STATE_VARIABLE_Info_15)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      succeeded = ((((MR_tag((MR_Word) Var_79)) == (MR_Integer) 3)) && ((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), Var_79, (MR_Integer) 0))) == (MR_Integer) 3)));
      if (succeeded)
      {
      ...
      else
      {
        ...
        succeeded = ((((MR_tag((MR_Word) GoalExpr_58)) == (MR_Integer) 3)) && ((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), GoalExpr_58, (MR_Integer) 0))) == (MR_Integer) 5)));
        if (succeeded)
        {
