...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(0), Var_47, 0) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
...
{
  {
    ...
    mercury__varset__new_vars_4_p_0(TypeCtorInfo_63_63, ConsArity_10, &ArgVars_16, VarSet0_14, &VarSet_17);
    ...
    NonLocals_34 = parse_tree__set_of_var__make_singleton_1_f_0(TypeCtorInfo_63_63, Var_8);
