  ...
  MR_Word * STATE_VARIABLE_Info_72)
{
  ...
  {
    MR_Word Var_128 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Cases_41, (MR_Integer) 1))));
    MR_Word Var_129 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Cases_41, (MR_Integer) 0))));

    if ((Var_128 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      MR_Word Var_130 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_129, (MR_Integer) 2))));
      MR_Word Var_131 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_129, (MR_Integer) 1))));
      MR_Word Var_132 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_129, (MR_Integer) 0))));
      ...
      if ((Var_131 == (MR_Word) ((MR_Unsigned) 0U)))
      {
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              Var_111 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Var_84, (MR_Integer) 0))));
        ...
        {
          *GoalExpr_12 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_130, (MR_Integer) 0))));
          *GoalInfo_14 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_130, (MR_Integer) 1))));
  ...
  MR_Box * wrapper_arg_2)
{
  ...
  check_hlds__simplify__simplify_goal_switch__IntroducedFrom__pred__create_test_unification__274__1_3_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) (wrapper_arg_1)), &conv0_LambdaHeadVar__2_42);
