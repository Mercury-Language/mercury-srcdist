...
static void MR_CALL 
check_hlds__simplify__simplify_goal_switch__IntroducedFrom__pred__create_test_unification__292__1_2_p_0(
  MR_Word LambdaHeadVar__1_48,
  MR_Word * LambdaHeadVar__2_49);

static void MR_CALL 
check_hlds__simplify__simplify_goal_switch__IntroducedFrom__pred__create_test_unification__276__1_3_p_0(
...
{
  {
    ...
    *LambdaHeadVar__2_49 = base;
    MR_hl_field(MR_mktag(0), base, 0) = ((MR_Box) (LambdaHeadVar__1_48));
    MR_hl_field(MR_mktag(0), base, 1) = ((MR_Box) (LambdaHeadVar__1_48));
    MR_hl_field(MR_mktag(0), base, 2) = ((MR_Box) ((MR_Unsigned) 0U));
    MR_hl_field(MR_mktag(0), base, 3) = ((MR_Box) (LambdaHeadVar__1_48));
  }
}
  ...
  MR_Word * LambdaHeadVar__2_42)
{
  ...
  IsDummy_65 = check_hlds__type_util__is_type_a_dummy_2_f_0(ModuleInfo_15, LambdaHeadVar__1_41);
  {
    ...
    *LambdaHeadVar__2_42 = base;
    MR_hl_field(MR_mktag(0), base, 0) = ((MR_Box) ((MR_String) ""));
    MR_hl_field(MR_mktag(0), base, 1) = ((MR_Box) (LambdaHeadVar__1_41));
    MR_hl_field(MR_mktag(0), base, 2) = (MR_Box) ((MR_Unsigned) (IsDummy_65));
  }
}
  ...
  MR_Word * STATE_VARIABLE_Info_72)
{
  ...
  check_hlds__simplify__simplify_info__simplify_info_get_var_table_2_p_0(STATE_VARIABLE_Info_0_71, &VarTable_25);
  ...
  if ((Cases_41 == (MR_Word) ((MR_Unsigned) 0U)))
  {
    ...
    Var_78 = transform_hlds__pd_cost__cost_of_eliminate_switch_0_f_0();
    check_hlds__simplify__simplify_info__simplify_info_incr_cost_delta_3_p_0(Var_78, STATE_VARIABLE_Info_77_77, &STATE_VARIABLE_Info_79_79);
    Context_42 = hlds__hlds_goal__goal_info_get_context_1_f_0(GoalInfo0_13);
    Var_80 = hlds__make_goal__fail_goal_with_context_1_f_0(Context_42);
    *GoalExpr_12 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_80, (MR_Integer) 0))));
    *GoalInfo_14 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_80, (MR_Integer) 1))));
  }
  else
  {
    MR_Word Var_133 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Cases_41, (MR_Integer) 1))));
    MR_Word Var_134 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Cases_41, (MR_Integer) 0))));

    if ((Var_133 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      MR_Word Var_135 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_134, (MR_Integer) 2))));
      MR_Word Var_136 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_134, (MR_Integer) 1))));
      MR_Word Var_137 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_134, (MR_Integer) 0))));
      ...
      if ((Var_136 == (MR_Word) ((MR_Unsigned) 0U)))
      {
        ...
        MainConsIdArity_45 = parse_tree__prog_util__cons_id_arity_1_f_0(Var_137);
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            Var_84 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MaybeInstConsIds_33, (MR_Integer) 0))));
            succeeded = (Var_84 != (MR_Word) ((MR_Unsigned) 0U));
            if (succeeded)
            {
              Var_113 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Var_84, (MR_Integer) 0))));
              Var_85 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Var_84, (MR_Integer) 1))));
              succeeded = parse_tree__prog_data____Unify____cons_id_0_0(Var_137, Var_113);
              if (succeeded)
        ...
        if (succeeded)
        {
          ...
          parse_tree__var_table__lookup_var_type_3_p_0(VarTable_25, Var_20, &Type_46);
          check_hlds__simplify__simplify_info__simplify_info_get_module_info_2_p_0(STATE_VARIABLE_Info_77_77, &ModuleInfo1_47);
          succeeded = check_hlds__type_util__cons_id_is_existq_cons_3_p_0(ModuleInfo1_47, Type_46, Var_137);
          if (succeeded)
          {
            ...
            NonLocals_48 = hlds__hlds_goal__goal_info_get_nonlocals_1_f_0(GoalInfo0_13);
            {
              ...
              MR_hl_field(MR_mktag(1), Var_86, 0) = ((MR_Box) (VarTable_25));
            }
            hlds__instmap__merge_instmap_deltas_7_p_0(Var_86, NonLocals_48, InstMap0_16, RevInstMapDeltas_38, &NewDelta_49, ModuleInfo1_47, &ModuleInfo2_50);
            check_hlds__simplify__simplify_info__simplify_info_set_module_info_3_p_0(ModuleInfo2_50, STATE_VARIABLE_Info_77_77, &STATE_VARIABLE_Info_87_87);
          ...
          else
          {
            ...
            check_hlds__simplify__simplify_goal_switch__create_test_unification_7_p_0(Var_20, Var_137, MainConsIdArity_45, &UnifyGoal_51, InstMap0_16, STATE_VARIABLE_Info_77_77, &STATE_VARIABLE_Info_88_88);
            hlds__hlds_goal__goal_to_conj_list_2_p_0(Var_135, &SingleGoalConj_52);
            {
            ...
            parse_tree__set_of_var__insert_3_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), Var_20, NonLocals0_54, &NonLocals_104);
            InstMapDelta0_55 = hlds__hlds_goal__goal_info_get_instmap_delta_1_f_0(GoalInfo0_13);
            hlds__instmap__instmap_delta_bind_var_to_functor_8_p_0(Var_20, Type_46, Var_137, InstMap0_16, InstMapDelta0_55, &InstMapDelta_56, ModuleInfo1_47, &ModuleInfo_57);
            check_hlds__simplify__simplify_info__simplify_info_set_module_info_3_p_0(ModuleInfo_57, STATE_VARIABLE_Info_88_88, &STATE_VARIABLE_Info_89_89);
            ...
            hlds__hlds_goal__goal_info_init_5_p_0(NonLocals_104, InstMapDelta_56, Detism_59, Purity_60, GoalInfo_14);
            check_hlds__simplify__simplify_info__simplify_info_set_rerun_quant_instmap_delta_2_p_0(STATE_VARIABLE_Info_89_89, &STATE_VARIABLE_Info_87_87);
            {
              MR_Word base;
        ...
        {
          *GoalExpr_12 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_135, (MR_Integer) 0))));
          *GoalInfo_14 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_135, (MR_Integer) 1))));
          STATE_VARIABLE_Info_87_87 = STATE_VARIABLE_Info_77_77;
        }
        Var_93 = transform_hlds__pd_cost__cost_of_eliminate_switch_0_f_0();
        check_hlds__simplify__simplify_info__simplify_info_incr_cost_delta_3_p_0(Var_93, STATE_VARIABLE_Info_87_87, &STATE_VARIABLE_Info_79_79);
      }
      else
      {
        {
        ...
        if (succeeded)
        {
          *GoalInfo_14 = GoalInfo0_13;
          STATE_VARIABLE_Info_79_79 = STATE_VARIABLE_Info_77_77;
        }
        else
        {
          MR_Word Var_100;
          ...
          MR_Word NewDelta_107;
          MR_Word ModuleInfo2_108;

          check_hlds__simplify__simplify_info__simplify_info_get_module_info_2_p_0(STATE_VARIABLE_Info_77_77, &ModuleInfo1_105);
          NonLocals_106 = hlds__hlds_goal__goal_info_get_nonlocals_1_f_0(GoalInfo0_13);
          {
            Var_100 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), Var_100, 0) = ((MR_Box) (VarTable_25));
          }
          hlds__instmap__merge_instmap_deltas_7_p_0(Var_100, NonLocals_106, InstMap0_16, RevInstMapDeltas_38, &NewDelta_107, ModuleInfo1_105, &ModuleInfo2_108);
          check_hlds__simplify__simplify_info__simplify_info_set_module_info_3_p_0(ModuleInfo2_108, STATE_VARIABLE_Info_77_77, &STATE_VARIABLE_Info_79_79);
          hlds__hlds_goal__goal_info_set_instmap_delta_3_p_0(NewDelta_107, GoalInfo0_13, GoalInfo_14);
        }
      }
    }
    else
    {
      ...
      {
        MR_Word Var_116;
        MR_Word ModuleInfo1_117;
        MR_Word NonLocals_118;
        MR_Word NewDelta_119;
        MR_Word ModuleInfo2_120;

        check_hlds__simplify__simplify_info__simplify_info_get_module_info_2_p_0(STATE_VARIABLE_Info_77_77, &ModuleInfo1_117);
        NonLocals_118 = hlds__hlds_goal__goal_info_get_nonlocals_1_f_0(GoalInfo0_13);
        {
          Var_116 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), Var_116, 0) = ((MR_Box) (VarTable_25));
        }
        hlds__instmap__merge_instmap_deltas_7_p_0(Var_116, NonLocals_118, InstMap0_16, RevInstMapDeltas_38, &NewDelta_119, ModuleInfo1_117, &ModuleInfo2_120);
        check_hlds__simplify__simplify_info__simplify_info_set_module_info_3_p_0(ModuleInfo2_120, STATE_VARIABLE_Info_77_77, &STATE_VARIABLE_Info_79_79);
        hlds__hlds_goal__goal_info_set_instmap_delta_3_p_0(NewDelta_119, GoalInfo0_13, GoalInfo_14);
      }
    }
  }
  *Common_18 = Common0_17;
  ...
  if (succeeded)
    *STATE_VARIABLE_Info_72 = STATE_VARIABLE_Info_79_79;
  else
  {
    MR_Word STATE_VARIABLE_Info_102_102;

    check_hlds__simplify__simplify_info__simplify_info_set_rerun_quant_instmap_delta_2_p_0(STATE_VARIABLE_Info_79_79, &STATE_VARIABLE_Info_102_102);
    check_hlds__simplify__simplify_info__simplify_info_set_rerun_det_2_p_0(STATE_VARIABLE_Info_102_102, STATE_VARIABLE_Info_72);
  }
}
  ...
  MR_Box * wrapper_arg_2)
{
  ...
  check_hlds__simplify__simplify_goal_switch__IntroducedFrom__pred__create_test_unification__292__1_2_p_0(((MR_Word) (wrapper_arg_1)), &conv4_LambdaHeadVar__2_49);
  ...
  MR_Box * wrapper_arg_2)
{
  ...
  check_hlds__simplify__simplify_goal_switch__IntroducedFrom__pred__create_test_unification__276__1_3_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) (wrapper_arg_1)), &conv0_LambdaHeadVar__2_42);
  ...
  MR_Word * STATE_VARIABLE_Info_40)
{
  ...
  check_hlds__type_util__get_cons_id_arg_types_4_p_0(ModuleInfo_15, VarType_16, ConsId_9, &ArgTypes_17);
  {
    ...
    MR_hl_field(MR_mktag(0), MakeArgEntry_18, 0) = ((MR_Box) (&check_hlds__simplify__simplify_goal_switch_scalar_common_2[0]));
    MR_hl_field(MR_mktag(0), MakeArgEntry_18, 1) = ((MR_Box) (check_hlds__simplify__simplify_goal_switch__create_test_unification_7_p_0_1));
    MR_hl_field(MR_mktag(0), MakeArgEntry_18, 2) = ((MR_Box) ((MR_Integer) 1));
    MR_hl_field(MR_mktag(0), MakeArgEntry_18, 3) = ((MR_Box) (ModuleInfo_15));
  }
  ...
  mercury__list__map_3_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_inst_0), (MR_Word) (&hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_unify_mode_0), (MR_Word) (&check_hlds__simplify__simplify_goal_switch_scalar_common_4[1]), ArgInsts_27, &ArgUnifyModes_31);
  {
    ...
    MR_hl_field(MR_mktag(0), UnifyMode_32, 0) = ((MR_Box) (Inst0_24));
    MR_hl_field(MR_mktag(0), UnifyMode_32, 1) = ((MR_Box) (Inst0_24));
    MR_hl_field(MR_mktag(0), UnifyMode_32, 2) = ((MR_Box) (Inst0_24));
    MR_hl_field(MR_mktag(0), UnifyMode_32, 3) = ((MR_Box) (Inst0_24));
  }
  {
    Unification_34 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(MR_mktag(1), Unification_34, 0) = ((MR_Box) (Var_8));
    MR_hl_field(MR_mktag(1), Unification_34, 1) = ((MR_Box) (ConsId_9));
    MR_hl_field(MR_mktag(1), Unification_34, 2) = ((MR_Box) (ArgVars_22));
    MR_hl_field(MR_mktag(1), Unification_34, 3) = ((MR_Box) (ArgUnifyModes_31));
    MR_hl_field(MR_mktag(1), Unification_34, 4) = (MR_Box) (((((MR_Unsigned) ((MR_Integer) 0) << 1)) | (MR_Unsigned) ((MR_Integer) 1)));
  }
  {
    Var_60 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(MR_mktag(1), Var_60, 0) = ((MR_Box) (ConsId_9));
    MR_hl_field(MR_mktag(1), Var_60, 1) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 0));
    MR_hl_field(MR_mktag(1), Var_60, 2) = ((MR_Box) (ArgVars_22));
  }
  {
    ExtraGoalExpr_35 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(MR_mktag(1), ExtraGoalExpr_35, 0) = ((MR_Box) (Var_8));
    MR_hl_field(MR_mktag(1), ExtraGoalExpr_35, 1) = ((MR_Box) (Var_60));
    MR_hl_field(MR_mktag(1), ExtraGoalExpr_35, 2) = ((MR_Box) (UnifyMode_32));
    MR_hl_field(MR_mktag(1), ExtraGoalExpr_35, 3) = ((MR_Box) (Unification_34));
    MR_hl_field(MR_mktag(1), ExtraGoalExpr_35, 4) = ((MR_Box) (&check_hlds__simplify__simplify_goal_switch_scalar_common_1[1]));
  }
  ...
  hlds__hlds_goal__goal_info_init_5_p_0(NonLocals_36, InstMapDelta_37, (MR_Integer) 1, (MR_Integer) 0, &ExtraGoalInfo_38);
  {
    ...
    *ExtraGoal_11 = base;
    MR_hl_field(MR_mktag(0), base, 0) = ((MR_Box) (ExtraGoalExpr_35));
    MR_hl_field(MR_mktag(0), base, 1) = ((MR_Box) (ExtraGoalInfo_38));
  }
}
