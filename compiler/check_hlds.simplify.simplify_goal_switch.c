    ...
    if ((check_hlds__simplify__simplify_goal_switch__Cases_41 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
      {
        ...
        MR_Integer check_hlds__simplify__simplify_goal_switch__V_97_97;
        MR_Word check_hlds__simplify__simplify_goal_switch__V_99_99;

        {
          check_hlds__simplify__simplify_goal_switch__V_97_97 = transform_hlds__pd_cost__cost_of_eliminate_switch_0_f_0();
        }
        {
          check_hlds__simplify__simplify_info__simplify_info_incr_cost_delta_3_p_0(check_hlds__simplify__simplify_goal_switch__V_97_97, check_hlds__simplify__simplify_goal_switch__STATE_VARIABLE_Info_77_77, &check_hlds__simplify__simplify_goal_switch__STATE_VARIABLE_Info_98_98);
        }
        {
        ...
        {
          check_hlds__simplify__simplify_goal_switch__V_99_99 = hlds__make_goal__fail_goal_with_context_1_f_0(check_hlds__simplify__simplify_goal_switch__Context_42);
        }
        *check_hlds__simplify__simplify_goal_switch__GoalExpr_12 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__simplify__simplify_goal_switch__V_99_99, (MR_Integer) 0)));
        *check_hlds__simplify__simplify_goal_switch__GoalInfo_14 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__simplify__simplify_goal_switch__V_99_99, (MR_Integer) 1)));
      }
    else
      {
        MR_Word check_hlds__simplify__simplify_goal_switch__V_136_136 = ((MR_Word) (MR_hl_field(MR_mktag(1), check_hlds__simplify__simplify_goal_switch__Cases_41, (MR_Integer) 1)));
        MR_Word check_hlds__simplify__simplify_goal_switch__V_137_137 = ((MR_Word) (MR_hl_field(MR_mktag(1), check_hlds__simplify__simplify_goal_switch__Cases_41, (MR_Integer) 0)));

        if ((check_hlds__simplify__simplify_goal_switch__V_136_136 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
          {
            MR_Word check_hlds__simplify__simplify_goal_switch__V_138_138 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__simplify__simplify_goal_switch__V_137_137, (MR_Integer) 2)));
            MR_Word check_hlds__simplify__simplify_goal_switch__V_139_139 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__simplify__simplify_goal_switch__V_137_137, (MR_Integer) 1)));
            MR_Word check_hlds__simplify__simplify_goal_switch__V_140_140 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__simplify__simplify_goal_switch__V_137_137, (MR_Integer) 0)));

            if ((check_hlds__simplify__simplify_goal_switch__V_139_139 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
              {
                ...
                MR_Integer check_hlds__simplify__simplify_goal_switch__V_95_95;
                MR_Word check_hlds__simplify__simplify_goal_switch__V_87_87;
                MR_Word check_hlds__simplify__simplify_goal_switch__V_88_88;
                MR_Word check_hlds__simplify__simplify_goal_switch__V_119_119;

                {
                  check_hlds__simplify__simplify_goal_switch__MainConsIdArity_45 = parse_tree__prog_util__cons_id_arity_1_f_0(check_hlds__simplify__simplify_goal_switch__V_140_140);
                }
                ...
                if (check_hlds__simplify__simplify_goal_switch__succeeded)
                  {
                    ...
                    if (check_hlds__simplify__simplify_goal_switch__succeeded)
                      {
                        check_hlds__simplify__simplify_goal_switch__V_87_87 = ((MR_Word) (MR_hl_field(MR_mktag(1), check_hlds__simplify__simplify_goal_switch__MaybeInstConsIds_33, (MR_Integer) 0)));
                        check_hlds__simplify__simplify_goal_switch__succeeded = ((MR_tag((MR_Word) check_hlds__simplify__simplify_goal_switch__V_87_87)) == (MR_mktag((MR_Integer) 1)));
                        if (check_hlds__simplify__simplify_goal_switch__succeeded)
                          {
                            check_hlds__simplify__simplify_goal_switch__V_119_119 = ((MR_Word) (MR_hl_field(MR_mktag(1), check_hlds__simplify__simplify_goal_switch__V_87_87, (MR_Integer) 0)));
                            check_hlds__simplify__simplify_goal_switch__V_88_88 = ((MR_Word) (MR_hl_field(MR_mktag(1), check_hlds__simplify__simplify_goal_switch__V_87_87, (MR_Integer) 1)));
                            {
                              check_hlds__simplify__simplify_goal_switch__succeeded = parse_tree__prog_data____Unify____cons_id_0_0(check_hlds__simplify__simplify_goal_switch__V_140_140, check_hlds__simplify__simplify_goal_switch__V_119_119);
                            }
                            if (check_hlds__simplify__simplify_goal_switch__succeeded)
                              check_hlds__simplify__simplify_goal_switch__succeeded = (check_hlds__simplify__simplify_goal_switch__V_88_88 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
                          }
                      }
                ...
                if (check_hlds__simplify__simplify_goal_switch__succeeded)
                  {
                    ...
                    {
                      check_hlds__simplify__simplify_goal_switch__succeeded = check_hlds__type_util__cons_id_is_existq_cons_3_p_0(check_hlds__simplify__simplify_goal_switch__ModuleInfo1_47, check_hlds__simplify__simplify_goal_switch__Type_46, check_hlds__simplify__simplify_goal_switch__V_140_140);
                    }
                    if (check_hlds__simplify__simplify_goal_switch__succeeded)
                      {
                    ...
                    else
                      {
                        ...
                        {
                          hlds__instmap__instmap_delta_bind_var_to_functor_8_p_0(check_hlds__simplify__simplify_goal_switch__Var_20, check_hlds__simplify__simplify_goal_switch__Type_46, check_hlds__simplify__simplify_goal_switch__V_140_140, check_hlds__simplify__simplify_goal_switch__InstMap0_16, check_hlds__simplify__simplify_goal_switch__InstMapDelta0_55, &check_hlds__simplify__simplify_goal_switch__InstMapDelta_56, check_hlds__simplify__simplify_goal_switch__ModuleInfo1_47, &check_hlds__simplify__simplify_goal_switch__ModuleInfo_57);
                        }
                        {
                  ...
                  {
                    *check_hlds__simplify__simplify_goal_switch__GoalExpr_12 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__simplify__simplify_goal_switch__V_138_138, (MR_Integer) 0)));
                    *check_hlds__simplify__simplify_goal_switch__GoalInfo_14 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__simplify__simplify_goal_switch__V_138_138, (MR_Integer) 1)));
                ...
                {
                  check_hlds__simplify__simplify_goal_switch__V_95_95 = transform_hlds__pd_cost__cost_of_eliminate_switch_0_f_0();
                }
                {
                  check_hlds__simplify__simplify_info__simplify_info_incr_cost_delta_3_p_0(check_hlds__simplify__simplify_goal_switch__V_95_95, check_hlds__simplify__simplify_goal_switch__STATE_VARIABLE_Info_89_89, &check_hlds__simplify__simplify_goal_switch__STATE_VARIABLE_Info_98_98);
                }
              }
            else
              {
