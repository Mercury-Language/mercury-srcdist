...
static /* final */ const MR_Box check_hlds__simplify__simplify_goal_switch_scalar_common_1[1][2];
...
{
  {
    ...
    *LambdaHeadVar__2_44 = base;
    MR_hl_field(MR_mktag(0), base, 0) = ((MR_Box) (LambdaHeadVar__1_43));
    MR_hl_field(MR_mktag(0), base, 1) = ((MR_Box) (LambdaHeadVar__1_43));
    MR_hl_field(MR_mktag(0), base, 2) = ((MR_Box) ((MR_Unsigned) 0U));
    MR_hl_field(MR_mktag(0), base, 3) = ((MR_Box) (LambdaHeadVar__1_43));
  }
}
  ...
  MR_Word * STATE_VARIABLE_Info_72)
{
  ...
  if (succeeded)
  {
    ...
    parse_tree__vartypes__lookup_var_type_3_p_0(VarTypes_25, Var_20, &VarType_27);
    ...
    if ((Var_141 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      ...
      if ((Var_144 == (MR_Word) ((MR_Unsigned) 0U)))
      {
        ...
        if (succeeded)
        {
          ...
          parse_tree__vartypes__lookup_var_type_3_p_0(VarTypes_25, Var_20, &Type_46);
          ...
          if (succeeded)
          {
            ...
            NonLocals_48 = hlds__hlds_goal__goal_info_get_nonlocals_1_f_0(GoalInfo0_13);
            {
              ...
              MR_hl_field(MR_mktag(0), Var_90, 0) = ((MR_Box) (VarTypes_25));
            }
      ...
      else
      {
        ...
        else
        {
          ...
          NonLocals_106 = hlds__hlds_goal__goal_info_get_nonlocals_1_f_0(GoalInfo0_13);
          {
            ...
            MR_hl_field(MR_mktag(0), Var_83, 0) = ((MR_Box) (VarTypes_25));
          }
    ...
    else
    {
      ...
      else
      {
        ...
        NonLocals_126 = hlds__hlds_goal__goal_info_get_nonlocals_1_f_0(GoalInfo0_13);
        {
          ...
          MR_hl_field(MR_mktag(0), Var_124, 0) = ((MR_Box) (VarTypes_25));
        }
  ...
  MR_Box * wrapper_arg_2)
{
  ...
  check_hlds__simplify__simplify_goal_switch__IntroducedFrom__pred__create_test_unification__292__1_2_p_0(((MR_Word) (wrapper_arg_1)), &conv0_LambdaHeadVar__2_44);
  ...
  MR_Word * STATE_VARIABLE_Info_38)
{
  ...
  parse_tree__vartypes__lookup_var_type_3_p_0(VarTypes0_15, Var_8, &VarType_18);
  ...
  parse_tree__vartypes__vartypes_add_corresponding_lists_4_p_0(ArgVars_16, ArgTypes_20, VarTypes0_15, &VarTypes_21);
  ...
  check_hlds__inst_lookup__inst_expand_3_p_0(ModuleInfo_19, Inst0_22, &Inst1_23);
  ...
  mercury__list__map_3_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_inst_0), (MR_Word) (&hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_unify_mode_0), (MR_Word) (&check_hlds__simplify__simplify_goal_switch_scalar_common_3[0]), ArgInsts_25, &ArgUnifyModes_29);
  {
    UnifyMode_30 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(MR_mktag(0), UnifyMode_30, 0) = ((MR_Box) (Inst0_22));
    MR_hl_field(MR_mktag(0), UnifyMode_30, 1) = ((MR_Box) (Inst0_22));
    MR_hl_field(MR_mktag(0), UnifyMode_30, 2) = ((MR_Box) (Inst0_22));
    MR_hl_field(MR_mktag(0), UnifyMode_30, 3) = ((MR_Box) (Inst0_22));
  }
  {
  ...
  {
    Var_55 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(MR_mktag(1), Var_55, 0) = ((MR_Box) (ConsId_9));
    MR_hl_field(MR_mktag(1), Var_55, 1) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 0));
    MR_hl_field(MR_mktag(1), Var_55, 2) = ((MR_Box) (ArgVars_16));
  }
  {
    ...
    MR_hl_field(MR_mktag(1), ExtraGoalExpr_33, 1) = ((MR_Box) (Var_55));
    ...
    MR_hl_field(MR_mktag(1), ExtraGoalExpr_33, 4) = ((MR_Box) (&check_hlds__simplify__simplify_goal_switch_scalar_common_1[0]));
  }
  ...
  MR_Word * STATE_VARIABLE_Info_15)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      parse_tree__vartypes__lookup_var_type_3_p_0(VarTypes_50, Var_1, &Type_51);
