  ...
  MR_Word * STATE_VARIABLE_Info_72)
{
  ...
  {
    MR_Word Var_141 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Cases_41, (MR_Integer) 1))));
    MR_Word Var_142 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Cases_41, (MR_Integer) 0))));

    if ((Var_141 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      MR_Word Var_143 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_142, (MR_Integer) 2))));
      MR_Word Var_144 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_142, (MR_Integer) 1))));
      MR_Word Var_145 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_142, (MR_Integer) 0))));
      ...
      if ((Var_144 == (MR_Word) ((MR_Unsigned) 0U)))
      {
        ...
        MainConsIdArity_45 = parse_tree__prog_util__cons_id_arity_1_f_0(Var_145);
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              Var_121 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Var_84, (MR_Integer) 0))));
              Var_85 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Var_84, (MR_Integer) 1))));
              succeeded = parse_tree__prog_data____Unify____cons_id_0_0(Var_145, Var_121);
              if (succeeded)
        ...
        if (succeeded)
        {
          ...
          succeeded = check_hlds__type_util__cons_id_is_existq_cons_3_p_0(ModuleInfo1_47, Type_46, Var_145);
          if (succeeded)
          {
          ...
          else
          {
            ...
            check_hlds__simplify__simplify_goal_switch__create_test_unification_7_p_0(Var_20, Var_145, MainConsIdArity_45, &UnifyGoal_51, InstMap0_16, STATE_VARIABLE_Info_77_77, &STATE_VARIABLE_Info_88_88);
            hlds__hlds_goal__goal_to_conj_list_2_p_0(Var_143, &SingleGoalConj_52);
            {
            ...
            hlds__instmap__instmap_delta_bind_var_to_functor_8_p_0(Var_20, Type_46, Var_145, InstMap0_16, InstMapDelta0_55, &InstMapDelta_56, ModuleInfo1_47, &ModuleInfo_57);
        ...
        {
          *GoalExpr_12 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_143, (MR_Integer) 0))));
          *GoalInfo_14 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_143, (MR_Integer) 1))));
    ...
    else
    {
      ...
      {
        MR_Word Var_124;
        MR_Word ModuleInfo1_125;
        MR_Word NonLocals_126;
        MR_Word NewDelta_127;
        MR_Word ModuleInfo2_128;

        check_hlds__simplify__simplify_info__simplify_info_get_module_info_2_p_0(STATE_VARIABLE_Info_77_77, &ModuleInfo1_125);
        NonLocals_126 = hlds__hlds_goal__goal_info_get_nonlocals_1_f_0(GoalInfo0_13);
        {
          Var_124 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), Var_124, 0) = ((MR_Box) (VarTable_25));
        }
        hlds__instmap__merge_instmap_deltas_7_p_0(Var_124, NonLocals_126, InstMap0_16, RevInstMapDeltas_38, &NewDelta_127, ModuleInfo1_125, &ModuleInfo2_128);
        check_hlds__simplify__simplify_info__simplify_info_set_module_info_3_p_0(ModuleInfo2_128, STATE_VARIABLE_Info_77_77, &STATE_VARIABLE_Info_79_79);
        hlds__hlds_goal__goal_info_set_instmap_delta_3_p_0(NewDelta_127, GoalInfo0_13, GoalInfo_14);
      }
    }
  }
