...
MR_decl_label3(__Unify___transform_hlds__term_norm__functor_info_0_0, 8,4,1)
MR_decl_label1(__Unify___transform_hlds__term_norm__weight_info_0_0, 1)
MR_decl_label7(__Compare___transform_hlds__term_norm__functor_info_0_0, 34,18,11,4,43,9,7)
MR_decl_label2(__Compare___transform_hlds__term_norm__weight_info_0_0, 3,7)
...
MR_BEGIN_MODULE(transform_hlds__term_norm_module9)
	...
	MR_init_label3(__Unify___transform_hlds__term_norm__functor_info_0_0,8,4,1)
MR_BEGIN_CODE
...
MR_define_entry(mercury____Unify___transform_hlds__term_norm__functor_info_0_0);
	...
	if (MR_PTAG_TEST(MR_r1,1)) {
		MR_GOTO_LAB(__Unify___transform_hlds__term_norm__functor_info_0_0_i4);
	}
	if (MR_PTAG_TEST(MR_r1,2)) {
		MR_GOTO_LAB(__Unify___transform_hlds__term_norm__functor_info_0_0_i8);
	}
	MR_r1 = (MR_r2 == MR_r1);
	MR_proceed();
MR_def_label(__Unify___transform_hlds__term_norm__functor_info_0_0,8)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_def_label(__Unify___transform_hlds__term_norm__functor_info_0_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_BEGIN_MODULE(transform_hlds__term_norm_module10)
	...
	MR_init_label7(__Compare___transform_hlds__term_norm__functor_info_0_0,34,18,11,4,43,9,7)
MR_BEGIN_CODE
...
MR_define_entry(mercury____Compare___transform_hlds__term_norm__functor_info_0_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TEST(MR_r1,1)) {
		MR_GOTO_LAB(__Compare___transform_hlds__term_norm__functor_info_0_0_i4);
	}
	if (MR_PTAG_TEST(MR_r1,2)) {
...
MR_def_label(__Compare___transform_hlds__term_norm__functor_info_0_0,11)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TEST(MR_r2,1)) {
		MR_GOTO_LAB(__Compare___transform_hlds__term_norm__functor_info_0_0_i43);
	}
	if (MR_PTAG_TEST(MR_r2,2)) {
	...
	MR_r1 = (MR_Integer) 2;
	MR_proceed();
MR_def_label(__Compare___transform_hlds__term_norm__functor_info_0_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TEST(MR_r2,1)) {
		MR_GOTO_LAB(__Compare___transform_hlds__term_norm__functor_info_0_0_i7);
	}
...
MR_def_label(__Compare___transform_hlds__term_norm__functor_info_0_0,43)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Integer) 2;
	MR_proceed();
...
MR_def_label(__Compare___transform_hlds__term_norm__functor_info_0_0,7)
	...
	MR_tempr2 = MR_r2;
	MR_r2 = (MR_Word) MR_CTOR0_ADDR(transform_hlds__term_norm, weight_info);
	MR_r3 = MR_const_mask_field(MR_tempr1, 0);
	MR_r4 = MR_const_mask_field(MR_tempr2, 0);
...
MR_BEGIN_MODULE(transform_hlds__term_norm_module11)
	...
	MR_init_label1(__Unify___transform_hlds__term_norm__weight_info_0_0,1)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(transform_hlds__term_norm_module12)
	...
	MR_init_label2(__Compare___transform_hlds__term_norm__weight_info_0_0,3,7)
MR_BEGIN_CODE
...
MR_def_static(__Compare___transform_hlds__term_norm__weight_info_0_0)
	...
	MR_np_call_localret_ent(private_builtin__builtin_compare_int_3_0,
		__Compare___transform_hlds__term_norm__weight_info_0_0_i3);
MR_def_label(__Compare___transform_hlds__term_norm__weight_info_0_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___transform_hlds__term_norm__weight_info_0_0_i7);
	}
	MR_r1 = (MR_Word) MR_BOOL_CTOR_ADDR;
	MR_r2 = MR_sv(1);
	MR_r3 = MR_sv(2);
...
MR_def_label(__Compare___transform_hlds__term_norm__weight_info_0_0,7)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(3);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
