        ...
        switch (UseArg_34) {
          ...
          case (MR_Integer) 1:
            if (((MR_tag((MR_Word) Var_48)) == (MR_Integer) 0))
            {
              ...
              ConsId_50 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ConstStruct_49, (MR_Integer) 0))));
              Args_51 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ConstStruct_49, (MR_Integer) 1))));
              Type_52 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ConstStruct_49, (MR_Integer) 2))));
              parse_tree__prog_type__type_to_ctor_det_2_p_0(Type_52, &TypeCtor_55);
              {
                ...
                MR_hl_field(MR_mktag(0), Var_63, 0) = ((MR_Box) (TypeCtor_55));
                MR_hl_field(MR_mktag(0), Var_63, 1) = ((MR_Box) (ConsId_50));
              }
              ...
              else
              {
                ...
                if (succeeded)
                {
                  Arity_62 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), TypeCtor_55, (MR_Integer) 1))));
                  Var_68 = (MR_Integer) 1;
                  ...
                  mercury__list__duplicate_3_p_0(TypeCtorInfo_7_69, Arity_62, ((MR_Box) (Var_68)), &ArgInfos_67);
                  {
                    ...
                    MR_hl_field(MR_mktag(0), WeightInfo_56, 0) = ((MR_Box) (Arity_62));
                    MR_hl_field(MR_mktag(0), WeightInfo_56, 1) = ((MR_Box) (ArgInfos_67));
                  }
                  succeeded = MR_TRUE;
                }
              }
              if (succeeded)
              {
                MR_Integer ConsIdGamma_57 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), WeightInfo_56, (MR_Integer) 0))));
                MR_Word UseArgs_58 = ((MR_Word) ((MR_hl_field(MR_mktag(0), WeightInfo_56, (MR_Integer) 1))));
            ...
            else
            {
              ...
              parse_tree__prog_type__type_to_ctor_det_2_p_0(Type_38, &TypeCtor_39);
              {
                ...
                MR_hl_field(MR_mktag(0), Var_73, 0) = ((MR_Box) (TypeCtor_39));
                MR_hl_field(MR_mktag(0), Var_73, 1) = ((MR_Box) (ConsId_37));
              }
              ...
              else
              {
                ...
                if (succeeded)
                {
                  Arity_72 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), TypeCtor_39, (MR_Integer) 1))));
                  Var_78 = (MR_Integer) 1;
                  ...
                  mercury__list__duplicate_3_p_0(TypeCtorInfo_7_79, Arity_72, ((MR_Box) (Var_78)), &ArgInfos_77);
                  {
                    ...
                    MR_hl_field(MR_mktag(0), WeightInfo_40, 0) = ((MR_Box) (Arity_72));
                    MR_hl_field(MR_mktag(0), WeightInfo_40, 1) = ((MR_Box) (ArgInfos_77));
                  }
                  succeeded = MR_TRUE;
                }
              }
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      if (((MR_tag((MR_Word) Arg_13)) == (MR_Integer) 0))
      {
        ...
        ConsId_27 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ConstStruct_26, (MR_Integer) 0))));
        Args_28 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ConstStruct_26, (MR_Integer) 1))));
        Type_29 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ConstStruct_26, (MR_Integer) 2))));
        parse_tree__prog_type__type_to_ctor_det_2_p_0(Type_29, &TypeCtor_32);
        {
          ...
          MR_hl_field(MR_mktag(0), Var_40, 0) = ((MR_Box) (TypeCtor_32));
          MR_hl_field(MR_mktag(0), Var_40, 1) = ((MR_Box) (ConsId_27));
        }
        ...
        else
        {
          ...
          if (succeeded)
          {
            Arity_39 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), TypeCtor_32, (MR_Integer) 1))));
            Var_45 = (MR_Integer) 1;
            ...
            mercury__list__duplicate_3_p_0(TypeCtorInfo_7_46, Arity_39, ((MR_Box) (Var_45)), &ArgInfos_44);
            {
              ...
              MR_hl_field(MR_mktag(0), WeightInfo_33, 0) = ((MR_Box) (Arity_39));
              MR_hl_field(MR_mktag(0), WeightInfo_33, 1) = ((MR_Box) (ArgInfos_44));
            }
            succeeded = MR_TRUE;
          }
        }
        if (succeeded)
        {
          MR_Integer ConsIdGamma_34 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), WeightInfo_33, (MR_Integer) 0))));
      ...
      else
      {
        ...
        parse_tree__prog_type__type_to_ctor_det_2_p_0(Type_17, &TypeCtor_18);
        {
          ...
          MR_hl_field(MR_mktag(0), Var_50, 0) = ((MR_Box) (TypeCtor_18));
          MR_hl_field(MR_mktag(0), Var_50, 1) = ((MR_Box) (ConsId_16));
        }
        ...
        else
        {
          ...
          if (succeeded)
          {
            Arity_49 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), TypeCtor_18, (MR_Integer) 1))));
            Var_55 = (MR_Integer) 1;
            ...
            mercury__list__duplicate_3_p_0(TypeCtorInfo_7_56, Arity_49, ((MR_Box) (Var_55)), &ArgInfos_54);
            {
              ...
              MR_hl_field(MR_mktag(0), WeightInfo_19, 0) = ((MR_Box) (Arity_49));
              MR_hl_field(MR_mktag(0), WeightInfo_19, 1) = ((MR_Box) (ArgInfos_54));
            }
            succeeded = MR_TRUE;
          }
        }
