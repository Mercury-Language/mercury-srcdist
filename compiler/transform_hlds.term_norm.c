...
#line 55 "transform_hlds.term_norm.c"
...
#endif
#line 64 "transform_hlds.term_norm.c"
...
MR_decl_label8(transform_hlds__term_norm__find_and_count_nonrec_args_5_0, 40,4,9,11,13,15,16,7)
MR_decl_label2(transform_hlds__term_norm__find_and_count_nonrec_args_5_0, 18,6)
...
MR_decl_label3(transform_hlds__term_norm__zero_size_type_2_0, 2,18,19)
...
MR_BEGIN_MODULE(transform_hlds__term_norm_module5)
	...
	MR_init_label3(transform_hlds__term_norm__zero_size_type_2_0,2,18,19)
MR_BEGIN_CODE
...
MR_def_label(transform_hlds__term_norm__zero_size_type_2_0,2)
	...
	MR_COMPUTED_GOTO((MR_Unsigned) MR_r1,
		...
		MR_LABEL_AP(transform_hlds__term_norm__zero_size_type_2_0_i18) MR_AND
		MR_LABEL_AP(transform_hlds__term_norm__zero_size_type_2_0_i18) MR_AND
		MR_LABEL_AP(transform_hlds__term_norm__zero_size_type_2_0_i19) MR_AND
		MR_LABEL_AP(transform_hlds__term_norm__zero_size_type_2_0_i18) MR_AND
		MR_LABEL_AP(transform_hlds__term_norm__zero_size_type_2_0_i18) MR_AND
		MR_LABEL_AP(transform_hlds__term_norm__zero_size_type_2_0_i18) MR_AND
		MR_LABEL_AP(transform_hlds__term_norm__zero_size_type_2_0_i19) MR_AND
...
MR_BEGIN_MODULE(transform_hlds__term_norm_module7)
	...
	MR_init_label8(transform_hlds__term_norm__find_and_count_nonrec_args_5_0,40,4,9,11,13,15,16,7)
	MR_init_label2(transform_hlds__term_norm__find_and_count_nonrec_args_5_0,18,6)
MR_BEGIN_CODE
...
MR_def_static(transform_hlds__term_norm__find_and_count_nonrec_args_5_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
		MR_GOTO_LAB(transform_hlds__term_norm__find_and_count_nonrec_args_5_0_i40);
	}
	MR_r1 = (MR_Integer) 0;
	MR_r2 = (MR_Word) MR_tbmkword(0, 0);
	MR_proceed();
MR_def_label(transform_hlds__term_norm__find_and_count_nonrec_args_5_0,40)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(8);
