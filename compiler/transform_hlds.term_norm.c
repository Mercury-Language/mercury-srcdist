              ...
              else
              {
                ...
                if (succeeded)
                {
                  ...
                  Var_21 = ((MR_Word) (MR_hl_field(MR_mktag(3), ConsId_13, (MR_Integer) 2)));
                  {
                    ...
                    transform_hlds__term_norm__const_struct_count_cells_args_4_p_0(ConstStructDb_22, Args_81, ((MR_Integer) 0 + (MR_Integer) 1), Gamma_14);
                  }
                }
                else
          ...
          case (MR_Integer) 1:
            if (((MR_tag((MR_Word) Var_50)) == (MR_mktag((MR_Integer) 0))))
            {
              ...
              if (succeeded)
              {
                ...
                MR_Integer STATE_VARIABLE_Gamma_21_66 = (STATE_VARIABLE_Gamma_0_5 + ConsIdGamma_64);
            ...
            else
            {
              ...
              if (succeeded)
              {
                ...
                STATE_VARIABLE_Gamma_47_47 = (STATE_VARIABLE_Gamma_0_5 + ConsIdGamma_41);
              }
              else
                STATE_VARIABLE_Gamma_47_47 = STATE_VARIABLE_Gamma_0_5;
            }
