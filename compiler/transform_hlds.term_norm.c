...
#line 155 "transform_hlds.term_norm.c"
...
#line 837 "transform_hlds.term_norm.c"
static const MR_FA_TypeInfo_Struct1 transform_hlds__term_norm__list__ti_list_1bool__type_ctor_info_bool_0 = {
  &mercury__list__list__type_ctor_info_list_1,
  {
...
#line 851 "transform_hlds.term_norm.c"
static const MR_DuFunctorDesc transform_hlds__term_norm__transform_hlds__term_norm__du_functor_desc_weight_info_0_0 = {
  (MR_String) "weight",
  (MR_Integer) 2,
  (MR_Integer) 0,
...
#line 871 "transform_hlds.term_norm.c"
static const MR_DuPtagLayout transform_hlds__term_norm__transform_hlds__term_norm__du_ptag_ordered_weight_info_0[1] = {
  {
    (MR_Integer) 1,
    mercury__private_builtin__MR_SECTAG_NONE,
...
#line 890 "transform_hlds.term_norm.c"
...
#line 911 "transform_hlds.term_norm.c"
...
#line 1268 "transform_hlds.term_norm.c"
...
#line 1390 "transform_hlds.term_norm.c"
...
#line 134 "term_norm.m"
    if (transform_hlds__term_norm__succeeded)
#line 1525 "transform_hlds.term_norm.c"
...
#line 1547 "transform_hlds.term_norm.c"
...
#line 95 "term_norm.m"
    if (transform_hlds__term_norm__succeeded)
#line 1662 "transform_hlds.term_norm.c"
      *transform_hlds__term_norm__HeadVar__1_1 = (MR_Integer) 0;
#line 95 "term_norm.m"
    else
#line 95 "term_norm.m"
...
#line 1682 "transform_hlds.term_norm.c"
              *transform_hlds__term_norm__HeadVar__1_1 = (MR_Integer) 1;
#line 95 "term_norm.m"
            else
#line 1686 "transform_hlds.term_norm.c"
              *transform_hlds__term_norm__HeadVar__1_1 = (MR_Integer) 1;
#line 95 "term_norm.m"
      else
#line 95 "term_norm.m"
...
#line 95 "term_norm.m"
              if (((MR_tag((MR_Word) transform_hlds__term_norm__HeadVar__3_3)) == (MR_mktag((MR_Integer) 1))))
#line 1706 "transform_hlds.term_norm.c"
                *transform_hlds__term_norm__HeadVar__1_1 = (MR_Integer) 1;
#line 95 "term_norm.m"
              else
#line 1710 "transform_hlds.term_norm.c"
                *transform_hlds__term_norm__HeadVar__1_1 = (MR_Integer) 1;
#line 95 "term_norm.m"
        else
#line 95 "term_norm.m"
...
#line 95 "term_norm.m"
                if ((transform_hlds__term_norm__HeadVar__3_3 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 1)))))
#line 1729 "transform_hlds.term_norm.c"
                  *transform_hlds__term_norm__HeadVar__1_1 = (MR_Integer) 2;
#line 95 "term_norm.m"
                else
#line 95 "term_norm.m"
...
#line 1751 "transform_hlds.term_norm.c"
                    *transform_hlds__term_norm__HeadVar__1_1 = (MR_Integer) 1;
#line 95 "term_norm.m"
            }
#line 95 "term_norm.m"
...
#line 95 "term_norm.m"
                  if (((MR_tag((MR_Word) transform_hlds__term_norm__HeadVar__3_3)) == (MR_mktag((MR_Integer) 1))))
#line 1776 "transform_hlds.term_norm.c"
                    *transform_hlds__term_norm__HeadVar__1_1 = (MR_Integer) 2;
#line 95 "term_norm.m"
                  else
#line 95 "term_norm.m"
...
#line 2120 "transform_hlds.term_norm.c"
...
#line 2366 "transform_hlds.term_norm.c"
...
#line 2569 "transform_hlds.term_norm.c"
...
#line 2705 "transform_hlds.term_norm.c"
...
#line 202 "term_norm.m"
            transform_hlds__term_norm__V_36_36 = (MR_Integer) 1;
#line 2898 "transform_hlds.term_norm.c"
            transform_hlds__term_norm__TypeCtorInfo_7_37 = (MR_Word) &mercury__bool__bool__type_ctor_info_bool_0;
#line 202 "term_norm.m"
            {
#line 202 "term_norm.m"
...
#line 3521 "transform_hlds.term_norm.c"
...
#line 3586 "transform_hlds.term_norm.c"
...
#line 222 "term_norm.m"
                    {
#line 3667 "transform_hlds.term_norm.c"
