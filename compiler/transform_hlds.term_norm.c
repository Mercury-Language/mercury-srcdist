  ...
  MR_Word * STATE_VARIABLE_Weights_23)
{
    ...
    WeightInfo_20 = (MR_Word) (&transform_hlds__term_norm_scalar_common_2[2]);
  {
    ...
    MR_hl_field(3, ConsId_21, 0) = ((MR_Box) ((MR_Unsigned) 3U));
        ...
        case (MR_Integer) 0:
          {
            ...
            succeeded = ((((MR_tag((MR_Word) ConsId_13)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(3, ConsId_13, (MR_Integer) 0)))) == (MR_Integer) 3)));
            if (succeeded)
            {
          ...
          if (succeeded)
          {
            ConstNum_56 = ((MR_Integer) ((MR_hl_field(3, ConsId_13, (MR_Integer) 1))));
            {
              ...
              else
              {
                ...
                succeeded = parse_tree__prog_type_test__type_ctor_is_tuple_1_p_0(TypeCtor_106);
                if (succeeded)
                {
