...
{
  {
    ...
    else
    {
      ...
      {
        *HeadVar__4_4 = (MR_Integer) ((MR_Unsigned) NonRecArgs0_14 + (MR_Unsigned) (MR_Integer) 1);
        {
          MR_Word base;
          base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
          *HeadVar__5_5 = base;
          ...
          case (MR_Integer) 1:
            {
              ...
              MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), CtorCat_5, (MR_Integer) 1)));
          ...
          case (MR_Integer) 0:
            {
              ...
              succeeded = ((((MR_tag((MR_Word) ConsId_9)) == (MR_Integer) 3)) && ((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), ConsId_9, (MR_Integer) 0))) == (MR_Integer) 2)));
              if (succeeded)
              {
          ...
          case (MR_Integer) 0:
            {
              ...
              succeeded = ((((MR_tag((MR_Word) ConsId_13)) == (MR_Integer) 3)) && ((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), ConsId_13, (MR_Integer) 0))) == (MR_Integer) 2)));
              if (succeeded)
              {
              ...
              else
              {
                ...
                succeeded = ((((MR_tag((MR_Word) ConsId_13)) == (MR_Integer) 3)) && ((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), ConsId_13, (MR_Integer) 0))) == (MR_Integer) 23)));
                if (succeeded)
                {
                  ConstNum_20 = ((MR_Integer) ((MR_hl_field(MR_mktag(3), ConsId_13, (MR_Integer) 1))));
                  {
                    ...
                    transform_hlds__term_norm__const_struct_count_cells_args_4_p_0(ConstStructDb_22, Args_81, (MR_Integer) ((MR_Unsigned) (MR_Integer) 0 + (MR_Unsigned) (MR_Integer) 1), Gamma_14);
                  }
                }
                else
            ...
            if (((MR_tag((MR_Word) Var_50)) == (MR_Integer) 0))
            {
              ...
              else
              {
                ...
                if (succeeded)
                {
                  ...
                  {
                    WeightInfo_63 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      if (((MR_tag((MR_Word) Arg_10)) == (MR_Integer) 0))
      {
        ...
        hlds__const_struct__lookup_const_struct_num_3_p_0(HeadVar__1_1, ArgConstNum_15, &ConstStruct_25);
        Args_27 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ConstStruct_25, (MR_Integer) 1))));
        STATE_VARIABLE_Gamma_15_30 = (MR_Integer) ((MR_Unsigned) STATE_VARIABLE_Gamma_0_3 + (MR_Unsigned) (MR_Integer) 1);
