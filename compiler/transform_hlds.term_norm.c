              ...
              if (transform_hlds__term_norm__succeeded)
                *transform_hlds__term_norm__Gamma_14 = (MR_Integer) 1;
              else
                {
                  ...
                  transform_hlds__term_norm__succeeded = ((((MR_tag((MR_Word) transform_hlds__term_norm__ConsId_13)) == (MR_mktag((MR_Integer) 3)))) && (((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), transform_hlds__term_norm__ConsId_13, (MR_Integer) 0)))) == (MR_Integer) 15)));
                  if (transform_hlds__term_norm__succeeded)
                    {
