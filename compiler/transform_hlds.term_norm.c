...
transform_hlds__term_norm__find_weights_for_type_3_p_0(
  MR_Word HeadVar__1_1,
  MR_Word STATE_VARIABLE_Weights_0_19,
  MR_Word * STATE_VARIABLE_Weights_20);
    ...
    case (MR_Integer) 0:
      {
        ...
        MR_Word Var_21 = (MR_Word) ((MR_Word) (TypeBody_7));
        MR_Word Var_22;
        MR_Word Var_23;
        MR_Box conv1_STATE_VARIABLE_Weights_20;

        Constructors_8 = ((MR_Word) ((MR_hl_field(0, Var_21, 0))));
        hlds__hlds_data__get_type_defn_tparams_2_p_0(TypeDefn_5, &TypeParams_14);
        {
          Var_22 = (MR_Word) MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(0, Var_22, 0) = ((MR_Box) (&transform_hlds__term_norm_scalar_common_4[0]));
          MR_hl_field(0, Var_22, 1) = ((MR_Box) (transform_hlds__term_norm__find_weights_for_type_3_p_0_1));
          MR_hl_field(0, Var_22, 2) = ((MR_Box) ((MR_Integer) 2));
          MR_hl_field(0, Var_22, 3) = ((MR_Box) (TypeCtor_4));
          MR_hl_field(0, Var_22, 4) = ((MR_Box) (TypeParams_14));
        }
        Var_23 = mercury__one_or_more__one_or_more_to_list_1_f_1((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_constructor_0), Constructors_8);
        mercury__list__foldl_4_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_constructor_0), (MR_Word) (&transform_hlds__term_norm_scalar_common_1[2]), Var_22, Var_23, ((MR_Box) (STATE_VARIABLE_Weights_0_19)), &conv1_STATE_VARIABLE_Weights_20);
        *STATE_VARIABLE_Weights_20 = ((MR_Word) (conv1_STATE_VARIABLE_Weights_20));
      }
      break;
    case (MR_Integer) 1:
      *STATE_VARIABLE_Weights_20 = STATE_VARIABLE_Weights_0_19;
      break;
    case (MR_Integer) 2:
      *STATE_VARIABLE_Weights_20 = STATE_VARIABLE_Weights_0_19;
      break;
  ...
  MR_Word Type_4)
{
  ...
  CtorCat_5 = hlds__type_classify__classify_type_2_f_0(ModuleInfo_3, Type_4);
...
{
  MR_Box closure = closure_arg;
  MR_Word conv2_STATE_VARIABLE_Weights_20;

  transform_hlds__term_norm__find_weights_for_type_3_p_0(((MR_Word) (wrapper_arg_1)), ((MR_Word) (wrapper_arg_2)), &conv2_STATE_VARIABLE_Weights_20);
  *wrapper_arg_3 = ((MR_Box) (conv2_STATE_VARIABLE_Weights_20));
}
...
{
  MR_Box closure = closure_arg;
  MR_Word conv0_STATE_VARIABLE_Weights_20;

  transform_hlds__term_norm__find_weights_for_type_3_p_0(((MR_Word) (wrapper_arg_1)), ((MR_Word) (wrapper_arg_2)), &conv0_STATE_VARIABLE_Weights_20);
  *wrapper_arg_3 = ((MR_Box) (conv0_STATE_VARIABLE_Weights_20));
}
