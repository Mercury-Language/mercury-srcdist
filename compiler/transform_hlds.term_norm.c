          ...
          case (MR_Integer) 1:
            if (((MR_tag((MR_Word) Var_50)) == (MR_Integer) 0))
            {
              ...
              if (succeeded)
              {
                ...
                transform_hlds__term_norm__const_struct_count_cell_filtered_weights_args_6_p_0(HeadVar__1_1, HeadVar__2_2, Args_59, UseArgs_66, STATE_VARIABLE_Gamma_22_67, &STATE_VARIABLE_Gamma_46_46);
              }
              else
                STATE_VARIABLE_Gamma_46_46 = STATE_VARIABLE_Gamma_0_5;
            }
    ...
    else
    {
      ...
      if (((MR_tag((MR_Word) Arg_13)) == (MR_Integer) 0))
      {
        ...
        if (succeeded)
        {
          ...
          transform_hlds__term_norm__const_struct_count_cell_weights_args_5_p_0(HeadVar__1_1, HeadVar__2_2, Args_36, STATE_VARIABLE_Gamma_22_44, &STATE_VARIABLE_Gamma_25_25);
        }
        else
