            ...
            if (((MR_tag((MR_Word) Var_50)) == (MR_Integer) 0))
            {
              ...
              else
              {
                ...
                if (succeeded)
                {
                  ...
                  Var_70 = (MR_Integer) 1;
                  TypeCtorInfo_7_71 = (MR_Word) (&mercury__bool__bool__type_ctor_info_bool_0);
                  mercury__list__duplicate_3_p_0(TypeCtorInfo_7_71, Arity_64, ((MR_Box) (Var_70)), &ArgInfos_69);
                  {
            ...
            else
            {
              ...
              else
              {
                ...
                if (succeeded)
                {
                  ...
                  Var_80 = (MR_Integer) 1;
                  TypeCtorInfo_7_81 = (MR_Word) (&mercury__bool__bool__type_ctor_info_bool_0);
                  mercury__list__duplicate_3_p_0(TypeCtorInfo_7_81, Arity_74, ((MR_Box) (Var_80)), &ArgInfos_79);
                  {
