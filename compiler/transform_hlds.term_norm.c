...
#line 853 "transform_hlds.term_norm.c"
static const MR_DuFunctorDesc transform_hlds__term_norm__transform_hlds__term_norm__du_functor_desc_weight_info_0_0 = {
  (MR_String) "weight",
  (MR_Integer) 2,
  (MR_Integer) 0,
...
#line 868 "transform_hlds.term_norm.c"
static const MR_DuFunctorDescPtr transform_hlds__term_norm__transform_hlds__term_norm__du_stag_ordered_weight_info_0_0[1] = {
...
#line 882 "transform_hlds.term_norm.c"
static const MR_DuFunctorDescPtr transform_hlds__term_norm__transform_hlds__term_norm__du_name_ordered_weight_info_0[1] = {
  &transform_hlds__term_norm__transform_hlds__term_norm__du_functor_desc_weight_info_0_0
};

#line 887 "transform_hlds.term_norm.c"
static const MR_Integer transform_hlds__term_norm__transform_hlds__term_norm__functor_number_map_weight_info_0[1] = {
  (MR_Integer) 0
};

#line 892 "transform_hlds.term_norm.c"
...
#line 913 "transform_hlds.term_norm.c"
...
#line 1084 "transform_hlds.term_norm.c"
    {
...
#line 1089 "transform_hlds.term_norm.c"
    *transform_hlds__term_norm__wrapper_arg_1 = ((MR_Box) (transform_hlds__term_norm__conv0_HeadVar__1_1));
#line 1091 "transform_hlds.term_norm.c"
  }
#line 1093 "transform_hlds.term_norm.c"
}
...
#line 1392 "transform_hlds.term_norm.c"
...
#line 134 "term_norm.m"
    if (transform_hlds__term_norm__succeeded)
#line 1527 "transform_hlds.term_norm.c"
...
#line 1549 "transform_hlds.term_norm.c"
...
#line 1616 "transform_hlds.term_norm.c"
...
#line 1624 "transform_hlds.term_norm.c"
            {
...
#line 95 "term_norm.m"
    if (transform_hlds__term_norm__succeeded)
#line 1664 "transform_hlds.term_norm.c"
      *transform_hlds__term_norm__HeadVar__1_1 = (MR_Integer) 0;
#line 95 "term_norm.m"
    else
#line 95 "term_norm.m"
...
#line 1688 "transform_hlds.term_norm.c"
              *transform_hlds__term_norm__HeadVar__1_1 = (MR_Integer) 1;
#line 95 "term_norm.m"
      else
#line 95 "term_norm.m"
...
#line 1712 "transform_hlds.term_norm.c"
                *transform_hlds__term_norm__HeadVar__1_1 = (MR_Integer) 1;
#line 95 "term_norm.m"
        else
#line 95 "term_norm.m"
...
#line 95 "term_norm.m"
                if ((transform_hlds__term_norm__HeadVar__3_3 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 1)))))
#line 1731 "transform_hlds.term_norm.c"
                  *transform_hlds__term_norm__HeadVar__1_1 = (MR_Integer) 2;
#line 95 "term_norm.m"
                else
#line 95 "term_norm.m"
...
#line 1753 "transform_hlds.term_norm.c"
                    *transform_hlds__term_norm__HeadVar__1_1 = (MR_Integer) 1;
#line 95 "term_norm.m"
            }
#line 95 "term_norm.m"
...
#line 95 "term_norm.m"
                if ((transform_hlds__term_norm__HeadVar__3_3 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 1)))))
#line 1772 "transform_hlds.term_norm.c"
                  *transform_hlds__term_norm__HeadVar__1_1 = (MR_Integer) 2;
#line 95 "term_norm.m"
                else
#line 95 "term_norm.m"
                  if (((MR_tag((MR_Word) transform_hlds__term_norm__HeadVar__3_3)) == (MR_mktag((MR_Integer) 1))))
#line 1778 "transform_hlds.term_norm.c"
                    *transform_hlds__term_norm__HeadVar__1_1 = (MR_Integer) 2;
#line 95 "term_norm.m"
                  else
#line 95 "term_norm.m"
...
#line 1880 "transform_hlds.term_norm.c"
                  {
#line 1882 "transform_hlds.term_norm.c"
...
#line 1910 "transform_hlds.term_norm.c"
                  {
#line 1912 "transform_hlds.term_norm.c"
...
#line 2122 "transform_hlds.term_norm.c"
...
#line 2368 "transform_hlds.term_norm.c"
...
#line 2571 "transform_hlds.term_norm.c"
...
#line 2707 "transform_hlds.term_norm.c"
...
#line 202 "term_norm.m"
            transform_hlds__term_norm__V_36_36 = (MR_Integer) 1;
#line 2900 "transform_hlds.term_norm.c"
            transform_hlds__term_norm__TypeCtorInfo_7_37 = (MR_Word) &mercury__bool__bool__type_ctor_info_bool_0;
#line 202 "term_norm.m"
            {
#line 202 "term_norm.m"
...
#line 3523 "transform_hlds.term_norm.c"
...
#line 3588 "transform_hlds.term_norm.c"
...
#line 222 "term_norm.m"
                    {
#line 3669 "transform_hlds.term_norm.c"
