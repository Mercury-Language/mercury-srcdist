...
{
  {
    ...
    MR_Word ConsId_21;
    MR_Word Var_28;
    MR_Word _ExistQVars_10 = ((MR_Word) (MR_hl_field(MR_mktag(0), Ctor_8, (MR_Integer) 0)));
    MR_Word _Constraints_11 = ((MR_Word) (MR_hl_field(MR_mktag(0), Ctor_8, (MR_Integer) 1)));
    MR_Word Var_15 = ((MR_Word) (MR_hl_field(MR_mktag(0), Ctor_8, (MR_Integer) 5)));
    ...
    if (succeeded)
    {
      ...
      {
        WeightInfo_20 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
...
{
  {
    ...
    (env_ptr)->transform_hlds__term_norm__find_and_count_nonrec_args_5_p_0_env_0__TypeInfo_17_32 = (MR_Word) &transform_hlds__term_norm_scalar_common_2[2];
    (env_ptr)->transform_hlds__term_norm__find_and_count_nonrec_args_5_p_0_env_0__succeeded = mercury__builtin__unify_2_p_0((env_ptr)->transform_hlds__term_norm__find_and_count_nonrec_args_5_p_0_env_0__TypeInfo_17_32, ((MR_Box) ((env_ptr)->transform_hlds__term_norm__find_and_count_nonrec_args_5_p_0_env_0__ArgTypeParams_25)), ((MR_Box) ((env_ptr)->transform_hlds__term_norm__find_and_count_nonrec_args_5_p_0_env_0__Var_30)));
      ...
      {
        {
          ...
          MR_Word Var_28 = ((MR_Word) (MR_hl_field(MR_mktag(0), (env_ptr)->transform_hlds__term_norm__find_and_count_nonrec_args_5_p_0_env_0__Arg_8, (MR_Integer) 3)));
          ...
          if ((env_ptr)->transform_hlds__term_norm__find_and_count_nonrec_args_5_p_0_env_0__succeeded)
          {
            ...
            if ((env_ptr)->transform_hlds__term_norm__find_and_count_nonrec_args_5_p_0_env_0__succeeded)
            {
              ...
              if ((env_ptr)->transform_hlds__term_norm__find_and_count_nonrec_args_5_p_0_env_0__succeeded)
              {
                TypeInfo_14_29 = (MR_Word) &transform_hlds__term_norm_scalar_common_2[0];
                mercury__list__perm_2_p_0(TypeInfo_14_29, (env_ptr)->transform_hlds__term_norm__find_and_count_nonrec_args_5_p_0_env_0__Params_3, &(env_ptr)->transform_hlds__term_norm__find_and_count_nonrec_args_5_p_0_env_0__Var_30, transform_hlds__term_norm__find_and_count_nonrec_args_5_p_0_2, env_ptr);
              }
            }
          }
        }
...
{
  {
    ...
    switch (MR_tag((MR_Word) TypeBody_7)) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        *STATE_VARIABLE_Weights_23 = STATE_VARIABLE_Weights_0_22;
        break;
      case (MR_Integer) 1:
        {
          ...
          MR_Word Var_12 = ((MR_Word) (MR_hl_field(MR_mktag(1), TypeBody_7, (MR_Integer) 4)));
          MR_Word Var_13 = ((MR_Word) (MR_hl_field(MR_mktag(1), TypeBody_7, (MR_Integer) 5)));
          MR_Word Var_14 = ((((MR_Word) (MR_hl_field(MR_mktag(1), TypeBody_7, (MR_Integer) 6)))) & (MR_Integer) 1);
          MR_Word Var_15 = ((((((MR_Word) (MR_hl_field(MR_mktag(1), TypeBody_7, (MR_Integer) 6)))) >> (MR_Integer) 1)) & (MR_Integer) 1);
          MR_Word Var_16 = ((MR_Word) (MR_hl_field(MR_mktag(1), TypeBody_7, (MR_Integer) 7)));
          MR_Box conv1_STATE_VARIABLE_Weights_23;

          hlds__hlds_data__get_type_defn_tparams_2_p_0(TypeDefn_5, &TypeParams_17);
          {
            Var_24 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 5 * sizeof(MR_Word)), NULL, NULL);
            MR_hl_field(MR_mktag(0), Var_24, 0) = ((MR_Box) (&transform_hlds__term_norm_scalar_common_4[0]));
            MR_hl_field(MR_mktag(0), Var_24, 1) = ((MR_Box) (transform_hlds__term_norm__find_weights_for_type_3_p_0_1));
            MR_hl_field(MR_mktag(0), Var_24, 2) = ((MR_Box) (MR_Word) ((MR_Integer) 2));
            MR_hl_field(MR_mktag(0), Var_24, 3) = ((MR_Box) (TypeCtor_4));
            MR_hl_field(MR_mktag(0), Var_24, 4) = ((MR_Box) (TypeParams_17));
          }
          mercury__list__foldl_4_p_0((MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_constructor_0, (MR_Word) &transform_hlds__term_norm_scalar_common_1[2], Var_24, Constructors_8, ((MR_Box) (STATE_VARIABLE_Weights_0_22)), &conv1_STATE_VARIABLE_Weights_23);
          *STATE_VARIABLE_Weights_23 = ((MR_Word) conv1_STATE_VARIABLE_Weights_23);
        }
        break;
      case (MR_Integer) 2:
        *STATE_VARIABLE_Weights_23 = STATE_VARIABLE_Weights_0_22;
    ...
    switch (MR_tag((MR_Word) CtorCat_5)) {
      ...
      case (MR_Integer) 3:
        switch (((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), CtorCat_5, (MR_Integer) 0)))) {
          ...
          case (MR_Integer) 1:
            {
              MR_Word Var_16 = ((MR_Word) (MR_hl_field(MR_mktag(3), CtorCat_5, (MR_Integer) 1)));
          ...
          case (MR_Integer) 0:
            {
              ...
              else
              {
                ...
                succeeded = ((((MR_tag((MR_Word) ConsId_13)) == (MR_mktag((MR_Integer) 3)))) && (((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), ConsId_13, (MR_Integer) 0)))) == (MR_Integer) 21)));
                if (succeeded)
                {
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      else
      {
        ...
        {
          MR_Word next_value_of_HeadVar__3_3 = Var_51;
          MR_Word next_value_of_HeadVar__4_4 = UseArgs_37;
          MR_Integer next_value_of_STATE_VARIABLE_Gamma_0_5 = STATE_VARIABLE_Gamma_49_49;
  ...
  MR_Integer * STATE_VARIABLE_Gamma_5)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      /* direct tailcall eliminated */
      {
        MR_Word next_value_of_HeadVar__3_3 = Args_14;
        MR_Integer next_value_of_STATE_VARIABLE_Gamma_0_4 = STATE_VARIABLE_Gamma_26_26;
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      /* direct tailcall eliminated */
      {
        ...
        MR_Integer next_value_of_STATE_VARIABLE_Gamma_0_3 = STATE_VARIABLE_Gamma_18_18;
  ...
  MR_Box * wrapper_arg_3)
{
  {
    MR_Box closure = closure_arg;
    MR_Word conv2_STATE_VARIABLE_Weights_23;

    transform_hlds__term_norm__find_weights_for_type_3_p_0(((MR_Word) wrapper_arg_1), ((MR_Word) wrapper_arg_2), &conv2_STATE_VARIABLE_Weights_23);
    *wrapper_arg_3 = ((MR_Box) (conv2_STATE_VARIABLE_Weights_23));
  }
}
...
{
  {
    ...
    transform_hlds__term_norm__find_weights_for_type_3_p_0(((MR_Word) wrapper_arg_1), ((MR_Word) wrapper_arg_2), &conv0_STATE_VARIABLE_Weights_23);
    *wrapper_arg_3 = ((MR_Box) (conv0_STATE_VARIABLE_Weights_23));
  }
}
