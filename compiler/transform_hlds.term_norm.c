  ...
  MR_Word ConsId_9)
{
  ...
  switch (MR_tag((MR_Word) FunctorInfo_7)) {
        ...
        case (MR_Integer) 0:
          {
            ...
            if (succeeded)
            {
              ...
              Arity_12 = ((MR_Integer) ((MR_hl_field(0, Var_20, (MR_Integer) 1))));
        ...
        case (MR_Integer) 1:
          {
            ...
            if (succeeded)
            {
              ...
              Arity_22 = ((MR_Integer) ((MR_hl_field(0, Var_21, (MR_Integer) 1))));
              succeeded = MR_TRUE;
            }
            if (succeeded)
              Weight_10 = Arity_22;
    ...
    case (MR_Integer) 1:
      {
        ...
        else
        {
          ...
          if (succeeded)
          {
            Arity_28 = ((MR_Integer) ((MR_hl_field(0, TypeCtor_8, (MR_Integer) 1))));
            Var_34 = (MR_Integer) 1;
    ...
    case (MR_Integer) 2:
      {
        MR_Word WeightMap_25 = ((MR_Word) ((MR_hl_field(2, FunctorInfo_7, (MR_Integer) 0))));
        ...
        else
        {
          ...
          if (succeeded)
          {
            Arity_38 = ((MR_Integer) ((MR_hl_field(0, TypeCtor_8, (MR_Integer) 1))));
            Var_44 = (MR_Integer) 1;
        ...
        if (succeeded)
          Weight_10 = ((MR_Integer) ((MR_hl_field(0, WeightInfo_24, (MR_Integer) 0))));
        else
          Weight_10 = (MR_Integer) 0;
      }
      break;
  ...
  MR_Word * STATE_VARIABLE_Modes_35)
{
  ...
  switch (MR_tag((MR_Word) FunctorInfo_11)) {
        ...
        case (MR_Integer) 0:
          {
            ...
            if (succeeded)
            {
              ...
              Arity_18 = ((MR_Integer) ((MR_hl_field(0, Var_36, (MR_Integer) 1))));
            ...
            else
            {
              ...
              if (succeeded)
              {
                ConstNum_20 = ((MR_Integer) ((MR_hl_field(3, ConsId_13, (MR_Integer) 1))));
                {
                  ...
                  Args_77 = ((MR_Word) ((MR_hl_field(0, ConstStruct_75, (MR_Integer) 1))));
        ...
        case (MR_Integer) 1:
          {
            ...
            if (succeeded)
            {
              ...
              Arity_51 = ((MR_Integer) ((MR_hl_field(0, Var_38, (MR_Integer) 1))));
              succeeded = MR_TRUE;
            }
            if (succeeded)
              *Gamma_14 = Arity_51;
            else
            {
              ...
              if (succeeded)
              {
                ConstNum_49 = ((MR_Integer) ((MR_hl_field(3, ConsId_13, (MR_Integer) 1))));
                {
                  MR_Word ConstStructDb_48;
                  MR_Word ConstStruct_83;
                  MR_Word Args_85;
                  MR_Integer STATE_VARIABLE_Gamma_16_89;
                  MR_Integer Var_90;
                  ...
                  Args_85 = ((MR_Word) ((MR_hl_field(0, ConstStruct_83, (MR_Integer) 1))));
                  ...
                  STATE_VARIABLE_Gamma_16_89 = (MR_Integer) ((MR_Unsigned) 0 + (MR_Unsigned) Var_90);
                  transform_hlds__term_norm__const_struct_count_cell_arities_args_4_p_0(ConstStructDb_48, Args_85, STATE_VARIABLE_Gamma_16_89, Gamma_14);
                }
              }
              else
                *Gamma_14 = (MR_Integer) 0;
    ...
    case (MR_Integer) 1:
      {
        ...
        else
        {
          ...
          if (succeeded)
          {
            Arity_94 = ((MR_Integer) ((MR_hl_field(0, TypeCtor_12, (MR_Integer) 1))));
        ...
        else
        {
          ...
          if (succeeded)
          {
            ConstNum_58 = ((MR_Integer) ((MR_hl_field(3, ConsId_13, (MR_Integer) 1))));
            {
              ...
              ConsId_103 = ((MR_Word) ((MR_hl_field(0, ConstStruct_102, (MR_Integer) 0))));
              Args_104 = ((MR_Word) ((MR_hl_field(0, ConstStruct_102, (MR_Integer) 1))));
              Type_105 = ((MR_Word) ((MR_hl_field(0, ConstStruct_102, (MR_Integer) 2))));
              ...
              else
              {
                ...
                if (succeeded)
                {
                  Arity_115 = ((MR_Integer) ((MR_hl_field(0, TypeCtor_108, (MR_Integer) 1))));
              ...
              if (succeeded)
              {
                MR_Integer ConsIdGamma_110 = ((MR_Integer) ((MR_hl_field(0, WeightInfo_109, (MR_Integer) 0))));
                MR_Integer STATE_VARIABLE_Gamma_22_112 = (MR_Integer) ((MR_Unsigned) 0 + (MR_Unsigned) ConsIdGamma_110);

                transform_hlds__term_norm__const_struct_count_cell_weights_args_5_p_0(ConstStructDb_57, WeightMap_26, Args_104, STATE_VARIABLE_Gamma_22_112, Gamma_14);
              }
              else
                *Gamma_14 = (MR_Integer) 0;
            }
    ...
    case (MR_Integer) 2:
      {
        MR_Word WeightMap_74 = ((MR_Word) ((MR_hl_field(2, FunctorInfo_11, (MR_Integer) 0))));
        ...
        if (succeeded)
        {
          ...
          MR_Word STATE_VARIABLE_Args_41_41;
          MR_Word STATE_VARIABLE_Modes_42_42;

          *Gamma_14 = ((MR_Integer) ((MR_hl_field(0, WeightInfo_71, (MR_Integer) 0))));
          UseArgList_30 = ((MR_Word) ((MR_hl_field(0, WeightInfo_71, (MR_Integer) 1))));
          succeeded = transform_hlds__term_norm__functor_norm_filter_args_5_p_0(UseArgList_30, STATE_VARIABLE_Args_0_32, &STATE_VARIABLE_Args_41_41, STATE_VARIABLE_Modes_0_34, &STATE_VARIABLE_Modes_42_42);
          if (succeeded)
          {
            *STATE_VARIABLE_Modes_35 = STATE_VARIABLE_Modes_42_42;
            *STATE_VARIABLE_Args_33 = STATE_VARIABLE_Args_41_41;
          }
          else
            {
        ...
        else
        {
          ...
          if (succeeded)
          {
            ConstNum_65 = ((MR_Integer) ((MR_hl_field(3, ConsId_13, (MR_Integer) 1))));
            {
