      ...
      case (MR_Integer) 1:
        {
          ...
          {
            transform_hlds__term_norm__Var_25 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 5 * sizeof(MR_Word)), NULL, NULL);
            MR_hl_field(MR_mktag(0), transform_hlds__term_norm__Var_25, 0) = ((MR_Box) (&transform_hlds__term_norm_scalar_common_4[0]));
            MR_hl_field(MR_mktag(0), transform_hlds__term_norm__Var_25, 1) = ((MR_Box) (transform_hlds__term_norm__find_weights_for_type_3_p_0_1));
            MR_hl_field(MR_mktag(0), transform_hlds__term_norm__Var_25, 2) = ((MR_Box) (MR_Word) ((MR_Integer) 2));
            MR_hl_field(MR_mktag(0), transform_hlds__term_norm__Var_25, 3) = ((MR_Box) (transform_hlds__term_norm__TypeCtor_4));
            MR_hl_field(MR_mktag(0), transform_hlds__term_norm__Var_25, 4) = ((MR_Box) (transform_hlds__term_norm__TypeParams_17));
          }
          {
            mercury__list__foldl_4_p_0((MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_constructor_0, (MR_Word) &transform_hlds__term_norm_scalar_common_1[2], transform_hlds__term_norm__Var_25, transform_hlds__term_norm__Constructors_8, ((MR_Box) (transform_hlds__term_norm__STATE_VARIABLE_Weights_0_23)), &transform_hlds__term_norm__conv1_STATE_VARIABLE_Weights_24);
          }
