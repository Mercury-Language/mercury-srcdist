        ...
        switch (UseArg_34) {
          ...
          case (MR_Integer) 1:
            if (((MR_tag((MR_Word) Var_50)) == (MR_Integer) 0))
            {
              ...
              parse_tree__prog_type__type_to_ctor_det_2_p_0(Type_60, &TypeCtor_63);
              {
                Var_75 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
                MR_hl_field(MR_mktag(0), Var_75, 0) = ((MR_Box) (TypeCtor_63));
              ...
              else
              {
                ...
                succeeded = parse_tree__prog_type__type_ctor_is_tuple_1_p_0(TypeCtor_63);
                if (succeeded)
                {
                  Arity_74 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), TypeCtor_63, (MR_Integer) 1))));
                  Var_81 = (MR_Integer) 1;
                  ...
                  {
                    WeightInfo_64 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
                    MR_hl_field(MR_mktag(0), WeightInfo_64, 0) = ((MR_Box) (Arity_74));
                    MR_hl_field(MR_mktag(0), WeightInfo_64, 1) = ((MR_Box) (ArgInfos_80));
                  }
                  succeeded = MR_TRUE;
                }
              }
              if (succeeded)
              {
                MR_Integer ConsIdGamma_65 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), WeightInfo_64, (MR_Integer) 0))));
                MR_Word UseArgs_66 = ((MR_Word) ((MR_hl_field(MR_mktag(0), WeightInfo_64, (MR_Integer) 1))));
                MR_Integer STATE_VARIABLE_Gamma_22_67 = (MR_Integer) ((MR_Unsigned) STATE_VARIABLE_Gamma_0_5 + (MR_Unsigned) ConsIdGamma_65);

                transform_hlds__term_norm__const_struct_count_cell_filtered_weights_args_6_p_0(HeadVar__1_1, HeadVar__2_2, Args_59, UseArgs_66, STATE_VARIABLE_Gamma_22_67, &STATE_VARIABLE_Gamma_47_47);
              }
              else
                STATE_VARIABLE_Gamma_47_47 = STATE_VARIABLE_Gamma_0_5;
            }
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      if (((MR_tag((MR_Word) Arg_13)) == (MR_Integer) 0))
      {
        ...
        MR_Word Var_51;
        MR_Box conv0_WeightInfo0_48;

        hlds__const_struct__lookup_const_struct_num_3_p_0(HeadVar__1_1, ArgConstNum_22, &ConstStruct_33);
        ConsId_34 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ConstStruct_33, (MR_Integer) 0))));
        Args_35 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ConstStruct_33, (MR_Integer) 1))));
        Type_36 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ConstStruct_33, (MR_Integer) 2))));
        parse_tree__prog_type__type_to_ctor_det_2_p_0(Type_36, &TypeCtor_39);
        {
          Var_51 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), Var_51, 0) = ((MR_Box) (TypeCtor_39));
          MR_hl_field(MR_mktag(0), Var_51, 1) = ((MR_Box) (ConsId_34));
        }
        succeeded = mercury__map__search_3_p_0((MR_Word) (&transform_hlds__term_norm_scalar_common_1[0]), (MR_Word) (&transform_hlds__term_norm__transform_hlds__term_norm__type_ctor_info_weight_info_0), HeadVar__2_2, ((MR_Box) (Var_51)), &conv0_WeightInfo0_48);
        if (succeeded)
        {
          WeightInfo0_48 = ((MR_Word) (conv0_WeightInfo0_48));
          succeeded = MR_TRUE;
        }
        if (succeeded)
        {
          WeightInfo_40 = WeightInfo0_48;
          succeeded = MR_TRUE;
        }
        else
        {
          MR_Word TypeCtorInfo_7_58;
          MR_Integer Arity_50;
          MR_Word ArgInfos_56;
          MR_Word Var_57;
          ...
          if (succeeded)
          {
            Arity_50 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), TypeCtor_39, (MR_Integer) 1))));
            Var_57 = (MR_Integer) 1;
            TypeCtorInfo_7_58 = (MR_Word) (&mercury__bool__bool__type_ctor_info_bool_0);
            mercury__list__duplicate_3_p_0(TypeCtorInfo_7_58, Arity_50, ((MR_Box) (Var_57)), &ArgInfos_56);
            {
              WeightInfo_40 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
              MR_hl_field(MR_mktag(0), WeightInfo_40, 0) = ((MR_Box) (Arity_50));
              MR_hl_field(MR_mktag(0), WeightInfo_40, 1) = ((MR_Box) (ArgInfos_56));
            }
            succeeded = MR_TRUE;
          }
        }
        ...
        {
          MR_Integer ConsIdGamma_41 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), WeightInfo_40, (MR_Integer) 0))));
          MR_Integer STATE_VARIABLE_Gamma_22_43 = (MR_Integer) ((MR_Unsigned) STATE_VARIABLE_Gamma_0_4 + (MR_Unsigned) ConsIdGamma_41);

          transform_hlds__term_norm__const_struct_count_cell_weights_args_5_p_0(HeadVar__1_1, HeadVar__2_2, Args_35, STATE_VARIABLE_Gamma_22_43, &STATE_VARIABLE_Gamma_26_26);
        }
        else
      ...
      else
      {
        ...
        MR_Word WeightInfo0_63;
        MR_Word Var_66;
        MR_Box conv1_WeightInfo0_63;
        ...
        parse_tree__prog_type__type_to_ctor_det_2_p_0(Type_17, &TypeCtor_18);
        {
          ...
          MR_hl_field(MR_mktag(0), Var_66, 0) = ((MR_Box) (TypeCtor_18));
          MR_hl_field(MR_mktag(0), Var_66, 1) = ((MR_Box) (ConsId_16));
        }
        succeeded = mercury__map__search_3_p_0((MR_Word) (&transform_hlds__term_norm_scalar_common_1[0]), (MR_Word) (&transform_hlds__term_norm__transform_hlds__term_norm__type_ctor_info_weight_info_0), HeadVar__2_2, ((MR_Box) (Var_66)), &conv1_WeightInfo0_63);
        if (succeeded)
        {
          WeightInfo0_63 = ((MR_Word) (conv1_WeightInfo0_63));
          succeeded = MR_TRUE;
        }
        if (succeeded)
        {
          WeightInfo_19 = WeightInfo0_63;
          succeeded = MR_TRUE;
        }
        else
        {
          MR_Word TypeCtorInfo_7_73;
          MR_Integer Arity_65;
          MR_Word ArgInfos_71;
          MR_Word Var_72;
          ...
          if (succeeded)
          {
            Arity_65 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), TypeCtor_18, (MR_Integer) 1))));
            Var_72 = (MR_Integer) 1;
            TypeCtorInfo_7_73 = (MR_Word) (&mercury__bool__bool__type_ctor_info_bool_0);
            mercury__list__duplicate_3_p_0(TypeCtorInfo_7_73, Arity_65, ((MR_Box) (Var_72)), &ArgInfos_71);
            {
              WeightInfo_19 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
              MR_hl_field(MR_mktag(0), WeightInfo_19, 0) = ((MR_Box) (Arity_65));
              MR_hl_field(MR_mktag(0), WeightInfo_19, 1) = ((MR_Box) (ArgInfos_71));
            }
            succeeded = MR_TRUE;
          }
        }
