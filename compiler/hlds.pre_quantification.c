  ...
  MR_Word * STATE_VARIABLE_VarsToZones_95)
{
  while (MR_TRUE)
  {
    ...
    switch (MR_tag((MR_Word) GoalExpr_11)) {
      ...
      case (MR_Integer) 1:
        {
          MR_Word LHSVar_39 = ((MR_Word) ((MR_hl_field(1, GoalExpr_11, (MR_Integer) 0))));
          MR_Word RHS_40 = ((MR_Word) ((MR_hl_field(1, GoalExpr_11, (MR_Integer) 1))));
          MR_Word STATE_VARIABLE_VarsToZones_106_106;

          hlds__pre_quantification__record_var_in_zone_4_p_0(CurZone_7, LHSVar_39, STATE_VARIABLE_VarsToZones_0_94, &STATE_VARIABLE_VarsToZones_106_106);
          switch (MR_tag((MR_Word) RHS_40)) {
            default: /*NOTREACHED*/ MR_assert(0);
            case (MR_Integer) 0:
              {
                MR_Word RHSVar_44 = ((MR_Word) ((MR_hl_field(0, RHS_40, (MR_Integer) 0))));

                hlds__pre_quantification__record_var_in_zone_4_p_0(CurZone_7, RHSVar_44, STATE_VARIABLE_VarsToZones_106_106, STATE_VARIABLE_VarsToZones_95);
                *STATE_VARIABLE_TraceCounter_93 = STATE_VARIABLE_TraceCounter_0_92;
              }
              break;
            case (MR_Integer) 1:
              {
                MR_Word RHSArgVars_47 = ((MR_Word) ((MR_hl_field(1, RHS_40, (MR_Integer) 2))));

                hlds__pre_quantification__record_vars_in_zone_4_p_0(CurZone_7, RHSArgVars_47, STATE_VARIABLE_VarsToZones_106_106, STATE_VARIABLE_VarsToZones_95);
                *STATE_VARIABLE_TraceCounter_93 = STATE_VARIABLE_TraceCounter_0_92;
              }
              break;
            case (MR_Integer) 2:
              {
                MR_Word LambdaVarsModes_51 = ((MR_Word) ((MR_hl_field(2, RHS_40, (MR_Integer) 2))));
                MR_Word LambdaGoal_52 = ((MR_Word) ((MR_hl_field(2, RHS_40, (MR_Integer) 4))));
      ...
      case (MR_Integer) 3:
        switch (((MR_Integer) ((MR_hl_field(3, GoalExpr_11, (MR_Integer) 0))))) {
          ...
          case (MR_Integer) 0:
            {
              ...
              switch (MR_tag((MR_Word) GenericCall_19)) {
                ...
                case (MR_Integer) 1:
                  {
                    MR_Word TypeClassInfoVar_28 = ((MR_Word) ((MR_hl_field(1, GenericCall_19, (MR_Integer) 0))));

                    hlds__pre_quantification__record_var_in_zone_4_p_0(CurZone_7, TypeClassInfoVar_28, STATE_VARIABLE_VarsToZones_97_97, STATE_VARIABLE_VarsToZones_95);
                  }
                  break;
                case (MR_Integer) 2:
          ...
          case (MR_Integer) 1:
            {
              MR_Word ForeignArgs_35 = ((MR_Word) ((MR_hl_field(3, GoalExpr_11, (MR_Integer) 4))));
              MR_Word ExtraArgs_36 = ((MR_Word) ((MR_hl_field(3, GoalExpr_11, (MR_Integer) 5))));
              MR_Word Var_100;
