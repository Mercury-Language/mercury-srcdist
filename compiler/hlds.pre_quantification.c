          ...
          case (MR_Integer) 0:
            {
              ...
              switch (MR_tag((MR_Word) GenericCall_19)) {
                ...
                case (MR_Integer) 1:
                  {
                    MR_Word ClosureVar_23 = ((MR_Word) ((MR_hl_field(MR_mktag(1), GenericCall_19, (MR_Integer) 0))));
                ...
                case (MR_Integer) 2:
                  {
                    MR_Word TypeClassInfoVar_27 = ((MR_Word) ((MR_hl_field(MR_mktag(2), GenericCall_19, (MR_Integer) 0))));
