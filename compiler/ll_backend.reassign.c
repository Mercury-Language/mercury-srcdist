...
MR_decl_label10(ll_backend__reassign__remove_reassign_loop_5_0, 365,3,7,5,12,14,11,17,20,18)
...
MR_decl_label5(ll_backend__reassign__remove_reassign_loop_5_0, 133,138,136,139,380)
...
MR_BEGIN_MODULE(ll_backend__reassign_module7)
	...
	MR_init_label10(ll_backend__reassign__remove_reassign_loop_5_0,365,3,7,5,12,14,11,17,20,18)
	...
	MR_init_label5(ll_backend__reassign__remove_reassign_loop_5_0,133,138,136,139,380)
MR_BEGIN_CODE
...
MR_def_static(ll_backend__reassign__remove_reassign_loop_5_0)
	...
	MR_incr_sp(8);
	MR_sv(8) = (MR_Word) MR_succip;
MR_def_label(ll_backend__reassign__remove_reassign_loop_5_0,365)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_def_label(ll_backend__reassign__remove_reassign_loop_5_0,14)
	...
	MR_GOTO_LAB(ll_backend__reassign__remove_reassign_loop_5_0_i365);
...
MR_def_label(ll_backend__reassign__remove_reassign_loop_5_0,139)
	...
	MR_np_call_localret_ent(require__unexpected_2_0,
		ll_backend__reassign__remove_reassign_loop_5_0_i380);
MR_def_label(ll_backend__reassign__remove_reassign_loop_5_0,380)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_succip_word = MR_sv(8);
	MR_GOTO_LAB(ll_backend__reassign__remove_reassign_loop_5_0_i365);
#ifdef MR_maybe_local_thread_engine_base
