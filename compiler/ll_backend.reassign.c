    ...
    else
    {
      ...
      switch (MR_tag((MR_Word) Uinstr0_16)) {
        ...
        case (MR_Integer) 0:
          {
            {
              STATE_VARIABLE_RevInstrs_100_100 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), STATE_VARIABLE_RevInstrs_100_100, 0) = ((MR_Box) (Instr0_11));
              MR_hl_field(MR_mktag(1), STATE_VARIABLE_RevInstrs_100_100, 1) = ((MR_Box) (STATE_VARIABLE_RevInstrs_0_4));
            }
  ...
  MR_Word * STATE_VARIABLE_DepLvalMap_16)
{
  ...
  else
  {
    ...
    MR_Word TargetSubLvals_31;
    MR_Word SourceSubLvals_32;
    MR_Word AllSubLvals_33;
    MR_Word STATE_VARIABLE_DepLvalMap_21_35;
    MR_Word Var_36;
    MR_Word OldRval_29;
    MR_Box conv0_OldRval_29;
    MR_Box conv4_STATE_VARIABLE_DepLvalMap_18_18;
    MR_Word SourceLval_12;

    succeeded = mercury__map__search_3_p_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_lval_0), (MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_rval_0), STATE_VARIABLE_KnownContentsMap_0_13, ((MR_Box) (TargetLval_7)), &conv0_OldRval_29);
    if (succeeded)
    {
      OldRval_29 = ((MR_Word) (conv0_OldRval_29));
      succeeded = MR_TRUE;
    }
    if (succeeded)
    {
      MR_Word OldSubLvals_30;
      MR_Word Var_34;
      MR_Box conv2_STATE_VARIABLE_DepLvalMap_21_35;

      OldSubLvals_30 = ll_backend__code_util__lvals_in_rval_1_f_0(OldRval_29);
      {
        Var_34 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), Var_34, 0) = ((MR_Box) (&ll_backend__reassign_scalar_common_4[0]));
        MR_hl_field(MR_mktag(0), Var_34, 1) = ((MR_Box) (ll_backend__reassign__record_known_6_p_0_1));
        MR_hl_field(MR_mktag(0), Var_34, 2) = ((MR_Box) ((MR_Integer) 1));
        MR_hl_field(MR_mktag(0), Var_34, 3) = ((MR_Box) (TargetLval_7));
      }
      mercury__list__foldl_4_p_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_lval_0), (MR_Word) (&ll_backend__reassign_scalar_common_2[1]), Var_34, OldSubLvals_30, ((MR_Box) (STATE_VARIABLE_DepLvalMap_0_15)), &conv2_STATE_VARIABLE_DepLvalMap_21_35);
      STATE_VARIABLE_DepLvalMap_21_35 = ((MR_Word) (conv2_STATE_VARIABLE_DepLvalMap_21_35));
    }
    else
      STATE_VARIABLE_DepLvalMap_21_35 = STATE_VARIABLE_DepLvalMap_0_15;
    TargetSubLvals_31 = ll_backend__code_util__lvals_in_lval_1_f_0(TargetLval_7);
    SourceSubLvals_32 = ll_backend__code_util__lvals_in_rval_1_f_0(SourceRval_8);
    mercury__list__append_3_p_1((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_lval_0), TargetSubLvals_31, SourceSubLvals_32, &AllSubLvals_33);
    {
      ...
      MR_hl_field(MR_mktag(0), Var_36, 1) = ((MR_Box) (ll_backend__reassign__record_known_6_p_0_2));
      MR_hl_field(MR_mktag(0), Var_36, 2) = ((MR_Box) ((MR_Integer) 1));
      MR_hl_field(MR_mktag(0), Var_36, 3) = ((MR_Box) (TargetLval_7));
    }
    mercury__list__foldl_4_p_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_lval_0), (MR_Word) (&ll_backend__reassign_scalar_common_2[1]), Var_36, AllSubLvals_33, ((MR_Box) (STATE_VARIABLE_DepLvalMap_21_35)), &conv4_STATE_VARIABLE_DepLvalMap_18_18);
    ...
    if (succeeded)
    {
      ...
      {
        MR_Word Var_19;
        MR_Word TargetSubLvals_60;
        MR_Word SourceSubLvals_61;
        MR_Word AllSubLvals_62;
        MR_Word STATE_VARIABLE_DepLvalMap_21_64;
        MR_Word Var_65;
        MR_Word OldRval_58;
        MR_Box conv5_OldRval_58;
        ...
        succeeded = mercury__map__search_3_p_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_lval_0), (MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_rval_0), STATE_VARIABLE_KnownContentsMap_17_17, ((MR_Box) (SourceLval_12)), &conv5_OldRval_58);
        if (succeeded)
        {
          OldRval_58 = ((MR_Word) (conv5_OldRval_58));
          succeeded = MR_TRUE;
        }
        if (succeeded)
        {
          MR_Word OldSubLvals_59;
          MR_Word Var_63;
          MR_Box conv7_STATE_VARIABLE_DepLvalMap_21_64;

          OldSubLvals_59 = ll_backend__code_util__lvals_in_rval_1_f_0(OldRval_58);
          {
            Var_63 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
            MR_hl_field(MR_mktag(0), Var_63, 0) = ((MR_Box) (&ll_backend__reassign_scalar_common_4[0]));
            MR_hl_field(MR_mktag(0), Var_63, 1) = ((MR_Box) (ll_backend__reassign__record_known_6_p_0_3));
            MR_hl_field(MR_mktag(0), Var_63, 2) = ((MR_Box) ((MR_Integer) 1));
            MR_hl_field(MR_mktag(0), Var_63, 3) = ((MR_Box) (SourceLval_12));
          }
          mercury__list__foldl_4_p_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_lval_0), (MR_Word) (&ll_backend__reassign_scalar_common_2[1]), Var_63, OldSubLvals_59, ((MR_Box) (STATE_VARIABLE_DepLvalMap_18_18)), &conv7_STATE_VARIABLE_DepLvalMap_21_64);
          STATE_VARIABLE_DepLvalMap_21_64 = ((MR_Word) (conv7_STATE_VARIABLE_DepLvalMap_21_64));
        }
        else
          STATE_VARIABLE_DepLvalMap_21_64 = STATE_VARIABLE_DepLvalMap_18_18;
        TargetSubLvals_60 = ll_backend__code_util__lvals_in_lval_1_f_0(SourceLval_12);
        SourceSubLvals_61 = ll_backend__code_util__lvals_in_rval_1_f_0(Var_19);
        mercury__list__append_3_p_1((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_lval_0), TargetSubLvals_60, SourceSubLvals_61, &AllSubLvals_62);
        {
          Var_65 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), Var_65, 0) = ((MR_Box) (&ll_backend__reassign_scalar_common_4[0]));
          MR_hl_field(MR_mktag(0), Var_65, 1) = ((MR_Box) (ll_backend__reassign__record_known_6_p_0_4));
          MR_hl_field(MR_mktag(0), Var_65, 2) = ((MR_Box) ((MR_Integer) 1));
          MR_hl_field(MR_mktag(0), Var_65, 3) = ((MR_Box) (SourceLval_12));
        }
        mercury__list__foldl_4_p_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_lval_0), (MR_Word) (&ll_backend__reassign_scalar_common_2[1]), Var_65, AllSubLvals_62, ((MR_Box) (STATE_VARIABLE_DepLvalMap_21_64)), &conv9_STATE_VARIABLE_DepLvalMap_16);
