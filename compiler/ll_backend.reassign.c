  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      OldSubLvals_22 = ll_backend__code_util__lvals_in_rval_1_f_0(OldRval_21);
      {
        ...
        MR_hl_field(MR_mktag(0), Var_26, 0) = ((MR_Box) (&ll_backend__reassign_scalar_common_4[0]));
        MR_hl_field(MR_mktag(0), Var_26, 1) = ((MR_Box) (ll_backend__reassign__record_known_6_p_0_1));
        MR_hl_field(MR_mktag(0), Var_26, 2) = ((MR_Box) ((MR_Integer) 1));
        MR_hl_field(MR_mktag(0), Var_26, 3) = ((MR_Box) (TargetLval_7));
      }
    ...
    mercury__list__append_3_p_1((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_lval_0), TargetSubLvals_23, SourceSubLvals_24, &AllSubLvals_25);
    {
      ...
      MR_hl_field(MR_mktag(0), Var_28, 1) = ((MR_Box) (ll_backend__reassign__record_known_6_p_0_2));
      ...
      SourceLval_12 = ((MR_Word) ((MR_hl_field(MR_mktag(0), SourceRval_8, (MR_Integer) 0))));
      {
        ...
        if (succeeded)
        {
          ...
          OldSubLvals_37 = ll_backend__code_util__lvals_in_rval_1_f_0(OldRval_36);
          {
            ...
            MR_hl_field(MR_mktag(0), Var_41, 0) = ((MR_Box) (&ll_backend__reassign_scalar_common_4[0]));
            MR_hl_field(MR_mktag(0), Var_41, 1) = ((MR_Box) (ll_backend__reassign__record_known_6_p_0_3));
            MR_hl_field(MR_mktag(0), Var_41, 2) = ((MR_Box) ((MR_Integer) 1));
            MR_hl_field(MR_mktag(0), Var_41, 3) = ((MR_Box) (SourceLval_12));
          }
        ...
        mercury__list__append_3_p_1((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_lval_0), TargetSubLvals_38, SourceSubLvals_39, &AllSubLvals_40);
        {
          ...
          MR_hl_field(MR_mktag(0), Var_43, 1) = ((MR_Box) (ll_backend__reassign__record_known_6_p_0_4));
