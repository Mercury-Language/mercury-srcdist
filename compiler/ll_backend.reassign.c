...
MR_decl_label10(ll_backend__reassign__clobber_dependents_5_0, 3,6,7,2,11,16,15,18,19,20)
MR_decl_label1(ll_backend__reassign__clobber_dependents_5_0, 13)
...
MR_decl_label10(ll_backend__reassign__record_known_6_0, 2,4,3,7,9,11,6,12,13,14)
MR_decl_label10(ll_backend__reassign__record_known_6_0, 15,17,18,23,25,27,22,28,29,30)
MR_decl_label4(ll_backend__reassign__record_known_6_0, 31,33,34,19)
MR_decl_label3(ll_backend__reassign__remove_reassign_2_0, 2,3,4)
MR_decl_label10(ll_backend__reassign__remove_reassign_loop_5_0, 360,3,7,5,11,13,10,16,19,17)
MR_decl_label10(ll_backend__reassign__remove_reassign_loop_5_0, 9,24,28,26,32,30,36,34,38,42)
MR_decl_label10(ll_backend__reassign__remove_reassign_loop_5_0, 40,46,44,48,50,52,58,56,60,65)
MR_decl_label10(ll_backend__reassign__remove_reassign_loop_5_0, 63,67,71,69,73,77,81,85,83,87)
MR_decl_label10(ll_backend__reassign__remove_reassign_loop_5_0, 91,97,95,99,104,105,106,107,102,109)
MR_decl_label10(ll_backend__reassign__remove_reassign_loop_5_0, 114,115,112,118,116,122,120,124,130,131)
MR_decl_label4(ll_backend__reassign__remove_reassign_loop_5_0, 128,134,132,373)
...
static const MR_UserClosureId
mercury_data__closure_layout__ll_backend__reassign__record_known_6_0_3;
static const MR_UserClosureId
mercury_data__closure_layout__ll_backend__reassign__record_known_6_0_4;
...
{
{
(MR_Word *) &mercury_data__closure_layout__ll_backend__reassign__record_known_6_0_3,
(MR_Word *) (MR_Integer) 0
},
4,
{
...
{
{
(MR_Word *) &mercury_data__closure_layout__ll_backend__reassign__record_known_6_0_4,
(MR_Word *) (MR_Integer) 0
},
4,
{
...
MR_BEGIN_MODULE(ll_backend__reassign_module0)
	...
	MR_init_label10(ll_backend__reassign__clobber_dependents_5_0,3,6,7,2,11,16,15,18,19,20)
	MR_init_label1(ll_backend__reassign__clobber_dependents_5_0,13)
MR_BEGIN_CODE
...
MR_def_label(ll_backend__reassign__clobber_dependents_5_0,6)
	...
	MR_np_call_localret_ent(map__delete_3_0,
		ll_backend__reassign__clobber_dependents_5_0_i7);
MR_def_label(ll_backend__reassign__clobber_dependents_5_0,7)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	...
	MR_np_call_localret_ent(fn__ll_backend__code_util__lvals_in_rval_1_0,
		ll_backend__reassign__clobber_dependents_5_0_i11);
MR_def_label(ll_backend__reassign__clobber_dependents_5_0,2)
	...
	MR_np_call_localret_ent(fn__ll_backend__code_util__lvals_in_rval_1_0,
		ll_backend__reassign__clobber_dependents_5_0_i11);
MR_def_label(ll_backend__reassign__clobber_dependents_5_0,11)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(4) = (MR_Word) MR_redoip_slot(MR_maxfr);
	MR_sv(5) = (MR_Word) MR_redofr_slot(MR_maxfr);
	MR_save_maxfr(MR_sv(6));
	MR_redofr_slot_word(MR_maxfr) = (MR_Word) MR_curfr;
	MR_redoip_slot_word(MR_maxfr) = (MR_Word) MR_LABEL_AP(ll_backend__reassign__clobber_dependents_5_0_i15);
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(ll_backend__llds, lval);
...
MR_def_label(ll_backend__reassign__clobber_dependents_5_0,16)
	...
	MR_GOTO_LAB(ll_backend__reassign__clobber_dependents_5_0_i18);
MR_def_label(ll_backend__reassign__clobber_dependents_5_0,15)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_redoip_slot_word(MR_maxfr) = MR_sv(4);
	MR_redofr_slot_word(MR_maxfr) = MR_sv(5);
	MR_GOTO_LAB(ll_backend__reassign__clobber_dependents_5_0_i13);
MR_def_label(ll_backend__reassign__clobber_dependents_5_0,18)
	...
	MR_np_call_localret_ent(fn__map__init_0_0,
		ll_backend__reassign__clobber_dependents_5_0_i19);
MR_def_label(ll_backend__reassign__clobber_dependents_5_0,19)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(3) = MR_r1;
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(ll_backend__llds, lval);
	MR_r2 = (MR_Word) MR_TAG_COMMON(0,0,0);
	MR_np_call_localret_ent(fn__map__init_0_0,
		ll_backend__reassign__clobber_dependents_5_0_i20);
...
MR_BEGIN_MODULE(ll_backend__reassign_module4)
	...
	MR_init_label10(ll_backend__reassign__record_known_6_0,2,4,3,7,9,11,6,12,13,14)
	MR_init_label10(ll_backend__reassign__record_known_6_0,15,17,18,23,25,27,22,28,29,30)
	MR_init_label4(ll_backend__reassign__record_known_6_0,31,33,34,19)
MR_BEGIN_CODE
...
MR_def_label(ll_backend__reassign__record_known_6_0,9)
	...
	MR_np_call_localret_ent(list__foldl_4_0,
		ll_backend__reassign__record_known_6_0_i11);
MR_def_label(ll_backend__reassign__record_known_6_0,11)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(4) = MR_r1;
	MR_r1 = MR_sv(1);
	MR_GOTO_LAB(ll_backend__reassign__record_known_6_0_i12);
...
MR_def_label(ll_backend__reassign__record_known_6_0,17)
	...
	MR_np_call_localret_ent(map__set_4_0,
		ll_backend__reassign__record_known_6_0_i18);
MR_def_label(ll_backend__reassign__record_known_6_0,18)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_sv(2),0)) {
		MR_GOTO_LAB(ll_backend__reassign__record_known_6_0_i19);
	}
	...
	MR_r3 = MR_sv(2);
	MR_np_call_localret_ent(map__search_3_0,
		ll_backend__reassign__record_known_6_0_i23);
MR_def_label(ll_backend__reassign__record_known_6_0,23)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(ll_backend__reassign__record_known_6_0_i22);
	}
	MR_r1 = MR_r2;
	MR_np_call_localret_ent(fn__ll_backend__code_util__lvals_in_rval_1_0,
		ll_backend__reassign__record_known_6_0_i25);
MR_def_label(ll_backend__reassign__record_known_6_0,25)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tag_alloc_heap(MR_tempr1, 0, (MR_Integer) 4);
	...
	MR_np_call_localret_ent(list__foldl_4_0,
		ll_backend__reassign__record_known_6_0_i27);
MR_def_label(ll_backend__reassign__record_known_6_0,27)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(4) = MR_r1;
	MR_r1 = MR_sv(1);
	MR_GOTO_LAB(ll_backend__reassign__record_known_6_0_i28);
MR_def_label(ll_backend__reassign__record_known_6_0,22)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(1);
	MR_sv(4) = MR_sv(3);
MR_def_label(ll_backend__reassign__record_known_6_0,28)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(1) = MR_r1;
	MR_np_call_localret_ent(fn__ll_backend__code_util__lvals_in_lval_1_0,
		ll_backend__reassign__record_known_6_0_i29);
MR_def_label(ll_backend__reassign__record_known_6_0,29)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(3) = MR_r1;
	MR_r1 = MR_sv(5);
	MR_np_call_localret_ent(fn__ll_backend__code_util__lvals_in_rval_1_0,
		ll_backend__reassign__record_known_6_0_i30);
MR_def_label(ll_backend__reassign__record_known_6_0,30)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tempr1 = MR_sv(3);
	...
	MR_np_call_localret_ent(list__append_3_1,
		ll_backend__reassign__record_known_6_0_i31);
MR_def_label(ll_backend__reassign__record_known_6_0,31)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tag_alloc_heap(MR_tempr1, 0, (MR_Integer) 4);
	...
	MR_np_call_localret_ent(list__foldl_4_0,
		ll_backend__reassign__record_known_6_0_i33);
MR_def_label(ll_backend__reassign__record_known_6_0,33)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_sv(1);
	...
	MR_np_call_localret_ent(map__set_4_0,
		ll_backend__reassign__record_known_6_0_i34);
MR_def_label(ll_backend__reassign__record_known_6_0,34)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_sv(1);
	MR_decr_sp_and_return(6);
MR_def_label(ll_backend__reassign__record_known_6_0,19)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_sv(3);
	MR_decr_sp_and_return(6);
#ifdef MR_maybe_local_thread_engine_base
...
MR_BEGIN_MODULE(ll_backend__reassign_module5)
	...
	MR_init_label10(ll_backend__reassign__remove_reassign_loop_5_0,360,3,7,5,11,13,10,16,19,17)
	MR_init_label10(ll_backend__reassign__remove_reassign_loop_5_0,9,24,28,26,32,30,36,34,38,42)
	MR_init_label10(ll_backend__reassign__remove_reassign_loop_5_0,40,46,44,48,50,52,58,56,60,65)
	MR_init_label10(ll_backend__reassign__remove_reassign_loop_5_0,63,67,71,69,73,77,81,85,83,87)
	MR_init_label10(ll_backend__reassign__remove_reassign_loop_5_0,91,97,95,99,104,105,106,107,102,109)
	MR_init_label10(ll_backend__reassign__remove_reassign_loop_5_0,114,115,112,118,116,122,120,124,130,131)
	MR_init_label4(ll_backend__reassign__remove_reassign_loop_5_0,128,134,132,373)
MR_BEGIN_CODE
...
MR_def_label(ll_backend__reassign__remove_reassign_loop_5_0,360)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_def_label(ll_backend__reassign__remove_reassign_loop_5_0,7)
	...
	MR_r2 = (MR_Word) MR_TAG_COMMON(0,0,0);
	MR_np_call_localret_ent(fn__map__init_0_0,
		ll_backend__reassign__remove_reassign_loop_5_0_i115);
MR_def_label(ll_backend__reassign__remove_reassign_loop_5_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_RTAGS_TESTR(MR_r5,3,1)) {
		MR_GOTO_LAB(ll_backend__reassign__remove_reassign_loop_5_0_i9);
	}
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tempr2 = MR_r5;
	...
	MR_np_call_localret_ent(map__search_3_0,
		ll_backend__reassign__remove_reassign_loop_5_0_i11);
MR_def_label(ll_backend__reassign__remove_reassign_loop_5_0,11)
	...
	MR_np_call_localret_ent(__Unify___ll_backend__llds__rval_0_0,
		ll_backend__reassign__remove_reassign_loop_5_0_i13);
MR_def_label(ll_backend__reassign__remove_reassign_loop_5_0,13)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(ll_backend__reassign__remove_reassign_loop_5_0_i10);
	}
	...
	MR_GOTO_LAB(ll_backend__reassign__remove_reassign_loop_5_0_i360);
...
MR_def_label(ll_backend__reassign__remove_reassign_loop_5_0,16)
	...
	MR_np_call_localret_ent(ll_backend__reassign__no_implicit_alias_target_1_0,
		ll_backend__reassign__remove_reassign_loop_5_0_i19);
MR_def_label(ll_backend__reassign__remove_reassign_loop_5_0,19)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(ll_backend__reassign__remove_reassign_loop_5_0_i17);
	}
	MR_r1 = MR_sv(6);
	MR_r2 = MR_sv(7);
	MR_r3 = MR_sv(1);
	...
	MR_np_call_localret_ent(ll_backend__reassign__record_known_6_0,
		ll_backend__reassign__remove_reassign_loop_5_0_i134);
...
MR_def_label(ll_backend__reassign__remove_reassign_loop_5_0,9)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_r5,1)) {
		MR_GOTO_LAB(ll_backend__reassign__remove_reassign_loop_5_0_i24);
	}
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 2);
...
MR_def_label(ll_backend__reassign__remove_reassign_loop_5_0,24)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!((((MR_tag(MR_r5) == MR_mktag((MR_Integer) 3)) && ((MR_Integer) MR_tfield(3, MR_r5, 0) == (MR_Integer) 7)) || ((MR_tag(MR_r5) == MR_mktag((MR_Integer) 3)) && ((MR_Integer) MR_tfield(3, MR_r5, 0) == (MR_Integer) 6))))) {
		MR_GOTO_LAB(ll_backend__reassign__remove_reassign_loop_5_0_i26);
	}
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 2);
	...
	MR_np_call_localret_ent(fn__map__init_0_0,
		ll_backend__reassign__remove_reassign_loop_5_0_i28);
MR_def_label(ll_backend__reassign__remove_reassign_loop_5_0,28)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(1) = MR_r1;
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(ll_backend__llds, lval);
	MR_r2 = (MR_Word) MR_TAG_COMMON(0,0,0);
	MR_np_call_localret_ent(fn__map__init_0_0,
		ll_backend__reassign__remove_reassign_loop_5_0_i115);
MR_def_label(ll_backend__reassign__remove_reassign_loop_5_0,26)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_RTAGS_TESTR(MR_r5,3,25)) {
		MR_GOTO_LAB(ll_backend__reassign__remove_reassign_loop_5_0_i30);
	}
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 2);
	...
	MR_np_call_localret_ent(fn__map__init_0_0,
		ll_backend__reassign__remove_reassign_loop_5_0_i32);
...
MR_def_label(ll_backend__reassign__remove_reassign_loop_5_0,30)
	...
	if (MR_RTAGS_TESTR(MR_r5,3,26)) {
		MR_GOTO_LAB(ll_backend__reassign__remove_reassign_loop_5_0_i34);
	}
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 2);
...
MR_def_label(ll_backend__reassign__remove_reassign_loop_5_0,34)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(((((((MR_Integer) MR_r5 == (MR_Integer) MR_tbmkword(0, 1)) || ((MR_tag(MR_r5) == MR_mktag((MR_Integer) 3)) && ((MR_Integer) MR_tfield(3, MR_r5, 0) == (MR_Integer) 34))) || ((MR_tag(MR_r5) == MR_mktag((MR_Integer) 3)) && ((MR_Integer) MR_tfield(3, MR_r5, 0) == (MR_Integer) 33))) || ((MR_Integer) MR_r5 == (MR_Integer) MR_tbmkword(0, 0))) || ((MR_tag(MR_r5) == MR_mktag((MR_Integer) 3)) && ((MR_Integer) MR_tfield(3, MR_r5, 0) == (MR_Integer) 23))))) {
		MR_GOTO_LAB(ll_backend__reassign__remove_reassign_loop_5_0_i38);
	}
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 2);
...
MR_def_label(ll_backend__reassign__remove_reassign_loop_5_0,38)
	...
	if (MR_RTAGS_TESTR(MR_r5,3,27)) {
		MR_GOTO_LAB(ll_backend__reassign__remove_reassign_loop_5_0_i40);
	}
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 2);
...
MR_def_label(ll_backend__reassign__remove_reassign_loop_5_0,42)
	...
	MR_np_call_localret_ent(fn__map__init_0_0,
		ll_backend__reassign__remove_reassign_loop_5_0_i115);
MR_def_label(ll_backend__reassign__remove_reassign_loop_5_0,40)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_def_label(ll_backend__reassign__remove_reassign_loop_5_0,44)
	...
	if (MR_RTAGS_TESTR(MR_r5,3,15)) {
		MR_GOTO_LAB(ll_backend__reassign__remove_reassign_loop_5_0_i48);
	}
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 2);
...
MR_def_label(ll_backend__reassign__remove_reassign_loop_5_0,48)
	...
	if (MR_RTAGS_TESTR(MR_r5,3,9)) {
		MR_GOTO_LAB(ll_backend__reassign__remove_reassign_loop_5_0_i50);
	}
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 2);
...
MR_def_label(ll_backend__reassign__remove_reassign_loop_5_0,50)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_RTAGS_TESTR(MR_r5,3,12)) {
		MR_GOTO_LAB(ll_backend__reassign__remove_reassign_loop_5_0_i52);
	}
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 2);
	...
	MR_np_call_localret_ent(ll_backend__reassign__clobber_dependents_5_0,
		ll_backend__reassign__remove_reassign_loop_5_0_i130);
MR_def_label(ll_backend__reassign__remove_reassign_loop_5_0,52)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	...
	MR_np_call_localret_ent(fn__map__init_0_0,
		ll_backend__reassign__remove_reassign_loop_5_0_i58);
...
MR_def_label(ll_backend__reassign__remove_reassign_loop_5_0,56)
	...
	if (MR_RTAGS_TESTR(MR_r5,3,28)) {
		MR_GOTO_LAB(ll_backend__reassign__remove_reassign_loop_5_0_i60);
	}
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 2);
...
MR_def_label(ll_backend__reassign__remove_reassign_loop_5_0,60)
	...
	if (MR_RTAGS_TESTR(MR_r5,3,30)) {
		MR_GOTO_LAB(ll_backend__reassign__remove_reassign_loop_5_0_i63);
	}
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 2);
...
MR_def_label(ll_backend__reassign__remove_reassign_loop_5_0,65)
	...
	MR_np_call_localret_ent(fn__map__init_0_0,
		ll_backend__reassign__remove_reassign_loop_5_0_i115);
MR_def_label(ll_backend__reassign__remove_reassign_loop_5_0,63)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_def_label(ll_backend__reassign__remove_reassign_loop_5_0,67)
	...
	if (MR_RTAGS_TESTR(MR_r5,3,5)) {
		MR_GOTO_LAB(ll_backend__reassign__remove_reassign_loop_5_0_i69);
	}
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 2);
	...
	MR_np_call_localret_ent(fn__map__init_0_0,
		ll_backend__reassign__remove_reassign_loop_5_0_i71);
MR_def_label(ll_backend__reassign__remove_reassign_loop_5_0,71)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(1) = MR_r1;
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(ll_backend__llds, lval);
	MR_r2 = (MR_Word) MR_TAG_COMMON(0,0,0);
...
MR_def_label(ll_backend__reassign__remove_reassign_loop_5_0,69)
	...
	if (MR_RTAGS_TESTR(MR_r5,3,31)) {
		MR_GOTO_LAB(ll_backend__reassign__remove_reassign_loop_5_0_i73);
	}
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 2);
	...
	MR_np_call_localret_ent(ll_backend__reassign__clobber_dependents_5_0,
		ll_backend__reassign__remove_reassign_loop_5_0_i130);
MR_def_label(ll_backend__reassign__remove_reassign_loop_5_0,73)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_def_label(ll_backend__reassign__remove_reassign_loop_5_0,77)
	...
	if (MR_PTAG_TESTR(MR_r5,2)) {
		MR_GOTO_LAB(ll_backend__reassign__remove_reassign_loop_5_0_i81);
	}
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 2);
...
MR_def_label(ll_backend__reassign__remove_reassign_loop_5_0,81)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_RTAGS_TESTR(MR_r5,3,3)) {
		MR_GOTO_LAB(ll_backend__reassign__remove_reassign_loop_5_0_i83);
	}
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 2);
	...
	MR_np_call_localret_ent(fn__map__init_0_0,
		ll_backend__reassign__remove_reassign_loop_5_0_i85);
...
MR_def_label(ll_backend__reassign__remove_reassign_loop_5_0,83)
	...
	if (MR_RTAGS_TESTR(MR_r5,3,13)) {
		MR_GOTO_LAB(ll_backend__reassign__remove_reassign_loop_5_0_i87);
	}
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 2);
	...
	MR_np_call_localret_ent(ll_backend__reassign__clobber_dependents_5_0,
		ll_backend__reassign__remove_reassign_loop_5_0_i130);
MR_def_label(ll_backend__reassign__remove_reassign_loop_5_0,87)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_RTAGS_TESTR(MR_r5,3,22)) {
		MR_GOTO_LAB(ll_backend__reassign__remove_reassign_loop_5_0_i91);
	}
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 2);
...
MR_def_label(ll_backend__reassign__remove_reassign_loop_5_0,91)
	...
	if (MR_RTAGS_TESTR(MR_r5,3,4)) {
		MR_GOTO_LAB(ll_backend__reassign__remove_reassign_loop_5_0_i95);
	}
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 2);
...
MR_def_label(ll_backend__reassign__remove_reassign_loop_5_0,95)
	...
	if (MR_RTAGS_TESTR(MR_r5,3,16)) {
		MR_GOTO_LAB(ll_backend__reassign__remove_reassign_loop_5_0_i99);
	}
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 2);
...
MR_def_label(ll_backend__reassign__remove_reassign_loop_5_0,99)
	...
	if (MR_RTAGS_TESTR(MR_r5,3,17)) {
		MR_GOTO_LAB(ll_backend__reassign__remove_reassign_loop_5_0_i102);
	}
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 2);
	...
	MR_np_call_localret_ent(ll_backend__reassign__update_embdedded_frame_5_0,
		ll_backend__reassign__remove_reassign_loop_5_0_i104);
MR_def_label(ll_backend__reassign__remove_reassign_loop_5_0,104)
	...
	MR_np_call_localret_ent(ll_backend__reassign__clobber_dependents_5_0,
		ll_backend__reassign__remove_reassign_loop_5_0_i105);
MR_def_label(ll_backend__reassign__remove_reassign_loop_5_0,105)
	...
	MR_np_call_localret_ent(ll_backend__reassign__clobber_dependents_5_0,
		ll_backend__reassign__remove_reassign_loop_5_0_i106);
MR_def_label(ll_backend__reassign__remove_reassign_loop_5_0,106)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tempr1 = MR_sv(1);
	...
	MR_np_call_localret_ent(map__delete_3_0,
		ll_backend__reassign__remove_reassign_loop_5_0_i107);
MR_def_label(ll_backend__reassign__remove_reassign_loop_5_0,107)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
...
MR_def_label(ll_backend__reassign__remove_reassign_loop_5_0,102)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_RTAGS_TESTR(MR_r5,3,18)) {
		MR_GOTO_LAB(ll_backend__reassign__remove_reassign_loop_5_0_i109);
	}
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 2);
	...
	MR_np_call_localret_ent(ll_backend__reassign__update_embdedded_frame_5_0,
		ll_backend__reassign__remove_reassign_loop_5_0_i134);
MR_def_label(ll_backend__reassign__remove_reassign_loop_5_0,109)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_RTAGS_TESTR(MR_r5,3,21)) {
		MR_GOTO_LAB(ll_backend__reassign__remove_reassign_loop_5_0_i112);
	}
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 2);
	...
	MR_np_call_localret_ent(fn__map__init_0_0,
		ll_backend__reassign__remove_reassign_loop_5_0_i114);
MR_def_label(ll_backend__reassign__remove_reassign_loop_5_0,114)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(1) = MR_r1;
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(ll_backend__llds, lval);
	MR_r2 = (MR_Word) MR_TAG_COMMON(0,0,0);
...
MR_def_label(ll_backend__reassign__remove_reassign_loop_5_0,112)
	...
	if (MR_RTAGS_TESTR(MR_r5,3,14)) {
		MR_GOTO_LAB(ll_backend__reassign__remove_reassign_loop_5_0_i116);
	}
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 2);
	...
	MR_np_call_localret_ent(ll_backend__reassign__clobber_dependents_5_0,
		ll_backend__reassign__remove_reassign_loop_5_0_i118);
MR_def_label(ll_backend__reassign__remove_reassign_loop_5_0,118)
	...
	MR_np_call_localret_ent(map__delete_3_0,
		ll_backend__reassign__remove_reassign_loop_5_0_i131);
MR_def_label(ll_backend__reassign__remove_reassign_loop_5_0,116)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_RTAGS_TESTR(MR_r5,3,11)) {
		MR_GOTO_LAB(ll_backend__reassign__remove_reassign_loop_5_0_i120);
	}
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 2);
...
MR_def_label(ll_backend__reassign__remove_reassign_loop_5_0,120)
	...
	if (MR_RTAGS_TESTR(MR_r5,3,10)) {
		MR_GOTO_LAB(ll_backend__reassign__remove_reassign_loop_5_0_i124);
	}
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 2);
	...
	MR_np_call_localret_ent(ll_backend__reassign__clobber_dependents_5_0,
		ll_backend__reassign__remove_reassign_loop_5_0_i130);
MR_def_label(ll_backend__reassign__remove_reassign_loop_5_0,124)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_RTAGS_TESTR(MR_r5,3,20)) {
		MR_GOTO_LAB(ll_backend__reassign__remove_reassign_loop_5_0_i128);
	}
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 2);
...
MR_def_label(ll_backend__reassign__remove_reassign_loop_5_0,128)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_RTAGS_TESTR(MR_r5,3,19)) {
		MR_GOTO_LAB(ll_backend__reassign__remove_reassign_loop_5_0_i132);
	}
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 2);
	...
	MR_np_call_localret_ent(ll_backend__reassign__update_embdedded_frame_5_0,
		ll_backend__reassign__remove_reassign_loop_5_0_i134);
MR_def_label(ll_backend__reassign__remove_reassign_loop_5_0,134)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tempr1 = MR_r1;
...
MR_def_label(ll_backend__reassign__remove_reassign_loop_5_0,132)
	...
	MR_np_call_localret_ent(require__unexpected_3_0,
		ll_backend__reassign__remove_reassign_loop_5_0_i373);
MR_def_label(ll_backend__reassign__remove_reassign_loop_5_0,373)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_succip_word = MR_sv(8);
	MR_GOTO_LAB(ll_backend__reassign__remove_reassign_loop_5_0_i360);
#ifdef MR_maybe_local_thread_engine_base
...
void mercury__ll_backend__reassign__write_out_proc_statics(FILE *deep_fp, FILE *procrep_fp)
{
	MR_write_out_module_proc_reps_start(procrep_fp, &mercury_data__module_layout__ll_backend__reassign);
