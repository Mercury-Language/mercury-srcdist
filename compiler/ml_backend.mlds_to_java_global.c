  ...
  MR_Word * STATE_VARIABLE_DepGraph_35)
{
  ...
  mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&ml_backend__mlds_to_java_global_scalar_common_3[0]), TypeRawNum_20, &Var_69);
