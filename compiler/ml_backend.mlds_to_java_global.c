    ...
    case (MR_Integer) 3:
      {
...

        {
          ...
          MR_hl_field(0, Var_41, 0) = ((MR_Box) (&ml_backend__mlds_to_java_global_scalar_common_7[1]));
          MR_hl_field(0, Var_41, 1) = ((MR_Box) (ml_backend__mlds_to_java_global__output_rtti_defn_assignments_for_java_6_p_0_1));
