...
{
  {
...

    {
      ...
      MR_hl_field(MR_mktag(3), ArrayType_24, 0) = ((MR_Box) ((MR_Unsigned) 4U));
    ...
    mercury__io__write_string_3_p_0((MR_String) ";\n");
    packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Info_11, (MR_Integer) 1)));
    MLDS_ModuleName_26 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Info_11, (MR_Integer) 2))));
    packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Info_11, (MR_Integer) 5)));
    {
...
{
  {
    ...
    MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Info_7, (MR_Integer) 1)));
    MR_Unsigned packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Info_7, (MR_Integer) 5)));
    MR_Unsigned packed_word_2;

    ml_backend__mlds_to_java_util__indent_line_after_context_6_p_0(Var_20, (MR_Integer) 2, Context_13, Indent_8);
    packed_word_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Flags_14, (MR_Integer) 0)));
  ...
  MR_Word HeadVar__3_3)
{
  while (MR_TRUE)
  {
    ...
    if (!((HeadVar__3_3 == (MR_Word) ((MR_Unsigned) 0U))))
    {
      ...
      ml_backend__mlds_to_target_util__output_n_indents_3_p_0(Indent_2);
      packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Flags_18, (MR_Integer) 0)));
