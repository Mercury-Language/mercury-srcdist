  ...
  MR_Box * wrapper_arg_5)
{
  ...
  ml_backend__mlds_to_java_global__output_rtti_array_assignments_for_java_9_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 4)))), ((MR_Unsigned) ((MR_hl_field(0, closure, (MR_Integer) 5)))), ((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 6)))), ((MR_Word) (wrapper_arg_1)), ((MR_Integer) (wrapper_arg_2)), &conv0_HeadVar__7_7);
  ...
  MR_Word GlobalVarDefns_10)
{
  if (!((GlobalVarDefns_10 == (MR_Word) ((MR_Unsigned) 0U))))
  {
    ...
    Var_25 = (Indent_9 + (MR_Unsigned) 1U);
    {
  ...
  MR_Box * wrapper_arg_8)
{
  ...
  ml_backend__mlds_to_java_global__output_scalar_defns_for_java_11_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 4)))), ((MR_Unsigned) ((MR_hl_field(0, closure, (MR_Integer) 5)))), ((MR_Word) (wrapper_arg_1)), ((MR_Word) (wrapper_arg_2)), ((MR_Word) (wrapper_arg_3)), &conv1_STATE_VARIABLE_Graph_33, ((MR_Word) (wrapper_arg_5)), &conv0_STATE_VARIABLE_Map_35);
