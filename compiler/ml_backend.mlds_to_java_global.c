  ...
  MR_Word CellGroup_12)
{
  ...
  mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&ml_backend__mlds_to_java_global_scalar_common_3[0]), TypeRawNum_14, &Var_50);
  ...
  MR_Integer * HeadVar__7_7)
{
  ...
  *HeadVar__7_7 = (MR_Integer) ((MR_Unsigned) ChunkNum_15 + (MR_Unsigned) 1);
  ...
  mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&ml_backend__mlds_to_java_global_scalar_common_3[0]), ChunkNum_15, &Var_40);
  mercury__io__write_string_4_p_0(Stream_11, Var_40);
  mercury__io__write_string_4_p_0(Stream_11, (MR_String) "() {\n");
  Var_28 = (MR_Integer) ((MR_Unsigned) Indent_12 + (MR_Unsigned) 1);
  {
    Var_26 = (MR_Word) MR_new_object(MR_Word, (7 * sizeof(MR_Word)), NULL, NULL);
  ...
  MR_Word * STATE_VARIABLE_Map_33)
{
  ...
  mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&ml_backend__mlds_to_java_global_scalar_common_3[0]), TypeRawNum_20, &Var_74);
  ...
  MR_Integer * HeadVar__6_6)
{
  ...
  *HeadVar__6_6 = (MR_Integer) ((MR_Unsigned) Chunk_13 + (MR_Unsigned) 1);
  ...
  mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&ml_backend__mlds_to_java_global_scalar_common_3[0]), Chunk_13, &Var_32);
