...
{
  {
    ...
    packed_args_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Flags_14, (MR_Integer) 0)));
    Access_41 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Flags_14, (MR_Integer) 0))) >> (MR_Integer) 1)) & (MR_Integer) 1);
  ...
  MR_Word HeadVar__3_3)
{
  while (MR_TRUE)
  {
    ...
    if (!((HeadVar__3_3 == (MR_Word) ((MR_Unsigned) 0U))))
    {
      ...
      ml_backend__mlds_to_target_util__output_n_indents_3_p_0(Indent_2);
      packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Flags_18, (MR_Integer) 0)));
      Access_34 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Flags_18, (MR_Integer) 0))) >> (MR_Integer) 1)) & (MR_Integer) 1);
