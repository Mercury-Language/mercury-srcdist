          ...
          case (MR_Integer) 1:
            {
              ...
              ml_backend__mlds_to_java_data__output_nonempty_initializer_body_list_for_java_7_p_0(Info_7, Stream_8, Var_32, FieldInits_20, (MR_String) "");
              ml_backend__mlds_to_target_util__output_n_indents_4_p_0(Stream_8, Indent_9);
    ...
    case (MR_Integer) 3:
      {
...

        {
          ...
          MR_hl_field(MR_mktag(0), Var_41, 0) = ((MR_Box) (&ml_backend__mlds_to_java_global_scalar_common_7[1]));
          MR_hl_field(MR_mktag(0), Var_41, 1) = ((MR_Box) (ml_backend__mlds_to_java_global__output_rtti_defn_assignments_for_java_6_p_0_1));
          MR_hl_field(MR_mktag(0), Var_41, 2) = ((MR_Box) ((MR_Integer) 4));
          MR_hl_field(MR_mktag(0), Var_41, 3) = ((MR_Box) (Info_7));
          MR_hl_field(MR_mktag(0), Var_41, 4) = ((MR_Box) (Stream_8));
          MR_hl_field(MR_mktag(0), Var_41, 5) = ((MR_Box) (Indent_9));
          MR_hl_field(MR_mktag(0), Var_41, 6) = ((MR_Box) (GlobalVarName_12));
        }
