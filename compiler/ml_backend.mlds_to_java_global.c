  ...
  MR_Word HeadVar__4_4)
{
  while (MR_TRUE)
  {
    ...
    if (!((HeadVar__4_4 == (MR_Word) ((MR_Unsigned) 0U))))
    {
      ...
      MR_Word Type_22 = ((MR_Word) ((MR_hl_field(MR_mktag(0), GlobalVarDefn_16, (MR_Integer) 3))));
      MR_Word Access_37;
      MR_Word Constness_38;
      MR_Word next_value_of_HeadVar__4_4;

      ml_backend__mlds_to_target_util__output_n_indents_4_p_0(Stream_2, Indent_3);
      Access_37 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Flags_21, (MR_Integer) 0))) >> 1)) & (MR_Integer) 1);
      Constness_38 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Flags_21, (MR_Integer) 0))) & (MR_Integer) 1);
      switch (Access_37) {
        default: /*NOTREACHED*/ MR_assert(0);
        case (MR_Integer) 0:
