...
{
  {
    *HeadVar__6_6 = (MR_Integer) ((MR_Unsigned) Index_13 + (MR_Unsigned) (MR_Integer) 1);
    ...
    mercury__io__write_string_3_p_0((MR_String) "] = ");
    ml_backend__mlds_to_java_data__output_initializer_body_for_java_5_p_0(Info_9, ElementInit_12, (MR_Word) ((MR_Integer) 0));
    mercury__io__write_string_3_p_0((MR_String) ";\n");
  }
}
  ...
  MR_Word HeadVar__3_3)
{
  while (MR_TRUE)
  {
    ...
    if (!((HeadVar__3_3 == (MR_Word) ((MR_Integer) 0))))
    {
      ...
      ml_backend__mlds_to_java_data__output_initializer_for_java_6_p_0(Info_1, (MR_Word) ((MR_Integer) 0), Type_19, Initializer_20);
      mercury__io__write_string_3_p_0((MR_String) ";\n");
...
ml_backend__mlds_to_java_global__output_rtti_assignments_for_java_5_p_0(
  ...
  MR_Word GlobalVarDefns_8)
{
  if (!((GlobalVarDefns_8 == (MR_Word) ((MR_Integer) 0))))
  {
...
{
  {
    ...
    MR_Word Var_20 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Info_7, (MR_Integer) 1))) >> (MR_Integer) 1)) & (MR_Integer) 1);
    MR_Word Access_41;
    ...
    Access_41 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Flags_14, (MR_Integer) 0))));
    Constness_42 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Flags_14, (MR_Integer) 1))));
    switch (Access_41) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        {
