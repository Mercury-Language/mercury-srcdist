  ...
  MR_Word * BurdenedModules_14)
{
  ...
  STATE_VARIABLE_Specs_21_21 = parse_tree__parse_error__get_read_module_specs_1_f_0(ReadModuleErrors_10);
  parse_tree__split_parse_tree_src__split_into_component_modules_perform_checks_5_p_0(Globals_8, ParseTreeSrc_12, &ParseTreeModuleSrcs_15, STATE_VARIABLE_Specs_21_21, STATE_VARIABLE_Specs_20);
