  ...
  MR_Word * BurdenedModules_14)
{
  ...
  parse_tree__split_parse_tree_src__split_into_compilation_units_perform_checks_5_p_0(Globals_8, ParseTreeSrc_12, &ParseTreeModuleSrcs_15, STATE_VARIABLE_Specs_27_27, STATE_VARIABLE_Specs_26);
