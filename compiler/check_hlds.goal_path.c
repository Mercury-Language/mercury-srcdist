...
MR_decl_label3(__Unify___check_hlds__goal_path__slot_info_0_0, 2,4,1)
MR_decl_label3(__Compare___check_hlds__goal_path__slot_info_0_0, 3,7,12)
...
MR_BEGIN_MODULE(check_hlds__goal_path_module10)
	...
	MR_init_label3(__Unify___check_hlds__goal_path__slot_info_0_0,2,4,1)
MR_BEGIN_CODE
...
MR_def_static(__Unify___check_hlds__goal_path__slot_info_0_0)
	...
	MR_np_call_localret_ent(__Unify___tree234__tree234_2_0,
		__Unify___check_hlds__goal_path__slot_info_0_0_i2);
MR_def_label(__Unify___check_hlds__goal_path__slot_info_0_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
...
MR_BEGIN_MODULE(check_hlds__goal_path_module11)
	...
	MR_init_label3(__Compare___check_hlds__goal_path__slot_info_0_0,3,7,12)
MR_BEGIN_CODE
...
MR_def_static(__Compare___check_hlds__goal_path__slot_info_0_0)
	...
	MR_np_call_localret_ent(__Compare___tree234__tree234_2_0,
		__Compare___check_hlds__goal_path__slot_info_0_0_i3);
MR_def_label(__Compare___check_hlds__goal_path__slot_info_0_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___check_hlds__goal_path__slot_info_0_0_i12);
	}
	MR_r1 = MR_sv(1);
	MR_r2 = MR_sv(3);
	MR_np_call_localret_ent(__Compare___hlds__hlds_module__module_info_0_0,
		__Compare___check_hlds__goal_path__slot_info_0_0_i7);
MR_def_label(__Compare___check_hlds__goal_path__slot_info_0_0,7)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___check_hlds__goal_path__slot_info_0_0_i12);
	}
...
MR_def_label(__Compare___check_hlds__goal_path__slot_info_0_0,12)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(5);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
