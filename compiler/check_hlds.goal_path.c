...
MR_decl_label8(check_hlds__goal_path__fill_expr_slots_5_0, 53,56,3,62,93,5,94,8)
MR_decl_label8(check_hlds__goal_path__fill_expr_slots_5_0, 98,11,12,13,14,15,16,96)
MR_decl_label8(check_hlds__goal_path__fill_expr_slots_5_0, 19,20,97,23,24,25,29,30)
MR_decl_label8(check_hlds__goal_path__fill_expr_slots_5_0, 99,35,36,37,34,40,95,44)
MR_decl_label3(check_hlds__goal_path__fill_expr_slots_5_0, 47,46,51)
MR_decl_label4(check_hlds__goal_path__fill_goal_path_slots_3_0, 2,3,5,6)
MR_decl_label5(check_hlds__goal_path__fill_goal_path_slots_in_clauses_4_0, 2,3,4,7,8)
...
MR_BEGIN_MODULE(check_hlds__goal_path_module2)
	...
	MR_init_label8(check_hlds__goal_path__fill_expr_slots_5_0,53,56,3,62,93,5,94,8)
	MR_init_label8(check_hlds__goal_path__fill_expr_slots_5_0,98,11,12,13,14,15,16,96)
	MR_init_label8(check_hlds__goal_path__fill_expr_slots_5_0,19,20,97,23,24,25,29,30)
	MR_init_label8(check_hlds__goal_path__fill_expr_slots_5_0,99,35,36,37,34,40,95,44)
	MR_init_label3(check_hlds__goal_path__fill_expr_slots_5_0,47,46,51)
MR_BEGIN_CODE
...
MR_def_static(check_hlds__goal_path__fill_expr_slots_5_0)
	...
	MR_COMPUTED_GOTO((MR_Unsigned) MR_tag(MR_r4),
		MR_LABEL_AP(check_hlds__goal_path__fill_expr_slots_5_0_i53) MR_AND
		MR_LABEL_AP(check_hlds__goal_path__fill_expr_slots_5_0_i3) MR_AND
		MR_LABEL_AP(check_hlds__goal_path__fill_expr_slots_5_0_i3) MR_AND
		MR_LABEL_AP(check_hlds__goal_path__fill_expr_slots_5_0_i62));
MR_def_label(check_hlds__goal_path__fill_expr_slots_5_0,53)
	...
	MR_r1 = MR_r2;
	MR_r2 = MR_r3;
	MR_r3 = MR_ctfield(2, MR_tempr1, 8);
	}
...
MR_def_label(check_hlds__goal_path__fill_expr_slots_5_0,3)
	...
	MR_r1 = MR_r4;
	MR_proceed();
MR_def_label(check_hlds__goal_path__fill_expr_slots_5_0,62)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_COMPUTED_GOTO((MR_Unsigned) MR_ctfield(3, MR_r4, 0),
		MR_LABEL_AP(check_hlds__goal_path__fill_expr_slots_5_0_i3) MR_AND
		MR_LABEL_AP(check_hlds__goal_path__fill_expr_slots_5_0_i93) MR_AND
		MR_LABEL_AP(check_hlds__goal_path__fill_expr_slots_5_0_i94) MR_AND
		MR_LABEL_AP(check_hlds__goal_path__fill_expr_slots_5_0_i95) MR_AND
		MR_LABEL_AP(check_hlds__goal_path__fill_expr_slots_5_0_i96) MR_AND
		MR_LABEL_AP(check_hlds__goal_path__fill_expr_slots_5_0_i97) MR_AND
		MR_LABEL_AP(check_hlds__goal_path__fill_expr_slots_5_0_i98) MR_AND
		MR_LABEL_AP(check_hlds__goal_path__fill_expr_slots_5_0_i99));
MR_def_label(check_hlds__goal_path__fill_expr_slots_5_0,93)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(12);
	MR_sv(12) = (MR_Word) MR_succip;
...
MR_def_label(check_hlds__goal_path__fill_expr_slots_5_0,94)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(12);
	MR_sv(12) = (MR_Word) MR_succip;
	MR_r1 = MR_r2;
...
MR_def_label(check_hlds__goal_path__fill_expr_slots_5_0,98)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(12);
	MR_sv(12) = (MR_Word) MR_succip;
	MR_sv(1) = MR_r2;
...
MR_def_label(check_hlds__goal_path__fill_expr_slots_5_0,96)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(12);
	MR_sv(12) = (MR_Word) MR_succip;
	MR_sv(2) = MR_r3;
...
MR_def_label(check_hlds__goal_path__fill_expr_slots_5_0,97)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(12);
	MR_sv(12) = (MR_Word) MR_succip;
	MR_sv(1) = MR_r2;
...
MR_def_label(check_hlds__goal_path__fill_expr_slots_5_0,99)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(12);
	MR_sv(12) = (MR_Word) MR_succip;
	{
...
MR_def_label(check_hlds__goal_path__fill_expr_slots_5_0,95)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(12);
	MR_sv(12) = (MR_Word) MR_succip;
	MR_sv(1) = MR_r2;
...
MR_def_label(check_hlds__goal_path__fill_expr_slots_5_0,44)
	...
	MR_np_call_localret_ent(check_hlds__type_util__switch_type_num_functors_3_0,
		check_hlds__goal_path__fill_expr_slots_5_0_i47);
MR_def_label(check_hlds__goal_path__fill_expr_slots_5_0,47)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(check_hlds__goal_path__fill_expr_slots_5_0_i46);
	}
...
MR_BEGIN_MODULE(check_hlds__goal_path_module9)
	...
	MR_init_label5(check_hlds__goal_path__fill_goal_path_slots_in_clauses_4_0,2,3,4,7,8)
MR_BEGIN_CODE
...
MR_def_label(check_hlds__goal_path__fill_goal_path_slots_in_clauses_4_0,4)
	...
	MR_np_call_localret_ent(list__map_foldl_5_1,
		check_hlds__goal_path__fill_goal_path_slots_in_clauses_4_0_i7);
MR_def_label(check_hlds__goal_path__fill_goal_path_slots_in_clauses_4_0,7)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_sv(3);
