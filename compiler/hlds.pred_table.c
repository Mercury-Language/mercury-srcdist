                ...
                if (hlds__pred_table__succeeded)
                  {
                    ...
                    }
                    {
                      ...
                      MR_hl_field(MR_mktag(3), hlds__pred_table__Var_50, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 14));
                    ...
                    }
                    {
                      ...
                      MR_hl_field(MR_mktag(3), hlds__pred_table__Var_55, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 14));
