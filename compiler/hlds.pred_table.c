...
MR_decl_label10(hlds__pred_table__find_matching_pred_id_10_0, 72,4,5,6,7,10,11,12,13,15)
...
MR_BEGIN_MODULE(hlds__pred_table_module35)
	...
	MR_init_label10(hlds__pred_table__find_matching_pred_id_10_0,72,4,5,6,7,10,11,12,13,15)
...
MR_define_entry(mercury__hlds__pred_table__find_matching_pred_id_10_0);
	...
	MR_incr_sp(14);
	MR_sv(14) = (MR_Word) MR_succip;
MR_def_label(hlds__pred_table__find_matching_pred_id_10_0,72)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TEST(MR_r2,0,0)) {
...
MR_def_label(hlds__pred_table__find_matching_pred_id_10_0,3)
	...
	MR_GOTO_LAB(hlds__pred_table__find_matching_pred_id_10_0_i72);
