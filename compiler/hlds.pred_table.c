...
{
  {
    ...
    succeeded = ((MR_tag((MR_Word) PredIds_18)) == (MR_Integer) 1);
    if (succeeded)
    {
    ...
    else
    {
      ...
      succeeded = ((MR_tag((MR_Word) PredIds_70)) == (MR_Integer) 1);
      if (succeeded)
      {
    ...
    if ((ModeNo_14 == (MR_Word) ((MR_Integer) 0)))
    {
      ...
      succeeded = ((MR_tag((MR_Word) ProcIds_21)) == (MR_Integer) 1);
      if (succeeded)
      {
...
{
  {
    ...
    succeeded = ((MR_tag((MR_Word) ProcIds_8)) == (MR_Integer) 1);
    if (succeeded)
    {
