  ...
  else
  {
    ...
    if ((ProcIds_8 == (MR_Word) ((MR_Unsigned) 0U)))
    {
...

      {
        ...
        MR_hl_field(MR_mktag(1), Var_27, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &hlds__pred_table_scalar_common_1[13])));
      }
      {
    ...
    else
    {
...

      {
        ...
        MR_hl_field(MR_mktag(1), Var_43, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &hlds__pred_table_scalar_common_1[15])));
      }
      {
    ...
    case (MR_Integer) 1:
      {
        ...
        else
        {
          ...
          mercury__list__foldl_4_p_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), (MR_Word) (&hlds__pred_table_scalar_common_2[1]), Var_49, PartialQuals_45, ((MR_Box) (Func_MNA_Index0_23)), &conv1_STATE_VARIABLE_MNA_Index_43_50);
    ...
    case (MR_Integer) 0:
      {
        ...
        else
        {
          ...
          mercury__list__foldl_4_p_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), (MR_Word) (&hlds__pred_table_scalar_common_2[1]), Var_65, PartialQuals_61, ((MR_Box) (Pred_MNA_Index0_20)), &conv3_STATE_VARIABLE_MNA_Index_43_66);
