  ...
  MR_Word * STATE_VARIABLE_PredIds_16)
{
  ...
  if (succeeded)
  {
    TypeCtorInfo_31_31 = (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_user_arity_0);
    TypeInfo_32_32 = (MR_Word) (&hlds__pred_table_scalar_common_1[0]);
    succeeded = mercury__map__search_3_p_0(TypeCtorInfo_31_31, TypeInfo_32_32, ArityIndex_15, ((MR_Box) (UserArity_11)), &conv1_STATE_VARIABLE_PredIds_17_17);
    if (succeeded)
    {
