    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          hlds__hlds_pred__pred_info_get_simple_call_id_2_p_0(PredInfo_22, &PredCallId_38);
          hlds__hlds_pred__pred_info_get_simple_call_id_2_p_0(OtherPredInfo_37, &OtherPredCallId_39);
