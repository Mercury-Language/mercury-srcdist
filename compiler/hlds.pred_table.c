...
#line 576 "pred_table.m"
        if ((hlds__pred_table__IsFullyQualified_7 == (MR_Integer) 0))
#line 578 "pred_table.m"
          *hlds__pred_table__PredIds_10 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
#line 576 "pred_table.m"
        else
#line 574 "pred_table.m"
          {
#line 574 "pred_table.m"
