...
MR_decl_label10(hlds__pred_table__find_matching_pred_id_10_0, 84,4,5,6,7,10,11,12,13,15)
MR_decl_label10(hlds__pred_table__find_matching_pred_id_10_0, 9,17,18,22,24,25,26,27,41,20)
MR_decl_label3(hlds__pred_table__find_matching_pred_id_10_0, 3,46,1)
...
MR_decl_label4(hlds__pred_table__insert_into_mna_index_6_0, 7,9,2,13)
MR_decl_label10(hlds__pred_table__lookup_builtin_pred_proc_id_8_0, 2,7,10,6,12,15,3,21,24,20)
MR_decl_label10(hlds__pred_table__lookup_builtin_pred_proc_id_8_0, 26,29,18,31,32,33,34,37,38,39)
MR_decl_label10(hlds__pred_table__lookup_builtin_pred_proc_id_8_0, 42,45,46,47,41,52,51,54,55,56)
MR_decl_label4(hlds__pred_table__lookup_builtin_pred_proc_id_8_0, 57,58,59,60)
...
MR_decl_label10(hlds__pred_table__predicate_table_remove_from_index_10_0, 4,6,8,11,2,14,17,19,22,21)
MR_decl_label10(hlds__pred_table__predicate_table_remove_from_index_10_0, 26,15,34,35,36,37,40,42,41,39)
MR_decl_label2(hlds__pred_table__predicate_table_remove_from_index_10_0, 47,48)
...
MR_decl_label10(hlds__pred_table__predicate_table_search_sym_4_0, 9,11,12,14,4,20,19,23,3,71)
...
MR_decl_label3(__Compare___hlds__pred_table__predicate_table_0_0, 43,48,136)
...
MR_BEGIN_MODULE(hlds__pred_table_module8)
	...
	MR_init_label10(hlds__pred_table__predicate_table_remove_from_index_10_0,4,6,8,11,2,14,17,19,22,21)
	MR_init_label10(hlds__pred_table__predicate_table_remove_from_index_10_0,26,15,34,35,36,37,40,42,41,39)
	MR_init_label2(hlds__pred_table__predicate_table_remove_from_index_10_0,47,48)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(hlds__pred_table_module14)
	...
	MR_init_label10(hlds__pred_table__predicate_table_search_sym_4_0,9,11,12,14,4,20,19,23,3,71)
...
MR_def_label(hlds__pred_table__predicate_table_search_sym_4_0,3)
	...
	if (MR_INT_NE(MR_r2,1)) {
		MR_GOTO_LAB(hlds__pred_table__predicate_table_search_sym_4_0_i71);
	}
	MR_r2 = MR_tfield(0, MR_r3, 0);
	MR_np_tailcall_ent(hlds__pred_table__predicate_table_search_name_3_0);
MR_def_label(hlds__pred_table__predicate_table_search_sym_4_0,71)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(6);
	MR_sv(6) = (MR_Word) MR_succip;
...
MR_BEGIN_MODULE(hlds__pred_table_module30)
	...
	MR_init_label4(hlds__pred_table__insert_into_mna_index_6_0,7,9,2,13)
MR_BEGIN_CODE
...
MR_def_label(hlds__pred_table__insert_into_mna_index_6_0,2)
	...
	MR_np_call_localret_ent(fn__map__singleton_2_0,
		hlds__pred_table__insert_into_mna_index_6_0_i13);
MR_def_label(hlds__pred_table__insert_into_mna_index_6_0,13)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tag_alloc_heap(MR_tempr1, 0, (MR_Integer) 2);
...
MR_def_label(hlds__pred_table__predicate_table_insert_qual_6_0,7)
	...
	MR_r1 = MR_sv(7);
	MR_r2 = MR_sv(8);
	MR_r3 = ((MR_Integer) MR_sv(9) - (MR_Integer) 1);
	MR_r4 = MR_sv(12);
	MR_r5 = MR_sv(13);
	MR_r6 = MR_sv(1);
	MR_r7 = MR_sv(16);
...
MR_define_entry(mercury__hlds__pred_table__predicate_table_insert_4_0);
	...
	MR_sv(12) = MR_tfield(0, MR_r2, 4);
	MR_sv(13) = MR_tfield(0, MR_r2, 5);
	MR_sv(14) = MR_tfield(0, MR_r2, 6);
	MR_sv(15) = MR_tfield(0, MR_r2, 7);
	MR_sv(16) = MR_tfield(0, MR_r2, 8);
	MR_sv(3) = MR_tfield(0, MR_r2, 9);
	MR_sv(4) = MR_tfield(0, MR_r2, 10);
	MR_np_call_localret_ent(fn__hlds__hlds_pred__pred_info_module_1_0,
...
MR_def_label(hlds__pred_table__predicate_table_insert_4_0,6)
	...
	MR_r1 = MR_sv(5);
	MR_r2 = MR_sv(6);
	MR_r3 = ((MR_Integer) MR_sv(7) - (MR_Integer) 1);
	MR_r4 = (MR_Integer) 0;
...
MR_def_label(hlds__pred_table__predicate_table_insert_4_0,13)
	...
	MR_tfield(0, MR_r2, 2) = MR_sv(2);
	MR_tfield(0, MR_r2, 3) = MR_sv(16);
	MR_tfield(0, MR_r2, 4) = MR_sv(9);
	MR_tfield(0, MR_r2, 5) = MR_sv(10);
	MR_tfield(0, MR_r2, 6) = MR_sv(11);
	MR_tfield(0, MR_r2, 7) = MR_sv(12);
	MR_tfield(0, MR_r2, 8) = MR_sv(13);
	MR_tfield(0, MR_r2, 9) = MR_sv(14);
	MR_tfield(0, MR_r2, 10) = MR_sv(15);
	MR_r1 = MR_sv(1);
...
MR_BEGIN_MODULE(hlds__pred_table_module35)
	...
	MR_init_label10(hlds__pred_table__find_matching_pred_id_10_0,84,4,5,6,7,10,11,12,13,15)
	MR_init_label10(hlds__pred_table__find_matching_pred_id_10_0,9,17,18,22,24,25,26,27,41,20)
	MR_init_label3(hlds__pred_table__find_matching_pred_id_10_0,3,46,1)
MR_BEGIN_CODE
...
MR_define_entry(mercury__hlds__pred_table__find_matching_pred_id_10_0);
	...
	MR_incr_sp(14);
	MR_sv(14) = (MR_Word) MR_succip;
MR_def_label(hlds__pred_table__find_matching_pred_id_10_0,84)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TEST(MR_r2,0,0)) {
...
MR_def_label(hlds__pred_table__find_matching_pred_id_10_0,41)
	...
	MR_np_call_localret_ent(require__unexpected_3_0,
		hlds__pred_table__find_matching_pred_id_10_0_i46);
...
MR_def_label(hlds__pred_table__find_matching_pred_id_10_0,3)
	...
	MR_GOTO_LAB(hlds__pred_table__find_matching_pred_id_10_0_i84);
MR_def_label(hlds__pred_table__find_matching_pred_id_10_0,46)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_TRUE;
	MR_decr_sp_and_return(14);
...
MR_def_label(hlds__pred_table__get_proc_id_3_0,11)
	...
	MR_tfield(1, MR_r2, 1) = (MR_Word) MR_TAG_COMMON(1,5,1);
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 2);
...
MR_def_label(hlds__pred_table__get_proc_id_3_0,13)
	...
	MR_tag_alloc_heap(MR_r2, 1, (MR_Integer) 2);
	MR_tfield(1, MR_r2, 0) = MR_r1;
	MR_tfield(1, MR_r2, 1) = (MR_Word) MR_TAG_COMMON(1,5,3);
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 2);
	MR_tfield(1, MR_tempr1, 0) = (MR_Word) MR_string_const("/", 1);
...
MR_def_label(hlds__pred_table__get_pred_id_and_proc_id_by_types_11_0,12)
	...
	MR_tag_alloc_heap(MR_r2, 1, (MR_Integer) 2);
	MR_tfield(1, MR_r2, 0) = MR_r1;
	MR_tfield(1, MR_r2, 1) = (MR_Word) MR_TAG_COMMON(1,5,4);
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 2);
	MR_tfield(1, MR_tempr1, 0) = (MR_Word) MR_string_const("/", 1);
...
MR_BEGIN_MODULE(hlds__pred_table_module40)
	...
	MR_init_label10(hlds__pred_table__lookup_builtin_pred_proc_id_8_0,26,29,18,31,32,33,34,37,38,39)
	MR_init_label10(hlds__pred_table__lookup_builtin_pred_proc_id_8_0,42,45,46,47,41,52,51,54,55,56)
	MR_init_label4(hlds__pred_table__lookup_builtin_pred_proc_id_8_0,57,58,59,60)
MR_BEGIN_CODE
...
MR_def_label(hlds__pred_table__lookup_builtin_pred_proc_id_8_0,10)
	...
	MR_r1 = MR_sv(5);
	MR_r2 = MR_sv(7);
	MR_GOTO_LAB(hlds__pred_table__lookup_builtin_pred_proc_id_8_0_i37);
...
MR_def_label(hlds__pred_table__lookup_builtin_pred_proc_id_8_0,37)
	...
	MR_sv(5) = MR_r2;
	MR_np_call_localret_ent(hlds__hlds_module__module_info_pred_info_3_0,
		hlds__pred_table__lookup_builtin_pred_proc_id_8_0_i38);
MR_def_label(hlds__pred_table__lookup_builtin_pred_proc_id_8_0,38)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_np_call_localret_ent(fn__hlds__hlds_pred__pred_info_procids_1_0,
...
MR_def_label(hlds__pred_table__lookup_builtin_pred_proc_id_8_0,39)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_sv(4),0,0)) {
		MR_GOTO_LAB(hlds__pred_table__lookup_builtin_pred_proc_id_8_0_i41);
	}
	if (MR_LTAGS_TEST(MR_r1,0,0)) {
		MR_GOTO_LAB(hlds__pred_table__lookup_builtin_pred_proc_id_8_0_i42);
	}
	{
	MR_Word MR_tempr1, MR_tempr2;
...
MR_def_label(hlds__pred_table__lookup_builtin_pred_proc_id_8_0,52)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(hlds__pred_table__lookup_builtin_pred_proc_id_8_0_i51);
	}
	MR_r1 = MR_sv(5);
	MR_decr_sp_and_return(9);
...
MR_def_label(hlds__pred_table__lookup_builtin_pred_proc_id_8_0,56)
	...
	MR_np_call_localret_ent(fn__f_115_116_114_105_110_103_95_95_43_43_2_0,
		hlds__pred_table__lookup_builtin_pred_proc_id_8_0_i57);
...
MR_def_label(hlds__pred_table__reinsert_for_restrict_6_0,7)
	...
	MR_tempr2 = MR_sv(14);
	MR_sv(14) = MR_tempr1;
	MR_sv(15) = MR_tfield(0, MR_tempr2, 0);
	MR_sv(1) = MR_tfield(0, MR_tempr2, 2);
	MR_sv(16) = MR_tfield(0, MR_tempr2, 3);
	MR_sv(17) = MR_tfield(0, MR_tempr2, 4);
	MR_sv(18) = MR_tfield(0, MR_tempr2, 5);
	MR_sv(2) = MR_tfield(0, MR_tempr2, 6);
	MR_sv(3) = MR_tfield(0, MR_tempr2, 7);
	MR_sv(4) = MR_tfield(0, MR_tempr2, 8);
	MR_sv(5) = MR_tfield(0, MR_tempr2, 9);
	MR_sv(6) = MR_tfield(0, MR_tempr2, 10);
...
MR_define_entry(mercury____Unify___hlds__pred_table__predicate_table_0_0);
	...
	MR_Word MR_tempr1, MR_tempr2;
	MR_tempr1 = MR_sv(19);
	MR_sv(19) = MR_tfield(0, MR_tempr1, 1);
	MR_tempr2 = MR_sv(20);
	MR_sv(20) = MR_tfield(0, MR_tempr1, 2);
	...
	MR_sv(7) = MR_tfield(0, MR_tempr1, 9);
	MR_sv(8) = MR_tfield(0, MR_tempr1, 10);
...
MR_def_label(__Unify___hlds__pred_table__predicate_table_0_0,11)
	...
	MR_sv(19) = (MR_Word) MR_STRING_CTOR_ADDR;
	MR_r1 = MR_sv(19);
	MR_r2 = MR_sv(9);
	MR_r3 = MR_sv(3);
	MR_r4 = MR_sv(13);
...
MR_def_label(__Unify___hlds__pred_table__predicate_table_0_0,13)
	...
	MR_sv(20) = (MR_Word) MR_CTOR0_ADDR(hlds__pred_table, name_arity);
	MR_r1 = MR_sv(20);
	MR_r2 = MR_sv(9);
	MR_r3 = MR_sv(4);
	MR_r4 = MR_sv(14);
...
MR_BEGIN_MODULE(hlds__pred_table_module65)
	...
	MR_init_label3(__Compare___hlds__pred_table__predicate_table_0_0,43,48,136)
MR_BEGIN_CODE
...
MR_def_label(__Compare___hlds__pred_table__predicate_table_0_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___hlds__pred_table__predicate_table_0_0_i136);
	}
	MR_r1 = MR_sv(1);
	MR_r2 = MR_sv(11);
	MR_np_call_localret_ent(private_builtin__builtin_compare_int_3_0,
...
MR_def_label(__Compare___hlds__pred_table__predicate_table_0_0,48)
	...
	MR_decr_sp(21);
	MR_np_tailcall_ent(__Compare___tree234__tree234_2_0);
MR_def_label(__Compare___hlds__pred_table__predicate_table_0_0,136)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(21);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
