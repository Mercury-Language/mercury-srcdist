...
MR_decl_label8(hlds__pred_table__find_matching_pred_id_10_0, 71,4,5,6,7,10,11,12)
MR_decl_label8(hlds__pred_table__find_matching_pred_id_10_0, 13,15,9,17,18,22,24,25)
MR_decl_label6(hlds__pred_table__find_matching_pred_id_10_0, 26,40,20,3,45,1)
MR_decl_label8(hlds__pred_table__get_pred_id_and_proc_id_by_types_11_0, 3,4,5,7,2,9,10,11)
MR_decl_label4(hlds__pred_table__get_pred_id_and_proc_id_by_types_11_0, 12,21,23,24)
...
MR_BEGIN_MODULE(hlds__pred_table_module36)
	...
	MR_init_label8(hlds__pred_table__find_matching_pred_id_10_0,71,4,5,6,7,10,11,12)
	MR_init_label8(hlds__pred_table__find_matching_pred_id_10_0,13,15,9,17,18,22,24,25)
	MR_init_label6(hlds__pred_table__find_matching_pred_id_10_0,26,40,20,3,45,1)
MR_BEGIN_CODE
...
MR_def_label(hlds__pred_table__find_matching_pred_id_10_0,10)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(11) = MR_ctfield(1, MR_sv(8), 0);
	MR_r1 = MR_sv(10);
...
MR_BEGIN_MODULE(hlds__pred_table_module40)
	...
	MR_init_label8(hlds__pred_table__get_pred_id_and_proc_id_by_types_11_0,3,4,5,7,2,9,10,11)
	MR_init_label4(hlds__pred_table__get_pred_id_and_proc_id_by_types_11_0,12,21,23,24)
MR_BEGIN_CODE
