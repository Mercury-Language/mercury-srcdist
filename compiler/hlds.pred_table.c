  ...
  MR_Integer * ProcId_16)
{
  ...
  if ((ModeNo_14 == (MR_Word) ((MR_Unsigned) 0U)))
  {
    ...
    else
    {
      ...
      Var_92 = mercury__string__f_43_43_2_f_0(Var_58, Var_91);
      Var_54 = mercury__string__f_43_43_2_f_0((MR_String) "expected single mode for ", Var_92);
      {
  ...
  else
  {
    ...
    else
    {
      ...
      Var_106 = mercury__string__f_43_43_2_f_0(Var_46, Var_105);
      ...
      Var_40 = mercury__string__f_43_43_2_f_0((MR_String) "there is no mode ", Var_116);
      {
