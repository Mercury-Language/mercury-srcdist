  ...
  MR_Word * STATE_VARIABLE_Specs_42)
{
  ...
  else
  {
    ...
    {
      MR_Word Var_134 = ((MR_Word) ((MR_hl_field(MR_mktag(1), OtherPredFormAritiesList_32, (MR_Integer) 1))));
      MR_Word Var_135 = ((MR_Word) ((MR_hl_field(MR_mktag(1), OtherPredFormAritiesList_32, (MR_Integer) 0))));
      ...
      if ((Var_134 == (MR_Word) ((MR_Unsigned) 0U)))
      {
        ...
        Var_86 = hlds__make_hlds_error__pred_form_arity_to_int_fixed_2_f_0(PredOrFunc_12, Var_135);
        {
      ...
      else
      {
        ...
        OtherAritiesPieces_126 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_format_component_0), Var_94, (MR_Word) (MR_mkword(MR_mktag(1), &hlds__make_hlds_error_scalar_common_1[7])));
        {
  ...
  MR_Word * STATE_VARIABLE_Specs_26)
{
  ...
  {
    MR_Word Var_103 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MaybePorF_9, (MR_Integer) 0))));
