...
{
  {
    ...
    SubDeclStr_20 = parse_tree__parse_tree_out_pred_decl__mercury_mode_subdecl_to_string_6_f_0((MR_Integer) 1, PredOrFunc_17, Var_29, Var_30, StrippedModeList_16, (MR_Word) ((MR_Integer) 0));
    {
    ...
    if ((ProcIds_22 == (MR_Word) ((MR_Integer) 0)))
    {
      MR_Word Var_75;
      MR_Word Var_76;
    ...
    else
    {
      ...
      Var_65 = parse_tree__error_util__component_list_to_line_pieces_2_f_0(Var_66, (MR_Word) ((MR_Integer) 0));
...
{
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
          succeeded = (MaybeAttrs_9 == (MR_Word) ((MR_Integer) 0));
      }
    }
    if (succeeded)
    {
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_22, (MR_Integer) 186, &InferTypes_23);
    ...
    else
    {
      ...
      if ((OtherAritiesList_31 == (MR_Word) ((MR_Integer) 0)))
      {
        MR_Word Var_120;
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(0), Spec_33, 1) = ((MR_Box) ((MR_Integer) 16));
      ...
      else
      {
        ...
        if ((Var_137 == (MR_Word) ((MR_Integer) 0)))
        {
...
{
  {
    ...
    if ((OtherArities_10 == (MR_Word) ((MR_Integer) 0)))
      OtherArityPieces_15 = (MR_Word) ((MR_Integer) 0);
    else
    {
...
{
  {
    ...
    if ((ExtraPieces_14 == (MR_Word) ((MR_Integer) 0)))
      ExtraMsgs_20 = (MR_Word) ((MR_Integer) 0);
    else
    {
      MR_Word Var_61;
      MR_Word Var_62;
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(1), ExtraMsgs_20, 1) = ((MR_Box) ((MR_Integer) 0));
      }
    }
    {
      Var_70 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
