  ...
  MR_Word * STATE_VARIABLE_Specs_46)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_22, (MR_Integer) 235, &InferTypes_23);
  ...
  MR_Word * STATE_VARIABLE_Specs_29)
{
  ...
  else
  {
    ...
    Var_89 = parse_tree__error_spec__color_as_possible_cause_1_f_0((MR_Word) (MR_mkword(1, &hlds__make_hlds_error_scalar_common_1[29])));
