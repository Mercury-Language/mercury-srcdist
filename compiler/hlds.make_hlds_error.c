  ...
  else
  {
    ...
    if ((ProcIdsTail_28 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      ...
      }
      {
        ...
        MR_hl_field(1, Var_130, 1) = ((MR_Box) (MR_mkword(1, &hlds__make_hlds_error_scalar_common_1[50])));
      }
      {
        Var_88 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(1, Var_88, 0) = ((MR_Box) (MR_mkword(3, &hlds__make_hlds_error_scalar_common_1[49])));
    ...
    else
    {
      ...
      }
      {
        ...
        MR_hl_field(0, Var_107, 0) = ((MR_Box) (&hlds__make_hlds_error_scalar_common_4[0]));
