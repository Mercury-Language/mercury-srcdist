...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_22, (MR_Integer) 196, &InferTypes_23);
    ...
    else
    {
      ...
      PredOrFuncStr_24 = parse_tree__prog_out__pred_or_func_to_str_1_f_0(PredOrFunc_14);
      {
        ...
        MR_hl_field(MR_mktag(1), Var_46, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds_error_scalar_common_1[13])));
      ...
      if ((OtherAritiesList_31 == (MR_Word) ((MR_Unsigned) 0U)))
      {
...

        {
          ...
          MR_hl_field(MR_mktag(1), Var_119, 0) = ((MR_Box) (MainMsg_26));
          MR_hl_field(MR_mktag(1), Var_119, 1) = ((MR_Box) ((MR_Unsigned) 0U));
        }
        {
          Spec_33 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), Spec_33, 0) = ((MR_Box) ((MR_String) "predicate \140hlds.make_hlds_error.maybe_report_undefined_pred_error\'/10"));
          MR_hl_field(MR_mktag(0), Spec_33, 1) = ((MR_Box) ((MR_Unsigned) 0U));
          MR_hl_field(MR_mktag(0), Spec_33, 2) = ((MR_Box) ((MR_Unsigned) 16U));
          MR_hl_field(MR_mktag(0), Spec_33, 3) = ((MR_Box) (Var_119));
        }
      }
      else
      {
        MR_Word Var_134 = ((MR_Word) ((MR_hl_field(MR_mktag(1), OtherAritiesList_31, (MR_Integer) 1))));
        MR_Integer Var_135 = ((MR_Integer) ((MR_hl_field(MR_mktag(1), OtherAritiesList_31, (MR_Integer) 0))));
        ...
        if ((Var_134 == (MR_Word) ((MR_Unsigned) 0U)))
        {
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(1), OtherAritiesPieces_35, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds_error_scalar_common_1[25])));
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(1), Var_114, 0) = ((MR_Box) (OtherAritiesMsg_39));
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(1), Var_113, 0) = ((MR_Box) (MainMsg_26));
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(0), Spec_33, 1) = ((MR_Box) ((MR_Unsigned) 0U));
            MR_hl_field(MR_mktag(0), Spec_33, 2) = ((MR_Box) ((MR_Unsigned) 16U));
            MR_hl_field(MR_mktag(0), Spec_33, 3) = ((MR_Box) (Var_113));
          }
        }
        else
        {
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(1), Var_131, 0) = ((MR_Box) (MainMsg_26));
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(0), Spec_33, 1) = ((MR_Box) ((MR_Unsigned) 0U));
            MR_hl_field(MR_mktag(0), Spec_33, 2) = ((MR_Box) ((MR_Unsigned) 16U));
            MR_hl_field(MR_mktag(0), Spec_33, 3) = ((MR_Box) (Var_131));
          }
        }
      }
      {
