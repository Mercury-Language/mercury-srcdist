  ...
  MR_Word * Specs_14)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_15, (MR_Integer) 67, &Warn_17);
  ...
  MR_Word * STATE_VARIABLE_Specs_46)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_22, (MR_Integer) 250, &InferTypes_23);
