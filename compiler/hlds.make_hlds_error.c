...
{
  {
    ...
    if (succeeded)
    {
      packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), ItemMercuryStatus_5, (MR_Integer) 0)));
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_22, (MR_Integer) 187, &InferTypes_23);
    ...
    else
    {
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(0), Var_51, 0) = (MR_Box) ((MR_Unsigned) (PredOrFunc_14));
      ...
      MainPieces_25 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_format_component_0), Var_43, Var_46);
      {
      ...
      else
      {
        ...
        else
        {
          ...
          OtherAritiesPieces_127 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_format_component_0), Var_70, (MR_Word) (MR_mkword(MR_mktag(1), &hlds__make_hlds_error_scalar_common_1[5])));
          {
          ...
          {
            OtherAritiesMsg_128 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
