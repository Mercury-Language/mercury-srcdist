  ...
  MR_Word * Spec_16)
{
  ...
  else
  {
    ...
    else
    {
      ...
      Var_115 = mercury__list__map_2_f_0((MR_Word) (&hlds__pred_proc_id__hlds__pred_proc_id__type_ctor_info_proc_id_0), (MR_Word) (&hlds__make_hlds_error_scalar_common_1[0]), Var_116, ProcIds_24);
