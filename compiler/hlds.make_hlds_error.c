  ...
  MR_Word * STATE_VARIABLE_Specs_42)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_22, (MR_Integer) 214, &InferTypes_23);
  ...
  else
  {
    ...
    else
    {
      ...
      if ((Var_134 == (MR_Word) ((MR_Unsigned) 0U)))
      {
        ...
        Var_103 = hlds__make_hlds_error__pred_form_arity_to_int_fixed_2_f_0(PredOrFunc_12, Var_135);
        {
