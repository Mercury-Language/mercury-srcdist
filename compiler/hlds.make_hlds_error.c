...
static /* final */ const MR_Box hlds__make_hlds_error_scalar_common_1[64][2];
...
static /* final */ const MR_Box hlds__make_hlds_error_scalar_common_1[64][2] = {
  ...
  {
    ((MR_Box) ((MR_Unsigned) 8U)),
    ((MR_Box) (MR_mkword(1, &hlds__make_hlds_error_scalar_common_1[36])))
  },
  /* row  38 */
  {
    ((MR_Box) (MR_Word) ((MR_Unsigned) 6U)),
  ...
  /* row  55 */
  {
    ((MR_Box) (MR_mkword(3, &hlds__make_hlds_error_scalar_common_1[54]))),
    ((MR_Box) ((MR_Unsigned) 0U))
  },
  /* row  56 */
  {
  ...
  /* row  57 */
  {
    ...
    ((MR_Box) (MR_mkword(1, &hlds__make_hlds_error_scalar_common_1[55])))
  },
  /* row  58 */
  {
    ((MR_Box) (MR_Word) ((MR_Unsigned) 6U)),
  ...
  MR_Integer ProcId_5)
{
  ...
  }
  {
    ...
    MR_hl_field(1, Var_8, 1) = ((MR_Box) (MR_mkword(1, &hlds__make_hlds_error_scalar_common_1[30])));
  }
  {
    HeadVar__3_3 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(1, HeadVar__3_3, 0) = ((MR_Box) (MR_mkword(3, &hlds__make_hlds_error_scalar_common_1[63])));
  ...
  MR_Word * STATE_VARIABLE_Specs_46)
{
  ...
  else
  {
    ...
    }
    {
      ...
      MR_hl_field(1, Var_48, 0) = ((MR_Box) (MR_mkword(1, &hlds__make_hlds_error_scalar_common_1[52])));
    ...
    else
    {
      ...
      if ((Var_157 == (MR_Word) ((MR_Unsigned) 0U)))
      {
        ...
        }
        {
          ...
          MR_hl_field(1, Var_94, 1) = ((MR_Box) (MR_mkword(1, &hlds__make_hlds_error_scalar_common_1[57])));
        }
        {
          Var_91 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(1, Var_91, 0) = ((MR_Box) (MR_mkword(3, &hlds__make_hlds_error_scalar_common_1[53])));
          MR_hl_field(1, Var_91, 1) = ((MR_Box) (Var_94));
        }
        {
          Var_105 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(1, Var_105, 0) = ((MR_Box) (ArityPiece_38));
          MR_hl_field(1, Var_105, 1) = ((MR_Box) (MR_mkword(1, &hlds__make_hlds_error_scalar_common_1[30])));
        }
      ...
      else
      {
        ...
        }
        {
          ...
          MR_hl_field(1, Var_118, 1) = ((MR_Box) (MR_mkword(1, &hlds__make_hlds_error_scalar_common_1[62])));
        }
        {
          Var_115 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(1, Var_115, 0) = ((MR_Box) (MR_mkword(3, &hlds__make_hlds_error_scalar_common_1[58])));
          MR_hl_field(1, Var_115, 1) = ((MR_Box) (Var_118));
        }
        Var_128 = parse_tree__error_spec__component_list_to_color_pieces_4_f_0((MR_Word) (MR_mkword(1, &hlds__make_hlds_error_scalar_common_2[1])), (MR_String) "and", (MR_Word) (MR_mkword(1, &hlds__make_hlds_error_scalar_common_1[30])), ArityPieces_43);
  ...
  MR_Word * STATE_VARIABLE_Specs_34)
{
  ...
  PredColonPieces_18 = hlds__hlds_error_util__describe_one_pred_name_5_f_0(ModuleInfo_10, (MR_Word) (MR_mkword(1, &hlds__make_hlds_error_scalar_common_2[0])), (MR_Integer) 1, (MR_Word) (MR_mkword(1, &hlds__make_hlds_error_scalar_common_1[32])), PredId_11);
  ...
  SubDeclStr_23 = parse_tree__parse_tree_out_pred_decl__mercury_mode_subdecl_to_string_6_f_0((MR_Integer) 1, PredOrFunc_20, Var_45, Var_46, StrippedArgModes_19, (MR_Word) ((MR_Unsigned) 0U));
  {
    ...
    MR_hl_field(1, Var_47, 0) = ((MR_Box) (MR_mkword(3, &hlds__make_hlds_error_scalar_common_1[33])));
  ...
  }
  {
    ...
    MR_hl_field(1, Var_68, 1) = ((MR_Box) (MR_mkword(1, &hlds__make_hlds_error_scalar_common_1[30])));
  }
  {
    Var_65 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(1, Var_65, 0) = ((MR_Box) (MR_mkword(3, &hlds__make_hlds_error_scalar_common_1[38])));
  ...
  Var_56 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), (MR_Word) (MR_mkword(1, &hlds__make_hlds_error_scalar_common_1[37])), Var_63);
  ...
  Var_50 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), (MR_Word) (MR_mkword(1, &hlds__make_hlds_error_scalar_common_1[34])), Var_55);
  ...
  if ((ProcIds_25 == (MR_Word) ((MR_Unsigned) 0U)))
  {
    ...
    }
    {
      ...
      MR_hl_field(1, Var_79, 1) = ((MR_Box) (MR_mkword(1, &hlds__make_hlds_error_scalar_common_1[41])));
    }
    {
  ...
  else
  {
    ...
    if ((ProcIdsTail_28 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      ...
      }
      {
        ...
        MR_hl_field(1, Var_90, 1) = ((MR_Box) (MR_mkword(1, &hlds__make_hlds_error_scalar_common_1[46])));
      }
      {
        Var_87 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(1, Var_87, 0) = ((MR_Box) (MR_mkword(3, &hlds__make_hlds_error_scalar_common_1[42])));
      ...
      }
      {
        ...
        MR_hl_field(1, Var_142, 1) = ((MR_Box) (MR_mkword(1, &hlds__make_hlds_error_scalar_common_1[30])));
      }
      {
        Var_100 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(1, Var_100, 0) = ((MR_Box) (MR_mkword(3, &hlds__make_hlds_error_scalar_common_1[63])));
        MR_hl_field(1, Var_100, 1) = ((MR_Box) (Var_142));
      }
      Var_99 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), Var_100, (MR_Word) (MR_mkword(1, &hlds__make_hlds_error_scalar_common_1[48])));
    ...
    else
    {
      ...
      }
      {
        ...
        MR_hl_field(1, Var_108, 1) = ((MR_Box) (MR_mkword(1, &hlds__make_hlds_error_scalar_common_1[51])));
      }
      {
        Var_105 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(1, Var_105, 0) = ((MR_Box) (MR_mkword(3, &hlds__make_hlds_error_scalar_common_1[49])));
      ...
      Var_117 = parse_tree__error_spec__component_list_to_line_pieces_2_f_0(Var_118, (MR_Word) (MR_mkword(1, &hlds__make_hlds_error_scalar_common_1[48])));
  ...
  MR_Word * STATE_VARIABLE_Specs_29)
{
  ...
  {
    MR_Word Var_118 = ((MR_Word) ((MR_hl_field(1, MaybePorF_9, (MR_Integer) 0))));
  ...
  else
  {
    ...
    mercury__list__map_3_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0), (MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&hlds__make_hlds_error_scalar_common_4[1]), OtherUserArityInts_24, &OtherArityStrs_25);
    {
      ...
      MR_hl_field(3, Var_88, 1) = ((MR_Box) (SymName_10));
    }
    conv2_Var_94 = parse_tree__error_spec__choose_number_3_f_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), OtherArityStrs_25, ((MR_Box) ((MR_String) "arity")), ((MR_Box) ((MR_String) "arities")));
    Var_94 = ((MR_String) (conv2_Var_94));
    {
    ...
    }
    {
      ...
      MR_hl_field(1, Var_89, 0) = ((MR_Box) (MR_mkword(3, &hlds__make_hlds_error_scalar_common_1[29])));
    ...
    Var_99 = parse_tree__error_spec__list_to_pieces_1_f_0(OtherArityStrs_25);
    Var_98 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), Var_99, (MR_Word) (MR_mkword(1, &hlds__make_hlds_error_scalar_common_1[30])));
    ...
    Var_85 = parse_tree__error_spec__color_as_possible_cause_1_f_0(Var_86);
    OtherArityPieces_21 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), Var_85, (MR_Word) (MR_mkword(1, &hlds__make_hlds_error_scalar_common_1[6])));
  }
