  ...
  MR_Word * Specs_14)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_15, (MR_Integer) 64, &Warn_17);
      ...
      case (MR_Integer) 1:
        {
          ...
          }
          {
            ...
            MR_hl_field(1, Var_88, 0) = ((MR_Box) (MR_mkword(3, &hlds__make_hlds_error_scalar_common_1[67])));
          ...
          Var_95 = parse_tree__error_spec__color_as_incorrect_1_f_0((MR_Word) (MR_mkword(1, &hlds__make_hlds_error_scalar_common_1[71])));
          {
            Var_111 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(1, Var_111, 0) = ((MR_Box) (Var_92));
            MR_hl_field(1, Var_111, 1) = ((MR_Box) (MR_mkword(1, &hlds__make_hlds_error_scalar_common_1[84])));
          }
          {
            Var_108 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(1, Var_108, 0) = ((MR_Box) (MR_mkword(3, &hlds__make_hlds_error_scalar_common_1[73])));
            MR_hl_field(1, Var_108, 1) = ((MR_Box) (Var_111));
          }
          {
            Var_105 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(1, Var_105, 0) = ((MR_Box) (MR_mkword(3, &hlds__make_hlds_error_scalar_common_1[72])));
            MR_hl_field(1, Var_105, 1) = ((MR_Box) (Var_108));
          }
          {
            Var_103 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(1, Var_103, 0) = ((MR_Box) ((MR_Unsigned) 12U));
          ...
          Pieces_24 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), (MR_Word) (MR_mkword(1, &hlds__make_hlds_error_scalar_common_1[66])), Var_84);
        }
        break;
      case (MR_Integer) 0:
        {
          ...
          }
          {
            ...
            MR_hl_field(1, Var_37, 0) = ((MR_Box) (MR_mkword(3, &hlds__make_hlds_error_scalar_common_1[67])));
          ...
          Var_44 = parse_tree__error_spec__color_as_incorrect_1_f_0((MR_Word) (MR_mkword(1, &hlds__make_hlds_error_scalar_common_1[71])));
          {
            Var_60 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(1, Var_60, 0) = ((MR_Box) (Var_41));
            MR_hl_field(1, Var_60, 1) = ((MR_Box) (MR_mkword(1, &hlds__make_hlds_error_scalar_common_1[89])));
          }
          {
            Var_57 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(1, Var_57, 0) = ((MR_Box) (MR_mkword(3, &hlds__make_hlds_error_scalar_common_1[85])));
            MR_hl_field(1, Var_57, 1) = ((MR_Box) (Var_60));
          }
          {
            Var_54 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(1, Var_54, 0) = ((MR_Box) (MR_mkword(3, &hlds__make_hlds_error_scalar_common_1[72])));
            MR_hl_field(1, Var_54, 1) = ((MR_Box) (Var_57));
          }
          {
            Var_52 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(1, Var_52, 0) = ((MR_Box) ((MR_Unsigned) 12U));
          ...
          Pieces_24 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), (MR_Word) (MR_mkword(1, &hlds__make_hlds_error_scalar_common_1[66])), Var_33);
        }
        break;
    }
    {
      Spec_25 = (MR_Word) MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(0, Spec_25, 0) = ((MR_Box) ((MR_String) "predicate \140hlds.make_hlds_error.warn_about_pfu_unknown\'/7"));
  ...
  MR_Word * STATE_VARIABLE_Specs_46)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_22, (MR_Integer) 244, &InferTypes_23);
  ...
  else
  {
    ...
    {
      MR_Word Var_156 = ((MR_Word) ((MR_hl_field(1, OtherPredFormAritiesList_34, (MR_Integer) 1))));
      MR_Word Var_157 = ((MR_Word) ((MR_hl_field(1, OtherPredFormAritiesList_34, (MR_Integer) 0))));
  ...
  MR_Word * HeadVar__4_4)
{
  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      succeeded = hlds__hlds_pred__marker_is_present_2_p_0(Markers_14, (MR_Integer) 4);
      if (succeeded)
  ...
  MR_Word * STATE_VARIABLE_Specs_29)
{
  ...
  {
    MR_Word Var_126 = ((MR_Word) ((MR_hl_field(1, MaybePorF_9, (MR_Integer) 0))));
