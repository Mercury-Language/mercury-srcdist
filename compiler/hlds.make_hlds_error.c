...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_22, (MR_Integer) 213, &InferTypes_23);
...
{
  {
...

    {
      ...
      MR_hl_field(MR_mktag(1), Var_16, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds_error_scalar_common_1[0])));
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), Var_22, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &hlds__make_hlds_error_scalar_common_1[26])));
    }
    {
      Var_19 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), Var_19, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds_error_scalar_common_1[18])));
...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(0), SNA_18, 0) = ((MR_Box) (Name_10));
    ...
    else
    {
      ...
      mercury__list__map_3_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0), (MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&hlds__make_hlds_error_scalar_common_4[0]), OtherArities_12, &OtherArityStrs_23);
      {
        ...
        MR_hl_field(MR_mktag(3), Var_75, 1) = ((MR_Box) (Name_10));
      }
...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(3), SNA_19, 0) = ((MR_Box) ((MR_Unsigned) 10U));
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), Var_35, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &hlds__make_hlds_error_scalar_common_1[3])));
    }
    {
    ...
    else
    {
...

      {
        ...
        MR_hl_field(MR_mktag(0), Var_53, 0) = ((MR_Box) (SecondContext_18));
        MR_hl_field(MR_mktag(0), Var_53, 1) = ((MR_Box) (ExtraPieces_14));
      }
      {
        ExtraMsgs_24 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), ExtraMsgs_24, 0) = ((MR_Box) (Var_53));
        MR_hl_field(MR_mktag(1), ExtraMsgs_24, 1) = ((MR_Box) ((MR_Unsigned) 0U));
      }
    }
    {
      Var_59 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), Var_59, 0) = ((MR_Box) (FirstDeclMsg_23));
      MR_hl_field(MR_mktag(1), Var_59, 1) = ((MR_Box) (ExtraMsgs_24));
    }
    {
      Var_58 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), Var_58, 0) = ((MR_Box) (SecondDeclMsg_22));
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(0), Spec_27, 3) = ((MR_Box) (Var_58));
    }
    {
      MR_Word base;
      base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
