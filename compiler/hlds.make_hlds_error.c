...
static /* final */ const MR_Box hlds__make_hlds_error_scalar_common_3[1][5];

static /* final */ const MR_Box hlds__make_hlds_error_scalar_common_4[1][3];
...
static /* final */ const MR_Box hlds__make_hlds_error_scalar_common_1[50][2] = {
  ...
  /* row   4 */
  {
    ...
    ((MR_Box) (MR_mkword(MR_mktag(1), &hlds__make_hlds_error_scalar_common_1[2])))
  },
  /* row   5 */
  {
    ((MR_Box) (MR_Word) ((MR_Unsigned) 5U)),
  ...
  /* row  20 */
  {
    ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds_error_scalar_common_1[19]))),
    ((MR_Box) ((MR_Unsigned) 0U))
  },
  /* row  21 */
  {
  ...
  /* row  31 */
  {
    ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds_error_scalar_common_1[30]))),
    ((MR_Box) (MR_mkword(MR_mktag(1), &hlds__make_hlds_error_scalar_common_1[2])))
  },
  /* row  32 */
  {
  ...
  /* row  34 */
  {
    ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds_error_scalar_common_1[33]))),
    ((MR_Box) ((MR_Unsigned) 0U))
  },
  /* row  35 */
  {
  ...
  /* row  36 */
  {
    ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds_error_scalar_common_1[35]))),
    ((MR_Box) (MR_mkword(MR_mktag(1), &hlds__make_hlds_error_scalar_common_1[34])))
  },
  /* row  37 */
  {
    ((MR_Box) (MR_Word) ((MR_Unsigned) 30U)),
  ...
  /* row  38 */
  {
    ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds_error_scalar_common_1[37]))),
    ((MR_Box) ((MR_Unsigned) 0U))
  },
  /* row  39 */
  {
  ...
  /* row  41 */
  {
    ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds_error_scalar_common_1[40]))),
    ((MR_Box) (MR_mkword(MR_mktag(1), &hlds__make_hlds_error_scalar_common_1[34])))
  },
  /* row  42 */
  {
  ...
  MR_Box wrapper_arg_1)
{
  ...
  conv0_Component_6 = hlds__make_hlds_error__pred_form_arity_to_int_fixed_2_f_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) (wrapper_arg_1)));
  ...
  MR_Word * STATE_VARIABLE_Specs_42)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_22, (MR_Integer) 217, &InferTypes_23);
  ...
  else
  {
...

    {
      ...
      MR_hl_field(MR_mktag(0), PFSymNameArity_24, 0) = (MR_Box) ((MR_Unsigned) (PredOrFunc_12));
      MR_hl_field(MR_mktag(0), PFSymNameArity_24, 1) = ((MR_Box) (SymName_13));
      MR_hl_field(MR_mktag(0), PFSymNameArity_24, 2) = ((MR_Box) (PredFormArity_14));
    }
    PredOrFuncStr_25 = parse_tree__prog_out__pred_or_func_to_str_1_f_0(PredOrFunc_12);
    {
      Var_47 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), Var_47, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds_error_scalar_common_1[1])));
      MR_hl_field(MR_mktag(1), Var_47, 1) = ((MR_Box) (DescPieces_18));
    }
    {
      Var_44 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), Var_44, 0) = ((MR_Box) (MR_mkword(MR_mktag(1), &hlds__make_hlds_error_scalar_common_2[0])));
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(3), Var_61, 0) = ((MR_Box) ((MR_Unsigned) 28U));
      MR_hl_field(MR_mktag(3), Var_61, 1) = ((MR_Box) (PredOrFuncStr_25));
    }
    {
      Var_60 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), Var_60, 0) = ((MR_Box) (Var_61));
      MR_hl_field(MR_mktag(1), Var_60, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &hlds__make_hlds_error_scalar_common_1[24])));
    }
    {
      Var_57 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), Var_57, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds_error_scalar_common_1[21])));
    ...
    FullPredOrFuncStr_33 = parse_tree__prog_out__pred_or_func_to_full_str_1_f_0(PredOrFunc_12);
    if ((OtherPredFormAritiesList_32 == (MR_Word) ((MR_Unsigned) 0U)))
    {
...

      {
        ...
        MR_hl_field(MR_mktag(1), Var_72, 0) = ((MR_Box) (MainMsg_27));
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(0), Spec_34, 3) = ((MR_Box) (Var_72));
      }
    }
    else
    {
      MR_Word Var_133 = ((MR_Word) ((MR_hl_field(MR_mktag(1), OtherPredFormAritiesList_32, (MR_Integer) 1))));
      MR_Word Var_134 = ((MR_Word) ((MR_hl_field(MR_mktag(1), OtherPredFormAritiesList_32, (MR_Integer) 0))));
      ...
      if ((Var_133 == (MR_Word) ((MR_Unsigned) 0U)))
      {
...

        {
          ...
          MR_hl_field(MR_mktag(3), Var_78, 1) = ((MR_Box) (FullPredOrFuncStr_33));
        }
        Var_86 = hlds__make_hlds_error__pred_form_arity_to_int_fixed_2_f_0(PredOrFunc_12, Var_134);
        {
          Var_85 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), Var_85, 0) = ((MR_Box) (Var_86));
          MR_hl_field(MR_mktag(1), Var_85, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &hlds__make_hlds_error_scalar_common_1[7])));
        }
        {
          Var_82 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), Var_82, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds_error_scalar_common_1[44])));
          MR_hl_field(MR_mktag(1), Var_82, 1) = ((MR_Box) (Var_85));
        }
        {
          Var_79 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), Var_79, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds_error_scalar_common_1[43])));
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(1), OtherAritiesPieces_36, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds_error_scalar_common_1[42])));
          MR_hl_field(MR_mktag(1), OtherAritiesPieces_36, 1) = ((MR_Box) (Var_77));
        }
        {
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(1), Var_119, 0) = ((MR_Box) (OtherAritiesMsg_40));
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(1), Var_118, 0) = ((MR_Box) (MainMsg_27));
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(0), Spec_34, 1) = ((MR_Box) ((MR_Unsigned) 0U));
          MR_hl_field(MR_mktag(0), Spec_34, 2) = ((MR_Box) ((MR_Unsigned) 40U));
          MR_hl_field(MR_mktag(0), Spec_34, 3) = ((MR_Box) (Var_118));
        }
      }
      else
      {
...

        {
          ...
          MR_hl_field(MR_mktag(3), Var_98, 1) = ((MR_Box) (FullPredOrFuncStr_33));
        }
        {
          Var_108 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), Var_108, 0) = ((MR_Box) (&hlds__make_hlds_error_scalar_common_5[1]));
          MR_hl_field(MR_mktag(0), Var_108, 1) = ((MR_Box) (hlds__make_hlds_error__maybe_report_undefined_pred_error_10_p_0_1));
          MR_hl_field(MR_mktag(0), Var_108, 2) = ((MR_Box) ((MR_Integer) 1));
          MR_hl_field(MR_mktag(0), Var_108, 3) = ((MR_Box) (PredOrFunc_12));
        }
        Var_107 = mercury__list__map_2_f_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_pred_form_arity_0), (MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_format_component_0), Var_108, OtherPredFormAritiesList_32);
        Var_105 = parse_tree__error_util__component_list_to_pieces_2_f_0((MR_String) "and", Var_107);
        {
          Var_102 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), Var_102, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds_error_scalar_common_1[47])));
          MR_hl_field(MR_mktag(1), Var_102, 1) = ((MR_Box) (Var_105));
        }
        {
          Var_99 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), Var_99, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds_error_scalar_common_1[46])));
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(1), Var_94, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds_error_scalar_common_1[45])));
          MR_hl_field(MR_mktag(1), Var_94, 1) = ((MR_Box) (Var_97));
        }
        OtherAritiesPieces_125 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_format_component_0), Var_94, (MR_Word) (MR_mkword(MR_mktag(1), &hlds__make_hlds_error_scalar_common_1[7])));
        {
          OtherAritiesMsg_126 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), OtherAritiesMsg_126, 0) = ((MR_Box) (Context_17));
          MR_hl_field(MR_mktag(0), OtherAritiesMsg_126, 1) = ((MR_Box) (OtherAritiesPieces_125));
        }
        {
          Var_131 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), Var_131, 0) = ((MR_Box) (OtherAritiesMsg_126));
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(1), Var_130, 0) = ((MR_Box) (MainMsg_27));
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(0), Spec_34, 1) = ((MR_Box) ((MR_Unsigned) 0U));
          MR_hl_field(MR_mktag(0), Spec_34, 2) = ((MR_Box) ((MR_Unsigned) 40U));
          MR_hl_field(MR_mktag(0), Spec_34, 3) = ((MR_Box) (Var_130));
        }
      }
    }
    {
  ...
  MR_Word PredFormArity_5)
{
  ...
  UserArityInt_8 = (MR_Integer) (UserArity_7);
  {
    ...
    MR_hl_field(MR_mktag(3), Component_6, 0) = ((MR_Box) ((MR_Unsigned) 1U));
    MR_hl_field(MR_mktag(3), Component_6, 1) = ((MR_Box) (UserArityInt_8));
  }
  return Component_6;
}
  ...
  MR_Word * STATE_VARIABLE_Specs_34)
{
  ...
  parse_tree__prog_mode__strip_builtin_qualifiers_from_mode_list_2_p_0(ArgModes_14, &StrippedArgModes_19);
  ...
  Var_37 = mercury__varset__coerce_1_f_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_inst_var_type_0), VarSet_13);
  {
    Var_38 = (MR_Word) MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(MR_mktag(0), Var_38, 0) = ((MR_Box) (Name_21));
  }
  SubDeclStr_23 = parse_tree__parse_tree_out_pred_decl__mercury_mode_subdecl_to_string_6_f_0((MR_Integer) 1, PredOrFunc_20, Var_37, Var_38, StrippedArgModes_19, (MR_Word) ((MR_Unsigned) 0U));
  {
    Var_39 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(MR_mktag(1), Var_39, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds_error_scalar_common_1[26])));
    MR_hl_field(MR_mktag(1), Var_39, 1) = ((MR_Box) (DescPieces_15));
  }
  {
    ...
    MR_hl_field(MR_mktag(3), Var_57, 1) = ((MR_Box) (SubDeclStr_23));
  }
  {
    Var_56 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(MR_mktag(1), Var_56, 0) = ((MR_Box) (Var_57));
    MR_hl_field(MR_mktag(1), Var_56, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &hlds__make_hlds_error_scalar_common_1[7])));
  }
  {
    Var_53 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(MR_mktag(1), Var_53, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds_error_scalar_common_1[28])));
  ...
  }
  {
    ...
    MR_hl_field(MR_mktag(1), Var_48, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds_error_scalar_common_1[27])));
    MR_hl_field(MR_mktag(1), Var_48, 1) = ((MR_Box) (Var_51));
  }
  Var_47 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_format_component_0), PredIdPieces_18, Var_48);
  Var_42 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_format_component_0), (MR_Word) (MR_mkword(MR_mktag(1), &hlds__make_hlds_error_scalar_common_1[20])), Var_47);
  MainPieces_24 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_format_component_0), Var_39, Var_42);
  ...
  if ((ProcIds_25 == (MR_Word) ((MR_Unsigned) 0U)))
  {
...

    {
      ...
      MR_hl_field(MR_mktag(3), Var_67, 1) = (MR_Box) ((MR_Unsigned) (PredOrFunc_20));
    }
    {
      Var_66 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), Var_66, 0) = ((MR_Box) (Var_67));
      MR_hl_field(MR_mktag(1), Var_66, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &hlds__make_hlds_error_scalar_common_1[31])));
    }
    {
      VerbosePieces_26 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), VerbosePieces_26, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds_error_scalar_common_1[29])));
      MR_hl_field(MR_mktag(1), VerbosePieces_26, 1) = ((MR_Box) (Var_66));
    }
  }
  else
  {
    MR_Integer ProcIdsHead_27 = ((MR_Integer) ((MR_hl_field(MR_mktag(1), ProcIds_25, (MR_Integer) 0))));
    MR_Word ProcIdsTail_28 = ((MR_Word) ((MR_hl_field(MR_mktag(1), ProcIds_25, (MR_Integer) 1))));
    ...
    if ((ProcIdsTail_28 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      ...
      }
      {
        Var_77 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), Var_77, 0) = ((MR_Box) (Var_78));
        MR_hl_field(MR_mktag(1), Var_77, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &hlds__make_hlds_error_scalar_common_1[36])));
      }
      {
        Var_74 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), Var_74, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds_error_scalar_common_1[32])));
        MR_hl_field(MR_mktag(1), Var_74, 1) = ((MR_Box) (Var_77));
      }
      Var_87 = hlds__make_hlds_error__mode_decl_for_pred_info_to_pieces_2_f_0(PredInfo_12, ProcIdsHead_27);
      Var_86 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_format_component_0), Var_87, (MR_Word) (MR_mkword(MR_mktag(1), &hlds__make_hlds_error_scalar_common_1[38])));
      VerbosePieces_26 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_format_component_0), Var_74, Var_86);
    }
    else
    {
      MR_Word Var_92;
...

      {
        ...
        MR_hl_field(MR_mktag(3), Var_96, 0) = ((MR_Box) ((MR_Unsigned) 27U));
        MR_hl_field(MR_mktag(3), Var_96, 1) = (MR_Box) ((MR_Unsigned) (PredOrFunc_20));
      }
      {
        Var_95 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), Var_95, 0) = ((MR_Box) (Var_96));
        MR_hl_field(MR_mktag(1), Var_95, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &hlds__make_hlds_error_scalar_common_1[41])));
      }
      {
        Var_92 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), Var_92, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds_error_scalar_common_1[39])));
        MR_hl_field(MR_mktag(1), Var_92, 1) = ((MR_Box) (Var_95));
      }
      {
        Var_106 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), Var_106, 0) = ((MR_Box) (&hlds__make_hlds_error_scalar_common_5[0]));
        MR_hl_field(MR_mktag(0), Var_106, 1) = ((MR_Box) (hlds__make_hlds_error__report_undeclared_mode_error_9_p_0_1));
        MR_hl_field(MR_mktag(0), Var_106, 2) = ((MR_Box) ((MR_Integer) 1));
        MR_hl_field(MR_mktag(0), Var_106, 3) = ((MR_Box) (PredInfo_12));
      }
      Var_105 = mercury__list__map_2_f_0((MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_proc_id_0), (MR_Word) (&hlds__make_hlds_error_scalar_common_1[0]), Var_106, ProcIds_25);
      Var_104 = parse_tree__error_util__component_list_to_line_pieces_2_f_0(Var_105, (MR_Word) (MR_mkword(MR_mktag(1), &hlds__make_hlds_error_scalar_common_1[38])));
      VerbosePieces_26 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_format_component_0), Var_92, Var_104);
    }
  }
  {
    Var_112 = (MR_Word) MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(MR_mktag(0), Var_112, 0) = ((MR_Box) (MainPieces_24));
  }
  {
    Var_114 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(MR_mktag(2), Var_114, 0) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 0));
    MR_hl_field(MR_mktag(2), Var_114, 1) = ((MR_Box) (VerbosePieces_26));
  }
  {
  ...
  }
  {
    ...
    MR_hl_field(MR_mktag(2), Msg_31, 0) = ((MR_Box) (Context_16));
    MR_hl_field(MR_mktag(2), Msg_31, 1) = ((MR_Box) (Var_111));
  }
  {
  ...
  }
  {
    ...
    MR_hl_field(MR_mktag(0), Spec_32, 0) = ((MR_Box) ((MR_String) "predicate \140hlds.make_hlds_error.report_undeclared_mode_error\'/9"));
  ...
  MR_Integer ProcId_5)
{
  ...
  }
  {
    ...
    MR_hl_field(MR_mktag(1), Var_8, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &hlds__make_hlds_error_scalar_common_1[49])));
  }
  {
    HeadVar__3_3 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(MR_mktag(1), HeadVar__3_3, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds_error_scalar_common_1[48])));
  ...
  MR_Word * STATE_VARIABLE_Specs_26)
{
  ...
  if ((MaybePorF_9 == (MR_Word) ((MR_Unsigned) 0U)))
  {
    ...
    PredOrFuncPieces_17 = (MR_Word) (MR_mkword(MR_mktag(1), &hlds__make_hlds_error_scalar_common_1[13]));
  }
  else
  {
    MR_Word Var_102 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MaybePorF_9, (MR_Integer) 0))));

    switch (Var_102) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 1:
        {
          SNAPrefixPieces_16 = (MR_Word) (MR_mkword(MR_mktag(1), &hlds__make_hlds_error_scalar_common_1[15]));
          PredOrFuncPieces_17 = (MR_Word) (MR_mkword(MR_mktag(1), &hlds__make_hlds_error_scalar_common_1[9]));
        }
        break;
      case (MR_Integer) 0:
        {
          SNAPrefixPieces_16 = (MR_Word) (MR_mkword(MR_mktag(1), &hlds__make_hlds_error_scalar_common_1[17]));
          PredOrFuncPieces_17 = (MR_Word) (MR_mkword(MR_mktag(1), &hlds__make_hlds_error_scalar_common_1[18]));
        }
        break;
    }
  }
  {
    ...
    MR_hl_field(MR_mktag(0), SNA_18, 0) = ((MR_Box) (SymName_10));
    MR_hl_field(MR_mktag(0), SNA_18, 1) = ((MR_Box) (Arity_11));
  }
  {
    Var_50 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(MR_mktag(1), Var_50, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds_error_scalar_common_1[1])));
    MR_hl_field(MR_mktag(1), Var_50, 1) = ((MR_Box) (DescPieces_14));
  }
  {
    Var_61 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(MR_mktag(3), Var_61, 0) = ((MR_Box) ((MR_Unsigned) 11U));
    MR_hl_field(MR_mktag(3), Var_61, 1) = ((MR_Box) (SNA_18));
  }
  {
    Var_60 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(MR_mktag(1), Var_60, 0) = ((MR_Box) (Var_61));
    MR_hl_field(MR_mktag(1), Var_60, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &hlds__make_hlds_error_scalar_common_1[22])));
  }
  Var_66 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_format_component_0), PredOrFuncPieces_17, (MR_Word) (MR_mkword(MR_mktag(1), &hlds__make_hlds_error_scalar_common_1[24])));
  Var_59 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_format_component_0), Var_60, Var_66);
  Var_58 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_format_component_0), SNAPrefixPieces_16, Var_59);
  Var_53 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_format_component_0), (MR_Word) (MR_mkword(MR_mktag(1), &hlds__make_hlds_error_scalar_common_1[20])), Var_58);
  MainPieces_19 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_format_component_0), Var_50, Var_53);
  if ((OtherArities_12 == (MR_Word) ((MR_Unsigned) 0U)))
    OtherArityPieces_20 = (MR_Word) ((MR_Unsigned) 0U);
  else
  {
    MR_Word OtherArityStrs_23;
    MR_Word Var_74;
    MR_Word Var_75;
    MR_Word Var_76;
    MR_Word Var_79;
    ...
    mercury__list__map_3_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0), (MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&hlds__make_hlds_error_scalar_common_4[0]), OtherArities_12, &OtherArityStrs_23);
    {
      ...
      MR_hl_field(MR_mktag(3), Var_75, 1) = ((MR_Box) (SymName_10));
    }
    conv1_Var_81 = parse_tree__error_util__choose_number_3_f_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), OtherArityStrs_23, ((MR_Box) ((MR_String) "arity")), ((MR_Box) ((MR_String) "arities")));
    Var_81 = ((MR_String) (conv1_Var_81));
    {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), Var_76, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds_error_scalar_common_1[25])));
    ...
    Var_86 = parse_tree__error_util__list_to_pieces_1_f_0(OtherArityStrs_23);
    Var_85 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_format_component_0), Var_86, (MR_Word) (MR_mkword(MR_mktag(1), &hlds__make_hlds_error_scalar_common_1[7])));
    OtherArityPieces_20 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_format_component_0), Var_74, Var_85);
  }
  Var_96 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_format_component_0), MainPieces_19, OtherArityPieces_20);
  {
    Spec_24 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(MR_mktag(1), Spec_24, 0) = ((MR_Box) ((MR_String) "predicate \140hlds.make_hlds_error.report_undefined_pred_or_func_error\'/8"));
    ...
    MR_hl_field(MR_mktag(1), Spec_24, 4) = ((MR_Box) (Var_96));
  }
  {
    MR_Word base;
    base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
  ...
  MR_Word * STATE_VARIABLE_Specs_30)
{
  ...
  UserArityInt_19 = (MR_Integer) (UserArity_11);
  {
    ...
    MR_hl_field(MR_mktag(0), SNA_20, 0) = ((MR_Box) (SymName_10));
  ...
  }
  {
    ...
    MR_hl_field(MR_mktag(2), Var_34, 0) = ((MR_Box) (EntityKind_9));
  }
  {
    ...
    MR_hl_field(MR_mktag(3), Var_36, 1) = ((MR_Box) (SNA_20));
  }
  {
    Var_35 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(MR_mktag(1), Var_35, 0) = ((MR_Box) (Var_36));
    MR_hl_field(MR_mktag(1), Var_35, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &hlds__make_hlds_error_scalar_common_1[4])));
  }
  {
  ...
  }
  {
    ...
    MR_hl_field(MR_mktag(1), SecondDeclPieces_21, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds_error_scalar_common_1[1])));
    MR_hl_field(MR_mktag(1), SecondDeclPieces_21, 1) = ((MR_Box) (Var_33));
  }
  {
    Var_47 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(MR_mktag(1), Var_47, 0) = ((MR_Box) (Var_36));
    MR_hl_field(MR_mktag(1), Var_47, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &hlds__make_hlds_error_scalar_common_1[7])));
  }
  {
    Var_45 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(MR_mktag(1), Var_45, 0) = ((MR_Box) (Var_34));
    MR_hl_field(MR_mktag(1), Var_45, 1) = ((MR_Box) (Var_47));
  }
  {
    FirstDeclPieces_22 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(MR_mktag(1), FirstDeclPieces_22, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds_error_scalar_common_1[5])));
    MR_hl_field(MR_mktag(1), FirstDeclPieces_22, 1) = ((MR_Box) (Var_45));
  }
  {
    SecondDeclMsg_23 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(MR_mktag(0), SecondDeclMsg_23, 0) = ((MR_Box) (SecondContext_18));
    MR_hl_field(MR_mktag(0), SecondDeclMsg_23, 1) = ((MR_Box) (SecondDeclPieces_21));
  }
  {
    FirstDeclMsg_24 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(MR_mktag(0), FirstDeclMsg_24, 0) = ((MR_Box) (FirstContext_17));
    MR_hl_field(MR_mktag(0), FirstDeclMsg_24, 1) = ((MR_Box) (FirstDeclPieces_22));
  }
  ...
  else
  {
...

    {
      ...
      MR_hl_field(MR_mktag(0), Var_55, 0) = ((MR_Box) (SecondContext_18));
      MR_hl_field(MR_mktag(0), Var_55, 1) = ((MR_Box) (ExtraPieces_14));
    }
    {
      ExtraMsgs_25 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), ExtraMsgs_25, 0) = ((MR_Box) (Var_55));
      MR_hl_field(MR_mktag(1), ExtraMsgs_25, 1) = ((MR_Box) ((MR_Unsigned) 0U));
    }
  }
  {
    Var_61 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(MR_mktag(1), Var_61, 0) = ((MR_Box) (FirstDeclMsg_24));
    MR_hl_field(MR_mktag(1), Var_61, 1) = ((MR_Box) (ExtraMsgs_25));
  }
  {
    Var_60 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(MR_mktag(1), Var_60, 0) = ((MR_Box) (SecondDeclMsg_23));
    MR_hl_field(MR_mktag(1), Var_60, 1) = ((MR_Box) (Var_61));
  }
  {
    Spec_28 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(MR_mktag(0), Spec_28, 0) = ((MR_Box) ((MR_String) "predicate \140hlds.make_hlds_error.report_multiply_defined\'/8"));
    MR_hl_field(MR_mktag(0), Spec_28, 1) = ((MR_Box) ((MR_Unsigned) 0U));
    MR_hl_field(MR_mktag(0), Spec_28, 2) = ((MR_Box) ((MR_Unsigned) 40U));
    MR_hl_field(MR_mktag(0), Spec_28, 3) = ((MR_Box) (Var_60));
  }
  {
    MR_Word base;
    base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
