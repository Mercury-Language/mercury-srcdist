...
static /* final */ const MR_Box hlds__make_hlds_error_scalar_common_1[51][2];
  ...
  MR_Integer ProcId_5)
{
  ...
  }
  {
    ...
    MR_hl_field(1, Var_8, 1) = ((MR_Box) (MR_mkword(1, &hlds__make_hlds_error_scalar_common_1[50])));
  }
  {
    HeadVar__3_3 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(1, HeadVar__3_3, 0) = ((MR_Box) (MR_mkword(3, &hlds__make_hlds_error_scalar_common_1[49])));
  ...
  MR_Word * STATE_VARIABLE_Specs_42)
{
  ...
  else
  {
    ...
    PredOrFuncStr_25 = mdbcomp__prim_data__pred_or_func_to_str_1_f_0(PredOrFunc_12);
    {
      ...
      MR_hl_field(1, Var_48, 0) = ((MR_Box) (MR_mkword(3, &hlds__make_hlds_error_scalar_common_1[1])));
      MR_hl_field(1, Var_48, 1) = ((MR_Box) (DescPieces_18));
    }
    {
      Var_44 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(1, Var_44, 0) = ((MR_Box) (MR_mkword(1, &hlds__make_hlds_error_scalar_common_1[42])));
    ...
    }
    {
      ...
      MR_hl_field(3, Var_55, 1) = ((MR_Box) (PFSymNameArity_24));
    }
    {
      Var_62 = (MR_Word) MR_mkword(3, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(3, Var_62, 0) = ((MR_Box) ((MR_Unsigned) 31U));
      MR_hl_field(3, Var_62, 1) = ((MR_Box) (PredOrFuncStr_25));
    }
    {
      Var_61 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(1, Var_61, 0) = ((MR_Box) (Var_62));
      MR_hl_field(1, Var_61, 1) = ((MR_Box) (MR_mkword(1, &hlds__make_hlds_error_scalar_common_1[24])));
    }
    {
    ...
    }
    {
      ...
      MR_hl_field(1, Var_51, 0) = ((MR_Box) (MR_mkword(3, &hlds__make_hlds_error_scalar_common_1[19])));
    ...
    if ((OtherPredFormAritiesList_32 == (MR_Word) ((MR_Unsigned) 0U)))
    {
...

      {
        ...
        MR_hl_field(1, Var_73, 0) = ((MR_Box) (MainMsg_27));
      ...
      }
      {
        ...
        MR_hl_field(2, Spec_34, 3) = ((MR_Box) (Var_73));
      }
    }
    else
    {
      MR_Word Var_134 = ((MR_Word) ((MR_hl_field(1, OtherPredFormAritiesList_32, (MR_Integer) 1))));
      MR_Word Var_135 = ((MR_Word) ((MR_hl_field(1, OtherPredFormAritiesList_32, (MR_Integer) 0))));
      ...
      if ((Var_134 == (MR_Word) ((MR_Unsigned) 0U)))
      {
...

        {
          ...
          MR_hl_field(3, Var_79, 1) = ((MR_Box) (FullPredOrFuncStr_33));
        }
        ...
        UserArityInt_137 = (MR_Integer) (UserArity_136);
        {
          ...
          MR_hl_field(3, Var_87, 1) = ((MR_Box) (UserArityInt_137));
        }
        {
          Var_86 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(1, Var_86, 0) = ((MR_Box) (Var_87));
          MR_hl_field(1, Var_86, 1) = ((MR_Box) (MR_mkword(1, &hlds__make_hlds_error_scalar_common_1[7])));
        }
        {
          Var_83 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(1, Var_83, 0) = ((MR_Box) (MR_mkword(3, &hlds__make_hlds_error_scalar_common_1[45])));
          MR_hl_field(1, Var_83, 1) = ((MR_Box) (Var_86));
        }
        {
          Var_80 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(1, Var_80, 0) = ((MR_Box) (MR_mkword(3, &hlds__make_hlds_error_scalar_common_1[44])));
        ...
        }
        {
          ...
          MR_hl_field(1, OtherAritiesPieces_36, 0) = ((MR_Box) (MR_mkword(3, &hlds__make_hlds_error_scalar_common_1[43])));
          MR_hl_field(1, OtherAritiesPieces_36, 1) = ((MR_Box) (Var_78));
        }
        {
        ...
        }
        {
          ...
          MR_hl_field(1, Var_120, 0) = ((MR_Box) (OtherAritiesMsg_40));
          MR_hl_field(1, Var_120, 1) = ((MR_Box) ((MR_Unsigned) 0U));
        }
        {
          Var_119 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(1, Var_119, 0) = ((MR_Box) (MainMsg_27));
        ...
        }
        {
          ...
          MR_hl_field(2, Spec_34, 1) = ((MR_Box) ((MR_Unsigned) 0U));
          MR_hl_field(2, Spec_34, 2) = ((MR_Box) ((MR_Unsigned) 44U));
          MR_hl_field(2, Spec_34, 3) = ((MR_Box) (Var_119));
        }
      }
      else
      {
...

        {
          ...
          MR_hl_field(3, Var_99, 1) = ((MR_Box) (FullPredOrFuncStr_33));
        }
        {
          Var_109 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(0, Var_109, 0) = ((MR_Box) (&hlds__make_hlds_error_scalar_common_4[1]));
          MR_hl_field(0, Var_109, 1) = ((MR_Box) (hlds__make_hlds_error__maybe_report_undefined_pred_error_10_p_0_1));
          MR_hl_field(0, Var_109, 2) = ((MR_Box) ((MR_Integer) 1));
          MR_hl_field(0, Var_109, 3) = ((MR_Box) (PredOrFunc_12));
        }
        Var_108 = mercury__list__map_2_f_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_pred_form_arity_0), (MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), Var_109, OtherPredFormAritiesList_32);
        Var_106 = parse_tree__error_spec__component_list_to_pieces_2_f_0((MR_String) "and", Var_108);
        {
          Var_103 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(1, Var_103, 0) = ((MR_Box) (MR_mkword(3, &hlds__make_hlds_error_scalar_common_1[48])));
          MR_hl_field(1, Var_103, 1) = ((MR_Box) (Var_106));
        }
        {
          Var_100 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(1, Var_100, 0) = ((MR_Box) (MR_mkword(3, &hlds__make_hlds_error_scalar_common_1[47])));
        ...
        }
        {
          ...
          MR_hl_field(1, Var_95, 0) = ((MR_Box) (MR_mkword(3, &hlds__make_hlds_error_scalar_common_1[46])));
          MR_hl_field(1, Var_95, 1) = ((MR_Box) (Var_98));
        }
        OtherAritiesPieces_126 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), Var_95, (MR_Word) (MR_mkword(1, &hlds__make_hlds_error_scalar_common_1[7])));
        {
          OtherAritiesMsg_127 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(0, OtherAritiesMsg_127, 0) = ((MR_Box) (Context_17));
          MR_hl_field(0, OtherAritiesMsg_127, 1) = ((MR_Box) (OtherAritiesPieces_126));
        }
        {
          Var_132 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(1, Var_132, 0) = ((MR_Box) (OtherAritiesMsg_127));
        ...
        }
        {
          ...
          MR_hl_field(1, Var_131, 0) = ((MR_Box) (MainMsg_27));
        ...
        }
        {
          ...
          MR_hl_field(2, Spec_34, 1) = ((MR_Box) ((MR_Unsigned) 0U));
          MR_hl_field(2, Spec_34, 2) = ((MR_Box) ((MR_Unsigned) 44U));
          MR_hl_field(2, Spec_34, 3) = ((MR_Box) (Var_131));
        }
      }
    }
    {
  ...
  MR_Word * STATE_VARIABLE_Specs_34)
{
  ...
  SubDeclStr_23 = parse_tree__parse_tree_out_pred_decl__mercury_mode_subdecl_to_string_6_f_0((MR_Integer) 1, PredOrFunc_20, Var_39, Var_40, StrippedArgModes_19, (MR_Word) ((MR_Unsigned) 0U));
  {
    ...
    MR_hl_field(1, Var_41, 0) = ((MR_Box) (MR_mkword(3, &hlds__make_hlds_error_scalar_common_1[26])));
    MR_hl_field(1, Var_41, 1) = ((MR_Box) (DescPieces_15));
  }
  {
    Var_59 = (MR_Word) MR_mkword(3, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(3, Var_59, 0) = ((MR_Box) ((MR_Unsigned) 0U));
    MR_hl_field(3, Var_59, 1) = ((MR_Box) (SubDeclStr_23));
  }
  {
    Var_58 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(1, Var_58, 0) = ((MR_Box) (Var_59));
    MR_hl_field(1, Var_58, 1) = ((MR_Box) (MR_mkword(1, &hlds__make_hlds_error_scalar_common_1[7])));
  }
  {
    Var_55 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(1, Var_55, 0) = ((MR_Box) (MR_mkword(3, &hlds__make_hlds_error_scalar_common_1[28])));
  ...
  }
  {
    ...
    MR_hl_field(1, Var_50, 0) = ((MR_Box) (MR_mkword(3, &hlds__make_hlds_error_scalar_common_1[27])));
  ...
  Var_44 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), (MR_Word) (MR_mkword(1, &hlds__make_hlds_error_scalar_common_1[20])), Var_49);
  ...
  if ((ProcIds_25 == (MR_Word) ((MR_Unsigned) 0U)))
  {
...

    {
      ...
      MR_hl_field(3, Var_69, 0) = ((MR_Box) ((MR_Unsigned) 28U));
      MR_hl_field(3, Var_69, 1) = (MR_Box) ((MR_Unsigned) (PredOrFunc_20));
    }
    {
      Var_68 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(1, Var_68, 0) = ((MR_Box) (Var_69));
      MR_hl_field(1, Var_68, 1) = ((MR_Box) (MR_mkword(1, &hlds__make_hlds_error_scalar_common_1[31])));
    }
    {
      ...
      MR_hl_field(1, VerbosePieces_26, 1) = ((MR_Box) (Var_68));
    }
  }
  else
  {
    ...
    if ((ProcIdsTail_28 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      ...
      }
      {
        ...
        MR_hl_field(1, Var_79, 1) = ((MR_Box) (MR_mkword(1, &hlds__make_hlds_error_scalar_common_1[36])));
      }
      {
        Var_76 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(1, Var_76, 0) = ((MR_Box) (MR_mkword(3, &hlds__make_hlds_error_scalar_common_1[32])));
        MR_hl_field(1, Var_76, 1) = ((MR_Box) (Var_79));
      }
      Var_133 = check_hlds__mode_errors__mode_decl_to_string_3_f_0((MR_Integer) 1, ProcIdsHead_27, PredInfo_12);
      {
      ...
      }
      {
        ...
        MR_hl_field(1, Var_131, 1) = ((MR_Box) (MR_mkword(1, &hlds__make_hlds_error_scalar_common_1[50])));
      }
      {
        Var_89 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(1, Var_89, 0) = ((MR_Box) (MR_mkword(3, &hlds__make_hlds_error_scalar_common_1[49])));
        MR_hl_field(1, Var_89, 1) = ((MR_Box) (Var_131));
      }
      Var_88 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), Var_89, (MR_Word) (MR_mkword(1, &hlds__make_hlds_error_scalar_common_1[38])));
      VerbosePieces_26 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), Var_76, Var_88);
    }
    else
    {
      MR_Word Var_94;
...

      {
        ...
        MR_hl_field(3, Var_98, 0) = ((MR_Box) ((MR_Unsigned) 28U));
        MR_hl_field(3, Var_98, 1) = (MR_Box) ((MR_Unsigned) (PredOrFunc_20));
      }
      {
        Var_97 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(1, Var_97, 0) = ((MR_Box) (Var_98));
        MR_hl_field(1, Var_97, 1) = ((MR_Box) (MR_mkword(1, &hlds__make_hlds_error_scalar_common_1[41])));
      }
      {
        Var_94 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(1, Var_94, 0) = ((MR_Box) (MR_mkword(3, &hlds__make_hlds_error_scalar_common_1[39])));
        MR_hl_field(1, Var_94, 1) = ((MR_Box) (Var_97));
      }
      {
        Var_108 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(0, Var_108, 0) = ((MR_Box) (&hlds__make_hlds_error_scalar_common_4[0]));
        MR_hl_field(0, Var_108, 1) = ((MR_Box) (hlds__make_hlds_error__report_undeclared_mode_error_9_p_0_1));
        MR_hl_field(0, Var_108, 2) = ((MR_Box) ((MR_Integer) 1));
        MR_hl_field(0, Var_108, 3) = ((MR_Box) (PredInfo_12));
      }
      Var_107 = mercury__list__map_2_f_0((MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_proc_id_0), (MR_Word) (&hlds__make_hlds_error_scalar_common_1[0]), Var_108, ProcIds_25);
      Var_106 = parse_tree__error_spec__component_list_to_line_pieces_2_f_0(Var_107, (MR_Word) (MR_mkword(1, &hlds__make_hlds_error_scalar_common_1[38])));
      VerbosePieces_26 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), Var_94, Var_106);
    }
  }
  {
    Var_114 = (MR_Word) MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(0, Var_114, 0) = ((MR_Box) (MainPieces_24));
  }
  {
    Var_116 = (MR_Word) MR_mkword(2, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(2, Var_116, 0) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 0));
    MR_hl_field(2, Var_116, 1) = ((MR_Box) (VerbosePieces_26));
  }
  {
  ...
  }
  {
    ...
    MR_hl_field(2, Msg_31, 1) = ((MR_Box) (Var_113));
  }
  {
    Var_122 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(1, Var_122, 0) = ((MR_Box) (Msg_31));
  ...
  }
  {
    ...
    MR_hl_field(2, Spec_32, 3) = ((MR_Box) (Var_122));
  }
  {
    MR_Word base;
    base = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
  ...
  MR_Word * STATE_VARIABLE_Specs_28)
{
  ...
  Var_99 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), MainPieces_20, OtherArityPieces_21);
  {
    ...
    MR_hl_field(0, Spec_26, 0) = ((MR_Box) ((MR_String) "predicate \140hlds.make_hlds_error.report_undefined_pred_or_func_error\'/8"));
    ...
    MR_hl_field(0, Spec_26, 4) = ((MR_Box) (Var_99));
  }
  {
    MR_Word base;
    base = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
  ...
  MR_Word * STATE_VARIABLE_Specs_30)
{
  ...
  }
  {
    ...
    MR_hl_field(2, Spec_28, 3) = ((MR_Box) (Var_60));
  }
  {
    MR_Word base;
    base = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
