        ...
        case (MR_Integer) 0:
          {
            ...
            }
            {
              ...
              MR_hl_field(2, Spec_38, 2) = ((MR_Box) ((MR_Unsigned) 44U));
  ...
  MR_Word * STATE_VARIABLE_Specs_34)
{
  ...
  ProcIds_25 = hlds__hlds_pred__pred_info_all_proc_ids_1_f_0(PredInfo_12);
  ...
  else
  {
    ...
    if ((ProcIdsTail_28 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      ...
      }
      {
        ...
        MR_hl_field(1, Var_100, 0) = ((MR_Box) (MR_mkword(3, &hlds__make_hlds_error_scalar_common_1[96])));
  ...
  }
  {
    ...
    MR_hl_field(1, Var_128, 0) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 0));
    MR_hl_field(1, Var_128, 1) = ((MR_Box) (VerbosePieces_26));
  }
  {
    Var_127 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
