  ...
  MR_Word * Specs_14)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_15, (MR_Integer) 225, &Warn_17);
  ...
  if (succeeded)
  {
    ...
    if (succeeded)
    {
      Var_27 = ((MR_Word) ((MR_hl_field(3, OpMode_18, 0))));
      succeeded = ((MR_tag((MR_Word) Var_27)) == (MR_Integer) 3);
      if (succeeded)
      {
        Var_28 = ((MR_Word) ((MR_hl_field(3, Var_27, 0))));
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            Var_140 = ((MR_Word) ((MR_hl_field(1, SymName_11, 0))));
      ...
      case (MR_Integer) 1:
        {
...

          {
            ...
            MR_hl_field(3, Var_87, 0) = ((MR_Box) ((MR_Unsigned) 36U));
  ...
  MR_Word * STATE_VARIABLE_Specs_46)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_22, (MR_Integer) 123, &InferTypes_23);
