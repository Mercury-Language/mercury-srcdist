  ...
  MR_Word * STATE_VARIABLE_Specs_42)
{
  ...
  else
  {
...

    {
      ...
      MR_hl_field(MR_mktag(0), PFSymNameArity_24, 2) = ((MR_Box) (Arity_14));
    }
    ...
    mercury__set__delete_3_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0), ((MR_Box) (Arity_14)), PorFArities_30, &OtherArities_31);
    ...
    else
    {
      ...
      else
      {
        ...
        Var_83 = mercury__list__map_2_f_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0), (MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_format_component_0), (MR_Word) (&hlds__make_hlds_error_scalar_common_4[1]), OtherAritiesList_32);
