  ...
  else
  {
    ...
    else
    {
      ...
      if ((Var_134 == (MR_Word) ((MR_Unsigned) 0U)))
      {
        ...
        MR_Word Var_113;
        MR_Word Var_114;
        MR_Word UserArity_136;
        MR_Integer UserArityInt_137;
        ...
        parse_tree__prog_util__user_arity_pred_form_arity_3_p_1(PredOrFunc_12, &UserArity_136, Var_135);
        UserArityInt_137 = (MR_Integer) (UserArity_136);
        {
          ...
          MR_hl_field(MR_mktag(3), Var_103, 1) = ((MR_Box) (UserArityInt_137));
        }
        {
      ...
      else
      {
        ...
        OtherAritiesPieces_126 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_format_component_0), Var_70, (MR_Word) (MR_mkword(MR_mktag(1), &hlds__make_hlds_error_scalar_common_1[7])));
        {
