...
{
  {
    ...
    else
    {
      ...
      {
        MainMsg_26 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), MainMsg_26, 0) = ((MR_Box) (Context_17));
        MR_hl_field(MR_mktag(1), MainMsg_26, 1) = ((MR_Box) (Var_68));
      }
      ...
      else
      {
        ...
        if ((Var_140 == (MR_Word) ((MR_Unsigned) 0U)))
        {
          ...
          {
            OtherAritiesMsg_39 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), OtherAritiesMsg_39, 0) = ((MR_Box) (Context_17));
            MR_hl_field(MR_mktag(1), OtherAritiesMsg_39, 1) = ((MR_Box) (Var_113));
          }
          {
        ...
        else
        {
          ...
          {
            OtherAritiesMsg_131 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), OtherAritiesMsg_131, 0) = ((MR_Box) (Context_17));
            MR_hl_field(MR_mktag(1), OtherAritiesMsg_131, 1) = ((MR_Box) (Var_132));
          }
          {
...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), Msg_19, 0) = ((MR_Box) (Context_11));
      MR_hl_field(MR_mktag(1), Msg_19, 1) = ((MR_Box) (Var_70));
    }
    {
      Var_76 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
...
{
  {
    ...
    {
      SecondDeclMsg_22 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), SecondDeclMsg_22, 0) = ((MR_Box) (SecondContext_18));
      MR_hl_field(MR_mktag(1), SecondDeclMsg_22, 1) = ((MR_Box) (Var_53));
    }
    {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(2), FirstDeclMsg_23, 0) = ((MR_Box) (Var_56));
      ...
      MR_hl_field(MR_mktag(2), FirstDeclMsg_23, 3) = ((MR_Box) (Var_59));
    }
    ...
    else
    {
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(1), Var_62, 0) = ((MR_Box) (SecondContext_18));
