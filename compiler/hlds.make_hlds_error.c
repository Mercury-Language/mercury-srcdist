...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_22, (MR_Integer) 191, &InferTypes_23);
...
{
  {
    ...
    {
      Msg1_18 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
    ...
    {
      Msg2_19 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), Msg2_19, 0) = ((MR_Box) (Var_55));
      MR_hl_field(MR_mktag(1), Msg2_19, 1) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 0));
    ...
    if ((ExtraPieces_14 == (MR_Word) ((MR_Unsigned) 0U)))
      ExtraMsgs_20 = (MR_Word) ((MR_Unsigned) 0U);
    else
    {
      MR_Word Var_61;
      MR_Word Var_62;
      ...
      {
        ExtraMsgs_20 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), ExtraMsgs_20, 0) = ((MR_Box) (Var_61));
        MR_hl_field(MR_mktag(1), ExtraMsgs_20, 1) = ((MR_Box) ((MR_Unsigned) 0U));
      }
    }
    {
      Var_70 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
