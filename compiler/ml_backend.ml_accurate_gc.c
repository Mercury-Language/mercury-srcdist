...
MR_def_label(ml_backend__ml_accurate_gc__ml_gen_gc_statement_2_7_0,58)
	...
	{
	MR_Word MR_tempr1;
	MR_tempr1 = ((MR_Word *) &mercury_vector_common_11_0)[(MR_Integer) MR_r2];
	MR_r3 = MR_tempr1;
	if (((MR_Integer) MR_tempr1 && (strcmp((char *) (MR_Word *) MR_tempr1, (char *) (MR_Word *) MR_sv(7)) == 0))) {
		MR_GOTO_LAB(ml_backend__ml_accurate_gc__ml_gen_gc_statement_2_7_0_i60);
	}
	MR_r1 = ((MR_Word *) &mercury_vector_common_11_0)[((MR_Integer) MR_r2 + (MR_Integer) 1)];
