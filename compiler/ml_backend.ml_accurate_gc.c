...
{
  {
    ...
    else
    {
      ...
      else
      {
        ...
        mercury__builtin__compare_3_p_0((MR_Word) (&ml_backend__ml_accurate_gc_scalar_common_1[3]), &SubResult2_9, ((MR_Box) (ArgX2_7)), ((MR_Box) (ArgY2_8)));
...
{
  {
    ...
    ml_backend__ml_gen_info__ml_gen_info_get_var_types_2_p_0(*STATE_VARIABLE_Info_40, &VarTypes_31);
    {
      ...
      MR_hl_field(MR_mktag(0), GenLocalVarDecl_32, 2) = ((MR_Box) ((MR_Integer) 4));
