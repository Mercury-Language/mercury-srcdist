  ...
  MR_Word LambdaHeadVar__1_51)
{
  ...
  hlds__var_table__lookup_var_entry_3_p_0(VarTable_30, LambdaHeadVar__1_51, &Entry_34);
  ...
  MR_Word * STATE_VARIABLE_Info_13)
{
  ...
  ml_backend__ml_gen_info__ml_gen_info_get_gc_2_p_0(STATE_VARIABLE_Info_0_12, &GC_23);
  succeeded = (GC_23 == (MR_Integer) 5);
  if (succeeded)
  {
    MR_Word HowToGetTypeInfo_24;

    {
      HowToGetTypeInfo_24 = (MR_Word) MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), HowToGetTypeInfo_24, 0) = ((MR_Box) (Type_8));
    }
    ml_backend__ml_accurate_gc__ml_do_gen_gc_statement_7_p_0(VarName_7, Type_8, HowToGetTypeInfo_24, Context_9, GCStmt_10, STATE_VARIABLE_Info_0_12, STATE_VARIABLE_Info_13);
  }
  else
  {
  ...
  MR_Word * STATE_VARIABLE_Info_27)
{
  ...
  switch (MR_tag((MR_Word) MLDS_DeclType_15)) {
    ...
    case (MR_Integer) 1:
      {
        ...
        MR_Word Var_47 = (MR_Word) (MR_body((MR_Word) (MLDS_DeclType_15), (MR_Integer) 1));

        ClassKind_36 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Var_47, (MR_Integer) 2))) & (MR_Integer) 3);
        succeeded = (ClassKind_36 == (MR_Integer) 3);
        if (succeeded)
          succeeded = MR_FALSE;
        else
          succeeded = MR_TRUE;
    ...
    case (MR_Integer) 3:
      switch (((MR_Integer) ((MR_hl_field(MR_mktag(3), MLDS_DeclType_15, (MR_Integer) 0))))) {
        ...
        case (MR_Integer) 0:
          {
            MR_Word TypeCategory_33 = ((MR_Word) ((MR_hl_field(MR_mktag(3), MLDS_DeclType_15, (MR_Integer) 2))));

            switch (MR_tag((MR_Word) TypeCategory_33)) {
              default:
                succeeded = MR_FALSE;
                break;
              case (MR_Integer) 0:
                switch (MR_unmkbody(TypeCategory_33)) {
                  default:
                    succeeded = MR_FALSE;
                    break;
                  case (MR_Integer) 0:
              ...
              case (MR_Integer) 1:
                {
                  MR_Word Var_65 = ((MR_Word) ((MR_hl_field(MR_mktag(1), TypeCategory_33, (MR_Integer) 0))));

                  succeeded = (Var_65 == (MR_Word) ((MR_Unsigned) 8U));
                }
                break;
              case (MR_Integer) 3:
                switch (((MR_Integer) ((MR_hl_field(MR_mktag(3), TypeCategory_33, (MR_Integer) 0))))) {
                  default: /*NOTREACHED*/ MR_assert(0);
                  case (MR_Integer) 0:
                    {
                      MR_Word Var_66 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(3), TypeCategory_33, (MR_Integer) 1))) & (MR_Integer) 3);
                  ...
                  case (MR_Integer) 1:
                    {
                      MR_Word Var_67 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(3), TypeCategory_33, (MR_Integer) 1))) & (MR_Integer) 7);
  ...
  if (succeeded)
  {
    ...
    else
    {
      ...
      MR_Word TypeName_70;
      MR_Word PrivateBuiltin_73;
      MR_String Name_74;
      MR_Word Var_75;
      MR_Integer slot_0;
      MR_String str_1;

      succeeded = ((MR_tag((MR_Word) ActualType0_21)) == (MR_Integer) 1);
      if (succeeded)
      {
        TypeName_70 = ((MR_Word) ((MR_hl_field(MR_mktag(1), ActualType0_21, (MR_Integer) 0))));
        succeeded = ((MR_tag((MR_Word) TypeName_70)) == (MR_Integer) 1);
        if (succeeded)
        {
          PrivateBuiltin_73 = ((MR_Word) ((MR_hl_field(MR_mktag(1), TypeName_70, (MR_Integer) 0))));
          Name_74 = ((MR_String) ((MR_hl_field(MR_mktag(1), TypeName_70, (MR_Integer) 1))));
          Var_75 = mdbcomp__builtin_modules__mercury_private_builtin_module_0_f_0();
          succeeded = mdbcomp__sym_name____Unify____sym_name_0_0(PrivateBuiltin_73, Var_75);
          if (succeeded)
          {
            ...
            ;
            slot_0 = ((MR_hash_string5(Name_74)) & (MR_Integer) 15);
            // hash chain loop
            ;
            do
            {
              ...
              // did we find a match?
              ;
              if ((((str_1 != NULL)) && ((strcmp(str_1, Name_74) == 0))))
              {
  ...
  MR_Word * STATE_VARIABLE_Info_40)
{
  ...
  MR_Word Var_57;
  MR_Word Var_58;
  MR_Word ModuleInfo0_78;
  MR_Word PredProcId_79;
  MR_Word PredInfo0_80;
  MR_Word ProcInfo0_81;
  MR_Word ModuleInfo1_82;
  MR_Word PredInfo_83;
  MR_Word ProcInfo_84;
  ...
  MR_Word VarTypes_87;
  MR_Word VarTable_88;
  MR_Word STATE_VARIABLE_Info_25_89;

  ml_backend__ml_gen_info__ml_gen_info_get_module_info_2_p_0(STATE_VARIABLE_Info_0_39, &ModuleInfo0_78);
  ml_backend__ml_gen_info__ml_gen_info_get_pred_proc_id_2_p_0(STATE_VARIABLE_Info_0_39, &PredProcId_79);
  hlds__hlds_module__module_info_pred_proc_info_4_p_0(ModuleInfo0_78, PredProcId_79, &PredInfo0_80, &ProcInfo0_81);
  check_hlds__polymorphism_type_info__polymorphism_make_type_info_var_raw_10_p_0(ActualType_10, Context_11, &TypeInfoVar_14, &HLDS_TypeInfoGoals_15, ModuleInfo0_78, &ModuleInfo1_82, PredInfo0_80, &PredInfo_83, ProcInfo0_81, &ProcInfo_84);
  hlds__hlds_module__module_info_set_pred_proc_info_5_p_0(PredProcId_79, PredInfo_83, ProcInfo_84, ModuleInfo1_82, &ModuleInfo_85);
  hlds__hlds_pred__proc_info_get_varset_vartypes_3_p_0(ProcInfo_84, &VarSet_86, &VarTypes_87);
  hlds__var_table__make_var_table_4_p_0(ModuleInfo_85, VarSet_86, VarTypes_87, &VarTable_88);
  ml_backend__ml_gen_info__ml_gen_info_set_module_info_3_p_0(ModuleInfo_85, STATE_VARIABLE_Info_0_39, &STATE_VARIABLE_Info_25_89);
  ml_backend__ml_gen_info__ml_gen_info_set_var_table_3_p_0(VarTable_88, STATE_VARIABLE_Info_25_89, &STATE_VARIABLE_Info_41_41);
  ...
  ml_backend__ml_accurate_gc__fixup_newobj_4_p_0(Var_49, MLDS_TypeInfoStmt0_23, &MLDS_TypeInfoStmt_26, &NewObjLocalVarDefns_27);
  ...
  ml_backend__ml_gen_info__ml_gen_info_get_var_table_2_p_0(*STATE_VARIABLE_Info_40, &VarTable_30);
  {
    ...
    MR_hl_field(MR_mktag(0), GenLocalVarDecl_31, 0) = ((MR_Box) (&ml_backend__ml_accurate_gc_scalar_common_7[0]));
  ...
  MR_Word * Defns_8)
{
  ...
  Var_11 = mercury__cord__init_0_f_0((MR_Word) (&ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_local_var_defn_0));
  Var_12 = mercury__counter__init_1_f_0((MR_Integer) 0);
  {
    Info0_9 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(MR_mktag(0), Info0_9, 0) = ((MR_Box) (ModuleName_5));
    MR_hl_field(MR_mktag(0), Info0_9, 1) = ((MR_Box) (Var_11));
    MR_hl_field(MR_mktag(0), Info0_9, 2) = ((MR_Box) (Var_12));
  }
  ml_backend__ml_accurate_gc__fixup_newobj_in_stmt_4_p_0(Stmt0_6, Stmt_7, Info0_9, &Info_10);
  Var_14 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Info_10, (MR_Integer) 1))));
  *Defns_8 = mercury__cord__to_list_1_f_0((MR_Word) (&ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_local_var_defn_0), Var_14);
}
  ...
  if (succeeded)
  {
    ...
    ArgRvalsTypes_16 = ((MR_Word) ((MR_hl_field(MR_mktag(3), AtomicStmt0_6, (MR_Integer) 7))));
    {
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(0), Var_48, 0) = ((MR_Box) (&ml_backend__ml_accurate_gc_scalar_common_4[0]));
