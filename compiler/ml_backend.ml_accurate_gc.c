...
static /* final */ const MR_Box ml_backend__ml_accurate_gc_scalar_common_2[3][5] = {
  /* row 0 */
  {
    ...
    ((MR_Box) ((MR_Integer) 1)),
    (MR_Box) (((((MR_Unsigned) ((MR_Integer) 0) << (MR_Integer) 1)) | (MR_Unsigned) ((MR_Integer) 0)))
  },
  /* row 1 */
  {
    NULL,
      ...
      case (MR_Integer) 1:
        {
          ...
          MR_Unsigned packed_args_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Var_48, (MR_Integer) 2)));
                    ...
                    case (MR_Integer) 0:
                      {
                        ...
                        MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), TypeCategory_35, (MR_Integer) 1)));
                    ...
                    case (MR_Integer) 1:
                      {
                        ...
                        MR_Unsigned packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), TypeCategory_35, (MR_Integer) 1)));
    ...
    case (MR_Integer) 1:
      {
        ...
        MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), Stmt0_5, (MR_Integer) 0)));
        ...
        ml_backend__ml_accurate_gc__fixup_newobj_in_stmt_4_p_0(BodyStmt0_15, &BodyStmt_17, STATE_VARIABLE_Fixup_0_46, STATE_VARIABLE_Fixup_47);
        {
          ...
          *Stmt_6 = base;
          MR_hl_field(MR_mktag(1), base, 0) = (MR_Box) (packed_args_0);
...
{
  {
    ...
    if (succeeded)
    {
      ...
      packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), AtomicStmt0_6, (MR_Integer) 3)));
      ...
      packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), AtomicStmt0_6, (MR_Integer) 8)));
      {
        MR_Integer Id_19;
        MR_Word NextId_20;
        MR_Word VarName_21;
