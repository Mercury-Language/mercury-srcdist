  ...
  MR_Word * STATE_VARIABLE_Info_28)
{
        ...
        case (MR_Integer) 1:
          {
            ...
            switch (MR_tag((MR_Word) TypeCategory_32)) {
              ...
              case (MR_Integer) 1:
                {
                  MR_Word Var_61 = ((MR_Word) ((MR_hl_field(1, TypeCategory_32, (MR_Integer) 0))));
              ...
              case (MR_Integer) 3:
                switch (((MR_Integer) ((MR_hl_field(3, TypeCategory_32, (MR_Integer) 0))))) {
                  ...
                  case (MR_Integer) 0:
                    {
                      MR_Word Var_62 = ((MR_Unsigned) ((MR_hl_field(3, TypeCategory_32, (MR_Integer) 1))) & (MR_Integer) 3);
                  ...
                  case (MR_Integer) 1:
                    {
                      MR_Word Var_63 = ((MR_Unsigned) ((MR_hl_field(3, TypeCategory_32, (MR_Integer) 1))) & (MR_Integer) 7);
  ...
  if (succeeded)
  {
    ...
    if (((MR_tag((MR_Word) HowToGetTypeInfo_10)) == (MR_Integer) 1))
    {
      ...
      ml_backend__ml_gen_info__ml_gen_info_get_module_info_2_p_0(STATE_VARIABLE_Info_0_27, &ModuleInfo_64);
      ...
      Var_87 = parse_tree__builtin_lib_types__c_pointer_type_0_f_0();
      {
        ...
        MR_hl_field(3, CPointerType_76, 0) = ((MR_Box) ((MR_Unsigned) 1U));
      ...
      }
      {
        ...
        MR_hl_field(1, Var_97, 0) = ((MR_Box) (TypeInfoRval_26));
      ...
      }
      {
        ...
        MR_hl_field(3, GC_TraceCode_25, 1) = ((MR_Box) (Signature_78));
        MR_hl_field(3, GC_TraceCode_25, 2) = ((MR_Box) (FuncAddr_79));
        MR_hl_field(3, GC_TraceCode_25, 3) = ((MR_Box) (Var_97));
    ...
    else
    {
      ...
      succeeded = ml_backend__ml_accurate_gc__trace_type_info_type_2_p_0(ActualType0_22, &ActualType1_23);
      if (succeeded)
  ...
  MR_Box wrapper_arg_1)
{
  ...
  conv1_LambdaHeadVar__2_52 = ml_backend__ml_accurate_gc__IntroducedFrom__func__ml_gen_gc_trace_code__336__1_4_f_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 4)))), ((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 5)))), ((MR_Word) (wrapper_arg_1)));
