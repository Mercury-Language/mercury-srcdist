...
{
  {
    ...
    switch (MR_tag((MR_Word) MLDS_DeclType_15)) {
      ...
      case (MR_Integer) 2:
        {
          MR_Word TypeCategory_34 = ((MR_Word) (MR_hl_field(MR_mktag(2), MLDS_DeclType_15, (MR_Integer) 1)));
          MR_Word _Type_33 = ((MR_Word) (MR_hl_field(MR_mktag(2), MLDS_DeclType_15, (MR_Integer) 0)));
          MR_Word Var_35 = ((MR_Word) (MR_hl_field(MR_mktag(2), MLDS_DeclType_15, (MR_Integer) 2)));
          ...
          switch (MR_tag((MR_Word) TypeCategory_34)) {
            ...
            case (MR_Integer) 1:
              {
                MR_Word Var_63 = ((MR_Word) (MR_hl_field(MR_mktag(1), TypeCategory_34, (MR_Integer) 0)));

                succeeded = (Var_63 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 2))));
              }
              break;
            case (MR_Integer) 3:
              switch (((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), TypeCategory_34, (MR_Integer) 0)))) {
                ...
                case (MR_Integer) 0:
                  {
                    MR_Word Var_64 = ((MR_Word) (MR_hl_field(MR_mktag(3), TypeCategory_34, (MR_Integer) 1)));
      ...
      case (MR_Integer) 3:
        switch (((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), MLDS_DeclType_15, (MR_Integer) 0)))) {
          ...
          case (MR_Integer) 3:
            {
              MR_Word Category_38 = ((MR_Word) (MR_hl_field(MR_mktag(3), MLDS_DeclType_15, (MR_Integer) 3)));
              MR_Word Var_36 = ((MR_Word) (MR_hl_field(MR_mktag(3), MLDS_DeclType_15, (MR_Integer) 1)));
              MR_Integer Var_37 = ((MR_Integer) (MR_hl_field(MR_mktag(3), MLDS_DeclType_15, (MR_Integer) 2)));

              succeeded = (Category_38 == (MR_Integer) 3);
              if (succeeded)
                succeeded = MR_FALSE;
              else
                succeeded = MR_TRUE;
    ...
    if (succeeded)
    {
      ...
      else
      {
        ...
        if (succeeded)
        {
          TypeName_68 = ((MR_Word) (MR_hl_field(MR_mktag(1), ActualType0_21, (MR_Integer) 0)));
          Var_69 = ((MR_Word) (MR_hl_field(MR_mktag(1), ActualType0_21, (MR_Integer) 1)));
          Var_70 = ((MR_Word) (MR_hl_field(MR_mktag(1), ActualType0_21, (MR_Integer) 2)));
          succeeded = ((MR_tag((MR_Word) TypeName_68)) == (MR_mktag((MR_Integer) 1)));
          if (succeeded)
          {
            PrivateBuiltin_71 = ((MR_Word) (MR_hl_field(MR_mktag(1), TypeName_68, (MR_Integer) 0)));
            Name_72 = ((MR_String) (MR_hl_field(MR_mktag(1), TypeName_68, (MR_Integer) 1)));
            Var_73 = mdbcomp__builtin_modules__mercury_private_builtin_module_0_f_0();
            succeeded = mdbcomp__sym_name____Unify____sym_name_0_0(PrivateBuiltin_71, Var_73);
            if (succeeded)
            {
              /* hashed string jump switch */
              /* compute the hash value of the input string */
              slot_0 = ((MR_hash_string5(Name_72)) & (MR_Integer) 15);
              /* hash chain loop */
              do
              {
                ...
                /* did we find a match? */
                if ((((str_1 != NULL)) && ((strcmp(str_1, Name_72) == 0))))
                {
...
{
  {
    ...
    succeeded = ml_backend__ml_accurate_gc__IntroducedFrom__pred__ml_gen_make_type_info_var__420__1_2_p_0(((MR_Word) (MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3))), ((MR_Word) (MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4))));
    return succeeded;
  }
}
