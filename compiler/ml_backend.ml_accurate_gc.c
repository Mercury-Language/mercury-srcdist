...
static const MR_FA_PseudoTypeInfo_Struct2 ml_backend__ml_accurate_gc__tree234__pti_tree234_2__plain_term__ti_var_1parse_tree__prog_data__type_ctor_info_prog_var_type_0__plain_hlds__var_table__type_ctor_info_var_table_entry_0;
...
static /* final */ const MR_Box ml_backend__ml_accurate_gc_scalar_common_7[1][8] = {
  /* row   0 */
  {
    ...
    ((MR_Box) (&ml_backend__ml_accurate_gc__tree234__pti_tree234_2__plain_term__ti_var_1parse_tree__prog_data__type_ctor_info_prog_var_type_0__plain_hlds__var_table__type_ctor_info_var_table_entry_0)),
...
static const MR_FA_PseudoTypeInfo_Struct2 ml_backend__ml_accurate_gc__tree234__pti_tree234_2__plain_term__ti_var_1parse_tree__prog_data__type_ctor_info_prog_var_type_0__plain_hlds__var_table__type_ctor_info_var_table_entry_0 = {
  ...
  {
    (MR_PseudoTypeInfo) (&ml_backend__ml_accurate_gc__term__ti_var_1parse_tree__prog_data__type_ctor_info_prog_var_type_0),
    (MR_PseudoTypeInfo) (&hlds__var_table__hlds__var_table__type_ctor_info_var_table_entry_0)
  }
};
  ...
  MR_Word * STATE_VARIABLE_Info_13)
{
  ...
  if (succeeded)
  {
    ...
    {
      HowToGetTypeInfo_25 = (MR_Word) MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL);
    ...
    case (MR_Integer) 1:
      {
        ...
        ClassKind_37 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Var_48, (MR_Integer) 2))) & (MR_Integer) 3);
        succeeded = (ClassKind_37 == (MR_Integer) 3);
        if (succeeded)
          succeeded = MR_FALSE;
        else
          succeeded = MR_TRUE;
        ...
        case (MR_Integer) 0:
          {
            ...
            switch (MR_tag((MR_Word) TypeCategory_34)) {
              ...
              case (MR_Integer) 1:
                {
                  MR_Word Var_66 = ((MR_Word) ((MR_hl_field(MR_mktag(1), TypeCategory_34, (MR_Integer) 0))));

                  succeeded = (Var_66 == (MR_Word) ((MR_Unsigned) 8U));
                }
                break;
              case (MR_Integer) 3:
                switch (((MR_Integer) ((MR_hl_field(MR_mktag(3), TypeCategory_34, (MR_Integer) 0))))) {
                  default: /*NOTREACHED*/ MR_assert(0);
                  case (MR_Integer) 0:
                    {
                      MR_Word Var_67 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(3), TypeCategory_34, (MR_Integer) 1))) & (MR_Integer) 3);
                  ...
                  case (MR_Integer) 1:
                    {
                      MR_Word Var_68 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(3), TypeCategory_34, (MR_Integer) 1))) & (MR_Integer) 7);
  ...
  if (succeeded)
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        succeeded = ((MR_tag((MR_Word) TypeName_71)) == (MR_Integer) 1);
        if (succeeded)
        {
  ...
  MR_Word * STATE_VARIABLE_Info_40)
{
  ...
  hlds__hlds_pred__proc_info_get_varset_2_p_0(ProcInfo_84, &VarSet_86);
  hlds__hlds_pred__proc_info_get_vartypes_2_p_0(ProcInfo_84, &VarTypes_87);
