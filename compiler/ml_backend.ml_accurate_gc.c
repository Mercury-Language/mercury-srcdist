...
{
  {
    ...
    if (succeeded)
    {
      ...
      MaybePtag_11 = ((MR_Word) (MR_hl_field(MR_mktag(3), AtomicStmt0_6, (MR_Integer) 2)));
      ...
      _AllocId_18 = ((MR_Word) (MR_hl_field(MR_mktag(3), AtomicStmt0_6, (MR_Integer) 9)));
      {
        ...
        TypeCtorInfo_68_68 = (MR_Word) &ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_typed_rval_0;
        Var_40 = mercury__list__length_1_f_0(TypeCtorInfo_68_68, ArgRvalsTypes_16);
        ...
        TypeCtorInfo_74_74 = (MR_Word) &ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_stmt_0;
        mercury__list__map_foldl_5_p_0(TypeCtorInfo_68_68, TypeCtorInfo_74_74, (MR_Word) &mercury__builtin__builtin__type_ctor_info_int_0, Var_49, ArgRvalsTypes_16, &ArgInitStmts_31, ((MR_Box) ((MR_Integer) 0)), &conv2__NumFields_32);
        _NumFields_32 = ((MR_Integer) conv2__NumFields_32);
        if ((MaybePtag_11 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
          TaggedPtrRval_33 = PtrRval_30;
        else
        {
          MR_Integer Ptag_78 = ((MR_Integer) (MR_hl_field(MR_mktag(1), MaybePtag_11, (MR_Integer) 0)));
          MR_Word Var_83;

          {
            ...
            MR_hl_field(MR_mktag(3), Var_83, 1) = ((MR_Box) (Ptag_78));
            MR_hl_field(MR_mktag(3), Var_83, 2) = ((MR_Box) (PtrRval_30));
          }
          {
            ...
            MR_hl_field(MR_mktag(3), TaggedPtrRval_33, 2) = ((MR_Box) (Var_83));
          }
        }
        {
        ...
        Var_54 = mercury__list__f_43_43_2_f_0(TypeCtorInfo_74_74, ArgInitStmts_31, Var_55);
        {
          MR_Word base;
          base = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL);
          *Stmt_8 = base;
