  ...
  MR_Word * STATE_VARIABLE_Info_28)
{
  ...
  if (succeeded)
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        TypeName_95 = ((MR_Word) ((MR_hl_field(1, ActualType0_22, (MR_Integer) 0))));
        succeeded = ((MR_tag((MR_Word) TypeName_95)) == (MR_Integer) 1);
        if (succeeded)
        {
          PrivateBuiltin_98 = ((MR_Word) ((MR_hl_field(1, TypeName_95, (MR_Integer) 0))));
          Name_99 = ((MR_String) ((MR_hl_field(1, TypeName_95, (MR_Integer) 1))));
    ...
    case (MR_Integer) 1:
      {
        ...
        MR_Word BodyStmt_17;
        MR_Word Context_60 = ((MR_Word) ((MR_hl_field(1, Stmt0_5, (MR_Integer) 4))));
    ...
    case (MR_Integer) 2:
      {
        ...
        MR_Word Context_61 = ((MR_Word) ((MR_hl_field(2, Stmt0_5, (MR_Integer) 3))));

        ml_backend__ml_accurate_gc__fixup_newobj_in_stmt_4_p_0(Then0_19, &Then_21, STATE_VARIABLE_Fixup_0_47, &STATE_VARIABLE_Fixup_52_52);
        if ((MaybeElse0_20 == (MR_Word) ((MR_Unsigned) 0U)))
        {
          MaybeElse_22 = (MR_Word) ((MR_Unsigned) 0U);
          *STATE_VARIABLE_Fixup_48 = STATE_VARIABLE_Fixup_52_52;
        }
        else
        {
          ...
          ml_backend__ml_accurate_gc__fixup_newobj_in_stmt_4_p_0(Stmt0_85, &Stmt_86, STATE_VARIABLE_Fixup_52_52, STATE_VARIABLE_Fixup_48);
          {
        ...
        case (MR_Integer) 0:
          {
            ...
            MR_Word Cases_28;
            MR_Word Default_29;
            MR_Word STATE_VARIABLE_Fixup_55_55;
            MR_Word Context_62 = ((MR_Word) ((MR_hl_field(3, Stmt0_5, (MR_Integer) 6))));
            MR_Box conv5_STATE_VARIABLE_Fixup_55_55;

            mercury__list__map_foldl_5_p_0((MR_Word) (&ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_switch_case_0), (MR_Word) (&ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_switch_case_0), (MR_Word) (&ml_backend__ml_accurate_gc__ml_backend__ml_accurate_gc__type_ctor_info_fixup_newobj_info_0), (MR_Word) (&ml_backend__ml_accurate_gc_scalar_common_6[1]), Cases0_26, &Cases_28, ((MR_Box) (STATE_VARIABLE_Fixup_0_47)), &conv5_STATE_VARIABLE_Fixup_55_55);
            STATE_VARIABLE_Fixup_55_55 = ((MR_Word) (conv5_STATE_VARIABLE_Fixup_55_55));
            switch (MR_tag((MR_Word) Default0_27)) {
              default: /*NOTREACHED*/ MR_assert(0);
              case (MR_Integer) 0:
                {
                  Default_29 = Default0_27;
                  *STATE_VARIABLE_Fixup_48 = STATE_VARIABLE_Fixup_55_55;
                }
                break;
              case (MR_Integer) 1:
                {
                  ...
                  ml_backend__ml_accurate_gc__fixup_newobj_in_stmt_4_p_0(Stmt0_89, &Stmt_90, STATE_VARIABLE_Fixup_55_55, STATE_VARIABLE_Fixup_48);
                  {
        ...
        case (MR_Integer) 6:
          {
            ...
            MR_Word STATE_VARIABLE_Fixup_57_57;
            MR_Word Context_68 = ((MR_Word) ((MR_hl_field(3, Stmt0_5, (MR_Integer) 4))));
            MR_Word BodyStmt0_69 = ((MR_Word) ((MR_hl_field(3, Stmt0_5, (MR_Integer) 2))));
            MR_Word BodyStmt_70;

            ml_backend__ml_accurate_gc__fixup_newobj_in_stmt_4_p_0(BodyStmt0_69, &BodyStmt_70, STATE_VARIABLE_Fixup_0_47, &STATE_VARIABLE_Fixup_57_57);
            ml_backend__ml_accurate_gc__fixup_newobj_in_stmt_4_p_0(HandlerStmt0_43, &HandlerStmt_44, STATE_VARIABLE_Fixup_57_57, STATE_VARIABLE_Fixup_48);
            {
              MR_Word base;
...
{
  MR_bool succeeded;
  MR_Word AtomicStmt0_8 = ((MR_Word) ((MR_hl_field(3, Stmt0_5, (MR_Integer) 1))));
  MR_Word Context_9 = ((MR_Word) ((MR_hl_field(3, Stmt0_5, (MR_Integer) 2))));
  ...
  switch (MR_tag((MR_Word) AtomicStmt0_8)) {
    ...
    case (MR_Integer) 2:
      ...
      break;
    case (MR_Integer) 3:
      switch (((MR_Integer) ((MR_hl_field(3, AtomicStmt0_8, (MR_Integer) 0))))) {
        default: /*NOTREACHED*/ MR_assert(0);
        case (MR_Integer) 0:
        case (MR_Integer) 1:
        case (MR_Integer) 3:
        ...
        case (MR_Integer) 2:
          {
            MR_Word Lval_10 = ((MR_Word) ((MR_hl_field(3, AtomicStmt0_8, (MR_Integer) 1))));
            MR_Word Ptag_11 = ((MR_Word) ((MR_hl_field(3, AtomicStmt0_8, (MR_Integer) 2))));
            MR_Word PointerType_13 = ((MR_Word) ((MR_hl_field(3, AtomicStmt0_8, (MR_Integer) 4))));
            MR_Word ArgRvalsTypes_16 = ((MR_Word) ((MR_hl_field(3, AtomicStmt0_8, (MR_Integer) 7))));
            MR_Integer Id_19;
            MR_Word NextId_20;
            MR_Word VarName_21;
            MR_Word VarType_22;
            ...
            MR_Word Var_52 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_Fixup_0_50, (MR_Integer) 2))));
            MR_Word Var_53;
            MR_Integer Var_55;
            MR_Word STATE_VARIABLE_Fixup_60_60;
            MR_Word Var_62;
            MR_Word Var_63;
            MR_Word Var_67;
            MR_Word Var_70;
            ...
            Var_75 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_Fixup_0_50, (MR_Integer) 0))));
            Locals0_27 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_Fixup_0_50, (MR_Integer) 1))));
            {
              STATE_VARIABLE_Fixup_60_60 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
              MR_hl_field(0, STATE_VARIABLE_Fixup_60_60, 0) = ((MR_Box) (Var_75));
              MR_hl_field(0, STATE_VARIABLE_Fixup_60_60, 1) = ((MR_Box) (Locals0_27));
              MR_hl_field(0, STATE_VARIABLE_Fixup_60_60, 2) = ((MR_Box) (NextId_20));
            }
            ...
            Var_80 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_Fixup_60_60, (MR_Integer) 0))));
            Var_82 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_Fixup_60_60, (MR_Integer) 2))));
            {
              MR_Word base;
              base = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
