...
ml_backend__ml_accurate_gc__IntroducedFrom__pred__ml_gen_make_type_info_var__413__1_2_p_0(
...
{
  {
    ...
    succeeded = ml_backend__ml_accurate_gc__IntroducedFrom__pred__ml_gen_make_type_info_var__413__1_2_p_0(((MR_Word) (MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3))), ((MR_Word) (MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4))));
    return succeeded;
  }
}
