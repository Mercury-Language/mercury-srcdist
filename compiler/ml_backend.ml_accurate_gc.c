...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(3), ml_backend__ml_accurate_gc__Var_53, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 0));
      MR_hl_field(MR_mktag(3), ml_backend__ml_accurate_gc__Var_53, 1) = ((MR_Box) (ml_backend__ml_accurate_gc__LocalVarName_35));
    }
    {
...
{
  {
    ...
    *ml_backend__ml_accurate_gc__HeadVar__7_7 = (ml_backend__ml_accurate_gc__FieldNum_13 + (MR_Integer) 1);
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(3), ml_backend__ml_accurate_gc__Var_19, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 0));
...
{
  {
    ...
    {
      ml_backend__ml_accurate_gc__Var_50 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), ml_backend__ml_accurate_gc__Var_50, 0) = ((MR_Box) (ml_backend__ml_accurate_gc__TypeInfoLval_28));
    }
    {
    ...
    if (ml_backend__ml_accurate_gc__succeeded)
      {
        ...
        ml_backend__ml_accurate_gc___AllocId_19 = ((MR_Word) (MR_hl_field(MR_mktag(3), ml_backend__ml_accurate_gc__AtomicStmt0_6, (MR_Integer) 10)));
        {
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(3), ml_backend__ml_accurate_gc__Var_46, 1) = ((MR_Box) (ml_backend__ml_accurate_gc__VarName_22));
          }
          {
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(3), ml_backend__ml_accurate_gc__PtrRval_31, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 1));
          ...
          if ((ml_backend__ml_accurate_gc__MaybeTag_11 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
          ...
          else
            {
              ...
              {
                ml_backend__ml_accurate_gc__Var_89 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(2), ml_backend__ml_accurate_gc__Var_89, 0) = ((MR_Box) (ml_backend__ml_accurate_gc__Tag_84));
                MR_hl_field(MR_mktag(2), ml_backend__ml_accurate_gc__Var_89, 1) = ((MR_Box) (ml_backend__ml_accurate_gc__PtrRval_31));
              }
              {
                ...
                MR_hl_field(MR_mktag(3), ml_backend__ml_accurate_gc__TaggedPtrRval_34, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 1));
...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(3), ml_backend__ml_accurate_gc__Var_43, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 8));
    ...
    {
      ml_backend__ml_accurate_gc__Var_46 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(3), ml_backend__ml_accurate_gc__Var_46, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 3));
