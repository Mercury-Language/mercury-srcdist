  ...
  MR_Word * STATE_VARIABLE_Info_40)
{
  ...
  check_hlds__polymorphism_type_info__polymorphism_make_type_info_var_mi_10_p_0(ActualType_10, Context_11, &TypeInfoVar_14, &HLDS_TypeInfoGoals_15, ModuleInfo0_78, &ModuleInfo1_82, PredInfo0_80, &PredInfo_83, ProcInfo0_81, &ProcInfo_84);
    ...
    case (MR_Integer) 2:
      {
        ...
        else
        {
          ...
          ml_backend__ml_accurate_gc__fixup_newobj_in_stmt_4_p_0(Stmt0_86, &Stmt_87, STATE_VARIABLE_Fixup_51_51, STATE_VARIABLE_Fixup_47);
          {
        ...
        case (MR_Integer) 0:
          {
            ...
            ml_backend__ml_accurate_gc__fixup_newobj_in_default_4_p_0(Default0_27, &Default_29, STATE_VARIABLE_Fixup_54_54, STATE_VARIABLE_Fixup_47);
            {
              MR_Word base;
