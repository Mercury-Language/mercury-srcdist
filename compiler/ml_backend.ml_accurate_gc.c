...
{
  {
    ...
    succeeded = mercury__builtin__unify_2_p_0((MR_Word) &ml_backend__ml_accurate_gc_scalar_common_1[2], ((MR_Box) (PolySpecs_19)), ((MR_Box) (HeadVar__2_32)));
    return succeeded;
  }
}
...
{
  {
    ...
    ml_backend__ml_gen_info__ml_gen_info_get_module_info_2_p_0(STATE_VARIABLE_Info_0_25, &ModuleInfo_14);
    ...
    switch (MR_tag((MR_Word) MLDS_DeclType_15)) {
      ...
      case (MR_Integer) 2:
        {
          MR_Word TypeCategory_32 = ((MR_Word) (MR_hl_field(MR_mktag(2), MLDS_DeclType_15, (MR_Integer) 1)));
          MR_Word _Type_31 = ((MR_Word) (MR_hl_field(MR_mktag(2), MLDS_DeclType_15, (MR_Integer) 0)));
          MR_Word Var_33 = ((MR_Word) (MR_hl_field(MR_mktag(2), MLDS_DeclType_15, (MR_Integer) 2)));
          ...
          switch (MR_tag((MR_Word) TypeCategory_32)) {
            ...
            case (MR_Integer) 1:
              {
                MR_Word Var_61 = ((MR_Word) (MR_hl_field(MR_mktag(1), TypeCategory_32, (MR_Integer) 0)));

                succeeded = (Var_61 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 2))));
              }
              break;
            case (MR_Integer) 3:
              switch (((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), TypeCategory_32, (MR_Integer) 0)))) {
                default: /*NOTREACHED*/ MR_assert(0);
                case (MR_Integer) 0:
                  {
                    MR_Word Var_62 = ((MR_Word) (MR_hl_field(MR_mktag(3), TypeCategory_32, (MR_Integer) 1)));
                ...
                case (MR_Integer) 1:
                  {
                    MR_Word Var_63 = ((MR_Word) (MR_hl_field(MR_mktag(3), TypeCategory_32, (MR_Integer) 1)));
      ...
      case (MR_Integer) 3:
        switch (((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), MLDS_DeclType_15, (MR_Integer) 0)))) {
          ...
          case (MR_Integer) 3:
            {
              MR_Word Category_36 = ((MR_Word) (MR_hl_field(MR_mktag(3), MLDS_DeclType_15, (MR_Integer) 3)));
              MR_Word Var_34 = ((MR_Word) (MR_hl_field(MR_mktag(3), MLDS_DeclType_15, (MR_Integer) 1)));
              MR_Integer Var_35 = ((MR_Integer) (MR_hl_field(MR_mktag(3), MLDS_DeclType_15, (MR_Integer) 2)));

              succeeded = (Category_36 == (MR_Integer) 3);
              if (succeeded)
                succeeded = MR_FALSE;
              else
                succeeded = MR_TRUE;
    ...
    if (succeeded)
    {
      ml_backend__ml_gen_info__ml_gen_info_get_pred_id_2_p_0(STATE_VARIABLE_Info_0_25, &PredId_16);
      hlds__hlds_module__predicate_id_5_p_0(ModuleInfo_14, PredId_16, &PredModule_17, &PredName_18, &PredArity_19);
      succeeded = mdbcomp__program_representation__no_type_info_builtin_3_p_0(PredModule_17, PredName_18, PredArity_19);
      succeeded = !(succeeded);
    }
    if (succeeded)
    {
      MR_Word GC_TraceCode_23;

      if (((MR_tag((MR_Word) HowToGetTypeInfo_10)) == (MR_mktag((MR_Integer) 1))))
      {
        MR_Word TypeInfoRval_24 = ((MR_Word) (MR_hl_field(MR_mktag(1), HowToGetTypeInfo_10, (MR_Integer) 0)));

        ml_backend__ml_accurate_gc__ml_gen_trace_var_6_p_0(STATE_VARIABLE_Info_0_25, VarName_8, DeclType_9, TypeInfoRval_24, Context_11, &GC_TraceCode_23);
        *STATE_VARIABLE_Info_26 = STATE_VARIABLE_Info_0_25;
      }
      else
      {
        MR_Word ActualType0_20 = ((MR_Word) (MR_hl_field(MR_mktag(0), HowToGetTypeInfo_10, (MR_Integer) 0)));
        MR_Word ActualType_22;
        MR_Word ActualType1_21;
        MR_Word TypeName_66;
        MR_Word PrivateBuiltin_69;
        MR_String Name_70;
        MR_Word Var_71;
        MR_Word Var_67;
        MR_Word Var_68;
        ...
        succeeded = ((MR_tag((MR_Word) ActualType0_20)) == (MR_mktag((MR_Integer) 1)));
        if (succeeded)
        {
          TypeName_66 = ((MR_Word) (MR_hl_field(MR_mktag(1), ActualType0_20, (MR_Integer) 0)));
          Var_67 = ((MR_Word) (MR_hl_field(MR_mktag(1), ActualType0_20, (MR_Integer) 1)));
          Var_68 = ((MR_Word) (MR_hl_field(MR_mktag(1), ActualType0_20, (MR_Integer) 2)));
          succeeded = ((MR_tag((MR_Word) TypeName_66)) == (MR_mktag((MR_Integer) 1)));
          if (succeeded)
          {
            PrivateBuiltin_69 = ((MR_Word) (MR_hl_field(MR_mktag(1), TypeName_66, (MR_Integer) 0)));
            Name_70 = ((MR_String) (MR_hl_field(MR_mktag(1), TypeName_66, (MR_Integer) 1)));
            Var_71 = mdbcomp__builtin_modules__mercury_private_builtin_module_0_f_0();
            succeeded = mdbcomp__sym_name____Unify____sym_name_0_0(PrivateBuiltin_69, Var_71);
            if (succeeded)
            {
              /* hashed string jump switch */
              /* compute the hash value of the input string */
              slot_0 = ((MR_hash_string5(Name_70)) & (MR_Integer) 15);
              /* hash chain loop */
              do
              {
                ...
                /* did we find a match? */
                if ((((str_1 != NULL)) && ((strcmp(str_1, Name_70) == 0))))
                {
                  ...
                  switch (slot_0) {
                    ...
                    case (MR_Integer) 0:
                      {
                        ...
                        ActualType1_21 = parse_tree__builtin_lib_types__c_pointer_type_0_f_0();
                        succeeded = MR_TRUE;
                      }
                      break;
                    case (MR_Integer) 1:
                    ...
                    case (MR_Integer) 5:
                      {
                        /* case "typeclass_info" */
                        ActualType1_21 = parse_tree__builtin_lib_types__sample_typeclass_info_type_0_f_0();
                        succeeded = MR_TRUE;
                      }
                      break;
                    case (MR_Integer) 8:
                      {
                        /* case "type_info" */
                        ActualType1_21 = parse_tree__builtin_lib_types__sample_type_info_type_0_f_0();
                        succeeded = MR_TRUE;
                      }
                      break;
                    case (MR_Integer) 9:
        ...
        if (succeeded)
          ActualType_22 = ActualType1_21;
        else
          ActualType_22 = ActualType0_20;
        ml_backend__ml_accurate_gc__ml_gen_gc_trace_code_7_p_0(VarName_8, DeclType_9, ActualType_22, Context_11, &GC_TraceCode_23, STATE_VARIABLE_Info_0_25, STATE_VARIABLE_Info_26);
      }
      {
        MR_Word base;
        base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
        *GCStmt_12 = base;
        MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (GC_TraceCode_23));
      }
    }
    else
    {
...
{
  {
    ...
    conv0_LambdaHeadVar__2_44 = ml_backend__ml_accurate_gc__IntroducedFrom__func__ml_gen_gc_trace_code__312__1_1_f_0(((MR_Word) wrapper_arg_1));
...
{
  {
    ...
    NonLocalsList_16 = mercury__list__map_2_f_0((MR_Word) &hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_hlds_goal_0, (MR_Word) &ml_backend__ml_accurate_gc_scalar_common_1[1], (MR_Word) &ml_backend__ml_accurate_gc_scalar_common_7[2], HLDS_TypeInfoGoals_15);
    ...
    NonLocalVarDefns_38 = mercury__list__map_2_f_0((MR_Word) &ml_backend__ml_accurate_gc_scalar_common_1[0], TypeCtorInfo_68_68, GenLocalVarDecl_32, NonLocalVarList_37);
    ...
    case (MR_Integer) 1:
      {
        ...
        MR_Word BodyStmt_16;
        MR_Word Context_59 = ((MR_Word) (MR_hl_field(MR_mktag(1), Stmt0_5, (MR_Integer) 3)));

        ml_backend__ml_accurate_gc__fixup_newobj_in_stmt_4_p_0(BodyStmt0_15, &BodyStmt_16, STATE_VARIABLE_Fixup_0_46, STATE_VARIABLE_Fixup_47);
        {
          MR_Word base;
          ...
          *Stmt_6 = base;
          ...
          MR_hl_field(MR_mktag(1), base, 3) = ((MR_Box) (Context_59));
        }
      }
      break;
    case (MR_Integer) 2:
      {
        ...
        ml_backend__ml_accurate_gc__fixup_newobj_in_stmt_4_p_0(Then0_18, &Then_20, STATE_VARIABLE_Fixup_0_46, &STATE_VARIABLE_Fixup_54_54);
        ...
        {
          MR_Word Stmt0_86 = ((MR_Word) (MR_hl_field(MR_mktag(1), MaybeElse0_19, (MR_Integer) 0)));
          MR_Word Stmt_87;
          ...
          ml_backend__ml_accurate_gc__fixup_newobj_in_stmt_4_p_0(Stmt0_86, &Stmt_87, STATE_VARIABLE_Fixup_54_54, STATE_VARIABLE_Fixup_47);
          {
            ...
            MR_hl_field(MR_mktag(1), MaybeElse_21, 0) = ((MR_Box) (Stmt_87));
          }
        }
        {
          MR_Word base;
        ...
        case (MR_Integer) 0:
          {
            ...
            mercury__list__map_foldl_5_p_0(TypeCtorInfo_81_81, TypeCtorInfo_81_81, (MR_Word) &ml_backend__ml_accurate_gc__ml_backend__ml_accurate_gc__type_ctor_info_fixup_newobj_info_0, (MR_Word) &ml_backend__ml_accurate_gc_scalar_common_7[1], Cases0_25, &Cases_27, ((MR_Box) (STATE_VARIABLE_Fixup_0_46)), &conv5_STATE_VARIABLE_Fixup_52_52);
            STATE_VARIABLE_Fixup_52_52 = ((MR_Word) conv5_STATE_VARIABLE_Fixup_52_52);
            ml_backend__ml_accurate_gc__fixup_newobj_in_default_4_p_0(Default0_26, &Default_28, STATE_VARIABLE_Fixup_52_52, STATE_VARIABLE_Fixup_47);
            {
              MR_Word base;
    ...
    if (succeeded)
    {
      ...
      _AllocId_19 = ((MR_Word) (MR_hl_field(MR_mktag(3), AtomicStmt0_6, (MR_Integer) 10)));
      {
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(3), VarName_22, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 4));
...
{
  {
    ...
    succeeded = ml_backend__ml_accurate_gc__IntroducedFrom__pred__ml_gen_make_type_info_var__421__1_2_p_0(((MR_Word) (MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3))), ((MR_Word) (MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4))));
    return succeeded;
  }
}
...
{
  {
    ...
    ml_backend__ml_gen_info__ml_gen_info_get_module_info_2_p_0(STATE_VARIABLE_Info_0_26, &ModuleInfo0_12);
    ml_backend__ml_gen_info__ml_gen_info_get_pred_id_2_p_0(STATE_VARIABLE_Info_0_26, &PredId_13);
    ml_backend__ml_gen_info__ml_gen_info_get_proc_id_2_p_0(STATE_VARIABLE_Info_0_26, &ProcId_14);
    hlds__hlds_module__module_info_pred_proc_info_5_p_0(ModuleInfo0_12, PredId_13, ProcId_14, &PredInfo0_15, &ProcInfo0_16);
    check_hlds__polymorphism__create_poly_info_4_p_0(ModuleInfo0_12, PredInfo0_15, ProcInfo0_16, &PolyInfo0_17);
    check_hlds__polymorphism__polymorphism_make_type_info_var_6_p_0(Type_7, Context_8, TypeInfoVar_9, TypeInfoGoals_10, PolyInfo0_17, &PolyInfo_18);
    check_hlds__polymorphism__poly_info_extract_7_p_0(PolyInfo_18, &PolySpecs_19, PredInfo0_15, &PredInfo_20, ProcInfo0_16, &ProcInfo_21, &ModuleInfo1_22);
    {
      Var_28 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 5 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), Var_28, 0) = ((MR_Box) (&ml_backend__ml_accurate_gc_scalar_common_3[0]));
      MR_hl_field(MR_mktag(0), Var_28, 1) = ((MR_Box) (ml_backend__ml_accurate_gc__ml_gen_make_type_info_var_6_p_0_1));
      MR_hl_field(MR_mktag(0), Var_28, 2) = ((MR_Box) (MR_Word) ((MR_Integer) 2));
      MR_hl_field(MR_mktag(0), Var_28, 3) = ((MR_Box) (PolySpecs_19));
      MR_hl_field(MR_mktag(0), Var_28, 4) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
    }
    mercury__require__expect_4_p_0(Var_28, (MR_String) "ml_backend.ml_accurate_gc", (MR_String) "predicate \140ml_backend.ml_accurate_gc.ml_gen_make_type_info_var\'/6", (MR_String) "got errors while making type_info_var");
    hlds__hlds_module__module_info_set_pred_proc_info_6_p_0(PredId_13, ProcId_14, PredInfo_20, ProcInfo_21, ModuleInfo1_22, &ModuleInfo_23);
    hlds__hlds_pred__proc_info_get_varset_2_p_0(ProcInfo_21, &VarSet_24);
    hlds__hlds_pred__proc_info_get_vartypes_2_p_0(ProcInfo_21, &VarTypes_25);
    ml_backend__ml_gen_info__ml_gen_info_set_module_info_3_p_0(ModuleInfo_23, STATE_VARIABLE_Info_0_26, &STATE_VARIABLE_Info_33_33);
    ml_backend__ml_gen_info__ml_gen_info_set_varset_3_p_0(VarSet_24, STATE_VARIABLE_Info_33_33, &STATE_VARIABLE_Info_34_34);
    ml_backend__ml_gen_info__ml_gen_info_set_var_types_3_p_0(VarTypes_25, STATE_VARIABLE_Info_34_34, STATE_VARIABLE_Info_27);
  }
}
...
{
  {
    ...
    {
      CPointerType_25 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(2), CPointerType_25, 0) = ((MR_Box) (Var_35));
      MR_hl_field(MR_mktag(2), CPointerType_25, 1) = ((MR_Box) (MR_mkword(MR_mktag(3), &ml_backend__ml_accurate_gc_scalar_common_1[4])));
      MR_hl_field(MR_mktag(2), CPointerType_25, 2) = ((MR_Box) (Var_38));
    }
    {
    ...
    Var_53 = mercury__set__init_0_f_0((MR_Word) &ml_backend__mlds__ml_backend__mlds__type_ctor_info_ml_call_marker_0);
    {
      MR_Word base;
      ...
      *TraceStmt_12 = base;
      ...
      MR_hl_field(MR_mktag(3), base, 6) = ((MR_Box) (Var_53));
      MR_hl_field(MR_mktag(3), base, 7) = ((MR_Box) (Context_11));
    }
  }
}
