    ...
    if (ml_backend__ml_accurate_gc__succeeded)
      *ml_backend__ml_accurate_gc__HeadVar__1_1 = (MR_Integer) 0;
    else
      {
        ...
        MR_Word ml_backend__ml_accurate_gc__ArgX4_10 = ((MR_Word) (MR_hl_field(MR_mktag(0), ml_backend__ml_accurate_gc__HeadVar__2_2, (MR_Integer) 3)));
        MR_Word ml_backend__ml_accurate_gc__ArgY4_11 = ((MR_Word) (MR_hl_field(MR_mktag(0), ml_backend__ml_accurate_gc__HeadVar__3_3, (MR_Integer) 3)));
        MR_Word ml_backend__ml_accurate_gc__Var_12;

        {
          ml_backend__mlds____Compare____mlds_module_name_0_0(&ml_backend__ml_accurate_gc__Var_12, ml_backend__ml_accurate_gc__ArgX1_4, ml_backend__ml_accurate_gc__ArgY1_5);
        }
        ...
        if (ml_backend__ml_accurate_gc__succeeded)
          *ml_backend__ml_accurate_gc__HeadVar__1_1 = ml_backend__ml_accurate_gc__Var_12;
        else
          {
            ...
            {
              ml_backend__mlds____Compare____mlds_context_0_0(&ml_backend__ml_accurate_gc__Var_13, ml_backend__ml_accurate_gc__ArgX2_6, ml_backend__ml_accurate_gc__ArgY2_7);
            }
            ...
            if (ml_backend__ml_accurate_gc__succeeded)
              *ml_backend__ml_accurate_gc__HeadVar__1_1 = ml_backend__ml_accurate_gc__Var_13;
            else
              {
                ...
                {
                  mercury__builtin__compare_3_p_0((MR_Word) &ml_backend__ml_accurate_gc_scalar_common_1[3], &ml_backend__ml_accurate_gc__Var_14, ((MR_Box) (ml_backend__ml_accurate_gc__ArgX3_8)), ((MR_Box) (ml_backend__ml_accurate_gc__ArgY3_9)));
                }
                ...
                if (ml_backend__ml_accurate_gc__succeeded)
                  *ml_backend__ml_accurate_gc__HeadVar__1_1 = ml_backend__ml_accurate_gc__Var_14;
                  ...
                  {
                    mercury__counter____Compare____counter_0_0(ml_backend__ml_accurate_gc__HeadVar__1_1, ml_backend__ml_accurate_gc__ArgX4_10, ml_backend__ml_accurate_gc__ArgY4_11);
                  }
              }
          }
      }
...
{
  {
    ...
    if (ml_backend__ml_accurate_gc__succeeded)
    ...
    else
      {
        ...
        MR_Word ml_backend__ml_accurate_gc__ArgX4_9 = ((MR_Word) (MR_hl_field(MR_mktag(0), ml_backend__ml_accurate_gc__HeadVar__1_1, (MR_Integer) 3)));
        MR_Word ml_backend__ml_accurate_gc__ArgY4_10 = ((MR_Word) (MR_hl_field(MR_mktag(0), ml_backend__ml_accurate_gc__HeadVar__2_2, (MR_Integer) 3)));
        ...
        if (ml_backend__ml_accurate_gc__succeeded)
          {
            {
              ml_backend__ml_accurate_gc__succeeded = ml_backend__mlds____Unify____mlds_context_0_0(ml_backend__ml_accurate_gc__ArgX2_5, ml_backend__ml_accurate_gc__ArgY2_6);
            }
            if (ml_backend__ml_accurate_gc__succeeded)
              {
                ml_backend__ml_accurate_gc__TypeInfo_15_15 = (MR_Word) &ml_backend__ml_accurate_gc_scalar_common_1[3];
                {
                  ml_backend__ml_accurate_gc__succeeded = mercury__builtin__unify_2_p_0(ml_backend__ml_accurate_gc__TypeInfo_15_15, ((MR_Box) (ml_backend__ml_accurate_gc__ArgX3_7)), ((MR_Box) (ml_backend__ml_accurate_gc__ArgY3_8)));
                }
                if (ml_backend__ml_accurate_gc__succeeded)
                  {
                    ml_backend__ml_accurate_gc__succeeded = mercury__counter____Unify____counter_0_0(ml_backend__ml_accurate_gc__ArgX4_9, ml_backend__ml_accurate_gc__ArgY4_10);
                  }
              }
          }
      }
