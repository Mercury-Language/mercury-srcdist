  ...
  MR_Word * STATE_VARIABLE_Info_28)
{
        ...
        case (MR_Integer) 1:
          {
            ...
            switch (MR_tag((MR_Word) TypeCategory_32)) {
              ...
              case (MR_Integer) 1:
                {
                  MR_Word Var_60 = ((MR_Word) ((MR_hl_field(1, TypeCategory_32, (MR_Integer) 0))));

                  succeeded = (Var_60 == (MR_Word) ((MR_Unsigned) 8U));
                }
                break;
              case (MR_Integer) 3:
                switch (((MR_Integer) ((MR_hl_field(3, TypeCategory_32, (MR_Integer) 0))))) {
                  ...
                  case (MR_Integer) 0:
                    {
                      MR_Word Var_61 = ((MR_Unsigned) ((MR_hl_field(3, TypeCategory_32, (MR_Integer) 1))) & (MR_Integer) 3);
                  ...
                  case (MR_Integer) 1:
                    {
                      MR_Word Var_62 = ((MR_Unsigned) ((MR_hl_field(3, TypeCategory_32, (MR_Integer) 1))) & (MR_Integer) 7);
  ...
  if (succeeded)
  {
    ...
    if (((MR_tag((MR_Word) HowToGetTypeInfo_10)) == (MR_Integer) 1))
    {
      ...
      MR_Word MLDS_Type_64;
      MR_Word VarLval_65;
      MR_Integer ProcId_69;
      MR_Word PredModule_70;
      MR_Word MLDS_Module_71;
      MR_Word ProcLabel_72;
      MR_Word FuncLabel_73;
      MR_Word QualFuncLabel_74;
      MR_Word CPointerType_75;
      MR_Word ArgTypes_76;
      MR_Word Signature_77;
      MR_Word FuncAddr_78;
      MR_Word CastVarAddr_79;
      MR_Word Var_86;
      MR_Word Var_90;
      MR_Word Var_93;
      MR_Word Var_94;
      ...
      ml_backend__ml_gen_info__ml_gen_info_get_module_info_2_p_0(STATE_VARIABLE_Info_0_27, &ModuleInfo_63);
      MLDS_Type_64 = ml_backend__mlds__mercury_type_to_mlds_type_2_f_0(ModuleInfo_63, DeclType_9);
      {
        VarLval_65 = (MR_Word) MR_mkword(3, MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(3, VarLval_65, 0) = ((MR_Box) ((MR_Unsigned) 0U));
        MR_hl_field(3, VarLval_65, 1) = ((MR_Box) (VarName_8));
        MR_hl_field(3, VarLval_65, 2) = ((MR_Box) (MLDS_Type_64));
      }
      ProcId_69 = hlds__hlds_pred__initial_proc_id_0_f_0();
      PredModule_70 = mdbcomp__builtin_modules__mercury_private_builtin_module_0_f_0();
      MLDS_Module_71 = ml_backend__mlds__mercury_module_name_to_mlds_1_f_0(PredModule_70);
      {
        ProcLabel_72 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(0, ProcLabel_72, 0) = ((MR_Box) (&ml_backend__ml_accurate_gc_scalar_common_2[0]));
        MR_hl_field(0, ProcLabel_72, 1) = ((MR_Box) (ProcId_69));
      }
      {
        FuncLabel_73 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(0, FuncLabel_73, 0) = ((MR_Box) (ProcLabel_72));
        MR_hl_field(0, FuncLabel_73, 1) = ((MR_Box) ((MR_Unsigned) 0U));
      }
      {
        QualFuncLabel_74 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(0, QualFuncLabel_74, 0) = ((MR_Box) (MLDS_Module_71));
        MR_hl_field(0, QualFuncLabel_74, 1) = ((MR_Box) (FuncLabel_73));
      }
      Var_86 = parse_tree__builtin_lib_types__c_pointer_type_0_f_0();
      {
        CPointerType_75 = (MR_Word) MR_mkword(3, MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(3, CPointerType_75, 0) = ((MR_Box) ((MR_Unsigned) 1U));
        MR_hl_field(3, CPointerType_75, 1) = ((MR_Box) (Var_86));
        MR_hl_field(3, CPointerType_75, 2) = ((MR_Box) (MR_mkword(3, &ml_backend__ml_accurate_gc_scalar_common_1[3])));
      }
      {
        Var_90 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(1, Var_90, 0) = ((MR_Box) (CPointerType_75));
        MR_hl_field(1, Var_90, 1) = ((MR_Box) ((MR_Unsigned) 0U));
      }
      {
        ArgTypes_76 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(1, ArgTypes_76, 0) = ((MR_Box) ((MR_Unsigned) 32U));
        MR_hl_field(1, ArgTypes_76, 1) = ((MR_Box) (Var_90));
      }
      {
        Signature_77 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(0, Signature_77, 0) = ((MR_Box) (ArgTypes_76));
        MR_hl_field(0, Signature_77, 1) = ((MR_Box) ((MR_Unsigned) 0U));
      }
      {
        Var_94 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(0, Var_94, 0) = ((MR_Box) (QualFuncLabel_74));
        MR_hl_field(0, Var_94, 1) = ((MR_Box) (Signature_77));
      }
      Var_93 = (MR_Word) (MR_mkword(1, (MR_Word) (Var_94)));
      {
        FuncAddr_78 = (MR_Word) MR_mkword(3, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(3, FuncAddr_78, 0) = ((MR_Box) ((MR_Unsigned) 1U));
        MR_hl_field(3, FuncAddr_78, 1) = ((MR_Box) (Var_93));
      }
      {
        Var_95 = (MR_Word) MR_mkword(3, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(3, Var_95, 0) = ((MR_Box) ((MR_Unsigned) 7U));
        MR_hl_field(3, Var_95, 1) = ((MR_Box) (VarLval_65));
      }
      {
        CastVarAddr_79 = (MR_Word) MR_mkword(3, MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(3, CastVarAddr_79, 0) = ((MR_Box) ((MR_Unsigned) 4U));
        MR_hl_field(3, CastVarAddr_79, 1) = ((MR_Box) (CPointerType_75));
        MR_hl_field(3, CastVarAddr_79, 2) = ((MR_Box) (Var_95));
      }
      {
        Var_97 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(1, Var_97, 0) = ((MR_Box) (CastVarAddr_79));
        MR_hl_field(1, Var_97, 1) = ((MR_Box) ((MR_Unsigned) 0U));
      }
      {
        Var_96 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(1, Var_96, 0) = ((MR_Box) (TypeInfoRval_26));
      ...
      }
      {
        ...
        MR_hl_field(3, GC_TraceCode_25, 1) = ((MR_Box) (Signature_77));
        MR_hl_field(3, GC_TraceCode_25, 2) = ((MR_Box) (FuncAddr_78));
        MR_hl_field(3, GC_TraceCode_25, 3) = ((MR_Box) (Var_96));
