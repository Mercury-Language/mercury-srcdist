...
MR_decl_label8(check_hlds__common__apply_induced_substitutions_4_0, 2,3,4,11,18,20,22,12)
MR_decl_label8(check_hlds__common__apply_induced_substitutions_4_0, 16,7,28,26,5,6,33,38)
MR_decl_label1(check_hlds__common__apply_induced_substitutions_4_0, 37)
...
MR_BEGIN_MODULE(check_hlds__common_module7)
	...
	MR_init_label8(check_hlds__common__apply_induced_substitutions_4_0,2,3,4,11,18,20,22,12)
	MR_init_label8(check_hlds__common__apply_induced_substitutions_4_0,16,7,28,26,5,6,33,38)
	MR_init_label1(check_hlds__common__apply_induced_substitutions_4_0,37)
MR_BEGIN_CODE
...
MR_def_label(check_hlds__common__apply_induced_substitutions_4_0,6)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_sv(4),0,0)) {
		MR_GOTO_LAB(check_hlds__common__apply_induced_substitutions_4_0_i33);
	}
	MR_r1 = MR_sv(1);
	MR_r2 = MR_sv(2);
	MR_r3 = MR_sv(3);
	MR_np_call_localret_ent(hlds__hlds_rtti__rtti_var_info_duplicate_4_0,
		check_hlds__common__apply_induced_substitutions_4_0_i38);
MR_def_label(check_hlds__common__apply_induced_substitutions_4_0,33)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
		MR_GOTO_LAB(check_hlds__common__apply_induced_substitutions_4_0_i37);
	}
	MR_r1 = MR_sv(2);
	MR_r2 = MR_sv(1);
	MR_r3 = MR_sv(3);
	MR_np_call_localret_ent(hlds__hlds_rtti__rtti_var_info_duplicate_4_0,
		check_hlds__common__apply_induced_substitutions_4_0_i38);
MR_def_label(check_hlds__common__apply_induced_substitutions_4_0,38)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_sv(6);
	MR_succip_word = MR_sv(9);
	MR_decr_sp(9);
	MR_np_tailcall_ent(check_hlds__simplify__simplify_info_set_rtti_varmaps_3_0);
MR_def_label(check_hlds__common__apply_induced_substitutions_4_0,37)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_string_const("common.m", 8);
