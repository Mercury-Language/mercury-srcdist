...
MR_def_label(check_hlds__common__generate_assign_8_0,12)
	...
	MR_tempr10 = MR_sv(1);
	MR_tfield(2, MR_tempr5, 0) = MR_tempr10;
	...
	MR_tfield(0, MR_tempr6, 4) = (MR_Word) MR_TAG_COMMON(0,0,3);
	MR_tag_alloc_heap(MR_tempr3, 0, (MR_Integer) 2);
	MR_tfield(0, MR_tempr3, 0) = MR_tempr10;
...
MR_def_label(check_hlds__common__generate_assign_8_0,10)
	...
	MR_sv(3) = MR_tempr7;
	MR_tfield(2, MR_tempr7, 0) = (MR_Word) MR_TAG_COMMON(3,2,0);
...
MR_def_label(check_hlds__common__common_optimise_call_2_9_0,25)
	...
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 2);
	MR_r2 = MR_tempr1;
	MR_tfield(1, MR_tempr1, 0) = (MR_Word) MR_TAG_COMMON(3,5,0);
	MR_tempr2 = MR_r1;
...
MR_def_label(check_hlds__common__common_optimise_call_2_9_0,33)
	...
	MR_tfield(0, MR_tempr5, 1) = (MR_Word) MR_TAG_COMMON(2,2,0);
