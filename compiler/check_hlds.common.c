...
MR_decl_label4(check_hlds__common__apply_induced_tsubst_4_0, 39,30,37,33)
...
MR_decl_label8(check_hlds__common__common_optimise_call_2_9_0, 14,27,28,29,30,45,46,6)
MR_decl_label5(check_hlds__common__common_optimise_call_2_9_0, 47,3,50,51,53)
...
MR_decl_label8(check_hlds__common__partition_call_args_7_0, 65,64,9,11,12,15,13,17)
MR_decl_label5(check_hlds__common__partition_call_args_7_0, 19,21,8,2,1)
MR_decl_label3(check_hlds__common__record_cell_in_maps_6_0, 2,3,4)
MR_decl_label8(check_hlds__common__types_match_exactly_2_0, 4,8,10,14,16,31,33,21)
MR_decl_label5(check_hlds__common__types_match_exactly_2_0, 23,73,26,17,1)
...
MR_BEGIN_MODULE(check_hlds__common_module5)
	...
	MR_init_label8(check_hlds__common__types_match_exactly_2_0,4,8,10,14,16,31,33,21)
	MR_init_label5(check_hlds__common__types_match_exactly_2_0,23,73,26,17,1)
MR_BEGIN_CODE
...
MR_def_label(check_hlds__common__types_match_exactly_2_0,16)
	...
	if (MR_INT_EQ(MR_tempr1,1)) {
		MR_GOTO_LAB(check_hlds__common__types_match_exactly_2_0_i21);
	}
	...
	MR_np_call_localret_ent(libs__compiler_util__unexpected_2_0,
		check_hlds__common__types_match_exactly_2_0_i73);
...
MR_def_label(check_hlds__common__types_match_exactly_2_0,33)
	...
	MR_decr_sp(3);
	MR_np_tailcall_ent(check_hlds__common__types_match_exactly_list_2_0);
MR_def_label(check_hlds__common__types_match_exactly_2_0,21)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	...
	MR_np_call_localret_ent(check_hlds__common__types_match_exactly_list_2_0,
		check_hlds__common__types_match_exactly_2_0_i23);
MR_def_label(check_hlds__common__types_match_exactly_2_0,23)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(check_hlds__common__types_match_exactly_2_0_i1);
	}
	if (MR_LTAGS_TESTR(MR_sv(1),0,0)) {
		MR_GOTO_LAB(check_hlds__common__types_match_exactly_2_0_i26);
	}
	MR_r1 = ((MR_Integer) MR_sv(2) == (MR_Integer) MR_tbmkword(0, 0));
	MR_decr_sp_and_return(3);
MR_def_label(check_hlds__common__types_match_exactly_2_0,73)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_TRUE;
	MR_decr_sp_and_return(3);
MR_def_label(check_hlds__common__types_match_exactly_2_0,26)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_BEGIN_MODULE(check_hlds__common_module7)
	...
	MR_init_label4(check_hlds__common__apply_induced_tsubst_4_0,39,30,37,33)
MR_BEGIN_CODE
...
MR_def_label(check_hlds__common__apply_induced_tsubst_4_0,6)
	...
	if ((MR_tempr2 == MR_mktag((MR_Integer) 1))) {
		MR_GOTO_LAB(check_hlds__common__apply_induced_tsubst_4_0_i30);
	}
	if ((MR_tempr2 == MR_mktag((MR_Integer) 2))) {
		MR_GOTO_LAB(check_hlds__common__apply_induced_tsubst_4_0_i39);
	}
	MR_r1 = MR_sv(1);
	MR_r2 = MR_sv(2);
	MR_r3 = MR_sv(3);
	...
	MR_np_call_localret_ent(hlds__hlds_rtti__rtti_var_info_duplicate_4_0,
		check_hlds__common__apply_induced_tsubst_4_0_i37);
MR_def_label(check_hlds__common__apply_induced_tsubst_4_0,39)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_tag(MR_r1);
	if ((MR_tempr1 == MR_mktag((MR_Integer) 1))) {
		MR_GOTO_LAB(check_hlds__common__apply_induced_tsubst_4_0_i33);
	}
	if ((MR_tempr1 == MR_mktag((MR_Integer) 2))) {
		MR_GOTO_LAB(check_hlds__common__apply_induced_tsubst_4_0_i33);
	}
	...
	MR_np_call_localret_ent(hlds__hlds_rtti__rtti_var_info_duplicate_4_0,
		check_hlds__common__apply_induced_tsubst_4_0_i37);
MR_def_label(check_hlds__common__apply_induced_tsubst_4_0,30)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_tag(MR_r1);
	...
	MR_np_call_localret_ent(hlds__hlds_rtti__rtti_var_info_duplicate_4_0,
		check_hlds__common__apply_induced_tsubst_4_0_i37);
MR_def_label(check_hlds__common__apply_induced_tsubst_4_0,37)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_sv(6);
	MR_succip_word = MR_sv(9);
	MR_decr_sp(9);
	MR_np_tailcall_ent(check_hlds__simplify__simplify_info_set_rtti_varmaps_3_0);
MR_def_label(check_hlds__common__apply_induced_tsubst_4_0,33)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_string_const("common.m", 8);
...
MR_BEGIN_MODULE(check_hlds__common_module14)
	...
	MR_init_label8(check_hlds__common__common_optimise_call_2_9_0,14,27,28,29,30,45,46,6)
	MR_init_label5(check_hlds__common__common_optimise_call_2_9_0,47,3,50,51,53)
MR_BEGIN_CODE
...
MR_def_label(check_hlds__common__common_optimise_call_2_9_0,24)
	...
	MR_r1 = MR_tempr5;
	MR_tfield(0, MR_tempr5, 0) = (MR_Word) MR_TAG_COMMON(1,5,0);
	MR_tfield(0, MR_tempr5, 1) = (MR_Word) MR_TAG_COMMON(2,6,0);
...
MR_def_label(check_hlds__common__common_optimise_call_2_9_0,30)
	...
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(check_hlds__common__common_optimise_call_2_9_0_i45);
	}
	MR_r1 = MR_sv(1);
	MR_r2 = MR_sv(3);
	MR_np_call_localret_ent(check_hlds__simplify__simplify_info_set_common_info_3_0,
		check_hlds__common__common_optimise_call_2_9_0_i53);
MR_def_label(check_hlds__common__common_optimise_call_2_9_0,45)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(3);
	MR_np_call_localret_ent(check_hlds__simplify__simplify_info_set_rerun_det_2_0,
		check_hlds__common__common_optimise_call_2_9_0_i46);
MR_def_label(check_hlds__common__common_optimise_call_2_9_0,46)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_r1;
	MR_r1 = MR_sv(1);
	MR_np_call_localret_ent(check_hlds__simplify__simplify_info_set_common_info_3_0,
...
MR_BEGIN_MODULE(check_hlds__common_module15)
	...
	MR_init_label8(check_hlds__common__partition_call_args_7_0,65,64,9,11,12,15,13,17)
	MR_init_label5(check_hlds__common__partition_call_args_7_0,19,21,8,2,1)
MR_BEGIN_CODE
...
MR_def_static(check_hlds__common__partition_call_args_7_0)
	...
	if (MR_LTAGS_TESTR(MR_r4,0,0)) {
		MR_GOTO_LAB(check_hlds__common__partition_call_args_7_0_i65);
	}
	...
	MR_r1 = MR_TRUE;
	MR_proceed();
MR_def_label(check_hlds__common__partition_call_args_7_0,65)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(10);
...
MR_def_label(check_hlds__common__partition_call_args_7_0,13)
	...
	MR_np_call_localret_ent(check_hlds__inst_match__inst_is_not_partly_unique_2_0,
		check_hlds__common__partition_call_args_7_0_i17);
MR_def_label(check_hlds__common__partition_call_args_7_0,17)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(check_hlds__common__partition_call_args_7_0_i1);
	}
