...
MR_decl_label10(check_hlds__common__common_optimise_construct_10_0, 20,24,26,28,30,32,34,38,39,41)
MR_decl_label2(check_hlds__common__common_optimise_construct_10_0, 18,44)
...
MR_decl_label2(check_hlds__common__common_optimise_deconstruct_12_0, 15,44)
...
MR_def_label(check_hlds__common__record_cell_in_maps_6_0,23)
	...
	MR_tfield(0, MR_tempr1, 3) = MR_tfield(0, MR_sv(8), 3);
	MR_r1 = MR_tempr1;
	MR_r2 = MR_sv(7);
...
MR_def_label(check_hlds__common__generate_assign_8_0,9)
	...
	MR_tempr2 = MR_sv(5);
	MR_sv(5) = MR_r1;
	MR_sv(3) = MR_tfield(0, MR_tfield(0, MR_sv(3), 0), 1);
	MR_tempr3 = MR_sv(6);
	MR_sv(6) = MR_tempr1;
	MR_r1 = MR_tempr2;
	MR_r2 = MR_tempr3;
...
MR_def_label(check_hlds__common__generate_assign_8_0,12)
	...
	MR_tfield(0, MR_tempr5, 4) = (MR_Word) MR_TAG_COMMON(0,0,3);
	MR_tag_alloc_heap(MR_tempr2, 0, (MR_Integer) 2);
...
MR_def_label(check_hlds__common__generate_assign_8_0,10)
	...
	MR_tag_alloc_heap(MR_tempr6, 2, (MR_Integer) 4);
	MR_sv(3) = MR_tempr6;
	MR_tfield(2, MR_tempr6, 0) = (MR_Word) MR_TAG_COMMON(3,2,0);
	MR_tfield(2, MR_tempr6, 1) = MR_tempr5;
	MR_tfield(2, MR_tempr6, 2) = MR_tempr4;
	MR_tfield(2, MR_tempr6, 3) = (MR_Integer) 0;
...
MR_BEGIN_MODULE(check_hlds__common_module8)
	...
	MR_init_label10(check_hlds__common__common_optimise_construct_10_0,20,24,26,28,30,32,34,38,39,41)
	MR_init_label2(check_hlds__common__common_optimise_construct_10_0,18,44)
MR_BEGIN_CODE
...
MR_def_label(check_hlds__common__common_optimise_construct_10_0,41)
	...
	MR_np_call_localret_ent(check_hlds__simplify__simplify_info_incr_cost_delta_3_0,
		check_hlds__common__common_optimise_construct_10_0_i44);
MR_def_label(check_hlds__common__common_optimise_construct_10_0,18)
	...
	MR_np_call_localret_ent(check_hlds__common__record_cell_in_maps_6_0,
		check_hlds__common__common_optimise_construct_10_0_i44);
MR_def_label(check_hlds__common__common_optimise_construct_10_0,44)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
...
MR_BEGIN_MODULE(check_hlds__common_module11)
	...
	MR_init_label2(check_hlds__common__common_optimise_deconstruct_12_0,15,44)
MR_BEGIN_CODE
...
MR_def_label(check_hlds__common__common_optimise_deconstruct_12_0,14)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(13) = MR_tfield(0, MR_sv(10), 2);
	MR_sv(11) = MR_r1;
	MR_sv(12) = MR_r2;
	MR_r1 = MR_sv(6);
	MR_r2 = (MR_Integer) 3;
...
MR_def_label(check_hlds__common__common_optimise_deconstruct_12_0,39)
	...
	if (MR_INT_NE(MR_sv(5),0)) {
		MR_GOTO_LAB(check_hlds__common__common_optimise_deconstruct_12_0_i44);
	}
...
MR_def_label(check_hlds__common__common_optimise_call_2_9_0,2)
	...
	MR_sv(9) = MR_r3;
	MR_sv(11) = (MR_Word) MR_TAG_COMMON(0,0,8);
...
MR_def_label(check_hlds__common__common_optimise_call_2_9_0,25)
	...
	MR_sv(3) = MR_r1;
	MR_sv(4) = (MR_Word) MR_TAG_COMMON(1,0,9);
...
MR_def_label(check_hlds__common__common_optimise_call_2_9_0,33)
	...
	MR_tfield(1, MR_tempr1, 0) = (MR_Integer) 20;
	...
	MR_tfield(1, MR_tempr3, 0) = (MR_Integer) 20;
