...
MR_def_label(ll_backend__continuation_info__process_proc_llds_5_0,2)
	...
	MR_tempr2 = MR_r1;
	MR_sv(2) = MR_tempr2;
	MR_sv(4) = MR_tfield(0, MR_tempr2, 18);
...
MR_def_label(ll_backend__continuation_info__generate_var_live_lvalues_7_0,50)
	...
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
	MR_sv(7) = MR_tfield(0, MR_tfield(1, MR_tempr1, 0), 1);
...
MR_def_label(ll_backend__continuation_info__generate_resume_layout_for_var_7_0,7)
	...
	MR_tfield(0, MR_tempr1, 2) = (MR_Integer) 2;
	MR_tfield(0, MR_tempr1, 3) = MR_tfield(3, MR_sv(5), 1);
...
MR_def_label(ll_backend__continuation_info__build_closure_info_9_0,44)
	...
	MR_sv(9) = MR_tfield(0, MR_tfield(1, MR_tempr4, 0), 0);
	MR_r1 = MR_tempr1;
	MR_r2 = MR_sv(4);
	}
	MR_np_call_localret_ent(hlds__instmap__instmap_lookup_var_3_0,
...
MR_def_label(ll_backend__continuation_info__IntroducedFrom__pred__find_typeinfos_for_tvars__827__1_3_0,3)
	...
	MR_tfield(1, MR_tempr1, 1) = MR_tfield(1, MR_fv(1), 1);
	MR_r1 = MR_tempr1;
	MR_succeed();
	}
#ifdef MR_maybe_local_thread_engine_base
...
MR_def_static(ll_backend__continuation_info__IntroducedFrom__pred__process_proc_llds__469__1_2_0)
	...
	MR_tfield(0, MR_tempr3, 2) = MR_tfield(3, MR_tempr1, 3);
	MR_tfield(0, MR_tempr3, 3) = MR_tfield(3, MR_tempr1, 4);
	MR_tfield(0, MR_tempr3, 4) = MR_tfield(3, MR_tempr1, 5);
	MR_r1 = MR_TRUE;
	MR_proceed();
	}
