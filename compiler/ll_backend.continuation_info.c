...
static const MR_PseudoTypeInfo ll_backend__continuation_info__ll_backend__continuation_info__field_types_proc_layout_table_info_0_1[1] = { (MR_PseudoTypeInfo) (&hlds__proc_table_struct__hlds__proc_table_struct__type_ctor_info_proc_table_struct_info_0) };
  ...
  MR_Word HeadVar__3_3)
{
  ...
  else
  {
    ...
    hlds__proc_table_struct____Compare____proc_table_struct_info_0_0(HeadVar__1_1, ArgX1_6, ArgY1_7);
  }
}
  ...
  MR_Word HeadVar__2_2)
{
  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      succeeded = hlds__proc_table_struct____Unify____proc_table_struct_info_0_0(ArgX1_5, ArgY1_6);
    }
  }
  return succeeded;
}
