...
{
  {
    ...
    else
    {
      ...
      mercury__private_builtin__builtin_compare_int_3_p_0(&SubResult1_6, Var_101, Var_102);
      succeeded = (SubResult1_6 != (MR_Integer) 0);
      if (succeeded)
        *HeadVar__1_1 = SubResult1_6;
      else
      {
        ...
        else
        {
          ...
          else
          {
            ...
            mercury__private_builtin__builtin_compare_int_3_p_0(&SubResult4_15, Var_103, Var_104);
            succeeded = (SubResult4_15 != (MR_Integer) 0);
            if (succeeded)
              *HeadVar__1_1 = SubResult4_15;
            else
            {
              ...
              mercury__private_builtin__builtin_compare_int_3_p_0(&SubResult5_18, Var_105, Var_106);
              succeeded = (SubResult5_18 != (MR_Integer) 0);
              if (succeeded)
                *HeadVar__1_1 = SubResult5_18;
              else
              {
                ...
                mercury__private_builtin__builtin_compare_int_3_p_0(&SubResult6_21, Var_107, Var_108);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_9, (MR_Integer) 276, &UseFloatRegs_10);
...
{
  {
    ...
    {
      (env).ll_backend__continuation_info__basic_stack_layout_for_proc_4_p_0_env_0__succeeded = libs__globals__lookup_bool_option_3_p_1(Globals_6, (MR_Integer) 285, (MR_Integer) 1);
      if ((env).ll_backend__continuation_info__basic_stack_layout_for_proc_4_p_0_env_0__succeeded)
      {
        *BasicLayout_7 = (MR_Integer) 1;
