                        ...
                        if (ll_backend__continuation_info__succeeded)
                          *ll_backend__continuation_info__HeadVar__1_1 = ll_backend__continuation_info__V_56_56;
                        else
                          {
                            ...
                            {
                              parse_tree__prog_data_pragma____Compare____eval_method_0_0(&ll_backend__continuation_info__V_57_57, ll_backend__continuation_info__V_9_9, ll_backend__continuation_info__V_33_33);
                            }
                    ...
                    if (ll_backend__continuation_info__succeeded)
                      {
                        ...
                        if (ll_backend__continuation_info__succeeded)
                          {
                            {
                              ll_backend__continuation_info__succeeded = parse_tree__prog_data_pragma____Unify____eval_method_0_0(ll_backend__continuation_info__V_8_8, ll_backend__continuation_info__V_32_32);
                            }
                            if (ll_backend__continuation_info__succeeded)
                              {
                                {
...
{
  {
    ...
    {
      libs__globals__lookup_bool_option_3_p_0(ll_backend__continuation_info__Globals_9, (MR_Integer) 257, &ll_backend__continuation_info__UseFloatRegs_10);
    }
    {
...
{
  {
    ...
    {
      (ll_backend__continuation_info__env).ll_backend__continuation_info__basic_stack_layout_for_proc_4_p_0_env_0__succeeded = libs__globals__lookup_bool_option_3_p_1(ll_backend__continuation_info__Globals_6, (MR_Integer) 141, (MR_Integer) 1);
    }
