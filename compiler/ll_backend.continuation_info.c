...
MR_decl_label3(__Unify___ll_backend__continuation_info__return_layout_info_0_0, 7,11,1)
...
MR_decl_label4(__Compare___ll_backend__continuation_info__return_layout_info_0_0, 3,2,8,24)
...
MR_BEGIN_MODULE(ll_backend__continuation_info_module37)
	...
	MR_init_label3(__Unify___ll_backend__continuation_info__return_layout_info_0_0,7,11,1)
MR_BEGIN_CODE
...
MR_define_entry(mercury____Unify___ll_backend__continuation_info__return_layout_info_0_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if ((MR_r1 == MR_r2)) {
		MR_GOTO_LAB(__Unify___ll_backend__continuation_info__return_layout_info_0_0_i11);
	}
	MR_incr_sp(3);
	MR_sv(3) = (MR_Word) MR_succip;
	MR_sv(1) = MR_r1;
	...
	MR_np_call_localret_ent(__Unify___list__list_1_0,
		__Unify___ll_backend__continuation_info__return_layout_info_0_0_i7);
MR_def_label(__Unify___ll_backend__continuation_info__return_layout_info_0_0,7)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
...
MR_def_label(__Unify___ll_backend__continuation_info__return_layout_info_0_0,11)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_TRUE;
	MR_proceed();
...
MR_BEGIN_MODULE(ll_backend__continuation_info_module38)
	...
	MR_init_label4(__Compare___ll_backend__continuation_info__return_layout_info_0_0,3,2,8,24)
MR_BEGIN_CODE
...
MR_def_label(__Compare___ll_backend__continuation_info__return_layout_info_0_0,2)
	...
	MR_np_call_localret_ent(__Compare___list__list_1_0,
		__Compare___ll_backend__continuation_info__return_layout_info_0_0_i8);
MR_def_label(__Compare___ll_backend__continuation_info__return_layout_info_0_0,8)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___ll_backend__continuation_info__return_layout_info_0_0_i24);
	}
	MR_r1 = MR_sv(1);
	MR_r2 = MR_sv(2);
	MR_succip_word = MR_sv(3);
...
MR_def_label(__Compare___ll_backend__continuation_info__return_layout_info_0_0,24)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(3);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
