  ...
  MR_Word * ForceProcIdLayout_8)
{
  ...
  {
    (env).ll_backend__continuation_info__basic_stack_layout_for_proc_4_p_0_env_0__succeeded = libs__globals__lookup_bool_option_3_p_1(Globals_5, (MR_Integer) 753, (MR_Integer) 1);
    if ((env).ll_backend__continuation_info__basic_stack_layout_for_proc_4_p_0_env_0__succeeded)
    {
      *BasicLayout_7 = (MR_Integer) 1;
