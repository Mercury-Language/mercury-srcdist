...
{
  {
    ...
    MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Info_5, (MR_Integer) 0)));
...
{
  {
    ...
    MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Info_3, (MR_Integer) 0)));
...
{
  {
    ...
    {
      Info_4 = (MR_Word) MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL);
...
{
  {
    ...
    {
      Info_8 = (MR_Word) MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), Info_8, 0) = (MR_Box) (((((MR_Unsigned) (MaybeQualifiedItemNames_6) << 2)) | (((((MR_Unsigned) (LineNumbers_10) << 1)) | (MR_Unsigned) (Lang_7)))));
    }
    return Info_8;
  }
}
