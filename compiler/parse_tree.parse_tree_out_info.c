...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 162, &LineNumbersOpt_9);
    libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 165, &TypeRepnsForHumans_10);
