  ...
  MR_Word Lang_7)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 201, &LineNumbersOpt_9);
  libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 204, &TypeRepnsForHumans_10);
