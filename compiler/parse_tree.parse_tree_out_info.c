...
static const MR_EnumFunctorDescPtr parse_tree__parse_tree_out_info__parse_tree__parse_tree_out_info__enum_value_ordered_type_repn_for_0[2];
...
const MR_TypeCtorInfo_Struct parse_tree__parse_tree_out_info__parse_tree__parse_tree_out_info__type_ctor_info_type_repn_for_0 = {
  ...
  {     parse_tree__parse_tree_out_info__parse_tree__parse_tree_out_info__enum_value_ordered_type_repn_for_0 },
  (MR_Integer) 2,
  UINT16_C(4),
...
{
  {
    MR_Word LineNumbers_8 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Info_5, (MR_Integer) 0))) >> 2)) & (MR_Integer) 1);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 156, &LineNumbersOpt_9);
    libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 159, &TypeRepnsForHumans_10);
