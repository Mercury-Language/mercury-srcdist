  ...
  MR_String * HeadVar__4_4)
{
...

  {
    ...
    MR_hl_field(MR_mktag(1), Var_5, 0) = ((MR_Box) (HeadVar__3_3));
    MR_hl_field(MR_mktag(1), Var_5, 1) = ((MR_Box) (HeadVar__1_1));
  }
...
parse_tree__parse_tree_out_info__add_list_6_p_0(
  ...
  MR_Box * HeadVar__6_6)
{
  void MR_CALL (* func_0)(MR_Box, MR_Box, MR_Box, MR_Box, MR_Box, MR_Box, MR_Box, MR_Box *) = ((void MR_CALL (*)(MR_Box, MR_Box, MR_Box, MR_Box, MR_Box, MR_Box, MR_Box, MR_Box *)) ((MR_hl_field(MR_mktag(0), (MR_hl_field(MR_mktag(0), TypeClassInfo_for_output_7, (MR_Integer) 0)), (MR_Integer) 26))));
