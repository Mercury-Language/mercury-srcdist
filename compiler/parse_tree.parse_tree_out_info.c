  ...
  MR_Word Lang_7)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 474, &LineNumbersOpt_9);
  libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 477, &TypeRepnsForHumans_10);
