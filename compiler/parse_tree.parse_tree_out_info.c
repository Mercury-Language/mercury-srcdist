...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 168, &LineNumbersOpt_9);
    libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 171, &TypeRepnsForHumans_10);
