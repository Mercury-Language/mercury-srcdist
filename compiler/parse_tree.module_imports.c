...
{
  {
    ...
    if (succeeded)
      ContainsForeignCode_48 = (MR_Word) ((MR_Integer) 0);
    else
      {
    ...
    Var_69 = mercury__dir__this_directory_0_f_0();
    {
      ...
      *ModuleImports_16 = base;
      ...
      MR_hl_field(MR_mktag(0), base, 16) = ((MR_Box) ((MR_Integer) 0));
      ...
      MR_hl_field(MR_mktag(0), base, 24) = ((MR_Box) ((MR_Integer) 0));
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                ...
                if (succeeded)
                  succeeded = (WithType_14 == (MR_Word) ((MR_Integer) 0));
              }
            }
          }
        }
...
{
  if ((MaybeVersionNumbers_6 == (MR_Word) ((MR_Integer) 0)))
