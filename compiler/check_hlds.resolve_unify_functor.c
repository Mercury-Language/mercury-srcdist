...
check_hlds__resolve_unify_functor__IntroducedFrom__func__get_cons_id_arg_types_adding_existq_tvars__477__1_1_f_0(
  MR_Word LambdaHeadVar__1_51);

static MR_Word MR_CALL 
check_hlds__resolve_unify_functor__IntroducedFrom__func__find_matching_constructor__314__1_1_f_0(
  ...
  MR_Integer * FieldNumber_5)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      MR_Word CtorArgs_21 = ((MR_Word) (MR_hl_field(MR_mktag(0), Ctor_14, (MR_Integer) 2)));
...
{
  {
    ...
    conv0_LambdaHeadVar__2_52 = check_hlds__resolve_unify_functor__IntroducedFrom__func__get_cons_id_arg_types_adding_existq_tvars__477__1_1_f_0(((MR_Word) wrapper_arg_1));
...
{
  {
    ...
    ConsArgTypes_25 = mercury__list__map_2_f_0((MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_constructor_arg_0, TypeCtorInfo_62_62, (MR_Word) &check_hlds__resolve_unify_functor_scalar_common_3[1], ConsArgs_23);
    if ((MaybeExistConstraints_22 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
    {
    ...
    {
      MR_Word TypeInfo_63_63 = (MR_Word) &check_hlds__resolve_unify_functor_scalar_common_1[1];
      ...
      mercury__list__length_2_p_0(TypeInfo_63_63, ConsExistQVars_29, &NumExistQVars_31);
      ...
      mercury__map__from_corresponding_lists_3_p_0(TypeInfo_63_63, TypeInfo_63_63, ConsExistQVars_29, ParentExistQVars_33, &ConsToParentRenaming_35);
      parse_tree__prog_type_subst__apply_variable_renaming_to_type_list_3_p_0(ConsToParentRenaming_35, ConsArgTypes_25, &ParentArgTypes_36);
      parse_tree__prog_type_subst__apply_variable_renaming_to_prog_constraint_list_3_p_0(ConsToParentRenaming_35, ConsConstraints_30, &ParentConstraints_37);
      hlds__hlds_pred__pred_info_get_constraint_map_2_p_0(*STATE_VARIABLE_PredInfo_49, &ConstraintMap_38);
      mercury__list__length_2_p_0((MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_constraint_0, ConsConstraints_30, &NumConstraints_39);
      ...
      parse_tree__prog_type__constraint_list_get_tvars_2_p_0(ActualConstraints_40, &TVarsB_71);
      mercury__map__init_1_p_0((MR_Word) &check_hlds__resolve_unify_functor_scalar_common_1[1], (MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0, &Subst0_72);
      succeeded = check_hlds__resolve_unify_functor__unify_constraint_list_5_p_0(ParentConstraints_37, ActualConstraints_40, TVarsB_71, Subst0_72, &Subst1_73);
      if (succeeded)
        ExistTSubst_41 = Subst1_73;
      else
      {
        {
      ...
      parse_tree__prog_type_subst__apply_rec_subst_to_type_list_3_p_0(ExistTSubst_41, ParentArgTypes_36, &ActualArgTypes0_27);
      mercury__map__init_1_p_0(TypeInfo_63_63, (MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_kind_0, &KindMap_42);
    ...
    mercury__map__from_corresponding_lists_3_p_0((MR_Word) &check_hlds__resolve_unify_functor_scalar_common_1[1], TypeCtorInfo_62_62, TypeParams_20, TypeArgs_46, &UnivTSubst_47);
    parse_tree__prog_type_subst__apply_subst_to_type_list_3_p_0(UnivTSubst_47, ActualArgTypes0_27, ActualArgTypes_13);
  }
}
...
{
  {
    ...
    conv0_LambdaHeadVar__2_34 = check_hlds__resolve_unify_functor__IntroducedFrom__func__find_matching_constructor__314__1_1_f_0(((MR_Word) wrapper_arg_1));
...
{
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        Var_20 = ((MR_Word) (MR_hl_field(MR_mktag(0), ConsDefn_13, (MR_Integer) 6)));
        ...
        if (succeeded)
        {
          ...
          if ((MaybeExistConstraints_18 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
            ConsExistQVars_25 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
          else
          {
            MR_Word Var_31 = (MR_Word) MR_body(((MR_Word) MaybeExistConstraints_18), (MR_Integer) 1);
            MR_Word Var_26;

            ConsExistQVars_25 = ((MR_Word) (MR_hl_field(MR_mktag(0), Var_31, (MR_Integer) 0)));
            Var_26 = ((MR_Word) (MR_hl_field(MR_mktag(0), Var_31, (MR_Integer) 1)));
          }
          ...
          Var_32 = (MR_Word) &check_hlds__resolve_unify_functor_scalar_common_3[0];
          ConsArgTypes_27 = mercury__list__map_2_f_0(TypeCtorInfo_38_38, TypeCtorInfo_39_39, Var_32, ConsArgs_19);
          ExistQVars_29 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
          ExternalTypeParams_30 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
          succeeded = parse_tree__prog_type__arg_type_list_subsumes_8_p_0(TVarSet_7, ExistQVars_29, ArgTypes_10, ExternalTypeParams_30, TypeTVarSet_23, TypeKindMap_24, ConsExistQVars_25, ConsArgTypes_27);
        }
      }
    }
    return succeeded;
