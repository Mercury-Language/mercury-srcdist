...
{
  {
    ...
    if (succeeded)
    {
      ...
      {
        Var_115 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), Var_115, 0) = ((MR_Box) (FuncVar_36));
        MR_hl_field(MR_mktag(1), Var_115, 1) = (MR_Box) (((((MR_Unsigned) (Purity_35) << 1)) | (MR_Unsigned) ((MR_Integer) 1)));
        MR_hl_field(MR_mktag(1), Var_115, 2) = ((MR_Box) (FullArity_41));
      }
      {
          ...
          if ((MaybeProcId_76 == (MR_Word) ((MR_Unsigned) 0U)))
          {
            ...
            *Goal_28 = hlds__make_goal__true_goal_0_f_0();
            ...
            }
            {
              ...
              MR_hl_field(MR_mktag(1), Var_138, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &check_hlds__resolve_unify_functor_scalar_common_1[4])));
            }
            {
              Var_135 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), Var_135, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &check_hlds__resolve_unify_functor_scalar_common_1[7])));
                ...
                if (succeeded)
                  ...
                  else
                  {
                    ...
                    if (succeeded)
                      {
                        ConsId_180 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                        MR_hl_field(MR_mktag(3), ConsId_180, 0) = ((MR_Box) ((MR_Unsigned) 16U));
