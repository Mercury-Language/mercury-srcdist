...
{
  {
    ...
    if (succeeded)
    {
      ...
      {
        Var_116 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), Var_116, 0) = ((MR_Box) (FuncVar_36));
        MR_hl_field(MR_mktag(0), Var_116, 1) = (MR_Box) (((((MR_Unsigned) (Purity_35) << (MR_Integer) 1)) | (MR_Unsigned) ((MR_Integer) 1)));
