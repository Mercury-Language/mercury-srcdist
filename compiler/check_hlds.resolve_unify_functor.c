        ...
        if ((MaybeProcId_79 == (MR_Word) ((MR_Unsigned) 0U)))
        {
          ...
          *Goal_24 = hlds__make_goal__true_goal_0_f_0();
          ...
          }
          {
            ...
            MR_hl_field(0, Spec_88, 0) = ((MR_Box) ((MR_String) "predicate \140check_hlds.resolve_unify_functor.resolve_unify_functor\'/15"));
            MR_hl_field(0, Spec_88, 1) = ((MR_Box) ((MR_Unsigned) 0U));
            MR_hl_field(0, Spec_88, 2) = ((MR_Box) ((MR_Unsigned) 52U));
            MR_hl_field(0, Spec_88, 3) = ((MR_Box) (Context_190));
