      ...
      case (MR_Integer) 1:
        {
          ...
          Var_27 = mercury__one_or_more__one_or_more_to_list_1_f_1((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_constructor_0), Ctors_15);
          check_hlds__resolve_unify_functor__get_constructor_containing_field_loop_5_p_0(TermTypeCtor_11, Var_27, FieldName_20, ConsId_9, FieldNumber_10);
        }
        break;
      case (MR_Integer) 2:
        {
      ...
      case (MR_Integer) 1:
        {
          ...
          Var_86 = mercury__one_or_more__one_or_more_to_list_1_f_1((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_constructor_0), Ctors_74);
          check_hlds__resolve_unify_functor__get_constructor_containing_field_loop_5_p_0(TermTypeCtor_70, Var_86, FieldName_79, &ConsId_25, &FieldNumber_26);
        }
        break;
      case (MR_Integer) 2:
        {
