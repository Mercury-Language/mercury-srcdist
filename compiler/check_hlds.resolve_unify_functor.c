        ...
        case (MR_Integer) 1:
          {
            ...
            switch (MR_tag((MR_Word) check_hlds__resolve_unify_functor__HeadVar__3_3)) {
              ...
              case (MR_Integer) 1:
                {
                  MR_Word check_hlds__resolve_unify_functor__Var_9 = ((MR_Word) (MR_hl_field(MR_mktag(1), check_hlds__resolve_unify_functor__HeadVar__3_3, (MR_Integer) 0)));

                  {
                    parse_tree__error_util____Compare____error_spec_0_0(check_hlds__resolve_unify_functor__HeadVar__1_1, check_hlds__resolve_unify_functor__Var_13, check_hlds__resolve_unify_functor__Var_9);
                  }
                }
                break;
            }
...
{
  {
    ...
    if (check_hlds__resolve_unify_functor__succeeded)
      ...
      switch (MR_tag((MR_Word) check_hlds__resolve_unify_functor__HeadVar__1_1)) {
        ...
        case (MR_Integer) 1:
          {
            MR_Word check_hlds__resolve_unify_functor__Var_7 = ((MR_Word) (MR_hl_field(MR_mktag(1), check_hlds__resolve_unify_functor__HeadVar__1_1, (MR_Integer) 0)));
            MR_Word check_hlds__resolve_unify_functor__Var_8;
            ...
            if (check_hlds__resolve_unify_functor__succeeded)
              {
                check_hlds__resolve_unify_functor__Var_8 = ((MR_Word) (MR_hl_field(MR_mktag(1), check_hlds__resolve_unify_functor__HeadVar__2_2, (MR_Integer) 0)));
                {
                  check_hlds__resolve_unify_functor__succeeded = parse_tree__error_util____Unify____error_spec_0_0(check_hlds__resolve_unify_functor__Var_7, check_hlds__resolve_unify_functor__Var_8);
                }
              }
          }
          break;
