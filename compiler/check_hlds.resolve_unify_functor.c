...
{
  {
    ...
    else
    {
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              ...
              ArgTypes_55 = mercury__list__f_43_43_2_f_0(TypeCtorInfo_195_195, ArgTypes0_54, Var_119);
      ...
      if (succeeded)
      {
        ...
        ArgVars_163 = mercury__list__f_43_43_2_f_0((MR_Word) (&check_hlds__resolve_unify_functor_scalar_common_1[0]), ArgVars0_20, Var_123);
        {
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(2), FuncCall_64, 2) = ((MR_Box) (ArgVars_163));
      ...
      else
      {
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              hlds__vartypes__lookup_var_types_3_p_0(STATE_VARIABLE_VarTypes_0_108, ArgVars0_20, &ArgTypes0_167);
              TypeCtorInfo_198_198 = (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0);
              AllArgTypes_72 = mercury__list__f_43_43_2_f_0(TypeCtorInfo_198_198, ArgTypes0_167, HOArgTypes_71);
              hlds__hlds_pred__pred_info_get_typevarset_2_p_0(STATE_VARIABLE_PredInfo_0_104, &TVarSet_165);
              hlds__hlds_pred__pred_info_get_exist_quant_tvars_2_p_0(STATE_VARIABLE_PredInfo_0_104, &ExistQVars_73);
              hlds__hlds_pred__pred_info_get_external_type_params_2_p_0(STATE_VARIABLE_PredInfo_0_104, &ExternalTypeParams_166);
              hlds__hlds_pred__pred_info_get_markers_2_p_0(STATE_VARIABLE_PredInfo_0_104, &Markers_164);
              Context_190 = hlds__hlds_goal__goal_info_get_context_1_f_0(GoalInfo0_24);
              Var_129 = hlds__hlds_pred__calls_are_fully_qualified_1_f_0(Markers_164);
              succeeded = hlds__pred_table__get_pred_id_by_types_10_p_0(Var_129, Name_65, PredOrFunc_69, TVarSet_165, ExistQVars_73, AllArgTypes_72, ExternalTypeParams_166, ModuleInfo_17, Context_190, &PredId_191);
            }
          }
        }
        if (succeeded)
        {
          ...
          hlds__hlds_module__module_info_pred_info_3_p_0(ModuleInfo_17, PredId_191, &PredInfo_25);
          ...
          {
            MR_Word Var_202 = ((MR_Word) ((MR_hl_field(MR_mktag(1), ProcIds_74, (MR_Integer) 1))));
            MR_Integer Var_203 = ((MR_Integer) ((MR_hl_field(MR_mktag(1), ProcIds_74, (MR_Integer) 0))));

            if ((Var_202 == (MR_Word) ((MR_Unsigned) 0U)))
              {
                MaybeProcId_76 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(1), MaybeProcId_76, 0) = ((MR_Box) (Var_203));
              }
            else
            {
              MR_Integer Var_131;
          ...
          if ((MaybeProcId_76 == (MR_Word) ((MR_Unsigned) 0U)))
          {
            ...
            *Goal_28 = hlds__make_goal__true_goal_0_f_0();
            ...
            {
              Spec_84 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), Spec_84, 0) = ((MR_Box) ((MR_Unsigned) 0U));
              MR_hl_field(MR_mktag(1), Spec_84, 1) = ((MR_Box) ((MR_Unsigned) 24U));
              MR_hl_field(MR_mktag(1), Spec_84, 2) = ((MR_Box) (Context_190));
              MR_hl_field(MR_mktag(1), Spec_84, 3) = ((MR_Box) (Pieces_83));
            }
            {
              MR_Word base;
          ...
          else
          {
            ...
            MR_Word Var_149;
            MR_Word Var_150;
            MR_Integer ProcId_168 = ((MR_Integer) ((MR_hl_field(MR_mktag(1), MaybeProcId_76, (MR_Integer) 0))));

            {
              Var_149 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
              MR_hl_field(MR_mktag(0), Var_149, 0) = ((MR_Box) (PredId_191));
              MR_hl_field(MR_mktag(0), Var_149, 1) = ((MR_Box) (ProcId_168));
            }
            ShroudedPredProcId_80 = hlds__hlds_pred__shroud_pred_proc_id_1_f_0(Var_149);
            {
            ...
            {
              Var_150 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), Var_150, 0) = ((MR_Box) (ConsId_81));
              MR_hl_field(MR_mktag(1), Var_150, 1) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 0));
              MR_hl_field(MR_mktag(1), Var_150, 2) = ((MR_Box) (ArgVars0_20));
            }
            {
              ...
              MR_hl_field(MR_mktag(1), GoalExpr_82, 1) = ((MR_Box) (Var_150));
        ...
        else
        {
          ...
          if (succeeded)
          {
            Name_173 = ((MR_Word) ((MR_hl_field(MR_mktag(3), ConsId0_19, (MR_Integer) 1))));
            Var_199 = ((MR_Integer) ((MR_hl_field(MR_mktag(3), ConsId0_19, (MR_Integer) 2))));
            succeeded = (Arity_31 == Var_199);
            if (succeeded)
            {
              succeeded = hlds__hlds_pred__is_field_access_function_name_5_p_0(ModuleInfo_17, Name_173, &Var_200, &AccessType_86, &FieldName_87);
              if (succeeded)
              {
                ...
                if (succeeded)
                {
                  ...
                  if (succeeded)
                  {
                    hlds__hlds_pred__pred_info_get_typevarset_2_p_0(STATE_VARIABLE_PredInfo_0_104, &TVarSet_171);
                    hlds__vartypes__lookup_var_types_3_p_0(STATE_VARIABLE_VarTypes_0_108, ArgVars0_20, &ArgTypes0_172);
                    succeeded = check_hlds__resolve_unify_functor__find_matching_constructor_5_p_0(ModuleInfo_17, TVarSet_171, ConsId0_19, TypeOfX_30, ArgTypes0_172);
                    succeeded = !(succeeded);
                  }
                }
              }
          ...
          else
          {
              ...
              if (succeeded)
                {
                  ...
                  MR_hl_field(MR_mktag(3), ConsId_179, 1) = ((MR_Box) (Arity_31));
                }
              else
              {
                MR_Word Var_155;
                ...
                if (succeeded)
                {
                  Var_155 = ((MR_Word) ((MR_hl_field(MR_mktag(2), TypeOfX_30, (MR_Integer) 0))));
                ...
                if (succeeded)
                  ...
                  else
                  {
                    ...
                    if (succeeded)
                      {
                        ConsId_179 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                        MR_hl_field(MR_mktag(3), ConsId_179, 0) = ((MR_Box) ((MR_Unsigned) 16U));
                        MR_hl_field(MR_mktag(3), ConsId_179, 1) = ((MR_Box) (MR_Word) (Char_94));
                      }
                    else
                      {
                ...
                else
                {
                  ...
                  Name_174 = mdbcomp__sym_name__unqualify_name_1_f_0(SymName0_89);
                  ...
                  if (((MR_tag((MR_Word) TypeCtorSymName_97)) == (MR_Integer) 1))
                  {
...

                    {
                      ...
                      MR_hl_field(MR_mktag(1), SymName_101, 1) = ((MR_Box) (Name_174));
                    }
                    {
                      ...
                      MR_hl_field(MR_mktag(3), ConsId_179, 1) = ((MR_Box) (SymName_101));
                      MR_hl_field(MR_mktag(3), ConsId_179, 2) = ((MR_Box) (Arity_31));
                      MR_hl_field(MR_mktag(3), ConsId_179, 3) = ((MR_Box) (TypeCtorOfX_88));
                    }
                  }
                  else
                    {
            ...
            }
            {
              ...
              MR_hl_field(MR_mktag(1), GoalExpr_180, 0) = ((MR_Box) (X0_18));
              MR_hl_field(MR_mktag(1), GoalExpr_180, 1) = ((MR_Box) (RHS_103));
              MR_hl_field(MR_mktag(1), GoalExpr_180, 2) = ((MR_Box) (Mode0_21));
              MR_hl_field(MR_mktag(1), GoalExpr_180, 3) = ((MR_Box) (Unification0_22));
              MR_hl_field(MR_mktag(1), GoalExpr_180, 4) = ((MR_Box) (UnifyContext_23));
            }
            {
              MR_Word base;
              base = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
      ...
      case (MR_Integer) 1:
        {
          ...
          check_hlds__resolve_unify_functor__get_constructor_containing_field_loop_5_p_0(TermTypeCtor_11, Var_26, FieldName_19, ConsId_9, FieldNumber_10);
        }
        break;
      case (MR_Integer) 2:
        {
      ...
      case (MR_Integer) 1:
        {
          ...
          Var_85 = mercury__one_or_more__one_or_more_to_list_1_f_1((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_constructor_0), Ctors_74);
          check_hlds__resolve_unify_functor__get_constructor_containing_field_loop_5_p_0(TermTypeCtor_70, Var_85, FieldName_78, &ConsId_25, &FieldNumber_26);
        }
        break;
      case (MR_Integer) 2:
        {
