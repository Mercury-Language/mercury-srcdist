  ...
  else
  {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            ...
            TypeCtorInfo_192_192 = (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0);
            ...
            ArgTypes_55 = mercury__list__f_43_43_2_f_0(TypeCtorInfo_192_192, ArgTypes0_54, Var_117);
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            ...
            TypeCtorInfo_195_195 = (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0);
            AllArgTypes_72 = mercury__list__f_43_43_2_f_0(TypeCtorInfo_195_195, ArgTypes0_164, HOArgTypes_71);
      ...
      if (succeeded)
      {
        ...
        {
          MR_Word Var_199 = ((MR_Word) ((MR_hl_field(MR_mktag(1), ProcIds_74, (MR_Integer) 1))));
          MR_Integer Var_200 = ((MR_Integer) ((MR_hl_field(MR_mktag(1), ProcIds_74, (MR_Integer) 0))));
          ...
          if ((Var_199 == (MR_Word) ((MR_Unsigned) 0U)))
            {
              ...
              MR_hl_field(MR_mktag(1), MaybeProcId_76, 0) = ((MR_Box) (Var_200));
            }
          else
          {
            MR_Integer Var_130;
      ...
      else
      {
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            succeeded = hlds__hlds_pred__is_field_access_function_name_5_p_0(ModuleInfo_15, Name_170, &Var_197, &AccessType_87, &FieldName_88);
            if (succeeded)
            {
              succeeded = (Arity_28 == Var_197);
              if (succeeded)
              {
                succeeded = hlds__hlds_pred__is_unify_index_or_compare_pred_1_p_0(STATE_VARIABLE_PredInfo_0_107);
                succeeded = !(succeeded);
        ...
        else
        {
          ...
          if (succeeded)
          {
            ...
            Var_198 = ((MR_Integer) ((MR_hl_field(MR_mktag(3), ConsId0_17, (MR_Integer) 2))));
            succeeded = (Arity_28 == Var_198);
          }
          if (succeeded)
          {
