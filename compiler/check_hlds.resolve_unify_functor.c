...
check_hlds__resolve_unify_functor__IntroducedFrom__func__get_cons_id_arg_types_adding_existq_tvars__481__1_1_f_0(
  ...
  MR_Word * IsPlainUnify_29)
{
  ...
  if (succeeded)
  {
    ...
    Var_116 = (MR_Word) (Arity_31);
    parse_tree__prog_util__user_arity_pred_form_arity_3_p_0((MR_Integer) 1, Var_116, &PredFormArity_41);
    {
  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      hlds__hlds_pred__pred_info_get_markers_2_p_0(STATE_VARIABLE_PredInfo_0_105, &Markers_47);
      hlds__hlds_module__module_info_get_predicate_table_2_p_0(ModuleInfo_17, &PredTable_48);
      Var_119 = hlds__hlds_pred__calls_are_fully_qualified_1_f_0(Markers_47);
      hlds__pred_table__predicate_table_lookup_func_sym_arity_5_p_0(PredTable_48, Var_119, PredName_44, Arity_31, &PredIds_49);
      succeeded = (PredIds_49 != (MR_Word) ((MR_Unsigned) 0U));
      if (succeeded)
      {
        succeeded = hlds__hlds_pred__is_unify_index_or_compare_pred_1_p_0(STATE_VARIABLE_PredInfo_0_105);
        succeeded = !(succeeded);
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            hlds__hlds_pred__pred_info_get_typevarset_2_p_0(STATE_VARIABLE_PredInfo_0_105, &TVarSet_52);
            hlds__hlds_pred__pred_info_get_exist_quant_tvars_2_p_0(STATE_VARIABLE_PredInfo_0_105, &ExistQTVars_53);
            hlds__hlds_pred__pred_info_get_external_type_params_2_p_0(STATE_VARIABLE_PredInfo_0_105, &ExternalTypeParams_54);
            hlds__vartypes__lookup_var_types_3_p_0(STATE_VARIABLE_VarTypes_0_109, ArgVars0_20, &ArgTypes0_55);
            ...
            ArgTypes_56 = mercury__list__f_43_43_2_f_0(TypeCtorInfo_197_197, ArgTypes0_55, Var_120);
            hlds__hlds_pred__pred_info_get_constraint_map_2_p_0(STATE_VARIABLE_PredInfo_0_105, &ConstraintMap_57);
            GoalId_58 = hlds__hlds_goal__goal_info_get_goal_id_1_f_0(GoalInfo0_24);
            Var_122 = (MR_Integer) 0;
            {
              ConstraintSearch_59 = (MR_Word) MR_new_object(MR_Word, (6 * sizeof(MR_Word)), NULL, NULL);
              MR_hl_field(MR_mktag(0), ConstraintSearch_59, 0) = ((MR_Box) (&check_hlds__resolve_unify_functor_scalar_common_5[0]));
              MR_hl_field(MR_mktag(0), ConstraintSearch_59, 1) = ((MR_Box) (check_hlds__resolve_unify_functor__resolve_unify_functor_16_p_0_1));
              MR_hl_field(MR_mktag(0), ConstraintSearch_59, 2) = ((MR_Box) ((MR_Integer) 3));
              MR_hl_field(MR_mktag(0), ConstraintSearch_59, 3) = ((MR_Box) (ConstraintMap_57));
              MR_hl_field(MR_mktag(0), ConstraintSearch_59, 4) = ((MR_Box) (Var_122));
              MR_hl_field(MR_mktag(0), ConstraintSearch_59, 5) = ((MR_Box) (GoalId_58));
            }
            Context_60 = hlds__hlds_goal__goal_info_get_context_1_f_0(GoalInfo0_24);
            {
              Var_123 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), Var_123, 0) = ((MR_Box) (ConstraintSearch_59));
            }
            succeeded = hlds__pred_table__find_matching_pred_id_10_p_0(ModuleInfo_17, PredIds_49, TVarSet_52, ExistQTVars_53, ArgTypes_56, ExternalTypeParams_54, Var_123, Context_60, &PredId_61, &QualifiedFuncName_62);
          }
        }
      }
    }
    if (succeeded)
    {
      ...
      MR_Word FuncCallUnifyContext_64;
      MR_Word FuncCall_65;
      MR_Word Var_124;
      MR_Word Var_126;
      MR_Word Var_129;
      ...
      ProcId_63 = hlds__hlds_pred__invalid_proc_id_0_f_0();
      {
      ...
      ArgVars_165 = mercury__list__f_43_43_2_f_0((MR_Word) (&check_hlds__resolve_unify_functor_scalar_common_1[0]), ArgVars0_20, Var_124);
      {
      ...
      {
        FuncCallUnifyContext_64 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), FuncCallUnifyContext_64, 0) = ((MR_Box) (X0_18));
        MR_hl_field(MR_mktag(0), FuncCallUnifyContext_64, 1) = ((MR_Box) (Var_126));
        MR_hl_field(MR_mktag(0), FuncCallUnifyContext_64, 2) = ((MR_Box) (UnifyContext_23));
      }
      {
        Var_129 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), Var_129, 0) = ((MR_Box) (FuncCallUnifyContext_64));
      }
      {
        FuncCall_65 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, (6 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(2), FuncCall_65, 0) = ((MR_Box) (PredId_61));
        MR_hl_field(MR_mktag(2), FuncCall_65, 1) = ((MR_Box) (ProcId_63));
        MR_hl_field(MR_mktag(2), FuncCall_65, 2) = ((MR_Box) (ArgVars_165));
        MR_hl_field(MR_mktag(2), FuncCall_65, 3) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 1));
        MR_hl_field(MR_mktag(2), FuncCall_65, 4) = ((MR_Box) (Var_129));
        MR_hl_field(MR_mktag(2), FuncCall_65, 5) = ((MR_Box) (QualifiedFuncName_62));
      }
      {
        MR_Word base;
        base = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
        *Goal_28 = base;
        MR_hl_field(MR_mktag(0), base, 0) = ((MR_Box) (FuncCall_65));
        MR_hl_field(MR_mktag(0), base, 1) = ((MR_Box) (GoalInfo0_24));
      }
      *IsPlainUnify_29 = (MR_Word) ((MR_Unsigned) 0U);
      *STATE_VARIABLE_VarTypes_110 = STATE_VARIABLE_VarTypes_0_109;
    ...
    else
    {
      ...
      MR_Word HOArgTypes_72;
      MR_Word AllArgTypes_73;
      MR_Word ExistQVars_74;
      MR_Word Var_130;
      MR_Word Markers_166;
      MR_Word TVarSet_167;
      MR_Word ExternalTypeParams_168;
      ...
      if (succeeded)
      {
        Name_66 = ((MR_Word) ((MR_hl_field(MR_mktag(3), ConsId0_19, (MR_Integer) 1))));
        succeeded = parse_tree__prog_type__type_is_higher_order_details_5_p_0(TypeOfX_30, &_Purity_69, &PredOrFunc_70, &HOArgTypes_72);
        if (succeeded)
        {
          succeeded = hlds__hlds_pred__pred_info_is_field_access_function_2_p_0(ModuleInfo_17, STATE_VARIABLE_PredInfo_0_105);
          succeeded = !(succeeded);
          if (succeeded)
          {
            hlds__vartypes__lookup_var_types_3_p_0(STATE_VARIABLE_VarTypes_0_109, ArgVars0_20, &ArgTypes0_169);
            TypeCtorInfo_200_200 = (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0);
            AllArgTypes_73 = mercury__list__f_43_43_2_f_0(TypeCtorInfo_200_200, ArgTypes0_169, HOArgTypes_72);
            hlds__hlds_pred__pred_info_get_typevarset_2_p_0(STATE_VARIABLE_PredInfo_0_105, &TVarSet_167);
            hlds__hlds_pred__pred_info_get_exist_quant_tvars_2_p_0(STATE_VARIABLE_PredInfo_0_105, &ExistQVars_74);
            hlds__hlds_pred__pred_info_get_external_type_params_2_p_0(STATE_VARIABLE_PredInfo_0_105, &ExternalTypeParams_168);
            hlds__hlds_pred__pred_info_get_markers_2_p_0(STATE_VARIABLE_PredInfo_0_105, &Markers_166);
            Context_192 = hlds__hlds_goal__goal_info_get_context_1_f_0(GoalInfo0_24);
            Var_130 = hlds__hlds_pred__calls_are_fully_qualified_1_f_0(Markers_166);
            succeeded = hlds__pred_table__get_pred_id_by_types_10_p_0(Var_130, Name_66, PredOrFunc_70, TVarSet_167, ExistQVars_74, AllArgTypes_73, ExternalTypeParams_168, ModuleInfo_17, Context_192, &PredId_193);
          }
        }
      }
      if (succeeded)
      {
        MR_Word PredInfo_25;
        MR_Word ProcIds_75;
        MR_Word MaybeProcId_77;

        hlds__hlds_module__module_info_pred_info_3_p_0(ModuleInfo_17, PredId_193, &PredInfo_25);
        ProcIds_75 = hlds__hlds_pred__pred_info_all_procids_1_f_0(PredInfo_25);
        if ((ProcIds_75 == (MR_Word) ((MR_Unsigned) 0U)))
          MaybeProcId_77 = (MR_Word) ((MR_Unsigned) 0U);
        else
        {
          MR_Word Var_204 = ((MR_Word) ((MR_hl_field(MR_mktag(1), ProcIds_75, (MR_Integer) 1))));
          MR_Integer Var_205 = ((MR_Integer) ((MR_hl_field(MR_mktag(1), ProcIds_75, (MR_Integer) 0))));

          if ((Var_204 == (MR_Word) ((MR_Unsigned) 0U)))
            {
              MaybeProcId_77 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), MaybeProcId_77, 0) = ((MR_Box) (Var_205));
            }
          else
          {
            MR_Integer Var_132;
            ...
            {
              MaybeProcId_77 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), MaybeProcId_77, 0) = ((MR_Box) (Var_132));
            }
          }
        }
        if ((MaybeProcId_77 == (MR_Word) ((MR_Unsigned) 0U)))
        {
          MR_Word Pieces_84;
          MR_Word Spec_85;
          MR_Word Var_136;
          ...
          *Goal_28 = hlds__make_goal__true_goal_0_f_0();
          {
            ...
            MR_hl_field(MR_mktag(0), Var_141, 0) = ((MR_Box) (Name_66));
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(1), Spec_85, 0) = ((MR_Box) ((MR_String) "predicate \140check_hlds.resolve_unify_functor.resolve_unify_functor\'/16"));
            MR_hl_field(MR_mktag(1), Spec_85, 1) = ((MR_Box) ((MR_Unsigned) 0U));
            MR_hl_field(MR_mktag(1), Spec_85, 2) = ((MR_Box) ((MR_Unsigned) 48U));
            MR_hl_field(MR_mktag(1), Spec_85, 3) = ((MR_Box) (Context_192));
        ...
        {
          MR_Word ShroudedPredProcId_81;
          MR_Word ConsId_82;
          MR_Word GoalExpr_83;
          MR_Word Var_151;
          MR_Word Var_152;
          MR_Integer ProcId_170 = ((MR_Integer) ((MR_hl_field(MR_mktag(1), MaybeProcId_77, (MR_Integer) 0))));

          {
            Var_151 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
            MR_hl_field(MR_mktag(0), Var_151, 0) = ((MR_Box) (PredId_193));
            MR_hl_field(MR_mktag(0), Var_151, 1) = ((MR_Box) (ProcId_170));
          }
          ShroudedPredProcId_81 = hlds__hlds_pred__shroud_pred_proc_id_1_f_0(Var_151);
          {
            ConsId_82 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(3), ConsId_82, 0) = ((MR_Box) ((MR_Unsigned) 4U));
            MR_hl_field(MR_mktag(3), ConsId_82, 1) = ((MR_Box) (ShroudedPredProcId_81));
            MR_hl_field(MR_mktag(3), ConsId_82, 2) = NULL;
          }
          {
            Var_152 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), Var_152, 0) = ((MR_Box) (ConsId_82));
            MR_hl_field(MR_mktag(1), Var_152, 1) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 0));
            MR_hl_field(MR_mktag(1), Var_152, 2) = ((MR_Box) (ArgVars0_20));
          }
          {
            GoalExpr_83 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), GoalExpr_83, 0) = ((MR_Box) (X0_18));
            MR_hl_field(MR_mktag(1), GoalExpr_83, 1) = ((MR_Box) (Var_152));
            MR_hl_field(MR_mktag(1), GoalExpr_83, 2) = ((MR_Box) (Mode0_21));
            MR_hl_field(MR_mktag(1), GoalExpr_83, 3) = ((MR_Box) (Unification0_22));
            MR_hl_field(MR_mktag(1), GoalExpr_83, 4) = ((MR_Box) (UnifyContext_23));
          }
          {
            MR_Word base;
            base = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
      ...
      else
      {
        ...
        if (succeeded)
        {
          Name_175 = ((MR_Word) ((MR_hl_field(MR_mktag(3), ConsId0_19, (MR_Integer) 1))));
          Var_201 = ((MR_Integer) ((MR_hl_field(MR_mktag(3), ConsId0_19, (MR_Integer) 2))));
          succeeded = (Arity_31 == Var_201);
          if (succeeded)
          {
            succeeded = hlds__hlds_pred__is_field_access_function_name_5_p_0(ModuleInfo_17, Name_175, &Var_202, &AccessType_87, &FieldName_88);
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                ...
                if (succeeded)
                {
                  hlds__hlds_pred__pred_info_get_typevarset_2_p_0(STATE_VARIABLE_PredInfo_0_105, &TVarSet_173);
                  hlds__vartypes__lookup_var_types_3_p_0(STATE_VARIABLE_VarTypes_0_109, ArgVars0_20, &ArgTypes0_174);
                  succeeded = check_hlds__resolve_unify_functor__find_matching_constructor_5_p_0(ModuleInfo_17, TVarSet_173, ConsId0_19, TypeOfX_30, ArgTypes0_174);
                  succeeded = !(succeeded);
                }
              }
            }
        ...
        else
        {
          ...
          if (succeeded)
          {
            ...
            Var_203 = ((MR_Integer) ((MR_hl_field(MR_mktag(3), ConsId0_19, (MR_Integer) 2))));
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
              {
                ConsId_181 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), ConsId_181, 0) = ((MR_Box) ((MR_Unsigned) 3U));
                MR_hl_field(MR_mktag(3), ConsId_181, 1) = ((MR_Box) (Arity_31));
              }
            else
            {
              MR_Word Var_157;
              ...
              if (succeeded)
              {
                Var_157 = ((MR_Word) ((MR_hl_field(MR_mktag(2), TypeOfX_30, (MR_Integer) 0))));
                succeeded = (Var_157 == (MR_Word) ((MR_Unsigned) 8U));
              }
              if (succeeded)
                ...
                else
                {
                  ...
                  if (succeeded)
                    {
                      ConsId_181 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                      MR_hl_field(MR_mktag(3), ConsId_181, 0) = ((MR_Box) ((MR_Unsigned) 7U));
                      MR_hl_field(MR_mktag(3), ConsId_181, 1) = ((MR_Box) (MR_Word) (Char_95));
                    }
                  else
                    {
              ...
              else
              {
                ...
                Name_176 = mdbcomp__sym_name__unqualify_name_1_f_0(SymName0_90);
                ...
                if (((MR_tag((MR_Word) TypeCtorSymName_98)) == (MR_Integer) 1))
                {
...

                  {
                    ...
                    MR_hl_field(MR_mktag(1), SymName_102, 1) = ((MR_Box) (Name_176));
                  }
                  {
                    ConsId_181 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(MR_mktag(3), ConsId_181, 0) = ((MR_Box) ((MR_Unsigned) 2U));
                    MR_hl_field(MR_mktag(3), ConsId_181, 1) = ((MR_Box) (SymName_102));
                    MR_hl_field(MR_mktag(3), ConsId_181, 2) = ((MR_Box) (Arity_31));
                    MR_hl_field(MR_mktag(3), ConsId_181, 3) = ((MR_Box) (TypeCtorOfX_89));
                  }
                }
                else
                  {
            ...
            ConsId_181 = ConsId0_19;
          {
            RHS_104 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), RHS_104, 0) = ((MR_Box) (ConsId_181));
            MR_hl_field(MR_mktag(1), RHS_104, 1) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 0));
            MR_hl_field(MR_mktag(1), RHS_104, 2) = ((MR_Box) (ArgVars0_20));
          }
          {
            GoalExpr_182 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), GoalExpr_182, 0) = ((MR_Box) (X0_18));
            MR_hl_field(MR_mktag(1), GoalExpr_182, 1) = ((MR_Box) (RHS_104));
            MR_hl_field(MR_mktag(1), GoalExpr_182, 2) = ((MR_Box) (Mode0_21));
            MR_hl_field(MR_mktag(1), GoalExpr_182, 3) = ((MR_Box) (Unification0_22));
            MR_hl_field(MR_mktag(1), GoalExpr_182, 4) = ((MR_Box) (UnifyContext_23));
          }
          {
            MR_Word base;
            base = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
            *Goal_28 = base;
            MR_hl_field(MR_mktag(0), base, 0) = ((MR_Box) (GoalExpr_182));
            MR_hl_field(MR_mktag(0), base, 1) = ((MR_Box) (GoalInfo0_24));
          }
  ...
  MR_Box wrapper_arg_1)
{
  ...
  conv0_LambdaHeadVar__2_54 = check_hlds__resolve_unify_functor__IntroducedFrom__func__get_cons_id_arg_types_adding_existq_tvars__481__1_1_f_0(((MR_Word) (wrapper_arg_1)));
