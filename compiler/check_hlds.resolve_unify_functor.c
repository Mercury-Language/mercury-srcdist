...
{
  {
    ...
    conv0_LambdaHeadVar__2_52 = check_hlds__resolve_unify_functor__IntroducedFrom__func__get_cons_id_arg_types_adding_existq_tvars__478__1_1_f_0(((MR_Word) wrapper_arg_1));
...
{
  {
    ...
    else
    {
      ...
      hlds__hlds_class__lookup_hlds_constraint_list_5_p_0(ConstraintMap_38, (MR_Integer) 1, GoalId_10, NumConstraints_39, &ActualConstraints_40);
...
{
  {
    ...
    conv0_LambdaHeadVar__2_34 = check_hlds__resolve_unify_functor__IntroducedFrom__func__find_matching_constructor__315__1_1_f_0(((MR_Word) wrapper_arg_1));
