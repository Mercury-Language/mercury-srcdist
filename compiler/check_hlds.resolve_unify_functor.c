...
check_hlds__resolve_unify_functor__IntroducedFrom__func__get_cons_id_arg_types_adding_existq_tvars__530__1_1_f_0(
  MR_Word LambdaHeadVar__1_53);

static MR_Word MR_CALL 
check_hlds__resolve_unify_functor__IntroducedFrom__func__find_matching_constructor__368__1_1_f_0(
  ...
  if (succeeded)
  {
    DuCtor0_29 = (MR_Word) (MR_body((MR_Word) (ConsId0_18), (MR_Integer) 1));
    {
      ...
      else
      {
        ...
        if (succeeded)
        {
          succeeded = hlds__hlds_pred__is_unify_index_or_compare_pred_1_p_0(STATE_VARIABLE_PredInfo_0_111);
          succeeded = !(succeeded);
          if (succeeded)
          {
            succeeded = hlds__hlds_pred__pred_info_is_field_access_function_5_p_0(ModuleInfo_16, STATE_VARIABLE_PredInfo_0_111, &Var_53, &Var_54, &Var_55);
            succeeded = !(succeeded);
            if (succeeded)
            {
        ...
        else
        {
          ...
          if (succeeded)
          {
            succeeded = hlds__hlds_pred__pred_info_is_field_access_function_5_p_0(ModuleInfo_16, STATE_VARIABLE_PredInfo_0_111, &Var_74, &Var_75, &Var_76);
            succeeded = !(succeeded);
            if (succeeded)
            {
          ...
          else
          {
            ...
            succeeded = hlds__hlds_pred__is_field_access_function_name_6_p_0(ModuleInfo_16, SymName0_32, &Var_195, &AccessType_91, &FieldName_92, &_OoMFieldDefns_93);
            if (succeeded)
            {
  ...
  MR_Box wrapper_arg_1)
{
  ...
  conv0_LambdaHeadVar__2_54 = check_hlds__resolve_unify_functor__IntroducedFrom__func__get_cons_id_arg_types_adding_existq_tvars__530__1_1_f_0(((MR_Word) (wrapper_arg_1)));
  ...
  MR_Box wrapper_arg_1)
{
  ...
  conv0_LambdaHeadVar__2_36 = check_hlds__resolve_unify_functor__IntroducedFrom__func__find_matching_constructor__368__1_1_f_0(((MR_Word) (wrapper_arg_1)));
