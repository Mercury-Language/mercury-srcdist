...
{
  {
    ...
    if (succeeded)
    {
      ...
      {
        Var_116 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), Var_116, 0) = ((MR_Box) (FuncVar_36));
        MR_hl_field(MR_mktag(0), Var_116, 1) = (MR_Box) (((((MR_Unsigned) (Purity_35) << 1)) | (MR_Unsigned) ((MR_Integer) 1)));
        MR_hl_field(MR_mktag(0), Var_116, 2) = ((MR_Box) (FullArity_41));
      }
      {
      ...
      else
      {
        ...
        if (succeeded)
        {
          ...
          if ((MaybeProcId_76 == (MR_Word) ((MR_Unsigned) 0U)))
          {
            ...
            *Goal_28 = hlds__make_goal__true_goal_0_f_0();
            ...
            }
            {
              ...
              MR_hl_field(MR_mktag(3), Var_140, 0) = ((MR_Box) ((MR_Unsigned) 9U));
            ...
            }
            {
              ...
              MR_hl_field(MR_mktag(1), Msg_84, 0) = ((MR_Box) (Context_196));
              MR_hl_field(MR_mktag(1), Msg_84, 1) = ((MR_Box) (Var_148));
            }
            {
            ...
            {
              Spec_85 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
          ...
          else
          {
            ...
            {
              Var_156 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), Var_156, 0) = ((MR_Box) (ConsId_81));
              MR_hl_field(MR_mktag(1), Var_156, 1) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 0));
        ...
        else
        {
          ...
          else
          {
            ...
            if (succeeded)
            {
              ...
              if (succeeded)
                {
                  ConsId_185 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                  MR_hl_field(MR_mktag(3), ConsId_185, 0) = ((MR_Box) ((MR_Unsigned) 3U));
              ...
              else
              {
                ...
                if (succeeded)
                  ...
                  else
                  {
                    ...
                    if (succeeded)
                      {
                        ConsId_185 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                        MR_hl_field(MR_mktag(3), ConsId_185, 0) = ((MR_Box) ((MR_Unsigned) 16U));
                ...
                else
                {
                  ...
                  if (((MR_tag((MR_Word) TypeCtorSymName_98)) == (MR_Integer) 1))
                  {
                    ...
                    {
                      ConsId_185 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL));
                      MR_hl_field(MR_mktag(3), ConsId_185, 0) = ((MR_Box) ((MR_Unsigned) 2U));
            ...
            {
              GoalExpr_186 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL));
