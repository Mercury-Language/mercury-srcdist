      ...
      if (succeeded)
      {
        ...
        else
        {
          ...
          else
          {
            ...
            Var_130 = hlds__hlds_pred__invalid_proc_id_0_f_0();
            {
              MaybeProcId_76 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), MaybeProcId_76, 0) = ((MR_Box) (Var_130));
            }
          }
        }
        if ((MaybeProcId_76 == (MR_Word) ((MR_Unsigned) 0U)))
        {
          ...
          *Goal_23 = hlds__make_goal__true_goal_0_f_0();
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(3), Var_140, 0) = ((MR_Box) ((MR_Unsigned) 10U));
            MR_hl_field(MR_mktag(3), Var_140, 1) = ((MR_Box) (SNA_83));
          }
          {
            ...
            MR_hl_field(MR_mktag(1), Var_139, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &check_hlds__resolve_unify_functor_scalar_common_1[6])));
          }
          {
            Var_136 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), Var_136, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &check_hlds__resolve_unify_functor_scalar_common_1[3])));
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(1), Pieces_84, 1) = ((MR_Box) (Var_136));
          }
          {
        ...
        else
        {
...

          {
            ...
            MR_hl_field(MR_mktag(0), Var_131, 0) = ((MR_Box) (PredId_188));
            MR_hl_field(MR_mktag(0), Var_131, 1) = ((MR_Box) (ProcId_165));
          }
          ShroudedPredProcId_80 = hlds__hlds_pred__shroud_pred_proc_id_1_f_0(Var_131);
          {
          ...
          {
            Var_132 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), Var_132, 0) = ((MR_Box) (ConsId_81));
            MR_hl_field(MR_mktag(1), Var_132, 1) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 0));
            MR_hl_field(MR_mktag(1), Var_132, 2) = ((MR_Box) (ArgVars0_18));
          }
          {
            ...
            MR_hl_field(MR_mktag(1), GoalExpr_82, 1) = ((MR_Box) (Var_132));
