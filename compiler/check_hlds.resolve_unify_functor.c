      ...
      label_0:;
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              FuncVar_38 = ((MR_Word) ((MR_hl_field(1, ArgVars0_19, (MR_Integer) 0))));
              FuncArgVars_39 = ((MR_Word) ((MR_hl_field(1, ArgVars0_19, (MR_Integer) 1))));
            }
          }
        }
      }
      ...
      else
      {
        ...
        else
        {
          ...
          if (succeeded)
          {
            ...
            {
              MR_Word Var_189 = ((MR_Word) ((MR_hl_field(1, ProcIds_73, (MR_Integer) 1))));
              MR_Integer Var_190 = ((MR_Integer) ((MR_hl_field(1, ProcIds_73, (MR_Integer) 0))));
            ...
            else
            {
              ...
              MR_Word Var_128;
              MR_Word Var_129;
              MR_Integer ProcId_166 = ((MR_Integer) ((MR_hl_field(1, MaybeProcId_75, (MR_Integer) 0))));
            ...
            else
            {
              ...
              if (succeeded)
              {
                ...
                else
                {
                  ...
                  if (succeeded)
                  {
                    Var_154 = ((MR_Word) ((MR_hl_field(2, TypeOfX_30, (MR_Integer) 0))));
                  ...
                  if (succeeded)
                    ...
                    {
                      MR_String Name0_89 = ((MR_String) ((MR_hl_field(0, SymName0_32, (MR_Integer) 0))));
                      MR_Char Char_90;
                  ...
                  else
                  {
                    ...
                    TypeCtorSymName_95 = ((MR_Word) ((MR_hl_field(0, TypeCtorOfX_94, (MR_Integer) 0))));
                    if (((MR_tag((MR_Word) TypeCtorSymName_95)) == (MR_Integer) 1))
                    {
                      MR_Word TypeCtorModule_97 = ((MR_Word) ((MR_hl_field(1, TypeCtorSymName_95, (MR_Integer) 0))));
                      MR_Word SymName_99;
                      MR_Word DuCtor_100;
