...
check_hlds__resolve_unify_functor__IntroducedFrom__func__get_cons_id_arg_types_adding_existq_tvars__488__1_1_f_0(
  MR_Word LambdaHeadVar__1_53);

static MR_Word MR_CALL 
check_hlds__resolve_unify_functor__IntroducedFrom__func__find_matching_constructor__326__1_1_f_0(
  ...
  MR_Word * STATE_VARIABLE_PredInfo_110)
{
  ...
  else
  {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            ...
            ArgTypes_57 = mercury__list__f_43_43_2_f_0(TypeCtorInfo_193_193, ArgTypes0_56, Var_119);
    ...
    if (succeeded)
    {
      ...
      ArgVars_162 = mercury__list__f_43_43_2_f_0((MR_Word) (&check_hlds__resolve_unify_functor_scalar_common_1[0]), ArgVars0_19, Var_123);
      {
      ...
      }
      {
        ...
        MR_hl_field(2, FuncCall_67, 2) = ((MR_Box) (ArgVars_162));
    ...
    else
    {
      ...
      MR_Word Markers_163;
      MR_Word TVarSet_164;
      MR_Word ExternalTypeParams_165;
      MR_Word ArgTypes0_166;
      MR_Word _Purity_71;
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            parse_tree__var_table__lookup_var_types_3_p_0(STATE_VARIABLE_VarTable_0_107, ArgVars0_19, &ArgTypes0_166);
            TypeCtorInfo_196_196 = (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0);
            AllArgTypes_74 = mercury__list__f_43_43_2_f_0(TypeCtorInfo_196_196, ArgTypes0_166, HOArgTypes_73);
            hlds__hlds_pred__pred_info_get_typevarset_2_p_0(STATE_VARIABLE_PredInfo_0_109, &TVarSet_164);
            hlds__hlds_pred__pred_info_get_exist_quant_tvars_2_p_0(STATE_VARIABLE_PredInfo_0_109, &ExistQVars_75);
            hlds__hlds_pred__pred_info_get_external_type_params_2_p_0(STATE_VARIABLE_PredInfo_0_109, &ExternalTypeParams_165);
            hlds__hlds_pred__pred_info_get_markers_2_p_0(STATE_VARIABLE_PredInfo_0_109, &Markers_163);
            Context_189 = hlds__hlds_goal__goal_info_get_context_1_f_0(GoalInfo0_23);
            Var_129 = hlds__hlds_pred__calls_are_fully_qualified_1_f_0(Markers_163);
            succeeded = hlds__pred_table__get_pred_id_by_types_11_p_0(Var_129, Name_68, PredOrFunc_72, TVarSet_164, ExistQVars_75, AllArgTypes_74, ExternalTypeParams_165, ModuleInfo_16, Context_189, &PredId_190, &SpecsPrime_191);
          }
        }
      }
      if (succeeded)
      {
        ...
        hlds__hlds_module__module_info_pred_info_3_p_0(ModuleInfo_16, PredId_190, &PredInfo_28);
        ...
        {
          MR_Word Var_200 = ((MR_Word) ((MR_hl_field(1, ProcIds_76, (MR_Integer) 1))));
          MR_Integer Var_201 = ((MR_Integer) ((MR_hl_field(1, ProcIds_76, (MR_Integer) 0))));

          if ((Var_200 == (MR_Word) ((MR_Unsigned) 0U)))
            {
              MaybeProcId_78 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(1, MaybeProcId_78, 0) = ((MR_Box) (Var_201));
            }
          else
          {
            MR_Integer Var_132;
        ...
        if ((MaybeProcId_78 == (MR_Word) ((MR_Unsigned) 0U)))
        {
          ...
          *Goal_24 = hlds__make_goal__true_goal_0_f_0();
          ...
          }
          {
            ...
            MR_hl_field(3, Var_142, 0) = ((MR_Box) ((MR_Unsigned) 11U));
            MR_hl_field(3, Var_142, 1) = ((MR_Box) (SNA_85));
          }
          {
            Var_141 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(1, Var_141, 0) = ((MR_Box) (Var_142));
            MR_hl_field(1, Var_141, 1) = ((MR_Box) (MR_mkword(1, &check_hlds__resolve_unify_functor_scalar_common_1[6])));
          }
          {
            Var_138 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(1, Var_138, 0) = ((MR_Box) (MR_mkword(3, &check_hlds__resolve_unify_functor_scalar_common_1[3])));
            MR_hl_field(1, Var_138, 1) = ((MR_Box) (Var_141));
          }
          {
            Pieces_86 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(1, Pieces_86, 0) = ((MR_Box) (MR_mkword(3, &check_hlds__resolve_unify_functor_scalar_common_1[2])));
            MR_hl_field(1, Pieces_86, 1) = ((MR_Box) (Var_138));
          }
          {
            ...
            MR_hl_field(0, Spec_87, 3) = ((MR_Box) (Context_189));
        ...
        else
        {
          ...
          MR_Word Var_133;
          MR_Word Var_134;
          MR_Integer ProcId_167 = ((MR_Integer) ((MR_hl_field(1, MaybeProcId_78, (MR_Integer) 0))));

          {
            Var_133 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
            MR_hl_field(0, Var_133, 0) = ((MR_Box) (PredId_190));
            MR_hl_field(0, Var_133, 1) = ((MR_Box) (ProcId_167));
          }
      ...
      else
      {
        ...
        if (succeeded)
        {
          Name_172 = ((MR_Word) ((MR_hl_field(3, ConsId0_18, (MR_Integer) 1))));
          Var_197 = ((MR_Integer) ((MR_hl_field(3, ConsId0_18, (MR_Integer) 2))));
          succeeded = (Arity_30 == Var_197);
          if (succeeded)
          {
            succeeded = hlds__hlds_pred__is_field_access_function_name_5_p_0(ModuleInfo_16, Name_172, &Var_198, &AccessType_89, &FieldName_90);
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                ...
                if (succeeded)
                {
                  hlds__hlds_pred__pred_info_get_typevarset_2_p_0(STATE_VARIABLE_PredInfo_0_109, &TVarSet_170);
                  parse_tree__var_table__lookup_var_types_3_p_0(STATE_VARIABLE_VarTable_0_107, ArgVars0_19, &ArgTypes0_171);
                  succeeded = check_hlds__resolve_unify_functor__find_matching_constructor_5_p_0(ModuleInfo_16, TVarSet_170, ConsId0_18, TypeOfX_29, ArgTypes0_171);
                  succeeded = !(succeeded);
                }
              }
            }
        ...
        else
        {
          ...
          if (succeeded)
          {
            ...
            Var_199 = ((MR_Integer) ((MR_hl_field(3, ConsId0_18, (MR_Integer) 2))));
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
              {
                ConsId_178 = (MR_Word) MR_mkword(3, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(3, ConsId_178, 0) = ((MR_Box) ((MR_Unsigned) 4U));
                MR_hl_field(3, ConsId_178, 1) = ((MR_Box) (Arity_30));
              }
            else
            {
              MR_Word Var_154;
              ...
              if (succeeded)
              {
                Var_154 = ((MR_Word) ((MR_hl_field(2, TypeOfX_29, (MR_Integer) 0))));
                succeeded = (Var_154 == (MR_Word) ((MR_Unsigned) 8U));
              }
              if (succeeded)
                ...
                else
                {
                  ...
                  if (succeeded)
                    {
                      ConsId_178 = (MR_Word) MR_mkword(3, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                      MR_hl_field(3, ConsId_178, 0) = ((MR_Box) ((MR_Unsigned) 7U));
                      MR_hl_field(3, ConsId_178, 1) = ((MR_Box) (MR_Word) (Char_97));
                    }
                  else
                    {
              ...
              else
              {
                ...
                Name_173 = mdbcomp__sym_name__unqualify_name_1_f_0(SymName0_92);
                ...
                if (((MR_tag((MR_Word) TypeCtorSymName_100)) == (MR_Integer) 1))
                {
...

                  {
                    ...
                    MR_hl_field(1, SymName_104, 1) = ((MR_Box) (Name_173));
                  }
                  {
                    ConsId_178 = (MR_Word) MR_mkword(3, MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(3, ConsId_178, 0) = ((MR_Box) ((MR_Unsigned) 3U));
                    MR_hl_field(3, ConsId_178, 1) = ((MR_Box) (SymName_104));
                    MR_hl_field(3, ConsId_178, 2) = ((MR_Box) (Arity_30));
                    MR_hl_field(3, ConsId_178, 3) = ((MR_Box) (TypeCtorOfX_91));
                  }
                }
                else
                  {
            ...
            ConsId_178 = ConsId0_18;
          {
            RHS_106 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(1, RHS_106, 0) = ((MR_Box) (ConsId_178));
            MR_hl_field(1, RHS_106, 1) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 0));
            MR_hl_field(1, RHS_106, 2) = ((MR_Box) (ArgVars0_19));
          }
          {
            GoalExpr_179 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(1, GoalExpr_179, 0) = ((MR_Box) (X0_17));
            MR_hl_field(1, GoalExpr_179, 1) = ((MR_Box) (RHS_106));
            MR_hl_field(1, GoalExpr_179, 2) = ((MR_Box) (Mode0_20));
            MR_hl_field(1, GoalExpr_179, 3) = ((MR_Box) (Unification0_21));
            MR_hl_field(1, GoalExpr_179, 4) = ((MR_Box) (UnifyContext_22));
          }
          {
            MR_Word base;
            base = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
            *Goal_24 = base;
            MR_hl_field(0, base, 0) = ((MR_Box) (GoalExpr_179));
            MR_hl_field(0, base, 1) = ((MR_Box) (GoalInfo0_23));
          }
  ...
  MR_Box wrapper_arg_1)
{
  ...
  conv0_LambdaHeadVar__2_54 = check_hlds__resolve_unify_functor__IntroducedFrom__func__get_cons_id_arg_types_adding_existq_tvars__488__1_1_f_0(((MR_Word) (wrapper_arg_1)));
  ...
  MR_Box wrapper_arg_1)
{
  ...
  conv0_LambdaHeadVar__2_36 = check_hlds__resolve_unify_functor__IntroducedFrom__func__find_matching_constructor__326__1_1_f_0(((MR_Word) (wrapper_arg_1)));
