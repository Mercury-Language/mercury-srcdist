  ...
  MR_Word * IsPlainUnify_29)
{
  ...
  hlds__vartypes__lookup_var_type_3_p_0(STATE_VARIABLE_VarTypes_0_111, X0_18, &TypeOfX_30);
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            ...
            hlds__vartypes__lookup_var_types_3_p_0(STATE_VARIABLE_VarTypes_0_111, ArgVars0_20, &ArgTypes0_57);
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            hlds__vartypes__lookup_var_types_3_p_0(STATE_VARIABLE_VarTypes_0_111, ArgVars0_20, &ArgTypes0_170);
            ...
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                ...
                if (succeeded)
                {
                  ...
                  hlds__vartypes__lookup_var_types_3_p_0(STATE_VARIABLE_VarTypes_0_111, ArgVars0_20, &ArgTypes0_175);
