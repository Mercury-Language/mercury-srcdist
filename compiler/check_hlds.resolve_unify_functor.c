  ...
  MR_Word * STATE_VARIABLE_VarSet_14)
{
  ...
  parse_tree__vartypes__add_var_type_4_p_0(*Var_8, Type_7, STATE_VARIABLE_VarTypes_0_11, STATE_VARIABLE_VarTypes_12);
}
    ...
    case (MR_Integer) 0:
      {
        ...
        MR_Word Var_27 = (MR_Word) ((MR_Word) (TermTypeBody_14));
        MR_Word Var_28;

        Ctors_15 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_27, (MR_Integer) 0))));
        FieldName_20 = mdbcomp__sym_name__unqualify_name_1_f_0(FieldSymName_8);
        Var_28 = mercury__one_or_more__one_or_more_to_list_1_f_1((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_constructor_0), Ctors_15);
        check_hlds__resolve_unify_functor__get_constructor_containing_field_loop_5_p_0(TermTypeCtor_11, Var_28, FieldName_20, ConsId_9, FieldNumber_10);
      }
      break;
    case (MR_Integer) 1:
      {
  ...
  MR_Word * GoalExpr_23)
{
  ...
  switch (MR_tag((MR_Word) TermTypeBody_73)) {
    ...
    case (MR_Integer) 0:
      {
        MR_Word Ctors_74;
        MR_String FieldName_79;
        MR_Word Var_86 = (MR_Word) ((MR_Word) (TermTypeBody_73));
        MR_Word Var_87;

        Ctors_74 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_86, (MR_Integer) 0))));
        FieldName_79 = mdbcomp__sym_name__unqualify_name_1_f_0(FieldName_18);
        Var_87 = mercury__one_or_more__one_or_more_to_list_1_f_1((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_constructor_0), Ctors_74);
        check_hlds__resolve_unify_functor__get_constructor_containing_field_loop_5_p_0(TermTypeCtor_70, Var_87, FieldName_79, &ConsId_25, &FieldNumber_26);
      }
      break;
    case (MR_Integer) 1:
      {
  ...
  MR_Word * After_10)
{
  ...
  MR_Integer Var_15 = (MR_Integer) ((MR_Unsigned) Index_6 - (MR_Unsigned) 1);

  succeeded = mercury__list__split_list_4_p_0(TypeInfo_for_T_19, Var_15, List_7, &BeforePrime_11, &AtAndAfter_12);
  if (succeeded)
  {
    succeeded = (AtAndAfter_12 != (MR_Word) ((MR_Unsigned) 0U));
    if (succeeded)
    {
