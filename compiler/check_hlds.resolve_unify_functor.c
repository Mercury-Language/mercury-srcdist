...
{
  {
    ...
    MR_Word Var_58 = ((MR_Word) (MR_hl_field(MR_mktag(0), LambdaHeadVar__1_51, (MR_Integer) 0)));
    MR_Word Var_59 = ((MR_Word) (MR_hl_field(MR_mktag(0), LambdaHeadVar__1_51, (MR_Integer) 2)));
...
{
  {
    ...
    TypeInfo_200_200 = (MR_Word) &check_hlds__resolve_unify_functor_scalar_common_1[0];
    mercury__list__length_2_p_0(TypeInfo_200_200, ArgVars0_20, &Arity_31);
    ...
    if (succeeded)
    {
      ...
      ArgVars_38 = mercury__list__f_43_43_2_f_0(TypeInfo_200_200, FuncArgVars_37, Var_113);
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        ArgVars_169 = mercury__list__f_43_43_2_f_0(TypeInfo_200_200, ArgVars0_20, Var_124);
        {
      ...
      else
      {
        ...
        if (succeeded)
        {
          ...
          else
          {
            ...
            if ((Var_208 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
              {
...
{
  {
    ...
    TypeInfo_85_85 = (MR_Word) &check_hlds__resolve_unify_functor_scalar_common_1[0];
    {
    ...
    DeconstructArgs_38 = mercury__list__f_43_43_2_f_0(TypeInfo_85_85, VarsBeforeField_35, Var_68);
    OldNonLocals_39 = hlds__hlds_goal__goal_info_get_nonlocals_1_f_0(OldGoalInfo_24);
    NonLocalArgs_40 = mercury__list__f_43_43_2_f_0(TypeInfo_85_85, VarsBeforeField_35, VarsAfterField_37);
    TypeCtorInfo_86_86 = (MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0;
    parse_tree__set_of_var__insert_list_3_p_0(TypeCtorInfo_86_86, NonLocalArgs_40, OldNonLocals_39, &DeconstructRestrictNonLocals_41);
    {
    ...
    ConstructArgs_43 = mercury__list__f_43_43_2_f_0(TypeInfo_85_85, VarsBeforeField_35, Var_72);
    parse_tree__set_of_var__insert_list_3_p_0(TypeCtorInfo_86_86, NonLocalArgs_40, OldNonLocals_39, &ConstructRestrictNonLocals_44);
  ...
  MR_Integer * FieldNumber_5)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      MR_Word SymName_19 = ((MR_Word) (MR_hl_field(MR_mktag(0), Ctor_13, (MR_Integer) 1)));
      MR_Word CtorArgs_20 = ((MR_Word) (MR_hl_field(MR_mktag(0), Ctor_13, (MR_Integer) 2)));
      MR_Integer Arity_21 = ((MR_Integer) (MR_hl_field(MR_mktag(0), Ctor_13, (MR_Integer) 3)));
      MR_Word Var_18 = ((MR_Word) (MR_hl_field(MR_mktag(0), Ctor_13, (MR_Integer) 0)));
      MR_Word _Ctxt_22 = ((MR_Word) (MR_hl_field(MR_mktag(0), Ctor_13, (MR_Integer) 4)));
      MR_Integer FieldNumberPrime_23;

      succeeded = check_hlds__resolve_unify_functor__search_for_named_field_4_p_0(CtorArgs_20, UnqualFieldName_3, (MR_Integer) 1, &FieldNumberPrime_23);
      if (succeeded)
      {
        {
          MR_Word base;
          ...
          *ConsId_4 = base;
          ...
          MR_hl_field(MR_mktag(3), base, 1) = ((MR_Box) (SymName_19));
          MR_hl_field(MR_mktag(3), base, 2) = ((MR_Box) (Arity_21));
          MR_hl_field(MR_mktag(3), base, 3) = ((MR_Box) (TypeCtor_1));
        }
        *FieldNumber_5 = FieldNumberPrime_23;
      }
      else
      {
...
{
  {
    ...
    ConsArgTypes_25 = mercury__list__map_2_f_0((MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_constructor_arg_0, TypeCtorInfo_61_61, (MR_Word) &check_hlds__resolve_unify_functor_scalar_common_3[1], ConsArgs_23);
    ...
    {
      MR_Word TypeInfo_62_62 = (MR_Word) &check_hlds__resolve_unify_functor_scalar_common_1[1];
      ...
      mercury__list__length_2_p_0(TypeInfo_62_62, ConsExistQVars_29, &NumExistQVars_31);
      ...
      mercury__map__from_corresponding_lists_3_p_0(TypeInfo_62_62, TypeInfo_62_62, ConsExistQVars_29, ParentExistQVars_33, &ConsToParentRenaming_35);
      ...
      parse_tree__prog_type__constraint_list_get_tvars_2_p_0(ActualConstraints_40, &TVarsB_70);
      mercury__map__init_1_p_0((MR_Word) &check_hlds__resolve_unify_functor_scalar_common_1[1], (MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0, &Subst0_71);
      succeeded = check_hlds__resolve_unify_functor__unify_constraint_list_5_p_0(ParentConstraints_37, ActualConstraints_40, TVarsB_70, Subst0_71, &Subst1_72);
      if (succeeded)
        ExistTSubst_41 = Subst1_72;
      else
      {
        {
      ...
      mercury__map__init_1_p_0(TypeInfo_62_62, (MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_kind_0, &KindMap_42);
    ...
    mercury__map__from_corresponding_lists_3_p_0((MR_Word) &check_hlds__resolve_unify_functor_scalar_common_1[1], TypeCtorInfo_61_61, TypeParams_20, TypeArgs_46, &UnivTSubst_47);
