...
{
  {
    ...
    if (succeeded)
    {
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(3), HOCall_42, 3) = ((MR_Box) ((MR_Integer) 0));
        MR_hl_field(MR_mktag(3), HOCall_42, 4) = ((MR_Box) ((MR_Integer) 0));
      ...
      *IsPlainUnify_29 = (MR_Word) ((MR_Integer) 0);
    ...
    else
    {
      ...
      else
      {
        ...
        if (succeeded)
        {
          ...
          if ((ProcIds_74 == (MR_Word) ((MR_Integer) 0)))
            MaybeProcId_76 = (MR_Word) ((MR_Integer) 0);
          else
          {
            ...
            if ((Var_208 == (MR_Word) ((MR_Integer) 0)))
              {
          ...
          if ((MaybeProcId_76 == (MR_Word) ((MR_Integer) 0)))
          {
            MR_Word Pieces_83;
            MR_Word Msg_84;
            MR_Word Spec_85;
            ...
            *Goal_28 = hlds__make_goal__true_goal_0_f_0();
            ...
            }
            {
              ...
              MR_hl_field(MR_mktag(0), Spec_85, 0) = ((MR_Box) ((MR_Integer) 0));
              MR_hl_field(MR_mktag(0), Spec_85, 1) = ((MR_Box) ((MR_Integer) 24));
        ...
        else
        {
          ...
          else
          {
            ...
            if (succeeded)
            {
              ...
              else
              {
                ...
                if (succeeded)
                {
                  ...
                  succeeded = (Var_161 == (MR_Word) ((MR_Integer) 8));
                }
                if (succeeded)
            ...
            *IsPlainUnify_29 = (MR_Word) ((MR_Integer) 4);
            *STATE_VARIABLE_VarTypes_110 = STATE_VARIABLE_VarTypes_0_109;
            *STATE_VARIABLE_VarSet_108 = STATE_VARIABLE_VarSet_0_107;
            *STATE_VARIABLE_PredInfo_106 = STATE_VARIABLE_PredInfo_0_105;
          }
...
{
  {
    ...
    if ((ExistQVars_31 == (MR_Word) ((MR_Integer) 0)))
...
{
  {
    ...
    if ((ExistQVars_29 == (MR_Word) ((MR_Integer) 0)))
...
{
  {
    ...
    if ((MaybeExistConstraints_22 == (MR_Word) ((MR_Integer) 0)))
    {
      ActualArgTypes0_27 = ConsArgTypes_25;
      *ActualExistQVars_14 = (MR_Word) ((MR_Integer) 0);
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          if ((MaybeExistConstraints_18 == (MR_Word) ((MR_Integer) 0)))
            ConsExistQVars_25 = (MR_Word) ((MR_Integer) 0);
          else
          {
          ...
          ExistQVars_31 = (MR_Word) ((MR_Integer) 0);
          ExternalTypeParams_32 = (MR_Word) ((MR_Integer) 0);
