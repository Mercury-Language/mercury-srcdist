            ...
            if (check_hlds__resolve_unify_functor__succeeded)
              {
                ...
                check_hlds__resolve_unify_functor__Var_30 = (MR_Word) &check_hlds__resolve_unify_functor_scalar_common_5[0];
                {
                ...
                if ((check_hlds__resolve_unify_functor__MaybeProcId_76 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
                  {
                    ...
                    }
                    {
                      ...
                      MR_hl_field(MR_mktag(1), check_hlds__resolve_unify_functor__Var_136, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &check_hlds__resolve_unify_functor_scalar_common_1[6])));
