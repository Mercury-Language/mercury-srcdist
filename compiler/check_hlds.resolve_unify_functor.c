...
{
  {
    ...
    MR_Word Var_60 = ((MR_Word) (MR_hl_field(MR_mktag(0), LambdaHeadVar__1_53, (MR_Integer) 0)));
    MR_Word Var_61 = ((MR_Word) (MR_hl_field(MR_mktag(0), LambdaHeadVar__1_53, (MR_Integer) 2)));
...
{
  {
    ...
    MR_Word Var_38 = ((MR_Word) (MR_hl_field(MR_mktag(0), LambdaHeadVar__1_35, (MR_Integer) 0)));
    MR_Word Var_39 = ((MR_Word) (MR_hl_field(MR_mktag(0), LambdaHeadVar__1_35, (MR_Integer) 2)));
...
{
  {
    ...
    ConsArgTypes_25 = mercury__list__map_2_f_0((MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_constructor_arg_0, TypeCtorInfo_63_63, (MR_Word) &check_hlds__resolve_unify_functor_scalar_common_3[1], ConsArgs_23);
    ...
    else
    {
      ...
      MR_Word TVarsB_72;
      MR_Word Subst0_73;
      MR_Word _UnconstrainedExistQVars_31 = ((MR_Word) (MR_hl_field(MR_mktag(0), ExistConstraints_28, (MR_Integer) 2)));
      MR_Word _ConstrainedExistQVars_32 = ((MR_Word) (MR_hl_field(MR_mktag(0), ExistConstraints_28, (MR_Integer) 3)));
      MR_Word Subst1_74;
      MR_Word ActualExistQVars0_46;

      mercury__list__length_2_p_0(TypeInfo_64_64, ConsExistQVars_29, &NumExistQVars_33);
      ...
      mercury__map__from_corresponding_lists_3_p_0(TypeInfo_64_64, TypeInfo_64_64, ConsExistQVars_29, ParentExistQVars_35, &ConsToParentRenaming_37);
      ...
      mercury__map__init_1_p_0(TypeInfo_64_64, (MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_kind_0, &KindMap_44);
    ...
    mercury__map__from_corresponding_lists_3_p_0((MR_Word) &check_hlds__resolve_unify_functor_scalar_common_1[1], TypeCtorInfo_63_63, TypeParams_20, TypeArgs_48, &UnivTSubst_49);
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          else
          {
            ...
            Var_26 = ((MR_Word) (MR_hl_field(MR_mktag(0), Var_33, (MR_Integer) 1)));
            Var_27 = ((MR_Word) (MR_hl_field(MR_mktag(0), Var_33, (MR_Integer) 2)));
            Var_28 = ((MR_Word) (MR_hl_field(MR_mktag(0), Var_33, (MR_Integer) 3)));
          }
          ...
          ExistQVars_31 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
          ExternalTypeParams_32 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
