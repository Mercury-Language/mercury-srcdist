...
check_hlds__resolve_unify_functor__IntroducedFrom__func__get_cons_id_arg_types_adding_existq_tvars__489__1_1_f_0(
  MR_Word LambdaHeadVar__1_53);

static MR_Word MR_CALL 
check_hlds__resolve_unify_functor__IntroducedFrom__func__find_matching_constructor__327__1_1_f_0(
  ...
  else
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        succeeded = parse_tree__prog_type_test__type_is_higher_order_details_5_p_0(TypeOfX_29, &_Purity_71, &PredOrFunc_72, &HOArgTypes_74);
        if (succeeded)
        {
          succeeded = hlds__hlds_pred__pred_info_is_field_access_function_2_p_0(ModuleInfo_16, STATE_VARIABLE_PredInfo_0_110);
          succeeded = !(succeeded);
  ...
  MR_Box wrapper_arg_1)
{
  ...
  conv0_LambdaHeadVar__2_54 = check_hlds__resolve_unify_functor__IntroducedFrom__func__get_cons_id_arg_types_adding_existq_tvars__489__1_1_f_0(((MR_Word) (wrapper_arg_1)));
  ...
  MR_Box wrapper_arg_1)
{
  ...
  conv0_LambdaHeadVar__2_36 = check_hlds__resolve_unify_functor__IntroducedFrom__func__find_matching_constructor__327__1_1_f_0(((MR_Word) (wrapper_arg_1)));
