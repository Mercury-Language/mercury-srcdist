...
{
  {
    ...
    else
    {
      ...
      succeeded = ((((MR_tag((MR_Word) Var_36)) == (MR_Integer) 3)) && ((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), Var_36, (MR_Integer) 0))) == (MR_Integer) 2)));
      if (succeeded)
      {
        packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Var_36, (MR_Integer) 1)));
      ...
      case (MR_Integer) 2:
        {
          ...
          MR_Unsigned packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), GoalExpr0_15, (MR_Integer) 3)));
          MR_Word CallAux0_41;
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              ...
              packed_word_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), CallAux0_41, (MR_Integer) 3)));
          ...
          case (MR_Integer) 4:
            {
              ...
              MR_Unsigned packed_word_4 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), GoalExpr0_15, (MR_Integer) 2)));
          ...
          case (MR_Integer) 5:
            {
              ...
              if (succeeded)
              {
                packed_word_3 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Reason_56, (MR_Integer) 2)));
...
{
  {
    ...
    {
      Origin_48 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      else
      {
        ...
        succeeded = ((MR_tag((MR_Word) NewVars_24)) == (MR_Integer) 1);
        if (succeeded)
        {
                ...
                if (succeeded)
                {
                  ...
                  if (succeeded)
                  {
                    ...
                    if (succeeded)
                    {
                      ...
                      if (succeeded)
                      {
                        succeeded = ((MR_tag((MR_Word) SingleCtorArgs_27)) == (MR_Integer) 1);
                        if (succeeded)
                        {
            ...
            {
              {
                ...
                MR_hl_field(MR_mktag(3), Var_33, 0) = ((MR_Box) ((MR_Unsigned) 6U));
...
{
  {
    MR_bool succeeded = ((((MR_tag((MR_Word) HeadVar__2_2)) == (MR_Integer) 3)) && ((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), HeadVar__2_2, (MR_Integer) 0))) == (MR_Integer) 6)));
    MR_Word ArgX1_45;
                  ...
                  if (succeeded)
                  {
                    ...
                    if (succeeded)
                    {
                      ...
                      if (succeeded)
                      {
                        ...
                        if (succeeded)
                        {
                          succeeded = ((MR_tag((MR_Word) SingleCtorArgs_23)) == (MR_Integer) 1);
                          if (succeeded)
                          {
