...
transform_hlds__untupling__IntroducedFrom__func__expand_type__771__1_1_f_0(
  ...
  else
  {
    ...
    else
    {
      ...
      else
      {
        ...
        hlds__var_table_hlds__create_fresh_vars_5_p_0(ModuleInfo_1, Types_57, &ReplacementArgVars_59, STATE_VARIABLE_VarTable_0_9, &STATE_VARIABLE_VarTable_68_68);
        ...
        if (succeeded)
        {
          ...
          transform_hlds__untupling__expand_call_args_2_10_p_0(ModuleInfo_1, TypeTable_2, ContainerTypes_61, Var_69, Var_70, HeadVar__6_6, &EnterUnifs1_63, HeadVar__8_8, STATE_VARIABLE_VarTable_68_68, STATE_VARIABLE_VarTable_10);
          {
            MR_Word base;
            base = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            *HeadVar__7_7 = base;
        ...
        else
        {
          ...
          if (succeeded)
          {
            ...
            transform_hlds__untupling__expand_call_args_2_10_p_0(ModuleInfo_1, TypeTable_2, ContainerTypes_61, Var_74, Var_75, HeadVar__6_6, HeadVar__7_7, &ExitUnifs1_64, STATE_VARIABLE_VarTable_68_68, STATE_VARIABLE_VarTable_10);
  ...
  MR_Box wrapper_arg_1)
{
  ...
  conv0_LambdaHeadVar__2_31 = transform_hlds__untupling__IntroducedFrom__func__expand_type__771__1_1_f_0(((MR_Word) (wrapper_arg_1)));
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                ...
                Var_30 = ((MR_Word) ((MR_hl_field(0, TypeBodyDu_21, (MR_Integer) 0))));
                SingleCtor_22 = ((MR_Word) ((MR_hl_field(0, Var_30, (MR_Integer) 0))));
                Var_31 = ((MR_Word) ((MR_hl_field(0, Var_30, (MR_Integer) 1))));
                succeeded = (Var_31 == (MR_Word) ((MR_Unsigned) 0U));
                if (succeeded)
                {
                  Var_32 = ((MR_Word) ((MR_hl_field(0, SingleCtor_22, (MR_Integer) 1))));
                  SingleCtorName_23 = ((MR_Word) ((MR_hl_field(0, SingleCtor_22, (MR_Integer) 2))));
                  SingleCtorArgs_24 = ((MR_Word) ((MR_hl_field(0, SingleCtor_22, (MR_Integer) 3))));
