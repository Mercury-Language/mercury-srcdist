...
MR_decl_label10(transform_hlds__untupling__expand_call_args_2_11_0, 92,91,11,12,15,14,17,18,19,20)
...
MR_decl_label10(transform_hlds__untupling__fix_calls_in_goal_8_0, 24,23,30,32,33,34,35,41,42,43)
MR_decl_label10(transform_hlds__untupling__fix_calls_in_goal_8_0, 36,44,28,27,49,52,48,57,56,60)
MR_decl_label2(transform_hlds__untupling__fix_calls_in_goal_8_0, 148,147)
...
MR_BEGIN_MODULE(transform_hlds__untupling_module15)
	...
	MR_init_label10(transform_hlds__untupling__expand_call_args_2_11_0,92,91,11,12,15,14,17,18,19,20)
...
MR_def_static(transform_hlds__untupling__expand_call_args_2_11_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
		MR_GOTO_LAB(transform_hlds__untupling__expand_call_args_2_11_0_i91);
	}
	if (MR_LTAGS_TESTR(MR_r2,0,0)) {
		MR_GOTO_LAB(transform_hlds__untupling__expand_call_args_2_11_0_i92);
	}
	MR_r1 = (MR_Word) MR_tbmkword(0, 0);
	MR_r2 = (MR_Word) MR_tbmkword(0, 0);
	{
...
MR_def_label(transform_hlds__untupling__expand_call_args_2_11_0,92)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(15);
...
MR_def_label(transform_hlds__untupling__expand_call_args_2_11_0,91)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(15);
	MR_sv(15) = (MR_Word) MR_succip;
	if (MR_LTAGS_TEST(MR_r2,0,0)) {
...
MR_BEGIN_MODULE(transform_hlds__untupling_module16)
	...
	MR_init_label10(transform_hlds__untupling__fix_calls_in_goal_8_0,24,23,30,32,33,34,35,41,42,43)
	MR_init_label10(transform_hlds__untupling__fix_calls_in_goal_8_0,36,44,28,27,49,52,48,57,56,60)
	MR_init_label2(transform_hlds__untupling__fix_calls_in_goal_8_0,148,147)
MR_BEGIN_CODE
...
MR_def_static(transform_hlds__untupling__fix_calls_in_goal_8_0)
	...
	if (((((MR_tag(MR_tempr1) == MR_mktag((MR_Integer) 3)) && ((MR_Integer) MR_tfield(3, MR_tempr1, 0) == (MR_Integer) 0)) || (MR_tag(MR_tempr1) == MR_mktag((MR_Integer) 2))) || (MR_tag(MR_tempr1) == MR_mktag((MR_Integer) 0)))) {
		MR_GOTO_LAB(transform_hlds__untupling__fix_calls_in_goal_8_0_i148);
	}
	MR_incr_sp(10);
...
MR_def_label(transform_hlds__untupling__fix_calls_in_goal_8_0,27)
	...
	if (MR_RTAGS_TESTR(MR_r6,3,5)) {
		MR_GOTO_LAB(transform_hlds__untupling__fix_calls_in_goal_8_0_i48);
	}
	{
	MR_Word MR_tempr1, MR_tempr2, MR_tempr3;
	MR_tempr3 = MR_r6;
	...
	if (MR_INT_EQ(MR_tempr2,0)) {
		MR_GOTO_LAB(transform_hlds__untupling__fix_calls_in_goal_8_0_i147);
	}
	}
...
MR_def_label(transform_hlds__untupling__fix_calls_in_goal_8_0,48)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_def_label(transform_hlds__untupling__fix_calls_in_goal_8_0,60)
	...
	MR_decr_sp(10);
	MR_np_tailcall_ent(libs__compiler_util__unexpected_2_0);
MR_def_label(transform_hlds__untupling__fix_calls_in_goal_8_0,148)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_proceed();
MR_def_label(transform_hlds__untupling__fix_calls_in_goal_8_0,147)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(10);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
