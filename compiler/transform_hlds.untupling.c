...
transform_hlds__untupling__IntroducedFrom__func__expand_type__784__1_1_f_0(
...
static MR_bool MR_CALL 
transform_hlds__untupling____Unify______hlds__hlds_predpred_origin_0_1(
  MR_Word HeadVar__1_1,
  MR_Word HeadVar__2_2);
...
{
  {
    ...
    else
    {
      ...
      check_hlds__recompute_instmap_deltas__recompute_instmap_delta_proc_5_p_0((MR_Integer) 0, STATE_VARIABLE_ProcInfo_25_25, &STATE_VARIABLE_ProcInfo_27_27, STATE_VARIABLE_ModuleInfo_0_18, &STATE_VARIABLE_ModuleInfo_28_28);
...
{
  {
    ...
    check_hlds__recompute_instmap_deltas__recompute_instmap_delta_proc_5_p_0((MR_Integer) 0, STATE_VARIABLE_ProcInfo_48_48, &STATE_VARIABLE_ProcInfo_50_50, STATE_VARIABLE_ModuleInfo_0_35, &STATE_VARIABLE_ModuleInfo_51_51);
...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(3), Transform_45, 0) = ((MR_Box) ((MR_Unsigned) 4U));
    ...
    hlds__hlds_pred__define_new_pred_20_p_0(AuxPredSymName_46, Origin_47, TVarSet_29, VarTypes_30, ClassContext_31, RttiVarMaps_32, InstVarSet_34, InitialAuxInstMap_28, VarSet_33, VarNameRemap_38, Markers_35, (MR_Integer) 1, HasParallelConj_37, &AuxPredProcId_48, AuxHeadVars_24, &_ExtraArgs_49, Goal_25, CallAux_20, STATE_VARIABLE_ModuleInfo_0_50, STATE_VARIABLE_ModuleInfo_51);
...
{
  {
    ...
    conv0_LambdaHeadVar__2_30 = transform_hlds__untupling__IntroducedFrom__func__expand_type__784__1_1_f_0(((MR_Word) (wrapper_arg_1)));
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              ...
              succeeded = transform_hlds__untupling____Unify______hlds__hlds_predpred_origin_0_1(Var_34, Var_55);
              if (succeeded)
              {
