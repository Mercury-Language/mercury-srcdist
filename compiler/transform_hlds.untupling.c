...
MR_decl_label10(transform_hlds__untupling__fix_calls_in_goal_8_0, 35,27,26,47,50,46,55,54,145,144)
...
MR_BEGIN_MODULE(transform_hlds__untupling_module15)
	...
	MR_init_label10(transform_hlds__untupling__fix_calls_in_goal_8_0,35,27,26,47,50,46,55,54,145,144)
MR_BEGIN_CODE
...
MR_def_label(transform_hlds__untupling__fix_calls_in_goal_8_0,26)
	...
	if (MR_INT_EQ(MR_tempr2,0)) {
		MR_GOTO_LAB(transform_hlds__untupling__fix_calls_in_goal_8_0_i144);
	}
	}
MR_def_label(transform_hlds__untupling__fix_calls_in_goal_8_0,47)
	...
	MR_r1 = MR_r7;
	MR_np_localcall_lab(transform_hlds__untupling__fix_calls_in_goal_8_0,
		transform_hlds__untupling__fix_calls_in_goal_8_0_i50);
...
MR_def_label(transform_hlds__untupling__fix_calls_in_goal_8_0,46)
	...
	if (MR_RTAGS_TESTR(MR_r6,3,4)) {
		MR_GOTO_LAB(transform_hlds__untupling__fix_calls_in_goal_8_0_i54);
	}
	MR_incr_sp(10);
	MR_sv(10) = (MR_Word) MR_succip;
	MR_sv(3) = MR_tfield(0, MR_r1, 1);
	...
	MR_np_call_localret_ent(transform_hlds__untupling__fix_calls_in_cases_8_0,
		transform_hlds__untupling__fix_calls_in_goal_8_0_i55);
...
MR_def_label(transform_hlds__untupling__fix_calls_in_goal_8_0,54)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_string_const("transform_hlds.untupling", 24);
	MR_r2 = (MR_Word) MR_string_const("predicate \140transform_hlds.untupling.fix_calls_in_goal\'/8", 56);
...
MR_def_label(transform_hlds__untupling__fix_calls_in_goal_8_0,145)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_proceed();
MR_def_label(transform_hlds__untupling__fix_calls_in_goal_8_0,144)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(10);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
