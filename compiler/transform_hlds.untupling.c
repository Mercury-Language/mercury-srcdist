...
{
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Var_36, (MR_Integer) 1)));
      ...
      case (MR_Integer) 2:
        {
          ...
          MR_Unsigned packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), GoalExpr0_15, (MR_Integer) 3)));
          MR_Word CallAux0_41;
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              ...
              packed_args_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), CallAux0_41, (MR_Integer) 3)));
              ...
              Var_126 = ((MR_Word) ((MR_hl_field(MR_mktag(2), CallAux0_41, (MR_Integer) 5))));
              {
                ...
                MR_hl_field(MR_mktag(2), CallAux_50, 3) = (MR_Box) (packed_args_2);
          ...
          case (MR_Integer) 2:
            {
              ...
              }
              {
                ...
                MR_hl_field(MR_mktag(3), GoalExpr_115, 1) = (MR_Box) (packed_args_0);
          ...
          case (MR_Integer) 4:
            {
              ...
              MR_Unsigned packed_args_4 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), GoalExpr0_15, (MR_Integer) 2)));
              ...
              transform_hlds__untupling__fix_calls_in_cases_8_p_0(Cases0_64, &Cases_65, STATE_VARIABLE_VarSet_0_74, STATE_VARIABLE_VarSet_75, STATE_VARIABLE_VarTypes_0_76, STATE_VARIABLE_VarTypes_77, TransformMap_13, ModuleInfo_14);
              {
                ...
                MR_hl_field(MR_mktag(3), GoalExpr_119, 2) = (MR_Box) (packed_args_4);
          ...
          case (MR_Integer) 5:
            {
              ...
              if (succeeded)
              {
                packed_args_3 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Reason_56, (MR_Integer) 2)));
