  ...
  MR_Word * STATE_VARIABLE_Counter_40)
{
  ...
  transform_hlds__untupling__expand_args_in_proc_2_12_p_0(HeadVars0_17, ArgModes0_18, &HeadVars_22, &ArgModes_23, Goal0_19, &Goal_24, VarSet0_20, &VarSet_25, VarTypes0_21, &VarTypes_26, TypeTable_15, &UntupleMap_27);
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_51)
{
  ...
  hlds__hlds_pred__define_new_pred_20_p_0(AuxPredSymName_46, Origin_47, TVarSet_29, VarTypes_31, ClassContext_32, RttiVarMaps_33, InstVarSet_34, InitialAuxInstMap_28, VarSet_30, VarNameRemap_38, Markers_35, (MR_Integer) 1, HasParallelConj_37, &AuxPredProcId_48, AuxHeadVars_24, &_ExtraArgs_49, Goal_25, CallAux_20, STATE_VARIABLE_ModuleInfo_0_50, STATE_VARIABLE_ModuleInfo_51);
  ...
  MR_Word * UntupleMap_23)
{
  ...
  transform_hlds__untupling__expand_args_in_proc_3_12_p_0(HeadVars0_13, ArgModes0_14, &ListOfHeadVars_24, &ListOfArgModes_25, Goal0_17, &Var_32, STATE_VARIABLE_VarSet_0_28, STATE_VARIABLE_VarSet_29, STATE_VARIABLE_VarTypes_0_30, STATE_VARIABLE_VarTypes_31, (MR_Word) ((MR_Unsigned) 0U), TypeTable_22);
  ...
  mercury__list__condense_2_p_0((MR_Word) (&transform_hlds__untupling_scalar_common_2[0]), ListOfHeadVars_24, HeadVars_15);
  ...
  Var_37 = mercury__map__init_0_f_0((MR_Word) (&transform_hlds__untupling_scalar_common_2[0]), (MR_Word) (&transform_hlds__untupling_scalar_common_2[1]));
  ...
  MR_Word TypeTable_21)
{
  ...
  if ((MaybeHeadVarsAndArgModes_22 == (MR_Word) ((MR_Unsigned) 0U)))
  {
    {
      MR_Word base;
      base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      hlds__hlds_goal__goal_info_set_determinism_3_p_0(Determinism_60, GoalInfo0_61, &GoalInfo_62);
      {
        ...
        MR_hl_field(MR_mktag(3), Var_63, 1) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 0));
  ...
  MR_Word * Expansion_10)
{
  ...
  if (succeeded)
  {
    ...
    else
    {
      ...
      MR_Word TypeCtor_44;
      MR_Word TypeInfo_64_74;
      MR_Word TypeInfo_65_75;
      MR_Word TypeDefn_23;
      MR_Word TypeBody_24;
      ...
      MR_Word Var_72;
      MR_Word Var_73;
      MR_Word TypeCtorInfo_59_69;

      succeeded = parse_tree__prog_type__type_to_ctor_and_args_3_p_0(ArgType_7, &TypeCtor_44, &Var_72);
      if (succeeded)
      {
        TypeInfo_64_74 = (MR_Word) (&transform_hlds__untupling_scalar_common_2[2]);
        succeeded = mercury__builtin__unify_2_p_0(TypeInfo_64_74, ((MR_Box) ((MR_Unsigned) 0U)), ((MR_Box) (Var_72)));
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            ...
            hlds__hlds_data__get_type_defn_tparams_2_p_0(TypeDefn_23, &Var_73);
            TypeInfo_65_75 = (MR_Word) (&transform_hlds__untupling_scalar_common_2[4]);
            succeeded = mercury__builtin__unify_2_p_0(TypeInfo_65_75, ((MR_Box) (Var_34)), ((MR_Box) (Var_73)));
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                ...
                if (succeeded)
                {
                  ...
                  if (succeeded)
                  {
                    ...
                    if (succeeded)
                    {
                      TypeCtorInfo_59_69 = (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0);
                      succeeded = mercury__list__member_2_p_0(TypeCtorInfo_59_69, ((MR_Box) (ArgType_7)), ContainerTypes_8);
                      succeeded = !(succeeded);
                    }
                  }
                }
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            ...
            succeeded = transform_hlds__untupling____Unify____hlds__hlds_pred__pred_origin_0_1(Var_34, Var_55);
            if (succeeded)
            {
    ...
    if (succeeded)
    {
      ...
      Types_4 = ((MR_Word) ((MR_hl_field(MR_mktag(1), HeadVar__1_1, (MR_Integer) 1))));
      {
        ...
        else
        {
          ...
          MR_Word Var_68;
          MR_Word Var_69;
          MR_Word TypeCtorInfo_59_65;

          succeeded = parse_tree__prog_type__type_to_ctor_and_args_3_p_0(Type_3, &TypeCtor_40, &Var_68);
          if (succeeded)
          {
            TypeInfo_64_70 = (MR_Word) (&transform_hlds__untupling_scalar_common_2[2]);
            succeeded = mercury__builtin__unify_2_p_0(TypeInfo_64_70, ((MR_Box) ((MR_Unsigned) 0U)), ((MR_Box) (Var_68)));
            if (succeeded)
            {
              ...
              {
                Var_30 = (MR_Word) ((MR_Unsigned) 0U);
                hlds__hlds_data__get_type_defn_tparams_2_p_0(TypeDefn_19, &Var_69);
                TypeInfo_65_71 = (MR_Word) (&transform_hlds__untupling_scalar_common_2[4]);
                succeeded = mercury__builtin__unify_2_p_0(TypeInfo_65_71, ((MR_Box) (Var_30)), ((MR_Box) (Var_69)));
                if (succeeded)
                {
                  ...
                  if (succeeded)
                  {
                    ...
                    if (succeeded)
                    {
                      ...
                      if (succeeded)
                      {
                        ...
                        if (succeeded)
                        {
                          TypeCtorInfo_59_65 = (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0);
                          succeeded = mercury__list__member_2_p_0(TypeCtorInfo_59_65, ((MR_Box) (Type_3)), (MR_Word) ((MR_Unsigned) 0U));
                          succeeded = !(succeeded);
                        }
                      }
                    }
