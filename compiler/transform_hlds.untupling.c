...
MR_BEGIN_MODULE(transform_hlds__untupling_module30)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__fn__transform_hlds__untupling__IntroducedFrom__func__expand_type__762__1_1_0);
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'IntroducedFrom__func__expand_type__762__1'/2 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
