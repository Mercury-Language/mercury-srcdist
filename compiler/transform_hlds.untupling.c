...
MR_decl_label8(transform_hlds__untupling__fix_calls_in_goal_8_0, 89,30,32,33,34,35,41,42)
MR_decl_label8(transform_hlds__untupling__fix_calls_in_goal_8_0, 43,36,44,28,62,90,7,6)
MR_decl_label8(transform_hlds__untupling__fix_calls_in_goal_8_0, 10,91,14,95,18,19,20,93)
MR_decl_label8(transform_hlds__untupling__fix_calls_in_goal_8_0, 24,94,49,96,53,92,56,88)
...
MR_decl_static(fn__transform_hlds__untupling__IntroducedFrom__func__expand_type__762__1_1_0)
...
{
MR_COMMON(6,0),
MR_ENTRY_AP(fn__transform_hlds__untupling__IntroducedFrom__func__expand_type__762__1_1_0),
0
},
{
MR_COMMON(6,1),
...
MR_BEGIN_MODULE(transform_hlds__untupling_module16)
	...
	MR_init_label8(transform_hlds__untupling__fix_calls_in_goal_8_0,89,30,32,33,34,35,41,42)
	MR_init_label8(transform_hlds__untupling__fix_calls_in_goal_8_0,43,36,44,28,62,90,7,6)
	MR_init_label8(transform_hlds__untupling__fix_calls_in_goal_8_0,10,91,14,95,18,19,20,93)
	MR_init_label8(transform_hlds__untupling__fix_calls_in_goal_8_0,24,94,49,96,53,92,56,88)
MR_BEGIN_CODE
...
MR_def_static(transform_hlds__untupling__fix_calls_in_goal_8_0)
	...
	MR_COMPUTED_GOTO((MR_Unsigned) MR_tag(MR_r6),
		MR_LABEL_AP(transform_hlds__untupling__fix_calls_in_goal_8_0_i88) MR_AND
		MR_LABEL_AP(transform_hlds__untupling__fix_calls_in_goal_8_0_i89) MR_AND
		MR_LABEL_AP(transform_hlds__untupling__fix_calls_in_goal_8_0_i88) MR_AND
		MR_LABEL_AP(transform_hlds__untupling__fix_calls_in_goal_8_0_i62));
MR_def_label(transform_hlds__untupling__fix_calls_in_goal_8_0,89)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(10);
...
MR_def_label(transform_hlds__untupling__fix_calls_in_goal_8_0,28)
	...
	MR_r3 = MR_sv(9);
	MR_decr_sp_and_return(10);
MR_def_label(transform_hlds__untupling__fix_calls_in_goal_8_0,62)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_COMPUTED_GOTO((MR_Unsigned) MR_ctfield(3, MR_r6, 0),
		MR_LABEL_AP(transform_hlds__untupling__fix_calls_in_goal_8_0_i88) MR_AND
		MR_LABEL_AP(transform_hlds__untupling__fix_calls_in_goal_8_0_i90) MR_AND
		MR_LABEL_AP(transform_hlds__untupling__fix_calls_in_goal_8_0_i91) MR_AND
		MR_LABEL_AP(transform_hlds__untupling__fix_calls_in_goal_8_0_i92) MR_AND
		MR_LABEL_AP(transform_hlds__untupling__fix_calls_in_goal_8_0_i93) MR_AND
		MR_LABEL_AP(transform_hlds__untupling__fix_calls_in_goal_8_0_i94) MR_AND
		MR_LABEL_AP(transform_hlds__untupling__fix_calls_in_goal_8_0_i95) MR_AND
		MR_LABEL_AP(transform_hlds__untupling__fix_calls_in_goal_8_0_i96));
MR_def_label(transform_hlds__untupling__fix_calls_in_goal_8_0,90)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(10);
	MR_sv(10) = (MR_Word) MR_succip;
	{
...
MR_def_label(transform_hlds__untupling__fix_calls_in_goal_8_0,91)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(10);
	MR_sv(10) = (MR_Word) MR_succip;
	MR_sv(3) = MR_ctfield(0, MR_r1, 1);
...
MR_def_label(transform_hlds__untupling__fix_calls_in_goal_8_0,93)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(10);
	MR_sv(10) = (MR_Word) MR_succip;
	MR_sv(3) = MR_ctfield(0, MR_r1, 1);
...
MR_def_label(transform_hlds__untupling__fix_calls_in_goal_8_0,94)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(10);
	MR_sv(10) = (MR_Word) MR_succip;
	MR_sv(3) = MR_ctfield(0, MR_r1, 1);
	...
	MR_np_localcall_lab(transform_hlds__untupling__fix_calls_in_goal_8_0,
		transform_hlds__untupling__fix_calls_in_goal_8_0_i49);
...
MR_def_label(transform_hlds__untupling__fix_calls_in_goal_8_0,96)
	...
	MR_sv(10) = (MR_Word) MR_succip;
	MR_np_call_localret_ent(fn__transform_hlds__untupling__this_file_0_0,
		transform_hlds__untupling__fix_calls_in_goal_8_0_i53);
MR_def_label(transform_hlds__untupling__fix_calls_in_goal_8_0,53)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = (MR_Word) MR_string_const("fix_calls_in_goal: unexpected shorthand", 39);
	MR_succip_word = MR_sv(10);
	MR_decr_sp(10);
	MR_np_tailcall_ent(libs__compiler_util__unexpected_2_0);
MR_def_label(transform_hlds__untupling__fix_calls_in_goal_8_0,92)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(10);
	MR_sv(10) = (MR_Word) MR_succip;
	MR_sv(3) = MR_ctfield(0, MR_r1, 1);
	...
	MR_np_call_localret_ent(transform_hlds__untupling__fix_calls_in_cases_8_0,
		transform_hlds__untupling__fix_calls_in_goal_8_0_i56);
...
MR_def_label(transform_hlds__untupling__fix_calls_in_goal_8_0,88)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_proceed();
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
...
MR_BEGIN_MODULE(transform_hlds__untupling_module30)
	MR_init_entry1(fn__transform_hlds__untupling__IntroducedFrom__func__expand_type__762__1_1_0);
MR_BEGIN_CODE
	...
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(fn__transform_hlds__untupling__IntroducedFrom__func__expand_type__762__1_1_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
