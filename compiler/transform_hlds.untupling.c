...
{
  {
    transform_hlds__untupling__expand_call_args_2_11_p_0(Args0_11, ArgModes0_12, Args_13, EnterUnifs_14, ExitUnifs_15, STATE_VARIABLE_VarSet_0_19, STATE_VARIABLE_VarSet_20, STATE_VARIABLE_VarTypes_0_21, STATE_VARIABLE_VarTypes_22, (MR_Word) ((MR_Integer) 0), TypeTable_18);
  }
}
...
{
  {
    ...
    else
    {
      ...
      else
      {
        ...
        if ((Expansion_62 == (MR_Word) ((MR_Integer) 0)))
        {
          MR_Word Args1_72;
...
{
  {
    ...
    transform_hlds__untupling__expand_args_in_proc_3_12_p_0(HeadVars0_13, ArgModes0_14, &ListOfHeadVars_24, &ListOfArgModes_25, Goal0_17, &Var_32, STATE_VARIABLE_VarSet_0_28, STATE_VARIABLE_VarSet_29, STATE_VARIABLE_VarTypes_0_30, STATE_VARIABLE_VarTypes_31, (MR_Word) ((MR_Integer) 0), TypeTable_22);
...
{
  {
    ...
    if ((MaybeHeadVarsAndArgModes_22 == (MR_Word) ((MR_Integer) 0)))
    {
      {
        MR_Word base;
        base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
...
{
  {
    ...
    if ((Expansion_23 == (MR_Word) ((MR_Integer) 0)))
    {
      *MaybeHeadVarsAndArgModes_15 = (MR_Word) ((MR_Integer) 0);
    ...
    if (succeeded)
    {
      ...
      else
      {
        ...
        if (succeeded)
        {
          ...
          succeeded = mercury__builtin__unify_2_p_0(TypeInfo_62_72, ((MR_Box) ((MR_Integer) 0)), ((MR_Box) (Var_70)));
          if (succeeded)
          {
            succeeded = hlds__hlds_data__search_type_ctor_defn_3_p_0(TypeTable_9, TypeCtor_43, &TypeDefn_23);
            if (succeeded)
            {
              Var_33 = (MR_Word) ((MR_Integer) 0);
        ...
        if (succeeded)
        {
          ...
          *Expansion_10 = (MR_Word) ((MR_Integer) 0);
      }
    }
    else
      *Expansion_10 = (MR_Word) ((MR_Integer) 0);
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                ...
                if (succeeded)
                {
                  succeeded = (ExistQVars_17 == (MR_Word) ((MR_Integer) 0));
                  if (succeeded)
      ...
      Types_4 = ((MR_Word) ((MR_hl_field(MR_mktag(1), HeadVar__1_1, (MR_Integer) 1))));
      {
        ...
        else
        {
          ...
          if (succeeded)
          {
            ...
            succeeded = mercury__builtin__unify_2_p_0(TypeInfo_62_68, ((MR_Box) ((MR_Integer) 0)), ((MR_Box) (Var_66)));
            if (succeeded)
            {
                      ...
                      if (succeeded)
                      {
                        ...
                        if (succeeded)
                        {
                          ...
                          if (succeeded)
                          {
                            ...
                            succeeded = mercury__list__member_2_p_0(TypeCtorInfo_57_63, ((MR_Box) (Type_3)), (MR_Word) ((MR_Integer) 0));
                            succeeded = !(succeeded);
                          }
                        }
                      }
