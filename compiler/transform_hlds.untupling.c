  ...
  MR_Box * wrapper_arg_4)
{
  ...
  transform_hlds__untupling__IntroducedFrom__pred__expand_call_args_2__677__1_5_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) (wrapper_arg_1)), &conv2_LambdaHeadVar__2_76, ((MR_Word) (wrapper_arg_3)), &conv1_LambdaHeadVar__4_78);
  ...
  else
  {
    ...
    else
    {
      ...
      else
      {
        ...
        MR_Word Var_80 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MaybeHeadVarsAndArgModes_72, (MR_Integer) 0))));

        HeadVars1_74 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_80, (MR_Integer) 0))));
        ArgModes1_75 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_80, (MR_Integer) 1))));
