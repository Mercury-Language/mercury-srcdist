...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(3), Origin_48, 0) = ((MR_Box) ((MR_Unsigned) 0U));
...
{
  {
    ...
    if (succeeded)
    {
      ...
      else
      {
        ...
        succeeded = parse_tree__prog_type__type_to_ctor_and_args_3_p_0(ArgType_7, &TypeCtor_43, &Var_70);
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              ...
              succeeded = mercury__builtin__unify_2_p_0(TypeInfo_63_73, ((MR_Box) (Var_33)), ((MR_Box) (Var_71)));
              if (succeeded)
              {
...
{
  {
    MR_bool succeeded = ((((MR_tag((MR_Word) HeadVar__2_2)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(MR_mktag(3), HeadVar__2_2, (MR_Integer) 0)))) == (MR_Integer) 7)));
    MR_Word ArgX1_51;

    if (succeeded)
    {
      ArgX1_51 = ((MR_Word) ((MR_hl_field(MR_mktag(3), HeadVar__2_2, (MR_Integer) 1))));
      (MR_hl_field(MR_mktag(3), HeadVar__1_1, (MR_Integer) 1)) = ((MR_Box) (ArgX1_51));
      succeeded = MR_TRUE;
    }
    return succeeded;
  }
    ...
    if (succeeded)
    {
      ...
      Types_4 = ((MR_Word) ((MR_hl_field(MR_mktag(1), HeadVar__1_1, (MR_Integer) 1))));
      {
        ...
        else
        {
          ...
          succeeded = parse_tree__prog_type__type_to_ctor_and_args_3_p_0(Type_3, &TypeCtor_39, &Var_66);
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                ...
                succeeded = mercury__builtin__unify_2_p_0(TypeInfo_63_69, ((MR_Box) (Var_29)), ((MR_Box) (Var_67)));
                if (succeeded)
                {
