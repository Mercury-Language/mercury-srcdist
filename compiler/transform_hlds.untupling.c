  ...
  else
  {
    ...
    else
    {
      ...
      {
        {
          ...
          MR_hl_field(MR_mktag(1), HeadVar_58, 0) = ((MR_Box) (Var_71));
      ...
      else
      {
        ...
        MR_Word Var_82 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MaybeHeadVarsAndArgModes_72, (MR_Integer) 0))));

        HeadVars1_74 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_82, (MR_Integer) 0))));
        ArgModes1_75 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_82, (MR_Integer) 1))));
