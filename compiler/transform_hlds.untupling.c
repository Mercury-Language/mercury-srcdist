  ...
  MR_Box wrapper_arg_1)
{
  ...
  conv0_LambdaHeadVar__2_31 = transform_hlds__untupling__IntroducedFrom__func__expand_type__772__1_1_f_0(((MR_Word) (wrapper_arg_1)));
  ...
  if (succeeded)
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        hlds__hlds_goal__goal_to_conj_list_2_p_0(UnifGoal_28, &GoalListA_91);
        hlds__hlds_goal__goal_to_conj_list_2_p_0(STATE_VARIABLE_Goal_0_29, &GoalListB_92);
        ...
        hlds__hlds_goal__goal_list_determinism_2_p_0(GoalList_93, &Determinism_94);
      ...
      else
      {
        ...
        if (succeeded)
        {
          ...
          hlds__hlds_goal__goal_to_conj_list_2_p_0(STATE_VARIABLE_Goal_0_29, &GoalListA_100);
          hlds__hlds_goal__goal_to_conj_list_2_p_0(UnifGoal_41, &GoalListB_101);
          ...
          hlds__hlds_goal__goal_list_determinism_2_p_0(GoalList_102, &Determinism_103);
