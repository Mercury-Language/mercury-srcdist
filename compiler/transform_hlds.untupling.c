  ...
  MR_Box * wrapper_arg_4)
{
  ...
  transform_hlds__untupling__IntroducedFrom__pred__expand_call_args_2__677__1_5_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) (wrapper_arg_1)), &conv1_LambdaHeadVar__2_76, ((MR_Word) (wrapper_arg_3)), &conv0_LambdaHeadVar__4_78);
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_51)
{
  ...
  {
    ProcTransform_46 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(MR_mktag(3), ProcTransform_46, 0) = ((MR_Box) ((MR_Unsigned) 4U));
    MR_hl_field(MR_mktag(3), ProcTransform_46, 1) = ((MR_Box) (LineNum_43));
    MR_hl_field(MR_mktag(3), ProcTransform_46, 2) = ((MR_Box) (SeqNum_17));
  }
  {
    Origin_47 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(MR_mktag(3), Origin_47, 0) = ((MR_Box) (ProcTransform_46));
    MR_hl_field(MR_mktag(3), Origin_47, 1) = ((MR_Box) (OrigOrigin_35));
    MR_hl_field(MR_mktag(3), Origin_47, 2) = ((MR_Box) (PredId_13));
    MR_hl_field(MR_mktag(3), Origin_47, 3) = ((MR_Box) (ProcId_14));
  }
