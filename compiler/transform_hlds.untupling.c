    ...
    else
    {
      ...
      else
      {
        ...
        if (succeeded)
        {
          ...
          Var_81 = mercury__list__f_43_43_2_f_0((MR_Word) (&transform_hlds__untupling_scalar_common_2[0]), ReplacementArgs_66, Var_105);
        ...
        else
        {
          ...
          if (succeeded)
          {
            ...
            Var_86 = mercury__list__f_43_43_2_f_0((MR_Word) (&transform_hlds__untupling_scalar_common_2[0]), ReplacementArgs_66, Var_105);
  ...
  MR_Word * STATE_VARIABLE_VarTable_11)
{
  ...
  else
  {
    ...
    else
    {
      ...
      transform_hlds__untupling__expand_one_arg_in_proc_11_p_0(ModuleInfo_1, TypeTable_2, ContainerTypes_3, Var_73, ArgMode0_56, &HeadVar_58, &ArgMode_60, STATE_VARIABLE_Goal_0_8, &STATE_VARIABLE_Goal_68_68, STATE_VARIABLE_VarTable_0_10, &STATE_VARIABLE_VarTable_69_69);
  ...
  MR_Word * ContainerTypes_20)
{
  ...
  else
  {
    ...
    {
      MR_Word UnifGoal_28;
      MR_Word GoalListA_52;
      MR_Word GoalListB_53;
      MR_Word GoalList_54;
      MR_Word Determinism_55;
      MR_Word GoalInfo0_56;
      MR_Word GoalInfo_57;
      MR_Word Var_58;

      hlds__make_goal__construct_functor_4_p_0(HeadVar0_14, ConsId_23, NewHeadVars_26, &UnifGoal_28);
      hlds__hlds_goal__goal_to_conj_list_2_p_0(UnifGoal_28, &GoalListA_52);
      hlds__hlds_goal__goal_to_conj_list_2_p_0(STATE_VARIABLE_Goal_0_29, &GoalListB_53);
      GoalList_54 = mercury__list__f_43_43_2_f_0((MR_Word) (&hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_hlds_goal_0), GoalListA_52, GoalListB_53);
      hlds__hlds_goal__goal_list_determinism_2_p_0(GoalList_54, &Determinism_55);
      hlds__hlds_goal__goal_info_init_1_p_0(&GoalInfo0_56);
      hlds__hlds_goal__goal_info_set_determinism_3_p_0(Determinism_55, GoalInfo0_56, &GoalInfo_57);
      {
        ...
        MR_hl_field(MR_mktag(3), Var_58, 2) = ((MR_Box) (GoalList_54));
      }
      {
        MR_Word base;
        base = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
    ...
    else
    {
      ...
      {
        MR_Word UnifGoal_41;
        MR_Word GoalListA_64;
        MR_Word GoalListB_65;
        MR_Word GoalList_66;
        MR_Word Determinism_67;
        MR_Word GoalInfo0_68;
        MR_Word GoalInfo_69;
        MR_Word Var_70;

        hlds__make_goal__deconstruct_functor_4_p_0(HeadVar0_14, ConsId_23, NewHeadVars_26, &UnifGoal_41);
        hlds__hlds_goal__goal_to_conj_list_2_p_0(STATE_VARIABLE_Goal_0_29, &GoalListA_64);
        hlds__hlds_goal__goal_to_conj_list_2_p_0(UnifGoal_41, &GoalListB_65);
        GoalList_66 = mercury__list__f_43_43_2_f_0((MR_Word) (&hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_hlds_goal_0), GoalListA_64, GoalListB_65);
        hlds__hlds_goal__goal_list_determinism_2_p_0(GoalList_66, &Determinism_67);
        hlds__hlds_goal__goal_info_init_1_p_0(&GoalInfo0_68);
        hlds__hlds_goal__goal_info_set_determinism_3_p_0(Determinism_67, GoalInfo0_68, &GoalInfo_69);
        {
          ...
          MR_hl_field(MR_mktag(3), Var_70, 1) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 0));
          MR_hl_field(MR_mktag(3), Var_70, 2) = ((MR_Box) (GoalList_66));
        }
        {
          MR_Word base;
          base = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
          *STATE_VARIABLE_Goal_30 = base;
          ...
          MR_hl_field(MR_mktag(0), base, 1) = ((MR_Box) (GoalInfo_69));
        }
      }
      else
        {
