...
transform_hlds__untupling__IntroducedFrom__func__expand_type__777__1_1_f_0(
  MR_Word LambdaHeadVar__1_30);

static void MR_CALL 
transform_hlds__untupling__IntroducedFrom__pred__expand_call_args_2__679__1_5_p_0(
...
transform_hlds__untupling__IntroducedFrom__func__expand_type__777__1_1_f_0(
  MR_Word LambdaHeadVar__1_30)
{
  MR_Word LambdaHeadVar__2_31 = ((MR_Word) ((MR_hl_field(0, LambdaHeadVar__1_30, (MR_Integer) 1))));
  ...
  MR_Box * wrapper_arg_4)
{
  ...
  transform_hlds__untupling__IntroducedFrom__pred__expand_call_args_2__679__1_5_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) (wrapper_arg_1)), &conv2_LambdaHeadVar__2_76, ((MR_Word) (wrapper_arg_3)), &conv1_LambdaHeadVar__4_78);
  ...
  MR_Box wrapper_arg_1)
{
  ...
  conv0_LambdaHeadVar__2_31 = transform_hlds__untupling__IntroducedFrom__func__expand_type__777__1_1_f_0(((MR_Word) (wrapper_arg_1)));
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          Arity_114 = mercury__list__length_1_f_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0), TypeArgs_113);
          {
            ...
            MR_hl_field(3, ConsId_115, 0) = ((MR_Box) ((MR_Unsigned) 4U));
        ...
        else
        {
          ...
          MR_Word Var_146;
          MR_Word Var_147;
          MR_Word TypeCtorInfo_58_143;

          succeeded = parse_tree__prog_type__type_to_ctor_and_args_3_p_0(Arg0Type_54, &TypeCtor_134, &Var_146);
          if (succeeded)
          {
            TypeInfo_63_148 = (MR_Word) (&transform_hlds__untupling_scalar_common_2[2]);
            succeeded = mercury__builtin__unify_2_p_0(TypeInfo_63_148, ((MR_Box) ((MR_Unsigned) 0U)), ((MR_Box) (Var_146)));
            if (succeeded)
            {
              succeeded = hlds__hlds_data__search_type_ctor_defn_3_p_0(TypeTable_2, TypeCtor_134, &TypeDefn_116);
              if (succeeded)
              {
                Var_126 = (MR_Word) ((MR_Unsigned) 0U);
                hlds__hlds_data__get_type_defn_tparams_2_p_0(TypeDefn_116, &Var_147);
                TypeInfo_64_149 = (MR_Word) (&transform_hlds__untupling_scalar_common_2[4]);
                succeeded = mercury__builtin__unify_2_p_0(TypeInfo_64_149, ((MR_Box) (Var_126)), ((MR_Box) (Var_147)));
                if (succeeded)
                {
                  ...
                  if (succeeded)
                  {
                    ...
                    if (succeeded)
                    {
                      ...
                      if (succeeded)
                      {
                        ...
                        if (succeeded)
                        {
                          TypeCtorInfo_58_143 = (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0);
                          succeeded = mercury__list__member_2_p_0(TypeCtorInfo_58_143, ((MR_Box) (Arg0Type_54)), ContainerTypes0_3);
                          succeeded = !(succeeded);
                        }
                      }
                    }
          ...
          if (succeeded)
          {
            ...
            Arity_132 = mercury__list__length_1_f_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_constructor_arg_0), SingleCtorArgs_121);
            {
              Var_130 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
              MR_hl_field(0, Var_130, 0) = ((MR_Box) (SingleCtorName_120));
              MR_hl_field(0, Var_130, 1) = ((MR_Box) (Arity_132));
              MR_hl_field(0, Var_130, 2) = ((MR_Box) (TypeCtor_134));
            }
            ConsId_133 = (MR_Word) (MR_mkword(1, (MR_Word) (Var_130)));
            ...
            {
              Expansion_55 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(1, Expansion_55, 0) = ((MR_Box) (ConsId_133));
