  ...
  MR_Word * Expansion_10)
{
  ...
  if (succeeded)
  {
    ...
    else
    {
      ...
      MR_Word TypeCtor_36;
      MR_Word TypeInfo_64_50;
      MR_Word TypeInfo_65_51;
      MR_Word TypeDefn_19;
      MR_Word TypeBody_20;
      ...
      MR_Word Var_48;
      MR_Word Var_49;
      MR_Word TypeCtorInfo_59_45;

      succeeded = parse_tree__prog_type__type_to_ctor_and_args_3_p_0(ArgType_7, &TypeCtor_36, &Var_48);
      if (succeeded)
      {
        TypeInfo_64_50 = (MR_Word) (&transform_hlds__untupling_scalar_common_2[2]);
        succeeded = mercury__builtin__unify_2_p_0(TypeInfo_64_50, ((MR_Box) ((MR_Unsigned) 0U)), ((MR_Box) (Var_48)));
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            ...
            TypeInfo_65_51 = (MR_Word) (&transform_hlds__untupling_scalar_common_2[4]);
            succeeded = mercury__builtin__unify_2_p_0(TypeInfo_65_51, ((MR_Box) (Var_29)), ((MR_Box) (Var_49)));
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                ...
                if (succeeded)
                {
                  ...
                  if (succeeded)
                  {
                    ...
                    if (succeeded)
                    {
                      TypeCtorInfo_59_45 = (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0);
                      succeeded = mercury__list__member_2_p_0(TypeCtorInfo_59_45, ((MR_Box) (ArgType_7)), ContainerTypes_8);
                      succeeded = !(succeeded);
                    }
                  }
                }
  ...
  MR_Word TypeTable_21)
{
  ...
  if (succeeded)
  {
    ...
    else
    {
      ...
      MR_Word TypeCtor_79;
      MR_Word TypeInfo_64_93;
      MR_Word TypeInfo_65_94;
      MR_Word TypeDefn_62;
      MR_Word TypeBody_63;
      ...
      MR_Word Var_91;
      MR_Word Var_92;
      MR_Word TypeCtorInfo_59_88;

      succeeded = parse_tree__prog_type__type_to_ctor_and_args_3_p_0(Type_22, &TypeCtor_79, &Var_91);
      if (succeeded)
      {
        TypeInfo_64_93 = (MR_Word) (&transform_hlds__untupling_scalar_common_2[2]);
        succeeded = mercury__builtin__unify_2_p_0(TypeInfo_64_93, ((MR_Box) ((MR_Unsigned) 0U)), ((MR_Box) (Var_91)));
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            ...
            TypeInfo_65_94 = (MR_Word) (&transform_hlds__untupling_scalar_common_2[4]);
            succeeded = mercury__builtin__unify_2_p_0(TypeInfo_65_94, ((MR_Box) (Var_72)), ((MR_Box) (Var_92)));
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                ...
                if (succeeded)
                {
                  ...
                  if (succeeded)
                  {
                    ...
                    if (succeeded)
                    {
                      TypeCtorInfo_59_88 = (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0);
                      succeeded = mercury__list__member_2_p_0(TypeCtorInfo_59_88, ((MR_Box) (Type_22)), ContainerTypes0_19);
                      succeeded = !(succeeded);
                    }
                  }
                }
  ...
  if (succeeded)
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        TypeInfo_58_58 = (MR_Word) (&transform_hlds__untupling_scalar_common_2[4]);
        succeeded = mercury__builtin__unify_2_p_0(TypeInfo_58_58, ((MR_Box) (Var_30)), ((MR_Box) (Var_53)));
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              ...
              succeeded = mercury__varset__is_empty_1_p_0(TypeCtorInfo_39_39, TypeVarSet_16);
              if (succeeded)
              {
    ...
    if (succeeded)
    {
      ...
      Types_4 = ((MR_Word) ((MR_hl_field(MR_mktag(1), HeadVar__1_1, (MR_Integer) 1))));
      {
        ...
        else
        {
          ...
          MR_Word TypeCtor_32;
          MR_Word TypeInfo_64_46;
          MR_Word TypeInfo_65_47;
          MR_Word TypeDefn_15;
          MR_Word TypeBody_16;
          ...
          MR_Word Var_44;
          MR_Word Var_45;
          MR_Word TypeCtorInfo_59_41;

          succeeded = parse_tree__prog_type__type_to_ctor_and_args_3_p_0(Type_3, &TypeCtor_32, &Var_44);
          if (succeeded)
          {
            TypeInfo_64_46 = (MR_Word) (&transform_hlds__untupling_scalar_common_2[2]);
            succeeded = mercury__builtin__unify_2_p_0(TypeInfo_64_46, ((MR_Box) ((MR_Unsigned) 0U)), ((MR_Box) (Var_44)));
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                ...
                TypeInfo_65_47 = (MR_Word) (&transform_hlds__untupling_scalar_common_2[4]);
                succeeded = mercury__builtin__unify_2_p_0(TypeInfo_65_47, ((MR_Box) (Var_25)), ((MR_Box) (Var_45)));
                if (succeeded)
                {
                  ...
                  if (succeeded)
                  {
                    ...
                    if (succeeded)
                    {
                      ...
                      if (succeeded)
                      {
                        ...
                        if (succeeded)
                        {
                          TypeCtorInfo_59_41 = (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0);
                          succeeded = mercury__list__member_2_p_0(TypeCtorInfo_59_41, ((MR_Box) (Type_3)), (MR_Word) ((MR_Unsigned) 0U));
                          succeeded = !(succeeded);
                        }
                      }
                    }
