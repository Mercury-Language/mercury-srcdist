  ...
  MR_Box * wrapper_arg_4)
{
  ...
  transform_hlds__untupling__IntroducedFrom__pred__expand_call_args_2__676__1_5_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) (wrapper_arg_1)), &conv2_LambdaHeadVar__2_76, ((MR_Word) (wrapper_arg_3)), &conv1_LambdaHeadVar__4_78);
  ...
  MR_Word * STATE_VARIABLE_Counter_38)
{
  ...
  mercury__term__context_line_2_p_0(Context_92, &LineNum_93);
  {
    Var_101 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(MR_mktag(0), Var_101, 0) = ((MR_Box) (LineNum_93));
    MR_hl_field(MR_mktag(0), Var_101, 1) = ((MR_Box) (SeqNum_26));
  }
  {
    ...
    MR_hl_field(MR_mktag(3), Transform_94, 3) = ((MR_Box) (Var_101));
  }
  hlds__pred_name__make_transformed_pred_sym_name_4_p_0(PredModule_88, PredName_89, Transform_94, &AuxPredSymName_95);
  {
    ProcTransform_96 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(MR_mktag(3), ProcTransform_96, 0) = ((MR_Box) ((MR_Unsigned) 4U));
    MR_hl_field(MR_mktag(3), ProcTransform_96, 1) = ((MR_Box) (LineNum_93));
    MR_hl_field(MR_mktag(3), ProcTransform_96, 2) = ((MR_Box) (SeqNum_26));
  }
  {
    Origin_97 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(MR_mktag(3), Origin_97, 0) = ((MR_Box) (ProcTransform_96));
    MR_hl_field(MR_mktag(3), Origin_97, 1) = ((MR_Box) (OrigOrigin_85));
    MR_hl_field(MR_mktag(3), Origin_97, 2) = ((MR_Box) (PredId_9));
    MR_hl_field(MR_mktag(3), Origin_97, 3) = ((MR_Box) (ProcId_10));
  }
  ...
  AuxPredId_27 = ((MR_Word) ((MR_hl_field(MR_mktag(0), AuxPredProcId_98, (MR_Integer) 0))));
  AuxProcId_28 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), AuxPredProcId_98, (MR_Integer) 1))));
  ...
  }
  {
    ...
    MR_hl_field(MR_mktag(0), Var_55, 0) = ((MR_Box) (AuxPredProcId_98));
  ...
  MR_Word * STATE_VARIABLE_Counter_28)
{
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          succeeded = parse_tree__prog_data____Unify____prog_constraints_0_0(Var_34, Var_54);
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              Var_37 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Origin_15, (MR_Integer) 0))));
  ...
  if (succeeded)
  {
    ...
    ProcIds_22 = hlds__hlds_pred__pred_info_valid_non_imported_procids_1_f_0(PredInfo_13);
    {
      ...
      MR_hl_field(MR_mktag(0), Var_38, 0) = ((MR_Box) (&transform_hlds__untupling_scalar_common_7[0]));
      MR_hl_field(MR_mktag(0), Var_38, 1) = ((MR_Box) (transform_hlds__untupling__expand_args_in_pred_7_p_0_1));
