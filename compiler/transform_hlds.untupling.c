...
MR_decl_label10(transform_hlds__untupling__fix_calls_in_goal_8_0, 36,28,27,48,51,47,56,55,146,145)
...
MR_BEGIN_MODULE(transform_hlds__untupling_module15)
	...
	MR_init_label10(transform_hlds__untupling__fix_calls_in_goal_8_0,36,28,27,48,51,47,56,55,146,145)
MR_BEGIN_CODE
...
MR_def_static(transform_hlds__untupling__fix_calls_in_goal_8_0)
	...
	if (((((MR_tag(MR_tempr1) == MR_mktag((MR_Integer) 3)) && ((MR_Integer) MR_tfield(3, MR_tempr1, 0) == (MR_Integer) 0)) || (MR_tag(MR_tempr1) == MR_mktag((MR_Integer) 2))) || (MR_tag(MR_tempr1) == MR_mktag((MR_Integer) 0)))) {
		MR_GOTO_LAB(transform_hlds__untupling__fix_calls_in_goal_8_0_i146);
	}
...
MR_def_label(transform_hlds__untupling__fix_calls_in_goal_8_0,27)
	...
	if (MR_INT_EQ(MR_tempr2,0)) {
		MR_GOTO_LAB(transform_hlds__untupling__fix_calls_in_goal_8_0_i145);
	}
	}
MR_def_label(transform_hlds__untupling__fix_calls_in_goal_8_0,48)
	...
	MR_r1 = MR_r7;
	MR_np_localcall_lab(transform_hlds__untupling__fix_calls_in_goal_8_0,
		transform_hlds__untupling__fix_calls_in_goal_8_0_i51);
MR_def_label(transform_hlds__untupling__fix_calls_in_goal_8_0,51)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 3, (MR_Integer) 3);
...
MR_def_label(transform_hlds__untupling__fix_calls_in_goal_8_0,47)
	...
	if (MR_RTAGS_TESTR(MR_r6,3,3)) {
		MR_GOTO_LAB(transform_hlds__untupling__fix_calls_in_goal_8_0_i55);
	}
	MR_incr_sp(10);
	MR_sv(10) = (MR_Word) MR_succip;
	MR_sv(3) = MR_tfield(0, MR_r1, 1);
...
MR_def_label(transform_hlds__untupling__fix_calls_in_goal_8_0,55)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_string_const("transform_hlds.untupling", 24);
	MR_r2 = (MR_Word) MR_string_const("predicate \140transform_hlds.untupling.fix_calls_in_goal\'/8", 56);
	MR_r3 = (MR_Word) MR_string_const("shorthand", 9);
	MR_np_tailcall_ent(require__unexpected_3_0);
MR_def_label(transform_hlds__untupling__fix_calls_in_goal_8_0,146)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_proceed();
MR_def_label(transform_hlds__untupling__fix_calls_in_goal_8_0,145)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(10);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
...
MR_BEGIN_MODULE(transform_hlds__untupling_module28)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__fn__transform_hlds__untupling__IntroducedFrom__func__expand_type__759__1_1_0);
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'IntroducedFrom__func__expand_type__759__1'/2 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
