...
MR_decl_label5(fn__ml_backend__ml_target_util__target_supports_break_and_continue_1_0, 3,4,5,6,7)
MR_decl_label5(fn__ml_backend__ml_target_util__target_supports_computed_goto_1_0, 3,4,5,6,7)
MR_decl_label5(fn__ml_backend__ml_target_util__target_supports_goto_1_0, 3,4,5,6,7)
MR_decl_label5(fn__ml_backend__ml_target_util__target_supports_inheritence_1_0, 3,4,5,6,7)
MR_decl_label5(fn__ml_backend__ml_target_util__target_supports_int_switch_1_0, 3,4,5,6,7)
MR_decl_label5(fn__ml_backend__ml_target_util__target_supports_string_switch_1_0, 3,4,5,6,7)
...
MR_BEGIN_MODULE(ml_backend__ml_target_util_module0)
	...
	MR_init_label5(fn__ml_backend__ml_target_util__target_supports_int_switch_1_0,3,4,5,6,7)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(ml_backend__ml_target_util_module2)
	...
	MR_init_label5(fn__ml_backend__ml_target_util__target_supports_string_switch_1_0,3,4,5,6,7)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(ml_backend__ml_target_util_module4)
	...
	MR_init_label5(fn__ml_backend__ml_target_util__target_supports_goto_1_0,3,4,5,6,7)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(ml_backend__ml_target_util_module6)
	...
	MR_init_label5(fn__ml_backend__ml_target_util__target_supports_computed_goto_1_0,3,4,5,6,7)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(ml_backend__ml_target_util_module8)
	...
	MR_init_label5(fn__ml_backend__ml_target_util__target_supports_break_and_continue_1_0,3,4,5,6,7)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(ml_backend__ml_target_util_module10)
	...
	MR_init_label5(fn__ml_backend__ml_target_util__target_supports_inheritence_1_0,3,4,5,6,7)
MR_BEGIN_CODE
...
void mercury__ml_backend__ml_target_util__write_out_proc_statics(FILE *deep_fp, FILE *procrep_fp)
{
	MR_write_out_module_proc_reps_start(procrep_fp, &mercury_data__module_layout__ml_backend__ml_target_util);
