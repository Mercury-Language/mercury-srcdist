      ...
      case (MR_Integer) 3:
        {
          ...
          conv0_HeadVar__2_2 = mercury__require__unexpected_3_f_0((MR_Word) &mercury__bool__bool__type_ctor_info_bool_0, (MR_String) "ml_backend.ml_target_util", (MR_String) "function \140ml_backend.ml_target_util.target_supports_int64_switch\'/1", (MR_String) "target erlang");
          HeadVar__2_2 = ((MR_Word) conv0_HeadVar__2_2);
        }
        break;
      case (MR_Integer) 2:
