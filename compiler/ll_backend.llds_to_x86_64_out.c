...
#line 56 "ll_backend.llds_to_x86_64_out.c"
#line 57 "ll_backend.llds_to_x86_64_out.c"

#endif
#line 60 "ll_backend.llds_to_x86_64_out.c"
...
MR_decl_label3(ll_backend__llds_to_x86_64_out__output_asm_instr_list_4_0, 10,4,12)
...
MR_BEGIN_MODULE(ll_backend__llds_to_x86_64_out_module0)
	...
	MR_init_label3(ll_backend__llds_to_x86_64_out__output_asm_instr_list_4_0,10,4,12)
MR_BEGIN_CODE
...
MR_def_label(ll_backend__llds_to_x86_64_out__output_asm_instr_list_4_0,10)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TEST(MR_r2,0,0)) {
		MR_GOTO_LAB(ll_backend__llds_to_x86_64_out__output_asm_instr_list_4_0_i12);
	}
	MR_sv(1) = MR_r1;
	{
...
MR_def_label(ll_backend__llds_to_x86_64_out__output_asm_instr_list_4_0,4)
	...
	MR_GOTO_LAB(ll_backend__llds_to_x86_64_out__output_asm_instr_list_4_0_i10);
MR_def_label(ll_backend__llds_to_x86_64_out__output_asm_instr_list_4_0,12)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
void mercury__ll_backend__llds_to_x86_64_out__write_out_proc_statics(FILE *deep_fp, FILE *procrep_fp)
{
	MR_write_out_module_proc_reps_start(procrep_fp, &mercury_data__module_common_layout__ll_backend__llds_to_x86_64_out);
