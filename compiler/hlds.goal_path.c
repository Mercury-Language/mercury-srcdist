...
MR_decl_label10(hlds__goal_path__fill_goal_path_slots_4_0, 50,47,56,54,45,63,66,65,70,61)
...
MR_BEGIN_MODULE(hlds__goal_path_module8)
	...
	MR_init_label10(hlds__goal_path__fill_goal_path_slots_4_0,50,47,56,54,45,63,66,65,70,61)
MR_BEGIN_CODE
...
MR_def_label(hlds__goal_path__fill_goal_path_slots_4_0,35)
	...
	MR_tfield(1, MR_r1, 1) = (MR_Word) MR_TAG_COMMON(3,0,0);
	MR_r2 = MR_sv(3);
	MR_r3 = MR_sv(6);
	MR_np_localcall_lab(hlds__goal_path__fill_goal_path_slots_4_0,
...
MR_def_label(hlds__goal_path__fill_goal_path_slots_4_0,36)
	...
	MR_tag_alloc_heap(MR_r1, 1, (MR_Integer) 2);
	MR_tfield(1, MR_r1, 0) = MR_sv(2);
	MR_tfield(1, MR_r1, 1) = (MR_Word) MR_TAG_COMMON(3,0,1);
	MR_r2 = MR_sv(3);
	MR_r3 = MR_sv(6);
	MR_np_localcall_lab(hlds__goal_path__fill_goal_path_slots_4_0,
		hlds__goal_path__fill_goal_path_slots_4_0_i42);
