  ...
  MR_Word * STATE_VARIABLE_ProcInfo_11)
{
  ...
  hlds__hlds_pred__proc_info_get_var_table_3_p_0(ModuleInfo_4, STATE_VARIABLE_ProcInfo_0_10, &VarTable_6);
  {
    Var_12 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(MR_mktag(1), Var_12, 0) = ((MR_Box) (VarTable_6));
  }
  {
    SlotInfo_7 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(MR_mktag(0), SlotInfo_7, 0) = ((MR_Box) (ModuleInfo_4));
    MR_hl_field(MR_mktag(0), SlotInfo_7, 1) = ((MR_Box) (Var_12));
  }
  ...
  MR_Word * STATE_VARIABLE_ProcInfo_12)
{
  ...
  hlds__hlds_pred__proc_info_get_var_table_3_p_0(ModuleInfo_5, STATE_VARIABLE_ProcInfo_0_11, &VarTable_8);
  hlds__hlds_pred__proc_info_get_goal_2_p_0(STATE_VARIABLE_ProcInfo_0_11, &Goal0_9);
  {
    ...
    MR_hl_field(MR_mktag(1), Var_13, 0) = ((MR_Box) (VarTable_8));
  }
  hlds__goal_path__fill_goal_id_slots_in_proc_body_5_p_0(ModuleInfo_5, Var_13, ContainingGoalMap_6, Goal0_9, &Goal_10);
