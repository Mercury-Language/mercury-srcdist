...
MR_decl_label4(__Compare___hlds__goal_path__slot_info_0_0, 3,2,5,21)
...
MR_def_label(hlds__goal_path__fill_goal_id_slots_8_0,11)
	...
	MR_tempr1 = MR_sv(10);
	MR_tempr5 = MR_sv(11);
	MR_sv(10) = MR_tfield(1, MR_tempr5, 0);
	MR_tempr2 = MR_tempr5;
	MR_sv(11) = MR_tfield(1, MR_tempr2, 2);
	MR_sv(3) = MR_tfield(1, MR_tempr2, 3);
	MR_sv(12) = MR_tfield(1, MR_tempr2, 4);
	MR_tempr6 = MR_r3;
	MR_sv(1) = ((MR_Integer) MR_tfield(2, MR_tempr6, 0) & (MR_Integer) 3);
	MR_sv(4) = (((MR_Integer) MR_tfield(2, MR_tempr6, 0) >> (MR_Integer) 2) & (MR_Integer) 1);
	MR_tempr2 = MR_sv(5);
	MR_sv(5) = (((MR_Integer) MR_tfield(2, MR_tempr6, 0) >> (MR_Integer) 3) & (MR_Integer) 1);
	MR_sv(6) = MR_tfield(2, MR_tempr6, 2);
	MR_sv(7) = MR_tfield(2, MR_tempr6, 3);
	MR_sv(8) = MR_tfield(2, MR_tempr6, 4);
	MR_sv(9) = MR_tfield(2, MR_tempr6, 5);
	MR_tempr3 = MR_r1;
	MR_r1 = MR_tempr1;
	MR_tempr4 = MR_tempr6;
	MR_r3 = MR_tempr2;
	MR_r4 = MR_tempr3;
	MR_r5 = MR_tfield(2, MR_tempr4, 6);
	}
	MR_np_localcall_lab(hlds__goal_path__fill_goal_id_slots_8_0,
...
MR_def_label(hlds__goal_path__fill_goal_id_slots_8_0,37)
	...
	MR_tag_alloc_heap(MR_r2, 1, (MR_Integer) 2);
	MR_tfield(1, MR_r2, 0) = MR_sv(3);
	MR_tfield(1, MR_r2, 1) = (MR_Word) MR_TAG_COMMON(3,1,0);
	MR_r1 = MR_sv(10);
	MR_r3 = MR_sv(5);
	MR_r4 = MR_sv(6);
	MR_r5 = MR_sv(1);
...
MR_def_label(hlds__goal_path__fill_goal_id_slots_8_0,38)
	...
	MR_tag_alloc_heap(MR_r2, 1, (MR_Integer) 2);
	MR_tfield(1, MR_r2, 0) = MR_sv(3);
	MR_tfield(1, MR_r2, 1) = (MR_Word) MR_TAG_COMMON(3,1,1);
	MR_r1 = MR_sv(10);
	MR_r3 = MR_sv(5);
	MR_r4 = MR_sv(6);
	MR_r5 = MR_sv(1);
...
MR_def_label(hlds__goal_path__fill_goal_path_slots_4_0,35)
	...
	MR_tfield(1, MR_r1, 1) = (MR_Word) MR_TAG_COMMON(3,1,0);
	MR_r2 = MR_sv(3);
	MR_r3 = MR_sv(6);
	MR_np_localcall_lab(hlds__goal_path__fill_goal_path_slots_4_0,
...
MR_def_label(hlds__goal_path__fill_goal_path_slots_4_0,36)
	...
	MR_tag_alloc_heap(MR_r1, 1, (MR_Integer) 2);
	MR_tfield(1, MR_r1, 0) = MR_sv(2);
	MR_tfield(1, MR_r1, 1) = (MR_Word) MR_TAG_COMMON(3,1,1);
	MR_r2 = MR_sv(3);
	MR_r3 = MR_sv(6);
	MR_np_localcall_lab(hlds__goal_path__fill_goal_path_slots_4_0,
		hlds__goal_path__fill_goal_path_slots_4_0_i42);
...
MR_BEGIN_MODULE(hlds__goal_path_module16)
	...
	MR_init_label4(__Compare___hlds__goal_path__slot_info_0_0,3,2,5,21)
MR_BEGIN_CODE
...
MR_def_label(__Compare___hlds__goal_path__slot_info_0_0,5)
	...
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___hlds__goal_path__slot_info_0_0_i21);
	}
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(parse_tree__prog_data, vartypes);
	MR_r2 = MR_sv(1);
	MR_r3 = MR_sv(2);
...
MR_def_label(__Compare___hlds__goal_path__slot_info_0_0,21)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(3);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
...
void mercury__hlds__goal_path__write_out_proc_statics(FILE *deep_fp, FILE *procrep_fp)
{
	MR_write_out_module_proc_reps_start(procrep_fp, &mercury_data__module_layout__hlds__goal_path);
