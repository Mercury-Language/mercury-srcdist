...
MR_def_label(hlds__goal_path__fill_goal_id_slots_8_0,11)
	...
	MR_tempr5 = MR_r6;
	MR_sv(6) = ((MR_Integer) MR_tfield(2, MR_tempr5, 0) & (MR_Integer) 3);
	MR_sv(7) = (((MR_Integer) MR_tfield(2, MR_tempr5, 0) >> (MR_Integer) 2) & (MR_Integer) 1);
	MR_tempr2 = MR_sv(8);
	MR_sv(8) = (((MR_Integer) MR_tfield(2, MR_tempr5, 0) >> (MR_Integer) 3) & (MR_Integer) 1);
	MR_sv(9) = MR_tfield(2, MR_tempr5, 2);
	MR_sv(10) = MR_tfield(2, MR_tempr5, 3);
	MR_sv(11) = MR_tfield(2, MR_tempr5, 4);
	MR_sv(12) = MR_tfield(2, MR_tempr5, 5);
	MR_tempr3 = MR_r1;
	MR_r1 = MR_tempr1;
	MR_r3 = MR_tempr2;
	MR_r4 = MR_tempr3;
