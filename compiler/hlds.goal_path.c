        ...
        case (MR_Integer) 4:
          {
            ...
            MR_Word VarTable_19 = ((MR_Word) ((MR_hl_field(0, SlotInfo_6, 1))));
            MR_Word ModuleInfo_20 = ((MR_Word) ((MR_hl_field(0, SlotInfo_6, 0))));
            MR_Word Type_21;
  ...
  MR_Box * wrapper_arg_8)
{
  ...
  hlds__goal_path__fill_slots_in_clause_9_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) (wrapper_arg_1)), &conv3_Clause_12, ((MR_Integer) (wrapper_arg_3)), &conv2_NextClauseNum_14, ((MR_Word) (wrapper_arg_5)), &conv1_STATE_VARIABLE_GoalNumCounter_21, ((MR_Word) (wrapper_arg_7)), &conv0_STATE_VARIABLE_ContainingGoalList_23);
  ...
  MR_Word * HeadVar__9_9)
{
  ...
  else
  {
    ...
    hlds__goal_path__fill_goal_id_slots_8_p_0(SlotInfo_1, ContainingGoal_29, STATE_VARIABLE_GoalNumCounter_0_4, &STATE_VARIABLE_GoalNumCounter_1_36, STATE_VARIABLE_ContainingGoalList_0_6, &STATE_VARIABLE_ContainingGoalList_1_37, Goal0_24, &Goal_26);
    hlds__goal_path__fill_orelse_id_slots_9_p_0(SlotInfo_1, GoalId_2, CurOrElseNum_28, STATE_VARIABLE_GoalNumCounter_1_36, STATE_VARIABLE_GoalNumCounter_5, STATE_VARIABLE_ContainingGoalList_1_37, STATE_VARIABLE_ContainingGoalList_7, Goals0_25, &Goals_27);
    {
      MR_Word base;
      base = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      *HeadVar__9_9 = base;
  ...
  MR_Word * HeadVar__10_10)
{
  ...
  else
  {
    ...
    hlds__goal_path__fill_goal_id_slots_8_p_0(SlotInfo_1, ContainingGoal_35, STATE_VARIABLE_GoalNumCounter_0_5, &STATE_VARIABLE_GoalNumCounter_1_43, STATE_VARIABLE_ContainingGoalList_0_7, &STATE_VARIABLE_ContainingGoalList_1_44, Goal0_33, &Goal_36);
    {
    ...
    hlds__goal_path__fill_switch_id_slots_10_p_0(SlotInfo_1, GoalId_2, CurArmNum_34, MaybeNumFunctors_4, STATE_VARIABLE_GoalNumCounter_1_43, STATE_VARIABLE_GoalNumCounter_6, STATE_VARIABLE_ContainingGoalList_1_44, STATE_VARIABLE_ContainingGoalList_8, Cases0_28, &Cases_30);
    {
      MR_Word base;
      base = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      *HeadVar__10_10 = base;
  ...
  MR_Word * HeadVar__9_9)
{
  ...
  else
  {
    ...
    hlds__goal_path__fill_goal_id_slots_8_p_0(SlotInfo_1, ContainingGoal_29, STATE_VARIABLE_GoalNumCounter_0_4, &STATE_VARIABLE_GoalNumCounter_1_36, STATE_VARIABLE_ContainingGoalList_0_6, &STATE_VARIABLE_ContainingGoalList_1_37, Goal0_24, &Goal_26);
    hlds__goal_path__fill_disj_id_slots_9_p_0(SlotInfo_1, GoalId_2, CurDisjunctNum_28, STATE_VARIABLE_GoalNumCounter_1_36, STATE_VARIABLE_GoalNumCounter_5, STATE_VARIABLE_ContainingGoalList_1_37, STATE_VARIABLE_ContainingGoalList_7, Goals0_25, &Goals_27);
    {
      MR_Word base;
      base = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      *HeadVar__9_9 = base;
  ...
  MR_Word * HeadVar__9_9)
{
  ...
  else
  {
    ...
    hlds__goal_path__fill_goal_id_slots_8_p_0(SlotInfo_1, ContainingGoal_29, STATE_VARIABLE_GoalNumCounter_0_4, &STATE_VARIABLE_GoalNumCounter_1_36, STATE_VARIABLE_ContainingGoalList_0_6, &STATE_VARIABLE_ContainingGoalList_1_37, Goal0_24, &Goal_26);
    hlds__goal_path__fill_conj_id_slots_9_p_0(SlotInfo_1, GoalId_2, CurConjunctNum_28, STATE_VARIABLE_GoalNumCounter_1_36, STATE_VARIABLE_GoalNumCounter_5, STATE_VARIABLE_ContainingGoalList_1_37, STATE_VARIABLE_ContainingGoalList_7, Goals0_25, &Goals_27);
    {
      MR_Word base;
      base = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      *HeadVar__9_9 = base;
    ...
    case (MR_Integer) 0:
      {
        ...
        hlds__goal_path__fill_goal_id_slots_8_p_0(SlotInfo_9, Var_119, STATE_VARIABLE_GoalNumCounter_1_103, STATE_VARIABLE_GoalNumCounter_100, STATE_VARIABLE_ContainingGoalList_1_104, STATE_VARIABLE_ContainingGoalList_102, SubGoal0_69, &SubGoal_70);
          ...
          case (MR_Integer) 2:
            {
              ...
              hlds__goal_path__fill_goal_id_slots_8_p_0(SlotInfo_9, Var_106, STATE_VARIABLE_GoalNumCounter_1_103, STATE_VARIABLE_GoalNumCounter_100, STATE_VARIABLE_ContainingGoalList_1_104, STATE_VARIABLE_ContainingGoalList_102, LambdaGoal0_50, &LambdaGoal_51);
              {
        ...
        case (MR_Integer) 2:
          {
            ...
            hlds__goal_path__fill_conj_id_slots_9_p_0(SlotInfo_9, GoalId_18, (MR_Integer) 0, STATE_VARIABLE_GoalNumCounter_1_103, STATE_VARIABLE_GoalNumCounter_100, STATE_VARIABLE_ContainingGoalList_1_104, STATE_VARIABLE_ContainingGoalList_102, Goals0_58, &Goals_59);
            {
        ...
        case (MR_Integer) 3:
          {
            ...
            hlds__goal_path__fill_disj_id_slots_9_p_0(SlotInfo_9, GoalId_18, (MR_Integer) 0, STATE_VARIABLE_GoalNumCounter_1_103, STATE_VARIABLE_GoalNumCounter_100, STATE_VARIABLE_ContainingGoalList_1_104, STATE_VARIABLE_ContainingGoalList_102, Goals0_152, &Goals_153);
            {
        ...
        case (MR_Integer) 4:
          {
            ...
            hlds__goal_path__fill_switch_id_slots_10_p_0(SlotInfo_9, GoalId_18, (MR_Integer) 0, MaybeNumFunctors_67, STATE_VARIABLE_GoalNumCounter_1_103, STATE_VARIABLE_GoalNumCounter_100, STATE_VARIABLE_ContainingGoalList_1_104, STATE_VARIABLE_ContainingGoalList_102, Cases0_62, &Cases_68);
            {
        ...
        case (MR_Integer) 5:
          {
            ...
            hlds__goal_path__fill_goal_id_slots_8_p_0(SlotInfo_9, Var_123, STATE_VARIABLE_GoalNumCounter_1_103, STATE_VARIABLE_GoalNumCounter_100, STATE_VARIABLE_ContainingGoalList_1_104, STATE_VARIABLE_ContainingGoalList_102, SubGoal0_154, &SubGoal_155);
            {
              GoalExpr_38 = (MR_Word) MR_mkword(3, MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
        ...
        case (MR_Integer) 6:
          {
            ...
            hlds__goal_path__fill_goal_id_slots_8_p_0(SlotInfo_9, Var_127, STATE_VARIABLE_GoalNumCounter_1_103, &STATE_VARIABLE_GoalNumCounter_8_128, STATE_VARIABLE_ContainingGoalList_1_104, &STATE_VARIABLE_ContainingGoalList_8_129, Cond0_78, &Cond_81);
            {
            ...
            hlds__goal_path__fill_goal_id_slots_8_p_0(SlotInfo_9, Var_131, STATE_VARIABLE_GoalNumCounter_8_128, &STATE_VARIABLE_GoalNumCounter_9_132, STATE_VARIABLE_ContainingGoalList_8_129, &STATE_VARIABLE_ContainingGoalList_9_133, Then0_79, &Then_82);
            {
              Var_135 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(1, Var_135, 0) = ((MR_Box) (GoalId_18));
              MR_hl_field(1, Var_135, 1) = ((MR_Box) ((MR_Unsigned) 8U));
            }
            hlds__goal_path__fill_goal_id_slots_8_p_0(SlotInfo_9, Var_135, STATE_VARIABLE_GoalNumCounter_9_132, STATE_VARIABLE_GoalNumCounter_100, STATE_VARIABLE_ContainingGoalList_9_133, STATE_VARIABLE_ContainingGoalList_102, Else0_80, &Else_83);
            {
              ...
              case (MR_Integer) 1:
                {
                  ...
                  hlds__goal_path__fill_goal_id_slots_8_p_0(SlotInfo_9, Var_139, STATE_VARIABLE_GoalNumCounter_1_103, &STATE_VARIABLE_GoalNumCounter_11_140, STATE_VARIABLE_ContainingGoalList_1_104, &STATE_VARIABLE_ContainingGoalList_11_141, MainGoal0_89, &MainGoal_92);
                  hlds__goal_path__fill_orelse_id_slots_9_p_0(SlotInfo_9, GoalId_18, (MR_Integer) 0, STATE_VARIABLE_GoalNumCounter_11_140, STATE_VARIABLE_GoalNumCounter_100, STATE_VARIABLE_ContainingGoalList_11_141, STATE_VARIABLE_ContainingGoalList_102, OrElseGoals0_90, &OrElseGoals_93);
                  {
              ...
              case (MR_Integer) 2:
                {
                  ...
                  hlds__goal_path__fill_goal_id_slots_8_p_0(SlotInfo_9, Var_146, STATE_VARIABLE_GoalNumCounter_1_103, STATE_VARIABLE_GoalNumCounter_100, STATE_VARIABLE_ContainingGoalList_1_104, STATE_VARIABLE_ContainingGoalList_102, SubGoal0_156, &SubGoal_157);
                  {
