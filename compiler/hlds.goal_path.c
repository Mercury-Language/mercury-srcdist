          ...
          case (MR_Integer) 5:
            {
              ...
              MR_Word SubGoal_115;
              MR_Word Var_29 = ((MR_Word) (MR_hl_field(MR_mktag(0), SubGoal0_113, (MR_Integer) 0)));
                ...
                MaybeCut_33 = (MR_Integer) 0;
              {
                ...
                MR_hl_field(MR_mktag(3), Var_106, 1) = ((MR_Box) (MaybeCut_33));
              }
              {
                SubRevGoalPath_114 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                ...
                case (MR_Integer) 2:
                  {
                    ...
                    {
                      SubRevGoalPath_117 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                      MR_hl_field(MR_mktag(1), SubRevGoalPath_117, 0) = ((MR_Box) (RevGoalPath_5));
                      MR_hl_field(MR_mktag(1), SubRevGoalPath_117, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 5))));
                    }
      ...
      case (MR_Integer) 0:
        {
...

          {
            ...
            MR_hl_field(MR_mktag(1), Var_137, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 3))));
          }
            ...
            case (MR_Integer) 2:
              {
...

                {
                  ...
                  MR_hl_field(MR_mktag(1), Var_150, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 4))));
                }
          ...
          case (MR_Integer) 5:
            {
              ...
              MR_Word SubGoal_157;
              MR_Word Var_74 = ((MR_Word) (MR_hl_field(MR_mktag(0), SubGoal0_156, (MR_Integer) 0)));
                ...
                MaybeCut_78 = (MR_Integer) 0;
              {
                ...
                MR_hl_field(MR_mktag(3), Var_136, 1) = ((MR_Box) (MaybeCut_78));
              }
              {
          ...
          case (MR_Integer) 6:
            {
              ...
              hlds__goal_path__fill_goal_id_slots_8_p_0(SlotInfo_9, Var_121, STATE_VARIABLE_GoalNumCounter_105_105, &STATE_VARIABLE_GoalNumCounter_122_122, STATE_VARIABLE_ContainingGoalList_106_106, &STATE_VARIABLE_ContainingGoalList_123_123, Cond0_80, &Cond_83);
              {
                ...
                MR_hl_field(MR_mktag(1), Var_125, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 1))));
              }
              hlds__goal_path__fill_goal_id_slots_8_p_0(SlotInfo_9, Var_125, STATE_VARIABLE_GoalNumCounter_122_122, &STATE_VARIABLE_GoalNumCounter_126_126, STATE_VARIABLE_ContainingGoalList_123_123, &STATE_VARIABLE_ContainingGoalList_127_127, Then0_81, &Then_84);
              {
                ...
                MR_hl_field(MR_mktag(1), Var_129, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 2))));
              }
                ...
                case (MR_Integer) 1:
                  {
...

                    {
                      ...
                      MR_hl_field(MR_mktag(1), Var_114, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 6))));
                    }
                ...
                case (MR_Integer) 2:
                  {
...

                    {
                      ...
                      MR_hl_field(MR_mktag(1), Var_110, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 5))));
                    }
