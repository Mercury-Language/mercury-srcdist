...
{
  {
    ...
    if (hlds__goal_path__succeeded)
      *hlds__goal_path__HeadVar__1_1 = (MR_Integer) 0;
      ...
      {
        MR_Word hlds__goal_path__Var_4 = ((MR_Word) (MR_hl_field(MR_mktag(0), hlds__goal_path__HeadVar__2_2, (MR_Integer) 0)));
        MR_Word hlds__goal_path__Var_5 = ((MR_Word) (MR_hl_field(MR_mktag(0), hlds__goal_path__HeadVar__2_2, (MR_Integer) 1)));
        MR_Word hlds__goal_path__Var_6 = ((MR_Word) (MR_hl_field(MR_mktag(0), hlds__goal_path__HeadVar__3_3, (MR_Integer) 0)));
        MR_Word hlds__goal_path__Var_7 = ((MR_Word) (MR_hl_field(MR_mktag(0), hlds__goal_path__HeadVar__3_3, (MR_Integer) 1)));
        MR_Word hlds__goal_path__Var_8;

        {
          hlds__hlds_module____Compare____module_info_0_0(&hlds__goal_path__Var_8, hlds__goal_path__Var_4, hlds__goal_path__Var_6);
        }
        ...
        if (hlds__goal_path__succeeded)
          *hlds__goal_path__HeadVar__1_1 = hlds__goal_path__Var_8;
          ...
          {
            {
              mercury__builtin__compare_3_p_0((MR_Word) &hlds__goal_path_scalar_common_1[1], hlds__goal_path__HeadVar__1_1, ((MR_Box) (hlds__goal_path__Var_5)), ((MR_Box) (hlds__goal_path__Var_7)));
            }
          }
      }
  }
...
{
  {
    ...
    if (hlds__goal_path__succeeded)
    ...
    else
      {
        ...
        MR_Word hlds__goal_path__Var_3 = ((MR_Word) (MR_hl_field(MR_mktag(0), hlds__goal_path__HeadVar__1_1, (MR_Integer) 0)));
        MR_Word hlds__goal_path__Var_4 = ((MR_Word) (MR_hl_field(MR_mktag(0), hlds__goal_path__HeadVar__1_1, (MR_Integer) 1)));
        MR_Word hlds__goal_path__Var_5 = ((MR_Word) (MR_hl_field(MR_mktag(0), hlds__goal_path__HeadVar__2_2, (MR_Integer) 0)));
        MR_Word hlds__goal_path__Var_6 = ((MR_Word) (MR_hl_field(MR_mktag(0), hlds__goal_path__HeadVar__2_2, (MR_Integer) 1)));

        {
          hlds__goal_path__succeeded = hlds__hlds_module____Unify____module_info_0_0(hlds__goal_path__Var_3, hlds__goal_path__Var_5);
        }
        if (hlds__goal_path__succeeded)
          {
            hlds__goal_path__TypeInfo_10_10 = (MR_Word) &hlds__goal_path_scalar_common_1[1];
            {
              hlds__goal_path__succeeded = mercury__builtin__unify_2_p_0(hlds__goal_path__TypeInfo_10_10, ((MR_Box) (hlds__goal_path__Var_4)), ((MR_Box) (hlds__goal_path__Var_6)));
            }
          }
      }
    return hlds__goal_path__succeeded;
