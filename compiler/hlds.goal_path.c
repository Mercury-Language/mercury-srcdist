...
{
  {
    ...
    else
    {
      ...
      {
        mercury__builtin__compare_3_p_0((MR_Word) &hlds__goal_path_scalar_common_1[1], HeadVar__1_1, ((MR_Box) (ArgX2_6)), ((MR_Box) (ArgY2_7)));
      }
    }
  }
}
...
{
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        TypeInfo_10_10 = (MR_Word) &hlds__goal_path_scalar_common_1[1];
...
{
  {
    ...
    {
      ContainingGoal_18 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), ContainingGoal_18, 0) = ((MR_Box) (Var_24));
      MR_hl_field(MR_mktag(1), ContainingGoal_18, 1) = ((MR_Box) (Var_25));
    }
    *NextClauseNum_14 = (CurClauseNum_13 + (MR_Integer) 1);
    ...
    Var_30 = ((MR_Word) (MR_hl_field(MR_mktag(0), Clause0_11, (MR_Integer) 1)));
...
{
  {
    ...
    {
      SlotInfo_8 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), SlotInfo_8, 0) = ((MR_Box) (ModuleInfo_4));
      MR_hl_field(MR_mktag(0), SlotInfo_8, 1) = ((MR_Box) (VarTypes_7));
    }
    hlds__goal_path__fill_goal_path_slots_4_p_0((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), SlotInfo_8, Goal0_6, &Goal_9);
  ...
  MR_Word * HeadVar__5_5)
{
  ...
  else
  {
    ...
    MR_Word Goal_14;
    MR_Word Goals_15;
    MR_Integer CurOrElseNum_16 = (LastOrElseNum_2 + (MR_Integer) 1);
    ...
    {
      RevGoalPath_17 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
  ...
  MR_Word * HeadVar__6_6)
{
  ...
  else
  {
    ...
    MR_Integer CurArmNum_22 = (LastArmNum_2 + (MR_Integer) 1);
    ...
    {
      RevGoalPath_23 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
  ...
  MR_Word * HeadVar__5_5)
{
  ...
  else
  {
    ...
    MR_Word Goal_14;
    MR_Word Goals_15;
    MR_Integer CurDisjunctNum_16 = (LastDisjunctNum_2 + (MR_Integer) 1);
    MR_Word RevGoalPath_17;
    MR_Word Var_19;
  ...
  MR_Word * HeadVar__5_5)
{
  ...
  else
  {
    ...
    MR_Word Goal_14;
    MR_Word Goals_15;
    MR_Integer CurConjunctNum_16 = (LastConjunctNum_2 + (MR_Integer) 1);
    MR_Word RevGoalPath_17;
    MR_Word Var_19;
...
{
  {
    ...
    switch (MR_tag((MR_Word) GoalExpr0_9)) {
      ...
      case (MR_Integer) 0:
        {
          MR_Word SubGoal0_25 = (MR_Word) MR_body(((MR_Word) GoalExpr0_9), (MR_Integer) 0);
          MR_Word SubRevGoalPath_26;
          MR_Word SubGoal_27;

          {
            SubRevGoalPath_26 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), SubRevGoalPath_26, 0) = ((MR_Box) (RevGoalPath_5));
            MR_hl_field(MR_mktag(1), SubRevGoalPath_26, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 3))));
          }
          hlds__goal_path__fill_goal_path_slots_4_p_0(SubRevGoalPath_26, SlotInfo_6, SubGoal0_25, &SubGoal_27);
          GoalExpr_15 = (MR_Word) MR_mkword(MR_mktag(0), (MR_Word) SubGoal_27);
        }
        break;
      case (MR_Integer) 1:
        {
          ...
          switch (MR_tag((MR_Word) RHS0_45)) {
            ...
            case (MR_Integer) 2:
              {
                MR_Word Purity_49 = ((((MR_Word) (MR_hl_field(MR_mktag(2), RHS0_45, (MR_Integer) 0)))) & (MR_Integer) 3);
                MR_Word Groundness_50 = ((((((MR_Word) (MR_hl_field(MR_mktag(2), RHS0_45, (MR_Integer) 0)))) >> (MR_Integer) 2)) & (MR_Integer) 1);
                MR_Word PredOrFunc_51 = ((((((MR_Word) (MR_hl_field(MR_mktag(2), RHS0_45, (MR_Integer) 0)))) >> (MR_Integer) 3)) & (MR_Integer) 1);
                ...
                MR_Word Detism_56 = ((MR_Word) (MR_hl_field(MR_mktag(2), RHS0_45, (MR_Integer) 5)));
                ...
                {
                  RHS_59 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, ((MR_Integer) 7 * sizeof(MR_Word)), NULL, NULL));
                  MR_hl_field(MR_mktag(2), RHS_59, 0) = ((MR_Box) ((Purity_49 | ((((Groundness_50 << (MR_Integer) 2)) | ((PredOrFunc_51 << (MR_Integer) 3)))))));
                  MR_hl_field(MR_mktag(2), RHS_59, 1) = (MR_Integer) 0;
                  ...
                  MR_hl_field(MR_mktag(2), RHS_59, 5) = ((MR_Box) (Detism_56));
      ...
      case (MR_Integer) 3:
        switch (((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), GoalExpr0_9, (MR_Integer) 0)))) {
          ...
          case (MR_Integer) 2:
            {
              MR_Word ConjType_12 = ((MR_Word) (MR_hl_field(MR_mktag(3), GoalExpr0_9, (MR_Integer) 1)));
              ...
              hlds__goal_path__fill_conj_path_slots_5_p_0(RevGoalPath_5, (MR_Integer) 0, SlotInfo_6, Goals0_13, &Goals_14);
              {
                ...
                MR_hl_field(MR_mktag(3), GoalExpr_15, 1) = ((MR_Box) (ConjType_12));
          ...
          case (MR_Integer) 3:
            {
              MR_Word Goals0_112 = ((MR_Word) (MR_hl_field(MR_mktag(3), GoalExpr0_9, (MR_Integer) 1)));
              MR_Word Goals_113;

              hlds__goal_path__fill_disj_path_slots_5_p_0(RevGoalPath_5, (MR_Integer) 0, SlotInfo_6, Goals0_112, &Goals_113);
              {
                ...
                MR_hl_field(MR_mktag(3), GoalExpr_15, 1) = ((MR_Box) (Goals_113));
              }
            }
            break;
          case (MR_Integer) 4:
            {
              ...
              MR_Word CanFail_17 = ((MR_Word) (MR_hl_field(MR_mktag(3), GoalExpr0_9, (MR_Integer) 2)));
              ...
              if (succeeded)
                {
                  MaybeNumFunctors_23 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
                  MR_hl_field(MR_mktag(1), MaybeNumFunctors_23, 0) = ((MR_Box) (NumFunctors_22));
                }
              else
                MaybeNumFunctors_23 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
              hlds__goal_path__fill_switch_path_slots_6_p_0(RevGoalPath_5, (MR_Integer) 0, MaybeNumFunctors_23, SlotInfo_6, Cases0_18, &Cases_24);
              {
                ...
                MR_hl_field(MR_mktag(3), GoalExpr_15, 2) = ((MR_Box) (CanFail_17));
          ...
          case (MR_Integer) 5:
            {
              ...
              MR_Word MaybeCut_33;
              MR_Word Var_107;
              MR_Word SubGoal0_114 = ((MR_Word) (MR_hl_field(MR_mktag(3), GoalExpr0_9, (MR_Integer) 2)));
              MR_Word SubRevGoalPath_115;
              MR_Word SubGoal_116;
              MR_Word Var_29 = ((MR_Word) (MR_hl_field(MR_mktag(0), SubGoal0_114, (MR_Integer) 0)));

              InnerInfo_30 = ((MR_Word) (MR_hl_field(MR_mktag(0), SubGoal0_114, (MR_Integer) 1)));
                ...
                MaybeCut_33 = (MR_Integer) 0;
              {
                ...
                MR_hl_field(MR_mktag(3), Var_107, 1) = ((MR_Box) (MaybeCut_33));
              }
              {
                SubRevGoalPath_115 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(1), SubRevGoalPath_115, 0) = ((MR_Box) (RevGoalPath_5));
                MR_hl_field(MR_mktag(1), SubRevGoalPath_115, 1) = ((MR_Box) (Var_107));
              }
              hlds__goal_path__fill_goal_path_slots_4_p_0(SubRevGoalPath_115, SlotInfo_6, SubGoal0_114, &SubGoal_116);
              {
                GoalExpr_15 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), GoalExpr_15, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 5));
                MR_hl_field(MR_mktag(3), GoalExpr_15, 1) = ((MR_Box) (Reason_28));
                MR_hl_field(MR_mktag(3), GoalExpr_15, 2) = ((MR_Box) (SubGoal_116));
              }
            }
            break;
          case (MR_Integer) 6:
            {
              ...
              {
                RevPathCond_38 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(1), RevPathCond_38, 0) = ((MR_Box) (RevGoalPath_5));
                MR_hl_field(MR_mktag(1), RevPathCond_38, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
              }
              {
                RevPathThen_39 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(1), RevPathThen_39, 0) = ((MR_Box) (RevGoalPath_5));
                MR_hl_field(MR_mktag(1), RevPathThen_39, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 1))));
              }
              {
                RevPathElse_40 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(1), RevPathElse_40, 0) = ((MR_Box) (RevGoalPath_5));
                MR_hl_field(MR_mktag(1), RevPathElse_40, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 2))));
              }
          ...
          case (MR_Integer) 7:
            {
              ...
              switch (MR_tag((MR_Word) ShortHand0_82)) {
                ...
                case (MR_Integer) 1:
                  {
                    MR_Word GoalType_83 = ((MR_Word) (MR_hl_field(MR_mktag(1), ShortHand0_82, (MR_Integer) 0)));
                    ...
                    {
                      RevPathMain_90 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                      MR_hl_field(MR_mktag(1), RevPathMain_90, 0) = ((MR_Box) (RevGoalPath_5));
                      MR_hl_field(MR_mktag(1), RevPathMain_90, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 6))));
                    }
                    ...
                    {
                      ShortHand_93 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 7 * sizeof(MR_Word)), NULL, NULL));
                      MR_hl_field(MR_mktag(1), ShortHand_93, 0) = ((MR_Box) (GoalType_83));
                ...
                case (MR_Integer) 2:
                  {
                    ...
                    MR_Word SubGoal0_117 = ((MR_Word) (MR_hl_field(MR_mktag(2), ShortHand0_82, (MR_Integer) 2)));
                    MR_Word SubRevGoalPath_118;
                    MR_Word SubGoal_119;

                    {
                      SubRevGoalPath_118 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                      MR_hl_field(MR_mktag(1), SubRevGoalPath_118, 0) = ((MR_Box) (RevGoalPath_5));
                      MR_hl_field(MR_mktag(1), SubRevGoalPath_118, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 5))));
                    }
                    hlds__goal_path__fill_goal_path_slots_4_p_0(SubRevGoalPath_118, SlotInfo_6, SubGoal0_117, &SubGoal_119);
                    {
                      ShortHand_93 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL));
                      MR_hl_field(MR_mktag(2), ShortHand_93, 0) = ((MR_Box) (MaybeIO_94));
                      MR_hl_field(MR_mktag(2), ShortHand_93, 1) = ((MR_Box) (ResultVar_95));
                      MR_hl_field(MR_mktag(2), ShortHand_93, 2) = ((MR_Box) (SubGoal_119));
                    }
                  }
                  break;
              }
              {
                GoalExpr_15 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), GoalExpr_15, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 7));
...
{
  {
    ...
    {
      SlotInfo_13 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
    ...
    TypeCtorInfo_32_32 = (MR_Word) &hlds__hlds_clauses__hlds__hlds_clauses__type_ctor_info_clause_0;
    mercury__list__map_foldl3_9_p_1(TypeCtorInfo_32_32, TypeCtorInfo_32_32, (MR_Word) &mercury__builtin__builtin__type_ctor_info_int_0, (MR_Word) &mercury__counter__counter__type_ctor_info_counter_0, (MR_Word) &hlds__goal_path_scalar_common_2[0], Var_19, Clauses0_11, &Clauses_14, ((MR_Box) ((MR_Integer) 1)), &conv6_Var_15, ((MR_Box) (Var_21)), &conv5_Var_16, ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))), &conv4_ContainingGoalList_17);
    Var_15 = ((MR_Integer) conv6_Var_15);
...
{
  {
    ...
    {
      SlotInfo_11 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
    ...
    hlds__goal_path__fill_goal_id_slots_8_p_0(SlotInfo_11, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), Var_15, &Var_12, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), &ContainingGoalList_13, Goal0_9, Goal_10);
  ...
  MR_Word * HeadVar__9_9)
{
  ...
  else
  {
    ...
    MR_Word Goal_26;
    MR_Word Goals_27;
    MR_Integer CurOrElseNum_28 = (LastOrElseNum_3 + (MR_Integer) 1);
    ...
    {
      ContainingGoal_29 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
...
hlds__goal_path__fill_switch_id_slots_10_p_0(
  ...
  MR_Word * HeadVar__10_10)
{
  if ((HeadVar__9_9 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
  {
  ...
  else
  {
    ...
    MR_Integer CurArmNum_34 = (LastArmNum_3 + (MR_Integer) 1);
    ...
    {
      ContainingGoal_35 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
    ...
    {
      Case_29 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL);
  ...
  MR_Word * HeadVar__9_9)
{
  ...
  else
  {
    ...
    MR_Word Goal_26;
    MR_Word Goals_27;
    MR_Integer CurDisjunctNum_28 = (LastDisjunctNum_3 + (MR_Integer) 1);
    MR_Word ContainingGoal_29;
    MR_Word Var_35;
    MR_Word STATE_VARIABLE_GoalNumCounter_36_36;
    MR_Word STATE_VARIABLE_ContainingGoalList_37_37;
  ...
  MR_Word * HeadVar__9_9)
{
  ...
  else
  {
    ...
    MR_Word Goal_26;
    MR_Word Goals_27;
    MR_Integer CurConjunctNum_28 = (LastConjunctNum_3 + (MR_Integer) 1);
    MR_Word ContainingGoal_29;
    MR_Word Var_35;
    MR_Word STATE_VARIABLE_GoalNumCounter_36_36;
    MR_Word STATE_VARIABLE_ContainingGoalList_37_37;
...
{
  {
    ...
    {
      STATE_VARIABLE_ContainingGoalList_106_106 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
    ...
    switch (MR_tag((MR_Word) GoalExpr0_15)) {
      ...
      case (MR_Integer) 0:
        {
          MR_Word SubGoal0_71 = (MR_Word) MR_body(((MR_Word) GoalExpr0_15), (MR_Integer) 0);
          MR_Word SubGoal_72;
          MR_Word Var_138;

          {
            Var_138 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), Var_138, 0) = ((MR_Box) (GoalId_18));
            MR_hl_field(MR_mktag(1), Var_138, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 3))));
          }
          hlds__goal_path__fill_goal_id_slots_8_p_0(SlotInfo_9, Var_138, STATE_VARIABLE_GoalNumCounter_105_105, STATE_VARIABLE_GoalNumCounter_102, STATE_VARIABLE_ContainingGoalList_106_106, STATE_VARIABLE_ContainingGoalList_104, SubGoal0_71, &SubGoal_72);
          GoalExpr_38 = (MR_Word) MR_mkword(MR_mktag(0), (MR_Word) SubGoal_72);
        }
        break;
      case (MR_Integer) 1:
        {
          ...
          switch (MR_tag((MR_Word) RHS0_40)) {
            ...
            case (MR_Integer) 2:
              {
                MR_Word Purity_44 = ((((MR_Word) (MR_hl_field(MR_mktag(2), RHS0_40, (MR_Integer) 0)))) & (MR_Integer) 3);
                MR_Word Groundness_45 = ((((((MR_Word) (MR_hl_field(MR_mktag(2), RHS0_40, (MR_Integer) 0)))) >> (MR_Integer) 2)) & (MR_Integer) 1);
                MR_Word PredOrFunc_46 = ((((((MR_Word) (MR_hl_field(MR_mktag(2), RHS0_40, (MR_Integer) 0)))) >> (MR_Integer) 3)) & (MR_Integer) 1);
                ...
                MR_Word Detism_51 = ((MR_Word) (MR_hl_field(MR_mktag(2), RHS0_40, (MR_Integer) 5)));
...

                {
                  ...
                  MR_hl_field(MR_mktag(1), Var_151, 0) = ((MR_Box) (GoalId_18));
                  MR_hl_field(MR_mktag(1), Var_151, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 4))));
                }
                hlds__goal_path__fill_goal_id_slots_8_p_0(SlotInfo_9, Var_151, STATE_VARIABLE_GoalNumCounter_105_105, STATE_VARIABLE_GoalNumCounter_102, STATE_VARIABLE_ContainingGoalList_106_106, STATE_VARIABLE_ContainingGoalList_104, LambdaGoal0_52, &LambdaGoal_53);
                {
                  RHS_54 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, ((MR_Integer) 7 * sizeof(MR_Word)), NULL, NULL));
                  MR_hl_field(MR_mktag(2), RHS_54, 0) = ((MR_Box) ((Purity_44 | ((((Groundness_45 << (MR_Integer) 2)) | ((PredOrFunc_46 << (MR_Integer) 3)))))));
                  MR_hl_field(MR_mktag(2), RHS_54, 1) = (MR_Integer) 0;
                  ...
                  MR_hl_field(MR_mktag(2), RHS_54, 5) = ((MR_Box) (Detism_51));
                  MR_hl_field(MR_mktag(2), RHS_54, 6) = ((MR_Box) (LambdaGoal_53));
                }
                {
                  GoalExpr_38 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 5 * sizeof(MR_Word)), NULL, NULL));
      ...
      case (MR_Integer) 3:
        switch (((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), GoalExpr0_15, (MR_Integer) 0)))) {
          ...
          case (MR_Integer) 2:
            {
              ...
              {
                GoalExpr_38 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), GoalExpr_38, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 2));
                MR_hl_field(MR_mktag(3), GoalExpr_38, 1) = ((MR_Box) (ConjType_59));
          ...
          case (MR_Integer) 3:
            {
              MR_Word Goals0_155 = ((MR_Word) (MR_hl_field(MR_mktag(3), GoalExpr0_15, (MR_Integer) 1)));
              MR_Word Goals_156;

              hlds__goal_path__fill_disj_id_slots_9_p_0(SlotInfo_9, GoalId_18, (MR_Integer) 0, STATE_VARIABLE_GoalNumCounter_105_105, STATE_VARIABLE_GoalNumCounter_102, STATE_VARIABLE_ContainingGoalList_106_106, STATE_VARIABLE_ContainingGoalList_104, Goals0_155, &Goals_156);
              {
                GoalExpr_38 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), GoalExpr_38, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 3));
                MR_hl_field(MR_mktag(3), GoalExpr_38, 1) = ((MR_Box) (Goals_156));
              }
            }
            break;
          case (MR_Integer) 4:
            {
              ...
              if (succeeded)
                {
                  MaybeNumFunctors_69 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
                  MR_hl_field(MR_mktag(1), MaybeNumFunctors_69, 0) = ((MR_Box) (NumFunctors_68));
                }
              else
                MaybeNumFunctors_69 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
              ...
              {
                GoalExpr_38 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), GoalExpr_38, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 4));
                MR_hl_field(MR_mktag(3), GoalExpr_38, 1) = ((MR_Box) (Var_62));
                MR_hl_field(MR_mktag(3), GoalExpr_38, 2) = ((MR_Box) (CanFail_63));
          ...
          case (MR_Integer) 5:
            {
              ...
              MR_Word Var_134;
              MR_Word Var_137;
              MR_Word SubGoal0_157 = ((MR_Word) (MR_hl_field(MR_mktag(3), GoalExpr0_15, (MR_Integer) 2)));
              MR_Word SubGoal_158;
              MR_Word Var_74 = ((MR_Word) (MR_hl_field(MR_mktag(0), SubGoal0_157, (MR_Integer) 0)));

              InnerInfo_75 = ((MR_Word) (MR_hl_field(MR_mktag(0), SubGoal0_157, (MR_Integer) 1)));
                ...
                MaybeCut_78 = (MR_Integer) 0;
              {
                ...
                MR_hl_field(MR_mktag(3), Var_137, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 1));
                MR_hl_field(MR_mktag(3), Var_137, 1) = ((MR_Box) (MaybeCut_78));
              }
              {
                Var_134 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(1), Var_134, 0) = ((MR_Box) (GoalId_18));
                MR_hl_field(MR_mktag(1), Var_134, 1) = ((MR_Box) (Var_137));
              }
              hlds__goal_path__fill_goal_id_slots_8_p_0(SlotInfo_9, Var_134, STATE_VARIABLE_GoalNumCounter_105_105, STATE_VARIABLE_GoalNumCounter_102, STATE_VARIABLE_ContainingGoalList_106_106, STATE_VARIABLE_ContainingGoalList_104, SubGoal0_157, &SubGoal_158);
              {
                GoalExpr_38 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), GoalExpr_38, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 5));
                MR_hl_field(MR_mktag(3), GoalExpr_38, 1) = ((MR_Box) (Reason_73));
                MR_hl_field(MR_mktag(3), GoalExpr_38, 2) = ((MR_Box) (SubGoal_158));
              }
            }
            break;
          case (MR_Integer) 6:
            {
              ...
              MR_Word Else_85;
              MR_Word Var_122;
              MR_Word STATE_VARIABLE_GoalNumCounter_123_123;
              MR_Word STATE_VARIABLE_ContainingGoalList_124_124;
              MR_Word Var_126;
              MR_Word STATE_VARIABLE_GoalNumCounter_127_127;
              MR_Word STATE_VARIABLE_ContainingGoalList_128_128;
              MR_Word Var_130;

              {
                Var_122 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(1), Var_122, 0) = ((MR_Box) (GoalId_18));
                MR_hl_field(MR_mktag(1), Var_122, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
              }
              hlds__goal_path__fill_goal_id_slots_8_p_0(SlotInfo_9, Var_122, STATE_VARIABLE_GoalNumCounter_105_105, &STATE_VARIABLE_GoalNumCounter_123_123, STATE_VARIABLE_ContainingGoalList_106_106, &STATE_VARIABLE_ContainingGoalList_124_124, Cond0_80, &Cond_83);
              {
                Var_126 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(1), Var_126, 0) = ((MR_Box) (GoalId_18));
                MR_hl_field(MR_mktag(1), Var_126, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 1))));
              }
              hlds__goal_path__fill_goal_id_slots_8_p_0(SlotInfo_9, Var_126, STATE_VARIABLE_GoalNumCounter_123_123, &STATE_VARIABLE_GoalNumCounter_127_127, STATE_VARIABLE_ContainingGoalList_124_124, &STATE_VARIABLE_ContainingGoalList_128_128, Then0_81, &Then_84);
              {
                Var_130 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(1), Var_130, 0) = ((MR_Box) (GoalId_18));
                MR_hl_field(MR_mktag(1), Var_130, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 2))));
              }
              hlds__goal_path__fill_goal_id_slots_8_p_0(SlotInfo_9, Var_130, STATE_VARIABLE_GoalNumCounter_127_127, STATE_VARIABLE_GoalNumCounter_102, STATE_VARIABLE_ContainingGoalList_128_128, STATE_VARIABLE_ContainingGoalList_104, Else0_82, &Else_85);
              {
                GoalExpr_38 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 5 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), GoalExpr_38, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 6));
          ...
          case (MR_Integer) 7:
            {
              ...
              switch (MR_tag((MR_Word) ShortHand0_86)) {
                ...
                case (MR_Integer) 1:
                  {
                    MR_Word GoalType_87 = ((MR_Word) (MR_hl_field(MR_mktag(1), ShortHand0_86, (MR_Integer) 0)));
                    ...
                    MR_Word Var_115;
                    MR_Word STATE_VARIABLE_GoalNumCounter_116_116;
                    MR_Word STATE_VARIABLE_ContainingGoalList_117_117;

                    {
                      Var_115 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                      MR_hl_field(MR_mktag(1), Var_115, 0) = ((MR_Box) (GoalId_18));
                      MR_hl_field(MR_mktag(1), Var_115, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 6))));
                    }
                    hlds__goal_path__fill_goal_id_slots_8_p_0(SlotInfo_9, Var_115, STATE_VARIABLE_GoalNumCounter_105_105, &STATE_VARIABLE_GoalNumCounter_116_116, STATE_VARIABLE_ContainingGoalList_106_106, &STATE_VARIABLE_ContainingGoalList_117_117, MainGoal0_91, &MainGoal_94);
                    hlds__goal_path__fill_orelse_id_slots_9_p_0(SlotInfo_9, GoalId_18, (MR_Integer) 0, STATE_VARIABLE_GoalNumCounter_116_116, STATE_VARIABLE_GoalNumCounter_102, STATE_VARIABLE_ContainingGoalList_117_117, STATE_VARIABLE_ContainingGoalList_104, OrElseGoals0_92, &OrElseGoals_95);
                    {
                      ShortHand_96 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 7 * sizeof(MR_Word)), NULL, NULL));
                      MR_hl_field(MR_mktag(1), ShortHand_96, 0) = ((MR_Box) (GoalType_87));
                ...
                case (MR_Integer) 2:
                  {
                    ...
                    MR_Word Var_111;
                    MR_Word SubGoal0_159 = ((MR_Word) (MR_hl_field(MR_mktag(2), ShortHand0_86, (MR_Integer) 2)));
                    MR_Word SubGoal_160;

                    {
                      Var_111 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                      MR_hl_field(MR_mktag(1), Var_111, 0) = ((MR_Box) (GoalId_18));
                      MR_hl_field(MR_mktag(1), Var_111, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 5))));
                    }
                    hlds__goal_path__fill_goal_id_slots_8_p_0(SlotInfo_9, Var_111, STATE_VARIABLE_GoalNumCounter_105_105, STATE_VARIABLE_GoalNumCounter_102, STATE_VARIABLE_ContainingGoalList_106_106, STATE_VARIABLE_ContainingGoalList_104, SubGoal0_159, &SubGoal_160);
                    {
                      ShortHand_96 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL));
                      MR_hl_field(MR_mktag(2), ShortHand_96, 0) = ((MR_Box) (MaybeIO_97));
                      MR_hl_field(MR_mktag(2), ShortHand_96, 1) = ((MR_Box) (ResultVar_98));
                      MR_hl_field(MR_mktag(2), ShortHand_96, 2) = ((MR_Box) (SubGoal_160));
                    }
                  }
                  break;
              }
              {
                GoalExpr_38 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), GoalExpr_38, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 7));
