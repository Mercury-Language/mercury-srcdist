  ...
  MR_Word * STATE_VARIABLE_ProcInfo_11)
{
  ...
  hlds__hlds_proc__proc_info_get_var_table_2_p_0(STATE_VARIABLE_ProcInfo_0_10, &VarTable_6);
  {
  ...
  hlds__hlds_proc__proc_info_get_goal_2_p_0(STATE_VARIABLE_ProcInfo_0_10, &Goal0_8);
  hlds__goal_path__fill_goal_path_slots_in_goal_4_p_0(SlotInfo_7, (MR_Word) ((MR_Unsigned) 0U), Goal0_8, &Goal_9);
  hlds__hlds_proc__proc_info_set_goal_3_p_0(Goal_9, STATE_VARIABLE_ProcInfo_0_10, STATE_VARIABLE_ProcInfo_11);
}
  ...
  MR_Word * STATE_VARIABLE_ProcInfo_12)
{
  ...
  hlds__hlds_proc__proc_info_get_var_table_2_p_0(STATE_VARIABLE_ProcInfo_0_11, &VarTable_8);
  hlds__hlds_proc__proc_info_get_goal_2_p_0(STATE_VARIABLE_ProcInfo_0_11, &Goal0_9);
  hlds__goal_path__fill_goal_id_slots_in_proc_body_5_p_0(ModuleInfo_5, VarTable_8, ContainingGoalMap_6, Goal0_9, &Goal_10);
  hlds__hlds_proc__proc_info_set_goal_3_p_0(Goal_10, STATE_VARIABLE_ProcInfo_0_11, STATE_VARIABLE_ProcInfo_12);
}
