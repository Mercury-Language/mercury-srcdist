...
#line 636 "hlds.goal_path.c"
static const MR_DuFunctorDescPtr hlds__goal_path__hlds__goal_path__du_name_ordered_slot_info_0[1] = {
  &hlds__goal_path__hlds__goal_path__du_functor_desc_slot_info_0_0
};

#line 641 "hlds.goal_path.c"
static const MR_Integer hlds__goal_path__hlds__goal_path__functor_number_map_slot_info_0[1] = {
  (MR_Integer) 0
};

#line 646 "hlds.goal_path.c"
...
{
#line 676 "hlds.goal_path.c"
  {
#line 678 "hlds.goal_path.c"
    MR_bool hlds__goal_path__succeeded;

#line 681 "hlds.goal_path.c"
    {
#line 683 "hlds.goal_path.c"
...
#line 688 "hlds.goal_path.c"
  }
#line 690 "hlds.goal_path.c"
}

#line 693 "hlds.goal_path.c"
static void MR_CALL 
hlds__goal_path____Compare____containing_goal_list_0_0_10001(
...
{
#line 704 "hlds.goal_path.c"
  {
#line 706 "hlds.goal_path.c"
    MR_Word hlds__goal_path__conv0_HeadVar__1_1;

#line 709 "hlds.goal_path.c"
    {
#line 711 "hlds.goal_path.c"
...
#line 716 "hlds.goal_path.c"
  }
#line 718 "hlds.goal_path.c"
}

#line 721 "hlds.goal_path.c"
static MR_bool MR_CALL 
hlds__goal_path____Unify____slot_info_0_0_10001(
...
{
#line 730 "hlds.goal_path.c"
  {
#line 732 "hlds.goal_path.c"
    MR_bool hlds__goal_path__succeeded;

#line 735 "hlds.goal_path.c"
    {
#line 737 "hlds.goal_path.c"
...
#line 744 "hlds.goal_path.c"
}

#line 747 "hlds.goal_path.c"
static void MR_CALL 
hlds__goal_path____Compare____slot_info_0_0_10001(
...
{
#line 758 "hlds.goal_path.c"
  {
#line 760 "hlds.goal_path.c"
    MR_Word hlds__goal_path__conv0_HeadVar__1_1;

#line 763 "hlds.goal_path.c"
    {
#line 765 "hlds.goal_path.c"
...
#line 768 "hlds.goal_path.c"
    *hlds__goal_path__wrapper_arg_1 = ((MR_Box) (hlds__goal_path__conv0_HeadVar__1_1));
#line 770 "hlds.goal_path.c"
  }
#line 772 "hlds.goal_path.c"
}
...
#line 888 "hlds.goal_path.c"
        {
#line 890 "hlds.goal_path.c"
...
#line 899 "hlds.goal_path.c"
            {
#line 901 "hlds.goal_path.c"
...
#line 178 "goal_path.m"
          if (((MR_tag((MR_Word) hlds__goal_path__RHS0_40)) == (MR_mktag((MR_Integer) 2))))
...
#line 250 "goal_path.m"
                    if (((MR_tag((MR_Word) hlds__goal_path__ShortHand0_86)) == (MR_mktag((MR_Integer) 1))))
...
#line 250 "goal_path.m"
                      if (((MR_tag((MR_Word) hlds__goal_path__ShortHand0_86)) == (MR_mktag((MR_Integer) 0))))
...
#line 198 "goal_path.m"
                      {
#line 198 "goal_path.m"
                        parse_tree__prog_data__lookup_var_type_3_p_0(hlds__goal_path__VarTypes_65, hlds__goal_path__Var_62, &hlds__goal_path__Type_67);
                      }
