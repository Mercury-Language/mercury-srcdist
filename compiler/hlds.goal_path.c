  ...
  MR_Word * STATE_VARIABLE_Proc_12)
{
  ...
  hlds__hlds_pred__proc_info_get_varset_vartypes_3_p_0(STATE_VARIABLE_Proc_0_11, &_VarSet_7, &VarTypes_8);
  {
    ...
    MR_hl_field(MR_mktag(0), SlotInfo_9, 1) = ((MR_Box) (VarTypes_8));
  }
        ...
        case (MR_Integer) 4:
          {
            ...
            parse_tree__vartypes__lookup_var_type_3_p_0(VarTypes_19, Var_16, &Type_21);
  ...
  MR_Word * STATE_VARIABLE_ProcInfo_13)
{
  ...
  hlds__goal_path__fill_goal_id_slots_in_proc_body_5_p_0(ModuleInfo_5, VarTypes_9, ContainingGoalMap_6, Goal0_10, &Goal_11);
        ...
        case (MR_Integer) 4:
          {
            ...
            MR_Word VarTypes_64 = ((MR_Word) ((MR_hl_field(MR_mktag(0), SlotInfo_9, (MR_Integer) 1))));
            ...
            parse_tree__vartypes__lookup_var_type_3_p_0(VarTypes_64, Var_61, &Type_66);
