  ...
  MR_Word * STATE_VARIABLE_ProcInfo_11)
{
  ...
  hlds__hlds_pred__proc_info_get_var_table_3_p_0(ModuleInfo_4, STATE_VARIABLE_ProcInfo_0_10, &VarTable_6);
  {
    ...
    MR_hl_field(MR_mktag(0), SlotInfo_7, 1) = ((MR_Box) (VarTable_6));
  }
        ...
        case (MR_Integer) 4:
          {
            ...
            MR_Word VarTable_19 = ((MR_Word) ((MR_hl_field(MR_mktag(0), SlotInfo_6, (MR_Integer) 1))));
  ...
  MR_Word * ClausesInfo_8)
{
  ...
  hlds__hlds_clauses__clauses_info_get_var_table_2_p_0(ClausesInfo0_7, &VarTable_12);
  {
    ...
    MR_hl_field(MR_mktag(0), SlotInfo_13, 1) = ((MR_Box) (VarTable_12));
  }
  {
        ...
        case (MR_Integer) 4:
          {
            ...
            MR_Word VarTable_64 = ((MR_Word) ((MR_hl_field(MR_mktag(0), SlotInfo_9, (MR_Integer) 1))));
