...
MR_define_entry(mercury____Unify___ll_backend__layout__proc_layout_exec_trace_0_0);
	...
	MR_Word MR_tempr1, MR_tempr2;
	MR_tempr1 = MR_sv(35);
	MR_sv(35) = MR_tfield(0, MR_tempr1, 1);
	MR_tempr2 = MR_sv(1);
	...
	MR_sv(33) = MR_tfield(0, MR_tempr2, 17);
	MR_sv(34) = (MR_Word) MR_CTOR0_ADDR(ll_backend__layout, layout_slot_name);
	MR_r1 = MR_sv(34);
...
MR_def_label(__Unify___ll_backend__layout__proc_layout_exec_trace_0_0,12)
	...
	MR_sv(35) = (MR_Word) MR_INT_CTOR_ADDR;
	MR_r1 = MR_sv(35);
	MR_r2 = MR_sv(8);
	MR_r3 = MR_sv(25);
	MR_np_call_localret_ent(__Unify___maybe__maybe_1_0,
