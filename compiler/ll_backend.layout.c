...
MR_decl_label5(__Compare___ll_backend__layout__module_layout_data_0_0, 34,38,42,46,143)
...
const MR_ConstString mercury_data_ll_backend__layout__field_names_module_layout_data_0_0[] = {
	"mlcd_module_common_name",
	"mlcd_string_table_size",
	"mlcd_string_table"
};
...
MR_BEGIN_MODULE(ll_backend__layout_module37)
	...
	MR_init_label5(__Compare___ll_backend__layout__module_layout_data_0_0,34,38,42,46,143)
MR_BEGIN_CODE
...
MR_def_label(__Compare___ll_backend__layout__module_layout_data_0_0,9)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___ll_backend__layout__module_layout_data_0_0_i143);
	}
	MR_r1 = MR_sv(4);
	MR_r2 = MR_sv(1);
	MR_np_call_localret_ent(private_builtin__builtin_compare_int_3_0,
...
MR_def_label(__Compare___ll_backend__layout__module_layout_data_0_0,46)
	...
	MR_decr_sp(15);
	MR_np_tailcall_ent(builtin__compare_3_0);
MR_def_label(__Compare___ll_backend__layout__module_layout_data_0_0,143)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(15);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
