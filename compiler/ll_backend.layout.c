...
MR_decl_label1(__Compare___ll_backend__layout__proc_layout_exec_trace_0_0, 157)
...
MR_define_entry(mercury____Unify___ll_backend__layout__proc_layout_exec_trace_0_0);
	...
	MR_sv(11) = MR_tfield(0, MR_tempr1, 12);
	MR_sv(12) = MR_tfield(0, MR_tempr1, 13);
	MR_sv(13) = MR_tfield(0, MR_tempr1, 14);
	MR_sv(14) = MR_tfield(0, MR_tempr1, 15);
	MR_sv(15) = MR_tfield(0, MR_tempr1, 16);
	MR_sv(16) = MR_tfield(0, MR_tempr1, 17);
	MR_sv(17) = MR_tfield(0, MR_tempr1, 18);
	...
	MR_sv(35) = MR_tfield(0, MR_tempr2, 18);
	MR_sv(36) = (MR_Word) MR_CTOR0_ADDR(ll_backend__layout, layout_slot_name);
	MR_r1 = MR_sv(36);
...
MR_def_label(__Unify___ll_backend__layout__proc_layout_exec_trace_0_0,12)
	...
	MR_sv(37) = (MR_Word) MR_INT_CTOR_ADDR;
	MR_r1 = MR_sv(37);
	MR_r2 = MR_sv(9);
	MR_r3 = MR_sv(27);
	MR_np_call_localret_ent(__Unify___maybe__maybe_1_0,
...
MR_BEGIN_MODULE(ll_backend__layout_module41)
	...
	MR_init_label1(__Compare___ll_backend__layout__proc_layout_exec_trace_0_0,157)
MR_BEGIN_CODE
...
MR_def_label(__Compare___ll_backend__layout__proc_layout_exec_trace_0_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___ll_backend__layout__proc_layout_exec_trace_0_0_i157);
	}
	MR_r1 = MR_sv(1);
	MR_r2 = MR_sv(19);
...
MR_def_label(__Compare___ll_backend__layout__proc_layout_exec_trace_0_0,73)
	...
	MR_decr_sp(37);
	MR_np_tailcall_ent(private_builtin__builtin_compare_int_3_0);
MR_def_label(__Compare___ll_backend__layout__proc_layout_exec_trace_0_0,157)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_define_entry(mercury____Unify___ll_backend__layout__proc_layout_proc_static_0_0);
	...
	MR_tempr4 = MR_tempr2;
	MR_sv(1) = MR_tfield(0, MR_tempr3, 5);
