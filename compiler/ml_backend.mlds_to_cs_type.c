      ...
      case (MR_Integer) 1:
        {
          ...
          MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), ClassId_22, (MR_Integer) 2)));
          ...
          case (MR_Integer) 2:
            {
              ...
              if (succeeded)
              {
                packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), CtorCat_8, (MR_Integer) 0)));
              ...
              OutputGenerics_40 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Info_6, (MR_Integer) 5))) >> (MR_Integer) 2)) & (MR_Integer) 1);
            ...
            case (MR_Integer) 1:
              {
                ...
                MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), Var_25, (MR_Integer) 0)));
...
{
  {
    ...
    if (((((MR_tag((MR_Word) CtorCat_6)) == (MR_Integer) 3)) && ((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), CtorCat_6, (MR_Integer) 0))) == (MR_Integer) 0))))
    {
      ...
      MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), CtorCat_6, (MR_Integer) 1)));
    ...
    if (((((MR_tag((MR_Word) CtorCat_6)) == (MR_Integer) 3)) && ((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), CtorCat_6, (MR_Integer) 0))) == (MR_Integer) 1))))
    {
      ...
      MR_Unsigned packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), CtorCat_6, (MR_Integer) 1)));
      MR_Word Var_17;
                  ...
                  case (MR_Integer) 1:
                    {
                      ...
                      MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), BuiltinType_8, (MR_Integer) 0)));
