...
static /* final */ const struct ml_backend__mlds_to_cs_type__vector_common_type_5_0_s ml_backend__mlds_to_cs_type_vector_common_5[4] = {
  ...
  /* row   2 */
  {
    ...
    (MR_Word) (MR_mkword(MR_mktag(1), &ml_backend__mlds_to_cs_type_scalar_common_1[0]))
  },
  /* row   3 */
  {
...
ml_backend__mlds_to_cs_type__IntroducedFrom__func__type_to_string_for_csharp__212__1_1_f_0(
  MR_Word LambdaHeadVar__1_47)
{
  MR_Word LambdaHeadVar__2_48 = ((MR_Word) ((MR_hl_field(MR_mktag(0), LambdaHeadVar__1_47, (MR_Integer) 1))));
  ...
  MR_Word Stream_8)
{
  ...
  ml_backend__mlds_to_cs_type__type_to_string_for_csharp_4_p_0(Info_6, MLDS_Type_7, &String_20, &ArrayDims_21);
  mercury__io__write_string_4_p_0(Stream_8, String_20);
  Var_23 = mercury__list__f_43_43_2_f_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0), ArrayDims_21, (MR_Word) ((MR_Unsigned) 0U));
  ml_backend__mlds_to_target_util__output_array_dimensions_4_p_0(Stream_8, Var_23);
}
    ...
    switch (MR_tag((MR_Word) MLDS_Type_6)) {
      ...
      case (MR_Integer) 1:
        {
          ...
          MR_Word Name_21 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ClassId_20, (MR_Integer) 0))));
          MR_Integer Arity_22 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), ClassId_20, (MR_Integer) 1))));
      ...
      case (MR_Integer) 2:
        {
          ...
          Args_25 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_45, (MR_Integer) 0))));
          RetTypes_26 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_45, (MR_Integer) 1))));
      ...
      case (MR_Integer) 3:
        switch (((MR_Integer) ((MR_hl_field(MR_mktag(3), MLDS_Type_6, (MR_Integer) 0))))) {
          ...
          case (MR_Integer) 1:
            {
              ...
              if (succeeded)
              {
                Var_34 = ((MR_Word) ((MR_hl_field(MR_mktag(3), ElementType_13, (MR_Integer) 2))));
                ...
                if (succeeded)
                {
                  ...
                  ml_backend__mlds_to_cs_type__type_to_string_for_csharp_4_p_0(Info_5, ElementType_13, String_7, &ArrayDims0_55);
                  {
                    ...
                    *ArrayDims_8 = base;
                    ...
                    MR_hl_field(MR_mktag(1), base, 1) = ((MR_Box) (ArrayDims0_55));
                  }
                }
                else
                {
                  *String_7 = (MR_String) "object";
                  *ArrayDims_8 = (MR_Word) (MR_mkword(MR_mktag(1), &ml_backend__mlds_to_cs_type_scalar_common_1[0]));
                }
              }
            }
            break;
          ...
          case (MR_Integer) 4:
            {
              ...
              switch (MR_tag((MR_Word) ForeignType_17)) {
                ...
                case (MR_Integer) 2:
                  {
                    MR_Word Var_38 = ((MR_Word) ((MR_hl_field(MR_mktag(2), ForeignType_17, (MR_Integer) 0))));
          ...
          case (MR_Integer) 5:
            {
              MR_Word Type_60 = ((MR_Word) ((MR_hl_field(MR_mktag(3), MLDS_Type_6, (MR_Integer) 1))));
          ...
          case (MR_Integer) 6:
            {
              ...
              ml_backend__mlds_to_cs_type__type_to_string_for_csharp_4_p_0(Info_5, (MR_Word) ((MR_Unsigned) 20U), String_7, &ArrayDims0_63);
              {
                ...
                *ArrayDims_8 = base;
                MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) ((MR_Integer) 0));
                MR_hl_field(MR_mktag(1), base, 1) = ((MR_Box) (ArrayDims0_63));
              }
            }
            break;
          case (MR_Integer) 7:
          ...
          case (MR_Integer) 8:
            {
              MR_Word RttiIdMaybeElement_31 = ((MR_Word) ((MR_hl_field(MR_mktag(3), MLDS_Type_6, (MR_Integer) 1))));
              MR_Word IsArray_32;
          ...
          case (MR_Integer) 9:
            {
              MR_Word TablingId_33 = ((MR_Word) ((MR_hl_field(MR_mktag(3), MLDS_Type_6, (MR_Integer) 1))));
              MR_Word IsArray_69;
  ...
  MR_Word * ArrayDims_10)
{
  while (MR_TRUE)
  {
    ...
    switch (MR_tag((MR_Word) CtorCat_8)) {
      ...
      case (MR_Integer) 0:
        switch (MR_unmkbody(CtorCat_8)) {
          ...
          case (MR_Integer) 0:
            {
              ...
              *ArrayDims_10 = (MR_Word) (MR_mkword(MR_mktag(1), &ml_backend__mlds_to_cs_type_scalar_common_1[0]));
            }
            break;
          case (MR_Integer) 1:
            {
          ...
          case (MR_Integer) 2:
            {
              MR_Word TypeCtor_27;
              MR_Word ArgsTypes_28;
              MR_Word ClassName_29;
              MR_Integer ClassArity_30;
              MR_Word ClassKind_32;
              MR_Word ClassId_33;
              MR_Word MLDS_Type_34;
              MR_String TypeString_35;
              MR_Word OutputGenerics_36;

              parse_tree__prog_type__type_to_ctor_and_args_det_3_p_0(Type_7, &TypeCtor_27, &ArgsTypes_28);
              ml_backend__ml_type_gen__ml_gen_type_name_3_p_0(TypeCtor_27, &ClassName_29, &ClassArity_30);
              succeeded = ((MR_tag((MR_Word) CtorCat_8)) == (MR_Integer) 2);
              if (succeeded)
                ClassKind_32 = (MR_Integer) 3;
              else
                ClassKind_32 = (MR_Integer) 0;
              {
                ClassId_33 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
                MR_hl_field(MR_mktag(0), ClassId_33, 0) = ((MR_Box) (ClassName_29));
                MR_hl_field(MR_mktag(0), ClassId_33, 1) = ((MR_Box) (ClassArity_30));
                MR_hl_field(MR_mktag(0), ClassId_33, 2) = (MR_Box) ((MR_Unsigned) (ClassKind_32));
              }
              MLDS_Type_34 = (MR_Word) (MR_mkword(MR_mktag(1), (MR_Word) (ClassId_33)));
              ml_backend__mlds_to_cs_type__type_to_string_for_csharp_4_p_0(Info_6, MLDS_Type_34, &TypeString_35, ArrayDims_10);
              OutputGenerics_36 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Info_6, (MR_Integer) 5))) >> 2)) & (MR_Integer) 1);
              switch (OutputGenerics_36) {
                default: /*NOTREACHED*/ MR_assert(0);
                case (MR_Integer) 1:
                  *String_9 = TypeString_35;
                  break;
                case (MR_Integer) 0:
                  {
                    MR_String GenericsString_37;

                    ml_backend__mlds_to_cs_type__generic_args_types_to_string_for_csharp_3_p_0(Info_6, ArgsTypes_28, &GenericsString_37);
                    *String_9 = mercury__string__f_43_43_2_f_0(TypeString_35, GenericsString_37);
                  }
                  break;
              }
            }
      ...
      case (MR_Integer) 1:
        {
          MR_Word BuiltinCat_11 = ((MR_Word) ((MR_hl_field(MR_mktag(1), CtorCat_8, (MR_Integer) 0))));
          ...
          switch (MR_tag((MR_Word) BuiltinCat_11)) {
            ...
            case (MR_Integer) 1:
              {
                MR_Word IntType_12 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(1), BuiltinCat_11, (MR_Integer) 0))) & (MR_Integer) 15);
          ...
          case (MR_Integer) 0:
            {
              // direct tailcall eliminated
              ;
              CtorCat_8 = (MR_Word) (MR_mkword(MR_mktag(3), &ml_backend__mlds_to_cs_type_scalar_common_1[1]));
              continue;
            }
            break;
          case (MR_Integer) 1:
  ...
  MR_Box * wrapper_arg_2)
{
  ...
  ml_backend__mlds_to_cs_type__IntroducedFrom__pred__generic_args_types_to_string_for_csharp__460__1_3_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) (wrapper_arg_1)), &conv0_LambdaHeadVar__2_17);
  ...
  MR_String * String_6)
{
  ...
  else
  {
...

    {
      ...
      MR_hl_field(MR_mktag(0), ToString_9, 0) = ((MR_Box) (&ml_backend__mlds_to_cs_type_scalar_common_3[1]));
  ...
  MR_Word RetTypes_7)
{
  ...
  NumRets_10 = mercury__list__length_1_f_0((MR_Word) (&ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_type_0), RetTypes_7);
  {
    ...
    MR_hl_field(MR_mktag(0), Var_14, 0) = ((MR_Box) (&ml_backend__mlds_to_cs_type_scalar_common_3[0]));
