...
static void MR_CALL 
ml_backend__mlds_to_cs_type__IntroducedFrom__pred__generic_args_types_to_string_for_csharp__468__1_3_p_0(
  MR_Word Info_4,
  MR_Word LambdaHeadVar__1_16,
  MR_String * LambdaHeadVar__2_17);

static MR_Word MR_CALL 
ml_backend__mlds_to_cs_type__IntroducedFrom__func__type_to_string_for_csharp__215__1_1_f_0(
...
{
  {
    ...
    conv0_LambdaHeadVar__2_45 = ml_backend__mlds_to_cs_type__IntroducedFrom__func__type_to_string_for_csharp__215__1_1_f_0(((MR_Word) (wrapper_arg_1)));
      ...
      case (MR_Integer) 1:
        {
          ...
          MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), ClassId_22, (MR_Integer) 2)));

          ml_backend__mlds_to_cs_name__qual_class_name_to_string_for_csharp_3_p_0(Name_23, Arity_24, String_7);
          *ArrayDims_8 = (MR_Word) ((MR_Unsigned) 0U);
        }
        break;
      case (MR_Integer) 2:
          ...
          case (MR_Integer) 0:
            {
              ...
              succeeded = ml_backend__mlds_to_cs_type__hand_defined_type_for_csharp_4_p_0(Type_9, CtorCat_11, &SubstituteName_12, &ArrayDims0_13);
              if (succeeded)
              {
                ...
                else
                {
                  ...
                  if (succeeded)
                  {
                    ...
                    *ArrayDims_8 = (MR_Word) ((MR_Unsigned) 0U);
                    ...
                    ml_backend__mlds_to_cs_type__mercury_type_to_string_for_csharp_5_p_0(Info_5, Type_9, CtorCat_11, String_7, ArrayDims_8);
                }
              }
            }
            break;
          case (MR_Integer) 1:
            {
              ...
              else
              {
                ...
                succeeded = ml_backend__mlds_to_cs_type__csharp_builtin_type_2_p_0(ElementType_14, &Var_17);
                if (succeeded)
                {
                  MR_Word ArrayDims0_59;

                  ml_backend__mlds_to_cs_type__type_to_string_for_csharp_4_p_0(Info_5, ElementType_14, String_7, &ArrayDims0_59);
                  {
                    MR_Word base;
          ...
          case (MR_Integer) 4:
            {
              ...
              ml_backend__mlds_to_cs_type__type_to_string_for_csharp_4_p_0(Info_5, Type_64, String_7, &ArrayDims0_65);
              {
                MR_Word base;
                base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                *ArrayDims_8 = base;
          ...
          case (MR_Integer) 5:
            {
              ...
              ml_backend__mlds_to_cs_type__type_to_string_for_csharp_4_p_0(Info_5, (MR_Word) ((MR_Unsigned) 24U), String_7, &ArrayDims0_67);
              {
                MR_Word base;
                base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                *ArrayDims_8 = base;
          ...
          case (MR_Integer) 2:
            {
              ...
              if (succeeded)
              {
                packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), CtorCat_8, (MR_Integer) 0)));
              ...
              packed_word_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Info_6, (MR_Integer) 1)));
              packed_word_3 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Info_6, (MR_Integer) 5)));
            ...
            case (MR_Integer) 1:
              {
                ...
                MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), Var_25, (MR_Integer) 0)));
...
{
  {
    ...
    ml_backend__mlds_to_cs_type__IntroducedFrom__pred__generic_args_types_to_string_for_csharp__468__1_3_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) (wrapper_arg_1)), &conv0_LambdaHeadVar__2_17);
...
{
  {
    ...
    if (((((MR_tag((MR_Word) CtorCat_6)) == (MR_Integer) 3)) && ((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), CtorCat_6, (MR_Integer) 0))) == (MR_Integer) 0))))
    {
      ...
      MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), CtorCat_6, (MR_Integer) 1)));
    ...
    if (((((MR_tag((MR_Word) CtorCat_6)) == (MR_Integer) 3)) && ((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), CtorCat_6, (MR_Integer) 0))) == (MR_Integer) 1))))
    {
      ...
      MR_Unsigned packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), CtorCat_6, (MR_Integer) 1)));
      MR_Word Var_17;
          ...
          case (MR_Integer) 0:
            {
              ...
              if (((MR_tag((MR_Word) MerType_5)) == (MR_Integer) 2))
              {
                ...
                switch (MR_tag((MR_Word) BuiltinType_8)) {
                  ...
                  case (MR_Integer) 1:
                    {
                      MR_Word IntType_9 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(1), BuiltinType_8, (MR_Integer) 0))) & (MR_Integer) 15);
                      MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), BuiltinType_8, (MR_Integer) 0)));

                      *TargetType_4 = ml_backend__mlds_to_cs_type__int_type_to_csharp_type_1_f_0(IntType_9);
                      succeeded = MR_TRUE;
                    }
                    break;
                }
