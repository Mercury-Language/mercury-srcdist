  ...
  MR_Word Stream_8)
{
  ...
  ml_backend__mlds_to_cs_type__type_to_string_for_csharp_4_p_0(Info_6, MLDS_Type_7, &String_21, &ArrayDims_22);
  mercury__io__write_string_4_p_0(Stream_8, String_21);
  Var_24 = mercury__list__f_43_43_2_f_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0), ArrayDims_22, (MR_Word) ((MR_Unsigned) 0U));
  ml_backend__mlds_to_target_util__output_array_dimensions_4_p_0(Stream_8, Var_24);
}
