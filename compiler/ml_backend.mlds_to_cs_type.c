...
static void MR_CALL 
ml_backend__mlds_to_cs_type__IntroducedFrom__pred__generic_args_types_to_string_for_csharp__505__1_3_p_0(
  MR_Word Info_4,
  MR_Word LambdaHeadVar__1_16,
  MR_String * LambdaHeadVar__2_17);

static MR_bool MR_CALL 
ml_backend__mlds_to_cs_type__IntroducedFrom__pred__mercury_user_enum_type_to_string_and_dims_for_csharp__484__1_2_p_0(
  MR_Word ArrayDims_15,
  MR_Word HeadVar__2_21);

static MR_bool MR_CALL 
ml_backend__mlds_to_cs_type__IntroducedFrom__pred__mercury_user_type_to_string_and_dims_for_csharp__462__1_2_p_0(
  ...
  MR_Box * wrapper_arg_2)
{
  ...
  ml_backend__mlds_to_cs_type__IntroducedFrom__pred__generic_args_types_to_string_for_csharp__505__1_3_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) (wrapper_arg_1)), &conv0_LambdaHeadVar__2_17);
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = ml_backend__mlds_to_cs_type__IntroducedFrom__pred__mercury_user_enum_type_to_string_and_dims_for_csharp__484__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) ((MR_hl_field(0, closure, 4)))));
  return succeeded;
}
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = ml_backend__mlds_to_cs_type__IntroducedFrom__pred__mercury_user_type_to_string_and_dims_for_csharp__462__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) ((MR_hl_field(0, closure, 4)))));
  return succeeded;
}
