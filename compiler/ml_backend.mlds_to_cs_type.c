          ...
          case (MR_Integer) 2:
            {
                ...
                ClassKind_27 = (MR_Integer) 0;
              {
                ...
                MR_hl_field(MR_mktag(0), ClassId_28, 0) = ((MR_Box) (ClassName_24));
                MR_hl_field(MR_mktag(0), ClassId_28, 1) = ((MR_Box) (ClassArity_25));
                MR_hl_field(MR_mktag(0), ClassId_28, 2) = (MR_Box) ((MR_Unsigned) (ClassKind_27));
              }
              MLDS_Type_29 = (MR_Word) (MR_mkword(MR_mktag(1), (MR_Word) (ClassId_28)));
              ml_backend__mlds_to_cs_type__type_to_string_for_csharp_4_p_0(Info_6, MLDS_Type_29, &TypeString_30, ArrayDims_10);
              OutputGenerics_31 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Info_6, (MR_Integer) 5))) >> 2)) & (MR_Integer) 1);
