...
static void MR_CALL 
ml_backend__mlds_to_cs_type__IntroducedFrom__pred__generic_args_types_to_string_for_csharp__456__1_3_p_0(
  MR_Word Info_4,
      ...
      case (MR_Integer) 0:
        switch (MR_unmkbody(CtorCat_8)) {
          ...
          case (MR_Integer) 2:
            {
              MR_Word TypeCtor_26;
              MR_Word ArgsTypes_27;
              MR_Word ClassName_28;
              MR_Integer ClassArity_29;
              MR_Word ClassKind_31;
              MR_Word ClassId_32;
              MR_Word MLDS_Type_33;
              MR_String TypeString_34;
              MR_Word OutputGenerics_35;

              parse_tree__prog_type__type_to_ctor_and_args_det_3_p_0(Type_7, &TypeCtor_26, &ArgsTypes_27);
              ml_backend__ml_type_gen__ml_gen_type_name_3_p_0(TypeCtor_26, &ClassName_28, &ClassArity_29);
              succeeded = ((MR_tag((MR_Word) CtorCat_8)) == (MR_Integer) 2);
              if (succeeded)
                ClassKind_31 = (MR_Integer) 3;
              else
                ClassKind_31 = (MR_Integer) 0;
              {
                ClassId_32 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
                MR_hl_field(MR_mktag(0), ClassId_32, 0) = ((MR_Box) (ClassName_28));
                MR_hl_field(MR_mktag(0), ClassId_32, 1) = ((MR_Box) (ClassArity_29));
                MR_hl_field(MR_mktag(0), ClassId_32, 2) = (MR_Box) ((MR_Unsigned) (ClassKind_31));
              }
              MLDS_Type_33 = (MR_Word) (MR_mkword(MR_mktag(1), (MR_Word) (ClassId_32)));
              ml_backend__mlds_to_cs_type__type_to_string_for_csharp_4_p_0(Info_6, MLDS_Type_33, &TypeString_34, ArrayDims_10);
              OutputGenerics_35 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Info_6, (MR_Integer) 5))) >> 2)) & (MR_Integer) 1);
              switch (OutputGenerics_35) {
                default: /*NOTREACHED*/ MR_assert(0);
                case (MR_Integer) 1:
                  *String_9 = TypeString_34;
                  break;
                case (MR_Integer) 0:
                  {
                    MR_String GenericsString_36;

                    ml_backend__mlds_to_cs_type__generic_args_types_to_string_for_csharp_3_p_0(Info_6, ArgsTypes_27, &GenericsString_36);
                    *String_9 = mercury__string__f_43_43_2_f_0(TypeString_34, GenericsString_36);
                  }
                  break;
              }
            }
  ...
  MR_Box * wrapper_arg_2)
{
  ...
  ml_backend__mlds_to_cs_type__IntroducedFrom__pred__generic_args_types_to_string_for_csharp__456__1_3_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) (wrapper_arg_1)), &conv0_LambdaHeadVar__2_17);
