  ...
  MR_Box wrapper_arg_1)
{
  ...
  conv0_LambdaHeadVar__2_43 = ml_backend__mlds_to_cs_type__IntroducedFrom__func__type_to_string_for_csharp__212__1_1_f_0(((MR_Word) (wrapper_arg_1)));
      ...
      case (MR_Integer) 2:
        {
          ...
          MR_Word RetTypes_26;
          MR_Word ArgTypes_27;
          MR_Word Var_40 = (MR_Word) (MR_body((MR_Word) (MLDS_Type_6), (MR_Integer) 2));

          Args_25 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_40, (MR_Integer) 0))));
          RetTypes_26 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_40, (MR_Integer) 1))));
          ...
          case (MR_Integer) 1:
            {
              ...
              if (succeeded)
              {
                Var_51 = ((MR_Word) ((MR_hl_field(MR_mktag(3), ElementType_13, (MR_Integer) 2))));
          ...
          case (MR_Integer) 4:
            {
              ...
              switch (MR_tag((MR_Word) ForeignType_17)) {
                ...
                case (MR_Integer) 2:
                  {
                    MR_Word Var_50 = ((MR_Word) ((MR_hl_field(MR_mktag(2), ForeignType_17, (MR_Integer) 0))));

                    *String_7 = (MR_String) (Var_50);
                    *ArrayDims_8 = (MR_Word) ((MR_Unsigned) 0U);
                  }
                  break;
              }
