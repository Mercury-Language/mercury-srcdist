  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_25)
{
  ...
  else
  {
    ...
    else
    {
      ...
      mercury__list__map_3_p_0((MR_Word) (&hlds__hlds_class__hlds__hlds_class__type_ctor_info_method_info_0), (MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_id_0), (MR_Word) (&transform_hlds__intermod_mark_exported_scalar_common_1[7]), MethodInfos_22, &PredIds0_27);
      mercury__list__remove_adjacent_dups_2_p_0((MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_id_0), PredIds0_27, &PredIds_23);
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_13)
{
  ...
  else
  {
    ...
    mercury__list__remove_adjacent_dups_2_p_0((MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_id_0), PredIds0_49, &PredIds_11);
  ...
  MR_Box * wrapper_arg_2)
{
  ...
  succeeded = transform_hlds__intermod_mark_exported__IntroducedFrom__pred__adjust_status_of_special_preds__149__1_4_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) ((MR_hl_field(0, closure, 4)))), ((MR_Word) (wrapper_arg_1)), &conv0_LambdaHeadVar__2_14);
  if (succeeded)
  {
        ...
        case (MR_Integer) 1:
          {
            ...
            mercury__map__det_update_4_p_0((MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_id_0), (MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_info_0), ((MR_Box) (PredId_7)), ((MR_Box) (PredInfo_17)), STATE_VARIABLE_PredIdTable_0_2, &STATE_VARIABLE_PredIdTable_1_27);
          }
          break;
      }
