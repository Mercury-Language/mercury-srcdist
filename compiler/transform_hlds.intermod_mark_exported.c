  ...
  MR_Box * wrapper_arg_2)
{
  ...
  succeeded = transform_hlds__intermod_mark_exported__IntroducedFrom__pred__adjust_status_of_special_preds__150__1_4_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 4)))), ((MR_Word) (wrapper_arg_1)), &conv0_LambdaHeadVar__2_14);
  if (succeeded)
  {
...
void MR_CALL 
transform_hlds__intermod_mark_exported__maybe_opt_export_entities_2_p_0(
  MR_Word STATE_VARIABLE_ModuleInfo_0_9,
  MR_Word * STATE_VARIABLE_ModuleInfo_10)
{
  MR_Word Globals_4;
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_4, (MR_Integer) 73, &VeryVerbose_5);
  ...
  transform_hlds__intermod_decide__decide_what_to_opt_export_2_p_0(STATE_VARIABLE_ModuleInfo_0_9, &IntermodInfo_8);
  transform_hlds__intermod_mark_exported__maybe_opt_export_listed_entities_3_p_0(IntermodInfo_8, STATE_VARIABLE_ModuleInfo_0_9, STATE_VARIABLE_ModuleInfo_10);
