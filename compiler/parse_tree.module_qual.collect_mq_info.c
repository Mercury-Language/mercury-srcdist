        ...
        case (MR_Integer) 1:
          {
            ...
            switch (MR_tag((MR_Word) parse_tree__module_qual__collect_mq_info__HeadVar__3_3)) {
              ...
              case (MR_Integer) 1:
                {
                  MR_Word parse_tree__module_qual__collect_mq_info__Var_9 = ((MR_Word) (MR_hl_field(MR_mktag(1), parse_tree__module_qual__collect_mq_info__HeadVar__3_3, (MR_Integer) 0)));
                  MR_Integer parse_tree__module_qual__collect_mq_info__Var_16 = (MR_Integer) parse_tree__module_qual__collect_mq_info__Var_15;
                  MR_Integer parse_tree__module_qual__collect_mq_info__Var_17 = (MR_Integer) parse_tree__module_qual__collect_mq_info__Var_9;
...
{
  {
    ...
    if (parse_tree__module_qual__collect_mq_info__succeeded)
      ...
      switch (MR_tag((MR_Word) parse_tree__module_qual__collect_mq_info__HeadVar__1_1)) {
        ...
        case (MR_Integer) 1:
          {
            MR_Word parse_tree__module_qual__collect_mq_info__Var_7 = ((MR_Word) (MR_hl_field(MR_mktag(1), parse_tree__module_qual__collect_mq_info__HeadVar__1_1, (MR_Integer) 0)));
            MR_Word parse_tree__module_qual__collect_mq_info__Var_8;
            ...
            if (parse_tree__module_qual__collect_mq_info__succeeded)
              {
                parse_tree__module_qual__collect_mq_info__Var_8 = ((MR_Word) (MR_hl_field(MR_mktag(1), parse_tree__module_qual__collect_mq_info__HeadVar__2_2, (MR_Integer) 0)));
                parse_tree__module_qual__collect_mq_info__succeeded = (parse_tree__module_qual__collect_mq_info__Var_7 == parse_tree__module_qual__collect_mq_info__Var_8);
              }
          }
          break;
      }
