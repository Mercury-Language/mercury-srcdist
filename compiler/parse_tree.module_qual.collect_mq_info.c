          ...
          case (MR_Integer) 0:
            {
              ...
              mercury__set__insert_3_p_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), ((MR_Box) (ModuleName_13)), STATE_VARIABLE_ImportedModules_0_21, STATE_VARIABLE_ImportedModules_22);
              {
                ...
                MR_hl_field(MR_mktag(0), OnlyNewContexts_16, 1) = ((MR_Box) ((MR_Integer) 0));
              }
  ...
  MR_Word * STATE_VARIABLE_Info_4)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      if ((Incls_15 == (MR_Word) ((MR_Integer) 0)))
      ...
      case (MR_Integer) 1:
        {
          ...
          succeeded = (MQSection_6 == (MR_Word) ((MR_Integer) 8));
          if (succeeded)
            *STATE_VARIABLE_Info_70 = STATE_VARIABLE_Info_0_69;
          else
          {
...
{
  {
    ...
    {
      *MQSection_5 = (MR_Word) ((MR_Integer) 8);
      PermInInt_12 = (MR_Word) ((MR_Integer) 0);
...
{
  {
    ...
    switch (SrcSection_4) {
      ...
      case (MR_Integer) 1:
        {
          *MQSection_5 = (MR_Word) ((MR_Integer) 4);
          PermInInt_7 = (MR_Word) ((MR_Integer) 0);
        }
        break;
      case (MR_Integer) 0:
        {
          *MQSection_5 = (MR_Word) ((MR_Integer) 0);
