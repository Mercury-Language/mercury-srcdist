    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        if (((MR_tag((MR_Word) SymName_29)) == (MR_Integer) 1))
        {
          ...
          mercury__set__insert_3_p_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), ((MR_Box) (ModuleName_31)), STATE_VARIABLE_UsedModuleNames_0_2, &STATE_VARIABLE_UsedModuleNames_19_35);
          STATE_VARIABLE_FoundUnqual_18_34 = STATE_VARIABLE_FoundUnqual_0_4;
        }
        else
        {
          STATE_VARIABLE_FoundUnqual_18_34 = (MR_Integer) 1;
          STATE_VARIABLE_UsedModuleNames_19_35 = STATE_VARIABLE_UsedModuleNames_0_2;
        }
        parse_tree__module_qual__collect_mq_info__collect_used_modules_in_terms_5_p_0(ArgTerms_30, STATE_VARIABLE_UsedModuleNames_19_35, &STATE_VARIABLE_UsedModuleNames_20_20, STATE_VARIABLE_FoundUnqual_18_34, &STATE_VARIABLE_FoundUnqual_21_21);
      }
      else
      {
    ...
    case (MR_Integer) 2:
      {
...

        {
          ...
          MR_hl_field(MR_mktag(0), Var_18, 0) = ((MR_Box) (SymName_27));
          MR_hl_field(MR_mktag(0), Var_18, 1) = ((MR_Box) (Arity_28));
        }
