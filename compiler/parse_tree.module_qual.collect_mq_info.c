                ...
                case (MR_Integer) 0:
                  {
                    ...
                    }
                    {
                      ...
                      MR_hl_field(MR_mktag(0), parse_tree__module_qual__collect_mq_info__Var_76, 0) = ((MR_Box) (&parse_tree__module_qual__collect_mq_info_scalar_common_4[1]));
          ...
          *parse_tree__module_qual__collect_mq_info__STATE_VARIABLE_Info_4 = parse_tree__module_qual__collect_mq_info__STATE_VARIABLE_Info_0_3;
        else
          {
            ...
            if ((parse_tree__module_qual__collect_mq_info__Incls_15 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
            ...
            else
              {
                ...
                }
                {
                  ...
                  MR_hl_field(MR_mktag(0), parse_tree__module_qual__collect_mq_info__Var_51, 0) = ((MR_Box) (&parse_tree__module_qual__collect_mq_info_scalar_common_4[0]));
            ...
            }
            {
              ...
              MR_hl_field(MR_mktag(0), parse_tree__module_qual__collect_mq_info__Var_53, 0) = ((MR_Box) (&parse_tree__module_qual__collect_mq_info_scalar_common_5[0]));
