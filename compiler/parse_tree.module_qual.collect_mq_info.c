  ...
  MR_Word * STATE_VARIABLE_FoundUnqual_15)
{
  ...
  succeeded = parse_tree__parse_sym_name__try_parse_sym_name_and_args_3_p_0((MR_Word) (&mercury__term__term__type_ctor_info_generic_0), Pattern_11, &SymName_22, &ArgTerms_23);
  if (succeeded)
  {
    ...
    if (((MR_tag((MR_Word) SymName_22)) == (MR_Integer) 1))
    {
      ...
      mercury__set__insert_3_p_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), ((MR_Box) (ModuleName_24)), STATE_VARIABLE_UsedModuleNames_0_12, &STATE_VARIABLE_UsedModuleNames_19_28);
      STATE_VARIABLE_FoundUnqual_18_27 = STATE_VARIABLE_FoundUnqual_0_14;
    }
    else
    {
      STATE_VARIABLE_FoundUnqual_18_27 = (MR_Integer) 1;
      STATE_VARIABLE_UsedModuleNames_19_28 = STATE_VARIABLE_UsedModuleNames_0_12;
    }
    parse_tree__module_qual__collect_mq_info__collect_used_modules_in_terms_5_p_0(ArgTerms_23, STATE_VARIABLE_UsedModuleNames_19_28, &STATE_VARIABLE_UsedModuleNames_16_16, STATE_VARIABLE_FoundUnqual_18_27, &STATE_VARIABLE_FoundUnqual_17_17);
  }
  else
  {
