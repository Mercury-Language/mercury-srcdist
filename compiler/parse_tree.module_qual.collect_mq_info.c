          ...
          case (MR_Integer) 6:
            {
              ...
              MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Goal_6, (MR_Integer) 1)));
...
{
  {
    ...
    else
    {
      ...
      MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), IntSection_4, (MR_Integer) 1)));
