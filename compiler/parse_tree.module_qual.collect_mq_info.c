      ...
      case (MR_Integer) 2:
        {
          ...
          else
          {
            ...
            mercury__list__length_2_p_0((MR_Word) &parse_tree__module_qual__collect_mq_info_scalar_common_1[3], Params_87, &Arity_84);
          ...
          case (MR_Integer) 0:
            {
              ...
              else
              {
                ...
                mercury__list__length_2_p_0((MR_Word) &parse_tree__module_qual__collect_mq_info_scalar_common_1[3], Params_92, &Arity_89);
                ...
                case (MR_Integer) 1:
                  {
                    ...
                    mercury__map__init_1_p_0(TypeCtorInfo_110_110, (MR_Word) &parse_tree__module_qual__collect_mq_info_scalar_common_1[1], &UnusedModules_45);
          ...
          case (MR_Integer) 5:
            {
              ...
              else
              {
                ...
                mercury__list__length_2_p_0((MR_Word) &parse_tree__module_qual__collect_mq_info_scalar_common_1[2], Params_97, &Arity_94);
