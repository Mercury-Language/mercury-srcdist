...
{
  {
    MR_bool succeeded = ((MR_tag((MR_Word) ArgTerms_10)) == (MR_Integer) 1);
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            succeeded = ((MR_tag((MR_Word) TypeDefnArgTerms_17)) == (MR_Integer) 1);
            if (succeeded)
            {
...
{
  {
    ...
    if (succeeded)
    {
      ...
      succeeded = ((MR_tag((MR_Word) MaybeSolverTypeDetails_12)) == (MR_Integer) 1);
      if (succeeded)
...
{
  {
    ...
    if (succeeded)
    {
      ...
      succeeded = ((MR_tag((MR_Word) Args_19)) == (MR_Integer) 1);
      if (succeeded)
      {
...
{
  {
    ...
    if (succeeded)
    {
      ...
      if (((MR_tag((MR_Word) MaybeItem_9)) == (MR_Integer) 0))
...
{
  {
    ...
    if ((TypeIsAbstractNoncanonical_13 == (MR_Word) ((MR_Integer) 0)))
      switch (IsSolverType_12) {
        ...
        case (MR_Integer) 0:
          {
            succeeded = ((MR_tag((MR_Word) RepresentationIs_14)) == (MR_Integer) 1);
            if (succeeded)
            {
            }
            if (!(succeeded))
            {
              succeeded = ((MR_tag((MR_Word) GroundIs_15)) == (MR_Integer) 1);
              if (succeeded)
              {
              }
              if (!(succeeded))
              {
                succeeded = ((MR_tag((MR_Word) AnyIs_16)) == (MR_Integer) 1);
                if (succeeded)
                {
                }
                if (!(succeeded))
                {
                  succeeded = ((MR_tag((MR_Word) CStoreIs_17)) == (MR_Integer) 1);
                  if (succeeded)
                  {
                  }
                }
        ...
        case (MR_Integer) 1:
          {
            succeeded = ((MR_tag((MR_Word) DirectArgIs_20)) == (MR_Integer) 1);
            if (succeeded)
            {
              {
                MR_Word Var_76;
  ...
  MR_Word * STATE_VARIABLE_Specs_6)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      succeeded = ((MR_tag((MR_Word) NotExistQOrParamVars_36)) == (MR_Integer) 1);
      if (succeeded)
      {
        {
      ...
      else
      {
        ...
        else
        {
          ...
          succeeded = ((MR_tag((MR_Word) NotOccursExistQVars_50)) == (MR_Integer) 1);
          if (succeeded)
          {
            {
          ...
          else
          {
            ...
            succeeded = ((MR_tag((MR_Word) NotExistQArgTypes_57)) == (MR_Integer) 1);
            if (succeeded)
            {
              {
...
{
  {
    ...
    else
    {
      ...
      if (((MR_tag((MR_Word) MaybeFunctorAndArgTerms_38)) == (MR_Integer) 0))
      {
        MR_Word Var_79;
...
{
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          succeeded = ((MR_tag((MR_Word) Args_7)) == (MR_Integer) 1);
          if (succeeded)
          {
