...
parse_tree__parse_type_defn__IntroducedFrom__pred__parse_type_defn_head__1721__1_2_p_0(
  ...
  MR_Word * HeadVar__2_129)
{
  mercury__term__coerce_var_2_p_0((MR_Word) (&mercury__term__term__type_ctor_info_generic_0), (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_tvar_type_0), HeadVar__1_128, HeadVar__2_129);
}
...
{
  MR_Box closure = closure_arg;
  MR_Word conv0_HeadVar__2_129;

  parse_tree__parse_type_defn__IntroducedFrom__pred__parse_type_defn_head__1721__1_2_p_0(((MR_Word) (wrapper_arg_1)), &conv0_HeadVar__2_129);
  *wrapper_arg_2 = ((MR_Box) (conv0_HeadVar__2_129));
}
  ...
  MR_Word * MaybeTypeCtorAndArgs_10)
{
  ...
  if (((MR_tag((MR_Word) Term_9)) == (MR_Integer) 0))
  {
    ...
    MR_Word Context_123 = ((MR_Word) ((MR_hl_field(0, Term_9, (MR_Integer) 2))));
    ...
    else
    {
      ...
      parse_tree__parse_type_defn__check_user_type_name_3_p_0(SymName_20, Context_123, &NameSpecs_22);
      Var_69 = mdbcomp__sym_name__unqualify_name_1_f_0(SymName_20);
      succeeded = (strcmp(Var_69, (MR_String) "=<") == 0);
      if (succeeded)
      {
        Var_70 = (MR_Integer) 2;
        TypeInfo_127_127 = (MR_Word) (&parse_tree__parse_type_defn_scalar_common_1[1]);
        mercury__list__length_2_p_0(TypeInfo_127_127, ArgTerms_21, &Var_135);
        succeeded = (Var_70 == Var_135);
      }
      if (succeeded)
        {
          MR_Word base;
      ...
      else
      {
        ...
        if (((MR_tag((MR_Word) MaybeParamVars_23)) == (MR_Integer) 0))
        {
          ...
          if (succeeded)
          {
            ...
            Var_83 = parse_tree__error_spec__color_as_incorrect_1_f_0((MR_Word) (MR_mkword(1, &parse_tree__parse_type_defn_scalar_common_1[76])));
            ...
            Pieces_107 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), (MR_Word) (MR_mkword(1, &parse_tree__parse_type_defn_scalar_common_1[66])), Var_82);
            {
              Spec_108 = (MR_Word) MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL);
              MR_hl_field(0, Spec_108, 0) = ((MR_Box) ((MR_String) "predicate \140parse_tree.parse_type_defn.parse_type_defn_head\'/5"));
              MR_hl_field(0, Spec_108, 1) = ((MR_Box) ((MR_Unsigned) 0U));
              MR_hl_field(0, Spec_108, 2) = ((MR_Box) ((MR_Unsigned) 24U));
              MR_hl_field(0, Spec_108, 3) = ((MR_Box) (Context_123));
              MR_hl_field(0, Spec_108, 4) = ((MR_Box) (Pieces_107));
            }
            {
              Var_106 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(1, Var_106, 0) = ((MR_Box) (Spec_108));
              MR_hl_field(1, Var_106, 1) = ((MR_Box) (NameSpecs_22));
            }
            {
              MR_Word base;
              base = (MR_Word) MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL);
