    ...
    else
    {
      ...
      else
      {
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(0), Var_79, 0) = ((MR_Box) (Item_74));
        }
        {
          MR_Word base;
          base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
  ...
  if (succeeded)
  {
    ...
    if ((ErrorSpecs_48 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      ...
      if ((RecoverableSpecs_54 == (MR_Word) ((MR_Unsigned) 0U)))
        {
          IOM_64 = (MR_Word) MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), IOM_64, 0) = ((MR_Box) (Item_63));
        }
      else
        {
          IOM_64 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), IOM_64, 0) = ((MR_Box) (Item_63));
          MR_hl_field(MR_mktag(1), IOM_64, 1) = ((MR_Box) (RecoverableSpecs_54));
        }
      {
        MR_Word base;
        base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
