      ...
      case (MR_Integer) 1:
        {
          ...
          Var_80 = mercury__term__get_term_context_1_f_0((MR_Word) (&mercury__term__term__type_ctor_info_generic_0), HeadTerm_13);
          {
            ...
            MR_hl_field(MR_mktag(1), SolverSpec_21, 2) = ((MR_Box) ((MR_Unsigned) 20U));
      ...
      else
      {
        ...
        else
        {
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(1), CanonSpec_55, 2) = ((MR_Box) ((MR_Unsigned) 40U));
        ...
        else
        {
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(1), DirectArgSpec_59, 2) = ((MR_Box) ((MR_Unsigned) 40U));
