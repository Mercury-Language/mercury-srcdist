...
static /* final */ const MR_Box parse_tree__parse_type_defn_scalar_common_5[19][1] = {
  ...
  /* row 17 */
  {
    ((MR_Box) (MR_mkword(MR_mktag(3), &parse_tree__parse_type_defn_scalar_common_5[16])))
  },
  /* row 18 */
  {
...
{
  {
    ...
    parse_tree__parse_type_name__parse_type_5_p_0((MR_Word) (MR_mkword(MR_mktag(1), &parse_tree__parse_type_defn_scalar_common_5[15])), VarSet_10, BodyContextPieces_22, BodyTerm_12, &MaybeType_23);
