  ...
  MR_Word * MaybeMaybeCanonical_8)
{
  ...
  {
    MR_Word EndTerm_14 = ((MR_Word) ((MR_hl_field(1, STATE_VARIABLE_MaybeTerm_35_35, 0))));
  ...
  MR_Word * MaybeWhereDetails_12)
{
  ...
  {
    MR_Word EndTerm_25 = ((MR_Word) ((MR_hl_field(1, STATE_VARIABLE_MaybeTerm_60_60, 0))));
    MR_Word Pieces_26;
    MR_Word EndSpec_27;
    MR_Word Var_68;
    MR_Word Var_69;
  ...
  if (succeeded)
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          STATE_VARIABLE_PredTypeTerm_17_17 = ((MR_Word) ((MR_hl_field(1, Var_16, 0))));
