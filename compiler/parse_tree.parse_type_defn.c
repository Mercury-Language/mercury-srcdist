  ...
  MR_Word * STATE_VARIABLE_Specs_5)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      {
        MR_Word next_value_of_HeadVar__2_2 = DirectArgCtors_13;
        MR_Word next_value_of_STATE_VARIABLE_Specs_0_4 = STATE_VARIABLE_Specs_54_54;
  ...
  MR_Word * STATE_VARIABLE_Specs_6)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      /* direct tailcall eliminated */
      {
        MR_Word next_value_of_HeadVar__4_4 = Ctors_17;
        MR_Word next_value_of_STATE_VARIABLE_Specs_0_5 = STATE_VARIABLE_Specs_86_86;
