...
{
  {
    ...
    if (succeeded)
    {
      ...
      else
      {
        ...
        {
          MaybeItems_6 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
    ...
    else
    {
      ...
      else
      {
        ...
        {
          MaybeItems_6 = (MR_Word) MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL);
    ...
    else
    {
      ...
      if ((ExistQVars_10 == (MR_Word) ((MR_Unsigned) 0U)))
        ...
        else
        {
          ...
          {
            MCSpec_22 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
          ...
          {
            MCSpecs_18 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      ...
      else
      {
        ...
        else
        {
          ...
          if ((MCSpecs_18 == (MR_Word) ((MR_Unsigned) 0U)))
          {
            ...
            {
              Ctor_45 = (MR_Word) MR_new_object(MR_Word, (6 * sizeof(MR_Word)), NULL, NULL);
