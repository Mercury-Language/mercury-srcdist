...
transform_hlds__exception_analysis__IntroducedFrom__func__check_goal_for_exceptions_2__415__1_1_f_0(
  ...
  MR_Word * STATE_VARIABLE_Status_9)
{
  ...
  else
  {
    ...
    TypeCategory_11 = hlds__type_util__classify_type_2_f_0(ModuleInfo_5, Type_6);
  ...
  MR_Box wrapper_arg_1)
{
  ...
  conv0_LambdaHeadVar__2_94 = transform_hlds__exception_analysis__IntroducedFrom__func__check_goal_for_exceptions_2__415__1_1_f_0(((MR_Word) (wrapper_arg_1)));
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_23)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_15, (MR_Integer) 435, &IntermodAnalysis_16);
    ...
    else
    {
      ...
      else
      {
        ...
        if ((env).transform_hlds__exception_analysis__check_goal_for_exceptions_plain_call_9_p_0_env_0__succeeded)
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_29, (MR_Integer) 435, &IntermodAnalysis_30);
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_30)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_13, (MR_Integer) 435, &IntermodAnalysis_14);
  libs__globals__lookup_bool_option_3_p_0(Globals_13, (MR_Integer) 454, &ExceptionAnalysis_15);
