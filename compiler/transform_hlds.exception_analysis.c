  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_23)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_15, (MR_Integer) 410, &IntermodAnalysis_16);
    ...
    else
    {
      ...
      else
      {
        ...
        if ((env).transform_hlds__exception_analysis__check_goal_for_exceptions_plain_call_9_p_0_env_0__succeeded)
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_29, (MR_Integer) 410, &IntermodAnalysis_30);
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_30)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_13, (MR_Integer) 410, &IntermodAnalysis_14);
  libs__globals__lookup_bool_option_3_p_0(Globals_13, (MR_Integer) 429, &ExceptionAnalysis_15);
