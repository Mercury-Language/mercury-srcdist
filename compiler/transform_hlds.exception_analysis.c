          ...
          case (MR_Integer) 1:
            {
              ...
              if (transform_hlds__exception_analysis__succeeded)
                transform_hlds__exception_analysis__V_18_18 = ((MR_Word) (MR_hl_field(MR_mktag(1), transform_hlds__exception_analysis__Status2_7, (MR_Integer) 0)));
            }
            break;
        }
        break;
        ...
        if ((transform_hlds__exception_analysis__HeadVar__3_3 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
          *transform_hlds__exception_analysis__HeadVar__1_1 = (MR_Integer) 2;
        else
          {
            ...
            {
              mercury__builtin__compare_3_p_0((MR_Word) &transform_hlds__exception_analysis_scalar_common_1[6], transform_hlds__exception_analysis__HeadVar__1_1, ((MR_Box) (transform_hlds__exception_analysis__V_11_11)), ((MR_Box) (transform_hlds__exception_analysis__V_7_7)));
            }
          }
      }
  }
    ...
    if (transform_hlds__exception_analysis__succeeded)
      *transform_hlds__exception_analysis__STATE_VARIABLE_Status_9 = (MR_Integer) 1;
    else
      {
        ...
        {
          transform_hlds__exception_analysis__V_17_17 = transform_hlds__exception_analysis__excp_check_type_2_3_f_0(transform_hlds__exception_analysis__ModuleInfo_5, transform_hlds__exception_analysis__Type_6, transform_hlds__exception_analysis__TypeCategory_15);
        }
        switch (transform_hlds__exception_analysis__V_17_17) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 2:
