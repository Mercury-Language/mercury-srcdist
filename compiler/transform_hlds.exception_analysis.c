...
static const MR_FA_PseudoTypeInfo_Struct1 transform_hlds__exception_analysis__set_ordlist__pti_set_ordlist_1__plain_hlds__pred_proc_id__type_ctor_info_pred_proc_id_0;
...
static const MR_FA_TypeInfo_Struct1 transform_hlds__exception_analysis__list__ti_list_1hlds__pred_proc_id__type_ctor_info_pred_proc_id_0;
...
transform_hlds__exception_analysis__IntroducedFrom__func__check_goal_for_exceptions_2__420__1_1_f_0(
...
static /* final */ const MR_Box transform_hlds__exception_analysis_scalar_common_4[3][6] = {
  ...
  /* row   1 */
  {
    ...
    ((MR_Box) (NULL)),
    ((MR_Box) ((MR_Integer) 3)),
    ((MR_Box) (&transform_hlds__exception_analysis__set_ordlist__pti_set_ordlist_1__plain_hlds__pred_proc_id__type_ctor_info_pred_proc_id_0)),
...
static const MR_PseudoTypeInfo transform_hlds__exception_analysis__transform_hlds__exception_analysis__field_types_closures_exception_status_0_1[1] = { (MR_PseudoTypeInfo) (&transform_hlds__exception_analysis__list__ti_list_1hlds__pred_proc_id__type_ctor_info_pred_proc_id_0) };
    ...
    case (MR_Integer) 1:
      {
        ...
        hlds__hlds_proc__proc_info_get_exception_info_2_p_0(ProcInfo_25, &MaybeExceptionInfo_26);
  ...
  MR_Word * STATE_VARIABLE_Status_9)
{
  ...
  else
  {
    ...
    TypeCategory_11 = hlds__type_classify__classify_type_2_f_0(ModuleInfo_5, Type_6);
    ...
    case (MR_Integer) 2:
      {
        ...
        succeeded = hlds__type_util__type_has_user_defined_equality_pred_3_p_0(ModuleInfo_5, Type_6, &_UC_14);
        if (succeeded)
        ...
        case (MR_Integer) 1:
          {
            ...
            succeeded = hlds__type_util__type_has_user_defined_equality_pred_3_p_0(ModuleInfo_5, Type_6, &_UC_17);
            if (succeeded)
              WillThrow_8 = (MR_Integer) 1;
            else
            {
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_28)
{
  ...
  if (succeeded)
  {
    ...
    transform_hlds__mmc_analysis__ppid_to_module_name_func_id_4_p_0(STATE_VARIABLE_ModuleInfo_0_27, PPId_10, &ModuleName_35, &FuncId_36);
  ...
  else
  {
    ...
    hlds__hlds_proc__proc_info_get_exception_info_2_p_0(ProcInfo_15, &MaybeExceptionInfo_19);
  ...
  MR_Box wrapper_arg_1)
{
  ...
  conv0_LambdaHeadVar__2_94 = transform_hlds__exception_analysis__IntroducedFrom__func__check_goal_for_exceptions_2__420__1_1_f_0(((MR_Word) (wrapper_arg_1)));
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_23)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_15, (MR_Integer) 437, &IntermodAnalysis_16);
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_35)
{
...

  {
    ...
    (env).transform_hlds__exception_analysis__check_goal_for_exceptions_plain_call_9_p_0_env_0__succeeded = mercury__set__member_2_p_0((MR_Word) (&hlds__pred_proc_id__hlds__pred_proc_id__type_ctor_info_pred_proc_id_0), ((MR_Box) (CallPPId_17)), SCC_10);
    ...
    {
      (env).transform_hlds__exception_analysis__check_goal_for_exceptions_plain_call_9_p_0_env_0__succeeded = hlds__hlds_pred_tests__pred_info_is_builtin_1_p_0((env).transform_hlds__exception_analysis__check_goal_for_exceptions_plain_call_9_p_0_env_0__CallPredInfo_18);
      if ((env).transform_hlds__exception_analysis__check_goal_for_exceptions_plain_call_9_p_0_env_0__succeeded)
      {
        *STATE_VARIABLE_ModuleInfo_35 = STATE_VARIABLE_ModuleInfo_0_34;
      ...
      else
      {
        ...
        if ((env).transform_hlds__exception_analysis__check_goal_for_exceptions_plain_call_9_p_0_env_0__succeeded)
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_29, (MR_Integer) 437, &IntermodAnalysis_30);
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_30)
{
  ...
  if (succeeded)
  {
    ...
    transform_hlds__mmc_analysis__ppid_to_module_name_func_id_4_p_0(STATE_VARIABLE_ModuleInfo_0_29, PPId_10, &ModuleName_46, &FuncId_47);
  ...
  else
  {
    ...
    hlds__hlds_proc__proc_info_get_exception_info_2_p_0(ProcInfo_22, &MaybeCalleeExceptionInfo_23);
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_12)
{
  ...
  hlds__hlds_proc__proc_info_set_exception_info_3_p_0(Var_13, ProcInfo0_9, &ProcInfo_10);
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_11)
{
...

  {
    ...
    mercury__set__foldl_4_p_0((MR_Word) (&hlds__pred_proc_id__hlds__pred_proc_id__type_ctor_info_pred_proc_id_0), (MR_Word) (&hlds__hlds_module__hlds__hlds_module__type_ctor_info_module_info_0), Var_13, SCC_4, ((MR_Box) (STATE_VARIABLE_ModuleInfo_1_12)), &conv14_STATE_VARIABLE_ModuleInfo_11);
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_30)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_13, (MR_Integer) 437, &IntermodAnalysis_14);
  libs__globals__lookup_bool_option_3_p_0(Globals_13, (MR_Integer) 456, &ExceptionAnalysis_15);
    ...
    case (MR_Integer) 0:
      {
        ...
        hlds__hlds_proc__proc_info_get_exception_info_2_p_0(ProcInfo_11, &MaybeProcExceptionInfo_17);
    ...
    case (MR_Integer) 1:
      {
        ...
        transform_hlds__mmc_analysis__ppid_to_module_name_func_id_4_p_0(STATE_VARIABLE_ModuleInfo_0_29, PPId_5, &ModuleName_21, &FuncId_22);
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_15)
{
  ...
  if (succeeded)
  {
    ...
    mercury__list__foldl_4_p_0((MR_Word) (&hlds__pred_proc_id__hlds__pred_proc_id__type_ctor_info_pred_id_0), (MR_Word) (&analysis__operations__analysis__operations__type_ctor_info_analysis_info_0), Var_23, PredIds_12, ((MR_Box) (AnalysisInfo0_11)), &conv3_AnalysisInfo_13);
