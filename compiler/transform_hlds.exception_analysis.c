...
struct transform_hlds__exception_analysis__check_goal_for_exceptions_plain_call_9_p_0_env_0_s {
  ...
  MR_String transform_hlds__exception_analysis__check_goal_for_exceptions_plain_call_9_p_0_env_0__Var_52;
  MR_Integer transform_hlds__exception_analysis__check_goal_for_exceptions_plain_call_9_p_0_env_0__Var_53;
};
...

  {
    ...
    if ((env).transform_hlds__exception_analysis__check_goal_for_exceptions_plain_call_9_p_0_env_0__succeeded)
    {
      ...
      parse_tree__var_table__lookup_var_types_3_p_0(VarTable_11, CallArgs_14, &Types_19);
      {
        ...
        MR_hl_field(MR_mktag(0), Var_57, 0) = ((MR_Box) (&transform_hlds__exception_analysis_scalar_common_6[2]));
        MR_hl_field(MR_mktag(0), Var_57, 1) = ((MR_Box) (transform_hlds__exception_analysis__check_goal_for_exceptions_plain_call_9_p_0_1));
        MR_hl_field(MR_mktag(0), Var_57, 2) = ((MR_Box) ((MR_Integer) 1));
        MR_hl_field(MR_mktag(0), Var_57, 3) = ((MR_Box) (STATE_VARIABLE_ModuleInfo_0_34));
      }
      mercury__list__foldl_4_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0), (MR_Word) (&transform_hlds__exception_analysis__transform_hlds__exception_analysis__type_ctor_info_type_excp_status_0), Var_57, Types_19, ((MR_Box) ((MR_Integer) 0)), &conv1_TypeStatus_20);
      TypeStatus_20 = ((MR_Word) (conv1_TypeStatus_20));
      Var_44 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_Result_0_32, (MR_Integer) 0))));
      Var_45 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_Result_0_32, (MR_Integer) 1))));
      ...
      Var_46 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_Result_0_32, (MR_Integer) 3))));
    ...
    else
    {
      ...
      else
      {
        ...
        if (!((env).transform_hlds__exception_analysis__check_goal_for_exceptions_plain_call_9_p_0_env_0__succeeded))
        {
          ...
          if ((env).transform_hlds__exception_analysis__check_goal_for_exceptions_plain_call_9_p_0_env_0__succeeded)
          {
            Var_38 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Origin_27, (MR_Integer) 0))));
            (env).transform_hlds__exception_analysis__check_goal_for_exceptions_plain_call_9_p_0_env_0__succeeded = ((MR_tag((MR_Word) Var_38)) == (MR_Integer) 0);
            if ((env).transform_hlds__exception_analysis__check_goal_for_exceptions_plain_call_9_p_0_env_0__succeeded)
            {
              packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Var_38, (MR_Integer) 0)));
              SpecialPredId_43 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Var_38, (MR_Integer) 0))) & (MR_Integer) 3);
              Var_28 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_38, (MR_Integer) 1))));
        ...
        if ((env).transform_hlds__exception_analysis__check_goal_for_exceptions_plain_call_9_p_0_env_0__succeeded)
        {
          ...
          parse_tree__var_table__lookup_var_types_3_p_0(VarTable_11, CallArgs_14, &Types_73);
          {
          ...
          mercury__list__foldl_4_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0), (MR_Word) (&transform_hlds__exception_analysis__transform_hlds__exception_analysis__type_ctor_info_type_excp_status_0), Var_82, Types_73, ((MR_Box) ((MR_Integer) 0)), &conv3_TypeStatus_74);
          TypeStatus_74 = ((MR_Word) (conv3_TypeStatus_74));
