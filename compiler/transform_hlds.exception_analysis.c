...
{
  {
    ...
    transform_hlds__exception_analysis__succeeded = ((((MR_tag((MR_Word) transform_hlds__exception_analysis__OpMode_9)) == (MR_mktag((MR_Integer) 3)))) && (((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), transform_hlds__exception_analysis__OpMode_9, (MR_Integer) 0)))) == (MR_Integer) 1)));
    if (transform_hlds__exception_analysis__succeeded)
      {
        transform_hlds__exception_analysis__V_20_20 = ((MR_Word) (MR_hl_field(MR_mktag(3), transform_hlds__exception_analysis__OpMode_9, (MR_Integer) 1)));
