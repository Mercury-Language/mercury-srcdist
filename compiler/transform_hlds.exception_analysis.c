...
{
  {
    ...
    {
      libs__globals__lookup_bool_option_3_p_0(transform_hlds__exception_analysis__Globals_13, (MR_Integer) 333, &transform_hlds__exception_analysis__IntermodAnalysis_14);
    }
    {
      libs__globals__lookup_bool_option_3_p_0(transform_hlds__exception_analysis__Globals_13, (MR_Integer) 431, &transform_hlds__exception_analysis__ExceptionAnalysis_15);
    }
    {
