...
MR_decl_label8(transform_hlds__exception_analysis__check_goals_for_exceptions_9_0, 33,18,3,5,4,7,8,11)
...
MR_BEGIN_MODULE(transform_hlds__exception_analysis_module20)
	...
	MR_init_label8(transform_hlds__exception_analysis__check_goals_for_exceptions_9_0,33,18,3,5,4,7,8,11)
MR_BEGIN_CODE
...
MR_def_static(transform_hlds__exception_analysis__check_goals_for_exceptions_9_0)
	...
	MR_incr_sp(8);
	MR_sv(8) = (MR_Word) MR_succip;
MR_def_label(transform_hlds__exception_analysis__check_goals_for_exceptions_9_0,33)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r3,0,0)) {
		MR_GOTO_LAB(transform_hlds__exception_analysis__check_goals_for_exceptions_9_0_i3);
	}
MR_def_label(transform_hlds__exception_analysis__check_goals_for_exceptions_9_0,18)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_r4;
	MR_r2 = MR_r5;
	MR_decr_sp_and_return(8);
...
MR_def_label(transform_hlds__exception_analysis__check_goals_for_exceptions_9_0,8)
	...
	MR_GOTO_LAB(transform_hlds__exception_analysis__check_goals_for_exceptions_9_0_i33);
MR_def_label(transform_hlds__exception_analysis__check_goals_for_exceptions_9_0,11)
	...
	if (MR_INT_NE(MR_tempr1,1)) {
		MR_GOTO_LAB(transform_hlds__exception_analysis__check_goals_for_exceptions_9_0_i18);
	}
	MR_succip_word = MR_sv(8);
	MR_GOTO_LAB(transform_hlds__exception_analysis__check_goals_for_exceptions_9_0_i33);
	}
