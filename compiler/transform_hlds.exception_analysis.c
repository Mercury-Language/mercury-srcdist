      ...
      else
      {
        ...
        if (!((env).transform_hlds__exception_analysis__check_goal_for_exceptions_plain_call_9_p_0_env_0__succeeded))
        {
          ...
          if ((env).transform_hlds__exception_analysis__check_goal_for_exceptions_plain_call_9_p_0_env_0__succeeded)
          {
            ...
            (env).transform_hlds__exception_analysis__check_goal_for_exceptions_plain_call_9_p_0_env_0__succeeded = ((MR_tag((MR_Word) Var_38)) == (MR_Integer) 1);
            if ((env).transform_hlds__exception_analysis__check_goal_for_exceptions_plain_call_9_p_0_env_0__succeeded)
            {
              packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), Var_38, (MR_Integer) 0)));
              SpecialPredId_43 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(1), Var_38, (MR_Integer) 0))) & (MR_Integer) 3);
              Var_28 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Var_38, (MR_Integer) 1))));
