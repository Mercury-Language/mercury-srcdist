  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_23)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_15, (MR_Integer) 529, &IntermodAnalysis_16);
          ...
          case (MR_Integer) 6:
            {
              ...
              CurrentStatus_105 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_Result_27_110, 1))));
                      ...
                      case (MR_Integer) 1:
                        {
                          ...
                          CurrentStatus_128 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_Result_27_133, 1))));
                                  ...
                                  case (MR_Integer) 1:
                                    {
                                      ...
                                      CurrentStatus_151 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_Result_27_156, 1))));
            ...
            case (MR_Integer) 6:
              {
                ...
                CurrentStatus_93 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_Result_27_98, 1))));
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_7)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      CurrentStatus_22 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_Result_27_27, 1))));
    ...
    else
    {
      ...
      else
      {
        ...
        if ((env).transform_hlds__exception_analysis__check_goal_for_exceptions_plain_call_9_p_0_env_0__succeeded)
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_29, (MR_Integer) 529, &IntermodAnalysis_30);
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_30)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_13, (MR_Integer) 529, &IntermodAnalysis_14);
  libs__globals__lookup_bool_option_3_p_0(Globals_13, (MR_Integer) 559, &ExceptionAnalysis_15);
