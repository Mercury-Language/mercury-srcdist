...
{
  {
    ...
    {
      libs__globals__lookup_bool_option_3_p_0(transform_hlds__exception_analysis__Globals_8, (MR_Integer) 90, &transform_hlds__exception_analysis__MakeAnalysisReg_9);
    }
