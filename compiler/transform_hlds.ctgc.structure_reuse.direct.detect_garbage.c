  ...
  MR_Word * DeadCellTable_12)
{
  ...
  hlds__hlds_module__module_info_get_globals_2_p_0(ModuleInfo_7, &Globals_32);
  libs__globals__lookup_bool_option_3_p_0(Globals_32, (MR_Integer) 72, &VeryVerbose_33);
  {
    ...
    MR_hl_field(MR_mktag(0), Background_13, 4) = (MR_Box) ((MR_Unsigned) (VeryVerbose_33));
  }
  ...
  MR_Box wrapper_arg_1)
{
  ...
  conv4_LambdaHeadVar__2_80 = transform_hlds__ctgc__structure_reuse__direct__detect_garbage__IntroducedFrom__func__determine_dead_deconstructions_2__141__1_1_f_0(((MR_Word) (wrapper_arg_1)));
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                LiveData_54 = transform_hlds__ctgc__livedata__livedata_init_at_goal_4_f_0(ModuleInfo_9, VarTable_27, GoalInfo_11, Sharing_14);
                ...
                transform_hlds__ctgc__livedata__nodes_are_not_live_5_p_0(ModuleInfo_9, VarTable_27, Var_58, LiveData_54, &NotLive_55);
    ...
    case (MR_Integer) 1:
      {
        ...
        hlds__hlds_pred__proc_info_get_var_table_3_p_0(ModuleInfo_9, ProcInfo_10, &CallerVarTable_24);
