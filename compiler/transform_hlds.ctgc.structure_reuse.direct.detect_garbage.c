          ...
          case (MR_Integer) 0:
            {
              ...
              switch (MR_tag((MR_Word) GenDetails_25)) {
                ...
                case (MR_Integer) 1:
                  {
                    ...
                    {
                      MR_Word Context_145;
                      MR_String ContextStr_146;
                      MR_Word Var_147;
                      MR_String Var_148;
                      MR_String Var_150;

                      Context_145 = hlds__hlds_goal__goal_info_get_context_1_f_0(GoalInfo_12);
                      ContextStr_146 = parse_tree__parse_tree_out_misc__context_to_string_1_f_0(Context_145);
                      Var_150 = mercury__string__f_43_43_2_f_0(ContextStr_146, (MR_String) ")");
                ...
                case (MR_Integer) 3:
                  {
                    MR_Word Context_138;
                    MR_String ContextStr_139;
                    MR_Word Var_140;
                    MR_String Var_141;
                    MR_String Var_143;

                    Context_138 = hlds__hlds_goal__goal_info_get_context_1_f_0(GoalInfo_12);
                    ContextStr_139 = parse_tree__parse_tree_out_misc__context_to_string_1_f_0(Context_138);
                    Var_143 = mercury__string__f_43_43_2_f_0(ContextStr_139, (MR_String) ")");
