...
MR_decl_label4(__Unify___transform_hlds__ctgc__structure_reuse__direct__detect_garbage__detect_bg_info_0_0, 2,4,6,1)
MR_decl_label4(__Compare___transform_hlds__ctgc__structure_reuse__direct__detect_garbage__detect_bg_info_0_0, 3,7,11,17)
...
MR_BEGIN_MODULE(transform_hlds__ctgc__structure_reuse__direct__detect_garbage_module6)
	...
	MR_init_label4(__Unify___transform_hlds__ctgc__structure_reuse__direct__detect_garbage__detect_bg_info_0_0,2,4,6,1)
MR_BEGIN_CODE
...
MR_def_static(__Unify___transform_hlds__ctgc__structure_reuse__direct__detect_garbage__detect_bg_info_0_0)
	...
	MR_np_call_localret_ent(__Unify___hlds__hlds_module__module_info_0_0,
		__Unify___transform_hlds__ctgc__structure_reuse__direct__detect_garbage__detect_bg_info_0_0_i2);
MR_def_label(__Unify___transform_hlds__ctgc__structure_reuse__direct__detect_garbage__detect_bg_info_0_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
...
MR_BEGIN_MODULE(transform_hlds__ctgc__structure_reuse__direct__detect_garbage_module7)
	...
	MR_init_label4(__Compare___transform_hlds__ctgc__structure_reuse__direct__detect_garbage__detect_bg_info_0_0,3,7,11,17)
MR_BEGIN_CODE
...
MR_def_static(__Compare___transform_hlds__ctgc__structure_reuse__direct__detect_garbage__detect_bg_info_0_0)
	...
	MR_np_call_localret_ent(__Compare___hlds__hlds_module__module_info_0_0,
		__Compare___transform_hlds__ctgc__structure_reuse__direct__detect_garbage__detect_bg_info_0_0_i3);
MR_def_label(__Compare___transform_hlds__ctgc__structure_reuse__direct__detect_garbage__detect_bg_info_0_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___transform_hlds__ctgc__structure_reuse__direct__detect_garbage__detect_bg_info_0_0_i17);
	}
	MR_r1 = MR_sv(1);
	MR_r2 = MR_sv(4);
	MR_np_call_localret_ent(__Compare___hlds__hlds_pred__pred_info_0_0,
		__Compare___transform_hlds__ctgc__structure_reuse__direct__detect_garbage__detect_bg_info_0_0_i7);
MR_def_label(__Compare___transform_hlds__ctgc__structure_reuse__direct__detect_garbage__detect_bg_info_0_0,7)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___transform_hlds__ctgc__structure_reuse__direct__detect_garbage__detect_bg_info_0_0_i17);
	}
	...
	MR_np_call_localret_ent(__Compare___hlds__hlds_pred__proc_info_0_0,
		__Compare___transform_hlds__ctgc__structure_reuse__direct__detect_garbage__detect_bg_info_0_0_i11);
MR_def_label(__Compare___transform_hlds__ctgc__structure_reuse__direct__detect_garbage__detect_bg_info_0_0,11)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___transform_hlds__ctgc__structure_reuse__direct__detect_garbage__detect_bg_info_0_0_i17);
	}
...
void mercury__transform_hlds__ctgc__structure_reuse__direct__detect_garbage__write_out_proc_statics(FILE *fp);
#endif
