...
{
  {
    ...
    {
      libs__globals__lookup_bool_option_3_p_0(transform_hlds__ctgc__structure_reuse__direct__detect_garbage__Globals_30, (MR_Integer) 49, &transform_hlds__ctgc__structure_reuse__direct__detect_garbage__VeryVerbose_31);
    }
    {
