  ...
  MR_Word * DeadCellTable_12)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_32, (MR_Integer) 71, &VeryVerbose_33);
  {
    ...
    case (MR_Integer) 1:
      {
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            ...
            hlds__vartypes__lookup_var_type_3_p_0(VarTypes_28, Var_16, &Type_29);
            ...
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                ...
                succeeded = (NotLive_56 != (MR_Word) ((MR_Unsigned) 0U));
                if (succeeded)
                {
    ...
    case (MR_Integer) 1:
      {
        ...
        hlds__vartypes__lookup_var_types_3_p_0(CallerVarTypes_25, CallArgs_12, &ActualTypes_26);
