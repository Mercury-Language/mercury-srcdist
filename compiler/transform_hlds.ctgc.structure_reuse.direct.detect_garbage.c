...
{
  {
    ...
    packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Background_8, (MR_Integer) 4)));
...
{
  {
    ...
    MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Background_7, (MR_Integer) 4)));
...
{
  {
    ...
    packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Background_13, (MR_Integer) 4)));
      ...
      case (MR_Integer) 2:
        {
          ...
          MR_Unsigned packed_args_3 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), GoalExpr_11, (MR_Integer) 3)));
          ...
          case (MR_Integer) 0:
            {
              ...
              MR_Unsigned packed_args_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), GoalExpr_11, (MR_Integer) 5)));
          ...
          case (MR_Integer) 2:
            {
              ...
              MR_Word Var_88;
              MR_Unsigned packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), GoalExpr_11, (MR_Integer) 1)));
          ...
          case (MR_Integer) 4:
            {
              ...
              MR_Word Var_75;
              MR_Unsigned packed_args_5 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), GoalExpr_11, (MR_Integer) 2)));
          ...
          case (MR_Integer) 5:
            {
              ...
              succeeded = ((((MR_tag((MR_Word) Reason_41)) == (MR_Integer) 3)) && ((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), Reason_41, (MR_Integer) 0))) == (MR_Integer) 6)));
              if (succeeded)
              {
                packed_args_4 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Reason_41, (MR_Integer) 2)));
      ...
      case (MR_Integer) 1:
        {
          ...
          MR_Word LFU_22;
          MR_Word LBU_23;
          MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), Unification_12, (MR_Integer) 4)));
          MR_Integer Arity_25;
          MR_Word VarTypes_27;
          MR_Word Type_28;
          MR_Word LiveData_54;
            ...
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                ...
                if (succeeded)
                {
                  ...
                  succeeded = ((MR_tag((MR_Word) NotLive_55)) == (MR_Integer) 1);
                  if (succeeded)
                  {
