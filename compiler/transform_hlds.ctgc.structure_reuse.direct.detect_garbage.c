...
{
  {
    ...
    MR_Word Var_109 = ((MR_Word) (MR_hl_field(MR_mktag(0), LambdaHeadVar__1_79, (MR_Integer) 0)));
    MR_Word Var_110 = ((MR_Word) (MR_hl_field(MR_mktag(0), LambdaHeadVar__1_79, (MR_Integer) 1)));
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_30, (MR_Integer) 60, &VeryVerbose_31);
    {
  ...
  MR_Word * STATE_VARIABLE_DeadCellTable_64)
{
  while (MR_TRUE)
  {
    ...
    MR_Word Var_96 = ((MR_Word) (MR_hl_field(MR_mktag(0), Background_7, (MR_Integer) 4)));
          ...
          case (MR_Integer) 5:
            {
              ...
              if (succeeded)
              {
                ...
                Var_72 = ((MR_Word) (MR_hl_field(MR_mktag(3), Reason_41, (MR_Integer) 2)));
            ...
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                ...
                if (succeeded)
                {
                  ...
                  succeeded = ((MR_tag((MR_Word) NotLive_55)) == (MR_mktag((MR_Integer) 1)));
                  if (succeeded)
                  {
