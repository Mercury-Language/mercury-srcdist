              ...
              case (MR_Integer) 2:
                {
...

                  {
                    ...
                    MR_hl_field(MR_mktag(0), transform_hlds__ctgc__structure_reuse__direct__detect_garbage__Var_89, 0) = ((MR_Box) (&transform_hlds__ctgc__structure_reuse__direct__detect_garbage_scalar_common_3[0]));
...
{
  {
...

    {
      ...
      MR_hl_field(MR_mktag(0), transform_hlds__ctgc__structure_reuse__direct__detect_garbage__Var_15, 0) = ((MR_Box) (&transform_hlds__ctgc__structure_reuse__direct__detect_garbage_scalar_common_2[0]));
