        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                LiveData_48 = transform_hlds__ctgc__livedata__livedata_init_at_goal_4_f_0(ModuleInfo_9, VarTable_27, GoalInfo_11, Sharing_14);
                Var_53 = transform_hlds__ctgc__datastruct__datastruct_init_1_f_0(Var_16);
                ...
                transform_hlds__ctgc__livedata__nodes_are_not_live_5_p_0(ModuleInfo_9, VarTable_27, Var_52, LiveData_48, &NotLive_49);
                succeeded = (NotLive_49 != (MR_Word) ((MR_Unsigned) 0U));
                if (succeeded)
                {
                  Var_58 = ((MR_Word) ((MR_hl_field(MR_mktag(1), NotLive_49, (MR_Integer) 0))));
