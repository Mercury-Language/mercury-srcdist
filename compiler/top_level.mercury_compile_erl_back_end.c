...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 61, &Verbose_12);
    libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 71, &Stats_13);
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_40, (MR_Integer) 303, &NewTypeClassRtti_43);
