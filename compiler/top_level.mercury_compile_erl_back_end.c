...
{
  {
    ...
    {
      libs__globals__lookup_bool_option_3_p_0(top_level__mercury_compile_erl_back_end__Globals_40, (MR_Integer) 287, &top_level__mercury_compile_erl_back_end__NewTypeClassRtti_43);
    }
    {
