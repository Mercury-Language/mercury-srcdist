...
static const MR_FA_TypeInfo_Struct2 transform_hlds__unused_args_base_ops__tree234__ti_tree234_2hlds__hlds_pred__type_ctor_info_pred_proc_id_0tree234__ti_tree234_2term__ti_var_1parse_tree__prog_data__type_ctor_info_prog_var_type_0transform_hlds__unused_args_base_ops__type_ctor_info_required_by_0;
...
transform_hlds__unused_args_base_ops__write_var_requiring_vars_8_p_0(
  ...
  MR_Word STATE_VARIABLE_RevNoDependVars_0_26,
  MR_Word * STATE_VARIABLE_RevNoDependVars_27);
...
const MR_TypeCtorInfo_Struct transform_hlds__unused_args_base_ops__transform_hlds__unused_args_base_ops__type_ctor_info_global_var_usage_map_0 = {
  ...
  { NULL },
  { (MR_PseudoTypeInfo) (&transform_hlds__unused_args_base_ops__tree234__ti_tree234_2hlds__hlds_pred__type_ctor_info_pred_proc_id_0tree234__ti_tree234_2term__ti_var_1parse_tree__prog_data__type_ctor_info_prog_var_type_0transform_hlds__unused_args_base_ops__type_ctor_info_required_by_0) },
  (MR_Integer) -1,
  UINT16_C(0),
  NULL,
  ...
  if (succeeded)
    {
      ...
      *STATE_VARIABLE_RevNoDependVars_27 = base;
      MR_hl_field(1, base, 0) = ((MR_Box) (Var_12));
      MR_hl_field(1, base, 1) = ((MR_Box) (STATE_VARIABLE_RevNoDependVars_0_26));
    }
  else
  {
    MR_String VarStr_20;
    ...
    *STATE_VARIABLE_RevNoDependVars_27 = STATE_VARIABLE_RevNoDependVars_0_26;
  }
}
...
{
  MR_Box closure = closure_arg;
  MR_Word conv0_STATE_VARIABLE_RevNoDependVars_27;

  transform_hlds__unused_args_base_ops__write_var_requiring_vars_8_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) ((MR_hl_field(0, closure, 4)))), ((MR_Word) ((MR_hl_field(0, closure, 5)))), ((MR_Word) (wrapper_arg_1)), ((MR_Word) (wrapper_arg_2)), &conv0_STATE_VARIABLE_RevNoDependVars_27);
  *wrapper_arg_3 = ((MR_Box) (conv0_STATE_VARIABLE_RevNoDependVars_27));
}
  ...
  MR_Word LocalVarUsageMap_10)
{
  ...
  MR_Word ProcInfo_14;
  MR_Word VarTable_15;
  MR_Word RevNoDependVars_16;
  MR_Word NoDependVars_17;
  MR_Word Var_28;
  MR_Box conv2_RevNoDependVars_16;
  ...
  hlds__hlds_pred__proc_info_get_var_table_2_p_0(ProcInfo_14, &VarTable_15);
  {
  ...
  mercury__list__foldl2_6_p_2((MR_Word) (&transform_hlds__unused_args_base_ops_scalar_common_2[1]), (MR_Word) (&transform_hlds__unused_args_base_ops_scalar_common_1[1]), (MR_Word) (&mercury__io__io__type_ctor_info_state_0), Var_28, LocalVarUsages_13, ((MR_Box) ((MR_Unsigned) 0U)), &conv2_RevNoDependVars_16, ((MR_Box) ((MR_Integer) 0)), &conv1_STATE_VARIABLE_IO_2_30);
  RevNoDependVars_16 = ((MR_Word) (conv2_RevNoDependVars_16));
  mercury__list__reverse_2_p_0((MR_Word) (&transform_hlds__unused_args_base_ops_scalar_common_1[0]), RevNoDependVars_16, &NoDependVars_17);
  if (!((NoDependVars_17 == (MR_Word) ((MR_Unsigned) 0U))))
  {
    MR_String NoDependVarsStr_20;

    NoDependVarsStr_20 = parse_tree__parse_tree_out_term__mercury_vars_to_string_3_f_0(VarTable_15, (MR_Integer) 1, NoDependVars_17);
    mercury__io__write_string_4_p_0(Stream_7, (MR_String) "nodepend vars: ");
    mercury__io__write_string_4_p_0(Stream_7, NoDependVarsStr_20);
    mercury__io__write_string_4_p_0(Stream_7, (MR_String) "\n");
  }
}
  ...
  MR_Word GlobalVarUsageMap_8)
{
  ...
  mercury__map__foldl_4_p_2((MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_proc_id_0), (MR_Word) (&transform_hlds__unused_args_base_ops_scalar_common_2[0]), (MR_Word) (&mercury__io__io__type_ctor_info_state_0), Var_12, GlobalVarUsageMap_8, ((MR_Box) ((MR_Integer) 0)), &conv0_STATE_VARIABLE_IO_11);
}
  ...
  MR_Word Var_6)
{
  ...
  succeeded = mercury__map__search_3_p_0((MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_proc_id_0), (MR_Word) (&transform_hlds__unused_args_base_ops_scalar_common_2[0]), GlobalVarUsageMap_4, ((MR_Box) (PredProcId_5)), &conv0_LocalVarUsageMap_7);
  if (succeeded)
  {
