...
{
  {
    ...
    libs__globals__set_option_4_p_0((MR_Integer) 25, (MR_Word) (MR_mkword(MR_mktag(1), &check_hlds__det_report_scalar_common_3[0])), STATE_VARIABLE_Globals_0_8, &STATE_VARIABLE_Globals_14_14);
    libs__globals__set_option_4_p_0((MR_Integer) 9, (MR_Word) (MR_mkword(MR_mktag(1), &check_hlds__det_report_scalar_common_3[0])), STATE_VARIABLE_Globals_14_14, STATE_VARIABLE_Globals_9);
    {
