  ...
  MR_Word * STATE_VARIABLE_Specs_23)
{
  ...
  succeeded = hlds__hlds_pred__marker_is_present_2_p_0(Markers_45, (MR_Integer) 26);
  if (succeeded)
  {
    hlds__hlds_module__module_info_get_globals_2_p_0(STATE_VARIABLE_ModuleInfo_34_34, &Globals_46);
    Var_55 = (MR_Integer) 56;
    Var_56 = (MR_Integer) 1;
  ...
  {
    succeeded = hlds__hlds_pred__marker_is_present_2_p_0(Markers_45, (MR_Integer) 25);
    if (succeeded)
    {
