          ...
          case (MR_Integer) 6:
            {
              ...
              check_hlds__det_report__reqscope_check_goal_7_p_0(Cond_29, InstMap0_9, IIS_10, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), SwitchContexts_12, STATE_VARIABLE_DetInfo_0_87, &STATE_VARIABLE_DetInfo_104_104);
              hlds__goal_util__update_instmap_3_p_0(Cond_29, InstMap0_9, &InstMap1_32);
              check_hlds__det_report__reqscope_check_goal_7_p_0(Then_30, InstMap1_32, IIS_10, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), SwitchContexts_12, STATE_VARIABLE_DetInfo_104_104, &STATE_VARIABLE_DetInfo_106_106);
              // direct tailcall eliminated
                ...
                case (MR_Integer) 1:
                  {
                    ...
                    check_hlds__det_report__reqscope_check_goal_7_p_0(MainGoal_41, InstMap0_9, IIS_10, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), SwitchContexts_12, STATE_VARIABLE_DetInfo_0_87, &STATE_VARIABLE_DetInfo_97_97);
    ...
    switch (MR_tag((MR_Word) Reason_10)) {
      ...
      case (MR_Integer) 3:
        switch (((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), Reason_10, (MR_Integer) 0)))) {
          ...
          case (MR_Integer) 3:
            {
              MR_Word RequiredDetism_65 = ((MR_Word) (MR_hl_field(MR_mktag(3), Reason_10, (MR_Integer) 2)));
        ...
        case (MR_Integer) 0:
          {
            ...
            if (succeeded)
            {
              ...
              Context_236 = hlds__hlds_goal__goal_info_get_context_1_f_0(GoalInfo_11);
              {
                ...
                MR_hl_field(MR_mktag(0), Var_129, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &check_hlds__det_report_scalar_common_2[111])));
              }
              {
            ...
            else
            {
              ...
              if (succeeded)
              {
                ...
                Context_238 = hlds__hlds_goal__goal_info_get_context_1_f_0(GoalInfo_11);
                {
                  ...
                  MR_hl_field(MR_mktag(0), Var_139, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &check_hlds__det_report_scalar_common_2[112])));
                }
                {
                  Msgs_17 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
            ...
            case (MR_Integer) 0:
              {
                ...
                Var_170 = hlds__hlds_out__hlds_out_util__generic_call_id_to_string_1_f_0(GenericCallId_58);
                {
                  ...
                  MR_hl_field(MR_mktag(3), Var_169, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 5));
                  MR_hl_field(MR_mktag(3), Var_169, 1) = ((MR_Box) (Var_170));
                }
                {
                  StartingPieces_232 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                  MR_hl_field(MR_mktag(1), StartingPieces_232, 0) = ((MR_Box) (Var_169));
                  MR_hl_field(MR_mktag(1), StartingPieces_232, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
                }
            ...
            case (MR_Integer) 1:
              {
                ...
                }
                {
                  ...
                  MR_hl_field(MR_mktag(1), Var_151, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &check_hlds__det_report_scalar_common_2[110])));
            ...
            case (MR_Integer) 4:
              {
                ...
                if (succeeded)
                {
                  ...
                  if ((MaybeMissingInfo_33 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
                  {
                    ...
                    {
                      Var_180 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
                    ...
                    }
                    {
                      ...
                      MR_hl_field(MR_mktag(1), Var_176, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &check_hlds__det_report_scalar_common_2[87])));
                      MR_hl_field(MR_mktag(1), Var_176, 1) = ((MR_Box) (Var_179));
                    }
                    {
                      NoCoverPieces_222 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                      MR_hl_field(MR_mktag(1), NoCoverPieces_222, 0) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
                  ...
                  else
                  {
                    ...
                    {
                      Var_193 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
                    ...
                    }
                    {
                      ...
                      MR_hl_field(MR_mktag(1), Var_192, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &check_hlds__det_report_scalar_common_2[89])));
                    }
                    {
                      Var_189 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                      MR_hl_field(MR_mktag(1), Var_189, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &check_hlds__det_report_scalar_common_2[87])));
                  ...
                  {
                    Msgs1_227 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(MR_mktag(1), Msgs1_227, 0) = ((MR_Box) (Var_199));
                    MR_hl_field(MR_mktag(1), Msgs1_227, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
                  }
                }
                else
                  Msgs1_227 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
            ...
            case (MR_Integer) 6:
              {
                ...
                TypeCtorInfo_256_256 = (MR_Word) &parse_tree__error_util__parse_tree__error_util__type_ctor_info_error_msg_0;
                Var_148 = mercury__list__f_43_43_2_f_0(TypeCtorInfo_256_256, MsgsThen_87, MsgsElse_88);
                Msgs_17 = mercury__list__f_43_43_2_f_0(TypeCtorInfo_256_256, MsgsCond_85, Var_148);
              }
              break;
            case (MR_Integer) 7:
              {
