    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        hlds__hlds_pred__proc_info_get_context_2_p_0(ProcInfo_17, &ProcContext_35);
        {
          ...
          MR_hl_field(MR_mktag(1), Spec_37, 2) = ((MR_Box) ((MR_Unsigned) 48U));
    ...
    (env).check_hlds__det_report__check_for_multisoln_func_6_p_0_env_0__ModuleInfo_10 = ModuleInfo_10;
    {
      ...
      if ((env).check_hlds__det_report__check_for_multisoln_func_6_p_0_env_0__succeeded)
      {
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(0), Spec_26, 2) = ((MR_Box) ((MR_Unsigned) 48U));
...
{
  {
        ...
        case (MR_Integer) 0:
          {
            ...
            Var_67 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_error_msg_0), ReportMsgs_150, Var_68);
            {
              ...
              MR_hl_field(MR_mktag(0), ReportSpec_151, 2) = ((MR_Box) ((MR_Unsigned) 48U));
        ...
        case (MR_Integer) 2:
          {
            ...
            if (succeeded)
            {
              ...
              check_hlds__det_report__report_determinism_problem_6_p_0(PredProcId_8, STATE_VARIABLE_ModuleInfo_0_45, MessagePieces_23, DeclaredDetism_15, InferredDetism_14, &ReportMsgs_24);
              {
                ...
                MR_hl_field(MR_mktag(0), ReportSpec_25, 2) = ((MR_Box) ((MR_Unsigned) 48U));
    ...
    if (succeeded)
    {
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(0), ValidSpec_44, 2) = ((MR_Box) ((MR_Unsigned) 48U));
...
{
  {
    ...
    else
    {
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(0), Spec_35, 2) = ((MR_Box) ((MR_Unsigned) 48U));
