  ...
  MR_Word * AllPieces_16)
{
  ...
  if (succeeded)
  {
    ...
    else
    {
      ...
      RHSStr_28 = hlds__hlds_out__hlds_out_goal__unify_rhs_to_string_4_f_0(ModuleInfo_21, VarSet_19, (MR_Integer) 0, RHS_15);
      {
        ...
        MR_hl_field(MR_mktag(3), Var_41, 1) = ((MR_Box) (StartWords_22));
      }
      Var_47 = parse_tree__error_util__add_quotes_1_f_0(LHSVarName_24);
      {
        Var_46 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(3), Var_46, 0) = ((MR_Box) ((MR_Unsigned) 5U));
        MR_hl_field(MR_mktag(3), Var_46, 1) = ((MR_Box) (Var_47));
      }
      Var_53 = parse_tree__error_util__add_quotes_1_f_0(RHSStr_28);
      {
        Var_52 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      ...
      {
        Var_42 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), Var_42, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &check_hlds__det_report_scalar_common_2[183])));
        MR_hl_field(MR_mktag(1), Var_42, 1) = ((MR_Box) (Var_45));
      }
      {
        Pieces_27 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), Pieces_27, 0) = ((MR_Box) (Var_41));
        MR_hl_field(MR_mktag(1), Pieces_27, 1) = ((MR_Box) (Var_42));
      }
    }
  }
  else
  {
    ...
    RHSStr_64 = hlds__hlds_out__hlds_out_goal__unify_rhs_to_string_4_f_0(ModuleInfo_21, VarSet_19, (MR_Integer) 0, RHS_15);
    {
      Var_56 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(3), Var_56, 0) = ((MR_Box) ((MR_Unsigned) 5U));
      MR_hl_field(MR_mktag(3), Var_56, 1) = ((MR_Box) (StartWords_22));
    }
    Var_62 = parse_tree__error_util__add_quotes_1_f_0(RHSStr_64);
    {
    ...
    {
      Var_57 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), Var_57, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &check_hlds__det_report_scalar_common_2[182])));
      MR_hl_field(MR_mktag(1), Var_57, 1) = ((MR_Box) (Var_60));
    }
    {
      Pieces_27 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), Pieces_27, 0) = ((MR_Box) (Var_56));
  ...
  MR_Word * MaybeMissingInfo_18)
{
  ...
  *VarStr_17 = parse_tree__parse_tree_out_term__mercury_var_to_name_only_2_f_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), VarSet_19, Var_14);
  ...
  hlds__vartypes__lookup_var_type_3_p_0(VarTypes_22, Var_14, &VarType_23);
  ...
  MR_Word * HeadVar__3_3)
{
  ...
  else
  {
    ...
    MainMatchStr_15 = hlds__hlds_out__hlds_out_util__cons_id_and_vars_or_arity_to_string_4_f_0(VarSet_10, (MR_Integer) 1, ConsId_50, MaybeArgVars_51);
    {
