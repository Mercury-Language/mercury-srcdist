    ...
    (env).check_hlds__det_report__check_for_multisoln_func_6_p_0_env_0__ModuleInfo_10 = ModuleInfo_10;
    {
      ...
      if ((env).check_hlds__det_report__check_for_multisoln_func_6_p_0_env_0__succeeded)
      {
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(1), Var_59, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &check_hlds__det_report_scalar_common_2[179])));
        }
        {
          Var_58 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        ...
        case (MR_Integer) 0:
          {
            ...
            }
            {
              ...
              MR_hl_field(MR_mktag(1), MessagePieces_148, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &check_hlds__det_report_scalar_common_2[168])));
      ...
      case (MR_Integer) 0:
        {
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(1), Var_100, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &check_hlds__det_report_scalar_common_2[172])));
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(1), Var_97, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &check_hlds__det_report_scalar_common_2[171])));
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(1), Var_117, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &check_hlds__det_report_scalar_common_2[174])));
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(1), Var_114, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &check_hlds__det_report_scalar_common_2[173])));
...
{
  {
    ...
    else
    {
      ...
      check_hlds__det_report__det_diagnose_goal_7_p_0(Goal_8, InstMap0_10, RequiredDetism_7, (MR_Word) ((MR_Unsigned) 0U), STATE_VARIABLE_DetInfo_0_36, &STATE_VARIABLE_DetInfo_100_100, &SubMsgs_34);
      {
        ...
        MR_hl_field(MR_mktag(1), Var_104, 0) = ((MR_Box) (Msg_33));
        MR_hl_field(MR_mktag(1), Var_104, 1) = ((MR_Box) (SubMsgs_34));
      }
      {
        ...
        MR_hl_field(MR_mktag(0), Spec_35, 3) = ((MR_Box) (Var_104));
      }
