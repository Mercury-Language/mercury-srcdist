  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        TypeCtorInfo_58_58 = (MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0;
        ArgVarsSet_33 = parse_tree__set_of_var__list_to_set_1_f_0(TypeCtorInfo_58_58, ArgVars_28);
        parse_tree__set_of_var__intersect_3_p_0(TypeCtorInfo_58_58, NonLocals_32, ArgVarsSet_33, &NonLocalArgVarsSet_34);
        succeeded = parse_tree__set_of_var__is_non_empty_1_p_0(TypeCtorInfo_58_58, NonLocalArgVarsSet_34);
        if (succeeded)
          {
      ...
      else
      {
        ...
        else
        {
          ...
          if (succeeded)
          {
            ...
            succeeded = ((MR_tag((MR_Word) Unification_49)) == (MR_mktag((MR_Integer) 2)));
            if (succeeded)
            {
          ...
          if (succeeded)
            {
              STATE_VARIABLE_SwitchVarSynonyms_48_48 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
