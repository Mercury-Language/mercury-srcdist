        ...
        case (MR_Integer) 0:
          {
            ...
            if (succeeded)
            {
              ...
              {
                Msgs_17 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(1), Msgs_17, 0) = ((MR_Box) (Var_130));
                MR_hl_field(MR_mktag(1), Msgs_17, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
              }
            }
            else
            {
              ...
              if (succeeded)
              {
                ...
                {
                  Msgs_17 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                  MR_hl_field(MR_mktag(1), Msgs_17, 0) = ((MR_Box) (Var_140));
                  MR_hl_field(MR_mktag(1), Msgs_17, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
                }
              }
              else
            ...
            case (MR_Integer) 1:
              {
                ...
                {
                  Msgs_17 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                  MR_hl_field(MR_mktag(1), Msgs_17, 0) = ((MR_Box) (Var_163));
                  MR_hl_field(MR_mktag(1), Msgs_17, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
                }
                STATE_VARIABLE_DetInfo_116 = STATE_VARIABLE_DetInfo_0_115;
              }
                  ...
                  case (MR_Integer) 2:
                    {
                      ...
                      MR_Word next_value_of_tscc_proc_1_input_1_Goal_8 = SubGoal_248;
    ...
    switch (Why_10) {
      ...
      case (MR_Integer) 1:
        ...
        else
        {
          ...
          libs__globals__lookup_int_option_3_p_0(Globals_30, (MR_Integer) 50, &Threshold_31);
  ...
  while (MR_TRUE)
  {
    ...
    if (succeeded)
    {
      ...
      else
      {
        ...
        succeeded = hlds__hlds_goal__goal_has_feature_2_p_0(Var_20, (MR_Integer) 26);
        if (succeeded)
        {
          // direct tailcall eliminated
