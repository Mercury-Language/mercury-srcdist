  ...
  MR_Word * STATE_VARIABLE_Specs_22)
{
  ...
  if (succeeded)
  {
    Var_67 = hlds__hlds_pred__pred_info_pred_form_arity_1_f_0(PredInfo_9);
  ...
  hlds__hlds_module__module_info_set_pragma_exported_procs_3_p_0(ExportedProcsCord_74, STATE_VARIABLE_ModuleInfo_32_32, STATE_VARIABLE_ModuleInfo_20);
  hlds__hlds_pred__proc_info_get_inferred_determinism_2_p_0(ProcInfo_10, &Detism_75);
  PredId_76 = ((MR_Word) ((MR_hl_field(0, PredProcId_6, (MR_Integer) 0))));
  ProcId_77 = ((MR_Integer) ((MR_hl_field(0, PredProcId_6, (MR_Integer) 1))));
  ...
  if (succeeded)
  {
    ...
    }
    {
      ...
      MR_hl_field(1, Spec_80, 2) = ((MR_Box) ((MR_Unsigned) 64U));
