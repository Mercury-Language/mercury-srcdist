      ...
      case (MR_Integer) 0:
        {
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(0), Spec_22, 2) = ((MR_Box) ((MR_Unsigned) 64U));
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        hlds__hlds_pred__proc_info_get_context_2_p_0(ProcInfo_17, &ProcContext_35);
        {
          ...
          MR_hl_field(MR_mktag(1), Spec_37, 2) = ((MR_Box) ((MR_Unsigned) 64U));
...
{
  {
        ...
        case (MR_Integer) 0:
          {
            ...
            }
            {
              ...
              MR_hl_field(MR_mktag(0), ReportSpec_177, 2) = ((MR_Box) ((MR_Unsigned) 64U));
        ...
        case (MR_Integer) 2:
          {
            ...
            if (succeeded)
            {
              ...
              }
              {
                ...
                MR_hl_field(MR_mktag(0), ReportSpec_25, 2) = ((MR_Box) ((MR_Unsigned) 64U));
    ...
    if (succeeded)
    {
      ...
      {
        Var_165 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(2), Var_165, 0) = ((MR_Box) (Context_43));
        MR_hl_field(MR_mktag(2), Var_165, 1) = ((MR_Box) (Var_166));
      }
      {
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(0), ValidSpec_50, 2) = ((MR_Box) ((MR_Unsigned) 64U));
...
{
  {
    ...
    Context_14 = hlds__hlds_goal__goal_info_get_context_1_f_0(ScopeGoalInfo_8);
    {
      ...
      MR_hl_field(MR_mktag(1), Spec_15, 2) = ((MR_Box) ((MR_Unsigned) 64U));
            ...
            case (MR_Integer) 4:
              {
                ...
                if (succeeded)
                {
                  ...
                  {
                    Var_190 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(MR_mktag(2), Var_190, 0) = ((MR_Box) (Context_211));
                    MR_hl_field(MR_mktag(2), Var_190, 1) = ((MR_Box) (Var_191));
                  }
                  {
