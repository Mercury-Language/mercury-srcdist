...
MR_decl_label5(__Compare___check_hlds__det_report__switch_context_0_0, 3,2,5,9,38)
...
MR_BEGIN_MODULE(check_hlds__det_report_module52)
	...
	MR_init_label5(__Compare___check_hlds__det_report__switch_context_0_0,3,2,5,9,38)
MR_BEGIN_CODE
...
MR_def_label(__Compare___check_hlds__det_report__switch_context_0_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___check_hlds__det_report__switch_context_0_0_i38);
	}
	MR_r1 = MR_sv(1);
	MR_r2 = MR_sv(3);
...
MR_def_label(__Compare___check_hlds__det_report__switch_context_0_0,9)
	...
	MR_decr_sp(5);
	MR_np_tailcall_ent(builtin__compare_3_0);
MR_def_label(__Compare___check_hlds__det_report__switch_context_0_0,38)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(5);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
