  ...
  MR_Word * STATE_VARIABLE_Specs_27)
{
  ...
  if (succeeded)
  {
    ...
    hlds__hlds_pred__proc_info_get_context_2_p_0(ProcInfo_10, &ProcContext_24);
    {
      ...
      MR_hl_field(1, Spec_25, 0) = ((MR_Box) ((MR_String) "predicate \140check_hlds.det_report.check_io_state_proc_detism\'/6"));
      MR_hl_field(1, Spec_25, 1) = ((MR_Box) ((MR_Unsigned) 0U));
      MR_hl_field(1, Spec_25, 2) = ((MR_Box) ((MR_Unsigned) 68U));
      MR_hl_field(1, Spec_25, 3) = ((MR_Box) (ProcContext_24));
      MR_hl_field(1, Spec_25, 4) = ((MR_Box) (Pieces_23));
    }
    {
      MR_Word base;
      base = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
