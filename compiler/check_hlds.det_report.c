  ...
  MR_Word * STATE_VARIABLE_Specs_28)
{
  ...
  if (succeeded)
  {
    ...
    Var_46 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), (MR_Word) (MR_mkword(1, &check_hlds__det_report_scalar_common_2[116])), Var_53);
    ...
    MainPieces_24 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), (MR_Word) (MR_mkword(1, &check_hlds__det_report_scalar_common_2[113])), Var_39);
    {
    ...
    }
    {
      ...
      MR_hl_field(1, Var_69, 1) = ((MR_Box) (MR_mkword(1, &check_hlds__det_report_scalar_common_2[272])));
    }
    {
