    ...
    switch (Why_10) {
      ...
      case (MR_Integer) 1:
        ...
        else
        {
          ...
          libs__globals__lookup_int_option_3_p_0(Globals_30, (MR_Integer) 52, &Threshold_31);
    ...
    *VarStr_17 = parse_tree__parse_tree_out_term__mercury_var_to_name_only_2_f_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), VarSet_20, Var_14);
    ...
    if (succeeded)
    {
      ...
      else
      {
        ...
        {
          MR_Integer Var_65 = (MR_Integer) ((MR_Unsigned) Limit_51 - (MR_Unsigned) (MR_Integer) 1);
