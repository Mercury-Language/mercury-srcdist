      ...
      case (MR_Integer) 0:
        {
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(1), Var_36, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &check_hlds__det_report_scalar_common_2[143])));
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(1), Var_68, 0) = ((MR_Box) (Context_16));
    ...
    (env).check_hlds__det_report__check_for_multisoln_func_6_p_0_env_0__ModuleInfo_10 = ModuleInfo_10;
    {
      ...
      if ((env).check_hlds__det_report__check_for_multisoln_func_6_p_0_env_0__succeeded)
      {
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(1), Var_56, 0) = ((MR_Box) (FuncContext_19));
...
{
  {
    ...
    {
      Var_56 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), Var_56, 0) = ((MR_Box) (Context_14));
      MR_hl_field(MR_mktag(1), Var_56, 1) = ((MR_Box) (Var_57));
    }
    {
      MR_Word base;
