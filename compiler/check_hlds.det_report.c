...
MR_decl_label10(check_hlds__det_report__det_diagnose_goal_expr_9_0, 42,43,47,48,37,34,56,57,58,63)
MR_decl_label10(check_hlds__det_report__det_diagnose_goal_expr_9_0, 64,59,65,66,67,68,69,55,72,73)
MR_decl_label10(check_hlds__det_report__det_diagnose_goal_expr_9_0, 77,74,88,84,71,98,99,100,101,97)
...
MR_decl_label10(check_hlds__det_report__reqscope_check_goal_4_0, 121,3,4,7,10,11,12,5,46,14)
MR_decl_label10(check_hlds__det_report__reqscope_check_goal_4_0, 15,17,20,21,22,19,24,27,26,32)
MR_decl_label5(check_hlds__det_report__reqscope_check_goal_4_0, 31,34,29,37,39)
MR_decl_label10(check_hlds__det_report__reqscope_check_scope_6_0, 3,4,5,6,7,160,13,17,19,36)
MR_decl_label9(check_hlds__det_report__reqscope_check_scope_6_0, 10,11,9,45,82,46,47,48,62)
...
MR_BEGIN_MODULE(check_hlds__det_report_module5)
	...
	MR_init_label10(check_hlds__det_report__reqscope_check_scope_6_0,3,4,5,6,7,160,13,17,19,36)
	MR_init_label9(check_hlds__det_report__reqscope_check_scope_6_0,10,11,9,45,82,46,47,48,62)
MR_BEGIN_CODE
...
MR_def_label(check_hlds__det_report__reqscope_check_scope_6_0,7)
	...
	if (MR_RTAGS_TESTR(MR_r1,3,4)) {
		MR_GOTO_LAB(check_hlds__det_report__reqscope_check_scope_6_0_i160);
	}
	MR_r1 = MR_r5;
	MR_proceed();
MR_def_label(check_hlds__det_report__reqscope_check_scope_6_0,160)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(7);
...
MR_def_label(check_hlds__det_report__reqscope_check_scope_6_0,17)
	...
	MR_np_call_localret_ent(fn__hlds__hlds_goal__goal_info_get_context_1_0,
		check_hlds__det_report__reqscope_check_scope_6_0_i36);
MR_def_label(check_hlds__det_report__reqscope_check_scope_6_0,19)
	...
	MR_np_call_localret_ent(fn__hlds__hlds_goal__goal_info_get_context_1_0,
		check_hlds__det_report__reqscope_check_scope_6_0_i36);
MR_def_label(check_hlds__det_report__reqscope_check_scope_6_0,36)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
...
MR_BEGIN_MODULE(check_hlds__det_report_module7)
	...
	MR_init_label10(check_hlds__det_report__reqscope_check_goal_4_0,121,3,4,7,10,11,12,5,46,14)
	MR_init_label10(check_hlds__det_report__reqscope_check_goal_4_0,15,17,20,21,22,19,24,27,26,32)
...
MR_def_label(check_hlds__det_report__reqscope_check_goal_4_0,7)
	...
	if (MR_PTAG_TESTR(MR_r5,2)) {
		MR_GOTO_LAB(check_hlds__det_report__reqscope_check_goal_4_0_i46);
	}
	MR_sv(1) = MR_r2;
	{
	MR_Word MR_tempr1;
	...
	MR_r3 = MR_tfield(2, MR_tempr1, 5);
	MR_r4 = MR_tfield(2, MR_tempr1, 6);
	}
...
MR_def_label(check_hlds__det_report__reqscope_check_goal_4_0,46)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_r3;
	MR_decr_sp_and_return(5);
...
MR_def_label(check_hlds__det_report__reqscope_check_goal_4_0,17)
	...
	MR_np_localcall_lab(check_hlds__det_report__reqscope_check_goal_4_0,
		check_hlds__det_report__reqscope_check_goal_4_0_i20);
...
MR_def_label(check_hlds__det_report__reqscope_check_goal_4_0,19)
	...
	if (MR_RTAGS_TESTR(MR_r4,3,4)) {
		MR_GOTO_LAB(check_hlds__det_report__reqscope_check_goal_4_0_i24);
	}
	MR_r1 = MR_tfield(3, MR_r4, 1);
	MR_succip_word = MR_sv(5);
	MR_GOTO_LAB(check_hlds__det_report__reqscope_check_goal_4_0_i121);
...
MR_BEGIN_MODULE(check_hlds__det_report_module23)
	...
	MR_init_label10(check_hlds__det_report__det_diagnose_goal_expr_9_0,42,43,47,48,37,34,56,57,58,63)
	MR_init_label10(check_hlds__det_report__det_diagnose_goal_expr_9_0,64,59,65,66,67,68,69,55,72,73)
	MR_init_label10(check_hlds__det_report__det_diagnose_goal_expr_9_0,77,74,88,84,71,98,99,100,101,97)
...
MR_def_label(check_hlds__det_report__det_diagnose_goal_expr_9_0,43)
	...
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(parse_tree__error_util, format_component);
	MR_r2 = (MR_Word) MR_TAG_COMMON(1,1,14);
	MR_r3 = (MR_Word) MR_TAG_COMMON(1,1,17);
	MR_np_call_localret_ent(fn__f_108_105_115_116_95_95_43_43_2_0,
...
MR_def_label(check_hlds__det_report__det_diagnose_goal_expr_9_0,57)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_np_call_localret_ent(parse_tree__prog_data__determinism_components_3_0,
		check_hlds__det_report__det_diagnose_goal_expr_9_0_i58);
MR_def_label(check_hlds__det_report__det_diagnose_goal_expr_9_0,58)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r2,3)) {
		MR_GOTO_LAB(check_hlds__det_report__det_diagnose_goal_expr_9_0_i59);
	}
...
MR_def_label(check_hlds__det_report__det_diagnose_goal_expr_9_0,64)
	...
	MR_r1 = MR_sv(1);
	MR_sv(1) = MR_r3;
	MR_GOTO_LAB(check_hlds__det_report__det_diagnose_goal_expr_9_0_i65);
...
MR_def_label(check_hlds__det_report__det_diagnose_goal_expr_9_0,55)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_RTAGS_TESTR(MR_r1,3,4)) {
		MR_GOTO_LAB(check_hlds__det_report__det_diagnose_goal_expr_9_0_i71);
	}
	MR_incr_sp(9);
	MR_sv(9) = (MR_Word) MR_succip;
	MR_sv(1) = MR_r2;
...
MR_def_label(check_hlds__det_report__det_diagnose_goal_expr_9_0,77)
	...
	MR_tag_alloc_heap(MR_r2, 0, (MR_Integer) 2);
	MR_tfield(0, MR_r2, 0) = MR_r1;
	MR_tfield(0, MR_r2, 1) = (MR_Word) MR_TAG_COMMON(1,1,19);
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 2);
	MR_tfield(1, MR_tempr1, 0) = MR_r2;
...
MR_def_label(check_hlds__det_report__det_diagnose_goal_expr_9_0,74)
	...
	if (MR_INT_NE(MR_sv(3),0)) {
		MR_GOTO_LAB(check_hlds__det_report__det_diagnose_goal_expr_9_0_i84);
	}
	...
	MR_r1 = MR_sv(1);
	MR_np_call_localret_ent(fn__hlds__hlds_goal__goal_info_get_context_1_0,
		check_hlds__det_report__det_diagnose_goal_expr_9_0_i88);
...
MR_def_label(check_hlds__det_report__det_diagnose_goal_expr_9_0,84)
	...
	MR_r1 = MR_sv(8);
	MR_decr_sp_and_return(9);
MR_def_label(check_hlds__det_report__det_diagnose_goal_expr_9_0,71)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_def_label(fn__check_hlds__det_report__failing_context_description_3_0,3)
	...
	MR_r2 = (MR_Word) MR_TAG_COMMON(1,1,20);
	MR_r3 = (MR_Word) MR_TAG_COMMON(1,1,4);
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(parse_tree__error_util, format_component);
	MR_np_call_localret_ent(fn__f_108_105_115_116_95_95_43_43_2_0,
		fn__check_hlds__det_report__failing_context_description_3_0_i66);
...
MR_def_label(f_99_104_101_99_107_95_104_108_100_115_95_95_100_101_116_95_114_101_112_111_114_116_95_95_85_110_117_115_101_100_65_114_103_115_95_95_112_114_101_100_95_95_99_104_101_99_107_95_102_111_114_95_109_117_108_116_105_115_111_108_110_95_102_117_110_99_95_95_91_50_93_95_48_7_0,25)
	...
	MR_sv(1) = MR_r1;
	MR_r2 = MR_sv(2);
	MR_sv(2) = (MR_Word) MR_TAG_COMMON(1,1,30);
	MR_sv(4) = (MR_Word) MR_TAG_COMMON(3,3,9);
