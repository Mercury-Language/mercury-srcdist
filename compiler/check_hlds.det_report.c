    ...
    case (MR_Integer) 0:
      {
        ...
        GoalExpr_79 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Goal_10, (MR_Integer) 0))));
        GoalInfo_80 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Goal_10, (MR_Integer) 1))));
        Actual_81 = hlds__hlds_goal__goal_info_get_determinism_1_f_0(GoalInfo_80);
        parse_tree__prog_detism__compare_determinisms_3_p_0(DeclaredDetism_8, Actual_81, &CompareResult_82);
        switch (CompareResult_82) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 3:
          case (MR_Integer) 0:
            check_hlds__det_report__det_diagnose_goal_expr_9_p_0(GoalExpr_79, GoalInfo_80, InstMap0_12, DeclaredDetism_8, Actual_81, (MR_Word) ((MR_Unsigned) 0U), STATE_VARIABLE_DetInfo_0_25, &STATE_VARIABLE_DetInfo_64_64, &GoalMsgs_22);
            break;
          case (MR_Integer) 2:
          case (MR_Integer) 1:
            {
      ...
      case (MR_Integer) 0:
        {
          ...
          check_hlds__det_report__det_diagnose_goal_7_p_0(Goal_24, InstMap0_26, DeclaredDetism_13, (MR_Word) ((MR_Unsigned) 0U), DetInfo0_27, &DetInfo_28, &GoalMsgs_29);
          ...
          check_hlds__det_report__cse_nopull_msgs_2_p_0(ProcInfo_10, &CseMsgs_31);
          ...
          Var_74 = check_hlds__det_report__detism_decl_name_1_f_0(DetismDecl_108);
          {
      ...
      case (MR_Integer) 2:
        {
          ...
          if (succeeded)
          {
            ...
            Var_52 = check_hlds__det_report__detism_decl_name_1_f_0(DetismDecl_20);
            {
  ...
  MR_Word * HeadVar__7_7)
{
  ...
  else
  {
    ...
    MR_Word Msgs2_22;
    MR_Word STATE_VARIABLE_DetInfo_25_25;
    MR_Word GoalExpr_35 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Goal_14, (MR_Integer) 0))));
    MR_Word GoalInfo_36 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Goal_14, (MR_Integer) 1))));
    MR_Word Actual_37;
    MR_Word CompareResult_38;

    Actual_37 = hlds__hlds_goal__goal_info_get_determinism_1_f_0(GoalInfo_36);
    parse_tree__prog_detism__compare_determinisms_3_p_0(HeadVar__3_3, Actual_37, &CompareResult_38);
    switch (CompareResult_38) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 3:
      case (MR_Integer) 0:
        check_hlds__det_report__det_diagnose_goal_expr_9_p_0(GoalExpr_35, GoalInfo_36, InstMap0_2, HeadVar__3_3, Actual_37, HeadVar__4_4, STATE_VARIABLE_DetInfo_0_5, &STATE_VARIABLE_DetInfo_25_25, &Msgs1_21);
        break;
      case (MR_Integer) 2:
      case (MR_Integer) 1:
        {
  ...
  MR_Word * HeadVar__9_9)
{
  ...
  else
  {
    ...
    GoalExpr_55 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Goal_29, (MR_Integer) 0))));
    GoalInfo_56 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Goal_29, (MR_Integer) 1))));
    Actual_57 = hlds__hlds_goal__goal_info_get_determinism_1_f_0(GoalInfo_56);
    parse_tree__prog_detism__compare_determinisms_3_p_0(HeadVar__5_5, Actual_57, &CompareResult_58);
    switch (CompareResult_58) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 3:
      case (MR_Integer) 0:
        check_hlds__det_report__det_diagnose_goal_expr_9_p_0(GoalExpr_55, GoalInfo_56, InstMap1_36, HeadVar__5_5, Actual_57, SwitchContexts1_34, STATE_VARIABLE_DetInfo_44_44, &STATE_VARIABLE_DetInfo_45_45, &Msgs1_38);
        break;
      case (MR_Integer) 2:
      case (MR_Integer) 1:
        {
  ...
  MR_Word * HeadVar__10_10)
{
  ...
  else
  {
    ...
    GoalExpr_60 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Goal_21, (MR_Integer) 0))));
    GoalInfo_61 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Goal_21, (MR_Integer) 1))));
    Actual_62 = hlds__hlds_goal__goal_info_get_determinism_1_f_0(GoalInfo_61);
    parse_tree__prog_detism__compare_determinisms_3_p_0(ClauseDesired_35, Actual_62, &CompareResult_63);
    switch (CompareResult_63) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 3:
      case (MR_Integer) 0:
        check_hlds__det_report__det_diagnose_goal_expr_9_p_0(GoalExpr_60, GoalInfo_61, HeadVar__2_2, ClauseDesired_35, Actual_62, HeadVar__5_5, STATE_VARIABLE_DetInfo_0_6, &STATE_VARIABLE_DetInfo_46_46, &Msgs1_36);
        break;
      case (MR_Integer) 2:
      case (MR_Integer) 1:
        {
  ...
  MR_Word * HeadVar__7_7)
{
  ...
  else
  {
    ...
    switch (CompareResult_39) {
      ...
      case (MR_Integer) 3:
      case (MR_Integer) 0:
        check_hlds__det_report__det_diagnose_goal_expr_9_p_0(GoalExpr_36, GoalInfo_37, HeadVar__2_2, HeadVar__3_3, Actual_38, HeadVar__4_4, STATE_VARIABLE_DetInfo_0_5, &STATE_VARIABLE_DetInfo_26_26, &Msgs1_21);
        break;
      case (MR_Integer) 2:
      case (MR_Integer) 1:
        {
  ...
  MR_Word * HeadVar__3_3)
{
  ...
  else
  {
    ...
    MainMatchStr_14 = hlds__hlds_out__hlds_out_util__cons_id_and_vars_or_arity_to_string_4_f_0(VarNameSrc_10, (MR_Integer) 1, ConsId_49, MaybeArgVars_50);
    {
