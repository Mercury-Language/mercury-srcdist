      ...
      case (MR_Integer) 0:
        {
          ...
          hlds__hlds_pred__proc_info_get_var_table_3_p_0(STATE_VARIABLE_ModuleInfo_0_38, ProcInfo_10, &VarTable_25);
  ...
  MR_Word * STATE_VARIABLE_Specs_22)
{
  ...
  if (succeeded)
  {
    ...
    hlds__hlds_pred__proc_info_get_var_table_3_p_0(ModuleInfo_7, ProcInfo_10, &VarTable_16);
  ...
  if (succeeded)
  {
    *InitMsgs_13 = (MR_Word) ((MR_Unsigned) 0U);
    ...
    else
    {
      ...
      MR_Word RHS_20;
      MR_Word UC_21;
      MR_Word Var_31 = ((MR_Word) ((MR_hl_field(MR_mktag(1), CallUnifyContext_9, (MR_Integer) 0))));

      LHS_19 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_31, (MR_Integer) 0))));
      RHS_20 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_31, (MR_Integer) 1))));
      UC_21 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_31, (MR_Integer) 2))));
