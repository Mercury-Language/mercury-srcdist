...
static MR_bool MR_CALL 
check_hlds__det_report__cse_lifted_then_sortof_switch_4_p_0(
  MR_Word check_hlds__det_report__Conjuncts_5,
  MR_Word * check_hlds__det_report__SwitchVar_6,
  MR_Word * check_hlds__det_report__CanFail_7,
  MR_Word * check_hlds__det_report__Cases_8);

static MR_bool MR_CALL 
check_hlds__det_report__is_scope_subgoal_a_sortof_switch_4_p_0(
  MR_Word check_hlds__det_report__GoalExpr_5,
  MR_Word * check_hlds__det_report__SwitchVar_6,
  MR_Word * check_hlds__det_report__CanFail_7,
  MR_Word * check_hlds__det_report__Cases_8);
  ...
  while (MR_TRUE)
    {
      /* tailcall optimized into a loop */
      {
        MR_bool check_hlds__det_report__succeeded = ((MR_tag((MR_Word) check_hlds__det_report__Conjuncts_5)) == (MR_mktag((MR_Integer) 1)));
        MR_Word check_hlds__det_report__V_19_19;
        MR_Word check_hlds__det_report__V_20_20;

        if (check_hlds__det_report__succeeded)
          {
            check_hlds__det_report__V_20_20 = ((MR_Word) (MR_hl_field(MR_mktag(1), check_hlds__det_report__Conjuncts_5, (MR_Integer) 0)));
            check_hlds__det_report__V_19_19 = ((MR_Word) (MR_hl_field(MR_mktag(1), check_hlds__det_report__Conjuncts_5, (MR_Integer) 1)));
            if ((check_hlds__det_report__V_19_19 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
              {
                MR_Word check_hlds__det_report__ConjunctExpr_10 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__det_report__V_20_20, (MR_Integer) 0)));
                MR_Word check_hlds__det_report__V_11_11 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__det_report__V_20_20, (MR_Integer) 1)));

                switch (MR_tag((MR_Word) check_hlds__det_report__ConjunctExpr_10)) {
                  default:
                    check_hlds__det_report__succeeded = MR_FALSE;
                    break;
                  case (MR_Integer) 3:
                    switch (((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), check_hlds__det_report__ConjunctExpr_10, (MR_Integer) 0)))) {
                      default:
                        check_hlds__det_report__succeeded = MR_FALSE;
                        break;
                      case (MR_Integer) 2:
                        {
                          MR_Word check_hlds__det_report__Conjuncts0_30 = ((MR_Word) (MR_hl_field(MR_mktag(3), check_hlds__det_report__ConjunctExpr_10, (MR_Integer) 2)));
                          MR_Word check_hlds__det_report__Conjuncts_31;
                          MR_Word check_hlds__det_report__V_62_62 = ((MR_Word) (MR_hl_field(MR_mktag(3), check_hlds__det_report__ConjunctExpr_10, (MR_Integer) 1)));

                          check_hlds__det_report__succeeded = (check_hlds__det_report__V_62_62 == (MR_Integer) 0);
                          if (check_hlds__det_report__succeeded)
                            {
                              {
                                hlds__goal_util__flatten_conj_2_p_0(check_hlds__det_report__Conjuncts0_30, &check_hlds__det_report__Conjuncts_31);
                              }
                              /* direct tailcall eliminated */
                              {
                                MR_Word check_hlds__det_report__Conjuncts__tmp_copy_5 = check_hlds__det_report__Conjuncts_31;

                                check_hlds__det_report__Conjuncts_5 = check_hlds__det_report__Conjuncts__tmp_copy_5;
                              }
                              continue;
                            }
                        }
                      ...
                      case (MR_Integer) 4:
                        {
                          *check_hlds__det_report__SwitchVar_6 = ((MR_Word) (MR_hl_field(MR_mktag(3), check_hlds__det_report__ConjunctExpr_10, (MR_Integer) 1)));
                          *check_hlds__det_report__CanFail_7 = ((MR_Word) (MR_hl_field(MR_mktag(3), check_hlds__det_report__ConjunctExpr_10, (MR_Integer) 2)));
                          *check_hlds__det_report__Cases_8 = ((MR_Word) (MR_hl_field(MR_mktag(3), check_hlds__det_report__ConjunctExpr_10, (MR_Integer) 3)));
                          check_hlds__det_report__succeeded = MR_TRUE;
                        }
                        break;
                      case (MR_Integer) 5:
                        {
                          MR_Word check_hlds__det_report__Reason_25 = ((MR_Word) (MR_hl_field(MR_mktag(3), check_hlds__det_report__ConjunctExpr_10, (MR_Integer) 1)));
                          MR_Word check_hlds__det_report__SubGoal_26 = ((MR_Word) (MR_hl_field(MR_mktag(3), check_hlds__det_report__ConjunctExpr_10, (MR_Integer) 2)));
                          MR_Word check_hlds__det_report__SubGoalExpr_28;
                          MR_Word check_hlds__det_report___MaybeForcePruning_27;
                          MR_Word check_hlds__det_report__V_29_29;

                          check_hlds__det_report__succeeded = ((((MR_tag((MR_Word) check_hlds__det_report__Reason_25)) == (MR_mktag((MR_Integer) 3)))) && (((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), check_hlds__det_report__Reason_25, (MR_Integer) 0)))) == (MR_Integer) 4)));
                          if (check_hlds__det_report__succeeded)
                            {
                              check_hlds__det_report___MaybeForcePruning_27 = ((MR_Word) (MR_hl_field(MR_mktag(3), check_hlds__det_report__Reason_25, (MR_Integer) 1)));
                              check_hlds__det_report__SubGoalExpr_28 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__det_report__SubGoal_26, (MR_Integer) 0)));
                              check_hlds__det_report__V_29_29 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__det_report__SubGoal_26, (MR_Integer) 1)));
                              check_hlds__det_report__succeeded = ((((MR_tag((MR_Word) check_hlds__det_report__SubGoalExpr_28)) == (MR_mktag((MR_Integer) 3)))) && (((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), check_hlds__det_report__SubGoalExpr_28, (MR_Integer) 0)))) == (MR_Integer) 4)));
                              if (check_hlds__det_report__succeeded)
                                {
                                  *check_hlds__det_report__SwitchVar_6 = ((MR_Word) (MR_hl_field(MR_mktag(3), check_hlds__det_report__SubGoalExpr_28, (MR_Integer) 1)));
                                  *check_hlds__det_report__CanFail_7 = ((MR_Word) (MR_hl_field(MR_mktag(3), check_hlds__det_report__SubGoalExpr_28, (MR_Integer) 2)));
                                  *check_hlds__det_report__Cases_8 = ((MR_Word) (MR_hl_field(MR_mktag(3), check_hlds__det_report__SubGoalExpr_28, (MR_Integer) 3)));
                                }
                            }
                        }
                        break;
              ...
              {
                {
                  check_hlds__det_report__succeeded = hlds__hlds_goal__goal_has_feature_2_p_0(check_hlds__det_report__V_20_20, (MR_Integer) 24);
                }
                if (check_hlds__det_report__succeeded)
                  {
                    /* direct tailcall eliminated */
                    {
                      MR_Word check_hlds__det_report__Conjuncts__tmp_copy_5 = check_hlds__det_report__V_19_19;
...
{
  {
    ...
    switch (MR_tag((MR_Word) check_hlds__det_report__GoalExpr_5)) {
      default:
        check_hlds__det_report__succeeded = MR_FALSE;
        break;
      case (MR_Integer) 3:
        switch (((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), check_hlds__det_report__GoalExpr_5, (MR_Integer) 0)))) {
          default:
            check_hlds__det_report__succeeded = MR_FALSE;
            break;
          case (MR_Integer) 2:
            {
              MR_Word check_hlds__det_report__Conjuncts0_14 = ((MR_Word) (MR_hl_field(MR_mktag(3), check_hlds__det_report__GoalExpr_5, (MR_Integer) 2)));
              MR_Word check_hlds__det_report__Conjuncts_15;
              MR_Word check_hlds__det_report__V_46_46 = ((MR_Word) (MR_hl_field(MR_mktag(3), check_hlds__det_report__GoalExpr_5, (MR_Integer) 1)));

              check_hlds__det_report__succeeded = (check_hlds__det_report__V_46_46 == (MR_Integer) 0);
              if (check_hlds__det_report__succeeded)
                {
                  {
                    hlds__goal_util__flatten_conj_2_p_0(check_hlds__det_report__Conjuncts0_14, &check_hlds__det_report__Conjuncts_15);
                  }
                  {
                    check_hlds__det_report__succeeded = check_hlds__det_report__cse_lifted_then_sortof_switch_4_p_0(check_hlds__det_report__Conjuncts_15, check_hlds__det_report__SwitchVar_6, check_hlds__det_report__CanFail_7, check_hlds__det_report__Cases_8);
                  }
                }
            }
            break;
          case (MR_Integer) 4:
            {
              *check_hlds__det_report__SwitchVar_6 = ((MR_Word) (MR_hl_field(MR_mktag(3), check_hlds__det_report__GoalExpr_5, (MR_Integer) 1)));
              *check_hlds__det_report__CanFail_7 = ((MR_Word) (MR_hl_field(MR_mktag(3), check_hlds__det_report__GoalExpr_5, (MR_Integer) 2)));
              *check_hlds__det_report__Cases_8 = ((MR_Word) (MR_hl_field(MR_mktag(3), check_hlds__det_report__GoalExpr_5, (MR_Integer) 3)));
              check_hlds__det_report__succeeded = MR_TRUE;
            }
            break;
          case (MR_Integer) 5:
            {
              MR_Word check_hlds__det_report__Reason_9 = ((MR_Word) (MR_hl_field(MR_mktag(3), check_hlds__det_report__GoalExpr_5, (MR_Integer) 1)));
              MR_Word check_hlds__det_report__SubGoal_10 = ((MR_Word) (MR_hl_field(MR_mktag(3), check_hlds__det_report__GoalExpr_5, (MR_Integer) 2)));
              MR_Word check_hlds__det_report__SubGoalExpr_12;
              MR_Word check_hlds__det_report___MaybeForcePruning_11;
              MR_Word check_hlds__det_report__V_13_13;

              check_hlds__det_report__succeeded = ((((MR_tag((MR_Word) check_hlds__det_report__Reason_9)) == (MR_mktag((MR_Integer) 3)))) && (((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), check_hlds__det_report__Reason_9, (MR_Integer) 0)))) == (MR_Integer) 4)));
              if (check_hlds__det_report__succeeded)
                {
                  check_hlds__det_report___MaybeForcePruning_11 = ((MR_Word) (MR_hl_field(MR_mktag(3), check_hlds__det_report__Reason_9, (MR_Integer) 1)));
                  check_hlds__det_report__SubGoalExpr_12 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__det_report__SubGoal_10, (MR_Integer) 0)));
                  check_hlds__det_report__V_13_13 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__det_report__SubGoal_10, (MR_Integer) 1)));
                  check_hlds__det_report__succeeded = ((((MR_tag((MR_Word) check_hlds__det_report__SubGoalExpr_12)) == (MR_mktag((MR_Integer) 3)))) && (((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), check_hlds__det_report__SubGoalExpr_12, (MR_Integer) 0)))) == (MR_Integer) 4)));
                  if (check_hlds__det_report__succeeded)
                    {
                      *check_hlds__det_report__SwitchVar_6 = ((MR_Word) (MR_hl_field(MR_mktag(3), check_hlds__det_report__SubGoalExpr_12, (MR_Integer) 1)));
                      *check_hlds__det_report__CanFail_7 = ((MR_Word) (MR_hl_field(MR_mktag(3), check_hlds__det_report__SubGoalExpr_12, (MR_Integer) 2)));
                      *check_hlds__det_report__Cases_8 = ((MR_Word) (MR_hl_field(MR_mktag(3), check_hlds__det_report__SubGoalExpr_12, (MR_Integer) 3)));
                    }
                }
            }
            break;
    ...
    switch (MR_tag((MR_Word) check_hlds__det_report__Reason_7)) {
      ...
      case (MR_Integer) 3:
        switch (((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), check_hlds__det_report__Reason_7, (MR_Integer) 0)))) {
          ...
          case (MR_Integer) 1:
            {
              ...
              {
                check_hlds__det_report__V_96_96 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL);
                MR_hl_field(MR_mktag(0), check_hlds__det_report__V_96_96, 0) = ((MR_Box) (check_hlds__det_report__ScopeGoalInfo_9));
              }
              {
                check_hlds__det_report__reqscope_check_goal_detism_6_p_0(check_hlds__det_report__RequiredDetism_12, check_hlds__det_report__SubGoal_8, check_hlds__det_report__V_96_96, check_hlds__det_report__InstMap0_10, check_hlds__det_report__STATE_VARIABLE_DetInfo_0_52, check_hlds__det_report__STATE_VARIABLE_DetInfo_53);
              }
            }
            break;
          case (MR_Integer) 2:
            {
              ...
              MR_Word check_hlds__det_report__TypeInfo_106_106;
              MR_Word check_hlds__det_report__SwitchVar_16;

              {
                check_hlds__det_report__succeeded = check_hlds__det_report__is_scope_subgoal_a_sortof_switch_4_p_0(check_hlds__det_report__SubGoalExpr_14, &check_hlds__det_report__SwitchVar_16, &check_hlds__det_report__CanFail_17, &check_hlds__det_report__Cases_18);
              }
              if (check_hlds__det_report__succeeded)
                {
                  check_hlds__det_report__TypeInfo_106_106 = (MR_Word) &check_hlds__det_report_scalar_common_2[0];
                  {
                    check_hlds__det_report__succeeded = mercury__builtin__unify_2_p_0(check_hlds__det_report__TypeInfo_106_106, ((MR_Box) (check_hlds__det_report__SwitchVar_16)), ((MR_Box) (check_hlds__det_report__RequiredVar_13)));
                  }
                }
              if (check_hlds__det_report__succeeded)
                  ...
                  case (MR_Integer) 0:
                    {
                      ...
                      {
                        check_hlds__det_report__find_missing_cons_ids_6_p_0(check_hlds__det_report__STATE_VARIABLE_DetInfo_0_52, check_hlds__det_report__InstMap0_10, check_hlds__det_report__RequiredVar_13, check_hlds__det_report__Cases_18, &check_hlds__det_report__RequiredVarStr_19, &check_hlds__det_report__MaybeMissingPieces_20);
                      }
                      if ((check_hlds__det_report__MaybeMissingPieces_20 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
                        {
...

                          {
                            ...
                            MR_hl_field(MR_mktag(3), check_hlds__det_report__V_62_62, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 0));
                            MR_hl_field(MR_mktag(3), check_hlds__det_report__V_62_62, 1) = ((MR_Box) (check_hlds__det_report__RequiredVarStr_19));
                          }
                          {
                            ...
                            MR_hl_field(MR_mktag(1), check_hlds__det_report__V_61_61, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &check_hlds__det_report_scalar_common_2[59])));
                          }
                          {
                            ...
                            MR_hl_field(MR_mktag(1), check_hlds__det_report__SwitchPieces_22, 1) = ((MR_Box) (check_hlds__det_report__V_61_61));
                          }
                        }
                      else
                        {
...

                          {
                            ...
                            MR_hl_field(MR_mktag(3), check_hlds__det_report__V_76_76, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 0));
                            MR_hl_field(MR_mktag(3), check_hlds__det_report__V_76_76, 1) = ((MR_Box) (check_hlds__det_report__RequiredVarStr_19));
                          }
                          {
                            check_hlds__det_report__V_80_80 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                            MR_hl_field(MR_mktag(1), check_hlds__det_report__V_80_80, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &check_hlds__det_report_scalar_common_2[106])));
                            MR_hl_field(MR_mktag(1), check_hlds__det_report__V_80_80, 1) = ((MR_Box) (check_hlds__det_report__MissingPieces_21));
                          }
                          {
                            check_hlds__det_report__V_77_77 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                          ...
                          }
                          {
                            ...
                            MR_hl_field(MR_mktag(1), check_hlds__det_report__V_75_75, 1) = ((MR_Box) (check_hlds__det_report__V_77_77));
                          }
                          {
                            check_hlds__det_report__V_72_72 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                            MR_hl_field(MR_mktag(1), check_hlds__det_report__V_72_72, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &check_hlds__det_report_scalar_common_2[104])));
                            MR_hl_field(MR_mktag(1), check_hlds__det_report__V_72_72, 1) = ((MR_Box) (check_hlds__det_report__V_75_75));
                          }
                          {
                            check_hlds__det_report__SwitchPieces_22 = mercury__list__f_43_43_2_f_0((MR_Word) &parse_tree__error_util__parse_tree__error_util__type_ctor_info_format_component_0, check_hlds__det_report__V_72_72, (MR_Word) MR_mkword(MR_mktag(1), &check_hlds__det_report_scalar_common_2[6]));
                          }
                        }
                      {
                      ...
                      {
                        check_hlds__det_report__V_87_87 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL);
                        MR_hl_field(MR_mktag(0), check_hlds__det_report__V_87_87, 0) = ((MR_Box) (check_hlds__det_report__SwitchPieces_22));
                      }
                      {
                        check_hlds__det_report__V_86_86 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                        MR_hl_field(MR_mktag(1), check_hlds__det_report__V_86_86, 0) = ((MR_Box) (check_hlds__det_report__V_87_87));
                        MR_hl_field(MR_mktag(1), check_hlds__det_report__V_86_86, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
                      }
                      {
                        ...
                        MR_hl_field(MR_mktag(0), check_hlds__det_report__SwitchMsg_24, 1) = ((MR_Box) (check_hlds__det_report__V_86_86));
                      }
                      {
                        check_hlds__det_report__V_91_91 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                        MR_hl_field(MR_mktag(1), check_hlds__det_report__V_91_91, 0) = ((MR_Box) (check_hlds__det_report__SwitchMsg_24));
                      ...
                      }
                      {
                        ...
                        MR_hl_field(MR_mktag(0), check_hlds__det_report__SwitchSpec_25, 2) = ((MR_Box) (check_hlds__det_report__V_91_91));
                      }
                      {
                        check_hlds__det_util__det_info_add_error_spec_3_p_0(check_hlds__det_report__SwitchSpec_25, check_hlds__det_report__STATE_VARIABLE_DetInfo_0_52, check_hlds__det_report__STATE_VARIABLE_DetInfo_53);
                      }
                    }
                    break;
                  case (MR_Integer) 1:
                ...
                {
                  {
                    check_hlds__det_report__generate_error_not_switch_on_required_var_5_p_0(check_hlds__det_report__RequiredVar_13, (MR_String) "require_complete_switch", check_hlds__det_report__ScopeGoalInfo_9, check_hlds__det_report__STATE_VARIABLE_DetInfo_0_52, check_hlds__det_report__STATE_VARIABLE_DetInfo_53);
                  }
                }
            }
            break;
          case (MR_Integer) 3:
            {
              MR_Word check_hlds__det_report__RequiredDetism_100 = ((MR_Word) (MR_hl_field(MR_mktag(3), check_hlds__det_report__Reason_7, (MR_Integer) 2)));
              MR_Word check_hlds__det_report__RequiredVar_101 = ((MR_Word) (MR_hl_field(MR_mktag(3), check_hlds__det_report__Reason_7, (MR_Integer) 1)));
              MR_Word check_hlds__det_report__SubGoalExpr_102 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__det_report__SubGoal_8, (MR_Integer) 0)));
              MR_Word check_hlds__det_report__V_26_26 = ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__det_report__SubGoal_8, (MR_Integer) 1)));
              MR_Word check_hlds__det_report__SwitchVar_98;
              MR_Word check_hlds__det_report__Cases_99;
              MR_Word check_hlds__det_report___CanFail_27;

              {
                check_hlds__det_report__succeeded = check_hlds__det_report__is_scope_subgoal_a_sortof_switch_4_p_0(check_hlds__det_report__SubGoalExpr_102, &check_hlds__det_report__SwitchVar_98, &check_hlds__det_report___CanFail_27, &check_hlds__det_report__Cases_99);
              }
              if (check_hlds__det_report__succeeded)
                {
                  ...
                  {
                    check_hlds__det_util__det_info_get_vartypes_2_p_0(check_hlds__det_report__STATE_VARIABLE_DetInfo_0_52, &check_hlds__det_report__VarTypes_28);
                  }
                  {
                    hlds__vartypes__lookup_var_type_3_p_0(check_hlds__det_report__VarTypes_28, check_hlds__det_report__SwitchVar_98, &check_hlds__det_report__SwitchVarType_29);
                  }
                  {
                    check_hlds__det_report__reqscope_check_goal_detism_for_cases_7_p_0(check_hlds__det_report__RequiredDetism_100, check_hlds__det_report__SwitchVar_98, check_hlds__det_report__SwitchVarType_29, check_hlds__det_report__Cases_99, check_hlds__det_report__InstMap0_10, check_hlds__det_report__STATE_VARIABLE_DetInfo_0_52, check_hlds__det_report__STATE_VARIABLE_DetInfo_53);
                  }
                }
              else
                {
                  MR_String check_hlds__det_report__ScopeWord_30 = ((&check_hlds__det_report_vector_common_9[0 + check_hlds__det_report__RequiredDetism_100]))->check_hlds__det_report__vector_common_type_9_0__vct_9_f_0;

                  {
                    check_hlds__det_report__generate_error_not_switch_on_required_var_5_p_0(check_hlds__det_report__RequiredVar_101, check_hlds__det_report__ScopeWord_30, check_hlds__det_report__ScopeGoalInfo_9, check_hlds__det_report__STATE_VARIABLE_DetInfo_0_52, check_hlds__det_report__STATE_VARIABLE_DetInfo_53);
                  }
                }
            }
            break;
          ...
          case (MR_Integer) 2:
            {
              ...
              {
                libs__globals__lookup_bool_option_3_p_0(check_hlds__det_report__Globals_19, (MR_Integer) 8, &check_hlds__det_report__ShouldIssueWarning_20);
              }
              {
                libs__globals__lookup_bool_option_3_p_0(check_hlds__det_report__Globals_19, (MR_Integer) 9, &check_hlds__det_report__WarnAboutInferredErroneous_21);
              }
              {
