        ...
        case (MR_Integer) 2:
          {
            ...
            {
              check_hlds__det_report__generate_error_not_switch_on_required_var_6_p_0(SwitchContexts_9, RequiredVar_17, (MR_String) "require_complete_switch", ScopeGoalInfo_12, STATE_VARIABLE_DetInfo_0_50, STATE_VARIABLE_DetInfo_51);
              *MaybeReportedSwitch_14 = (MR_Word) ((MR_Unsigned) 0U);
            }
          }
          break;
        case (MR_Integer) 3:
          {
            ...
            else
            {
              ...
              check_hlds__det_report__generate_error_not_switch_on_required_var_6_p_0(SwitchContexts_9, RequiredVar_66, ScopeWord_28, ScopeGoalInfo_12, STATE_VARIABLE_DetInfo_0_50, STATE_VARIABLE_DetInfo_51);
            }
            *MaybeReportedSwitch_14 = (MR_Word) ((MR_Unsigned) 0U);
          }
          break;
  ...
  MR_Word * STATE_VARIABLE_DetInfo_19)
{
  ...
  Context_16 = hlds__hlds_goal__goal_info_get_context_1_f_0(ScopeGoalInfo_10);
  {
    ...
    MR_hl_field(1, Spec_17, 2) = ((MR_Box) ((MR_Unsigned) 64U));
