    ...
    *VarStr_17 = parse_tree__parse_tree_out_term__mercury_var_to_name_only_2_f_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), VarSet_20, Var_14);
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        Var_61 = mercury__list__one_or_more_to_list_1_f_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_constructor_0), TypeConstructors_32);
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          Var_62 = mercury__list__one_or_more_to_list_1_f_0(TypeCtorInfo_131_131, TypeConstructors_125);
