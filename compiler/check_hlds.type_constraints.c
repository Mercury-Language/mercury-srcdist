...
{
  {
    ...
    switch (MR_tag((MR_Word) RHS_12)) {
      ...
      case (MR_Integer) 2:
        {
          MR_Word Purity_45 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(2), RHS_12, (MR_Integer) 0))) & (MR_Integer) 3);
          MR_Word PredOrFunc_47 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(2), RHS_12, (MR_Integer) 0))) >> (MR_Integer) 3)) & (MR_Integer) 1);
          ...
          MR_Word Var_46 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(2), RHS_12, (MR_Integer) 0))) >> (MR_Integer) 2)) & (MR_Integer) 1);
