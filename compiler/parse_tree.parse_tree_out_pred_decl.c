...
static /* final */ const MR_Integer parse_tree__parse_tree_out_pred_decl_scalar_common_2[1][3];

static /* final */ const MR_Box parse_tree__parse_tree_out_pred_decl_scalar_common_3[1][10];
...
{
  {
    ...
    parse_tree__parse_tree_out_pred_decl__mercury_format_func_type_2_14_p_0((MR_Word) (&parse_tree__parse_tree_out_pred_decl_scalar_common_1[1]), TypeVarSet_11, VarNamePrint_12, ExistQVars_13, FuncName_14, Types_15, RetType_16, MaybeDet_17, Purity_18, ClassContext_19, (MR_String) ":- ", (MR_String) ".\n", ((MR_Box) ((MR_Integer) 0)), ((MR_Box) ((MR_String) "")), &conv0_String_20);
...
{
  {
    ...
    parse_tree__parse_tree_out_pred_decl__mercury_format_func_type_2_14_p_0((MR_Word) (&parse_tree__parse_tree_out_pred_decl_scalar_common_1[0]), VarSet_14, ExistQVars_15, FuncName_16, Types_17, RetType_18, MaybeDet_19, Purity_20, ClassContext_21, VarNamePrint_22, (MR_String) ":- ", (MR_String) ".\n", ((MR_Box) (Stream_13)), ((MR_Box) ((MR_Integer) 0)), &conv0_STATE_VARIABLE_IO_25);
  }
}
...
{
  {
    ...
    parse_tree__prog_util__split_types_and_modes_3_p_0(TypesAndModes_22, &Types_32, &MaybeModes_33);
    parse_tree__prog_util__split_type_and_mode_3_p_0(RetTypeAndMode_23, &RetType_34, &MaybeRetMode_35);
    succeeded = (MaybeModes_33 != (MR_Word) ((MR_Unsigned) 0U));
    if (succeeded)
    {
      Modes_36 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MaybeModes_33, (MR_Integer) 0))));
      succeeded = (MaybeRetMode_35 != (MR_Word) ((MR_Unsigned) 0U));
      if (succeeded)
        RetMode_37 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MaybeRetMode_35, (MR_Integer) 0))));
    }
    if (succeeded)
    {
      MR_Box STATE_VARIABLE_U_42_42;

      parse_tree__parse_tree_out_pred_decl__mercury_format_func_type_2_14_p_0(TypeClassInfo_for_output_46, TypeVarSet_18, (MR_Integer) 0, ExistQVars_20, FuncName_21, Types_32, RetType_34, (MR_Word) ((MR_Unsigned) 0U), Purity_25, ClassContext_26, StartString_27, Separator_28, S_30, STATE_VARIABLE_U_0_38, &STATE_VARIABLE_U_42_42);
      parse_tree__parse_tree_out_pred_decl__mercury_format_func_mode_decl_11_p_0(TypeClassInfo_for_output_46, Lang_17, InstVarSet_19, FuncName_21, Modes_36, RetMode_37, MaybeDet_24, StartString_27, Terminator_29, S_30, STATE_VARIABLE_U_42_42, STATE_VARIABLE_U_39);
    }
    else
      parse_tree__parse_tree_out_pred_decl__mercury_format_func_type_2_14_p_0(TypeClassInfo_for_output_46, TypeVarSet_18, (MR_Integer) 0, ExistQVars_20, FuncName_21, Types_32, RetType_34, MaybeDet_24, Purity_25, ClassContext_26, StartString_27, Terminator_29, S_30, STATE_VARIABLE_U_0_38, STATE_VARIABLE_U_39);
  }
}
...
{
  {
    ...
    else
    {
      ...
      func_4(((MR_Box) (TypeClassInfo_for_output_57)), ((MR_Box) ((MR_String) "(")), S_26, STATE_VARIABLE_U_43_43, &STATE_VARIABLE_U_45_45);
      {
        ...
        MR_hl_field(MR_mktag(0), Var_46, 0) = ((MR_Box) (&parse_tree__parse_tree_out_pred_decl_scalar_common_3[0]));
...
void MR_CALL 
parse_tree__parse_tree_out_pred_decl__mercury_format_pred_or_func_decl_18_p_0(
  ...
  MR_Word PredName_24,
  MR_Word TypesAndModes_25,
  MR_Word WithType_26,
  MR_Word WithInst_27,
  MR_Word MaybeDet_28,
  MR_Word Purity_29,
  MR_Word ClassContext_30,
  MR_String StartString_31,
  MR_String Separator_32,
  MR_String Terminator_33,
  MR_Box S_34,
...
{
  {
    ...
    parse_tree__prog_util__split_types_and_modes_3_p_0(TypesAndModes_25, &Types_36, &MaybeModes_37);
    succeeded = (MaybeModes_37 != (MR_Word) ((MR_Unsigned) 0U));
    if (succeeded)
    {
      Modes_38 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MaybeModes_37, (MR_Integer) 0))));
      succeeded = (Modes_38 != (MR_Word) ((MR_Unsigned) 0U));
      if (succeeded)
      {
      }
      if (!(succeeded))
      {
        succeeded = (WithInst_27 != (MR_Word) ((MR_Unsigned) 0U));
        if (succeeded)
        {
        }
      }
    ...
    if (succeeded)
    {
      ...
      parse_tree__parse_tree_out_pred_decl__mercury_format_pred_or_func_type_2_15_p_0(TypeClassInfo_for_output_50, TypeVarSet_20, (MR_Integer) 0, PredOrFunc_22, ExistQVars_23, PredName_24, Types_36, WithType_26, (MR_Word) ((MR_Unsigned) 0U), Purity_29, ClassContext_30, StartString_31, Separator_32, S_34, STATE_VARIABLE_U_0_42, &STATE_VARIABLE_U_46_46);
      parse_tree__parse_tree_out_pred_decl__mercury_format_pred_or_func_mode_decl_11_p_0(TypeClassInfo_for_output_50, Lang_19, InstVarSet_21, PredName_24, Modes_38, WithInst_27, MaybeDet_28, StartString_31, Terminator_33, S_34, STATE_VARIABLE_U_46_46, STATE_VARIABLE_U_43);
    }
    else
      parse_tree__parse_tree_out_pred_decl__mercury_format_pred_or_func_type_2_15_p_0(TypeClassInfo_for_output_50, TypeVarSet_20, (MR_Integer) 0, PredOrFunc_22, ExistQVars_23, PredName_24, Types_36, WithType_26, MaybeDet_28, Purity_29, ClassContext_30, StartString_31, Terminator_33, S_34, STATE_VARIABLE_U_0_42, STATE_VARIABLE_U_43);
  }
}
...
{
  {
    ...
    else
    {
      ...
      func_5(((MR_Box) (TypeClassInfo_for_output_69)), ((MR_Box) ((MR_String) "(")), S_28, STATE_VARIABLE_U_48_48, &STATE_VARIABLE_U_50_50);
      {
        ...
        MR_hl_field(MR_mktag(0), Var_51, 0) = ((MR_Box) (&parse_tree__parse_tree_out_pred_decl_scalar_common_3[0]));
    ...
    if (succeeded)
    {
      ...
      Var_85 = parse_tree__mercury_to_mercury__mercury_det_to_string_1_f_0((MR_Integer) 0);
