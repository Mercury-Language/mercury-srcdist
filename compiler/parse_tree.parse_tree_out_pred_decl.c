...
{
  {
    ...
    parse_tree__parse_tree_out_pred_decl__func_2 = ((void MR_CALL (*)(MR_Box, MR_Box, MR_Box, MR_Box *)) (MR_hl_field(MR_mktag(0), (MR_hl_field(MR_mktag(0), parse_tree__parse_tree_out_pred_decl__TypeClassInfo_for_output_54, (MR_Integer) 0)), (MR_Integer) 17)));
    {
    ...
    if ((parse_tree__parse_tree_out_pred_decl__Types_18 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
    ...
    else
      {
        ...
        parse_tree__parse_tree_out_pred_decl__func_5 = ((void MR_CALL (*)(MR_Box, MR_Box, MR_Box, MR_Box, MR_Box, MR_Box, MR_Box *)) (MR_hl_field(MR_mktag(0), (MR_hl_field(MR_mktag(0), parse_tree__parse_tree_out_pred_decl__TypeClassInfo_for_output_54, (MR_Integer) 0)), (MR_Integer) 25)));
        {
...
{
  {
    ...
    parse_tree__parse_tree_out_pred_decl__func_2 = ((void MR_CALL (*)(MR_Box, MR_Box, MR_Box, MR_Box *)) (MR_hl_field(MR_mktag(0), (MR_hl_field(MR_mktag(0), parse_tree__parse_tree_out_pred_decl__TypeClassInfo_for_output_66, (MR_Integer) 0)), (MR_Integer) 17)));
    {
    ...
    if ((parse_tree__parse_tree_out_pred_decl__Types_20 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
    ...
    else
      {
        ...
        parse_tree__parse_tree_out_pred_decl__func_6 = ((void MR_CALL (*)(MR_Box, MR_Box, MR_Box, MR_Box, MR_Box, MR_Box, MR_Box *)) (MR_hl_field(MR_mktag(0), (MR_hl_field(MR_mktag(0), parse_tree__parse_tree_out_pred_decl__TypeClassInfo_for_output_66, (MR_Integer) 0)), (MR_Integer) 25)));
        {
