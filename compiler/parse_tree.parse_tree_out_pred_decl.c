  ...
  MR_Box * STATE_VARIABLE_U_34)
{
  ...
  else
  {
    ...
    func_5 = ((void MR_CALL (*)(MR_Box, MR_Box, MR_Box, MR_Box, MR_Box, MR_Box, MR_Box, MR_Box *)) ((MR_hl_field(MR_mktag(0), (MR_hl_field(MR_mktag(0), TypeClassInfo_for_output_56, (MR_Integer) 0)), (MR_Integer) 26))));
  ...
  MR_Box * STATE_VARIABLE_U_38)
{
  ...
  else
  {
    ...
    func_6 = ((void MR_CALL (*)(MR_Box, MR_Box, MR_Box, MR_Box, MR_Box, MR_Box, MR_Box, MR_Box *)) ((MR_hl_field(MR_mktag(0), (MR_hl_field(MR_mktag(0), TypeClassInfo_for_output_68, (MR_Integer) 0)), (MR_Integer) 26))));
