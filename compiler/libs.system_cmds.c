  ...
  MR_Word * Succeeded_20)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_12, (MR_Integer) 732, &RestrictedCommandLine_22);
    ...
    case (MR_Integer) 1:
      {
        ...
        else
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_12, (MR_Integer) 78, &VeryVerbose_27);
  ...
  MR_Word * Succeeded_16)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_10, (MR_Integer) 77, &Verbose_19);
  switch (Verbosity_13) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 0:
      ...
      break;
    case (MR_Integer) 1:
      libs__globals__lookup_bool_option_3_p_0(Globals_10, (MR_Integer) 83, &PrintCommand_20);
      break;
  }
