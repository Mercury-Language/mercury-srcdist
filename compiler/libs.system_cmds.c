  ...
  MR_Word * Succeeded_20)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_12, (MR_Integer) 714, &RestrictedCommandLine_22);
    ...
    case (MR_Integer) 1:
      {
        ...
        else
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_12, (MR_Integer) 75, &VeryVerbose_27);
  ...
  MR_Word * Succeeded_16)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_10, (MR_Integer) 74, &Verbose_19);
  switch (Verbosity_13) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 0:
      ...
      break;
    case (MR_Integer) 1:
      libs__globals__lookup_bool_option_3_p_0(Globals_10, (MR_Integer) 80, &PrintCommand_20);
      break;
  }
