  ...
  MR_Word * Succeeded_20)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_12, (MR_Integer) 593, &RestrictedCommandLine_22);
  ...
  MR_Word * Succeeded_16)
{
  ...
  switch (Verbosity_13) {
    ...
    case (MR_Integer) 0:
      ...
      break;
    case (MR_Integer) 1:
      libs__globals__lookup_bool_option_3_p_0(Globals_10, (MR_Integer) 139, &PrintCommand_20);
      break;
  }
