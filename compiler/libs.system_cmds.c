  ...
  MR_Word * Succeeded_20)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_12, (MR_Integer) 608, &RestrictedCommandLine_22);
    ...
    case (MR_Integer) 1:
      {
        ...
        else
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_12, (MR_Integer) 134, &VeryVerbose_27);
  ...
  MR_Word * Succeeded_16)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_10, (MR_Integer) 133, &Verbose_19);
  switch (Verbosity_13) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 0:
      ...
      break;
    case (MR_Integer) 1:
      libs__globals__lookup_bool_option_3_p_0(Globals_10, (MR_Integer) 144, &PrintCommand_20);
      break;
  }
  ...
  if (((MR_tag((MR_Word) TmpFileResult_21)) == (MR_Integer) 1))
  {
    MR_String Var_92;
    MR_String Var_95;
    MR_Word Error_150 = ((MR_Word) ((MR_hl_field(1, TmpFileResult_21, 0))));
  ...
  else
  {
    ...
    {
      MR_Word Error_30 = ((MR_Word) ((MR_hl_field(1, CmdResult_24, 0))));
      MR_String Var_90;
    ...
    {
      MR_Word Var_151 = ((MR_Word) ((MR_hl_field(0, CmdResult_24, 0))));

      if (((MR_tag((MR_Word) Var_151)) == (MR_Integer) 0))
      {
        MR_Integer Status_25 = ((MR_Integer) ((MR_hl_field(0, Var_151, 0))));
      ...
      {
        MR_Integer Signal_27 = ((MR_Integer) ((MR_hl_field(1, Var_151, 0))));
  ...
  if (succeeded)
  {
    ...
    if (succeeded)
    {
      ProcessOutput_31 = ((MR_String) ((MR_hl_field(1, MaybeProcessOutput_15, 0))));
      succeeded = libs__system_cmds__use_dotnet_0_p_0();
      succeeded = !(succeeded);
    }
  }
  if (succeeded)
  {
    ...
    {
      MR_Word ProcessTmpError_45 = ((MR_Word) ((MR_hl_field(1, ProcessedTmpFileResult_33, 0))));
    ...
    else
    {
      ...
      MaybeProcessedTmpFile_35 = ((MR_String) ((MR_hl_field(0, ProcessedTmpFileResult_33, 0))));
      succeeded = libs__system_cmds__use_win32_0_p_0();
      if (succeeded)
      {
      ...
      {
        MR_Word ProcessOutputError_43 = ((MR_Word) ((MR_hl_field(1, ProcessOutputResult_38, 0))));
      ...
      {
        MR_Word Var_152 = ((MR_Word) ((MR_hl_field(0, ProcessOutputResult_38, 0))));

        if (((MR_tag((MR_Word) Var_152)) == (MR_Integer) 0))
        {
          MR_Integer ProcessOutputStatus_40 = ((MR_Integer) ((MR_hl_field(0, Var_152, 0))));
        ...
        {
          MR_Integer ProcessOutputSignal_42 = ((MR_Integer) ((MR_hl_field(1, Var_152, 0))));
          MR_String Var_134;
          MR_String Var_137;
          MR_String Var_138;
  ...
  *Succeeded_16 = libs__maybe_util__and_2_f_0(CommandSucceeded_26, ProcessOutputSucceeded_41);
  if (!(((MR_tag((MR_Word) TmpFileResult_21)) == (MR_Integer) 1)))
  {
    ...
    {
      MR_Word MaybeProcessedTmpFileError_50 = ((MR_Word) ((MR_hl_field(1, MaybeProcessedTmpFileResult_48, 0))));
      MR_String Var_144;
      MR_String Var_147;
    ...
    {
      MR_String MaybeProcessedTmpFileStr_49 = ((MR_String) ((MR_hl_field(0, MaybeProcessedTmpFileResult_48, 0))));
