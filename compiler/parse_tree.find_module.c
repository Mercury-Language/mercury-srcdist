...
parse_tree__find_module__IntroducedFrom__func__find_source_error__105__1_1_f_0(
...
{
  {
    ...
    if (((MR_tag((MR_Word) OpenRes_10)) == (MR_Integer) 1))
    {
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(0), Var_58, 0) = ((MR_Box) (Pieces_22));
      }
      {
      ...
      {
        Var_53 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(2), Var_53, 0) = ((MR_Box) ((MR_Unsigned) 0U));
        MR_hl_field(MR_mktag(2), Var_53, 1) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 0));
        MR_hl_field(MR_mktag(2), Var_53, 2) = ((MR_Box) ((MR_Integer) 0));
        MR_hl_field(MR_mktag(2), Var_53, 3) = ((MR_Box) (Var_57));
      }
      {
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(0), Spec_23, 0) = ((MR_Box) ((MR_String) "predicate \140parse_tree.find_module.find_module_name\'/5"));
        MR_hl_field(MR_mktag(0), Spec_23, 1) = ((MR_Box) ((MR_Unsigned) 0U));
        MR_hl_field(MR_mktag(0), Spec_23, 2) = ((MR_Box) ((MR_Unsigned) 4U));
        MR_hl_field(MR_mktag(0), Spec_23, 3) = ((MR_Box) (Var_52));
      }
      parse_tree__error_util__write_error_spec_ignore_4_p_0(Globals_6, Spec_23);
    ...
    else
    {
      ...
      parse_tree__error_util__write_error_specs_ignore_4_p_0(Globals_6, Specs_18);
    }
  }
}
...
{
  {
    ...
    parse_tree__find_module__search_for_module_source_and_stream_6_p_0(Globals_7, Dirs_8, ModuleName_9, &MaybeFileNameAndStream_12);
    ...
    else
    {
      ...
      MR_Word Var_19 = ((MR_Word) ((MR_hl_field(MR_mktag(0), MaybeFileNameAndStream_12, (MR_Integer) 0))));

      SourceFileName_13 = ((MR_String) ((MR_hl_field(MR_mktag(0), Var_19, (MR_Integer) 0))));
      SourceStream_14 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_19, (MR_Integer) 1))));
...
{
  {
    ...
    conv0_LambdaHeadVar__2_22 = parse_tree__find_module__IntroducedFrom__func__find_source_error__105__1_1_f_0(((MR_String) (wrapper_arg_1)));
...
{
  {
    ...
    parse_tree__file_names__module_name_to_file_name_7_p_0(Globals_7, (MR_Integer) 1, (MR_Word) (((MR_Box) ((MR_String) ".m"))), ModuleName_9, &FileName0_12);
    ...
    if (((MR_tag((MR_Word) MaybeFileNameAndStream0_13)) == (MR_Integer) 1))
    {
      ...
      ModuleNameStr_29 = mdbcomp__sym_name__sym_name_to_string_1_f_0(ModuleName_9);
      Var_39 = mercury__list__map_2_f_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&parse_tree__find_module_scalar_common_3[0]), Dirs_8);
      Var_37 = mercury__string__join_list_2_f_0((MR_String) ", ", Var_39);
      Var_35 = mercury__string__f_43_43_2_f_0((MR_String) "\' in directories ", Var_37);
      Var_34 = mercury__string__f_43_43_2_f_0(ModuleNameStr_29, Var_35);
      Error_16 = mercury__string__f_43_43_2_f_0((MR_String) "cannot find source for module \140", Var_34);
      {
        MR_Word base;
        base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
