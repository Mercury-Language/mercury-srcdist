...
static const MR_PseudoTypeInfo parse_tree__find_module__parse_tree__find_module__field_types_path_name_and_contents_0_0[2];

static const MR_DuFunctorDesc parse_tree__find_module__parse_tree__find_module__du_functor_desc_path_name_and_contents_0_0;

static const MR_DuFunctorDescPtr parse_tree__find_module__parse_tree__find_module__du_stag_ordered_path_name_and_contents_0_0[1];

static const MR_DuPtagLayout parse_tree__find_module__parse_tree__find_module__du_ptag_ordered_path_name_and_contents_0[1];

static const MR_DuFunctorDescPtr parse_tree__find_module__parse_tree__find_module__du_name_ordered_path_name_and_contents_0[1];

static const MR_Integer parse_tree__find_module__parse_tree__find_module__functor_number_map_path_name_and_contents_0[1];
...
parse_tree__find_module__IntroducedFrom__func__find_source_error__374__1_1_f_0(
  MR_String LambdaHeadVar__1_15);

static MR_String MR_CALL 
parse_tree__find_module__IntroducedFrom__func__cannot_find_in_dirs_msg__320__1_1_f_0(
...
parse_tree__find_module____Unify____path_name_and_contents_0_0_10001(
  MR_Box wrapper_arg_1,
  MR_Box wrapper_arg_2);

static void MR_CALL 
parse_tree__find_module____Compare____path_name_and_contents_0_0_10001(
  MR_Box * wrapper_arg_1,
  MR_Box wrapper_arg_2,
...
static const MR_DuFunctorDesc parse_tree__find_module__parse_tree__find_module__du_functor_desc_path_name_and_contents_0_0 = {
  (MR_String) "path_name_and_contents",
  INT16_C(2),
  UINT16_C(0),
  MR_SECTAG_NONE,
  UINT8_C(0),
  (MR_Integer) -1,
  INT32_C(0),
  parse_tree__find_module__parse_tree__find_module__field_types_path_name_and_contents_0_0,
  NULL,
  NULL,
  NULL,
...
static const MR_DuFunctorDescPtr parse_tree__find_module__parse_tree__find_module__du_stag_ordered_path_name_and_contents_0_0[1] = { &parse_tree__find_module__parse_tree__find_module__du_functor_desc_path_name_and_contents_0_0 };

static const MR_DuPtagLayout parse_tree__find_module__parse_tree__find_module__du_ptag_ordered_path_name_and_contents_0[1] = {
  {
    UINT32_C(1),
    MR_SECTAG_NONE,
    parse_tree__find_module__parse_tree__find_module__du_stag_ordered_path_name_and_contents_0_0,
    INT8_C(-1),
    UINT8_C(0),
    UINT8_C(1)
  }
...
static const MR_DuFunctorDescPtr parse_tree__find_module__parse_tree__find_module__du_name_ordered_path_name_and_contents_0[1] = { &parse_tree__find_module__parse_tree__find_module__du_functor_desc_path_name_and_contents_0_0 };

static const MR_Integer parse_tree__find_module__parse_tree__find_module__functor_number_map_path_name_and_contents_0[1] = { (MR_Integer) 0 };

const MR_TypeCtorInfo_Struct parse_tree__find_module__parse_tree__find_module__type_ctor_info_path_name_and_contents_0 = {
  (MR_Integer) 0,
  UINT8_C(18),
  INT8_C(1),
  MR_TYPECTOR_REP_DU,
  ((MR_Box) (parse_tree__find_module____Unify____path_name_and_contents_0_0_10001)),
  ((MR_Box) (parse_tree__find_module____Compare____path_name_and_contents_0_0_10001)),
  (MR_String) "parse_tree.find_module",
  (MR_String) "path_name_and_contents",
  { parse_tree__find_module__parse_tree__find_module__du_name_ordered_path_name_and_contents_0 },
  { parse_tree__find_module__parse_tree__find_module__du_ptag_ordered_path_name_and_contents_0 },
  (MR_Integer) 1,
  UINT16_C(12),
  parse_tree__find_module__parse_tree__find_module__functor_number_map_path_name_and_contents_0,
...
void MR_CALL 
parse_tree__find_module____Compare____path_name_and_contents_0_0(
  MR_Word * HeadVar__1_1,
  MR_Word HeadVar__2_2,
  MR_Word HeadVar__3_3)
{
...
MR_bool MR_CALL 
parse_tree__find_module____Unify____path_name_and_contents_0_0(
  MR_Word HeadVar__1_1,
  MR_Word HeadVar__2_2)
{
  MR_bool succeeded;
...
void MR_CALL 
parse_tree__find_module__find_module_name_6_p_0(
  ...
  MR_Word * MaybeModuleName_10)
{
  ...
  mercury__io__open_input_4_p_0(FileName_9, &OpenRes_12);
  if (((MR_tag((MR_Word) OpenRes_12)) == (MR_Integer) 1))
  {
    MR_Word Error_21 = ((MR_Word) ((MR_hl_field(1, OpenRes_12, (MR_Integer) 0))));
    ...
    mercury__io__progname_base_4_p_0((MR_String) "mercury_compile", &Progname_23);
    {
      ...
      MR_hl_field(2, Var_36, 0) = ((MR_Box) (Progname_23));
    }
    Var_38 = (MR_Word) (MR_mkword(3, &parse_tree__find_module_scalar_common_1[0]));
    {
      Var_44 = (MR_Word) MR_mkword(3, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(3, Var_44, 0) = ((MR_Box) ((MR_Unsigned) 0U));
      MR_hl_field(3, Var_44, 1) = ((MR_Box) (FileName_9));
    }
    {
      Var_49 = (MR_Word) MR_mkword(3, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(3, Var_49, 0) = ((MR_Box) ((MR_Unsigned) 6U));
      MR_hl_field(3, Var_49, 1) = ((MR_Box) (ErrorMsg_22));
    }
    {
      Var_48 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(1, Var_48, 0) = ((MR_Box) (Var_49));
      MR_hl_field(1, Var_48, 1) = ((MR_Box) (MR_mkword(1, &parse_tree__find_module_scalar_common_1[4])));
    }
    {
      Var_45 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(1, Var_45, 0) = ((MR_Box) (Var_38));
    ...
    }
    {
      ...
      MR_hl_field(1, Var_40, 0) = ((MR_Box) (MR_mkword(3, &parse_tree__find_module_scalar_common_1[1])));
    ...
    }
    {
      ...
      MR_hl_field(1, Pieces_24, 0) = ((MR_Box) (Var_36));
      MR_hl_field(1, Pieces_24, 1) = ((MR_Box) (Var_37));
    }
    {
      Spec_25 = (MR_Word) MR_mkword(2, MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(2, Spec_25, 0) = ((MR_Box) ((MR_String) "predicate \140parse_tree.find_module.find_module_name\'/6"));
      MR_hl_field(2, Spec_25, 1) = ((MR_Box) ((MR_Unsigned) 0U));
      MR_hl_field(2, Spec_25, 2) = ((MR_Box) ((MR_Unsigned) 12U));
      MR_hl_field(2, Spec_25, 3) = ((MR_Box) (Pieces_24));
    }
    parse_tree__write_error_spec__write_error_spec_5_p_0(ProgressStream_7, Globals_8, Spec_25);
    *MaybeModuleName_10 = (MR_Word) ((MR_Unsigned) 0U);
  }
  else
  {
    MR_Word FileStream_13 = ((MR_Word) ((MR_hl_field(0, OpenRes_12, (MR_Integer) 0))));
    MR_String PartialFileName_15;
    MR_String BaseName_17;
    MR_Word DefaultModuleName_18;
    MR_Word ModuleName_19;
    MR_Word Specs_20;
    MR_String PartialFileName0_14;
    MR_String BaseName0_16;

    succeeded = mercury__string__remove_suffix_3_p_0(FileName_9, (MR_String) ".m", &PartialFileName0_14);
    if (succeeded)
      PartialFileName_15 = PartialFileName0_14;
    else
      PartialFileName_15 = FileName_9;
    succeeded = mercury__dir__basename_2_p_0(PartialFileName_15, &BaseName0_16);
    if (succeeded)
      BaseName_17 = BaseName0_16;
    else
      BaseName_17 = (MR_String) "";
    parse_tree__file_names__file_name_to_module_name_2_p_0(BaseName_17, &DefaultModuleName_18);
    parse_tree__parse_module__peek_at_file_8_p_0(FileStream_13, DefaultModuleName_18, (MR_Word) ((MR_Unsigned) 0U), FileName_9, &ModuleName_19, &Specs_20);
    ...
    parse_tree__write_error_spec__write_error_specs_5_p_0(ProgressStream_7, Globals_8, Specs_20);
  }
}
  ...
  MR_Box wrapper_arg_1)
{
  ...
  conv0_LambdaHeadVar__2_16 = parse_tree__find_module__IntroducedFrom__func__find_source_error__374__1_1_f_0(((MR_String) (wrapper_arg_1)));
  ...
  MR_Box wrapper_arg_1)
{
  ...
  conv0_LambdaHeadVar__2_27 = parse_tree__find_module__IntroducedFrom__func__cannot_find_in_dirs_msg__320__1_1_f_0(((MR_String) (wrapper_arg_1)));
  ...
  MR_Box wrapper_arg_2)
{
  ...
  succeeded = parse_tree__find_module____Unify____path_name_and_contents_0_0(((MR_Word) (wrapper_arg_1)), ((MR_Word) (wrapper_arg_2)));
  return succeeded;
}
  ...
  MR_Box wrapper_arg_3)
{
  ...
  parse_tree__find_module____Compare____path_name_and_contents_0_0(&conv0_HeadVar__1_1, ((MR_Word) (wrapper_arg_2)), ((MR_Word) (wrapper_arg_3)));
...
void mercury__parse_tree__find_module__init_type_tables(void)
{
	...
	MR_register_type_ctor_info(&parse_tree__find_module__parse_tree__find_module__type_ctor_info_path_name_and_contents_0);
