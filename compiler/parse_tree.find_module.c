...
{
  {
    ...
    {
      parse_tree__find_module__Var_19 = mercury__list__map_2_f_0(parse_tree__find_module__TypeCtorInfo_31_31, parse_tree__find_module__TypeCtorInfo_31_31, (MR_Word) &parse_tree__find_module_scalar_common_3[2], parse_tree__find_module__Dirs_6);
    }
    {
    ...
    if ((parse_tree__find_module__MaybeFileNameAndStream_12 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
      {
        ...
        {
          parse_tree__find_module__Var_33 = mercury__list__map_2_f_0(parse_tree__find_module__TypeCtorInfo_31_45, parse_tree__find_module__TypeCtorInfo_31_45, (MR_Word) &parse_tree__find_module_scalar_common_3[1], parse_tree__find_module__Dirs_8);
        }
        {
            ...
            if (parse_tree__find_module__succeeded)
              {
                ...
                {
                  parse_tree__find_module__Var_72 = mercury__list__map_2_f_0(parse_tree__find_module__TypeCtorInfo_31_84, parse_tree__find_module__TypeCtorInfo_31_84, (MR_Word) &parse_tree__find_module_scalar_common_3[0], parse_tree__find_module__Dirs_9);
                }
                {
