...
{
  {
    ...
    if (((MR_tag((MR_Word) OpenRes_10)) == (MR_mktag((MR_Integer) 1))))
    {
      ...
      MR_Word Var_58;
      MR_Word Var_59;
      MR_Integer _NumWarnings_71;
      MR_Integer _NumErrors_72;
      ...
      parse_tree__error_util__write_error_spec_8_p_0(Spec_25, Globals_6, (MR_Integer) 0, &_NumWarnings_71, (MR_Integer) 0, &_NumErrors_72);
    ...
    else
    {
      ...
      parse_tree__parse_module__peek_at_file_7_p_0(FileStream_11, DefaultModuleName_16, FileName_7, &ModuleName_17, &Specs_18);
