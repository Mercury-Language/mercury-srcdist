...
{
  {
    ...
    if (((MR_tag((MR_Word) OpenRes_10)) == (MR_Integer) 1))
    {
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(1), Var_54, 0) = ((MR_Box) ((MR_Integer) 0));
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(0), Spec_25, 1) = ((MR_Box) ((MR_Integer) 4));
      ...
      *MaybeModuleName_8 = (MR_Word) ((MR_Integer) 0);
    }
    else
    {
      ...
      parse_tree__parse_module__peek_at_file_8_p_0(FileStream_11, DefaultModuleName_16, (MR_Word) ((MR_Integer) 0), FileName_7, &ModuleName_17, &Specs_18);
...
{
  {
    ...
    if ((MaybeBetterMatch_7 == (MR_Word) ((MR_Integer) 0)))
      Msg_8 = Msg0_10;
    else
    {
...
{
  {
    ...
    if ((MaybeFileNameAndStream_12 == (MR_Word) ((MR_Integer) 0)))
    {
      MR_String Error_14;
  ...
  while (MR_TRUE)
  {
    ...
    if (((MR_tag((MR_Word) MaybeFileNameAndStream0_13)) == (MR_Integer) 1))
    {
      ...
      if (succeeded)
      {
        ...
        *MaybeFileNameAndStream_10 = (MR_Word) ((MR_Integer) 0);
    }
    else
    {
