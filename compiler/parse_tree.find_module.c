...
parse_tree__find_module__IntroducedFrom__func__compute_search_dirs__493__1_2_f_0(
  MR_String GradeDir_12,
  MR_String LambdaHeadVar__1_24);

static MR_String MR_CALL 
parse_tree__find_module__IntroducedFrom__func__find_source_error__426__1_1_f_0(
  MR_String LambdaHeadVar__1_15);

static MR_String MR_CALL 
parse_tree__find_module__IntroducedFrom__func__cannot_find_in_dirs_msg__370__1_1_f_0(
...
static /* final */ const MR_Box parse_tree__find_module_scalar_common_2[5][2];
...
static /* final */ const MR_Box parse_tree__find_module_scalar_common_2[5][2] = {
  ...
  /* row   4 */
  {
    ((MR_Box) (MR_mkword(3, &parse_tree__find_module_scalar_common_2[3]))),
    ((MR_Box) (MR_mkword(1, &parse_tree__find_module_scalar_common_2[2])))
  },
};
        ...
        case (MR_Integer) 2:
          {
            ...
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                Cast_HeadVar1_31 = (MR_Word) (ArgX2_9);
                Cast_HeadVar2_32 = (MR_Word) (ArgY2_10);
                // direct tailcall eliminated
                ;
            ...
            case (MR_Integer) 2:
              {
                ...
                if (succeeded)
                {
                  ...
                  succeeded = mercury__builtin__unify_2_p_0(TypeInfo_26_26, ((MR_Box) (ArgX1_15)), ((MR_Box) (ArgY1_16)));
                }
              }
              break;
            case (MR_Integer) 3:
              {
                ...
                if (succeeded)
                {
                  ...
                  succeeded = mercury__builtin__unify_2_p_0(TypeInfo_25_25, ((MR_Box) (ArgX1_17)), ((MR_Box) (ArgY1_18)));
                }
              }
              break;
            case (MR_Integer) 4:
              {
                ...
                if (succeeded)
                {
                  ...
                  succeeded = mercury__builtin__unify_2_p_0(TypeInfo_30_30, ((MR_Box) (ArgX1_19)), ((MR_Box) (ArgY1_20)));
                }
              }
              break;
            case (MR_Integer) 5:
              {
                ...
                if (succeeded)
                {
                  ...
                  succeeded = libs__globals____Unify____globals_0_0(ArgX1_21, ArgY1_22);
                }
              }
              break;
          }
  ...
  MR_Word * MaybeModuleName_6)
{
  ...
  if (((MR_tag((MR_Word) OpenRes_8)) == (MR_Integer) 1))
  {
    ...
    Var_30 = (MR_Word) (MR_mkword(3, &parse_tree__find_module_scalar_common_2[0]));
    {
    ...
    }
    {
      ...
      MR_hl_field(1, Var_40, 1) = ((MR_Box) (MR_mkword(1, &parse_tree__find_module_scalar_common_2[4])));
    }
    {
    ...
    }
    {
      ...
      MR_hl_field(1, Var_32, 0) = ((MR_Box) (MR_mkword(3, &parse_tree__find_module_scalar_common_2[1])));
  ...
  MR_Box wrapper_arg_1)
{
  ...
  conv0_LambdaHeadVar__2_16 = parse_tree__find_module__IntroducedFrom__func__find_source_error__426__1_1_f_0(((MR_String) (wrapper_arg_1)));
  ...
  MR_Box wrapper_arg_1)
{
  ...
  conv0_LambdaHeadVar__2_27 = parse_tree__find_module__IntroducedFrom__func__cannot_find_in_dirs_msg__370__1_1_f_0(((MR_String) (wrapper_arg_1)));
  ...
  MR_Box wrapper_arg_1)
{
  ...
  conv0_LambdaHeadVar__2_25 = parse_tree__find_module__IntroducedFrom__func__compute_search_dirs__493__1_2_f_0(((MR_String) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_String) (wrapper_arg_1)));
        ...
        case (MR_Integer) 5:
          {
            ...
            libs__globals__get_grade_dir_2_p_0(Globals_10, &GradeDir_12);
            {
              ...
              MR_hl_field(0, Var_23, 0) = ((MR_Box) (&parse_tree__find_module_scalar_common_4[0]));
