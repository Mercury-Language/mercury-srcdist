  ...
  MR_Word * MaybeFileNameAndStream_8)
{
  ...
  if (((MR_tag((MR_Word) MaybeFileNameAndStream0_11)) == (MR_Integer) 1))
  {
    ...
    Var_29 = mercury__list__map_2_f_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&parse_tree__find_module_scalar_common_3[0]), Dirs_6);
    Var_27 = mercury__string__join_list_2_f_0((MR_String) ", ", Var_29);
    Var_25 = mercury__string__f_43_43_2_f_0((MR_String) "\' in directories ", Var_27);
    Var_24 = mercury__string__f_43_43_2_f_0(ModuleNameStr_20, Var_25);
    Error_14 = mercury__string__f_43_43_2_f_0((MR_String) "cannot find source for module \140", Var_24);
    {
      MR_Word base;
      base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
