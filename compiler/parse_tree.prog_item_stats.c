  ...
  MR_Word * STATE_VARIABLE_CompUnitStats_4)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      {
        MR_Word Var_56 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Section_13, (MR_Integer) 1))) >> (MR_Integer) 4)) & (MR_Integer) 3);
        MR_Word Var_57 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Section_13, (MR_Integer) 1))) >> (MR_Integer) 2)) & (MR_Integer) 3);
        MR_Word Var_58 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Section_13, (MR_Integer) 1))) & (MR_Integer) 3);
    ...
    switch (MR_tag((MR_Word) Goal_4)) {
      ...
      case (MR_Integer) 3:
        switch (((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), Goal_4, (MR_Integer) 0)))) {
          ...
          case (MR_Integer) 6:
            {
              MR_Word QuantType_13 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(3), Goal_4, (MR_Integer) 1))) & (MR_Integer) 1);
              MR_Word QuantVarsKind_14 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(3), Goal_4, (MR_Integer) 1))) >> (MR_Integer) 1)) & (MR_Integer) 1);
