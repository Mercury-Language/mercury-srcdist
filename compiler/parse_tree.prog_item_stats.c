...
static const MR_PseudoTypeInfo parse_tree__prog_item_stats__parse_tree__prog_item_stats__field_types_item_stats_0_0[23];

static const MR_ConstString parse_tree__prog_item_stats__parse_tree__prog_item_stats__field_names_item_stats_0_0[23];
...
parse_tree__prog_item_stats__gather_stats_in_item_5_p_0(
  MR_Word Item_6,
  MR_Word STATE_VARIABLE_ItemStats_0_35,
  MR_Word * STATE_VARIABLE_ItemStats_36,
  MR_Word STATE_VARIABLE_GoalStats_0_37,
  MR_Word * STATE_VARIABLE_GoalStats_38);
...
parse_tree__prog_item_stats__gather_stats_in_item_pragma_3_p_0(
  ...
  MR_Word STATE_VARIABLE_ItemStats_0_41,
  MR_Word * STATE_VARIABLE_ItemStats_42);
...
static /* final */ const MR_Box parse_tree__prog_item_stats_scalar_common_2[1][23];
...
{
  {
    ...
    MR_Integer PragmaExcp_32 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), ItemStats_9, (MR_Integer) 11))));
    MR_Integer PragmaTrail_33 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), ItemStats_9, (MR_Integer) 12))));
    MR_Integer PragmaMM_34 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), ItemStats_9, (MR_Integer) 13))));
    MR_Integer PragmaPass2_35 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), ItemStats_9, (MR_Integer) 14))));
    MR_Integer PragmaPass3_36 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), ItemStats_9, (MR_Integer) 15))));
    MR_Integer Promise_37 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), ItemStats_9, (MR_Integer) 16))));
    MR_Integer Typeclass_38 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), ItemStats_9, (MR_Integer) 17))));
    MR_Integer Instance_39 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), ItemStats_9, (MR_Integer) 18))));
    MR_Integer Initialise_40 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), ItemStats_9, (MR_Integer) 19))));
    MR_Integer Finalise_41 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), ItemStats_9, (MR_Integer) 20))));
    MR_Integer Mutable_42 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), ItemStats_9, (MR_Integer) 21))));
    MR_Integer TypeRepn_43 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), ItemStats_9, (MR_Integer) 22))));
    ...
    parse_tree__prog_item_stats__write_one_stat_6_p_0(Stream_5, SectionName_6, (MR_String) "item_pragma_excp", PragmaExcp_32);
    parse_tree__prog_item_stats__write_one_stat_6_p_0(Stream_5, SectionName_6, (MR_String) "item_pragma_trail", PragmaTrail_33);
    parse_tree__prog_item_stats__write_one_stat_6_p_0(Stream_5, SectionName_6, (MR_String) "item_pragma_mm", PragmaMM_34);
    parse_tree__prog_item_stats__write_one_stat_6_p_0(Stream_5, SectionName_6, (MR_String) "item_pragma_pass2", PragmaPass2_35);
    parse_tree__prog_item_stats__write_one_stat_6_p_0(Stream_5, SectionName_6, (MR_String) "item_pragma_pass3", PragmaPass3_36);
    parse_tree__prog_item_stats__write_one_stat_6_p_0(Stream_5, SectionName_6, (MR_String) "item_promise", Promise_37);
    parse_tree__prog_item_stats__write_one_stat_6_p_0(Stream_5, SectionName_6, (MR_String) "item_typeclass", Typeclass_38);
    parse_tree__prog_item_stats__write_one_stat_6_p_0(Stream_5, SectionName_6, (MR_String) "item_instance", Instance_39);
    parse_tree__prog_item_stats__write_one_stat_6_p_0(Stream_5, SectionName_6, (MR_String) "item_promise", Promise_37);
    parse_tree__prog_item_stats__write_one_stat_6_p_0(Stream_5, SectionName_6, (MR_String) "item_initialise", Initialise_40);
    parse_tree__prog_item_stats__write_one_stat_6_p_0(Stream_5, SectionName_6, (MR_String) "item_finalise", Finalise_41);
    parse_tree__prog_item_stats__write_one_stat_6_p_0(Stream_5, SectionName_6, (MR_String) "item_mutable", Mutable_42);
    parse_tree__prog_item_stats__write_one_stat_6_p_0(Stream_5, SectionName_6, (MR_String) "item_type_repn", TypeRepn_43);
  ...
  MR_Word * STATE_VARIABLE_CompUnitStats_4)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      MR_Word Section_14 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ItemBlock_10, (MR_Integer) 1))));
      ...
      switch (Section_14) {
        ...
        case (MR_Integer) 2:
          SectionName_19 = (MR_String) "src_impl_sub";
          break;
        case (MR_Integer) 1:
          SectionName_19 = (MR_String) "src_impl";
          break;
        case (MR_Integer) 0:
          SectionName_19 = (MR_String) "src_int";
          break;
      }
      succeeded = mercury__map__search_3_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&parse_tree__prog_item_stats__parse_tree__prog_item_stats__type_ctor_info_section_stats_0), STATE_VARIABLE_CompUnitStats_0_3, ((MR_Box) (SectionName_19)), &conv0_SectionStats0_20);
      if (succeeded)
      {
        SectionStats0_20 = ((MR_Word) (conv0_SectionStats0_20));
        succeeded = MR_TRUE;
      }
      if (succeeded)
      {
  ...
  MR_Word * STATE_VARIABLE_CompUnitStats_4)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      if (((MR_tag((MR_Word) Section_14)) == (MR_Integer) 1))
        SectionName_19 = (MR_String) "int_abstract_imported";
      else
      {
        MR_Word Var_57 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Section_14, (MR_Integer) 1))) & (MR_Integer) 3);

        switch (Var_57) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 0:
            SectionName_19 = (MR_String) "int_imported";
            break;
          case (MR_Integer) 1:
            SectionName_19 = (MR_String) "int_used";
            break;
          case (MR_Integer) 2:
            SectionName_19 = (MR_String) "int_used_and_imported";
            break;
        }
      }
      succeeded = mercury__map__search_3_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&parse_tree__prog_item_stats__parse_tree__prog_item_stats__type_ctor_info_section_stats_0), STATE_VARIABLE_CompUnitStats_0_3, ((MR_Box) (SectionName_19)), &conv0_SectionStats0_20);
      ...
      else
      {
        ...
        Var_30 = parse_tree__prog_item_stats__init_goal_stats_0_f_0();
        parse_tree__prog_item_stats__gather_stats_in_items_5_p_0(Items_18, (MR_Word) (&parse_tree__prog_item_stats_scalar_common_2[0]), &ItemStats_33, Var_30, &GoalStats_34);
        {
          SectionStats_35 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), SectionStats_35, 0) = ((MR_Box) (ItemStats_33));
          MR_hl_field(MR_mktag(0), SectionStats_35, 1) = ((MR_Box) (GoalStats_34));
  ...
  MR_Word * STATE_VARIABLE_CompUnitStats_4)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      succeeded = mercury__map__search_3_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&parse_tree__prog_item_stats__parse_tree__prog_item_stats__type_ctor_info_section_stats_0), STATE_VARIABLE_CompUnitStats_0_3, ((MR_Box) ((MR_String) "int_for_opt_imported")), &conv0_SectionStats0_20);
      if (succeeded)
      {
        SectionStats0_20 = ((MR_Word) (conv0_SectionStats0_20));
        succeeded = MR_TRUE;
      ...
      if (succeeded)
      {
        ...
        mercury__map__det_update_4_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&parse_tree__prog_item_stats__parse_tree__prog_item_stats__type_ctor_info_section_stats_0), ((MR_Box) ((MR_String) "int_for_opt_imported")), ((MR_Box) (SectionStats_25)), STATE_VARIABLE_CompUnitStats_0_3, &STATE_VARIABLE_CompUnitStats_28_28);
      }
      else
      {
        MR_Word ItemStats_33;
        ...
        mercury__map__det_insert_4_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&parse_tree__prog_item_stats__parse_tree__prog_item_stats__type_ctor_info_section_stats_0), ((MR_Box) ((MR_String) "int_for_opt_imported")), ((MR_Box) (SectionStats_35)), STATE_VARIABLE_CompUnitStats_0_3, &STATE_VARIABLE_CompUnitStats_28_28);
      }
      // direct tailcall eliminated
      ;
      next_value_of_HeadVar__2_2 = ItemBlocks_11;
  ...
  MR_Word * STATE_VARIABLE_CompUnitStats_4)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      succeeded = mercury__map__search_3_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&parse_tree__prog_item_stats__parse_tree__prog_item_stats__type_ctor_info_section_stats_0), STATE_VARIABLE_CompUnitStats_0_3, ((MR_Box) ((MR_String) "opt_imported")), &conv0_SectionStats0_20);
      if (succeeded)
      {
        SectionStats0_20 = ((MR_Word) (conv0_SectionStats0_20));
        succeeded = MR_TRUE;
      ...
      if (succeeded)
      {
        ...
        mercury__map__det_update_4_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&parse_tree__prog_item_stats__parse_tree__prog_item_stats__type_ctor_info_section_stats_0), ((MR_Box) ((MR_String) "opt_imported")), ((MR_Box) (SectionStats_25)), STATE_VARIABLE_CompUnitStats_0_3, &STATE_VARIABLE_CompUnitStats_28_28);
      }
      else
      {
        MR_Word ItemStats_33;
        ...
        mercury__map__det_insert_4_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&parse_tree__prog_item_stats__parse_tree__prog_item_stats__type_ctor_info_section_stats_0), ((MR_Box) ((MR_String) "opt_imported")), ((MR_Box) (SectionStats_35)), STATE_VARIABLE_CompUnitStats_0_3, &STATE_VARIABLE_CompUnitStats_28_28);
      }
      // direct tailcall eliminated
      ;
      next_value_of_HeadVar__2_2 = ItemBlocks_11;
  ...
  MR_Word * STATE_VARIABLE_GoalStats_38)
{
  switch (MR_tag((MR_Word) Item_6)) {
    ...
    case (MR_Integer) 0:
      {
        ...
        MR_Integer Var_97;
        MR_Integer Var_98 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 0))));
        MR_Integer Var_101 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 1))));
        MR_Integer Var_102 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 2))));
        MR_Integer Var_103 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 3))));
        MR_Integer Var_104 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 4))));
        MR_Integer Var_105 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 5))));
        MR_Integer Var_106 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 6))));
        MR_Integer Var_107 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 7))));
        MR_Integer Var_108 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 8))));
        MR_Integer Var_109 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 9))));
        MR_Integer Var_110 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 10))));
        MR_Integer Var_111 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 11))));
        MR_Integer Var_112 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 12))));
        MR_Integer Var_113 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 13))));
        MR_Integer Var_114 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 14))));
        MR_Integer Var_115 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 15))));
        MR_Integer Var_116 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 16))));
        MR_Integer Var_117 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 17))));
        MR_Integer Var_118 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 18))));
        MR_Integer Var_119 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 19))));
        MR_Integer Var_120 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 20))));
        MR_Integer Var_121 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 21))));
        MR_Integer Var_122 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 22))));

        Var_97 = (MR_Integer) ((MR_Unsigned) Var_98 + (MR_Unsigned) 1);
        {
          MR_Word base;
          base = (MR_Word) MR_new_object(MR_Word, (23 * sizeof(MR_Word)), NULL, NULL);
          *STATE_VARIABLE_ItemStats_36 = base;
        ...
        if (((MR_tag((MR_Word) MaybeGoal_15)) == (MR_Integer) 0))
          *STATE_VARIABLE_GoalStats_38 = STATE_VARIABLE_GoalStats_0_37;
        else
        {
          MR_Word Goal_18 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MaybeGoal_15, (MR_Integer) 0))));

          parse_tree__prog_item_stats__gather_stats_in_goal_3_p_0(Goal_18, STATE_VARIABLE_GoalStats_0_37, STATE_VARIABLE_GoalStats_38);
        }
      }
      break;
    case (MR_Integer) 1:
      {
        MR_Integer Var_89;
        MR_Integer Var_90 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 2))));
        MR_Integer Var_191 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 0))));
        MR_Integer Var_192 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 1))));
        MR_Integer Var_193 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 3))));
        MR_Integer Var_194 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 4))));
        MR_Integer Var_195 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 5))));
        MR_Integer Var_196 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 6))));
        MR_Integer Var_197 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 7))));
        MR_Integer Var_198 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 8))));
        MR_Integer Var_199 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 9))));
        MR_Integer Var_200 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 10))));
        MR_Integer Var_201 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 11))));
        MR_Integer Var_202 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 12))));
        MR_Integer Var_203 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 13))));
        MR_Integer Var_204 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 14))));
        MR_Integer Var_205 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 15))));
        MR_Integer Var_206 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 16))));
        MR_Integer Var_207 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 17))));
        MR_Integer Var_208 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 18))));
        MR_Integer Var_209 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 19))));
        MR_Integer Var_210 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 20))));
        MR_Integer Var_211 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 21))));
        MR_Integer Var_212 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 22))));
        ...
        Var_89 = (MR_Integer) ((MR_Unsigned) Var_90 + (MR_Unsigned) 1);
        {
          ...
          *STATE_VARIABLE_ItemStats_36 = base;
          ...
          MR_hl_field(MR_mktag(0), base, 3) = ((MR_Box) (Var_193));
          MR_hl_field(MR_mktag(0), base, 4) = ((MR_Box) (Var_194));
          MR_hl_field(MR_mktag(0), base, 5) = ((MR_Box) (Var_195));
          MR_hl_field(MR_mktag(0), base, 6) = ((MR_Box) (Var_196));
          MR_hl_field(MR_mktag(0), base, 7) = ((MR_Box) (Var_197));
          MR_hl_field(MR_mktag(0), base, 8) = ((MR_Box) (Var_198));
          MR_hl_field(MR_mktag(0), base, 9) = ((MR_Box) (Var_199));
          MR_hl_field(MR_mktag(0), base, 10) = ((MR_Box) (Var_200));
          MR_hl_field(MR_mktag(0), base, 11) = ((MR_Box) (Var_201));
          MR_hl_field(MR_mktag(0), base, 12) = ((MR_Box) (Var_202));
          MR_hl_field(MR_mktag(0), base, 13) = ((MR_Box) (Var_203));
          MR_hl_field(MR_mktag(0), base, 14) = ((MR_Box) (Var_204));
          MR_hl_field(MR_mktag(0), base, 15) = ((MR_Box) (Var_205));
          MR_hl_field(MR_mktag(0), base, 16) = ((MR_Box) (Var_206));
          MR_hl_field(MR_mktag(0), base, 17) = ((MR_Box) (Var_207));
          MR_hl_field(MR_mktag(0), base, 18) = ((MR_Box) (Var_208));
          MR_hl_field(MR_mktag(0), base, 19) = ((MR_Box) (Var_209));
          MR_hl_field(MR_mktag(0), base, 20) = ((MR_Box) (Var_210));
          MR_hl_field(MR_mktag(0), base, 21) = ((MR_Box) (Var_211));
          MR_hl_field(MR_mktag(0), base, 22) = ((MR_Box) (Var_212));
        }
        *STATE_VARIABLE_GoalStats_38 = STATE_VARIABLE_GoalStats_0_37;
      }
      break;
    case (MR_Integer) 2:
      {
        MR_Integer Var_85;
        MR_Integer Var_86 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 3))));
        MR_Integer Var_236 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 0))));
        MR_Integer Var_237 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 1))));
        MR_Integer Var_238 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 2))));
        MR_Integer Var_239 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 4))));
        MR_Integer Var_240 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 5))));
        MR_Integer Var_241 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 6))));
        MR_Integer Var_242 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 7))));
        MR_Integer Var_243 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 8))));
        MR_Integer Var_244 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 9))));
        MR_Integer Var_245 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 10))));
        MR_Integer Var_246 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 11))));
        MR_Integer Var_247 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 12))));
        MR_Integer Var_248 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 13))));
        MR_Integer Var_249 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 14))));
        MR_Integer Var_250 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 15))));
        MR_Integer Var_251 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 16))));
        MR_Integer Var_252 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 17))));
        MR_Integer Var_253 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 18))));
        MR_Integer Var_254 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 19))));
        MR_Integer Var_255 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 20))));
        MR_Integer Var_256 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 21))));
        MR_Integer Var_257 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 22))));
        ...
        Var_85 = (MR_Integer) ((MR_Unsigned) Var_86 + (MR_Unsigned) 1);
        {
          ...
          *STATE_VARIABLE_ItemStats_36 = base;
          ...
          MR_hl_field(MR_mktag(0), base, 5) = ((MR_Box) (Var_240));
          MR_hl_field(MR_mktag(0), base, 6) = ((MR_Box) (Var_241));
          MR_hl_field(MR_mktag(0), base, 7) = ((MR_Box) (Var_242));
          MR_hl_field(MR_mktag(0), base, 8) = ((MR_Box) (Var_243));
          MR_hl_field(MR_mktag(0), base, 9) = ((MR_Box) (Var_244));
          MR_hl_field(MR_mktag(0), base, 10) = ((MR_Box) (Var_245));
          MR_hl_field(MR_mktag(0), base, 11) = ((MR_Box) (Var_246));
          MR_hl_field(MR_mktag(0), base, 12) = ((MR_Box) (Var_247));
          MR_hl_field(MR_mktag(0), base, 13) = ((MR_Box) (Var_248));
          MR_hl_field(MR_mktag(0), base, 14) = ((MR_Box) (Var_249));
          MR_hl_field(MR_mktag(0), base, 15) = ((MR_Box) (Var_250));
          MR_hl_field(MR_mktag(0), base, 16) = ((MR_Box) (Var_251));
          MR_hl_field(MR_mktag(0), base, 17) = ((MR_Box) (Var_252));
          MR_hl_field(MR_mktag(0), base, 18) = ((MR_Box) (Var_253));
          MR_hl_field(MR_mktag(0), base, 19) = ((MR_Box) (Var_254));
          MR_hl_field(MR_mktag(0), base, 20) = ((MR_Box) (Var_255));
          MR_hl_field(MR_mktag(0), base, 21) = ((MR_Box) (Var_256));
          MR_hl_field(MR_mktag(0), base, 22) = ((MR_Box) (Var_257));
        }
        *STATE_VARIABLE_GoalStats_38 = STATE_VARIABLE_GoalStats_0_37;
      }
      break;
    case (MR_Integer) 3:
      switch (((MR_Integer) ((MR_hl_field(MR_mktag(3), Item_6, (MR_Integer) 0))))) {
        ...
        case (MR_Integer) 0:
          {
            MR_Integer Var_81;
            MR_Integer Var_82 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 4))));
            MR_Integer Var_281 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 0))));
            MR_Integer Var_282 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 1))));
            MR_Integer Var_283 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 2))));
            MR_Integer Var_284 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 3))));
            MR_Integer Var_285 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 5))));
            MR_Integer Var_286 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 6))));
            MR_Integer Var_287 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 7))));
            MR_Integer Var_288 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 8))));
            MR_Integer Var_289 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 9))));
            MR_Integer Var_290 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 10))));
            MR_Integer Var_291 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 11))));
            MR_Integer Var_292 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 12))));
            MR_Integer Var_293 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 13))));
            MR_Integer Var_294 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 14))));
            MR_Integer Var_295 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 15))));
            MR_Integer Var_296 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 16))));
            MR_Integer Var_297 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 17))));
            MR_Integer Var_298 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 18))));
            MR_Integer Var_299 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 19))));
            MR_Integer Var_300 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 20))));
            MR_Integer Var_301 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 21))));
            MR_Integer Var_302 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 22))));
            ...
            Var_81 = (MR_Integer) ((MR_Unsigned) Var_82 + (MR_Unsigned) 1);
            {
              ...
              *STATE_VARIABLE_ItemStats_36 = base;
              ...
              MR_hl_field(MR_mktag(0), base, 5) = ((MR_Box) (Var_285));
              MR_hl_field(MR_mktag(0), base, 6) = ((MR_Box) (Var_286));
              MR_hl_field(MR_mktag(0), base, 7) = ((MR_Box) (Var_287));
              MR_hl_field(MR_mktag(0), base, 8) = ((MR_Box) (Var_288));
              MR_hl_field(MR_mktag(0), base, 9) = ((MR_Box) (Var_289));
              MR_hl_field(MR_mktag(0), base, 10) = ((MR_Box) (Var_290));
              MR_hl_field(MR_mktag(0), base, 11) = ((MR_Box) (Var_291));
              MR_hl_field(MR_mktag(0), base, 12) = ((MR_Box) (Var_292));
              MR_hl_field(MR_mktag(0), base, 13) = ((MR_Box) (Var_293));
              MR_hl_field(MR_mktag(0), base, 14) = ((MR_Box) (Var_294));
              MR_hl_field(MR_mktag(0), base, 15) = ((MR_Box) (Var_295));
              MR_hl_field(MR_mktag(0), base, 16) = ((MR_Box) (Var_296));
              MR_hl_field(MR_mktag(0), base, 17) = ((MR_Box) (Var_297));
              MR_hl_field(MR_mktag(0), base, 18) = ((MR_Box) (Var_298));
              MR_hl_field(MR_mktag(0), base, 19) = ((MR_Box) (Var_299));
              MR_hl_field(MR_mktag(0), base, 20) = ((MR_Box) (Var_300));
              MR_hl_field(MR_mktag(0), base, 21) = ((MR_Box) (Var_301));
              MR_hl_field(MR_mktag(0), base, 22) = ((MR_Box) (Var_302));
            }
            *STATE_VARIABLE_GoalStats_38 = STATE_VARIABLE_GoalStats_0_37;
          }
          break;
        case (MR_Integer) 1:
          {
            MR_Integer Var_77;
            MR_Integer Var_78 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 5))));
            MR_Integer Var_326 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 0))));
            MR_Integer Var_327 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 1))));
            MR_Integer Var_328 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 2))));
            MR_Integer Var_329 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 3))));
            MR_Integer Var_330 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 4))));
            MR_Integer Var_331 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 6))));
            MR_Integer Var_332 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 7))));
            MR_Integer Var_333 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 8))));
            MR_Integer Var_334 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 9))));
            MR_Integer Var_335 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 10))));
            MR_Integer Var_336 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 11))));
            MR_Integer Var_337 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 12))));
            MR_Integer Var_338 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 13))));
            MR_Integer Var_339 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 14))));
            MR_Integer Var_340 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 15))));
            MR_Integer Var_341 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 16))));
            MR_Integer Var_342 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 17))));
            MR_Integer Var_343 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 18))));
            MR_Integer Var_344 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 19))));
            MR_Integer Var_345 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 20))));
            MR_Integer Var_346 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 21))));
            MR_Integer Var_347 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 22))));
            ...
            Var_77 = (MR_Integer) ((MR_Unsigned) Var_78 + (MR_Unsigned) 1);
            {
              ...
              *STATE_VARIABLE_ItemStats_36 = base;
              ...
              MR_hl_field(MR_mktag(0), base, 1) = ((MR_Box) (Var_327));
              MR_hl_field(MR_mktag(0), base, 2) = ((MR_Box) (Var_328));
              MR_hl_field(MR_mktag(0), base, 3) = ((MR_Box) (Var_329));
              MR_hl_field(MR_mktag(0), base, 4) = ((MR_Box) (Var_330));
              MR_hl_field(MR_mktag(0), base, 5) = ((MR_Box) (Var_77));
              MR_hl_field(MR_mktag(0), base, 6) = ((MR_Box) (Var_331));
              MR_hl_field(MR_mktag(0), base, 7) = ((MR_Box) (Var_332));
              MR_hl_field(MR_mktag(0), base, 8) = ((MR_Box) (Var_333));
              MR_hl_field(MR_mktag(0), base, 9) = ((MR_Box) (Var_334));
              MR_hl_field(MR_mktag(0), base, 10) = ((MR_Box) (Var_335));
              MR_hl_field(MR_mktag(0), base, 11) = ((MR_Box) (Var_336));
              MR_hl_field(MR_mktag(0), base, 12) = ((MR_Box) (Var_337));
              MR_hl_field(MR_mktag(0), base, 13) = ((MR_Box) (Var_338));
              MR_hl_field(MR_mktag(0), base, 14) = ((MR_Box) (Var_339));
              MR_hl_field(MR_mktag(0), base, 15) = ((MR_Box) (Var_340));
              MR_hl_field(MR_mktag(0), base, 16) = ((MR_Box) (Var_341));
              MR_hl_field(MR_mktag(0), base, 17) = ((MR_Box) (Var_342));
              MR_hl_field(MR_mktag(0), base, 18) = ((MR_Box) (Var_343));
              MR_hl_field(MR_mktag(0), base, 19) = ((MR_Box) (Var_344));
              MR_hl_field(MR_mktag(0), base, 20) = ((MR_Box) (Var_345));
              MR_hl_field(MR_mktag(0), base, 21) = ((MR_Box) (Var_346));
              MR_hl_field(MR_mktag(0), base, 22) = ((MR_Box) (Var_347));
            }
            *STATE_VARIABLE_GoalStats_38 = STATE_VARIABLE_GoalStats_0_37;
          }
          break;
        case (MR_Integer) 2:
          {
            MR_Integer Var_73;
            MR_Integer Var_74 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 7))));
            MR_Integer Var_371 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 0))));
            MR_Integer Var_372 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 1))));
            MR_Integer Var_373 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 2))));
            MR_Integer Var_374 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 3))));
            MR_Integer Var_375 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 4))));
            MR_Integer Var_376 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 5))));
            MR_Integer Var_377 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 6))));
            MR_Integer Var_378 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 8))));
            MR_Integer Var_379 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 9))));
            MR_Integer Var_380 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 10))));
            MR_Integer Var_381 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 11))));
            MR_Integer Var_382 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 12))));
            MR_Integer Var_383 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 13))));
            MR_Integer Var_384 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 14))));
            MR_Integer Var_385 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 15))));
            MR_Integer Var_386 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 16))));
            MR_Integer Var_387 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 17))));
            MR_Integer Var_388 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 18))));
            MR_Integer Var_389 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 19))));
            MR_Integer Var_390 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 20))));
            MR_Integer Var_391 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 21))));
            MR_Integer Var_392 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 22))));

            Var_73 = (MR_Integer) ((MR_Unsigned) Var_74 + (MR_Unsigned) 1);
            {
              MR_Word base;
              base = (MR_Word) MR_new_object(MR_Word, (23 * sizeof(MR_Word)), NULL, NULL);
              *STATE_VARIABLE_ItemStats_36 = base;
              MR_hl_field(MR_mktag(0), base, 0) = ((MR_Box) (Var_371));
              ...
              MR_hl_field(MR_mktag(0), base, 8) = ((MR_Box) (Var_378));
              MR_hl_field(MR_mktag(0), base, 9) = ((MR_Box) (Var_379));
              MR_hl_field(MR_mktag(0), base, 10) = ((MR_Box) (Var_380));
              MR_hl_field(MR_mktag(0), base, 11) = ((MR_Box) (Var_381));
              MR_hl_field(MR_mktag(0), base, 12) = ((MR_Box) (Var_382));
              MR_hl_field(MR_mktag(0), base, 13) = ((MR_Box) (Var_383));
              MR_hl_field(MR_mktag(0), base, 14) = ((MR_Box) (Var_384));
              MR_hl_field(MR_mktag(0), base, 15) = ((MR_Box) (Var_385));
              MR_hl_field(MR_mktag(0), base, 16) = ((MR_Box) (Var_386));
              MR_hl_field(MR_mktag(0), base, 17) = ((MR_Box) (Var_387));
              MR_hl_field(MR_mktag(0), base, 18) = ((MR_Box) (Var_388));
              MR_hl_field(MR_mktag(0), base, 19) = ((MR_Box) (Var_389));
              MR_hl_field(MR_mktag(0), base, 20) = ((MR_Box) (Var_390));
              MR_hl_field(MR_mktag(0), base, 21) = ((MR_Box) (Var_391));
              MR_hl_field(MR_mktag(0), base, 22) = ((MR_Box) (Var_392));
            }
            *STATE_VARIABLE_GoalStats_38 = STATE_VARIABLE_GoalStats_0_37;
          }
          break;
        case (MR_Integer) 3:
          {
            MR_Integer Var_69;
            MR_Integer Var_70 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 8))));
            MR_Integer Var_416 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 0))));
            MR_Integer Var_417 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 1))));
            MR_Integer Var_418 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 2))));
            MR_Integer Var_419 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 3))));
            MR_Integer Var_420 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 4))));
            MR_Integer Var_421 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 5))));
            MR_Integer Var_422 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 6))));
            MR_Integer Var_423 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 7))));
            MR_Integer Var_424 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 9))));
            MR_Integer Var_425 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 10))));
            MR_Integer Var_426 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 11))));
            MR_Integer Var_427 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 12))));
            MR_Integer Var_428 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 13))));
            MR_Integer Var_429 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 14))));
            MR_Integer Var_430 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 15))));
            MR_Integer Var_431 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 16))));
            MR_Integer Var_432 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 17))));
            MR_Integer Var_433 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 18))));
            MR_Integer Var_434 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 19))));
            MR_Integer Var_435 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 20))));
            MR_Integer Var_436 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 21))));
            MR_Integer Var_437 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 22))));
            ...
            Var_69 = (MR_Integer) ((MR_Unsigned) Var_70 + (MR_Unsigned) 1);
            {
              ...
              *STATE_VARIABLE_ItemStats_36 = base;
              ...
              MR_hl_field(MR_mktag(0), base, 1) = ((MR_Box) (Var_417));
              MR_hl_field(MR_mktag(0), base, 2) = ((MR_Box) (Var_418));
              MR_hl_field(MR_mktag(0), base, 3) = ((MR_Box) (Var_419));
              MR_hl_field(MR_mktag(0), base, 4) = ((MR_Box) (Var_420));
              MR_hl_field(MR_mktag(0), base, 5) = ((MR_Box) (Var_421));
              MR_hl_field(MR_mktag(0), base, 6) = ((MR_Box) (Var_422));
              MR_hl_field(MR_mktag(0), base, 7) = ((MR_Box) (Var_423));
              MR_hl_field(MR_mktag(0), base, 8) = ((MR_Box) (Var_69));
              MR_hl_field(MR_mktag(0), base, 9) = ((MR_Box) (Var_424));
              MR_hl_field(MR_mktag(0), base, 10) = ((MR_Box) (Var_425));
              MR_hl_field(MR_mktag(0), base, 11) = ((MR_Box) (Var_426));
              MR_hl_field(MR_mktag(0), base, 12) = ((MR_Box) (Var_427));
              MR_hl_field(MR_mktag(0), base, 13) = ((MR_Box) (Var_428));
              MR_hl_field(MR_mktag(0), base, 14) = ((MR_Box) (Var_429));
              MR_hl_field(MR_mktag(0), base, 15) = ((MR_Box) (Var_430));
              MR_hl_field(MR_mktag(0), base, 16) = ((MR_Box) (Var_431));
              MR_hl_field(MR_mktag(0), base, 17) = ((MR_Box) (Var_432));
              MR_hl_field(MR_mktag(0), base, 18) = ((MR_Box) (Var_433));
              MR_hl_field(MR_mktag(0), base, 19) = ((MR_Box) (Var_434));
              MR_hl_field(MR_mktag(0), base, 20) = ((MR_Box) (Var_435));
              MR_hl_field(MR_mktag(0), base, 21) = ((MR_Box) (Var_436));
              MR_hl_field(MR_mktag(0), base, 22) = ((MR_Box) (Var_437));
            }
            *STATE_VARIABLE_GoalStats_38 = STATE_VARIABLE_GoalStats_0_37;
          }
          break;
        case (MR_Integer) 4:
          {
            MR_Integer Var_64;
            MR_Integer Var_65 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 16))));
            MR_Integer Var_461 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 0))));
            MR_Integer Var_462 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 1))));
            MR_Integer Var_463 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 2))));
            MR_Integer Var_464 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 3))));
            MR_Integer Var_465 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 4))));
            MR_Integer Var_466 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 5))));
            MR_Integer Var_467 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 6))));
            MR_Integer Var_468 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 7))));
            MR_Integer Var_469 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 8))));
            MR_Integer Var_470 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 9))));
            MR_Integer Var_471 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 10))));
            MR_Integer Var_472 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 11))));
            MR_Integer Var_473 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 12))));
            MR_Integer Var_474 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 13))));
            MR_Integer Var_475 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 14))));
            MR_Integer Var_476 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 15))));
            MR_Integer Var_477 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 17))));
            MR_Integer Var_478 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 18))));
            MR_Integer Var_479 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 19))));
            MR_Integer Var_480 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 20))));
            MR_Integer Var_481 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 21))));
            MR_Integer Var_482 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 22))));
            ...
            Var_64 = (MR_Integer) ((MR_Unsigned) Var_65 + (MR_Unsigned) 1);
            {
              ...
              base = (MR_Word) MR_new_object(MR_Word, (23 * sizeof(MR_Word)), NULL, NULL);
              *STATE_VARIABLE_ItemStats_36 = base;
              MR_hl_field(MR_mktag(0), base, 0) = ((MR_Box) (Var_461));
              MR_hl_field(MR_mktag(0), base, 1) = ((MR_Box) (Var_462));
              MR_hl_field(MR_mktag(0), base, 2) = ((MR_Box) (Var_463));
              MR_hl_field(MR_mktag(0), base, 3) = ((MR_Box) (Var_464));
              MR_hl_field(MR_mktag(0), base, 4) = ((MR_Box) (Var_465));
              MR_hl_field(MR_mktag(0), base, 5) = ((MR_Box) (Var_466));
              MR_hl_field(MR_mktag(0), base, 6) = ((MR_Box) (Var_467));
              MR_hl_field(MR_mktag(0), base, 7) = ((MR_Box) (Var_468));
              MR_hl_field(MR_mktag(0), base, 8) = ((MR_Box) (Var_469));
              MR_hl_field(MR_mktag(0), base, 9) = ((MR_Box) (Var_470));
              MR_hl_field(MR_mktag(0), base, 10) = ((MR_Box) (Var_471));
              MR_hl_field(MR_mktag(0), base, 11) = ((MR_Box) (Var_472));
              MR_hl_field(MR_mktag(0), base, 12) = ((MR_Box) (Var_473));
              MR_hl_field(MR_mktag(0), base, 13) = ((MR_Box) (Var_474));
              MR_hl_field(MR_mktag(0), base, 14) = ((MR_Box) (Var_475));
              MR_hl_field(MR_mktag(0), base, 15) = ((MR_Box) (Var_476));
              MR_hl_field(MR_mktag(0), base, 16) = ((MR_Box) (Var_64));
              MR_hl_field(MR_mktag(0), base, 17) = ((MR_Box) (Var_477));
              MR_hl_field(MR_mktag(0), base, 18) = ((MR_Box) (Var_478));
              MR_hl_field(MR_mktag(0), base, 19) = ((MR_Box) (Var_479));
              MR_hl_field(MR_mktag(0), base, 20) = ((MR_Box) (Var_480));
              MR_hl_field(MR_mktag(0), base, 21) = ((MR_Box) (Var_481));
              MR_hl_field(MR_mktag(0), base, 22) = ((MR_Box) (Var_482));
            }
            *STATE_VARIABLE_GoalStats_38 = STATE_VARIABLE_GoalStats_0_37;
          }
          break;
        case (MR_Integer) 5:
          {
            MR_Integer Var_60;
            MR_Integer Var_61 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 17))));
            MR_Integer Var_506 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 0))));
            MR_Integer Var_507 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 1))));
            MR_Integer Var_508 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 2))));
            MR_Integer Var_509 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 3))));
            MR_Integer Var_510 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 4))));
            MR_Integer Var_511 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 5))));
            MR_Integer Var_512 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 6))));
            MR_Integer Var_513 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 7))));
            MR_Integer Var_514 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 8))));
            MR_Integer Var_515 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 9))));
            MR_Integer Var_516 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 10))));
            MR_Integer Var_517 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 11))));
            MR_Integer Var_518 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 12))));
            MR_Integer Var_519 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 13))));
            MR_Integer Var_520 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 14))));
            MR_Integer Var_521 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 15))));
            MR_Integer Var_522 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 16))));
            MR_Integer Var_523 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 18))));
            MR_Integer Var_524 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 19))));
            MR_Integer Var_525 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 20))));
            MR_Integer Var_526 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 21))));
            MR_Integer Var_527 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 22))));
            ...
            Var_60 = (MR_Integer) ((MR_Unsigned) Var_61 + (MR_Unsigned) 1);
            {
              ...
              base = (MR_Word) MR_new_object(MR_Word, (23 * sizeof(MR_Word)), NULL, NULL);
              *STATE_VARIABLE_ItemStats_36 = base;
              MR_hl_field(MR_mktag(0), base, 0) = ((MR_Box) (Var_506));
              MR_hl_field(MR_mktag(0), base, 1) = ((MR_Box) (Var_507));
              MR_hl_field(MR_mktag(0), base, 2) = ((MR_Box) (Var_508));
              MR_hl_field(MR_mktag(0), base, 3) = ((MR_Box) (Var_509));
              MR_hl_field(MR_mktag(0), base, 4) = ((MR_Box) (Var_510));
              MR_hl_field(MR_mktag(0), base, 5) = ((MR_Box) (Var_511));
              MR_hl_field(MR_mktag(0), base, 6) = ((MR_Box) (Var_512));
              MR_hl_field(MR_mktag(0), base, 7) = ((MR_Box) (Var_513));
              MR_hl_field(MR_mktag(0), base, 8) = ((MR_Box) (Var_514));
              MR_hl_field(MR_mktag(0), base, 9) = ((MR_Box) (Var_515));
              MR_hl_field(MR_mktag(0), base, 10) = ((MR_Box) (Var_516));
              MR_hl_field(MR_mktag(0), base, 11) = ((MR_Box) (Var_517));
              MR_hl_field(MR_mktag(0), base, 12) = ((MR_Box) (Var_518));
              MR_hl_field(MR_mktag(0), base, 13) = ((MR_Box) (Var_519));
              MR_hl_field(MR_mktag(0), base, 14) = ((MR_Box) (Var_520));
              MR_hl_field(MR_mktag(0), base, 15) = ((MR_Box) (Var_521));
              MR_hl_field(MR_mktag(0), base, 16) = ((MR_Box) (Var_522));
              MR_hl_field(MR_mktag(0), base, 17) = ((MR_Box) (Var_60));
              MR_hl_field(MR_mktag(0), base, 18) = ((MR_Box) (Var_523));
              MR_hl_field(MR_mktag(0), base, 19) = ((MR_Box) (Var_524));
              MR_hl_field(MR_mktag(0), base, 20) = ((MR_Box) (Var_525));
              MR_hl_field(MR_mktag(0), base, 21) = ((MR_Box) (Var_526));
              MR_hl_field(MR_mktag(0), base, 22) = ((MR_Box) (Var_527));
            }
            *STATE_VARIABLE_GoalStats_38 = STATE_VARIABLE_GoalStats_0_37;
          }
          break;
        case (MR_Integer) 6:
          {
            MR_Integer Var_56;
            MR_Integer Var_57 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 18))));
            MR_Integer Var_551 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 0))));
            MR_Integer Var_552 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 1))));
            MR_Integer Var_553 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 2))));
            MR_Integer Var_554 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 3))));
            MR_Integer Var_555 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 4))));
            MR_Integer Var_556 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 5))));
            MR_Integer Var_557 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 6))));
            MR_Integer Var_558 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 7))));
            MR_Integer Var_559 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 8))));
            MR_Integer Var_560 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 9))));
            MR_Integer Var_561 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 10))));
            MR_Integer Var_562 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 11))));
            MR_Integer Var_563 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 12))));
            MR_Integer Var_564 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 13))));
            MR_Integer Var_565 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 14))));
            MR_Integer Var_566 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 15))));
            MR_Integer Var_567 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 16))));
            MR_Integer Var_568 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 17))));
            MR_Integer Var_569 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 19))));
            MR_Integer Var_570 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 20))));
            MR_Integer Var_571 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 21))));
            MR_Integer Var_572 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 22))));
            ...
            Var_56 = (MR_Integer) ((MR_Unsigned) Var_57 + (MR_Unsigned) 1);
            {
              ...
              *STATE_VARIABLE_ItemStats_36 = base;
              ...
              MR_hl_field(MR_mktag(0), base, 6) = ((MR_Box) (Var_557));
              MR_hl_field(MR_mktag(0), base, 7) = ((MR_Box) (Var_558));
              MR_hl_field(MR_mktag(0), base, 8) = ((MR_Box) (Var_559));
              MR_hl_field(MR_mktag(0), base, 9) = ((MR_Box) (Var_560));
              MR_hl_field(MR_mktag(0), base, 10) = ((MR_Box) (Var_561));
              MR_hl_field(MR_mktag(0), base, 11) = ((MR_Box) (Var_562));
              MR_hl_field(MR_mktag(0), base, 12) = ((MR_Box) (Var_563));
              MR_hl_field(MR_mktag(0), base, 13) = ((MR_Box) (Var_564));
              MR_hl_field(MR_mktag(0), base, 14) = ((MR_Box) (Var_565));
              MR_hl_field(MR_mktag(0), base, 15) = ((MR_Box) (Var_566));
              MR_hl_field(MR_mktag(0), base, 16) = ((MR_Box) (Var_567));
              MR_hl_field(MR_mktag(0), base, 17) = ((MR_Box) (Var_568));
              MR_hl_field(MR_mktag(0), base, 18) = ((MR_Box) (Var_56));
              MR_hl_field(MR_mktag(0), base, 19) = ((MR_Box) (Var_569));
              MR_hl_field(MR_mktag(0), base, 20) = ((MR_Box) (Var_570));
              MR_hl_field(MR_mktag(0), base, 21) = ((MR_Box) (Var_571));
              MR_hl_field(MR_mktag(0), base, 22) = ((MR_Box) (Var_572));
            }
            *STATE_VARIABLE_GoalStats_38 = STATE_VARIABLE_GoalStats_0_37;
          }
          break;
        case (MR_Integer) 7:
          {
            MR_Integer Var_52;
            MR_Integer Var_53 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 19))));
            MR_Integer Var_596 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 0))));
            MR_Integer Var_597 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 1))));
            MR_Integer Var_598 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 2))));
            MR_Integer Var_599 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 3))));
            MR_Integer Var_600 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 4))));
            MR_Integer Var_601 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 5))));
            MR_Integer Var_602 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 6))));
            MR_Integer Var_603 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 7))));
            MR_Integer Var_604 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 8))));
            MR_Integer Var_605 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 9))));
            MR_Integer Var_606 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 10))));
            MR_Integer Var_607 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 11))));
            MR_Integer Var_608 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 12))));
            MR_Integer Var_609 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 13))));
            MR_Integer Var_610 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 14))));
            MR_Integer Var_611 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 15))));
            MR_Integer Var_612 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 16))));
            MR_Integer Var_613 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 17))));
            MR_Integer Var_614 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 18))));
            MR_Integer Var_615 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 20))));
            MR_Integer Var_616 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 21))));
            MR_Integer Var_617 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 22))));
            ...
            Var_52 = (MR_Integer) ((MR_Unsigned) Var_53 + (MR_Unsigned) 1);
            {
              ...
              base = (MR_Word) MR_new_object(MR_Word, (23 * sizeof(MR_Word)), NULL, NULL);
              *STATE_VARIABLE_ItemStats_36 = base;
              MR_hl_field(MR_mktag(0), base, 0) = ((MR_Box) (Var_596));
              MR_hl_field(MR_mktag(0), base, 1) = ((MR_Box) (Var_597));
              MR_hl_field(MR_mktag(0), base, 2) = ((MR_Box) (Var_598));
              MR_hl_field(MR_mktag(0), base, 3) = ((MR_Box) (Var_599));
              MR_hl_field(MR_mktag(0), base, 4) = ((MR_Box) (Var_600));
              MR_hl_field(MR_mktag(0), base, 5) = ((MR_Box) (Var_601));
              MR_hl_field(MR_mktag(0), base, 6) = ((MR_Box) (Var_602));
              MR_hl_field(MR_mktag(0), base, 7) = ((MR_Box) (Var_603));
              MR_hl_field(MR_mktag(0), base, 8) = ((MR_Box) (Var_604));
              MR_hl_field(MR_mktag(0), base, 9) = ((MR_Box) (Var_605));
              MR_hl_field(MR_mktag(0), base, 10) = ((MR_Box) (Var_606));
              MR_hl_field(MR_mktag(0), base, 11) = ((MR_Box) (Var_607));
              MR_hl_field(MR_mktag(0), base, 12) = ((MR_Box) (Var_608));
              MR_hl_field(MR_mktag(0), base, 13) = ((MR_Box) (Var_609));
              MR_hl_field(MR_mktag(0), base, 14) = ((MR_Box) (Var_610));
              MR_hl_field(MR_mktag(0), base, 15) = ((MR_Box) (Var_611));
              MR_hl_field(MR_mktag(0), base, 16) = ((MR_Box) (Var_612));
              MR_hl_field(MR_mktag(0), base, 17) = ((MR_Box) (Var_613));
              MR_hl_field(MR_mktag(0), base, 18) = ((MR_Box) (Var_614));
              MR_hl_field(MR_mktag(0), base, 19) = ((MR_Box) (Var_52));
              MR_hl_field(MR_mktag(0), base, 20) = ((MR_Box) (Var_615));
              MR_hl_field(MR_mktag(0), base, 21) = ((MR_Box) (Var_616));
              MR_hl_field(MR_mktag(0), base, 22) = ((MR_Box) (Var_617));
            }
            *STATE_VARIABLE_GoalStats_38 = STATE_VARIABLE_GoalStats_0_37;
          }
          break;
        case (MR_Integer) 8:
          {
            MR_Integer Var_48;
            MR_Integer Var_49 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 20))));
            MR_Integer Var_641 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 0))));
            MR_Integer Var_642 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 1))));
            MR_Integer Var_643 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 2))));
            MR_Integer Var_644 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 3))));
            MR_Integer Var_645 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 4))));
            MR_Integer Var_646 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 5))));
            MR_Integer Var_647 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 6))));
            MR_Integer Var_648 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 7))));
            MR_Integer Var_649 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 8))));
            MR_Integer Var_650 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 9))));
            MR_Integer Var_651 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 10))));
            MR_Integer Var_652 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 11))));
            MR_Integer Var_653 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 12))));
            MR_Integer Var_654 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 13))));
            MR_Integer Var_655 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 14))));
            MR_Integer Var_656 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 15))));
            MR_Integer Var_657 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 16))));
            MR_Integer Var_658 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 17))));
            MR_Integer Var_659 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 18))));
            MR_Integer Var_660 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 19))));
            MR_Integer Var_661 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 21))));
            MR_Integer Var_662 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 22))));
            ...
            Var_48 = (MR_Integer) ((MR_Unsigned) Var_49 + (MR_Unsigned) 1);
            {
              ...
              base = (MR_Word) MR_new_object(MR_Word, (23 * sizeof(MR_Word)), NULL, NULL);
              *STATE_VARIABLE_ItemStats_36 = base;
              MR_hl_field(MR_mktag(0), base, 0) = ((MR_Box) (Var_641));
              MR_hl_field(MR_mktag(0), base, 1) = ((MR_Box) (Var_642));
              MR_hl_field(MR_mktag(0), base, 2) = ((MR_Box) (Var_643));
              MR_hl_field(MR_mktag(0), base, 3) = ((MR_Box) (Var_644));
              MR_hl_field(MR_mktag(0), base, 4) = ((MR_Box) (Var_645));
              MR_hl_field(MR_mktag(0), base, 5) = ((MR_Box) (Var_646));
              MR_hl_field(MR_mktag(0), base, 6) = ((MR_Box) (Var_647));
              MR_hl_field(MR_mktag(0), base, 7) = ((MR_Box) (Var_648));
              MR_hl_field(MR_mktag(0), base, 8) = ((MR_Box) (Var_649));
              MR_hl_field(MR_mktag(0), base, 9) = ((MR_Box) (Var_650));
              MR_hl_field(MR_mktag(0), base, 10) = ((MR_Box) (Var_651));
              MR_hl_field(MR_mktag(0), base, 11) = ((MR_Box) (Var_652));
              MR_hl_field(MR_mktag(0), base, 12) = ((MR_Box) (Var_653));
              MR_hl_field(MR_mktag(0), base, 13) = ((MR_Box) (Var_654));
              MR_hl_field(MR_mktag(0), base, 14) = ((MR_Box) (Var_655));
              MR_hl_field(MR_mktag(0), base, 15) = ((MR_Box) (Var_656));
              MR_hl_field(MR_mktag(0), base, 16) = ((MR_Box) (Var_657));
              MR_hl_field(MR_mktag(0), base, 17) = ((MR_Box) (Var_658));
              MR_hl_field(MR_mktag(0), base, 18) = ((MR_Box) (Var_659));
              MR_hl_field(MR_mktag(0), base, 19) = ((MR_Box) (Var_660));
              MR_hl_field(MR_mktag(0), base, 20) = ((MR_Box) (Var_48));
              MR_hl_field(MR_mktag(0), base, 21) = ((MR_Box) (Var_661));
              MR_hl_field(MR_mktag(0), base, 22) = ((MR_Box) (Var_662));
            }
            *STATE_VARIABLE_GoalStats_38 = STATE_VARIABLE_GoalStats_0_37;
          }
          break;
        case (MR_Integer) 9:
          {
            MR_Integer Var_44;
            MR_Integer Var_45 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 21))));
            MR_Integer Var_686 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 0))));
            MR_Integer Var_687 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 1))));
            MR_Integer Var_688 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 2))));
            MR_Integer Var_689 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 3))));
            MR_Integer Var_690 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 4))));
            MR_Integer Var_691 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 5))));
            MR_Integer Var_692 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 6))));
            MR_Integer Var_693 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 7))));
            MR_Integer Var_694 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 8))));
            MR_Integer Var_695 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 9))));
            MR_Integer Var_696 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 10))));
            MR_Integer Var_697 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 11))));
            MR_Integer Var_698 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 12))));
            MR_Integer Var_699 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 13))));
            MR_Integer Var_700 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 14))));
            MR_Integer Var_701 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 15))));
            MR_Integer Var_702 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 16))));
            MR_Integer Var_703 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 17))));
            MR_Integer Var_704 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 18))));
            MR_Integer Var_705 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 19))));
            MR_Integer Var_706 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 20))));
            MR_Integer Var_707 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 22))));

            Var_44 = (MR_Integer) ((MR_Unsigned) Var_45 + (MR_Unsigned) 1);
            {
              MR_Word base;
              base = (MR_Word) MR_new_object(MR_Word, (23 * sizeof(MR_Word)), NULL, NULL);
              *STATE_VARIABLE_ItemStats_36 = base;
              MR_hl_field(MR_mktag(0), base, 0) = ((MR_Box) (Var_686));
              MR_hl_field(MR_mktag(0), base, 1) = ((MR_Box) (Var_687));
              MR_hl_field(MR_mktag(0), base, 2) = ((MR_Box) (Var_688));
              MR_hl_field(MR_mktag(0), base, 3) = ((MR_Box) (Var_689));
              MR_hl_field(MR_mktag(0), base, 4) = ((MR_Box) (Var_690));
              MR_hl_field(MR_mktag(0), base, 5) = ((MR_Box) (Var_691));
              MR_hl_field(MR_mktag(0), base, 6) = ((MR_Box) (Var_692));
              MR_hl_field(MR_mktag(0), base, 7) = ((MR_Box) (Var_693));
              MR_hl_field(MR_mktag(0), base, 8) = ((MR_Box) (Var_694));
              MR_hl_field(MR_mktag(0), base, 9) = ((MR_Box) (Var_695));
              MR_hl_field(MR_mktag(0), base, 10) = ((MR_Box) (Var_696));
              MR_hl_field(MR_mktag(0), base, 11) = ((MR_Box) (Var_697));
              MR_hl_field(MR_mktag(0), base, 12) = ((MR_Box) (Var_698));
              MR_hl_field(MR_mktag(0), base, 13) = ((MR_Box) (Var_699));
              MR_hl_field(MR_mktag(0), base, 14) = ((MR_Box) (Var_700));
              MR_hl_field(MR_mktag(0), base, 15) = ((MR_Box) (Var_701));
              MR_hl_field(MR_mktag(0), base, 16) = ((MR_Box) (Var_702));
              MR_hl_field(MR_mktag(0), base, 17) = ((MR_Box) (Var_703));
              MR_hl_field(MR_mktag(0), base, 18) = ((MR_Box) (Var_704));
              MR_hl_field(MR_mktag(0), base, 19) = ((MR_Box) (Var_705));
              MR_hl_field(MR_mktag(0), base, 20) = ((MR_Box) (Var_706));
              MR_hl_field(MR_mktag(0), base, 21) = ((MR_Box) (Var_44));
              MR_hl_field(MR_mktag(0), base, 22) = ((MR_Box) (Var_707));
            }
            *STATE_VARIABLE_GoalStats_38 = STATE_VARIABLE_GoalStats_0_37;
          }
          break;
        case (MR_Integer) 10:
          {
            MR_Integer Var_40;
            MR_Integer Var_41 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 22))));
            MR_Integer Var_731 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 0))));
            MR_Integer Var_732 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 1))));
            MR_Integer Var_733 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 2))));
            MR_Integer Var_734 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 3))));
            MR_Integer Var_735 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 4))));
            MR_Integer Var_736 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 5))));
            MR_Integer Var_737 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 6))));
            MR_Integer Var_738 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 7))));
            MR_Integer Var_739 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 8))));
            MR_Integer Var_740 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 9))));
            MR_Integer Var_741 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 10))));
            MR_Integer Var_742 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 11))));
            MR_Integer Var_743 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 12))));
            MR_Integer Var_744 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 13))));
            MR_Integer Var_745 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 14))));
            MR_Integer Var_746 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 15))));
            MR_Integer Var_747 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 16))));
            MR_Integer Var_748 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 17))));
            MR_Integer Var_749 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 18))));
            MR_Integer Var_750 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 19))));
            MR_Integer Var_751 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 20))));
            MR_Integer Var_752 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 21))));

            Var_40 = (MR_Integer) ((MR_Unsigned) Var_41 + (MR_Unsigned) 1);
            {
              MR_Word base;
              base = (MR_Word) MR_new_object(MR_Word, (23 * sizeof(MR_Word)), NULL, NULL);
              *STATE_VARIABLE_ItemStats_36 = base;
              MR_hl_field(MR_mktag(0), base, 0) = ((MR_Box) (Var_731));
              MR_hl_field(MR_mktag(0), base, 1) = ((MR_Box) (Var_732));
              MR_hl_field(MR_mktag(0), base, 2) = ((MR_Box) (Var_733));
              MR_hl_field(MR_mktag(0), base, 3) = ((MR_Box) (Var_734));
              MR_hl_field(MR_mktag(0), base, 4) = ((MR_Box) (Var_735));
              MR_hl_field(MR_mktag(0), base, 5) = ((MR_Box) (Var_736));
              MR_hl_field(MR_mktag(0), base, 6) = ((MR_Box) (Var_737));
              MR_hl_field(MR_mktag(0), base, 7) = ((MR_Box) (Var_738));
              MR_hl_field(MR_mktag(0), base, 8) = ((MR_Box) (Var_739));
              MR_hl_field(MR_mktag(0), base, 9) = ((MR_Box) (Var_740));
              MR_hl_field(MR_mktag(0), base, 10) = ((MR_Box) (Var_741));
              MR_hl_field(MR_mktag(0), base, 11) = ((MR_Box) (Var_742));
              MR_hl_field(MR_mktag(0), base, 12) = ((MR_Box) (Var_743));
              MR_hl_field(MR_mktag(0), base, 13) = ((MR_Box) (Var_744));
              MR_hl_field(MR_mktag(0), base, 14) = ((MR_Box) (Var_745));
              MR_hl_field(MR_mktag(0), base, 15) = ((MR_Box) (Var_746));
              MR_hl_field(MR_mktag(0), base, 16) = ((MR_Box) (Var_747));
              MR_hl_field(MR_mktag(0), base, 17) = ((MR_Box) (Var_748));
              MR_hl_field(MR_mktag(0), base, 18) = ((MR_Box) (Var_749));
              MR_hl_field(MR_mktag(0), base, 19) = ((MR_Box) (Var_750));
              MR_hl_field(MR_mktag(0), base, 20) = ((MR_Box) (Var_751));
              MR_hl_field(MR_mktag(0), base, 21) = ((MR_Box) (Var_752));
        ...
        case (MR_Integer) 11:
          {
            MR_Integer Var_93;
            MR_Integer Var_94 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 1))));
            MR_Integer Var_146 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 0))));
            MR_Integer Var_147 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 2))));
            MR_Integer Var_148 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 3))));
            MR_Integer Var_149 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 4))));
            MR_Integer Var_150 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 5))));
            MR_Integer Var_151 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 6))));
            MR_Integer Var_152 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 7))));
            MR_Integer Var_153 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 8))));
            MR_Integer Var_154 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 9))));
            MR_Integer Var_155 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 10))));
            MR_Integer Var_156 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 11))));
            MR_Integer Var_157 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 12))));
            MR_Integer Var_158 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 13))));
            MR_Integer Var_159 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 14))));
            MR_Integer Var_160 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 15))));
            MR_Integer Var_161 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 16))));
            MR_Integer Var_162 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 17))));
            MR_Integer Var_163 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 18))));
            MR_Integer Var_164 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 19))));
            MR_Integer Var_165 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 20))));
            MR_Integer Var_166 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 21))));
            MR_Integer Var_167 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_35, (MR_Integer) 22))));
            ...
            Var_93 = (MR_Integer) ((MR_Unsigned) Var_94 + (MR_Unsigned) 1);
            {
              ...
              *STATE_VARIABLE_ItemStats_36 = base;
              ...
              MR_hl_field(MR_mktag(0), base, 5) = ((MR_Box) (Var_150));
              MR_hl_field(MR_mktag(0), base, 6) = ((MR_Box) (Var_151));
              MR_hl_field(MR_mktag(0), base, 7) = ((MR_Box) (Var_152));
              MR_hl_field(MR_mktag(0), base, 8) = ((MR_Box) (Var_153));
              MR_hl_field(MR_mktag(0), base, 9) = ((MR_Box) (Var_154));
              MR_hl_field(MR_mktag(0), base, 10) = ((MR_Box) (Var_155));
              MR_hl_field(MR_mktag(0), base, 11) = ((MR_Box) (Var_156));
              MR_hl_field(MR_mktag(0), base, 12) = ((MR_Box) (Var_157));
              MR_hl_field(MR_mktag(0), base, 13) = ((MR_Box) (Var_158));
              MR_hl_field(MR_mktag(0), base, 14) = ((MR_Box) (Var_159));
              MR_hl_field(MR_mktag(0), base, 15) = ((MR_Box) (Var_160));
              MR_hl_field(MR_mktag(0), base, 16) = ((MR_Box) (Var_161));
              MR_hl_field(MR_mktag(0), base, 17) = ((MR_Box) (Var_162));
              MR_hl_field(MR_mktag(0), base, 18) = ((MR_Box) (Var_163));
              MR_hl_field(MR_mktag(0), base, 19) = ((MR_Box) (Var_164));
              MR_hl_field(MR_mktag(0), base, 20) = ((MR_Box) (Var_165));
              MR_hl_field(MR_mktag(0), base, 21) = ((MR_Box) (Var_166));
              MR_hl_field(MR_mktag(0), base, 22) = ((MR_Box) (Var_167));
            }
            *STATE_VARIABLE_GoalStats_38 = STATE_VARIABLE_GoalStats_0_37;
          }
          break;
        case (MR_Integer) 12:
          {
            MR_Word ItemPragmaInfo_27 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Item_6, (MR_Integer) 1))));

            parse_tree__prog_item_stats__gather_stats_in_item_pragma_3_p_0(ItemPragmaInfo_27, STATE_VARIABLE_ItemStats_0_35, STATE_VARIABLE_ItemStats_36);
            *STATE_VARIABLE_GoalStats_38 = STATE_VARIABLE_GoalStats_0_37;
          }
          break;
      }
...
{
  {
    ...
    MR_Integer Var_386 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_41, (MR_Integer) 22))));
    MR_Integer Var_387 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_41, (MR_Integer) 21))));
    MR_Integer Var_388 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_41, (MR_Integer) 20))));
    MR_Integer Var_389 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_41, (MR_Integer) 19))));
    MR_Integer Var_390 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_41, (MR_Integer) 18))));
    MR_Integer Var_391 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_41, (MR_Integer) 17))));
    MR_Integer Var_392 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_41, (MR_Integer) 16))));
    MR_Integer Var_393 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_41, (MR_Integer) 15))));
    MR_Integer Var_394 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_41, (MR_Integer) 14))));
    MR_Integer Var_395 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_41, (MR_Integer) 13))));
    MR_Integer Var_396 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_41, (MR_Integer) 12))));
    MR_Integer Var_397 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_41, (MR_Integer) 11))));
    MR_Integer Var_398 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_41, (MR_Integer) 10))));
    MR_Integer Var_399 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_41, (MR_Integer) 9))));
    MR_Integer Var_400 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_41, (MR_Integer) 8))));
    MR_Integer Var_401 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_41, (MR_Integer) 7))));
    MR_Integer Var_402 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_41, (MR_Integer) 6))));
    MR_Integer Var_403 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_41, (MR_Integer) 5))));
    MR_Integer Var_404 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_41, (MR_Integer) 4))));
    MR_Integer Var_405 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_41, (MR_Integer) 3))));
    MR_Integer Var_406 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_41, (MR_Integer) 2))));
    MR_Integer Var_407 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_41, (MR_Integer) 1))));
    MR_Integer Var_408 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ItemStats_0_41, (MR_Integer) 0))));
    ...
    switch (MR_tag((MR_Word) PragmaType_6)) {
      ...
      case (MR_Integer) 1:
        {
          MR_Integer Var_48 = (MR_Integer) ((MR_Unsigned) Var_394 + (MR_Unsigned) 1);

          {
            MR_Word base;
            base = (MR_Word) MR_new_object(MR_Word, (23 * sizeof(MR_Word)), NULL, NULL);
            *STATE_VARIABLE_ItemStats_42 = base;
            MR_hl_field(MR_mktag(0), base, 0) = ((MR_Box) (Var_408));
            MR_hl_field(MR_mktag(0), base, 1) = ((MR_Box) (Var_407));
            MR_hl_field(MR_mktag(0), base, 2) = ((MR_Box) (Var_406));
            MR_hl_field(MR_mktag(0), base, 3) = ((MR_Box) (Var_405));
            MR_hl_field(MR_mktag(0), base, 4) = ((MR_Box) (Var_404));
            MR_hl_field(MR_mktag(0), base, 5) = ((MR_Box) (Var_403));
            MR_hl_field(MR_mktag(0), base, 6) = ((MR_Box) (Var_402));
            MR_hl_field(MR_mktag(0), base, 7) = ((MR_Box) (Var_401));
            MR_hl_field(MR_mktag(0), base, 8) = ((MR_Box) (Var_400));
            MR_hl_field(MR_mktag(0), base, 9) = ((MR_Box) (Var_399));
            MR_hl_field(MR_mktag(0), base, 10) = ((MR_Box) (Var_398));
            MR_hl_field(MR_mktag(0), base, 11) = ((MR_Box) (Var_397));
            MR_hl_field(MR_mktag(0), base, 12) = ((MR_Box) (Var_396));
            MR_hl_field(MR_mktag(0), base, 13) = ((MR_Box) (Var_395));
            MR_hl_field(MR_mktag(0), base, 14) = ((MR_Box) (Var_48));
            MR_hl_field(MR_mktag(0), base, 15) = ((MR_Box) (Var_393));
            MR_hl_field(MR_mktag(0), base, 16) = ((MR_Box) (Var_392));
            MR_hl_field(MR_mktag(0), base, 17) = ((MR_Box) (Var_391));
            MR_hl_field(MR_mktag(0), base, 18) = ((MR_Box) (Var_390));
            MR_hl_field(MR_mktag(0), base, 19) = ((MR_Box) (Var_389));
            MR_hl_field(MR_mktag(0), base, 20) = ((MR_Box) (Var_388));
            MR_hl_field(MR_mktag(0), base, 21) = ((MR_Box) (Var_387));
            MR_hl_field(MR_mktag(0), base, 22) = ((MR_Box) (Var_386));
          }
        }
        break;
      case (MR_Integer) 2:
        {
          MR_Integer Var_44 = (MR_Integer) ((MR_Unsigned) Var_393 + (MR_Unsigned) 1);

          {
            ...
            *STATE_VARIABLE_ItemStats_42 = base;
            ...
            MR_hl_field(MR_mktag(0), base, 12) = ((MR_Box) (Var_396));
            MR_hl_field(MR_mktag(0), base, 13) = ((MR_Box) (Var_395));
            MR_hl_field(MR_mktag(0), base, 14) = ((MR_Box) (Var_394));
        ...
        break;
      case (MR_Integer) 3:
        switch (((MR_Integer) ((MR_hl_field(MR_mktag(3), PragmaType_6, (MR_Integer) 0))))) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 0:
          case (MR_Integer) 2:
          case (MR_Integer) 12:
          ...
          case (MR_Integer) 7:
            {
              MR_Integer Var_60 = (MR_Integer) ((MR_Unsigned) Var_397 + (MR_Unsigned) 1);
          ...
          case (MR_Integer) 8:
            {
              MR_Integer Var_56 = (MR_Integer) ((MR_Unsigned) Var_396 + (MR_Unsigned) 1);
          ...
          case (MR_Integer) 9:
            {
              MR_Integer Var_52 = (MR_Integer) ((MR_Unsigned) Var_395 + (MR_Unsigned) 1);

              {
                ...
                *STATE_VARIABLE_ItemStats_42 = base;
                ...
                MR_hl_field(MR_mktag(0), base, 11) = ((MR_Box) (Var_397));
                MR_hl_field(MR_mktag(0), base, 12) = ((MR_Box) (Var_396));
                MR_hl_field(MR_mktag(0), base, 13) = ((MR_Box) (Var_52));
                MR_hl_field(MR_mktag(0), base, 14) = ((MR_Box) (Var_394));
                MR_hl_field(MR_mktag(0), base, 15) = ((MR_Box) (Var_393));
                MR_hl_field(MR_mktag(0), base, 16) = ((MR_Box) (Var_392));
                MR_hl_field(MR_mktag(0), base, 17) = ((MR_Box) (Var_391));
          ...
          case (MR_Integer) 18:
            {
              MR_Integer Var_68 = (MR_Integer) ((MR_Unsigned) Var_399 + (MR_Unsigned) 1);
          ...
          case (MR_Integer) 19:
            {
              MR_Integer Var_64 = (MR_Integer) ((MR_Unsigned) Var_398 + (MR_Unsigned) 1);

              {
                ...
                *STATE_VARIABLE_ItemStats_42 = base;
                ...
                MR_hl_field(MR_mktag(0), base, 8) = ((MR_Box) (Var_400));
                MR_hl_field(MR_mktag(0), base, 9) = ((MR_Box) (Var_399));
                MR_hl_field(MR_mktag(0), base, 10) = ((MR_Box) (Var_64));
                MR_hl_field(MR_mktag(0), base, 11) = ((MR_Box) (Var_397));
                MR_hl_field(MR_mktag(0), base, 12) = ((MR_Box) (Var_396));
                MR_hl_field(MR_mktag(0), base, 13) = ((MR_Box) (Var_395));
                MR_hl_field(MR_mktag(0), base, 14) = ((MR_Box) (Var_394));
