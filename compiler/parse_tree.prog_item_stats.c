...
{
  {
    ...
    Var_51 = mdbcomp__sym_name__sym_name_to_string_1_f_0(Var_11);
    mercury__io__write_string_4_p_0(Stream_5, (MR_String) "MODULE ");
    mercury__io__write_string_4_p_0(Stream_5, Var_51);
    mercury__io__write_string_4_p_0(Stream_5, (MR_String) "\n");
    mercury__map__to_assoc_list_2_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&parse_tree__prog_item_stats__parse_tree__prog_item_stats__type_ctor_info_section_stats_0), CompUnitStats_8, &SectionStatPairs_46);
    {
      Var_53 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), Var_53, 0) = ((MR_Box) (&parse_tree__prog_item_stats_scalar_common_4[0]));
      MR_hl_field(MR_mktag(0), Var_53, 1) = ((MR_Box) (parse_tree__prog_item_stats__gather_and_write_item_stats_4_p_0_1));
      MR_hl_field(MR_mktag(0), Var_53, 2) = ((MR_Box) ((MR_Integer) 1));
      MR_hl_field(MR_mktag(0), Var_53, 3) = ((MR_Box) (Stream_5));
    }
    mercury__list__foldl_4_p_2((MR_Word) (&parse_tree__prog_item_stats_scalar_common_1[0]), (MR_Word) (&mercury__io__io__type_ctor_info_state_0), Var_53, SectionStatPairs_46, ((MR_Box) ((MR_Integer) 0)), &conv0_STATE_VARIABLE_IO_10);
  }
}
