...
parse_tree__prog_item_stats__gather_stats_in_item_decl_pragma_3_p_0(
  ...
  MR_Word STATE_VARIABLE_ItemStats_0_17,
  MR_Word * STATE_VARIABLE_ItemStats_18);
...
parse_tree__prog_item_stats__gather_stats_in_item_decl_pragma_3_p_0(
  ...
  MR_Word * STATE_VARIABLE_ItemStats_18)
{
  MR_Integer Var_190 = ((MR_Integer) ((MR_hl_field(0, STATE_VARIABLE_ItemStats_0_17, 26))));
  MR_Integer Var_191 = ((MR_Integer) ((MR_hl_field(0, STATE_VARIABLE_ItemStats_0_17, 25))));
  MR_Integer Var_192 = ((MR_Integer) ((MR_hl_field(0, STATE_VARIABLE_ItemStats_0_17, 24))));
  MR_Integer Var_193 = ((MR_Integer) ((MR_hl_field(0, STATE_VARIABLE_ItemStats_0_17, 23))));
  MR_Integer Var_194 = ((MR_Integer) ((MR_hl_field(0, STATE_VARIABLE_ItemStats_0_17, 22))));
  MR_Integer Var_195 = ((MR_Integer) ((MR_hl_field(0, STATE_VARIABLE_ItemStats_0_17, 21))));
  MR_Integer Var_196 = ((MR_Integer) ((MR_hl_field(0, STATE_VARIABLE_ItemStats_0_17, 20))));
  MR_Integer Var_197 = ((MR_Integer) ((MR_hl_field(0, STATE_VARIABLE_ItemStats_0_17, 19))));
  MR_Integer Var_198 = ((MR_Integer) ((MR_hl_field(0, STATE_VARIABLE_ItemStats_0_17, 18))));
  MR_Integer Var_199 = ((MR_Integer) ((MR_hl_field(0, STATE_VARIABLE_ItemStats_0_17, 17))));
  MR_Integer Var_200 = ((MR_Integer) ((MR_hl_field(0, STATE_VARIABLE_ItemStats_0_17, 16))));
  MR_Integer Var_201 = ((MR_Integer) ((MR_hl_field(0, STATE_VARIABLE_ItemStats_0_17, 15))));
  MR_Integer Var_202 = ((MR_Integer) ((MR_hl_field(0, STATE_VARIABLE_ItemStats_0_17, 14))));
  MR_Integer Var_203 = ((MR_Integer) ((MR_hl_field(0, STATE_VARIABLE_ItemStats_0_17, 13))));
  MR_Integer Var_204 = ((MR_Integer) ((MR_hl_field(0, STATE_VARIABLE_ItemStats_0_17, 12))));
  MR_Integer Var_205 = ((MR_Integer) ((MR_hl_field(0, STATE_VARIABLE_ItemStats_0_17, 11))));
  MR_Integer Var_206 = ((MR_Integer) ((MR_hl_field(0, STATE_VARIABLE_ItemStats_0_17, 10))));
  MR_Integer Var_207 = ((MR_Integer) ((MR_hl_field(0, STATE_VARIABLE_ItemStats_0_17, 9))));
  MR_Integer Var_208 = ((MR_Integer) ((MR_hl_field(0, STATE_VARIABLE_ItemStats_0_17, 8))));
  MR_Integer Var_209 = ((MR_Integer) ((MR_hl_field(0, STATE_VARIABLE_ItemStats_0_17, 7))));
  MR_Integer Var_210 = ((MR_Integer) ((MR_hl_field(0, STATE_VARIABLE_ItemStats_0_17, 6))));
  MR_Integer Var_211 = ((MR_Integer) ((MR_hl_field(0, STATE_VARIABLE_ItemStats_0_17, 5))));
  MR_Integer Var_212 = ((MR_Integer) ((MR_hl_field(0, STATE_VARIABLE_ItemStats_0_17, 4))));
  MR_Integer Var_213 = ((MR_Integer) ((MR_hl_field(0, STATE_VARIABLE_ItemStats_0_17, 3))));
  MR_Integer Var_214 = ((MR_Integer) ((MR_hl_field(0, STATE_VARIABLE_ItemStats_0_17, 2))));
  MR_Integer Var_215 = ((MR_Integer) ((MR_hl_field(0, STATE_VARIABLE_ItemStats_0_17, 1))));
  MR_Integer Var_216 = ((MR_Integer) ((MR_hl_field(0, STATE_VARIABLE_ItemStats_0_17, 0))));
  ...
  switch (MR_tag((MR_Word) DeclPragma_4)) {
    ...
    case (MR_Integer) 2:
      {
        MR_Integer Var_28 = (MR_Integer) ((MR_Unsigned) Var_204 + (MR_Unsigned) 1);

        {
          MR_Word base;
          base = (MR_Word) MR_new_object(MR_Word, (27 * sizeof(MR_Word)), NULL, NULL);
          *STATE_VARIABLE_ItemStats_18 = base;
          MR_hl_field(0, base, 0) = ((MR_Box) (Var_216));
          MR_hl_field(0, base, 1) = ((MR_Box) (Var_215));
          MR_hl_field(0, base, 2) = ((MR_Box) (Var_214));
          MR_hl_field(0, base, 3) = ((MR_Box) (Var_213));
          MR_hl_field(0, base, 4) = ((MR_Box) (Var_212));
          MR_hl_field(0, base, 5) = ((MR_Box) (Var_211));
          MR_hl_field(0, base, 6) = ((MR_Box) (Var_210));
          MR_hl_field(0, base, 7) = ((MR_Box) (Var_209));
          MR_hl_field(0, base, 8) = ((MR_Box) (Var_208));
          MR_hl_field(0, base, 9) = ((MR_Box) (Var_207));
          MR_hl_field(0, base, 10) = ((MR_Box) (Var_206));
          MR_hl_field(0, base, 11) = ((MR_Box) (Var_205));
          MR_hl_field(0, base, 12) = ((MR_Box) (Var_28));
          MR_hl_field(0, base, 13) = ((MR_Box) (Var_203));
          MR_hl_field(0, base, 14) = ((MR_Box) (Var_202));
          MR_hl_field(0, base, 15) = ((MR_Box) (Var_201));
          MR_hl_field(0, base, 16) = ((MR_Box) (Var_200));
          MR_hl_field(0, base, 17) = ((MR_Box) (Var_199));
          MR_hl_field(0, base, 18) = ((MR_Box) (Var_198));
          MR_hl_field(0, base, 19) = ((MR_Box) (Var_197));
          MR_hl_field(0, base, 20) = ((MR_Box) (Var_196));
          MR_hl_field(0, base, 21) = ((MR_Box) (Var_195));
          MR_hl_field(0, base, 22) = ((MR_Box) (Var_194));
          MR_hl_field(0, base, 23) = ((MR_Box) (Var_193));
          MR_hl_field(0, base, 24) = ((MR_Box) (Var_192));
          MR_hl_field(0, base, 25) = ((MR_Box) (Var_191));
          MR_hl_field(0, base, 26) = ((MR_Box) (Var_190));
        }
      }
      break;
    case (MR_Integer) 3:
      switch (((MR_Integer) ((MR_hl_field(3, DeclPragma_4, 0))))) {
        ...
        case (MR_Integer) 4:
          {
            MR_Integer Var_20 = (MR_Integer) ((MR_Unsigned) Var_206 + (MR_Unsigned) 1);

            {
              ...
              *STATE_VARIABLE_ItemStats_18 = base;
              ...
              MR_hl_field(0, base, 11) = ((MR_Box) (Var_205));
              MR_hl_field(0, base, 12) = ((MR_Box) (Var_204));
              MR_hl_field(0, base, 13) = ((MR_Box) (Var_203));
              MR_hl_field(0, base, 14) = ((MR_Box) (Var_202));
              MR_hl_field(0, base, 15) = ((MR_Box) (Var_201));
              MR_hl_field(0, base, 16) = ((MR_Box) (Var_200));
        ...
        case (MR_Integer) 5:
          {
            MR_Integer Var_24 = (MR_Integer) ((MR_Unsigned) Var_205 + (MR_Unsigned) 1);
  ...
  MR_Word AugCompUnit_6)
{
  ...
  mercury__map__to_assoc_list_2_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&parse_tree__prog_item_stats__parse_tree__prog_item_stats__type_ctor_info_section_stats_0), CompUnitStats_8, &SectionStatPairs_69);
  {
    ...
    MR_hl_field(0, Var_72, 0) = ((MR_Box) (&parse_tree__prog_item_stats_scalar_common_3[0]));
