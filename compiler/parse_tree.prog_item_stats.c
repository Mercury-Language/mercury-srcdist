  ...
  MR_Word HeadVar__2_2)
{
  ...
  MR_Integer Clause_20 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), ItemStats_9, (MR_Integer) 0))));
  MR_Integer TypeDefn_21 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), ItemStats_9, (MR_Integer) 1))));
  MR_Integer InstDefn_22 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), ItemStats_9, (MR_Integer) 2))));
  MR_Integer ModeDefn_23 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), ItemStats_9, (MR_Integer) 3))));
  MR_Integer PredDecl_24 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), ItemStats_9, (MR_Integer) 4))));
  MR_Integer ModeDecl_25 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), ItemStats_9, (MR_Integer) 5))));
  MR_Integer FIM_26 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), ItemStats_9, (MR_Integer) 6))));
  MR_Integer ForeignEnum_27 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), ItemStats_9, (MR_Integer) 7))));
  MR_Integer ForeignExportEnum_28 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), ItemStats_9, (MR_Integer) 8))));
  MR_Integer PragmaTerm_29 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), ItemStats_9, (MR_Integer) 9))));
  MR_Integer PragmaTerm2_30 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), ItemStats_9, (MR_Integer) 10))));
  MR_Integer PragmaDecl_31 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), ItemStats_9, (MR_Integer) 11))));
  MR_Integer PragmaImpl_32 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), ItemStats_9, (MR_Integer) 12))));
  MR_Integer PragmaUArgs_33 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), ItemStats_9, (MR_Integer) 13))));
  MR_Integer PragmaExcp_34 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), ItemStats_9, (MR_Integer) 14))));
  MR_Integer PragmaTrail_35 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), ItemStats_9, (MR_Integer) 15))));
  MR_Integer PragmaMM_36 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), ItemStats_9, (MR_Integer) 16))));
  MR_Integer Promise_37 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), ItemStats_9, (MR_Integer) 17))));
  MR_Integer Typeclass_38 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), ItemStats_9, (MR_Integer) 18))));
  MR_Integer Instance_39 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), ItemStats_9, (MR_Integer) 19))));
  MR_Integer Initialise_40 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), ItemStats_9, (MR_Integer) 20))));
  MR_Integer Finalise_41 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), ItemStats_9, (MR_Integer) 21))));
  MR_Integer Mutable_42 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), ItemStats_9, (MR_Integer) 22))));
  MR_Integer TypeRepn_43 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), ItemStats_9, (MR_Integer) 23))));

  parse_tree__prog_item_stats__write_one_stat_6_p_0(Stream_5, SectionName_6, (MR_String) "item_clause", Clause_20);
  parse_tree__prog_item_stats__write_one_stat_6_p_0(Stream_5, SectionName_6, (MR_String) "item_type_defn", TypeDefn_21);
  parse_tree__prog_item_stats__write_one_stat_6_p_0(Stream_5, SectionName_6, (MR_String) "item_inst_defn", InstDefn_22);
  parse_tree__prog_item_stats__write_one_stat_6_p_0(Stream_5, SectionName_6, (MR_String) "item_mode_defn", ModeDefn_23);
  parse_tree__prog_item_stats__write_one_stat_6_p_0(Stream_5, SectionName_6, (MR_String) "item_pred_decl", PredDecl_24);
  parse_tree__prog_item_stats__write_one_stat_6_p_0(Stream_5, SectionName_6, (MR_String) "item_mode_decl", ModeDecl_25);
  parse_tree__prog_item_stats__write_one_stat_6_p_0(Stream_5, SectionName_6, (MR_String) "item_fim", FIM_26);
  parse_tree__prog_item_stats__write_one_stat_6_p_0(Stream_5, SectionName_6, (MR_String) "item_foreign_enum", ForeignEnum_27);
  parse_tree__prog_item_stats__write_one_stat_6_p_0(Stream_5, SectionName_6, (MR_String) "item_foreign_export_enum", ForeignExportEnum_28);
  parse_tree__prog_item_stats__write_one_stat_6_p_0(Stream_5, SectionName_6, (MR_String) "item_pragma_term", PragmaTerm_29);
  parse_tree__prog_item_stats__write_one_stat_6_p_0(Stream_5, SectionName_6, (MR_String) "item_pragma_term2", PragmaTerm2_30);
  parse_tree__prog_item_stats__write_one_stat_6_p_0(Stream_5, SectionName_6, (MR_String) "item_pragma_decl", PragmaDecl_31);
  parse_tree__prog_item_stats__write_one_stat_6_p_0(Stream_5, SectionName_6, (MR_String) "item_pragma_impl", PragmaImpl_32);
  parse_tree__prog_item_stats__write_one_stat_6_p_0(Stream_5, SectionName_6, (MR_String) "item_pragma_uargs", PragmaUArgs_33);
  parse_tree__prog_item_stats__write_one_stat_6_p_0(Stream_5, SectionName_6, (MR_String) "item_pragma_excp", PragmaExcp_34);
  parse_tree__prog_item_stats__write_one_stat_6_p_0(Stream_5, SectionName_6, (MR_String) "item_pragma_trail", PragmaTrail_35);
  parse_tree__prog_item_stats__write_one_stat_6_p_0(Stream_5, SectionName_6, (MR_String) "item_pragma_mm", PragmaMM_36);
