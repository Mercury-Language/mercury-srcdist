...
MR_decl_label8(ll_backend__dupelim__dupelim_build_maps_6_0, 31,4,5,7,8,9,6,11)
MR_decl_label5(ll_backend__dupelim__dupelim_build_maps_6_0, 13,10,14,16,3)
...
MR_decl_label6(ll_backend__dupelim__find_clusters_4_0, 35,8,11,4,5,3)
...
MR_decl_label6(ll_backend__dupelim__process_clusters_7_0, 14,4,5,6,7,3)
...
MR_decl_label4(ll_backend__dupelim__standardize_instrs_2_0, 4,5,6,3)
...
MR_BEGIN_MODULE(ll_backend__dupelim_module3)
	...
	MR_init_label4(ll_backend__dupelim__standardize_instrs_2_0,4,5,6,3)
MR_BEGIN_CODE
...
MR_def_static(ll_backend__dupelim__standardize_instrs_2_0)
	...
	if (MR_LTAGS_TEST(MR_r1,0,0)) {
		MR_GOTO_LAB(ll_backend__dupelim__standardize_instrs_2_0_i3);
	}
	MR_incr_sp(2);
...
MR_def_label(ll_backend__dupelim__standardize_instrs_2_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_BEGIN_MODULE(ll_backend__dupelim_module4)
	...
	MR_init_label8(ll_backend__dupelim__dupelim_build_maps_6_0,31,4,5,7,8,9,6,11)
	MR_init_label5(ll_backend__dupelim__dupelim_build_maps_6_0,13,10,14,16,3)
MR_BEGIN_CODE
...
MR_def_label(ll_backend__dupelim__dupelim_build_maps_6_0,31)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TEST(MR_r1,0,0)) {
...
MR_def_label(ll_backend__dupelim__dupelim_build_maps_6_0,16)
	...
	MR_GOTO_LAB(ll_backend__dupelim__dupelim_build_maps_6_0_i31);
...
MR_BEGIN_MODULE(ll_backend__dupelim_module5)
	...
	MR_init_label6(ll_backend__dupelim__find_clusters_4_0,35,8,11,4,5,3)
MR_BEGIN_CODE
...
MR_def_label(ll_backend__dupelim__most_specific_instr_3_0,90)
	...
	MR_sv(13) = MR_ctfield(3, MR_tempr2, 6);
...
MR_BEGIN_MODULE(ll_backend__dupelim_module12)
	...
	MR_init_label6(ll_backend__dupelim__process_clusters_7_0,14,4,5,6,7,3)
MR_BEGIN_CODE
...
MR_def_label(ll_backend__dupelim__process_clusters_7_0,14)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TEST(MR_r1,0,0)) {
...
MR_def_label(ll_backend__dupelim__process_clusters_7_0,7)
	...
	MR_GOTO_LAB(ll_backend__dupelim__process_clusters_7_0_i14);
...
void mercury__ll_backend__dupelim__write_out_proc_statics(FILE *fp);
#endif
