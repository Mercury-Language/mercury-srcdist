  ...
  MR_Word * STATE_VARIABLE_ReplMap_7)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      next_value_of_STATE_VARIABLE_LabelSeq_0_2 = STATE_VARIABLE_LabelSeq_45_45;
      next_value_of_STATE_VARIABLE_BlockMap_0_4 = STATE_VARIABLE_BlockMap_47_47;
      next_value_of_STATE_VARIABLE_ReplMap_0_6 = STATE_VARIABLE_ReplMap_46_46;
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        next_value_of_STATE_VARIABLE_LabelSeq_0_3 = STATE_VARIABLE_LabelSeq_53_53;
        next_value_of_STATE_VARIABLE_ReplMap_0_7 = STATE_VARIABLE_ReplMap_54_54;
        next_value_of_STATE_VARIABLE_MaybeFallThrough_0_10 = STATE_VARIABLE_MaybeFallThrough_52_52;
        HeadVar__1_1 = next_value_of_HeadVar__1_1;
