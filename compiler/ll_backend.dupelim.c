...
{
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        succeeded = ((((MR_tag((MR_Word) Var_28)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(MR_mktag(3), Var_28, (MR_Integer) 0)))) == (MR_Integer) 6)));
        if (succeeded)
        {
    ...
    if (succeeded)
    {
      ...
      succeeded = ((((MR_tag((MR_Word) Var_18)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(MR_mktag(3), Var_18, (MR_Integer) 0)))) == (MR_Integer) 6)));
      if (succeeded)
      {
