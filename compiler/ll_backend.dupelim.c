  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        ll_backend__dupelim__standardize_instrs_2_p_0(Instrs_22, &Uinstrs1_56);
        if ((MaybeFallThrough_26 == (MR_Word) ((MR_Unsigned) 0U)))
          StdInstrs_27 = Uinstrs1_56;
        else
        {
          MR_Word Label_57 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MaybeFallThrough_26, (MR_Integer) 0))));
          MR_Word Goto_58;
          MR_Word Var_59;
          MR_Word Var_60;

          {
            ...
            MR_hl_field(MR_mktag(1), Var_59, 0) = ((MR_Box) (Label_57));
          }
          {
            Goto_58 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(3), Goto_58, 0) = ((MR_Box) ((MR_Unsigned) 6U));
            MR_hl_field(MR_mktag(3), Goto_58, 1) = ((MR_Box) (Var_59));
          }
          {
            Var_60 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), Var_60, 0) = ((MR_Box) (Goto_58));
            MR_hl_field(MR_mktag(1), Var_60, 1) = ((MR_Box) ((MR_Unsigned) 0U));
          }
          StdInstrs_27 = mercury__list__f_43_43_2_f_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_instr_0), Uinstrs1_56, Var_60);
        }
        {
