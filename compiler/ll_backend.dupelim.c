  ...
  MR_Word HeadVar__2_2)
{
  ...
  else
  {
    ...
    if (succeeded)
    {
      TypeInfo__10_10 = (MR_Word) (&ll_backend__dupelim_scalar_common_1[1]);
  ...
  MR_Word * STATE_VARIABLE_MaybeFallThrough_11)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        TypeCtorInfo__20_68 = (MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_instruction_0);
        mercury__list__det_last_2_p_0(TypeCtorInfo__20_68, Instrs1_41, &conv3_LastInstr_63);
        ...
        case (MR_Integer) 12:
          {
            ...
            MR_Word Lval_148;
            MR_Word Rval_149;
            MR_Word TypeInfo__250_250;
            MR_Word TypeInfo__251_251;
            MR_Word TypeInfo__252_252;
            ...
            if (succeeded)
            {
              ...
              TypeInfo__250_250 = (MR_Word) (&ll_backend__dupelim_scalar_common_1[3]);
              succeeded = mercury__builtin__unify_2_p_0(TypeInfo__250_250, ((MR_Box) (MaybeTag_15)), ((MR_Box) (Var_232)));
              if (succeeded)
              {
                TypeInfo__251_251 = (MR_Word) (&ll_backend__dupelim_scalar_common_1[4]);
                succeeded = mercury__builtin__unify_2_p_0(TypeInfo__251_251, ((MR_Box) (MaybeOffset_16)), ((MR_Box) (Var_233)));
                if (succeeded)
                {
                  TypeInfo__252_252 = (MR_Word) (&ll_backend__dupelim_scalar_common_1[5]);
                  succeeded = mercury__builtin__unify_2_p_0(TypeInfo__252_252, ((MR_Box) (Msg_17)), ((MR_Box) (Var_234)));
                  if (succeeded)
                  {
        ...
        case (MR_Integer) 9:
          {
            ...
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                ...
                if (succeeded)
                {
                  TypeInfo__36_36 = (MR_Word) (&ll_backend__dupelim_scalar_common_1[3]);
                  succeeded = mercury__builtin__unify_2_p_0(TypeInfo__36_36, ((MR_Box) (MaybeTagA_23)), ((MR_Box) (MaybeTagB_26)));
                  if (succeeded)
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          mercury__list__filter_4_p_0(TypeCtorInfo__33_33, IsFallenInto_16, Labels_9, &FixedLabels_18, &NonFixedLabels_19);
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        ll_backend__dupelim__standardize_instrs_2_p_0(Instrs_22, &Uinstrs1_55);
        if ((MaybeFallThrough_26 == (MR_Word) ((MR_Unsigned) 0U)))
          StdInstrs_27 = Uinstrs1_55;
        else
        {
          MR_Word Label_56 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MaybeFallThrough_26, (MR_Integer) 0))));
          MR_Word Goto_57;
          MR_Word Var_58;
          MR_Word Var_59;

          {
            ...
            MR_hl_field(MR_mktag(1), Var_58, 0) = ((MR_Box) (Label_56));
          }
          {
            Goto_57 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(3), Goto_57, 0) = ((MR_Box) ((MR_Unsigned) 6U));
            MR_hl_field(MR_mktag(3), Goto_57, 1) = ((MR_Box) (Var_58));
          }
          {
            Var_59 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), Var_59, 0) = ((MR_Box) (Goto_57));
            MR_hl_field(MR_mktag(1), Var_59, 1) = ((MR_Box) ((MR_Unsigned) 0U));
          }
          StdInstrs_27 = mercury__list__f_43_43_2_f_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_instr_0), Uinstrs1_55, Var_59);
        }
        {
