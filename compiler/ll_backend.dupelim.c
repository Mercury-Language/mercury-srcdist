...
{
  {
    ...
    if (succeeded)
    {
      packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Uinstr_6, (MR_Integer) 3)));
      ...
      packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Uinstr_6, (MR_Integer) 9)));
      {
  ...
  MR_Word * STATE_VARIABLE_ReplMap_7)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), ExemplarInfo0_24, (MR_Integer) 4)));
  ...
  MR_Word * STATE_VARIABLE_MaybeFallThrough_11)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), ElimLabelInfo_33, (MR_Integer) 4)));
...
{
  {
    ...
    else
    {
      ...
      else
      {
        ...
        {
          Goto_27 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
    ...
    else
    {
      ...
      else
      {
        ...
        {
          Goto_45 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
          ...
          case (MR_Integer) 12:
            {
              ...
              MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), InstrA_4, (MR_Integer) 6)));
              ...
              if (succeeded)
              {
                ...
                packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), InstrB_5, (MR_Integer) 6)));
              ...
              if (succeeded)
              {
                ...
                {
                  Var_122 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (9 * sizeof(MR_Word)), NULL, NULL));
                  ...
                  MR_hl_field(MR_mktag(3), Var_122, 6) = (MR_Box) ((MR_Unsigned) (MayUseAtomic_18));
          ...
          case (MR_Integer) 16:
            {
              ...
              MR_Unsigned packed_word_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), InstrA_4, (MR_Integer) 1)));
              MR_Word Var_236;
              MR_Word Var_237;
              ...
              if (succeeded)
              {
                packed_word_3 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), InstrB_5, (MR_Integer) 1)));
          ...
          case (MR_Integer) 17:
            {
              ...
              if (succeeded)
              {
                ...
                {
                  Var_117 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (6 * sizeof(MR_Word)), NULL, NULL));
          ...
          case (MR_Integer) 18:
            {
              ...
              MR_Unsigned packed_word_4 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), InstrA_4, (MR_Integer) 1)));
              ...
              if (succeeded)
              {
                packed_word_5 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), InstrB_5, (MR_Integer) 1)));
          ...
          case (MR_Integer) 21:
            {
              ...
              MR_Unsigned packed_word_6 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), InstrA_4, (MR_Integer) 2)));
              MR_Word Rval_185;
              MR_Word RvalB_183;
              MR_Word Var_244;
              ...
              if (succeeded)
              {
                ...
                packed_word_7 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), InstrB_5, (MR_Integer) 2)));
              ...
              if (succeeded)
              {
...

                {
                  ...
                  MR_hl_field(MR_mktag(3), Var_113, 2) = (MR_Box) ((MR_Unsigned) (Reason_54));
                }
                {
                  MR_Word base;
                  base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
          ...
          case (MR_Integer) 33:
            {
              ...
              if (succeeded)
              {
                ...
                {
                  Var_108 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL));
  ...
  MR_Word * STATE_VARIABLE_Fixed_6)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), BlockInfo_19, (MR_Integer) 4)));
      ...
      if (succeeded)
      {
        ...
        else
        {
          ...
          {
            Goto_60 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        ...
        case (MR_Integer) 12:
          {
            ...
            MR_Word Lval_99;
            MR_Word Rval_100;
            MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Instr0_3, (MR_Integer) 6)));
        ...
        case (MR_Integer) 18:
          {
            ...
            MR_Unsigned packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Instr0_3, (MR_Integer) 1)));
        ...
        case (MR_Integer) 21:
          {
            ...
            MR_Word Rval_111;
            MR_Unsigned packed_word_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Instr0_3, (MR_Integer) 2)));
