...
MR_decl_label8(ll_backend__dupelim__dupelim_build_maps_6_0, 41,3,4,5,7,11,12,6)
MR_decl_label5(ll_backend__dupelim__dupelim_build_maps_6_0, 16,19,13,25,29)
MR_decl_label8(ll_backend__dupelim__dupelim_main_5_0, 2,5,6,7,8,9,11,12)
MR_decl_label4(ll_backend__dupelim__dupelim_main_5_0, 13,14,15,16)
MR_decl_label6(ll_backend__dupelim__find_clusters_4_0, 40,3,9,12,4,5)
MR_decl_label8(ll_backend__dupelim__most_specific_block_6_0, 3,5,9,4,15,2,20,24)
MR_decl_label7(ll_backend__dupelim__most_specific_block_6_0, 19,30,17,32,34,35,1)
MR_decl_label8(ll_backend__dupelim__most_specific_instr_3_0, 3,5,178,9,12,14,20,23)
MR_decl_label8(ll_backend__dupelim__most_specific_instr_3_0, 28,31,33,38,41,43,45,47)
MR_decl_label8(ll_backend__dupelim__most_specific_instr_3_0, 50,53,49,57,60,63,67,56)
MR_decl_label8(ll_backend__dupelim__most_specific_instr_3_0, 74,77,79,84,87,92,95,100)
MR_decl_label8(ll_backend__dupelim__most_specific_instr_3_0, 103,108,111,115,118,120,122,124)
MR_decl_label8(ll_backend__dupelim__most_specific_instr_3_0, 126,131,134,136,141,144,149,152)
MR_decl_label6(ll_backend__dupelim__most_specific_instr_3_0, 157,160,165,168,170,166)
MR_decl_label8(ll_backend__dupelim__most_specific_instrs_3_0, 109,6,8,12,5,15,2,24)
MR_decl_label2(ll_backend__dupelim__most_specific_instrs_3_0, 27,1)
MR_decl_label8(ll_backend__dupelim__most_specific_lval_3_0, 3,4,23,6,8,10,13,12)
MR_decl_label3(ll_backend__dupelim__most_specific_lval_3_0, 17,2,1)
MR_decl_label8(ll_backend__dupelim__most_specific_rval_3_0, 15,17,25,12,13,30,5,7)
MR_decl_label5(ll_backend__dupelim__most_specific_rval_3_0, 9,20,22,2,1)
...
MR_decl_label8(ll_backend__dupelim__standardize_instr_2_0, 75,79,120,5,6,128,9,122)
MR_decl_label8(ll_backend__dupelim__standardize_instr_2_0, 12,125,15,16,18,19,17,22)
MR_decl_label8(ll_backend__dupelim__standardize_instr_2_0, 24,26,29,135,34,136,37,121)
MR_decl_label8(ll_backend__dupelim__standardize_instr_2_0, 40,41,126,44,133,47,134,50)
MR_decl_label8(ll_backend__dupelim__standardize_instr_2_0, 129,53,54,55,130,58,132,61)
MR_decl_label8(ll_backend__dupelim__standardize_instr_2_0, 127,64,124,67,123,70,131,73)
MR_decl_label1(ll_backend__dupelim__standardize_instr_2_0, 118)
...
MR_decl_label8(ll_backend__dupelim__standardize_rval_2_0, 38,9,14,19,4,5,41,12)
MR_decl_label1(ll_backend__dupelim__standardize_rval_2_0, 39)
...
MR_BEGIN_MODULE(ll_backend__dupelim_module1)
	...
	MR_init_label8(ll_backend__dupelim__standardize_rval_2_0,38,9,14,19,4,5,41,12)
	MR_init_label1(ll_backend__dupelim__standardize_rval_2_0,39)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(ll_backend__dupelim_module2)
	...
	MR_init_label8(ll_backend__dupelim__standardize_instr_2_0,75,79,120,5,6,128,9,122)
	MR_init_label8(ll_backend__dupelim__standardize_instr_2_0,12,125,15,16,18,19,17,22)
	MR_init_label8(ll_backend__dupelim__standardize_instr_2_0,24,26,29,135,34,136,37,121)
	MR_init_label8(ll_backend__dupelim__standardize_instr_2_0,40,41,126,44,133,47,134,50)
	MR_init_label8(ll_backend__dupelim__standardize_instr_2_0,129,53,54,55,130,58,132,61)
	MR_init_label8(ll_backend__dupelim__standardize_instr_2_0,127,64,124,67,123,70,131,73)
	MR_init_label1(ll_backend__dupelim__standardize_instr_2_0,118)
MR_BEGIN_CODE
...
MR_def_label(ll_backend__dupelim__standardize_instr_2_0,24)
	...
	MR_tfield(3, MR_tempr2, 7) = MR_sv(5);
...
MR_def_label(ll_backend__dupelim__standardize_instr_2_0,29)
	...
	MR_tfield(3, MR_tempr3, 6) = MR_sv(4);
	MR_tfield(3, MR_tempr3, 7) = MR_sv(5);
...
MR_BEGIN_MODULE(ll_backend__dupelim_module4)
	...
	MR_init_label8(ll_backend__dupelim__dupelim_build_maps_6_0,41,3,4,5,7,11,12,6)
	MR_init_label5(ll_backend__dupelim__dupelim_build_maps_6_0,16,19,13,25,29)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(ll_backend__dupelim_module6)
	...
	MR_init_label8(ll_backend__dupelim__most_specific_lval_3_0,3,4,23,6,8,10,13,12)
	MR_init_label3(ll_backend__dupelim__most_specific_lval_3_0,17,2,1)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(ll_backend__dupelim_module7)
	...
	MR_init_label8(ll_backend__dupelim__most_specific_rval_3_0,15,17,25,12,13,30,5,7)
	MR_init_label5(ll_backend__dupelim__most_specific_rval_3_0,9,20,22,2,1)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(ll_backend__dupelim_module8)
	...
	MR_init_label8(ll_backend__dupelim__most_specific_instr_3_0,3,5,178,9,12,14,20,23)
	MR_init_label8(ll_backend__dupelim__most_specific_instr_3_0,28,31,33,38,41,43,45,47)
	MR_init_label8(ll_backend__dupelim__most_specific_instr_3_0,50,53,49,57,60,63,67,56)
	MR_init_label8(ll_backend__dupelim__most_specific_instr_3_0,74,77,79,84,87,92,95,100)
	MR_init_label8(ll_backend__dupelim__most_specific_instr_3_0,103,108,111,115,118,120,122,124)
	MR_init_label8(ll_backend__dupelim__most_specific_instr_3_0,126,131,134,136,141,144,149,152)
	MR_init_label6(ll_backend__dupelim__most_specific_instr_3_0,157,160,165,168,170,166)
MR_BEGIN_CODE
...
MR_def_label(ll_backend__dupelim__most_specific_instr_3_0,38)
	...
	MR_tempr3 = MR_r2;
	MR_sv(7) = MR_ctfield(3, MR_tempr3, 7);
	MR_sv(8) = MR_ctfield(3, MR_tempr3, 8);
	MR_sv(9) = MR_ctfield(3, MR_tempr3, 1);
	MR_sv(10) = MR_ctfield(3, MR_tempr3, 4);
	MR_sv(11) = MR_ctfield(3, MR_tempr2, 1);
	MR_sv(12) = MR_ctfield(3, MR_tempr2, 4);
	MR_sv(13) = MR_ctfield(3, MR_tempr3, 3);
	MR_sv(14) = MR_ctfield(3, MR_tempr3, 5);
	MR_sv(15) = MR_ctfield(3, MR_tempr3, 6);
...
MR_BEGIN_MODULE(ll_backend__dupelim_module9)
	...
	MR_init_label8(ll_backend__dupelim__most_specific_instrs_3_0,109,6,8,12,5,15,2,24)
	MR_init_label2(ll_backend__dupelim__most_specific_instrs_3_0,27,1)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(ll_backend__dupelim_module10)
	...
	MR_init_label8(ll_backend__dupelim__most_specific_block_6_0,3,5,9,4,15,2,20,24)
	MR_init_label7(ll_backend__dupelim__most_specific_block_6_0,19,30,17,32,34,35,1)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(ll_backend__dupelim_module13)
	...
	MR_init_label8(ll_backend__dupelim__dupelim_main_5_0,2,5,6,7,8,9,11,12)
	MR_init_label4(ll_backend__dupelim__dupelim_main_5_0,13,14,15,16)
MR_BEGIN_CODE
...
/*-------------------------------------------------------------------------*/
/* code for 'IntroducedFrom__pred__find_clusters__197__1'/2 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
...
/*-------------------------------------------------------------------------*/
/* code for 'IntroducedFrom__pred__process_clusters__234__1'/2 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
...
/*-------------------------------------------------------------------------*/
/* code for 'IntroducedFrom__pred__process_elim_labels__265__1'/2 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
