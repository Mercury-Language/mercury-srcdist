...
{
  {
    ...
    Var_39 = hlds__hlds_pred__proc_id_to_int_1_f_0(ProcId_32);
    {
      ...
      MR_hl_field(MR_mktag(3), Transform_38, 0) = ((MR_Box) ((MR_Unsigned) 6U));
    ...
    parse_tree__pred_name__make_pred_name_4_p_0(PredModule_35, PredName_37, Transform_38, &ReusePredName_12);
