                  ...
                  case (MR_Integer) 0:
                    {
                      ...
                      {
                        ReuseDescription_101 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
                      ...
                      Var_121 = ((MR_Word) (MR_hl_field(MR_mktag(1), GoalExpr0_10, (MR_Integer) 3)));
                      Var_122 = ((MR_Word) (MR_hl_field(MR_mktag(1), GoalExpr0_10, (MR_Integer) 4)));
                      {
                        GoalExpr_100 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 5 * sizeof(MR_Word)), NULL, NULL));
            ...
            case (MR_Integer) 3:
              {
                ...
                Var_132 = ((MR_Word) (MR_hl_field(MR_mktag(1), GoalExpr0_10, (MR_Integer) 3)));
                Var_137 = ((MR_Word) (MR_hl_field(MR_mktag(1), GoalExpr0_10, (MR_Integer) 4)));
                {
                  GoalExpr_145 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 5 * sizeof(MR_Word)), NULL, NULL));
      ...
      case (MR_Integer) 2:
        {
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              _CondDescr_23 = ((MR_Word) (MR_hl_field(MR_mktag(2), Var_81, (MR_Integer) 0)));
          ...
          if (succeeded)
          {
            ...
            {
              GoalExpr_88 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, ((MR_Integer) 6 * sizeof(MR_Word)), NULL, NULL));
              ...
              MR_hl_field(MR_mktag(2), GoalExpr_88, 3) = ((MR_Box) (BI_19));
          ...
          else
          {
            ...
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                ...
                if (succeeded)
                {
                  CondDescr_28 = ((MR_Word) (MR_hl_field(MR_mktag(2), Var_83, (MR_Integer) 0)));
          ...
          case (MR_Integer) 2:
            {
              ...
              TypeCtorInfo_125_125 = (MR_Word) &hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_hlds_goal_0;
              mercury__list__map_3_p_0(TypeCtorInfo_125_125, TypeCtorInfo_125_125, Var_86, Goals0_13, &Goals_14);
              {
          ...
          case (MR_Integer) 3:
            {
              ...
              TypeCtorInfo_128_128 = (MR_Word) &hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_hlds_goal_0;
              mercury__list__map_3_p_0(TypeCtorInfo_128_128, TypeCtorInfo_128_128, Var_78, Goals0_110, &Goals_111);
              {
          ...
          case (MR_Integer) 4:
            {
              ...
              TypeCtorInfo_131_131 = (MR_Word) &hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_case_0;
              mercury__list__map_3_p_0(TypeCtorInfo_131_131, TypeCtorInfo_131_131, Var_76, Cases0_47, &Cases_48);
              {
                GoalExpr_113 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), GoalExpr_113, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 4));
                MR_hl_field(MR_mktag(3), GoalExpr_113, 1) = ((MR_Box) (A_45));
                MR_hl_field(MR_mktag(3), GoalExpr_113, 2) = ((MR_Box) (B_46));
          ...
          case (MR_Integer) 5:
            {
              ...
              if (succeeded)
              {
                ...
                Var_74 = ((MR_Word) (MR_hl_field(MR_mktag(3), Reason_50, (MR_Integer) 2)));
              ...
              else
              {
                ...
                {
                  GoalExpr_114 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL));
                  MR_hl_field(MR_mktag(3), GoalExpr_114, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 5));
          ...
          case (MR_Integer) 6:
            {
              ...
              {
                GoalExpr_117 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 5 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), GoalExpr_117, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 6));
...
{
  {
    ...
    if (succeeded)
    {
      ...
      transform_hlds__ctgc__structure_reuse__domain__reuse_as_table_insert_reuse_version_proc_5_p_0(PPId_7, NoClobbers_11, *NewPPId_8, STATE_VARIABLE_ReuseTable_21_21, STATE_VARIABLE_ReuseTable_17);
    }
    else
    {
      {
