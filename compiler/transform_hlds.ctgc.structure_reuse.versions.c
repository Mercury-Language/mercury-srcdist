...
MR_decl_label8(transform_hlds__ctgc__structure_reuse__versions__create_reuse_procedures_4_0, 2,3,5,7,9,10,12,13)
...
MR_BEGIN_MODULE(transform_hlds__ctgc__structure_reuse__versions_module0)
	...
	MR_init_label8(transform_hlds__ctgc__structure_reuse__versions__create_reuse_procedures_4_0,2,3,5,7,9,10,12,13)
MR_BEGIN_CODE
...
MR_def_label(transform_hlds__ctgc__structure_reuse__versions__create_reuse_procedures_4_0,3)
	...
	MR_np_call_localret_ent(map__foldl2_6_0,
		transform_hlds__ctgc__structure_reuse__versions__create_reuse_procedures_4_0_i5);
MR_def_label(transform_hlds__ctgc__structure_reuse__versions__create_reuse_procedures_4_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	...
	MR_np_call_localret_ent(list__map_foldl2_7_0,
		transform_hlds__ctgc__structure_reuse__versions__create_reuse_procedures_4_0_i7);
MR_def_label(transform_hlds__ctgc__structure_reuse__versions__create_reuse_procedures_4_0,7)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	...
	MR_np_call_localret_ent(list__foldl_4_0,
		transform_hlds__ctgc__structure_reuse__versions__create_reuse_procedures_4_0_i9);
MR_def_label(transform_hlds__ctgc__structure_reuse__versions__create_reuse_procedures_4_0,9)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
...
MR_def_label(transform_hlds__ctgc__structure_reuse__versions__create_reuse_procedures_4_0,10)
	...
	MR_np_call_localret_ent(list__foldl_4_0,
		transform_hlds__ctgc__structure_reuse__versions__create_reuse_procedures_4_0_i12);
MR_def_label(transform_hlds__ctgc__structure_reuse__versions__create_reuse_procedures_4_0,12)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
...
void mercury__transform_hlds__ctgc__structure_reuse__versions__write_out_proc_statics(FILE *deep_fp, FILE *procrep_fp)
{
	MR_write_out_module_proc_reps_start(procrep_fp, &mercury_data__module_layout__transform_hlds__ctgc__structure_reuse__versions);
