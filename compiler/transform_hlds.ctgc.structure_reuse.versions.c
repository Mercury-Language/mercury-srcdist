    ...
    if (transform_hlds__ctgc__structure_reuse__versions__succeeded)
      {
        ...
        if (transform_hlds__ctgc__structure_reuse__versions__succeeded)
          {
            transform_hlds__ctgc__structure_reuse__versions__V_17_17 = ((MR_Word) (MR_hl_field(MR_mktag(3), transform_hlds__ctgc__structure_reuse__versions__OpMode_12, (MR_Integer) 0)));
