...
MR_decl_label1(transform_hlds__ctgc__structure_reuse__versions__create_fresh_pred_proc_info_copy_4_0, 26)
...
MR_decl_entry(hlds__hlds_pred__pred_info_create_15_0);
...
MR_BEGIN_MODULE(transform_hlds__ctgc__structure_reuse__versions_module1)
	...
	MR_init_label1(transform_hlds__ctgc__structure_reuse__versions__create_fresh_pred_proc_info_copy_4_0,26)
MR_BEGIN_CODE
...
MR_def_label(transform_hlds__ctgc__structure_reuse__versions__create_fresh_pred_proc_info_copy_4_0,19)
	...
	MR_r11 = MR_sv(2);
	MR_r13 = MR_sv(3);
	MR_np_call_localret_ent(hlds__hlds_pred__pred_info_create_15_0,
...
void mercury__transform_hlds__ctgc__structure_reuse__versions__write_out_proc_statics(FILE *fp);
#endif
