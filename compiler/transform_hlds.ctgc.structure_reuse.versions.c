    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          succeeded = (Var_18 == (MR_Word) ((MR_Integer) 8));
        }
      }
      succeeded = !(succeeded);
    }
...
{
  {
    ...
    succeeded = transform_hlds__ctgc__structure_reuse__domain__reuse_as_table_search_reuse_version_proc_4_p_0(STATE_VARIABLE_ReuseTable_0_16, PPId_7, (MR_Word) ((MR_Integer) 0), &Var_12);
    if (succeeded)
    {
      {
    ...
    transform_hlds__ctgc__structure_reuse__versions__create_fresh_pred_proc_info_copy_5_p_0(PPId_7, (MR_Word) ((MR_Integer) 0), NewPPId_8, STATE_VARIABLE_ModuleInfo_0_14, STATE_VARIABLE_ModuleInfo_15);
    ...
    if (succeeded)
    {
      ...
      transform_hlds__ctgc__structure_reuse__domain__reuse_as_table_insert_reuse_version_proc_5_p_0(PPId_7, (MR_Word) ((MR_Integer) 0), *NewPPId_8, STATE_VARIABLE_ReuseTable_21_21, STATE_VARIABLE_ReuseTable_17);
    }
    else
    {
      {
...
{
  {
    ...
    if (succeeded)
      PredStatus_53 = (MR_Word) (((MR_Box) ((MR_Integer) 32)));
    else
    ...
    hlds__hlds_pred__pred_info_get_var_name_remap_2_p_0(PredInfo0_10, &VarNameRemap_60);
    {
      ...
      MR_hl_field(MR_mktag(2), NewPredOrigin_61, 0) = ((MR_Box) ((MR_Integer) 16));
