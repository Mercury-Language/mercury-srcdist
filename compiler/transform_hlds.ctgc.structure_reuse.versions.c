...
MR_decl_label2(transform_hlds__ctgc__structure_reuse__versions__unification_set_reuse_3_0, 13,6)
...
MR_BEGIN_MODULE(transform_hlds__ctgc__structure_reuse__versions_module5)
	...
	MR_init_label2(transform_hlds__ctgc__structure_reuse__versions__unification_set_reuse_3_0,13,6)
MR_BEGIN_CODE
...
MR_def_static(transform_hlds__ctgc__structure_reuse__versions__unification_set_reuse_3_0)
	...
	if (MR_PTAG_TESTR(MR_r2,0)) {
		MR_GOTO_LAB(transform_hlds__ctgc__structure_reuse__versions__unification_set_reuse_3_0_i13);
	}
...
MR_def_label(transform_hlds__ctgc__structure_reuse__versions__unification_set_reuse_3_0,13)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_r2;
	MR_proceed();
