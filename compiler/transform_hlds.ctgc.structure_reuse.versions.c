  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_15)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_10, (MR_Integer) 502, &IntermodAnalysis_11);
  ...
  if (succeeded)
  {
    ...
    if (succeeded)
    {
      Var_17 = ((MR_Word) ((MR_hl_field(3, OpMode_12, (MR_Integer) 0))));
      succeeded = ((MR_tag((MR_Word) Var_17)) == (MR_Integer) 2);
      if (succeeded)
      {
        Var_18 = ((MR_Word) ((MR_hl_field(2, Var_17, (MR_Integer) 0))));
  ...
  if (succeeded)
  {
    ...
    switch (IsHarsher_13) {
      ...
      case (MR_Integer) 0:
        transform_hlds__ctgc__structure_reuse__versions__apply_reuse_in_proc_5_p_0(ConvertPotentialReuse_6, ReuseTable_7, ReusePPId_8, STATE_VARIABLE_ModuleInfo_0_14, STATE_VARIABLE_ModuleInfo_15);
        break;
      case (MR_Integer) 1:
        transform_hlds__ctgc__structure_reuse__versions__apply_reuse_in_proc_5_p_0((MR_Integer) 1, ReuseTable_7, ReusePPId_8, STATE_VARIABLE_ModuleInfo_0_14, STATE_VARIABLE_ModuleInfo_15);
        break;
    }
  }
  else
  ...
  MR_Box * wrapper_arg_3)
{
  ...
  transform_hlds__ctgc__structure_reuse__versions__check_cond_apply_reuse_in_proc_5_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 4)))), ((MR_Word) (wrapper_arg_1)), ((MR_Word) (wrapper_arg_2)), &conv9_STATE_VARIABLE_ModuleInfo_15);
