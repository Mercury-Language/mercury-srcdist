  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_15)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_10, (MR_Integer) 500, &IntermodAnalysis_11);
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_20)
{
  ...
  {
    NewPredOrigin_48 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(MR_mktag(2), NewPredOrigin_48, 0) = ((MR_Box) ((MR_Unsigned) 4U));
    MR_hl_field(MR_mktag(2), NewPredOrigin_48, 1) = ((MR_Box) (PredOrigin_38));
    MR_hl_field(MR_mktag(2), NewPredOrigin_48, 2) = ((MR_Box) (PredId_30));
  }
