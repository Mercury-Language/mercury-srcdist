...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_10, (MR_Integer) 347, &IntermodAnalysis_11);
...
{
  {
    ...
    if (succeeded)
    {
      packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), Var_23, (MR_Integer) 0)));
      ...
      case (MR_Integer) 2:
        {
          ...
          MR_Unsigned packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), GoalExpr0_10, (MR_Integer) 3)));
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              packed_args_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), Var_81, (MR_Integer) 0)));
          ...
          if (succeeded)
          {
            ...
            transform_hlds__ctgc__structure_reuse__versions__determine_reuse_version_9_p_0(ReuseTable_7, ModuleInfo_8, CalleePredId_16, CalleeProcId_17, CalleePredName_21, NoClobbers_24, &ReuseCalleePredId_25, &ReuseCalleeProcId_26, &ReuseCalleePredName_27);
            {
              ...
              MR_hl_field(MR_mktag(2), GoalExpr_88, 3) = (MR_Box) (packed_args_1);
          ...
          else
          {
            ...
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                ...
                if (succeeded)
                {
                  packed_args_3 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), Var_83, (MR_Integer) 0)));
            ...
            if (succeeded)
            {
              ...
              transform_hlds__ctgc__structure_reuse__versions__determine_reuse_version_9_p_0(ReuseTable_7, ModuleInfo_8, CalleePredId_16, CalleeProcId_17, CalleePredName_21, NoClobbers_94, &ReuseCalleePredId_90, &ReuseCalleeProcId_91, &ReuseCalleePredName_92);
              {
                ...
                MR_hl_field(MR_mktag(2), GoalExpr_89, 3) = (MR_Box) (packed_args_1);
          ...
          case (MR_Integer) 4:
            {
              ...
              MR_Unsigned packed_args_5 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), GoalExpr0_10, (MR_Integer) 2)));
              ...
              mercury__list__map_3_p_0((MR_Word) (&hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_case_0), (MR_Word) (&hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_case_0), Var_76, Cases0_47, &Cases_48);
              {
                ...
                MR_hl_field(MR_mktag(3), GoalExpr_113, 2) = (MR_Box) (packed_args_5);
          ...
          case (MR_Integer) 5:
            {
              ...
              if (succeeded)
              {
                packed_args_4 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Reason_50, (MR_Integer) 2)));
...
{
  {
    ...
    if (succeeded)
    {
      ...
      packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_Unification_0_15, (MR_Integer) 5)));
      ...
      if (succeeded)
      {
        ...
        packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), ShortReuseDescription_4, (MR_Integer) 1)));
...
{
  {
    ...
    MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), ReuseAs_Status_10, (MR_Integer) 1)));
