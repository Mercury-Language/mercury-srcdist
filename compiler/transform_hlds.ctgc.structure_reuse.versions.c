...
{
  {
    ...
    if (succeeded)
    {
      packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), Var_23, (MR_Integer) 0)));
      ...
      case (MR_Integer) 2:
        {
          ...
          MR_Unsigned packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), GoalExpr0_10, (MR_Integer) 3)));
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              packed_word_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), Var_81, (MR_Integer) 0)));
          ...
          else
          {
            ...
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                ...
                if (succeeded)
                {
                  packed_word_3 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), Var_83, (MR_Integer) 0)));
          ...
          case (MR_Integer) 4:
            {
              ...
              MR_Unsigned packed_word_5 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), GoalExpr0_10, (MR_Integer) 2)));
          ...
          case (MR_Integer) 5:
            {
              ...
              if (succeeded)
              {
                packed_word_4 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Reason_50, (MR_Integer) 2)));
...
{
  {
    ...
    if (succeeded)
    {
      ...
      packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_Unification_0_15, (MR_Integer) 5)));
      ...
      if (succeeded)
      {
        ...
        packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), ShortReuseDescription_4, (MR_Integer) 1)));
...
{
  {
    ...
    MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), ReuseAs_Status_10, (MR_Integer) 1)));
