  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_23)
{
  ...
  MR_Word ProgContext_48;
  MR_Word PredOrigin_49;
  MR_Word PredStatus0_50;
  MR_Word PredStatus_51;
  MR_Word PredMarkers_52;
  MR_Word MerTypes_53;
  MR_Word TVarset_54;
  MR_Word ExistQTVars_55;
  MR_Word ProgConstraints_56;
  MR_Word AssertIds_57;
  MR_Word VarNameRemap_58;
  MR_Word NewPredOrigin_59;
  ...
  Var_39 = hlds__hlds_pred__proc_id_to_int_1_f_0(ProcId_32);
  {
    Transform_38 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(MR_mktag(3), Transform_38, 0) = ((MR_Box) ((MR_Unsigned) 10U));
    MR_hl_field(MR_mktag(3), Transform_38, 1) = (MR_Box) ((MR_Unsigned) (PredOrFunc_36));
    MR_hl_field(MR_mktag(3), Transform_38, 2) = ((MR_Box) (Var_39));
    MR_hl_field(MR_mktag(3), Transform_38, 3) = ((MR_Box) (NoClobbers_7));
  }
  parse_tree__pred_name__make_transformed_pred_sym_name_4_p_0(PredModule_35, PredName_37, Transform_38, &ReusePredName_12);
  PredId_13 = ((MR_Word) ((MR_hl_field(MR_mktag(0), PPId_6, (MR_Integer) 0))));
  ModuleName_46 = hlds__hlds_pred__pred_info_module_1_f_0(PredInfo0_10);
  PredOrFunc_47 = hlds__hlds_pred__pred_info_is_pred_or_func_1_f_0(PredInfo0_10);
  hlds__hlds_pred__pred_info_get_context_2_p_0(PredInfo0_10, &ProgContext_48);
  hlds__hlds_pred__pred_info_get_origin_2_p_0(PredInfo0_10, &PredOrigin_49);
  hlds__hlds_pred__pred_info_get_status_2_p_0(PredInfo0_10, &PredStatus0_50);
  Var_61 = (MR_Word) (PredStatus0_50);
  succeeded = (Var_61 == (MR_Word) ((MR_Unsigned) 0U));
  if (succeeded)
    PredStatus_51 = (MR_Word) (((MR_Box) ((MR_Unsigned) 32U)));
  else
    PredStatus_51 = PredStatus0_50;
  hlds__hlds_pred__pred_info_get_markers_2_p_0(PredInfo0_10, &PredMarkers_52);
  hlds__hlds_pred__pred_info_get_arg_types_2_p_0(PredInfo0_10, &MerTypes_53);
  hlds__hlds_pred__pred_info_get_typevarset_2_p_0(PredInfo0_10, &TVarset_54);
  hlds__hlds_pred__pred_info_get_exist_quant_tvars_2_p_0(PredInfo0_10, &ExistQTVars_55);
  hlds__hlds_pred__pred_info_get_class_context_2_p_0(PredInfo0_10, &ProgConstraints_56);
  hlds__hlds_pred__pred_info_get_assertions_2_p_0(PredInfo0_10, &AssertIds_57);
  hlds__hlds_pred__pred_info_get_var_name_remap_2_p_0(PredInfo0_10, &VarNameRemap_58);
  {
    NewPredOrigin_59 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(MR_mktag(3), NewPredOrigin_59, 0) = ((MR_Box) ((MR_Unsigned) 1U));
    MR_hl_field(MR_mktag(3), NewPredOrigin_59, 1) = ((MR_Box) ((MR_Unsigned) 16U));
    MR_hl_field(MR_mktag(3), NewPredOrigin_59, 2) = ((MR_Box) (PredOrigin_49));
    MR_hl_field(MR_mktag(3), NewPredOrigin_59, 3) = ((MR_Box) (PredId_13));
  }
  hlds__hlds_pred__pred_info_create_17_p_0(ModuleName_46, ReusePredName_12, PredOrFunc_47, ProgContext_48, NewPredOrigin_59, PredStatus_51, PredMarkers_52, MerTypes_53, TVarset_54, ExistQTVars_55, ProgConstraints_56, AssertIds_57, VarNameRemap_58, (MR_Word) (&transform_hlds__ctgc__structure_reuse__versions_scalar_common_2[0]), ProcInfo0_11, &ReuseProcId_16, &ReusePredInfo_15);
