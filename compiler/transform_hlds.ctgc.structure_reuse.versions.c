...
{
  {
    ...
    {
      NewPredOrigin_61 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(3), NewPredOrigin_61, 0) = ((MR_Box) ((MR_Unsigned) 1U));
      MR_hl_field(MR_mktag(3), NewPredOrigin_61, 1) = ((MR_Box) ((MR_Unsigned) 16U));
      MR_hl_field(MR_mktag(3), NewPredOrigin_61, 2) = ((MR_Box) (PredOrigin_51));
      MR_hl_field(MR_mktag(3), NewPredOrigin_61, 3) = ((MR_Box) (PredId_13));
    }
    hlds__hlds_pred__pred_info_create_17_p_0(ModuleName_48, ReusePredName_12, PredOrFunc_49, ProgContext_50, NewPredOrigin_61, PredStatus_53, PredMarkers_54, MerTypes_55, TVarset_56, ExistQTVars_57, ProgConstraints_58, AssertIds_59, VarNameRemap_60, (MR_Word) (&transform_hlds__ctgc__structure_reuse__versions_scalar_common_2[0]), ProcInfo0_11, &ReuseProcId_16, &ReusePredInfo_15);
