...
{
  {
    ...
    {
      libs__globals__lookup_bool_option_3_p_0(transform_hlds__ctgc__structure_reuse__versions__Globals_10, (MR_Integer) 327, &transform_hlds__ctgc__structure_reuse__versions__IntermodAnalysis_11);
    }
    {
    ...
    if (transform_hlds__ctgc__structure_reuse__versions__succeeded)
      {
        transform_hlds__ctgc__structure_reuse__versions__succeeded = ((((MR_tag((MR_Word) transform_hlds__ctgc__structure_reuse__versions__OpMode_12)) == (MR_mktag((MR_Integer) 3)))) && (((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), transform_hlds__ctgc__structure_reuse__versions__OpMode_12, (MR_Integer) 0)))) == (MR_Integer) 1)));
        if (transform_hlds__ctgc__structure_reuse__versions__succeeded)
          {
            transform_hlds__ctgc__structure_reuse__versions__V_17_17 = ((MR_Word) (MR_hl_field(MR_mktag(3), transform_hlds__ctgc__structure_reuse__versions__OpMode_12, (MR_Integer) 1)));
            transform_hlds__ctgc__structure_reuse__versions__succeeded = ((MR_tag((MR_Word) transform_hlds__ctgc__structure_reuse__versions__V_17_17)) == (MR_mktag((MR_Integer) 1)));
            if (transform_hlds__ctgc__structure_reuse__versions__succeeded)
              {
                transform_hlds__ctgc__structure_reuse__versions__V_18_18 = ((MR_Word) (MR_hl_field(MR_mktag(1), transform_hlds__ctgc__structure_reuse__versions__V_17_17, (MR_Integer) 0)));
                transform_hlds__ctgc__structure_reuse__versions__succeeded = (transform_hlds__ctgc__structure_reuse__versions__V_18_18 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 2))));
              }
          }
