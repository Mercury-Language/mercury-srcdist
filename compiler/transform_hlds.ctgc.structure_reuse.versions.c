...
MR_decl_label10(transform_hlds__ctgc__structure_reuse__versions__process_goal_5_0, 167,3,6,4,11,9,14,16,17,18)
MR_decl_label10(transform_hlds__ctgc__structure_reuse__versions__process_goal_5_0, 15,188,23,27,24,34,22,42,41,47)
MR_decl_label10(transform_hlds__ctgc__structure_reuse__versions__process_goal_5_0, 45,51,53,54,87,55,60,62,56,64)
MR_decl_label3(transform_hlds__ctgc__structure_reuse__versions__process_goal_5_0, 66,50,68)
...
MR_BEGIN_MODULE(transform_hlds__ctgc__structure_reuse__versions_module8)
	...
	MR_init_label10(transform_hlds__ctgc__structure_reuse__versions__process_goal_5_0,167,3,6,4,11,9,14,16,17,18)
	MR_init_label10(transform_hlds__ctgc__structure_reuse__versions__process_goal_5_0,15,188,23,27,24,34,22,42,41,47)
	MR_init_label10(transform_hlds__ctgc__structure_reuse__versions__process_goal_5_0,45,51,53,54,87,55,60,62,56,64)
	MR_init_label3(transform_hlds__ctgc__structure_reuse__versions__process_goal_5_0,66,50,68)
MR_BEGIN_CODE
...
MR_def_static(transform_hlds__ctgc__structure_reuse__versions__process_goal_5_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
MR_def_label(transform_hlds__ctgc__structure_reuse__versions__process_goal_5_0,167)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tempr2 = MR_r4;
...
MR_def_label(transform_hlds__ctgc__structure_reuse__versions__process_goal_5_0,3)
	...
	MR_tfield(0, MR_tempr1, 1) = (MR_Word) MR_LABEL_AP(transform_hlds__ctgc__structure_reuse__versions__process_goal_5_0_i167);
...
MR_def_label(transform_hlds__ctgc__structure_reuse__versions__process_goal_5_0,15)
	...
	if (MR_RTAGS_TESTR(MR_r5,3,4)) {
		MR_GOTO_LAB(transform_hlds__ctgc__structure_reuse__versions__process_goal_5_0_i188);
	}
	MR_r1 = MR_r4;
	MR_proceed();
MR_def_label(transform_hlds__ctgc__structure_reuse__versions__process_goal_5_0,188)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(12);
	MR_sv(12) = (MR_Word) MR_succip;
...
MR_def_label(transform_hlds__ctgc__structure_reuse__versions__process_goal_5_0,24)
	...
	if (MR_INT_NE(MR_sv(1),0)) {
		MR_GOTO_LAB(transform_hlds__ctgc__structure_reuse__versions__process_goal_5_0_i87);
	}
...
MR_def_label(transform_hlds__ctgc__structure_reuse__versions__process_goal_5_0,34)
	...
	MR_np_call_localret_ent(hlds__hlds_goal__goal_info_set_reuse_3_0,
		transform_hlds__ctgc__structure_reuse__versions__process_goal_5_0_i62);
...
MR_def_label(transform_hlds__ctgc__structure_reuse__versions__process_goal_5_0,41)
	...
	if (MR_RTAGS_TESTR(MR_r5,3,3)) {
		MR_GOTO_LAB(transform_hlds__ctgc__structure_reuse__versions__process_goal_5_0_i45);
	}
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tag_alloc_heap(MR_tempr1, 0, (MR_Integer) 6);
	...
	MR_np_call_localret_ent(list__map_3_0,
		transform_hlds__ctgc__structure_reuse__versions__process_goal_5_0_i47);
MR_def_label(transform_hlds__ctgc__structure_reuse__versions__process_goal_5_0,47)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_def_label(transform_hlds__ctgc__structure_reuse__versions__process_goal_5_0,45)
	...
	if (MR_PTAG_TESTR(MR_r5,0)) {
		MR_GOTO_LAB(transform_hlds__ctgc__structure_reuse__versions__process_goal_5_0_i50);
	}
	MR_sv(1) = MR_r1;
	{
	MR_Word MR_tempr1, MR_tempr2;
...
MR_def_label(transform_hlds__ctgc__structure_reuse__versions__process_goal_5_0,51)
	...
	if (MR_LTAGS_TESTR(MR_r1,0,1)) {
		MR_GOTO_LAB(transform_hlds__ctgc__structure_reuse__versions__process_goal_5_0_i53);
	}
	MR_r1 = MR_sv(11);
	MR_decr_sp_and_return(12);
MR_def_label(transform_hlds__ctgc__structure_reuse__versions__process_goal_5_0,53)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
...
MR_def_label(transform_hlds__ctgc__structure_reuse__versions__process_goal_5_0,54)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_r1,1)) {
		MR_GOTO_LAB(transform_hlds__ctgc__structure_reuse__versions__process_goal_5_0_i55);
	}
MR_def_label(transform_hlds__ctgc__structure_reuse__versions__process_goal_5_0,87)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(11);
	MR_decr_sp_and_return(12);
MR_def_label(transform_hlds__ctgc__structure_reuse__versions__process_goal_5_0,55)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_r1,2)) {
		MR_GOTO_LAB(transform_hlds__ctgc__structure_reuse__versions__process_goal_5_0_i56);
	}
	if (MR_INT_NE(MR_sv(1),0)) {
		MR_GOTO_LAB(transform_hlds__ctgc__structure_reuse__versions__process_goal_5_0_i87);
	}
	...
	MR_np_call_localret_ent(transform_hlds__ctgc__structure_reuse__versions__unification_set_reuse_3_0,
		transform_hlds__ctgc__structure_reuse__versions__process_goal_5_0_i60);
MR_def_label(transform_hlds__ctgc__structure_reuse__versions__process_goal_5_0,60)
	...
	MR_np_call_localret_ent(hlds__hlds_goal__goal_info_set_reuse_3_0,
		transform_hlds__ctgc__structure_reuse__versions__process_goal_5_0_i62);
MR_def_label(transform_hlds__ctgc__structure_reuse__versions__process_goal_5_0,62)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 0, (MR_Integer) 2);
...
MR_def_label(transform_hlds__ctgc__structure_reuse__versions__process_goal_5_0,56)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(1) = MR_r1;
