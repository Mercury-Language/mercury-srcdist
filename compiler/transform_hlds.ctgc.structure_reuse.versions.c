...
static /* final */ const MR_Box transform_hlds__ctgc__structure_reuse__versions_scalar_common_6[1][1];
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_10, (MR_Integer) 491, &IntermodAnalysis_11);
