  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_20)
{
  ...
  MR_String ReusePredName_29;
  MR_Word PredModuleName_30;
  MR_Word ProgContext_31;
  ...
  MR_Word AssertIds_40;
  MR_Word VarNameRemap_41;
  MR_Word NewPredOrigin_42;
  MR_Integer Var_44;
  MR_Word Var_45;

  hlds__hlds_module__module_info_pred_proc_info_4_p_0(STATE_VARIABLE_ModuleInfo_0_19, PPId_6, &PredInfo0_10, &ProcInfo0_11);
  PredId_24 = ((MR_Word) ((MR_hl_field(MR_mktag(0), PPId_6, (MR_Integer) 0))));
  ProcId_25 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), PPId_6, (MR_Integer) 1))));
  PredOrFunc_26 = hlds__hlds_pred__pred_info_is_pred_or_func_1_f_0(PredInfo0_10);
  PredName_27 = hlds__hlds_pred__pred_info_name_1_f_0(PredInfo0_10);
  Var_44 = hlds__hlds_pred__proc_id_to_int_1_f_0(ProcId_25);
  {
    Transform_28 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(MR_mktag(3), Transform_28, 0) = ((MR_Box) ((MR_Unsigned) 11U));
    MR_hl_field(MR_mktag(3), Transform_28, 1) = (MR_Box) ((MR_Unsigned) (PredOrFunc_26));
    MR_hl_field(MR_mktag(3), Transform_28, 2) = ((MR_Box) (Var_44));
    MR_hl_field(MR_mktag(3), Transform_28, 3) = ((MR_Box) (NoClobberArgNums_7));
  }
  parse_tree__pred_name__make_transformed_pred_name_3_p_0(PredName_27, Transform_28, &ReusePredName_29);
  PredModuleName_30 = hlds__hlds_pred__pred_info_module_1_f_0(PredInfo0_10);
  hlds__hlds_pred__pred_info_get_context_2_p_0(PredInfo0_10, &ProgContext_31);
  hlds__hlds_pred__pred_info_get_origin_2_p_0(PredInfo0_10, &PredOrigin_32);
  hlds__hlds_pred__pred_info_get_status_2_p_0(PredInfo0_10, &PredStatus0_33);
  Var_45 = (MR_Word) (PredStatus0_33);
  succeeded = (Var_45 == (MR_Word) ((MR_Unsigned) 0U));
  if (succeeded)
    PredStatus_34 = (MR_Word) (((MR_Box) ((MR_Unsigned) 32U)));
  else
    PredStatus_34 = PredStatus0_33;
  hlds__hlds_pred__pred_info_get_markers_2_p_0(PredInfo0_10, &PredMarkers_35);
  hlds__hlds_pred__pred_info_get_arg_types_2_p_0(PredInfo0_10, &MerTypes_36);
  hlds__hlds_pred__pred_info_get_typevarset_2_p_0(PredInfo0_10, &TVarset_37);
  hlds__hlds_pred__pred_info_get_exist_quant_tvars_2_p_0(PredInfo0_10, &ExistQTVars_38);
  hlds__hlds_pred__pred_info_get_class_context_2_p_0(PredInfo0_10, &ProgConstraints_39);
  hlds__hlds_pred__pred_info_get_assertions_2_p_0(PredInfo0_10, &AssertIds_40);
  hlds__hlds_pred__pred_info_get_var_name_remap_2_p_0(PredInfo0_10, &VarNameRemap_41);
  {
    NewPredOrigin_42 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(MR_mktag(3), NewPredOrigin_42, 0) = ((MR_Box) ((MR_Unsigned) 1U));
    MR_hl_field(MR_mktag(3), NewPredOrigin_42, 1) = ((MR_Box) ((MR_Unsigned) 16U));
    MR_hl_field(MR_mktag(3), NewPredOrigin_42, 2) = ((MR_Box) (PredOrigin_32));
    MR_hl_field(MR_mktag(3), NewPredOrigin_42, 3) = ((MR_Box) (PredId_24));
  }
  hlds__hlds_pred__pred_info_create_17_p_0(PredOrFunc_26, PredModuleName_30, ReusePredName_29, ProgContext_31, NewPredOrigin_42, PredStatus_34, PredMarkers_35, MerTypes_36, TVarset_37, ExistQTVars_38, ProgConstraints_39, AssertIds_40, VarNameRemap_41, (MR_Word) (&transform_hlds__ctgc__structure_reuse__versions_scalar_common_2[0]), ProcInfo0_11, &ReuseProcId_13, &ReusePredInfo_12);
