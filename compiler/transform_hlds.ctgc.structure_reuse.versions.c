...
MR_decl_label10(transform_hlds__ctgc__structure_reuse__versions__process_goal_5_0, 113,125,54,81,59,63,67,68,70,126)
MR_decl_label10(transform_hlds__ctgc__structure_reuse__versions__process_goal_5_0, 23,27,24,34,37,80,127,6,128,11)
MR_decl_label10(transform_hlds__ctgc__structure_reuse__versions__process_goal_5_0, 131,16,17,18,21,130,42,132,46,129)
MR_decl_label1(transform_hlds__ctgc__structure_reuse__versions__process_goal_5_0, 50)
...
MR_BEGIN_MODULE(transform_hlds__ctgc__structure_reuse__versions_module3)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__fn__transform_hlds__ctgc__structure_reuse__versions__this_file_0_0);
MR_BEGIN_CODE
...
MR_def_static(transform_hlds__ctgc__structure_reuse__versions__unification_set_reuse_3_0)
	...
	MR_tfield(0, MR_tempr1, 1) = MR_tfield(1, MR_tempr4, 2);
	MR_tfield(0, MR_tempr1, 2) = MR_tfield(1, MR_tempr4, 3);
...
MR_BEGIN_MODULE(transform_hlds__ctgc__structure_reuse__versions_module8)
	...
	MR_init_label10(transform_hlds__ctgc__structure_reuse__versions__process_goal_5_0,113,125,54,81,59,63,67,68,70,126)
	MR_init_label10(transform_hlds__ctgc__structure_reuse__versions__process_goal_5_0,23,27,24,34,37,80,127,6,128,11)
	MR_init_label10(transform_hlds__ctgc__structure_reuse__versions__process_goal_5_0,131,16,17,18,21,130,42,132,46,129)
	MR_init_label1(transform_hlds__ctgc__structure_reuse__versions__process_goal_5_0,50)
MR_BEGIN_CODE
