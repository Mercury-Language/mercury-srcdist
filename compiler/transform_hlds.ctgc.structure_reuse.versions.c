  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_20)
{
  ...
  PredId_23 = ((MR_Word) ((MR_hl_field(MR_mktag(0), PPId_6, (MR_Integer) 0))));
  ProcId_24 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), PPId_6, (MR_Integer) 1))));
  ...
  Var_43 = hlds__hlds_pred__proc_id_to_int_1_f_0(ProcId_24);
  {
    ...
    MR_hl_field(MR_mktag(3), Transform_27, 0) = ((MR_Box) ((MR_Unsigned) 11U));
    MR_hl_field(MR_mktag(3), Transform_27, 1) = (MR_Box) ((MR_Unsigned) (PredOrFunc_25));
    MR_hl_field(MR_mktag(3), Transform_27, 2) = ((MR_Box) (Var_43));
    MR_hl_field(MR_mktag(3), Transform_27, 3) = ((MR_Box) (NoClobberArgNums_7));
  }
  parse_tree__pred_name__make_transformed_pred_name_3_p_0(PredName_26, Transform_27, &ReusePredName_28);
  ...
  {
    NewPredOrigin_41 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(MR_mktag(3), NewPredOrigin_41, 0) = ((MR_Box) ((MR_Unsigned) 1U));
    MR_hl_field(MR_mktag(3), NewPredOrigin_41, 1) = ((MR_Box) ((MR_Unsigned) 16U));
    MR_hl_field(MR_mktag(3), NewPredOrigin_41, 2) = ((MR_Box) (PredOrigin_31));
    MR_hl_field(MR_mktag(3), NewPredOrigin_41, 3) = ((MR_Box) (PredId_23));
  }
