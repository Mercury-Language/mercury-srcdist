  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_20)
{
  ...
  {
    NewPredOrigin_41 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(MR_mktag(2), NewPredOrigin_41, 0) = ((MR_Box) ((MR_Unsigned) 4U));
    MR_hl_field(MR_mktag(2), NewPredOrigin_41, 1) = ((MR_Box) (PredOrigin_31));
    MR_hl_field(MR_mktag(2), NewPredOrigin_41, 2) = ((MR_Box) (PredId_23));
  }
