  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_15)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_10, (MR_Integer) 501, &IntermodAnalysis_11);
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_18)
{
  ...
  hlds__passes_aux__write_proc_progress_message_5_p_0(STATE_VARIABLE_ModuleInfo_0_17, (MR_String) "Apply reuse ", PPId_8);
