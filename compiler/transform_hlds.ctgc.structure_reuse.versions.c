...
{
  {
    ...
    {
      libs__globals__lookup_bool_option_3_p_0(transform_hlds__ctgc__structure_reuse__versions__Globals_10, (MR_Integer) 336, &transform_hlds__ctgc__structure_reuse__versions__IntermodAnalysis_11);
    }
    {
