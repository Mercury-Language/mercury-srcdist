...
static /* final */ const MR_Box parse_tree__parse_vars_scalar_common_1[8][2];
...
{
  {
    ...
    if (succeeded)
    {
...

      {
        ...
        MR_hl_field(MR_mktag(0), Var_43, 0) = ((MR_Box) (Var_42));
        MR_hl_field(MR_mktag(0), Var_43, 1) = ((MR_Box) (Var_42));
        MR_hl_field(MR_mktag(0), Var_43, 2) = ((MR_Box) (Var_42));
        MR_hl_field(MR_mktag(0), Var_43, 3) = ((MR_Box) (Var_42));
      }
      {
        MR_Word base;
...
{
  {
    ...
    if (succeeded)
    {
...

      {
        ...
        MR_hl_field(MR_mktag(0), Var_34, 0) = ((MR_Box) (Var_33));
        MR_hl_field(MR_mktag(0), Var_34, 1) = ((MR_Box) (Var_33));
      }
      {
        MR_Word base;
        base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
