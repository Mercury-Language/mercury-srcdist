          ...
          case (MR_Integer) 0:
            {
              ...
              if (succeeded)
              {
                ...
                parse_tree__parse_vars__generate_repeated_var_msg_4_p_0(TypeInfo_for_T_102, ContextPieces_7, VarSet_6, HeadTerm_10, &Spec_32);
                {
                  ...
                  MR_hl_field(MR_mktag(1), Var_72, 0) = ((MR_Box) (Spec_32));
          ...
          case (MR_Integer) 1:
            {
              ...
              if (succeeded)
              {
                ...
                parse_tree__parse_vars__generate_repeated_var_msg_4_p_0(TypeInfo_for_T_102, ContextPieces_7, VarSet_6, HeadTerm_10, &Spec_90);
                {
                  ...
                  MR_hl_field(MR_mktag(1), Var_75, 0) = ((MR_Box) (Spec_90));
              ...
              else
              {
                ...
                }
                {
                  ...
                  MR_hl_field(MR_mktag(0), Var_77, 1) = ((MR_Box) (StateVars_35));
                  MR_hl_field(MR_mktag(0), Var_77, 2) = ((MR_Box) (TailDotVars_29));
          ...
          case (MR_Integer) 2:
            {
              ...
              if (succeeded)
              {
                ...
                parse_tree__parse_vars__generate_repeated_var_msg_4_p_0(TypeInfo_for_T_102, ContextPieces_7, VarSet_6, HeadTerm_10, &Spec_93);
                {
                  ...
                  MR_hl_field(MR_mktag(1), Var_78, 0) = ((MR_Box) (Spec_93));
              ...
              else
              {
                ...
                }
                {
                  ...
                  MR_hl_field(MR_mktag(0), Var_80, 1) = ((MR_Box) (TailStateVars_28));
                  MR_hl_field(MR_mktag(0), Var_80, 2) = ((MR_Box) (DotVars_36));
          ...
          case (MR_Integer) 3:
            {
              ...
              if (succeeded)
              {
                ...
                parse_tree__parse_vars__generate_repeated_var_msg_4_p_0(TypeInfo_for_T_102, ContextPieces_7, VarSet_6, HeadTerm_10, &Spec_97);
                {
                  ...
                  MR_hl_field(MR_mktag(1), Var_81, 0) = ((MR_Box) (Spec_97));
        ...
        if (((MR_tag((MR_Word) VarKind_22)) == (MR_Integer) 0))
        {
          ...
          if (succeeded)
          {
            ...
            parse_tree__parse_vars__generate_repeated_var_msg_4_p_0(TypeInfo_for_T_66, ContextPieces_7, VarSet_6, HeadTerm_10, &Spec_26);
            {
              ...
              MR_hl_field(MR_mktag(1), Var_51, 0) = ((MR_Box) (Spec_26));
          ...
          else
          {
            ...
            }
            {
              ...
              MR_hl_field(MR_mktag(0), Var_53, 0) = ((MR_Box) (Vars_27));
              MR_hl_field(MR_mktag(0), Var_53, 1) = ((MR_Box) (TailStateVars_24));
            }
            {
              MR_Word base;
              base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
        ...
        else
        {
          ...
          if (succeeded)
          {
            ...
            }
            {
              ...
              MR_hl_field(MR_mktag(1), Var_54, 0) = ((MR_Box) (Spec_62));
          ...
          else
          {
            ...
            }
            {
              ...
              MR_hl_field(MR_mktag(0), Var_56, 0) = ((MR_Box) (TailVars_23));
              MR_hl_field(MR_mktag(0), Var_56, 1) = ((MR_Box) (StateVars_29));
            }
            {
              MR_Word base;
              base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
