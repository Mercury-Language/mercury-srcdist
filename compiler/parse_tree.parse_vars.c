...
{
  {
    ...
    TermStr_9 = parse_tree__parse_tree_out_term__describe_error_term_2_f_0(TypeInfo_for_T_28, VarSet_6, Term_7);
    ...
    Var_27 = mercury__term__get_term_context_1_f_0(TypeInfo_for_T_28, Term_7);
    {
      MR_Word base;
      ...
      *Spec_8 = base;
      ...
      MR_hl_field(MR_mktag(1), base, 3) = ((MR_Box) (Pieces_10));
    }
  }
}
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            ...
            TermStr_58 = parse_tree__parse_tree_out_term__describe_error_term_2_f_0(TypeInfo_for_T_46, VarSet_6, HeadTerm_10);
            ...
            }
            {
              ...
              MR_hl_field(MR_mktag(1), Var_66, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &parse_tree__parse_vars_scalar_common_1[2])));
            }
            {
              Var_63 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), Var_63, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &parse_tree__parse_vars_scalar_common_1[6])));
            ...
            Pieces_59 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_format_component_0), Var_60, Var_61);
            Var_76 = mercury__term__get_term_context_1_f_0(TypeInfo_for_T_46, HeadTerm_10);
            {
              ...
              MR_hl_field(MR_mktag(1), Spec_23, 2) = ((MR_Box) (Var_76));
              MR_hl_field(MR_mktag(1), Spec_23, 3) = ((MR_Box) (Pieces_59));
            }
            {
...
{
  {
    ...
    TermStr_11 = parse_tree__parse_tree_out_term__describe_error_term_2_f_0(TypeInfo_for_T_38, VarSet_7, Term_9);
    ...
    Var_37 = mercury__term__get_term_context_1_f_0(TypeInfo_for_T_38, Term_9);
    {
      MR_Word base;
      base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL));
      *Spec_10 = base;
      ...
      MR_hl_field(MR_mktag(1), base, 3) = ((MR_Box) (Pieces_12));
    }
  }
}
