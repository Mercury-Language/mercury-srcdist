      ...
      if (succeeded)
        ...
        else
        {
          ...
          if (succeeded)
          {
            ...
            {
              Var_81 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(1, Var_81, 0) = ((MR_Box) (MR_mkword(3, &parse_tree__parse_vars_scalar_common_2[5])));
            ...
            Var_90 = mercury__term__get_term_context_1_f_0(TypeInfo_for_T_66, HeadTerm_10);
            {
              ...
              MR_hl_field(1, Spec_62, 0) = ((MR_Box) ((MR_String) "predicate \140parse_tree.parse_vars.generate_repeated_state_var_msg\'/4"));
              MR_hl_field(1, Spec_62, 1) = ((MR_Box) ((MR_Unsigned) 0U));
              MR_hl_field(1, Spec_62, 2) = ((MR_Box) ((MR_Unsigned) 20U));
              MR_hl_field(1, Spec_62, 3) = ((MR_Box) (Var_90));
              MR_hl_field(1, Spec_62, 4) = ((MR_Box) (Pieces_77));
            }
            {
