...
{
  {
    ...
    else
    {
      ...
      mercury__list____Compare____list_1_0(TypeInfo_13_13, &Var_8, (MR_Word) ArgX1_4, (MR_Word) ArgY1_5);
      ...
      else
      {
        ...
        mercury__list____Compare____list_1_0(TypeInfo_17_17, HeadVar__1_1, (MR_Word) ArgX2_6, (MR_Word) ArgY2_7);
      }
    }
  }
}
...
{
  {
    ...
    else
    {
      ...
      mercury__list____Compare____list_1_0(TypeInfo_19_19, &Var_12, (MR_Word) ArgX1_4, (MR_Word) ArgY1_5);
      ...
      else
      {
        ...
        mercury__list____Compare____list_1_0(TypeInfo_23_23, &Var_13, (MR_Word) ArgX2_6, (MR_Word) ArgY2_7);
        ...
        else
        {
          ...
          mercury__list____Compare____list_1_0(TypeInfo_27_27, &Var_14, (MR_Word) ArgX3_8, (MR_Word) ArgY3_9);
          ...
          else
          {
            ...
            mercury__list____Compare____list_1_0(TypeInfo_31_31, HeadVar__1_1, (MR_Word) ArgX4_10, (MR_Word) ArgY4_11);
          }
        }
      }
    }
...
{
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        Var_12 = ((MR_Word) (MR_hl_field(MR_mktag(0), Term_5, (MR_Integer) 2)));
      ...
      if (succeeded)
      {
        ...
        if (((MR_tag((MR_Word) HeadTerm_10)) == (MR_mktag((MR_Integer) 0))))
        {
          ...
          MR_String Var_133;
          MR_Word Var_135;
          MR_Word Var_128 = ((MR_Word) (MR_hl_field(MR_mktag(0), HeadTerm_10, (MR_Integer) 2)));
          MR_Word Var_134;

          succeeded = ((MR_tag((MR_Word) Var_129)) == (MR_mktag((MR_Integer) 1)));
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              succeeded = ((MR_tag((MR_Word) Var_130)) == (MR_mktag((MR_Integer) 0)));
              if (succeeded)
              {
                Var_133 = ((MR_String) (MR_hl_field(MR_mktag(0), Var_130, (MR_Integer) 0)));
                succeeded = ((MR_tag((MR_Word) Var_132)) == (MR_mktag((MR_Integer) 1)));
                if (succeeded)
                {
                  Var_135 = ((MR_Word) (MR_hl_field(MR_mktag(1), Var_132, (MR_Integer) 0)));
                  Var_134 = ((MR_Word) (MR_hl_field(MR_mktag(1), Var_132, (MR_Integer) 1)));
                  if ((strcmp(Var_133, (MR_String) "!") == 0))
                  {
                    {
                      VarKind0_15 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
                  ...
                  {
                    {
                      VarKind0_15 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
                  ...
                  {
                    {
                      VarKind0_15 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
        ...
        else
        {
          ...
          MR_Word Var_14 = ((MR_Word) (MR_hl_field(MR_mktag(1), HeadTerm_10, (MR_Integer) 1)));

          {
            VarKind0_15 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL);
        ...
        if (succeeded)
          {
            MaybeHeadVar_23 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
        ...
        else
        {
          ...
          {
            MaybeHeadVar_23 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL);
        ...
        succeeded = ((MR_tag((MR_Word) MaybeHeadVar_23)) == (MR_mktag((MR_Integer) 1)));
        if (succeeded)
        {
          VarKind_26 = ((MR_Word) (MR_hl_field(MR_mktag(1), MaybeHeadVar_23, (MR_Integer) 0)));
          succeeded = ((MR_tag((MR_Word) MaybeTailVars_25)) == (MR_mktag((MR_Integer) 1)));
          if (succeeded)
          {
            ...
            case (MR_Integer) 1:
              {
                ...
                else
                {
                  ...
                  {
                    StateVars_35 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
            ...
            case (MR_Integer) 2:
              {
                ...
                else
                {
                  ...
                  {
                    DotVars_36 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
            ...
            case (MR_Integer) 3:
              {
...

                {
                  ...
                  {
                    TypeInfo_118_118 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
                ...
                else
                {
                  ...
                  {
                    ColonVars_37 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
        ...
        else
        {
          ...
          {
            TypeInfo_124_124 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        if (((MR_tag((MR_Word) HeadTerm_10)) == (MR_mktag((MR_Integer) 0))))
        {
          ...
          MR_Word Var_45;
          MR_Word Var_46;
          MR_Word Var_18 = ((MR_Word) (MR_hl_field(MR_mktag(0), HeadTerm_10, (MR_Integer) 2)));
          MR_Word Var_17;
              ...
              if (succeeded)
              {
                ...
                if (succeeded)
                {
                  ...
                  if (succeeded)
                  {
                    ...
                    Var_17 = ((MR_Word) (MR_hl_field(MR_mktag(1), Var_45, (MR_Integer) 1)));
                    {
                      VarKind0_15 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
        ...
        if (succeeded)
          {
            MaybeHeadVar_19 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
        ...
        else
        {
          ...
          {
            MaybeHeadVar_19 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL);
        ...
        succeeded = ((MR_tag((MR_Word) MaybeHeadVar_19)) == (MR_mktag((MR_Integer) 1)));
        if (succeeded)
        {
          VarKind_22 = ((MR_Word) (MR_hl_field(MR_mktag(1), MaybeHeadVar_19, (MR_Integer) 0)));
          succeeded = ((MR_tag((MR_Word) MaybeTailVars_21)) == (MR_mktag((MR_Integer) 1)));
          if (succeeded)
          {
        ...
        if (succeeded)
          if (((MR_tag((MR_Word) VarKind_22)) == (MR_mktag((MR_Integer) 0))))
          {
            ...
            else
            {
              ...
              {
                Vars_27 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
          ...
          else
          {
            ...
            else
            {
              ...
              {
                StateVars_29 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
...
{
  {
    ...
    TypeCtorInfo_35_35 = (MR_Word) &parse_tree__error_util__parse_tree__error_util__type_ctor_info_format_component_0;
    Var_11 = mercury__cord__list_1_f_0(TypeCtorInfo_35_35, ContextPieces_5);
    {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), Var_12, 0) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
      MR_hl_field(MR_mktag(1), Var_12, 1) = ((MR_Box) (Var_14));
    }
    Pieces_10 = mercury__list__f_43_43_2_f_0(TypeCtorInfo_35_35, Var_11, Var_12);
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        if (((MR_tag((MR_Word) HeadTerm_10)) == (MR_mktag((MR_Integer) 0))))
        {
          ...
          {
            MaybeHeadVar_15 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL);
        ...
        else
        {
          ...
          {
            MaybeHeadVar_15 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
        ...
        succeeded = ((MR_tag((MR_Word) MaybeHeadVar_15)) == (MR_mktag((MR_Integer) 1)));
        if (succeeded)
        {
          HeadVar_21 = ((MR_Word) (MR_hl_field(MR_mktag(1), MaybeHeadVar_15, (MR_Integer) 0)));
          succeeded = ((MR_tag((MR_Word) MaybeTailVars_20)) == (MR_mktag((MR_Integer) 1)));
          if (succeeded)
        ...
        if (succeeded)
        {
          ...
          else
          {
            ...
            {
              Vars_24 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
...
{
  {
    ...
    Var_13 = mercury__cord__list_1_f_0(TypeCtorInfo_45_45, ContextPieces_6);
    {
    ...
    Pieces_12 = mercury__list__f_43_43_2_f_0(TypeCtorInfo_45_45, Var_13, Var_14);
