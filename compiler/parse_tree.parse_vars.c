        ...
        if (((MR_tag((MR_Word) VarKind_22)) == (MR_Integer) 0))
        {
          ...
          if (succeeded)
          {
            ...
            Var_90 = mercury__term__get_term_context_1_f_0(TypeInfo_for_T_66, HeadTerm_10);
            {
              ...
              MR_hl_field(0, Spec_26, 0) = ((MR_Box) ((MR_String) "predicate \140parse_tree.parse_vars.generate_repeated_var_msg\'/4"));
              MR_hl_field(0, Spec_26, 1) = ((MR_Box) ((MR_Unsigned) 0U));
              MR_hl_field(0, Spec_26, 2) = ((MR_Box) ((MR_Unsigned) 24U));
              MR_hl_field(0, Spec_26, 3) = ((MR_Box) (Var_90));
              MR_hl_field(0, Spec_26, 4) = ((MR_Box) (Pieces_77));
            }
            {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          Var_68 = mercury__term__get_term_context_1_f_0(TypeInfo_for_T_46, HeadTerm_10);
          {
            ...
            MR_hl_field(0, Spec_23, 0) = ((MR_Box) ((MR_String) "predicate \140parse_tree.parse_vars.generate_repeated_var_msg\'/4"));
            MR_hl_field(0, Spec_23, 1) = ((MR_Box) ((MR_Unsigned) 0U));
            MR_hl_field(0, Spec_23, 2) = ((MR_Box) ((MR_Unsigned) 24U));
            MR_hl_field(0, Spec_23, 3) = ((MR_Box) (Var_68));
            MR_hl_field(0, Spec_23, 4) = ((MR_Box) (Pieces_55));
          }
          {
