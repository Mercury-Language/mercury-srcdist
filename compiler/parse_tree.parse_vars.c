  ...
  MR_Word * Spec_8)
{
  ...
  }
  {
    ...
    MR_hl_field(MR_mktag(1), Var_14, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &parse_tree__parse_vars_scalar_common_2[5])));
  ...
  Var_28 = mercury__term__get_term_context_1_f_0(TypeInfo_for_T_29, Term_7);
  {
    ...
    *Spec_8 = base;
    MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) ((MR_String) "predicate \140parse_tree.parse_vars.generate_repeated_state_var_msg\'/4"));
