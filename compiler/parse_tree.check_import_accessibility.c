...
static const MR_FA_PseudoTypeInfo_Struct1 parse_tree__check_import_accessibility__list__pti_list_1__plain_parse_tree__error_spec__type_ctor_info_diag_spec_0;
...
static /* final */ const MR_Box parse_tree__check_import_accessibility_scalar_common_4[7][9] = {
  ...
  /* row   6 */
  {
    ...
    ((MR_Box) (&parse_tree__check_import_accessibility__list__pti_list_1__plain_parse_tree__error_spec__type_ctor_info_diag_spec_0)),
    ((MR_Box) (&parse_tree__check_import_accessibility__list__pti_list_1__plain_parse_tree__error_spec__type_ctor_info_diag_spec_0))
  },
};
