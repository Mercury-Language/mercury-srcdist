...
MR_decl_label8(hlds__mark_tail_calls__mark_tail_calls_7_0, 2,3,4,5,7,8,9,10)
MR_decl_label6(hlds__mark_tail_calls__mark_tail_calls_7_0, 13,12,16,17,18,20)
...
MR_decl_label8(hlds__mark_tail_calls__mark_tail_calls_in_goal_9_0, 90,42,40,91,24,27,22,92)
MR_decl_label8(hlds__mark_tail_calls__mark_tail_calls_in_goal_9_0, 23,49,4,97,7,8,9,93)
MR_decl_label8(hlds__mark_tail_calls__mark_tail_calls_in_goal_9_0, 13,95,17,18,96,31,94,34)
...
MR_BEGIN_MODULE(hlds__mark_tail_calls_module4)
	...
	MR_init_label8(hlds__mark_tail_calls__mark_tail_calls_in_goal_9_0,90,42,40,91,24,27,22,92)
	MR_init_label8(hlds__mark_tail_calls__mark_tail_calls_in_goal_9_0,23,49,4,97,7,8,9,93)
	MR_init_label8(hlds__mark_tail_calls__mark_tail_calls_in_goal_9_0,13,95,17,18,96,31,94,34)
MR_BEGIN_CODE
...
MR_def_static(hlds__mark_tail_calls__mark_tail_calls_in_goal_9_0)
	...
	MR_COMPUTED_GOTO((MR_Unsigned) MR_tag(MR_r7),
		MR_LABEL_AP(hlds__mark_tail_calls__mark_tail_calls_in_goal_9_0_i90) MR_AND
		MR_LABEL_AP(hlds__mark_tail_calls__mark_tail_calls_in_goal_9_0_i91) MR_AND
		MR_LABEL_AP(hlds__mark_tail_calls__mark_tail_calls_in_goal_9_0_i92) MR_AND
		MR_LABEL_AP(hlds__mark_tail_calls__mark_tail_calls_in_goal_9_0_i49));
MR_def_label(hlds__mark_tail_calls__mark_tail_calls_in_goal_9_0,90)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(9);
...
MR_def_label(hlds__mark_tail_calls__mark_tail_calls_in_goal_9_0,91)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(9);
	MR_sv(9) = (MR_Word) MR_succip;
	{
...
MR_def_label(hlds__mark_tail_calls__mark_tail_calls_in_goal_9_0,22)
	...
	MR_r6 = MR_sv(7);
	MR_GOTO_LAB(hlds__mark_tail_calls__mark_tail_calls_in_goal_9_0_i23);
MR_def_label(hlds__mark_tail_calls__mark_tail_calls_in_goal_9_0,92)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(9);
	MR_sv(9) = (MR_Word) MR_succip;
MR_def_label(hlds__mark_tail_calls__mark_tail_calls_in_goal_9_0,23)
	...
	MR_r3 = MR_r6;
	MR_decr_sp_and_return(9);
MR_def_label(hlds__mark_tail_calls__mark_tail_calls_in_goal_9_0,49)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_COMPUTED_GOTO((MR_Unsigned) MR_ctfield(3, MR_r7, 0),
		...
		MR_LABEL_AP(hlds__mark_tail_calls__mark_tail_calls_in_goal_9_0_i93) MR_AND
		MR_LABEL_AP(hlds__mark_tail_calls__mark_tail_calls_in_goal_9_0_i94) MR_AND
		MR_LABEL_AP(hlds__mark_tail_calls__mark_tail_calls_in_goal_9_0_i92) MR_AND
		MR_LABEL_AP(hlds__mark_tail_calls__mark_tail_calls_in_goal_9_0_i92) MR_AND
		MR_LABEL_AP(hlds__mark_tail_calls__mark_tail_calls_in_goal_9_0_i95) MR_AND
		MR_LABEL_AP(hlds__mark_tail_calls__mark_tail_calls_in_goal_9_0_i96));
MR_def_label(hlds__mark_tail_calls__mark_tail_calls_in_goal_9_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r8 = MR_ctfield(3, MR_r7, 1);
	if (MR_INT_NE(MR_r8,1)) {
		MR_GOTO_LAB(hlds__mark_tail_calls__mark_tail_calls_in_goal_9_0_i97);
	}
	MR_r1 = (MR_Word) MR_tbmkword(0, 0);
	MR_r2 = MR_r5;
	MR_r3 = MR_r6;
	MR_proceed();
MR_def_label(hlds__mark_tail_calls__mark_tail_calls_in_goal_9_0,97)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(9);
	MR_sv(9) = (MR_Word) MR_succip;
	MR_sv(1) = MR_r1;
...
MR_def_label(hlds__mark_tail_calls__mark_tail_calls_in_goal_9_0,93)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(9);
	MR_sv(9) = (MR_Word) MR_succip;
	MR_sv(5) = MR_ctfield(0, MR_r5, 1);
...
MR_def_label(hlds__mark_tail_calls__mark_tail_calls_in_goal_9_0,95)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(9);
	MR_sv(9) = (MR_Word) MR_succip;
	MR_sv(1) = MR_r1;
...
MR_def_label(hlds__mark_tail_calls__mark_tail_calls_in_goal_9_0,96)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(9);
	MR_sv(9) = (MR_Word) MR_succip;
...
MR_def_label(hlds__mark_tail_calls__mark_tail_calls_in_goal_9_0,94)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(9);
	MR_sv(9) = (MR_Word) MR_succip;
	MR_sv(5) = MR_ctfield(0, MR_r5, 1);
...
MR_BEGIN_MODULE(hlds__mark_tail_calls_module8)
	...
	MR_init_label8(hlds__mark_tail_calls__mark_tail_calls_7_0,2,3,4,5,7,8,9,10)
	MR_init_label6(hlds__mark_tail_calls__mark_tail_calls_7_0,13,12,16,17,18,20)
MR_BEGIN_CODE
...
MR_def_label(hlds__mark_tail_calls__mark_tail_calls_7_0,5)
	...
	if (MR_INT_NE(MR_r2,3)) {
		MR_GOTO_LAB(hlds__mark_tail_calls__mark_tail_calls_7_0_i7);
	}
	MR_r1 = MR_sv(8);
	MR_decr_sp_and_return(9);
MR_def_label(hlds__mark_tail_calls__mark_tail_calls_7_0,7)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r2,0)) {
		MR_GOTO_LAB(hlds__mark_tail_calls__mark_tail_calls_7_0_i8);
	}
	MR_r1 = MR_sv(8);
	MR_decr_sp_and_return(9);
