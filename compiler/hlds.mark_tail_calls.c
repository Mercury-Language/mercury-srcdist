...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_17, (MR_Integer) 146, &ExecTraceTailRec_34);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_14, (MR_Integer) 146, &ExecTraceTailRec_28);
...
{
  {
    ...
    {
      MainMsg_23 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), MainMsg_23, 0) = ((MR_Box) (Context_12));
      MR_hl_field(MR_mktag(1), MainMsg_23, 1) = ((MR_Box) (Var_50));
    }
    {
...
{
  {
    ...
    {
      MainMsg_21 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), MainMsg_21, 0) = ((MR_Box) (Context_10));
      MR_hl_field(MR_mktag(1), MainMsg_21, 1) = ((MR_Box) (Var_46));
    }
    {
      Var_50 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
    ...
    case (MR_Integer) 0:
      {
        ...
        else
        {
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(1), Msg_32, 0) = ((MR_Box) (Context_14));
            MR_hl_field(MR_mktag(1), Msg_32, 1) = ((MR_Box) (Var_63));
          }
          {
