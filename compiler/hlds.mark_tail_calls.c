  ...
  MR_Word * STATE_VARIABLE_Specs_25)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_17, (MR_Integer) 162, &ExecTraceTailRec_34);
  ...
  MR_Word * STATE_VARIABLE_Specs_22)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_14, (MR_Integer) 162, &ExecTraceTailRec_26);
  ...
  MR_Word * STATE_VARIABLE_Specs_7)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      hlds__mark_tail_calls__maybe_override_warn_params_for_proc_3_p_0(ProcInfo0_25, WarnParams_44, &ProcWarnParams_45);
      ...
      Var_51 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), HeadVar__1_1, (MR_Integer) 2))) & (MR_Integer) 1);
      {
        ...
        MR_hl_field(MR_mktag(0), ProcParams_26, 0) = ((MR_Box) (Var_49));
        MR_hl_field(MR_mktag(0), ProcParams_26, 1) = ((MR_Box) (Var_50));
        MR_hl_field(MR_mktag(0), ProcParams_26, 2) = (MR_Box) ((MR_Unsigned) (Var_51));
        MR_hl_field(MR_mktag(0), ProcParams_26, 3) = ((MR_Box) (ProcWarnParams_45));
      }
    ...
    case (MR_Integer) 1:
      {
        ...
        *Goal_8 = Goal0_7;
        ...
        hlds__var_table__lookup_var_entry_3_p_0(VarTable_62, LHSVar_57, &LHSVarEntry_63);
  ...
  MR_Word * STATE_VARIABLE_Specs_23)
{
  ...
  if (succeeded)
  {
    ...
    MR_Word CallerPredFormArity_42;
    MR_Word CallerId_43;
    MR_Word Var_51;
    ...
    CallerPredFormArity_42 = hlds__hlds_pred__pred_info_pred_form_arity_1_f_0(CallerPredInfo_39);
    {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(0), CallerId_43, 2) = ((MR_Box) (CallerPredFormArity_42));
    }
    succeeded = hlds__hlds_pred____Unify____pred_proc_id_0_0(CallerPredProcId_11, CalleePredProcId_12);
    if (succeeded)
    ...
    else
    {
      ...
      MR_Word CalleePredFormArity_49;
      MR_Word CalleeId_50;
      MR_Word Var_53;
      MR_String Var_54;
      ...
      CalleePredFormArity_49 = hlds__hlds_pred__pred_info_pred_form_arity_1_f_0(CalleePredInfo_46);
      {
        ...
        MR_hl_field(MR_mktag(0), CalleeId_50, 2) = ((MR_Box) (CalleePredFormArity_49));
      }
        ...
        *ReasonPieces_7 = (MR_Word) (MR_mkword(MR_mktag(1), &hlds__mark_tail_calls_scalar_common_1[21]));
        {
          ...
          MR_hl_field(MR_mktag(2), Var_63, 0) = ((MR_Box) (Context_6));
          MR_hl_field(MR_mktag(2), Var_63, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &hlds__mark_tail_calls_scalar_common_1[51])));
        }
        {
          MR_Word base;
          base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
