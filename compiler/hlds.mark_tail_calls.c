  ...
  MR_Word * WarnNonTailRecParams_4)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 214, &WarnNonTailSelfRecBool_5);
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 215, &WarnNonTailMutualRecBool_7);
      ...
      case (MR_Integer) 1:
        {
          ...
          succeeded = libs__globals__lookup_bool_option_3_p_1(Globals_21, (MR_Integer) 213, (MR_Integer) 1);
        }
        break;
    }
  if (succeeded)
