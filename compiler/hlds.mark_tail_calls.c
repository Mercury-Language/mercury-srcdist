...
static const MR_FA_TypeInfo_Struct1 hlds__mark_tail_calls__maybe__ti_maybe_1parse_tree__prog_data_pragma__type_ctor_info_require_tail_recursion_0;
...
static const MR_PseudoTypeInfo hlds__mark_tail_calls__hlds__mark_tail_calls__field_types_mark_tail_calls_info_0_0[8] = {
  ...
  (MR_PseudoTypeInfo) &hlds__mark_tail_calls__maybe__ti_maybe_1parse_tree__prog_data_pragma__type_ctor_info_require_tail_recursion_0
};
...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(0), hlds__mark_tail_calls__Spec_24, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 18))));
            ...
            *hlds__mark_tail_calls__Errors_18 = hlds__mark_tail_calls__Errors0_28;
          else
            {
              ...
              }
              {
                ...
                MR_hl_field(MR_mktag(0), hlds__mark_tail_calls__NonRecursiveSpec_42, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 18))));
      ...
      case (MR_Integer) 1:
        {
          ...
          {
            libs__globals__lookup_bool_option_3_p_0(hlds__mark_tail_calls__Globals_19, (MR_Integer) 136, &hlds__mark_tail_calls__ExecTraceTailRec_20);
          }
          ...
          {
            libs__globals__lookup_bool_option_3_p_0(hlds__mark_tail_calls__Globals_19, (MR_Integer) 31, &hlds__mark_tail_calls__WarnNonTailRecursionBool_22);
          }
