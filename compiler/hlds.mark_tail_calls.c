...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_17, (MR_Integer) 145, &ExecTraceTailRec_34);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_14, (MR_Integer) 145, &ExecTraceTailRec_28);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 32, &WarnNonTailSelfRecBool_5);
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 33, &WarnNonTailMutualRecBool_7);
        ...
        case (MR_Integer) 1:
          {
            ...
            succeeded = libs__globals__lookup_bool_option_3_p_1(Globals_21, (MR_Integer) 35, (MR_Integer) 1);
          }
          break;
      }
    if (succeeded)
