...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_17, (MR_Integer) 153, &ExecTraceTailRec_34);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_14, (MR_Integer) 153, &ExecTraceTailRec_28);
    ...
    case (MR_Integer) 0:
      {
        ...
        else
        {
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(3), Var_52, 0) = ((MR_Box) ((MR_Unsigned) 22U));
