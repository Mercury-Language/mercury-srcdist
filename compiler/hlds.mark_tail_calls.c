...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_17, (MR_Integer) 148, &ExecTraceTailRec_34);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_14, (MR_Integer) 148, &ExecTraceTailRec_28);
...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(0), Spec_24, 2) = ((MR_Box) ((MR_Unsigned) 76U));
...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(0), Spec_22, 2) = ((MR_Box) ((MR_Unsigned) 76U));
    ...
    case (MR_Integer) 0:
      {
        ...
        else
        {
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(1), Spec_32, 2) = ((MR_Box) ((MR_Unsigned) 76U));
