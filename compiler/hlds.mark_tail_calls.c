...
{
  {
...

    {
      ...
      MR_hl_field(MR_mktag(3), hlds__mark_tail_calls__Var_25, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 14));
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(3), hlds__mark_tail_calls__Var_35, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 13));
...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(3), hlds__mark_tail_calls__Var_32, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 14));
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(3), hlds__mark_tail_calls__Var_43, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 14));
...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(3), hlds__mark_tail_calls__Var_30, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 14));
