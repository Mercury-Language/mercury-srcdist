...
{
  {
    ...
    else
    {
      ...
      MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), AtTail_17, (MR_Integer) 0)));
...
{
  {
    ...
    else
    {
      ...
      MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), AtTail_12, (MR_Integer) 0)));
...
{
  {
    ...
    packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Params_18, (MR_Integer) 2)));
    ...
    packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Params_18, (MR_Integer) 2)));
  ...
  MR_Word * STATE_VARIABLE_Specs_9)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), HeadVar__1_1, (MR_Integer) 2)));
      ...
      case (MR_Integer) 1:
        {
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), WarnNonTailRecParams_27, (MR_Integer) 0)));
          ...
          else
          {
            ...
            packed_word_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Info_38, (MR_Integer) 6)));
      ...
      case (MR_Integer) 1:
        {
          ...
          *Goal_8 = Goal0_7;
          ...
          packed_word_18 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_Info_0_149, (MR_Integer) 6)));
      ...
      case (MR_Integer) 2:
        {
          ...
          packed_word_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_Info_0_149, (MR_Integer) 6)));
          ...
          if (succeeded)
          {
            ...
            {
              STATE_VARIABLE_Info_166_166 = (MR_Word) MR_new_object(MR_Word, (8 * sizeof(MR_Word)), NULL, NULL);
              ...
              MR_hl_field(MR_mktag(0), STATE_VARIABLE_Info_166_166, 6) = (MR_Box) ((((packed_word_3 & (~((MR_Unsigned) 1U)))) | (MR_Unsigned) ((MR_Integer) 1)));
            ...
            if (succeeded)
            {
              ...
              packed_word_4 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_Info_166_166, (MR_Integer) 6)));
            ...
            if (succeeded)
            {
              ...
              MR_Unsigned packed_word_5 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_Info_166_166, (MR_Integer) 6)));
              ...
              packed_word_6 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Var_168, (MR_Integer) 2)));
            ...
            else
            {
              ...
              else
              {
                ...
                MR_Unsigned packed_word_7 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), AtTail0_9, (MR_Integer) 0)));
              ...
              packed_word_8 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_Info_166_166, (MR_Integer) 6)));
              ...
              packed_word_9 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_Info_166_166, (MR_Integer) 6)));
              Specs0_114 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_Info_166_166, (MR_Integer) 7))));
              packed_word_10 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Var_176, (MR_Integer) 2)));
              ...
              packed_word_11 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_Info_166_166, (MR_Integer) 6)));
              {
                MR_Word base;
                base = (MR_Word) MR_new_object(MR_Word, (8 * sizeof(MR_Word)), NULL, NULL);
                *STATE_VARIABLE_Info_150 = base;
          ...
          case (MR_Integer) 3:
            {
              ...
              if (succeeded)
              {
                ...
                *STATE_VARIABLE_Info_150 = ((MR_Word) (conv4_STATE_VARIABLE_Info_150));
                ...
                {
                  GoalExpr_206 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          ...
          case (MR_Integer) 4:
            {
              ...
              MR_Unsigned packed_word_17 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), GoalExpr0_12, (MR_Integer) 2)));
              ...
              *STATE_VARIABLE_Info_150 = ((MR_Word) (conv9_STATE_VARIABLE_Info_150));
              ...
              {
                GoalExpr_210 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), GoalExpr_210, 0) = ((MR_Box) ((MR_Unsigned) 4U));
                MR_hl_field(MR_mktag(3), GoalExpr_210, 1) = ((MR_Box) (Var_131));
                MR_hl_field(MR_mktag(3), GoalExpr_210, 2) = (MR_Box) ((MR_Unsigned) (CanFail_132));
          ...
          case (MR_Integer) 5:
            {
                ...
                case (MR_Integer) 1:
                  {
                    ...
                    MR_Unsigned packed_word_12 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), Reason_27, (MR_Integer) 0)));
                    ...
                    if (succeeded)
                    {
                      ...
                      MR_Word Var_187;
                      MR_Unsigned packed_word_13 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_Info_0_149, (MR_Integer) 6)));
                      MR_Word Var_223;
                      MR_Word Var_224;
                      MR_Word Var_225;
                      ...
                      packed_word_14 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), OldParams_31, (MR_Integer) 2)));
                      Var_225 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), OldParams_31, (MR_Integer) 2))) & (MR_Integer) 1);
                      {
                        ...
                        MR_hl_field(MR_mktag(0), InnerParams_32, 2) = (MR_Box) ((MR_Unsigned) (Var_225));
              ...
              {
                Var_190 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
          ...
          case (MR_Integer) 6:
            {
              ...
              {
                GoalExpr_213 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL));
  ...
  MR_Word * SeenLaterRecCall_4)
{
  ...
  {
    MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), AtTail_3, (MR_Integer) 0)));
...
{
  {
    ...
    MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), WarnParams_16, (MR_Integer) 0)));
    ...
    case (MR_Integer) 0:
      {
        ...
        else
        {
          ...
          {
            MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), RequireTailRecInfo_11, (MR_Integer) 0)));
...
{
  {
    ...
    else
    {
      ...
      if (((MR_tag((MR_Word) Pragma_8)) == (MR_Integer) 1))
      {
        ...
        MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), Pragma_8, (MR_Integer) 0)));
