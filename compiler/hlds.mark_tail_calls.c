...
#line 27 "hlds.mark_tail_calls.c"
#line 144 "../library/io.int2"
#include "string.mh"

#line 31 "hlds.mark_tail_calls.c"
#line 33 "../mdbcomp/mdbcomp.rtti_access.int2"
#include "mdbcomp.rtti_access.mh"

#line 35 "hlds.mark_tail_calls.c"
#line 31 "../library/array.int2"
#include "array.mh"

#line 39 "hlds.mark_tail_calls.c"
#line 29 "../library/bitmap.int2"
#include "bitmap.mh"

#line 43 "hlds.mark_tail_calls.c"
#line 28 "../library/time.int2"
#include "time.mh"

#line 47 "hlds.mark_tail_calls.c"
#line 48 "hlds.mark_tail_calls.c"
#include "hlds.mark_tail_calls.mh"

#line 51 "hlds.mark_tail_calls.c"
#line 52 "hlds.mark_tail_calls.c"
#ifndef HLDS__MARK_TAIL_CALLS_DECL_GUARD
#define HLDS__MARK_TAIL_CALLS_DECL_GUARD

#line 56 "hlds.mark_tail_calls.c"
#line 57 "hlds.mark_tail_calls.c"

#endif
#line 60 "hlds.mark_tail_calls.c"
...
MR_decl_label6(hlds__mark_tail_calls__find_maybe_output_args_2_5_0, 41,8,10,12,42,1)
MR_decl_label4(hlds__mark_tail_calls__is_output_arg_rename_4_0, 5,4,8,1)
MR_decl_label10(hlds__mark_tail_calls__mark_tail_calls_7_0, 2,3,4,5,8,9,10,13,12,16)
MR_decl_label4(hlds__mark_tail_calls__mark_tail_calls_7_0, 17,18,20,22)
MR_decl_label3(hlds__mark_tail_calls__mark_tail_calls_in_cases_8_0, 15,4,6)
MR_decl_label4(hlds__mark_tail_calls__mark_tail_calls_in_conj_9_0, 22,5,7,9)
MR_decl_label10(hlds__mark_tail_calls__mark_tail_calls_in_goal_9_0, 37,42,40,104,24,27,22,105,23,55)
MR_decl_label10(hlds__mark_tail_calls__mark_tail_calls_in_goal_9_0, 4,62,111,7,8,9,107,13,109,17)
MR_decl_label5(hlds__mark_tail_calls__mark_tail_calls_in_goal_9_0, 18,110,31,108,34)
MR_decl_label3(hlds__mark_tail_calls__mark_tail_calls_in_goals_8_0, 14,4,5)
...
MR_decl_static(fn__hlds__mark_tail_calls__this_file_0_0)
...
MR_def_extern_entry(hlds__mark_tail_calls__mark_tail_calls_7_0)
...
MR_BEGIN_MODULE(hlds__mark_tail_calls_module0)
	...
	MR_init_label6(hlds__mark_tail_calls__find_maybe_output_args_2_5_0,41,8,10,12,42,1)
MR_BEGIN_CODE
...
MR_def_static(hlds__mark_tail_calls__find_maybe_output_args_2_5_0)
	...
	if (MR_LTAGS_TESTR(MR_r2,0,0)) {
		MR_GOTO_LAB(hlds__mark_tail_calls__find_maybe_output_args_2_5_0_i41);
	}
	if (MR_LTAGS_TESTR(MR_r3,0,0)) {
		MR_GOTO_LAB(hlds__mark_tail_calls__find_maybe_output_args_2_5_0_i42);
	}
	...
	MR_r1 = MR_TRUE;
	MR_proceed();
MR_def_label(hlds__mark_tail_calls__find_maybe_output_args_2_5_0,41)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(6);
...
MR_def_label(hlds__mark_tail_calls__find_maybe_output_args_2_5_0,42)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(6);
	MR_sv(6) = (MR_Word) MR_succip;
...
MR_BEGIN_MODULE(hlds__mark_tail_calls_module1)
	MR_init_entry1(fn__hlds__mark_tail_calls__this_file_0_0);
	MR_INIT_PROC_LAYOUT_ADDR(mercury__fn__hlds__mark_tail_calls__this_file_0_0);
MR_BEGIN_CODE
...
/* code for 'this_file'/1 mode 0 */
	...
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(fn__hlds__mark_tail_calls__this_file_0_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_string_const("mark_tail_calls.m", 17);
	MR_proceed();
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_thread_engine_base
...
MR_def_label(hlds__mark_tail_calls__match_output_args_2_0,38)
	...
	MR_r1 = (MR_Word) MR_string_const("mark_tail_calls.m", 17);
	MR_r2 = (MR_Word) MR_string_const("match_output_args: length mismatch", 34);
...
MR_BEGIN_MODULE(hlds__mark_tail_calls_module4)
	...
	MR_init_label10(hlds__mark_tail_calls__mark_tail_calls_in_goal_9_0,37,42,40,104,24,27,22,105,23,55)
	MR_init_label10(hlds__mark_tail_calls__mark_tail_calls_in_goal_9_0,4,62,111,7,8,9,107,13,109,17)
	MR_init_label5(hlds__mark_tail_calls__mark_tail_calls_in_goal_9_0,18,110,31,108,34)
MR_BEGIN_CODE
...
MR_def_static(hlds__mark_tail_calls__mark_tail_calls_in_goal_9_0)
	...
	MR_COMPUTED_GOTO((MR_Unsigned) MR_tag(MR_r7),
		MR_LABEL_AP(hlds__mark_tail_calls__mark_tail_calls_in_goal_9_0_i37) MR_AND
		MR_LABEL_AP(hlds__mark_tail_calls__mark_tail_calls_in_goal_9_0_i104) MR_AND
		MR_LABEL_AP(hlds__mark_tail_calls__mark_tail_calls_in_goal_9_0_i105) MR_AND
		MR_LABEL_AP(hlds__mark_tail_calls__mark_tail_calls_in_goal_9_0_i55));
MR_def_label(hlds__mark_tail_calls__mark_tail_calls_in_goal_9_0,37)
	...
	if (MR_INT_NE(MR_tag(MR_tempr1),2)) {
		MR_GOTO_LAB(hlds__mark_tail_calls__mark_tail_calls_in_goal_9_0_i62);
	}
	MR_incr_sp(9);
	...
	MR_np_call_localret_ent(hlds__mark_tail_calls__is_output_arg_rename_4_0,
		hlds__mark_tail_calls__mark_tail_calls_in_goal_9_0_i42);
MR_def_label(hlds__mark_tail_calls__mark_tail_calls_in_goal_9_0,42)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(hlds__mark_tail_calls__mark_tail_calls_in_goal_9_0_i40);
	}
...
MR_def_label(hlds__mark_tail_calls__mark_tail_calls_in_goal_9_0,40)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tempr1 = MR_sv(1);
...
MR_def_label(hlds__mark_tail_calls__mark_tail_calls_in_goal_9_0,104)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(9);
	MR_sv(9) = (MR_Word) MR_succip;
	{
...
MR_def_label(hlds__mark_tail_calls__mark_tail_calls_in_goal_9_0,22)
	...
	MR_r6 = MR_sv(7);
	MR_GOTO_LAB(hlds__mark_tail_calls__mark_tail_calls_in_goal_9_0_i23);
MR_def_label(hlds__mark_tail_calls__mark_tail_calls_in_goal_9_0,105)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(9);
	MR_sv(9) = (MR_Word) MR_succip;
MR_def_label(hlds__mark_tail_calls__mark_tail_calls_in_goal_9_0,23)
	...
	MR_r3 = MR_r6;
	MR_decr_sp_and_return(9);
MR_def_label(hlds__mark_tail_calls__mark_tail_calls_in_goal_9_0,55)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_COMPUTED_GOTO((MR_Unsigned) MR_tfield(3, MR_r7, 0),
		MR_LABEL_AP(hlds__mark_tail_calls__mark_tail_calls_in_goal_9_0_i105) MR_AND
		MR_LABEL_AP(hlds__mark_tail_calls__mark_tail_calls_in_goal_9_0_i4) MR_AND
		MR_LABEL_AP(hlds__mark_tail_calls__mark_tail_calls_in_goal_9_0_i107) MR_AND
		MR_LABEL_AP(hlds__mark_tail_calls__mark_tail_calls_in_goal_9_0_i108) MR_AND
		MR_LABEL_AP(hlds__mark_tail_calls__mark_tail_calls_in_goal_9_0_i105) MR_AND
		MR_LABEL_AP(hlds__mark_tail_calls__mark_tail_calls_in_goal_9_0_i105) MR_AND
		MR_LABEL_AP(hlds__mark_tail_calls__mark_tail_calls_in_goal_9_0_i109) MR_AND
		MR_LABEL_AP(hlds__mark_tail_calls__mark_tail_calls_in_goal_9_0_i110));
MR_def_label(hlds__mark_tail_calls__mark_tail_calls_in_goal_9_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r8 = MR_tfield(3, MR_r7, 1);
	if (MR_INT_NE(MR_r8,1)) {
		MR_GOTO_LAB(hlds__mark_tail_calls__mark_tail_calls_in_goal_9_0_i111);
	}
MR_def_label(hlds__mark_tail_calls__mark_tail_calls_in_goal_9_0,62)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_tbmkword(0, 0);
	MR_r2 = MR_r5;
	MR_r3 = MR_r6;
	MR_proceed();
MR_def_label(hlds__mark_tail_calls__mark_tail_calls_in_goal_9_0,111)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(9);
	MR_sv(9) = (MR_Word) MR_succip;
	MR_sv(1) = MR_r1;
...
MR_def_label(hlds__mark_tail_calls__mark_tail_calls_in_goal_9_0,107)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(9);
	MR_sv(9) = (MR_Word) MR_succip;
	MR_sv(5) = MR_tfield(0, MR_r5, 1);
...
MR_def_label(hlds__mark_tail_calls__mark_tail_calls_in_goal_9_0,109)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(9);
	MR_sv(9) = (MR_Word) MR_succip;
	MR_sv(1) = MR_r1;
...
MR_def_label(hlds__mark_tail_calls__mark_tail_calls_in_goal_9_0,110)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(9);
	MR_sv(9) = (MR_Word) MR_succip;
	MR_np_call_localret_ent(fn__hlds__mark_tail_calls__this_file_0_0,
		hlds__mark_tail_calls__mark_tail_calls_in_goal_9_0_i31);
MR_def_label(hlds__mark_tail_calls__mark_tail_calls_in_goal_9_0,31)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = (MR_Word) MR_string_const("mark_tail_calls_in_goal: shorthand", 34);
	MR_succip_word = MR_sv(9);
	MR_decr_sp(9);
	MR_np_tailcall_ent(libs__compiler_util__unexpected_2_0);
MR_def_label(hlds__mark_tail_calls__mark_tail_calls_in_goal_9_0,108)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(9);
	MR_sv(9) = (MR_Word) MR_succip;
	MR_sv(5) = MR_tfield(0, MR_r5, 1);
	...
	MR_np_call_localret_ent(hlds__mark_tail_calls__mark_tail_calls_in_cases_8_0,
		hlds__mark_tail_calls__mark_tail_calls_in_goal_9_0_i34);
...
MR_BEGIN_MODULE(hlds__mark_tail_calls_module5)
	...
	MR_init_label3(hlds__mark_tail_calls__mark_tail_calls_in_goals_8_0,14,4,5)
MR_BEGIN_CODE
...
MR_def_static(hlds__mark_tail_calls__mark_tail_calls_in_goals_8_0)
	...
	if (MR_LTAGS_TESTR(MR_r5,0,0)) {
		MR_GOTO_LAB(hlds__mark_tail_calls__mark_tail_calls_in_goals_8_0_i14);
	}
	MR_r1 = (MR_Word) MR_tbmkword(0, 0);
	MR_r2 = MR_r6;
	MR_proceed();
MR_def_label(hlds__mark_tail_calls__mark_tail_calls_in_goals_8_0,14)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(6);
	MR_sv(6) = (MR_Word) MR_succip;
	MR_sv(1) = MR_r1;
...
MR_BEGIN_MODULE(hlds__mark_tail_calls_module6)
	...
	MR_init_label3(hlds__mark_tail_calls__mark_tail_calls_in_cases_8_0,15,4,6)
MR_BEGIN_CODE
...
MR_def_static(hlds__mark_tail_calls__mark_tail_calls_in_cases_8_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r5,0,0)) {
		MR_GOTO_LAB(hlds__mark_tail_calls__mark_tail_calls_in_cases_8_0_i15);
	}
	MR_r1 = (MR_Word) MR_tbmkword(0, 0);
	MR_r2 = MR_r6;
	MR_proceed();
MR_def_label(hlds__mark_tail_calls__mark_tail_calls_in_cases_8_0,15)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(8);
...
MR_BEGIN_MODULE(hlds__mark_tail_calls_module7)
	...
	MR_init_label4(hlds__mark_tail_calls__mark_tail_calls_in_conj_9_0,22,5,7,9)
MR_BEGIN_CODE
...
MR_def_static(hlds__mark_tail_calls__mark_tail_calls_in_conj_9_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r5,0,0)) {
		MR_GOTO_LAB(hlds__mark_tail_calls__mark_tail_calls_in_conj_9_0_i22);
	}
	MR_tag_alloc_heap(MR_r1, 1, (MR_Integer) 1);
	...
	MR_r3 = MR_r6;
	MR_proceed();
MR_def_label(hlds__mark_tail_calls__mark_tail_calls_in_conj_9_0,22)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(5);
...
MR_BEGIN_MODULE(hlds__mark_tail_calls_module8)
	MR_init_entry1(hlds__mark_tail_calls__mark_tail_calls_7_0);
	MR_INIT_PROC_LAYOUT_ADDR(mercury__hlds__mark_tail_calls__mark_tail_calls_7_0);
	MR_init_label10(hlds__mark_tail_calls__mark_tail_calls_7_0,2,3,4,5,8,9,10,13,12,16)
	MR_init_label4(hlds__mark_tail_calls__mark_tail_calls_7_0,17,18,20,22)
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'mark_tail_calls'/7 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_define_entry(mercury__hlds__mark_tail_calls__mark_tail_calls_7_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(9);
	MR_sv(9) = (MR_Word) MR_succip;
	MR_sv(1) = MR_r1;
	...
	MR_np_call_localret_ent(hlds__hlds_pred__pred_info_get_arg_types_2_0,
		hlds__mark_tail_calls__mark_tail_calls_7_0_i2);
MR_def_label(hlds__mark_tail_calls__mark_tail_calls_7_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(5) = MR_r1;
	MR_r1 = MR_sv(8);
	MR_np_call_localret_ent(hlds__hlds_pred__proc_info_get_goal_2_0,
		hlds__mark_tail_calls__mark_tail_calls_7_0_i3);
MR_def_label(hlds__mark_tail_calls__mark_tail_calls_7_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(6) = MR_r1;
	MR_r1 = MR_sv(8);
	MR_np_call_localret_ent(hlds__hlds_pred__proc_info_interface_determinism_2_0,
		hlds__mark_tail_calls__mark_tail_calls_7_0_i4);
MR_def_label(hlds__mark_tail_calls__mark_tail_calls_7_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_np_call_localret_ent(parse_tree__prog_data__determinism_components_3_0,
		hlds__mark_tail_calls__mark_tail_calls_7_0_i5);
MR_def_label(hlds__mark_tail_calls__mark_tail_calls_7_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_COMPUTED_GOTO((MR_Unsigned) MR_r2,
		MR_LABEL_AP(hlds__mark_tail_calls__mark_tail_calls_7_0_i22) MR_AND
		MR_LABEL_AP(hlds__mark_tail_calls__mark_tail_calls_7_0_i8) MR_AND
		MR_LABEL_AP(hlds__mark_tail_calls__mark_tail_calls_7_0_i8) MR_AND
		MR_LABEL_AP(hlds__mark_tail_calls__mark_tail_calls_7_0_i22));
MR_def_label(hlds__mark_tail_calls__mark_tail_calls_7_0,8)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(8);
	MR_np_call_localret_ent(hlds__hlds_pred__proc_info_get_argmodes_2_0,
		hlds__mark_tail_calls__mark_tail_calls_7_0_i9);
MR_def_label(hlds__mark_tail_calls__mark_tail_calls_7_0,9)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(7) = MR_r1;
	MR_r1 = MR_sv(8);
	MR_np_call_localret_ent(hlds__hlds_pred__proc_info_get_headvars_2_0,
		hlds__mark_tail_calls__mark_tail_calls_7_0_i10);
MR_def_label(hlds__mark_tail_calls__mark_tail_calls_7_0,10)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
	...
	MR_np_call_localret_ent(hlds__mark_tail_calls__find_maybe_output_args_2_5_0,
		hlds__mark_tail_calls__mark_tail_calls_7_0_i13);
MR_def_label(hlds__mark_tail_calls__mark_tail_calls_7_0,13)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(hlds__mark_tail_calls__mark_tail_calls_7_0_i12);
	}
	MR_r1 = MR_sv(1);
	{
	MR_Word MR_tempr1;
	...
	MR_np_call_localret_ent(hlds__mark_tail_calls__mark_tail_calls_in_goal_9_0,
		hlds__mark_tail_calls__mark_tail_calls_7_0_i17);
MR_def_label(hlds__mark_tail_calls__mark_tail_calls_7_0,12)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_string_const("mark_tail_calls.m", 17);
	MR_r2 = (MR_Word) MR_string_const("find_maybe_output_args: list length mismatch", 44);
	MR_np_call_localret_ent(libs__compiler_util__unexpected_2_0,
		hlds__mark_tail_calls__mark_tail_calls_7_0_i16);
MR_def_label(hlds__mark_tail_calls__mark_tail_calls_7_0,16)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_np_call_localret_ent(hlds__mark_tail_calls__mark_tail_calls_in_goal_9_0,
		hlds__mark_tail_calls__mark_tail_calls_7_0_i17);
MR_def_label(hlds__mark_tail_calls__mark_tail_calls_7_0,17)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(1) = MR_r3;
	MR_r1 = MR_r2;
	MR_r2 = MR_sv(8);
	MR_np_call_localret_ent(hlds__hlds_pred__proc_info_set_goal_3_0,
		hlds__mark_tail_calls__mark_tail_calls_7_0_i18);
MR_def_label(hlds__mark_tail_calls__mark_tail_calls_7_0,18)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_sv(1),0)) {
		MR_GOTO_LAB(hlds__mark_tail_calls__mark_tail_calls_7_0_i20);
	}
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
...
MR_def_label(hlds__mark_tail_calls__mark_tail_calls_7_0,20)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
...
MR_def_label(hlds__mark_tail_calls__mark_tail_calls_7_0,22)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(8);
	MR_decr_sp_and_return(9);
#ifdef MR_maybe_local_thread_engine_base
