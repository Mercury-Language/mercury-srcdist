...
static /* final */ const MR_Box hlds__mark_tail_calls_scalar_common_1[13][2];
...
{
  {
      ...
      case (MR_Integer) 1:
        {
          ...
          hlds__mark_tail_calls__WarnOrErrorWord_16 = (MR_Word) MR_mkword(MR_mktag(3), &hlds__mark_tail_calls_scalar_common_1[8]);
        }
        break;
      case (MR_Integer) 0:
        {
          hlds__mark_tail_calls__Severity_15 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 1));
          hlds__mark_tail_calls__WarnOrErrorWord_16 = (MR_Word) MR_mkword(MR_mktag(3), &hlds__mark_tail_calls_scalar_common_1[9]);
        }
        break;
    }
    {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), hlds__mark_tail_calls__V_43_43, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &hlds__mark_tail_calls_scalar_common_1[7])));
    }
    {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), hlds__mark_tail_calls__V_38_38, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__mark_tail_calls_scalar_common_1[12])));
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), hlds__mark_tail_calls__V_33_33, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__mark_tail_calls_scalar_common_1[11])));
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), hlds__mark_tail_calls__Pieces_22, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__mark_tail_calls_scalar_common_1[10])));
      ...
      case (MR_Integer) 1:
        {
          ...
          if (hlds__mark_tail_calls__succeeded)
            ...
            {
              MR_Word hlds__mark_tail_calls__Types_46;
              MR_Word hlds__mark_tail_calls__Goal0_47;
              MR_Word hlds__mark_tail_calls__Modes_48;
              MR_Word hlds__mark_tail_calls__HeadVars_49;
              MR_Word hlds__mark_tail_calls__VarTypes_50;
              MR_Word hlds__mark_tail_calls__Outputs_51;
              MR_Word hlds__mark_tail_calls__Info_52;
              MR_Word hlds__mark_tail_calls__FoundTailCalls_53;
              MR_Word hlds__mark_tail_calls__Goal_54;
              MR_Word hlds__mark_tail_calls__TailCallEvents_56;
              MR_Word hlds__mark_tail_calls__V_57_57;
              MR_Word hlds__mark_tail_calls__STATE_VARIABLE_ProcInfo_34_58;
              MR_Word hlds__mark_tail_calls__OutputsPrime_65;
              MR_Word hlds__mark_tail_calls__V_55_55;

              {
                hlds__hlds_pred__pred_info_get_arg_types_2_p_0(hlds__mark_tail_calls__PredInfo_11, &hlds__mark_tail_calls__Types_46);
              }
              {
                hlds__hlds_pred__proc_info_get_goal_2_p_0(hlds__mark_tail_calls__STATE_VARIABLE_ProcInfo_0_26, &hlds__mark_tail_calls__Goal0_47);
              }
              {
                hlds__hlds_pred__proc_info_get_argmodes_2_p_0(hlds__mark_tail_calls__STATE_VARIABLE_ProcInfo_0_26, &hlds__mark_tail_calls__Modes_48);
              }
              {
                hlds__hlds_pred__proc_info_get_headvars_2_p_0(hlds__mark_tail_calls__STATE_VARIABLE_ProcInfo_0_26, &hlds__mark_tail_calls__HeadVars_49);
              }
              {
                hlds__hlds_pred__proc_info_get_vartypes_2_p_0(hlds__mark_tail_calls__STATE_VARIABLE_ProcInfo_0_26, &hlds__mark_tail_calls__VarTypes_50);
              }
              {
                hlds__mark_tail_calls__succeeded = hlds__mark_tail_calls__find_maybe_output_args_2_5_p_0(hlds__mark_tail_calls__ModuleInfo_8, hlds__mark_tail_calls__Types_46, hlds__mark_tail_calls__Modes_48, hlds__mark_tail_calls__HeadVars_49, &hlds__mark_tail_calls__OutputsPrime_65);
              }
              if (hlds__mark_tail_calls__succeeded)
                hlds__mark_tail_calls__Outputs_51 = hlds__mark_tail_calls__OutputsPrime_65;
              else
                {
                  {
              ...
              {
                hlds__mark_tail_calls__Info_52 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 8 * sizeof(MR_Word)), NULL, NULL);
                MR_hl_field(MR_mktag(0), hlds__mark_tail_calls__Info_52, 0) = ((MR_Box) (hlds__mark_tail_calls__AddGoalFeature_21));
                MR_hl_field(MR_mktag(0), hlds__mark_tail_calls__Info_52, 1) = ((MR_Box) (hlds__mark_tail_calls__ModuleInfo_8));
                MR_hl_field(MR_mktag(0), hlds__mark_tail_calls__Info_52, 2) = ((MR_Box) (hlds__mark_tail_calls__PredInfo_11));
                MR_hl_field(MR_mktag(0), hlds__mark_tail_calls__Info_52, 3) = ((MR_Box) (hlds__mark_tail_calls__PredId_9));
                MR_hl_field(MR_mktag(0), hlds__mark_tail_calls__Info_52, 4) = ((MR_Box) (hlds__mark_tail_calls__ProcId_10));
                MR_hl_field(MR_mktag(0), hlds__mark_tail_calls__Info_52, 5) = ((MR_Box) (hlds__mark_tail_calls__VarTypes_50));
                MR_hl_field(MR_mktag(0), hlds__mark_tail_calls__Info_52, 6) = ((MR_Box) (hlds__mark_tail_calls__WarnNonTailRecursion_23));
                MR_hl_field(MR_mktag(0), hlds__mark_tail_calls__Info_52, 7) = ((MR_Box) (hlds__mark_tail_calls__MaybeRequireTailRecursion_18));
              }
              {
                hlds__mark_tail_calls__V_57_57 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(1), hlds__mark_tail_calls__V_57_57, 0) = ((MR_Box) (hlds__mark_tail_calls__Outputs_51));
              }
              {
                hlds__mark_tail_calls__mark_tail_calls_in_goal_7_p_0(hlds__mark_tail_calls__Info_52, &hlds__mark_tail_calls__FoundTailCalls_53, hlds__mark_tail_calls__Errors_12, hlds__mark_tail_calls__Goal0_47, &hlds__mark_tail_calls__Goal_54, hlds__mark_tail_calls__V_57_57, &hlds__mark_tail_calls__V_55_55);
              }
              {
                hlds__hlds_pred__proc_info_set_goal_3_p_0(hlds__mark_tail_calls__Goal_54, hlds__mark_tail_calls__STATE_VARIABLE_ProcInfo_0_26, &hlds__mark_tail_calls__STATE_VARIABLE_ProcInfo_34_58);
              }
              switch (hlds__mark_tail_calls__FoundTailCalls_53) {
                default: /*NOTREACHED*/ MR_assert(0);
                case (MR_Integer) 0:
              ...
              {
                hlds__hlds_pred__proc_info_set_has_tail_call_event_3_p_0(hlds__mark_tail_calls__TailCallEvents_56, hlds__mark_tail_calls__STATE_VARIABLE_ProcInfo_34_58, hlds__mark_tail_calls__STATE_VARIABLE_ProcInfo_27);
              }
