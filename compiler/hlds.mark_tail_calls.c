  ...
  MR_Word * STATE_VARIABLE_Specs_36)
{
  ...
  mercury__map__count_2_p_0((MR_Word) (&hlds__pred_proc_id__hlds__pred_proc_id__type_ctor_info_proc_id_0), (MR_Word) (&hlds__hlds_proc__hlds__hlds_proc__type_ctor_info_proc_info_0), CallerProcTable_25, &CallerNumProcs_26);
  ...
  if (succeeded)
  {
    ...
    else
    {
      ...
      hlds__pred_proc_id__proc_id_to_int_2_p_0(CallerProcId_76, &CallerProcNumber0_77);
    ...
    }
    {
      ...
      MR_hl_field(2, Spec_53, 2) = ((MR_Box) ((MR_Unsigned) 116U));
  ...
  MR_Word * STATE_VARIABLE_Specs_28)
{
  ...
  else
  {
    ...
    hlds__pred_proc_id__proc_id_to_int_2_p_0(CallerProcId_66, &CallerProcNumber0_67);
  ...
  }
  {
    ...
    MR_hl_field(2, Spec_26, 2) = ((MR_Box) ((MR_Unsigned) 116U));
