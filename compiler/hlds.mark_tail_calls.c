...
MR_decl_label10(hlds__mark_tail_calls__mark_tail_calls_7_0, 2,3,4,5,7,8,9,10,13,12)
MR_decl_label4(hlds__mark_tail_calls__mark_tail_calls_7_0, 16,17,18,20)
...
MR_decl_label10(hlds__mark_tail_calls__mark_tail_calls_in_goal_9_0, 3,144,7,8,9,143,13,12,17,18)
MR_decl_label10(hlds__mark_tail_calls__mark_tail_calls_in_goal_9_0, 16,24,27,22,23,21,31,30,39,37)
MR_decl_label2(hlds__mark_tail_calls__mark_tail_calls_in_goal_9_0, 34,43)
...
MR_BEGIN_MODULE(hlds__mark_tail_calls_module4)
	...
	MR_init_label10(hlds__mark_tail_calls__mark_tail_calls_in_goal_9_0,3,144,7,8,9,143,13,12,17,18)
	MR_init_label10(hlds__mark_tail_calls__mark_tail_calls_in_goal_9_0,16,24,27,22,23,21,31,30,39,37)
	MR_init_label2(hlds__mark_tail_calls__mark_tail_calls_in_goal_9_0,34,43)
MR_BEGIN_CODE
...
MR_def_label(hlds__mark_tail_calls__mark_tail_calls_in_goal_9_0,3)
	...
	if (MR_RTAGS_TESTR(MR_r7,3,1)) {
		MR_GOTO_LAB(hlds__mark_tail_calls__mark_tail_calls_in_goal_9_0_i143);
	}
	MR_r8 = MR_tfield(3, MR_r7, 1);
	if (MR_INT_NE(MR_r8,1)) {
		MR_GOTO_LAB(hlds__mark_tail_calls__mark_tail_calls_in_goal_9_0_i144);
	}
	MR_r1 = (MR_Word) MR_tbmkword(0, 0);
	MR_r2 = MR_r5;
	MR_r3 = MR_r6;
	MR_proceed();
MR_def_label(hlds__mark_tail_calls__mark_tail_calls_in_goal_9_0,144)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(9);
...
MR_def_label(hlds__mark_tail_calls__mark_tail_calls_in_goal_9_0,143)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(9);
	MR_sv(9) = (MR_Word) MR_succip;
...
MR_def_label(hlds__mark_tail_calls__mark_tail_calls_in_goal_9_0,34)
	...
	MR_np_call_localret_ent(fn__hlds__mark_tail_calls__this_file_0_0,
		hlds__mark_tail_calls__mark_tail_calls_in_goal_9_0_i43);
MR_def_label(hlds__mark_tail_calls__mark_tail_calls_in_goal_9_0,43)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_BEGIN_MODULE(hlds__mark_tail_calls_module8)
	...
	MR_init_label10(hlds__mark_tail_calls__mark_tail_calls_7_0,2,3,4,5,7,8,9,10,13,12)
	MR_init_label4(hlds__mark_tail_calls__mark_tail_calls_7_0,16,17,18,20)
MR_BEGIN_CODE
