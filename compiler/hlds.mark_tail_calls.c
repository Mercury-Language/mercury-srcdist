...
MR_decl_label10(hlds__mark_tail_calls__mark_tail_calls_in_goal_9_0, 45,3,138,7,8,9,4,13,12,17)
MR_decl_label10(hlds__mark_tail_calls__mark_tail_calls_in_goal_9_0, 18,16,23,25,28,22,21,32,31,40)
MR_decl_label2(hlds__mark_tail_calls__mark_tail_calls_in_goal_9_0, 38,35)
...
MR_BEGIN_MODULE(hlds__mark_tail_calls_module3)
	...
	MR_init_label10(hlds__mark_tail_calls__mark_tail_calls_in_goal_9_0,45,3,138,7,8,9,4,13,12,17)
	MR_init_label10(hlds__mark_tail_calls__mark_tail_calls_in_goal_9_0,18,16,23,25,28,22,21,32,31,40)
	MR_init_label2(hlds__mark_tail_calls__mark_tail_calls_in_goal_9_0,38,35)
MR_BEGIN_CODE
...
MR_def_label(hlds__mark_tail_calls__mark_tail_calls_in_goal_9_0,45)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_def_label(hlds__mark_tail_calls__mark_tail_calls_in_goal_9_0,3)
	...
	if (MR_INT_NE(MR_r8,1)) {
		MR_GOTO_LAB(hlds__mark_tail_calls__mark_tail_calls_in_goal_9_0_i138);
	}
	MR_r1 = (MR_Word) MR_tbmkword(0, 0);
	MR_r2 = MR_r5;
	MR_r3 = MR_r6;
	MR_proceed();
MR_def_label(hlds__mark_tail_calls__mark_tail_calls_in_goal_9_0,138)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(11);
...
MR_def_label(hlds__mark_tail_calls__mark_tail_calls_in_goal_9_0,16)
	...
	MR_np_call_localret_ent(__Unify___hlds__hlds_pred__pred_id_0_0,
		hlds__mark_tail_calls__mark_tail_calls_in_goal_9_0_i23);
MR_def_label(hlds__mark_tail_calls__mark_tail_calls_in_goal_9_0,23)
	...
	MR_np_call_localret_ent(hlds__mark_tail_calls__match_output_args_2_0,
		hlds__mark_tail_calls__mark_tail_calls_in_goal_9_0_i25);
MR_def_label(hlds__mark_tail_calls__mark_tail_calls_in_goal_9_0,25)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(hlds__mark_tail_calls__mark_tail_calls_in_goal_9_0_i22);
	}
	...
	MR_np_call_localret_ent(hlds__hlds_goal__goal_info_add_feature_3_0,
		hlds__mark_tail_calls__mark_tail_calls_in_goal_9_0_i28);
MR_def_label(hlds__mark_tail_calls__mark_tail_calls_in_goal_9_0,28)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_tag_alloc_heap(MR_r2, 0, (MR_Integer) 2);
...
MR_def_label(hlds__mark_tail_calls__mark_tail_calls_in_goal_9_0,21)
	...
	if (MR_RTAGS_TESTR(MR_r7,3,4)) {
		MR_GOTO_LAB(hlds__mark_tail_calls__mark_tail_calls_in_goal_9_0_i31);
	}
	MR_incr_sp(11);
	MR_sv(11) = (MR_Word) MR_succip;
	MR_sv(7) = MR_tfield(0, MR_r5, 1);
	...
	MR_np_call_localret_ent(hlds__mark_tail_calls__mark_tail_calls_in_cases_8_0,
		hlds__mark_tail_calls__mark_tail_calls_in_goal_9_0_i32);
MR_def_label(hlds__mark_tail_calls__mark_tail_calls_in_goal_9_0,32)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
...
MR_def_label(hlds__mark_tail_calls__mark_tail_calls_in_goal_9_0,31)
	...
	if (MR_PTAG_TESTR(MR_r7,1)) {
		MR_GOTO_LAB(hlds__mark_tail_calls__mark_tail_calls_in_goal_9_0_i35);
	}
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_tfield(1, MR_r7, 3);
	if (MR_PTAG_TESTR(MR_tempr1,2)) {
		MR_GOTO_LAB(hlds__mark_tail_calls__mark_tail_calls_in_goal_9_0_i45);
	}
	MR_incr_sp(11);
	MR_sv(11) = (MR_Word) MR_succip;
	MR_sv(5) = MR_r5;
	...
	MR_np_call_localret_ent(hlds__mark_tail_calls__is_output_arg_rename_4_0,
		hlds__mark_tail_calls__mark_tail_calls_in_goal_9_0_i40);
MR_def_label(hlds__mark_tail_calls__mark_tail_calls_in_goal_9_0,40)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(hlds__mark_tail_calls__mark_tail_calls_in_goal_9_0_i38);
	}
	...
	MR_r3 = MR_sv(10);
	MR_decr_sp_and_return(11);
MR_def_label(hlds__mark_tail_calls__mark_tail_calls_in_goal_9_0,38)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tempr1 = MR_sv(5);
...
MR_def_label(hlds__mark_tail_calls__mark_tail_calls_in_goal_9_0,35)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_string_const("hlds.mark_tail_calls", 20);
