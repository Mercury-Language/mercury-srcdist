  ...
  MR_Word * STATE_VARIABLE_Specs_25)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_17, (MR_Integer) 168, &ExecTraceTailRec_30);
  ...
  MR_Word * STATE_VARIABLE_Specs_22)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_14, (MR_Integer) 168, &ExecTraceTailRec_24);
