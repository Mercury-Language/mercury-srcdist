    ...
    case (MR_Integer) 1:
      {
        ...
        else
        {
          ...
          *STATE_VARIABLE_Specs_56 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_error_spec_0), GoalSpecs_51, STATE_VARIABLE_Specs_1_66);
      ...
      case (MR_Integer) 1:
        {
          ...
          succeeded = libs__globals__lookup_bool_option_3_p_1(Globals_25, (MR_Integer) 213, (MR_Integer) 1);
        }
        break;
    }
    if (succeeded)
