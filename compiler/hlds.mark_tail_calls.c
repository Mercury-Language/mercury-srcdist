      ...
      case (MR_Integer) 1:
        {
          ...
          {
            libs__globals__lookup_bool_option_3_p_0(hlds__mark_tail_calls__Globals_19, (MR_Integer) 132, &hlds__mark_tail_calls__ExecTraceTailRec_20);
          }
          ...
          {
            libs__globals__lookup_bool_option_3_p_0(hlds__mark_tail_calls__Globals_19, (MR_Integer) 27, &hlds__mark_tail_calls__WarnNonTailRecursionBool_22);
          }
