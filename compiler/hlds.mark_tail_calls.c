  ...
  MR_Word * STATE_VARIABLE_Specs_25)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_17, (MR_Integer) 164, &ExecTraceTailRec_34);
  ...
  MR_Word * STATE_VARIABLE_Specs_22)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_14, (MR_Integer) 164, &ExecTraceTailRec_28);
    ...
    case (MR_Integer) 1:
      {
        ...
        ReasonPieces_14 = (MR_Word) (MR_mkword(MR_mktag(1), &hlds__mark_tail_calls_scalar_common_1[21]));
        {
          ...
          MR_hl_field(MR_mktag(2), Var_89, 0) = ((MR_Box) (Context_10));
          MR_hl_field(MR_mktag(2), Var_89, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &hlds__mark_tail_calls_scalar_common_1[51])));
        }
        {
          VerboseMsgs_15 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), VerboseMsgs_15, 0) = ((MR_Box) (Var_89));
