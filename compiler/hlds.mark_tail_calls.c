...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_17, (MR_Integer) 155, &ExecTraceTailRec_34);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_14, (MR_Integer) 155, &ExecTraceTailRec_28);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 34, &WarnNonTailSelfRecBool_5);
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 35, &WarnNonTailMutualRecBool_7);
        ...
        case (MR_Integer) 1:
          {
            ...
            succeeded = libs__globals__lookup_bool_option_3_p_1(Globals_21, (MR_Integer) 37, (MR_Integer) 1);
          }
          break;
      }
    if (succeeded)
...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(0), Spec_24, 2) = ((MR_Box) ((MR_Unsigned) 100U));
...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(0), Spec_22, 2) = ((MR_Box) ((MR_Unsigned) 100U));
        ...
        *ReasonPieces_7 = (MR_Word) (MR_mkword(MR_mktag(1), &hlds__mark_tail_calls_scalar_common_1[21]));
        {
          ...
          MR_hl_field(MR_mktag(1), Var_63, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &hlds__mark_tail_calls_scalar_common_1[51])));
        }
        {
          MR_Word base;
          base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
...
{
  {
    ...
    if (succeeded)
    {
      ...
      check_hlds__mode_util__mode_to_top_functor_mode_4_p_0(ModuleInfo_6, HeadMode_13, HeadType_11, &TopFunctorMode_18);
    ...
    case (MR_Integer) 0:
      {
        ...
        else
        {
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(1), Spec_32, 2) = ((MR_Box) ((MR_Unsigned) 100U));
