...
{
  {
    ...
    else
    {
      ...
      else
      {
        ...
        if (((MR_tag((MR_Word) MaybeType_86)) == (MR_Integer) 0))
        {
          ...
          case (MR_Integer) 1:
            {
              ...
              if (succeeded)
              {
                ...
                if (succeeded)
                {
                  ...
                  if (succeeded)
                  {
                    succeeded = ((MR_tag((MR_Word) Args_253)) == (MR_Integer) 1);
                    if (succeeded)
                    {
                      ...
                      if (succeeded)
                      {
                        ...
                        if (succeeded)
                        {
                          succeeded = ((MR_tag((MR_Word) BeforeEqTerm_254)) == (MR_Integer) 0);
                          if (succeeded)
                          {
              ...
              if (succeeded)
              {
                ...
                if (succeeded)
                {
                  succeeded = ((MR_tag((MR_Word) MaybeRetType_265)) == (MR_Integer) 1);
                  if (succeeded)
                ...
                else
                {
                  ...
                  if (succeeded)
                  {
                    ...
                    if (succeeded)
                    {
                      ...
                      if (succeeded)
                      {
                        succeeded = ((MR_tag((MR_Word) Args_275)) == (MR_Integer) 1);
                        if (succeeded)
                        {
                  ...
                  if (succeeded)
                  {
                    ...
                    if (((MR_tag((MR_Word) MaybeType_286)) == (MR_Integer) 0))
        ...
        case (MR_Integer) 0:
          {
            ...
            if (((MR_tag((MR_Word) MaybeType_75)) == (MR_Integer) 0))
