            ...
            else
            {
              ...
              else
              {
                ...
                else
                {
                  ...
                  {
                    Var_72 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
...
{
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        {
          Spec_48 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
...
{
  {
    ...
    else
    {
      ...
      else
      {
        ...
        {
          HOSpec_27 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
      ...
      case (MR_Integer) 0:
        {
          ...
          else
          {
            ...
            {
              Var_228 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
          ...
          case (MR_Integer) 0:
            {
              ...
              else
              {
                ...
                MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), AllowHOInstInfo_7, (MR_Integer) 0)));
          ...
          case (MR_Integer) 1:
            {
              ...
              MR_Unsigned packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), CompoundTypeKind_11, (MR_Integer) 2)));
                ...
                else
                {
                  ...
                  if (succeeded)
                  {
                    ...
                    else
                    {
                      ...
                      MR_Unsigned packed_word_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), AllowHOInstInfo_7, (MR_Integer) 0)));
