    ...
    case (MR_Integer) 1:
      {
        ...
        if (succeeded)
        {
          Var_83 = ((MR_Word) ((MR_hl_field(0, BeforeEqTerm_25, (MR_Integer) 0))));
        ...
        if (succeeded)
        {
          ...
          Var_90 = mercury__cord__from_list_1_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), (MR_Word) (MR_mkword(1, &parse_tree__parse_type_name_scalar_common_1[28])));
          RetContextPieces_30 = mercury__cord__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), ContextPieces_10, Var_90);
          ...
          if (succeeded)
          {
            ...
            parse_tree__prog_type_construct__construct_higher_order_func_type_4_p_0((MR_Integer) 0, ArgTypes_222, RetType_32, &FuncType_33);
            {
              MR_Word base;
              base = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
              *Result_12 = base;
          ...
          else
          {
            ...
            Var_100 = parse_tree__maybe_error__get_any_errors1_1_f_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0), MaybeRetType_31);
            Specs_220 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_error_spec_0), ArgSpecs_29, Var_100);
            {
              MR_Word base;
              base = (MR_Word) MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL);
              *Result_12 = base;
        ...
        else
        {
          ...
          Var_101 = mercury__cord__list_1_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), ContextPieces_10);
          Pieces_225 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), Var_101, (MR_Word) (MR_mkword(1, &parse_tree__parse_type_name_scalar_common_1[41])));
          Var_131 = mercury__term__get_term_context_1_f_0((MR_Word) (&mercury__term__term__type_ctor_info_generic_0), BeforeEqTerm_25);
          {
            Spec_226 = (MR_Word) MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL);
            MR_hl_field(0, Spec_226, 0) = ((MR_Box) ((MR_String) "predicate \140parse_tree.parse_type_name.parse_compound_type\'/6"));
            MR_hl_field(0, Spec_226, 1) = ((MR_Box) ((MR_Unsigned) 0U));
            MR_hl_field(0, Spec_226, 2) = ((MR_Box) ((MR_Unsigned) 24U));
            MR_hl_field(0, Spec_226, 3) = ((MR_Box) (Var_131));
            MR_hl_field(0, Spec_226, 4) = ((MR_Box) (Pieces_225));
          }
          {
            Var_132 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(1, Var_132, 0) = ((MR_Box) (Spec_226));
    ...
    case (MR_Integer) 2:
      {
        ...
        if ((Specs_219 == (MR_Word) ((MR_Unsigned) 0U)))
        {
          ...
          parse_tree__prog_type_construct__construct_higher_order_pred_type_3_p_0((MR_Integer) 0, ArgTypes_218, &PredType_22);
          {
            MR_Word base;
            base = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
            *Result_12 = base;
        ...
        case (MR_Integer) 1:
          {
            ...
            if (succeeded)
            {
              Var_135 = ((MR_Word) ((MR_hl_field(0, SubTerm_41, (MR_Integer) 0))));
              Args_240 = ((MR_Word) ((MR_hl_field(0, SubTerm_41, (MR_Integer) 1))));
              succeeded = ((MR_tag((MR_Word) Var_135)) == (MR_Integer) 0);
              if (succeeded)
              {
                Name_42 = ((MR_String) ((MR_hl_field(0, Var_135, (MR_Integer) 0))));
                ...
                if (succeeded)
                {
                  ...
                  if (succeeded)
                  {
                    ...
                    Var_136 = ((MR_Word) ((MR_hl_field(1, Args_240, (MR_Integer) 1))));
                    succeeded = (Var_136 != (MR_Word) ((MR_Unsigned) 0U));
                    if (succeeded)
                    {
                      AfterEqTerm_307 = ((MR_Word) ((MR_hl_field(1, Var_136, (MR_Integer) 0))));
                      Var_137 = ((MR_Word) ((MR_hl_field(1, Var_136, (MR_Integer) 1))));
                      ...
                      if (succeeded)
                      {
                        ...
                        if (succeeded)
                        {
                          Var_138 = ((MR_Word) ((MR_hl_field(0, BeforeEqTerm_241, (MR_Integer) 0))));
                          FuncArgs_308 = ((MR_Word) ((MR_hl_field(0, BeforeEqTerm_241, (MR_Integer) 1))));
                          succeeded = ((MR_tag((MR_Word) Var_138)) == (MR_Integer) 0);
                          if (succeeded)
                          {
                            Var_139 = ((MR_String) ((MR_hl_field(0, Var_138, (MR_Integer) 0))));
                            succeeded = (strcmp(Var_139, (MR_String) "func") == 0);
                          }
                        }
                      }
                    }
            ...
            if (succeeded)
            {
              ...
              Var_145 = mercury__cord__from_list_1_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), (MR_Word) (MR_mkword(1, &parse_tree__parse_type_name_scalar_common_1[28])));
              RetContextPieces_251 = mercury__cord__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), ContextPieces_10, Var_145);
              ...
              if (succeeded)
              {
                ...
                parse_tree__prog_type_construct__construct_higher_order_func_type_4_p_0(Purity_40, ArgTypes_247, RetType_245, &Type_242);
                {
                  MR_Word base;
                  base = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                  *Result_12 = base;
              ...
              else
              {
                ...
                Var_154 = parse_tree__maybe_error__get_any_errors1_1_f_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0), MaybeRetType_252);
                Specs_243 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_error_spec_0), ArgSpecs_250, Var_154);
                {
                  MR_Word base;
                  base = (MR_Word) MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL);
                  *Result_12 = base;
            ...
            else
            {
              ...
              if (succeeded)
              {
                Var_155 = ((MR_Word) ((MR_hl_field(0, SubTerm_41, (MR_Integer) 0))));
                Args_288 = ((MR_Word) ((MR_hl_field(0, SubTerm_41, (MR_Integer) 1))));
                succeeded = ((MR_tag((MR_Word) Var_155)) == (MR_Integer) 0);
                if (succeeded)
                {
                  Name_255 = ((MR_String) ((MR_hl_field(0, Var_155, (MR_Integer) 0))));
              ...
              if (succeeded)
              {
                ...
                if ((Specs_259 == (MR_Word) ((MR_Unsigned) 0U)))
                {
                  ...
                  parse_tree__prog_type_construct__construct_higher_order_pred_type_3_p_0(Purity_40, ArgTypes_258, &Type_256);
                  {
                    MR_Word base;
                    base = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                    *Result_12 = base;
              ...
              else
              {
                ...
                if (succeeded)
                {
                  Var_161 = ((MR_Word) ((MR_hl_field(0, SubTerm_41, (MR_Integer) 0))));
                  Args_262 = ((MR_Word) ((MR_hl_field(0, SubTerm_41, (MR_Integer) 1))));
                  succeeded = ((MR_tag((MR_Word) Var_161)) == (MR_Integer) 0);
                  if (succeeded)
                  {
                    Name_263 = ((MR_String) ((MR_hl_field(0, Var_161, (MR_Integer) 0))));
                    ...
                    if (succeeded)
                    {
                      ...
                      if (succeeded)
                      {
                        ...
                        Var_162 = ((MR_Word) ((MR_hl_field(1, Args_262, (MR_Integer) 1))));
                        succeeded = (Var_162 != (MR_Word) ((MR_Unsigned) 0U));
                        if (succeeded)
                        {
                          AfterIsTerm_283 = ((MR_Word) ((MR_hl_field(1, Var_162, (MR_Integer) 0))));
                ...
                if (succeeded)
                {
                  ...
                  {
                    MR_Word Why_265 = ((MR_Unsigned) ((MR_hl_field(1, AllowHOInstInfo_7, (MR_Integer) 0))) & (MR_Integer) 31);
                ...
                else
                {
                  ...
                  Var_184 = mercury__cord__list_1_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), ContextPieces_10);
                  {
                    Var_192 = (MR_Word) MR_mkword(3, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(3, Var_192, 0) = ((MR_Box) ((MR_Unsigned) 0U));
                    MR_hl_field(3, Var_192, 1) = ((MR_Box) (PurityName_39));
                  }
                  {
                    Var_191 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(1, Var_191, 0) = ((MR_Box) (Var_192));
                    MR_hl_field(1, Var_191, 1) = ((MR_Box) (MR_mkword(1, &parse_tree__parse_type_name_scalar_common_1[54])));
                  }
                  {
                    Var_188 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(1, Var_188, 0) = ((MR_Box) (MR_mkword(3, &parse_tree__parse_type_name_scalar_common_1[48])));
                    MR_hl_field(1, Var_188, 1) = ((MR_Box) (Var_191));
                  }
                  {
                    Var_186 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(1, Var_186, 0) = ((MR_Box) ((MR_Unsigned) 0U));
                    MR_hl_field(1, Var_186, 1) = ((MR_Box) (Var_188));
                  }
                  Var_203 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), FormPieces_51, (MR_Word) (MR_mkword(1, &parse_tree__parse_type_name_scalar_common_1[57])));
                  Var_185 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), Var_186, Var_203);
                  Pieces_276 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), Var_184, Var_185);
                  Var_214 = mercury__term__get_term_context_1_f_0((MR_Word) (&mercury__term__term__type_ctor_info_generic_0), SubTerm_41);
                  {
                    ...
                    MR_hl_field(0, Spec_277, 0) = ((MR_Box) ((MR_String) "predicate \140parse_tree.parse_type_name.parse_compound_type\'/6"));
                    MR_hl_field(0, Spec_277, 1) = ((MR_Box) ((MR_Unsigned) 0U));
                    MR_hl_field(0, Spec_277, 2) = ((MR_Box) ((MR_Unsigned) 24U));
                    MR_hl_field(0, Spec_277, 3) = ((MR_Box) (Var_214));
