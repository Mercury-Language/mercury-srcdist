  ...
  MR_Word * STATE_VARIABLE_Specs_8)
{
  ...
  else
  {
    ...
    if (succeeded)
    {
      Var_43 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Term_19, (MR_Integer) 0))));
      Var_45 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Term_19, (MR_Integer) 1))));
    ...
    if (succeeded)
    {
      ...
      Var_49 = mercury__cord__from_list_1_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_format_component_0), (MR_Word) (MR_mkword(MR_mktag(1), &parse_tree__parse_type_name_scalar_common_1[62])));
      Var_48 = mercury__cord__f_43_43_2_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_format_component_0), Var_33, Var_49);
      Pieces_41 = mercury__cord__list_1_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_format_component_0), Var_48);
      Var_53 = mercury__term__get_term_context_1_f_0((MR_Word) (&mercury__term__term__type_ctor_info_generic_0), Term_19);
      {
        ...
        MR_hl_field(MR_mktag(1), Spec_42, 0) = ((MR_Box) ((MR_String) "predicate \140parse_tree.parse_type_name.parse_type_no_mode\'/5"));
        MR_hl_field(MR_mktag(1), Spec_42, 1) = ((MR_Box) ((MR_Unsigned) 0U));
        MR_hl_field(MR_mktag(1), Spec_42, 2) = ((MR_Box) ((MR_Unsigned) 20U));
        MR_hl_field(MR_mktag(1), Spec_42, 3) = ((MR_Box) (Var_53));
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(1), TSpecs_27, 0) = ((MR_Box) (Spec_42));
        MR_hl_field(MR_mktag(1), TSpecs_27, 1) = ((MR_Box) (Var_47));
      }
    ...
    else
    {
      ...
      {
        MR_Word TSpecs_58 = ((MR_Word) ((MR_hl_field(MR_mktag(0), MaybeType_62, (MR_Integer) 0))));

        *HeadVar__6_6 = TypesTail_24;
        *STATE_VARIABLE_Specs_8 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_error_spec_0), TSpecs_58, STATE_VARIABLE_Specs_31_31);
      }
      else
      {
        MR_Word Type_26 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MaybeType_62, (MR_Integer) 0))));
