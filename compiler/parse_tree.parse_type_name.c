  ...
  MR_Word * STATE_VARIABLE_Specs_8)
{
  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      Var_68 = mercury__cord__from_list_1_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_format_component_0), (MR_Word) (MR_mkword(MR_mktag(1), &parse_tree__parse_type_name_scalar_common_1[62])));
            ...
            else
            {
              ...
              if ((Var_341 == (MR_Word) ((MR_Unsigned) 0U)))
              {
...

                {
                  ...
                  MR_hl_field(MR_mktag(1), Var_45, 0) = Var_332;
                  MR_hl_field(MR_mktag(1), Var_45, 1) = Var_342;
                }
                {
                  MR_Word base;
                  base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
          ...
          else
          {
            ...
            if ((Var_333 == (MR_Word) ((MR_Unsigned) 0U)))
            {
...

              {
                ...
                MR_hl_field(MR_mktag(3), Var_57, 3) = Var_334;
              }
              {
                MR_Word base;
                base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
            ...
            else
            {
              ...
              if ((Var_343 == (MR_Word) ((MR_Unsigned) 0U)))
              {
...

                {
                  ...
                  MR_hl_field(MR_mktag(3), Var_53, 1) = Var_336;
                  MR_hl_field(MR_mktag(3), Var_53, 2) = Var_344;
                }
                {
                  MR_Word base;
                  base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
