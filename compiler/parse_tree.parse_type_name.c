...
static /* final */ const MR_Box parse_tree__parse_type_name_scalar_common_1[68][2] = {
  ...
  {
    ((MR_Box) ((MR_Unsigned) 8U)),
    ((MR_Box) (MR_mkword(1, &parse_tree__parse_type_name_scalar_common_1[64])))
  },
  /* row  66 */
  {
  ...
  {
    ((MR_Box) ((MR_Unsigned) 8U)),
    ((MR_Box) (MR_mkword(1, &parse_tree__parse_type_name_scalar_common_1[66])))
  },
};
    ...
    case (MR_Integer) 1:
      {
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            ...
            parse_tree__prog_type_construct__construct_higher_order_func_type_5_p_0((MR_Integer) 0, ArgTypes_222, RetType_32, &FuncType_33);
            {
              MR_Word base;
              base = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
              *Result_12 = base;
        ...
        else
        {
          ...
          Var_133 = mercury__term__get_term_context_1_f_0((MR_Word) (&mercury__term__term__type_ctor_info_generic_0), BeforeEqTerm_25);
          {
            ...
            MR_hl_field(1, Spec_226, 2) = ((MR_Box) ((MR_Unsigned) 24U));
    ...
    case (MR_Integer) 2:
      {
        ...
        if ((Specs_219 == (MR_Word) ((MR_Unsigned) 0U)))
        {
          ...
          parse_tree__prog_type_construct__construct_higher_order_pred_type_4_p_0((MR_Integer) 0, ArgTypes_218, &PredType_22);
          {
            MR_Word base;
            base = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
            *Result_12 = base;
        ...
        case (MR_Integer) 1:
          {
            ...
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                ...
                parse_tree__prog_type_construct__construct_higher_order_func_type_5_p_0(Purity_40, ArgTypes_247, RetType_245, &Type_242);
                {
                  MR_Word base;
                  base = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                  *Result_12 = base;
            ...
            else
            {
              ...
              if (succeeded)
              {
                ...
                if ((Specs_259 == (MR_Word) ((MR_Unsigned) 0U)))
                {
                  ...
                  parse_tree__prog_type_construct__construct_higher_order_pred_type_4_p_0(Purity_40, ArgTypes_258, &Type_256);
                  {
                    MR_Word base;
                    base = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                    *Result_12 = base;
