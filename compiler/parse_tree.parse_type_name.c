  ...
  MR_Word HeadVar__2_2)
{
  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      TypeInfo__9_9 = (MR_Word) (&parse_tree__parse_type_name_scalar_common_3[0]);
  ...
  MR_Word * STATE_VARIABLE_Specs_8)
{
  ...
  else
  {
    ...
    if (succeeded)
    {
      Var_44 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Term_19, (MR_Integer) 0))));
      Var_46 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Term_19, (MR_Integer) 1))));
    ...
    if (succeeded)
    {
      ...
      Var_50 = mercury__cord__from_list_1_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_format_component_0), (MR_Word) (MR_mkword(MR_mktag(1), &parse_tree__parse_type_name_scalar_common_1[62])));
      Var_49 = mercury__cord__f_43_43_2_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_format_component_0), Var_33, Var_50);
      Pieces_42 = mercury__cord__list_1_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_format_component_0), Var_49);
      Var_54 = mercury__term__get_term_context_1_f_0((MR_Word) (&mercury__term__term__type_ctor_info_generic_0), Term_19);
      {
        Spec_43 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), Spec_43, 0) = ((MR_Box) ((MR_String) "predicate \140parse_tree.parse_type_name.parse_type_no_mode\'/5"));
        MR_hl_field(MR_mktag(1), Spec_43, 1) = ((MR_Box) ((MR_Unsigned) 0U));
        MR_hl_field(MR_mktag(1), Spec_43, 2) = ((MR_Box) ((MR_Unsigned) 20U));
        MR_hl_field(MR_mktag(1), Spec_43, 3) = ((MR_Box) (Var_54));
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(1), TSpecs_27, 0) = ((MR_Box) (Spec_43));
        MR_hl_field(MR_mktag(1), TSpecs_27, 1) = ((MR_Box) (Var_48));
      }
    ...
    {
      MR_Word MaybeType_63;

      parse_tree__parse_type_name__parse_type_5_p_0(AllowHOInstInfo_1, Varset_2, Var_33, Term_19, &MaybeType_63);
      if (((MR_tag((MR_Word) MaybeType_63)) == (MR_Integer) 0))
      {
        MR_Word TSpecs_59 = ((MR_Word) ((MR_hl_field(MR_mktag(0), MaybeType_63, (MR_Integer) 0))));

        *HeadVar__6_6 = TypesTail_24;
        *STATE_VARIABLE_Specs_8 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_error_spec_0), TSpecs_59, STATE_VARIABLE_Specs_31_31);
      }
      else
      {
        MR_Word Type_26 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MaybeType_63, (MR_Integer) 0))));
