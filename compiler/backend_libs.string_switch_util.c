...
static /* final */ const MR_Box backend_libs__string_switch_util_scalar_common_1[1][5];

static /* final */ const MR_Integer backend_libs__string_switch_util_scalar_common_2[1][2];

static /* final */ const MR_Box backend_libs__string_switch_util_scalar_common_3[1][8];
...
static /* final */ const MR_Box backend_libs__string_switch_util_scalar_common_3[1][8] = {
  ...
  {
    NULL,
    ((MR_Box) (&backend_libs__string_switch_util_scalar_common_2[0])),
    ((MR_Box) ((MR_Integer) 5)),
  ...
  MR_Word * STATE_VARIABLE_UnsortedTable_12)
{
  ...
  else
  {
    ...
    backend_libs__string_switch_util__add_string_binary_entry_4_p_0(TypeInfo_for_CaseRep_63, CaseRep_37, MainTaggedConsId_38, STATE_VARIABLE_UnsortedTable_56_56, &STATE_VARIABLE_UnsortedTable_61_61);
    {
      ...
      MR_hl_field(0, Var_62, 0) = ((MR_Box) (&backend_libs__string_switch_util_scalar_common_3[0]));
  ...
  MR_Integer * FreeSlot_10)
{
  while (MR_TRUE)
  {
    ...
    ;
    {
      ...
      MR_hl_field(0, Var_13, 0) = ((MR_Box) (&backend_libs__string_switch_util_scalar_common_1[0]));
