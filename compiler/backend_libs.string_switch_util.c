...
{
  MR_bool succeeded;
  MR_Word ChoiceMap_10 = ((MR_Word) ((MR_hl_field(1, TrieNode_5, (MR_Integer) 1))));
  MR_Word MaybeEnd_11 = ((MR_Word) ((MR_hl_field(1, TrieNode_5, (MR_Integer) 2))));
  ...
  if (succeeded)
  {
    ...
    if (succeeded)
    {
      OneChoicePair_12 = ((MR_Word) ((MR_hl_field(1, *ChoicePairs_6, (MR_Integer) 0))));
      Var_23 = ((MR_Word) ((MR_hl_field(1, *ChoicePairs_6, (MR_Integer) 1))));
      succeeded = (Var_23 == (MR_Word) ((MR_Unsigned) 0U));
    }
  }
  if (succeeded)
  {
    MR_Integer OneCodeUnit_13 = ((MR_Integer) ((MR_hl_field(0, OneChoicePair_12, (MR_Integer) 0))));
    MR_Word OneSubTrieNode_14 = ((MR_Word) ((MR_hl_field(0, OneChoicePair_12, (MR_Integer) 1))));
  ...
  MR_Word * TopTrieNode_6)
{
  ...
  {
    MR_Word HeadStrCaseId_7 = ((MR_Word) ((MR_hl_field(1, StrsCaseIds_5, (MR_Integer) 0))));
    MR_Word TailStrCaseIds_8 = ((MR_Word) ((MR_hl_field(1, StrsCaseIds_5, (MR_Integer) 1))));
    MR_String HeadStr_9 = ((MR_String) ((MR_hl_field(0, HeadStrCaseId_7, (MR_Integer) 0))));
    MR_Word HeadCaseId_10 = ((MR_Word) ((MR_hl_field(0, HeadStrCaseId_7, (MR_Integer) 1))));
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = backend_libs__string_switch_util__IntroducedFrom__pred__insert_case_into_trie_node__204__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 4)))));
  return succeeded;
}
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = backend_libs__string_switch_util__IntroducedFrom__pred__insert_case_into_trie_node__218__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 4)))));
  return succeeded;
}
