  ...
  MR_Word * STATE_VARIABLE_Specs_37)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_20, (MR_Integer) 271, &UseTrail_24);
  ...
  if (succeeded)
  {
...

    {
      ...
      MR_hl_field(1, TrailSpec_28, 2) = ((MR_Box) ((MR_Unsigned) 44U));
  ...
  MR_Word * STATE_VARIABLE_Specs_21)
{
  ...
  InstPieces_17 = hlds__error_msg_inst__error_msg_inst_9_f_0(ModuleInfo_9, InstVarSet_11, (MR_Integer) 0, (MR_Word) ((MR_Unsigned) 0U), (MR_Integer) 0, (MR_Word) ((MR_Unsigned) 0U), (MR_Word) (MR_mkword(1, &hlds__make_hlds__add_mutable_aux_preds_scalar_common_1[29])), (MR_Word) (MR_mkword(1, &hlds__make_hlds__add_mutable_aux_preds_scalar_common_1[31])), Inst_13);
  {
    Var_34 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(1, Var_34, 0) = ((MR_Box) (MR_mkword(3, &hlds__make_hlds__add_mutable_aux_preds_scalar_common_1[32])));
    MR_hl_field(1, Var_34, 1) = ((MR_Box) (ParentPieces_16));
  }
  {
    Var_38 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(1, Var_38, 0) = ((MR_Box) (MR_mkword(3, &hlds__make_hlds__add_mutable_aux_preds_scalar_common_1[33])));
    MR_hl_field(1, Var_38, 1) = ((MR_Box) (InstPieces_17));
  }
  Var_41 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), ProblemPieces_14, (MR_Word) (MR_mkword(1, &hlds__make_hlds__add_mutable_aux_preds_scalar_common_1[3])));
  ...
  Pieces_18 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), Var_34, Var_37);
  {
