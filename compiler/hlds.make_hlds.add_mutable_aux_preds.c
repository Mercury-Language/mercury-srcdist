...
static const MR_EnumFunctorDescPtr hlds__make_hlds__add_mutable_aux_preds__hlds__make_hlds__add_mutable_aux_preds__enum_ordinal_ordered_mutable_impl_lang_0[3];
...
static const MR_EnumFunctorDescPtr hlds__make_hlds__add_mutable_aux_preds__hlds__make_hlds__add_mutable_aux_preds__enum_ordinal_ordered_need_lock_unlock_preds_0[2];
...
static const MR_EnumFunctorDescPtr hlds__make_hlds__add_mutable_aux_preds__hlds__make_hlds__add_mutable_aux_preds__enum_ordinal_ordered_need_pre_init_pred_0[2];
...
static const MR_EnumFunctorDescPtr hlds__make_hlds__add_mutable_aux_preds__hlds__make_hlds__add_mutable_aux_preds__enum_ordinal_ordered_need_unsafe_get_set_preds_0[2];
...
hlds__make_hlds__add_mutable_aux_preds__IntroducedFrom__pred__define_main_get_set_preds__1450__1_2_p_0(
  MR_Word AttachToIO_41,
  MR_Word HeadVar__2_190);

static MR_bool MR_CALL 
hlds__make_hlds__add_mutable_aux_preds__IntroducedFrom__pred__define_unsafe_get_set_preds__1253__1_2_p_0(
  MR_Word IsConstant_33,
  MR_Word HeadVar__2_64);

static MR_bool MR_CALL 
hlds__make_hlds__add_mutable_aux_preds__IntroducedFrom__pred__define_lock_unlock_preds__1169__1_2_p_0(
  MR_Word IsConstant_33,
  MR_Word HeadVar__2_55);

static MR_bool MR_CALL 
hlds__make_hlds__add_mutable_aux_preds__IntroducedFrom__pred__define_pre_init_pred__1111__1_2_p_0(
  MR_Word IsConstant_33,
  MR_Word HeadVar__2_48);

static MR_bool MR_CALL 
hlds__make_hlds__add_mutable_aux_preds__IntroducedFrom__pred__define_aux_preds_for_mutable__1093__1_1_p_0(
...
const MR_TypeCtorInfo_Struct hlds__make_hlds__add_mutable_aux_preds__hlds__make_hlds__add_mutable_aux_preds__type_ctor_info_mutable_impl_lang_0 = {
  ...
  {     hlds__make_hlds__add_mutable_aux_preds__hlds__make_hlds__add_mutable_aux_preds__enum_ordinal_ordered_mutable_impl_lang_0 },
  (MR_Integer) 3,
  UINT16_C(12),
...
const MR_TypeCtorInfo_Struct hlds__make_hlds__add_mutable_aux_preds__hlds__make_hlds__add_mutable_aux_preds__type_ctor_info_need_lock_unlock_preds_0 = {
  ...
  {     hlds__make_hlds__add_mutable_aux_preds__hlds__make_hlds__add_mutable_aux_preds__enum_ordinal_ordered_need_lock_unlock_preds_0 },
  (MR_Integer) 2,
  UINT16_C(12),
...
const MR_TypeCtorInfo_Struct hlds__make_hlds__add_mutable_aux_preds__hlds__make_hlds__add_mutable_aux_preds__type_ctor_info_need_pre_init_pred_0 = {
  ...
  {     hlds__make_hlds__add_mutable_aux_preds__hlds__make_hlds__add_mutable_aux_preds__enum_ordinal_ordered_need_pre_init_pred_0 },
  (MR_Integer) 2,
  UINT16_C(12),
...
const MR_TypeCtorInfo_Struct hlds__make_hlds__add_mutable_aux_preds__hlds__make_hlds__add_mutable_aux_preds__type_ctor_info_need_unsafe_get_set_preds_0 = {
  ...
  {     hlds__make_hlds__add_mutable_aux_preds__hlds__make_hlds__add_mutable_aux_preds__enum_ordinal_ordered_need_unsafe_get_set_preds_0 },
  (MR_Integer) 2,
  UINT16_C(12),
...
{
  {
    ...
    succeeded = hlds__make_hlds__add_mutable_aux_preds__IntroducedFrom__pred__define_aux_preds_for_mutable__1093__1_1_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))));
    return succeeded;
  }
}
...
{
  {
    ...
    switch (ImplLang_18) {
      ...
      case (MR_Integer) 1:
      case (MR_Integer) 2:
        parse_tree__prog_data_foreign__set_may_export_body_3_p_0((MR_Word) (MR_mkword(MR_mktag(1), &hlds__make_hlds__add_mutable_aux_preds_scalar_common_5[0])), Attrs0_27, &Attrs_29);
        break;
    }
...
{
  {
    ...
    hlds__hlds_module__module_info_new_user_init_pred_5_p_0(InitPredName_39, (MR_Integer) 0, &CName_78, STATE_VARIABLE_ModuleInfo_57_57, &STATE_VARIABLE_ModuleInfo_30_83);
    {
      ...
      MR_hl_field(MR_mktag(0), PredNameModesPF_79, 0) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 0));
      MR_hl_field(MR_mktag(0), PredNameModesPF_79, 1) = ((MR_Box) (InitPredName_39));
      MR_hl_field(MR_mktag(0), PredNameModesPF_79, 2) = ((MR_Box) ((MR_Unsigned) 0U));
    }
    {
...
{
  {
    ...
    succeeded = hlds__make_hlds__add_mutable_aux_preds__IntroducedFrom__pred__define_main_get_set_preds__1450__1_2_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))));
    return succeeded;
  }
}
...
{
  {
    ...
    succeeded = hlds__make_hlds__add_mutable_aux_preds__IntroducedFrom__pred__define_unsafe_get_set_preds__1253__1_2_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))));
    return succeeded;
  }
}
...
{
  {
    ...
    succeeded = hlds__make_hlds__add_mutable_aux_preds__IntroducedFrom__pred__define_lock_unlock_preds__1169__1_2_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))));
    return succeeded;
  }
}
...
{
  {
    ...
    succeeded = hlds__make_hlds__add_mutable_aux_preds__IntroducedFrom__pred__define_pre_init_pred__1111__1_2_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))));
    return succeeded;
  }
}
