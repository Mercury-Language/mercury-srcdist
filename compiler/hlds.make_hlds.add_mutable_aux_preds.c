  ...
  MR_Word * STATE_VARIABLE_Specs_35)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_18, (MR_Integer) 261, &UseTrail_22);
                    ...
                    else
                    {
                      ...
                      else
                      {
                        ...
                        if (succeeded)
                        {
                          ...
                          hlds__make_hlds__add_mutable_aux_preds__invalid_inst_in_mutable_8_p_0(ModuleInfo_8, Context_9, InstVarSet_10, ParentInsts_11, Inst_12, (MR_Word) (MR_mkword(MR_mktag(1), &hlds__make_hlds__add_mutable_aux_preds_scalar_common_1[22])), STATE_VARIABLE_Specs_122_122, STATE_VARIABLE_Specs_70);
                      }
                    }
                  }
                  break;
    ...
    case (MR_Integer) 4:
      {
        ...
        if (succeeded)
          ...
          UniqPieces_66 = (MR_Word) (MR_mkword(MR_mktag(1), &hlds__make_hlds__add_mutable_aux_preds_scalar_common_1[44]));
    ...
    case (MR_Integer) 2:
      {
        ...
        if (succeeded)
          ...
          UniqPieces_90 = (MR_Word) (MR_mkword(MR_mktag(1), &hlds__make_hlds__add_mutable_aux_preds_scalar_common_1[46]));
    ...
    case (MR_Integer) 1:
      {
        ...
        if (succeeded)
          ...
          UniqPieces_114 = (MR_Word) (MR_mkword(MR_mktag(1), &hlds__make_hlds__add_mutable_aux_preds_scalar_common_1[48]));
  ...
  MR_Word * HeadVar__2_2)
{
  ...
  else
  {
    ...
    MR_Word InstName_9 = ((MR_Word) ((MR_hl_field(MR_mktag(0), InstCtor_3, (MR_Integer) 0))));
    MR_Integer InstArity_10 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), InstCtor_3, (MR_Integer) 1))));
    MR_Word Var_13;
    MR_Word Var_14;
    MR_Word Var_15;

    {
      ...
      MR_hl_field(MR_mktag(0), Var_15, 0) = ((MR_Box) (InstName_9));
      MR_hl_field(MR_mktag(0), Var_15, 1) = ((MR_Box) (InstArity_10));
    }
    {
      Var_14 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(3), Var_14, 0) = ((MR_Box) ((MR_Unsigned) 10U));
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), Var_13, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &hlds__make_hlds__add_mutable_aux_preds_scalar_common_1[40])));
    }
    {
      ...
      MR_hl_field(MR_mktag(1), HeadPieces_6, 1) = ((MR_Box) (Var_13));
    }
