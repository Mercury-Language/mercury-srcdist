  ...
  MR_Word * STATE_VARIABLE_Specs_36)
{
  ...
  else
  {
    ...
    if ((UnexpandedInstSpecs_32 == (MR_Word) ((MR_Unsigned) 0U)))
      *STATE_VARIABLE_Specs_36 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_diag_spec_0), ExpandedInstSpecs_29, STATE_VARIABLE_Specs_1_67);
    else
      *STATE_VARIABLE_Specs_36 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_diag_spec_0), UnexpandedInstSpecs_32, STATE_VARIABLE_Specs_1_67);
  }
}
