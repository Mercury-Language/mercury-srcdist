...
static /* final */ const MR_Box hlds__make_hlds__add_mutable_aux_preds_scalar_common_1[47][2];
      ...
      case (MR_Integer) 3:
        switch (((MR_Integer) ((MR_hl_field(3, Inst_14, (MR_Integer) 0))))) {
          ...
          case (MR_Integer) 0:
                ...
                case (MR_Integer) 0:
                  {
                    ...
                    else
                    {
                      ...
                      if (succeeded)
                      {
                        ...
                        hlds__make_hlds__add_mutable_aux_preds__invalid_inst_in_mutable_8_p_0(ModuleInfo_9, Context_11, InstVarSet_12, ParentInsts_13, UnqualInst_30, (MR_Word) (MR_mkword(1, &hlds__make_hlds__add_mutable_aux_preds_scalar_common_1[16])), STATE_VARIABLE_Specs_0_68, STATE_VARIABLE_Specs_69);
                      }
                      else
                      {
                        ...
                        else
                        {
                          ...
                          if (succeeded)
                            *STATE_VARIABLE_Specs_69 = STATE_VARIABLE_Specs_84_84;
                            ...
                            hlds__make_hlds__add_mutable_aux_preds__invalid_inst_in_mutable_8_p_0(ModuleInfo_9, Context_11, InstVarSet_12, ParentInsts_13, Inst_14, (MR_Word) (MR_mkword(1, &hlds__make_hlds__add_mutable_aux_preds_scalar_common_1[20])), STATE_VARIABLE_Specs_84_84, STATE_VARIABLE_Specs_69);
                        }
                      }
                    }
                  }
            ...
            break;
          case (MR_Integer) 1:
            hlds__make_hlds__add_mutable_aux_preds__invalid_inst_in_mutable_8_p_0(ModuleInfo_9, Context_11, InstVarSet_12, ParentInsts_13, Inst_14, (MR_Word) (MR_mkword(1, &hlds__make_hlds__add_mutable_aux_preds_scalar_common_1[18])), STATE_VARIABLE_Specs_0_68, STATE_VARIABLE_Specs_69);
            break;
          case (MR_Integer) 2:
            {
    ...
    case (MR_Integer) 3:
      {
        ...
        if (succeeded)
          ...
          UniqPieces_18 = (MR_Word) (MR_mkword(1, &hlds__make_hlds__add_mutable_aux_preds_scalar_common_1[40]));
    ...
    case (MR_Integer) 4:
      {
        ...
        if (succeeded)
          ...
          UniqPieces_65 = (MR_Word) (MR_mkword(1, &hlds__make_hlds__add_mutable_aux_preds_scalar_common_1[42]));
    ...
    case (MR_Integer) 2:
      {
        ...
        if (succeeded)
          ...
          UniqPieces_89 = (MR_Word) (MR_mkword(1, &hlds__make_hlds__add_mutable_aux_preds_scalar_common_1[44]));
    ...
    case (MR_Integer) 1:
      {
        ...
        if (succeeded)
          ...
          UniqPieces_113 = (MR_Word) (MR_mkword(1, &hlds__make_hlds__add_mutable_aux_preds_scalar_common_1[46]));
  ...
  MR_Word * STATE_VARIABLE_Specs_21)
{
  ...
  InstPieces_17 = hlds__error_msg_inst__error_msg_inst_8_f_0(ModuleInfo_9, InstVarSet_11, (MR_Integer) 0, (MR_Integer) 0, (MR_Word) ((MR_Unsigned) 0U), (MR_Word) (MR_mkword(1, &hlds__make_hlds__add_mutable_aux_preds_scalar_common_1[31])), (MR_Word) (MR_mkword(1, &hlds__make_hlds__add_mutable_aux_preds_scalar_common_1[33])), Inst_13);
  {
    Var_33 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(1, Var_33, 0) = ((MR_Box) (MR_mkword(3, &hlds__make_hlds__add_mutable_aux_preds_scalar_common_1[34])));
    MR_hl_field(1, Var_33, 1) = ((MR_Box) (ParentPieces_16));
  }
  {
    Var_37 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(1, Var_37, 0) = ((MR_Box) (MR_mkword(3, &hlds__make_hlds__add_mutable_aux_preds_scalar_common_1[35])));
  ...
  MR_Word * HeadVar__2_2)
{
  ...
  else
  {
    ...
    }
    {
      ...
      MR_hl_field(1, Var_13, 1) = ((MR_Box) (MR_mkword(1, &hlds__make_hlds__add_mutable_aux_preds_scalar_common_1[38])));
    }
    {
      HeadPieces_6 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(1, HeadPieces_6, 0) = ((MR_Box) (MR_mkword(3, &hlds__make_hlds__add_mutable_aux_preds_scalar_common_1[36])));
