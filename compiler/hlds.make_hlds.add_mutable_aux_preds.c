...
{
  {
    ...
    hlds__make_hlds__add_clause__module_add_clause_15_p_0(VarSetMutableX_32, (MR_Integer) 0, InitPredName_39, (MR_Word) ((MR_Unsigned) 0U), Var_54, PredStatus_13, Context_29, (MR_Word) ((MR_Unsigned) 0U), (MR_Word) ((MR_Unsigned) 12U), STATE_VARIABLE_ModuleInfo_0_41, &STATE_VARIABLE_ModuleInfo_57_57, STATE_VARIABLE_QualInfo_0_43, STATE_VARIABLE_QualInfo_44, STATE_VARIABLE_Specs_0_45, &STATE_VARIABLE_Specs_59_59);
    {
      ...
      MR_hl_field(MR_mktag(3), Var_80, 1) = ((MR_Box) (ModuleName_20));
      MR_hl_field(MR_mktag(3), Var_80, 2) = ((MR_Box) (MutableName_21));
      MR_hl_field(MR_mktag(3), Var_80, 3) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 11));
    }
            ...
            case (MR_Integer) 3:
              {
...

                {
                  ...
                  MR_hl_field(MR_mktag(1), Var_223, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &hlds__make_hlds__add_mutable_aux_preds_scalar_common_1[32])));
                }
                {
      ...
      case (MR_Integer) 0:
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_16, (MR_Integer) 287, &HighLevelCode_17);
...
{
  {
    ...
    else
    {
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals_38, (MR_Integer) 245, &UseTrail_46);
