  ...
  MR_Word * STATE_VARIABLE_Specs_37)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_20, (MR_Integer) 269, &UseTrail_24);
  ...
  MR_Word * STATE_VARIABLE_Specs_73)
{
  while (MR_TRUE)
  {
    ...
    switch (MR_tag((MR_Word) Inst_14)) {
      ...
      case (MR_Integer) 1:
        {
          MR_Word Uniq_145 = ((MR_Unsigned) ((MR_hl_field(1, Inst_14, (MR_Integer) 0))) & (MR_Integer) 7);
      ...
      case (MR_Integer) 2:
        {
          ...
          MR_Word Uniq_134 = ((MR_Unsigned) ((MR_hl_field(2, Inst_14, (MR_Integer) 0))) & (MR_Integer) 7);
