      ...
      else
      {
        ...
        else
        {
          ...
          else
          {
            ...
            mercury__private_builtin__builtin_compare_int_3_p_0(&SubResult4_15, Var_35, Var_36);
      ...
      case (MR_Integer) 0:
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_51, (MR_Integer) 277, &HighLevelCode_58);
      ...
      case (MR_Integer) 0:
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_16, (MR_Integer) 277, &HighLevelCode_17);
      ...
      case (MR_Integer) 0:
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 277, &HighLevelCode_14);
