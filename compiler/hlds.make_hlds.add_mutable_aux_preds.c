...
{
  {
    ...
    MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), SectionInfo_12, (MR_Integer) 1)));
      ...
      case (MR_Integer) 0:
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_51, (MR_Integer) 275, &HighLevelCode_58);
...
{
  {
    ...
    else
    {
      ...
      else
      {
        ...
        {
          MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Var_65, (MR_Integer) 0)));
      ...
      case (MR_Integer) 1:
        {
          ...
          *InitSetPredName_21 = parse_tree__prog_mutable__mutable_secret_set_pred_sym_name_2_f_0(ModuleName_26, MutableName_27);
          ...
          Var_234 = parse_tree__prog_mode__out_mode_1_f_0(Inst_31);
          {
            ...
            MR_hl_field(MR_mktag(0), Var_232, 3) = (MR_Box) ((MR_Unsigned) (BoxPolicy_42));
          }
          {
          ...
          Var_243 = parse_tree__prog_mode__in_mode_1_f_0(Inst_31);
          {
            ...
            MR_hl_field(MR_mktag(0), Var_241, 3) = (MR_Box) ((MR_Unsigned) (BoxPolicy_42));
          }
          {
...
{
  {
    ...
    Var_126 = parse_tree__prog_mode__out_mode_1_f_0(Inst_27);
    {
      ...
      MR_hl_field(MR_mktag(0), Var_124, 3) = (MR_Box) ((MR_Unsigned) (BoxPolicy_37));
    }
    {
    ...
    Var_135 = parse_tree__prog_mode__in_mode_1_f_0(Inst_27);
    {
      ...
      MR_hl_field(MR_mktag(0), Var_133, 3) = (MR_Box) ((MR_Unsigned) (BoxPolicy_37));
    }
    {
...
{
  {
      ...
      case (MR_Integer) 0:
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_16, (MR_Integer) 275, &HighLevelCode_17);
    ...
    {
      ForeignDeclCode_23 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), ForeignDeclCode_23, 0) = (MR_Box) (((((MR_Unsigned) ((MR_Integer) 0) << (MR_Integer) 1)) | (MR_Unsigned) ((MR_Integer) 1)));
...
{
  {
    ...
    else
    {
      ...
      MR_Unsigned packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), ItemMercuryStatus_11, (MR_Integer) 0)));
...
{
  {
    ...
    else
    {
      ...
      {
        MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Var_56, (MR_Integer) 0)));
...
{
  {
    ...
    else
    {
      ...
      packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), ForeignName_5, (MR_Integer) 0)));
      ...
      case (MR_Integer) 0:
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 275, &HighLevelCode_14);
...
{
  {
    ...
    packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), ItemPredDecl_11, (MR_Integer) 1)));
    ...
    packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), ItemPredDecl_11, (MR_Integer) 10)));
    ...
    switch (MR_tag((MR_Word) Inst_12)) {
      ...
      case (MR_Integer) 2:
        {
          ...
          MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), Inst_12, (MR_Integer) 0)));
      ...
      case (MR_Integer) 3:
        switch (((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), Inst_12, (MR_Integer) 0)))) {
          ...
          case (MR_Integer) 0:
            {
              ...
              MR_Word Uniq_133 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(3), Inst_12, (MR_Integer) 1))) & (MR_Integer) 7);
              MR_Unsigned packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Inst_12, (MR_Integer) 1)));
          ...
          case (MR_Integer) 1:
            {
              MR_Word Uniq_140 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(3), Inst_12, (MR_Integer) 1))) & (MR_Integer) 7);
              MR_Unsigned packed_args_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Inst_12, (MR_Integer) 1)));
      ...
      case (MR_Integer) 3:
        {
          ...
          if (succeeded)
          {
            packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Inst_13, (MR_Integer) 1)));
      ...
      case (MR_Integer) 4:
        {
          ...
          if (succeeded)
          {
            packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Inst_13, (MR_Integer) 1)));
      ...
      case (MR_Integer) 2:
        {
          ...
          if (succeeded)
          {
            packed_args_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Inst_13, (MR_Integer) 1)));
      ...
      case (MR_Integer) 1:
        {
          ...
          if (succeeded)
          {
            packed_args_3 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Inst_13, (MR_Integer) 1)));
