      ...
      case (MR_Integer) 0:
        {
          ...
          {
            libs__globals__lookup_bool_option_3_p_0(hlds__make_hlds__add_mutable_aux_preds__Globals_51, (MR_Integer) 254, &hlds__make_hlds__add_mutable_aux_preds__HighLevelCode_58);
          }
...
{
  {
    ...
    if (((MR_tag((MR_Word) hlds__make_hlds__add_mutable_aux_preds__ItemMercuryStatus_11)) == (MR_mktag((MR_Integer) 1))))
    ...
    else
      {
        ...
        {
          libs__globals__lookup_bool_option_3_p_0(hlds__make_hlds__add_mutable_aux_preds__Globals_39, (MR_Integer) 219, &hlds__make_hlds__add_mutable_aux_preds__UseTrail_47);
        }
