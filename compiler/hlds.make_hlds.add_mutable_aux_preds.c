  ...
  MR_Word * STATE_VARIABLE_Specs_33)
{
  ...
  Var_36 = mercury__cord__init_0_f_0((MR_Word) (&hlds__make_hlds__add_mutable_aux_preds_scalar_common_1[3]));
  ...
  Var_39 = mercury__cord__init_0_f_0((MR_Word) (&hlds__make_hlds__add_mutable_aux_preds_scalar_common_1[4]));
  ...
  *ForeignProcs_19 = mercury__cord__list_1_f_0((MR_Word) (&hlds__make_hlds__add_mutable_aux_preds_scalar_common_1[3]), ForeignProcCord_27);
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      else
      {
        ...
        Var_92 = mercury__cord__init_0_f_0((MR_Word) (&hlds__make_hlds__add_mutable_aux_preds_scalar_common_1[2]));
        ...
        succeeded = mercury__cord__is_empty_1_p_0((MR_Word) (&hlds__make_hlds__add_mutable_aux_preds_scalar_common_1[2]), ForeignProcSubCord_69);
        if (succeeded)
          STATE_VARIABLE_ForeignProcCord_103_103 = STATE_VARIABLE_ForeignProcCord_0_8;
        else
        {
          ...
          Var_102 = mercury__cord__list_1_f_0((MR_Word) (&hlds__make_hlds__add_mutable_aux_preds_scalar_common_1[2]), ForeignProcSubCord_69);
          {
          ...
          mercury__cord__snoc_3_p_0((MR_Word) (&hlds__make_hlds__add_mutable_aux_preds_scalar_common_1[3]), ((MR_Box) (ForeignProcSubList_72)), STATE_VARIABLE_ForeignProcCord_0_8, &STATE_VARIABLE_ForeignProcCord_103_103);
        }
      }
  ...
  MR_Word * STATE_VARIABLE_Specs_37)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_20, (MR_Integer) 268, &UseTrail_24);
  ...
  if (succeeded)
  {
    ...
    {
      TrailSpec_28 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(1, TrailSpec_28, 0) = ((MR_Box) ((MR_String) "predicate \140hlds.make_hlds.add_mutable_aux_preds.check_mutable\'/5"));
      MR_hl_field(1, TrailSpec_28, 1) = ((MR_Box) ((MR_Unsigned) 0U));
      MR_hl_field(1, TrailSpec_28, 2) = ((MR_Box) ((MR_Unsigned) 40U));
      MR_hl_field(1, TrailSpec_28, 3) = ((MR_Box) (Context_18));
      MR_hl_field(1, TrailSpec_28, 4) = ((MR_Box) (MR_mkword(1, &hlds__make_hlds__add_mutable_aux_preds_scalar_common_1[11])));
    }
    {
    ...
    switch (MR_tag((MR_Word) Inst_14)) {
      ...
      case (MR_Integer) 0:
        switch (MR_unmkbody(Inst_14)) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 0:
            hlds__make_hlds__add_mutable_aux_preds__invalid_inst_in_mutable_8_p_0(ModuleInfo_9, Context_11, InstVarSet_12, ParentInsts_13, Inst_14, (MR_Word) (MR_mkword(1, &hlds__make_hlds__add_mutable_aux_preds_scalar_common_1[16])), STATE_VARIABLE_Specs_0_72, STATE_VARIABLE_Specs_73);
            break;
          case (MR_Integer) 1:
            {
      ...
      case (MR_Integer) 2:
        {
          MR_Word Uniq_16 = ((MR_Unsigned) ((MR_hl_field(2, Inst_14, (MR_Integer) 0))) & (MR_Integer) 7);

          hlds__make_hlds__add_mutable_aux_preds__check_mutable_inst_uniqueness_8_p_0(ModuleInfo_9, Context_11, InstVarSet_12, ParentInsts_13, Inst_14, Uniq_16, STATE_VARIABLE_Specs_0_72, STATE_VARIABLE_Specs_73);
        }
        break;
      case (MR_Integer) 3:
        switch (((MR_Integer) ((MR_hl_field(3, Inst_14, (MR_Integer) 0))))) {
          ...
          case (MR_Integer) 0:
            {
              MR_Word BoundInsts_20 = ((MR_Word) ((MR_hl_field(3, Inst_14, (MR_Integer) 3))));
              MR_Word STATE_VARIABLE_Specs_75_75;
              MR_Word Uniq_134 = ((MR_Unsigned) ((MR_hl_field(3, Inst_14, (MR_Integer) 1))) & (MR_Integer) 7);

              hlds__make_hlds__add_mutable_aux_preds__check_mutable_inst_uniqueness_8_p_0(ModuleInfo_9, Context_11, InstVarSet_12, ParentInsts_13, Inst_14, Uniq_134, STATE_VARIABLE_Specs_0_72, &STATE_VARIABLE_Specs_75_75);
              hlds__make_hlds__add_mutable_aux_preds__check_mutable_bound_insts_8_p_0(ModuleInfo_9, ModuleParams_10, Context_11, InstVarSet_12, ParentInsts_13, BoundInsts_20, STATE_VARIABLE_Specs_75_75, STATE_VARIABLE_Specs_73);
            }
            break;
          case (MR_Integer) 1:
            {
              MR_Word Uniq_145 = ((MR_Unsigned) ((MR_hl_field(3, Inst_14, (MR_Integer) 1))) & (MR_Integer) 7);

              hlds__make_hlds__add_mutable_aux_preds__check_mutable_inst_uniqueness_8_p_0(ModuleInfo_9, Context_11, InstVarSet_12, ParentInsts_13, Inst_14, Uniq_145, STATE_VARIABLE_Specs_0_72, STATE_VARIABLE_Specs_73);
            }
            break;
          case (MR_Integer) 2:
            *STATE_VARIABLE_Specs_73 = STATE_VARIABLE_Specs_0_72;
            break;
          case (MR_Integer) 3:
            hlds__make_hlds__add_mutable_aux_preds__invalid_inst_in_mutable_8_p_0(ModuleInfo_9, Context_11, InstVarSet_12, ParentInsts_13, Inst_14, (MR_Word) (MR_mkword(1, &hlds__make_hlds__add_mutable_aux_preds_scalar_common_1[20])), STATE_VARIABLE_Specs_0_72, STATE_VARIABLE_Specs_73);
            break;
          case (MR_Integer) 4:
            {
                ...
                case (MR_Integer) 0:
                  {
                    ...
                    else
                    {
                      ...
                      if (succeeded)
                      {
                        ...
                        Var_144 = mdbcomp__builtin_modules__mercury_public_builtin_module_0_f_0();
                        succeeded = mdbcomp__sym_name____Unify____sym_name_0_0(UserInstModuleName_26, Var_144);
                        if (succeeded)
                        {
                      ...
                      if (succeeded)
                      {
...

                        {
                          ...
                          MR_hl_field(0, Var_86, 0) = ((MR_Box) (UserInstBaseName_27));
                        }
                        {
                          UnqualInstName_29 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
                          MR_hl_field(0, UnqualInstName_29, 0) = ((MR_Box) (Var_86));
                        ...
                        }
                        {
                          ...
                          MR_hl_field(3, UnqualInst_30, 0) = ((MR_Box) ((MR_Unsigned) 4U));
                          MR_hl_field(3, UnqualInst_30, 1) = ((MR_Box) (UnqualInstName_29));
                        }
                        hlds__make_hlds__add_mutable_aux_preds__invalid_inst_in_mutable_8_p_0(ModuleInfo_9, Context_11, InstVarSet_12, ParentInsts_13, UnqualInst_30, (MR_Word) (MR_mkword(1, &hlds__make_hlds__add_mutable_aux_preds_scalar_common_1[16])), STATE_VARIABLE_Specs_0_72, STATE_VARIABLE_Specs_73);
                      }
                      else
                      {
                        ...
                        hlds__make_hlds__add_mutable_aux_preds__check_mutable_insts_8_p_0(ModuleInfo_9, ModuleParams_10, Context_11, InstVarSet_12, ParentInsts_13, UserInstArgs_23, STATE_VARIABLE_Specs_0_72, &STATE_VARIABLE_Specs_88_88);
                        ...
                        if (succeeded)
                        {
                          ...
                          next_value_of_STATE_VARIABLE_Specs_0_72 = STATE_VARIABLE_Specs_88_88;
                        ...
                        else
                        {
                          ...
                          if (succeeded)
                            *STATE_VARIABLE_Specs_73 = STATE_VARIABLE_Specs_88_88;
                            ...
                            hlds__make_hlds__add_mutable_aux_preds__invalid_inst_in_mutable_8_p_0(ModuleInfo_9, Context_11, InstVarSet_12, ParentInsts_13, Inst_14, (MR_Word) (MR_mkword(1, &hlds__make_hlds__add_mutable_aux_preds_scalar_common_1[22])), STATE_VARIABLE_Specs_88_88, STATE_VARIABLE_Specs_73);
                        }
                      }
                    }
                  }
            ...
            break;
          case (MR_Integer) 5:
            hlds__make_hlds__add_mutable_aux_preds__invalid_inst_in_mutable_8_p_0(ModuleInfo_9, Context_11, InstVarSet_12, ParentInsts_13, Inst_14, (MR_Word) (MR_mkword(1, &hlds__make_hlds__add_mutable_aux_preds_scalar_common_1[18])), STATE_VARIABLE_Specs_0_72, STATE_VARIABLE_Specs_73);
            break;
        }
        break;
    }
