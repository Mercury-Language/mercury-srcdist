  ...
  MR_Word * STATE_VARIABLE_Specs_21)
{
  ...
  Var_40 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_format_component_0), ProblemPieces_14, (MR_Word) (MR_mkword(1, &hlds__make_hlds__add_mutable_aux_preds_scalar_common_1[5])));
  ...
  MR_Word * HeadVar__2_2)
{
  ...
  else
  {
    ...
    }
    {
      ...
      MR_hl_field(3, Var_14, 0) = ((MR_Box) ((MR_Unsigned) 10U));
