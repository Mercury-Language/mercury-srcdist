  ...
  MR_Word * STATE_VARIABLE_Specs_36)
{
  ...
  Const_22 = ((MR_Word) ((MR_hl_field(0, MutAttrs_17, (MR_Integer) 1))));
  libs__globals__lookup_bool_option_3_p_0(Globals_20, (MR_Integer) 290, &UseTrail_23);
  succeeded = (Const_22 != (MR_Word) ((MR_Unsigned) 0U));
  if (succeeded)
  {
    Local_25 = ((MR_Word) ((MR_hl_field(1, Const_22, (MR_Integer) 1))));
