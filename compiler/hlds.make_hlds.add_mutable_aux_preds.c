...
{
  {
    ...
    hlds__make_hlds__add_foreign_proc__add_pragma_foreign_proc_export_7_p_0(((MR_Box) (&hlds__make_hlds__add_mutable_aux_preds_scalar_common_1[70])), FPEInfo_75, Context_29, STATE_VARIABLE_ModuleInfo_24_78, STATE_VARIABLE_ModuleInfo_42, STATE_VARIABLE_Specs_59_59, STATE_VARIABLE_Specs_46);
  }
}
