...
static /* final */ const MR_Box hlds__make_hlds__add_mutable_aux_preds_scalar_common_5[2][1];

static /* final */ const MR_Box hlds__make_hlds__add_mutable_aux_preds_scalar_common_6[2][5];
...
static /* final */ const MR_Box hlds__make_hlds__add_mutable_aux_preds_scalar_common_1[70][2] = {
  ...
  /* row 68 */
  {
    ((MR_Box) (&hlds__make_hlds__add_mutable_aux_preds_scalar_common_5[0])),
    ((MR_Box) ((MR_Unsigned) 0U))
  },
  /* row 69 */
  {
...
{
  {
    ...
    switch (ImplLang_18) {
      ...
      case (MR_Integer) 1:
      case (MR_Integer) 2:
        parse_tree__prog_data_foreign__set_may_duplicate_3_p_0((MR_Word) (MR_mkword(MR_mktag(1), &hlds__make_hlds__add_mutable_aux_preds_scalar_common_5[1])), Attrs0_27, &Attrs_29);
        break;
      case (MR_Integer) 3:
        Attrs_29 = Attrs0_27;
        break;
      ...
      case (MR_Integer) 1:
        {
          ...
          *InitSetPredName_24 = parse_tree__prog_mutable__mutable_secret_set_pred_sym_name_2_f_0(ModuleName_29, MutableName_30);
          ...
          mercury__set__det_remove_3_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mutable_pred_kind_0), ((MR_Box) ((MR_Integer) 5)), STATE_VARIABLE_PredKinds_267_267, STATE_VARIABLE_PredKinds_87);
          {
            ...
            MR_hl_field(MR_mktag(0), Var_270, 0) = ((MR_Box) (&hlds__make_hlds__add_mutable_aux_preds_scalar_common_6[1]));
...
{
  {
    ...
    IsConstant_33 = parse_tree__prog_item__mutable_var_constant_1_f_0(MutAttrs_30);
    {
      ...
      MR_hl_field(MR_mktag(0), Var_61, 0) = ((MR_Box) (&hlds__make_hlds__add_mutable_aux_preds_scalar_common_6[0]));
...
{
  {
    ...
    IsConstant_33 = parse_tree__prog_item__mutable_var_constant_1_f_0(MutAttrs_30);
    {
      ...
      MR_hl_field(MR_mktag(0), Var_52, 0) = ((MR_Box) (&hlds__make_hlds__add_mutable_aux_preds_scalar_common_6[0]));
...
{
  {
    ...
    IsConstant_33 = parse_tree__prog_item__mutable_var_constant_1_f_0(MutAttrs_30);
    {
      ...
      MR_hl_field(MR_mktag(0), Var_45, 0) = ((MR_Box) (&hlds__make_hlds__add_mutable_aux_preds_scalar_common_6[0]));
...
{
  {
    ...
    else
    {
      ...
      switch (ItemExport_13) {
        default: /*NOTREACHED*/ MR_assert(0);
        case (MR_Integer) 2:
          hlds__make_hlds_error__error_is_exported_4_p_0(Context_37, (MR_Word) (MR_mkword(MR_mktag(1), &hlds__make_hlds__add_mutable_aux_preds_scalar_common_1[6])), STATE_VARIABLE_Specs_0_18, &STATE_VARIABLE_Specs_42_59);
          break;
        case (MR_Integer) 0:
      ...
      if (succeeded)
      {
        ...
        {
          TrailMsg_49 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), TrailMsg_49, 0) = ((MR_Box) (Context_37));
          MR_hl_field(MR_mktag(1), TrailMsg_49, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &hlds__make_hlds__add_mutable_aux_preds_scalar_common_1[68])));
        }
        {
    ...
    else
    {
      ...
      else
      {
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(1), Var_36, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &hlds__make_hlds__add_mutable_aux_preds_scalar_common_1[37])));
        }
        {
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(1), Msg_26, 0) = ((MR_Box) (Context_11));
          MR_hl_field(MR_mktag(1), Msg_26, 1) = ((MR_Box) (Var_45));
        }
        {
...
{
  {
    ...
    Var_41 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_format_component_0), ProblemPieces_14, (MR_Word) (MR_mkword(MR_mktag(1), &hlds__make_hlds__add_mutable_aux_preds_scalar_common_1[7])));
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), Msg_19, 0) = ((MR_Box) (Context_10));
      MR_hl_field(MR_mktag(1), Msg_19, 1) = ((MR_Box) (Var_45));
    }
    {
      Var_50 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
