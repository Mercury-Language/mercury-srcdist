...
static /* final */ const MR_Box hlds__make_hlds__add_mutable_aux_preds_scalar_common_1[46][2];
...
static /* final */ const MR_Box hlds__make_hlds__add_mutable_aux_preds_scalar_common_1[46][2] = {
  ...
  /* row   6 */
  {
    ...
    ((MR_Box) (MR_mkword(1, &hlds__make_hlds__add_mutable_aux_preds_scalar_common_1[4])))
  },
  /* row   7 */
  {
  ...
  /* row  25 */
  {
    ...
    ((MR_Box) (MR_mkword(1, &hlds__make_hlds__add_mutable_aux_preds_scalar_common_1[23])))
  },
  /* row  26 */
  {
    ((MR_Box) (MR_Word) ((MR_Unsigned) 0U)),
  ...
  /* row  38 */
  {
    ...
    ((MR_Box) (MR_mkword(1, &hlds__make_hlds__add_mutable_aux_preds_scalar_common_1[25])))
  },
  /* row  39 */
  {
  ...
  {
    ((MR_Box) (MR_mkword(3, &hlds__make_hlds__add_mutable_aux_preds_scalar_common_1[20]))),
    ((MR_Box) (MR_mkword(1, &hlds__make_hlds__add_mutable_aux_preds_scalar_common_1[42])))
  },
  /* row  44 */
  {
  ...
  {
    ((MR_Box) (MR_mkword(3, &hlds__make_hlds__add_mutable_aux_preds_scalar_common_1[20]))),
    ((MR_Box) (MR_mkword(1, &hlds__make_hlds__add_mutable_aux_preds_scalar_common_1[44])))
  },
};
  ...
  MR_Word * STATE_VARIABLE_Specs_33)
{
  ...
  Var_39 = mercury__cord__init_0_f_0((MR_Word) (&hlds__make_hlds__add_mutable_aux_preds_scalar_common_1[3]));
  ...
  MR_Word * STATE_VARIABLE_Specs_20)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      mercury__cord__snoc_3_p_0((MR_Word) (&hlds__make_hlds__add_mutable_aux_preds_scalar_common_1[3]), ((MR_Box) (FPEInfo_64)), STATE_VARIABLE_FPEInfoCord_0_15, &STATE_VARIABLE_FPEInfoCord_91_91);
      // direct tailcall eliminated
      ;
  ...
  MR_Word * STATE_VARIABLE_Specs_37)
{
  ...
  if (succeeded)
  {
...

    {
      ...
      MR_hl_field(1, TrailSpec_28, 4) = ((MR_Box) (MR_mkword(1, &hlds__make_hlds__add_mutable_aux_preds_scalar_common_1[10])));
    }
    {
    ...
    switch (MR_tag((MR_Word) Inst_14)) {
      ...
      case (MR_Integer) 0:
        switch (MR_unmkbody(Inst_14)) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 0:
            hlds__make_hlds__add_mutable_aux_preds__invalid_inst_in_mutable_8_p_0(ModuleInfo_9, Context_11, InstVarSet_12, ParentInsts_13, Inst_14, (MR_Word) (MR_mkword(1, &hlds__make_hlds__add_mutable_aux_preds_scalar_common_1[15])), STATE_VARIABLE_Specs_0_68, STATE_VARIABLE_Specs_69);
            break;
          case (MR_Integer) 1:
            {
      ...
      case (MR_Integer) 3:
        switch (((MR_Integer) ((MR_hl_field(3, Inst_14, (MR_Integer) 0))))) {
          ...
          case (MR_Integer) 0:
                ...
                case (MR_Integer) 0:
                  {
                    ...
                    else
                    {
                      ...
                      if (succeeded)
                      {
                        ...
                        hlds__make_hlds__add_mutable_aux_preds__invalid_inst_in_mutable_8_p_0(ModuleInfo_9, Context_11, InstVarSet_12, ParentInsts_13, UnqualInst_30, (MR_Word) (MR_mkword(1, &hlds__make_hlds__add_mutable_aux_preds_scalar_common_1[15])), STATE_VARIABLE_Specs_0_68, STATE_VARIABLE_Specs_69);
                      }
                      else
                      {
                        ...
                        else
                        {
                          ...
                          if (succeeded)
                            *STATE_VARIABLE_Specs_69 = STATE_VARIABLE_Specs_84_84;
                            ...
                            hlds__make_hlds__add_mutable_aux_preds__invalid_inst_in_mutable_8_p_0(ModuleInfo_9, Context_11, InstVarSet_12, ParentInsts_13, Inst_14, (MR_Word) (MR_mkword(1, &hlds__make_hlds__add_mutable_aux_preds_scalar_common_1[19])), STATE_VARIABLE_Specs_84_84, STATE_VARIABLE_Specs_69);
                        }
                      }
                    }
                  }
            ...
            break;
          case (MR_Integer) 1:
            hlds__make_hlds__add_mutable_aux_preds__invalid_inst_in_mutable_8_p_0(ModuleInfo_9, Context_11, InstVarSet_12, ParentInsts_13, Inst_14, (MR_Word) (MR_mkword(1, &hlds__make_hlds__add_mutable_aux_preds_scalar_common_1[17])), STATE_VARIABLE_Specs_0_68, STATE_VARIABLE_Specs_69);
            break;
          case (MR_Integer) 2:
            {
    ...
    case (MR_Integer) 3:
      {
        ...
        if (succeeded)
          UniqPieces_18 = (MR_Word) (MR_mkword(1, &hlds__make_hlds__add_mutable_aux_preds_scalar_common_1[15]));
        else
          UniqPieces_18 = (MR_Word) (MR_mkword(1, &hlds__make_hlds__add_mutable_aux_preds_scalar_common_1[39]));
    ...
    case (MR_Integer) 4:
      {
        ...
        if (succeeded)
          UniqPieces_65 = (MR_Word) (MR_mkword(1, &hlds__make_hlds__add_mutable_aux_preds_scalar_common_1[15]));
        else
          UniqPieces_65 = (MR_Word) (MR_mkword(1, &hlds__make_hlds__add_mutable_aux_preds_scalar_common_1[41]));
    ...
    case (MR_Integer) 2:
      {
        ...
        if (succeeded)
          UniqPieces_89 = (MR_Word) (MR_mkword(1, &hlds__make_hlds__add_mutable_aux_preds_scalar_common_1[15]));
        else
          UniqPieces_89 = (MR_Word) (MR_mkword(1, &hlds__make_hlds__add_mutable_aux_preds_scalar_common_1[43]));
    ...
    case (MR_Integer) 1:
      {
        ...
        if (succeeded)
          UniqPieces_113 = (MR_Word) (MR_mkword(1, &hlds__make_hlds__add_mutable_aux_preds_scalar_common_1[15]));
        else
          UniqPieces_113 = (MR_Word) (MR_mkword(1, &hlds__make_hlds__add_mutable_aux_preds_scalar_common_1[45]));
  ...
  MR_Word * STATE_VARIABLE_Specs_21)
{
  ...
  InstPieces_17 = hlds__error_msg_inst__error_msg_inst_8_f_0(ModuleInfo_9, InstVarSet_11, (MR_Integer) 0, (MR_Integer) 0, (MR_Word) ((MR_Unsigned) 0U), (MR_Word) (MR_mkword(1, &hlds__make_hlds__add_mutable_aux_preds_scalar_common_1[30])), (MR_Word) (MR_mkword(1, &hlds__make_hlds__add_mutable_aux_preds_scalar_common_1[32])), Inst_13);
  {
    Var_33 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(1, Var_33, 0) = ((MR_Box) (MR_mkword(3, &hlds__make_hlds__add_mutable_aux_preds_scalar_common_1[33])));
    MR_hl_field(1, Var_33, 1) = ((MR_Box) (ParentPieces_16));
  }
  {
    Var_37 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(1, Var_37, 0) = ((MR_Box) (MR_mkword(3, &hlds__make_hlds__add_mutable_aux_preds_scalar_common_1[34])));
    MR_hl_field(1, Var_37, 1) = ((MR_Box) (InstPieces_17));
  }
  Var_40 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), ProblemPieces_14, (MR_Word) (MR_mkword(1, &hlds__make_hlds__add_mutable_aux_preds_scalar_common_1[4])));
  ...
  MR_Word * HeadVar__2_2)
{
  ...
  else
  {
    ...
    }
    {
      ...
      MR_hl_field(1, Var_13, 1) = ((MR_Box) (MR_mkword(1, &hlds__make_hlds__add_mutable_aux_preds_scalar_common_1[37])));
    }
    {
      HeadPieces_6 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(1, HeadPieces_6, 0) = ((MR_Box) (MR_mkword(3, &hlds__make_hlds__add_mutable_aux_preds_scalar_common_1[35])));
