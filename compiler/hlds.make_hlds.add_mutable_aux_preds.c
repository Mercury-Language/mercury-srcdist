...
{
  {
    ...
    else
    {
      ...
      MR_Word ArgX2_6 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), HeadVar__2_2, (MR_Integer) 0))) >> 4)) & (MR_Integer) 3);
      MR_Word ArgY2_7 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), HeadVar__3_3, (MR_Integer) 0))) >> 4)) & (MR_Integer) 3);
      MR_Word ArgX3_8 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), HeadVar__2_2, (MR_Integer) 0))) >> 3)) & (MR_Integer) 1);
      MR_Word ArgY3_9 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), HeadVar__3_3, (MR_Integer) 0))) >> 3)) & (MR_Integer) 1);
      MR_Word ArgX4_10 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), HeadVar__2_2, (MR_Integer) 0))) >> 2)) & (MR_Integer) 1);
      MR_Word ArgY4_11 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), HeadVar__3_3, (MR_Integer) 0))) >> 2)) & (MR_Integer) 1);
      MR_Word ArgX5_12 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), HeadVar__2_2, (MR_Integer) 0))) >> 1)) & (MR_Integer) 1);
      MR_Word ArgY5_13 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), HeadVar__3_3, (MR_Integer) 0))) >> 1)) & (MR_Integer) 1);
...
{
  {
    ...
    MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), SectionInfo_12, (MR_Integer) 1)));
...
{
  {
    ...
    else
    {
      ...
      else
      {
        ...
        {
          MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Var_65, (MR_Integer) 0)));
...
{
  {
    ...
    MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), TargetParams_12, (MR_Integer) 0)));
...
{
  {
    ...
    packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), TargetParams_16, (MR_Integer) 0)));
      ...
      case (MR_Integer) 1:
        {
          ...
          *InitSetPredName_21 = parse_tree__prog_mutable__mutable_secret_set_pred_sym_name_2_f_0(ModuleName_26, MutableName_27);
          ...
          {
            Var_237 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
            ...
            case (MR_Integer) 2:
              {
                ...
                else
                {
                  ...
                  {
                    Var_159 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
...
{
  {
    ...
    packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), TargetParams_14, (MR_Integer) 0)));
...
{
  {
    ...
    else
    {
      ...
      MR_Unsigned packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), ItemMercuryStatus_11, (MR_Integer) 0)));
...
{
  {
    ...
    else
    {
      ...
      {
        MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Var_56, (MR_Integer) 0)));
...
{
  {
    ...
    else
    {
      ...
      packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), ForeignName_5, (MR_Integer) 0)));
...
{
  {
    ...
    else
    {
      ...
      MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), TargetParams_24, (MR_Integer) 0)));
...
{
  {
    ...
    packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), ItemPredDecl_11, (MR_Integer) 1)));
    ...
    packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), ItemPredDecl_11, (MR_Integer) 10)));
      ...
      case (MR_Integer) 2:
        {
          ...
          MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), Inst_12, (MR_Integer) 0)));
          ...
          case (MR_Integer) 0:
            {
              ...
              MR_Unsigned packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Inst_12, (MR_Integer) 1)));
          ...
          case (MR_Integer) 1:
            {
              ...
              MR_Unsigned packed_word_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Inst_12, (MR_Integer) 1)));
      ...
      case (MR_Integer) 3:
        {
          ...
          if (succeeded)
          {
            packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Inst_13, (MR_Integer) 1)));
      ...
      case (MR_Integer) 4:
        {
          ...
          if (succeeded)
          {
            packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Inst_13, (MR_Integer) 1)));
      ...
      case (MR_Integer) 2:
        {
          ...
          if (succeeded)
          {
            packed_word_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Inst_13, (MR_Integer) 1)));
      ...
      case (MR_Integer) 1:
        {
          ...
          if (succeeded)
          {
            packed_word_3 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Inst_13, (MR_Integer) 1)));
