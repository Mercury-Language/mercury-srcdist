...
{
  {
    ...
    hlds__make_hlds__add_pragma__add_pragma_foreign_proc_export_7_p_0(Origin_79, FPEInfo_77, Context_29, STATE_VARIABLE_ModuleInfo_28_80, STATE_VARIABLE_ModuleInfo_42, STATE_VARIABLE_Specs_59_59, STATE_VARIABLE_Specs_46);
  }
}
