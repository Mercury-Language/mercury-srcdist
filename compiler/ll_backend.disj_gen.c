      ...
      case (MR_Integer) 0:
        {
          ...
          {
            libs__globals__lookup_int_option_3_p_0(ll_backend__disj_gen__Globals_22, (MR_Integer) 286, &ll_backend__disj_gen__FixedSize_23);
          }
          {
            libs__globals__lookup_int_option_3_p_0(ll_backend__disj_gen__Globals_22, (MR_Integer) 292, &ll_backend__disj_gen__SnapshotSize_24);
          }
      ...
      case (MR_Integer) 0:
        {
          ...
          {
            libs__globals__lookup_int_option_3_p_0(ll_backend__disj_gen__Globals_29, (MR_Integer) 286, &ll_backend__disj_gen__FixedSize_30);
          }
          {
            libs__globals__lookup_int_option_3_p_0(ll_backend__disj_gen__Globals_29, (MR_Integer) 291, &ll_backend__disj_gen__ProtectSize_31);
          }
          {
            libs__globals__lookup_int_option_3_p_0(ll_backend__disj_gen__Globals_29, (MR_Integer) 292, &ll_backend__disj_gen__SnapshotSize_32);
          }
      ...
      case (MR_Integer) 2:
        {
          ...
          {
            libs__globals__lookup_bool_option_3_p_0(ll_backend__disj_gen__Globals_23, (MR_Integer) 303, &ll_backend__disj_gen__ReclaimHeap_26);
          }
          {
                        ...
                        if (ll_backend__disj_gen__succeeded)
                          {
                            ...
                            ll_backend__disj_gen__V_56_56 = (MR_Integer) 444;
                                ...
                                if (ll_backend__disj_gen__succeeded)
                                  {
                                    ...
                                    if (ll_backend__disj_gen__succeeded)
                                      {
                                        ll_backend__disj_gen__V_66_66 = (MR_Integer) 303;
                                        {
