    ...
    case (MR_Integer) 0:
      {
        ...
        libs__globals__lookup_int_option_3_p_0(Globals_22, (MR_Integer) 316, &FixedSize_23);
    ...
    case (MR_Integer) 0:
      {
        ...
        libs__globals__lookup_int_option_3_p_0(Globals_29, (MR_Integer) 316, &FixedSize_30);
...
{
  {
    ...
    else
    {
      ...
      if ((Resume_65 == (MR_Word) ((MR_Unsigned) 0U)))
      {
        ...
        ll_backend__code_loc_dep__generate_branch_end_6_p_0(StoreMap_194, MaybeEnd0_15, MaybeEnd_16, &SaveCode_195, *STATE_VARIABLE_CI_19, STATE_VARIABLE_CLD_166_197);
      ...
      else
      {
          ...
          case (MR_Integer) 2:
            {
              ...
              ll_backend__code_loc_dep__flush_resume_vars_to_stack_4_p_0(&FlushResumeVarsCode_86, STATE_VARIABLE_CI_151_151, STATE_VARIABLE_CLD_152_152, &STATE_VARIABLE_CLD_161_161);
        ...
        ll_backend__code_loc_dep__generate_branch_end_6_p_0(StoreMap_90, MaybeEnd0_15, &MaybeEnd1_91, &SaveCode_92, STATE_VARIABLE_CI_162_162, STATE_VARIABLE_CLD_166_166);
        if ((RegionCommitDisjCleanup_7 == (MR_Word) ((MR_Unsigned) 0U)))
        {
          MR_Word Var_171;
          MR_Word Var_172;
...
{
  {
    ...
    ll_backend__code_loc_dep__flush_resume_vars_to_stack_4_p_0(&LaterFlushResumeVarsCode_55, *STATE_VARIABLE_CI_62, STATE_VARIABLE_CLD_166_166, &STATE_VARIABLE_CLD_167_167);
    ...
    ll_backend__lookup_util__set_liveness_and_end_branch_7_p_0(StoreMap_14, Liveness_16, MaybeEnd1_41, &MaybeEnd_57, &LaterBranchEndCode_58, *STATE_VARIABLE_CI_62, STATE_VARIABLE_CLD_170_170);
