            ...
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                ...
                if (succeeded)
                {
                  ...
                  TypeInfo_201_201 = (MR_Word) (&ll_backend__disj_gen_scalar_common_1[0]);
                  TypeCtorInfo_202_202 = (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0);
                  {
                  ...
                  OutTypes_31 = mercury__list__map_2_f_0(TypeInfo_201_201, TypeCtorInfo_202_202, Var_59, OutVars_29);
                  TypeCtorInfo_205_205 = (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0);
                  Var_60 = parse_tree__set_of_var__to_sorted_list_1_f_0(TypeCtorInfo_205_205, ResumeVars_13);
