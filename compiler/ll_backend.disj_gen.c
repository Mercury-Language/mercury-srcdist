...
MR_decl_label10(ll_backend__disj_gen__is_lookup_disj_8_0, 5,6,8,10,12,13,16,17,18,19)
MR_decl_label10(ll_backend__disj_gen__is_lookup_disj_8_0, 20,21,22,23,24,26,27,28,29,30)
MR_decl_label7(ll_backend__disj_gen__is_lookup_disj_8_0, 31,33,36,37,38,39,1)
...
MR_BEGIN_MODULE(ll_backend__disj_gen_module0)
	...
	MR_init_label10(ll_backend__disj_gen__is_lookup_disj_8_0,5,6,8,10,12,13,16,17,18,19)
	MR_init_label10(ll_backend__disj_gen__is_lookup_disj_8_0,20,21,22,23,24,26,27,28,29,30)
	MR_init_label7(ll_backend__disj_gen__is_lookup_disj_8_0,31,33,36,37,38,39,1)
MR_BEGIN_CODE
...
MR_def_label(ll_backend__disj_gen__generate_lookup_disj_5_0,8)
	...
	MR_tfield(2, MR_tempr1, 2) = (MR_Word) MR_TAG_COMMON(3,3,0);
	MR_tag_alloc_heap(MR_tempr2, 3, (MR_Integer) 2);
	...
	MR_sv(12) = MR_r1;
	MR_sv(10) = MR_r2;
	MR_sv(27) = (MR_Word) MR_TAG_COMMON(1,2,0);
...
void mercury__ll_backend__disj_gen__write_out_proc_statics(FILE *deep_fp, FILE *procrep_fp)
{
	MR_write_out_module_proc_reps_start(procrep_fp, &mercury_data__module_layout__ll_backend__disj_gen);
