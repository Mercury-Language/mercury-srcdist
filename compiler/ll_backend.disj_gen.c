...
ll_backend__disj_gen__IntroducedFrom__pred__generate_disjuncts__559__1_2_p_0(
  MR_Word HpSlot_76,
...
{
  {
    ...
    succeeded = ll_backend__disj_gen__IntroducedFrom__pred__generate_disjuncts__559__1_2_p_0(((MR_Word) (MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3))), ((MR_Word) (MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4))));
    return succeeded;
  }
}
...
{
  {
    ...
    ll_backend__code_info__add_vector_static_cell_5_p_0(LLDSTypes_27, Solns_26, &SolnVectorAddr_30, STATE_VARIABLE_CI_0_61, &STATE_VARIABLE_CI_65_65);
    {
      ...
      MR_hl_field(MR_mktag(3), Var_66, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 13));
...
{
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          Var_23 = ((MR_Word) (MR_hl_field(MR_mktag(1), Var_56, (MR_Integer) 0)));
          Var_24 = ((MR_Word) (MR_hl_field(MR_mktag(1), Var_56, (MR_Integer) 1)));
              ...
              if (succeeded)
              {
                ...
                if (succeeded)
                {
                  ...
                  if (succeeded)
                  {
                    ...
                    Var_61 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 3));
                    Var_62 = (MR_Integer) 1;
