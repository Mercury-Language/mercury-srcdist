      ...
      case (MR_Integer) 0:
        {
          ...
          {
            libs__globals__lookup_int_option_3_p_0(ll_backend__disj_gen__Globals_22, (MR_Integer) 295, &ll_backend__disj_gen__FixedSize_23);
          }
          {
            libs__globals__lookup_int_option_3_p_0(ll_backend__disj_gen__Globals_22, (MR_Integer) 301, &ll_backend__disj_gen__SnapshotSize_24);
          }
      ...
      case (MR_Integer) 0:
        {
          ...
          {
            libs__globals__lookup_int_option_3_p_0(ll_backend__disj_gen__Globals_29, (MR_Integer) 295, &ll_backend__disj_gen__FixedSize_30);
          }
          {
            libs__globals__lookup_int_option_3_p_0(ll_backend__disj_gen__Globals_29, (MR_Integer) 300, &ll_backend__disj_gen__ProtectSize_31);
          }
          {
            libs__globals__lookup_int_option_3_p_0(ll_backend__disj_gen__Globals_29, (MR_Integer) 301, &ll_backend__disj_gen__SnapshotSize_32);
          }
                        ...
                        if (ll_backend__disj_gen__succeeded)
                          {
                            ...
                            ll_backend__disj_gen__Var_56 = (MR_Integer) 456;
                                ...
                                if (ll_backend__disj_gen__succeeded)
                                  {
                                    ...
                                    if (ll_backend__disj_gen__succeeded)
                                      {
                                        ll_backend__disj_gen__Var_66 = (MR_Integer) 312;
                                        {
