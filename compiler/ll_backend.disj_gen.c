      ...
      case (MR_Integer) 1:
        {
          ...
          {
            libs__globals__lookup_bool_option_3_p_0(ll_backend__disj_gen__Globals_23, (MR_Integer) 308, &ll_backend__disj_gen__ReclaimHeap_26);
          }
                        ...
                        if (ll_backend__disj_gen__succeeded)
                          {
                            ...
                            ll_backend__disj_gen__V_56_56 = (MR_Integer) 450;
                                ...
                                if (ll_backend__disj_gen__succeeded)
                                  {
                                    ...
                                    if (ll_backend__disj_gen__succeeded)
                                      {
                                        ll_backend__disj_gen__V_66_66 = (MR_Integer) 309;
                                        {
