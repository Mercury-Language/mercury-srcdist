      ...
      case (MR_Integer) 1:
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_23, (MR_Integer) 332, &ReclaimHeap_26);
      ...
      case (MR_Integer) 2:
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_23, (MR_Integer) 333, &ReclaimHeap_26);
    ...
    case (MR_Integer) 0:
      {
        ...
        libs__globals__lookup_int_option_3_p_0(Globals_22, (MR_Integer) 317, &FixedSize_23);
        libs__globals__lookup_int_option_3_p_0(Globals_22, (MR_Integer) 322, &SnapshotSize_24);
    ...
    case (MR_Integer) 0:
      {
        ...
        libs__globals__lookup_int_option_3_p_0(Globals_29, (MR_Integer) 317, &FixedSize_30);
        libs__globals__lookup_int_option_3_p_0(Globals_29, (MR_Integer) 321, &ProtectSize_31);
        libs__globals__lookup_int_option_3_p_0(Globals_29, (MR_Integer) 322, &SnapshotSize_32);
              ...
              if (succeeded)
              {
                ...
                if (succeeded)
                {
                  ...
                  if (succeeded)
                  {
                    ...
                    ll_backend__code_loc_dep__produce_vars_5_p_0(Var_59, &ResumeMap_31, &FlushCode_32, STATE_VARIABLE_CLD_0_55, &STATE_VARIABLE_CLD_60_60);
