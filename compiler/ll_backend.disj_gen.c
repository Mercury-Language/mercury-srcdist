...
MR_decl_label10(ll_backend__disj_gen__generate_lookup_disj_5_0, 26,27,28,29,30,31,32,33,37,38)
MR_decl_label10(ll_backend__disj_gen__generate_lookup_disj_5_0, 39,40,41,42,43,44,68,69,78,79)
MR_decl_label10(ll_backend__disj_gen__generate_lookup_disj_5_0, 80,81,82,83,84,85,86,89,92,93)
MR_decl_label10(ll_backend__disj_gen__generate_lookup_disj_5_0, 94,95,96,97,98,99,100,101,102,103)
MR_decl_label8(ll_backend__disj_gen__generate_lookup_disj_5_0, 104,105,106,107,108,109,110,111)
...
MR_BEGIN_MODULE(ll_backend__disj_gen_module1)
	...
	MR_init_label10(ll_backend__disj_gen__generate_lookup_disj_5_0,26,27,28,29,30,31,32,33,37,38)
	MR_init_label10(ll_backend__disj_gen__generate_lookup_disj_5_0,39,40,41,42,43,44,68,69,78,79)
	MR_init_label10(ll_backend__disj_gen__generate_lookup_disj_5_0,80,81,82,83,84,85,86,89,92,93)
	MR_init_label10(ll_backend__disj_gen__generate_lookup_disj_5_0,94,95,96,97,98,99,100,101,102,103)
	MR_init_label8(ll_backend__disj_gen__generate_lookup_disj_5_0,104,105,106,107,108,109,110,111)
MR_BEGIN_CODE
...
MR_def_label(ll_backend__disj_gen__generate_lookup_disj_5_0,86)
	...
	MR_np_call_localret_ent(fn__cord__singleton_1_0,
		ll_backend__disj_gen__generate_lookup_disj_5_0_i89);
MR_def_label(ll_backend__disj_gen__generate_lookup_disj_5_0,89)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(23) = MR_r1;
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(ll_backend__llds, instruction);
...
MR_def_label(ll_backend__disj_gen__generate_disjuncts_19_0,66)
	...
	MR_tfield(0, MR_r1, 1) = (MR_Word) MR_ENTRY_AP(ll_backend__disj_gen__IntroducedFrom__pred__generate_disjuncts__537__1_2_0);
