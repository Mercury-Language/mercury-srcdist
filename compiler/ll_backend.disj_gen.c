    ...
    else
    {
      ...
      else
      {
        ...
        switch (CodeModel_2) {
          ...
          case (MR_Integer) 2:
            {
              ll_backend__code_loc_dep__flush_resume_vars_to_stack_3_p_0(&ResumeVarsCode_87, STATE_VARIABLE_CLD_154_154, &STATE_VARIABLE_CLD_161_161);
        ...
        Var_182 = mercury__cord__f_43_43_2_f_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_instruction_0), ResumeVarsCode_87, Var_183);
        Var_181 = mercury__cord__f_43_43_2_f_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_instruction_0), GoalCode_86, Var_182);
