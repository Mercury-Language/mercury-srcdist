...
{
  {
    ...
    else
    {
      ...
      else
      {
        ...
        packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), Resume_20, (MR_Integer) 1)));
      }
...
{
  {
    ...
    else
    {
      ...
      else
      {
        ...
        MR_Word Var_185;
        MR_Word Var_186;
        MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), Resume_65, (MR_Integer) 1)));
