      ...
      case (MR_Integer) 0:
        {
          ...
          {
            libs__globals__lookup_int_option_3_p_0(ll_backend__disj_gen__Globals_22, (MR_Integer) 285, &ll_backend__disj_gen__FixedSize_23);
          }
          {
            libs__globals__lookup_int_option_3_p_0(ll_backend__disj_gen__Globals_22, (MR_Integer) 291, &ll_backend__disj_gen__SnapshotSize_24);
          }
      ...
      case (MR_Integer) 0:
        {
          ...
          {
            libs__globals__lookup_int_option_3_p_0(ll_backend__disj_gen__Globals_29, (MR_Integer) 285, &ll_backend__disj_gen__FixedSize_30);
          }
          {
            libs__globals__lookup_int_option_3_p_0(ll_backend__disj_gen__Globals_29, (MR_Integer) 290, &ll_backend__disj_gen__ProtectSize_31);
          }
          {
            libs__globals__lookup_int_option_3_p_0(ll_backend__disj_gen__Globals_29, (MR_Integer) 291, &ll_backend__disj_gen__SnapshotSize_32);
          }
