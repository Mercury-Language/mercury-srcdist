        ...
        case (MR_Integer) 2:
          {
            ...
            libs__globals__lookup_bool_option_3_p_0(Globals_41, (MR_Integer) 372, &ReclaimHeap_44);
    ...
    case (MR_Integer) 0:
      {
        ...
        libs__globals__lookup_int_option_3_p_0(Globals_22, (MR_Integer) 357, &FixedSize_23);
        libs__globals__lookup_int_option_3_p_0(Globals_22, (MR_Integer) 362, &SnapshotSize_24);
    ...
    case (MR_Integer) 0:
      {
        ...
        libs__globals__lookup_int_option_3_p_0(Globals_29, (MR_Integer) 357, &FixedSize_30);
        libs__globals__lookup_int_option_3_p_0(Globals_29, (MR_Integer) 361, &ProtectSize_31);
        libs__globals__lookup_int_option_3_p_0(Globals_29, (MR_Integer) 362, &SnapshotSize_32);
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = ll_backend__disj_gen__IntroducedFrom__pred__generate_disjuncts__564__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 4)))));
  return succeeded;
}
  ...
  MR_Word * STATE_VARIABLE_CLD_65)
{
  ...
  MR_Word STATE_VARIABLE_CLD_172_172;
  MR_Word Var_174;
  MR_Word Var_175;
  MR_Word Var_181;
  MR_Word Var_182;
  ...
  ll_backend__code_loc_dep__undo_disj_hijack_4_p_0(HijackInfo_24, &UndoHijackCode_53, STATE_VARIABLE_CLD_106_106, &STATE_VARIABLE_CLD_149_149);
  {
  ...
  ll_backend__code_loc_dep__effect_resume_point_5_p_0(ResumePoint_37, (MR_Integer) 2, &_LaterUpdateRedoipCode_55, STATE_VARIABLE_CLD_149_149, &STATE_VARIABLE_CLD_166_166);
  ll_backend__lookup_util__record_offset_assigns_6_p_0(OutVars_13, (MR_Integer) 0, LaterBaseReg_48, *STATE_VARIABLE_CI_63, STATE_VARIABLE_CLD_166_166, &STATE_VARIABLE_CLD_168_168);
  ll_backend__code_loc_dep__flush_resume_vars_to_stack_3_p_0(&LaterFlushResumeVarsCode_56, STATE_VARIABLE_CLD_168_168, &STATE_VARIABLE_CLD_169_169);
  ll_backend__code_loc_dep__pop_resume_point_2_p_0(STATE_VARIABLE_CLD_169_169, &STATE_VARIABLE_CLD_170_170);
  ll_backend__code_loc_dep__pickup_zombies_3_p_0(&LaterZombies_57, STATE_VARIABLE_CLD_170_170, &STATE_VARIABLE_CLD_171_171);
  ll_backend__code_loc_dep__make_vars_forward_dead_3_p_0(LaterZombies_57, STATE_VARIABLE_CLD_171_171, &STATE_VARIABLE_CLD_172_172);
  ll_backend__lookup_util__set_liveness_and_end_branch_5_p_0(EndBranch_41, &LaterBranchEndCode_58, MaybeEnd1_43, &MaybeEnd_59, STATE_VARIABLE_CLD_172_172);
