      ...
      case (MR_Integer) 1:
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_23, (MR_Integer) 339, &ReclaimHeap_26);
    ...
    case (MR_Integer) 0:
      {
        ...
        libs__globals__lookup_int_option_3_p_0(Globals_22, (MR_Integer) 324, &FixedSize_23);
        libs__globals__lookup_int_option_3_p_0(Globals_22, (MR_Integer) 329, &SnapshotSize_24);
    ...
    case (MR_Integer) 0:
      {
        ...
        libs__globals__lookup_int_option_3_p_0(Globals_29, (MR_Integer) 324, &FixedSize_30);
        libs__globals__lookup_int_option_3_p_0(Globals_29, (MR_Integer) 328, &ProtectSize_31);
        libs__globals__lookup_int_option_3_p_0(Globals_29, (MR_Integer) 329, &SnapshotSize_32);
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                ...
                if (succeeded)
                {
                  Var_58 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), OptTuple_28, (MR_Integer) 1))) >> 14)) & (MR_Integer) 1);
                  ...
                  if (succeeded)
                  {
                    ...
                    TypeCtorInfo_199_199 = (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0);
                    Var_59 = parse_tree__set_of_var__to_sorted_list_1_f_0(TypeCtorInfo_199_199, ResumeVars_13);
                    ...
                    ll_backend__code_info__get_globals_2_p_0(STATE_VARIABLE_CI_65_65, &Var_200);
                    succeeded = libs__globals____Unify____globals_0_0(Globals_27, Var_200);
                    if (succeeded)
                    {
                      Var_67 = (MR_Integer) 340;
