        ...
        case (MR_Integer) 1:
          {
            ...
            libs__globals__lookup_bool_option_3_p_0(Globals_40, (MR_Integer) 381, &ReclaimHeap_43);
        ...
        case (MR_Integer) 2:
          {
            ...
            libs__globals__lookup_bool_option_3_p_0(Globals_40, (MR_Integer) 382, &ReclaimHeap_43);
    ...
    case (MR_Integer) 0:
      {
        ...
        libs__globals__lookup_int_option_3_p_0(Globals_22, (MR_Integer) 367, &FixedSize_23);
        libs__globals__lookup_int_option_3_p_0(Globals_22, (MR_Integer) 372, &SnapshotSize_24);
    ...
    case (MR_Integer) 0:
      {
        ...
        libs__globals__lookup_int_option_3_p_0(Globals_29, (MR_Integer) 367, &FixedSize_30);
        libs__globals__lookup_int_option_3_p_0(Globals_29, (MR_Integer) 371, &ProtectSize_31);
        libs__globals__lookup_int_option_3_p_0(Globals_29, (MR_Integer) 372, &SnapshotSize_32);
            ...
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                ...
                if (succeeded)
                {
                  ...
                  TypeInfo_202_202 = (MR_Word) (&ll_backend__disj_gen_scalar_common_1[0]);
                  TypeCtorInfo_203_203 = (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0);
                  {
                  ...
                  OutTypes_31 = mercury__list__map_2_f_0(TypeInfo_202_202, TypeCtorInfo_203_203, Var_59, OutVars_29);
                  TypeCtorInfo_206_206 = (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0);
                  Var_60 = parse_tree__set_of_var__to_sorted_list_1_f_0(TypeCtorInfo_206_206, ResumeVars_13);
                  ...
                  ll_backend__code_info__get_globals_2_p_0(STATE_VARIABLE_CI_2_66, &Var_207);
                  succeeded = libs__globals____Unify____globals_0_0(Globals_27, Var_207);
                  if (succeeded)
                  {
                    Var_68 = (MR_Integer) 382;
