      ...
      case (MR_Integer) 2:
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_23, (MR_Integer) 334, &ReclaimHeap_26);
    ...
    case (MR_Integer) 0:
      {
        ...
        libs__globals__lookup_int_option_3_p_0(Globals_22, (MR_Integer) 323, &SnapshotSize_24);
    ...
    case (MR_Integer) 0:
      {
        ...
        libs__globals__lookup_int_option_3_p_0(Globals_29, (MR_Integer) 322, &ProtectSize_31);
        libs__globals__lookup_int_option_3_p_0(Globals_29, (MR_Integer) 323, &SnapshotSize_32);
