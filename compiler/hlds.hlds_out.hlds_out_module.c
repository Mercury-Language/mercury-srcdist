  ...
  MR_Word ModuleInfo_3)
{
  ...
  libs__globals__lookup_accumulating_option_3_p_0(Globals_7, (MR_Integer) 205, &DumpPredIdStrs_8);
  libs__globals__lookup_accumulating_option_3_p_0(Globals_7, (MR_Integer) 206, &DumpPredNames_9);
  libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 208, &DumpSpecPreds0_10);
  libs__globals__lookup_accumulating_option_3_p_0(Globals_7, (MR_Integer) 209, &DumpSpecPredTypeNames_11);
  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      libs__globals__lookup_int_option_3_p_0(Globals_7, (MR_Integer) 212, &InstNumLimit_29);
      libs__globals__lookup_int_option_3_p_0(Globals_7, (MR_Integer) 213, &InstSizeLimit_30);
    ...
    case (MR_Integer) 0:
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_16, (MR_Integer) 207, &NameOrder_17);
        switch (NameOrder_17) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 0:
