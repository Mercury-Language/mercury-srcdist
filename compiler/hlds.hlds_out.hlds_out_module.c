...
static /* final */ const MR_Box hlds__hlds_out__hlds_out_module_scalar_common_6[1][6];
  ...
  MR_Word PredProcId_10)
{
  ...
  Desc_15 = parse_tree__write_error_spec__error_pieces_to_one_line_string_1_f_0(Pieces_14);
    ...
    case (MR_Integer) 3:
      {
        ...
        TypeStr_31 = parse_tree__parse_tree_out_type__mercury_type_to_string_3_f_0(TVarSet_7, (MR_Integer) 1, Type_28);
        switch (IsPoly_29) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 0:
  ...
  MR_Word HeadVar__2_2)
{
  ...
  parse_tree__parse_tree_out_cons_id__mercury_output_cons_id_6_p_0((MR_Integer) 1, (MR_Integer) 1, ConsId_9, Stream_5);
  ...
  parse_tree__parse_tree_out_type__mercury_output_type_6_p_0(Var_34, (MR_Integer) 0, Type_11, Stream_5);
  mercury__io__nl_3_p_0(Stream_5);
  ...
  hlds__hlds_out__hlds_out_mode__mercury_output_structured_inst_8_p_0(Stream_5, (MR_Integer) 1, Var_41, (MR_Integer) 0, (MR_Unsigned) 0U, Inst_12);
  ...
  MR_Word TailConstArgs_8)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      parse_tree__parse_tree_out_cons_id__mercury_output_cons_id_6_p_0((MR_Integer) 1, (MR_Integer) 1, ConsId_11, Stream_6);
      mercury__io__write_string_4_p_0(Stream_6, (MR_String) "\n        with type ");
      Var_29 = mercury__varset__init_0_f_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_tvar_type_0));
      parse_tree__parse_tree_out_type__mercury_output_type_6_p_0(Var_29, (MR_Integer) 0, Type_12, Stream_6);
    }
  ...
  MR_Word Entry_8)
{
  ...
  Var_22 = parse_tree__parse_tree_out_sym_name__escaped_sym_name_to_string_1_f_0(ModuleName_7);
  mercury__io__write_string_4_p_0(Stream_6, (MR_String) ":- ");
  ...
  MR_Word ModuleInfo_6)
{
  ...
  libs__globals__lookup_accumulating_option_3_p_0(Globals_8, (MR_Integer) 196, &DumpPredIdStrs_9);
  libs__globals__lookup_accumulating_option_3_p_0(Globals_8, (MR_Integer) 197, &DumpPredNames_10);
  libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 199, &DumpSpecPreds0_11);
  libs__globals__lookup_accumulating_option_3_p_0(Globals_8, (MR_Integer) 200, &DumpSpecPredTypeNames_12);
  hlds__hlds_module__module_info_get_name_2_p_0(ModuleInfo_6, &ModuleName_81);
  mercury__io__write_string_4_p_0(Stream_5, (MR_String) "% vim: ts=2 sw=2 ft=mercury\n\n");
  Var_87 = parse_tree__parse_tree_out_sym_name__escaped_sym_name_to_string_1_f_0(ModuleName_81);
  ...
  if (!(succeeded))
  {
    ...
    if (succeeded)
    {
      ...
      MR_Word MaybeUseErrorMsgInst_31;
      MR_Integer InstNumLimit_32;
      MR_Integer InstSizeLimit_33;
      ...
      succeeded = mercury__string__contains_char_2_p_0(DumpOptions_19, (MR_Char) 89);
      if (succeeded)
        {
          MaybeUseErrorMsgInst_31 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(1, MaybeUseErrorMsgInst_31, 0) = ((MR_Box) (ModuleInfo_6));
        }
      else
        MaybeUseErrorMsgInst_31 = (MR_Word) ((MR_Unsigned) 0U);
      libs__globals__lookup_int_option_3_p_0(Globals_8, (MR_Integer) 203, &InstNumLimit_32);
      libs__globals__lookup_int_option_3_p_0(Globals_8, (MR_Integer) 204, &InstSizeLimit_33);
      hlds__hlds_out__hlds_out_inst_table__write_inst_table_8_p_0(Stream_5, (MR_Integer) 1, MaybeUseErrorMsgInst_31, InstNumLimit_32, InstSizeLimit_33, InstTable_29);
    ...
    if (succeeded)
    {
      ...
      MR_Word TableStructs_93;
      MR_Word Var_96;
      MR_Box conv1_STATE_VARIABLE_IO_16_97;

      hlds__hlds_module__module_info_get_table_struct_map_2_p_0(ModuleInfo_6, &TableStructMap_34);
      mercury__map__to_assoc_list_2_p_0((MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_proc_id_0), (MR_Word) (&hlds__hlds_module__hlds__hlds_module__type_ctor_info_table_struct_info_0), TableStructMap_34, &TableStructs_93);
      mercury__io__write_string_4_p_0(Stream_5, (MR_String) "%-------- Table structs --------\n");
      {
        ...
        MR_hl_field(0, Var_96, 0) = ((MR_Box) (&hlds__hlds_out__hlds_out_module_scalar_common_8[3]));
        MR_hl_field(0, Var_96, 1) = ((MR_Box) (hlds__hlds_out__hlds_out_module__write_hlds_4_p_0_2));
        MR_hl_field(0, Var_96, 2) = ((MR_Box) ((MR_Integer) 2));
        MR_hl_field(0, Var_96, 3) = ((MR_Box) (Stream_5));
        MR_hl_field(0, Var_96, 4) = ((MR_Box) (ModuleInfo_6));
      }
      mercury__list__foldl_4_p_2((MR_Word) (&hlds__hlds_out__hlds_out_module_scalar_common_2[1]), (MR_Word) (&mercury__io__io__type_ctor_info_state_0), Var_96, TableStructs_93, ((MR_Box) ((MR_Integer) 0)), &conv1_STATE_VARIABLE_IO_16_97);
      mercury__io__nl_3_p_0(Stream_5);
    }
  }
  ...
  if (succeeded)
  {
    ...
    hlds__hlds_module__module_info_get_const_struct_db_2_p_0(ModuleInfo_6, &ConstStructDb_35);
    hlds__hlds_out__hlds_out_module__write_const_struct_db_4_p_0(Stream_5, ConstStructDb_35);
  }
  ...
  if (succeeded)
  {
    ...
    hlds__hlds_module__module_info_get_maybe_dependency_info_2_p_0(ModuleInfo_6, &MaybeDependencyInfo_36);
    if ((MaybeDependencyInfo_36 == (MR_Word) ((MR_Unsigned) 0U)))
      mercury__io__write_string_4_p_0(Stream_5, (MR_String) "% No dependency info\n\n");
    else
    {
      MR_Word DependencyInfo_37 = ((MR_Word) ((MR_hl_field(1, MaybeDependencyInfo_36, (MR_Integer) 0))));

      hlds__hlds_out__hlds_out_module__f_85_110_117_115_101_100_65_114_103_115_95_95_112_114_101_100_95_95_119_114_105_116_101_95_100_101_112_101_110_100_101_110_99_121_95_105_110_102_111_95_95_91_49_93_95_48_6_p_0(Stream_5, ModuleInfo_6, DependencyInfo_37);
    }
  }
    ...
    case (MR_Integer) 0:
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_18, (MR_Integer) 198, &NameOrder_19);
        switch (NameOrder_19) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 0:
    ...
    case (MR_Integer) 1:
      {
        ...
        mercury__map__init_1_p_0((MR_Word) (&hlds__hlds_out__hlds_out_module_scalar_common_3[0]), (MR_Word) (&hlds__hlds_out__hlds_out_module_scalar_common_2[2]), &SpecPredMap0_21);
        {
          ...
          MR_hl_field(0, Var_29, 0) = ((MR_Box) (&hlds__hlds_out__hlds_out_module_scalar_common_5[1]));
  ...
  MR_Word ConstStructDb_6)
{
  ...
  mercury__io__write_string_4_p_0(Stream_5, (MR_String) "%-------- Const structs --------\n\n");
  {
    ...
    MR_hl_field(0, Var_13, 0) = ((MR_Box) (&hlds__hlds_out__hlds_out_module_scalar_common_5[0]));
    MR_hl_field(0, Var_13, 1) = ((MR_Box) (hlds__hlds_out__hlds_out_module__write_const_struct_db_4_p_0_1));
  ...
  MR_Word Module_6)
{
  ...
  Var_15 = parse_tree__parse_tree_out_sym_name__escaped_sym_name_to_string_1_f_0(ModuleName_8);
