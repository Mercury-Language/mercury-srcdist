  ...
  MR_Word * STATE_VARIABLE_State_47)
{
  ...
  libs__globals__lookup_accumulating_option_3_p_0(Globals_6, (MR_Integer) 707, &DumpPredIdStrs_7);
  libs__globals__lookup_accumulating_option_3_p_0(Globals_6, (MR_Integer) 708, &DumpPredNames_8);
  libs__globals__lookup_bool_option_3_p_0(Globals_6, (MR_Integer) 710, &DumpSpecPreds0_9);
  libs__globals__lookup_accumulating_option_3_p_0(Globals_6, (MR_Integer) 711, &DumpSpecPredTypeNames_10);
      ...
      case (MR_Integer) 1:
        {
          ...
          libs__globals__lookup_int_option_3_p_0(Globals_6, (MR_Integer) 714, &InstNumLimit_34);
          libs__globals__lookup_int_option_3_p_0(Globals_6, (MR_Integer) 715, &InstSizeLimit_35);
    ...
    case (MR_Integer) 0:
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_16, (MR_Integer) 709, &NameOrder_17);
        switch (NameOrder_17) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 0:
