...
MR_def_static(hlds__hlds_out__hlds_out_module__write_type_body_7_0)
	...
	MR_sv(11) = ((MR_Integer) MR_tfield(1, MR_tempr1, 6) & (MR_Integer) 1);
	MR_sv(12) = (((MR_Integer) MR_tfield(1, MR_tempr1, 6) >> (MR_Integer) 1) & (MR_Integer) 1);
	MR_sv(13) = MR_tfield(1, MR_tempr1, 7);
	MR_r1 = (MR_Word) MR_string_const(" --->\n", 6);
	}
	MR_np_call_localret_ent(io__write_string_3_0,
...
MR_def_label(hlds__hlds_out__hlds_out_module__write_type_body_7_0,6)
	...
	MR_sv(16) = MR_tfield(1, MR_tempr1, 3);
...
MR_def_label(hlds__hlds_out__hlds_out_module__write_type_body_7_0,25)
	...
	MR_sv(14) = MR_tfield(2, MR_tempr1, 2);
	}
	MR_np_call_localret_ent(hlds__hlds_out__hlds_out_util__write_indent_3_0,
...
MR_def_static(hlds__hlds_out__hlds_out_module__write_user_inst_4_0)
	...
	MR_sv(3) = MR_tfield(0, MR_tfield(0, MR_r2, 0), 0);
	MR_np_call_localret_ent(hlds__hlds_out__hlds_out_util__write_indent_3_0,
