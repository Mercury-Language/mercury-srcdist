...
{
  {
    ...
    libs__globals__lookup_accumulating_option_3_p_0(Globals_8, (MR_Integer) 161, &DumpPredIdStrs_9);
    libs__globals__lookup_accumulating_option_3_p_0(Globals_8, (MR_Integer) 162, &DumpPredNames_10);
    hlds__hlds_out__hlds_out_util__write_indent_3_p_0(Indent_5);
    ...
    if (!(succeeded))
    {
      ...
      if (succeeded)
      {
        ...
        libs__globals__lookup_int_option_3_p_0(Globals_8, (MR_Integer) 166, &InstLimit_24);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_15, (MR_Integer) 163, &NameOrder_16);
    switch (NameOrder_16) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
