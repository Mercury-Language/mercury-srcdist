  ...
  MR_Word ModuleInfo_6)
{
  ...
  libs__globals__lookup_accumulating_option_3_p_0(Globals_8, (MR_Integer) 189, &DumpPredIdStrs_9);
  libs__globals__lookup_accumulating_option_3_p_0(Globals_8, (MR_Integer) 190, &DumpPredNames_10);
  libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 192, &DumpSpecPreds0_11);
  libs__globals__lookup_accumulating_option_3_p_0(Globals_8, (MR_Integer) 193, &DumpSpecPredTypeNames_12);
  ...
  if (!(succeeded))
  {
    ...
    if (succeeded)
    {
      ...
      libs__globals__lookup_int_option_3_p_0(Globals_8, (MR_Integer) 196, &InstLimit_31);
    ...
    case (MR_Integer) 0:
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_18, (MR_Integer) 191, &NameOrder_19);
        switch (NameOrder_19) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 0:
    ...
    case (MR_Integer) 1:
      {
        ...
        mercury__map__init_1_p_0((MR_Word) (&hlds__hlds_out__hlds_out_module_scalar_common_3[0]), (MR_Word) (&hlds__hlds_out__hlds_out_module_scalar_common_2[2]), &SpecPredMap0_21);
        {
          ...
          MR_hl_field(MR_mktag(0), Var_29, 0) = ((MR_Box) (&hlds__hlds_out__hlds_out_module_scalar_common_5[1]));
          MR_hl_field(MR_mktag(0), Var_29, 1) = ((MR_Box) (hlds__hlds_out__hlds_out_module__write_preds_8_p_0_2));
          MR_hl_field(MR_mktag(0), Var_29, 2) = ((MR_Box) ((MR_Integer) 1));
          MR_hl_field(MR_mktag(0), Var_29, 3) = ((MR_Box) (DumpSpecPredTypeNames_12));
        }
