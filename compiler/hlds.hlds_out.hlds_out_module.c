...
{
  {
    ...
    if (!(succeeded))
    {
      ...
      if (succeeded)
      {
        ...
        libs__globals__lookup_int_option_3_p_0(Globals_8, (MR_Integer) 167, &InstLimit_24);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_15, (MR_Integer) 164, &NameOrder_16);
    switch (NameOrder_16) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
