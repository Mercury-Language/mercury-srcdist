...
static void MR_CALL 
hlds__hlds_out__hlds_out_module__IntroducedFrom__pred__write_promise__1524__1_4_p_0(
  MR_Word VarSet_16,
...
{
  {
    ...
    hlds__hlds_out__hlds_out_module__IntroducedFrom__pred__write_promise__1524__1_4_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) (wrapper_arg_1)));
  }
}
...
{
  {
    ...
    libs__globals__lookup_accumulating_option_3_p_0(Globals_8, (MR_Integer) 174, &DumpPredIdStrs_9);
    libs__globals__lookup_accumulating_option_3_p_0(Globals_8, (MR_Integer) 175, &DumpPredNames_10);
    libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 177, &DumpSpecPreds0_11);
    libs__globals__lookup_accumulating_option_3_p_0(Globals_8, (MR_Integer) 178, &DumpSpecPredTypeNames_12);
    hlds__hlds_out__hlds_out_util__write_indent_3_p_0(Indent_5);
    ...
    if (!(succeeded))
    {
      ...
      if (succeeded)
      {
        ...
        libs__globals__lookup_int_option_3_p_0(Globals_8, (MR_Integer) 181, &InstLimit_31);
      ...
      case (MR_Integer) 0:
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_18, (MR_Integer) 176, &NameOrder_19);
          switch (NameOrder_19) {
            default: /*NOTREACHED*/ MR_assert(0);
            case (MR_Integer) 0:
