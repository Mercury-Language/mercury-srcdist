  ...
  MR_Word ModuleInfo_6)
{
  ...
  libs__globals__lookup_accumulating_option_3_p_0(Globals_8, (MR_Integer) 187, &DumpPredIdStrs_9);
  libs__globals__lookup_accumulating_option_3_p_0(Globals_8, (MR_Integer) 188, &DumpPredNames_10);
  libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 190, &DumpSpecPreds0_11);
  libs__globals__lookup_accumulating_option_3_p_0(Globals_8, (MR_Integer) 191, &DumpSpecPredTypeNames_12);
  ...
  if (!(succeeded))
  {
    ...
    if (succeeded)
    {
      ...
      libs__globals__lookup_int_option_3_p_0(Globals_8, (MR_Integer) 194, &InstLimit_31);
    ...
    case (MR_Integer) 0:
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_18, (MR_Integer) 189, &NameOrder_19);
        switch (NameOrder_19) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 0:
