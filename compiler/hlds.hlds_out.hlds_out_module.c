  ...
  MR_Word Entry_8)
{
  ...
  Var_22 = parse_tree__parse_tree_out_sym_name__sym_name_to_escaped_string_1_f_0(ModuleName_7);
  mercury__io__write_string_4_p_0(Stream_6, (MR_String) ":- ");
  ...
  MR_Word ModuleInfo_6)
{
  ...
  libs__globals__lookup_accumulating_option_3_p_0(Globals_8, (MR_Integer) 193, &DumpPredIdStrs_9);
  libs__globals__lookup_accumulating_option_3_p_0(Globals_8, (MR_Integer) 194, &DumpPredNames_10);
  libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 196, &DumpSpecPreds0_11);
  libs__globals__lookup_accumulating_option_3_p_0(Globals_8, (MR_Integer) 197, &DumpSpecPredTypeNames_12);
  ...
  Var_85 = parse_tree__parse_tree_out_sym_name__sym_name_to_escaped_string_1_f_0(ModuleName_79);
  ...
  if (!(succeeded))
  {
    ...
    if (succeeded)
    {
      ...
      libs__globals__lookup_int_option_3_p_0(Globals_8, (MR_Integer) 200, &InstNumLimit_31);
      libs__globals__lookup_int_option_3_p_0(Globals_8, (MR_Integer) 201, &InstSizeLimit_32);
    ...
    case (MR_Integer) 0:
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_18, (MR_Integer) 195, &NameOrder_19);
        switch (NameOrder_19) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 0:
  ...
  MR_Word Module_6)
{
  ...
  Var_15 = parse_tree__parse_tree_out_sym_name__sym_name_to_escaped_string_1_f_0(ModuleName_8);
