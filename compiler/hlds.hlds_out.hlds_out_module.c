  ...
  MR_Word * STATE_VARIABLE_SpecPredMap_19)
{
  ...
  succeeded = ((MR_tag((MR_Word) Origin_10)) == (MR_Integer) 2);
  if (succeeded)
  {
    SpecialPredId_11 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(2), Origin_10, (MR_Integer) 0))) & (MR_Integer) 3);
    TypeCtor_12 = ((MR_Word) ((MR_hl_field(MR_mktag(2), Origin_10, (MR_Integer) 1))));
  ...
  MR_Word ModuleInfo_6)
{
  ...
  hlds__hlds_module__module_info_get_name_2_p_0(ModuleInfo_6, &ModuleName_82);
  mercury__io__write_string_4_p_0(Stream_5, (MR_String) "% vim: ts=2 sw=2 ft=mercury\n\n");
  Var_89 = parse_tree__prog_out__sym_name_to_escaped_string_1_f_0(ModuleName_82);
  mercury__io__write_string_4_p_0(Stream_5, (MR_String) ":- module ");
  mercury__io__write_string_4_p_0(Stream_5, Var_89);
  mercury__io__write_string_4_p_0(Stream_5, (MR_String) ".\n\n");
