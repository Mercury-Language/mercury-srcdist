  ...
  MR_Word ModuleInfo_3)
{
  ...
  libs__globals__lookup_accumulating_option_3_p_0(Globals_7, (MR_Integer) 197, &DumpPredIdStrs_8);
  libs__globals__lookup_accumulating_option_3_p_0(Globals_7, (MR_Integer) 198, &DumpPredNames_9);
  libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 200, &DumpSpecPreds0_10);
  libs__globals__lookup_accumulating_option_3_p_0(Globals_7, (MR_Integer) 201, &DumpSpecPredTypeNames_11);
  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      libs__globals__lookup_int_option_3_p_0(Globals_7, (MR_Integer) 204, &InstNumLimit_29);
      libs__globals__lookup_int_option_3_p_0(Globals_7, (MR_Integer) 205, &InstSizeLimit_30);
    ...
    case (MR_Integer) 0:
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_16, (MR_Integer) 199, &NameOrder_17);
        switch (NameOrder_17) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 0:
