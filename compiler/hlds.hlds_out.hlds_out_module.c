...
{
  {
    ...
    libs__globals__lookup_accumulating_option_3_p_0(Globals_8, (MR_Integer) 170, &DumpPredIdStrs_9);
    libs__globals__lookup_accumulating_option_3_p_0(Globals_8, (MR_Integer) 171, &DumpPredNames_10);
    libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 173, &DumpSpecPreds0_11);
    libs__globals__lookup_accumulating_option_3_p_0(Globals_8, (MR_Integer) 174, &DumpSpecPredTypeNames_12);
    hlds__hlds_out__hlds_out_util__write_indent_3_p_0(Indent_5);
    ...
    if (!(succeeded))
    {
      ...
      if (succeeded)
      {
        ...
        libs__globals__lookup_int_option_3_p_0(Globals_8, (MR_Integer) 177, &InstLimit_31);
      ...
      case (MR_Integer) 0:
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_18, (MR_Integer) 172, &NameOrder_19);
          switch (NameOrder_19) {
            default: /*NOTREACHED*/ MR_assert(0);
            case (MR_Integer) 0:
