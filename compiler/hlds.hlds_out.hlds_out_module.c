  ...
  MR_Word TVarSet_12)
{
  switch (MR_tag((MR_Word) TypeBody_10)) {
    ...
    case (MR_Integer) 1:
      {
        ...
        Var_133 = ((MR_String) (MR_hl_field(MR_mktag(0), Info_8, (MR_Integer) 0)));
        Var_134 = ((MR_String) (MR_hl_field(MR_mktag(0), Info_8, (MR_Integer) 1)));
        Var_135 = ((MR_Word) (MR_hl_field(MR_mktag(0), Info_8, (MR_Integer) 2)));
        Var_136 = ((MR_Word) (MR_hl_field(MR_mktag(0), Info_8, (MR_Integer) 3)));
        ...
        else
        {
          ...
          MR_Word MaybeDirectArgCtors_130 = ((MR_Word) (MR_hl_field(MR_mktag(0), Repn_21, (MR_Integer) 5)));
          ...
          if (!((CheaperTagTest_25 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))))))
          {
            ...
            MR_Word ExpConsId_27 = ((MR_Word) (MR_hl_field(MR_mktag(1), CheaperTagTest_25, (MR_Integer) 0)));
            MR_Word ExpConsTag_28 = ((MR_Word) (MR_hl_field(MR_mktag(1), CheaperTagTest_25, (MR_Integer) 1)));
            MR_Word CheapConsId_29 = ((MR_Word) (MR_hl_field(MR_mktag(1), CheaperTagTest_25, (MR_Integer) 2)));
            MR_Word CheapConsTag_30 = ((MR_Word) (MR_hl_field(MR_mktag(1), CheaperTagTest_25, (MR_Integer) 3)));
            MR_String Var_71;
            MR_String Var_80;
            ...
            Var_71 = parse_tree__prog_out__cons_id_and_arity_to_string_1_f_0(ExpConsId_27);
            mercury__io__write_string_3_p_0(Var_71);
            mercury__io__write_string_3_p_0((MR_String) " tag ");
            TypeCtorInfo_141_141 = (MR_Word) &hlds__hlds_data__hlds__hlds_data__type_ctor_info_cons_tag_0;
            mercury__io__print_3_p_0(TypeCtorInfo_141_141, ((MR_Box) (ExpConsTag_28)));
            mercury__io__nl_2_p_0();
            hlds__hlds_out__hlds_out_util__write_indent_3_p_0(Indent_11);
            mercury__io__write_string_3_p_0((MR_String) "%   to   ");
            Var_80 = parse_tree__prog_out__cons_id_and_arity_to_string_1_f_0(CheapConsId_29);
            mercury__io__write_string_3_p_0(Var_80);
            mercury__io__write_string_3_p_0((MR_String) " tag ");
            mercury__io__print_3_p_0(TypeCtorInfo_141_141, ((MR_Box) (CheapConsTag_30)));
            mercury__io__nl_2_p_0();
          }
          switch (MR_tag((MR_Word) DuTypeKind_26)) {
            ...
            case (MR_Integer) 1:
              {
                MR_Word Lang_31 = ((MR_Word) (MR_hl_field(MR_mktag(1), DuTypeKind_26, (MR_Integer) 0)));
                MR_String Var_109;

                hlds__hlds_out__hlds_out_util__write_indent_3_p_0(Indent_11);
                mercury__io__write_string_3_p_0((MR_String) "% KIND foreign enumeration for ");
                Var_109 = libs__globals__foreign_language_string_1_f_0(Lang_31);
            ...
            case (MR_Integer) 2:
              {
                MR_Word FunctorName_32 = ((MR_Word) (MR_hl_field(MR_mktag(2), DuTypeKind_26, (MR_Integer) 0)));
                MR_Word ArgType_33 = ((MR_Word) (MR_hl_field(MR_mktag(2), DuTypeKind_26, (MR_Integer) 1)));
                MR_Word MaybeArgName_34 = ((MR_Word) (MR_hl_field(MR_mktag(2), DuTypeKind_26, (MR_Integer) 2)));

                hlds__hlds_out__hlds_out_util__write_indent_3_p_0(Indent_11);
                mercury__io__write_string_3_p_0((MR_String) "% KIND notag: ");
                parse_tree__prog_out__write_sym_name_3_p_0(FunctorName_32);
                mercury__io__write_string_3_p_0((MR_String) ", ");
                parse_tree__mercury_to_mercury__mercury_output_type_5_p_0(TVarSet_12, (MR_Integer) 0, ArgType_33);
                mercury__io__write_string_3_p_0((MR_String) ", ");
                if ((MaybeArgName_34 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
                {
                  mercury__io__write_string_3_p_0((MR_String) "no arg name");
                }
                else
                {
                  MR_String ArgName_35 = ((MR_String) (MR_hl_field(MR_mktag(1), MaybeArgName_34, (MR_Integer) 0)));

                  mercury__io__write_string_3_p_0(ArgName_35);
                }
                mercury__io__nl_2_p_0();
              }
              break;
          }
          parse_tree__parse_tree_out__mercury_output_where_attributes_7_p_0(MercInfo_19, TVarSet_12, MaybeSolverTypeDetails_18, MaybeUserEqComp_15, MaybeDirectArgCtors_130);
    ...
    case (MR_Integer) 2:
      {
        MR_Word Type_41 = ((MR_Word) (MR_hl_field(MR_mktag(2), TypeBody_10, (MR_Integer) 0)));

        mercury__io__write_string_3_p_0((MR_String) " == ");
        parse_tree__mercury_to_mercury__mercury_output_type_5_p_0(TVarSet_12, (MR_Integer) 0, Type_41);
        mercury__io__write_string_3_p_0((MR_String) ".\n");
      }
      break;
    case (MR_Integer) 3:
      switch (((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), TypeBody_10, (MR_Integer) 0)))) {
        ...
        case (MR_Integer) 0:
          {
            MR_Word DetailsSolver_44 = ((MR_Word) (MR_hl_field(MR_mktag(3), TypeBody_10, (MR_Integer) 1)));
            MR_Word SolverTypeDetails_45 = ((MR_Word) (MR_hl_field(MR_mktag(0), DetailsSolver_44, (MR_Integer) 0)));
            MR_Word Var_48;
            MR_Word MaybeUserEqComp_131 = ((MR_Word) (MR_hl_field(MR_mktag(0), DetailsSolver_44, (MR_Integer) 1)));
            MR_Word MercInfo_132 = ((MR_Word) (MR_hl_field(MR_mktag(0), Info_8, (MR_Integer) 4)));
            MR_String Var_137 = ((MR_String) (MR_hl_field(MR_mktag(0), Info_8, (MR_Integer) 0)));
            MR_String Var_138 = ((MR_String) (MR_hl_field(MR_mktag(0), Info_8, (MR_Integer) 1)));
            MR_Word Var_139 = ((MR_Word) (MR_hl_field(MR_mktag(0), Info_8, (MR_Integer) 2)));
            MR_Word Var_140 = ((MR_Word) (MR_hl_field(MR_mktag(0), Info_8, (MR_Integer) 3)));

            {
              Var_48 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), Var_48, 0) = ((MR_Box) (SolverTypeDetails_45));
            }
            parse_tree__parse_tree_out__mercury_output_where_attributes_7_p_0(MercInfo_132, TVarSet_12, Var_48, MaybeUserEqComp_131, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)));
            mercury__io__write_string_3_p_0((MR_String) ".\n");
          }
          break;
        case (MR_Integer) 1:
