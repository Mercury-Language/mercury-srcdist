  ...
  MR_Word HeadVar__3_3)
{
  while (MR_TRUE)
  {
    ...
    if (!((HeadVar__3_3 == (MR_Word) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))))))
    {
      ...
      MR_Integer Var_117;
      MR_Word _MaybeFieldName_16 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Arg_13, (MR_Integer) 0))));
      MR_Word _Type_17 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Arg_13, (MR_Integer) 1))));
      MR_Word _Context_19 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Arg_13, (MR_Integer) 3))));
