  ...
  MR_Word * STATE_VARIABLE_State_45)
{
  ...
  libs__globals__lookup_accumulating_option_3_p_0(Globals_6, (MR_Integer) 218, &DumpPredIdStrs_7);
  libs__globals__lookup_accumulating_option_3_p_0(Globals_6, (MR_Integer) 219, &DumpPredNames_8);
  libs__globals__lookup_bool_option_3_p_0(Globals_6, (MR_Integer) 221, &DumpSpecPreds0_9);
  libs__globals__lookup_accumulating_option_3_p_0(Globals_6, (MR_Integer) 222, &DumpSpecPredTypeNames_10);
      ...
      case (MR_Integer) 1:
        {
          ...
          libs__globals__lookup_int_option_3_p_0(Globals_6, (MR_Integer) 225, &InstNumLimit_34);
          libs__globals__lookup_int_option_3_p_0(Globals_6, (MR_Integer) 226, &InstSizeLimit_35);
    ...
    case (MR_Integer) 0:
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_16, (MR_Integer) 220, &NameOrder_17);
        switch (NameOrder_17) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 0:
