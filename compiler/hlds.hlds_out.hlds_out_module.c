  ...
  MR_Word * STATE_VARIABLE_SpecPredMap_19)
{
  ...
  if (succeeded)
  {
    Var_20 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Origin_10, (MR_Integer) 0))));
    succeeded = ((MR_tag((MR_Word) Var_20)) == (MR_Integer) 0);
    if (succeeded)
    {
      SpecialPredId_11 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Var_20, (MR_Integer) 0))) & (MR_Integer) 3);
      TypeCtor_12 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_20, (MR_Integer) 1))));
    }
  }
  if (succeeded)
    if ((DumpSpecPredTypeNames_5 == (MR_Word) ((MR_Unsigned) 0U)))
    {
...

      {
        ...
        MR_hl_field(MR_mktag(0), Var_21, 0) = ((MR_Box) (TypeCtor_12));
        MR_hl_field(MR_mktag(0), Var_21, 1) = ((MR_Box) (SpecialPredId_11));
      }
    ...
    else
    {
      ...
      if (succeeded)
      {
...

        {
          ...
          MR_hl_field(MR_mktag(0), Var_23, 0) = ((MR_Box) (TypeCtor_12));
          MR_hl_field(MR_mktag(0), Var_23, 1) = ((MR_Box) (SpecialPredId_11));
        }
