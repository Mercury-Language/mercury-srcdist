...
{
  {
    ...
    {
      libs__globals__lookup_bool_option_3_p_0(hlds__hlds_out__hlds_out_module__Globals_15, (MR_Integer) 153, &hlds__hlds_out__hlds_out_module__NameOrder_16);
    }
...
{
  {
    ...
    {
      libs__globals__lookup_accumulating_option_3_p_0(hlds__hlds_out__hlds_out_module__Globals_8, (MR_Integer) 151, &hlds__hlds_out__hlds_out_module__DumpPredIdStrs_9);
    }
    {
      libs__globals__lookup_accumulating_option_3_p_0(hlds__hlds_out__hlds_out_module__Globals_8, (MR_Integer) 152, &hlds__hlds_out__hlds_out_module__DumpPredNames_10);
    }
    {
      hlds__hlds_out__hlds_out_util__write_indent_3_p_0(hlds__hlds_out__hlds_out_module__Indent_5);
    }
        ...
        if (hlds__hlds_out__hlds_out_module__succeeded)
          {
            ...
            {
              libs__globals__lookup_int_option_3_p_0(hlds__hlds_out__hlds_out_module__Globals_8, (MR_Integer) 156, &hlds__hlds_out__hlds_out_module__InstLimit_24);
            }
            {
