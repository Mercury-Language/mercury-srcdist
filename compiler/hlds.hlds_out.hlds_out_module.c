  ...
  MR_Word ModuleInfo_6)
{
  ...
  Var_83 = parse_tree__parse_tree_out_sym_name__sym_name_to_escaped_string_1_f_0(ModuleName_77);
  ...
  if (!(succeeded))
  {
    ...
    if (succeeded)
    {
      ...
      libs__globals__lookup_int_option_3_p_0(Globals_8, (MR_Integer) 200, &InstLimit_31);
