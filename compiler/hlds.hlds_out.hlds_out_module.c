  ...
  MR_Word ModuleInfo_6)
{
  ...
  if (!(succeeded))
  {
    ...
    if (succeeded)
    {
      ...
      mercury__io__write_string_4_p_0(Stream_5, (MR_String) "%-------- Table structs --------\n");
      {
        ...
        MR_hl_field(MR_mktag(0), Var_92, 0) = ((MR_Box) (&hlds__hlds_out__hlds_out_module_scalar_common_8[3]));
        MR_hl_field(MR_mktag(0), Var_92, 1) = ((MR_Box) (hlds__hlds_out__hlds_out_module__write_hlds_4_p_0_2));
        MR_hl_field(MR_mktag(0), Var_92, 2) = ((MR_Box) ((MR_Integer) 2));
        MR_hl_field(MR_mktag(0), Var_92, 3) = ((MR_Box) (Stream_5));
        MR_hl_field(MR_mktag(0), Var_92, 4) = ((MR_Box) (ModuleInfo_6));
      }
  ...
  if (succeeded)
  {
    ...
    mercury__io__write_string_4_p_0(Stream_5, (MR_String) "%-------- Const structs --------\n\n");
    {
      ...
      MR_hl_field(MR_mktag(0), Var_101, 0) = ((MR_Box) (&hlds__hlds_out__hlds_out_module_scalar_common_6[1]));
      MR_hl_field(MR_mktag(0), Var_101, 1) = ((MR_Box) (hlds__hlds_out__hlds_out_module__write_hlds_4_p_0_3));
      MR_hl_field(MR_mktag(0), Var_101, 2) = ((MR_Box) ((MR_Integer) 1));
      MR_hl_field(MR_mktag(0), Var_101, 3) = ((MR_Box) (Stream_5));
    }
    ...
    case (MR_Integer) 1:
      {
        ...
        mercury__map__init_1_p_0((MR_Word) (&hlds__hlds_out__hlds_out_module_scalar_common_3[0]), (MR_Word) (&hlds__hlds_out__hlds_out_module_scalar_common_2[2]), &SpecPredMap0_21);
        {
          ...
          MR_hl_field(MR_mktag(0), Var_29, 0) = ((MR_Box) (&hlds__hlds_out__hlds_out_module_scalar_common_6[0]));
