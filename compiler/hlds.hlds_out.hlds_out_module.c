...
static void MR_CALL 
hlds__hlds_out__hlds_out_module__IntroducedFrom__pred__write_promise__1520__1_4_p_0(
  MR_Word VarSet_16,
...
{
  {
    ...
    hlds__hlds_out__hlds_out_module__IntroducedFrom__pred__write_promise__1520__1_4_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) (wrapper_arg_1)));
  }
}
