        ...
        if ((env).ll_backend__stack_opt__use_cell_8_p_0_env_0__succeeded)
        {
          ...
          else
          {
            ...
            if ((env).ll_backend__stack_opt__use_cell_8_p_0_env_0__succeeded)
            {
              ...
              (env).ll_backend__stack_opt__use_cell_8_p_0_env_0__succeeded = (ConsTag_31 == (MR_Word) ((MR_Unsigned) 8U));
              if ((env).ll_backend__stack_opt__use_cell_8_p_0_env_0__succeeded)
...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(0), StackOptParams_49, 2) = (MR_Box) (((((MR_Unsigned) (((MR_Box) (FixpointLoop_43))) << (MR_Integer) 2)) | (((((MR_Unsigned) (((MR_Box) (FullPath_44))) << (MR_Integer) 1)) | (MR_Unsigned) (((MR_Box) (OnStack_45)))))));
