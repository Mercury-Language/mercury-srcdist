  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_34)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 367, &OptNoReturnCalls_16);
  {
  ...
  MR_Integer PredIdInt_13)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_21, (MR_Integer) 367, &OptNoReturnCalls_46);
  {
