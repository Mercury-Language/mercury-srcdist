...
{
  {
    ...
    libs__globals__lookup_int_option_3_p_0(Globals_11, (MR_Integer) 100, &DebugStackOpt_28);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_22, (MR_Integer) 363, &OptNoReturnCalls_47);
    {
    ...
    else
    {
      ...
      backend_libs__interval__record_decisions_in_goal_10_p_0(Goal0_14, &Goal1_58, VarSet0_16, &VarSet_59, VarTypes0_15, &VarTypes_60, Var_89, &RenameMap_61, InsertMap_57, (MR_Word) (MR_mkword(MR_mktag(1), &ll_backend__stack_opt_scalar_common_3[0])));
