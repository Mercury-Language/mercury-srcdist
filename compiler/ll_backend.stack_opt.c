  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_33)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 369, &OptNoReturnCalls_16);
  {
  ...
  MR_Word PredId_13)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_21, (MR_Integer) 369, &OptNoReturnCalls_46);
  {
