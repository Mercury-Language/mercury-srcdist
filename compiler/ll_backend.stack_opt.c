  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_35)
{
  ...
  if (succeeded)
  {
    ...
    hlds__hlds_out__hlds_out_goal__write_goal_nl_12_p_0(OutInfo_75, ProgressStream_7, STATE_VARIABLE_ModuleInfo_38_38, Var_85, (MR_Integer) 1, TVarSet_78, InstVarSet_79, (MR_Integer) 0, (MR_String) "\n", Goal_80);
  }
  ...
  MR_String Message_14)
{
  ...
  if (succeeded)
  {
    ...
    hlds__hlds_out__hlds_out_goal__write_goal_nl_12_p_0(OutInfo_18, ProgressStream_9, ModuleInfo_10, Var_30, (MR_Integer) 1, TVarSet_21, InstVarSet_22, (MR_Integer) 0, (MR_String) "\n", Goal_23);
  }
}
