  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_34)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 365, &OptNoReturnCalls_16);
  {
  ...
  if (succeeded)
  {
    ...
    hlds__hlds_pred__proc_info_get_var_table_2_p_0(STATE_VARIABLE_ProcInfo_46_46, &VarTable_72);
    ...
    case (MR_Integer) 1:
      {
        ...
        if (succeeded)
        {
          ...
          hlds__hlds_pred__proc_info_get_var_table_2_p_0(STATE_VARIABLE_ProcInfo_51_51, &VarTable_88);
  ...
  MR_Integer PredIdInt_13)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_21, (MR_Integer) 365, &OptNoReturnCalls_46);
  {
