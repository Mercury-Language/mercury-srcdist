...
{
  {
    ...
    {
      libs__globals__lookup_bool_option_3_p_0(ll_backend__stack_opt__Globals_14, (MR_Integer) 324, &ll_backend__stack_opt__OptNoReturnCalls_16);
    }
    {
    ...
    {
      libs__globals__lookup_int_option_3_p_0(ll_backend__stack_opt__Globals_14, (MR_Integer) 83, &ll_backend__stack_opt__DebugStackOpt_28);
    }
    {
