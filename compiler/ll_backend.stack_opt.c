...
#line 62 "ll_backend.stack_opt.c"
...
MR_def_label(ll_backend__stack_opt__optimize_live_sets_9_0,49)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_tag_alloc_heap(MR_r2, 0, (MR_Integer) 2);
	MR_tfield(0, MR_r2, 0) = MR_sv(31);
	MR_tfield(0, MR_r2, 1) = MR_sv(33);
	MR_sv(29) = MR_r1;
...
MR_def_label(fn__ll_backend__stack_opt__anchor_requires_close_2_0,17)
	...
	MR_r2 = (MR_Word) &MR_tfield(0, (MR_Word *) &mercury_vector_common_4_1, (MR_Integer) MR_tempr1);
