...
top_of_proc_1:;
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        Var_82 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_AllPaths_0_28, (MR_Integer) 0))));
        Var_83 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_AllPaths_0_28, (MR_Integer) 1))) & (MR_Integer) 1);
        {
          STATE_VARIABLE_AllPaths_29 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), STATE_VARIABLE_AllPaths_29, 0) = ((MR_Box) (Var_82));
          MR_hl_field(MR_mktag(0), STATE_VARIABLE_AllPaths_29, 1) = (MR_Box) ((MR_Unsigned) (Var_83));
      ...
      else
      {
        ...
        if (succeeded)
        {
          MR_Word Var_104 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_AllPaths_0_28, (MR_Integer) 0))));
          MR_Word Var_105 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_AllPaths_0_28, (MR_Integer) 1))) & (MR_Integer) 1);

          {
            STATE_VARIABLE_AllPaths_29 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
            MR_hl_field(MR_mktag(0), STATE_VARIABLE_AllPaths_29, 0) = ((MR_Box) (Var_104));
            MR_hl_field(MR_mktag(0), STATE_VARIABLE_AllPaths_29, 1) = (MR_Box) ((MR_Unsigned) (Var_105));
...
top_of_proc_2:;
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        MR_Word SuccessorId_185;
        MR_Word MoreSuccessorIds_186;
        MR_Word STATE_VARIABLE_AllPaths_24_190;
        MR_Word SuccessorId_202;
        MR_Word MoreSuccessorIds_203;
        MR_Word STATE_VARIABLE_AllPaths_24_207;
        MR_Word ElseStartIdPrime_25;
        MR_Word CondStartIdPrime_26;
        MR_Word Var_47;
        MR_Word Var_48;
        MR_Box conv5_SuccessorId_185;
        ...
        mercury__map__lookup_3_p_0((MR_Word) (&mdbcomp__goal_path__mdbcomp__goal_path__type_ctor_info_goal_id_0), (MR_Word) (&backend_libs__interval__backend_libs__interval__type_ctor_info_interval_id_0), CondEndMap_31, ((MR_Box) (EndGoalId_79)), &conv5_SuccessorId_185);
        SuccessorId_185 = ((MR_Word) (conv5_SuccessorId_185));
        {
          MoreSuccessorIds_186 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), MoreSuccessorIds_186, 0) = ((MR_Box) (ElseStartId_27));
          MR_hl_field(MR_mktag(1), MoreSuccessorIds_186, 1) = ((MR_Box) ((MR_Unsigned) 0U));
        }
        ll_backend__stack_opt__apply_interval_find_all_branches_7_p_0(RelevantVars_10, MaybeSearchAnchorEnd_30, IntervalInfo_12, StackOptInfo_13, SuccessorId_185, STATE_VARIABLE_AllPaths_52_52, &STATE_VARIABLE_AllPaths_24_190);
        SuccessorId_202 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MoreSuccessorIds_186, (MR_Integer) 0))));
        MoreSuccessorIds_203 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MoreSuccessorIds_186, (MR_Integer) 1))));
        ll_backend__stack_opt__apply_interval_find_all_branches_7_p_0(RelevantVars_10, MaybeSearchAnchorEnd_30, IntervalInfo_12, StackOptInfo_13, SuccessorId_202, STATE_VARIABLE_AllPaths_24_190, &STATE_VARIABLE_AllPaths_24_207);
        ll_backend__stack_opt__one_after_another_7_p_0(RelevantVars_10, MaybeSearchAnchorEnd_30, IntervalInfo_12, StackOptInfo_13, MoreSuccessorIds_203, STATE_VARIABLE_AllPaths_24_207, &STATE_VARIABLE_AllPaths_56_56);
