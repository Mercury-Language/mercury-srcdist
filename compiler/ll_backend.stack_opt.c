  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_35)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_13, (MR_Integer) 382, &OptNoReturnCalls_18);
  {
  ...
  libs__globals__lookup_int_option_3_p_0(Globals_13, (MR_Integer) 118, &DebugStackOpt_29);
  ...
  MR_Word PredId_13)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_21, (MR_Integer) 382, &OptNoReturnCalls_46);
  {
