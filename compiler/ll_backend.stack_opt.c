                ...
                case (MR_Integer) 0:
                  {
                    ...
                    MR_Unsigned packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), StackOptParams_16, (MR_Integer) 2)));
  ...
  top_of_proc_2:;
    {
      ...
      packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), StackOptParams_19, (MR_Integer) 2)));
