...
top_of_proc_2:;
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        MR_Word SuccessorId_205;
        MR_Word MoreSuccessorIds_206;
        MR_Word STATE_VARIABLE_AllPaths_24_210;
        ...
        SuccessorId_205 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MoreSuccessorIds_189, (MR_Integer) 0))));
        MoreSuccessorIds_206 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MoreSuccessorIds_189, (MR_Integer) 1))));
        ll_backend__stack_opt__apply_interval_find_all_branches_7_p_0(RelevantVars_10, MaybeSearchAnchorEnd_30, IntervalInfo_12, StackOptInfo_13, SuccessorId_205, STATE_VARIABLE_AllPaths_24_193, &STATE_VARIABLE_AllPaths_24_210);
        ll_backend__stack_opt__one_after_another_7_p_0(RelevantVars_10, MaybeSearchAnchorEnd_30, IntervalInfo_12, StackOptInfo_13, MoreSuccessorIds_206, STATE_VARIABLE_AllPaths_24_210, &STATE_VARIABLE_AllPaths_56_56);
