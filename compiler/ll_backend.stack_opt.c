...
{
  {
    ...
    libs__globals__lookup_int_option_3_p_0(Globals_11, (MR_Integer) 98, &DebugStackOpt_28);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_22, (MR_Integer) 360, &OptNoReturnCalls_47);
    {
