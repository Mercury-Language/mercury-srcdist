...
{
  MR_bool succeeded;
  MR_Word ClassProc_12 = ((MR_Word) ((MR_hl_field(0, ClassMethodInfo_6, 3))));
  MR_Word PredId_13 = ((MR_Word) ((MR_hl_field(0, ClassProc_12, 0))));
  MR_Integer ProcId_14 = ((MR_Integer) ((MR_hl_field(0, ClassProc_12, 1))));
  ...
  succeeded = mercury__map__search_3_p_0((MR_Word) (&hlds__pred_proc_id__hlds__pred_proc_id__type_ctor_info_proc_id_0), (MR_Word) (&hlds__hlds_proc__hlds__hlds_proc__type_ctor_info_proc_info_0), ProcTable0_16, ((MR_Box) (ProcId_14)), &conv0_ProcInfo0_17);
  if (succeeded)
  {
  ...
  if (succeeded)
  {
    ...
    MR_Word PredInfo_48;
    MR_Word STATE_VARIABLE_ModuleInfo_1_56;
    MR_Word Var_59;
    MR_Word Var_60;
    MR_Word Var_61;
    MR_Word Head_19;
    ...
    Var_53 = ((MR_Word) ((MR_hl_field(0, ClassContext_18, 0))));
    succeeded = (Var_53 != (MR_Word) ((MR_Unsigned) 0U));
    if (succeeded)
    {
      Head_19 = ((MR_Word) ((MR_hl_field(1, Var_53, 0))));
    ...
    hlds__hlds_proc__proc_info_get_rtti_varmaps_2_p_0(ProcInfo0_17, &RttiVarMaps_23);
    hlds__hlds_rtti__rtti_lookup_typeclass_info_var_3_p_0(RttiVarMaps_23, InstanceConstraint_22, &TypeClassInfoVar_24);
    hlds__hlds_proc__proc_info_get_headvars_2_p_0(ProcInfo0_17, &HeadVars0_25);
    hlds__hlds_proc__proc_info_get_argmodes_2_p_0(ProcInfo0_17, &Modes0_26);
    hlds__hlds_proc__proc_info_get_declared_determinism_2_p_0(ProcInfo0_17, &MaybeDetism0_27);
    if ((MaybeDetism0_27 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      Detism_28 = (MR_Integer) 3;
      hlds__hlds_module__module_info_make_pred_id_invalid_3_p_0(PredId_13, STATE_VARIABLE_ModuleInfo_0_51, &STATE_VARIABLE_ModuleInfo_1_56);
    }
    else
    {
      Detism_28 = ((MR_Word) ((MR_hl_field(1, MaybeDetism0_27, 0))));
      STATE_VARIABLE_ModuleInfo_1_56 = STATE_VARIABLE_ModuleInfo_0_51;
    }
    ...
    ClassName_34 = ((MR_Word) ((MR_hl_field(0, InstanceConstraint_22, 0))));
    InstanceArgs_35 = ((MR_Word) ((MR_hl_field(0, InstanceConstraint_22, 1))));
    ...
    hlds__hlds_pred__pred_info_get_pf_sym_name_pred_form_arity_2_p_0(PredInfo0_15, &PFSymNameArity_37);
    ...
    hlds__instmap__instmap_delta_from_mode_list_4_p_0(STATE_VARIABLE_ModuleInfo_1_56, HeadVars0_25, Modes0_26, &InstmapDelta_40);
    ...
    hlds__hlds_proc__proc_info_set_goal_3_p_0(BodyGoal_44, ProcInfo0_17, &ProcInfo_45);
    mercury__map__det_update_4_p_0((MR_Word) (&hlds__pred_proc_id__hlds__pred_proc_id__type_ctor_info_proc_id_0), (MR_Word) (&hlds__hlds_proc__hlds__hlds_proc__type_ctor_info_proc_info_0), ((MR_Box) (ProcId_14)), ((MR_Box) (ProcInfo_45)), ProcTable0_16, &ProcTable_46);
    ...
    hlds__hlds_module__module_info_set_pred_info_4_p_0(PredId_13, PredInfo_48, STATE_VARIABLE_ModuleInfo_1_56, STATE_VARIABLE_ModuleInfo_52);
  }
  else
...
check_hlds__polymorphism_post_copy__expand_class_method_bodies_in_defn_3_p_0(
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_9)
{
  MR_Word MethodInfos_6 = ((MR_Word) ((MR_hl_field(0, ClassDefn_4, 8))));
  MR_Box conv3_Var_7;
...
{
  MR_bool succeeded;
  MR_Word Var_7 = ((MR_Word) ((MR_hl_field(0, ClassId_4, 0))));
  MR_Word Var_8;

  succeeded = ((MR_tag((MR_Word) Var_7)) == (MR_Integer) 1);
  if (succeeded)
  {
    Var_8 = ((MR_Word) ((MR_hl_field(1, Var_7, 0))));
  ...
  MR_Box wrapper_arg_1)
{
  ...
  succeeded = check_hlds__polymorphism_post_copy__class_id_is_from_given_module_2_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) (wrapper_arg_1)));
  return succeeded;
}
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_15)
{
  ...
  MR_Word STATE_VARIABLE_ModuleInfo_1_17;
  MR_Box conv1_STATE_VARIABLE_ModuleInfo_1_17;
  MR_Box conv3_STATE_VARIABLE_ModuleInfo_15;

  mercury__list__foldl_4_p_0((MR_Word) (&hlds__pred_proc_id__hlds__pred_proc_id__type_ctor_info_pred_id_0), (MR_Word) (&hlds__hlds_module__hlds__hlds_module__type_ctor_info_module_info_0), (MR_Word) (&check_hlds__polymorphism_post_copy_scalar_common_3[0]), ExistsCastPredIds_4, ((MR_Box) (STATE_VARIABLE_ModuleInfo_0_14)), &conv1_STATE_VARIABLE_ModuleInfo_1_17);
  STATE_VARIABLE_ModuleInfo_1_17 = ((MR_Word) (conv1_STATE_VARIABLE_ModuleInfo_1_17));
  hlds__hlds_module__module_info_get_class_table_2_p_0(STATE_VARIABLE_ModuleInfo_1_17, &ClassMap_6);
  hlds__hlds_module__module_info_get_name_2_p_0(STATE_VARIABLE_ModuleInfo_1_17, &ModuleName_7);
  ...
  hlds__hlds_module__module_info_get_globals_2_p_0(STATE_VARIABLE_ModuleInfo_1_17, &Globals_9);
  libs__globals__get_opt_tuple_2_p_0(Globals_9, &OptTuple_10);
  UserTypeSpec_11 = ((((MR_Unsigned) ((MR_hl_field(0, OptTuple_10, 0))) >> 1)) & (MR_Integer) 1);
