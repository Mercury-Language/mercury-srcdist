...
{
  MR_bool succeeded;
  MR_Word PredId_9 = ((MR_Word) ((MR_hl_field(0, ClassProc_6, (MR_Integer) 0))));
  MR_Integer ProcId_10 = ((MR_Integer) ((MR_hl_field(0, ClassProc_6, (MR_Integer) 1))));
  ...
  if (succeeded)
  {
    ...
    Var_49 = ((MR_Word) ((MR_hl_field(0, ClassContext_14, (MR_Integer) 0))));
    succeeded = (Var_49 != (MR_Word) ((MR_Unsigned) 0U));
    if (succeeded)
    {
      Head_15 = ((MR_Word) ((MR_hl_field(1, Var_49, (MR_Integer) 0))));
    ...
    {
      Detism_24 = ((MR_Word) ((MR_hl_field(1, MaybeDetism0_23, (MR_Integer) 0))));
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        succeeded = mercury__list__delete_nth_3_p_0(TypeCtorInfo_66_66, Modes0_22, N_25, &ModesPrime_27);
      }
    }
    if (succeeded)
    {
    ...
    ClassName_30 = ((MR_Word) ((MR_hl_field(0, InstanceConstraint_18, (MR_Integer) 0))));
    InstanceArgs_31 = ((MR_Word) ((MR_hl_field(0, InstanceConstraint_18, (MR_Integer) 1))));
    ...
    hlds__hlds_pred__pred_info_get_pf_sym_name_arity_2_p_0(PredInfo0_11, &PFSymNameArity_33);
    {
      ...
      MR_hl_field(0, Var_56, 0) = ((MR_Box) (ClassName_30));
      MR_hl_field(0, Var_56, 1) = ((MR_Box) (InstanceArity_32));
    }
    {
      Var_55 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(1, Var_55, 0) = ((MR_Box) (TypeClassInfoVar_20));
      MR_hl_field(1, Var_55, 1) = ((MR_Box) (STATE_VARIABLE_ProcNum_0_45));
      MR_hl_field(1, Var_55, 2) = ((MR_Box) (Var_56));
      MR_hl_field(1, Var_55, 3) = ((MR_Box) (PFSymNameArity_33));
    }
    {
      BodyGoalExpr_34 = (MR_Word) MR_mkword(3, MR_new_object(MR_Word, (6 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(3, BodyGoalExpr_34, 0) = ((MR_Box) ((MR_Unsigned) 0U));
      MR_hl_field(3, BodyGoalExpr_34, 1) = ((MR_Box) (Var_55));
      MR_hl_field(3, BodyGoalExpr_34, 2) = ((MR_Box) (HeadVars_28));
      MR_hl_field(3, BodyGoalExpr_34, 3) = ((MR_Box) (Modes_29));
      MR_hl_field(3, BodyGoalExpr_34, 4) = ((MR_Box) ((MR_Unsigned) 0U));
      MR_hl_field(3, BodyGoalExpr_34, 5) = (MR_Box) ((MR_Unsigned) (Detism_24));
    }
    ...
    hlds__hlds_goal__goal_info_init_6_p_0(NonLocals_35, InstmapDelta_36, Detism_24, Purity_37, Context_38, &GoalInfo_39);
    {
      ...
      MR_hl_field(0, BodyGoal_40, 0) = ((MR_Box) (BodyGoalExpr_34));
      MR_hl_field(0, BodyGoal_40, 1) = ((MR_Box) (GoalInfo_39));
    }
...
check_hlds__polymorphism_post_copy__expand_class_method_bodies_in_defn_3_p_0(
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_9)
{
  MR_Word MethodPredProcIds_6 = ((MR_Word) ((MR_hl_field(0, ClassDefn_4, (MR_Integer) 7))));
  MR_Box conv3_Var_7;
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_15)
{
  ...
  UserTypeSpec_11 = ((((MR_Unsigned) ((MR_hl_field(0, OptTuple_10, (MR_Integer) 0))) >> 1)) & (MR_Integer) 1);
