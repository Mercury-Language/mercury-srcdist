...
check_hlds__polymorphism_post_copy__expand_class_method_body_5_p_0(
  MR_Word ClassProc_6,
  MR_Integer STATE_VARIABLE_ProcNum_0_45,
  MR_Integer * STATE_VARIABLE_ProcNum_46,
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_48)
{
  ...
  hlds__hlds_module__module_info_pred_info_3_p_0(STATE_VARIABLE_ModuleInfo_0_47, PredId_9, &PredInfo0_11);
  hlds__hlds_pred__pred_info_get_proc_table_2_p_0(PredInfo0_11, &ProcTable0_12);
  succeeded = mercury__map__search_3_p_0((MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_proc_id_0), (MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_proc_info_0), ProcTable0_12, ((MR_Box) (ProcId_10)), &conv0_ProcInfo0_13);
  if (succeeded)
  {
  ...
  if (succeeded)
  {
    MR_Word ClassContext_14;
    MR_Word InstanceConstraint_18;
    MR_Word RttiVarMaps_19;
    MR_Word TypeClassInfoVar_20;
    MR_Word HeadVars0_21;
    MR_Word Modes0_22;
    MR_Word MaybeDetism0_23;
    MR_Word Detism_24;
    MR_Word HeadVars_28;
    MR_Word Modes_29;
    MR_Word ClassName_30;
    MR_Word InstanceArgs_31;
    MR_Integer InstanceArity_32;
    MR_Word PFSymNameArity_33;
    MR_Word BodyGoalExpr_34;
    ...
    MR_Word Head_15;
    MR_Word Var_49;
    MR_Word HeadVarsPrime_26;
    MR_Word ModesPrime_27;
    MR_Word TypeCtorInfo__66_66;
    MR_Integer N_25;

    hlds__hlds_pred__pred_info_get_class_context_2_p_0(PredInfo0_11, &ClassContext_14);
    Var_49 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ClassContext_14, (MR_Integer) 0))));
    succeeded = (Var_49 != (MR_Word) ((MR_Unsigned) 0U));
    if (succeeded)
    {
      Head_15 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Var_49, (MR_Integer) 0))));
      InstanceConstraint_18 = Head_15;
    }
    else
      {
    ...
    hlds__hlds_pred__proc_info_get_rtti_varmaps_2_p_0(ProcInfo0_13, &RttiVarMaps_19);
    hlds__hlds_rtti__rtti_lookup_typeclass_info_var_3_p_0(RttiVarMaps_19, InstanceConstraint_18, &TypeClassInfoVar_20);
    hlds__hlds_pred__proc_info_get_headvars_2_p_0(ProcInfo0_13, &HeadVars0_21);
    hlds__hlds_pred__proc_info_get_argmodes_2_p_0(ProcInfo0_13, &Modes0_22);
    hlds__hlds_pred__proc_info_get_declared_determinism_2_p_0(ProcInfo0_13, &MaybeDetism0_23);
    if ((MaybeDetism0_23 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      Detism_24 = (MR_Integer) 3;
      hlds__hlds_module__module_info_make_pred_id_invalid_3_p_0(PredId_9, STATE_VARIABLE_ModuleInfo_0_47, &STATE_VARIABLE_ModuleInfo_52_52);
    }
    else
    {
      Detism_24 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MaybeDetism0_23, (MR_Integer) 0))));
      STATE_VARIABLE_ModuleInfo_52_52 = STATE_VARIABLE_ModuleInfo_0_47;
    }
    succeeded = mercury__list__index1_of_first_occurrence_3_p_0((MR_Word) (&check_hlds__polymorphism_post_copy_scalar_common_1[0]), HeadVars0_21, ((MR_Box) (TypeClassInfoVar_20)), &N_25);
    if (succeeded)
    {
      succeeded = mercury__list__delete_nth_3_p_0((MR_Word) (&check_hlds__polymorphism_post_copy_scalar_common_1[0]), HeadVars0_21, N_25, &HeadVarsPrime_26);
      if (succeeded)
      {
        TypeCtorInfo__66_66 = (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_mode_0);
        succeeded = mercury__list__delete_nth_3_p_0(TypeCtorInfo__66_66, Modes0_22, N_25, &ModesPrime_27);
      }
    }
    if (succeeded)
    {
      HeadVars_28 = HeadVarsPrime_26;
      Modes_29 = ModesPrime_27;
    }
    else
      {
    ...
    ClassName_30 = ((MR_Word) ((MR_hl_field(MR_mktag(0), InstanceConstraint_18, (MR_Integer) 0))));
    InstanceArgs_31 = ((MR_Word) ((MR_hl_field(MR_mktag(0), InstanceConstraint_18, (MR_Integer) 1))));
    mercury__list__length_2_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0), InstanceArgs_31, &InstanceArity_32);
    hlds__hlds_pred__pred_info_get_pf_sym_name_arity_2_p_0(PredInfo0_11, &PFSymNameArity_33);
    {
      Var_56 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), Var_56, 0) = ((MR_Box) (ClassName_30));
      MR_hl_field(MR_mktag(0), Var_56, 1) = ((MR_Box) (InstanceArity_32));
    }
    {
      Var_55 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), Var_55, 0) = ((MR_Box) (TypeClassInfoVar_20));
      MR_hl_field(MR_mktag(1), Var_55, 1) = ((MR_Box) (STATE_VARIABLE_ProcNum_0_45));
      MR_hl_field(MR_mktag(1), Var_55, 2) = ((MR_Box) (Var_56));
      MR_hl_field(MR_mktag(1), Var_55, 3) = ((MR_Box) (PFSymNameArity_33));
    }
    {
      BodyGoalExpr_34 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (6 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(3), BodyGoalExpr_34, 0) = ((MR_Box) ((MR_Unsigned) 0U));
      MR_hl_field(MR_mktag(3), BodyGoalExpr_34, 1) = ((MR_Box) (Var_55));
      MR_hl_field(MR_mktag(3), BodyGoalExpr_34, 2) = ((MR_Box) (HeadVars_28));
      MR_hl_field(MR_mktag(3), BodyGoalExpr_34, 3) = ((MR_Box) (Modes_29));
      MR_hl_field(MR_mktag(3), BodyGoalExpr_34, 4) = ((MR_Box) ((MR_Unsigned) 0U));
      MR_hl_field(MR_mktag(3), BodyGoalExpr_34, 5) = (MR_Box) ((MR_Unsigned) (Detism_24));
    }
    parse_tree__set_of_var__list_to_set_2_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), HeadVars0_21, &NonLocals_35);
    hlds__instmap__instmap_delta_from_mode_list_4_p_0(STATE_VARIABLE_ModuleInfo_52_52, HeadVars0_21, Modes0_22, &InstmapDelta_36);
    hlds__hlds_pred__pred_info_get_purity_2_p_0(PredInfo0_11, &Purity_37);
    hlds__hlds_pred__pred_info_get_context_2_p_0(PredInfo0_11, &Context_38);
    hlds__hlds_goal__goal_info_init_6_p_0(NonLocals_35, InstmapDelta_36, Detism_24, Purity_37, Context_38, &GoalInfo_39);
    {
      BodyGoal_40 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), BodyGoal_40, 0) = ((MR_Box) (BodyGoalExpr_34));
      MR_hl_field(MR_mktag(0), BodyGoal_40, 1) = ((MR_Box) (GoalInfo_39));
    }
    hlds__hlds_pred__proc_info_set_goal_3_p_0(BodyGoal_40, ProcInfo0_13, &ProcInfo_41);
    mercury__map__det_update_4_p_0((MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_proc_id_0), (MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_proc_info_0), ((MR_Box) (ProcId_10)), ((MR_Box) (ProcInfo_41)), ProcTable0_12, &ProcTable_42);
    hlds__hlds_pred__pred_info_set_proc_table_3_p_0(ProcTable_42, PredInfo0_11, &PredInfo1_43);
    succeeded = hlds__hlds_pred__pred_info_is_imported_1_p_0(PredInfo1_43);
    if (succeeded)
      hlds__hlds_pred__pred_info_set_status_3_p_0((MR_Word) (((MR_Box) ((MR_Unsigned) 0U))), PredInfo1_43, &PredInfo_44);
    else
      PredInfo_44 = PredInfo1_43;
    hlds__hlds_module__module_info_set_pred_info_4_p_0(PredId_9, PredInfo_44, STATE_VARIABLE_ModuleInfo_52_52, STATE_VARIABLE_ModuleInfo_48);
  }
  else
    *STATE_VARIABLE_ModuleInfo_48 = STATE_VARIABLE_ModuleInfo_0_47;
  *STATE_VARIABLE_ProcNum_46 = (MR_Integer) ((MR_Unsigned) STATE_VARIABLE_ProcNum_0_45 + (MR_Unsigned) 1);
}
  ...
  MR_Box * wrapper_arg_5)
{
  ...
  MR_Integer conv1_STATE_VARIABLE_ProcNum_46;
  MR_Word conv0_STATE_VARIABLE_ModuleInfo_48;

  check_hlds__polymorphism_post_copy__expand_class_method_body_5_p_0(((MR_Word) (wrapper_arg_1)), ((MR_Integer) (wrapper_arg_2)), &conv1_STATE_VARIABLE_ProcNum_46, ((MR_Word) (wrapper_arg_4)), &conv0_STATE_VARIABLE_ModuleInfo_48);
  *wrapper_arg_3 = ((MR_Box) (conv1_STATE_VARIABLE_ProcNum_46));
  *wrapper_arg_5 = ((MR_Box) (conv0_STATE_VARIABLE_ModuleInfo_48));
}
...
check_hlds__polymorphism_post_copy__expand_class_method_bodies_in_defn_3_p_0(
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_9)
{
  MR_Word MethodPredProcIds_6 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ClassDefn_4, (MR_Integer) 7))));
  MR_Box conv3_Var_7;
  MR_Box conv2_STATE_VARIABLE_ModuleInfo_9;

  mercury__list__foldl2_6_p_0((MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_proc_id_0), (MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0), (MR_Word) (&hlds__hlds_module__hlds__hlds_module__type_ctor_info_module_info_0), (MR_Word) (&check_hlds__polymorphism_post_copy_scalar_common_3[2]), MethodPredProcIds_6, ((MR_Box) ((MR_Integer) 1)), &conv3_Var_7, ((MR_Box) (STATE_VARIABLE_ModuleInfo_0_8)), &conv2_STATE_VARIABLE_ModuleInfo_9);
