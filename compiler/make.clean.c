  ...
  MR_Box * wrapper_arg_5)
{
  ...
  backend_libs__link_target_util__linked_target_file_name_full_curdir_7_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) ((MR_hl_field(0, closure, 4)))), ((MR_Word) (wrapper_arg_1)), &conv1_HeadVar__4_4, &conv0_HeadVar__5_5);
