...
parse_tree.prog_util.optdate parse_tree.prog_util.trans_opt_date prog_util.err parse_tree.prog_util.c_date parse_tree.prog_util.s_date parse_tree.prog_util.pic_s_date parse_tree.prog_util.il_date parse_tree.prog_util.java_date : prog_util.m \
	parse_tree.int0 \
	bool.int \
	builtin.int \
	int.int \
...
ifeq ($(TARGET_ASM),yes)
parse_tree.prog_util.mh parse_tree.prog_util.mih : parse_tree.prog_util.s
else
parse_tree.prog_util.mh parse_tree.prog_util.mih : parse_tree.prog_util.c
endif

ifeq ($(TARGET_ASM),yes)
parse_tree.prog_util.module_dep : parse_tree.prog_util.s
else
 ifeq ($(findstring il,$(GRADE)),il)
parse_tree.prog_util.module_dep : parse_tree.prog_util.il
  ifeq ($(findstring java,$(GRADE)),java)
parse_tree.prog_util.module_dep : mercury/parse_tree_/prog_util.java
  else
...
ifeq ($(TARGET_ASM),yes)
parse_tree.prog_util.s_date : prog_util.m
	$(MCG) $(ALL_GRADEFLAGS) $(ALL_MCGFLAGS) --target-code-only parse_tree.prog_util $(ERR_REDIRECT)
parse_tree.prog_util.pic_s_date : prog_util.m
	$(MCG) $(ALL_GRADEFLAGS) $(ALL_MCGFLAGS) --target-code-only --pic \
		--cflags "$(GCCFLAGS_FOR_PIC)" parse_tree.prog_util $(ERR_REDIRECT)
endif # TARGET_ASM
parse_tree.prog_util.il_date : prog_util.m
	$(MCG) $(ALL_GRADEFLAGS) $(ALL_MCGFLAGS) --il-only parse_tree.prog_util $(ERR_REDIRECT)
