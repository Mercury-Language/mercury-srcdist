  ...
  MR_Word * STATE_VARIABLE_ProcInfo_20)
{
  ...
  hlds__hlds_pred__proc_info_get_var_table_2_p_0(STATE_VARIABLE_ProcInfo_0_19, &VarTable_13);
  ...
  hlds__hlds_pred__proc_info_get_initial_instmap_3_p_0(ModuleInfo_5, STATE_VARIABLE_ProcInfo_0_19, &InstMap0_15);
  {
    ...
    MR_hl_field(0, DelayInfo_16, 0) = ((MR_Box) (ModuleInfo_5));
    MR_hl_field(0, DelayInfo_16, 1) = (MR_Box) ((MR_Unsigned) (BodyTypeinfoLiveness_12));
    MR_hl_field(0, DelayInfo_16, 2) = ((MR_Box) (VarTable_13));
    MR_hl_field(0, DelayInfo_16, 3) = ((MR_Box) (RttiVarMaps_14));
  }
