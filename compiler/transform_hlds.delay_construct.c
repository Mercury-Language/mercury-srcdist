    ...
    else
    {
      ...
      else
      {
        ...
        else
        {
          ...
          mercury__builtin__compare_3_p_0((MR_Word) &transform_hlds__delay_construct_scalar_common_2[0], &Var_14, ((MR_Box) (ArgX3_8)), ((MR_Box) (ArgY3_9)));
...
{
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          TypeInfo_14_14 = (MR_Word) &transform_hlds__delay_construct_scalar_common_2[0];
...
{
  {
    ...
    hlds__passes_aux__write_proc_progress_message_6_p_0((MR_String) "% Delaying construction unifications in ", PredId_6, ProcId_7, ModuleInfo_5);
    ...
    hlds__hlds_pred__proc_info_get_vartypes_2_p_0(STATE_VARIABLE_ProcInfo_0_19, &VarTypes_13);
    hlds__hlds_pred__proc_info_get_rtti_varmaps_2_p_0(STATE_VARIABLE_ProcInfo_0_19, &RttiVarMaps_14);
    hlds__hlds_pred__proc_info_get_initial_instmap_3_p_0(STATE_VARIABLE_ProcInfo_0_19, ModuleInfo_5, &InstMap0_15);
    {
      DelayInfo_16 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), DelayInfo_16, 0) = ((MR_Box) (ModuleInfo_5));
      MR_hl_field(MR_mktag(0), DelayInfo_16, 1) = ((MR_Box) (BodyTypeinfoLiveness_12));
      MR_hl_field(MR_mktag(0), DelayInfo_16, 2) = ((MR_Box) (VarTypes_13));
...
{
  {
    ...
    switch (MR_tag((MR_Word) GoalExpr0_9)) {
      ...
      case (MR_Integer) 0:
        {
          MR_Word NegGoal0_18 = (MR_Word) MR_body(((MR_Word) GoalExpr0_9), (MR_Integer) 0);
          MR_Word NegGoal_19;
          MR_Word Var_69;

          transform_hlds__delay_construct__delay_construct_in_goal_4_p_0(NegGoal0_18, InstMap0_6, DelayInfo_7, &NegGoal_19);
          Var_69 = (MR_Word) MR_mkword(MR_mktag(0), (MR_Word) NegGoal_19);
          {
            MR_Word base;
      ...
      case (MR_Integer) 3:
        switch (((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), GoalExpr0_9, (MR_Integer) 0)))) {
          ...
          case (MR_Integer) 2:
            {
              MR_Word ConjType_11 = ((MR_Word) (MR_hl_field(MR_mktag(3), GoalExpr0_9, (MR_Integer) 1)));
                ...
                case (MR_Integer) 0:
                  {
                    ...
                    if (succeeded)
                    {
                      ...
                      Var_71 = mercury__set__init_0_f_0((MR_Word) &transform_hlds__delay_construct_scalar_common_1[0]);
                      transform_hlds__delay_construct__delay_construct_in_conj_6_p_0(Goals0_12, InstMap0_6, DelayInfo_7, Var_71, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), &Goals1_16);
                    }
                    else
                      Goals1_16 = Goals0_12;
                  }
              ...
              transform_hlds__delay_construct__delay_construct_in_goals_4_p_0(Goals1_16, InstMap0_6, DelayInfo_7, &Goals_17);
              {
                ...
                MR_hl_field(MR_mktag(3), Var_73, 1) = ((MR_Box) (ConjType_11));
                MR_hl_field(MR_mktag(3), Var_73, 2) = ((MR_Box) (Goals_17));
              }
              {
                MR_Word base;
                base = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
          ...
          case (MR_Integer) 3:
            {
              MR_Word Var_70;
              MR_Word Goals0_74 = ((MR_Word) (MR_hl_field(MR_mktag(3), GoalExpr0_9, (MR_Integer) 1)));
              MR_Word Goals_75;

              transform_hlds__delay_construct__delay_construct_in_goals_4_p_0(Goals0_74, InstMap0_6, DelayInfo_7, &Goals_75);
              {
                ...
                MR_hl_field(MR_mktag(3), Var_70, 1) = ((MR_Box) (Goals_75));
              }
              {
                MR_Word base;
                base = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
          ...
          case (MR_Integer) 4:
            {
              ...
              MR_Word Cases_22;
              MR_Word Var_68;
              MR_Word CanFail_76 = ((MR_Word) (MR_hl_field(MR_mktag(3), GoalExpr0_9, (MR_Integer) 2)));
              ...
              transform_hlds__delay_construct__delay_construct_in_cases_4_p_0(Cases0_21, InstMap0_6, DelayInfo_7, &Cases_22);
              {
                ...
                MR_hl_field(MR_mktag(3), Var_68, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 4));
                MR_hl_field(MR_mktag(3), Var_68, 1) = ((MR_Box) (Var_20));
                MR_hl_field(MR_mktag(3), Var_68, 2) = ((MR_Box) (CanFail_76));
          ...
          case (MR_Integer) 5:
            {
              ...
              succeeded = ((((MR_tag((MR_Word) Reason_34)) == (MR_mktag((MR_Integer) 3)))) && (((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), Reason_34, (MR_Integer) 0)))) == (MR_Integer) 6)));
              if (succeeded)
              {
                Var_36 = ((MR_Word) (MR_hl_field(MR_mktag(3), Reason_34, (MR_Integer) 1)));
                FGT_37 = ((MR_Word) (MR_hl_field(MR_mktag(3), Reason_34, (MR_Integer) 2)));
                switch (FGT_37) {
                  default:
                    succeeded = MR_FALSE;
                    break;
              ...
              else
              {
                ...
                transform_hlds__delay_construct__delay_construct_in_goal_4_p_0(SubGoal0_35, InstMap0_6, DelayInfo_7, &SubGoal_38);
                {
                  ...
                  MR_hl_field(MR_mktag(3), Var_66, 1) = ((MR_Box) (Reason_34));
                  MR_hl_field(MR_mktag(3), Var_66, 2) = ((MR_Box) (SubGoal_38));
                }
                {
                  MR_Word base;
                  base = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
          ...
          case (MR_Integer) 6:
            {
              ...
              MR_Word Else_33;
              MR_Word Var_67;
              MR_Word Var_27 = ((MR_Word) (MR_hl_field(MR_mktag(0), Cond0_24, (MR_Integer) 0)));

              CondInstMapDelta_29 = hlds__hlds_goal__goal_info_get_instmap_delta_1_f_0(CondInfo0_28);
              hlds__instmap__apply_instmap_delta_3_p_0(InstMap0_6, CondInstMapDelta_29, &InstMapThen_30);
              ...
              {
                Var_67 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 5 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), Var_67, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 6));
                MR_hl_field(MR_mktag(3), Var_67, 1) = ((MR_Box) (Vars_23));
                MR_hl_field(MR_mktag(3), Var_67, 2) = ((MR_Box) (Cond_31));
                MR_hl_field(MR_mktag(3), Var_67, 3) = ((MR_Box) (Then_32));
                MR_hl_field(MR_mktag(3), Var_67, 4) = ((MR_Box) (Else_33));
              }
              {
                MR_Word base;
                base = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
  ...
  MR_Word * HeadVar__6_6)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      hlds__instmap__apply_instmap_delta_3_p_0(InstMap0_2, InstMapDelta0_21, &InstMap1_22);
      succeeded = ((MR_tag((MR_Word) GoalExpr0_19)) == (MR_mktag((MR_Integer) 1)));
      if (succeeded)
      {
        Var_23 = ((MR_Word) (MR_hl_field(MR_mktag(1), GoalExpr0_19, (MR_Integer) 0)));
        Var_24 = ((MR_Word) (MR_hl_field(MR_mktag(1), GoalExpr0_19, (MR_Integer) 1)));
        Var_25 = ((MR_Word) (MR_hl_field(MR_mktag(1), GoalExpr0_19, (MR_Integer) 2)));
        Unif_26 = ((MR_Word) (MR_hl_field(MR_mktag(1), GoalExpr0_19, (MR_Integer) 3)));
        Var_27 = ((MR_Word) (MR_hl_field(MR_mktag(1), GoalExpr0_19, (MR_Integer) 4)));
        succeeded = ((MR_tag((MR_Word) Unif_26)) == (MR_mktag((MR_Integer) 0)));
        if (succeeded)
        {
          Var_28 = ((MR_Word) (MR_hl_field(MR_mktag(0), Unif_26, (MR_Integer) 0)));
          Var_29 = ((MR_Word) (MR_hl_field(MR_mktag(0), Unif_26, (MR_Integer) 1)));
          Args_30 = ((MR_Word) (MR_hl_field(MR_mktag(0), Unif_26, (MR_Integer) 2)));
          Var_31 = ((MR_Word) (MR_hl_field(MR_mktag(0), Unif_26, (MR_Integer) 3)));
          Var_32 = ((MR_Word) (MR_hl_field(MR_mktag(0), Unif_26, (MR_Integer) 4)));
          Var_33 = ((MR_Word) (MR_hl_field(MR_mktag(0), Unif_26, (MR_Integer) 5)));
          Var_34 = ((MR_Word) (MR_hl_field(MR_mktag(0), Unif_26, (MR_Integer) 6)));
          succeeded = ((MR_tag((MR_Word) Args_30)) == (MR_mktag((MR_Integer) 1)));
          if (succeeded)
          {
            Var_35 = ((MR_Word) (MR_hl_field(MR_mktag(1), Args_30, (MR_Integer) 0)));
            Var_36 = ((MR_Word) (MR_hl_field(MR_mktag(1), Args_30, (MR_Integer) 1)));
            ...
            Var_57 = ((MR_Word) (MR_hl_field(MR_mktag(0), DelayInfo_3, (MR_Integer) 1)));
            Var_58 = ((MR_Word) (MR_hl_field(MR_mktag(0), DelayInfo_3, (MR_Integer) 2)));
            Var_59 = ((MR_Word) (MR_hl_field(MR_mktag(0), DelayInfo_3, (MR_Integer) 3)));
            ...
            if (succeeded)
            {
              ...
              Var_60 = ((MR_Word) (MR_hl_field(MR_mktag(0), DelayInfo_3, (MR_Integer) 1)));
              Var_61 = ((MR_Word) (MR_hl_field(MR_mktag(0), DelayInfo_3, (MR_Integer) 2)));
              Var_62 = ((MR_Word) (MR_hl_field(MR_mktag(0), DelayInfo_3, (MR_Integer) 3)));
      ...
      if (succeeded)
      {
        ...
        {
          RevDelayedGoals1_40 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
        ...
        {
          MR_Word next_value_of_HeadVar__1_1 = Goals0_13;
          MR_Word next_value_of_InstMap0_2 = InstMap1_22;
          MR_Word next_value_of_ConstructedVars0_4 = ConstructedVars1_39;
          MR_Word next_value_of_HeadVar__5_5 = RevDelayedGoals1_40;
      ...
      else
      {
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            if (((MR_tag((MR_Word) GoalExpr0_19)) == (MR_mktag((MR_Integer) 2))))
            {
              MR_Word Var_96 = ((MR_Word) (MR_hl_field(MR_mktag(2), GoalExpr0_19, (MR_Integer) 3)));
              MR_Word Var_88 = ((MR_Word) (MR_hl_field(MR_mktag(2), GoalExpr0_19, (MR_Integer) 0)));
              MR_Integer Var_89 = ((MR_Integer) (MR_hl_field(MR_mktag(2), GoalExpr0_19, (MR_Integer) 1)));
              MR_Word Var_90 = ((MR_Word) (MR_hl_field(MR_mktag(2), GoalExpr0_19, (MR_Integer) 2)));
              MR_Word Var_91 = ((MR_Word) (MR_hl_field(MR_mktag(2), GoalExpr0_19, (MR_Integer) 4)));
              MR_Word Var_92 = ((MR_Word) (MR_hl_field(MR_mktag(2), GoalExpr0_19, (MR_Integer) 5)));

              succeeded = (Var_96 == (MR_Integer) 0);
            }
            else
            if (((MR_tag((MR_Word) GoalExpr0_19)) == (MR_mktag((MR_Integer) 1))))
              succeeded = MR_TRUE;
            else
              succeeded = MR_FALSE;
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                ...
                Var_63 = ((MR_Word) (MR_hl_field(MR_mktag(0), DelayInfo_3, (MR_Integer) 0)));
                Var_48 = ((MR_Word) (MR_hl_field(MR_mktag(0), DelayInfo_3, (MR_Integer) 1)));
                Var_64 = ((MR_Word) (MR_hl_field(MR_mktag(0), DelayInfo_3, (MR_Integer) 2)));
                Var_65 = ((MR_Word) (MR_hl_field(MR_mktag(0), DelayInfo_3, (MR_Integer) 3)));
                hlds__hlds_rtti__maybe_complete_with_typeinfo_vars_5_p_0(NonLocals_41, Var_48, Var_64, Var_65, &CompletedNonLocals_42);
        ...
        {
          MR_Word TypeCtorInfo_75_75 = (MR_Word) &hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_hlds_goal_0;
          MR_Word DelayedGoals_45;
          MR_Word Var_53;
          MR_Word Var_55;
          MR_Word Goals1_56;

          mercury__list__reverse_2_p_0(TypeCtorInfo_75_75, HeadVar__5_5, &DelayedGoals_45);
          Var_53 = mercury__set__init_0_f_0((MR_Word) &transform_hlds__delay_construct_scalar_common_1[0]);
          transform_hlds__delay_construct__delay_construct_in_conj_6_p_0(Goals0_13, InstMap1_22, DelayInfo_3, Var_53, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), &Goals1_56);
          {
          ...
          mercury__list__append_3_p_1(TypeCtorInfo_75_75, DelayedGoals_45, Var_55, HeadVar__6_6);
        }
      }
    }
    break;
