  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            ...
            ModuleInfo_39 = ((MR_Word) ((MR_hl_field(0, DelayInfo_3, (MR_Integer) 0))));
            succeeded = check_hlds__inst_test__inst_is_free_2_p_0(ModuleInfo_39, Inst0_37);
            if (succeeded)
            {
              VarTable_40 = ((MR_Word) ((MR_hl_field(0, DelayInfo_3, (MR_Integer) 2))));
      ...
      else
      {
        ...
        MR_Word Var_65;
        MR_Word Var_66;
        MR_Word Var_78 = ((MR_Word) ((MR_hl_field(0, Goal0_12, (MR_Integer) 0))));
        MR_Word Var_79 = ((MR_Word) ((MR_hl_field(0, Goal0_12, (MR_Integer) 1))));
        MR_Word Detism_92;
        MR_Word MaxSoln_94;
        MR_Word _CanFail_93;
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            ...
            {
              MR_Word Var_95 = ((MR_Unsigned) ((MR_hl_field(2, GoalExpr0_19, (MR_Integer) 3))) & (MR_Integer) 1);
            ...
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                ...
                Var_65 = ((MR_Unsigned) ((MR_hl_field(0, DelayInfo_3, (MR_Integer) 1))) & (MR_Integer) 1);
                Var_49 = ((MR_Word) ((MR_hl_field(0, DelayInfo_3, (MR_Integer) 2))));
                Var_66 = ((MR_Word) ((MR_hl_field(0, DelayInfo_3, (MR_Integer) 3))));
