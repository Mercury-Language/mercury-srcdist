...
MR_decl_label10(transform_hlds__delay_construct__delay_construct_in_conj_6_0, 115,3,5,6,12,13,15,16,19,7)
MR_decl_label10(transform_hlds__delay_construct__delay_construct_in_conj_6_0, 8,23,25,27,29,30,31,32,33,34)
MR_decl_label6(transform_hlds__delay_construct__delay_construct_in_conj_6_0, 36,38,22,40,42,43)
MR_decl_label10(transform_hlds__delay_construct__delay_construct_in_goal_4_0, 6,7,8,14,15,9,17,4,21,20)
MR_decl_label10(transform_hlds__delay_construct__delay_construct_in_goal_4_0, 25,26,27,28,29,24,33,32,36,39)
MR_decl_label5(transform_hlds__delay_construct__delay_construct_in_goal_4_0, 35,44,43,124,123)
...
MR_decl_label6(__Compare___transform_hlds__delay_construct__delay_construct_info_0_0, 3,2,5,9,14,50)
...
MR_BEGIN_MODULE(transform_hlds__delay_construct_module1)
	...
	MR_init_label10(transform_hlds__delay_construct__delay_construct_in_conj_6_0,115,3,5,6,12,13,15,16,19,7)
	MR_init_label10(transform_hlds__delay_construct__delay_construct_in_conj_6_0,8,23,25,27,29,30,31,32,33,34)
	MR_init_label6(transform_hlds__delay_construct__delay_construct_in_conj_6_0,36,38,22,40,42,43)
MR_BEGIN_CODE
...
MR_def_label(transform_hlds__delay_construct__delay_construct_in_conj_6_0,115)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_def_label(transform_hlds__delay_construct__delay_construct_in_conj_6_0,19)
	...
	MR_r4 = MR_tempr2;
	MR_succip_word = MR_sv(10);
	MR_GOTO_LAB(transform_hlds__delay_construct__delay_construct_in_conj_6_0_i115);
	}
...
MR_def_label(transform_hlds__delay_construct__delay_construct_in_conj_6_0,42)
	...
	MR_np_localcall_lab(transform_hlds__delay_construct__delay_construct_in_conj_6_0,
		transform_hlds__delay_construct__delay_construct_in_conj_6_0_i43);
MR_def_label(transform_hlds__delay_construct__delay_construct_in_conj_6_0,43)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 2);
...
MR_BEGIN_MODULE(transform_hlds__delay_construct_module2)
	...
	MR_init_label10(transform_hlds__delay_construct__delay_construct_in_goal_4_0,6,7,8,14,15,9,17,4,21,20)
	MR_init_label10(transform_hlds__delay_construct__delay_construct_in_goal_4_0,25,26,27,28,29,24,33,32,36,39)
	MR_init_label5(transform_hlds__delay_construct__delay_construct_in_goal_4_0,35,44,43,124,123)
MR_BEGIN_CODE
...
MR_def_static(transform_hlds__delay_construct__delay_construct_in_goal_4_0)
	...
	if ((((((MR_tag(MR_tempr1) == MR_mktag((MR_Integer) 3)) && ((MR_Integer) MR_tfield(3, MR_tempr1, 0) == (MR_Integer) 1)) || ((MR_tag(MR_tempr1) == MR_mktag((MR_Integer) 3)) && ((MR_Integer) MR_tfield(3, MR_tempr1, 0) == (MR_Integer) 0))) || (MR_tag(MR_tempr1) == MR_mktag((MR_Integer) 2))) || (MR_tag(MR_tempr1) == MR_mktag((MR_Integer) 1)))) {
		MR_GOTO_LAB(transform_hlds__delay_construct__delay_construct_in_goal_4_0_i124);
	}
...
MR_def_label(transform_hlds__delay_construct__delay_construct_in_goal_4_0,4)
	...
	if (MR_RTAGS_TESTR(MR_r4,3,3)) {
		MR_GOTO_LAB(transform_hlds__delay_construct__delay_construct_in_goal_4_0_i20);
	}
	MR_incr_sp(8);
	MR_sv(8) = (MR_Word) MR_succip;
	MR_sv(2) = MR_tfield(0, MR_r1, 1);
...
MR_def_label(transform_hlds__delay_construct__delay_construct_in_goal_4_0,20)
	...
	if (MR_RTAGS_TESTR(MR_r4,3,6)) {
		MR_GOTO_LAB(transform_hlds__delay_construct__delay_construct_in_goal_4_0_i24);
	}
	MR_incr_sp(8);
	MR_sv(8) = (MR_Word) MR_succip;
	MR_sv(7) = MR_r2;
...
MR_def_label(transform_hlds__delay_construct__delay_construct_in_goal_4_0,24)
	...
	if (MR_PTAG_TESTR(MR_r4,0)) {
		MR_GOTO_LAB(transform_hlds__delay_construct__delay_construct_in_goal_4_0_i32);
	}
	MR_incr_sp(8);
	MR_sv(8) = (MR_Word) MR_succip;
	MR_sv(2) = MR_tfield(0, MR_r1, 1);
...
MR_def_label(transform_hlds__delay_construct__delay_construct_in_goal_4_0,32)
	...
	if (MR_RTAGS_TESTR(MR_tempr1,3,4)) {
		MR_GOTO_LAB(transform_hlds__delay_construct__delay_construct_in_goal_4_0_i36);
	}
	MR_tempr2 = MR_tfield(3, MR_tempr1, 2);
	if (MR_INT_EQ(MR_tempr2,0)) {
		MR_GOTO_LAB(transform_hlds__delay_construct__delay_construct_in_goal_4_0_i123);
	}
	}
MR_def_label(transform_hlds__delay_construct__delay_construct_in_goal_4_0,36)
	...
	MR_r1 = MR_r5;
	MR_np_localcall_lab(transform_hlds__delay_construct__delay_construct_in_goal_4_0,
		transform_hlds__delay_construct__delay_construct_in_goal_4_0_i39);
MR_def_label(transform_hlds__delay_construct__delay_construct_in_goal_4_0,39)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
...
MR_def_label(transform_hlds__delay_construct__delay_construct_in_goal_4_0,35)
	...
	if (MR_RTAGS_TESTR(MR_r4,3,4)) {
		MR_GOTO_LAB(transform_hlds__delay_construct__delay_construct_in_goal_4_0_i43);
	}
	MR_incr_sp(8);
	MR_sv(8) = (MR_Word) MR_succip;
	MR_sv(2) = MR_tfield(0, MR_r1, 1);
	...
	MR_np_call_localret_ent(transform_hlds__delay_construct__delay_construct_in_cases_4_0,
		transform_hlds__delay_construct__delay_construct_in_goal_4_0_i44);
...
MR_def_label(transform_hlds__delay_construct__delay_construct_in_goal_4_0,43)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_def_label(transform_hlds__delay_construct__delay_construct_in_goal_4_0,124)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_proceed();
MR_def_label(transform_hlds__delay_construct__delay_construct_in_goal_4_0,123)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(8);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
...
MR_BEGIN_MODULE(transform_hlds__delay_construct_module7)
	...
	MR_init_label6(__Compare___transform_hlds__delay_construct__delay_construct_info_0_0,3,2,5,9,14,50)
MR_BEGIN_CODE
...
MR_def_label(__Compare___transform_hlds__delay_construct__delay_construct_info_0_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___transform_hlds__delay_construct__delay_construct_info_0_0_i50);
	}
	MR_r1 = MR_sv(1);
	MR_r2 = MR_sv(4);
...
MR_def_label(__Compare___transform_hlds__delay_construct__delay_construct_info_0_0,50)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(7);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
