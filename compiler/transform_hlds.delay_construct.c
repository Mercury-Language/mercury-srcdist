      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            ...
            succeeded = check_hlds__inst_test__inst_is_free_2_p_0(ModuleInfo_39, Inst0_37);
            if (succeeded)
            {
              VarTable_40 = ((MR_Word) ((MR_hl_field(0, DelayInfo_3, 2))));
              parse_tree__var_table__lookup_var_type_3_p_0(VarTable_40, Var_28, &Type_41);
              succeeded = check_hlds__inst_test__inst_is_ground_3_p_0(ModuleInfo_39, Type_41, Inst1_38);
            }
          }
        }
      }
