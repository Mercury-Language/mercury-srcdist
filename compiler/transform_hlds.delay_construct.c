          ...
          case (MR_Integer) 2:
            {
              ...
              transform_hlds__delay_construct__delay_construct_in_goals_4_p_0(Goals1_16, InstMap0_6, DelayInfo_7, &Goals_17);
              {
                ...
                MR_hl_field(MR_mktag(3), Var_73, 1) = (MR_Box) ((MR_Unsigned) (ConjType_11));
          ...
          case (MR_Integer) 4:
            {
              ...
              MR_Word Cases_22;
              MR_Word Var_68;
              MR_Word CanFail_76 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(3), GoalExpr0_9, (MR_Integer) 2))) & (MR_Integer) 1);
              ...
              transform_hlds__delay_construct__delay_construct_in_cases_4_p_0(Cases0_21, InstMap0_6, DelayInfo_7, &Cases_22);
              {
                ...
                MR_hl_field(MR_mktag(3), Var_68, 2) = (MR_Box) ((MR_Unsigned) (CanFail_76));
          ...
          case (MR_Integer) 5:
            {
              ...
              if (succeeded)
              {
                packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Reason_34, (MR_Integer) 2)));
          ...
          case (MR_Integer) 6:
            {
              ...
              {
                Var_67 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL));
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Unif_26, (MR_Integer) 5)));
          ...
          if (succeeded)
          {
            ...
            packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), DelayInfo_3, (MR_Integer) 1)));
            ...
            if (succeeded)
            {
              ...
              packed_word_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), DelayInfo_3, (MR_Integer) 1)));
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            if (((MR_tag((MR_Word) GoalExpr0_19)) == (MR_Integer) 2))
            {
              ...
              MR_Unsigned packed_word_3 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), GoalExpr0_19, (MR_Integer) 3)));
            ...
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                ...
                packed_word_4 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), DelayInfo_3, (MR_Integer) 1)));
