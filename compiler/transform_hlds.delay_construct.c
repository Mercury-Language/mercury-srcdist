  ...
  MR_Word * STATE_VARIABLE_ProcInfo_23)
{
  ...
  PredId_11 = ((MR_Word) ((MR_hl_field(0, PredProcId_8, 0))));
  ...
  hlds__hlds_proc__proc_info_get_var_table_2_p_0(STATE_VARIABLE_ProcInfo_0_22, &VarTable_16);
  hlds__hlds_proc__proc_info_get_rtti_varmaps_2_p_0(STATE_VARIABLE_ProcInfo_0_22, &RttiVarMaps_17);
  hlds__hlds_proc_util__proc_info_get_initial_instmap_3_p_0(ModuleInfo_7, STATE_VARIABLE_ProcInfo_0_22, &InstMap0_18);
  {
  ...
  hlds__hlds_proc__proc_info_get_goal_2_p_0(STATE_VARIABLE_ProcInfo_0_22, &Goal0_20);
  transform_hlds__delay_construct__delay_construct_in_goal_4_p_0(Goal0_20, InstMap0_18, DelayInfo_19, &Goal_21);
  hlds__hlds_proc__proc_info_set_goal_3_p_0(Goal_21, STATE_VARIABLE_ProcInfo_0_22, STATE_VARIABLE_ProcInfo_23);
}
  ...
  MR_Word * Goal_8)
{
  ...
  MR_Word GoalInfo0_10 = ((MR_Word) ((MR_hl_field(0, Goal0_5, 1))));
  ...
  switch (MR_tag((MR_Word) GoalExpr0_9)) {
    ...
    case (MR_Integer) 3:
      switch (((MR_Integer) ((MR_hl_field(3, GoalExpr0_9, 0))))) {
        ...
        case (MR_Integer) 2:
          {
            MR_Word ConjType_11 = ((MR_Unsigned) ((MR_hl_field(3, GoalExpr0_9, 1))) & (MR_Integer) 1);
            MR_Word Goals0_12 = ((MR_Word) ((MR_hl_field(3, GoalExpr0_9, 2))));
            MR_Word Goals1_16;
            MR_Word Goals_17;
            MR_Word Var_65;
        ...
        case (MR_Integer) 3:
          {
            MR_Word Var_66;
            MR_Word Goals0_73 = ((MR_Word) ((MR_hl_field(3, GoalExpr0_9, 1))));
            MR_Word Goals_74;
        ...
        case (MR_Integer) 4:
          {
            MR_Word Var_20 = ((MR_Word) ((MR_hl_field(3, GoalExpr0_9, 1))));
            MR_Word Cases0_21 = ((MR_Word) ((MR_hl_field(3, GoalExpr0_9, 3))));
            MR_Word Cases_22;
            MR_Word Var_68;
            MR_Word CanFail_75 = ((MR_Unsigned) ((MR_hl_field(3, GoalExpr0_9, 2))) & (MR_Integer) 1);
        ...
        case (MR_Integer) 5:
          {
            MR_Word Reason_34 = ((MR_Word) ((MR_hl_field(3, GoalExpr0_9, 1))));
            MR_Word SubGoal0_35 = ((MR_Word) ((MR_hl_field(3, GoalExpr0_9, 2))));
            MR_Word FGT_37;

            succeeded = ((((MR_tag((MR_Word) Reason_34)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(3, Reason_34, 0)))) == (MR_Integer) 6)));
            if (succeeded)
            {
              FGT_37 = ((MR_Unsigned) ((MR_hl_field(3, Reason_34, 2))) & (MR_Integer) 3);
              switch (FGT_37) {
                default:
                  succeeded = MR_FALSE;
                  break;
        ...
        case (MR_Integer) 6:
          {
            MR_Word Vars_23 = ((MR_Word) ((MR_hl_field(3, GoalExpr0_9, 1))));
            MR_Word Cond0_24 = ((MR_Word) ((MR_hl_field(3, GoalExpr0_9, 2))));
            MR_Word Then0_25 = ((MR_Word) ((MR_hl_field(3, GoalExpr0_9, 3))));
            MR_Word Else0_26 = ((MR_Word) ((MR_hl_field(3, GoalExpr0_9, 4))));
            MR_Word CondInfo0_28 = ((MR_Word) ((MR_hl_field(0, Cond0_24, 1))));
  ...
  MR_Word * HeadVar__6_6)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      MR_Word GoalExpr0_19 = ((MR_Word) ((MR_hl_field(0, Goal0_12, 0))));
      MR_Word GoalInfo0_20 = ((MR_Word) ((MR_hl_field(0, Goal0_12, 1))));
      ...
      if (succeeded)
      {
        Unif_26 = ((MR_Word) ((MR_hl_field(1, GoalExpr0_19, 3))));
        succeeded = ((MR_tag((MR_Word) Unif_26)) == (MR_Integer) 0);
        if (succeeded)
        {
          Var_28 = ((MR_Word) ((MR_hl_field(0, Unif_26, 0))));
          Args_30 = ((MR_Word) ((MR_hl_field(0, Unif_26, 2))));
          ...
          if (succeeded)
          {
            ...
            ModuleInfo_39 = ((MR_Word) ((MR_hl_field(0, DelayInfo_3, 0))));
            succeeded = hlds__inst_test__inst_is_free_2_p_0(ModuleInfo_39, Inst0_37);
            if (succeeded)
            {
              VarTable_40 = ((MR_Word) ((MR_hl_field(0, DelayInfo_3, 2))));
              parse_tree__var_table__lookup_var_type_3_p_0(VarTable_40, Var_28, &Type_41);
              succeeded = hlds__inst_test__inst_is_ground_3_p_0(ModuleInfo_39, Type_41, Inst1_38);
            }
          }
        }
      }
      if (succeeded)
      {
        MR_Word ConstructedVars1_42;
        MR_Word RevDelayedGoals1_43;
        MR_Word next_value_of_HeadVar__1_1;
        MR_Word next_value_of_InstMap0_2;
        MR_Word next_value_of_ConstructedVars0_4;
        MR_Word next_value_of_HeadVar__5_5;

        mercury__set__insert_3_p_0((MR_Word) (&transform_hlds__delay_construct_scalar_common_1[0]), ((MR_Box) (Var_28)), ConstructedVars0_4, &ConstructedVars1_42);
        {
          RevDelayedGoals1_43 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(1, RevDelayedGoals1_43, 0) = ((MR_Box) (Goal0_12));
          MR_hl_field(1, RevDelayedGoals1_43, 1) = ((MR_Box) (HeadVar__5_5));
        }
        // direct tailcall eliminated
        ;
        next_value_of_HeadVar__1_1 = Goals0_13;
        next_value_of_InstMap0_2 = InstMap1_22;
        next_value_of_ConstructedVars0_4 = ConstructedVars1_42;
        next_value_of_HeadVar__5_5 = RevDelayedGoals1_43;
      ...
      else
      {
        ...
        MR_Word CompletedNonLocals_45;
        MR_Word Intersection_46;
        MR_Word Var_49;
        MR_Word Var_52;
        MR_Word Var_53;
        MR_Word Var_65;
        MR_Word Var_66;
        MR_Word Var_78 = ((MR_Word) ((MR_hl_field(0, Goal0_12, 0))));
        MR_Word Var_79 = ((MR_Word) ((MR_hl_field(0, Goal0_12, 1))));
        MR_Word Detism_92;
        MR_Word MaxSoln_94;
        MR_Word _CanFail_93;

        succeeded = hlds__hlds_goal____Unify____hlds_goal_expr_0_0(GoalExpr0_19, Var_78);
        if (succeeded)
        {
          succeeded = hlds__hlds_goal____Unify____hlds_goal_info_0_0(GoalInfo0_20, Var_79);
          if (succeeded)
          {
            if (((MR_tag((MR_Word) GoalExpr0_19)) == (MR_Integer) 2))
            {
              MR_Word Var_95 = ((MR_Unsigned) ((MR_hl_field(2, GoalExpr0_19, 3))) & (MR_Integer) 1);
            ...
            if (succeeded)
            {
              Detism_92 = hlds__hlds_goal__goal_info_get_determinism_1_f_0(GoalInfo0_20);
              parse_tree__prog_data__determinism_components_3_p_0(Detism_92, &_CanFail_93, &MaxSoln_94);
              succeeded = (MaxSoln_94 != (MR_Integer) 3);
              if (succeeded)
              {
                NonLocals_44 = hlds__hlds_goal__goal_info_get_nonlocals_1_f_0(GoalInfo0_20);
                Var_65 = ((MR_Unsigned) ((MR_hl_field(0, DelayInfo_3, 1))) & (MR_Integer) 1);
                Var_49 = ((MR_Word) ((MR_hl_field(0, DelayInfo_3, 2))));
                Var_66 = ((MR_Word) ((MR_hl_field(0, DelayInfo_3, 3))));
                hlds__hlds_rtti__maybe_complete_with_typeinfo_vars_5_p_0(Var_49, Var_66, Var_65, NonLocals_44, &CompletedNonLocals_45);
                TypeCtorInfo_75_75 = (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0);
                Var_52 = parse_tree__set_of_var__set_to_bitset_1_f_0(TypeCtorInfo_75_75, ConstructedVars0_4);
                parse_tree__set_of_var__intersect_3_p_0(TypeCtorInfo_75_75, CompletedNonLocals_45, Var_52, &Intersection_46);
                succeeded = parse_tree__set_of_var__is_empty_1_p_0(TypeCtorInfo_75_75, Intersection_46);
                if (succeeded)
                {
                  Var_53 = hlds__hlds_goal__goal_info_get_purity_1_f_0(GoalInfo0_20);
        ...
        if (succeeded)
        {
          ...
          transform_hlds__delay_construct__delay_construct_in_conj_6_p_0(Goals0_13, InstMap1_22, DelayInfo_3, ConstructedVars0_4, HeadVar__5_5, &Goals1_47);
          {
            MR_Word base;
            base = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            *HeadVar__6_6 = base;
        ...
        {
          MR_Word DelayedGoals_48;
          MR_Word Var_54;
          MR_Word Var_56;
          MR_Word Goals1_57;

          mercury__list__reverse_2_p_0((MR_Word) (&hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_hlds_goal_0), HeadVar__5_5, &DelayedGoals_48);
          Var_54 = mercury__set__init_0_f_0((MR_Word) (&transform_hlds__delay_construct_scalar_common_1[0]));
          transform_hlds__delay_construct__delay_construct_in_conj_6_p_0(Goals0_13, InstMap1_22, DelayInfo_3, Var_54, (MR_Word) ((MR_Unsigned) 0U), &Goals1_57);
          {
            Var_56 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(1, Var_56, 0) = ((MR_Box) (Goal0_12));
            MR_hl_field(1, Var_56, 1) = ((MR_Box) (Goals1_57));
          }
          mercury__list__append_3_p_1((MR_Word) (&hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_hlds_goal_0), DelayedGoals_48, Var_56, HeadVar__6_6);
        }
      }
    }
    break;
