...
MR_decl_label10(transform_hlds__delay_construct__delay_construct_in_conj_6_0, 114,3,5,6,12,13,15,16,19,7)
MR_decl_label10(transform_hlds__delay_construct__delay_construct_in_conj_6_0, 8,23,25,27,29,30,31,32,33,35)
MR_decl_label5(transform_hlds__delay_construct__delay_construct_in_conj_6_0, 37,22,39,41,42)
MR_decl_label10(transform_hlds__delay_construct__delay_construct_in_goal_4_0, 6,7,8,14,15,9,17,4,21,20)
MR_decl_label10(transform_hlds__delay_construct__delay_construct_in_goal_4_0, 25,26,27,28,29,24,33,32,39,36)
MR_decl_label5(transform_hlds__delay_construct__delay_construct_in_goal_4_0, 41,35,46,45,140)
...
MR_BEGIN_MODULE(transform_hlds__delay_construct_module1)
	...
	MR_init_label10(transform_hlds__delay_construct__delay_construct_in_conj_6_0,114,3,5,6,12,13,15,16,19,7)
	MR_init_label10(transform_hlds__delay_construct__delay_construct_in_conj_6_0,8,23,25,27,29,30,31,32,33,35)
	MR_init_label5(transform_hlds__delay_construct__delay_construct_in_conj_6_0,37,22,39,41,42)
MR_BEGIN_CODE
...
MR_def_label(transform_hlds__delay_construct__delay_construct_in_conj_6_0,114)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_def_label(transform_hlds__delay_construct__delay_construct_in_conj_6_0,19)
	...
	MR_r4 = MR_tempr2;
	MR_succip_word = MR_sv(10);
	MR_GOTO_LAB(transform_hlds__delay_construct__delay_construct_in_conj_6_0_i114);
	}
...
MR_BEGIN_MODULE(transform_hlds__delay_construct_module2)
	...
	MR_init_label10(transform_hlds__delay_construct__delay_construct_in_goal_4_0,25,26,27,28,29,24,33,32,39,36)
	MR_init_label5(transform_hlds__delay_construct__delay_construct_in_goal_4_0,41,35,46,45,140)
MR_BEGIN_CODE
...
MR_def_static(transform_hlds__delay_construct__delay_construct_in_goal_4_0)
	...
	if ((((((MR_tag(MR_tempr1) == MR_mktag((MR_Integer) 3)) && ((MR_Integer) MR_tfield(3, MR_tempr1, 0) == (MR_Integer) 1)) || ((MR_tag(MR_tempr1) == MR_mktag((MR_Integer) 3)) && ((MR_Integer) MR_tfield(3, MR_tempr1, 0) == (MR_Integer) 0))) || (MR_tag(MR_tempr1) == MR_mktag((MR_Integer) 2))) || (MR_tag(MR_tempr1) == MR_mktag((MR_Integer) 1)))) {
		MR_GOTO_LAB(transform_hlds__delay_construct__delay_construct_in_goal_4_0_i140);
	}
...
MR_def_label(transform_hlds__delay_construct__delay_construct_in_goal_4_0,32)
	...
	if (MR_INT_NE(MR_r4,1)) {
		MR_GOTO_LAB(transform_hlds__delay_construct__delay_construct_in_goal_4_0_i39);
	}
	MR_tempr2 = MR_tempr1;
	MR_sv(7) = MR_r2;
	MR_sv(1) = MR_r3;
...
MR_def_label(transform_hlds__delay_construct__delay_construct_in_goal_4_0,36)
	...
	MR_r1 = MR_r5;
	MR_np_localcall_lab(transform_hlds__delay_construct__delay_construct_in_goal_4_0,
		transform_hlds__delay_construct__delay_construct_in_goal_4_0_i41);
MR_def_label(transform_hlds__delay_construct__delay_construct_in_goal_4_0,41)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
...
MR_def_label(transform_hlds__delay_construct__delay_construct_in_goal_4_0,35)
	...
	if (MR_RTAGS_TESTR(MR_r4,3,4)) {
		MR_GOTO_LAB(transform_hlds__delay_construct__delay_construct_in_goal_4_0_i45);
	}
	MR_incr_sp(8);
	MR_sv(8) = (MR_Word) MR_succip;
	MR_sv(2) = MR_tfield(0, MR_r1, 1);
	...
	MR_np_call_localret_ent(transform_hlds__delay_construct__delay_construct_in_cases_4_0,
		transform_hlds__delay_construct__delay_construct_in_goal_4_0_i46);
MR_def_label(transform_hlds__delay_construct__delay_construct_in_goal_4_0,46)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
...
MR_def_label(transform_hlds__delay_construct__delay_construct_in_goal_4_0,140)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_proceed();
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
