...
#line 28 "transform_hlds.delay_construct.c"
#line 150 "../library/io.int2"
#include "time.mh"

#line 32 "transform_hlds.delay_construct.c"
#line 151 "../library/io.int2"
#include "string.mh"

#line 36 "transform_hlds.delay_construct.c"
#line 33 "../library/array.int2"
#include "array.mh"

#line 40 "transform_hlds.delay_construct.c"
#line 39 "../mdbcomp/mdbcomp.rtti_access.int2"
#include "mdbcomp.rtti_access.mh"

#line 44 "transform_hlds.delay_construct.c"
#line 31 "../library/bitmap.int2"
#include "bitmap.mh"

#line 48 "transform_hlds.delay_construct.c"
#line 49 "transform_hlds.delay_construct.c"
#include "transform_hlds.delay_construct.mh"

#line 52 "transform_hlds.delay_construct.c"
#line 53 "transform_hlds.delay_construct.c"
...
#line 58 "transform_hlds.delay_construct.c"

#endif
#line 61 "transform_hlds.delay_construct.c"
...
MR_decl_label3(transform_hlds__delay_construct__delay_construct_in_cases_4_0, 18,4,6)
MR_decl_label10(transform_hlds__delay_construct__delay_construct_in_conj_6_0, 136,3,5,6,12,13,15,16,18,7)
MR_decl_label10(transform_hlds__delay_construct__delay_construct_in_conj_6_0, 8,22,24,27,26,30,31,34,35,36)
MR_decl_label8(transform_hlds__delay_construct__delay_construct_in_conj_6_0, 37,38,40,42,21,44,45,46)
MR_decl_label10(transform_hlds__delay_construct__delay_construct_in_goal_4_0, 6,7,8,13,14,9,16,4,20,19)
MR_decl_label10(transform_hlds__delay_construct__delay_construct_in_goal_4_0, 24,25,26,27,28,23,32,31,38,35)
MR_decl_label5(transform_hlds__delay_construct__delay_construct_in_goal_4_0, 40,34,45,44,139)
MR_decl_label3(transform_hlds__delay_construct__delay_construct_in_goals_4_0, 17,4,5)
MR_decl_label9(transform_hlds__delay_construct__delay_construct_proc_4_0, 2,3,4,5,6,7,8,10,11)
MR_decl_label4(__Unify___transform_hlds__delay_construct__delay_construct_info_0_0, 4,6,10,1)
MR_decl_label6(__Compare___transform_hlds__delay_construct__delay_construct_info_0_0, 3,2,5,9,13,37)
...
MR_def_extern_entry(transform_hlds__delay_construct__delay_construct_proc_4_0)
...
MR_BEGIN_MODULE(transform_hlds__delay_construct_module0)
	...
	MR_init_label10(transform_hlds__delay_construct__delay_construct_in_conj_6_0,136,3,5,6,12,13,15,16,18,7)
	MR_init_label10(transform_hlds__delay_construct__delay_construct_in_conj_6_0,8,22,24,27,26,30,31,34,35,36)
	MR_init_label8(transform_hlds__delay_construct__delay_construct_in_conj_6_0,37,38,40,42,21,44,45,46)
MR_BEGIN_CODE
...
MR_def_label(transform_hlds__delay_construct__delay_construct_in_conj_6_0,136)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_def_label(transform_hlds__delay_construct__delay_construct_in_conj_6_0,16)
	...
	MR_np_call_localret_ent(set__insert_3_0,
		transform_hlds__delay_construct__delay_construct_in_conj_6_0_i18);
MR_def_label(transform_hlds__delay_construct__delay_construct_in_conj_6_0,18)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
	...
	MR_r4 = MR_tempr2;
	MR_succip_word = MR_sv(10);
	MR_GOTO_LAB(transform_hlds__delay_construct__delay_construct_in_conj_6_0_i136);
	}
...
MR_def_label(transform_hlds__delay_construct__delay_construct_in_conj_6_0,8)
	...
	MR_np_call_localret_ent(__Unify___hlds__hlds_goal__hlds_goal_expr_0_0,
		transform_hlds__delay_construct__delay_construct_in_conj_6_0_i22);
MR_def_label(transform_hlds__delay_construct__delay_construct_in_conj_6_0,22)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(transform_hlds__delay_construct__delay_construct_in_conj_6_0_i21);
	}
	MR_r1 = MR_sv(5);
	MR_r2 = MR_sv(7);
	MR_np_call_localret_ent(__Unify___hlds__hlds_goal__hlds_goal_info_0_0,
		transform_hlds__delay_construct__delay_construct_in_conj_6_0_i24);
MR_def_label(transform_hlds__delay_construct__delay_construct_in_conj_6_0,24)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(transform_hlds__delay_construct__delay_construct_in_conj_6_0_i21);
	}
	if (MR_PTAG_TESTR(MR_sv(8),2)) {
		MR_GOTO_LAB(transform_hlds__delay_construct__delay_construct_in_conj_6_0_i27);
	}
	MR_r2 = MR_tfield(2, MR_sv(8), 3);
	if (MR_INT_NE(MR_r2,0)) {
		MR_GOTO_LAB(transform_hlds__delay_construct__delay_construct_in_conj_6_0_i21);
	}
	MR_r1 = MR_sv(5);
	MR_GOTO_LAB(transform_hlds__delay_construct__delay_construct_in_conj_6_0_i26);
MR_def_label(transform_hlds__delay_construct__delay_construct_in_conj_6_0,27)
	...
	MR_r1 = MR_sv(5);
MR_def_label(transform_hlds__delay_construct__delay_construct_in_conj_6_0,26)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(5) = MR_r1;
...
MR_def_label(transform_hlds__delay_construct__delay_construct_in_conj_6_0,30)
	...
	MR_np_call_localret_ent(parse_tree__prog_data__determinism_components_3_0,
		transform_hlds__delay_construct__delay_construct_in_conj_6_0_i31);
MR_def_label(transform_hlds__delay_construct__delay_construct_in_conj_6_0,31)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	...
	MR_np_call_localret_ent(fn__hlds__hlds_goal__goal_info_get_nonlocals_1_0,
		transform_hlds__delay_construct__delay_construct_in_conj_6_0_i34);
MR_def_label(transform_hlds__delay_construct__delay_construct_in_conj_6_0,34)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_sv(1);
...
MR_def_label(transform_hlds__delay_construct__delay_construct_in_conj_6_0,35)
	...
	MR_np_call_localret_ent(fn__parse_tree__set_of_var__set_to_bitset_1_0,
		transform_hlds__delay_construct__delay_construct_in_conj_6_0_i36);
MR_def_label(transform_hlds__delay_construct__delay_construct_in_conj_6_0,36)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
...
MR_def_label(transform_hlds__delay_construct__delay_construct_in_conj_6_0,37)
	...
	MR_np_call_localret_ent(parse_tree__set_of_var__is_empty_1_0,
		transform_hlds__delay_construct__delay_construct_in_conj_6_0_i38);
MR_def_label(transform_hlds__delay_construct__delay_construct_in_conj_6_0,38)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(transform_hlds__delay_construct__delay_construct_in_conj_6_0_i21);
	}
	...
	MR_np_call_localret_ent(fn__hlds__hlds_goal__goal_info_get_purity_1_0,
		transform_hlds__delay_construct__delay_construct_in_conj_6_0_i40);
MR_def_label(transform_hlds__delay_construct__delay_construct_in_conj_6_0,40)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_def_label(transform_hlds__delay_construct__delay_construct_in_conj_6_0,21)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_sv(2);
	...
	MR_np_call_localret_ent(list__reverse_2_0,
		transform_hlds__delay_construct__delay_construct_in_conj_6_0_i44);
MR_def_label(transform_hlds__delay_construct__delay_construct_in_conj_6_0,44)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(9) = MR_r1;
	MR_r1 = (MR_Word) MR_TAG_COMMON(0,0,0);
	MR_np_call_localret_ent(fn__set__init_0_0,
		transform_hlds__delay_construct__delay_construct_in_conj_6_0_i45);
MR_def_label(transform_hlds__delay_construct__delay_construct_in_conj_6_0,45)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
	...
	MR_np_localcall_lab(transform_hlds__delay_construct__delay_construct_in_conj_6_0,
		transform_hlds__delay_construct__delay_construct_in_conj_6_0_i46);
MR_def_label(transform_hlds__delay_construct__delay_construct_in_conj_6_0,46)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 2);
...
MR_BEGIN_MODULE(transform_hlds__delay_construct_module1)
	...
	MR_init_label10(transform_hlds__delay_construct__delay_construct_in_goal_4_0,6,7,8,13,14,9,16,4,20,19)
	MR_init_label10(transform_hlds__delay_construct__delay_construct_in_goal_4_0,24,25,26,27,28,23,32,31,38,35)
	MR_init_label5(transform_hlds__delay_construct__delay_construct_in_goal_4_0,40,34,45,44,139)
MR_BEGIN_CODE
...
MR_def_static(transform_hlds__delay_construct__delay_construct_in_goal_4_0)
	...
	if ((((((MR_tag(MR_tempr1) == MR_mktag((MR_Integer) 3)) && ((MR_Integer) MR_tfield(3, MR_tempr1, 0) == (MR_Integer) 1)) || ((MR_tag(MR_tempr1) == MR_mktag((MR_Integer) 3)) && ((MR_Integer) MR_tfield(3, MR_tempr1, 0) == (MR_Integer) 0))) || (MR_tag(MR_tempr1) == MR_mktag((MR_Integer) 2))) || (MR_tag(MR_tempr1) == MR_mktag((MR_Integer) 1)))) {
		MR_GOTO_LAB(transform_hlds__delay_construct__delay_construct_in_goal_4_0_i139);
	}
	if (MR_RTAGS_TESTR(MR_tempr1,3,2)) {
		MR_GOTO_LAB(transform_hlds__delay_construct__delay_construct_in_goal_4_0_i4);
	}
	MR_incr_sp(8);
	...
	MR_np_call_localret_ent(transform_hlds__delay_construct__delay_construct_in_goals_4_0,
		transform_hlds__delay_construct__delay_construct_in_goal_4_0_i16);
...
MR_def_label(transform_hlds__delay_construct__delay_construct_in_goal_4_0,8)
	...
	MR_r1 = (MR_Word) MR_TAG_COMMON(0,0,0);
	MR_np_call_localret_ent(fn__set__init_0_0,
		transform_hlds__delay_construct__delay_construct_in_goal_4_0_i13);
MR_def_label(transform_hlds__delay_construct__delay_construct_in_goal_4_0,13)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
...
MR_def_label(transform_hlds__delay_construct__delay_construct_in_goal_4_0,9)
	...
	MR_np_call_localret_ent(transform_hlds__delay_construct__delay_construct_in_goals_4_0,
		transform_hlds__delay_construct__delay_construct_in_goal_4_0_i16);
MR_def_label(transform_hlds__delay_construct__delay_construct_in_goal_4_0,16)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_def_label(transform_hlds__delay_construct__delay_construct_in_goal_4_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_RTAGS_TESTR(MR_r4,3,3)) {
		MR_GOTO_LAB(transform_hlds__delay_construct__delay_construct_in_goal_4_0_i19);
	}
	MR_incr_sp(8);
	MR_sv(8) = (MR_Word) MR_succip;
	MR_sv(2) = MR_tfield(0, MR_r1, 1);
	...
	MR_np_call_localret_ent(transform_hlds__delay_construct__delay_construct_in_goals_4_0,
		transform_hlds__delay_construct__delay_construct_in_goal_4_0_i20);
MR_def_label(transform_hlds__delay_construct__delay_construct_in_goal_4_0,20)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
...
MR_def_label(transform_hlds__delay_construct__delay_construct_in_goal_4_0,19)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_RTAGS_TESTR(MR_r4,3,6)) {
		MR_GOTO_LAB(transform_hlds__delay_construct__delay_construct_in_goal_4_0_i23);
	}
	MR_incr_sp(8);
	MR_sv(8) = (MR_Word) MR_succip;
	MR_sv(7) = MR_r2;
	...
	MR_np_call_localret_ent(fn__hlds__hlds_goal__goal_info_get_instmap_delta_1_0,
		transform_hlds__delay_construct__delay_construct_in_goal_4_0_i24);
MR_def_label(transform_hlds__delay_construct__delay_construct_in_goal_4_0,24)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
...
MR_def_label(transform_hlds__delay_construct__delay_construct_in_goal_4_0,23)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_r4,0)) {
		MR_GOTO_LAB(transform_hlds__delay_construct__delay_construct_in_goal_4_0_i31);
	}
	MR_incr_sp(8);
	MR_sv(8) = (MR_Word) MR_succip;
	MR_sv(2) = MR_tfield(0, MR_r1, 1);
	...
	MR_np_localcall_lab(transform_hlds__delay_construct__delay_construct_in_goal_4_0,
		transform_hlds__delay_construct__delay_construct_in_goal_4_0_i32);
MR_def_label(transform_hlds__delay_construct__delay_construct_in_goal_4_0,32)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	...
	MR_r1 = MR_r2;
	MR_decr_sp_and_return(8);
MR_def_label(transform_hlds__delay_construct__delay_construct_in_goal_4_0,31)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_RTAGS_TESTR(MR_r4,3,5)) {
		MR_GOTO_LAB(transform_hlds__delay_construct__delay_construct_in_goal_4_0_i34);
	}
	MR_incr_sp(8);
	MR_sv(8) = (MR_Word) MR_succip;
	{
	...
	if (MR_RTAGS_TESTR(MR_tempr1,3,4)) {
		MR_GOTO_LAB(transform_hlds__delay_construct__delay_construct_in_goal_4_0_i35);
	}
	MR_r4 = MR_tfield(3, MR_tempr1, 2);
	if (MR_INT_NE(MR_r4,1)) {
		MR_GOTO_LAB(transform_hlds__delay_construct__delay_construct_in_goal_4_0_i38);
	}
	MR_tempr2 = MR_tempr1;
	MR_sv(7) = MR_r2;
	MR_sv(1) = MR_r3;
...
MR_def_label(transform_hlds__delay_construct__delay_construct_in_goal_4_0,38)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_def_label(transform_hlds__delay_construct__delay_construct_in_goal_4_0,35)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_r5;
	MR_np_localcall_lab(transform_hlds__delay_construct__delay_construct_in_goal_4_0,
...
MR_def_label(transform_hlds__delay_construct__delay_construct_in_goal_4_0,34)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_RTAGS_TESTR(MR_r4,3,4)) {
		MR_GOTO_LAB(transform_hlds__delay_construct__delay_construct_in_goal_4_0_i44);
	}
	MR_incr_sp(8);
	MR_sv(8) = (MR_Word) MR_succip;
	MR_sv(2) = MR_tfield(0, MR_r1, 1);
	...
	MR_np_call_localret_ent(transform_hlds__delay_construct__delay_construct_in_cases_4_0,
		transform_hlds__delay_construct__delay_construct_in_goal_4_0_i45);
MR_def_label(transform_hlds__delay_construct__delay_construct_in_goal_4_0,45)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
...
MR_def_label(transform_hlds__delay_construct__delay_construct_in_goal_4_0,44)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_string_const("transform_hlds.delay_construct", 30);
	MR_r2 = (MR_Word) MR_string_const("predicate \140transform_hlds.delay_construct.delay_construct_in_goal\'/4", 68);
	MR_r3 = (MR_Word) MR_string_const("shorthand", 9);
	MR_np_tailcall_ent(require__unexpected_3_0);
MR_def_label(transform_hlds__delay_construct__delay_construct_in_goal_4_0,139)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_proceed();
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
...
MR_BEGIN_MODULE(transform_hlds__delay_construct_module2)
	...
	MR_init_label3(transform_hlds__delay_construct__delay_construct_in_goals_4_0,17,4,5)
MR_BEGIN_CODE
...
MR_def_static(transform_hlds__delay_construct__delay_construct_in_goals_4_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
		MR_GOTO_LAB(transform_hlds__delay_construct__delay_construct_in_goals_4_0_i17);
	}
	MR_r1 = (MR_Word) MR_tbmkword(0, 0);
	MR_proceed();
MR_def_label(transform_hlds__delay_construct__delay_construct_in_goals_4_0,17)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(4);
...
MR_BEGIN_MODULE(transform_hlds__delay_construct_module3)
	...
	MR_init_label3(transform_hlds__delay_construct__delay_construct_in_cases_4_0,18,4,6)
MR_BEGIN_CODE
...
MR_def_static(transform_hlds__delay_construct__delay_construct_in_cases_4_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
		MR_GOTO_LAB(transform_hlds__delay_construct__delay_construct_in_cases_4_0_i18);
	}
	MR_r1 = (MR_Word) MR_tbmkword(0, 0);
	MR_proceed();
MR_def_label(transform_hlds__delay_construct__delay_construct_in_cases_4_0,18)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(6);
...
MR_BEGIN_MODULE(transform_hlds__delay_construct_module4)
	MR_init_entry1(transform_hlds__delay_construct__delay_construct_proc_4_0);
	MR_INIT_PROC_LAYOUT_ADDR(mercury__transform_hlds__delay_construct__delay_construct_proc_4_0);
	MR_init_label9(transform_hlds__delay_construct__delay_construct_proc_4_0,2,3,4,5,6,7,8,10,11)
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'delay_construct_proc'/4 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_define_entry(mercury__transform_hlds__delay_construct__delay_construct_proc_4_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(6);
	MR_sv(6) = (MR_Word) MR_succip;
	MR_sv(3) = MR_r1;
	...
	MR_np_call_localret_ent(hlds__passes_aux__write_proc_progress_message_6_0,
		transform_hlds__delay_construct__delay_construct_proc_4_0_i2);
MR_def_label(transform_hlds__delay_construct__delay_construct_proc_4_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(3);
	MR_np_call_localret_ent(hlds__hlds_module__module_info_get_globals_2_0,
		transform_hlds__delay_construct__delay_construct_proc_4_0_i3);
MR_def_label(transform_hlds__delay_construct__delay_construct_proc_4_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_sv(4);
	...
	MR_np_call_localret_ent(hlds__hlds_module__module_info_pred_info_3_0,
		transform_hlds__delay_construct__delay_construct_proc_4_0_i4);
MR_def_label(transform_hlds__delay_construct__delay_construct_proc_4_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_sv(4);
	MR_np_call_localret_ent(hlds__hlds_pred__body_should_use_typeinfo_liveness_3_0,
		transform_hlds__delay_construct__delay_construct_proc_4_0_i5);
MR_def_label(transform_hlds__delay_construct__delay_construct_proc_4_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(4) = MR_r1;
	MR_r1 = MR_sv(5);
	MR_np_call_localret_ent(hlds__hlds_pred__proc_info_get_vartypes_2_0,
		transform_hlds__delay_construct__delay_construct_proc_4_0_i6);
MR_def_label(transform_hlds__delay_construct__delay_construct_proc_4_0,6)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(1) = MR_r1;
	MR_r1 = MR_sv(5);
	MR_np_call_localret_ent(hlds__hlds_pred__proc_info_get_rtti_varmaps_2_0,
		transform_hlds__delay_construct__delay_construct_proc_4_0_i7);
MR_def_label(transform_hlds__delay_construct__delay_construct_proc_4_0,7)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(2) = MR_r1;
	MR_r1 = MR_sv(5);
	MR_r2 = MR_sv(3);
	MR_np_call_localret_ent(hlds__hlds_pred__proc_info_get_initial_instmap_3_0,
		transform_hlds__delay_construct__delay_construct_proc_4_0_i8);
MR_def_label(transform_hlds__delay_construct__delay_construct_proc_4_0,8)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	...
	MR_np_call_localret_ent(hlds__hlds_pred__proc_info_get_goal_2_0,
		transform_hlds__delay_construct__delay_construct_proc_4_0_i10);
MR_def_label(transform_hlds__delay_construct__delay_construct_proc_4_0,10)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_sv(3);
	MR_r3 = MR_sv(4);
	MR_np_call_localret_ent(transform_hlds__delay_construct__delay_construct_in_goal_4_0,
		transform_hlds__delay_construct__delay_construct_proc_4_0_i11);
MR_def_label(transform_hlds__delay_construct__delay_construct_proc_4_0,11)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_sv(5);
...
MR_BEGIN_MODULE(transform_hlds__delay_construct_module5)
	...
	MR_init_label4(__Unify___transform_hlds__delay_construct__delay_construct_info_0_0,4,6,10,1)
MR_BEGIN_CODE
...
MR_def_static(__Unify___transform_hlds__delay_construct__delay_construct_info_0_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if ((MR_r1 == MR_r2)) {
		MR_GOTO_LAB(__Unify___transform_hlds__delay_construct__delay_construct_info_0_0_i10);
	}
	MR_incr_sp(7);
...
MR_def_label(__Unify___transform_hlds__delay_construct__delay_construct_info_0_0,4)
	...
	MR_np_call_localret_ent(builtin__unify_2_0,
		__Unify___transform_hlds__delay_construct__delay_construct_info_0_0_i6);
MR_def_label(__Unify___transform_hlds__delay_construct__delay_construct_info_0_0,6)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(__Unify___transform_hlds__delay_construct__delay_construct_info_0_0_i1);
	}
...
MR_def_label(__Unify___transform_hlds__delay_construct__delay_construct_info_0_0,10)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_TRUE;
	MR_proceed();
...
MR_BEGIN_MODULE(transform_hlds__delay_construct_module6)
	...
	MR_init_label6(__Compare___transform_hlds__delay_construct__delay_construct_info_0_0,3,2,5,9,13,37)
MR_BEGIN_CODE
...
MR_def_label(__Compare___transform_hlds__delay_construct__delay_construct_info_0_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___transform_hlds__delay_construct__delay_construct_info_0_0_i37);
	}
	MR_r1 = MR_sv(1);
	MR_r2 = MR_sv(4);
...
MR_def_label(__Compare___transform_hlds__delay_construct__delay_construct_info_0_0,9)
	...
	MR_np_call_localret_ent(builtin__compare_3_0,
		__Compare___transform_hlds__delay_construct__delay_construct_info_0_0_i13);
MR_def_label(__Compare___transform_hlds__delay_construct__delay_construct_info_0_0,13)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___transform_hlds__delay_construct__delay_construct_info_0_0_i37);
	}
...
MR_def_label(__Compare___transform_hlds__delay_construct__delay_construct_info_0_0,37)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(7);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
...
void mercury__transform_hlds__delay_construct__init_threadscope_string_table(void);
#endif
...
void mercury__transform_hlds__delay_construct__write_out_proc_statics(FILE *deep_fp, FILE *procrep_fp)
{
	MR_write_out_module_proc_reps_start(procrep_fp, &mercury_data__module_layout__transform_hlds__delay_construct);
