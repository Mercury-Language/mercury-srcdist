...
MR_decl_label6(__Compare___transform_hlds__delay_construct__delay_construct_info_0_0, 3,2,5,9,13,49)
...
MR_BEGIN_MODULE(transform_hlds__delay_construct_module6)
	...
	MR_init_label6(__Compare___transform_hlds__delay_construct__delay_construct_info_0_0,3,2,5,9,13,49)
MR_BEGIN_CODE
...
MR_def_label(__Compare___transform_hlds__delay_construct__delay_construct_info_0_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___transform_hlds__delay_construct__delay_construct_info_0_0_i49);
	}
	MR_r1 = MR_sv(1);
	MR_r2 = MR_sv(4);
...
MR_def_label(__Compare___transform_hlds__delay_construct__delay_construct_info_0_0,49)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(7);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
