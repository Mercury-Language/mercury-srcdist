...
MR_decl_label3(transform_hlds__delay_construct__delay_construct_in_cases_4_0, 13,4,5)
MR_decl_label8(transform_hlds__delay_construct__delay_construct_in_conj_6_0, 86,3,5,6,12,13,15,16)
MR_decl_label8(transform_hlds__delay_construct__delay_construct_in_conj_6_0, 18,7,8,21,23,25,27,28)
MR_decl_label8(transform_hlds__delay_construct__delay_construct_in_conj_6_0, 29,30,32,34,20,35,36,37)
...
MR_decl_label3(transform_hlds__delay_construct__delay_construct_in_goals_4_0, 13,4,5)
...
MR_BEGIN_MODULE(transform_hlds__delay_construct_module1)
	...
	MR_init_label8(transform_hlds__delay_construct__delay_construct_in_conj_6_0,86,3,5,6,12,13,15,16)
	MR_init_label8(transform_hlds__delay_construct__delay_construct_in_conj_6_0,18,7,8,21,23,25,27,28)
	MR_init_label8(transform_hlds__delay_construct__delay_construct_in_conj_6_0,29,30,32,34,20,35,36,37)
MR_BEGIN_CODE
...
MR_def_label(transform_hlds__delay_construct__delay_construct_in_conj_6_0,8)
	...
	MR_np_call_localret_ent(__Unify___hlds__hlds_goal__hlds_goal_expr_0_0,
		transform_hlds__delay_construct__delay_construct_in_conj_6_0_i21);
MR_def_label(transform_hlds__delay_construct__delay_construct_in_conj_6_0,21)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(transform_hlds__delay_construct__delay_construct_in_conj_6_0_i20);
	}
	MR_r1 = MR_sv(8);
	MR_r2 = MR_sv(9);
...
MR_BEGIN_MODULE(transform_hlds__delay_construct_module3)
	...
	MR_init_label3(transform_hlds__delay_construct__delay_construct_in_goals_4_0,13,4,5)
MR_BEGIN_CODE
...
MR_def_static(transform_hlds__delay_construct__delay_construct_in_goals_4_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
		MR_GOTO_LAB(transform_hlds__delay_construct__delay_construct_in_goals_4_0_i13);
	}
	MR_r1 = (MR_Word) MR_tbmkword(0, 0);
	MR_proceed();
MR_def_label(transform_hlds__delay_construct__delay_construct_in_goals_4_0,13)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(4);
...
MR_BEGIN_MODULE(transform_hlds__delay_construct_module4)
	...
	MR_init_label3(transform_hlds__delay_construct__delay_construct_in_cases_4_0,13,4,5)
MR_BEGIN_CODE
...
MR_def_static(transform_hlds__delay_construct__delay_construct_in_cases_4_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
		MR_GOTO_LAB(transform_hlds__delay_construct__delay_construct_in_cases_4_0_i13);
	}
	MR_r1 = (MR_Word) MR_tbmkword(0, 0);
	MR_proceed();
MR_def_label(transform_hlds__delay_construct__delay_construct_in_cases_4_0,13)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(5);
