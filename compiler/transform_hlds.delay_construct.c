...
MR_decl_label10(transform_hlds__delay_construct__delay_construct_in_goal_4_0, 25,26,27,28,29,24,33,32,37,40)
MR_decl_label5(transform_hlds__delay_construct__delay_construct_in_goal_4_0, 36,45,44,125,124)
...
MR_BEGIN_MODULE(transform_hlds__delay_construct_module2)
	...
	MR_init_label10(transform_hlds__delay_construct__delay_construct_in_goal_4_0,25,26,27,28,29,24,33,32,37,40)
	MR_init_label5(transform_hlds__delay_construct__delay_construct_in_goal_4_0,36,45,44,125,124)
MR_BEGIN_CODE
...
MR_def_static(transform_hlds__delay_construct__delay_construct_in_goal_4_0)
	...
	if ((((((MR_tag(MR_tempr1) == MR_mktag((MR_Integer) 3)) && ((MR_Integer) MR_tfield(3, MR_tempr1, 0) == (MR_Integer) 0)) || (MR_tag(MR_tempr1) == MR_mktag((MR_Integer) 2))) || (MR_tag(MR_tempr1) == MR_mktag((MR_Integer) 1))) || (MR_tag(MR_tempr1) == MR_mktag((MR_Integer) 0)))) {
		MR_GOTO_LAB(transform_hlds__delay_construct__delay_construct_in_goal_4_0_i125);
	}
...
MR_def_label(transform_hlds__delay_construct__delay_construct_in_goal_4_0,125)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_proceed();
