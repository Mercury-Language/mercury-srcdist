                ...
                case (MR_Integer) 0:
                  {
                    ...
                    if (succeeded)
                    {
                      ...
                      transform_hlds__delay_construct__delay_construct_in_conj_6_p_0(Goals0_12, InstMap0_6, DelayInfo_7, Var_71, (MR_Word) ((MR_Integer) 0), &Goals1_16);
                    }
                    else
                      Goals1_16 = Goals0_12;
                  }
    ...
    else
    {
      ...
      else
      {
        ...
        else
        {
          ...
          transform_hlds__delay_construct__delay_construct_in_conj_6_p_0(Goals0_13, InstMap1_22, DelayInfo_3, Var_53, (MR_Word) ((MR_Integer) 0), &Goals1_56);
          {
