  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        succeeded = mercury__builtin__unify_2_p_0(TypeCtorInfo__14_14, ((MR_Box) (ArgX3_7)), ((MR_Box) (ArgY3_8)));
        if (succeeded)
  ...
  MR_Word * STATE_VARIABLE_ProcInfo_21)
{
  ...
  hlds__hlds_pred__proc_info_get_varset_vartypes_3_p_0(STATE_VARIABLE_ProcInfo_0_20, &_VarSet_13, &VarTypes_14);
  hlds__hlds_pred__proc_info_get_rtti_varmaps_2_p_0(STATE_VARIABLE_ProcInfo_0_20, &RttiVarMaps_15);
  hlds__hlds_pred__proc_info_get_initial_instmap_3_p_0(ModuleInfo_5, STATE_VARIABLE_ProcInfo_0_20, &InstMap0_16);
  {
    DelayInfo_17 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(MR_mktag(0), DelayInfo_17, 0) = ((MR_Box) (ModuleInfo_5));
    MR_hl_field(MR_mktag(0), DelayInfo_17, 1) = (MR_Box) ((MR_Unsigned) (BodyTypeinfoLiveness_12));
    MR_hl_field(MR_mktag(0), DelayInfo_17, 2) = ((MR_Box) (VarTypes_14));
    MR_hl_field(MR_mktag(0), DelayInfo_17, 3) = ((MR_Box) (RttiVarMaps_15));
  }
  hlds__hlds_pred__proc_info_get_goal_2_p_0(STATE_VARIABLE_ProcInfo_0_20, &Goal0_18);
  transform_hlds__delay_construct__delay_construct_in_goal_4_p_0(Goal0_18, InstMap0_16, DelayInfo_17, &Goal_19);
  hlds__hlds_pred__proc_info_set_goal_3_p_0(Goal_19, STATE_VARIABLE_ProcInfo_0_20, STATE_VARIABLE_ProcInfo_21);
}
    ...
    case (MR_Integer) 0:
      {
        ...
        Var_68 = (MR_Word) ((MR_Word) (NegGoal_19));
        {
          MR_Word base;
        ...
        case (MR_Integer) 2:
          {
              ...
              case (MR_Integer) 0:
                {
                  ...
                  if (succeeded)
                  {
                    ...
                    Var_70 = mercury__set__init_0_f_0((MR_Word) (&transform_hlds__delay_construct_scalar_common_1[0]));
                    transform_hlds__delay_construct__delay_construct_in_conj_6_p_0(Goals0_12, InstMap0_6, DelayInfo_7, Var_70, (MR_Word) ((MR_Unsigned) 0U), &Goals1_16);
                  }
                  else
                    Goals1_16 = Goals0_12;
                }
            ...
            transform_hlds__delay_construct__delay_construct_in_goals_4_p_0(Goals1_16, InstMap0_6, DelayInfo_7, &Goals_17);
            {
              ...
              MR_hl_field(MR_mktag(3), Var_72, 1) = (MR_Box) ((MR_Unsigned) (ConjType_11));
              MR_hl_field(MR_mktag(3), Var_72, 2) = ((MR_Box) (Goals_17));
            }
            {
              MR_Word base;
              base = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
        ...
        case (MR_Integer) 3:
          {
            ...
            transform_hlds__delay_construct__delay_construct_in_goals_4_p_0(Goals0_73, InstMap0_6, DelayInfo_7, &Goals_74);
            {
              ...
              MR_hl_field(MR_mktag(3), Var_69, 1) = ((MR_Box) (Goals_74));
            }
            {
              MR_Word base;
              base = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
        ...
        case (MR_Integer) 4:
          {
            ...
            {
              Var_67 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(3), Var_67, 0) = ((MR_Box) ((MR_Unsigned) 4U));
              MR_hl_field(MR_mktag(3), Var_67, 1) = ((MR_Box) (Var_20));
              MR_hl_field(MR_mktag(3), Var_67, 2) = (MR_Box) ((MR_Unsigned) (CanFail_75));
              MR_hl_field(MR_mktag(3), Var_67, 3) = ((MR_Box) (Cases_22));
            }
            {
              MR_Word base;
              base = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
        ...
        case (MR_Integer) 5:
          {
            ...
            else
            {
              ...
              transform_hlds__delay_construct__delay_construct_in_goal_4_p_0(SubGoal0_35, InstMap0_6, DelayInfo_7, &SubGoal_38);
              {
                ...
                MR_hl_field(MR_mktag(3), Var_65, 1) = ((MR_Box) (Reason_34));
                MR_hl_field(MR_mktag(3), Var_65, 2) = ((MR_Box) (SubGoal_38));
              }
              {
                MR_Word base;
                base = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
        ...
        case (MR_Integer) 6:
          {
            ...
            {
              Var_66 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(3), Var_66, 0) = ((MR_Box) ((MR_Unsigned) 6U));
              MR_hl_field(MR_mktag(3), Var_66, 1) = ((MR_Box) (Vars_23));
              MR_hl_field(MR_mktag(3), Var_66, 2) = ((MR_Box) (Cond_31));
              MR_hl_field(MR_mktag(3), Var_66, 3) = ((MR_Box) (Then_32));
              MR_hl_field(MR_mktag(3), Var_66, 4) = ((MR_Box) (Else_33));
            }
            {
              MR_Word base;
              base = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
      ...
      else
      {
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            ...
            {
              MR_Word Var_94 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(2), GoalExpr0_19, (MR_Integer) 3))) & (MR_Integer) 1);
            ...
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                ...
                TypeCtorInfo__74_74 = (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0);
                Var_51 = parse_tree__set_of_var__set_to_bitset_1_f_0(TypeCtorInfo__74_74, ConstructedVars0_4);
                parse_tree__set_of_var__intersect_3_p_0(TypeCtorInfo__74_74, CompletedNonLocals_42, Var_51, &Intersection_43);
                succeeded = parse_tree__set_of_var__is_empty_1_p_0(TypeCtorInfo__74_74, Intersection_43);
                if (succeeded)
                {
