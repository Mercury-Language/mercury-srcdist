                ...
                case (MR_Integer) 0:
                  {
                    ...
                    if (succeeded)
                    {
                      ...
                      transform_hlds__delay_construct__delay_construct_in_conj_6_p_0(Goals0_12, InstMap0_6, DelayInfo_7, Var_71, (MR_Word) ((MR_Unsigned) 0U), &Goals1_16);
                    }
                    else
                      Goals1_16 = Goals0_12;
                  }
          ...
          case (MR_Integer) 4:
            {
              ...
              transform_hlds__delay_construct__delay_construct_in_cases_4_p_0(Cases0_21, InstMap0_6, DelayInfo_7, &Cases_22);
              {
                ...
                MR_hl_field(MR_mktag(3), Var_68, 2) = (MR_Box) (packed_args_2);
          ...
          case (MR_Integer) 5:
            {
              ...
              if (succeeded)
              {
                packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Reason_34, (MR_Integer) 2)));
          ...
          case (MR_Integer) 6:
            {
              ...
              transform_hlds__delay_construct__delay_construct_in_goal_4_p_0(Else0_26, InstMap0_6, DelayInfo_7, &Else_33);
              {
                ...
                MR_hl_field(MR_mktag(3), Var_67, 0) = ((MR_Box) ((MR_Unsigned) 6U));
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Unif_26, (MR_Integer) 5)));
          ...
          if (succeeded)
          {
            ...
            packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), DelayInfo_3, (MR_Integer) 1)));
            ...
            if (succeeded)
            {
              ...
              packed_args_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), DelayInfo_3, (MR_Integer) 1)));
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            if (((MR_tag((MR_Word) GoalExpr0_19)) == (MR_Integer) 2))
            {
              ...
              MR_Unsigned packed_args_3 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), GoalExpr0_19, (MR_Integer) 3)));
            ...
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                ...
                packed_args_4 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), DelayInfo_3, (MR_Integer) 1)));
                Var_48 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), DelayInfo_3, (MR_Integer) 1))) & (MR_Integer) 1);
