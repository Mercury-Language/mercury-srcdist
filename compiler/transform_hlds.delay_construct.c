...
MR_decl_label8(transform_hlds__delay_construct__delay_construct_in_conj_6_0, 92,3,5,6,12,13,15,16)
MR_decl_label8(transform_hlds__delay_construct__delay_construct_in_conj_6_0, 19,7,8,23,25,27,29,30)
MR_decl_label8(transform_hlds__delay_construct__delay_construct_in_conj_6_0, 32,33,35,37,22,39,41,42)
MR_decl_label8(transform_hlds__delay_construct__delay_construct_in_goal_4_0, 76,6,7,8,14,15,9,17)
MR_decl_label8(transform_hlds__delay_construct__delay_construct_in_goal_4_0, 77,21,81,25,26,27,28,29)
MR_decl_label8(transform_hlds__delay_construct__delay_construct_in_goal_4_0, 79,33,80,37,40,78,43,75)
MR_decl_label3(transform_hlds__delay_construct__delay_construct_in_goals_4_0, 14,4,5)
MR_decl_label8(transform_hlds__delay_construct__delay_construct_proc_7_0, 2,3,4,5,6,7,8,10)
MR_decl_label1(transform_hlds__delay_construct__delay_construct_proc_7_0, 11)
...
MR_BEGIN_MODULE(transform_hlds__delay_construct_module1)
	...
	MR_init_label8(transform_hlds__delay_construct__delay_construct_in_conj_6_0,92,3,5,6,12,13,15,16)
	MR_init_label8(transform_hlds__delay_construct__delay_construct_in_conj_6_0,19,7,8,23,25,27,29,30)
	MR_init_label8(transform_hlds__delay_construct__delay_construct_in_conj_6_0,32,33,35,37,22,39,41,42)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(transform_hlds__delay_construct_module2)
	...
	MR_init_label8(transform_hlds__delay_construct__delay_construct_in_goal_4_0,76,6,7,8,14,15,9,17)
	MR_init_label8(transform_hlds__delay_construct__delay_construct_in_goal_4_0,77,21,81,25,26,27,28,29)
	MR_init_label8(transform_hlds__delay_construct__delay_construct_in_goal_4_0,79,33,80,37,40,78,43,75)
MR_BEGIN_CODE
...
MR_def_static(transform_hlds__delay_construct__delay_construct_in_goal_4_0)
	...
	if (MR_INT_NE(MR_tag(MR_tempr1),3)) {
		MR_GOTO_LAB(transform_hlds__delay_construct__delay_construct_in_goal_4_0_i75);
	}
	MR_COMPUTED_GOTO((MR_Unsigned) MR_ctfield(3, MR_tempr1, 0),
		MR_LABEL_AP(transform_hlds__delay_construct__delay_construct_in_goal_4_0_i75) MR_AND
		MR_LABEL_AP(transform_hlds__delay_construct__delay_construct_in_goal_4_0_i76) MR_AND
		MR_LABEL_AP(transform_hlds__delay_construct__delay_construct_in_goal_4_0_i77) MR_AND
		MR_LABEL_AP(transform_hlds__delay_construct__delay_construct_in_goal_4_0_i78) MR_AND
		MR_LABEL_AP(transform_hlds__delay_construct__delay_construct_in_goal_4_0_i79) MR_AND
		MR_LABEL_AP(transform_hlds__delay_construct__delay_construct_in_goal_4_0_i80) MR_AND
		MR_LABEL_AP(transform_hlds__delay_construct__delay_construct_in_goal_4_0_i81) MR_AND
		MR_LABEL_AP(transform_hlds__delay_construct__delay_construct_in_goal_4_0_i40));
	}
MR_def_label(transform_hlds__delay_construct__delay_construct_in_goal_4_0,76)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(8);
...
MR_def_label(transform_hlds__delay_construct__delay_construct_in_goal_4_0,77)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(8);
	MR_sv(8) = (MR_Word) MR_succip;
	MR_sv(1) = MR_ctfield(0, MR_r1, 1);
...
MR_def_label(transform_hlds__delay_construct__delay_construct_in_goal_4_0,81)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(8);
	MR_sv(8) = (MR_Word) MR_succip;
	MR_sv(1) = MR_ctfield(0, MR_r1, 1);
...
MR_def_label(transform_hlds__delay_construct__delay_construct_in_goal_4_0,79)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(8);
	MR_sv(8) = (MR_Word) MR_succip;
	MR_sv(1) = MR_ctfield(0, MR_r1, 1);
...
MR_def_label(transform_hlds__delay_construct__delay_construct_in_goal_4_0,80)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(8);
	MR_sv(8) = (MR_Word) MR_succip;
	MR_sv(1) = MR_ctfield(0, MR_r1, 1);
	...
	MR_np_localcall_lab(transform_hlds__delay_construct__delay_construct_in_goal_4_0,
		transform_hlds__delay_construct__delay_construct_in_goal_4_0_i37);
...
MR_def_label(transform_hlds__delay_construct__delay_construct_in_goal_4_0,78)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(8);
	MR_sv(8) = (MR_Word) MR_succip;
	MR_sv(1) = MR_ctfield(0, MR_r1, 1);
	...
	MR_np_call_localret_ent(transform_hlds__delay_construct__delay_construct_in_cases_4_0,
		transform_hlds__delay_construct__delay_construct_in_goal_4_0_i43);
...
MR_def_label(transform_hlds__delay_construct__delay_construct_in_goal_4_0,75)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_proceed();
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
...
MR_BEGIN_MODULE(transform_hlds__delay_construct_module5)
	...
	MR_init_label8(transform_hlds__delay_construct__delay_construct_proc_7_0,2,3,4,5,6,7,8,10)
	MR_init_label1(transform_hlds__delay_construct__delay_construct_proc_7_0,11)
MR_BEGIN_CODE
