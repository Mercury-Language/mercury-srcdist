...
ifeq ($(TARGET_ASM),yes)
libs.file_util.mh libs.file_util.mih : libs.file_util.s
else
libs.file_util.mh libs.file_util.mih : libs.file_util.c
endif

ifeq ($(TARGET_ASM),yes)
libs.file_util.module_dep : libs.file_util.s
else
 ifeq ($(findstring il,$(GRADE)),il)
libs.file_util.module_dep : libs.file_util.il
  ifeq ($(findstring java,$(GRADE)),java)
libs.file_util.module_dep : mercury/libs_/file_util.java
  else
...
ifeq ($(TARGET_ASM),yes)
libs.file_util.s_date : file_util.m
	$(MCG) $(ALL_GRADEFLAGS) $(ALL_MCGFLAGS) --target-code-only libs.file_util $(ERR_REDIRECT)
libs.file_util.pic_s_date : file_util.m
	$(MCG) $(ALL_GRADEFLAGS) $(ALL_MCGFLAGS) --target-code-only --pic \
		--cflags "$(GCCFLAGS_FOR_PIC)" libs.file_util $(ERR_REDIRECT)
endif # TARGET_ASM
