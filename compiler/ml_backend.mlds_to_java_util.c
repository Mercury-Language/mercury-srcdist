...
static /* final */ const MR_Box ml_backend__mlds_to_java_util_scalar_common_1[2][3];

static /* final */ const MR_Box ml_backend__mlds_to_java_util_scalar_common_2[3][2];
...
static /* final */ const MR_Box ml_backend__mlds_to_java_util_scalar_common_2[3][2] = {
  ...
  /* row 1 */
  {
    ...
    ((MR_Box) (&ml_backend__mlds_to_java_util_scalar_common_2[0]))
  },
  /* row 2 */
  {
...
{
  {
    ...
    else
    {
      ...
      {
        mercury__builtin__compare_3_p_0((MR_Word) (&ml_backend__mlds_to_java_util_scalar_common_2[2]), HeadVar__1_1, ((MR_Box) (ArgX2_7)), ((MR_Box) (ArgY2_8)));
      }
    }
  }
}
...
{
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        TypeInfo_9_9 = (MR_Word) (&ml_backend__mlds_to_java_util_scalar_common_2[2]);
            ...
            else
            {
              ...
              else
              {
                ...
                else
                {
                  ...
                  mercury__builtin__compare_3_p_0((MR_Word) (&ml_backend__mlds_to_java_util_scalar_common_1[0]), &SubResult7_24, ((MR_Box) (ArgX7_22)), ((MR_Box) (ArgY7_23)));
                  ...
                  else
                  {
                    ...
                    else
                    {
                      ...
                      {
                        mercury__builtin__compare_3_p_0((MR_Word) (&ml_backend__mlds_to_java_util_scalar_common_2[1]), HeadVar__1_1, ((MR_Box) (ArgX10_31)), ((MR_Box) (ArgY10_32)));
                      }
                    }
                  }
                }
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                ...
                if (succeeded)
                {
                  TypeInfo_27_27 = (MR_Word) (&ml_backend__mlds_to_java_util_scalar_common_1[0]);
                  ...
                  if (succeeded)
                  {
                    ...
                    if (succeeded)
                    {
                      ...
                      if (succeeded)
                      {
                        TypeInfo_28_28 = (MR_Word) (&ml_backend__mlds_to_java_util_scalar_common_2[1]);
...
{
  {
    ...
    mercury__string__foldl2_6_p_2((MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0), (MR_Word) (&mercury__builtin__builtin__type_ctor_info_character_0), (MR_Word) (&ml_backend__mlds_to_java_util_scalar_common_1[1]), Code_9, ((MR_Box) ((MR_Integer) 1)), &conv3_Var_23, ((MR_Box) (MR_Word) ((MR_Char) 120)), &conv2_Var_56);
