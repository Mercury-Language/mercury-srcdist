...
#line 132 "mlds_to_java_util.m"
void 
ml_backend__mlds_to_java_util__user_init_pred_36_0(void)
#line 132 "mlds_to_java_util.m"
{
#line 132 "mlds_to_java_util.m"
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                TypeInfo__27_27 = (MR_Word) (&ml_backend__mlds_to_java_util_scalar_common_2[0]);
                ...
                if (succeeded)
                {
                  ...
                  if (succeeded)
                  {
                    ...
                    if (succeeded)
                    {
                      TypeInfo__28_28 = (MR_Word) (&ml_backend__mlds_to_java_util_scalar_common_1[2]);
  ...
  MR_Word HeadVar__2_2)
{
  ...
  else
  {
    ...
    if (succeeded)
    {
      TypeInfo__9_9 = (MR_Word) (&ml_backend__mlds_to_java_util_scalar_common_1[0]);
...
void MR_CALL 
ml_backend__mlds_to_java_util__maybe_output_comment_for_java_5_p_0(
  MR_Word Info_6,
  MR_Word Stream_7,
  MR_String Comment_8)
{
  ...
  MR_Word Context_12)
{
  ...
  MR_Word Var_19 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Info_8, (MR_Integer) 1))) & (MR_Integer) 1);
  MR_Integer Var_24;
  MR_Integer Var_25;
  MR_Word Var_26;
  MR_Box conv3_Var_25;
  ...
  File_14 = ((MR_String) ((MR_hl_field(MR_mktag(0), Context_12, (MR_Integer) 0))));
  Lines0_15 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), Context_12, (MR_Integer) 1))));
  mercury__string__foldl2_6_p_2((MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0), (MR_Word) (&mercury__builtin__builtin__type_ctor_info_character_0), (MR_Word) (&ml_backend__mlds_to_java_util_scalar_common_2[1]), Code_11, ((MR_Box) ((MR_Integer) 1)), &conv3_Var_25, ((MR_Box) (MR_Word) ((MR_Char) 120)), &conv2_Var_48);
  ...
  Var_24 = (MR_Integer) ((MR_Unsigned) Lines0_15 + (MR_Unsigned) Var_25);
  {
    ...
    MR_hl_field(MR_mktag(0), ContextEnd_16, 0) = ((MR_Box) (File_14));
    MR_hl_field(MR_mktag(0), ContextEnd_16, 1) = ((MR_Box) (Var_24));
  }
  ...
  MR_Integer N_12)
{
  ...
  ml_backend__mlds_to_target_util__output_n_indents_4_p_0(Stream_8, N_12);
}
...
#undef MR_PROC_LABEL
        ...
        mercury__term__context_file_2_p_0(ProgContext_10, &File_13);
        mercury__term__context_line_2_p_0(ProgContext_10, &Line_14);
        succeeded = (Marker_9 == (MR_Integer) 2);
        if (succeeded)
        {
          succeeded = mercury__term____Unify____context_0_0(ProgContext_10, LastContext_12);
          succeeded = !(succeeded);
          if (succeeded)
          {
            Var_19 = (MR_Integer) 0;
        ...
        if (succeeded)
        {
          ...
          mercury__io__write_string_4_p_0(Stream_7, (MR_String) ":");
          mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&ml_backend__mlds_to_java_util_scalar_common_3[0]), Line_14, &Var_42);
  ...
  MR_Word Info_3)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_6, (MR_Integer) 362, &DebugClassInit_4);
...
{
	ml_backend__mlds_to_java_util__user_init_pred_36_0();
}
