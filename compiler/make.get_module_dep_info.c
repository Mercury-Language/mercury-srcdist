...
make__get_module_dep_info__cleanup_module_dep_file_7_p_0(
  ...
  MR_Word * STATE_VARIABLE_Info_14)
{
  make__util__remove_module_file_for_make_9_p_0(ProgressStream_8, Globals_9, (MR_Integer) 137, ModuleName_10, (MR_Word) (MR_mkword(1, &make__get_module_dep_info_scalar_common_2[0])), STATE_VARIABLE_Info_0_13, STATE_VARIABLE_Info_14);
}
