...
make__get_module_dep_info__IntroducedFrom__func__write_module_dep_files_for_source_file__606__1_1_f_0(
  ...
  MR_Box wrapper_arg_1)
{
  ...
  conv0_LambdaHeadVar__2_58 = make__get_module_dep_info__IntroducedFrom__func__write_module_dep_files_for_source_file__606__1_1_f_0(((MR_Word) (wrapper_arg_1)));
  ...
  MR_Word * STATE_VARIABLE_Info_53)
{
  ...
  if (succeeded)
  {
    ...
    else
    {
      ...
      parse_tree__write_error_spec__write_oom_diag_specs_5_p_0(ErrorStream_17, Globals_14, MSISpecs_43);
