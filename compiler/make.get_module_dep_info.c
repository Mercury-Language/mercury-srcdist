...
make__get_module_dep_info__IntroducedFrom__func__write_module_dep_files_for_source_file__597__1_1_f_0(
...
make__get_module_dep_info__do_get_maybe_module_dep_info_9_p_0(
  ...
  MR_Word * STATE_VARIABLE_MaybeModuleDepInfo_47,
  ...
  MR_Word * STATE_VARIABLE_Info_49)
{
  ...
  MR_Word SearchAuthDirs_21;
  MR_Word SearchDirs_22;
  MR_Word MaybeDepFileTimestamp_23;
  MR_Word ModuleDepMap2_43;
  MR_Word MaybeOldMaybeModuleDepInfo_44;
  MR_Word ModuleDepMap_45;
  ...
  libs__globals__get_options_2_p_0(Globals_11, &OptionTable_20);
  SearchAuthDirs_21 = parse_tree__find_module__get_search_auth_normal_dirs_1_f_0(OptionTable_20);
  make__timestamp__get_file_timestamp_8_p_0(SearchAuthDirs_21, DepFileName_18, &SearchDirs_22, &MaybeDepFileTimestamp_23, STATE_VARIABLE_Info_0_48, &STATE_VARIABLE_Info_54_54);
  if (((MR_tag((MR_Word) MaybeDepFileTimestamp_23)) == (MR_Integer) 1))
  {
    MR_String SearchDirsString_38;
    ...
    Var_89 = mercury__list__map_2_f_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&make__get_module_dep_info_scalar_common_5[3]), SearchDirs_22);
    SearchDirsString_38 = mercury__string__join_list_2_f_0((MR_String) ", ", Var_89);
    {
    ...
    }
    {
      ...
      MR_hl_field(3, Var_101, 1) = ((MR_Box) (SearchDirsString_38));
    }
    {
    ...
    make__util__debug_make_msg_3_p_0(Globals_11, Var_96, &DebugMsg_40);
    make__util__maybe_write_msg_4_p_0(ProgressStream_10, DebugMsg_40);
    switch (RebuildModuleDeps_12) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 1:
        {
          MR_Word ModuleDepMap0_41;
          MR_Word ModuleDepMap1_42;

          ModuleDepMap0_41 = make__make_info__make_info_get_maybe_module_dep_info_map_1_f_0(STATE_VARIABLE_Info_54_54);
          mercury__map__set_4_p_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), (MR_Word) (&make__make_info__make__make_info__type_ctor_info_maybe_module_dep_info_0), ((MR_Box) (ModuleName_13)), ((MR_Box) ((MR_Unsigned) 0U)), ModuleDepMap0_41, &ModuleDepMap1_42);
          make__make_info__make_info_set_maybe_module_dep_info_map_3_p_0(ModuleDepMap1_42, STATE_VARIABLE_Info_54_54, &STATE_VARIABLE_Info_62_62);
        }
        break;
      case (MR_Integer) 0:
  ...
  {
    MR_Word DepFileTimestamp_24 = ((MR_Word) ((MR_hl_field(0, MaybeDepFileTimestamp_23, (MR_Integer) 0))));
    MR_String SourceFileName_25;
    MR_Word MaybeSourceFileTimestamp_27;
    MR_Word STATE_VARIABLE_Info_58_58;
    MR_Word _SearchDirs_26;

    parse_tree__file_names__module_name_to_source_file_name_4_p_0(ModuleName_13, &SourceFileName_25);
    make__timestamp__get_file_timestamp_8_p_0((MR_Word) ((MR_Unsigned) 0U), SourceFileName_25, &_SearchDirs_26, &MaybeSourceFileTimestamp_27, STATE_VARIABLE_Info_54_54, &STATE_VARIABLE_Info_58_58);
    if (((MR_tag((MR_Word) MaybeSourceFileTimestamp_27)) == (MR_Integer) 1))
    {
      MR_Word Var_66;
      ...
      MR_Word ModuleDepInfo0_30;
      MR_String DepFileDir_31;
      MR_String Var_124;

      {
        Var_66 = (MR_Word) MR_mkword(3, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(3, Var_66, 0) = ((MR_Box) ((MR_Unsigned) 1U));
        MR_hl_field(3, Var_66, 1) = ((MR_Box) (OptionTable_20));
      }
      make__get_module_dep_info__find_and_read_module_dep_file_9_p_0(ProgressStream_10, Globals_11, RebuildModuleDeps_12, Var_66, ModuleName_13, STATE_VARIABLE_Info_58_58, &STATE_VARIABLE_Info_67_67);
      ...
      if (succeeded)
      {
        ModuleDepInfo0_30 = ((MR_Word) ((MR_hl_field(1, STATE_VARIABLE_MaybeModuleDepInfo_70_70, (MR_Integer) 0))));
        parse_tree__module_dep_info__module_dep_info_get_source_file_dir_2_p_0(ModuleDepInfo0_30, &DepFileDir_31);
        Var_124 = mercury__dir__this_directory_0_f_0();
        succeeded = (strcmp(DepFileDir_31, Var_124) == 0);
      }
      if (succeeded)
      {
        MR_String SourceFileName1_32;
        MR_Word MaybeSourceFileTimestamp1_34;
        MR_Word STATE_VARIABLE_Info_72_72;
        MR_Word _SearchCurDirs1_33;

        parse_tree__module_dep_info__module_dep_info_get_source_file_name_2_p_0(ModuleDepInfo0_30, &SourceFileName1_32);
        make__timestamp__get_file_timestamp_8_p_0((MR_Word) ((MR_Unsigned) 0U), SourceFileName1_32, &_SearchCurDirs1_33, &MaybeSourceFileTimestamp1_34, STATE_VARIABLE_Info_67_67, &STATE_VARIABLE_Info_72_72);
        if (((MR_tag((MR_Word) MaybeSourceFileTimestamp1_34)) == (MR_Integer) 1))
        {
          MR_String Message_36 = ((MR_String) ((MR_hl_field(1, MaybeSourceFileTimestamp1_34, (MR_Integer) 0))));
          MR_Word Var_86;

          mercury__io__write_string_4_p_0(ProgressStream_10, (MR_String) "** Error reading file \140");
          mercury__io__write_string_4_p_0(ProgressStream_10, SourceFileName1_32);
          mercury__io__write_string_4_p_0(ProgressStream_10, (MR_String) "\' to generate dependencies: ");
          mercury__io__write_string_4_p_0(ProgressStream_10, Message_36);
        ...
        {
          MR_Word SourceFileTimestamp1_35 = ((MR_Word) ((MR_hl_field(0, MaybeSourceFileTimestamp1_34, (MR_Integer) 0))));
          ...
          if (!(succeeded))
          {
            ...
            libs__timestamp____Compare____timestamp_0_0(&Var_125, DepFileTimestamp_24, SourceFileTimestamp1_35);
    ...
    {
      MR_Word SourceFileTimestamp_28 = ((MR_Word) ((MR_hl_field(0, MaybeSourceFileTimestamp_27, (MR_Integer) 0))));
      ...
      if (!(succeeded))
      {
        ...
        libs__timestamp____Compare____timestamp_0_0(&Var_123, DepFileTimestamp_24, SourceFileTimestamp_28);
  ...
  ModuleDepMap2_43 = make__make_info__make_info_get_maybe_module_dep_info_map_1_f_0(STATE_VARIABLE_Info_62_62);
  mercury__map__search_insert_5_p_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), (MR_Word) (&make__make_info__make__make_info__type_ctor_info_maybe_module_dep_info_0), ((MR_Box) (ModuleName_13)), ((MR_Box) ((MR_Unsigned) 0U)), &MaybeOldMaybeModuleDepInfo_44, ModuleDepMap2_43, &ModuleDepMap_45);
  if ((MaybeOldMaybeModuleDepInfo_44 == (MR_Word) ((MR_Unsigned) 0U)))
  {
    *STATE_VARIABLE_MaybeModuleDepInfo_47 = (MR_Word) ((MR_Unsigned) 0U);
    make__make_info__make_info_set_maybe_module_dep_info_map_3_p_0(ModuleDepMap_45, STATE_VARIABLE_Info_62_62, STATE_VARIABLE_Info_49);
  }
  else
  {
    *STATE_VARIABLE_MaybeModuleDepInfo_47 = ((MR_Word) ((MR_hl_field(1, MaybeOldMaybeModuleDepInfo_44, (MR_Integer) 0))));
    *STATE_VARIABLE_Info_49 = STATE_VARIABLE_Info_62_62;
  }
}
  ...
  MR_Box wrapper_arg_1)
{
  ...
  conv0_LambdaHeadVar__2_60 = make__get_module_dep_info__IntroducedFrom__func__write_module_dep_files_for_source_file__597__1_1_f_0(((MR_Word) (wrapper_arg_1)));
