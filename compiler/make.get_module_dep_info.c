...
make__get_module_dep_info__IntroducedFrom__func__write_module_dep_files_for_source_file__592__1_1_f_0(
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        if ((SourceFileExists_54 == (MR_Word) ((MR_Unsigned) 0U)))
        {
          ...
          succeeded = make__get_module_dep_info__some_bad_module_dependency_2_p_0(STATE_VARIABLE_Info_38_38, NestedSubModules_59);
          if (succeeded)
      ...
      else
      {
        ...
        succeeded = make__get_module_dep_info__some_bad_module_dependency_2_p_0(STATE_VARIABLE_Info_38_38, NestedSubModules_112);
        if (succeeded)
          Result_25 = (MR_Word) (MR_mkword(1, &make__get_module_dep_info_scalar_common_2[1]));
        else
          Result_25 = (MR_Word) ((MR_Unsigned) 0U);
  ...
  MR_Box wrapper_arg_1)
{
  ...
  conv0_LambdaHeadVar__2_60 = make__get_module_dep_info__IntroducedFrom__func__write_module_dep_files_for_source_file__592__1_1_f_0(((MR_Word) (wrapper_arg_1)));
