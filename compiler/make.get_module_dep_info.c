  ...
  MR_Word * STATE_VARIABLE_Info_44)
{
  ...
  libs__globals__lookup_accumulating_option_3_p_0(Globals_11, (MR_Integer) 708, &SearchDirs_17);
  ...
  MR_Word * STATE_VARIABLE_Info_54)
{
  ...
  make__module_target__record_made_target_10_p_0(ProgressStream_15, Globals_14, MadeTarget_31, MadeTargetFileName_32, (MR_Word) (&make__get_module_dep_info_scalar_common_2[4]), Succeeded_49, STATE_VARIABLE_Info_85_85, &STATE_VARIABLE_Info_88_88);
