  ...
  MR_Word * STATE_VARIABLE_Info_55)
{
  ...
  if (succeeded)
  {
    ...
    make__build__setup_for_build_with_module_options_12_p_0(ProgressStream_15, DefaultOptionTable_38, (MR_Integer) 1, ModuleName_19, DetectedGradeFlags_39, EnvOptFileVariables_40, EnvVarArgs_41, OptionArgs_42, (MR_Word) (MR_mkword(1, &make__get_module_dep_info_scalar_common_1[1])), &MayBuild_44);
