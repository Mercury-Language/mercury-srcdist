...
static /* final */ const MR_Box make__get_module_dep_info_scalar_common_1[4][2];
...
make__get_module_dep_info__cleanup_module_dep_file_7_p_0(
  ...
  MR_Word * STATE_VARIABLE_Info_14)
{
  make__util__remove_module_file_for_make_9_p_0(ProgressStream_8, Globals_9, (MR_Integer) 80, ModuleName_10, (MR_Word) (MR_mkword(1, &make__get_module_dep_info_scalar_common_2[0])), STATE_VARIABLE_Info_0_13, STATE_VARIABLE_Info_14);
}
  ...
  MR_Box wrapper_arg_1)
{
  ...
  conv0_LambdaHeadVar__2_59 = make__get_module_dep_info__IntroducedFrom__func__write_module_dep_files_for_source_file__609__1_1_f_0(((MR_Word) (wrapper_arg_1)));
  ...
  MR_Word * STATE_VARIABLE_Info_54)
{
  ...
  if (succeeded)
  {
    ...
    make__build__setup_for_build_with_module_options_12_p_0(ProgressStream_15, DefaultOptionTable_37, (MR_Integer) 1, ModuleName_19, DetectedGradeFlags_38, OptionVariables_39, EnvVarArgs_40, OptionArgs_41, (MR_Word) (MR_mkword(1, &make__get_module_dep_info_scalar_common_1[3])), &MayBuild_43);
  ...
  make__module_target__record_made_target_10_p_0(ProgressStream_15, Globals_14, MadeTarget_31, MadeTargetFileName_32, (MR_Word) (&make__get_module_dep_info_scalar_common_2[3]), Succeeded_49, STATE_VARIABLE_Info_85_85, &STATE_VARIABLE_Info_88_88);
  ...
  MR_Word * STATE_VARIABLE_Info_30)
{
  ...
  libs__globals__set_option_4_p_0((MR_Integer) 82, (MR_Word) (MR_mkword(3, &make__get_module_dep_info_scalar_common_1[1])), Globals_13, &UnredirectGlobals_24);
  ...
  parse_tree__file_names__module_name_to_file_name_5_p_0(Globals_13, (MR_String) "predicate \140make.get_module_dep_info.cannot_write_module_dep_files\'/12", (MR_Word) (MR_mkword(3, &make__get_module_dep_info_scalar_common_1[2])), ModuleName_18, &ErrFileName_25);
