  ...
  MR_Word * STATE_VARIABLE_Info_27)
{
  ...
  make__build__open_module_error_stream_8_p_0(ProgressStream_8, Globals_9, ModuleName_10, &MaybeErrorStream_13, STATE_VARIABLE_Info_0_26, &STATE_VARIABLE_Info_30_30);
