  ...
  MR_Box wrapper_arg_1)
{
  ...
  conv0_LambdaHeadVar__2_92 = make__get_module_dep_info__IntroducedFrom__func__do_get_maybe_module_dep_info__269__1_1_f_0(((MR_String) (wrapper_arg_1)));
  ...
  MR_Word * STATE_VARIABLE_Info_48)
{
  ...
  SearchAuthDirs_20 = parse_tree__find_module__get_search_auth_normal_dirs_2_f_0((MR_Integer) 4, Globals_11);
