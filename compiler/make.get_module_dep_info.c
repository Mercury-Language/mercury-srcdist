...
static void MR_CALL 
make__get_module_dep_info__write_module_dep_files_for_source_file_12_p_0_8(
  MR_Box closure_arg,
  MR_Box wrapper_arg_1,
  MR_Box * wrapper_arg_2,
  MR_Box wrapper_arg_3,
...
static /* final */ const MR_Box make__get_module_dep_info_scalar_common_6[1][11];
  ...
  MR_Word * STATE_VARIABLE_Info_43)
{
  ...
  libs__globals__lookup_accumulating_option_3_p_0(Globals_11, (MR_Integer) 688, &SearchDirs_17);
...
{
  MR_Box closure = closure_arg;
  MR_Word conv11_STATE_VARIABLE_Info_14;

  make__get_module_dep_info__cleanup_module_dep_files_7_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 4)))), ((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 5)))), ((MR_Word) (wrapper_arg_1)), &conv11_STATE_VARIABLE_Info_14);
  *wrapper_arg_2 = ((MR_Box) (conv11_STATE_VARIABLE_Info_14));
}
...
{
  MR_Box closure = closure_arg;
  MR_Word conv8_STATE_VARIABLE_Info_14;

  make__get_module_dep_info__cleanup_int3_files_7_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 4)))), ((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 5)))), ((MR_Word) (wrapper_arg_1)), &conv8_STATE_VARIABLE_Info_14);
  *wrapper_arg_2 = ((MR_Box) (conv8_STATE_VARIABLE_Info_14));
}
  ...
  MR_Box * wrapper_arg_5)
{
  ...
  parse_tree__write_module_interface_files__write_short_interface_file_int3_8_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 4)))), ((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 5)))), ((MR_Word) (wrapper_arg_1)), &conv5_HeadVar__5_5, &conv4_HeadVar__6_6);
  ...
  MR_Word * STATE_VARIABLE_Info_51)
{
  ...
  MR_Box conv10_STATE_VARIABLE_IO_80_80;
  MR_Word _Succeeded_49;
  MR_Box conv12_STATE_VARIABLE_Info_82_82;
  ...
  if (succeeded)
  {
    ...
    make__build__setup_for_build_with_module_options_11_p_0(ProgressStream_14, DefaultOptionTable_35, (MR_Integer) 1, ModuleName_18, DetectedGradeFlags_36, OptionVariables_37, OptionArgs_38, (MR_Word) (MR_mkword(1, &make__get_module_dep_info_scalar_common_1[2])), &MayBuild_40);
    if (((MR_tag((MR_Word) MayBuild_40)) == (MR_Integer) 1))
    {
      ...
      MR_Word Var_117;
      MR_Word Var_119;
      MR_Box conv6_STATE_VARIABLE_IO_24_118;
      MR_Box conv7_STATE_VARIABLE_IO_73_73;

      {
        Var_117 = (MR_Word) MR_new_object(MR_Word, (6 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(0, Var_117, 0) = ((MR_Box) (&make__get_module_dep_info_scalar_common_6[0]));
        MR_hl_field(0, Var_117, 1) = ((MR_Box) (make__get_module_dep_info__write_module_dep_files_for_source_file_12_p_0_4));
        MR_hl_field(0, Var_117, 2) = ((MR_Box) ((MR_Integer) 3));
        MR_hl_field(0, Var_117, 3) = ((MR_Box) (ProgressStream_14));
        MR_hl_field(0, Var_117, 4) = ((MR_Box) (ErrorStream_16));
        MR_hl_field(0, Var_117, 5) = ((MR_Box) (BuildGlobals_44));
      }
      mercury__list__map2_foldl_6_p_2((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_parse_tree_module_src_0), (MR_Word) (&libs__maybe_util__libs__maybe_util__type_ctor_info_maybe_succeeded_0), (MR_Word) (&make__get_module_dep_info_scalar_common_1[0]), (MR_Word) (&mercury__io__io__type_ctor_info_state_0), Var_117, ParseTreeModuleSrcs_25, &Succeededs_115, &SpecsList_116, ((MR_Box) ((MR_Integer) 0)), &conv6_STATE_VARIABLE_IO_24_118);
      {
        Var_119 = (MR_Word) MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(0, Var_119, 0) = ((MR_Box) (&make__get_module_dep_info_scalar_common_7[0]));
        MR_hl_field(0, Var_119, 1) = ((MR_Box) (make__get_module_dep_info__write_module_dep_files_for_source_file_12_p_0_5));
        MR_hl_field(0, Var_119, 2) = ((MR_Box) ((MR_Integer) 2));
        MR_hl_field(0, Var_119, 3) = ((MR_Box) (ErrorStream_16));
        MR_hl_field(0, Var_119, 4) = ((MR_Box) (BuildGlobals_44));
      }
      mercury__list__foldl_4_p_2((MR_Word) (&make__get_module_dep_info_scalar_common_1[0]), (MR_Word) (&mercury__io__io__type_ctor_info_state_0), Var_119, SpecsList_116, ((MR_Box) ((MR_Integer) 0)), &conv7_STATE_VARIABLE_IO_73_73);
    ...
    }
    {
      ...
      MR_hl_field(0, CleanupMSI_45, 0) = ((MR_Box) (&make__get_module_dep_info_scalar_common_8[0]));
      MR_hl_field(0, CleanupMSI_45, 1) = ((MR_Box) (make__get_module_dep_info__write_module_dep_files_for_source_file_12_p_0_6));
    ...
    libs__process_util__teardown_checking_for_interrupt_9_p_0((MR_Word) (&make__make_info__make__make_info__type_ctor_info_make_info_0), VeryVerbose_31, CookieMSI_34, CleanupMSI_45, Succeeded0_42, &Succeeded_46, ((MR_Box) (STATE_VARIABLE_Info_74_74)), &conv9_STATE_VARIABLE_Info_76_76);
  ...
  libs__process_util__setup_checking_for_interrupt_3_p_0(&CookieWMDF_47);
  {
    ...
    MR_hl_field(0, Var_79, 0) = ((MR_Box) (&make__get_module_dep_info_scalar_common_7[1]));
    MR_hl_field(0, Var_79, 1) = ((MR_Box) (make__get_module_dep_info__write_module_dep_files_for_source_file_12_p_0_7));
  ...
  mercury__list__foldl_4_p_2((MR_Word) (&parse_tree__module_baggage__parse_tree__module_baggage__type_ctor_info_burdened_module_0), (MR_Word) (&mercury__io__io__type_ctor_info_state_0), Var_79, BurdenedModules_24, ((MR_Box) ((MR_Integer) 0)), &conv10_STATE_VARIABLE_IO_80_80);
  {
    CleanupWMDF_48 = (MR_Word) MR_new_object(MR_Word, (6 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(0, CleanupWMDF_48, 0) = ((MR_Box) (&make__get_module_dep_info_scalar_common_8[0]));
    MR_hl_field(0, CleanupWMDF_48, 1) = ((MR_Box) (make__get_module_dep_info__write_module_dep_files_for_source_file_12_p_0_8));
  ...
  libs__process_util__teardown_checking_for_interrupt_9_p_0((MR_Word) (&make__make_info__make__make_info__type_ctor_info_make_info_0), VeryVerbose_31, CookieWMDF_47, CleanupWMDF_48, (MR_Integer) 1, &_Succeeded_49, ((MR_Box) (STATE_VARIABLE_Info_76_76)), &conv12_STATE_VARIABLE_Info_82_82);
  STATE_VARIABLE_Info_82_82 = ((MR_Word) (conv12_STATE_VARIABLE_Info_82_82));
  make__module_target__record_made_target_10_p_0(ProgressStream_14, Globals_13, MadeTarget_29, MadeTargetFileName_30, (MR_Word) (&make__get_module_dep_info_scalar_common_2[4]), Succeeded_46, STATE_VARIABLE_Info_82_82, &STATE_VARIABLE_Info_85_85);
