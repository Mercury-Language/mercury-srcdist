...
make__get_module_dep_info__IntroducedFrom__func__write_module_dep_files_for_source_file__598__1_1_f_0(
  MR_Word LambdaHeadVar__1_59)
{
  MR_Word LambdaHeadVar__2_60 = ((MR_Word) ((MR_hl_field(0, LambdaHeadVar__1_59, 1))));
  ...
  MR_Word * STATE_VARIABLE_Info_7)
{
  while (MR_TRUE)
  {
    ...
    {
      MR_Word ModuleName_23 = ((MR_Word) ((MR_hl_field(1, HeadVar__4_4, 0))));
      MR_Word ModuleNames_24 = ((MR_Word) ((MR_hl_field(1, HeadVar__4_4, 1))));
  ...
  MR_Word * STATE_VARIABLE_Info_48)
{
  ...
  else
  {
    ...
    if (((MR_tag((MR_Word) MaybeSourceFileTimestamp_26)) == (MR_Integer) 1))
    {
      ...
      if (succeeded)
      {
        ModuleDepInfo0_29 = ((MR_Word) ((MR_hl_field(1, STATE_VARIABLE_MaybeModuleDepInfo_70_70, 0))));
  ...
  MR_Word * STATE_VARIABLE_Info_26)
{
  ...
  if (((MR_tag((MR_Word) HaveReadSrc_13)) == (MR_Integer) 0))
  {
    ...
    if (succeeded)
    {
      ...
      {
        MR_Word ImportOrInclude_76 = ((MR_Word) ((MR_hl_field(1, Var_71, 0))));

        if (((MR_tag((MR_Word) ImportOrInclude_76)) == (MR_Integer) 0))
        {
          MR_Word ImportingModuleName_77 = ((MR_Word) ((MR_hl_field(0, ImportOrInclude_76, 0))));
          MR_String Var_82;
          MR_String Var_85;
        ...
        {
          MR_Word IncludingModuleName_78 = ((MR_Word) ((MR_hl_field(1, ImportOrInclude_76, 0))));
          MR_String Var_90;
          MR_String Var_93;
  ...
  else
  {
    ...
    MR_String SourceFileName_49 = ((MR_String) ((MR_hl_field(1, HaveReadSrc_13, 0))));
    ...
    Var_59 = ((MR_Word) ((MR_hl_field(0, ReadModuleErrors0_24, 0))));
    Var_60 = ((MR_Word) ((MR_hl_field(0, ReadModuleErrors0_24, 1))));
    Var_61 = ((MR_Word) ((MR_hl_field(0, ReadModuleErrors0_24, 2))));
    Var_62 = ((MR_Word) ((MR_hl_field(0, ReadModuleErrors0_24, 3))));
    {
  ...
  MR_Word * STATE_VARIABLE_Info_55)
{
  ...
  if (succeeded)
  {
    ...
    {
      MR_Word BuildGlobals_48 = ((MR_Word) ((MR_hl_field(1, MayBuild_44, 1))));
    ...
    {
      MR_Word MSISpecs_45 = ((MR_Word) ((MR_hl_field(0, MayBuild_44, 0))));
