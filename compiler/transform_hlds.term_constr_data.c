...
/* sealed */ struct transform_hlds__term_constr_data__vector_common_type_4_0_s {
...
{
  {
...

    {
      ...
      MR_hl_field(MR_mktag(0), Var_21, 0) = ((MR_Box) (&transform_hlds__term_constr_data_scalar_common_8[0]));
