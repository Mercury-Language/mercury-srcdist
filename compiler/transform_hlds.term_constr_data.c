  ...
  MR_Word SCC_8)
{
...

  {
    ...
    MR_hl_field(MR_mktag(0), Var_20, 0) = ((MR_Box) (&transform_hlds__term_constr_data_scalar_common_8[0]));
    MR_hl_field(MR_mktag(0), Var_20, 1) = ((MR_Box) (transform_hlds__term_constr_data__dump_abstract_scc_5_p_0_1));
    MR_hl_field(MR_mktag(0), Var_20, 2) = ((MR_Box) ((MR_Integer) 3));
    MR_hl_field(MR_mktag(0), Var_20, 3) = ((MR_Box) (Stream_6));
    MR_hl_field(MR_mktag(0), Var_20, 4) = ((MR_Box) (ModuleInfo_7));
    MR_hl_field(MR_mktag(0), Var_20, 5) = ((MR_Box) ((MR_Integer) 0));
  }
  mercury__set__foldl_4_p_2((MR_Word) (&transform_hlds__term_constr_data__transform_hlds__term_constr_data__type_ctor_info_abstract_proc_0), (MR_Word) (&mercury__io__io__type_ctor_info_state_0), Var_20, SCC_8, ((MR_Box) ((MR_Integer) 0)), &conv0_STATE_VARIABLE_IO_11);
}
