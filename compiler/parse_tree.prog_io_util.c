...
MR_decl_label7(parse_tree__prog_io_util__map_parser_3_0, 35,4,5,10,9,7,34)
...
MR_decl_label5(parse_tree__prog_io_util__parse_types_2_3_0, 16,4,3,5,19)
...
MR_decl_label4(parse_tree__prog_io_util__unparse_qualified_term_3_0, 4,3,5,6)
MR_decl_label8(parse_tree__prog_io_util__unparse_type_2_0, 68,5,6,69,8,70,11,12)
MR_decl_label8(parse_tree__prog_io_util__unparse_type_2_0, 13,73,29,30,31,72,18,19)
MR_decl_label8(parse_tree__prog_io_util__unparse_type_2_0, 21,22,20,24,26,25,27,71)
MR_decl_label2(parse_tree__prog_io_util__unparse_type_2_0, 15,16)
...
MR_BEGIN_MODULE(parse_tree__prog_io_util_module18)
	...
	MR_init_label5(parse_tree__prog_io_util__parse_types_2_3_0,16,4,3,5,19)
MR_BEGIN_CODE
...
MR_def_static(parse_tree__prog_io_util__parse_types_2_3_0)
	...
	MR_incr_sp(3);
	MR_sv(3) = (MR_Word) MR_succip;
MR_def_label(parse_tree__prog_io_util__parse_types_2_3_0,16)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_def_label(parse_tree__prog_io_util__parse_types_2_3_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TEST(MR_r1,0)) {
		MR_GOTO_LAB(parse_tree__prog_io_util__parse_types_2_3_0_i19);
	}
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 2);
	...
	MR_r1 = MR_sv(2);
	MR_succip_word = MR_sv(3);
	MR_GOTO_LAB(parse_tree__prog_io_util__parse_types_2_3_0_i16);
	}
MR_def_label(parse_tree__prog_io_util__parse_types_2_3_0,19)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(3);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
...
MR_BEGIN_MODULE(parse_tree__prog_io_util_module21)
	...
	MR_init_label4(parse_tree__prog_io_util__unparse_qualified_term_3_0,4,3,5,6)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(parse_tree__prog_io_util_module22)
	...
	MR_init_label8(parse_tree__prog_io_util__unparse_type_2_0,13,73,29,30,31,72,18,19)
	MR_init_label8(parse_tree__prog_io_util__unparse_type_2_0,21,22,20,24,26,25,27,71)
	MR_init_label2(parse_tree__prog_io_util__unparse_type_2_0,15,16)
MR_BEGIN_CODE
...
MR_def_label(parse_tree__prog_io_util__unparse_type_2_0,72)
	...
	MR_np_call_localret_ent(fn__term__context_init_0_0,
		parse_tree__prog_io_util__unparse_type_2_0_i18);
...
MR_def_label(parse_tree__prog_io_util__unparse_type_2_0,19)
	...
	MR_sv(1) = MR_tempr1;
	MR_GOTO_LAB(parse_tree__prog_io_util__unparse_type_2_0_i20);
	}
MR_def_label(parse_tree__prog_io_util__unparse_type_2_0,21)
	...
	MR_np_localcall_lab(parse_tree__prog_io_util__unparse_type_2_0,
		parse_tree__prog_io_util__unparse_type_2_0_i22);
MR_def_label(parse_tree__prog_io_util__unparse_type_2_0,22)
	...
	MR_tfield(1, MR_tempr2, 1) = MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 0, (MR_Integer) 3);
	MR_tfield(0, MR_tempr1, 0) = (MR_Word) MR_TAG_COMMON(0,3,5);
...
MR_def_label(parse_tree__prog_io_util__unparse_type_2_0,20)
	...
	if (MR_INT_NE(MR_sv(3),0)) {
		MR_GOTO_LAB(parse_tree__prog_io_util__unparse_type_2_0_i24);
	}
	MR_r1 = MR_sv(1);
	MR_decr_sp_and_return(4);
MR_def_label(parse_tree__prog_io_util__unparse_type_2_0,24)
	...
	if (MR_INT_NE(MR_sv(3),1)) {
		MR_GOTO_LAB(parse_tree__prog_io_util__unparse_type_2_0_i25);
	}
	MR_np_call_localret_ent(fn__term__context_init_0_0,
...
MR_def_label(parse_tree__prog_io_util__unparse_type_2_0,25)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_np_call_localret_ent(fn__term__context_init_0_0,
...
MR_def_label(parse_tree__prog_io_util__unparse_type_2_0,27)
	...
	MR_tfield(1, MR_tempr1, 1) = (MR_Word) MR_tbmkword(0, 0);
	MR_tag_alloc_heap(MR_tempr2, 0, (MR_Integer) 3);
	MR_tfield(0, MR_tempr2, 0) = (MR_Word) MR_TAG_COMMON(0,3,7);
	MR_tfield(0, MR_tempr2, 1) = MR_tempr1;
	MR_tfield(0, MR_tempr2, 2) = MR_r1;
	MR_r1 = MR_tempr2;
	MR_decr_sp_and_return(4);
...
MR_def_label(parse_tree__prog_io_util__list_to_conjunction_4_0,5)
	...
	MR_tag_alloc_heap(MR_tempr3, 0, (MR_Integer) 3);
	MR_r1 = MR_tempr3;
	MR_tfield(0, MR_tempr3, 0) = (MR_Word) MR_TAG_COMMON(0,3,8);
	MR_tfield(0, MR_tempr3, 1) = MR_tempr2;
...
MR_BEGIN_MODULE(parse_tree__prog_io_util_module36)
	...
	MR_init_label7(parse_tree__prog_io_util__map_parser_3_0,35,4,5,10,9,7,34)
MR_BEGIN_CODE
...
MR_define_entry(mercury__parse_tree__prog_io_util__map_parser_3_0);
	...
	if (MR_LTAGS_TESTR(MR_r3,0,0)) {
		MR_GOTO_LAB(parse_tree__prog_io_util__map_parser_3_0_i35);
	}
	MR_r1 = (MR_Word) MR_TAG_COMMON(1,0,0);
	MR_proceed();
MR_def_label(parse_tree__prog_io_util__map_parser_3_0,35)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(4);
	MR_sv(4) = (MR_Word) MR_succip;
	{
...
MR_define_entry(mercury____Unify___parse_tree__prog_io_util__maybe1_2_0);
	...
	MR_tag_alloc_heap(MR_tempr4, 0, (MR_Integer) 3);
	MR_r1 = MR_tempr4;
	MR_tfield(0, MR_tempr4, 0) = (MR_Word) MR_CTOR_ADDR(pair, pair, 2);
