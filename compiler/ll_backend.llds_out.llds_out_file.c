  ...
  MR_Word * Succeeded_8)
{
  ...
  parse_tree__file_names__module_name_to_file_name_8_p_0(Globals_6, (MR_String) "predicate \140ll_backend.llds_out.llds_out_file.output_llds\'/5", (MR_Integer) 0, (MR_Word) (MR_mkword(3, &ll_backend__llds_out__llds_out_file_scalar_common_1[5])), ModuleName_10, &FileName_11);
  {
    Var_19 = (MR_Word) MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(0, Var_19, 0) = ((MR_Box) (&ll_backend__llds_out__llds_out_file_scalar_common_5[0]));
    MR_hl_field(0, Var_19, 1) = ((MR_Box) (ll_backend__llds_out__llds_out_file__output_llds_5_p_0_1));
    MR_hl_field(0, Var_19, 2) = ((MR_Box) ((MR_Integer) 2));
    MR_hl_field(0, Var_19, 3) = ((MR_Box) (Globals_6));
    MR_hl_field(0, Var_19, 4) = ((MR_Box) (CFile_7));
  }
  libs__file_util__output_to_file_stream_7_p_0(Globals_6, ModuleName_10, FileName_11, Var_19, Succeeded_8);
}
