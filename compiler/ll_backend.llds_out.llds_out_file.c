...
static /* final */ const MR_Box ll_backend__llds_out__llds_out_file_scalar_common_4[1][1];
...
ll_backend__llds_out__llds_out_file__IntroducedFrom__pred__output_c_internal_label_no_layout_init_chunk__1140__1_4_p_0(
  ...
  MR_Word HeadVar__2_28)
{
  void MR_CALL (* func_0)(MR_Box, MR_Box, MR_Box, MR_Box, MR_Box *) = ((void MR_CALL (*)(MR_Box, MR_Box, MR_Box, MR_Box, MR_Box *)) ((MR_hl_field(0, (MR_hl_field(0, (MR_Word) (&ll_backend__llds_out__llds_out_file_scalar_common_2[1]), (MR_Integer) 0)), (MR_Integer) 10))));
  ...
  MR_Word AnnotatedProc_8)
{
  ...
  mercury__io__write_string_4_p_0(Stream_7, (MR_String) "\'/");
  mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&ll_backend__llds_out__llds_out_file_scalar_common_4[0]), Arity_14, &Var_145);
  mercury__io__write_string_4_p_0(Stream_7, Var_145);
  mercury__io__write_string_4_p_0(Stream_7, (MR_String) " mode ");
  mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&ll_backend__llds_out__llds_out_file_scalar_common_4[0]), ModeNum_19, &Var_155);
  ...
  MR_Word LabelSlotNums_12)
{
  ...
  mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&ll_backend__llds_out__llds_out_file_scalar_common_4[0]), Var_23, &Var_67);
  ...
  MR_Word LabelNums_8)
{
  ...
  mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&ll_backend__llds_out__llds_out_file_scalar_common_4[0]), Var_16, &Var_35);
  ...
  MR_Word * STATE_VARIABLE_DeclSet_14)
{
  ...
  mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&ll_backend__llds_out__llds_out_file_scalar_common_4[0]), Var_21, &Var_46);
  ...
  MR_Word * STATE_VARIABLE_DeclSet_56)
{
  ...
  if (!((TSStringTable_25 == (MR_Word) ((MR_Unsigned) 0U))))
  {
    ...
    mercury__io__write_string_4_p_0(Stream_18, (MR_String) ", ");
    mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&ll_backend__llds_out__llds_out_file_scalar_common_4[0]), TSStringTableSize_49, &Var_340);
  ...
  MR_Word HeadVar__5_5)
{
  while (MR_TRUE)
  {
    ...
    if (!((HeadVar__5_5 == (MR_Word) ((MR_Unsigned) 0U))))
    {
      ...
      mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&ll_backend__llds_out__llds_out_file_scalar_common_4[0]), Seq_4, &Var_71);
  ...
  MR_Word HeadVar__5_5)
{
  while (MR_TRUE)
  {
    ...
    if (!((HeadVar__5_5 == (MR_Word) ((MR_Unsigned) 0U))))
    {
      ...
      mercury__io__write_string_4_p_0(Stream_2, InitStatus_3);
      mercury__io__write_string_4_p_0(Stream_2, (MR_String) "_bunch_");
      mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&ll_backend__llds_out__llds_out_file_scalar_common_4[0]), Seq_4, &Var_76);
  ...
  MR_Word * Succeeded_8)
{
  ...
  parse_tree__file_names__module_name_to_file_name_create_dirs_7_p_0(Globals_6, (MR_String) "predicate \140ll_backend.llds_out.llds_out_file.output_llds\'/5", (MR_Word) (MR_mkword(3, &ll_backend__llds_out__llds_out_file_scalar_common_1[5])), ModuleName_10, &FileName_11);
  {
    ...
    MR_hl_field(0, Var_18, 0) = ((MR_Box) (&ll_backend__llds_out__llds_out_file_scalar_common_5[0]));
