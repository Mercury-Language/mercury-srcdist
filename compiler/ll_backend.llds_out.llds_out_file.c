  ...
  MR_Word HeadVar__2_92)
{
  ...
  succeeded = mercury__set_tree234__contains_2_p_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_label_0), UndefWhileLabels_26, ((MR_Box) (HeadVar__2_92)));
  return succeeded;
}
    ...
    case (MR_Integer) 0:
      {
        ...
        Var_44 = mercury__string__f_43_43_2_f_0((MR_String) "\t#define MR_maybe_local_thread_engine_base ", (MR_String) "MR_local_thread_engine_base\n");
        mercury__io__write_string_4_p_0(Stream_7, Var_44);
        mercury__io__write_string_4_p_0(Stream_7, (MR_String) "#endif\n");
        ll_backend__llds_out__llds_out_instr__output_instruction_list_7_p_0(Info_6, Stream_7, Instrs_15, LabelOutputInfo_11, (MR_Integer) 0);
        mercury__io__write_string_4_p_0(Stream_7, (MR_String) "#ifdef MR_maybe_local_thread_engine_base\n");
        mercury__io__write_string_4_p_0(Stream_7, (MR_String) "\t#undef MR_maybe_local_thread_engine_base\n");
        Var_56 = mercury__string__f_43_43_2_f_0((MR_String) "\t#define MR_maybe_local_thread_engine_base ", (MR_String) "MR_thread_engine_base\n");
        mercury__io__write_string_4_p_0(Stream_7, Var_56);
        mercury__io__write_string_4_p_0(Stream_7, (MR_String) "#endif\n");
      }
      break;
  }
  ...
  MR_Word LabelSlotNums_12)
{
  ...
  mercury__io__write_string_4_p_0(Stream_9, (MR_String) ",\n\t\t");
  parse_tree__parse_tree_out_info__write_out_list_6_p_0((MR_Word) (&ll_backend__llds_out__llds_out_file_scalar_common_3[2]), (MR_Word) (&ll_backend__llds_out__llds_out_file_scalar_common_2[7]), (MR_String) ", ", LabelSlotNums_12, Stream_9);
  mercury__io__write_string_4_p_0(Stream_9, (MR_String) ")\n");
}
  ...
  MR_Word * STATE_VARIABLE_DeclSet_56)
{
  ...
  if (!((TSStringTable_25 == (MR_Word) ((MR_Unsigned) 0U))))
  {
    ...
    mercury__io__write_string_4_p_0(Stream_18, (MR_String) ", ");
    mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&ll_backend__llds_out__llds_out_file_scalar_common_5[0]), TSStringTableSize_49, &Var_340);
  ...
  MR_Word * Succeeded_8)
{
  ...
  parse_tree__file_names__module_name_to_file_name_create_dirs_7_p_0(Globals_6, (MR_String) "predicate \140ll_backend.llds_out.llds_out_file.output_llds\'/5", (MR_Word) (MR_mkword(3, &ll_backend__llds_out__llds_out_file_scalar_common_1[5])), ModuleName_10, &FileName_11);
  {
    Var_18 = (MR_Word) MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(0, Var_18, 0) = ((MR_Box) (&ll_backend__llds_out__llds_out_file_scalar_common_6[0]));
    MR_hl_field(0, Var_18, 1) = ((MR_Box) (ll_backend__llds_out__llds_out_file__output_llds_5_p_0_1));
    MR_hl_field(0, Var_18, 2) = ((MR_Box) ((MR_Integer) 2));
    MR_hl_field(0, Var_18, 3) = ((MR_Box) (Globals_6));
    MR_hl_field(0, Var_18, 4) = ((MR_Box) (CFile_7));
  }
  libs__file_util__output_to_file_stream_7_p_0(Globals_6, ModuleName_10, FileName_11, Var_18, Succeeded_8);
}
