...
ll_backend__llds_out__llds_out_file__output_c_internal_label_layout_init_chunk_7_p_0(
  ...
  MR_Word LabelSlotNums_12)
{
  MR_String ModuleName_14 = ((MR_String) ((MR_hl_field(MR_mktag(0), Info_8, (MR_Integer) 1))));
  MR_Integer Var_23;
  MR_String Var_26;
  MR_String Var_67;
  ...
  MR_Word * STATE_VARIABLE_DeclSet_14)
{
  ...
  mercury__io__write_string_4_p_0(Stream_8, (MR_String) ")\n");
  {
    ...
    MR_hl_field(MR_mktag(0), Var_32, 0) = ((MR_Box) (&ll_backend__llds_out__llds_out_file_scalar_common_9[2]));
    MR_hl_field(MR_mktag(0), Var_32, 1) = ((MR_Box) (ll_backend__llds_out__llds_out_file__output_record_internal_label_decl_group_7_p_0_2));
    MR_hl_field(MR_mktag(0), Var_32, 2) = ((MR_Box) ((MR_Integer) 1));
    MR_hl_field(MR_mktag(0), Var_32, 3) = ((MR_Box) (ProcLabel_9));
  }
