            ...
            case (MR_Integer) 12:
              {
                ...
                }
                {
                  ...
                  MR_hl_field(1, Var_236, 1) = ((MR_Box) (MR_mkword(1, &libs__print_help_scalar_common_2[107])));
                }
            ...
            case (MR_Integer) 26:
              {
                ...
                }
                {
                  ...
                  MR_hl_field(1, Var_209, 1) = ((MR_Box) (MR_mkword(1, &libs__print_help_scalar_common_2[107])));
                }
                {
