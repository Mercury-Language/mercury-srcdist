  ...
  MR_Word * STATE_VARIABLE_ModeInfo_18)
{
  ...
  check_hlds__mode_info__mode_info_get_head_inst_vars_2_p_0(STATE_VARIABLE_ModeInfo_1_20, &HeadInstVars_24);
  {
    ...
    MR_hl_field(0, Var_31, 0) = ((MR_Box) (&check_hlds__modecheck_util_scalar_common_2[0]));
  ...
  mercury__map__foldl_4_p_0((MR_Word) (&check_hlds__modecheck_util_scalar_common_1[0]), (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_inst_0), (MR_Word) (&check_hlds__modecheck_util_scalar_common_1[2]), Var_31, *Subst_13, ((MR_Box) (Var_32)), &conv1_BoundInstVars_14);
