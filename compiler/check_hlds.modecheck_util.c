      ...
      case (MR_Integer) 2:
        {
          ...
          if ((HOInstInfo_23 == (MR_Word) ((MR_Integer) 0)))
          {
            *STATE_VARIABLE_Map_34 = STATE_VARIABLE_Map_0_33;
            *STATE_VARIABLE_Expansions_36 = STATE_VARIABLE_Expansions_0_35;
          }
                ...
                case (MR_Integer) 1:
                  {
                    ...
                    succeeded = ((MR_tag((MR_Word) InstVarsResult_18)) == (MR_Integer) 1);
                    if (succeeded)
                    {
          ...
          case (MR_Integer) 1:
            {
              ...
              if ((HOInstInfo_80 == (MR_Word) ((MR_Integer) 0)))
              {
                *STATE_VARIABLE_Map_34 = STATE_VARIABLE_Map_0_33;
                *STATE_VARIABLE_Expansions_36 = STATE_VARIABLE_Expansions_0_35;
              }
...
{
  {
    ...
    mercury__list__duplicate_3_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_inst_0), ConsIdAdjustedArity_9, ((MR_Box) ((MR_Integer) 0)), &ArgInsts_10);
    {
...
{
  {
    ...
    if (succeeded)
    {
      ...
      succeeded = ((((MR_tag((MR_Word) Subst_8)) == (MR_Integer) 3)) && ((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), Subst_8, (MR_Integer) 0))) == (MR_Integer) 3)));
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          succeeded = ((((MR_tag((MR_Word) Inst_10)) == (MR_Integer) 3)) && ((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), Inst_10, (MR_Integer) 0))) == (MR_Integer) 0)));
          if (succeeded)
          {
            ...
            succeeded = ((((MR_tag((MR_Word) SubstInst_12)) == (MR_Integer) 3)) && ((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), SubstInst_12, (MR_Integer) 0))) == (MR_Integer) 0)));
            if (succeeded)
            {
...
{
  {
    MR_bool succeeded = ((((MR_tag((MR_Word) GoalExpr_8)) == (MR_Integer) 3)) && ((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), GoalExpr_8, (MR_Integer) 0))) == (MR_Integer) 2)));
...
{
  {
    ...
    BoundInsts_13 = mercury__list__map_2_f_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_cons_id_0), (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_bound_inst_0), Var_17, Var_18);
    {
      ...
      MR_hl_field(MR_mktag(3), Inst_14, 2) = ((MR_Box) ((MR_Integer) 0));
      MR_hl_field(MR_mktag(3), Inst_14, 3) = ((MR_Box) (BoundInsts_13));
    }
    check_hlds__modecheck_util__modecheck_set_var_inst_5_p_0(Var_6, Inst_14, (MR_Word) ((MR_Integer) 0), STATE_VARIABLE_ModeInfo_0_15, STATE_VARIABLE_ModeInfo_16);
  }
}
...
{
  {
    ...
    mercury__list__duplicate_3_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_inst_0), ConsIdAdjustedArity_25, ((MR_Box) ((MR_Integer) 0)), &ArgInsts_26);
    {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(3), Inst_12, 2) = ((MR_Box) ((MR_Integer) 0));
      MR_hl_field(MR_mktag(3), Inst_12, 3) = ((MR_Box) (Var_17));
    }
    check_hlds__modecheck_util__modecheck_set_var_inst_5_p_0(Var_5, Inst_12, (MR_Word) ((MR_Integer) 0), STATE_VARIABLE_ModeInfo_0_13, STATE_VARIABLE_ModeInfo_14);
  }
}
...
{
  {
    ...
    succeeded = check_hlds__modecheck_util__modecheck_set_var_inst_list_2_9_p_0(Vars0_9, InitialInsts_10, FinalInsts_11, ArgOffset_12, &Vars1_16, (MR_Word) ((MR_Integer) 0), &Goals1_17, STATE_VARIABLE_ModeInfo_0_18, &STATE_VARIABLE_ModeInfo_21_21);
    if (succeeded)
    {
...
{
  {
    ...
    if (succeeded)
    {
        ...
        else
        {
          ...
          else
          {
            ...
            }
            {
              ...
              MR_hl_field(MR_mktag(1), NewUnifyExtraGoal_53, 0) = ((MR_Box) ((MR_Integer) 0));
      ...
      check_hlds__modecheck_util__modecheck_set_var_inst_5_p_0(Var0_9, FinalInst_11, (MR_Word) ((MR_Integer) 0), STATE_VARIABLE_ModeInfo_22_22, &STATE_VARIABLE_ModeInfo_24_24);
      ...
      {
        check_hlds__modecheck_util__modecheck_set_var_inst_5_p_0(*Var_12, FinalInst_11, (MR_Word) ((MR_Integer) 0), STATE_VARIABLE_ModeInfo_24_24, STATE_VARIABLE_ModeInfo_20);
      }
    }
    else
    {
...
{
  {
    ...
    if (succeeded)
    {
      ...
      succeeded = parse_tree__prog_data____Unify____mer_inst_0_0((MR_Word) ((MR_Integer) 4), Var_56);
      if (succeeded)
      {
        MR_Word InstMap_21;
      ...
      else
      {
        ...
        else
        {
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              succeeded = ((MR_tag((MR_Word) MaybeUInst_8)) == (MR_Integer) 1);
              if (succeeded)
              {
    ...
    if ((PVars0_10 == (MR_Word) ((MR_Integer) 0)))
...
{
  {
    ...
    else
    {
      ...
      WaitingVars_15 = parse_tree__set_of_var__make_singleton_1_f_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), Var_6);
      {
        ...
        MR_hl_field(MR_mktag(3), ModeError_16, 4) = ((MR_Box) ((MR_Integer) 0));
      }
      ...
      else
      {
        ...
        else
        {
          ...
          if (succeeded)
            ...
            MaybeMultiModeError_74 = (MR_Word) ((MR_Integer) 0);
...
{
  {
    ...
    else
    {
      ...
      if (succeeded)
        succeeded = (Errors_27 == (MR_Word) ((MR_Integer) 0));
      if (succeeded)
      {
  ...
  MR_Word * STATE_VARIABLE_ModeInfo_3)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      succeeded = ((((MR_tag((MR_Word) Var_15)) == (MR_Integer) 3)) && ((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), Var_15, (MR_Integer) 0))) == (MR_Integer) 2)));
      if (succeeded)
      {
  ...
  MR_Word * STATE_VARIABLE_ModeInfo_4)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      succeeded = ((((MR_tag((MR_Word) Var_19)) == (MR_Integer) 3)) && ((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), Var_19, (MR_Integer) 0))) == (MR_Integer) 2)));
      if (succeeded)
      {
