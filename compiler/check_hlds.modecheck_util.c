      ...
      case (MR_Integer) 2:
        {
          ...
          MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), Inst_8, (MR_Integer) 0)));
          ...
          case (MR_Integer) 0:
            {
              ...
              MR_Unsigned packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Inst_8, (MR_Integer) 1)));
                ...
                case (MR_Integer) 1:
                  {
                    ...
                    MR_Unsigned packed_args_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), InstResults_13, (MR_Integer) 0)));
          ...
          case (MR_Integer) 1:
            {
              ...
              MR_Unsigned packed_args_3 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Inst_8, (MR_Integer) 1)));
...
{
  {
    ...
    MR_Word Var_19;
    MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), PredInstInfo_8, (MR_Integer) 0)));
    MR_Unsigned packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), PredInstInfo_8, (MR_Integer) 3)));
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Inst_10, (MR_Integer) 1)));
            ...
            if (succeeded)
            {
              packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), SubstInst_12, (MR_Integer) 1)));
    ...
    case (MR_Integer) 2:
      {
        ...
        *UnifyContext_6 = ((MR_Word) ((MR_hl_field(MR_mktag(2), ModeContext_5, (MR_Integer) 0))));
        packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), ModeContext_5, (MR_Integer) 1)));
      }
      break;
  }
}
...
{
  {
    ...
    if (succeeded)
    {
      packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), GoalExpr_8, (MR_Integer) 1)));
...
{
  {
    ...
    if (succeeded)
    {
      ...
      else
      {
        ...
        if (succeeded)
        {
          packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), InitialInst_39, (MR_Integer) 0)));
  ...
  MR_Word * STATE_VARIABLE_ModeInfo_3)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Var_15, (MR_Integer) 1)));
  ...
  MR_Word * STATE_VARIABLE_ModeInfo_4)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Var_19, (MR_Integer) 1)));
