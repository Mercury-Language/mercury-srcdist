            ...
            else
            {
              ...
              else
              {
                ...
                VarIsDummy_56 = check_hlds__type_util__is_type_a_dummy_2_f_0(ModuleInfo0_44, VarType_48);
                {
                  ...
                  MR_hl_field(MR_mktag(0), VarEntry_57, 0) = ((MR_Box) ((MR_String) ""));
                  MR_hl_field(MR_mktag(0), VarEntry_57, 1) = ((MR_Box) (VarType_48));
                  MR_hl_field(MR_mktag(0), VarEntry_57, 2) = (MR_Box) ((MR_Unsigned) (VarIsDummy_56));
                }
  ...
  MR_Word * STATE_VARIABLE_ModeInfo_13)
{
  ...
  check_hlds__mode_info__mode_info_get_head_inst_vars_2_p_0(STATE_VARIABLE_ModeInfo_15_15, &HeadInstVars_18);
  {
    ...
    MR_hl_field(MR_mktag(0), Var_23, 0) = ((MR_Box) (&check_hlds__modecheck_util_scalar_common_3[0]));
    MR_hl_field(MR_mktag(0), Var_23, 1) = ((MR_Box) (check_hlds__modecheck_util__modecheck_var_has_inst_list_no_exact_match_6_p_0_1));
    MR_hl_field(MR_mktag(0), Var_23, 2) = ((MR_Box) ((MR_Integer) 1));
    MR_hl_field(MR_mktag(0), Var_23, 3) = ((MR_Box) (HeadInstVars_18));
  }
  ...
  else
  {
    ...
    WaitingVars_21 = parse_tree__set_of_var__list_to_set_1_f_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), Vars_7);
    {
      ...
      MR_hl_field(MR_mktag(3), ModeError_22, 1) = ((MR_Box) (InstMap_20));
      MR_hl_field(MR_mktag(3), ModeError_22, 2) = ((MR_Box) (Vars_7));
      MR_hl_field(MR_mktag(3), ModeError_22, 3) = ((MR_Box) ((MR_Unsigned) 0U));
    }
  ...
  MR_Word * STATE_VARIABLE_ModeInfo_13)
{
  ...
  check_hlds__mode_info__mode_info_get_head_inst_vars_2_p_0(STATE_VARIABLE_ModeInfo_15_15, &HeadInstVars_18);
  {
    Var_23 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(MR_mktag(0), Var_23, 0) = ((MR_Box) (&check_hlds__modecheck_util_scalar_common_3[0]));
    MR_hl_field(MR_mktag(0), Var_23, 1) = ((MR_Box) (check_hlds__modecheck_util__modecheck_var_has_inst_list_exact_match_6_p_0_1));
    MR_hl_field(MR_mktag(0), Var_23, 2) = ((MR_Box) ((MR_Integer) 1));
    MR_hl_field(MR_mktag(0), Var_23, 3) = ((MR_Box) (HeadInstVars_18));
  }
  succeeded = mercury__map__foldl_4_p_3((MR_Word) (&check_hlds__modecheck_util_scalar_common_1[0]), (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_inst_0), (MR_Word) (&mercury__unit__unit__type_ctor_info_unit_0), Var_23, *Subst_10, ((MR_Box) ((MR_Integer) 0)), &conv0_Var_19);
