          ...
          case (MR_Integer) 1:
            {
              ...
              if ((HOInstInfo_80 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
              {
                *STATE_VARIABLE_Map_34 = STATE_VARIABLE_Map_0_33;
                *STATE_VARIABLE_Expansions_36 = STATE_VARIABLE_Expansions_0_35;
              }
    ...
    case (MR_Integer) 1:
      {
...

        {
          ...
          MR_hl_field(MR_mktag(2), Var_12, 0) = ((MR_Box) (CallId_8));
          MR_hl_field(MR_mktag(2), Var_12, 1) = ((MR_Box) (Arg_9));
        }
        {
          MR_Word base;
...
{
  {
    ...
    if (succeeded)
    {
      ...
      succeeded = parse_tree__prog_data____Unify____mer_inst_0_0((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 1)), Var_56);
      if (succeeded)
      {
        MR_Word InstMap_21;
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      else
      {
        ...
        MR_Integer ArgNum_44 = (MR_Integer) ((MR_Unsigned) HeadVar__3_3 + (MR_Unsigned) (MR_Integer) 1);
        ...
        else
        {
          ...
          if (succeeded)
            {
              MaybeMultiModeError_74 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), MaybeMultiModeError_74, 0) = ((MR_Box) (MultiModeError_73));
            }
          else
            MaybeMultiModeError_74 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
          ...
          {
            ModeError_76 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 5 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(3), ModeError_76, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 3));
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      else
      {
        ...
        MR_Integer ArgNum_32 = (MR_Integer) ((MR_Unsigned) HeadVar__3_3 + (MR_Unsigned) (MR_Integer) 1);
        MR_Word STATE_VARIABLE_ModeInfo_36_36;
        ...
        if (succeeded)
        {
          ...
          {
            ModeError_48 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(3), ModeError_48, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 2));
