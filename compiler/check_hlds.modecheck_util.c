  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      else
      {
        ...
        check_hlds__mode_info__mode_info_get_var_types_2_p_0(STATE_VARIABLE_ModeInfo_50_50, &VarTypes_58);
        parse_tree__vartypes__lookup_var_type_3_p_0(VarTypes_58, Var_54, &Type_59);
        ...
        else
        {
          ...
          if (succeeded)
            {
              MaybeMultiModeError_64 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), MaybeMultiModeError_64, 0) = ((MR_Box) (MultiModeError_63));
            }
          else
          ...
          {
            ModeError_66 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(3), ModeError_66, 0) = ((MR_Box) ((MR_Unsigned) 6U));
            MR_hl_field(MR_mktag(3), ModeError_66, 1) = ((MR_Box) (Var_54));
            MR_hl_field(MR_mktag(3), ModeError_66, 2) = ((MR_Box) (VarInst_57));
            MR_hl_field(MR_mktag(3), ModeError_66, 3) = ((MR_Box) (Inst_55));
            MR_hl_field(MR_mktag(3), ModeError_66, 4) = ((MR_Box) (MaybeMultiModeError_64));
          }
    ...
    else
    {
      ...
      else
      {
        ...
        if (succeeded)
        {
          ...
          {
            ModeError_42 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(3), ModeError_42, 0) = ((MR_Box) ((MR_Unsigned) 7U));
            MR_hl_field(MR_mktag(3), ModeError_42, 1) = ((MR_Box) (Var_39));
          }
