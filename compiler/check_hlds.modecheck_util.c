                    ...
                    case (MR_Integer) 0:
                      {
...

                        {
                          ...
                          MR_hl_field(MR_mktag(0), Var_40, 1) = ((MR_Box) (check_hlds__modecheck_util__get_constrained_insts_in_inst_6_p_0_2));
                ...
                case (MR_Integer) 1:
                  {
                    ...
                    else
                    {
...

                      {
                        ...
                        MR_hl_field(MR_mktag(0), Var_37, 1) = ((MR_Box) (check_hlds__modecheck_util__get_constrained_insts_in_inst_6_p_0_3));
          ...
          case (MR_Integer) 3:
            {
              ...
              check_hlds__inst_lookup__inst_expand_and_remove_constrained_inst_vars_3_p_0(ModuleInfo_7, Inst_8, &SubInst_27);
              {
                ...
                MR_hl_field(MR_mktag(0), Var_45, 1) = ((MR_Box) (check_hlds__modecheck_util__get_constrained_insts_in_inst_6_p_0_4));
