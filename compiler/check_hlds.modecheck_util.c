  ...
  MR_Word * STATE_VARIABLE_ModeInfo_20)
{
  ...
  if (succeeded)
  {
    ...
    parse_tree__vartypes__lookup_var_type_3_p_0(VarTypes0_41, Var0_9, &VarType_42);
    ...
    else
    {
      ...
      else
      {
        ...
        else
        {
          ...
          MR_Word STATE_VARIABLE_ModeInfo_40_59;
          MR_Word Var_62;

          check_hlds__mode_info__mode_info_get_varset_2_p_0(STATE_VARIABLE_ModeInfo_0_19, &VarSet0_50);
          mercury__varset__new_var_3_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), Var_12, VarSet0_50, &VarSet_51);
          parse_tree__vartypes__add_var_type_4_p_0(*Var_12, VarType_42, VarTypes0_41, &VarTypes_52);
          check_hlds__mode_info__mode_info_set_varset_3_p_0(VarSet_51, STATE_VARIABLE_ModeInfo_0_19, &STATE_VARIABLE_ModeInfo_40_59);
          check_hlds__mode_info__mode_info_set_var_types_3_p_0(VarTypes_52, STATE_VARIABLE_ModeInfo_40_59, &STATE_VARIABLE_ModeInfo_22_22);
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      else
      {
        ...
        parse_tree__vartypes__lookup_var_type_3_p_0(VarTypes_68, Var_56, &Type_69);
