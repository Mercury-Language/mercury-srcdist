  ...
  MR_Word * STATE_VARIABLE_Expansions_36)
{
  while (MR_TRUE)
  {
    ...
    switch (MR_tag((MR_Word) Inst_8)) {
      ...
      case (MR_Integer) 1:
        {
          MR_Word HOInstInfo_80 = ((MR_Word) ((MR_hl_field(1, Inst_8, (MR_Integer) 1))));
      ...
      case (MR_Integer) 2:
        {
          MR_Word InstResults_13 = ((MR_Word) ((MR_hl_field(2, Inst_8, (MR_Integer) 1))));
          MR_Word BoundInsts_14 = ((MR_Word) ((MR_hl_field(2, Inst_8, (MR_Integer) 2))));
      ...
      case (MR_Integer) 3:
        switch (((MR_Integer) ((MR_hl_field(3, Inst_8, (MR_Integer) 0))))) {
          ...
          case (MR_Integer) 2:
            {
              MR_Word HOInstInfo_23 = ((MR_Word) ((MR_hl_field(3, Inst_8, (MR_Integer) 2))));
