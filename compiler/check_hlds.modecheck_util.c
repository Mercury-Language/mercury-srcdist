          ...
          case (MR_Integer) 4:
            {
              ...
              if (succeeded)
              {
                ...
                next_value_of_STATE_VARIABLE_Expansions_0_35 = STATE_VARIABLE_Expansions_43_43;
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      else
      {
        ...
        next_value_of_HeadVar__2_2 = Insts_42;
        next_value_of_HeadVar__3_3 = ArgNum_46;
        next_value_of_STATE_VARIABLE_Subst_0_4 = STATE_VARIABLE_Subst_53_53;
        next_value_of_STATE_VARIABLE_ModeInfo_0_6 = STATE_VARIABLE_ModeInfo_54_54;
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      else
      {
        ...
        next_value_of_HeadVar__2_2 = IsLives_31;
        next_value_of_HeadVar__3_3 = ArgNum_34;
