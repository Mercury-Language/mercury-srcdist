...
{
  {
    ...
    if (succeeded)
    {
      ...
      succeeded = check_hlds__inst_match__inst_matches_initial_no_implied_modes_sub_7_p_0(VarInst1_40, InitialInst_39, VarType_42, ModuleInfo0_38, &_ModuleInfo_43, Var_55, &_Sub_44);
      if (succeeded)
      {
        *Var_12 = Var0_9;
        ...
        if (succeeded)
        {
          ...
          *Var_12 = Var0_9;
          WaitingVars_47 = parse_tree__set_of_var__make_singleton_1_f_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), Var0_9);
          {
            ...
            MR_hl_field(MR_mktag(3), ModeError_48, 0) = ((MR_Box) ((MR_Unsigned) 17U));
          ...
          if (succeeded)
          {
            ...
            *Var_12 = Var0_9;
            WaitingVars_65 = parse_tree__set_of_var__make_singleton_1_f_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), Var0_9);
            {
              ...
              MR_hl_field(MR_mktag(3), ModeError_66, 0) = ((MR_Box) ((MR_Unsigned) 17U));
...
{
  {
    ...
    if (succeeded)
    {
      ...
      else
      {
        ...
        succeeded = check_hlds__inst_util__abstractly_unify_inst_8_p_0((MR_Integer) 1, OldInst_12, NewInst0_7, (MR_Integer) 1, &UnifyInst_16, &_Det_17, ModuleInfo0_13, &ModuleInfo1_18);
        if (succeeded)
        {
      ...
      check_hlds__inst_util__inst_expand_3_p_0(ModuleInfo_14, NewInst_15, &Var_56);
      ...
      {
        succeeded = check_hlds__inst_match__inst_matches_initial_4_p_0(OldInst_12, NewInst_15, Type_20, ModuleInfo_14);
        if (succeeded)
        {
          MR_Word InstMap_49;
        ...
        else
        {
          ...
          succeeded = check_hlds__inst_match__inst_matches_binding_4_p_0(NewInst_15, OldInst_12, Type_20, ModuleInfo_14);
          succeeded = !(succeeded);
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                ...
                succeeded = check_hlds__inst_match__inst_is_at_least_as_instantiated_4_p_0(NewInst_15, UInst_23, Type_20, ModuleInfo_14);
                if (succeeded)
                  succeeded = check_hlds__inst_match__inst_matches_binding_allow_any_any_4_p_0(NewInst0_7, OldInst_12, Type_20, ModuleInfo_14);
              }
              succeeded = !(succeeded);
            }
          }
          if (succeeded)
          {
            ...
            WaitingVars_24 = parse_tree__set_of_var__make_singleton_1_f_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), Var0_6);
            {
              ...
              MR_hl_field(MR_mktag(3), ModeError_25, 0) = ((MR_Box) ((MR_Unsigned) 14U));
...
{
  {
    ...
    else
    {
      ...
      WaitingVars_15 = parse_tree__set_of_var__make_singleton_1_f_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), Var_6);
      {
        ...
        MR_hl_field(MR_mktag(3), ModeError_16, 0) = ((MR_Box) ((MR_Unsigned) 5U));
...
{
  {
    ...
    else
    {
      ...
      {
        ModeError_29 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(3), ModeError_29, 0) = ((MR_Box) ((MR_Unsigned) 7U));
        MR_hl_field(MR_mktag(3), ModeError_29, 1) = ((MR_Box) (Vars_7));
        MR_hl_field(MR_mktag(3), ModeError_29, 2) = ((MR_Box) (VarInsts_27));
        MR_hl_field(MR_mktag(3), ModeError_29, 3) = ((MR_Box) ((MR_Unsigned) 0U));
      }
      ...
      else
      {
        ...
        else
        {
          ...
          WaitingVars_75 = parse_tree__set_of_var__make_singleton_1_f_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), Var_56);
          {
            ...
            MR_hl_field(MR_mktag(3), ModeError_76, 0) = ((MR_Box) ((MR_Unsigned) 5U));
      ...
      else
      {
        ...
        if (succeeded)
        {
          ...
          WaitingVars_47 = parse_tree__set_of_var__make_singleton_1_f_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), Var_40);
          {
            ...
            MR_hl_field(MR_mktag(3), ModeError_48, 0) = ((MR_Box) ((MR_Unsigned) 6U));
