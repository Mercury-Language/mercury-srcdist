        ...
        if ((check_hlds__modecheck_util__HeadVar__3_3 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
          *check_hlds__modecheck_util__HeadVar__1_1 = (MR_Integer) 2;
        else
          {
            ...
            {
              mercury__builtin__compare_3_p_0((MR_Word) &check_hlds__modecheck_util_scalar_common_1[2], &check_hlds__modecheck_util__Var_12, ((MR_Box) (check_hlds__modecheck_util__Var_18)), ((MR_Box) (check_hlds__modecheck_util__Var_10)));
            }
            ...
            if (check_hlds__modecheck_util__succeeded)
              *check_hlds__modecheck_util__HeadVar__1_1 = check_hlds__modecheck_util__Var_12;
              ...
              {
                {
                  mercury__builtin__compare_3_p_0((MR_Word) &check_hlds__modecheck_util_scalar_common_1[2], check_hlds__modecheck_util__HeadVar__1_1, ((MR_Box) (check_hlds__modecheck_util__Var_17)), ((MR_Box) (check_hlds__modecheck_util__Var_11)));
                }
              }
          }
      }
            ...
            else
              {
                ...
                if (check_hlds__modecheck_util__succeeded)
                ...
                else
                  {
                    ...
                    {
                      check_hlds__modecheck_util__WaitingVars_74 = parse_tree__set_of_var__make_singleton_1_f_0((MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0, check_hlds__modecheck_util__Var_58);
                    }
                    {
                      ...
                      MR_hl_field(MR_mktag(3), check_hlds__modecheck_util__ModeError_75, 1) = ((MR_Box) (check_hlds__modecheck_util__Var_58));
