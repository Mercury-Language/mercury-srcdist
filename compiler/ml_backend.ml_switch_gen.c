  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      if (!(succeeded))
      {
        ...
        ml_backend__ml_gen_info__ml_gen_info_get_high_level_data_2_p_0(STATE_VARIABLE_Info_0_38, &Var_438);
        succeeded = ((MR_Integer) 1 == Var_438);
      }
    }
    if (succeeded)
    {
    ...
    {
      {
        ...
        ml_backend__ml_gen_info__ml_gen_info_get_high_level_data_2_p_0(STATE_VARIABLE_Info_0_38, &Var_439);
        succeeded = ((MR_Integer) 1 == Var_439);
      }
      if (!(succeeded))
      {
        MR_Word Var_48;
      ...
      else
      {
        ...
        {
          Var_52 = (MR_Integer) 0;
          libs__globals__get_target_2_p_0(Globals_29, &Var_440);
          succeeded = (Var_52 == Var_440);
        }
        if (succeeded)
        {
    ...
    case (MR_Integer) 1:
      {
        ...
        MR_Word Rval_40;
        MR_Word Range_41;
        MR_Word MLDS_Cases_42;
        MR_Word ReachableConstVarMaps_43;
        MR_Word Default_44;
        MR_Word SwitchStmt0_45;
        MR_Word SwitchStmt_46;
        MR_Word STATE_VARIABLE_Info_33_48;
        MR_Word STATE_VARIABLE_Info_34_49;
        MR_Word STATE_VARIABLE_Info_35_50;
        MR_Integer MinRange_61;
        MR_Integer MaxRange_62;
        MR_Word ModuleInfo_58;
        MR_Word Type_59;
        MR_Word TypeCategory_60;
        MR_Integer _NumValuesInRange_63;

        ml_backend__ml_gen_info__ml_gen_info_get_var_table_2_p_0(STATE_VARIABLE_Info_0_21, &VarTable_35);
        parse_tree__var_table__lookup_var_entry_3_p_0(VarTable_35, SwitchVar_10, &VarEntry_36);
        Type_37 = ((MR_Word) ((MR_hl_field(MR_mktag(0), VarEntry_36, (MR_Integer) 1))));
        ml_backend__ml_code_util__ml_gen_mlds_type_3_p_0(STATE_VARIABLE_Info_0_21, Type_37, &MLDS_Type_38);
        ml_backend__ml_code_util__ml_gen_var_4_p_0(STATE_VARIABLE_Info_0_21, SwitchVar_10, VarEntry_36, &Lval_39);
        {
          Rval_40 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(2), Rval_40, 0) = ((MR_Box) (Lval_39));
        }
        ml_backend__ml_gen_info__ml_gen_info_get_module_info_2_p_0(STATE_VARIABLE_Info_0_21, &ModuleInfo_58);
        succeeded = ((((MR_tag((MR_Word) MLDS_Type_38)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(MR_mktag(3), MLDS_Type_38, (MR_Integer) 0)))) == (MR_Integer) 0)));
        if (succeeded)
        {
          Type_59 = ((MR_Word) ((MR_hl_field(MR_mktag(3), MLDS_Type_38, (MR_Integer) 1))));
          TypeCategory_60 = ((MR_Word) ((MR_hl_field(MR_mktag(3), MLDS_Type_38, (MR_Integer) 2))));
          succeeded = backend_libs__switch_util__type_range_6_p_0(ModuleInfo_58, TypeCategory_60, Type_59, &MinRange_61, &MaxRange_62, &_NumValuesInRange_63);
        }
        if (succeeded)
          {
            Range_41 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), Range_41, 0) = ((MR_Box) (MinRange_61));
            MR_hl_field(MR_mktag(1), Range_41, 1) = ((MR_Box) (MaxRange_62));
          }
        else
          Range_41 = (MR_Word) ((MR_Unsigned) 0U);
        ml_backend__ml_switch_gen__ml_switch_generate_mlds_cases_10_p_0(Type_37, MLDS_Type_38, CodeModel_13, EntryPackedWordMap_14, TaggedCases_12, &MLDS_Cases_42, (MR_Word) ((MR_Unsigned) 0U), &ReachableConstVarMaps_43, STATE_VARIABLE_Info_0_21, &STATE_VARIABLE_Info_33_48);
        ml_backend__ml_code_gen__ml_gen_record_consensus_const_var_map_3_p_0(ReachableConstVarMaps_43, STATE_VARIABLE_Info_33_48, &STATE_VARIABLE_Info_34_49);
        ml_backend__ml_switch_gen__ml_switch_generate_default_6_p_0(CanFail_11, CodeModel_13, Context_15, &Default_44, STATE_VARIABLE_Info_34_49, &STATE_VARIABLE_Info_35_50);
        {
          SwitchStmt0_45 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (7 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(3), SwitchStmt0_45, 0) = ((MR_Box) ((MR_Unsigned) 0U));
          MR_hl_field(MR_mktag(3), SwitchStmt0_45, 1) = ((MR_Box) (MLDS_Type_38));
          MR_hl_field(MR_mktag(3), SwitchStmt0_45, 2) = ((MR_Box) (Rval_40));
          MR_hl_field(MR_mktag(3), SwitchStmt0_45, 3) = ((MR_Box) (Range_41));
          MR_hl_field(MR_mktag(3), SwitchStmt0_45, 4) = ((MR_Box) (MLDS_Cases_42));
          MR_hl_field(MR_mktag(3), SwitchStmt0_45, 5) = ((MR_Box) (Default_44));
          MR_hl_field(MR_mktag(3), SwitchStmt0_45, 6) = ((MR_Box) (Context_15));
        }
        ml_backend__ml_simplify_switch__ml_simplify_switch_4_p_0(SwitchStmt0_45, &SwitchStmt_46, STATE_VARIABLE_Info_35_50, STATE_VARIABLE_Info_22);
        {
          MR_Word base;
          base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          *Stmts_16 = base;
          MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (SwitchStmt_46));
