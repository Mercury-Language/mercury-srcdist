...
MR_decl_label4(ml_backend__ml_switch_gen__target_supports_computed_goto_1_0, 2,8,13,10)
MR_decl_label4(ml_backend__ml_switch_gen__target_supports_goto_1_0, 2,6,11,9)
MR_decl_label4(ml_backend__ml_switch_gen__target_supports_int_switch_1_0, 2,5,11,9)
MR_decl_label3(ml_backend__ml_switch_gen__target_supports_string_switch_1_0, 2,8,3)
...
MR_BEGIN_MODULE(ml_backend__ml_switch_gen_module0)
	...
	MR_init_label4(ml_backend__ml_switch_gen__target_supports_int_switch_1_0,2,5,11,9)
MR_BEGIN_CODE
...
MR_def_label(ml_backend__ml_switch_gen__target_supports_int_switch_1_0,2)
	...
	MR_COMPUTED_GOTO((MR_Unsigned) MR_r1,
		MR_LABEL_AP(ml_backend__ml_switch_gen__target_supports_int_switch_1_0_i11) MR_AND
		MR_LABEL_AP(ml_backend__ml_switch_gen__target_supports_int_switch_1_0_i5) MR_AND
		MR_LABEL_AP(ml_backend__ml_switch_gen__target_supports_int_switch_1_0_i11) MR_AND
		MR_LABEL_AP(ml_backend__ml_switch_gen__target_supports_int_switch_1_0_i11) MR_AND
		MR_LABEL_AP(ml_backend__ml_switch_gen__target_supports_int_switch_1_0_i9));
...
MR_def_label(ml_backend__ml_switch_gen__target_supports_int_switch_1_0,9)
	...
	MR_np_call_localret_ent(fn__libs__compiler_util__unexpected_2_0,
		ml_backend__ml_switch_gen__target_supports_int_switch_1_0_i11);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
...
MR_BEGIN_MODULE(ml_backend__ml_switch_gen_module1)
	...
	MR_init_label3(ml_backend__ml_switch_gen__target_supports_string_switch_1_0,2,8,3)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(ml_backend__ml_switch_gen_module2)
	...
	MR_init_label4(ml_backend__ml_switch_gen__target_supports_goto_1_0,2,6,11,9)
MR_BEGIN_CODE
...
MR_def_label(ml_backend__ml_switch_gen__target_supports_goto_1_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_COMPUTED_GOTO((MR_Unsigned) MR_r1,
		MR_LABEL_AP(ml_backend__ml_switch_gen__target_supports_goto_1_0_i11) MR_AND
		MR_LABEL_AP(ml_backend__ml_switch_gen__target_supports_goto_1_0_i11) MR_AND
		MR_LABEL_AP(ml_backend__ml_switch_gen__target_supports_goto_1_0_i6) MR_AND
		MR_LABEL_AP(ml_backend__ml_switch_gen__target_supports_goto_1_0_i11) MR_AND
		MR_LABEL_AP(ml_backend__ml_switch_gen__target_supports_goto_1_0_i9));
...
MR_def_label(ml_backend__ml_switch_gen__target_supports_goto_1_0,9)
	...
	MR_r3 = (MR_Word) MR_string_const("target x86_64 with --high-level code", 36);
	MR_np_call_localret_ent(fn__libs__compiler_util__unexpected_2_0,
		ml_backend__ml_switch_gen__target_supports_goto_1_0_i11);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_thread_engine_base
#endif
...
MR_BEGIN_MODULE(ml_backend__ml_switch_gen_module3)
	...
	MR_init_label4(ml_backend__ml_switch_gen__target_supports_computed_goto_1_0,2,8,13,10)
MR_BEGIN_CODE
...
MR_def_label(ml_backend__ml_switch_gen__target_supports_computed_goto_1_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_COMPUTED_GOTO((MR_Unsigned) MR_r1,
		MR_LABEL_AP(ml_backend__ml_switch_gen__target_supports_computed_goto_1_0_i13) MR_AND
		MR_LABEL_AP(ml_backend__ml_switch_gen__target_supports_computed_goto_1_0_i13) MR_AND
		MR_LABEL_AP(ml_backend__ml_switch_gen__target_supports_computed_goto_1_0_i8) MR_AND
		MR_LABEL_AP(ml_backend__ml_switch_gen__target_supports_computed_goto_1_0_i8) MR_AND
		MR_LABEL_AP(ml_backend__ml_switch_gen__target_supports_computed_goto_1_0_i10));
MR_def_label(ml_backend__ml_switch_gen__target_supports_computed_goto_1_0,8)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = ((MR_Integer) 0 == (MR_Integer) 1);
	MR_decr_sp_and_return(1);
MR_def_label(ml_backend__ml_switch_gen__target_supports_computed_goto_1_0,13)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_succip_word = MR_sv(1);
	MR_decr_sp(1);
	MR_r1 = MR_TRUE;
...
MR_def_label(ml_backend__ml_switch_gen__target_supports_computed_goto_1_0,10)
	...
	MR_r3 = (MR_Word) MR_string_const("target x86_64 with --high-level code", 36);
	MR_np_call_localret_ent(fn__libs__compiler_util__unexpected_2_0,
		ml_backend__ml_switch_gen__target_supports_computed_goto_1_0_i13);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_thread_engine_base
#endif
