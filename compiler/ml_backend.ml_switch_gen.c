  ...
  MR_Word * STATE_VARIABLE_Info_38)
{
  ...
  ml_backend__ml_lookup_switch__ml_is_lookup_switch_6_p_0(SwitchVar_16, FilteredTaggedCases_23, GoalInfo_20, CodeModel_19, STATE_VARIABLE_Info_0_37, &MaybeLookupSwitchInfo_30);
  ...
  if (succeeded)
  {
    ...
    if (succeeded)
    {
      ...
      succeeded = (NumConsIds_22 >= StringTrieSwitchSize_33);
    }
  }
  if (succeeded)
  {
    if ((MaybeLookupSwitchInfo_30 == (MR_Word) ((MR_Unsigned) 0U)))
      ml_backend__ml_string_switch__ml_generate_string_trie_jump_switch_9_p_0(SwitchVarRval_29, FilteredTaggedCases_23, CodeModel_19, FilteredCanFail_18, EntryPackedWordMap_24, Context_21, Stmts_26, STATE_VARIABLE_Info_0_37, STATE_VARIABLE_Info_38);
    else
    {
      MR_Word LookupSwitchInfo_34 = ((MR_Word) ((MR_hl_field(1, MaybeLookupSwitchInfo_30, (MR_Integer) 0))));

      ml_backend__ml_string_switch__ml_generate_string_trie_lookup_switch_8_p_0(SwitchVarRval_29, FilteredTaggedCases_23, LookupSwitchInfo_34, CodeModel_19, FilteredCanFail_18, Context_21, Stmts_26, STATE_VARIABLE_Info_38);
    }
  ...
  else
  {
    ...
    succeeded = (NumConsIds_22 >= StringHashSwitchSize_35);
    if (succeeded)
      if ((MaybeLookupSwitchInfo_30 == (MR_Word) ((MR_Unsigned) 0U)))
        ml_backend__ml_string_switch__ml_generate_string_hash_jump_switch_10_p_0(SwitchVarRval_29, FilteredTaggedCases_23, CodeModel_19, FilteredCanFail_18, EntryPackedWordMap_24, Context_21, Defns_25, Stmts_26, STATE_VARIABLE_Info_0_37, STATE_VARIABLE_Info_38);
      else
      {
        MR_Word LookupSwitchInfo_47 = ((MR_Word) ((MR_hl_field(1, MaybeLookupSwitchInfo_30, (MR_Integer) 0))));

        ml_backend__ml_string_switch__ml_generate_string_hash_lookup_switch_9_p_0(SwitchVarRval_29, FilteredTaggedCases_23, LookupSwitchInfo_47, CodeModel_19, FilteredCanFail_18, Context_21, Defns_25, Stmts_26, STATE_VARIABLE_Info_38);
      }
    else
    {
      MR_Integer StringBinarySwitchSize_36 = ((MR_Integer) ((MR_hl_field(0, OptTuple_31, (MR_Integer) 32))));

      succeeded = (NumConsIds_22 >= StringBinarySwitchSize_36);
      if (succeeded)
        if ((MaybeLookupSwitchInfo_30 == (MR_Word) ((MR_Unsigned) 0U)))
          ml_backend__ml_string_switch__ml_generate_string_binary_jump_switch_10_p_0(SwitchVarRval_29, FilteredTaggedCases_23, CodeModel_19, FilteredCanFail_18, EntryPackedWordMap_24, Context_21, Defns_25, Stmts_26, STATE_VARIABLE_Info_0_37, STATE_VARIABLE_Info_38);
        else
        {
          MR_Word LookupSwitchInfo_49 = ((MR_Word) ((MR_hl_field(1, MaybeLookupSwitchInfo_30, (MR_Integer) 0))));

          ml_backend__ml_string_switch__ml_generate_string_binary_lookup_switch_9_p_0(SwitchVarRval_29, FilteredTaggedCases_23, LookupSwitchInfo_49, CodeModel_19, FilteredCanFail_18, Context_21, Defns_25, Stmts_26, STATE_VARIABLE_Info_38);
        }
      else
      {
        ml_backend__ml_switch_gen__ml_switch_generate_if_then_else_chain_9_p_0(FilteredTaggedCases_23, SwitchVar_16, CodeModel_19, FilteredCanFail_18, EntryPackedWordMap_24, Context_21, Stmts_26, STATE_VARIABLE_Info_0_37, STATE_VARIABLE_Info_38);
        *Defns_25 = (MR_Word) ((MR_Unsigned) 0U);
      }
    }
  }
