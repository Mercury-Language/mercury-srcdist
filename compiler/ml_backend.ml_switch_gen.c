      ...
      case (MR_Integer) 1:
        {
...

          {
            ...
            MR_hl_field(MR_mktag(3), ml_backend__ml_switch_gen__Var_49, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 3));
              ...
              if (ml_backend__ml_switch_gen__succeeded)
                {
                  ml_backend__ml_switch_gen__Var_10 = ((MR_Integer) (MR_hl_field(MR_mktag(3), ml_backend__ml_switch_gen__ConsId_7, (MR_Integer) 1)));
                  {
                    ...
                    {
                      ml_backend__ml_switch_gen__Var_51 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
                      MR_hl_field(MR_mktag(1), ml_backend__ml_switch_gen__Var_51, 0) = ((MR_Box) (ml_backend__ml_switch_gen__Int_9));
                    }
                    {
                      ml_backend__ml_switch_gen__Rval_11 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                      MR_hl_field(MR_mktag(3), ml_backend__ml_switch_gen__Rval_11, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 1));
                  ...
                  if (ml_backend__ml_switch_gen__succeeded)
                    {
                      ml_backend__ml_switch_gen__Var_12 = ((MR_Char) (MR_Word) (MR_hl_field(MR_mktag(3), ml_backend__ml_switch_gen__ConsId_7, (MR_Integer) 1)));
                      {
...

                        {
                          ...
                          MR_hl_field(MR_mktag(3), ml_backend__ml_switch_gen__Var_52, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 1));
                  ...
                  else
                    {
...

                      {
                        ...
                        MR_hl_field(MR_mktag(3), ml_backend__ml_switch_gen__Var_53, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 0));
          ...
          case (MR_Integer) 1:
            {
              ...
              {
                ml_backend__ml_switch_gen__Var_50 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(2), ml_backend__ml_switch_gen__Var_50, 0) = ((MR_Box) (ml_backend__ml_switch_gen__UInt_13));
              }
              {
                ml_backend__ml_switch_gen__Rval_11 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), ml_backend__ml_switch_gen__Rval_11, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 1));
          ...
          case (MR_Integer) 2:
            {
...

              {
                ...
                MR_hl_field(MR_mktag(3), ml_backend__ml_switch_gen__Var_48, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 5));
