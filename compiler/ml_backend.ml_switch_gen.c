            ...
            case (MR_Integer) 3:
              {
                ...
                libs__globals__lookup_int_option_3_p_0(Globals_27, (MR_Integer) 460, &TagSize_30);
...
{
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        succeeded = libs__globals__lookup_bool_option_3_p_1(Globals_27, (MR_Integer) 337, (MR_Integer) 1);
        if (!(succeeded))
        {
          MR_Word Var_66;
      ...
      else
      {
        ...
        else
        {
          ...
          libs__globals__lookup_int_option_3_p_0(Globals_27, (MR_Integer) 457, &StringTrieSwitchSize_31);
          ...
          else
          {
            ...
            libs__globals__lookup_int_option_3_p_0(Globals_27, (MR_Integer) 458, &StringHashSwitchSize_33);
            ...
            else
            {
              ...
              libs__globals__lookup_int_option_3_p_0(Globals_27, (MR_Integer) 459, &StringBinarySwitchSize_34);
