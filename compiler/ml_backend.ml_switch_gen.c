            ...
            case (MR_Integer) 2:
              {
                ...
                libs__globals__lookup_int_option_3_p_0(Globals_26, (MR_Integer) 448, &TagSize_29);
    ...
    else
    {
      ...
      else
      {
        ...
        else
        {
          ...
          libs__globals__lookup_int_option_3_p_0(Globals_25, (MR_Integer) 445, &StringTrieSwitchSize_29);
          ...
          else
          {
            ...
            libs__globals__lookup_int_option_3_p_0(Globals_25, (MR_Integer) 446, &StringHashSwitchSize_31);
            ...
            else
            {
              ...
              libs__globals__lookup_int_option_3_p_0(Globals_25, (MR_Integer) 447, &StringBinarySwitchSize_32);
  ...
  MR_Word * Expr_6)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      {
        MR_Word next_value_of_FirstExpr_4 = FirstSecondExpr_9;
        MR_Word next_value_of_LaterExprs_5 = OtherExprs_8;
