    ...
    else
    {
      ...
      else
      {
        ...
        else
        {
          ...
          if (succeeded)
          {
            if ((MaybeLookupSwitchInfo_28 == (MR_Word) ((MR_Integer) 0)))
      ...
      case (MR_Integer) 1:
        {
...

          {
            ...
            MR_hl_field(MR_mktag(3), Var_45, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 12));
          ...
          case (MR_Integer) 1:
            {
...

              {
                ...
                MR_hl_field(MR_mktag(3), Var_44, 1) = ((MR_Box) (ForeignLang_14));
...
{
  {
    ...
    if ((TaggedCases_20 == (MR_Word) ((MR_Integer) 0)))
    {
      {
...
{
  {
    ...
    if ((TaggedCases_12 == (MR_Word) ((MR_Integer) 0)))
      switch (CanFail_15) {
        default: /*NOTREACHED*/ MR_assert(0);
        case (MR_Integer) 0:
          {
            ...
            FailBlock_27 = ml_backend__ml_code_util__ml_gen_block_4_f_0((MR_Word) ((MR_Integer) 0), (MR_Word) ((MR_Integer) 0), FailStmts_26, Context_17);
            {
    ...
    else
    {
      ...
      LaterBlock_31 = ml_backend__ml_code_util__ml_gen_block_4_f_0((MR_Word) ((MR_Integer) 0), (MR_Word) ((MR_Integer) 0), LaterStmts_30, Context_17);
      {
  ...
  MR_Word * Expr_6)
{
  while (MR_TRUE)
  {
    ...
    ;
    if ((LaterExprs_5 == (MR_Word) ((MR_Integer) 0)))
      *Expr_6 = FirstExpr_4;
    else
    {
...

      {
        ...
        MR_hl_field(MR_mktag(3), FirstSecondExpr_9, 1) = ((MR_Box) ((MR_Integer) 4));
...
{
  {
    ...
    switch (CanFail_7) {
      ...
      case (MR_Integer) 0:
        {
          ...
          if (succeeded)
            *Default_10 = (MR_Word) ((MR_Integer) 4);
          else
          {
            MR_Word Fail_13;

            Fail_13 = ml_backend__ml_code_util__ml_gen_block_4_f_0((MR_Word) ((MR_Integer) 0), (MR_Word) ((MR_Integer) 0), FailStmts_12, Context_9);
            {
              MR_Word base;
      ...
      case (MR_Integer) 1:
        {
          *Default_10 = (MR_Word) ((MR_Integer) 0);
