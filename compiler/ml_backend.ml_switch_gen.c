    ...
    if (ml_backend__ml_switch_gen__succeeded)
    ...
    else
      {
        ...
        if (ml_backend__ml_switch_gen__succeeded)
          {
            {
              ml_backend__ml_switch_gen__succeeded = libs__globals__lookup_bool_option_3_p_1(ml_backend__ml_switch_gen__Globals_25, (MR_Integer) 317, (MR_Integer) 1);
            }
            if (!(ml_backend__ml_switch_gen__succeeded))
              {
        ...
        else
          {
            ...
            if (ml_backend__ml_switch_gen__succeeded)
            ...
            else
              {
                ...
                {
                  libs__globals__lookup_int_option_3_p_0(ml_backend__ml_switch_gen__Globals_25, (MR_Integer) 432, &ml_backend__ml_switch_gen__StringTrieSwitchSize_29);
                }
                ...
                if (ml_backend__ml_switch_gen__succeeded)
                ...
                else
                  {
                    ...
                    {
                      libs__globals__lookup_int_option_3_p_0(ml_backend__ml_switch_gen__Globals_25, (MR_Integer) 433, &ml_backend__ml_switch_gen__StringHashSwitchSize_31);
                    }
                    ...
                    if (ml_backend__ml_switch_gen__succeeded)
                    ...
                    else
                      {
                        ...
                        {
                          libs__globals__lookup_int_option_3_p_0(ml_backend__ml_switch_gen__Globals_25, (MR_Integer) 434, &ml_backend__ml_switch_gen__StringBinarySwitchSize_32);
                        }
        ...
        if (ml_backend__ml_switch_gen__succeeded)
          {
            ...
            ml_backend__ml_switch_gen__V_45_45 = (MR_Integer) 444;
            ...
            if (ml_backend__ml_switch_gen__succeeded)
              {
                ml_backend__ml_switch_gen__V_47_47 = (MR_Integer) 431;
                {
                ...
                if (ml_backend__ml_switch_gen__succeeded)
                  {
                    ...
                    if (ml_backend__ml_switch_gen__succeeded)
                      {
                        ml_backend__ml_switch_gen__V_49_49 = (MR_Integer) 429;
                        {
            ...
            case (MR_Integer) 2:
              {
                ...
                {
                  libs__globals__lookup_int_option_3_p_0(ml_backend__ml_switch_gen__Globals_26, (MR_Integer) 435, &ml_backend__ml_switch_gen__TagSize_29);
                }
