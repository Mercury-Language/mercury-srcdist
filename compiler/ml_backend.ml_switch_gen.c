                  ...
                  case (MR_Integer) 1:
                    {
                      ...
                      if (succeeded)
                      {
                        Type_83 = ((MR_Word) (MR_hl_field(MR_mktag(3), MLDS_Type_66, (MR_Integer) 1)));
                        TypeCategory_84 = ((MR_Word) (MR_hl_field(MR_mktag(3), MLDS_Type_66, (MR_Integer) 2)));
                        ExportedType_82 = ((MR_Word) (MR_hl_field(MR_mktag(3), MLDS_Type_66, (MR_Integer) 3)));
                        Var_88 = backend_libs__foreign__to_exported_type_2_f_0(ModuleInfo_81, Type_83);
                        succeeded = backend_libs__foreign____Unify____exported_type_0_0(ExportedType_82, Var_88);
                        if (succeeded)
                          succeeded = backend_libs__switch_util__type_range_6_p_0(ModuleInfo_81, TypeCategory_84, Type_83, &MinRange_85, &MaxRange_86, &_NumValuesInRange_87);
                      }
                      if (succeeded)
                        {
            ...
            case (MR_Integer) 3:
              {
                ...
                libs__globals__lookup_int_option_3_p_0(Globals_26, (MR_Integer) 449, &TagSize_29);
...
{
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        succeeded = libs__globals__lookup_bool_option_3_p_1(Globals_25, (MR_Integer) 326, (MR_Integer) 1);
        if (!(succeeded))
        {
          MR_Word Var_64;
      ...
      else
      {
        ...
        else
        {
          ...
          libs__globals__lookup_int_option_3_p_0(Globals_25, (MR_Integer) 446, &StringTrieSwitchSize_29);
          ...
          else
          {
            ...
            libs__globals__lookup_int_option_3_p_0(Globals_25, (MR_Integer) 447, &StringHashSwitchSize_31);
            ...
            else
            {
              ...
              libs__globals__lookup_int_option_3_p_0(Globals_25, (MR_Integer) 448, &StringBinarySwitchSize_32);
...
{
  {
    ...
    if (succeeded)
    {
      Type_36 = ((MR_Word) (MR_hl_field(MR_mktag(3), MLDS_Type_17, (MR_Integer) 1)));
      TypeCategory_37 = ((MR_Word) (MR_hl_field(MR_mktag(3), MLDS_Type_17, (MR_Integer) 2)));
      ExportedType_35 = ((MR_Word) (MR_hl_field(MR_mktag(3), MLDS_Type_17, (MR_Integer) 3)));
...
{
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          Type_82 = ((MR_Word) (MR_hl_field(MR_mktag(3), MLDS_Type_65, (MR_Integer) 1)));
          TypeCategory_83 = ((MR_Word) (MR_hl_field(MR_mktag(3), MLDS_Type_65, (MR_Integer) 2)));
          ExportedType_81 = ((MR_Word) (MR_hl_field(MR_mktag(3), MLDS_Type_65, (MR_Integer) 3)));
