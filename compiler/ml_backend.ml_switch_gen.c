  ...
  MR_Word * STATE_VARIABLE_Info_46)
{
  ...
  if (succeeded)
  {
    ...
    if (succeeded)
    {
      ...
      Var_47 = ((((MR_Unsigned) ((MR_hl_field(0, OptTuple_33, 1))) >> 13)) & (MR_Integer) 1);
      ReqDensity_35 = ((MR_Integer) ((MR_hl_field(0, OptTuple_33, 26))));
      LookupSize_34 = ((MR_Integer) ((MR_hl_field(0, OptTuple_33, 28))));
