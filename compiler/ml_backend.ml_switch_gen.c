      ...
      case (MR_Integer) 2:
        {
          ...
          if (succeeded)
          {
            ...
            succeeded = backend_libs__switch_util__type_range_6_p_0(ModuleInfo_67, Var_73, Type_68, &MinRange_70, &MaxRange_71, &_NumValuesInRange_72);
          }
          if (succeeded)
            {
  ...
  MR_Word * STATE_VARIABLE_Info_31)
{
  ...
  if (succeeded)
  {
    ...
    succeeded = backend_libs__switch_util__type_range_6_p_0(ModuleInfo_40, Var_46, Type_41, &MinRange_43, &MaxRange_44, &_NumValuesInRange_45);
  }
  if (succeeded)
    {
