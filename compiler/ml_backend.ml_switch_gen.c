...
#line 55 "ml_backend.ml_switch_gen.c"
...
#endif
#line 64 "ml_backend.ml_switch_gen.c"
...
MR_decl_label7(ml_backend__ml_switch_gen__ml_switch_generate_mlds_case_5_0, 37,8,11,12,13,2,36)
MR_decl_label3(ml_backend__ml_switch_gen__ml_switch_generate_mlds_cases_5_0, 13,4,5)
...
MR_decl_label5(ml_backend__ml_switch_gen__ml_switch_lookup_tags_4_0, 15,4,5,6,7)
...
MR_decl_static(ml_backend__ml_switch_gen__ml_switch_generate_mlds_case_5_0)
...
MR_BEGIN_MODULE(ml_backend__ml_switch_gen_module4)
	...
	MR_init_label5(ml_backend__ml_switch_gen__ml_switch_lookup_tags_4_0,15,4,5,6,7)
MR_BEGIN_CODE
...
MR_def_static(ml_backend__ml_switch_gen__ml_switch_lookup_tags_4_0)
	...
	if (MR_LTAGS_TESTR(MR_r2,0,0)) {
		MR_GOTO_LAB(ml_backend__ml_switch_gen__ml_switch_lookup_tags_4_0_i15);
	}
	MR_r1 = (MR_Word) MR_tbmkword(0, 0);
	MR_proceed();
MR_def_label(ml_backend__ml_switch_gen__ml_switch_lookup_tags_4_0,15)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(7);
...
MR_BEGIN_MODULE(ml_backend__ml_switch_gen_module7)
	MR_init_entry1(ml_backend__ml_switch_gen__ml_switch_generate_mlds_case_5_0);
	MR_init_label7(ml_backend__ml_switch_gen__ml_switch_generate_mlds_case_5_0,37,8,11,12,13,2,36)
MR_BEGIN_CODE
	...
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(ml_backend__ml_switch_gen__ml_switch_generate_mlds_case_5_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(2);
	MR_sv(2) = (MR_Word) MR_succip;
	MR_r4 = MR_ctfield(0, MR_r1, 1);
	MR_COMPUTED_GOTO((MR_Unsigned) MR_tag(MR_r4),
		MR_LABEL_AP(ml_backend__ml_switch_gen__ml_switch_generate_mlds_case_5_0_i37) MR_AND
		MR_LABEL_AP(ml_backend__ml_switch_gen__ml_switch_generate_mlds_case_5_0_i8) MR_AND
		MR_LABEL_AP(ml_backend__ml_switch_gen__ml_switch_generate_mlds_case_5_0_i37) MR_AND
		MR_LABEL_AP(ml_backend__ml_switch_gen__ml_switch_generate_mlds_case_5_0_i11));
MR_def_label(ml_backend__ml_switch_gen__ml_switch_generate_mlds_case_5_0,37)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tempr1 = MR_r1;
	...
	MR_np_call_localret_ent(libs__compiler_util__unexpected_2_0,
		ml_backend__ml_switch_gen__ml_switch_generate_mlds_case_5_0_i2);
MR_def_label(ml_backend__ml_switch_gen__ml_switch_generate_mlds_case_5_0,8)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tag_alloc_heap(MR_tempr1, 3, (MR_Integer) 2);
	MR_tfield(3, MR_tempr1, 0) = (MR_Integer) 1;
	MR_tfield(3, MR_tempr1, 1) = MR_ctfield(1, MR_r4, 0);
	...
	MR_np_call_localret_ent(ml_backend__ml_code_gen__ml_gen_goal_5_0,
		ml_backend__ml_switch_gen__ml_switch_generate_mlds_case_5_0_i36);
MR_def_label(ml_backend__ml_switch_gen__ml_switch_generate_mlds_case_5_0,11)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_COMPUTED_GOTO((MR_Unsigned) MR_ctfield(3, MR_r4, 0),
		MR_LABEL_AP(ml_backend__ml_switch_gen__ml_switch_generate_mlds_case_5_0_i12) MR_AND
		MR_LABEL_AP(ml_backend__ml_switch_gen__ml_switch_generate_mlds_case_5_0_i13) MR_AND
		MR_LABEL_AP(ml_backend__ml_switch_gen__ml_switch_generate_mlds_case_5_0_i37) MR_AND
		MR_LABEL_AP(ml_backend__ml_switch_gen__ml_switch_generate_mlds_case_5_0_i37) MR_AND
		MR_LABEL_AP(ml_backend__ml_switch_gen__ml_switch_generate_mlds_case_5_0_i37) MR_AND
		MR_LABEL_AP(ml_backend__ml_switch_gen__ml_switch_generate_mlds_case_5_0_i37) MR_AND
		...
		MR_LABEL_AP(ml_backend__ml_switch_gen__ml_switch_generate_mlds_case_5_0_i37) MR_AND
		MR_LABEL_AP(ml_backend__ml_switch_gen__ml_switch_generate_mlds_case_5_0_i37) MR_AND
		MR_LABEL_AP(ml_backend__ml_switch_gen__ml_switch_generate_mlds_case_5_0_i37));
MR_def_label(ml_backend__ml_switch_gen__ml_switch_generate_mlds_case_5_0,12)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 1);
	...
	MR_np_call_localret_ent(ml_backend__ml_code_gen__ml_gen_goal_5_0,
		ml_backend__ml_switch_gen__ml_switch_generate_mlds_case_5_0_i36);
MR_def_label(ml_backend__ml_switch_gen__ml_switch_generate_mlds_case_5_0,13)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2, MR_tempr3;
	...
	MR_np_call_localret_ent(ml_backend__ml_code_gen__ml_gen_goal_5_0,
		ml_backend__ml_switch_gen__ml_switch_generate_mlds_case_5_0_i36);
MR_def_label(ml_backend__ml_switch_gen__ml_switch_generate_mlds_case_5_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_np_call_localret_ent(ml_backend__ml_code_gen__ml_gen_goal_5_0,
		ml_backend__ml_switch_gen__ml_switch_generate_mlds_case_5_0_i36);
MR_def_label(ml_backend__ml_switch_gen__ml_switch_generate_mlds_case_5_0,36)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
...
MR_BEGIN_MODULE(ml_backend__ml_switch_gen_module8)
	...
	MR_init_label3(ml_backend__ml_switch_gen__ml_switch_generate_mlds_cases_5_0,13,4,5)
MR_BEGIN_CODE
...
MR_def_static(ml_backend__ml_switch_gen__ml_switch_generate_mlds_cases_5_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
		MR_GOTO_LAB(ml_backend__ml_switch_gen__ml_switch_generate_mlds_cases_5_0_i13);
	}
	MR_r1 = (MR_Word) MR_tbmkword(0, 0);
	MR_r2 = MR_r3;
	MR_proceed();
MR_def_label(ml_backend__ml_switch_gen__ml_switch_generate_mlds_cases_5_0,13)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(3);
	...
	MR_np_call_localret_ent(ml_backend__ml_switch_gen__ml_switch_generate_mlds_case_5_0,
