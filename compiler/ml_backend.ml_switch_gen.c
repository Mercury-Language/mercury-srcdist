...
static void MR_CALL 
ml_backend__ml_switch_gen__ml_gen_smart_string_switch_12_p_0_1(
  MR_Box closure_arg,
  MR_Box wrapper_arg_1,
  MR_Box * wrapper_arg_2);
...
static void MR_CALL 
ml_backend__ml_switch_gen__ml_gen_smart_string_switch_c_14_p_0(
  MR_Word Globals_15,
  MR_Word SwitchVar_16,
  MR_Word SwitchVarEntry_17,
  MR_Word FilteredCanFail_18,
...
static /* final */ const MR_Box ml_backend__ml_switch_gen_scalar_common_1[4][3] = {
  ...
  {
    ((MR_Box) (&ml_backend__ml_switch_gen_scalar_common_3[0])),
    ((MR_Box) (ml_backend__ml_switch_gen__ml_gen_smart_string_switch_12_p_0_1)),
    ((MR_Box) ((MR_Integer) 0))
  },
  /* row   3 */
  {
  ...
  MR_Word * STATE_VARIABLE_Info_36)
{
  ...
  switch (SwitchCategory_27) {
    ...
    case (MR_Integer) 2:
      {
        ...
        switch (Int64SwitchSupported_29) {
          ...
          case (MR_Integer) 0:
            ...
            break;
          case (MR_Integer) 1:
            ml_backend__ml_switch_gen__ml_switch_generate_mlds_switch_9_p_0(TaggedCases_24, SwitchVar_11, CodeModel_13, CanFail_12, EntryPackedWordMap_26, Context_15, Stmts_18, STATE_VARIABLE_Info_0_35, &STATE_VARIABLE_Info_37_37);
            break;
        }
        *Defns_17 = (MR_Word) ((MR_Unsigned) 0U);
      }
    ...
    case (MR_Integer) 1:
      {
        ml_backend__ml_switch_gen__ml_gen_smart_int_max_32_switch_12_p_0(SwitchVar_11, SwitchVarType_22, CanFail_12, TaggedCases_24, MaybeIntSwitchInfo_25, CodeModel_13, GoalInfo_14, EntryPackedWordMap_26, Context_15, Stmts_18, STATE_VARIABLE_Info_0_35, &STATE_VARIABLE_Info_37_37);
        *Defns_17 = (MR_Word) ((MR_Unsigned) 0U);
      }
      break;
    case (MR_Integer) 3:
      ml_backend__ml_switch_gen__ml_gen_smart_string_switch_12_p_0(SwitchVar_11, SwitchVarEntry_21, CanFail_12, CodeModel_13, GoalInfo_14, Context_15, TaggedCases_24, EntryPackedWordMap_26, Defns_17, Stmts_18, STATE_VARIABLE_Info_0_35, &STATE_VARIABLE_Info_37_37);
      break;
    case (MR_Integer) 5:
      {
  ...
  MR_Word * STATE_VARIABLE_Info_32)
{
  ...
  if (succeeded)
  {
    ...
    else
    {
      ...
      ml_backend__ml_switch_gen__ml_switch_generate_if_then_else_chain_ites_12_p_0(FirstTaggedCase_37, LaterTaggedCases_38, SwitchVar_13, CodeModel_16, FilteredCanFail_25, EntryPackedWordMap_20, Context_18, Stmts_22, (MR_Word) ((MR_Unsigned) 0U), &ReachableConstVarMaps_39, STATE_VARIABLE_Info_0_31, &STATE_VARIABLE_Info_30_44);
  ...
  else
  {
    ...
    switch (Target_30) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        ml_backend__ml_switch_gen__ml_gen_smart_string_switch_c_14_p_0(Globals_29, SwitchVar_13, SwitchVarEntry_14, FilteredCanFail_25, CodeModel_16, GoalInfo_17, Context_18, NumConsIds_26, FilteredTaggedCases_24, EntryPackedWordMap_20, Defns_21, Stmts_22, STATE_VARIABLE_Info_0_31, STATE_VARIABLE_Info_32);
        break;
      case (MR_Integer) 1:
      case (MR_Integer) 2:
        {
          ...
          succeeded = ((((MR_tag((MR_Word) MLDS_Type_51)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(3, MLDS_Type_51, (MR_Integer) 0)))) == (MR_Integer) 0)));
          if (succeeded)
          {
            Type_68 = ((MR_Word) ((MR_hl_field(3, MLDS_Type_51, (MR_Integer) 1))));
            TypeCategory_69 = ((MR_Word) ((MR_hl_field(3, MLDS_Type_51, (MR_Integer) 2))));
            succeeded = backend_libs__switch_util__type_range_6_p_0(ModuleInfo_67, TypeCategory_69, Type_68, &MinRange_70, &MaxRange_71, &_NumValuesInRange_72);
          }
          if (succeeded)
            {
          ...
          ml_backend__ml_switch_gen__ml_switch_generate_mlds_cases_10_p_0(Type_50, MLDS_Type_51, CodeModel_16, EntryPackedWordMap_20, FilteredTaggedCases_24, &MLDS_Cases_55, (MR_Word) ((MR_Unsigned) 0U), &ReachableConstVarMaps_56, STATE_VARIABLE_Info_0_31, &STATE_VARIABLE_Info_33_61);
          ...
          ml_backend__ml_switch_gen__ml_switch_generate_default_6_p_0(FilteredCanFail_25, CodeModel_16, Context_18, &Default_57, STATE_VARIABLE_Info_34_62, &STATE_VARIABLE_Info_35_63);
          {
            ...
            MR_hl_field(3, SwitchStmt0_58, 6) = ((MR_Box) (Context_18));
          }
  ...
  MR_Word * STATE_VARIABLE_Info_37)
{
  ...
  ml_backend__ml_lookup_switch__ml_is_lookup_switch_7_p_0(SwitchVar_16, FilteredTaggedCases_23, GoalInfo_20, CodeModel_19, &MaybeLookupSwitchInfo_28, STATE_VARIABLE_Info_0_36, &STATE_VARIABLE_Info_38_38);
  ml_backend__ml_code_util__ml_gen_var_4_p_0(STATE_VARIABLE_Info_38_38, SwitchVar_16, SwitchVarEntry_17, &SwitchVarLval_29);
  {
    SwitchVarRval_30 = (MR_Word) MR_mkword(2, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(2, SwitchVarRval_30, 0) = ((MR_Box) (SwitchVarLval_29));
  }
  libs__globals__get_opt_tuple_2_p_0(Globals_15, &OptTuple_31);
  StringTrieSwitchSize_32 = ((MR_Integer) ((MR_hl_field(0, OptTuple_31, (MR_Integer) 30))));
  succeeded = (NumConsIds_22 >= StringTrieSwitchSize_32);
  if (succeeded)
  {
    if ((MaybeLookupSwitchInfo_28 == (MR_Word) ((MR_Unsigned) 0U)))
      ml_backend__ml_string_switch__ml_generate_string_trie_jump_switch_9_p_0(SwitchVarRval_30, FilteredTaggedCases_23, CodeModel_19, FilteredCanFail_18, EntryPackedWordMap_24, Context_21, Stmts_26, STATE_VARIABLE_Info_38_38, STATE_VARIABLE_Info_37);
    else
    {
      MR_Word LookupSwitchInfo_33 = ((MR_Word) ((MR_hl_field(1, MaybeLookupSwitchInfo_28, (MR_Integer) 0))));

      ml_backend__ml_string_switch__ml_generate_string_trie_lookup_switch_9_p_0(SwitchVarRval_30, FilteredTaggedCases_23, LookupSwitchInfo_33, CodeModel_19, FilteredCanFail_18, Context_21, Stmts_26, STATE_VARIABLE_Info_38_38, STATE_VARIABLE_Info_37);
    }
    *Defns_25 = (MR_Word) ((MR_Unsigned) 0U);
  }
  else
  {
    MR_Integer StringHashSwitchSize_34 = ((MR_Integer) ((MR_hl_field(0, OptTuple_31, (MR_Integer) 31))));

    succeeded = (NumConsIds_22 >= StringHashSwitchSize_34);
    if (succeeded)
      if ((MaybeLookupSwitchInfo_28 == (MR_Word) ((MR_Unsigned) 0U)))
        ml_backend__ml_string_switch__ml_generate_string_hash_jump_switch_10_p_0(SwitchVarRval_30, FilteredTaggedCases_23, CodeModel_19, FilteredCanFail_18, EntryPackedWordMap_24, Context_21, Defns_25, Stmts_26, STATE_VARIABLE_Info_38_38, STATE_VARIABLE_Info_37);
      else
      {
        MR_Word LookupSwitchInfo_46 = ((MR_Word) ((MR_hl_field(1, MaybeLookupSwitchInfo_28, (MR_Integer) 0))));

        ml_backend__ml_string_switch__ml_generate_string_hash_lookup_switch_10_p_0(SwitchVarRval_30, FilteredTaggedCases_23, LookupSwitchInfo_46, CodeModel_19, FilteredCanFail_18, Context_21, Defns_25, Stmts_26, STATE_VARIABLE_Info_38_38, STATE_VARIABLE_Info_37);
      }
    else
    {
      MR_Integer StringBinarySwitchSize_35 = ((MR_Integer) ((MR_hl_field(0, OptTuple_31, (MR_Integer) 32))));

      succeeded = (NumConsIds_22 >= StringBinarySwitchSize_35);
      if (succeeded)
        if ((MaybeLookupSwitchInfo_28 == (MR_Word) ((MR_Unsigned) 0U)))
          ml_backend__ml_string_switch__ml_generate_string_binary_jump_switch_10_p_0(SwitchVarRval_30, FilteredTaggedCases_23, CodeModel_19, FilteredCanFail_18, EntryPackedWordMap_24, Context_21, Defns_25, Stmts_26, STATE_VARIABLE_Info_38_38, STATE_VARIABLE_Info_37);
        else
        {
          MR_Word LookupSwitchInfo_48 = ((MR_Word) ((MR_hl_field(1, MaybeLookupSwitchInfo_28, (MR_Integer) 0))));

          ml_backend__ml_string_switch__ml_generate_string_binary_lookup_switch_10_p_0(SwitchVarRval_30, FilteredTaggedCases_23, LookupSwitchInfo_48, CodeModel_19, FilteredCanFail_18, Context_21, Defns_25, Stmts_26, STATE_VARIABLE_Info_38_38, STATE_VARIABLE_Info_37);
        }
      else
      {
        ml_backend__ml_switch_gen__ml_switch_generate_if_then_else_chain_9_p_0(FilteredTaggedCases_23, SwitchVar_16, CodeModel_19, FilteredCanFail_18, EntryPackedWordMap_24, Context_21, Stmts_26, STATE_VARIABLE_Info_38_38, STATE_VARIABLE_Info_37);
        *Defns_25 = (MR_Word) ((MR_Unsigned) 0U);
      }
    }
  }
  ...
  MR_Word * STATE_VARIABLE_Info_46)
{
  ...
  if (succeeded)
  {
    ...
    if (succeeded)
    {
      IntSwitchInfo_29 = ((MR_Word) ((MR_hl_field(1, MaybeIntSwitchInfo_17, (MR_Integer) 0))));
      ...
      Var_47 = ((((MR_Unsigned) ((MR_hl_field(0, OptTuple_33, (MR_Integer) 1))) >> 13)) & (MR_Integer) 1);
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            backend_libs__switch_util__filter_out_failing_cases_if_needed_5_p_0(CodeModel_18, TaggedCases_16, &FilteredTaggedCases_36, CanFail_15, &FilteredCanFail_37);
            succeeded = backend_libs__switch_util__find_int_lookup_switch_params_11_p_0(ModuleInfo_26, SwitchVarType_14, FilteredCanFail_37, LowerLimit_30, UpperLimit_31, NumValues_32, ReqDensity_35, &NeedBitVecCheck_38, &NeedRangeCheck_39, &FirstVal_40, &LastVal_41);
            if (succeeded)
            {
              ml_backend__ml_lookup_switch__ml_is_lookup_switch_7_p_0(SwitchVar_13, FilteredTaggedCases_36, GoalInfo_19, CodeModel_18, &MaybeLookupSwitchInfo_42, STATE_VARIABLE_Info_0_45, &STATE_VARIABLE_Info_49_49);
  ...
  if (succeeded)
  {
    ...
    ml_backend__ml_lookup_switch__ml_gen_int_max_32_lookup_switch_12_p_0(SwitchVar_13, TaggedCases_16, LookupSwitchInfo_43, CodeModel_18, Context_21, FirstVal_40, LastVal_41, NeedBitVecCheck_38, NeedRangeCheck_39, &LookupStmt_44, STATE_VARIABLE_Info_49_49, STATE_VARIABLE_Info_46);
    {
      MR_Word base;
      base = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      *Stmts_22 = base;
    ...
    ml_backend__ml_switch_gen__ml_switch_generate_mlds_switch_9_p_0(TaggedCases_16, SwitchVar_13, CodeModel_18, CanFail_15, EntryPackedWordMap_20, Context_21, Stmts_22, STATE_VARIABLE_Info_0_45, STATE_VARIABLE_Info_46);
}
