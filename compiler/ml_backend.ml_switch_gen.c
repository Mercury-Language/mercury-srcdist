  ...
  MR_Word * STATE_VARIABLE_Info_32)
{
  ...
  backend_libs__lookup_switch_util__filter_out_failing_cases_if_needed_5_p_0(CodeModel_16, TaggedCases_19, &FilteredTaggedCases_24, CanFail_15, &FilteredCanFail_25);
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            backend_libs__lookup_switch_util__filter_out_failing_cases_if_needed_5_p_0(CodeModel_18, TaggedCases_16, &FilteredTaggedCases_36, CanFail_15, &FilteredCanFail_37);
