      ...
      case (MR_Integer) 1:
        {
...

          {
            ...
            MR_hl_field(MR_mktag(3), ml_backend__ml_switch_gen__Var_50, 1) = ((MR_Box) (ml_backend__ml_switch_gen__String_13));
          }
          {
          ...
          case (MR_Integer) 2:
            {
...

              {
                ...
                MR_hl_field(MR_mktag(3), ml_backend__ml_switch_gen__Var_49, 1) = ((MR_Box) (ml_backend__ml_switch_gen__ForeignLang_14));
                MR_hl_field(MR_mktag(3), ml_backend__ml_switch_gen__Var_49, 2) = ((MR_Box) (ml_backend__ml_switch_gen__ForeignTag_15));
