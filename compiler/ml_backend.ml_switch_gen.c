...
{
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        {
          Rval_70 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
        ...
        if (succeeded)
          {
            Range_71 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        ...
        ml_backend__ml_switch_gen__ml_switch_generate_mlds_cases_8_p_0(Type_67, MLDS_Type_68, TaggedCases_16, CodeModel_18, EntryPackedWordMap_20, &MLDS_Cases_72, STATE_VARIABLE_Info_0_42, &STATE_VARIABLE_Info_29_76);
        ...
        {
          SwitchStmt0_74 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (7 * sizeof(MR_Word)), NULL, NULL));
        ...
        ml_backend__ml_switch_gen__ml_switch_generate_if_then_else_chain_9_p_0(TaggedCases_16, SwitchVar_13, CodeModel_18, CanFail_15, EntryPackedWordMap_20, Context_21, Stmts_22, STATE_VARIABLE_Info_0_42, STATE_VARIABLE_Info_43);
    }
  }
}
          ...
          case (MR_Integer) 1:
            {
              ...
              MR_Word Var_44;
              MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Tag_10, (MR_Integer) 1)));
