...
MR_decl_label3(ml_backend__ml_switch_gen__ml_switch_generate_mlds_cases_5_0, 4,5,3)
...
MR_BEGIN_MODULE(ml_backend__ml_switch_gen_module8)
	...
	MR_init_label3(ml_backend__ml_switch_gen__ml_switch_generate_mlds_cases_5_0,4,5,3)
MR_BEGIN_CODE
