            ...
            case (MR_Integer) 2:
              {
                ...
                libs__globals__lookup_int_option_3_p_0(Globals_26, (MR_Integer) 452, &TagSize_29);
...
{
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        succeeded = libs__globals__lookup_bool_option_3_p_1(Globals_25, (MR_Integer) 329, (MR_Integer) 1);
        if (!(succeeded))
        {
          MR_Word Var_64;
      ...
      else
      {
        ...
        else
        {
          ...
          libs__globals__lookup_int_option_3_p_0(Globals_25, (MR_Integer) 449, &StringTrieSwitchSize_29);
          ...
          else
          {
            ...
            libs__globals__lookup_int_option_3_p_0(Globals_25, (MR_Integer) 450, &StringHashSwitchSize_31);
            ...
            else
            {
              ...
              libs__globals__lookup_int_option_3_p_0(Globals_25, (MR_Integer) 451, &StringBinarySwitchSize_32);
