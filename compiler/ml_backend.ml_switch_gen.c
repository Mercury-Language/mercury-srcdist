  ...
  MR_Word * STATE_VARIABLE_Info_36)
{
  ...
  hlds__var_table__lookup_var_entry_3_p_0(VarTable_20, SwitchVar_11, &SwitchVarEntry_21);
    ...
    case (MR_Integer) 1:
      {
        ...
        hlds__var_table__lookup_var_entry_3_p_0(VarTable_33, SwitchVar_10, &VarEntry_34);
  ...
  MR_Word * STATE_VARIABLE_Info_31)
{
  ...
  hlds__var_table__lookup_var_entry_3_p_0(VarTable_18, Var_11, &VarEntry_19);
