      ...
      case (MR_Integer) 2:
        {
          ...
          succeeded = ((((MR_tag((MR_Word) MLDS_Type_51)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(3, MLDS_Type_51, (MR_Integer) 0)))) == (MR_Integer) 1)));
          if (succeeded)
          {
  ...
  MR_Word * STATE_VARIABLE_Info_31)
{
  ...
  succeeded = ((((MR_tag((MR_Word) MLDS_Type_21)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(3, MLDS_Type_21, (MR_Integer) 0)))) == (MR_Integer) 1)));
  if (succeeded)
  {
