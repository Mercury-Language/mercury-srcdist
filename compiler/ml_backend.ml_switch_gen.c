...
MR_decl_label10(ml_backend__ml_switch_gen__ml_gen_switch_10_0, 35,36,25,41,40,23,47,50,51,53)
MR_decl_label10(ml_backend__ml_switch_gen__ml_gen_switch_10_0, 54,55,57,56,66,65,68,63,70,62)
MR_decl_label10(ml_backend__ml_switch_gen__ml_gen_switch_10_0, 78,77,80,82,74,52,49,91,92,95)
MR_decl_label3(ml_backend__ml_switch_gen__ml_gen_switch_10_0, 97,94,98)
...
MR_decl_entry(ml_backend__ml_string_switch__ml_generate_string_hash_switch_9_0);
MR_decl_entry(ml_backend__ml_string_switch__ml_generate_string_binary_switch_9_0);
...
MR_BEGIN_MODULE(ml_backend__ml_switch_gen_module11)
	...
	MR_init_label10(ml_backend__ml_switch_gen__ml_gen_switch_10_0,35,36,25,41,40,23,47,50,51,53)
	MR_init_label10(ml_backend__ml_switch_gen__ml_gen_switch_10_0,54,55,57,56,66,65,68,63,70,62)
	MR_init_label10(ml_backend__ml_switch_gen__ml_gen_switch_10_0,78,77,80,82,74,52,49,91,92,95)
	MR_init_label3(ml_backend__ml_switch_gen__ml_gen_switch_10_0,97,94,98)
MR_BEGIN_CODE
...
MR_def_label(ml_backend__ml_switch_gen__ml_gen_switch_10_0,56)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (((MR_Integer) MR_sv(9) < (MR_Integer) MR_sv(12))) {
...
MR_def_label(ml_backend__ml_switch_gen__ml_gen_switch_10_0,70)
	...
	MR_decr_sp(16);
	MR_np_tailcall_ent(ml_backend__ml_string_switch__ml_generate_string_hash_switch_9_0);
MR_def_label(ml_backend__ml_switch_gen__ml_gen_switch_10_0,62)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (((MR_Integer) MR_sv(9) < (MR_Integer) MR_sv(13))) {
...
MR_def_label(ml_backend__ml_switch_gen__ml_gen_switch_10_0,78)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(ml_backend__ml_switch_gen__ml_gen_switch_10_0_i77);
	}
	MR_r1 = MR_sv(5);
	MR_np_call_localret_ent(ml_backend__ml_switch_gen__target_supports_goto_1_0,
		ml_backend__ml_switch_gen__ml_gen_switch_10_0_i82);
...
MR_def_label(ml_backend__ml_switch_gen__ml_gen_switch_10_0,82)
	...
	MR_succip_word = MR_sv(16);
	MR_decr_sp(16);
	MR_np_tailcall_ent(ml_backend__ml_string_switch__ml_generate_string_binary_switch_9_0);
...
MR_def_label(ml_backend__ml_switch_gen__ml_gen_switch_10_0,92)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (((MR_Integer) MR_sv(13) < (MR_Integer) MR_r1)) {
		MR_GOTO_LAB(ml_backend__ml_switch_gen__ml_gen_switch_10_0_i94);
	}
	if (MR_INT_LE(MR_sv(14),1)) {
		MR_GOTO_LAB(ml_backend__ml_switch_gen__ml_gen_switch_10_0_i94);
	}
	MR_r1 = MR_sv(5);
	MR_np_call_localret_ent(ml_backend__ml_switch_gen__target_supports_int_switch_1_0,
