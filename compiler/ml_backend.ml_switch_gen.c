            ...
            case (MR_Integer) 3:
              {
                ...
                libs__globals__lookup_int_option_3_p_0(Globals_27, (MR_Integer) 463, &TagSize_30);
...
{
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        succeeded = libs__globals__lookup_bool_option_3_p_1(Globals_27, (MR_Integer) 340, (MR_Integer) 1);
        if (!(succeeded))
        {
          MR_Word Var_66;
      ...
      else
      {
        ...
        else
        {
          ...
          libs__globals__lookup_int_option_3_p_0(Globals_27, (MR_Integer) 460, &StringTrieSwitchSize_31);
          ...
          else
          {
            ...
            libs__globals__lookup_int_option_3_p_0(Globals_27, (MR_Integer) 461, &StringHashSwitchSize_33);
            ...
            else
            {
              ...
              libs__globals__lookup_int_option_3_p_0(Globals_27, (MR_Integer) 462, &StringBinarySwitchSize_34);
...
{
  {
    ...
    if (succeeded)
    {
      succeeded = (MaybeIntSwitchInfo_17 != (MR_Word) ((MR_Unsigned) 0U));
      if (succeeded)
      {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        MR_Integer MinRange_86;
        MR_Integer MaxRange_87;
        MR_Word ModuleInfo_83;
        MR_Word Type_84;
        MR_Word TypeCategory_85;
        MR_Integer _NumValuesInRange_88;
        ...
        succeeded = ((((MR_tag((MR_Word) MLDS_Type_68)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(MR_mktag(3), MLDS_Type_68, (MR_Integer) 0)))) == (MR_Integer) 0)));
        if (succeeded)
        {
          Type_84 = ((MR_Word) ((MR_hl_field(MR_mktag(3), MLDS_Type_68, (MR_Integer) 1))));
          TypeCategory_85 = ((MR_Word) ((MR_hl_field(MR_mktag(3), MLDS_Type_68, (MR_Integer) 2))));
          succeeded = backend_libs__switch_util__type_range_6_p_0(ModuleInfo_83, TypeCategory_85, Type_84, &MinRange_86, &MaxRange_87, &_NumValuesInRange_88);
        }
        if (succeeded)
          {
            Range_71 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), Range_71, 0) = ((MR_Box) (MinRange_86));
            MR_hl_field(MR_mktag(1), Range_71, 1) = ((MR_Box) (MaxRange_87));
          }
        else
