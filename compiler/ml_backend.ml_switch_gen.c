            ...
            case (MR_Integer) 3:
              {
                ...
                libs__globals__lookup_int_option_3_p_0(Globals_27, (MR_Integer) 465, &TagSize_30);
    ...
    else
    {
      ...
      else
      {
        ...
        else
        {
          ...
          libs__globals__lookup_int_option_3_p_0(Globals_27, (MR_Integer) 462, &StringTrieSwitchSize_31);
          ...
          else
          {
            ...
            libs__globals__lookup_int_option_3_p_0(Globals_27, (MR_Integer) 463, &StringHashSwitchSize_33);
            ...
            else
            {
              ...
              libs__globals__lookup_int_option_3_p_0(Globals_27, (MR_Integer) 464, &StringBinarySwitchSize_34);
