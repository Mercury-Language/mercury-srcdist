      ...
      case (MR_Integer) 1:
        {
          ...
          {
            ml_backend__ml_switch_gen__V_50_50 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(3), ml_backend__ml_switch_gen__V_50_50, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 4));
            MR_hl_field(MR_mktag(3), ml_backend__ml_switch_gen__V_50_50, 1) = ((MR_Box) (ml_backend__ml_switch_gen__String_13));
          }
          {
              ...
              if (ml_backend__ml_switch_gen__succeeded)
                {
                  ml_backend__ml_switch_gen__V_10_10 = ((MR_Integer) (MR_hl_field(MR_mktag(3), ml_backend__ml_switch_gen__ConsId_7, (MR_Integer) 1)));
                  {
                    ...
                    {
                      ml_backend__ml_switch_gen__V_51_51 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
                      MR_hl_field(MR_mktag(2), ml_backend__ml_switch_gen__V_51_51, 0) = ((MR_Box) (ml_backend__ml_switch_gen__Int_9));
                    }
                    {
                      ml_backend__ml_switch_gen__Rval_11 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                      MR_hl_field(MR_mktag(3), ml_backend__ml_switch_gen__Rval_11, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 0));
                  ...
                  if (ml_backend__ml_switch_gen__succeeded)
                    {
                      ml_backend__ml_switch_gen__V_12_12 = ((MR_Char) (MR_Word) (MR_hl_field(MR_mktag(3), ml_backend__ml_switch_gen__ConsId_7, (MR_Integer) 1)));
                      {
                        ...
                        {
                          ml_backend__ml_switch_gen__V_52_52 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                          MR_hl_field(MR_mktag(3), ml_backend__ml_switch_gen__V_52_52, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 2));
                  ...
                  else
                    {
                      ...
                      {
                        ml_backend__ml_switch_gen__V_53_53 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL));
                        MR_hl_field(MR_mktag(3), ml_backend__ml_switch_gen__V_53_53, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 1));
                        MR_hl_field(MR_mktag(3), ml_backend__ml_switch_gen__V_53_53, 1) = ((MR_Box) (ml_backend__ml_switch_gen__Int_9));
                        MR_hl_field(MR_mktag(3), ml_backend__ml_switch_gen__V_53_53, 2) = ((MR_Box) (ml_backend__ml_switch_gen__MLDS_Type_4));
                      }
                      {
                        ml_backend__ml_switch_gen__Rval_11 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                        MR_hl_field(MR_mktag(3), ml_backend__ml_switch_gen__Rval_11, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 0));
                        MR_hl_field(MR_mktag(3), ml_backend__ml_switch_gen__Rval_11, 1) = ((MR_Box) (ml_backend__ml_switch_gen__V_53_53));
                      }
                    }
                }
            }
          ...
          case (MR_Integer) 2:
            {
              ...
              {
                ml_backend__ml_switch_gen__V_49_49 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), ml_backend__ml_switch_gen__V_49_49, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 6));
                MR_hl_field(MR_mktag(3), ml_backend__ml_switch_gen__V_49_49, 1) = ((MR_Box) (ml_backend__ml_switch_gen__ForeignLang_14));
                MR_hl_field(MR_mktag(3), ml_backend__ml_switch_gen__V_49_49, 2) = ((MR_Box) (ml_backend__ml_switch_gen__ForeignTag_15));
                MR_hl_field(MR_mktag(3), ml_backend__ml_switch_gen__V_49_49, 3) = ((MR_Box) (ml_backend__ml_switch_gen__MLDS_Type_4));
              }
              {
                ml_backend__ml_switch_gen__Rval_11 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), ml_backend__ml_switch_gen__Rval_11, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 0));
    ...
    if (ml_backend__ml_switch_gen__succeeded)
    ...
    else
      {
        ...
        if (ml_backend__ml_switch_gen__succeeded)
          {
            {
              ml_backend__ml_switch_gen__succeeded = libs__globals__lookup_bool_option_3_p_1(ml_backend__ml_switch_gen__Globals_25, (MR_Integer) 321, (MR_Integer) 1);
            }
            if (!(ml_backend__ml_switch_gen__succeeded))
              {
        ...
        else
          {
            ...
            if (ml_backend__ml_switch_gen__succeeded)
            ...
            else
              {
                ...
                {
                  libs__globals__lookup_int_option_3_p_0(ml_backend__ml_switch_gen__Globals_25, (MR_Integer) 436, &ml_backend__ml_switch_gen__StringTrieSwitchSize_29);
                }
                ...
                if (ml_backend__ml_switch_gen__succeeded)
                ...
                else
                  {
                    ...
                    {
                      libs__globals__lookup_int_option_3_p_0(ml_backend__ml_switch_gen__Globals_25, (MR_Integer) 437, &ml_backend__ml_switch_gen__StringHashSwitchSize_31);
                    }
                    ...
                    if (ml_backend__ml_switch_gen__succeeded)
                    ...
                    else
                      {
                        ...
                        {
                          libs__globals__lookup_int_option_3_p_0(ml_backend__ml_switch_gen__Globals_25, (MR_Integer) 438, &ml_backend__ml_switch_gen__StringBinarySwitchSize_32);
                        }
        ...
        if (ml_backend__ml_switch_gen__succeeded)
          {
            ...
            ml_backend__ml_switch_gen__V_45_45 = (MR_Integer) 448;
            ...
            if (ml_backend__ml_switch_gen__succeeded)
              {
                ml_backend__ml_switch_gen__V_47_47 = (MR_Integer) 435;
                {
                ...
                if (ml_backend__ml_switch_gen__succeeded)
                  {
                    ...
                    if (ml_backend__ml_switch_gen__succeeded)
                      {
                        ml_backend__ml_switch_gen__V_49_49 = (MR_Integer) 433;
                        {
            ...
            case (MR_Integer) 2:
              {
                ...
                {
                  libs__globals__lookup_int_option_3_p_0(ml_backend__ml_switch_gen__Globals_26, (MR_Integer) 439, &ml_backend__ml_switch_gen__TagSize_29);
                }
