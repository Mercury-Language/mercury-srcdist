            ...
            case (MR_Integer) 3:
              {
                ...
                libs__globals__lookup_int_option_3_p_0(Globals_27, (MR_Integer) 458, &TagSize_30);
...
{
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        succeeded = libs__globals__lookup_bool_option_3_p_1(Globals_27, (MR_Integer) 335, (MR_Integer) 1);
        if (!(succeeded))
        {
          MR_Word Var_66;
      ...
      else
      {
        ...
        else
        {
          ...
          libs__globals__lookup_int_option_3_p_0(Globals_27, (MR_Integer) 455, &StringTrieSwitchSize_31);
          ...
          else
          {
            ...
            libs__globals__lookup_int_option_3_p_0(Globals_27, (MR_Integer) 456, &StringHashSwitchSize_33);
            ...
            else
            {
              ...
              libs__globals__lookup_int_option_3_p_0(Globals_27, (MR_Integer) 457, &StringBinarySwitchSize_34);
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        ml_backend__ml_switch_gen__ml_switch_generate_default_6_p_0(CanFail_15, CodeModel_18, Context_21, &Default_73, STATE_VARIABLE_Info_29_76, &STATE_VARIABLE_Info_30_77);
        {
          ...
          MR_hl_field(MR_mktag(3), SwitchStmt0_74, 0) = ((MR_Box) ((MR_Unsigned) 0U));
          ...
          case (MR_Integer) 1:
            {
              ...
              MR_Word Var_44;
              MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Tag_10, (MR_Integer) 1)));

              {
                ...
                MR_hl_field(MR_mktag(3), Var_44, 1) = (MR_Box) (packed_args_0);
