      ...
      case (MR_Integer) 1:
        {
...

          {
            ...
            MR_hl_field(MR_mktag(3), ml_backend__ml_switch_gen__Var_50, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 4));
            MR_hl_field(MR_mktag(3), ml_backend__ml_switch_gen__Var_50, 1) = ((MR_Box) (ml_backend__ml_switch_gen__String_14));
          }
          {
              ...
              if (ml_backend__ml_switch_gen__succeeded)
                {
                  ml_backend__ml_switch_gen__Var_10 = ((MR_Integer) (MR_hl_field(MR_mktag(3), ml_backend__ml_switch_gen__ConsId_7, (MR_Integer) 1)));
                  {
                    ...
                    {
                      ml_backend__ml_switch_gen__Var_52 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
                      MR_hl_field(MR_mktag(2), ml_backend__ml_switch_gen__Var_52, 0) = ((MR_Box) (ml_backend__ml_switch_gen__Int_9));
                    }
                    {
                      ml_backend__ml_switch_gen__Rval_11 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                      MR_hl_field(MR_mktag(3), ml_backend__ml_switch_gen__Rval_11, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 0));
                  ...
                  if (ml_backend__ml_switch_gen__succeeded)
                    {
                      ml_backend__ml_switch_gen__Var_12 = ((MR_Char) (MR_Word) (MR_hl_field(MR_mktag(3), ml_backend__ml_switch_gen__ConsId_7, (MR_Integer) 1)));
                      {
                        ...
                        {
                          ml_backend__ml_switch_gen__Var_53 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                          MR_hl_field(MR_mktag(3), ml_backend__ml_switch_gen__Var_53, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 2));
                  ...
                  else
                    {
                      ...
                      {
                        ml_backend__ml_switch_gen__Var_54 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL));
                        MR_hl_field(MR_mktag(3), ml_backend__ml_switch_gen__Var_54, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 1));
                        MR_hl_field(MR_mktag(3), ml_backend__ml_switch_gen__Var_54, 1) = ((MR_Box) (ml_backend__ml_switch_gen__Int_9));
                        MR_hl_field(MR_mktag(3), ml_backend__ml_switch_gen__Var_54, 2) = ((MR_Box) (ml_backend__ml_switch_gen__MLDS_Type_4));
                      }
                      {
                        ml_backend__ml_switch_gen__Rval_11 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                        MR_hl_field(MR_mktag(3), ml_backend__ml_switch_gen__Rval_11, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 0));
          ...
          case (MR_Integer) 1:
            {
              ...
              {
                ml_backend__ml_switch_gen__Var_51 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), ml_backend__ml_switch_gen__Var_51, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 0));
                MR_hl_field(MR_mktag(3), ml_backend__ml_switch_gen__Var_51, 1) = ((MR_Box) (ml_backend__ml_switch_gen__UInt_13));
              }
              {
                ml_backend__ml_switch_gen__Rval_11 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), ml_backend__ml_switch_gen__Rval_11, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 0));
          ...
          case (MR_Integer) 2:
            {
              ...
              {
                ml_backend__ml_switch_gen__Var_49 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), ml_backend__ml_switch_gen__Var_49, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 6));
                MR_hl_field(MR_mktag(3), ml_backend__ml_switch_gen__Var_49, 1) = ((MR_Box) (ml_backend__ml_switch_gen__ForeignLang_15));
                MR_hl_field(MR_mktag(3), ml_backend__ml_switch_gen__Var_49, 2) = ((MR_Box) (ml_backend__ml_switch_gen__ForeignTag_16));
                MR_hl_field(MR_mktag(3), ml_backend__ml_switch_gen__Var_49, 3) = ((MR_Box) (ml_backend__ml_switch_gen__MLDS_Type_4));
              }
              {
                ml_backend__ml_switch_gen__Rval_11 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), ml_backend__ml_switch_gen__Rval_11, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 0));
    ...
    if ((ml_backend__ml_switch_gen__HeadVar__2_2 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
    ...
    else
      {
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(0), ml_backend__ml_switch_gen__Var_37, 0) = ((MR_Box) (&ml_backend__ml_switch_gen_scalar_common_3[1]));
    ...
    if (ml_backend__ml_switch_gen__succeeded)
      {
        ...
        {
          ml_backend__ml_switch_gen__Var_42 = backend_libs__foreign__to_exported_type_2_f_0(ml_backend__ml_switch_gen__ModuleInfo_35, ml_backend__ml_switch_gen__Type_37);
        }
        {
          ml_backend__ml_switch_gen__succeeded = backend_libs__foreign____Unify____exported_type_0_0(ml_backend__ml_switch_gen__ExportedType_36, ml_backend__ml_switch_gen__Var_42);
        }
        if (ml_backend__ml_switch_gen__succeeded)
          {
...
{
  {
    ...
    if ((ml_backend__ml_switch_gen__TaggedCases_11 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
        ...
        case (MR_Integer) 0:
          {
            ...
            {
              ml_backend__ml_unify_gen__ml_gen_known_tag_test_5_p_0(ml_backend__ml_switch_gen__Var_12, ml_backend__ml_switch_gen__Var_18, &ml_backend__ml_switch_gen__MainTagTestRval_60, ml_backend__ml_switch_gen__STATE_VARIABLE_Info_0_31, &ml_backend__ml_switch_gen__STATE_VARIABLE_Info_18_62);
            }
            {
              ml_backend__ml_switch_gen__Var_63 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL);
              MR_hl_field(MR_mktag(0), ml_backend__ml_switch_gen__Var_63, 0) = ((MR_Box) (&ml_backend__ml_switch_gen_scalar_common_4[0]));
              MR_hl_field(MR_mktag(0), ml_backend__ml_switch_gen__Var_63, 1) = ((MR_Box) (ml_backend__ml_switch_gen__ml_switch_generate_if_then_else_chain_ites_9_p_0_1));
              MR_hl_field(MR_mktag(0), ml_backend__ml_switch_gen__Var_63, 2) = ((MR_Box) (MR_Word) ((MR_Integer) 1));
              MR_hl_field(MR_mktag(0), ml_backend__ml_switch_gen__Var_63, 3) = ((MR_Box) (ml_backend__ml_switch_gen__Var_12));
            }
            {
              mercury__list__map_foldl_5_p_0((MR_Word) &hlds__hlds_data__hlds__hlds_data__type_ctor_info_tagged_cons_id_0, (MR_Word) &ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_rval_0, (MR_Word) &ml_backend__ml_gen_info__ml_backend__ml_gen_info__type_ctor_info_ml_gen_info_0, ml_backend__ml_switch_gen__Var_63, ml_backend__ml_switch_gen__Var_19, &ml_backend__ml_switch_gen__OtherTagTestRval_61, ((MR_Box) (ml_backend__ml_switch_gen__STATE_VARIABLE_Info_18_62)), &ml_backend__ml_switch_gen__conv2_STATE_VARIABLE_Info_40_40);
            }
            ...
            }
            {
              ...
              MR_hl_field(MR_mktag(2), ml_backend__ml_switch_gen__Stmt_26, 2) = ((MR_Box) (ml_backend__ml_switch_gen__Var_44));
            }
            {
              ml_backend__ml_switch_gen__Var_45 = ml_backend__mlds__mlds_make_context_1_f_0(ml_backend__ml_switch_gen__Context_15);
            }
            {
              ...
              MR_hl_field(MR_mktag(0), ml_backend__ml_switch_gen__Statement_16, 1) = ((MR_Box) (ml_backend__ml_switch_gen__Var_45));
            }
          }
          break;
        case (MR_Integer) 1:
    ...
    else
      {
        ...
        MR_Word ml_backend__ml_switch_gen__Var_39;
        ...
        MR_Word ml_backend__ml_switch_gen__Var_85;
        MR_Box ml_backend__ml_switch_gen__conv5_STATE_VARIABLE_Info_34_34;

        {
          ml_backend__ml_unify_gen__ml_gen_known_tag_test_5_p_0(ml_backend__ml_switch_gen__Var_12, ml_backend__ml_switch_gen__Var_18, &ml_backend__ml_switch_gen__MainTagTestRval_82, ml_backend__ml_switch_gen__STATE_VARIABLE_Info_0_31, &ml_backend__ml_switch_gen__STATE_VARIABLE_Info_18_84);
        }
        {
          ml_backend__ml_switch_gen__Var_85 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), ml_backend__ml_switch_gen__Var_85, 0) = ((MR_Box) (&ml_backend__ml_switch_gen_scalar_common_4[0]));
          MR_hl_field(MR_mktag(0), ml_backend__ml_switch_gen__Var_85, 1) = ((MR_Box) (ml_backend__ml_switch_gen__ml_switch_generate_if_then_else_chain_ites_9_p_0_2));
          MR_hl_field(MR_mktag(0), ml_backend__ml_switch_gen__Var_85, 2) = ((MR_Box) (MR_Word) ((MR_Integer) 1));
          MR_hl_field(MR_mktag(0), ml_backend__ml_switch_gen__Var_85, 3) = ((MR_Box) (ml_backend__ml_switch_gen__Var_12));
        }
        {
          mercury__list__map_foldl_5_p_0((MR_Word) &hlds__hlds_data__hlds__hlds_data__type_ctor_info_tagged_cons_id_0, (MR_Word) &ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_rval_0, (MR_Word) &ml_backend__ml_gen_info__ml_backend__ml_gen_info__type_ctor_info_ml_gen_info_0, ml_backend__ml_switch_gen__Var_85, ml_backend__ml_switch_gen__Var_19, &ml_backend__ml_switch_gen__OtherTagTestRval_83, ((MR_Box) (ml_backend__ml_switch_gen__STATE_VARIABLE_Info_18_84)), &ml_backend__ml_switch_gen__conv5_STATE_VARIABLE_Info_34_34);
        }
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(1), ml_backend__ml_switch_gen__Var_38, 0) = ((MR_Box) (ml_backend__ml_switch_gen__LaterBlock_30));
        }
        {
          ...
          MR_hl_field(MR_mktag(2), ml_backend__ml_switch_gen__Stmt_49, 2) = ((MR_Box) (ml_backend__ml_switch_gen__Var_38));
        }
        {
          ml_backend__ml_switch_gen__Var_39 = ml_backend__mlds__mlds_make_context_1_f_0(ml_backend__ml_switch_gen__Context_15);
        }
        {
          ml_backend__ml_switch_gen__Statement_16 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), ml_backend__ml_switch_gen__Statement_16, 0) = ((MR_Box) (ml_backend__ml_switch_gen__Stmt_49));
          MR_hl_field(MR_mktag(0), ml_backend__ml_switch_gen__Statement_16, 1) = ((MR_Box) (ml_backend__ml_switch_gen__Var_39));
        }
      }
    {
      MR_Word base;
...
{
  {
    ...
    MR_Word ml_backend__ml_switch_gen__Var_45;
    MR_Word ml_backend__ml_switch_gen__Var_46;
    MR_Word ml_backend__ml_switch_gen__Var_47;
    MR_Integer ml_backend__ml_switch_gen__Var_48;
    MR_Word ml_backend__ml_switch_gen__Var_49;
    ...
    {
      ml_backend__ml_gen_info__ml_gen_info_get_high_level_data_2_p_0(ml_backend__ml_switch_gen__STATE_VARIABLE_Info_0_42, &ml_backend__ml_switch_gen__Var_56);
    }
    ml_backend__ml_switch_gen__succeeded = ((MR_Integer) 0 == ml_backend__ml_switch_gen__Var_56);
    if (ml_backend__ml_switch_gen__succeeded)
      {
        ...
        if (ml_backend__ml_switch_gen__succeeded)
          {
            ...
            ml_backend__ml_switch_gen__Var_45 = (MR_Integer) 456;
            ml_backend__ml_switch_gen__Var_46 = (MR_Integer) 1;
            {
              ml_backend__ml_switch_gen__succeeded = libs__globals__lookup_bool_option_3_p_1(ml_backend__ml_switch_gen__Globals_27, ml_backend__ml_switch_gen__Var_45, ml_backend__ml_switch_gen__Var_46);
            }
            if (ml_backend__ml_switch_gen__succeeded)
              {
                ml_backend__ml_switch_gen__Var_47 = (MR_Integer) 443;
                {
                  libs__globals__lookup_int_option_3_p_0(ml_backend__ml_switch_gen__Globals_27, ml_backend__ml_switch_gen__Var_47, &ml_backend__ml_switch_gen__LookupSize_31);
                }
                ml_backend__ml_switch_gen__succeeded = (ml_backend__ml_switch_gen__NumConsIds_24 >= ml_backend__ml_switch_gen__LookupSize_31);
                if (ml_backend__ml_switch_gen__succeeded)
                  {
                    ml_backend__ml_switch_gen__Var_48 = (MR_Integer) 1;
                    ml_backend__ml_switch_gen__succeeded = (ml_backend__ml_switch_gen__NumArms_25 > ml_backend__ml_switch_gen__Var_48);
                    if (ml_backend__ml_switch_gen__succeeded)
                      {
                        ml_backend__ml_switch_gen__Var_49 = (MR_Integer) 441;
                        {
                          libs__globals__lookup_int_option_3_p_0(ml_backend__ml_switch_gen__Globals_27, ml_backend__ml_switch_gen__Var_49, &ml_backend__ml_switch_gen__ReqDensity_32);
                        }
                        {
    ...
    if (ml_backend__ml_switch_gen__succeeded)
    ...
    else
      {
        ...
        {
          ml_backend__ml_switch_gen__Var_53 = ml_backend__ml_target_util__globals_target_supports_int_switch_1_f_0(ml_backend__ml_switch_gen__Globals_27);
        }
        ml_backend__ml_switch_gen__succeeded = (ml_backend__ml_switch_gen__Var_53 == (MR_Integer) 1);
        if (ml_backend__ml_switch_gen__succeeded)
          {
            ...
            MR_Word ml_backend__ml_switch_gen__Var_90;
            ...
            if (ml_backend__ml_switch_gen__succeeded)
              {
                ...
                {
                  ml_backend__ml_switch_gen__Var_90 = backend_libs__foreign__to_exported_type_2_f_0(ml_backend__ml_switch_gen__ModuleInfo_83, ml_backend__ml_switch_gen__Type_85);
                }
                {
                  ml_backend__ml_switch_gen__succeeded = backend_libs__foreign____Unify____exported_type_0_0(ml_backend__ml_switch_gen__ExportedType_84, ml_backend__ml_switch_gen__Var_90);
                }
                if (ml_backend__ml_switch_gen__succeeded)
                  {
