...
{
  {
    ...
    ml_backend__ml_gen_info__ml_gen_info_get_module_info_2_p_0(STATE_VARIABLE_Info_0_32, &ModuleInfo_20);
    ml_backend__ml_code_util__ml_variable_type_3_p_0(STATE_VARIABLE_Info_0_32, SwitchVar_11, &SwitchVarType_21);
    backend_libs__switch_util__tag_cases_5_p_0(ModuleInfo_20, SwitchVarType_21, Cases_13, &TaggedCases_22, &MaybeIntSwitchInfo_23);
    ml_backend__ml_gen_info__ml_gen_info_get_packed_word_map_2_p_0(STATE_VARIABLE_Info_0_32, &EntryPackedWordMap_24);
    ...
    switch (MayUseSmartIndexing_26) {
      ...
      case (MR_Integer) 0:
        {
          ml_backend__ml_switch_gen__ml_switch_generate_if_then_else_chain_9_p_0(TaggedCases_22, SwitchVar_11, CodeModel_14, CanFail_12, EntryPackedWordMap_24, Context_15, Stmts_18, STATE_VARIABLE_Info_0_32, &STATE_VARIABLE_Info_42_42);
      ...
      case (MR_Integer) 1:
        {
          ...
          switch (SwitchCategory_25) {
            ...
            case (MR_Integer) 0:
              {
                ml_backend__ml_switch_gen__ml_gen_smart_atomic_switch_12_p_0(SwitchVar_11, SwitchVarType_21, CanFail_12, TaggedCases_22, MaybeIntSwitchInfo_23, CodeModel_14, GoalInfo_16, EntryPackedWordMap_24, Context_15, Stmts_18, STATE_VARIABLE_Info_0_32, &STATE_VARIABLE_Info_42_42);
                *Decls_17 = (MR_Word) ((MR_Unsigned) 0U);
              }
              break;
            case (MR_Integer) 4:
            ...
            case (MR_Integer) 1:
              {
                ml_backend__ml_switch_gen__ml_gen_smart_int64_switch_9_p_0(SwitchVar_11, CanFail_12, TaggedCases_22, CodeModel_14, EntryPackedWordMap_24, Context_15, Stmts_18, STATE_VARIABLE_Info_0_32, &STATE_VARIABLE_Info_42_42);
                *Decls_17 = (MR_Word) ((MR_Unsigned) 0U);
              }
              break;
            case (MR_Integer) 2:
              ml_backend__ml_switch_gen__ml_gen_smart_string_switch_11_p_0(SwitchVar_11, CanFail_12, TaggedCases_22, CodeModel_14, GoalInfo_16, EntryPackedWordMap_24, Context_15, Decls_17, Stmts_18, STATE_VARIABLE_Info_0_32, &STATE_VARIABLE_Info_42_42);
              break;
            case (MR_Integer) 3:
              {
                ...
                succeeded = (NumConsIds_28 >= TagSize_31);
                if (succeeded)
                {
                  Var_35 = (MR_Integer) 1;
                ...
                if (succeeded)
                  ml_backend__ml_tag_switch__ml_generate_tag_switch_9_p_0(TaggedCases_22, SwitchVar_11, CodeModel_14, CanFail_12, EntryPackedWordMap_24, Context_15, Stmts_18, STATE_VARIABLE_Info_0_32, &STATE_VARIABLE_Info_42_42);
                else
                  ml_backend__ml_switch_gen__ml_switch_generate_if_then_else_chain_9_p_0(TaggedCases_22, SwitchVar_11, CodeModel_14, CanFail_12, EntryPackedWordMap_24, Context_15, Stmts_18, STATE_VARIABLE_Info_0_32, &STATE_VARIABLE_Info_42_42);
                *Decls_17 = (MR_Word) ((MR_Unsigned) 0U);
              }
    ...
    ml_backend__ml_gen_info__ml_gen_info_set_packed_word_map_3_p_0(EntryPackedWordMap_24, STATE_VARIABLE_Info_42_42, STATE_VARIABLE_Info_33);
  }
}
...
{
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        succeeded = libs__globals__lookup_bool_option_3_p_1(Globals_27, (MR_Integer) 353, (MR_Integer) 1);
        if (!(succeeded))
        {
          MR_Word Var_433;

          ml_backend__ml_gen_info__ml_gen_info_get_high_level_data_2_p_0(STATE_VARIABLE_Info_0_36, &Var_433);
          succeeded = ((MR_Integer) 1 == Var_433);
        }
      }
      if (succeeded)
      {
      ...
      {
        {
          ...
          ml_backend__ml_gen_info__ml_gen_info_get_high_level_data_2_p_0(STATE_VARIABLE_Info_0_36, &Var_434);
          succeeded = ((MR_Integer) 1 == Var_434);
        }
        if (!(succeeded))
        {
          MR_Word Var_45;
        ...
        else
        {
          ...
          {
            Var_50 = (MR_Integer) 0;
            libs__globals__get_target_2_p_0(Globals_27, &Var_435);
            succeeded = (Var_50 == Var_435);
          }
          if (succeeded)
          {
      ...
      case (MR_Integer) 1:
        {
          ...
          MR_Word Default_41;
          MR_Word SwitchStmt0_42;
          MR_Word SwitchStmt_43;
          MR_Word STATE_VARIABLE_Info_29_44;
          MR_Word STATE_VARIABLE_Info_30_45;
          MR_Integer MinRange_54;
          MR_Integer MaxRange_55;
          MR_Word ModuleInfo_51;
          MR_Word Type_52;
          MR_Word TypeCategory_53;
          MR_Integer _NumValuesInRange_56;
          ...
          ml_backend__ml_gen_info__ml_gen_info_get_module_info_2_p_0(STATE_VARIABLE_Info_0_21, &ModuleInfo_51);
          ...
          if (succeeded)
          {
            Type_52 = ((MR_Word) ((MR_hl_field(MR_mktag(3), MLDS_Type_36, (MR_Integer) 1))));
            TypeCategory_53 = ((MR_Word) ((MR_hl_field(MR_mktag(3), MLDS_Type_36, (MR_Integer) 2))));
            succeeded = backend_libs__switch_util__type_range_6_p_0(ModuleInfo_51, TypeCategory_53, Type_52, &MinRange_54, &MaxRange_55, &_NumValuesInRange_56);
          }
          if (succeeded)
            {
              Range_39 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), Range_39, 0) = ((MR_Box) (MinRange_54));
              MR_hl_field(MR_mktag(1), Range_39, 1) = ((MR_Box) (MaxRange_55));
            }
          else
            Range_39 = (MR_Word) ((MR_Unsigned) 0U);
          ml_backend__ml_switch_gen__ml_switch_generate_mlds_cases_8_p_0(Type_35, MLDS_Type_36, TaggedCases_12, CodeModel_13, EntryPackedWordMap_14, &MLDS_Cases_40, STATE_VARIABLE_Info_0_21, &STATE_VARIABLE_Info_29_44);
          ml_backend__ml_switch_gen__ml_switch_generate_default_6_p_0(CanFail_11, CodeModel_13, Context_15, &Default_41, STATE_VARIABLE_Info_29_44, &STATE_VARIABLE_Info_30_45);
          {
            SwitchStmt0_42 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (7 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(3), SwitchStmt0_42, 0) = ((MR_Box) ((MR_Unsigned) 0U));
            MR_hl_field(MR_mktag(3), SwitchStmt0_42, 1) = ((MR_Box) (MLDS_Type_36));
            MR_hl_field(MR_mktag(3), SwitchStmt0_42, 2) = ((MR_Box) (Rval_38));
            MR_hl_field(MR_mktag(3), SwitchStmt0_42, 3) = ((MR_Box) (Range_39));
            MR_hl_field(MR_mktag(3), SwitchStmt0_42, 4) = ((MR_Box) (MLDS_Cases_40));
            MR_hl_field(MR_mktag(3), SwitchStmt0_42, 5) = ((MR_Box) (Default_41));
            MR_hl_field(MR_mktag(3), SwitchStmt0_42, 6) = ((MR_Box) (Context_15));
          }
          ml_backend__ml_simplify_switch__ml_simplify_switch_4_p_0(SwitchStmt0_42, &SwitchStmt_43, STATE_VARIABLE_Info_30_45, STATE_VARIABLE_Info_22);
          {
            MR_Word base;
            base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            *Stmts_16 = base;
            MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (SwitchStmt_43));
...
{
  {
    ...
    hlds__hlds_module__module_info_get_globals_2_p_0(ModuleInfo_26, &Globals_27);
    ml_backend__ml_gen_info__ml_gen_info_get_high_level_data_2_p_0(STATE_VARIABLE_Info_0_44, &Var_424);
    succeeded = ((MR_Integer) 0 == Var_424);
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        Var_47 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), OptTuple_32, (MR_Integer) 1))) >> 14)) & (MR_Integer) 1);
