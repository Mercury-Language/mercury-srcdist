          ...
          case (MR_Integer) 0:
            {
...

              {
                ...
                MR_hl_field(MR_mktag(3), Var_47, 1) = ((MR_Box) (String_13));
              }
              {
          ...
          case (MR_Integer) 1:
            {
...

              {
                ...
                MR_hl_field(MR_mktag(3), Var_46, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 14));
                MR_hl_field(MR_mktag(3), Var_46, 1) = ((MR_Box) (ForeignLang_14));
                MR_hl_field(MR_mktag(3), Var_46, 2) = ((MR_Box) (ForeignTag_15));
                MR_hl_field(MR_mktag(3), Var_46, 3) = ((MR_Box) (MLDS_Type_6));
              }
              {
                Rval_12 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), Rval_12, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 1));
