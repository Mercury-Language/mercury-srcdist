...
static /* final */ const MR_Box ml_backend__ml_switch_gen_scalar_common_4[2][6];
...
static /* final */ const MR_Box ml_backend__ml_switch_gen_scalar_common_1[6][3] = {
  ...
  /* row 5 */
  {
    ((MR_Box) (&ml_backend__ml_switch_gen_scalar_common_4[1])),
            ...
            case (MR_Integer) 2:
              {
                ...
                {
                  libs__globals__lookup_int_option_3_p_0(ml_backend__ml_switch_gen__Globals_26, (MR_Integer) 447, &ml_backend__ml_switch_gen__TagSize_29);
                }
    ...
    if (ml_backend__ml_switch_gen__succeeded)
    ...
    else
      {
        ...
        if (ml_backend__ml_switch_gen__succeeded)
          {
            {
              ml_backend__ml_switch_gen__succeeded = libs__globals__lookup_bool_option_3_p_1(ml_backend__ml_switch_gen__Globals_25, (MR_Integer) 326, (MR_Integer) 1);
            }
            if (!(ml_backend__ml_switch_gen__succeeded))
              {
        ...
        else
          {
            ...
            if (ml_backend__ml_switch_gen__succeeded)
            ...
            else
              {
                ...
                {
                  libs__globals__lookup_int_option_3_p_0(ml_backend__ml_switch_gen__Globals_25, (MR_Integer) 444, &ml_backend__ml_switch_gen__StringTrieSwitchSize_29);
                }
                ...
                if (ml_backend__ml_switch_gen__succeeded)
                ...
                else
                  {
                    ...
                    {
                      libs__globals__lookup_int_option_3_p_0(ml_backend__ml_switch_gen__Globals_25, (MR_Integer) 445, &ml_backend__ml_switch_gen__StringHashSwitchSize_31);
                    }
                    ...
                    if (ml_backend__ml_switch_gen__succeeded)
                    ...
                    else
                      {
                        ...
                        {
                          libs__globals__lookup_int_option_3_p_0(ml_backend__ml_switch_gen__Globals_25, (MR_Integer) 446, &ml_backend__ml_switch_gen__StringBinarySwitchSize_32);
                        }
        ...
        if (ml_backend__ml_switch_gen__succeeded)
          {
            ...
            ml_backend__ml_switch_gen__Var_43 = (MR_Integer) 456;
            ...
            if (ml_backend__ml_switch_gen__succeeded)
              {
                ml_backend__ml_switch_gen__Var_45 = (MR_Integer) 443;
                {
                ...
                if (ml_backend__ml_switch_gen__succeeded)
                  {
                    ...
                    if (ml_backend__ml_switch_gen__succeeded)
                      {
                        ml_backend__ml_switch_gen__Var_47 = (MR_Integer) 441;
                        {
...
{
  {
    ...
    if ((ml_backend__ml_switch_gen__HeadVar__2_2 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
    ...
    else
      {
        ...
        MR_Word ml_backend__ml_switch_gen__Stmt_36;
        MR_Word ml_backend__ml_switch_gen__Var_37;
        MR_Word ml_backend__ml_switch_gen__Var_32 = ((MR_Word) (MR_hl_field(MR_mktag(0), ml_backend__ml_switch_gen__TaggedCase_13, (MR_Integer) 2)));
        ...
        {
          ml_backend__ml_switch_gen__Var_37 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), ml_backend__ml_switch_gen__Var_37, 0) = ((MR_Box) (&ml_backend__ml_switch_gen_scalar_common_4[0]));
          MR_hl_field(MR_mktag(0), ml_backend__ml_switch_gen__Var_37, 1) = ((MR_Box) (ml_backend__ml_switch_gen__ml_switch_generate_mlds_cases_6_p_0_1));
          MR_hl_field(MR_mktag(0), ml_backend__ml_switch_gen__Var_37, 2) = ((MR_Box) (MR_Word) ((MR_Integer) 1));
          MR_hl_field(MR_mktag(0), ml_backend__ml_switch_gen__Var_37, 3) = ((MR_Box) (ml_backend__ml_switch_gen__MLDS_Type_1));
        }
        {
          mercury__list__map_3_p_0((MR_Word) &hlds__hlds_data__hlds__hlds_data__type_ctor_info_tagged_cons_id_0, (MR_Word) &ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_case_match_cond_0, ml_backend__ml_switch_gen__Var_37, ml_backend__ml_switch_gen__TaggedOtherConsIds_31, &ml_backend__ml_switch_gen__OtherConds_35);
        }
        {
          ml_backend__ml_code_gen__ml_gen_goal_as_branch_block_5_p_0(ml_backend__ml_switch_gen__CodeModel_3, ml_backend__ml_switch_gen__Goal_33, &ml_backend__ml_switch_gen__Stmt_36, ml_backend__ml_switch_gen__STATE_VARIABLE_Info_0_5, &ml_backend__ml_switch_gen__STATE_VARIABLE_Info_21_21);
        }
        {
          ...
          MR_hl_field(MR_mktag(0), ml_backend__ml_switch_gen__MLDS_Case_16, 2) = ((MR_Box) (ml_backend__ml_switch_gen__Stmt_36));
        }
        {
...
{
  {
    ...
    switch (MR_tag((MR_Word) ml_backend__ml_switch_gen__Tag_8)) {
      ...
      case (MR_Integer) 0:
        {
          {
            mercury__require__unexpected_2_p_0((MR_String) "predicate \140ml_backend.ml_switch_gen.ml_tagged_cons_id_to_match_cond\'/3", (MR_String) "invalid tag type");
            return;
          }
        }
        break;
      case (MR_Integer) 1:
        {
          MR_String ml_backend__ml_switch_gen__String_20 = ((MR_String) (MR_hl_field(MR_mktag(1), ml_backend__ml_switch_gen__Tag_8, (MR_Integer) 0)));
          MR_Word ml_backend__ml_switch_gen__Var_55;

          {
            ml_backend__ml_switch_gen__Var_55 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(3), ml_backend__ml_switch_gen__Var_55, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 9));
            MR_hl_field(MR_mktag(3), ml_backend__ml_switch_gen__Var_55, 1) = ((MR_Box) (ml_backend__ml_switch_gen__String_20));
          }
          {
            ...
            MR_hl_field(MR_mktag(3), ml_backend__ml_switch_gen__Rval_11, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 1));
            MR_hl_field(MR_mktag(3), ml_backend__ml_switch_gen__Rval_11, 1) = ((MR_Box) (ml_backend__ml_switch_gen__Var_55));
          }
        }
        break;
      case (MR_Integer) 2:
      ...
      case (MR_Integer) 3:
        switch (((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), ml_backend__ml_switch_gen__Tag_8, (MR_Integer) 0)))) {
          ...
          case (MR_Integer) 0:
            {
              ...
              MR_Integer ml_backend__ml_switch_gen__Var_10;
              ...
              if (ml_backend__ml_switch_gen__succeeded)
                {
                  ml_backend__ml_switch_gen__Var_10 = ((MR_Integer) (MR_hl_field(MR_mktag(3), ml_backend__ml_switch_gen__ConsId_7, (MR_Integer) 1)));
                  {
                    MR_Word ml_backend__ml_switch_gen__Var_63;

                    {
                      ml_backend__ml_switch_gen__Var_63 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
                      MR_hl_field(MR_mktag(1), ml_backend__ml_switch_gen__Var_63, 0) = ((MR_Box) (ml_backend__ml_switch_gen__Int_9));
                    }
                    {
                      ml_backend__ml_switch_gen__Rval_11 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                      MR_hl_field(MR_mktag(3), ml_backend__ml_switch_gen__Rval_11, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 1));
                      MR_hl_field(MR_mktag(3), ml_backend__ml_switch_gen__Rval_11, 1) = ((MR_Box) (ml_backend__ml_switch_gen__Var_63));
                    }
                  }
                }
              else
                {
                  MR_Char ml_backend__ml_switch_gen__Var_12;

                  ml_backend__ml_switch_gen__succeeded = ((((MR_tag((MR_Word) ml_backend__ml_switch_gen__ConsId_7)) == (MR_mktag((MR_Integer) 3)))) && (((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), ml_backend__ml_switch_gen__ConsId_7, (MR_Integer) 0)))) == (MR_Integer) 14)));
                  if (ml_backend__ml_switch_gen__succeeded)
                    {
                      ml_backend__ml_switch_gen__Var_12 = ((MR_Char) (MR_Word) (MR_hl_field(MR_mktag(3), ml_backend__ml_switch_gen__ConsId_7, (MR_Integer) 1)));
                      {
                        MR_Word ml_backend__ml_switch_gen__Var_64;

                        {
                          ml_backend__ml_switch_gen__Var_64 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                          MR_hl_field(MR_mktag(3), ml_backend__ml_switch_gen__Var_64, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 7));
                          MR_hl_field(MR_mktag(3), ml_backend__ml_switch_gen__Var_64, 1) = ((MR_Box) (ml_backend__ml_switch_gen__Int_9));
                        }
                        {
                          ml_backend__ml_switch_gen__Rval_11 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                          MR_hl_field(MR_mktag(3), ml_backend__ml_switch_gen__Rval_11, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 1));
                          MR_hl_field(MR_mktag(3), ml_backend__ml_switch_gen__Rval_11, 1) = ((MR_Box) (ml_backend__ml_switch_gen__Var_64));
                        }
                      }
                    }
                  else
                    {
                      ...
                      {
                        ml_backend__ml_switch_gen__Var_65 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL));
                        MR_hl_field(MR_mktag(3), ml_backend__ml_switch_gen__Var_65, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 6));
                        MR_hl_field(MR_mktag(3), ml_backend__ml_switch_gen__Var_65, 1) = ((MR_Box) (ml_backend__ml_switch_gen__Int_9));
                        MR_hl_field(MR_mktag(3), ml_backend__ml_switch_gen__Var_65, 2) = ((MR_Box) (ml_backend__ml_switch_gen__MLDS_Type_4));
                      }
                      {
                        ml_backend__ml_switch_gen__Rval_11 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                        MR_hl_field(MR_mktag(3), ml_backend__ml_switch_gen__Rval_11, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 1));
                        MR_hl_field(MR_mktag(3), ml_backend__ml_switch_gen__Rval_11, 1) = ((MR_Box) (ml_backend__ml_switch_gen__Var_65));
                      }
                    }
                }
            }
          ...
          case (MR_Integer) 1:
            {
              MR_Unsigned ml_backend__ml_switch_gen__UInt_13 = ((MR_Unsigned) (MR_hl_field(MR_mktag(3), ml_backend__ml_switch_gen__Tag_8, (MR_Integer) 1)));
              MR_Word ml_backend__ml_switch_gen__Var_62;

              {
                ml_backend__ml_switch_gen__Var_62 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(2), ml_backend__ml_switch_gen__Var_62, 0) = ((MR_Box) (ml_backend__ml_switch_gen__UInt_13));
              }
              {
                ml_backend__ml_switch_gen__Rval_11 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), ml_backend__ml_switch_gen__Rval_11, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 1));
                MR_hl_field(MR_mktag(3), ml_backend__ml_switch_gen__Rval_11, 1) = ((MR_Box) (ml_backend__ml_switch_gen__Var_62));
              }
            }
            break;
          case (MR_Integer) 2:
            {
              MR_Integer ml_backend__ml_switch_gen__Int8_14 = ((MR_Integer) (MR_hl_field(MR_mktag(3), ml_backend__ml_switch_gen__Tag_8, (MR_Integer) 1)));
              MR_Word ml_backend__ml_switch_gen__Var_61;

              {
                ml_backend__ml_switch_gen__Var_61 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), ml_backend__ml_switch_gen__Var_61, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 0));
                MR_hl_field(MR_mktag(3), ml_backend__ml_switch_gen__Var_61, 1) = ((MR_Box) (ml_backend__ml_switch_gen__Int8_14));
              }
              {
                ml_backend__ml_switch_gen__Rval_11 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), ml_backend__ml_switch_gen__Rval_11, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 1));
                MR_hl_field(MR_mktag(3), ml_backend__ml_switch_gen__Rval_11, 1) = ((MR_Box) (ml_backend__ml_switch_gen__Var_61));
              }
            }
            break;
          case (MR_Integer) 3:
            {
              MR_Integer ml_backend__ml_switch_gen__UInt8_15 = ((MR_Integer) (MR_hl_field(MR_mktag(3), ml_backend__ml_switch_gen__Tag_8, (MR_Integer) 1)));
              MR_Word ml_backend__ml_switch_gen__Var_60;

              {
                ml_backend__ml_switch_gen__Var_60 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), ml_backend__ml_switch_gen__Var_60, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 1));
                MR_hl_field(MR_mktag(3), ml_backend__ml_switch_gen__Var_60, 1) = ((MR_Box) (ml_backend__ml_switch_gen__UInt8_15));
              }
              {
                ml_backend__ml_switch_gen__Rval_11 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), ml_backend__ml_switch_gen__Rval_11, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 1));
                MR_hl_field(MR_mktag(3), ml_backend__ml_switch_gen__Rval_11, 1) = ((MR_Box) (ml_backend__ml_switch_gen__Var_60));
              }
            }
            break;
          case (MR_Integer) 4:
            {
              MR_Integer ml_backend__ml_switch_gen__Int16_16 = ((MR_Integer) (MR_hl_field(MR_mktag(3), ml_backend__ml_switch_gen__Tag_8, (MR_Integer) 1)));
              MR_Word ml_backend__ml_switch_gen__Var_59;

              {
                ml_backend__ml_switch_gen__Var_59 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), ml_backend__ml_switch_gen__Var_59, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 2));
                MR_hl_field(MR_mktag(3), ml_backend__ml_switch_gen__Var_59, 1) = ((MR_Box) (ml_backend__ml_switch_gen__Int16_16));
              }
              {
                ml_backend__ml_switch_gen__Rval_11 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), ml_backend__ml_switch_gen__Rval_11, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 1));
                MR_hl_field(MR_mktag(3), ml_backend__ml_switch_gen__Rval_11, 1) = ((MR_Box) (ml_backend__ml_switch_gen__Var_59));
              }
            }
            break;
          case (MR_Integer) 5:
            {
              MR_Integer ml_backend__ml_switch_gen__UInt16_17 = ((MR_Integer) (MR_hl_field(MR_mktag(3), ml_backend__ml_switch_gen__Tag_8, (MR_Integer) 1)));
              MR_Word ml_backend__ml_switch_gen__Var_58;

              {
                ml_backend__ml_switch_gen__Var_58 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), ml_backend__ml_switch_gen__Var_58, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 3));
                MR_hl_field(MR_mktag(3), ml_backend__ml_switch_gen__Var_58, 1) = ((MR_Box) (ml_backend__ml_switch_gen__UInt16_17));
              }
              {
                ml_backend__ml_switch_gen__Rval_11 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), ml_backend__ml_switch_gen__Rval_11, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 1));
                MR_hl_field(MR_mktag(3), ml_backend__ml_switch_gen__Rval_11, 1) = ((MR_Box) (ml_backend__ml_switch_gen__Var_58));
              }
            }
            break;
          case (MR_Integer) 6:
            {
              MR_Integer ml_backend__ml_switch_gen__Int32_18 = ((MR_Integer) (MR_hl_field(MR_mktag(3), ml_backend__ml_switch_gen__Tag_8, (MR_Integer) 1)));
              MR_Word ml_backend__ml_switch_gen__Var_57;

              {
                ml_backend__ml_switch_gen__Var_57 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), ml_backend__ml_switch_gen__Var_57, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 4));
                MR_hl_field(MR_mktag(3), ml_backend__ml_switch_gen__Var_57, 1) = ((MR_Box) (ml_backend__ml_switch_gen__Int32_18));
              }
              {
                ml_backend__ml_switch_gen__Rval_11 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), ml_backend__ml_switch_gen__Rval_11, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 1));
                MR_hl_field(MR_mktag(3), ml_backend__ml_switch_gen__Rval_11, 1) = ((MR_Box) (ml_backend__ml_switch_gen__Var_57));
              }
            }
            break;
          case (MR_Integer) 7:
            {
              MR_Integer ml_backend__ml_switch_gen__UInt32_19 = ((MR_Integer) (MR_hl_field(MR_mktag(3), ml_backend__ml_switch_gen__Tag_8, (MR_Integer) 1)));
              MR_Word ml_backend__ml_switch_gen__Var_56;

              {
                ml_backend__ml_switch_gen__Var_56 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), ml_backend__ml_switch_gen__Var_56, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 5));
                MR_hl_field(MR_mktag(3), ml_backend__ml_switch_gen__Var_56, 1) = ((MR_Box) (ml_backend__ml_switch_gen__UInt32_19));
              }
              {
                ml_backend__ml_switch_gen__Rval_11 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), ml_backend__ml_switch_gen__Rval_11, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 1));
                MR_hl_field(MR_mktag(3), ml_backend__ml_switch_gen__Rval_11, 1) = ((MR_Box) (ml_backend__ml_switch_gen__Var_56));
              }
            }
            break;
          case (MR_Integer) 8:
            {
              MR_Word ml_backend__ml_switch_gen__ForeignLang_21 = ((MR_Word) (MR_hl_field(MR_mktag(3), ml_backend__ml_switch_gen__Tag_8, (MR_Integer) 1)));
              MR_String ml_backend__ml_switch_gen__ForeignTag_22 = ((MR_String) (MR_hl_field(MR_mktag(3), ml_backend__ml_switch_gen__Tag_8, (MR_Integer) 2)));
              MR_Word ml_backend__ml_switch_gen__Var_54;

              {
                ml_backend__ml_switch_gen__Var_54 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), ml_backend__ml_switch_gen__Var_54, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 11));
                MR_hl_field(MR_mktag(3), ml_backend__ml_switch_gen__Var_54, 1) = ((MR_Box) (ml_backend__ml_switch_gen__ForeignLang_21));
                MR_hl_field(MR_mktag(3), ml_backend__ml_switch_gen__Var_54, 2) = ((MR_Box) (ml_backend__ml_switch_gen__ForeignTag_22));
                MR_hl_field(MR_mktag(3), ml_backend__ml_switch_gen__Var_54, 3) = ((MR_Box) (ml_backend__ml_switch_gen__MLDS_Type_4));
              }
              {
                ml_backend__ml_switch_gen__Rval_11 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), ml_backend__ml_switch_gen__Rval_11, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 1));
                MR_hl_field(MR_mktag(3), ml_backend__ml_switch_gen__Rval_11, 1) = ((MR_Box) (ml_backend__ml_switch_gen__Var_54));
              }
            }
            break;
          case (MR_Integer) 9:
...
{
  {
    ...
    if ((ml_backend__ml_switch_gen__TaggedCases_11 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
        ...
        case (MR_Integer) 0:
          {
            ...
            MR_Word ml_backend__ml_switch_gen__STATE_VARIABLE_Info_38_38;
            MR_Word ml_backend__ml_switch_gen__STATE_VARIABLE_Info_39_39;
            MR_Word ml_backend__ml_switch_gen__Var_42;
            MR_Word ml_backend__ml_switch_gen__MainTagTestRval_56;
            MR_Word ml_backend__ml_switch_gen__OtherTagTestRval_57;
            MR_Word ml_backend__ml_switch_gen__STATE_VARIABLE_Info_18_58;
            MR_Word ml_backend__ml_switch_gen__Var_59;
            MR_Box ml_backend__ml_switch_gen__conv2_STATE_VARIABLE_Info_38_38;

            {
              ml_backend__ml_unify_gen__ml_gen_known_tag_test_5_p_0(ml_backend__ml_switch_gen__Var_12, ml_backend__ml_switch_gen__Var_18, &ml_backend__ml_switch_gen__MainTagTestRval_56, ml_backend__ml_switch_gen__STATE_VARIABLE_Info_0_30, &ml_backend__ml_switch_gen__STATE_VARIABLE_Info_18_58);
            }
            {
              ml_backend__ml_switch_gen__Var_59 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL);
              MR_hl_field(MR_mktag(0), ml_backend__ml_switch_gen__Var_59, 0) = ((MR_Box) (&ml_backend__ml_switch_gen_scalar_common_2[0]));
              MR_hl_field(MR_mktag(0), ml_backend__ml_switch_gen__Var_59, 1) = ((MR_Box) (ml_backend__ml_switch_gen__ml_switch_generate_if_then_else_chain_ites_9_p_0_1));
              MR_hl_field(MR_mktag(0), ml_backend__ml_switch_gen__Var_59, 2) = ((MR_Box) (MR_Word) ((MR_Integer) 1));
              MR_hl_field(MR_mktag(0), ml_backend__ml_switch_gen__Var_59, 3) = ((MR_Box) (ml_backend__ml_switch_gen__Var_12));
            }
            {
              mercury__list__map_foldl_5_p_0((MR_Word) &hlds__hlds_data__hlds__hlds_data__type_ctor_info_tagged_cons_id_0, (MR_Word) &ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_rval_0, (MR_Word) &ml_backend__ml_gen_info__ml_backend__ml_gen_info__type_ctor_info_ml_gen_info_0, ml_backend__ml_switch_gen__Var_59, ml_backend__ml_switch_gen__Var_19, &ml_backend__ml_switch_gen__OtherTagTestRval_57, ((MR_Box) (ml_backend__ml_switch_gen__STATE_VARIABLE_Info_18_58)), &ml_backend__ml_switch_gen__conv2_STATE_VARIABLE_Info_38_38);
            }
            ml_backend__ml_switch_gen__STATE_VARIABLE_Info_38_38 = ((MR_Word) ml_backend__ml_switch_gen__conv2_STATE_VARIABLE_Info_38_38);
            {
              ml_backend__ml_switch_gen__chain_ors_3_p_0(ml_backend__ml_switch_gen__MainTagTestRval_56, ml_backend__ml_switch_gen__OtherTagTestRval_57, &ml_backend__ml_switch_gen__Cond_22);
            }
            {
              ml_backend__ml_code_gen__ml_gen_goal_as_branch_block_5_p_0(ml_backend__ml_switch_gen__CodeModel_13, ml_backend__ml_switch_gen__Goal_21, &ml_backend__ml_switch_gen__GoalBlock_23, ml_backend__ml_switch_gen__STATE_VARIABLE_Info_38_38, &ml_backend__ml_switch_gen__STATE_VARIABLE_Info_39_39);
            }
            {
              ml_backend__ml_code_util__ml_gen_failure_5_p_0(ml_backend__ml_switch_gen__CodeModel_13, ml_backend__ml_switch_gen__Context_15, &ml_backend__ml_switch_gen__FailStmts_24, ml_backend__ml_switch_gen__STATE_VARIABLE_Info_39_39, ml_backend__ml_switch_gen__STATE_VARIABLE_Info_31);
            }
            {
              ml_backend__ml_switch_gen__FailBlock_25 = ml_backend__ml_code_util__ml_gen_block_3_f_0((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), ml_backend__ml_switch_gen__FailStmts_24, ml_backend__ml_switch_gen__Context_15);
            }
            {
              ml_backend__ml_switch_gen__Var_42 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), ml_backend__ml_switch_gen__Var_42, 0) = ((MR_Box) (ml_backend__ml_switch_gen__FailBlock_25));
            }
            {
              ...
              MR_hl_field(MR_mktag(2), ml_backend__ml_switch_gen__Stmt_16, 2) = ((MR_Box) (ml_backend__ml_switch_gen__Var_42));
    ...
    else
      {
        ...
        MR_Word ml_backend__ml_switch_gen__Var_37;
        MR_Word ml_backend__ml_switch_gen__Cond_44;
        MR_Word ml_backend__ml_switch_gen__GoalBlock_45;
        MR_Word ml_backend__ml_switch_gen__MainTagTestRval_78;
        MR_Word ml_backend__ml_switch_gen__OtherTagTestRval_79;
        MR_Word ml_backend__ml_switch_gen__STATE_VARIABLE_Info_18_80;
        MR_Word ml_backend__ml_switch_gen__Var_81;
        MR_Box ml_backend__ml_switch_gen__conv5_STATE_VARIABLE_Info_33_33;

        {
          ml_backend__ml_unify_gen__ml_gen_known_tag_test_5_p_0(ml_backend__ml_switch_gen__Var_12, ml_backend__ml_switch_gen__Var_18, &ml_backend__ml_switch_gen__MainTagTestRval_78, ml_backend__ml_switch_gen__STATE_VARIABLE_Info_0_30, &ml_backend__ml_switch_gen__STATE_VARIABLE_Info_18_80);
        }
        {
          ml_backend__ml_switch_gen__Var_81 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), ml_backend__ml_switch_gen__Var_81, 0) = ((MR_Box) (&ml_backend__ml_switch_gen_scalar_common_2[0]));
          MR_hl_field(MR_mktag(0), ml_backend__ml_switch_gen__Var_81, 1) = ((MR_Box) (ml_backend__ml_switch_gen__ml_switch_generate_if_then_else_chain_ites_9_p_0_2));
          MR_hl_field(MR_mktag(0), ml_backend__ml_switch_gen__Var_81, 2) = ((MR_Box) (MR_Word) ((MR_Integer) 1));
          MR_hl_field(MR_mktag(0), ml_backend__ml_switch_gen__Var_81, 3) = ((MR_Box) (ml_backend__ml_switch_gen__Var_12));
        }
        {
          mercury__list__map_foldl_5_p_0((MR_Word) &hlds__hlds_data__hlds__hlds_data__type_ctor_info_tagged_cons_id_0, (MR_Word) &ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_rval_0, (MR_Word) &ml_backend__ml_gen_info__ml_backend__ml_gen_info__type_ctor_info_ml_gen_info_0, ml_backend__ml_switch_gen__Var_81, ml_backend__ml_switch_gen__Var_19, &ml_backend__ml_switch_gen__OtherTagTestRval_79, ((MR_Box) (ml_backend__ml_switch_gen__STATE_VARIABLE_Info_18_80)), &ml_backend__ml_switch_gen__conv5_STATE_VARIABLE_Info_33_33);
        }
        ml_backend__ml_switch_gen__STATE_VARIABLE_Info_33_33 = ((MR_Word) ml_backend__ml_switch_gen__conv5_STATE_VARIABLE_Info_33_33);
        {
          ml_backend__ml_switch_gen__chain_ors_3_p_0(ml_backend__ml_switch_gen__MainTagTestRval_78, ml_backend__ml_switch_gen__OtherTagTestRval_79, &ml_backend__ml_switch_gen__Cond_44);
        }
        {
          ml_backend__ml_code_gen__ml_gen_goal_as_branch_block_5_p_0(ml_backend__ml_switch_gen__CodeModel_13, ml_backend__ml_switch_gen__Goal_21, &ml_backend__ml_switch_gen__GoalBlock_45, ml_backend__ml_switch_gen__STATE_VARIABLE_Info_33_33, &ml_backend__ml_switch_gen__STATE_VARIABLE_Info_34_34);
        }
        {
        ...
        {
          ml_backend__ml_switch_gen__LaterBlock_29 = ml_backend__ml_code_util__ml_gen_block_3_f_0((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), ml_backend__ml_switch_gen__LaterStmts_28, ml_backend__ml_switch_gen__Context_15);
        }
        {
          ml_backend__ml_switch_gen__Var_37 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), ml_backend__ml_switch_gen__Var_37, 0) = ((MR_Box) (ml_backend__ml_switch_gen__LaterBlock_29));
        }
        {
          ml_backend__ml_switch_gen__Stmt_16 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(2), ml_backend__ml_switch_gen__Stmt_16, 0) = ((MR_Box) (ml_backend__ml_switch_gen__Cond_44));
          MR_hl_field(MR_mktag(2), ml_backend__ml_switch_gen__Stmt_16, 1) = ((MR_Box) (ml_backend__ml_switch_gen__GoalBlock_45));
          MR_hl_field(MR_mktag(2), ml_backend__ml_switch_gen__Stmt_16, 2) = ((MR_Box) (ml_backend__ml_switch_gen__Var_37));
          MR_hl_field(MR_mktag(2), ml_backend__ml_switch_gen__Stmt_16, 3) = ((MR_Box) (ml_backend__ml_switch_gen__Context_15));
        }
      }
    {
          ...
          if (ml_backend__ml_switch_gen__succeeded)
            *ml_backend__ml_switch_gen__Default_10 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 1));
          else
            {
              ...
              {
                ml_backend__ml_switch_gen__Fail_13 = ml_backend__ml_code_util__ml_gen_block_3_f_0((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), ml_backend__ml_switch_gen__FailStmts_12, ml_backend__ml_switch_gen__Context_9);
              }
              {
                MR_Word base;
