    ...
    if (ml_backend__ml_switch_gen__succeeded)
    ...
    else
      {
        ...
        if (ml_backend__ml_switch_gen__succeeded)
          {
            {
              ml_backend__ml_switch_gen__succeeded = libs__globals__lookup_bool_option_3_p_1(ml_backend__ml_switch_gen__Globals_25, (MR_Integer) 325, (MR_Integer) 1);
            }
            if (!(ml_backend__ml_switch_gen__succeeded))
              {
        ...
        else
          {
            ...
            if (ml_backend__ml_switch_gen__succeeded)
            ...
            else
              {
                ...
                {
                  libs__globals__lookup_int_option_3_p_0(ml_backend__ml_switch_gen__Globals_25, (MR_Integer) 443, &ml_backend__ml_switch_gen__StringTrieSwitchSize_29);
                }
                ...
                if (ml_backend__ml_switch_gen__succeeded)
                ...
                else
                  {
                    ...
                    {
                      libs__globals__lookup_int_option_3_p_0(ml_backend__ml_switch_gen__Globals_25, (MR_Integer) 444, &ml_backend__ml_switch_gen__StringHashSwitchSize_31);
                    }
                    ...
                    if (ml_backend__ml_switch_gen__succeeded)
                    ...
                    else
                      {
                        ...
                        {
                          libs__globals__lookup_int_option_3_p_0(ml_backend__ml_switch_gen__Globals_25, (MR_Integer) 445, &ml_backend__ml_switch_gen__StringBinarySwitchSize_32);
                        }
        ...
        if (ml_backend__ml_switch_gen__succeeded)
          {
            ...
            ml_backend__ml_switch_gen__Var_45 = (MR_Integer) 455;
                ...
                if (ml_backend__ml_switch_gen__succeeded)
                  {
                    ...
                    if (ml_backend__ml_switch_gen__succeeded)
                      {
                        ml_backend__ml_switch_gen__Var_49 = (MR_Integer) 440;
                        {
            ...
            case (MR_Integer) 2:
              {
                ...
                {
                  libs__globals__lookup_int_option_3_p_0(ml_backend__ml_switch_gen__Globals_26, (MR_Integer) 446, &ml_backend__ml_switch_gen__TagSize_29);
                }
