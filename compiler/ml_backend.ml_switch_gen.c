    ...
    case (MR_Integer) 1:
      {
        ...
        MR_Word STATE_VARIABLE_Info_34_47;
        MR_Word STATE_VARIABLE_Info_35_48;
        MR_Integer MinRange_59;
        MR_Integer MaxRange_60;
        MR_Word ModuleInfo_56;
        MR_Word Type_57;
        MR_Word TypeCategory_58;
        MR_Integer _NumValuesInRange_61;

        ml_backend__ml_gen_info__ml_gen_info_get_var_table_2_p_0(STATE_VARIABLE_Info_0_21, &VarTable_33);
        parse_tree__var_table__lookup_var_entry_3_p_0(VarTable_33, SwitchVar_10, &VarEntry_34);
        Type_35 = ((MR_Word) ((MR_hl_field(MR_mktag(0), VarEntry_34, (MR_Integer) 1))));
        ml_backend__ml_code_util__ml_gen_mlds_type_3_p_0(STATE_VARIABLE_Info_0_21, Type_35, &MLDS_Type_36);
        ml_backend__ml_code_util__ml_gen_var_4_p_0(STATE_VARIABLE_Info_0_21, SwitchVar_10, VarEntry_34, &Lval_37);
        {
        ...
        ml_backend__ml_gen_info__ml_gen_info_get_module_info_2_p_0(STATE_VARIABLE_Info_0_21, &ModuleInfo_56);
        ...
        if (succeeded)
        {
          Type_57 = ((MR_Word) ((MR_hl_field(MR_mktag(3), MLDS_Type_36, (MR_Integer) 1))));
          TypeCategory_58 = ((MR_Word) ((MR_hl_field(MR_mktag(3), MLDS_Type_36, (MR_Integer) 2))));
          succeeded = backend_libs__switch_util__type_range_6_p_0(ModuleInfo_56, TypeCategory_58, Type_57, &MinRange_59, &MaxRange_60, &_NumValuesInRange_61);
        }
        if (succeeded)
          {
            Range_39 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), Range_39, 0) = ((MR_Box) (MinRange_59));
            MR_hl_field(MR_mktag(1), Range_39, 1) = ((MR_Box) (MaxRange_60));
          }
        else
          Range_39 = (MR_Word) ((MR_Unsigned) 0U);
        ml_backend__ml_switch_gen__ml_switch_generate_mlds_cases_10_p_0(Type_35, MLDS_Type_36, CodeModel_13, EntryPackedWordMap_14, TaggedCases_12, &MLDS_Cases_40, (MR_Word) ((MR_Unsigned) 0U), &ReachableConstVarMaps_41, STATE_VARIABLE_Info_0_21, &STATE_VARIABLE_Info_33_46);
        ml_backend__ml_code_gen__ml_gen_record_consensus_const_var_map_3_p_0(ReachableConstVarMaps_41, STATE_VARIABLE_Info_33_46, &STATE_VARIABLE_Info_34_47);
        ml_backend__ml_switch_gen__ml_switch_generate_default_6_p_0(CanFail_11, CodeModel_13, Context_15, &Default_42, STATE_VARIABLE_Info_34_47, &STATE_VARIABLE_Info_35_48);
        {
        ...
        ml_backend__ml_simplify_switch__ml_simplify_switch_4_p_0(SwitchStmt0_43, &SwitchStmt_44, STATE_VARIABLE_Info_35_48, STATE_VARIABLE_Info_22);
        {
          MR_Word base;
  ...
  MR_Word * STATE_VARIABLE_Info_31)
{
  ...
  MR_Integer MinRange_46;
  MR_Integer MaxRange_47;
  MR_Word ModuleInfo_43;
  MR_Word Type_44;
  MR_Word TypeCategory_45;
  MR_Integer _NumValuesInRange_48;
  ...
  ml_backend__ml_gen_info__ml_gen_info_get_module_info_2_p_0(STATE_VARIABLE_Info_0_30, &ModuleInfo_43);
  ...
  if (succeeded)
  {
    Type_44 = ((MR_Word) ((MR_hl_field(MR_mktag(3), MLDS_Type_21, (MR_Integer) 1))));
    TypeCategory_45 = ((MR_Word) ((MR_hl_field(MR_mktag(3), MLDS_Type_21, (MR_Integer) 2))));
    succeeded = backend_libs__switch_util__type_range_6_p_0(ModuleInfo_43, TypeCategory_45, Type_44, &MinRange_46, &MaxRange_47, &_NumValuesInRange_48);
  }
  if (succeeded)
    {
      Range_24 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), Range_24, 0) = ((MR_Box) (MinRange_46));
      MR_hl_field(MR_mktag(1), Range_24, 1) = ((MR_Box) (MaxRange_47));
    }
  else
  ...
  MR_Word * STATE_VARIABLE_Info_10)
{
  ...
  else
  {
    ...
    MR_Word TaggedMainConsId_49;
    MR_Word TaggedOtherConsIds_50;
    MR_Word Goal_52;
    MR_Word MainCond_53;
    MR_Word OtherConds_54;
    MR_Word Stmt_55;
    MR_Word STATE_VARIABLE_Info_30_56;
    MR_Word Var_57;

    ml_backend__ml_gen_info__ml_gen_info_set_packed_word_map_3_p_0(EntryPackedWordMap_4, STATE_VARIABLE_Info_0_9, &STATE_VARIABLE_Info_30_56);
    TaggedMainConsId_49 = ((MR_Word) ((MR_hl_field(MR_mktag(0), TaggedCase_25, (MR_Integer) 0))));
    TaggedOtherConsIds_50 = ((MR_Word) ((MR_hl_field(MR_mktag(0), TaggedCase_25, (MR_Integer) 1))));
    Goal_52 = ((MR_Word) ((MR_hl_field(MR_mktag(0), TaggedCase_25, (MR_Integer) 3))));
    ml_backend__ml_switch_gen__ml_tagged_cons_id_to_match_cond_4_p_0(MerType_1, MLDS_Type_2, TaggedMainConsId_49, &MainCond_53);
    {
      Var_57 = (MR_Word) MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), Var_57, 0) = ((MR_Box) (&ml_backend__ml_switch_gen_scalar_common_3[0]));
      MR_hl_field(MR_mktag(0), Var_57, 1) = ((MR_Box) (ml_backend__ml_switch_gen__ml_switch_generate_mlds_cases_10_p_0_1));
      MR_hl_field(MR_mktag(0), Var_57, 2) = ((MR_Box) ((MR_Integer) 2));
      MR_hl_field(MR_mktag(0), Var_57, 3) = ((MR_Box) (MerType_1));
      MR_hl_field(MR_mktag(0), Var_57, 4) = ((MR_Box) (MLDS_Type_2));
    }
    mercury__list__map_3_p_0((MR_Word) (&hlds__hlds_data__hlds__hlds_data__type_ctor_info_tagged_cons_id_0), (MR_Word) (&ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_case_match_cond_0), Var_57, TaggedOtherConsIds_50, &OtherConds_54);
    ml_backend__ml_code_gen__ml_gen_goal_as_branch_block_7_p_0(CodeModel_3, Goal_52, &Stmt_55, STATE_VARIABLE_ReachableConstVarMaps_0_7, &STATE_VARIABLE_ReachableConstVarMaps_35_35, STATE_VARIABLE_Info_30_56, &STATE_VARIABLE_Info_36_36);
    {
      MLDS_Case_27 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), MLDS_Case_27, 0) = ((MR_Box) (MainCond_53));
      MR_hl_field(MR_mktag(0), MLDS_Case_27, 1) = ((MR_Box) (OtherConds_54));
      MR_hl_field(MR_mktag(0), MLDS_Case_27, 2) = ((MR_Box) (Stmt_55));
    }
