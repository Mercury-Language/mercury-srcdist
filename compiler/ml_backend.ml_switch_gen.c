...
MR_decl_label8(ml_backend__ml_switch_gen__ml_gen_switch_9_0, 2,4,5,6,7,8,9,10)
MR_decl_label8(ml_backend__ml_switch_gen__ml_gen_switch_9_0, 11,13,14,15,16,17,19,98)
MR_decl_label8(ml_backend__ml_switch_gen__ml_gen_switch_9_0, 12,27,28,32,31,34,29,36)
MR_decl_label8(ml_backend__ml_switch_gen__ml_gen_switch_9_0, 39,41,38,24,48,49,50,45)
MR_decl_label5(ml_backend__ml_switch_gen__ml_gen_switch_9_0, 61,60,64,58,67)
MR_decl_label5(ml_backend__ml_switch_gen__ml_switch_generate_default_6_0, 4,6,5,8,3)
MR_decl_label8(ml_backend__ml_switch_gen__ml_switch_generate_if_then_else_chain_9_0, 6,5,47,9,10,14,15,16)
MR_decl_label3(ml_backend__ml_switch_gen__ml_switch_generate_if_then_else_chain_9_0, 17,20,23)
MR_decl_label8(ml_backend__ml_switch_gen__ml_switch_generate_mlds_cases_5_0, 37,5,7,15,22,9,12,6)
MR_decl_label2(ml_backend__ml_switch_gen__ml_switch_generate_mlds_cases_5_0, 23,27)
...
MR_decl_label6(ml_backend__ml_switch_gen__ml_switch_lookup_tags_4_0, 21,5,6,7,8,12)
...
MR_decl_static(ml_backend__ml_switch_gen__IntroducedFrom__pred__ml_switch_lookup_tags__344__1_2_0)
MR_decl_static(ml_backend__ml_switch_gen__IntroducedFrom__pred__ml_switch_generate_if_then_else_chain__375__1_2_0)
MR_decl_static(ml_backend__ml_switch_gen__IntroducedFrom__pred__ml_switch_generate_mlds_case__455__1_2_0)
...
mercury_data__closure_layout__ml_backend__ml_switch_gen__ml_switch_lookup_tags_4_0_1;
static const MR_UserClosureId
...
{
{
(MR_Word *) &mercury_data__closure_layout__ml_backend__ml_switch_gen__ml_switch_lookup_tags_4_0_1,
...
MR_BEGIN_MODULE(ml_backend__ml_switch_gen_module4)
	...
	MR_init_label6(ml_backend__ml_switch_gen__ml_switch_lookup_tags_4_0,21,5,6,7,8,12)
MR_BEGIN_CODE
...
MR_def_static(ml_backend__ml_switch_gen__ml_switch_lookup_tags_4_0)
	...
	if (MR_LTAGS_TESTR(MR_r2,0,0)) {
		MR_GOTO_LAB(ml_backend__ml_switch_gen__ml_switch_lookup_tags_4_0_i21);
	}
	MR_r1 = (MR_Word) MR_tbmkword(0, 0);
	MR_proceed();
MR_def_label(ml_backend__ml_switch_gen__ml_switch_lookup_tags_4_0,21)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(7);
	...
	MR_tfield(0, MR_tempr1, 1) = (MR_Word) MR_ENTRY_AP(ml_backend__ml_switch_gen__IntroducedFrom__pred__ml_switch_lookup_tags__344__1_2_0);
	...
	MR_r1 = MR_tempr1;
	MR_r2 = (MR_Word) MR_string_const("ml_switch_gen.m", 15);
	MR_r3 = (MR_Word) MR_string_const("ml_switch_lookup_tags: multi-cons-id switch arms NYI", 52);
	}
...
MR_def_label(ml_backend__ml_switch_gen__ml_switch_lookup_tags_4_0,7)
	...
	MR_np_call_localret_ent(fn__backend_libs__switch_util__estimate_switch_tag_test_cost_1_0,
		ml_backend__ml_switch_gen__ml_switch_lookup_tags_4_0_i8);
MR_def_label(ml_backend__ml_switch_gen__ml_switch_lookup_tags_4_0,8)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	...
	MR_np_localcall_lab(ml_backend__ml_switch_gen__ml_switch_lookup_tags_4_0,
		ml_backend__ml_switch_gen__ml_switch_lookup_tags_4_0_i12);
MR_def_label(ml_backend__ml_switch_gen__ml_switch_lookup_tags_4_0,12)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
...
MR_BEGIN_MODULE(ml_backend__ml_switch_gen_module5)
	...
	MR_init_label8(ml_backend__ml_switch_gen__ml_switch_generate_if_then_else_chain_9_0,6,5,47,9,10,14,15,16)
	MR_init_label3(ml_backend__ml_switch_gen__ml_switch_generate_if_then_else_chain_9_0,17,20,23)
MR_BEGIN_CODE
...
MR_def_static(ml_backend__ml_switch_gen__ml_switch_generate_if_then_else_chain_9_0)
	...
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
		MR_GOTO_LAB(ml_backend__ml_switch_gen__ml_switch_generate_if_then_else_chain_9_0_i47);
	}
	if (MR_INT_NE(MR_r4,0)) {
		MR_GOTO_LAB(ml_backend__ml_switch_gen__ml_switch_generate_if_then_else_chain_9_0_i5);
	}
	MR_incr_sp(9);
...
MR_def_label(ml_backend__ml_switch_gen__ml_switch_generate_if_then_else_chain_9_0,47)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(9);
	MR_sv(9) = (MR_Word) MR_succip;
	{
	...
	MR_tfield(0, MR_tempr1, 1) = (MR_Word) MR_ENTRY_AP(ml_backend__ml_switch_gen__IntroducedFrom__pred__ml_switch_generate_if_then_else_chain__375__1_2_0);
	MR_tfield(0, MR_tempr1, 2) = (MR_Integer) 2;
	MR_tempr3 = MR_r1;
	MR_tempr2 = MR_ctfield(1, MR_tempr3, 0);
	MR_tfield(0, MR_tempr1, 3) = MR_ctfield(0, MR_tempr2, 1);
	...
	MR_r1 = MR_tempr1;
	MR_r2 = (MR_Word) MR_string_const("ml_switch_gen.m", 15);
	MR_r3 = (MR_Word) MR_string_const("ml_switch_generate_if_then_else_chain: OtherTaggedConsIds != []", 63);
	}
	MR_np_call_localret_ent(libs__compiler_util__expect_3_0,
...
MR_def_label(ml_backend__ml_switch_gen__ml_switch_generate_if_then_else_chain_9_0,9)
	...
	if (MR_LTAGS_TESTR(MR_sv(6),0,0)) {
		MR_GOTO_LAB(ml_backend__ml_switch_gen__ml_switch_generate_if_then_else_chain_9_0_i10);
	}
...
MR_def_label(ml_backend__ml_switch_gen__ml_switch_generate_if_then_else_chain_9_0,10)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(1);
	MR_r2 = MR_r4;
	MR_r3 = MR_sv(5);
	MR_np_call_localret_ent(ml_backend__ml_unify_gen__ml_gen_tag_test_7_0,
		ml_backend__ml_switch_gen__ml_switch_generate_if_then_else_chain_9_0_i14);
MR_def_label(ml_backend__ml_switch_gen__ml_switch_generate_if_then_else_chain_9_0,14)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(5) = MR_r1;
	MR_sv(7) = MR_r2;
	{
	...
	MR_np_call_localret_ent(ml_backend__ml_code_gen__ml_gen_goal_as_block_5_0,
		ml_backend__ml_switch_gen__ml_switch_generate_if_then_else_chain_9_0_i15);
MR_def_label(ml_backend__ml_switch_gen__ml_switch_generate_if_then_else_chain_9_0,15)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tempr1 = MR_sv(2);
	...
	MR_np_localcall_lab(ml_backend__ml_switch_gen__ml_switch_generate_if_then_else_chain_9_0,
		ml_backend__ml_switch_gen__ml_switch_generate_if_then_else_chain_9_0_i16);
MR_def_label(ml_backend__ml_switch_gen__ml_switch_generate_if_then_else_chain_9_0,16)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(1) = MR_r3;
	MR_r3 = MR_sv(4);
	MR_np_call_localret_ent(fn__ml_backend__ml_code_util__ml_gen_block_3_0,
		ml_backend__ml_switch_gen__ml_switch_generate_if_then_else_chain_9_0_i17);
MR_def_label(ml_backend__ml_switch_gen__ml_switch_generate_if_then_else_chain_9_0,17)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
	...
	MR_np_call_localret_ent(fn__ml_backend__mlds__mlds_make_context_1_0,
		ml_backend__ml_switch_gen__ml_switch_generate_if_then_else_chain_9_0_i20);
MR_def_label(ml_backend__ml_switch_gen__ml_switch_generate_if_then_else_chain_9_0,20)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tag_alloc_heap(MR_tempr1, 0, (MR_Integer) 2);
	...
	MR_np_call_localret_ent(fn__f_108_105_115_116_95_95_43_43_2_0,
		ml_backend__ml_switch_gen__ml_switch_generate_if_then_else_chain_9_0_i23);
MR_def_label(ml_backend__ml_switch_gen__ml_switch_generate_if_then_else_chain_9_0,23)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
...
MR_BEGIN_MODULE(ml_backend__ml_switch_gen_module7)
	...
	MR_init_label8(ml_backend__ml_switch_gen__ml_switch_generate_mlds_cases_5_0,37,5,7,15,22,9,12,6)
	MR_init_label2(ml_backend__ml_switch_gen__ml_switch_generate_mlds_cases_5_0,23,27)
MR_BEGIN_CODE
...
MR_def_static(ml_backend__ml_switch_gen__ml_switch_generate_mlds_cases_5_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
		MR_GOTO_LAB(ml_backend__ml_switch_gen__ml_switch_generate_mlds_cases_5_0_i37);
	}
	MR_r1 = (MR_Word) MR_tbmkword(0, 0);
	MR_r2 = MR_r3;
	MR_proceed();
MR_def_label(ml_backend__ml_switch_gen__ml_switch_generate_mlds_cases_5_0,37)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(6);
	...
	MR_tfield(0, MR_tempr1, 1) = (MR_Word) MR_ENTRY_AP(ml_backend__ml_switch_gen__IntroducedFrom__pred__ml_switch_generate_mlds_case__455__1_2_0);
	MR_tfield(0, MR_tempr1, 2) = (MR_Integer) 2;
	MR_tempr3 = MR_r1;
	MR_tempr2 = MR_ctfield(1, MR_tempr3, 0);
	MR_tfield(0, MR_tempr1, 3) = MR_ctfield(0, MR_tempr2, 1);
	...
	MR_r1 = MR_tempr1;
	MR_r2 = (MR_Word) MR_string_const("ml_switch_gen.m", 15);
	MR_r3 = (MR_Word) MR_string_const("ml_switch_generate_mlds_case: OtherTaggedConsIds != []", 54);
	}
	MR_np_call_localret_ent(libs__compiler_util__expect_3_0,
		ml_backend__ml_switch_gen__ml_switch_generate_mlds_cases_5_0_i5);
MR_def_label(ml_backend__ml_switch_gen__ml_switch_generate_mlds_cases_5_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r3 = MR_ctfield(0, MR_sv(4), 1);
	MR_COMPUTED_GOTO((MR_Unsigned) MR_tag(MR_r3),
		MR_LABEL_AP(ml_backend__ml_switch_gen__ml_switch_generate_mlds_cases_5_0_i7) MR_AND
		MR_LABEL_AP(ml_backend__ml_switch_gen__ml_switch_generate_mlds_cases_5_0_i15) MR_AND
		MR_LABEL_AP(ml_backend__ml_switch_gen__ml_switch_generate_mlds_cases_5_0_i7) MR_AND
		MR_LABEL_AP(ml_backend__ml_switch_gen__ml_switch_generate_mlds_cases_5_0_i22));
...
MR_def_label(ml_backend__ml_switch_gen__ml_switch_generate_mlds_cases_5_0,15)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
...
MR_def_label(ml_backend__ml_switch_gen__ml_switch_generate_mlds_cases_5_0,22)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_COMPUTED_GOTO((MR_Unsigned) MR_ctfield(3, MR_r3, 0),
		MR_LABEL_AP(ml_backend__ml_switch_gen__ml_switch_generate_mlds_cases_5_0_i12) MR_AND
		MR_LABEL_AP(ml_backend__ml_switch_gen__ml_switch_generate_mlds_cases_5_0_i9) MR_AND
		MR_LABEL_AP(ml_backend__ml_switch_gen__ml_switch_generate_mlds_cases_5_0_i7) MR_AND
		MR_LABEL_AP(ml_backend__ml_switch_gen__ml_switch_generate_mlds_cases_5_0_i7) MR_AND
		MR_LABEL_AP(ml_backend__ml_switch_gen__ml_switch_generate_mlds_cases_5_0_i7) MR_AND
		MR_LABEL_AP(ml_backend__ml_switch_gen__ml_switch_generate_mlds_cases_5_0_i7) MR_AND
		...
		MR_LABEL_AP(ml_backend__ml_switch_gen__ml_switch_generate_mlds_cases_5_0_i7) MR_AND
		MR_LABEL_AP(ml_backend__ml_switch_gen__ml_switch_generate_mlds_cases_5_0_i7) MR_AND
		MR_LABEL_AP(ml_backend__ml_switch_gen__ml_switch_generate_mlds_cases_5_0_i7));
...
MR_def_label(ml_backend__ml_switch_gen__ml_switch_generate_mlds_cases_5_0,6)
	...
	MR_sv(1) = MR_r1;
	MR_np_call_localret_ent(ml_backend__ml_code_gen__ml_gen_goal_as_block_5_0,
		ml_backend__ml_switch_gen__ml_switch_generate_mlds_cases_5_0_i23);
MR_def_label(ml_backend__ml_switch_gen__ml_switch_generate_mlds_cases_5_0,23)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2, MR_tempr3;
	...
	MR_np_localcall_lab(ml_backend__ml_switch_gen__ml_switch_generate_mlds_cases_5_0,
		ml_backend__ml_switch_gen__ml_switch_generate_mlds_cases_5_0_i27);
MR_def_label(ml_backend__ml_switch_gen__ml_switch_generate_mlds_cases_5_0,27)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 2);
...
MR_BEGIN_MODULE(ml_backend__ml_switch_gen_module9)
	...
	MR_init_label8(ml_backend__ml_switch_gen__ml_gen_switch_9_0,2,4,5,6,7,8,9,10)
	MR_init_label8(ml_backend__ml_switch_gen__ml_gen_switch_9_0,11,13,14,15,16,17,19,98)
	MR_init_label8(ml_backend__ml_switch_gen__ml_gen_switch_9_0,12,27,28,32,31,34,29,36)
	MR_init_label8(ml_backend__ml_switch_gen__ml_gen_switch_9_0,39,41,38,24,48,49,50,45)
	MR_init_label5(ml_backend__ml_switch_gen__ml_gen_switch_9_0,61,60,64,58,67)
MR_BEGIN_CODE
...
MR_def_label(ml_backend__ml_switch_gen__ml_gen_switch_9_0,9)
	...
	MR_np_call_localret_ent(ml_backend__ml_code_util__ml_gen_info_get_globals_2_0,
		ml_backend__ml_switch_gen__ml_gen_switch_9_0_i10);
MR_def_label(ml_backend__ml_switch_gen__ml_gen_switch_9_0,10)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(7) = MR_r1;
	MR_r2 = (MR_Integer) 401;
	MR_np_call_localret_ent(libs__globals__lookup_bool_option_3_0,
		ml_backend__ml_switch_gen__ml_gen_switch_9_0_i11);
MR_def_label(ml_backend__ml_switch_gen__ml_gen_switch_9_0,11)
	...
	MR_r2 = MR_sv(1);
	MR_np_call_localret_ent(ml_backend__ml_code_util__ml_variable_type_3_0,
		ml_backend__ml_switch_gen__ml_gen_switch_9_0_i13);
...
MR_def_label(ml_backend__ml_switch_gen__ml_gen_switch_9_0,16)
	...
	MR_np_call_localret_ent(map__search_3_0,
		ml_backend__ml_switch_gen__ml_gen_switch_9_0_i17);
MR_def_label(ml_backend__ml_switch_gen__ml_gen_switch_9_0,17)
	...
	MR_np_call_localret_ent(hlds__hlds_data__get_type_defn_body_2_0,
		ml_backend__ml_switch_gen__ml_gen_switch_9_0_i19);
MR_def_label(ml_backend__ml_switch_gen__ml_gen_switch_9_0,19)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_def_label(ml_backend__ml_switch_gen__ml_gen_switch_9_0,98)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(5);
	MR_r2 = MR_sv(1);
	MR_r3 = MR_sv(3);
...
MR_def_label(ml_backend__ml_switch_gen__ml_gen_switch_9_0,12)
	...
	if (MR_INT_NE(MR_sv(8),1)) {
		MR_GOTO_LAB(ml_backend__ml_switch_gen__ml_gen_switch_9_0_i24);
	}
	...
	MR_np_call_localret_ent(list__length_2_0,
		ml_backend__ml_switch_gen__ml_gen_switch_9_0_i27);
...
MR_def_label(ml_backend__ml_switch_gen__ml_gen_switch_9_0,28)
	...
	MR_np_call_localret_ent(ml_backend__ml_switch_gen__target_supports_computed_goto_1_0,
		ml_backend__ml_switch_gen__ml_gen_switch_9_0_i32);
MR_def_label(ml_backend__ml_switch_gen__ml_gen_switch_9_0,32)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(ml_backend__ml_switch_gen__ml_gen_switch_9_0_i31);
	}
	MR_r1 = MR_sv(7);
	MR_GOTO_LAB(ml_backend__ml_switch_gen__ml_gen_switch_9_0_i29);
MR_def_label(ml_backend__ml_switch_gen__ml_gen_switch_9_0,31)
	...
	MR_np_call_localret_ent(ml_backend__ml_switch_gen__target_supports_int_switch_1_0,
		ml_backend__ml_switch_gen__ml_gen_switch_9_0_i34);
MR_def_label(ml_backend__ml_switch_gen__ml_gen_switch_9_0,34)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(ml_backend__ml_switch_gen__ml_gen_switch_9_0_i24);
	}
...
MR_def_label(ml_backend__ml_switch_gen__ml_gen_switch_9_0,36)
	...
	MR_np_call_localret_ent(ml_backend__ml_switch_gen__target_supports_string_switch_1_0,
		ml_backend__ml_switch_gen__ml_gen_switch_9_0_i39);
MR_def_label(ml_backend__ml_switch_gen__ml_gen_switch_9_0,39)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(ml_backend__ml_switch_gen__ml_gen_switch_9_0_i38);
	}
	MR_r1 = MR_sv(7);
...
MR_def_label(ml_backend__ml_switch_gen__ml_gen_switch_9_0,24)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_sv(8),1)) {
		MR_GOTO_LAB(ml_backend__ml_switch_gen__ml_gen_switch_9_0_i45);
	}
...
MR_def_label(ml_backend__ml_switch_gen__ml_gen_switch_9_0,48)
	...
	MR_np_call_localret_ent(libs__globals__lookup_int_option_3_0,
		ml_backend__ml_switch_gen__ml_gen_switch_9_0_i49);
MR_def_label(ml_backend__ml_switch_gen__ml_gen_switch_9_0,49)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (((MR_Integer) MR_sv(9) < (MR_Integer) MR_r1)) {
		MR_GOTO_LAB(ml_backend__ml_switch_gen__ml_gen_switch_9_0_i45);
	}
	MR_r1 = MR_sv(7);
	MR_np_call_localret_ent(ml_backend__ml_switch_gen__target_supports_int_switch_1_0,
		ml_backend__ml_switch_gen__ml_gen_switch_9_0_i50);
MR_def_label(ml_backend__ml_switch_gen__ml_gen_switch_9_0,50)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(ml_backend__ml_switch_gen__ml_gen_switch_9_0_i45);
	}
...
MR_def_label(ml_backend__ml_switch_gen__ml_gen_switch_9_0,45)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_sv(8),1)) {
		MR_GOTO_LAB(ml_backend__ml_switch_gen__ml_gen_switch_9_0_i98);
	}
...
MR_def_label(ml_backend__ml_switch_gen__ml_gen_switch_9_0,61)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(ml_backend__ml_switch_gen__ml_gen_switch_9_0_i58);
	}
	MR_r2 = MR_sv(1);
	MR_r4 = MR_sv(2);
	MR_r3 = MR_sv(3);
...
MR_def_label(ml_backend__ml_switch_gen__ml_gen_switch_9_0,58)
	...
	MR_r1 = MR_sv(7);
	MR_np_call_localret_ent(ml_backend__ml_switch_gen__target_supports_computed_goto_1_0,
		ml_backend__ml_switch_gen__ml_gen_switch_9_0_i67);
MR_def_label(ml_backend__ml_switch_gen__ml_gen_switch_9_0,67)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(ml_backend__ml_switch_gen__ml_gen_switch_9_0_i98);
	}
...
MR_BEGIN_MODULE(ml_backend__ml_switch_gen_module10)
	MR_init_entry1(ml_backend__ml_switch_gen__IntroducedFrom__pred__ml_switch_lookup_tags__344__1_2_0);
MR_BEGIN_CODE
	...
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(ml_backend__ml_switch_gen__IntroducedFrom__pred__ml_switch_lookup_tags__344__1_2_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tempr1 = MR_r1;
...
MR_BEGIN_MODULE(ml_backend__ml_switch_gen_module11)
	MR_init_entry1(ml_backend__ml_switch_gen__IntroducedFrom__pred__ml_switch_generate_if_then_else_chain__375__1_2_0);
MR_BEGIN_CODE
	...
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(ml_backend__ml_switch_gen__IntroducedFrom__pred__ml_switch_generate_if_then_else_chain__375__1_2_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tempr1 = MR_r1;
...
MR_BEGIN_MODULE(ml_backend__ml_switch_gen_module12)
	MR_init_entry1(ml_backend__ml_switch_gen__IntroducedFrom__pred__ml_switch_generate_mlds_case__455__1_2_0);
MR_BEGIN_CODE
	...
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(ml_backend__ml_switch_gen__IntroducedFrom__pred__ml_switch_generate_mlds_case__455__1_2_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tempr1 = MR_r1;
