  ...
  MR_Word * STATE_VARIABLE_Info_36)
{
  ...
  switch (MayUseSmartIndexing_28) {
    ...
    case (MR_Integer) 0:
      {
        ml_backend__ml_switch_gen__ml_switch_generate_if_then_else_chain_9_p_0(TaggedCases_24, SwitchVar_11, CodeModel_13, CanFail_12, EntryPackedWordMap_26, Context_15, Stmts_18, STATE_VARIABLE_Info_0_35, &STATE_VARIABLE_Info_45_45);
    ...
    case (MR_Integer) 1:
      switch (SwitchCategory_27) {
        ...
        case (MR_Integer) 0:
          {
            ml_backend__ml_switch_gen__ml_gen_smart_atomic_switch_12_p_0(SwitchVar_11, SwitchVarType_22, CanFail_12, TaggedCases_24, MaybeIntSwitchInfo_25, CodeModel_13, GoalInfo_14, EntryPackedWordMap_26, Context_15, Stmts_18, STATE_VARIABLE_Info_0_35, &STATE_VARIABLE_Info_45_45);
            *Decls_17 = (MR_Word) ((MR_Unsigned) 0U);
          }
          break;
        case (MR_Integer) 4:
        ...
        case (MR_Integer) 1:
          {
            ml_backend__ml_switch_gen__ml_gen_smart_int64_switch_9_p_0(SwitchVar_11, CanFail_12, TaggedCases_24, CodeModel_13, EntryPackedWordMap_26, Context_15, Stmts_18, STATE_VARIABLE_Info_0_35, &STATE_VARIABLE_Info_45_45);
            *Decls_17 = (MR_Word) ((MR_Unsigned) 0U);
          }
          break;
        case (MR_Integer) 2:
          ml_backend__ml_switch_gen__ml_gen_smart_string_switch_12_p_0(SwitchVar_11, SwitchVarEntry_21, CanFail_12, CodeModel_13, GoalInfo_14, Context_15, TaggedCases_24, EntryPackedWordMap_26, Decls_17, Stmts_18, STATE_VARIABLE_Info_0_35, &STATE_VARIABLE_Info_45_45);
          break;
        case (MR_Integer) 3:
          {
            ...
            {
              Var_38 = (MR_Integer) 1;
              succeeded = (NumArms_30 > Var_38);
              if (succeeded)
              {
                Var_39 = ml_backend__ml_target_util__globals_target_supports_int_switch_1_f_0(Globals_31);
                succeeded = (Var_39 == (MR_Integer) 1);
                if (succeeded)
                  succeeded = ml_backend__ml_tag_switch__ml_generate_tag_switch_if_possible_10_p_0(SwitchVar_11, SwitchVarEntry_21, CodeModel_13, CanFail_12, Context_15, EntryPackedWordMap_26, TaggedCases_24, &StmtsPrime_34, STATE_VARIABLE_Info_0_35, &STATE_VARIABLE_Info_40_40);
              }
            }
            if (succeeded)
            {
              STATE_VARIABLE_Info_45_45 = STATE_VARIABLE_Info_40_40;
  ...
  ml_backend__ml_gen_info__ml_gen_info_set_packed_word_map_3_p_0(EntryPackedWordMap_26, STATE_VARIABLE_Info_45_45, STATE_VARIABLE_Info_36);
}
  ...
  else
  {
    ...
    else
    {
      ...
      if (!(succeeded))
      {
        ...
        Var_47 = ml_backend__ml_target_util__globals_target_supports_computed_goto_1_f_0(Globals_29);
        succeeded = (Var_47 == (MR_Integer) 0);
        if (succeeded)
        {
          Var_48 = ml_backend__ml_target_util__globals_target_supports_int_switch_1_f_0(Globals_29);
