  ...
  MR_Word * STATE_VARIABLE_Info_36)
{
  ...
  switch (SwitchCategory_27) {
    ...
    case (MR_Integer) 1:
      ...
      break;
    case (MR_Integer) 3:
      ml_backend__ml_switch_gen__ml_gen_string_switch_12_p_0(SwitchVar_11, SwitchVarEntry_21, CanFail_12, CodeModel_13, GoalInfo_14, Context_15, TaggedCases_24, EntryPackedWordMap_26, Defns_17, Stmts_18, STATE_VARIABLE_Info_0_35, &STATE_VARIABLE_Info_37_37);
      break;
    case (MR_Integer) 5:
      {
  ...
  MR_Word * STATE_VARIABLE_Info_32)
{
  ...
  else
  {
    ...
    switch (Target_30) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        ml_backend__ml_switch_gen__ml_gen_smart_string_switch_14_p_0(Globals_29, SwitchVar_13, SwitchVarEntry_14, FilteredCanFail_25, CodeModel_16, GoalInfo_17, Context_18, NumConsIds_26, FilteredTaggedCases_24, EntryPackedWordMap_20, Defns_21, Stmts_22, STATE_VARIABLE_Info_0_31, STATE_VARIABLE_Info_32);
        break;
      case (MR_Integer) 1:
      case (MR_Integer) 2:
        {
  ...
  MR_Word * STATE_VARIABLE_Info_37)
{
  ...
  ml_backend__ml_code_util__ml_gen_var_4_p_0(STATE_VARIABLE_Info_0_36, SwitchVar_16, SwitchVarEntry_17, &SwitchVarLval_28);
  {
  ...
  ml_backend__ml_lookup_switch__ml_is_lookup_switch_6_p_0(SwitchVar_16, FilteredTaggedCases_23, GoalInfo_20, CodeModel_19, STATE_VARIABLE_Info_0_36, &MaybeLookupSwitchInfo_30);
  ...
  if (succeeded)
  {
    if ((MaybeLookupSwitchInfo_30 == (MR_Word) ((MR_Unsigned) 0U)))
      ml_backend__ml_string_switch__ml_generate_string_trie_jump_switch_9_p_0(SwitchVarRval_29, FilteredTaggedCases_23, CodeModel_19, FilteredCanFail_18, EntryPackedWordMap_24, Context_21, Stmts_26, STATE_VARIABLE_Info_0_36, STATE_VARIABLE_Info_37);
    else
    {
      MR_Word LookupSwitchInfo_33 = ((MR_Word) ((MR_hl_field(1, MaybeLookupSwitchInfo_30, (MR_Integer) 0))));

      ml_backend__ml_string_switch__ml_generate_string_trie_lookup_switch_8_p_0(SwitchVarRval_29, FilteredTaggedCases_23, LookupSwitchInfo_33, CodeModel_19, FilteredCanFail_18, Context_21, Stmts_26, STATE_VARIABLE_Info_37);
    }
  ...
  else
  {
    ...
    if (succeeded)
      if ((MaybeLookupSwitchInfo_30 == (MR_Word) ((MR_Unsigned) 0U)))
        ml_backend__ml_string_switch__ml_generate_string_hash_jump_switch_10_p_0(SwitchVarRval_29, FilteredTaggedCases_23, CodeModel_19, FilteredCanFail_18, EntryPackedWordMap_24, Context_21, Defns_25, Stmts_26, STATE_VARIABLE_Info_0_36, STATE_VARIABLE_Info_37);
      else
      {
        MR_Word LookupSwitchInfo_45 = ((MR_Word) ((MR_hl_field(1, MaybeLookupSwitchInfo_30, (MR_Integer) 0))));

        ml_backend__ml_string_switch__ml_generate_string_hash_lookup_switch_9_p_0(SwitchVarRval_29, FilteredTaggedCases_23, LookupSwitchInfo_45, CodeModel_19, FilteredCanFail_18, Context_21, Defns_25, Stmts_26, STATE_VARIABLE_Info_37);
      }
    else
    {
      ...
      if (succeeded)
        if ((MaybeLookupSwitchInfo_30 == (MR_Word) ((MR_Unsigned) 0U)))
          ml_backend__ml_string_switch__ml_generate_string_binary_jump_switch_10_p_0(SwitchVarRval_29, FilteredTaggedCases_23, CodeModel_19, FilteredCanFail_18, EntryPackedWordMap_24, Context_21, Defns_25, Stmts_26, STATE_VARIABLE_Info_0_36, STATE_VARIABLE_Info_37);
        else
        {
          MR_Word LookupSwitchInfo_47 = ((MR_Word) ((MR_hl_field(1, MaybeLookupSwitchInfo_30, (MR_Integer) 0))));

          ml_backend__ml_string_switch__ml_generate_string_binary_lookup_switch_9_p_0(SwitchVarRval_29, FilteredTaggedCases_23, LookupSwitchInfo_47, CodeModel_19, FilteredCanFail_18, Context_21, Defns_25, Stmts_26, STATE_VARIABLE_Info_37);
        }
      else
      {
        ml_backend__ml_switch_gen__ml_switch_generate_if_then_else_chain_9_p_0(FilteredTaggedCases_23, SwitchVar_16, CodeModel_19, FilteredCanFail_18, EntryPackedWordMap_24, Context_21, Stmts_26, STATE_VARIABLE_Info_0_36, STATE_VARIABLE_Info_37);
        *Defns_25 = (MR_Word) ((MR_Unsigned) 0U);
      }
    }
  }
  ...
  MR_Word * STATE_VARIABLE_Info_46)
{
  ...
  if (succeeded)
  {
    ...
    ml_backend__ml_lookup_switch__ml_gen_int_max_32_lookup_switch_11_p_0(SwitchVar_13, TaggedCases_16, LookupSwitchInfo_43, CodeModel_18, Context_21, FirstVal_40, LastVal_41, NeedBitVecCheck_38, NeedRangeCheck_39, &LookupStmt_44, STATE_VARIABLE_Info_46);
    {
      MR_Word base;
      base = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      *Stmts_22 = base;
