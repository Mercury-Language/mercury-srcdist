  ...
  MR_Word * STATE_VARIABLE_Info_39)
{
  ...
  else
  {
    ...
    if (succeeded)
    {
      succeeded = libs__globals__lookup_bool_option_3_p_1(Globals_29, (MR_Integer) 363, (MR_Integer) 1);
      if (!(succeeded))
      {
        MR_Word Var_435;
    ...
    else
    {
      ...
      else
      {
        ...
        {
          SwitchVarRval_32 = (MR_Word) MR_mkword(2, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(2, SwitchVarRval_32, 0) = ((MR_Box) (SwitchVarLval_31));
        }
        libs__globals__get_opt_tuple_2_p_0(Globals_29, &OptTuple_33);
        StringTrieSwitchSize_34 = ((MR_Integer) ((MR_hl_field(0, OptTuple_33, (MR_Integer) 30))));
        ...
        if (succeeded)
        {
          ...
          {
            MR_Word LookupSwitchInfo_35 = ((MR_Word) ((MR_hl_field(1, MaybeLookupSwitchInfo_30, (MR_Integer) 0))));
        ...
        {
          MR_Integer StringHashSwitchSize_36 = ((MR_Integer) ((MR_hl_field(0, OptTuple_33, (MR_Integer) 31))));
          ...
          if (succeeded)
            ...
            {
              MR_Word LookupSwitchInfo_60 = ((MR_Word) ((MR_hl_field(1, MaybeLookupSwitchInfo_30, (MR_Integer) 0))));
          ...
          {
            MR_Integer StringBinarySwitchSize_37 = ((MR_Integer) ((MR_hl_field(0, OptTuple_33, (MR_Integer) 32))));
            ...
            if (succeeded)
              ...
              {
                MR_Word LookupSwitchInfo_62 = ((MR_Word) ((MR_hl_field(1, MaybeLookupSwitchInfo_30, (MR_Integer) 0))));
    ...
    case (MR_Integer) 1:
      {
        ...
        Type_25 = ((MR_Word) ((MR_hl_field(0, VarEntry_24, (MR_Integer) 1))));
        ...
        {
          Rval_28 = (MR_Word) MR_mkword(2, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(2, Rval_28, 0) = ((MR_Box) (Lval_27));
        }
        ml_backend__ml_gen_info__ml_gen_info_get_module_info_2_p_0(STATE_VARIABLE_Info_0_21, &ModuleInfo_42);
        succeeded = ((((MR_tag((MR_Word) MLDS_Type_26)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(3, MLDS_Type_26, (MR_Integer) 0)))) == (MR_Integer) 0)));
        if (succeeded)
        {
          Type_43 = ((MR_Word) ((MR_hl_field(3, MLDS_Type_26, (MR_Integer) 1))));
          TypeCategory_44 = ((MR_Word) ((MR_hl_field(3, MLDS_Type_26, (MR_Integer) 2))));
        ...
        if (succeeded)
          {
            Range_29 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(1, Range_29, 0) = ((MR_Box) (MinRange_45));
            MR_hl_field(1, Range_29, 1) = ((MR_Box) (MaxRange_46));
          }
        else
        ...
        {
          SwitchStmt0_33 = (MR_Word) MR_mkword(3, MR_new_object(MR_Word, (7 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(3, SwitchStmt0_33, 0) = ((MR_Box) ((MR_Unsigned) 0U));
          MR_hl_field(3, SwitchStmt0_33, 1) = ((MR_Box) (MLDS_Type_26));
          MR_hl_field(3, SwitchStmt0_33, 2) = ((MR_Box) (Rval_28));
          MR_hl_field(3, SwitchStmt0_33, 3) = ((MR_Box) (Range_29));
          MR_hl_field(3, SwitchStmt0_33, 4) = ((MR_Box) (MLDS_Cases_30));
          MR_hl_field(3, SwitchStmt0_33, 5) = ((MR_Box) (Default_32));
          MR_hl_field(3, SwitchStmt0_33, 6) = ((MR_Box) (Context_15));
        }
        ml_backend__ml_simplify_switch__ml_simplify_switch_4_p_0(SwitchStmt0_33, &SwitchStmt_34, STATE_VARIABLE_Info_35_38, STATE_VARIABLE_Info_22);
        {
          ...
          *Stmts_16 = base;
          MR_hl_field(1, base, 0) = ((MR_Box) (SwitchStmt_34));
  ...
  MR_Word * STATE_VARIABLE_Info_45)
{
  ...
  if (succeeded)
  {
    ...
    if (succeeded)
    {
      IntSwitchInfo_28 = ((MR_Word) ((MR_hl_field(1, MaybeIntSwitchInfo_17, (MR_Integer) 0))));
      LowerLimit_29 = ((MR_Integer) ((MR_hl_field(0, IntSwitchInfo_28, (MR_Integer) 0))));
      UpperLimit_30 = ((MR_Integer) ((MR_hl_field(0, IntSwitchInfo_28, (MR_Integer) 1))));
      NumValues_31 = ((MR_Integer) ((MR_hl_field(0, IntSwitchInfo_28, (MR_Integer) 2))));
      libs__globals__get_opt_tuple_2_p_0(Globals_27, &OptTuple_32);
      Var_47 = ((((MR_Unsigned) ((MR_hl_field(0, OptTuple_32, (MR_Integer) 1))) >> 13)) & (MR_Integer) 1);
      ReqDensity_34 = ((MR_Integer) ((MR_hl_field(0, OptTuple_32, (MR_Integer) 27))));
      LookupSize_33 = ((MR_Integer) ((MR_hl_field(0, OptTuple_32, (MR_Integer) 29))));
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              ...
              if (succeeded)
                LookupSwitchInfo_42 = ((MR_Word) ((MR_hl_field(1, MaybeLookupSwitchInfo_41, (MR_Integer) 0))));
            }
          }
        }
      }
  ...
  if (succeeded)
  {
    ...
    ml_backend__ml_lookup_switch__ml_gen_atomic_lookup_switch_12_p_0(SwitchVar_13, TaggedCases_16, LookupSwitchInfo_42, CodeModel_18, Context_21, FirstVal_39, LastVal_40, NeedBitVecCheck_37, NeedRangeCheck_38, &LookupStmt_43, STATE_VARIABLE_Info_49_49, STATE_VARIABLE_Info_45);
    {
      ...
      base = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      *Stmts_22 = base;
      MR_hl_field(1, base, 0) = ((MR_Box) (LookupStmt_43));
      MR_hl_field(1, base, 1) = ((MR_Box) ((MR_Unsigned) 0U));
    }
  }
  else
  ...
  MR_Word * STATE_VARIABLE_Info_31)
{
  ...
  succeeded = ((((MR_tag((MR_Word) MLDS_Type_21)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(3, MLDS_Type_21, (MR_Integer) 0)))) == (MR_Integer) 0)));
  if (succeeded)
  {
  ...
  MR_Word * STATE_VARIABLE_Info_10)
{
  ...
  else
  {
    ...
    ml_backend__ml_switch_gen__ml_tagged_cons_id_to_match_cond_4_p_0(MerType_1, MLDS_Type_2, TaggedMainConsId_37, &MainCond_41);
    {
      ...
      MR_hl_field(0, Var_45, 0) = ((MR_Box) (&ml_backend__ml_switch_gen_scalar_common_3[0]));
  ...
  MR_Word * STATE_VARIABLE_Info_38)
{
  ...
  Var_23 = ((MR_Word) ((MR_hl_field(0, TaggedCase_13, (MR_Integer) 0))));
  Var_24 = ((MR_Word) ((MR_hl_field(0, TaggedCase_13, (MR_Integer) 1))));
  Goal_26 = ((MR_Word) ((MR_hl_field(0, TaggedCase_13, (MR_Integer) 3))));
  ...
  {
    MR_Word LaterTaggedCase_31 = ((MR_Word) ((MR_hl_field(1, TaggedCases_14, (MR_Integer) 0))));
    MR_Word LaterTaggedCases_32 = ((MR_Word) ((MR_hl_field(1, TaggedCases_14, (MR_Integer) 1))));
