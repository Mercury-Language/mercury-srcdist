            ...
            case (MR_Integer) 3:
              {
                ...
                libs__globals__lookup_int_option_3_p_0(Globals_27, (MR_Integer) 456, &TagSize_30);
...
{
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        succeeded = libs__globals__lookup_bool_option_3_p_1(Globals_27, (MR_Integer) 333, (MR_Integer) 1);
        if (!(succeeded))
        {
          MR_Word Var_66;
      ...
      else
      {
        ...
        else
        {
          ...
          libs__globals__lookup_int_option_3_p_0(Globals_27, (MR_Integer) 453, &StringTrieSwitchSize_31);
          ...
          else
          {
            ...
            libs__globals__lookup_int_option_3_p_0(Globals_27, (MR_Integer) 454, &StringHashSwitchSize_33);
            ...
            else
            {
              ...
              libs__globals__lookup_int_option_3_p_0(Globals_27, (MR_Integer) 455, &StringBinarySwitchSize_34);
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
          ...
          Range_71 = (MR_Word) ((MR_Unsigned) 0U);
      ...
      case (MR_Integer) 1:
        {
...

          {
            ...
            MR_hl_field(MR_mktag(3), Var_48, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 12));
          ...
          case (MR_Integer) 1:
            {
...

              {
                ...
                MR_hl_field(MR_mktag(3), Var_47, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 14));
...
{
  {
    ...
    ml_backend__ml_unify_gen_test__ml_gen_known_tag_test_5_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) (wrapper_arg_1)), &conv4_HeadVar__3_3, ((MR_Word) (wrapper_arg_3)), &conv3_HeadVar__5_5);
...
{
  {
    ...
    ml_backend__ml_unify_gen_test__ml_gen_known_tag_test_5_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) (wrapper_arg_1)), &conv1_HeadVar__3_3, ((MR_Word) (wrapper_arg_3)), &conv0_HeadVar__5_5);
...
{
  {
        ...
        case (MR_Integer) 0:
          {
            ...
            ml_backend__ml_unify_gen_test__ml_gen_known_tag_test_5_p_0(Var_13, Var_20, &MainTagTestRval_61, STATE_VARIABLE_Info_35_35, &STATE_VARIABLE_Info_18_63);
            {
    ...
    else
    {
      ...
      ml_backend__ml_unify_gen_test__ml_gen_known_tag_test_5_p_0(Var_13, Var_20, &MainTagTestRval_83, STATE_VARIABLE_Info_35_35, &STATE_VARIABLE_Info_18_85);
      {
  ...
  MR_Word * Expr_6)
{
  while (MR_TRUE)
  {
    ...
    ;
    if ((LaterExprs_5 == (MR_Word) ((MR_Unsigned) 0U)))
      *Expr_6 = FirstExpr_4;
    else
    {
...

      {
        ...
        MR_hl_field(MR_mktag(3), FirstSecondExpr_9, 1) = ((MR_Box) ((MR_Unsigned) 4U));
