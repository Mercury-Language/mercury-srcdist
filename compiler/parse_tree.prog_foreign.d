...
ifeq ($(TARGET_ASM),yes)
parse_tree.prog_foreign.mh parse_tree.prog_foreign.mih : parse_tree.prog_foreign.s
else
parse_tree.prog_foreign.mh parse_tree.prog_foreign.mih : parse_tree.prog_foreign.c
endif

ifeq ($(TARGET_ASM),yes)
parse_tree.prog_foreign.module_dep : parse_tree.prog_foreign.s
else
 ifeq ($(findstring il,$(GRADE)),il)
parse_tree.prog_foreign.module_dep : parse_tree.prog_foreign.il
  ifeq ($(findstring java,$(GRADE)),java)
parse_tree.prog_foreign.module_dep : mercury/parse_tree_/prog_foreign.java
  else
...
ifeq ($(TARGET_ASM),yes)
parse_tree.prog_foreign.s_date : prog_foreign.m
	$(MCG) $(ALL_GRADEFLAGS) $(ALL_MCGFLAGS) --target-code-only parse_tree.prog_foreign $(ERR_REDIRECT)
parse_tree.prog_foreign.pic_s_date : prog_foreign.m
	$(MCG) $(ALL_GRADEFLAGS) $(ALL_MCGFLAGS) --target-code-only --pic \
		--cflags "$(GCCFLAGS_FOR_PIC)" parse_tree.prog_foreign $(ERR_REDIRECT)
endif # TARGET_ASM
