  ...
  MR_Word * List_8)
{
  ...
  else
  {
    ...
    Reverse_24 = ((MR_Box) ((MR_hl_field(0, Var_27, (MR_Integer) 1))));
    I_26 = (MR_Unsigned) (ModuleIndex_15);
    Var_28 = mercury__uint__cast_to_int_1_f_0(I_26);
    conv1_ModuleName_17 = mercury__version_array__lookup_2_f_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), Reverse_24, Var_28);
  ...
  MR_Word * STATE_VARIABLE_Info_22)
{
  ...
  Map0_8 = make__make_info__make_info_get_dep_file_index_map_1_f_0(STATE_VARIABLE_Info_0_21);
  ...
  else
  {
    ...
    *Index_6 = (MR_Word) (Slot_14);
    ...
    make__make_info__make_info_set_dep_file_index_map_3_p_0(Map_20, STATE_VARIABLE_Info_0_21, STATE_VARIABLE_Info_22);
  }
}
  ...
  MR_Word * STATE_VARIABLE_Info_24)
{
  ...
  Forward0_9 = ((MR_Word) ((MR_hl_field(0, Map0_8, (MR_Integer) 0))));
  ...
  else
  {
    ...
    *Index_6 = (MR_Word) (Slot_16);
    ...
    CurReverseSize_19 = mercury__version_array__size_1_f_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), Reverse0_14);
    Var_26 = mercury__uint__cast_to_int_1_f_0(USize_17);
    succeeded = (Var_26 > CurReverseSize_19);
    if (succeeded)
    {
      MR_Integer NewReverseSize_20;

      succeeded = (CurReverseSize_19 == (MR_Integer) 0);
      if (succeeded)
        NewReverseSize_20 = (MR_Integer) 1;
      else
        NewReverseSize_20 = (MR_Integer) ((MR_Unsigned) CurReverseSize_19 * (MR_Unsigned) 2);
      mercury__version_array__resize_4_p_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), NewReverseSize_20, ((MR_Box) (ModuleName_5)), Reverse0_14, &Reverse_21);
    }
    else
    {
      MR_Integer Var_27;
