  ...
  MR_Word * STATE_VARIABLE_Set_10)
{
  ...
  MR_Box Reverse_16;
  MR_Integer I_18;
  MR_Word Var_19 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Info_5, (MR_Integer) 6))));
  MR_Box conv0_ModuleName_8;

  Reverse_16 = ((MR_Box) ((MR_hl_field(MR_mktag(0), Var_19, (MR_Integer) 1))));
  I_18 = (MR_Integer) (ModuleIndex_6);
  conv0_ModuleName_8 = mercury__version_array__lookup_2_f_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), Reverse_16, I_18);
