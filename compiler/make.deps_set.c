  ...
  MR_Word * STATE_VARIABLE_Set_10)
{
  ...
  I_16 = (MR_Integer) (ModuleIndex_6);
  conv0_ModuleName_8 = mercury__version_array__lookup_2_f_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), Reverse_14, I_16);
