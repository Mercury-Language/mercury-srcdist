  ...
  MR_Word * STATE_VARIABLE_Info_18)
{
  ...
  else
  {
    ...
    make__deps_set__module_name_to_index_4_p_0(ModuleName_9, &ModuleIndex_11, STATE_VARIABLE_Info_0_17, &STATE_VARIABLE_Info_1_20);
    {
  ...
  make__deps_set__dependency_file_to_index_4_p_0(DepFile_12, &DepIndex_14, STATE_VARIABLE_Info_1_20, STATE_VARIABLE_Info_18);
  ...
  MR_Box * wrapper_arg_3)
{
  ...
  make__deps_set__acc_dependency_file_index_set_to_plain_set_4_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) (wrapper_arg_1)), ((MR_Word) (wrapper_arg_2)), &conv0_List_8);
  ...
  MR_Box * wrapper_arg_3)
{
  ...
  make__deps_set__acc_module_index_set_to_plain_set_4_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) (wrapper_arg_1)), ((MR_Word) (wrapper_arg_2)), &conv0_STATE_VARIABLE_Set_10);
  ...
  MR_Word * STATE_VARIABLE_Info_5)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      make__deps_set__module_name_to_index_4_p_0(ModuleName_12, &ModuleIndex_16, STATE_VARIABLE_Info_0_4, &STATE_VARIABLE_Info_1_21);
      mercury__sparse_bitset__insert_3_p_0((MR_Word) (&make__deps_set_scalar_common_1[0]), ((MR_Box) (ModuleIndex_16)), HeadVar__2_2, &STATE_VARIABLE_Set_1_22);
