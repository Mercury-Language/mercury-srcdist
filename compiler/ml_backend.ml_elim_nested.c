...
{
  {
    ...
    else
    {
      ...
      Arguments_52 = mercury__list__map_2_f_0((MR_Word) (&ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_argument_0), (MR_Word) (&ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_argument_0), (MR_Word) (&ml_backend__ml_elim_nested_scalar_common_2[7]), Arguments0_29);
      {
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_20, (MR_Integer) 291, &OnHeap_25);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 291, &OnHeap_9);
    switch (OnHeap_9) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
