...
{
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        succeeded = ((((MR_tag((MR_Word) ThisVarName_8)) == (MR_Integer) 3)) && ((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), ThisVarName_8, (MR_Integer) 0))) == (MR_Integer) 8)));
        if (succeeded)
        {
      ...
      case (MR_Integer) 2:
        {
          ...
          if (!(succeeded))
          {
            ...
            succeeded = ((MR_tag((MR_Word) MaybeSubElse_15)) == (MR_Integer) 1);
            if (succeeded)
            {
      ...
      {
        {
          ...
          succeeded = ((MR_tag((MR_Word) FunctionBody_17)) == (MR_Integer) 1);
          if (succeeded)
          {
