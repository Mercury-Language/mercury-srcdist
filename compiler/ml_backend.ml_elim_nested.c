...
static /* final */ const MR_Box ml_backend__ml_elim_nested_scalar_common_3[10][1];
...
{
  {
    ...
    else
    {
      ...
      mercury__builtin__compare_3_p_0((MR_Word) (&ml_backend__ml_elim_nested_scalar_common_1[3]), &SubResult1_6, ((MR_Box) (ArgX1_4)), ((MR_Box) (ArgY1_5)));
      ...
      else
      {
        ...
        mercury__builtin__compare_3_p_0((MR_Word) (&ml_backend__ml_elim_nested_scalar_common_1[4]), &SubResult2_9, ((MR_Box) (ArgX2_7)), ((MR_Box) (ArgY2_8)));
...
{
  {
    ...
    else
    {
      ...
      succeeded = mercury__builtin__unify_2_p_0((MR_Word) (&ml_backend__ml_elim_nested_scalar_common_1[3]), ((MR_Box) (ArgX1_3)), ((MR_Box) (ArgY1_4)));
      if (succeeded)
      {
        TypeInfo_18_18 = (MR_Word) (&ml_backend__ml_elim_nested_scalar_common_1[4]);
...
{
  {
    ...
    mercury__builtin__compare_3_p_0((MR_Word) (&ml_backend__ml_elim_nested_scalar_common_1[2]), HeadVar__1_1, ((MR_Box) (Cast_HeadVar1_4)), ((MR_Box) (Cast_HeadVar2_5)));
  }
}
...
{
  {
    ...
    succeeded = mercury__builtin__unify_2_p_0((MR_Word) (&ml_backend__ml_elim_nested_scalar_common_1[2]), ((MR_Box) (Cast_HeadVar1_3)), ((MR_Box) (Cast_HeadVar2_4)));
    return succeeded;
  }
}
...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(0), FieldVarDefn_4, 2) = ((MR_Box) (&ml_backend__ml_elim_nested_scalar_common_3[1]));
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_20, (MR_Integer) 285, &OnHeap_25);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 285, &OnHeap_9);
    switch (OnHeap_9) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
