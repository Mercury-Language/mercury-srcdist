...
{
  {
    ...
    else
    {
      ...
      Var_93 = (MR_Word) (MR_mkword(MR_mktag(1), (MR_Word) (EnvClassId_27)));
      {
        ...
        MR_hl_field(MR_mktag(3), EnvPtrTypeName_28, 0) = ((MR_Box) ((MR_Unsigned) 7U));
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_20, (MR_Integer) 281, &OnHeap_25);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 281, &OnHeap_9);
    switch (OnHeap_9) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
