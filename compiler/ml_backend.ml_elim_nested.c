  ...
  MR_Word * STATE_VARIABLE_ClassDefnsCord_58)
{
  ...
  else
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_12, (MR_Integer) 312, &OnHeap_90);
    switch (OnHeap_90) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
  ...
  MR_Word * GCTraceFuncDefns_24)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_20, (MR_Integer) 312, &OnHeap_25);
  ...
  MR_Word Globals_7)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 312, &OnHeap_9);
  switch (OnHeap_9) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 0:
