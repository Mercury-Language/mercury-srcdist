...
static const MR_EnumFunctorDesc libs__maybe_util__libs__maybe_util__enum_functor_desc_is_first_0_0;

static const MR_EnumFunctorDesc libs__maybe_util__libs__maybe_util__enum_functor_desc_is_first_0_1;

static const MR_EnumFunctorDescPtr libs__maybe_util__libs__maybe_util__enum_ordinal_ordered_is_first_0[2];

static const MR_EnumFunctorDescPtr libs__maybe_util__libs__maybe_util__enum_name_ordered_is_first_0[2];

static const MR_Integer libs__maybe_util__libs__maybe_util__functor_number_map_is_first_0[2];

static const MR_EnumFunctorDesc libs__maybe_util__libs__maybe_util__enum_functor_desc_is_last_0_0;

static const MR_EnumFunctorDesc libs__maybe_util__libs__maybe_util__enum_functor_desc_is_last_0_1;

static const MR_EnumFunctorDescPtr libs__maybe_util__libs__maybe_util__enum_ordinal_ordered_is_last_0[2];

static const MR_EnumFunctorDescPtr libs__maybe_util__libs__maybe_util__enum_name_ordered_is_last_0[2];

static const MR_Integer libs__maybe_util__libs__maybe_util__functor_number_map_is_last_0[2];
...
libs__maybe_util__or_list_1_f_0_1(
  MR_Box closure_arg,
...
libs__maybe_util____Unify____is_first_0_0_10001(
  MR_Box wrapper_arg_1,
  MR_Box wrapper_arg_2);

static void MR_CALL 
libs__maybe_util____Compare____is_first_0_0_10001(
  MR_Box * wrapper_arg_1,
  MR_Box wrapper_arg_2,
  MR_Box wrapper_arg_3);

static MR_bool MR_CALL 
libs__maybe_util____Unify____is_last_0_0_10001(
  MR_Box wrapper_arg_1,
  MR_Box wrapper_arg_2);

static void MR_CALL 
libs__maybe_util____Compare____is_last_0_0_10001(
  MR_Box * wrapper_arg_1,
  MR_Box wrapper_arg_2,
  MR_Box wrapper_arg_3);
...
static /* final */ const MR_Box libs__maybe_util_scalar_common_1[2][6];

static /* final */ const MR_Box libs__maybe_util_scalar_common_2[2][3];
...
static /* final */ const MR_Box libs__maybe_util_scalar_common_2[2][3] = {
  ...
  /* row   1 */
  {
    ((MR_Box) (&libs__maybe_util_scalar_common_1[1])),
    ((MR_Box) (libs__maybe_util__or_list_1_f_0_1)),
    ((MR_Box) ((MR_Integer) 0))
  },
};
...
static const MR_EnumFunctorDescPtr libs__maybe_util__libs__maybe_util__enum_ordinal_ordered_is_first_0[2] = {
  &libs__maybe_util__libs__maybe_util__enum_functor_desc_is_first_0_0,
  &libs__maybe_util__libs__maybe_util__enum_functor_desc_is_first_0_1
};
...
const MR_TypeCtorInfo_Struct libs__maybe_util__libs__maybe_util__type_ctor_info_is_first_0 = {
  (MR_Integer) 0,
  UINT8_C(18),
  INT8_C(-1),
  MR_TYPECTOR_REP_ENUM,
  ((MR_Box) (libs__maybe_util____Unify____is_first_0_0_10001)),
  ((MR_Box) (libs__maybe_util____Compare____is_first_0_0_10001)),
  (MR_String) "libs.maybe_util",
  (MR_String) "is_first",
  { libs__maybe_util__libs__maybe_util__enum_name_ordered_is_first_0 },
  { libs__maybe_util__libs__maybe_util__enum_ordinal_ordered_is_first_0 },
  (MR_Integer) 2,
  UINT16_C(12),
  libs__maybe_util__libs__maybe_util__functor_number_map_is_first_0,
...
static const MR_EnumFunctorDescPtr libs__maybe_util__libs__maybe_util__enum_ordinal_ordered_is_last_0[2] = {
  &libs__maybe_util__libs__maybe_util__enum_functor_desc_is_last_0_0,
  &libs__maybe_util__libs__maybe_util__enum_functor_desc_is_last_0_1
};
...
const MR_TypeCtorInfo_Struct libs__maybe_util__libs__maybe_util__type_ctor_info_is_last_0 = {
  (MR_Integer) 0,
  UINT8_C(18),
  INT8_C(-1),
  MR_TYPECTOR_REP_ENUM,
  ((MR_Box) (libs__maybe_util____Unify____is_last_0_0_10001)),
  ((MR_Box) (libs__maybe_util____Compare____is_last_0_0_10001)),
  (MR_String) "libs.maybe_util",
  (MR_String) "is_last",
  { libs__maybe_util__libs__maybe_util__enum_name_ordered_is_last_0 },
  { libs__maybe_util__libs__maybe_util__enum_ordinal_ordered_is_last_0 },
  (MR_Integer) 2,
  UINT16_C(12),
  libs__maybe_util__libs__maybe_util__functor_number_map_is_last_0,
...
void MR_CALL 
libs__maybe_util____Compare____is_last_0_0(
  MR_Word * HeadVar__1_1,
  MR_Word HeadVar__2_2,
  MR_Word HeadVar__3_3)
{
...
MR_bool MR_CALL 
libs__maybe_util____Unify____is_last_0_0(
  MR_Word HeadVar__1_1,
  MR_Word HeadVar__2_2)
{
  MR_bool succeeded = (HeadVar__1_1 == HeadVar__2_2);
...
void MR_CALL 
libs__maybe_util____Compare____is_first_0_0(
  MR_Word * HeadVar__1_1,
  MR_Word HeadVar__2_2,
  MR_Word HeadVar__3_3)
{
...
MR_bool MR_CALL 
libs__maybe_util____Unify____is_first_0_0(
  MR_Word HeadVar__1_1,
  MR_Word HeadVar__2_2)
{
  MR_bool succeeded = (HeadVar__1_1 == HeadVar__2_2);
  ...
  MR_Box wrapper_arg_2)
{
  ...
  conv0_HeadVar__3_3 = libs__maybe_util__or_2_f_0(((MR_Word) (wrapper_arg_1)), ((MR_Word) (wrapper_arg_2)));
  wrapper_arg_3 = ((MR_Box) (conv0_HeadVar__3_3));
  return wrapper_arg_3;
}

MR_Word MR_CALL 
libs__maybe_util__or_list_1_f_0(
  MR_Word Changeds_3)
{
  MR_Word AnyChanged_4;
  MR_Box conv1_AnyChanged_4;

  conv1_AnyChanged_4 = mercury__list__foldl_3_f_0((MR_Word) (&libs__maybe_util__libs__maybe_util__type_ctor_info_maybe_changed_0), (MR_Word) (&libs__maybe_util__libs__maybe_util__type_ctor_info_maybe_changed_0), (MR_Word) (&libs__maybe_util_scalar_common_2[1]), Changeds_3, ((MR_Box) ((MR_Integer) 0)));
  AnyChanged_4 = ((MR_Word) (conv1_AnyChanged_4));
  return AnyChanged_4;
}

MR_Word MR_CALL 
libs__maybe_util__or_2_f_0(
  MR_Word ChangedA_4,
  MR_Word ChangedB_5)
{
  MR_bool succeeded = (ChangedA_4 == (MR_Integer) 1);
  MR_Word HeadVar__3_3;

  if (!(succeeded))
    succeeded = (ChangedB_5 == (MR_Integer) 1);
  if (succeeded)
  ...
  MR_Box wrapper_arg_2)
{
  ...
  succeeded = libs__maybe_util____Unify____is_first_0_0(((MR_Word) (wrapper_arg_1)), ((MR_Word) (wrapper_arg_2)));
  return succeeded;
}
  ...
  MR_Box wrapper_arg_3)
{
  ...
  libs__maybe_util____Compare____is_first_0_0(&conv0_HeadVar__1_1, ((MR_Word) (wrapper_arg_2)), ((MR_Word) (wrapper_arg_3)));
  ...
  MR_Box wrapper_arg_2)
{
  ...
  succeeded = libs__maybe_util____Unify____is_last_0_0(((MR_Word) (wrapper_arg_1)), ((MR_Word) (wrapper_arg_2)));
  return succeeded;
}
  ...
  MR_Box wrapper_arg_3)
{
  ...
  libs__maybe_util____Compare____is_last_0_0(&conv0_HeadVar__1_1, ((MR_Word) (wrapper_arg_2)), ((MR_Word) (wrapper_arg_3)));
  *wrapper_arg_1 = ((MR_Box) (conv0_HeadVar__1_1));
}
...
void mercury__libs__maybe_util__init_type_tables(void)
{
  ...
  MR_register_type_ctor_info(&libs__maybe_util__libs__maybe_util__type_ctor_info_is_first_0);
  MR_register_type_ctor_info(&libs__maybe_util__libs__maybe_util__type_ctor_info_is_last_0);
