...
MR_decl_label8(check_hlds__mode_constraint_robdd__IntroducedFrom__pred__robdd_to_dot__390__1_5_0, 3,4,5,6,7,8,9,10)
MR_decl_label3(check_hlds__mode_constraint_robdd__IntroducedFrom__pred__robdd_to_dot__390__1_5_0, 11,12,13)
MR_decl_label4(check_hlds__mode_constraint_robdd__IntroducedFrom__pred__set_input_nodes__300__1_6_0, 1,2,6,7)
MR_decl_label8(check_hlds__mode_constraint_robdd__dump_goal_path_step_3_0, 31,58,59,34,35,61,6,3)
MR_decl_label6(check_hlds__mode_constraint_robdd__dump_goal_path_step_3_0, 14,16,18,20,22,24)
MR_decl_label8(check_hlds__mode_constraint_robdd__dump_mode_constraint_var_4_0, 4,5,6,7,10,11,12,14)
MR_decl_label2(check_hlds__mode_constraint_robdd__dump_mode_constraint_var_4_0, 15,16)
...
MR_decl_label8(__Unify___check_hlds__mode_constraint_robdd__mode_constraint_info_0_0, 4,7,9,11,13,16,18,20)
MR_decl_label1(__Unify___check_hlds__mode_constraint_robdd__mode_constraint_info_0_0, 1)
...
MR_decl_label8(__Compare___check_hlds__mode_constraint_robdd__mode_constraint_info_0_0, 3,2,5,10,14,18,23,28)
MR_decl_label3(__Compare___check_hlds__mode_constraint_robdd__mode_constraint_info_0_0, 33,37,81)
MR_decl_label5(__Compare___check_hlds__mode_constraint_robdd__prog_var_and_level_0_0, 3,2,5,9,29)
MR_decl_label8(__Compare___check_hlds__mode_constraint_robdd__rep_var_0_0, 3,2,9,18,26,56,29,30)
MR_decl_label1(__Compare___check_hlds__mode_constraint_robdd__rep_var_0_0, 92)
...
MR_def_label(check_hlds__mode_constraint_robdd__robdd_to_dot_6_0,2)
	...
	MR_tfield(0, MR_tempr1, 2) = (MR_Integer) 2;
	MR_tfield(0, MR_tempr1, 3) = MR_sv(1);
	MR_tfield(0, MR_tempr1, 4) = MR_ctfield(0, MR_sv(2), 1);
	MR_tempr2 = MR_r1;
	MR_r1 = MR_sv(4);
	MR_r2 = MR_tempr2;
	MR_r4 = MR_sv(3);
...
MR_BEGIN_MODULE(check_hlds__mode_constraint_robdd_module21)
	...
	MR_init_label8(check_hlds__mode_constraint_robdd__dump_mode_constraint_var_4_0,4,5,6,7,10,11,12,14)
	MR_init_label2(check_hlds__mode_constraint_robdd__dump_mode_constraint_var_4_0,15,16)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(check_hlds__mode_constraint_robdd_module22)
	...
	MR_init_label8(check_hlds__mode_constraint_robdd__dump_goal_path_step_3_0,31,58,59,34,35,61,6,3)
	MR_init_label6(check_hlds__mode_constraint_robdd__dump_goal_path_step_3_0,14,16,18,20,22,24)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(check_hlds__mode_constraint_robdd_module29)
	...
	MR_init_label8(__Unify___check_hlds__mode_constraint_robdd__mode_constraint_info_0_0,4,7,9,11,13,16,18,20)
	MR_init_label1(__Unify___check_hlds__mode_constraint_robdd__mode_constraint_info_0_0,1)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(check_hlds__mode_constraint_robdd_module30)
	...
	MR_init_label8(__Compare___check_hlds__mode_constraint_robdd__mode_constraint_info_0_0,3,2,5,10,14,18,23,28)
	MR_init_label3(__Compare___check_hlds__mode_constraint_robdd__mode_constraint_info_0_0,33,37,81)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(check_hlds__mode_constraint_robdd_module42)
	...
	MR_init_label8(__Compare___check_hlds__mode_constraint_robdd__rep_var_0_0,3,2,9,18,26,56,29,30)
	MR_init_label1(__Compare___check_hlds__mode_constraint_robdd__rep_var_0_0,92)
MR_BEGIN_CODE
...
MR_def_label(check_hlds__mode_constraint_robdd__IntroducedFrom__pred__set_input_nodes__300__1_6_0,2)
	...
	MR_Word MR_tempr1;
	MR_tempr1 = MR_fv(5);
	MR_fv(5) = MR_ctfield(0, MR_fv(6), 0);
	MR_r1 = MR_fv(7);
	MR_r2 = (MR_Word) MR_TAG_COMMON(0,0,0);
	MR_r3 = MR_fv(1);
	MR_r4 = MR_tempr1;
...
MR_BEGIN_MODULE(check_hlds__mode_constraint_robdd_module56)
	...
	MR_init_label8(check_hlds__mode_constraint_robdd__IntroducedFrom__pred__robdd_to_dot__390__1_5_0,3,4,5,6,7,8,9,10)
	MR_init_label3(check_hlds__mode_constraint_robdd__IntroducedFrom__pred__robdd_to_dot__390__1_5_0,11,12,13)
MR_BEGIN_CODE
