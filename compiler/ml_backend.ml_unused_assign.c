...
{
  {
    ...
    {
      SeenAtContinueLoop0_20 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), SeenAtContinueLoop0_20, 0) = ((MR_Box) (SeenAfter_17));
    }
    {
      Info0_21 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 5 * sizeof(MR_Word)), NULL, NULL);
    ...
    packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Info_24, (MR_Integer) 4)));
  ...
  else
  {
    ...
    else
    {
      ...
      if ((Stmts_70 == (MR_Word) ((MR_Unsigned) 0U)))
      {
        ...
        {
          Stmt_40 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL);
      ...
      packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Info_41, (MR_Integer) 4)));
      ...
      case (MR_Integer) 0:
        {
          ...
          else
          {
            ...
            MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_Info_114_114, (MR_Integer) 4)));
          ...
          else
          {
            ...
            {
              Stmt_22 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL);
      ...
      case (MR_Integer) 1:
        {
          ...
          MR_Word Var_166;
          MR_Word Var_167;
          MR_Unsigned packed_args_9 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), Stmt0_7, (MR_Integer) 0)));
          ...
          packed_args_10 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_Info_0_79, (MR_Integer) 4)));
          ...
          {
            STATE_VARIABLE_Info_109_109 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 5 * sizeof(MR_Word)), NULL, NULL);
          ...
          packed_args_11 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_Info_111_111, (MR_Integer) 4)));
          {
            MR_Word base;
            base = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 5 * sizeof(MR_Word)), NULL, NULL);
            *STATE_VARIABLE_Info_80 = base;
            ...
            MR_hl_field(MR_mktag(0), base, 4) = (MR_Box) (packed_args_11);
          }
          {
            Stmt_118 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 5 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), Stmt_118, 0) = (MR_Box) (packed_args_9);
      ...
      case (MR_Integer) 2:
        {
          ...
          else
          {
            ...
            if (succeeded)
              ...
              {
                MaybeElseStmt_36 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
          ...
          {
            Stmt_120 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL));
          ...
          case (MR_Integer) 0:
            {
              ...
              MR_Unsigned packed_args_7 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_Info_0_79, (MR_Integer) 4)));
              MR_Word Var_185;
              MR_Word Var_187;
              MR_Word Var_188;
              ...
              {
                STATE_VARIABLE_Info_97_97 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 5 * sizeof(MR_Word)), NULL, NULL);
                ...
                MR_hl_field(MR_mktag(0), STATE_VARIABLE_Info_97_97, 4) = (MR_Box) (packed_args_7);
              }
              ...
              packed_args_8 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_Info_100_100, (MR_Integer) 4)));
              {
                MR_Word base;
                base = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 5 * sizeof(MR_Word)), NULL, NULL);
                *STATE_VARIABLE_Info_80 = base;
                ...
                MR_hl_field(MR_mktag(0), base, 4) = (MR_Box) (packed_args_8);
              }
              ml_backend__ml_unused_assign__see_in_rval_3_p_0(SwitchRval_43, SeenBeforeDefaultCases_51, SeenBefore_10);
              {
                Stmt_123 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 7 * sizeof(MR_Word)), NULL, NULL));
          ...
          case (MR_Integer) 1:
            {
              ...
              MR_Unsigned packed_args_5 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_Info_0_79, (MR_Integer) 4)));
              MR_Word Var_195;
              MR_Word Var_196;
              MR_Word Var_197;
              ...
              packed_args_6 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_Info_0_79, (MR_Integer) 4)));
              {
                MR_Word base;
                base = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 5 * sizeof(MR_Word)), NULL, NULL);
                *STATE_VARIABLE_Info_80 = base;
                ...
                MR_hl_field(MR_mktag(0), base, 4) = (MR_Box) (packed_args_6);
              }
                    ...
                    case (MR_Integer) 0:
                      {
                        ...
                        MR_Unsigned packed_args_3 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_Info_0_79, (MR_Integer) 4)));
                    ...
                    case (MR_Integer) 1:
                      {
                        ...
                        MR_Unsigned packed_args_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_Info_0_79, (MR_Integer) 4)));
                    ...
                    case (MR_Integer) 2:
                      {
                        ...
                        MR_Unsigned packed_args_4 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_Info_0_79, (MR_Integer) 4)));
          ...
          case (MR_Integer) 4:
            {
              ...
              MR_Unsigned packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Stmt0_7, (MR_Integer) 5)));
          ...
          case (MR_Integer) 6:
            {
              ...
              {
                Stmt_138 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 5 * sizeof(MR_Word)), NULL, NULL));
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      else
      {
        ...
        MR_Unsigned packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_Info_0_4, (MR_Integer) 4)));
...
{
  {
    ...
    else
    {
      ...
      MR_Unsigned packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_Info_0_10, (MR_Integer) 4)));
          ...
          case (MR_Integer) 2:
            {
              ...
              MR_Unsigned packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), AtomicStmt0_9, (MR_Integer) 3)));
              MR_Unsigned packed_args_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), AtomicStmt0_9, (MR_Integer) 8)));
          ...
          case (MR_Integer) 6:
            {
              ...
              MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), AtomicStmt0_9, (MR_Integer) 1)));
          ...
          case (MR_Integer) 7:
            {
              ...
              MR_Unsigned packed_args_3 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), AtomicStmt0_9, (MR_Integer) 1)));
