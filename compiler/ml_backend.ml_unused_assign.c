    ...
    case (MR_Integer) 0:
      {
        ...
        {
          MR_Word Var_158 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_Info_83_83, 0))));
          MR_Word Var_159 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_Info_83_83, 1))));
          MR_Word Var_160 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_Info_83_83, 2))));
          MR_Word Var_161 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_Info_83_83, 3))));
    ...
    case (MR_Integer) 1:
      {
        ...
        Var_181 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_Info_90_90, 0))));
        Var_182 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_Info_90_90, 1))));
        Var_185 = ((MR_Unsigned) ((MR_hl_field(0, STATE_VARIABLE_Info_90_90, 4))) & (MR_Integer) 1);
        {
          MR_Word base;
          base = (MR_Word) MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL);
          *STATE_VARIABLE_Info_82 = base;
        ...
        case (MR_Integer) 0:
          {
            ...
            Var_200 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_Info_111_111, 0))));
            Var_202 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_Info_111_111, 2))));
            Var_203 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_Info_111_111, 3))));
            Var_204 = ((MR_Unsigned) ((MR_hl_field(0, STATE_VARIABLE_Info_111_111, 4))) & (MR_Integer) 1);
            {
              MR_Word base;
              base = (MR_Word) MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL);
              *STATE_VARIABLE_Info_82 = base;
  ...
  switch (MR_tag((MR_Word) AtomicStmt0_9)) {
    ...
    case (MR_Integer) 3:
      switch (((MR_Integer) ((MR_hl_field(3, AtomicStmt0_9, 0))))) {
        ...
        case (MR_Integer) 0:
          {
            MR_Word TargetLval_135 = ((MR_Word) ((MR_hl_field(3, AtomicStmt0_9, 1))));
            MR_Word SourceRval_136 = ((MR_Word) ((MR_hl_field(3, AtomicStmt0_9, 2))));
            MR_Word TargetLocalVarName_105;
            MR_Word TypeCtorInfo_55_84;

            succeeded = ((((MR_tag((MR_Word) TargetLval_135)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(3, TargetLval_135, 0)))) == (MR_Integer) 0)));
            if (succeeded)
            {
              TargetLocalVarName_105 = ((MR_Word) ((MR_hl_field(3, TargetLval_135, 1))));
              ...
              if (succeeded)
                switch (MR_tag((MR_Word) TargetLocalVarName_105)) {
                  ...
                  case (MR_Integer) 1:
                    ...
                    break;
                  case (MR_Integer) 3:
                    switch (((MR_Integer) ((MR_hl_field(3, TargetLocalVarName_105, 0))))) {
                      default:
                        succeeded = MR_FALSE;
                        break;
                      case (MR_Integer) 0:
                      ...
                      case (MR_Integer) 8:
                        {
                          MR_Word CompVar_87 = ((MR_Word) ((MR_hl_field(3, TargetLocalVarName_105, 1))));
    ...
    switch (MR_tag((MR_Word) Rval_4)) {
      ...
      case (MR_Integer) 3:
        switch (((MR_Integer) ((MR_hl_field(3, Rval_4, 0))))) {
          ...
          case (MR_Integer) 5:
            {
              MR_Word BaseRvalA_32 = ((MR_Word) ((MR_hl_field(3, Rval_4, 2))));
          ...
          case (MR_Integer) 7:
            {
              MR_Word Lval_30 = ((MR_Word) ((MR_hl_field(3, Rval_4, 1))));
