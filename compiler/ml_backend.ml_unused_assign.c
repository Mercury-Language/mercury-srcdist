                    ...
                    case (MR_Integer) 8:
                      {
                        ...
                        succeeded = ((((MR_tag((MR_Word) CompVar_24)) == (MR_Integer) 3)) && ((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), CompVar_24, (MR_Integer) 0))) == (MR_Integer) 10)));
                        if (succeeded)
                        {
                        }
                      }
          ...
          case (MR_Integer) 0:
            {
              ...
              succeeded = ((((MR_tag((MR_Word) TargetLval_136)) == (MR_Integer) 3)) && ((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), TargetLval_136, (MR_Integer) 0))) == (MR_Integer) 0)));
              if (succeeded)
              {
                ...
                if (succeeded)
                  switch (MR_tag((MR_Word) TargetLocalVarName_106)) {
                    ...
                    case (MR_Integer) 1:
                      ...
                      break;
                    case (MR_Integer) 3:
                      switch (((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), TargetLocalVarName_106, (MR_Integer) 0)))) {
                        default:
                          succeeded = MR_FALSE;
                          break;
                        case (MR_Integer) 0:
                        ...
                        case (MR_Integer) 8:
                          {
                            ...
                            succeeded = ((((MR_tag((MR_Word) CompVar_88)) == (MR_Integer) 3)) && ((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), CompVar_88, (MR_Integer) 0))) == (MR_Integer) 10)));
                            if (succeeded)
                            {
                            }
                          }
