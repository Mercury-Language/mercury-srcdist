    ...
    case (MR_Integer) 2:
      {
        ...
        if (succeeded)
        {
          ...
          TypeCtorInfo_56_56 = (MR_Word) (&ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_local_var_name_0);
          succeeded = mercury__set__member_2_p_0(TypeCtorInfo_56_56, ((MR_Box) (TargetLocalVarName_15)), SeenAfter_7);
          succeeded = !(succeeded);
          if (succeeded)
        ...
        case (MR_Integer) 0:
          {
            ...
            if (succeeded)
            {
              ...
              TypeCtorInfo_56_85 = (MR_Word) (&ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_local_var_name_0);
              succeeded = mercury__set__member_2_p_0(TypeCtorInfo_56_85, ((MR_Box) (TargetLocalVarName_106)), SeenAfter_7);
              succeeded = !(succeeded);
              if (succeeded)
