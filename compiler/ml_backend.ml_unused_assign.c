      ...
      case (MR_Integer) 2:
        {
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              succeeded = ((((MR_tag((MR_Word) TargetLocalVarName_15)) == (MR_Integer) 3)) && ((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), TargetLocalVarName_15, (MR_Integer) 0))) == (MR_Integer) 8)));
              if (succeeded)
              {
              }
              succeeded = !(succeeded);
          ...
          case (MR_Integer) 0:
            {
              ...
              succeeded = ((((MR_tag((MR_Word) TargetLval_95)) == (MR_Integer) 3)) && ((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), TargetLval_95, (MR_Integer) 0))) == (MR_Integer) 0)));
              if (succeeded)
              {
                ...
                if (succeeded)
                {
                  succeeded = ((((MR_tag((MR_Word) TargetLocalVarName_81)) == (MR_Integer) 3)) && ((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), TargetLocalVarName_81, (MR_Integer) 0))) == (MR_Integer) 8)));
                  if (succeeded)
                  {
                  }
                  succeeded = !(succeeded);
