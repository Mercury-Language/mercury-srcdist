  ...
  switch (MR_tag((MR_Word) Stmt0_7)) {
    ...
    case (MR_Integer) 3:
      switch (((MR_Integer) ((MR_hl_field(3, Stmt0_7, (MR_Integer) 0))))) {
        ...
        case (MR_Integer) 1:
          {
            MR_String Label_52 = ((MR_String) ((MR_hl_field(3, Stmt0_7, (MR_Integer) 1))));
        ...
        case (MR_Integer) 2:
          {
            ...
            *StmtCord_8 = mercury__cord__singleton_1_f_0((MR_Word) (&ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_stmt_0), ((MR_Box) (Stmt0_7)));
            switch (MR_tag((MR_Word) Target_56)) {
              ...
              case (MR_Integer) 1:
                {
                  MR_String Label_125 = ((MR_String) ((MR_hl_field(1, Target_56, (MR_Integer) 0))));
  ...
  MR_Word * STATE_VARIABLE_Info_5)
{
  while (MR_TRUE)
  {
    ...
    {
      MR_String Label_12 = ((MR_String) ((MR_hl_field(1, HeadVar__1_1, (MR_Integer) 0))));
