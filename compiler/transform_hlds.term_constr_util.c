...
static /* final */ const MR_Box transform_hlds__term_constr_util_scalar_common_3[6][6];
...
{
  {
...

    {
      ...
      MR_hl_field(MR_mktag(0), Var_13, 0) = ((MR_Box) (&transform_hlds__term_constr_util_scalar_common_3[5]));
