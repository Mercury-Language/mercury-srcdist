...
{
  {
...

    {
      ...
      MR_hl_field(MR_mktag(0), WriteSizeVar_8, 2) = ((MR_Box) ((MR_Integer) 1));
...
{
  {
...

    {
      ...
      MR_hl_field(MR_mktag(0), SubVarInCoeff_7, 2) = ((MR_Box) ((MR_Integer) 1));
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(0), SubVarInEqn_11, 2) = ((MR_Box) ((MR_Integer) 1));
