...
transform_hlds__term_constr_util__IntroducedFrom__pred__create_nonneg_constraints_2__320__1_2_p_0(
  MR_Word HeadVar__1_10,
  MR_Word HeadVar__2_14);

static void MR_CALL 
transform_hlds__term_constr_util__IntroducedFrom__pred__write_size_vars__459__1_3_p_0(
  MR_Word VarSet_7,
...
static MR_Word MR_CALL 
transform_hlds__term_constr_util__IntroducedFrom__func__substitute_size_vars__362__1_2_f_0(
  MR_Word SubstMap_5,
  ...
  MR_Box * wrapper_arg_2)
{
  ...
  transform_hlds__term_constr_util__IntroducedFrom__pred__write_size_vars__459__1_3_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) (wrapper_arg_1)), &conv0_HeadVar__3_22);
...
{
  MR_Word PredId_21 = ((MR_Word) ((MR_hl_field(MR_mktag(0), PPID_5, (MR_Integer) 0))));
  MR_Integer ProcId_22 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), PPID_5, (MR_Integer) 1))));
  MR_Word PredInfo0_23;
  MR_Word ProcInfo0_24;
  MR_Word Term2Info0_25;
  MR_Word Term2Info_26;
  MR_Word ProcInfo_27;
  MR_Word PredInfo_28;
  MR_Word Var_31;

  hlds__hlds_module__module_info_pred_info_3_p_0(STATE_VARIABLE_ModuleInfo_0_8, PredId_21, &PredInfo0_23);
  hlds__hlds_pred__pred_info_proc_info_3_p_0(PredInfo0_23, ProcId_22, &ProcInfo0_24);
  hlds__hlds_pred__proc_info_get_termination2_info_2_p_0(ProcInfo0_24, &Term2Info0_25);
  {
    Var_31 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(MR_mktag(1), Var_31, 0) = ((MR_Box) (Polyhedron_6));
  }
  transform_hlds__term_constr_main_types__term2_info_set_success_constrs_3_p_0(Var_31, Term2Info0_25, &Term2Info_26);
  hlds__hlds_pred__proc_info_set_termination2_info_3_p_0(Term2Info_26, ProcInfo0_24, &ProcInfo_27);
  hlds__hlds_pred__pred_info_set_proc_info_4_p_0(ProcId_22, ProcInfo_27, PredInfo0_23, &PredInfo_28);
  hlds__hlds_module__module_info_set_pred_info_4_p_0(PredId_21, PredInfo_28, STATE_VARIABLE_ModuleInfo_0_8, STATE_VARIABLE_ModuleInfo_9);
}
  ...
  MR_Box wrapper_arg_1)
{
  ...
  conv1_LambdaHeadVar__2_20 = transform_hlds__term_constr_util__IntroducedFrom__func__substitute_size_vars__366__1_2_f_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) (wrapper_arg_1)));
  ...
  MR_Box wrapper_arg_1)
{
  ...
  conv0_LambdaHeadVar__2_18 = transform_hlds__term_constr_util__IntroducedFrom__func__substitute_size_vars__362__1_2_f_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) (wrapper_arg_1)));
  ...
  MR_Box wrapper_arg_1)
{
  ...
  succeeded = transform_hlds__term_constr_util__IntroducedFrom__pred__create_nonneg_constraints_2__320__1_2_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) (wrapper_arg_1)));
  return succeeded;
}
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_4)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      {
        Var_23 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), Var_23, 0) = ((MR_Box) (HeadVar__2_2));
      }
      transform_hlds__term_constr_main_types__term2_info_set_success_constrs_3_p_0(Var_23, Term2Info0_17, &Term2Info_18);
      hlds__hlds_pred__proc_info_set_termination2_info_3_p_0(Term2Info_18, ProcInfo0_16, &ProcInfo_19);
