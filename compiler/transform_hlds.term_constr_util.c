...
{
  MR_Word PredId_19 = ((MR_Word) ((MR_hl_field(MR_mktag(0), PPID_5, (MR_Integer) 0))));
  MR_Integer ProcId_20 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), PPID_5, (MR_Integer) 1))));
  ...
  hlds__hlds_pred__proc_info_get_termination2_info_2_p_0(ProcInfo0_22, &Term2Info0_23);
  {
    ...
    MR_hl_field(MR_mktag(1), Var_29, 0) = ((MR_Box) (Polyhedron_6));
  }
  ...
  MR_Word Zeros_5)
{
  ...
  SizeVars_7 = mercury__map__values_1_f_0((MR_Word) (&transform_hlds__term_constr_util_scalar_common_1[0]), (MR_Word) (&transform_hlds__term_constr_util_scalar_common_1[1]), SizeVarMap_4);
  {
    ...
    MR_hl_field(MR_mktag(0), Var_10, 0) = ((MR_Box) (&transform_hlds__term_constr_util_scalar_common_6[0]));
    MR_hl_field(MR_mktag(0), Var_10, 1) = ((MR_Box) (transform_hlds__term_constr_util__create_nonneg_constraints_2_f_0_1));
    MR_hl_field(MR_mktag(0), Var_10, 2) = ((MR_Box) ((MR_Integer) 1));
    MR_hl_field(MR_mktag(0), Var_10, 3) = ((MR_Box) (Zeros_5));
  }
  {
    Var_9 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(MR_mktag(0), Var_9, 0) = ((MR_Box) (&transform_hlds__term_constr_util_scalar_common_6[1]));
    MR_hl_field(MR_mktag(0), Var_9, 1) = ((MR_Box) (transform_hlds__term_constr_util__create_nonneg_constraints_2_f_0_2));
    MR_hl_field(MR_mktag(0), Var_9, 2) = ((MR_Box) ((MR_Integer) 1));
    MR_hl_field(MR_mktag(0), Var_9, 3) = ((MR_Box) (Var_10));
  }
  mercury__list__filter_3_p_0((MR_Word) (&transform_hlds__term_constr_util_scalar_common_1[1]), Var_9, SizeVars_7, &NonZeroSizeVars_8);
  Constraints_6 = mercury__list__map_2_f_0((MR_Word) (&transform_hlds__term_constr_util_scalar_common_1[1]), (MR_Word) (&libs__lp_rational__libs__lp_rational__type_ctor_info_constraint_0), (MR_Word) (&transform_hlds__term_constr_util_scalar_common_2[5]), NonZeroSizeVars_8);
  return Constraints_6;
}
  ...
  MR_Word VarTypes_7)
{
  ...
  ZeroProgVars_10 = mercury__list__filter_2_f_0((MR_Word) (&transform_hlds__term_constr_util_scalar_common_1[0]), Var_12, ProgVars_9);
  {
    ...
    MR_hl_field(MR_mktag(0), Var_15, 0) = ((MR_Box) (&transform_hlds__term_constr_util_scalar_common_4[1]));
    MR_hl_field(MR_mktag(0), Var_15, 1) = ((MR_Box) (transform_hlds__term_constr_util__find_zero_size_vars_3_f_0_2));
    MR_hl_field(MR_mktag(0), Var_15, 2) = ((MR_Box) ((MR_Integer) 1));
    MR_hl_field(MR_mktag(0), Var_15, 3) = ((MR_Box) (SizeVarMap_6));
  }
