...
MR_decl_label1(transform_hlds__term_constr_util__IntroducedFrom__pred__write_size_vars__408__1_4_0, 2)
...
MR_decl_label8(transform_hlds__term_constr_util__change_procs_constr_arg_size_info_5_0, 31,3,4,5,11,8,13,14)
MR_decl_label2(transform_hlds__term_constr_util__change_procs_constr_arg_size_info_5_0, 15,7)
MR_decl_label8(transform_hlds__term_constr_util__change_procs_constr_termination_info_5_0, 31,3,4,5,11,8,13,14)
MR_decl_label2(transform_hlds__term_constr_util__change_procs_constr_termination_info_5_0, 15,7)
...
MR_decl_label5(transform_hlds__term_constr_util__dump_size_varset_2_4_0, 12,4,5,6,14)
...
MR_decl_label4(transform_hlds__term_constr_util__maybe_write_trace_4_0, 2,5,6,3)
MR_decl_label8(transform_hlds__term_constr_util__set_pred_proc_ids_constr_arg_size_info_4_0, 20,3,4,5,6,7,8,9)
MR_decl_label5(transform_hlds__term_constr_util__set_pred_proc_ids_constr_arg_size_info_4_0, 10,11,12,13,14)
...
MR_decl_label7(fn__transform_hlds__term_constr_util__make_arg_constraints_2_0, 23,4,6,5,8,9,10)
...
MR_decl_static(transform_hlds__term_constr_util__IntroducedFrom__pred__write_size_vars__408__1_4_0)
...
MR_BEGIN_MODULE(transform_hlds__term_constr_util_module0)
	...
	MR_init_label8(transform_hlds__term_constr_util__set_pred_proc_ids_constr_arg_size_info_4_0,20,3,4,5,6,7,8,9)
	MR_init_label5(transform_hlds__term_constr_util__set_pred_proc_ids_constr_arg_size_info_4_0,10,11,12,13,14)
MR_BEGIN_CODE
...
MR_def_label(transform_hlds__term_constr_util__set_pred_proc_ids_constr_arg_size_info_4_0,20)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_def_label(transform_hlds__term_constr_util__set_pred_proc_ids_constr_arg_size_info_4_0,14)
	...
	MR_GOTO_LAB(transform_hlds__term_constr_util__set_pred_proc_ids_constr_arg_size_info_4_0_i20);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
...
MR_BEGIN_MODULE(transform_hlds__term_constr_util_module12)
	...
	MR_init_label7(fn__transform_hlds__term_constr_util__make_arg_constraints_2_0,23,4,6,5,8,9,10)
MR_BEGIN_CODE
...
MR_define_entry(mercury__fn__transform_hlds__term_constr_util__make_arg_constraints_2_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
		MR_GOTO_LAB(fn__transform_hlds__term_constr_util__make_arg_constraints_2_0_i23);
	}
	MR_r1 = (MR_Word) MR_tbmkword(0, 0);
	MR_proceed();
MR_def_label(fn__transform_hlds__term_constr_util__make_arg_constraints_2_0,23)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(3);
	MR_sv(3) = (MR_Word) MR_succip;
	MR_sv(1) = MR_r2;
...
MR_BEGIN_MODULE(transform_hlds__term_constr_util_module16)
	...
	MR_init_label4(transform_hlds__term_constr_util__maybe_write_trace_4_0,2,5,6,3)
MR_BEGIN_CODE
...
MR_def_label(transform_hlds__term_constr_util__maybe_write_trace_4_0,5)
	...
	if (MR_INT_EQ(MR_sv(2),0)) {
		MR_GOTO_LAB(transform_hlds__term_constr_util__maybe_write_trace_4_0_i6);
	}
	MR_np_call_localret_ent(io__nl_2_0,
		transform_hlds__term_constr_util__maybe_write_trace_4_0_i6);
MR_def_label(transform_hlds__term_constr_util__maybe_write_trace_4_0,6)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_succip_word = MR_sv(3);
	MR_decr_sp(3);
...
MR_define_entry(mercury__transform_hlds__term_constr_util__write_size_vars_4_0);
	...
	MR_tfield(0, MR_tempr1, 1) = (MR_Word) MR_ENTRY_AP(transform_hlds__term_constr_util__IntroducedFrom__pred__write_size_vars__408__1_4_0);
	MR_tfield(0, MR_tempr1, 2) = (MR_Integer) 1;
	MR_tfield(0, MR_tempr1, 3) = MR_r1;
	MR_sv(1) = MR_r2;
	MR_r1 = (MR_Integer) 91;
...
MR_BEGIN_MODULE(transform_hlds__term_constr_util_module24)
	...
	MR_init_label5(transform_hlds__term_constr_util__dump_size_varset_2_4_0,12,4,5,6,14)
MR_BEGIN_CODE
...
MR_def_static(transform_hlds__term_constr_util__dump_size_varset_2_4_0)
	...
	MR_incr_sp(4);
	MR_sv(4) = (MR_Word) MR_succip;
MR_def_label(transform_hlds__term_constr_util__dump_size_varset_2_4_0,12)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TEST(MR_r1,0,0)) {
		MR_GOTO_LAB(transform_hlds__term_constr_util__dump_size_varset_2_4_0_i14);
	}
	MR_sv(1) = MR_r2;
	{
	MR_Word MR_tempr1;
...
MR_def_label(transform_hlds__term_constr_util__dump_size_varset_2_4_0,6)
	...
	MR_r2 = MR_sv(1);
	MR_succip_word = MR_sv(4);
	MR_GOTO_LAB(transform_hlds__term_constr_util__dump_size_varset_2_4_0_i12);
MR_def_label(transform_hlds__term_constr_util__dump_size_varset_2_4_0,14)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(4);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
...
MR_BEGIN_MODULE(transform_hlds__term_constr_util_module28)
	...
	MR_init_label8(transform_hlds__term_constr_util__change_procs_constr_termination_info_5_0,31,3,4,5,11,8,13,14)
	MR_init_label2(transform_hlds__term_constr_util__change_procs_constr_termination_info_5_0,15,7)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(transform_hlds__term_constr_util_module29)
	...
	MR_init_label8(transform_hlds__term_constr_util__change_procs_constr_arg_size_info_5_0,31,3,4,5,11,8,13,14)
	MR_init_label2(transform_hlds__term_constr_util__change_procs_constr_arg_size_info_5_0,15,7)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(transform_hlds__term_constr_util_module36)
	MR_init_entry1(transform_hlds__term_constr_util__IntroducedFrom__pred__write_size_vars__408__1_4_0);
	MR_init_label1(transform_hlds__term_constr_util__IntroducedFrom__pred__write_size_vars__408__1_4_0,2)
MR_BEGIN_CODE
	...
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(transform_hlds__term_constr_util__IntroducedFrom__pred__write_size_vars__408__1_4_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(1);
	MR_sv(1) = (MR_Word) MR_succip;
	MR_r3 = MR_r2;
	...
	MR_np_call_localret_ent(varset__lookup_name_3_0,
		transform_hlds__term_constr_util__IntroducedFrom__pred__write_size_vars__408__1_4_0_i2);
MR_def_label(transform_hlds__term_constr_util__IntroducedFrom__pred__write_size_vars__408__1_4_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_succip_word = MR_sv(1);
	MR_decr_sp(1);
