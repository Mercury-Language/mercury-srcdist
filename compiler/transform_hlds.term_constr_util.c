  ...
  MR_Word * STATE_VARIABLE_Subst_4)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      {
        MR_Word TypeInfo_29_29 = (MR_Word) &transform_hlds__term_constr_util_scalar_common_1[1];
        MR_Word HeadVar_22 = ((MR_Word) (MR_hl_field(MR_mktag(1), HeadVar__2_2, (MR_Integer) 0)));
        MR_Word HeadVars_23 = ((MR_Word) (MR_hl_field(MR_mktag(1), HeadVar__2_2, (MR_Integer) 1)));
        MR_Word STATE_VARIABLE_Subst_27_27;
        MR_Word next_value_of_HeadVar__1_1;
        MR_Word next_value_of_HeadVar__2_2;
        MR_Word next_value_of_STATE_VARIABLE_Subst_0_3;

        mercury__map__det_insert_4_p_0(TypeInfo_29_29, TypeInfo_29_29, ((MR_Box) (HeadVar_22)), ((MR_Box) (Var_31)), STATE_VARIABLE_Subst_0_3, &STATE_VARIABLE_Subst_27_27);
        // direct tailcall eliminated
