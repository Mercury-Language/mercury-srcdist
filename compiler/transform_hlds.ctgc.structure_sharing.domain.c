...
{
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        succeeded = ((MR_tag((MR_Word) *LambdaHeadVar__2_40)) == (MR_Integer) 1);
        if (succeeded)
        {
        }
      }
    ...
    else
    {
      ...
      if (!(succeeded))
      {
        ...
        if (!(succeeded))
        {
          ...
          succeeded = ((MR_tag((MR_Word) Origin_34)) == (MR_Integer) 0);
          if (succeeded)
          {
          }
        }
...
{
  {
    ...
    succeeded = ((MR_tag((MR_Word) UserSharing_45)) == (MR_Integer) 1);
    if (succeeded)
    {
    ...
    else
    {
      ...
      if (!(succeeded))
      {
        ...
        if (!(succeeded))
        {
          ...
          succeeded = ((MR_tag((MR_Word) Origin_57)) == (MR_Integer) 0);
          if (succeeded)
          {
          }
        }
...
{
  {
...

    {
      ...
      succeeded = ((MR_tag((MR_Word) Origin_7)) == (MR_Integer) 0);
      if (succeeded)
      {
      }
    }
