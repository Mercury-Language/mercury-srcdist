  ...
  MR_Word * LambdaHeadVar__3_35)
{
  ...
  if (succeeded)
  {
    ...
    hlds__vartypes__lookup_var_type_3_p_0(VarTypes_58, Var_54, &VarType_59);
  ...
  MR_Word * LambdaHeadVar__3_35)
{
  ...
  hlds__vartypes__lookup_var_type_3_p_0(VarTypes_24, LambdaHeadVar__1_33, &Type_27);
  ...
  MR_Word SharingSet_9)
{
  ...
  if (succeeded)
  {
    ...
    hlds__vartypes__lookup_var_type_3_p_0(VarTypes_17, Var_13, &VarType_18);
  ...
  MR_Word Var_4)
{
  ...
  hlds__vartypes__lookup_var_type_3_p_0(VarTypes_6, Var_4, &Type_7);
  ...
  MR_Word * STATE_VARIABLE_Sharing_29)
{
  ...
  hlds__vartypes__lookup_var_types_3_p_0(VarTypes_23, ActualVars_16, &ActualTypes_24);
    ...
    case (MR_Integer) 1:
      {
        ...
        if (succeeded)
        {
          ...
          hlds__vartypes__lookup_var_type_3_p_0(VarTypes_27, Var_23, &VarType_28);
  ...
  MR_Word * NewSharing_18)
{
  ...
  hlds__vartypes__lookup_var_types_3_p_0(VarTypes_22, ActualVars_20, &ActualTypes_23);
  ...
  MR_Word ProcInfo_6)
{
  ...
  if (!(succeeded))
  {
    ...
    hlds__vartypes__lookup_var_types_3_p_0(VarTypes_13, HeadVars_10, &Types_14);
  ...
  MR_Word * STATE_VARIABLE_SharingSet_18)
{
  ...
  else
  {
    ...
    hlds__vartypes__lookup_var_type_3_p_0(VarTypes_39, Var1_32, &Type1_36);
    hlds__vartypes__lookup_var_type_3_p_0(VarTypes_39, Var2_34, &Type2_37);
  ...
  MR_Word SharingPair_8)
{
  ...
  (env).transform_hlds__ctgc__structure_sharing__domain__sharing_set_subsumes_sharing_pair_4_p_0_env_0__ModuleInfo_5 = ModuleInfo_5;
  {
    ...
    hlds__vartypes__lookup_var_type_3_p_0(VarTypes_20, Var1_13, &(env).transform_hlds__ctgc__structure_sharing__domain__sharing_set_subsumes_sharing_pair_4_p_0_env_0__Type1_17);
    hlds__vartypes__lookup_var_type_3_p_0(VarTypes_20, (env).transform_hlds__ctgc__structure_sharing__domain__sharing_set_subsumes_sharing_pair_4_p_0_env_0__Var2_15, &(env).transform_hlds__ctgc__structure_sharing__domain__sharing_set_subsumes_sharing_pair_4_p_0_env_0__Type2_18);
