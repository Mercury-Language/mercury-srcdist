...
{
  {
    ...
    if (succeeded)
    {
      ...
      packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Var_20, (MR_Integer) 1)));
    ...
    else
    {
      ...
      if (!(succeeded))
      {
        ...
        if (!(succeeded))
        {
          ...
          if (succeeded)
            packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Origin_34, (MR_Integer) 0)));
        }
      }
      if (succeeded)
      {
...
{
  {
    ...
    MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), SharingAs_Status1_7, (MR_Integer) 1)));
    MR_Unsigned packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), SharingAs_Status2_8, (MR_Integer) 1)));
    ...
    else
    {
      ...
      if (!(succeeded))
      {
        ...
        if (!(succeeded))
        {
          ...
          if (succeeded)
            packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Origin_57, (MR_Integer) 0)));
        }
      }
      if (succeeded)
...
{
  {
...

    {
      ...
      if (succeeded)
        packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Origin_7, (MR_Integer) 0)));
    }
    if (!(succeeded))
    {
      MR_Word HeadVars_10;
...
{
  {
    ...
    if (succeeded)
    {
      packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Unification_9, (MR_Integer) 5)));
      {
        MR_Word HeadVars_26;
