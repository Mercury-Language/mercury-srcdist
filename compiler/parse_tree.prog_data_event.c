  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          TypeInfo__15_15 = (MR_Word) (&parse_tree__prog_data_event_scalar_common_2[4]);
          succeeded = mercury__builtin__unify_2_p_0(TypeInfo__15_15, ((MR_Box) (ArgX4_9)), ((MR_Box) (ArgY4_10)));
          if (succeeded)
          {
            TypeInfo__16_16 = (MR_Word) (&parse_tree__prog_data_event_scalar_common_2[1]);
            succeeded = mercury__builtin__unify_2_p_0(TypeInfo__16_16, ((MR_Box) (ArgX5_11)), ((MR_Box) (ArgY5_12)));
          }
        }
      }
    }
  ...
  MR_Word HeadVar__2_2)
{
  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        TypeInfo__13_13 = (MR_Word) (&parse_tree__prog_data_event_scalar_common_2[3]);
  ...
  MR_Word HeadVar__2_2)
{
  ...
  else
  {
    ...
    if (succeeded)
    {
      TypeInfo__9_9 = (MR_Word) (&parse_tree__prog_data_event_scalar_common_1[1]);
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            TypeInfo__17_17 = (MR_Word) (&parse_tree__prog_data_event_scalar_common_2[2]);
  ...
  MR_Word HeadVar__2_2)
{
  ...
  else
  {
    ...
    if (succeeded)
    {
      TypeInfo__12_12 = (MR_Word) (&parse_tree__prog_data_event_scalar_common_2[0]);
      succeeded = mercury__builtin__unify_2_p_0(TypeInfo__12_12, ((MR_Box) (ArgX2_5)), ((MR_Box) (ArgY2_6)));
      if (succeeded)
      {
        TypeInfo__13_13 = (MR_Word) (&parse_tree__prog_data_event_scalar_common_2[1]);
        succeeded = mercury__builtin__unify_2_p_0(TypeInfo__13_13, ((MR_Box) (ArgX3_7)), ((MR_Box) (ArgY3_8)));
      }
    }
  }
