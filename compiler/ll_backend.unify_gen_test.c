...
{
  {
    ...
    switch (MR_tag((MR_Word) ConsTag_7)) {
      ...
      case (MR_Integer) 1:
        {
          MR_String String_13 = ((MR_String) ((MR_hl_field(MR_mktag(1), ConsTag_7, (MR_Integer) 0))));
          MR_Word Var_119;
          MR_Word Var_120;

          {
            Var_120 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(3), Var_120, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 10));
            MR_hl_field(MR_mktag(3), Var_120, 1) = ((MR_Box) (String_13));
          }
          {
      ...
      case (MR_Integer) 2:
        {
...

          {
            ...
            MR_hl_field(MR_mktag(3), Var_123, 1) = MR_box_float(Float_12);
          }
          {
          ...
          }
          {
            ...
            *TestRval_8 = base;
            ...
            MR_hl_field(MR_mktag(3), base, 2) = ((MR_Box) (VarRval_6));
            MR_hl_field(MR_mktag(3), base, 3) = ((MR_Box) (Var_122));
          }
        }
        break;
      case (MR_Integer) 3:
        switch (((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), ConsTag_7, (MR_Integer) 0)))) {
          ...
          case (MR_Integer) 0:
            {
              MR_Word IntTag_9 = ((MR_Word) ((MR_hl_field(MR_mktag(3), ConsTag_7, (MR_Integer) 1))));
              MR_Word Const_10;
              MR_Word IntType_11;
              MR_Word Var_124;
              MR_Word Var_125;
              ...
              ll_backend__unify_gen_util__int_tag_to_const_and_int_type_3_p_0(IntTag_9, &Const_10, &IntType_11);
              {
                ...
                MR_hl_field(MR_mktag(3), Var_124, 1) = ((MR_Box) (IntType_11));
              }
              {
                ...
                MR_hl_field(MR_mktag(3), Var_125, 1) = ((MR_Box) (Const_10));
              }
              {
                MR_Word base;
                base = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL));
                *TestRval_8 = base;
                ...
                MR_hl_field(MR_mktag(3), base, 2) = ((MR_Box) (VarRval_6));
                MR_hl_field(MR_mktag(3), base, 3) = ((MR_Box) (Var_125));
              }
            }
            break;
          case (MR_Integer) 1:
            {
...

              {
                ...
                MR_hl_field(MR_mktag(0), Var_108, 1) = ((MR_Box) (ll_backend__unify_gen_test__generate_test_rval_has_cons_tag_4_p_0_1));
              ...
              mercury__require__expect_3_p_0(Var_108, (MR_String) "predicate \140ll_backend.unify_gen_test.generate_test_rval_has_cons_tag\'/4", (MR_String) "foreign tag for language other than C");
              {
          ...
          case (MR_Integer) 11:
            {
...

              {
                ...
                MR_hl_field(MR_mktag(3), VarPtag_158, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 3));
                MR_hl_field(MR_mktag(3), VarPtag_158, 1) = ((MR_Box) ((MR_Unsigned) 0U));
                MR_hl_field(MR_mktag(3), VarPtag_158, 2) = ((MR_Box) (VarRval_6));
              }
          ...
          case (MR_Integer) 12:
            {
              ...
              }
              {
                ...
                MR_hl_field(MR_mktag(3), PtagConstRval_19, 1) = ((MR_Box) (Var_103));
              }
              {
                MR_Word base;
                base = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL));
          ...
          case (MR_Integer) 13:
            {
              ...
              MR_Word Var_62;
              MR_Integer Var_63;
              MR_Word LocalSectag_145 = ((MR_Word) ((MR_hl_field(MR_mktag(3), ConsTag_7, (MR_Integer) 2))));
              MR_Unsigned PrimSec_147 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), LocalSectag_145, (MR_Integer) 1))));
              MR_Word SectagBits_148 = ((MR_Word) ((MR_hl_field(MR_mktag(0), LocalSectag_145, (MR_Integer) 2))));
              MR_Word ConstPrimSecRval_149;

              Var_63 = mercury__uint__cast_to_int_1_f_0(PrimSec_147);
              {
              ...
              {
                ConstPrimSecRval_149 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), ConstPrimSecRval_149, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 1));
                MR_hl_field(MR_mktag(3), ConstPrimSecRval_149, 1) = ((MR_Box) (Var_62));
              }
              switch (MustMask_40) {
                default: /*NOTREACHED*/ MR_assert(0);
                case (MR_Integer) 0:
                  {
                    {
                      ...
                      *TestRval_8 = base;
                      ...
                      MR_hl_field(MR_mktag(3), base, 1) = ((MR_Box) (MR_mkword(MR_mktag(3), &ll_backend__unify_gen_test_scalar_common_1[0])));
                      MR_hl_field(MR_mktag(3), base, 2) = ((MR_Box) (VarRval_6));
                      MR_hl_field(MR_mktag(3), base, 3) = ((MR_Box) (ConstPrimSecRval_149));
                    }
                  }
                  break;
                case (MR_Integer) 1:
                  {
                    ...
                    MR_Word Var_70;
                    MR_Word Var_71;
                    uint8_t NumPtagBits_132;
                    uint8_t NumSectagBits_133;
                    MR_Integer NumPtagSectagBits_135;
                    MR_Unsigned PrimSecMask_136;
                    MR_Word MaskedVarRval_137;

                    ll_backend__code_info__get_num_ptag_bits_2_p_0(CI_5, &NumPtagBits_132);
                    NumSectagBits_133 = ((uint8_t) (MR_Word) (MR_hl_field(MR_mktag(0), SectagBits_148, (MR_Integer) 0)));
                    Var_64 = (NumPtagBits_132 + NumSectagBits_133);
                    NumPtagSectagBits_135 = mercury__uint8__cast_to_int_1_f_0(Var_64);
                    Var_65 = mercury__uint__f_60_60_2_f_0((MR_Unsigned) 1U, NumPtagSectagBits_135);
                    PrimSecMask_136 = (Var_65 - (MR_Unsigned) 1U);
                    {
                      Var_71 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
                      MR_hl_field(MR_mktag(2), Var_71, 0) = ((MR_Box) (PrimSecMask_136));
                    }
                    {
                    ...
                    {
                      MaskedVarRval_137 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL));
                      MR_hl_field(MR_mktag(3), MaskedVarRval_137, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 4));
                      MR_hl_field(MR_mktag(3), MaskedVarRval_137, 1) = ((MR_Box) (MR_mkword(MR_mktag(3), &ll_backend__unify_gen_test_scalar_common_1[2])));
                      MR_hl_field(MR_mktag(3), MaskedVarRval_137, 2) = ((MR_Box) (VarRval_6));
                      MR_hl_field(MR_mktag(3), MaskedVarRval_137, 3) = ((MR_Box) (Var_70));
                    }
                    {
                      MR_Word base;
                      base = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL));
                      *TestRval_8 = base;
                      ...
                      MR_hl_field(MR_mktag(3), base, 2) = ((MR_Box) (MaskedVarRval_137));
                      MR_hl_field(MR_mktag(3), base, 3) = ((MR_Box) (ConstPrimSecRval_149));
                    }
                  }
                  break;
          ...
          case (MR_Integer) 14:
            {
              MR_Word LocalSectag_29 = ((MR_Word) ((MR_hl_field(MR_mktag(3), ConsTag_7, (MR_Integer) 2))));
              MR_Unsigned PrimSec_31 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), LocalSectag_29, (MR_Integer) 1))));
              MR_Word SectagBits_32 = ((MR_Word) ((MR_hl_field(MR_mktag(0), LocalSectag_29, (MR_Integer) 2))));
              MR_Word ConstPrimSecRval_33;
              uint8_t NumPtagBits_34;
              uint8_t NumSectagBits_35;
              MR_Integer NumPtagSectagBits_37;
              MR_Unsigned PrimSecMask_38;
              MR_Word MaskedVarRval_39;
              MR_Word Var_76;
              uint8_t Var_77;
              MR_Unsigned Var_78;
              MR_Word Var_83;
...

              {
                ...
                MR_hl_field(MR_mktag(2), Var_76, 0) = ((MR_Box) (PrimSec_31));
              }
              {
                ConstPrimSecRval_33 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), ConstPrimSecRval_33, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 1));
                MR_hl_field(MR_mktag(3), ConstPrimSecRval_33, 1) = ((MR_Box) (Var_76));
              }
              ...
              Var_77 = (NumPtagBits_34 + NumSectagBits_35);
              NumPtagSectagBits_37 = mercury__uint8__cast_to_int_1_f_0(Var_77);
              Var_78 = mercury__uint__f_60_60_2_f_0((MR_Unsigned) 1U, NumPtagSectagBits_37);
              PrimSecMask_38 = (Var_78 - (MR_Unsigned) 1U);
              {
                Var_84 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(2), Var_84, 0) = ((MR_Box) (PrimSecMask_38));
              }
              {
              ...
              {
                MaskedVarRval_39 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), MaskedVarRval_39, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 4));
                MR_hl_field(MR_mktag(3), MaskedVarRval_39, 1) = ((MR_Box) (MR_mkword(MR_mktag(3), &ll_backend__unify_gen_test_scalar_common_1[2])));
                MR_hl_field(MR_mktag(3), MaskedVarRval_39, 2) = ((MR_Box) (VarRval_6));
                MR_hl_field(MR_mktag(3), MaskedVarRval_39, 3) = ((MR_Box) (Var_83));
              }
              {
                MR_Word base;
                base = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL));
                *TestRval_8 = base;
                MR_hl_field(MR_mktag(3), base, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 4));
                MR_hl_field(MR_mktag(3), base, 1) = ((MR_Box) (MR_mkword(MR_mktag(3), &ll_backend__unify_gen_test_scalar_common_1[3])));
                MR_hl_field(MR_mktag(3), base, 2) = ((MR_Box) (MaskedVarRval_39));
                MR_hl_field(MR_mktag(3), base, 3) = ((MR_Box) (ConstPrimSecRval_33));
              }
            }
            break;
          case (MR_Integer) 15:
            {
...

              {
                ...
                MR_hl_field(MR_mktag(3), VarPtag_127, 2) = ((MR_Box) (VarRval_6));
              }
              ...
              }
              {
                ...
                MR_hl_field(MR_mktag(3), ConstPtagRval_21, 1) = ((MR_Box) (Var_88));
              }
              Var_90 = (MR_Word) (MR_mkword(MR_mktag(3), &ll_backend__unify_gen_test_scalar_common_1[0]));
              {
                ...
                MR_hl_field(MR_mktag(3), PtagTestRval_22, 1) = ((MR_Box) (Var_90));
                MR_hl_field(MR_mktag(3), PtagTestRval_22, 2) = ((MR_Box) (VarPtag_127));
              ...
              }
              {
                ...
                MR_hl_field(MR_mktag(3), Var_92, 2) = ((MR_Box) (VarRval_6));
                MR_hl_field(MR_mktag(3), Var_92, 3) = ((MR_Box) (MR_mkword(MR_mktag(3), &ll_backend__unify_gen_test_scalar_common_1[4])));
              }
              {
                VarSectagRval_23 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL);
                MR_hl_field(MR_mktag(0), VarSectagRval_23, 0) = ((MR_Box) (Var_92));
              }
              SecTagUint_24 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), RemoteSectag_20, (MR_Integer) 0))));
              Var_98 = mercury__uint__cast_to_int_1_f_0(SecTagUint_24);
              {
              ...
              }
              {
                ...
                MR_hl_field(MR_mktag(3), ConstSectagRval_26, 1) = ((MR_Box) (Var_97));
              }
              {
                ...
                MR_hl_field(MR_mktag(3), SectagTestRval_27, 1) = ((MR_Box) (Var_90));
