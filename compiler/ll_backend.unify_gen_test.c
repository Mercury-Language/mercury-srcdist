...
ll_backend__unify_gen_test__IntroducedFrom__pred__generate_test_rval_has_cons_tag__198__1_2_p_0(
  ...
  MR_Word HeadVar__2_76)
{
  MR_bool succeeded = (ForeignLang_14 == HeadVar__2_76);
    ...
    case (MR_Integer) 1:
      {
        ...
        }
        {
          ...
          *TestRval_8 = base;
          ...
          MR_hl_field(3, base, 3) = ((MR_Box) (Var_66));
        }
      }
      break;
    case (MR_Integer) 2:
      {
...

        {
          ...
          MR_hl_field(3, Var_69, 1) = MR_box_float(Float_12);
        }
        {
        ...
        case (MR_Integer) 0:
          {
...

            {
              ...
              MR_hl_field(3, Var_72, 1) = ((MR_Box) (String_13));
            }
            {
        ...
        case (MR_Integer) 1:
          {
...

            {
              ...
              MR_hl_field(0, Var_73, 0) = ((MR_Box) (&ll_backend__unify_gen_test_scalar_common_3[0]));
              MR_hl_field(0, Var_73, 1) = ((MR_Box) (ll_backend__unify_gen_test__generate_test_rval_has_cons_tag_4_p_0_1));
              MR_hl_field(0, Var_73, 2) = ((MR_Box) ((MR_Integer) 2));
              MR_hl_field(0, Var_73, 3) = ((MR_Box) (ForeignLang_14));
              MR_hl_field(0, Var_73, 4) = ((MR_Box) ((MR_Integer) 0));
            }
            mercury__require__expect_3_p_0(Var_73, (MR_String) "predicate \140ll_backend.unify_gen_test.generate_test_rval_has_cons_tag\'/4", (MR_String) "foreign tag for language other than C");
            {
              Var_80 = (MR_Word) MR_mkword(3, MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(3, Var_80, 0) = ((MR_Box) ((MR_Unsigned) 8U));
              MR_hl_field(3, Var_80, 1) = ((MR_Box) (ForeignVal_15));
              MR_hl_field(3, Var_80, 2) = ((MR_Box) (MR_mkword(2, &ll_backend__unify_gen_test_scalar_common_2[0])));
            }
            {
            ...
            }
            {
              ...
              *TestRval_8 = base;
              ...
              MR_hl_field(3, base, 2) = ((MR_Box) (VarRval_6));
              MR_hl_field(3, base, 3) = ((MR_Box) (Var_79));
            }
          }
          break;
        case (MR_Integer) 2:
          {
            ...
            MR_Word Var_128;
            MR_Integer Var_129;
            MR_Word SectagBits_177;
            MR_Word LocalSectag_179 = ((MR_Word) ((MR_hl_field(3, ConsTag_7, (MR_Integer) 2))));
            MR_Unsigned PrimSec_181 = ((MR_Unsigned) ((MR_hl_field(0, LocalSectag_179, (MR_Integer) 1))));
            MR_Word ConstPrimSecRval_182;

            SectagBits_177 = ((MR_Word) ((MR_hl_field(0, LocalSectag_179, (MR_Integer) 2))));
            Var_129 = mercury__uint__cast_to_int_1_f_0(PrimSec_181);
            {
              Var_128 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(1, Var_128, 0) = ((MR_Box) (Var_129));
            }
            {
              ConstPrimSecRval_182 = (MR_Word) MR_mkword(3, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(3, ConstPrimSecRval_182, 0) = ((MR_Box) ((MR_Unsigned) 1U));
              MR_hl_field(3, ConstPrimSecRval_182, 1) = ((MR_Box) (Var_128));
            }
            switch (MustMask_46) {
              default: /*NOTREACHED*/ MR_assert(0);
              case (MR_Integer) 0:
                {
                  ...
                  *TestRval_8 = base;
                  ...
                  MR_hl_field(3, base, 1) = ((MR_Box) (MR_mkword(3, &ll_backend__unify_gen_test_scalar_common_1[0])));
                  MR_hl_field(3, base, 2) = ((MR_Box) (VarRval_6));
                  MR_hl_field(3, base, 3) = ((MR_Box) (ConstPrimSecRval_182));
                }
                break;
              case (MR_Integer) 1:
                {
                  ...
                  MR_Word Var_138;
                  MR_Word Var_139;
                  uint8_t NumPtagBits_165;
                  uint8_t NumSectagBits_166;
                  MR_Integer NumPtagSectagBits_168;
                  MR_Unsigned PrimSecMask_169;
                  MR_Word MaskedVarRval_170;

                  ll_backend__code_info__get_num_ptag_bits_2_p_0(CI_5, &NumPtagBits_165);
                  NumSectagBits_166 = ((uint8_t) (MR_Word) (MR_hl_field(0, SectagBits_177, (MR_Integer) 0)));
                  Var_132 = (NumPtagBits_165 + NumSectagBits_166);
                  NumPtagSectagBits_168 = mercury__uint8__cast_to_int_1_f_0(Var_132);
                  Var_133 = mercury__uint__f_60_60_2_f_0((MR_Unsigned) 1U, NumPtagSectagBits_168);
                  PrimSecMask_169 = (Var_133 - (MR_Unsigned) 1U);
                  {
                    Var_139 = (MR_Word) MR_mkword(2, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(2, Var_139, 0) = ((MR_Box) (PrimSecMask_169));
                  }
                  {
                  ...
                  {
                    MaskedVarRval_170 = (MR_Word) MR_mkword(3, MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(3, MaskedVarRval_170, 0) = ((MR_Box) ((MR_Unsigned) 4U));
                    MR_hl_field(3, MaskedVarRval_170, 1) = ((MR_Box) (MR_mkword(3, &ll_backend__unify_gen_test_scalar_common_1[2])));
                    MR_hl_field(3, MaskedVarRval_170, 2) = ((MR_Box) (VarRval_6));
                    MR_hl_field(3, MaskedVarRval_170, 3) = ((MR_Box) (Var_138));
                  }
                  {
                    MR_Word base;
                    base = (MR_Word) MR_mkword(3, MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL));
                    *TestRval_8 = base;
                    MR_hl_field(3, base, 0) = ((MR_Box) ((MR_Unsigned) 4U));
                    MR_hl_field(3, base, 1) = ((MR_Box) (MR_mkword(3, &ll_backend__unify_gen_test_scalar_common_1[3])));
                    MR_hl_field(3, base, 2) = ((MR_Box) (MaskedVarRval_170));
                    MR_hl_field(3, base, 3) = ((MR_Box) (ConstPrimSecRval_182));
                  }
                }
                break;
              ...
              case (MR_Integer) 1:
                {
                  MR_Word Var_91;
                  MR_Integer Var_92;
                  MR_Word Ptag_144 = ((MR_Word) ((MR_hl_field(1, RemoteArgsTagInfo_20, (MR_Integer) 0))));
                  MR_Word VarPtag_145;
                  uint8_t PtagUint8_146;
                  MR_Word PtagConstRval_147;

                  {
                    VarPtag_145 = (MR_Word) MR_mkword(3, MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(3, VarPtag_145, 0) = ((MR_Box) ((MR_Unsigned) 3U));
                    MR_hl_field(3, VarPtag_145, 1) = ((MR_Box) ((MR_Unsigned) 0U));
                    MR_hl_field(3, VarPtag_145, 2) = ((MR_Box) (VarRval_6));
                  }
                  PtagUint8_146 = (uint8_t) (Ptag_144);
                  Var_92 = mercury__uint8__cast_to_int_1_f_0(PtagUint8_146);
                  {
                    Var_91 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(1, Var_91, 0) = ((MR_Box) (Var_92));
                  }
                  {
                    PtagConstRval_147 = (MR_Word) MR_mkword(3, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(3, PtagConstRval_147, 0) = ((MR_Box) ((MR_Unsigned) 1U));
                    MR_hl_field(3, PtagConstRval_147, 1) = ((MR_Box) (Var_91));
                  }
                  {
                    MR_Word base;
                    base = (MR_Word) MR_mkword(3, MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL));
                    *TestRval_8 = base;
                    MR_hl_field(3, base, 0) = ((MR_Box) ((MR_Unsigned) 4U));
                    MR_hl_field(3, base, 1) = ((MR_Box) (MR_mkword(3, &ll_backend__unify_gen_test_scalar_common_1[0])));
                    MR_hl_field(3, base, 2) = ((MR_Box) (VarPtag_145));
                    MR_hl_field(3, base, 3) = ((MR_Box) (PtagConstRval_147));
                  }
                }
                break;
              case (MR_Integer) 2:
                {
                  ...
                  MR_Word Var_109;
                  MR_Integer Var_110;
                  MR_Word Ptag_148 = ((MR_Word) ((MR_hl_field(2, RemoteArgsTagInfo_20, (MR_Integer) 0))));
                  MR_Word VarPtag_149;
                  uint8_t PtagUint8_150;

                  {
                    VarPtag_149 = (MR_Word) MR_mkword(3, MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(3, VarPtag_149, 0) = ((MR_Box) ((MR_Unsigned) 3U));
                    MR_hl_field(3, VarPtag_149, 1) = ((MR_Box) ((MR_Unsigned) 0U));
                    MR_hl_field(3, VarPtag_149, 2) = ((MR_Box) (VarRval_6));
                  }
                  PtagUint8_150 = (uint8_t) (Ptag_148);
                  Var_97 = mercury__uint8__cast_to_int_1_f_0(PtagUint8_150);
                  {
                  ...
                  }
                  {
                    ...
                    MR_hl_field(3, ConstPtagRval_22, 1) = ((MR_Box) (Var_96));
                  }
                  {
                    ...
                    MR_hl_field(3, PtagTestRval_23, 2) = ((MR_Box) (VarPtag_149));
                  ...
                  }
                  {
                    ...
                    MR_hl_field(1, Var_101, 0) = ((MR_Box) (Ptag_148));
                  }
                  {
                    ...
                    MR_hl_field(3, Var_100, 2) = ((MR_Box) (VarRval_6));
                    MR_hl_field(3, Var_100, 3) = ((MR_Box) (MR_mkword(3, &ll_backend__unify_gen_test_scalar_common_1[4])));
                  }
                  {
                    VarSectagWordRval_24 = (MR_Word) MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL);
                    MR_hl_field(0, VarSectagWordRval_24, 0) = ((MR_Box) (Var_100));
                  }
                  ...
                  else
                  {
...

                    {
                      ...
                      MR_hl_field(2, Var_108, 0) = ((MR_Box) (SectagMask_30));
                    }
                    {
                    ...
                    }
                    {
                      ...
                      MR_hl_field(3, VarSectagRval_27, 1) = ((MR_Box) (MR_mkword(3, &ll_backend__unify_gen_test_scalar_common_1[2])));
                      MR_hl_field(3, VarSectagRval_27, 2) = ((MR_Box) (VarSectagWordRval_24));
                      MR_hl_field(3, VarSectagRval_27, 3) = ((MR_Box) (Var_107));
                    }
                  }
                  Var_110 = mercury__uint__cast_to_int_1_f_0(SecTagUint_25);
                  {
                  ...
                  }
                  {
                    ...
                    MR_hl_field(3, ConstSectagRval_31, 1) = ((MR_Box) (Var_109));
                  }
                  {
        ...
        case (MR_Integer) 12:
          {
            ...
            else
            {
              ...
              MR_Word Var_124;
              MR_Word Var_125;
              MR_Word SectagBits_159 = ((MR_Word) ((MR_hl_field(0, LocalSectag_36, (MR_Integer) 2))));

              {
                Var_117 = (MR_Word) MR_mkword(2, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(2, Var_117, 0) = ((MR_Box) (PrimSec_38));
              }
              {
                ...
                MR_hl_field(3, ConstPrimSecRval_39, 1) = ((MR_Box) (Var_117));
              }
              ll_backend__code_info__get_num_ptag_bits_2_p_0(CI_5, &NumPtagBits_40);
              NumSectagBits_41 = ((uint8_t) (MR_Word) (MR_hl_field(0, SectagBits_159, (MR_Integer) 0)));
              Var_118 = (NumPtagBits_40 + NumSectagBits_41);
              NumPtagSectagBits_43 = mercury__uint8__cast_to_int_1_f_0(Var_118);
              Var_119 = mercury__uint__f_60_60_2_f_0((MR_Unsigned) 1U, NumPtagSectagBits_43);
              PrimSecMask_44 = (Var_119 - (MR_Unsigned) 1U);
              {
                Var_125 = (MR_Word) MR_mkword(2, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(2, Var_125, 0) = ((MR_Box) (PrimSecMask_44));
              }
              {
              ...
              }
              {
                ...
                MR_hl_field(3, MaskedVarRval_45, 1) = ((MR_Box) (MR_mkword(3, &ll_backend__unify_gen_test_scalar_common_1[2])));
                MR_hl_field(3, MaskedVarRval_45, 2) = ((MR_Box) (VarRval_6));
                MR_hl_field(3, MaskedVarRval_45, 3) = ((MR_Box) (Var_124));
              }
              {
                MR_Word base;
                base = (MR_Word) MR_mkword(3, MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL));
        ...
        case (MR_Integer) 13:
          {
            ...
            Var_86 = mercury__uint8__cast_to_int_1_f_0(PtagUint8_18);
            {
            ...
            }
            {
              ...
              MR_hl_field(3, PtagConstRval_19, 1) = ((MR_Box) (Var_85));
            }
            {
              MR_Word base;
              base = (MR_Word) MR_mkword(3, MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL));
