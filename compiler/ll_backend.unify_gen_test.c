...
ll_backend__unify_gen_test__IntroducedFrom__pred__raw_tag_test__239__1_2_p_0(
...
{
  {
    ...
    succeeded = ll_backend__unify_gen_test__IntroducedFrom__pred__raw_tag_test__239__1_2_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))));
    return succeeded;
  }
}
...
void MR_CALL 
ll_backend__unify_gen_test__generate_simple_test_unification_7_p_0(
  MR_Word VarA_8,
  MR_Word VarB_9,
  MR_Word * Code_10,
            ...
            switch (MR_tag((MR_Word) BuiltinType_19)) {
              ...
              case (MR_Integer) 0:
                switch (MR_unmkbody(BuiltinType_19)) {
                  default: /*NOTREACHED*/ MR_assert(0);
                  case (MR_Integer) 0:
                    Op_20 = (MR_Word) ((MR_Unsigned) 64U);
                    break;
                  case (MR_Integer) 1:
                    Op_20 = (MR_Word) ((MR_Unsigned) 16U);
                    break;
                  case (MR_Integer) 2:
                    Op_20 = (MR_Word) (MR_mkword(MR_mktag(3), &ll_backend__unify_gen_test_scalar_common_1[0]));
                    break;
                }
                break;
              case (MR_Integer) 1:
