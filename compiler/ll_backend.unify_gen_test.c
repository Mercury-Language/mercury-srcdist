  ...
  MR_Word * STATE_VARIABLE_CI_21)
{
  ...
  switch (Sense_14) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 1:
      ll_backend__code_util__neg_rval_2_p_0(TestRval_40, &BranchRval_61);
      break;
    case (MR_Integer) 0:
      BranchRval_61 = TestRval_40;
      break;
  }
  {
    Var_65 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(MR_mktag(1), Var_65, 0) = ((MR_Box) (*ElseLabel_15));
  }
  {
    Var_64 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(MR_mktag(3), Var_64, 0) = ((MR_Box) ((MR_Unsigned) 9U));
    MR_hl_field(MR_mktag(3), Var_64, 1) = ((MR_Box) (BranchRval_61));
  ...
  }
  {
    ...
    MR_hl_field(MR_mktag(0), Var_63, 1) = ((MR_Box) (Comment_38));
  }
