  ...
  MR_Word * STATE_VARIABLE_CI_33)
{
  ...
  if ((OtherTaggedConsIds_14 == (MR_Word) ((MR_Unsigned) 0U)))
  {
    ...
    if (succeeded)
    {
      ExpensiveConsId_49 = ((MR_Word) ((MR_hl_field(1, CheaperTagTest_15, (MR_Integer) 0))));
    ...
    switch (Sense_16) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 1:
        ll_backend__code_util__negate_rval_2_p_0(TestRval_55, &BranchRval_67);
        break;
      case (MR_Integer) 0:
  ...
  else
  {
    ...
    MR_String Var_37;
    MR_String Var_38;
    MR_Word ConsTag_73 = ((MR_Word) ((MR_hl_field(0, MainTaggedConsId_13, (MR_Integer) 1))));
      ...
      case (MR_Integer) 1:
        {
          ...
          ll_backend__code_util__negate_rval_2_p_0(TestRval_26, &BranchRval_74);
        }
        break;
      case (MR_Integer) 0:
        {
    ...
    }
    {
      ...
      MR_hl_field(0, Var_75, 1) = ((MR_Box) (Comment_31));
    }
  ...
  MR_Word * STATE_VARIABLE_CI_21)
{
  ...
  if (succeeded)
  {
    ExpensiveConsId_23 = ((MR_Word) ((MR_hl_field(1, CheaperTagTest_13, (MR_Integer) 0))));
  ...
  switch (Sense_14) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 1:
      ll_backend__code_util__negate_rval_2_p_0(TestRval_29, &BranchRval_41);
      break;
    case (MR_Integer) 0:
  ...
  }
  {
    ...
    MR_hl_field(0, Var_42, 1) = ((MR_Box) (Comment_27));
  }
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = ll_backend__unify_gen_test__IntroducedFrom__pred__generate_test_rval_has_cons_tag__197__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 4)))));
  return succeeded;
}
