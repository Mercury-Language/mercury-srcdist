  ...
  MR_Word * STATE_VARIABLE_CI_33)
{
  ...
  if ((OtherTaggedConsIds_14 == (MR_Word) ((MR_Unsigned) 0U)))
  {
    ...
    MR_String ConsIdName_49;
    MR_String Comment_54;
    MR_Word TestRval_56;
    MR_Word BranchRval_68;
    MR_Word Var_69;
    MR_Word Var_70;
    MR_Word Var_71;
    MR_Word CheapConsTag_53;
    MR_Word ExpensiveConsId_50;

    ConsIdName_49 = parse_tree__prog_out__cons_id_and_arity_to_string_1_f_0(MainConsId_20);
    succeeded = (CheaperTagTest_15 != (MR_Word) ((MR_Unsigned) 0U));
    if (succeeded)
    {
      ExpensiveConsId_50 = ((MR_Word) ((MR_hl_field(MR_mktag(1), CheaperTagTest_15, (MR_Integer) 0))));
      CheapConsTag_53 = ((MR_Word) ((MR_hl_field(MR_mktag(1), CheaperTagTest_15, (MR_Integer) 3))));
      succeeded = parse_tree__prog_data____Unify____cons_id_0_0(MainConsId_20, ExpensiveConsId_50);
    }
    if (succeeded)
    {
      MR_Word NegTestRval_55;
      MR_String Var_57;
      MR_String Var_58;
      MR_String Var_59;
      MR_String Var_61;
      ...
      switch (Sense_16) {
        ...
        case (MR_Integer) 1:
          Var_57 = (MR_String) "branch away unless ";
          break;
        case (MR_Integer) 0:
          Var_57 = (MR_String) "branch away if ";
          break;
      }
      Var_61 = mercury__string__f_43_43_2_f_0(ConsIdName_49, (MR_String) " (inverted test)");
      Var_59 = mercury__string__f_43_43_2_f_0((MR_String) " has functor ", Var_61);
      Var_58 = mercury__string__f_43_43_2_f_0(VarName_12, Var_59);
      Comment_54 = mercury__string__f_43_43_2_f_0(Var_57, Var_58);
      ll_backend__unify_gen_test__generate_test_rval_has_cons_tag_4_p_0(STATE_VARIABLE_CI_0_32, VarRval_11, CheapConsTag_53, &NegTestRval_55);
      ll_backend__code_util__neg_rval_2_p_0(NegTestRval_55, &TestRval_56);
    }
    else
    {
      MR_String Var_63;
      ...
      switch (Sense_16) {
        default: /*NOTREACHED*/ MR_assert(0);
        case (MR_Integer) 1:
          Var_63 = (MR_String) "branch away unless ";
          break;
        case (MR_Integer) 0:
          Var_63 = (MR_String) "branch away if ";
          break;
      }
      Var_65 = mercury__string__f_43_43_2_f_0((MR_String) " has functor ", ConsIdName_49);
      Var_64 = mercury__string__f_43_43_2_f_0(VarName_12, Var_65);
      Comment_54 = mercury__string__f_43_43_2_f_0(Var_63, Var_64);
      ll_backend__unify_gen_test__generate_test_rval_has_cons_tag_4_p_0(STATE_VARIABLE_CI_0_32, VarRval_11, MainConsTag_21, &TestRval_56);
    }
    ll_backend__code_info__get_next_label_3_p_0(ElseLabel_17, STATE_VARIABLE_CI_0_32, STATE_VARIABLE_CI_33);
    switch (Sense_16) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 1:
        ll_backend__code_util__neg_rval_2_p_0(TestRval_56, &BranchRval_68);
        break;
      case (MR_Integer) 0:
        BranchRval_68 = TestRval_56;
        break;
    }
    {
      Var_71 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), Var_71, 0) = ((MR_Box) (*ElseLabel_17));
    }
    {
      ...
      MR_hl_field(MR_mktag(3), Var_70, 1) = ((MR_Box) (BranchRval_68));
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(0), Var_69, 1) = ((MR_Box) (Comment_54));
    }
  ...
  else
  {
    ...
    MR_String Var_36;
    MR_String Var_37;
    MR_Word ConsTag_74 = ((MR_Word) ((MR_hl_field(MR_mktag(0), MainTaggedConsId_13, (MR_Integer) 1))));
      ...
      case (MR_Integer) 1:
        {
          ...
          ll_backend__code_util__neg_rval_2_p_0(TestRval_26, &BranchRval_75);
        }
        break;
      case (MR_Integer) 0:
        {
    ...
    Comment_31 = mercury__string__f_43_43_2_f_0(Var_36, Var_37);
    {
      ...
      MR_hl_field(MR_mktag(1), Var_78, 0) = ((MR_Box) (*ElseLabel_17));
    }
    {
      ...
      MR_hl_field(MR_mktag(3), Var_77, 1) = ((MR_Box) (BranchRval_75));
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(0), Var_76, 1) = ((MR_Box) (Comment_31));
    }
        ...
        case (MR_Integer) 1:
          {
...

            {
              ...
              MR_hl_field(MR_mktag(0), Var_127, 0) = ((MR_Box) (&ll_backend__unify_gen_test_scalar_common_3[0]));
            ...
            mercury__require__expect_3_p_0(Var_127, (MR_String) "predicate \140ll_backend.unify_gen_test.generate_test_rval_has_cons_tag\'/4", (MR_String) "foreign tag for language other than C");
            {
              ...
              MR_hl_field(MR_mktag(3), Var_134, 2) = ((MR_Box) (MR_mkword(MR_mktag(2), &ll_backend__unify_gen_test_scalar_common_2[0])));
            }
            {
