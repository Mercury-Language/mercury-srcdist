  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      if (((MR_tag((MR_Word) FullTimeResult_38)) == (MR_Integer) 1))
      {
        ...
        parse_tree__module_cmds__make_symlink_or_copy_file_7_p_0(ProgressStream_11, Globals_12, FullFileName_15, CurDirFileName_16, &Succeeded0_21);
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        if (((MR_tag((MR_Word) FullTimeResult_46)) == (MR_Integer) 1))
        {
          ...
          parse_tree__module_cmds__make_symlink_or_copy_file_7_p_0(ProgressStream_11, Globals_12, FullLauncherName_25, CurDirLauncherName_27, Succeeded_17);
        }
        else
          *Succeeded_17 = (MR_Integer) 1;
      }
  ...
  MR_Word Globals_6)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_6, (MR_Integer) 134, &Stats_8);
