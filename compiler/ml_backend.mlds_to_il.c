...
MR_decl_label8(ml_backend__mlds_to_il__statement_to_il_4_0, 121,124,123,128,129,130,127,131)
...
MR_def_label(fn__ml_backend__mlds_to_il__il_mercury_string_hash_0_0,3)
	...
	MR_tfield(0, MR_r1, 2) = MR_tempr1;
	MR_tfield(0, MR_r1, 3) = (MR_Word) MR_TAG_COMMON(1,4,35);
	MR_decr_sp_and_return(2);
	}
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
...
MR_def_label(ml_backend__mlds_to_il__binaryop_to_il_4_0,38)
	...
	MR_tag_alloc_heap(MR_r1, 1, (MR_Integer) 2);
	MR_tfield(1, MR_r1, 0) = MR_tempr1;
	MR_tfield(1, MR_r1, 1) = (MR_Word) MR_TAG_COMMON(1,4,40);
	MR_tag_alloc_heap(MR_tempr2, 1, (MR_Integer) 1);
	MR_r2 = MR_tempr2;
	MR_tfield(1, MR_tempr2, 0) = MR_r1;
	MR_r1 = MR_tempr2;
...
MR_def_label(ml_backend__mlds_to_il__binaryop_to_il_4_0,40)
	...
	MR_tag_alloc_heap(MR_r1, 1, (MR_Integer) 2);
	MR_tfield(1, MR_r1, 0) = MR_tempr1;
	MR_tfield(1, MR_r1, 1) = (MR_Word) MR_TAG_COMMON(1,4,43);
	MR_tag_alloc_heap(MR_tempr2, 1, (MR_Integer) 1);
	MR_r2 = MR_tempr2;
	MR_tfield(1, MR_tempr2, 0) = MR_r1;
	MR_r1 = MR_tempr2;
...
MR_def_label(ml_backend__mlds_to_il__binaryop_to_il_4_0,44)
	...
	MR_tag_alloc_heap(MR_r1, 1, (MR_Integer) 2);
	MR_tfield(1, MR_r1, 0) = MR_tempr1;
	MR_tfield(1, MR_r1, 1) = (MR_Word) MR_TAG_COMMON(1,4,46);
	MR_tag_alloc_heap(MR_tempr2, 1, (MR_Integer) 1);
	MR_r2 = MR_tempr2;
	MR_tfield(1, MR_tempr2, 0) = MR_r1;
	MR_r1 = MR_tempr2;
...
MR_BEGIN_MODULE(ml_backend__mlds_to_il_module117)
	...
	MR_init_label8(ml_backend__mlds_to_il__statement_to_il_4_0,121,124,123,128,129,130,127,131)
...
MR_def_label(ml_backend__mlds_to_il__statement_to_il_4_0,123)
	...
	MR_tempr1 = MR_ctfield(1, MR_tempr2, 1);
	if (MR_LTAGS_TESTR(MR_tempr1,0,0)) {
		MR_GOTO_LAB(ml_backend__mlds_to_il__statement_to_il_4_0_i127);
	}
	MR_sv(12) = MR_ctfield(0, MR_r1, 1);
