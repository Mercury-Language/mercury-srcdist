...
MR_def_label(ml_backend__mlds_to_il__il_transform_mlds_2_0,11)
	...
	MR_tfield(0, MR_tempr1, 1) = (MR_Word) MR_ENTRY_AP(ml_backend__mlds_to_il__IntroducedFrom__pred__il_transform_mlds__381__1_1_0);
	MR_tfield(0, MR_tempr1, 2) = (MR_Integer) 1;
...
MR_def_label(fn__ml_backend__mlds_to_il__il_info_init_9_0,10)
	...
	MR_tfield(0, MR_tempr1, 24) = (MR_Word) MR_TAG_COMMON(0,2,3);
	MR_r1 = MR_tempr1;
...
MR_def_label(ml_backend__mlds_to_il__generate_il_5_0,6)
	...
	MR_tfield(0, MR_tempr1, 1) = (MR_Word) MR_ENTRY_AP(ml_backend__mlds_to_il__IntroducedFrom__pred__generate_il__266__1_1_0);
	MR_tfield(0, MR_tempr1, 2) = (MR_Integer) 1;
...
MR_def_label(ml_backend__mlds_to_il__data_addr_constant_to_fieldref_2_0,17)
	...
	MR_tag_alloc_heap(MR_tempr3, 0, (MR_Integer) 2);
	MR_r1 = MR_tempr3;
	MR_tfield(0, MR_tempr3, 0) = (MR_Word) MR_TAG_COMMON(0,4,12);
	MR_tfield(0, MR_tempr3, 1) = MR_tempr2;
	MR_decr_sp_and_return(7);
	}
#ifdef MR_maybe_local_thread_engine_base
...
MR_def_label(ml_backend__mlds_to_il__atomic_statement_to_il_4_0,63)
	...
	MR_Word MR_tempr1, MR_tempr2;
	MR_tag_alloc_heap(MR_tempr1, 0, (MR_Integer) 2);
	MR_tempr2 = MR_tfield(0, MR_tfield(1, MR_sv(5), 0), 2);
	MR_tfield(0, MR_tempr1, 0) = MR_tfield(0, MR_tempr2, 0);
	MR_tfield(0, MR_tempr1, 1) = MR_tfield(0, MR_tempr2, 1);
	MR_sv(3) = MR_r1;
	MR_r1 = MR_tempr1;
...
MR_def_label(ml_backend__mlds_to_il__atomic_statement_to_il_4_0,130)
	...
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_tfield(0, MR_sv(5), 24);
	MR_sv(3) = MR_tfield(0, MR_tempr1, 1);
...
MR_def_static(ml_backend__mlds_to_il__il_info_get_locals_list_2_0)
	...
	MR_tfield(0, MR_tempr1, 2) = (MR_Integer) 1;
	MR_tempr3 = MR_r1;
	MR_tfield(0, MR_tempr1, 3) = MR_tfield(0, MR_tempr3, 4);
...
MR_def_label(ml_backend__mlds_to_il__generate_method_6_0,116)
	...
	MR_tfield(0, MR_tempr1, 18) = MR_tfield(0, MR_tempr4, 18);
	MR_tfield(0, MR_tempr1, 19) = MR_tfield(0, MR_tempr4, 19);
	MR_tfield(0, MR_tempr1, 20) = MR_tfield(0, MR_tempr4, 20);
	MR_tfield(0, MR_tempr1, 21) = MR_tfield(0, MR_tempr4, 21);
	MR_tfield(0, MR_tempr1, 22) = MR_tfield(0, MR_tempr4, 22);
	MR_tfield(0, MR_tempr1, 23) = MR_tfield(0, MR_tempr4, 23);
	MR_tfield(0, MR_tempr1, 24) = MR_tfield(0, MR_tempr4, 24);
	MR_sv(3) = MR_r1;
...
MR_def_label(ml_backend__mlds_to_il__mlds_export_to_mlds_defn_2_0,21)
	...
	MR_tfield(0, MR_tempr1, 1) = MR_tfield(2, MR_tempr5, 1);
	MR_tag_alloc_heap(MR_tempr2, 0, (MR_Integer) 3);
...
MR_def_static(fn__ml_backend__mlds_to_il__IntroducedFrom__func__mlds_export_to_mlds_defn__1403__1_2_0)
	...
	MR_tfield(0, MR_tempr2, 0) = MR_r1;
	MR_tfield(0, MR_tempr2, 1) = (MR_Integer) 0;
	MR_tfield(0, MR_tempr2, 2) = MR_tfield(1, MR_tempr1, 0);
	MR_r1 = MR_tempr2;
	MR_proceed();
	}
