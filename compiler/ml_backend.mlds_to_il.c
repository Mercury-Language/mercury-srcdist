...
MR_def_label(ml_backend__mlds_to_il__atomic_statement_to_il_4_0,127)
	...
	MR_r1 = MR_r2;
	MR_sv(5) = MR_tempr1;
	MR_sv(6) = MR_tfield(0, MR_sv(1), 19);
	}
...
MR_def_label(ml_backend__mlds_to_il__atomic_statement_to_il_4_0,131)
	...
	MR_r1 = MR_tempr1;
	MR_sv(5) = MR_r2;
	MR_sv(6) = MR_tfield(0, MR_tempr2, 19);
	}
	MR_np_call_localret_ent(fn__ml_backend__mlds_to_il__il_method_params_to_il_types_1_0,
		ml_backend__mlds_to_il__atomic_statement_to_il_4_0_i133);
...
MR_def_label(ml_backend__mlds_to_il__statement_to_il_4_0,7)
	...
	MR_sv(7) = (((MR_Integer) MR_tfield(0, MR_r2, 5) >> (MR_Integer) 1) & (MR_Integer) 1);
	MR_sv(8) = (((MR_Integer) MR_tfield(0, MR_r2, 5) >> (MR_Integer) 2) & (MR_Integer) 1);
	MR_sv(9) = (((MR_Integer) MR_tfield(0, MR_r2, 5) >> (MR_Integer) 3) & (MR_Integer) 1);
	MR_sv(10) = (((MR_Integer) MR_tfield(0, MR_r2, 5) >> (MR_Integer) 4) & (MR_Integer) 1);
...
MR_def_label(ml_backend__mlds_to_il__statement_to_il_4_0,37)
	...
	MR_r2 = MR_sv(2);
	MR_sv(6) = MR_r1;
	MR_sv(11) = MR_tfield(0, MR_tfield(0, MR_sv(1), 20), 1);
