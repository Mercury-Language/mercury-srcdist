...
{
  {
    ...
    MR_Word TabledMethod_14 = ((MR_Word) ((MR_hl_field(MR_mktag(0), TablingInfoStruct_10, (MR_Integer) 1))));
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), InputStepsDataId_24, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &ll_backend__llds_out__llds_out_global_scalar_common_2[0])));
    }
    {
      ...
      MR_hl_field(MR_mktag(1), OutputStepsDataId_25, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &ll_backend__llds_out__llds_out_global_scalar_common_2[1])));
    }
    {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), CallStatsDataId_27, 1) = ((MR_Box) (MR_mkword(MR_mktag(3), &ll_backend__llds_out__llds_out_global_scalar_common_2[2])));
    }
    {
      ...
      MR_hl_field(MR_mktag(1), PrevCallStatsDataId_28, 1) = ((MR_Box) (MR_mkword(MR_mktag(3), &ll_backend__llds_out__llds_out_global_scalar_common_2[3])));
    }
    {
      ...
      MR_hl_field(MR_mktag(1), AnswerStatsDataId_29, 1) = ((MR_Box) (MR_mkword(MR_mktag(3), &ll_backend__llds_out__llds_out_global_scalar_common_2[4])));
    }
    {
      ...
      MR_hl_field(MR_mktag(1), PrevAnswerStatsDataId_30, 1) = ((MR_Box) (MR_mkword(MR_mktag(3), &ll_backend__llds_out__llds_out_global_scalar_common_2[5])));
    }
    ...
    else
    {
      ...
      if (!((MaybeSizeLimit_21 == (MR_Word) ((MR_Unsigned) 0U))))
      {
        MR_Integer SizeLimit1_246 = ((MR_Integer) ((MR_hl_field(MR_mktag(1), MaybeSizeLimit_21, (MR_Integer) 0))));

        ll_backend__llds_out__llds_out_global__output_table_tips_6_p_0(Info_8, Stream_9, ProcLabel_13, SizeLimit1_246);
      }
      switch (Stats_22) {
        default: /*NOTREACHED*/ MR_assert(0);
        case (MR_Integer) 1:
    ...
    mercury__io__write_string_4_p_0(Stream_9, (MR_String) ",\n");
    mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&ll_backend__llds_out__llds_out_global_scalar_common_2[6]), NumInputs_15, &Var_218);
    mercury__io__write_string_4_p_0(Stream_9, Var_218);
    mercury__io__write_string_4_p_0(Stream_9, (MR_String) ",\n");
    mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&ll_backend__llds_out__llds_out_global_scalar_common_2[6]), NumOutputs_16, &Var_228);
    mercury__io__write_string_4_p_0(Stream_9, Var_228);
    mercury__io__write_string_4_p_0(Stream_9, (MR_String) ",\n");
    mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&ll_backend__llds_out__llds_out_global_scalar_common_2[6]), OS_35, &Var_238);
    ...
    {
      MR_Integer SizeLimit2_39 = ((MR_Integer) ((MR_hl_field(MR_mktag(1), MaybeSizeLimit_21, (MR_Integer) 0))));
    ...
    mercury__io__write_string_4_p_0(Stream_9, (MR_String) "};\n");
    {
      DeclId_40 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(3), DeclId_40, 0) = ((MR_Box) ((MR_Unsigned) 4U));
      MR_hl_field(MR_mktag(3), DeclId_40, 1) = ((MR_Box) (ProcLabel_13));
      MR_hl_field(MR_mktag(3), DeclId_40, 2) = ((MR_Box) ((MR_Unsigned) 0U));
    }
  ...
  MR_Word HeadVar__2_2)
{
  while (MR_TRUE)
  {
    ...
    if (!((HeadVar__2_2 == (MR_Word) ((MR_Unsigned) 0U))))
    {
      ...
      mercury__io__write_string_4_p_0(Stream_1, (MR_String) "\", ");
      mercury__list__filter_3_p_0((MR_Word) (&hlds__hlds_module__hlds__hlds_module__type_ctor_info_complexity_arg_info_0), (MR_Word) (&ll_backend__llds_out__llds_out_global_scalar_common_4[0]), ArgInfos_15, &ProfiledArgInfos_16);
