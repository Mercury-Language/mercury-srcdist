...
{
  {
    ...
    mercury__io__write_string_3_p_0((MR_String) "\n");
    {
      TypeDeclId_37 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(3), TypeDeclId_37, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 0));
...
{
  {
    ...
    mercury__io__write_string_3_p_0((MR_String) "\n");
    {
      TypeDeclId_36 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(3), TypeDeclId_36, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 0));
  ...
  MR_Integer ArgNum_3)
{
  while (MR_TRUE)
  {
    ...
    if (!((HeadVar__1_1 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))))))
    {
      ...
      Var_36 = (MR_Integer) ((MR_Unsigned) ArgNum_3 + (MR_Unsigned) (MR_Integer) 1);
      // direct tailcall eliminated
  ...
  MR_Integer ArgNum_3)
{
  while (MR_TRUE)
  {
    ...
    if (!((HeadVar__1_1 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))))))
    {
      ...
      mercury__io__write_string_3_p_0(Indent_2);
      succeeded = (Type_11 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 1))));
      if (succeeded)
      {
      ...
      mercury__io__write_int_3_p_0(ArgNum_3);
      mercury__io__write_string_3_p_0((MR_String) ";\n");
      Var_27 = (MR_Integer) ((MR_Unsigned) ArgNum_3 + (MR_Unsigned) (MR_Integer) 1);
      // direct tailcall eliminated
...
{
  {
    ...
    mercury__io__write_string_3_p_0((MR_String) "};\n");
    {
      ...
      MR_hl_field(MR_mktag(3), DeclId_36, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 4));
