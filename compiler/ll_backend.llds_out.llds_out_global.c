...
{
  {
    ...
    MR_String Var_75;
    MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), TablingInfoStruct_8, (MR_Integer) 9)));
  ...
  MR_Word HeadVar__1_1)
{
  while (MR_TRUE)
  {
    ...
    if (!((HeadVar__1_1 == (MR_Word) ((MR_Unsigned) 0U))))
    {
      ...
      MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Arg_7, (MR_Integer) 1)));
      MR_Word next_value_of_HeadVar__1_1;
