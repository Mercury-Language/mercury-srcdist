...
MR_decl_label10(ll_backend__llds_out__llds_out_global__output_cons_arg_groups_4_0, 80,6,9,11,7,14,5,21,17,18)
MR_decl_label4(ll_backend__llds_out__llds_out_global__output_cons_arg_groups_4_0, 4,27,29,83)
MR_decl_label8(ll_backend__llds_out__llds_out_global__output_cons_arg_types_5_0, 23,4,5,8,10,11,12,25)
MR_decl_label8(ll_backend__llds_out__llds_out_global__output_cons_args_4_0, 39,8,4,5,12,14,16,42)
...
MR_decl_label10(ll_backend__llds_out__llds_out_global__output_scalar_common_data_decl_5_0, 2,6,4,8,9,10,11,12,13,15)
MR_decl_label10(ll_backend__llds_out__llds_out_global__output_scalar_common_data_decl_5_0, 17,18,19,20,22,23,24,25,26,27)
MR_decl_label1(ll_backend__llds_out__llds_out_global__output_scalar_common_data_decl_5_0, 28)
MR_decl_label10(ll_backend__llds_out__llds_out_global__output_scalar_common_data_defn_6_0, 2,4,5,6,7,8,9,10,11,12)
MR_decl_label6(ll_backend__llds_out__llds_out_global__output_scalar_common_data_defn_6_0, 13,14,15,16,18,19)
...
MR_decl_label10(ll_backend__llds_out__llds_out_global__output_vector_common_data_decl_5_0, 2,6,4,8,9,10,11,12,13,15)
MR_decl_label10(ll_backend__llds_out__llds_out_global__output_vector_common_data_decl_5_0, 17,18,19,20,22,23,24,25,26,27)
MR_decl_label1(ll_backend__llds_out__llds_out_global__output_vector_common_data_decl_5_0, 28)
MR_decl_label10(ll_backend__llds_out__llds_out_global__output_vector_common_data_defn_6_0, 2,4,5,6,7,8,9,10,11,12)
MR_decl_label6(ll_backend__llds_out__llds_out_global__output_vector_common_data_defn_6_0, 13,14,15,16,18,19)
MR_decl_label1(ll_backend__llds_out__llds_out_global__project_int_constant_2_0, 1)
MR_decl_label2(fn__ll_backend__llds_out__llds_out_global__common_cell_get_rvals_1_0, 5,3)
...
MR_def_label(ll_backend__llds_out__llds_out_global__output_init_complexity_proc_list_3_0,8)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(4) = (MR_Word) MR_CTOR0_ADDR(hlds__hlds_module, complexity_arg_info);
	MR_r1 = MR_sv(4);
...
MR_define_entry(mercury__ll_backend__llds_out__llds_out_global__output_tabling_info_struct_6_0);
	...
	MR_tfield(1, MR_tempr2, 1) = (MR_Word) MR_TAG_COMMON(1,3,0);
	MR_tag_alloc_heap(MR_tempr3, 1, (MR_Integer) 2);
	MR_sv(14) = MR_tempr3;
	MR_tfield(1, MR_tempr3, 0) = MR_tfield(1, MR_tempr2, 0);
	MR_tfield(1, MR_tempr3, 1) = (MR_Word) MR_TAG_COMMON(1,3,1);
...
MR_def_label(ll_backend__llds_out__llds_out_global__output_tabling_info_struct_6_0,20)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(20) = MR_tfield(1, MR_sv(7), 0);
	MR_sv(21) = MR_r1;
	MR_r1 = MR_sv(2);
	MR_r2 = MR_sv(14);
	MR_r3 = MR_sv(20);
...
MR_BEGIN_MODULE(ll_backend__llds_out__llds_out_global_module9)
	...
	MR_init_label8(ll_backend__llds_out__llds_out_global__output_cons_arg_types_5_0,23,4,5,8,10,11,12,25)
MR_BEGIN_CODE
...
MR_def_static(ll_backend__llds_out__llds_out_global__output_cons_arg_types_5_0)
	...
	MR_incr_sp(5);
	MR_sv(5) = (MR_Word) MR_succip;
MR_def_label(ll_backend__llds_out__llds_out_global__output_cons_arg_types_5_0,23)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TEST(MR_r1,0,0)) {
		MR_GOTO_LAB(ll_backend__llds_out__llds_out_global__output_cons_arg_types_5_0_i25);
	}
	MR_sv(1) = MR_r2;
	MR_sv(2) = MR_r3;
...
MR_def_label(ll_backend__llds_out__llds_out_global__output_cons_arg_types_5_0,4)
	...
	if (MR_INT_NE(MR_sv(3),9)) {
		MR_GOTO_LAB(ll_backend__llds_out__llds_out_global__output_cons_arg_types_5_0_i5);
	}
	MR_r1 = (MR_Word) MR_string_const("MR_Float_Aligned", 16);
	MR_np_call_localret_ent(io__write_string_3_0,
...
MR_def_label(ll_backend__llds_out__llds_out_global__output_cons_arg_types_5_0,8)
	...
	MR_np_call_localret_ent(io__write_string_3_0,
		ll_backend__llds_out__llds_out_global__output_cons_arg_types_5_0_i10);
MR_def_label(ll_backend__llds_out__llds_out_global__output_cons_arg_types_5_0,10)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(2);
	MR_np_call_localret_ent(io__write_int_3_0,
		ll_backend__llds_out__llds_out_global__output_cons_arg_types_5_0_i11);
MR_def_label(ll_backend__llds_out__llds_out_global__output_cons_arg_types_5_0,11)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_string_const(";\n", 2);
	MR_np_call_localret_ent(io__write_string_3_0,
		ll_backend__llds_out__llds_out_global__output_cons_arg_types_5_0_i12);
MR_def_label(ll_backend__llds_out__llds_out_global__output_cons_arg_types_5_0,12)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(4);
	MR_r2 = MR_sv(1);
	MR_r3 = ((MR_Integer) MR_sv(2) + (MR_Integer) 1);
	MR_succip_word = MR_sv(5);
	MR_GOTO_LAB(ll_backend__llds_out__llds_out_global__output_cons_arg_types_5_0_i23);
MR_def_label(ll_backend__llds_out__llds_out_global__output_cons_arg_types_5_0,25)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(5);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
...
MR_decl_entry(backend_libs__c_util__output_pragma_pack_push_2_0);
MR_decl_entry(fn__backend_libs__name_mangle__mercury_common_type_prefix_0_0);
MR_decl_entry(backend_libs__c_util__output_pragma_pack_pop_2_0);
...
MR_BEGIN_MODULE(ll_backend__llds_out__llds_out_global_module11)
	...
	MR_init_label10(ll_backend__llds_out__llds_out_global__output_scalar_common_data_decl_5_0,2,6,4,8,9,10,11,12,13,15)
	MR_init_label10(ll_backend__llds_out__llds_out_global__output_scalar_common_data_decl_5_0,17,18,19,20,22,23,24,25,26,27)
	MR_init_label1(ll_backend__llds_out__llds_out_global__output_scalar_common_data_decl_5_0,28)
MR_BEGIN_CODE
...
MR_def_label(ll_backend__llds_out__llds_out_global__output_scalar_common_data_decl_5_0,4)
	...
	MR_np_call_localret_ent(backend_libs__c_util__output_pragma_pack_push_2_0,
...
MR_def_label(ll_backend__llds_out__llds_out_global__output_scalar_common_data_decl_5_0,12)
	...
	MR_r1 = (MR_Word) MR_string_const(" {\n", 3);
	MR_np_call_localret_ent(io__write_string_3_0,
		ll_backend__llds_out__llds_out_global__output_scalar_common_data_decl_5_0_i13);
MR_def_label(ll_backend__llds_out__llds_out_global__output_scalar_common_data_decl_5_0,13)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_sv(3),1)) {
		MR_GOTO_LAB(ll_backend__llds_out__llds_out_global__output_scalar_common_data_decl_5_0_i15);
	}
	MR_r1 = MR_tfield(1, MR_sv(3), 0);
...
MR_def_label(ll_backend__llds_out__llds_out_global__output_scalar_common_data_decl_5_0,15)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_def_label(ll_backend__llds_out__llds_out_global__output_scalar_common_data_decl_5_0,18)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_np_call_localret_ent(backend_libs__c_util__output_pragma_pack_pop_2_0,
		ll_backend__llds_out__llds_out_global__output_scalar_common_data_decl_5_0_i19);
MR_def_label(ll_backend__llds_out__llds_out_global__output_scalar_common_data_decl_5_0,19)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(4);
	MR_r2 = MR_sv(2);
...
MR_def_label(ll_backend__llds_out__llds_out_global__output_scalar_common_data_decl_5_0,26)
	...
	MR_np_call_localret_ent(ll_backend__llds_out__llds_out_data__output_common_scalar_cell_array_name_3_0,
		ll_backend__llds_out__llds_out_global__output_scalar_common_data_decl_5_0_i27);
MR_def_label(ll_backend__llds_out__llds_out_global__output_scalar_common_data_decl_5_0,27)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_string_const("[];\n", 4);
	MR_np_call_localret_ent(io__write_string_3_0,
		ll_backend__llds_out__llds_out_global__output_scalar_common_data_decl_5_0_i28);
MR_def_label(ll_backend__llds_out__llds_out_global__output_scalar_common_data_decl_5_0,28)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(3);
...
MR_BEGIN_MODULE(ll_backend__llds_out__llds_out_global_module12)
	...
	MR_init_label10(ll_backend__llds_out__llds_out_global__output_vector_common_data_decl_5_0,2,6,4,8,9,10,11,12,13,15)
	MR_init_label10(ll_backend__llds_out__llds_out_global__output_vector_common_data_decl_5_0,17,18,19,20,22,23,24,25,26,27)
	MR_init_label1(ll_backend__llds_out__llds_out_global__output_vector_common_data_decl_5_0,28)
MR_BEGIN_CODE
...
MR_def_label(ll_backend__llds_out__llds_out_global__output_vector_common_data_decl_5_0,12)
	...
	MR_r1 = (MR_Word) MR_string_const(" {\n", 3);
	MR_np_call_localret_ent(io__write_string_3_0,
		ll_backend__llds_out__llds_out_global__output_vector_common_data_decl_5_0_i13);
MR_def_label(ll_backend__llds_out__llds_out_global__output_vector_common_data_decl_5_0,13)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_sv(4),1)) {
		MR_GOTO_LAB(ll_backend__llds_out__llds_out_global__output_vector_common_data_decl_5_0_i15);
	}
...
MR_def_label(ll_backend__llds_out__llds_out_global__output_vector_common_data_decl_5_0,15)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_def_label(ll_backend__llds_out__llds_out_global__output_vector_common_data_decl_5_0,18)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_np_call_localret_ent(backend_libs__c_util__output_pragma_pack_pop_2_0,
		ll_backend__llds_out__llds_out_global__output_vector_common_data_decl_5_0_i19);
MR_def_label(ll_backend__llds_out__llds_out_global__output_vector_common_data_decl_5_0,19)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(5);
	MR_r2 = MR_sv(3);
	MR_np_call_localret_ent(ll_backend__llds_out__llds_out_util__decl_set_insert_3_0,
...
MR_def_label(ll_backend__llds_out__llds_out_global__output_vector_common_data_decl_5_0,26)
	...
	MR_np_call_localret_ent(ll_backend__llds_out__llds_out_data__output_common_vector_cell_array_name_4_0,
		ll_backend__llds_out__llds_out_global__output_vector_common_data_decl_5_0_i27);
MR_def_label(ll_backend__llds_out__llds_out_global__output_vector_common_data_decl_5_0,27)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_string_const("[];\n", 4);
	MR_np_call_localret_ent(io__write_string_3_0,
		ll_backend__llds_out__llds_out_global__output_vector_common_data_decl_5_0_i28);
MR_def_label(ll_backend__llds_out__llds_out_global__output_vector_common_data_decl_5_0,28)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(4);
...
MR_BEGIN_MODULE(ll_backend__llds_out__llds_out_global_module13)
	...
	MR_init_label10(ll_backend__llds_out__llds_out_global__output_scalar_common_data_defn_6_0,2,4,5,6,7,8,9,10,11,12)
	MR_init_label6(ll_backend__llds_out__llds_out_global__output_scalar_common_data_defn_6_0,13,14,15,16,18,19)
MR_BEGIN_CODE
...
MR_def_label(ll_backend__llds_out__llds_out_global__output_scalar_common_data_defn_6_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(5) = (MR_Word) MR_CTOR0_ADDR(ll_backend__llds, common_cell_value);
	MR_r1 = MR_sv(5);
	MR_r2 = (MR_Word) MR_TAG_COMMON(0,0,0);
	MR_r3 = (MR_Word) MR_TAG_COMMON(0,2,1);
	MR_r4 = MR_sv(3);
	MR_np_call_localret_ent(fn__list__map_2_0,
		ll_backend__llds_out__llds_out_global__output_scalar_common_data_defn_6_0_i4);
MR_def_label(ll_backend__llds_out__llds_out_global__output_scalar_common_data_defn_6_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
...
MR_def_label(ll_backend__llds_out__llds_out_global__output_scalar_common_data_defn_6_0,16)
	...
	MR_np_call_localret_ent(list__foldl_4_2,
		ll_backend__llds_out__llds_out_global__output_scalar_common_data_defn_6_0_i18);
MR_def_label(ll_backend__llds_out__llds_out_global__output_scalar_common_data_defn_6_0,18)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_string_const("};\n", 3);
	MR_np_call_localret_ent(io__write_string_3_0,
...
MR_BEGIN_MODULE(ll_backend__llds_out__llds_out_global_module14)
	...
	MR_init_label10(ll_backend__llds_out__llds_out_global__output_vector_common_data_defn_6_0,2,4,5,6,7,8,9,10,11,12)
	MR_init_label6(ll_backend__llds_out__llds_out_global__output_vector_common_data_defn_6_0,13,14,15,16,18,19)
MR_BEGIN_CODE
...
MR_def_label(ll_backend__llds_out__llds_out_global__output_vector_common_data_defn_6_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(6) = (MR_Word) MR_CTOR0_ADDR(ll_backend__llds, common_cell_value);
	MR_r1 = MR_sv(6);
	MR_r2 = (MR_Word) MR_TAG_COMMON(0,0,0);
	MR_r3 = (MR_Word) MR_TAG_COMMON(0,2,2);
	MR_r4 = MR_sv(4);
	MR_np_call_localret_ent(fn__list__map_2_0,
		ll_backend__llds_out__llds_out_global__output_vector_common_data_defn_6_0_i4);
MR_def_label(ll_backend__llds_out__llds_out_global__output_vector_common_data_defn_6_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
...
MR_def_label(ll_backend__llds_out__llds_out_global__output_vector_common_data_defn_6_0,16)
	...
	MR_np_call_localret_ent(list__foldl_4_2,
		ll_backend__llds_out__llds_out_global__output_vector_common_data_defn_6_0_i18);
MR_def_label(ll_backend__llds_out__llds_out_global__output_vector_common_data_defn_6_0,18)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_string_const("};\n", 3);
	MR_np_call_localret_ent(io__write_string_3_0,
...
extern const MR_TypeCtorInfo_Struct mercury_data_ll_backend__llds__type_ctor_info_common_cell_arg_group_0;
MR_decl_entry(fn__ll_backend__llds__typed_rvals_project_rvals_1_0);
...
MR_BEGIN_MODULE(ll_backend__llds_out__llds_out_global_module16)
	...
	MR_init_label2(fn__ll_backend__llds_out__llds_out_global__common_cell_get_rvals_1_0,5,3)
MR_BEGIN_CODE
...
MR_def_static(fn__ll_backend__llds_out__llds_out_global__common_cell_get_rvals_1_0)
	...
	MR_np_call_localret_ent(fn__list__map_2_0,
		fn__ll_backend__llds_out__llds_out_global__common_cell_get_rvals_1_0_i5);
MR_def_label(fn__ll_backend__llds_out__llds_out_global__common_cell_get_rvals_1_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
...
MR_def_label(fn__ll_backend__llds_out__llds_out_global__common_cell_get_rvals_1_0,3)
	...
	MR_np_tailcall_ent(fn__ll_backend__llds__typed_rvals_project_rvals_1_0);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_thread_engine_base
#endif
...
MR_BEGIN_MODULE(ll_backend__llds_out__llds_out_global_module18)
	...
	MR_init_label8(ll_backend__llds_out__llds_out_global__output_cons_args_4_0,39,8,4,5,12,14,16,42)
MR_BEGIN_CODE
...
MR_def_static(ll_backend__llds_out__llds_out_global__output_cons_args_4_0)
	...
	MR_incr_sp(6);
	MR_sv(6) = (MR_Word) MR_succip;
MR_def_label(ll_backend__llds_out__llds_out_global__output_cons_args_4_0,39)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TEST(MR_r2,0,0)) {
		MR_GOTO_LAB(ll_backend__llds_out__llds_out_global__output_cons_args_4_0_i42);
	}
	{
	...
	if (MR_RTAGS_TESTR(MR_tempr3,3,1)) {
		MR_GOTO_LAB(ll_backend__llds_out__llds_out_global__output_cons_args_4_0_i5);
	}
	...
	MR_np_call_localret_ent(fn__ll_backend__llds_out__llds_out_data__direct_field_int_constant_1_0,
		ll_backend__llds_out__llds_out_global__output_cons_args_4_0_i8);
MR_def_label(ll_backend__llds_out__llds_out_global__output_cons_args_4_0,8)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	...
	MR_r1 = MR_sv(5);
	MR_np_call_localret_ent(io__write_int_3_0,
		ll_backend__llds_out__llds_out_global__output_cons_args_4_0_i12);
...
MR_def_label(ll_backend__llds_out__llds_out_global__output_cons_args_4_0,5)
	...
	MR_np_call_localret_ent(ll_backend__llds_out__llds_out_data__output_rval_as_type_5_0,
		ll_backend__llds_out__llds_out_global__output_cons_args_4_0_i12);
MR_def_label(ll_backend__llds_out__llds_out_global__output_cons_args_4_0,12)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_sv(2),0,0)) {
		MR_GOTO_LAB(ll_backend__llds_out__llds_out_global__output_cons_args_4_0_i14);
	}
	MR_r1 = (MR_Word) MR_string_const("\n", 1);
	MR_succip_word = MR_sv(6);
	MR_decr_sp(6);
	MR_np_tailcall_ent(io__write_string_3_0);
MR_def_label(ll_backend__llds_out__llds_out_global__output_cons_args_4_0,14)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_string_const(",\n", 2);
	MR_np_call_localret_ent(io__write_string_3_0,
		ll_backend__llds_out__llds_out_global__output_cons_args_4_0_i16);
MR_def_label(ll_backend__llds_out__llds_out_global__output_cons_args_4_0,16)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(1);
	MR_r2 = MR_sv(2);
	MR_succip_word = MR_sv(6);
	MR_GOTO_LAB(ll_backend__llds_out__llds_out_global__output_cons_args_4_0_i39);
MR_def_label(ll_backend__llds_out__llds_out_global__output_cons_args_4_0,42)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(6);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
...
MR_BEGIN_MODULE(ll_backend__llds_out__llds_out_global_module22)
	...
	MR_init_label10(ll_backend__llds_out__llds_out_global__output_cons_arg_groups_4_0,80,6,9,11,7,14,5,21,17,18)
	MR_init_label4(ll_backend__llds_out__llds_out_global__output_cons_arg_groups_4_0,4,27,29,83)
MR_BEGIN_CODE
...
MR_def_static(ll_backend__llds_out__llds_out_global__output_cons_arg_groups_4_0)
	...
	MR_incr_sp(6);
	MR_sv(6) = (MR_Word) MR_succip;
MR_def_label(ll_backend__llds_out__llds_out_global__output_cons_arg_groups_4_0,80)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TEST(MR_r2,0,0)) {
		MR_GOTO_LAB(ll_backend__llds_out__llds_out_global__output_cons_arg_groups_4_0_i83);
	}
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_tfield(1, MR_r2, 0);
...
MR_def_label(ll_backend__llds_out__llds_out_global__output_cons_arg_groups_4_0,6)
	...
	MR_np_call_localret_ent(list__map_3_2,
		ll_backend__llds_out__llds_out_global__output_cons_arg_groups_4_0_i9);
MR_def_label(ll_backend__llds_out__llds_out_global__output_cons_arg_groups_4_0,9)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
...
MR_def_label(ll_backend__llds_out__llds_out_global__output_cons_arg_groups_4_0,5)
	...
	if (MR_RTAGS_TESTR(MR_tempr2,3,1)) {
		MR_GOTO_LAB(ll_backend__llds_out__llds_out_global__output_cons_arg_groups_4_0_i18);
	}
	...
	MR_np_call_localret_ent(fn__ll_backend__llds_out__llds_out_data__direct_field_int_constant_1_0,
		ll_backend__llds_out__llds_out_global__output_cons_arg_groups_4_0_i21);
MR_def_label(ll_backend__llds_out__llds_out_global__output_cons_arg_groups_4_0,21)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,1)) {
...
MR_def_label(ll_backend__llds_out__llds_out_global__output_cons_arg_groups_4_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_sv(2),0,0)) {
		MR_GOTO_LAB(ll_backend__llds_out__llds_out_global__output_cons_arg_groups_4_0_i27);
	}
	MR_r1 = (MR_Word) MR_string_const("\n", 1);
	MR_succip_word = MR_sv(6);
	MR_decr_sp(6);
	MR_np_tailcall_ent(io__write_string_3_0);
MR_def_label(ll_backend__llds_out__llds_out_global__output_cons_arg_groups_4_0,27)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_string_const(",\n", 2);
	MR_np_call_localret_ent(io__write_string_3_0,
		ll_backend__llds_out__llds_out_global__output_cons_arg_groups_4_0_i29);
MR_def_label(ll_backend__llds_out__llds_out_global__output_cons_arg_groups_4_0,29)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(1);
	MR_r2 = MR_sv(2);
	MR_succip_word = MR_sv(6);
	MR_GOTO_LAB(ll_backend__llds_out__llds_out_global__output_cons_arg_groups_4_0_i80);
MR_def_label(ll_backend__llds_out__llds_out_global__output_cons_arg_groups_4_0,83)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(6);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
...
void mercury__ll_backend__llds_out__llds_out_global__init_threadscope_string_table(void);
#endif
...
void mercury__ll_backend__llds_out__llds_out_global__write_out_proc_statics(FILE *deep_fp, FILE *procrep_fp)
{
	MR_write_out_module_proc_reps_start(procrep_fp, &mercury_data__module_layout__ll_backend__llds_out__llds_out_global);
