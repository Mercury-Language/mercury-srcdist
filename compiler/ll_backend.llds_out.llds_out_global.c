  ...
  MR_Word * STATE_VARIABLE_DeclSet_19)
{
  ...
  mercury__io__write_string_4_p_0(Stream_9, (MR_String) "static const struct ");
  TypeNum_54 = (MR_Integer) (TypeNum_14);
  Var_56 = backend_libs__name_mangle__mercury_common_type_prefix_0_f_0();
  mercury__io__write_string_4_p_0(Stream_9, Var_56);
  mercury__io__write_int_4_p_0(Stream_9, TypeNum_54);
  mercury__io__write_string_4_p_0(Stream_9, (MR_String) " ");
  ...
  MR_Word * STATE_VARIABLE_DeclSet_42)
{
  ...
  else
  {
    ...
    if (!((MaybeSizeLimit_21 == (MR_Word) ((MR_Unsigned) 0U))))
    {
      MR_Integer SizeLimit1_245 = ((MR_Integer) ((MR_hl_field(MR_mktag(1), MaybeSizeLimit_21, (MR_Integer) 0))));

      ll_backend__llds_out__llds_out_global__output_table_tips_6_p_0(Info_8, Stream_9, ProcLabel_13, SizeLimit1_245);
    }
    switch (Stats_22) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 1:
  ...
  mercury__io__write_string_4_p_0(Stream_9, (MR_String) ",\n");
  mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&ll_backend__llds_out__llds_out_global_scalar_common_2[6]), NumInputs_15, &Var_217);
  mercury__io__write_string_4_p_0(Stream_9, Var_217);
  mercury__io__write_string_4_p_0(Stream_9, (MR_String) ",\n");
  mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&ll_backend__llds_out__llds_out_global_scalar_common_2[6]), NumOutputs_16, &Var_227);
  mercury__io__write_string_4_p_0(Stream_9, Var_227);
  mercury__io__write_string_4_p_0(Stream_9, (MR_String) ",\n");
  mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&ll_backend__llds_out__llds_out_global_scalar_common_2[6]), OS_35, &Var_237);
  ...
  MR_Word HeadVar__2_2)
{
  while (MR_TRUE)
  {
    ...
    if (!((HeadVar__2_2 == (MR_Word) ((MR_Unsigned) 0U))))
    {
      ...
      mercury__io__write_string_4_p_0(Stream_1, (MR_String) ", ");
      Var_44 = mercury__string__int_to_string_1_f_0(ProcNum_13);
      Var_36 = mercury__string__f_43_43_2_f_0((MR_String) "MR_complexity_arg_info_", Var_44);
  ...
  MR_Word HeadVar__2_2)
{
  while (MR_TRUE)
  {
    ...
    if (!((HeadVar__2_2 == (MR_Word) ((MR_Unsigned) 0U))))
    {
      ...
      Var_34 = mercury__string__int_to_string_1_f_0(ProcNum_13);
      Var_20 = mercury__string__f_43_43_2_f_0((MR_String) "MR_complexity_arg_info_", Var_34);
