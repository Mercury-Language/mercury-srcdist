...
{
  {
    ...
    {
      libs__globals__lookup_bool_option_3_p_0(ml_backend__mlds_to_cs__Globals_9, (MR_Integer) 147, &ml_backend__mlds_to_cs__AutoComments_10);
    }
    {
      libs__globals__lookup_bool_option_3_p_0(ml_backend__mlds_to_cs__Globals_9, (MR_Integer) 144, &ml_backend__mlds_to_cs__LineNumbers_11);
    }
    {
      libs__globals__lookup_bool_option_3_p_0(ml_backend__mlds_to_cs__Globals_9, (MR_Integer) 145, &ml_backend__mlds_to_cs__ForeignLineNumbers_12);
    }
    {
