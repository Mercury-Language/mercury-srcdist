                                ...
                                else
                                  {
                                    ...
                                    if (ml_backend__mlds_to_cs__succeeded)
                                      *ml_backend__mlds_to_cs__HeadVar__1_1 = ml_backend__mlds_to_cs__Var_29;
                                      ...
                                      {
                                        {
                                          mercury__builtin__compare_3_p_0((MR_Word) &ml_backend__mlds_to_cs_scalar_common_1[4], ml_backend__mlds_to_cs__HeadVar__1_1, ((MR_Box) (ml_backend__mlds_to_cs__ArgX9_20)), ((MR_Box) (ml_backend__mlds_to_cs__ArgY9_21)));
                                        }
                                      }
                                  }
                              }
