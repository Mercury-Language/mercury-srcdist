        ...
        case (MR_Integer) 0:
          {
            ...
            if (((MR_tag((MR_Word) FieldId_11)) == (MR_mktag((MR_Integer) 1))))
            {
            ...
            else
            {
              ...
              if (((((MR_tag((MR_Word) FieldType_12)) == (MR_mktag((MR_Integer) 3)))) && ((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), FieldType_12, (MR_Integer) 0))) == (MR_Integer) 0))))
              {
