...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), hlds__make_hlds__add_pred__V_66_66, 0) = ((MR_Box) (((MR_Integer) 177 | (((MR_Integer) 0 << (MR_Integer) 10)))));
        ...
        if (hlds__make_hlds__add_pred__succeeded)
          {
            ...
            }
            {
              ...
              MR_hl_field(MR_mktag(3), hlds__make_hlds__add_pred__GoalExpr_20, 1) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__add_pred_scalar_common_1[50])));
            ...
            if (hlds__make_hlds__add_pred__succeeded)
              {
                ...
                }
                {
                  hlds__make_hlds__add_pred__GoalExpr_20 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL));
                  MR_hl_field(MR_mktag(3), hlds__make_hlds__add_pred__GoalExpr_20, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 5));
                  MR_hl_field(MR_mktag(3), hlds__make_hlds__add_pred__GoalExpr_20, 1) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__add_pred_scalar_common_1[51])));
