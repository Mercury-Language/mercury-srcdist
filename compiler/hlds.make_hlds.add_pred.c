...
MR_decl_label10(hlds__make_hlds__add_pred__add_builtin_5_0, 14,15,18,19,22,23,17,13,27,28)
MR_decl_label10(hlds__make_hlds__add_pred__add_builtin_5_0, 31,33,48,49,52,53,54,58,59,60)
MR_decl_label10(hlds__make_hlds__add_pred__add_builtin_5_0, 26,69,70,68,78,80,81,84,85,86)
MR_decl_label10(hlds__make_hlds__add_pred__add_builtin_5_0, 87,89,90,91,97,99,100,93,102,104)
MR_decl_label4(hlds__make_hlds__add_pred__add_builtin_5_0, 105,106,107,108)
...
MR_decl_label10(hlds__make_hlds__add_pred__module_do_add_mode_11_0, 4,5,6,7,11,13,10,35,3,38)
...
MR_BEGIN_MODULE(hlds__make_hlds__add_pred_module5)
	...
	MR_init_label10(hlds__make_hlds__add_pred__module_do_add_mode_11_0,4,5,6,7,11,13,10,35,3,38)
MR_BEGIN_CODE
...
MR_def_label(hlds__make_hlds__add_pred__module_do_add_mode_11_0,11)
	...
	MR_tfield(1, MR_tempr3, 0) = (MR_Integer) 154;
...
MR_BEGIN_MODULE(hlds__make_hlds__add_pred_module7)
	...
	MR_init_label10(hlds__make_hlds__add_pred__add_builtin_5_0,14,15,18,19,22,23,17,13,27,28)
	MR_init_label10(hlds__make_hlds__add_pred__add_builtin_5_0,31,33,48,49,52,53,54,58,59,60)
	MR_init_label10(hlds__make_hlds__add_pred__add_builtin_5_0,26,69,70,68,78,80,81,84,85,86)
	MR_init_label10(hlds__make_hlds__add_pred__add_builtin_5_0,87,89,90,91,97,99,100,93,102,104)
	MR_init_label4(hlds__make_hlds__add_pred__add_builtin_5_0,105,106,107,108)
MR_BEGIN_CODE
...
MR_def_label(hlds__make_hlds__add_pred__add_builtin_5_0,91)
	...
	if (MR_INT_NE(MR_sv(8),0)) {
		MR_GOTO_LAB(hlds__make_hlds__add_pred__add_builtin_5_0_i93);
	}
	MR_tag_alloc_heap(MR_r2, 0, (MR_Integer) 2);
...
MR_def_label(hlds__make_hlds__add_pred__add_builtin_5_0,93)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(1) = MR_r1;
