...
MR_def_static(hlds__make_hlds__add_pred__unspecified_det_for_local_6_0)
	...
	MR_tfield(1, MR_r2, 1) = (MR_Word) MR_TAG_COMMON(1,0,9);
	MR_tag_alloc_heap(MR_tempr2, 1, (MR_Integer) 3);
	MR_tfield(1, MR_tempr2, 0) = (MR_Integer) 148;
	...
	MR_tfield(0, MR_tempr2, 0) = (MR_Word) MR_TAG_COMMON(1,3,0);
...
MR_def_static(hlds__make_hlds__add_pred__unspecified_det_for_method_6_0)
	...
	MR_tag_alloc_heap(MR_r2, 1, (MR_Integer) 2);
	MR_tfield(1, MR_r2, 0) = (MR_Word) MR_TAG_COMMON(3,1,7);
	MR_tfield(1, MR_r2, 1) = MR_tempr2;
	MR_tag_alloc_heap(MR_tempr2, 0, (MR_Integer) 1);
	MR_tfield(0, MR_tempr2, 0) = MR_r2;
	MR_tag_alloc_heap(MR_r2, 1, (MR_Integer) 2);
...
MR_def_label(hlds__make_hlds__add_pred__add_builtin_5_0,77)
	...
	MR_tfield(1, MR_r2, 3) = (MR_Integer) 0;
