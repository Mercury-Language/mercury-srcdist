      ...
      case (MR_Integer) 1:
        {
          ...
          hlds__make_hlds__add_pred__maybe_check_field_access_function_7_p_0(ModuleInfo_5, SymName_12, FuncArity_27, PredStatus_28, Context_24, STATE_VARIABLE_Specs_0_29, STATE_VARIABLE_Specs_30);
        }
        break;
      case (MR_Integer) 0:
...
{
  {
    ...
    Var_62 = mercury__map__init_0_f_0((MR_Word) &hlds__make_hlds__add_pred_scalar_common_1[1], (MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_kind_0);
    ...
    mercury__map__init_1_p_0((MR_Word) &hlds__make_hlds__add_pred_scalar_common_1[0], (MR_Word) &mercury__builtin__builtin__type_ctor_info_string_0, &VarNameRemap_52);
    hlds__hlds_pred__pred_info_init_19_p_0(ModuleName_12, PredName_13, Arity_14, PredOrFunc_15, Context_18, Var_27, Status_17, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 3)), Markers0_43, Types_47, TVarSet_46, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), (MR_Word) &hlds__make_hlds__add_pred_scalar_common_1[46], Proofs_50, ConstraintMap_51, ClausesInfo_20, VarNameRemap_52, &PredInfo0_53);
...
{
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        hlds__make_hlds__add_pred__module_add_mode_15_p_0(Context_23, ItemNumber_24, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), PredStatus_26, PredOrFunc_28, PredName_29, InstVarSet_31, Modes_52, MaybeDet_35, IsClassMethod_53, &PredProcId_55, STATE_VARIABLE_ModuleInfo_69_211, STATE_VARIABLE_ModuleInfo_63, STATE_VARIABLE_Specs_70_212, STATE_VARIABLE_Specs_65);
        {
          MR_Word base;
      ...
      else
      {
          ...
          *MaybePredProcId_38 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
          ...
          if (succeeded)
          {
            ...
            }
            {
              ...
              MR_hl_field(MR_mktag(1), Var_124, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &hlds__make_hlds__add_pred_scalar_common_1[7])));
            }
            {
              DetPieces_119 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), DetPieces_119, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__add_pred_scalar_common_1[69])));
        ...
        else
        {
          ...
          hlds__make_hlds__add_pred__module_add_mode_15_p_0(Context_23, ItemNumber_24, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), PredStatus_26, PredOrFunc_28, PredName_29, InstVarSet_31, Modes_232, MaybeDet_35, IsClassMethod_233, &PredProcId_235, STATE_VARIABLE_ModuleInfo_69_248, STATE_VARIABLE_ModuleInfo_63, STATE_VARIABLE_Specs_70_249, STATE_VARIABLE_Specs_65);
          {
            MR_Word base;
            base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
            *MaybePredProcId_38 = base;
...
{
  {
    ...
    if (succeeded)
    {
      PredStatus_37 = (MR_Word) ((MR_Box) (MR_mkword(MR_mktag(2), &hlds__make_hlds__add_pred_scalar_common_5[1])));
    }
    else
    ...
    if (((MR_tag((MR_Word) PredName_27)) == (MR_mktag((MR_Integer) 1))))
    {
      ...
      if (succeeded)
      {
        ...
        DeclSection_45 = hlds__make_hlds__add_pred__item_decl_section_1_f_0(ItemExport_44);
      ...
      mercury__map__init_1_p_0((MR_Word) &hlds__make_hlds__add_pred_scalar_common_1[0], (MR_Word) &mercury__builtin__builtin__type_ctor_info_string_0, &VarNameRemap_55);
      ...
      if ((PredIds_57 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
      {
        ...
        if (succeeded)
        {
          ...
          hlds__make_hlds__add_pred__add_builtin_5_p_0(PredId_65, Types_30, CompilationTarget_68, PredInfo0_56, &PredInfo_69);
      ...
      else
      {
        ...
        {
          hlds__make_hlds__make_hlds_error__report_multiple_def_error_8_p_0(PredName_27, OrigArity_63, DeclString_62, Context_21, OrigContext_61, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), STATE_VARIABLE_Specs_0_75, STATE_VARIABLE_Specs_76);
        }
    ...
    else
    {
      ...
      hlds__make_hlds__add_pred__unqualified_pred_error_5_p_0(PredName_27, Arity_39, Context_21, STATE_VARIABLE_Specs_0_75, STATE_VARIABLE_Specs_76);
    }
  }
}
...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), Var_17, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &hlds__make_hlds__add_pred_scalar_common_1[38])));
    }
    {
      Pieces_10 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), Pieces_10, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__add_pred_scalar_common_1[68])));
...
{
  {
    ...
    TypeInfo_131_131 = (MR_Word) &hlds__make_hlds__add_pred_scalar_common_1[0];
    ...
    if (succeeded)
    {
      ...
      do
      {
        ...
        result_3 = MR_strcmp(Name_11, ((&hlds__make_hlds__add_pred_vector_common_3[0 + mid_2]))->hlds__make_hlds__add_pred__vector_common_type_3_0__vct_3_f_0);
        if ((result_3 == (MR_Integer) 0))
        {
          switch (((&hlds__make_hlds__add_pred_vector_common_3[0 + mid_2]))->hlds__make_hlds__add_pred__vector_common_type_3_0__vct_3_f_1) {
            default: /*NOTREACHED*/ MR_assert(0);
            case (MR_Integer) 0:
              {
    ...
    if (succeeded)
    {
      GoalExpr_21 = (MR_Word) MR_mkword(MR_mktag(3), &hlds__make_hlds__add_pred_scalar_common_4[0]);
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(0), Unification_32, 1) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__add_pred_scalar_common_1[64])));
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(1), AssignExpr_34, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &hlds__make_hlds__add_pred_scalar_common_4[1])));
          MR_hl_field(MR_mktag(1), AssignExpr_34, 2) = ((MR_Box) (UnifyMode_31));
          MR_hl_field(MR_mktag(1), AssignExpr_34, 3) = ((MR_Box) (Unification_32));
          MR_hl_field(MR_mktag(1), AssignExpr_34, 4) = ((MR_Box) (&hlds__make_hlds__add_pred_scalar_common_1[65]));
        }
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(3), CastExpr_37, 1) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__add_pred_scalar_common_5[0])));
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(3), GoalExpr_21, 1) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__add_pred_scalar_common_1[66])));
      ...
      else
      {
        ...
        if (succeeded)
        {
          ...
          GoalInfo_22 = GoalInfo1_19;
          {
            ...
            MR_hl_field(MR_mktag(0), ConjGoal_125, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__add_pred_scalar_common_4[0])));
            MR_hl_field(MR_mktag(0), ConjGoal_125, 1) = ((MR_Box) (GoalInfo_22));
          }
          {
            GoalExpr_21 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(3), GoalExpr_21, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 5));
            MR_hl_field(MR_mktag(3), GoalExpr_21, 1) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__add_pred_scalar_common_1[67])));
    ...
    TypeInfo_134_134 = (MR_Word) &hlds__make_hlds__add_pred_scalar_common_1[1];
...
{
  {
    ...
    else
    {
      ...
      hlds__make_hlds__add_pred__preds_add_implicit_report_error_14_p_0(STATE_VARIABLE_ModuleInfo_0_43, &STATE_VARIABLE_ModuleInfo_49_49, ModuleName_30, PredName_21, Arity_31, PredOrFunc_20, PredStatus_19, IsClassMethod_25, Context_16, Var_50, (MR_Word) MR_mkword(MR_mktag(1), &hlds__make_hlds__add_pred_scalar_common_1[11]), &PredId_35, STATE_VARIABLE_Specs_0_45, &STATE_VARIABLE_Specs_52_52);
    }
    ...
    hlds__make_hlds__add_pred__module_do_add_mode_13_p_0(Context_16, ItemNumber_17, MaybeItemMercuryStatus_18, Arity_31, InstVarSet_22, Modes_23, MaybeDet_24, IsClassMethod_25, PredInfo0_38, &PredInfo_39, &ProcId_40, STATE_VARIABLE_Specs_52_52, STATE_VARIABLE_Specs_46);
...
{
  {
    ...
    if ((MaybeDet_20 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
    {
      ...
      switch (IsClassMethod_21) {
        default: /*NOTREACHED*/ MR_assert(0);
        case (MR_Integer) 1:
          hlds__make_hlds__add_pred__unspecified_det_for_method_6_p_0(PredSymName_30, Arity_17, PredOrFunc_26, Context_14, STATE_VARIABLE_Specs_0_53, &STATE_VARIABLE_Specs_57_57);
          break;
        case (MR_Integer) 0:
          {
            ...
            switch (IsExported_31) {
              default: /*NOTREACHED*/ MR_assert(0);
              case (MR_Integer) 0:
                hlds__make_hlds__add_pred__unspecified_det_for_local_6_p_0(PredSymName_30, Arity_17, PredOrFunc_26, Context_14, STATE_VARIABLE_Specs_0_53, &STATE_VARIABLE_Specs_57_57);
                break;
              case (MR_Integer) 1:
                hlds__make_hlds__add_pred__unspecified_det_for_exported_6_p_0(PredSymName_30, Arity_17, PredOrFunc_26, Context_14, STATE_VARIABLE_Specs_0_53, &STATE_VARIABLE_Specs_57_57);
                break;
            }
          }
          break;
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        ModeDeclSection_40 = hlds__make_hlds__add_pred__item_decl_section_1_f_0(ItemExport_39);
        ...
        else
        {
          ...
          ModeSectionStr_41 = hlds__make_hlds__add_pred__decl_section_to_string_1_f_0(ModeDeclSection_40);
          PredSectionStr_42 = hlds__make_hlds__add_pred__decl_section_to_string_1_f_0(PredDeclSection_35);
          {
          ...
          }
          {
            Var_91 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), Var_91, 0) = ((MR_Box) (Var_92));
            MR_hl_field(MR_mktag(1), Var_91, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &hlds__make_hlds__add_pred_scalar_common_1[13])));
          }
          {
            Var_88 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), Var_88, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__add_pred_scalar_common_1[61])));
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(1), Var_85, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__add_pred_scalar_common_1[60])));
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(1), Var_82, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__add_pred_scalar_common_1[59])));
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(1), Var_77, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__add_pred_scalar_common_1[58])));
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(1), Var_74, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__add_pred_scalar_common_1[57])));
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(1), Var_65, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__add_pred_scalar_common_1[56])));
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(1), Var_62, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__add_pred_scalar_common_1[55])));
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(1), SectionPieces_43, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__add_pred_scalar_common_1[54])));
          ...
          case (MR_Integer) 1:
            {
              ...
              }
              {
                ...
                MR_hl_field(MR_mktag(1), Var_118, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &hlds__make_hlds__add_pred_scalar_common_1[18])));
              }
              {
                Var_115 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(1), Var_115, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__add_pred_scalar_common_1[63])));
              ...
              }
              {
                ...
                MR_hl_field(MR_mktag(1), PredModePieces_46, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__add_pred_scalar_common_1[62])));
    ...
    hlds__make_hlds__add_pred__do_add_new_proc_14_p_0(Context_14, ItemNumber_15, Arity_17, InstVarSet_18, Modes_19, Var_140, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), DetismDecl_27, MaybeDet_20, (MR_Integer) 1, (MR_Integer) 1, STATE_VARIABLE_PredInfo_0_51, STATE_VARIABLE_PredInfo_52, ProcId_23);
  }
}
...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), Var_21, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &hlds__make_hlds__add_pred_scalar_common_1[13])));
    }
    {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), Pieces_12, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__add_pred_scalar_common_1[53])));
...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), Var_24, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &hlds__make_hlds__add_pred_scalar_common_1[13])));
    }
    {
    ...
    {
      Var_19 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), Var_19, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__add_pred_scalar_common_1[52])));
      MR_hl_field(MR_mktag(1), Var_19, 1) = ((MR_Box) (Var_22));
    }
    {
      Pieces_12 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), Pieces_12, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__add_pred_scalar_common_1[51])));
      MR_hl_field(MR_mktag(1), Pieces_12, 1) = ((MR_Box) (Var_19));
    }
    {
...
{
  {
    ...
    }
    {
      Var_22 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), Var_22, 0) = ((MR_Box) (Var_23));
      MR_hl_field(MR_mktag(1), Var_22, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &hlds__make_hlds__add_pred_scalar_common_1[13])));
    }
    {
      MainPieces_12 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), MainPieces_12, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__add_pred_scalar_common_1[48])));
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), InnerComponents_14, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &hlds__make_hlds__add_pred_scalar_common_1[50])));
    }
    {
      Var_66 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), Var_66, 0) = ((MR_Box) (((MR_Integer) 183 | (((MR_Integer) 0 << (MR_Integer) 10)))));
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(0), Spec_17, 0) = ((MR_Box) (MR_mkword(MR_mktag(1), &hlds__make_hlds__add_pred_scalar_common_2[0])));
...
{
  {
    ...
    mercury__map__f_84_121_112_101_83_112_101_99_79_102_95_95_112_114_101_100_95_95_100_101_116_95_105_110_115_101_114_116_95_95_91_75_32_61_32_105_110_116_93_95_48_95_49_4_p_0((MR_Word) &hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_proc_info_0, *ModeId_28, ((MR_Box) (NewProc_33)), Procs0_29, &Procs_34);
...
{
  {
    ...
    hlds__make_hlds__make_hlds_error__maybe_report_undefined_pred_error_10_p_0(STATE_VARIABLE_ModuleInfo_0_31, PredName_17, Arity_18, PredOrFunc_19, Status_20, IsClassMethod_21, Context_22, DescPieces_24, STATE_VARIABLE_Specs_0_33, &STATE_VARIABLE_Specs_35_35);
      ...
      case (MR_Integer) 1:
        {
          ...
          hlds__make_hlds__add_pred__maybe_check_field_access_function_7_p_0(STATE_VARIABLE_ModuleInfo_0_31, PredName_17, FuncArity_28, Status_20, Context_22, STATE_VARIABLE_Specs_35_35, STATE_VARIABLE_Specs_34);
        }
        break;
      case (MR_Integer) 0:
    ...
    hlds__make_hlds__add_pred__preds_do_add_implicit_12_p_0(STATE_VARIABLE_ModuleInfo_0_31, ModuleName_16, PredName_17, Arity_18, PredOrFunc_19, Status_20, Context_22, Origin_23, ClausesInfo_29, PredId_25, PredicateTable0_27, &PredicateTable_30);
...
{
  {
    ...
    if (succeeded)
    {
      ...
      succeeded = mercury__map__search_3_p_0((MR_Word) &mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0, (MR_Word) &hlds__make_hlds__add_pred_scalar_common_1[2], CtorFieldTable_32, ((MR_Box) (FieldName_15)), &conv0_Var_41);
      if (succeeded)
      {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          TypeInfo_39_49 = (MR_Word) &hlds__make_hlds__add_pred_scalar_common_1[2];
      ...
      if (succeeded)
      {
        ...
        }
        {
          Var_60 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), Var_60, 0) = ((MR_Box) (Var_61));
          MR_hl_field(MR_mktag(1), Var_60, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &hlds__make_hlds__add_pred_scalar_common_1[45])));
        }
        {
          Pieces_55 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), Pieces_55, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__add_pred_scalar_common_1[47])));
...
{
  {
    ...
    Var_46 = mercury__map__init_0_f_0((MR_Word) &hlds__make_hlds__add_pred_scalar_common_1[1], (MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_kind_0);
    ...
    mercury__map__init_1_p_0((MR_Word) &hlds__make_hlds__add_pred_scalar_common_1[0], (MR_Word) &mercury__builtin__builtin__type_ctor_info_string_0, &VarNameRemap_34);
    hlds__hlds_pred__pred_info_init_19_p_0(ModuleName_14, PredName_15, Arity_16, PredOrFunc_17, Context_19, Origin_20, PredStatus_18, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 3)), Markers0_25, Types_29, TVarSet_28, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), (MR_Word) &hlds__make_hlds__add_pred_scalar_common_1[46], Proofs_32, ConstraintMap_33, ClausesInfo_21, VarNameRemap_34, &PredInfo0_35);
