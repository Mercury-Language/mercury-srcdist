...
hlds__make_hlds__add_pred__IntroducedFrom__pred__module_add_mode_decl__753__1_2_p_0(
  MR_Word WithInst_22,
  ...
  else
  {
    ...
    else
    {
      ...
      else
      {
        ...
        succeeded = hlds__hlds_pred__marker_is_present_2_p_0(Markers_52, (MR_Integer) 11);
        if (succeeded)
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = hlds__make_hlds__add_pred__IntroducedFrom__pred__module_add_mode_decl__753__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 4)))));
  return succeeded;
}
