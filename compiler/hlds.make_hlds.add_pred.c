...
MR_decl_label8(hlds__make_hlds__add_pred__add_builtin_5_0, 88,89,90,96,98,99,92,101)
MR_decl_label5(hlds__make_hlds__add_pred__add_builtin_5_0, 103,104,105,106,107)
MR_decl_label8(hlds__make_hlds__add_pred__add_new_pred_15_0, 2,5,6,7,10,11,12,13)
MR_decl_label8(hlds__make_hlds__add_pred__add_new_pred_15_0, 14,15,16,18,20,22,24,27)
MR_decl_label8(hlds__make_hlds__add_pred__add_new_pred_15_0, 28,29,30,31,23,32,33,36)
MR_decl_label8(hlds__make_hlds__add_pred__add_new_pred_15_0, 38,39,40,41,42,43,34,45)
MR_decl_label3(hlds__make_hlds__add_pred__add_new_pred_15_0, 9,47,48)
...
MR_decl_label8(hlds__make_hlds__add_pred__preds_add_implicit_11_0, 2,3,4,5,7,8,9,10)
MR_decl_label8(hlds__make_hlds__add_pred__preds_add_implicit_11_0, 12,14,15,16,17,20,22,18)
...
MR_BEGIN_MODULE(hlds__make_hlds__add_pred_module0)
	...
	MR_init_label8(hlds__make_hlds__add_pred__preds_add_implicit_11_0,2,3,4,5,7,8,9,10)
	MR_init_label8(hlds__make_hlds__add_pred__preds_add_implicit_11_0,12,14,15,16,17,20,22,18)
MR_BEGIN_CODE
...
MR_def_label(hlds__make_hlds__add_pred__preds_add_implicit_11_0,5)
	...
	MR_sv(11) = MR_r1;
	MR_sv(12) = MR_r2;
	MR_sv(16) = (MR_Word) MR_CTOR1_ADDR(term, var);
...
MR_def_label(hlds__make_hlds__add_pred__preds_add_implicit_11_0,8)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(11) = MR_r1;
	MR_sv(13) = (MR_Word) MR_CTOR0_ADDR(parse_tree__prog_data, prog_constraint);
	MR_r1 = MR_sv(13);
...
MR_def_label(hlds__make_hlds__add_pred__preds_add_implicit_11_0,17)
	...
	MR_np_call_localret_ent(hlds__pred_table__predicate_table_search_pf_sym_arity_6_0,
		hlds__make_hlds__add_pred__preds_add_implicit_11_0_i20);
MR_def_label(hlds__make_hlds__add_pred__preds_add_implicit_11_0,20)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_r1) {
...
/*-------------------------------------------------------------------------*/
/* code for 'do_add_new_proc'/11 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
...
/*-------------------------------------------------------------------------*/
/* code for 'unspecified_det_for_local'/6 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(hlds__make_hlds__add_pred__unspecified_det_for_local_6_0)
	...
	MR_tfield(1, MR_tempr3, 0) = (MR_Integer) 147;
...
MR_BEGIN_MODULE(hlds__make_hlds__add_pred_module7)
	...
	MR_init_label8(hlds__make_hlds__add_pred__add_builtin_5_0,88,89,90,96,98,99,92,101)
	MR_init_label5(hlds__make_hlds__add_pred__add_builtin_5_0,103,104,105,106,107)
MR_BEGIN_CODE
...
MR_def_label(hlds__make_hlds__add_pred__add_builtin_5_0,90)
	...
	if (MR_INT_NE(MR_sv(8),0)) {
		MR_GOTO_LAB(hlds__make_hlds__add_pred__add_builtin_5_0_i92);
	}
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tag_alloc_heap(MR_tempr1, 0, (MR_Integer) 2);
	...
	MR_np_call_localret_ent(hlds__hlds_clauses__set_clause_list_2_0,
		hlds__make_hlds__add_pred__add_builtin_5_0_i96);
MR_def_label(hlds__make_hlds__add_pred__add_builtin_5_0,96)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
...
MR_def_label(hlds__make_hlds__add_pred__add_builtin_5_0,98)
	...
	MR_np_call_localret_ent(hlds__hlds_pred__pred_info_get_markers_2_0,
		hlds__make_hlds__add_pred__add_builtin_5_0_i99);
MR_def_label(hlds__make_hlds__add_pred__add_builtin_5_0,99)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
...
MR_BEGIN_MODULE(hlds__make_hlds__add_pred_module9)
	...
	MR_init_label8(hlds__make_hlds__add_pred__add_new_pred_15_0,14,15,16,18,20,22,24,27)
	MR_init_label8(hlds__make_hlds__add_pred__add_new_pred_15_0,28,29,30,31,23,32,33,36)
	MR_init_label8(hlds__make_hlds__add_pred__add_new_pred_15_0,38,39,40,41,42,43,34,45)
	MR_init_label3(hlds__make_hlds__add_pred__add_new_pred_15_0,9,47,48)
MR_BEGIN_CODE
...
MR_def_static(hlds__make_hlds__add_pred__add_new_pred_15_0)
	...
	MR_sv(10) = MR_r10;
	MR_sv(11) = MR_r11;
	MR_sv(12) = (MR_Word) MR_TAG_COMMON(2,7,0);
	MR_r1 = MR_r12;
	MR_sv(21) = MR_r13;
