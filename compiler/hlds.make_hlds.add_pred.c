...
MR_decl_label8(hlds__make_hlds__add_pred__module_do_add_mode_11_0, 4,5,6,7,8,11,10,14)
MR_decl_label2(hlds__make_hlds__add_pred__module_do_add_mode_11_0, 3,17)
...
MR_def_static(hlds__make_hlds__add_pred__unspecified_det_for_local_6_0)
	...
	MR_tfield(1, MR_tempr3, 0) = (MR_Integer) 135;
...
MR_BEGIN_MODULE(hlds__make_hlds__add_pred_module5)
	...
	MR_init_label8(hlds__make_hlds__add_pred__module_do_add_mode_11_0,4,5,6,7,8,11,10,14)
	MR_init_label2(hlds__make_hlds__add_pred__module_do_add_mode_11_0,3,17)
MR_BEGIN_CODE
...
MR_def_label(hlds__make_hlds__add_pred__module_do_add_mode_11_0,7)
	...
	if (MR_INT_NE(MR_sv(5),1)) {
		MR_GOTO_LAB(hlds__make_hlds__add_pred__module_do_add_mode_11_0_i8);
	}
	MR_tag_alloc_heap(MR_tempr2, 3, (MR_Integer) 2);
	...
	MR_tag_alloc_heap(MR_tempr4, 1, (MR_Integer) 2);
	MR_tfield(1, MR_tempr4, 0) = (MR_Word) MR_TAG_COMMON(3,1,8);
	...
	MR_np_call_localret_ent(hlds__make_hlds__add_pred__do_add_new_proc_11_0,
		hlds__make_hlds__add_pred__module_do_add_mode_11_0_i17);
MR_def_label(hlds__make_hlds__add_pred__module_do_add_mode_11_0,8)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(5) = MR_r10;
	MR_r1 = MR_sv(7);
...
MR_def_label(hlds__make_hlds__add_pred__module_do_add_mode_11_0,3)
	...
	MR_np_call_localret_ent(hlds__make_hlds__add_pred__do_add_new_proc_11_0,
		hlds__make_hlds__add_pred__module_do_add_mode_11_0_i17);
MR_def_label(hlds__make_hlds__add_pred__module_do_add_mode_11_0,17)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r3 = MR_sv(1);
	MR_decr_sp_and_return(12);
#ifdef MR_maybe_local_thread_engine_base
...
void mercury__hlds__make_hlds__add_pred__write_out_proc_statics(FILE *fp);
#endif
