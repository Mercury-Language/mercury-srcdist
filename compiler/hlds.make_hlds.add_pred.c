...
hlds__make_hlds__add_pred__preds_do_add_implicit_12_p_0(
  ...
  MR_Word hlds__make_hlds__add_pred__STATE_VARIABLE_PredicateTable_0_43,
  MR_Word * hlds__make_hlds__add_pred__STATE_VARIABLE_PredicateTable_44);
...
static /* final */ const MR_Box hlds__make_hlds__add_pred_scalar_common_4[2][3];

static /* final */ const MR_Box hlds__make_hlds__add_pred_scalar_common_5[2][1];


/* sealed */ struct hlds__make_hlds__add_pred__vector_common_type_3_0_s {
  const MR_String hlds__make_hlds__add_pred__vector_common_type_3_0__vct_3_f_0;
  const MR_Integer hlds__make_hlds__add_pred__vector_common_type_3_0__vct_3_f_1;
};

static /* final */ const struct hlds__make_hlds__add_pred__vector_common_type_3_0_s hlds__make_hlds__add_pred_vector_common_3[4];
...
static /* final */ const MR_Box hlds__make_hlds__add_pred_scalar_common_1[70][2] = {
  ...
  /* row 50 */
  {
    ((MR_Box) (MR_mkword(MR_mktag(2), &hlds__make_hlds__add_pred_scalar_common_1[49]))),
    ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))))
  },
  /* row 51 */
  {
...
static /* final */ const MR_Box hlds__make_hlds__add_pred_scalar_common_4[2][3] = {
  ...
  /* row 1 */
  {
    ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__add_pred_scalar_common_1[64]))),
    ((MR_Box) ((MR_Integer) 0)),
    ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))))
  },
};
...
{
  {
    MR_Word hlds__make_hlds__add_pred__TypeCtorInfo_57_73;
    MR_Word hlds__make_hlds__add_pred__TypeCtorInfo_60_76;
    ...
    MR_Word hlds__make_hlds__add_pred__Markers1_54;
    MR_Word hlds__make_hlds__add_pred__Markers_55;
    ...
    hlds__make_hlds__add_pred__TypeCtorInfo_57_73 = (MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_tvar_type_0;
    mercury__varset__init_1_p_0(hlds__make_hlds__add_pred__TypeCtorInfo_57_73, &hlds__make_hlds__add_pred__TVarSet0_44);
    parse_tree__prog_util__make_n_fresh_vars_5_p_0(hlds__make_hlds__add_pred__TypeCtorInfo_57_73, (MR_String) "T", hlds__make_hlds__add_pred__Arity_14, &hlds__make_hlds__add_pred__TypeVars_45, hlds__make_hlds__add_pred__TVarSet0_44, &hlds__make_hlds__add_pred__TVarSet_46);
    hlds__make_hlds__add_pred__Var_62 = mercury__map__init_0_f_0((MR_Word) &hlds__make_hlds__add_pred_scalar_common_1[1], (MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_kind_0);
    parse_tree__prog_type__var_list_to_type_list_3_p_0(hlds__make_hlds__add_pred__Var_62, hlds__make_hlds__add_pred__TypeVars_45, &hlds__make_hlds__add_pred__Types_47);
    hlds__make_hlds__add_pred__TypeCtorInfo_60_76 = (MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_constraint_0;
    mercury__map__init_1_p_0(hlds__make_hlds__add_pred__TypeCtorInfo_60_76, (MR_Word) &hlds__hlds_data__hlds__hlds_data__type_ctor_info_constraint_proof_0, &hlds__make_hlds__add_pred__Proofs_50);
    mercury__map__init_1_p_0((MR_Word) &hlds__hlds_data__hlds__hlds_data__type_ctor_info_constraint_id_0, hlds__make_hlds__add_pred__TypeCtorInfo_60_76, &hlds__make_hlds__add_pred__ConstraintMap_51);
    ...
    hlds__hlds_pred__pred_info_init_19_p_0(hlds__make_hlds__add_pred__ModuleName_12, hlds__make_hlds__add_pred__PredName_13, hlds__make_hlds__add_pred__Arity_14, hlds__make_hlds__add_pred__PredOrFunc_15, hlds__make_hlds__add_pred__Context_18, hlds__make_hlds__add_pred__Var_27, hlds__make_hlds__add_pred__Status_17, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 3)), hlds__make_hlds__add_pred__Markers0_43, hlds__make_hlds__add_pred__Types_47, hlds__make_hlds__add_pred__TVarSet_46, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), (MR_Word) &hlds__make_hlds__add_pred_scalar_common_1[46], hlds__make_hlds__add_pred__Proofs_50, hlds__make_hlds__add_pred__ConstraintMap_51, hlds__make_hlds__add_pred__ClausesInfo_20, hlds__make_hlds__add_pred__VarNameRemap_52, &hlds__make_hlds__add_pred__PredInfo0_53);
    hlds__hlds_pred__add_marker_3_p_0((MR_Integer) 2, hlds__make_hlds__add_pred__Markers0_43, &hlds__make_hlds__add_pred__Markers1_54);
    hlds__hlds_pred__add_marker_3_p_0((MR_Integer) 4, hlds__make_hlds__add_pred__Markers1_54, &hlds__make_hlds__add_pred__Markers_55);
    hlds__hlds_pred__pred_info_set_markers_3_p_0(hlds__make_hlds__add_pred__Markers_55, hlds__make_hlds__add_pred__PredInfo0_53, &hlds__make_hlds__add_pred__PredInfo_56);
    hlds__pred_table__predicate_table_lookup_pf_sym_arity_6_p_0(hlds__make_hlds__add_pred__PredicateTable0_23, (MR_Integer) 0, hlds__make_hlds__add_pred__PredOrFunc_15, hlds__make_hlds__add_pred__PredName_13, hlds__make_hlds__add_pred__Arity_14, &hlds__make_hlds__add_pred__PredIds_57);
    if ((hlds__make_hlds__add_pred__PredIds_57 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
    {
      MR_Word hlds__make_hlds__add_pred__MQInfo_58;

      hlds__hlds_module__module_info_get_partial_qualifier_info_2_p_0(hlds__make_hlds__add_pred__STATE_VARIABLE_ModuleInfo_0_25, &hlds__make_hlds__add_pred__MQInfo_58);
      hlds__pred_table__predicate_table_insert_qual_6_p_0(hlds__make_hlds__add_pred__PredInfo_56, (MR_Integer) 1, hlds__make_hlds__add_pred__MQInfo_58, hlds__make_hlds__add_pred__PredId_19, hlds__make_hlds__add_pred__PredicateTable0_23, &hlds__make_hlds__add_pred__PredicateTable_24);
    }
    else
    {
      {
        mercury__require__unexpected_2_p_0((MR_String) "predicate \140hlds.make_hlds.add_pred.preds_do_add_implicit\'/12", (MR_String) "search succeeded");
        return;
      }
    }
...
{
  {
    ...
    else
    {
      ...
      if (hlds__make_hlds__add_pred__succeeded)
      {
        ...
        hlds__make_hlds__add_pred__succeeded = hlds__hlds_pred__check_marker_2_p_0(hlds__make_hlds__add_pred__Markers_37, (MR_Integer) 11);
        if (hlds__make_hlds__add_pred__succeeded)
          ...
          *hlds__make_hlds__add_pred__MaybePredProcId_38 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
          ...
          if (hlds__make_hlds__add_pred__succeeded)
          {
            ...
            }
            {
              ...
              MR_hl_field(MR_mktag(1), hlds__make_hlds__add_pred__DetPieces_119, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__add_pred_scalar_common_1[69])));
...
{
  {
    ...
    if (hlds__make_hlds__add_pred__succeeded)
    {
      hlds__make_hlds__add_pred__PredStatus_37 = (MR_Word) ((MR_Box) (MR_mkword(MR_mktag(2), &hlds__make_hlds__add_pred_scalar_common_5[1])));
    }
    else
    ...
    {
      MR_Word hlds__make_hlds__add_pred__TypeCtorInfo_91_91;
      ...
      hlds__make_hlds__add_pred__TypeCtorInfo_91_91 = (MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_constraint_0;
      mercury__map__init_1_p_0(hlds__make_hlds__add_pred__TypeCtorInfo_91_91, (MR_Word) &hlds__hlds_data__hlds__hlds_data__type_ctor_info_constraint_proof_0, &hlds__make_hlds__add_pred__Proofs_51);
      mercury__map__init_1_p_0((MR_Word) &hlds__hlds_data__hlds__hlds_data__type_ctor_info_constraint_id_0, hlds__make_hlds__add_pred__TypeCtorInfo_91_91, &hlds__make_hlds__add_pred__ConstraintMap_52);
...
{
  {
    ...
    if (hlds__make_hlds__add_pred__succeeded)
    {
      ...
      do
      {
        ...
        hlds__make_hlds__add_pred__result_3 = MR_strcmp(hlds__make_hlds__add_pred__Name_11, ((&hlds__make_hlds__add_pred_vector_common_3[0 + hlds__make_hlds__add_pred__mid_2]))->hlds__make_hlds__add_pred__vector_common_type_3_0__vct_3_f_0);
        if ((hlds__make_hlds__add_pred__result_3 == (MR_Integer) 0))
        {
          switch (((&hlds__make_hlds__add_pred_vector_common_3[0 + hlds__make_hlds__add_pred__mid_2]))->hlds__make_hlds__add_pred__vector_common_type_3_0__vct_3_f_1) {
            default: /*NOTREACHED*/ MR_assert(0);
            case (MR_Integer) 0:
              {
    ...
    if (hlds__make_hlds__add_pred__succeeded)
    {
      hlds__make_hlds__add_pred__GoalExpr_21 = (MR_Word) MR_mkword(MR_mktag(3), &hlds__make_hlds__add_pred_scalar_common_4[0]);
    ...
    else
    {
      ...
      if (hlds__make_hlds__add_pred__succeeded)
      {
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(0), hlds__make_hlds__add_pred__Unification_32, 1) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__add_pred_scalar_common_1[64])));
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(1), hlds__make_hlds__add_pred__AssignExpr_34, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &hlds__make_hlds__add_pred_scalar_common_4[1])));
          ...
          MR_hl_field(MR_mktag(1), hlds__make_hlds__add_pred__AssignExpr_34, 4) = ((MR_Box) (&hlds__make_hlds__add_pred_scalar_common_1[65]));
        }
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(3), hlds__make_hlds__add_pred__CastExpr_37, 1) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__add_pred_scalar_common_5[0])));
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(3), hlds__make_hlds__add_pred__GoalExpr_21, 1) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__add_pred_scalar_common_1[66])));
      ...
      else
      {
        ...
        if (hlds__make_hlds__add_pred__succeeded)
        {
          ...
          hlds__make_hlds__add_pred__GoalInfo_22 = hlds__make_hlds__add_pred__GoalInfo1_19;
          {
            ...
            MR_hl_field(MR_mktag(0), hlds__make_hlds__add_pred__ConjGoal_125, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__add_pred_scalar_common_4[0])));
            MR_hl_field(MR_mktag(0), hlds__make_hlds__add_pred__ConjGoal_125, 1) = ((MR_Box) (hlds__make_hlds__add_pred__GoalInfo_22));
          }
          {
            hlds__make_hlds__add_pred__GoalExpr_21 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(3), hlds__make_hlds__add_pred__GoalExpr_21, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 5));
            MR_hl_field(MR_mktag(3), hlds__make_hlds__add_pred__GoalExpr_21, 1) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__add_pred_scalar_common_1[67])));
    ...
    hlds__make_hlds__add_pred__Var_120 = (MR_Integer) 8;
      ...
      if (hlds__make_hlds__add_pred__succeeded)
      {
        ...
        else
        {
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(3), hlds__make_hlds__add_pred__Var_69, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 14));
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(1), hlds__make_hlds__add_pred__Var_88, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__add_pred_scalar_common_1[61])));
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(1), hlds__make_hlds__add_pred__Var_85, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__add_pred_scalar_common_1[60])));
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(1), hlds__make_hlds__add_pred__Var_82, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__add_pred_scalar_common_1[59])));
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(1), hlds__make_hlds__add_pred__Var_77, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__add_pred_scalar_common_1[58])));
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(1), hlds__make_hlds__add_pred__Var_74, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__add_pred_scalar_common_1[57])));
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(1), hlds__make_hlds__add_pred__Var_65, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__add_pred_scalar_common_1[56])));
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(1), hlds__make_hlds__add_pred__Var_62, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__add_pred_scalar_common_1[55])));
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(1), hlds__make_hlds__add_pred__SectionPieces_43, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__add_pred_scalar_common_1[54])));
          ...
          case (MR_Integer) 1:
            {
...

              {
                ...
                MR_hl_field(MR_mktag(3), hlds__make_hlds__add_pred__Var_110, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 14));
              ...
              }
              {
                ...
                MR_hl_field(MR_mktag(1), hlds__make_hlds__add_pred__Var_115, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__add_pred_scalar_common_1[63])));
              ...
              }
              {
                ...
                MR_hl_field(MR_mktag(1), hlds__make_hlds__add_pred__PredModePieces_46, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__add_pred_scalar_common_1[62])));
...
{
  {
...

    {
      ...
      MR_hl_field(MR_mktag(3), hlds__make_hlds__add_pred__Var_20, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 14));
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), hlds__make_hlds__add_pred__Pieces_12, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__add_pred_scalar_common_1[53])));
...
{
  {
    ...
    {
      hlds__make_hlds__add_pred__Var_19 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), hlds__make_hlds__add_pred__Var_19, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__add_pred_scalar_common_1[52])));
      MR_hl_field(MR_mktag(1), hlds__make_hlds__add_pred__Var_19, 1) = ((MR_Box) (hlds__make_hlds__add_pred__Var_22));
    }
    {
      hlds__make_hlds__add_pred__Pieces_12 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), hlds__make_hlds__add_pred__Pieces_12, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__add_pred_scalar_common_1[51])));
      MR_hl_field(MR_mktag(1), hlds__make_hlds__add_pred__Pieces_12, 1) = ((MR_Box) (hlds__make_hlds__add_pred__Var_19));
    }
    {
...
{
  {
    ...
    {
      hlds__make_hlds__add_pred__Var_23 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(3), hlds__make_hlds__add_pred__Var_23, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 15));
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), hlds__make_hlds__add_pred__MainPieces_12, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__add_pred_scalar_common_1[48])));
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), hlds__make_hlds__add_pred__InnerComponents_14, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &hlds__make_hlds__add_pred_scalar_common_1[50])));
    }
    {
      ...
      MR_hl_field(MR_mktag(1), hlds__make_hlds__add_pred__Var_66, 0) = ((MR_Box) (((MR_Integer) 183 | (((MR_Integer) 0 << (MR_Integer) 10)))));
    ...
    if (hlds__make_hlds__add_pred__succeeded)
    {
      ...
      if (hlds__make_hlds__add_pred__succeeded)
      {
...

        {
          ...
          MR_hl_field(MR_mktag(3), hlds__make_hlds__add_pred__Var_61, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 15));
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(1), hlds__make_hlds__add_pred__Pieces_55, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__add_pred_scalar_common_1[47])));
...
{
  {
    MR_Word hlds__make_hlds__add_pred__TypeCtorInfo_57_57;
    ...
    MR_Word hlds__make_hlds__add_pred__Markers1_36;
    MR_Word hlds__make_hlds__add_pred__Markers_37;
    MR_Word hlds__make_hlds__add_pred__PredInfo_38;
    MR_Word hlds__make_hlds__add_pred__PredIds_39;
    MR_Word hlds__make_hlds__add_pred__Var_46;

    hlds__hlds_pred__init_markers_1_p_0(&hlds__make_hlds__add_pred__Markers0_25);
    hlds__make_hlds__add_pred__TypeCtorInfo_57_57 = (MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_tvar_type_0;
    mercury__varset__init_1_p_0(hlds__make_hlds__add_pred__TypeCtorInfo_57_57, &hlds__make_hlds__add_pred__TVarSet0_26);
    parse_tree__prog_util__make_n_fresh_vars_5_p_0(hlds__make_hlds__add_pred__TypeCtorInfo_57_57, (MR_String) "T", hlds__make_hlds__add_pred__Arity_16, &hlds__make_hlds__add_pred__TypeVars_27, hlds__make_hlds__add_pred__TVarSet0_26, &hlds__make_hlds__add_pred__TVarSet_28);
    hlds__make_hlds__add_pred__Var_46 = mercury__map__init_0_f_0((MR_Word) &hlds__make_hlds__add_pred_scalar_common_1[1], (MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_kind_0);
    parse_tree__prog_type__var_list_to_type_list_3_p_0(hlds__make_hlds__add_pred__Var_46, hlds__make_hlds__add_pred__TypeVars_27, &hlds__make_hlds__add_pred__Types_29);
    hlds__make_hlds__add_pred__TypeCtorInfo_60_60 = (MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_constraint_0;
    mercury__map__init_1_p_0(hlds__make_hlds__add_pred__TypeCtorInfo_60_60, (MR_Word) &hlds__hlds_data__hlds__hlds_data__type_ctor_info_constraint_proof_0, &hlds__make_hlds__add_pred__Proofs_32);
    mercury__map__init_1_p_0((MR_Word) &hlds__hlds_data__hlds__hlds_data__type_ctor_info_constraint_id_0, hlds__make_hlds__add_pred__TypeCtorInfo_60_60, &hlds__make_hlds__add_pred__ConstraintMap_33);
    ...
    hlds__hlds_pred__pred_info_init_19_p_0(hlds__make_hlds__add_pred__ModuleName_14, hlds__make_hlds__add_pred__PredName_15, hlds__make_hlds__add_pred__Arity_16, hlds__make_hlds__add_pred__PredOrFunc_17, hlds__make_hlds__add_pred__Context_19, hlds__make_hlds__add_pred__Origin_20, hlds__make_hlds__add_pred__PredStatus_18, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 3)), hlds__make_hlds__add_pred__Markers0_25, hlds__make_hlds__add_pred__Types_29, hlds__make_hlds__add_pred__TVarSet_28, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), (MR_Word) &hlds__make_hlds__add_pred_scalar_common_1[46], hlds__make_hlds__add_pred__Proofs_32, hlds__make_hlds__add_pred__ConstraintMap_33, hlds__make_hlds__add_pred__ClausesInfo_21, hlds__make_hlds__add_pred__VarNameRemap_34, &hlds__make_hlds__add_pred__PredInfo0_35);
    hlds__hlds_pred__add_marker_3_p_0((MR_Integer) 2, hlds__make_hlds__add_pred__Markers0_25, &hlds__make_hlds__add_pred__Markers1_36);
    hlds__hlds_pred__add_marker_3_p_0((MR_Integer) 4, hlds__make_hlds__add_pred__Markers1_36, &hlds__make_hlds__add_pred__Markers_37);
    hlds__hlds_pred__pred_info_set_markers_3_p_0(hlds__make_hlds__add_pred__Markers_37, hlds__make_hlds__add_pred__PredInfo0_35, &hlds__make_hlds__add_pred__PredInfo_38);
    hlds__pred_table__predicate_table_lookup_pf_sym_arity_6_p_0(hlds__make_hlds__add_pred__STATE_VARIABLE_PredicateTable_0_43, (MR_Integer) 0, hlds__make_hlds__add_pred__PredOrFunc_17, hlds__make_hlds__add_pred__PredName_15, hlds__make_hlds__add_pred__Arity_16, &hlds__make_hlds__add_pred__PredIds_39);
    if ((hlds__make_hlds__add_pred__PredIds_39 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
    {
      MR_Word hlds__make_hlds__add_pred__MQInfo_40;

      hlds__hlds_module__module_info_get_partial_qualifier_info_2_p_0(hlds__make_hlds__add_pred__ModuleInfo_13, &hlds__make_hlds__add_pred__MQInfo_40);
      hlds__pred_table__predicate_table_insert_qual_6_p_0(hlds__make_hlds__add_pred__PredInfo_38, (MR_Integer) 1, hlds__make_hlds__add_pred__MQInfo_40, hlds__make_hlds__add_pred__PredId_22, hlds__make_hlds__add_pred__STATE_VARIABLE_PredicateTable_0_43, hlds__make_hlds__add_pred__STATE_VARIABLE_PredicateTable_44);
    }
    else
    {
      {
