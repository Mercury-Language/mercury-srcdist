...
MR_decl_label10(hlds__make_hlds__add_pred__add_builtin_5_0, 26,69,70,68,78,80,81,85,86,87)
MR_decl_label10(hlds__make_hlds__add_pred__add_builtin_5_0, 88,89,90,96,98,99,92,101,103,104)
MR_decl_label3(hlds__make_hlds__add_pred__add_builtin_5_0, 105,106,107)
MR_decl_label10(hlds__make_hlds__add_pred__add_new_pred_15_0, 2,5,6,7,10,11,12,13,14,15)
MR_decl_label10(hlds__make_hlds__add_pred__add_new_pred_15_0, 16,18,19,21,22,25,26,29,31,32)
MR_decl_label10(hlds__make_hlds__add_pred__add_new_pred_15_0, 33,34,35,36,27,38,24,39,40,41)
MR_decl_label5(hlds__make_hlds__add_pred__add_new_pred_15_0, 42,43,9,44,45)
MR_decl_label8(hlds__make_hlds__add_pred__do_add_new_proc_12_0, 2,3,4,5,6,7,8,9)
MR_decl_label10(hlds__make_hlds__add_pred__module_add_mode_13_0, 2,3,4,5,6,7,13,14,15,16)
MR_decl_label5(hlds__make_hlds__add_pred__module_add_mode_13_0, 17,18,19,20,21)
...
MR_decl_label6(hlds__make_hlds__add_pred__preds_add_implicit_11_0, 13,14,15,16,19,18)
MR_decl_label10(hlds__make_hlds__add_pred__preds_add_implicit_for_assertion_11_0, 2,3,4,6,7,8,9,10,11,13)
MR_decl_label7(hlds__make_hlds__add_pred__preds_add_implicit_for_assertion_11_0, 14,15,16,17,18,21,20)
...
{
4,
MR_string_const("mode declaration", 16)
},
{
4,
...
MR_BEGIN_MODULE(hlds__make_hlds__add_pred_module0)
	...
	MR_init_label6(hlds__make_hlds__add_pred__preds_add_implicit_11_0,13,14,15,16,19,18)
MR_BEGIN_CODE
...
MR_def_label(hlds__make_hlds__add_pred__module_do_add_mode_11_0,11)
	...
	MR_tfield(2, MR_tempr2, 0) = (MR_Word) MR_TAG_COMMON(1,0,6);
...
MR_BEGIN_MODULE(hlds__make_hlds__add_pred_module6)
	...
	MR_init_label10(hlds__make_hlds__add_pred__module_add_mode_13_0,2,3,4,5,6,7,13,14,15,16)
	MR_init_label5(hlds__make_hlds__add_pred__module_add_mode_13_0,17,18,19,20,21)
MR_BEGIN_CODE
...
MR_def_label(hlds__make_hlds__add_pred__module_add_mode_13_0,5)
	...
	MR_r5 = MR_sv(4);
	MR_np_call_localret_ent(hlds__pred_table__predicate_table_lookup_pf_sym_arity_6_0,
		hlds__make_hlds__add_pred__module_add_mode_13_0_i6);
MR_def_label(hlds__make_hlds__add_pred__module_add_mode_13_0,6)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TEST(MR_r1,0,0)) {
		MR_GOTO_LAB(hlds__make_hlds__add_pred__module_add_mode_13_0_i7);
	}
...
MR_def_label(hlds__make_hlds__add_pred__module_add_mode_13_0,7)
	...
	MR_r6 = MR_sv(3);
	MR_r7 = MR_sv(2);
	MR_r9 = (MR_Word) MR_TAG_COMMON(1,0,9);
	MR_r10 = MR_sv(11);
	MR_r11 = MR_sv(12);
	}
...
MR_BEGIN_MODULE(hlds__make_hlds__add_pred_module7)
	...
	MR_init_label10(hlds__make_hlds__add_pred__add_builtin_5_0,26,69,70,68,78,80,81,85,86,87)
	MR_init_label10(hlds__make_hlds__add_pred__add_builtin_5_0,88,89,90,96,98,99,92,101,103,104)
	MR_init_label3(hlds__make_hlds__add_pred__add_builtin_5_0,105,106,107)
MR_BEGIN_CODE
...
MR_def_label(hlds__make_hlds__add_pred__add_builtin_5_0,33)
	...
	MR_tfield(1, MR_tempr3, 4) = (MR_Word) MR_TAG_COMMON(0,0,7);
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(parse_tree__prog_data, prog_var_type);
	MR_r2 = MR_tempr4;
	}
...
MR_def_label(hlds__make_hlds__add_pred__add_builtin_5_0,60)
	...
	MR_tfield(3, MR_tempr1, 1) = (MR_Word) MR_TAG_COMMON(2,6,0);
...
MR_def_static(hlds__make_hlds__add_pred__unqualified_pred_error_5_0)
	...
	MR_tag_alloc_heap(MR_r2, 1, (MR_Integer) 2);
	MR_tfield(1, MR_r2, 0) = (MR_Word) MR_TAG_COMMON(3,1,11);
...
MR_BEGIN_MODULE(hlds__make_hlds__add_pred_module9)
	...
	MR_init_label10(hlds__make_hlds__add_pred__add_new_pred_15_0,16,18,19,21,22,25,26,29,31,32)
	MR_init_label10(hlds__make_hlds__add_pred__add_new_pred_15_0,33,34,35,36,27,38,24,39,40,41)
	MR_init_label5(hlds__make_hlds__add_pred__add_new_pred_15_0,42,43,9,44,45)
MR_BEGIN_CODE
...
MR_def_label(hlds__make_hlds__add_pred__add_new_pred_15_0,22)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
		MR_GOTO_LAB(hlds__make_hlds__add_pred__add_new_pred_15_0_i24);
	}
	MR_r1 = MR_sv(19);
	MR_np_call_localret_ent(hlds__hlds_module__module_info_get_partial_qualifier_info_2_0,
...
MR_def_label(hlds__make_hlds__add_pred__add_new_pred_15_0,29)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(hlds__make_hlds__add_pred__add_new_pred_15_0_i27);
	}
	MR_r1 = MR_sv(19);
	MR_np_call_localret_ent(hlds__hlds_module__module_info_get_globals_2_0,
...
MR_BEGIN_MODULE(hlds__make_hlds__add_pred_module11)
	...
	MR_init_label7(hlds__make_hlds__add_pred__preds_add_implicit_for_assertion_11_0,14,15,16,17,18,21,20)
MR_BEGIN_CODE
...
void mercury__hlds__make_hlds__add_pred__write_out_proc_statics(FILE *deep_fp, FILE *procrep_fp)
{
	MR_write_out_module_proc_reps_start(procrep_fp, &mercury_data__module_layout__hlds__make_hlds__add_pred);
