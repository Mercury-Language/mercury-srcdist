  ...
  MR_Word * STATE_VARIABLE_PredInfo_62)
{
  ...
  MR_Word Markers_60;
  MR_Word Var_109;
  MR_Word STATE_VARIABLE_PredInfo_1_112;
  MR_Word Var_124;
  ...
  else
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        MR_Word ConjGoal_118;

        GoalInfo_24 = GoalInfo1_21;
        {
          ConjGoal_118 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(0, ConjGoal_118, 0) = ((MR_Box) (MR_mkword(3, &hlds__make_hlds__add_pred_scalar_common_3[0])));
          MR_hl_field(0, ConjGoal_118, 1) = ((MR_Box) (GoalInfo1_21));
        }
        {
          GoalExpr_23 = (MR_Word) MR_mkword(3, MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(3, GoalExpr_23, 0) = ((MR_Box) ((MR_Unsigned) 5U));
          MR_hl_field(3, GoalExpr_23, 1) = ((MR_Box) (MR_mkword(3, &hlds__make_hlds__add_pred_scalar_common_1[55])));
          MR_hl_field(3, GoalExpr_23, 2) = ((MR_Box) (ConjGoal_118));
        }
        HeadVars_25 = HeadVars0_18;
        HeadTypes_26 = HeadTypes0_10;
        VarSet_27 = VarSet0_16;
    ...
    case (MR_Integer) 0:
      {
        ...
        {
          Clause_50 = (MR_Word) MR_new_object(MR_Word, (6 * sizeof(MR_Word)), NULL, NULL);
        ...
        }
        {
          ...
          MR_hl_field(1, Var_106, 0) = ((MR_Box) (Clause_50));
          MR_hl_field(1, Var_106, 1) = ((MR_Box) ((MR_Unsigned) 0U));
        }
        hlds__hlds_clauses__set_clause_list_2_p_0(Var_106, &ClausesRep_51);
        {
          ...
          MR_hl_field(0, ClausesInfo_56, 7) = ((MR_Box) (Var_109));
          MR_hl_field(0, ClausesInfo_56, 8) = (MR_Box) (((((MR_Unsigned) ((MR_Integer) 0) << 1)) | (MR_Unsigned) ((MR_Integer) 0)));
        }
        hlds__hlds_pred__pred_info_set_clauses_info_3_p_0(ClausesInfo_56, STATE_VARIABLE_PredInfo_0_61, &STATE_VARIABLE_PredInfo_1_112);
        hlds__hlds_pred__pred_info_get_markers_2_p_0(STATE_VARIABLE_PredInfo_1_112, &Markers0_57);
    ...
    case (MR_Integer) 1:
      {
        ...
        hlds__hlds_clauses__set_clause_list_2_p_0((MR_Word) ((MR_Unsigned) 0U), &ClausesRep_134);
        {
          ...
          MR_hl_field(0, ClausesInfo_135, 0) = ((MR_Box) (VarSet_27));
          MR_hl_field(0, ClausesInfo_135, 1) = ((MR_Box) (ExplicitVarTypes_52));
          MR_hl_field(0, ClausesInfo_135, 2) = ((MR_Box) (VarTable_53));
          MR_hl_field(0, ClausesInfo_135, 3) = ((MR_Box) (RttiVarMaps_54));
          MR_hl_field(0, ClausesInfo_135, 4) = ((MR_Box) (TVarNameMap_55));
          MR_hl_field(0, ClausesInfo_135, 5) = ((MR_Box) (ProcArgVector_17));
          MR_hl_field(0, ClausesInfo_135, 6) = ((MR_Box) (ClausesRep_134));
          MR_hl_field(0, ClausesInfo_135, 7) = ((MR_Box) (Var_109));
          MR_hl_field(0, ClausesInfo_135, 8) = (MR_Box) (((((MR_Unsigned) ((MR_Integer) 0) << 1)) | (MR_Unsigned) ((MR_Integer) 0)));
        }
        hlds__hlds_pred__pred_info_set_clauses_info_3_p_0(ClausesInfo_135, STATE_VARIABLE_PredInfo_0_61, &STATE_VARIABLE_PredInfo_1_112);
        hlds__hlds_pred__pred_info_get_markers_2_p_0(STATE_VARIABLE_PredInfo_1_112, &Markers0_136);
        hlds__hlds_markers__add_marker_3_p_0((MR_Integer) 8, Markers0_136, &Markers1_137);
        hlds__hlds_markers__add_marker_3_p_0((MR_Integer) 0, Markers1_137, &Markers2_59);
        hlds__hlds_markers__add_marker_3_p_0((MR_Integer) 1, Markers2_59, &Markers_60);
      }
      break;
  }
  hlds__hlds_pred__pred_info_set_markers_3_p_0(Markers_60, STATE_VARIABLE_PredInfo_1_112, STATE_VARIABLE_PredInfo_62);
}
