...
MR_decl_label10(hlds__make_hlds__add_pred__add_builtin_5_0, 14,15,18,19,22,17,13,26,27,30)
MR_decl_label10(hlds__make_hlds__add_pred__add_builtin_5_0, 32,47,48,51,52,53,57,58,59,25)
MR_decl_label10(hlds__make_hlds__add_pred__add_builtin_5_0, 68,69,67,77,79,80,83,84,85,86)
...
MR_decl_label10(hlds__make_hlds__add_pred__module_do_add_mode_11_0, 4,5,6,7,11,13,10,32,3,35)
MR_decl_label10(hlds__make_hlds__add_pred__preds_add_implicit_11_0, 2,3,4,5,7,8,9,10,12,14)
MR_decl_label6(hlds__make_hlds__add_pred__preds_add_implicit_11_0, 15,16,17,20,22,18)
MR_decl_label10(hlds__make_hlds__add_pred__preds_add_implicit_for_assertion_11_0, 2,3,4,6,7,9,10,11,12,14)
MR_decl_label7(hlds__make_hlds__add_pred__preds_add_implicit_for_assertion_11_0, 16,17,18,19,22,24,20)
...
MR_BEGIN_MODULE(hlds__make_hlds__add_pred_module0)
	...
	MR_init_label6(hlds__make_hlds__add_pred__preds_add_implicit_11_0,15,16,17,20,22,18)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(hlds__make_hlds__add_pred_module2)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__hlds__make_hlds__add_pred__do_add_new_proc_11_0);
...
MR_BEGIN_MODULE(hlds__make_hlds__add_pred_module3)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__hlds__make_hlds__add_pred__unspecified_det_for_local_6_0);
MR_BEGIN_CODE
...
MR_def_static(hlds__make_hlds__add_pred__unspecified_det_for_local_6_0)
	...
	MR_tfield(1, MR_tempr3, 0) = (MR_Integer) 148;
...
MR_BEGIN_MODULE(hlds__make_hlds__add_pred_module5)
	...
	MR_init_label10(hlds__make_hlds__add_pred__module_do_add_mode_11_0,4,5,6,7,11,13,10,32,3,35)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(hlds__make_hlds__add_pred_module7)
	...
	MR_init_label10(hlds__make_hlds__add_pred__add_builtin_5_0,14,15,18,19,22,17,13,26,27,30)
	MR_init_label10(hlds__make_hlds__add_pred__add_builtin_5_0,32,47,48,51,52,53,57,58,59,25)
	MR_init_label10(hlds__make_hlds__add_pred__add_builtin_5_0,68,69,67,77,79,80,83,84,85,86)
...
MR_BEGIN_MODULE(hlds__make_hlds__add_pred_module11)
	...
	MR_init_label7(hlds__make_hlds__add_pred__preds_add_implicit_for_assertion_11_0,16,17,18,19,22,24,20)
MR_BEGIN_CODE
