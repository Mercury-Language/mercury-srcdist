...
MR_decl_label8(hlds__make_hlds__add_pred__add_new_pred_15_0, 12,13,14,15,16,17,18,20)
MR_decl_label8(hlds__make_hlds__add_pred__add_new_pred_15_0, 23,24,25,26,27,19,28,29)
MR_decl_label7(hlds__make_hlds__add_pred__add_new_pred_15_0, 32,34,35,36,37,30,39)
MR_decl_label7(hlds__make_hlds__add_pred__do_add_new_proc_11_0, 2,3,4,5,6,7,8)
...
MR_decl_label6(hlds__make_hlds__add_pred__preds_add_implicit_11_0, 10,11,12,15,17,13)
MR_decl_label8(hlds__make_hlds__add_pred__preds_add_implicit_for_assertion_11_0, 2,3,4,5,6,7,8,9)
MR_decl_label8(hlds__make_hlds__add_pred__preds_add_implicit_for_assertion_11_0, 10,11,12,13,14,17,19,15)
...
MR_BEGIN_MODULE(hlds__make_hlds__add_pred_module0)
	...
	MR_init_label6(hlds__make_hlds__add_pred__preds_add_implicit_11_0,10,11,12,15,17,13)
MR_BEGIN_CODE
...
MR_def_label(hlds__make_hlds__add_pred__preds_add_implicit_11_0,15)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_r1) {
		MR_GOTO_LAB(hlds__make_hlds__add_pred__preds_add_implicit_11_0_i13);
	}
	MR_r1 = MR_sv(1);
...
MR_decl_entry(hlds__hlds_pred__proc_info_init_9_0);
...
MR_BEGIN_MODULE(hlds__make_hlds__add_pred_module2)
	...
	MR_init_label7(hlds__make_hlds__add_pred__do_add_new_proc_11_0,2,3,4,5,6,7,8)
MR_BEGIN_CODE
...
MR_def_label(hlds__make_hlds__add_pred__do_add_new_proc_11_0,4)
	...
	MR_r7 = MR_sv(6);
	MR_r8 = MR_sv(8);
	MR_np_call_localret_ent(hlds__hlds_pred__proc_info_init_9_0,
...
MR_def_static(hlds__make_hlds__add_pred__unspecified_det_for_local_6_0)
	...
	MR_tfield(1, MR_tempr3, 0) = (MR_Integer) 131;
...
MR_def_label(hlds__make_hlds__add_pred__module_do_add_mode_11_0,7)
	...
	MR_tfield(1, MR_tempr5, 1) = (MR_Word) MR_TAG_COMMON(1,0,2);
...
MR_def_label(hlds__make_hlds__add_pred__add_builtin_4_0,9)
	...
	MR_sv(16) = (MR_Word) MR_TAG_COMMON(0,0,9);
	MR_r1 = MR_sv(16);
	MR_r2 = MR_sv(6);
...
MR_BEGIN_MODULE(hlds__make_hlds__add_pred_module9)
	...
	MR_init_label8(hlds__make_hlds__add_pred__add_new_pred_15_0,12,13,14,15,16,17,18,20)
	MR_init_label8(hlds__make_hlds__add_pred__add_new_pred_15_0,23,24,25,26,27,19,28,29)
	MR_init_label7(hlds__make_hlds__add_pred__add_new_pred_15_0,32,34,35,36,37,30,39)
MR_BEGIN_CODE
...
MR_def_label(hlds__make_hlds__add_pred__add_new_pred_15_0,20)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(hlds__make_hlds__add_pred__add_new_pred_15_0_i19);
	}
	if (MR_LTAGS_TEST(MR_r2,0,0)) {
		MR_GOTO_LAB(hlds__make_hlds__add_pred__add_new_pred_15_0_i19);
	}
	...
	MR_np_call_localret_ent(hlds__hlds_module__module_info_pred_info_3_0,
		hlds__make_hlds__add_pred__add_new_pred_15_0_i23);
...
MR_def_label(hlds__make_hlds__add_pred__add_new_pred_15_0,32)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(hlds__make_hlds__add_pred__add_new_pred_15_0_i30);
	}
	MR_r1 = MR_sv(2);
	MR_r2 = MR_sv(4);
	MR_r3 = MR_sv(1);
	MR_np_call_localret_ent(hlds__make_hlds__add_pred__add_builtin_4_0,
		hlds__make_hlds__add_pred__add_new_pred_15_0_i34);
...
MR_BEGIN_MODULE(hlds__make_hlds__add_pred_module11)
	...
	MR_init_label8(hlds__make_hlds__add_pred__preds_add_implicit_for_assertion_11_0,10,11,12,13,14,17,19,15)
MR_BEGIN_CODE
...
MR_def_label(hlds__make_hlds__add_pred__preds_add_implicit_for_assertion_11_0,17)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_r1) {
		MR_GOTO_LAB(hlds__make_hlds__add_pred__preds_add_implicit_for_assertion_11_0_i15);
	}
	MR_r1 = MR_sv(1);
	MR_np_call_localret_ent(hlds__hlds_module__module_info_get_partial_qualifier_info_2_0,
