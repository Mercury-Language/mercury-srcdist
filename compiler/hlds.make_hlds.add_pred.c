...
static /* final */ const MR_Box hlds__make_hlds__add_pred_scalar_common_1[51][2];

static /* final */ const MR_Box hlds__make_hlds__add_pred_scalar_common_2[6][1];
...
static /* final */ const MR_Box hlds__make_hlds__add_pred_scalar_common_1[51][2] = {
  ...
  /* row 45 */
  {
    ((MR_Box) (MR_mkword(MR_mktag(2), &hlds__make_hlds__add_pred_scalar_common_1[44]))),
    ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))))
  },
  /* row 46 */
  {
  ...
  /* row 50 */
  {
    ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__add_pred_scalar_common_1[49]))),
    ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))))
  },
};
...
#line 677 "hlds.make_hlds.add_pred.c"
static const MR_FA_PseudoTypeInfo_Struct1 hlds__make_hlds__add_pred__list__pti_list_1__plain_hlds__hlds_pred__type_ctor_info_marker_0 = {
...
#line 769 "hlds.make_hlds.add_pred.c"
...
#line 545 "add_pred.m"
      MR_hl_field(MR_mktag(1), hlds__make_hlds__add_pred__V_17_17, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &hlds__make_hlds__add_pred_scalar_common_1[50])));
#line 545 "add_pred.m"
    }
#line 544 "add_pred.m"
    {
...
#line 544 "add_pred.m"
      MR_hl_field(MR_mktag(1), hlds__make_hlds__add_pred__Pieces_10, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__add_pred_scalar_common_1[48])));
#line 544 "add_pred.m"
...
#line 524 "add_pred.m"
      MR_hl_field(MR_mktag(1), hlds__make_hlds__add_pred__V_19_19, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__add_pred_scalar_common_1[47])));
#line 524 "add_pred.m"
...
#line 523 "add_pred.m"
      MR_hl_field(MR_mktag(1), hlds__make_hlds__add_pred__Pieces_12, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__add_pred_scalar_common_1[46])));
#line 523 "add_pred.m"
...
#line 511 "add_pred.m"
      MR_hl_field(MR_mktag(1), hlds__make_hlds__add_pred__InnerComponents_14, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &hlds__make_hlds__add_pred_scalar_common_1[45])));
#line 511 "add_pred.m"
    }
#line 514 "add_pred.m"
    {
...
#line 1769 "hlds.make_hlds.add_pred.c"
...
#line 1771 "hlds.make_hlds.add_pred.c"
...
#line 2373 "hlds.make_hlds.add_pred.c"
      {
#line 2375 "hlds.make_hlds.add_pred.c"
        MR_Word hlds__make_hlds__add_pred__Goal_49;
#line 2377 "hlds.make_hlds.add_pred.c"
        MR_Word hlds__make_hlds__add_pred__Clause_50;
#line 2379 "hlds.make_hlds.add_pred.c"
        MR_Word hlds__make_hlds__add_pred__ClausesRep_51;
#line 2381 "hlds.make_hlds.add_pred.c"
        MR_Word hlds__make_hlds__add_pred__ClausesInfo_56;
#line 2383 "hlds.make_hlds.add_pred.c"
        MR_Word hlds__make_hlds__add_pred__Markers0_57;
#line 2385 "hlds.make_hlds.add_pred.c"
...
#line 2468 "hlds.make_hlds.add_pred.c"
      }
#line 2470 "hlds.make_hlds.add_pred.c"
    else
#line 2472 "hlds.make_hlds.add_pred.c"
      {
#line 2474 "hlds.make_hlds.add_pred.c"
        MR_Word hlds__make_hlds__add_pred__Markers2_59;
#line 2476 "hlds.make_hlds.add_pred.c"
        MR_Word hlds__make_hlds__add_pred__ClausesRep_148;
#line 2478 "hlds.make_hlds.add_pred.c"
        MR_Word hlds__make_hlds__add_pred__ClausesInfo_149;
#line 2480 "hlds.make_hlds.add_pred.c"
        MR_Word hlds__make_hlds__add_pred__Markers0_150;
#line 2482 "hlds.make_hlds.add_pred.c"
...
#line 3029 "hlds.make_hlds.add_pred.c"
...
#line 3304 "hlds.make_hlds.add_pred.c"
...
#line 3326 "hlds.make_hlds.add_pred.c"
...
#line 3931 "hlds.make_hlds.add_pred.c"
    if (hlds__make_hlds__add_pred__succeeded)
#line 3933 "hlds.make_hlds.add_pred.c"
      {
#line 150 "add_pred.m"
...
#line 3941 "hlds.make_hlds.add_pred.c"
      }
#line 3943 "hlds.make_hlds.add_pred.c"
    else
#line 3945 "hlds.make_hlds.add_pred.c"
      {
#line 126 "add_pred.m"
...
#line 4012 "hlds.make_hlds.add_pred.c"
...
#line 4069 "hlds.make_hlds.add_pred.c"
          }
#line 4071 "hlds.make_hlds.add_pred.c"
        else
#line 148 "add_pred.m"
...
#line 4128 "hlds.make_hlds.add_pred.c"
      }
#line 105 "add_pred.m"
  }
#line 33 "add_pred.m"
