...
MR_decl_label8(hlds__make_hlds__add_pred__add_builtin_4_0, 10,11,13,14,12,18,19,22)
MR_decl_label8(hlds__make_hlds__add_pred__add_builtin_4_0, 23,24,25,26,27,28,29,30)
MR_decl_label8(hlds__make_hlds__add_pred__add_builtin_4_0, 31,17,33,34,32,37,40,41)
MR_decl_label8(hlds__make_hlds__add_pred__add_builtin_4_0, 42,43,44,45,46,47,48,49)
...
MR_BEGIN_MODULE(hlds__make_hlds__add_pred_module7)
	...
	MR_init_label8(hlds__make_hlds__add_pred__add_builtin_4_0,10,11,13,14,12,18,19,22)
	MR_init_label8(hlds__make_hlds__add_pred__add_builtin_4_0,23,24,25,26,27,28,29,30)
	MR_init_label8(hlds__make_hlds__add_pred__add_builtin_4_0,31,17,33,34,32,37,40,41)
	MR_init_label8(hlds__make_hlds__add_pred__add_builtin_4_0,42,43,44,45,46,47,48,49)
MR_BEGIN_CODE
...
MR_def_label(hlds__make_hlds__add_pred__add_builtin_4_0,14)
	...
	MR_sv(4) = MR_sv(7);
	MR_r1 = MR_sv(16);
	MR_GOTO_LAB(hlds__make_hlds__add_pred__add_builtin_4_0_i40);
	}
MR_def_label(hlds__make_hlds__add_pred__add_builtin_4_0,12)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_np_call_localret_ent(fn__mdbcomp__prim_data__mercury_private_builtin_module_0_0,
		hlds__make_hlds__add_pred__add_builtin_4_0_i18);
MR_def_label(hlds__make_hlds__add_pred__add_builtin_4_0,18)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_r1;
	MR_r1 = MR_sv(3);
	MR_np_call_localret_ent(__Unify___mdbcomp__prim_data__sym_name_0_0,
		hlds__make_hlds__add_pred__add_builtin_4_0_i19);
MR_def_label(hlds__make_hlds__add_pred__add_builtin_4_0,19)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
...
MR_def_label(hlds__make_hlds__add_pred__add_builtin_4_0,22)
	...
	MR_np_call_localret_ent(fn__parse_tree__prog_type__int_type_0_0,
		hlds__make_hlds__add_pred__add_builtin_4_0_i23);
MR_def_label(hlds__make_hlds__add_pred__add_builtin_4_0,23)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	...
	MR_np_call_localret_ent(fn__set__make_singleton_set_1_0,
		hlds__make_hlds__add_pred__add_builtin_4_0_i24);
MR_def_label(hlds__make_hlds__add_pred__add_builtin_4_0,24)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_sv(9);
	MR_np_call_localret_ent(hlds__hlds_goal__goal_info_set_nonlocals_3_0,
...
MR_def_label(hlds__make_hlds__add_pred__add_builtin_4_0,34)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(hlds__make_hlds__add_pred__add_builtin_4_0_i32);
	}
...
MR_def_label(hlds__make_hlds__add_pred__add_builtin_4_0,40)
	...
	MR_sv(16) = MR_r1;
	MR_np_call_localret_ent(fn__f_108_105_115_116_95_95_43_43_2_0,
		hlds__make_hlds__add_pred__add_builtin_4_0_i41);
MR_def_label(hlds__make_hlds__add_pred__add_builtin_4_0,41)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r3 = MR_sv(2);
	MR_sv(2) = MR_r1;
	...
	MR_r2 = MR_sv(3);
	MR_np_call_localret_ent(fn__f_108_105_115_116_95_95_43_43_2_0,
		hlds__make_hlds__add_pred__add_builtin_4_0_i42);
MR_def_label(hlds__make_hlds__add_pred__add_builtin_4_0,42)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r4 = MR_r1;
	MR_r1 = MR_sv(16);
	...
	MR_np_call_localret_ent(map__from_corresponding_lists_3_0,
		hlds__make_hlds__add_pred__add_builtin_4_0_i43);
