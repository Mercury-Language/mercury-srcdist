  ...
  MR_Word * Succeeded_12)
{
  ...
  parse_tree__file_names__module_name_to_file_name_7_p_0(Globals_8, (MR_String) "predicate \140top_level.mercury_compile_llds_back_end.llds_c_to_obj\'/7", (MR_Word) (MR_mkword(3, &top_level__mercury_compile_llds_back_end_scalar_common_2[5])), ModuleName_11, &C_File_18);
  {
    Var_27 = (MR_Word) MR_mkword(3, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(3, Var_27, 0) = ((MR_Box) ((MR_Unsigned) 5U));
    MR_hl_field(3, Var_27, 1) = (MR_Box) ((MR_Unsigned) (ObjExt_16));
  }
  parse_tree__file_names__module_name_to_file_name_create_dirs_7_p_0(Globals_8, (MR_String) "predicate \140top_level.mercury_compile_llds_back_end.llds_c_to_obj\'/7", Var_27, ModuleName_11, &O_File_19);
