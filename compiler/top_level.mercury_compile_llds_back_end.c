...
MR_decl_static(top_level__mercury_compile_llds_back_end__IntroducedFrom__pred__llds_backend_pass_by_phases__155__1_2_0)
...
"top_level.mercury_compile_llds_back_end",
"top_level.mercury_compile_llds_back_end",
"lambda_mercury_compile_llds_back_end_m_155",
2,
0
},
"top_level.mercury_compile_llds_back_end",
...
MR_def_label(top_level__mercury_compile_llds_back_end__llds_backend_pass_by_phases_9_0,12)
	...
	MR_tfield(0, MR_tempr1, 1) = (MR_Word) MR_ENTRY_AP(top_level__mercury_compile_llds_back_end__IntroducedFrom__pred__llds_backend_pass_by_phases__155__1_2_0);
	MR_tfield(0, MR_tempr1, 2) = (MR_Integer) 2;
	MR_tfield(0, MR_tempr1, 3) = MR_r1;
	MR_tfield(0, MR_tempr1, 4) = (MR_Integer) 0;
	MR_r1 = MR_tempr1;
	MR_r2 = (MR_Word) MR_string_const("mercury_compile_llds_back_end.m", 31);
...
MR_BEGIN_MODULE(top_level__mercury_compile_llds_back_end_module28)
	MR_init_entry1(top_level__mercury_compile_llds_back_end__IntroducedFrom__pred__llds_backend_pass_by_phases__155__1_2_0);
	MR_INIT_PROC_LAYOUT_ADDR(mercury__top_level__mercury_compile_llds_back_end__IntroducedFrom__pred__llds_backend_pass_by_phases__155__1_2_0);
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'IntroducedFrom__pred__llds_backend_pass_by_phases__155__1'/2 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(top_level__mercury_compile_llds_back_end__IntroducedFrom__pred__llds_backend_pass_by_phases__155__1_2_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_r1 == MR_r2);
	MR_proceed();
#ifdef MR_maybe_local_thread_engine_base
