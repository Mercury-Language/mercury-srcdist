  ...
  MR_Word * Succeeded_14)
{
  ...
  backend_libs__compile_target_code__pic_object_file_extension_5_p_0(Globals_9, PIC_17, &ObjOtherExt_18, &Var_19, &Var_20);
  C_FileName_21 = mercury__string__f_43_43_2_f_0(BaseName_12, (MR_String) ".c");
  Var_25 = parse_tree__file_names__other_extension_to_string_1_f_0(ObjOtherExt_18);
