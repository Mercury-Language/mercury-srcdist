  ...
  MR_Word * STATE_VARIABLE_Specs_51)
{
  ...
  else
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals0_26, (MR_Integer) 72, &Verbose_27);
    switch (Verbose_27) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        {
    ...
    *STATE_VARIABLE_CProcsCord_47 = mercury__cord__f_43_43_2_f_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_c_procedure_0), STATE_VARIABLE_CProcsCord_0_46, Var_70);
    libs__globals__lookup_bool_option_3_p_0(Globals0_26, (MR_Integer) 82, &Stats_41);
  ...
  MR_Word * STATE_VARIABLE_HLDS_15)
{
  ...
  libs__globals__lookup_int_option_3_p_0(Globals_11, (MR_Integer) 103, &DebugLiveness_13);
