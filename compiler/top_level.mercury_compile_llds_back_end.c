...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_18, (MR_Integer) 61, &Verbose_19);
    libs__globals__lookup_bool_option_3_p_0(Globals_18, (MR_Integer) 71, &Stats_20);
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_18, (MR_Integer) 303, &NewTypeClassRtti_23);
    ...
    libs__globals__lookup_int_option_3_p_0(Globals_18, (MR_Integer) 509, &ProcsPerFunc_69);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_15, (MR_Integer) 263, &OptUnboxFloat_16);
    libs__globals__lookup_bool_option_3_p_0(Globals_15, (MR_Integer) 487, &DoCommonData_17);
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_15, (MR_Integer) 264, &OptUnboxInt64s_19);
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_15, (MR_Integer) 61, &Verbose_24);
    libs__globals__lookup_bool_option_3_p_0(Globals_15, (MR_Integer) 71, &Stats_25);
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_15, (MR_Integer) 323, &TradPasses_26);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_13, (MR_Integer) 501, &ProcDups_14);
    switch (ProcDups_14) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        {
...
{
  {
    ...
    else
    {
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals0_27, (MR_Integer) 61, &Verbose_28);
      switch (Verbose_28) {
        default: /*NOTREACHED*/ MR_assert(0);
        case (MR_Integer) 0:
          {
      ...
      *STATE_VARIABLE_CProcsCord_47 = mercury__cord__f_43_43_2_f_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_c_procedure_0), STATE_VARIABLE_CProcsCord_0_46, Var_70);
      libs__globals__lookup_bool_option_3_p_0(Globals0_27, (MR_Integer) 71, &Stats_41);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_25, (MR_Integer) 395, &SavedVarsConst_26);
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_25, (MR_Integer) 396, &SavedVarsCell_27);
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_25, (MR_Integer) 412, &FollowCode_28);
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_25, (MR_Integer) 391, &ConstProp_31);
    libs__globals__lookup_bool_option_3_p_0(Globals_25, (MR_Integer) 217, &DeepProf_32);
    libs__globals__lookup_bool_option_3_p_0(Globals_25, (MR_Integer) 234, &TSWProf_33);
    libs__globals__lookup_bool_option_3_p_0(Globals_25, (MR_Integer) 235, &TSCProf_34);
    {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_25, (MR_Integer) 489, &Optimize_41);
    switch (Optimize_41) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        *CProc_21 = CProc0_40;
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_15, (MR_Integer) 489, &Optimize_16);
    switch (Optimize_16) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 324, &ParallelLiveness_12);
    libs__globals__lookup_int_option_3_p_0(Globals_11, (MR_Integer) 89, &DebugLiveness_13);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 412, &FollowCode_12);
...
{
  {
    ...
    hlds__hlds_module__module_info_get_globals_2_p_0(STATE_VARIABLE_HLDS_0_13, &Globals_11);
    libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 396, &SavedVars_12);
    switch (SavedVars_12) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        *STATE_VARIABLE_HLDS_14 = STATE_VARIABLE_HLDS_0_13;
...
{
  {
    ...
    hlds__hlds_module__module_info_get_globals_2_p_0(STATE_VARIABLE_HLDS_0_13, &Globals_11);
    libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 395, &SavedVars_12);
    switch (SavedVars_12) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        *STATE_VARIABLE_HLDS_14 = STATE_VARIABLE_HLDS_0_13;
