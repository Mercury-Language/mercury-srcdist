...
static /* final */ const MR_Box top_level__mercury_compile_llds_back_end_scalar_common_3[5][1];
    ...
    case (MR_Integer) 0:
      {
        ...
        parse_tree__file_names__module_name_to_search_file_name_5_p_0(Globals_6, (MR_String) "predicate \140top_level.mercury_compile_llds_back_end.make_foreign_import_header_code\'/5", (MR_Word) (&top_level__mercury_compile_llds_back_end_scalar_common_3[1]), ModuleName_11, &HeaderFileName_12);
  ...
  MR_Word * Succeeded_10)
{
  ...
  parse_tree__file_names__module_name_to_file_name_5_p_0(Globals_7, (MR_String) "predicate \140top_level.mercury_compile_llds_back_end.llds_c_to_obj\'/6", (MR_Word) (MR_mkword(3, &top_level__mercury_compile_llds_back_end_scalar_common_2[4])), ModuleName_9, &C_File_16);
  {
  ...
  MR_Word * STATE_VARIABLE_DumpInfo_32)
{
  ...
  if (succeeded)
    ...
    hlds__passes_aux__process_valid_nonimported_procs_3_p_0((MR_Word) (MR_mkword(1, &top_level__mercury_compile_llds_back_end_scalar_common_3[4])), STATE_VARIABLE_HLDS_58_58, &STATE_VARIABLE_HLDS_70_70);
