  ...
  MR_Word * Succeeded_12)
{
  ...
  backend_libs__link_target_code__get_linked_target_type_2_p_0(Globals_8, &LinkedTargetType_14);
  backend_libs__link_target_code__get_object_code_type_3_p_0(Globals_8, LinkedTargetType_14, &PIC_15);
  ...
  Var_22 = parse_tree__file_names__extension_to_string_2_f_0(Globals_8, Var_23);
  *O_FileName_11 = mercury__string__f_43_43_2_f_0(BaseName_10, Var_22);
  backend_libs__compile_target_code__do_compile_c_file_8_p_0(Globals_8, ProgressStream_9, PIC_15, C_FileName_18, *O_FileName_11, Succeeded_12);
}
  ...
  MR_Word * FactTableObjFiles_18)
{
  ...
  Var_244 = ((MR_Integer) ((MR_hl_field(0, OptTuple_71, 39))));
  switch (JustOneCFunc_72) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 1:
      mercury__list__chunk_3_p_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_c_procedure_0), Procs_15, Var_244, &ChunkedProcs_73);
      break;
    case (MR_Integer) 0:
      {
          ...
          case (MR_Integer) 3:
            {
              ...
              top_level__mercury_compile_llds_back_end__llds_c_to_obj_6_p_0(Globals_20, ProgressStream_11, ModuleName_16, &CompileSucceeded_92);
              hlds__hlds_module__module_info_get_fact_table_file_names_2_p_0(HLDS_13, &FactTableBaseFiles_93);
              {
                ...
                MR_hl_field(0, Var_119, 3) = ((MR_Box) (Globals_20));
                MR_hl_field(0, Var_119, 4) = ((MR_Box) (ProgressStream_11));
              }
  ...
  MR_Word * Succeeded_10)
{
  ...
  backend_libs__link_target_code__get_linked_target_type_2_p_0(Globals_7, &LinkedTargetType_12);
  backend_libs__link_target_code__get_object_code_type_3_p_0(Globals_7, LinkedTargetType_12, &PIC_13);
  backend_libs__compile_target_code__maybe_pic_object_file_extension_3_p_0(PIC_13, &ObjExt_14, &Var_15);
  parse_tree__file_names__module_name_to_file_name_6_p_0(Globals_7, (MR_String) "predicate \140top_level.mercury_compile_llds_back_end.llds_c_to_obj\'/6", (MR_Word) (MR_mkword(3, &top_level__mercury_compile_llds_back_end_scalar_common_2[5])), ModuleName_9, &C_File_16, &_C_FileProposed_17);
  {
    Var_26 = (MR_Word) MR_mkword(3, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(3, Var_26, 0) = ((MR_Box) ((MR_Unsigned) 2U));
    MR_hl_field(3, Var_26, 1) = (MR_Box) ((MR_Unsigned) (ObjExt_14));
  }
  parse_tree__file_names__module_name_to_file_name_create_dirs_8_p_0(Globals_7, (MR_String) "predicate \140top_level.mercury_compile_llds_back_end.llds_c_to_obj\'/6", Var_26, ModuleName_9, &O_File_18, &_O_FileProposed_19);
  backend_libs__compile_target_code__do_compile_c_file_8_p_0(Globals_7, ProgressStream_8, PIC_13, C_File_16, O_File_18, Succeeded_10);
}
  ...
  MR_Word * STATE_VARIABLE_DumpInfo_37)
{
  ...
  DoCommonData_22 = ((((MR_Unsigned) ((MR_hl_field(0, OptTuple_21, 2))) >> 22)) & (MR_Integer) 1);
  ...
  MR_Word * STATE_VARIABLE_Specs_52)
{
  ...
  Optimize_44 = ((((MR_Unsigned) ((MR_hl_field(0, OptTuple_27, 2))) >> 20)) & (MR_Integer) 1);
  switch (Optimize_44) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 1:
      *CProc_22 = CProc0_43;
  ...
  MR_Word * STATE_VARIABLE_LLDS_22)
{
  ...
  Optimize_19 = ((((MR_Unsigned) ((MR_hl_field(0, OptTuple_18, 2))) >> 20)) & (MR_Integer) 1);
  switch (Optimize_19) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 1:
