    ...
    case (MR_Integer) 0:
      {
        ...
        parse_tree__file_names__module_name_to_search_file_name_5_p_0(Globals_6, (MR_String) "predicate \140top_level.mercury_compile_llds_back_end.make_foreign_import_header_code\'/5", (MR_Word) (MR_mkword(2, &top_level__mercury_compile_llds_back_end_scalar_common_3[1])), ModuleName_11, &HeaderFileName_12);
  ...
  MR_Word * Succeeded_12)
{
  ...
  parse_tree__file_names__module_name_to_file_name_5_p_0(Globals_8, (MR_String) "predicate \140top_level.mercury_compile_llds_back_end.llds_c_to_obj\'/7", (MR_Word) (MR_mkword(3, &top_level__mercury_compile_llds_back_end_scalar_common_2[4])), ModuleName_11, &C_File_18);
  {
