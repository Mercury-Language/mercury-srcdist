  ...
  MR_Word * FactTableObjFiles_18)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_20, (MR_Integer) 740, &NewTypeClassRtti_25);
  ...
  Var_244 = ((MR_Integer) ((MR_hl_field(0, OptTuple_71, 38))));
  ...
  MR_Word * STATE_VARIABLE_DumpInfo_37)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_19, (MR_Integer) 633, &TradPasses_31);
  ...
  MR_Word * STATE_VARIABLE_DumpInfo_32)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_100, (MR_Integer) 634, &ParallelLiveness_101);
  libs__globals__lookup_int_option_3_p_0(Globals_100, (MR_Integer) 693, &DebugLiveness_102);
