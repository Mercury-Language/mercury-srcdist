...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_18, (MR_Integer) 58, &Verbose_19);
    libs__globals__lookup_bool_option_3_p_0(Globals_18, (MR_Integer) 68, &Stats_20);
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_18, (MR_Integer) 289, &NewTypeClassRtti_23);
    ...
    libs__globals__lookup_int_option_3_p_0(Globals_18, (MR_Integer) 492, &ProcsPerFunc_69);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_15, (MR_Integer) 256, &OptUnboxFloat_16);
    libs__globals__lookup_bool_option_3_p_0(Globals_15, (MR_Integer) 470, &DoCommonData_17);
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_15, (MR_Integer) 58, &Verbose_22);
    libs__globals__lookup_bool_option_3_p_0(Globals_15, (MR_Integer) 68, &Stats_23);
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_15, (MR_Integer) 309, &TradPasses_24);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_13, (MR_Integer) 484, &ProcDups_14);
    switch (ProcDups_14) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        {
...
{
  {
    ...
    else
    {
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals0_27, (MR_Integer) 58, &Verbose_28);
      switch (Verbose_28) {
        default: /*NOTREACHED*/ MR_assert(0);
        case (MR_Integer) 0:
          {
      ...
      *STATE_VARIABLE_CProcsCord_47 = mercury__cord__f_43_43_2_f_0(TypeCtorInfo_80_80, STATE_VARIABLE_CProcsCord_0_46, Var_70);
      libs__globals__lookup_bool_option_3_p_0(Globals0_27, (MR_Integer) 68, &Stats_41);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_25, (MR_Integer) 380, &SavedVarsConst_26);
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_25, (MR_Integer) 381, &SavedVarsCell_27);
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_25, (MR_Integer) 397, &FollowCode_28);
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_25, (MR_Integer) 376, &ConstProp_31);
    libs__globals__lookup_bool_option_3_p_0(Globals_25, (MR_Integer) 208, &DeepProf_32);
    libs__globals__lookup_bool_option_3_p_0(Globals_25, (MR_Integer) 225, &TSWProf_33);
    libs__globals__lookup_bool_option_3_p_0(Globals_25, (MR_Integer) 226, &TSCProf_34);
    {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_25, (MR_Integer) 472, &Optimize_41);
    switch (Optimize_41) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        *CProc_21 = CProc0_40;
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_15, (MR_Integer) 472, &Optimize_16);
    switch (Optimize_16) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 310, &ParallelLiveness_12);
    libs__globals__lookup_int_option_3_p_0(Globals_11, (MR_Integer) 86, &DebugLiveness_13);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 397, &FollowCode_12);
...
{
  {
    ...
    hlds__hlds_module__module_info_get_globals_2_p_0(STATE_VARIABLE_HLDS_0_13, &Globals_11);
    libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 381, &SavedVars_12);
    switch (SavedVars_12) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        *STATE_VARIABLE_HLDS_14 = STATE_VARIABLE_HLDS_0_13;
...
{
  {
    ...
    hlds__hlds_module__module_info_get_globals_2_p_0(STATE_VARIABLE_HLDS_0_13, &Globals_11);
    libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 380, &SavedVars_12);
    switch (SavedVars_12) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        *STATE_VARIABLE_HLDS_14 = STATE_VARIABLE_HLDS_0_13;
