  ...
  MR_Word * FactTableObjFiles_18)
{
  ...
  mercury__list__filter_4_p_0((MR_Word) (&parse_tree__prog_foreign__parse_tree__prog_foreign__type_ctor_info_foreign_decl_code_0), (MR_Word) (&top_level__mercury_compile_llds_back_end_scalar_common_1[5]), C_HeaderCodes0_64, &C_LocalHeaderCodes_79, &C_ExportedHeaderCodes_80);
  {
