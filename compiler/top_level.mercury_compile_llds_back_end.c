...
static /* final */ const MR_Box top_level__mercury_compile_llds_back_end_scalar_common_5[1][7];
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_18, (MR_Integer) 70, &Verbose_19);
    libs__globals__lookup_bool_option_3_p_0(Globals_18, (MR_Integer) 80, &Stats_20);
            ...
            case (MR_Integer) 2:
              {
                ...
                hlds__hlds_module__module_info_get_fact_table_file_names_2_p_0(HLDS_11, &FactTableBaseFiles_93);
                {
                  ...
                  MR_hl_field(MR_mktag(0), Var_122, 0) = ((MR_Box) (&top_level__mercury_compile_llds_back_end_scalar_common_6[1]));
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_15, (MR_Integer) 70, &Verbose_25);
    libs__globals__lookup_bool_option_3_p_0(Globals_15, (MR_Integer) 80, &Stats_26);
...
{
  {
    ...
    else
    {
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals0_27, (MR_Integer) 70, &Verbose_28);
      switch (Verbose_28) {
        default: /*NOTREACHED*/ MR_assert(0);
        case (MR_Integer) 0:
          {
      ...
      *STATE_VARIABLE_CProcsCord_48 = mercury__cord__f_43_43_2_f_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_c_procedure_0), STATE_VARIABLE_CProcsCord_0_47, Var_71);
      libs__globals__lookup_bool_option_3_p_0(Globals0_27, (MR_Integer) 80, &Stats_42);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_25, (MR_Integer) 237, &DeepProf_33);
    libs__globals__lookup_bool_option_3_p_0(Globals_25, (MR_Integer) 254, &TSWProf_34);
    libs__globals__lookup_bool_option_3_p_0(Globals_25, (MR_Integer) 255, &TSCProf_35);
    {
...
{
  {
    ...
    hlds__passes_aux__process_valid_nonimported_procs_3_p_0((MR_Word) (MR_mkword(MR_mktag(1), &top_level__mercury_compile_llds_back_end_scalar_common_3[5])), STATE_VARIABLE_HLDS_0_11, STATE_VARIABLE_HLDS_12);
...
{
  {
    ...
    libs__file_util__maybe_flush_output_3_p_0(Verbose_7);
    hlds__passes_aux__process_valid_nonimported_procs_3_p_0((MR_Word) (MR_mkword(MR_mktag(1), &top_level__mercury_compile_llds_back_end_scalar_common_3[4])), STATE_VARIABLE_HLDS_0_11, STATE_VARIABLE_HLDS_12);
    libs__file_util__maybe_write_string_4_p_0(Verbose_7, (MR_String) " done.\n");
    libs__file_util__maybe_report_stats_3_p_0(Stats_8);
  }
}
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 341, &ParallelLiveness_12);
    libs__globals__lookup_int_option_3_p_0(Globals_11, (MR_Integer) 99, &DebugLiveness_13);
    ...
    if (succeeded)
      ...
      hlds__passes_aux__process_valid_nonimported_procs_3_p_0((MR_Word) (MR_mkword(MR_mktag(1), &top_level__mercury_compile_llds_back_end_scalar_common_3[3])), STATE_VARIABLE_HLDS_0_14, STATE_VARIABLE_HLDS_15);
    libs__file_util__maybe_write_string_4_p_0(Verbose_7, (MR_String) "% done.\n");
    libs__file_util__maybe_report_stats_3_p_0(Stats_8);
  }
}
