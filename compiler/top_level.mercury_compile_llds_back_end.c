...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_15, (MR_Integer) 257, &OptUnboxFloat_16);
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_15, (MR_Integer) 258, &OptUnboxInt64s_19);
