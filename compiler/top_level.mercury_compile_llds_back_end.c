...
{
  {
    ...
    Var_21 = parse_tree__file_names__extension_to_string_1_f_0(Obj_16);
    *O_File_11 = mercury__string__f_43_43_2_f_0(BaseName_10, Var_21);
      ...
      case (MR_Integer) 0:
        {
          ...
          parse_tree__file_names__module_name_to_search_file_name_6_p_0(Globals_6, (MR_Word) (((MR_Box) ((MR_String) ".mh"))), ModuleName_11, &HeaderFileName_12);
          Var_32 = mercury__string__f_43_43_2_f_0(HeaderFileName_12, (MR_String) "\"\n");
          IncludeString_13 = mercury__string__f_43_43_2_f_0((MR_String) "#include \"", Var_32);
          {
            Var_36 = (MR_Word) MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL);
            MR_hl_field(MR_mktag(0), Var_36, 0) = ((MR_Box) (IncludeString_13));
          }
...
{
  {
    ...
    parse_tree__file_names__module_name_to_file_name_7_p_0(Globals_7, (MR_Integer) 1, (MR_Word) (((MR_Box) ((MR_String) ".c"))), ModuleName_9, &C_File_15);
