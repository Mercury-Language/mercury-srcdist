...
{
  {
      ...
      case (MR_Integer) 1:
        {
          ...
          mercury__list__chunk_3_p_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_c_procedure_0), Procs_13, Var_248, &ChunkedProcs_73);
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(0), Var_110, 0) = ((MR_Box) (&top_level__mercury_compile_llds_back_end_scalar_common_3[2]));
...
{
  {
    ...
    parse_tree__file_names__module_name_to_file_name_8_p_0(Globals_8, (MR_String) "predicate \140top_level.mercury_compile_llds_back_end.llds_c_to_obj\'/7", (MR_Integer) 1, (MR_Word) (MR_mkword(MR_mktag(1), &top_level__mercury_compile_llds_back_end_scalar_common_5[4])), ModuleName_11, &C_File_17);
    {
