  ...
  MR_Word * FactTableObjFiles_18)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_20, (MR_Integer) 766, &NewTypeClassRtti_25);
  ...
  MR_Word * STATE_VARIABLE_DumpInfo_32)
{
  ...
  libs__globals__lookup_int_option_3_p_0(Globals_100, (MR_Integer) 719, &DebugLiveness_102);
