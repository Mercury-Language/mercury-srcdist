      ...
      case (MR_Integer) 1:
        {
          ...
          PredStr_29 = hlds__hlds_out__hlds_out_util__pred_id_to_user_string_2_f_0(STATE_VARIABLE_HLDS_0_42, PredId_17);
  ...
  MR_Word * STATE_VARIABLE_HLDS_15)
{
  ...
  libs__globals__lookup_int_option_3_p_0(Globals_11, (MR_Integer) 102, &DebugLiveness_13);
