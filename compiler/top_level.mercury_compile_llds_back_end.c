  ...
  MR_Word * Succeeded_14)
{
  ...
  MR_Word NewExtObj_19;
  MR_String C_FileName_21;
  MR_String Var_25;
  MR_Word Var_26;
  MR_Word Var_27;
  MR_Word Var_20;
  ...
  backend_libs__compile_target_code__maybe_pic_object_file_extension_5_p_0(Globals_9, PIC_17, &ObjOtherExt_18, &NewExtObj_19, &Var_20);
  C_FileName_21 = mercury__string__f_43_43_2_f_0(BaseName_12, (MR_String) ".c");
  {
    Var_26 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(1, Var_26, 0) = ((MR_Box) (ObjOtherExt_18));
  }
  {
    Var_27 = (MR_Word) MR_mkword(3, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(3, Var_27, 0) = ((MR_Box) ((MR_Unsigned) 5U));
    MR_hl_field(3, Var_27, 1) = (MR_Box) ((MR_Unsigned) (NewExtObj_19));
  }
  Var_25 = parse_tree__file_names__extension_to_string_3_f_0(Globals_9, Var_26, Var_27);
  *O_FileName_13 = mercury__string__f_43_43_2_f_0(BaseName_12, Var_25);
  backend_libs__compile_target_code__do_compile_c_file_9_p_0(Globals_9, ProgressStream_10, ErrorStream_11, PIC_17, C_FileName_21, *O_FileName_13, Succeeded_14);
}
    ...
    case (MR_Integer) 0:
      {
        ...
        parse_tree__file_names__module_name_to_search_file_name_8_p_0(Globals_6, (MR_String) "predicate \140top_level.mercury_compile_llds_back_end.make_foreign_import_header_code\'/5", (MR_Word) (MR_mkword(1, &top_level__mercury_compile_llds_back_end_scalar_common_3[1])), (MR_Word) (MR_mkword(3, &top_level__mercury_compile_llds_back_end_scalar_common_2[4])), ModuleName_11, &HeaderFileName_12);
        Var_24 = mercury__string__f_43_43_2_f_0(HeaderFileName_12, (MR_String) "\"\n");
        IncludeString_13 = mercury__string__f_43_43_2_f_0((MR_String) "#include \"", Var_24);
        {
          Var_28 = (MR_Word) MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(0, Var_28, 0) = ((MR_Box) (IncludeString_13));
        }
    ...
    case (MR_Integer) 1:
      {
        ...
        Var_31 = mercury__string__f_43_43_2_f_0((MR_String) ":- import_module not yet implemented: ", (MR_String) "\140:- pragma foreign_import_module\' for C#");
        {
    ...
    case (MR_Integer) 2:
      {
        ...
        Var_35 = mercury__string__f_43_43_2_f_0((MR_String) ":- import_module not yet implemented: ", (MR_String) "\140:- pragma foreign_import_module\' for Java");
        {
          mercury__require__sorry_2_p_0((MR_String) "predicate \140top_level.mercury_compile_llds_back_end.make_foreign_import_header_code\'/5", Var_35);
          return;
        }
      }
      break;
  ...
  MR_Word * Succeeded_12)
{
  ...
  backend_libs__compile_target_code__maybe_pic_object_file_extension_5_p_0(Globals_8, PIC_15, &ObjOtherExt_16, &ObjNewExt_17, &Var_18);
  parse_tree__file_names__module_name_to_file_name_9_p_0(Globals_8, (MR_String) "predicate \140top_level.mercury_compile_llds_back_end.llds_c_to_obj\'/7", (MR_Integer) 1, (MR_Word) (MR_mkword(1, &top_level__mercury_compile_llds_back_end_scalar_common_3[2])), (MR_Word) (MR_mkword(3, &top_level__mercury_compile_llds_back_end_scalar_common_2[5])), ModuleName_11, &C_File_19);
  {
    Var_33 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(1, Var_33, 0) = ((MR_Box) (ObjOtherExt_16));
  }
  {
    Var_34 = (MR_Word) MR_mkword(3, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(3, Var_34, 0) = ((MR_Box) ((MR_Unsigned) 5U));
    MR_hl_field(3, Var_34, 1) = (MR_Box) ((MR_Unsigned) (ObjNewExt_17));
  }
  parse_tree__file_names__module_name_to_file_name_9_p_0(Globals_8, (MR_String) "predicate \140top_level.mercury_compile_llds_back_end.llds_c_to_obj\'/7", (MR_Integer) 0, Var_33, Var_34, ModuleName_11, &O_File_20);
  backend_libs__compile_target_code__do_compile_c_file_9_p_0(Globals_8, ProgressStream_9, ErrorStream_10, PIC_15, C_File_19, O_File_20, Succeeded_12);
}
