  ...
  MR_Word * STATE_VARIABLE_DumpInfo_37)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_19, (MR_Integer) 634, &TradPasses_31);
  ...
  MR_Word * STATE_VARIABLE_DumpInfo_32)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_100, (MR_Integer) 635, &ParallelLiveness_101);
  libs__globals__lookup_int_option_3_p_0(Globals_100, (MR_Integer) 694, &DebugLiveness_102);
