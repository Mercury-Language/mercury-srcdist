...
{
  {
    ...
    MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), ForeignImportModule_7, (MR_Integer) 0)));
      ...
      case (MR_Integer) 0:
        {
          ...
          Var_36 = mercury__term__context_init_0_f_0();
          {
            ...
            *Include_8 = base;
            MR_hl_field(MR_mktag(0), base, 0) = (MR_Box) (((((MR_Unsigned) ((MR_Integer) 0) << (MR_Integer) 1)) | (MR_Unsigned) ((MR_Integer) 1)));
...
{
  {
    ...
    MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Decl_2, (MR_Integer) 0)));
