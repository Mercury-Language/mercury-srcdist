...
MR_def_label(top_level__mercury_compile_llds_back_end__llds_output_pass_8_0,49)
	...
	MR_tfield(0, MR_tempr1, 6) = MR_sv(37);
	...
	MR_tfield(0, MR_tempr1, 25) = MR_sv(2);
	MR_tfield(0, MR_tempr1, 26) = MR_sv(27);
	MR_tfield(0, MR_tempr1, 27) = MR_sv(28);
	MR_tfield(0, MR_tempr1, 28) = MR_sv(29);
	MR_tfield(0, MR_tempr1, 29) = MR_sv(30);
	MR_tfield(0, MR_tempr1, 30) = MR_sv(31);
	MR_tfield(0, MR_tempr1, 31) = MR_sv(32);
	MR_tfield(0, MR_tempr1, 32) = MR_sv(35);
	MR_tfield(0, MR_tempr1, 33) = MR_sv(9);
	MR_tfield(0, MR_tempr1, 34) = MR_sv(38);
	MR_tfield(0, MR_tempr1, 35) = MR_sv(3);
