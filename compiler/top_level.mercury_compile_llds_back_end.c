  ...
  MR_Word * Succeeded_14)
{
  ...
  backend_libs__compile_target_code__pic_object_file_extension_5_p_0(Globals_9, PIC_17, &ObjOtherExt_18, &NewExtObj_19, &Var_20);
  ...
  MR_Word * Succeeded_12)
{
  ...
  backend_libs__compile_target_code__pic_object_file_extension_5_p_0(Globals_8, PIC_15, &ObjOtherExt_16, &ObjNewExt_17, &Var_18);
