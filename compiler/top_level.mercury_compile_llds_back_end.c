...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_18, (MR_Integer) 57, &Verbose_19);
    libs__globals__lookup_bool_option_3_p_0(Globals_18, (MR_Integer) 67, &Stats_20);
    ...
    libs__globals__lookup_int_option_3_p_0(Globals_18, (MR_Integer) 493, &ProcsPerFunc_69);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_15, (MR_Integer) 255, &OptUnboxFloat_16);
    libs__globals__lookup_bool_option_3_p_0(Globals_15, (MR_Integer) 471, &DoCommonData_17);
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_15, (MR_Integer) 57, &Verbose_22);
    libs__globals__lookup_bool_option_3_p_0(Globals_15, (MR_Integer) 67, &Stats_23);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_13, (MR_Integer) 485, &ProcDups_14);
    switch (ProcDups_14) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        {
...
{
  {
    ...
    else
    {
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals0_27, (MR_Integer) 57, &Verbose_28);
      switch (Verbose_28) {
        default: /*NOTREACHED*/ MR_assert(0);
        case (MR_Integer) 0:
          {
      ...
      *STATE_VARIABLE_CProcsCord_47 = mercury__cord__f_43_43_2_f_0(TypeCtorInfo_80_80, STATE_VARIABLE_CProcsCord_0_46, Var_70);
      libs__globals__lookup_bool_option_3_p_0(Globals0_27, (MR_Integer) 67, &Stats_41);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_25, (MR_Integer) 379, &SavedVarsConst_26);
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_25, (MR_Integer) 380, &SavedVarsCell_27);
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_25, (MR_Integer) 396, &FollowCode_28);
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_25, (MR_Integer) 375, &ConstProp_31);
    libs__globals__lookup_bool_option_3_p_0(Globals_25, (MR_Integer) 207, &DeepProf_32);
    libs__globals__lookup_bool_option_3_p_0(Globals_25, (MR_Integer) 224, &TSWProf_33);
    libs__globals__lookup_bool_option_3_p_0(Globals_25, (MR_Integer) 225, &TSCProf_34);
    {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_25, (MR_Integer) 473, &Optimize_41);
    switch (Optimize_41) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        *CProc_21 = CProc0_40;
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_15, (MR_Integer) 473, &Optimize_16);
    switch (Optimize_16) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
...
{
  {
    ...
    libs__globals__lookup_int_option_3_p_0(Globals_11, (MR_Integer) 85, &DebugLiveness_13);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 396, &FollowCode_12);
