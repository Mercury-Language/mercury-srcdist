...
top_level__mercury_compile_llds_back_end__IntroducedFrom__pred__llds_backend_pass_by_phases__196__1_2_p_0(
    ...
    case (MR_Integer) 0:
      {
        ...
        MR_Word Var_25;
        MR_Word Var_26;
        MR_String _HeaderFileNameProposed_13;

        parse_tree__file_names__module_name_to_search_file_name_6_p_0(Globals_6, (MR_String) "predicate \140top_level.mercury_compile_llds_back_end.make_foreign_import_header_code\'/5", (MR_Word) (MR_mkword(3, &top_level__mercury_compile_llds_back_end_scalar_common_2[4])), ModuleName_11, &HeaderFileName_12, &_HeaderFileNameProposed_13);
        Var_21 = mercury__string__f_43_43_2_f_0(HeaderFileName_12, (MR_String) "\"\n");
        IncludeString_14 = mercury__string__f_43_43_2_f_0((MR_String) "#include \"", Var_21);
        {
          Var_25 = (MR_Word) MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(0, Var_25, 0) = ((MR_Box) (IncludeString_14));
        }
  ...
  MR_Word * FactTableObjFiles_18)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_20, (MR_Integer) 76, &Verbose_21);
  libs__globals__lookup_bool_option_3_p_0(Globals_20, (MR_Integer) 86, &Stats_22);
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_20, (MR_Integer) 349, &NewTypeClassRtti_25);
  ...
  MR_Word * STATE_VARIABLE_DumpInfo_37)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_19, (MR_Integer) 310, &OptUnboxFloat_20);
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_19, (MR_Integer) 311, &OptUnboxInt64s_24);
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_19, (MR_Integer) 76, &Verbose_29);
  libs__globals__lookup_bool_option_3_p_0(Globals_19, (MR_Integer) 86, &Stats_30);
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_19, (MR_Integer) 367, &TradPasses_31);
  ...
  MR_Word * STATE_VARIABLE_Specs_54)
{
  ...
  else
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals0_28, (MR_Integer) 76, &Verbose_29);
    switch (Verbose_29) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        {
    ...
    *STATE_VARIABLE_CProcsCord_50 = mercury__cord__f_43_43_2_f_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_c_procedure_0), STATE_VARIABLE_CProcsCord_0_49, Var_73);
    libs__globals__lookup_bool_option_3_p_0(Globals0_28, (MR_Integer) 86, &Stats_44);
  ...
  MR_Word * STATE_VARIABLE_Specs_52)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_26, (MR_Integer) 266, &DeepProf_35);
  libs__globals__lookup_bool_option_3_p_0(Globals_26, (MR_Integer) 283, &TSWProf_36);
  libs__globals__lookup_bool_option_3_p_0(Globals_26, (MR_Integer) 284, &TSCProf_37);
  {
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = top_level__mercury_compile_llds_back_end__IntroducedFrom__pred__llds_backend_pass_by_phases__196__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 4)))));
  return succeeded;
}
  ...
  MR_Word * STATE_VARIABLE_DumpInfo_32)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_100, (MR_Integer) 368, &ParallelLiveness_101);
  libs__globals__lookup_int_option_3_p_0(Globals_100, (MR_Integer) 123, &DebugLiveness_102);
