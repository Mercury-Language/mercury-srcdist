      ...
      case (MR_Integer) 0:
        {
          ...
          Var_34 = mercury__string__f_43_43_2_f_0(HeaderFileName_12, (MR_String) "\"\n");
          IncludeString_13 = mercury__string__f_43_43_2_f_0((MR_String) "#include \"", Var_34);
          {
            Var_38 = (MR_Word) MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL);
            MR_hl_field(MR_mktag(0), Var_38, 0) = ((MR_Box) (IncludeString_13));
          }
      ...
      case (MR_Integer) 1:
        {
          ...
          Var_25 = mercury__string__f_43_43_2_f_0((MR_String) ":- import_module not yet implemented: ", (MR_String) "\140:- pragma foreign_import_module\' for C#");
          {
            mercury__require__sorry_2_p_0((MR_String) "predicate \140top_level.mercury_compile_llds_back_end.make_foreign_import_header_code\'/5", Var_25);
            return;
          }
        }
        break;
      case (MR_Integer) 3:
        {
          ...
          Var_17 = mercury__string__f_43_43_2_f_0((MR_String) ":- import_module not yet implemented: ", (MR_String) "\140:- pragma foreign_import_module\' for Erlang");
          {
      ...
      case (MR_Integer) 2:
        {
          ...
          Var_21 = mercury__string__f_43_43_2_f_0((MR_String) ":- import_module not yet implemented: ", (MR_String) "\140:- pragma foreign_import_module\' for Java");
          {
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_18, (MR_Integer) 312, &NewTypeClassRtti_23);
...
{
  {
    ...
    hlds__hlds_module__module_info_get_c_j_cs_e_fims_2_p_0(HLDS_4, &CJCsEFIMs0_12);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_15, (MR_Integer) 271, &OptUnboxFloat_16);
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_15, (MR_Integer) 272, &OptUnboxInt64s_20);
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_15, (MR_Integer) 331, &TradPasses_27);
...
{
  {
    ...
    else
    {
      ...
      *STATE_VARIABLE_CProcsCord_47 = mercury__cord__f_43_43_2_f_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_c_procedure_0), STATE_VARIABLE_CProcsCord_0_46, Var_70);
      libs__globals__lookup_bool_option_3_p_0(Globals0_27, (MR_Integer) 75, &Stats_41);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_25, (MR_Integer) 226, &DeepProf_33);
    libs__globals__lookup_bool_option_3_p_0(Globals_25, (MR_Integer) 243, &TSWProf_34);
    libs__globals__lookup_bool_option_3_p_0(Globals_25, (MR_Integer) 244, &TSCProf_35);
    {
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 332, &ParallelLiveness_12);
