...
{
  {
    ...
    if (succeeded)
    {
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(1), ChunkedModules_70, 1) = ((MR_Box) ((MR_Integer) 0));
      }
    }
    else
    {
      ...
      case (MR_Integer) 0:
        {
          ...
          *FactTableObjFiles_16 = (MR_Word) ((MR_Integer) 0);
        }
        break;
      case (MR_Integer) 1:
        {
...
{
  {
    ...
    switch (TradPasses_26) {
      ...
      case (MR_Integer) 0:
        {
          top_level__mercury_compile_llds_back_end__llds_backend_pass_by_phases_11_p_0(STATE_VARIABLE_HLDS_43_43, STATE_VARIABLE_HLDS_31, LLDS_11, STATE_VARIABLE_GlobalData_50_50, STATE_VARIABLE_GlobalData_32, (MR_Word) ((MR_Integer) 0), &Specs_27, STATE_VARIABLE_DumpInfo_47_47, STATE_VARIABLE_DumpInfo_34);
        }
        break;
      case (MR_Integer) 1:
        {
          top_level__mercury_compile_llds_back_end__llds_backend_pass_by_preds_7_p_0(STATE_VARIABLE_HLDS_43_43, STATE_VARIABLE_HLDS_31, LLDS_11, STATE_VARIABLE_GlobalData_50_50, STATE_VARIABLE_GlobalData_32, (MR_Word) ((MR_Integer) 0), &Specs_27);
      ...
      case (MR_Integer) 0:
        {
          ...
          MaybeDupProcMap_16 = (MR_Word) ((MR_Integer) 0);
        }
        break;
      case (MR_Integer) 1:
        {
...
{
  {
    ...
    if ((ProcIds_24 == (MR_Word) ((MR_Integer) 0)))
    {
    ...
    else
    {
      ...
      if ((STATE_VARIABLE_MaybeDupProcMap_0_44 == (MR_Word) ((MR_Integer) 0)))
      {
...
{
  {
    ...
    top_level__mercury_compile_front_end__maybe_simplify_10_p_0((MR_Integer) 0, (MR_Integer) 5, Verbose_19, Stats_20, STATE_VARIABLE_HLDS_47_47, &STATE_VARIABLE_HLDS_55_55, (MR_Word) ((MR_Integer) 0), &SimplifySpecs_21);
