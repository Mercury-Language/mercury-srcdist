  ...
  MR_Word * FactTableObjFiles_18)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_20, (MR_Integer) 743, &NewTypeClassRtti_25);
  ...
  MR_Word * STATE_VARIABLE_DumpInfo_37)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_19, (MR_Integer) 636, &TradPasses_31);
  ...
  MR_Word * STATE_VARIABLE_DumpInfo_32)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_100, (MR_Integer) 637, &ParallelLiveness_101);
  libs__globals__lookup_int_option_3_p_0(Globals_100, (MR_Integer) 696, &DebugLiveness_102);
