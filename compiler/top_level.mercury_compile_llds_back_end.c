  ...
  MR_Word * FactTableObjFiles_16)
{
  ...
  Var_247 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), OptTuple_69, (MR_Integer) 39))));
  switch (JustOneCFunc_70) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 1:
      mercury__list__chunk_3_p_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_c_procedure_0), Procs_13, Var_247, &ChunkedProcs_71);
      break;
    case (MR_Integer) 0:
      {
