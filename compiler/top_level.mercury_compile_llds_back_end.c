  ...
  MR_Word * STATE_VARIABLE_Specs_54)
{
  ...
  else
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals0_28, (MR_Integer) 72, &Verbose_29);
    switch (Verbose_29) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        {
    ...
    *STATE_VARIABLE_CProcsCord_50 = mercury__cord__f_43_43_2_f_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_c_procedure_0), STATE_VARIABLE_CProcsCord_0_49, Var_73);
    libs__globals__lookup_bool_option_3_p_0(Globals0_28, (MR_Integer) 82, &Stats_44);
  ...
  MR_Word * STATE_VARIABLE_DumpInfo_32)
{
  ...
  libs__globals__lookup_int_option_3_p_0(Globals_100, (MR_Integer) 104, &DebugLiveness_102);
