...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_18, (MR_Integer) 293, &NewTypeClassRtti_23);
    ...
    libs__globals__lookup_int_option_3_p_0(Globals_18, (MR_Integer) 498, &ProcsPerFunc_69);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_15, (MR_Integer) 476, &DoCommonData_17);
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_15, (MR_Integer) 313, &TradPasses_26);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_13, (MR_Integer) 490, &ProcDups_14);
    switch (ProcDups_14) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        {
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_25, (MR_Integer) 384, &SavedVarsConst_26);
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_25, (MR_Integer) 385, &SavedVarsCell_27);
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_25, (MR_Integer) 401, &FollowCode_28);
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_25, (MR_Integer) 380, &ConstProp_31);
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_25, (MR_Integer) 478, &Optimize_41);
    switch (Optimize_41) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        *CProc_21 = CProc0_40;
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_15, (MR_Integer) 478, &Optimize_16);
    switch (Optimize_16) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 314, &ParallelLiveness_12);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 401, &FollowCode_12);
...
{
  {
    ...
    hlds__hlds_module__module_info_get_globals_2_p_0(STATE_VARIABLE_HLDS_0_13, &Globals_11);
    libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 385, &SavedVars_12);
    switch (SavedVars_12) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        *STATE_VARIABLE_HLDS_14 = STATE_VARIABLE_HLDS_0_13;
