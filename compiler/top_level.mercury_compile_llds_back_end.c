    ...
    case (MR_Integer) 0:
      {
        ...
        parse_tree__file_names__module_name_to_search_file_name_5_p_0(Globals_6, (MR_String) "predicate \140top_level.mercury_compile_llds_back_end.make_foreign_import_header_code\'/5", (MR_Word) (MR_mkword(3, &top_level__mercury_compile_llds_back_end_scalar_common_2[4])), ModuleName_11, &HeaderFileName_12);
        Var_20 = mercury__string__f_43_43_2_f_0(HeaderFileName_12, (MR_String) "\"\n");
        IncludeString_13 = mercury__string__f_43_43_2_f_0((MR_String) "#include \"", Var_20);
        {
          Var_24 = (MR_Word) MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(0, Var_24, 0) = ((MR_Box) (IncludeString_13));
        }
  ...
  MR_Word * Succeeded_10)
{
  ...
  parse_tree__file_names__module_name_to_file_name_5_p_0(Globals_7, (MR_String) "predicate \140top_level.mercury_compile_llds_back_end.llds_c_to_obj\'/6", (MR_Word) (MR_mkword(3, &top_level__mercury_compile_llds_back_end_scalar_common_2[5])), ModuleName_9, &C_File_16);
  {
    Var_24 = (MR_Word) MR_mkword(3, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(3, Var_24, 0) = ((MR_Box) ((MR_Unsigned) 0U));
    MR_hl_field(3, Var_24, 1) = (MR_Box) ((MR_Unsigned) (ObjExt_14));
  }
  parse_tree__file_names__module_name_to_file_name_create_dirs_7_p_0(Globals_7, (MR_String) "predicate \140top_level.mercury_compile_llds_back_end.llds_c_to_obj\'/6", Var_24, ModuleName_9, &O_File_17);
  backend_libs__compile_target_code__do_compile_c_file_8_p_0(Globals_7, ProgressStream_8, PIC_13, C_File_16, O_File_17, Succeeded_10);
}
