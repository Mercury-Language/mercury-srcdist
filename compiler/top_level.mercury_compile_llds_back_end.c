    ...
    case (MR_Integer) 0:
      {
        ...
        parse_tree__file_names__module_name_to_search_file_name_7_p_0(Globals_6, (MR_String) "predicate \140top_level.mercury_compile_llds_back_end.make_foreign_import_header_code\'/5", (MR_Word) (MR_mkword(3, &top_level__mercury_compile_llds_back_end_scalar_common_2[4])), ModuleName_11, &HeaderFileName_12);
        Var_21 = mercury__string__f_43_43_2_f_0(HeaderFileName_12, (MR_String) "\"\n");
        IncludeString_13 = mercury__string__f_43_43_2_f_0((MR_String) "#include \"", Var_21);
        {
          Var_25 = (MR_Word) MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(0, Var_25, 0) = ((MR_Box) (IncludeString_13));
        }
    ...
    case (MR_Integer) 1:
      {
        ...
        Var_28 = mercury__string__f_43_43_2_f_0((MR_String) ":- import_module not yet implemented: ", (MR_String) "\140:- pragma foreign_import_module\' for C#");
        {
          mercury__require__sorry_2_p_0((MR_String) "predicate \140top_level.mercury_compile_llds_back_end.make_foreign_import_header_code\'/5", Var_28);
          return;
        }
      }
      break;
    case (MR_Integer) 2:
      {
        ...
        Var_32 = mercury__string__f_43_43_2_f_0((MR_String) ":- import_module not yet implemented: ", (MR_String) "\140:- pragma foreign_import_module\' for Java");
        {
          mercury__require__sorry_2_p_0((MR_String) "predicate \140top_level.mercury_compile_llds_back_end.make_foreign_import_header_code\'/5", Var_32);
          return;
        }
      }
      break;
  ...
  MR_Word * Succeeded_12)
{
  ...
  parse_tree__file_names__module_name_to_file_name_8_p_0(Globals_8, (MR_String) "predicate \140top_level.mercury_compile_llds_back_end.llds_c_to_obj\'/7", (MR_Integer) 1, (MR_Word) (MR_mkword(3, &top_level__mercury_compile_llds_back_end_scalar_common_2[5])), ModuleName_11, &C_File_18);
  {
    Var_29 = (MR_Word) MR_mkword(3, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(3, Var_29, 0) = ((MR_Box) ((MR_Unsigned) 5U));
    MR_hl_field(3, Var_29, 1) = (MR_Box) ((MR_Unsigned) (ObjExt_16));
  }
  parse_tree__file_names__module_name_to_file_name_8_p_0(Globals_8, (MR_String) "predicate \140top_level.mercury_compile_llds_back_end.llds_c_to_obj\'/7", (MR_Integer) 0, Var_29, ModuleName_11, &O_File_19);
  ...
  MR_Word * STATE_VARIABLE_DumpInfo_37)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_19, (MR_Integer) 289, &OptUnboxFloat_20);
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_19, (MR_Integer) 290, &OptUnboxInt64s_24);
  ...
  MR_Word * STATE_VARIABLE_Specs_54)
{
  ...
  ProcIds_25 = hlds__hlds_pred__pred_info_valid_non_imported_procids_1_f_0(PredInfo_24);
  ...
  MR_Word * STATE_VARIABLE_Specs_52)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_26, (MR_Integer) 245, &DeepProf_35);
  libs__globals__lookup_bool_option_3_p_0(Globals_26, (MR_Integer) 262, &TSWProf_36);
  libs__globals__lookup_bool_option_3_p_0(Globals_26, (MR_Integer) 263, &TSCProf_37);
  {
