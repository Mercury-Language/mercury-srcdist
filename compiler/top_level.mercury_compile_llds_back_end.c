...
{
  {
    ...
    {
      libs__globals__lookup_bool_option_3_p_0(top_level__mercury_compile_llds_back_end__Globals_23, (MR_Integer) 461, &top_level__mercury_compile_llds_back_end__Optimize_41);
    }
