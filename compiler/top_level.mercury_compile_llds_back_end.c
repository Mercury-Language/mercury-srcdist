...
static /* final */ const MR_Box top_level__mercury_compile_llds_back_end_scalar_common_2[8][2];
  ...
  MR_Word * Succeeded_14)
{
  ...
  backend_libs__compile_target_code__maybe_pic_object_file_extension_3_p_0(PIC_17, &ExtObj_18, &Var_19);
  C_FileName_20 = mercury__string__f_43_43_2_f_0(BaseName_12, (MR_String) ".c");
  {
    Var_25 = (MR_Word) MR_mkword(3, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(3, Var_25, 0) = ((MR_Box) ((MR_Unsigned) 5U));
    MR_hl_field(3, Var_25, 1) = (MR_Box) ((MR_Unsigned) (ExtObj_18));
  }
  Var_24 = parse_tree__file_names__extension_to_string_2_f_0(Globals_9, Var_25);
  *O_FileName_13 = mercury__string__f_43_43_2_f_0(BaseName_12, Var_24);
  backend_libs__compile_target_code__do_compile_c_file_9_p_0(Globals_9, ProgressStream_10, ErrorStream_11, PIC_17, C_FileName_20, *O_FileName_13, Succeeded_14);
}
    ...
    case (MR_Integer) 1:
      {
        ...
        Var_27 = mercury__string__f_43_43_2_f_0((MR_String) ":- import_module not yet implemented: ", (MR_String) "\140:- pragma foreign_import_module\' for C#");
        {
          mercury__require__sorry_2_p_0((MR_String) "predicate \140top_level.mercury_compile_llds_back_end.make_foreign_import_header_code\'/5", Var_27);
          return;
        }
      }
      break;
    case (MR_Integer) 2:
      {
        ...
        Var_31 = mercury__string__f_43_43_2_f_0((MR_String) ":- import_module not yet implemented: ", (MR_String) "\140:- pragma foreign_import_module\' for Java");
        {
          mercury__require__sorry_2_p_0((MR_String) "predicate \140top_level.mercury_compile_llds_back_end.make_foreign_import_header_code\'/5", Var_31);
          return;
        }
      }
      break;
  ...
  MR_Word * FactTableObjFiles_20)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_22, (MR_Integer) 329, &NewTypeClassRtti_27);
  ...
  JustOneCFunc_74 = ((((MR_Unsigned) ((MR_hl_field(0, OptTuple_73, (MR_Integer) 2))) >> 3)) & (MR_Integer) 1);
  ...
  MR_Word * Succeeded_12)
{
  ...
  backend_libs__compile_target_code__maybe_pic_object_file_extension_3_p_0(PIC_15, &ObjExt_16, &Var_17);
  parse_tree__file_names__module_name_to_file_name_5_p_0(Globals_8, (MR_String) "predicate \140top_level.mercury_compile_llds_back_end.llds_c_to_obj\'/7", (MR_Word) (MR_mkword(3, &top_level__mercury_compile_llds_back_end_scalar_common_2[5])), ModuleName_11, &C_File_18);
  {
    Var_26 = (MR_Word) MR_mkword(3, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(3, Var_26, 0) = ((MR_Box) ((MR_Unsigned) 5U));
    MR_hl_field(3, Var_26, 1) = (MR_Box) ((MR_Unsigned) (ObjExt_16));
  }
  parse_tree__file_names__module_name_to_file_name_create_dirs_7_p_0(Globals_8, (MR_String) "predicate \140top_level.mercury_compile_llds_back_end.llds_c_to_obj\'/7", Var_26, ModuleName_11, &O_File_19);
  backend_libs__compile_target_code__do_compile_c_file_9_p_0(Globals_8, ProgressStream_9, ErrorStream_10, PIC_15, C_File_18, O_File_19, Succeeded_12);
}
  ...
  MR_Word * STATE_VARIABLE_DumpInfo_37)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_19, (MR_Integer) 290, &OptUnboxFloat_20);
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_19, (MR_Integer) 291, &OptUnboxInt64s_24);
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_19, (MR_Integer) 347, &TradPasses_31);
  ...
  MR_Word * STATE_VARIABLE_Specs_52)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_26, (MR_Integer) 246, &DeepProf_35);
  libs__globals__lookup_bool_option_3_p_0(Globals_26, (MR_Integer) 263, &TSWProf_36);
  libs__globals__lookup_bool_option_3_p_0(Globals_26, (MR_Integer) 264, &TSCProf_37);
  {
  ...
  MR_Word * STATE_VARIABLE_DumpInfo_32)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_100, (MR_Integer) 348, &ParallelLiveness_101);
    ...
    case (MR_Integer) 0:
      {
        ...
        libs__file_util__maybe_flush_output_4_p_0(ProgressStream_8, Verbose_9);
        hlds__passes_aux__process_valid_nonimported_procs_3_p_0((MR_Word) (MR_mkword(3, &top_level__mercury_compile_llds_back_end_scalar_common_2[7])), STATE_VARIABLE_HLDS_0_16, STATE_VARIABLE_HLDS_17);
        libs__file_util__maybe_write_string_5_p_0(ProgressStream_8, Verbose_9, (MR_String) " done.\n");
        libs__file_util__maybe_report_stats_4_p_0(ProgressStream_8, Stats_10);
      }
      break;
