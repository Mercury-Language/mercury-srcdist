...
{
  {
    ...
    parse_tree__prog_data_foreign__add_fim_spec_3_p_0(ForeignSelfImport_8, ForeignImportsModules0_11, &ForeignImportsModules_14);
    ...
    Var_22 = parse_tree__prog_data_foreign__get_lang_fim_specs_2_f_0(ForeignImportsModules_14, UseForeignLanguage_5);
    WantedForeignImports_19 = mercury__set__to_sorted_list_1_f_0((MR_Word) (&parse_tree__prog_data_foreign__parse_tree__prog_data_foreign__type_ctor_info_fim_spec_0), Var_22);
