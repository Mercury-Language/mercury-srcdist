  ...
  MR_Word * STATE_VARIABLE_Arities_4)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      MR_Word STATE_VARIABLE_Arities_18_36;
      MR_Word ThisSymName_31;
      MR_Integer ThisArity_32;
      MR_Word next_value_of_HeadVar__1_1;
      ...
      if (succeeded)
      {
        ThisSymName_31 = ((MR_Word) ((MR_hl_field(MR_mktag(3), ConsId_27, (MR_Integer) 1))));
        ThisArity_32 = ((MR_Integer) ((MR_hl_field(MR_mktag(3), ConsId_27, (MR_Integer) 2))));
        succeeded = mdbcomp__sym_name____Unify____sym_name_0_0(ThisSymName_31, SymName_2);
        if (succeeded)
          {
            STATE_VARIABLE_Arities_18_36 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), STATE_VARIABLE_Arities_18_36, 0) = ((MR_Box) (ThisArity_32));
            MR_hl_field(MR_mktag(1), STATE_VARIABLE_Arities_18_36, 1) = ((MR_Box) (STATE_VARIABLE_Arities_0_3));
          }
        else
          STATE_VARIABLE_Arities_18_36 = STATE_VARIABLE_Arities_0_3;
      }
      else
        {
      ...
      hlds__hlds_cons__return_cons_arities_inner_cons_ids_4_p_0(ConsIds_28, SymName_2, STATE_VARIABLE_Arities_18_36, &STATE_VARIABLE_Arities_18_18);
      // direct tailcall eliminated
      ;
