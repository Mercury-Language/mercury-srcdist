  ...
  MR_Word * STATE_VARIABLE_Entry_9)
{
  ...
  Var_12 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_Entry_0_8, (MR_Integer) 0))));
  Var_13 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_Entry_0_8, (MR_Integer) 1))));
  {
    MR_Word base;
  ...
  MR_Word * STATE_VARIABLE_Arities_4)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      MR_Word ConsId_26 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Entry_9, (MR_Integer) 0))));
      MR_Word ConsIds_27 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Entry_9, (MR_Integer) 1))));
      ...
      succeeded = ((((MR_tag((MR_Word) ConsId_26)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(MR_mktag(3), ConsId_26, (MR_Integer) 0)))) == (MR_Integer) 2)));
      if (succeeded)
      {
        ThisSymName_29 = ((MR_Word) ((MR_hl_field(MR_mktag(3), ConsId_26, (MR_Integer) 1))));
        ThisArity_30 = ((MR_Integer) ((MR_hl_field(MR_mktag(3), ConsId_26, (MR_Integer) 2))));
        succeeded = mdbcomp__sym_name____Unify____sym_name_0_0(ThisSymName_29, SymName_2);
        if (succeeded)
          {
            STATE_VARIABLE_Arities_18_34 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), STATE_VARIABLE_Arities_18_34, 0) = ((MR_Box) (ThisArity_30));
            MR_hl_field(MR_mktag(1), STATE_VARIABLE_Arities_18_34, 1) = ((MR_Box) (STATE_VARIABLE_Arities_0_3));
          }
        else
