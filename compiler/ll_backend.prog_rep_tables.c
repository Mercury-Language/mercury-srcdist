  ...
  MR_Word HeadVar__2_2)
{
  ...
  else
  {
    ...
    if (succeeded)
    {
      TypeInfo__12_12 = (MR_Word) (&ll_backend__prog_rep_tables_scalar_common_1[1]);
  ...
  MR_Word HeadVar__2_2)
{
  ...
  else
  {
    ...
    if (succeeded)
    {
      TypeInfo__12_12 = (MR_Word) (&ll_backend__prog_rep_tables_scalar_common_1[2]);
      succeeded = mercury__builtin__unify_2_p_0(TypeInfo__12_12, ((MR_Box) (ArgX2_5)), ((MR_Box) (ArgY2_6)));
      if (succeeded)
        succeeded = (ArgX3_7 == ArgY3_8);
    }
  ...
  MR_Word * STATE_VARIABLE_StringTable_15)
{
  ...
  if (succeeded)
  {
    ...
    if (succeeded)
    {
      ...
      mercury__string__from_char_list_2_p_0(BaseNameChars_38, &BaseName_40);
      {
        ...
        MR_hl_field(MR_mktag(1), MaybeBaseName_9, 0) = ((MR_Box) (BaseName_40));
      }
    ...
    else
    {
      {
        MaybeBaseName_9 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), MaybeBaseName_9, 0) = ((MR_Box) (NoPrefix_36));
      }
      N_10 = (MR_Integer) 0;
    }
    succeeded = MR_TRUE;
  ...
  if (succeeded)
  {
    ...
    if (succeeded)
    {
      ...
      else
      {
        ...
        MR_Integer Var_21;
        MR_Integer Var_22;
        MR_Word TableMap0_59 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_StringTable_0_14, (MR_Integer) 0))));
        MR_Word TableList0_60 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_StringTable_0_14, (MR_Integer) 1))));
        MR_Integer TableOffset0_61 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_StringTable_0_14, (MR_Integer) 2))));
        ...
        {
          {
            ...
            MR_hl_field(MR_mktag(1), MaybeOffset_12, 0) = ((MR_Box) (OldOffset_62));
          }
          STATE_VARIABLE_StringTable_19_19 = STATE_VARIABLE_StringTable_0_14;
        }
        else
        {
          ...
          if (succeeded)
          {
            ...
            {
              MaybeOffset_12 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), MaybeOffset_12, 0) = ((MR_Box) (TableOffset0_61));
            }
            ...
            {
              TableList_66 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), TableList_66, 0) = ((MR_Box) (BaseName_11));
              MR_hl_field(MR_mktag(1), TableList_66, 1) = ((MR_Box) (TableList0_60));
            }
            {
              STATE_VARIABLE_StringTable_19_19 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
              MR_hl_field(MR_mktag(0), STATE_VARIABLE_StringTable_19_19, 0) = ((MR_Box) (TableMap_65));
              MR_hl_field(MR_mktag(0), STATE_VARIABLE_StringTable_19_19, 1) = ((MR_Box) (TableList_66));
              MR_hl_field(MR_mktag(0), STATE_VARIABLE_StringTable_19_19, 2) = ((MR_Box) (TableOffset_64));
            }
          }
          else
          {
  ...
  else
  {
    ...
    MR_Word TableMap0_76 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_StringTable_0_14, (MR_Integer) 0))));
    MR_Word TableList0_77 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_StringTable_0_14, (MR_Integer) 1))));
    MR_Integer TableOffset0_78 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_StringTable_0_14, (MR_Integer) 2))));
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        {
          TableList_83 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), TableList_83, 0) = ((MR_Box) (String_5));
          MR_hl_field(MR_mktag(1), TableList_83, 1) = ((MR_Box) (TableList0_77));
        }
        {
          MR_Word base;
          base = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
          *STATE_VARIABLE_StringTable_15 = base;
          MR_hl_field(MR_mktag(0), base, 0) = ((MR_Box) (TableMap_82));
          MR_hl_field(MR_mktag(0), base, 1) = ((MR_Box) (TableList_83));
          MR_hl_field(MR_mktag(0), base, 2) = ((MR_Box) (TableOffset_81));
        }
