  ...
  MR_Word * STATE_VARIABLE_TypeTable_49)
{
  ...
  *TypeCode_8 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_TypeTable_76_76, (MR_Integer) 2))));
  NextTypeNum_43 = (MR_Integer) ((MR_Unsigned) *TypeCode_8 + (MR_Unsigned) 1);
  ...
  MR_Word * STATE_VARIABLE_StringTable_15)
{
  ...
  if (succeeded)
  {
    ...
    if (succeeded)
    {
      ...
      N_10 = (MR_Integer) ((MR_Unsigned) Num_43 + (MR_Unsigned) 1);
    }
    else
    {
      {
    ...
    if (succeeded)
    {
      ...
      else
      {
        ...
        else
        {
          ...
          TableOffset_79 = (MR_Integer) ((MR_Unsigned) Var_82 + (MR_Unsigned) 1);
  ...
  MR_Word * STATE_VARIABLE_StringTable_17)
{
  ...
  else
  {
    ...
    TableOffset_13 = (MR_Integer) ((MR_Unsigned) Var_18 + (MR_Unsigned) 1);
