  ...
  MR_Word * STATE_VARIABLE_StringTable_15)
{
  ...
  if (succeeded)
  {
    ...
    mercury__list__reverse_2_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_character_0), NoPrefixChars_41, &RevString_61);
    succeeded = ll_backend__prog_rep_tables__rev_find_number_suffix_6_p_0(RevString_61, (MR_Integer) 0, &Num_43, (MR_Integer) 1, &Scale_62, &RevRest_63);
    if (succeeded)
    {
      Var_66 = (MR_Integer) 1;
      succeeded = (Scale_62 > Var_66);
      if (succeeded)
      {
        mercury__list__reverse_2_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_character_0), RevRest_63, &BaseNameChars_42);
        succeeded = MR_TRUE;
      }
    }
    if (succeeded)
  ...
  if (succeeded)
  {
    ...
    if (succeeded)
    {
      ...
      else
      {
        ...
        MR_Integer Var_21;
        MR_Integer Var_22;
        MR_Word TableMap0_73 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_StringTable_0_14, (MR_Integer) 0))));
        MR_Word TableList0_74 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_StringTable_0_14, (MR_Integer) 1))));
        MR_Integer TableOffset0_75 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_StringTable_0_14, (MR_Integer) 2))));
        MR_Integer OldOffset_76;
        MR_Box conv0_OldOffset_76;

        succeeded = mercury__map__search_3_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0), TableMap0_73, ((MR_Box) (BaseName_11)), &conv0_OldOffset_76);
        if (succeeded)
        {
          OldOffset_76 = ((MR_Integer) (conv0_OldOffset_76));
          succeeded = MR_TRUE;
        }
        if (succeeded)
        {
          {
            ...
            MR_hl_field(MR_mktag(1), MaybeOffset_12, 0) = ((MR_Box) (OldOffset_76));
          }
          STATE_VARIABLE_StringTable_19_19 = STATE_VARIABLE_StringTable_0_14;
        }
        else
        {
          MR_Integer TableOffset_78;
          MR_Integer Length_77;
          MR_Integer Var_81;
          MR_Integer Var_83;

          Length_77 = mercury__string__count_utf8_code_units_1_f_0(BaseName_11);
          Var_81 = (MR_Integer) ((MR_Unsigned) TableOffset0_75 + (MR_Unsigned) Length_77);
          TableOffset_78 = (MR_Integer) ((MR_Unsigned) Var_81 + (MR_Unsigned) 1);
          Var_83 = mercury__int__f_60_60_2_f_0((MR_Integer) 1, (MR_Integer) 30);
          succeeded = (TableOffset_78 < Var_83);
          if (succeeded)
          {
            MR_Word TableMap_79;
            MR_Word TableList_80;

            {
              MaybeOffset_12 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), MaybeOffset_12, 0) = ((MR_Box) (TableOffset0_75));
            }
            mercury__map__det_insert_4_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0), ((MR_Box) (BaseName_11)), ((MR_Box) (TableOffset0_75)), TableMap0_73, &TableMap_79);
            {
              TableList_80 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), TableList_80, 0) = ((MR_Box) (BaseName_11));
              MR_hl_field(MR_mktag(1), TableList_80, 1) = ((MR_Box) (TableList0_74));
            }
            {
              STATE_VARIABLE_StringTable_19_19 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
              MR_hl_field(MR_mktag(0), STATE_VARIABLE_StringTable_19_19, 0) = ((MR_Box) (TableMap_79));
              MR_hl_field(MR_mktag(0), STATE_VARIABLE_StringTable_19_19, 1) = ((MR_Box) (TableList_80));
              MR_hl_field(MR_mktag(0), STATE_VARIABLE_StringTable_19_19, 2) = ((MR_Box) (TableOffset_78));
            }
          }
          else
          {
