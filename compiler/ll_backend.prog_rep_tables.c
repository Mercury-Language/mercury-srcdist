            ...
            case (MR_Integer) 1:
              {
                ...
                MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), BuiltinType_29, (MR_Integer) 0)));
          ...
          case (MR_Integer) 1:
            {
              ...
              MR_Unsigned packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Type_7, (MR_Integer) 1)));
              MR_Unsigned packed_word_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Type_7, (MR_Integer) 4)));
...
{
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        {
          MaybeBaseName_9 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        else
        {
          ...
          {
            {
              MaybeOffset_12 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
          ...
          else
          {
            ...
            if (succeeded)
            {
              ...
              {
                TableList_81 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
...
{
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        {
          TableList_15 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
