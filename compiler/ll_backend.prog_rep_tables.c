      ...
      case (MR_Integer) 1:
        {
          ...
          if ((ArgTypeCodes_14 == (MR_Word) ((MR_Integer) 0)))
          {
          ...
          else
          {
            ...
            if ((Var_160 == (MR_Word) ((MR_Integer) 0)))
            {
              MR_Word Var_98;
            ...
            else
            {
              ...
              if ((Var_162 == (MR_Word) ((MR_Integer) 0)))
              {
                MR_Word Var_93;
                MR_Word Var_94;
                MR_Word Var_95;
              ...
              else
              {
                ...
                if ((Var_164 == (MR_Word) ((MR_Integer) 0)))
                {
                  MR_Word Var_84;
                  MR_Word Var_85;
                  MR_Word Var_86;
...
{
  {
    ...
    mercury__map__init_1_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0), &StringMap0_3);
    {
      ...
      MR_hl_field(MR_mktag(0), STATE_VARIABLE_StringTable_7_7, 1) = ((MR_Box) ((MR_Integer) 0));
...
{
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          MaybeBaseName_9 = (MR_Word) ((MR_Integer) 0);
          succeeded = MR_TRUE;
        }
      }
      else
      ...
      if (succeeded)
      {
        ...
        else
        {
          ...
          else
          {
            ...
            {
              MaybeOffset_12 = (MR_Word) ((MR_Integer) 0);
              STATE_VARIABLE_StringTable_19_19 = STATE_VARIABLE_StringTable_0_14;
            }
          }
    ...
    else
    {
      ...
      if ((MaybeOffset_34 == (MR_Word) ((MR_Integer) 0)))
...
{
  {
    ...
    else
    {
      ...
      {
        *MaybeOffset_6 = (MR_Word) ((MR_Integer) 0);
        *STATE_VARIABLE_StringTable_17 = STATE_VARIABLE_StringTable_0_16;
      }
    }
  }
