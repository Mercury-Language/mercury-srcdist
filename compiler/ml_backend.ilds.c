...
MR_decl_label4(__Unify___ml_backend__ilds__blocktype_0_0, 5,19,6,1)
...
MR_decl_label8(__Compare___ml_backend__ilds__blocktype_0_0, 30,7,5,33,11,9,15,16)
...
MR_decl_label4(__Compare___ml_backend__ilds__il_method_param_0_0, 3,2,5,27)
MR_decl_label4(__Compare___ml_backend__ilds__il_type_0_0, 3,2,5,27)
...
MR_decl_label2(__Compare___ml_backend__ilds__methodref_0_0, 35,110)
MR_decl_label4(__Compare___ml_backend__ilds__ret_type_0_0, 18,7,5,9)
MR_decl_label5(__Compare___ml_backend__ilds__signature_0_0, 3,2,5,9,38)
...
MR_decl_label5(__Compare___ml_backend__ilds__structured_name_0_0, 3,2,5,9,38)
...
const MR_DuArgLocn mercury_data_ml_backend__ilds__field_locns_constant_0_1[] = {
	{ 0, 0, -1 },
};
...
static const MR_DuFunctorDesc mercury_data_ml_backend__ilds__du_functor_desc_constant_0_1 = {
	...
	NULL,
	mercury_data_ml_backend__ilds__field_locns_constant_0_1,
	NULL
};
...
MR_BEGIN_MODULE(ml_backend__ilds_module15)
	...
	MR_init_label4(__Unify___ml_backend__ilds__blocktype_0_0,5,19,6,1)
MR_BEGIN_CODE
...
MR_define_entry(mercury____Unify___ml_backend__ilds__blocktype_0_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if ((MR_r1 == MR_r2)) {
		MR_GOTO_LAB(__Unify___ml_backend__ilds__blocktype_0_0_i19);
	}
	MR_incr_sp(3);
	MR_sv(3) = (MR_Word) MR_succip;
	{
...
MR_def_label(__Unify___ml_backend__ilds__blocktype_0_0,19)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_TRUE;
	MR_proceed();
...
MR_BEGIN_MODULE(ml_backend__ilds_module16)
	...
	MR_init_label8(__Compare___ml_backend__ilds__blocktype_0_0,30,7,5,33,11,9,15,16)
MR_BEGIN_CODE
...
MR_define_entry(mercury____Compare___ml_backend__ilds__blocktype_0_0);
	...
	MR_sv(3) = (MR_Word) MR_succip;
	if ((MR_r1 == MR_r2)) {
		MR_GOTO_LAB(__Compare___ml_backend__ilds__blocktype_0_0_i30);
	}
	MR_sv(1) = MR_r1;
	MR_sv(2) = MR_r2;
...
MR_def_label(__Compare___ml_backend__ilds__blocktype_0_0,30)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Integer) 0;
	MR_decr_sp_and_return(3);
MR_def_label(__Compare___ml_backend__ilds__blocktype_0_0,7)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_sv(2),1)) {
		MR_GOTO_LAB(__Compare___ml_backend__ilds__blocktype_0_0_i33);
	}
	MR_r1 = (MR_Integer) 1;
	MR_decr_sp_and_return(3);
...
MR_def_label(__Compare___ml_backend__ilds__blocktype_0_0,33)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Integer) 2;
	MR_decr_sp_and_return(3);
...
MR_define_entry(mercury____Unify___ml_backend__ilds__constant_0_0);
	...
	MR_tempf3 = MR_float_from_dword_ptr(&MR_tfield(1, MR_tempr1, 0));
	MR_tempf4 = MR_float_from_dword_ptr(&MR_tfield(1, MR_tempr2, 0));
...
MR_BEGIN_MODULE(ml_backend__ilds_module36)
	...
	MR_init_label4(__Compare___ml_backend__ilds__il_method_param_0_0,3,2,5,27)
MR_BEGIN_CODE
...
MR_def_label(__Compare___ml_backend__ilds__il_method_param_0_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___ml_backend__ilds__il_method_param_0_0_i27);
	}
	MR_r1 = (MR_Word) MR_TAG_COMMON(0,0,3);
	MR_r2 = MR_sv(1);
	MR_r3 = MR_sv(2);
	...
	MR_decr_sp(3);
	MR_np_tailcall_ent(builtin__compare_3_0);
MR_def_label(__Compare___ml_backend__ilds__il_method_param_0_0,27)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(3);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
...
MR_BEGIN_MODULE(ml_backend__ilds_module38)
	...
	MR_init_label4(__Compare___ml_backend__ilds__il_type_0_0,3,2,5,27)
MR_BEGIN_CODE
...
MR_def_label(__Compare___ml_backend__ilds__il_type_0_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___ml_backend__ilds__il_type_0_0_i27);
	}
	MR_r1 = MR_sv(1);
	MR_r2 = MR_sv(2);
	MR_succip_word = MR_sv(3);
...
MR_def_label(__Compare___ml_backend__ilds__il_type_0_0,27)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(3);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
...
MR_BEGIN_MODULE(ml_backend__ilds_module53)
	...
	MR_init_label2(__Compare___ml_backend__ilds__methodref_0_0,35,110)
MR_BEGIN_CODE
...
MR_def_label(__Compare___ml_backend__ilds__methodref_0_0,9)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___ml_backend__ilds__methodref_0_0_i110);
	}
	MR_r1 = MR_sv(6);
	MR_r2 = MR_sv(1);
...
MR_def_label(__Compare___ml_backend__ilds__methodref_0_0,35)
	...
	MR_decr_sp(7);
	MR_np_tailcall_ent(builtin__compare_3_0);
MR_def_label(__Compare___ml_backend__ilds__methodref_0_0,110)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(7);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
...
MR_BEGIN_MODULE(ml_backend__ilds_module67)
	...
	MR_init_label5(__Compare___ml_backend__ilds__signature_0_0,3,2,5,9,38)
MR_BEGIN_CODE
...
MR_def_label(__Compare___ml_backend__ilds__signature_0_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___ml_backend__ilds__signature_0_0_i38);
	}
	MR_r1 = MR_sv(1);
	MR_r2 = MR_sv(3);
	MR_np_call_localret_ent(__Compare___ml_backend__ilds__ret_type_0_0,
...
MR_def_label(__Compare___ml_backend__ilds__signature_0_0,9)
	...
	MR_decr_sp(5);
	MR_np_tailcall_ent(builtin__compare_3_0);
MR_def_label(__Compare___ml_backend__ilds__signature_0_0,38)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(5);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
...
MR_BEGIN_MODULE(ml_backend__ilds_module74)
	...
	MR_init_label5(__Compare___ml_backend__ilds__structured_name_0_0,3,2,5,9,38)
MR_BEGIN_CODE
...
MR_def_label(__Compare___ml_backend__ilds__structured_name_0_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___ml_backend__ilds__structured_name_0_0_i38);
	}
	MR_r1 = (MR_Word) MR_TAG_COMMON(0,0,0);
	MR_r2 = MR_sv(1);
	MR_r3 = MR_sv(3);
...
MR_def_label(__Compare___ml_backend__ilds__structured_name_0_0,9)
	...
	MR_decr_sp(5);
	MR_np_tailcall_ent(builtin__compare_3_0);
MR_def_label(__Compare___ml_backend__ilds__structured_name_0_0,38)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(5);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
...
void mercury__ml_backend__ilds__write_out_proc_statics(FILE *deep_fp, FILE *procrep_fp)
{
	MR_write_out_module_proc_reps_start(procrep_fp, &mercury_data__module_layout__ml_backend__ilds);
