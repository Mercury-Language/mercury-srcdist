...
struct check_hlds__delay_partial_inst__delay_partial_inst_in_goal_7_p_0_env_0_s {
  ...
  MR_Word check_hlds__delay_partial_inst__delay_partial_inst_in_goal_7_p_0_env_0__ArgMode_163;
  MR_Box check_hlds__delay_partial_inst__delay_partial_inst_in_goal_7_p_0_env_0__conv0_ArgMode_163;
};
...
check_hlds__delay_partial_inst__delay_partial_inst_in_goal_7_p_0(
  ...
  MR_Word Goal0_9,
  MR_Word * Goal_10,
  MR_Word STATE_VARIABLE_ConstructMap_0_123,
  MR_Word * STATE_VARIABLE_ConstructMap_124,
  MR_Word STATE_VARIABLE_DelayInfo_0_125,
  MR_Word * STATE_VARIABLE_DelayInfo_126);
...
{
  {
    ...
    hlds__hlds_pred__proc_info_get_varset_2_p_0(STATE_VARIABLE_ProcInfo_33_33, &VarSet0_14);
    hlds__hlds_pred__proc_info_get_vartypes_2_p_0(STATE_VARIABLE_ProcInfo_33_33, &VarTypes0_15);
      ...
      case (MR_Integer) 1:
        {
          ...
          hlds__hlds_pred__proc_info_set_varset_3_p_0(VarSet_24, STATE_VARIABLE_ProcInfo_35_35, &STATE_VARIABLE_ProcInfo_36_36);
          hlds__hlds_pred__proc_info_set_vartypes_3_p_0(VarTypes_25, STATE_VARIABLE_ProcInfo_36_36, &STATE_VARIABLE_ProcInfo_37_37);
          hlds__quantification__requantify_proc_general_3_p_0((MR_Integer) 0, STATE_VARIABLE_ProcInfo_37_37, &STATE_VARIABLE_ProcInfo_39_39);
          {
            ...
            MR_hl_field(MR_mktag(0), Var_41, 0) = ((MR_Box) (ProcId_10));
            MR_hl_field(MR_mktag(0), Var_41, 1) = ((MR_Box) (STATE_VARIABLE_ProcInfo_39_39));
          }
          {
            MR_Word base;
...
{
  {
    ...
    (env_ptr)->check_hlds__delay_partial_inst__delay_partial_inst_in_goal_7_p_0_env_0__ArgMode_163 = ((MR_Word) ((env_ptr)->check_hlds__delay_partial_inst__delay_partial_inst_in_goal_7_p_0_env_0__conv0_ArgMode_163));
...
{
  {
    ...
    {
      MR_Word Var_57 = ((MR_Word) ((MR_hl_field(MR_mktag(0), (env_ptr)->check_hlds__delay_partial_inst__delay_partial_inst_in_goal_7_p_0_env_0__ArgMode_163, (MR_Integer) 0))));
      MR_Word Var_58 = ((MR_Word) ((MR_hl_field(MR_mktag(0), (env_ptr)->check_hlds__delay_partial_inst__delay_partial_inst_in_goal_7_p_0_env_0__ArgMode_163, (MR_Integer) 1))));
      MR_Word Var_59 = ((MR_Word) ((MR_hl_field(MR_mktag(0), (env_ptr)->check_hlds__delay_partial_inst__delay_partial_inst_in_goal_7_p_0_env_0__ArgMode_163, (MR_Integer) 2))));

      (env_ptr)->check_hlds__delay_partial_inst__delay_partial_inst_in_goal_7_p_0_env_0__RHSFinalInst_60 = ((MR_Word) ((MR_hl_field(MR_mktag(0), (env_ptr)->check_hlds__delay_partial_inst__delay_partial_inst_in_goal_7_p_0_env_0__ArgMode_163, (MR_Integer) 3))));
        ...
        case (MR_Integer) 0:
          {
            ...
            check_hlds__delay_partial_inst__delay_partial_inst_in_goal_7_p_0(InstMap0_8, NegGoal0_18, &NegGoal_19, STATE_VARIABLE_ConstructMap_0_123, &Var_20, STATE_VARIABLE_DelayInfo_0_125, STATE_VARIABLE_DelayInfo_126);
            Var_154 = (MR_Word) ((MR_Word) (NegGoal_19));
            {
              MR_Word base;
            ...
            *STATE_VARIABLE_ConstructMap_124 = STATE_VARIABLE_ConstructMap_0_123;
          }
          break;
        case (MR_Integer) 1:
          {
              ...
              case (MR_Integer) 0:
                {
                  ...
                  {
                    (env).check_hlds__delay_partial_inst__delay_partial_inst_in_goal_7_p_0_env_0__ModuleInfo_55 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_DelayInfo_0_125, (MR_Integer) 0))));
                    Var_181 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_DelayInfo_0_125, (MR_Integer) 1))));
                    Var_182 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_DelayInfo_0_125, (MR_Integer) 2))));
                    packed_word_5 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_DelayInfo_0_125, (MR_Integer) 3)));
                    Var_183 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_DelayInfo_0_125, (MR_Integer) 3))) & (MR_Integer) 1);
                    check_hlds__delay_partial_inst__delay_partial_inst_in_goal_7_p_0_4(&env);
                  }
                  if ((env).check_hlds__delay_partial_inst__delay_partial_inst_in_goal_7_p_0_env_0__succeeded)
                    check_hlds__delay_partial_inst__delay_partial_inst_in_partial_construct_7_p_0(GoalInfo0_14, Unify_42, Goal_10, STATE_VARIABLE_ConstructMap_0_123, STATE_VARIABLE_ConstructMap_124, STATE_VARIABLE_DelayInfo_0_125, STATE_VARIABLE_DelayInfo_126);
                  else
                  {
                    switch (MR_tag((MR_Word) RHS0_40)) {
                      ...
                      case (MR_Integer) 1:
                        {
                          *Goal_10 = Goal0_9;
                          *STATE_VARIABLE_DelayInfo_126 = STATE_VARIABLE_DelayInfo_0_125;
                        }
                        break;
                      case (MR_Integer) 2:
                        {
                          ...
                          MR_Word LambdaQuantVars_66 = ((MR_Word) ((MR_hl_field(MR_mktag(2), RHS0_40, (MR_Integer) 3))));
                          MR_Word Modues_67 = ((MR_Word) ((MR_hl_field(MR_mktag(2), RHS0_40, (MR_Integer) 4))));
                          MR_Word Detism_68 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(2), RHS0_40, (MR_Integer) 5))) & (MR_Integer) 7);
                          MR_Word LambdaGoal0_69 = ((MR_Word) ((MR_hl_field(MR_mktag(2), RHS0_40, (MR_Integer) 6))));
                          MR_Word LambdaGoal_70;
                          MR_Word RHS_72;
                          MR_Word GoalExpr_73;
                          MR_Word Var_139;
                          MR_Unsigned packed_word_6 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), RHS0_40, (MR_Integer) 0)));
                          MR_Unsigned packed_word_7 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), RHS0_40, (MR_Integer) 5)));
                          MR_Word _ConstructMap_71;

                          Var_139 = mercury__map__init_0_f_0((MR_Word) (&check_hlds__delay_partial_inst_scalar_common_2[1]), (MR_Word) (&check_hlds__delay_partial_inst_scalar_common_1[1]));
                          check_hlds__delay_partial_inst__delay_partial_inst_in_goal_7_p_0(InstMap0_8, LambdaGoal0_69, &LambdaGoal_70, Var_139, &_ConstructMap_71, STATE_VARIABLE_DelayInfo_0_125, STATE_VARIABLE_DelayInfo_126);
                          {
                            RHS_72 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, (7 * sizeof(MR_Word)), NULL, NULL));
                            MR_hl_field(MR_mktag(2), RHS_72, 0) = (MR_Box) (packed_word_6);
                            MR_hl_field(MR_mktag(2), RHS_72, 1) = NULL;
                            MR_hl_field(MR_mktag(2), RHS_72, 2) = ((MR_Box) (NonLocals_65));
                            MR_hl_field(MR_mktag(2), RHS_72, 3) = ((MR_Box) (LambdaQuantVars_66));
                            MR_hl_field(MR_mktag(2), RHS_72, 4) = ((MR_Box) (Modues_67));
                            MR_hl_field(MR_mktag(2), RHS_72, 5) = (MR_Box) ((MR_Unsigned) (Detism_68));
                            MR_hl_field(MR_mktag(2), RHS_72, 6) = ((MR_Box) (LambdaGoal_70));
                          }
                          {
                            GoalExpr_73 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL));
                            MR_hl_field(MR_mktag(1), GoalExpr_73, 0) = ((MR_Box) (LHS_39));
                            MR_hl_field(MR_mktag(1), GoalExpr_73, 1) = ((MR_Box) (RHS_72));
                            MR_hl_field(MR_mktag(1), GoalExpr_73, 2) = ((MR_Box) (Mode_41));
                            MR_hl_field(MR_mktag(1), GoalExpr_73, 3) = ((MR_Box) (Unify_42));
                            MR_hl_field(MR_mktag(1), GoalExpr_73, 4) = ((MR_Box) (Context_43));
                          }
                          {
                            MR_Word base;
                            base = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
                ...
                break;
              case (MR_Integer) 1:
                check_hlds__delay_partial_inst__delay_partial_inst_in_deconstruct_8_p_0(Goal0_9, Mode_41, Unify_42, Goal_10, STATE_VARIABLE_ConstructMap_0_123, STATE_VARIABLE_ConstructMap_124, STATE_VARIABLE_DelayInfo_0_125, STATE_VARIABLE_DelayInfo_126);
                break;
              case (MR_Integer) 2:
                {
                  *Goal_10 = Goal0_9;
              ...
              case (MR_Integer) 3:
                switch (((MR_Integer) ((MR_hl_field(MR_mktag(3), Unify_42, (MR_Integer) 0))))) {
                  ...
                  case (MR_Integer) 0:
                    ...
                    break;
                  case (MR_Integer) 1:
                    check_hlds__delay_partial_inst__delay_partial_inst_in_complicated_unify_9_p_0(Goal0_9, LHS_39, RHS0_40, Unify_42, Goal_10, STATE_VARIABLE_ConstructMap_0_123, STATE_VARIABLE_ConstructMap_124, STATE_VARIABLE_DelayInfo_0_125, STATE_VARIABLE_DelayInfo_126);
                    break;
                }
                break;
            }
        ...
        case (MR_Integer) 3:
          switch (((MR_Integer) ((MR_hl_field(MR_mktag(3), GoalExpr0_13, (MR_Integer) 0))))) {
            ...
            case (MR_Integer) 2:
              {
                ...
                check_hlds__delay_partial_inst__delay_partial_inst_in_conj_7_p_0(InstMap0_8, Goals0_16, &Goals_17, STATE_VARIABLE_ConstructMap_0_123, STATE_VARIABLE_ConstructMap_124, STATE_VARIABLE_DelayInfo_0_125, STATE_VARIABLE_DelayInfo_126);
                {
                  ...
                  MR_hl_field(MR_mktag(3), Var_160, 1) = (MR_Box) ((MR_Unsigned) (ConjType_15));
                  MR_hl_field(MR_mktag(3), Var_160, 2) = ((MR_Box) (Goals_17));
                }
                {
                  MR_Word base;
                  base = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
            ...
            case (MR_Integer) 3:
              {
                MR_Word Var_157;
                MR_Word Goals0_161 = ((MR_Word) ((MR_hl_field(MR_mktag(3), GoalExpr0_13, (MR_Integer) 1))));
                MR_Word Goals_162;

                check_hlds__delay_partial_inst__delay_partial_inst_in_disj_7_p_0(InstMap0_8, Goals0_161, &Goals_162, STATE_VARIABLE_ConstructMap_0_123, STATE_VARIABLE_ConstructMap_124, STATE_VARIABLE_DelayInfo_0_125, STATE_VARIABLE_DelayInfo_126);
                {
                  Var_157 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                  MR_hl_field(MR_mktag(3), Var_157, 0) = ((MR_Box) ((MR_Unsigned) 3U));
                  MR_hl_field(MR_mktag(3), Var_157, 1) = ((MR_Box) (Goals_162));
                }
                {
                  MR_Word base;
                  base = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
            ...
            case (MR_Integer) 4:
              {
                ...
                check_hlds__delay_partial_inst__delay_partial_inst_in_cases_7_p_0(InstMap0_8, Cases0_23, &Cases_24, STATE_VARIABLE_ConstructMap_0_123, STATE_VARIABLE_ConstructMap_124, STATE_VARIABLE_DelayInfo_0_125, STATE_VARIABLE_DelayInfo_126);
                {
                  Var_152 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL));
                  MR_hl_field(MR_mktag(3), Var_152, 0) = ((MR_Box) ((MR_Unsigned) 4U));
                  MR_hl_field(MR_mktag(3), Var_152, 1) = ((MR_Box) (Var_21));
                  MR_hl_field(MR_mktag(3), Var_152, 2) = (MR_Box) ((MR_Unsigned) (CanFail_22));
                  MR_hl_field(MR_mktag(3), Var_152, 3) = ((MR_Box) (Cases_24));
                }
                {
                  MR_Word base;
                  base = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
            ...
            case (MR_Integer) 5:
              {
                ...
                else
                {
                  ...
                  check_hlds__delay_partial_inst__delay_partial_inst_in_goal_7_p_0(InstMap0_8, SubGoal0_34, &SubGoal_37, STATE_VARIABLE_ConstructMap_0_123, &Var_38, STATE_VARIABLE_DelayInfo_0_125, STATE_VARIABLE_DelayInfo_126);
                  {
                    Var_142 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(MR_mktag(3), Var_142, 0) = ((MR_Box) ((MR_Unsigned) 5U));
                    MR_hl_field(MR_mktag(3), Var_142, 1) = ((MR_Box) (Reason_33));
                    MR_hl_field(MR_mktag(3), Var_142, 2) = ((MR_Box) (SubGoal_37));
                  }
                  {
                    MR_Word base;
                    base = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
            ...
            case (MR_Integer) 6:
              {
                ...
                MR_Word Then_31;
                MR_Word Else_32;
                MR_Word STATE_VARIABLE_ConstructMap_143_143;
                MR_Word STATE_VARIABLE_DelayInfo_144_144;
                ...
                check_hlds__delay_partial_inst__delay_partial_inst_in_goal_7_p_0(InstMap0_8, Cond0_26, &Cond_30, STATE_VARIABLE_ConstructMap_0_123, &STATE_VARIABLE_ConstructMap_143_143, STATE_VARIABLE_DelayInfo_0_125, &STATE_VARIABLE_DelayInfo_144_144);
                check_hlds__delay_partial_inst__delay_partial_inst_in_goal_7_p_0(InstMapThen_29, Then0_27, &Then_31, STATE_VARIABLE_ConstructMap_143_143, &STATE_VARIABLE_ConstructMap_145_145, STATE_VARIABLE_DelayInfo_144_144, &STATE_VARIABLE_DelayInfo_146_146);
                check_hlds__delay_partial_inst__delay_partial_inst_in_goal_7_p_0(InstMap0_8, Else0_28, &Else_32, STATE_VARIABLE_ConstructMap_145_145, STATE_VARIABLE_ConstructMap_124, STATE_VARIABLE_DelayInfo_146_146, STATE_VARIABLE_DelayInfo_126);
                {
                  ...
                  MR_hl_field(MR_mktag(3), Var_149, 1) = ((MR_Box) (Vars_25));
                  MR_hl_field(MR_mktag(3), Var_149, 2) = ((MR_Box) (Cond_30));
                  MR_hl_field(MR_mktag(3), Var_149, 3) = ((MR_Box) (Then_31));
                  MR_hl_field(MR_mktag(3), Var_149, 4) = ((MR_Box) (Else_32));
                }
                {
                  MR_Word base;
                  base = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
            ...
            case (MR_Integer) 7:
              {
                MR_Word ShortHand0_106 = ((MR_Word) ((MR_hl_field(MR_mktag(3), GoalExpr0_13, (MR_Integer) 1))));

                switch (MR_tag((MR_Word) ShortHand0_106)) {
                  default: /*NOTREACHED*/ MR_assert(0);
                  case (MR_Integer) 0:
                    {
                  ...
                  case (MR_Integer) 1:
                    {
                      MR_Word GoalType_107 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(1), ShortHand0_106, (MR_Integer) 0))) & (MR_Integer) 3);
                      MR_Word Outer_108 = ((MR_Word) ((MR_hl_field(MR_mktag(1), ShortHand0_106, (MR_Integer) 1))));
                      MR_Word Inner_109 = ((MR_Word) ((MR_hl_field(MR_mktag(1), ShortHand0_106, (MR_Integer) 2))));
                      MR_Word MaybeOutputVars_110 = ((MR_Word) ((MR_hl_field(MR_mktag(1), ShortHand0_106, (MR_Integer) 3))));
                      MR_Word MainGoal0_111 = ((MR_Word) ((MR_hl_field(MR_mktag(1), ShortHand0_106, (MR_Integer) 4))));
                      MR_Word OrElseGoals0_112 = ((MR_Word) ((MR_hl_field(MR_mktag(1), ShortHand0_106, (MR_Integer) 5))));
                      MR_Word OrElseInners_113 = ((MR_Word) ((MR_hl_field(MR_mktag(1), ShortHand0_106, (MR_Integer) 6))));
                      MR_Word MainGoal_114;
                      MR_Word OrElseGoals_116;
                      MR_Word ShortHand_118;
                      MR_Word STATE_VARIABLE_DelayInfo_131_131;
                      MR_Word GoalExpr_170;
                      MR_Unsigned packed_word_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), ShortHand0_106, (MR_Integer) 0)));
                      MR_Word Var_115;
                      MR_Word Var_117;

                      check_hlds__delay_partial_inst__delay_partial_inst_in_goal_7_p_0(InstMap0_8, MainGoal0_111, &MainGoal_114, STATE_VARIABLE_ConstructMap_0_123, &Var_115, STATE_VARIABLE_DelayInfo_0_125, &STATE_VARIABLE_DelayInfo_131_131);
                      check_hlds__delay_partial_inst__delay_partial_inst_in_disj_7_p_0(InstMap0_8, OrElseGoals0_112, &OrElseGoals_116, STATE_VARIABLE_ConstructMap_0_123, &Var_117, STATE_VARIABLE_DelayInfo_131_131, STATE_VARIABLE_DelayInfo_126);
                      {
                        ShortHand_118 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (7 * sizeof(MR_Word)), NULL, NULL));
                        MR_hl_field(MR_mktag(1), ShortHand_118, 0) = (MR_Box) ((MR_Unsigned) (GoalType_107));
                        MR_hl_field(MR_mktag(1), ShortHand_118, 1) = ((MR_Box) (Outer_108));
                        MR_hl_field(MR_mktag(1), ShortHand_118, 2) = ((MR_Box) (Inner_109));
                        MR_hl_field(MR_mktag(1), ShortHand_118, 3) = ((MR_Box) (MaybeOutputVars_110));
                        MR_hl_field(MR_mktag(1), ShortHand_118, 4) = ((MR_Box) (MainGoal_114));
                        MR_hl_field(MR_mktag(1), ShortHand_118, 5) = ((MR_Box) (OrElseGoals_116));
                        MR_hl_field(MR_mktag(1), ShortHand_118, 6) = ((MR_Box) (OrElseInners_113));
                      }
                      {
                        GoalExpr_170 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                        MR_hl_field(MR_mktag(3), GoalExpr_170, 0) = ((MR_Box) ((MR_Unsigned) 7U));
                        MR_hl_field(MR_mktag(3), GoalExpr_170, 1) = ((MR_Box) (ShortHand_118));
                      }
                      {
                        MR_Word base;
                        base = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
                        *Goal_10 = base;
                        MR_hl_field(MR_mktag(0), base, 0) = ((MR_Box) (GoalExpr_170));
                        MR_hl_field(MR_mktag(0), base, 1) = ((MR_Box) (GoalInfo0_14));
                      }
                      *STATE_VARIABLE_ConstructMap_124 = STATE_VARIABLE_ConstructMap_0_123;
                    }
                  ...
                  case (MR_Integer) 2:
                    {
                      MR_Word MaybeIO_119 = ((MR_Word) ((MR_hl_field(MR_mktag(2), ShortHand0_106, (MR_Integer) 0))));
                      MR_Word ResultVar_120 = ((MR_Word) ((MR_hl_field(MR_mktag(2), ShortHand0_106, (MR_Integer) 1))));
                      MR_Word SubGoal0_171 = ((MR_Word) ((MR_hl_field(MR_mktag(2), ShortHand0_106, (MR_Integer) 2))));
                      MR_Word SubGoal_172;
                      MR_Word GoalExpr_173;
                      MR_Word ShortHand_174;

                      check_hlds__delay_partial_inst__delay_partial_inst_in_goal_7_p_0(InstMap0_8, SubGoal0_171, &SubGoal_172, STATE_VARIABLE_ConstructMap_0_123, STATE_VARIABLE_ConstructMap_124, STATE_VARIABLE_DelayInfo_0_125, STATE_VARIABLE_DelayInfo_126);
                      {
                        ShortHand_174 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
                        MR_hl_field(MR_mktag(2), ShortHand_174, 0) = ((MR_Box) (MaybeIO_119));
                        MR_hl_field(MR_mktag(2), ShortHand_174, 1) = ((MR_Box) (ResultVar_120));
                        MR_hl_field(MR_mktag(2), ShortHand_174, 2) = ((MR_Box) (SubGoal_172));
                      }
                      {
                        GoalExpr_173 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                        MR_hl_field(MR_mktag(3), GoalExpr_173, 0) = ((MR_Box) ((MR_Unsigned) 7U));
                        MR_hl_field(MR_mktag(3), GoalExpr_173, 1) = ((MR_Box) (ShortHand_174));
                      }
                      {
                        MR_Word base;
                        base = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
                        *Goal_10 = base;
                        MR_hl_field(MR_mktag(0), base, 0) = ((MR_Box) (GoalExpr_173));
                        MR_hl_field(MR_mktag(0), base, 1) = ((MR_Box) (GoalInfo0_14));
                      }
                    }
                    break;
...
{
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        TypeInfo_19_53 = (MR_Word) (&check_hlds__delay_partial_inst_scalar_common_2[1]);
        TypeInfo_20_54 = (MR_Word) (&check_hlds__delay_partial_inst_scalar_common_1[1]);
        succeeded = mercury__map__search_3_p_0(TypeInfo_19_53, TypeInfo_20_54, STATE_VARIABLE_ConstructMap_0_28, ((MR_Box) (LHS_11)), &conv0_CanonVarsMap_43);
        if (succeeded)
        {
        ...
        if (succeeded)
        {
          TypeCtorInfo_21_55 = (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_cons_id_0);
          TypeInfo_22_56 = (MR_Word) (&check_hlds__delay_partial_inst_scalar_common_2[2]);
          List_44 = mercury__map__to_assoc_list_1_f_0(TypeCtorInfo_21_55, TypeInfo_22_56, CanonVarsMap_43);
          succeeded = (List_44 != (MR_Word) ((MR_Unsigned) 0U));
          if (succeeded)
          {
            Var_57 = ((MR_Word) ((MR_hl_field(MR_mktag(1), List_44, (MR_Integer) 0))));
            Rest_45 = ((MR_Word) ((MR_hl_field(MR_mktag(1), List_44, (MR_Integer) 1))));
            ConsId_21 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_57, (MR_Integer) 0))));
            CanonArgs_22 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_57, (MR_Integer) 1))));
            if (!((Rest_45 == (MR_Word) ((MR_Unsigned) 0U))))
            {
              MR_String Var_50;

              Var_50 = mercury__string__f_43_43_2_f_0((MR_String) "delaying partial instantiations when variable could be ", (MR_String) "bound to multiple functors");
              {
                mercury__require__sorry_2_p_0((MR_String) "predicate \140check_hlds.delay_partial_inst.get_sole_cons_id_and_canon_vars\'/4", Var_50);
                return;
              }
            }
            succeeded = MR_TRUE;
    ...
    if (succeeded)
    {
      ...
      hlds__make_goal__create_pure_atomic_complicated_unification_6_p_0(LHS_11, RHS0_12, ProgContext_25, (MR_Word) (MR_mkword(MR_mktag(3), &check_hlds__delay_partial_inst_scalar_common_4[0])), (MR_Word) ((MR_Unsigned) 0U), &AssignGoal_27);
...
{
  {
    ...
    else
    {
      ...
      Var_65 = mercury__map__init_0_f_0((MR_Word) (&check_hlds__delay_partial_inst_scalar_common_2[1]), (MR_Word) (&check_hlds__delay_partial_inst_scalar_common_2[1]));
      ...
      Var_78 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_DelayInfo_0_28, (MR_Integer) 3))) & (MR_Integer) 1);
      {
        ...
        MR_hl_field(MR_mktag(0), STATE_VARIABLE_DelayInfo_30_30, 3) = (MR_Box) ((MR_Unsigned) (Var_78));
      }
