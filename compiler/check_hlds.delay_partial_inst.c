...
static const MR_FA_PseudoTypeInfo_Struct2 check_hlds__delay_partial_inst__tree234__pti_tree234_2__plain_builtin__type_ctor_info_int_0__plain_hlds__hlds_proc__type_ctor_info_proc_info_0;

static const MR_FA_TypeInfo_Struct2 check_hlds__delay_partial_inst__pair__ti_pair_2builtin__type_ctor_info_int_0hlds__hlds_proc__type_ctor_info_proc_info_0;

static const MR_FA_PseudoTypeInfo_Struct1 check_hlds__delay_partial_inst__list__pti_list_1__plain_pair__ti_pair_2builtin__type_ctor_info_int_0hlds__hlds_proc__type_ctor_info_proc_info_0;
...
static /* final */ const MR_Box check_hlds__delay_partial_inst_scalar_common_4[2][10] = {
  /* row   0 */
  {
    ...
    ((MR_Box) (&check_hlds__delay_partial_inst__tree234__pti_tree234_2__plain_builtin__type_ctor_info_int_0__plain_hlds__hlds_proc__type_ctor_info_proc_info_0)),
    ((MR_Box) (&mercury__builtin__builtin__type_ctor_info_int_0)),
    ((MR_Box) (&check_hlds__delay_partial_inst__list__pti_list_1__plain_pair__ti_pair_2builtin__type_ctor_info_int_0hlds__hlds_proc__type_ctor_info_proc_info_0)),
    ((MR_Box) (&check_hlds__delay_partial_inst__list__pti_list_1__plain_pair__ti_pair_2builtin__type_ctor_info_int_0hlds__hlds_proc__type_ctor_info_proc_info_0))
  },
  /* row   1 */
  {
...
static const MR_FA_PseudoTypeInfo_Struct1 check_hlds__delay_partial_inst__list__pti_list_1__plain_pair__ti_pair_2builtin__type_ctor_info_int_0hlds__hlds_proc__type_ctor_info_proc_info_0 = {
  ...
  { (MR_PseudoTypeInfo) (&check_hlds__delay_partial_inst__pair__ti_pair_2builtin__type_ctor_info_int_0hlds__hlds_proc__type_ctor_info_proc_info_0) }
};
  ...
  MR_Word * STATE_VARIABLE_ChangedProcs_31)
{
  ...
  mercury__map__lookup_3_p_0((MR_Word) (&hlds__pred_proc_id__hlds__pred_proc_id__type_ctor_info_proc_id_0), (MR_Word) (&hlds__hlds_proc__hlds__hlds_proc__type_ctor_info_proc_info_0), ProcTable_11, ((MR_Box) (ProcId_12)), &conv0_STATE_VARIABLE_ProcInfo_1_36);
  STATE_VARIABLE_ProcInfo_1_36 = ((MR_Word) (conv0_STATE_VARIABLE_ProcInfo_1_36));
  hlds__hlds_proc__proc_info_get_var_table_2_p_0(STATE_VARIABLE_ProcInfo_1_36, &VarTable0_16);
  hlds__hlds_proc_util__proc_info_get_initial_instmap_3_p_0(ModuleInfo_9, STATE_VARIABLE_ProcInfo_1_36, &InstMap0_17);
  hlds__hlds_proc__proc_info_get_goal_2_p_0(STATE_VARIABLE_ProcInfo_1_36, &Goal0_18);
  {
    ...
    case (MR_Integer) 1:
      {
        ...
        hlds__hlds_proc__proc_info_set_goal_3_p_0(Goal_21, STATE_VARIABLE_ProcInfo_1_36, &STATE_VARIABLE_ProcInfo_2_38);
        hlds__hlds_proc__proc_info_set_var_table_3_p_0(VarTable_25, STATE_VARIABLE_ProcInfo_2_38, &STATE_VARIABLE_ProcInfo_3_39);
  ...
  MR_Word * STATE_VARIABLE_DelayInfo_7)
{
  ...
  else
  {
    ...
    hlds__goal_list_util__goal_to_conj_list_2_p_0(HeadGoal_21, &HeadGoals_24);
  ...
  MR_Word * Goal_12)
{
  ...
  if (succeeded)
  {
    ...
    hlds__goal_list_util__conjoin_goals_3_p_0(TestGoal_22, AssignGoal_23, Goal_12);
  }
  else
    *Goal_12 = Goal0_8;
}
  ...
  MR_Word * STATE_VARIABLE_ConstructMap_37)
{
  ...
  if (succeeded)
  {
    ...
    hlds__goal_list_util__conj_list_to_goal_3_p_0(ConjList_34, GoalInfo0_25, Goal_12);
  }
  else
  {
    *Goal_12 = Goal0_9;
  ...
  MR_Word * STATE_VARIABLE_DelayInfo_30)
{
  ...
  hlds__goal_list_util__conj_list_to_goal_3_p_0(SubUnifyGoals_26, GoalInfo0_8, Goal_10);
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_12)
{
  ...
  mercury__list__reverse_2_p_0((MR_Word) (&hlds__pred_proc_id__hlds__pred_proc_id__type_ctor_info_pred_id_0), RevChangedPredIds_10, ChangedPredIds_8);
}
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_6)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      mercury__list__foldl_4_p_0((MR_Word) (&hlds__pred_proc_id__hlds__pred_proc_id__type_ctor_info_proc_id_0), (MR_Word) (&check_hlds__delay_partial_inst_scalar_common_2[0]), Var_31, ProcIds_21, ((MR_Box) ((MR_Unsigned) 0U)), &conv1_ChangedProcs_22);
      ...
      else
      {
        ...
        mercury__map__set_from_assoc_list_3_p_0((MR_Word) (&hlds__pred_proc_id__hlds__pred_proc_id__type_ctor_info_proc_id_0), (MR_Word) (&hlds__hlds_proc__hlds__hlds_proc__type_ctor_info_proc_info_0), ChangedProcs_22, ProcTable0_20, &ProcTable_25);
