                      ...
                      case (MR_Integer) 2:
                        {
                          ...
                          check_hlds__delay_partial_inst__delay_partial_inst_in_goal_7_p_0(InstMap0_8, LambdaGoal0_70, &LambdaGoal_71, Var_141, &_ConstructMap_72, STATE_VARIABLE_DelayInfo_0_126, STATE_VARIABLE_DelayInfo_127);
                          {
                            ...
                            MR_hl_field(MR_mktag(2), RHS_73, 0) = (MR_Box) (((MR_Unsigned) (((MR_Box) (Purity_62))) | (((((MR_Unsigned) (((MR_Box) (Groundness_63))) << (MR_Integer) 2)) | (((MR_Unsigned) (((MR_Box) (PredOrFunc_64))) << (MR_Integer) 3))))));
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_5)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      mercury__list__foldl_4_p_0((MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_proc_id_0), (MR_Word) (&check_hlds__delay_partial_inst_scalar_common_2[0]), Var_28, ProcIds_18, ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))), &conv1_ChangedProcs_19);
