              ...
              case (MR_Integer) 0:
                {
                  ...
                  else
                  {
                    switch (MR_tag((MR_Word) RHS0_40)) {
                      ...
                      case (MR_Integer) 2:
                        {
                          MR_Word Purity_62 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(2), RHS0_40, (MR_Integer) 0))) & (MR_Integer) 3);
                          MR_Word Groundness_63 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(2), RHS0_40, (MR_Integer) 0))) >> (MR_Integer) 2)) & (MR_Integer) 1);
                          MR_Word PredOrFunc_64 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(2), RHS0_40, (MR_Integer) 0))) >> (MR_Integer) 3)) & (MR_Integer) 1);
                          ...
                          check_hlds__delay_partial_inst__delay_partial_inst_in_goal_7_p_0(InstMap0_8, LambdaGoal0_70, &LambdaGoal_71, Var_141, &_ConstructMap_72, STATE_VARIABLE_DelayInfo_0_126, STATE_VARIABLE_DelayInfo_127);
                          {
                            ...
                            MR_hl_field(MR_mktag(2), RHS_73, 0) = (MR_Box) (packed_args_0);
...
{
  {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            ...
            if (!((Rest_45 == (MR_Word) ((MR_Integer) 0))))
            {
              {
    ...
    if (succeeded)
    {
      ...
      hlds__make_goal__create_pure_atomic_complicated_unification_6_p_0(RHSVar_20, Var_32, ProgContext_25, (MR_Word) ((MR_Integer) 0), (MR_Word) ((MR_Integer) 0), &TestGoal_26);
      hlds__make_goal__create_pure_atomic_complicated_unification_6_p_0(LHS_11, RHS0_12, ProgContext_25, (MR_Word) (MR_mkword(MR_mktag(3), &check_hlds__delay_partial_inst_scalar_common_4[0])), (MR_Word) ((MR_Integer) 0), &AssignGoal_27);
...
{
  {
    ...
    check_hlds__delay_partial_inst__delay_partial_inst_preds_acc_5_p_0(PredIds_5, (MR_Word) ((MR_Integer) 0), &RevChangedPredIds_8, STATE_VARIABLE_ModuleInfo_0_9, STATE_VARIABLE_ModuleInfo_10);
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_5)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      mercury__list__foldl_4_p_0((MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_proc_id_0), (MR_Word) (&check_hlds__delay_partial_inst_scalar_common_2[0]), Var_28, ProcIds_18, ((MR_Box) ((MR_Integer) 0)), &conv1_ChangedProcs_19);
      ChangedProcs_19 = ((MR_Word) (conv1_ChangedProcs_19));
      if ((ChangedProcs_19 == (MR_Word) ((MR_Integer) 0)))
      {
