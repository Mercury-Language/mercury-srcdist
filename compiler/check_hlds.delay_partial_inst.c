...
MR_def_label(check_hlds__delay_partial_inst__delay_partial_inst_in_goal_7_0,38)
	...
	MR_Word MR_tempr1, MR_tempr2;
	MR_tempr2 = MR_sv(5);
	MR_sv(2) = ((MR_Integer) MR_tfield(2, MR_tempr2, 0) & (MR_Integer) 3);
	MR_tempr1 = MR_tempr2;
	MR_sv(5) = (((MR_Integer) MR_tfield(2, MR_tempr1, 0) >> (MR_Integer) 2) & (MR_Integer) 1);
	MR_sv(9) = (((MR_Integer) MR_tfield(2, MR_tempr1, 0) >> (MR_Integer) 3) & (MR_Integer) 1);
...
MR_def_label(check_hlds__delay_partial_inst__delay_partial_inst_in_goal_7_0,43)
	...
	MR_tfield(2, MR_tempr1, 0) = ((MR_Integer) MR_sv(2) | (((MR_Integer) MR_sv(5) << (MR_Integer) 2) | ((MR_Integer) MR_sv(9) << (MR_Integer) 3)));
	MR_tfield(2, MR_tempr1, 2) = MR_sv(10);
	MR_tfield(2, MR_tempr1, 3) = MR_sv(11);
	MR_tfield(2, MR_tempr1, 4) = MR_sv(12);
	...
	MR_tfield(1, MR_tempr2, 3) = MR_sv(7);
	MR_tfield(1, MR_tempr2, 4) = MR_sv(8);
