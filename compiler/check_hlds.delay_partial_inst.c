  ...
  MR_Word * STATE_VARIABLE_DelayInfo_29)
{
  ...
  {
    MR_Word VarSet0_54 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_DelayInfo_0_28, (MR_Integer) 1))));
    MR_Word VarTypes0_55 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_DelayInfo_0_28, (MR_Integer) 2))));
    MR_Word VarSet_56;
    MR_Word VarTypes_57;
    MR_Word Renaming_58;
    MR_Word Var_61;
    ...
    Var_61 = mercury__map__init_0_f_0((MR_Word) (&check_hlds__delay_partial_inst_scalar_common_2[1]), (MR_Word) (&check_hlds__delay_partial_inst_scalar_common_2[1]));
    hlds__goal_util__clone_variables_9_p_0(Args_15, VarSet0_54, VarTypes0_55, VarSet0_54, &VarSet_56, VarTypes0_55, &VarTypes_57, Var_61, &Renaming_58);
    parse_tree__prog_rename__rename_var_list_4_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), (MR_Integer) 0, Renaming_58, Args_15, &CanonVars_22);
    Var_71 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_DelayInfo_0_28, (MR_Integer) 0))));
    Var_74 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_DelayInfo_0_28, (MR_Integer) 3))) & (MR_Integer) 1);
    {
      STATE_VARIABLE_DelayInfo_30_30 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), STATE_VARIABLE_DelayInfo_30_30, 0) = ((MR_Box) (Var_71));
      MR_hl_field(MR_mktag(0), STATE_VARIABLE_DelayInfo_30_30, 1) = ((MR_Box) (VarSet_56));
      MR_hl_field(MR_mktag(0), STATE_VARIABLE_DelayInfo_30_30, 2) = ((MR_Box) (VarTypes_57));
      MR_hl_field(MR_mktag(0), STATE_VARIABLE_DelayInfo_30_30, 3) = (MR_Box) ((MR_Unsigned) (Var_74));
    }
