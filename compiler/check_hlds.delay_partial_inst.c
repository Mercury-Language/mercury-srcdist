...
{
  {
    ...
    packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), DelayInfo_22, (MR_Integer) 3)));
              ...
              case (MR_Integer) 0:
                {
                  ...
                  if (((((MR_tag((MR_Word) ConsId_45)) == (MR_Integer) 3)) && ((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), ConsId_45, (MR_Integer) 0))) == (MR_Integer) 2))))
                    (env).check_hlds__delay_partial_inst__delay_partial_inst_in_goal_7_p_0_env_0__succeeded = MR_TRUE;
                  else
                  if (((((MR_tag((MR_Word) ConsId_45)) == (MR_Integer) 3)) && ((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), ConsId_45, (MR_Integer) 0))) == (MR_Integer) 3))))
                    (env).check_hlds__delay_partial_inst__delay_partial_inst_in_goal_7_p_0_env_0__succeeded = MR_TRUE;
                  else
                  ...
                  if ((env).check_hlds__delay_partial_inst__delay_partial_inst_in_goal_7_p_0_env_0__succeeded)
                  {
                    ...
                    Var_185 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_DelayInfo_0_126, (MR_Integer) 3))) & (MR_Integer) 1);
            ...
            case (MR_Integer) 2:
              {
                ...
                check_hlds__delay_partial_inst__delay_partial_inst_in_conj_7_p_0(InstMap0_8, Goals0_16, &Goals_17, STATE_VARIABLE_ConstructMap_0_124, STATE_VARIABLE_ConstructMap_125, STATE_VARIABLE_DelayInfo_0_126, STATE_VARIABLE_DelayInfo_127);
                {
                  ...
                  MR_hl_field(MR_mktag(3), Var_162, 0) = ((MR_Box) ((MR_Unsigned) 2U));
                  MR_hl_field(MR_mktag(3), Var_162, 1) = (MR_Box) ((MR_Unsigned) (ConjType_15));
            ...
            case (MR_Integer) 3:
              {
                ...
                check_hlds__delay_partial_inst__delay_partial_inst_in_disj_7_p_0(InstMap0_8, Goals0_163, &Goals_164, STATE_VARIABLE_ConstructMap_0_124, STATE_VARIABLE_ConstructMap_125, STATE_VARIABLE_DelayInfo_0_126, STATE_VARIABLE_DelayInfo_127);
                {
                  ...
                  MR_hl_field(MR_mktag(3), Var_159, 0) = ((MR_Box) ((MR_Unsigned) 3U));
            ...
            case (MR_Integer) 4:
              {
                ...
                {
                  Var_154 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL));
                  MR_hl_field(MR_mktag(3), Var_154, 0) = ((MR_Box) ((MR_Unsigned) 4U));
                  MR_hl_field(MR_mktag(3), Var_154, 1) = ((MR_Box) (Var_21));
                  MR_hl_field(MR_mktag(3), Var_154, 2) = (MR_Box) ((MR_Unsigned) (CanFail_22));
            ...
            case (MR_Integer) 5:
              {
                ...
                (env).check_hlds__delay_partial_inst__delay_partial_inst_in_goal_7_p_0_env_0__succeeded = ((((MR_tag((MR_Word) Reason_33)) == (MR_Integer) 3)) && ((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), Reason_33, (MR_Integer) 0))) == (MR_Integer) 6)));
                if ((env).check_hlds__delay_partial_inst__delay_partial_inst_in_goal_7_p_0_env_0__succeeded)
                {
                ...
                else
                {
                  ...
                  check_hlds__delay_partial_inst__delay_partial_inst_in_goal_7_p_0(InstMap0_8, SubGoal0_34, &SubGoal_37, STATE_VARIABLE_ConstructMap_0_124, &Var_38, STATE_VARIABLE_DelayInfo_0_126, STATE_VARIABLE_DelayInfo_127);
                  {
                    ...
                    MR_hl_field(MR_mktag(3), Var_144, 0) = ((MR_Box) ((MR_Unsigned) 5U));
            ...
            case (MR_Integer) 6:
              {
                ...
                {
                  Var_151 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL));
                  MR_hl_field(MR_mktag(3), Var_151, 0) = ((MR_Box) ((MR_Unsigned) 6U));
                  ...
                  case (MR_Integer) 2:
                    {
                      ...
                      {
                        ShortHand_176 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
                      ...
                      {
                        GoalExpr_175 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                        MR_hl_field(MR_mktag(3), GoalExpr_175, 0) = ((MR_Box) ((MR_Unsigned) 7U));
...
{
  {
    ...
    MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Unify_13, (MR_Integer) 2)));
    MR_Word RHSVar_20;
    MR_Word ConsId_21;
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          succeeded = ((MR_tag((MR_Word) List_44)) == (MR_Integer) 1);
          if (succeeded)
          {
...
{
  {
    ...
    MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), Unify_11, (MR_Integer) 4)));
    ...
    if (succeeded)
    {
      ...
      MR_Word ConjList_33;
      MR_Word Var_39;
      MR_Unsigned packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_DelayInfo_0_37, (MR_Integer) 3)));
...
{
  {
    ...
    MR_Word STATE_VARIABLE_DelayInfo_30_30;
    MR_Word Var_32;
    MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Unify_9, (MR_Integer) 5)));
    ...
    else
    {
      ...
      MR_Word Var_75;
      MR_Word Var_78;
      MR_Unsigned packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_DelayInfo_0_28, (MR_Integer) 3)));
      ...
      packed_word_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_DelayInfo_0_28, (MR_Integer) 3)));
    ...
    packed_word_3 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_DelayInfo_30_30, (MR_Integer) 3)));
    ...
    packed_word_4 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_DelayInfo_30_30, (MR_Integer) 3)));
    {
      MR_Word base;
