  ...
  MR_Word * STATE_VARIABLE_Info_27)
{
  ...
  if (succeeded)
  {
    ...
    make__file_names__get_file_name_for_target_file_10_p_0(ProgressStream_10, Globals_11, (MR_String) "predicate \140make.timestamp.get_target_timestamp\'/9", ForSearch_19, TargetFile_13, &FileName_20, STATE_VARIABLE_Info_0_26, &STATE_VARIABLE_Info_31_31);
  ...
  else
  {
    ...
    else
    {
      ...
      make__file_names__get_file_name_for_target_file_10_p_0(ProgressStream_10, Globals_11, (MR_String) "predicate \140make.timestamp.get_target_timestamp\'/9", ForSearch_43, TargetFile_13, &FileName_44, STATE_VARIABLE_Info_0_26, &STATE_VARIABLE_Info_36_36);
