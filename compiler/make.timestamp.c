  ...
  MR_Word * STATE_VARIABLE_Info_22)
{
  ...
  {
    MR_Word Target_17 = ((MR_Word) ((MR_hl_field(0, DependencyFile_11, (MR_Integer) 0))));
  ...
  MR_Word * STATE_VARIABLE_Info_27)
{
  ...
  if (succeeded)
  {
    ...
    make__file_names__get_file_name_9_p_0(Globals_11, (MR_String) "predicate \140make.timestamp.get_target_timestamp\'/9", ForSearch_19, TargetFile_13, &FileName_20, STATE_VARIABLE_Info_0_26, &STATE_VARIABLE_Info_31_31);
        ...
        case (MR_Integer) 1:
          {
            ...
            if (succeeded)
            {
              ...
              make__module_dep_file__get_maybe_module_dep_info_8_p_0(ProgressStream_10, Globals_11, ModuleName_63, &MaybeModuleDepInfo_68, STATE_VARIABLE_Info_35_75, &STATE_VARIABLE_Info_37_77);
  ...
  else
  {
    ...
    else
    {
      ...
      make__file_names__get_file_name_9_p_0(Globals_11, (MR_String) "predicate \140make.timestamp.get_target_timestamp\'/9", ForSearch_43, TargetFile_13, &FileName_44, STATE_VARIABLE_Info_0_26, &STATE_VARIABLE_Info_36_36);
  ...
  MR_Word * STATE_VARIABLE_Info_30)
{
  ...
  if (succeeded)
  {
    ...
    make__module_dep_file__get_maybe_module_dep_info_8_p_0(ProgressStream_11, Globals_12, ModuleName_19, &MaybeModuleDepInfo_24, STATE_VARIABLE_Info_35_35, &STATE_VARIABLE_Info_37_37);
