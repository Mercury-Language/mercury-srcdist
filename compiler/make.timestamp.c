...
static /* final */ const MR_Box make__timestamp_scalar_common_3[4][1] = {
  ...
  /* row   1 */
  { ((MR_Box) ((MR_Integer) 704)) },
  /* row   2 */
  { ((MR_Box) ((MR_Integer) 555)) },
  /* row   3 */
  { ((MR_Box) ((MR_Integer) 703)) },
};
  ...
  MR_Word * STATE_VARIABLE_Info_29)
{
  ...
  if (succeeded)
  {
    ...
    else
    {
      ...
      analysis__do_read_module_overall_status_6_p_0((MR_Word) (&make__timestamp_scalar_common_2[0]), ((MR_Box) ((MR_Integer) 0)), Globals_11, ModuleName_52, &Status_56);
      switch (Status_56) {
