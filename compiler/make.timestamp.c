  ...
  MR_Word * STATE_VARIABLE_Info_27)
{
                ...
                switch (MR_tag((MR_Word) TargetType_63)) {
                  ...
                  case (MR_Integer) 0:
                    switch (MR_unmkbody(TargetType_63)) {
                      ...
                      case (MR_Integer) 5:
                        {
                          MR_Word SearchDirOpt_119 = ((MR_Word) ((MR_hl_field(1, (MR_Word) (MR_mkword(1, &make__timestamp_scalar_common_3[3])), (MR_Integer) 0))));
                          MR_Word SearchDirs0_120;
                          MR_String Var_112;

                          libs__globals__lookup_accumulating_option_3_p_0(Globals_11, SearchDirOpt_119, &SearchDirs0_120);
                          Var_112 = mercury__dir__this_directory_0_f_0();
                          succeeded = mercury__list__member_2_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), ((MR_Box) (Var_112)), SearchDirs0_120);
                          if (succeeded)
                            SearchDirs_64 = SearchDirs0_120;
                          else
                          {
                            MR_String Var_114;
                            ...
                            {
                              SearchDirs_64 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                              MR_hl_field(1, SearchDirs_64, 0) = ((MR_Box) (Var_114));
                              MR_hl_field(1, SearchDirs_64, 1) = ((MR_Box) (SearchDirs0_120));
                            }
                          }
                        }
                        break;
                  ...
                  case (MR_Integer) 1:
                    {
                      MR_Word SearchDirOpt_107 = ((MR_Word) ((MR_hl_field(1, (MR_Word) (MR_mkword(1, &make__timestamp_scalar_common_3[2])), (MR_Integer) 0))));
                      MR_Word SearchDirs0_108;
                      MR_String Var_100;

                      libs__globals__lookup_accumulating_option_3_p_0(Globals_11, SearchDirOpt_107, &SearchDirs0_108);
                      Var_100 = mercury__dir__this_directory_0_f_0();
                      succeeded = mercury__list__member_2_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), ((MR_Box) (Var_100)), SearchDirs0_108);
                      if (succeeded)
                        SearchDirs_64 = SearchDirs0_108;
                      else
                      {
                        MR_String Var_102;
                        ...
                        {
                          SearchDirs_64 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                          MR_hl_field(1, SearchDirs_64, 0) = ((MR_Box) (Var_102));
                          MR_hl_field(1, SearchDirs_64, 1) = ((MR_Box) (SearchDirs0_108));
                        }
                      }
                    }
                    break;
  ...
  else
  {
    ...
    else
    {
      ...
      make__file_names__module_target_file_to_file_name_maybe_search_module_dep_10_p_0(ProgressStream_10, Globals_11, (MR_String) "predicate \140make.timestamp.get_target_timestamp\'/9", ForSearch_42, TargetFile_13, &FileName_43, STATE_VARIABLE_Info_0_26, &STATE_VARIABLE_Info_35_35);
