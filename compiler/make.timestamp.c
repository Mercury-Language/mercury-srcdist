  ...
  MR_Word * STATE_VARIABLE_Info_27)
{
  ...
  if (succeeded)
  {
    ...
    ModuleName_47 = ((MR_Word) ((MR_hl_field(0, TargetFile_13, (MR_Integer) 0))));
    FileTimestamps0_49 = make__make_info__make_info_get_file_timestamps_1_f_0(STATE_VARIABLE_Info_0_26);
    succeeded = mercury__map__search_3_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&make__timestamp_scalar_common_1[0]), FileTimestamps0_49, ((MR_Box) (FileName_20)), &conv0_MaybeTimestamp0_50);
    if (succeeded)
    {
    ...
    if (succeeded)
    {
      *MaybeTimestamp_14 = MaybeTimestamp0_50;
    ...
    else
    {
      ...
      analysis__do_read_module_overall_status_6_p_0((MR_Word) (&make__timestamp_scalar_common_2[0]), ((MR_Box) ((MR_Integer) 0)), Globals_11, ModuleName_47, &Status_51);
      switch (Status_51) {
        ...
        case (MR_Integer) 0:
          {
            ...
            *MaybeTimestamp_14 = (MR_Word) (MR_mkword(1, &make__timestamp_scalar_common_3[0]));
            mercury__map__det_insert_4_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&make__timestamp_scalar_common_1[0]), ((MR_Box) (FileName_20)), ((MR_Box) (*MaybeTimestamp_14)), FileTimestamps0_49, &FileTimestamps_52);
            make__make_info__make_info_set_file_timestamps_3_p_0(FileTimestamps_52, STATE_VARIABLE_Info_0_26, STATE_VARIABLE_Info_27);
          }
          break;
        case (MR_Integer) 2:
        case (MR_Integer) 1:
          {
            MR_Word ModuleName_61 = ((MR_Word) ((MR_hl_field(0, TargetFile_13, (MR_Integer) 0))));
            MR_Word TargetType_62 = ((MR_Word) ((MR_hl_field(0, TargetFile_13, (MR_Integer) 1))));
                      ...
                      case (MR_Integer) 5:
                        {
                          ...
                          libs__globals__lookup_accumulating_option_3_p_0(Globals_11, SearchDirOpt_118, &SearchDirs0_119);
                      ...
                      case (MR_Integer) 7:
                        {
                          ...
                          libs__globals__lookup_accumulating_option_3_p_0(Globals_11, SearchDirOpt_81, &SearchDirs0_82);
                  ...
                  case (MR_Integer) 1:
                    {
                      ...
                      libs__globals__lookup_accumulating_option_3_p_0(Globals_11, SearchDirOpt_106, &SearchDirs0_107);
            ...
            make__timestamp__get_file_timestamp_7_p_0(SearchDirs_63, FileName_20, &MaybeTimestamp0_64, STATE_VARIABLE_Info_0_26, &STATE_VARIABLE_Info_35_73);
            ...
            if (succeeded)
            {
              ...
              MR_Word STATE_VARIABLE_Info_37_75;
              MR_Word ModuleDepInfo_67;
              MR_String ModuleDir_68;
              MR_String Var_79;

              make__get_module_dep_info__get_maybe_module_dep_info_8_p_0(ProgressStream_10, Globals_11, ModuleName_61, &MaybeModuleDepInfo_66, STATE_VARIABLE_Info_35_73, &STATE_VARIABLE_Info_37_75);
              ...
              if (succeeded)
              {
                ...
                FileTimestamps0_69 = make__make_info__make_info_get_file_timestamps_1_f_0(STATE_VARIABLE_Info_37_75);
                mercury__map__set_4_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&make__timestamp_scalar_common_1[0]), ((MR_Box) (FileName_20)), ((MR_Box) (*MaybeTimestamp_14)), FileTimestamps0_69, &FileTimestamps_70);
                make__make_info__make_info_set_file_timestamps_3_p_0(FileTimestamps_70, STATE_VARIABLE_Info_37_75, STATE_VARIABLE_Info_27);
              }
              else
              {
                *MaybeTimestamp_14 = MaybeTimestamp0_64;
                *STATE_VARIABLE_Info_27 = STATE_VARIABLE_Info_37_75;
              }
            }
            else
            {
              *MaybeTimestamp_14 = MaybeTimestamp0_64;
              *STATE_VARIABLE_Info_27 = STATE_VARIABLE_Info_35_73;
            }
          }
          break;
      }
  ...
  else
  {
    ...
    else
    {
      ...
      ForSearch_41 = parse_tree__file_names__maybe_search_to_maybe_for_search_1_f_0(Search_12);
      make__file_names__module_target_to_maybe_for_search_file_name_8_p_0(Globals_11, (MR_String) "predicate \140make.timestamp.get_target_timestamp\'/9", ForSearch_41, TargetType_18, ModuleName_17, &FileName_42);
      make__timestamp__get_target_timestamp_2_10_p_0(ProgressStream_10, Globals_11, Search_12, TargetFile_13, FileName_42, MaybeTimestamp_14, STATE_VARIABLE_Info_0_26, &STATE_VARIABLE_Info_36_36);
      ...
      else
      {
        ...
        MR_Word Timestamp_39 = ((MR_Word) ((MR_hl_field(0, *MaybeTimestamp_14, (MR_Integer) 0))));

        TargetFileTimestamps1_23 = make__make_info__make_info_get_target_file_timestamps_1_f_0(STATE_VARIABLE_Info_36_36);
        mercury__version_hash_table__det_insert_4_p_0((MR_Word) (&make__make_info__make__make_info__type_ctor_info_target_file_0), (MR_Word) (&libs__timestamp__libs__timestamp__type_ctor_info_timestamp_0), ((MR_Box) (TargetFile_13)), ((MR_Box) (Timestamp_39)), TargetFileTimestamps1_23, &TargetFileTimestamps_24);
        make__make_info__make_info_set_target_file_timestamps_3_p_0(TargetFileTimestamps_24, STATE_VARIABLE_Info_36_36, STATE_VARIABLE_Info_27);
      }
    }
  }
}
