...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), Var_67, 0) = ((MR_Box) (TypeSymName_9));
      MR_hl_field(MR_mktag(1), Var_67, 1) = ((MR_Box) (Arity_19));
      MR_hl_field(MR_mktag(1), Var_67, 2) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 0));
    }
    ...
    {
      Var_81 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), Var_81, 0) = ((MR_Box) (TypeSymName_9));
      MR_hl_field(MR_mktag(1), Var_81, 1) = ((MR_Box) (Arity_19));
      MR_hl_field(MR_mktag(1), Var_81, 2) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 1));
    }
    ...
    {
      Var_95 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), Var_95, 0) = ((MR_Box) (TypeSymName_9));
      MR_hl_field(MR_mktag(1), Var_95, 1) = ((MR_Box) (Arity_19));
      MR_hl_field(MR_mktag(1), Var_95, 2) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 2));
    }
    ...
    {
      Var_109 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), Var_109, 0) = ((MR_Box) (TypeSymName_9));
      MR_hl_field(MR_mktag(1), Var_109, 1) = ((MR_Box) (Arity_19));
      MR_hl_field(MR_mktag(1), Var_109, 2) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 3));
    }
