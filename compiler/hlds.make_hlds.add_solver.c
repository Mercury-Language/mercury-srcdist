...
{
  {
    ...
    else
    {
      ...
      mdbcomp__sym_name____Compare____sym_name_0_0(&Var_18, ArgX1_4, ArgY1_5);
      ...
      else
      {
        ...
        mercury__builtin__compare_3_p_0((MR_Word) &hlds__make_hlds__add_solver_scalar_common_1[1], &Var_19, ((MR_Box) (ArgX2_6)), ((MR_Box) (ArgY2_7)));
        ...
        else
        {
          ...
          mercury__builtin__compare_3_p_0((MR_Word) &hlds__make_hlds__add_solver_scalar_common_1[2], &Var_20, ((MR_Box) (ArgX3_8)), ((MR_Box) (ArgY3_9)));
          ...
          else
          {
            ...
            parse_tree__prog_data____Compare____solver_type_details_0_0(&Var_21, ArgX4_10, ArgY4_11);
            ...
            else
            {
              ...
              mercury__term____Compare____context_0_0(&Var_22, ArgX5_12, ArgY5_13);
              ...
              else
              {
                ...
                hlds__status____Compare____item_mercury_status_0_0(&Var_23, ArgX6_14, ArgY6_15);
...
{
  {
    ...
    MR_Word _TypeSymName_12 = ((MR_Word) (MR_hl_field(MR_mktag(0), SolverAuxPredInfo_8, (MR_Integer) 0)));
    MR_Word _TypeParams_13 = ((MR_Word) (MR_hl_field(MR_mktag(0), SolverAuxPredInfo_8, (MR_Integer) 1)));
    MR_Word _TVarSet_14 = ((MR_Word) (MR_hl_field(MR_mktag(0), SolverAuxPredInfo_8, (MR_Integer) 2)));
    MR_Word _SolverTypeDetails_15 = ((MR_Word) (MR_hl_field(MR_mktag(0), SolverAuxPredInfo_8, (MR_Integer) 3)));
    MR_Word _Context_16 = ((MR_Word) (MR_hl_field(MR_mktag(0), SolverAuxPredInfo_8, (MR_Integer) 4)));
    MR_Word _NeedQual_18 = ((MR_Word) (MR_hl_field(MR_mktag(0), SolverAuxPredInfo_8, (MR_Integer) 6)));

    if (((MR_tag((MR_Word) ItemMercuryStatus_17)) == (MR_mktag((MR_Integer) 1))))
    {
...
{
  {
    ...
    Arity_20 = mercury__list__length_1_f_0((MR_Word) &hlds__make_hlds__add_solver_scalar_common_1[0], TypeParams_13);
    Var_122 = ((MR_Word) (MR_hl_field(MR_mktag(0), SolverTypeDetails_15, (MR_Integer) 0)));
    ...
    Var_124 = ((MR_Word) (MR_hl_field(MR_mktag(0), SolverTypeDetails_15, (MR_Integer) 3)));
    ...
    TypeCtorInfo_129_129 = (MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0;
    ProgVarSet0_27 = mercury__varset__init_0_f_0(TypeCtorInfo_129_129);
    mercury__varset__new_var_3_p_0(TypeCtorInfo_129_129, &X_28, ProgVarSet0_27, &ProgVarSet1_29);
    mercury__varset__new_var_3_p_0(TypeCtorInfo_129_129, &Y_30, ProgVarSet1_29, &ProgVarSet_31);
      ...
      case (MR_Integer) 2:
        {
          ...
          {
            Impl_38 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
    ...
    {
      XTGPragmaVar_40 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL);
      ...
      MR_hl_field(MR_mktag(0), XTGPragmaVar_40, 3) = ((MR_Box) ((MR_Integer) 0));
    }
    {
      YTGPragmaVar_41 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL);
      ...
      MR_hl_field(MR_mktag(0), YTGPragmaVar_41, 3) = ((MR_Box) ((MR_Integer) 0));
    }
    {
    ...
    {
      ToGroundRepnArgs_42 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
    ...
    {
      ToGroundRepnFPInfo_43 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 7 * sizeof(MR_Word)), NULL, NULL);
      ...
      MR_hl_field(MR_mktag(0), ToGroundRepnFPInfo_43, 2) = ((MR_Box) ((MR_Integer) 1));
    ...
    hlds__make_hlds__add_foreign_proc__add_pragma_foreign_proc_8_p_0(ToGroundRepnFPInfo_43, PredStatus_19, Context_16, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), STATE_VARIABLE_ModuleInfo_0_59, &STATE_VARIABLE_ModuleInfo_87_87, STATE_VARIABLE_Specs_0_63, &STATE_VARIABLE_Specs_88_88);
    ...
    {
      XTAPragmaVar_45 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL);
      ...
      MR_hl_field(MR_mktag(0), XTAPragmaVar_45, 3) = ((MR_Box) ((MR_Integer) 0));
    }
    {
      YTAPragmaVar_46 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL);
      ...
      MR_hl_field(MR_mktag(0), YTAPragmaVar_46, 3) = ((MR_Box) ((MR_Integer) 0));
    }
    {
    ...
    {
      ToAnyRepnArgs_47 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), ToAnyRepnArgs_47, 0) = ((MR_Box) (XTAPragmaVar_45));
      MR_hl_field(MR_mktag(1), ToAnyRepnArgs_47, 1) = ((MR_Box) (Var_94));
    }
    {
      ToAnyRepnFPInfo_48 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 7 * sizeof(MR_Word)), NULL, NULL);
      ...
      MR_hl_field(MR_mktag(0), ToAnyRepnFPInfo_48, 2) = ((MR_Box) ((MR_Integer) 1));
    ...
    hlds__make_hlds__add_foreign_proc__add_pragma_foreign_proc_8_p_0(ToAnyRepnFPInfo_48, PredStatus_19, Context_16, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), STATE_VARIABLE_ModuleInfo_87_87, &STATE_VARIABLE_ModuleInfo_98_98, STATE_VARIABLE_Specs_88_88, &STATE_VARIABLE_Specs_99_99);
    FromGroundRepnSymName_49 = hlds__make_hlds__add_solver__repn_to_ground_solver_symname_2_f_0(TypeSymName_12, Arity_20);
    {
      XFGPragmaVar_50 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL);
      ...
      MR_hl_field(MR_mktag(0), XFGPragmaVar_50, 3) = ((MR_Box) ((MR_Integer) 0));
    }
    Var_103 = parse_tree__prog_mode__out_mode_0_f_0();
    {
      YFGPragmaVar_51 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL);
      ...
      MR_hl_field(MR_mktag(0), YFGPragmaVar_51, 3) = ((MR_Box) ((MR_Integer) 0));
    }
    {
    ...
    {
      FromGroundRepnArgs_52 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
    ...
    {
      FromGroundRepnFPInfo_53 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 7 * sizeof(MR_Word)), NULL, NULL);
      ...
      MR_hl_field(MR_mktag(0), FromGroundRepnFPInfo_53, 2) = ((MR_Box) ((MR_Integer) 1));
    ...
    hlds__make_hlds__add_foreign_proc__add_pragma_foreign_proc_8_p_0(FromGroundRepnFPInfo_53, PredStatus_19, Context_16, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), STATE_VARIABLE_ModuleInfo_98_98, &STATE_VARIABLE_ModuleInfo_109_109, STATE_VARIABLE_Specs_99_99, &STATE_VARIABLE_Specs_110_110);
    FromAnyRepnSymName_54 = hlds__make_hlds__add_solver__repn_to_any_solver_symname_2_f_0(TypeSymName_12, Arity_20);
    {
      XFAPragmaVar_55 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL);
      ...
      MR_hl_field(MR_mktag(0), XFAPragmaVar_55, 3) = ((MR_Box) ((MR_Integer) 0));
    }
    Var_114 = parse_tree__prog_mode__out_any_mode_0_f_0();
    {
      YFAPragmaVar_56 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL);
      ...
      MR_hl_field(MR_mktag(0), YFAPragmaVar_56, 3) = ((MR_Box) ((MR_Integer) 0));
    }
    {
    ...
    {
      FromAnyRepnArgs_57 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
    ...
    {
      FromAnyRepnFPInfo_58 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 7 * sizeof(MR_Word)), NULL, NULL);
      ...
      MR_hl_field(MR_mktag(0), FromAnyRepnFPInfo_58, 2) = ((MR_Box) ((MR_Integer) 1));
    ...
    hlds__make_hlds__add_foreign_proc__add_pragma_foreign_proc_8_p_0(FromAnyRepnFPInfo_58, PredStatus_19, Context_16, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), STATE_VARIABLE_ModuleInfo_109_109, STATE_VARIABLE_ModuleInfo_60, STATE_VARIABLE_Specs_110_110, STATE_VARIABLE_Specs_64);
...
{
  {
    ...
    MR_Word NeedQual_15 = ((MR_Word) (MR_hl_field(MR_mktag(0), SolverAuxPredInfo_6, (MR_Integer) 6)));
    MR_Word PredStatus_16;
    MR_Word MaybeItemMercuryStatus_18;
    MR_Word NoConstraints_19;
    MR_Word Args_20;
    MR_Word SolverType_21;
    MR_Integer Arity_22;
    MR_Word RepnType_23;
    MR_Word AnyInst_24;
    MR_Word GroundInst_25;
    MR_Word InAnyMode_26;
    MR_Word InGroundMode_27;
    MR_Word OutAnyMode_28;
    MR_Word OutGroundMode_29;
    MR_Word InstVarSet_30;
    MR_Word ExistQTVars_31;
    MR_Word NoMarkers_32;
    MR_Word ToGroundRepnSymName_33;
    MR_Word ToGroundRepnArgTypesModes_34;
    MR_Word ToGroundOrigin_35;
    MR_Word ToAnyRepnSymName_37;
    MR_Word ToAnyRepnArgTypesModes_38;
    MR_Word ToAnyOrigin_39;
    MR_Word FromGroundRepnSymName_41;
    MR_Word FromGroundRepnArgTypesModes_42;
    MR_Word FromGroundOrigin_43;
    MR_Word FromAnyRepnSymName_45;
    MR_Word FromAnyRepnArgTypesModes_46;
    MR_Word FromAnyOrigin_47;
    MR_Word Var_55;
    MR_Word Var_57;
    MR_Word Var_58;
    MR_Word Var_59;
    ...
    MaybeItemMercuryStatus_18 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
    NoConstraints_19 = (MR_Word) &hlds__make_hlds__add_solver_scalar_common_1[3];
    TypeInfo_114_114 = (MR_Word) &hlds__make_hlds__add_solver_scalar_common_1[0];
    Var_55 = mercury__map__init_0_f_0(TypeInfo_114_114, (MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_kind_0);
    parse_tree__prog_type__var_list_to_type_list_3_p_0(Var_55, TypeParams_10, &Args_20);
    {
      SolverType_21 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), SolverType_21, 0) = ((MR_Box) (TypeSymName_9));
      MR_hl_field(MR_mktag(1), SolverType_21, 1) = ((MR_Box) (Args_20));
      MR_hl_field(MR_mktag(1), SolverType_21, 2) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
    }
    Arity_22 = mercury__list__length_1_f_0(TypeInfo_114_114, TypeParams_10);
    RepnType_23 = ((MR_Word) (MR_hl_field(MR_mktag(0), SolverTypeDetails_12, (MR_Integer) 0)));
    GroundInst_25 = ((MR_Word) (MR_hl_field(MR_mktag(0), SolverTypeDetails_12, (MR_Integer) 1)));
    AnyInst_24 = ((MR_Word) (MR_hl_field(MR_mktag(0), SolverTypeDetails_12, (MR_Integer) 2)));
    Var_107 = ((MR_Word) (MR_hl_field(MR_mktag(0), SolverTypeDetails_12, (MR_Integer) 3)));
    InAnyMode_26 = parse_tree__prog_mode__in_mode_1_f_0(AnyInst_24);
    InGroundMode_27 = parse_tree__prog_mode__in_mode_1_f_0(GroundInst_25);
    OutAnyMode_28 = parse_tree__prog_mode__out_mode_1_f_0(AnyInst_24);
    OutGroundMode_29 = parse_tree__prog_mode__out_mode_1_f_0(GroundInst_25);
    InstVarSet_30 = mercury__varset__init_0_f_0((MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_inst_var_type_0);
    ExistQTVars_31 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
    hlds__hlds_pred__init_markers_1_p_0(&NoMarkers_32);
    ToGroundRepnSymName_33 = hlds__make_hlds__add_solver__solver_to_ground_repn_symname_2_f_0(TypeSymName_9, Arity_22);
    Var_58 = parse_tree__prog_mode__in_mode_0_f_0();
    {
      ...
      MR_hl_field(MR_mktag(1), Var_57, 0) = ((MR_Box) (SolverType_21));
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), Var_60, 0) = ((MR_Box) (RepnType_23));
      MR_hl_field(MR_mktag(1), Var_60, 1) = ((MR_Box) (OutGroundMode_29));
    }
    {
    ...
    {
      ToGroundRepnArgTypesModes_34 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), ToGroundRepnArgTypesModes_34, 0) = ((MR_Box) (Var_57));
      MR_hl_field(MR_mktag(1), ToGroundRepnArgTypesModes_34, 1) = ((MR_Box) (Var_59));
    }
    {
      ToGroundOrigin_35 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(3), ToGroundOrigin_35, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 3));
      MR_hl_field(MR_mktag(3), ToGroundOrigin_35, 1) = ((MR_Box) (TypeSymName_9));
      MR_hl_field(MR_mktag(3), ToGroundOrigin_35, 2) = ((MR_Box) (Arity_22));
      MR_hl_field(MR_mktag(3), ToGroundOrigin_35, 3) = ((MR_Box) ((MR_Integer) 0));
    }
    Var_64 = (MR_Word) MR_mkword(MR_mktag(1), &hlds__make_hlds__add_solver_scalar_common_2[0]);
    hlds__make_hlds__add_pred__module_add_pred_or_func_21_p_0(ToGroundOrigin_35, Context_13, (MR_Integer) -1, MaybeItemMercuryStatus_18, PredStatus_16, NeedQual_15, (MR_Integer) 1, ToGroundRepnSymName_33, TVarSet_11, InstVarSet_30, ExistQTVars_31, ToGroundRepnArgTypesModes_34, NoConstraints_19, Var_64, (MR_Integer) 2, NoMarkers_32, &Var_36, STATE_VARIABLE_ModuleInfo_0_49, &STATE_VARIABLE_ModuleInfo_66_66, STATE_VARIABLE_Specs_0_51, &STATE_VARIABLE_Specs_67_67);
    ToAnyRepnSymName_37 = hlds__make_hlds__add_solver__solver_to_any_repn_symname_2_f_0(TypeSymName_9, Arity_22);
    Var_70 = parse_tree__prog_mode__in_any_mode_0_f_0();
    {
      Var_69 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), Var_69, 0) = ((MR_Box) (SolverType_21));
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), Var_72, 0) = ((MR_Box) (RepnType_23));
      MR_hl_field(MR_mktag(1), Var_72, 1) = ((MR_Box) (OutAnyMode_28));
    }
    {
    ...
    {
      ToAnyRepnArgTypesModes_38 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), ToAnyRepnArgTypesModes_38, 0) = ((MR_Box) (Var_69));
      MR_hl_field(MR_mktag(1), ToAnyRepnArgTypesModes_38, 1) = ((MR_Box) (Var_71));
    }
    {
      ToAnyOrigin_39 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(3), ToAnyOrigin_39, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 3));
      MR_hl_field(MR_mktag(3), ToAnyOrigin_39, 1) = ((MR_Box) (TypeSymName_9));
      MR_hl_field(MR_mktag(3), ToAnyOrigin_39, 2) = ((MR_Box) (Arity_22));
      MR_hl_field(MR_mktag(3), ToAnyOrigin_39, 3) = ((MR_Box) ((MR_Integer) 1));
    }
    hlds__make_hlds__add_pred__module_add_pred_or_func_21_p_0(ToAnyOrigin_39, Context_13, (MR_Integer) -1, MaybeItemMercuryStatus_18, PredStatus_16, NeedQual_15, (MR_Integer) 1, ToAnyRepnSymName_37, TVarSet_11, InstVarSet_30, ExistQTVars_31, ToAnyRepnArgTypesModes_38, NoConstraints_19, Var_64, (MR_Integer) 2, NoMarkers_32, &Var_40, STATE_VARIABLE_ModuleInfo_66_66, &STATE_VARIABLE_ModuleInfo_78_78, STATE_VARIABLE_Specs_67_67, &STATE_VARIABLE_Specs_79_79);
    FromGroundRepnSymName_41 = hlds__make_hlds__add_solver__repn_to_ground_solver_symname_2_f_0(TypeSymName_9, Arity_22);
    {
      Var_81 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), Var_81, 0) = ((MR_Box) (RepnType_23));
      MR_hl_field(MR_mktag(1), Var_81, 1) = ((MR_Box) (InGroundMode_27));
    }
    Var_84 = parse_tree__prog_mode__out_mode_0_f_0();
    {
      Var_83 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), Var_83, 0) = ((MR_Box) (SolverType_21));
    ...
    {
      FromGroundRepnArgTypesModes_42 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), FromGroundRepnArgTypesModes_42, 0) = ((MR_Box) (Var_81));
      MR_hl_field(MR_mktag(1), FromGroundRepnArgTypesModes_42, 1) = ((MR_Box) (Var_82));
    }
    {
      FromGroundOrigin_43 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(3), FromGroundOrigin_43, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 3));
      MR_hl_field(MR_mktag(3), FromGroundOrigin_43, 1) = ((MR_Box) (TypeSymName_9));
      MR_hl_field(MR_mktag(3), FromGroundOrigin_43, 2) = ((MR_Box) (Arity_22));
      MR_hl_field(MR_mktag(3), FromGroundOrigin_43, 3) = ((MR_Box) ((MR_Integer) 2));
    }
    hlds__make_hlds__add_pred__module_add_pred_or_func_21_p_0(FromGroundOrigin_43, Context_13, (MR_Integer) -1, MaybeItemMercuryStatus_18, PredStatus_16, NeedQual_15, (MR_Integer) 1, FromGroundRepnSymName_41, TVarSet_11, InstVarSet_30, ExistQTVars_31, FromGroundRepnArgTypesModes_42, NoConstraints_19, Var_64, (MR_Integer) 2, NoMarkers_32, &Var_44, STATE_VARIABLE_ModuleInfo_78_78, &STATE_VARIABLE_ModuleInfo_90_90, STATE_VARIABLE_Specs_79_79, &STATE_VARIABLE_Specs_91_91);
    FromAnyRepnSymName_45 = hlds__make_hlds__add_solver__repn_to_any_solver_symname_2_f_0(TypeSymName_9, Arity_22);
    {
      Var_93 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), Var_93, 0) = ((MR_Box) (RepnType_23));
      MR_hl_field(MR_mktag(1), Var_93, 1) = ((MR_Box) (InAnyMode_26));
    }
    Var_96 = parse_tree__prog_mode__out_any_mode_0_f_0();
    {
      Var_95 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), Var_95, 0) = ((MR_Box) (SolverType_21));
    ...
    {
      FromAnyRepnArgTypesModes_46 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), FromAnyRepnArgTypesModes_46, 0) = ((MR_Box) (Var_93));
      MR_hl_field(MR_mktag(1), FromAnyRepnArgTypesModes_46, 1) = ((MR_Box) (Var_94));
    }
    {
      FromAnyOrigin_47 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(3), FromAnyOrigin_47, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 3));
      MR_hl_field(MR_mktag(3), FromAnyOrigin_47, 1) = ((MR_Box) (TypeSymName_9));
      MR_hl_field(MR_mktag(3), FromAnyOrigin_47, 2) = ((MR_Box) (Arity_22));
      MR_hl_field(MR_mktag(3), FromAnyOrigin_47, 3) = ((MR_Box) ((MR_Integer) 3));
    }
    hlds__make_hlds__add_pred__module_add_pred_or_func_21_p_0(FromAnyOrigin_47, Context_13, (MR_Integer) -1, MaybeItemMercuryStatus_18, PredStatus_16, NeedQual_15, (MR_Integer) 1, FromAnyRepnSymName_45, TVarSet_11, InstVarSet_30, ExistQTVars_31, FromAnyRepnArgTypesModes_46, NoConstraints_19, Var_64, (MR_Integer) 2, NoMarkers_32, &Var_48, STATE_VARIABLE_ModuleInfo_90_90, STATE_VARIABLE_ModuleInfo_50, STATE_VARIABLE_Specs_91_91, STATE_VARIABLE_Specs_52);
  }
}
