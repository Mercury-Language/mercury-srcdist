  ...
  MR_Word * hlds__make_hlds__add_solver__STATE_VARIABLE_Specs_49)
{
  {
    MR_bool hlds__make_hlds__add_solver__succeeded;
    MR_Word hlds__make_hlds__add_solver__TypeInfo_121_121;
    ...
    hlds__make_hlds__add_solver__TypeInfo_121_121 = (MR_Word) &hlds__make_hlds__add_solver_scalar_common_1[0];
    {
      hlds__make_hlds__add_solver__V_50_50 = mercury__map__init_0_f_0(hlds__make_hlds__add_solver__TypeInfo_121_121, (MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_kind_0);
    }
    {
    ...
    {
      hlds__make_hlds__add_solver__Arity_19 = mercury__list__length_1_f_0(hlds__make_hlds__add_solver__TypeInfo_121_121, hlds__make_hlds__add_solver__TypeParams_10);
    }
    ...
    hlds__make_hlds__add_solver__V_114_114 = ((MR_Word) (MR_hl_field(MR_mktag(0), hlds__make_hlds__add_solver__SolverTypeDetails_12, (MR_Integer) 3)));
    {
      hlds__make_hlds__add_solver__InAnyMode_23 = parse_tree__prog_mode__in_mode_1_f_0(hlds__make_hlds__add_solver__AnyInst_21);
    }
    {
