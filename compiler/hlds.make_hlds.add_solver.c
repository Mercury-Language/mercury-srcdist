...
{
  {
    ...
    MR_Word hlds__make_hlds__add_solver__V_60_60;
    MR_Word hlds__make_hlds__add_solver__V_64_64;
    ...
    MR_Word hlds__make_hlds__add_solver__V_93_93;
    MR_Word hlds__make_hlds__add_solver__V_94_94;
    ...
    MR_Word hlds__make_hlds__add_solver__V_36_36;
    MR_Word hlds__make_hlds__add_solver__V_40_40;
    MR_Word hlds__make_hlds__add_solver__V_44_44;
    MR_Word hlds__make_hlds__add_solver__V_48_48;
    ...
    {
      hlds__make_hlds__add_solver__V_55_55 = mercury__map__init_0_f_0(hlds__make_hlds__add_solver__TypeInfo_114_114, (MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_kind_0);
    }
    {
      parse_tree__prog_type__var_list_to_type_list_3_p_0(hlds__make_hlds__add_solver__V_55_55, hlds__make_hlds__add_solver__TypeParams_10, &hlds__make_hlds__add_solver__Args_20);
    }
    {
    ...
    hlds__make_hlds__add_solver__V_107_107 = ((MR_Word) (MR_hl_field(MR_mktag(0), hlds__make_hlds__add_solver__SolverTypeDetails_12, (MR_Integer) 3)));
    {
    ...
    {
      hlds__make_hlds__add_solver__V_58_58 = parse_tree__prog_mode__in_mode_0_f_0();
    }
    {
      ...
      MR_hl_field(MR_mktag(1), hlds__make_hlds__add_solver__V_57_57, 0) = ((MR_Box) (hlds__make_hlds__add_solver__SolverType_21));
      MR_hl_field(MR_mktag(1), hlds__make_hlds__add_solver__V_57_57, 1) = ((MR_Box) (hlds__make_hlds__add_solver__V_58_58));
    }
    {
      hlds__make_hlds__add_solver__V_60_60 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), hlds__make_hlds__add_solver__V_60_60, 0) = ((MR_Box) (hlds__make_hlds__add_solver__RepnType_23));
      MR_hl_field(MR_mktag(1), hlds__make_hlds__add_solver__V_60_60, 1) = ((MR_Box) (hlds__make_hlds__add_solver__OutGroundMode_29));
    }
    {
      ...
      MR_hl_field(MR_mktag(1), hlds__make_hlds__add_solver__V_59_59, 0) = ((MR_Box) (hlds__make_hlds__add_solver__V_60_60));
      MR_hl_field(MR_mktag(1), hlds__make_hlds__add_solver__V_59_59, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
    }
    {
      ...
      MR_hl_field(MR_mktag(1), hlds__make_hlds__add_solver__ToGroundRepnArgTypesModes_34, 0) = ((MR_Box) (hlds__make_hlds__add_solver__V_57_57));
      MR_hl_field(MR_mktag(1), hlds__make_hlds__add_solver__ToGroundRepnArgTypesModes_34, 1) = ((MR_Box) (hlds__make_hlds__add_solver__V_59_59));
    }
    {
    ...
    hlds__make_hlds__add_solver__V_64_64 = (MR_Word) MR_mkword(MR_mktag(1), &hlds__make_hlds__add_solver_scalar_common_2[0]);
    {
      hlds__make_hlds__add_pred__module_add_pred_or_func_21_p_0(hlds__make_hlds__add_solver__ToGroundOrigin_35, hlds__make_hlds__add_solver__Context_13, (MR_Integer) -1, hlds__make_hlds__add_solver__MaybeItemMercuryStatus_18, hlds__make_hlds__add_solver__PredStatus_16, hlds__make_hlds__add_solver__NeedQual_15, (MR_Integer) 1, hlds__make_hlds__add_solver__ToGroundRepnSymName_33, hlds__make_hlds__add_solver__TVarSet_11, hlds__make_hlds__add_solver__InstVarSet_30, hlds__make_hlds__add_solver__ExistQTVars_31, hlds__make_hlds__add_solver__ToGroundRepnArgTypesModes_34, hlds__make_hlds__add_solver__NoConstraints_19, hlds__make_hlds__add_solver__V_64_64, (MR_Integer) 2, hlds__make_hlds__add_solver__NoMarkers_32, &hlds__make_hlds__add_solver__V_36_36, hlds__make_hlds__add_solver__STATE_VARIABLE_ModuleInfo_0_49, &hlds__make_hlds__add_solver__STATE_VARIABLE_ModuleInfo_66_66, hlds__make_hlds__add_solver__STATE_VARIABLE_Specs_0_51, &hlds__make_hlds__add_solver__STATE_VARIABLE_Specs_67_67);
    }
    {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), hlds__make_hlds__add_solver__V_69_69, 0) = ((MR_Box) (hlds__make_hlds__add_solver__SolverType_21));
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), hlds__make_hlds__add_solver__V_72_72, 0) = ((MR_Box) (hlds__make_hlds__add_solver__RepnType_23));
      MR_hl_field(MR_mktag(1), hlds__make_hlds__add_solver__V_72_72, 1) = ((MR_Box) (hlds__make_hlds__add_solver__OutAnyMode_28));
    }
    {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), hlds__make_hlds__add_solver__ToAnyRepnArgTypesModes_38, 0) = ((MR_Box) (hlds__make_hlds__add_solver__V_69_69));
      MR_hl_field(MR_mktag(1), hlds__make_hlds__add_solver__ToAnyRepnArgTypesModes_38, 1) = ((MR_Box) (hlds__make_hlds__add_solver__V_71_71));
    }
    {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), hlds__make_hlds__add_solver__FromGroundRepnArgTypesModes_42, 0) = ((MR_Box) (hlds__make_hlds__add_solver__V_81_81));
      MR_hl_field(MR_mktag(1), hlds__make_hlds__add_solver__FromGroundRepnArgTypesModes_42, 1) = ((MR_Box) (hlds__make_hlds__add_solver__V_82_82));
    }
    {
    ...
    {
      hlds__make_hlds__add_solver__V_93_93 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), hlds__make_hlds__add_solver__V_93_93, 0) = ((MR_Box) (hlds__make_hlds__add_solver__RepnType_23));
      MR_hl_field(MR_mktag(1), hlds__make_hlds__add_solver__V_93_93, 1) = ((MR_Box) (hlds__make_hlds__add_solver__InAnyMode_26));
    }
    {
      hlds__make_hlds__add_solver__V_96_96 = parse_tree__prog_mode__out_any_mode_0_f_0();
    }
    {
      ...
      MR_hl_field(MR_mktag(1), hlds__make_hlds__add_solver__V_95_95, 0) = ((MR_Box) (hlds__make_hlds__add_solver__SolverType_21));
      MR_hl_field(MR_mktag(1), hlds__make_hlds__add_solver__V_95_95, 1) = ((MR_Box) (hlds__make_hlds__add_solver__V_96_96));
    }
    {
      hlds__make_hlds__add_solver__V_94_94 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), hlds__make_hlds__add_solver__V_94_94, 0) = ((MR_Box) (hlds__make_hlds__add_solver__V_95_95));
      MR_hl_field(MR_mktag(1), hlds__make_hlds__add_solver__V_94_94, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
    }
    {
      ...
      MR_hl_field(MR_mktag(1), hlds__make_hlds__add_solver__FromAnyRepnArgTypesModes_46, 0) = ((MR_Box) (hlds__make_hlds__add_solver__V_93_93));
      MR_hl_field(MR_mktag(1), hlds__make_hlds__add_solver__FromAnyRepnArgTypesModes_46, 1) = ((MR_Box) (hlds__make_hlds__add_solver__V_94_94));
    }
    {
