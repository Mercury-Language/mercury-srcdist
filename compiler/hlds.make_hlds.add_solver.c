...
MR_decl_label10(hlds__make_hlds__add_solver__add_solver_type_clause_items_12_0, 23,25,24,30,31,41,42,43,52,53)
MR_decl_label4(hlds__make_hlds__add_solver__add_solver_type_clause_items_12_0, 55,63,64,66)
...
MR_BEGIN_MODULE(hlds__make_hlds__add_solver_module5)
	...
	MR_init_label10(hlds__make_hlds__add_solver__add_solver_type_clause_items_12_0,23,25,24,30,31,41,42,43,52,53)
	MR_init_label4(hlds__make_hlds__add_solver__add_solver_type_clause_items_12_0,55,63,64,66)
MR_BEGIN_CODE
...
MR_def_label(hlds__make_hlds__add_solver__add_solver_type_clause_items_12_0,31)
	...
	MR_tfield(0, MR_tempr3, 4) = MR_sv(6);
	...
	MR_tfield(0, MR_tempr5, 0) = (MR_Word) MR_TAG_COMMON(1,1,1);
	MR_tfield(0, MR_tempr5, 1) = MR_tempr4;
	MR_tfield(0, MR_tempr5, 2) = MR_sv(2);
...
MR_def_label(hlds__make_hlds__add_solver__add_solver_type_clause_items_12_0,53)
	...
	MR_np_call_localret_ent(fn__parse_tree__prog_mode__out_mode_0_0,
		hlds__make_hlds__add_solver__add_solver_type_clause_items_12_0_i55);
MR_def_label(hlds__make_hlds__add_solver__add_solver_type_clause_items_12_0,55)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2, MR_tempr3, MR_tempr4;
	MR_tag_alloc_heap(MR_tempr1, 0, (MR_Integer) 4);
...
MR_def_label(hlds__make_hlds__add_solver__add_solver_type_clause_items_12_0,64)
	...
	MR_np_call_localret_ent(fn__parse_tree__prog_mode__out_any_mode_0_0,
		hlds__make_hlds__add_solver__add_solver_type_clause_items_12_0_i66);
MR_def_label(hlds__make_hlds__add_solver__add_solver_type_clause_items_12_0,66)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tag_alloc_heap(MR_tempr1, 0, (MR_Integer) 4);
...
void mercury__hlds__make_hlds__add_solver__write_out_proc_statics(FILE *deep_fp, FILE *procrep_fp)
{
	MR_write_out_module_proc_reps_start(procrep_fp, &mercury_data__module_layout__hlds__make_hlds__add_solver);
