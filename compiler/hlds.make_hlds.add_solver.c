...
{
  {
    ...
    switch (Target_34) {
      ...
      case (MR_Integer) 0:
        Lang_35 = (MR_Integer) 0;
        break;
      case (MR_Integer) 1:
        Lang_35 = (MR_Integer) 1;
        break;
      case (MR_Integer) 2:
        Lang_35 = (MR_Integer) 2;
        break;
    }
    ...
    Var_77 = parse_tree__prog_mode__in_mode_0_f_0();
    {
      ...
      MR_hl_field(MR_mktag(0), XTGPragmaVar_40, 2) = ((MR_Box) (Var_77));
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), Var_81, 0) = ((MR_Box) (YTGPragmaVar_41));
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), ToGroundRepnArgs_42, 1) = ((MR_Box) (Var_81));
    }
    {
    ...
    hlds__make_hlds__add_foreign_proc__add_pragma_foreign_proc_8_p_0(ToGroundRepnFPInfo_43, PredStatus_19, Context_16, (MR_Word) ((MR_Unsigned) 0U), STATE_VARIABLE_ModuleInfo_0_59, &STATE_VARIABLE_ModuleInfo_85_85, STATE_VARIABLE_Specs_0_63, &STATE_VARIABLE_Specs_86_86);
    ToAnyRepnSymName_44 = hlds__make_hlds__add_solver__solver_to_any_repn_symname_2_f_0(TypeSymName_12, Arity_20);
    Var_88 = parse_tree__prog_mode__in_any_mode_0_f_0();
    {
      ...
      MR_hl_field(MR_mktag(0), XTAPragmaVar_45, 2) = ((MR_Box) (Var_88));
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), Var_92, 0) = ((MR_Box) (YTAPragmaVar_46));
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), ToAnyRepnArgs_47, 1) = ((MR_Box) (Var_92));
    }
    {
    ...
    hlds__make_hlds__add_foreign_proc__add_pragma_foreign_proc_8_p_0(ToAnyRepnFPInfo_48, PredStatus_19, Context_16, (MR_Word) ((MR_Unsigned) 0U), STATE_VARIABLE_ModuleInfo_85_85, &STATE_VARIABLE_ModuleInfo_96_96, STATE_VARIABLE_Specs_86_86, &STATE_VARIABLE_Specs_97_97);
    ...
    Var_101 = parse_tree__prog_mode__out_mode_0_f_0();
    {
      ...
      MR_hl_field(MR_mktag(0), YFGPragmaVar_51, 2) = ((MR_Box) (Var_101));
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), Var_103, 0) = ((MR_Box) (YFGPragmaVar_51));
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), FromGroundRepnArgs_52, 1) = ((MR_Box) (Var_103));
    }
    {
    ...
    hlds__make_hlds__add_foreign_proc__add_pragma_foreign_proc_8_p_0(FromGroundRepnFPInfo_53, PredStatus_19, Context_16, (MR_Word) ((MR_Unsigned) 0U), STATE_VARIABLE_ModuleInfo_96_96, &STATE_VARIABLE_ModuleInfo_107_107, STATE_VARIABLE_Specs_97_97, &STATE_VARIABLE_Specs_108_108);
    ...
    Var_112 = parse_tree__prog_mode__out_any_mode_0_f_0();
    {
      ...
      MR_hl_field(MR_mktag(0), YFAPragmaVar_56, 2) = ((MR_Box) (Var_112));
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), Var_114, 0) = ((MR_Box) (YFAPragmaVar_56));
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), FromAnyRepnArgs_57, 1) = ((MR_Box) (Var_114));
    }
    {
    ...
    hlds__make_hlds__add_foreign_proc__add_pragma_foreign_proc_8_p_0(FromAnyRepnFPInfo_58, PredStatus_19, Context_16, (MR_Word) ((MR_Unsigned) 0U), STATE_VARIABLE_ModuleInfo_107_107, STATE_VARIABLE_ModuleInfo_60, STATE_VARIABLE_Specs_108_108, STATE_VARIABLE_Specs_64);
