        ...
        case (MR_Integer) 0:
          {
            ...
            else
            {
              ...
              check_hlds__recompute_instmap_deltas__recompute_instmap_delta_proc_5_p_0((MR_Integer) 1, ProcInfo3_43, &ProcInfo_44, STATE_VARIABLE_ModuleInfo_52_52, &STATE_VARIABLE_ModuleInfo_58_58);
