...
transform_hlds__distance_granularity__IntroducedFrom__pred__apply_dg_to_preds__230__1_2_p_0(
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = transform_hlds__distance_granularity__IntroducedFrom__pred__apply_dg_to_preds__230__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) ((MR_hl_field(0, closure, 4)))));
  return succeeded;
}
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_4)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      ProcIds_21 = hlds__hlds_pred__pred_info_all_non_imported_procids_1_f_0(STATE_VARIABLE_ClonePredInfo_1_36);
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_9)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      hlds__hlds_pred__proc_info_get_goal_2_p_0(STATE_VARIABLE_ProcInfo_1_36, &Body0_29);
      ...
      hlds__hlds_pred__proc_info_set_goal_3_p_0(Body_30, STATE_VARIABLE_ProcInfo_2_37, &STATE_VARIABLE_ProcInfo_3_38);
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_11)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      hlds__hlds_pred__proc_info_get_has_parallel_conj_2_p_0(STATE_VARIABLE_ProcInfo_1_47, &HasParallelConj_35);
        ...
        case (MR_Integer) 0:
          {
            ...
            hlds__hlds_pred__proc_info_get_goal_2_p_0(STATE_VARIABLE_ProcInfo_1_47, &Body_36);
            ...
            else
            {
              ...
              hlds__hlds_pred__proc_info_set_goal_3_p_0(BodyClone_37, STATE_VARIABLE_ProcInfo_2_48, &STATE_VARIABLE_ProcInfo_3_53);
  ...
  *ModuleInfo_10 = ModuleInfo_21;
  ...
  if (succeeded)
  {
    if ((STATE_VARIABLE_MaybeGranularityVar_0_41 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      ...
      hlds__hlds_pred__proc_info_get_argmodes_2_p_0(STATE_VARIABLE_ProcInfo_1_46, &ArgsModes0_33);
      hlds__hlds_pred__proc_info_get_headvars_2_p_0(STATE_VARIABLE_ProcInfo_1_46, &HeadVars0_34);
      ...
      hlds__hlds_pred__proc_info_set_argmodes_3_p_0(ArgsModes_35, STATE_VARIABLE_ProcInfo_1_46, &STATE_VARIABLE_ProcInfo_2_53);
      hlds__hlds_pred__proc_info_set_headvars_3_p_0(HeadVars_36, STATE_VARIABLE_ProcInfo_2_53, STATE_VARIABLE_ProcInfo_40);
    }
    else
    {
