...
transform_hlds__distance_granularity__IntroducedFrom__pred__apply_dg_to_preds__228__1_2_p_0(
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = transform_hlds__distance_granularity__IntroducedFrom__pred__apply_dg_to_preds__228__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 4)))));
  return succeeded;
}
        ...
        case (MR_Integer) 1:
          {
            ...
            hlds__pred_table__predicate_table_insert_4_p_0(STATE_VARIABLE_ClonePredInfo_52_52, &InsertedPredId_30, PredicateTable0_29, &PredicateTable1_31);
            {
              ...
              MR_hl_field(0, Var_53, 0) = ((MR_Box) (&transform_hlds__distance_granularity_scalar_common_5[0]));
