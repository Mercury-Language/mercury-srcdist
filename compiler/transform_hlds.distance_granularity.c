...
MR_decl_label3(transform_hlds__distance_granularity__apply_dg_to_goal_15_0, 40,39,43)
...
MR_decl_label1(transform_hlds__distance_granularity__update_original_predicate_goal_9_0, 42)
...
MR_BEGIN_MODULE(transform_hlds__distance_granularity_module4)
	...
	MR_init_label3(transform_hlds__distance_granularity__apply_dg_to_goal_15_0,40,39,43)
MR_BEGIN_CODE
...
MR_def_label(transform_hlds__distance_granularity__apply_dg_to_goal_15_0,39)
	...
	if (MR_PTAG_TESTR(MR_r11,0)) {
		MR_GOTO_LAB(transform_hlds__distance_granularity__apply_dg_to_goal_15_0_i43);
	}
	MR_r5 = (MR_Integer) 0;
	MR_r2 = MR_r6;
	MR_r3 = MR_r7;
...
MR_BEGIN_MODULE(transform_hlds__distance_granularity_module10)
	...
	MR_init_label1(transform_hlds__distance_granularity__update_original_predicate_goal_9_0,42)
MR_BEGIN_CODE
...
MR_def_label(transform_hlds__distance_granularity__update_original_predicate_goal_9_0,38)
	...
	if (MR_PTAG_TESTR(MR_r8,0)) {
		MR_GOTO_LAB(transform_hlds__distance_granularity__update_original_predicate_goal_9_0_i42);
	}
	MR_r2 = MR_r6;
	MR_proceed();
