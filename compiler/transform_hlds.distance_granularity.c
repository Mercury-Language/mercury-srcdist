...
MR_decl_label8(transform_hlds__distance_granularity__apply_dg_to_else2_10_0, 95,5,6,7,11,12,13,14)
MR_decl_label8(transform_hlds__distance_granularity__apply_dg_to_else2_10_0, 15,17,22,33,43,44,45,46)
MR_decl_label8(transform_hlds__distance_granularity__apply_dg_to_else2_10_0, 48,50,52,53,55,56,58,60)
MR_decl_label5(transform_hlds__distance_granularity__apply_dg_to_else2_10_0, 61,10,8,2,67)
...
MR_decl_label8(transform_hlds__distance_granularity__apply_dg_to_preds_4_0, 49,3,4,5,6,7,10,11)
MR_decl_label8(transform_hlds__distance_granularity__apply_dg_to_preds_4_0, 12,13,15,16,17,18,19,20)
MR_decl_label8(transform_hlds__distance_granularity__apply_dg_to_preds_4_0, 21,22,23,24,25,26,27,28)
MR_decl_label8(transform_hlds__distance_granularity__apply_dg_to_preds_4_0, 30,31,32,33,34,35,36,37)
MR_decl_label1(transform_hlds__distance_granularity__apply_dg_to_preds_4_0, 38)
...
MR_BEGIN_MODULE(transform_hlds__distance_granularity_module2)
	...
	MR_init_label8(transform_hlds__distance_granularity__apply_dg_to_else2_10_0,95,5,6,7,11,12,13,14)
	MR_init_label8(transform_hlds__distance_granularity__apply_dg_to_else2_10_0,15,17,22,33,43,44,45,46)
	MR_init_label8(transform_hlds__distance_granularity__apply_dg_to_else2_10_0,48,50,52,53,55,56,58,60)
	MR_init_label5(transform_hlds__distance_granularity__apply_dg_to_else2_10_0,61,10,8,2,67)
MR_BEGIN_CODE
...
MR_def_label(transform_hlds__distance_granularity__apply_dg_to_else2_10_0,22)
	...
	MR_r2 = MR_sv(17);
	MR_r3 = MR_ctfield(1, MR_tempr6, 2);
	}
...
MR_def_label(transform_hlds__distance_granularity__apply_dg_to_else2_10_0,33)
	...
	MR_tfield(0, MR_tempr2, 1) = (MR_Word) MR_TAG_COMMON(3,3,1);
	MR_tag_alloc_heap(MR_tempr3, 1, (MR_Integer) 2);
...
MR_BEGIN_MODULE(transform_hlds__distance_granularity_module15)
	...
	MR_init_label8(transform_hlds__distance_granularity__apply_dg_to_preds_4_0,49,3,4,5,6,7,10,11)
	MR_init_label8(transform_hlds__distance_granularity__apply_dg_to_preds_4_0,12,13,15,16,17,18,19,20)
	MR_init_label8(transform_hlds__distance_granularity__apply_dg_to_preds_4_0,21,22,23,24,25,26,27,28)
	MR_init_label8(transform_hlds__distance_granularity__apply_dg_to_preds_4_0,30,31,32,33,34,35,36,37)
	MR_init_label1(transform_hlds__distance_granularity__apply_dg_to_preds_4_0,38)
MR_BEGIN_CODE
