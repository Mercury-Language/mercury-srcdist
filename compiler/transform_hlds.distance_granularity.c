...
static /* final */ const MR_Box transform_hlds__distance_granularity_scalar_common_1[6][2] = {
  ...
  /* row   4 */
  {
    ((MR_Box) (MR_mkword(3, &transform_hlds__distance_granularity_scalar_common_1[3]))),
    ((MR_Box) ((MR_Unsigned) 0U))
  },
  /* row   5 */
  {
...
static /* final */ const MR_Box transform_hlds__distance_granularity_scalar_common_4[1][4] = {
  /* row   0 */
  {
    ...
    ((MR_Box) (MR_mkword(1, &transform_hlds__distance_granularity_scalar_common_1[5])))
  },
};
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = transform_hlds__distance_granularity__IntroducedFrom__pred__apply_dg_to_preds__227__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 4)))));
  return succeeded;
}
        ...
        case (MR_Integer) 1:
          {
            ...
            hlds__pred_table__predicate_table_insert_4_p_0(STATE_VARIABLE_ClonePredInfo_50_50, &InsertedPredId_30, PredicateTable0_29, &PredicateTable1_31);
            {
              ...
              MR_hl_field(0, Var_51, 0) = ((MR_Box) (&transform_hlds__distance_granularity_scalar_common_5[0]));
              MR_hl_field(0, Var_51, 1) = ((MR_Box) (transform_hlds__distance_granularity__apply_dg_to_preds_4_p_0_1));
              MR_hl_field(0, Var_51, 2) = ((MR_Box) ((MR_Integer) 2));
              MR_hl_field(0, Var_51, 3) = ((MR_Box) (ClonePredId_15));
              MR_hl_field(0, Var_51, 4) = ((MR_Box) (InsertedPredId_30));
            }
  ...
  MR_Integer Distance_16)
{
  ...
  if (succeeded)
  {
    ...
    hlds__instmap__instmap_delta_insert_var_4_p_0(Var_25, (MR_Word) (MR_mkword(3, &transform_hlds__distance_granularity_scalar_common_3[1])), InstMapDelta0_33, &InstMapDelta_35);
      ...
      else
      {
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            ...
            {
              MerInst_35 = (MR_Word) MR_mkword(3, MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(3, MerInst_35, 0) = ((MR_Box) ((MR_Unsigned) 0U));
              MR_hl_field(3, MerInst_35, 1) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 0));
              MR_hl_field(3, MerInst_35, 2) = ((MR_Box) ((MR_Unsigned) 4U));
              MR_hl_field(3, MerInst_35, 3) = ((MR_Box) (Var_58));
            }
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            ...
            Var_97 = parse_tree__prog_data__cons_id_dummy_type_ctor_0_f_0();
            {
              ...
              MR_hl_field(3, ConsId_37, 1) = ((MR_Box) (MinusCallSymName_36));
              MR_hl_field(3, ConsId_37, 2) = ((MR_Box) ((MR_Integer) 2));
              MR_hl_field(3, ConsId_37, 3) = ((MR_Box) (Var_97));
            }
            {
              Var_100 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(1, Var_100, 0) = ((MR_Box) (Var_29));
              MR_hl_field(1, Var_100, 1) = ((MR_Box) ((MR_Unsigned) 0U));
            }
            {
              Var_99 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(1, Var_99, 0) = ((MR_Box) (GranularityVar_13));
            ...
            }
            {
              ...
              MR_hl_field(1, Rhs_38, 2) = ((MR_Box) (Var_99));
            }
            {
              Var_102 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
              MR_hl_field(0, Var_102, 0) = ((MR_Box) (VarResult_31));
              MR_hl_field(0, Var_102, 1) = ((MR_Box) (Rhs_38));
              MR_hl_field(0, Var_102, 2) = ((MR_Box) (&transform_hlds__distance_granularity_scalar_common_1[2]));
            }
            {
              MinusCallUnifyContext_39 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(1, MinusCallUnifyContext_39, 0) = ((MR_Box) (Var_102));
            }
            {
            ...
            parse_tree__set_of_var__list_to_set_2_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), MinusCallArgs_34, &NonLocals_41);
            {
              ...
              MR_hl_field(0, VarResultDelta_42, 1) = ((MR_Box) (MR_mkword(3, &transform_hlds__distance_granularity_scalar_common_3[0])));
            }
            {
              VarDelta_43 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
              MR_hl_field(0, VarDelta_43, 0) = ((MR_Box) (Var_29));
              MR_hl_field(0, VarDelta_43, 1) = ((MR_Box) (MR_mkword(3, &transform_hlds__distance_granularity_scalar_common_4[0])));
            }
            {
              Var_125 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(1, Var_125, 0) = ((MR_Box) (VarResultDelta_42));
              MR_hl_field(1, Var_125, 1) = ((MR_Box) ((MR_Unsigned) 0U));
            }
            {
              Var_124 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(1, Var_124, 0) = ((MR_Box) (VarDelta_43));
            ...
            hlds__instmap__instmap_delta_insert_var_4_p_0(Var_29, (MR_Word) (MR_mkword(3, &transform_hlds__distance_granularity_scalar_common_3[1])), InstMapDelta0_55, &InstMapDelta_57);
            ...
            mercury__list__det_split_list_4_p_0((MR_Word) (&hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_hlds_goal_0), Var_132, Goals1_60, &StartGoals_61, &EndGoals_62);
            {
              ...
              MR_hl_field(1, Var_134, 0) = ((MR_Box) (UnifyGoal_30));
            ...
            mercury__list__append_3_p_1((MR_Word) (&hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_hlds_goal_0), StartGoals_61, Var_134, &GoalsAppend0_63);
            {
              ...
              MR_hl_field(1, Var_136, 0) = ((MR_Box) (DecrementGoal_52));
            ...
            {
              STATE_VARIABLE_GoalExpr_138_138 = (MR_Word) MR_mkword(3, MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(3, STATE_VARIABLE_GoalExpr_138_138, 0) = ((MR_Box) ((MR_Unsigned) 2U));
              MR_hl_field(3, STATE_VARIABLE_GoalExpr_138_138, 1) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 0));
              MR_hl_field(3, STATE_VARIABLE_GoalExpr_138_138, 2) = ((MR_Box) (Goals_65));
            }
          }
          else
          {
