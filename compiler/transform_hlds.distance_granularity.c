  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_4)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      {
        NewPredIdGranularity_19 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
...
{
  {
    ...
    MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), CallExpr0_17, (MR_Integer) 3)));
          ...
          case (MR_Integer) 2:
            {
              ...
              MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), GoalExpr0_27, (MR_Integer) 1)));
          ...
          case (MR_Integer) 4:
            {
              ...
              MR_Unsigned packed_word_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), GoalExpr0_27, (MR_Integer) 2)));
          ...
          case (MR_Integer) 5:
            {
              ...
              if (succeeded)
              {
                packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Reason_63, (MR_Integer) 2)));
...
{
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Var_86, (MR_Integer) 1)));
      ...
      {
        Var_51 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL));
  ...
  MR_Word * STATE_VARIABLE_ProcInfo_45)
{
  while (MR_TRUE)
  {
    ...
    if (succeeded)
    {
      packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), STATE_VARIABLE_GoalExpr_0_40, (MR_Integer) 1)));
    ...
    if (succeeded)
    {
      ...
      else
      {
        ...
        if (succeeded)
        {
          ...
          packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), GoalExpr0_21, (MR_Integer) 3)));
          ...
          if (succeeded)
          {
            ...
            {
              MerInst_34 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL));
            ...
            {
              STATE_VARIABLE_GoalExpr_61_61 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
...
{
  {
    ...
    if (succeeded)
    {
      packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Var_41, (MR_Integer) 1)));
  ...
  MR_Word * STATE_VARIABLE_ProcInfo_71)
{
  while (MR_TRUE)
  {
    ...
    if (succeeded)
    {
      packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), STATE_VARIABLE_GoalExpr_0_66, (MR_Integer) 1)));
      ...
      else
      {
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            ...
            {
              STATE_VARIABLE_GoalExpr_134_134 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
...
{
  {
    ...
    MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), STATE_VARIABLE_GoalExpr_0_37, (MR_Integer) 3)));
