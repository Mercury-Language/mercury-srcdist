  ...
  MR_Box closure_arg)
{
  ...
  succeeded = transform_hlds__distance_granularity__IntroducedFrom__pred__apply_dg_to_preds__229__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) ((MR_hl_field(0, closure, 4)))));
  return succeeded;
}
