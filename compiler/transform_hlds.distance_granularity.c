...
MR_decl_label8(transform_hlds__distance_granularity__apply_dg_to_goal_15_0, 28,29,50,4,5,9,10,7)
MR_decl_label8(transform_hlds__distance_granularity__apply_dg_to_goal_15_0, 13,14,18,19,20,21,24,25)
MR_decl_label8(transform_hlds__distance_granularity__apply_dg_to_goal_15_0, 31,58,32,35,39,40,42,43)
...
MR_decl_label8(transform_hlds__distance_granularity__update_original_predicate_goal_9_0, 75,76,4,5,7,10,13,14)
MR_decl_label8(transform_hlds__distance_granularity__update_original_predicate_goal_9_0, 18,19,20,21,24,25,30,74)
MR_decl_label7(transform_hlds__distance_granularity__update_original_predicate_goal_9_0, 55,31,34,38,39,41,42)
...
MR_BEGIN_MODULE(transform_hlds__distance_granularity_module5)
	...
	MR_init_label8(transform_hlds__distance_granularity__apply_dg_to_goal_15_0,28,29,50,4,5,9,10,7)
	MR_init_label8(transform_hlds__distance_granularity__apply_dg_to_goal_15_0,13,14,18,19,20,21,24,25)
	MR_init_label8(transform_hlds__distance_granularity__apply_dg_to_goal_15_0,31,58,32,35,39,40,42,43)
MR_BEGIN_CODE
...
MR_def_label(transform_hlds__distance_granularity__apply_dg_to_goal_15_0,31)
	...
	MR_Word MR_tempr1, MR_tempr2, MR_tempr3;
	MR_tempr3 = MR_r11;
	MR_r12 = MR_ctfield(3, MR_tempr3, 2);
...
MR_BEGIN_MODULE(transform_hlds__distance_granularity_module11)
	...
	MR_init_label8(transform_hlds__distance_granularity__update_original_predicate_goal_9_0,75,76,4,5,7,10,13,14)
	MR_init_label8(transform_hlds__distance_granularity__update_original_predicate_goal_9_0,18,19,20,21,24,25,30,74)
	MR_init_label7(transform_hlds__distance_granularity__update_original_predicate_goal_9_0,55,31,34,38,39,41,42)
MR_BEGIN_CODE
...
MR_def_label(transform_hlds__distance_granularity__update_original_predicate_goal_9_0,30)
	...
	MR_Word MR_tempr1, MR_tempr2;
	MR_tempr2 = MR_r8;
	MR_r9 = MR_ctfield(3, MR_tempr2, 2);
	MR_tempr1 = MR_ctfield(3, MR_tempr2, 1);
	MR_sv(1) = MR_tempr1;
	MR_sv(6) = MR_ctfield(0, MR_r1, 1);
	if (MR_RTAGS_TESTR(MR_tempr1,3,2)) {
	...
	MR_r8 = MR_ctfield(3, MR_tempr1, 2);
