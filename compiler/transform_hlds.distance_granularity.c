  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      PredName0_17 = hlds__hlds_pred__pred_info_name_1_f_0(PredInfo_13);
      {
        ...
        MR_hl_field(MR_mktag(3), Transform_18, 0) = ((MR_Box) ((MR_Unsigned) 4U));
      ...
      parse_tree__pred_name__make_pred_name_4_p_0(ModuleName_16, PredName0_17, Transform_18, &NewPredSymName_19);
