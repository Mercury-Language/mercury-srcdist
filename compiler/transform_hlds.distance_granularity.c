  ...
  MR_Word * IsRecursiveCallInParallelConj_24)
{
  ...
  MR_Word CalleePredId_25 = ((MR_Word) ((MR_hl_field(2, STATE_VARIABLE_GoalExpr_0_37, 0))));
  MR_Integer CalleeProcId_26 = ((MR_Integer) ((MR_hl_field(2, STATE_VARIABLE_GoalExpr_0_37, 1))));
  MR_Word CallArgs_27 = ((MR_Word) ((MR_hl_field(2, STATE_VARIABLE_GoalExpr_0_37, 2))));
  MR_Word CallBuiltin_28 = ((MR_Unsigned) ((MR_hl_field(2, STATE_VARIABLE_GoalExpr_0_37, 3))) & (MR_Integer) 1);
  MR_Word CallUnifyContext_29 = ((MR_Word) ((MR_hl_field(2, STATE_VARIABLE_GoalExpr_0_37, 4))));
  ...
  if (succeeded)
  {
    if ((STATE_VARIABLE_MaybeGranularityVar_0_43 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      ...
      hlds__hlds_proc_util__proc_info_create_var_from_type_6_p_0((MR_String) "", Var_46, (MR_Integer) 1, &GranularityVar_32, STATE_VARIABLE_ProcInfo_0_39, &STATE_VARIABLE_ProcInfo_1_48);
      {
        MR_Word base;
      ...
      hlds__hlds_pred__proc_info_get_argmodes_2_p_0(STATE_VARIABLE_ProcInfo_1_48, &ArgsModes0_33);
      hlds__hlds_pred__proc_info_get_headvars_2_p_0(STATE_VARIABLE_ProcInfo_1_48, &HeadVars0_34);
      ...
      hlds__hlds_pred__proc_info_set_argmodes_3_p_0(ArgsModes_35, STATE_VARIABLE_ProcInfo_1_48, &STATE_VARIABLE_ProcInfo_2_55);
      hlds__hlds_pred__proc_info_set_headvars_3_p_0(HeadVars_36, STATE_VARIABLE_ProcInfo_2_55, STATE_VARIABLE_ProcInfo_40);
    }
    else
    {
