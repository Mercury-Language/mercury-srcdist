  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_9)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      hlds__quantification__requantify_proc_general_3_p_0((MR_Integer) 1, STATE_VARIABLE_ProcInfo_3_38, &STATE_VARIABLE_ProcInfo_4_40);
        ...
        case (MR_Integer) 0:
          {
            ...
            else
            {
              ...
              hlds__quantification__requantify_proc_general_3_p_0((MR_Integer) 1, STATE_VARIABLE_ProcInfo_3_53, &STATE_VARIABLE_ProcInfo_4_55);
