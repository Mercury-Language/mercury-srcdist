...
MR_decl_label10(transform_hlds__distance_granularity__apply_dg_to_else2_10_0, 107,5,6,7,11,12,13,14,15,17)
...
MR_decl_label10(transform_hlds__distance_granularity__apply_dg_to_goal_15_0, 20,21,18,25,24,29,28,32,35,31)
MR_decl_label4(transform_hlds__distance_granularity__apply_dg_to_goal_15_0, 40,39,155,44)
...
MR_decl_label10(transform_hlds__distance_granularity__create_if_then_else_goal_10_0, 19,20,21,22,13,27,28,29,31,32)
...
MR_decl_label10(transform_hlds__distance_granularity__update_original_predicate_goal_9_0, 21,18,25,24,28,31,34,30,39,38)
MR_decl_label2(transform_hlds__distance_granularity__update_original_predicate_goal_9_0, 147,43)
...
MR_BEGIN_MODULE(transform_hlds__distance_granularity_module2)
	...
	MR_init_label10(transform_hlds__distance_granularity__apply_dg_to_else2_10_0,107,5,6,7,11,12,13,14,15,17)
...
MR_def_label(transform_hlds__distance_granularity__apply_dg_to_else2_10_0,107)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_def_label(transform_hlds__distance_granularity__apply_dg_to_else2_10_0,61)
	...
	MR_GOTO_LAB(transform_hlds__distance_granularity__apply_dg_to_else2_10_0_i107);
	}
...
MR_BEGIN_MODULE(transform_hlds__distance_granularity_module4)
	...
	MR_init_label10(transform_hlds__distance_granularity__create_if_then_else_goal_10_0,19,20,21,22,13,27,28,29,31,32)
...
MR_def_label(transform_hlds__distance_granularity__create_if_then_else_goal_10_0,31)
	...
	MR_r2 = MR_sv(2);
	MR_np_call_localret_ent(hlds__hlds_goal__goal_info_set_nonlocals_3_0,
		transform_hlds__distance_granularity__create_if_then_else_goal_10_0_i32);
MR_def_label(transform_hlds__distance_granularity__create_if_then_else_goal_10_0,32)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
...
MR_BEGIN_MODULE(transform_hlds__distance_granularity_module5)
	...
	MR_init_label10(transform_hlds__distance_granularity__apply_dg_to_goal_15_0,20,21,18,25,24,29,28,32,35,31)
	MR_init_label4(transform_hlds__distance_granularity__apply_dg_to_goal_15_0,40,39,155,44)
MR_BEGIN_CODE
...
MR_def_label(transform_hlds__distance_granularity__apply_dg_to_goal_15_0,24)
	...
	if (MR_PTAG_TESTR(MR_r11,1)) {
		MR_GOTO_LAB(transform_hlds__distance_granularity__apply_dg_to_goal_15_0_i28);
	}
	MR_incr_sp(10);
	MR_sv(10) = (MR_Word) MR_succip;
	MR_sv(6) = MR_tfield(0, MR_r1, 1);
...
MR_def_label(transform_hlds__distance_granularity__apply_dg_to_goal_15_0,31)
	...
	if (MR_RTAGS_TESTR(MR_r11,3,3)) {
		MR_GOTO_LAB(transform_hlds__distance_granularity__apply_dg_to_goal_15_0_i39);
	}
	MR_incr_sp(10);
	MR_sv(10) = (MR_Word) MR_succip;
	MR_sv(6) = MR_tfield(0, MR_r1, 1);
...
MR_def_label(transform_hlds__distance_granularity__apply_dg_to_goal_15_0,39)
	...
	if (MR_PTAG_TESTR(MR_r11,0)) {
		MR_GOTO_LAB(transform_hlds__distance_granularity__apply_dg_to_goal_15_0_i155);
	}
	MR_r5 = (MR_Integer) 0;
	MR_r2 = MR_r6;
	MR_r3 = MR_r7;
	MR_r4 = MR_r10;
	MR_proceed();
MR_def_label(transform_hlds__distance_granularity__apply_dg_to_goal_15_0,155)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(10);
	MR_sv(10) = (MR_Word) MR_succip;
	MR_np_call_localret_ent(fn__transform_hlds__distance_granularity__this_file_0_0,
		transform_hlds__distance_granularity__apply_dg_to_goal_15_0_i44);
MR_def_label(transform_hlds__distance_granularity__apply_dg_to_goal_15_0,44)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = (MR_Word) MR_string_const("apply_dg_to_goal", 16);
...
MR_BEGIN_MODULE(transform_hlds__distance_granularity_module11)
	...
	MR_init_label10(transform_hlds__distance_granularity__update_original_predicate_goal_9_0,21,18,25,24,28,31,34,30,39,38)
	MR_init_label2(transform_hlds__distance_granularity__update_original_predicate_goal_9_0,147,43)
MR_BEGIN_CODE
...
MR_def_label(transform_hlds__distance_granularity__update_original_predicate_goal_9_0,24)
	...
	if (MR_PTAG_TESTR(MR_r8,1)) {
		MR_GOTO_LAB(transform_hlds__distance_granularity__update_original_predicate_goal_9_0_i28);
	}
...
MR_def_label(transform_hlds__distance_granularity__update_original_predicate_goal_9_0,30)
	...
	if (MR_RTAGS_TESTR(MR_r8,3,3)) {
		MR_GOTO_LAB(transform_hlds__distance_granularity__update_original_predicate_goal_9_0_i38);
	}
	MR_incr_sp(10);
	MR_sv(10) = (MR_Word) MR_succip;
	MR_sv(6) = MR_tfield(0, MR_r1, 1);
...
MR_def_label(transform_hlds__distance_granularity__update_original_predicate_goal_9_0,38)
	...
	if (MR_PTAG_TESTR(MR_r8,0)) {
		MR_GOTO_LAB(transform_hlds__distance_granularity__update_original_predicate_goal_9_0_i147);
	}
	MR_r2 = MR_r6;
	MR_proceed();
MR_def_label(transform_hlds__distance_granularity__update_original_predicate_goal_9_0,147)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(10);
	MR_sv(10) = (MR_Word) MR_succip;
	MR_np_call_localret_ent(fn__transform_hlds__distance_granularity__this_file_0_0,
		transform_hlds__distance_granularity__update_original_predicate_goal_9_0_i43);
MR_def_label(transform_hlds__distance_granularity__update_original_predicate_goal_9_0,43)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
