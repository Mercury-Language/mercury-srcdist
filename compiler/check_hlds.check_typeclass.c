...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(0), Spec_6, 2) = ((MR_Box) ((MR_Unsigned) 32U));
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_13, (MR_Integer) 490, &IntermodOpt_14);
...

    {
      ...
      if ((env).check_hlds__check_typeclass__check_for_corresponding_instances_2_5_p_0_env_0__succeeded)
      {
        ...
        else
        {
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(1), Spec_22, 2) = ((MR_Box) ((MR_Unsigned) 32U));
      ...
      else
      {
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(1), Spec_109, 2) = ((MR_Box) ((MR_Unsigned) 32U));
...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(0), Spec_36, 2) = ((MR_Box) ((MR_Unsigned) 32U));
...
{
  {
    ...
    else
    {
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(1), Spec_53, 2) = ((MR_Box) ((MR_Unsigned) 32U));
  ...
  MR_Word * STATE_VARIABLE_Specs_43)
{
  if ((ClassInterface_19 == (MR_Word) ((MR_Unsigned) 0U)))
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), Spec_28, 2) = ((MR_Box) ((MR_Unsigned) 32U));
        ...
        case (MR_Integer) 0:
          {
            ...
            }
            {
              ...
              MR_hl_field(MR_mktag(1), Spec_31, 2) = ((MR_Box) ((MR_Unsigned) 32U));
...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(0), Spec_10, 2) = ((MR_Box) ((MR_Unsigned) 32U));
