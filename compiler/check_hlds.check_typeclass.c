  ...
  MR_Word * STATE_VARIABLE_Specs_49)
{
  ...
  else
  {
    ...
    Var_79 = parse_tree__error_spec__component_list_to_color_line_pieces_3_f_0((MR_Word) (MR_mkword(1, &check_hlds__check_typeclass_scalar_common_3[2])), (MR_Word) (MR_mkword(1, &check_hlds__check_typeclass_scalar_common_1[36])), ConstraintPieceLists_58);
  ...
  MR_Word * STATE_VARIABLE_Specs_28)
{
  ...
  else
  {
    ...
    Var_81 = parse_tree__error_spec__component_list_to_color_line_pieces_3_f_0((MR_Word) (MR_mkword(1, &check_hlds__check_typeclass_scalar_common_3[2])), (MR_Word) (MR_mkword(1, &check_hlds__check_typeclass_scalar_common_1[36])), MethodPieces_25);
