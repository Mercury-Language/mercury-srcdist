      ...
      case (MR_Integer) 1:
        {
...

          {
            ...
            MR_hl_field(MR_mktag(0), Var_20, 1) = ((MR_Box) (check_hlds__check_typeclass__check_typeclass_constraints_on_type_ctor_4_p_0_1));
          ...
          Var_21 = mercury__one_or_more__one_or_more_to_list_1_f_1((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_constructor_0), Ctors_10);
      ...
      case (MR_Integer) 0:
        {
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(1), Var_176, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &check_hlds__check_typeclass_scalar_common_1[126])));
          }
          {
            Var_173 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), Var_173, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &check_hlds__check_typeclass_scalar_common_1[117])));
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(1), EndPieces_166, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &check_hlds__check_typeclass_scalar_common_1[116])));
      ...
      case (MR_Integer) 1:
        {
          ...
          else
          {
            ...
            {
              TypeCtor_100 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
              MR_hl_field(MR_mktag(0), TypeCtor_100, 0) = ((MR_Box) (TypeName_37));
              MR_hl_field(MR_mktag(0), TypeCtor_100, 1) = ((MR_Box) (Var_60));
            }
            Spec_99 = check_hlds__check_typeclass__badly_formed_instance_type_msg_5_f_0(ClassId_10, InstanceDefn_11, N_13, TypeCtor_100, NonTVarArgs_105);
            {
              MR_Word base;
              base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              *STATE_VARIABLE_Specs_55 = base;
          ...
          case (MR_Integer) 0:
            {
              ...
              else
              {
                ...
                Var_66 = mercury__list__length_1_f_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0), ArgTypes_31);
                {
                  ...
                  MR_hl_field(MR_mktag(0), TypeCtor_36, 1) = ((MR_Box) (Var_66));
                }
                Spec_96 = check_hlds__check_typeclass__badly_formed_instance_type_msg_5_f_0(ClassId_10, InstanceDefn_11, N_13, TypeCtor_36, NonTVarArgs_33);
                {
                  MR_Word base;
                  base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                  *STATE_VARIABLE_Specs_55 = base;
          ...
          case (MR_Integer) 1:
            {
              ...
              }
              {
                ...
                MR_hl_field(MR_mktag(1), Var_140, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &check_hlds__check_typeclass_scalar_common_1[124])));
              }
              {
                Var_137 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(1), Var_137, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &check_hlds__check_typeclass_scalar_common_1[117])));
              ...
              }
              {
                ...
                MR_hl_field(MR_mktag(1), EndPieces_130, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &check_hlds__check_typeclass_scalar_common_1[116])));
          ...
          case (MR_Integer) 2:
            {
              ...
              }
              {
                ...
                MR_hl_field(MR_mktag(1), Var_79, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &check_hlds__check_typeclass_scalar_common_1[122])));
              }
              {
                Var_76 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(1), Var_76, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &check_hlds__check_typeclass_scalar_common_1[117])));
...
{
  {
    ...
    check_hlds__check_typeclass__check_typeclass_constraints_on_type_ctor_4_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) (wrapper_arg_1)), ((MR_Word) (wrapper_arg_2)), &conv2_STATE_VARIABLE_Specs_19);
