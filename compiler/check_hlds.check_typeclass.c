  ...
  MR_Word * STATE_VARIABLE_Specs_17)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_13, (MR_Integer) 314, &IntermodOpt_14);
  ...
  MR_Word * STATE_VARIABLE_Specs_22)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 133, &Verbose_12);
