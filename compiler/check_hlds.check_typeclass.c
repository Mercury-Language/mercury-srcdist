  ...
  MR_Box wrapper_arg_1)
{
  ...
  conv0_HeadVar__3_88 = check_hlds__check_typeclass__IntroducedFrom__func__report_unbound_tvars_in_pred_context__2318__1_2_f_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) (wrapper_arg_1)));
  ...
  MR_Word * STATE_VARIABLE_Specs_17)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_13, (MR_Integer) 491, &IntermodOpt_14);
  ...
  MR_Box * wrapper_arg_2)
{
  ...
  check_hlds__check_typeclass__IntroducedFrom__pred__check_instance_pred_procs__844__1_3_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Integer) (wrapper_arg_1)), &conv0_LambdaHeadVar__2_75);
