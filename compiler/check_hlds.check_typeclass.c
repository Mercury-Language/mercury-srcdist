  ...
  MR_Word * STATE_VARIABLE_Specs_75)
{
  ...
  parse_tree__pred_name__make_instance_method_pred_sym_name_5_p_0(ClassId_15, MethodName_44, Arity_47, InstanceTypes_57, &PredName_66);
  {
