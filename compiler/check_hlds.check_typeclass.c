    ...
    else
    {
      ...
      if ((BadClassSNAs_25 == (MR_Word) ((MR_Unsigned) 0U)))
      {
        ...
        hlds__hlds_module__module_info_get_class_table_2_p_0(ModuleInfo_7, &ClassTable_64);
        {
          ...
          MR_hl_field(MR_mktag(0), Var_75, 0) = ((MR_Box) (&check_hlds__check_typeclass_scalar_common_5[5]));
...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), Var_16, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &check_hlds__check_typeclass_scalar_common_1[33])));
    }
    {
      StartPieces_12 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), StartPieces_12, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &check_hlds__check_typeclass_scalar_common_1[166])));
