...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), Var_22, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &check_hlds__check_typeclass_scalar_common_1[147])));
...

    {
      ...
      else
      {
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(1), Var_117, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &check_hlds__check_typeclass_scalar_common_1[136])));
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(1), Pieces_107, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &check_hlds__check_typeclass_scalar_common_1[135])));
...
{
  {
    ...
    check_hlds__check_typeclass__IntroducedFrom__pred__report_duplicate_method_defn__2126__1_2_p_0(((MR_Word) (wrapper_arg_1)), &conv0_LambdaHeadVar__2_84);
