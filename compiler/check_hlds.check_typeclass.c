...
{
  {
...

    {
      ...
      MR_hl_field(MR_mktag(3), LambdaHeadVar__2_15, 0) = ((MR_Box) ((MR_Unsigned) 17U));
...
{
  {
...

    {
      ...
      MR_hl_field(MR_mktag(3), QualHeadClassId_9, 0) = ((MR_Box) ((MR_Unsigned) 17U));
...
{
  {
...

    {
      ...
      MR_hl_field(MR_mktag(3), Var_12, 0) = ((MR_Box) ((MR_Unsigned) 17U));
...
{
  {
    ...
    else
    {
      ...
      check_hlds__check_typeclass__format_method_names_3_p_0(HeadTailMethod_13, TailTailMethods_14, &TailPieces_15);
      {
        ...
        MR_hl_field(MR_mktag(3), Var_16, 0) = ((MR_Box) ((MR_Unsigned) 22U));
