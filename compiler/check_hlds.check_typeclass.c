...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_13, (MR_Integer) 355, &IntermodOpt_14);
  ...
  MR_Word * STATE_VARIABLE_Specs_45)
{
  ...
  else
  {
    ...
    *STATE_VARIABLE_QualInfo_43 = ((MR_Word) (conv6_STATE_VARIABLE_QualInfo_43));
    ...
    Var_85 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_InstanceDefn_47_47, (MR_Integer) 4))));
