  ...
  MR_Word * STATE_VARIABLE_Specs_14)
{
  ...
  else
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), Msg_30, 0) = ((MR_Box) (Context_21));
...
{
  {
    ...
    else
    {
      ...
      }
      {
        Msg_15 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), Msg_15, 0) = ((MR_Box) (Context_9));
        MR_hl_field(MR_mktag(1), Msg_15, 1) = ((MR_Box) (Var_30));
      }
      {
        Var_35 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
...
{
  {
...

    {
      ...
      if ((env).check_hlds__check_typeclass__check_for_corresponding_instances_2_5_p_0_env_0__succeeded)
      {
        ...
        else
        {
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(1), Msg_22, 0) = ((MR_Box) (AbstractInstanceContext_21));
            MR_hl_field(MR_mktag(1), Msg_22, 1) = ((MR_Box) (Var_47));
          }
          {
      ...
      else
      {
        ...
        {
          Msg_114 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), Msg_114, 0) = ((MR_Box) (AbstractInstanceContext_113));
          MR_hl_field(MR_mktag(1), Msg_114, 1) = ((MR_Box) (Var_129));
        }
        {
...
{
  {
    ...
    {
      Msg_22 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), Msg_22, 0) = ((MR_Box) (InstanceContext_16));
      MR_hl_field(MR_mktag(1), Msg_22, 1) = ((MR_Box) (Var_57));
    }
    {
      Var_62 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
...
{
  {
    ...
    else
    {
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(1), Msg_53, 0) = ((MR_Box) (Context_22));
        MR_hl_field(MR_mktag(1), Msg_53, 1) = ((MR_Box) (Var_92));
      }
      {
  ...
  MR_Word * STATE_VARIABLE_Specs_46)
{
  if ((ClassInterface_19 == (MR_Word) ((MR_Unsigned) 0U)))
  {
    ...
    {
      Msg_30 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), Msg_30, 0) = ((MR_Box) (TermContext_21));
      MR_hl_field(MR_mktag(1), Msg_30, 1) = ((MR_Box) (Var_69));
    }
    {
      Var_74 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), Msg_25, 0) = ((MR_Box) (Context_10));
      MR_hl_field(MR_mktag(1), Msg_25, 1) = ((MR_Box) (Var_72));
    }
    {
        ...
        case (MR_Integer) 0:
          {
            ...
            }
            {
              ...
              MR_hl_field(MR_mktag(1), Msg_34, 0) = ((MR_Box) (ClassContext_28));
              MR_hl_field(MR_mktag(1), Msg_34, 1) = ((MR_Box) (Var_55));
            }
            {
              Var_60 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
