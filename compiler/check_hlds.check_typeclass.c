...
{
  {
    ...
    {
      libs__globals__lookup_bool_option_3_p_0(check_hlds__check_typeclass__Globals_13, (MR_Integer) 328, &check_hlds__check_typeclass__IntermodOpt_14);
    }
...
{
  {
    ...
    {
      libs__globals__lookup_bool_option_3_p_0(check_hlds__check_typeclass__Globals_10, (MR_Integer) 54, &check_hlds__check_typeclass__Verbose_11);
    }
    {
