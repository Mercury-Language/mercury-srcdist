...
{
  {
    ...
    else
    {
      ...
      mercury__private_builtin__builtin_compare_int_3_p_0(&SubResult1_6, Var_41, Var_42);
      succeeded = (SubResult1_6 != (MR_Integer) 0);
      if (succeeded)
        *HeadVar__1_1 = SubResult1_6;
      else
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_13, (MR_Integer) 344, &IntermodOpt_14);
