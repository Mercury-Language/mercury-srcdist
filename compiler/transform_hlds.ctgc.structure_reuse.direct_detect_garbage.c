  ...
  MR_Word * DeadCellTable_12)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_27, (MR_Integer) 78, &VeryVerbose_28);
  {
  ...
  MR_Box * wrapper_arg_5)
{
  ...
  transform_hlds__ctgc__structure_reuse__direct_detect_garbage__determine_dead_deconstructions_2_disj_goal_7_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 4)))), ((MR_Word) (wrapper_arg_1)), ((MR_Word) (wrapper_arg_2)), &conv10_STATE_VARIABLE_SharingAs_15, ((MR_Word) (wrapper_arg_4)), &conv9_STATE_VARIABLE_DeadCellTable_17);
