...
{
  {
    ...
    else
    {
      ...
      TypeCtorInfo_246_246 = (MR_Word) &hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_proc_id_0;
      TypeCtorInfo_247_247 = (MR_Word) &hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_proc_info_0;
      mercury__map__to_assoc_list_2_p_0(TypeCtorInfo_246_246, TypeCtorInfo_247_247, ProcTable0_53, &ExistingProcs_54);
      ...
      else
      {
        ...
        if (succeeded)
        {
          ...
          mercury__map__lookup_3_p_0(TypeCtorInfo_246_246, TypeCtorInfo_247_247, ProcTable0_53, ((MR_Box) (ProcId_56)), &conv1_ProcInfo0_57);
