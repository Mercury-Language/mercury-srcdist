    ...
    if (succeeded)
    {
      ...
      else
      {
        ...
        else
        {
          ...
          MR_Word Strictness_182 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Attributes_35, (MR_Integer) 0))));
          ...
          switch (MR_tag((MR_Word) Strictness_182)) {
            default: /*NOTREACHED*/ MR_assert(0);
            case (MR_Integer) 0:
              hlds__make_hlds__add_pragma__add_pragma_tabling__check_pred_args_against_tabling_4_p_0(DeclaredArgModes_34, STATE_VARIABLE_ModuleInfo_0_49, (MR_Integer) 1, &MaybeError_41);
              break;
            case (MR_Integer) 1:
              {
                MR_Word MaybeArgMethods_39 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Strictness_182, (MR_Integer) 0))));
...
{
  {
    ...
    else
    {
      ...
      MR_Word Var_157 = ((MR_Word) ((MR_hl_field(MR_mktag(1), PredIds_31, (MR_Integer) 1))));
