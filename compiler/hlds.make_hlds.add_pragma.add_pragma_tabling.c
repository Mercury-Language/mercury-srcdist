...
{
  {
    ...
    if (succeeded)
    {
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals_26, (MR_Integer) 258, &OwnStacks_28);
      switch (OwnStacks_28) {
    ...
    if (succeeded)
    {
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(1), InlineWarningSpec_47, 2) = ((MR_Box) ((MR_Unsigned) 20U));
      ...
      else
      {
        ...
        else
        {
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(1), Spec_164, 2) = ((MR_Box) ((MR_Unsigned) 20U));
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_9, (MR_Integer) 297, &HighLevelCode_11);
