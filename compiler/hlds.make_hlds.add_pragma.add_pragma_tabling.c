...
hlds__make_hlds__add_pragma__add_pragma_tabling__IntroducedFrom__pred__table_info_c_global_var_name__649__1_2_p_0(
  MR_Word Target_10,
...
{
  {
    ...
    if (succeeded)
    {
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals_28, (MR_Integer) 244, &OwnStacks_30);
      switch (OwnStacks_30) {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_28, (MR_Integer) 63, &VeryVerbose_39);
    ...
    if (succeeded)
    {
      ...
      {
        InlineWarningMsg_45 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), InlineWarningMsg_45, 0) = ((MR_Box) (Context_22));
        MR_hl_field(MR_mktag(1), InlineWarningMsg_45, 1) = ((MR_Box) (Var_127));
      }
      {
    ...
    if (succeeded)
    {
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(1), Msg_48, 0) = ((MR_Box) (Context_22));
        MR_hl_field(MR_mktag(1), Msg_48, 1) = ((MR_Box) (Var_150));
      }
      {
      ...
      if ((MaybeModes_20 == (MR_Word) ((MR_Unsigned) 0U)))
        if ((ExistingProcs_54 == (MR_Word) ((MR_Unsigned) 0U)))
        {
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(1), Msg_224, 0) = ((MR_Box) (Context_22));
            MR_hl_field(MR_mktag(1), Msg_224, 1) = ((MR_Box) (Var_178));
          }
          {
      ...
      else
      {
        ...
        else
        {
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(1), Msg_215, 0) = ((MR_Box) (Context_22));
            MR_hl_field(MR_mktag(1), Msg_215, 1) = ((MR_Box) (Var_206));
          }
          {
...
{
  {
    ...
    if (succeeded)
    {
      ...
      if ((MaybeDeclaredArgModes_30 == (MR_Word) ((MR_Unsigned) 0U)))
      {
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(1), Msg_33, 0) = ((MR_Box) (Context_19));
          MR_hl_field(MR_mktag(1), Msg_33, 1) = ((MR_Box) (Var_115));
        }
        {
      ...
      else
      {
        ...
        else
        {
          ...
          {
            Msg_171 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), Msg_171, 0) = ((MR_Box) (Context_19));
            MR_hl_field(MR_mktag(1), Msg_171, 1) = ((MR_Box) (Var_80));
          }
          {
    ...
    else
    {
      ...
      {
        Msg_183 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), Msg_183, 0) = ((MR_Box) (Context_19));
        MR_hl_field(MR_mktag(1), Msg_183, 1) = ((MR_Box) (Var_161));
      }
      {
...
{
  {
    ...
    succeeded = hlds__make_hlds__add_pragma__add_pragma_tabling__IntroducedFrom__pred__table_info_c_global_var_name__649__1_2_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))));
    return succeeded;
  }
}
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_9, (MR_Integer) 283, &HighLevelCode_11);
          ...
          case (MR_Integer) 0:
            {
              ...
              {
                StatsMsg_44 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(1), StatsMsg_44, 0) = ((MR_Box) (Context_11));
                MR_hl_field(MR_mktag(1), StatsMsg_44, 1) = ((MR_Box) (Var_99));
              }
              {
                Var_104 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          ...
          case (MR_Integer) 0:
            {
              ...
              {
                ResetMsg_47 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(1), ResetMsg_47, 0) = ((MR_Box) (Context_11));
                MR_hl_field(MR_mktag(1), ResetMsg_47, 1) = ((MR_Box) (Var_127));
              }
              {
                Var_132 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
