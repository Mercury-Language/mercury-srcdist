...
{
  {
    ...
    if (succeeded)
    {
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals_26, (MR_Integer) 261, &OwnStacks_28);
      switch (OwnStacks_28) {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_26, (MR_Integer) 69, &VeryVerbose_40);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_9, (MR_Integer) 300, &HighLevelCode_11);
