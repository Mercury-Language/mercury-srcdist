      ...
      case (MR_Integer) 0:
        {
          ...
          mdbcomp__sym_name__sym_name_to_term_4_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), Context_15, DummyStatsFuncSymName_54, (MR_Word) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))), &DummyStatsFuncTerm_55);
          {
      ...
      case (MR_Integer) 1:
        {
          ...
          VarName_8 = ml_backend__mlds_to_c_name__mlds_tabling_data_name_2_f_0(MLDS_ProcLabel_21, (MR_Word) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
        }
        break;
    }
    return VarName_8;
