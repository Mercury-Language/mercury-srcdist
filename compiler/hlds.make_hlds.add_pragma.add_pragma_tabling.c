...
hlds__make_hlds__add_pragma__add_pragma_tabling__IntroducedFrom__pred__table_info_c_global_var_name__640__1_2_p_0(
      ...
      case (MR_Integer) 1:
        {
          ...
          {
            hlds__make_hlds__add_pragma__add_pragma_tabling__STATE_VARIABLE_Attrs_98_98 = parse_tree__prog_data_foreign__default_attributes_1_f_0((MR_Integer) 0);
          }
          {
            parse_tree__prog_data_foreign__set_may_call_mercury_3_p_0((MR_Integer) 1, hlds__make_hlds__add_pragma__add_pragma_tabling__STATE_VARIABLE_Attrs_98_98, &hlds__make_hlds__add_pragma__add_pragma_tabling__STATE_VARIABLE_Attrs_101_101);
          }
          {
            parse_tree__prog_data_foreign__set_thread_safe_3_p_0((MR_Integer) 1, hlds__make_hlds__add_pragma__add_pragma_tabling__STATE_VARIABLE_Attrs_101_101, &hlds__make_hlds__add_pragma__add_pragma_tabling__STATE_VARIABLE_Attrs_103_103);
          }
          {
            parse_tree__prog_data_foreign__set_purity_3_p_0((MR_Integer) 0, hlds__make_hlds__add_pragma__add_pragma_tabling__STATE_VARIABLE_Attrs_103_103, &hlds__make_hlds__add_pragma__add_pragma_tabling__STATE_VARIABLE_Attrs_105_105);
          }
          {
            parse_tree__prog_data_foreign__set_may_duplicate_3_p_0((MR_Word) MR_mkword(MR_mktag(1), &hlds__make_hlds__add_pragma__add_pragma_tabling_scalar_common_3[3]), hlds__make_hlds__add_pragma__add_pragma_tabling__STATE_VARIABLE_Attrs_105_105, &hlds__make_hlds__add_pragma__add_pragma_tabling__STATE_VARIABLE_Attrs_107_107);
          }
          {
      ...
      case (MR_Integer) 1:
        {
          ...
          {
            hlds__make_hlds__add_pragma__add_pragma_tabling__STATE_VARIABLE_Attrs_127_127 = parse_tree__prog_data_foreign__default_attributes_1_f_0((MR_Integer) 0);
          }
          {
            parse_tree__prog_data_foreign__set_may_call_mercury_3_p_0((MR_Integer) 0, hlds__make_hlds__add_pragma__add_pragma_tabling__STATE_VARIABLE_Attrs_127_127, &hlds__make_hlds__add_pragma__add_pragma_tabling__STATE_VARIABLE_Attrs_130_130);
          }
          {
            parse_tree__prog_data_foreign__set_thread_safe_3_p_0((MR_Integer) 1, hlds__make_hlds__add_pragma__add_pragma_tabling__STATE_VARIABLE_Attrs_130_130, &hlds__make_hlds__add_pragma__add_pragma_tabling__STATE_VARIABLE_Attrs_132_132);
          }
          {
            parse_tree__prog_data_foreign__set_purity_3_p_0((MR_Integer) 0, hlds__make_hlds__add_pragma__add_pragma_tabling__STATE_VARIABLE_Attrs_132_132, &hlds__make_hlds__add_pragma__add_pragma_tabling__STATE_VARIABLE_Attrs_134_134);
          }
          {
            parse_tree__prog_data_foreign__set_may_duplicate_3_p_0((MR_Word) MR_mkword(MR_mktag(1), &hlds__make_hlds__add_pragma__add_pragma_tabling_scalar_common_3[3]), hlds__make_hlds__add_pragma__add_pragma_tabling__STATE_VARIABLE_Attrs_134_134, &hlds__make_hlds__add_pragma__add_pragma_tabling__STATE_VARIABLE_Attrs_136_136);
          }
          {
...
{
  {
    ...
    {
      libs__globals__lookup_bool_option_3_p_0(hlds__make_hlds__add_pragma__add_pragma_tabling__Globals_28, (MR_Integer) 49, &hlds__make_hlds__add_pragma__add_pragma_tabling__VeryVerbose_39);
    }
    ...
    if (hlds__make_hlds__add_pragma__add_pragma_tabling__succeeded)
      {
        hlds__make_hlds__add_pragma__add_pragma_tabling__V_86_86 = (MR_Integer) 33;
        {
