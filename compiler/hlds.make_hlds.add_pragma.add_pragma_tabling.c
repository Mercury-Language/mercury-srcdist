...
{
  {
    ...
    if (succeeded)
    {
      Var_29 = ((MR_Word) (MR_hl_field(MR_mktag(2), EvalMethod0_16, (MR_Integer) 0)));
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_28, (MR_Integer) 233, &OwnStacks_30);
        switch (OwnStacks_30) {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_28, (MR_Integer) 58, &VeryVerbose_39);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_9, (MR_Integer) 265, &HighLevelCode_11);
