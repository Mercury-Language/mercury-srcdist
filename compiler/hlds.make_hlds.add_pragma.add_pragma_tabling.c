  ...
  else
  {
    ...
    if ((MaybeModes_35 == (MR_Word) ((MR_Unsigned) 0U)))
      ...
      else
      {
        ...
        hlds__make_hlds__add_pragma__add_pragma_tabling__set_eval_method_create_aux_preds_list_19_p_0(PredOrFunc_36, PredModuleName_18, PredName_19, UserArity_34, ProcIdsInfos_242, SingleProc_63, Context_21, TabledMethod_31, MaybeAttributes_20, ItemMercuryStatus_22, PredStatus_23, STATE_VARIABLE_ProcTable_68_258, &ProcTable_206, STATE_VARIABLE_ModuleInfo_69_259, &STATE_VARIABLE_ModuleInfo_151_151, STATE_VARIABLE_QualInfo_70_260, STATE_VARIABLE_QualInfo_69, STATE_VARIABLE_Specs_71_261, STATE_VARIABLE_Specs_71);
    ...
    case (MR_Integer) 1:
      {
        ...
        if ((PredIds0_33 == (MR_Word) ((MR_Unsigned) 0U)))
        {
          ...
          hlds__add_pred__add_implicit_pred_decl_report_error_14_p_0((MR_Integer) 1, PredModuleName_23, PredName_24, PredFormArity_30, PredStatus_14, (MR_Integer) 0, Context_12, Var_82, DescPieces_35, &PredId_36, STATE_VARIABLE_ModuleInfo_0_53, &STATE_VARIABLE_ModuleInfo_83_83, STATE_VARIABLE_Specs_0_57, &STATE_VARIABLE_Specs_84_84);
          {
            PredIds_37 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
