  ...
  MR_Word * STATE_VARIABLE_Specs_71)
{
  ...
  if (succeeded)
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_28, (MR_Integer) 270, &OwnStacks_30);
    switch (OwnStacks_30) {
  ...
  MR_Integer ProcId_7)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_9, (MR_Integer) 309, &HighLevelCode_11);
