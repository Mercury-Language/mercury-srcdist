  ...
  MR_Word * STATE_VARIABLE_Specs_74)
{
  ...
  if (succeeded)
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_30, (MR_Integer) 283, &OwnStacks_32);
    switch (OwnStacks_32) {
  ...
  MR_Integer ProcId_7)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_9, (MR_Integer) 322, &HighLevelCode_11);
