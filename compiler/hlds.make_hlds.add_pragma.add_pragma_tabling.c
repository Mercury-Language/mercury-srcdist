...
hlds__make_hlds__add_pragma__add_pragma_tabling__IntroducedFrom__pred__table_info_c_global_var_name__684__1_2_p_0(
  MR_Word Target_10,
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = hlds__make_hlds__add_pragma__add_pragma_tabling__IntroducedFrom__pred__table_info_c_global_var_name__684__1_2_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))));
  return succeeded;
}
  ...
  MR_Word * STATE_VARIABLE_Specs_58)
{
  ...
  switch (MR_tag((MR_Word) PFUMM_21)) {
    ...
    case (MR_Integer) 0:
      {
        MR_Word ModesOrArity_202 = ((MR_Word) ((MR_hl_field(MR_mktag(0), PFUMM_21, (MR_Integer) 0))));
        MR_Word PredFormArity_205;
        MR_Word UserArity_206;
        MR_Word PredIds0_207;

        if (((MR_tag((MR_Word) ModesOrArity_202)) == (MR_Integer) 1))
        {
          UserArity_206 = ((MR_Word) ((MR_hl_field(MR_mktag(1), ModesOrArity_202, (MR_Integer) 0))));
          parse_tree__prog_util__user_arity_pred_form_arity_3_p_0((MR_Integer) 0, UserArity_206, &PredFormArity_205);
        }
        else
        {
          MR_Word Modes_170 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ModesOrArity_202, (MR_Integer) 0))));

          PredFormArity_205 = parse_tree__prog_data__arg_list_arity_1_f_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_mode_0), Modes_170);
          parse_tree__prog_util__user_arity_pred_form_arity_3_p_1((MR_Integer) 0, &UserArity_206, PredFormArity_205);
        }
        UserArityInt_32 = (MR_Integer) (UserArity_206);
        hlds__pred_table__predicate_table_lookup_pf_m_n_a_7_p_0(PredicateTable0_26, (MR_Integer) 0, (MR_Integer) 0, PredModuleName_23, PredName_24, PredFormArity_205, &PredIds0_207);
        if ((PredIds0_207 == (MR_Word) ((MR_Unsigned) 0U)))
        {
          MR_String TabledMethodStr_174;
          MR_Word DescPieces_175;
          MR_Word PredId_176;
          MR_Word Var_177;
          MR_Word Var_183;

          TabledMethodStr_174 = parse_tree__prog_out__tabled_eval_method_to_string_1_f_0(TabledMethod_18);
          {
            Var_177 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(3), Var_177, 0) = ((MR_Box) ((MR_Unsigned) 29U));
            MR_hl_field(MR_mktag(3), Var_177, 1) = ((MR_Box) (TabledMethodStr_174));
          }
          {
            DescPieces_175 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), DescPieces_175, 0) = ((MR_Box) (Var_177));
            MR_hl_field(MR_mktag(1), DescPieces_175, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &hlds__make_hlds__add_pragma__add_pragma_tabling_scalar_common_1[2])));
          }
          {
            Var_183 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(3), Var_183, 0) = ((MR_Box) ((MR_Unsigned) 8U));
            MR_hl_field(MR_mktag(3), Var_183, 1) = ((MR_Box) (PredSymName_22));
          }
          hlds__add_pred__add_implicit_pred_decl_report_error_14_p_0((MR_Integer) 0, PredModuleName_23, PredName_24, PredFormArity_205, PredStatus_14, (MR_Integer) 0, Context_12, Var_183, DescPieces_175, &PredId_176, STATE_VARIABLE_ModuleInfo_0_53, &STATE_VARIABLE_ModuleInfo_69_69, STATE_VARIABLE_Specs_0_57, &STATE_VARIABLE_Specs_70_70);
          {
            PredIds_37 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), PredIds_37, 0) = ((MR_Box) (PredId_176));
            MR_hl_field(MR_mktag(1), PredIds_37, 1) = ((MR_Box) ((MR_Unsigned) 0U));
          }
        }
        else
        {
          PredIds_37 = PredIds0_207;
          STATE_VARIABLE_ModuleInfo_69_69 = STATE_VARIABLE_ModuleInfo_0_53;
          STATE_VARIABLE_Specs_70_70 = STATE_VARIABLE_Specs_0_57;
        }
      }
      break;
    case (MR_Integer) 1:
      {
        ...
        if ((PredIds0_33 == (MR_Word) ((MR_Unsigned) 0U)))
        {
          ...
          TabledMethodStr_34 = parse_tree__prog_out__tabled_eval_method_to_string_1_f_0(TabledMethod_18);
          {
            ...
            MR_hl_field(MR_mktag(3), Var_62, 1) = ((MR_Box) (TabledMethodStr_34));
          }
          {
            DescPieces_35 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), DescPieces_35, 0) = ((MR_Box) (Var_62));
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(3), Var_68, 1) = ((MR_Box) (PredSymName_22));
          }
          hlds__add_pred__add_implicit_pred_decl_report_error_14_p_0((MR_Integer) 1, PredModuleName_23, PredName_24, PredFormArity_30, PredStatus_14, (MR_Integer) 0, Context_12, Var_68, DescPieces_35, &PredId_36, STATE_VARIABLE_ModuleInfo_0_53, &STATE_VARIABLE_ModuleInfo_69_69, STATE_VARIABLE_Specs_0_57, &STATE_VARIABLE_Specs_70_70);
          {
            PredIds_37 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
    ...
    case (MR_Integer) 2:
      {
        ...
        hlds__make_hlds__add_pragma__maybe_warn_about_pfumm_unknown_7_p_0(STATE_VARIABLE_ModuleInfo_0_53, TabledMethodStr_149, PFUMM_21, PredSymName_22, Context_12, STATE_VARIABLE_Specs_0_57, &STATE_VARIABLE_Specs_72_72);
        ...
        if ((PredIds0_148 == (MR_Word) ((MR_Unsigned) 0U)))
        {
...

          {
            ...
            MR_hl_field(MR_mktag(3), Var_74, 1) = ((MR_Box) (TabledMethodStr_149));
          }
          {
            DescPieces_141 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), DescPieces_141, 0) = ((MR_Box) (Var_74));
          ...
          hlds__add_pred__add_implicit_pred_decl_report_error_14_p_0((MR_Integer) 0, PredModuleName_23, PredName_24, PredFormArity_140, PredStatus_14, (MR_Integer) 0, Context_12, Var_82, DescPieces_141, &PredId_142, STATE_VARIABLE_ModuleInfo_0_53, &STATE_VARIABLE_ModuleInfo_69_69, STATE_VARIABLE_Specs_72_72, &STATE_VARIABLE_Specs_70_70);
          {
            PredIds_37 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
  ...
  else
  {
    ...
    MR_Word Var_223 = ((MR_Word) ((MR_hl_field(MR_mktag(1), PredIds_37, (MR_Integer) 1))));
        ...
        case (MR_Integer) 0:
          {
            ...
            }
            {
              ...
              MR_hl_field(MR_mktag(1), StatsPieces_49, 1) = ((MR_Box) (Var_90));
            }
            {
            ...
            }
            {
              ...
              MR_hl_field(MR_mktag(1), STATE_VARIABLE_Specs_111_111, 0) = ((MR_Box) (StatsSpec_50));
        ...
        case (MR_Integer) 0:
          {
            ...
            }
            {
              ...
              MR_hl_field(MR_mktag(1), ResetPieces_51, 1) = ((MR_Box) (Var_114));
            }
            {
            ...
            }
            {
              ...
              MR_hl_field(MR_mktag(1), STATE_VARIABLE_Specs_135_135, 0) = ((MR_Box) (ResetSpec_52));
  ...
  mercury__list__foldl3_8_p_0((MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_id_0), (MR_Word) (&hlds__hlds_module__hlds__hlds_module__type_ctor_info_module_info_0), (MR_Word) (&hlds__make_hlds__qual_info__hlds__make_hlds__qual_info__type_ctor_info_qual_info_0), (MR_Word) (&hlds__make_hlds__add_pragma__add_pragma_tabling_scalar_common_1[0]), Var_136, PredIds_37, ((MR_Box) (STATE_VARIABLE_ModuleInfo_69_69)), &conv5_STATE_VARIABLE_ModuleInfo_54, ((MR_Box) (STATE_VARIABLE_QualInfo_0_55)), &conv4_STATE_VARIABLE_QualInfo_56, ((MR_Box) (STATE_VARIABLE_Specs_135_135)), &conv3_STATE_VARIABLE_Specs_58);
