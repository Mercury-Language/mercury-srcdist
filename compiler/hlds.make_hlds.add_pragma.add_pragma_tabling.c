...
{
  {
    ...
    {
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_28, (MR_Integer) 242, &OwnStacks_30);
        switch (OwnStacks_30) {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_28, (MR_Integer) 61, &VeryVerbose_39);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_9, (MR_Integer) 280, &HighLevelCode_11);
