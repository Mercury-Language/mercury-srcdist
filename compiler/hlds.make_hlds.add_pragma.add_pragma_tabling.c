...
{
  {
    ...
    {
      libs__globals__lookup_bool_option_3_p_0(hlds__make_hlds__add_pragma__add_pragma_tabling__Globals_9, (MR_Integer) 253, &hlds__make_hlds__add_pragma__add_pragma_tabling__HighLevelCode_11);
    }
    {
