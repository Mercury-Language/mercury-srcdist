...
{
  {
    ...
    {
      libs__globals__lookup_bool_option_3_p_0(hlds__make_hlds__add_pragma__add_pragma_tabling__Globals_9, (MR_Integer) 258, &hlds__make_hlds__add_pragma__add_pragma_tabling__HighLevelCode_11);
    }
    {
...
{
  {
    ...
    if (hlds__make_hlds__add_pragma__add_pragma_tabling__succeeded)
      {
        hlds__make_hlds__add_pragma__add_pragma_tabling__V_29_29 = ((MR_Word) (MR_hl_field(MR_mktag(2), hlds__make_hlds__add_pragma__add_pragma_tabling__EvalMethod0_16, (MR_Integer) 0)));
        {
          ...
          {
            libs__globals__lookup_bool_option_3_p_0(hlds__make_hlds__add_pragma__add_pragma_tabling__Globals_28, (MR_Integer) 226, &hlds__make_hlds__add_pragma__add_pragma_tabling__OwnStacks_30);
          }
    ...
    {
      libs__globals__lookup_bool_option_3_p_0(hlds__make_hlds__add_pragma__add_pragma_tabling__Globals_28, (MR_Integer) 53, &hlds__make_hlds__add_pragma__add_pragma_tabling__VeryVerbose_39);
    }
    ...
    if (hlds__make_hlds__add_pragma__add_pragma_tabling__succeeded)
      {
        hlds__make_hlds__add_pragma__add_pragma_tabling__V_86_86 = (MR_Integer) 37;
        {
