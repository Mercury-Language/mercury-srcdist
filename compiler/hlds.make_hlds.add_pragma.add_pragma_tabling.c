...
{
  {
    ...
    PredFormArityInt_35 = (MR_Integer) (Var_72);
    {
      ...
      MR_hl_field(MR_mktag(0), PFSymNameArity_36, 1) = ((MR_Box) (PredName_17));
      ...
      case (MR_Integer) 1:
        {
          ...
          IdStr_40 = parse_tree__prog_out__pf_sym_name_orig_arity_to_string_3_f_0(PredOrFunc_34, PredName_17, PredFormArityInt_35);
...
{
  {
    ...
    succeeded = hlds__make_hlds__add_pragma__add_pragma_tabling__IntroducedFrom__pred__table_info_c_global_var_name__710__1_2_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))));
    return succeeded;
  }
}
          ...
          case (MR_Integer) 0:
            {
              ...
              }
              {
                ...
                MR_hl_field(MR_mktag(1), StatsSpec_48, 2) = ((MR_Box) ((MR_Unsigned) 40U));
          ...
          case (MR_Integer) 0:
            {
              ...
              }
              {
                ...
                MR_hl_field(MR_mktag(1), ResetSpec_50, 2) = ((MR_Box) ((MR_Unsigned) 40U));
