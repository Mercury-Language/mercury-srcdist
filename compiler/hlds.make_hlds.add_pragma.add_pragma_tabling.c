...
{
  {
    ...
    if (succeeded)
    {
      packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), EvalMethod0_16, (MR_Integer) 0)));
      {
    ...
    if (succeeded)
    {
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(3), Var_95, 0) = ((MR_Box) ((MR_Unsigned) 17U));
      ...
      {
        InlineWarningMsg_45 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
      ...
      {
        InlineWarningSpec_46 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
    ...
    if (succeeded)
    {
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(3), Var_143, 0) = ((MR_Box) ((MR_Unsigned) 15U));
      ...
      if ((MaybeModes_20 == (MR_Word) ((MR_Unsigned) 0U)))
        if ((ExistingProcs_54 == (MR_Word) ((MR_Unsigned) 0U)))
        {
...

          {
            ...
            MR_hl_field(MR_mktag(3), Var_166, 0) = ((MR_Box) ((MR_Unsigned) 17U));
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(3), Var_171, 0) = ((MR_Box) ((MR_Unsigned) 15U));
          ...
          {
            Pieces_223 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      ...
      else
      {
        ...
        else
        {
...

          {
            ...
            MR_hl_field(MR_mktag(3), Var_194, 0) = ((MR_Box) ((MR_Unsigned) 17U));
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(3), Var_199, 0) = ((MR_Box) ((MR_Unsigned) 15U));
    ...
    if (succeeded)
    {
      ...
      if ((MaybeDeclaredArgModes_30 == (MR_Word) ((MR_Unsigned) 0U)))
      {
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(3), Var_105, 0) = ((MR_Box) ((MR_Unsigned) 15U));
      ...
      else
      {
        ...
        else
        {
          ...
          MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Attributes_36, (MR_Integer) 2)));

          Statistics_38 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Attributes_36, (MR_Integer) 2))) >> 1)) & (MR_Integer) 1);
          AllowReset_39 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Attributes_36, (MR_Integer) 2))) & (MR_Integer) 1);
            ...
            case (MR_Integer) 1:
              {
                ...
                MR_Unsigned packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), Strictness_199, (MR_Integer) 1)));
        ...
        else
        {
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(3), Var_67, 0) = ((MR_Box) ((MR_Unsigned) 15U));
          ...
          {
            Pieces_170 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          ...
          {
            Msg_171 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
          ...
          {
            Spec_172 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
    ...
    else
    {
      ...
      if (succeeded)
      {
...

        {
          ...
          MR_hl_field(MR_mktag(3), Var_126, 0) = ((MR_Box) ((MR_Unsigned) 15U));
        ...
        {
          Pieces_182 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      ...
      else
      {
        ...
        OldEvalMethodStr_47 = parse_tree__prog_out__eval_method_to_string_1_f_0(OldEvalMethod_29);
        {
          ...
          MR_hl_field(MR_mktag(3), Var_141, 0) = ((MR_Box) ((MR_Unsigned) 15U));
      ...
      {
        Msg_183 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
...
{
  {
    ...
    {
      TypeAndModeArg1_23 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
    ...
    {
      TypeAndModeArg2_24 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
    ...
    {
      TypeAndModeArgs_25 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
    ...
    {
      Origin_26 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(3), Origin_26, 0) = ((MR_Box) ((MR_Unsigned) 4U));
      MR_hl_field(MR_mktag(3), Origin_26, 1) = ((MR_Box) (SimpleCallId_16));
      MR_hl_field(MR_mktag(3), Origin_26, 2) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 1));
    }
      ...
      case (MR_Integer) 0:
        {
          ...
          {
            Args_48 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), Args_48, 0) = ((MR_Box) (Var_79));
            MR_hl_field(MR_mktag(1), Args_48, 1) = ((MR_Box) (Var_80));
          }
          {
            BodyExpr_49 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
            ...
            MR_hl_field(MR_mktag(0), BodyExpr_49, 3) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 0));
          }
          {
      ...
      case (MR_Integer) 1:
        {
          ...
          {
            ResetPragmaFCInfo_47 = (MR_Word) MR_new_object(MR_Word, (7 * sizeof(MR_Word)), NULL, NULL);
            ...
            MR_hl_field(MR_mktag(0), ResetPragmaFCInfo_47, 2) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 0));
...
{
  {
    ...
    MR_String Var_28;
    MR_String Var_30;
    MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), SimpleCallId_5, (MR_Integer) 0)));
...
{
  {
    ...
    {
      StatsTypeName_24 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
    ...
    {
      StatsType_25 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
    ...
    {
      TypeAndModeArg3_28 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
    ...
    {
      TypeAndModeArgs_29 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
    ...
    {
      Origin_30 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(3), Origin_30, 0) = ((MR_Box) ((MR_Unsigned) 4U));
      MR_hl_field(MR_mktag(3), Origin_30, 1) = ((MR_Box) (SimpleCallId_16));
      MR_hl_field(MR_mktag(3), Origin_30, 2) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 0));
    }
      ...
      case (MR_Integer) 0:
        {
          ...
          {
            DummyStatsFuncSymName_54 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          ...
          {
            Args_56 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), Args_56, 0) = ((MR_Box) (Var_100));
            MR_hl_field(MR_mktag(1), Args_56, 1) = ((MR_Box) (Var_101));
          }
          {
            GetStatsExpr_57 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
            ...
            MR_hl_field(MR_mktag(0), GetStatsExpr_57, 3) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 0));
          }
          {
            UpdateIOExpr_58 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
            ...
            MR_hl_field(MR_mktag(0), UpdateIOExpr_58, 3) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 0));
          }
          {
            GetStatsUpdateIOExpr_59 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
          ...
          {
            BodyExpr_60 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(3), BodyExpr_60, 0) = ((MR_Box) ((MR_Unsigned) 7U));
            MR_hl_field(MR_mktag(3), BodyExpr_60, 1) = ((MR_Box) (Context_15));
            MR_hl_field(MR_mktag(3), BodyExpr_60, 2) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 0));
      ...
      case (MR_Integer) 1:
        {
          ...
          {
            StatsPragmaFCInfo_53 = (MR_Word) MR_new_object(MR_Word, (7 * sizeof(MR_Word)), NULL, NULL);
            ...
            MR_hl_field(MR_mktag(0), StatsPragmaFCInfo_53, 2) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 0));
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_9, (MR_Integer) 275, &HighLevelCode_11);
    hlds__hlds_module__module_info_get_name_2_p_0(ModuleInfo_5, &ModuleName_12);
    packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), SimpleCallId_6, (MR_Integer) 0)));
    ...
    else
    {
      ...
      if ((PredIds0_27 == (MR_Word) ((MR_Unsigned) 0U)))
      {
        ...
        hlds__hlds_module__module_info_get_name_2_p_0(STATE_VARIABLE_ModuleInfo_0_49, &ModuleName_28);
        {
          ...
          MR_hl_field(MR_mktag(3), Var_68, 0) = ((MR_Box) ((MR_Unsigned) 17U));
          ...
          case (MR_Integer) 0:
            {
              ...
              {
                StatsMsg_44 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
              ...
              {
                StatsSpec_45 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
          ...
          case (MR_Integer) 0:
            {
              ...
              {
                ResetPieces_46 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              ...
              {
                ResetMsg_47 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
              ...
              {
                ResetSpec_48 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
