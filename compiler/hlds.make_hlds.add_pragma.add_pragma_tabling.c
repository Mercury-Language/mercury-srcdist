...
{
  {
    ...
    if (succeeded)
    {
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals_26, (MR_Integer) 262, &OwnStacks_28);
      switch (OwnStacks_28) {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_26, (MR_Integer) 70, &VeryVerbose_40);
