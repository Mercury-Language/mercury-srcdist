...
hlds__make_hlds__add_pragma__add_pragma_tabling__IntroducedFrom__pred__table_info_c_global_var_name__690__1_2_p_0(
  MR_Word Target_10,
  ...
  MR_Word * STATE_VARIABLE_Specs_71)
{
  ...
  if (succeeded)
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_28, (MR_Integer) 265, &OwnStacks_30);
    switch (OwnStacks_30) {
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_28, (MR_Integer) 72, &VeryVerbose_41);
  ...
  else
  {
    ...
    if ((MaybeModes_35 == (MR_Word) ((MR_Unsigned) 0U)))
      if ((ExistingProcs_55 == (MR_Word) ((MR_Unsigned) 0U)))
      {
...

        {
          ...
          MR_hl_field(MR_mktag(3), Var_178, 0) = ((MR_Box) ((MR_Unsigned) 29U));
          MR_hl_field(MR_mktag(3), Var_178, 1) = ((MR_Box) (TabledMethodStr_40));
        }
        {
          Var_183 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(3), Var_183, 0) = ((MR_Box) ((MR_Unsigned) 14U));
          MR_hl_field(MR_mktag(3), Var_183, 1) = ((MR_Box) (PFSymNameArity_39));
        }
        {
          ...
          MR_hl_field(MR_mktag(1), Var_182, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &hlds__make_hlds__add_pragma__add_pragma_tabling_scalar_common_1[42])));
        }
        {
          Var_179 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), Var_179, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__add_pragma__add_pragma_tabling_scalar_common_1[40])));
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(1), Pieces_204, 1) = ((MR_Box) (Var_177));
        }
        {
      ...
      else
      {
        ...
        hlds__make_hlds__add_pragma__add_pragma_tabling__set_eval_method_create_aux_preds_list_19_p_0(PredOrFunc_36, PredModuleName_18, PredName_19, UserArity_34, ExistingProcs_55, SingleProc_63, Context_21, TabledMethod_31, MaybeAttributes_20, ItemMercuryStatus_22, PredStatus_23, ProcTable0_54, &ProcTable_206, STATE_VARIABLE_ModuleInfo_150_150, &STATE_VARIABLE_ModuleInfo_194_194, STATE_VARIABLE_QualInfo_0_68, STATE_VARIABLE_QualInfo_69, STATE_VARIABLE_Specs_130_130, STATE_VARIABLE_Specs_71);
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        hlds__make_hlds__add_pragma__add_pragma_tabling__set_eval_method_create_aux_preds_20_p_0(PredOrFunc_36, PredModuleName_18, PredName_19, UserArity_34, ProcId_57, ProcInfo0_58, (MR_Integer) 1, Context_21, TabledMethod_31, MaybeAttributes_20, ItemMercuryStatus_22, PredStatus_23, ProcTable0_54, &ProcTable_59, STATE_VARIABLE_ModuleInfo_150_150, &STATE_VARIABLE_ModuleInfo_152_152, STATE_VARIABLE_QualInfo_0_68, STATE_VARIABLE_QualInfo_69, STATE_VARIABLE_Specs_130_130, STATE_VARIABLE_Specs_71);
        hlds__hlds_pred__pred_info_set_proc_table_3_p_0(ProcTable_59, PredInfo0_32, &PredInfo_60);
        hlds__hlds_module__module_info_set_pred_info_4_p_0(PredId_24, PredInfo_60, STATE_VARIABLE_ModuleInfo_152_152, STATE_VARIABLE_ModuleInfo_67);
      }
      else
      {
        MR_Word Var_158;
...

        {
          ...
          MR_hl_field(MR_mktag(3), Var_159, 0) = ((MR_Box) ((MR_Unsigned) 29U));
          MR_hl_field(MR_mktag(3), Var_159, 1) = ((MR_Box) (TabledMethodStr_40));
        }
        {
          Var_164 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(3), Var_164, 0) = ((MR_Box) ((MR_Unsigned) 14U));
          MR_hl_field(MR_mktag(3), Var_164, 1) = ((MR_Box) (PFSymNameArity_39));
        }
        {
          ...
          MR_hl_field(MR_mktag(1), Var_163, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &hlds__make_hlds__add_pragma__add_pragma_tabling_scalar_common_1[39])));
        }
        {
          Var_160 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), Var_160, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__add_pragma__add_pragma_tabling_scalar_common_1[44])));
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(1), Pieces_198, 1) = ((MR_Box) (Var_158));
        }
        {
  ...
  if ((OldEvalMethod_37 == (MR_Word) ((MR_Unsigned) 0U)))
  {
    ...
    if ((MaybeDeclaredArgModes_40 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      ...
      TabledMethodStr_41 = parse_tree__prog_out__tabled_eval_method_to_pragma_name_1_f_0(TabledMethod_29);
      {
        ...
        MR_hl_field(MR_mktag(3), Var_72, 1) = ((MR_Box) (TabledMethodStr_41));
      }
      {
        ...
        MR_hl_field(MR_mktag(3), Var_77, 1) = ((MR_Box) (PFSymNameArity_39));
      }
      {
        Var_76 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), Var_76, 0) = ((MR_Box) (Var_77));
        MR_hl_field(MR_mktag(1), Var_76, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &hlds__make_hlds__add_pragma__add_pragma_tabling_scalar_common_1[47])));
      }
      {
        Var_73 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), Var_73, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__add_pragma__add_pragma_tabling_scalar_common_1[40])));
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(1), Pieces_42, 1) = ((MR_Box) (Var_71));
      }
      {
    ...
    else
    {
      ...
      else
      {
        ...
        TabledMethodStr_162 = parse_tree__prog_out__tabled_eval_method_to_pragma_name_1_f_0(TabledMethod_29);
        {
          ...
          MR_hl_field(MR_mktag(3), Var_96, 0) = ((MR_Box) ((MR_Unsigned) 29U));
          MR_hl_field(MR_mktag(3), Var_96, 1) = ((MR_Box) (TabledMethodStr_162));
        }
        {
          Var_101 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(3), Var_101, 0) = ((MR_Box) ((MR_Unsigned) 14U));
          MR_hl_field(MR_mktag(3), Var_101, 1) = ((MR_Box) (PFSymNameArity_39));
        }
        {
          Var_105 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), Var_105, 0) = ((MR_Box) ((MR_Unsigned) 4U));
          MR_hl_field(MR_mktag(1), Var_105, 1) = ((MR_Box) (ArgErrorPieces_51));
        }
        {
          Var_102 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), Var_102, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__add_pragma__add_pragma_tabling_scalar_common_1[49])));
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(1), Var_97, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__add_pragma__add_pragma_tabling_scalar_common_1[40])));
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(1), Pieces_163, 1) = ((MR_Box) (Var_95));
        }
        {
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(1), STATE_VARIABLE_Specs_110_110, 0) = ((MR_Box) (Spec_164));
          MR_hl_field(MR_mktag(1), STATE_VARIABLE_Specs_110_110, 1) = ((MR_Box) (STATE_VARIABLE_Specs_0_67));
        }
      }
      {
  ...
  else
  {
    ...
    if (succeeded)
    {
...

      {
        ...
        MR_hl_field(MR_mktag(3), Var_123, 0) = ((MR_Box) ((MR_Unsigned) 14U));
        MR_hl_field(MR_mktag(3), Var_123, 1) = ((MR_Box) (PFSymNameArity_39));
      }
      {
        Var_128 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(2), Var_128, 0) = ((MR_Box) (TabledMethodStr_171));
      }
      {
        ...
        MR_hl_field(MR_mktag(1), Var_127, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &hlds__make_hlds__add_pragma__add_pragma_tabling_scalar_common_1[52])));
      }
      {
        Var_124 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), Var_124, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__add_pragma__add_pragma_tabling_scalar_common_1[50])));
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(1), Pieces_172, 1) = ((MR_Box) (Var_122));
      }
    }
    else
    {
      ...
      OldTabledMethodStr_60 = parse_tree__prog_out__tabled_eval_method_to_pragma_name_1_f_0(OldTabledMethod_59);
      {
        ...
        MR_hl_field(MR_mktag(3), Var_138, 0) = ((MR_Box) ((MR_Unsigned) 14U));
        MR_hl_field(MR_mktag(3), Var_138, 1) = ((MR_Box) (PFSymNameArity_39));
      }
      {
        Var_143 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(2), Var_143, 0) = ((MR_Box) (OldTabledMethodStr_60));
      }
      {
        Var_148 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(2), Var_148, 0) = ((MR_Box) (TabledMethodStr_171));
      }
      {
        ...
        MR_hl_field(MR_mktag(1), Var_147, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &hlds__make_hlds__add_pragma__add_pragma_tabling_scalar_common_1[57])));
      }
      {
        Var_144 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), Var_144, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__add_pragma__add_pragma_tabling_scalar_common_1[54])));
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(1), Var_139, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__add_pragma__add_pragma_tabling_scalar_common_1[53])));
      ...
      }
      {
        Pieces_172 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), Pieces_172, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__add_pragma__add_pragma_tabling_scalar_common_1[43])));
        MR_hl_field(MR_mktag(1), Pieces_172, 1) = ((MR_Box) (Var_137));
      }
    }
    {
        ...
        if (succeeded)
          if ((MaybeArgMethod_32 == (MR_Word) ((MR_Unsigned) 0U)))
          {
            ...
            }
            {
              ...
              MR_hl_field(MR_mktag(1), Var_49, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &hlds__make_hlds__add_pragma__add_pragma_tabling_scalar_common_1[65])));
            }
            {
              Var_46 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), Var_46, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__add_pragma__add_pragma_tabling_scalar_common_1[63])));
              MR_hl_field(MR_mktag(1), Var_46, 1) = ((MR_Box) (Var_49));
            }
            {
              Var_43 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), Var_43, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__add_pragma__add_pragma_tabling_scalar_common_1[49])));
          ...
          if (succeeded)
            ...
            else
            {
              ...
              }
              {
                ...
                MR_hl_field(MR_mktag(1), Var_68, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &hlds__make_hlds__add_pragma__add_pragma_tabling_scalar_common_1[67])));
              }
              {
                Var_65 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(1), Var_65, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__add_pragma__add_pragma_tabling_scalar_common_1[63])));
                MR_hl_field(MR_mktag(1), Var_65, 1) = ((MR_Box) (Var_68));
              }
              {
                Var_62 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(1), Var_62, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__add_pragma__add_pragma_tabling_scalar_common_1[49])));
  ...
  MR_Word * STATE_VARIABLE_Specs_72)
{
  ...
  Var_74 = hlds__hlds_pred__proc_id_to_int_1_f_0(ProcId_23);
  {
    ...
    MR_hl_field(MR_mktag(2), Transform_33, 3) = ((MR_Box) (Var_74));
  }
  ...
  Var_76 = parse_tree__prog_mode__di_mode_0_f_0();
  {
    ...
    MR_hl_field(MR_mktag(1), TypeAndModeArg1_36, 0) = ((MR_Box) (Var_75));
    MR_hl_field(MR_mktag(1), TypeAndModeArg1_36, 1) = ((MR_Box) (Var_76));
  }
  ...
  Var_78 = parse_tree__prog_mode__uo_mode_0_f_0();
  {
    ...
    MR_hl_field(MR_mktag(1), TypeAndModeArg2_37, 0) = ((MR_Box) (Var_77));
    MR_hl_field(MR_mktag(1), TypeAndModeArg2_37, 1) = ((MR_Box) (Var_78));
  }
  {
    Var_79 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(MR_mktag(1), Var_79, 0) = ((MR_Box) (TypeAndModeArg2_37));
  ...
  }
  {
    ...
    MR_hl_field(MR_mktag(1), ArgTypesAndModes_38, 1) = ((MR_Box) (Var_79));
  }
  ...
  }
  {
    ...
    MR_hl_field(MR_mktag(0), PredSpec_44, 0) = (MR_Box) ((MR_Unsigned) (PredOrFunc_19));
    MR_hl_field(MR_mktag(0), PredSpec_44, 1) = ((MR_Box) (PredSymName_43));
    MR_hl_field(MR_mktag(0), PredSpec_44, 2) = ((MR_Box) (UserArity_22));
  }
  {
    ...
    MR_hl_field(MR_mktag(3), Var_83, 1) = ((MR_Box) (PredSpec_44));
    MR_hl_field(MR_mktag(3), Var_83, 2) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 1));
  }
  ...
  }
  {
    ...
    MR_hl_field(MR_mktag(0), PredDecl_47, 0) = ((MR_Box) (ResetPredSymName_35));
    MR_hl_field(MR_mktag(0), PredDecl_47, 1) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 0));
    MR_hl_field(MR_mktag(0), PredDecl_47, 2) = ((MR_Box) (ArgTypesAndModes_38));
    MR_hl_field(MR_mktag(0), PredDecl_47, 3) = ((MR_Box) ((MR_Unsigned) 0U));
    MR_hl_field(MR_mktag(0), PredDecl_47, 4) = ((MR_Box) ((MR_Unsigned) 0U));
    MR_hl_field(MR_mktag(0), PredDecl_47, 5) = ((MR_Box) (MR_mkword(MR_mktag(1), &hlds__make_hlds__add_pragma__add_pragma_tabling_scalar_common_2[2])));
    MR_hl_field(MR_mktag(0), PredDecl_47, 6) = ((MR_Box) (MaybeAttrs_46));
    MR_hl_field(MR_mktag(0), PredDecl_47, 7) = ((MR_Box) (TypeVarSet_39));
    MR_hl_field(MR_mktag(0), PredDecl_47, 8) = ((MR_Box) (InstVarSet_40));
    MR_hl_field(MR_mktag(0), PredDecl_47, 9) = ((MR_Box) ((MR_Unsigned) 0U));
    MR_hl_field(MR_mktag(0), PredDecl_47, 10) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 0));
    MR_hl_field(MR_mktag(0), PredDecl_47, 11) = ((MR_Box) (&hlds__make_hlds__add_pragma__add_pragma_tabling_scalar_common_1[58]));
    MR_hl_field(MR_mktag(0), PredDecl_47, 12) = ((MR_Box) (Context_25));
  ...
  parse_tree__prog_util__user_arity_pred_form_arity_3_p_0(PredOrFunc_19, UserArity_22, &PredFormArity_49);
  {
    ...
    MR_hl_field(MR_mktag(0), PFSymNameArity_50, 0) = (MR_Box) ((MR_Unsigned) (PredOrFunc_19));
    MR_hl_field(MR_mktag(0), PFSymNameArity_50, 1) = ((MR_Box) (PredSymName_43));
    MR_hl_field(MR_mktag(0), PFSymNameArity_50, 2) = ((MR_Box) (PredFormArity_49));
  }
    ...
    case (MR_Integer) 0:
      {
...

        {
          ...
          MR_hl_field(MR_mktag(1), Var_126, 0) = ((MR_Box) (IO0_52));
          MR_hl_field(MR_mktag(1), Var_126, 1) = ((MR_Box) (Context_25));
        }
        {
          Var_128 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), Var_128, 0) = ((MR_Box) (IO_53));
          MR_hl_field(MR_mktag(1), Var_128, 1) = ((MR_Box) (Context_25));
        }
        {
          Var_127 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), Var_127, 0) = ((MR_Box) (Var_128));
        ...
        {
          Args_61 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), Args_61, 0) = ((MR_Box) (Var_126));
          MR_hl_field(MR_mktag(1), Args_61, 1) = ((MR_Box) (Var_127));
        }
        {
          BodyExpr_62 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), BodyExpr_62, 0) = ((MR_Box) (Context_25));
          MR_hl_field(MR_mktag(0), BodyExpr_62, 1) = ((MR_Box) (Var_126));
          MR_hl_field(MR_mktag(0), BodyExpr_62, 2) = ((MR_Box) (Var_128));
          MR_hl_field(MR_mktag(0), BodyExpr_62, 3) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 0));
        }
        {
          Var_134 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), Var_134, 0) = ((MR_Box) (BodyExpr_62));
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(0), ResetClauseInfo_63, 0) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 0));
          MR_hl_field(MR_mktag(0), ResetClauseInfo_63, 1) = ((MR_Box) (ResetPredSymName_35));
          MR_hl_field(MR_mktag(0), ResetClauseInfo_63, 2) = ((MR_Box) (Args_61));
          MR_hl_field(MR_mktag(0), ResetClauseInfo_63, 3) = ((MR_Box) (STATE_VARIABLE_VarSet_99_99));
          MR_hl_field(MR_mktag(0), ResetClauseInfo_63, 4) = ((MR_Box) (Var_134));
          MR_hl_field(MR_mktag(0), ResetClauseInfo_63, 5) = ((MR_Box) (Context_25));
          MR_hl_field(MR_mktag(0), ResetClauseInfo_63, 6) = ((MR_Box) ((MR_Unsigned) 0U));
        }
    ...
    case (MR_Integer) 1:
      {
        ...
        Var_101 = parse_tree__prog_mode__di_mode_0_f_0();
        {
          ...
          MR_hl_field(MR_mktag(0), Arg1_54, 0) = ((MR_Box) (IO0_52));
          MR_hl_field(MR_mktag(0), Arg1_54, 1) = ((MR_Box) ((MR_String) "_IO0"));
          MR_hl_field(MR_mktag(0), Arg1_54, 2) = ((MR_Box) (Var_101));
          MR_hl_field(MR_mktag(0), Arg1_54, 3) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 1));
        }
        Var_104 = parse_tree__prog_mode__uo_mode_0_f_0();
        {
          Arg2_55 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), Arg2_55, 0) = ((MR_Box) (IO_53));
          MR_hl_field(MR_mktag(0), Arg2_55, 1) = ((MR_Box) ((MR_String) "_IO"));
          MR_hl_field(MR_mktag(0), Arg2_55, 2) = ((MR_Box) (Var_104));
          MR_hl_field(MR_mktag(0), Arg2_55, 3) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 1));
        }
        ...
        ResetCode_57 = mercury__string__f_43_43_2_f_0(GlobalVarName_56, (MR_String) ".MR_pt_tablenode.MR_integer = 0;");
        {
          ...
          MR_hl_field(MR_mktag(1), Var_118, 0) = ((MR_Box) (Context_25));
        }
        {
          ResetImpl_58 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), ResetImpl_58, 0) = ((MR_Box) (ResetCode_57));
          MR_hl_field(MR_mktag(0), ResetImpl_58, 1) = ((MR_Box) (Var_118));
        }
        {
          Var_121 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), Var_121, 0) = ((MR_Box) (Arg2_55));
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(1), Var_120, 0) = ((MR_Box) (Arg1_54));
          MR_hl_field(MR_mktag(1), Var_120, 1) = ((MR_Box) (Var_121));
        }
        {
          ResetFCInfo_59 = (MR_Word) MR_new_object(MR_Word, (7 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), ResetFCInfo_59, 0) = ((MR_Box) (STATE_VARIABLE_Attrs_115_115));
          MR_hl_field(MR_mktag(0), ResetFCInfo_59, 1) = ((MR_Box) (ResetPredSymName_35));
          MR_hl_field(MR_mktag(0), ResetFCInfo_59, 2) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 0));
          MR_hl_field(MR_mktag(0), ResetFCInfo_59, 3) = ((MR_Box) (Var_120));
          MR_hl_field(MR_mktag(0), ResetFCInfo_59, 4) = ((MR_Box) (STATE_VARIABLE_VarSet_99_99));
          MR_hl_field(MR_mktag(0), ResetFCInfo_59, 5) = ((MR_Box) (InstVarSet_40));
          MR_hl_field(MR_mktag(0), ResetFCInfo_59, 6) = ((MR_Box) (ResetImpl_58));
        }
        {
          PragmaResetFCInfo_60 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), PragmaResetFCInfo_60, 0) = ((MR_Box) (ResetFCInfo_59));
          MR_hl_field(MR_mktag(0), PragmaResetFCInfo_60, 1) = ((MR_Box) (Context_25));
          MR_hl_field(MR_mktag(0), PragmaResetFCInfo_60, 2) = ((MR_Box) ((MR_Unsigned) 0U));
        }
  ...
  MR_Word * STATE_VARIABLE_Specs_83)
{
  ...
  Var_85 = hlds__hlds_pred__proc_id_to_int_1_f_0(ProcId_23);
  {
    ...
    MR_hl_field(MR_mktag(2), Transform_33, 3) = ((MR_Box) (Var_85));
  }
  ...
  Var_89 = parse_tree__prog_mode__out_mode_0_f_0();
  {
    ...
    MR_hl_field(MR_mktag(1), TypeAndModeArg1_39, 1) = ((MR_Box) (Var_89));
  }
  ...
  Var_91 = parse_tree__prog_mode__di_mode_0_f_0();
  {
    ...
    MR_hl_field(MR_mktag(1), TypeAndModeArg2_40, 0) = ((MR_Box) (Var_90));
    MR_hl_field(MR_mktag(1), TypeAndModeArg2_40, 1) = ((MR_Box) (Var_91));
  }
  ...
  Var_93 = parse_tree__prog_mode__uo_mode_0_f_0();
  {
    ...
    MR_hl_field(MR_mktag(1), TypeAndModeArg3_41, 0) = ((MR_Box) (Var_92));
    MR_hl_field(MR_mktag(1), TypeAndModeArg3_41, 1) = ((MR_Box) (Var_93));
  }
  {
    Var_95 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(MR_mktag(1), Var_95, 0) = ((MR_Box) (TypeAndModeArg3_41));
    MR_hl_field(MR_mktag(1), Var_95, 1) = ((MR_Box) ((MR_Unsigned) 0U));
  }
  {
    Var_94 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(MR_mktag(1), Var_94, 0) = ((MR_Box) (TypeAndModeArg2_40));
  ...
  }
  {
    ...
    MR_hl_field(MR_mktag(1), ArgTypesAndModes_42, 1) = ((MR_Box) (Var_94));
  }
  ...
  }
  {
    ...
    MR_hl_field(MR_mktag(0), PredSpec_48, 0) = (MR_Box) ((MR_Unsigned) (PredOrFunc_19));
    MR_hl_field(MR_mktag(0), PredSpec_48, 1) = ((MR_Box) (PredSymName_47));
    MR_hl_field(MR_mktag(0), PredSpec_48, 2) = ((MR_Box) (UserArity_22));
  }
  {
    ...
    MR_hl_field(MR_mktag(3), Var_99, 1) = ((MR_Box) (PredSpec_48));
    MR_hl_field(MR_mktag(3), Var_99, 2) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 0));
  }
  Attrs_49 = (MR_Word) (Var_99);
  {
    MaybeAttrs_50 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(MR_mktag(1), MaybeAttrs_50, 0) = ((MR_Box) (Attrs_49));
  }
  {
    PredDecl_51 = (MR_Word) MR_new_object(MR_Word, (14 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(MR_mktag(0), PredDecl_51, 0) = ((MR_Box) (StatsPredSymName_35));
    MR_hl_field(MR_mktag(0), PredDecl_51, 1) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 0));
    MR_hl_field(MR_mktag(0), PredDecl_51, 2) = ((MR_Box) (ArgTypesAndModes_42));
    MR_hl_field(MR_mktag(0), PredDecl_51, 3) = ((MR_Box) ((MR_Unsigned) 0U));
    MR_hl_field(MR_mktag(0), PredDecl_51, 4) = ((MR_Box) ((MR_Unsigned) 0U));
    MR_hl_field(MR_mktag(0), PredDecl_51, 5) = ((MR_Box) (MR_mkword(MR_mktag(1), &hlds__make_hlds__add_pragma__add_pragma_tabling_scalar_common_2[2])));
    MR_hl_field(MR_mktag(0), PredDecl_51, 6) = ((MR_Box) (MaybeAttrs_50));
    MR_hl_field(MR_mktag(0), PredDecl_51, 7) = ((MR_Box) (TypeVarSet_43));
    MR_hl_field(MR_mktag(0), PredDecl_51, 8) = ((MR_Box) (InstVarSet_44));
    MR_hl_field(MR_mktag(0), PredDecl_51, 9) = ((MR_Box) ((MR_Unsigned) 0U));
    MR_hl_field(MR_mktag(0), PredDecl_51, 10) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 0));
    MR_hl_field(MR_mktag(0), PredDecl_51, 11) = ((MR_Box) (&hlds__make_hlds__add_pragma__add_pragma_tabling_scalar_common_1[58]));
    MR_hl_field(MR_mktag(0), PredDecl_51, 12) = ((MR_Box) (Context_25));
    MR_hl_field(MR_mktag(0), PredDecl_51, 13) = ((MR_Box) ((MR_Unsigned) 0U));
  }
  ...
  parse_tree__prog_util__user_arity_pred_form_arity_3_p_0(PredOrFunc_19, UserArity_22, &PredFormArity_53);
  {
    ...
    MR_hl_field(MR_mktag(0), PFSymNameArity_54, 0) = (MR_Box) ((MR_Unsigned) (PredOrFunc_19));
    MR_hl_field(MR_mktag(0), PFSymNameArity_54, 1) = ((MR_Box) (PredSymName_47));
    MR_hl_field(MR_mktag(0), PFSymNameArity_54, 2) = ((MR_Box) (PredFormArity_53));
  }
    ...
    case (MR_Integer) 0:
      {
        ...
        {
          DummyStatsFuncSymName_67 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), DummyStatsFuncSymName_67, 0) = ((MR_Box) (Var_150));
          MR_hl_field(MR_mktag(1), DummyStatsFuncSymName_67, 1) = ((MR_Box) ((MR_String) "dummy_proc_table_statistics"));
        }
        mdbcomp__sym_name__sym_name_to_term_4_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), Context_25, DummyStatsFuncSymName_67, (MR_Word) ((MR_Unsigned) 0U), &DummyStatsFuncTerm_68);
        {
          ...
          MR_hl_field(MR_mktag(1), Var_153, 0) = ((MR_Box) (Stats_56));
          MR_hl_field(MR_mktag(1), Var_153, 1) = ((MR_Box) (Context_25));
        }
        {
          Var_155 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), Var_155, 0) = ((MR_Box) (IO0_57));
          MR_hl_field(MR_mktag(1), Var_155, 1) = ((MR_Box) (Context_25));
        }
        {
          Var_157 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), Var_157, 0) = ((MR_Box) (IO_58));
          MR_hl_field(MR_mktag(1), Var_157, 1) = ((MR_Box) (Context_25));
        }
        {
        ...
        {
          Args_69 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), Args_69, 0) = ((MR_Box) (Var_153));
          MR_hl_field(MR_mktag(1), Args_69, 1) = ((MR_Box) (Var_154));
        }
        {
          GetStatsExpr_70 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), GetStatsExpr_70, 0) = ((MR_Box) (Context_25));
          MR_hl_field(MR_mktag(0), GetStatsExpr_70, 1) = ((MR_Box) (Var_153));
          MR_hl_field(MR_mktag(0), GetStatsExpr_70, 2) = ((MR_Box) (DummyStatsFuncTerm_68));
          MR_hl_field(MR_mktag(0), GetStatsExpr_70, 3) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 0));
        }
        {
          UpdateIOExpr_71 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), UpdateIOExpr_71, 0) = ((MR_Box) (Context_25));
          MR_hl_field(MR_mktag(0), UpdateIOExpr_71, 1) = ((MR_Box) (Var_155));
          MR_hl_field(MR_mktag(0), UpdateIOExpr_71, 2) = ((MR_Box) (Var_157));
          MR_hl_field(MR_mktag(0), UpdateIOExpr_71, 3) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 0));
        }
        {
          Var_164 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), Var_164, 0) = ((MR_Box) (UpdateIOExpr_71));
          MR_hl_field(MR_mktag(1), Var_164, 1) = ((MR_Box) ((MR_Unsigned) 0U));
        }
        {
          GetStatsUpdateIOExpr_72 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(2), GetStatsUpdateIOExpr_72, 0) = ((MR_Box) (Context_25));
          MR_hl_field(MR_mktag(2), GetStatsUpdateIOExpr_72, 1) = ((MR_Box) (GetStatsExpr_70));
          MR_hl_field(MR_mktag(2), GetStatsUpdateIOExpr_72, 2) = ((MR_Box) (Var_164));
        }
        {
          BodyExpr_73 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(3), BodyExpr_73, 0) = ((MR_Box) ((MR_Unsigned) 7U));
          MR_hl_field(MR_mktag(3), BodyExpr_73, 1) = ((MR_Box) (Context_25));
          MR_hl_field(MR_mktag(3), BodyExpr_73, 2) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 0));
          MR_hl_field(MR_mktag(3), BodyExpr_73, 3) = ((MR_Box) (GetStatsUpdateIOExpr_72));
        }
        {
          Var_168 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), Var_168, 0) = ((MR_Box) (BodyExpr_73));
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(0), StatsClauseInfo_74, 0) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 0));
          MR_hl_field(MR_mktag(0), StatsClauseInfo_74, 1) = ((MR_Box) (StatsPredSymName_35));
          MR_hl_field(MR_mktag(0), StatsClauseInfo_74, 2) = ((MR_Box) (Args_69));
          MR_hl_field(MR_mktag(0), StatsClauseInfo_74, 3) = ((MR_Box) (STATE_VARIABLE_VarSet_117_117));
          MR_hl_field(MR_mktag(0), StatsClauseInfo_74, 4) = ((MR_Box) (Var_168));
          MR_hl_field(MR_mktag(0), StatsClauseInfo_74, 5) = ((MR_Box) (Context_25));
          MR_hl_field(MR_mktag(0), StatsClauseInfo_74, 6) = ((MR_Box) ((MR_Unsigned) 0U));
        }
    ...
    case (MR_Integer) 1:
      {
        ...
        Var_119 = parse_tree__prog_mode__out_mode_0_f_0();
        {
          ...
          MR_hl_field(MR_mktag(0), Arg1_59, 0) = ((MR_Box) (Stats_56));
          MR_hl_field(MR_mktag(0), Arg1_59, 1) = ((MR_Box) ((MR_String) "Stats"));
          MR_hl_field(MR_mktag(0), Arg1_59, 2) = ((MR_Box) (Var_119));
          MR_hl_field(MR_mktag(0), Arg1_59, 3) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 1));
        }
        Var_122 = parse_tree__prog_mode__di_mode_0_f_0();
        {
          Arg2_60 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), Arg2_60, 0) = ((MR_Box) (IO0_57));
          MR_hl_field(MR_mktag(0), Arg2_60, 1) = ((MR_Box) ((MR_String) "_IO0"));
          MR_hl_field(MR_mktag(0), Arg2_60, 2) = ((MR_Box) (Var_122));
          MR_hl_field(MR_mktag(0), Arg2_60, 3) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 1));
        }
        Var_125 = parse_tree__prog_mode__uo_mode_0_f_0();
        {
          Arg3_61 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), Arg3_61, 0) = ((MR_Box) (IO_58));
          MR_hl_field(MR_mktag(0), Arg3_61, 1) = ((MR_Box) ((MR_String) "_IO"));
          MR_hl_field(MR_mktag(0), Arg3_61, 2) = ((MR_Box) (Var_125));
          MR_hl_field(MR_mktag(0), Arg3_61, 3) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 1));
        }
        ...
        parse_tree__prog_data_foreign__set_may_duplicate_3_p_0((MR_Word) (MR_mkword(MR_mktag(1), &hlds__make_hlds__add_pragma__add_pragma_tabling_scalar_common_2[3])), STATE_VARIABLE_Attrs_134_134, &STATE_VARIABLE_Attrs_136_136);
        ...
        StatsCode_63 = mercury__string__f_43_43_2_f_0((MR_String) "MR_get_tabling_stats(&", Var_139);
        {
          ...
          MR_hl_field(MR_mktag(1), Var_141, 0) = ((MR_Box) (Context_25));
        }
        {
          StatsImpl_64 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), StatsImpl_64, 0) = ((MR_Box) (StatsCode_63));
          MR_hl_field(MR_mktag(0), StatsImpl_64, 1) = ((MR_Box) (Var_141));
        }
        {
          Var_145 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), Var_145, 0) = ((MR_Box) (Arg3_61));
          MR_hl_field(MR_mktag(1), Var_145, 1) = ((MR_Box) ((MR_Unsigned) 0U));
        }
        {
          Var_144 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), Var_144, 0) = ((MR_Box) (Arg2_60));
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(1), Var_143, 0) = ((MR_Box) (Arg1_59));
          MR_hl_field(MR_mktag(1), Var_143, 1) = ((MR_Box) (Var_144));
        }
        {
          StatsFCInfo_65 = (MR_Word) MR_new_object(MR_Word, (7 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), StatsFCInfo_65, 0) = ((MR_Box) (STATE_VARIABLE_Attrs_136_136));
          MR_hl_field(MR_mktag(0), StatsFCInfo_65, 1) = ((MR_Box) (StatsPredSymName_35));
          MR_hl_field(MR_mktag(0), StatsFCInfo_65, 2) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 0));
          MR_hl_field(MR_mktag(0), StatsFCInfo_65, 3) = ((MR_Box) (Var_143));
          MR_hl_field(MR_mktag(0), StatsFCInfo_65, 4) = ((MR_Box) (STATE_VARIABLE_VarSet_117_117));
          MR_hl_field(MR_mktag(0), StatsFCInfo_65, 5) = ((MR_Box) (InstVarSet_44));
          MR_hl_field(MR_mktag(0), StatsFCInfo_65, 6) = ((MR_Box) (StatsImpl_64));
        }
        {
          PragmaStatsFCInfo_66 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), PragmaStatsFCInfo_66, 0) = ((MR_Box) (StatsFCInfo_65));
          MR_hl_field(MR_mktag(0), PragmaStatsFCInfo_66, 1) = ((MR_Box) (Context_25));
          MR_hl_field(MR_mktag(0), PragmaStatsFCInfo_66, 2) = ((MR_Box) ((MR_Unsigned) 0U));
        }
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = hlds__make_hlds__add_pragma__add_pragma_tabling__IntroducedFrom__pred__table_info_c_global_var_name__690__1_2_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))));
  return succeeded;
}
  ...
  MR_Integer ProcId_7)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_9, (MR_Integer) 304, &HighLevelCode_11);
  ...
  MR_Word * STATE_VARIABLE_Specs_59)
{
  ...
  switch (MR_tag((MR_Word) PFUMM_21)) {
    ...
    case (MR_Integer) 0:
      {
        MR_Word ModesOrArity_209 = ((MR_Word) ((MR_hl_field(MR_mktag(0), PFUMM_21, (MR_Integer) 0))));
        ...
        {
          UserArity_213 = ((MR_Word) ((MR_hl_field(MR_mktag(1), ModesOrArity_209, (MR_Integer) 0))));
          parse_tree__prog_util__user_arity_pred_form_arity_3_p_0((MR_Integer) 0, UserArity_213, &PredFormArity_212);
        }
        else
        {
          MR_Word Modes_175 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ModesOrArity_209, (MR_Integer) 0))));
        ...
        if ((PredIds0_214 == (MR_Word) ((MR_Unsigned) 0U)))
        {
...

          {
            ...
            MR_hl_field(MR_mktag(0), Var_183, 0) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 0));
            MR_hl_field(MR_mktag(0), Var_183, 1) = ((MR_Box) (PredSymName_22));
            MR_hl_field(MR_mktag(0), Var_183, 2) = ((MR_Box) (UserArity_213));
          }
          {
            Origin_179 = (MR_Word) MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL);
            MR_hl_field(MR_mktag(0), Origin_179, 0) = ((MR_Box) (Var_183));
          }
          TabledMethodStr_180 = parse_tree__prog_out__tabled_eval_method_to_string_1_f_0(TabledMethod_18);
          {
            ...
            MR_hl_field(MR_mktag(3), Var_184, 0) = ((MR_Box) ((MR_Unsigned) 29U));
            MR_hl_field(MR_mktag(3), Var_184, 1) = ((MR_Box) (TabledMethodStr_180));
          }
          {
            DescPieces_181 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), DescPieces_181, 0) = ((MR_Box) (Var_184));
            MR_hl_field(MR_mktag(1), DescPieces_181, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &hlds__make_hlds__add_pragma__add_pragma_tabling_scalar_common_1[2])));
          }
          ...
          {
            PredIds_38 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), PredIds_38, 0) = ((MR_Box) (PredId_182));
            MR_hl_field(MR_mktag(1), PredIds_38, 1) = ((MR_Box) ((MR_Unsigned) 0U));
          }
        }
        else
        {
    ...
    case (MR_Integer) 1:
      {
        ...
        if ((PredIds0_33 == (MR_Word) ((MR_Unsigned) 0U)))
        {
...

          {
            ...
            MR_hl_field(MR_mktag(0), Var_63, 0) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 1));
            MR_hl_field(MR_mktag(0), Var_63, 1) = ((MR_Box) (PredSymName_22));
            MR_hl_field(MR_mktag(0), Var_63, 2) = ((MR_Box) (UserArity_31));
          }
          {
            Origin_34 = (MR_Word) MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL);
            MR_hl_field(MR_mktag(0), Origin_34, 0) = ((MR_Box) (Var_63));
          }
          TabledMethodStr_35 = parse_tree__prog_out__tabled_eval_method_to_string_1_f_0(TabledMethod_18);
          {
            ...
            MR_hl_field(MR_mktag(3), Var_64, 1) = ((MR_Box) (TabledMethodStr_35));
          }
          {
            DescPieces_36 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), DescPieces_36, 0) = ((MR_Box) (Var_64));
            MR_hl_field(MR_mktag(1), DescPieces_36, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &hlds__make_hlds__add_pragma__add_pragma_tabling_scalar_common_1[2])));
          }
          ...
          {
            PredIds_38 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), PredIds_38, 0) = ((MR_Box) (PredId_37));
            MR_hl_field(MR_mktag(1), PredIds_38, 1) = ((MR_Box) ((MR_Unsigned) 0U));
          }
        }
        else
    ...
    case (MR_Integer) 2:
      {
        ...
        MR_Word UserArity_151 = ((MR_Word) ((MR_hl_field(MR_mktag(2), PFUMM_21, (MR_Integer) 0))));
        ...
        if ((PredIds0_152 == (MR_Word) ((MR_Unsigned) 0U)))
        {
...

          {
            ...
            MR_hl_field(MR_mktag(0), Var_75, 0) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 0));
            MR_hl_field(MR_mktag(0), Var_75, 1) = ((MR_Box) (PredSymName_22));
            MR_hl_field(MR_mktag(0), Var_75, 2) = ((MR_Box) (UserArity_151));
          }
          {
            Origin_143 = (MR_Word) MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL);
            MR_hl_field(MR_mktag(0), Origin_143, 0) = ((MR_Box) (Var_75));
          }
          {
            Var_77 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(3), Var_77, 0) = ((MR_Box) ((MR_Unsigned) 29U));
            MR_hl_field(MR_mktag(3), Var_77, 1) = ((MR_Box) (TabledMethodStr_154));
          }
          {
            DescPieces_144 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), DescPieces_144, 0) = ((MR_Box) (Var_77));
            MR_hl_field(MR_mktag(1), DescPieces_144, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &hlds__make_hlds__add_pragma__add_pragma_tabling_scalar_common_1[2])));
          }
          ...
          {
            PredIds_38 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), PredIds_38, 0) = ((MR_Box) (PredId_145));
            MR_hl_field(MR_mktag(1), PredIds_38, 1) = ((MR_Box) ((MR_Unsigned) 0U));
          }
        }
        else
  ...
  {
    MR_Word Attributes_43 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MaybeAttributes_20, (MR_Integer) 0))));
    MR_Word Statistics_44 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Attributes_43, (MR_Integer) 2))) >> 2)) & (MR_Integer) 1);
    MR_Word AllowReset_45 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Attributes_43, (MR_Integer) 2))) >> 1)) & (MR_Integer) 1);
    MR_Word Var_231 = ((MR_Word) ((MR_hl_field(MR_mktag(1), PredIds_38, (MR_Integer) 1))));
        ...
        case (MR_Integer) 0:
          {
...

            {
              ...
              MR_hl_field(MR_mktag(0), Var_97, 0) = ((MR_Box) (PredSymName_22));
              MR_hl_field(MR_mktag(0), Var_97, 1) = ((MR_Box) (UserArityInt_32));
            }
            {
              Var_96 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            ...
            }
            {
              Var_95 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), Var_95, 0) = ((MR_Box) (Var_96));
              MR_hl_field(MR_mktag(1), Var_95, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &hlds__make_hlds__add_pragma__add_pragma_tabling_scalar_common_1[11])));
            }
            {
              Var_92 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), Var_92, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__add_pragma__add_pragma_tabling_scalar_common_1[4])));
              MR_hl_field(MR_mktag(1), Var_92, 1) = ((MR_Box) (Var_95));
            }
            {
              StatsPieces_50 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), StatsPieces_50, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__add_pragma__add_pragma_tabling_scalar_common_1[3])));
              MR_hl_field(MR_mktag(1), StatsPieces_50, 1) = ((MR_Box) (Var_92));
            }
            {
              StatsSpec_51 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), StatsSpec_51, 0) = ((MR_Box) ((MR_String) "predicate \140hlds.make_hlds.add_pragma.add_pragma_tabling.module_add_pragma_tabled\'/10"));
              MR_hl_field(MR_mktag(1), StatsSpec_51, 1) = ((MR_Box) ((MR_Unsigned) 0U));
              MR_hl_field(MR_mktag(1), StatsSpec_51, 2) = ((MR_Box) ((MR_Unsigned) 40U));
              MR_hl_field(MR_mktag(1), StatsSpec_51, 3) = ((MR_Box) (Context_12));
              MR_hl_field(MR_mktag(1), StatsSpec_51, 4) = ((MR_Box) (StatsPieces_50));
            }
            {
              STATE_VARIABLE_Specs_113_113 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), STATE_VARIABLE_Specs_113_113, 0) = ((MR_Box) (StatsSpec_51));
              MR_hl_field(MR_mktag(1), STATE_VARIABLE_Specs_113_113, 1) = ((MR_Box) (STATE_VARIABLE_Specs_71_71));
            }
          }
          break;
      }
        ...
        case (MR_Integer) 0:
          {
...

            {
              ...
              MR_hl_field(MR_mktag(0), Var_121, 0) = ((MR_Box) (PredSymName_22));
              MR_hl_field(MR_mktag(0), Var_121, 1) = ((MR_Box) (UserArityInt_32));
            }
            {
            ...
            }
            {
              ...
              MR_hl_field(MR_mktag(1), Var_119, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &hlds__make_hlds__add_pragma__add_pragma_tabling_scalar_common_1[15])));
            }
            {
              Var_116 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), Var_116, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__add_pragma__add_pragma_tabling_scalar_common_1[4])));
              MR_hl_field(MR_mktag(1), Var_116, 1) = ((MR_Box) (Var_119));
            }
            {
              ResetPieces_52 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), ResetPieces_52, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__add_pragma__add_pragma_tabling_scalar_common_1[12])));
              MR_hl_field(MR_mktag(1), ResetPieces_52, 1) = ((MR_Box) (Var_116));
            }
            {
              ResetSpec_53 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), ResetSpec_53, 0) = ((MR_Box) ((MR_String) "predicate \140hlds.make_hlds.add_pragma.add_pragma_tabling.module_add_pragma_tabled\'/10"));
              MR_hl_field(MR_mktag(1), ResetSpec_53, 1) = ((MR_Box) ((MR_Unsigned) 0U));
              MR_hl_field(MR_mktag(1), ResetSpec_53, 2) = ((MR_Box) ((MR_Unsigned) 40U));
              MR_hl_field(MR_mktag(1), ResetSpec_53, 3) = ((MR_Box) (Context_12));
              MR_hl_field(MR_mktag(1), ResetSpec_53, 4) = ((MR_Box) (ResetPieces_52));
            }
            {
              STATE_VARIABLE_Specs_137_137 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), STATE_VARIABLE_Specs_137_137, 0) = ((MR_Box) (ResetSpec_53));
              MR_hl_field(MR_mktag(1), STATE_VARIABLE_Specs_137_137, 1) = ((MR_Box) (STATE_VARIABLE_Specs_113_113));
            }
          }
          break;
        case (MR_Integer) 1:
  ...
  }
  {
    ...
    MR_hl_field(MR_mktag(0), Var_138, 0) = ((MR_Box) (&hlds__make_hlds__add_pragma__add_pragma_tabling_scalar_common_3[0]));
    MR_hl_field(MR_mktag(0), Var_138, 1) = ((MR_Box) (hlds__make_hlds__add_pragma__add_pragma_tabling__module_add_pragma_tabled_10_p_0_1));
    MR_hl_field(MR_mktag(0), Var_138, 2) = ((MR_Box) ((MR_Integer) 8));
    MR_hl_field(MR_mktag(0), Var_138, 3) = ((MR_Box) (TabledMethod_18));
    MR_hl_field(MR_mktag(0), Var_138, 4) = ((MR_Box) (PFUMM_21));
    MR_hl_field(MR_mktag(0), Var_138, 5) = ((MR_Box) (PredModuleName_23));
    MR_hl_field(MR_mktag(0), Var_138, 6) = ((MR_Box) (PredName_24));
    MR_hl_field(MR_mktag(0), Var_138, 7) = ((MR_Box) (MaybeAttributes_20));
    MR_hl_field(MR_mktag(0), Var_138, 8) = ((MR_Box) (Context_12));
    MR_hl_field(MR_mktag(0), Var_138, 9) = ((MR_Box) (ItemMercuryStatus_13));
    MR_hl_field(MR_mktag(0), Var_138, 10) = ((MR_Box) (PredStatus_14));
  }
