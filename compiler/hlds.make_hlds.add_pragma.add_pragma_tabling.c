...
{
  {
    ...
    if (succeeded)
    {
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals_26, (MR_Integer) 259, &OwnStacks_28);
      switch (OwnStacks_28) {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_26, (MR_Integer) 67, &VeryVerbose_40);
    ...
    if (succeeded)
    {
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(3), Var_95, 0) = ((MR_Box) ((MR_Unsigned) 25U));
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(1), InlineWarningSpec_47, 2) = ((MR_Box) ((MR_Unsigned) 24U));
    ...
    if (succeeded)
    {
...

      {
        ...
        MR_hl_field(MR_mktag(3), Var_134, 0) = ((MR_Box) ((MR_Unsigned) 25U));
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(1), Spec_49, 2) = ((MR_Box) ((MR_Unsigned) 24U));
      ...
      if ((MaybeModes_35 == (MR_Word) ((MR_Unsigned) 0U)))
        if ((ExistingProcs_54 == (MR_Word) ((MR_Unsigned) 0U)))
        {
...

          {
            ...
            MR_hl_field(MR_mktag(3), Var_158, 0) = ((MR_Box) ((MR_Unsigned) 25U));
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(1), Spec_205, 2) = ((MR_Box) ((MR_Unsigned) 24U));
      ...
      else
      {
        ...
        else
        {
...

          {
            ...
            MR_hl_field(MR_mktag(3), Var_182, 0) = ((MR_Box) ((MR_Unsigned) 25U));
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(1), Spec_199, 2) = ((MR_Box) ((MR_Unsigned) 24U));
...
{
  {
    ...
    if ((OldEvalMethod_31 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      ...
      if ((MaybeDeclaredArgModes_32 == (MR_Word) ((MR_Unsigned) 0U)))
      {
        ...
        TabledMethodStr_33 = parse_tree__prog_out__tabled_eval_method_to_pragma_name_1_f_0(TabledMethod_23);
        {
          ...
          MR_hl_field(MR_mktag(3), Var_143, 0) = ((MR_Box) ((MR_Unsigned) 25U));
      ...
      else
      {
        ...
        else
        {
          ...
          TabledMethodStr_162 = parse_tree__prog_out__tabled_eval_method_to_pragma_name_1_f_0(TabledMethod_23);
          {
            ...
            MR_hl_field(MR_mktag(3), Var_109, 0) = ((MR_Box) ((MR_Unsigned) 25U));
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(1), Spec_164, 2) = ((MR_Box) ((MR_Unsigned) 24U));
    ...
    else
    {
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(1), Spec_173, 2) = ((MR_Box) ((MR_Unsigned) 24U));
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_9, (MR_Integer) 298, &HighLevelCode_11);
      ...
      case (MR_Integer) 0:
        {
          ...
          if ((PredIds0_217 == (MR_Word) ((MR_Unsigned) 0U)))
          {
            ...
            hlds__hlds_module__module_info_get_name_2_p_0(STATE_VARIABLE_ModuleInfo_0_51, &ModuleName_183);
            {
              ...
              MR_hl_field(MR_mktag(3), Var_186, 0) = ((MR_Box) ((MR_Unsigned) 25U));
      ...
      case (MR_Integer) 2:
        {
          ...
          if ((PredIds0_149 == (MR_Word) ((MR_Unsigned) 0U)))
          {
            ...
            hlds__hlds_module__module_info_get_name_2_p_0(STATE_VARIABLE_ModuleInfo_0_51, &ModuleName_140);
            {
              ...
              MR_hl_field(MR_mktag(3), Var_59, 0) = ((MR_Box) ((MR_Unsigned) 25U));
          ...
          case (MR_Integer) 0:
            {
              ...
              }
              {
                ...
                MR_hl_field(MR_mktag(1), StatsSpec_48, 2) = ((MR_Box) ((MR_Unsigned) 24U));
          ...
          case (MR_Integer) 0:
            {
              ...
              }
              {
                ...
                MR_hl_field(MR_mktag(1), ResetSpec_50, 2) = ((MR_Box) ((MR_Unsigned) 24U));
