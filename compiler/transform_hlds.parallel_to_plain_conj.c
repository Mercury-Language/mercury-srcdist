...
#line 27 "transform_hlds.parallel_to_plain_conj.c"
#line 144 "../library/io.int2"
#include "string.mh"

#line 31 "transform_hlds.parallel_to_plain_conj.c"
#line 33 "../mdbcomp/mdbcomp.rtti_access.int2"
#include "mdbcomp.rtti_access.mh"

#line 35 "transform_hlds.parallel_to_plain_conj.c"
#line 29 "../library/bitmap.int2"
#include "bitmap.mh"

#line 39 "transform_hlds.parallel_to_plain_conj.c"
#line 28 "../library/time.int2"
#include "time.mh"

#line 43 "transform_hlds.parallel_to_plain_conj.c"
#line 31 "../library/array.int2"
#include "array.mh"

#line 47 "transform_hlds.parallel_to_plain_conj.c"
#line 48 "transform_hlds.parallel_to_plain_conj.c"
#include "transform_hlds.parallel_to_plain_conj.mh"

#line 51 "transform_hlds.parallel_to_plain_conj.c"
...
#line 56 "transform_hlds.parallel_to_plain_conj.c"
#line 57 "transform_hlds.parallel_to_plain_conj.c"

#endif
#line 60 "transform_hlds.parallel_to_plain_conj.c"
...
MR_decl_label3(transform_hlds__parallel_to_plain_conj__parallel_to_plain_conjs_cases_2_0, 15,4,6)
MR_decl_label8(transform_hlds__parallel_to_plain_conj__parallel_to_plain_conjs_goal_2_0, 58,5,59,9,63,13,14,15)
MR_decl_label8(transform_hlds__parallel_to_plain_conj__parallel_to_plain_conjs_goal_2_0, 61,19,62,23,26,30,60,33)
MR_decl_label2(transform_hlds__parallel_to_plain_conj__parallel_to_plain_conjs_goal_2_0, 56,57)
MR_decl_label3(transform_hlds__parallel_to_plain_conj__parallel_to_plain_conjs_goals_2_0, 14,4,5)
...
MR_BEGIN_MODULE(transform_hlds__parallel_to_plain_conj_module0)
	...
	MR_init_label8(transform_hlds__parallel_to_plain_conj__parallel_to_plain_conjs_goal_2_0,58,5,59,9,63,13,14,15)
	MR_init_label8(transform_hlds__parallel_to_plain_conj__parallel_to_plain_conjs_goal_2_0,61,19,62,23,26,30,60,33)
	MR_init_label2(transform_hlds__parallel_to_plain_conj__parallel_to_plain_conjs_goal_2_0,56,57)
MR_BEGIN_CODE
...
MR_def_static(transform_hlds__parallel_to_plain_conj__parallel_to_plain_conjs_goal_2_0)
	...
	if (MR_INT_NE(MR_tag(MR_tempr1),3)) {
		MR_GOTO_LAB(transform_hlds__parallel_to_plain_conj__parallel_to_plain_conjs_goal_2_0_i57);
	}
	MR_COMPUTED_GOTO((MR_Unsigned) MR_ctfield(3, MR_tempr1, 0),
		MR_LABEL_AP(transform_hlds__parallel_to_plain_conj__parallel_to_plain_conjs_goal_2_0_i57) MR_AND
		MR_LABEL_AP(transform_hlds__parallel_to_plain_conj__parallel_to_plain_conjs_goal_2_0_i58) MR_AND
		MR_LABEL_AP(transform_hlds__parallel_to_plain_conj__parallel_to_plain_conjs_goal_2_0_i59) MR_AND
		MR_LABEL_AP(transform_hlds__parallel_to_plain_conj__parallel_to_plain_conjs_goal_2_0_i60) MR_AND
		MR_LABEL_AP(transform_hlds__parallel_to_plain_conj__parallel_to_plain_conjs_goal_2_0_i61) MR_AND
		MR_LABEL_AP(transform_hlds__parallel_to_plain_conj__parallel_to_plain_conjs_goal_2_0_i62) MR_AND
		MR_LABEL_AP(transform_hlds__parallel_to_plain_conj__parallel_to_plain_conjs_goal_2_0_i63) MR_AND
		MR_LABEL_AP(transform_hlds__parallel_to_plain_conj__parallel_to_plain_conjs_goal_2_0_i30));
	}
MR_def_label(transform_hlds__parallel_to_plain_conj__parallel_to_plain_conjs_goal_2_0,58)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(5);
...
MR_def_label(transform_hlds__parallel_to_plain_conj__parallel_to_plain_conjs_goal_2_0,59)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(5);
	MR_sv(5) = (MR_Word) MR_succip;
	MR_sv(1) = MR_ctfield(0, MR_r1, 1);
...
MR_def_label(transform_hlds__parallel_to_plain_conj__parallel_to_plain_conjs_goal_2_0,63)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(5);
	MR_sv(5) = (MR_Word) MR_succip;
	MR_sv(1) = MR_ctfield(0, MR_r1, 1);
...
MR_def_label(transform_hlds__parallel_to_plain_conj__parallel_to_plain_conjs_goal_2_0,61)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(5);
	MR_sv(5) = (MR_Word) MR_succip;
	MR_sv(1) = MR_ctfield(0, MR_r1, 1);
...
MR_def_label(transform_hlds__parallel_to_plain_conj__parallel_to_plain_conjs_goal_2_0,62)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(5);
	MR_sv(5) = (MR_Word) MR_succip;
	{
	...
	if (MR_RTAGS_TESTR(MR_tempr1,3,2)) {
		MR_GOTO_LAB(transform_hlds__parallel_to_plain_conj__parallel_to_plain_conjs_goal_2_0_i23);
	}
	MR_tempr2 = MR_ctfield(3, MR_tempr1, 2);
	if (MR_INT_EQ(MR_tempr2,0)) {
		MR_GOTO_LAB(transform_hlds__parallel_to_plain_conj__parallel_to_plain_conjs_goal_2_0_i56);
	}
	}
MR_def_label(transform_hlds__parallel_to_plain_conj__parallel_to_plain_conjs_goal_2_0,23)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_r3;
	MR_np_localcall_lab(transform_hlds__parallel_to_plain_conj__parallel_to_plain_conjs_goal_2_0,
		transform_hlds__parallel_to_plain_conj__parallel_to_plain_conjs_goal_2_0_i26);
MR_def_label(transform_hlds__parallel_to_plain_conj__parallel_to_plain_conjs_goal_2_0,26)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tag_alloc_heap(MR_tempr1, 3, (MR_Integer) 3);
...
MR_def_label(transform_hlds__parallel_to_plain_conj__parallel_to_plain_conjs_goal_2_0,30)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_string_const("parallel_to_plain_conj.m", 24);
	MR_r2 = (MR_Word) MR_string_const("shorthand", 9);
	MR_np_tailcall_ent(libs__compiler_util__unexpected_2_0);
MR_def_label(transform_hlds__parallel_to_plain_conj__parallel_to_plain_conjs_goal_2_0,60)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(5);
	MR_sv(5) = (MR_Word) MR_succip;
	MR_sv(1) = MR_ctfield(0, MR_r1, 1);
	...
	MR_np_call_localret_ent(transform_hlds__parallel_to_plain_conj__parallel_to_plain_conjs_cases_2_0,
		transform_hlds__parallel_to_plain_conj__parallel_to_plain_conjs_goal_2_0_i33);
MR_def_label(transform_hlds__parallel_to_plain_conj__parallel_to_plain_conjs_goal_2_0,33)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
...
MR_def_label(transform_hlds__parallel_to_plain_conj__parallel_to_plain_conjs_goal_2_0,56)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(5);
MR_def_label(transform_hlds__parallel_to_plain_conj__parallel_to_plain_conjs_goal_2_0,57)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_proceed();
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
...
MR_BEGIN_MODULE(transform_hlds__parallel_to_plain_conj_module1)
	...
	MR_init_label3(transform_hlds__parallel_to_plain_conj__parallel_to_plain_conjs_goals_2_0,14,4,5)
MR_BEGIN_CODE
...
MR_def_static(transform_hlds__parallel_to_plain_conj__parallel_to_plain_conjs_goals_2_0)
	...
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
		MR_GOTO_LAB(transform_hlds__parallel_to_plain_conj__parallel_to_plain_conjs_goals_2_0_i14);
	}
	MR_r1 = (MR_Word) MR_tbmkword(0, 0);
	MR_proceed();
MR_def_label(transform_hlds__parallel_to_plain_conj__parallel_to_plain_conjs_goals_2_0,14)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(2);
...
MR_BEGIN_MODULE(transform_hlds__parallel_to_plain_conj_module2)
	...
	MR_init_label3(transform_hlds__parallel_to_plain_conj__parallel_to_plain_conjs_cases_2_0,15,4,6)
MR_BEGIN_CODE
...
MR_def_static(transform_hlds__parallel_to_plain_conj__parallel_to_plain_conjs_cases_2_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
		MR_GOTO_LAB(transform_hlds__parallel_to_plain_conj__parallel_to_plain_conjs_cases_2_0_i15);
	}
	MR_r1 = (MR_Word) MR_tbmkword(0, 0);
	MR_proceed();
MR_def_label(transform_hlds__parallel_to_plain_conj__parallel_to_plain_conjs_cases_2_0,15)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(4);
