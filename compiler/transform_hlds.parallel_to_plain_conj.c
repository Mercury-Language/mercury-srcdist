...
{
  {
    ...
    switch (MR_tag((MR_Word) GoalExpr0_5)) {
      ...
      case (MR_Integer) 0:
        {
          MR_Word SubGoal0_22 = (MR_Word) MR_body(((MR_Word) GoalExpr0_5), (MR_Integer) 0);
          MR_Word SubGoal_23;

          transform_hlds__parallel_to_plain_conj__parallel_to_plain_conjs_goal_2_p_0(SubGoal0_22, &SubGoal_23);
          GoalExpr_10 = (MR_Word) MR_mkword(MR_mktag(0), (MR_Word) SubGoal_23);
        }
        break;
      case (MR_Integer) 1:
      case (MR_Integer) 2:
      ...
      case (MR_Integer) 3:
        switch (((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), GoalExpr0_5, (MR_Integer) 0)))) {
          ...
          case (MR_Integer) 2:
            {
              ...
              MR_Word Goals_9;
              MR_Word _ConjType_7 = ((MR_Word) (MR_hl_field(MR_mktag(3), GoalExpr0_5, (MR_Integer) 1)));

              transform_hlds__parallel_to_plain_conj__parallel_to_plain_conjs_goals_2_p_0(Goals0_8, &Goals_9);
              {
                GoalExpr_10 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), GoalExpr_10, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 2));
                MR_hl_field(MR_mktag(3), GoalExpr_10, 1) = ((MR_Box) ((MR_Integer) 0));
          ...
          case (MR_Integer) 3:
            {
              MR_Word Goals0_55 = ((MR_Word) (MR_hl_field(MR_mktag(3), GoalExpr0_5, (MR_Integer) 1)));
              MR_Word Goals_56;

              transform_hlds__parallel_to_plain_conj__parallel_to_plain_conjs_goals_2_p_0(Goals0_55, &Goals_56);
              {
                GoalExpr_10 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), GoalExpr_10, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 3));
                MR_hl_field(MR_mktag(3), GoalExpr_10, 1) = ((MR_Box) (Goals_56));
              }
            }
            break;
          case (MR_Integer) 4:
            {
              ...
              MR_Word CanFail_12 = ((MR_Word) (MR_hl_field(MR_mktag(3), GoalExpr0_5, (MR_Integer) 2)));
              ...
              {
                GoalExpr_10 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), GoalExpr_10, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 4));
                MR_hl_field(MR_mktag(3), GoalExpr_10, 1) = ((MR_Box) (Var_11));
                MR_hl_field(MR_mktag(3), GoalExpr_10, 2) = ((MR_Box) (CanFail_12));
          ...
          case (MR_Integer) 5:
            {
              ...
              else
              {
                ...
                transform_hlds__parallel_to_plain_conj__parallel_to_plain_conjs_goal_2_p_0(SubGoal0_59, &SubGoal_57);
                {
                  GoalExpr_10 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL));
                  MR_hl_field(MR_mktag(3), GoalExpr_10, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 5));
                  MR_hl_field(MR_mktag(3), GoalExpr_10, 1) = ((MR_Box) (Reason_24));
                  MR_hl_field(MR_mktag(3), GoalExpr_10, 2) = ((MR_Box) (SubGoal_57));
                }
              }
            }
            break;
          case (MR_Integer) 6:
            {
              ...
              {
                GoalExpr_10 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 5 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), GoalExpr_10, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 6));
