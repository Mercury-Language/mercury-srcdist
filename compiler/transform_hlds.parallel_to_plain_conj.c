          ...
          case (MR_Integer) 5:
            {
              ...
              MR_Word transform_hlds__parallel_to_plain_conj__Var_25;

              transform_hlds__parallel_to_plain_conj__succeeded = ((((MR_tag((MR_Word) transform_hlds__parallel_to_plain_conj__Reason_24)) == (MR_mktag((MR_Integer) 3)))) && (((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), transform_hlds__parallel_to_plain_conj__Reason_24, (MR_Integer) 0)))) == (MR_Integer) 6)));
              if (transform_hlds__parallel_to_plain_conj__succeeded)
                {
                  transform_hlds__parallel_to_plain_conj__Var_25 = ((MR_Word) (MR_hl_field(MR_mktag(3), transform_hlds__parallel_to_plain_conj__Reason_24, (MR_Integer) 1)));
