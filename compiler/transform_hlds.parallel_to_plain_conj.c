...
MR_decl_label7(transform_hlds__parallel_to_plain_conj__parallel_to_plain_conjs_goal_2_0, 23,26,22,31,30,69,68)
...
MR_BEGIN_MODULE(transform_hlds__parallel_to_plain_conj_module0)
	...
	MR_init_label7(transform_hlds__parallel_to_plain_conj__parallel_to_plain_conjs_goal_2_0,23,26,22,31,30,69,68)
MR_BEGIN_CODE
...
MR_def_static(transform_hlds__parallel_to_plain_conj__parallel_to_plain_conjs_goal_2_0)
	...
	if ((((((MR_tag(MR_r2) == MR_mktag((MR_Integer) 3)) && ((MR_Integer) MR_tfield(3, MR_r2, 0) == (MR_Integer) 0)) || (MR_tag(MR_r2) == MR_mktag((MR_Integer) 2))) || (MR_tag(MR_r2) == MR_mktag((MR_Integer) 1))) || (MR_tag(MR_r2) == MR_mktag((MR_Integer) 0)))) {
		MR_GOTO_LAB(transform_hlds__parallel_to_plain_conj__parallel_to_plain_conjs_goal_2_0_i69);
	}
...
MR_def_label(transform_hlds__parallel_to_plain_conj__parallel_to_plain_conjs_goal_2_0,18)
	...
	if (MR_INT_EQ(MR_r2,0)) {
		MR_GOTO_LAB(transform_hlds__parallel_to_plain_conj__parallel_to_plain_conjs_goal_2_0_i68);
	}
	}
...
MR_def_label(transform_hlds__parallel_to_plain_conj__parallel_to_plain_conjs_goal_2_0,22)
	...
	if (MR_RTAGS_TESTR(MR_r2,3,3)) {
		MR_GOTO_LAB(transform_hlds__parallel_to_plain_conj__parallel_to_plain_conjs_goal_2_0_i30);
	}
	MR_incr_sp(5);
	MR_sv(5) = (MR_Word) MR_succip;
	MR_sv(1) = MR_tfield(0, MR_r1, 1);
	...
	MR_np_call_localret_ent(transform_hlds__parallel_to_plain_conj__parallel_to_plain_conjs_cases_2_0,
		transform_hlds__parallel_to_plain_conj__parallel_to_plain_conjs_goal_2_0_i31);
...
MR_def_label(transform_hlds__parallel_to_plain_conj__parallel_to_plain_conjs_goal_2_0,69)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_proceed();
MR_def_label(transform_hlds__parallel_to_plain_conj__parallel_to_plain_conjs_goal_2_0,68)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(5);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
