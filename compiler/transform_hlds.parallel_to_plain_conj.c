    ...
    case (MR_Integer) 0:
      {
        ...
        hlds__hlds_pred__proc_info_set_goal_3_p_0(Goal_15, STATE_VARIABLE_ProcInfo_0_16, &STATE_VARIABLE_ProcInfo_1_31);
        hlds__hlds_pred__proc_info_set_has_parallel_conj_3_p_0((MR_Integer) 1, STATE_VARIABLE_ProcInfo_1_31, STATE_VARIABLE_ProcInfo_17);
      }
      break;
  }
}
