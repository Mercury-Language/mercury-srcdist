  ...
  while (MR_TRUE)
  {
    ...
    if (!((HeadVar__2_2 == (MR_Word) ((MR_Unsigned) 0U))))
    {
      ...
      if (!((ExternalTypeParams_23 == (MR_Word) ((MR_Unsigned) 0U))))
      {
        ...
        parse_tree__parse_tree_out_term__mercury_output_vars_6_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_tvar_type_0), TypeVarSet_27, (MR_Integer) 1, ExternalTypeParams_23, Stream_1);
        mercury__io__write_string_4_p_0(Stream_1, (MR_String) "]\n\t");
      }
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        mercury__io__write_string_4_p_0(Stream_1, (MR_String) ": ");
        parse_tree__prog_type_subst__apply_rec_subst_to_type_3_p_0(TypeBindings_5, Type_30, &Type1_44);
        parse_tree__prog_type__strip_builtin_qualifiers_from_type_2_p_0(Type1_44, &Type_45);
        parse_tree__mercury_to_mercury__mercury_output_type_6_p_0(TypeVarSet_3, (MR_Integer) 1, Type_45, Stream_1);
        // direct tailcall eliminated
        ;
