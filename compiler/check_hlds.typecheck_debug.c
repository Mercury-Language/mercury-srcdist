  ...
  MR_Word TypeAssignSet_10)
{
  ...
  {
    MR_Word DetailedStats_13 = ((MR_Unsigned) ((MR_hl_field(1, Debug_12, (MR_Integer) 0))) & (MR_Integer) 1);
    MR_Word Stream_14 = ((MR_Word) ((MR_hl_field(1, Debug_12, (MR_Integer) 1))));
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
        TypeAssign_17 = ((MR_Word) ((MR_hl_field(1, TypeAssignSet_10, (MR_Integer) 0))));
    }
    if (succeeded)
    {
      MR_Word VarTypes_19;
  ...
  MR_Word VarSet_3)
{
  while (MR_TRUE)
  {
    ...
    {
      MR_Word TypeAssign_12 = ((MR_Word) ((MR_hl_field(1, HeadVar__2_2, (MR_Integer) 0))));
      MR_Word TypeAssigns_13 = ((MR_Word) ((MR_hl_field(1, HeadVar__2_2, (MR_Integer) 1))));
      ...
      ConstraintsToProve_42 = ((MR_Word) ((MR_hl_field(0, Constraints_25, (MR_Integer) 0))));
      AssumedConstraints_43 = ((MR_Word) ((MR_hl_field(0, Constraints_25, (MR_Integer) 1))));
  ...
  MR_String MaybeOperator_5)
{
  while (MR_TRUE)
  {
    ...
    {
      MR_Word Constraint_18 = ((MR_Word) ((MR_hl_field(1, HeadVar__4_4, (MR_Integer) 0))));
      MR_Word Constraints_19 = ((MR_Word) ((MR_hl_field(1, HeadVar__4_4, (MR_Integer) 1))));
  ...
  MR_Word HeadVar__7_7)
{
  while (MR_TRUE)
  {
    ...
    {
      MR_Word Var_27 = ((MR_Word) ((MR_hl_field(1, HeadVar__7_7, (MR_Integer) 0))));
      MR_Word Vars_28 = ((MR_Word) ((MR_hl_field(1, HeadVar__7_7, (MR_Integer) 1))));
      MR_Word Type_30;
