  ...
  MR_Word TypeAssignSet_10)
{
  ...
  if (!((Debug_12 == (MR_Word) ((MR_Unsigned) 0U))))
  {
    ...
    if (succeeded)
    {
      ...
      hlds__vartypes__vartypes_count_2_p_0(VarTypes_28, &VarTypesCount_29);
      mercury__io__write_string_4_p_0(Stream_14, (MR_String) "\t\140var -> type\' map: count = ");
      mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&check_hlds__typecheck_debug_scalar_common_2[0]), VarTypesCount_29, &Var_59);
      mercury__io__write_string_4_p_0(Stream_14, Var_59);
      mercury__io__write_string_4_p_0(Stream_14, (MR_String) "\n");
      ...
      mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&check_hlds__typecheck_debug_scalar_common_2[0]), TypeBindingsCount_31, &Var_70);
  ...
  MR_Word VarSet_3)
{
  while (MR_TRUE)
  {
    ...
    if (!((HeadVar__2_2 == (MR_Word) ((MR_Unsigned) 0U))))
    {
      ...
      MR_Word Vars_34;
      MR_Word ConstraintsToProve_56;
      MR_Word AssumedConstraints_57;
      ...
      hlds__vartypes__vartypes_vars_2_p_0(VarTypes_30, &Vars_34);
      ...
      ConstraintsToProve_56 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Constraints_31, (MR_Integer) 0))));
      AssumedConstraints_57 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Constraints_31, (MR_Integer) 1))));
      check_hlds__typecheck_debug__write_type_assign_constraints_7_p_0(Stream_1, TypeVarSet_33, TypeBindings_32, AssumedConstraints_57, (MR_String) "&");
      check_hlds__typecheck_debug__write_type_assign_constraints_7_p_0(Stream_1, TypeVarSet_33, TypeBindings_32, ConstraintsToProve_56, (MR_String) "<=");
      mercury__io__write_string_4_p_0(Stream_1, (MR_String) "\n");
      mercury__io__write_string_4_p_0(Stream_1, (MR_String) "\n");
