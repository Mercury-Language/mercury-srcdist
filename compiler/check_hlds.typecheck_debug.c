  ...
  MR_Word TypeAssignSet_10)
{
  ...
  {
    MR_Word DetailedStats_13 = ((MR_Unsigned) ((MR_hl_field(1, Debug_12, 0))) & (MR_Integer) 1);
    MR_Word Stream_14 = ((MR_Word) ((MR_hl_field(1, Debug_12, 1))));
    MR_Word TypeAssign_17;
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
        TypeAssign_17 = ((MR_Word) ((MR_hl_field(1, TypeAssignSet_10, 0))));
    }
    if (succeeded)
    {
      MR_Word VarTypes_19;
      MR_Integer VarTypesCount_20;
      MR_Word TypeBindings_21;
      MR_Integer TypeBindingsCount_22;
      MR_String Var_49;
      MR_String Var_60;

      check_hlds__type_assign__type_assign_get_var_types_2_p_0(TypeAssign_17, &VarTypes_19);
      parse_tree__vartypes__vartypes_count_2_p_0(VarTypes_19, &VarTypesCount_20);
      mercury__io__write_string_4_p_0(Stream_14, (MR_String) "\t\140var -> type\' map: count = ");
      mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&check_hlds__typecheck_debug_scalar_common_2[0]), VarTypesCount_20, &Var_49);
      mercury__io__write_string_4_p_0(Stream_14, Var_49);
      mercury__io__write_string_4_p_0(Stream_14, (MR_String) "\n");
      check_hlds__type_assign__type_assign_get_type_bindings_2_p_0(TypeAssign_17, &TypeBindings_21);
      mercury__map__count_2_p_0((MR_Word) (&check_hlds__typecheck_debug_scalar_common_1[0]), (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0), TypeBindings_21, &TypeBindingsCount_22);
      mercury__io__write_string_4_p_0(Stream_14, (MR_String) "\t\140type var -> type\' map: count = ");
      mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&check_hlds__typecheck_debug_scalar_common_2[0]), TypeBindingsCount_22, &Var_60);
  ...
  MR_Word VarSet_3)
{
  while (MR_TRUE)
  {
    ...
    {
      MR_Word TypeAssign_12 = ((MR_Word) ((MR_hl_field(1, HeadVar__2_2, 0))));
      MR_Word TypeAssigns_13 = ((MR_Word) ((MR_hl_field(1, HeadVar__2_2, 1))));
      MR_Word ExistQTVars_23;
      MR_Word VarTypes_24;
      ...
      check_hlds__type_assign__type_assign_get_existq_tvars_2_p_0(TypeAssign_12, &ExistQTVars_23);
      check_hlds__type_assign__type_assign_get_var_types_2_p_0(TypeAssign_12, &VarTypes_24);
      check_hlds__type_assign__type_assign_get_constraint_db_2_p_0(TypeAssign_12, &Constraints_25);
      ...
      if (!((ExistQTVars_23 == (MR_Word) ((MR_Unsigned) 0U))))
      {
        mercury__io__write_string_4_p_0(Stream_1, (MR_String) "some [");
        parse_tree__parse_tree_out_term__mercury_output_vars_vs_6_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_tvar_type_0), TypeVarSet_27, (MR_Integer) 1, ExistQTVars_23, Stream_1);
        mercury__io__write_string_4_p_0(Stream_1, (MR_String) "]\n\t");
      }
      ...
      ConstraintsToProve_42 = ((MR_Word) ((MR_hl_field(0, Constraints_25, 0))));
      AssumedConstraints_43 = ((MR_Word) ((MR_hl_field(0, Constraints_25, 1))));
  ...
  MR_String MaybeOperator_5)
{
  while (MR_TRUE)
  {
    ...
    {
      MR_Word Constraint_18 = ((MR_Word) ((MR_hl_field(1, HeadVar__4_4, 0))));
      MR_Word Constraints_19 = ((MR_Word) ((MR_hl_field(1, HeadVar__4_4, 1))));
      ...
      hlds__type_rename__apply_rec_subst_to_constraint_3_p_0(TypeBindings_3, Constraint_18, &BoundConstraint_22);
      hlds__hlds_class__retrieve_prog_constraint_2_p_0(BoundConstraint_22, &ProgConstraint_23);
      parse_tree__parse_tree_out_type__mercury_output_constraint_6_p_0(TypeVarSet_2, (MR_Integer) 1, ProgConstraint_23, Stream_1);
      // direct tailcall eliminated
      ;
  ...
  MR_Word HeadVar__7_7)
{
  while (MR_TRUE)
  {
    ...
    {
      MR_Word Var_27 = ((MR_Word) ((MR_hl_field(1, HeadVar__7_7, 0))));
      MR_Word Vars_28 = ((MR_Word) ((MR_hl_field(1, HeadVar__7_7, 1))));
      MR_Word Type_30;
      ...
      if (succeeded)
      {
        ...
        parse_tree__prog_type__strip_module_names_from_type_4_p_0((MR_Integer) 0, (MR_Integer) 0, Type1_42, &Type_43);
        parse_tree__parse_tree_out_type__mercury_output_type_6_p_0(TypeVarSet_3, (MR_Integer) 1, Type_43, Stream_1);
        // direct tailcall eliminated
        ;
