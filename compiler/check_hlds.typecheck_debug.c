  ...
  MR_Word TypeAssignSet_10)
{
  ...
  if (!((Debug_12 == (MR_Word) ((MR_Unsigned) 0U))))
  {
    ...
    if (succeeded)
    {
      ...
      check_hlds__type_assign__type_assign_get_var_types_2_p_0(TypeAssign_27, &VarTypes_29);
      parse_tree__vartypes__vartypes_count_2_p_0(VarTypes_29, &VarTypesCount_30);
      mercury__io__write_string_4_p_0(Stream_14, (MR_String) "\t\140var -> type\' map: count = ");
      mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&check_hlds__typecheck_debug_scalar_common_2[0]), VarTypesCount_30, &Var_60);
      mercury__io__write_string_4_p_0(Stream_14, Var_60);
      mercury__io__write_string_4_p_0(Stream_14, (MR_String) "\n");
      check_hlds__type_assign__type_assign_get_type_bindings_2_p_0(TypeAssign_27, &TypeBindings_31);
      mercury__map__count_2_p_0((MR_Word) (&check_hlds__typecheck_debug_scalar_common_1[0]), (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0), TypeBindings_31, &TypeBindingsCount_32);
      mercury__io__write_string_4_p_0(Stream_14, (MR_String) "\t\140type var -> type\' map: count = ");
      mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&check_hlds__typecheck_debug_scalar_common_2[0]), TypeBindingsCount_32, &Var_71);
      mercury__io__write_string_4_p_0(Stream_14, Var_71);
      mercury__io__write_string_4_p_0(Stream_14, (MR_String) "\n");
    }
  ...
  MR_Word VarSet_3)
{
  while (MR_TRUE)
  {
    ...
    if (!((HeadVar__2_2 == (MR_Word) ((MR_Unsigned) 0U))))
    {
      ...
      MR_Word ExternalTypeParams_30;
      MR_Word VarTypes_31;
      MR_Word Constraints_32;
      MR_Word TypeBindings_33;
      MR_Word TypeVarSet_34;
      MR_Word Vars_35;
      MR_Word ConstraintsToProve_57;
      MR_Word AssumedConstraints_58;
      MR_Word next_value_of_HeadVar__2_2;

      mercury__io__write_string_4_p_0(Stream_1, (MR_String) "\t");
      check_hlds__type_assign__type_assign_get_external_type_params_2_p_0(TypeAssign_12, &ExternalTypeParams_30);
      check_hlds__type_assign__type_assign_get_var_types_2_p_0(TypeAssign_12, &VarTypes_31);
      check_hlds__type_assign__type_assign_get_typeclass_constraints_2_p_0(TypeAssign_12, &Constraints_32);
      check_hlds__type_assign__type_assign_get_type_bindings_2_p_0(TypeAssign_12, &TypeBindings_33);
      check_hlds__type_assign__type_assign_get_typevarset_2_p_0(TypeAssign_12, &TypeVarSet_34);
      parse_tree__vartypes__vartypes_vars_2_p_0(VarTypes_31, &Vars_35);
      if (!((ExternalTypeParams_30 == (MR_Word) ((MR_Unsigned) 0U))))
      {
        mercury__io__write_string_4_p_0(Stream_1, (MR_String) "some [");
        parse_tree__parse_tree_out_term__mercury_output_vars_6_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_tvar_type_0), TypeVarSet_34, (MR_Integer) 1, ExternalTypeParams_30, Stream_1);
        mercury__io__write_string_4_p_0(Stream_1, (MR_String) "]\n\t");
      }
      check_hlds__typecheck_debug__write_type_assign_types_9_p_0(Stream_1, VarSet_3, TypeVarSet_34, VarTypes_31, TypeBindings_33, (MR_Integer) 0, Vars_35);
      ConstraintsToProve_57 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Constraints_32, (MR_Integer) 0))));
      AssumedConstraints_58 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Constraints_32, (MR_Integer) 1))));
      check_hlds__typecheck_debug__write_type_assign_constraints_7_p_0(Stream_1, TypeVarSet_34, TypeBindings_33, AssumedConstraints_58, (MR_String) "&");
      check_hlds__typecheck_debug__write_type_assign_constraints_7_p_0(Stream_1, TypeVarSet_34, TypeBindings_33, ConstraintsToProve_57, (MR_String) "<=");
      mercury__io__write_string_4_p_0(Stream_1, (MR_String) "\n");
      mercury__io__write_string_4_p_0(Stream_1, (MR_String) "\n");
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        mercury__io__write_string_4_p_0(Stream_1, (MR_String) ": ");
        parse_tree__prog_type_subst__apply_rec_subst_to_type_3_p_0(TypeBindings_5, Type_30, &Type1_51);
        parse_tree__prog_type__strip_builtin_qualifiers_from_type_2_p_0(Type1_51, &Type_52);
        parse_tree__mercury_to_mercury__mercury_output_type_6_p_0(TypeVarSet_3, (MR_Integer) 1, Type_52, Stream_1);
        // direct tailcall eliminated
        ;
