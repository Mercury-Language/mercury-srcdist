...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 344, &Transitive_18);
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 370, &UnusedArgs_24);
    libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 428, &StructureReuse_25);
