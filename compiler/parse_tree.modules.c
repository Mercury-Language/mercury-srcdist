...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 335, &Transitive_16);
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 361, &UnusedArgs_22);
    libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 419, &StructureReuse_23);
