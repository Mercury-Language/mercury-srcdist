...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 339, &Transitive_18);
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 365, &UnusedArgs_24);
    libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 423, &StructureReuse_25);
