...
{
  {
    ...
    parse_tree__modules__process_module_interface_general_14_p_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_int_for_opt_module_section_0), Globals_15, (MR_Word) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))), HaveReadModuleMapInt_16, Module_17, (MR_Word) (&parse_tree__modules_scalar_common_2[23]), (MR_Word) (&parse_tree__modules_scalar_common_2[24]), (MR_Word) (&parse_tree__modules_scalar_common_2[25]), &_IntAvails_26, &_ImpAvails_27, &ItemBlocks_28, STATE_VARIABLE_ModuleAndImports_0_37, STATE_VARIABLE_ModuleAndImports_38);
