              ...
              case (MR_Integer) 2:
                {
                  ...
                  mercury__private_builtin__builtin_compare_int_3_p_0(&SubResult1_20, Var_31, Var_32);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 345, &Transitive_18);
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 371, &UnusedArgs_24);
    libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 429, &StructureReuse_25);
