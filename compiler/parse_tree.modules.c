...
parse_tree__modules__IntroducedFrom__pred__process_module_private_interfaces__845__1_2_p_0(
...
{
  {
    ...
    else
    {
      ...
      else
      {
        ...
        mercury__builtin__compare_3_p_0((MR_Word) (&parse_tree__modules_scalar_common_1[11]), &SubResult1_6, ((MR_Box) (Var_18)), ((MR_Box) (ArgY1_5)));
...
{
  {
    ...
    succeeded = parse_tree__modules__IntroducedFrom__pred__process_module_private_interfaces__845__1_2_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))));
    return succeeded;
  }
}
