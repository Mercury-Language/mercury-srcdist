...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 57, &Verbose_13);
  ...
  MR_Word * STATE_VARIABLE_Error_8)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals_1, (MR_Integer) 58, &VeryVerbose_31);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 334, &Transitive_16);
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 360, &UnusedArgs_22);
    libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 418, &StructureReuse_23);
  ...
  MR_Word * STATE_VARIABLE_Error_10)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals_1, (MR_Integer) 58, &VeryVerbose_37);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_15, (MR_Integer) 68, &Statistics_45);
