...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 334, &Transitive_18);
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 360, &UnusedArgs_24);
    libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 418, &StructureReuse_25);
