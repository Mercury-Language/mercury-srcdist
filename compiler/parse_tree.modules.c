...
{
  {
    ...
    parse_tree__modules__process_module_interface_general_14_p_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_int_for_opt_module_section_0), Globals_15, (MR_Word) ((MR_Unsigned) 0U), HaveReadModuleMapInt_16, Module_17, (MR_Word) (&parse_tree__modules_scalar_common_2[23]), (MR_Word) (&parse_tree__modules_scalar_common_2[24]), (MR_Word) (&parse_tree__modules_scalar_common_2[25]), &_IntAvails_26, &_ImpAvails_27, &ItemBlocks_28, STATE_VARIABLE_ModuleAndImports_0_37, STATE_VARIABLE_ModuleAndImports_38);
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(1), Severity_18, 2) = ((MR_Box) ((MR_Unsigned) 4U));
          MR_hl_field(MR_mktag(1), Severity_18, 3) = ((MR_Box) ((MR_Unsigned) 0U));
        }
        {
