        ...
        case (MR_Integer) 1:
          {
            ...
            libs__mmakefiles__maybe_write_phony_rule_5_p_0(OutStream_6, IsPhony_245, Var_123);
        ...
        case (MR_Integer) 4:
          {
            ...
            libs__mmakefiles__maybe_write_phony_rule_5_p_0(OutStream_6, IsPhony_204, Var_155);
