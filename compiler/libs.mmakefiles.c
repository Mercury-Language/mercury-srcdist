          ...
          case (MR_Integer) 1:
            {
              ...
              MR_Word Var_95;
              MR_String RuleName_249 = ((MR_String) ((MR_hl_field(MR_mktag(3), MmakeEntry_8, (MR_Integer) 1))));
              MR_Word IsPhony_250 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(3), MmakeEntry_8, (MR_Integer) 2))) & (MR_Integer) 1);
              MR_Word SourceFiles_251 = ((MR_Word) ((MR_hl_field(MR_mktag(3), MmakeEntry_8, (MR_Integer) 4))));
              MR_Word Actions_252 = ((MR_Word) ((MR_hl_field(MR_mktag(3), MmakeEntry_8, (MR_Integer) 5))));

              libs__mmakefiles__write_rule_name_4_p_0(OutStream_6, RuleName_249);
              ...
              libs__mmakefiles__maybe_write_phony_rule_5_p_0(OutStream_6, IsPhony_250, Var_95);
              libs__mmakefiles__write_mmake_file_name_4_p_0(OutStream_6, TargetFile_31);
              if ((SourceFiles_251 == (MR_Word) ((MR_Unsigned) 0U)))
                mercury__io__write_string_4_p_0(OutStream_6, (MR_String) " :");
              else
              {
                MR_String HeadSourceFile_226 = ((MR_String) ((MR_hl_field(MR_mktag(1), SourceFiles_251, (MR_Integer) 0))));
                MR_Word TailSourceFiles_227 = ((MR_Word) ((MR_hl_field(MR_mktag(1), SourceFiles_251, (MR_Integer) 1))));

                mercury__io__write_string_4_p_0(OutStream_6, (MR_String) " : ");
                succeeded = (strcmp(RuleName_249, (MR_String) "trans_opt_deps") == 0);
                if (!(succeeded))
                {
                  MR_Integer Var_207;
                  MR_Integer Var_208;
                  ...
                  Var_210 = mercury__list__length_1_f_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), TailSourceFiles_227);
                ...
                {
                  mercury__io__write_string_4_p_0(OutStream_6, (MR_String) "\\\n");
                  libs__mmakefiles__write_mmake_file_names_vertical_5_p_0(OutStream_6, HeadSourceFile_226, TailSourceFiles_227);
                }
                else
                  libs__mmakefiles__write_mmake_file_names_horizontal_5_p_0(OutStream_6, HeadSourceFile_226, TailSourceFiles_227);
              }
              mercury__io__nl_3_p_0(OutStream_6);
              libs__mmakefiles__write_mmake_actions_4_p_0(OutStream_6, Actions_252);
            }
            break;
          case (MR_Integer) 2:
            {
