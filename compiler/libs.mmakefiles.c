        ...
        case (MR_Integer) 1:
          {
            ...
            libs__mmakefiles__maybe_write_phony_rule_5_p_0(OutStream_6, IsPhony_244, Var_95);
        ...
        case (MR_Integer) 4:
          {
            ...
            libs__mmakefiles__maybe_write_phony_rule_5_p_0(OutStream_6, IsPhony_203, Var_76);
