  ...
  MR_Word HeadVar__3_3)
{
  while (MR_TRUE)
  {
    ...
    if (!((HeadVar__3_3 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))))))
    {
      ...
      {
        MR_Word next_value_of_HeadVar__3_3 = MmakeFragments_14;
  ...
  MR_Word HeadVar__2_2)
{
  while (MR_TRUE)
  {
    ...
    if (!((HeadVar__2_2 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))))))
    {
      ...
      /* direct tailcall eliminated */
      {
        MR_Word next_value_of_HeadVar__2_2 = Actions_11;
  ...
  while (MR_TRUE)
  {
    /* tailcall optimized into a loop */
    {
      ...
      if (!((FileNameGroups_8 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))))))
      {
        ...
        /* direct tailcall eliminated */
        {
          MR_Word next_value_of_FileNameGroup_7 = HeadFileNameGroup_10;
          MR_Word next_value_of_FileNameGroups_8 = TailFileNameGroups_11;
  ...
  MR_Word FileNames_8)
{
  while (MR_TRUE)
  {
    ...
    if (!((FileNames_8 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))))))
    {
      ...
      /* direct tailcall eliminated */
      {
        MR_String next_value_of_FileName_7 = HeadFileName_10;
        MR_Word next_value_of_FileNames_8 = TailFileNames_11;
  ...
  MR_Word TailValues_8)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      /* direct tailcall eliminated */
      {
        MR_String next_value_of_HeadValue_7 = HeadTailValue_10;
        MR_Word next_value_of_TailValues_8 = TailTailValues_11;
