                      ...
                      case (MR_Integer) 1:
                        {
                          ...
                          else
                          {
                            ...
                            mercury__private_builtin__builtin_compare_int_3_p_0(&SubResult2_245, Var_574, Var_575);
                            succeeded = (SubResult2_245 != (MR_Integer) 0);
                            if (succeeded)
                      ...
                      case (MR_Integer) 2:
                        {
                          ...
                          else
                          {
                            ...
                            mercury__private_builtin__builtin_compare_int_3_p_0(&SubResult2_329, Var_570, Var_571);
                            succeeded = (SubResult2_329 != (MR_Integer) 0);
                            if (succeeded)
                      ...
                      case (MR_Integer) 3:
                        {
                          ...
                          else
                          {
                            ...
                            mercury__private_builtin__builtin_compare_int_3_p_0(&SubResult2_413, Var_568, Var_569);
                            succeeded = (SubResult2_413 != (MR_Integer) 0);
                            if (succeeded)
                      ...
                      case (MR_Integer) 4:
                        {
                          ...
                          else
                          {
                            ...
                            mercury__private_builtin__builtin_compare_int_3_p_0(&SubResult2_497, Var_572, Var_573);
                            succeeded = (SubResult2_497 != (MR_Integer) 0);
                            if (succeeded)
