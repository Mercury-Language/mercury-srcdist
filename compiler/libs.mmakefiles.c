    ...
    case (MR_Integer) 0:
      {
        ...
        mercury__string__builder__append_string_3_p_0((MR_String) "# Automatically generated ", STATE_VARIABLE_SB_1_70, &Var_286);
        mercury__string__builder__append_string_3_p_0(Contents_8, Var_286, &Var_288);
        mercury__string__builder__append_string_3_p_0((MR_String) " for\n", Var_288, &STATE_VARIABLE_SB_2_73);
        mercury__string__builder__append_string_3_p_0((MR_String) "# module \140", STATE_VARIABLE_SB_2_73, &Var_290);
        ...
        mercury__string__builder__append_string_3_p_0((MR_String) "\'.\n", Var_295, &STATE_VARIABLE_SB_3_78);
        mercury__string__builder__append_string_3_p_0((MR_String) "# Generated by Mercury compiler version ", STATE_VARIABLE_SB_3_78, &Var_297);
        mercury__string__builder__append_string_3_p_0(Version_11, Var_297, &Var_299);
        mercury__string__builder__append_string_3_p_0((MR_String) "\n", Var_299, &STATE_VARIABLE_SB_4_85);
        mercury__string__builder__append_string_3_p_0((MR_String) "# configured for ", STATE_VARIABLE_SB_4_85, &Var_301);
        mercury__string__builder__append_string_3_p_0(FullArch_12, Var_301, &Var_303);
        mercury__string__builder__append_string_3_p_0((MR_String) ".\n", Var_303, &STATE_VARIABLE_SB_5_90);
      }
      break;
    case (MR_Integer) 1:
      {
    ...
    case (MR_Integer) 2:
      {
        ...
        mercury__string__builder__append_string_3_p_0((MR_String) "\n", Var_283, &STATE_VARIABLE_SB_5_90);
      }
      break;
    case (MR_Integer) 3:
        ...
        case (MR_Integer) 0:
          {
            ...
            if ((Values_16 == (MR_Word) ((MR_Unsigned) 0U)))
            {
              ...
              mercury__string__builder__append_string_3_p_0((MR_String) " =\n", Var_278, &STATE_VARIABLE_SB_5_90);
            }
            else
            {
              ...
              if ((TailValues_18 == (MR_Word) ((MR_Unsigned) 0U)))
              {
                ...
                mercury__string__builder__append_string_3_p_0((MR_String) "\n", Var_276, &STATE_VARIABLE_SB_5_90);
              }
              else
              {
                ...
                MR_Word STATE_VARIABLE_SB_2_313;
                MR_Word Var_316;
                MR_Word Var_318;

                mercury__string__builder__append_string_3_p_0(VarName_167, STATE_VARIABLE_SB_0_66, &Var_271);
                mercury__string__builder__append_string_3_p_0((MR_String) " = \\\n", Var_271, &STATE_VARIABLE_SB_10_116);
                HeadTailValue_305 = ((MR_String) ((MR_hl_field(1, TailValues_18, 0))));
                TailTailValues_306 = ((MR_Word) ((MR_hl_field(1, TailValues_18, 1))));
                mercury__string__builder__append_string_3_p_0((MR_String) "\t", STATE_VARIABLE_SB_10_116, &Var_316);
                mercury__string__builder__append_string_3_p_0(HeadValue_17, Var_316, &Var_318);
                mercury__string__builder__append_string_3_p_0((MR_String) " \\\n", Var_318, &STATE_VARIABLE_SB_2_313);
                libs__mmakefiles__append_mmake_var_values_4_p_0(HeadTailValue_305, TailTailValues_306, STATE_VARIABLE_SB_2_313, &STATE_VARIABLE_SB_5_90);
              }
            }
          }
          break;
        case (MR_Integer) 1:
          {
            ...
            MR_String RuleName_250 = ((MR_String) ((MR_hl_field(3, MmakeEntry_6, 1))));
            MR_Word IsPhony_251 = ((MR_Unsigned) ((MR_hl_field(3, MmakeEntry_6, 2))) & (MR_Integer) 1);
            MR_Word SourceFiles_252 = ((MR_Word) ((MR_hl_field(3, MmakeEntry_6, 4))));
            MR_Word Actions_253 = ((MR_Word) ((MR_hl_field(3, MmakeEntry_6, 5))));
            MR_Word STATE_VARIABLE_SB_12_256;
            MR_Word STATE_VARIABLE_SB_14_257;
            MR_Word STATE_VARIABLE_SB_17_259;
            MR_Word STATE_VARIABLE_SB_22_269;

            libs__mmakefiles__append_rule_name_3_p_0(RuleName_250, STATE_VARIABLE_SB_0_66, &STATE_VARIABLE_SB_12_256);
            ...
            libs__mmakefiles__maybe_append_phony_rule_4_p_0(IsPhony_251, Var_121, STATE_VARIABLE_SB_12_256, &STATE_VARIABLE_SB_13_122);
            libs__mmakefiles__append_mmake_file_name_3_p_0(TargetFile_29, STATE_VARIABLE_SB_13_122, &STATE_VARIABLE_SB_14_257);
            if ((SourceFiles_252 == (MR_Word) ((MR_Unsigned) 0U)))
              mercury__string__builder__append_string_3_p_0((MR_String) " :", STATE_VARIABLE_SB_14_257, &STATE_VARIABLE_SB_17_259);
            else
            {
              MR_String HeadSourceFile_227 = ((MR_String) ((MR_hl_field(1, SourceFiles_252, 0))));
              MR_Word TailSourceFiles_228 = ((MR_Word) ((MR_hl_field(1, SourceFiles_252, 1))));
              MR_Word STATE_VARIABLE_SB_18_230;

              mercury__string__builder__append_string_3_p_0((MR_String) " : ", STATE_VARIABLE_SB_14_257, &STATE_VARIABLE_SB_18_230);
              ...
              if (succeeded)
              {
                MR_Word STATE_VARIABLE_SB_19_219;

                mercury__string__builder__append_string_3_p_0((MR_String) "\\\n", STATE_VARIABLE_SB_18_230, &STATE_VARIABLE_SB_19_219);
                libs__mmakefiles__append_mmake_file_names_vertical_4_p_0(HeadSourceFile_227, TailSourceFiles_228, STATE_VARIABLE_SB_19_219, &STATE_VARIABLE_SB_17_259);
              }
              else
                libs__mmakefiles__append_mmake_file_names_horizontal_4_p_0(HeadSourceFile_227, TailSourceFiles_228, STATE_VARIABLE_SB_18_230, &STATE_VARIABLE_SB_17_259);
            }
            mercury__string__builder__append_string_3_p_0((MR_String) "\n", STATE_VARIABLE_SB_17_259, &STATE_VARIABLE_SB_22_269);
            libs__mmakefiles__append_mmake_actions_3_p_0(Actions_253, STATE_VARIABLE_SB_22_269, &STATE_VARIABLE_SB_5_90);
          }
          break;
        case (MR_Integer) 2:
          {
        ...
        case (MR_Integer) 4:
          {
            ...
            MR_Word SourceGroups_190 = ((MR_Word) ((MR_hl_field(3, MmakeEntry_6, 4))));
            MR_Word STATE_VARIABLE_SB_24_193;
            MR_Word STATE_VARIABLE_SB_25_194;
            MR_Word STATE_VARIABLE_SB_26_196;
            MR_Word STATE_VARIABLE_SB_28_197;
            MR_Word STATE_VARIABLE_SB_31_199;
            MR_Word STATE_VARIABLE_SB_34_203;
            MR_String RuleName_204 = ((MR_String) ((MR_hl_field(3, MmakeEntry_6, 1))));
            MR_Word IsPhony_205 = ((MR_Unsigned) ((MR_hl_field(3, MmakeEntry_6, 2))) & (MR_Integer) 1);
            MR_Word Actions_206 = ((MR_Word) ((MR_hl_field(3, MmakeEntry_6, 5))));

            libs__mmakefiles__append_rule_name_3_p_0(RuleName_204, STATE_VARIABLE_SB_0_66, &STATE_VARIABLE_SB_24_193);
            ...
            libs__mmakefiles__maybe_append_group_names_4_p_0((MR_String) "target", Var_146, STATE_VARIABLE_SB_24_193, &STATE_VARIABLE_SB_25_194);
            libs__mmakefiles__maybe_append_group_names_4_p_0((MR_String) "source", SourceGroups_190, STATE_VARIABLE_SB_25_194, &STATE_VARIABLE_SB_26_196);
            ...
            libs__mmakefiles__maybe_append_phony_rule_4_p_0(IsPhony_205, Var_154, STATE_VARIABLE_SB_26_196, &STATE_VARIABLE_SB_29_155);
            HeadTargetGroup_62 = ((MR_Word) ((MR_hl_field(0, TargetGroups_59, 0))));
            TailTargetGroups_63 = ((MR_Word) ((MR_hl_field(0, TargetGroups_59, 1))));
            libs__mmakefiles__append_mmake_file_name_groups_horizontal_4_p_0(HeadTargetGroup_62, TailTargetGroups_63, STATE_VARIABLE_SB_29_155, &STATE_VARIABLE_SB_28_197);
            if ((SourceGroups_190 == (MR_Word) ((MR_Unsigned) 0U)))
              mercury__string__builder__append_string_3_p_0((MR_String) " :", STATE_VARIABLE_SB_28_197, &STATE_VARIABLE_SB_31_199);
            else
            {
              MR_Word HeadSourceGroup_181 = ((MR_Word) ((MR_hl_field(1, SourceGroups_190, 0))));
              MR_Word TailSourceGroups_182 = ((MR_Word) ((MR_hl_field(1, SourceGroups_190, 1))));
              MR_Word STATE_VARIABLE_SB_32_184;

              mercury__string__builder__append_string_3_p_0((MR_String) " : \\\n", STATE_VARIABLE_SB_28_197, &STATE_VARIABLE_SB_32_184);
              libs__mmakefiles__append_mmake_file_name_groups_vertical_4_p_0(HeadSourceGroup_181, TailSourceGroups_182, STATE_VARIABLE_SB_32_184, &STATE_VARIABLE_SB_31_199);
            }
            mercury__string__builder__append_string_3_p_0((MR_String) "\n", STATE_VARIABLE_SB_31_199, &STATE_VARIABLE_SB_34_203);
            libs__mmakefiles__append_mmake_actions_3_p_0(Actions_206, STATE_VARIABLE_SB_34_203, &STATE_VARIABLE_SB_5_90);
          }
          break;
      }
      break;
