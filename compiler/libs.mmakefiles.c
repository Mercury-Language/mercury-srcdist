              ...
              case (MR_Integer) 2:
                {
                  ...
                  else
                  {
                    ...
                    mercury__builtin__compare_3_p_0((MR_Word) (&libs__mmakefiles_scalar_common_1[2]), &SubResult2_47, ((MR_Box) (Var_63)), ((MR_Box) (ArgY2_46)));
                    succeeded = (SubResult2_47 != (MR_Integer) 0);
                    if (succeeded)
                      *HeadVar__1_1 = SubResult2_47;
                    else
                    {
                      mercury__builtin__compare_3_p_0((MR_Word) (&libs__mmakefiles_scalar_common_1[2]), HeadVar__1_1, ((MR_Box) (Var_62)), ((MR_Box) (ArgY3_49)));
                    }
                  }
                }
                break;
                          ...
                          else
                          {
                            ...
                            else
                            {
                              ...
                              else
                              {
                                ...
                                mercury__builtin__compare_3_p_0((MR_Word) (&libs__mmakefiles_scalar_common_1[5]), &SubResult4_419, ((MR_Box) (Var_540)), ((MR_Box) (ArgY4_418)));
                      ...
                      case (MR_Integer) 4:
                        {
                          ...
                          else
                          {
                            ...
                            else
                            {
                              ...
                              mercury__builtin__compare_3_p_0((MR_Word) (&libs__mmakefiles_scalar_common_1[4]), &SubResult3_500, ((MR_Box) (Var_551)), ((MR_Box) (ArgY3_499)));
                              ...
                              else
                              {
                                ...
                                mercury__builtin__compare_3_p_0((MR_Word) (&libs__mmakefiles_scalar_common_1[5]), &SubResult4_503, ((MR_Box) (Var_550)), ((MR_Box) (ArgY4_502)));
        ...
        case (MR_Integer) 2:
          {
            ...
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                TypeInfo_19_19 = (MR_Word) (&libs__mmakefiles_scalar_common_1[2]);
                succeeded = mercury__builtin__unify_2_p_0(TypeInfo_19_19, ((MR_Box) (ArgX2_13)), ((MR_Box) (ArgY2_14)));
                if (succeeded)
                {
                  TypeInfo_20_20 = (MR_Word) (&libs__mmakefiles_scalar_common_1[2]);
                ...
                if (succeeded)
                {
                  ...
                  if (succeeded)
                  {
                    ...
                    if (succeeded)
                    {
                      ...
                      if (succeeded)
                      {
                        TypeInfo_66_66 = (MR_Word) (&libs__mmakefiles_scalar_common_1[5]);
            ...
            case (MR_Integer) 4:
              {
                ...
                if (succeeded)
                {
                  ...
                  if (succeeded)
                  {
                    ...
                    if (succeeded)
                    {
                      TypeInfo_71_71 = (MR_Word) (&libs__mmakefiles_scalar_common_1[4]);
                      succeeded = mercury__builtin__unify_2_p_0(TypeInfo_71_71, ((MR_Box) (ArgX3_57)), ((MR_Box) (ArgY3_58)));
                      if (succeeded)
                      {
                        TypeInfo_72_72 = (MR_Word) (&libs__mmakefiles_scalar_common_1[5]);
...
{
  {
    ...
    mercury__builtin__compare_3_p_0((MR_Word) (&libs__mmakefiles_scalar_common_1[1]), HeadVar__1_1, ((MR_Box) (Cast_HeadVar1_4)), ((MR_Box) (Cast_HeadVar2_5)));
  }
}
...
{
  {
    ...
    succeeded = mercury__builtin__unify_2_p_0((MR_Word) (&libs__mmakefiles_scalar_common_1[1]), ((MR_Box) (Cast_HeadVar1_3)), ((MR_Box) (Cast_HeadVar2_4)));
    return succeeded;
  }
}
