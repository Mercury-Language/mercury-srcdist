...
MR_decl_label5(transform_hlds__ctgc__structure_reuse__direct__choose_reuse__cons_has_no_packed_fields_2_0, 4,9,8,3,2)
...
MR_decl_static(transform_hlds__ctgc__structure_reuse__direct__choose_reuse__cons_has_no_packed_fields_2_0)
...
MR_decl_static(fn__transform_hlds__ctgc__structure_reuse__direct__choose_reuse__IntroducedFrom__func__dump_match_details__1375__1_1_0)
...
{
MR_COMMON(0,6),
MR_ENTRY_AP(fn__transform_hlds__ctgc__structure_reuse__direct__choose_reuse__IntroducedFrom__func__dump_match_details__1375__1_1_0),
0
},
{
MR_COMMON(8,0),
...
"transform_hlds.ctgc.structure_reuse.direct.choose_reuse",
"transform_hlds.ctgc.structure_reuse.direct.choose_reuse",
"lambda_structure_reuse_direct_choose_reuse_m_1375",
2,
0
},
"transform_hlds.ctgc.structure_reuse.direct.choose_reuse",
...
MR_BEGIN_MODULE(transform_hlds__ctgc__structure_reuse__direct__choose_reuse_module35)
	MR_init_entry1(transform_hlds__ctgc__structure_reuse__direct__choose_reuse__cons_has_no_packed_fields_2_0);
	MR_INIT_PROC_LAYOUT_ADDR(mercury__transform_hlds__ctgc__structure_reuse__direct__choose_reuse__cons_has_no_packed_fields_2_0);
	MR_init_label5(transform_hlds__ctgc__structure_reuse__direct__choose_reuse__cons_has_no_packed_fields_2_0,4,9,8,3,2)
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'cons_has_no_packed_fields'/2 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(transform_hlds__ctgc__structure_reuse__direct__choose_reuse__cons_has_no_packed_fields_2_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(4);
	MR_sv(4) = (MR_Word) MR_succip;
	if (MR_RTAGS_TESTR(MR_r2,3,2)) {
		MR_GOTO_LAB(transform_hlds__ctgc__structure_reuse__direct__choose_reuse__cons_has_no_packed_fields_2_0_i3);
	}
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r2;
	...
	MR_np_call_localret_ent(check_hlds__type_util__get_cons_defn_det_4_0,
		transform_hlds__ctgc__structure_reuse__direct__choose_reuse__cons_has_no_packed_fields_2_0_i4);
MR_def_label(transform_hlds__ctgc__structure_reuse__direct__choose_reuse__cons_has_no_packed_fields_2_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(1) = (MR_Word) MR_redoip_slot(MR_maxfr);
	MR_sv(2) = (MR_Word) MR_redofr_slot(MR_maxfr);
	MR_save_maxfr(MR_sv(3));
	MR_redofr_slot_word(MR_maxfr) = (MR_Word) MR_curfr;
	MR_redoip_slot_word(MR_maxfr) = (MR_Word) MR_LABEL_AP(transform_hlds__ctgc__structure_reuse__direct__choose_reuse__cons_has_no_packed_fields_2_0_i8);
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
	...
	MR_np_call_localret_ent(list__member_2_1,
		transform_hlds__ctgc__structure_reuse__direct__choose_reuse__cons_has_no_packed_fields_2_0_i9);
MR_def_label(transform_hlds__ctgc__structure_reuse__direct__choose_reuse__cons_has_no_packed_fields_2_0,9)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	...
	MR_r1 = MR_FALSE;
	MR_proceed();
MR_def_label(transform_hlds__ctgc__structure_reuse__direct__choose_reuse__cons_has_no_packed_fields_2_0,8)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_redoip_slot_word(MR_maxfr) = MR_sv(1);
	MR_redofr_slot_word(MR_maxfr) = MR_sv(2);
	MR_succip_word = MR_sv(4);
	...
	MR_r1 = MR_TRUE;
	MR_proceed();
MR_def_label(transform_hlds__ctgc__structure_reuse__direct__choose_reuse__cons_has_no_packed_fields_2_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_RTAGS_TEST(MR_r2,3,3)) {
		MR_GOTO_LAB(transform_hlds__ctgc__structure_reuse__direct__choose_reuse__cons_has_no_packed_fields_2_0_i2);
	}
	MR_r1 = (MR_Word) MR_string_const("transform_hlds.ctgc.structure_reuse.direct.choose_reuse", 55);
	MR_r2 = (MR_Word) MR_string_const("predicate \140transform_hlds.ctgc.structure_reuse.direct.choose_reuse.cons_has_no_packed_fields\'/2", 95);
	MR_r3 = (MR_Word) MR_string_const("unusual cons_id", 15);
	MR_np_call_localret_ent(require__unexpected_3_0,
		transform_hlds__ctgc__structure_reuse__direct__choose_reuse__cons_has_no_packed_fields_2_0_i2);
MR_def_label(transform_hlds__ctgc__structure_reuse__direct__choose_reuse__cons_has_no_packed_fields_2_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_succip_word = MR_sv(4);
	MR_decr_sp(4);
	MR_r1 = MR_TRUE;
...
MR_def_label(transform_hlds__ctgc__structure_reuse__direct__choose_reuse__compute_reuse_type_6_0,2)
	...
	MR_np_call_localret_ent(transform_hlds__ctgc__structure_reuse__direct__choose_reuse__cons_has_no_packed_fields_2_0,
...
MR_def_label(transform_hlds__ctgc__structure_reuse__direct__choose_reuse__compute_reuse_type_6_0,28)
	...
	MR_r3 = MR_sv(1);
	MR_sv(1) = MR_tempr1;
	MR_sv(2) = ((MR_Integer) MR_sv(2) - (MR_Integer) MR_tempr1);
	MR_r1 = (MR_Integer) 1;
	}
...
MR_def_label(transform_hlds__ctgc__structure_reuse__direct__choose_reuse__compute_reuse_type_6_0,21)
	...
	{
	MR_Word MR_tempr1;
	MR_tempr1 = ((MR_Integer) MR_sv(11) + (MR_Integer) 0);
	MR_r5 = MR_tempr1;
	if (((MR_Integer) MR_tempr1 > (MR_Integer) MR_sv(2))) {
		MR_GOTO_LAB(transform_hlds__ctgc__structure_reuse__direct__choose_reuse__compute_reuse_type_6_0_i1);
	}
...
MR_def_label(transform_hlds__ctgc__structure_reuse__direct__choose_reuse__compute_reuse_type_6_0,43)
	...
	MR_Word MR_tempr1, MR_tempr2;
	MR_tempr2 = MR_sv(1);
	MR_tempr1 = ((((((MR_Integer) 6 * (MR_Integer) MR_tempr2) + (MR_Integer) 1) - ((MR_Integer) 1 * ((MR_Integer) MR_tempr2 - (MR_Integer) MR_r1))) - ((MR_Integer) 1 * (MR_Integer) MR_r2)) - ((MR_Integer) 5 * (MR_Integer) MR_sv(2)));
...
MR_BEGIN_MODULE(transform_hlds__ctgc__structure_reuse__direct__choose_reuse_module67)
	MR_init_entry1(fn__transform_hlds__ctgc__structure_reuse__direct__choose_reuse__IntroducedFrom__func__dump_match_details__1375__1_1_0);
	MR_INIT_PROC_LAYOUT_ADDR(mercury__fn__transform_hlds__ctgc__structure_reuse__direct__choose_reuse__IntroducedFrom__func__dump_match_details__1375__1_1_0);
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'IntroducedFrom__func__dump_match_details__1375__1'/2 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(fn__transform_hlds__ctgc__structure_reuse__direct__choose_reuse__IntroducedFrom__func__dump_match_details__1375__1_1_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_tfield(0, MR_r1, 4);
	MR_proceed();
#ifdef MR_maybe_local_thread_engine_base
