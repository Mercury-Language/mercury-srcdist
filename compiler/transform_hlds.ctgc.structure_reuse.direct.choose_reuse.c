            ...
            case (MR_Integer) 0:
              {
                ...
                parse_tree__var_table__lookup_var_type_3_p_0(Var_91, Var_15, &VarType_22);
  ...
  MR_Word * ReuseAs_11)
{
  ...
  hlds__hlds_pred__proc_info_get_var_table_3_p_0(ModuleInfo_7, ProcInfo_8, &VarTable_24);
  {
    ...
    MR_hl_field(MR_mktag(0), BackGroundInfo_14, 3) = ((MR_Box) (VarTable_24));
  }
