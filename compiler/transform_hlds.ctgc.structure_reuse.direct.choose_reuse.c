  ...
  MR_Word * ReuseAs_11)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_12, (MR_Integer) 518, &FreeCells_16);
  switch (FreeCells_16) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 0:
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      else
      {
        ...
        libs__globals__lookup_int_option_3_p_0(Globals_13, (MR_Integer) 516, &MaxConditions_24);
  ...
  MR_Word HighestMatch_8)
{
  ...
  Var_26 = mercury__string__count_code_points_1_f_0(Start_21);
  ...
  if (succeeded)
  {
    ...
    Var_51 = mercury__string__count_code_points_1_f_0(Start_46);
  ...
  else
  {
    ...
    Var_63 = mercury__string__count_code_points_1_f_0(Start_58);
    ...
    Var_75 = mercury__string__count_code_points_1_f_0(Start_70);
  ...
  Var_87 = mercury__string__count_code_points_1_f_0(Start_82);
