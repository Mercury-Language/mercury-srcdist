...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_12, (MR_Integer) 432, &FreeCells_16);
    switch (FreeCells_16) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      else
      {
        ...
        libs__globals__lookup_int_option_3_p_0(Globals_13, (MR_Integer) 430, &MaxConditions_23);
