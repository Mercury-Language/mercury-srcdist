  ...
  while (MR_TRUE)
    {
      /* tailcall optimized into a loop */
      {
        ...
        {
          libs__globals__lookup_bool_option_3_p_0(transform_hlds__ctgc__structure_reuse__direct__choose_reuse__Globals_13, (MR_Integer) 53, &transform_hlds__ctgc__structure_reuse__direct__choose_reuse__VeryVerbose_14);
        }
        {
      ...
      case (MR_Integer) 1:
        {
          ...
          {
            libs__globals__lookup_bool_option_3_p_0(transform_hlds__ctgc__structure_reuse__direct__choose_reuse__Globals_12, (MR_Integer) 53, &transform_hlds__ctgc__structure_reuse__direct__choose_reuse__VeryVerbose_17);
          }
          {
