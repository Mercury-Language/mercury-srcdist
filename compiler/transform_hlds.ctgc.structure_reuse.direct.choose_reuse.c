  ...
  MR_Word * ReuseAs_11)
{
  ...
  hlds__hlds_pred__proc_info_get_varset_vartypes_3_p_0(ProcInfo_8, &_VarSet_29, &VarTypes_30);
  {
    ...
    MR_hl_field(MR_mktag(0), BackGroundInfo_14, 3) = ((MR_Box) (VarTypes_30));
  }
    ...
    case (MR_Integer) 1:
      {
        ...
        MR_Word DeadCellTable_36;

        libs__globals__lookup_bool_option_3_p_0(Globals_12, (MR_Integer) 72, &VeryVerbose_17);
        transform_hlds__ctgc__structure_reuse__direct__dead_cell_table_remove_conditionals_2_p_0(RemainingDeadCellTable_15, &DeadCellTable_36);
        succeeded = transform_hlds__ctgc__structure_reuse__direct__dead_cell_table_is_empty_1_p_0(DeadCellTable_36);
        if (succeeded)
        {
          MR_Word StdErr_48;

          mercury__io__stderr_stream_3_p_0(&StdErr_48);
          libs__file_util__maybe_write_string_5_p_0(StdErr_48, VeryVerbose_17, (MR_String) "% No cells to be cached/freed.\n");
          *STATE_VARIABLE_Goal_19 = STATE_VARIABLE_Goal_20_20;
        }
        else
        {
          ...
          libs__file_util__maybe_write_string_5_p_0(StdErr_49, VeryVerbose_17, (MR_String) "% Marking cacheable/freeable cells.\n");
          transform_hlds__ctgc__structure_reuse__direct__choose_reuse__check_for_cell_caching_2_3_p_0(DeadCellTable_36, STATE_VARIABLE_Goal_20_20, STATE_VARIABLE_Goal_19);
        }
      }
      break;
  }
  ...
  MR_Word * STATE_VARIABLE_Table_15)
{
...

  {
    ...
    MR_hl_field(MR_mktag(0), Var_35, 0) = ((MR_Box) (&transform_hlds__ctgc__structure_reuse__direct__choose_reuse_scalar_common_7[0]));
  ...
  else
  {
    ...
    else
    {
...

      {
        ...
        MR_hl_field(MR_mktag(0), Var_47, 0) = ((MR_Box) (&transform_hlds__ctgc__structure_reuse__direct__choose_reuse_scalar_common_5[1]));
