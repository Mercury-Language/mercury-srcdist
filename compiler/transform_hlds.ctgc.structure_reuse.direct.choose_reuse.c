...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(transform_hlds__ctgc__structure_reuse__direct__choose_reuse__Globals_12, (MR_Integer) 422, &transform_hlds__ctgc__structure_reuse__direct__choose_reuse__FreeCells_16);
    ...
    /* tailcall optimized into a loop */
    {
      ...
      else
      {
        ...
        else
        {
          ...
          libs__globals__lookup_int_option_3_p_0(transform_hlds__ctgc__structure_reuse__direct__choose_reuse__Globals_13, (MR_Integer) 420, &transform_hlds__ctgc__structure_reuse__direct__choose_reuse__MaxConditions_23);
