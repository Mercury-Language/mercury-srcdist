...
{
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        TypeInfo_14_14 = (MR_Word) (&transform_hlds__ctgc__structure_reuse__direct__choose_reuse_scalar_common_1[5]);
...
{
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        TypeInfo_11_11 = (MR_Word) (&transform_hlds__ctgc__structure_reuse__direct__choose_reuse_scalar_common_1[4]);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_12, (MR_Integer) 437, &FreeCells_16);
    switch (FreeCells_16) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
      ...
      case (MR_Integer) 1:
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_12, (MR_Integer) 61, &VeryVerbose_17);
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      else
      {
        ...
        libs__globals__lookup_int_option_3_p_0(Globals_13, (MR_Integer) 435, &MaxConditions_23);
      ...
      case (MR_Integer) 0:
        {
          ...
          if (succeeded)
          {
            ...
            TypeInfo_17_67 = (MR_Word) (&transform_hlds__ctgc__structure_reuse__direct__choose_reuse_scalar_common_1[5]);
