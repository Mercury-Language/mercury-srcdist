...
MR_decl_label8(ll_backend__code_util__goal_may_alloc_temp_frame_2_2_0, 51,33,4,6,9,11,10,13)
MR_decl_label8(ll_backend__code_util__goal_may_alloc_temp_frame_2_2_0, 12,17,20,21,40,23,25,27)
MR_decl_label5(ll_backend__code_util__lvals_in_lval_2_0, 45,5,6,28,29)
MR_decl_label3(ll_backend__code_util__lvals_in_lvals_2_0, 14,4,5)
MR_decl_label4(ll_backend__code_util__lvals_in_mem_ref_2_0, 16,24,6,7)
MR_decl_label8(ll_backend__code_util__lvals_in_rval_2_0, 8,9,13,21,3,4,5,7)
MR_decl_label1(ll_backend__code_util__lvals_in_rval_2_0, 15)
...
MR_decl_label8(ll_backend__code_util__neg_rval_2_0, 6,8,10,12,14,16,18,20)
MR_decl_label8(ll_backend__code_util__neg_rval_2_0, 22,24,26,28,30,32,34,36)
MR_decl_label6(ll_backend__code_util__neg_rval_2_0, 38,40,44,46,50,2)
...
MR_decl_label7(fn__ll_backend__code_util__make_entry_label_from_rtti_2_0, 4,2,6,8,19,18,17)
MR_decl_label1(fn__ll_backend__code_util__make_internal_label_4_0, 2)
MR_decl_label6(fn__ll_backend__code_util__make_local_entry_label_4_0, 2,3,5,14,13,12)
...
MR_BEGIN_MODULE(ll_backend__code_util_module0)
	...
	MR_init_label7(fn__ll_backend__code_util__make_entry_label_from_rtti_2_0,4,2,6,8,19,18,17)
MR_BEGIN_CODE
...
MR_def_label(fn__ll_backend__code_util__make_entry_label_from_rtti_2_0,6)
	...
	if (MR_LTAGS_TESTR(MR_sv(2),0,0)) {
		MR_GOTO_LAB(fn__ll_backend__code_util__make_entry_label_from_rtti_2_0_i8);
	}
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_ctfield(0, MR_sv(1), 14);
	if (MR_INT_NE(MR_tempr1,1)) {
		MR_GOTO_LAB(fn__ll_backend__code_util__make_entry_label_from_rtti_2_0_i17);
	}
...
MR_def_label(fn__ll_backend__code_util__make_entry_label_from_rtti_2_0,8)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	...
	if (MR_INT_NE(MR_r6,0)) {
		MR_GOTO_LAB(fn__ll_backend__code_util__make_entry_label_from_rtti_2_0_i19);
	}
	MR_sv(1) = MR_r1;
	MR_GOTO_LAB(fn__ll_backend__code_util__make_entry_label_from_rtti_2_0_i18);
	}
MR_def_label(fn__ll_backend__code_util__make_entry_label_from_rtti_2_0,19)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if ((MR_r3 != MR_r7)) {
		MR_GOTO_LAB(fn__ll_backend__code_util__make_entry_label_from_rtti_2_0_i17);
	}
	...
	MR_sv(1) = MR_r1;
MR_def_label(fn__ll_backend__code_util__make_entry_label_from_rtti_2_0,18)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 2);
...
MR_def_label(fn__ll_backend__code_util__make_entry_label_from_rtti_2_0,17)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 2);
...
MR_BEGIN_MODULE(ll_backend__code_util_module2)
	...
	MR_init_label6(fn__ll_backend__code_util__make_local_entry_label_4_0,2,3,5,14,13,12)
MR_BEGIN_CODE
...
MR_def_label(fn__ll_backend__code_util__make_local_entry_label_4_0,5)
	...
	MR_r6 = MR_ctfield(0, MR_tempr1, 0);
	if (MR_INT_NE(MR_r6,0)) {
		MR_GOTO_LAB(fn__ll_backend__code_util__make_local_entry_label_4_0_i14);
	}
	MR_sv(1) = MR_r1;
	MR_GOTO_LAB(fn__ll_backend__code_util__make_local_entry_label_4_0_i13);
	}
MR_def_label(fn__ll_backend__code_util__make_local_entry_label_4_0,14)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if ((MR_r3 != MR_r7)) {
		MR_GOTO_LAB(fn__ll_backend__code_util__make_local_entry_label_4_0_i12);
	}
...
MR_BEGIN_MODULE(ll_backend__code_util_module11)
	...
	MR_init_label8(ll_backend__code_util__goal_may_alloc_temp_frame_2_2_0,51,33,4,6,9,11,10,13)
	MR_init_label8(ll_backend__code_util__goal_may_alloc_temp_frame_2_2_0,12,17,20,21,40,23,25,27)
MR_BEGIN_CODE
...
MR_def_static(ll_backend__code_util__goal_may_alloc_temp_frame_2_2_0)
	...
	MR_incr_sp(3);
	MR_sv(3) = (MR_Word) MR_succip;
MR_def_label(ll_backend__code_util__goal_may_alloc_temp_frame_2_2_0,51)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_EQ(MR_tag(MR_r1),3)) {
		MR_GOTO_LAB(ll_backend__code_util__goal_may_alloc_temp_frame_2_2_0_i33);
	}
	MR_r1 = (MR_Integer) 0;
	MR_decr_sp_and_return(3);
MR_def_label(ll_backend__code_util__goal_may_alloc_temp_frame_2_2_0,33)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_COMPUTED_GOTO((MR_Unsigned) MR_ctfield(3, MR_r1, 0),
		MR_LABEL_AP(ll_backend__code_util__goal_may_alloc_temp_frame_2_2_0_i40) MR_AND
		MR_LABEL_AP(ll_backend__code_util__goal_may_alloc_temp_frame_2_2_0_i4) MR_AND
		MR_LABEL_AP(ll_backend__code_util__goal_may_alloc_temp_frame_2_2_0_i6) MR_AND
		MR_LABEL_AP(ll_backend__code_util__goal_may_alloc_temp_frame_2_2_0_i27) MR_AND
		MR_LABEL_AP(ll_backend__code_util__goal_may_alloc_temp_frame_2_2_0_i17) MR_AND
		MR_LABEL_AP(ll_backend__code_util__goal_may_alloc_temp_frame_2_2_0_i20) MR_AND
		MR_LABEL_AP(ll_backend__code_util__goal_may_alloc_temp_frame_2_2_0_i9) MR_AND
		MR_LABEL_AP(ll_backend__code_util__goal_may_alloc_temp_frame_2_2_0_i25));
...
MR_def_label(ll_backend__code_util__goal_may_alloc_temp_frame_2_2_0,12)
	...
	MR_succip_word = MR_sv(3);
	MR_GOTO_LAB(ll_backend__code_util__goal_may_alloc_temp_frame_2_2_0_i51);
...
MR_def_label(ll_backend__code_util__goal_may_alloc_temp_frame_2_2_0,40)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Integer) 1;
	MR_decr_sp_and_return(3);
...
MR_def_label(ll_backend__code_util__goal_may_alloc_temp_frame_2_2_0,25)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_string_const("code_util.m", 11);
	MR_r2 = (MR_Word) MR_string_const("goal_may_alloc_temp_frame_2: shorthand", 38);
	MR_succip_word = MR_sv(3);
	MR_decr_sp(3);
	MR_np_tailcall_ent(libs__compiler_util__unexpected_2_0);
...
MR_BEGIN_MODULE(ll_backend__code_util_module14)
	...
	MR_init_label8(ll_backend__code_util__neg_rval_2_0,6,8,10,12,14,16,18,20)
	MR_init_label8(ll_backend__code_util__neg_rval_2_0,22,24,26,28,30,32,34,36)
	MR_init_label6(ll_backend__code_util__neg_rval_2_0,38,40,44,46,50,2)
MR_BEGIN_CODE
...
MR_define_entry(mercury__ll_backend__code_util__neg_rval_2_0);
	...
	if (MR_INT_EQ(MR_tempr1,1)) {
		MR_GOTO_LAB(ll_backend__code_util__neg_rval_2_0_i50);
	}
	...
	MR_COMPUTED_GOTO((MR_Unsigned) MR_unmkbody(MR_tempr2),
		...
		MR_LABEL_AP(ll_backend__code_util__neg_rval_2_0_i2) MR_AND
		MR_LABEL_AP(ll_backend__code_util__neg_rval_2_0_i2) MR_AND
		MR_LABEL_AP(ll_backend__code_util__neg_rval_2_0_i6) MR_AND
		MR_LABEL_AP(ll_backend__code_util__neg_rval_2_0_i28) MR_AND
		MR_LABEL_AP(ll_backend__code_util__neg_rval_2_0_i2) MR_AND
		MR_LABEL_AP(ll_backend__code_util__neg_rval_2_0_i30) MR_AND
		MR_LABEL_AP(ll_backend__code_util__neg_rval_2_0_i40) MR_AND
		MR_LABEL_AP(ll_backend__code_util__neg_rval_2_0_i38) MR_AND
		MR_LABEL_AP(ll_backend__code_util__neg_rval_2_0_i34) MR_AND
		MR_LABEL_AP(ll_backend__code_util__neg_rval_2_0_i36) MR_AND
		...
		MR_LABEL_AP(ll_backend__code_util__neg_rval_2_0_i2) MR_AND
		MR_LABEL_AP(ll_backend__code_util__neg_rval_2_0_i2) MR_AND
		MR_LABEL_AP(ll_backend__code_util__neg_rval_2_0_i8) MR_AND
		MR_LABEL_AP(ll_backend__code_util__neg_rval_2_0_i18) MR_AND
		MR_LABEL_AP(ll_backend__code_util__neg_rval_2_0_i16) MR_AND
		MR_LABEL_AP(ll_backend__code_util__neg_rval_2_0_i12) MR_AND
		MR_LABEL_AP(ll_backend__code_util__neg_rval_2_0_i14) MR_AND
		MR_LABEL_AP(ll_backend__code_util__neg_rval_2_0_i10) MR_AND
		MR_LABEL_AP(ll_backend__code_util__neg_rval_2_0_i2) MR_AND
...
MR_def_label(ll_backend__code_util__neg_rval_2_0,40)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2, MR_tempr3;
	MR_tag_alloc_heap(MR_tempr1, 3, (MR_Integer) 4);
...
MR_def_label(ll_backend__code_util__neg_rval_2_0,44)
	...
	if (MR_LTAGS_TESTR(MR_r2,0,1)) {
		MR_GOTO_LAB(ll_backend__code_util__neg_rval_2_0_i46);
	}
	MR_tempr1 = MR_tempr2;
	MR_r1 = (MR_Word) MR_TAG_COMMON(3,0,0);
	MR_proceed();
	}
MR_def_label(ll_backend__code_util__neg_rval_2_0,46)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_def_label(ll_backend__code_util__neg_rval_2_0,50)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tempr2 = MR_r1;
...
MR_BEGIN_MODULE(ll_backend__code_util_module16)
	...
	MR_init_label8(ll_backend__code_util__lvals_in_rval_2_0,8,9,13,21,3,4,5,7)
	MR_init_label1(ll_backend__code_util__lvals_in_rval_2_0,15)
MR_BEGIN_CODE
...
MR_define_entry(mercury__ll_backend__code_util__lvals_in_rval_2_0);
	...
	MR_COMPUTED_GOTO((MR_Unsigned) MR_tag(MR_r1),
		MR_LABEL_AP(ll_backend__code_util__lvals_in_rval_2_0_i8) MR_AND
		MR_LABEL_AP(ll_backend__code_util__lvals_in_rval_2_0_i7) MR_AND
		MR_LABEL_AP(ll_backend__code_util__lvals_in_rval_2_0_i13) MR_AND
		MR_LABEL_AP(ll_backend__code_util__lvals_in_rval_2_0_i21));
MR_def_label(ll_backend__code_util__lvals_in_rval_2_0,8)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(1) = MR_ctfield(0, MR_r1, 0);
	MR_r1 = MR_sv(1);
	MR_np_call_localret_ent(ll_backend__code_util__lvals_in_lval_2_0,
		ll_backend__code_util__lvals_in_rval_2_0_i9);
...
MR_def_label(ll_backend__code_util__lvals_in_rval_2_0,13)
	...
	MR_COMPUTED_GOTO((MR_Unsigned) MR_tag(MR_r1),
		...
		MR_LABEL_AP(ll_backend__code_util__lvals_in_rval_2_0_i13) MR_AND
		MR_LABEL_AP(ll_backend__code_util__lvals_in_rval_2_0_i21));
MR_def_label(ll_backend__code_util__lvals_in_rval_2_0,21)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_ctfield(3, MR_r1, 0);
	if (MR_INT_EQ(MR_tempr1,0)) {
		MR_GOTO_LAB(ll_backend__code_util__lvals_in_rval_2_0_i7);
	}
	if (MR_INT_EQ(MR_tempr1,1)) {
		MR_GOTO_LAB(ll_backend__code_util__lvals_in_rval_2_0_i15);
	}
	if (MR_INT_EQ(MR_tempr1,2)) {
		MR_GOTO_LAB(ll_backend__code_util__lvals_in_rval_2_0_i3);
	}
	MR_r1 = MR_ctfield(3, MR_r1, 1);
	MR_succip_word = MR_sv(2);
	MR_decr_sp(2);
...
MR_def_label(ll_backend__code_util__lvals_in_rval_2_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(1) = MR_ctfield(3, MR_r1, 3);
	MR_r1 = MR_ctfield(3, MR_r1, 2);
	MR_np_localcall_lab(ll_backend__code_util__lvals_in_rval_2_0,
		ll_backend__code_util__lvals_in_rval_2_0_i4);
...
MR_BEGIN_MODULE(ll_backend__code_util_module17)
	...
	MR_init_label5(ll_backend__code_util__lvals_in_lval_2_0,45,5,6,28,29)
MR_BEGIN_CODE
...
MR_define_entry(mercury__ll_backend__code_util__lvals_in_lval_2_0);
	...
	if (MR_INT_NE(MR_tag(MR_r1),3)) {
		MR_GOTO_LAB(ll_backend__code_util__lvals_in_lval_2_0_i28);
	}
	MR_COMPUTED_GOTO((MR_Unsigned) MR_ctfield(3, MR_r1, 0),
		MR_LABEL_AP(ll_backend__code_util__lvals_in_lval_2_0_i28) MR_AND
		MR_LABEL_AP(ll_backend__code_util__lvals_in_lval_2_0_i28) MR_AND
		MR_LABEL_AP(ll_backend__code_util__lvals_in_lval_2_0_i28) MR_AND
		MR_LABEL_AP(ll_backend__code_util__lvals_in_lval_2_0_i29) MR_AND
		MR_LABEL_AP(ll_backend__code_util__lvals_in_lval_2_0_i29) MR_AND
		MR_LABEL_AP(ll_backend__code_util__lvals_in_lval_2_0_i29) MR_AND
		MR_LABEL_AP(ll_backend__code_util__lvals_in_lval_2_0_i29) MR_AND
		MR_LABEL_AP(ll_backend__code_util__lvals_in_lval_2_0_i29) MR_AND
		MR_LABEL_AP(ll_backend__code_util__lvals_in_lval_2_0_i45) MR_AND
		MR_LABEL_AP(ll_backend__code_util__lvals_in_lval_2_0_i29) MR_AND
		MR_LABEL_AP(ll_backend__code_util__lvals_in_lval_2_0_i28) MR_AND
		MR_LABEL_AP(ll_backend__code_util__lvals_in_lval_2_0_i28));
MR_def_label(ll_backend__code_util__lvals_in_lval_2_0,45)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(2);
	MR_sv(2) = (MR_Word) MR_succip;
	MR_sv(1) = MR_ctfield(3, MR_r1, 3);
	...
	MR_np_call_localret_ent(ll_backend__code_util__lvals_in_rval_2_0,
		ll_backend__code_util__lvals_in_lval_2_0_i5);
MR_def_label(ll_backend__code_util__lvals_in_lval_2_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_sv(1);
	...
	MR_np_call_localret_ent(ll_backend__code_util__lvals_in_rval_2_0,
		ll_backend__code_util__lvals_in_lval_2_0_i6);
MR_def_label(ll_backend__code_util__lvals_in_lval_2_0,6)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
...
MR_BEGIN_MODULE(ll_backend__code_util_module18)
	...
	MR_init_label4(ll_backend__code_util__lvals_in_mem_ref_2_0,16,24,6,7)
MR_BEGIN_CODE
...
MR_def_static(ll_backend__code_util__lvals_in_mem_ref_2_0)
	...
	if ((MR_tempr1 == MR_mktag((MR_Integer) 1))) {
		MR_GOTO_LAB(ll_backend__code_util__lvals_in_mem_ref_2_0_i16);
	}
	if ((MR_tempr1 == MR_mktag((MR_Integer) 2))) {
		MR_GOTO_LAB(ll_backend__code_util__lvals_in_mem_ref_2_0_i24);
	}
	}
MR_def_label(ll_backend__code_util__lvals_in_mem_ref_2_0,16)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_const_mask_field(MR_r1, 0);
	MR_np_tailcall_ent(ll_backend__code_util__lvals_in_rval_2_0);
MR_def_label(ll_backend__code_util__lvals_in_mem_ref_2_0,24)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(2);
	MR_sv(2) = (MR_Word) MR_succip;
	...
	MR_r1 = MR_ctfield(2, MR_r1, 0);
	MR_np_call_localret_ent(ll_backend__code_util__lvals_in_rval_2_0,
		ll_backend__code_util__lvals_in_mem_ref_2_0_i6);
MR_def_label(ll_backend__code_util__lvals_in_mem_ref_2_0,6)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_sv(1);
