  ...
  while (MR_TRUE)
  {
    /* tailcall optimized into a loop */
    {
      ...
      else
      {
        ...
        /* direct tailcall eliminated */
        {
          MR_Word next_value_of_HeadVar__1_1 = Lvals_13;
          MR_Integer next_value_of_STATE_VARIABLE_MaxRegR_0_2 = STATE_VARIABLE_MaxRegR_23_23;
          MR_Integer next_value_of_STATE_VARIABLE_MaxRegF_0_4 = STATE_VARIABLE_MaxRegF_22_22;
