        ...
        case (MR_Integer) 12:
          {
            ...
            MR_Unsigned packed_args_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), HeadVar__1_1, (MR_Integer) 6)));
        ...
        case (MR_Integer) 27:
          {
            ...
            MR_Unsigned packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), HeadVar__1_1, (MR_Integer) 9)));
...
{
  {
    ...
    else
    {
      ...
      MR_Word Lvals_6;
      MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Output_3, (MR_Integer) 2)));
      MR_Unsigned packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Output_3, (MR_Integer) 6)));
...
{
  {
    ...
    else
    {
      ...
      MR_Word Rvals_6;
      MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Input_3, (MR_Integer) 2)));
      MR_Unsigned packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Input_3, (MR_Integer) 6)));
    ...
    else
    {
      ...
      switch (MR_tag((MR_Word) CellArg_7)) {
        ...
        case (MR_Integer) 2:
          ...
          break;
        case (MR_Integer) 3:
          switch (((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), CellArg_7, (MR_Integer) 0)))) {
            default: /*NOTREACHED*/ MR_assert(0);
            case (MR_Integer) 0:
              CellSize_14 = (MR_Integer) 1;
              break;
  ...
  MR_Word * HeadVar__2_2)
{
  ...
  else
  {
    ...
    packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Arg_4, (MR_Integer) 1)));
      ...
      case (MR_Integer) 0:
        {
          ...
          MR_Unsigned packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Loc_7, (MR_Integer) 0)));

          {
            Reg_9 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), Reg_9, 0) = (MR_Box) (packed_args_1);
      ...
      if (succeeded)
      {
        ...
        Target_11 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Var_15, (MR_Integer) 2))));
        {
          ...
          ll_backend__code_util__neg_rval_2_p_0(Test_10, &NewTest_13);
          {
            ...
            MR_hl_field(MR_mktag(3), Var_17, 0) = ((MR_Box) ((MR_Unsigned) 9U));
              ...
              switch (MR_tag((MR_Word) Op_11)) {
                ...
                case (MR_Integer) 0:
                  switch (MR_unmkbody(Op_11)) {
                    ...
                    case (MR_Integer) 17:
                      {
                        NegOp_14 = (MR_Word) ((MR_Unsigned) 64U);
                        succeeded = MR_TRUE;
                      }
                      break;
                    case (MR_Integer) 18:
                    ...
                    case (MR_Integer) 8:
                      {
...

                        {
                          ...
                          MR_hl_field(MR_mktag(3), NegOp_14, 1) = (MR_Box) (packed_args_0);
                        }
                        succeeded = MR_TRUE;
                      }
                      break;
                    case (MR_Integer) 9:
                      {
...

                        {
                          ...
                          MR_hl_field(MR_mktag(3), NegOp_14, 1) = (MR_Box) (packed_args_5);
                        }
                        succeeded = MR_TRUE;
                      }
                      break;
                    case (MR_Integer) 12:
                      {
...

                        {
                          ...
                          MR_hl_field(MR_mktag(3), NegOp_14, 1) = (MR_Box) (packed_args_4);
                        }
                        succeeded = MR_TRUE;
                      }
                      break;
                    case (MR_Integer) 13:
                      {
...

                        {
                          ...
                          MR_hl_field(MR_mktag(3), NegOp_14, 1) = (MR_Box) (packed_args_2);
                        }
                        succeeded = MR_TRUE;
                      }
                      break;
                    case (MR_Integer) 14:
                      {
...

                        {
                          ...
                          MR_hl_field(MR_mktag(3), NegOp_14, 1) = (MR_Box) (packed_args_3);
                        }
                        succeeded = MR_TRUE;
                      }
                      break;
                    case (MR_Integer) 15:
                      {
...

                        {
                          ...
                          MR_hl_field(MR_mktag(3), NegOp_14, 1) = (MR_Box) (packed_args_1);
                        }
                        succeeded = MR_TRUE;
                      }
                      break;
          ...
          case (MR_Integer) 4:
            {
              ...
              MR_Unsigned packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), GoalExpr_3, (MR_Integer) 2)));
  ...
  MR_Integer * STATE_VARIABLE_MaxRegF_5)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), Lval_12, (MR_Integer) 0)));
...
{
  {
    ...
    packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), RttiProcLabel_11, (MR_Integer) 0)));
    ...
    packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), RttiProcLabel_11, (MR_Integer) 10)));
    packed_args_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), RttiProcLabel_11, (MR_Integer) 12)));
    Var_71 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), RttiProcLabel_11, (MR_Integer) 12))) >> (MR_Integer) 1)) & (MR_Integer) 1);
    if ((Immed_9 == (MR_Word) ((MR_Unsigned) 0U)))
    {
    ...
    else
    {
      ...
      {
        Label_10 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), Label_10, 0) = (MR_Box) ((MR_Unsigned) (EntryType_93));
        MR_hl_field(MR_mktag(1), Label_10, 1) = ((MR_Box) (ProcLabel_15));
      }
    }
    return Label_10;
...
{
  {
    ...
    MR_Unsigned packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), RttiProcLabel_4, (MR_Integer) 10)));
    MR_Unsigned packed_args_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), RttiProcLabel_4, (MR_Integer) 12)));
...
{
  {
    ...
    packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), RttiProcLabel_4, (MR_Integer) 0)));
    ...
    Var_63 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), RttiProcLabel_4, (MR_Integer) 12))) >> (MR_Integer) 1)) & (MR_Integer) 1);
    if ((Immed_5 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      MR_Word EntryType_9;
    ...
    else
    {
      ...
      {
        Label_6 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), Label_6, 0) = (MR_Box) ((MR_Unsigned) (EntryType_85));
        MR_hl_field(MR_mktag(1), Label_6, 1) = ((MR_Box) (ProcLabel_7));
      }
    }
    return Label_6;
