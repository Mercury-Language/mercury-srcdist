          ...
          case (MR_Integer) 2:
            {
              ...
              ll_backend__code_util__succeeded = (ll_backend__code_util__Var_10 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 6))));
            }
            break;
          case (MR_Integer) 3:
            {
              ...
              switch (MR_tag((MR_Word) ll_backend__code_util__Op_11)) {
                ...
                case (MR_Integer) 0:
                  switch (MR_unmkbody(ll_backend__code_util__Op_11)) {
                    ...
                    case (MR_Integer) 4:
                      {
                        ll_backend__code_util__NegOp_14 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 5));
                        ll_backend__code_util__succeeded = MR_TRUE;
                      }
                      break;
                    case (MR_Integer) 5:
                      {
                        ll_backend__code_util__NegOp_14 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 4));
                        ll_backend__code_util__succeeded = MR_TRUE;
                      }
                      break;
                    case (MR_Integer) 6:
                      {
                        ll_backend__code_util__NegOp_14 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 9));
                        ll_backend__code_util__succeeded = MR_TRUE;
                      }
                      break;
                    case (MR_Integer) 7:
                      {
                        ll_backend__code_util__NegOp_14 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 8));
                        ll_backend__code_util__succeeded = MR_TRUE;
                      }
                      break;
                    case (MR_Integer) 8:
                      {
                        ll_backend__code_util__NegOp_14 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 7));
                        ll_backend__code_util__succeeded = MR_TRUE;
                      }
                      break;
                    case (MR_Integer) 9:
                      {
                        ll_backend__code_util__NegOp_14 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 6));
                        ll_backend__code_util__succeeded = MR_TRUE;
                      }
                      break;
                    case (MR_Integer) 16:
                  ...
                  break;
                case (MR_Integer) 3:
                  switch (((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), ll_backend__code_util__Op_11, (MR_Integer) 0)))) {
                    default:
                      ll_backend__code_util__succeeded = MR_FALSE;
                      break;
                    case (MR_Integer) 8:
                      {
                        MR_Word ll_backend__code_util__T_15 = ((MR_Word) (MR_hl_field(MR_mktag(3), ll_backend__code_util__Op_11, (MR_Integer) 1)));

                        {
                          ll_backend__code_util__NegOp_14 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                          MR_hl_field(MR_mktag(3), ll_backend__code_util__NegOp_14, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 9));
                          MR_hl_field(MR_mktag(3), ll_backend__code_util__NegOp_14, 1) = ((MR_Box) (ll_backend__code_util__T_15));
                        }
                        ll_backend__code_util__succeeded = MR_TRUE;
                      }
                      break;
                    case (MR_Integer) 9:
                      {
                        MR_Word ll_backend__code_util__T_16 = ((MR_Word) (MR_hl_field(MR_mktag(3), ll_backend__code_util__Op_11, (MR_Integer) 1)));

                        {
                          ll_backend__code_util__NegOp_14 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                          MR_hl_field(MR_mktag(3), ll_backend__code_util__NegOp_14, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 8));
                          MR_hl_field(MR_mktag(3), ll_backend__code_util__NegOp_14, 1) = ((MR_Box) (ll_backend__code_util__T_16));
                        }
                        ll_backend__code_util__succeeded = MR_TRUE;
                      }
                      break;
                    case (MR_Integer) 12:
                      {
                        MR_Word ll_backend__code_util__T_17 = ((MR_Word) (MR_hl_field(MR_mktag(3), ll_backend__code_util__Op_11, (MR_Integer) 1)));

                        {
                          ll_backend__code_util__NegOp_14 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                          MR_hl_field(MR_mktag(3), ll_backend__code_util__NegOp_14, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 15));
                          MR_hl_field(MR_mktag(3), ll_backend__code_util__NegOp_14, 1) = ((MR_Box) (ll_backend__code_util__T_17));
                        }
                        ll_backend__code_util__succeeded = MR_TRUE;
                      }
                      break;
                    case (MR_Integer) 13:
                      {
                        MR_Word ll_backend__code_util__T_19 = ((MR_Word) (MR_hl_field(MR_mktag(3), ll_backend__code_util__Op_11, (MR_Integer) 1)));

                        {
                          ll_backend__code_util__NegOp_14 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                          MR_hl_field(MR_mktag(3), ll_backend__code_util__NegOp_14, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 14));
                          MR_hl_field(MR_mktag(3), ll_backend__code_util__NegOp_14, 1) = ((MR_Box) (ll_backend__code_util__T_19));
                        }
                        ll_backend__code_util__succeeded = MR_TRUE;
                      }
                      break;
                    case (MR_Integer) 14:
                      {
                        MR_Word ll_backend__code_util__T_18 = ((MR_Word) (MR_hl_field(MR_mktag(3), ll_backend__code_util__Op_11, (MR_Integer) 1)));

                        {
                          ll_backend__code_util__NegOp_14 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                          MR_hl_field(MR_mktag(3), ll_backend__code_util__NegOp_14, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 13));
                          MR_hl_field(MR_mktag(3), ll_backend__code_util__NegOp_14, 1) = ((MR_Box) (ll_backend__code_util__T_18));
                        }
                        ll_backend__code_util__succeeded = MR_TRUE;
                      }
                      break;
                    case (MR_Integer) 15:
                      {
                        MR_Word ll_backend__code_util__T_20 = ((MR_Word) (MR_hl_field(MR_mktag(3), ll_backend__code_util__Op_11, (MR_Integer) 1)));

                        {
                          ll_backend__code_util__NegOp_14 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                          MR_hl_field(MR_mktag(3), ll_backend__code_util__NegOp_14, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 12));
                          MR_hl_field(MR_mktag(3), ll_backend__code_util__NegOp_14, 1) = ((MR_Box) (ll_backend__code_util__T_20));
                        }
                        ll_backend__code_util__succeeded = MR_TRUE;
                      }
                      break;
