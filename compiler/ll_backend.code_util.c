        ...
        case (MR_Integer) 12:
          {
            ...
            MR_Unsigned packed_word_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), HeadVar__1_1, (MR_Integer) 6)));
        ...
        case (MR_Integer) 27:
          {
            ...
            MR_Unsigned packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), HeadVar__1_1, (MR_Integer) 9)));
...
{
  {
    ...
    else
    {
      ...
      MR_Word Lvals_6;
      MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Output_3, (MR_Integer) 2)));
      MR_Unsigned packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Output_3, (MR_Integer) 6)));
...
{
  {
    ...
    else
    {
      ...
      MR_Word Rvals_6;
      MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Input_3, (MR_Integer) 2)));
      MR_Unsigned packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Input_3, (MR_Integer) 6)));
  ...
  MR_Word * HeadVar__2_2)
{
  ...
  else
  {
    ...
    packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Arg_4, (MR_Integer) 1)));
      ...
      case (MR_Integer) 0:
        {
          ...
          MR_Unsigned packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Loc_7, (MR_Integer) 0)));
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        Target_11 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Var_15, (MR_Integer) 2))));
        {
          ...
          {
            Var_17 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
          ...
          case (MR_Integer) 4:
            {
              ...
              MR_Unsigned packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), GoalExpr_3, (MR_Integer) 2)));
  ...
  MR_Integer * STATE_VARIABLE_MaxRegF_5)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), Lval_12, (MR_Integer) 0)));
...
{
  {
    ...
    packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), RttiProcLabel_11, (MR_Integer) 0)));
    ...
    packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), RttiProcLabel_11, (MR_Integer) 10)));
    packed_word_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), RttiProcLabel_11, (MR_Integer) 12)));
    Var_71 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), RttiProcLabel_11, (MR_Integer) 12))) >> 1)) & (MR_Integer) 1);
...
{
  {
    ...
    MR_Unsigned packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), RttiProcLabel_4, (MR_Integer) 10)));
    MR_Unsigned packed_word_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), RttiProcLabel_4, (MR_Integer) 12)));
...
{
  {
    ...
    packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), RttiProcLabel_4, (MR_Integer) 0)));
    ...
    Var_63 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), RttiProcLabel_4, (MR_Integer) 12))) >> 1)) & (MR_Integer) 1);
