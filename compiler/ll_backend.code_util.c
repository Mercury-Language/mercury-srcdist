  ...
  MR_Word * VarLvals_4)
{
  ...
  hlds__hlds_proc__proc_info_get_headvars_2_p_0(ProcInfo_3, &HeadVars_5);
  hlds__hlds_proc_util__proc_info_arg_info_2_p_0(ProcInfo_3, &ArgInfos_6);
  mercury__assoc_list__from_corresponding_lists_3_p_0((MR_Word) (&ll_backend__code_util_scalar_common_1[0]), (MR_Word) (&hlds__pred_info_types__hlds__pred_info_types__type_ctor_info_arg_info_0), HeadVars_5, ArgInfos_6, &VarArgInfos_7);
  ...
  MR_Word ForFromWhere_9)
{
  ...
  else
  {
    ...
    if (!(succeeded))
    {
      succeeded = hlds__pred_proc_id____Unify____pred_id_0_0(Var_74, CurPredId_16);
      if (succeeded)
    ...
    case (MR_Integer) 0:
      {
        ...
        else
        {
          ...
          if (!(succeeded))
          {
            succeeded = hlds__pred_proc_id____Unify____pred_id_0_0(Var_87, CurPredId_29);
            if (succeeded)
