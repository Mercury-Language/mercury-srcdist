...
MR_decl_label5(fn__ll_backend__code_util__lvals_in_lval_1_0, 45,5,6,28,29)
MR_decl_label3(fn__ll_backend__code_util__lvals_in_lvals_1_0, 14,4,5)
MR_decl_label4(fn__ll_backend__code_util__lvals_in_mem_ref_1_0, 16,24,6,7)
MR_decl_label8(fn__ll_backend__code_util__lvals_in_rval_1_0, 8,9,13,21,3,4,5,7)
MR_decl_label1(fn__ll_backend__code_util__lvals_in_rval_1_0, 15)
...
MR_BEGIN_MODULE(ll_backend__code_util_module17)
	...
	MR_init_label8(fn__ll_backend__code_util__lvals_in_rval_1_0,8,9,13,21,3,4,5,7)
	MR_init_label1(fn__ll_backend__code_util__lvals_in_rval_1_0,15)
MR_BEGIN_CODE
...
MR_define_entry(mercury__fn__ll_backend__code_util__lvals_in_rval_1_0);
	...
	MR_COMPUTED_GOTO((MR_Unsigned) MR_tag(MR_r1),
		MR_LABEL_AP(fn__ll_backend__code_util__lvals_in_rval_1_0_i8) MR_AND
		MR_LABEL_AP(fn__ll_backend__code_util__lvals_in_rval_1_0_i7) MR_AND
		MR_LABEL_AP(fn__ll_backend__code_util__lvals_in_rval_1_0_i13) MR_AND
		MR_LABEL_AP(fn__ll_backend__code_util__lvals_in_rval_1_0_i21));
MR_def_label(fn__ll_backend__code_util__lvals_in_rval_1_0,8)
	...
	MR_np_call_localret_ent(fn__ll_backend__code_util__lvals_in_lval_1_0,
		fn__ll_backend__code_util__lvals_in_rval_1_0_i9);
...
MR_def_label(fn__ll_backend__code_util__lvals_in_rval_1_0,13)
	...
	MR_COMPUTED_GOTO((MR_Unsigned) MR_tag(MR_r1),
		...
		MR_LABEL_AP(fn__ll_backend__code_util__lvals_in_rval_1_0_i13) MR_AND
		MR_LABEL_AP(fn__ll_backend__code_util__lvals_in_rval_1_0_i21));
MR_def_label(fn__ll_backend__code_util__lvals_in_rval_1_0,21)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_ctfield(3, MR_r1, 0);
	if (MR_INT_EQ(MR_tempr1,0)) {
		MR_GOTO_LAB(fn__ll_backend__code_util__lvals_in_rval_1_0_i7);
	}
	if (MR_INT_EQ(MR_tempr1,1)) {
		MR_GOTO_LAB(fn__ll_backend__code_util__lvals_in_rval_1_0_i15);
	}
...
MR_def_label(fn__ll_backend__code_util__lvals_in_rval_1_0,4)
	...
	MR_np_localcall_lab(fn__ll_backend__code_util__lvals_in_rval_1_0,
		fn__ll_backend__code_util__lvals_in_rval_1_0_i5);
MR_def_label(fn__ll_backend__code_util__lvals_in_rval_1_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
...
MR_def_label(fn__ll_backend__code_util__lvals_in_rval_1_0,7)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_tbmkword(0, 0);
	MR_decr_sp_and_return(2);
MR_def_label(fn__ll_backend__code_util__lvals_in_rval_1_0,15)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_ctfield(3, MR_r1, 2);
	MR_succip_word = MR_sv(2);
	MR_COMPUTED_GOTO((MR_Unsigned) MR_tag(MR_r1),
...
MR_BEGIN_MODULE(ll_backend__code_util_module18)
	...
	MR_init_label5(fn__ll_backend__code_util__lvals_in_lval_1_0,45,5,6,28,29)
MR_BEGIN_CODE
...
MR_define_entry(mercury__fn__ll_backend__code_util__lvals_in_lval_1_0);
	...
	if (MR_INT_NE(MR_tag(MR_r1),3)) {
		MR_GOTO_LAB(fn__ll_backend__code_util__lvals_in_lval_1_0_i28);
	}
	MR_COMPUTED_GOTO((MR_Unsigned) MR_ctfield(3, MR_r1, 0),
		MR_LABEL_AP(fn__ll_backend__code_util__lvals_in_lval_1_0_i28) MR_AND
		MR_LABEL_AP(fn__ll_backend__code_util__lvals_in_lval_1_0_i28) MR_AND
		MR_LABEL_AP(fn__ll_backend__code_util__lvals_in_lval_1_0_i28) MR_AND
		MR_LABEL_AP(fn__ll_backend__code_util__lvals_in_lval_1_0_i29) MR_AND
		MR_LABEL_AP(fn__ll_backend__code_util__lvals_in_lval_1_0_i29) MR_AND
		MR_LABEL_AP(fn__ll_backend__code_util__lvals_in_lval_1_0_i29) MR_AND
		MR_LABEL_AP(fn__ll_backend__code_util__lvals_in_lval_1_0_i29) MR_AND
		MR_LABEL_AP(fn__ll_backend__code_util__lvals_in_lval_1_0_i29) MR_AND
		MR_LABEL_AP(fn__ll_backend__code_util__lvals_in_lval_1_0_i45) MR_AND
		MR_LABEL_AP(fn__ll_backend__code_util__lvals_in_lval_1_0_i29) MR_AND
		MR_LABEL_AP(fn__ll_backend__code_util__lvals_in_lval_1_0_i28) MR_AND
		MR_LABEL_AP(fn__ll_backend__code_util__lvals_in_lval_1_0_i28));
MR_def_label(fn__ll_backend__code_util__lvals_in_lval_1_0,45)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(2);
	MR_sv(2) = (MR_Word) MR_succip;
	MR_sv(1) = MR_ctfield(3, MR_r1, 3);
	...
	MR_np_call_localret_ent(fn__ll_backend__code_util__lvals_in_rval_1_0,
		fn__ll_backend__code_util__lvals_in_lval_1_0_i5);
MR_def_label(fn__ll_backend__code_util__lvals_in_lval_1_0,5)
	...
	MR_np_call_localret_ent(fn__ll_backend__code_util__lvals_in_rval_1_0,
		fn__ll_backend__code_util__lvals_in_lval_1_0_i6);
...
MR_def_label(fn__ll_backend__code_util__lvals_in_lval_1_0,28)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_tbmkword(0, 0);
	MR_proceed();
MR_def_label(fn__ll_backend__code_util__lvals_in_lval_1_0,29)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_ctfield(3, MR_r1, 1);
...
MR_BEGIN_MODULE(ll_backend__code_util_module19)
	...
	MR_init_label4(fn__ll_backend__code_util__lvals_in_mem_ref_1_0,16,24,6,7)
MR_BEGIN_CODE
...
MR_def_static(fn__ll_backend__code_util__lvals_in_mem_ref_1_0)
	...
	if ((MR_tempr1 == MR_mktag((MR_Integer) 1))) {
		MR_GOTO_LAB(fn__ll_backend__code_util__lvals_in_mem_ref_1_0_i16);
	}
	if ((MR_tempr1 == MR_mktag((MR_Integer) 2))) {
		MR_GOTO_LAB(fn__ll_backend__code_util__lvals_in_mem_ref_1_0_i24);
	}
	}
MR_def_label(fn__ll_backend__code_util__lvals_in_mem_ref_1_0,16)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_const_mask_field(MR_r1, 0);
	MR_np_tailcall_ent(fn__ll_backend__code_util__lvals_in_rval_1_0);
MR_def_label(fn__ll_backend__code_util__lvals_in_mem_ref_1_0,24)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(2);
	MR_sv(2) = (MR_Word) MR_succip;
...
MR_BEGIN_MODULE(ll_backend__code_util_module20)
	...
	MR_init_label3(fn__ll_backend__code_util__lvals_in_lvals_1_0,14,4,5)
MR_BEGIN_CODE
...
MR_define_entry(mercury__fn__ll_backend__code_util__lvals_in_lvals_1_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
		MR_GOTO_LAB(fn__ll_backend__code_util__lvals_in_lvals_1_0_i14);
	}
	MR_r1 = (MR_Word) MR_tbmkword(0, 0);
	MR_proceed();
MR_def_label(fn__ll_backend__code_util__lvals_in_lvals_1_0,14)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(2);
	MR_sv(2) = (MR_Word) MR_succip;
	MR_sv(1) = MR_ctfield(1, MR_r1, 1);
