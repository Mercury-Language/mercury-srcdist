                  ...
                  case (MR_Integer) 0:
                    {
                      ...
                      succeeded = ll_backend__code_util__natural_negate_rval_2_p_0(SubTestRvalA0_10, &SubTestRvalA_14);
                      if (succeeded)
                      {
                        succeeded = ll_backend__code_util__natural_negate_rval_2_p_0(SubTestRvalB0_11, &SubTestRvalB_15);
                        if (succeeded)
                        {
