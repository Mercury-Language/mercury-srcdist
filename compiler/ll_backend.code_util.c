              ...
              switch (MR_tag((MR_Word) ll_backend__code_util__Op_11)) {
                ...
                case (MR_Integer) 0:
                  switch (MR_unmkbody(ll_backend__code_util__Op_11)) {
                    ...
                    case (MR_Integer) 46:
                      {
                        ll_backend__code_util__NegOp_14 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 47));
                        ll_backend__code_util__succeeded = MR_TRUE;
                      }
                      break;
                    case (MR_Integer) 47:
                      {
                        ll_backend__code_util__NegOp_14 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 46));
                        ll_backend__code_util__succeeded = MR_TRUE;
                      }
                      break;
                    case (MR_Integer) 48:
