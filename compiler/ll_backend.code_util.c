...
MR_decl_label10(ll_backend__code_util__goal_may_alloc_temp_frame_2_2_0, 51,33,4,6,9,11,10,13,12,17)
MR_decl_label6(ll_backend__code_util__goal_may_alloc_temp_frame_2_2_0, 20,21,40,23,25,27)
...
MR_decl_label10(ll_backend__code_util__neg_rval_2_0, 26,28,30,32,34,36,38,40,44,46)
MR_decl_label2(ll_backend__code_util__neg_rval_2_0, 50,2)
...
MR_decl_label9(fn__ll_backend__code_util__lvals_in_rval_1_0, 8,9,13,21,3,4,5,7,15)
...
MR_BEGIN_MODULE(ll_backend__code_util_module12)
	...
	MR_init_label10(ll_backend__code_util__goal_may_alloc_temp_frame_2_2_0,51,33,4,6,9,11,10,13,12,17)
	MR_init_label6(ll_backend__code_util__goal_may_alloc_temp_frame_2_2_0,20,21,40,23,25,27)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(ll_backend__code_util_module15)
	...
	MR_init_label10(ll_backend__code_util__neg_rval_2_0,26,28,30,32,34,36,38,40,44,46)
	MR_init_label2(ll_backend__code_util__neg_rval_2_0,50,2)
MR_BEGIN_CODE
...
MR_def_label(ll_backend__code_util__neg_rval_2_0,18)
	...
	MR_tag_alloc_heap(MR_r2, 3, (MR_Integer) 4);
	MR_tfield(3, MR_r2, 0) = (MR_Integer) 2;
	MR_tfield(3, MR_r2, 1) = (MR_Word) MR_tbmkword(0, 30);
	MR_tfield(3, MR_r2, 2) = MR_tfield(3, MR_r1, 2);
	MR_tfield(3, MR_r2, 3) = MR_tfield(3, MR_r1, 3);
	{
	MR_Word MR_tempr1;
...
MR_BEGIN_MODULE(ll_backend__code_util_module17)
	...
	MR_init_label9(fn__ll_backend__code_util__lvals_in_rval_1_0,8,9,13,21,3,4,5,7,15)
MR_BEGIN_CODE
