    ...
    switch (MR_tag((MR_Word) GoalExpr_6)) {
      ...
      case (MR_Integer) 1:
        {
          ...
          succeeded = mercury__set__contains_2_p_0((MR_Word) (&hlds__hlds_markers__hlds__hlds_markers__type_ctor_info_goal_feature_0), GoalFeatures_13, ((MR_Box) ((MR_Integer) 16)));
          if (succeeded)
              ...
              case (MR_Integer) 0:
                {
                  ...
                  if (succeeded)
                  {
                    ...
                    succeeded = mercury__builtin__unify_2_p_0(TypeInfo_170_170, ((MR_Box) (Var_8)), ((MR_Box) (Var_169)));
                  }
                  if (succeeded)
      ...
      case (MR_Integer) 3:
        switch (((MR_Integer) ((MR_hl_field(3, GoalExpr_6, 0))))) {
          ...
          case (MR_Integer) 3:
            {
              MR_Word Goals_171 = ((MR_Word) ((MR_hl_field(3, GoalExpr_6, 1))));

              hlds__goal_vars__non_svar_copy_vars_in_goals_acc_3_p_0(Goals_171, STATE_VARIABLE_Set_0_100, STATE_VARIABLE_Set_101);
            }
            break;
          case (MR_Integer) 4:
            {
              ...
              switch (MR_tag((MR_Word) Reason_51)) {
                ...
                case (MR_Integer) 3:
                  switch (((MR_Integer) ((MR_hl_field(3, Reason_51, 0))))) {
                    ...
                    case (MR_Integer) 3:
                      {
                        MR_Word Var_172 = ((MR_Word) ((MR_hl_field(3, Reason_51, 1))));

                        parse_tree__set_of_var__insert_3_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), Var_172, STATE_VARIABLE_Set_0_100, &STATE_VARIABLE_Set_10_113);
                      }
                      break;
                    case (MR_Integer) 4:
                      STATE_VARIABLE_Set_10_113 = STATE_VARIABLE_Set_0_100;
    ...
    switch (MR_tag((MR_Word) GoalExpr_6)) {
            ...
            case (MR_Integer) 0:
              {
                ...
                if (succeeded)
                {
                  ...
                  TypeInfo_167_167 = (MR_Word) (&hlds__goal_vars_scalar_common_1[0]);
                  succeeded = mercury__builtin__unify_2_p_0(TypeInfo_167_167, ((MR_Box) (Var_8)), ((MR_Box) (Var_166)));
                }
                if (succeeded)
      ...
      case (MR_Integer) 3:
        switch (((MR_Integer) ((MR_hl_field(3, GoalExpr_6, 0))))) {
          ...
          case (MR_Integer) 3:
            {
              MR_Word Goals_168 = ((MR_Word) ((MR_hl_field(3, GoalExpr_6, 1))));

              hlds__goal_vars__vars_in_goals_acc_3_p_0(Goals_168, STATE_VARIABLE_Set_0_99, &STATE_VARIABLE_Set_100);
            }
            break;
          case (MR_Integer) 4:
            {
              ...
              switch (MR_tag((MR_Word) Reason_50)) {
                ...
                case (MR_Integer) 3:
                  switch (((MR_Integer) ((MR_hl_field(3, Reason_50, 0))))) {
                    ...
                    case (MR_Integer) 3:
                      {
                        MR_Word Var_169 = ((MR_Word) ((MR_hl_field(3, Reason_50, 1))));

                        parse_tree__set_of_var__insert_3_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), Var_169, STATE_VARIABLE_Set_0_99, &STATE_VARIABLE_Set_10_111);
                      }
                      break;
                    case (MR_Integer) 4:
                      STATE_VARIABLE_Set_10_111 = STATE_VARIABLE_Set_0_99;
