  ...
  MR_Word * STATE_VARIABLE_GlobalData_112)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_22, (MR_Integer) 269, &Parallel_25);
  {
    MR_Word Var_114;
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_22, (MR_Integer) 174, &GenBytecode_105);
  ...
  MR_Word * STATE_VARIABLE_GlobalData_19)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 351, &ParallelCodeGen_12);
  libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 73, &VeryVerbose_13);
  libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 83, &Statistics_14);
