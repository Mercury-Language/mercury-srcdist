  ...
  MR_Word * STATE_VARIABLE_GlobalData_109)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_22, (MR_Integer) 288, &Parallel_25);
  {
    MR_Word Var_111;
  ...
  MR_Word * STATE_VARIABLE_GlobalData_19)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 370, &ParallelCodeGen_12);
  libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 78, &VeryVerbose_13);
  libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 88, &Statistics_14);
