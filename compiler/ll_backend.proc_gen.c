  ...
  MR_Word * STATE_VARIABLE_GlobalData_109)
{
  ...
  if (succeeded)
  {
    ...
    hlds__hlds_pred__proc_info_get_varset_vartypes_3_p_0(ProcInfo_25, &VarSet_76, &VarTypes_77);
    ...
    hlds__hlds_pred__proc_info_get_oisu_kind_fors_2_p_0(ProcInfo_25, &OISUKindFors_95);
    {
      ...
      MR_hl_field(MR_mktag(0), ProcLayout_96, 11) = ((MR_Box) (ArgModes_78));
      ...
      MR_hl_field(MR_mktag(0), ProcLayout_96, 16) = ((MR_Box) (VarTypes_77));
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_20, (MR_Integer) 169, &GenBytecode_104);
