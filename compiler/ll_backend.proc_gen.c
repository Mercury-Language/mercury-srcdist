  ...
  MR_Word * STATE_VARIABLE_GlobalData_19)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 635, &ParallelCodeGen_12);
  libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 132, &VeryVerbose_13);
  libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 659, &Statistics_14);
