...
{
  {
    ...
    if (succeeded)
    {
      ...
      {
        ProcLayout_96 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 21 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), ProcLayout_96, 0) = (MR_Box) (((((MR_Unsigned) (Detism_31) << (MR_Integer) 3)) | (MR_Unsigned) (EffTraceLevel_86)));
        MR_hl_field(MR_mktag(0), ProcLayout_96, 1) = ((MR_Box) (EvalMethod_73));
        MR_hl_field(MR_mktag(0), ProcLayout_96, 2) = (MR_Box) (((((MR_Unsigned) (NeedGoalRep_81) << (MR_Integer) 2)) | (((((MR_Unsigned) (ForceProcId_39) << (MR_Integer) 1)) | (MR_Unsigned) (NeedsAllNames_82)))));
