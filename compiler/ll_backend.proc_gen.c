...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_20, (MR_Integer) 232, &Parallel_23);
    {
      MR_Word Var_111;
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_20, (MR_Integer) 150, &GenBytecode_104);
      ...
      case (MR_Integer) 0:
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_22, (MR_Integer) 467, &MiddleRec_23);
...
{
  {
    ...
    if (succeeded)
    {
      MR_Integer Var_52 = (MR_Integer) ((MR_Unsigned) MainSlots_17 + (MR_Unsigned) (MR_Integer) 1);
      MR_Word Var_54;
      MR_Word Var_55;
      MR_Word Var_56;
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_9, (MR_Integer) 314, &ParallelCodeGen_10);
    libs__globals__lookup_bool_option_3_p_0(Globals_9, (MR_Integer) 60, &VeryVerbose_11);
    libs__globals__lookup_bool_option_3_p_0(Globals_9, (MR_Integer) 70, &Statistics_12);
    switch (VeryVerbose_11) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
