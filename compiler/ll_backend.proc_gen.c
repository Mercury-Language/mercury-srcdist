  ...
  MR_Word * STATE_VARIABLE_GlobalData_11)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      STATE_VARIABLE_CProcsCord_1_53 = mercury__cord__snoc_2_f_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_c_procedure_0), STATE_VARIABLE_CProcsCord_0_8, ((MR_Box) (CProc_38)));
  ...
  MR_Word * STATE_VARIABLE_GlobalData_19)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 686, &Statistics_14);
