...
{
  {
    ...
    {
      libs__globals__lookup_bool_option_3_p_0(ll_backend__proc_gen__Globals_20, (MR_Integer) 139, &ll_backend__proc_gen__GenBytecode_104);
    }
...
{
  {
    ...
    {
      libs__globals__lookup_bool_option_3_p_0(ll_backend__proc_gen__Globals_9, (MR_Integer) 49, &ll_backend__proc_gen__VeryVerbose_11);
    }
    {
      libs__globals__lookup_bool_option_3_p_0(ll_backend__proc_gen__Globals_9, (MR_Integer) 59, &ll_backend__proc_gen__Statistics_12);
    }
    switch (ll_backend__proc_gen__VeryVerbose_11) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
