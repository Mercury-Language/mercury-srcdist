  ...
  MR_Word * STATE_VARIABLE_GlobalData_108)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_20, (MR_Integer) 259, &Parallel_23);
  {
    MR_Word Var_110;
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_20, (MR_Integer) 169, &GenBytecode_103);
