      ...
      case (MR_Integer) 0:
        {
          ...
          {
            libs__globals__lookup_bool_option_3_p_0(ll_backend__proc_gen__Globals_22, (MR_Integer) 448, &ll_backend__proc_gen__MiddleRec_23);
          }
...
{
  {
    ...
    {
      libs__globals__lookup_bool_option_3_p_0(ll_backend__proc_gen__Globals_20, (MR_Integer) 138, &ll_backend__proc_gen__GenBytecode_104);
    }
...
{
  {
    ...
    {
      libs__globals__lookup_bool_option_3_p_0(ll_backend__proc_gen__Globals_9, (MR_Integer) 300, &ll_backend__proc_gen__ParallelCodeGen_10);
    }
    {
      libs__globals__lookup_bool_option_3_p_0(ll_backend__proc_gen__Globals_9, (MR_Integer) 48, &ll_backend__proc_gen__VeryVerbose_11);
    }
    {
      libs__globals__lookup_bool_option_3_p_0(ll_backend__proc_gen__Globals_9, (MR_Integer) 58, &ll_backend__proc_gen__Statistics_12);
    }
    switch (ll_backend__proc_gen__VeryVerbose_11) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
