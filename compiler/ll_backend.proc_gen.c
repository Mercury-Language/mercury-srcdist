  ...
  MR_Word * STATE_VARIABLE_GlobalData_9)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      MR_Word next_value_of_STATE_VARIABLE_CProcsCord_0_6;
      ...
      next_value_of_STATE_VARIABLE_CProcsCord_0_6 = STATE_VARIABLE_CProcsCord_36_36;
      next_value_of_STATE_VARIABLE_GlobalData_0_8 = STATE_VARIABLE_GlobalData_35_35;
