...
{
  {
    ...
    packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), TableAttributes_8, (MR_Integer) 2)));
    Statistics_25 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), TableAttributes_8, (MR_Integer) 2))) >> 1)) & (MR_Integer) 1);
...
{
  {
    ...
    packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), ClausesInfo_27, (MR_Integer) 8)));
      ...
      case (MR_Integer) 1:
        {
          ...
          {
            Var_136 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
...
{
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Var_22, (MR_Integer) 0)));
        {
