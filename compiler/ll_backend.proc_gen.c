...
ll_backend__proc_gen__IntroducedFrom__pred__add_tabling_info_struct__1353__1_2_p_0(
  MR_Integer NumPTIs_19,
  MR_Integer NumArgs_23);

static MR_bool MR_CALL 
ll_backend__proc_gen__IntroducedFrom__pred__generate_exit__1235__1_2_p_0(
  MR_Word MaybeSpecialReturn_51,
  MR_Word HeadVar__2_147);

static MR_bool MR_CALL 
ll_backend__proc_gen__IntroducedFrom__pred__generate_exit__1227__1_2_p_0(
  MR_Word MaybeSpecialReturn_51,
  MR_Word HeadVar__2_132);

static MR_bool MR_CALL 
ll_backend__proc_gen__IntroducedFrom__pred__generate_non_code__861__1_2_p_0(
  MR_Word MaybeTailRecInfo_23,
  MR_Word HeadVar__2_55);

static MR_bool MR_CALL 
ll_backend__proc_gen__IntroducedFrom__pred__generate_proc_code__477__1_2_p_0(
  MR_Word NeedsMaxfrSlot_65,
  MR_Word HeadVar__2_124);

static MR_bool MR_CALL 
ll_backend__proc_gen__IntroducedFrom__pred__generate_proc_code__392__1_2_p_0(
  MR_Word Parallel_25,
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = ll_backend__proc_gen__IntroducedFrom__pred__add_tabling_info_struct__1353__1_2_p_0(((MR_Integer) ((MR_hl_field(0, closure, 3)))), ((MR_Integer) ((MR_hl_field(0, closure, 4)))));
  return succeeded;
}
            ...
            case (MR_Integer) 1:
              {
                ...
                Var_48 = hlds__hlds_pred__pred_id_to_int_1_f_0(PredId_18);
                mercury__io__write_string_4_p_0(ProgressStream_12, (MR_String) "% Generating code for ");
  ...
  MR_Word * STATE_VARIABLE_GlobalData_11)
{
  while (MR_TRUE)
  {
    ...
    else
    {
        ...
        case (MR_Integer) 1:
          {
            ...
            ProcIdInt_35 = hlds__hlds_pred__proc_id_to_int_1_f_0(ProcId_30);
      ...
      mercury__map__lookup_3_p_0((MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_proc_id_0), (MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_proc_info_0), ProcInfos_36, ((MR_Box) (ProcId_30)), &conv0_ProcInfo_37);
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = ll_backend__proc_gen__IntroducedFrom__pred__generate_proc_code__477__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) ((MR_hl_field(0, closure, 4)))));
  return succeeded;
}
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = ll_backend__proc_gen__IntroducedFrom__pred__generate_proc_code__392__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) ((MR_hl_field(0, closure, 4)))));
  return succeeded;
}
  ...
  MR_Word * STATE_VARIABLE_GlobalData_109)
{
  ...
  hlds__hlds_pred__proc_info_get_has_parallel_conj_2_p_0(ProcInfo1_21, &HasParConj_24);
  ...
  hlds__hlds_pred__proc_info_get_goal_2_p_0(ProcInfo_27, &Goal_35);
  ...
  hlds__hlds_pred__proc_info_get_var_table_2_p_0(ProcInfo_27, &VarTable_46);
  ...
  hlds__hlds_pred__proc_info_get_maybe_proc_table_io_info_2_p_0(ProcInfo_27, &MaybeTableIOInfo_72);
  ...
  if (succeeded)
  {
    ...
    hlds__hlds_pred__proc_info_get_eval_method_2_p_0(ProcInfo_27, &EvalMethod_77);
    hlds__hlds_proc_util__proc_info_get_initial_instmap_3_p_0(ModuleInfo_20, ProcInfo_27, &InstMap0_78);
    hlds__hlds_pred__proc_info_get_headvars_2_p_0(ProcInfo_27, &HeadVars_79);
    hlds__hlds_pred__proc_info_get_argmodes_2_p_0(ProcInfo_27, &ArgModes_80);
    ...
    hlds__hlds_pred__proc_info_get_maybe_deep_profile_info_2_p_0(ProcInfo_27, &MaybeHLDSDeepInfo_85);
    ...
    if ((MaybeTableIOInfo_72 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      ...
      succeeded = mercury__map__search_3_p_0((MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_proc_id_0), (MR_Word) (&hlds__hlds_module__hlds__hlds_module__type_ctor_info_table_struct_info_0), TableStructMap_88, ((MR_Box) (PredProcId_89)), &conv0_TableStructInfo_90);
      if (succeeded)
      {
    ...
    else
    {
      ...
      succeeded = mercury__map__search_3_p_0((MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_proc_id_0), (MR_Word) (&hlds__hlds_module__hlds__hlds_module__type_ctor_info_table_struct_info_0), TableStructMap_88, ((MR_Box) (PredProcId_89)), &conv1__TableStructInfo_95);
      if (succeeded)
        succeeded = MR_TRUE;
      if (succeeded)
        {
    ...
    hlds__hlds_pred__proc_info_get_oisu_kind_fors_2_p_0(ProcInfo_27, &OISUKindFors_96);
    {
  ...
  if (succeeded)
  {
    ...
    hlds__hlds_pred__proc_info_get_needs_maxfr_slot_2_p_0(ProcInfo_27, &NeedsMaxfrSlot_65);
    {
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = ll_backend__proc_gen__IntroducedFrom__pred__generate_non_code__861__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) ((MR_hl_field(0, closure, 4)))));
  return succeeded;
}
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = ll_backend__proc_gen__IntroducedFrom__pred__generate_exit__1235__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) ((MR_hl_field(0, closure, 4)))));
  return succeeded;
}
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = ll_backend__proc_gen__IntroducedFrom__pred__generate_exit__1227__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) ((MR_hl_field(0, closure, 4)))));
  return succeeded;
}
  ...
  MR_Word * STATE_VARIABLE_GlobalData_21)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 663, &ParallelCodeGen_12);
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 688, &Statistics_16);
  ...
  if (succeeded)
  {
    ...
    mercury__list__chunk_3_p_0((MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_id_0), PredIds_10, (MR_Integer) 50, &ListsOfPredIds_33);
    ...
    mercury__list__condense_2_p_0((MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_id_0), ListsOfPredIdsA_34, &PredIdsA_36);
    {
    ...
    mercury__list__condense_2_p_0((MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_id_0), ListsOfPredIdsB_35, &PredIdsB_39);
