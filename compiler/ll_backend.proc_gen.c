  ...
  MR_Word * STATE_VARIABLE_GlobalData_108)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_20, (MR_Integer) 262, &Parallel_23);
  {
    MR_Word Var_110;
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_20, (MR_Integer) 172, &GenBytecode_103);
  ...
  MR_Word * STATE_VARIABLE_GlobalData_18)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_9, (MR_Integer) 345, &ParallelCodeGen_10);
