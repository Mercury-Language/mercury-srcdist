...
ll_backend__proc_gen__IntroducedFrom__pred__add_tabling_info_struct__1375__1_2_p_0(
...
{
  {
    ...
    succeeded = ll_backend__proc_gen__IntroducedFrom__pred__add_tabling_info_struct__1375__1_2_p_0(((MR_Integer) (MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3))), ((MR_Integer) (MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4))));
    return succeeded;
  }
}
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_9, (MR_Integer) 309, &ParallelCodeGen_10);
