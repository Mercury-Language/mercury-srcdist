...
{
  {
    ...
    if (ll_backend__proc_gen__succeeded)
      *ll_backend__proc_gen__HeadVar__1_1 = (MR_Integer) 0;
      ...
      {
        MR_Integer ll_backend__proc_gen__Var_4 = ((MR_Integer) (MR_hl_field(MR_mktag(0), ll_backend__proc_gen__HeadVar__2_2, (MR_Integer) 0)));
        MR_Word ll_backend__proc_gen__Var_5 = ((MR_Word) (MR_hl_field(MR_mktag(0), ll_backend__proc_gen__HeadVar__2_2, (MR_Integer) 1)));
        MR_Integer ll_backend__proc_gen__Var_6 = ((MR_Integer) (MR_hl_field(MR_mktag(0), ll_backend__proc_gen__HeadVar__3_3, (MR_Integer) 0)));
        MR_Word ll_backend__proc_gen__Var_7 = ((MR_Word) (MR_hl_field(MR_mktag(0), ll_backend__proc_gen__HeadVar__3_3, (MR_Integer) 1)));
        MR_Word ll_backend__proc_gen__Var_8;

        {
          mercury__private_builtin__builtin_compare_int_3_p_0(&ll_backend__proc_gen__Var_8, ll_backend__proc_gen__Var_4, ll_backend__proc_gen__Var_6);
        }
        ...
        if (ll_backend__proc_gen__succeeded)
          *ll_backend__proc_gen__HeadVar__1_1 = ll_backend__proc_gen__Var_8;
          ...
          {
            {
              mercury__builtin__compare_3_p_0((MR_Word) &ll_backend__proc_gen_scalar_common_1[8], ll_backend__proc_gen__HeadVar__1_1, ((MR_Box) (ll_backend__proc_gen__Var_5)), ((MR_Box) (ll_backend__proc_gen__Var_7)));
            }
          }
      }
  }
...
{
  {
    ...
    if (ll_backend__proc_gen__succeeded)
    ...
    else
      {
        ...
        MR_Integer ll_backend__proc_gen__Var_3 = ((MR_Integer) (MR_hl_field(MR_mktag(0), ll_backend__proc_gen__HeadVar__1_1, (MR_Integer) 0)));
        MR_Word ll_backend__proc_gen__Var_4 = ((MR_Word) (MR_hl_field(MR_mktag(0), ll_backend__proc_gen__HeadVar__1_1, (MR_Integer) 1)));
        MR_Integer ll_backend__proc_gen__Var_5 = ((MR_Integer) (MR_hl_field(MR_mktag(0), ll_backend__proc_gen__HeadVar__2_2, (MR_Integer) 0)));
        MR_Word ll_backend__proc_gen__Var_6 = ((MR_Word) (MR_hl_field(MR_mktag(0), ll_backend__proc_gen__HeadVar__2_2, (MR_Integer) 1)));

        ll_backend__proc_gen__succeeded = (ll_backend__proc_gen__Var_3 == ll_backend__proc_gen__Var_5);
        if (ll_backend__proc_gen__succeeded)
          {
            ll_backend__proc_gen__TypeInfo_9_9 = (MR_Word) &ll_backend__proc_gen_scalar_common_1[8];
            {
              ll_backend__proc_gen__succeeded = mercury__builtin__unify_2_p_0(ll_backend__proc_gen__TypeInfo_9_9, ((MR_Box) (ll_backend__proc_gen__Var_4)), ((MR_Box) (ll_backend__proc_gen__Var_6)));
            }
          }
      }
    return ll_backend__proc_gen__succeeded;
...
{
  {
    ...
    ll_backend__proc_gen__NumArgs_23 = (ll_backend__proc_gen__NumInputs_12 + ll_backend__proc_gen__NumOutputs_13);
    {
      ...
      MR_hl_field(MR_mktag(0), ll_backend__proc_gen__Var_31, 0) = ((MR_Box) (&ll_backend__proc_gen_scalar_common_5[4]));
      ...
      if ((ll_backend__proc_gen__Var_220 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
      ...
      else
        {
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(3), ll_backend__proc_gen__Var_94, 1) = ((MR_Box) ((MR_Integer) 7));
          ...
          ll_backend__proc_gen__Var_100 = (MR_Word) &ll_backend__proc_gen_scalar_common_1[34];
          {
      ...
      case (MR_Integer) 0:
        {
...

          {
            ...
            MR_hl_field(MR_mktag(0), ll_backend__proc_gen__Var_200, 0) = ((MR_Box) (&ll_backend__proc_gen_scalar_common_5[3]));
      ...
      case (MR_Integer) 1:
        {
...

          {
            ...
            MR_hl_field(MR_mktag(0), ll_backend__proc_gen__Var_172, 0) = ((MR_Box) (&ll_backend__proc_gen_scalar_common_5[3]));
...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), ll_backend__proc_gen__Var_38, 0) = ((MR_Box) (&ll_backend__proc_gen_scalar_common_1[30]));
    ...
    if (ll_backend__proc_gen__succeeded)
      {
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(3), ll_backend__proc_gen__Var_55, 2) = ((MR_Box) (&ll_backend__proc_gen_scalar_common_7[1]));
        }
        {
      ...
      case (MR_Integer) 0:
        {
          ...
          {
            libs__globals__lookup_bool_option_3_p_0(ll_backend__proc_gen__Globals_22, (MR_Integer) 459, &ll_backend__proc_gen__MiddleRec_23);
          }
          ...
          if ((ll_backend__proc_gen__MaybeTraceInfo_284 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
          ...
          else
            {
              ...
              }
              {
                ...
                MR_hl_field(MR_mktag(0), ll_backend__proc_gen__Var_73, 0) = ((MR_Box) (&ll_backend__proc_gen_scalar_common_5[2]));
              ...
              if ((ll_backend__proc_gen__Var_301 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
              ...
              else
                {
                  ...
                  }
                  {
                    ...
                    MR_hl_field(MR_mktag(3), ll_backend__proc_gen__Var_98, 1) = ((MR_Box) ((MR_Integer) 7));
                  ...
                  {
                    ll_backend__proc_gen__Var_103 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(MR_mktag(1), ll_backend__proc_gen__Var_103, 0) = ((MR_Box) (&ll_backend__proc_gen_scalar_common_1[27]));
...
{
  {
    ...
    if (ll_backend__proc_gen__succeeded)
    ...
    else
      {
        ...
        if (ll_backend__proc_gen__succeeded)
          {
            ll_backend__proc_gen__Var_25 = ((MR_Word) (MR_hl_field(MR_mktag(0), ll_backend__proc_gen__Var_22, (MR_Integer) 0)));
            ll_backend__proc_gen__Var_26 = ((MR_Word) (MR_hl_field(MR_mktag(0), ll_backend__proc_gen__Var_22, (MR_Integer) 1)));
            {
...
{
  {
...

    {
      ...
      MR_hl_field(MR_mktag(0), ll_backend__proc_gen__Var_18, 0) = ((MR_Box) (&ll_backend__proc_gen_scalar_common_6[0]));
...
{
  {
    ...
    {
      libs__globals__lookup_bool_option_3_p_0(ll_backend__proc_gen__Globals_20, (MR_Integer) 225, &ll_backend__proc_gen__Parallel_23);
    }
    {
          ...
          case (MR_Integer) 0:
            {
...

              {
                ...
                MR_hl_field(MR_mktag(0), ll_backend__proc_gen__Var_112, 0) = ((MR_Box) (&ll_backend__proc_gen_scalar_common_5[0]));
    ...
    if (ll_backend__proc_gen__succeeded)
      {
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(0), ll_backend__proc_gen__Var_122, 0) = ((MR_Box) (&ll_backend__proc_gen_scalar_common_5[1]));
...
{
  {
    ...
    {
      libs__globals__lookup_bool_option_3_p_0(ll_backend__proc_gen__Globals_9, (MR_Integer) 308, &ll_backend__proc_gen__ParallelCodeGen_10);
    }
    {
    ...
    if (ll_backend__proc_gen__succeeded)
      {
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(0), ll_backend__proc_gen__Var_52, 0) = ((MR_Box) (&ll_backend__proc_gen_scalar_common_3[0]));
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(0), ll_backend__proc_gen__Var_58, 0) = ((MR_Box) (&ll_backend__proc_gen_scalar_common_4[0]));
