...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_20, (MR_Integer) 228, &Parallel_23);
    {
      MR_Word Var_111;
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_20, (MR_Integer) 148, &GenBytecode_104);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_9, (MR_Integer) 58, &VeryVerbose_11);
    libs__globals__lookup_bool_option_3_p_0(Globals_9, (MR_Integer) 68, &Statistics_12);
    switch (VeryVerbose_11) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
