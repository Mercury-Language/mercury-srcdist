...
ll_backend__proc_gen__IntroducedFrom__pred__add_tabling_info_struct__1432__1_2_p_0(
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = ll_backend__proc_gen__IntroducedFrom__pred__add_tabling_info_struct__1432__1_2_p_0(((MR_Integer) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Integer) ((MR_hl_field(0, closure, (MR_Integer) 4)))));
  return succeeded;
}
