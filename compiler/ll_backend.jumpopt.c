  ...
  switch (MR_tag((MR_Word) Lval0_5)) {
    ...
    case (MR_Integer) 3:
      switch (((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), Lval0_5, (MR_Integer) 0)))) {
        ...
        case (MR_Integer) 5:
          {
            MR_Word Rval0_30 = ((MR_Word) (MR_hl_field(MR_mktag(3), Lval0_5, (MR_Integer) 1)));
            MR_Word Rval_31;

            ll_backend__jumpopt__short_circuit_labels_rval_3_p_0(InstrMap_4, Rval0_30, &Rval_31);
            {
              MR_Word base;
              base = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
              *Lval_6 = base;
        ...
        case (MR_Integer) 6:
          {
            MR_Word Rval0_26 = ((MR_Word) (MR_hl_field(MR_mktag(3), Lval0_5, (MR_Integer) 1)));
            MR_Word Rval_27;

            ll_backend__jumpopt__short_circuit_labels_rval_3_p_0(InstrMap_4, Rval0_26, &Rval_27);
            {
              MR_Word base;
              base = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
              *Lval_6 = base;
        ...
        case (MR_Integer) 7:
          {
            MR_Word Rval0_28 = ((MR_Word) (MR_hl_field(MR_mktag(3), Lval0_5, (MR_Integer) 1)));
            MR_Word Rval_29;

            ll_backend__jumpopt__short_circuit_labels_rval_3_p_0(InstrMap_4, Rval0_28, &Rval_29);
            {
              MR_Word base;
              base = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
              *Lval_6 = base;
        ...
        case (MR_Integer) 8:
          {
            MR_Word Rval0_32 = ((MR_Word) (MR_hl_field(MR_mktag(3), Lval0_5, (MR_Integer) 1)));
            MR_Word Rval_33;

            ll_backend__jumpopt__short_circuit_labels_rval_3_p_0(InstrMap_4, Rval0_32, &Rval_33);
            {
              MR_Word base;
              base = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
              *Lval_6 = base;
        ...
        case (MR_Integer) 9:
          {
            ...
            MR_Word Field_15;
            MR_Word Rval0_34 = ((MR_Word) (MR_hl_field(MR_mktag(3), Lval0_5, (MR_Integer) 2)));
            MR_Word Rval_35;

            ll_backend__jumpopt__short_circuit_labels_rval_3_p_0(InstrMap_4, Rval0_34, &Rval_35);
        ...
        case (MR_Integer) 10:
          {
            MR_Word Rval0_36 = ((MR_Word) (MR_hl_field(MR_mktag(3), Lval0_5, (MR_Integer) 1)));
            MR_Word Rval_37;

            ll_backend__jumpopt__short_circuit_labels_rval_3_p_0(InstrMap_4, Rval0_36, &Rval_37);
            {
              MR_Word base;
              base = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
              *Lval_6 = base;
              ...
              switch (MR_tag((MR_Word) Const0_13)) {
                ...
                case (MR_Integer) 3:
                  switch (((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), Const0_13, (MR_Integer) 0)))) {
                    ...
                    case (MR_Integer) 12:
                      {
                        MR_Word CodeAddr0_47 = ((MR_Word) (MR_hl_field(MR_mktag(3), Const0_13, (MR_Integer) 1)));
                        MR_Word CodeAddr_50;
                        MR_Word Label0_48;

                        succeeded = ((MR_tag((MR_Word) CodeAddr0_47)) == (MR_mktag((MR_Integer) 1)));
                        if (succeeded)
                        {
                          Label0_48 = ((MR_Word) (MR_hl_field(MR_mktag(1), CodeAddr0_47, (MR_Integer) 0)));
                          {
                            MR_Word Label_49;
                            MR_Word Instr0_55;
                            MR_Box conv0_Instr0_55;

                            succeeded = mercury__map__search_3_p_0((MR_Word) &ll_backend__llds__ll_backend__llds__type_ctor_info_label_0, (MR_Word) &ll_backend__llds__ll_backend__llds__type_ctor_info_instruction_0, InstrMap_4, ((MR_Box) (Label0_48)), &conv0_Instr0_55);
                            if (succeeded)
                            {
                              Instr0_55 = ((MR_Word) conv0_Instr0_55);
                              succeeded = MR_TRUE;
                            }
                            if (succeeded)
                            {
                              ...
                              ll_backend__jumpopt__final_dest_loop_6_p_0(InstrMap_4, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), Label0_48, &Label_49, Instr0_55, &_Instr_56);
                            }
                            else
                              Label_49 = Label0_48;
                            {
                              CodeAddr_50 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
                              MR_hl_field(MR_mktag(1), CodeAddr_50, 0) = ((MR_Box) (Label_49));
                            }
                          }
                        }
                        else
                          CodeAddr_50 = CodeAddr0_47;
                        {
                          ...
                          MR_hl_field(MR_mktag(3), Const_14, 1) = ((MR_Box) (CodeAddr_50));
                        }
                      }
                      break;
                  }
