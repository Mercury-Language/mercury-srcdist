          ...
          switch (MR_tag((MR_Word) Lval0_7)) {
            ...
            case (MR_Integer) 3:
              switch (((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), Lval0_7, (MR_Integer) 0)))) {
                ...
                case (MR_Integer) 4:
                  {
                    MR_Word Rval0_71 = ((MR_Word) (MR_hl_field(MR_mktag(3), Lval0_7, (MR_Integer) 1)));
                    MR_Word Rval_72;

                    ll_backend__jumpopt__short_circuit_labels_rval_3_p_0(InstrMap_4, Rval0_71, &Rval_72);
                    {
                      ...
                      MR_hl_field(MR_mktag(3), Lval_8, 1) = ((MR_Box) (Rval_72));
                    }
                  }
                  break;
                case (MR_Integer) 5:
                ...
                case (MR_Integer) 9:
                  {
                    MR_Word Tag_73 = ((MR_Word) (MR_hl_field(MR_mktag(3), Lval0_7, (MR_Integer) 1)));
                    MR_Word Field0_74 = ((MR_Word) (MR_hl_field(MR_mktag(3), Lval0_7, (MR_Integer) 3)));
                    MR_Word Field_75;
                    ...
                    ll_backend__jumpopt__short_circuit_labels_rval_3_p_0(InstrMap_4, Field0_74, &Field_75);
                    {
                      ...
                      MR_hl_field(MR_mktag(3), Lval_8, 1) = ((MR_Box) (Tag_73));
                      MR_hl_field(MR_mktag(3), Lval_8, 2) = ((MR_Box) (Rval_94));
                      MR_hl_field(MR_mktag(3), Lval_8, 3) = ((MR_Box) (Field_75));
                    }
                  }
                  break;
                case (MR_Integer) 10:
                    ...
                    case (MR_Integer) 12:
                      {
                        ...
                        succeeded = ((MR_tag((MR_Word) CodeAddr0_46)) == (MR_mktag((MR_Integer) 1)));
                        if (succeeded)
                        {
                          Label0_47 = ((MR_Word) (MR_hl_field(MR_mktag(1), CodeAddr0_46, (MR_Integer) 0)));
                          {
                            MR_Word Label_48;
                            MR_Word Instr0_54;
                            MR_Box conv0_Instr0_54;

                            succeeded = mercury__map__search_3_p_0((MR_Word) &ll_backend__llds__ll_backend__llds__type_ctor_info_label_0, (MR_Word) &ll_backend__llds__ll_backend__llds__type_ctor_info_instruction_0, InstrMap_4, ((MR_Box) (Label0_47)), &conv0_Instr0_54);
                            if (succeeded)
                            {
                              Instr0_54 = ((MR_Word) conv0_Instr0_54);
                              succeeded = MR_TRUE;
                            }
                            if (succeeded)
                            {
                              ...
                              ll_backend__jumpopt__final_dest_loop_6_p_0(InstrMap_4, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), Label0_47, &Label_48, Instr0_54, &_Instr_55);
                            }
                            else
                              Label_48 = Label0_47;
                            {
                              CodeAddr_49 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
          ...
          case (MR_Integer) 2:
            {
              ...
              MR_Word SubRval0_24 = ((MR_Word) (MR_hl_field(MR_mktag(3), Rval0_5, (MR_Integer) 2)));
              MR_Word SubRval_25;

              ll_backend__jumpopt__short_circuit_labels_rval_3_p_0(InstrMap_4, SubRval0_24, &SubRval_25);
              {
                MR_Word base;
                ...
                *Rval_6 = base;
                ...
                MR_hl_field(MR_mktag(3), base, 2) = ((MR_Box) (SubRval_25));
              }
            }
            break;
          case (MR_Integer) 3:
            {
              ...
              MR_Word LRval_18;
              MR_Word RRval_19;
              MR_Word Op_26 = ((MR_Word) (MR_hl_field(MR_mktag(3), Rval0_5, (MR_Integer) 1)));
              ...
              ll_backend__jumpopt__short_circuit_labels_rval_3_p_0(InstrMap_4, RRval0_17, &RRval_19);
              {
                ...
                *Rval_6 = base;
                ...
                MR_hl_field(MR_mktag(3), base, 1) = ((MR_Box) (Op_26));
