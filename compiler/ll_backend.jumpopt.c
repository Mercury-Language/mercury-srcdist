  ...
  MR_Word * STATE_VARIABLE_RevInstrs_7)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      {
        MR_Word next_value_of_HeadVar__1_1 = RecurseInstrs_120;
        MR_Word next_value_of_HeadVar__2_2 = NewPrevInstr_125;
        MR_Word next_value_of_STATE_VARIABLE_CheckedNondetTailCallInfo_0_4 = STATE_VARIABLE_CheckedNondetTailCallInfo_164_164;
        MR_Word next_value_of_STATE_VARIABLE_RevInstrs_0_6 = STATE_VARIABLE_RevInstrs_167_167;
  ...
  MR_Word * DestInstr_12)
{
  while (MR_TRUE)
  {
    ...
    if (succeeded)
    {
      ...
      /* direct tailcall eliminated */
      {
        MR_Word next_value_of_LabelsSofar_8 = Var_18;
        MR_Word next_value_of_SrcLabel_9 = TargetLabel_15;
        MR_Word next_value_of_SrcInstr_11 = TargetInstr_16;
  ...
  MR_Word * STATE_VARIABLE_ForkMap_4)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      /* direct tailcall eliminated */
      {
        MR_Word next_value_of_HeadVar__1_1 = Instrs_11;
        MR_Word next_value_of_STATE_VARIABLE_ForkMap_0_3 = STATE_VARIABLE_ForkMap_19_19;
  ...
  MR_Word * STATE_VARIABLE_SuccMap_14)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      /* direct tailcall eliminated */
      {
        MR_Word next_value_of_HeadVar__1_1 = Instrs0_35;
        MR_Word next_value_of_STATE_VARIABLE_InstrMap_0_3 = STATE_VARIABLE_InstrMap_79_79;
        MR_Word next_value_of_STATE_VARIABLE_BlockMap_0_5 = STATE_VARIABLE_BlockMap_84_84;
        MR_Word next_value_of_STATE_VARIABLE_LvalMap_0_7 = STATE_VARIABLE_LvalMap_76_76;
        MR_Word next_value_of_STATE_VARIABLE_ProcMap_0_9 = STATE_VARIABLE_ProcMap_80_80;
        MR_Word next_value_of_STATE_VARIABLE_SdprocMap_0_11 = STATE_VARIABLE_SdprocMap_81_81;
        MR_Word next_value_of_STATE_VARIABLE_SuccMap_0_13 = STATE_VARIABLE_SuccMap_82_82;
