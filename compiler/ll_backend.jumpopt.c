  ...
  MR_Word HeadVar__2_2)
{
  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      TypeInfo__11_11 = (MR_Word) (&ll_backend__jumpopt_scalar_common_1[0]);
      succeeded = mercury__builtin__unify_2_p_0(TypeInfo__11_11, ((MR_Box) (ArgX1_3)), ((MR_Box) (ArgY1_4)));
      if (succeeded)
      {
        TypeInfo__12_12 = (MR_Word) (&ll_backend__jumpopt_scalar_common_1[0]);
  ...
  MR_Word * STATE_VARIABLE_Redirect_24)
{
  ...
  switch (MR_tag((MR_Word) STATE_VARIABLE_Component_0_21)) {
    ...
    case (MR_Integer) 2:
      ...
      break;
    case (MR_Integer) 3:
      switch (((MR_Integer) ((MR_hl_field(MR_mktag(3), STATE_VARIABLE_Component_0_21, (MR_Integer) 0))))) {
        default: /*NOTREACHED*/ MR_assert(0);
        case (MR_Integer) 0:
          {
            *STATE_VARIABLE_Component_22 = STATE_VARIABLE_Component_0_21;
        ...
        case (MR_Integer) 2:
          {
            ...
            MR_Word Label_10;
            MR_Word Instr0_28;
            MR_Box conv0_Instr0_28;

            succeeded = mercury__map__search_3_p_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_label_0), (MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_instruction_0), InstrMap_6, ((MR_Box) (Label0_9)), &conv0_Instr0_28);
            if (succeeded)
            {
              Instr0_28 = ((MR_Word) (conv0_Instr0_28));
              succeeded = MR_TRUE;
            }
            if (succeeded)
            {
              ...
              ll_backend__jumpopt__final_dest_loop_6_p_0(InstrMap_6, (MR_Word) ((MR_Unsigned) 0U), Label0_9, &Label_10, Instr0_28, &_Instr_29);
            }
            else
              Label_10 = Label0_9;
            {
  ...
  MR_Word * Mod_22)
{
  ...
  }
  {
    ...
    MR_hl_field(MR_mktag(0), JumpOptInfo_31, 8) = (MR_Box) (((((MR_Unsigned) (Fulljumpopt_16) << 1)) | (MR_Unsigned) (MayAlterRtti_14)));
  }
    ...
    case (MR_Integer) 1:
      {
        ...
        ll_backend__jumpopt__jump_opt_instr_list_7_p_0(STATE_VARIABLE_Instrs_0_39, (MR_Word) (MR_mkword(MR_mktag(1), &ll_backend__jumpopt_scalar_common_3[0])), JumpOptInfo_31, (MR_Word) ((MR_Unsigned) 0U), &Var_36, (MR_Word) ((MR_Unsigned) 0U), &RevInstrs_34);
    ...
    case (MR_Integer) 0:
      {
        ...
        {
          CheckedNondetTailCallInfo0_32 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        ...
        ll_backend__jumpopt__jump_opt_instr_list_7_p_0(STATE_VARIABLE_Instrs_0_39, (MR_Word) (MR_mkword(MR_mktag(1), &ll_backend__jumpopt_scalar_common_3[0])), JumpOptInfo_31, CheckedNondetTailCallInfo0_32, &CheckedNondetTailCallInfo_33, (MR_Word) ((MR_Unsigned) 0U), &RevInstrs_34);
  ...
  MR_Word * STATE_VARIABLE_RevInstrs_7)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      MR_Word STATE_VARIABLE_CheckedNondetTailCallInfo_163_163;
      MR_Word STATE_VARIABLE_RevInstrs_166_166;
      ...
      switch (MR_tag((MR_Word) Uinstr0_22)) {
        ...
        case (MR_Integer) 0:
          {
            STATE_VARIABLE_CheckedNondetTailCallInfo_163_163 = STATE_VARIABLE_CheckedNondetTailCallInfo_0_4;
            ReplacementInstrsEmpty_119 = (MR_Integer) 0;
            RecurseInstrs_120 = Instrs0_17;
            {
              STATE_VARIABLE_RevInstrs_166_166 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), STATE_VARIABLE_RevInstrs_166_166, 0) = ((MR_Box) (Instr0_16));
              MR_hl_field(MR_mktag(1), STATE_VARIABLE_RevInstrs_166_166, 1) = ((MR_Box) (STATE_VARIABLE_RevInstrs_0_6));
            }
          }
          break;
        case (MR_Integer) 1:
        case (MR_Integer) 2:
          ...
          break;
        case (MR_Integer) 3:
          switch (((MR_Integer) ((MR_hl_field(MR_mktag(3), Uinstr0_22, (MR_Integer) 0))))) {
            default: /*NOTREACHED*/ MR_assert(0);
            case (MR_Integer) 0:
              {
            ...
            case (MR_Integer) 1:
              {
                ...
                MR_Word Rval_42;
                MR_Word InstrMap_173 = ((MR_Word) ((MR_hl_field(MR_mktag(0), JumpOptInfo_3, (MR_Integer) 0))));
                ...
                else
                {
                  ...
                  Shorted_169 = mercury__string__f_43_43_2_f_0(Comment0_23, (MR_String) " (some shortcircuits)");
                  {
                    ...
                    MR_hl_field(MR_mktag(3), Var_155, 1) = ((MR_Box) (Lval_40));
                    MR_hl_field(MR_mktag(3), Var_155, 2) = ((MR_Box) (Rval_42));
                  }
                  {
                    Var_154 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
                    MR_hl_field(MR_mktag(0), Var_154, 0) = ((MR_Box) (Var_155));
                    MR_hl_field(MR_mktag(0), Var_154, 1) = ((MR_Box) (Shorted_169));
                  }
                  {
                    ReplacementInstrs_121 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(MR_mktag(1), ReplacementInstrs_121, 0) = ((MR_Box) (Var_154));
                    MR_hl_field(MR_mktag(1), ReplacementInstrs_121, 1) = ((MR_Box) ((MR_Unsigned) 0U));
                  }
                  RecurseInstrs_120 = Instrs0_17;
                  Var_165 = mercury__list__reverse_1_f_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_instruction_0), ReplacementInstrs_121);
                  STATE_VARIABLE_RevInstrs_166_166 = mercury__list__f_43_43_2_f_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_instruction_0), Var_165, STATE_VARIABLE_RevInstrs_0_6);
                  ReplacementInstrsEmpty_119 = (MR_Integer) 0;
                }
              }
              break;
            case (MR_Integer) 2:
              {
                MR_Word InstrMap_180 = ((MR_Word) ((MR_hl_field(MR_mktag(0), JumpOptInfo_3, (MR_Integer) 0))));
                MR_Word Lval_183 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Uinstr0_22, (MR_Integer) 1))));
                MR_Word Rval0_184 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Uinstr0_22, (MR_Integer) 2))));
                MR_Word Rval_185;
                ...
                else
                {
                  ...
                  Shorted_176 = mercury__string__f_43_43_2_f_0(Comment0_23, (MR_String) " (some shortcircuits)");
                  {
                    ...
                    MR_hl_field(MR_mktag(3), Var_151, 1) = ((MR_Box) (Lval_183));
                    MR_hl_field(MR_mktag(3), Var_151, 2) = ((MR_Box) (Rval_185));
                  }
                  {
                    Var_150 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
                    MR_hl_field(MR_mktag(0), Var_150, 0) = ((MR_Box) (Var_151));
                    MR_hl_field(MR_mktag(0), Var_150, 1) = ((MR_Box) (Shorted_176));
                  }
                  {
                    ReplacementInstrs_357 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(MR_mktag(1), ReplacementInstrs_357, 0) = ((MR_Box) (Var_150));
                    MR_hl_field(MR_mktag(1), ReplacementInstrs_357, 1) = ((MR_Box) ((MR_Unsigned) 0U));
                  }
                  RecurseInstrs_120 = Instrs0_17;
                  Var_358 = mercury__list__reverse_1_f_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_instruction_0), ReplacementInstrs_357);
                  STATE_VARIABLE_RevInstrs_166_166 = mercury__list__f_43_43_2_f_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_instruction_0), Var_358, STATE_VARIABLE_RevInstrs_0_6);
                  ReplacementInstrsEmpty_119 = (MR_Integer) 0;
                }
              }
              break;
            case (MR_Integer) 3:
              {
                ...
                ll_backend__jumpopt__jump_opt_llcall_8_p_0(Uinstr0_22, Comment0_23, Instrs0_17, HeadVar__2_2, JumpOptInfo_3, STATE_VARIABLE_CheckedNondetTailCallInfo_0_4, &STATE_VARIABLE_CheckedNondetTailCallInfo_163_163, &NewRemain_385);
                ...
                {
                  MR_Word ReplacementInstrs_379 = ((MR_Word) ((MR_hl_field(MR_mktag(1), NewRemain_385, (MR_Integer) 0))));
                  MR_Word Var_380;

                  RecurseInstrs_120 = ((MR_Word) ((MR_hl_field(MR_mktag(1), NewRemain_385, (MR_Integer) 1))));
                  Var_380 = mercury__list__reverse_1_f_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_instruction_0), ReplacementInstrs_379);
                  STATE_VARIABLE_RevInstrs_166_166 = mercury__list__f_43_43_2_f_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_instruction_0), Var_380, STATE_VARIABLE_RevInstrs_0_6);
            ...
            case (MR_Integer) 4:
              {
                ...
                if (succeeded)
                {
                  Var_142 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Redoip_44, (MR_Integer) 0))));
                  succeeded = ((MR_tag((MR_Word) Var_142)) == (MR_Integer) 1);
                  if (succeeded)
                    Label0_45 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Var_142, (MR_Integer) 0))));
                }
                if (succeeded)
                {
                  MR_Word Label_46;
                  MR_Word InstrMap_190 = ((MR_Word) ((MR_hl_field(MR_mktag(0), JumpOptInfo_3, (MR_Integer) 0))));
                  ...
                  else
                  {
                    ...
                    Shorted_186 = mercury__string__f_43_43_2_f_0(Comment0_23, (MR_String) " (some shortcircuits)");
                    {
                      ...
                      MR_hl_field(MR_mktag(1), Var_147, 0) = ((MR_Box) (Label_46));
                    }
                    {
                    ...
                    }
                    {
                      ...
                      MR_hl_field(MR_mktag(3), Var_145, 0) = ((MR_Box) ((MR_Unsigned) 4U));
                      MR_hl_field(MR_mktag(3), Var_145, 1) = ((MR_Box) (FrameInfo_43));
                    ...
                    }
                    {
                      ...
                      MR_hl_field(MR_mktag(0), Var_144, 1) = ((MR_Box) (Shorted_186));
                    }
                    {
                      ReplacementInstrs_389 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                      MR_hl_field(MR_mktag(1), ReplacementInstrs_389, 0) = ((MR_Box) (Var_144));
                      MR_hl_field(MR_mktag(1), ReplacementInstrs_389, 1) = ((MR_Box) ((MR_Unsigned) 0U));
                    }
                    RecurseInstrs_120 = Instrs0_17;
                    Var_390 = mercury__list__reverse_1_f_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_instruction_0), ReplacementInstrs_389);
                    STATE_VARIABLE_RevInstrs_166_166 = mercury__list__f_43_43_2_f_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_instruction_0), Var_390, STATE_VARIABLE_RevInstrs_0_6);
                    ReplacementInstrsEmpty_119 = (MR_Integer) 0;
                  }
                }
                else
            ...
            case (MR_Integer) 6:
              {
                MR_Word NewRemain_333;

                ll_backend__jumpopt__jump_opt_goto_8_p_0(Uinstr0_22, Comment0_23, Instrs0_17, HeadVar__2_2, JumpOptInfo_3, STATE_VARIABLE_CheckedNondetTailCallInfo_0_4, &STATE_VARIABLE_CheckedNondetTailCallInfo_163_163, &NewRemain_333);
                if ((NewRemain_333 == (MR_Word) ((MR_Unsigned) 0U)))
                {
                  ReplacementInstrsEmpty_119 = (MR_Integer) 0;
                  RecurseInstrs_120 = Instrs0_17;
                  {
                ...
                {
                  MR_Word ReplacementInstrs_327 = ((MR_Word) ((MR_hl_field(MR_mktag(1), NewRemain_333, (MR_Integer) 0))));
                  MR_Word Var_328;

                  RecurseInstrs_120 = ((MR_Word) ((MR_hl_field(MR_mktag(1), NewRemain_333, (MR_Integer) 1))));
                  Var_328 = mercury__list__reverse_1_f_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_instruction_0), ReplacementInstrs_327);
                  STATE_VARIABLE_RevInstrs_166_166 = mercury__list__f_43_43_2_f_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_instruction_0), Var_328, STATE_VARIABLE_RevInstrs_0_6);
                  if ((ReplacementInstrs_327 == (MR_Word) ((MR_Unsigned) 0U)))
                    ReplacementInstrsEmpty_119 = (MR_Integer) 1;
                  else
                    ReplacementInstrsEmpty_119 = (MR_Integer) 0;
                }
            ...
            case (MR_Integer) 7:
              {
                ...
                else
                {
                  ...
                  Shorted_36 = mercury__string__f_43_43_2_f_0(Comment0_23, (MR_String) " (some shortcircuits)");
                  {
                    ...
                    MR_hl_field(MR_mktag(3), Var_160, 0) = ((MR_Box) ((MR_Unsigned) 7U));
                    MR_hl_field(MR_mktag(3), Var_160, 1) = ((MR_Box) (Index_32));
                    MR_hl_field(MR_mktag(3), Var_160, 2) = ((MR_Box) (MaybeTargets_35));
                  }
                  {
                    Var_159 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
                    MR_hl_field(MR_mktag(0), Var_159, 0) = ((MR_Box) (Var_160));
                    MR_hl_field(MR_mktag(0), Var_159, 1) = ((MR_Box) (Shorted_36));
                  }
                  {
                    ReplacementInstrs_297 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(MR_mktag(1), ReplacementInstrs_297, 0) = ((MR_Box) (Var_159));
                    MR_hl_field(MR_mktag(1), ReplacementInstrs_297, 1) = ((MR_Box) ((MR_Unsigned) 0U));
                  }
                  RecurseInstrs_120 = Instrs0_17;
                  Var_298 = mercury__list__reverse_1_f_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_instruction_0), ReplacementInstrs_297);
                  STATE_VARIABLE_RevInstrs_166_166 = mercury__list__f_43_43_2_f_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_instruction_0), Var_298, STATE_VARIABLE_RevInstrs_0_6);
                  ReplacementInstrsEmpty_119 = (MR_Integer) 0;
                }
              }
              break;
            case (MR_Integer) 9:
              {
                MR_Word NewRemain_343;

                ll_backend__jumpopt__f_85_110_117_115_101_100_65_114_103_115_95_95_112_114_101_100_95_95_106_117_109_112_95_111_112_116_95_105_102_95_118_97_108_95_95_91_52_93_95_48_8_p_0(Uinstr0_22, Comment0_23, Instrs0_17, JumpOptInfo_3, STATE_VARIABLE_CheckedNondetTailCallInfo_0_4, &STATE_VARIABLE_CheckedNondetTailCallInfo_163_163, &NewRemain_343);
                if ((NewRemain_343 == (MR_Word) ((MR_Unsigned) 0U)))
                {
                  ReplacementInstrsEmpty_119 = (MR_Integer) 0;
                  RecurseInstrs_120 = Instrs0_17;
                  {
                ...
                {
                  MR_Word ReplacementInstrs_337 = ((MR_Word) ((MR_hl_field(MR_mktag(1), NewRemain_343, (MR_Integer) 0))));
                  MR_Word Var_338;

                  RecurseInstrs_120 = ((MR_Word) ((MR_hl_field(MR_mktag(1), NewRemain_343, (MR_Integer) 1))));
                  Var_338 = mercury__list__reverse_1_f_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_instruction_0), ReplacementInstrs_337);
                  STATE_VARIABLE_RevInstrs_166_166 = mercury__list__f_43_43_2_f_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_instruction_0), Var_338, STATE_VARIABLE_RevInstrs_0_6);
                  if ((ReplacementInstrs_337 == (MR_Word) ((MR_Unsigned) 0U)))
                    ReplacementInstrsEmpty_119 = (MR_Integer) 1;
                  else
                    ReplacementInstrsEmpty_119 = (MR_Integer) 0;
                }
            ...
            case (MR_Integer) 27:
              {
                MR_Word NewRemain_313;

                ll_backend__jumpopt__f_85_110_117_115_101_100_65_114_103_115_95_95_112_114_101_100_95_95_106_117_109_112_95_111_112_116_95_102_111_114_101_105_103_110_95_112_114_111_99_95_99_111_100_101_95_95_91_52_93_95_48_8_p_0(Uinstr0_22, Comment0_23, Instrs0_17, JumpOptInfo_3, STATE_VARIABLE_CheckedNondetTailCallInfo_0_4, &STATE_VARIABLE_CheckedNondetTailCallInfo_163_163, &NewRemain_313);
                if ((NewRemain_313 == (MR_Word) ((MR_Unsigned) 0U)))
                {
                  ReplacementInstrsEmpty_119 = (MR_Integer) 0;
                  RecurseInstrs_120 = Instrs0_17;
                  {
                ...
                {
                  MR_Word ReplacementInstrs_307 = ((MR_Word) ((MR_hl_field(MR_mktag(1), NewRemain_313, (MR_Integer) 0))));
                  MR_Word Var_308;

                  RecurseInstrs_120 = ((MR_Word) ((MR_hl_field(MR_mktag(1), NewRemain_313, (MR_Integer) 1))));
                  Var_308 = mercury__list__reverse_1_f_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_instruction_0), ReplacementInstrs_307);
                  STATE_VARIABLE_RevInstrs_166_166 = mercury__list__f_43_43_2_f_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_instruction_0), Var_308, STATE_VARIABLE_RevInstrs_0_6);
                  if ((ReplacementInstrs_307 == (MR_Word) ((MR_Unsigned) 0U)))
                    ReplacementInstrsEmpty_119 = (MR_Integer) 1;
                  else
                    ReplacementInstrsEmpty_119 = (MR_Integer) 0;
                }
            ...
            case (MR_Integer) 29:
              {
                ...
                MR_Word Child_62;
                MR_Word InstrMap_199 = ((MR_Word) ((MR_hl_field(MR_mktag(0), JumpOptInfo_3, (MR_Integer) 0))));
                ...
                else
                {
                  ...
                  MR_Word Instr_65;
                  MR_Word ReplacementInstrs_317;
                  MR_Word Var_318;

                  {
                    Uinstr_63 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(MR_mktag(3), Uinstr_63, 0) = ((MR_Box) ((MR_Unsigned) 29U));
                  ...
                  {
                    ReplacementInstrs_317 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(MR_mktag(1), ReplacementInstrs_317, 0) = ((MR_Box) (Instr_65));
                    MR_hl_field(MR_mktag(1), ReplacementInstrs_317, 1) = ((MR_Box) ((MR_Unsigned) 0U));
                  }
                  RecurseInstrs_120 = Instrs0_17;
                  Var_318 = mercury__list__reverse_1_f_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_instruction_0), ReplacementInstrs_317);
                  STATE_VARIABLE_RevInstrs_166_166 = mercury__list__f_43_43_2_f_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_instruction_0), Var_318, STATE_VARIABLE_RevInstrs_0_6);
                  ReplacementInstrsEmpty_119 = (MR_Integer) 0;
                }
              }
              break;
            case (MR_Integer) 30:
              {
                MR_Word InstrMap_206 = ((MR_Word) ((MR_hl_field(MR_mktag(0), JumpOptInfo_3, (MR_Integer) 0))));
                MR_Word Label0_207 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Uinstr0_22, (MR_Integer) 2))));
                MR_Word Label_208;
                MR_Word SyncTerm_209 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Uinstr0_22, (MR_Integer) 1))));
                ...
                else
                {
                  ...
                  MR_Word Instr_202;
                  MR_Word ReplacementInstrs_347;
                  MR_Word Var_348;

                  {
                    Uinstr_200 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(MR_mktag(3), Uinstr_200, 0) = ((MR_Box) ((MR_Unsigned) 30U));
                    MR_hl_field(MR_mktag(3), Uinstr_200, 1) = ((MR_Box) (SyncTerm_209));
                    MR_hl_field(MR_mktag(3), Uinstr_200, 2) = ((MR_Box) (Label_208));
                  }
                  Comment_201 = mercury__string__f_43_43_2_f_0(Comment0_23, (MR_String) " (redirect)");
                  {
                    ...
                    MR_hl_field(MR_mktag(0), Instr_202, 0) = ((MR_Box) (Uinstr_200));
                    MR_hl_field(MR_mktag(0), Instr_202, 1) = ((MR_Box) (Comment_201));
                  }
                  {
                    ReplacementInstrs_347 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(MR_mktag(1), ReplacementInstrs_347, 0) = ((MR_Box) (Instr_202));
                    MR_hl_field(MR_mktag(1), ReplacementInstrs_347, 1) = ((MR_Box) ((MR_Unsigned) 0U));
                  }
                  RecurseInstrs_120 = Instrs0_17;
                  Var_348 = mercury__list__reverse_1_f_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_instruction_0), ReplacementInstrs_347);
                  STATE_VARIABLE_RevInstrs_166_166 = mercury__list__f_43_43_2_f_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_instruction_0), Var_348, STATE_VARIABLE_RevInstrs_0_6);
                  ReplacementInstrsEmpty_119 = (MR_Integer) 0;
                }
              }
              break;
            ...
            case (MR_Integer) 33:
              {
                ...
                MR_Word InstrMap_219 = ((MR_Word) ((MR_hl_field(MR_mktag(0), JumpOptInfo_3, (MR_Integer) 0))));
                MR_Word Child0_220 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Uinstr0_22, (MR_Integer) 3))));
                MR_Word Child_221;
                ...
                else
                {
                  ...
                  MR_Word Instr_215;
                  MR_Word ReplacementInstrs_367;
                  MR_Word Var_368;

                  {
                    Uinstr_213 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(MR_mktag(3), Uinstr_213, 0) = ((MR_Box) ((MR_Unsigned) 33U));
                    MR_hl_field(MR_mktag(3), Uinstr_213, 1) = ((MR_Box) (LCRval_69));
                    MR_hl_field(MR_mktag(3), Uinstr_213, 2) = ((MR_Box) (LCSRval_70));
                    MR_hl_field(MR_mktag(3), Uinstr_213, 3) = ((MR_Box) (Child_221));
                  }
                  Comment_214 = mercury__string__f_43_43_2_f_0(Comment0_23, (MR_String) " (redirect)");
                  {
                    ...
                    MR_hl_field(MR_mktag(0), Instr_215, 0) = ((MR_Box) (Uinstr_213));
                    MR_hl_field(MR_mktag(0), Instr_215, 1) = ((MR_Box) (Comment_214));
                  }
                  {
                    ReplacementInstrs_367 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(MR_mktag(1), ReplacementInstrs_367, 0) = ((MR_Box) (Instr_215));
                    MR_hl_field(MR_mktag(1), ReplacementInstrs_367, 1) = ((MR_Box) ((MR_Unsigned) 0U));
                  }
                  RecurseInstrs_120 = Instrs0_17;
                  Var_368 = mercury__list__reverse_1_f_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_instruction_0), ReplacementInstrs_367);
                  STATE_VARIABLE_RevInstrs_166_166 = mercury__list__f_43_43_2_f_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_instruction_0), Var_368, STATE_VARIABLE_RevInstrs_0_6);
                  ReplacementInstrsEmpty_119 = (MR_Integer) 0;
                }
              }
              break;
      ...
      next_value_of_STATE_VARIABLE_CheckedNondetTailCallInfo_0_4 = STATE_VARIABLE_CheckedNondetTailCallInfo_163_163;
      next_value_of_STATE_VARIABLE_RevInstrs_0_6 = STATE_VARIABLE_RevInstrs_166_166;
  ...
  if (succeeded)
  {
    TargetLabel_17 = ((MR_Word) ((MR_hl_field(MR_mktag(1), TargetAddr_16, (MR_Integer) 0))));
    {
      ...
      else
      {
        ...
        succeeded = ((((MR_tag((MR_Word) PrevInstr_12)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(MR_mktag(3), PrevInstr_12, (MR_Integer) 0)))) == (MR_Integer) 9)));
        if (succeeded)
        {
        ...
        if (succeeded)
        {
          ...
          {
            NewInstrs_83 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), NewInstrs_83, 0) = ((MR_Box) (Var_51));
            MR_hl_field(MR_mktag(1), NewInstrs_83, 1) = ((MR_Box) ((MR_Unsigned) 0U));
          }
          {
            MR_Word base;
            base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          ...
          else
          {
            ...
            else
            {
              ...
              else
              {
                ...
                MR_Word BlockMap_33;
                MR_Word Block_34;
                MR_Word TypeCtorInfo__195_195;
                MR_Word TypeCtorInfo__196_196;
                MR_Word TypeInfo__197_197;
                MR_Word InstrMap_29 = ((MR_Word) ((MR_hl_field(MR_mktag(0), JumpOptInfo_13, (MR_Integer) 0))));
                MR_Word TargetInstr_30;
                MR_Word Var_65 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), JumpOptInfo_13, (MR_Integer) 8))) >> 1)) & (MR_Integer) 1);
                MR_Word Var_66;
                ...
                if (succeeded)
                {
                  TypeCtorInfo__195_195 = (MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_label_0);
                  TypeCtorInfo__196_196 = (MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_instruction_0);
                  succeeded = mercury__map__search_3_p_0(TypeCtorInfo__195_195, TypeCtorInfo__196_196, InstrMap_29, ((MR_Box) (TargetLabel_17)), &conv3_TargetInstr_30);
                  if (succeeded)
                  {
                  ...
                  if (succeeded)
                  {
                    ...
                    TypeInfo__197_197 = (MR_Word) (&ll_backend__jumpopt_scalar_common_1[0]);
                    succeeded = mercury__map__search_3_p_0(TypeCtorInfo__195_195, TypeInfo__197_197, BlockMap_33, ((MR_Box) (DestLabel_31)), &conv4_Block_34);
                    if (succeeded)
                    {
                ...
                if (succeeded)
                {
                  ...
                  packed_word_5 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), JumpOptInfo_13, (MR_Integer) 8)));
                  {
                    ...
                    MR_hl_field(MR_mktag(0), CrippledJumpOptInfo_38, 8) = (MR_Box) (packed_word_5);
                  }
                  ll_backend__jumpopt__jump_opt_instr_list_7_p_0(AdjustedBlock_36, (MR_Word) (MR_mkword(MR_mktag(1), &ll_backend__jumpopt_scalar_common_3[0])), CrippledJumpOptInfo_38, STATE_VARIABLE_CheckedNondetTailCallInfo_0_48, STATE_VARIABLE_CheckedNondetTailCallInfo_49, (MR_Word) ((MR_Unsigned) 0U), &RevNewInstrs_39);
                      ...
                      case (MR_Integer) 0:
                        {
                          ...
                          {
                            NewInstrs0_45 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                            MR_hl_field(MR_mktag(1), NewInstrs0_45, 0) = ((MR_Box) (Var_79));
                            MR_hl_field(MR_mktag(1), NewInstrs0_45, 1) = ((MR_Box) ((MR_Unsigned) 0U));
                          }
                        }
                        break;
                      case (MR_Integer) 1:
                        {
                          ...
                          else
                          {
                            ...
                            }
                            {
                              ...
                              MR_hl_field(MR_mktag(3), Var_76, 0) = ((MR_Box) ((MR_Unsigned) 6U));
  ...
  MR_Word * NewRemain_15)
{
  ...
  MR_Word MayCallMercury_18 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(3), Uinstr0_9, (MR_Integer) 3))) & (MR_Integer) 1);
  ...
  MR_Unsigned packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Uinstr0_9, (MR_Integer) 9)));
  ...
  else
  {
    ...
    {
      MaybeNoFix_31 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
    ...
    case (MR_Integer) 1:
      {
        ...
        {
          Uinstr_33 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (10 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(3), Uinstr_33, 0) = ((MR_Box) ((MR_Unsigned) 27U));
          MR_hl_field(MR_mktag(3), Uinstr_33, 1) = ((MR_Box) (Decls_16));
          MR_hl_field(MR_mktag(3), Uinstr_33, 2) = ((MR_Box) (Components_28));
          MR_hl_field(MR_mktag(3), Uinstr_33, 3) = (MR_Box) ((MR_Unsigned) (MayCallMercury_18));
          ...
          MR_hl_field(MR_mktag(3), Uinstr_33, 9) = (MR_Box) (packed_word_1);
        }
        {
  ...
  MR_Word * NewRemain_15)
{
  ...
  if (succeeded)
  {
    TargetLabel_18 = ((MR_Word) ((MR_hl_field(MR_mktag(1), TargetAddr_17, (MR_Integer) 0))));
    {
      ...
      MR_Word Fulljumpopt_27 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), JumpOptInfo_13, (MR_Integer) 8))) >> 1)) & (MR_Integer) 1);
      ...
      if (succeeded)
      {
        ...
        succeeded = ((((MR_tag((MR_Word) Var_71)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(MR_mktag(3), Var_71, (MR_Integer) 0)))) == (MR_Integer) 5)));
        if (succeeded)
        {
        ...
        if (succeeded)
        {
          ...
          succeeded = ((((MR_tag((MR_Word) Var_72)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(MR_mktag(3), Var_72, (MR_Integer) 0)))) == (MR_Integer) 6)));
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                ...
                succeeded = ((((MR_tag((MR_Word) Var_73)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(MR_mktag(3), Var_73, (MR_Integer) 0)))) == (MR_Integer) 5)));
                if (succeeded)
                {
      ...
      if (succeeded)
      {
        ...
        {
          RemainInstrs_48 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      ...
      else
      {
        ...
        if (succeeded)
        {
          TypeCtorInfo__127_127 = (MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_label_0);
          TypeInfo__128_128 = (MR_Word) (&ll_backend__jumpopt_scalar_common_1[0]);
          succeeded = mercury__map__search_3_p_0(TypeCtorInfo__127_127, TypeInfo__128_128, BlockMap_20, ((MR_Box) (TargetLabel_18)), &conv0__TargetBlock_49);
          if (succeeded)
            succeeded = MR_TRUE;
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                ...
                if (succeeded)
                {
                  ...
                  succeeded = mercury__map__search_3_p_0(TypeCtorInfo__127_127, TypeInfo__128_128, BlockMap_20, ((MR_Box) (GotoLabel_51)), &conv1_Var_52);
                  if (succeeded)
                    succeeded = MR_TRUE;
                }
                succeeded = !(succeeded);
        ...
        if (succeeded)
        {
          ...
          {
            NewInstrs_111 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), NewInstrs_111, 0) = ((MR_Box) (NewIfInstr_53));
            MR_hl_field(MR_mktag(1), NewInstrs_111, 1) = ((MR_Box) ((MR_Unsigned) 0U));
          }
          NewGotoComment_54 = mercury__string__f_43_43_2_f_0(Comment0_10, (MR_String) " (switched)");
          {
            ...
            MR_hl_field(MR_mktag(3), Var_79, 0) = ((MR_Box) ((MR_Unsigned) 6U));
          ...
          {
            RemainInstrs_112 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        ...
        else
        {
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              TypeCtorInfo__131_131 = (MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_label_0);
              TypeInfo__132_132 = (MR_Word) (&ll_backend__jumpopt_scalar_common_1[0]);
              succeeded = mercury__map__search_3_p_0(TypeCtorInfo__131_131, TypeInfo__132_132, BlockMap_20, ((MR_Box) (DestLabel_57)), &conv3_Block_60);
              if (succeeded)
              {
              ...
              if (succeeded)
              {
                ...
                if (succeeded)
                {
                  ...
                  if (succeeded)
                  {
                    ...
                    TypeInfo__137_137 = (MR_Word) (&ll_backend__jumpopt_scalar_common_1[0]);
                    succeeded = mercury__builtin__unify_2_p_0(TypeInfo__137_137, ((MR_Box) (Between_63)), ((MR_Box) (Var_135)));
                    if (succeeded)
                    {
                      ...
                      if (succeeded)
                      {
                        ...
                        if (succeeded)
                        {
                          Var_83 = (MR_Word) (MR_mkword(MR_mktag(1), &ll_backend__jumpopt_scalar_common_1[15]));
            ...
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                ...
                if (succeeded)
                {
                  Var_87 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(1), Var_86, (MR_Integer) 0))) & (MR_Integer) 1);
              ...
              else
              {
...

                {
                  ...
                  MR_hl_field(MR_mktag(3), Var_92, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &ll_backend__jumpopt_scalar_common_1[15])));
              ...
              NewInstrs_113 = mercury__list__f_43_43_2_f_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_instruction_0), Var_100, (MR_Word) (MR_mkword(MR_mktag(1), &ll_backend__jumpopt_scalar_common_1[14])));
              {
                MR_Word base;
                base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                *NewRemain_15 = base;
            ...
            else
            {
              ...
              if (succeeded)
              {
                ...
                {
                  NewInstrs_114 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                  MR_hl_field(MR_mktag(1), NewInstrs_114, 0) = ((MR_Box) (Var_104));
                  MR_hl_field(MR_mktag(1), NewInstrs_114, 1) = ((MR_Box) ((MR_Unsigned) 0U));
                }
                {
                  MR_Word base;
                  base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
  ...
  MR_Word Cond_4)
{
  ...
  if (((((MR_tag((MR_Word) Cond_4)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(MR_mktag(3), Cond_4, (MR_Integer) 0)))) == (MR_Integer) 4))))
  {
    ...
    if (((((MR_tag((MR_Word) Op_5)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(MR_mktag(3), Op_5, (MR_Integer) 0)))) == (MR_Integer) 8))))
      succeeded = MR_TRUE;
    else
    if (((((MR_tag((MR_Word) Op_5)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(MR_mktag(3), Op_5, (MR_Integer) 0)))) == (MR_Integer) 9))))
      succeeded = MR_TRUE;
    else
      succeeded = MR_FALSE;
    if (succeeded)
      switch (MR_tag((MR_Word) Left_6)) {
        ...
        case (MR_Integer) 0:
          {
            MR_Word Var_32 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Left_6, (MR_Integer) 0))));
            ...
            if (succeeded)
            {
              ...
              {
                MR_Word Var_10 = ((MR_Word) ((MR_hl_field(MR_mktag(2), Right_7, (MR_Integer) 0))));
                uint8_t Var_11 = (uint8_t) (Var_10);
                MR_Word Var_12 = ((MR_Word) ((MR_hl_field(MR_mktag(2), Right_7, (MR_Integer) 1))));
                MR_Word Var_13;
                MR_Word Var_14;
                MR_Word Var_15;
                MR_Integer Var_16;
                ...
                if (succeeded)
                {
                  ...
                  if (succeeded)
                  {
                    ...
                    Var_14 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Var_12, (MR_Integer) 2))));
                    succeeded = (Var_13 == (MR_Word) ((MR_Unsigned) 8U));
                    if (succeeded)
                    {
                      succeeded = ((((MR_tag((MR_Word) Var_14)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(MR_mktag(3), Var_14, (MR_Integer) 0)))) == (MR_Integer) 1)));
                      if (succeeded)
                      {
              ...
              if (((((MR_tag((MR_Word) Right_7)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(MR_mktag(3), Right_7, (MR_Integer) 0)))) == (MR_Integer) 1))))
              {
                MR_Word Var_17 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Right_7, (MR_Integer) 1))));
                MR_Integer Var_18;
        ...
        case (MR_Integer) 2:
          {
            ...
            if (succeeded)
            {
              Var_33 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Right_7, (MR_Integer) 0))));
              succeeded = ll_backend__llds____Unify____lval_0_0(Lval_3, Var_33);
              if (succeeded)
              {
                Var_19 = ((MR_Word) ((MR_hl_field(MR_mktag(2), Left_6, (MR_Integer) 0))));
                Var_21 = ((MR_Word) ((MR_hl_field(MR_mktag(2), Left_6, (MR_Integer) 1))));
                Var_20 = (uint8_t) (Var_19);
                succeeded = (Var_20 == UINT8_C(0));
                if (succeeded)
                {
                  succeeded = ((((MR_tag((MR_Word) Var_21)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(MR_mktag(3), Var_21, (MR_Integer) 0)))) == (MR_Integer) 3)));
                  if (succeeded)
                  {
                    Var_22 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Var_21, (MR_Integer) 1))));
                    Var_23 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Var_21, (MR_Integer) 2))));
          ...
          break;
        case (MR_Integer) 3:
          switch (((MR_Integer) ((MR_hl_field(MR_mktag(3), Left_6, (MR_Integer) 0))))) {
            default:
              succeeded = MR_FALSE;
              break;
            case (MR_Integer) 1:
              {
                ...
                if (succeeded)
                {
                  ...
                  if (succeeded)
                  {
                    Var_26 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Left_6, (MR_Integer) 1))));
  ...
  if (((((MR_tag((MR_Word) Cond_4)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(MR_mktag(3), Cond_4, (MR_Integer) 0)))) == (MR_Integer) 3))))
  {
    MR_Word Var_28 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Cond_4, (MR_Integer) 1))));
    MR_Word Var_29 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Cond_4, (MR_Integer) 2))));
    MR_Word Var_30;

    succeeded = (Var_28 == (MR_Word) ((MR_Unsigned) 16U));
    if (succeeded)
    {
      succeeded = ((MR_tag((MR_Word) Var_29)) == (MR_Integer) 0);
      if (succeeded)
      {
        Var_30 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_29, (MR_Integer) 0))));
  ...
  switch (MR_tag((MR_Word) Rval0_5)) {
              ...
              case (MR_Integer) 4:
                {
                  ...
                  {
                    Lval_8 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(MR_mktag(3), Lval_8, 0) = ((MR_Box) ((MR_Unsigned) 4U));
                    MR_hl_field(MR_mktag(3), Lval_8, 1) = ((MR_Box) (Rval_61));
                  }
                }
                break;
              case (MR_Integer) 5:
                {
                  MR_Word Rval0_78 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Lval0_7, (MR_Integer) 1))));
                  MR_Word Rval_79;

                  ll_backend__jumpopt__short_circuit_labels_rval_3_p_0(InstrMap_4, Rval0_78, &Rval_79);
                  {
                    Lval_8 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(MR_mktag(3), Lval_8, 0) = ((MR_Box) ((MR_Unsigned) 5U));
                    MR_hl_field(MR_mktag(3), Lval_8, 1) = ((MR_Box) (Rval_79));
                  }
                }
                break;
              case (MR_Integer) 6:
                {
                  MR_Word Rval0_74 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Lval0_7, (MR_Integer) 1))));
                  MR_Word Rval_75;

                  ll_backend__jumpopt__short_circuit_labels_rval_3_p_0(InstrMap_4, Rval0_74, &Rval_75);
                  {
                    Lval_8 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(MR_mktag(3), Lval_8, 0) = ((MR_Box) ((MR_Unsigned) 6U));
                    MR_hl_field(MR_mktag(3), Lval_8, 1) = ((MR_Box) (Rval_75));
                  }
                }
                break;
              case (MR_Integer) 7:
                {
                  MR_Word Rval0_76 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Lval0_7, (MR_Integer) 1))));
                  MR_Word Rval_77;

                  ll_backend__jumpopt__short_circuit_labels_rval_3_p_0(InstrMap_4, Rval0_76, &Rval_77);
                  {
                    Lval_8 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(MR_mktag(3), Lval_8, 0) = ((MR_Box) ((MR_Unsigned) 7U));
                    MR_hl_field(MR_mktag(3), Lval_8, 1) = ((MR_Box) (Rval_77));
                  }
                }
                break;
              case (MR_Integer) 8:
                {
                  MR_Word Rval0_80 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Lval0_7, (MR_Integer) 1))));
                  MR_Word Rval_81;

                  ll_backend__jumpopt__short_circuit_labels_rval_3_p_0(InstrMap_4, Rval0_80, &Rval_81);
                  {
                    Lval_8 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(MR_mktag(3), Lval_8, 0) = ((MR_Box) ((MR_Unsigned) 8U));
                    MR_hl_field(MR_mktag(3), Lval_8, 1) = ((MR_Box) (Rval_81));
                  }
                }
                break;
              case (MR_Integer) 9:
                {
                  MR_Word Tag_62 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Lval0_7, (MR_Integer) 1))));
                  MR_Word Field0_63 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Lval0_7, (MR_Integer) 3))));
                  MR_Word Field_64;
                  MR_Word Rval0_82 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Lval0_7, (MR_Integer) 2))));
                  MR_Word Rval_83;
                  ...
                  {
                    Lval_8 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(MR_mktag(3), Lval_8, 0) = ((MR_Box) ((MR_Unsigned) 9U));
                    MR_hl_field(MR_mktag(3), Lval_8, 1) = ((MR_Box) (Tag_62));
                    MR_hl_field(MR_mktag(3), Lval_8, 2) = ((MR_Box) (Rval_83));
                    MR_hl_field(MR_mktag(3), Lval_8, 3) = ((MR_Box) (Field_64));
                  }
                }
                break;
              case (MR_Integer) 10:
                {
                  MR_Word Rval0_84 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Lval0_7, (MR_Integer) 1))));
                  MR_Word Rval_85;

                  ll_backend__jumpopt__short_circuit_labels_rval_3_p_0(InstrMap_4, Rval0_84, &Rval_85);
                  {
                    Lval_8 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(MR_mktag(3), Lval_8, 0) = ((MR_Box) ((MR_Unsigned) 10U));
                    MR_hl_field(MR_mktag(3), Lval_8, 1) = ((MR_Box) (Rval_85));
                  }
                }
                break;
              case (MR_Integer) 12:
    ...
    case (MR_Integer) 3:
      switch (((MR_Integer) ((MR_hl_field(MR_mktag(3), Rval0_5, (MR_Integer) 0))))) {
            ...
            switch (MR_tag((MR_Word) Const0_13)) {
              ...
              case (MR_Integer) 3:
                switch (((MR_Integer) ((MR_hl_field(MR_mktag(3), Const0_13, (MR_Integer) 0))))) {
                  ...
                  case (MR_Integer) 12:
                    {
                      MR_Word CodeAddr0_46 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Const0_13, (MR_Integer) 1))));
                      MR_Word CodeAddr_49;
                      MR_Word Label0_47;
                      ...
                      if (succeeded)
                      {
                        Label0_47 = ((MR_Word) ((MR_hl_field(MR_mktag(1), CodeAddr0_46, (MR_Integer) 0))));
                        {
                          MR_Word Label_48;
                          MR_Word Instr0_51;
                          ...
                          if (succeeded)
                          {
                            ...
                            Label_48 = Label0_47;
                          {
                            CodeAddr_49 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                            MR_hl_field(MR_mktag(1), CodeAddr_49, 0) = ((MR_Box) (Label_48));
                          }
                        }
                      }
                      else
                        CodeAddr_49 = CodeAddr0_46;
                      {
                        ...
                        MR_hl_field(MR_mktag(3), Const_14, 1) = ((MR_Box) (CodeAddr_49));
                      }
                    }
                    break;
                }
        ...
        case (MR_Integer) 2:
          {
            MR_Word Type_15 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Rval0_5, (MR_Integer) 1))));
            MR_Word SubRval0_26 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Rval0_5, (MR_Integer) 2))));
            MR_Word SubRval_27;
            ...
            ll_backend__jumpopt__short_circuit_labels_rval_3_p_0(InstrMap_4, SubRval0_26, &SubRval_27);
            {
              ...
              *Rval_6 = base;
              ...
              MR_hl_field(MR_mktag(3), base, 2) = ((MR_Box) (SubRval_27));
            }
          }
          break;
        case (MR_Integer) 3:
          {
            ...
            MR_Word SubRval0_28 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Rval0_5, (MR_Integer) 2))));
            MR_Word SubRval_29;
            ...
            ll_backend__jumpopt__short_circuit_labels_rval_3_p_0(InstrMap_4, SubRval0_28, &SubRval_29);
            {
              ...
              *Rval_6 = base;
              ...
              MR_hl_field(MR_mktag(3), base, 2) = ((MR_Box) (SubRval_29));
            }
          }
          break;
        case (MR_Integer) 4:
          {
            MR_Word BinOp_17 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Rval0_5, (MR_Integer) 1))));
            MR_Word LRval0_18 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Rval0_5, (MR_Integer) 2))));
            MR_Word RRval0_19 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Rval0_5, (MR_Integer) 3))));
            MR_Word LRval_20;
            MR_Word RRval_21;
            ...
            ll_backend__jumpopt__short_circuit_labels_rval_3_p_0(InstrMap_4, RRval0_19, &RRval_21);
            {
              ...
              *Rval_6 = base;
              ...
              MR_hl_field(MR_mktag(3), base, 2) = ((MR_Box) (LRval_20));
              MR_hl_field(MR_mktag(3), base, 3) = ((MR_Box) (RRval_21));
            }
          }
          break;
      }
  ...
  else
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        Label_11 = Label0_10;
      {
        MaybeLabel_8 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
  ...
  MR_Word HeadVar__1_1)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        Var_10 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Uinstr_6, (MR_Integer) 6))));
      ...
      else
      {
        ...
        if (succeeded)
        {
          Var_11 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(3), Uinstr_6, (MR_Integer) 9))) & (MR_Integer) 1);
  ...
  MR_Word * NewRemain_15)
{
  ...
  if (succeeded)
  {
    ...
    {
      MR_Word Var_280 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), JumpOptInfo_13, (MR_Integer) 8))) & (MR_Integer) 1);
      ...
      {
        MR_Word Between0_25;
        MR_Word TypeCtorInfo__268_268;
        MR_Word TypeInfo__269_269;
        MR_Word ProcMap_24;
        MR_Box conv0_Between0_25;

        if (((MR_tag((MR_Word) CallModel_21)) == (MR_Integer) 0))
        {
          MR_Word Var_54 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), CallModel_21, (MR_Integer) 0))) & (MR_Integer) 1);
        ...
        {
          MR_Word Var_53 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(1), CallModel_21, (MR_Integer) 0))) & (MR_Integer) 1);
        ...
        if (succeeded)
        {
          ...
          TypeCtorInfo__268_268 = (MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_label_0);
          TypeInfo__269_269 = (MR_Word) (&ll_backend__jumpopt_scalar_common_1[0]);
          succeeded = mercury__map__search_3_p_0(TypeCtorInfo__268_268, TypeInfo__269_269, ProcMap_24, ((MR_Box) (RetLabel_22)), &conv0_Between0_25);
          if (succeeded)
          {
        ...
        {
          MR_Word Between_30;
          MR_Word TypeCtorInfo__271_271;
          MR_Word TypeInfo__272_272;
          MR_Word ForkMap_29;
          MR_Word Var_64;
          ...
          if (succeeded)
          {
            Var_64 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(1), CallModel_21, (MR_Integer) 0))) & (MR_Integer) 1);
            succeeded = (Var_64 == (MR_Integer) 1);
            if (succeeded)
            {
              ForkMap_29 = ((MR_Word) ((MR_hl_field(MR_mktag(0), JumpOptInfo_13, (MR_Integer) 5))));
              TypeCtorInfo__271_271 = (MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_label_0);
              TypeInfo__272_272 = (MR_Word) (&ll_backend__jumpopt_scalar_common_1[0]);
              succeeded = mercury__map__search_3_p_0(TypeCtorInfo__271_271, TypeInfo__272_272, ForkMap_29, ((MR_Box) (RetLabel_22)), &conv1_Between_30);
              if (succeeded)
              {
          ...
          {
            MR_Word TypeCtorInfo__274_274;
            MR_Word TypeInfo__275_275;
            MR_Word SuccMap_31;
            ...
            if (succeeded)
            {
              Var_74 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(2), CallModel_21, (MR_Integer) 0))) & (MR_Integer) 3);
              succeeded = (Var_74 == (MR_Integer) 2);
              if (succeeded)
              {
                SuccMap_31 = ((MR_Word) ((MR_hl_field(MR_mktag(0), JumpOptInfo_13, (MR_Integer) 6))));
                TypeCtorInfo__274_274 = (MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_label_0);
                TypeInfo__275_275 = (MR_Word) (&ll_backend__jumpopt_scalar_common_1[0]);
                succeeded = mercury__map__search_3_p_0(TypeCtorInfo__274_274, TypeInfo__275_275, SuccMap_31, ((MR_Box) (RetLabel_22)), &conv2_BetweenIncl_32);
                if (succeeded)
                {
                      ...
                      if (succeeded)
                      {
                        ...
                        if (succeeded)
                        {
                          ...
                          if (succeeded)
                          {
                            ...
                            succeeded = ((((MR_tag((MR_Word) Var_79)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(MR_mktag(3), Var_79, (MR_Integer) 0)))) == (MR_Integer) 6)));
                            if (succeeded)
                            {
                            }
                          }
            ...
            if (succeeded)
            {
              ...
              {
                NewInstrs_189 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            ...
            else
            {
              ...
              MR_Word TypeCtorInfo__276_276;
              MR_Word TypeInfo__277_277;
              MR_Word Var_116;
              MR_Word Var_117;
              MR_Word Var_118;
              MR_Word Var_119;
              ...
              if (succeeded)
              {
                Var_116 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(2), CallModel_21, (MR_Integer) 0))) & (MR_Integer) 3);
                ...
                if (succeeded)
                {
                  ...
                  if (succeeded)
                  {
                    ...
                    TypeCtorInfo__276_276 = (MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_label_0);
                    TypeInfo__277_277 = (MR_Word) (&ll_backend__jumpopt_scalar_common_1[0]);
                    succeeded = mercury__map__search_3_p_0(TypeCtorInfo__276_276, TypeInfo__277_277, SuccMap_190, ((MR_Box) (RetLabel_22)), &conv3_BetweenIncl_191);
                    if (succeeded)
                    {
                          ...
                          if (succeeded)
                          {
                            ...
                            if (succeeded)
                            {
                              ...
                              if (succeeded)
                              {
                                ...
                                succeeded = ((((MR_tag((MR_Word) Var_121)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(MR_mktag(3), Var_121, (MR_Integer) 0)))) == (MR_Integer) 6)));
                                if (succeeded)
                                {
                                }
                              }
              ...
              if (succeeded)
              {
                ...
                {
                  NewInstrs_192 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              ...
              else
              {
                ...
                if (succeeded)
                {
                  ...
                  if (succeeded)
                  {
                    ...
                    {
                      NewInstrs_193 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                      MR_hl_field(MR_mktag(1), NewInstrs_193, 0) = ((MR_Box) (Var_181));
                      MR_hl_field(MR_mktag(1), NewInstrs_193, 1) = ((MR_Box) ((MR_Unsigned) 0U));
                    }
                  }
                  else
                  {
                    ...
                    {
                      Var_184 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (7 * sizeof(MR_Word)), NULL, NULL));
                      MR_hl_field(MR_mktag(3), Var_184, 0) = ((MR_Box) ((MR_Unsigned) 3U));
  ...
  MR_Word * DestInstr_12)
{
  while (MR_TRUE)
  {
    ...
    // setup for model_det tailcalls optimized into a loop
    ;
    if (((((MR_tag((MR_Word) SrcUinstr_13)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(MR_mktag(3), SrcUinstr_13, (MR_Integer) 0)))) == (MR_Integer) 6))))
    {
    ...
    if (((((MR_tag((MR_Word) SrcUinstr_13)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(MR_mktag(3), SrcUinstr_13, (MR_Integer) 0)))) == (MR_Integer) 5))))
    {
    ...
    if (succeeded)
    {
      TypeCtorInfo__19_19 = (MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_label_0);
      TypeCtorInfo__20_20 = (MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_instruction_0);
      succeeded = mercury__map__search_3_p_0(TypeCtorInfo__19_19, TypeCtorInfo__20_20, InstrMap_7, ((MR_Box) (TargetLabel_15)), &conv0_TargetInstr_16);
      if (succeeded)
      {
      ...
      if (succeeded)
      {
        succeeded = mercury__list__member_2_p_0(TypeCtorInfo__19_19, ((MR_Box) (SrcLabel_9)), LabelsSofar_8);
        succeeded = !(succeeded);
      }
    }
    if (succeeded)
  ...
  MR_Word * STATE_VARIABLE_ForkMap_4)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      succeeded = ((((MR_tag((MR_Word) Uinstr_9)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(MR_mktag(3), Uinstr_9, (MR_Integer) 0)))) == (MR_Integer) 5)));
      if (succeeded)
      {
  ...
  MR_Word * STATE_VARIABLE_SuccMap_14)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      succeeded = ((((MR_tag((MR_Word) Uinstr0_43)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(MR_mktag(3), Uinstr0_43, (MR_Integer) 0)))) == (MR_Integer) 5)));
      if (succeeded)
      {
