        ...
        case (MR_Integer) 2:
          {
            ...
            MR_Word Label_10;
            MR_Word Instr0_29;
            MR_Box conv0_Instr0_29;

            succeeded = mercury__map__search_3_p_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_label_0), (MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_instruction_0), InstrMap_6, ((MR_Box) (Label0_9)), &conv0_Instr0_29);
            if (succeeded)
            {
              Instr0_29 = ((MR_Word) (conv0_Instr0_29));
              succeeded = MR_TRUE;
            }
            if (succeeded)
            {
              ...
              ll_backend__jumpopt__final_dest_loop_6_p_0(InstrMap_6, (MR_Word) ((MR_Unsigned) 0U), Label0_9, &Label_10, Instr0_29, &_Instr_30);
            }
            else
              Label_10 = Label0_9;
            {
            ...
            case (MR_Integer) 2:
              {
                ...
                else
                {
                  ...
                  }
                  {
                    ...
                    MR_hl_field(MR_mktag(1), ReplacementInstrs_354, 0) = ((MR_Box) (Var_142));
                ...
                if (succeeded)
                {
                  ...
                  else
                  {
                    ...
                    }
                    {
                      ...
                      MR_hl_field(MR_mktag(1), ReplacementInstrs_386, 0) = ((MR_Box) (Var_147));
            ...
            case (MR_Integer) 7:
              {
                ...
                else
                {
                  ...
                  }
                  {
                    ...
                    MR_hl_field(MR_mktag(1), ReplacementInstrs_294, 0) = ((MR_Box) (Var_133));
