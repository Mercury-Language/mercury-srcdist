  ...
  MR_Word * STATE_VARIABLE_Errors_9)
{
  ...
  {
    MR_Word FatalErrors_16 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_Errors_0_8, (MR_Integer) 0))));
    MR_Word FatalSpecs_17 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_Errors_0_8, (MR_Integer) 1))));
    MR_Word NonFatalErrors0_18 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_Errors_0_8, (MR_Integer) 2))));
    MR_Word NonFatalSpecs0_19 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_Errors_0_8, (MR_Integer) 3))));
    MR_Word WarningSpecs_20 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_Errors_0_8, (MR_Integer) 4))));
    MR_Word NonFatalErrors_21;
    MR_Word NonFatalSpecs_22;

    mercury__set__insert_3_p_0((MR_Word) (&parse_tree__parse_error__parse_tree__parse_error__type_ctor_info_nonfatal_read_module_error_0), ((MR_Box) ((MR_Integer) 7)), NonFatalErrors0_18, &NonFatalErrors_21);
    NonFatalSpecs_22 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_error_spec_0), Specs_4, NonFatalSpecs0_19);
    {
      MR_Word base;
      base = (MR_Word) MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL);
      *STATE_VARIABLE_Errors_9 = base;
      MR_hl_field(MR_mktag(0), base, 0) = ((MR_Box) (FatalErrors_16));
      MR_hl_field(MR_mktag(0), base, 1) = ((MR_Box) (FatalSpecs_17));
      MR_hl_field(MR_mktag(0), base, 2) = ((MR_Box) (NonFatalErrors_21));
      MR_hl_field(MR_mktag(0), base, 3) = ((MR_Box) (NonFatalSpecs_22));
      MR_hl_field(MR_mktag(0), base, 4) = ((MR_Box) (WarningSpecs_20));
    }
  }
}
