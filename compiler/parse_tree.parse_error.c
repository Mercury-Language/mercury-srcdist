  ...
  MR_Word * STATE_VARIABLE_Errors_9)
{
  ...
  {
    MR_Word FatalErrors_11 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_Errors_0_8, 0))));
    MR_Word FatalSpecs_12 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_Errors_0_8, 1))));
    MR_Word NonFatalErrors0_13 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_Errors_0_8, 2))));
    MR_Word NonFatalSpecs0_14 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_Errors_0_8, 3))));
    MR_Word WarningSpecs_15 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_Errors_0_8, 4))));
