...
{
  MR_Word Specs_4;
  MR_Word FatalSpecs_6 = ((MR_Word) ((MR_hl_field(0, Errors_3, (MR_Integer) 1))));
  MR_Word NonFatalSpecs_8 = ((MR_Word) ((MR_hl_field(0, Errors_3, (MR_Integer) 3))));
  MR_Word WarningSpecs_9 = ((MR_Word) ((MR_hl_field(0, Errors_3, (MR_Integer) 4))));
  MR_Word Var_10;
...
{
  MR_bool succeeded;
  MR_Word FatalErrors_3 = ((MR_Word) ((MR_hl_field(0, Errors_2, (MR_Integer) 0))));
  MR_Word NonFatalErrors_5 = ((MR_Word) ((MR_hl_field(0, Errors_2, (MR_Integer) 2))));
...
parse_tree__parse_error__add_warning_3_p_0(
  ...
  MR_Word * Errors_6)
{
  MR_Word FatalErrors_7 = ((MR_Word) ((MR_hl_field(0, Errors0_5, (MR_Integer) 0))));
  MR_Word FatalSpecs_8 = ((MR_Word) ((MR_hl_field(0, Errors0_5, (MR_Integer) 1))));
  MR_Word NonFatalErrors_9 = ((MR_Word) ((MR_hl_field(0, Errors0_5, (MR_Integer) 2))));
  MR_Word NonFatalSpecs_10 = ((MR_Word) ((MR_hl_field(0, Errors0_5, (MR_Integer) 3))));
  MR_Word WarningSpecs0_11 = ((MR_Word) ((MR_hl_field(0, Errors0_5, (MR_Integer) 4))));
  ...
  MR_Word * STATE_VARIABLE_Errors_9)
{
  ...
  {
    MR_Word FatalErrors_11 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_Errors_0_8, (MR_Integer) 0))));
    MR_Word FatalSpecs_12 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_Errors_0_8, (MR_Integer) 1))));
    MR_Word NonFatalErrors0_13 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_Errors_0_8, (MR_Integer) 2))));
    MR_Word NonFatalSpecs0_14 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_Errors_0_8, (MR_Integer) 3))));
    MR_Word WarningSpecs_15 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_Errors_0_8, (MR_Integer) 4))));
    MR_Word NonFatalErrors_16;
    MR_Word NonFatalSpecs_17;

    mercury__set__insert_3_p_0((MR_Word) (&parse_tree__parse_error__parse_tree__parse_error__type_ctor_info_nonfatal_read_module_error_0), ((MR_Box) ((MR_Integer) 8)), NonFatalErrors0_13, &NonFatalErrors_16);
    NonFatalSpecs_17 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_error_spec_0), Specs_4, NonFatalSpecs0_14);
    {
      MR_Word base;
      base = (MR_Word) MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL);
...
parse_tree__parse_error__add_nonfatal_error_4_p_0(
  ...
  MR_Word * Errors_8)
{
  MR_Word FatalErrors_9 = ((MR_Word) ((MR_hl_field(0, Errors0_7, (MR_Integer) 0))));
  MR_Word FatalSpecs_10 = ((MR_Word) ((MR_hl_field(0, Errors0_7, (MR_Integer) 1))));
  MR_Word NonFatalErrors0_11 = ((MR_Word) ((MR_hl_field(0, Errors0_7, (MR_Integer) 2))));
  MR_Word NonFatalSpecs0_12 = ((MR_Word) ((MR_hl_field(0, Errors0_7, (MR_Integer) 3))));
  MR_Word WarningSpecs_13 = ((MR_Word) ((MR_hl_field(0, Errors0_7, (MR_Integer) 4))));
  ...
  NonFatalSpecs_15 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_error_spec_0), Specs_6, NonFatalSpecs0_12);
  {
    MR_Word base;
    base = (MR_Word) MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL);
    *Errors_8 = base;
...
parse_tree__parse_error__add_fatal_error_4_p_0(
  ...
  MR_Word * Errors_8)
{
  MR_Word FatalErrors0_9 = ((MR_Word) ((MR_hl_field(0, Errors0_7, (MR_Integer) 0))));
  MR_Word FatalSpecs0_10 = ((MR_Word) ((MR_hl_field(0, Errors0_7, (MR_Integer) 1))));
  MR_Word NonFatalErrors_11 = ((MR_Word) ((MR_hl_field(0, Errors0_7, (MR_Integer) 2))));
  MR_Word NonFatalSpecs_12 = ((MR_Word) ((MR_hl_field(0, Errors0_7, (MR_Integer) 3))));
  MR_Word WarningSpecs_13 = ((MR_Word) ((MR_hl_field(0, Errors0_7, (MR_Integer) 4))));
