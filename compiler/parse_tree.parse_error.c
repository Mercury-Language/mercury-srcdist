...
static /* final */ const MR_Box parse_tree__parse_error_scalar_common_1[3][2];
  ...
  MR_Word HeadVar__2_2)
{
  ...
  else
  {
    ...
    if (succeeded)
    {
      TypeInfo__16_16 = (MR_Word) (&parse_tree__parse_error_scalar_common_1[1]);
      succeeded = mercury__builtin__unify_2_p_0(TypeInfo__16_16, ((MR_Box) (ArgX2_5)), ((MR_Box) (ArgY2_6)));
      if (succeeded)
      {
        TypeInfo__17_17 = (MR_Word) (&parse_tree__parse_error_scalar_common_1[2]);
        succeeded = mercury__builtin__unify_2_p_0(TypeInfo__17_17, ((MR_Box) (ArgX3_7)), ((MR_Box) (ArgY3_8)));
        if (succeeded)
        {
          TypeInfo__18_18 = (MR_Word) (&parse_tree__parse_error_scalar_common_1[1]);
          succeeded = mercury__builtin__unify_2_p_0(TypeInfo__18_18, ((MR_Box) (ArgX4_9)), ((MR_Box) (ArgY4_10)));
          if (succeeded)
          {
            TypeInfo__19_19 = (MR_Word) (&parse_tree__parse_error_scalar_common_1[1]);
  ...
  MR_Word Errors_2)
{
  ...
  if (succeeded)
  {
    TypeCtorInfo__9_9 = (MR_Word) (&parse_tree__parse_error__parse_tree__parse_error__type_ctor_info_nonfatal_read_module_error_0);
    succeeded = mercury__set__is_empty_1_p_0(TypeCtorInfo__9_9, NonFatalErrors_5);
  }
  return succeeded;
}
