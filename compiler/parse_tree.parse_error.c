  ...
  MR_Word * STATE_VARIABLE_Errors_9)
{
  ...
  else
  {
    ...
    mercury__set__insert_3_p_0((MR_Word) (&parse_tree__parse_error__parse_tree__parse_error__type_ctor_info_nonfatal_read_module_error_0), ((MR_Box) ((MR_Integer) 7)), NonFatalErrors0_13, &NonFatalErrors_16);
