  ...
  MR_Word * Errors_8)
{
  ...
  FatalSpecs_30 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_error_spec_0), Var_15, (MR_Word) ((MR_Unsigned) 0U));
  {
    ...
    *Errors_8 = base;
    MR_hl_field(MR_mktag(0), base, 0) = ((MR_Box) (FatalErrors_29));
    MR_hl_field(MR_mktag(0), base, 1) = ((MR_Box) (FatalSpecs_30));
    MR_hl_field(MR_mktag(0), base, 2) = ((MR_Box) (NonFatalErrors_26));
  ...
  MR_Word * STATE_VARIABLE_Errors_9)
{
  ...
  {
    MR_Word FatalErrors_11 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_Errors_0_8, (MR_Integer) 0))));
    MR_Word FatalSpecs_12 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_Errors_0_8, (MR_Integer) 1))));
    MR_Word NonFatalErrors0_13 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_Errors_0_8, (MR_Integer) 2))));
    MR_Word NonFatalSpecs0_14 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_Errors_0_8, (MR_Integer) 3))));
    MR_Word WarningSpecs_15 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_Errors_0_8, (MR_Integer) 4))));
    ...
    NonFatalSpecs_17 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_error_spec_0), Specs_4, NonFatalSpecs0_14);
    {
      ...
      *STATE_VARIABLE_Errors_9 = base;
      MR_hl_field(MR_mktag(0), base, 0) = ((MR_Box) (FatalErrors_11));
      MR_hl_field(MR_mktag(0), base, 1) = ((MR_Box) (FatalSpecs_12));
      MR_hl_field(MR_mktag(0), base, 2) = ((MR_Box) (NonFatalErrors_16));
      MR_hl_field(MR_mktag(0), base, 3) = ((MR_Box) (NonFatalSpecs_17));
      MR_hl_field(MR_mktag(0), base, 4) = ((MR_Box) (WarningSpecs_15));
    }
  }
}
