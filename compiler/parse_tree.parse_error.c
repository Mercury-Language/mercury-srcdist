  ...
  MR_Word * Errors_8)
{
  MR_Word Spec_10;
  MR_Word Var_15;
  MR_Word FatalErrors0_24;
  MR_Word NonFatalErrors_26;
  MR_Word FatalErrors_29;
  MR_Word FatalSpecs_30;

  parse_tree__parse_error__io_error_to_error_spec_4_p_0(ErrorMsg_6, &Spec_10);
  FatalErrors0_24 = mercury__set__init_0_f_0((MR_Word) (&parse_tree__parse_error__parse_tree__parse_error__type_ctor_info_fatal_read_module_error_0));
  NonFatalErrors_26 = mercury__set__init_0_f_0((MR_Word) (&parse_tree__parse_error__parse_tree__parse_error__type_ctor_info_nonfatal_read_module_error_0));
  {
    Var_15 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(1, Var_15, 0) = ((MR_Box) (Spec_10));
    MR_hl_field(1, Var_15, 1) = ((MR_Box) ((MR_Unsigned) 0U));
  }
  mercury__set__insert_3_p_0((MR_Word) (&parse_tree__parse_error__parse_tree__parse_error__type_ctor_info_fatal_read_module_error_0), ((MR_Box) (FatalError_7)), FatalErrors0_24, &FatalErrors_29);
  FatalSpecs_30 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_error_spec_0), Var_15, (MR_Word) ((MR_Unsigned) 0U));
  {
    MR_Word base;
    base = (MR_Word) MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL);
    *Errors_8 = base;
    MR_hl_field(0, base, 0) = ((MR_Box) (FatalErrors_29));
    MR_hl_field(0, base, 1) = ((MR_Box) (FatalSpecs_30));
    MR_hl_field(0, base, 2) = ((MR_Box) (NonFatalErrors_26));
  ...
  MR_Word * Spec_6)
{
  ...
  mercury__io__progname_base_4_p_0((MR_String) "mercury_compile", &ProgName_8);
  {
    ...
    MR_hl_field(2, Var_14, 0) = ((MR_Box) (ProgName_8));
  }
  {
    Var_19 = (MR_Word) MR_mkword(3, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(3, Var_19, 0) = ((MR_Box) ((MR_Unsigned) 6U));
    MR_hl_field(3, Var_19, 1) = ((MR_Box) (ErrorMsg_5));
  }
  {
    Var_18 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(1, Var_18, 0) = ((MR_Box) (Var_19));
    MR_hl_field(1, Var_18, 1) = ((MR_Box) (MR_mkword(1, &parse_tree__parse_error_scalar_common_1[4])));
  }
  {
    Var_15 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(1, Var_15, 0) = ((MR_Box) (MR_mkword(3, &parse_tree__parse_error_scalar_common_1[3])));
    MR_hl_field(1, Var_15, 1) = ((MR_Box) (Var_18));
  }
  {
    Pieces_9 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(1, Pieces_9, 0) = ((MR_Box) (Var_14));
    MR_hl_field(1, Pieces_9, 1) = ((MR_Box) (Var_15));
  }
  {
    MR_Word base;
    base = (MR_Word) MR_mkword(2, MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL));
    *Spec_6 = base;
    MR_hl_field(2, base, 0) = ((MR_Box) ((MR_String) "predicate \140parse_tree.parse_error.io_error_to_error_spec\'/4"));
    MR_hl_field(2, base, 1) = ((MR_Box) ((MR_Unsigned) 0U));
    MR_hl_field(2, base, 2) = ((MR_Box) ((MR_Unsigned) 12U));
    MR_hl_field(2, base, 3) = ((MR_Box) (Pieces_9));
  }
}
