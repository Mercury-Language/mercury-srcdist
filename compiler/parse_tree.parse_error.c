  ...
  MR_Word * Spec_8)
{
  ...
  }
  {
    ...
    *Spec_8 = base;
    MR_hl_field(2, base, 0) = ((MR_Box) ((MR_String) "predicate \140parse_tree.parse_error.io_error_to_error_spec\'/5"));
    MR_hl_field(2, base, 1) = ((MR_Box) ((MR_Unsigned) 0U));
    MR_hl_field(2, base, 2) = ((MR_Box) (Phase_6));
    MR_hl_field(2, base, 3) = ((MR_Box) (Pieces_11));
  }
}
