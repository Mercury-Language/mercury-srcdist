...
MR_decl_static(fn__hlds__make_hlds__add_type__IntroducedFrom__func__ctors_add__739__1_1_0)
...
{
MR_COMMON(10,0),
MR_ENTRY_AP(fn__hlds__make_hlds__add_type__IntroducedFrom__func__ctors_add__739__1_1_0),
0
},
};
...
MR_def_label(hlds__make_hlds__add_type__merge_foreign_type_bodies_5_0,15)
	...
	MR_tag_alloc_heap(MR_r2, 1, (MR_Integer) 9);
	MR_tempr2 = MR_sv(3);
	MR_tfield(1, MR_r2, 0) = MR_tfield(1, MR_tempr2, 0);
	MR_tfield(1, MR_r2, 1) = MR_tfield(1, MR_tempr2, 1);
	MR_tfield(1, MR_r2, 2) = MR_tfield(1, MR_tempr2, 2);
	MR_tfield(1, MR_r2, 3) = MR_tfield(1, MR_tempr2, 3);
	MR_tfield(1, MR_r2, 4) = MR_tfield(1, MR_tempr2, 4);
	MR_tfield(1, MR_r2, 5) = MR_tfield(1, MR_tempr2, 5);
	MR_tfield(1, MR_r2, 6) = MR_tfield(1, MR_tempr2, 6);
	MR_tfield(1, MR_r2, 7) = MR_tfield(1, MR_tempr2, 7);
	MR_tfield(1, MR_r2, 8) = MR_tempr1;
	MR_r1 = MR_TRUE;
	MR_decr_sp_and_return(4);
	}
...
MR_def_label(hlds__make_hlds__add_type__convert_type_defn_4_0,9)
	...
	MR_tfield(1, MR_r2, 7) = MR_sv(6);
	MR_tfield(1, MR_r2, 8) = (MR_Word) MR_tbmkword(0, 0);
	MR_r1 = MR_r2;
...
MR_def_label(hlds__make_hlds__add_type__convert_type_defn_4_0,7)
	...
	MR_tfield(1, MR_tempr1, 7) = MR_r2;
	MR_tfield(1, MR_tempr1, 8) = (MR_Word) MR_tbmkword(0, 0);
	MR_r1 = MR_tempr1;
	MR_decr_sp_and_return(8);
	}
...
MR_def_label(hlds__make_hlds__add_type__process_type_defn_8_0,9)
	...
	MR_sv(12) = MR_tfield(1, MR_tempr1, 6);
	MR_r1 = MR_sv(16);
	}
...
MR_BEGIN_MODULE(hlds__make_hlds__add_type_module16)
	MR_init_entry1(fn__hlds__make_hlds__add_type__IntroducedFrom__func__ctors_add__739__1_1_0);
	MR_INIT_PROC_LAYOUT_ADDR(mercury__fn__hlds__make_hlds__add_type__IntroducedFrom__func__ctors_add__739__1_1_0);
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'IntroducedFrom__func__ctors_add__739__1'/2 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(fn__hlds__make_hlds__add_type__IntroducedFrom__func__ctors_add__739__1_1_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
