...
{
  {
    ...
    switch (MR_tag((MR_Word) Body_18)) {
      ...
      case (MR_Integer) 0:
        {
          MR_Word ForeignTypeBody_38 = (MR_Word) ((MR_Word) (Body_18));
      ...
      case (MR_Integer) 1:
        {
          ...
          hlds__hlds_module__module_info_set_cons_table_3_p_0(CtorMap_34, STATE_VARIABLE_ModuleInfo_0_46, &STATE_VARIABLE_ModuleInfo_56_56);
          hlds__hlds_module__module_info_set_ctor_field_table_3_p_0(CtorFieldMap_33, STATE_VARIABLE_ModuleInfo_56_56, STATE_VARIABLE_ModuleInfo_47);
...
{
  {
    ...
    conv3_LambdaHeadVar__2_96 = hlds__make_hlds__add_type__IntroducedFrom__func__add_type_defn_ctor__1071__1_1_f_0(((MR_Word) (wrapper_arg_1)));
