...
hlds__make_hlds__add_type__IntroducedFrom__pred__compute_subtype_ctors_diff__2023__1_2_p_0(
  ...
  MR_Box wrapper_arg_1)
{
  ...
  succeeded = hlds__make_hlds__add_type__IntroducedFrom__pred__compute_subtype_ctors_diff__2023__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_String) (wrapper_arg_1)));
  return succeeded;
}
  ...
  MR_Box wrapper_arg_1)
{
  ...
  conv3_LambdaHeadVar__2_100 = hlds__make_hlds__add_type__IntroducedFrom__func__add_type_defn_ctor__1087__1_1_f_0(((MR_Word) (wrapper_arg_1)));
