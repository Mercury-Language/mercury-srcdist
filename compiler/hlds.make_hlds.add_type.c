...
{
  {
    ...
    conv3_LambdaHeadVar__2_91 = hlds__make_hlds__add_type__IntroducedFrom__func__add_type_defn_ctor__1054__1_1_f_0(((MR_Word) (wrapper_arg_1)));
    ...
    (env).hlds__make_hlds__add_type__add_type_defn_ctor_15_p_0_env_0__TypeCtor_17 = TypeCtor_17;
    {
      ...
      else
      {
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(0), Var_86, 0) = ((MR_Box) (&hlds__make_hlds__add_type_scalar_common_5[0]));
...
{
  {
    ...
    else
    {
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(0), Var_76, 0) = ((MR_Box) (&hlds__make_hlds__add_type_scalar_common_4[0]));
