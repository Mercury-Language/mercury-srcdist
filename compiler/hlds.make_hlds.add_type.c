...
static /* final */ const MR_Box hlds__make_hlds__add_type_scalar_common_1[90][2] = {
  ...
  /* row 71 */
  {
    ((MR_Box) (MR_mkword(MR_mktag(2), &hlds__make_hlds__add_type_scalar_common_1[70]))),
    ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))))
  },
  /* row 72 */
  {
    ...
    if (hlds__make_hlds__add_type__succeeded)
      {
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(1), hlds__make_hlds__add_type__Pieces_32, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__add_type_scalar_common_1[88])));
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(1), hlds__make_hlds__add_type__PrevPieces_34, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__add_type_scalar_common_1[89])));
      ...
      if ((hlds__make_hlds__add_type__env).hlds__make_hlds__add_type__add_type_defn_ctor_15_p_0_env_0__succeeded)
        {
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(1), hlds__make_hlds__add_type__Var_68, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__add_type_scalar_common_1[87])));
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(1), hlds__make_hlds__add_type__Pieces_47, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__add_type_scalar_common_1[86])));
          ...
          case (MR_Integer) 1:
            {
              ...
              {
                hlds__make_hlds__add_type__Pieces_23 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(1), hlds__make_hlds__add_type__Pieces_23, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__add_type_scalar_common_1[80])));
...
{
  {
    ...
    if (hlds__make_hlds__add_type__succeeded)
    ...
    else
      {
        ...
        {
          hlds__make_hlds__add_type__Var_58 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), hlds__make_hlds__add_type__Var_58, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__add_type_scalar_common_1[77])));
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(1), hlds__make_hlds__add_type__Var_55, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__add_type_scalar_common_1[76])));
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(1), hlds__make_hlds__add_type__Var_49, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__add_type_scalar_common_1[75])));
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(1), hlds__make_hlds__add_type__MainPieces_33, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__add_type_scalar_common_1[74])));
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(1), hlds__make_hlds__add_type__OldPieces_34, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__add_type_scalar_common_1[78])));
      ...
      if ((hlds__make_hlds__add_type__env).hlds__make_hlds__add_type__check_for_polymorphic_eqv_type_with_monomorphic_body_9_p_0_env_0__succeeded)
        {
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(1), hlds__make_hlds__add_type__PolyEqvPieces_21, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__add_type_scalar_common_1[69])));
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(1), hlds__make_hlds__add_type__Var_49, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &hlds__make_hlds__add_type_scalar_common_1[73])));
          }
          {
    ...
    if (hlds__make_hlds__add_type__succeeded)
      {
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(1), hlds__make_hlds__add_type__DummyMainPieces_22, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__add_type_scalar_common_1[69])));
        ...
        }
        {
          hlds__make_hlds__add_type__Var_61 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), hlds__make_hlds__add_type__Var_61, 0) = ((MR_Box) (hlds__make_hlds__add_type__Var_62));
          MR_hl_field(MR_mktag(1), hlds__make_hlds__add_type__Var_61, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &hlds__make_hlds__add_type_scalar_common_1[71])));
        }
        {
    ...
    if (hlds__make_hlds__add_type__succeeded)
    ...
    else
      {
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(1), hlds__make_hlds__add_type__ForeignDeclPieces_36, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__add_type_scalar_common_1[68])));
