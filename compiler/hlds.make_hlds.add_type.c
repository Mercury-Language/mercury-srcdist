...
MR_decl_label10(hlds__make_hlds__add_type__convert_type_defn_4_0, 3,6,9,7,5,13,17,22,27,32)
...
MR_decl_label9(hlds__make_hlds__add_type__merge_foreign_type_bodies_5_0, 88,3,11,13,16,15,9,23,1)
...
MR_BEGIN_MODULE(hlds__make_hlds__add_type_module7)
	...
	MR_init_label9(hlds__make_hlds__add_type__merge_foreign_type_bodies_5_0,88,3,11,13,16,15,9,23,1)
MR_BEGIN_CODE
...
MR_def_label(hlds__make_hlds__add_type__merge_foreign_type_bodies_5_0,88)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	while (1) {
...
MR_def_label(hlds__make_hlds__add_type__merge_foreign_type_bodies_5_0,9)
	...
	MR_np_call_localret_ent(hlds__make_hlds__add_type__merge_foreign_type_bodies_2_3_0,
		hlds__make_hlds__add_type__merge_foreign_type_bodies_5_0_i23);
...
MR_BEGIN_MODULE(hlds__make_hlds__add_type_module8)
	...
	MR_init_label10(hlds__make_hlds__add_type__convert_type_defn_4_0,3,6,9,7,5,13,17,22,27,32)
...
MR_def_label(hlds__make_hlds__add_type__convert_type_defn_4_0,17)
	...
	if (MR_PTAG_TESTR(MR_r6,0)) {
		MR_GOTO_LAB(hlds__make_hlds__add_type__convert_type_defn_4_0_i22);
	}
	{
	MR_Word MR_tempr1, MR_tempr2;
...
MR_def_label(hlds__make_hlds__add_type__convert_type_defn_4_0,22)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_r6,2)) {
		MR_GOTO_LAB(hlds__make_hlds__add_type__convert_type_defn_4_0_i27);
	}
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tag_alloc_heap(MR_tempr1, 0, (MR_Integer) 3);
...
MR_def_label(hlds__make_hlds__add_type__convert_type_defn_4_0,27)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_RTAGS_TESTR(MR_r6,3,0)) {
		MR_GOTO_LAB(hlds__make_hlds__add_type__convert_type_defn_4_0_i32);
	}
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tag_alloc_heap(MR_tempr1, 0, (MR_Integer) 3);
...
MR_def_label(hlds__make_hlds__add_type__convert_type_defn_4_0,32)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tag_alloc_heap(MR_tempr1, 0, (MR_Integer) 3);
...
MR_def_label(hlds__make_hlds__add_type__process_type_defn_8_0,9)
	...
	MR_sv(12) = MR_tfield(0, MR_tempr1, 6);
	MR_r1 = MR_sv(16);
	}
