    ...
    else
    {
      ...
      else
      {
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(0), Msg_24, 1) = ((MR_Box) (Var_75));
        }
        {
...
{
  {
    ...
    if (succeeded)
    {
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(0), HereMsg_33, 1) = ((MR_Box) (Var_57));
      }
      {
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(0), PrevMsg_35, 1) = ((MR_Box) (Var_70));
      }
      {
      ...
      case (MR_Integer) 1:
        {
          ...
          if (succeeded)
          {
            ...
            }
            {
              ...
              MR_hl_field(MR_mktag(0), Var_75, 0) = ((MR_Box) (Context_20));
...
{
  {
    ...
    else
    {
      ...
      {
        ForeignDeclMsg_38 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), ForeignDeclMsg_38, 0) = ((MR_Box) (Context_18));
        MR_hl_field(MR_mktag(0), ForeignDeclMsg_38, 1) = ((MR_Box) (Var_70));
      }
      {
        Var_75 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
...
{
  {
    ...
    if (succeeded)
    {
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(0), Msg_28, 0) = ((MR_Box) (Context_27));
        MR_hl_field(MR_mktag(0), Msg_28, 1) = ((MR_Box) (Var_60));
      }
      {
...
{
  {
    ...
    if (succeeded)
    {
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(0), DupMsg_29, 1) = ((MR_Box) (Var_76));
      }
      {
        ...
        MR_hl_field(MR_mktag(0), FirstMsg_31, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &hlds__make_hlds__add_type_scalar_common_1[70])));
      }
      {
        Var_89 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
