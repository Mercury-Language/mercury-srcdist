    ...
    case (MR_Integer) 0:
      ...
      else
      {
        ...
        else
        {
          ...
          hlds__make_hlds__add_type__check_subtype_ctor_exist_constraints_9_p_0(CtorSymNameArity_33, Var_67, SuperConstraints_32, ExistQVarsMapping_30, Context_22, STATE_VARIABLE_FoundInvalidType_0_36, STATE_VARIABLE_FoundInvalidType_37, STATE_VARIABLE_Specs_44_44, STATE_VARIABLE_Specs_39);
        }
      }
      break;
    case (MR_Integer) 1:
  ...
  else
  {
    ...
    else
    {
      ...
      mercury__list__map_3_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_constructor_0), (MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&hlds__make_hlds__add_type_scalar_common_2[6]), SuperCtors_5, &SuperCtorStrs0_12);
      {
        ...
        MR_hl_field(MR_mktag(0), Var_24, 1) = ((MR_Box) (hlds__make_hlds__add_type__compute_subtype_ctors_diff_3_p_0_3));
        MR_hl_field(MR_mktag(0), Var_24, 2) = ((MR_Box) ((MR_Integer) 1));
        MR_hl_field(MR_mktag(0), Var_24, 3) = ((MR_Box) (SuperCtorStrs0_12));
      }
      mercury__list__filter_3_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), Var_24, CtorStrs0_11, &CtorStrs_13);
      {
        Var_25 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), Var_25, 0) = ((MR_Box) (&hlds__make_hlds__add_type_scalar_common_4[3]));
        MR_hl_field(MR_mktag(0), Var_25, 1) = ((MR_Box) (hlds__make_hlds__add_type__compute_subtype_ctors_diff_3_p_0_4));
        MR_hl_field(MR_mktag(0), Var_25, 2) = ((MR_Box) ((MR_Integer) 1));
        MR_hl_field(MR_mktag(0), Var_25, 3) = ((MR_Box) (CtorStrs0_11));
      }
      mercury__list__filter_3_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), Var_25, SuperCtorStrs0_12, &SuperCtorStrs_14);
  ...
  MR_Word * MaybeSuperTypeDefn_12)
{
  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      Var_37 = hlds__status__type_status_defined_in_this_module_1_f_0(OrigTypeStatus_15);
      succeeded = (Var_37 == (MR_Integer) 1);
      if (succeeded)
      {
        Var_38 = hlds__status__type_status_defined_in_impl_section_1_f_0(OrigTypeStatus_15);
        succeeded = (Var_38 == (MR_Integer) 0);
        if (succeeded)
        {
          Var_39 = hlds__status__type_status_defined_in_this_module_1_f_0(SuperTypeStatus_16);
          succeeded = (Var_39 == (MR_Integer) 1);
          if (succeeded)
          {
            Var_40 = hlds__status__type_status_defined_in_impl_section_1_f_0(SuperTypeStatus_16);
      ...
      if (succeeded)
      {
        ...
        else
        {
          ...
          if (succeeded)
          {
            ...
            Var_69 = hlds__status__type_status_defined_in_this_module_1_f_0(OrigTypeStatus_47);
            succeeded = (Var_69 == (MR_Integer) 1);
            if (succeeded)
            {
              Var_70 = hlds__status__type_status_defined_in_impl_section_1_f_0(OrigTypeStatus_47);
              succeeded = (Var_70 == (MR_Integer) 0);
              if (succeeded)
              {
                Var_71 = hlds__status__type_status_defined_in_this_module_1_f_0(SuperTypeStatus_48);
                succeeded = (Var_71 == (MR_Integer) 1);
                if (succeeded)
                {
                  Var_72 = hlds__status__type_status_defined_in_impl_section_1_f_0(SuperTypeStatus_48);
            ...
            if (succeeded)
            {
              ...
              {
                SearchResult_75 = (MR_Word) MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL);
                MR_hl_field(MR_mktag(0), SearchResult_75, 0) = ((MR_Box) (Var_56));
              }
            }
            else
            {
              ...
              if (((MR_tag((MR_Word) MaybeSuperTypeBodyDu_49)) == (MR_Integer) 0))
              {
                ...
                {
                  SearchResult_75 = (MR_Word) MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL);
                  MR_hl_field(MR_mktag(0), SearchResult_75, 0) = ((MR_Box) (SuperSpecs_51));
                }
              }
              else
              {
                ...
                {
                  SearchResult_75 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                  MR_hl_field(MR_mktag(1), SearchResult_75, 0) = ((MR_Box) (SuperTypeDefn_46));
                  MR_hl_field(MR_mktag(1), SearchResult_75, 1) = ((MR_Box) (SuperTypeBodyDu_50));
                }
              }
            }
          }
          else
          {
            ...
            {
              SearchResult_75 = (MR_Word) MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL);
              MR_hl_field(MR_mktag(0), SearchResult_75, 0) = ((MR_Box) (Var_59));
            }
          }
          if (((MR_tag((MR_Word) SearchResult_75)) == (MR_Integer) 0))
          {
            MR_Word SearchSpecs_73 = ((MR_Word) ((MR_hl_field(MR_mktag(0), SearchResult_75, (MR_Integer) 0))));

            {
              MR_Word base;
              base = (MR_Word) MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL);
              *MaybeBaseMaybeCanon_16 = base;
              MR_hl_field(MR_mktag(0), base, 0) = ((MR_Box) (SearchSpecs_73));
            }
          }
          else
          {
            MR_Word NextSuperTypeDefn_26 = ((MR_Word) ((MR_hl_field(MR_mktag(1), SearchResult_75, (MR_Integer) 0))));
            MR_Word NextSuperTypeBodyDu_27 = ((MR_Word) ((MR_hl_field(MR_mktag(1), SearchResult_75, (MR_Integer) 1))));
    ...
    case (MR_Integer) 2:
      {
        ...
        Var_78 = hlds__make_hlds__add_type__describe_supertype_chain_3_f_0(OrigTypeCtor_7, PrevSuperTypeCtors_9, LastSuperTypeCtor_10);
    ...
    case (MR_Integer) 0:
      {
        ...
        Var_20 = hlds__make_hlds__add_type__describe_supertype_chain_3_f_0(OrigTypeCtor_7, PrevSuperTypeCtors_9, LastSuperTypeCtor_10);
    ...
    case (MR_Integer) 1:
      {
        ...
        if (succeeded)
        {
          ...
          Var_37 = hlds__make_hlds__add_type__describe_supertype_chain_3_f_0(OrigTypeCtor_7, PrevSuperTypeCtors_9, LastSuperTypeCtor_10);
        ...
        else
        {
          ...
          Var_54 = hlds__make_hlds__add_type__describe_supertype_chain_3_f_0(OrigTypeCtor_7, PrevSuperTypeCtors_9, LastSuperTypeCtor_10);
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      else
      {
        ...
        if (succeeded)
        {
          TypeCtorInfo_36_75 = (MR_Word) (&hlds__hlds_cons__hlds__hlds_cons__type_ctor_info_hlds_ctor_field_defn_0);
          {
          ...
          succeeded = mercury__list__find_first_match_3_p_0(TypeCtorInfo_36_75, Var_67, ExistingDefns_62, &conv1__ConflictingDefn_63);
          if (succeeded)
            succeeded = MR_TRUE;
        }
        if (succeeded)
  ...
  MR_Word * STATE_VARIABLE_Specs_42)
{
  ...
  if (succeeded)
  {
    ...
    MR_Word STATE_VARIABLE_Specs_44_44;
    MR_Word OldTypeStatus_79;

    hlds__hlds_data__get_type_defn_status_2_p_0(OldDefn_23, &OldTypeStatus_79);
    hlds__status__type_combine_status_3_p_0(TypeStatus1_14, OldTypeStatus_79, &TypeStatus_24);
    ...
    case (MR_Integer) 1:
      {
        ...
        succeeded = (Var_65 == (MR_Word) ((MR_Unsigned) 20U));
        if (succeeded)
        {
          MR_Word Var_66;

          Var_66 = hlds__status__type_status_is_exported_to_non_submodules_1_f_0(NewStatus_17);
          succeeded = (Var_66 == (MR_Integer) 0);
        }
        else
        {
          MR_Word Var_67 = (MR_Word) (OldStatus_15);

          succeeded = (Var_67 == (MR_Word) ((MR_Unsigned) 12U));
          if (succeeded)
          {
            MR_Word Var_68 = (MR_Word) (NewStatus_17);
          ...
          else
          {
            ...
            Var_69 = hlds__status__type_status_is_exported_to_non_submodules_1_f_0(OldStatus_15);
  ...
  if (succeeded)
  {
    ...
    if (succeeded)
    {
      ...
      else
      {
        ...
        Var_78 = (MR_Word) (Arity_74);
        hlds__make_hlds_error__report_multiply_defined_8_p_0((MR_String) "type", SymName_73, Var_78, Context_20, OldContext_75, (MR_Word) ((MR_Unsigned) 0U), STATE_VARIABLE_Specs_42_42, &STATE_VARIABLE_Specs_45_45);
  ...
  MR_Word * STATE_VARIABLE_Specs_30)
{
  ...
  if (succeeded)
  {
    ...
    hlds__hlds_data__get_type_defn_status_2_p_0(OldDefn_21, &OldTypeStatus_39);
    hlds__status__type_combine_status_3_p_0(TypeStatus1_12, OldTypeStatus_39, &_TypeStatus_22);
  ...
  switch (MR_tag((MR_Word) OldBody_15)) {
    ...
    case (MR_Integer) 3:
      switch (((MR_Integer) ((MR_hl_field(MR_mktag(3), OldBody_15, (MR_Integer) 0))))) {
        ...
        case (MR_Integer) 1:
          {
            MR_Word Details_87 = ((MR_Word) ((MR_hl_field(MR_mktag(3), OldBody_15, (MR_Integer) 1))));

            switch (MR_tag((MR_Word) Details_87)) {
              default: /*NOTREACHED*/ MR_assert(0);
              case (MR_Integer) 0:
                switch (MR_unmkbody(Details_87)) {
                  default: /*NOTREACHED*/ MR_assert(0);
                  case (MR_Integer) 0:
                  case (MR_Integer) 1:
                  case (MR_Integer) 2:
        ...
        case (MR_Integer) 1:
          {
...

            {
              ...
              MR_hl_field(MR_mktag(1), Var_51, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &hlds__make_hlds__add_type_scalar_common_1[24])));
            }
            {
              DupPieces_26 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), DupPieces_26, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__add_type_scalar_common_1[16])));
