...
MR_decl_label4(hlds__make_hlds__add_type__convert_type_defn_4_0, 38,43,48,31)
...
MR_decl_label10(hlds__make_hlds__add_type__merge_foreign_type_bodies_5_0, 197,3,11,10,15,13,12,20,18,17)
MR_decl_label10(hlds__make_hlds__add_type__merge_foreign_type_bodies_5_0, 25,23,22,30,28,27,35,33,32,41)
MR_decl_label4(hlds__make_hlds__add_type__merge_foreign_type_bodies_5_0, 40,9,48,1)
...
MR_decl_static(fn__hlds__make_hlds__add_type__IntroducedFrom__func__ctors_add__757__1_1_0)
...
{
MR_COMMON(9,0),
MR_ENTRY_AP(fn__hlds__make_hlds__add_type__IntroducedFrom__func__ctors_add__757__1_1_0),
0
},
};
...
MR_BEGIN_MODULE(hlds__make_hlds__add_type_module7)
	...
	MR_init_label10(hlds__make_hlds__add_type__merge_foreign_type_bodies_5_0,197,3,11,10,15,13,12,20,18,17)
	MR_init_label10(hlds__make_hlds__add_type__merge_foreign_type_bodies_5_0,25,23,22,30,28,27,35,33,32,41)
	MR_init_label4(hlds__make_hlds__add_type__merge_foreign_type_bodies_5_0,40,9,48,1)
MR_BEGIN_CODE
...
MR_def_label(hlds__make_hlds__add_type__merge_foreign_type_bodies_5_0,197)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	while (1) {
...
MR_def_label(hlds__make_hlds__add_type__merge_foreign_type_bodies_5_0,9)
	...
	MR_np_call_localret_ent(hlds__make_hlds__add_type__merge_foreign_type_bodies_2_3_0,
		hlds__make_hlds__add_type__merge_foreign_type_bodies_5_0_i48);
MR_def_label(hlds__make_hlds__add_type__merge_foreign_type_bodies_5_0,48)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(hlds__make_hlds__add_type__merge_foreign_type_bodies_5_0_i1);
	}
...
MR_BEGIN_MODULE(hlds__make_hlds__add_type_module8)
	...
	MR_init_label4(hlds__make_hlds__add_type__convert_type_defn_4_0,38,43,48,31)
MR_BEGIN_CODE
...
MR_def_label(hlds__make_hlds__add_type__convert_type_defn_4_0,43)
	...
	if (MR_RTAGS_TESTR(MR_r6,3,0)) {
		MR_GOTO_LAB(hlds__make_hlds__add_type__convert_type_defn_4_0_i48);
	}
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tag_alloc_heap(MR_tempr1, 0, (MR_Integer) 3);
...
MR_def_label(hlds__make_hlds__add_type__check_foreign_type_8_0,59)
	...
	MR_tag_alloc_heap(MR_tempr6, 1, (MR_Integer) 2);
	MR_r5 = MR_tempr6;
	MR_tfield(1, MR_tempr6, 0) = (MR_Word) MR_TAG_COMMON(1,3,5);
	MR_tfield(1, MR_tempr6, 1) = MR_tempr5;
	MR_tag_alloc_heap(MR_tempr7, 1, (MR_Integer) 2);
	MR_r4 = MR_tempr7;
	MR_tfield(1, MR_tempr7, 0) = (MR_Word) MR_TAG_COMMON(3,1,6);
...
MR_BEGIN_MODULE(hlds__make_hlds__add_type_module16)
	MR_init_entry1(fn__hlds__make_hlds__add_type__IntroducedFrom__func__ctors_add__757__1_1_0);
	MR_INIT_PROC_LAYOUT_ADDR(mercury__fn__hlds__make_hlds__add_type__IntroducedFrom__func__ctors_add__757__1_1_0);
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'IntroducedFrom__func__ctors_add__757__1'/2 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(fn__hlds__make_hlds__add_type__IntroducedFrom__func__ctors_add__757__1_1_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
