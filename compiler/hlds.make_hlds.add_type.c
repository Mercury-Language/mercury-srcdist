      ...
      case (MR_Integer) 0:
        {
          ...
          MR_Word VarB_16;
          MR_Word Var_71;
          MR_Word TypeInfo_11_97;

          succeeded = ((MR_tag((MR_Word) TypeB_12)) == (MR_Integer) 0);
          if (succeeded)
          {
            VarB_16 = ((MR_Word) ((MR_hl_field(0, TypeB_12, 0))));
            Var_71 = ((MR_Word) ((MR_hl_field(0, TypeB_12, 1))));
            succeeded = parse_tree__prog_data____Unify____kind_0_0(Kind_15, Var_71);
            if (succeeded)
            {
              TypeInfo_11_97 = (MR_Word) (&hlds__make_hlds__add_type_scalar_common_1[0]);
              succeeded = mercury__builtin__unify_2_p_0(TypeInfo_11_97, ((MR_Box) (VarA_14)), ((MR_Box) (VarB_16)));
              if (succeeded)
              {
                MR_Box conv0_Var_93;

                succeeded = mercury__bimap__forward_search_3_p_0((MR_Word) (&hlds__make_hlds__add_type_scalar_common_1[0]), (MR_Word) (&hlds__make_hlds__add_type_scalar_common_1[0]), ExistQVarsMapping_10, ((MR_Box) (VarB_16)), &conv0_Var_93);
                if (succeeded)
                  succeeded = MR_TRUE;
                succeeded = !(succeeded);
              }
              else
              {
                ...
                succeeded = mercury__bimap__forward_search_3_p_0((MR_Word) (&hlds__make_hlds__add_type_scalar_common_1[0]), (MR_Word) (&hlds__make_hlds__add_type_scalar_common_1[0]), ExistQVarsMapping_10, ((MR_Box) (VarB_16)), &conv1_Var_96);
                if (succeeded)
                {
                  Var_96 = ((MR_Word) (conv1_Var_96));
                  succeeded = MR_TRUE;
                }
                if (succeeded)
                {
                  TypeInfo_12_98 = (MR_Word) (&hlds__make_hlds__add_type_scalar_common_1[0]);
                  succeeded = mercury__builtin__unify_2_p_0(TypeInfo_12_98, ((MR_Box) (VarA_14)), ((MR_Box) (Var_96)));
                }
              }
            }
          }
      ...
      case (MR_Integer) 1:
        {
          ...
          MR_Word Kind_58 = ((MR_Word) ((MR_hl_field(1, TypeA_11, 2))));
          MR_Word Var_72;
          ...
          if (succeeded)
          {
            ...
            Var_72 = ((MR_Word) ((MR_hl_field(1, TypeB_12, 2))));
            succeeded = parse_tree__prog_data____Unify____kind_0_0(Kind_58, Var_72);
            if (succeeded)
            {
              TypeCtorInfo_66_66 = (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0);
              mercury__list__length_2_p_0(TypeCtorInfo_66_66, ArgTypesA_18, &ArityA_21);
              mercury__list__length_2_p_0(TypeCtorInfo_66_66, ArgTypesB_20, &ArityB_22);
              ...
              else
              {
                ...
                if (succeeded)
                {
                  ...
                  if (succeeded)
                  {
                    ...
                    Var_57 = ((MR_Word) ((MR_hl_field(0, TypeBodyDuA_26, 2))));
                    succeeded = (Var_57 != (MR_Word) ((MR_Unsigned) 0U));
                    if (succeeded)
                    {
                      SuperTypeA_29 = ((MR_Word) ((MR_hl_field(1, Var_57, 0))));
                      hlds__hlds_data__get_type_defn_status_2_p_0(TypeDefnA_24, &TypeStatusA_33);
                      Var_88 = hlds__status__type_status_defined_in_this_module_1_f_0(OrigTypeStatus_9);
                      succeeded = (Var_88 == (MR_Integer) 1);
                      if (succeeded)
                      {
                        Var_89 = hlds__status__type_status_defined_in_impl_section_1_f_0(OrigTypeStatus_9);
                        succeeded = (Var_89 == (MR_Integer) 0);
                        if (succeeded)
                        {
                          Var_90 = hlds__status__type_status_defined_in_this_module_1_f_0(TypeStatusA_33);
                          succeeded = (Var_90 == (MR_Integer) 1);
                          if (succeeded)
                          {
                            Var_91 = hlds__status__type_status_defined_in_impl_section_1_f_0(TypeStatusA_33);
                      ...
                      if (succeeded)
                      {
                        ...
                        TypeInfo_67_67 = (MR_Word) (&hlds__make_hlds__add_type_scalar_common_1[0]);
                        mercury__map__from_corresponding_lists_3_p_0(TypeInfo_67_67, TypeCtorInfo_66_66, TypeParamsA_38, ArgTypesA_18, &TSubstA_39);
                        parse_tree__prog_type_subst__apply_renaming_to_type_3_p_0(RenamingA_37, SuperTypeA_29, &Type1_92);
                        parse_tree__prog_type_subst__apply_rec_subst_to_type_3_p_0(TSubstA_39, Type1_92, &RenamedSuperTypeA_40);
      ...
      case (MR_Integer) 2:
        {
          ...
          if (succeeded)
          {
            Var_70 = ((MR_Word) ((MR_hl_field(2, TypeB_12, 0))));
            succeeded = parse_tree__prog_data____Unify____builtin_type_0_0(BuiltinType_13, Var_70);
          }
        }
        break;
      case (MR_Integer) 3:
        switch (((MR_Integer) ((MR_hl_field(3, TypeA_11, 0))))) {
          ...
          case (MR_Integer) 0:
            {
              ...
              MR_Integer Arity_41;
              MR_Word Kind_59 = ((MR_Word) ((MR_hl_field(3, TypeA_11, 2))));
              MR_Word ArgTypesA_60 = ((MR_Word) ((MR_hl_field(3, TypeA_11, 1))));
              ...
              if (succeeded)
              {
                ArgTypesB_61 = ((MR_Word) ((MR_hl_field(3, TypeB_12, 1))));
                Var_73 = ((MR_Word) ((MR_hl_field(3, TypeB_12, 2))));
                succeeded = parse_tree__prog_data____Unify____kind_0_0(Kind_59, Var_73);
                if (succeeded)
                {
                  TypeCtorInfo_68_68 = (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0);
                  mercury__list__length_2_p_0(TypeCtorInfo_68_68, ArgTypesA_60, &Arity_41);
                  mercury__list__length_2_p_0(TypeCtorInfo_68_68, ArgTypesB_61, &Var_74);
                  succeeded = (Arity_41 == Var_74);
                  if (succeeded)
                    succeeded = hlds__make_hlds__add_type__check_corresponding_args_are_subtype_6_p_0(TypeTable_7, TVarSet0_8, OrigTypeStatus_9, ExistQVarsMapping_10, ArgTypesA_60, ArgTypesB_61);
                }
              }
            }
            break;
          case (MR_Integer) 1:
            {
              ...
              MR_Word ArgTypesA_62 = ((MR_Word) ((MR_hl_field(3, TypeA_11, 2))));
              ...
              if (succeeded)
              {
                Var_75 = ((MR_Unsigned) ((MR_hl_field(3, TypeB_12, 1))) & (MR_Integer) 1);
                ArgTypesB_63 = ((MR_Word) ((MR_hl_field(3, TypeB_12, 2))));
                HOInstInfoB_45 = ((MR_Word) ((MR_hl_field(3, TypeB_12, 3))));
                Var_76 = ((MR_Unsigned) ((MR_hl_field(3, TypeB_12, 4))) & (MR_Integer) 3);
                succeeded = (PredOrFunc_42 == Var_75);
                if (succeeded)
                {
                  succeeded = (Purity_44 == Var_76);
                  if (succeeded)
                  {
                    TypeCtorInfo_69_69 = (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0);
                    mercury__list__length_2_p_0(TypeCtorInfo_69_69, ArgTypesA_62, &Arity_64);
                    mercury__list__length_2_p_0(TypeCtorInfo_69_69, ArgTypesB_63, &Var_77);
                    succeeded = (Arity_64 == Var_77);
                    if (succeeded)
                    {
                      ...
                      else
                      {
                        ...
                        if (succeeded)
                        {
                          ...
                          Var_78 = ((MR_Unsigned) ((MR_hl_field(0, PredInfoInfoA_46, 0))) & (MR_Integer) 1);
                          ...
                          if (succeeded)
                          {
                            Var_79 = ((MR_Unsigned) ((MR_hl_field(0, PredInfoInfoB_47, 0))) & (MR_Integer) 1);
                            ArgModesB_51 = ((MR_Word) ((MR_hl_field(0, PredInfoInfoB_47, 1))));
                            Var_80 = ((MR_Unsigned) ((MR_hl_field(0, PredInfoInfoB_47, 3))) & (MR_Integer) 7);
                            succeeded = (PredOrFunc_42 == Var_79);
                            if (succeeded)
                            {
                              succeeded = (Detism_50 == Var_80);
                              if (succeeded)
                              {
                                {
                      ...
                      if (succeeded)
                        succeeded = hlds__make_hlds__add_type__check_is_subtype_higher_order_8_p_0(TypeTable_7, TVarSet0_8, OrigTypeStatus_9, ExistQVarsMapping_10, ArgTypesA_62, ArgTypesB_63, MaybeArgModesA_53, MaybeArgModesB_54);
                    }
                  }
                }
              }
          ...
          case (MR_Integer) 2:
            {
              MR_Word TypeA1_55 = ((MR_Word) ((MR_hl_field(3, TypeA_11, 1))));
              MR_Word TypeB1_56;
              MR_Word Kind_65 = ((MR_Word) ((MR_hl_field(3, TypeA_11, 2))));
              MR_Word Var_81;
              MR_Word next_value_of_TypeA_11;
              MR_Word next_value_of_TypeB_12;

              succeeded = ((((MR_tag((MR_Word) TypeB_12)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(3, TypeB_12, 0)))) == (MR_Integer) 2)));
              if (succeeded)
              {
                TypeB1_56 = ((MR_Word) ((MR_hl_field(3, TypeB_12, 1))));
                Var_81 = ((MR_Word) ((MR_hl_field(3, TypeB_12, 2))));
                succeeded = parse_tree__prog_data____Unify____kind_0_0(Kind_65, Var_81);
                if (succeeded)
                {
                  // direct tailcall eliminated
                  ;
                  next_value_of_TypeA_11 = TypeA1_55;
                  next_value_of_TypeB_12 = TypeB1_56;
                  TypeA_11 = next_value_of_TypeA_11;
  ...
  MR_Box wrapper_arg_1)
{
  ...
  succeeded = hlds__make_hlds__add_type__IntroducedFrom__pred__compute_subtype_ctors_diff__2045__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_String) (wrapper_arg_1)));
  return succeeded;
}
  ...
  MR_Box wrapper_arg_1)
{
  ...
  succeeded = hlds__make_hlds__add_type__IntroducedFrom__pred__compute_subtype_ctors_diff__2044__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_String) (wrapper_arg_1)));
  return succeeded;
}
