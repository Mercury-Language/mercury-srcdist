  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      else
      {
        ...
        if (succeeded)
        {
          TypeCtorInfo_37_62 = (MR_Word) (&hlds__hlds_cons__hlds__hlds_cons__type_ctor_info_hlds_ctor_field_defn_0);
          {
          ...
          succeeded = mercury__list__find_first_match_3_p_0(TypeCtorInfo_37_62, Var_55, ExistingDefns_50, &conv1__ConflictingDefn_51);
          if (succeeded)
            succeeded = MR_TRUE;
        }
        if (succeeded)
