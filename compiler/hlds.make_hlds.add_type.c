      ...
      case (MR_Integer) 1:
        {
          ...
          hlds__make_hlds__add_type__add_type_defn_ctors_15_p_0(ConsList_21, TypeCtor_9, TypeCtorModuleName_31, TVarSet_15, TypeParams_16, KindMap_17, NeedQual_20, PQInfo_26, Status_19, CtorFieldMap0_27, &CtorFieldMap_33, CtorMap0_25, &CtorMap_34, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), &CtorAddSpecs_35);
...
{
  {
    ...
    conv3_LambdaHeadVar__2_95 = hlds__make_hlds__add_type__IntroducedFrom__func__add_type_defn_ctor__1024__1_1_f_0(((MR_Word) wrapper_arg_1));
