...
hlds__make_hlds__add_type__IntroducedFrom__pred__compute_subtype_ctors_diff__2060__1_2_p_0(
  ...
  MR_Box wrapper_arg_1)
{
  ...
  succeeded = hlds__make_hlds__add_type__IntroducedFrom__pred__compute_subtype_ctors_diff__2060__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_String) (wrapper_arg_1)));
  return succeeded;
}
