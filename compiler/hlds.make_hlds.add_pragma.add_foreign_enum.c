  ...
  MR_Word * STATE_VARIABLE_NonEnumConsIds_5)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      {
        MR_Word next_value_of_HeadVar__1_1 = ConsIds_13;
        MR_Word next_value_of_STATE_VARIABLE_EnumSymNames_0_2 = STATE_VARIABLE_EnumSymNames_23_23;
        MR_Word next_value_of_STATE_VARIABLE_NonEnumConsIds_0_4 = STATE_VARIABLE_NonEnumConsIds_24_24;
