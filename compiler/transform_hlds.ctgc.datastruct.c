...
MR_decl_label5(fn__transform_hlds__ctgc__datastruct__datastruct_termshift_4_0, 19,4,5,6,7)
...
MR_BEGIN_MODULE(transform_hlds__ctgc__datastruct_module6)
	...
	MR_init_label5(fn__transform_hlds__ctgc__datastruct__datastruct_termshift_4_0,19,4,5,6,7)
MR_BEGIN_CODE
...
MR_define_entry(mercury__fn__transform_hlds__ctgc__datastruct__datastruct_termshift_4_0);
	...
	if (MR_LTAGS_TESTR(MR_r3,0,0)) {
		MR_GOTO_LAB(fn__transform_hlds__ctgc__datastruct__datastruct_termshift_4_0_i19);
	}
	MR_r1 = MR_r4;
	MR_proceed();
MR_def_label(fn__transform_hlds__ctgc__datastruct__datastruct_termshift_4_0,19)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(4);
