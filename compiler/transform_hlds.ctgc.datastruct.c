  ...
  MR_Word * Data_8)
{
  ...
  hlds__hlds_pred__proc_info_get_varset_vartypes_3_p_0(ProcInfo_6, &_VarSet_11, &VarTypes_12);
  parse_tree__vartypes__lookup_var_type_3_p_0(VarTypes_12, Var_9, &Type_13);
  transform_hlds__ctgc__selector__selector_apply_widening_4_p_0(ModuleInfo_5, Type_13, Sel0_10, &Sel_14);
  {
    MR_Word base;
    base = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
    *Data_8 = base;
    MR_hl_field(MR_mktag(0), base, 0) = ((MR_Box) (Var_9));
    MR_hl_field(MR_mktag(0), base, 1) = ((MR_Box) (Sel_14));
  }
}
  ...
  while (MR_TRUE)
  {
    ...
    if (succeeded)
    {
      ...
      Rest_9 = ((MR_Word) ((MR_hl_field(MR_mktag(1), HeadVar__4_4, (MR_Integer) 1))));
      {
        ...
        succeeded = transform_hlds__ctgc__datastruct__datastruct_subsumed_by_return_selector_5_p_0(ModuleInfo_5, ProcInfo_6, Data0_7, Data_8, &Var_10);
      }
      if (!(succeeded))
      {
  ...
  MR_Word * Extension_10)
{
  ...
  MR_Word Type_16;
  MR_Word Var_17;
  MR_Word Var_18 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Data2_9, (MR_Integer) 0))));
  MR_Word _VarSet_14;

  succeeded = mercury__builtin__unify_2_p_0((MR_Word) (&transform_hlds__ctgc__datastruct_scalar_common_1[0]), ((MR_Box) (Var_11)), ((MR_Box) (Var_18)));
  if (succeeded)
  {
    hlds__hlds_pred__proc_info_get_varset_vartypes_3_p_0(ProcInfo_7, &_VarSet_14, &VarTypes_15);
    parse_tree__vartypes__lookup_var_type_3_p_0(VarTypes_15, Var_11, &Type_16);
    Var_17 = (MR_Integer) 1;
    succeeded = transform_hlds__ctgc__selector__selector_subsumed_by_6_p_0(ModuleInfo_6, Var_17, Sel1_12, Sel2_13, Type_16, Extension_10);
  }
  return succeeded;
}
  ...
  MR_Word Data0_7)
{
  ...
  hlds__hlds_pred__proc_info_get_varset_vartypes_3_p_0(ProcInfo_6, &_VarSet_11, &VarTypes_12);
  parse_tree__vartypes__lookup_var_type_3_p_0(VarTypes_12, Var_9, &Type_13);
  transform_hlds__ctgc__selector__normalize_selector_with_type_information_4_p_0(ModuleInfo_5, Type_13, DSel0_10, &DSel_14);
  {
    Data_8 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(MR_mktag(0), Data_8, 0) = ((MR_Box) (Var_9));
    MR_hl_field(MR_mktag(0), Data_8, 1) = ((MR_Box) (DSel_14));
  }
  return Data_8;
}
  ...
  MR_Word Data0_9)
{
  ...
  else
  {
    ...
    hlds__hlds_pred__proc_info_get_varset_vartypes_3_p_0(ProcInfo_7, &_VarSet_16, &VarTypes_17);
    parse_tree__vartypes__lookup_var_type_3_p_0(VarTypes_17, Var_13, &Type_18);
    transform_hlds__ctgc__selector__normalize_selector_with_type_information_4_p_0(ModuleInfo_6, Type_18, NewSel0_15, &NewSel_19);
    {
      Data_10 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), Data_10, 0) = ((MR_Box) (Var_13));
      MR_hl_field(MR_mktag(0), Data_10, 1) = ((MR_Box) (NewSel_19));
    }
  }
  return Data_10;
}
