  ...
  MR_Word HeadVar__4_4)
{
  while (MR_TRUE)
  {
    ...
    if (succeeded)
    {
      ...
      {
        MR_Word Var_11 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Data0_7, (MR_Integer) 0))));
        MR_Word Sel1_12 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Data0_7, (MR_Integer) 1))));
        MR_Word Sel2_13 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Data_8, (MR_Integer) 1))));
        MR_Word Type_14;
        MR_Word Var_15;
        MR_Word Var_16 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Data_8, (MR_Integer) 0))));
        MR_Word Var_10;
...
{
  MR_bool succeeded;
  MR_Word Var_10 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Data1_7, (MR_Integer) 0))));
  MR_Word Sel1_11 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Data1_7, (MR_Integer) 1))));
  MR_Word Sel2_12 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Data2_8, (MR_Integer) 1))));
  MR_Word Type_13;
  MR_Word Var_14;
  MR_Word Var_15 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Data2_8, (MR_Integer) 0))));
  MR_Word Var_9;
