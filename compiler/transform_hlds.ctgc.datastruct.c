  ...
  MR_Box wrapper_arg_1)
{
  ...
  succeeded = transform_hlds__ctgc__datastruct__IntroducedFrom__pred__datastructs_project__193__1_2_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) (wrapper_arg_1)));
  return succeeded;
}
  ...
  MR_Word * Data_8)
{
  ...
  transform_hlds__ctgc__selector__selector_apply_widening_4_p_0(ModuleInfo_5, Type_11, Sel0_10, &Sel_12);
  {
    ...
    *Data_8 = base;
    ...
    MR_hl_field(MR_mktag(0), base, 1) = ((MR_Box) (Sel_12));
  }
}
  ...
  MR_Word Data2_9)
{
...

  {
    ...
    MR_hl_field(MR_mktag(0), Var_13, 4) = ((MR_Box) (VarTable_7));
  ...
  MR_Word * SubsumedData_10)
{
...

  {
    ...
    MR_hl_field(MR_mktag(0), Var_11, 4) = ((MR_Box) (VarTable_7));
  ...
  MR_Word HeadVar__4_4)
{
  while (MR_TRUE)
  {
    ...
    if (succeeded)
    {
      ...
      {
        MR_Word Var_20 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Data0_7, (MR_Integer) 0))));
        MR_Word Sel1_21 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Data0_7, (MR_Integer) 1))));
        MR_Word Sel2_22 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Data_8, (MR_Integer) 1))));
        MR_Word Type_23;
        MR_Word Var_24;
        MR_Word Var_25 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Data_8, (MR_Integer) 0))));
        MR_Word Var_14;

        succeeded = mercury__builtin__unify_2_p_0((MR_Word) (&transform_hlds__ctgc__datastruct_scalar_common_1[0]), ((MR_Box) (Var_20)), ((MR_Box) (Var_25)));
        if (succeeded)
        {
          parse_tree__var_table__lookup_var_type_3_p_0(VarTable_6, Var_20, &Type_23);
          Var_24 = (MR_Integer) 1;
          succeeded = transform_hlds__ctgc__selector__selector_subsumed_by_6_p_0(ModuleInfo_5, Var_24, Sel1_21, Sel2_22, Type_23, &Var_14);
        }
      }
      if (!(succeeded))
      {
...
{
  MR_bool succeeded;
  MR_Word Var_15 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Data1_7, (MR_Integer) 0))));
  MR_Word Sel1_16 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Data1_7, (MR_Integer) 1))));
  MR_Word Sel2_17 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Data2_8, (MR_Integer) 1))));
  MR_Word Type_18;
  MR_Word Var_19;
  MR_Word Var_20 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Data2_8, (MR_Integer) 0))));
  MR_Word Var_9;

  succeeded = mercury__builtin__unify_2_p_0((MR_Word) (&transform_hlds__ctgc__datastruct_scalar_common_1[0]), ((MR_Box) (Var_15)), ((MR_Box) (Var_20)));
  if (succeeded)
  {
    parse_tree__var_table__lookup_var_type_3_p_0(VarTable_6, Var_15, &Type_18);
    Var_19 = (MR_Integer) 1;
    succeeded = transform_hlds__ctgc__selector__selector_subsumed_by_6_p_0(ModuleInfo_5, Var_19, Sel1_16, Sel2_17, Type_18, &Var_9);
  }
  return succeeded;
}
  ...
  MR_Word * Extension_10)
{
  ...
  MR_Word Type_14;
  MR_Word Var_15;
  MR_Word Var_16 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Data2_9, (MR_Integer) 0))));
  ...
  MR_Word Data0_7)
{
  ...
  transform_hlds__ctgc__selector__normalize_selector_with_type_information_4_p_0(ModuleInfo_5, Type_11, DSel0_10, &DSel_12);
  {
    ...
    MR_hl_field(MR_mktag(0), Data_8, 1) = ((MR_Box) (DSel_12));
  }
  return Data_8;
}
  ...
  MR_Word Data0_9)
{
  ...
  else
  {
    ...
    transform_hlds__ctgc__selector__normalize_selector_with_type_information_4_p_0(ModuleInfo_6, Type_16, NewSel0_15, &NewSel_17);
    {
      ...
      MR_hl_field(MR_mktag(0), Data_10, 1) = ((MR_Box) (NewSel_17));
    }
  }
  return Data_10;
}
