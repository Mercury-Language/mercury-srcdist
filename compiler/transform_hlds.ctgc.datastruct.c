...
#line 27 "transform_hlds.ctgc.datastruct.c"
#line 136 "../library/io.int2"
#include "io.mh"

#line 31 "transform_hlds.ctgc.datastruct.c"
#line 144 "../library/io.int2"
#include "string.mh"

#line 35 "transform_hlds.ctgc.datastruct.c"
#line 33 "../mdbcomp/mdbcomp.rtti_access.int2"
#include "mdbcomp.rtti_access.mh"

#line 39 "transform_hlds.ctgc.datastruct.c"
#line 29 "../library/bitmap.int2"
#include "bitmap.mh"

#line 43 "transform_hlds.ctgc.datastruct.c"
#line 28 "../library/time.int2"
#include "time.mh"

#line 47 "transform_hlds.ctgc.datastruct.c"
#line 48 "transform_hlds.ctgc.datastruct.c"
#include "transform_hlds.ctgc.datastruct.mh"

#line 51 "transform_hlds.ctgc.datastruct.c"
...
#line 56 "transform_hlds.ctgc.datastruct.c"
#line 57 "transform_hlds.ctgc.datastruct.c"

#endif
#line 60 "transform_hlds.ctgc.datastruct.c"
...
MR_decl_label1(transform_hlds__ctgc__datastruct__datastruct_termshift_3_0, 2)
MR_decl_label1(transform_hlds__ctgc__datastruct__datastructs_subsumed_by_list_4_0, 2)
MR_decl_label1(transform_hlds__ctgc__datastruct__normalize_datastruct_with_type_information_4_0, 2)
MR_decl_label1(fn__transform_hlds__ctgc__datastruct__datastruct_init_with_pos_3_0, 2)
MR_decl_label1(fn__transform_hlds__ctgc__datastruct__datastruct_lists_least_upper_bound_4_0, 2)
MR_decl_label1(fn__transform_hlds__ctgc__datastruct__datastruct_termshift_2_0, 2)
MR_decl_label3(fn__transform_hlds__ctgc__datastruct__normalize_datastruct_3_0, 2,3,4)
MR_decl_label1(fn__transform_hlds__ctgc__datastruct__normalize_datastruct_with_type_information_3_0, 2)
...
MR_def_extern_entry(transform_hlds__ctgc__datastruct__datastruct_termshift_3_0)
MR_def_extern_entry(fn__transform_hlds__ctgc__datastruct__datastruct_termshift_2_0)
MR_def_extern_entry(transform_hlds__ctgc__datastruct__normalize_datastruct_with_type_information_4_0)
MR_def_extern_entry(fn__transform_hlds__ctgc__datastruct__normalize_datastruct_with_type_information_3_0)
...
MR_decl_static(transform_hlds__ctgc__datastruct__IntroducedFrom__pred__datastructs_project__180__1_2_0)
...
mercury_data__closure_layout__transform_hlds__ctgc__datastruct__datastructs_subsumed_by_list_4_0_1;
...
{
{
(MR_Word *) &mercury_data__closure_layout__transform_hlds__ctgc__datastruct__datastructs_subsumed_by_list_4_0_1,
...
MR_BEGIN_MODULE(transform_hlds__ctgc__datastruct_module5)
	MR_init_entry1(transform_hlds__ctgc__datastruct__datastruct_termshift_3_0);
	MR_init_label1(transform_hlds__ctgc__datastruct__datastruct_termshift_3_0,2)
MR_BEGIN_CODE
	...
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_define_entry(mercury__transform_hlds__ctgc__datastruct__datastruct_termshift_3_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(2);
	MR_sv(2) = (MR_Word) MR_succip;
	MR_sv(1) = MR_r2;
	...
	MR_np_call_localret_ent(transform_hlds__ctgc__selector__selector_termshift_3_0,
		transform_hlds__ctgc__datastruct__datastruct_termshift_3_0_i2);
MR_def_label(transform_hlds__ctgc__datastruct__datastruct_termshift_3_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 0, (MR_Integer) 2);
...
MR_BEGIN_MODULE(transform_hlds__ctgc__datastruct_module6)
	MR_init_entry1(fn__transform_hlds__ctgc__datastruct__datastruct_termshift_2_0);
	MR_init_label1(fn__transform_hlds__ctgc__datastruct__datastruct_termshift_2_0,2)
MR_BEGIN_CODE
	...
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_define_entry(mercury__fn__transform_hlds__ctgc__datastruct__datastruct_termshift_2_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(2);
	MR_sv(2) = (MR_Word) MR_succip;
	MR_sv(1) = MR_r2;
	...
	MR_r1 = MR_ctfield(0, MR_sv(1), 1);
	MR_np_call_localret_ent(transform_hlds__ctgc__selector__selector_termshift_3_0,
		fn__transform_hlds__ctgc__datastruct__datastruct_termshift_2_0_i2);
MR_def_label(fn__transform_hlds__ctgc__datastruct__datastruct_termshift_2_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 0, (MR_Integer) 2);
...
MR_BEGIN_MODULE(transform_hlds__ctgc__datastruct_module7)
	MR_init_entry1(transform_hlds__ctgc__datastruct__normalize_datastruct_with_type_information_4_0);
	MR_init_label1(transform_hlds__ctgc__datastruct__normalize_datastruct_with_type_information_4_0,2)
MR_BEGIN_CODE
	...
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_define_entry(mercury__transform_hlds__ctgc__datastruct__normalize_datastruct_with_type_information_4_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(2);
	MR_sv(2) = (MR_Word) MR_succip;
	MR_sv(1) = MR_r3;
	...
	MR_np_call_localret_ent(transform_hlds__ctgc__selector__normalize_selector_with_type_information_4_0,
		transform_hlds__ctgc__datastruct__normalize_datastruct_with_type_information_4_0_i2);
MR_def_label(transform_hlds__ctgc__datastruct__normalize_datastruct_with_type_information_4_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 0, (MR_Integer) 2);
...
MR_BEGIN_MODULE(transform_hlds__ctgc__datastruct_module8)
	MR_init_entry1(fn__transform_hlds__ctgc__datastruct__normalize_datastruct_with_type_information_3_0);
	MR_init_label1(fn__transform_hlds__ctgc__datastruct__normalize_datastruct_with_type_information_3_0,2)
MR_BEGIN_CODE
	...
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_define_entry(mercury__fn__transform_hlds__ctgc__datastruct__normalize_datastruct_with_type_information_3_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(2);
	MR_sv(2) = (MR_Word) MR_succip;
	MR_sv(1) = MR_r3;
	MR_r3 = MR_ctfield(0, MR_r3, 1);
	MR_np_call_localret_ent(transform_hlds__ctgc__selector__normalize_selector_with_type_information_4_0,
		fn__transform_hlds__ctgc__datastruct__normalize_datastruct_with_type_information_3_0_i2);
MR_def_label(fn__transform_hlds__ctgc__datastruct__normalize_datastruct_with_type_information_3_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 0, (MR_Integer) 2);
...
MR_def_label(transform_hlds__ctgc__datastruct__datastruct_subsumed_by_return_selector_5_0,5)
	...
	MR_decr_sp(8);
	MR_np_tailcall_ent(transform_hlds__ctgc__selector__subsumed_by_5_0);
...
MR_BEGIN_MODULE(transform_hlds__ctgc__datastruct_module13)
	...
	MR_init_label1(transform_hlds__ctgc__datastruct__datastructs_subsumed_by_list_4_0,2)
MR_BEGIN_CODE
...
MR_define_entry(mercury__transform_hlds__ctgc__datastruct__datastructs_subsumed_by_list_4_0);
	...
	MR_np_call_localret_ent(list__takewhile_4_0,
		transform_hlds__ctgc__datastruct__datastructs_subsumed_by_list_4_0_i2);
MR_def_label(transform_hlds__ctgc__datastruct__datastructs_subsumed_by_list_4_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_BEGIN_MODULE(transform_hlds__ctgc__datastruct_module14)
	...
	MR_init_label1(fn__transform_hlds__ctgc__datastruct__datastruct_lists_least_upper_bound_4_0,2)
MR_BEGIN_CODE
...
MR_define_entry(mercury__fn__transform_hlds__ctgc__datastruct__datastruct_lists_least_upper_bound_4_0);
	...
	MR_np_call_localret_ent(list__filter_4_0,
		fn__transform_hlds__ctgc__datastruct__datastruct_lists_least_upper_bound_4_0_i2);
MR_def_label(fn__transform_hlds__ctgc__datastruct__datastruct_lists_least_upper_bound_4_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(parse_tree__prog_data, datastruct);
	MR_r3 = MR_sv(1);
...
MR_define_entry(mercury__fn__transform_hlds__ctgc__datastruct__datastructs_project_2_0);
	...
	MR_tfield(0, MR_tempr1, 1) = (MR_Word) MR_ENTRY_AP(transform_hlds__ctgc__datastruct__IntroducedFrom__pred__datastructs_project__180__1_2_0);
...
MR_BEGIN_MODULE(transform_hlds__ctgc__datastruct_module18)
	MR_init_entry1(transform_hlds__ctgc__datastruct__IntroducedFrom__pred__datastructs_project__180__1_2_0);
MR_BEGIN_CODE
	...
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(transform_hlds__ctgc__datastruct__IntroducedFrom__pred__datastructs_project__180__1_2_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r4 = MR_r1;
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(parse_tree__prog_data, prog_var_type);
	{
...
void mercury__transform_hlds__ctgc__datastruct__write_out_proc_statics(FILE *deep_fp, FILE *procrep_fp)
{
	MR_write_out_module_proc_reps_start(procrep_fp, &mercury_data__module_common_layout__transform_hlds__ctgc__datastruct);
