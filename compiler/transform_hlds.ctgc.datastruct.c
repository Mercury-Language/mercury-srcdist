...
{
  {
    ...
    MR_Word Var_9 = ((MR_Word) (MR_hl_field(MR_mktag(0), LambdaHeadVar__1_6, (MR_Integer) 1)));
...
{
  {
    ...
    MR_Word Var_11 = ((MR_Word) (MR_hl_field(MR_mktag(0), LambdaHeadVar__1_8, (MR_Integer) 1)));
...
{
  {
    ...
    mercury__list__filter_4_p_0(TypeCtorInfo_15_15, Var_13, Data2_9, &_SubsumedData_11, &NotSubsumedData_12);
    Data_10 = mercury__list__append_2_f_0(TypeCtorInfo_15_15, NotSubsumedData_12, Data1_8);
    return Data_10;
  }
}
...
{
  {
    ...
    if ((Sel_8 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
      Data_10 = Data0_9;
    else
    {
      ...
      {
        Data_10 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
...
{
  {
    ...
    MR_Word Var_4 = ((MR_Word) (MR_hl_field(MR_mktag(0), Data_2, (MR_Integer) 0)));

    succeeded = (DSel_3 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
    return succeeded;
  }
}
...
{
  {
    ...
    MR_Word Var_6 = ((MR_Word) (MR_hl_field(MR_mktag(0), D1_3, (MR_Integer) 1)));
    MR_Word Var_7 = ((MR_Word) (MR_hl_field(MR_mktag(0), D2_4, (MR_Integer) 1)));
