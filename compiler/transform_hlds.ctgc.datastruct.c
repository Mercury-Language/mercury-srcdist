  ...
  MR_Word * Data_8)
{
  ...
  hlds__vartypes__lookup_var_type_3_p_0(VarTypes_12, Var_9, &Type_13);
  ...
  MR_Word * Extension_10)
{
  ...
  if (succeeded)
  {
    ...
    hlds__vartypes__lookup_var_type_3_p_0(VarTypes_15, Var_11, &Type_16);
    Var_17 = (MR_Integer) 1;
  ...
  MR_Word Data0_9)
{
  ...
  else
  {
    ...
    hlds__vartypes__lookup_var_type_3_p_0(VarTypes_17, Var_13, &Type_18);
