...
{
  {
    ...
    succeeded = mercury__set__remove_least_3_p_0((MR_Word) &parse_tree__parse_tree_out_inst_scalar_common_1[2], &conv0_Var_12, STATE_VARIABLE_Vars_0_13, &STATE_VARIABLE_Vars_16_16);
    if (succeeded)
    {
    ...
    if (succeeded)
    {
      ...
      void MR_CALL (* func_1)(MR_Box, MR_Box, MR_Box, MR_Box *) = ((void MR_CALL (*)(MR_Box, MR_Box, MR_Box, MR_Box *)) (MR_hl_field(MR_mktag(0), (MR_hl_field(MR_mktag(0), TypeClassInfo_for_output_30, (MR_Integer) 0)), (MR_Integer) 5)));
      void MR_CALL (* func_2)(MR_Box, MR_Box, MR_Box, MR_Box *);
      void MR_CALL (* func_3)(MR_Box, MR_Box, MR_Box, MR_Box *);

      func_1(((MR_Box) TypeClassInfo_for_output_30), ((MR_Box) ((MR_String) "(")), STATE_VARIABLE_U_0_14, &STATE_VARIABLE_U_18_18);
      ...
      func_2 = ((void MR_CALL (*)(MR_Box, MR_Box, MR_Box, MR_Box *)) (MR_hl_field(MR_mktag(0), (MR_hl_field(MR_mktag(0), TypeClassInfo_for_output_30, (MR_Integer) 0)), (MR_Integer) 5)));
      func_2(((MR_Box) TypeClassInfo_for_output_30), ((MR_Box) ((MR_String) " =< ")), STATE_VARIABLE_U_20_20, &STATE_VARIABLE_U_22_22);
      ...
      func_3 = ((void MR_CALL (*)(MR_Box, MR_Box, MR_Box, MR_Box *)) (MR_hl_field(MR_mktag(0), (MR_hl_field(MR_mktag(0), TypeClassInfo_for_output_30, (MR_Integer) 0)), (MR_Integer) 5)));
      func_3(((MR_Box) TypeClassInfo_for_output_30), ((MR_Box) ((MR_String) ")")), STATE_VARIABLE_U_23_23, STATE_VARIABLE_U_15);
    }
    else
      parse_tree__parse_tree_out_inst__mercury_format_inst_5_p_0(TypeClassInfo_for_output_30, Lang_7, InstVarSet_8, Inst_10, STATE_VARIABLE_U_0_14, STATE_VARIABLE_U_15);
  }
}
        ...
        case (MR_Integer) 3:
          {
            ...
            parse_tree__parse_tree_out_inst__mercury_format_constrained_inst_vars_6_p_0(TypeClassInfo_for_output_54, Lang_6, InstVarSet_7, Vars_17, CInst_18, STATE_VARIABLE_U_0_22, STATE_VARIABLE_U_23);
          }
          break;
        case (MR_Integer) 4:
          {
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      else
      {
        ...
        {
          MR_Word next_value_of_HeadVar__3_3 = BoundInsts_14;
          MR_Box next_value_of_STATE_VARIABLE_U_0_4 = STATE_VARIABLE_U_34_34;
    ...
    else
    {
      ...
      else
      {
        ...
        else
        {
          ...
          /* direct tailcall eliminated */
          {
            MR_Word next_value_of_HeadVar__3_3 = Insts_33;
            MR_Box next_value_of_STATE_VARIABLE_U_0_4 = STATE_VARIABLE_U_22_41;
    ...
    else
    {
      ...
      else
      {
        ...
        else
        {
          ...
          /* direct tailcall eliminated */
          {
            MR_Word next_value_of_HeadVar__3_3 = Modes_33;
            MR_Box next_value_of_STATE_VARIABLE_U_0_4 = STATE_VARIABLE_U_22_41;
    ...
    else
    {
      ...
      else
      {
        ...
        else
        {
          ...
          /* direct tailcall eliminated */
          {
            MR_Word next_value_of_HeadVar__1_1 = Regs_26;
            MR_Box next_value_of_STATE_VARIABLE_U_0_2 = STATE_VARIABLE_U_19_37;
