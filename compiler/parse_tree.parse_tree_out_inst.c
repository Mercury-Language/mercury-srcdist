          ...
          case (MR_Integer) 0:
            {
              ...
              parse_tree__parse_tree_out_inst__mercury_format_uniqueness_5_p_0(TypeClassInfo_for_output_56, Uniq_50, (MR_String) "bound", S_10, STATE_VARIABLE_U_0_24, &STATE_VARIABLE_U_38_38);
              ...
              func_0(((MR_Box) (TypeClassInfo_for_output_56)), ((MR_Box) ((MR_String) "(")), S_10, STATE_VARIABLE_U_38_38, &STATE_VARIABLE_U_40_40);
              parse_tree__parse_tree_out_inst__mercury_format_bound_insts_6_p_0(TypeClassInfo_for_output_56, Lang_7, InstVarSet_8, BoundInsts_17, S_10, STATE_VARIABLE_U_40_40, &STATE_VARIABLE_U_41_41);
              ...
              func_1(((MR_Box) (TypeClassInfo_for_output_56)), ((MR_Box) ((MR_String) ")")), S_10, STATE_VARIABLE_U_41_41, &STATE_VARIABLE_U_25);
            }
            break;
          case (MR_Integer) 1:
            {
          ...
          case (MR_Integer) 5:
            {
              ...
              parse_tree__parse_tree_out_inst__mercury_format_inst_name_6_p_0(TypeClassInfo_for_output_56, Lang_7, InstVarSet_8, Var_29, S_10, STATE_VARIABLE_U_0_24, &STATE_VARIABLE_U_25);
            }
            break;
        }
        break;
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      if ((Args_20 == (MR_Word) ((MR_Unsigned) 0U)))
        parse_tree__mercury_to_mercury__mercury_format_cons_id_6_p_0(TypeClassInfo_for_output_39, Lang_1, (MR_Integer) 0, ConsId_19, HeadVar__4_4, STATE_VARIABLE_U_0_5, &STATE_VARIABLE_U_35_35);
      else
      {
        ...
        parse_tree__mercury_to_mercury__mercury_format_cons_id_6_p_0(TypeClassInfo_for_output_39, Lang_1, (MR_Integer) 1, ConsId_19, HeadVar__4_4, STATE_VARIABLE_U_0_5, &STATE_VARIABLE_U_28_28);
        ...
        func_0(((MR_Box) (TypeClassInfo_for_output_39)), ((MR_Box) ((MR_String) "(")), HeadVar__4_4, STATE_VARIABLE_U_28_28, &STATE_VARIABLE_U_30_30);
        parse_tree__parse_tree_out_inst__mercury_format_inst_list_6_p_0(TypeClassInfo_for_output_39, Lang_1, InstVarSet_2, Args_20, HeadVar__4_4, STATE_VARIABLE_U_30_30, &STATE_VARIABLE_U_31_31);
        ...
        func_1(((MR_Box) (TypeClassInfo_for_output_39)), ((MR_Box) ((MR_String) ")")), HeadVar__4_4, STATE_VARIABLE_U_31_31, &STATE_VARIABLE_U_35_35);
      }
      ...
      else
      {
        ...
        func_2(((MR_Box) (TypeClassInfo_for_output_39)), ((MR_Box) ((MR_String) " ; ")), HeadVar__4_4, STATE_VARIABLE_U_35_35, &STATE_VARIABLE_U_37_37);
        // direct tailcall eliminated
        ;
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      else
      {
        ...
        parse_tree__parse_tree_out_inst__mercury_format_inst_6_p_0(TypeClassInfo_for_output_27, Lang_1, InstVarSet_2, Inst_35, HeadVar__4_4, STATE_VARIABLE_U_25_25, &STATE_VARIABLE_U_23_42);
        if ((Insts_36 == (MR_Word) ((MR_Unsigned) 0U)))
          *STATE_VARIABLE_U_6 = STATE_VARIABLE_U_23_42;
        else
        {
          ...
          func_1(((MR_Box) (TypeClassInfo_for_output_27)), ((MR_Box) ((MR_String) ", ")), HeadVar__4_4, STATE_VARIABLE_U_23_42, &STATE_VARIABLE_U_25_44);
          // direct tailcall eliminated
          ;
          next_value_of_HeadVar__3_3 = Insts_36;
          next_value_of_STATE_VARIABLE_U_0_5 = STATE_VARIABLE_U_25_44;
          HeadVar__3_3 = next_value_of_HeadVar__3_3;
          STATE_VARIABLE_U_0_5 = next_value_of_STATE_VARIABLE_U_0_5;
          continue;
        }
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      else
      {
        ...
        parse_tree__parse_tree_out_inst__mercury_format_mode_6_p_0(TypeClassInfo_for_output_27, Lang_1, InstVarSet_2, Mode_35, HeadVar__4_4, STATE_VARIABLE_U_25_25, &STATE_VARIABLE_U_23_42);
      ...
      case (MR_Integer) 0:
        {
          ...
          else
          {
            ...
            MR_Word Inst_211;
            MR_Word Insts_212;
            MR_Box STATE_VARIABLE_U_23_218;

            parse_tree__mercury_to_mercury__mercury_format_sym_name_4_p_0(TypeClassInfo_for_output_133, Name_12, S_10, STATE_VARIABLE_U_0_25, &STATE_VARIABLE_U_111_111);
            parse_tree__parse_tree_out_info__add_string_4_p_0(TypeClassInfo_for_output_133, (MR_String) "(", S_10, STATE_VARIABLE_U_111_111, &STATE_VARIABLE_U_113_113);
            Inst_211 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Args_13, (MR_Integer) 0))));
            Insts_212 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Args_13, (MR_Integer) 1))));
            parse_tree__parse_tree_out_inst__mercury_format_inst_6_p_0(TypeClassInfo_for_output_133, Lang_7, InstVarSet_8, Inst_211, S_10, STATE_VARIABLE_U_113_113, &STATE_VARIABLE_U_23_218);
            if ((Insts_212 == (MR_Word) ((MR_Unsigned) 0U)))
              STATE_VARIABLE_U_114_114 = STATE_VARIABLE_U_23_218;
            else
            {
              MR_Box STATE_VARIABLE_U_25_220;
              void MR_CALL (* func_2)(MR_Box, MR_Box, MR_Box, MR_Box, MR_Box *) = ((void MR_CALL (*)(MR_Box, MR_Box, MR_Box, MR_Box, MR_Box *)) ((MR_hl_field(MR_mktag(0), (MR_hl_field(MR_mktag(0), TypeClassInfo_for_output_133, (MR_Integer) 0)), (MR_Integer) 5))));

              func_2(((MR_Box) (TypeClassInfo_for_output_133)), ((MR_Box) ((MR_String) ", ")), S_10, STATE_VARIABLE_U_23_218, &STATE_VARIABLE_U_25_220);
              parse_tree__parse_tree_out_inst__mercury_format_inst_list_6_p_0(TypeClassInfo_for_output_133, Lang_7, InstVarSet_8, Insts_212, S_10, STATE_VARIABLE_U_25_220, &STATE_VARIABLE_U_114_114);
            }
            parse_tree__parse_tree_out_info__add_string_4_p_0(TypeClassInfo_for_output_133, (MR_String) ")", S_10, STATE_VARIABLE_U_114_114, STATE_VARIABLE_U_26);
          }
        }
        break;
      case (MR_Integer) 1:
            ...
            case (MR_Integer) 1:
              {
                ...
                MR_Word Insts_178;
                MR_Box STATE_VARIABLE_U_23_184;
                MR_Box STATE_VARIABLE_U_25_186;
                MR_Word Inst_194;
                void MR_CALL (* func_1)(MR_Box, MR_Box, MR_Box, MR_Box, MR_Box *);

                parse_tree__parse_tree_out_info__add_string_4_p_0(TypeClassInfo_for_output_133, (MR_String) "\044unify(", S_10, STATE_VARIABLE_U_0_25, &STATE_VARIABLE_U_100_100);
                parse_tree__parse_tree_out_inst__mercury_format_is_live_comma_4_p_0(TypeClassInfo_for_output_133, IsLive_16, S_10, STATE_VARIABLE_U_100_100, &STATE_VARIABLE_U_101_101);
                parse_tree__parse_tree_out_inst__mercury_format_comma_real_4_p_0(TypeClassInfo_for_output_133, Real_17, S_10, STATE_VARIABLE_U_101_101, &STATE_VARIABLE_U_102_102);
                {
                  Insts_178 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                  MR_hl_field(MR_mktag(1), Insts_178, 0) = ((MR_Box) (InstB_19));
                  MR_hl_field(MR_mktag(1), Insts_178, 1) = ((MR_Box) ((MR_Unsigned) 0U));
                }
                parse_tree__parse_tree_out_inst__mercury_format_inst_6_p_0(TypeClassInfo_for_output_133, Lang_7, InstVarSet_8, InstA_18, S_10, STATE_VARIABLE_U_102_102, &STATE_VARIABLE_U_23_184);
                ...
                func_1(((MR_Box) (TypeClassInfo_for_output_133)), ((MR_Box) ((MR_String) ", ")), S_10, STATE_VARIABLE_U_23_184, &STATE_VARIABLE_U_25_186);
                Inst_194 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Insts_178, (MR_Integer) 0))));
                parse_tree__parse_tree_out_inst__mercury_format_inst_6_p_0(TypeClassInfo_for_output_133, Lang_7, InstVarSet_8, Inst_194, S_10, STATE_VARIABLE_U_25_186, &STATE_VARIABLE_U_104_104);
                parse_tree__parse_tree_out_info__add_string_4_p_0(TypeClassInfo_for_output_133, (MR_String) ")", S_10, STATE_VARIABLE_U_104_104, STATE_VARIABLE_U_26);
              }
              break;
            case (MR_Integer) 0:
              {
            ...
            case (MR_Integer) 1:
              {
                ...
                MR_Word Insts_144;
                MR_Box STATE_VARIABLE_U_23_150;
                MR_Box STATE_VARIABLE_U_25_152;
                MR_Word Inst_160;
                void MR_CALL (* func_0)(MR_Box, MR_Box, MR_Box, MR_Box, MR_Box *);

                parse_tree__parse_tree_out_info__add_string_4_p_0(TypeClassInfo_for_output_133, (MR_String) "\044merge_inst(", S_10, STATE_VARIABLE_U_0_25, &STATE_VARIABLE_U_90_90);
                {
                ...
                parse_tree__parse_tree_out_inst__mercury_format_inst_6_p_0(TypeClassInfo_for_output_133, Lang_7, InstVarSet_8, InstA_118, S_10, STATE_VARIABLE_U_90_90, &STATE_VARIABLE_U_23_150);
                ...
                func_0(((MR_Box) (TypeClassInfo_for_output_133)), ((MR_Box) ((MR_String) ", ")), S_10, STATE_VARIABLE_U_23_150, &STATE_VARIABLE_U_25_152);
                Inst_160 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Insts_144, (MR_Integer) 0))));
                parse_tree__parse_tree_out_inst__mercury_format_inst_6_p_0(TypeClassInfo_for_output_133, Lang_7, InstVarSet_8, Inst_160, S_10, STATE_VARIABLE_U_25_152, &STATE_VARIABLE_U_92_92);
                parse_tree__parse_tree_out_info__add_string_4_p_0(TypeClassInfo_for_output_133, (MR_String) ")", S_10, STATE_VARIABLE_U_92_92, STATE_VARIABLE_U_26);
              }
              break;
            case (MR_Integer) 0:
              {
                ...
                case (MR_Integer) 1:
                  {
                    ...
                    parse_tree__parse_tree_out_info__add_string_4_p_0(TypeClassInfo_for_output_133, (MR_String) "\044ground(", S_10, STATE_VARIABLE_U_0_25, &STATE_VARIABLE_U_77_77);
                    parse_tree__parse_tree_out_inst__mercury_format_inst_name_6_p_0(TypeClassInfo_for_output_133, Lang_7, InstVarSet_8, SubInstName_20, S_10, STATE_VARIABLE_U_77_77, &STATE_VARIABLE_U_78_78);
                    parse_tree__parse_tree_out_info__add_string_4_p_0(TypeClassInfo_for_output_133, (MR_String) ", ", S_10, STATE_VARIABLE_U_78_78, &STATE_VARIABLE_U_80_80);
                    parse_tree__parse_tree_out_inst__mercury_format_is_live_comma_4_p_0(TypeClassInfo_for_output_133, IsLive_120, S_10, STATE_VARIABLE_U_80_80, &STATE_VARIABLE_U_81_81);
                    parse_tree__parse_tree_out_inst__mercury_format_uniqueness_5_p_0(TypeClassInfo_for_output_133, Uniq_21, (MR_String) "shared", S_10, STATE_VARIABLE_U_81_81, &STATE_VARIABLE_U_83_83);
                    parse_tree__parse_tree_out_inst__mercury_format_comma_real_4_p_0(TypeClassInfo_for_output_133, Real_121, S_10, STATE_VARIABLE_U_83_83, &STATE_VARIABLE_U_84_84);
                    parse_tree__parse_tree_out_info__add_string_4_p_0(TypeClassInfo_for_output_133, (MR_String) ")", S_10, STATE_VARIABLE_U_84_84, STATE_VARIABLE_U_26);
                  }
                  break;
                case (MR_Integer) 0:
                  {
                ...
                case (MR_Integer) 1:
                  {
                    ...
                    parse_tree__parse_tree_out_info__add_string_4_p_0(TypeClassInfo_for_output_133, (MR_String) "\044any(", S_10, STATE_VARIABLE_U_0_25, &STATE_VARIABLE_U_64_64);
                    parse_tree__parse_tree_out_inst__mercury_format_inst_name_6_p_0(TypeClassInfo_for_output_133, Lang_7, InstVarSet_8, SubInstName_124, S_10, STATE_VARIABLE_U_64_64, &STATE_VARIABLE_U_65_65);
                    parse_tree__parse_tree_out_info__add_string_4_p_0(TypeClassInfo_for_output_133, (MR_String) ", ", S_10, STATE_VARIABLE_U_65_65, &STATE_VARIABLE_U_67_67);
                    parse_tree__parse_tree_out_inst__mercury_format_is_live_comma_4_p_0(TypeClassInfo_for_output_133, IsLive_122, S_10, STATE_VARIABLE_U_67_67, &STATE_VARIABLE_U_68_68);
                    parse_tree__parse_tree_out_inst__mercury_format_uniqueness_5_p_0(TypeClassInfo_for_output_133, Uniq_125, (MR_String) "shared", S_10, STATE_VARIABLE_U_68_68, &STATE_VARIABLE_U_70_70);
                    parse_tree__parse_tree_out_inst__mercury_format_comma_real_4_p_0(TypeClassInfo_for_output_133, Real_123, S_10, STATE_VARIABLE_U_70_70, &STATE_VARIABLE_U_71_71);
                    parse_tree__parse_tree_out_info__add_string_4_p_0(TypeClassInfo_for_output_133, (MR_String) ")", S_10, STATE_VARIABLE_U_71_71, STATE_VARIABLE_U_26);
                  }
                  break;
                case (MR_Integer) 0:
                  {
                ...
                case (MR_Integer) 1:
                  {
                    ...
                    parse_tree__parse_tree_out_info__add_string_4_p_0(TypeClassInfo_for_output_133, (MR_String) "\044shared_inst(", S_10, STATE_VARIABLE_U_0_25, &STATE_VARIABLE_U_57_57);
                    parse_tree__parse_tree_out_inst__mercury_format_inst_name_6_p_0(TypeClassInfo_for_output_133, Lang_7, InstVarSet_8, SubInstName_126, S_10, STATE_VARIABLE_U_57_57, &STATE_VARIABLE_U_58_58);
                    parse_tree__parse_tree_out_info__add_string_4_p_0(TypeClassInfo_for_output_133, (MR_String) ")", S_10, STATE_VARIABLE_U_58_58, STATE_VARIABLE_U_26);
                  }
                  break;
                case (MR_Integer) 0:
                  {
                ...
                case (MR_Integer) 1:
                  {
                    ...
                    parse_tree__parse_tree_out_info__add_string_4_p_0(TypeClassInfo_for_output_133, (MR_String) "\044mostly_uniq_inst(", S_10, STATE_VARIABLE_U_0_25, &STATE_VARIABLE_U_50_50);
                    parse_tree__parse_tree_out_inst__mercury_format_inst_name_6_p_0(TypeClassInfo_for_output_133, Lang_7, InstVarSet_8, SubInstName_127, S_10, STATE_VARIABLE_U_50_50, &STATE_VARIABLE_U_51_51);
                ...
                case (MR_Integer) 1:
                  {
                    ...
                    parse_tree__parse_tree_out_info__add_string_4_p_0(TypeClassInfo_for_output_133, (MR_String) "\044typed_ground(", S_10, STATE_VARIABLE_U_0_25, &STATE_VARIABLE_U_38_38);
                    parse_tree__parse_tree_out_inst__mercury_format_uniqueness_5_p_0(TypeClassInfo_for_output_133, Uniqueness_22, (MR_String) "shared", S_10, STATE_VARIABLE_U_38_38, &STATE_VARIABLE_U_40_40);
                    parse_tree__parse_tree_out_info__add_string_4_p_0(TypeClassInfo_for_output_133, (MR_String) ", ", S_10, STATE_VARIABLE_U_40_40, &STATE_VARIABLE_U_42_42);
                    ...
                    parse_tree__mercury_to_mercury__mercury_format_type_6_p_0(TypeClassInfo_for_output_133, TypeVarSet_24, (MR_Integer) 0, Type_23, S_10, STATE_VARIABLE_U_42_42, &STATE_VARIABLE_U_44_44);
                    parse_tree__parse_tree_out_info__add_string_4_p_0(TypeClassInfo_for_output_133, (MR_String) ")", S_10, STATE_VARIABLE_U_44_44, STATE_VARIABLE_U_26);
                  }
                  break;
                case (MR_Integer) 0:
                  {
                ...
                case (MR_Integer) 1:
                  {
                    ...
                    parse_tree__parse_tree_out_info__add_string_4_p_0(TypeClassInfo_for_output_133, (MR_String) "\044typed_inst(", S_10, STATE_VARIABLE_U_0_25, &STATE_VARIABLE_U_28_28);
                    ...
                    parse_tree__mercury_to_mercury__mercury_format_type_6_p_0(TypeClassInfo_for_output_133, TypeVarSet_128, (MR_Integer) 0, Type_131, S_10, STATE_VARIABLE_U_28_28, &STATE_VARIABLE_U_30_30);
                    parse_tree__parse_tree_out_info__add_string_4_p_0(TypeClassInfo_for_output_133, (MR_String) ", ", S_10, STATE_VARIABLE_U_30_30, &STATE_VARIABLE_U_32_32);
                    parse_tree__parse_tree_out_inst__mercury_format_inst_name_6_p_0(TypeClassInfo_for_output_133, Lang_7, InstVarSet_8, SubInstName_130, S_10, STATE_VARIABLE_U_32_32, &STATE_VARIABLE_U_33_33);
                    parse_tree__parse_tree_out_info__add_string_4_p_0(TypeClassInfo_for_output_133, (MR_String) ")", S_10, STATE_VARIABLE_U_33_33, STATE_VARIABLE_U_26);
                  }
                  break;
                case (MR_Integer) 0:
                  {
  ...
  MR_Box * STATE_VARIABLE_U_26)
{
    ...
    case (MR_Integer) 1:
      {
        ...
        if ((Modes_15 == (MR_Word) ((MR_Unsigned) 0U)))
        {
          ...
          func_3(((MR_Box) (TypeClassInfo_for_output_64)), ((MR_Box) ((MR_String) "(any_func = ")), S_12, STATE_VARIABLE_U_32_32, &STATE_VARIABLE_U_39_39);
        }
        else
        {
          ...
          func_4(((MR_Box) (TypeClassInfo_for_output_64)), ((MR_Box) ((MR_String) "(any_func(")), S_12, STATE_VARIABLE_U_32_32, &STATE_VARIABLE_U_34_34);
          parse_tree__parse_tree_out_inst__mercury_format_mode_list_6_p_0(TypeClassInfo_for_output_64, Lang_8, InstVarSet_9, ArgModes_20, S_12, STATE_VARIABLE_U_34_34, &STATE_VARIABLE_U_35_35);
          ...
          func_5(((MR_Box) (TypeClassInfo_for_output_64)), ((MR_Box) ((MR_String) ") = ")), S_12, STATE_VARIABLE_U_35_35, &STATE_VARIABLE_U_39_39);
        }
        parse_tree__parse_tree_out_inst__mercury_format_mode_6_p_0(TypeClassInfo_for_output_64, Lang_8, InstVarSet_9, RetMode_21, S_12, STATE_VARIABLE_U_39_39, &STATE_VARIABLE_U_40_40);
        ...
        func_6(((MR_Box) (TypeClassInfo_for_output_64)), ((MR_Box) ((MR_String) " is ")), S_12, STATE_VARIABLE_U_40_40, &STATE_VARIABLE_U_42_42);
        ...
        func_7(((MR_Box) (TypeClassInfo_for_output_64)), ((MR_Box) ((MR_String) ")")), S_12, STATE_VARIABLE_U_43_43, &STATE_VARIABLE_U_58_58);
      }
      break;
    case (MR_Integer) 0:
      if ((Modes_15 == (MR_Word) ((MR_Unsigned) 0U)))
      {
        ...
        func_8(((MR_Box) (TypeClassInfo_for_output_64)), ((MR_Box) ((MR_String) "(any_pred is ")), S_12, STATE_VARIABLE_U_32_32, &STATE_VARIABLE_U_55_55);
        ...
        func_9(((MR_Box) (TypeClassInfo_for_output_64)), ((MR_Box) ((MR_String) ")")), S_12, STATE_VARIABLE_U_56_56, &STATE_VARIABLE_U_58_58);
      }
      else
      {
        ...
        func_10(((MR_Box) (TypeClassInfo_for_output_64)), ((MR_Box) ((MR_String) "(any_pred(")), S_12, STATE_VARIABLE_U_32_32, &STATE_VARIABLE_U_47_47);
        ...
        parse_tree__parse_tree_out_inst__mercury_format_mode_6_p_0(TypeClassInfo_for_output_64, Lang_8, InstVarSet_9, Mode_73, S_12, STATE_VARIABLE_U_47_47, &STATE_VARIABLE_U_23_80);
        if ((Modes_74 == (MR_Word) ((MR_Unsigned) 0U)))
          STATE_VARIABLE_U_48_48 = STATE_VARIABLE_U_23_80;
        else
        {
          ...
          func_11(((MR_Box) (TypeClassInfo_for_output_64)), ((MR_Box) ((MR_String) ", ")), S_12, STATE_VARIABLE_U_23_80, &STATE_VARIABLE_U_25_82);
          parse_tree__parse_tree_out_inst__mercury_format_mode_list_6_p_0(TypeClassInfo_for_output_64, Lang_8, InstVarSet_9, Modes_74, S_12, STATE_VARIABLE_U_25_82, &STATE_VARIABLE_U_48_48);
        }
        ...
        func_12(((MR_Box) (TypeClassInfo_for_output_64)), ((MR_Box) ((MR_String) ") is ")), S_12, STATE_VARIABLE_U_48_48, &STATE_VARIABLE_U_50_50);
        parse_tree__mercury_to_mercury__mercury_format_det_4_p_0(TypeClassInfo_for_output_64, Det_17, S_12, STATE_VARIABLE_U_50_50, &STATE_VARIABLE_U_51_51);
        ...
        func_13(((MR_Box) (TypeClassInfo_for_output_64)), ((MR_Box) ((MR_String) ")")), S_12, STATE_VARIABLE_U_51_51, &STATE_VARIABLE_U_58_58);
      }
      break;
  }
  ...
  else
  {
    ...
    func_14(((MR_Box) (TypeClassInfo_for_output_64)), ((MR_Box) ((MR_String) " /* arg regs: [")), S_12, STATE_VARIABLE_U_58_58, &STATE_VARIABLE_U_60_60);
  ...
  MR_Box * STATE_VARIABLE_U_26)
{
    ...
    case (MR_Integer) 1:
      {
        ...
        if ((ArgModes_20 == (MR_Word) ((MR_Unsigned) 0U)))
        {
          ...
          func_3(((MR_Box) (TypeClassInfo_for_output_64)), ((MR_Box) ((MR_String) "((func) = ")), S_12, STATE_VARIABLE_U_32_32, &STATE_VARIABLE_U_39_39);
        }
        else
        {
          MR_Box STATE_VARIABLE_U_34_34;
          ...
          func_4(((MR_Box) (TypeClassInfo_for_output_64)), ((MR_Box) ((MR_String) "(func(")), S_12, STATE_VARIABLE_U_32_32, &STATE_VARIABLE_U_34_34);
          ...
          parse_tree__parse_tree_out_inst__mercury_format_mode_6_p_0(TypeClassInfo_for_output_64, Lang_8, InstVarSet_9, Mode_73, S_12, STATE_VARIABLE_U_34_34, &STATE_VARIABLE_U_23_80);
          if ((Modes_74 == (MR_Word) ((MR_Unsigned) 0U)))
            STATE_VARIABLE_U_35_35 = STATE_VARIABLE_U_23_80;
          else
          {
            MR_Box STATE_VARIABLE_U_25_82;
            ...
            func_5(((MR_Box) (TypeClassInfo_for_output_64)), ((MR_Box) ((MR_String) ", ")), S_12, STATE_VARIABLE_U_23_80, &STATE_VARIABLE_U_25_82);
            parse_tree__parse_tree_out_inst__mercury_format_mode_list_6_p_0(TypeClassInfo_for_output_64, Lang_8, InstVarSet_9, Modes_74, S_12, STATE_VARIABLE_U_25_82, &STATE_VARIABLE_U_35_35);
          }
          func_6 = ((void MR_CALL (*)(MR_Box, MR_Box, MR_Box, MR_Box, MR_Box *)) ((MR_hl_field(MR_mktag(0), (MR_hl_field(MR_mktag(0), TypeClassInfo_for_output_64, (MR_Integer) 0)), (MR_Integer) 5))));
          func_6(((MR_Box) (TypeClassInfo_for_output_64)), ((MR_Box) ((MR_String) ") = ")), S_12, STATE_VARIABLE_U_35_35, &STATE_VARIABLE_U_39_39);
        }
        parse_tree__parse_tree_out_inst__mercury_format_mode_6_p_0(TypeClassInfo_for_output_64, Lang_8, InstVarSet_9, RetMode_21, S_12, STATE_VARIABLE_U_39_39, &STATE_VARIABLE_U_40_40);
        func_7 = ((void MR_CALL (*)(MR_Box, MR_Box, MR_Box, MR_Box, MR_Box *)) ((MR_hl_field(MR_mktag(0), (MR_hl_field(MR_mktag(0), TypeClassInfo_for_output_64, (MR_Integer) 0)), (MR_Integer) 5))));
        func_7(((MR_Box) (TypeClassInfo_for_output_64)), ((MR_Box) ((MR_String) " is ")), S_12, STATE_VARIABLE_U_40_40, &STATE_VARIABLE_U_42_42);
        parse_tree__mercury_to_mercury__mercury_format_det_4_p_0(TypeClassInfo_for_output_64, Det_17, S_12, STATE_VARIABLE_U_42_42, &STATE_VARIABLE_U_43_43);
        ...
        func_8(((MR_Box) (TypeClassInfo_for_output_64)), ((MR_Box) ((MR_String) ")")), S_12, STATE_VARIABLE_U_43_43, &STATE_VARIABLE_U_58_58);
      }
      break;
    case (MR_Integer) 0:
      if ((Modes_15 == (MR_Word) ((MR_Unsigned) 0U)))
      {
        ...
        func_9(((MR_Box) (TypeClassInfo_for_output_64)), ((MR_Box) ((MR_String) "((pred) is ")), S_12, STATE_VARIABLE_U_32_32, &STATE_VARIABLE_U_55_55);
        parse_tree__mercury_to_mercury__mercury_format_det_4_p_0(TypeClassInfo_for_output_64, Det_17, S_12, STATE_VARIABLE_U_55_55, &STATE_VARIABLE_U_56_56);
        ...
        func_10(((MR_Box) (TypeClassInfo_for_output_64)), ((MR_Box) ((MR_String) ")")), S_12, STATE_VARIABLE_U_56_56, &STATE_VARIABLE_U_58_58);
      }
      else
      {
        MR_Box STATE_VARIABLE_U_47_47;
        ...
        MR_Word Mode_90;
        MR_Word Modes_91;
        MR_Box STATE_VARIABLE_U_23_97;
        void MR_CALL (* func_11)(MR_Box, MR_Box, MR_Box, MR_Box, MR_Box *) = ((void MR_CALL (*)(MR_Box, MR_Box, MR_Box, MR_Box, MR_Box *)) ((MR_hl_field(MR_mktag(0), (MR_hl_field(MR_mktag(0), TypeClassInfo_for_output_64, (MR_Integer) 0)), (MR_Integer) 5))));
        void MR_CALL (* func_13)(MR_Box, MR_Box, MR_Box, MR_Box, MR_Box *);
        void MR_CALL (* func_14)(MR_Box, MR_Box, MR_Box, MR_Box, MR_Box *);

        func_11(((MR_Box) (TypeClassInfo_for_output_64)), ((MR_Box) ((MR_String) "(pred(")), S_12, STATE_VARIABLE_U_32_32, &STATE_VARIABLE_U_47_47);
        Mode_90 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Modes_15, (MR_Integer) 0))));
        Modes_91 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Modes_15, (MR_Integer) 1))));
        parse_tree__parse_tree_out_inst__mercury_format_mode_6_p_0(TypeClassInfo_for_output_64, Lang_8, InstVarSet_9, Mode_90, S_12, STATE_VARIABLE_U_47_47, &STATE_VARIABLE_U_23_97);
        if ((Modes_91 == (MR_Word) ((MR_Unsigned) 0U)))
          STATE_VARIABLE_U_48_48 = STATE_VARIABLE_U_23_97;
        else
        {
          MR_Box STATE_VARIABLE_U_25_99;
          ...
          func_12(((MR_Box) (TypeClassInfo_for_output_64)), ((MR_Box) ((MR_String) ", ")), S_12, STATE_VARIABLE_U_23_97, &STATE_VARIABLE_U_25_99);
          parse_tree__parse_tree_out_inst__mercury_format_mode_list_6_p_0(TypeClassInfo_for_output_64, Lang_8, InstVarSet_9, Modes_91, S_12, STATE_VARIABLE_U_25_99, &STATE_VARIABLE_U_48_48);
        }
        func_13 = ((void MR_CALL (*)(MR_Box, MR_Box, MR_Box, MR_Box, MR_Box *)) ((MR_hl_field(MR_mktag(0), (MR_hl_field(MR_mktag(0), TypeClassInfo_for_output_64, (MR_Integer) 0)), (MR_Integer) 5))));
        func_13(((MR_Box) (TypeClassInfo_for_output_64)), ((MR_Box) ((MR_String) ") is ")), S_12, STATE_VARIABLE_U_48_48, &STATE_VARIABLE_U_50_50);
        parse_tree__mercury_to_mercury__mercury_format_det_4_p_0(TypeClassInfo_for_output_64, Det_17, S_12, STATE_VARIABLE_U_50_50, &STATE_VARIABLE_U_51_51);
        ...
        func_14(((MR_Box) (TypeClassInfo_for_output_64)), ((MR_Box) ((MR_String) ")")), S_12, STATE_VARIABLE_U_51_51, &STATE_VARIABLE_U_58_58);
      }
      break;
  }
  if ((MaybeArgRegs_16 == (MR_Word) ((MR_Unsigned) 0U)))
  ...
  else
  {
    ...
    func_15(((MR_Box) (TypeClassInfo_for_output_64)), ((MR_Box) ((MR_String) " /* arg regs: [")), S_12, STATE_VARIABLE_U_58_58, &STATE_VARIABLE_U_60_60);
    parse_tree__parse_tree_out_inst__mercury_format_arg_reg_list_4_p_0(TypeClassInfo_for_output_64, ArgRegs_24, S_12, STATE_VARIABLE_U_60_60, &STATE_VARIABLE_U_61_61);
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
        ...
        case (MR_Integer) 1:
          {
            ...
            func_0(((MR_Box) (TypeClassInfo_for_output_24)), ((MR_Box) ((MR_String) "reg_f")), HeadVar__2_2, STATE_VARIABLE_U_0_3, &STATE_VARIABLE_U_20_20);
          }
          break;
        case (MR_Integer) 0:
          {
            ...
            func_1(((MR_Box) (TypeClassInfo_for_output_24)), ((MR_Box) ((MR_String) "reg_r")), HeadVar__2_2, STATE_VARIABLE_U_0_3, &STATE_VARIABLE_U_20_20);
          }
          break;
      }
      ...
      else
      {
        ...
        func_2(((MR_Box) (TypeClassInfo_for_output_24)), ((MR_Box) ((MR_String) ", ")), HeadVar__2_2, STATE_VARIABLE_U_20_20, &STATE_VARIABLE_U_22_22);
          ...
          case (MR_Integer) 1:
            {
              ...
              func_3(((MR_Box) (TypeClassInfo_for_output_24)), ((MR_Box) ((MR_String) "reg_f")), HeadVar__2_2, STATE_VARIABLE_U_22_22, &STATE_VARIABLE_U_20_37);
            }
            break;
          case (MR_Integer) 0:
            {
              ...
              func_4(((MR_Box) (TypeClassInfo_for_output_24)), ((MR_Box) ((MR_String) "reg_r")), HeadVar__2_2, STATE_VARIABLE_U_22_22, &STATE_VARIABLE_U_20_37);
            }
            break;
        }
        if ((Regs_29 == (MR_Word) ((MR_Unsigned) 0U)))
          *STATE_VARIABLE_U_4 = STATE_VARIABLE_U_20_37;
        else
        {
          MR_Box STATE_VARIABLE_U_22_39;
          ...
          func_5(((MR_Box) (TypeClassInfo_for_output_24)), ((MR_Box) ((MR_String) ", ")), HeadVar__2_2, STATE_VARIABLE_U_20_37, &STATE_VARIABLE_U_22_39);
          // direct tailcall eliminated
          ;
          next_value_of_HeadVar__1_1 = Regs_29;
          next_value_of_STATE_VARIABLE_U_0_3 = STATE_VARIABLE_U_22_39;
