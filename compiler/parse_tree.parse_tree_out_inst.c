            ...
            case (MR_Integer) 1:
              {
                ...
                MR_Unsigned packed_args_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Inst_8, (MR_Integer) 1)));
...
{
  {
    ...
    if (((MR_tag((MR_Word) Mode_8)) == (MR_Integer) 0))
    {
      ...
      succeeded = ((((MR_tag((MR_Word) InstA_10)) == (MR_Integer) 3)) && ((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), InstA_10, (MR_Integer) 0))) == (MR_Integer) 1)));
      if (succeeded)
      {
        packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), InstA_10, (MR_Integer) 1)));
    ...
    else
    {
      ...
      if ((Args_18 == (MR_Word) ((MR_Unsigned) 0U)))
      ...
      else
      {
        ...
        if ((Insts_51 == (MR_Word) ((MR_Unsigned) 0U)))
  ...
  MR_Box * STATE_VARIABLE_U_24)
{
  while (MR_TRUE)
  {
    ...
    switch (MR_tag((MR_Word) InstName_8)) {
      ...
      case (MR_Integer) 1:
        {
          MR_Word IsLive_14 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(1), InstName_8, (MR_Integer) 0))) >> (MR_Integer) 1)) & (MR_Integer) 1);
          ...
          MR_Unsigned packed_args_3 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), InstName_8, (MR_Integer) 0)));
            ...
            case (MR_Integer) 1:
              {
                ...
                {
                  Insts_178 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
            ...
            case (MR_Integer) 1:
              {
                ...
                {
                  Insts_142 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      ...
      case (MR_Integer) 3:
        switch (((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), InstName_8, (MR_Integer) 0)))) {
          ...
          case (MR_Integer) 0:
            {
              ...
              MR_Word Uniq_19 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(3), InstName_8, (MR_Integer) 2))) >> (MR_Integer) 2)) & (MR_Integer) 7);
              MR_Word IsLive_118 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(3), InstName_8, (MR_Integer) 2))) >> (MR_Integer) 1)) & (MR_Integer) 1);
              MR_Word Real_119 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(3), InstName_8, (MR_Integer) 2))) & (MR_Integer) 1);
              MR_Unsigned packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), InstName_8, (MR_Integer) 2)));
          ...
          case (MR_Integer) 1:
            {
              MR_Word IsLive_120 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(3), InstName_8, (MR_Integer) 2))) >> (MR_Integer) 1)) & (MR_Integer) 1);
              ...
              MR_Word Uniq_123 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(3), InstName_8, (MR_Integer) 2))) >> (MR_Integer) 2)) & (MR_Integer) 7);
              MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), InstName_8, (MR_Integer) 2)));
          ...
          case (MR_Integer) 4:
            {
              ...
              MR_Unsigned packed_args_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), InstName_8, (MR_Integer) 1)));
...
{
  {
    ...
    MR_Box STATE_VARIABLE_U_30_30;
    MR_Box STATE_VARIABLE_U_56_56;
    MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), PredInstInfo_10, (MR_Integer) 0)));
    MR_Unsigned packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), PredInstInfo_10, (MR_Integer) 3)));
