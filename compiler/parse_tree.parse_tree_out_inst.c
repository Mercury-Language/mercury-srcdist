  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      if ((Args_20 == (MR_Word) ((MR_Unsigned) 0U)))
        parse_tree__mercury_to_mercury__mercury_format_cons_id_5_p_0(TypeClassInfo_for_output_39, (MR_Integer) 0, ConsId_19, HeadVar__4_4, STATE_VARIABLE_U_0_5, &STATE_VARIABLE_U_35_35);
      else
      {
        ...
        parse_tree__mercury_to_mercury__mercury_format_cons_id_5_p_0(TypeClassInfo_for_output_39, (MR_Integer) 1, ConsId_19, HeadVar__4_4, STATE_VARIABLE_U_0_5, &STATE_VARIABLE_U_28_28);
