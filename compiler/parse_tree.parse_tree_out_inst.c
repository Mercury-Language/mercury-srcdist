    ...
    switch (MR_tag((MR_Word) InstName_8)) {
      ...
      case (MR_Integer) 3:
        switch (((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), InstName_8, (MR_Integer) 0)))) {
          ...
          case (MR_Integer) 0:
            {
              ...
              MR_Word IsLive_118 = ((((((MR_Word) (MR_hl_field(MR_mktag(3), InstName_8, (MR_Integer) 2)))) >> (MR_Integer) 3)) & (MR_Integer) 1);
              MR_Word Real_119 = ((((((MR_Word) (MR_hl_field(MR_mktag(3), InstName_8, (MR_Integer) 2)))) >> (MR_Integer) 4)) & (MR_Integer) 1);
          ...
          case (MR_Integer) 1:
            {
              MR_Word IsLive_120 = ((((((MR_Word) (MR_hl_field(MR_mktag(3), InstName_8, (MR_Integer) 2)))) >> (MR_Integer) 3)) & (MR_Integer) 1);
              MR_Word Real_121 = ((((((MR_Word) (MR_hl_field(MR_mktag(3), InstName_8, (MR_Integer) 2)))) >> (MR_Integer) 4)) & (MR_Integer) 1);
              MR_Word SubInstName_122 = ((MR_Word) (MR_hl_field(MR_mktag(3), InstName_8, (MR_Integer) 1)));
              MR_Word Uniq_123 = ((((MR_Word) (MR_hl_field(MR_mktag(3), InstName_8, (MR_Integer) 2)))) & (MR_Integer) 7);
