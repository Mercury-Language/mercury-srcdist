            ...
            case (MR_Integer) 1:
              {
                ...
                MR_Unsigned packed_word_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Inst_8, (MR_Integer) 1)));
...
{
  {
    ...
    if (((MR_tag((MR_Word) Mode_8)) == (MR_Integer) 0))
    {
      ...
      if (succeeded)
      {
        packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), InstA_10, (MR_Integer) 1)));
      ...
      case (MR_Integer) 1:
        {
          ...
          MR_Unsigned packed_word_3 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), InstName_8, (MR_Integer) 0)));
          ...
          case (MR_Integer) 0:
            {
              ...
              MR_Unsigned packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), InstName_8, (MR_Integer) 2)));
          ...
          case (MR_Integer) 1:
            {
              ...
              MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), InstName_8, (MR_Integer) 2)));
          ...
          case (MR_Integer) 4:
            {
              ...
              MR_Unsigned packed_word_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), InstName_8, (MR_Integer) 1)));
...
{
  {
    ...
    MR_Box STATE_VARIABLE_U_30_30;
    MR_Box STATE_VARIABLE_U_56_56;
    MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), PredInstInfo_10, (MR_Integer) 0)));
    MR_Unsigned packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), PredInstInfo_10, (MR_Integer) 3)));
