        ...
        case (MR_Integer) 2:
          {
            ...
            if ((HOInstInfo_11 == (MR_Word) ((MR_Integer) 0)))
            ...
            case (MR_Integer) 1:
              {
                ...
                if ((HOInstInfo_52 == (MR_Word) ((MR_Integer) 0)))
                {
...
{
  {
    ...
    else
    {
      ...
      else
      {
        ...
        if ((Insts_51 == (MR_Word) ((MR_Integer) 0)))
  ...
  MR_Box * STATE_VARIABLE_U_5)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      if ((Insts_14 == (MR_Word) ((MR_Integer) 0)))
      ...
      else
      {
        ...
        if ((Insts_33 == (MR_Word) ((MR_Integer) 0)))
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      else
      {
        ...
        if ((Modes_33 == (MR_Word) ((MR_Integer) 0)))
          *STATE_VARIABLE_U_5 = STATE_VARIABLE_U_20_39;
        else
        {
          MR_Box STATE_VARIABLE_U_22_41;
    ...
    switch (MR_tag((MR_Word) InstName_8)) {
            ...
            case (MR_Integer) 1:
              {
                ...
                parse_tree__parse_tree_out_inst__mercury_format_comma_real_3_p_0(TypeClassInfo_for_output_131, Real_15, STATE_VARIABLE_U_99_99, &STATE_VARIABLE_U_100_100);
                {
                  ...
                  MR_hl_field(MR_mktag(1), Insts_178, 1) = ((MR_Box) ((MR_Integer) 0));
                }
            ...
            case (MR_Integer) 1:
              {
                ...
                parse_tree__parse_tree_out_info__add_string_3_p_0(TypeClassInfo_for_output_131, (MR_String) "\044merge_inst(", STATE_VARIABLE_U_0_23, &STATE_VARIABLE_U_88_88);
                {
                  ...
                  MR_hl_field(MR_mktag(1), Insts_142, 1) = ((MR_Box) ((MR_Integer) 0));
                }
      ...
      case (MR_Integer) 3:
        switch (((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), InstName_8, (MR_Integer) 0)))) {
          ...
          case (MR_Integer) 0:
            {
              ...
              MR_Word Uniq_19 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(3), InstName_8, (MR_Integer) 2))) & (MR_Integer) 7);
              MR_Word IsLive_118 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(3), InstName_8, (MR_Integer) 2))) >> (MR_Integer) 3)) & (MR_Integer) 1);
              MR_Word Real_119 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(3), InstName_8, (MR_Integer) 2))) >> (MR_Integer) 4)) & (MR_Integer) 1);
          ...
          case (MR_Integer) 1:
            {
              MR_Word IsLive_120 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(3), InstName_8, (MR_Integer) 2))) >> (MR_Integer) 3)) & (MR_Integer) 1);
              MR_Word Real_121 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(3), InstName_8, (MR_Integer) 2))) >> (MR_Integer) 4)) & (MR_Integer) 1);
              MR_Word SubInstName_122 = ((MR_Word) ((MR_hl_field(MR_mktag(3), InstName_8, (MR_Integer) 1))));
              MR_Word Uniq_123 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(3), InstName_8, (MR_Integer) 2))) & (MR_Integer) 7);
...
{
  {
    ...
    switch (PredOrFunc_12) {
      ...
      case (MR_Integer) 0:
        ...
        else
        {
          ...
          if ((Modes_72 == (MR_Word) ((MR_Integer) 0)))
    ...
    if ((MaybeArgRegs_14 == (MR_Word) ((MR_Integer) 0)))
    ...
    switch (PredOrFunc_12) {
      ...
      case (MR_Integer) 1:
        {
          ...
          parse_tree__prog_util__pred_args_to_func_args_3_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_mode_0), Modes_13, &ArgModes_18, &conv2_RetMode_19);
          RetMode_19 = ((MR_Word) (conv2_RetMode_19));
          if ((ArgModes_18 == (MR_Word) ((MR_Integer) 0)))
          {
            void MR_CALL (* func_3)(MR_Box, MR_Box, MR_Box, MR_Box *) = ((void MR_CALL (*)(MR_Box, MR_Box, MR_Box, MR_Box *)) ((MR_hl_field(MR_mktag(0), (MR_hl_field(MR_mktag(0), TypeClassInfo_for_output_62, (MR_Integer) 0)), (MR_Integer) 5))));
      ...
      case (MR_Integer) 0:
        ...
        else
        {
          ...
          if ((Modes_90 == (MR_Word) ((MR_Integer) 0)))
  ...
  MR_Box * STATE_VARIABLE_U_3)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      if ((Regs_8 == (MR_Word) ((MR_Integer) 0)))
      ...
      else
      {
        ...
        if ((Regs_26 == (MR_Word) ((MR_Integer) 0)))
