        ...
        case (MR_Integer) 1:
          {
            ...
            else
            {
              ...
              MR_Word STATE_VARIABLE_Expansions_70_372;
              MR_Word Var_373;
              MR_Word Var_374;
              MR_Word Var_376;
              MR_Word Var_379;
              ...
              hlds__error_msg_inst__record_internal_inst_name_5_p_0(InstName_9, (MR_String) "\044unify_inst", &InstNumPieces_371, STATE_VARIABLE_Expansions_0_45, &STATE_VARIABLE_Expansions_70_372);
              hlds__error_msg_inst__inst_to_inline_pieces_6_p_0(Info_7, STATE_VARIABLE_Expansions_70_372, &STATE_VARIABLE_Expansions_46, EqvInst_426, Suffix_10, &EqvPieces_386);
              {
        ...
        case (MR_Integer) 2:
          {
            ...
            else
            {
              ...
              MR_Word STATE_VARIABLE_Expansions_70_180;
              MR_Word Var_181;
              MR_Word Var_182;
              MR_Word Var_184;
              MR_Word Var_187;
              ...
              hlds__error_msg_inst__record_internal_inst_name_5_p_0(InstName_9, (MR_String) "\044merge_inst", &InstNumPieces_179, STATE_VARIABLE_Expansions_0_45, &STATE_VARIABLE_Expansions_70_180);
              hlds__error_msg_inst__inst_to_inline_pieces_6_p_0(Info_7, STATE_VARIABLE_Expansions_70_180, &STATE_VARIABLE_Expansions_46, EqvInst_234, Suffix_10, &EqvPieces_194);
              {
            ...
            case (MR_Integer) 0:
              {
                ...
                else
                {
                  ...
                  MR_Word STATE_VARIABLE_Expansions_70_116;
                  MR_Word Var_117;
                  MR_Word Var_118;
                  MR_Word Var_120;
                  MR_Word Var_123;
                  ...
                  hlds__error_msg_inst__record_internal_inst_name_5_p_0(InstName_9, (MR_String) "\044ground_inst", &InstNumPieces_115, STATE_VARIABLE_Expansions_0_45, &STATE_VARIABLE_Expansions_70_116);
                  hlds__error_msg_inst__inst_to_inline_pieces_6_p_0(Info_7, STATE_VARIABLE_Expansions_70_116, &STATE_VARIABLE_Expansions_46, EqvInst_170, Suffix_10, &EqvPieces_130);
                  {
            ...
            case (MR_Integer) 2:
              {
                ...
                else
                {
                  ...
                  MR_Word STATE_VARIABLE_Expansions_70_308;
                  MR_Word Var_309;
                  MR_Word Var_310;
                  MR_Word Var_312;
                  MR_Word Var_315;
                  ...
                  hlds__error_msg_inst__record_internal_inst_name_5_p_0(InstName_9, (MR_String) "\044shared_inst", &InstNumPieces_307, STATE_VARIABLE_Expansions_0_45, &STATE_VARIABLE_Expansions_70_308);
                  hlds__error_msg_inst__inst_to_inline_pieces_6_p_0(Info_7, STATE_VARIABLE_Expansions_70_308, &STATE_VARIABLE_Expansions_46, EqvInst_362, Suffix_10, &EqvPieces_322);
                  {
            ...
            case (MR_Integer) 3:
              {
                ...
                else
                {
                  ...
                  MR_Word STATE_VARIABLE_Expansions_70_244;
                  MR_Word Var_245;
                  MR_Word Var_246;
                  MR_Word Var_248;
                  MR_Word Var_251;
                  ...
                  hlds__error_msg_inst__record_internal_inst_name_5_p_0(InstName_9, (MR_String) "\044mostly_uniq_inst", &InstNumPieces_243, STATE_VARIABLE_Expansions_0_45, &STATE_VARIABLE_Expansions_70_244);
                  hlds__error_msg_inst__inst_to_inline_pieces_6_p_0(Info_7, STATE_VARIABLE_Expansions_70_244, &STATE_VARIABLE_Expansions_46, EqvInst_298, Suffix_10, &EqvPieces_258);
                  {
  ...
  else
  {
    ...
    if (((MR_tag((MR_Word) Mode1_26)) == (MR_Integer) 0))
    {
      ...
      if (((MR_tag((MR_Word) Mode_29)) == (MR_Integer) 0))
      {
        ...
        MR_Word ToPieces_33;
        MR_Word STATE_VARIABLE_Expansions_22_36;
        MR_Word Var_40;

        hlds__error_msg_inst__inst_to_pieces_6_p_0(HeadVar__1_1, STATE_VARIABLE_Expansions_0_2, &STATE_VARIABLE_Expansions_22_36, FromInst_30, (MR_Word) ((MR_Unsigned) 0U), &FromPieces_32);
        hlds__error_msg_inst__inst_to_pieces_6_p_0(HeadVar__1_1, STATE_VARIABLE_Expansions_22_36, &STATE_VARIABLE_Expansions_18_18, ToInst_31, (MR_Word) ((MR_Unsigned) 0U), &ToPieces_33);
        {
          Var_40 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), Var_40, 0) = ((MR_Box) (MR_mkword(MR_mktag(2), &hlds__error_msg_inst_scalar_common_3[17])));
          MR_hl_field(MR_mktag(1), Var_40, 1) = ((MR_Box) (ToPieces_33));
        }
        HeadPieces_14 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_format_component_0), FromPieces_32, Var_40);
      }
      else
      {
  ...
  MR_Word * Pieces_13)
{
  ...
  if ((ArgInsts_19 == (MR_Word) ((MR_Unsigned) 0U)))
  {
...

    {
      ...
      MR_hl_field(MR_mktag(2), Var_54, 0) = ((MR_Box) (ConsIdStr_26));
    }
    {
      MR_Word base;
      base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      Var_63 = mercury__string__f_43_43_2_f_0(ArgSummary_53, (MR_String) ")");
    ...
    else
    {
      ...
      }
      {
        Var_65 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), Var_65, 0) = ((MR_Box) (Var_66));
        MR_hl_field(MR_mktag(1), Var_65, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &hlds__error_msg_inst_scalar_common_1[21])));
      }
      {
        Var_78 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      ...
      {
        Var_75 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), Var_75, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__error_msg_inst_scalar_common_1[5])));
        MR_hl_field(MR_mktag(1), Var_75, 1) = ((MR_Box) (Var_78));
      }
      Var_74 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_format_component_0), ArgPieces_52, Var_75);
  ...
  else
  {
    ...
    if (((MR_tag((MR_Word) Mode1_26)) == (MR_Integer) 0))
    {
      ...
      if (((MR_tag((MR_Word) Mode_29)) == (MR_Integer) 0))
      {
        ...
        hlds__error_msg_inst__inst_to_inline_pieces_6_p_0(HeadVar__1_1, STATE_VARIABLE_Expansions_0_2, &STATE_VARIABLE_Expansions_22_36, FromInst_30, (MR_Word) ((MR_Unsigned) 0U), &FromPieces_32);
        hlds__error_msg_inst__inst_to_inline_pieces_6_p_0(HeadVar__1_1, STATE_VARIABLE_Expansions_22_36, &STATE_VARIABLE_Expansions_18_18, ToInst_31, (MR_Word) ((MR_Unsigned) 0U), &ToPieces_33);
        {
          Var_40 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), Var_40, 0) = ((MR_Box) (MR_mkword(MR_mktag(2), &hlds__error_msg_inst_scalar_common_3[17])));
          MR_hl_field(MR_mktag(1), Var_40, 1) = ((MR_Box) (ToPieces_33));
  ...
  MR_Word * Pieces_13)
{
  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      Var_56 = mercury__string__f_43_43_2_f_0(ArgSummary_47, (MR_String) ")");
    ...
    else
    {
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(1), Var_58, 1) = ((MR_Box) (ArgPieces_46));
      }
      {
        Var_62 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), Var_62, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__error_msg_inst_scalar_common_1[6])));
