  ...
  MR_Word * STATE_VARIABLE_Expansions_30)
{
  ...
  succeeded = ((((MR_tag((MR_Word) ConsId0_20)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(3, ConsId0_20, (MR_Integer) 0)))) == (MR_Integer) 3)));
  if (succeeded)
  {
  ...
  if (succeeded)
  {
    ...
    }
    {
      ...
      MR_hl_field(3, ConsId_27, 0) = ((MR_Box) ((MR_Unsigned) 3U));
