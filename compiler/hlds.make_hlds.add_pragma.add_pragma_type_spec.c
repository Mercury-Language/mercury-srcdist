...
static /* final */ const MR_Box hlds__make_hlds__add_pragma__add_pragma_type_spec_scalar_common_4[1][11];
  ...
  MR_Word * STATE_VARIABLE_Specs_49)
{
  ...
  hlds__hlds_module__module_info_pred_info_3_p_0(STATE_VARIABLE_ModuleInfo_0_44, PredId_10, &PredInfo0_22);
  ...
  else
  {
    ...
    hlds__make_hlds__add_pragma__add_pragma_type_spec__handle_pragma_type_spec_modes_8_p_0(STATE_VARIABLE_ModuleInfo_0_44, PredId_10, PredInfo0_22, ProcTable0_29, TVarSet0_18, Context_20, PFUMM0_14, &MaybeSpecProcs_30);
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_31, (MR_Integer) 154, &Smart_34);
    ...
    if (succeeded)
    {
      ...
      hlds__make_hlds__add_pragma__add_pragma_type_spec__add_type_spec_version_of_pred_14_p_0(PredId_10, PredInfo0_22, PredFormArity_38, TypeSpec_9, TVarSet_24, Types_25, ExistQVars_26, ClassContext_27, SpecProcTable0_35, SpecProcIds_36, &SpecPredId_40, &SpecPredStatus_41, STATE_VARIABLE_ModuleInfo_0_44, &STATE_VARIABLE_ModuleInfo_51_51);
      hlds__make_hlds__add_pragma__add_pragma_type_spec__record_type_specialization_10_p_0(TypeSpec_9, PredId_10, SpecPredId_40, SpecPredStatus_41, SpecProcIds_36, RenamedSubst_28, TVarSet_24, PFUMM_39, STATE_VARIABLE_ModuleInfo_51_51, STATE_VARIABLE_ModuleInfo_45);
      PredOrFunc_42 = hlds__hlds_pred__pred_info_is_pred_or_func_1_f_0(PredInfo0_22);
      hlds__make_hlds__add_pragma__add_pragma_type_spec__maybe_record_type_spec_in_qual_info_7_p_0(PredOrFunc_42, SymName_15, UserArity_37, SpecPredStatus_41, TypeSpec_9, STATE_VARIABLE_QualInfo_0_46, STATE_VARIABLE_QualInfo_47);
  ...
  MR_Word * MaybeSubstResult_10)
{
  ...
  if ((MultiSubstVars0_13 == (MR_Word) ((MR_Unsigned) 0U)))
  {
    ...
    if ((UnknownVarsToSub_22 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      ...
      parse_tree__prog_type_scan__type_vars_in_types_2_p_0(SubstTypes0_24, &TVarsInSubstTypes0_25);
      ...
      if ((RecSubstTVars_28 == (MR_Word) ((MR_Unsigned) 0U)))
      {
        ...
        if ((SubExistQVars_37 == (MR_Word) ((MR_Unsigned) 0U)))
        {
          ...
          parse_tree__prog_type_subst__apply_rec_subst_to_univ_exist_constraints_3_p_0(TypeSubst_40, ClassContext0_42, &ClassContext_44);
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_35)
{
  ...
  mercury__multi_map__set_4_p_0((MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_id_0), (MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_decl_pragma_type_spec_info_0), ((MR_Box) (PredId_12)), ((MR_Box) (TSInfo_31)), PragmaMap0_24, &PragmaMap_32);
  {
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_78)
{
  ...
  MR_Word Context_34 = ((MR_Word) ((MR_hl_field(0, TSInfo0_18, (MR_Integer) 6))));
  ...
  mercury__map__map_values_only_3_p_0((MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_proc_info_0), (MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_proc_info_0), (MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_proc_id_0), (MR_Word) (&hlds__make_hlds__add_pragma__add_pragma_type_spec_scalar_common_2[3]), SpecProcTable0_23, &SpecProcTable_36);
  ...
  hlds__hlds_goal__goal_info_set_context_3_p_0(Context_34, GoalInfo1_43, &GoalInfo_44);
  PredOrFunc_45 = hlds__hlds_pred__pred_info_is_pred_or_func_1_f_0(PredInfo0_16);
  hlds__make_hlds__qual_info__construct_pred_or_func_call_6_p_0(PredId_15, PredOrFunc_45, SymName_29, ArgVars_39, GoalInfo_44, &Goal_46);
  {
    Var_81 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(1, Var_81, 0) = ((MR_Box) (SpecProcIds_24));
  }
  {
    ...
    MR_hl_field(0, Clause_47, 3) = ((MR_Box) (Context_34));
  ...
  hlds__hlds_pred__pred_info_get_markers_2_p_0(PredInfo0_16, &Markers0_56);
  ...
  parse_tree__prog_item__pfumm_to_maybe_pf_arity_maybe_modes_4_p_0(PFUMM0_28, &MaybePredOrFunc0_60, &_Arity_61, &_MaybeModes_62);
  UnqualName_63 = mdbcomp__sym_name__unqualify_name_1_f_0(SymName_29);
  {
    ...
    MR_hl_field(3, Transform_64, 2) = ((MR_Box) (TVarSet0_32));
    MR_hl_field(3, Transform_64, 3) = ((MR_Box) (Subst_31));
  }
  hlds__pred_name__make_transformed_pred_name_3_p_0(UnqualName_63, Transform_64, &SpecName_65);
  hlds__hlds_pred__pred_info_get_origin_2_p_0(PredInfo0_16, &OrigOrigin_66);
  SubstDesc_67 = mercury__one_or_more__map_2_f_0((MR_Word) (&hlds__make_hlds__add_pragma__add_pragma_type_spec_scalar_common_2[1]), (MR_Word) (&hlds__make_hlds__add_pragma__add_pragma_type_spec_scalar_common_2[2]), (MR_Word) (&hlds__make_hlds__add_pragma__add_pragma_type_spec_scalar_common_2[4]), Subst_31);
  {
  ...
  }
  {
    ...
    MR_hl_field(2, Origin_69, 2) = ((MR_Box) (PredId_15));
  }
  hlds__hlds_pred__pred_info_get_var_name_remap_2_p_0(PredInfo0_16, &VarNameRemap_72);
  hlds__hlds_pred__pred_info_init_19_p_0(PredOrFunc_45, SpecModuleName_30, SpecName_65, PredFormArity_17, Context_34, Origin_69, *SpecPredStatus_26, (MR_Word) ((MR_Unsigned) 0U), (MR_Word) (&hlds__make_hlds__add_pragma__add_pragma_type_spec_scalar_common_3[2]), Markers_57, Types_20, TVarSet_19, ExistQVars_21, ClassContext_22, Proofs_58, ConstraintMap_59, Clauses_55, VarNameRemap_72, &SpecPredInfo0_73);
  ...
  hlds__pred_table__predicate_table_insert_4_p_0(SpecPredInfo_74, SpecPredId_25, PredTable0_75, &PredTable_76);
  ...
  MR_Box * wrapper_arg_7)
{
  ...
  hlds__make_hlds__add_pragma__add_pragma_type_spec__add_pragma_type_spec_for_pred_8_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) (wrapper_arg_1)), ((MR_Word) (wrapper_arg_2)), &conv2_STATE_VARIABLE_ModuleInfo_45, ((MR_Word) (wrapper_arg_4)), &conv1_STATE_VARIABLE_QualInfo_47, ((MR_Word) (wrapper_arg_6)), &conv0_STATE_VARIABLE_Specs_49);
  ...
  MR_Word * STATE_VARIABLE_Specs_38)
{
  ...
  if ((PredIds_27 == (MR_Word) ((MR_Unsigned) 0U)))
  {
    ...
    hlds__make_hlds_error__report_undefined_pred_or_func_error_8_p_0(MaybePredOrFunc_23, SymName_13, UserArity_26, OtherUserArities_30, Context_18, (MR_Word) (MR_mkword(1, &hlds__make_hlds__add_pragma__add_pragma_type_spec_scalar_common_1[7])), STATE_VARIABLE_Specs_42_42, STATE_VARIABLE_Specs_38);
