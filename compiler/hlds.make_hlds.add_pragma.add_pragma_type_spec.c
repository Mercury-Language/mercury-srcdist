...
{
  {
    ...
    else
    {
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals_37, (MR_Integer) 147, &Smart_40);
...
{
  {
    ...
    if ((PredIds_28 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      ...
      hlds__hlds_module__module_info_get_preds_2_p_0(STATE_VARIABLE_ModuleInfo_0_36, &Preds_31);
      hlds__hlds_error_util__find_user_arities_other_than_4_p_0(Preds_31, AllArityPredIds_29, UserArity_26, &OtherUserArities_32);
