...
{
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        {
          Clauses_58 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 9 * sizeof(MR_Word)), NULL, NULL);
          ...
          MR_hl_field(MR_mktag(0), Clauses_58, 8) = (MR_Box) (((((MR_Unsigned) ((MR_Integer) 0) << (MR_Integer) 1)) | (MR_Unsigned) ((MR_Integer) 0)));
        }
