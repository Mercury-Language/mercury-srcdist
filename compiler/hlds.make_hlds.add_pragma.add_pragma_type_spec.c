...
{
  {
    ...
    {
      hlds__make_hlds_error__report_undefined_pred_or_func_error_7_p_0(SymName_14, Arity_16, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), Context_10, (MR_Word) MR_mkword(MR_mktag(1), &hlds__make_hlds__add_pragma__add_pragma_type_spec_scalar_common_1[6]), STATE_VARIABLE_Specs_0_33, STATE_VARIABLE_Specs_34);
