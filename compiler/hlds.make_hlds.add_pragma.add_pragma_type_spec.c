...
{
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        mercury__map__init_1_p_0(TypeCtorInfo_138_138, (MR_Word) &hlds__hlds_class__hlds__hlds_class__type_ctor_info_constraint_proof_0, &Proofs_61);
        mercury__map__init_1_p_0((MR_Word) &hlds__hlds_class__hlds__hlds_class__type_ctor_info_constraint_id_0, TypeCtorInfo_138_138, &ConstraintMap_62);
        succeeded = hlds__hlds_pred__pred_info_is_imported_1_p_0(PredInfo0_24);
        if (succeeded)
        {
