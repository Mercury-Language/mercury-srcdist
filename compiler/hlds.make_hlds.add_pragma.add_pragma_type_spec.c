...
{
  {
    ...
    else
    {
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals_35, (MR_Integer) 387, &DoTypeSpec_36);
      libs__globals__lookup_bool_option_3_p_0(Globals_35, (MR_Integer) 132, &Smart_37);
...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), Msg_15, 1) = ((MR_Box) (Var_41));
    }
    {
...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), Msg_13, 0) = ((MR_Box) (Context_8));
      MR_hl_field(MR_mktag(1), Msg_13, 1) = ((MR_Box) (Var_34));
    }
    {
...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), Msg_12, 1) = ((MR_Box) (Var_31));
    }
    {
