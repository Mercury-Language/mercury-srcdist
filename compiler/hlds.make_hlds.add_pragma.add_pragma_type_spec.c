...
{
  {
    ...
    else
    {
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals_35, (MR_Integer) 386, &DoTypeSpec_36);
      libs__globals__lookup_bool_option_3_p_0(Globals_35, (MR_Integer) 131, &Smart_37);
