...
static void MR_CALL 
hlds__make_hlds__add_pragma__add_pragma_type_spec__IntroducedFrom__pred__handle_pragma_type_spec_subst__362__1_3_p_0(
  MR_Word HeadVar__1_95,
  MR_Word HeadVar__2_96,
  MR_Word * HeadVar__3_97);

static MR_bool MR_CALL 
hlds__make_hlds__add_pragma__add_pragma_type_spec__IntroducedFrom__pred__handle_pragma_type_spec_subst__351__1_2_p_0(
...
static void MR_CALL 
hlds__make_hlds__add_pragma__add_pragma_type_spec__IntroducedFrom__pred__add_pragma_type_spec_for_pred__224__1_3_p_0(
  MR_Word PredId_16,
  MR_Integer LambdaHeadVar__1_125,
...
static /* final */ const MR_Box hlds__make_hlds__add_pragma__add_pragma_type_spec_scalar_common_3[2][1];
...
{
  {
    ...
    *LambdaHeadVar__2_126 = base;
    MR_hl_field(MR_mktag(0), base, 0) = ((MR_Box) (PredId_16));
    MR_hl_field(MR_mktag(0), base, 1) = ((MR_Box) (LambdaHeadVar__1_125));
  }
}
  ...
  MR_Box * wrapper_arg_2)
{
  {
    MR_Box closure = closure_arg;
    MR_Word conv2_LambdaHeadVar__2_126;

    hlds__make_hlds__add_pragma__add_pragma_type_spec__IntroducedFrom__pred__add_pragma_type_spec_for_pred__224__1_3_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Integer) (wrapper_arg_1)), &conv2_LambdaHeadVar__2_126);
    *wrapper_arg_2 = ((MR_Box) (conv2_LambdaHeadVar__2_126));
  }
}
...
{
  {
    ...
    hlds__hlds_module__module_info_pred_info_3_p_0(STATE_VARIABLE_ModuleInfo_0_96, PredId_16, &PredInfo0_26);
    hlds__make_hlds__add_pragma__add_pragma_type_spec__handle_pragma_type_spec_subst_13_p_0(Context_15, Subst_23, PredInfo0_26, TVarSet0_24, &TVarSet_27, &Types_28, &ExistQVars_29, &ClassContext_30, &SubstOk_31, STATE_VARIABLE_ModuleInfo_0_96, &STATE_VARIABLE_ModuleInfo_102_102, STATE_VARIABLE_Specs_0_100, &STATE_VARIABLE_Specs_103_103);
    if ((SubstOk_31 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      *STATE_VARIABLE_ModuleInfo_97 = STATE_VARIABLE_ModuleInfo_102_102;
      *STATE_VARIABLE_QualInfo_99 = STATE_VARIABLE_QualInfo_0_98;
      *STATE_VARIABLE_Specs_101 = STATE_VARIABLE_Specs_103_103;
    }
    else
    {
      ...
      hlds__make_hlds__add_pragma__add_pragma_type_spec__handle_pragma_type_spec_modes_11_p_0(SymName_21, UserArity_13, Context_15, MaybeModes_14, &MaybeProcIds_34, Procs0_33, &Procs1_35, STATE_VARIABLE_ModuleInfo_102_102, &STATE_VARIABLE_ModuleInfo_104_104, STATE_VARIABLE_Specs_103_103, STATE_VARIABLE_Specs_101);
      ...
      hlds__hlds_module__module_info_get_globals_2_p_0(STATE_VARIABLE_ModuleInfo_104_104, &Globals_37);
      libs__globals__get_opt_tuple_2_p_0(Globals_37, &OptTuple_38);
      DoTypeSpec_39 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), OptTuple_38, (MR_Integer) 0))) >> 2)) & (MR_Integer) 1);
      libs__globals__lookup_bool_option_3_p_0(Globals_37, (MR_Integer) 140, &Smart_40);
      ...
      if (succeeded)
      {
        ...
        MR_Word NewPredInfo0_71;
        MR_Word NewPredInfo_72;
        MR_Word PredTable0_73;
        MR_Word NewPredId_74;
        MR_Word PredTable_75;
        MR_Word TypeSpecInfo0_76;
        MR_Word ProcsToSpec0_77;
        MR_Word ForceVersions0_78;
        MR_Word SpecMap0_79;
        MR_Word PragmaMap0_80;
        MR_Word PredProcIds_83;
        MR_Word ProcsToSpec_84;
        MR_Word ForceVersions_85;
        MR_Word SpecMap_86;
        MR_Word ModesOrArity_87;
        MR_Word PFUMM_89;
        MR_Word TSInfo_90;
        MR_Word PragmaMap_91;
        MR_Word TypeSpecInfo_92;
        MR_Word IsImported_93;
        MR_Word Var_108;
        MR_Word Var_110;
        MR_Word Var_113;
        MR_Word Var_121;
        ...
        parse_tree__prog_util__user_arity_pred_form_arity_3_p_0(PredOrFunc_42, UserArity_13, &Var_108);
        PredArityInt_44 = (MR_Integer) (Var_108);
        ...
        hlds__make_hlds__qual_info__do_construct_pred_or_func_call_6_p_0(PredId_16, PredOrFunc_42, SymName_21, Args_45, GoalInfo_51, &Goal_52);
        {
          ...
          MR_hl_field(MR_mktag(1), Var_110, 0) = ((MR_Box) (ProcIds_41));
        }
        {
          Clause_53 = (MR_Word) MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), Clause_53, 0) = ((MR_Box) (Var_110));
        ...
        ArgsVec_55 = hlds__hlds_args__proc_arg_vector_init_2_f_0((MR_Word) (&hlds__make_hlds__add_pragma__add_pragma_type_spec_scalar_common_1[2]), PredOrFunc_42, Args_45);
        {
          ...
          MR_hl_field(MR_mktag(1), Var_113, 0) = ((MR_Box) (Clause_53));
          MR_hl_field(MR_mktag(1), Var_113, 1) = ((MR_Box) ((MR_Unsigned) 0U));
        }
        hlds__hlds_clauses__set_clause_list_2_p_0(Var_113, &ClausesRep_56);
        ...
        SubstDesc_67 = mercury__list__map_2_f_0((MR_Word) (&hlds__make_hlds__add_pragma__add_pragma_type_spec_scalar_common_2[0]), (MR_Word) (&hlds__make_hlds__add_pragma__add_pragma_type_spec_scalar_common_2[1]), (MR_Word) (&hlds__make_hlds__add_pragma__add_pragma_type_spec_scalar_common_2[5]), Subst_23);
        {
          ...
          MR_hl_field(MR_mktag(3), Var_121, 1) = ((MR_Box) (SubstDesc_67));
        }
        {
          ...
          MR_hl_field(MR_mktag(3), Origin_68, 1) = ((MR_Box) (Var_121));
          MR_hl_field(MR_mktag(3), Origin_68, 2) = ((MR_Box) (OrigOrigin_66));
          MR_hl_field(MR_mktag(3), Origin_68, 3) = ((MR_Box) (PredId_16));
        }
        hlds__hlds_pred__pred_info_get_var_name_remap_2_p_0(PredInfo0_26, &VarNameRemap_70);
        hlds__hlds_pred__pred_info_init_19_p_0(ModuleName_65, SpecName_22, PredArityInt_44, PredOrFunc_42, Context_15, Origin_68, PredStatus_64, (MR_Word) ((MR_Unsigned) 0U), (MR_Word) ((MR_Unsigned) 12U), Markers_61, Types_28, TVarSet_27, ExistQVars_29, ClassContext_30, Proofs_62, ConstraintMap_63, Clauses_59, VarNameRemap_70, &NewPredInfo0_71);
        hlds__hlds_pred__pred_info_set_proc_table_3_p_0(Procs_36, NewPredInfo0_71, &NewPredInfo_72);
        hlds__hlds_module__module_info_get_predicate_table_2_p_0(STATE_VARIABLE_ModuleInfo_104_104, &PredTable0_73);
        hlds__pred_table__predicate_table_insert_4_p_0(NewPredInfo_72, &NewPredId_74, PredTable0_73, &PredTable_75);
        hlds__hlds_module__module_info_set_predicate_table_3_p_0(PredTable_75, STATE_VARIABLE_ModuleInfo_104_104, &STATE_VARIABLE_ModuleInfo_123_123);
        hlds__hlds_module__module_info_get_type_spec_info_2_p_0(STATE_VARIABLE_ModuleInfo_123_123, &TypeSpecInfo0_76);
        ProcsToSpec0_77 = ((MR_Word) ((MR_hl_field(MR_mktag(0), TypeSpecInfo0_76, (MR_Integer) 0))));
        ForceVersions0_78 = ((MR_Word) ((MR_hl_field(MR_mktag(0), TypeSpecInfo0_76, (MR_Integer) 1))));
        SpecMap0_79 = ((MR_Word) ((MR_hl_field(MR_mktag(0), TypeSpecInfo0_76, (MR_Integer) 2))));
        PragmaMap0_80 = ((MR_Word) ((MR_hl_field(MR_mktag(0), TypeSpecInfo0_76, (MR_Integer) 3))));
        {
          Var_124 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), Var_124, 0) = ((MR_Box) (&hlds__make_hlds__add_pragma__add_pragma_type_spec_scalar_common_5[2]));
          MR_hl_field(MR_mktag(0), Var_124, 1) = ((MR_Box) (hlds__make_hlds__add_pragma__add_pragma_type_spec__add_pragma_type_spec_for_pred_11_p_0_3));
          MR_hl_field(MR_mktag(0), Var_124, 2) = ((MR_Box) ((MR_Integer) 1));
          MR_hl_field(MR_mktag(0), Var_124, 3) = ((MR_Box) (PredId_16));
        }
        mercury__list__map_3_p_0((MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_proc_id_0), (MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_proc_id_0), Var_124, ProcIds_41, &PredProcIds_83);
        mercury__set__insert_list_3_p_0((MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_proc_id_0), PredProcIds_83, ProcsToSpec0_77, &ProcsToSpec_84);
        mercury__set__insert_3_p_0((MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_id_0), ((MR_Box) (NewPredId_74)), ForceVersions0_78, &ForceVersions_85);
        Var_127 = (MR_Word) (PredStatus_64);
        succeeded = (Var_127 == (MR_Word) ((MR_Unsigned) 0U));
        if (succeeded)
          mercury__multi_map__set_4_p_0((MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_id_0), (MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_id_0), ((MR_Box) (PredId_16)), ((MR_Box) (NewPredId_74)), SpecMap0_79, &SpecMap_86);
        else
          SpecMap_86 = SpecMap0_79;
        if ((MaybeModes_14 == (MR_Word) ((MR_Unsigned) 0U)))
          {
            ModesOrArity_87 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), ModesOrArity_87, 0) = ((MR_Box) (UserArity_13));
          }
        else
        {
          MR_Word Modes_88 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MaybeModes_14, (MR_Integer) 0))));

          {
            ModesOrArity_87 = (MR_Word) MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL);
            MR_hl_field(MR_mktag(0), ModesOrArity_87, 0) = ((MR_Box) (Modes_88));
          }
        }
        switch (PredOrFunc_42) {
          ...
          case (MR_Integer) 1:
            {
              PFUMM_89 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), PFUMM_89, 0) = ((MR_Box) (ModesOrArity_87));
            }
            break;
          case (MR_Integer) 0:
            {
              PFUMM_89 = (MR_Word) MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL);
              MR_hl_field(MR_mktag(0), PFUMM_89, 0) = ((MR_Box) (ModesOrArity_87));
            }
            break;
        }
        Var_128 = mercury__map__to_assoc_list_1_f_0((MR_Word) (&hlds__make_hlds__add_pragma__add_pragma_type_spec_scalar_common_1[1]), (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0), RenamedSubst_32);
        {
          TSInfo_90 = (MR_Word) MR_new_object(MR_Word, (6 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), TSInfo_90, 0) = ((MR_Box) (PFUMM_89));
          MR_hl_field(MR_mktag(0), TSInfo_90, 1) = ((MR_Box) (SymName_21));
          MR_hl_field(MR_mktag(0), TSInfo_90, 2) = ((MR_Box) (SpecName_22));
          MR_hl_field(MR_mktag(0), TSInfo_90, 3) = ((MR_Box) (Var_128));
          MR_hl_field(MR_mktag(0), TSInfo_90, 4) = ((MR_Box) (TVarSet_27));
          MR_hl_field(MR_mktag(0), TSInfo_90, 5) = ((MR_Box) (ExpandedItems_25));
        }
        mercury__multi_map__set_4_p_0((MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_id_0), (MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_pragma_info_type_spec_0), ((MR_Box) (PredId_16)), ((MR_Box) (TSInfo_90)), PragmaMap0_80, &PragmaMap_91);
        {
          TypeSpecInfo_92 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), TypeSpecInfo_92, 0) = ((MR_Box) (ProcsToSpec_84));
          MR_hl_field(MR_mktag(0), TypeSpecInfo_92, 1) = ((MR_Box) (ForceVersions_85));
          MR_hl_field(MR_mktag(0), TypeSpecInfo_92, 2) = ((MR_Box) (SpecMap_86));
          MR_hl_field(MR_mktag(0), TypeSpecInfo_92, 3) = ((MR_Box) (PragmaMap_91));
        }
        hlds__hlds_module__module_info_set_type_spec_info_3_p_0(TypeSpecInfo_92, STATE_VARIABLE_ModuleInfo_123_123, STATE_VARIABLE_ModuleInfo_97);
        IsImported_93 = hlds__status__pred_status_is_imported_1_f_0(PredStatus_64);
        switch (IsImported_93) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 0:
            *STATE_VARIABLE_QualInfo_99 = STATE_VARIABLE_QualInfo_0_98;
            break;
          case (MR_Integer) 1:
            {
              MR_Word ItemType_94;
              MR_Integer UserArityInt_95;
              MR_Word Var_130;
              MR_Word Var_132;
              MR_Word Var_133;

              ItemType_94 = recompilation__pred_or_func_to_item_type_1_f_0(PredOrFunc_42);
              UserArityInt_95 = (MR_Integer) (UserArity_13);
              {
                Var_133 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
                MR_hl_field(MR_mktag(0), Var_133, 0) = ((MR_Box) (SymName_21));
                MR_hl_field(MR_mktag(0), Var_133, 1) = ((MR_Box) (UserArityInt_95));
              }
              {
                Var_132 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
                MR_hl_field(MR_mktag(0), Var_132, 0) = (MR_Box) ((MR_Unsigned) (ItemType_94));
                MR_hl_field(MR_mktag(0), Var_132, 1) = ((MR_Box) (Var_133));
              }
              {
                Var_130 = (MR_Word) MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL);
                MR_hl_field(MR_mktag(0), Var_130, 0) = ((MR_Box) (&hlds__make_hlds__add_pragma__add_pragma_type_spec_scalar_common_7[0]));
                MR_hl_field(MR_mktag(0), Var_130, 1) = ((MR_Box) (hlds__make_hlds__add_pragma__add_pragma_type_spec__add_pragma_type_spec_for_pred_11_p_0_4));
                MR_hl_field(MR_mktag(0), Var_130, 2) = ((MR_Box) ((MR_Integer) 2));
                MR_hl_field(MR_mktag(0), Var_130, 3) = ((MR_Box) (Var_132));
                MR_hl_field(MR_mktag(0), Var_130, 4) = ((MR_Box) (ExpandedItems_25));
              }
              hlds__make_hlds__qual_info__apply_to_recompilation_info_3_p_0(Var_130, STATE_VARIABLE_QualInfo_0_98, STATE_VARIABLE_QualInfo_99);
            }
            break;
        }
      }
      ...
      {
        *STATE_VARIABLE_QualInfo_99 = STATE_VARIABLE_QualInfo_0_98;
        *STATE_VARIABLE_ModuleInfo_97 = STATE_VARIABLE_ModuleInfo_104_104;
      }
    }
  }
}
...
{
  {
    ...
    hlds__make_hlds__add_pragma__add_pragma_type_spec__IntroducedFrom__pred__handle_pragma_type_spec_subst__362__1_3_p_0(((MR_Word) (wrapper_arg_1)), ((MR_Word) (wrapper_arg_2)), &conv0_HeadVar__3_97);
...
{
  {
    ...
    succeeded = hlds__make_hlds__add_pragma__add_pragma_type_spec__IntroducedFrom__pred__handle_pragma_type_spec_subst__351__1_2_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) (wrapper_arg_1)));
    return succeeded;
  }
}
...
{
  {
    ...
    succeeded = hlds__make_hlds__add_pragma__add_pragma_type_spec__IntroducedFrom__pred__handle_pragma_type_spec_subst__320__1_3_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))), ((MR_Word) (wrapper_arg_1)));
    return succeeded;
  }
}
  ...
  MR_Box * wrapper_arg_7)
{
  {
    MR_Box closure = closure_arg;
    MR_Word conv2_STATE_VARIABLE_ModuleInfo_97;
    MR_Word conv1_STATE_VARIABLE_QualInfo_99;
    MR_Word conv0_STATE_VARIABLE_Specs_101;

    hlds__make_hlds__add_pragma__add_pragma_type_spec__add_pragma_type_spec_for_pred_11_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 5)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 6)))), ((MR_Word) (wrapper_arg_1)), ((MR_Word) (wrapper_arg_2)), &conv2_STATE_VARIABLE_ModuleInfo_97, ((MR_Word) (wrapper_arg_4)), &conv1_STATE_VARIABLE_QualInfo_99, ((MR_Word) (wrapper_arg_6)), &conv0_STATE_VARIABLE_Specs_101);
    *wrapper_arg_3 = ((MR_Box) (conv2_STATE_VARIABLE_ModuleInfo_97));
    *wrapper_arg_5 = ((MR_Box) (conv1_STATE_VARIABLE_QualInfo_99));
    *wrapper_arg_7 = ((MR_Box) (conv0_STATE_VARIABLE_Specs_101));
  }
}
...
{
  {
    ...
    switch (MR_tag((MR_Word) PFUMM_14)) {
      ...
      case (MR_Integer) 0:
        {
          MR_Word ModesOrArity_75 = ((MR_Word) ((MR_hl_field(MR_mktag(0), PFUMM_14, (MR_Integer) 0))));
          MR_Integer PredArityInt_78;

          MaybePredOrFunc_23 = (MR_Word) (MR_mkword(MR_mktag(1), &hlds__make_hlds__add_pragma__add_pragma_type_spec_scalar_common_3[1]));
          if (((MR_tag((MR_Word) ModesOrArity_75)) == (MR_Integer) 1))
          {
            MR_Word Var_67;

            UserArity_26 = ((MR_Word) ((MR_hl_field(MR_mktag(1), ModesOrArity_75, (MR_Integer) 0))));
            parse_tree__prog_util__user_arity_pred_form_arity_3_p_0((MR_Integer) 0, UserArity_26, &Var_67);
            PredArityInt_78 = (MR_Integer) (Var_67);
            MaybeModes_27 = (MR_Word) ((MR_Unsigned) 0U);
          }
          else
          {
            MR_Word Modes_68 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ModesOrArity_75, (MR_Integer) 0))));
            MR_Word Var_69;

            mercury__list__length_2_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_mode_0), Modes_68, &PredArityInt_78);
            Var_69 = (MR_Word) (PredArityInt_78);
            parse_tree__prog_util__user_arity_pred_form_arity_3_p_1((MR_Integer) 0, &UserArity_26, Var_69);
            {
              MaybeModes_27 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), MaybeModes_27, 0) = ((MR_Box) (Modes_68));
            }
          }
          hlds__pred_table__predicate_table_lookup_pf_sym_arity_6_p_0(Preds_20, (MR_Integer) 0, (MR_Integer) 0, SymName_15, PredArityInt_78, &PredIds_28);
      ...
      case (MR_Integer) 1:
        {
          ...
          if (((MR_tag((MR_Word) ModesOrArity_21)) == (MR_Integer) 1))
          {
            ...
            parse_tree__prog_util__user_arity_pred_form_arity_3_p_0((MR_Integer) 1, UserArity_26, &Var_40);
            PredArityInt_25 = (MR_Integer) (Var_40);
            MaybeModes_27 = (MR_Word) ((MR_Unsigned) 0U);
          }
          else
          {
            ...
            Var_41 = (MR_Word) (PredArityInt_25);
            parse_tree__prog_util__user_arity_pred_form_arity_3_p_1((MR_Integer) 1, &UserArity_26, Var_41);
            {
              MaybeModes_27 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
    ...
    {
      hlds__make_hlds_error__report_undefined_pred_or_func_error_8_p_0(MaybePredOrFunc_23, SymName_15, UserArityInt_29, (MR_Word) ((MR_Unsigned) 0U), Context_10, (MR_Word) (MR_mkword(MR_mktag(1), &hlds__make_hlds__add_pragma__add_pragma_type_spec_scalar_common_1[6])), STATE_VARIABLE_Specs_0_37, STATE_VARIABLE_Specs_38);
    ...
    else
    {
...

      {
        ...
        MR_hl_field(MR_mktag(0), Var_43, 0) = ((MR_Box) (&hlds__make_hlds__add_pragma__add_pragma_type_spec_scalar_common_4[0]));
        MR_hl_field(MR_mktag(0), Var_43, 1) = ((MR_Box) (hlds__make_hlds__add_pragma__add_pragma_type_spec__add_pragma_type_spec_8_p_0_1));
        MR_hl_field(MR_mktag(0), Var_43, 2) = ((MR_Box) ((MR_Integer) 4));
        MR_hl_field(MR_mktag(0), Var_43, 3) = ((MR_Box) (TSInfo_9));
        MR_hl_field(MR_mktag(0), Var_43, 4) = ((MR_Box) (UserArity_26));
        MR_hl_field(MR_mktag(0), Var_43, 5) = ((MR_Box) (MaybeModes_27));
        MR_hl_field(MR_mktag(0), Var_43, 6) = ((MR_Box) (Context_10));
      }
      mercury__list__foldl3_8_p_0((MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_id_0), (MR_Word) (&hlds__hlds_module__hlds__hlds_module__type_ctor_info_module_info_0), (MR_Word) (&hlds__make_hlds__qual_info__hlds__make_hlds__qual_info__type_ctor_info_qual_info_0), (MR_Word) (&hlds__make_hlds__add_pragma__add_pragma_type_spec_scalar_common_1[0]), Var_43, PredIds_28, ((MR_Box) (STATE_VARIABLE_ModuleInfo_0_33)), &conv5_STATE_VARIABLE_ModuleInfo_34, ((MR_Box) (STATE_VARIABLE_QualInfo_0_35)), &conv4_STATE_VARIABLE_QualInfo_36, ((MR_Box) (STATE_VARIABLE_Specs_0_37)), &conv3_STATE_VARIABLE_Specs_38);
