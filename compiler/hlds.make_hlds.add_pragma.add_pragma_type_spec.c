...
{
  {
    ...
    else
    {
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals_35, (MR_Integer) 390, &DoTypeSpec_36);
      libs__globals__lookup_bool_option_3_p_0(Globals_35, (MR_Integer) 135, &Smart_37);
...
{
  {
    ...
    {
      SimpleCallId_53 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), SimpleCallId_53, 0) = (MR_Box) ((MR_Unsigned) (PredOrFunc_52));
      MR_hl_field(MR_mktag(0), SimpleCallId_53, 1) = ((MR_Box) (Var_54));
      MR_hl_field(MR_mktag(0), SimpleCallId_53, 2) = ((MR_Box) (Arity_51));
    }
    {
      ...
      MR_hl_field(MR_mktag(3), Var_64, 1) = ((MR_Box) (SimpleCallId_53));
    }
    {
...
{
  {
    ...
    {
      SimpleCallId_46 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), SimpleCallId_46, 0) = (MR_Box) ((MR_Unsigned) (PredOrFunc_45));
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(3), Var_57, 0) = ((MR_Box) ((MR_Unsigned) 17U));
...
{
  {
    ...
    {
      SimpleCallId_41 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), SimpleCallId_41, 0) = (MR_Box) ((MR_Unsigned) (PredOrFunc_40));
      MR_hl_field(MR_mktag(0), SimpleCallId_41, 1) = ((MR_Box) (Var_42));
      MR_hl_field(MR_mktag(0), SimpleCallId_41, 2) = ((MR_Box) (Arity_39));
    }
    {
      Var_52 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(3), Var_52, 0) = ((MR_Box) ((MR_Unsigned) 17U));
      MR_hl_field(MR_mktag(3), Var_52, 1) = ((MR_Box) (SimpleCallId_41));
    }
    {
