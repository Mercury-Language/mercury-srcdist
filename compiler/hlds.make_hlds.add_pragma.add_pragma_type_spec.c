...
static void MR_CALL 
hlds__make_hlds__add_pragma__add_pragma_type_spec__IntroducedFrom__pred__handle_pragma_type_spec_subst__377__1_3_p_0(
  MR_Word HeadVar__1_95,
  MR_Word HeadVar__2_96,
  MR_Word * HeadVar__3_97);

static MR_bool MR_CALL 
hlds__make_hlds__add_pragma__add_pragma_type_spec__IntroducedFrom__pred__handle_pragma_type_spec_subst__366__1_2_p_0(
  MR_Word ExistQVars_20,
  MR_Word LambdaHeadVar__1_75);

static MR_bool MR_CALL 
hlds__make_hlds__add_pragma__add_pragma_type_spec__IntroducedFrom__pred__handle_pragma_type_spec_subst__335__1_3_p_0(
  MR_Word TVarSet0_17,
  MR_Word NameVarIndex0_33,
  MR_Word LambdaHeadVar__1_67);

static void MR_CALL 
hlds__make_hlds__add_pragma__add_pragma_type_spec__IntroducedFrom__pred__add_pragma_type_spec_for_pred__239__1_3_p_0(
  MR_Word PredId_16,
  ...
  MR_Box * wrapper_arg_2)
{
  ...
  hlds__make_hlds__add_pragma__add_pragma_type_spec__IntroducedFrom__pred__add_pragma_type_spec_for_pred__239__1_3_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Integer) (wrapper_arg_1)), &conv2_LambdaHeadVar__2_131);
  ...
  MR_Word * STATE_VARIABLE_Specs_104)
{
  ...
  hlds__hlds_module__module_info_pred_info_3_p_0(STATE_VARIABLE_ModuleInfo_0_99, PredId_16, &PredInfo0_29);
  hlds__make_hlds__add_pragma__add_pragma_type_spec__handle_pragma_type_spec_subst_13_p_0(Context_15, Subst_23, PredInfo0_29, TVarSet0_24, &TVarSet_30, &Types_31, &ExistQVars_32, &ClassContext_33, &SubstOk_34, STATE_VARIABLE_ModuleInfo_0_99, &STATE_VARIABLE_ModuleInfo_107_107, STATE_VARIABLE_Specs_0_103, &STATE_VARIABLE_Specs_108_108);
  if ((SubstOk_34 == (MR_Word) ((MR_Unsigned) 0U)))
  {
    *STATE_VARIABLE_ModuleInfo_100 = STATE_VARIABLE_ModuleInfo_107_107;
    *STATE_VARIABLE_QualInfo_102 = STATE_VARIABLE_QualInfo_0_101;
    *STATE_VARIABLE_Specs_104 = STATE_VARIABLE_Specs_108_108;
  }
  else
  {
    ...
    hlds__make_hlds__add_pragma__add_pragma_type_spec__handle_pragma_type_spec_modes_11_p_0(SymName_21, UserArity_13, Context_15, MaybeModes_14, &MaybeProcIds_37, Procs0_36, &Procs1_38, STATE_VARIABLE_ModuleInfo_107_107, &STATE_VARIABLE_ModuleInfo_109_109, STATE_VARIABLE_Specs_108_108, STATE_VARIABLE_Specs_104);
    ...
    hlds__hlds_module__module_info_get_globals_2_p_0(STATE_VARIABLE_ModuleInfo_109_109, &Globals_40);
    ...
    if (succeeded)
    {
      ...
      MR_Word ArgVarSet0_46;
      MR_Integer PredArityInt_47;
      MR_Word ArgVars_48;
      ...
      MR_Word Markers_64;
      MR_Word Proofs_65;
      MR_Word ConstraintMap_66;
      MR_Word PredStatus_67;
      MR_Word OrigOrigin_68;
      MR_Word SubstDesc_69;
      MR_Word Origin_70;
      MR_Word VarNameRemap_73;
      MR_Word NewPredInfo0_74;
      MR_Word NewPredInfo_75;
      MR_Word PredTable0_76;
      MR_Word NewPredId_77;
      MR_Word PredTable_78;
      MR_Word TypeSpecInfo0_79;
      MR_Word ProcsToSpec0_80;
      MR_Word ForceVersions0_81;
      MR_Word SpecMap0_82;
      MR_Word PragmaMap0_83;
      MR_Word PredProcIds_86;
      MR_Word ProcsToSpec_87;
      MR_Word ForceVersions_88;
      MR_Word SpecMap_89;
      MR_Word ModesOrArity_90;
      MR_Word PFUMM_92;
      MR_Word TSInfo_93;
      MR_Word PragmaMap_94;
      MR_Word TypeSpecInfo_95;
      MR_Word IsImported_96;
      MR_Word Var_113;
      MR_Word Var_115;
      MR_Word Var_118;
      MR_Word Var_126;
      ...
      PredOrFunc_45 = hlds__hlds_pred__pred_info_is_pred_or_func_1_f_0(PredInfo0_29);
      mercury__varset__init_1_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), &ArgVarSet0_46);
      parse_tree__prog_util__user_arity_pred_form_arity_3_p_0(PredOrFunc_45, UserArity_13, &Var_113);
      PredArityInt_47 = (MR_Integer) (Var_113);
      parse_tree__prog_util__make_n_fresh_vars_5_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), (MR_String) "HeadVar__", PredArityInt_47, &ArgVars_48, ArgVarSet0_46, &ArgVarSet_49);
      hlds__vartypes__init_vartypes_1_p_0(&VarTypes0_50);
      hlds__hlds_goal__goal_info_init_1_p_0(&GoalInfo0_51);
      parse_tree__set_of_var__list_to_set_2_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), ArgVars_48, &NonLocals_52);
      ...
      hlds__make_hlds__qual_info__construct_pred_or_func_call_6_p_0(PredId_16, PredOrFunc_45, SymName_21, ArgVars_48, GoalInfo_54, &Goal_55);
      {
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(0), Clause_56, 0) = ((MR_Box) (Var_115));
      ...
      mercury__map__init_1_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&hlds__make_hlds__add_pragma__add_pragma_type_spec_scalar_common_1[1]), &TVarNameMap_57);
      ArgsVec_58 = hlds__hlds_args__proc_arg_vector_init_2_f_0((MR_Word) (&hlds__make_hlds__add_pragma__add_pragma_type_spec_scalar_common_1[2]), PredOrFunc_45, ArgVars_48);
      {
        Var_118 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), Var_118, 0) = ((MR_Box) (Clause_56));
        MR_hl_field(MR_mktag(1), Var_118, 1) = ((MR_Box) ((MR_Unsigned) 0U));
      }
      hlds__hlds_clauses__set_clause_list_2_p_0(Var_118, &ClausesRep_59);
      ItemNumbers_60 = hlds__hlds_clauses__init_clause_item_numbers_comp_gen_0_f_0();
      hlds__hlds_rtti__rtti_varmaps_init_1_p_0(&RttiVarMaps_61);
      {
        Clauses_62 = (MR_Word) MR_new_object(MR_Word, (9 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), Clauses_62, 0) = ((MR_Box) (ArgVarSet_49));
        MR_hl_field(MR_mktag(0), Clauses_62, 1) = ((MR_Box) (TVarNameMap_57));
        MR_hl_field(MR_mktag(0), Clauses_62, 2) = ((MR_Box) (VarTypes0_50));
        MR_hl_field(MR_mktag(0), Clauses_62, 3) = ((MR_Box) (VarTypes0_50));
        MR_hl_field(MR_mktag(0), Clauses_62, 4) = ((MR_Box) (ArgsVec_58));
        MR_hl_field(MR_mktag(0), Clauses_62, 5) = ((MR_Box) (ClausesRep_59));
        MR_hl_field(MR_mktag(0), Clauses_62, 6) = ((MR_Box) (ItemNumbers_60));
        MR_hl_field(MR_mktag(0), Clauses_62, 7) = ((MR_Box) (RttiVarMaps_61));
        MR_hl_field(MR_mktag(0), Clauses_62, 8) = (MR_Box) (((((MR_Unsigned) ((MR_Integer) 0) << 1)) | (MR_Unsigned) ((MR_Integer) 0)));
      }
      hlds__hlds_pred__pred_info_get_markers_2_p_0(PredInfo0_29, &Markers0_63);
      hlds__hlds_pred__add_marker_3_p_0((MR_Integer) 21, Markers0_63, &Markers_64);
      mercury__map__init_1_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_constraint_0), (MR_Word) (&hlds__hlds_class__hlds__hlds_class__type_ctor_info_constraint_proof_0), &Proofs_65);
      mercury__map__init_1_p_0((MR_Word) (&hlds__hlds_class__hlds__hlds_class__type_ctor_info_constraint_id_0), (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_constraint_0), &ConstraintMap_66);
      succeeded = hlds__hlds_pred__pred_info_is_imported_1_p_0(PredInfo0_29);
      if (succeeded)
        PredStatus_67 = (MR_Word) (((MR_Box) ((MR_Unsigned) 0U)));
      else
        hlds__hlds_pred__pred_info_get_status_2_p_0(PredInfo0_29, &PredStatus_67);
      hlds__hlds_pred__pred_info_get_origin_2_p_0(PredInfo0_29, &OrigOrigin_68);
      SubstDesc_69 = mercury__list__map_2_f_0((MR_Word) (&hlds__make_hlds__add_pragma__add_pragma_type_spec_scalar_common_2[0]), (MR_Word) (&hlds__make_hlds__add_pragma__add_pragma_type_spec_scalar_common_2[1]), (MR_Word) (&hlds__make_hlds__add_pragma__add_pragma_type_spec_scalar_common_2[6]), Subst_23);
      {
        ...
        MR_hl_field(MR_mktag(3), Var_126, 1) = ((MR_Box) (SubstDesc_69));
      }
      {
        Origin_70 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(3), Origin_70, 0) = ((MR_Box) ((MR_Unsigned) 1U));
        MR_hl_field(MR_mktag(3), Origin_70, 1) = ((MR_Box) (Var_126));
        MR_hl_field(MR_mktag(3), Origin_70, 2) = ((MR_Box) (OrigOrigin_68));
        MR_hl_field(MR_mktag(3), Origin_70, 3) = ((MR_Box) (PredId_16));
      }
      hlds__hlds_pred__pred_info_get_var_name_remap_2_p_0(PredInfo0_29, &VarNameRemap_73);
      hlds__hlds_pred__pred_info_init_19_p_0(PredOrFunc_45, SpecModuleName_26, SpecName_27, PredArityInt_47, Context_15, Origin_70, PredStatus_67, (MR_Word) ((MR_Unsigned) 0U), (MR_Word) (&hlds__make_hlds__add_pragma__add_pragma_type_spec_scalar_common_3[2]), Markers_64, Types_31, TVarSet_30, ExistQVars_32, ClassContext_33, Proofs_65, ConstraintMap_66, Clauses_62, VarNameRemap_73, &NewPredInfo0_74);
      hlds__hlds_pred__pred_info_set_proc_table_3_p_0(Procs_39, NewPredInfo0_74, &NewPredInfo_75);
      hlds__hlds_module__module_info_get_predicate_table_2_p_0(STATE_VARIABLE_ModuleInfo_109_109, &PredTable0_76);
      hlds__pred_table__predicate_table_insert_4_p_0(NewPredInfo_75, &NewPredId_77, PredTable0_76, &PredTable_78);
      hlds__hlds_module__module_info_set_predicate_table_3_p_0(PredTable_78, STATE_VARIABLE_ModuleInfo_109_109, &STATE_VARIABLE_ModuleInfo_128_128);
      hlds__hlds_module__module_info_get_type_spec_info_2_p_0(STATE_VARIABLE_ModuleInfo_128_128, &TypeSpecInfo0_79);
      ProcsToSpec0_80 = ((MR_Word) ((MR_hl_field(MR_mktag(0), TypeSpecInfo0_79, (MR_Integer) 0))));
      ForceVersions0_81 = ((MR_Word) ((MR_hl_field(MR_mktag(0), TypeSpecInfo0_79, (MR_Integer) 1))));
      SpecMap0_82 = ((MR_Word) ((MR_hl_field(MR_mktag(0), TypeSpecInfo0_79, (MR_Integer) 2))));
      PragmaMap0_83 = ((MR_Word) ((MR_hl_field(MR_mktag(0), TypeSpecInfo0_79, (MR_Integer) 3))));
      {
      ...
      mercury__list__map_3_p_0((MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_proc_id_0), (MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_proc_id_0), Var_129, ProcIds_44, &PredProcIds_86);
      mercury__set__insert_list_3_p_0((MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_proc_id_0), PredProcIds_86, ProcsToSpec0_80, &ProcsToSpec_87);
      mercury__set__insert_3_p_0((MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_id_0), ((MR_Box) (NewPredId_77)), ForceVersions0_81, &ForceVersions_88);
      Var_132 = (MR_Word) (PredStatus_67);
      succeeded = (Var_132 == (MR_Word) ((MR_Unsigned) 0U));
      if (succeeded)
        mercury__multi_map__set_4_p_0((MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_id_0), (MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_id_0), ((MR_Box) (PredId_16)), ((MR_Box) (NewPredId_77)), SpecMap0_82, &SpecMap_89);
      else
        SpecMap_89 = SpecMap0_82;
      if ((MaybeModes_14 == (MR_Word) ((MR_Unsigned) 0U)))
        {
          ModesOrArity_90 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), ModesOrArity_90, 0) = ((MR_Box) (UserArity_13));
        }
      else
      {
        MR_Word Modes_91 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MaybeModes_14, (MR_Integer) 0))));

        {
          ModesOrArity_90 = (MR_Word) MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), ModesOrArity_90, 0) = ((MR_Box) (Modes_91));
        }
      }
      switch (PredOrFunc_45) {
        ...
        case (MR_Integer) 1:
          {
            PFUMM_92 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), PFUMM_92, 0) = ((MR_Box) (ModesOrArity_90));
          }
          break;
        case (MR_Integer) 0:
          {
            PFUMM_92 = (MR_Word) MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL);
            MR_hl_field(MR_mktag(0), PFUMM_92, 0) = ((MR_Box) (ModesOrArity_90));
          }
          break;
      }
      ...
      {
        TSInfo_93 = (MR_Word) MR_new_object(MR_Word, (6 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), TSInfo_93, 0) = ((MR_Box) (PFUMM_92));
        MR_hl_field(MR_mktag(0), TSInfo_93, 1) = ((MR_Box) (SymName_21));
        MR_hl_field(MR_mktag(0), TSInfo_93, 2) = ((MR_Box) (SpecSymName_22));
        MR_hl_field(MR_mktag(0), TSInfo_93, 3) = ((MR_Box) (Var_133));
        MR_hl_field(MR_mktag(0), TSInfo_93, 4) = ((MR_Box) (TVarSet_30));
        MR_hl_field(MR_mktag(0), TSInfo_93, 5) = ((MR_Box) (ExpandedItems_25));
      }
      mercury__multi_map__set_4_p_0((MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_id_0), (MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_pragma_info_type_spec_0), ((MR_Box) (PredId_16)), ((MR_Box) (TSInfo_93)), PragmaMap0_83, &PragmaMap_94);
      {
        TypeSpecInfo_95 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), TypeSpecInfo_95, 0) = ((MR_Box) (ProcsToSpec_87));
        MR_hl_field(MR_mktag(0), TypeSpecInfo_95, 1) = ((MR_Box) (ForceVersions_88));
        MR_hl_field(MR_mktag(0), TypeSpecInfo_95, 2) = ((MR_Box) (SpecMap_89));
        MR_hl_field(MR_mktag(0), TypeSpecInfo_95, 3) = ((MR_Box) (PragmaMap_94));
      }
      hlds__hlds_module__module_info_set_type_spec_info_3_p_0(TypeSpecInfo_95, STATE_VARIABLE_ModuleInfo_128_128, STATE_VARIABLE_ModuleInfo_100);
      IsImported_96 = hlds__status__pred_status_is_imported_1_f_0(PredStatus_67);
      switch (IsImported_96) {
        default: /*NOTREACHED*/ MR_assert(0);
        case (MR_Integer) 0:
          *STATE_VARIABLE_QualInfo_102 = STATE_VARIABLE_QualInfo_0_101;
          break;
        case (MR_Integer) 1:
          {
            MR_Word ItemType_97;
            MR_Integer UserArityInt_98;
            MR_Word Var_135;
            MR_Word Var_137;
            MR_Word Var_138;

            ItemType_97 = recompilation__pred_or_func_to_item_type_1_f_0(PredOrFunc_45);
            UserArityInt_98 = (MR_Integer) (UserArity_13);
            {
              Var_138 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
              MR_hl_field(MR_mktag(0), Var_138, 0) = ((MR_Box) (SymName_21));
              MR_hl_field(MR_mktag(0), Var_138, 1) = ((MR_Box) (UserArityInt_98));
            }
            {
              Var_137 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
              MR_hl_field(MR_mktag(0), Var_137, 0) = (MR_Box) ((MR_Unsigned) (ItemType_97));
            ...
            hlds__make_hlds__qual_info__apply_to_recompilation_info_3_p_0(Var_135, STATE_VARIABLE_QualInfo_0_101, STATE_VARIABLE_QualInfo_102);
          }
          break;
      }
    }
    ...
    {
      *STATE_VARIABLE_QualInfo_102 = STATE_VARIABLE_QualInfo_0_101;
      *STATE_VARIABLE_ModuleInfo_100 = STATE_VARIABLE_ModuleInfo_109_109;
    }
  }
}
  ...
  MR_Word * STATE_VARIABLE_Specs_31)
{
  ...
  if ((MaybeModes_15 == (MR_Word) ((MR_Unsigned) 0U)))
  {
    ...
    mercury__map__keys_2_p_0((MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_proc_id_0), (MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_proc_info_0), STATE_VARIABLE_Procs_0_26, &ProcIds_42);
    {
      MR_Word base;
  ...
  MR_Box * wrapper_arg_3)
{
  ...
  hlds__make_hlds__add_pragma__add_pragma_type_spec__IntroducedFrom__pred__handle_pragma_type_spec_subst__377__1_3_p_0(((MR_Word) (wrapper_arg_1)), ((MR_Word) (wrapper_arg_2)), &conv0_HeadVar__3_97);
  ...
  MR_Box wrapper_arg_1)
{
  ...
  succeeded = hlds__make_hlds__add_pragma__add_pragma_type_spec__IntroducedFrom__pred__handle_pragma_type_spec_subst__366__1_2_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) (wrapper_arg_1)));
  return succeeded;
}
  ...
  MR_Box wrapper_arg_1)
{
  ...
  succeeded = hlds__make_hlds__add_pragma__add_pragma_type_spec__IntroducedFrom__pred__handle_pragma_type_spec_subst__335__1_3_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))), ((MR_Word) (wrapper_arg_1)));
  return succeeded;
}
...
{
  MR_Box closure = closure_arg;
  MR_Word conv3_STATE_VARIABLE_ModuleInfo_100;
  MR_Word conv2_STATE_VARIABLE_QualInfo_102;
  MR_Word conv1_STATE_VARIABLE_Specs_104;

  hlds__make_hlds__add_pragma__add_pragma_type_spec__add_pragma_type_spec_for_pred_11_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 5)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 6)))), ((MR_Word) (wrapper_arg_1)), ((MR_Word) (wrapper_arg_2)), &conv3_STATE_VARIABLE_ModuleInfo_100, ((MR_Word) (wrapper_arg_4)), &conv2_STATE_VARIABLE_QualInfo_102, ((MR_Word) (wrapper_arg_6)), &conv1_STATE_VARIABLE_Specs_104);
  *wrapper_arg_3 = ((MR_Box) (conv3_STATE_VARIABLE_ModuleInfo_100));
  *wrapper_arg_5 = ((MR_Box) (conv2_STATE_VARIABLE_QualInfo_102));
  *wrapper_arg_7 = ((MR_Box) (conv1_STATE_VARIABLE_Specs_104));
}
  ...
  MR_Word * STATE_VARIABLE_Specs_41)
{
  ...
  switch (MR_tag((MR_Word) PFUMM_14)) {
    ...
    case (MR_Integer) 0:
      {
        MR_Word ModesOrArity_87 = ((MR_Word) ((MR_hl_field(MR_mktag(0), PFUMM_14, (MR_Integer) 0))));
        MR_Integer PredArityInt_90;

        MaybePredOrFunc_23 = (MR_Word) (MR_mkword(MR_mktag(1), &hlds__make_hlds__add_pragma__add_pragma_type_spec_scalar_common_3[1]));
        if (((MR_tag((MR_Word) ModesOrArity_87)) == (MR_Integer) 1))
        {
          MR_Word Var_79;

          UserArity_26 = ((MR_Word) ((MR_hl_field(MR_mktag(1), ModesOrArity_87, (MR_Integer) 0))));
          parse_tree__prog_util__user_arity_pred_form_arity_3_p_0((MR_Integer) 0, UserArity_26, &Var_79);
          PredArityInt_90 = (MR_Integer) (Var_79);
          MaybeModes_27 = (MR_Word) ((MR_Unsigned) 0U);
        }
        else
        {
          MR_Word Modes_80 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ModesOrArity_87, (MR_Integer) 0))));
          MR_Word Var_81;

          mercury__list__length_2_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_mode_0), Modes_80, &PredArityInt_90);
          Var_81 = (MR_Word) (PredArityInt_90);
          parse_tree__prog_util__user_arity_pred_form_arity_3_p_1((MR_Integer) 0, &UserArity_26, Var_81);
          {
            MaybeModes_27 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), MaybeModes_27, 0) = ((MR_Box) (Modes_80));
          }
        }
        hlds__pred_table__predicate_table_lookup_pf_sym_arity_6_p_0(PredTable_20, (MR_Integer) 0, (MR_Integer) 0, SymName_15, PredArityInt_90, &PredIds_28);
    ...
    case (MR_Integer) 1:
      {
        ...
        if (((MR_tag((MR_Word) ModesOrArity_21)) == (MR_Integer) 1))
        {
          ...
          parse_tree__prog_util__user_arity_pred_form_arity_3_p_0((MR_Integer) 1, UserArity_26, &Var_46);
          PredArityInt_25 = (MR_Integer) (Var_46);
          MaybeModes_27 = (MR_Word) ((MR_Unsigned) 0U);
        }
        else
        {
          ...
          Var_47 = (MR_Word) (PredArityInt_25);
          parse_tree__prog_util__user_arity_pred_form_arity_3_p_1((MR_Integer) 1, &UserArity_26, Var_47);
          {
            MaybeModes_27 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), MaybeModes_27, 0) = ((MR_Box) (Modes_24));
          }
        }
        hlds__pred_table__predicate_table_lookup_pf_sym_arity_6_p_0(PredTable_20, (MR_Integer) 0, (MR_Integer) 1, SymName_15, PredArityInt_25, &PredIds_28);
    ...
    case (MR_Integer) 2:
      {
        ...
        MaybeModes_27 = (MR_Word) ((MR_Unsigned) 0U);
        hlds__pred_table__predicate_table_lookup_sym_arity_5_p_0(PredTable_20, (MR_Integer) 0, SymName_15, UserArityInt_30, &PredIds_28);
