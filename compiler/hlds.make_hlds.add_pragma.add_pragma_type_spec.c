  ...
  MR_Word * STATE_VARIABLE_Specs_105)
{
  ...
  else
  {
    ...
    hlds__make_hlds__add_pragma__add_pragma_type_spec__handle_pragma_type_spec_modes_11_p_0(SymName_21, UserArity_13, Context_15, MaybeModes_14, &MaybeProcIds_37, Procs0_36, &Procs1_38, STATE_VARIABLE_ModuleInfo_108_108, &STATE_VARIABLE_ModuleInfo_110_110, STATE_VARIABLE_Specs_109_109, STATE_VARIABLE_Specs_105);
    ...
    if (succeeded)
    {
      ...
      parse_tree__prog_util__user_arity_pred_form_arity_3_p_0(PredOrFunc_45, UserArity_13, &PredFormArity_47);
      PredFormArityInt_48 = (MR_Integer) (PredFormArity_47);
      parse_tree__prog_util__make_n_fresh_vars_5_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), (MR_String) "HeadVar__", PredFormArityInt_48, &ArgVars_49, ArgVarSet0_46, &ArgVarSet_50);
      ...
      hlds__make_hlds__qual_info__construct_pred_or_func_call_6_p_0(PredId_16, PredOrFunc_45, SymName_21, ArgVars_49, GoalInfo_55, &Goal_56);
      {
      ...
      ArgsVec_59 = hlds__hlds_args__proc_arg_vector_init_2_f_0((MR_Word) (&hlds__make_hlds__add_pragma__add_pragma_type_spec_scalar_common_1[2]), PredOrFunc_45, ArgVars_49);
      {
      ...
      {
        MR_Word Modes_92 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MaybeModes_14, (MR_Integer) 0))));

        {
          ModesOrArity_91 = (MR_Word) MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), ModesOrArity_91, 0) = ((MR_Box) (Modes_92));
        }
      }
        ...
        case (MR_Integer) 1:
          {
            ...
            ItemType_98 = recompilation__pred_or_func_to_item_type_1_f_0(PredOrFunc_45);
