...
static void MR_CALL 
hlds__make_hlds__add_pragma__add_pragma_type_spec__IntroducedFrom__pred__handle_pragma_type_spec_subst__322__1_3_p_0(
  MR_Word HeadVar__1_95,
  MR_Word HeadVar__2_96,
  MR_Word * HeadVar__3_97);

static MR_bool MR_CALL 
hlds__make_hlds__add_pragma__add_pragma_type_spec__IntroducedFrom__pred__handle_pragma_type_spec_subst__312__1_2_p_0(
  MR_Word ExistQVars_20,
  MR_Word LambdaHeadVar__1_75);

static MR_bool MR_CALL 
hlds__make_hlds__add_pragma__add_pragma_type_spec__IntroducedFrom__pred__handle_pragma_type_spec_subst__281__1_3_p_0(
  MR_Word TVarSet0_17,
  MR_Word NameVarIndex0_33,
  MR_Word LambdaHeadVar__1_67);

static void MR_CALL 
hlds__make_hlds__add_pragma__add_pragma_type_spec__IntroducedFrom__pred__add_pragma_type_spec_for_pred__199__1_3_p_0(
  MR_Word PredId_12,
...
{
  {
    ...
    hlds__make_hlds__add_pragma__add_pragma_type_spec__IntroducedFrom__pred__add_pragma_type_spec_for_pred__199__1_3_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Integer) (wrapper_arg_1)), &conv2_LambdaHeadVar__2_119);
...
{
  {
    ...
    hlds__hlds_module__module_info_pred_info_3_p_0(STATE_VARIABLE_ModuleInfo_0_90, PredId_12, &PredInfo0_24);
    hlds__make_hlds__add_pragma__add_pragma_type_spec__handle_pragma_type_spec_subst_13_p_0(Context_11, Subst_21, PredInfo0_24, TVarSet0_22, &TVarSet_25, &Types_26, &ExistQVars_27, &ClassContext_28, &SubstOk_29, STATE_VARIABLE_ModuleInfo_0_90, &STATE_VARIABLE_ModuleInfo_96_96, STATE_VARIABLE_Specs_0_94, &STATE_VARIABLE_Specs_97_97);
    if ((SubstOk_29 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      *STATE_VARIABLE_ModuleInfo_91 = STATE_VARIABLE_ModuleInfo_96_96;
      *STATE_VARIABLE_QualInfo_93 = STATE_VARIABLE_QualInfo_0_92;
      *STATE_VARIABLE_Specs_95 = STATE_VARIABLE_Specs_97_97;
    }
    else
    {
      ...
      MR_Word Globals_35;
      MR_Word OptTuple_36;
      MR_Word DoTypeSpec_37;
      MR_Word Smart_38;
      MR_Word STATE_VARIABLE_ModuleInfo_98_98;
      MR_Word ProcIds_39;

      hlds__hlds_pred__pred_info_get_proc_table_2_p_0(PredInfo0_24, &Procs0_31);
      hlds__make_hlds__add_pragma__add_pragma_type_spec__handle_pragma_type_spec_modes_11_p_0(SymName_16, Arity_18, Context_11, MaybeModes_20, &MaybeProcIds_32, Procs0_31, &Procs1_33, STATE_VARIABLE_ModuleInfo_96_96, &STATE_VARIABLE_ModuleInfo_98_98, STATE_VARIABLE_Specs_97_97, STATE_VARIABLE_Specs_95);
      ...
      hlds__hlds_module__module_info_get_globals_2_p_0(STATE_VARIABLE_ModuleInfo_98_98, &Globals_35);
      libs__globals__get_opt_tuple_2_p_0(Globals_35, &OptTuple_36);
      DoTypeSpec_37 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), OptTuple_36, (MR_Integer) 0))) >> 2)) & (MR_Integer) 1);
      libs__globals__lookup_bool_option_3_p_0(Globals_35, (MR_Integer) 140, &Smart_38);
      succeeded = (MaybeProcIds_32 != (MR_Word) ((MR_Unsigned) 0U));
      if (succeeded)
      {
        ProcIds_39 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MaybeProcIds_32, (MR_Integer) 0))));
        succeeded = (DoTypeSpec_37 == (MR_Integer) 0);
        if (!(succeeded))
        {
          succeeded = hlds__hlds_pred__pred_info_is_imported_1_p_0(PredInfo0_24);
          succeeded = !(succeeded);
          if (!(succeeded))
            succeeded = (Smart_38 == (MR_Integer) 1);
        }
      }
      if (succeeded)
      {
        ...
        MR_Word ArgVarSet0_42;
        MR_Word Args_43;
        MR_Word ArgVarSet_44;
        ...
        MR_Word OrigOrigin_64;
        MR_Word SubstDesc_65;
        MR_Word Origin_66;
        MR_Word VarNameRemap_68;
        MR_Word NewPredInfo0_69;
        MR_Word NewPredInfo_70;
        MR_Word PredTable0_71;
        MR_Word NewPredId_72;
        MR_Word PredTable_73;
        MR_Word TypeSpecInfo0_74;
        MR_Word ProcsToSpec0_75;
        MR_Word ForceVersions0_76;
        MR_Word SpecMap0_77;
        MR_Word PragmaMap0_78;
        MR_Word PredProcIds_81;
        MR_Word ProcsToSpec_82;
        MR_Word ForceVersions_83;
        MR_Word SpecMap_84;
        MR_Word TSInfo_85;
        MR_Word PragmaMap_86;
        MR_Word TypeSpecInfo_87;
        MR_Word IsImported_88;
        MR_Word Var_103;
        MR_Word Var_106;
        MR_Word Var_114;
        ...
        PredOrFunc_40 = hlds__hlds_pred__pred_info_is_pred_or_func_1_f_0(PredInfo0_24);
        parse_tree__prog_util__adjust_func_arity_3_p_0(PredOrFunc_40, Arity_18, &PredArity_41);
        mercury__varset__init_1_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), &ArgVarSet0_42);
        parse_tree__prog_util__make_n_fresh_vars_5_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), (MR_String) "HeadVar__", PredArity_41, &Args_43, ArgVarSet0_42, &ArgVarSet_44);
        hlds__vartypes__init_vartypes_1_p_0(&VarTypes0_45);
        hlds__hlds_goal__goal_info_init_1_p_0(&GoalInfo0_46);
        parse_tree__set_of_var__list_to_set_2_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), Args_43, &NonLocals_47);
        hlds__hlds_goal__goal_info_set_nonlocals_3_p_0(NonLocals_47, GoalInfo0_46, &GoalInfo1_48);
        hlds__hlds_goal__goal_info_set_context_3_p_0(Context_11, GoalInfo1_48, &GoalInfo_49);
        hlds__make_hlds__qual_info__do_construct_pred_or_func_call_6_p_0(PredId_12, PredOrFunc_40, SymName_16, Args_43, GoalInfo_49, &Goal_50);
        {
          Var_103 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), Var_103, 0) = ((MR_Box) (ProcIds_39));
        }
        {
          Clause_51 = (MR_Word) MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), Clause_51, 0) = ((MR_Box) (Var_103));
          MR_hl_field(MR_mktag(0), Clause_51, 1) = ((MR_Box) (Goal_50));
          MR_hl_field(MR_mktag(0), Clause_51, 2) = ((MR_Box) ((MR_Unsigned) 0U));
          MR_hl_field(MR_mktag(0), Clause_51, 3) = ((MR_Box) (Context_11));
          MR_hl_field(MR_mktag(0), Clause_51, 4) = ((MR_Box) ((MR_Unsigned) 0U));
        }
        mercury__map__init_1_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&hlds__make_hlds__add_pragma__add_pragma_type_spec_scalar_common_1[1]), &TVarNameMap_52);
        ArgsVec_53 = hlds__hlds_args__proc_arg_vector_init_2_f_0((MR_Word) (&hlds__make_hlds__add_pragma__add_pragma_type_spec_scalar_common_1[2]), PredOrFunc_40, Args_43);
        {
          Var_106 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), Var_106, 0) = ((MR_Box) (Clause_51));
          MR_hl_field(MR_mktag(1), Var_106, 1) = ((MR_Box) ((MR_Unsigned) 0U));
        }
        hlds__hlds_clauses__set_clause_list_2_p_0(Var_106, &ClausesRep_54);
        ItemNumbers_55 = hlds__hlds_clauses__init_clause_item_numbers_comp_gen_0_f_0();
        hlds__hlds_rtti__rtti_varmaps_init_1_p_0(&RttiVarMaps_56);
        {
          Clauses_57 = (MR_Word) MR_new_object(MR_Word, (9 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), Clauses_57, 0) = ((MR_Box) (ArgVarSet_44));
          MR_hl_field(MR_mktag(0), Clauses_57, 1) = ((MR_Box) (TVarNameMap_52));
          MR_hl_field(MR_mktag(0), Clauses_57, 2) = ((MR_Box) (VarTypes0_45));
          MR_hl_field(MR_mktag(0), Clauses_57, 3) = ((MR_Box) (VarTypes0_45));
          MR_hl_field(MR_mktag(0), Clauses_57, 4) = ((MR_Box) (ArgsVec_53));
          MR_hl_field(MR_mktag(0), Clauses_57, 5) = ((MR_Box) (ClausesRep_54));
          MR_hl_field(MR_mktag(0), Clauses_57, 6) = ((MR_Box) (ItemNumbers_55));
          MR_hl_field(MR_mktag(0), Clauses_57, 7) = ((MR_Box) (RttiVarMaps_56));
          MR_hl_field(MR_mktag(0), Clauses_57, 8) = (MR_Box) (((((MR_Unsigned) ((MR_Integer) 0) << 1)) | (MR_Unsigned) ((MR_Integer) 0)));
        }
        hlds__hlds_pred__pred_info_get_markers_2_p_0(PredInfo0_24, &Markers0_58);
        hlds__hlds_pred__add_marker_3_p_0((MR_Integer) 21, Markers0_58, &Markers_59);
        mercury__map__init_1_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_constraint_0), (MR_Word) (&hlds__hlds_class__hlds__hlds_class__type_ctor_info_constraint_proof_0), &Proofs_60);
        mercury__map__init_1_p_0((MR_Word) (&hlds__hlds_class__hlds__hlds_class__type_ctor_info_constraint_id_0), (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_constraint_0), &ConstraintMap_61);
        succeeded = hlds__hlds_pred__pred_info_is_imported_1_p_0(PredInfo0_24);
        if (succeeded)
          PredStatus_62 = (MR_Word) (((MR_Box) ((MR_Unsigned) 0U)));
        else
          hlds__hlds_pred__pred_info_get_status_2_p_0(PredInfo0_24, &PredStatus_62);
        ModuleName_63 = hlds__hlds_pred__pred_info_module_1_f_0(PredInfo0_24);
        hlds__hlds_pred__pred_info_get_origin_2_p_0(PredInfo0_24, &OrigOrigin_64);
        SubstDesc_65 = mercury__list__map_2_f_0((MR_Word) (&hlds__make_hlds__add_pragma__add_pragma_type_spec_scalar_common_2[0]), (MR_Word) (&hlds__make_hlds__add_pragma__add_pragma_type_spec_scalar_common_2[1]), (MR_Word) (&hlds__make_hlds__add_pragma__add_pragma_type_spec_scalar_common_2[5]), Subst_21);
        {
          ...
          MR_hl_field(MR_mktag(3), Var_114, 1) = ((MR_Box) (SubstDesc_65));
        }
        {
          Origin_66 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(3), Origin_66, 0) = ((MR_Box) ((MR_Unsigned) 1U));
          MR_hl_field(MR_mktag(3), Origin_66, 1) = ((MR_Box) (Var_114));
          MR_hl_field(MR_mktag(3), Origin_66, 2) = ((MR_Box) (OrigOrigin_64));
          MR_hl_field(MR_mktag(3), Origin_66, 3) = ((MR_Box) (PredId_12));
        }
        hlds__hlds_pred__pred_info_get_var_name_remap_2_p_0(PredInfo0_24, &VarNameRemap_68);
        hlds__hlds_pred__pred_info_init_19_p_0(ModuleName_63, SpecName_17, PredArity_41, PredOrFunc_40, Context_11, Origin_66, PredStatus_62, (MR_Word) ((MR_Unsigned) 0U), (MR_Word) ((MR_Unsigned) 12U), Markers_59, Types_26, TVarSet_25, ExistQVars_27, ClassContext_28, Proofs_60, ConstraintMap_61, Clauses_57, VarNameRemap_68, &NewPredInfo0_69);
        hlds__hlds_pred__pred_info_set_proc_table_3_p_0(Procs_34, NewPredInfo0_69, &NewPredInfo_70);
        hlds__hlds_module__module_info_get_predicate_table_2_p_0(STATE_VARIABLE_ModuleInfo_98_98, &PredTable0_71);
        hlds__pred_table__predicate_table_insert_4_p_0(NewPredInfo_70, &NewPredId_72, PredTable0_71, &PredTable_73);
        hlds__hlds_module__module_info_set_predicate_table_3_p_0(PredTable_73, STATE_VARIABLE_ModuleInfo_98_98, &STATE_VARIABLE_ModuleInfo_116_116);
        hlds__hlds_module__module_info_get_type_spec_info_2_p_0(STATE_VARIABLE_ModuleInfo_116_116, &TypeSpecInfo0_74);
        ProcsToSpec0_75 = ((MR_Word) ((MR_hl_field(MR_mktag(0), TypeSpecInfo0_74, (MR_Integer) 0))));
        ForceVersions0_76 = ((MR_Word) ((MR_hl_field(MR_mktag(0), TypeSpecInfo0_74, (MR_Integer) 1))));
        SpecMap0_77 = ((MR_Word) ((MR_hl_field(MR_mktag(0), TypeSpecInfo0_74, (MR_Integer) 2))));
        PragmaMap0_78 = ((MR_Word) ((MR_hl_field(MR_mktag(0), TypeSpecInfo0_74, (MR_Integer) 3))));
        {
        ...
        mercury__list__map_3_p_0((MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_proc_id_0), (MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_proc_id_0), Var_117, ProcIds_39, &PredProcIds_81);
        mercury__set__insert_list_3_p_0((MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_proc_id_0), PredProcIds_81, ProcsToSpec0_75, &ProcsToSpec_82);
        mercury__set__insert_3_p_0((MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_id_0), ((MR_Box) (NewPredId_72)), ForceVersions0_76, &ForceVersions_83);
        Var_120 = (MR_Word) (PredStatus_62);
        succeeded = (Var_120 == (MR_Word) ((MR_Unsigned) 0U));
        if (succeeded)
          mercury__multi_map__set_4_p_0((MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_id_0), (MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_id_0), ((MR_Box) (PredId_12)), ((MR_Box) (NewPredId_72)), SpecMap0_77, &SpecMap_84);
        else
          SpecMap_84 = SpecMap0_77;
        {
          Var_121 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), Var_121, 0) = ((MR_Box) (PredOrFunc_40));
        }
        ...
        {
          TSInfo_85 = (MR_Word) MR_new_object(MR_Word, (8 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), TSInfo_85, 0) = ((MR_Box) (SymName_16));
          MR_hl_field(MR_mktag(0), TSInfo_85, 1) = ((MR_Box) (SpecName_17));
          MR_hl_field(MR_mktag(0), TSInfo_85, 2) = ((MR_Box) (Arity_18));
          MR_hl_field(MR_mktag(0), TSInfo_85, 3) = ((MR_Box) (Var_121));
          MR_hl_field(MR_mktag(0), TSInfo_85, 4) = ((MR_Box) (MaybeModes_20));
          MR_hl_field(MR_mktag(0), TSInfo_85, 5) = ((MR_Box) (Var_122));
          MR_hl_field(MR_mktag(0), TSInfo_85, 6) = ((MR_Box) (TVarSet_25));
          MR_hl_field(MR_mktag(0), TSInfo_85, 7) = ((MR_Box) (ExpandedItems_23));
        }
        mercury__multi_map__set_4_p_0((MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_id_0), (MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_pragma_info_type_spec_0), ((MR_Box) (PredId_12)), ((MR_Box) (TSInfo_85)), PragmaMap0_78, &PragmaMap_86);
        {
          TypeSpecInfo_87 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), TypeSpecInfo_87, 0) = ((MR_Box) (ProcsToSpec_82));
          MR_hl_field(MR_mktag(0), TypeSpecInfo_87, 1) = ((MR_Box) (ForceVersions_83));
          MR_hl_field(MR_mktag(0), TypeSpecInfo_87, 2) = ((MR_Box) (SpecMap_84));
          MR_hl_field(MR_mktag(0), TypeSpecInfo_87, 3) = ((MR_Box) (PragmaMap_86));
        }
        hlds__hlds_module__module_info_set_type_spec_info_3_p_0(TypeSpecInfo_87, STATE_VARIABLE_ModuleInfo_116_116, STATE_VARIABLE_ModuleInfo_91);
        IsImported_88 = hlds__status__pred_status_is_imported_1_f_0(PredStatus_62);
        switch (IsImported_88) {
          ...
          case (MR_Integer) 1:
            {
              ...
              ItemType_89 = recompilation__pred_or_func_to_item_type_1_f_0(PredOrFunc_40);
              {
              ...
              }
              {
                ...
                MR_hl_field(MR_mktag(0), Var_126, 0) = (MR_Box) ((MR_Unsigned) (ItemType_89));
              ...
              hlds__make_hlds__qual_info__apply_to_recompilation_info_3_p_0(Var_124, STATE_VARIABLE_QualInfo_0_92, STATE_VARIABLE_QualInfo_93);
            }
            break;
        }
      }
      ...
      {
        *STATE_VARIABLE_QualInfo_93 = STATE_VARIABLE_QualInfo_0_92;
        *STATE_VARIABLE_ModuleInfo_91 = STATE_VARIABLE_ModuleInfo_98_98;
      }
    }
  }
}
...
{
  {
    ...
    hlds__make_hlds__add_pragma__add_pragma_type_spec__IntroducedFrom__pred__handle_pragma_type_spec_subst__322__1_3_p_0(((MR_Word) (wrapper_arg_1)), ((MR_Word) (wrapper_arg_2)), &conv0_HeadVar__3_97);
...
{
  {
    ...
    succeeded = hlds__make_hlds__add_pragma__add_pragma_type_spec__IntroducedFrom__pred__handle_pragma_type_spec_subst__312__1_2_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) (wrapper_arg_1)));
    return succeeded;
  }
}
...
{
  {
    ...
    succeeded = hlds__make_hlds__add_pragma__add_pragma_type_spec__IntroducedFrom__pred__handle_pragma_type_spec_subst__281__1_3_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))), ((MR_Word) (wrapper_arg_1)));
    return succeeded;
  }
}
...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), Var_63, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &hlds__make_hlds__add_pragma__add_pragma_type_spec_scalar_common_1[13])));
    }
    {
      Var_60 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), Var_60, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__add_pragma__add_pragma_type_spec_scalar_common_1[16])));
      MR_hl_field(MR_mktag(1), Var_60, 1) = ((MR_Box) (Var_63));
    }
    {
      Var_57 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), Var_57, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__add_pragma__add_pragma_type_spec_scalar_common_1[15])));
...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), Var_51, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &hlds__make_hlds__add_pragma__add_pragma_type_spec_scalar_common_1[13])));
    }
    {
      Var_48 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), Var_48, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__add_pragma__add_pragma_type_spec_scalar_common_1[16])));
      MR_hl_field(MR_mktag(1), Var_48, 1) = ((MR_Box) (Var_51));
    }
    {
      Var_45 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), Var_45, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__add_pragma__add_pragma_type_spec_scalar_common_1[15])));
  ...
  MR_Box * wrapper_arg_7)
{
  {
    MR_Box closure = closure_arg;
    MR_Word conv2_STATE_VARIABLE_ModuleInfo_91;
    MR_Word conv1_STATE_VARIABLE_QualInfo_93;
    MR_Word conv0_STATE_VARIABLE_Specs_95;

    hlds__make_hlds__add_pragma__add_pragma_type_spec__add_pragma_type_spec_for_pred_9_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))), ((MR_Word) (wrapper_arg_1)), ((MR_Word) (wrapper_arg_2)), &conv2_STATE_VARIABLE_ModuleInfo_91, ((MR_Word) (wrapper_arg_4)), &conv1_STATE_VARIABLE_QualInfo_93, ((MR_Word) (wrapper_arg_6)), &conv0_STATE_VARIABLE_Specs_95);
    *wrapper_arg_3 = ((MR_Box) (conv2_STATE_VARIABLE_ModuleInfo_91));
    *wrapper_arg_5 = ((MR_Box) (conv1_STATE_VARIABLE_QualInfo_93));
    *wrapper_arg_7 = ((MR_Box) (conv0_STATE_VARIABLE_Specs_95));
  }
}
