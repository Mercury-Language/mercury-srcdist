...
{
  {
    ...
    if (succeeded)
    {
      ...
      succeeded = ((((MR_tag((MR_Word) TypeBody_9)) == (MR_mktag((MR_Integer) 3)))) && (((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), TypeBody_9, (MR_Integer) 0)))) == (MR_Integer) 1)));
      if (succeeded)
        Var_10 = ((MR_Word) (MR_hl_field(MR_mktag(3), TypeBody_9, (MR_Integer) 1)));
    }
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          succeeded = ((MR_tag((MR_Word) ModuleName_14)) == (MR_mktag((MR_Integer) 0)));
          if (succeeded)
          {
      ...
      if (succeeded)
      {
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(0), Msg_17, 0) = ((MR_Box) (TypeContext_15));
...
{
  {
    ...
    hlds__hlds_data__foldl_over_type_ctor_defns_4_p_0((MR_Word) &check_hlds__check_for_missing_type_defns_scalar_common_1[0], (MR_Word) &check_hlds__check_for_missing_type_defns_scalar_common_3[0], TypeTable_5, ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))), &conv1_Specs_4);
