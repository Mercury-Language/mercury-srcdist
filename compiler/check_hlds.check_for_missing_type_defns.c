...
static /* final */ const MR_Box check_hlds__check_for_missing_type_defns_scalar_common_1[5][2] = {
  ...
  /* row   4 */
  {
    ((MR_Box) (MR_mkword(MR_mktag(3), &check_hlds__check_for_missing_type_defns_scalar_common_1[3]))),
    ((MR_Box) (MR_mkword(MR_mktag(1), &check_hlds__check_for_missing_type_defns_scalar_common_1[2])))
  },
};
  ...
  if (succeeded)
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          Var_21 = ((MR_String) ((MR_hl_field(MR_mktag(0), ModuleName_14, (MR_Integer) 0))));
          succeeded = (strcmp(Var_21, (MR_String) "type_desc") == 0);
        }
        succeeded = !(succeeded);
        if (succeeded)
        {
          TypeCtorInfo__38_38 = (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_type_ctor_0);
          succeeded = mercury__list__member_2_p_0(TypeCtorInfo__38_38, ((MR_Box) (TypeCtor_5)), BuiltinTypeCtors_13);
          succeeded = !(succeeded);
          if (succeeded)
          {
            Var_22 = (MR_Integer) 0;
            hlds__hlds_data__get_type_defn_prev_errors_2_p_0(TypeDefn_6, &Var_39);
    ...
    if (succeeded)
    {
      ...
      hlds__hlds_data__get_type_defn_context_2_p_0(TypeDefn_6, &TypeContext_15);
      {
        ...
        MR_hl_field(MR_mktag(0), Var_27, 0) = ((MR_Box) (SymName_11));
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(1), Var_25, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &check_hlds__check_for_missing_type_defns_scalar_common_1[4])));
      }
      {
        Pieces_16 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), Pieces_16, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &check_hlds__check_for_missing_type_defns_scalar_common_1[1])));
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(1), Spec_17, 0) = ((MR_Box) ((MR_String) "predicate \140check_hlds.check_for_missing_type_defns.check_for_missing_type_defns_in_type\'/4"));
        MR_hl_field(MR_mktag(1), Spec_17, 1) = ((MR_Box) ((MR_Unsigned) 0U));
        MR_hl_field(MR_mktag(1), Spec_17, 2) = ((MR_Box) ((MR_Unsigned) 48U));
        MR_hl_field(MR_mktag(1), Spec_17, 3) = ((MR_Box) (TypeContext_15));
