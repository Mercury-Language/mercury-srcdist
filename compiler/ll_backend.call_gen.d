...
ll_backend.call_gen.optdate ll_backend.call_gen.trans_opt_date call_gen.err ll_backend.call_gen.c_date ll_backend.call_gen.java_date : call_gen.m \
	ll_backend.int0 \
	assoc_list.int \
	backend_libs.int \
	bool.int \
...
#   long deps
#   short deps
ll_backend.call_gen.optdate ll_backend.call_gen.trans_opt_date call_gen.err ll_backend.call_gen.c_date ll_backend.call_gen.java_date : \
		call_gen.m \
	\
		ll_backend.int0 \
	\
...
ll_backend.call_gen.pic_o ll_backend.call_gen.$O : \
	analysis.mih \
	array.mih \
	assoc_list.mih \
	backend_libs.mih \
...
ll_backend.call_gen.mh ll_backend.call_gen.mih : ll_backend.call_gen.c
...
ll_backend.call_gen.module_dep : jmercury/ll_backend__call_gen.java
else
ll_backend.call_gen.module_dep : ll_backend.call_gen.c
endif
...
ll_backend.call_gen.date ll_backend.call_gen.date0 \
	ll_backend.date : call_gen.m \
	ll_backend.int0 \
	assoc_list.int3 \
	backend_libs.int3 \
	bool.int3 \
...
#   long dep int3s
#   short dep int3s
ll_backend.call_gen.date ll_backend.call_gen.date0 ll_backend.date : \
		call_gen.m \
	\
		ll_backend.int0 \
	\
...
ll_backend.call_gen.date0 \
	ll_backend.date0 : call_gen.m \
	assoc_list.int3 \
	backend_libs.int3 \
	bool.int3 \
	builtin.int3 \
...
#   long dep int3s
#   short dep int3s
ll_backend.call_gen.date0 ll_backend.date0 : \
		call_gen.m \
	\
		assoc_list.int3 \
		backend_libs.int3 \
...
ll_backend.call_gen.int0 : ll_backend.call_gen.date0
	@:
ll_backend.call_gen.int : ll_backend.call_gen.date
	@:
ll_backend.call_gen.int2 : ll_backend.call_gen.date
	@:
ll_backend.call_gen.int3 : ll_backend.call_gen.date3
	@:
ll_backend.call_gen.opt : ll_backend.call_gen.optdate
	@:
ll_backend.call_gen.trans_opt : ll_backend.call_gen.trans_opt_date
	@:
...
ll_backend.call_gen.date0 : call_gen.m
	$(MCPI) $(ALL_GRADEFLAGS) $(ALL_MCPIFLAGS) ll_backend.call_gen
ll_backend.call_gen.date : call_gen.m
	$(MCI) $(ALL_GRADEFLAGS) $(ALL_MCIFLAGS) ll_backend.call_gen
ll_backend.call_gen.date3 : call_gen.m
	$(MCSI) $(ALL_GRADEFLAGS) $(ALL_MCSIFLAGS) ll_backend.call_gen
ll_backend.call_gen.optdate : call_gen.m
	$(MCOI) $(ALL_GRADEFLAGS) $(ALL_MCOIFLAGS) ll_backend.call_gen
ll_backend.call_gen.trans_opt_date : call_gen.m
	$(MCTOI) $(ALL_GRADEFLAGS) $(ALL_MCTOIFLAGS) ll_backend.call_gen
ll_backend.call_gen.c_date : call_gen.m
	$(MCG) $(ALL_GRADEFLAGS) $(ALL_MCGFLAGS) ll_backend.call_gen $(ERR_REDIRECT)
ll_backend.call_gen.java_date : call_gen.m
	$(MCG) $(ALL_GRADEFLAGS) $(ALL_MCGFLAGS) --java-only ll_backend.call_gen $(ERR_REDIRECT)
