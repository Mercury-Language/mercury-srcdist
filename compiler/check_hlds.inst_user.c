  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      else
      {
        ...
        MR_Word Inst0_48 = (MR_Word) (InstBody0_44);

        if ((InstParams_43 == (MR_Word) ((MR_Unsigned) 0U)))
        {
          MR_Word Inst1_51;
          MR_Word Inst_64;
          MR_Word InstBody_65;
          ...
          succeeded = ((((MR_tag((MR_Word) Inst1_51)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(MR_mktag(3), Inst1_51, (MR_Integer) 0)))) == (MR_Integer) 0)));
          if (succeeded)
          {
            if (((MR_tag((MR_Word) IFTC_45)) == (MR_Integer) 1))
            {
              InstTypeCtor_60 = ((MR_Word) ((MR_hl_field(MR_mktag(1), IFTC_45, (MR_Integer) 0))));
              succeeded = MR_TRUE;
            }
            else
            if (((MR_tag((MR_Word) IFTC_45)) == (MR_Integer) 2))
            {
          ...
          if (succeeded)
          {
            ...
            {
              Type_63 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), Type_63, 0) = ((MR_Box) (TypeCtorSymName_61));
              MR_hl_field(MR_mktag(1), Type_63, 1) = ((MR_Box) ((MR_Unsigned) 0U));
              MR_hl_field(MR_mktag(1), Type_63, 2) = ((MR_Box) ((MR_Unsigned) 0U));
            }
            check_hlds__inst_mode_type_prop__propagate_unchecked_type_into_bound_inst_4_p_0(ModuleInfo_1, Type_63, Inst1_51, &Inst_64);
          }
          else
            Inst_64 = Inst1_51;
          InstBody_65 = (MR_Word) (Inst_64);
          {
            InstDefn_66 = (MR_Word) MR_new_object(MR_Word, (6 * sizeof(MR_Word)), NULL, NULL);
        ...
        case (MR_Integer) 3:
          {
            ...
            MR_Word InstVarsA_93 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Inst0_11, (MR_Integer) 1))));
            ...
            {
              MR_Word InstVarsB_94 = ((MR_Word) ((MR_hl_field(MR_mktag(1), ContainsInstVars0_29, (MR_Integer) 0))));
              MR_Word InstVars_95;

              mercury__set__union_3_p_0((MR_Word) (&check_hlds__inst_user_scalar_common_1[0]), InstVarsA_93, InstVarsB_94, &InstVars_95);
              {
                MR_Word base;
                base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                *ContainsInstVars_17 = base;
                MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (InstVars_95));
              }
            }
            {
              MR_Word base;
              ...
              *Inst_12 = base;
              ...
              MR_hl_field(MR_mktag(3), base, 1) = ((MR_Box) (InstVarsA_93));
