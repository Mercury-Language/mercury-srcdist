    ...
    else
      {
        ...
        if ((check_hlds__inst_user__HeadVar__3_3 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
          *check_hlds__inst_user__HeadVar__1_1 = (MR_Integer) 2;
          ...
          {
            MR_Word check_hlds__inst_user__Var_7 = (MR_Word) MR_body(((MR_Word) check_hlds__inst_user__HeadVar__3_3), (MR_Integer) 1);

            {
              hlds__hlds_data____Compare____hlds_inst_defn_0_0(check_hlds__inst_user__HeadVar__1_1, check_hlds__inst_user__Var_11, check_hlds__inst_user__Var_7);
            }
          }
      }
  }
...
{
  {
    ...
    if ((check_hlds__inst_user__HeadVar__1_1 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
      ...
      {
        MR_Word check_hlds__inst_user__Var_5 = (MR_Word) MR_body(((MR_Word) check_hlds__inst_user__HeadVar__1_1), (MR_Integer) 1);
        MR_Word check_hlds__inst_user__Var_6;

        check_hlds__inst_user__succeeded = ((MR_tag((MR_Word) check_hlds__inst_user__HeadVar__2_2)) == (MR_mktag((MR_Integer) 1)));
        if (check_hlds__inst_user__succeeded)
          {
            check_hlds__inst_user__Var_6 = (MR_Word) MR_body(((MR_Word) check_hlds__inst_user__HeadVar__2_2), (MR_Integer) 1);
            {
              check_hlds__inst_user__succeeded = hlds__hlds_data____Unify____hlds_inst_defn_0_0(check_hlds__inst_user__Var_5, check_hlds__inst_user__Var_6);
            }
          }
      }
    return check_hlds__inst_user__succeeded;
