  ...
  MR_Word * STATE_VARIABLE_MaybeInstDefnsMap_6)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      MR_Word InstCtor_23 = ((MR_Word) ((MR_hl_field(MR_mktag(0), InstDefnPair_18, (MR_Integer) 0))));
      ...
      if (succeeded)
      {
        if ((MaybeUserInst_25 == (MR_Word) ((MR_Unsigned) 0U)))
          {
            STATE_VARIABLE_DelayedInstDefnPairs_30_30 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      ...
      {
        MR_Word InstVarSet_35 = ((MR_Word) ((MR_hl_field(MR_mktag(0), InstDefn_24, (MR_Integer) 0))));
        MR_Word InstParams_36 = ((MR_Word) ((MR_hl_field(MR_mktag(0), InstDefn_24, (MR_Integer) 1))));
        MR_Word InstBody0_37 = ((MR_Word) ((MR_hl_field(MR_mktag(0), InstDefn_24, (MR_Integer) 2))));
        MR_Word IFTC_38 = ((MR_Word) ((MR_hl_field(MR_mktag(0), InstDefn_24, (MR_Integer) 3))));
        MR_Word Context_39 = ((MR_Word) ((MR_hl_field(MR_mktag(0), InstDefn_24, (MR_Integer) 4))));
        MR_Word Status_40 = ((MR_Word) ((MR_hl_field(MR_mktag(0), InstDefn_24, (MR_Integer) 5))));
        MR_Word Inst0_41 = (MR_Word) (InstBody0_37);

        if ((InstParams_36 == (MR_Word) ((MR_Unsigned) 0U)))
        {
          MR_Word Inst1_44;
          MR_Word Inst_57;
          MR_Word InstBody_58;
          MR_Word InstDefn_59;
          MR_Word STATE_VARIABLE_MaybeInstDefnsMap_40_61;
          MR_Word STATE_VARIABLE_MaybeInstDefnsMap_41_62;
          MR_Word Var_67;
          MR_Word Var_45;
          MR_Word Var_46;
          MR_Word Var_47;
          MR_Word Var_48;
          MR_Word Var_49;
          MR_Word TypeCtorSymName_54;
          MR_Word InstTypeCtor_53;
          MR_Integer TypeCtorArity_55;

          mercury__map__det_insert_4_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_inst_ctor_0), (MR_Word) (&check_hlds__inst_user__check_hlds__inst_user__type_ctor_info_maybe_user_inst_0), ((MR_Box) (InstCtor_23)), ((MR_Box) ((MR_Unsigned) 0U)), STATE_VARIABLE_MaybeInstDefnsMap_0_5, &STATE_VARIABLE_MaybeInstDefnsMap_40_61);
          check_hlds__inst_user__f_85_110_117_115_101_100_65_114_103_115_95_95_112_114_101_100_95_95_112_114_101_116_101_115_116_95_105_110_115_116_95_95_91_51_93_95_48_10_p_0(Inst0_41, &Inst1_44, &Var_45, &Var_46, &Var_47, &Var_48, &Var_49, STATE_VARIABLE_MaybeInstDefnsMap_40_61, &STATE_VARIABLE_MaybeInstDefnsMap_41_62);
          succeeded = ((((MR_tag((MR_Word) Inst1_44)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(MR_mktag(3), Inst1_44, (MR_Integer) 0)))) == (MR_Integer) 0)));
          if (succeeded)
          {
            if (((MR_tag((MR_Word) IFTC_38)) == (MR_Integer) 1))
            {
              InstTypeCtor_53 = ((MR_Word) ((MR_hl_field(MR_mktag(1), IFTC_38, (MR_Integer) 0))));
              succeeded = MR_TRUE;
            }
            else
            if (((MR_tag((MR_Word) IFTC_38)) == (MR_Integer) 2))
            {
              MR_Word Var_63 = ((MR_Word) ((MR_hl_field(MR_mktag(2), IFTC_38, (MR_Integer) 0))));
              MR_Word Var_64;

              succeeded = (Var_63 != (MR_Word) ((MR_Unsigned) 0U));
              if (succeeded)
              {
                InstTypeCtor_53 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Var_63, (MR_Integer) 0))));
            ...
            if (succeeded)
            {
              TypeCtorSymName_54 = ((MR_Word) ((MR_hl_field(MR_mktag(0), InstTypeCtor_53, (MR_Integer) 0))));
              TypeCtorArity_55 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), InstTypeCtor_53, (MR_Integer) 1))));
              succeeded = (TypeCtorArity_55 == (MR_Integer) 0);
            }
          }
          if (succeeded)
          {
            ...
            {
              Type_56 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), Type_56, 0) = ((MR_Box) (TypeCtorSymName_54));
              MR_hl_field(MR_mktag(1), Type_56, 1) = ((MR_Box) ((MR_Unsigned) 0U));
              MR_hl_field(MR_mktag(1), Type_56, 2) = ((MR_Box) ((MR_Unsigned) 0U));
            }
            check_hlds__inst_mode_type_prop__propagate_unchecked_type_into_bound_inst_4_p_0(ModuleInfo_1, Type_56, Inst1_44, &Inst_57);
          }
          else
            Inst_57 = Inst1_44;
          InstBody_58 = (MR_Word) (Inst_57);
          {
            InstDefn_59 = (MR_Word) MR_new_object(MR_Word, (6 * sizeof(MR_Word)), NULL, NULL);
            MR_hl_field(MR_mktag(0), InstDefn_59, 0) = ((MR_Box) (InstVarSet_35));
            MR_hl_field(MR_mktag(0), InstDefn_59, 1) = ((MR_Box) (InstParams_36));
            MR_hl_field(MR_mktag(0), InstDefn_59, 2) = ((MR_Box) (InstBody_58));
            MR_hl_field(MR_mktag(0), InstDefn_59, 3) = ((MR_Box) (IFTC_38));
            MR_hl_field(MR_mktag(0), InstDefn_59, 4) = ((MR_Box) (Context_39));
            MR_hl_field(MR_mktag(0), InstDefn_59, 5) = ((MR_Box) (Status_40));
          }
          Var_67 = (MR_Word) (MR_mkword(MR_mktag(1), (MR_Word) (InstDefn_59)));
          mercury__map__det_update_4_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_inst_ctor_0), (MR_Word) (&check_hlds__inst_user__check_hlds__inst_user__type_ctor_info_maybe_user_inst_0), ((MR_Box) (InstCtor_23)), ((MR_Box) (Var_67)), STATE_VARIABLE_MaybeInstDefnsMap_41_62, &STATE_VARIABLE_MaybeInstDefnsMap_31_31);
        }
        else
        {
          MR_Word Var_68 = (MR_Word) (MR_mkword(MR_mktag(1), (MR_Word) (InstDefn_24)));

          mercury__map__det_insert_4_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_inst_ctor_0), (MR_Word) (&check_hlds__inst_user__check_hlds__inst_user__type_ctor_info_maybe_user_inst_0), ((MR_Box) (InstCtor_23)), ((MR_Box) (Var_68)), STATE_VARIABLE_MaybeInstDefnsMap_0_5, &STATE_VARIABLE_MaybeInstDefnsMap_31_31);
        }
        STATE_VARIABLE_DelayedInstDefnPairs_30_30 = HeadVar__3_3;
      }
      // direct tailcall eliminated
  ...
  MR_Word * STATE_VARIABLE_MaybeInstDefnsMap_15)
{
  ...
  else
  {
    ...
    {
      MR_Word InstNamesA_69 = ((MR_Word) ((MR_hl_field(MR_mktag(1), ArgContainsInstNames_48, (MR_Integer) 0))));

      if ((STATE_VARIABLE_ContainsInstNames_0_8 == (MR_Word) ((MR_Unsigned) 0U)))
        STATE_VARIABLE_ContainsInstNames_66_66 = (MR_Word) ((MR_Unsigned) 0U);
      else
      {
        MR_Word InstNamesB_70 = ((MR_Word) ((MR_hl_field(MR_mktag(1), STATE_VARIABLE_ContainsInstNames_0_8, (MR_Integer) 0))));
        ...
        {
          STATE_VARIABLE_ContainsInstNames_66_66 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), STATE_VARIABLE_ContainsInstNames_66_66, 0) = ((MR_Box) (InstNames_71));
        }
      }
    }
    ...
    {
      MR_Word InstVarsA_73 = ((MR_Word) ((MR_hl_field(MR_mktag(1), ArgContainsInstVars_49, (MR_Integer) 0))));

      if ((STATE_VARIABLE_ContainsInstVars_0_10 == (MR_Word) ((MR_Unsigned) 0U)))
        STATE_VARIABLE_ContainsInstVars_67_67 = (MR_Word) ((MR_Unsigned) 0U);
      else
      {
        MR_Word InstVarsB_74 = ((MR_Word) ((MR_hl_field(MR_mktag(1), STATE_VARIABLE_ContainsInstVars_0_10, (MR_Integer) 0))));
        MR_Word InstVars_75;

        mercury__set__union_3_p_0((MR_Word) (&check_hlds__inst_user_scalar_common_1[0]), InstVarsA_73, InstVarsB_74, &InstVars_75);
        {
          STATE_VARIABLE_ContainsInstVars_67_67 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), STATE_VARIABLE_ContainsInstVars_67_67, 0) = ((MR_Box) (InstVars_75));
        }
      }
    }
    ...
    {
      MR_Word TypesA_77 = ((MR_Word) ((MR_hl_field(MR_mktag(1), ArgContainsTypes_50, (MR_Integer) 0))));

      if ((STATE_VARIABLE_ContainsTypes_0_12 == (MR_Word) ((MR_Unsigned) 0U)))
        STATE_VARIABLE_ContainsTypes_68_68 = (MR_Word) ((MR_Unsigned) 0U);
      else
      {
        MR_Word TypesB_78 = ((MR_Word) ((MR_hl_field(MR_mktag(1), STATE_VARIABLE_ContainsTypes_0_12, (MR_Integer) 0))));
        MR_Word Types_79;
        ...
        {
          STATE_VARIABLE_ContainsTypes_68_68 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), STATE_VARIABLE_ContainsTypes_68_68, 0) = ((MR_Box) (Types_79));
        }
      }
    }
  ...
  switch (MR_tag((MR_Word) Inst0_11)) {
        ...
        case (MR_Integer) 0:
          {
            ...
            *ContainsAny_15 = (MR_Integer) 0;
            ...
            Var_68 = mercury__set__init_0_f_0((MR_Word) (&check_hlds__inst_user_scalar_common_1[0]));
            {
              MR_Word base;
              base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
            ...
            Var_69 = mercury__set__init_0_f_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_type_ctor_0));
            {
              MR_Word base;
              base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
    ...
    case (MR_Integer) 2:
      {
        ...
        *ContainsAny_15 = (MR_Integer) 1;
        ...
        Var_60 = mercury__set__init_0_f_0((MR_Word) (&check_hlds__inst_user_scalar_common_1[0]));
        {
          MR_Word base;
          base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
          *ContainsInstVars_17 = base;
    ...
    case (MR_Integer) 3:
      switch (((MR_Integer) ((MR_hl_field(MR_mktag(3), Inst0_11, (MR_Integer) 0))))) {
        ...
        case (MR_Integer) 0:
          {
            MR_Word Uniq_33 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(3), Inst0_11, (MR_Integer) 1))) & (MR_Integer) 7);
            ...
            {
              TestResults_37 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), TestResults_37, 0) = (MR_Box) (((((MR_Unsigned) (*Groundness_14) << 2)) | (MR_Unsigned) (*ContainsAny_15)));
              MR_hl_field(MR_mktag(1), TestResults_37, 1) = ((MR_Box) (*ContainsInstNames_16));
              MR_hl_field(MR_mktag(1), TestResults_37, 2) = ((MR_Box) (*ContainsInstVars_17));
              MR_hl_field(MR_mktag(1), TestResults_37, 3) = ((MR_Box) (*ContainsTypes_18));
              MR_hl_field(MR_mktag(1), TestResults_37, 4) = ((MR_Box) ((MR_Unsigned) 0U));
            }
            {
              MR_Word base;
              ...
              *Inst_12 = base;
              ...
              MR_hl_field(MR_mktag(3), base, 1) = (MR_Box) ((MR_Unsigned) (Uniq_33));
        ...
        case (MR_Integer) 3:
          {
            ...
            MR_Word InstVarsA_90 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Inst0_11, (MR_Integer) 1))));
            ...
            {
              MR_Word InstVarsB_91 = ((MR_Word) ((MR_hl_field(MR_mktag(1), ContainsInstVars0_29, (MR_Integer) 0))));
              MR_Word InstVars_92;

              mercury__set__union_3_p_0((MR_Word) (&check_hlds__inst_user_scalar_common_1[0]), InstVarsA_90, InstVarsB_91, &InstVars_92);
              {
                MR_Word base;
                base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                *ContainsInstVars_17 = base;
                MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (InstVars_92));
              }
            }
            {
              MR_Word base;
              ...
              *Inst_12 = base;
              ...
              MR_hl_field(MR_mktag(3), base, 1) = ((MR_Box) (InstVarsA_90));
        ...
        case (MR_Integer) 4:
          {
            ...
            *ContainsInstNames_16 = (MR_Word) ((MR_Unsigned) 0U);
            Var_52 = mercury__set__init_0_f_0((MR_Word) (&check_hlds__inst_user_scalar_common_1[0]));
            {
              MR_Word base;
              base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
              *ContainsInstVars_17 = base;
  ...
  MR_Word * HeadVar__2_2)
{
  ...
  else
  {
    ...
    MR_Word InstCtor_7 = ((MR_Word) ((MR_hl_field(MR_mktag(0), MaybeInstPair_3, (MR_Integer) 0))));
      ...
      UserInstDefn_9 = (MR_Word) (MR_body((MR_Word) (MaybeUserInst_8), (MR_Integer) 1));
    {
      ...
      MR_hl_field(MR_mktag(0), InstDefnPair_5, 0) = ((MR_Box) (InstCtor_7));
