...
{
  {
    ...
    else
    {
      ...
      else
      {
        ...
        hlds__hlds_data____Compare____hlds_inst_defn_0_0(HeadVar__1_1, Var_11, ArgY1_7);
      }
    }
  }
}
...
{
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        succeeded = hlds__hlds_data____Unify____hlds_inst_defn_0_0(ArgX1_5, ArgY1_6);
      }
    }
    return succeeded;
  }
...
{
  {
    ...
    hlds__hlds_data__inst_table_get_user_insts_2_p_0(InstTable0_4, &UserInstTable0_5);
    TypeCtorInfo_17_17 = (MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_inst_id_0;
    TypeCtorInfo_18_18 = (MR_Word) &hlds__hlds_data__hlds__hlds_data__type_ctor_info_hlds_inst_defn_0;
    ...
    hlds__hlds_data__inst_table_set_user_insts_3_p_0(UserInstTable_10, InstTable0_4, &InstTable_11);
  ...
  MR_Word * STATE_VARIABLE_MaybeInstDefnsMap_6)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      /* direct tailcall eliminated */
      {
        MR_Word next_value_of_HeadVar__2_2 = InstDefnPairs_19;
        MR_Word next_value_of_HeadVar__3_3 = STATE_VARIABLE_DelayedInstDefnPairs_30_30;
        MR_Word next_value_of_STATE_VARIABLE_MaybeInstDefnsMap_0_5 = STATE_VARIABLE_MaybeInstDefnsMap_31_31;
