  ...
  MR_Word * STATE_VARIABLE_MaybeInstDefnsMap_39)
{
  ...
  switch (MR_tag((MR_Word) Inst0_11)) {
    ...
    case (MR_Integer) 2:
      {
        MR_Word Uniq_33 = ((MR_Unsigned) ((MR_hl_field(2, Inst0_11, (MR_Integer) 0))) & (MR_Integer) 7);
        MR_Word BoundInsts0_35 = ((MR_Word) ((MR_hl_field(2, Inst0_11, (MR_Integer) 2))));
        ...
        }
        {
          ...
          *Inst_12 = base;
          MR_hl_field(2, base, 0) = (MR_Box) ((MR_Unsigned) (Uniq_33));
          MR_hl_field(2, base, 1) = ((MR_Box) (TestResults_37));
          MR_hl_field(2, base, 2) = ((MR_Box) (BoundInsts_36));
        }
      }
      break;
    case (MR_Integer) 3:
      switch (((MR_Integer) ((MR_hl_field(3, Inst0_11, (MR_Integer) 0))))) {
        ...
        case (MR_Integer) 3:
          {
            MR_Word Type_20 = ((MR_Word) ((MR_hl_field(3, Inst0_11, (MR_Integer) 1))));
            MR_Word Var_43;
            MR_Word Var_44;
            MR_Word TypeCtor_21;
