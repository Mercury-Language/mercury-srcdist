      ...
      else
      {
        ...
        if ((InstParams_35 == (MR_Word) ((MR_Unsigned) 0U)))
        {
          ...
          if (succeeded)
          {
            ...
            {
              MR_Word Var_63 = ((MR_Word) ((MR_hl_field(MR_mktag(2), IFTC_37, (MR_Integer) 0))));
              MR_Word Var_64;

              succeeded = (Var_63 != (MR_Word) ((MR_Unsigned) 0U));
              if (succeeded)
              {
                InstTypeCtor_52 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Var_63, (MR_Integer) 0))));
          ...
          Var_67 = (MR_Word) (MR_mkword(MR_mktag(1), (MR_Word) (InstDefn_58)));
        ...
        {
          MR_Word Var_59 = (MR_Word) (MR_mkword(MR_mktag(1), (MR_Word) (InstDefn_24)));
