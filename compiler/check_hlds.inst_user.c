      ...
      else
      {
        ...
        else
        {
          ...
          if ((InstParams_43 == (MR_Word) ((MR_Unsigned) 0U)))
          {
            ...
            if (succeeded)
            {
              packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Inst1_51, (MR_Integer) 1)));
          ...
          case (MR_Integer) 0:
            {
              ...
              MR_Word Var_47;
              MR_Word Var_48;
              MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Inst0_11, (MR_Integer) 1)));
              ...
              {
                TestResults_37 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 5 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(1), TestResults_37, 0) = (MR_Box) (((((MR_Unsigned) (*Groundness_14) << (MR_Integer) 2)) | (MR_Unsigned) (*ContainsAny_15)));
