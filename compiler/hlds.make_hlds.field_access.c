  ...
  MR_Word * STATE_VARIABLE_UrInfo_14)
{
  ...
  else
  {
    ...
    hlds__make_hlds__superhomogeneous__make_fresh_arg_vars_subst_svars_7_p_0(FieldArgs_36, &FieldArgVars_46, &FieldArgVarsArgs_47, STATE_VARIABLE_SVarState_0_11, &STATE_VARIABLE_SVarState_1_70, STATE_VARIABLE_UrInfo_0_13, &STATE_VARIABLE_UrInfo_1_71);
    {
  ...
  MR_Word * STATE_VARIABLE_UrInfo_14)
{
  ...
  else
  {
    ...
    hlds__make_hlds__superhomogeneous__make_fresh_arg_vars_subst_svars_7_p_0(FieldArgs_36, &FieldArgVars_46, &FieldArgVarsArgs_47, STATE_VARIABLE_SVarState_0_11, &STATE_VARIABLE_SVarState_1_76, STATE_VARIABLE_UrInfo_0_13, &STATE_VARIABLE_UrInfo_1_77);
    if ((FieldNames_37 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      MR_Word Goal_66;
      MR_Word Var_97;
