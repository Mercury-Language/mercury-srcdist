...
{
  {
    ...
    if (succeeded)
    {
      ...
      Var_11 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Term_5, (MR_Integer) 2))));
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        if (((MR_tag((MR_Word) MaybeFieldNamesTail_14)) == (MR_mktag((MR_Integer) 0))))
      ...
      else
      {
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(1), Var_50, 0) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), Var_14, 0) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
...
{
  {
    ...
    {
      Goals_41 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
  ...
  MR_Word * STATE_VARIABLE_Specs_22)
{
  ...
  {
    MR_Word FieldName_56;
    MR_Word FieldArgs_57;
    MR_Word FieldNames_58 = ((MR_Word) ((MR_hl_field(MR_mktag(1), HeadVar__4_4, (MR_Integer) 1))));
    MR_Word FieldArgVars_71;
    ...
    FieldName_56 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_99, (MR_Integer) 0))));
    FieldArgs_57 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_99, (MR_Integer) 1))));
    hlds__make_hlds__superhomogeneous__make_fresh_arg_vars_subst_svars_8_p_0(FieldArgs_57, &FieldArgVars_71, STATE_VARIABLE_VarSet_0_15, &STATE_VARIABLE_VarSet_100_100, STATE_VARIABLE_SVarState_0_11, &STATE_VARIABLE_SVarState_101_101, STATE_VARIABLE_Specs_0_21, &STATE_VARIABLE_Specs_102_102);
    {
    ...
    GetArgVars_72 = mercury__list__f_43_43_2_f_0((MR_Word) (&hlds__make_hlds__field_access_scalar_common_1[0]), FieldArgVars_71, Var_103);
    if ((FieldNames_58 == (MR_Word) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
    {
      MR_Word Goal_126;

      hlds__make_hlds__field_access__construct_field_access_function_call_12_p_0((MR_Integer) 0, Context_1, MainContext_2, SubContext0_3, FieldName_56, FieldValueVar_5, GetArgVars_72, Purity_7, Functor_8, &Goal_126, STATE_VARIABLE_QualInfo_0_19, &STATE_VARIABLE_QualInfo_117_117);
      {
        MR_Word base;
      ...
      {
        Goals2_82 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), Goals2_82, 0) = ((MR_Box) (Goal_126));
        MR_hl_field(MR_mktag(1), Goals2_82, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
      }
    ...
    else
    {
      ...
      hlds__make_hlds__field_access__construct_field_access_function_call_12_p_0((MR_Integer) 0, Context_1, MainContext_2, SubContext0_3, FieldName_56, SubTermInputVar_75, GetArgVars_72, Purity_7, Functor_8, &Goal_76, STATE_VARIABLE_QualInfo_0_19, &STATE_VARIABLE_QualInfo_110_110);
      Var_112 = mercury__list__length_1_f_0((MR_Word) (&hlds__make_hlds__field_access_scalar_common_1[0]), FieldArgVars_71);
      TermInputArgNumber_77 = (MR_Integer) ((MR_Unsigned) (MR_Integer) 1 + (MR_Unsigned) Var_112);
      {
        TermInputContext_78 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
      ...
      {
        SubContext_79 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
    ...
    {
      ArgContext_83 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL));
  ...
  MR_Word * STATE_VARIABLE_Specs_22)
{
  ...
  else
  {
    ...
    FieldName_56 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_103, (MR_Integer) 0))));
    FieldArgs_57 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_103, (MR_Integer) 1))));
    hlds__make_hlds__superhomogeneous__make_fresh_arg_vars_subst_svars_8_p_0(FieldArgs_57, &FieldArgVars_71, STATE_VARIABLE_VarSet_0_15, &STATE_VARIABLE_VarSet_104_104, STATE_VARIABLE_SVarState_0_11, &STATE_VARIABLE_SVarState_105_105, STATE_VARIABLE_Specs_0_21, &STATE_VARIABLE_Specs_106_106);
    if ((FieldNames_58 == (MR_Word) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
    {
      MR_Word Goal_86;
      MR_Word Var_107;
      ...
      SetArgs_146 = mercury__list__f_43_43_2_f_0((MR_Word) (&hlds__make_hlds__field_access_scalar_common_1[0]), FieldArgVars_71, Var_107);
      hlds__make_hlds__field_access__construct_field_access_function_call_12_p_0((MR_Integer) 1, Context_1, MainContext_2, SubContext0_3, FieldName_56, TermOutputVar_7, SetArgs_146, (MR_Integer) 0, Functor_8, &Goal_86, STATE_VARIABLE_QualInfo_0_19, &STATE_VARIABLE_QualInfo_134_134);
      {
        MR_Word base;
        base = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
        *FieldSubContext_9 = base;
      ...
      {
        Goals1_85 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), Goals1_85, 0) = ((MR_Box) (Goal_86));
        MR_hl_field(MR_mktag(1), Goals1_85, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
      }
    ...
    else
    {
      ...
      SetArgs_76 = mercury__list__f_43_43_2_f_0((MR_Word) (&hlds__make_hlds__field_access_scalar_common_1[0]), FieldArgVars_71, Var_116);
      hlds__make_hlds__field_access__construct_field_access_function_call_12_p_0((MR_Integer) 1, Context_1, MainContext_2, SubContext0_3, FieldName_56, TermOutputVar_7, SetArgs_76, (MR_Integer) 0, Functor_8, &UpdateGoal_77, STATE_VARIABLE_QualInfo_0_19, &STATE_VARIABLE_QualInfo_121_121);
      {
      ...
      Var_123 = mercury__list__f_43_43_2_f_0((MR_Word) (&hlds__make_hlds__field_access_scalar_common_1[0]), FieldArgVars_71, Var_126);
      hlds__make_hlds__field_access__construct_field_access_function_call_12_p_0((MR_Integer) 0, Context_1, MainContext_2, SubContext0_3, FieldName_56, SubTermInputVar_74, Var_123, (MR_Integer) 0, &Var_78, &GetSubFieldGoal_79, STATE_VARIABLE_QualInfo_121_121, &STATE_VARIABLE_QualInfo_125_125);
      Var_129 = mercury__list__length_1_f_0((MR_Word) (&hlds__make_hlds__field_access_scalar_common_1[1]), FieldArgs_57);
      SubTermInputArgNumber_80 = (MR_Integer) ((MR_Unsigned) (MR_Integer) 2 + (MR_Unsigned) Var_129);
      {
        TermInputContext_81 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
      ...
      {
        SubContext_82 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      ...
      hlds__make_hlds__field_access__expand_set_field_function_call_2_22_p_0(Context_1, MainContext_2, SubContext_82, FieldNames_58, FieldValueVar_5, SubTermInputVar_74, SubTermOutputVar_75, &Var_83, FieldSubContext_9, &Goals0_84, STATE_VARIABLE_SVarState_105_105, &STATE_VARIABLE_SVarState_130_130, STATE_VARIABLE_SVarStore_0_13, &STATE_VARIABLE_SVarStore_131_131, STATE_VARIABLE_VarSet_115_115, &STATE_VARIABLE_VarSet_132_132, STATE_VARIABLE_ModuleInfo_0_17, &STATE_VARIABLE_ModuleInfo_133_133, STATE_VARIABLE_QualInfo_125_125, &STATE_VARIABLE_QualInfo_134_134, STATE_VARIABLE_Specs_106_106, &STATE_VARIABLE_Specs_135_135);
      {
    ...
    {
      ArgContext_87 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL));
