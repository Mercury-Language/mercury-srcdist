  ...
  else
  {
    ...
    else
    {
      ...
      Pieces_58 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), ContextPieces_7, Var_60);
      {
        ...
        MR_hl_field(0, Spec_34, 0) = ((MR_Box) ((MR_String) "function \140hlds.make_hlds.field_access.make_field_list_error\'/4"));
        MR_hl_field(0, Spec_34, 1) = ((MR_Box) ((MR_Unsigned) 0U));
        MR_hl_field(0, Spec_34, 2) = ((MR_Box) ((MR_Unsigned) 24U));
        MR_hl_field(0, Spec_34, 3) = ((MR_Box) (Var_31));
        MR_hl_field(0, Spec_34, 4) = ((MR_Box) (Pieces_58));
      }
      {
