  ...
  if (succeeded)
  {
    ...
    else
    {
      ...
      }
      {
        ...
        MR_hl_field(0, Var_26, 0) = ((MR_Box) (Spec_17));
  ...
  else
  {
    ...
    else
    {
      ...
      Spec_34 = hlds__make_hlds__field_access__make_field_list_error_4_f_0(VarSet_6, Var_31, Term_5, ContextPieces_7);
      {
        ...
        MR_hl_field(0, Var_32, 0) = ((MR_Box) (Spec_34));
  ...
  MR_Word * STATE_VARIABLE_UrInfo_32)
{
  ...
  hlds__goal_list_util__conj_list_to_goal_3_p_0(Goals_27, GoalInfo_28, Goal_24);
}
  ...
  MR_Word * STATE_VARIABLE_UrInfo_36)
{
  ...
  Var_46 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_UrInfo_0_35, 0))));
  Var_47 = ((MR_Integer) ((MR_hl_field(0, STATE_VARIABLE_UrInfo_0_35, 1))));
  Var_49 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_UrInfo_0_35, 3))));
  Var_50 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_UrInfo_0_35, 4))));
  Var_51 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_UrInfo_0_35, 5))));
  Var_52 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_UrInfo_0_35, 6))));
  {
    STATE_VARIABLE_UrInfo_1_38 = (MR_Word) MR_new_object(MR_Word, (7 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(0, STATE_VARIABLE_UrInfo_1_38, 0) = ((MR_Box) (Var_46));
    MR_hl_field(0, STATE_VARIABLE_UrInfo_1_38, 1) = ((MR_Box) (Var_47));
    MR_hl_field(0, STATE_VARIABLE_UrInfo_1_38, 2) = ((MR_Box) (QualInfo_29));
    MR_hl_field(0, STATE_VARIABLE_UrInfo_1_38, 3) = ((MR_Box) (Var_49));
    MR_hl_field(0, STATE_VARIABLE_UrInfo_1_38, 4) = ((MR_Box) (Var_50));
    MR_hl_field(0, STATE_VARIABLE_UrInfo_1_38, 5) = ((MR_Box) (Var_51));
    MR_hl_field(0, STATE_VARIABLE_UrInfo_1_38, 6) = ((MR_Box) (Var_52));
  }
  ...
  hlds__goal_list_util__conj_list_to_goal_3_p_0(Goals_31, GoalInfo_32, Goal_24);
}
  ...
  MR_Word * STATE_VARIABLE_UrInfo_14)
{
  ...
  else
  {
    ...
    if ((FieldNames_37 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      ...
      Var_109 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_UrInfo_1_71, 0))));
      Var_110 = ((MR_Integer) ((MR_hl_field(0, STATE_VARIABLE_UrInfo_1_71, 1))));
      Var_112 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_UrInfo_1_71, 3))));
      Var_113 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_UrInfo_1_71, 4))));
      Var_114 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_UrInfo_1_71, 5))));
      Var_115 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_UrInfo_1_71, 6))));
      {
        STATE_VARIABLE_UrInfo_4_80 = (MR_Word) MR_new_object(MR_Word, (7 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(0, STATE_VARIABLE_UrInfo_4_80, 0) = ((MR_Box) (Var_109));
        MR_hl_field(0, STATE_VARIABLE_UrInfo_4_80, 1) = ((MR_Box) (Var_110));
        MR_hl_field(0, STATE_VARIABLE_UrInfo_4_80, 2) = ((MR_Box) (QualInfo_89));
        MR_hl_field(0, STATE_VARIABLE_UrInfo_4_80, 3) = ((MR_Box) (Var_112));
        MR_hl_field(0, STATE_VARIABLE_UrInfo_4_80, 4) = ((MR_Box) (Var_113));
        MR_hl_field(0, STATE_VARIABLE_UrInfo_4_80, 5) = ((MR_Box) (Var_114));
        MR_hl_field(0, STATE_VARIABLE_UrInfo_4_80, 6) = ((MR_Box) (Var_115));
      }
      {
    ...
    else
    {
      ...
      hlds__make_hlds__unravel_info__create_new_unravel_var_3_p_0(&SubTermInputVar_51, STATE_VARIABLE_UrInfo_1_71, &STATE_VARIABLE_UrInfo_2_74);
      ...
      Var_96 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_UrInfo_2_74, 0))));
      Var_97 = ((MR_Integer) ((MR_hl_field(0, STATE_VARIABLE_UrInfo_2_74, 1))));
      Var_99 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_UrInfo_2_74, 3))));
      Var_100 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_UrInfo_2_74, 4))));
      Var_101 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_UrInfo_2_74, 5))));
      Var_102 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_UrInfo_2_74, 6))));
      {
        STATE_VARIABLE_UrInfo_3_76 = (MR_Word) MR_new_object(MR_Word, (7 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(0, STATE_VARIABLE_UrInfo_3_76, 0) = ((MR_Box) (Var_96));
        MR_hl_field(0, STATE_VARIABLE_UrInfo_3_76, 1) = ((MR_Box) (Var_97));
        MR_hl_field(0, STATE_VARIABLE_UrInfo_3_76, 2) = ((MR_Box) (QualInfo_54));
        MR_hl_field(0, STATE_VARIABLE_UrInfo_3_76, 3) = ((MR_Box) (Var_99));
        MR_hl_field(0, STATE_VARIABLE_UrInfo_3_76, 4) = ((MR_Box) (Var_100));
        MR_hl_field(0, STATE_VARIABLE_UrInfo_3_76, 5) = ((MR_Box) (Var_101));
        MR_hl_field(0, STATE_VARIABLE_UrInfo_3_76, 6) = ((MR_Box) (Var_102));
      }
    ...
    hlds__goal_list_util__conj_list_to_goal_3_p_0(Goals2_60, GoalInfo_62, &Conj0_63);
  ...
  MR_Word * STATE_VARIABLE_UrInfo_14)
{
  ...
  else
  {
    ...
    if ((FieldNames_37 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      ...
      Var_129 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_UrInfo_1_77, 0))));
      Var_130 = ((MR_Integer) ((MR_hl_field(0, STATE_VARIABLE_UrInfo_1_77, 1))));
      Var_132 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_UrInfo_1_77, 3))));
      Var_133 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_UrInfo_1_77, 4))));
      Var_134 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_UrInfo_1_77, 5))));
      Var_135 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_UrInfo_1_77, 6))));
      {
        STATE_VARIABLE_UrInfo_5_93 = (MR_Word) MR_new_object(MR_Word, (7 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(0, STATE_VARIABLE_UrInfo_5_93, 0) = ((MR_Box) (Var_129));
        MR_hl_field(0, STATE_VARIABLE_UrInfo_5_93, 1) = ((MR_Box) (Var_130));
        MR_hl_field(0, STATE_VARIABLE_UrInfo_5_93, 2) = ((MR_Box) (QualInfo_109));
        MR_hl_field(0, STATE_VARIABLE_UrInfo_5_93, 3) = ((MR_Box) (Var_132));
        MR_hl_field(0, STATE_VARIABLE_UrInfo_5_93, 4) = ((MR_Box) (Var_133));
        MR_hl_field(0, STATE_VARIABLE_UrInfo_5_93, 5) = ((MR_Box) (Var_134));
        MR_hl_field(0, STATE_VARIABLE_UrInfo_5_93, 6) = ((MR_Box) (Var_135));
      }
      {
        MR_Word base;
        base = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
    ...
    else
    {
      ...
      hlds__make_hlds__unravel_info__create_new_unravel_var_3_p_0(&SubTermInputVar_50, STATE_VARIABLE_UrInfo_1_77, &STATE_VARIABLE_UrInfo_2_78);
      hlds__make_hlds__unravel_info__create_new_unravel_var_3_p_0(&SubTermOutputVar_51, STATE_VARIABLE_UrInfo_2_78, &STATE_VARIABLE_UrInfo_3_79);
      {
      ...
      Var_116 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_UrInfo_3_79, 0))));
      Var_117 = ((MR_Integer) ((MR_hl_field(0, STATE_VARIABLE_UrInfo_3_79, 1))));
      Var_119 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_UrInfo_3_79, 3))));
      Var_120 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_UrInfo_3_79, 4))));
      Var_121 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_UrInfo_3_79, 5))));
      Var_122 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_UrInfo_3_79, 6))));
      {
        STATE_VARIABLE_UrInfo_4_89 = (MR_Word) MR_new_object(MR_Word, (7 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(0, STATE_VARIABLE_UrInfo_4_89, 0) = ((MR_Box) (Var_116));
        MR_hl_field(0, STATE_VARIABLE_UrInfo_4_89, 1) = ((MR_Box) (Var_117));
        MR_hl_field(0, STATE_VARIABLE_UrInfo_4_89, 2) = ((MR_Box) (QualInfo_59));
        MR_hl_field(0, STATE_VARIABLE_UrInfo_4_89, 3) = ((MR_Box) (Var_119));
        MR_hl_field(0, STATE_VARIABLE_UrInfo_4_89, 4) = ((MR_Box) (Var_120));
        MR_hl_field(0, STATE_VARIABLE_UrInfo_4_89, 5) = ((MR_Box) (Var_121));
        MR_hl_field(0, STATE_VARIABLE_UrInfo_4_89, 6) = ((MR_Box) (Var_122));
      }
    ...
    hlds__goal_list_util__conj_list_to_goal_3_p_0(Goals1_65, GoalInfo_68, &Conj0_69);
  ...
  MR_Word * STATE_VARIABLE_QualInfo_27)
{
  ...
  hlds__hlds_pred_tests__construct_field_access_function_name_3_p_0(AccessType_13, FieldName_17, &FuncName_24);
