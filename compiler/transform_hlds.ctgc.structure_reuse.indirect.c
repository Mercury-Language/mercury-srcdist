...
MR_BEGIN_MODULE(transform_hlds__ctgc__structure_reuse__indirect_module46)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__transform_hlds__ctgc__structure_reuse__indirect__IntroducedFrom__pred__extend_scc_with_reuse_procs__188__1_3_0);
...
/*-------------------------------------------------------------------------*/
/* code for 'IntroducedFrom__pred__extend_scc_with_reuse_procs__188__1'/3 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(transform_hlds__ctgc__structure_reuse__indirect__IntroducedFrom__pred__extend_scc_with_reuse_procs__188__1_3_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_mkframe("pred transform_hlds.ctgc.structure_reuse.indirect.IntroducedFrom__pred__extend_scc_with_reuse_procs__188__1/3-0", 4,
		MR_ENTRY(MR_do_fail));
	MR_fv(1) = MR_r2;
