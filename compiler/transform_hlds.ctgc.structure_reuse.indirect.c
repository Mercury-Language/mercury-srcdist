    ...
    case (MR_Integer) 1:
      {
        ...
        hlds__vartypes__lookup_var_types_3_p_0(CallerVarTypes_25, CallArgs_10, &ActualTypes_26);
  ...
  MR_Word * NotDeadVars_16)
{
  ...
  hlds__vartypes__lookup_var_types_3_p_0(ActualVarTypes_22, CalleeArgs_13, &CalleeTypes_25);
