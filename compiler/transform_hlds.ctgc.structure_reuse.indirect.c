...
MR_decl_label10(transform_hlds__ctgc__structure_reuse__indirect__indirect_reuse_analyse_generic_call_7_0, 4,5,6,7,3,11,12,15,14,17)
MR_decl_label4(transform_hlds__ctgc__structure_reuse__indirect__indirect_reuse_analyse_generic_call_7_0, 18,19,20,22)
...
MR_BEGIN_MODULE(transform_hlds__ctgc__structure_reuse__indirect_module21)
	...
	MR_init_label10(transform_hlds__ctgc__structure_reuse__indirect__indirect_reuse_analyse_generic_call_7_0,4,5,6,7,3,11,12,15,14,17)
	MR_init_label4(transform_hlds__ctgc__structure_reuse__indirect__indirect_reuse_analyse_generic_call_7_0,18,19,20,22)
MR_BEGIN_CODE
...
MR_def_label(transform_hlds__ctgc__structure_reuse__indirect__indirect_reuse_analyse_generic_call_7_0,11)
	...
	MR_np_call_localret_ent(map__apply_to_list_3_0,
		transform_hlds__ctgc__structure_reuse__indirect__indirect_reuse_analyse_generic_call_7_0_i12);
MR_def_label(transform_hlds__ctgc__structure_reuse__indirect__indirect_reuse_analyse_generic_call_7_0,12)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
	...
	MR_np_call_localret_ent(transform_hlds__ctgc__structure_sharing__domain__bottom_sharing_is_safe_approximation_by_args_3_0,
		transform_hlds__ctgc__structure_reuse__indirect__indirect_reuse_analyse_generic_call_7_0_i15);
MR_def_label(transform_hlds__ctgc__structure_reuse__indirect__indirect_reuse_analyse_generic_call_7_0,15)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(transform_hlds__ctgc__structure_reuse__indirect__indirect_reuse_analyse_generic_call_7_0_i14);
	}
	MR_r1 = MR_sv(6);
	MR_decr_sp_and_return(7);
MR_def_label(transform_hlds__ctgc__structure_reuse__indirect__indirect_reuse_analyse_generic_call_7_0,14)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(3);
	MR_np_call_localret_ent(fn__hlds__hlds_goal__goal_info_get_context_1_0,
