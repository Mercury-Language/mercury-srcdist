  ...
  MR_Word * STATE_VARIABLE_IrInfo_21)
{
  ...
  else
  {
    ...
    *IntraModule_10 = (MR_Integer) 0;
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_18, (MR_Integer) 505, &IntermoduleAnalysis_19);
  ...
  MR_Word ReuseTable_13)
{
  ...
  libs__globals__lookup_int_option_3_p_0(Globals_18, (MR_Integer) 517, &MaxConditions_19);
