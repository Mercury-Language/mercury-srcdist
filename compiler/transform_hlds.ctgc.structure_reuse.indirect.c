...
{
  {
    ...
    else
    {
      ...
      *IntraModule_10 = (MR_Integer) 0;
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals_18, (MR_Integer) 359, &IntermoduleAnalysis_19);
...
{
  {
    ...
    libs__globals__lookup_int_option_3_p_0(Globals_18, (MR_Integer) 442, &MaxConditions_19);
