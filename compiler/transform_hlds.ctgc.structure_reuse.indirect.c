  ...
  MR_Word * STATE_VARIABLE_IntermodRequests_55)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_22, (MR_Integer) 125, &DebugIndirect_24);
  ...
  MR_Word * STATE_VARIABLE_IrInfo_21)
{
  ...
  else
  {
    ...
    *IntraModule_10 = (MR_Integer) 0;
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_18, (MR_Integer) 519, &IntermoduleAnalysis_19);
  ...
  MR_Word ReuseTable_13)
{
  ...
  libs__globals__lookup_int_option_3_p_0(Globals_18, (MR_Integer) 531, &MaxConditions_19);
  libs__globals__lookup_bool_option_3_p_0(Globals_18, (MR_Integer) 75, &VeryVerbose_20);
  libs__globals__lookup_bool_option_3_p_0(Globals_18, (MR_Integer) 125, &DebugIndirect_21);
  {
