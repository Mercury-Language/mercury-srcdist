  ...
  MR_Word * STATE_VARIABLE_IntermodRequests_55)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_22, (MR_Integer) 688, &DebugIndirect_24);
  ...
  MR_Word ReuseTable_13)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_18, (MR_Integer) 688, &DebugIndirect_21);
  {
