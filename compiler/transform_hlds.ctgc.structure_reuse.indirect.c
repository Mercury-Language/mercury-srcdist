...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_22, (MR_Integer) 102, &DebugIndirect_24);
...
{
  {
    ...
    else
    {
      ...
      *IntraModule_10 = (MR_Integer) 0;
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals_18, (MR_Integer) 494, &IntermoduleAnalysis_19);
...
{
  {
    ...
    libs__globals__lookup_int_option_3_p_0(Globals_18, (MR_Integer) 506, &MaxConditions_19);
    libs__globals__lookup_bool_option_3_p_0(Globals_18, (MR_Integer) 66, &VeryVerbose_20);
    libs__globals__lookup_bool_option_3_p_0(Globals_18, (MR_Integer) 102, &DebugIndirect_21);
    {
