...
transform_hlds__ctgc__structure_reuse__indirect__verify_indirect_reuse_conditional_9_p_0(
  ...
  MR_Word STATE_VARIABLE_IrInfo_0_27,
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_22, (MR_Integer) 57, &VeryVerbose_23);
    libs__globals__lookup_bool_option_3_p_0(Globals_22, (MR_Integer) 92, &DebugIndirect_24);
...
{
  {
    ...
    if (succeeded)
    {
      ...
      else
      {
        ...
        if (succeeded)
        {
          transform_hlds__ctgc__structure_reuse__indirect__verify_indirect_reuse_9_p_0(BaseInfo_10, CalleePPId_11, NotDeadArgNums_20, CalleeArgs_13, (MR_Integer) 0, STATE_VARIABLE_GoalInfo_0_25, STATE_VARIABLE_GoalInfo_26, STATE_VARIABLE_IrInfo_0_27, STATE_VARIABLE_IrInfo_28);
        }
        else
        {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        Var_96 = ((MR_Word) (MR_hl_field(MR_mktag(0), STATE_VARIABLE_IrInfo_0_27, (MR_Integer) 7)));
        {
          MR_Word base;
          base = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 8 * sizeof(MR_Word)), NULL, NULL);
          *STATE_VARIABLE_IrInfo_28 = base;
          MR_hl_field(MR_mktag(0), base, 0) = ((MR_Box) (Var_89));
          MR_hl_field(MR_mktag(0), base, 1) = ((MR_Box) (NewReuseAs_24));
        ...
        if (succeeded)
        {
          ...
          Var_129 = ((MR_Word) (MR_hl_field(MR_mktag(0), STATE_VARIABLE_IrInfo_0_27, (MR_Integer) 7)));
          {
            ...
            *STATE_VARIABLE_IrInfo_28 = base;
            ...
            MR_hl_field(MR_mktag(0), base, 1) = ((MR_Box) (NewReuseAs_71));
            ...
            MR_hl_field(MR_mktag(0), base, 6) = ((MR_Box) (Var_128));
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        Var_61 = ((MR_Word) (MR_hl_field(MR_mktag(0), STATE_VARIABLE_IrInfo_25_25, (MR_Integer) 7)));
        {
          MR_Word base;
          base = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 8 * sizeof(MR_Word)), NULL, NULL);
          *STATE_VARIABLE_IrInfo_24 = base;
          MR_hl_field(MR_mktag(0), base, 0) = ((MR_Box) (Var_54));
          MR_hl_field(MR_mktag(0), base, 1) = ((MR_Box) (NewReuseAs_20));
          ...
          case (MR_Integer) 0:
            {
              ...
              if (succeeded)
              {
                ...
                *STATE_VARIABLE_IrInfo_24 = STATE_VARIABLE_IrInfo_25_25;
                ...
                transform_hlds__ctgc__structure_reuse__indirect__verify_indirect_reuse_conditional_9_p_0(BaseInfo_10, CalleePPId_11, NoClobbers_12, CalleeArgs_13, FormalReuseAs_17, STATE_VARIABLE_GoalInfo_0_21, STATE_VARIABLE_GoalInfo_22, STATE_VARIABLE_IrInfo_25_25, STATE_VARIABLE_IrInfo_24);
            }
            break;
          case (MR_Integer) 1:
            {
...
{
  {
    ...
    else
    {
      ...
      *IntraModule_10 = (MR_Integer) 0;
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals_18, (MR_Integer) 337, &IntermoduleAnalysis_19);
...
{
  {
    ...
    libs__globals__lookup_int_option_3_p_0(Globals_18, (MR_Integer) 420, &MaxConditions_19);
    libs__globals__lookup_bool_option_3_p_0(Globals_18, (MR_Integer) 57, &VeryVerbose_20);
    libs__globals__lookup_bool_option_3_p_0(Globals_18, (MR_Integer) 92, &DebugIndirect_21);
    {
  ...
  MR_Word * STATE_VARIABLE_IntermodRequests_31)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      {
        MR_Word next_value_of_STATE_VARIABLE_ModuleInfo_0_22 = STATE_VARIABLE_ModuleInfo_33_33;
        MR_Word next_value_of_STATE_VARIABLE_FixpointTable_0_24 = STATE_VARIABLE_FixpointTable_38_38;
        MR_Word next_value_of_STATE_VARIABLE_DepProcs_0_26 = STATE_VARIABLE_DepProcs_35_35;
        MR_Word next_value_of_STATE_VARIABLE_Requests_0_28 = STATE_VARIABLE_Requests_36_36;
        MR_Word next_value_of_STATE_VARIABLE_IntermodRequests_0_30 = STATE_VARIABLE_IntermodRequests_37_37;
