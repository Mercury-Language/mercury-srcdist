...
MR_decl_label4(transform_hlds__ctgc__structure_reuse__indirect__indirect_reuse_pass_7_0, 2,3,6,5)
...
MR_BEGIN_MODULE(transform_hlds__ctgc__structure_reuse__indirect_module1)
	...
	MR_init_label4(transform_hlds__ctgc__structure_reuse__indirect__indirect_reuse_pass_7_0,2,3,6,5)
MR_BEGIN_CODE
...
MR_def_label(transform_hlds__ctgc__structure_reuse__indirect__indirect_reuse_pass_7_0,3)
	...
	MR_np_call_localret_ent(hlds__hlds_module__hlds_dependency_info_get_dependency_ordering_2_0,
		transform_hlds__ctgc__structure_reuse__indirect__indirect_reuse_pass_7_0_i6);
MR_def_label(transform_hlds__ctgc__structure_reuse__indirect__indirect_reuse_pass_7_0,6)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
