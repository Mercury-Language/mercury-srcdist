  ...
  MR_Word * STATE_VARIABLE_IntermodRequests_55)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_22, (MR_Integer) 71, &VeryVerbose_23);
  libs__globals__lookup_bool_option_3_p_0(Globals_22, (MR_Integer) 107, &DebugIndirect_24);
  ...
  MR_Word * STATE_VARIABLE_IrInfo_21)
{
  ...
  else
  {
    ...
    *IntraModule_10 = (MR_Integer) 0;
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_18, (MR_Integer) 496, &IntermoduleAnalysis_19);
  ...
  MR_Word ReuseTable_13)
{
  ...
  libs__globals__lookup_int_option_3_p_0(Globals_19, (MR_Integer) 508, &MaxConditions_20);
  libs__globals__lookup_bool_option_3_p_0(Globals_19, (MR_Integer) 71, &VeryVerbose_21);
  libs__globals__lookup_bool_option_3_p_0(Globals_19, (MR_Integer) 107, &DebugIndirect_22);
  {
  ...
  MR_Word * STATE_VARIABLE_IntermodRequests_33)
{
  ...
  else
  {
    ...
    ExtendedSCC_21 = mercury__list__f_43_43_2_f_0((MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_proc_id_0), SCCProcs_20, Extension_52);
    {
      ...
      MR_hl_field(MR_mktag(0), Var_67, 0) = ((MR_Box) (&transform_hlds__ctgc__structure_reuse__indirect_scalar_common_6[0]));
