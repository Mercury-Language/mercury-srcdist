  ...
  MR_Word * STATE_VARIABLE_Specs_23)
{
  ...
  if (succeeded)
  {
    ...
    }
    {
      ...
      MR_hl_field(3, Spec_19, 1) = (MR_Box) (((((MR_Unsigned) ((MR_Integer) 246) << 1)) | (MR_Unsigned) ((MR_Integer) 1)));
  ...
  MR_Word * STATE_VARIABLE_Specs_125)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_6, (MR_Integer) 259, &WarnUnsortedImportBlocks_118);
