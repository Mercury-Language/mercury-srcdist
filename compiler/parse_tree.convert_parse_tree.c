  ...
  MR_Word * STATE_VARIABLE_Specs_64)
{
  ...
  mercury__list__sort_2_p_0((MR_Word) (&parse_tree__prog_item_pragma__parse_tree__prog_item_pragma__type_ctor_info_decl_pragma_input_spec_info_0), InputSpecs0_30, &InputSpecs_53);
