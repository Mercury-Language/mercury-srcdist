...
{
  {
    ...
    Var_62 = mercury__string__f_43_43_2_f_0((MR_String) "trying to convert non-ofk_plain_opt parse_tree_opt ", (MR_String) "to parse_tree_plain_opt");
    mercury__require__expect_3_p_0(Var_60, (MR_String) "predicate \140parse_tree.convert_parse_tree.check_convert_parse_tree_opt_to_plain_opt\'/4", Var_62);
