  ...
  MR_Word * STATE_VARIABLE_ImpInstanceCord_5)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      MR_Word Var_27 = ((MR_Word) ((MR_hl_field(MR_mktag(0), IntInstance_12, (MR_Integer) 0))));
      MR_Word Var_28 = ((MR_Word) ((MR_hl_field(MR_mktag(0), IntInstance_12, (MR_Integer) 1))));
      MR_Word Var_29 = ((MR_Word) ((MR_hl_field(MR_mktag(0), IntInstance_12, (MR_Integer) 2))));
      MR_Word Var_30 = ((MR_Word) ((MR_hl_field(MR_mktag(0), IntInstance_12, (MR_Integer) 3))));
      MR_Word Var_31 = ((MR_Word) ((MR_hl_field(MR_mktag(0), IntInstance_12, (MR_Integer) 5))));
      MR_Word Var_32 = ((MR_Word) ((MR_hl_field(MR_mktag(0), IntInstance_12, (MR_Integer) 6))));
      MR_Word Var_33 = ((MR_Word) ((MR_hl_field(MR_mktag(0), IntInstance_12, (MR_Integer) 7))));
      MR_Word Var_34 = ((MR_Word) ((MR_hl_field(MR_mktag(0), IntInstance_12, (MR_Integer) 8))));
      MR_Word next_value_of_HeadVar__1_1;
      ...
      else
      {
...

        {
          ...
          MR_hl_field(MR_mktag(0), AbstractIntInstance_18, 0) = ((MR_Box) (Var_27));
          MR_hl_field(MR_mktag(0), AbstractIntInstance_18, 1) = ((MR_Box) (Var_28));
          MR_hl_field(MR_mktag(0), AbstractIntInstance_18, 2) = ((MR_Box) (Var_29));
          MR_hl_field(MR_mktag(0), AbstractIntInstance_18, 3) = ((MR_Box) (Var_30));
          MR_hl_field(MR_mktag(0), AbstractIntInstance_18, 4) = ((MR_Box) ((MR_Unsigned) 0U));
          MR_hl_field(MR_mktag(0), AbstractIntInstance_18, 5) = ((MR_Box) (Var_31));
          MR_hl_field(MR_mktag(0), AbstractIntInstance_18, 6) = ((MR_Box) (Var_32));
          MR_hl_field(MR_mktag(0), AbstractIntInstance_18, 7) = ((MR_Box) (Var_33));
          MR_hl_field(MR_mktag(0), AbstractIntInstance_18, 8) = ((MR_Box) (Var_34));
        }
