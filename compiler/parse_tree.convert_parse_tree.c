        ...
        case (MR_Integer) 1:
          {
            ...
            parse_tree__convert_parse_tree__report_forbidden_avail_6_p_0(Extension_8, (MR_String) "import_module", (MR_Word) (MR_mkword(1, &parse_tree__convert_parse_tree_scalar_common_3[0])), ImpContext_16, STATE_VARIABLE_Specs_3_31, STATE_VARIABLE_Specs_20);
            *STATE_VARIABLE_IntImportMap_18 = STATE_VARIABLE_IntImportMap_0_17;
          }
          break;
      }
  ...
  MR_Word * STATE_VARIABLE_Specs_23)
{
  ...
  if (succeeded)
  {
    ...
    }
    {
      ...
      MR_hl_field(3, Spec_19, 1) = (MR_Box) (((((MR_Unsigned) ((MR_Integer) 36) << 1)) | (MR_Unsigned) ((MR_Integer) 1)));
  ...
  MR_Word * STATE_VARIABLE_Specs_125)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_6, (MR_Integer) 83, &WarnUnsortedImportBlocks_118);
