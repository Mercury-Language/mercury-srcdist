      ...
      case (MR_Integer) 1:
        {
          ...
          AddrType_62 = ((MR_Word) ((MR_hl_field(MR_mktag(0), FieldGen_19, (MR_Integer) 2))));
          {
            ...
            MR_hl_field(MR_mktag(0), FieldLval_64, 2) = ((MR_Box) (FieldId_59));
            MR_hl_field(MR_mktag(0), FieldLval_64, 3) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 6))));
            MR_hl_field(MR_mktag(0), FieldLval_64, 4) = ((MR_Box) (AddrType_62));
          }
          {
            Var_87 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
...
{
  {
    ...
    ml_backend__ml_code_util__ml_gen_type_3_p_0(STATE_VARIABLE_Info_0_44, FieldType_38, &MLDS_FieldType_39);
    {
      ...
      MR_hl_field(MR_mktag(0), FieldLval_40, 2) = ((MR_Box) (FieldId_27));
      MR_hl_field(MR_mktag(0), FieldLval_40, 3) = ((MR_Box) (MLDS_FieldType_39));
      MR_hl_field(MR_mktag(0), FieldLval_40, 4) = ((MR_Box) (AddrType_24));
    }
...
{
  {
    ...
    else
    {
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(0), FieldLval_35, 2) = ((MR_Box) (FieldId_29));
        MR_hl_field(MR_mktag(0), FieldLval_35, 3) = ((MR_Box) (ExtraType_31));
        MR_hl_field(MR_mktag(0), FieldLval_35, 4) = ((MR_Box) (MLDS_VarType_2));
      }
