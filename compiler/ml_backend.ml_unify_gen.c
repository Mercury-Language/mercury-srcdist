...
{
  {
    ...
    switch (MR_tag((MR_Word) Unification_9)) {
      ...
      case (MR_Integer) 1:
        {
          MR_Word CanFail_29 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Unification_9, (MR_Integer) 4))));
          MR_Word CanCGC_30 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Unification_9, (MR_Integer) 5))));
      ...
      case (MR_Integer) 1:
        {
          ...
          {
            SidesAreEqualRval_15 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(3), SidesAreEqualRval_15, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 6));
