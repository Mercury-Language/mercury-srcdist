...
{
  {
    ...
    {
      libs__globals__lookup_bool_option_3_p_0(ml_backend__ml_unify_gen__Globals_41, (MR_Integer) 446, &ml_backend__ml_unify_gen__UseAtomicCells_42);
    }
    ...
    if ((ml_backend__ml_unify_gen__HeadVar__1_1 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
      *ml_backend__ml_unify_gen__HeadVar__7_7 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
    else
      {
        ...
        {
          libs__globals__lookup_bool_option_3_p_0(ml_backend__ml_unify_gen__Globals_27, (MR_Integer) 254, &ml_backend__ml_unify_gen__HighLevelData_28);
        }
...
{
  {
    ...
    {
      libs__globals__lookup_bool_option_3_p_0(ml_backend__ml_unify_gen__Globals_8, (MR_Integer) 254, &ml_backend__ml_unify_gen__HighLevelData_10);
    }
    {
...
{
  {
...

    {
      ...
      {
        libs__globals__lookup_bool_option_3_p_0(ml_backend__ml_unify_gen__Globals_12, (MR_Integer) 254, &ml_backend__ml_unify_gen__HighLevelData_13);
      }
