    ...
    case (MR_Integer) 0:
      {
...

        {
          ...
          MR_hl_field(MR_mktag(0), Var_47, 0) = ((MR_Box) (&ml_backend__ml_unify_gen_scalar_common_2[0]));
          MR_hl_field(MR_mktag(0), Var_47, 1) = ((MR_Box) (ml_backend__ml_unify_gen__ml_generate_unification_7_p_0_2));
          MR_hl_field(MR_mktag(0), Var_47, 2) = ((MR_Box) ((MR_Integer) 2));
          MR_hl_field(MR_mktag(0), Var_47, 3) = ((MR_Box) (CodeModel_8));
        ...
        else
        {
            ...
            TakeAddr_26 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MaybeTakeAddr_27, (MR_Integer) 0))));
          {
            ...
            MR_hl_field(MR_mktag(0), Var_51, 0) = ((MR_Box) (&ml_backend__ml_unify_gen_scalar_common_2[1]));
            MR_hl_field(MR_mktag(0), Var_51, 1) = ((MR_Box) (ml_backend__ml_unify_gen__ml_generate_unification_7_p_0_3));
            MR_hl_field(MR_mktag(0), Var_51, 2) = ((MR_Box) ((MR_Integer) 2));
            MR_hl_field(MR_mktag(0), Var_51, 3) = ((MR_Box) (MaybeSizeProfInfo_28));
    ...
    case (MR_Integer) 2:
      {
        ...
        MR_Word Var_36;
        MR_Word VarTable_70;
        MR_Word TargetVarEntry_71;
        MR_Word IsDummyType_74;
        MR_Word GroundTerm_79;

        {
          Var_36 = (MR_Word) MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), Var_36, 0) = ((MR_Box) (&ml_backend__ml_unify_gen_scalar_common_2[0]));
          MR_hl_field(MR_mktag(0), Var_36, 1) = ((MR_Box) (ml_backend__ml_unify_gen__ml_generate_unification_7_p_0_1));
          MR_hl_field(MR_mktag(0), Var_36, 2) = ((MR_Box) ((MR_Integer) 2));
          MR_hl_field(MR_mktag(0), Var_36, 3) = ((MR_Box) (CodeModel_8));
        ...
        ml_backend__ml_gen_info__ml_gen_info_get_var_table_2_p_0(STATE_VARIABLE_Info_0_34, &VarTable_70);
        parse_tree__var_table__lookup_var_entry_3_p_0(VarTable_70, TargetVar_14, &TargetVarEntry_71);
        IsDummyType_74 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), TargetVarEntry_71, (MR_Integer) 2))) & (MR_Integer) 1);
        switch (IsDummyType_74) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 0:
          ...
          case (MR_Integer) 1:
            {
              MR_Word SourceVarEntry_75;
              MR_Word TargetLval_76;
              MR_Word SourceLval_77;
              MR_Word Stmt_78;
              MR_Word Var_80;

              parse_tree__var_table__lookup_var_entry_3_p_0(VarTable_70, SourceVar_15, &SourceVarEntry_75);
              ml_backend__ml_code_util__ml_gen_var_4_p_0(STATE_VARIABLE_Info_0_34, TargetVar_14, TargetVarEntry_71, &TargetLval_76);
              ml_backend__ml_code_util__ml_gen_var_4_p_0(STATE_VARIABLE_Info_0_34, SourceVar_15, SourceVarEntry_75, &SourceLval_77);
              {
                Var_80 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(2), Var_80, 0) = ((MR_Box) (SourceLval_77));
              }
              Stmt_78 = ml_backend__ml_code_util__ml_gen_assign_3_f_0(TargetLval_76, Var_80, Context_10);
              {
                MR_Word base;
        ...
        succeeded = ml_backend__ml_gen_info__ml_gen_info_search_const_var_3_p_0(STATE_VARIABLE_Info_0_34, SourceVar_15, &GroundTerm_79);
        if (succeeded)
          ml_backend__ml_gen_info__ml_gen_info_set_const_var_4_p_0(TargetVar_14, GroundTerm_79, STATE_VARIABLE_Info_0_34, STATE_VARIABLE_Info_35);
        else
        ...
        case (MR_Integer) 0:
          {
...

            {
              ...
              MR_hl_field(MR_mktag(0), Var_41, 0) = ((MR_Box) (&ml_backend__ml_unify_gen_scalar_common_2[0]));
              MR_hl_field(MR_mktag(0), Var_41, 1) = ((MR_Box) (ml_backend__ml_unify_gen__ml_generate_unification_7_p_0_4));
              MR_hl_field(MR_mktag(0), Var_41, 2) = ((MR_Box) ((MR_Integer) 2));
              MR_hl_field(MR_mktag(0), Var_41, 3) = ((MR_Box) (CodeModel_8));
  ...
  MR_Word * STATE_VARIABLE_Info_25)
{
  ...
  parse_tree__var_table__lookup_var_entry_3_p_0(VarTable_12, VarA_7, &VarAEntry_13);
    ...
    case (MR_Integer) 1:
      {
        ...
        if (succeeded)
        {
          ...
          EqOp_19 = (MR_Word) (MR_mkword(MR_mktag(3), &ml_backend__ml_unify_gen_scalar_common_1[2]));
        parse_tree__var_table__lookup_var_entry_3_p_0(VarTable_12, VarB_8, &VarBEntry_21);
        ...
        ml_backend__ml_code_util__ml_gen_var_4_p_0(STATE_VARIABLE_Info_0_24, VarB_8, VarBEntry_21, &VarLvalB_23);
        {
          ...
          MR_hl_field(MR_mktag(2), Var_29, 0) = ((MR_Box) (VarLvalA_22));
        }
        {
          Var_30 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(2), Var_30, 0) = ((MR_Box) (VarLvalB_23));
        }
        {
          ...
          MR_hl_field(MR_mktag(3), SidesAreEqualRval_17, 2) = ((MR_Box) (Var_29));
          MR_hl_field(MR_mktag(3), SidesAreEqualRval_17, 3) = ((MR_Box) (Var_30));
        }
      }
      break;
  }
