              ...
              case (MR_Integer) 1:
                {
                  ...
                  ml_backend__ml_code_util__ml_gen_var_4_p_0(STATE_VARIABLE_Info_0_34, VarB_17, VarBEntry_84, &VarLvalB_86);
                  {
                    ...
                    MR_hl_field(MR_mktag(2), Var_89, 0) = ((MR_Box) (VarLvalA_85));
                  }
                  {
                    Var_90 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(MR_mktag(2), Var_90, 0) = ((MR_Box) (VarLvalB_86));
                  }
                  {
                    ...
                    MR_hl_field(MR_mktag(3), SidesAreEqualRval_80, 2) = ((MR_Box) (Var_89));
                    MR_hl_field(MR_mktag(3), SidesAreEqualRval_80, 3) = ((MR_Box) (Var_90));
                  }
                }
                break;
            }
