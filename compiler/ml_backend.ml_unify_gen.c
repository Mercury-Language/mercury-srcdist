...
{
  {
    ...
    {
      libs__globals__lookup_bool_option_3_p_0(ml_backend__ml_unify_gen__Globals_41, (MR_Integer) 195, &ml_backend__ml_unify_gen__ProfileMemory_61);
    }
          ...
          case (MR_Integer) 13:
            {
              ...
              {
                libs__globals__lookup_int_option_3_p_0(ml_backend__ml_unify_gen__Globals_45, (MR_Integer) 238, &ml_backend__ml_unify_gen__NumTagBits_46);
              }
