    ...
    case (MR_Integer) 2:
      {
        ...
        hlds__var_table__lookup_var_entry_3_p_0(VarTable_70, TargetVar_14, &TargetVarEntry_71);
          ...
          case (MR_Integer) 1:
            {
              ...
              hlds__var_table__lookup_var_entry_3_p_0(VarTable_70, SourceVar_15, &SourceVarEntry_75);
