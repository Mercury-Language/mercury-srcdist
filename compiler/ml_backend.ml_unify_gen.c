    ...
    case (MR_Integer) 2:
      {
        ...
        IsDummyType_67 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), TargetVarEntry_64, (MR_Integer) 2))) & (MR_Integer) 1);
          ...
          case (MR_Integer) 1:
            {
              ...
              ml_backend__ml_code_util__ml_gen_var_4_p_0(STATE_VARIABLE_Info_0_34, SourceVar_15, SourceVarEntry_68, &SourceLval_70);
              {
                ...
                MR_hl_field(MR_mktag(2), Var_73, 0) = ((MR_Box) (SourceLval_70));
              }
        ...
        case (MR_Integer) 0:
          {
            ...
            Type_78 = ((MR_Word) ((MR_hl_field(MR_mktag(0), VarAEntry_76, (MR_Integer) 1))));
            IsDummyType_79 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), VarAEntry_76, (MR_Integer) 2))) & (MR_Integer) 1);
            switch (IsDummyType_79) {
              default: /*NOTREACHED*/ MR_assert(0);
              case (MR_Integer) 0:
                SidesAreEqualRval_80 = (MR_Word) (MR_mkword(MR_mktag(3), &ml_backend__ml_unify_gen_scalar_common_1[1]));
                break;
              case (MR_Integer) 1:
                {
                  MR_Word EqOp_82;
                  ...
                  if (succeeded)
                  {
                    BuiltinType_81 = ((MR_Word) ((MR_hl_field(MR_mktag(2), Type_78, (MR_Integer) 0))));
                      ...
                      case (MR_Integer) 0:
                        switch (MR_unmkbody(BuiltinType_81)) {
                          ...
                          case (MR_Integer) 1:
                            ...
                            break;
                          case (MR_Integer) 2:
                            EqOp_82 = (MR_Word) (MR_mkword(MR_mktag(3), &ml_backend__ml_unify_gen_scalar_common_1[2]));
                            break;
                        }
                        break;
                      case (MR_Integer) 1:
                        {
                          MR_Word IntType_83 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(1), BuiltinType_81, (MR_Integer) 0))) & (MR_Integer) 15);

                          {
                            EqOp_82 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                            MR_hl_field(MR_mktag(3), EqOp_82, 0) = ((MR_Box) ((MR_Unsigned) 8U));
                            MR_hl_field(MR_mktag(3), EqOp_82, 1) = (MR_Box) ((MR_Unsigned) (IntType_83));
                          }
                        }
                        break;
                    }
                  ...
                  ml_backend__ml_code_util__ml_gen_var_4_p_0(STATE_VARIABLE_Info_0_34, VarB_17, VarBEntry_84, &VarLvalB_86);
                  {
                    ...
                    MR_hl_field(MR_mktag(2), Var_90, 0) = ((MR_Box) (VarLvalA_85));
                  }
                  {
                    Var_91 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(MR_mktag(2), Var_91, 0) = ((MR_Box) (VarLvalB_86));
                  }
                  {
                    SidesAreEqualRval_80 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(MR_mktag(3), SidesAreEqualRval_80, 0) = ((MR_Box) ((MR_Unsigned) 6U));
                    MR_hl_field(MR_mktag(3), SidesAreEqualRval_80, 1) = ((MR_Box) (EqOp_82));
                    MR_hl_field(MR_mktag(3), SidesAreEqualRval_80, 2) = ((MR_Box) (Var_90));
                    MR_hl_field(MR_mktag(3), SidesAreEqualRval_80, 3) = ((MR_Box) (Var_91));
                  }
                }
                break;
            }
