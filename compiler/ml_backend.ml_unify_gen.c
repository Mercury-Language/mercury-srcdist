              ...
              case (MR_Integer) 1:
                {
                    ...
                    switch (MR_tag((MR_Word) BuiltinType_81)) {
                      ...
                      case (MR_Integer) 0:
                        switch (MR_unmkbody(BuiltinType_81)) {
                          default: /*NOTREACHED*/ MR_assert(0);
                          case (MR_Integer) 0:
                            EqOp_82 = (MR_Word) (MR_mkword(3, &ml_backend__ml_unify_gen_scalar_common_1[3]));
                            break;
                          case (MR_Integer) 1:
                            EqOp_82 = (MR_Word) (MR_mkword(3, &ml_backend__ml_unify_gen_scalar_common_1[4]));
                            break;
                          case (MR_Integer) 2:
                      ...
                      case (MR_Integer) 1:
                        {
...

                          {
                            ...
                            MR_hl_field(3, EqOp_82, 0) = ((MR_Box) ((MR_Unsigned) 4U));
                            MR_hl_field(3, EqOp_82, 1) = (MR_Box) (((((MR_Unsigned) (IntType_83) << 3)) | (MR_Unsigned) ((MR_Integer) 0)));
                          }
                        }
                        break;
                    }
                  ...
                  ml_backend__ml_code_util__ml_gen_var_4_p_0(STATE_VARIABLE_Info_0_34, VarB_17, VarBEntry_84, &VarLvalB_86);
                  {
                    ...
                    MR_hl_field(2, Var_95, 0) = ((MR_Box) (VarLvalA_85));
                  }
                  {
                    Var_96 = (MR_Word) MR_mkword(2, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(2, Var_96, 0) = ((MR_Box) (VarLvalB_86));
                  }
                  {
                    ...
                    MR_hl_field(3, SidesAreEqualRval_80, 2) = ((MR_Box) (Var_95));
                    MR_hl_field(3, SidesAreEqualRval_80, 3) = ((MR_Box) (Var_96));
                  }
                }
                break;
            }
