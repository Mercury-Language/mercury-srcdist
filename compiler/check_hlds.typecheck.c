...
{
  {
    ...
    hlds__goal_util__generate_simple_call_12_p_0(Var_49, CalleeName_41, (MR_Integer) 0, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), (MR_Integer) 0, (MR_Integer) 0, Var_54, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), Var_56, ModuleInfo_7, Context_37, &CallGoal_42);
