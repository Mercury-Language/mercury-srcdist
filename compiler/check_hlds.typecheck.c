...
{
  {
    ...
    libs__globals__lookup_int_option_3_p_0(Globals_10, (MR_Integer) 191, &MaxIterations_11);
      ...
      case (MR_Integer) 1:
        {
          ...
          succeeded = libs__globals__lookup_bool_option_3_p_1(Globals_16, (MR_Integer) 186, (MR_Integer) 1);
          if (succeeded)
          {
