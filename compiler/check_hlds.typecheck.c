  ...
  MR_Box closure_arg)
{
  ...
  succeeded = check_hlds__typecheck__IntroducedFrom__pred__handle_stubs_and_non_contiguous_clauses__460__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 4)))));
  return succeeded;
}
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = check_hlds__typecheck__IntroducedFrom__pred__typecheck_goal_expr__1497__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 4)))));
  return succeeded;
}
