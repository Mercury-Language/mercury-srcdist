...
MR_def_label(check_hlds__typecheck__construct_type_inference_messages_5_0,37)
	...
	MR_r4 = MR_tempr6;
	MR_tfield(0, MR_tempr6, 0) = MR_sv(8);
...
MR_def_label(check_hlds__typecheck__typecheck_clause_list_6_0,4)
	...
	MR_tfield(0, MR_tempr1, 2) = MR_tfield(0, MR_tempr2, 2);
	MR_tfield(0, MR_tempr1, 3) = MR_tfield(0, MR_tempr2, 3);
	MR_tfield(0, MR_tempr1, 4) = MR_tfield(0, MR_sv(4), 3);
	MR_tfield(0, MR_tempr1, 5) = MR_tfield(0, MR_tempr2, 5);
	MR_tfield(0, MR_tempr1, 6) = MR_tfield(0, MR_tempr2, 6);
	MR_tfield(0, MR_tempr1, 7) = MR_tfield(0, MR_tempr2, 7);
	MR_sv(3) = MR_r1;
...
MR_def_label(check_hlds__typecheck__do_typecheck_pred_7_0,14)
	...
	MR_sv(13) = (MR_Word) MR_TAG_COMMON(0,0,10);
