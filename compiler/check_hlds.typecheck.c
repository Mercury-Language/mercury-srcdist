...
MR_decl_static(fn__check_hlds__typecheck__IntroducedFrom__func__convert_cons_defn__3204__2_1_0)
...
{
MR_COMMON(3,1),
MR_ENTRY_AP(fn__check_hlds__typecheck__IntroducedFrom__func__convert_cons_defn__3204__2_1_0),
0
},
{
MR_COMMON(3,2),
...
MR_BEGIN_MODULE(check_hlds__typecheck_module73)
	MR_init_entry1(fn__check_hlds__typecheck__IntroducedFrom__func__convert_cons_defn__3204__2_1_0);
	MR_INIT_PROC_LAYOUT_ADDR(mercury__fn__check_hlds__typecheck__IntroducedFrom__func__convert_cons_defn__3204__2_1_0);
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'IntroducedFrom__func__convert_cons_defn__3204__2'/2 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(fn__check_hlds__typecheck__IntroducedFrom__func__convert_cons_defn__3204__2_1_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_tfield(0, MR_r1, 1);
	MR_proceed();
#ifdef MR_maybe_local_thread_engine_base
