...
{
  {
    ...
    libs__globals__lookup_int_option_3_p_0(Globals_10, (MR_Integer) 196, &MaxIterations_11);
  ...
  MR_Word * ExceededIterationLimit_19)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals_29, (MR_Integer) 75, &DebugTypes_30);
      ...
      case (MR_Integer) 1:
        {
          ...
          succeeded = libs__globals__lookup_bool_option_3_p_1(Globals_14, (MR_Integer) 191, (MR_Integer) 1);
          if (succeeded)
          {
...
{
  {
    ...
    if ((AllOtherDeclaredPredIds_35 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(1), Var_66, 0) = (MR_Box) (((((MR_Unsigned) ((MR_Integer) 58) << 1)) | (MR_Unsigned) ((MR_Integer) 1)));
