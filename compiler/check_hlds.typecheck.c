      ...
      case (MR_Integer) 1:
        {
          ...
          {
            check_hlds__typecheck__succeeded = libs__globals__lookup_bool_option_3_p_1(check_hlds__typecheck__Globals_16, (MR_Integer) 170, (MR_Integer) 1);
          }
          if (check_hlds__typecheck__succeeded)
            {
            ...
            if (check_hlds__typecheck__succeeded)
              {
                ...
                {
                  check_hlds__typecheck__V_54_54 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                  MR_hl_field(MR_mktag(1), check_hlds__typecheck__V_54_54, 0) = ((MR_Box) (((MR_Integer) 46 | (((MR_Integer) 1 << (MR_Integer) 10)))));
      ...
      /* tailcall optimized into a loop */
      {
        ...
        if (check_hlds__typecheck__succeeded)
        ...
        else
          {
            ...
            {
              libs__globals__lookup_bool_option_3_p_0(check_hlds__typecheck__Globals_29, (MR_Integer) 62, &check_hlds__typecheck__DebugTypes_30);
            }
...
{
  {
    ...
    {
      libs__globals__lookup_int_option_3_p_0(check_hlds__typecheck__Globals_10, (MR_Integer) 175, &check_hlds__typecheck__MaxIterations_11);
    }
    {
