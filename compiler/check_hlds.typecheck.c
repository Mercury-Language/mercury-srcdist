...
{
  {
    ...
    switch (MR_tag((MR_Word) RHS0_15)) {
      ...
      case (MR_Integer) 2:
        {
          MR_Word Purity_23 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(2), RHS0_15, (MR_Integer) 0))) >> (MR_Integer) 2)) & (MR_Integer) 3);
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(2), RHS_84, 5) = (MR_Box) (packed_args_1);
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        {
          Var_54 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), Var_54, 0) = (MR_Box) (((((MR_Unsigned) (((MR_Box) ((MR_Integer) 56))) << (MR_Integer) 1)) | (MR_Unsigned) (((MR_Box) ((MR_Integer) 1)))));
