...

  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          SpecialPredId_39 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(1), Var_44, (MR_Integer) 0))) & (MR_Integer) 3);
          TypeCtor_40 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Var_44, (MR_Integer) 1))));
  ...
  MR_Word * Origin_6)
{
  ...
  if (succeeded)
  {
    ...
    if (succeeded)
    {
      MethodName_8 = ((MR_Word) ((MR_hl_field(MR_mktag(3), OriginUser0_7, (MR_Integer) 1))));
  ...
  if (succeeded)
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(3), OriginUser_18, 1) = ((MR_Box) (MethodName_8));
