  ...
  MR_Word * NumberOfIterations_11)
{
  ...
  libs__globals__lookup_int_option_3_p_0(Globals_12, (MR_Integer) 237, &MaxIterations_13);
  ...
  MR_Word * NumberOfIterations_21)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals_31, (MR_Integer) 96, &DebugTypes_32);
      ...
      case (MR_Integer) 1:
        {
          ...
          succeeded = libs__globals__lookup_bool_option_3_p_1(Globals_48, (MR_Integer) 232, (MR_Integer) 1);
          if (succeeded)
          {
