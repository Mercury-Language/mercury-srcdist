      ...
      case (MR_Integer) 1:
        {
          ...
          {
            check_hlds__typecheck__succeeded = libs__globals__lookup_bool_option_3_p_1(check_hlds__typecheck__Globals_16, (MR_Integer) 178, (MR_Integer) 1);
          }
          if (check_hlds__typecheck__succeeded)
            {
            ...
            if (check_hlds__typecheck__succeeded)
              {
                ...
                {
                  check_hlds__typecheck__V_54_54 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                  MR_hl_field(MR_mktag(1), check_hlds__typecheck__V_54_54, 0) = ((MR_Box) (((MR_Integer) 54 | (((MR_Integer) 1 << (MR_Integer) 10)))));
...
{
  {
    ...
    {
      libs__globals__lookup_int_option_3_p_0(check_hlds__typecheck__Globals_10, (MR_Integer) 183, &check_hlds__typecheck__MaxIterations_11);
    }
    {
