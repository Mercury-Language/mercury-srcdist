  ...
  MR_Word * STATE_VARIABLE_Info_19)
{
  ...
  MR_Word Status_11 = ((MR_Unsigned) ((MR_hl_field(0, Coercion_6, (MR_Integer) 3))) & (MR_Integer) 3);
  MR_Word TVarSet_12;
  ...
  switch (Status_11) {
    ...
    case (MR_Integer) 0:
      ...
      break;
    case (MR_Integer) 2:
      Spec_17 = check_hlds__typecheck_errors__report_redundant_coerce_4_f_0(ClauseContext_16, Context_10, TVarSet_12, FromType_14);
      break;
    case (MR_Integer) 1:
  ...
  MR_Word * NumberOfIterations_11)
{
  ...
  libs__globals__lookup_int_option_3_p_0(Globals_12, (MR_Integer) 246, &MaxIterations_13);
  ...
  MR_Word * NumberOfIterations_21)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals_31, (MR_Integer) 105, &DebugTypes_32);
      ...
      case (MR_Integer) 1:
        {
          ...
          succeeded = libs__globals__lookup_bool_option_3_p_1(Globals_48, (MR_Integer) 241, (MR_Integer) 1);
          if (succeeded)
          {
  ...
  MR_Box * wrapper_arg_3)
{
  ...
  check_hlds__typecheck__report_coercion_4_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) (wrapper_arg_1)), ((MR_Word) (wrapper_arg_2)), &conv0_STATE_VARIABLE_Info_19);
