...
MR_decl_label10(check_hlds__typecheck__typecheck_goal_2_5_0, 75,77,78,79,80,83,85,88,90,91)
...
MR_BEGIN_MODULE(check_hlds__typecheck_module43)
	...
	MR_init_label10(check_hlds__typecheck__typecheck_goal_2_5_0,75,77,78,79,80,83,85,88,90,91)
...
MR_def_label(check_hlds__typecheck__make_field_access_function_cons_type_info_8_0,13)
	...
	MR_tfield(0, MR_tempr1, 1) = (MR_Word) MR_ENTRY_AP(check_hlds__typecheck__IntroducedFrom__pred__get_field_access_constructor__2726__1_2_0);
	MR_tfield(0, MR_tempr1, 2) = (MR_Integer) 1;
	MR_tfield(0, MR_tempr1, 3) = MR_sv(8);
	MR_tempr2 = MR_r1;
	MR_r1 = MR_sv(3);
