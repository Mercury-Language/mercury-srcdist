...
check_hlds__typecheck__IntroducedFrom__pred__handle_stubs_and_non_contiguous_clauses__459__1_2_p_0(
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = check_hlds__typecheck__IntroducedFrom__pred__handle_stubs_and_non_contiguous_clauses__459__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 4)))));
  return succeeded;
}
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          succeeded = parse_tree__prog_type__identical_up_to_renaming_2_p_0(TypesListA_19, TypesListB_20);
        }
      }
    }
  }
