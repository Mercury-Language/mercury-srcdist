  ...
  MR_Box * wrapper_arg_5)
{
  ...
  check_hlds__typecheck__check_mention_existq_var_8_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) ((MR_hl_field(0, closure, 4)))), ((MR_Word) ((MR_hl_field(0, closure, 5)))), ((MR_Word) (wrapper_arg_1)), ((MR_Integer) (wrapper_arg_2)), &conv1_STATE_VARIABLE_ExistQVarNum_21, ((MR_Word) (wrapper_arg_4)), &conv0_STATE_VARIABLE_Info_23);
  ...
  MR_Word * STATE_VARIABLE_Info_22)
{
  ...
  Var_23 = ((MR_Word) ((MR_hl_field(0, Goal_10, 0))));
  succeeded = ((((MR_tag((MR_Word) Var_23)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(3, Var_23, 0)))) == (MR_Integer) 1)));
  if (succeeded)
  {
    Impl_17 = ((MR_Word) ((MR_hl_field(3, Var_23, 7))));
    {
      MR_Word Context_19 = ((MR_Word) ((MR_hl_field(0, Clause_8, 3))));
      MR_Word Var_24;
      MR_Box conv3__N_20;
  ...
  MR_Word * NumberOfIterations_11)
{
  ...
  libs__globals__lookup_int_option_3_p_0(Globals_12, (MR_Integer) 255, &MaxIterations_13);
  ...
  MR_Word * NumberOfIterations_21)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals_31, (MR_Integer) 112, &DebugTypes_32);
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = check_hlds__typecheck__IntroducedFrom__pred__handle_stubs_and_non_contiguous_clauses__462__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) ((MR_hl_field(0, closure, 4)))));
  return succeeded;
}
  ...
  MR_Word * NextIteration_17)
{
  ...
  else
  {
    ...
    switch (ClausesRep0IsEmpty_47) {
      ...
      case (MR_Integer) 0:
        {
          check_hlds__typecheck_msgs__maybe_check_for_and_report_any_non_contiguous_clauses_5_p_0(ModuleInfo_11, PredId_12, STATE_VARIABLE_PredInfo_0_21, ItemNumbers0_46, &STATE_VARIABLE_Specs_1_67);
      ...
      case (MR_Integer) 1:
        {
          ...
          succeeded = libs__globals__lookup_bool_option_3_p_1(Globals_48, (MR_Integer) 250, (MR_Integer) 1);
          if (succeeded)
          {
      ...
      case (MR_Integer) 1:
        {
          ...
          succeeded = hlds__hlds_markers__marker_is_present_2_p_0(Markers0_43, (MR_Integer) 11);
          if (succeeded)
          {
            MR_Word HeadVars_53;
            MR_Word ArgTypes_56;
  ...
  MR_Word * STATE_VARIABLE_PredInfo_33)
{
  ...
  {
    StubClause_24 = (MR_Word) MR_new_object(MR_Word, (6 * sizeof(MR_Word)), NULL, NULL);
  ...
  MR_Box * wrapper_arg_3)
{
  ...
  check_hlds__typecheck__check_existq_clause_5_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) ((MR_hl_field(0, closure, 4)))), ((MR_Word) (wrapper_arg_1)), ((MR_Word) (wrapper_arg_2)), &conv0_STATE_VARIABLE_Info_22);
  ...
  MR_Word * NextIteration_14)
{
  ...
  check_hlds__type_assign__type_assign_set_init_5_p_0(TypeVarSet0_25, ExplicitVarTypes0_23, STATE_VARIABLE_ExternalTypeParams_1_85, Constraints_35, &STATE_VARIABLE_TypeAssignSet_1_96);
    ...
    case (MR_Integer) 1:
      {
        ...
        hlds__hlds_markers__add_marker_3_p_0((MR_Integer) 28, PredMarkers0_36, &PredMarkers_40);
  ...
  check_hlds__typecheck_clauses__typecheck_check_for_ambiguity_6_p_0(Context_41, (MR_Integer) 1, HeadVars_21, STATE_VARIABLE_TypeAssignSet_3_102, STATE_VARIABLE_Info_3_103, &STATE_VARIABLE_Info_4_105);
    ...
    case (MR_Integer) 0:
      {
        ...
        MR_Word STATE_VARIABLE_PredInfo_11_123;
        MR_Word STATE_VARIABLE_PredInfo_12_124;
        ...
        if ((ExistQVars0_27 == (MR_Word) ((MR_Unsigned) 0U)))
        {
          ...
          STATE_VARIABLE_Info_6_122 = STATE_VARIABLE_Info_5_106;
        }
        else
        {
          MR_Word Var_121;
          MR_Box conv1_STATE_VARIABLE_Info_6_122;
          ...
          mercury__list__foldl_4_p_0((MR_Word) (&hlds__hlds_clauses__hlds__hlds_clauses__type_ctor_info_clause_0), (MR_Word) (&check_hlds__typecheck_info__check_hlds__typecheck_info__type_ctor_info_typecheck_info_0), Var_121, Clauses_38, ((MR_Box) (STATE_VARIABLE_Info_5_106)), &conv1_STATE_VARIABLE_Info_6_122);
          STATE_VARIABLE_Info_6_122 = ((MR_Word) (conv1_STATE_VARIABLE_Info_6_122));
        ...
        hlds__hlds_pred__pred_info_set_arg_types_5_p_0(TypeVarSet_42, ExistQVars_127, RenamedOldArgTypes_73, STATE_VARIABLE_PredInfo_10_120, &STATE_VARIABLE_PredInfo_11_123);
        hlds__hlds_pred__pred_info_set_class_context_3_p_0(RenamedOldConstraints_74, STATE_VARIABLE_PredInfo_11_123, &STATE_VARIABLE_PredInfo_12_124);
        hlds__hlds_pred__pred_info_set_origin_3_p_0(Origin_75, STATE_VARIABLE_PredInfo_12_124, STATE_VARIABLE_PredInfo_77);
  ...
  check_hlds__typecheck_info__typecheck_info_get_all_errors_2_p_0(STATE_VARIABLE_Info_6_122, STATE_VARIABLE_Specs_79);
}
