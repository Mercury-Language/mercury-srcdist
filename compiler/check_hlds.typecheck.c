              ...
              case (MR_Integer) 0:
                {
                  ...
                  if (succeeded)
                  {
                    ...
                    if (succeeded)
                    {
                      TypeInfo_69_69 = (MR_Word) (&check_hlds__typecheck_scalar_common_1[11]);
                      succeeded = mercury__builtin__unify_2_p_0(TypeInfo_69_69, ((MR_Box) (CurTypeParams_9)), ((MR_Box) (Var_67)));
                    }
                  }
                  if (succeeded)
                    *STATE_VARIABLE_InvariantSet_36 = STATE_VARIABLE_InvariantSet_0_35;
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          TypeInfo_24_29 = (MR_Word) (&check_hlds__typecheck_scalar_common_1[1]);
          succeeded = mercury__set__contains_2_p_0(TypeInfo_24_29, InvariantSet_11, ((MR_Box) (TypeVar_16)));
          if (succeeded)
          {
...

      {
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            ...
            TypeCtorInfo_12_88 = (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_type_ctor_0);
            succeeded = mercury__list__member_2_p_0(TypeCtorInfo_12_88, ((MR_Box) (TypeCtor_83)), Var_87);
            succeeded = !(succeeded);
            if (succeeded)
            {
