  ...
  MR_Word * NextIteration_17)
{
  ...
  if (!(succeeded))
  {
    ...
    if (succeeded)
    {
      ...
      Var_33 = (MR_Integer) 1;
      succeeded = hlds__hlds_pred__marker_is_present_2_p_0(Markers_28, Var_33);
      succeeded = !(succeeded);
    }
  }
  if (succeeded)
      ...
      case (MR_Integer) 1:
        {
          ...
          if (succeeded)
          {
            ...
            succeeded = hlds__hlds_pred__marker_is_present_2_p_0(Markers0_43, Var_66);
            succeeded = !(succeeded);
          }
          if (succeeded)
          {
          ...
          {
            succeeded = hlds__hlds_pred__marker_is_present_2_p_0(Markers0_43, (MR_Integer) 1);
            if (succeeded)
            {
      ...
      case (MR_Integer) 1:
        {
          ...
          succeeded = hlds__hlds_pred__marker_is_present_2_p_0(Markers0_43, (MR_Integer) 11);
          if (succeeded)
          {
            MR_Word HeadVars_53;
            MR_Word ArgTypes_56;
  ...
  MR_Word * NextIteration_14)
{
  ...
  succeeded = hlds__hlds_pred__marker_is_present_2_p_0(Markers0_29, (MR_Integer) 2);
  if (succeeded)
  {
