...
static const MR_FA_PseudoTypeInfo_Struct1 check_hlds__typecheck__list__pti_list_1__plain_parse_tree__error_spec__type_ctor_info_diag_spec_0;
...
static const MR_DuFunctorDesc check_hlds__typecheck__check_hlds__typecheck__du_functor_desc_number_of_iterations_0_0;

static const MR_PseudoTypeInfo check_hlds__typecheck__check_hlds__typecheck__field_types_number_of_iterations_0_1[1];

static const MR_DuFunctorDesc check_hlds__typecheck__check_hlds__typecheck__du_functor_desc_number_of_iterations_0_1;

static const MR_DuFunctorDescPtr check_hlds__typecheck__check_hlds__typecheck__du_stag_ordered_number_of_iterations_0_0[1];

static const MR_DuFunctorDescPtr check_hlds__typecheck__check_hlds__typecheck__du_stag_ordered_number_of_iterations_0_1[1];

static const MR_DuPtagLayout check_hlds__typecheck__check_hlds__typecheck__du_ptag_ordered_number_of_iterations_0[2];

static const MR_DuFunctorDescPtr check_hlds__typecheck__check_hlds__typecheck__du_name_ordered_number_of_iterations_0[2];

static const MR_Integer check_hlds__typecheck__check_hlds__typecheck__functor_number_map_number_of_iterations_0[2];

static MR_bool MR_CALL 
check_hlds__typecheck__IntroducedFrom__pred__handle_stubs__455__1_2_p_0(
...
static /* final */ const MR_Box check_hlds__typecheck_scalar_common_3[2][5] = {
  ...
  /* row   1 */
  {
    ...
    ((MR_Box) (NULL)),
    ((MR_Box) ((MR_Integer) 2)),
    ((MR_Box) (&check_hlds__typecheck__list__pti_list_1__plain_parse_tree__error_spec__type_ctor_info_diag_spec_0)),
    ((MR_Box) (&check_hlds__typecheck__list__pti_list_1__plain_parse_tree__error_spec__type_ctor_info_diag_spec_0))
  },
};
...
static const MR_PseudoTypeInfo check_hlds__typecheck__check_hlds__typecheck__field_types_number_of_iterations_0_1[1] = { (MR_PseudoTypeInfo) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_diag_spec_0) };
...
static const MR_DuFunctorDesc check_hlds__typecheck__check_hlds__typecheck__du_functor_desc_number_of_iterations_0_1 = {
  ...
  (MR_Integer) -1,
  INT32_C(1),
  check_hlds__typecheck__check_hlds__typecheck__field_types_number_of_iterations_0_1,
  NULL,
  NULL,
  NULL,
  MR_FUNCTOR_SUBTYPE_NONE,
...
static const MR_DuFunctorDescPtr check_hlds__typecheck__check_hlds__typecheck__du_stag_ordered_number_of_iterations_0_0[1] = { &check_hlds__typecheck__check_hlds__typecheck__du_functor_desc_number_of_iterations_0_0 };

static const MR_DuFunctorDescPtr check_hlds__typecheck__check_hlds__typecheck__du_stag_ordered_number_of_iterations_0_1[1] = { &check_hlds__typecheck__check_hlds__typecheck__du_functor_desc_number_of_iterations_0_1 };

static const MR_DuPtagLayout check_hlds__typecheck__check_hlds__typecheck__du_ptag_ordered_number_of_iterations_0[2] = {
  {
    UINT32_C(1),
    MR_SECTAG_LOCAL_REST_OF_WORD,
    check_hlds__typecheck__check_hlds__typecheck__du_stag_ordered_number_of_iterations_0_0,
    INT8_C(-1),
    UINT8_C(0),
    UINT8_C(1)
  },
  {
    UINT32_C(1),
    MR_SECTAG_NONE,
    check_hlds__typecheck__check_hlds__typecheck__du_stag_ordered_number_of_iterations_0_1,
    INT8_C(-1),
    UINT8_C(1),
    UINT8_C(1)
  }
...
static const MR_DuFunctorDescPtr check_hlds__typecheck__check_hlds__typecheck__du_name_ordered_number_of_iterations_0[2] = {
  &check_hlds__typecheck__check_hlds__typecheck__du_functor_desc_number_of_iterations_0_1,
  &check_hlds__typecheck__check_hlds__typecheck__du_functor_desc_number_of_iterations_0_0
};
...
const MR_TypeCtorInfo_Struct check_hlds__typecheck__check_hlds__typecheck__type_ctor_info_number_of_iterations_0 = {
  ...
  { check_hlds__typecheck__check_hlds__typecheck__du_name_ordered_number_of_iterations_0 },
  { check_hlds__typecheck__check_hlds__typecheck__du_ptag_ordered_number_of_iterations_0 },
  (MR_Integer) 2,
  UINT16_C(12),
  ...
  MR_Word * STATE_VARIABLE_Info_21)
{
  ...
  MR_Word Fails_13 = ((MR_Word) ((MR_hl_field(0, Coercion_6, 5))));
  MR_Word TVarSet_14;
  ...
  parse_tree__prog_type_subst__apply_rec_subst_to_type_3_p_0(TypeBindings_15, FromType0_8, &FromType_16);
  parse_tree__prog_type_subst__apply_rec_subst_to_type_3_p_0(TypeBindings_15, ToType0_9, &ToType_17);
  check_hlds__typecheck_info__typecheck_info_get_error_clause_context_2_p_0(STATE_VARIABLE_Info_0_20, &ClauseContext_18);
  switch (Status_12) {
    ...
    case (MR_Integer) 0:
      ...
      break;
    case (MR_Integer) 2:
      Spec_19 = check_hlds__typecheck_errors__report_unresolved_coerce_from_to_6_f_0(ClauseContext_18, Context_10, FromVar_11, TVarSet_14, FromType_16, ToType_17);
      break;
    case (MR_Integer) 3:
      Spec_19 = check_hlds__typecheck_errors__report_redundant_coerce_5_f_0(ClauseContext_18, Context_10, FromVar_11, TVarSet_14, FromType_16);
      break;
    case (MR_Integer) 1:
      Spec_19 = check_hlds__typecheck_errors__report_invalid_coerce_from_to_7_f_0(ClauseContext_18, Context_10, FromVar_11, TVarSet_14, FromType_16, ToType_17, Fails_13);
      break;
  }
  check_hlds__typecheck_info__typecheck_info_add_error_3_p_0(Spec_19, STATE_VARIABLE_Info_0_20, STATE_VARIABLE_Info_21);
}
  ...
  MR_Word * NumberOfIterations_11)
{
  ...
  OrigValidPredIds_15 = mercury__set_tree234__to_sorted_list_1_f_0((MR_Word) (&hlds__pred_proc_id__hlds__pred_proc_id__type_ctor_info_pred_id_0), OrigValidPredIdSet_14);
  ...
  *Specs_9 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_diag_spec_0), InferSpecs_18, CheckSpecs_17);
}
  ...
  MR_Word * NumberOfIterations_21)
{
  while (MR_TRUE)
  {
    ...
    ;
    hlds__hlds_module__module_info_get_pred_id_table_2_p_0(STATE_VARIABLE_ModuleInfo_0_38, &PredIdTable0_22);
    mercury__map__to_assoc_list_2_p_0((MR_Word) (&hlds__pred_proc_id__hlds__pred_proc_id__type_ctor_info_pred_id_0), (MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_info_0), PredIdTable0_22, &PredIdsInfos0_23);
    check_hlds__typecheck__typecheck_module_one_iteration_14_p_0(ProgressStream_12, STATE_VARIABLE_ModuleInfo_0_38, OrigValidPredIdSet_17, PredIdsInfos0_23, (MR_Word) ((MR_Unsigned) 0U), &RevPredIdsInfos_24, (MR_Word) ((MR_Unsigned) 0U), &NewlyInvalidPredIds_25, (MR_Word) ((MR_Unsigned) 0U), &CurSpecs_26, (MR_Integer) 0, &CurFoundSyntaxError_27, (MR_Integer) 0, &NextIteration_28);
    mercury__map__from_rev_sorted_assoc_list_2_p_0((MR_Word) (&hlds__pred_proc_id__hlds__pred_proc_id__type_ctor_info_pred_id_0), (MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_info_0), RevPredIdsInfos_24, &PredIdTable_29);
    hlds__hlds_module__module_info_set_pred_id_table_3_p_0(PredIdTable_29, STATE_VARIABLE_ModuleInfo_0_38, &STATE_VARIABLE_ModuleInfo_1_45);
    hlds__hlds_module__module_info_make_pred_ids_invalid_3_p_0(NewlyInvalidPredIds_25, STATE_VARIABLE_ModuleInfo_1_45, &STATE_VARIABLE_ModuleInfo_2_46);
    hlds__hlds_module__module_info_get_valid_pred_id_set_2_p_0(STATE_VARIABLE_ModuleInfo_2_46, &NewValidPredIdSet_30);
    hlds__hlds_module__module_info_get_globals_2_p_0(STATE_VARIABLE_ModuleInfo_2_46, &Globals_31);
    succeeded = (NextIteration_28 == (MR_Integer) 0);
    if (!(succeeded))
    {
      MR_Word Var_47;

      Var_47 = parse_tree__error_util__contains_errors_2_f_0(Globals_31, CurSpecs_26);
    ...
    if (succeeded)
    {
      ...
      *NumberOfIterations_21 = (MR_Word) ((MR_Unsigned) 0U);
      *STATE_VARIABLE_ModuleInfo_39 = STATE_VARIABLE_ModuleInfo_2_46;
    }
    else
    {
      MR_Word DebugTypes_32;

      libs__globals__lookup_bool_option_3_p_0(Globals_31, (MR_Integer) 699, &DebugTypes_32);
        ...
        case (MR_Integer) 1:
          {
            ...
            MR_Word DebugStream_36;

            check_hlds__typecheck_msgs__construct_type_inference_messages_5_p_0(STATE_VARIABLE_ModuleInfo_2_46, NewValidPredIdSet_30, OrigValidPredIds_16, (MR_Word) ((MR_Unsigned) 0U), &ProgressSpecs_33);
            hlds__hlds_module__module_info_get_name_2_p_0(STATE_VARIABLE_ModuleInfo_2_46, &ModuleName_35);
            libs__globals__get_debug_output_stream_5_p_0(Globals_31, ModuleName_35, &DebugStream_36);
            parse_tree__write_error_spec__write_diag_specs_5_p_0(DebugStream_36, Globals_31, ProgressSpecs_33);
          }
          break;
      }
      ...
      if (succeeded)
      {
        MR_Integer Var_53 = (MR_Integer) ((MR_Unsigned) Iteration_13 + (MR_Unsigned) 1);
        MR_Integer next_value_of_Iteration_13 = Var_53;
        MR_Word next_value_of_STATE_VARIABLE_ModuleInfo_0_38 = STATE_VARIABLE_ModuleInfo_2_46;

        // direct tailcall eliminated
        ;
        Iteration_13 = next_value_of_Iteration_13;
        STATE_VARIABLE_ModuleInfo_0_38 = next_value_of_STATE_VARIABLE_ModuleInfo_0_38;
        continue;
      }
      else
      {
        ...
        *FinalValidPredIdSet_18 = NewValidPredIdSet_30;
        *FoundSyntaxError_20 = CurFoundSyntaxError_27;
        Spec_37 = check_hlds__typecheck_msgs__typecheck_report_max_iterations_exceeded_1_f_0(MaxIterations_14);
        {
          MR_Word base;
  ...
  MR_Word * STATE_VARIABLE_NextIteration_14)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      if (!(succeeded))
      {
        succeeded = mercury__set_tree234__contains_2_p_0((MR_Word) (&hlds__pred_proc_id__hlds__pred_proc_id__type_ctor_info_pred_id_0), ValidPredIdSet_3, ((MR_Box) (PredId_43)));
        succeeded = !(succeeded);
      }
      if (succeeded)
      {
      ...
      else
      {
        ...
        STATE_VARIABLE_Specs_2_68 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_diag_spec_0), PredSpecs_46, STATE_VARIABLE_Specs_0_9);
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = check_hlds__typecheck__IntroducedFrom__pred__handle_stubs__455__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) ((MR_hl_field(0, closure, 4)))));
  return succeeded;
}
  ...
  MR_Word * NextIteration_17)
{
...

  {
    ...
    succeeded = hlds__hlds_pred_tests__is_unify_index_or_compare_pred_1_p_0(STATE_VARIABLE_PredInfo_0_21);
    if (succeeded)
    {
  ...
  if (!(succeeded))
  {
    ...
    succeeded = hlds__hlds_pred_tests__pred_info_is_builtin_1_p_0(STATE_VARIABLE_PredInfo_0_21);
    if (succeeded)
    {
  ...
  MR_Box * wrapper_arg_3)
{
  ...
  check_hlds__typecheck__report_coercion_4_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) (wrapper_arg_1)), ((MR_Word) (wrapper_arg_2)), &conv0_STATE_VARIABLE_Info_21);
