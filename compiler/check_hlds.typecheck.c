  ...
  MR_Word * STATE_VARIABLE_Info_33)
{
  ...
  else
  {
    ...
    else
    {
      ...
      MR_Word SymNamePredFormArity_54;
      MR_Word Symbol_55;
      MR_Word ModuleInfo_56;
      MR_Word ClassTable_57;
      MR_Word PredicateTable_58;
      MR_Word PredIdTable_59;
      MR_Word ArgsTypeAssignSet_60;
      MR_Word VarVectorKind_61;
      MR_Word STATE_VARIABLE_Info_29_62;
      MR_Word Var_64;
      MR_Word PredId_75;
      MR_Word PredIds_76;
      MR_Word PredInfo_82;
      MR_Word PredTypeVarSet_83;
      MR_Word PredExistQVars_84;
      MR_Word PredArgTypes_85;
      MR_Word PredClassContext_86;
      MR_Word TVarSet_87;
      MR_Word PredConstraints_88;
      MR_Word STATE_VARIABLE_ArgsTypeAssignSet_31_91;
      MR_Box conv0_PredInfo_82;

      PredFormArity_53 = parse_tree__prog_data__arg_list_arity_1_f_0((MR_Word) (&check_hlds__typecheck_scalar_common_1[2]), ArgVars_13);
      {
        SymNamePredFormArity_54 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), SymNamePredFormArity_54, 0) = ((MR_Box) (SymName_10));
        MR_hl_field(MR_mktag(0), SymNamePredFormArity_54, 1) = ((MR_Box) (PredFormArity_53));
      }
      {
        Symbol_55 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), Symbol_55, 0) = ((MR_Box) (SymNamePredFormArity_54));
        MR_hl_field(MR_mktag(0), Symbol_55, 1) = ((MR_Box) (PredIds_22));
      }
      check_hlds__typecheck_info__typecheck_info_add_overloaded_symbol_4_p_0(Symbol_55, Context_11, STATE_VARIABLE_Info_0_32, &STATE_VARIABLE_Info_29_62);
      check_hlds__typecheck_info__typecheck_info_get_module_info_2_p_0(STATE_VARIABLE_Info_29_62, &ModuleInfo_56);
      hlds__hlds_module__module_info_get_class_table_2_p_0(ModuleInfo_56, &ClassTable_57);
      hlds__hlds_module__module_info_get_predicate_table_2_p_0(ModuleInfo_56, &PredicateTable_58);
      hlds__pred_table__predicate_table_get_pred_id_table_2_p_0(PredicateTable_58, &PredIdTable_59);
      PredId_75 = ((MR_Word) ((MR_hl_field(MR_mktag(1), PredIds_22, (MR_Integer) 0))));
      PredIds_76 = ((MR_Word) ((MR_hl_field(MR_mktag(1), PredIds_22, (MR_Integer) 1))));
      mercury__map__lookup_3_p_0((MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_id_0), (MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_info_0), PredIdTable_59, ((MR_Box) (PredId_75)), &conv0_PredInfo_82);
      PredInfo_82 = ((MR_Word) (conv0_PredInfo_82));
      hlds__hlds_pred__pred_info_get_arg_types_4_p_0(PredInfo_82, &PredTypeVarSet_83, &PredExistQVars_84, &PredArgTypes_85);
      hlds__hlds_pred__pred_info_get_class_context_2_p_0(PredInfo_82, &PredClassContext_86);
      hlds__hlds_pred__pred_info_get_typevarset_2_p_0(PredInfo_82, &TVarSet_87);
      hlds__hlds_class__make_body_hlds_constraints_5_p_0(ClassTable_57, TVarSet_87, GoalId_12, PredClassContext_86, &PredConstraints_88);
      check_hlds__typecheck__rename_apart_7_p_0(STATE_VARIABLE_TypeAssignSet_0_30, PredTypeVarSet_83, PredExistQVars_84, PredArgTypes_85, PredConstraints_88, (MR_Word) ((MR_Unsigned) 0U), &STATE_VARIABLE_ArgsTypeAssignSet_31_91);
      check_hlds__typecheck__get_overloaded_pred_arg_types_7_p_0(PredIds_76, PredIdTable_59, ClassTable_57, GoalId_12, STATE_VARIABLE_TypeAssignSet_0_30, STATE_VARIABLE_ArgsTypeAssignSet_31_91, &ArgsTypeAssignSet_60);
      {
        Var_64 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(2), Var_64, 0) = ((MR_Box) (SymNamePredFormArity_54));
      }
      {
        VarVectorKind_61 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), VarVectorKind_61, 0) = ((MR_Box) (Var_64));
      }
      check_hlds__typecheck__typecheck_var_has_arg_type_list_8_p_0(VarVectorKind_61, (MR_Integer) 1, Context_11, ArgVars_13, ArgsTypeAssignSet_60, &STATE_VARIABLE_TypeAssignSet_37_37, STATE_VARIABLE_Info_29_62, &STATE_VARIABLE_Info_38_38);
      *PredId_14 = hlds__hlds_pred__invalid_pred_id_0_f_0();
    }
  ...
  MR_Word * STATE_VARIABLE_PredInfo_17)
{
  ...
  Var_50 = mdbcomp__builtin_modules__mercury_private_builtin_module_0_f_0();
  {
    ...
    MR_hl_field(MR_mktag(1), Var_52, 0) = ((MR_Box) (PredNameVar_38));
    MR_hl_field(MR_mktag(1), Var_52, 1) = ((MR_Box) ((MR_Unsigned) 0U));
  }
  Var_53 = hlds__instmap__instmap_delta_bind_no_var_0_f_0();
  hlds__goal_util__generate_plain_call_13_p_0(ModuleInfo_5, (MR_Integer) 0, Var_50, CalleeName_41, (MR_Word) ((MR_Unsigned) 0U), Var_52, Var_53, (MR_Word) ((MR_Unsigned) 0U), (MR_Integer) 0, (MR_Integer) 0, (MR_Word) ((MR_Unsigned) 0U), Context_37, &CallGoal_42);
  hlds__hlds_goal__goal_info_init_2_p_0(Context_37, &GoalInfo_43);
  {
    Var_62 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(MR_mktag(1), Var_62, 0) = ((MR_Box) (CallGoal_42));
    MR_hl_field(MR_mktag(1), Var_62, 1) = ((MR_Box) ((MR_Unsigned) 0U));
  }
  {
    Var_61 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(MR_mktag(1), Var_61, 0) = ((MR_Box) (UnifyGoal_39));
    MR_hl_field(MR_mktag(1), Var_61, 1) = ((MR_Box) (Var_62));
  }
  {
    ...
    MR_hl_field(MR_mktag(3), Var_59, 1) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 0));
    MR_hl_field(MR_mktag(3), Var_59, 2) = ((MR_Box) (Var_61));
  }
  {
    Body_44 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(MR_mktag(0), Body_44, 0) = ((MR_Box) (Var_59));
