...
{
  {
    ...
    libs__globals__lookup_int_option_3_p_0(Globals_10, (MR_Integer) 215, &MaxIterations_11);
  ...
  MR_Word * ExceededIterationLimit_19)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals_29, (MR_Integer) 83, &DebugTypes_30);
      ...
      case (MR_Integer) 1:
        {
          ...
          succeeded = libs__globals__lookup_bool_option_3_p_1(Globals_14, (MR_Integer) 210, (MR_Integer) 1);
          if (succeeded)
          {
