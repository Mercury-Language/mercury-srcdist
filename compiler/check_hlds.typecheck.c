      ...
      case (MR_Integer) 0:
        {
          ...
          switch (WarnNonContiguousForeignProcs_27) {
            ...
            case (MR_Integer) 0:
              {
                ...
                switch (WarnNonContiguousClauses_28) {
                  ...
                  case (MR_Integer) 1:
                    {
                      MR_Word FirstRegion_69;
                      MR_Word SecondRegion_70;
                      MR_Word LaterRegions_71;

                      succeeded = hlds__hlds_clauses__clauses_are_non_contiguous_5_p_0(ItemNumbers0_22, (MR_Integer) 0, &FirstRegion_69, &SecondRegion_70, &LaterRegions_71);
                      if (succeeded)
                      {
                        MR_Word Spec_72;

                        Spec_72 = check_hlds__typecheck_errors__report_non_contiguous_clauses_6_f_0(ModuleInfo_9, PredId_10, STATE_VARIABLE_PredInfo_0_36, FirstRegion_69, SecondRegion_70, LaterRegions_71);
                        {
                          StartingSpecs_26 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                          MR_hl_field(MR_mktag(1), StartingSpecs_26, 0) = ((MR_Box) (Spec_72));
            ...
            case (MR_Integer) 1:
              {
                MR_Word FirstRegion_80;
                MR_Word SecondRegion_81;
                MR_Word LaterRegions_82;

                succeeded = hlds__hlds_clauses__clauses_are_non_contiguous_5_p_0(ItemNumbers0_22, (MR_Integer) 1, &FirstRegion_80, &SecondRegion_81, &LaterRegions_82);
                if (succeeded)
                {
                  MR_Word Spec_83;

                  Spec_83 = check_hlds__typecheck_errors__report_non_contiguous_clauses_6_f_0(ModuleInfo_9, PredId_10, STATE_VARIABLE_PredInfo_0_36, FirstRegion_80, SecondRegion_81, LaterRegions_82);
                  {
                    StartingSpecs_26 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(MR_mktag(1), StartingSpecs_26, 0) = ((MR_Box) (Spec_83));
                    MR_hl_field(MR_mktag(1), StartingSpecs_26, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
                  }
                }
                else
...
{
  {
    ...
    else
    {
      ...
      Var_118 = ((MR_Word) (MR_hl_field(MR_mktag(0), PredConstraints_30, (MR_Integer) 1)));
      parse_tree__prog_type__constraint_list_get_tvars_2_p_0(Var_85, &UnivTVars_31);
      TypeInfo_119_119 = (MR_Word) &check_hlds__typecheck_scalar_common_1[1];
      STATE_VARIABLE_ExternalTypeParams_86_86 = mercury__list__f_43_43_2_f_0(TypeInfo_119_119, UnivTVars_31, STATE_VARIABLE_ExternalTypeParams_84_84);
      mercury__list__sort_and_remove_dups_2_p_0(TypeInfo_119_119, STATE_VARIABLE_ExternalTypeParams_86_86, &STATE_VARIABLE_ExternalTypeParams_87_87);
      mercury__list__delete_elems_3_p_0(TypeInfo_119_119, STATE_VARIABLE_ExternalTypeParams_87_87, ExistQVars0_25, &STATE_VARIABLE_ExternalTypeParams_78_78);
    }
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          TypeInfo_53_73 = (MR_Word) &check_hlds__typecheck_scalar_common_1[2];
          hlds__hlds_args__proc_arg_vector_to_func_args_3_p_0(TypeInfo_53_73, HeadVars_32, &FuncArgs_33, &conv0_FuncRetVal_34);
          ...
          {
            FuncSymName_40 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
          ...
          {
            FuncConsId_41 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(3), FuncConsId_41, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 2));
          ...
          {
            FuncRHS_42 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), FuncRHS_42, 0) = ((MR_Box) (FuncConsId_41));
            MR_hl_field(MR_mktag(1), FuncRHS_42, 1) = ((MR_Box) ((MR_Integer) 0));
            MR_hl_field(MR_mktag(1), FuncRHS_42, 2) = ((MR_Box) (FuncArgs_33));
          }
          hlds__make_goal__create_pure_atomic_complicated_unification_6_p_0(FuncRetVal_34, FuncRHS_42, Context_35, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), &Goal0_43);
          ...
          Var_62 = hlds__hlds_args__proc_arg_vector_to_list_1_f_0(TypeInfo_53_73, HeadVars_32);
          ...
          {
            Goal_48 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
            MR_hl_field(MR_mktag(0), Goal_48, 0) = ((MR_Box) (GoalExpr_44));
            MR_hl_field(MR_mktag(0), Goal_48, 1) = ((MR_Box) (GoalInfo_47));
          }
          {
            Clause_49 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 5 * sizeof(MR_Word)), NULL, NULL);
            MR_hl_field(MR_mktag(0), Clause_49, 0) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
            MR_hl_field(MR_mktag(0), Clause_49, 1) = ((MR_Box) (Goal_48));
            MR_hl_field(MR_mktag(0), Clause_49, 2) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
            MR_hl_field(MR_mktag(0), Clause_49, 3) = ((MR_Box) (Context_35));
            MR_hl_field(MR_mktag(0), Clause_49, 4) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
          }
          {
            Var_66 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
          ...
          hlds__hlds_pred__pred_info_update_goal_type_3_p_0((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 2)), STATE_VARIABLE_PredInfo_20_20, &STATE_VARIABLE_PredInfo_49_69);
      ...
      AddrPredIdsInfos_75 = (MR_Word *) &(MR_hl_field(MR_mktag(1), *HeadVar__4_4, (MR_Integer) 1));
      check_hlds__typecheck__LCMCpr_prepare_for_typecheck_1_4_p_0(ModuleInfo_1, ValidPredIdSet_2, PredIdsInfos0_10, AddrPredIdsInfos_75);
    }
  }
}
  ...
  MR_Word * AddrOfHeadVar__4_76)
{
  while (MR_TRUE)
  {
    ...
    if ((HeadVar__3_3 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
    {
      *AddrOfHeadVar__4_76 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
    }
    else
    {
      MR_Word PredIdInfo0_9 = ((MR_Word) (MR_hl_field(MR_mktag(1), HeadVar__3_3, (MR_Integer) 0)));
      ...
      MR_Word STATE_VARIABLE_PredInfo_19_19 = ((MR_Word) (MR_hl_field(MR_mktag(0), PredIdInfo0_9, (MR_Integer) 1)));
      MR_Word * AddrPredIdsInfos_75;
      MR_Word HeadVar__4_77;
      MR_Word next_value_of_HeadVar__3_3;
      MR_Word * next_value_of_AddrOfHeadVar__4_76;
      ...
      if (succeeded)
      {
        ...
        PredIdInfo_11 = PredIdInfo0_9;
      {
        HeadVar__4_77 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), HeadVar__4_77, 0) = ((MR_Box) (PredIdInfo_11));
        MR_hl_field(MR_mktag(1), HeadVar__4_77, 1) = NULL;
      }
      AddrPredIdsInfos_75 = (MR_Word *) &(MR_hl_field(MR_mktag(1), HeadVar__4_77, (MR_Integer) 1));
      *AddrOfHeadVar__4_76 = HeadVar__4_77;
      // direct tailcall eliminated
      next_value_of_HeadVar__3_3 = PredIdsInfos0_10;
      next_value_of_AddrOfHeadVar__4_76 = AddrPredIdsInfos_75;
      HeadVar__3_3 = next_value_of_HeadVar__3_3;
      AddrOfHeadVar__4_76 = next_value_of_AddrOfHeadVar__4_76;
      continue;
    }
    break;
  }
