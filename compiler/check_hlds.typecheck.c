...
{
  {
    ...
    if (check_hlds__typecheck__succeeded)
    ...
    else
      {
        ...
        if (check_hlds__typecheck__succeeded)
          {
            *check_hlds__typecheck__ConsTypeInfo_10 = (MR_Word) MR_mkword(MR_mktag(1), &check_hlds__typecheck_scalar_common_4[1]);
          }
        else
          {
                ...
                do
                  {
                    ...
                    check_hlds__typecheck__result_3 = MR_strcmp(check_hlds__typecheck__Name_89, ((&check_hlds__typecheck_vector_common_9[0 + check_hlds__typecheck__mid_2]))->check_hlds__typecheck__vector_common_type_9_0__vct_9_f_0);
