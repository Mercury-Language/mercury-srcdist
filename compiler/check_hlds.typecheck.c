...
check_hlds__typecheck__IntroducedFrom__pred__handle_stubs__452__1_2_p_0(
  ...
  MR_Word * NumberOfIterations_21)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals_31, (MR_Integer) 698, &DebugTypes_32);
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = check_hlds__typecheck__IntroducedFrom__pred__handle_stubs__452__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) ((MR_hl_field(0, closure, 4)))));
  return succeeded;
}
