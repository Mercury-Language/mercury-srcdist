...
static /* final */ const MR_Box check_hlds__typecheck_scalar_common_2[8][3] = {
  /* row 0 */
  {
    (MR_Box) (((((MR_Unsigned) ((MR_Integer) 57) << 1)) | (MR_Unsigned) ((MR_Integer) 1))),
...
{
  {
    ...
    libs__globals__lookup_int_option_3_p_0(Globals_10, (MR_Integer) 192, &MaxIterations_11);
  ...
  MR_Word * ExceededIterationLimit_19)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals_29, (MR_Integer) 74, &DebugTypes_30);
      ...
      case (MR_Integer) 1:
        {
          ...
          succeeded = libs__globals__lookup_bool_option_3_p_1(Globals_16, (MR_Integer) 187, (MR_Integer) 1);
          if (succeeded)
          {
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        {
          Var_54 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), Var_54, 0) = (MR_Box) (((((MR_Unsigned) ((MR_Integer) 57) << 1)) | (MR_Unsigned) ((MR_Integer) 1)));
