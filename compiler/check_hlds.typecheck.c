      ...
      case (MR_Integer) 1:
        {
          ...
          {
            check_hlds__typecheck__succeeded = libs__globals__lookup_bool_option_3_p_1(check_hlds__typecheck__Globals_16, (MR_Integer) 179, (MR_Integer) 1);
          }
          if (check_hlds__typecheck__succeeded)
            {
...
{
  {
    ...
    {
      libs__globals__lookup_int_option_3_p_0(check_hlds__typecheck__Globals_10, (MR_Integer) 184, &check_hlds__typecheck__MaxIterations_11);
    }
    {
