  ...
  MR_Word Context_13)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_15, (MR_Integer) 180, &WarnKnownBadFormatCalls_16);
    ...
    case (MR_Integer) 1:
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_15, (MR_Integer) 225, &WarnAllFormatStringErrors_21);
