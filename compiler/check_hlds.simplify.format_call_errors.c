...
static /* final */ const MR_Box check_hlds__simplify__format_call_errors_scalar_common_2[4][1];
  ...
  MR_Word Context_13)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_15, (MR_Integer) 189, &WarnKnownBadFormatCalls_16);
    ...
    case (MR_Integer) 1:
      {
        ...
        else
        {
          ...
          MR_Tuple Var_35 = ((MR_Tuple) ((MR_hl_field(1, MaybePos_10, 0))));
          MR_Word Var_36;
          MR_Word Var_41;
          MR_Word Var_44;
          MR_Word Var_45;
          ...
          Pos_18 = ((MR_Integer) ((MR_hl_field(0, Var_35, 0))));
          ArgNumFS_19 = ((MR_Integer) ((MR_hl_field(0, Var_35, 1))));
          ArgNumVL_20 = ((MR_Integer) ((MR_hl_field(0, Var_35, 2))));
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_15, (MR_Integer) 246, &WarnAllFormatStringErrors_21);
        ...
        Pieces_24 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), (MR_Word) (MR_mkword(1, &check_hlds__simplify__format_call_errors_scalar_common_1[24])), Var_82);
        {
          ...
          MR_hl_field(0, Spec_26, 1) = ((MR_Box) (MR_mkword(1, &check_hlds__simplify__format_call_errors_scalar_common_2[3])));
        ...
        case (MR_Integer) 1:
          {
            ...
            MR_Word Var_471;
            MR_Word Var_472;
            MR_Integer SpecNum_480 = ((MR_Integer) ((MR_hl_field(3, Error_3, 1))));
            MR_Word PolyKind_481 = ((MR_Unsigned) ((MR_hl_field(3, Error_3, 2))) & (MR_Integer) 15);
            MR_String AAn_482;
            ...
            check_hlds__simplify__format_call_errors__poly_kind_desc_3_p_0(PolyKind_481, &AAn_482, &PolyKindDesc_483);
            {
              ...
              MR_hl_field(3, Var_438, 0) = ((MR_Box) ((MR_Unsigned) 5U));
            ...
            Var_436 = parse_tree__error_spec__color_as_subject_1_f_0(Var_437);
            {
              ...
              MR_hl_field(3, Var_456, 0) = ((MR_Box) ((MR_Unsigned) 9U));
            ...
            }
            {
              ...
              MR_hl_field(3, Var_461, 0) = ((MR_Box) ((MR_Unsigned) 9U));
        ...
        case (MR_Integer) 2:
          {
            ...
            MR_Word Var_418;
            MR_Word Var_419;
            MR_Integer SpecNum_427 = ((MR_Integer) ((MR_hl_field(3, Error_3, 1))));

            {
              Var_406 = (MR_Word) MR_mkword(3, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(3, Var_406, 0) = ((MR_Box) ((MR_Unsigned) 5U));
    ...
    case (MR_Integer) 1:
      {
        ...
        Pieces_12 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), (MR_Word) (MR_mkword(1, &check_hlds__simplify__format_call_errors_scalar_common_1[4])), Var_26);
        {
          ...
          MR_hl_field(0, Spec_14, 1) = ((MR_Box) (MR_mkword(1, &check_hlds__simplify__format_call_errors_scalar_common_2[2])));
