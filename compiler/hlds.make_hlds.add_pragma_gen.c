  ...
  MR_Word * STATE_VARIABLE_Specs_26)
{
  ...
  else
  {
    ...
    mercury__map__set_4_p_0((MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_proc_id_0), (MR_Word) (&hlds__make_hlds__add_pragma_gen_scalar_common_1[0]), ((MR_Box) (PredProcId_21)), ((MR_Box) (UnusedArgs_10)), UnusedArgInfo0_19, &UnusedArgInfo_22);
