  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(0), Unification_143, 4) = ((MR_Box) (MR_mkword(MR_mktag(2), &check_hlds__polymorphism_type_info_scalar_common_3[0])));
  ...
  MR_Word * STATE_VARIABLE_Info_17)
{
  ...
  else
  {
    ...
    check_hlds__polymorphism_info__poly_info_get_var_table_2_p_0(STATE_VARIABLE_Info_0_16, &VarTable0_27);
    ...
    parse_tree__var_table__add_prefix_number_var_entry_6_p_0((MR_String) "TypeInfo", Var_42, (MR_Integer) 1, &Var_13, VarTable0_27, &VarTable_29);
    hlds__hlds_rtti__rtti_det_insert_type_info_type_4_p_0(Var_13, Type_12, RttiVarMaps0_28, &RttiVarMaps_30);
    check_hlds__polymorphism_info__poly_info_set_var_table_rtti_4_p_0(VarTable_29, RttiVarMaps_30, STATE_VARIABLE_Info_0_16, &STATE_VARIABLE_Info_19_19);
    {
      MR_Word base;
      base = (MR_Word) MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL);
      *TypeInfoLocn_6 = base;
