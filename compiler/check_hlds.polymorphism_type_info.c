  ...
  MR_Word * STATE_VARIABLE_Info_86)
{
  ...
  else
  {
    ...
    MR_Integer VarNum_200;
    MR_String VarNumStr_201;
    MR_String Name_203;
    MR_Word STATE_VARIABLE_VarSet_26_204;
    MR_Word Var_205;

    mercury__varset__new_var_3_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), &TypeCtorVar_31, VarSet0_23, &STATE_VARIABLE_VarSet_26_204);
    mercury__term__var_to_int_2_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), TypeCtorVar_31, &VarNum_200);
    mercury__string__int_to_string_2_p_0(VarNum_200, &VarNumStr_201);
    RttiVarMaps1_35 = RttiVarMaps0_25;
    Name_203 = mercury__string__f_43_43_2_f_0((MR_String) "TypeCtorInfo_", VarNumStr_201);
    mercury__varset__name_var_4_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), TypeCtorVar_31, Name_203, STATE_VARIABLE_VarSet_26_204, &VarSet1_33);
    Var_205 = parse_tree__builtin_lib_types__type_info_type_0_f_0();
    parse_tree__vartypes__add_var_type_4_p_0(TypeCtorVar_31, Var_205, VarTypes0_24, &VarTypes1_34);
        ...
        case (MR_Integer) 0:
          {
            ...
            check_hlds__polymorphism_type_info__get_type_info_locn_4_p_0(TypeVar_44, &TypeInfoLocn_46, STATE_VARIABLE_Info_0_5, &STATE_VARIABLE_Info_38_49);
