  ...
  MR_Word TargetOrDump_7)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 432, &LineNumbers_9);
  libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 433, &ForeignLineNumbers_10);
  libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 436, &Comments_11);
