  ...
  MR_Word TargetOrDump_7)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 240, &ProfileCalls_13);
  libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 242, &ProfileMemory_14);
  libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 241, &ProfileTime_15);
