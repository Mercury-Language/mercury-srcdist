  ...
  MR_Word TargetOrDump_7)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 269, &SinglePrecFloat_12);
  libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 238, &ProfileCalls_13);
  libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 240, &ProfileMemory_14);
  libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 239, &ProfileTime_15);
