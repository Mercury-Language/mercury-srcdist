...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 236, &ProfileCalls_13);
    libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 238, &ProfileMemory_14);
    libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 237, &ProfileTime_15);
