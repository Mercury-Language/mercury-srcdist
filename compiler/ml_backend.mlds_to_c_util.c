  ...
  MR_Word TargetOrDump_9)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_6, (MR_Integer) 459, &LineNumbers_11);
  libs__globals__lookup_bool_option_3_p_0(Globals_6, (MR_Integer) 460, &ForeignLineNumbers_12);
  libs__globals__lookup_bool_option_3_p_0(Globals_6, (MR_Integer) 463, &Comments_13);
