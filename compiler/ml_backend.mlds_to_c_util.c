  ...
  MR_Word TargetOrDump_7)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 457, &LineNumbers_9);
  libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 458, &ForeignLineNumbers_10);
  libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 461, &Comments_11);
