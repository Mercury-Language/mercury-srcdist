...
parse_tree__equiv_type__IntroducedFrom__func__replace_in_pred_type__1418__1_1_f_0(
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      mercury__list__reverse_2_p_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_0), RevReplItems_46, &ReplItems_47);
      {
        ...
        MR_hl_field(MR_mktag(0), ReplItemBlock_48, 0) = ((MR_Box) (BlockModuleName_40));
        MR_hl_field(MR_mktag(0), ReplItemBlock_48, 1) = ((MR_Box) (Section_41));
...
{
  {
    ...
    conv0_LambdaHeadVar__2_242 = parse_tree__equiv_type__IntroducedFrom__func__replace_in_pred_type__1418__1_1_f_0(((MR_Word) (wrapper_arg_1)));
