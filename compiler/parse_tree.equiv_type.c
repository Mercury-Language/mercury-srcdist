...
{
  {
    ...
    if (succeeded)
    {
      ...
      Var_15 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Section_3, (MR_Integer) 1))) & (MR_Integer) 3);
      Var_16 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Section_3, (MR_Integer) 1))) >> (MR_Integer) 2)) & (MR_Integer) 3);
      Var_17 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Section_3, (MR_Integer) 1))) >> (MR_Integer) 4)) & (MR_Integer) 3);
    }
    return succeeded;
  }
}
