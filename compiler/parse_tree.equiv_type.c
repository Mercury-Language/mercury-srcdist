...
parse_tree__equiv_type__IntroducedFrom__func__replace_in_pred_type__1490__1_1_f_0(
...
{
  {
    ...
    switch (ContainsCirc_30) {
      ...
      case (MR_Integer) 1:
        {
          succeeded = ((MR_tag((MR_Word) TypeRepn0_23)) == (MR_Integer) 1);
          if (succeeded)
          {
    ...
    case (MR_Integer) 0:
      {
        ...
        *STATE_VARIABLE_EquivTypeInfo_36 = STATE_VARIABLE_EquivTypeInfo_0_35;
        *STATE_VARIABLE_UsedModules_38 = STATE_VARIABLE_UsedModules_0_37;
      }
      break;
    case (MR_Integer) 1:
      {
        MR_Word Type0_24 = ((MR_Word) ((MR_hl_field(MR_mktag(1), TypeRepn0_18, (MR_Integer) 0))));
        MR_Word Type_25;
        MR_Word Var_39;
        MR_Word Var_26;

        {
          ...
          MR_hl_field(MR_mktag(1), Var_39, 0) = ((MR_Box) (TypeCtor_17));
          MR_hl_field(MR_mktag(1), Var_39, 1) = ((MR_Box) ((MR_Unsigned) 0U));
        }
        parse_tree__equiv_type__replace_in_type_maybe_record_use_2_13_p_0(MaybeRecord_14, TypeEqvMap_15, Var_39, Type0_24, &Type_25, &Var_26, ContainsCirc_20, STATE_VARIABLE_VarSet_0_33, STATE_VARIABLE_VarSet_34, STATE_VARIABLE_EquivTypeInfo_0_35, STATE_VARIABLE_EquivTypeInfo_36, STATE_VARIABLE_UsedModules_0_37, STATE_VARIABLE_UsedModules_38);
        {
          MR_Word base;
          base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
          *TypeRepn_19 = base;
          MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (Type_25));
        }
      }
      break;
    case (MR_Integer) 2:
...
{
  {
    ...
    conv0_LambdaHeadVar__2_242 = parse_tree__equiv_type__IntroducedFrom__func__replace_in_pred_type__1490__1_1_f_0(((MR_Word) (wrapper_arg_1)));
