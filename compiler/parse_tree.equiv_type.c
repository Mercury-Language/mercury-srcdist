    ...
    if ((STATE_VARIABLE_Specs_141_141 == (MR_Word) ((MR_Unsigned) 0U)))
      ...
      else
      {
        ...
        if ((LeftOverExtraTypes_64 == (MR_Word) ((MR_Unsigned) 0U)))
          ...
          else
          {
            ...
            }
            {
              ...
              MR_hl_field(MR_mktag(0), Msg2_71, 1) = ((MR_Box) (Var_232));
            }
            {
        ...
        if ((LeftOverExtraModes_65 == (MR_Word) ((MR_Unsigned) 0U)))
        {
          ...
          {
            Msg2_251 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
            MR_hl_field(MR_mktag(0), Msg2_251, 0) = ((MR_Box) (Context_27));
            MR_hl_field(MR_mktag(0), Msg2_251, 1) = ((MR_Box) (Var_184));
          }
          {
