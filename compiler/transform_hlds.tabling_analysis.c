...
{
  {
    ...
    {
      transform_hlds__tabling_analysis__conv0_LambdaHeadVar__2_94 = transform_hlds__tabling_analysis__IntroducedFrom__func__check_goal_for_mm_tabling__380__1_1_f_0(((MR_Word) transform_hlds__tabling_analysis__wrapper_arg_1));
    }
...
{
  {
    ...
    {
      libs__globals__lookup_bool_option_3_p_0(transform_hlds__tabling_analysis__Globals_4, (MR_Integer) 225, &transform_hlds__tabling_analysis__UseMinimalModel_5);
    }
      ...
      case (MR_Integer) 1:
        {
          ...
          {
            libs__globals__lookup_bool_option_3_p_0(transform_hlds__tabling_analysis__Globals_4, (MR_Integer) 87, &transform_hlds__tabling_analysis__Debug_11);
          }
          {
