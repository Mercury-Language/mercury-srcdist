        ...
        case (MR_Integer) 6:
          {
            ...
            transform_hlds__tabling_analysis__mm_tabling_annotate_goal_6_p_0(VarTable_7, Cond0_76, &Cond_79, &CondStatus_80, STATE_VARIABLE_ModuleInfo_0_93, &STATE_VARIABLE_ModuleInfo_104_104);
            transform_hlds__tabling_analysis__mm_tabling_annotate_goal_6_p_0(VarTable_7, Then0_77, &Then_81, &ThenStatus_82, STATE_VARIABLE_ModuleInfo_104_104, &STATE_VARIABLE_ModuleInfo_105_105);
            transform_hlds__tabling_analysis__mm_tabling_annotate_goal_6_p_0(VarTable_7, Else0_78, &Else_83, &ElseStatus_84, STATE_VARIABLE_ModuleInfo_105_105, STATE_VARIABLE_ModuleInfo_94);
...

  {
    ...
    else
    {
      ...
      else
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_21, (MR_Integer) 527, &IntermodAnalysis_22);
    ...
    else
    {
      ...
      else
      {
        ...
        else
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_25, (MR_Integer) 527, &Intermod_26);
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_21)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_4, (MR_Integer) 292, &UseMinimalModel_5);
    ...
    case (MR_Integer) 1:
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_4, (MR_Integer) 132, &Debug_12);
        {
