...

    {
      ...
      else
      {
        ...
        else
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_21, (MR_Integer) 337, &IntermodAnalysis_22);
...
{
  {
    ...
    conv0_LambdaHeadVar__2_94 = transform_hlds__tabling_analysis__IntroducedFrom__func__check_goal_for_mm_tabling__381__1_1_f_0(((MR_Word) wrapper_arg_1));
      ...
      else
      {
        ...
        else
        {
          ...
          else
          {
            ...
            libs__globals__lookup_bool_option_3_p_0(Globals_25, (MR_Integer) 337, &Intermod_26);
