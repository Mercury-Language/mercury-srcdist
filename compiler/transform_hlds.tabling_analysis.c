...

    {
      ...
      else
      {
        ...
        else
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_21, (MR_Integer) 498, &IntermodAnalysis_22);
      ...
      else
      {
        ...
        else
        {
          ...
          else
          {
            ...
            libs__globals__lookup_bool_option_3_p_0(Globals_25, (MR_Integer) 498, &Intermod_26);
      ...
      case (MR_Integer) 1:
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_4, (MR_Integer) 105, &Debug_11);
          {
