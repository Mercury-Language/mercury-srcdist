...

  {
    ...
    else
    {
      ...
      else
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_21, (MR_Integer) 539, &IntermodAnalysis_22);
    ...
    else
    {
      ...
      else
      {
        ...
        else
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_25, (MR_Integer) 539, &Intermod_26);
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_21)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_4, (MR_Integer) 302, &UseMinimalModel_5);
