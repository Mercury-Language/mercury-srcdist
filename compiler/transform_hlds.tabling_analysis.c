  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_12)
{
  ...
  transform_hlds__tabling_analysis__mm_tabling_annotate_goal_2_6_p_0(VarTypes_9, GoalExpr0_27, &GoalExpr_29, &_Status_10, STATE_VARIABLE_ModuleInfo_0_11, &STATE_VARIABLE_ModuleInfo_16_16);
  switch (_Status_10) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 2:
    case (MR_Integer) 0:
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_25)
{
  ...
  if ((EvalMethod_13 == (MR_Word) ((MR_Unsigned) 0U)))
  {
    ...
    transform_hlds__tabling_analysis__check_goal_for_mm_tabling_7_p_0(SCC_7, VarTypes_21, Body_20, &Result_15, &MaybeAnalysisStatus_16, STATE_VARIABLE_ModuleInfo_0_24, STATE_VARIABLE_ModuleInfo_25);
  }
  else
  {
    MR_Word Var_43 = ((MR_Word) ((MR_hl_field(MR_mktag(1), EvalMethod_13, (MR_Integer) 0))));
      ...
      case (MR_Integer) 0:
        {
          ...
          hlds__hlds_pred__proc_info_get_goal_2_p_0(ProcInfo_12, &Body_35);
          hlds__hlds_pred__proc_info_get_vartypes_2_p_0(ProcInfo_12, &VarTypes_36);
          transform_hlds__tabling_analysis__check_goal_for_mm_tabling_7_p_0(SCC_7, VarTypes_36, Body_35, &Result_15, &MaybeAnalysisStatus_16, STATE_VARIABLE_ModuleInfo_0_24, STATE_VARIABLE_ModuleInfo_25);
        }
        break;
      case (MR_Integer) 1:
        {
          ...
          hlds__hlds_pred__proc_info_get_vartypes_2_p_0(ProcInfo_12, &VarTypes_38);
          transform_hlds__tabling_analysis__check_goal_for_mm_tabling_7_p_0(SCC_7, VarTypes_38, Body_37, &Result_15, &MaybeAnalysisStatus_16, STATE_VARIABLE_ModuleInfo_0_24, STATE_VARIABLE_ModuleInfo_25);
        }
        break;
      case (MR_Integer) 2:
        {
          ...
          hlds__hlds_pred__proc_info_get_goal_2_p_0(ProcInfo_12, &Body_39);
          hlds__hlds_pred__proc_info_get_vartypes_2_p_0(ProcInfo_12, &VarTypes_40);
          transform_hlds__tabling_analysis__check_goal_for_mm_tabling_7_p_0(SCC_7, VarTypes_40, Body_39, &Result_15, &MaybeAnalysisStatus_16, STATE_VARIABLE_ModuleInfo_0_24, STATE_VARIABLE_ModuleInfo_25);
        }
        break;
      case (MR_Integer) 3:
        {
  ...
  }
  {
    ...
    MR_hl_field(MR_mktag(0), Var_32, 0) = ((MR_Box) (PPId_8));
    MR_hl_field(MR_mktag(0), Var_32, 1) = (MR_Box) ((MR_Unsigned) (Result_15));
    MR_hl_field(MR_mktag(0), Var_32, 2) = ((MR_Box) (MaybeAnalysisStatus_16));
  }
  ...
  MR_Box * wrapper_arg_3)
{
  ...
  transform_hlds__tabling_analysis__mm_tabling_annotate_proc_3_p_0(((MR_Word) (wrapper_arg_1)), ((MR_Word) (wrapper_arg_2)), &conv12_STATE_VARIABLE_ModuleInfo_12);
  ...
  MR_Box * wrapper_arg_5)
{
  ...
  transform_hlds__tabling_analysis__check_proc_for_mm_tabling_6_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) (wrapper_arg_1)), ((MR_Word) (wrapper_arg_2)), &conv1_STATE_VARIABLE_Results_23, ((MR_Word) (wrapper_arg_4)), &conv0_STATE_VARIABLE_ModuleInfo_25);
