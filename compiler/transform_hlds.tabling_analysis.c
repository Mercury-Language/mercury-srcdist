...
#line 123 "tabling_analysis.m"
    {
#line 123 "tabling_analysis.m"
      libs__globals__lookup_bool_option_3_p_0(transform_hlds__tabling_analysis__Globals_7, (MR_Integer) 218, &transform_hlds__tabling_analysis__UseMinimalModel_8);
    }
