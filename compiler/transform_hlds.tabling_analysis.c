...
{
  {
    ...
    if (transform_hlds__tabling_analysis__succeeded)
      ...
      {
        MR_Word transform_hlds__tabling_analysis__Var_9 = (MR_Word) transform_hlds__tabling_analysis__Status_3;
        MR_Word transform_hlds__tabling_analysis__Var_10 = (MR_Word) transform_hlds__tabling_analysis__Status_8;

        transform_hlds__tabling_analysis__succeeded = (transform_hlds__tabling_analysis__Var_9 == transform_hlds__tabling_analysis__Var_10);
      }
    return transform_hlds__tabling_analysis__succeeded;
  }
}
...
{
  {
    ...
    if (transform_hlds__tabling_analysis__succeeded)
      *transform_hlds__tabling_analysis__HeadVar__1_1 = (MR_Integer) 0;
      ...
      {
        MR_Word transform_hlds__tabling_analysis__Var_4 = ((MR_Word) (MR_hl_field(MR_mktag(0), transform_hlds__tabling_analysis__HeadVar__2_2, (MR_Integer) 0)));
        MR_Word transform_hlds__tabling_analysis__Var_5 = ((MR_Word) (MR_hl_field(MR_mktag(0), transform_hlds__tabling_analysis__HeadVar__2_2, (MR_Integer) 1)));
        MR_Word transform_hlds__tabling_analysis__Var_6 = ((MR_Word) (MR_hl_field(MR_mktag(0), transform_hlds__tabling_analysis__HeadVar__2_2, (MR_Integer) 2)));
        MR_Word transform_hlds__tabling_analysis__Var_7 = ((MR_Word) (MR_hl_field(MR_mktag(0), transform_hlds__tabling_analysis__HeadVar__3_3, (MR_Integer) 0)));
        MR_Word transform_hlds__tabling_analysis__Var_8 = ((MR_Word) (MR_hl_field(MR_mktag(0), transform_hlds__tabling_analysis__HeadVar__3_3, (MR_Integer) 1)));
        MR_Word transform_hlds__tabling_analysis__Var_9 = ((MR_Word) (MR_hl_field(MR_mktag(0), transform_hlds__tabling_analysis__HeadVar__3_3, (MR_Integer) 2)));
        MR_Word transform_hlds__tabling_analysis__Var_10;

        {
          hlds__hlds_pred____Compare____pred_proc_id_0_0(&transform_hlds__tabling_analysis__Var_10, transform_hlds__tabling_analysis__Var_4, transform_hlds__tabling_analysis__Var_7);
        }
        ...
        if (transform_hlds__tabling_analysis__succeeded)
          *transform_hlds__tabling_analysis__HeadVar__1_1 = transform_hlds__tabling_analysis__Var_10;
        else
          {
            ...
            MR_Integer transform_hlds__tabling_analysis__Var_17 = (MR_Integer) transform_hlds__tabling_analysis__Var_5;
            MR_Integer transform_hlds__tabling_analysis__Var_18 = (MR_Integer) transform_hlds__tabling_analysis__Var_8;
            ...
            if (transform_hlds__tabling_analysis__succeeded)
              *transform_hlds__tabling_analysis__HeadVar__1_1 = transform_hlds__tabling_analysis__Var_11;
              ...
              {
                {
                  mercury__builtin__compare_3_p_0((MR_Word) &transform_hlds__tabling_analysis_scalar_common_1[2], transform_hlds__tabling_analysis__HeadVar__1_1, ((MR_Box) (transform_hlds__tabling_analysis__Var_6)), ((MR_Box) (transform_hlds__tabling_analysis__Var_9)));
                }
              }
          }
      }
...
{
  {
    ...
    if (transform_hlds__tabling_analysis__succeeded)
    ...
    else
      {
        ...
        MR_Word transform_hlds__tabling_analysis__Var_3 = ((MR_Word) (MR_hl_field(MR_mktag(0), transform_hlds__tabling_analysis__HeadVar__1_1, (MR_Integer) 0)));
        MR_Word transform_hlds__tabling_analysis__Var_4 = ((MR_Word) (MR_hl_field(MR_mktag(0), transform_hlds__tabling_analysis__HeadVar__1_1, (MR_Integer) 1)));
        MR_Word transform_hlds__tabling_analysis__Var_5 = ((MR_Word) (MR_hl_field(MR_mktag(0), transform_hlds__tabling_analysis__HeadVar__1_1, (MR_Integer) 2)));
        MR_Word transform_hlds__tabling_analysis__Var_6 = ((MR_Word) (MR_hl_field(MR_mktag(0), transform_hlds__tabling_analysis__HeadVar__2_2, (MR_Integer) 0)));
        MR_Word transform_hlds__tabling_analysis__Var_7 = ((MR_Word) (MR_hl_field(MR_mktag(0), transform_hlds__tabling_analysis__HeadVar__2_2, (MR_Integer) 1)));
        MR_Word transform_hlds__tabling_analysis__Var_8 = ((MR_Word) (MR_hl_field(MR_mktag(0), transform_hlds__tabling_analysis__HeadVar__2_2, (MR_Integer) 2)));

        {
          transform_hlds__tabling_analysis__succeeded = hlds__hlds_pred____Unify____pred_proc_id_0_0(transform_hlds__tabling_analysis__Var_3, transform_hlds__tabling_analysis__Var_6);
        }
        if (transform_hlds__tabling_analysis__succeeded)
          {
            transform_hlds__tabling_analysis__succeeded = (transform_hlds__tabling_analysis__Var_4 == transform_hlds__tabling_analysis__Var_7);
            if (transform_hlds__tabling_analysis__succeeded)
              {
                transform_hlds__tabling_analysis__TypeInfo_12_12 = (MR_Word) &transform_hlds__tabling_analysis_scalar_common_1[2];
                {
                  transform_hlds__tabling_analysis__succeeded = mercury__builtin__unify_2_p_0(transform_hlds__tabling_analysis__TypeInfo_12_12, ((MR_Box) (transform_hlds__tabling_analysis__Var_5)), ((MR_Box) (transform_hlds__tabling_analysis__Var_8)));
                }
              }
          }
      }
...
{
  {
    ...
    if (transform_hlds__tabling_analysis__succeeded)
      *transform_hlds__tabling_analysis__HeadVar__1_1 = (MR_Integer) 0;
      ...
      {
        MR_Word transform_hlds__tabling_analysis__Var_4 = (MR_Word) transform_hlds__tabling_analysis__HeadVar__2_2;
        MR_Word transform_hlds__tabling_analysis__Var_5 = (MR_Word) transform_hlds__tabling_analysis__HeadVar__3_3;
        MR_Integer transform_hlds__tabling_analysis__Var_9 = (MR_Integer) transform_hlds__tabling_analysis__Var_4;
        MR_Integer transform_hlds__tabling_analysis__Var_10 = (MR_Integer) transform_hlds__tabling_analysis__Var_5;
...
{
  {
    ...
    if (transform_hlds__tabling_analysis__succeeded)
      ...
      {
        MR_Word transform_hlds__tabling_analysis__Var_3 = (MR_Word) transform_hlds__tabling_analysis__HeadVar__1_1;
        MR_Word transform_hlds__tabling_analysis__Var_4 = (MR_Word) transform_hlds__tabling_analysis__HeadVar__2_2;

        transform_hlds__tabling_analysis__succeeded = (transform_hlds__tabling_analysis__Var_3 == transform_hlds__tabling_analysis__Var_4);
      }
    return transform_hlds__tabling_analysis__succeeded;
  }
}
