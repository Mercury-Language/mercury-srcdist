...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(0), transform_hlds__tabling_analysis__Var_24, 0) = ((MR_Box) (&transform_hlds__tabling_analysis_scalar_common_6[2]));
...
{
  {
...

    {
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(0), transform_hlds__tabling_analysis__Var_22, 0) = ((MR_Box) (&transform_hlds__tabling_analysis_scalar_common_6[1]));
