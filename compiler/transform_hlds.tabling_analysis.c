...
{
  {
    ...
    {
      libs__globals__lookup_bool_option_3_p_0(transform_hlds__tabling_analysis__Globals_4, (MR_Integer) 227, &transform_hlds__tabling_analysis__UseMinimalModel_5);
    }
      ...
      case (MR_Integer) 1:
        {
          ...
          {
            libs__globals__lookup_bool_option_3_p_0(transform_hlds__tabling_analysis__Globals_4, (MR_Integer) 89, &transform_hlds__tabling_analysis__Debug_11);
          }
          {
