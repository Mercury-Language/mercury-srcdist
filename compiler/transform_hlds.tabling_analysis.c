...
{
  {
...

    {
      ...
      {
        transform_hlds__tabling_analysis__V_6_6 = parse_tree__prog_data_foreign__get_may_call_mm_tabled_1_f_0(transform_hlds__tabling_analysis__Attributes_3);
      }
    ...
    if (!(transform_hlds__tabling_analysis__succeeded))
      {
        ...
        {
          transform_hlds__tabling_analysis__V_4_4 = parse_tree__prog_data_foreign__get_may_call_mm_tabled_1_f_0(transform_hlds__tabling_analysis__Attributes_3);
        }
        transform_hlds__tabling_analysis__succeeded = (transform_hlds__tabling_analysis__V_4_4 == (MR_Integer) 2);
        if (transform_hlds__tabling_analysis__succeeded)
          {
            {
              transform_hlds__tabling_analysis__V_5_5 = parse_tree__prog_data_foreign__get_may_call_mercury_1_f_0(transform_hlds__tabling_analysis__Attributes_3);
            }
      ...
      case (MR_Integer) 1:
        {
          ...
          if (transform_hlds__tabling_analysis__succeeded)
            {
              transform_hlds__tabling_analysis__V_20_20 = ((MR_Word) (MR_hl_field(MR_mktag(3), transform_hlds__tabling_analysis__OpMode_6, (MR_Integer) 0)));
          ...
          if (transform_hlds__tabling_analysis__succeeded)
            {
              transform_hlds__tabling_analysis__V_27_27 = ((MR_Word) (MR_hl_field(MR_mktag(3), transform_hlds__tabling_analysis__OpMode_6, (MR_Integer) 0)));
