...
transform_hlds.ctgc.structure_sharing.domain.optdate transform_hlds.ctgc.structure_sharing.domain.trans_opt_date structure_sharing.domain.err transform_hlds.ctgc.structure_sharing.domain.c_date transform_hlds.ctgc.structure_sharing.domain.java_date : structure_sharing.domain.m \
	transform_hlds.int0 \
...
#   long deps
#   short deps
transform_hlds.ctgc.structure_sharing.domain.optdate transform_hlds.ctgc.structure_sharing.domain.trans_opt_date structure_sharing.domain.err transform_hlds.ctgc.structure_sharing.domain.c_date transform_hlds.ctgc.structure_sharing.domain.java_date : \
...
transform_hlds.ctgc.structure_sharing.domain.pic_o transform_hlds.ctgc.structure_sharing.domain.$O : \
	analysis.mih \
	array.mih \
	assoc_list.mih \
	bag.mih \
...
transform_hlds.ctgc.structure_sharing.domain.date transform_hlds.ctgc.structure_sharing.domain.date0 \
	...
	transform_hlds.ctgc.structure_sharing.date : structure_sharing.domain.m \
	transform_hlds.int0 \
	transform_hlds.ctgc.int0 \
	transform_hlds.ctgc.structure_sharing.int0 \
	analysis.int3 \
...
#   long dep int3s
#   short dep int3s
transform_hlds.ctgc.structure_sharing.domain.date transform_hlds.ctgc.structure_sharing.domain.date0 transform_hlds.date transform_hlds.ctgc.date transform_hlds.ctgc.structure_sharing.date : \
		structure_sharing.domain.m \
	\
		transform_hlds.int0 \
		transform_hlds.ctgc.int0 \
...
transform_hlds.ctgc.structure_sharing.domain.date0 \
	...
	transform_hlds.ctgc.structure_sharing.date0 : structure_sharing.domain.m \
	analysis.int3 \
	assoc_list.int3 \
	bool.int3 \
	builtin.int3 \
...
#   long dep int3s
#   short dep int3s
transform_hlds.ctgc.structure_sharing.domain.date0 transform_hlds.date0 transform_hlds.ctgc.date0 transform_hlds.ctgc.structure_sharing.date0 : \
		structure_sharing.domain.m \
	\
		analysis.int3 \
		assoc_list.int3 \
