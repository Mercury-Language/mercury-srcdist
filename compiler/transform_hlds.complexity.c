  ...
  MR_Integer ProcId_7)
{
  ...
  NameAndArity_14 = parse_tree__parse_tree_out_sym_name__sym_name_arity_to_string_1_f_0(Var_17);
  ...
  FullName_8 = mercury__string__f_43_43_2_f_0(NameAndArity_14, Var_18);
  return FullName_8;
}
