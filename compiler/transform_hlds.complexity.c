  ...
  MR_Box wrapper_arg_1)
{
  ...
  succeeded = transform_hlds__complexity__IntroducedFrom__pred__read_spec_file_lines__136__1_2_p_0(((MR_Char) (MR_Word) (MR_hl_field(0, closure, (MR_Integer) 3))), ((MR_Char) (MR_Word) wrapper_arg_1));
  return succeeded;
}
