  ...
  MR_Word * STATE_VARIABLE_ProcInfo_16)
{
...

  {
    ...
    MR_hl_field(MR_mktag(0), Entry_12, 0) = ((MR_Box) (Name_7));
    MR_hl_field(MR_mktag(0), Entry_12, 1) = ((MR_Box) (Type_8));
    MR_hl_field(MR_mktag(0), Entry_12, 2) = (MR_Box) ((MR_Unsigned) (IsDummy_9));
  }
