  ...
  MR_Box closure_arg)
{
  ...
  succeeded = transform_hlds__complexity__IntroducedFrom__pred__make_type_info_var__598__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 4)))));
  return succeeded;
}
  ...
  MR_Integer ProcId_7)
{
  ...
  {
    QualifiedName_12 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(1, QualifiedName_12, 0) = ((MR_Box) (ModuleSymName_9));
    MR_hl_field(1, QualifiedName_12, 1) = ((MR_Box) (PredName_11));
  }
  Arity_13 = hlds__hlds_pred__pred_info_orig_arity_1_f_0(PredInfo_10);
  {
    Var_16 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(0, Var_16, 0) = ((MR_Box) (QualifiedName_12));
    MR_hl_field(0, Var_16, 1) = ((MR_Box) (Arity_13));
  }
