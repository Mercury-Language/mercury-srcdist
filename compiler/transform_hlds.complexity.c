    ...
    case (MR_Integer) 0:
      {
...

        {
          ...
          MR_hl_field(MR_mktag(1), Var_205, 0) = ((MR_Box) (ExitGoal_43));
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(1), Var_204, 0) = ((MR_Box) (OrigGoal_20));
          MR_hl_field(MR_mktag(1), Var_204, 1) = ((MR_Box) (Var_205));
        }
        Var_203 = mercury__list__f_43_43_2_f_0((MR_Word) (&hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_hlds_goal_0), SlotGoals_34, Var_204);
        {
          ...
          MR_hl_field(MR_mktag(3), TransformedGoalExpr_50, 2) = ((MR_Box) (Var_203));
        }
        {
    ...
    case (MR_Integer) 2:
      {
        ...
        Var_167 = parse_tree__set_of_var__make_singleton_1_f_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), SlotVar_32);
        hlds__hlds_goal__goal_info_init_6_p_0(Var_167, AfterInstMapDelta_58, (MR_Integer) 2, (MR_Integer) 2, Context_21, &AfterGoalInfo_59);
        {
          Var_172 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), Var_172, 0) = ((MR_Box) (RedoGoal_57));
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(1), Var_171, 0) = ((MR_Box) (ExitGoal_43));
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(0), AfterGoal_60, 0) = ((MR_Box) (Var_170));
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(1), Var_177, 0) = ((MR_Box) (AfterGoal_60));
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(1), Var_176, 0) = ((MR_Box) (OrigGoal_20));
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(1), Var_181, 0) = ((MR_Box) (FailGoal_46));
        ...
        Var_185 = mercury__list__f_43_43_2_f_0((MR_Word) (&hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_hlds_goal_0), SlotGoals_34, Var_186);
        {
        ...
        {
          TransGoal_51 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), TransGoal_51, 0) = ((MR_Box) (Var_183));
          MR_hl_field(MR_mktag(0), TransGoal_51, 1) = ((MR_Box) (ImpureOrigGoalInfo_26));
        }
      }
      break;
    case (MR_Integer) 1:
      {
...

        {
          ...
          MR_hl_field(MR_mktag(1), Var_191, 0) = ((MR_Box) (ExitGoal_43));
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(1), Var_190, 0) = ((MR_Box) (OrigGoal_20));
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(0), OrigAfterGoal_52, 0) = ((MR_Box) (Var_188));
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(1), Var_195, 0) = ((MR_Box) (FailGoal_46));
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(1), Var_194, 0) = ((MR_Box) (OrigAfterGoal_52));
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(0), DisjGoal_53, 0) = ((MR_Box) (Var_193));
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(1), Var_200, 0) = ((MR_Box) (DisjGoal_53));
          MR_hl_field(MR_mktag(1), Var_200, 1) = ((MR_Box) ((MR_Unsigned) 0U));
        }
        Var_199 = mercury__list__f_43_43_2_f_0((MR_Word) (&hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_hlds_goal_0), SlotGoals_34, Var_200);
        {
        ...
        {
          TransGoal_51 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), TransGoal_51, 0) = ((MR_Box) (Var_197));
          MR_hl_field(MR_mktag(0), TransGoal_51, 1) = ((MR_Box) (ImpureOrigGoalInfo_26));
        }
      }
      break;
  ...
  MR_Word * TypeInfoGoals_16)
{
  ...
  check_hlds__polymorphism_type_info__polymorphism_make_type_info_var_raw_10_p_0(Type_10, Context_11, TypeInfoVar_15, TypeInfoGoals_16, STATE_VARIABLE_ModuleInfo_0_21, STATE_VARIABLE_ModuleInfo_22, PredInfo0_17, &PredInfo_18, STATE_VARIABLE_ProcInfo_0_19, STATE_VARIABLE_ProcInfo_20);
  {
