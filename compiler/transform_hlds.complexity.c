...
transform_hlds__complexity__IntroducedFrom__pred__make_type_info_var__591__1_2_p_0(
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = transform_hlds__complexity__IntroducedFrom__pred__make_type_info_var__591__1_2_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))));
  return succeeded;
}
