...
{
  {
    ...
    succeeded = mercury__builtin__unify_2_p_0((MR_Word) &transform_hlds__complexity_scalar_common_1[1], ((MR_Box) (PolySpecs_20)), ((MR_Box) (HeadVar__2_32)));
    return succeeded;
  }
}
...
{
  {
    ...
    parse_tree__set_of_var__list_to_set_2_p_0(TypeCtorInfo_235_235, HeadVars_17, &OrigNonLocals_24);
    Var_25 = ((MR_Word) (MR_hl_field(MR_mktag(0), OrigGoal_21, (MR_Integer) 0)));
    ...
    {
      IsActiveOutputArg_36 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL);
      ...
      MR_hl_field(MR_mktag(0), IsActiveOutputArg_36, 3) = ((MR_Box) ((MR_Integer) 0));
    }
    ...
    {
      SlotInputArg_37 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL);
      ...
      MR_hl_field(MR_mktag(0), SlotInputArg_37, 3) = ((MR_Box) ((MR_Integer) 0));
    }
    ...
    transform_hlds__complexity__complexity_generate_foreign_proc_9_p_0((MR_String) "complexity_is_active", (MR_Integer) 0, Var_116, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), IsActiveStr_40, Var_118, STATE_VARIABLE_ModuleInfo_84_84, Context_22, &IsActiveGoal_41);
    ...
    transform_hlds__complexity__complexity_generate_foreign_proc_9_p_0((MR_String) "complexity_exit_proc", (MR_Integer) 0, Var_132, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), ExitStr_43, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), STATE_VARIABLE_ModuleInfo_84_84, Context_22, &ExitGoal_44);
    ...
    transform_hlds__complexity__complexity_generate_foreign_proc_9_p_0((MR_String) "complexity_fail_proc", (MR_Integer) 7, Var_132, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), FailStr_46, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), STATE_VARIABLE_ModuleInfo_84_84, Context_22, &FailGoal_47);
    ...
    transform_hlds__complexity__complexity_generate_foreign_proc_9_p_0((MR_String) "complexity_redo_proc", (MR_Integer) 7, Var_132, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), RedoStr_49, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), STATE_VARIABLE_ModuleInfo_84_84, Context_22, &RedoGoal0_50);
    switch (CodeModel_16) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        {
          ...
          {
            TransformedGoalExpr_51 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(3), TransformedGoalExpr_51, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 2));
            MR_hl_field(MR_mktag(3), TransformedGoalExpr_51, 1) = ((MR_Box) ((MR_Integer) 0));
            MR_hl_field(MR_mktag(3), TransformedGoalExpr_51, 2) = ((MR_Box) (Var_203));
          }
          {
            TransGoal_52 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
      ...
      case (MR_Integer) 2:
        {
          ...
          {
            RedoGoal_58 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
          ...
          Var_167 = parse_tree__set_of_var__make_singleton_1_f_0(TypeCtorInfo_235_235, SlotVar_33);
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(3), Var_170, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 3));
            MR_hl_field(MR_mktag(3), Var_170, 1) = ((MR_Box) (Var_171));
          }
          {
            AfterGoal_61 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(3), Var_174, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 2));
            MR_hl_field(MR_mktag(3), Var_174, 1) = ((MR_Box) ((MR_Integer) 0));
            MR_hl_field(MR_mktag(3), Var_174, 2) = ((MR_Box) (Var_176));
          }
          {
            OrigAfterGoal_233 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(3), Var_179, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 3));
            MR_hl_field(MR_mktag(3), Var_179, 1) = ((MR_Box) (Var_180));
          }
          {
            DisjGoal_234 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
          ...
          Var_185 = mercury__list__f_43_43_2_f_0((MR_Word) &hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_hlds_goal_0, SlotGoals_35, Var_186);
          {
            ...
            MR_hl_field(MR_mktag(3), Var_183, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 2));
            MR_hl_field(MR_mktag(3), Var_183, 1) = ((MR_Box) ((MR_Integer) 0));
      ...
      case (MR_Integer) 1:
        {
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(3), Var_188, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 2));
            MR_hl_field(MR_mktag(3), Var_188, 1) = ((MR_Box) ((MR_Integer) 0));
            MR_hl_field(MR_mktag(3), Var_188, 2) = ((MR_Box) (Var_190));
          }
          {
            OrigAfterGoal_53 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
          ...
          {
            DisjGoal_54 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
          ...
          Var_199 = mercury__list__f_43_43_2_f_0((MR_Word) &hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_hlds_goal_0, SlotGoals_35, Var_200);
          {
            ...
            MR_hl_field(MR_mktag(3), Var_197, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 2));
            MR_hl_field(MR_mktag(3), Var_197, 1) = ((MR_Box) ((MR_Integer) 0));
    ...
    {
      Var_211 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(3), Var_211, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 2));
    ...
    {
      Var_210 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), Var_210, 0) = ((MR_Box) (Var_211));
      MR_hl_field(MR_mktag(0), Var_210, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
    ...
    {
      Var_218 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(3), Var_218, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 2));
    ...
    {
      Var_217 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), Var_217, 0) = ((MR_Box) (Var_218));
      MR_hl_field(MR_mktag(0), Var_217, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
    ...
    {
      SwitchArms_64 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), SwitchArms_64, 0) = ((MR_Box) (Var_210));
      MR_hl_field(MR_mktag(1), SwitchArms_64, 1) = ((MR_Box) (Var_216));
    }
    {
      SwitchExpr_65 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(3), SwitchExpr_65, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 4));
      MR_hl_field(MR_mktag(3), SwitchExpr_65, 1) = ((MR_Box) (IsActiveVar_29));
      MR_hl_field(MR_mktag(3), SwitchExpr_65, 2) = ((MR_Box) ((MR_Integer) 1));
    ...
    {
      SwitchGoal_67 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
    ...
    {
      GoalExpr_68 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(3), GoalExpr_68, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 2));
      MR_hl_field(MR_mktag(3), GoalExpr_68, 1) = ((MR_Box) ((MR_Integer) 0));
    ...
    {
      Goal_70 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
    ...
    {
      ComplexityInfo_72 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL);
    ...
    {
      ComplexityInfos_74 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
  ...
  MR_Word * HeadVar__3_3)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      Var_10 = ((MR_Word) (MR_hl_field(MR_mktag(0), Info_6, (MR_Integer) 0)));
      Kind_11 = ((MR_Word) (MR_hl_field(MR_mktag(0), Info_6, (MR_Integer) 1)));
      switch (Kind_11) {
        default: /*NOTREACHED*/ MR_assert(0);
        case (MR_Integer) 1:
        case (MR_Integer) 2:
        ...
        case (MR_Integer) 0:
          {
            ...
            MR_Integer Var_14 = (MR_Integer) ((MR_Unsigned) Offset_2 + (MR_Unsigned) (MR_Integer) 1);
            MR_Word Var_16;
...
{
  {
    ...
    else
    {
      ...
      {
        MR_Word Mode_30 = ((MR_Word) (MR_hl_field(MR_mktag(1), HeadVar__2_2, (MR_Integer) 0)));
        MR_Word Modes_31 = ((MR_Word) (MR_hl_field(MR_mktag(1), HeadVar__2_2, (MR_Integer) 1)));
        MR_Word MaybeName_35;
        MR_Word Kind_36;
        MR_Word VarInfos_37;
        MR_Word Var_40;
        MR_Word Var_41;
        ...
        transform_hlds__complexity__classify_args_6_p_0(Var_43, Modes_31, ModuleInfo_3, VarSet_4, VarTypes_5, &VarInfos_37);
        succeeded = mercury__varset__search_name_3_p_0((MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0, VarSet_4, Var_44, &Name_38);
        if (succeeded)
          {
            MaybeName_35 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), MaybeName_35, 0) = ((MR_Box) (Name_38));
          }
        else
          MaybeName_35 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
        succeeded = check_hlds__mode_util__mode_is_fully_input_2_p_0(ModuleInfo_3, Mode_30);
        if (succeeded)
        {
          MR_Word VarType_39;

          hlds__vartypes__lookup_var_type_3_p_0(VarTypes_5, Var_44, &VarType_39);
          succeeded = transform_hlds__term_norm__zero_size_type_2_p_0(ModuleInfo_3, VarType_39);
          if (succeeded)
            Kind_36 = (MR_Integer) 1;
          else
            Kind_36 = (MR_Integer) 0;
        }
        else
          Kind_36 = (MR_Integer) 2;
        {
          Var_41 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), Var_41, 0) = ((MR_Box) (MaybeName_35));
          MR_hl_field(MR_mktag(0), Var_41, 1) = ((MR_Box) (Kind_36));
        }
        {
          Var_40 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), Var_40, 0) = ((MR_Box) (Var_44));
        ...
        }
        {
          ...
          *HeadVar__6_6 = base;
          ...
          MR_hl_field(MR_mktag(1), base, 1) = ((MR_Box) (VarInfos_37));
        }
      }
    }
  }
...
{
  {
    ...
    *SlotVarName_21 = (MR_String) "SlotVar";
    ...
    {
      SlotVarArg_27 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL);
      ...
      MR_hl_field(MR_mktag(0), SlotVarArg_27, 3) = ((MR_Box) ((MR_Integer) 0));
    }
...
{
  {
    ...
    hlds__goal_util__generate_foreign_proc_16_p_0(BuiltinModule_19, PredName_10, (MR_Integer) 0, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), Detism_11, (MR_Integer) 2, Attrs_21, Args_12, ExtraArgs_13, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), Code_14, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), Var_29, ModuleInfo_16, Context_17, Goal_18);
  }
}
...
{
  {
    ...
    {
      ForeignArg_35 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL);
      ...
      MR_hl_field(MR_mktag(0), ForeignArg_35, 3) = ((MR_Box) ((MR_Integer) 0));
    }
    ...
    {
      ForeignTypeInfoArg_36 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL);
      ...
      MR_hl_field(MR_mktag(0), ForeignTypeInfoArg_36, 3) = ((MR_Box) ((MR_Integer) 0));
    }
    {
...
{
  {
    ...
    mercury__require__expect_4_p_0(Var_28, (MR_String) "transform_hlds.complexity", (MR_String) "predicate \140transform_hlds.complexity.make_type_info_var\'/9", (MR_String) "got errors while making type_info_var");
    {
      Var_33 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 5 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), Var_33, 0) = ((MR_Box) (&transform_hlds__complexity_scalar_common_3[2]));
      MR_hl_field(MR_mktag(0), Var_33, 1) = ((MR_Box) (transform_hlds__complexity__make_type_info_var_9_p_0_2));
      MR_hl_field(MR_mktag(0), Var_33, 2) = ((MR_Box) (MR_Word) ((MR_Integer) 2));
      MR_hl_field(MR_mktag(0), Var_33, 3) = ((MR_Box) (PredInfo0_17));
      MR_hl_field(MR_mktag(0), Var_33, 4) = ((MR_Box) (PredInfo_21));
    }
    mercury__require__expect_4_p_0(Var_33, (MR_String) "transform_hlds.complexity", (MR_String) "predicate \140transform_hlds.complexity.make_type_info_var\'/9", (MR_String) "modified pred_info");
  }
}
...
{
  {
    ...
    if (succeeded)
      {
        IsInMap_10 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), IsInMap_10, 0) = ((MR_Box) (ProcNum_12));
      }
    else
      IsInMap_10 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
    return IsInMap_10;
  }
}
...
{
  {
    ...
    NameAndArity_14 = parse_tree__prog_out__sym_name_and_arity_to_string_1_f_0(Var_16);
...
{
  {
    ...
    if (((MR_tag((MR_Word) ResStream_8)) == (MR_mktag((MR_Integer) 1))))
    {
      ...
      case (MR_Integer) 0:
        {
          ...
          *MaybeError_12 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
      ...
      case (MR_Integer) 1:
        {
          ...
          if (succeeded)
          {
            MR_Integer Var_29 = (MR_Integer) ((MR_Unsigned) CurLineNum_10 + (MR_Unsigned) (MR_Integer) 1);
