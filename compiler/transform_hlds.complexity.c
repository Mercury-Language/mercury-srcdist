...
transform_hlds__complexity__IntroducedFrom__pred__make_type_info_var__599__1_2_p_0(
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_77)
{
  ...
  hlds__hlds_proc_util__proc_info_interface_determinism_2_p_0(STATE_VARIABLE_ProcInfo_0_74, &Detism_15);
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = transform_hlds__complexity__IntroducedFrom__pred__make_type_info_var__599__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 4)))));
  return succeeded;
}
