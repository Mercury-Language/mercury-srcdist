...
transform_hlds__complexity__IntroducedFrom__pred__make_type_info_var__605__1_2_p_0(
  MR_Word PredInfo0_17,
  MR_Word PredInfo_18);

static MR_bool MR_CALL 
transform_hlds__complexity__IntroducedFrom__pred__read_spec_file_lines__141__1_2_p_0(
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_79)
{
  ...
  hlds__hlds_proc__proc_info_get_headvars_2_p_0(STATE_VARIABLE_ProcInfo_0_76, &HeadVars_17);
  hlds__hlds_proc__proc_info_get_argmodes_2_p_0(STATE_VARIABLE_ProcInfo_0_76, &ArgModes_18);
  hlds__hlds_proc__proc_info_get_var_table_2_p_0(STATE_VARIABLE_ProcInfo_0_76, &VarTable_19);
  hlds__hlds_proc__proc_info_get_goal_2_p_0(STATE_VARIABLE_ProcInfo_0_76, &OrigGoal_20);
    ...
    case (MR_Integer) 2:
      {
        ...
        hlds__hlds_goal__goal_info_add_feature_3_p_0((MR_Integer) 7, RedoGoalInfo0_55, &RedoGoalInfo_56);
        {
  ...
  hlds__hlds_proc__proc_info_set_goal_3_p_0(Goal_71, STATE_VARIABLE_ProcInfo_2_85, STATE_VARIABLE_ProcInfo_77);
  ...
  MR_Word * HeadVar__5_5)
{
  ...
  else
  {
    ...
    else
    {
      ...
      succeeded = hlds__mode_test__mode_is_fully_input_3_p_0(ModuleInfo_1, VarType_33, Mode_26);
      if (succeeded)
      {
        succeeded = (IsDummy_34 == (MR_Integer) 0);
        if (!(succeeded))
          succeeded = termination__term_norm__zero_size_type_2_p_0(ModuleInfo_1, VarType_33);
        if (succeeded)
  ...
  MR_Word * STATE_VARIABLE_ProcInfo_16)
{
  ...
  hlds__hlds_proc__proc_info_get_var_table_2_p_0(STATE_VARIABLE_ProcInfo_0_15, &VarTable0_13);
  ...
  MR_Word * Goals_22)
{
  ...
  *SlotVarName_21 = (MR_String) "SlotVar";
  ...
  hlds__hlds_proc__proc_info_get_var_table_2_p_0(STATE_VARIABLE_ProcInfo_0_33, &VarTable0_79);
  parse_tree__var_table__add_var_entry_4_p_0(Entry_78, SlotVar_20, VarTable0_79, &VarTable_80);
  hlds__hlds_proc__proc_info_set_var_table_3_p_0(VarTable_80, STATE_VARIABLE_ProcInfo_0_33, &STATE_VARIABLE_ProcInfo_1_39);
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = transform_hlds__complexity__IntroducedFrom__pred__make_type_info_var__605__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) ((MR_hl_field(0, closure, 4)))));
  return succeeded;
}
  ...
  MR_String * CodeStr_26)
{
  ...
  hlds__hlds_proc__proc_info_get_var_table_2_p_0(STATE_VARIABLE_ProcInfo_0_37, &VarTable1_27);
  ...
  hlds__hlds_proc__proc_info_get_var_table_2_p_0(*STATE_VARIABLE_ProcInfo_38, &VarTable2_31);
  ...
  MR_Integer ProcId_7)
{
  ...
  hlds__pred_proc_id__proc_id_to_int_2_p_0(ProcId_7, &ProcIdInt_15);
  ...
  MR_Box wrapper_arg_1)
{
  ...
  succeeded = transform_hlds__complexity__IntroducedFrom__pred__read_spec_file_lines__141__1_2_p_0(((MR_Char) (MR_Word) (MR_hl_field(0, closure, 3))), ((MR_Char) (MR_Word) wrapper_arg_1));
  return succeeded;
}
