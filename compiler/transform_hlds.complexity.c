  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_24)
{
  ...
  MR_String FullName_29;
  MR_Integer ProcNum_30;
  MR_Box conv0_ProcNum_30;

  FullName_29 = transform_hlds__complexity__complexity_proc_name_3_f_0(STATE_VARIABLE_ModuleInfo_0_23, PredId_13, ProcId_14);
  succeeded = mercury__map__search_3_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0), ProcMap_9, ((MR_Box) (FullName_29)), &conv0_ProcNum_30);
  if (succeeded)
  {
    ProcNum_30 = ((MR_Integer) (conv0_ProcNum_30));
    succeeded = MR_TRUE;
  }
  if (succeeded)
  {
    ...
    transform_hlds__complexity__complexity_process_proc_8_p_0(NumProcs_8, ProcNum_30, FullName_17, PredId_13, STATE_VARIABLE_ProcInfo_0_21, STATE_VARIABLE_ProcInfo_22, STATE_VARIABLE_ModuleInfo_0_23, STATE_VARIABLE_ModuleInfo_24);
  }
  else
  {
  ...
  MR_Word * Goals_22)
{
  ...
  *SlotVarName_21 = (MR_String) "SlotVar";
  Var_37 = parse_tree__builtin_lib_types__int_type_0_f_0();
  {
    ...
    MR_hl_field(MR_mktag(0), Entry_78, 0) = ((MR_Box) (*SlotVarName_21));
    MR_hl_field(MR_mktag(0), Entry_78, 1) = ((MR_Box) (Var_37));
    MR_hl_field(MR_mktag(0), Entry_78, 2) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 1));
  }
  hlds__hlds_pred__proc_info_get_var_table_3_p_0(STATE_VARIABLE_ModuleInfo_0_35, STATE_VARIABLE_ProcInfo_0_33, &VarTable0_79);
  ...
  MR_String * CodeStr_26)
{
  ...
  check_hlds__polymorphism_type_info__polymorphism_make_type_info_var_mi_10_p_0(VarType_28, Context_17, &TypeInfoVar_30, Goals_24, STATE_VARIABLE_ModuleInfo_0_39, STATE_VARIABLE_ModuleInfo_40, PredInfo0_82, &PredInfo_83, STATE_VARIABLE_ProcInfo_0_37, STATE_VARIABLE_ProcInfo_38);
  {
    ...
    MR_hl_field(MR_mktag(0), Var_84, 0) = ((MR_Box) (&transform_hlds__complexity_scalar_common_3[1]));
    MR_hl_field(MR_mktag(0), Var_84, 1) = ((MR_Box) (transform_hlds__complexity__generate_size_goal_14_p_0_1));
    MR_hl_field(MR_mktag(0), Var_84, 2) = ((MR_Box) ((MR_Integer) 2));
    MR_hl_field(MR_mktag(0), Var_84, 3) = ((MR_Box) (PredInfo0_82));
    MR_hl_field(MR_mktag(0), Var_84, 4) = ((MR_Box) (PredInfo_83));
  }
