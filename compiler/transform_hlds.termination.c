  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      else
      {
        ...
        succeeded = mdbcomp__prim_data__special_pred_name_arity_4_p_1(&SpecPredId0_72, Name_70, &Var_73, &Var_77);
        if (succeeded)
        {
          succeeded = (Arity_71 == Var_77);
          if (succeeded)
        ...
        else
        {
          ...
          succeeded = ((MR_tag((MR_Word) Origin_75)) == (MR_Integer) 2);
          if (succeeded)
            SpecialPredId_74 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(2), Origin_75, (MR_Integer) 0))) & (MR_Integer) 3);
        }
        if (succeeded)
        {
