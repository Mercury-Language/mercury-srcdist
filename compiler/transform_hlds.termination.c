  ...
  MR_Word * STATE_VARIABLE_Specs_46)
{
  ...
  else
  {
    ...
    if ((BothErrors_31 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      ...
      libs__globals__lookup_int_option_3_p_0(Globals_39, (MR_Integer) 534, &SingleArgs_40);
    ...
    *STATE_VARIABLE_ModuleInfo_44 = ((MR_Word) (conv3_STATE_VARIABLE_ModuleInfo_44));
    if (((MR_tag((MR_Word) TerminationResult_38)) == (MR_Integer) 1))
    {
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals_75, (MR_Integer) 532, &NormalErrors_76);
      libs__globals__lookup_bool_option_3_p_0(Globals_75, (MR_Integer) 533, &VerboseErrors_77);
      {
        ...
        case (MR_Integer) 0:
          {
            ...
            Var_102 = parse_tree__error_spec__color_as_possible_cause_1_f_0((MR_Word) (MR_mkword(1, &transform_hlds__termination_scalar_common_1[11])));
            Var_116 = parse_tree__error_spec__color_as_possible_cause_1_f_0((MR_Word) (MR_mkword(1, &transform_hlds__termination_scalar_common_1[17])));
        ...
        case (MR_Integer) 1:
          {
            ...
            Var_54 = parse_tree__error_spec__color_as_possible_cause_1_f_0((MR_Word) (MR_mkword(1, &transform_hlds__termination_scalar_common_1[22])));
            Var_68 = parse_tree__error_spec__color_as_possible_cause_1_f_0((MR_Word) (MR_mkword(1, &transform_hlds__termination_scalar_common_1[24])));
  ...
  MR_Word * STATE_VARIABLE_Specs_21)
{
  ...
  libs__globals__lookup_int_option_3_p_0(Globals_6, (MR_Integer) 536, &MaxErrors_9);
  libs__globals__lookup_int_option_3_p_0(Globals_6, (MR_Integer) 537, &MaxPaths_10);
  {
