...
MR_decl_label2(transform_hlds__termination__check_foreign_code_attributes_2_5_0, 140,84)
MR_decl_label10(transform_hlds__termination__check_preds_5_0, 112,3,4,5,6,7,8,9,10,11)
...
MR_BEGIN_MODULE(transform_hlds__termination_module7)
	...
	MR_init_label10(transform_hlds__termination__check_preds_5_0,112,3,4,5,6,7,8,9,10,11)
...
MR_def_label(transform_hlds__termination__check_preds_5_0,112)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
...
MR_def_label(transform_hlds__termination__check_preds_5_0,61)
	...
	MR_GOTO_LAB(transform_hlds__termination__check_preds_5_0_i112);
	}
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_thread_engine_base
...
MR_BEGIN_MODULE(transform_hlds__termination_module11)
	...
	MR_init_label2(transform_hlds__termination__check_foreign_code_attributes_2_5_0,140,84)
MR_BEGIN_CODE
...
MR_def_static(transform_hlds__termination__check_foreign_code_attributes_2_5_0)
	...
	if (MR_LTAGS_TEST(MR_r1,0,0)) {
		MR_GOTO_LAB(transform_hlds__termination__check_foreign_code_attributes_2_5_0_i140);
	}
	{
	MR_Word MR_tempr1;
...
MR_def_label(transform_hlds__termination__check_foreign_code_attributes_2_5_0,5)
	...
	MR_r2 = MR_r3;
	MR_proceed();
MR_def_label(transform_hlds__termination__check_foreign_code_attributes_2_5_0,140)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(8);
	MR_sv(8) = (MR_Word) MR_succip;
