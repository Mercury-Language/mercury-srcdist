  ...
  MR_Box wrapper_arg_1)
{
  ...
  conv5_HeadVar__2_74 = transform_hlds__termination__IntroducedFrom__func__check_scc_pragmas_are_consistent__310__1_1_f_0(((MR_Word) (wrapper_arg_1)));
  ...
  else
  {
    ...
    if ((Var_78 == (MR_Word) ((MR_Unsigned) 0U)))
    {
...

      {
        ...
        MR_hl_field(MR_mktag(0), Var_59, 3) = ((MR_Box) (Var_79));
      }
