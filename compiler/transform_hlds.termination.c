...
MR_decl_label2(transform_hlds__termination__IntroducedFrom__pred__report_termination_errors__537__1_1_0, 2,1)
...
MR_decl_static(transform_hlds__termination__IntroducedFrom__pred__report_termination_errors__537__1_1_0)
...
{
MR_COMMON(11,0),
MR_ENTRY_AP(transform_hlds__termination__IntroducedFrom__pred__report_termination_errors__537__1_1_0),
0
},
{
MR_COMMON(11,1),
...
MR_BEGIN_MODULE(transform_hlds__termination_module25)
	MR_init_entry1(transform_hlds__termination__IntroducedFrom__pred__report_termination_errors__537__1_1_0);
	MR_init_label2(transform_hlds__termination__IntroducedFrom__pred__report_termination_errors__537__1_1_0,2,1)
MR_BEGIN_CODE
	...
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(transform_hlds__termination__IntroducedFrom__pred__report_termination_errors__537__1_1_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(1);
	MR_sv(1) = (MR_Word) MR_succip;
	MR_r1 = MR_ctfield(0, MR_r1, 0);
	MR_np_call_localret_ent(fn__transform_hlds__term_errors__is_indirect_error_1_0,
		transform_hlds__termination__IntroducedFrom__pred__report_termination_errors__537__1_1_0_i2);
MR_def_label(transform_hlds__termination__IntroducedFrom__pred__report_termination_errors__537__1_1_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(transform_hlds__termination__IntroducedFrom__pred__report_termination_errors__537__1_1_0_i1);
	}
	MR_succip_word = MR_sv(1);
	MR_decr_sp(1);
	MR_r1 = MR_TRUE;
	MR_proceed();
MR_def_label(transform_hlds__termination__IntroducedFrom__pred__report_termination_errors__537__1_1_0,1)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_succip_word = MR_sv(1);
	MR_decr_sp(1);
	MR_r1 = MR_FALSE;
