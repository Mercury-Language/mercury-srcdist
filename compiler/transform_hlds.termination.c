...
MR_def_label(transform_hlds__termination__report_termination_errors_6_0,4)
	...
	MR_tfield(0, MR_r2, 1) = (MR_Word) MR_ENTRY_AP(transform_hlds__termination__IntroducedFrom__pred__report_termination_errors__502__1_2_0);
...
MR_def_label(transform_hlds__termination__report_termination_errors_6_0,5)
	...
	MR_tfield(0, MR_r2, 1) = (MR_Word) MR_ENTRY_AP(transform_hlds__termination__IntroducedFrom__pred__report_termination_errors__518__1_2_0);
	MR_tfield(0, MR_r2, 2) = (MR_Integer) 1;
	MR_tfield(0, MR_r2, 3) = MR_sv(5);
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(hlds__hlds_pred, pred_proc_id);
	MR_r3 = MR_sv(1);
