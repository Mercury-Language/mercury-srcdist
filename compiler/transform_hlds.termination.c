...
{
  {
    ...
    else
    {
      ...
      if ((BothErrors_31 == (MR_Word) ((MR_Unsigned) 0U)))
      {
        ...
        libs__globals__lookup_int_option_3_p_0(Globals_39, (MR_Integer) 445, &SingleArgs_40);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_19, (MR_Integer) 443, &NormalErrors_20);
    libs__globals__lookup_bool_option_3_p_0(Globals_19, (MR_Integer) 444, &VerboseErrors_21);
    {
    ...
    else
    {
      ...
      else
      {
        ...
        *STATE_VARIABLE_ModuleInfo_26 = ((MR_Word) (conv4_STATE_VARIABLE_ModuleInfo_26));
        ...
        {
          Msg_23 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), Msg_23, 0) = ((MR_Box) (LeastContext_18));
          MR_hl_field(MR_mktag(1), Msg_23, 1) = ((MR_Box) (Var_55));
        }
        {
          ...
          case (MR_Integer) 0:
            {
              ...
              {
                Msg_120 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(1), Msg_120, 0) = ((MR_Box) (Context_14));
                MR_hl_field(MR_mktag(1), Msg_120, 1) = ((MR_Box) (Var_56));
              }
              {
          ...
          case (MR_Integer) 1:
            {
              ...
              }
              {
                ...
                MR_hl_field(MR_mktag(1), Msg_21, 0) = ((MR_Box) (Context_14));
                MR_hl_field(MR_mktag(1), Msg_21, 1) = ((MR_Box) (Var_93));
              }
              {
...
{
  {
    ...
    libs__globals__lookup_int_option_3_p_0(Globals_6, (MR_Integer) 447, &MaxErrors_9);
    libs__globals__lookup_int_option_3_p_0(Globals_6, (MR_Integer) 448, &MaxPaths_10);
    {
