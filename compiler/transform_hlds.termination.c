        ...
        if ((transform_hlds__termination__HeadVar__1_1 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
          *transform_hlds__termination__STATE_VARIABLE_ModuleInfo_3 = transform_hlds__termination__STATE_VARIABLE_ModuleInfo_0_2;
        else
          {
            ...
            {
              libs__globals__lookup_bool_option_3_p_0(transform_hlds__termination__Globals_10, (MR_Integer) 88, &transform_hlds__termination__MakeOptInt_11);
            }
            {
                    ...
                    if (!(transform_hlds__termination__succeeded))
                      {
                        ...
                        if (transform_hlds__termination__succeeded)
                          {
                            transform_hlds__termination__V_38_38 = (MR_Integer) 20;
                            {
            ...
            {
              transform_hlds__termination__succeeded = hlds__hlds_pred__check_marker_2_p_0(transform_hlds__termination__Markers_17, (MR_Integer) 19);
            }
            if (transform_hlds__termination__succeeded)
              {
