  ...
  MR_Word * STATE_VARIABLE_Specs_13)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_19, (MR_Integer) 515, &NormalErrors_20);
  libs__globals__lookup_bool_option_3_p_0(Globals_19, (MR_Integer) 516, &VerboseErrors_21);
  {
  ...
  else
  {
    ...
    if ((Var_79 == (MR_Word) ((MR_Unsigned) 0U)))
    {
...

      {
        ...
        MR_hl_field(MR_mktag(0), Var_34, 3) = ((MR_Box) (Var_80));
      }
      ...
      else
      {
        ...
        else
        {
          ...
          if (!(succeeded))
          {
            ...
            if (succeeded)
            {
              Var_44 = (MR_Integer) 20;
              succeeded = hlds__hlds_pred__check_marker_2_p_0(Markers_26, Var_44);
            }
          }
          if (succeeded)
