    ...
    if (transform_hlds__termination__succeeded)
      {
        ...
        transform_hlds__termination__Var_31 = (MR_Integer) 20;
        {
...
{
  {
    ...
    if (transform_hlds__termination__succeeded)
      transform_hlds__termination__Var_78 = ((MR_Word) (MR_hl_field(MR_mktag(1), transform_hlds__termination__Var_73, (MR_Integer) 0)));
    return transform_hlds__termination__succeeded;
  }
}
                    ...
                    if (!(transform_hlds__termination__succeeded))
                      {
                        ...
                        if (transform_hlds__termination__succeeded)
                          {
                            transform_hlds__termination__Var_40 = (MR_Integer) 20;
                            {
...
{
  {
    ...
    {
      transform_hlds__termination__Var_30 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), transform_hlds__termination__Var_30, 0) = ((MR_Box) (&transform_hlds__termination_scalar_common_4[0]));
