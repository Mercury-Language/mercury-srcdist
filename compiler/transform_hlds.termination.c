...
{
  {
    ...
    {
      libs__globals__lookup_bool_option_3_p_0(transform_hlds__termination__Globals_19, (MR_Integer) 417, &transform_hlds__termination__NormalErrors_20);
    }
    {
      libs__globals__lookup_bool_option_3_p_0(transform_hlds__termination__Globals_19, (MR_Integer) 418, &transform_hlds__termination__VerboseErrors_21);
    }
        ...
        if ((transform_hlds__termination__BothErrors_31 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
          {
            ...
            {
              libs__globals__lookup_int_option_3_p_0(transform_hlds__termination__Globals_39, (MR_Integer) 419, &transform_hlds__termination__SingleArgs_40);
            }
            {
...
{
  {
    ...
    {
      libs__globals__lookup_int_option_3_p_0(transform_hlds__termination__Globals_6, (MR_Integer) 421, &transform_hlds__termination__MaxErrors_9);
    }
    {
      libs__globals__lookup_int_option_3_p_0(transform_hlds__termination__Globals_6, (MR_Integer) 422, &transform_hlds__termination__MaxPaths_10);
    }
    {
