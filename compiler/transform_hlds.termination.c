  ...
  MR_Word * STATE_VARIABLE_Specs_46)
{
  ...
  else
  {
    ...
    else
    {
      ...
      mercury__set__foldl_4_p_0((MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_proc_id_0), (MR_Word) (&hlds__hlds_module__hlds__hlds_module__type_ctor_info_module_info_0), Var_75, SCCTerminationUnknown_25, ((MR_Box) (STATE_VARIABLE_ModuleInfo_52_52)), &conv5_STATE_VARIABLE_ModuleInfo_44);
  ...
  MR_Word * STATE_VARIABLE_Specs_13)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_18, (MR_Integer) 513, &NormalErrors_19);
  libs__globals__lookup_bool_option_3_p_0(Globals_18, (MR_Integer) 514, &VerboseErrors_20);
  {
  ...
  else
  {
    ...
    if (succeeded)
      switch (VerboseErrors_20) {
        ...
        case (MR_Integer) 0:
          {
            MR_Word MaybeErrorsToReport_57;

            switch (NormalErrors_19) {
              default: /*NOTREACHED*/ MR_assert(0);
              case (MR_Integer) 0:
                MaybeErrorsToReport_57 = (MR_Word) ((MR_Unsigned) 0U);
                break;
              case (MR_Integer) 1:
                {
                  ...
                  if ((DirectErrors_34 == (MR_Word) ((MR_Unsigned) 0U)))
                    {
                      MaybeErrorsToReport_57 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                      MR_hl_field(MR_mktag(1), MaybeErrorsToReport_57, 0) = ((MR_Box) (Errors_8));
                    }
                  else
                    {
                      MaybeErrorsToReport_57 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                      MR_hl_field(MR_mktag(1), MaybeErrorsToReport_57, 0) = ((MR_Box) (DirectErrors_34));
                    }
                }
                break;
            }
            if ((MaybeErrorsToReport_57 == (MR_Word) ((MR_Unsigned) 0U)))
              *STATE_VARIABLE_Specs_13 = STATE_VARIABLE_Specs_0_12;
            else
            {
              MR_Word ErrorsToReport_55 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MaybeErrorsToReport_57, (MR_Integer) 0))));

              transform_hlds__term_errors__report_term_errors_5_p_0(ModuleInfo_6, SCC_7, ErrorsToReport_55, STATE_VARIABLE_Specs_0_12, STATE_VARIABLE_Specs_13);
            }
          }
          break;
        case (MR_Integer) 1:
    ...
    else
    {
      ...
      else
      {
        ...
        else
        {
          ...
          if (succeeded)
            SpecialPredId_74 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(1), Origin_75, (MR_Integer) 0))) & (MR_Integer) 3);
        }
        if (succeeded)
        {
      ...
      else
      {
        ...
        else
        {
          ...
          if (!(succeeded))
          {
            ...
            if (succeeded)
            {
              Var_42 = (MR_Integer) 20;
              succeeded = hlds__hlds_pred__check_marker_2_p_0(Markers_25, Var_42);
            }
          }
          if (succeeded)
