...
{
  {
    ...
    else
    {
      ...
      if (((MR_tag((MR_Word) KnownTermStatus_16)) == (MR_Integer) 1))
      {
        succeeded = ((MR_tag((MR_Word) PPIdStatus_88)) == (MR_Integer) 1);
        if (succeeded)
        {
        }
      }
      else
        succeeded = ((MR_tag((MR_Word) PPIdStatus_88)) == (MR_Integer) 0);
      if (succeeded)
  ...
  MR_Word ModuleInfo_3)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      if (((MR_tag((MR_Word) Status_1)) == (MR_Integer) 1))
      {
        succeeded = ((MR_tag((MR_Word) PPIdStatus_13)) == (MR_Integer) 1);
        if (succeeded)
        {
        }
      }
      else
        succeeded = ((MR_tag((MR_Word) PPIdStatus_13)) == (MR_Integer) 0);
      if (succeeded)
      {
        // direct tailcall eliminated
        ;
...
{
  {
    ...
    else
    {
      ...
      if ((Var_38 == (MR_Word) ((MR_Integer) 0)))
      {
        ...
        succeeded = ((((MR_tag((MR_Word) GoalExpr_14)) == (MR_Integer) 3)) && ((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), GoalExpr_14, (MR_Integer) 0))) == (MR_Integer) 1)));
        if (succeeded)
        {
