  ...
  MR_Word * STATE_VARIABLE_Specs_13)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_18, (MR_Integer) 516, &NormalErrors_19);
  libs__globals__lookup_bool_option_3_p_0(Globals_18, (MR_Integer) 517, &VerboseErrors_20);
  {
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_4)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      succeeded = hlds__hlds_pred__check_marker_2_p_0(Markers_25, (MR_Integer) 20);
      if (succeeded)
      {
