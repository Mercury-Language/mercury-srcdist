...
{
  {
    ...
    else
    {
      ...
      if ((BothErrors_31 == (MR_Word) ((MR_Unsigned) 0U)))
      {
        ...
        libs__globals__lookup_int_option_3_p_0(Globals_39, (MR_Integer) 446, &SingleArgs_40);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_19, (MR_Integer) 444, &NormalErrors_20);
    libs__globals__lookup_bool_option_3_p_0(Globals_19, (MR_Integer) 445, &VerboseErrors_21);
    {
...
{
  {
    ...
    conv5_HeadVar__2_74 = transform_hlds__termination__IntroducedFrom__func__check_scc_pragmas_are_consistent__309__1_1_f_0(((MR_Word) (wrapper_arg_1)));
    ...
    else
    {
      ...
      if ((Var_78 == (MR_Word) ((MR_Unsigned) 0U)))
      {
...

        {
          ...
          MR_hl_field(MR_mktag(0), Var_58, 0) = ((MR_Box) (&transform_hlds__termination_scalar_common_6[0]));
          MR_hl_field(MR_mktag(0), Var_58, 1) = ((MR_Box) (transform_hlds__termination__check_scc_pragmas_are_consistent_5_p_0_1));
          MR_hl_field(MR_mktag(0), Var_58, 2) = ((MR_Box) ((MR_Integer) 1));
          MR_hl_field(MR_mktag(0), Var_58, 3) = ((MR_Box) (Var_79));
        }
        mercury__set__foldl_4_p_0((MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_proc_id_0), (MR_Word) (&hlds__hlds_module__hlds__hlds_module__type_ctor_info_module_info_0), Var_58, UnknownPPIdSet_12, ((MR_Box) (STATE_VARIABLE_ModuleInfo_0_24)), &conv1_STATE_VARIABLE_ModuleInfo_25);
      ...
      else
      {
        ...
        *STATE_VARIABLE_ModuleInfo_25 = ((MR_Word) (conv4_STATE_VARIABLE_ModuleInfo_25));
        ...
        PredNamePieces_21 = hlds__hlds_error_util__describe_several_pred_names_3_f_0(*STATE_VARIABLE_ModuleInfo_25, (MR_Integer) 0, Var_42);
        {
          ...
          MR_hl_field(MR_mktag(1), Var_44, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &transform_hlds__termination_scalar_common_1[36])));
          MR_hl_field(MR_mktag(1), Var_44, 1) = ((MR_Box) (PredNamePieces_21));
        }
        Pieces_22 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_format_component_0), Var_44, (MR_Word) (MR_mkword(MR_mktag(1), &transform_hlds__termination_scalar_common_1[27])));
        {
          Spec_23 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), Spec_23, 0) = ((MR_Box) ((MR_Unsigned) 4U));
          MR_hl_field(MR_mktag(1), Spec_23, 1) = ((MR_Box) ((MR_Unsigned) 4U));
          MR_hl_field(MR_mktag(1), Spec_23, 2) = ((MR_Box) (LeastContext_18));
...
{
  {
    ...
    if ((MaybeTermination_13 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      ...
      else
      {
        ...
        {
          TermStatus_98 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), TermStatus_98, 0) = ((MR_Box) (Var_94));
        }
        hlds__hlds_pred__proc_info_set_maybe_termination_info_3_p_0(TermStatus_98, STATE_VARIABLE_ProcInfo_0_24, STATE_VARIABLE_ProcInfo_25);
      }
      *STATE_VARIABLE_Specs_27 = STATE_VARIABLE_Specs_0_26;
    }
    else
    {
      MR_Word Var_123 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MaybeTermination_13, (MR_Integer) 0))));

      if (((MR_tag((MR_Word) Var_123)) == (MR_Integer) 1))
      {
        MR_Word TermErrs0_22 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Var_123, (MR_Integer) 0))));
        MR_Word ProcTerminates_117;

        ProcTerminates_117 = parse_tree__prog_data_foreign__get_terminates_1_f_0(Attributes_10);
        switch (ProcTerminates_117) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 2:
            {
          ...
          case (MR_Integer) 0:
            {
              ...
              MR_Word Var_30;
              MR_Word Var_33;
              MR_Word TermStatus_105;
              MR_Word TermErr_106;
              MR_Word ProcNamePieces_107;
              MR_Word Pieces_108;
              MR_Word Spec_109;

              {
                TermErr_106 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
                MR_hl_field(MR_mktag(0), TermErr_106, 0) = ((MR_Box) (Context_14));
                MR_hl_field(MR_mktag(0), TermErr_106, 1) = ((MR_Box) ((MR_Unsigned) 28U));
              }
              {
                TermErrs_23 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(1), TermErrs_23, 0) = ((MR_Box) (TermErr_106));
              ...
              {
                TermStatus_105 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(1), TermStatus_105, 0) = ((MR_Box) (Var_30));
              }
              hlds__hlds_pred__proc_info_set_maybe_termination_info_3_p_0(TermStatus_105, STATE_VARIABLE_ProcInfo_0_24, STATE_VARIABLE_ProcInfo_25);
              ProcNamePieces_107 = hlds__hlds_error_util__describe_one_proc_name_3_f_0(ModuleInfo_8, (MR_Integer) 0, PPId_9);
              {
                Var_33 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(1), Var_33, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &transform_hlds__termination_scalar_common_1[36])));
                MR_hl_field(MR_mktag(1), Var_33, 1) = ((MR_Box) (ProcNamePieces_107));
              }
              Pieces_108 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_format_component_0), Var_33, (MR_Word) (MR_mkword(MR_mktag(1), &transform_hlds__termination_scalar_common_1[16])));
              {
                Spec_109 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(1), Spec_109, 0) = ((MR_Box) ((MR_Unsigned) 4U));
                MR_hl_field(MR_mktag(1), Spec_109, 1) = ((MR_Box) ((MR_Unsigned) 4U));
                MR_hl_field(MR_mktag(1), Spec_109, 2) = ((MR_Box) (Context_14));
                MR_hl_field(MR_mktag(1), Spec_109, 3) = ((MR_Box) (Pieces_108));
              }
              {
                MR_Word base;
                base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          ...
          case (MR_Integer) 1:
            {
              ...
              MR_Word Var_61;
              MR_Word Var_65;
              MR_Word TermStatus_99;
              MR_Word TermErr_100;

              {
                TermErr_100 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
                MR_hl_field(MR_mktag(0), TermErr_100, 0) = ((MR_Box) (Context_14));
                MR_hl_field(MR_mktag(0), TermErr_100, 1) = ((MR_Box) ((MR_Unsigned) 28U));
              }
              {
                Var_61 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(1), Var_61, 0) = ((MR_Box) (TermErr_100));
              ...
              {
                TermStatus_99 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(1), TermStatus_99, 0) = ((MR_Box) (Var_60));
              }
              hlds__hlds_pred__proc_info_set_maybe_termination_info_3_p_0(TermStatus_99, STATE_VARIABLE_ProcInfo_0_24, STATE_VARIABLE_ProcInfo_25);
              ProcNamePieces_19 = hlds__hlds_error_util__describe_one_proc_name_3_f_0(ModuleInfo_8, (MR_Integer) 0, PPId_9);
              {
                Var_65 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(1), Var_65, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &transform_hlds__termination_scalar_common_1[36])));
                MR_hl_field(MR_mktag(1), Var_65, 1) = ((MR_Box) (ProcNamePieces_19));
              }
              Pieces_20 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_format_component_0), Var_65, (MR_Word) (MR_mkword(MR_mktag(1), &transform_hlds__termination_scalar_common_1[23])));
              {
                ...
                MR_hl_field(MR_mktag(1), Spec_21, 2) = ((MR_Box) (Context_14));
...
{
  {
    ...
    libs__globals__lookup_int_option_3_p_0(Globals_6, (MR_Integer) 448, &MaxErrors_9);
    libs__globals__lookup_int_option_3_p_0(Globals_6, (MR_Integer) 449, &MaxPaths_10);
    {
