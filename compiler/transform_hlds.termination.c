...
{
  {
    ...
    else
    {
      ...
      if ((BothErrors_31 == (MR_Word) ((MR_Unsigned) 0U)))
      {
        ...
        libs__globals__lookup_int_option_3_p_0(Globals_39, (MR_Integer) 509, &SingleArgs_40);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_19, (MR_Integer) 507, &NormalErrors_20);
    libs__globals__lookup_bool_option_3_p_0(Globals_19, (MR_Integer) 508, &VerboseErrors_21);
    {
          ...
          case (MR_Integer) 0:
            {
              ...
              Pieces_110 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_format_component_0), Var_33, (MR_Word) (MR_mkword(MR_mktag(1), &transform_hlds__termination_scalar_common_1[16])));
              {
          ...
          case (MR_Integer) 1:
            {
              ...
              ProcNamePieces_19 = hlds__hlds_error_util__describe_one_proc_name_3_f_0(ModuleInfo_8, (MR_Integer) 0, PPId_9);
              {
                ...
                MR_hl_field(MR_mktag(1), Var_66, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &transform_hlds__termination_scalar_common_1[36])));
                MR_hl_field(MR_mktag(1), Var_66, 1) = ((MR_Box) (ProcNamePieces_19));
              }
              Pieces_20 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_format_component_0), Var_66, (MR_Word) (MR_mkword(MR_mktag(1), &transform_hlds__termination_scalar_common_1[23])));
              {
...
{
  {
    ...
    libs__globals__lookup_int_option_3_p_0(Globals_6, (MR_Integer) 511, &MaxErrors_9);
    libs__globals__lookup_int_option_3_p_0(Globals_6, (MR_Integer) 512, &MaxPaths_10);
    {
