  ...
  else
  {
    ...
    *STATE_VARIABLE_ModuleInfo_44 = ((MR_Word) (conv3_STATE_VARIABLE_ModuleInfo_44));
    if (((MR_tag((MR_Word) TerminationResult_38)) == (MR_Integer) 1))
    {
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals_75, (MR_Integer) 513, &NormalErrors_76);
      libs__globals__lookup_bool_option_3_p_0(Globals_75, (MR_Integer) 514, &VerboseErrors_77);
      {
          ...
          if ((MaybeTermination_40 == (MR_Word) ((MR_Unsigned) 0U)))
          {
            ...
            else
            {
...

              {
                ...
                MR_hl_field(MR_mktag(3), Var_77, 1) = ((MR_Box) (Var_39));
              }
              {
                TermErr_43 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
                MR_hl_field(MR_mktag(0), TermErr_43, 0) = ((MR_Box) (Context_41));
                MR_hl_field(MR_mktag(0), TermErr_43, 1) = ((MR_Box) (Var_77));
              }
              {
                Var_79 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(1), Var_79, 0) = ((MR_Box) (TermErr_43));
              ...
              }
              {
                ...
                MR_hl_field(MR_mktag(1), TermStatus_81, 0) = ((MR_Box) (Var_78));
              }
                ...
                case (MR_Integer) 0:
                  {
                    ...
                    }
                    {
                      ...
                      MR_hl_field(MR_mktag(1), Var_53, 0) = ((MR_Box) (TermErrs_50));
                    }
                    {
                      TermStatus_84 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                      MR_hl_field(MR_mktag(1), TermStatus_84, 0) = ((MR_Box) (Var_53));
                    }
                    ...
                    ProcNamePieces_86 = hlds__hlds_error_util__describe_one_proc_name_3_f_0(STATE_VARIABLE_ModuleInfo_0_27, (MR_Integer) 0, Var_39);
                    {
                      ...
                      MR_hl_field(MR_mktag(1), Var_55, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &transform_hlds__termination_scalar_common_1[5])));
                      MR_hl_field(MR_mktag(1), Var_55, 1) = ((MR_Box) (ProcNamePieces_86));
                    }
                    Pieces_87 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_format_component_0), Var_55, (MR_Word) (MR_mkword(MR_mktag(1), &transform_hlds__termination_scalar_common_1[17])));
                    {
                ...
                case (MR_Integer) 1:
                  {
                    ...
                    }
                    {
                      ...
                      MR_hl_field(MR_mktag(1), Var_65, 0) = ((MR_Box) (TermErr_83));
                    ...
                    }
                    {
                      ...
                      MR_hl_field(MR_mktag(1), TermStatus_82, 0) = ((MR_Box) (Var_64));
                    }
                    ...
                    ProcNamePieces_46 = hlds__hlds_error_util__describe_one_proc_name_3_f_0(STATE_VARIABLE_ModuleInfo_0_27, (MR_Integer) 0, Var_39);
                    {
                      ...
                      MR_hl_field(MR_mktag(1), Var_68, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &transform_hlds__termination_scalar_common_1[5])));
                      MR_hl_field(MR_mktag(1), Var_68, 1) = ((MR_Box) (ProcNamePieces_46));
                    }
                    Pieces_47 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_format_component_0), Var_68, (MR_Word) (MR_mkword(MR_mktag(1), &transform_hlds__termination_scalar_common_1[24])));
                    {
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      else
      {
        ...
        succeeded = mdbcomp__prim_data__special_pred_name_arity_4_p_1(&SpecPredId0_59, Name_57, &Var_60, &Var_64);
        if (succeeded)
        {
          succeeded = (Arity_58 == Var_64);
          if (succeeded)
        ...
        else
        {
          ...
          if (succeeded)
            SpecialPredId_61 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(1), Origin_62, (MR_Integer) 0))) & (MR_Integer) 3);
        }
        if (succeeded)
        {
      ...
      else
      {
        ...
        if (succeeded)
        {
          succeeded = hlds__hlds_pred__check_marker_2_p_0(Markers_20, (MR_Integer) 18);
          if (succeeded)
        ...
        else
        {
          ...
          if (!(succeeded))
          {
            ...
            if (succeeded)
            {
              ...
              succeeded = hlds__hlds_pred__check_marker_2_p_0(Markers_20, Var_37);
            }
          }
          if (succeeded)
        ...
        case (MR_Integer) 2:
          {
            ...
            transform_hlds__term_util__make_bool_list_3_p_0((MR_Word) (&transform_hlds__termination_scalar_common_1[4]), HeadVars_14, (MR_Word) (MR_mkword(MR_mktag(1), &transform_hlds__termination_scalar_common_1[32])), &OutList_27);
            {
              ...
              MR_hl_field(MR_mktag(0), ArgSize_15, 1) = ((MR_Box) (OutList_27));
            }
        ...
        case (MR_Integer) 1:
          {
            ...
            transform_hlds__term_util__make_bool_list_3_p_0((MR_Word) (&transform_hlds__termination_scalar_common_1[4]), HeadVars_14, (MR_Word) (MR_mkword(MR_mktag(1), &transform_hlds__termination_scalar_common_1[31])), &OutList_38);
            {
              ArgSize_15 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
              MR_hl_field(MR_mktag(0), ArgSize_15, 0) = ((MR_Box) ((MR_Integer) 0));
              MR_hl_field(MR_mktag(0), ArgSize_15, 1) = ((MR_Box) (OutList_38));
            }
            Termination_16 = (MR_Word) (&transform_hlds__termination_scalar_common_3[0]);
          }
          break;
        case (MR_Integer) 0:
          {
            ...
            transform_hlds__term_util__make_bool_list_3_p_0((MR_Word) (&transform_hlds__termination_scalar_common_1[4]), HeadVars_14, (MR_Word) (MR_mkword(MR_mktag(1), &transform_hlds__termination_scalar_common_1[34])), &OutList_37);
            {
              ArgSize_15 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
              MR_hl_field(MR_mktag(0), ArgSize_15, 0) = ((MR_Box) ((MR_Integer) 0));
