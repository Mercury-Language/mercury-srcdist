  ...
  MR_Word * STATE_VARIABLE_Specs_46)
{
  ...
  else
  {
    ...
    if ((BothErrors_31 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      ...
      libs__globals__lookup_int_option_3_p_0(Globals_39, (MR_Integer) 550, &SingleArgs_40);
    ...
    *STATE_VARIABLE_ModuleInfo_44 = ((MR_Word) (conv3_STATE_VARIABLE_ModuleInfo_44));
    if (((MR_tag((MR_Word) TerminationResult_38)) == (MR_Integer) 1))
    {
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals_75, (MR_Integer) 548, &NormalErrors_76);
      libs__globals__lookup_bool_option_3_p_0(Globals_75, (MR_Integer) 549, &VerboseErrors_77);
      {
  ...
  MR_Word * STATE_VARIABLE_Specs_21)
{
  ...
  libs__globals__lookup_int_option_3_p_0(Globals_6, (MR_Integer) 552, &MaxErrors_9);
  libs__globals__lookup_int_option_3_p_0(Globals_6, (MR_Integer) 553, &MaxPaths_10);
  {
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      else
      {
        ...
        if (succeeded)
        {
          succeeded = hlds__hlds_markers__marker_is_present_2_p_0(Markers_20, (MR_Integer) 19);
          if (succeeded)
