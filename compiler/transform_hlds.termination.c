...
{
  {
    ...
    else
    {
      ...
      if ((BothErrors_31 == (MR_Word) ((MR_Unsigned) 0U)))
      {
        ...
        libs__globals__lookup_int_option_3_p_0(Globals_39, (MR_Integer) 434, &SingleArgs_40);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_19, (MR_Integer) 432, &NormalErrors_20);
    libs__globals__lookup_bool_option_3_p_0(Globals_19, (MR_Integer) 433, &VerboseErrors_21);
    {
...
{
  {
    ...
    if ((SCCTerminationKnown_9 == (MR_Word) ((MR_Unsigned) 0U)))
    {
    ...
    else
    {
      ...
      if ((MaybeKnownTerm_15 == (MR_Word) ((MR_Unsigned) 0U)))
      {
        {
      ...
      if ((MaybeTerm_87 == (MR_Word) ((MR_Unsigned) 0U)))
      {
        {
  ...
  MR_Word ModuleInfo_3)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      if ((MaybeTerm_12 == (MR_Word) ((MR_Unsigned) 0U)))
      {
        mercury__require__unexpected_2_p_0((MR_String) "predicate \140transform_hlds.termination.check_procs_known_term\'/3", (MR_String) "no termination info for procedure");
      }
      else
...
{
  {
    ...
    libs__globals__lookup_int_option_3_p_0(Globals_6, (MR_Integer) 436, &MaxErrors_9);
    libs__globals__lookup_int_option_3_p_0(Globals_6, (MR_Integer) 437, &MaxPaths_10);
    {
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        transform_hlds__term_util__make_bool_list_3_p_0((MR_Word) (&transform_hlds__termination_scalar_common_1[3]), HeadVars_20, (MR_Word) ((MR_Unsigned) 0U), &UsedArgs_21);
        {
