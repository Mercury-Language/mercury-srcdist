  ...
  else
  {
    ...
    *STATE_VARIABLE_ModuleInfo_44 = ((MR_Word) (conv3_STATE_VARIABLE_ModuleInfo_44));
    if (((MR_tag((MR_Word) TerminationResult_38)) == (MR_Integer) 1))
    {
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals_75, (MR_Integer) 515, &NormalErrors_76);
      libs__globals__lookup_bool_option_3_p_0(Globals_75, (MR_Integer) 516, &VerboseErrors_77);
      {
