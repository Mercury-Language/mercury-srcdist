...
{
  {
    MR_Word LambdaHeadVar__2_44 = ((MR_Word) (MR_hl_field(MR_mktag(0), LambdaHeadVar__1_43, (MR_Integer) 0)));
    MR_Integer Var_64 = ((MR_Integer) (MR_hl_field(MR_mktag(0), LambdaHeadVar__1_43, (MR_Integer) 1)));
...
{
  {
    ...
    conv4_LambdaHeadVar__2_44 = transform_hlds__termination__IntroducedFrom__func__check_scc_pragmas_are_consistent__315__1_1_f_0(((MR_Word) wrapper_arg_1));
...
{
  {
    ...
    TypeCtorInfo_68_68 = (MR_Word) &hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_proc_id_0;
    Var_31 = mercury__set__to_sorted_list_1_f_0(TypeCtorInfo_68_68, SCC_6);
    mercury__list__filter_4_p_0(TypeCtorInfo_68_68, Var_30, Var_31, &SCCTerminationKnown_9, &SCCTerminationUnknown_10);
    ...
    else
    {
      ...
      MR_Word PPIds_83;
      MR_Word ProcInfo_86;
      MR_Word MaybeTerm_87;
      MR_Word PPIdStatus_88;
      MR_Word Var_85;
      ...
      {
        {
          mercury__require__unexpected_2_p_0((MR_String) "predicate \140transform_hlds.termination.check_scc_pragmas_are_consistent\'/5", (MR_String) "no termination info found");
          return;
        }
      }
      else
        KnownTermStatus_16 = ((MR_Word) (MR_hl_field(MR_mktag(1), MaybeKnownTerm_15, (MR_Integer) 0)));
      PPId_82 = ((MR_Word) (MR_hl_field(MR_mktag(1), SCCTerminationKnown_9, (MR_Integer) 0)));
      PPIds_83 = ((MR_Word) (MR_hl_field(MR_mktag(1), SCCTerminationKnown_9, (MR_Integer) 1)));
      hlds__hlds_module__module_info_pred_proc_info_4_p_0(STATE_VARIABLE_ModuleInfo_0_26, PPId_82, &Var_85, &ProcInfo_86);
      hlds__hlds_pred__proc_info_get_maybe_termination_info_2_p_0(ProcInfo_86, &MaybeTerm_87);
      if ((MaybeTerm_87 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
      {
        {
          mercury__require__unexpected_2_p_0((MR_String) "predicate \140transform_hlds.termination.check_procs_known_term\'/3", (MR_String) "no termination info for procedure");
          return;
        }
      }
      else
        PPIdStatus_88 = ((MR_Word) (MR_hl_field(MR_mktag(1), MaybeTerm_87, (MR_Integer) 0)));
      if (((MR_tag((MR_Word) KnownTermStatus_16)) == (MR_mktag((MR_Integer) 1))))
      {
        MR_Word Var_92;

        succeeded = ((MR_tag((MR_Word) PPIdStatus_88)) == (MR_mktag((MR_Integer) 1)));
        if (succeeded)
          Var_92 = ((MR_Word) (MR_hl_field(MR_mktag(1), PPIdStatus_88, (MR_Integer) 0)));
      }
      else
        succeeded = ((MR_tag((MR_Word) PPIdStatus_88)) == (MR_mktag((MR_Integer) 0)));
      if (succeeded)
        succeeded = transform_hlds__termination__check_procs_known_term_3_p_0(KnownTermStatus_16, PPIds_83, STATE_VARIABLE_ModuleInfo_0_26);
      if (succeeded)
      {
        MR_Word Var_34;
...

        {
          ...
          MR_hl_field(MR_mktag(0), Var_34, 0) = ((MR_Box) (&transform_hlds__termination_scalar_common_7[0]));
          MR_hl_field(MR_mktag(0), Var_34, 1) = ((MR_Box) (transform_hlds__termination__check_scc_pragmas_are_consistent_5_p_0_2));
          MR_hl_field(MR_mktag(0), Var_34, 2) = ((MR_Box) (MR_Word) ((MR_Integer) 1));
          MR_hl_field(MR_mktag(0), Var_34, 3) = ((MR_Box) (KnownTermStatus_16));
        }
        mercury__list__foldl_4_p_0(TypeCtorInfo_68_68, (MR_Word) &hlds__hlds_module__hlds__hlds_module__type_ctor_info_module_info_0, Var_34, SCCTerminationUnknown_10, ((MR_Box) (STATE_VARIABLE_ModuleInfo_0_26)), &conv1_STATE_VARIABLE_ModuleInfo_27);
      ...
      else
      {
        ...
        hlds__hlds_pred__pred_info_get_context_2_p_0(KnownPredInfo_13, &Context_17);
        {
          ...
          MR_hl_field(MR_mktag(0), Var_37, 0) = ((MR_Box) (Context_17));
          MR_hl_field(MR_mktag(0), Var_37, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 7))));
        }
        {
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(1), NewTermStatus_18, 0) = ((MR_Box) (Var_36));
        }
        {
          Var_40 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), Var_40, 0) = ((MR_Box) (&transform_hlds__termination_scalar_common_7[0]));
          MR_hl_field(MR_mktag(0), Var_40, 1) = ((MR_Box) (transform_hlds__termination__check_scc_pragmas_are_consistent_5_p_0_3));
          MR_hl_field(MR_mktag(0), Var_40, 2) = ((MR_Box) (MR_Word) ((MR_Integer) 1));
          MR_hl_field(MR_mktag(0), Var_40, 3) = ((MR_Box) (NewTermStatus_18));
        }
        mercury__set__foldl_4_p_0(TypeCtorInfo_68_68, (MR_Word) &hlds__hlds_module__hlds__hlds_module__type_ctor_info_module_info_0, Var_40, SCC_6, ((MR_Box) (STATE_VARIABLE_ModuleInfo_0_26)), &conv3_STATE_VARIABLE_ModuleInfo_27);
        *STATE_VARIABLE_ModuleInfo_27 = ((MR_Word) conv3_STATE_VARIABLE_ModuleInfo_27);
        PredIds_19 = mercury__list__map_2_f_0(TypeCtorInfo_68_68, (MR_Word) &hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_id_0, (MR_Word) &transform_hlds__termination_scalar_common_2[3], SCCTerminationKnown_9);
        PredNamePieces_22 = hlds__hlds_error_util__describe_several_pred_names_3_f_0(*STATE_VARIABLE_ModuleInfo_27, (MR_Integer) 0, PredIds_19);
        {
          ...
          MR_hl_field(MR_mktag(1), Var_46, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &transform_hlds__termination_scalar_common_1[36])));
          MR_hl_field(MR_mktag(1), Var_46, 1) = ((MR_Box) (PredNamePieces_22));
        }
        Pieces_23 = mercury__list__f_43_43_2_f_0((MR_Word) &parse_tree__error_util__parse_tree__error_util__type_ctor_info_format_component_0, Var_46, (MR_Word) MR_mkword(MR_mktag(1), &transform_hlds__termination_scalar_common_1[26]));
        {
