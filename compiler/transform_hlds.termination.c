...
{
  {
    ...
    if (succeeded)
    {
      ArgSizeErrors_18 = (MR_Word) ((MR_Integer) 0);
      TermErrors_19 = (MR_Word) ((MR_Integer) 0);
    ...
    else
    {
      ...
      if ((BothErrors_31 == (MR_Word) ((MR_Integer) 0)))
      {
          ...
          case (MR_Integer) 0:
            {
              ...
              switch (NormalErrors_20) {
                default: /*NOTREACHED*/ MR_assert(0);
                case (MR_Integer) 0:
                  MaybeErrorsToReport_58 = (MR_Word) ((MR_Integer) 0);
                  break;
                case (MR_Integer) 1:
                  {
                    ...
                    if ((DirectErrors_35 == (MR_Word) ((MR_Integer) 0)))
                      {
              ...
              if ((MaybeErrorsToReport_58 == (MR_Word) ((MR_Integer) 0)))
...
{
  {
    ...
    if ((SCCTerminationKnown_9 == (MR_Word) ((MR_Integer) 0)))
    {
    ...
    else
    {
      ...
      if ((MaybeKnownTerm_15 == (MR_Word) ((MR_Integer) 0)))
      {
        {
      ...
      if ((MaybeTerm_87 == (MR_Word) ((MR_Integer) 0)))
      {
        {
      ...
      else
      {
        ...
        hlds__hlds_pred__pred_info_get_context_2_p_0(KnownPredInfo_13, &Context_17);
        {
          ...
          MR_hl_field(MR_mktag(0), Var_37, 1) = ((MR_Box) ((MR_Integer) 28));
        }
        {
        ...
        *STATE_VARIABLE_ModuleInfo_27 = ((MR_Word) (conv3_STATE_VARIABLE_ModuleInfo_27));
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(0), Spec_25, 0) = ((MR_Box) ((MR_Integer) 4));
  ...
  MR_Word ModuleInfo_3)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      if ((MaybeTerm_12 == (MR_Word) ((MR_Integer) 0)))
      {
        mercury__require__unexpected_2_p_0((MR_String) "predicate \140transform_hlds.termination.check_procs_known_term\'/3", (MR_String) "no termination info for procedure");
      }
      else
...
{
  {
    ...
    if ((PPIds_9 == (MR_Word) ((MR_Integer) 0)))
    {
      {
...
{
  {
    ...
    if ((MaybeTermination_13 == (MR_Word) ((MR_Integer) 0)))
    {
          ...
          case (MR_Integer) 0:
            {
...

              {
                ...
                MR_hl_field(MR_mktag(0), TermErr_117, 1) = ((MR_Box) ((MR_Integer) 28));
              }
              {
              ...
              }
              {
                ...
                MR_hl_field(MR_mktag(0), Spec_121, 0) = ((MR_Box) ((MR_Integer) 4));
                MR_hl_field(MR_mktag(0), Spec_121, 1) = ((MR_Box) ((MR_Integer) 4));
          ...
          case (MR_Integer) 1:
            {
...

              {
                ...
                MR_hl_field(MR_mktag(0), TermErr_111, 1) = ((MR_Box) ((MR_Integer) 28));
              }
              {
              ...
              }
              {
                ...
                MR_hl_field(MR_mktag(0), Spec_22, 0) = ((MR_Box) ((MR_Integer) 4));
                MR_hl_field(MR_mktag(0), Spec_22, 1) = ((MR_Box) ((MR_Integer) 4));
        ...
        else
        {
          ...
          else
          {
...

            {
              ...
              MR_hl_field(MR_mktag(0), TerminationError_22, 1) = ((MR_Box) ((MR_Integer) 4));
            }
            {
              Var_46 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(0), ArgSizeError_24, 1) = ((MR_Box) ((MR_Integer) 4));
          }
          {
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      if (!(succeeded))
      {
        ...
        succeeded = mercury__builtin__unify_2_p_0((MR_Word) (&transform_hlds__termination_scalar_common_1[35]), ((MR_Box) ((MR_Integer) 0)), ((MR_Box) (Var_26)));
      }
      if (succeeded)
      {
        MR_Word ProcInfo_17;
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      if (!(succeeded))
      {
        ...
        succeeded = mercury__builtin__unify_2_p_0((MR_Word) (&transform_hlds__termination_scalar_common_1[34]), ((MR_Box) ((MR_Integer) 0)), ((MR_Box) (Var_26)));
      }
      if (succeeded)
      {
        MR_Word ProcInfo_17;
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        transform_hlds__term_util__make_bool_list_3_p_0((MR_Word) (&transform_hlds__termination_scalar_common_1[3]), HeadVars_20, (MR_Word) ((MR_Integer) 0), &UsedArgs_21);
        {
