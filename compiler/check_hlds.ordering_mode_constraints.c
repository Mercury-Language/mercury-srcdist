...
#line 51 "check_hlds.ordering_mode_constraints.c"
#line 31 "../library/array.int2"
#include "array.mh"

#line 55 "check_hlds.ordering_mode_constraints.c"
#line 56 "check_hlds.ordering_mode_constraints.c"
#include "check_hlds.ordering_mode_constraints.mh"

#line 59 "check_hlds.ordering_mode_constraints.c"
#line 60 "check_hlds.ordering_mode_constraints.c"
#ifndef CHECK_HLDS__ORDERING_MODE_CONSTRAINTS_DECL_GUARD
#define CHECK_HLDS__ORDERING_MODE_CONSTRAINTS_DECL_GUARD

#line 64 "check_hlds.ordering_mode_constraints.c"
#line 65 "check_hlds.ordering_mode_constraints.c"

#endif
#line 68 "check_hlds.ordering_mode_constraints.c"
...
MR_decl_label4(__Unify___check_hlds__ordering_mode_constraints__mode_analysis_failure_0_0, 10,6,27,1)
...
MR_decl_label8(__Compare___check_hlds__ordering_mode_constraints__mode_analysis_failure_0_0, 3,2,33,17,6,37,16,9)
MR_decl_label2(__Compare___check_hlds__ordering_mode_constraints__mode_analysis_failure_0_0, 11,71)
...
MR_BEGIN_MODULE(check_hlds__ordering_mode_constraints_module27)
	...
	MR_init_label4(__Unify___check_hlds__ordering_mode_constraints__mode_analysis_failure_0_0,10,6,27,1)
MR_BEGIN_CODE
...
MR_def_static(__Unify___check_hlds__ordering_mode_constraints__mode_analysis_failure_0_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if ((MR_r1 == MR_r2)) {
		MR_GOTO_LAB(__Unify___check_hlds__ordering_mode_constraints__mode_analysis_failure_0_0_i27);
	}
	MR_incr_sp(3);
	MR_sv(3) = (MR_Word) MR_succip;
	MR_sv(1) = MR_r1;
	...
	if (MR_PTAG_TEST(MR_tempr2,1)) {
		MR_GOTO_LAB(__Unify___check_hlds__ordering_mode_constraints__mode_analysis_failure_0_0_i6);
	}
	if (MR_PTAG_TEST(MR_tempr2,2)) {
		MR_GOTO_LAB(__Unify___check_hlds__ordering_mode_constraints__mode_analysis_failure_0_0_i10);
	}
...
MR_def_label(__Unify___check_hlds__ordering_mode_constraints__mode_analysis_failure_0_0,10)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	...
	MR_decr_sp(3);
	MR_np_tailcall_ent(__Unify___hlds__hlds_pred__pred_proc_id_0_0);
MR_def_label(__Unify___check_hlds__ordering_mode_constraints__mode_analysis_failure_0_0,6)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_def_label(__Unify___check_hlds__ordering_mode_constraints__mode_analysis_failure_0_0,27)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_TRUE;
	MR_proceed();
...
MR_BEGIN_MODULE(check_hlds__ordering_mode_constraints_module28)
	...
	MR_init_label8(__Compare___check_hlds__ordering_mode_constraints__mode_analysis_failure_0_0,3,2,33,17,6,37,16,9)
	MR_init_label2(__Compare___check_hlds__ordering_mode_constraints__mode_analysis_failure_0_0,11,71)
MR_BEGIN_CODE
...
MR_def_label(__Compare___check_hlds__ordering_mode_constraints__mode_analysis_failure_0_0,2)
	...
	if (MR_PTAG_TEST(MR_tempr1,1)) {
		MR_GOTO_LAB(__Compare___check_hlds__ordering_mode_constraints__mode_analysis_failure_0_0_i6);
	}
	if (MR_PTAG_TEST(MR_tempr1,2)) {
		MR_GOTO_LAB(__Compare___check_hlds__ordering_mode_constraints__mode_analysis_failure_0_0_i17);
	}
	MR_tempr2 = MR_sv(2);
	MR_r4 = MR_tempr2;
	if (MR_PTAG_TEST(MR_tempr2,1)) {
		MR_GOTO_LAB(__Compare___check_hlds__ordering_mode_constraints__mode_analysis_failure_0_0_i16);
	}
	if (MR_PTAG_TEST(MR_tempr2,2)) {
		MR_GOTO_LAB(__Compare___check_hlds__ordering_mode_constraints__mode_analysis_failure_0_0_i16);
	}
...
MR_def_label(__Compare___check_hlds__ordering_mode_constraints__mode_analysis_failure_0_0,17)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_sv(2);
...
MR_def_label(__Compare___check_hlds__ordering_mode_constraints__mode_analysis_failure_0_0,6)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_sv(2);
	MR_r4 = MR_tempr1;
	if (MR_PTAG_TEST(MR_tempr1,1)) {
		MR_GOTO_LAB(__Compare___check_hlds__ordering_mode_constraints__mode_analysis_failure_0_0_i9);
	}
	if (MR_PTAG_TEST(MR_tempr1,2)) {
		MR_GOTO_LAB(__Compare___check_hlds__ordering_mode_constraints__mode_analysis_failure_0_0_i16);
	}
...
MR_def_label(__Compare___check_hlds__ordering_mode_constraints__mode_analysis_failure_0_0,37)
	...
	MR_r1 = (MR_Integer) 2;
	MR_decr_sp_and_return(3);
MR_def_label(__Compare___check_hlds__ordering_mode_constraints__mode_analysis_failure_0_0,16)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Integer) 1;
	MR_decr_sp_and_return(3);
MR_def_label(__Compare___check_hlds__ordering_mode_constraints__mode_analysis_failure_0_0,9)
	...
	MR_np_call_localret_ent(private_builtin__builtin_compare_int_3_0,
		__Compare___check_hlds__ordering_mode_constraints__mode_analysis_failure_0_0_i11);
MR_def_label(__Compare___check_hlds__ordering_mode_constraints__mode_analysis_failure_0_0,11)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___check_hlds__ordering_mode_constraints__mode_analysis_failure_0_0_i71);
	}
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(hlds__hlds_pred, pred_id);
	MR_r2 = MR_sv(2);
	MR_r3 = MR_sv(1);
...
MR_def_label(__Compare___check_hlds__ordering_mode_constraints__mode_analysis_failure_0_0,71)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(3);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
