  ...
  MR_Word * STATE_VARIABLE_OCInfo_19)
{
  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      TypeCtorInfo_13_43 = (MR_Word) (&mdbcomp__goal_path__mdbcomp__goal_path__type_ctor_info_goal_id_0);
      TypeCtorInfo_14_44 = (MR_Word) (&mdbcomp__goal_path__mdbcomp__goal_path__type_ctor_info_containing_goal_0);
      mercury__map__lookup_3_p_0(TypeCtorInfo_13_43, TypeCtorInfo_14_44, ContainingGoalMap_15, ((MR_Box) (GoalId_38)), &conv0_ContainingGoal_39);
