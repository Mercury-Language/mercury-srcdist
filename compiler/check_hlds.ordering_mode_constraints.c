...
MR_decl_label10(check_hlds__ordering_mode_constraints__dump_goal_goal_paths_5_0, 63,2,3,7,10,13,17,23,26,28)
MR_decl_label7(check_hlds__ordering_mode_constraints__dump_goal_goal_paths_5_0, 38,34,35,30,42,43,73)
...
MR_BEGIN_MODULE(check_hlds__ordering_mode_constraints_module21)
	...
	MR_init_label10(check_hlds__ordering_mode_constraints__dump_goal_goal_paths_5_0,63,2,3,7,10,13,17,23,26,28)
	MR_init_label7(check_hlds__ordering_mode_constraints__dump_goal_goal_paths_5_0,38,34,35,30,42,43,73)
MR_BEGIN_CODE
...
MR_def_static(check_hlds__ordering_mode_constraints__dump_goal_goal_paths_5_0)
	...
	MR_incr_sp(4);
	MR_sv(4) = (MR_Word) MR_succip;
MR_def_label(check_hlds__ordering_mode_constraints__dump_goal_goal_paths_5_0,63)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(1) = MR_r1;
	MR_sv(2) = MR_r2;
	{
...
MR_def_label(check_hlds__ordering_mode_constraints__dump_goal_goal_paths_5_0,7)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_tag(MR_sv(3)),3)) {
		MR_GOTO_LAB(check_hlds__ordering_mode_constraints__dump_goal_goal_paths_5_0_i73);
	}
	MR_COMPUTED_GOTO((MR_Unsigned) MR_tfield(3, MR_sv(3), 0),
		MR_LABEL_AP(check_hlds__ordering_mode_constraints__dump_goal_goal_paths_5_0_i73) MR_AND
		MR_LABEL_AP(check_hlds__ordering_mode_constraints__dump_goal_goal_paths_5_0_i10) MR_AND
		MR_LABEL_AP(check_hlds__ordering_mode_constraints__dump_goal_goal_paths_5_0_i13) MR_AND
		MR_LABEL_AP(check_hlds__ordering_mode_constraints__dump_goal_goal_paths_5_0_i42) MR_AND
		MR_LABEL_AP(check_hlds__ordering_mode_constraints__dump_goal_goal_paths_5_0_i23) MR_AND
		MR_LABEL_AP(check_hlds__ordering_mode_constraints__dump_goal_goal_paths_5_0_i26) MR_AND
		MR_LABEL_AP(check_hlds__ordering_mode_constraints__dump_goal_goal_paths_5_0_i17) MR_AND
		MR_LABEL_AP(check_hlds__ordering_mode_constraints__dump_goal_goal_paths_5_0_i28));
...
MR_def_label(check_hlds__ordering_mode_constraints__dump_goal_goal_paths_5_0,23)
	...
	MR_succip_word = MR_sv(4);
	MR_GOTO_LAB(check_hlds__ordering_mode_constraints__dump_goal_goal_paths_5_0_i63);
...
MR_def_label(check_hlds__ordering_mode_constraints__dump_goal_goal_paths_5_0,28)
	...
	MR_np_call_localret_ent(fn__check_hlds__ordering_mode_constraints__this_file_0_0,
		check_hlds__ordering_mode_constraints__dump_goal_goal_paths_5_0_i38);
MR_def_label(check_hlds__ordering_mode_constraints__dump_goal_goal_paths_5_0,38)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_def_label(check_hlds__ordering_mode_constraints__dump_goal_goal_paths_5_0,30)
	...
	MR_tfield(0, MR_tempr2, 1) = (MR_Word) MR_ENTRY_AP(check_hlds__ordering_mode_constraints__dump_goal_goal_paths_5_0);
	MR_tfield(0, MR_tempr2, 2) = (MR_Integer) 2;
	MR_tfield(0, MR_tempr2, 3) = MR_sv(1);
	MR_tfield(0, MR_tempr2, 4) = ((MR_Integer) MR_sv(2) + (MR_Integer) 1);
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(hlds__hlds_goal, hlds_goal);
	MR_r2 = (MR_Word) MR_IO_CTOR_ADDR;
	MR_succip_word = MR_sv(4);
	MR_decr_sp(4);
...
MR_def_label(check_hlds__ordering_mode_constraints__dump_goal_goal_paths_5_0,42)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_np_call_localret_ent(fn__check_hlds__ordering_mode_constraints__this_file_0_0,
		check_hlds__ordering_mode_constraints__dump_goal_goal_paths_5_0_i43);
MR_def_label(check_hlds__ordering_mode_constraints__dump_goal_goal_paths_5_0,43)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = (MR_Word) MR_string_const("switch", 6);
	MR_succip_word = MR_sv(4);
	MR_decr_sp(4);
	MR_np_tailcall_ent(libs__compiler_util__unexpected_2_0);
MR_def_label(check_hlds__ordering_mode_constraints__dump_goal_goal_paths_5_0,73)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(4);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
