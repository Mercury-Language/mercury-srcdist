                ...
                case (MR_Integer) 1:
                  {
                    ...
                    MR_Word Var_77;
                    MR_Word Goals_95;
                    MR_Unsigned packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), ShortHand_50, (MR_Integer) 0)));
          ...
          case (MR_Integer) 2:
            {
              ...
              MR_Word Goals_46;
              MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), GoalExpr0_13, (MR_Integer) 1)));
