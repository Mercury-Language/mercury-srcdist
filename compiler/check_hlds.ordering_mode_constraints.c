              ...
              case (MR_Integer) 1:
                {
...

                  {
                    ...
                    MR_hl_field(MR_mktag(0), Var_66, 0) = ((MR_Box) (&check_hlds__ordering_mode_constraints_scalar_common_10[1]));
                  ...
                  if (succeeded)
                  {
                    ...
                    if (succeeded)
                    {
                      ...
                      mercury__list__map_3_p_0(TypeCtorInfo_78_78, (MR_Word) (&hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_hlds_goal_0), Var_68, Order_44, &Goals1_45);
                      {
                        ...
                        MR_hl_field(MR_mktag(0), Var_69, 0) = ((MR_Box) (&check_hlds__ordering_mode_constraints_scalar_common_10[1]));
