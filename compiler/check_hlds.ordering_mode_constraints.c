...
{
  {
    ...
    check_hlds__ordering_mode_constraints__IntroducedFrom__pred__make_conjunct_nonlocal_repvars__507__1_5_p_0(((MR_Word) (MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3))), ((MR_Word) (MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4))), ((MR_Word) wrapper_arg_1), ((MR_Word) wrapper_arg_2), &conv0_LambdaHeadVar__3_20);
...
{
  {
    ...
    check_hlds__ordering_mode_constraints__IntroducedFrom__pred__goal_reordering__356__1_3_p_0(((MR_Word) (MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3))), ((MR_Integer) wrapper_arg_1), &conv1_HeadVar__3_78);
...
{
  {
    ...
    else
    {
      ...
      check_hlds__clause_to_proc__copy_clauses_to_procs_for_pred_in_module_info_3_p_0(PredId_8, STATE_VARIABLE_ModuleInfo_0_20, &STATE_VARIABLE_ModuleInfo_25_25);
      hlds__hlds_module__module_info_pred_info_3_p_0(STATE_VARIABLE_ModuleInfo_25_25, PredId_8, &PredInfo1_11);
      mercury__map__lookup_3_p_0((MR_Word) &hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_id_0, (MR_Word) &check_hlds__ordering_mode_constraints_scalar_common_3[0], PredConstraintsMap_6, ((MR_Box) (PredId_8)), &conv0_Var_26);
      Var_26 = ((MR_Tuple) conv0_Var_26);
      ContainingGoalMap_12 = ((MR_Word) (MR_hl_field(MR_mktag(0), Var_26, (MR_Integer) 0)));
      PredConstraints_13 = ((MR_Word) (MR_hl_field(MR_mktag(0), Var_26, (MR_Integer) 1)));
      ProcIds_14 = hlds__hlds_pred__pred_info_all_procids_1_f_0(PredInfo1_11);
      {
        Var_27 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 7 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), Var_27, 0) = ((MR_Box) (&check_hlds__ordering_mode_constraints_scalar_common_8[0]));
        MR_hl_field(MR_mktag(0), Var_27, 1) = ((MR_Box) (check_hlds__ordering_mode_constraints__pred_reordering_5_p_0_1));
        MR_hl_field(MR_mktag(0), Var_27, 2) = ((MR_Box) (MR_Word) ((MR_Integer) 4));
        MR_hl_field(MR_mktag(0), Var_27, 3) = ((MR_Box) (ContainingGoalMap_12));
        MR_hl_field(MR_mktag(0), Var_27, 4) = ((MR_Box) (PredConstraints_13));
        MR_hl_field(MR_mktag(0), Var_27, 5) = ((MR_Box) (VarMap_7));
        MR_hl_field(MR_mktag(0), Var_27, 6) = ((MR_Box) (PredId_8));
      }
      TypeInfo_42_42 = (MR_Word) &check_hlds__ordering_mode_constraints_scalar_common_1[1];
      mercury__list__foldl2_6_p_0((MR_Word) &hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_proc_id_0, TypeInfo_42_42, (MR_Word) &hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_info_0, Var_27, ProcIds_14, ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))), &conv4_Errors_15, ((MR_Box) (PredInfo1_11)), &conv3_PredInfo_16);
      ...
      if ((Errors_15 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
        hlds__hlds_module__module_info_set_pred_info_4_p_0(PredId_8, PredInfo_16, STATE_VARIABLE_ModuleInfo_25_25, STATE_VARIABLE_ModuleInfo_21);
      else
      {
        MR_String ErrorsString_19;
        MR_String Var_31;

        ErrorsString_19 = mercury__string__string_1_f_0(TypeInfo_42_42, ((MR_Box) (Errors_15)));
        Var_31 = mercury__string__f_43_43_2_f_0((MR_String) "mode checking failure: ", ErrorsString_19);
        {
          mercury__require__sorry_3_p_0((MR_String) "check_hlds.ordering_mode_constraints", (MR_String) "predicate \140check_hlds.ordering_mode_constraints.pred_reordering\'/5", Var_31);
          return;
        }
      }
    }
