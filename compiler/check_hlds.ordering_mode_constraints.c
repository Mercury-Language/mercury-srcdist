...
MR_decl_label1(check_hlds__ordering_mode_constraints__make_conjuncts_nonlocal_repvars_3_0, 4)
MR_decl_label2(check_hlds__ordering_mode_constraints__minimum_reordering_2_0, 2,3)
MR_decl_label10(check_hlds__ordering_mode_constraints__pred_reordering_5_0, 2,5,4,9,10,13,14,17,19,21)
MR_decl_label1(check_hlds__ordering_mode_constraints__pred_reordering_5_0, 22)
...
MR_decl_label5(__Compare___check_hlds__ordering_mode_constraints__ordering_constraints_info_0_0, 3,2,5,9,29)
...
MR_BEGIN_MODULE(check_hlds__ordering_mode_constraints_module5)
	...
	MR_init_label10(check_hlds__ordering_mode_constraints__pred_reordering_5_0,2,5,4,9,10,13,14,17,19,21)
	MR_init_label1(check_hlds__ordering_mode_constraints__pred_reordering_5_0,22)
MR_BEGIN_CODE
...
MR_def_label(check_hlds__ordering_mode_constraints__pred_reordering_5_0,10)
	...
	MR_np_call_localret_ent(map__lookup_3_0,
		check_hlds__ordering_mode_constraints__pred_reordering_5_0_i13);
MR_def_label(check_hlds__ordering_mode_constraints__pred_reordering_5_0,13)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_def_label(check_hlds__ordering_mode_constraints__pred_reordering_5_0,17)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
		MR_GOTO_LAB(check_hlds__ordering_mode_constraints__pred_reordering_5_0_i19);
	}
	MR_r1 = MR_sv(2);
	MR_r3 = MR_sv(5);
	MR_succip_word = MR_sv(7);
...
MR_def_label(check_hlds__ordering_mode_constraints__pred_reordering_5_0,19)
	...
	MR_np_call_localret_ent(fn__string__string_1_0,
		check_hlds__ordering_mode_constraints__pred_reordering_5_0_i21);
MR_def_label(check_hlds__ordering_mode_constraints__pred_reordering_5_0,21)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
	...
	MR_np_call_localret_ent(fn__f_115_116_114_105_110_103_95_95_43_43_2_0,
		check_hlds__ordering_mode_constraints__pred_reordering_5_0_i22);
MR_def_label(check_hlds__ordering_mode_constraints__pred_reordering_5_0,22)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
...
MR_BEGIN_MODULE(check_hlds__ordering_mode_constraints_module6)
	...
	MR_init_label1(check_hlds__ordering_mode_constraints__make_conjuncts_nonlocal_repvars_3_0,4)
MR_BEGIN_CODE
...
MR_def_static(check_hlds__ordering_mode_constraints__make_conjuncts_nonlocal_repvars_3_0)
	...
	MR_tfield(0, MR_tempr1, 3) = MR_r1;
	MR_sv(1) = MR_r2;
	MR_sv(3) = (MR_Word) MR_TAG_COMMON(0,2,10);
	MR_sv(4) = (MR_Word) MR_CTOR0_ADDR(check_hlds__build_mode_constraints, mc_rep_var);
	MR_r1 = MR_sv(3);
	MR_r2 = MR_sv(4);
	}
	MR_np_call_localret_ent(fn__multi_map__init_0_0,
		check_hlds__ordering_mode_constraints__make_conjuncts_nonlocal_repvars_3_0_i4);
MR_def_label(check_hlds__ordering_mode_constraints__make_conjuncts_nonlocal_repvars_3_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
...
MR_def_static(check_hlds__ordering_mode_constraints__produced_at_path_3_0)
	...
	MR_sv(3) = (MR_Word) MR_TAG_COMMON(0,2,15);
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tempr1 = MR_r1;
...
MR_def_label(check_hlds__ordering_mode_constraints__dump_pred_goal_paths_4_0,8)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(4) = (MR_Word) MR_TAG_COMMON(1,2,17);
	MR_r1 = (MR_Integer) 0;
	MR_r2 = MR_sv(1);
...
MR_def_label(check_hlds__ordering_mode_constraints__dump_pred_goal_paths_4_0,11)
	...
	MR_r2 = MR_tempr1;
	MR_r3 = (MR_Word) MR_TAG_COMMON(1,2,19);
	}
...
MR_def_label(check_hlds__ordering_mode_constraints__dump_goal_goal_paths_5_0,13)
	...
	MR_r3 = MR_tempr4;
	MR_tfield(0, MR_tempr4, 0) = (MR_Word) MR_COMMON(3,7);
...
MR_def_label(check_hlds__ordering_mode_constraints__dump_goal_goal_paths_5_0,26)
	...
	MR_r3 = MR_tempr3;
	MR_tfield(0, MR_tempr3, 0) = (MR_Word) MR_COMMON(3,8);
...
MR_def_label(check_hlds__ordering_mode_constraints__dump_proc_goal_paths_5_0,3)
	...
	MR_tag_alloc_heap(MR_tempr2, 1, (MR_Integer) 2);
	MR_tfield(1, MR_tempr2, 0) = MR_tempr1;
	MR_tfield(1, MR_tempr2, 1) = (MR_Word) MR_TAG_COMMON(1,2,20);
	MR_tag_alloc_heap(MR_r2, 1, (MR_Integer) 2);
	MR_tfield(1, MR_r2, 0) = (MR_Word) MR_TAG_COMMON(3,12,2);
...
MR_BEGIN_MODULE(check_hlds__ordering_mode_constraints_module32)
	...
	MR_init_label5(__Compare___check_hlds__ordering_mode_constraints__ordering_constraints_info_0_0,3,2,5,9,29)
MR_BEGIN_CODE
...
MR_def_label(__Compare___check_hlds__ordering_mode_constraints__ordering_constraints_info_0_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___check_hlds__ordering_mode_constraints__ordering_constraints_info_0_0_i29);
	}
	MR_r1 = MR_sv(1);
	MR_r2 = MR_sv(3);
	MR_np_call_localret_ent(private_builtin__builtin_compare_int_3_0,
...
MR_def_label(__Compare___check_hlds__ordering_mode_constraints__ordering_constraints_info_0_0,29)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(5);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
