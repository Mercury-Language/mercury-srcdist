  ...
  MR_Word * STATE_VARIABLE_Info_51)
{
  ...
  hlds__hlds_proc__proc_info_get_var_table_2_p_0(ProcInfo0_17, &VarTable_19);
              ...
              if (succeeded)
              {
                ...
                if (succeeded)
                {
                  ...
                  if (succeeded)
                  {
                    ...
                    if (succeeded)
                    {
                      succeeded = hlds__type_util__type_has_user_defined_equality_pred_3_p_0(ModuleInfo_16, Type_25, &Var_40);
                      succeeded = !(succeeded);
                      if (succeeded)
                      {
                        hlds__pred_proc_id__proc_id_to_int_2_p_0(CalleeProcId_10, &CalleeProcIdInt_41);
                      ...
                      if (succeeded)
                      {
                        ...
                        Var_60 = hlds__type_util__is_type_a_dummy_2_f_0(ModuleInfo_16, Type_25);
                        ...
                        {
                          succeeded = hlds__type_classify__type_is_atomic_2_p_0(ModuleInfo_16, Type_25);
                          if (succeeded)
                          {
                          ...
                          else
                          {
                            ...
                            succeeded = hlds__type_util__type_is_no_tag_type_4_p_0(ModuleInfo_16, Type_25, &Constructor_46, &WrappedType_47);
                            if (succeeded)
                            {
                              succeeded = hlds__type_util__type_has_user_defined_equality_pred_3_p_0(ModuleInfo_16, WrappedType_47, &Var_48);
                              succeeded = !(succeeded);
                              if (succeeded)
                                succeeded = hlds__type_classify__type_is_atomic_2_p_0(ModuleInfo_16, WrappedType_47);
                            }
                            if (succeeded)
                            {
                              MR_Word WrappedTypeIsDummy_49;

                              WrappedTypeIsDummy_49 = hlds__type_util__is_type_a_dummy_2_f_0(ModuleInfo_16, WrappedType_47);
  ...
  MR_Word * NeedIntCast_8)
{
  ...
  CtorCat_9 = hlds__type_classify__classify_type_2_f_0(ModuleInfo_5, Type_6);
  ...
  MR_Word * STATE_VARIABLE_Info_42)
{
  ...
  else
  {
    ...
    CtorCat_78 = hlds__type_classify__classify_type_2_f_0(ModuleInfo_18, SpecialPredType_10);
        ...
        case (MR_Integer) 2:
          {
            ...
            SpecialProcId_19 = hlds__pred_proc_id__initial_proc_id_0_f_0();
            succeeded = MR_TRUE;
          }
          break;
        case (MR_Integer) 0:
          {
            ...
            hlds__pred_proc_id__in_in_unification_proc_id_1_p_0(&SpecialProcId_19);
            succeeded = MR_TRUE;
          }
          break;
      }
