  ...
  MR_Word * STATE_VARIABLE_Info_51)
{
  ...
  Var_64 = hlds__hlds_pred__pred_info_module_1_f_0(CalledPredInfo_20);
  succeeded = mdbcomp__sym_name____Unify____sym_name_0_0(Var_53, Var_64);
  if (succeeded)
  {
    ...
    succeeded = mdbcomp__prim_data__special_pred_name_arity_4_p_1(&SpecialId_23, PredName_21, &Var_24, &Var_65);
    if (succeeded)
    {
      succeeded = (PredFormArityInt_22 == Var_65);
      if (succeeded)
      {
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                ...
                TypeInfo_62_62 = (MR_Word) (&transform_hlds__higher_order__specialize_unify_compare_scalar_common_1[0]);
                TypeCtorInfo_63_63 = (MR_Word) (&transform_hlds__higher_order__higher_order_global_info__transform_hlds__higher_order__higher_order_global_info__type_ctor_info_known_const_0);
                succeeded = mercury__map__search_3_p_0(TypeInfo_62_62, TypeCtorInfo_63_63, KnownVarMap_18, ((MR_Box) (TypeInfoVar_31)), &conv0_Var_55);
                if (succeeded)
                {
                    ...
                    if (succeeded)
                    {
                      ...
                      if (succeeded)
                      {
                        ...
                        if (succeeded)
                        {
                          ...
                          if (succeeded)
                          {
                            Var_67 = ((MR_Word) ((MR_hl_field(1, SpecialPredArgs_32, (MR_Integer) 0))));
                            Var_66 = ((MR_Word) ((MR_hl_field(1, SpecialPredArgs_32, (MR_Integer) 1))));
                            succeeded = (Var_66 != (MR_Word) ((MR_Unsigned) 0U));
                            if (succeeded)
                            {
                              Var_69 = ((MR_Word) ((MR_hl_field(1, Var_66, (MR_Integer) 0))));
                              Var_68 = ((MR_Word) ((MR_hl_field(1, Var_66, (MR_Integer) 1))));
                              ...
                              else
                              {
                                ...
                                {
                                  Arg1_42 = Var_69;
                                  Arg2_43 = ((MR_Word) ((MR_hl_field(1, Var_68, (MR_Integer) 0))));
                                  Var_60 = ((MR_Word) ((MR_hl_field(1, Var_68, (MR_Integer) 1))));
                                  ...
                                  {
                                    {
                                      ...
                                      MR_hl_field(1, MaybeResult_44, 0) = ((MR_Box) (Var_67));
                                    }
                                    succeeded = MR_TRUE;
                                  }
                                }
                      ...
                      if (succeeded)
                      {
                        ...
                        if (succeeded)
                        {
                          ...
                          {
                            MR_Word ComparisonResult_71 = ((MR_Word) ((MR_hl_field(1, MaybeResult_44, (MR_Integer) 0))));
                            MR_Word Builtin_72;
                            MR_Word TypeCtor_73;
                            MR_Word Eq_74;
                            MR_Word Goal_75;
                            ...
                            Builtin_72 = mdbcomp__builtin_modules__mercury_public_builtin_module_0_f_0();
                            {
                              Var_79 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                              MR_hl_field(1, Var_79, 0) = ((MR_Box) (Builtin_72));
                              MR_hl_field(1, Var_79, 1) = ((MR_Box) ((MR_String) "comparison_result"));
                            }
                            {
                              TypeCtor_73 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
                              MR_hl_field(0, TypeCtor_73, 0) = ((MR_Box) (Var_79));
                              MR_hl_field(0, TypeCtor_73, 1) = ((MR_Box) ((MR_Integer) 0));
                            }
                            ...
                            {
                              Eq_74 = (MR_Word) MR_mkword(3, MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL));
                              MR_hl_field(3, Eq_74, 0) = ((MR_Box) ((MR_Unsigned) 2U));
                              MR_hl_field(3, Eq_74, 1) = ((MR_Box) (Var_82));
                              MR_hl_field(3, Eq_74, 2) = ((MR_Box) ((MR_Integer) 0));
                              MR_hl_field(3, Eq_74, 3) = ((MR_Box) (TypeCtor_73));
                            }
                            Var_86 = mercury__term_context__dummy_context_0_f_0();
                            hlds__make_goal__make_const_construction_4_p_0(Var_86, ComparisonResult_71, Eq_74, &Goal_75);
                            *Goal_14 = ((MR_Word) ((MR_hl_field(0, Goal_75, (MR_Integer) 0))));
                          }
                        ...
                        else
                        {
                          ...
                          if (succeeded)
                          {
                            transform_hlds__higher_order__specialize_unify_compare__specialize_unify_or_compare_pred_for_atomic_9_p_0(Type_26, MaybeResult_44, Arg1_42, Arg2_43, MaybeContext_12, OrigGoalInfo_13, Goal_14, STATE_VARIABLE_Info_0_50, STATE_VARIABLE_Info_51);
                            succeeded = MR_TRUE;
                          }
                          else
                          {
                            ...
                            if (succeeded)
                            {
                              ...
                              transform_hlds__higher_order__specialize_unify_compare__specialize_unify_or_compare_pred_for_no_tag_12_p_0(Type_26, WrappedType_47, WrappedTypeIsDummy_49, Constructor_46, MaybeResult_44, Arg1_42, Arg2_43, MaybeContext_12, OrigGoalInfo_13, Goal_14, STATE_VARIABLE_Info_0_50, STATE_VARIABLE_Info_51);
                              succeeded = MR_TRUE;
                            }
                            else
                              succeeded = transform_hlds__higher_order__specialize_unify_compare__create_goal_to_call_type_specific_unify_or_compare_8_p_0(Type_26, SpecialId_23, TypeInfoArgs_38, SpecialPredArgs_32, MaybeContext_12, Goal_14, STATE_VARIABLE_Info_0_50, STATE_VARIABLE_Info_51);
                          }
                        }
                      }
                      else
