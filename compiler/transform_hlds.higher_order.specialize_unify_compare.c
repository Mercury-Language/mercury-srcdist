                  ...
                  if (succeeded)
                  {
                    ...
                    if (succeeded)
                    {
                      ...
                      if (succeeded)
                      {
                        ...
                        {
                          succeeded = hlds__type_util__type_is_atomic_2_p_0(ModuleInfo_16, Type_25);
                          if (succeeded)
                          {
                          ...
                          else
                          {
                            ...
                            if (succeeded)
                            {
                              ...
                              succeeded = !(succeeded);
                              if (succeeded)
                                succeeded = hlds__type_util__type_is_atomic_2_p_0(ModuleInfo_16, WrappedType_47);
                            }
                            if (succeeded)
                            {
  ...
  MR_Word * NeedIntCast_8)
{
  ...
  CtorCat_9 = hlds__type_util__classify_type_2_f_0(ModuleInfo_5, Type_6);
  ...
  MR_Word * STATE_VARIABLE_Info_42)
{
  ...
  else
  {
    ...
    CtorCat_78 = hlds__type_util__classify_type_2_f_0(ModuleInfo_18, SpecialPredType_10);
