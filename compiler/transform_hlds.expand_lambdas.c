/*
** Automatically generated from `expand_lambdas.m'
...
/*
INIT mercury__transform_hlds__expand_lambdas__init
ENDINIT
*/
...
static const MR_FA_PseudoTypeInfo_Struct1 transform_hlds__expand_lambdas__term__pti_var_1__plain_parse_tree__prog_data__type_ctor_info_prog_var_type_0;

static const MR_FA_TypeInfo_Struct1 transform_hlds__expand_lambdas__term__ti_var_1parse_tree__prog_data__type_ctor_info_tvar_type_0;

static const MR_FA_PseudoTypeInfo_Struct1 transform_hlds__expand_lambdas__set_ordlist__pti_set_ordlist_1__plain_term__ti_var_1parse_tree__prog_data__type_ctor_info_tvar_type_0;

static const MR_EnumFunctorDesc transform_hlds__expand_lambdas__transform_hlds__expand_lambdas__enum_functor_desc_have_we_expanded_lambdas_0_0;

static const MR_EnumFunctorDesc transform_hlds__expand_lambdas__transform_hlds__expand_lambdas__enum_functor_desc_have_we_expanded_lambdas_0_1;

static const MR_EnumFunctorDescPtr transform_hlds__expand_lambdas__transform_hlds__expand_lambdas__enum_ordinal_ordered_have_we_expanded_lambdas_0[2];

static const MR_EnumFunctorDescPtr transform_hlds__expand_lambdas__transform_hlds__expand_lambdas__enum_name_ordered_have_we_expanded_lambdas_0[2];

static const MR_Integer transform_hlds__expand_lambdas__transform_hlds__expand_lambdas__functor_number_map_have_we_expanded_lambdas_0[2];

static const MR_FA_TypeInfo_Struct1 transform_hlds__expand_lambdas__varset__ti_varset_1parse_tree__prog_data__type_ctor_info_tvar_type_0;

static const MR_FA_TypeInfo_Struct1 transform_hlds__expand_lambdas__varset__ti_varset_1parse_tree__prog_data__type_ctor_info_inst_var_type_0;

static const MR_PseudoTypeInfo transform_hlds__expand_lambdas__transform_hlds__expand_lambdas__field_types_lambda_info_0_0[9];

static const MR_ConstString transform_hlds__expand_lambdas__transform_hlds__expand_lambdas__field_names_lambda_info_0_0[9];

static const MR_DuArgLocn transform_hlds__expand_lambdas__transform_hlds__expand_lambdas__field_locns_lambda_info_0_0[9];

static const MR_DuFunctorDesc transform_hlds__expand_lambdas__transform_hlds__expand_lambdas__du_functor_desc_lambda_info_0_0;

static const MR_DuFunctorDescPtr transform_hlds__expand_lambdas__transform_hlds__expand_lambdas__du_stag_ordered_lambda_info_0_0[1];

static const MR_DuPtagLayout transform_hlds__expand_lambdas__transform_hlds__expand_lambdas__du_ptag_ordered_lambda_info_0[1];

static const MR_DuFunctorDescPtr transform_hlds__expand_lambdas__transform_hlds__expand_lambdas__du_name_ordered_lambda_info_0[1];

static const MR_Integer transform_hlds__expand_lambdas__transform_hlds__expand_lambdas__functor_number_map_lambda_info_0[1];

static const MR_EnumFunctorDesc transform_hlds__expand_lambdas__transform_hlds__expand_lambdas__enum_functor_desc_maybe_recompute_nonlocals_0_0;

static const MR_EnumFunctorDesc transform_hlds__expand_lambdas__transform_hlds__expand_lambdas__enum_functor_desc_maybe_recompute_nonlocals_0_1;

static const MR_EnumFunctorDescPtr transform_hlds__expand_lambdas__transform_hlds__expand_lambdas__enum_ordinal_ordered_maybe_recompute_nonlocals_0[2];

static const MR_EnumFunctorDescPtr transform_hlds__expand_lambdas__transform_hlds__expand_lambdas__enum_name_ordered_maybe_recompute_nonlocals_0[2];

static const MR_Integer transform_hlds__expand_lambdas__transform_hlds__expand_lambdas__functor_number_map_maybe_recompute_nonlocals_0[2];

static const MR_FA_TypeInfo_Struct1 transform_hlds__expand_lambdas__term__ti_var_1parse_tree__prog_data__type_ctor_info_prog_var_type_0;

static const MR_FA_TypeInfo_Struct1 transform_hlds__expand_lambdas__sparse_bitset__ti_sparse_bitset_1term__ti_var_1parse_tree__prog_data__type_ctor_info_prog_var_type_0;

static const MR_PseudoTypeInfo transform_hlds__expand_lambdas__transform_hlds__expand_lambdas__field_types_reg_wrapper_proc_0_0[1];

static const MR_DuFunctorDesc transform_hlds__expand_lambdas__transform_hlds__expand_lambdas__du_functor_desc_reg_wrapper_proc_0_0;

static const MR_DuFunctorDesc transform_hlds__expand_lambdas__transform_hlds__expand_lambdas__du_functor_desc_reg_wrapper_proc_0_1;

static const MR_DuFunctorDescPtr transform_hlds__expand_lambdas__transform_hlds__expand_lambdas__du_stag_ordered_reg_wrapper_proc_0_0[1];

static const MR_DuFunctorDescPtr transform_hlds__expand_lambdas__transform_hlds__expand_lambdas__du_stag_ordered_reg_wrapper_proc_0_1[1];

static const MR_DuPtagLayout transform_hlds__expand_lambdas__transform_hlds__expand_lambdas__du_ptag_ordered_reg_wrapper_proc_0[2];

static const MR_DuFunctorDescPtr transform_hlds__expand_lambdas__transform_hlds__expand_lambdas__du_name_ordered_reg_wrapper_proc_0[2];

static const MR_Integer transform_hlds__expand_lambdas__transform_hlds__expand_lambdas__functor_number_map_reg_wrapper_proc_0[2];

static void MR_CALL 
transform_hlds__expand_lambdas____Compare____have_we_expanded_lambdas_0_0(
  MR_Word * HeadVar__1_1,
  MR_Word HeadVar__2_2,
  MR_Word HeadVar__3_3);

static MR_bool MR_CALL 
transform_hlds__expand_lambdas____Unify____have_we_expanded_lambdas_0_0(
  MR_Word HeadVar__1_1,
  MR_Word HeadVar__2_2);

static void MR_CALL 
transform_hlds__expand_lambdas__check_lambda_arg_type_and_mode_5_p_0(
...
static MR_bool MR_CALL 
transform_hlds__expand_lambdas__constraint_contains_only_lambda_tvars_2_p_0(
  MR_Word LambdaTVars_3,
  MR_Word ClassConstraint_4);

static void MR_CALL 
transform_hlds__expand_lambdas__expand_lambdas_in_proc_4_p_0(
  MR_Word PredId_5,
  MR_Integer ProcId_6,
...
static void MR_CALL 
transform_hlds__expand_lambdas__expand_lambdas_in_unify_goal_8_p_0(
  MR_Word LHSVar_9,
  MR_Word RHS0_10,
...
static void MR_CALL 
transform_hlds__expand_lambdas__expand_lambdas_in_cases_4_p_0(
  MR_Word HeadVar__1_1,
  MR_Word * HeadVar__2_2,
...
static void MR_CALL 
transform_hlds__expand_lambdas__expand_lambdas_in_goal_list_4_p_0(
  MR_Word HeadVar__1_1,
  MR_Word * HeadVar__2_2,
  MR_Word STATE_VARIABLE_Info_0_3,
  MR_Word * STATE_VARIABLE_Info_4);
...
static void MR_CALL 
transform_hlds__expand_lambdas__expand_lambdas_in_goal_4_p_0(
  MR_Word Goal0_5,
  MR_Word * Goal_6,
...
static void MR_CALL 
transform_hlds__expand_lambdas__expand_lambdas_in_pred_3_p_0_1(
  MR_Box closure_arg,
...
static void MR_CALL 
transform_hlds__expand_lambdas__expand_lambdas_in_pred_3_p_0(
  MR_Word PredId_4,
  MR_Word STATE_VARIABLE_ModuleInfo_0_8,
  MR_Word * STATE_VARIABLE_ModuleInfo_9);

static void MR_CALL 
transform_hlds__expand_lambdas__create_new_pred_for_lambda_12_p_0_2(
  MR_Box closure_arg,
  MR_Box wrapper_arg_1,
  MR_Box wrapper_arg_2,
  MR_Box wrapper_arg_3,
...
static MR_bool MR_CALL 
transform_hlds__expand_lambdas__create_new_pred_for_lambda_12_p_0_1(
  MR_Box closure_arg,
  MR_Box wrapper_arg_1);

static void MR_CALL 
transform_hlds__expand_lambdas__create_new_pred_for_lambda_12_p_0(
...
static void MR_CALL 
transform_hlds__expand_lambdas__restrict_var_maps_6_p_0(
  MR_Word HeadVars_7,
  MR_Word Goal_8,
...
static void MR_CALL 
transform_hlds__expand_lambdas__filter_var_table_entries_4_p_0(
  MR_Word HeadVar__1_1,
...
transform_hlds__expand_lambdas__find_used_vars_in_goal_3_p_0_2(
  MR_Box closure_arg,
  MR_Box wrapper_arg_1);

static MR_Box MR_CALL 
transform_hlds__expand_lambdas__find_used_vars_in_goal_3_p_0_1(
  MR_Box closure_arg,
  MR_Box wrapper_arg_1);

static void MR_CALL 
transform_hlds__expand_lambdas__find_used_vars_in_goal_3_p_0(
...
static void MR_CALL 
transform_hlds__expand_lambdas__find_used_vars_in_unify_rhs_3_p_0(
  MR_Word tscc_proc_2_input_1_RHS_4,
  MR_ArrayPtr tscc_proc_2_input_2_STATE_VARIABLE_VarUses_0_17,
  MR_ArrayPtr * tscc_output_ptr_1_STATE_VARIABLE_VarUses_114);

static void MR_CALL 
transform_hlds__expand_lambdas__find_used_vars_in_cases_3_p_0(
  MR_Word HeadVar__1_1,
  MR_ArrayPtr STATE_VARIABLE_VarUses_0_2,
  MR_ArrayPtr * STATE_VARIABLE_VarUses_3);

static void MR_CALL 
transform_hlds__expand_lambdas__find_used_vars_in_goals_3_p_0(
  MR_Word HeadVar__1_1,
  MR_ArrayPtr STATE_VARIABLE_VarUses_0_2,
  MR_ArrayPtr * STATE_VARIABLE_VarUses_3);

static void MR_CALL 
transform_hlds__expand_lambdas__mark_vars_as_used_3_p_0(
  MR_Word HeadVar__1_1,
  MR_ArrayPtr STATE_VARIABLE_VarUses_0_2,
  MR_ArrayPtr * STATE_VARIABLE_VarUses_3);

static void MR_CALL 
transform_hlds__expand_lambdas__unify_modes_to_modes_2_p_0(
  MR_Word HeadVar__1_1,
  MR_Word * HeadVar__2_2);

static MR_bool MR_CALL 
transform_hlds__expand_lambdas__can_we_use_existing_pred_11_p_0_1(
  MR_Box closure_arg,
  MR_Box wrapper_arg_1);

static MR_bool MR_CALL 
transform_hlds__expand_lambdas__can_we_use_existing_pred_11_p_0(
...
static void MR_CALL 
transform_hlds__expand_lambdas__expand_lambdas_in_module_2_p_0_1(
  MR_Box closure_arg,
  MR_Box wrapper_arg_1,
  MR_Box wrapper_arg_2,
  MR_Box * wrapper_arg_3);
...
static MR_bool MR_CALL 
transform_hlds__expand_lambdas____Unify____have_we_expanded_lambdas_0_0_10001(
  MR_Box wrapper_arg_1,
  MR_Box wrapper_arg_2);

static void MR_CALL 
transform_hlds__expand_lambdas____Compare____have_we_expanded_lambdas_0_0_10001(
  MR_Box * wrapper_arg_1,
  MR_Box wrapper_arg_2,
  MR_Box wrapper_arg_3);

static MR_bool MR_CALL 
transform_hlds__expand_lambdas____Unify____lambda_info_0_0_10001(
  MR_Box wrapper_arg_1,
  MR_Box wrapper_arg_2);

static void MR_CALL 
transform_hlds__expand_lambdas____Compare____lambda_info_0_0_10001(
  MR_Box * wrapper_arg_1,
  MR_Box wrapper_arg_2,
  MR_Box wrapper_arg_3);

static MR_bool MR_CALL 
transform_hlds__expand_lambdas____Unify____maybe_recompute_nonlocals_0_0_10001(
  MR_Box wrapper_arg_1,
  MR_Box wrapper_arg_2);

static void MR_CALL 
transform_hlds__expand_lambdas____Compare____maybe_recompute_nonlocals_0_0_10001(
  MR_Box * wrapper_arg_1,
  MR_Box wrapper_arg_2,
  MR_Box wrapper_arg_3);

static MR_bool MR_CALL 
transform_hlds__expand_lambdas____Unify____reg_wrapper_proc_0_0_10001(
  MR_Box wrapper_arg_1,
  MR_Box wrapper_arg_2);

static void MR_CALL 
transform_hlds__expand_lambdas____Compare____reg_wrapper_proc_0_0_10001(
  MR_Box * wrapper_arg_1,
  MR_Box wrapper_arg_2,
  MR_Box wrapper_arg_3);


static /* final */ const MR_Box transform_hlds__expand_lambdas_scalar_common_1[5][2];

static /* final */ const MR_Box transform_hlds__expand_lambdas_scalar_common_2[1][1];

static /* final */ const MR_Box transform_hlds__expand_lambdas_scalar_common_3[1][6];

static /* final */ const MR_Box transform_hlds__expand_lambdas_scalar_common_4[3][3];

static /* final */ const MR_Box transform_hlds__expand_lambdas_scalar_common_5[3][5];

static /* final */ const MR_Box transform_hlds__expand_lambdas_scalar_common_6[1][8];

static /* final */ const MR_Box transform_hlds__expand_lambdas_scalar_common_7[1][7];
...
static /* final */ const MR_Box transform_hlds__expand_lambdas_scalar_common_4[3][3] = {
  /* row   0 */
  {
    ((MR_Box) (&transform_hlds__expand_lambdas_scalar_common_3[0])),
    ((MR_Box) (transform_hlds__expand_lambdas__expand_lambdas_in_module_2_p_0_1)),
    ((MR_Box) ((MR_Integer) 0))
  },
  /* row   1 */
  {
    ((MR_Box) (&transform_hlds__expand_lambdas_scalar_common_5[1])),
    ((MR_Box) (transform_hlds__expand_lambdas__find_used_vars_in_goal_3_p_0_1)),
    ((MR_Box) ((MR_Integer) 0))
  },
  /* row   2 */
  {
    ((MR_Box) (&transform_hlds__expand_lambdas_scalar_common_5[1])),
    ((MR_Box) (transform_hlds__expand_lambdas__find_used_vars_in_goal_3_p_0_2)),
    ((MR_Box) ((MR_Integer) 0))
  },
};
...
static /* final */ const MR_Box transform_hlds__expand_lambdas_scalar_common_5[3][5] = {
  ...
  /* row   1 */
  {
    ...
    ((MR_Box) (&transform_hlds__expand_lambdas__term__pti_var_1__plain_parse_tree__prog_data__type_ctor_info_prog_var_type_0))
  },
  /* row   2 */
  {
    NULL,
    ((MR_Box) (NULL)),
    ((MR_Box) ((MR_Integer) 2)),
    ((MR_Box) (&transform_hlds__expand_lambdas__set_ordlist__pti_set_ordlist_1__plain_term__ti_var_1parse_tree__prog_data__type_ctor_info_tvar_type_0)),
...
static const MR_FA_PseudoTypeInfo_Struct1 transform_hlds__expand_lambdas__set_ordlist__pti_set_ordlist_1__plain_term__ti_var_1parse_tree__prog_data__type_ctor_info_tvar_type_0 = {
  ...
  { (MR_PseudoTypeInfo) (&transform_hlds__expand_lambdas__term__ti_var_1parse_tree__prog_data__type_ctor_info_tvar_type_0) }
};
...
static const MR_EnumFunctorDescPtr transform_hlds__expand_lambdas__transform_hlds__expand_lambdas__enum_ordinal_ordered_have_we_expanded_lambdas_0[2] = {
  &transform_hlds__expand_lambdas__transform_hlds__expand_lambdas__enum_functor_desc_have_we_expanded_lambdas_0_0,
  &transform_hlds__expand_lambdas__transform_hlds__expand_lambdas__enum_functor_desc_have_we_expanded_lambdas_0_1
};
...
const MR_TypeCtorInfo_Struct transform_hlds__expand_lambdas__transform_hlds__expand_lambdas__type_ctor_info_have_we_expanded_lambdas_0 = {
  (MR_Integer) 0,
  UINT8_C(18),
  INT8_C(-1),
  MR_TYPECTOR_REP_ENUM,
  ((MR_Box) (transform_hlds__expand_lambdas____Unify____have_we_expanded_lambdas_0_0_10001)),
  ((MR_Box) (transform_hlds__expand_lambdas____Compare____have_we_expanded_lambdas_0_0_10001)),
  (MR_String) "transform_hlds.expand_lambdas",
  (MR_String) "have_we_expanded_lambdas",
  { transform_hlds__expand_lambdas__transform_hlds__expand_lambdas__enum_name_ordered_have_we_expanded_lambdas_0 },
  { transform_hlds__expand_lambdas__transform_hlds__expand_lambdas__enum_ordinal_ordered_have_we_expanded_lambdas_0 },
  (MR_Integer) 2,
  UINT16_C(12),
  transform_hlds__expand_lambdas__transform_hlds__expand_lambdas__functor_number_map_have_we_expanded_lambdas_0,
...
static const MR_PseudoTypeInfo transform_hlds__expand_lambdas__transform_hlds__expand_lambdas__field_types_lambda_info_0_0[9] = {
  ...
  (MR_PseudoTypeInfo) (&transform_hlds__expand_lambdas__varset__ti_varset_1parse_tree__prog_data__type_ctor_info_tvar_type_0),
  (MR_PseudoTypeInfo) (&transform_hlds__expand_lambdas__varset__ti_varset_1parse_tree__prog_data__type_ctor_info_inst_var_type_0),
  ...
  (MR_PseudoTypeInfo) (&transform_hlds__expand_lambdas__transform_hlds__expand_lambdas__type_ctor_info_maybe_recompute_nonlocals_0),
  (MR_PseudoTypeInfo) (&transform_hlds__expand_lambdas__transform_hlds__expand_lambdas__type_ctor_info_have_we_expanded_lambdas_0)
};
...
static const MR_DuFunctorDesc transform_hlds__expand_lambdas__transform_hlds__expand_lambdas__du_functor_desc_lambda_info_0_0 = {
  ...
  (MR_Integer) -1,
  INT32_C(0),
  transform_hlds__expand_lambdas__transform_hlds__expand_lambdas__field_types_lambda_info_0_0,
  transform_hlds__expand_lambdas__transform_hlds__expand_lambdas__field_names_lambda_info_0_0,
  transform_hlds__expand_lambdas__transform_hlds__expand_lambdas__field_locns_lambda_info_0_0,
  NULL,
  MR_FUNCTOR_SUBTYPE_NONE,
  UINT8_C(0)
};

static const MR_DuFunctorDescPtr transform_hlds__expand_lambdas__transform_hlds__expand_lambdas__du_stag_ordered_lambda_info_0_0[1] = { &transform_hlds__expand_lambdas__transform_hlds__expand_lambdas__du_functor_desc_lambda_info_0_0 };

static const MR_DuPtagLayout transform_hlds__expand_lambdas__transform_hlds__expand_lambdas__du_ptag_ordered_lambda_info_0[1] = {
  {
    UINT32_C(1),
    MR_SECTAG_NONE,
    transform_hlds__expand_lambdas__transform_hlds__expand_lambdas__du_stag_ordered_lambda_info_0_0,
    INT8_C(-1),
    UINT8_C(0),
    UINT8_C(1)
  }
...
static const MR_DuFunctorDescPtr transform_hlds__expand_lambdas__transform_hlds__expand_lambdas__du_name_ordered_lambda_info_0[1] = { &transform_hlds__expand_lambdas__transform_hlds__expand_lambdas__du_functor_desc_lambda_info_0_0 };

static const MR_Integer transform_hlds__expand_lambdas__transform_hlds__expand_lambdas__functor_number_map_lambda_info_0[1] = { (MR_Integer) 0 };

const MR_TypeCtorInfo_Struct transform_hlds__expand_lambdas__transform_hlds__expand_lambdas__type_ctor_info_lambda_info_0 = {
  (MR_Integer) 0,
  UINT8_C(18),
  INT8_C(1),
  MR_TYPECTOR_REP_DU,
  ((MR_Box) (transform_hlds__expand_lambdas____Unify____lambda_info_0_0_10001)),
  ((MR_Box) (transform_hlds__expand_lambdas____Compare____lambda_info_0_0_10001)),
  (MR_String) "transform_hlds.expand_lambdas",
  (MR_String) "lambda_info",
  { transform_hlds__expand_lambdas__transform_hlds__expand_lambdas__du_name_ordered_lambda_info_0 },
  { transform_hlds__expand_lambdas__transform_hlds__expand_lambdas__du_ptag_ordered_lambda_info_0 },
  (MR_Integer) 1,
  UINT16_C(12),
  transform_hlds__expand_lambdas__transform_hlds__expand_lambdas__functor_number_map_lambda_info_0,
...
static const MR_EnumFunctorDescPtr transform_hlds__expand_lambdas__transform_hlds__expand_lambdas__enum_ordinal_ordered_maybe_recompute_nonlocals_0[2] = {
  &transform_hlds__expand_lambdas__transform_hlds__expand_lambdas__enum_functor_desc_maybe_recompute_nonlocals_0_0,
  &transform_hlds__expand_lambdas__transform_hlds__expand_lambdas__enum_functor_desc_maybe_recompute_nonlocals_0_1
};
...
const MR_TypeCtorInfo_Struct transform_hlds__expand_lambdas__transform_hlds__expand_lambdas__type_ctor_info_maybe_recompute_nonlocals_0 = {
  (MR_Integer) 0,
  UINT8_C(18),
  INT8_C(-1),
  MR_TYPECTOR_REP_ENUM,
  ((MR_Box) (transform_hlds__expand_lambdas____Unify____maybe_recompute_nonlocals_0_0_10001)),
  ((MR_Box) (transform_hlds__expand_lambdas____Compare____maybe_recompute_nonlocals_0_0_10001)),
  (MR_String) "transform_hlds.expand_lambdas",
  (MR_String) "maybe_recompute_nonlocals",
  { transform_hlds__expand_lambdas__transform_hlds__expand_lambdas__enum_name_ordered_maybe_recompute_nonlocals_0 },
  { transform_hlds__expand_lambdas__transform_hlds__expand_lambdas__enum_ordinal_ordered_maybe_recompute_nonlocals_0 },
  (MR_Integer) 2,
  UINT16_C(12),
  transform_hlds__expand_lambdas__transform_hlds__expand_lambdas__functor_number_map_maybe_recompute_nonlocals_0,
...
static const MR_FA_TypeInfo_Struct1 transform_hlds__expand_lambdas__sparse_bitset__ti_sparse_bitset_1term__ti_var_1parse_tree__prog_data__type_ctor_info_prog_var_type_0 = {
  ...
  { (MR_TypeInfo) (&transform_hlds__expand_lambdas__term__ti_var_1parse_tree__prog_data__type_ctor_info_prog_var_type_0) }
};

static const MR_PseudoTypeInfo transform_hlds__expand_lambdas__transform_hlds__expand_lambdas__field_types_reg_wrapper_proc_0_0[1] = { (MR_PseudoTypeInfo) (&transform_hlds__expand_lambdas__sparse_bitset__ti_sparse_bitset_1term__ti_var_1parse_tree__prog_data__type_ctor_info_prog_var_type_0) };
...
static const MR_DuFunctorDesc transform_hlds__expand_lambdas__transform_hlds__expand_lambdas__du_functor_desc_reg_wrapper_proc_0_0 = {
  ...
  (MR_Integer) -1,
  INT32_C(0),
  transform_hlds__expand_lambdas__transform_hlds__expand_lambdas__field_types_reg_wrapper_proc_0_0,
  NULL,
  NULL,
  NULL,
  MR_FUNCTOR_SUBTYPE_NONE,
...
static const MR_DuFunctorDescPtr transform_hlds__expand_lambdas__transform_hlds__expand_lambdas__du_stag_ordered_reg_wrapper_proc_0_0[1] = { &transform_hlds__expand_lambdas__transform_hlds__expand_lambdas__du_functor_desc_reg_wrapper_proc_0_1 };

static const MR_DuFunctorDescPtr transform_hlds__expand_lambdas__transform_hlds__expand_lambdas__du_stag_ordered_reg_wrapper_proc_0_1[1] = { &transform_hlds__expand_lambdas__transform_hlds__expand_lambdas__du_functor_desc_reg_wrapper_proc_0_0 };

static const MR_DuPtagLayout transform_hlds__expand_lambdas__transform_hlds__expand_lambdas__du_ptag_ordered_reg_wrapper_proc_0[2] = {
  {
    UINT32_C(1),
    MR_SECTAG_LOCAL_REST_OF_WORD,
    transform_hlds__expand_lambdas__transform_hlds__expand_lambdas__du_stag_ordered_reg_wrapper_proc_0_0,
    INT8_C(-1),
    UINT8_C(0),
    UINT8_C(1)
  },
  {
    UINT32_C(1),
    MR_SECTAG_NONE,
    transform_hlds__expand_lambdas__transform_hlds__expand_lambdas__du_stag_ordered_reg_wrapper_proc_0_1,
    INT8_C(-1),
    UINT8_C(1),
    UINT8_C(1)
  }
...
static const MR_DuFunctorDescPtr transform_hlds__expand_lambdas__transform_hlds__expand_lambdas__du_name_ordered_reg_wrapper_proc_0[2] = {
  &transform_hlds__expand_lambdas__transform_hlds__expand_lambdas__du_functor_desc_reg_wrapper_proc_0_1,
  &transform_hlds__expand_lambdas__transform_hlds__expand_lambdas__du_functor_desc_reg_wrapper_proc_0_0
};
...
const MR_TypeCtorInfo_Struct transform_hlds__expand_lambdas__transform_hlds__expand_lambdas__type_ctor_info_reg_wrapper_proc_0 = {
  (MR_Integer) 0,
  UINT8_C(18),
  INT8_C(2),
  MR_TYPECTOR_REP_DU,
  ((MR_Box) (transform_hlds__expand_lambdas____Unify____reg_wrapper_proc_0_0_10001)),
  ((MR_Box) (transform_hlds__expand_lambdas____Compare____reg_wrapper_proc_0_0_10001)),
  (MR_String) "transform_hlds.expand_lambdas",
  (MR_String) "reg_wrapper_proc",
  { transform_hlds__expand_lambdas__transform_hlds__expand_lambdas__du_name_ordered_reg_wrapper_proc_0 },
  { transform_hlds__expand_lambdas__transform_hlds__expand_lambdas__du_ptag_ordered_reg_wrapper_proc_0 },
  (MR_Integer) 2,
  UINT16_C(12),
  transform_hlds__expand_lambdas__transform_hlds__expand_lambdas__functor_number_map_reg_wrapper_proc_0,

};

void MR_CALL 
transform_hlds__expand_lambdas____Compare____reg_wrapper_proc_0_0(
  MR_Word * HeadVar__1_1,
  MR_Word HeadVar__2_2,
  MR_Word HeadVar__3_3)
{
  ...
  else
  {
    ...
    mercury__builtin__compare_3_p_0((MR_Word) (&transform_hlds__expand_lambdas_scalar_common_1[4]), HeadVar__1_1, ((MR_Box) (ArgX1_4)), ((MR_Box) (ArgY1_5)));
  }
}

MR_bool MR_CALL 
transform_hlds__expand_lambdas____Unify____reg_wrapper_proc_0_0(
  MR_Word HeadVar__1_1,
  MR_Word HeadVar__2_2)
{
  MR_bool succeeded;
  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      TypeInfo_9_9 = (MR_Word) (&transform_hlds__expand_lambdas_scalar_common_1[4]);
...
void MR_CALL 
transform_hlds__expand_lambdas____Compare____maybe_recompute_nonlocals_0_0(
  MR_Word * HeadVar__1_1,
  MR_Word HeadVar__2_2,
  MR_Word HeadVar__3_3)
{
...
MR_bool MR_CALL 
transform_hlds__expand_lambdas____Unify____maybe_recompute_nonlocals_0_0(
  MR_Word HeadVar__1_1,
  MR_Word HeadVar__2_2)
{
...
void MR_CALL 
transform_hlds__expand_lambdas____Compare____lambda_info_0_0(
  MR_Word * HeadVar__1_1,
  MR_Word HeadVar__2_2,
  MR_Word HeadVar__3_3)
{
  ...
  else
  {
    ...
    else
    {
      ...
      else
      {
        ...
        mercury__builtin__compare_3_p_0((MR_Word) (&transform_hlds__expand_lambdas_scalar_common_1[2]), &SubResult3_12, ((MR_Box) (ArgX3_10)), ((MR_Box) (ArgY3_11)));
        ...
        else
        {
          ...
          mercury__builtin__compare_3_p_0((MR_Word) (&transform_hlds__expand_lambdas_scalar_common_1[3]), &SubResult4_15, ((MR_Box) (ArgX4_13)), ((MR_Box) (ArgY4_14)));
...
MR_bool MR_CALL 
transform_hlds__expand_lambdas____Unify____lambda_info_0_0(
  MR_Word HeadVar__1_1,
  MR_Word HeadVar__2_2)
{
  MR_bool succeeded;
  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        TypeInfo_25_25 = (MR_Word) (&transform_hlds__expand_lambdas_scalar_common_1[2]);
        succeeded = mercury__builtin__unify_2_p_0(TypeInfo_25_25, ((MR_Box) (ArgX3_7)), ((MR_Box) (ArgY3_8)));
        if (succeeded)
        {
          TypeInfo_26_26 = (MR_Word) (&transform_hlds__expand_lambdas_scalar_common_1[3]);
  ...
  MR_Integer * X_5)
{
  ...
  *X_5 = X_9;
  ...
  if (succeeded)
  {
    ...
    if (!(succeeded))
      {
        mercury__require__unexpected_2_p_0((MR_String) "predicate \140transform_hlds.expand_lambdas.check_lambda_arg_type_and_mode\'/5", (MR_String) "non-higher order argument with higher order inst");
        return;
      }
  }
}
  ...
  MR_Word ClassConstraint_4)
{
  ...
  succeeded = mercury__set__subset_2_p_0((MR_Word) (&transform_hlds__expand_lambdas_scalar_common_1[1]), ConstraintTVars_7, LambdaTVars_3);
  return succeeded;
}
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_17)
{
  ...
  transform_hlds__expand_lambdas__expand_lambdas_in_goal_4_p_0(Goal0_24, &Goal1_29, Info0_28, &Info1_30);
    ...
    case (MR_Integer) 1:
      {
        ...
        hlds__quantification__implicitly_quantify_clause_body_general_9_p_1((MR_Integer) 1, HeadVars_22, &_Warnings_39, Goal1_29, &Goal2_40, VarTable1_34, &VarTable2_41, RttiVarMaps1_35, &RttiVarMaps2_42);
    ...
    case (MR_Integer) 1:
      {
        ...
        transform_hlds__expand_lambdas__mark_vars_as_used_3_p_0(HeadVars_22, VarUses0_55, &VarUses1_56);
        transform_hlds__expand_lambdas__find_used_vars_in_goal_3_p_0(Goal_44, VarUses1_56, &VarUses_57);
        parse_tree__var_table__var_table_to_sorted_assoc_list_2_p_0(VarTable2_41, &VarTableEntries0_58);
        transform_hlds__expand_lambdas__filter_var_table_entries_4_p_0(VarTableEntries0_58, VarUses_57, (MR_Word) ((MR_Unsigned) 0U), &RevVarTableEntries_59);
    ...
    case (MR_Integer) 2:
      {
        ...
        transform_hlds__expand_lambdas__expand_lambdas_in_goal_4_p_0(LambdaGoal0_22, &LambdaGoal_23, STATE_VARIABLE_Info_0_49, &STATE_VARIABLE_Info_1_51);
        {
        ...
        switch (MR_tag((MR_Word) Unification0_12)) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 0:
            transform_hlds__expand_lambdas__expand_lambda_9_p_0((MR_Word) ((MR_Unsigned) 0U), LHSVar_9, RHS_24, UnifyMode_11, Unification0_12, UnifyContext_13, GoalExpr_14, STATE_VARIABLE_Info_1_51, STATE_VARIABLE_Info_50);
            break;
          case (MR_Integer) 1:
          case (MR_Integer) 2:
          case (MR_Integer) 3:
            {
              mercury__require__unexpected_2_p_0((MR_String) "predicate \140transform_hlds.expand_lambdas.expand_lambdas_in_unify_goal\'/8", (MR_String) "unexpected unification");
              return;
            }
            break;
        }
  ...
  MR_Word * STATE_VARIABLE_Info_4)
{
  ...
  else
  {
    ...
    transform_hlds__expand_lambdas__expand_lambdas_in_goal_4_p_0(Goal0_15, &Goal_16, STATE_VARIABLE_Info_0_3, &STATE_VARIABLE_Info_1_19);
    {
    ...
    transform_hlds__expand_lambdas__expand_lambdas_in_cases_4_p_0(Cases0_9, &Cases_11, STATE_VARIABLE_Info_1_19, STATE_VARIABLE_Info_4);
    {
      MR_Word base;
  ...
  MR_Word * STATE_VARIABLE_Info_4)
{
  ...
  else
  {
    ...
    transform_hlds__expand_lambdas__expand_lambdas_in_goal_4_p_0(Goal0_8, &Goal_10, STATE_VARIABLE_Info_0_3, &STATE_VARIABLE_Info_1_15);
    transform_hlds__expand_lambdas__expand_lambdas_in_goal_list_4_p_0(Goals0_9, &Goals_11, STATE_VARIABLE_Info_1_15, STATE_VARIABLE_Info_4);
    {
      MR_Word base;
      base = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      *HeadVar__2_2 = base;
    ...
    case (MR_Integer) 0:
      {
        ...
        transform_hlds__expand_lambdas__expand_lambdas_in_goal_4_p_0(SubGoal0_23, &SubGoal_24, STATE_VARIABLE_Info_0_68, STATE_VARIABLE_Info_69);
    ...
    case (MR_Integer) 1:
      {
        ...
        transform_hlds__expand_lambdas__expand_lambdas_in_unify_goal_8_p_0(LHS_10, RHS_11, Mode_12, Unification_13, Context_14, &GoalExpr_15, STATE_VARIABLE_Info_0_68, STATE_VARIABLE_Info_69);
      }
      break;
    case (MR_Integer) 2:
      {
        ...
        case (MR_Integer) 2:
          {
            ...
            transform_hlds__expand_lambdas__expand_lambdas_in_goal_list_4_p_0(Goals0_17, &Goals_18, STATE_VARIABLE_Info_0_68, STATE_VARIABLE_Info_69);
            {
        ...
        case (MR_Integer) 3:
          {
            ...
            transform_hlds__expand_lambdas__expand_lambdas_in_goal_list_4_p_0(Goals0_84, &Goals_85, STATE_VARIABLE_Info_0_68, STATE_VARIABLE_Info_69);
            {
        ...
        case (MR_Integer) 4:
          {
            ...
            transform_hlds__expand_lambdas__expand_lambdas_in_cases_4_p_0(Cases0_21, &Cases_22, STATE_VARIABLE_Info_0_68, STATE_VARIABLE_Info_69);
            {
        ...
        case (MR_Integer) 5:
          {
            ...
            else
            {
              ...
              transform_hlds__expand_lambdas__expand_lambdas_in_goal_4_p_0(SubGoal0_88, &SubGoal_86, STATE_VARIABLE_Info_0_68, STATE_VARIABLE_Info_69);
              {
                GoalExpr_15 = (MR_Word) MR_mkword(3, MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
        ...
        case (MR_Integer) 6:
          {
            ...
            transform_hlds__expand_lambdas__expand_lambdas_in_goal_4_p_0(Cond0_29, &Cond_32, STATE_VARIABLE_Info_0_68, &STATE_VARIABLE_Info_7_76);
            transform_hlds__expand_lambdas__expand_lambdas_in_goal_4_p_0(Then0_30, &Then_33, STATE_VARIABLE_Info_7_76, &STATE_VARIABLE_Info_8_77);
            transform_hlds__expand_lambdas__expand_lambdas_in_goal_4_p_0(Else0_31, &Else_34, STATE_VARIABLE_Info_8_77, STATE_VARIABLE_Info_69);
            {
        ...
        case (MR_Integer) 7:
          {
            ...
            switch (MR_tag((MR_Word) ShortHand0_53)) {
              ...
              case (MR_Integer) 0:
                {
                  mercury__require__unexpected_2_p_0((MR_String) "predicate \140transform_hlds.expand_lambdas.expand_lambdas_in_goal\'/4", (MR_String) "bi_implication");
                  return;
                }
                break;
              case (MR_Integer) 1:
                {
                  ...
                  transform_hlds__expand_lambdas__expand_lambdas_in_goal_4_p_0(MainGoal0_58, &MainGoal_61, STATE_VARIABLE_Info_0_68, &STATE_VARIABLE_Info_10_79);
                  transform_hlds__expand_lambdas__expand_lambdas_in_goal_list_4_p_0(OrElseGoals0_59, &OrElseGoals_62, STATE_VARIABLE_Info_10_79, STATE_VARIABLE_Info_69);
                  {
              ...
              case (MR_Integer) 2:
                {
                  ...
                  transform_hlds__expand_lambdas__expand_lambdas_in_goal_4_p_0(SubGoal0_90, &SubGoal_91, STATE_VARIABLE_Info_0_68, STATE_VARIABLE_Info_69);
                  {
  ...
  MR_Box * wrapper_arg_3)
{
  ...
  transform_hlds__expand_lambdas__expand_lambdas_in_proc_4_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Integer) (wrapper_arg_1)), ((MR_Word) (wrapper_arg_2)), &conv0_STATE_VARIABLE_ModuleInfo_17);
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_9)
{
  ...
  ProcIds_7 = hlds__hlds_pred__pred_info_all_proc_ids_1_f_0(PredInfo_6);
  {
    ...
    MR_hl_field(0, Var_10, 0) = ((MR_Box) (&transform_hlds__expand_lambdas_scalar_common_7[0]));
    MR_hl_field(0, Var_10, 1) = ((MR_Box) (transform_hlds__expand_lambdas__expand_lambdas_in_pred_3_p_0_1));
...
void MR_CALL 
transform_hlds__expand_lambdas__lambda_info_set_recompute_nonlocals_3_p_0(
  MR_Word X_4,
...
void MR_CALL 
transform_hlds__expand_lambdas__lambda_info_set_var_table_3_p_0(
  MR_Word X_4,
  MR_Word STATE_VARIABLE_Info_0_6,
  MR_Word * STATE_VARIABLE_Info_7)
{
...
void MR_CALL 
transform_hlds__expand_lambdas__lambda_info_set_module_info_3_p_0(
  MR_Word X_4,
  MR_Word STATE_VARIABLE_Info_0_6,
  MR_Word * STATE_VARIABLE_Info_7)
{
...
void MR_CALL 
transform_hlds__expand_lambdas__lambda_info_get_recompute_nonlocals_2_p_0(
  MR_Word Info_3,
  MR_Word * X_4)
{
...
void MR_CALL 
transform_hlds__expand_lambdas__lambda_info_get_rtti_varmaps_2_p_0(
  MR_Word Info_3,
  MR_Word * X_4)
{
...
void MR_CALL 
transform_hlds__expand_lambdas__lambda_info_get_var_table_2_p_0(
  MR_Word Info_3,
  MR_Word * X_4)
{
...
void MR_CALL 
transform_hlds__expand_lambdas__lambda_info_get_inst_varset_2_p_0(
  MR_Word Info_3,
  MR_Word * X_4)
{
...
void MR_CALL 
transform_hlds__expand_lambdas__lambda_info_get_tvarset_2_p_0(
  MR_Word Info_3,
  MR_Word * X_4)
{
...
void MR_CALL 
transform_hlds__expand_lambdas__lambda_info_get_pred_info_2_p_0(
  MR_Word Info_3,
  MR_Word * X_4)
{
...
void MR_CALL 
transform_hlds__expand_lambdas__lambda_info_get_module_info_2_p_0(
  MR_Word Info_3,
  MR_Word * X_4)
{
...
void MR_CALL 
transform_hlds__expand_lambdas__init_lambda_info_8_p_0(
...
void MR_CALL 
transform_hlds__expand_lambdas__expand_lambda_9_p_0(
  ...
  MR_Word * LambdaInfo_18)
{
  ...
  mercury__assoc_list__keys_2_p_0((MR_Word) (&transform_hlds__expand_lambdas_scalar_common_1[0]), (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_mode_0), VarsModes_32, &Vars_35);
  ...
  succeeded = transform_hlds__expand_lambdas__can_we_use_existing_pred_11_p_0(ModuleInfo0_19, PredOrFunc_30, Vars_35, Detism_33, LambdaGoal_34, &PredId0_45, &ProcId0_46, &CalleePredInfo_47, &CalleeProcInfo0_48, &CurriedArgVars_49, &ArgUnifyModes1_50);
  if (succeeded)
  {
    ...
    transform_hlds__expand_lambdas__create_new_pred_for_lambda_12_p_0(RegWrapperProc_10, RHS0_12, ArgVars0_38, &ArgVars_53, &PredId_51, &ProcId_52, ArgUnifyModes0_39, &ArgUnifyModes_54, MustRecomputeNonLocals0_26, &MustRecomputeNonLocals_57, LambdaInfo0_17, &ModuleInfo_56);
  {
  ...
  MR_Box * wrapper_arg_4)
{
  ...
  transform_hlds__expand_lambdas__check_lambda_arg_type_and_mode_5_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) (wrapper_arg_1)), ((MR_Word) (wrapper_arg_2)), ((MR_Integer) (wrapper_arg_3)), &conv0_X_5);
  ...
  MR_Box wrapper_arg_1)
{
  ...
  succeeded = transform_hlds__expand_lambdas__constraint_contains_only_lambda_tvars_2_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) (wrapper_arg_1)));
  return succeeded;
}
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_94)
{
  ...
  mercury__assoc_list__keys_and_values_3_p_0((MR_Word) (&transform_hlds__expand_lambdas_scalar_common_1[0]), (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_mode_0), LambdaVarsModes_36, &LambdaVars_39, &LambdaVarModes_40);
  ...
  parse_tree__prog_type_scan__set_of_type_vars_in_types_2_p_0(LambdaVarTypeList_44, &LambdaTypeVars_45);
  {
    ...
    MR_hl_field(0, Var_96, 0) = ((MR_Box) (&transform_hlds__expand_lambdas_scalar_common_5[2]));
    MR_hl_field(0, Var_96, 1) = ((MR_Box) (transform_hlds__expand_lambdas__create_new_pred_for_lambda_12_p_0_1));
  ...
  *ArgVars_16 = hlds__type_util__put_typeinfo_vars_first_2_f_0(VarTable_27, ArgVars1_55);
  AllArgVars_56 = mercury__list__f_43_43_2_f_0((MR_Word) (&transform_hlds__expand_lambdas_scalar_common_1[0]), *ArgVars_16, LambdaVars_39);
  ...
  transform_hlds__expand_lambdas__unify_modes_to_modes_2_p_0(ArgUnifyModes0_19, &OrigArgModes_66);
  mercury__list__length_2_p_0((MR_Word) (&transform_hlds__expand_lambdas_scalar_common_1[0]), *ArgVars_16, &NumArgVars_67);
  ...
  mercury__map__from_corresponding_lists_3_p_0((MR_Word) (&transform_hlds__expand_lambdas_scalar_common_1[0]), (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_mode_0), *ArgVars_16, InModes_69, &ArgModesMap_70);
  mercury__map__from_corresponding_lists_3_p_0((MR_Word) (&transform_hlds__expand_lambdas_scalar_common_1[0]), (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_mode_0), OrigVars_15, OrigArgModes_66, &OrigArgModesMap_71);
  mercury__map__overlay_3_p_0((MR_Word) (&transform_hlds__expand_lambdas_scalar_common_1[0]), (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_mode_0), ArgModesMap_70, OrigArgModesMap_71, &ArgModesMap1_72);
  mercury__map__apply_to_list_3_p_0((MR_Word) (&transform_hlds__expand_lambdas_scalar_common_1[0]), (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_mode_0), *ArgVars_16, ArgModesMap1_72, &ArgModes1_73);
  ...
  parse_tree__var_table__lookup_var_types_3_p_0(VarTable_27, AllArgVars_56, &ArgTypes_75);
  {
    ...
    MR_hl_field(0, Var_102, 0) = ((MR_Box) (&transform_hlds__expand_lambdas_scalar_common_6[0]));
    MR_hl_field(0, Var_102, 1) = ((MR_Box) (transform_hlds__expand_lambdas__create_new_pred_for_lambda_12_p_0_2));
  ...
  mercury__map__init_1_p_0((MR_Word) (&transform_hlds__expand_lambdas_scalar_common_1[0]), (MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), &VarNameRemap_80);
  transform_hlds__expand_lambdas__restrict_var_maps_6_p_0(AllArgVars_56, LambdaGoal_38, VarTable_27, &LambdaVarTable_81, RttiVarMaps_28, &LambdaRttiVarMaps_82);
  ...
  MR_Word * STATE_VARIABLE_RttiVarMaps_20)
{
  ...
  transform_hlds__expand_lambdas__mark_vars_as_used_3_p_0(HeadVars_7, VarUses0_12, &VarUses1_13);
  transform_hlds__expand_lambdas__find_used_vars_in_goal_3_p_0(Goal_8, VarUses1_13, &VarUses_14);
  parse_tree__var_table__var_table_to_sorted_assoc_list_2_p_0(STATE_VARIABLE_VarTable_0_17, &VarTableEntries0_15);
  transform_hlds__expand_lambdas__filter_var_table_entries_4_p_0(VarTableEntries0_15, VarUses_14, (MR_Word) ((MR_Unsigned) 0U), &RevVarTableEntries_16);
  ...
  MR_ArrayPtr * tscc_output_ptr_1_STATE_VARIABLE_VarUses_114)
{
  ...
  // The code for TSCC PROC 1: pred transform_hlds.expand_lambdas.find_used_vars_in_goal/3-0.
  ;
  ...
  ;
  ;
  // proc 1 in TSCC: pred transform_hlds.expand_lambdas.find_used_vars_in_goal/3-0
  ;
  // proc 2 in TSCC: pred transform_hlds.expand_lambdas.find_used_vars_in_unify_rhs/3-0
  ;
  ;
  goto top_of_proc_1;
top_of_proc_1:;
      ...
      case (MR_Integer) 2:
        {
          ...
          transform_hlds__expand_lambdas__mark_vars_as_used_3_p_0(ArgVars_161, STATE_VARIABLE_VarUses_0_113, &STATE_VARIABLE_VarUses_7_122);
          ...
          case (MR_Integer) 0:
            {
              ...
              transform_hlds__expand_lambdas__mark_vars_as_used_3_p_0(ArgVars_37, STATE_VARIABLE_VarUses_4_119, &STATE_VARIABLE_VarUses_114);
            }
            break;
          case (MR_Integer) 1:
            {
              ...
              ArgVars_170 = mercury__list__map_2_f_0((MR_Word) (&hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_foreign_arg_0), (MR_Word) (&transform_hlds__expand_lambdas_scalar_common_1[0]), (MR_Word) (&transform_hlds__expand_lambdas_scalar_common_4[1]), Args_91);
              ExtraVars_95 = mercury__list__map_2_f_0((MR_Word) (&hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_foreign_arg_0), (MR_Word) (&transform_hlds__expand_lambdas_scalar_common_1[0]), (MR_Word) (&transform_hlds__expand_lambdas_scalar_common_4[2]), ExtraArgs_92);
              transform_hlds__expand_lambdas__mark_vars_as_used_3_p_0(ArgVars_170, STATE_VARIABLE_VarUses_0_113, &STATE_VARIABLE_VarUses_24_143);
              transform_hlds__expand_lambdas__mark_vars_as_used_3_p_0(ExtraVars_95, STATE_VARIABLE_VarUses_24_143, &STATE_VARIABLE_VarUses_114);
            }
            break;
          case (MR_Integer) 2:
            {
              ...
              transform_hlds__expand_lambdas__find_used_vars_in_goals_3_p_0(Goals_59, STATE_VARIABLE_VarUses_0_113, &STATE_VARIABLE_VarUses_114);
            }
            break;
          case (MR_Integer) 3:
            {
              ...
              transform_hlds__expand_lambdas__find_used_vars_in_goals_3_p_0(Goals_178, STATE_VARIABLE_VarUses_0_113, &STATE_VARIABLE_VarUses_114);
            }
            break;
          case (MR_Integer) 4:
            {
              ...
              transform_hlds__expand_lambdas__find_used_vars_in_cases_3_p_0(Cases_61, STATE_VARIABLE_VarUses_11_126, &STATE_VARIABLE_VarUses_114);
            }
            break;
          case (MR_Integer) 5:
            {
                ...
                case (MR_Integer) 0:
                  {
                    ...
                    transform_hlds__expand_lambdas__mark_vars_as_used_3_p_0(Vars_64, STATE_VARIABLE_VarUses_0_113, &STATE_VARIABLE_VarUses_13_128);
                  }
                  break;
                case (MR_Integer) 1:
                ...
                case (MR_Integer) 2:
                  {
                    ...
                    transform_hlds__expand_lambdas__mark_vars_as_used_3_p_0(Vars_164, STATE_VARIABLE_VarUses_0_113, &STATE_VARIABLE_VarUses_13_128);
                  }
                  break;
                case (MR_Integer) 3:
                  switch (((MR_Integer) ((MR_hl_field(3, Reason_62, 0))))) {
                    ...
                    case (MR_Integer) 3:
                      {
                        mercury__require__unexpected_2_p_0((MR_String) "predicate \140transform_hlds.expand_lambdas.find_used_vars_in_goal\'/3", (MR_String) "unexpected scope");
                        return;
                      }
                      break;
                    case (MR_Integer) 4:
          ...
          case (MR_Integer) 6:
            {
              ...
              transform_hlds__expand_lambdas__mark_vars_as_used_3_p_0(Vars_169, STATE_VARIABLE_VarUses_0_113, &STATE_VARIABLE_VarUses_20_137);
              transform_hlds__expand_lambdas__find_used_vars_in_goal_3_p_0(Cond_85, STATE_VARIABLE_VarUses_20_137, &STATE_VARIABLE_VarUses_21_138);
              transform_hlds__expand_lambdas__find_used_vars_in_goal_3_p_0(Then_86, STATE_VARIABLE_VarUses_21_138, &STATE_VARIABLE_VarUses_22_139);
              // direct tailcall eliminated
              ;
                ...
                case (MR_Integer) 0:
                  {
                    ...
                    transform_hlds__expand_lambdas__find_used_vars_in_goal_3_p_0(LeftGoal_111, STATE_VARIABLE_VarUses_0_113, &STATE_VARIABLE_VarUses_34_153);
                    // direct tailcall eliminated
                    ;
                ...
                case (MR_Integer) 1:
                  {
                    ...
                    else
                    {
                      ...
                      transform_hlds__expand_lambdas__mark_vars_as_used_3_p_0(OutputVars_108, STATE_VARIABLE_VarUses_29_148, &STATE_VARIABLE_VarUses_30_149);
                    }
                    transform_hlds__expand_lambdas__find_used_vars_in_goal_3_p_0(MainGoal_101, STATE_VARIABLE_VarUses_30_149, &STATE_VARIABLE_VarUses_31_150);
                    transform_hlds__expand_lambdas__find_used_vars_in_goals_3_p_0(OrElseGoals_102, STATE_VARIABLE_VarUses_31_150, &STATE_VARIABLE_VarUses_114);
                  }
                  break;
                case (MR_Integer) 2:
                  {
      ...
      case (MR_Integer) 1:
        {
          ...
          transform_hlds__expand_lambdas__mark_vars_as_used_3_p_0(ArgVars_9, STATE_VARIABLE_VarUses_0_17, &STATE_VARIABLE_VarUses_18);
        }
        break;
      case (MR_Integer) 2:
        {
          ...
          mercury__assoc_list__keys_2_p_0((MR_Word) (&transform_hlds__expand_lambdas_scalar_common_1[0]), (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_mode_0), ArgVarsModes_14, &ArgVars_24);
          transform_hlds__expand_lambdas__mark_vars_as_used_3_p_0(NonLocals_13, STATE_VARIABLE_VarUses_0_17, &STATE_VARIABLE_VarUses_3_21);
          transform_hlds__expand_lambdas__mark_vars_as_used_3_p_0(ArgVars_24, STATE_VARIABLE_VarUses_3_21, &STATE_VARIABLE_VarUses_4_22);
          // direct tailcall eliminated
          ;
  ...
  MR_ArrayPtr * tscc_output_ptr_1_STATE_VARIABLE_VarUses_114)
{
  ...
  // The code for TSCC PROC 2: pred transform_hlds.expand_lambdas.find_used_vars_in_unify_rhs/3-0.
  ;
  // Setup for mutual tailcalls optimized into a loop.
  ;
  // The mutually recursive procedures are:
  ...
  MR_ArrayPtr * STATE_VARIABLE_VarUses_3)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      transform_hlds__expand_lambdas__find_used_vars_in_goal_3_p_0(Goal_12, STATE_VARIABLE_VarUses_0_2, &STATE_VARIABLE_VarUses_1_15);
      // direct tailcall eliminated
      ;
  ...
  MR_ArrayPtr * STATE_VARIABLE_VarUses_3)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      transform_hlds__expand_lambdas__find_used_vars_in_goal_3_p_0(Goal_7, STATE_VARIABLE_VarUses_0_2, &STATE_VARIABLE_VarUses_1_12);
      // direct tailcall eliminated
      ;
  ...
  MR_Word * HeadVar__2_2)
{
  ...
  else
  {
    ...
    transform_hlds__expand_lambdas__unify_modes_to_modes_2_p_0(UnifyModes_4, &Modes_6);
    {
      MR_Word base;
      base = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      *HeadVar__2_2 = base;
  ...
  MR_Word * CurriedArgUnifyModes_22)
{
  ...
  if (succeeded)
  {
    ...
    *ProcId_18 = ((MR_Integer) ((MR_hl_field(2, LambdaGoalExpr_23, 1))));
    ...
    TypeInfo_43_43 = (MR_Word) (&transform_hlds__expand_lambdas_scalar_common_1[0]);
        ...
        {
          {
            ...
            MR_hl_field(0, Var_40, 0) = ((MR_Box) (&transform_hlds__expand_lambdas_scalar_common_5[0]));
            MR_hl_field(0, Var_40, 1) = ((MR_Box) (transform_hlds__expand_lambdas__can_we_use_existing_pred_11_p_0_1));
  ...
  MR_Box * wrapper_arg_3)
{
  ...
  transform_hlds__expand_lambdas__expand_lambdas_in_pred_3_p_0(((MR_Word) (wrapper_arg_1)), ((MR_Word) (wrapper_arg_2)), &conv0_STATE_VARIABLE_ModuleInfo_9);
  *wrapper_arg_3 = ((MR_Box) (conv0_STATE_VARIABLE_ModuleInfo_9));
}

void MR_CALL 
transform_hlds__expand_lambdas__expand_lambdas_in_module_2_p_0(
  ...
  MR_Box wrapper_arg_2)
{
  ...
  succeeded = transform_hlds__expand_lambdas____Unify____have_we_expanded_lambdas_0_0(((MR_Word) (wrapper_arg_1)), ((MR_Word) (wrapper_arg_2)));
  return succeeded;
}
  ...
  MR_Box wrapper_arg_3)
{
  ...
  transform_hlds__expand_lambdas____Compare____have_we_expanded_lambdas_0_0(&conv0_HeadVar__1_1, ((MR_Word) (wrapper_arg_2)), ((MR_Word) (wrapper_arg_3)));
  ...
  MR_Box wrapper_arg_2)
{
  ...
  succeeded = transform_hlds__expand_lambdas____Unify____lambda_info_0_0(((MR_Word) (wrapper_arg_1)), ((MR_Word) (wrapper_arg_2)));
  return succeeded;
}
  ...
  MR_Box wrapper_arg_3)
{
  ...
  transform_hlds__expand_lambdas____Compare____lambda_info_0_0(&conv0_HeadVar__1_1, ((MR_Word) (wrapper_arg_2)), ((MR_Word) (wrapper_arg_3)));
  *wrapper_arg_1 = ((MR_Box) (conv0_HeadVar__1_1));
}
  ...
  MR_Box wrapper_arg_2)
{
  ...
  succeeded = transform_hlds__expand_lambdas____Unify____maybe_recompute_nonlocals_0_0(((MR_Word) (wrapper_arg_1)), ((MR_Word) (wrapper_arg_2)));
  return succeeded;
}
  ...
  MR_Box wrapper_arg_3)
{
  ...
  transform_hlds__expand_lambdas____Compare____maybe_recompute_nonlocals_0_0(&conv0_HeadVar__1_1, ((MR_Word) (wrapper_arg_2)), ((MR_Word) (wrapper_arg_3)));
  *wrapper_arg_1 = ((MR_Box) (conv0_HeadVar__1_1));
}
  ...
  MR_Box wrapper_arg_2)
{
  ...
  succeeded = transform_hlds__expand_lambdas____Unify____reg_wrapper_proc_0_0(((MR_Word) (wrapper_arg_1)), ((MR_Word) (wrapper_arg_2)));
  return succeeded;
}
  ...
  MR_Box wrapper_arg_3)
{
  ...
  transform_hlds__expand_lambdas____Compare____reg_wrapper_proc_0_0(&conv0_HeadVar__1_1, ((MR_Word) (wrapper_arg_2)), ((MR_Word) (wrapper_arg_3)));
  *wrapper_arg_1 = ((MR_Box) (conv0_HeadVar__1_1));
}

void mercury__transform_hlds__expand_lambdas__init(void)
{
}

void mercury__transform_hlds__expand_lambdas__init_type_tables(void)
{
  static MR_bool initialised = MR_FALSE;
  if (initialised) return;
  initialised = MR_TRUE;

  MR_register_type_ctor_info(&transform_hlds__expand_lambdas__transform_hlds__expand_lambdas__type_ctor_info_have_we_expanded_lambdas_0);
  MR_register_type_ctor_info(&transform_hlds__expand_lambdas__transform_hlds__expand_lambdas__type_ctor_info_lambda_info_0);
  MR_register_type_ctor_info(&transform_hlds__expand_lambdas__transform_hlds__expand_lambdas__type_ctor_info_maybe_recompute_nonlocals_0);
  MR_register_type_ctor_info(&transform_hlds__expand_lambdas__transform_hlds__expand_lambdas__type_ctor_info_reg_wrapper_proc_0);
}

void mercury__transform_hlds__expand_lambdas__init_debugger(void)
{
  MR_fatal_error("debugger initialization in MLDS grade");
}

// Ensure everything is compiled with the same grade.
const char *mercury__transform_hlds__expand_lambdas__grade_check(void)
{
  return &MR_GRADE_VAR;
}
