...
{
  {
    ...
    if (succeeded)
    {
      ...
      packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), Var_22, (MR_Integer) 3)));
      ...
      if (succeeded)
      {
        ...
        else
        {
          ...
          if (succeeded)
          {
            ...
            packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), Var_55, (MR_Integer) 3)));
            {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        else
        {
          ...
          if (succeeded)
          {
            succeeded = ((MR_tag((MR_Word) MaybeCoveringPredProcId_44)) == (MR_Integer) 1);
            if (succeeded)
  ...
  MR_Word * PredProcId_8)
{
  while (MR_TRUE)
  {
    ...
    if (succeeded)
    {
      ...
      succeeded = ((MR_tag((MR_Word) Calls_10)) == (MR_Integer) 1);
      if (succeeded)
      {
