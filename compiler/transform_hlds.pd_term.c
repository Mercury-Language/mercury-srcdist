...
#line 708 "transform_hlds.pd_term.c"
static const MR_DuFunctorDesc transform_hlds__pd_term__transform_hlds__pd_term__du_functor_desc_global_term_info_0_0 = {
...
#line 723 "transform_hlds.pd_term.c"
static const MR_DuFunctorDescPtr transform_hlds__pd_term__transform_hlds__pd_term__du_stag_ordered_global_term_info_0_0[1] = {
...
#line 737 "transform_hlds.pd_term.c"
static const MR_DuFunctorDescPtr transform_hlds__pd_term__transform_hlds__pd_term__du_name_ordered_global_term_info_0[1] = {
  &transform_hlds__pd_term__transform_hlds__pd_term__du_functor_desc_global_term_info_0_0
};

#line 742 "transform_hlds.pd_term.c"
static const MR_Integer transform_hlds__pd_term__transform_hlds__pd_term__functor_number_map_global_term_info_0[1] = {
  (MR_Integer) 0
};

#line 747 "transform_hlds.pd_term.c"
...
#line 768 "transform_hlds.pd_term.c"
...
#line 810 "transform_hlds.pd_term.c"
...
#line 831 "transform_hlds.pd_term.c"
...
{
#line 1234 "transform_hlds.pd_term.c"
  {
#line 1236 "transform_hlds.pd_term.c"
    MR_Word transform_hlds__pd_term__conv0_HeadVar__1_1;

#line 1239 "transform_hlds.pd_term.c"
    {
...
#line 1244 "transform_hlds.pd_term.c"
    *transform_hlds__pd_term__wrapper_arg_1 = ((MR_Box) (transform_hlds__pd_term__conv0_HeadVar__1_1));
#line 1246 "transform_hlds.pd_term.c"
  }
#line 1248 "transform_hlds.pd_term.c"
}
...
#line 117 "pd_term.m"
    if (transform_hlds__pd_term__succeeded)
#line 2247 "transform_hlds.pd_term.c"
...
#line 2269 "transform_hlds.pd_term.c"
...
#line 2336 "transform_hlds.pd_term.c"
        {
#line 2338 "transform_hlds.pd_term.c"
...
#line 2347 "transform_hlds.pd_term.c"
            {
#line 2349 "transform_hlds.pd_term.c"
...
#line 72 "pd_term.m"
    if (transform_hlds__pd_term__succeeded)
#line 2387 "transform_hlds.pd_term.c"
      *transform_hlds__pd_term__HeadVar__1_1 = (MR_Integer) 0;
#line 72 "pd_term.m"
    else
#line 72 "pd_term.m"
...
#line 2405 "transform_hlds.pd_term.c"
            *transform_hlds__pd_term__HeadVar__1_1 = (MR_Integer) 2;
#line 72 "pd_term.m"
      else
#line 72 "pd_term.m"
...
#line 72 "pd_term.m"
            if ((transform_hlds__pd_term__HeadVar__3_3 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
#line 2420 "transform_hlds.pd_term.c"
...
#line 2461 "transform_hlds.pd_term.c"
                *transform_hlds__pd_term__HeadVar__1_1 = (MR_Integer) 1;
#line 72 "pd_term.m"
          }
#line 72 "pd_term.m"
...
#line 72 "pd_term.m"
            if ((transform_hlds__pd_term__HeadVar__3_3 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
#line 2478 "transform_hlds.pd_term.c"
              *transform_hlds__pd_term__HeadVar__1_1 = (MR_Integer) 1;
#line 72 "pd_term.m"
            else
#line 72 "pd_term.m"
...
#line 2504 "transform_hlds.pd_term.c"
...
#line 2524 "transform_hlds.pd_term.c"
...
#line 2620 "transform_hlds.pd_term.c"
                {
#line 2622 "transform_hlds.pd_term.c"
...
#line 72 "pd_term.m"
                if (transform_hlds__pd_term__succeeded)
#line 2627 "transform_hlds.pd_term.c"
...
#line 2666 "transform_hlds.pd_term.c"
                {
#line 2668 "transform_hlds.pd_term.c"
...
#line 72 "pd_term.m"
                    if (transform_hlds__pd_term__succeeded)
#line 2679 "transform_hlds.pd_term.c"
                      {
#line 2681 "transform_hlds.pd_term.c"
