              ...
              case (MR_Integer) 1:
                {
                  ...
                  if (succeeded)
                    *HeadVar__1_1 = SubResult1_6;
                    ...
                    mercury__private_builtin__builtin_compare_int_3_p_0(HeadVar__1_1, Var_44, ArgY2_8);
                }
                break;
              case (MR_Integer) 2:
                *HeadVar__1_1 = (MR_Integer) 1;
              ...
              case (MR_Integer) 2:
                {
                  ...
                  else
                  {
                    ...
                    mercury__private_builtin__builtin_compare_int_3_p_0(&SubResult2_26, Var_47, ArgY2_25);
