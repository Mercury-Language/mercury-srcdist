  ...
  MR_Word HeadVar__2_2)
{
  ...
  else
  {
    ...
    if (succeeded)
    {
      TypeInfo__10_10 = (MR_Word) (&transform_hlds__pd_term_scalar_common_1[4]);
      ...
      case (MR_Integer) 1:
        {
          ...
          if (succeeded)
          {
            ...
            TypeInfo__17_17 = (MR_Word) (&transform_hlds__pd_term_scalar_common_1[1]);
            succeeded = mercury__builtin__unify_2_p_0(TypeInfo__17_17, ((MR_Box) (ArgX1_3)), ((MR_Box) (ArgY1_4)));
            if (succeeded)
      ...
      case (MR_Integer) 2:
        {
          ...
          if (succeeded)
          {
            ...
            TypeInfo__18_18 = (MR_Word) (&transform_hlds__pd_term_scalar_common_1[1]);
            succeeded = mercury__builtin__unify_2_p_0(TypeInfo__18_18, ((MR_Box) (ArgX1_7)), ((MR_Box) (ArgY1_8)));
            if (succeeded)
            {
  ...
  MR_Word * STATE_VARIABLE_Cover_21)
{
  ...
  if (succeeded)
  {
    ...
    TypeCtorInfo__29_29 = (MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_proc_id_0);
    TypeInfo__30_30 = (MR_Word) (&transform_hlds__pd_term_scalar_common_2[0]);
    {
    ...
    succeeded = mercury__map__search_3_p_0(TypeCtorInfo__29_29, TypeInfo__30_30, STATE_VARIABLE_Cover_0_20, ((MR_Box) (Var_23)), &conv0_CoveringInstSizes0_17);
    if (succeeded)
    {
    ...
    if (succeeded)
    {
      ...
      MR_Word NewSizes1_35;
      MR_Integer OldTotal_36;
      MR_Integer NewTotal_37;

      transform_hlds__pd_term__get_matching_sizes_7_p_0(ModuleInfo_6, InstMap_8, Args_12, CoveringInstSizes0_17, &NewSizes1_35, &OldTotal_36, &NewTotal_37);
      succeeded = (NewTotal_37 < OldTotal_36);
      if (succeeded)
      {
        CoveringInstSizes_18 = NewSizes1_35;
        succeeded = MR_TRUE;
      }
      else
      {
        ...
        succeeded = transform_hlds__pd_term__split_out_non_increasing_4_p_0(CoveringInstSizes0_17, NewSizes1_35, &Var_39, &CoveringInstSizes_18);
        if (succeeded)
          succeeded = ((MR_Integer) 1 == Var_39);
      }
      if (succeeded)
      {
        TypeCtorInfo__31_31 = (MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_proc_id_0);
        TypeInfo__32_32 = (MR_Word) (&transform_hlds__pd_term_scalar_common_2[0]);
        mercury__map__set_4_p_0(TypeCtorInfo__31_31, TypeInfo__32_32, ((MR_Box) (Var_23)), ((MR_Box) (CoveringInstSizes_18)), STATE_VARIABLE_Cover_0_20, STATE_VARIABLE_Cover_21);
        succeeded = MR_TRUE;
      }
    }
    else
