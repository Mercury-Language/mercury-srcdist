  ...
  MR_Word * STATE_VARIABLE_Cover_21)
{
  ...
  if (succeeded)
  {
    ...
    if (succeeded)
    {
      ...
      MR_Word NewSizes1_39;
      MR_Integer OldTotal_40;
      MR_Integer NewTotal_41;

      transform_hlds__pd_term__get_matching_sizes_7_p_0(ModuleInfo_6, InstMap_8, Args_12, CoveringInstSizes0_17, &NewSizes1_39, &OldTotal_40, &NewTotal_41);
      succeeded = (NewTotal_41 < OldTotal_40);
      if (succeeded)
      {
        CoveringInstSizes_18 = NewSizes1_39;
        succeeded = MR_TRUE;
      }
      else
      {
        ...
        succeeded = transform_hlds__pd_term__split_out_non_increasing_4_p_0(CoveringInstSizes0_17, NewSizes1_39, &Var_43, &CoveringInstSizes_18);
        if (succeeded)
