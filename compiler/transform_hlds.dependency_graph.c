...
MR_decl_label10(transform_hlds__dependency_graph__add_dependency_arcs_in_goal_4_0, 168,3,6,9,10,11,13,7,4,18)
MR_decl_label10(transform_hlds__dependency_graph__add_dependency_arcs_in_goal_4_0, 19,21,16,61,24,25,27,30,31,29)
MR_decl_label8(transform_hlds__dependency_graph__add_dependency_arcs_in_goal_4_0, 33,36,35,44,43,48,46,41)
...
MR_BEGIN_MODULE(transform_hlds__dependency_graph_module17)
	...
	MR_init_label10(transform_hlds__dependency_graph__add_dependency_arcs_in_goal_4_0,168,3,6,9,10,11,13,7,4,18)
	MR_init_label10(transform_hlds__dependency_graph__add_dependency_arcs_in_goal_4_0,19,21,16,61,24,25,27,30,31,29)
	MR_init_label8(transform_hlds__dependency_graph__add_dependency_arcs_in_goal_4_0,33,36,35,44,43,48,46,41)
MR_BEGIN_CODE
...
MR_def_label(transform_hlds__dependency_graph__add_dependency_arcs_in_goal_4_0,3)
	...
	if (MR_PTAG_TESTR(MR_r5,1)) {
		MR_GOTO_LAB(transform_hlds__dependency_graph__add_dependency_arcs_in_goal_4_0_i4);
	}
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_tfield(1, MR_r5, 3);
	if (MR_INT_NE(MR_tempr1,0)) {
		MR_GOTO_LAB(transform_hlds__dependency_graph__add_dependency_arcs_in_goal_4_0_i6);
	}
	MR_r1 = MR_r4;
	MR_decr_sp_and_return(5);
	}
MR_def_label(transform_hlds__dependency_graph__add_dependency_arcs_in_goal_4_0,6)
	...
	MR_np_call_localret_ent(fn__transform_hlds__dependency_graph__dependency_node_1_0,
		transform_hlds__dependency_graph__add_dependency_arcs_in_goal_4_0_i9);
...
MR_def_label(transform_hlds__dependency_graph__add_dependency_arcs_in_goal_4_0,11)
	...
	MR_r2 = (MR_Integer) 1;
	MR_np_call_localret_ent(private_builtin__type_info_from_typeclass_info_3_0,
		transform_hlds__dependency_graph__add_dependency_arcs_in_goal_4_0_i13);
...
MR_def_label(transform_hlds__dependency_graph__add_dependency_arcs_in_goal_4_0,19)
	...
	if (MR_PTAG_TESTR(MR_r6,1)) {
		MR_GOTO_LAB(transform_hlds__dependency_graph__add_dependency_arcs_in_goal_4_0_i21);
	}
...
MR_def_label(transform_hlds__dependency_graph__add_dependency_arcs_in_goal_4_0,21)
	...
	if (MR_RTAGS_TESTR(MR_r6,3,1)) {
		MR_GOTO_LAB(transform_hlds__dependency_graph__add_dependency_arcs_in_goal_4_0_i61);
	}
	MR_r1 = MR_r4;
	MR_decr_sp_and_return(5);
MR_def_label(transform_hlds__dependency_graph__add_dependency_arcs_in_goal_4_0,16)
	...
	if (MR_RTAGS_TESTR(MR_r5,3,0)) {
		MR_GOTO_LAB(transform_hlds__dependency_graph__add_dependency_arcs_in_goal_4_0_i24);
	}
MR_def_label(transform_hlds__dependency_graph__add_dependency_arcs_in_goal_4_0,61)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_r4;
	MR_decr_sp_and_return(5);
...
MR_def_label(transform_hlds__dependency_graph__add_dependency_arcs_in_goal_4_0,25)
	...
	if (MR_RTAGS_TESTR(MR_r5,3,2)) {
		MR_GOTO_LAB(transform_hlds__dependency_graph__add_dependency_arcs_in_goal_4_0_i27);
	}
...
MR_def_label(transform_hlds__dependency_graph__add_dependency_arcs_in_goal_4_0,27)
	...
	if (MR_RTAGS_TESTR(MR_r5,3,6)) {
		MR_GOTO_LAB(transform_hlds__dependency_graph__add_dependency_arcs_in_goal_4_0_i29);
	}
	MR_sv(1) = MR_r2;
	{
	MR_Word MR_tempr1;
	...
	MR_np_localcall_lab(transform_hlds__dependency_graph__add_dependency_arcs_in_goal_4_0,
		transform_hlds__dependency_graph__add_dependency_arcs_in_goal_4_0_i30);
...
MR_def_label(transform_hlds__dependency_graph__add_dependency_arcs_in_goal_4_0,29)
	...
	if (MR_RTAGS_TESTR(MR_r5,3,4)) {
		MR_GOTO_LAB(transform_hlds__dependency_graph__add_dependency_arcs_in_goal_4_0_i33);
	}
	MR_r3 = MR_tfield(3, MR_r5, 1);
	MR_succip_word = MR_sv(5);
	MR_GOTO_LAB(transform_hlds__dependency_graph__add_dependency_arcs_in_goal_4_0_i168);
