...
MR_decl_label7(transform_hlds__dependency_graph__add_dependency_arcs_in_cons_4_0, 10,12,13,14,16,11,23)
MR_decl_label8(transform_hlds__dependency_graph__add_dependency_arcs_in_goal_4_0, 74,39,45,51,15,58,17,20)
MR_decl_label8(transform_hlds__dependency_graph__add_dependency_arcs_in_goal_4_0, 21,22,24,18,56,4,6,9)
MR_decl_label8(transform_hlds__dependency_graph__add_dependency_arcs_in_goal_4_0, 10,11,13,27,29,32,31,35)
MR_decl_label1(transform_hlds__dependency_graph__add_dependency_arcs_in_goal_4_0, 37)
MR_decl_label3(transform_hlds__dependency_graph__add_dependency_arcs_in_list_4_0, 10,3,4)
MR_decl_label8(transform_hlds__dependency_graph__add_pred_arcs_5_0, 34,3,4,5,9,6,7,11)
MR_decl_label5(transform_hlds__dependency_graph__add_pred_arcs_5_0, 12,13,15,16,18)
...
MR_decl_label8(transform_hlds__dependency_graph__add_proc_arcs_6_0, 38,3,4,5,6,7,10,12)
MR_decl_label7(transform_hlds__dependency_graph__add_proc_arcs_6_0, 9,15,16,19,21,23,18)
MR_decl_label8(transform_hlds__dependency_graph__build_pred_dependency_graph_4_0, 3,4,5,6,7,8,9,10)
MR_decl_label5(transform_hlds__dependency_graph__build_pred_dependency_graph_4_0, 11,12,13,14,15)
MR_decl_label8(transform_hlds__dependency_graph__build_proc_dependency_graph_4_0, 3,4,5,6,7,8,9,10)
MR_decl_label5(transform_hlds__dependency_graph__build_proc_dependency_graph_4_0, 11,12,13,14,15)
MR_decl_label8(transform_hlds__dependency_graph__is_entry_point_3_0, 4,5,8,9,10,11,13,14)
MR_decl_label4(transform_hlds__dependency_graph__is_entry_point_3_0, 16,17,7,2)
MR_decl_label8(transform_hlds__dependency_graph__module_info_ensure_dependency_info_2_0, 2,5,7,8,9,10,11,12)
MR_decl_label8(transform_hlds__dependency_graph__module_info_ensure_dependency_info_2_0, 13,14,15,16,17,18,19,20)
MR_decl_label1(transform_hlds__dependency_graph__module_info_ensure_dependency_info_2_0, 4)
MR_decl_label8(transform_hlds__dependency_graph__module_info_rebuild_dependency_info_3_0, 2,4,5,6,7,8,9,10)
MR_decl_label8(transform_hlds__dependency_graph__module_info_rebuild_dependency_info_3_0, 11,12,13,14,15,16,17,18)
...
MR_decl_label6(transform_hlds__dependency_graph__write_dep_graph_link_5_0, 10,11,12,14,15,17)
...
MR_BEGIN_MODULE(transform_hlds__dependency_graph_module3)
	...
	MR_init_label8(transform_hlds__dependency_graph__module_info_ensure_dependency_info_2_0,2,5,7,8,9,10,11,12)
	MR_init_label8(transform_hlds__dependency_graph__module_info_ensure_dependency_info_2_0,13,14,15,16,17,18,19,20)
...
MR_BEGIN_MODULE(transform_hlds__dependency_graph_module4)
	...
	MR_init_label8(transform_hlds__dependency_graph__module_info_rebuild_dependency_info_3_0,2,4,5,6,7,8,9,10)
	MR_init_label8(transform_hlds__dependency_graph__module_info_rebuild_dependency_info_3_0,11,12,13,14,15,16,17,18)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(transform_hlds__dependency_graph_module5)
	...
	MR_init_label8(transform_hlds__dependency_graph__build_pred_dependency_graph_4_0,3,4,5,6,7,8,9,10)
	MR_init_label5(transform_hlds__dependency_graph__build_pred_dependency_graph_4_0,11,12,13,14,15)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(transform_hlds__dependency_graph_module6)
	...
	MR_init_label8(transform_hlds__dependency_graph__build_proc_dependency_graph_4_0,3,4,5,6,7,8,9,10)
	MR_init_label5(transform_hlds__dependency_graph__build_proc_dependency_graph_4_0,11,12,13,14,15)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(transform_hlds__dependency_graph_module16)
	...
	MR_init_label7(transform_hlds__dependency_graph__add_dependency_arcs_in_cons_4_0,10,12,13,14,16,11,23)
MR_BEGIN_CODE
...
MR_def_label(transform_hlds__dependency_graph__add_dependency_arcs_in_cons_4_0,10)
	...
	MR_noprof_call_localret(MR_ENTRY(mercury__do_call_class_method_1),
		mercury__transform_hlds__dependency_graph__add_dependency_arcs_in_cons_4_0_i12);
...
MR_def_label(transform_hlds__dependency_graph__add_dependency_arcs_in_cons_4_0,14)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(transform_hlds__dependency_graph__add_dependency_arcs_in_cons_4_0_i11);
	}
	MR_sv(2) = MR_r2;
	MR_r1 = MR_sv(4);
	MR_r2 = (MR_Integer) 1;
	MR_np_call_localret_ent(private_builtin__type_info_from_typeclass_info_3_0,
		transform_hlds__dependency_graph__add_dependency_arcs_in_cons_4_0_i16);
MR_def_label(transform_hlds__dependency_graph__add_dependency_arcs_in_cons_4_0,16)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_sv(1);
	MR_r3 = MR_sv(2);
	MR_r4 = MR_sv(3);
...
MR_BEGIN_MODULE(transform_hlds__dependency_graph_module17)
	...
	MR_init_label8(transform_hlds__dependency_graph__add_dependency_arcs_in_goal_4_0,74,39,45,51,15,58,17,20)
	MR_init_label8(transform_hlds__dependency_graph__add_dependency_arcs_in_goal_4_0,21,22,24,18,56,4,6,9)
	MR_init_label8(transform_hlds__dependency_graph__add_dependency_arcs_in_goal_4_0,10,11,13,27,29,32,31,35)
	MR_init_label1(transform_hlds__dependency_graph__add_dependency_arcs_in_goal_4_0,37)
MR_BEGIN_CODE
...
MR_def_static(transform_hlds__dependency_graph__add_dependency_arcs_in_goal_4_0)
	...
	MR_incr_sp(5);
	MR_sv(5) = (MR_Word) MR_succip;
MR_def_label(transform_hlds__dependency_graph__add_dependency_arcs_in_goal_4_0,74)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	...
	MR_COMPUTED_GOTO((MR_Unsigned) MR_tag(MR_r5),
		...
		MR_LABEL_AP(transform_hlds__dependency_graph__add_dependency_arcs_in_goal_4_0_i58) MR_AND
		MR_LABEL_AP(transform_hlds__dependency_graph__add_dependency_arcs_in_goal_4_0_i56));
...
MR_def_label(transform_hlds__dependency_graph__add_dependency_arcs_in_goal_4_0,45)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r3 = MR_const_mask_field(MR_r6, 1);
	MR_succip_word = MR_sv(5);
	MR_decr_sp(5);
...
MR_def_label(transform_hlds__dependency_graph__add_dependency_arcs_in_goal_4_0,15)
	...
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_ctfield(1, MR_r5, 3);
...
MR_def_label(transform_hlds__dependency_graph__add_dependency_arcs_in_goal_4_0,18)
	...
	MR_r1 = MR_sv(3);
	MR_decr_sp_and_return(5);
MR_def_label(transform_hlds__dependency_graph__add_dependency_arcs_in_goal_4_0,56)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_COMPUTED_GOTO((MR_Unsigned) MR_ctfield(3, MR_r5, 0),
		...
		MR_LABEL_AP(transform_hlds__dependency_graph__add_dependency_arcs_in_goal_4_0_i29));
...
MR_def_label(transform_hlds__dependency_graph__add_dependency_arcs_in_goal_4_0,11)
	...
	MR_r4 = MR_tempr1;
	MR_succip_word = MR_sv(5);
	MR_GOTO_LAB(transform_hlds__dependency_graph__add_dependency_arcs_in_goal_4_0_i74);
	}
...
MR_def_label(transform_hlds__dependency_graph__add_dependency_arcs_in_goal_4_0,31)
	...
	MR_np_localcall_lab(transform_hlds__dependency_graph__add_dependency_arcs_in_goal_4_0,
		transform_hlds__dependency_graph__add_dependency_arcs_in_goal_4_0_i35);
...
MR_def_label(transform_hlds__dependency_graph__add_dependency_arcs_in_cases_4_0,6)
	...
	MR_tag_alloc_heap(MR_tempr1, 0, (MR_Integer) 2);
	MR_r2 = MR_tempr1;
	MR_tfield(0, MR_tempr1, 0) = (MR_Word) MR_CTOR1_ADDR(digraph, digraph);
...
MR_BEGIN_MODULE(transform_hlds__dependency_graph_module20)
	...
	MR_init_label8(transform_hlds__dependency_graph__add_proc_arcs_6_0,38,3,4,5,6,7,10,12)
	MR_init_label7(transform_hlds__dependency_graph__add_proc_arcs_6_0,9,15,16,19,21,23,18)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(transform_hlds__dependency_graph_module22)
	...
	MR_init_label8(transform_hlds__dependency_graph__add_pred_arcs_5_0,34,3,4,5,9,6,7,11)
	MR_init_label5(transform_hlds__dependency_graph__add_pred_arcs_5_0,12,13,15,16,18)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(transform_hlds__dependency_graph_module24)
	...
	MR_init_label6(transform_hlds__dependency_graph__write_dep_graph_link_5_0,10,11,12,14,15,17)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(transform_hlds__dependency_graph_module25)
	...
	MR_init_label8(transform_hlds__dependency_graph__is_entry_point_3_0,4,5,8,9,10,11,13,14)
	MR_init_label4(transform_hlds__dependency_graph__is_entry_point_3_0,16,17,7,2)
MR_BEGIN_CODE
