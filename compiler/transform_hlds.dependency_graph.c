...
transform_hlds__dependency_graph__add_dependency_arcs_in_cons_4_p_0(
  MR_Word transform_hlds__dependency_graph__TypeClassInfo_for_dependency_node_41,
  MR_Word transform_hlds__dependency_graph__Caller_5,
  MR_Word transform_hlds__dependency_graph__ConsId_6,
  MR_Word transform_hlds__dependency_graph__STATE_VARIABLE_DepGraph_0_37,
  MR_Word * transform_hlds__dependency_graph__STATE_VARIABLE_DepGraph_38);
...
{
  {
    ...
    switch (MR_tag((MR_Word) transform_hlds__dependency_graph__ConsId_6)) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        *transform_hlds__dependency_graph__STATE_VARIABLE_DepGraph_38 = transform_hlds__dependency_graph__STATE_VARIABLE_DepGraph_0_37;
        break;
      case (MR_Integer) 1:
        *transform_hlds__dependency_graph__STATE_VARIABLE_DepGraph_38 = transform_hlds__dependency_graph__STATE_VARIABLE_DepGraph_0_37;
        break;
          ...
          case (MR_Integer) 4:
            {
              ...
              MR_Word transform_hlds__dependency_graph__TypeInfo_43_43;
              MR_Box transform_hlds__dependency_graph__V_39_39;
              ...
              transform_hlds__dependency_graph__func_0 = ((MR_Box MR_CALL (*)(MR_Box, MR_Box)) (MR_hl_field(MR_mktag(0), (MR_hl_field(MR_mktag(0), transform_hlds__dependency_graph__TypeClassInfo_for_dependency_node_41, (MR_Integer) 0)), (MR_Integer) 7)));
              {
                transform_hlds__dependency_graph__V_39_39 = transform_hlds__dependency_graph__func_0(((MR_Box) transform_hlds__dependency_graph__TypeClassInfo_for_dependency_node_41), ((MR_Box) (transform_hlds__dependency_graph__PredProcId_10)));
              }
              {
                mercury__private_builtin__type_info_from_typeclass_info_3_p_0(transform_hlds__dependency_graph__TypeClassInfo_for_dependency_node_41, (MR_Integer) 1, &transform_hlds__dependency_graph__TypeInfo_43_43);
              }
              {
                transform_hlds__dependency_graph__succeeded = mercury__digraph__search_key_3_p_0(transform_hlds__dependency_graph__TypeInfo_43_43, transform_hlds__dependency_graph__STATE_VARIABLE_DepGraph_0_37, transform_hlds__dependency_graph__V_39_39, &transform_hlds__dependency_graph__Callee_11);
              }
              if (transform_hlds__dependency_graph__succeeded)
                {
                  MR_Word transform_hlds__dependency_graph__TypeInfo_45_45;

                  {
                    mercury__private_builtin__type_info_from_typeclass_info_3_p_0(transform_hlds__dependency_graph__TypeClassInfo_for_dependency_node_41, (MR_Integer) 1, &transform_hlds__dependency_graph__TypeInfo_45_45);
                  }
                  {
                    mercury__digraph__add_edge_4_p_0(transform_hlds__dependency_graph__TypeInfo_45_45, transform_hlds__dependency_graph__Caller_5, transform_hlds__dependency_graph__Callee_11, transform_hlds__dependency_graph__STATE_VARIABLE_DepGraph_0_37, transform_hlds__dependency_graph__STATE_VARIABLE_DepGraph_38);
                  }
                }
              else
                *transform_hlds__dependency_graph__STATE_VARIABLE_DepGraph_38 = transform_hlds__dependency_graph__STATE_VARIABLE_DepGraph_0_37;
  ...
  MR_Box * transform_hlds__dependency_graph__wrapper_arg_3)
{
  {
    MR_Box transform_hlds__dependency_graph__closure = transform_hlds__dependency_graph__closure_arg;
    MR_Word transform_hlds__dependency_graph__conv0_STATE_VARIABLE_DepGraph_38;

    {
      transform_hlds__dependency_graph__add_dependency_arcs_in_cons_4_p_0(((MR_Word) (MR_hl_field(MR_mktag(0), transform_hlds__dependency_graph__closure, (MR_Integer) 3))), ((MR_Word) (MR_hl_field(MR_mktag(0), transform_hlds__dependency_graph__closure, (MR_Integer) 4))), ((MR_Word) transform_hlds__dependency_graph__wrapper_arg_1), ((MR_Word) transform_hlds__dependency_graph__wrapper_arg_2), &transform_hlds__dependency_graph__conv0_STATE_VARIABLE_DepGraph_38);
    }
    *transform_hlds__dependency_graph__wrapper_arg_3 = ((MR_Box) (transform_hlds__dependency_graph__conv0_STATE_VARIABLE_DepGraph_38));
  }
}
              ...
              case (MR_Integer) 5:
                {
                  ...
                  transform_hlds__dependency_graph__succeeded = ((((MR_tag((MR_Word) transform_hlds__dependency_graph__Reason_20)) == (MR_mktag((MR_Integer) 3)))) && (((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), transform_hlds__dependency_graph__Reason_20, (MR_Integer) 0)))) == (MR_Integer) 6)));
                  if (transform_hlds__dependency_graph__succeeded)
                    {
...
const char *mercury__transform_hlds__dependency_graph__grade_check(void)
{
    return &MR_GRADE_VAR;
}
