...
MR_decl_label10(transform_hlds__dependency_graph__add_dependency_arcs_in_goal_4_0, 168,3,7,10,11,12,14,8,5,19)
MR_decl_label10(transform_hlds__dependency_graph__add_dependency_arcs_in_goal_4_0, 20,22,17,25,26,28,64,30,32,33)
MR_decl_label8(transform_hlds__dependency_graph__add_dependency_arcs_in_goal_4_0, 31,36,35,44,43,48,46,41)
...
MR_BEGIN_MODULE(transform_hlds__dependency_graph_module17)
	...
	MR_init_label10(transform_hlds__dependency_graph__add_dependency_arcs_in_goal_4_0,168,3,7,10,11,12,14,8,5,19)
	MR_init_label10(transform_hlds__dependency_graph__add_dependency_arcs_in_goal_4_0,20,22,17,25,26,28,64,30,32,33)
	MR_init_label8(transform_hlds__dependency_graph__add_dependency_arcs_in_goal_4_0,31,36,35,44,43,48,46,41)
MR_BEGIN_CODE
...
MR_def_static(transform_hlds__dependency_graph__add_dependency_arcs_in_goal_4_0)
	...
	MR_incr_sp(5);
	MR_sv(5) = (MR_Word) MR_succip;
MR_def_label(transform_hlds__dependency_graph__add_dependency_arcs_in_goal_4_0,168)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	while (1) {
	{
	MR_Word MR_tempr1;
...
MR_def_label(transform_hlds__dependency_graph__add_dependency_arcs_in_goal_4_0,22)
	...
	if (MR_RTAGS_TESTR(MR_r6,3,1)) {
		MR_GOTO_LAB(transform_hlds__dependency_graph__add_dependency_arcs_in_goal_4_0_i64);
	}
	MR_r1 = MR_r4;
	MR_decr_sp_and_return(5);
...
MR_def_label(transform_hlds__dependency_graph__add_dependency_arcs_in_goal_4_0,64)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_r4;
	MR_decr_sp_and_return(5);
...
MR_def_label(transform_hlds__dependency_graph__add_dependency_arcs_in_goal_4_0,33)
	...
	MR_r4 = MR_tempr1;
	MR_succip_word = MR_sv(5);
	MR_GOTO_LAB(transform_hlds__dependency_graph__add_dependency_arcs_in_goal_4_0_i168);
	}
...
MR_def_label(transform_hlds__dependency_graph__add_dependency_arcs_in_goal_4_0,35)
	...
	if (MR_RTAGS_TESTR(MR_r5,3,7)) {
		MR_GOTO_LAB(transform_hlds__dependency_graph__add_dependency_arcs_in_goal_4_0_i41);
	}
	{
	MR_Word MR_tempr1;
...
MR_def_label(transform_hlds__dependency_graph__add_dependency_arcs_in_goal_4_0,43)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_r6,0)) {
		MR_GOTO_LAB(transform_hlds__dependency_graph__add_dependency_arcs_in_goal_4_0_i46);
	}
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 2);
