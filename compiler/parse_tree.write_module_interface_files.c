...
{
  {
    ...
    (env).parse_tree__write_module_interface_files__make_impl_type_abstract_3_p_0_env_0__TypeDefnMap_4 = TypeDefnMap_4;
    {
      ...
      (env).parse_tree__write_module_interface_files__make_impl_type_abstract_3_p_0_env_0__succeeded = (STATE_VARIABLE_TypeDefnPairs_0_16 != (MR_Word) ((MR_Unsigned) 0U));
      ...
      if ((env).parse_tree__write_module_interface_files__make_impl_type_abstract_3_p_0_env_0__succeeded)
      {
        ...
        if ((env).parse_tree__write_module_interface_files__make_impl_type_abstract_3_p_0_env_0__succeeded)
        {
          ...
          if ((env).parse_tree__write_module_interface_files__make_impl_type_abstract_3_p_0_env_0__succeeded)
          {
            ...
            (env).parse_tree__write_module_interface_files__make_impl_type_abstract_3_p_0_env_0__succeeded = (Ctors_9 != (MR_Word) ((MR_Unsigned) 0U));
            if ((env).parse_tree__write_module_interface_files__make_impl_type_abstract_3_p_0_env_0__succeeded)
            {
