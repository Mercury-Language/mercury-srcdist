  ...
  MR_Word * Succeeded_16)
{
  ...
  libs__globals__set_option_4_p_0((MR_Integer) 176, (MR_Word) (MR_mkword(1, &parse_tree__write_module_interface_files_scalar_common_1[2])), Globals_11, &NoLineNumGlobals0_41);
  libs__globals__set_option_4_p_0((MR_Integer) 177, (MR_Word) (MR_mkword(1, &parse_tree__write_module_interface_files_scalar_common_1[2])), NoLineNumGlobals0_41, &NoLineNumGlobals_18);
  libs__globals__lookup_bool_option_3_p_0(NoLineNumGlobals_18, (MR_Integer) 156, &GenerateVersionNumbers_79);
  ...
  MR_Word * Succeeded_16)
{
  ...
  libs__globals__set_option_4_p_0((MR_Integer) 176, (MR_Word) (MR_mkword(1, &parse_tree__write_module_interface_files_scalar_common_1[2])), Globals_11, &NoLineNumGlobals0_47);
  libs__globals__set_option_4_p_0((MR_Integer) 177, (MR_Word) (MR_mkword(1, &parse_tree__write_module_interface_files_scalar_common_1[2])), NoLineNumGlobals0_47, &NoLineNumGlobals_18);
  libs__globals__lookup_bool_option_3_p_0(NoLineNumGlobals_18, (MR_Integer) 156, &GenerateVersionNumbers_91);
  ...
  MR_Word * STATE_VARIABLE_HaveParseTreeMaps_21)
{
  ...
  else
  {
    ...
    *Specs_16 = ((MR_Word) ((MR_hl_field(0, GenerateResult_19, (MR_Integer) 4))));
    ...
    libs__globals__set_option_4_p_0((MR_Integer) 176, (MR_Word) (MR_mkword(1, &parse_tree__write_module_interface_files_scalar_common_1[2])), Globals_12, &NoLineNumGlobals0_99);
    libs__globals__set_option_4_p_0((MR_Integer) 177, (MR_Word) (MR_mkword(1, &parse_tree__write_module_interface_files_scalar_common_1[2])), NoLineNumGlobals0_99, &NoLineNumGlobals_67);
  ...
  MR_Word * MaybeVersionNumbers_12)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(NoLineNumGlobals_9, (MR_Integer) 156, &GenerateVersionNumbers_59);
  ...
  MR_Word * STATE_VARIABLE_HaveParseTreeMaps_21)
{
  ...
  else
  {
    ...
    *Specs_16 = ((MR_Word) ((MR_hl_field(0, GenerateResult_19, (MR_Integer) 3))));
    ...
    libs__globals__set_option_4_p_0((MR_Integer) 176, (MR_Word) (MR_mkword(1, &parse_tree__write_module_interface_files_scalar_common_1[2])), Globals_12, &NoLineNumGlobals0_58);
    libs__globals__set_option_4_p_0((MR_Integer) 177, (MR_Word) (MR_mkword(1, &parse_tree__write_module_interface_files_scalar_common_1[2])), NoLineNumGlobals0_58, &NoLineNumGlobals_53);
  ...
  MR_Word * Specs_18)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 691, &Std_76);
  switch (Std_76) {
  ...
  else
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 691, &Std_79);
    switch (Std_79) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
