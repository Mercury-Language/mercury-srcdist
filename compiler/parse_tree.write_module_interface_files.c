...
{
  {
    ...
    parse_tree__grab_modules__grab_unqual_imported_modules_make_int_7_p_0(Globals_8, SourceFileName_9, SourceFileModuleName_10, IntRawCompUnit_17, &ModuleAndImports_18);
    ...
    GetSpecsEffectivelyErrors_22 = parse_tree__error_util__contains_errors_or_warnings_treated_as_errors_2_f_0(Globals_8, GetSpecs_20);
    ...
    if (succeeded)
    {
      ...
      succeeded = mercury__set__is_empty_1_p_0(TypeCtorInfo_74_74, GetErrors_21);
    }
    if (succeeded)
    {
      ...
      parse_tree__module_qual__module_qualify_aug_comp_unit_13_p_0(Globals_8, AugCompUnit1_19, &AugCompUnit_23, Var_45, &Var_24, (MR_String) "", &Var_25, &Var_26, &Var_27, &Var_28, &Var_29, (MR_Word) ((MR_Unsigned) 0U), &QualSpecs_30);
      if ((QualSpecs_30 == (MR_Word) ((MR_Unsigned) 0U)))
      {
        MR_Word ParseTreeInt1_31;
        MR_Word ParseTreeInt2_32;
        MR_Word Specs_33;

        parse_tree__comp_unit_interface__generate_interfaces_int1_int2_6_p_0(Globals_8, AugCompUnit_23, &ParseTreeInt1_31, &ParseTreeInt2_32, (MR_Word) ((MR_Unsigned) 0U), &Specs_33);
        if ((Specs_33 == (MR_Word) ((MR_Unsigned) 0U)))
        {
          MR_Word Experiment2_34;

          parse_tree__write_module_interface_files__actually_write_interface_file_6_p_0(Globals_8, ParseTreeInt1_31, (MR_String) "", MaybeTimestamp_11);
          parse_tree__write_module_interface_files__actually_write_interface_file_6_p_0(Globals_8, ParseTreeInt2_32, (MR_String) "", MaybeTimestamp_11);
          libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 699, &Experiment2_34);
          switch (Experiment2_34) {
            ...
            case (MR_Integer) 1:
              {
                MR_Word ParseTreeInt23_35;
                MR_Word _Specs_36;

                parse_tree__comp_unit_interface__generate_interface_int2_via_int3_5_p_0(Globals_8, AugCompUnit_23, &ParseTreeInt23_35, (MR_Word) ((MR_Unsigned) 0U), &_Specs_36);
                parse_tree__write_module_interface_files__actually_write_interface_file_6_p_0(Globals_8, ParseTreeInt23_35, (MR_String) ".via3", MaybeTimestamp_11);
              }
              break;
          }
          ...
          parse_tree__write_module_interface_files__report_file_not_written_8_p_0(Globals_8, Specs_33, (MR_Word) ((MR_Unsigned) 0U), ModuleName_14, (MR_String) ".int", (MR_Word) (MR_mkword(MR_mktag(1), &parse_tree__write_module_interface_files_scalar_common_2[3])));
      }
      else
        parse_tree__write_module_interface_files__report_file_not_written_8_p_0(Globals_8, QualSpecs_30, (MR_Word) ((MR_Unsigned) 0U), ModuleName_14, (MR_String) ".int", (MR_Word) (MR_mkword(MR_mktag(1), &parse_tree__write_module_interface_files_scalar_common_2[3])));
    }
    else
      parse_tree__write_module_interface_files__report_file_not_written_8_p_0(Globals_8, GetSpecs_20, (MR_Word) (MR_mkword(MR_mktag(1), &parse_tree__write_module_interface_files_scalar_common_2[4])), ModuleName_14, (MR_String) ".int", (MR_Word) (MR_mkword(MR_mktag(1), &parse_tree__write_module_interface_files_scalar_common_2[3])));
  }
}
...
{
  {
    ...
    MR_Word GetSpecs_19;
    MR_Word GetErrors_20;
    MR_Word GetSpecsEffectivelyErrors_21;
    MR_Word TypeCtorInfo_60_60;

    parse_tree__grab_modules__grab_unqual_imported_modules_make_int_7_p_0(Globals_8, SourceFileName_9, SourceFileModuleName_10, RawCompUnit0_12, &ModuleAndImports_17);
    parse_tree__module_imports__module_and_imports_get_aug_comp_unit_4_p_0(ModuleAndImports_17, &AugCompUnit1_18, &GetSpecs_19, &GetErrors_20);
    GetSpecsEffectivelyErrors_21 = parse_tree__error_util__contains_errors_or_warnings_treated_as_errors_2_f_0(Globals_8, GetSpecs_19);
    succeeded = (GetSpecsEffectivelyErrors_21 == (MR_Integer) 0);
    if (succeeded)
    {
      TypeCtorInfo_60_60 = (MR_Word) (&parse_tree__parse_error__parse_tree__parse_error__type_ctor_info_read_module_error_0);
      succeeded = mercury__set__is_empty_1_p_0(TypeCtorInfo_60_60, GetErrors_20);
    }
    if (succeeded)
    {
      ...
      parse_tree__module_qual__module_qualify_aug_comp_unit_13_p_0(Globals_8, AugCompUnit1_18, &AugCompUnit_22, Var_40, &_EventSpecMap_23, (MR_String) "", &Var_24, &Var_25, &Var_26, &Var_27, &Var_28, (MR_Word) ((MR_Unsigned) 0U), &QualSpecs_29);
      if ((QualSpecs_29 == (MR_Word) ((MR_Unsigned) 0U)))
      {
        MR_Word ParseTreeInt0_30;
        MR_Word Specs_31;

        parse_tree__comp_unit_interface__generate_private_interface_int0_4_p_0(AugCompUnit_22, &ParseTreeInt0_30, (MR_Word) ((MR_Unsigned) 0U), &Specs_31);
        if ((Specs_31 == (MR_Word) ((MR_Unsigned) 0U)))
        {
          parse_tree__write_module_interface_files__actually_write_interface_file_6_p_0(Globals_8, ParseTreeInt0_30, (MR_String) "", MaybeTimestamp_11);
          parse_tree__module_cmds__touch_interface_datestamp_5_p_0(Globals_8, ModuleName_14, (MR_String) ".date0");
        }
        else
          parse_tree__write_module_interface_files__report_file_not_written_8_p_0(Globals_8, Specs_31, (MR_Word) ((MR_Unsigned) 0U), ModuleName_14, (MR_String) ".int0", (MR_Word) ((MR_Unsigned) 0U));
      }
      else
        parse_tree__write_module_interface_files__report_file_not_written_8_p_0(Globals_8, QualSpecs_29, (MR_Word) ((MR_Unsigned) 0U), ModuleName_14, (MR_String) ".int0", (MR_Word) ((MR_Unsigned) 0U));
    }
    else
      parse_tree__write_module_interface_files__report_file_not_written_8_p_0(Globals_8, GetSpecs_19, (MR_Word) (MR_mkword(MR_mktag(1), &parse_tree__write_module_interface_files_scalar_common_2[2])), ModuleName_14, (MR_String) ".int0", (MR_Word) ((MR_Unsigned) 0U));
  }
}
...
{
  {
    ...
    parse_tree__comp_unit_interface__generate_short_interface_int3_6_p_0(Globals_6, RawCompUnit_8, &Var_13, &ParseTreeInt3_14, (MR_Word) ((MR_Unsigned) 0U), &Specs_15);
...
{
  {
    ...
    libs__globals__set_option_4_p_0((MR_Integer) 155, Var_39, Globals_7, &NoLineNumGlobals0_19);
    libs__globals__set_option_4_p_0((MR_Integer) 156, Var_39, NoLineNumGlobals0_19, &NoLineNumGlobals_20);
    libs__globals__lookup_bool_option_3_p_0(NoLineNumGlobals_20, (MR_Integer) 134, &GenerateVersionNumbers_21);
