...
{
  {
    ...
    parse_tree__grab_modules__grab_unqual_imported_modules_make_int_9_p_0(Globals_10, SourceFileName_11, SourceFileModuleName_12, IntRawCompUnit_20, &ModuleAndImports_21, STATE_VARIABLE_HaveReadModuleMaps_0_44, STATE_VARIABLE_HaveReadModuleMaps_45);
    ...
    if (succeeded)
    {
      TypeCtorInfo_82_82 = (MR_Word) (&parse_tree__parse_error__parse_tree__parse_error__type_ctor_info_read_module_error_0);
      succeeded = mercury__set__is_empty_1_p_0(TypeCtorInfo_82_82, GetErrors_24);
    }
    if (succeeded)
    {
      ...
      Var_50 = mercury__map__init_0_f_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&parse_tree__prog_data_event__parse_tree__prog_data_event__type_ctor_info_event_spec_0));
      parse_tree__module_qual__module_qualify_aug_comp_unit_13_p_0(Globals_10, AugCompUnit1_22, &AugCompUnit_26, Var_50, &Var_27, (MR_String) "", &Var_28, &Var_29, &Var_30, &Var_31, &Var_32, (MR_Word) ((MR_Unsigned) 0U), &QualSpecs_33);
      Var_53 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_error_spec_0), GetSpecs_23, QualSpecs_33);
      parse_tree__error_util__filter_interface_generation_specs_5_p_0(Globals_10, Var_53, &EffectiveGetQualSpecs_34);
      if ((EffectiveGetQualSpecs_34 == (MR_Word) ((MR_Unsigned) 0U)))
      {
        ...
        Var_63 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_error_spec_0), EffectiveGetQualSpecs_34, GenerateSpecs_37);
        parse_tree__error_util__filter_interface_generation_specs_5_p_0(Globals_10, Var_63, &Specs_38);
        ...
        libs__globals__get_progress_output_stream_5_p_0(Globals_10, ModuleName_17, &ProgressStream_40);
        parse_tree__module_cmds__touch_interface_datestamp_7_p_0(Globals_10, ProgressStream_40, ErrorStream_39, ModuleName_17, (MR_Word) (((MR_Box) ((MR_String) ".date"))));
      }
      else
        parse_tree__write_module_interface_files__report_file_not_written_8_p_0(Globals_10, EffectiveGetQualSpecs_34, (MR_Word) ((MR_Unsigned) 0U), ModuleName_17, (MR_Word) (((MR_Box) ((MR_String) ".int"))), (MR_Word) (MR_mkword(MR_mktag(1), &parse_tree__write_module_interface_files_scalar_common_1[1])));
    }
    else
      parse_tree__write_module_interface_files__report_file_not_written_8_p_0(Globals_10, GetSpecs_23, (MR_Word) (MR_mkword(MR_mktag(1), &parse_tree__write_module_interface_files_scalar_common_1[2])), ModuleName_17, (MR_Word) (((MR_Box) ((MR_String) ".int"))), (MR_Word) (MR_mkword(MR_mktag(1), &parse_tree__write_module_interface_files_scalar_common_1[1])));
  }
}
...
{
  {
    ...
    libs__globals__set_option_4_p_0((MR_Integer) 162, (MR_Word) (MR_mkword(MR_mktag(1), &parse_tree__write_module_interface_files_scalar_common_1[3])), Globals_7, &NoLineNumGlobals0_80);
    libs__globals__set_option_4_p_0((MR_Integer) 163, (MR_Word) (MR_mkword(MR_mktag(1), &parse_tree__write_module_interface_files_scalar_common_1[3])), NoLineNumGlobals0_80, &NoLineNumGlobals_15);
...
{
  {
    ...
    parse_tree__grab_modules__grab_unqual_imported_modules_make_int_9_p_0(Globals_10, SourceFileName_11, SourceFileModuleName_12, RawCompUnit0_14, &ModuleAndImports_20, STATE_VARIABLE_HaveReadModuleMaps_0_42, STATE_VARIABLE_HaveReadModuleMaps_43);
    ...
    if (succeeded)
    {
      TypeCtorInfo_74_74 = (MR_Word) (&parse_tree__parse_error__parse_tree__parse_error__type_ctor_info_read_module_error_0);
      succeeded = mercury__set__is_empty_1_p_0(TypeCtorInfo_74_74, GetErrors_23);
    }
    if (succeeded)
    {
      ...
      parse_tree__module_qual__module_qualify_aug_comp_unit_13_p_0(Globals_10, AugCompUnit1_21, &AugCompUnit_25, Var_48, &_EventSpecMap_26, (MR_String) "", &Var_27, &Var_28, &Var_29, &Var_30, &Var_31, (MR_Word) ((MR_Unsigned) 0U), &QualSpecs_32);
      Var_51 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_error_spec_0), GetSpecs_22, QualSpecs_32);
      parse_tree__error_util__filter_interface_generation_specs_5_p_0(Globals_10, Var_51, &EffectiveGetQualSpecs_33);
      if ((EffectiveGetQualSpecs_33 == (MR_Word) ((MR_Unsigned) 0U)))
      {
        ...
        Var_59 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_error_spec_0), EffectiveGetQualSpecs_33, GenerateSpecs_35);
        parse_tree__error_util__filter_interface_generation_specs_5_p_0(Globals_10, Var_59, &Specs_36);
        ...
        parse_tree__module_cmds__touch_interface_datestamp_7_p_0(Globals_10, ProgressStream_38, ErrorStream_37, ModuleName_17, (MR_Word) (((MR_Box) ((MR_String) ".date0"))));
      }
      else
      ...
      parse_tree__write_module_interface_files__report_file_not_written_8_p_0(Globals_10, GetSpecs_22, (MR_Word) (MR_mkword(MR_mktag(1), &parse_tree__write_module_interface_files_scalar_common_1[0])), ModuleName_17, (MR_Word) (((MR_Box) ((MR_String) ".int0"))), (MR_Word) ((MR_Unsigned) 0U));
  }
}
      ...
      case (MR_Integer) 0:
        {
          ...
          MR_Word ModuleName_43 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ParseTreeInt3_13, (MR_Integer) 0))));
          MR_String OutputFileName_44;
          MR_String TmpOutputFileName_45;
          MR_Word NoLineNumGlobals_46;
          MR_Word OtherExt_72;
          ...
          parse_tree__file_kind__int_file_kind_to_extension_3_p_0((MR_Integer) 3, &_ExtStr_71, &OtherExt_72);
          {
          ...
          parse_tree__file_names__module_name_to_file_name_8_p_0(Globals_6, (MR_String) "predicate \140parse_tree.write_module_interface_files.construct_int_file_name\'/8", (MR_Integer) 0, Var_76, ModuleName_43, &OutputFileName0_73);
          OutputFileName_44 = mercury__string__f_43_43_2_f_0(OutputFileName0_73, (MR_String) "");
          TmpOutputFileName_45 = mercury__string__f_43_43_2_f_0(OutputFileName_44, (MR_String) ".tmp");
          libs__globals__set_option_4_p_0((MR_Integer) 162, (MR_Word) (MR_mkword(MR_mktag(1), &parse_tree__write_module_interface_files_scalar_common_1[3])), Globals_6, &NoLineNumGlobals0_81);
          libs__globals__set_option_4_p_0((MR_Integer) 163, (MR_Word) (MR_mkword(MR_mktag(1), &parse_tree__write_module_interface_files_scalar_common_1[3])), NoLineNumGlobals0_81, &NoLineNumGlobals_46);
          parse_tree__parse_tree_out__output_parse_tree_int3_5_p_0(NoLineNumGlobals_46, TmpOutputFileName_45, ParseTreeInt3_13);
          parse_tree__module_cmds__update_interface_5_p_0(Globals_6, ModuleName_43, OutputFileName_44);
          libs__globals__get_progress_output_stream_5_p_0(Globals_6, ModuleName_10, &ProgressStream_17);
          libs__globals__get_error_output_stream_5_p_0(Globals_6, ModuleName_10, &ErrorStream_18);
          parse_tree__module_cmds__touch_interface_datestamp_7_p_0(Globals_6, ProgressStream_17, ErrorStream_18, ModuleName_10, (MR_Word) (((MR_Box) ((MR_String) ".date3"))));
        }
        break;
      case (MR_Integer) 1:
