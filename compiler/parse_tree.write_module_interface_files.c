  ...
  MR_Word * MaybeVersionNumbers_10)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(NoLineNumGlobals_7, (MR_Integer) 150, &GenerateVersionNumbers_46);
  ...
  MR_Word * MaybeVersionNumbers_10)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(NoLineNumGlobals_7, (MR_Integer) 150, &GenerateVersionNumbers_53);
  ...
  MR_Word * MaybeVersionNumbers_10)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(NoLineNumGlobals_7, (MR_Integer) 150, &GenerateVersionNumbers_59);
