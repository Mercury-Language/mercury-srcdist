  ...
  MR_Word * STATE_VARIABLE_HaveReadModuleMaps_44)
{
  ...
  if (succeeded)
  {
    ...
    if ((EffectiveGetQualSpecs_32 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      ...
      *Succeeded_20 = libs__maybe_succeeded__and_list_1_f_0(Var_61);
    }
    else
    {
  ...
  MR_Word OtherExtDate_18)
{
  ...
  Var_69 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), PrefixPieces_14, NotWrittenPieces_22);
  {
