  ...
  MR_Word * Succeeded_16)
{
  ...
  parse_tree__file_kind__int_file_kind_to_extension_3_p_0((MR_Integer) 2, &_ExtStr_57, &OtherExt_58);
  {
    Var_62 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(1, Var_62, 0) = ((MR_Box) (OtherExt_58));
  }
  parse_tree__file_names__module_name_to_file_name_8_p_0(Globals_12, (MR_String) "predicate \140parse_tree.write_module_interface_files.construct_int_file_name\'/8", (MR_Integer) 0, Var_62, ModuleName_18, &OutputFileName0_59);
  ...
  libs__globals__set_option_4_p_0((MR_Integer) 173, (MR_Word) (MR_mkword(1, &parse_tree__write_module_interface_files_scalar_common_2[1])), Globals_12, &NoLineNumGlobals0_64);
  libs__globals__set_option_4_p_0((MR_Integer) 174, (MR_Word) (MR_mkword(1, &parse_tree__write_module_interface_files_scalar_common_2[1])), NoLineNumGlobals0_64, &NoLineNumGlobals_21);
  ...
  MR_Word * Succeeded_16)
{
  ...
  parse_tree__file_kind__int_file_kind_to_extension_3_p_0((MR_Integer) 1, &_ExtStr_67, &OtherExt_68);
  {
    Var_72 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(1, Var_72, 0) = ((MR_Box) (OtherExt_68));
  }
  parse_tree__file_names__module_name_to_file_name_8_p_0(Globals_12, (MR_String) "predicate \140parse_tree.write_module_interface_files.construct_int_file_name\'/8", (MR_Integer) 0, Var_72, ModuleName_18, &OutputFileName0_69);
  OutputFileName_19 = mercury__string__f_43_43_2_f_0(OutputFileName0_69, ExtraSuffix_14);
  TmpOutputFileName_20 = mercury__string__f_43_43_2_f_0(OutputFileName_19, (MR_String) ".tmp");
  libs__globals__set_option_4_p_0((MR_Integer) 173, (MR_Word) (MR_mkword(1, &parse_tree__write_module_interface_files_scalar_common_2[1])), Globals_12, &NoLineNumGlobals0_74);
  libs__globals__set_option_4_p_0((MR_Integer) 174, (MR_Word) (MR_mkword(1, &parse_tree__write_module_interface_files_scalar_common_2[1])), NoLineNumGlobals0_74, &NoLineNumGlobals_21);
  ...
  MR_Word * Succeeded_16)
{
  ...
  parse_tree__file_kind__int_file_kind_to_extension_3_p_0((MR_Integer) 0, &_ExtStr_75, &OtherExt_76);
  {
