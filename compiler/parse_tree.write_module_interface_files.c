...
{
  {
    ...
    else
    {
      ...
      else
      {
        ...
        {
          mercury__builtin__compare_3_p_0((MR_Word) (&parse_tree__write_module_interface_files_scalar_common_1[5]), HeadVar__1_1, ((MR_Box) (ArgX3_10)), ((MR_Box) (ArgY3_11)));
        }
      }
    }
  }
...
{
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          TypeInfo_12_12 = (MR_Word) (&parse_tree__write_module_interface_files_scalar_common_1[5]);
...
{
  {
    ...
    mercury__builtin__compare_3_p_0((MR_Word) (&parse_tree__write_module_interface_files_scalar_common_1[4]), HeadVar__1_1, ((MR_Box) (Cast_HeadVar1_4)), ((MR_Box) (Cast_HeadVar2_5)));
  }
}
...
{
  {
    ...
    succeeded = mercury__builtin__unify_2_p_0((MR_Word) (&parse_tree__write_module_interface_files_scalar_common_1[4]), ((MR_Box) (Cast_HeadVar1_3)), ((MR_Box) (Cast_HeadVar2_4)));
    return succeeded;
  }
}
