  ...
  MR_Word * Succeeded_16)
{
  ...
  parse_tree__file_kind__int_file_kind_to_extension_3_p_0((MR_Integer) 2, &_ExtStr_70, &OtherExt_71);
  {
    Var_75 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(MR_mktag(1), Var_75, 0) = ((MR_Box) (OtherExt_71));
  }
  parse_tree__file_names__module_name_to_file_name_8_p_0(Globals_12, (MR_String) "predicate \140parse_tree.write_module_interface_files.construct_int_file_name\'/8", (MR_Integer) 0, Var_75, ModuleName_18, &OutputFileName0_72);
  ...
  libs__globals__set_option_4_p_0((MR_Integer) 172, (MR_Word) (MR_mkword(MR_mktag(1), &parse_tree__write_module_interface_files_scalar_common_2[1])), Globals_12, &NoLineNumGlobals0_80);
  libs__globals__set_option_4_p_0((MR_Integer) 173, (MR_Word) (MR_mkword(MR_mktag(1), &parse_tree__write_module_interface_files_scalar_common_2[1])), NoLineNumGlobals0_80, &NoLineNumGlobals_21);
  ...
  MR_Word * MaybeVersionNumbers_10)
{
  ...
  MR_Word DisableVersionNumbers_53;

  libs__globals__lookup_bool_option_3_p_0(NoLineNumGlobals_7, (MR_Integer) 152, &GenerateVersionNumbers_52);
  libs__globals__io_get_disable_generate_item_version_numbers_3_p_0(&DisableVersionNumbers_53);
  succeeded = (GenerateVersionNumbers_52 == (MR_Integer) 1);
  if (succeeded)
    succeeded = (DisableVersionNumbers_53 == (MR_Integer) 0);
  if (succeeded)
  {
  ...
  MR_Word * Succeeded_16)
{
  ...
  MR_Word UpdateSucceeded_25;
  MR_Word OtherExt_85;
  MR_String OutputFileName0_86;
  MR_Word Var_89;
  MR_String _ExtStr_84;
  MR_Word Var_53;
  MR_Word Var_54;
  MR_Word Var_56;
  MR_Word Var_57;
  ...
  parse_tree__file_kind__int_file_kind_to_extension_3_p_0((MR_Integer) 1, &_ExtStr_84, &OtherExt_85);
  {
    Var_89 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(MR_mktag(1), Var_89, 0) = ((MR_Box) (OtherExt_85));
  }
  parse_tree__file_names__module_name_to_file_name_8_p_0(Globals_12, (MR_String) "predicate \140parse_tree.write_module_interface_files.construct_int_file_name\'/8", (MR_Integer) 0, Var_89, ModuleName_18, &OutputFileName0_86);
  OutputFileName_19 = mercury__string__f_43_43_2_f_0(OutputFileName0_86, ExtraSuffix_14);
  TmpOutputFileName_20 = mercury__string__f_43_43_2_f_0(OutputFileName_19, (MR_String) ".tmp");
  ...
  MR_Word * MaybeVersionNumbers_10)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(NoLineNumGlobals_7, (MR_Integer) 152, &GenerateVersionNumbers_59);
  ...
  MR_Word * NoLineNumGlobals_4)
{
  ...
  libs__globals__set_option_4_p_0((MR_Integer) 172, (MR_Word) (MR_mkword(MR_mktag(1), &parse_tree__write_module_interface_files_scalar_common_2[1])), Globals_3, &NoLineNumGlobals0_5);
  libs__globals__set_option_4_p_0((MR_Integer) 173, (MR_Word) (MR_mkword(MR_mktag(1), &parse_tree__write_module_interface_files_scalar_common_2[1])), NoLineNumGlobals0_5, NoLineNumGlobals_4);
}
  ...
  MR_Word * Succeeded_16)
{
  ...
  libs__globals__set_option_4_p_0((MR_Integer) 172, (MR_Word) (MR_mkword(MR_mktag(1), &parse_tree__write_module_interface_files_scalar_common_2[1])), Globals_12, &NoLineNumGlobals0_89);
  libs__globals__set_option_4_p_0((MR_Integer) 173, (MR_Word) (MR_mkword(MR_mktag(1), &parse_tree__write_module_interface_files_scalar_common_2[1])), NoLineNumGlobals0_89, &NoLineNumGlobals_21);
...
{
  MR_bool succeeded;
  MR_Word GenerateVersionNumbers_65;
  MR_Word DisableVersionNumbers_66;

  libs__globals__lookup_bool_option_3_p_0(NoLineNumGlobals_7, (MR_Integer) 152, &GenerateVersionNumbers_65);
  libs__globals__io_get_disable_generate_item_version_numbers_3_p_0(&DisableVersionNumbers_66);
  succeeded = (GenerateVersionNumbers_65 == (MR_Integer) 1);
  if (succeeded)
    succeeded = (DisableVersionNumbers_66 == (MR_Integer) 0);
  if (succeeded)
  {
  ...
  MR_Word * Succeeded_16)
{
  ...
  MR_Word OtherExt_50;
  MR_String OutputFileName0_51;
  MR_Word Var_54;
  MR_Word NoLineNumGlobals0_59;
  MR_String _ExtStr_49;

  parse_tree__file_kind__int_file_kind_to_extension_3_p_0((MR_Integer) 3, &_ExtStr_49, &OtherExt_50);
  {
    Var_54 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(MR_mktag(1), Var_54, 0) = ((MR_Box) (OtherExt_50));
  }
  parse_tree__file_names__module_name_to_file_name_8_p_0(Globals_12, (MR_String) "predicate \140parse_tree.write_module_interface_files.construct_int_file_name\'/8", (MR_Integer) 0, Var_54, ModuleName_18, &OutputFileName0_51);
  OutputFileName_19 = mercury__string__f_43_43_2_f_0(OutputFileName0_51, ExtraSuffix_14);
  TmpOutputFileName_20 = mercury__string__f_43_43_2_f_0(OutputFileName_19, (MR_String) ".tmp");
  libs__globals__set_option_4_p_0((MR_Integer) 172, (MR_Word) (MR_mkword(MR_mktag(1), &parse_tree__write_module_interface_files_scalar_common_2[1])), Globals_12, &NoLineNumGlobals0_59);
  libs__globals__set_option_4_p_0((MR_Integer) 173, (MR_Word) (MR_mkword(MR_mktag(1), &parse_tree__write_module_interface_files_scalar_common_2[1])), NoLineNumGlobals0_59, &NoLineNumGlobals_21);
