...
{
  {
    ...
    libs__globals__set_option_4_p_0((MR_Integer) 163, (MR_Word) (MR_mkword(MR_mktag(1), &parse_tree__write_module_interface_files_scalar_common_2[1])), Globals_12, &NoLineNumGlobals0_81);
    libs__globals__set_option_4_p_0((MR_Integer) 164, (MR_Word) (MR_mkword(MR_mktag(1), &parse_tree__write_module_interface_files_scalar_common_2[1])), NoLineNumGlobals0_81, &NoLineNumGlobals_21);
...
{
  {
    ...
    libs__globals__set_option_4_p_0((MR_Integer) 163, (MR_Word) (MR_mkword(MR_mktag(1), &parse_tree__write_module_interface_files_scalar_common_2[1])), Globals_3, &NoLineNumGlobals0_5);
    libs__globals__set_option_4_p_0((MR_Integer) 164, (MR_Word) (MR_mkword(MR_mktag(1), &parse_tree__write_module_interface_files_scalar_common_2[1])), NoLineNumGlobals0_5, NoLineNumGlobals_4);
  }
}
...
{
  {
    ...
    libs__globals__set_option_4_p_0((MR_Integer) 163, (MR_Word) (MR_mkword(MR_mktag(1), &parse_tree__write_module_interface_files_scalar_common_2[1])), Globals_12, &NoLineNumGlobals0_90);
    libs__globals__set_option_4_p_0((MR_Integer) 164, (MR_Word) (MR_mkword(MR_mktag(1), &parse_tree__write_module_interface_files_scalar_common_2[1])), NoLineNumGlobals0_90, &NoLineNumGlobals_21);
...
{
  {
    ...
    TmpOutputFileName_20 = mercury__string__f_43_43_2_f_0(OutputFileName_19, (MR_String) ".tmp");
    libs__globals__set_option_4_p_0((MR_Integer) 163, (MR_Word) (MR_mkword(MR_mktag(1), &parse_tree__write_module_interface_files_scalar_common_2[1])), Globals_12, &NoLineNumGlobals0_60);
    libs__globals__set_option_4_p_0((MR_Integer) 164, (MR_Word) (MR_mkword(MR_mktag(1), &parse_tree__write_module_interface_files_scalar_common_2[1])), NoLineNumGlobals0_60, &NoLineNumGlobals_21);
