  ...
  MR_Word * STATE_VARIABLE_HaveReadModuleMaps_44)
{
  ...
  if (succeeded)
  {
    ...
    if ((EffectiveGetQualSpecs_32 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      ...
      parse_tree__module_cmds__touch_interface_datestamp_8_p_0(Globals_15, ProgressStream_13, ErrorStream_14, ModuleName_23, (MR_Word) (&parse_tree__write_module_interface_files_scalar_common_1[4]), &TouchSucceeded_39);
      {
  ...
  MR_Word * Succeeded_16)
{
  ...
  libs__globals__set_option_4_p_0((MR_Integer) 174, (MR_Word) (MR_mkword(1, &parse_tree__write_module_interface_files_scalar_common_1[3])), Globals_12, &NoLineNumGlobals0_62);
  libs__globals__set_option_4_p_0((MR_Integer) 175, (MR_Word) (MR_mkword(1, &parse_tree__write_module_interface_files_scalar_common_1[3])), NoLineNumGlobals0_62, &NoLineNumGlobals_21);
  libs__globals__lookup_bool_option_3_p_0(NoLineNumGlobals_21, (MR_Integer) 154, &GenerateVersionNumbers_100);
  ...
  MR_Word * Succeeded_16)
{
  ...
  TmpOutputFileName_20 = mercury__string__f_43_43_2_f_0(OutputFileName_19, (MR_String) ".tmp");
  libs__globals__set_option_4_p_0((MR_Integer) 174, (MR_Word) (MR_mkword(1, &parse_tree__write_module_interface_files_scalar_common_1[3])), Globals_12, &NoLineNumGlobals0_72);
  libs__globals__set_option_4_p_0((MR_Integer) 175, (MR_Word) (MR_mkword(1, &parse_tree__write_module_interface_files_scalar_common_1[3])), NoLineNumGlobals0_72, &NoLineNumGlobals_21);
  ...
  MR_Word * STATE_VARIABLE_HaveReadModuleMaps_41)
{
  ...
  if (succeeded)
  {
    ...
    if ((EffectiveGetQualSpecs_31 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      ...
      parse_tree__module_cmds__touch_interface_datestamp_8_p_0(Globals_15, ProgressStream_13, ErrorStream_14, ModuleName_23, (MR_Word) (&parse_tree__write_module_interface_files_scalar_common_1[2]), &TouchSucceeded_36);
  ...
  MR_Word * Succeeded_16)
{
  ...
  TmpOutputFileName_20 = mercury__string__f_43_43_2_f_0(OutputFileName_19, (MR_String) ".tmp");
  libs__globals__set_option_4_p_0((MR_Integer) 174, (MR_Word) (MR_mkword(1, &parse_tree__write_module_interface_files_scalar_common_1[3])), Globals_12, &NoLineNumGlobals0_80);
  libs__globals__set_option_4_p_0((MR_Integer) 175, (MR_Word) (MR_mkword(1, &parse_tree__write_module_interface_files_scalar_common_1[3])), NoLineNumGlobals0_80, &NoLineNumGlobals_21);
    ...
    case (MR_Integer) 0:
      {
        ...
        libs__globals__set_option_4_p_0((MR_Integer) 174, (MR_Word) (MR_mkword(1, &parse_tree__write_module_interface_files_scalar_common_1[3])), Globals_10, &NoLineNumGlobals0_91);
        libs__globals__set_option_4_p_0((MR_Integer) 175, (MR_Word) (MR_mkword(1, &parse_tree__write_module_interface_files_scalar_common_1[3])), NoLineNumGlobals0_91, &NoLineNumGlobals_71);
        ...
        parse_tree__module_cmds__touch_interface_datestamp_8_p_0(Globals_10, ProgressStream_8, ErrorStream_9, ModuleName_18, (MR_Word) (&parse_tree__write_module_interface_files_scalar_common_1[0]), &TouchSucceeded_20);
