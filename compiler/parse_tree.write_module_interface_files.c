  ...
  MR_Word * Succeeded_16)
{
  ...
  TmpOutputFileName_20 = mercury__string__f_43_43_2_f_0(OutputFileName_19, (MR_String) ".tmp");
  libs__globals__set_option_4_p_0((MR_Integer) 173, (MR_Word) (MR_mkword(MR_mktag(1), &parse_tree__write_module_interface_files_scalar_common_2[1])), Globals_12, &NoLineNumGlobals0_47);
  libs__globals__set_option_4_p_0((MR_Integer) 174, (MR_Word) (MR_mkword(MR_mktag(1), &parse_tree__write_module_interface_files_scalar_common_2[1])), NoLineNumGlobals0_47, &NoLineNumGlobals_21);
