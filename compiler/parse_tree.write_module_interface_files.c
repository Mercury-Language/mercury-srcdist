  ...
  MR_Word * Succeeded_16)
{
  ...
  libs__globals__set_option_4_p_0((MR_Integer) 173, (MR_Word) (MR_mkword(MR_mktag(1), &parse_tree__write_module_interface_files_scalar_common_2[1])), Globals_12, &NoLineNumGlobals0_80);
  libs__globals__set_option_4_p_0((MR_Integer) 174, (MR_Word) (MR_mkword(MR_mktag(1), &parse_tree__write_module_interface_files_scalar_common_2[1])), NoLineNumGlobals0_80, &NoLineNumGlobals_21);
  ...
  MR_Word * MaybeVersionNumbers_10)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(NoLineNumGlobals_7, (MR_Integer) 153, &GenerateVersionNumbers_52);
  ...
  MR_Word * MaybeVersionNumbers_10)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(NoLineNumGlobals_7, (MR_Integer) 153, &GenerateVersionNumbers_59);
  ...
  MR_Word * NoLineNumGlobals_4)
{
  ...
  libs__globals__set_option_4_p_0((MR_Integer) 173, (MR_Word) (MR_mkword(MR_mktag(1), &parse_tree__write_module_interface_files_scalar_common_2[1])), Globals_3, &NoLineNumGlobals0_5);
  libs__globals__set_option_4_p_0((MR_Integer) 174, (MR_Word) (MR_mkword(MR_mktag(1), &parse_tree__write_module_interface_files_scalar_common_2[1])), NoLineNumGlobals0_5, NoLineNumGlobals_4);
}
  ...
  MR_Word * Succeeded_16)
{
  ...
  libs__globals__set_option_4_p_0((MR_Integer) 173, (MR_Word) (MR_mkword(MR_mktag(1), &parse_tree__write_module_interface_files_scalar_common_2[1])), Globals_12, &NoLineNumGlobals0_89);
  libs__globals__set_option_4_p_0((MR_Integer) 174, (MR_Word) (MR_mkword(MR_mktag(1), &parse_tree__write_module_interface_files_scalar_common_2[1])), NoLineNumGlobals0_89, &NoLineNumGlobals_21);
  ...
  MR_Word * MaybeVersionNumbers_10)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(NoLineNumGlobals_7, (MR_Integer) 153, &GenerateVersionNumbers_65);
  ...
  MR_Word * Succeeded_16)
{
  ...
  TmpOutputFileName_20 = mercury__string__f_43_43_2_f_0(OutputFileName_19, (MR_String) ".tmp");
  libs__globals__set_option_4_p_0((MR_Integer) 173, (MR_Word) (MR_mkword(MR_mktag(1), &parse_tree__write_module_interface_files_scalar_common_2[1])), Globals_12, &NoLineNumGlobals0_59);
  libs__globals__set_option_4_p_0((MR_Integer) 174, (MR_Word) (MR_mkword(MR_mktag(1), &parse_tree__write_module_interface_files_scalar_common_2[1])), NoLineNumGlobals0_59, &NoLineNumGlobals_21);
