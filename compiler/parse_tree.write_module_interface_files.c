...
{
  {
    ...
    if (succeeded)
    {
      ...
      if ((QualSpecs_35 == (MR_Word) ((MR_Unsigned) 0U)))
      {
        ...
        parse_tree__comp_unit_interface__generate_interfaces_int1_int2_5_p_0(AugCompUnit_27, &ParseTreeInt1_36, &ParseTreeInt2_37, (MR_Word) ((MR_Unsigned) 0U), &GenerateSpecs0_38);
        ...
        {
          parse_tree__write_module_interface_files__actually_write_interface_file1_6_p_0(Globals_10, ParseTreeInt1_36, (MR_String) "", MaybeTimestamp_13);
          parse_tree__write_module_interface_files__actually_write_interface_file2_6_p_0(Globals_10, ParseTreeInt2_37, (MR_String) "", MaybeTimestamp_13);
...
{
  {
    ...
    libs__globals__set_option_4_p_0((MR_Integer) 157, Var_78, Globals_7, &NoLineNumGlobals0_76);
    libs__globals__set_option_4_p_0((MR_Integer) 158, Var_78, NoLineNumGlobals0_76, &NoLineNumGlobals_15);
...
{
  {
    ...
    if (succeeded)
    {
      ...
      if ((QualSpecs_34 == (MR_Word) ((MR_Unsigned) 0U)))
      {
        ...
        {
          parse_tree__write_module_interface_files__actually_write_interface_file0_6_p_0(Globals_10, ParseTreeInt0_35, (MR_String) "", MaybeTimestamp_13);
...
{
  {
    ...
    libs__globals__set_option_4_p_0((MR_Integer) 157, Var_7, Globals_3, &NoLineNumGlobals0_5);
    libs__globals__set_option_4_p_0((MR_Integer) 158, Var_7, NoLineNumGlobals0_5, NoLineNumGlobals_4);
  }
}
...
{
  {
    ...
    parse_tree__error_util__filter_interface_generation_specs_3_p_0(Globals_6, Specs0_14, &Specs_15);
    ...
    switch (EffectivelyErrors_16) {
      ...
      case (MR_Integer) 0:
        {
          MR_Word ModuleName_36 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ParseTreeInt3_13, (MR_Integer) 0))));
          MR_String OutputFileName_37;
          MR_String TmpOutputFileName_38;
          MR_Word NoLineNumGlobals_39;
          MR_String Suffix_64;
          MR_String OutputFileName0_65;
          MR_Word NoLineNumGlobals0_71;
          MR_Word Var_73;

          Suffix_64 = parse_tree__file_kind__int_file_kind_to_extension_1_f_0((MR_Integer) 3);
          parse_tree__file_names__module_name_to_file_name_7_p_0(Globals_6, (MR_Integer) 0, Suffix_64, ModuleName_36, &OutputFileName0_65);
          OutputFileName_37 = mercury__string__f_43_43_2_f_0(OutputFileName0_65, (MR_String) "");
          TmpOutputFileName_38 = mercury__string__f_43_43_2_f_0(OutputFileName_37, (MR_String) ".tmp");
          Var_73 = (MR_Word) (MR_mkword(MR_mktag(1), &parse_tree__write_module_interface_files_scalar_common_2[0]));
          libs__globals__set_option_4_p_0((MR_Integer) 157, Var_73, Globals_6, &NoLineNumGlobals0_71);
          libs__globals__set_option_4_p_0((MR_Integer) 158, Var_73, NoLineNumGlobals0_71, &NoLineNumGlobals_39);
          parse_tree__parse_tree_out__output_parse_tree_int3_5_p_0(NoLineNumGlobals_39, TmpOutputFileName_38, ParseTreeInt3_13);
          parse_tree__module_cmds__update_interface_4_p_0(Globals_6, OutputFileName_37);
