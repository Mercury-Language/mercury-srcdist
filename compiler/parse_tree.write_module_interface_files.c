...
{
  {
    ...
    succeeded = (GetSpecs_20 == (MR_Word) ((MR_Unsigned) 0U));
    if (succeeded)
    {
      TypeCtorInfo_73_73 = (MR_Word) (&parse_tree__parse_error__parse_tree__parse_error__type_ctor_info_read_module_error_0);
      succeeded = mercury__set__is_empty_1_p_0(TypeCtorInfo_73_73, GetErrors_21);
    }
    if (succeeded)
    {
      ...
      Var_44 = mercury__map__init_0_f_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&parse_tree__prog_data_event__parse_tree__prog_data_event__type_ctor_info_event_spec_0));
      parse_tree__module_qual__module_qualify_aug_comp_unit_13_p_0(Globals_8, AugCompUnit1_19, &AugCompUnit_22, Var_44, &Var_23, (MR_String) "", &Var_24, &Var_25, &Var_26, &Var_27, &Var_28, (MR_Word) ((MR_Unsigned) 0U), &QualSpecs_29);
      if ((QualSpecs_29 == (MR_Word) ((MR_Unsigned) 0U)))
      {
        MR_Word ParseTreeInt1_30;
        MR_Word ParseTreeInt2_31;
        MR_Word Specs_32;

        parse_tree__comp_unit_interface__generate_interfaces_int1_int2_6_p_0(Globals_8, AugCompUnit_22, &ParseTreeInt1_30, &ParseTreeInt2_31, (MR_Word) ((MR_Unsigned) 0U), &Specs_32);
        if ((Specs_32 == (MR_Word) ((MR_Unsigned) 0U)))
        {
          MR_Word Experiment2_33;

          parse_tree__write_module_interface_files__actually_write_interface_file_6_p_0(Globals_8, ParseTreeInt1_30, (MR_String) "", MaybeTimestamp_11);
          parse_tree__write_module_interface_files__actually_write_interface_file_6_p_0(Globals_8, ParseTreeInt2_31, (MR_String) "", MaybeTimestamp_11);
          libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 697, &Experiment2_33);
          switch (Experiment2_33) {
            ...
            case (MR_Integer) 1:
              {
                MR_Word ParseTreeInt23_34;
                MR_Word _Specs_35;

                parse_tree__comp_unit_interface__generate_interface_int2_via_int3_5_p_0(Globals_8, AugCompUnit_22, &ParseTreeInt23_34, (MR_Word) ((MR_Unsigned) 0U), &_Specs_35);
                parse_tree__write_module_interface_files__actually_write_interface_file_6_p_0(Globals_8, ParseTreeInt23_34, (MR_String) ".via3", MaybeTimestamp_11);
              }
              break;
          }
          ...
          parse_tree__write_module_interface_files__report_file_not_written_8_p_0(Globals_8, Specs_32, (MR_Word) ((MR_Unsigned) 0U), ModuleName_14, (MR_String) ".int", (MR_Word) (MR_mkword(MR_mktag(1), &parse_tree__write_module_interface_files_scalar_common_2[3])));
      }
      else
        parse_tree__write_module_interface_files__report_file_not_written_8_p_0(Globals_8, QualSpecs_29, (MR_Word) ((MR_Unsigned) 0U), ModuleName_14, (MR_String) ".int", (MR_Word) (MR_mkword(MR_mktag(1), &parse_tree__write_module_interface_files_scalar_common_2[3])));
    }
    else
...
{
  {
    ...
    succeeded = (GetSpecs_19 == (MR_Word) ((MR_Unsigned) 0U));
    if (succeeded)
    {
      TypeCtorInfo_59_59 = (MR_Word) (&parse_tree__parse_error__parse_tree__parse_error__type_ctor_info_read_module_error_0);
      succeeded = mercury__set__is_empty_1_p_0(TypeCtorInfo_59_59, GetErrors_20);
    }
    if (succeeded)
    {
      MR_Word AugCompUnit_21;
      MR_Word QualSpecs_28;
      MR_Word Var_39;
      MR_Word _EventSpecMap_22;
      MR_Word Var_23;
      MR_Word Var_24;
      MR_Word Var_25;
      MR_Word Var_26;
      ...
      Var_39 = mercury__map__init_0_f_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&parse_tree__prog_data_event__parse_tree__prog_data_event__type_ctor_info_event_spec_0));
      parse_tree__module_qual__module_qualify_aug_comp_unit_13_p_0(Globals_8, AugCompUnit1_18, &AugCompUnit_21, Var_39, &_EventSpecMap_22, (MR_String) "", &Var_23, &Var_24, &Var_25, &Var_26, &Var_27, (MR_Word) ((MR_Unsigned) 0U), &QualSpecs_28);
      if ((QualSpecs_28 == (MR_Word) ((MR_Unsigned) 0U)))
      {
        MR_Word ParseTreeInt0_29;
        MR_Word Specs_30;

        parse_tree__comp_unit_interface__generate_private_interface_int0_4_p_0(AugCompUnit_21, &ParseTreeInt0_29, (MR_Word) ((MR_Unsigned) 0U), &Specs_30);
        if ((Specs_30 == (MR_Word) ((MR_Unsigned) 0U)))
        {
          parse_tree__write_module_interface_files__actually_write_interface_file_6_p_0(Globals_8, ParseTreeInt0_29, (MR_String) "", MaybeTimestamp_11);
          parse_tree__module_cmds__touch_interface_datestamp_5_p_0(Globals_8, ModuleName_14, (MR_String) ".date0");
        }
        else
          parse_tree__write_module_interface_files__report_file_not_written_8_p_0(Globals_8, Specs_30, (MR_Word) ((MR_Unsigned) 0U), ModuleName_14, (MR_String) ".int0", (MR_Word) ((MR_Unsigned) 0U));
      }
      else
        parse_tree__write_module_interface_files__report_file_not_written_8_p_0(Globals_8, QualSpecs_28, (MR_Word) ((MR_Unsigned) 0U), ModuleName_14, (MR_String) ".int0", (MR_Word) ((MR_Unsigned) 0U));
    }
    else
