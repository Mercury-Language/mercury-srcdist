...
{
  MR_bool succeeded;
  MR_Word GenerateVersionNumbers_44;
  MR_Word DisableVersionNumbers_45;

  libs__globals__lookup_bool_option_3_p_0(NoLineNumGlobals_7, (MR_Integer) 150, &GenerateVersionNumbers_44);
  libs__globals__io_get_disable_generate_item_version_numbers_3_p_0(&DisableVersionNumbers_45);
  succeeded = (GenerateVersionNumbers_44 == (MR_Integer) 1);
  if (succeeded)
    succeeded = (DisableVersionNumbers_45 == (MR_Integer) 0);
  if (succeeded)
  {
    ...
    MR_Word OldModuleErrors_18;
    MR_Word MaybeOldParseTreeInt2_19;
      ...
      Timestamp_14 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MaybeTimestamp_9, (MR_Integer) 0))));
    {
      ...
      MR_hl_field(MR_mktag(2), Var_24, 0) = ((MR_Box) (ModuleName_13));
    }
    parse_tree__read_modules__read_module_int2_12_p_0(NoLineNumGlobals_7, Var_24, (MR_Integer) 0, (MR_Integer) 0, ModuleName_13, &_OldIntFileName_15, (MR_Word) (&parse_tree__write_module_interface_files_scalar_common_2[2]), &_OldTimestamp_16, &OldParseTreeInt2_17, &OldModuleErrors_18);
    succeeded = parse_tree__parse_error__there_are_no_errors_1_p_0(OldModuleErrors_18);
    if (succeeded)
      {
        MaybeOldParseTreeInt2_19 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), MaybeOldParseTreeInt2_19, 0) = ((MR_Box) (OldParseTreeInt2_17));
      }
    else
      MaybeOldParseTreeInt2_19 = (MR_Word) ((MR_Unsigned) 0U);
    recompilation__version__compute_version_numbers_int2_4_p_0(MaybeOldParseTreeInt2_19, Timestamp_14, ParseTreeInt2_8, &VersionNumbers_20);
    {
      MR_Word base;
      base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
      *MaybeVersionNumbers_10 = base;
      MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (VersionNumbers_20));
    }
  }
  else
  ...
  MR_Word * MaybeVersionNumbers_10)
{
  ...
  if (succeeded)
  {
    ...
    MR_Word OldModuleErrors_18;
    MR_Word MaybeOldParseTreeInt1_19;
    MR_Word VersionNumbers_20;
    MR_Word Var_24;
    MR_String _OldIntFileName_15;
    MR_Word _OldTimestamp_16;
    ...
    parse_tree__read_modules__read_module_int1_12_p_0(NoLineNumGlobals_7, Var_24, (MR_Integer) 0, (MR_Integer) 0, ModuleName_13, &_OldIntFileName_15, (MR_Word) (&parse_tree__write_module_interface_files_scalar_common_2[2]), &_OldTimestamp_16, &OldParseTreeInt1_17, &OldModuleErrors_18);
    succeeded = parse_tree__parse_error__there_are_no_errors_1_p_0(OldModuleErrors_18);
    if (succeeded)
      {
        MaybeOldParseTreeInt1_19 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), MaybeOldParseTreeInt1_19, 0) = ((MR_Box) (OldParseTreeInt1_17));
      }
    else
      MaybeOldParseTreeInt1_19 = (MR_Word) ((MR_Unsigned) 0U);
    recompilation__version__compute_version_numbers_int1_4_p_0(MaybeOldParseTreeInt1_19, Timestamp_14, ParseTreeInt1_8, &VersionNumbers_20);
    {
      MR_Word base;
      base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
      *MaybeVersionNumbers_10 = base;
  ...
  MR_Word * MaybeVersionNumbers_10)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(NoLineNumGlobals_7, (MR_Integer) 150, &GenerateVersionNumbers_57);
  ...
  if (succeeded)
  {
    ...
    MR_Word OldModuleErrors_18;
    MR_Word MaybeOldParseTreeInt0_19;
    MR_Word VersionNumbers_20;
    MR_Word Var_24;
    MR_String _OldIntFileName_15;
    MR_Word _OldTimestamp_16;
    ...
    parse_tree__read_modules__read_module_int0_12_p_0(NoLineNumGlobals_7, Var_24, (MR_Integer) 0, (MR_Integer) 0, ModuleName_13, &_OldIntFileName_15, (MR_Word) (&parse_tree__write_module_interface_files_scalar_common_2[2]), &_OldTimestamp_16, &OldParseTreeInt0_17, &OldModuleErrors_18);
    succeeded = parse_tree__parse_error__there_are_no_errors_1_p_0(OldModuleErrors_18);
    if (succeeded)
      {
        MaybeOldParseTreeInt0_19 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), MaybeOldParseTreeInt0_19, 0) = ((MR_Box) (OldParseTreeInt0_17));
      }
    else
      MaybeOldParseTreeInt0_19 = (MR_Word) ((MR_Unsigned) 0U);
    recompilation__version__compute_version_numbers_int0_4_p_0(MaybeOldParseTreeInt0_19, Timestamp_14, ParseTreeInt0_8, &VersionNumbers_20);
    {
      MR_Word base;
      base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
      *MaybeVersionNumbers_10 = base;
