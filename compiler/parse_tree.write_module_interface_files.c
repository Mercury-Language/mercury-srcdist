  ...
  MR_Word * MaybeVersionNumbers_10)
{
  ...
  if (succeeded)
  {
    ...
    parse_tree__read_modules__read_module_int2_10_p_0((MR_Word) ((MR_Unsigned) 0U), NoLineNumGlobals_7, Var_28, (MR_Integer) 0, (MR_Integer) 1, ModuleName_13, (MR_Word) (&parse_tree__write_module_interface_files_scalar_common_1[5]), &HaveReadInt2_16);
  ...
  MR_Word * MaybeVersionNumbers_10)
{
  ...
  if (succeeded)
  {
    ...
    parse_tree__read_modules__read_module_int1_10_p_0((MR_Word) ((MR_Unsigned) 0U), NoLineNumGlobals_7, Var_28, (MR_Integer) 0, (MR_Integer) 1, ModuleName_13, (MR_Word) (&parse_tree__write_module_interface_files_scalar_common_1[5]), &HaveReadInt1_16);
  ...
  MR_Word * MaybeVersionNumbers_10)
{
  ...
  if (succeeded)
  {
    ...
    parse_tree__read_modules__read_module_int0_10_p_0((MR_Word) ((MR_Unsigned) 0U), NoLineNumGlobals_7, Var_28, (MR_Integer) 0, (MR_Integer) 1, ModuleName_13, (MR_Word) (&parse_tree__write_module_interface_files_scalar_common_1[5]), &HaveReadInt0_16);
