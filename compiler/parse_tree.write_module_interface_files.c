  ...
  MR_Word * Succeeded_18)
{
  ...
  MR_Word ParseTreeInt2V_22;
  MR_Word OutputSucceeded_23;
  MR_Word UpdateSucceeded_24;
  MR_Word NoLineNumGlobals0_43;
  MR_Word GenerateVersionNumbers_80;
  MR_Word DisableVersionNumbers_81;
  MR_Word Var_30;
  MR_Word Var_31;
  MR_Word Var_33;
  MR_Word Var_34;
  ...
  libs__globals__set_option_4_p_0((MR_Integer) 175, (MR_Word) (MR_mkword(1, &parse_tree__write_module_interface_files_scalar_common_2[3])), Globals_13, &NoLineNumGlobals0_43);
  libs__globals__set_option_4_p_0((MR_Integer) 176, (MR_Word) (MR_mkword(1, &parse_tree__write_module_interface_files_scalar_common_2[3])), NoLineNumGlobals0_43, &NoLineNumGlobals_20);
  libs__globals__lookup_bool_option_3_p_0(NoLineNumGlobals_20, (MR_Integer) 155, &GenerateVersionNumbers_80);
  libs__globals__io_get_disable_generate_item_version_numbers_3_p_0(&DisableVersionNumbers_81);
  succeeded = (GenerateVersionNumbers_80 == (MR_Integer) 1);
  if (succeeded)
    succeeded = (DisableVersionNumbers_81 == (MR_Integer) 0);
  if (succeeded)
  {
    MR_Word ModuleName_51 = ((MR_Word) ((MR_hl_field(0, ParseTreeInt2_14, (MR_Integer) 0))));
    MR_Word Timestamp_52;
    MR_Word HaveReadInt2_53;
    MR_Word MaybeOldParseTreeInt2_58;
    MR_Word VersionNumbers_61;
    ...
    if ((MaybeTimestamp_17 == (MR_Word) ((MR_Unsigned) 0U)))
      ...
      Timestamp_52 = ((MR_Word) ((MR_hl_field(1, MaybeTimestamp_17, (MR_Integer) 0))));
    parse_tree__read_modules__read_module_int2_10_p_0(ProgressStream_11, NoLineNumGlobals_20, (MR_Integer) 2, (MR_Integer) 0, (MR_Integer) 1, ModuleName_51, (MR_Word) (&parse_tree__write_module_interface_files_scalar_common_2[5]), &HaveReadInt2_53);
    if (((MR_tag((MR_Word) HaveReadInt2_53)) == (MR_Integer) 1))
      MaybeOldParseTreeInt2_58 = (MR_Word) ((MR_Unsigned) 0U);
    else
    {
      MR_Word OldParseTreeInt2_56 = ((MR_Word) ((MR_hl_field(0, HaveReadInt2_53, (MR_Integer) 2))));
      MR_Word OldModuleErrors_57 = ((MR_Word) ((MR_hl_field(0, HaveReadInt2_53, (MR_Integer) 3))));

      succeeded = parse_tree__parse_error__there_are_no_errors_1_p_0(OldModuleErrors_57);
      if (succeeded)
        {
          MaybeOldParseTreeInt2_58 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(1, MaybeOldParseTreeInt2_58, 0) = ((MR_Box) (OldParseTreeInt2_56));
        }
      else
        MaybeOldParseTreeInt2_58 = (MR_Word) ((MR_Unsigned) 0U);
    }
    recompilation__version__compute_version_numbers_int2_4_p_0(MaybeOldParseTreeInt2_58, Timestamp_52, ParseTreeInt2_14, &VersionNumbers_61);
    {
      MaybeVersionNumbers_21 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(1, MaybeVersionNumbers_21, 0) = ((MR_Box) (VersionNumbers_61));
    }
  }
  else
    MaybeVersionNumbers_21 = (MR_Word) ((MR_Unsigned) 0U);
  Var_30 = ((MR_Word) ((MR_hl_field(0, ParseTreeInt2_14, (MR_Integer) 0))));
  Var_31 = ((MR_Word) ((MR_hl_field(0, ParseTreeInt2_14, (MR_Integer) 1))));
  Var_33 = ((MR_Word) ((MR_hl_field(0, ParseTreeInt2_14, (MR_Integer) 3))));
  Var_34 = ((MR_Word) ((MR_hl_field(0, ParseTreeInt2_14, (MR_Integer) 4))));
  Var_35 = ((MR_Word) ((MR_hl_field(0, ParseTreeInt2_14, (MR_Integer) 5))));
  Var_36 = ((MR_Word) ((MR_hl_field(0, ParseTreeInt2_14, (MR_Integer) 6))));
  Var_37 = ((MR_Word) ((MR_hl_field(0, ParseTreeInt2_14, (MR_Integer) 7))));
  Var_38 = ((MR_Word) ((MR_hl_field(0, ParseTreeInt2_14, (MR_Integer) 8))));
  Var_39 = ((MR_Word) ((MR_hl_field(0, ParseTreeInt2_14, (MR_Integer) 9))));
  Var_40 = ((MR_Word) ((MR_hl_field(0, ParseTreeInt2_14, (MR_Integer) 10))));
  Var_41 = ((MR_Word) ((MR_hl_field(0, ParseTreeInt2_14, (MR_Integer) 11))));
  Var_42 = ((MR_Word) ((MR_hl_field(0, ParseTreeInt2_14, (MR_Integer) 12))));
  {
    ParseTreeInt2V_22 = (MR_Word) MR_new_object(MR_Word, (13 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(0, ParseTreeInt2V_22, 0) = ((MR_Box) (Var_30));
    MR_hl_field(0, ParseTreeInt2V_22, 1) = ((MR_Box) (Var_31));
    MR_hl_field(0, ParseTreeInt2V_22, 2) = ((MR_Box) (MaybeVersionNumbers_21));
    MR_hl_field(0, ParseTreeInt2V_22, 3) = ((MR_Box) (Var_33));
    MR_hl_field(0, ParseTreeInt2V_22, 4) = ((MR_Box) (Var_34));
    MR_hl_field(0, ParseTreeInt2V_22, 5) = ((MR_Box) (Var_35));
    MR_hl_field(0, ParseTreeInt2V_22, 6) = ((MR_Box) (Var_36));
    MR_hl_field(0, ParseTreeInt2V_22, 7) = ((MR_Box) (Var_37));
    MR_hl_field(0, ParseTreeInt2V_22, 8) = ((MR_Box) (Var_38));
    MR_hl_field(0, ParseTreeInt2V_22, 9) = ((MR_Box) (Var_39));
    MR_hl_field(0, ParseTreeInt2V_22, 10) = ((MR_Box) (Var_40));
    MR_hl_field(0, ParseTreeInt2V_22, 11) = ((MR_Box) (Var_41));
    MR_hl_field(0, ParseTreeInt2V_22, 12) = ((MR_Box) (Var_42));
  }
  parse_tree__parse_tree_out__output_parse_tree_int2_8_p_0(ProgressStream_11, ErrorStream_12, NoLineNumGlobals_20, TmpFileName_16, ParseTreeInt2V_22, &OutputSucceeded_23);
  parse_tree__module_cmds__copy_dot_tmp_to_base_file_report_any_error_7_p_0(ProgressStream_11, Globals_13, (MR_String) ".int2", FileName_15, &UpdateSucceeded_24);
  *Succeeded_18 = libs__maybe_util__and_2_f_0(OutputSucceeded_23, UpdateSucceeded_24);
}
  ...
  MR_Word * Succeeded_18)
{
  ...
  MR_Word NoLineNumGlobals_20;
  MR_Word MaybeVersionNumbers_21;
  MR_Word ParseTreeInt1V_22;
  MR_Word OutputSucceeded_23;
  MR_Word UpdateSucceeded_24;
  MR_Word NoLineNumGlobals0_49;
  MR_Word GenerateVersionNumbers_92;
  MR_Word DisableVersionNumbers_93;
  MR_Word Var_30;
  MR_Word Var_31;
  MR_Word Var_33;
  MR_Word Var_34;
  ...
  libs__globals__set_option_4_p_0((MR_Integer) 175, (MR_Word) (MR_mkword(1, &parse_tree__write_module_interface_files_scalar_common_2[3])), Globals_13, &NoLineNumGlobals0_49);
  libs__globals__set_option_4_p_0((MR_Integer) 176, (MR_Word) (MR_mkword(1, &parse_tree__write_module_interface_files_scalar_common_2[3])), NoLineNumGlobals0_49, &NoLineNumGlobals_20);
  libs__globals__lookup_bool_option_3_p_0(NoLineNumGlobals_20, (MR_Integer) 155, &GenerateVersionNumbers_92);
  libs__globals__io_get_disable_generate_item_version_numbers_3_p_0(&DisableVersionNumbers_93);
  succeeded = (GenerateVersionNumbers_92 == (MR_Integer) 1);
  if (succeeded)
    succeeded = (DisableVersionNumbers_93 == (MR_Integer) 0);
  if (succeeded)
  {
    MR_Word ModuleName_57 = ((MR_Word) ((MR_hl_field(0, ParseTreeInt1_14, (MR_Integer) 0))));
    MR_Word Timestamp_58;
    MR_Word HaveReadInt1_59;
    MR_Word MaybeOldParseTreeInt1_64;
    MR_Word VersionNumbers_67;
    ...
    if ((MaybeTimestamp_17 == (MR_Word) ((MR_Unsigned) 0U)))
      ...
      Timestamp_58 = ((MR_Word) ((MR_hl_field(1, MaybeTimestamp_17, (MR_Integer) 0))));
    parse_tree__read_modules__read_module_int1_10_p_0(ProgressStream_11, NoLineNumGlobals_20, (MR_Integer) 2, (MR_Integer) 0, (MR_Integer) 1, ModuleName_57, (MR_Word) (&parse_tree__write_module_interface_files_scalar_common_2[5]), &HaveReadInt1_59);
    if (((MR_tag((MR_Word) HaveReadInt1_59)) == (MR_Integer) 1))
      MaybeOldParseTreeInt1_64 = (MR_Word) ((MR_Unsigned) 0U);
    else
    {
      MR_Word OldParseTreeInt1_62 = ((MR_Word) ((MR_hl_field(0, HaveReadInt1_59, (MR_Integer) 2))));
      MR_Word OldModuleErrors_63 = ((MR_Word) ((MR_hl_field(0, HaveReadInt1_59, (MR_Integer) 3))));

      succeeded = parse_tree__parse_error__there_are_no_errors_1_p_0(OldModuleErrors_63);
      if (succeeded)
        {
          MaybeOldParseTreeInt1_64 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(1, MaybeOldParseTreeInt1_64, 0) = ((MR_Box) (OldParseTreeInt1_62));
        }
      else
        MaybeOldParseTreeInt1_64 = (MR_Word) ((MR_Unsigned) 0U);
    }
    recompilation__version__compute_version_numbers_int1_4_p_0(MaybeOldParseTreeInt1_64, Timestamp_58, ParseTreeInt1_14, &VersionNumbers_67);
    {
      MaybeVersionNumbers_21 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(1, MaybeVersionNumbers_21, 0) = ((MR_Box) (VersionNumbers_67));
    }
  }
  else
    MaybeVersionNumbers_21 = (MR_Word) ((MR_Unsigned) 0U);
  Var_30 = ((MR_Word) ((MR_hl_field(0, ParseTreeInt1_14, (MR_Integer) 0))));
  Var_31 = ((MR_Word) ((MR_hl_field(0, ParseTreeInt1_14, (MR_Integer) 1))));
  Var_33 = ((MR_Word) ((MR_hl_field(0, ParseTreeInt1_14, (MR_Integer) 3))));
  Var_34 = ((MR_Word) ((MR_hl_field(0, ParseTreeInt1_14, (MR_Integer) 4))));
  Var_35 = ((MR_Word) ((MR_hl_field(0, ParseTreeInt1_14, (MR_Integer) 5))));
  Var_36 = ((MR_Word) ((MR_hl_field(0, ParseTreeInt1_14, (MR_Integer) 6))));
  Var_37 = ((MR_Word) ((MR_hl_field(0, ParseTreeInt1_14, (MR_Integer) 7))));
  Var_38 = ((MR_Word) ((MR_hl_field(0, ParseTreeInt1_14, (MR_Integer) 8))));
  Var_39 = ((MR_Word) ((MR_hl_field(0, ParseTreeInt1_14, (MR_Integer) 9))));
  Var_40 = ((MR_Word) ((MR_hl_field(0, ParseTreeInt1_14, (MR_Integer) 10))));
  Var_41 = ((MR_Word) ((MR_hl_field(0, ParseTreeInt1_14, (MR_Integer) 11))));
  Var_42 = ((MR_Word) ((MR_hl_field(0, ParseTreeInt1_14, (MR_Integer) 12))));
  Var_43 = ((MR_Word) ((MR_hl_field(0, ParseTreeInt1_14, (MR_Integer) 13))));
  Var_44 = ((MR_Word) ((MR_hl_field(0, ParseTreeInt1_14, (MR_Integer) 14))));
  Var_45 = ((MR_Word) ((MR_hl_field(0, ParseTreeInt1_14, (MR_Integer) 15))));
  Var_46 = ((MR_Word) ((MR_hl_field(0, ParseTreeInt1_14, (MR_Integer) 16))));
  Var_47 = ((MR_Word) ((MR_hl_field(0, ParseTreeInt1_14, (MR_Integer) 17))));
  Var_48 = ((MR_Word) ((MR_hl_field(0, ParseTreeInt1_14, (MR_Integer) 18))));
  {
    ParseTreeInt1V_22 = (MR_Word) MR_new_object(MR_Word, (19 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(0, ParseTreeInt1V_22, 0) = ((MR_Box) (Var_30));
    MR_hl_field(0, ParseTreeInt1V_22, 1) = ((MR_Box) (Var_31));
    MR_hl_field(0, ParseTreeInt1V_22, 2) = ((MR_Box) (MaybeVersionNumbers_21));
    MR_hl_field(0, ParseTreeInt1V_22, 3) = ((MR_Box) (Var_33));
    MR_hl_field(0, ParseTreeInt1V_22, 4) = ((MR_Box) (Var_34));
    MR_hl_field(0, ParseTreeInt1V_22, 5) = ((MR_Box) (Var_35));
    MR_hl_field(0, ParseTreeInt1V_22, 6) = ((MR_Box) (Var_36));
    MR_hl_field(0, ParseTreeInt1V_22, 7) = ((MR_Box) (Var_37));
    MR_hl_field(0, ParseTreeInt1V_22, 8) = ((MR_Box) (Var_38));
    MR_hl_field(0, ParseTreeInt1V_22, 9) = ((MR_Box) (Var_39));
    MR_hl_field(0, ParseTreeInt1V_22, 10) = ((MR_Box) (Var_40));
    MR_hl_field(0, ParseTreeInt1V_22, 11) = ((MR_Box) (Var_41));
    MR_hl_field(0, ParseTreeInt1V_22, 12) = ((MR_Box) (Var_42));
    MR_hl_field(0, ParseTreeInt1V_22, 13) = ((MR_Box) (Var_43));
    MR_hl_field(0, ParseTreeInt1V_22, 14) = ((MR_Box) (Var_44));
    MR_hl_field(0, ParseTreeInt1V_22, 15) = ((MR_Box) (Var_45));
    MR_hl_field(0, ParseTreeInt1V_22, 16) = ((MR_Box) (Var_46));
    MR_hl_field(0, ParseTreeInt1V_22, 17) = ((MR_Box) (Var_47));
    MR_hl_field(0, ParseTreeInt1V_22, 18) = ((MR_Box) (Var_48));
  }
  parse_tree__parse_tree_out__output_parse_tree_int1_8_p_0(ProgressStream_11, ErrorStream_12, NoLineNumGlobals_20, TmpFileName_16, ParseTreeInt1V_22, &OutputSucceeded_23);
  parse_tree__module_cmds__copy_dot_tmp_to_base_file_report_any_error_7_p_0(ProgressStream_11, Globals_13, (MR_String) ".int", FileName_15, &UpdateSucceeded_24);
  *Succeeded_18 = libs__maybe_util__and_2_f_0(OutputSucceeded_23, UpdateSucceeded_24);
}
  ...
  MR_Word * Succeeded_18)
{
  MR_Word NoLineNumGlobals_20;
  MR_Word MaybeVersionNumbers_21;
  MR_Word ParseTreeInt0V_22;
  MR_Word OutputSucceeded_23;
  MR_Word UpdateSucceeded_24;
  MR_Word NoLineNumGlobals0_54;
  MR_Word Var_30;
  MR_Word Var_31;
  MR_Word Var_33;
  MR_Word Var_34;
  ...
  libs__globals__set_option_4_p_0((MR_Integer) 175, (MR_Word) (MR_mkword(1, &parse_tree__write_module_interface_files_scalar_common_2[3])), Globals_13, &NoLineNumGlobals0_54);
  libs__globals__set_option_4_p_0((MR_Integer) 176, (MR_Word) (MR_mkword(1, &parse_tree__write_module_interface_files_scalar_common_2[3])), NoLineNumGlobals0_54, &NoLineNumGlobals_20);
  parse_tree__write_module_interface_files__maybe_read_old_int0_and_compare_for_smart_recomp_7_p_0(ProgressStream_11, NoLineNumGlobals_20, ParseTreeInt0_14, MaybeTimestamp_17, &MaybeVersionNumbers_21);
  Var_30 = ((MR_Word) ((MR_hl_field(0, ParseTreeInt0_14, (MR_Integer) 0))));
  Var_31 = ((MR_Word) ((MR_hl_field(0, ParseTreeInt0_14, (MR_Integer) 1))));
  Var_33 = ((MR_Word) ((MR_hl_field(0, ParseTreeInt0_14, (MR_Integer) 3))));
  Var_34 = ((MR_Word) ((MR_hl_field(0, ParseTreeInt0_14, (MR_Integer) 4))));
  Var_35 = ((MR_Word) ((MR_hl_field(0, ParseTreeInt0_14, (MR_Integer) 5))));
  Var_36 = ((MR_Word) ((MR_hl_field(0, ParseTreeInt0_14, (MR_Integer) 6))));
  Var_37 = ((MR_Word) ((MR_hl_field(0, ParseTreeInt0_14, (MR_Integer) 7))));
  Var_38 = ((MR_Word) ((MR_hl_field(0, ParseTreeInt0_14, (MR_Integer) 8))));
  Var_39 = ((MR_Word) ((MR_hl_field(0, ParseTreeInt0_14, (MR_Integer) 9))));
  Var_40 = ((MR_Word) ((MR_hl_field(0, ParseTreeInt0_14, (MR_Integer) 10))));
  Var_41 = ((MR_Word) ((MR_hl_field(0, ParseTreeInt0_14, (MR_Integer) 11))));
  Var_42 = ((MR_Word) ((MR_hl_field(0, ParseTreeInt0_14, (MR_Integer) 12))));
  Var_43 = ((MR_Word) ((MR_hl_field(0, ParseTreeInt0_14, (MR_Integer) 13))));
  Var_44 = ((MR_Word) ((MR_hl_field(0, ParseTreeInt0_14, (MR_Integer) 14))));
  Var_45 = ((MR_Word) ((MR_hl_field(0, ParseTreeInt0_14, (MR_Integer) 15))));
  Var_46 = ((MR_Word) ((MR_hl_field(0, ParseTreeInt0_14, (MR_Integer) 16))));
  Var_47 = ((MR_Word) ((MR_hl_field(0, ParseTreeInt0_14, (MR_Integer) 17))));
  Var_48 = ((MR_Word) ((MR_hl_field(0, ParseTreeInt0_14, (MR_Integer) 18))));
  Var_49 = ((MR_Word) ((MR_hl_field(0, ParseTreeInt0_14, (MR_Integer) 19))));
  Var_50 = ((MR_Word) ((MR_hl_field(0, ParseTreeInt0_14, (MR_Integer) 20))));
  Var_51 = ((MR_Word) ((MR_hl_field(0, ParseTreeInt0_14, (MR_Integer) 21))));
  Var_52 = ((MR_Word) ((MR_hl_field(0, ParseTreeInt0_14, (MR_Integer) 22))));
  Var_53 = ((MR_Word) ((MR_hl_field(0, ParseTreeInt0_14, (MR_Integer) 23))));
  {
    ParseTreeInt0V_22 = (MR_Word) MR_new_object(MR_Word, (24 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(0, ParseTreeInt0V_22, 0) = ((MR_Box) (Var_30));
    MR_hl_field(0, ParseTreeInt0V_22, 1) = ((MR_Box) (Var_31));
    MR_hl_field(0, ParseTreeInt0V_22, 2) = ((MR_Box) (MaybeVersionNumbers_21));
    MR_hl_field(0, ParseTreeInt0V_22, 3) = ((MR_Box) (Var_33));
    MR_hl_field(0, ParseTreeInt0V_22, 4) = ((MR_Box) (Var_34));
    MR_hl_field(0, ParseTreeInt0V_22, 5) = ((MR_Box) (Var_35));
    MR_hl_field(0, ParseTreeInt0V_22, 6) = ((MR_Box) (Var_36));
    MR_hl_field(0, ParseTreeInt0V_22, 7) = ((MR_Box) (Var_37));
    MR_hl_field(0, ParseTreeInt0V_22, 8) = ((MR_Box) (Var_38));
    MR_hl_field(0, ParseTreeInt0V_22, 9) = ((MR_Box) (Var_39));
    MR_hl_field(0, ParseTreeInt0V_22, 10) = ((MR_Box) (Var_40));
    MR_hl_field(0, ParseTreeInt0V_22, 11) = ((MR_Box) (Var_41));
    MR_hl_field(0, ParseTreeInt0V_22, 12) = ((MR_Box) (Var_42));
    MR_hl_field(0, ParseTreeInt0V_22, 13) = ((MR_Box) (Var_43));
    MR_hl_field(0, ParseTreeInt0V_22, 14) = ((MR_Box) (Var_44));
    MR_hl_field(0, ParseTreeInt0V_22, 15) = ((MR_Box) (Var_45));
    MR_hl_field(0, ParseTreeInt0V_22, 16) = ((MR_Box) (Var_46));
    MR_hl_field(0, ParseTreeInt0V_22, 17) = ((MR_Box) (Var_47));
    MR_hl_field(0, ParseTreeInt0V_22, 18) = ((MR_Box) (Var_48));
    MR_hl_field(0, ParseTreeInt0V_22, 19) = ((MR_Box) (Var_49));
    MR_hl_field(0, ParseTreeInt0V_22, 20) = ((MR_Box) (Var_50));
    MR_hl_field(0, ParseTreeInt0V_22, 21) = ((MR_Box) (Var_51));
    MR_hl_field(0, ParseTreeInt0V_22, 22) = ((MR_Box) (Var_52));
    MR_hl_field(0, ParseTreeInt0V_22, 23) = ((MR_Box) (Var_53));
  }
  parse_tree__parse_tree_out__output_parse_tree_int0_8_p_0(ProgressStream_11, ErrorStream_12, NoLineNumGlobals_20, TmpFileName_16, ParseTreeInt0V_22, &OutputSucceeded_23);
  parse_tree__module_cmds__copy_dot_tmp_to_base_file_report_any_error_7_p_0(ProgressStream_11, Globals_13, (MR_String) ".int0", FileName_15, &UpdateSucceeded_24);
  *Succeeded_18 = libs__maybe_util__and_2_f_0(OutputSucceeded_23, UpdateSucceeded_24);
}
  ...
  MR_Word * Succeeded_18)
{
  ...
  MR_Word NoLineNumGlobals0_27;

  libs__globals__set_option_4_p_0((MR_Integer) 175, (MR_Word) (MR_mkword(1, &parse_tree__write_module_interface_files_scalar_common_2[3])), Globals_13, &NoLineNumGlobals0_27);
  libs__globals__set_option_4_p_0((MR_Integer) 176, (MR_Word) (MR_mkword(1, &parse_tree__write_module_interface_files_scalar_common_2[3])), NoLineNumGlobals0_27, &NoLineNumGlobals_20);
  parse_tree__parse_tree_out__output_parse_tree_int3_8_p_0(ProgressStream_11, ErrorStream_12, NoLineNumGlobals_20, TmpFileName_16, ParseTreeInt3_14, &OutputSucceeded_21);
  parse_tree__module_cmds__copy_dot_tmp_to_base_file_report_any_error_7_p_0(ProgressStream_11, Globals_13, (MR_String) ".int3", FileName_15, &UpdateSucceeded_22);
  *Succeeded_18 = libs__maybe_util__and_2_f_0(OutputSucceeded_21, UpdateSucceeded_22);
}
