    ...
    case (MR_Integer) 0:
      {
        ...
        MR_Word ModuleName_69 = ((MR_Word) ((MR_hl_field(0, ParseTreeInt3_14, (MR_Integer) 0))));
        MR_String OutputFileName_70;
        MR_String TmpOutputFileName_71;
        MR_Word NoLineNumGlobals_72;
        MR_Word OutputSucceeded_73;
        MR_Word UpdateSucceeded_74;
        MR_Word Ext_89;
        MR_String OutputFileName0_90;
        MR_Word NoLineNumGlobals0_93;
        MR_String _ExtStr_88;

        parse_tree__file_kind__int_file_kind_to_extension_3_p_0((MR_Integer) 3, &_ExtStr_88, &Ext_89);
        parse_tree__file_names__module_name_to_file_name_create_dirs_7_p_0(Globals_10, (MR_String) "predicate \140parse_tree.write_module_interface_files.construct_int_file_name\'/8", Ext_89, ModuleName_69, &OutputFileName0_90);
        OutputFileName_70 = mercury__string__f_43_43_2_f_0(OutputFileName0_90, (MR_String) "");
        TmpOutputFileName_71 = mercury__string__f_43_43_2_f_0(OutputFileName_70, (MR_String) ".tmp");
        libs__globals__set_option_4_p_0((MR_Integer) 174, (MR_Word) (MR_mkword(1, &parse_tree__write_module_interface_files_scalar_common_1[3])), Globals_10, &NoLineNumGlobals0_93);
        libs__globals__set_option_4_p_0((MR_Integer) 175, (MR_Word) (MR_mkword(1, &parse_tree__write_module_interface_files_scalar_common_1[3])), NoLineNumGlobals0_93, &NoLineNumGlobals_72);
        parse_tree__parse_tree_out__output_parse_tree_int3_8_p_0(ProgressStream_8, ErrorStream_9, NoLineNumGlobals_72, TmpOutputFileName_71, ParseTreeInt3_14, &OutputSucceeded_73);
        parse_tree__module_cmds__copy_dot_tmp_to_base_file_report_any_error_7_p_0(Globals_10, (MR_String) ".int3", ModuleName_69, OutputFileName_70, &UpdateSucceeded_74);
        OutputSucceeded_19 = libs__maybe_util__and_2_f_0(OutputSucceeded_73, UpdateSucceeded_74);
