...
static void MR_CALL 
parse_tree__write_module_interface_files__IntroducedFrom__pred__strip_unnecessary_impl_defns__717__1_3_p_0(
...
static /* final */ const MR_Box parse_tree__write_module_interface_files_scalar_common_1[8][2];
...
static /* final */ const MR_Box parse_tree__write_module_interface_files_scalar_common_4[2][1];
...
{
  {
    ...
    else
    {
      ...
      parse_tree__error_util__write_error_specs_8_p_0(STATE_VARIABLE_Specs_96_96, NoHaltAtWarnGlobals_39, (MR_Integer) 0, &_NumWarnings_144, (MR_Integer) 0, &NumErrors_40);
      succeeded = (NumErrors_40 > (MR_Integer) 0);
      if (succeeded)
      {
        MR_Word Var_107;
        MR_Word Var_110;
        MR_String IntFileName_145;

        parse_tree__file_names__module_name_to_file_name_7_p_0(Globals_8, (MR_Integer) 1, (MR_String) ".int", ModuleName_14, &IntFileName_145);
        {
          Var_110 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), Var_110, 0) = ((MR_Box) (IntFileName_145));
      ...
      else
      {
        ...
        parse_tree__write_module_interface_files__get_short_interface_from_raw_item_blocks_7_p_0(BothRawItemBlocks_58, &ShortIntIncls_59, &ShortImpIncls_60, &ShortIntAvails_61, &ShortImpAvails_62, &ShortIntItems_63, &ShortImpItems_64);
        {
...
{
  {
    ...
    parse_tree__write_module_interface_files__IntroducedFrom__pred__strip_unnecessary_impl_defns__717__1_3_p_0(((MR_Word) (wrapper_arg_1)), ((MR_Word) (wrapper_arg_2)), &conv3_HeadVar__3_72);
