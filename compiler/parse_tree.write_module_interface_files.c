  ...
  MR_Word * Succeeded_16)
{
  ...
  MR_Word OtherExt_60;
  MR_String OutputFileName0_61;
  MR_Word Var_64;
  MR_Word NoLineNumGlobals0_66;
  ...
  parse_tree__file_kind__int_file_kind_to_extension_3_p_0((MR_Integer) 2, &_ExtStr_59, &OtherExt_60);
  {
    Var_64 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(1, Var_64, 0) = ((MR_Box) (OtherExt_60));
  }
  parse_tree__file_names__module_name_to_file_name_8_p_0(Globals_12, (MR_String) "predicate \140parse_tree.write_module_interface_files.construct_int_file_name\'/8", (MR_Integer) 0, Var_64, ModuleName_18, &OutputFileName0_61);
  OutputFileName_19 = mercury__string__f_43_43_2_f_0(OutputFileName0_61, ExtraSuffix_14);
  TmpOutputFileName_20 = mercury__string__f_43_43_2_f_0(OutputFileName_19, (MR_String) ".tmp");
  libs__globals__set_option_4_p_0((MR_Integer) 173, (MR_Word) (MR_mkword(1, &parse_tree__write_module_interface_files_scalar_common_2[1])), Globals_12, &NoLineNumGlobals0_66);
  libs__globals__set_option_4_p_0((MR_Integer) 174, (MR_Word) (MR_mkword(1, &parse_tree__write_module_interface_files_scalar_common_2[1])), NoLineNumGlobals0_66, &NoLineNumGlobals_21);
  ...
  Var_58 = ((MR_Word) ((MR_hl_field(0, ParseTreeInt2_13, (MR_Integer) 13))));
  {
    ParseTreeInt2V_23 = (MR_Word) MR_new_object(MR_Word, (14 * sizeof(MR_Word)), NULL, NULL);
    ...
    MR_hl_field(0, ParseTreeInt2V_23, 13) = ((MR_Box) (Var_58));
  }
  ...
  MR_Word * Succeeded_16)
{
  ...
  parse_tree__file_kind__int_file_kind_to_extension_3_p_0((MR_Integer) 1, &_ExtStr_71, &OtherExt_72);
  {
    Var_76 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(1, Var_76, 0) = ((MR_Box) (OtherExt_72));
  }
  ...
  TmpOutputFileName_20 = mercury__string__f_43_43_2_f_0(OutputFileName_19, (MR_String) ".tmp");
  libs__globals__set_option_4_p_0((MR_Integer) 173, (MR_Word) (MR_mkword(1, &parse_tree__write_module_interface_files_scalar_common_2[1])), Globals_12, &NoLineNumGlobals0_78);
  libs__globals__set_option_4_p_0((MR_Integer) 174, (MR_Word) (MR_mkword(1, &parse_tree__write_module_interface_files_scalar_common_2[1])), NoLineNumGlobals0_78, &NoLineNumGlobals_21);
  ...
  Var_70 = ((MR_Word) ((MR_hl_field(0, ParseTreeInt1_13, (MR_Integer) 19))));
  {
    ParseTreeInt1V_23 = (MR_Word) MR_new_object(MR_Word, (20 * sizeof(MR_Word)), NULL, NULL);
    ...
    MR_hl_field(0, ParseTreeInt1V_23, 19) = ((MR_Box) (Var_70));
  }
  ...
  MR_Word * MaybeVersionNumbers_10)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(NoLineNumGlobals_7, (MR_Integer) 153, &GenerateVersionNumbers_53);
  ...
  MR_Word * Succeeded_16)
{
  ...
  MR_Word UpdateSucceeded_25;
  MR_Word OtherExt_80;
  MR_String OutputFileName0_81;
  MR_Word Var_84;
  MR_Word NoLineNumGlobals0_86;
  MR_String _ExtStr_79;
  MR_Word Var_55;
  MR_Word Var_56;
  MR_Word Var_58;
  MR_Word Var_59;
  ...
  parse_tree__file_kind__int_file_kind_to_extension_3_p_0((MR_Integer) 0, &_ExtStr_79, &OtherExt_80);
  {
    Var_84 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(1, Var_84, 0) = ((MR_Box) (OtherExt_80));
  }
  parse_tree__file_names__module_name_to_file_name_8_p_0(Globals_12, (MR_String) "predicate \140parse_tree.write_module_interface_files.construct_int_file_name\'/8", (MR_Integer) 0, Var_84, ModuleName_18, &OutputFileName0_81);
  OutputFileName_19 = mercury__string__f_43_43_2_f_0(OutputFileName0_81, ExtraSuffix_14);
  TmpOutputFileName_20 = mercury__string__f_43_43_2_f_0(OutputFileName_19, (MR_String) ".tmp");
  libs__globals__set_option_4_p_0((MR_Integer) 173, (MR_Word) (MR_mkword(1, &parse_tree__write_module_interface_files_scalar_common_2[1])), Globals_12, &NoLineNumGlobals0_86);
  libs__globals__set_option_4_p_0((MR_Integer) 174, (MR_Word) (MR_mkword(1, &parse_tree__write_module_interface_files_scalar_common_2[1])), NoLineNumGlobals0_86, &NoLineNumGlobals_21);
  ...
  Var_55 = ((MR_Word) ((MR_hl_field(0, ParseTreeInt0_13, (MR_Integer) 0))));
  Var_56 = ((MR_Word) ((MR_hl_field(0, ParseTreeInt0_13, (MR_Integer) 1))));
  Var_58 = ((MR_Word) ((MR_hl_field(0, ParseTreeInt0_13, (MR_Integer) 3))));
  Var_59 = ((MR_Word) ((MR_hl_field(0, ParseTreeInt0_13, (MR_Integer) 4))));
  Var_60 = ((MR_Word) ((MR_hl_field(0, ParseTreeInt0_13, (MR_Integer) 5))));
  Var_61 = ((MR_Word) ((MR_hl_field(0, ParseTreeInt0_13, (MR_Integer) 6))));
  Var_62 = ((MR_Word) ((MR_hl_field(0, ParseTreeInt0_13, (MR_Integer) 7))));
  Var_63 = ((MR_Word) ((MR_hl_field(0, ParseTreeInt0_13, (MR_Integer) 8))));
  Var_64 = ((MR_Word) ((MR_hl_field(0, ParseTreeInt0_13, (MR_Integer) 9))));
  Var_65 = ((MR_Word) ((MR_hl_field(0, ParseTreeInt0_13, (MR_Integer) 10))));
  Var_66 = ((MR_Word) ((MR_hl_field(0, ParseTreeInt0_13, (MR_Integer) 11))));
  Var_67 = ((MR_Word) ((MR_hl_field(0, ParseTreeInt0_13, (MR_Integer) 12))));
  Var_68 = ((MR_Word) ((MR_hl_field(0, ParseTreeInt0_13, (MR_Integer) 13))));
  Var_69 = ((MR_Word) ((MR_hl_field(0, ParseTreeInt0_13, (MR_Integer) 14))));
  Var_70 = ((MR_Word) ((MR_hl_field(0, ParseTreeInt0_13, (MR_Integer) 15))));
  Var_71 = ((MR_Word) ((MR_hl_field(0, ParseTreeInt0_13, (MR_Integer) 16))));
  Var_72 = ((MR_Word) ((MR_hl_field(0, ParseTreeInt0_13, (MR_Integer) 17))));
  Var_73 = ((MR_Word) ((MR_hl_field(0, ParseTreeInt0_13, (MR_Integer) 18))));
  Var_74 = ((MR_Word) ((MR_hl_field(0, ParseTreeInt0_13, (MR_Integer) 19))));
  Var_75 = ((MR_Word) ((MR_hl_field(0, ParseTreeInt0_13, (MR_Integer) 20))));
  Var_76 = ((MR_Word) ((MR_hl_field(0, ParseTreeInt0_13, (MR_Integer) 21))));
  Var_77 = ((MR_Word) ((MR_hl_field(0, ParseTreeInt0_13, (MR_Integer) 22))));
  Var_78 = ((MR_Word) ((MR_hl_field(0, ParseTreeInt0_13, (MR_Integer) 23))));
  {
    ParseTreeInt0V_23 = (MR_Word) MR_new_object(MR_Word, (24 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(0, ParseTreeInt0V_23, 0) = ((MR_Box) (Var_55));
    MR_hl_field(0, ParseTreeInt0V_23, 1) = ((MR_Box) (Var_56));
    MR_hl_field(0, ParseTreeInt0V_23, 2) = ((MR_Box) (MaybeVersionNumbers_22));
    MR_hl_field(0, ParseTreeInt0V_23, 3) = ((MR_Box) (Var_58));
    MR_hl_field(0, ParseTreeInt0V_23, 4) = ((MR_Box) (Var_59));
    MR_hl_field(0, ParseTreeInt0V_23, 5) = ((MR_Box) (Var_60));
    MR_hl_field(0, ParseTreeInt0V_23, 6) = ((MR_Box) (Var_61));
    MR_hl_field(0, ParseTreeInt0V_23, 7) = ((MR_Box) (Var_62));
    MR_hl_field(0, ParseTreeInt0V_23, 8) = ((MR_Box) (Var_63));
    MR_hl_field(0, ParseTreeInt0V_23, 9) = ((MR_Box) (Var_64));
    MR_hl_field(0, ParseTreeInt0V_23, 10) = ((MR_Box) (Var_65));
    MR_hl_field(0, ParseTreeInt0V_23, 11) = ((MR_Box) (Var_66));
    MR_hl_field(0, ParseTreeInt0V_23, 12) = ((MR_Box) (Var_67));
    MR_hl_field(0, ParseTreeInt0V_23, 13) = ((MR_Box) (Var_68));
    MR_hl_field(0, ParseTreeInt0V_23, 14) = ((MR_Box) (Var_69));
    MR_hl_field(0, ParseTreeInt0V_23, 15) = ((MR_Box) (Var_70));
    MR_hl_field(0, ParseTreeInt0V_23, 16) = ((MR_Box) (Var_71));
    MR_hl_field(0, ParseTreeInt0V_23, 17) = ((MR_Box) (Var_72));
    MR_hl_field(0, ParseTreeInt0V_23, 18) = ((MR_Box) (Var_73));
    MR_hl_field(0, ParseTreeInt0V_23, 19) = ((MR_Box) (Var_74));
    MR_hl_field(0, ParseTreeInt0V_23, 20) = ((MR_Box) (Var_75));
    MR_hl_field(0, ParseTreeInt0V_23, 21) = ((MR_Box) (Var_76));
    MR_hl_field(0, ParseTreeInt0V_23, 22) = ((MR_Box) (Var_77));
    MR_hl_field(0, ParseTreeInt0V_23, 23) = ((MR_Box) (Var_78));
  }
...
{
  MR_bool succeeded;
  MR_Word GenerateVersionNumbers_57;
  MR_Word DisableVersionNumbers_58;

  libs__globals__lookup_bool_option_3_p_0(NoLineNumGlobals_7, (MR_Integer) 153, &GenerateVersionNumbers_57);
  libs__globals__io_get_disable_generate_item_version_numbers_3_p_0(&DisableVersionNumbers_58);
  succeeded = (GenerateVersionNumbers_57 == (MR_Integer) 1);
  if (succeeded)
    succeeded = (DisableVersionNumbers_58 == (MR_Integer) 0);
  if (succeeded)
  {
