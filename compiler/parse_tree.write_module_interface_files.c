...
static void MR_CALL 
parse_tree__write_module_interface_files__report_file_not_written_9_p_0(
  MR_Word ErrorStream_10,
  MR_Word Globals_11,
  MR_Word Specs_12,
  MR_Word MaybePrefixMsg_13,
  MR_Word ModuleName_14,
  MR_Word OtherExtA_15,
  MR_Word MaybeOtherExtB_16);
...
{
  {
    ...
    if (succeeded)
    {
      TypeCtorInfo_132_132 = (MR_Word) (&parse_tree__parse_error__parse_tree__parse_error__type_ctor_info_read_module_error_0);
      succeeded = mercury__set__is_empty_1_p_0(TypeCtorInfo_132_132, GetErrors_28);
    }
    if (succeeded)
    {
      ...
      if ((EffectiveGetQualSpecs_32 == (MR_Word) ((MR_Unsigned) 0U)))
      {
        ...
        Var_60 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_error_spec_0), EffectiveGetQualSpecs_32, GenerateSpecs_35);
        parse_tree__error_util__filter_interface_generation_specs_5_p_0(Globals_15, Var_60, &Specs_36);
        ...
        parse_tree__module_cmds__touch_interface_datestamp_8_p_0(Globals_15, ProgressStream_13, ErrorStream_14, ModuleName_23, (MR_Word) (((MR_Box) ((MR_String) ".date"))), &TouchSucceeded_39);
        {
          ...
          MR_hl_field(MR_mktag(1), Var_72, 0) = ((MR_Box) (TouchSucceeded_39));
          MR_hl_field(MR_mktag(1), Var_72, 1) = ((MR_Box) ((MR_Unsigned) 0U));
        }
        {
          Var_71 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), Var_71, 0) = ((MR_Box) (OutputSucceeded2_38));
          MR_hl_field(MR_mktag(1), Var_71, 1) = ((MR_Box) (Var_72));
        }
        {
          Var_70 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), Var_70, 0) = ((MR_Box) (OutputSucceeded1_37));
          MR_hl_field(MR_mktag(1), Var_70, 1) = ((MR_Box) (Var_71));
        }
        *Succeeded_20 = libs__maybe_succeeded__and_list_1_f_0(Var_70);
      }
      else
      {
        parse_tree__write_module_interface_files__report_file_not_written_9_p_0(ErrorStream_14, Globals_15, EffectiveGetQualSpecs_32, (MR_Word) ((MR_Unsigned) 0U), ModuleName_23, (MR_Word) (((MR_Box) ((MR_String) ".int"))), (MR_Word) (MR_mkword(MR_mktag(1), &parse_tree__write_module_interface_files_scalar_common_1[1])));
...
{
  {
    ...
    libs__globals__set_option_4_p_0((MR_Integer) 163, (MR_Word) (MR_mkword(MR_mktag(1), &parse_tree__write_module_interface_files_scalar_common_1[3])), Globals_12, &NoLineNumGlobals0_81);
    libs__globals__set_option_4_p_0((MR_Integer) 164, (MR_Word) (MR_mkword(MR_mktag(1), &parse_tree__write_module_interface_files_scalar_common_1[3])), NoLineNumGlobals0_81, &NoLineNumGlobals_21);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(NoLineNumGlobals_7, (MR_Integer) 143, &GenerateVersionNumbers_51);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(NoLineNumGlobals_7, (MR_Integer) 143, &GenerateVersionNumbers_58);
...
{
  {
    ...
    if (succeeded)
    {
      TypeCtorInfo_119_119 = (MR_Word) (&parse_tree__parse_error__parse_tree__parse_error__type_ctor_info_read_module_error_0);
      succeeded = mercury__set__is_empty_1_p_0(TypeCtorInfo_119_119, GetErrors_27);
    }
    if (succeeded)
    {
      ...
      if ((EffectiveGetQualSpecs_31 == (MR_Word) ((MR_Unsigned) 0U)))
      {
        ...
        Var_55 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_error_spec_0), EffectiveGetQualSpecs_31, GenerateSpecs_33);
        parse_tree__error_util__filter_interface_generation_specs_5_p_0(Globals_15, Var_55, &Specs_34);
      ...
      {
        parse_tree__write_module_interface_files__report_file_not_written_9_p_0(ErrorStream_14, Globals_15, EffectiveGetQualSpecs_31, (MR_Word) ((MR_Unsigned) 0U), ModuleName_23, (MR_Word) (((MR_Box) ((MR_String) ".int0"))), (MR_Word) ((MR_Unsigned) 0U));
        *Succeeded_20 = (MR_Integer) 0;
      }
    }
    else
    {
      parse_tree__write_module_interface_files__report_file_not_written_9_p_0(ErrorStream_14, Globals_15, GetSpecs_26, (MR_Word) (MR_mkword(MR_mktag(1), &parse_tree__write_module_interface_files_scalar_common_1[0])), ModuleName_23, (MR_Word) (((MR_Box) ((MR_String) ".int0"))), (MR_Word) ((MR_Unsigned) 0U));
      *Succeeded_20 = (MR_Integer) 0;
    }
  }
}
...
{
  {
    ...
    libs__globals__set_option_4_p_0((MR_Integer) 163, (MR_Word) (MR_mkword(MR_mktag(1), &parse_tree__write_module_interface_files_scalar_common_1[3])), Globals_12, &NoLineNumGlobals0_90);
    libs__globals__set_option_4_p_0((MR_Integer) 164, (MR_Word) (MR_mkword(MR_mktag(1), &parse_tree__write_module_interface_files_scalar_common_1[3])), NoLineNumGlobals0_90, &NoLineNumGlobals_21);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(NoLineNumGlobals_7, (MR_Integer) 143, &GenerateVersionNumbers_64);
...
{
  {
    ...
    switch (EffectivelyErrors_17) {
      ...
      case (MR_Integer) 1:
        {
          parse_tree__write_module_interface_files__report_file_not_written_9_p_0(ErrorStream_9, Globals_10, Specs_16, (MR_Word) ((MR_Unsigned) 0U), ModuleName_18, (MR_Word) (((MR_Box) ((MR_String) ".int3"))), (MR_Word) ((MR_Unsigned) 0U));
...
{
  {
    ...
    TmpOutputFileName_20 = mercury__string__f_43_43_2_f_0(OutputFileName_19, (MR_String) ".tmp");
    libs__globals__set_option_4_p_0((MR_Integer) 163, (MR_Word) (MR_mkword(MR_mktag(1), &parse_tree__write_module_interface_files_scalar_common_1[3])), Globals_12, &NoLineNumGlobals0_60);
    libs__globals__set_option_4_p_0((MR_Integer) 164, (MR_Word) (MR_mkword(MR_mktag(1), &parse_tree__write_module_interface_files_scalar_common_1[3])), NoLineNumGlobals0_60, &NoLineNumGlobals_21);
...
{
  {
    ...
    parse_tree__error_util__write_error_specs_ignore_5_p_0(ErrorStream_10, Globals_11, Specs_12);
    if (!((MaybePrefixMsg_13 == (MR_Word) ((MR_Unsigned) 0U))))
    {
      MR_String PrefixMsg_18 = ((MR_String) ((MR_hl_field(MR_mktag(1), MaybePrefixMsg_13, (MR_Integer) 0))));

      mercury__io__write_string_4_p_0(ErrorStream_10, PrefixMsg_18);
    }
    {
      Var_31 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), Var_31, 0) = ((MR_Box) (OtherExtA_15));
    }
    parse_tree__file_names__module_name_to_file_name_8_p_0(Globals_11, (MR_String) "predicate \140parse_tree.write_module_interface_files.report_file_not_written\'/9", (MR_Integer) 1, Var_31, ModuleName_14, &IntAFileName_19);
    if ((MaybeOtherExtB_16 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      MR_Word Var_49;
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(1), NotWrittenPieces_20, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &parse_tree__write_module_interface_files_scalar_common_2[2])));
      }
    }
    else
    {
      MR_Word OtherExtB_21 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MaybeOtherExtB_16, (MR_Integer) 0))));
...

      {
        ...
        MR_hl_field(MR_mktag(1), Var_35, 0) = ((MR_Box) (OtherExtB_21));
      }
      parse_tree__file_names__module_name_to_file_name_8_p_0(Globals_11, (MR_String) "predicate \140parse_tree.write_module_interface_files.report_file_not_written\'/9", (MR_Integer) 1, Var_35, ModuleName_14, &IntBFileName_22);
      {
    ...
    {
      NotWrittenMsg_23 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(2), NotWrittenMsg_23, 0) = ((MR_Box) ((MR_Unsigned) 0U));
      MR_hl_field(MR_mktag(2), NotWrittenMsg_23, 1) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 0));
      MR_hl_field(MR_mktag(2), NotWrittenMsg_23, 2) = ((MR_Box) ((MR_Integer) 0));
      MR_hl_field(MR_mktag(2), NotWrittenMsg_23, 3) = ((MR_Box) (Var_59));
    }
    {
      Var_65 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), Var_65, 0) = ((MR_Box) (NotWrittenMsg_23));
      MR_hl_field(MR_mktag(1), Var_65, 1) = ((MR_Box) ((MR_Unsigned) 0U));
    }
    {
      NotWrittenSpec_24 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), NotWrittenSpec_24, 0) = ((MR_Box) ((MR_String) "predicate \140parse_tree.write_module_interface_files.report_file_not_written\'/9"));
      MR_hl_field(MR_mktag(0), NotWrittenSpec_24, 1) = ((MR_Box) ((MR_Unsigned) 8U));
      MR_hl_field(MR_mktag(0), NotWrittenSpec_24, 2) = ((MR_Box) ((MR_Unsigned) 8U));
      MR_hl_field(MR_mktag(0), NotWrittenSpec_24, 3) = ((MR_Box) (Var_65));
    }
    parse_tree__error_util__write_error_spec_ignore_5_p_0(ErrorStream_10, Globals_11, NotWrittenSpec_24);
  }
}
