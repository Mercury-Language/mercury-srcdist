...
{
  {
    ...
    if (succeeded)
    {
      TypeCtorInfo_138_138 = (MR_Word) (&parse_tree__parse_error__parse_tree__parse_error__type_ctor_info_read_module_error_0);
      succeeded = mercury__set__is_empty_1_p_0(TypeCtorInfo_138_138, GetErrors_28);
    }
    if (succeeded)
    {
...
{
  {
    ...
    if (succeeded)
    {
      TypeCtorInfo_125_125 = (MR_Word) (&parse_tree__parse_error__parse_tree__parse_error__type_ctor_info_read_module_error_0);
      succeeded = mercury__set__is_empty_1_p_0(TypeCtorInfo_125_125, GetErrors_27);
    }
    if (succeeded)
    {
