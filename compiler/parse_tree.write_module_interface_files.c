  ...
  MR_Word * Succeeded_16)
{
  ...
  MR_Word OtherExt_63;
  MR_String OutputFileName0_64;
  MR_Word Var_67;
  MR_Word NoLineNumGlobals0_69;
  ...
  parse_tree__file_kind__int_file_kind_to_extension_3_p_0((MR_Integer) 2, &_ExtStr_62, &OtherExt_63);
  {
    Var_67 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(MR_mktag(1), Var_67, 0) = ((MR_Box) (OtherExt_63));
  }
  parse_tree__file_names__module_name_to_file_name_8_p_0(Globals_12, (MR_String) "predicate \140parse_tree.write_module_interface_files.construct_int_file_name\'/8", (MR_Integer) 0, Var_67, ModuleName_18, &OutputFileName0_64);
  OutputFileName_19 = mercury__string__f_43_43_2_f_0(OutputFileName0_64, ExtraSuffix_14);
  TmpOutputFileName_20 = mercury__string__f_43_43_2_f_0(OutputFileName_19, (MR_String) ".tmp");
  libs__globals__set_option_4_p_0((MR_Integer) 170, (MR_Word) (MR_mkword(MR_mktag(1), &parse_tree__write_module_interface_files_scalar_common_2[1])), Globals_12, &NoLineNumGlobals0_69);
  libs__globals__set_option_4_p_0((MR_Integer) 171, (MR_Word) (MR_mkword(MR_mktag(1), &parse_tree__write_module_interface_files_scalar_common_2[1])), NoLineNumGlobals0_69, &NoLineNumGlobals_21);
  ...
  MR_Word * Succeeded_16)
{
  ...
  parse_tree__file_kind__int_file_kind_to_extension_3_p_0((MR_Integer) 1, &_ExtStr_76, &OtherExt_77);
  {
    Var_81 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(MR_mktag(1), Var_81, 0) = ((MR_Box) (OtherExt_77));
  }
  parse_tree__file_names__module_name_to_file_name_8_p_0(Globals_12, (MR_String) "predicate \140parse_tree.write_module_interface_files.construct_int_file_name\'/8", (MR_Integer) 0, Var_81, ModuleName_18, &OutputFileName0_78);
  OutputFileName_19 = mercury__string__f_43_43_2_f_0(OutputFileName0_78, ExtraSuffix_14);
  TmpOutputFileName_20 = mercury__string__f_43_43_2_f_0(OutputFileName_19, (MR_String) ".tmp");
  libs__globals__set_option_4_p_0((MR_Integer) 170, (MR_Word) (MR_mkword(MR_mktag(1), &parse_tree__write_module_interface_files_scalar_common_2[1])), Globals_12, &NoLineNumGlobals0_83);
  libs__globals__set_option_4_p_0((MR_Integer) 171, (MR_Word) (MR_mkword(MR_mktag(1), &parse_tree__write_module_interface_files_scalar_common_2[1])), NoLineNumGlobals0_83, &NoLineNumGlobals_21);
  ...
  MR_Word * Succeeded_16)
{
  ...
  parse_tree__file_kind__int_file_kind_to_extension_3_p_0((MR_Integer) 0, &_ExtStr_88, &OtherExt_89);
  {
    Var_93 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(MR_mktag(1), Var_93, 0) = ((MR_Box) (OtherExt_89));
  }
  parse_tree__file_names__module_name_to_file_name_8_p_0(Globals_12, (MR_String) "predicate \140parse_tree.write_module_interface_files.construct_int_file_name\'/8", (MR_Integer) 0, Var_93, ModuleName_18, &OutputFileName0_90);
  OutputFileName_19 = mercury__string__f_43_43_2_f_0(OutputFileName0_90, ExtraSuffix_14);
  TmpOutputFileName_20 = mercury__string__f_43_43_2_f_0(OutputFileName_19, (MR_String) ".tmp");
  libs__globals__set_option_4_p_0((MR_Integer) 170, (MR_Word) (MR_mkword(MR_mktag(1), &parse_tree__write_module_interface_files_scalar_common_2[1])), Globals_12, &NoLineNumGlobals0_95);
  libs__globals__set_option_4_p_0((MR_Integer) 171, (MR_Word) (MR_mkword(MR_mktag(1), &parse_tree__write_module_interface_files_scalar_common_2[1])), NoLineNumGlobals0_95, &NoLineNumGlobals_21);
  ...
  MR_Word * Succeeded_16)
{
  ...
  MR_Word OtherExt_42;
  MR_String OutputFileName0_43;
  MR_Word Var_46;
  MR_Word NoLineNumGlobals0_48;
  MR_String _ExtStr_41;

  parse_tree__file_kind__int_file_kind_to_extension_3_p_0((MR_Integer) 3, &_ExtStr_41, &OtherExt_42);
  {
    Var_46 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(MR_mktag(1), Var_46, 0) = ((MR_Box) (OtherExt_42));
  }
  parse_tree__file_names__module_name_to_file_name_8_p_0(Globals_12, (MR_String) "predicate \140parse_tree.write_module_interface_files.construct_int_file_name\'/8", (MR_Integer) 0, Var_46, ModuleName_18, &OutputFileName0_43);
  OutputFileName_19 = mercury__string__f_43_43_2_f_0(OutputFileName0_43, ExtraSuffix_14);
  TmpOutputFileName_20 = mercury__string__f_43_43_2_f_0(OutputFileName_19, (MR_String) ".tmp");
  libs__globals__set_option_4_p_0((MR_Integer) 170, (MR_Word) (MR_mkword(MR_mktag(1), &parse_tree__write_module_interface_files_scalar_common_2[1])), Globals_12, &NoLineNumGlobals0_48);
  libs__globals__set_option_4_p_0((MR_Integer) 171, (MR_Word) (MR_mkword(MR_mktag(1), &parse_tree__write_module_interface_files_scalar_common_2[1])), NoLineNumGlobals0_48, &NoLineNumGlobals_21);
