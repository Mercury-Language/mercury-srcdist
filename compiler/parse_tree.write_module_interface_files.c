  ...
  MR_Word * STATE_VARIABLE_HaveReadModuleMaps_44)
{
  ...
  if (succeeded)
  {
    ...
    if ((EffectiveGetQualSpecs_32 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      ...
      parse_tree__module_cmds__touch_module_ext_datestamp_8_p_0(Globals_15, ProgressStream_13, ErrorStream_14, ModuleName_23, (MR_Word) (&parse_tree__write_module_interface_files_scalar_common_1[4]), &TouchSucceeded_39);
      {
  ...
  MR_Word * MaybeVersionNumbers_10)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(NoLineNumGlobals_7, (MR_Integer) 154, &GenerateVersionNumbers_46);
  ...
  if (succeeded)
  {
    ...
    parse_tree__read_modules__read_module_int2_10_p_0((MR_Word) ((MR_Unsigned) 0U), NoLineNumGlobals_7, Var_28, (MR_Integer) 0, (MR_Integer) 0, ModuleName_13, (MR_Word) (&parse_tree__write_module_interface_files_scalar_common_1[5]), &HaveReadInt2_16);
  ...
  MR_Word * Succeeded_16)
{
  ...
  parse_tree__file_kind__int_file_kind_to_extension_3_p_0((MR_Integer) 1, &_ExtStr_68, &Ext_69);
  parse_tree__file_names__module_name_to_file_name_create_dirs_7_p_0(Globals_12, (MR_String) "predicate \140parse_tree.write_module_interface_files.construct_int_file_name\'/8", Ext_69, ModuleName_18, &OutputFileName0_70);
  OutputFileName_19 = mercury__string__f_43_43_2_f_0(OutputFileName0_70, ExtraSuffix_14);
  TmpOutputFileName_20 = mercury__string__f_43_43_2_f_0(OutputFileName_19, (MR_String) ".tmp");
  libs__globals__set_option_4_p_0((MR_Integer) 174, (MR_Word) (MR_mkword(1, &parse_tree__write_module_interface_files_scalar_common_1[3])), Globals_12, &NoLineNumGlobals0_73);
  libs__globals__set_option_4_p_0((MR_Integer) 175, (MR_Word) (MR_mkword(1, &parse_tree__write_module_interface_files_scalar_common_1[3])), NoLineNumGlobals0_73, &NoLineNumGlobals_21);
  ...
  Var_50 = ((MR_Word) ((MR_hl_field(0, ParseTreeInt1_13, (MR_Integer) 0))));
  Var_51 = ((MR_Word) ((MR_hl_field(0, ParseTreeInt1_13, (MR_Integer) 1))));
  Var_53 = ((MR_Word) ((MR_hl_field(0, ParseTreeInt1_13, (MR_Integer) 3))));
  Var_54 = ((MR_Word) ((MR_hl_field(0, ParseTreeInt1_13, (MR_Integer) 4))));
  Var_55 = ((MR_Word) ((MR_hl_field(0, ParseTreeInt1_13, (MR_Integer) 5))));
  Var_56 = ((MR_Word) ((MR_hl_field(0, ParseTreeInt1_13, (MR_Integer) 6))));
  Var_57 = ((MR_Word) ((MR_hl_field(0, ParseTreeInt1_13, (MR_Integer) 7))));
  Var_58 = ((MR_Word) ((MR_hl_field(0, ParseTreeInt1_13, (MR_Integer) 8))));
  Var_59 = ((MR_Word) ((MR_hl_field(0, ParseTreeInt1_13, (MR_Integer) 9))));
  Var_60 = ((MR_Word) ((MR_hl_field(0, ParseTreeInt1_13, (MR_Integer) 10))));
  Var_61 = ((MR_Word) ((MR_hl_field(0, ParseTreeInt1_13, (MR_Integer) 11))));
  Var_62 = ((MR_Word) ((MR_hl_field(0, ParseTreeInt1_13, (MR_Integer) 12))));
  Var_63 = ((MR_Word) ((MR_hl_field(0, ParseTreeInt1_13, (MR_Integer) 13))));
  Var_64 = ((MR_Word) ((MR_hl_field(0, ParseTreeInt1_13, (MR_Integer) 14))));
  Var_65 = ((MR_Word) ((MR_hl_field(0, ParseTreeInt1_13, (MR_Integer) 15))));
  Var_66 = ((MR_Word) ((MR_hl_field(0, ParseTreeInt1_13, (MR_Integer) 16))));
  Var_67 = ((MR_Word) ((MR_hl_field(0, ParseTreeInt1_13, (MR_Integer) 17))));
  {
    ParseTreeInt1V_23 = (MR_Word) MR_new_object(MR_Word, (18 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(0, ParseTreeInt1V_23, 0) = ((MR_Box) (Var_50));
    MR_hl_field(0, ParseTreeInt1V_23, 1) = ((MR_Box) (Var_51));
    MR_hl_field(0, ParseTreeInt1V_23, 2) = ((MR_Box) (MaybeVersionNumbers_22));
    MR_hl_field(0, ParseTreeInt1V_23, 3) = ((MR_Box) (Var_53));
    MR_hl_field(0, ParseTreeInt1V_23, 4) = ((MR_Box) (Var_54));
    MR_hl_field(0, ParseTreeInt1V_23, 5) = ((MR_Box) (Var_55));
    MR_hl_field(0, ParseTreeInt1V_23, 6) = ((MR_Box) (Var_56));
    MR_hl_field(0, ParseTreeInt1V_23, 7) = ((MR_Box) (Var_57));
    MR_hl_field(0, ParseTreeInt1V_23, 8) = ((MR_Box) (Var_58));
    MR_hl_field(0, ParseTreeInt1V_23, 9) = ((MR_Box) (Var_59));
    MR_hl_field(0, ParseTreeInt1V_23, 10) = ((MR_Box) (Var_60));
    MR_hl_field(0, ParseTreeInt1V_23, 11) = ((MR_Box) (Var_61));
    MR_hl_field(0, ParseTreeInt1V_23, 12) = ((MR_Box) (Var_62));
    MR_hl_field(0, ParseTreeInt1V_23, 13) = ((MR_Box) (Var_63));
    MR_hl_field(0, ParseTreeInt1V_23, 14) = ((MR_Box) (Var_64));
    MR_hl_field(0, ParseTreeInt1V_23, 15) = ((MR_Box) (Var_65));
    MR_hl_field(0, ParseTreeInt1V_23, 16) = ((MR_Box) (Var_66));
    MR_hl_field(0, ParseTreeInt1V_23, 17) = ((MR_Box) (Var_67));
  }
  ...
  MR_Word * MaybeVersionNumbers_10)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(NoLineNumGlobals_7, (MR_Integer) 154, &GenerateVersionNumbers_51);
  ...
  if (succeeded)
  {
    ...
    parse_tree__read_modules__read_module_int1_10_p_0((MR_Word) ((MR_Unsigned) 0U), NoLineNumGlobals_7, Var_28, (MR_Integer) 0, (MR_Integer) 0, ModuleName_13, (MR_Word) (&parse_tree__write_module_interface_files_scalar_common_1[5]), &HaveReadInt1_16);
  ...
  MR_Word * STATE_VARIABLE_HaveReadModuleMaps_41)
{
  ...
  if (succeeded)
  {
    ...
    if ((EffectiveGetQualSpecs_31 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      ...
      parse_tree__module_cmds__touch_module_ext_datestamp_8_p_0(Globals_15, ProgressStream_13, ErrorStream_14, ModuleName_23, (MR_Word) (&parse_tree__write_module_interface_files_scalar_common_1[2]), &TouchSucceeded_36);
      *Succeeded_20 = libs__maybe_util__and_2_f_0(OutputSucceeded_35, TouchSucceeded_36);
    }
    else
    {
      parse_tree__write_module_interface_files__report_file_not_written_10_p_0(ErrorStream_14, Globals_15, EffectiveGetQualSpecs_31, (MR_Word) ((MR_Unsigned) 0U), ModuleName_23, (MR_Word) (&parse_tree__write_module_interface_files_scalar_common_1[3]), (MR_Word) ((MR_Unsigned) 0U), (MR_Word) (&parse_tree__write_module_interface_files_scalar_common_1[2]));
      *Succeeded_20 = (MR_Integer) 0;
    }
  }
  else
  {
    parse_tree__write_module_interface_files__report_file_not_written_10_p_0(ErrorStream_14, Globals_15, GetSpecs_27, (MR_Word) (MR_mkword(1, &parse_tree__write_module_interface_files_scalar_common_2[3])), ModuleName_23, (MR_Word) (&parse_tree__write_module_interface_files_scalar_common_1[3]), (MR_Word) ((MR_Unsigned) 0U), (MR_Word) (&parse_tree__write_module_interface_files_scalar_common_1[2]));
    *Succeeded_20 = (MR_Integer) 0;
  }
}
  ...
  MR_Word * Succeeded_16)
{
  ...
  parse_tree__file_kind__int_file_kind_to_extension_3_p_0((MR_Integer) 0, &_ExtStr_76, &Ext_77);
  parse_tree__file_names__module_name_to_file_name_create_dirs_7_p_0(Globals_12, (MR_String) "predicate \140parse_tree.write_module_interface_files.construct_int_file_name\'/8", Ext_77, ModuleName_18, &OutputFileName0_78);
  OutputFileName_19 = mercury__string__f_43_43_2_f_0(OutputFileName0_78, ExtraSuffix_14);
  TmpOutputFileName_20 = mercury__string__f_43_43_2_f_0(OutputFileName_19, (MR_String) ".tmp");
  libs__globals__set_option_4_p_0((MR_Integer) 174, (MR_Word) (MR_mkword(1, &parse_tree__write_module_interface_files_scalar_common_1[3])), Globals_12, &NoLineNumGlobals0_81);
  libs__globals__set_option_4_p_0((MR_Integer) 175, (MR_Word) (MR_mkword(1, &parse_tree__write_module_interface_files_scalar_common_1[3])), NoLineNumGlobals0_81, &NoLineNumGlobals_21);
  ...
  Var_54 = ((MR_Word) ((MR_hl_field(0, ParseTreeInt0_13, (MR_Integer) 0))));
  Var_55 = ((MR_Word) ((MR_hl_field(0, ParseTreeInt0_13, (MR_Integer) 1))));
  Var_57 = ((MR_Word) ((MR_hl_field(0, ParseTreeInt0_13, (MR_Integer) 3))));
  Var_58 = ((MR_Word) ((MR_hl_field(0, ParseTreeInt0_13, (MR_Integer) 4))));
  Var_59 = ((MR_Word) ((MR_hl_field(0, ParseTreeInt0_13, (MR_Integer) 5))));
  Var_60 = ((MR_Word) ((MR_hl_field(0, ParseTreeInt0_13, (MR_Integer) 6))));
  Var_61 = ((MR_Word) ((MR_hl_field(0, ParseTreeInt0_13, (MR_Integer) 7))));
  Var_62 = ((MR_Word) ((MR_hl_field(0, ParseTreeInt0_13, (MR_Integer) 8))));
  Var_63 = ((MR_Word) ((MR_hl_field(0, ParseTreeInt0_13, (MR_Integer) 9))));
  Var_64 = ((MR_Word) ((MR_hl_field(0, ParseTreeInt0_13, (MR_Integer) 10))));
  Var_65 = ((MR_Word) ((MR_hl_field(0, ParseTreeInt0_13, (MR_Integer) 11))));
  Var_66 = ((MR_Word) ((MR_hl_field(0, ParseTreeInt0_13, (MR_Integer) 12))));
  Var_67 = ((MR_Word) ((MR_hl_field(0, ParseTreeInt0_13, (MR_Integer) 13))));
  Var_68 = ((MR_Word) ((MR_hl_field(0, ParseTreeInt0_13, (MR_Integer) 14))));
  Var_69 = ((MR_Word) ((MR_hl_field(0, ParseTreeInt0_13, (MR_Integer) 15))));
  Var_70 = ((MR_Word) ((MR_hl_field(0, ParseTreeInt0_13, (MR_Integer) 16))));
  Var_71 = ((MR_Word) ((MR_hl_field(0, ParseTreeInt0_13, (MR_Integer) 17))));
  Var_72 = ((MR_Word) ((MR_hl_field(0, ParseTreeInt0_13, (MR_Integer) 18))));
  Var_73 = ((MR_Word) ((MR_hl_field(0, ParseTreeInt0_13, (MR_Integer) 19))));
  Var_74 = ((MR_Word) ((MR_hl_field(0, ParseTreeInt0_13, (MR_Integer) 20))));
  Var_75 = ((MR_Word) ((MR_hl_field(0, ParseTreeInt0_13, (MR_Integer) 21))));
  {
  ...
  MR_Word * MaybeVersionNumbers_10)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(NoLineNumGlobals_7, (MR_Integer) 154, &GenerateVersionNumbers_55);
  ...
  if (succeeded)
  {
    ...
    parse_tree__read_modules__read_module_int0_10_p_0((MR_Word) ((MR_Unsigned) 0U), NoLineNumGlobals_7, Var_28, (MR_Integer) 0, (MR_Integer) 0, ModuleName_13, (MR_Word) (&parse_tree__write_module_interface_files_scalar_common_1[5]), &HaveReadInt0_16);
    ...
    case (MR_Integer) 0:
      {
        ...
        MR_Word ModuleName_68 = ((MR_Word) ((MR_hl_field(0, ParseTreeInt3_14, (MR_Integer) 0))));
        MR_String OutputFileName_69;
        MR_String TmpOutputFileName_70;
        MR_Word NoLineNumGlobals_71;
        MR_Word OutputSucceeded_72;
        MR_Word UpdateSucceeded_73;
        MR_Word Ext_88;
        MR_String OutputFileName0_89;
        MR_Word NoLineNumGlobals0_92;
        MR_String _ExtStr_87;

        parse_tree__file_kind__int_file_kind_to_extension_3_p_0((MR_Integer) 3, &_ExtStr_87, &Ext_88);
        parse_tree__file_names__module_name_to_file_name_create_dirs_7_p_0(Globals_10, (MR_String) "predicate \140parse_tree.write_module_interface_files.construct_int_file_name\'/8", Ext_88, ModuleName_68, &OutputFileName0_89);
        OutputFileName_69 = mercury__string__f_43_43_2_f_0(OutputFileName0_89, (MR_String) "");
        TmpOutputFileName_70 = mercury__string__f_43_43_2_f_0(OutputFileName_69, (MR_String) ".tmp");
        libs__globals__set_option_4_p_0((MR_Integer) 174, (MR_Word) (MR_mkword(1, &parse_tree__write_module_interface_files_scalar_common_1[3])), Globals_10, &NoLineNumGlobals0_92);
        libs__globals__set_option_4_p_0((MR_Integer) 175, (MR_Word) (MR_mkword(1, &parse_tree__write_module_interface_files_scalar_common_1[3])), NoLineNumGlobals0_92, &NoLineNumGlobals_71);
        parse_tree__parse_tree_out__output_parse_tree_int3_8_p_0(ProgressStream_8, ErrorStream_9, NoLineNumGlobals_71, TmpOutputFileName_70, ParseTreeInt3_14, &OutputSucceeded_72);
        parse_tree__module_cmds__copy_dot_tmp_to_base_file_report_any_error_7_p_0(Globals_10, (MR_String) ".int3", ModuleName_68, OutputFileName_69, &UpdateSucceeded_73);
        OutputSucceeded_19 = libs__maybe_util__and_2_f_0(OutputSucceeded_72, UpdateSucceeded_73);
        parse_tree__module_cmds__touch_module_ext_datestamp_8_p_0(Globals_10, ProgressStream_8, ErrorStream_9, ModuleName_18, (MR_Word) (&parse_tree__write_module_interface_files_scalar_common_1[0]), &TouchSucceeded_20);
        *Succeeded_12 = libs__maybe_util__and_2_f_0(OutputSucceeded_19, TouchSucceeded_20);
      }
      break;
    case (MR_Integer) 1:
      {
        parse_tree__write_module_interface_files__report_file_not_written_10_p_0(ErrorStream_9, Globals_10, Specs_16, (MR_Word) ((MR_Unsigned) 0U), ModuleName_18, (MR_Word) (&parse_tree__write_module_interface_files_scalar_common_1[1]), (MR_Word) ((MR_Unsigned) 0U), (MR_Word) (&parse_tree__write_module_interface_files_scalar_common_1[0]));
