  ...
  MR_Word * STATE_VARIABLE_HaveReadModuleMaps_44)
{
  ...
  if (succeeded)
  {
    ...
    if ((EffectiveGetQualSpecs_32 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      ...
      parse_tree__module_cmds__touch_module_ext_datestamp_8_p_0(Globals_15, ProgressStream_13, ErrorStream_14, ModuleName_23, (MR_Word) (MR_mkword(1, &parse_tree__write_module_interface_files_scalar_common_1[4])), &TouchSucceeded_39);
      {
  ...
  MR_Word * STATE_VARIABLE_HaveReadModuleMaps_41)
{
  ...
  if (succeeded)
  {
    ...
    if ((EffectiveGetQualSpecs_31 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      ...
      parse_tree__module_cmds__touch_module_ext_datestamp_8_p_0(Globals_15, ProgressStream_13, ErrorStream_14, ModuleName_23, (MR_Word) (MR_mkword(1, &parse_tree__write_module_interface_files_scalar_common_1[2])), &TouchSucceeded_36);
    ...
    case (MR_Integer) 0:
      {
        ...
        parse_tree__module_cmds__touch_module_ext_datestamp_8_p_0(Globals_10, ProgressStream_8, ErrorStream_9, ModuleName_18, (MR_Word) (MR_mkword(1, &parse_tree__write_module_interface_files_scalar_common_1[0])), &TouchSucceeded_20);
