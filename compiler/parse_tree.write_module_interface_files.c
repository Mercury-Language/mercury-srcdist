...
{
  {
    ...
    if (succeeded)
    {
      ...
      if ((EffectiveGetQualSpecs_34 == (MR_Word) ((MR_Unsigned) 0U)))
      {
        ...
        parse_tree__comp_unit_interface__generate_interfaces_int1_int2_5_p_0(AugCompUnit_26, &ParseTreeInt1_35, &ParseTreeInt2_36, (MR_Word) ((MR_Unsigned) 0U), &GenerateSpecs_37);
        ...
        parse_tree__error_util__write_error_specs_ignore_4_p_0(Specs_38, Globals_10);
...
{
  {
    ...
    if (succeeded)
    {
      ...
      if ((EffectiveGetQualSpecs_33 == (MR_Word) ((MR_Unsigned) 0U)))
      {
        ...
        parse_tree__error_util__write_error_specs_ignore_4_p_0(Specs_36, Globals_10);
      ...
      case (MR_Integer) 0:
        {
          ...
          libs__globals__set_option_4_p_0((MR_Integer) 157, Var_74, Globals_6, &NoLineNumGlobals0_72);
          libs__globals__set_option_4_p_0((MR_Integer) 158, Var_74, NoLineNumGlobals0_72, &NoLineNumGlobals_40);
