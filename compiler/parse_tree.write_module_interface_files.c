...
{
  MR_bool succeeded;
  MR_Word GenerateVersionNumbers_48;
  MR_Word DisableVersionNumbers_49;

  libs__globals__lookup_bool_option_3_p_0(NoLineNumGlobals_7, (MR_Integer) 153, &GenerateVersionNumbers_48);
  libs__globals__io_get_disable_generate_item_version_numbers_3_p_0(&DisableVersionNumbers_49);
  succeeded = (GenerateVersionNumbers_48 == (MR_Integer) 1);
  if (succeeded)
    succeeded = (DisableVersionNumbers_49 == (MR_Integer) 0);
  if (succeeded)
  {
  ...
  MR_Word * MaybeVersionNumbers_10)
{
  ...
  MR_Word DisableVersionNumbers_62;

  libs__globals__lookup_bool_option_3_p_0(NoLineNumGlobals_7, (MR_Integer) 153, &GenerateVersionNumbers_61);
  libs__globals__io_get_disable_generate_item_version_numbers_3_p_0(&DisableVersionNumbers_62);
  succeeded = (GenerateVersionNumbers_61 == (MR_Integer) 1);
  if (succeeded)
    succeeded = (DisableVersionNumbers_62 == (MR_Integer) 0);
  if (succeeded)
  {
