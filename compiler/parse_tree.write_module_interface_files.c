...
static const MR_EnumFunctorDescPtr parse_tree__write_module_interface_files__parse_tree__write_module_interface_files__enum_value_ordered_maybe_generate_version_numbers_0[2];
...
const MR_TypeCtorInfo_Struct parse_tree__write_module_interface_files__parse_tree__write_module_interface_files__type_ctor_info_maybe_generate_version_numbers_0 = {
  ...
  {     parse_tree__write_module_interface_files__parse_tree__write_module_interface_files__enum_value_ordered_maybe_generate_version_numbers_0 },
  (MR_Integer) 2,
  UINT16_C(4),
...
{
  {
    ...
    if (succeeded)
    {
      TypeCtorInfo_78_78 = (MR_Word) (&parse_tree__parse_error__parse_tree__parse_error__type_ctor_info_read_module_error_0);
      succeeded = mercury__set__is_empty_1_p_0(TypeCtorInfo_78_78, GetErrors_24);
    }
    if (succeeded)
    {
      ...
      if ((EffectiveGetQualSpecs_34 == (MR_Word) ((MR_Unsigned) 0U)))
      {
        ...
        Var_61 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_error_spec_0), EffectiveGetQualSpecs_34, GenerateSpecs_37);
        parse_tree__error_util__filter_interface_generation_specs_5_p_0(Globals_10, Var_61, &Specs_38);
...
{
  {
    ...
    libs__globals__set_option_4_p_0((MR_Integer) 156, Var_81, Globals_7, &NoLineNumGlobals0_79);
    libs__globals__set_option_4_p_0((MR_Integer) 157, Var_81, NoLineNumGlobals0_79, &NoLineNumGlobals_15);
...
{
  {
    ...
    libs__globals__set_option_4_p_0((MR_Integer) 156, Var_82, Globals_7, &NoLineNumGlobals0_80);
    libs__globals__set_option_4_p_0((MR_Integer) 157, Var_82, NoLineNumGlobals0_80, &NoLineNumGlobals_15);
...
{
  {
    ...
    if (succeeded)
    {
      ...
      succeeded = mercury__set__is_empty_1_p_0(TypeCtorInfo_70_70, GetErrors_23);
    }
    if (succeeded)
    {
      ...
      if ((EffectiveGetQualSpecs_33 == (MR_Word) ((MR_Unsigned) 0U)))
      {
        ...
        Var_57 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_error_spec_0), EffectiveGetQualSpecs_33, GenerateSpecs_35);
        parse_tree__error_util__filter_interface_generation_specs_5_p_0(Globals_10, Var_57, &Specs_36);
      ...
      case (MR_Integer) 0:
        {
          ...
          libs__globals__set_option_4_p_0((MR_Integer) 156, Var_79, Globals_6, &NoLineNumGlobals0_77);
          libs__globals__set_option_4_p_0((MR_Integer) 157, Var_79, NoLineNumGlobals0_77, &NoLineNumGlobals_42);
          parse_tree__parse_tree_out__output_parse_tree_int3_5_p_0(NoLineNumGlobals_42, TmpOutputFileName_41, ParseTreeInt3_13);
          parse_tree__module_cmds__update_interface_4_p_0(Globals_6, OutputFileName_40);
...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), Var_29, 0) = ((MR_Box) (OtherExtA_13));
    }
    parse_tree__file_names__module_name_to_file_name_8_p_0(Globals_9, (MR_String) "predicate \140parse_tree.write_module_interface_files.report_file_not_written\'/8", (MR_Integer) 1, Var_29, ModuleName_12, &IntAFileName_17);
    if ((MaybeOtherExtB_14 == (MR_Word) ((MR_Unsigned) 0U)))
    {
...

      {
        ...
        MR_hl_field(MR_mktag(3), Var_47, 1) = ((MR_Box) (IntAFileName_17));
      }
      {
        NotWrittenPieces_18 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), NotWrittenPieces_18, 0) = ((MR_Box) (Var_47));
    ...
    {
      MR_Word OtherExtB_19 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MaybeOtherExtB_14, (MR_Integer) 0))));
...

      {
        ...
        MR_hl_field(MR_mktag(1), Var_33, 0) = ((MR_Box) (OtherExtB_19));
      }
      parse_tree__file_names__module_name_to_file_name_8_p_0(Globals_9, (MR_String) "predicate \140parse_tree.write_module_interface_files.report_file_not_written\'/8", (MR_Integer) 1, Var_33, ModuleName_12, &IntBFileName_20);
      {
        ...
        MR_hl_field(MR_mktag(3), Var_35, 1) = ((MR_Box) (IntAFileName_17));
      }
      {
        ...
        MR_hl_field(MR_mktag(3), Var_40, 1) = ((MR_Box) (IntBFileName_20));
      }
      {
        Var_39 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), Var_39, 0) = ((MR_Box) (Var_40));
        MR_hl_field(MR_mktag(1), Var_39, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &parse_tree__write_module_interface_files_scalar_common_1[2])));
      }
      {
        Var_36 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), Var_36, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &parse_tree__write_module_interface_files_scalar_common_1[3])));
        MR_hl_field(MR_mktag(1), Var_36, 1) = ((MR_Box) (Var_39));
      }
      {
        NotWrittenPieces_18 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), NotWrittenPieces_18, 0) = ((MR_Box) (Var_35));
        MR_hl_field(MR_mktag(1), NotWrittenPieces_18, 1) = ((MR_Box) (Var_36));
      }
    }
    {
      Var_58 = (MR_Word) MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), Var_58, 0) = ((MR_Box) (NotWrittenPieces_18));
    }
    {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(2), NotWrittenMsg_21, 3) = ((MR_Box) (Var_57));
    }
    {
      Var_63 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), Var_63, 0) = ((MR_Box) (NotWrittenMsg_21));
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(0), NotWrittenSpec_22, 3) = ((MR_Box) (Var_63));
    }
