...
{
  {
    ...
    else
    {
      ...
      else
      {
        ...
        parse_tree__write_module_interface_files__actually_write_interface_file_6_p_0(Globals_8, ParseTreeInt1_34, (MR_String) "", MaybeTimestamp_11);
        parse_tree__write_module_interface_files__actually_write_interface_file_6_p_0(Globals_8, ParseTreeInt2_35, (MR_String) "", MaybeTimestamp_11);
        libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 694, &Experiment2_37);
        switch (Experiment2_37) {
          ...
          case (MR_Integer) 1:
            {
              MR_Word ParseTreeInt23_38;
              MR_Word Int23Specs_39;

              parse_tree__comp_unit_interface__generate_interface_int2_via_int3_5_p_0(Globals_8, AugCompUnit_23, &ParseTreeInt23_38, (MR_Word) ((MR_Unsigned) 0U), &Int23Specs_39);
              parse_tree__error_util__write_error_specs_ignore_4_p_0(Int23Specs_39, NoHaltAtWarnGlobals_31);
              parse_tree__write_module_interface_files__actually_write_interface_file_6_p_0(Globals_8, ParseTreeInt23_38, (MR_String) ".via3", MaybeTimestamp_11);
            }
            break;
        }
...
{
  {
    ...
    else
    {
      ...
      if ((Specs_29 == (MR_Word) ((MR_Unsigned) 0U)))
      {
        ...
        parse_tree__write_module_interface_files__actually_write_interface_file_6_p_0(Globals_8, ParseTreeInt0_32, (MR_String) "", MaybeTimestamp_11);
...
{
  {
    ...
    parse_tree__comp_unit_interface__generate_short_interface_int3_5_p_0(Globals_6, RawCompUnit_8, &Var_13, &ParseTreeInt3_14, &Specs_15);
    parse_tree__error_util__write_error_specs_ignore_4_p_0(Specs_15, Globals_6);
...
{
  {
    ...
    libs__globals__set_option_4_p_0((MR_Integer) 153, Var_39, Globals_7, &NoLineNumGlobals0_19);
    libs__globals__set_option_4_p_0((MR_Integer) 154, Var_39, NoLineNumGlobals0_19, &NoLineNumGlobals_20);
    ...
    Var_74 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ParseTreeInt1_12, (MR_Integer) 0))));
    Var_75 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), ParseTreeInt1_12, (MR_Integer) 1))) & (MR_Integer) 3);
    Var_76 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ParseTreeInt1_12, (MR_Integer) 2))));
    Var_78 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ParseTreeInt1_12, (MR_Integer) 4))));
    Var_79 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ParseTreeInt1_12, (MR_Integer) 5))));
    Var_80 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ParseTreeInt1_12, (MR_Integer) 6))));
    Var_81 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ParseTreeInt1_12, (MR_Integer) 7))));
    Var_82 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ParseTreeInt1_12, (MR_Integer) 8))));
    Var_83 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ParseTreeInt1_12, (MR_Integer) 9))));
    {
      ParseTreeInt_32 = (MR_Word) MR_new_object(MR_Word, (10 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), ParseTreeInt_32, 0) = ((MR_Box) (Var_74));
      MR_hl_field(MR_mktag(0), ParseTreeInt_32, 1) = (MR_Box) ((MR_Unsigned) (Var_75));
      MR_hl_field(MR_mktag(0), ParseTreeInt_32, 2) = ((MR_Box) (Var_76));
      MR_hl_field(MR_mktag(0), ParseTreeInt_32, 3) = ((MR_Box) (MaybeVersionNumbers_31));
      MR_hl_field(MR_mktag(0), ParseTreeInt_32, 4) = ((MR_Box) (Var_78));
      MR_hl_field(MR_mktag(0), ParseTreeInt_32, 5) = ((MR_Box) (Var_79));
      MR_hl_field(MR_mktag(0), ParseTreeInt_32, 6) = ((MR_Box) (Var_80));
      MR_hl_field(MR_mktag(0), ParseTreeInt_32, 7) = ((MR_Box) (Var_81));
      MR_hl_field(MR_mktag(0), ParseTreeInt_32, 8) = ((MR_Box) (Var_82));
      MR_hl_field(MR_mktag(0), ParseTreeInt_32, 9) = ((MR_Box) (Var_83));
    }
