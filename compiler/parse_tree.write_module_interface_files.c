      ...
      case (MR_Integer) 0:
        {
          ...
          Var_83 = (MR_Word) (MR_mkword(MR_mktag(1), &parse_tree__write_module_interface_files_scalar_common_2[0]));
          libs__globals__set_option_4_p_0((MR_Integer) 161, Var_83, Globals_6, &NoLineNumGlobals0_81);
          libs__globals__set_option_4_p_0((MR_Integer) 162, Var_83, NoLineNumGlobals0_81, &NoLineNumGlobals_46);
