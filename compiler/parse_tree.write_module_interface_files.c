...
{
  {
    ...
    switch (MR_tag((MR_Word) TypeDefn_13)) {
      ...
      case (MR_Integer) 2:
        ...
        break;
      case (MR_Integer) 3:
        switch (((MR_Integer) ((MR_hl_field(MR_mktag(3), TypeDefn_13, (MR_Integer) 0))))) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 0:
            {
              MR_Box conv1_Var_19;
                    ...
                    FEInfo_25 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Pragma_20, (MR_Integer) 1))));
                    {
                      ...
                      if (succeeded)
                      {
                        ...
                        if (succeeded)
                        {
                          ...
                          succeeded = ((((MR_tag((MR_Word) Var_59)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(MR_mktag(3), Var_59, (MR_Integer) 0)))) == (MR_Integer) 1)));
                          if (succeeded)
                          {
