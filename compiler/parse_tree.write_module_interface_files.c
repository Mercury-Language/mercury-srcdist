  ...
  MR_Word * Succeeded_14)
{
  ...
  libs__globals__set_option_4_p_0((MR_Integer) 460, (MR_Word) (MR_mkword(1, &parse_tree__write_module_interface_files_scalar_common_1[2])), Globals_10, &NoLineNumGlobals0_60);
  libs__globals__set_option_4_p_0((MR_Integer) 461, (MR_Word) (MR_mkword(1, &parse_tree__write_module_interface_files_scalar_common_1[2])), NoLineNumGlobals0_60, &NoLineNumGlobals_16);
  Info_17 = parse_tree__parse_tree_out_info__init_merc_out_info_3_f_0(NoLineNumGlobals_16, (MR_Integer) 0, (MR_Integer) 0);
  libs__globals__lookup_bool_option_3_p_0(NoLineNumGlobals_16, (MR_Integer) 792, &GenerateVersionNumbers_67);
  ...
  MR_Word * STATE_VARIABLE_HaveParseTreeMaps_21)
{
  ...
  else
  {
    ...
    *Specs_16 = ((MR_Word) ((MR_hl_field(0, GenerateResult_19, 2))));
    ...
    libs__globals__set_option_4_p_0((MR_Integer) 460, (MR_Word) (MR_mkword(1, &parse_tree__write_module_interface_files_scalar_common_1[2])), Globals_12, &NoLineNumGlobals0_84);
    libs__globals__set_option_4_p_0((MR_Integer) 461, (MR_Word) (MR_mkword(1, &parse_tree__write_module_interface_files_scalar_common_1[2])), NoLineNumGlobals0_84, &NoLineNumGlobals_51);
