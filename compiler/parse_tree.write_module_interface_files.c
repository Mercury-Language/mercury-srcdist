...
{
  {
    ...
    else
    {
      ...
      parse_tree__module_qual__module_qualify_aug_comp_unit_13_p_0(Globals_8, AugCompUnit1_19, &AugCompUnit_23, Var_46, &Var_24, (MR_String) "", &Var_25, &Var_26, &Var_27, &Var_28, &Var_29, Specs0_20, &Specs_30);
      ...
      else
      {
        ...
        MR_Word Experiment2_36;

        parse_tree__comp_unit_interface__generate_interfaces_int1_int2_4_p_0(Globals_8, AugCompUnit_23, &ParseTreeInt1_34, &ParseTreeInt2_35);
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 696, &Experiment2_36);
        switch (Experiment2_36) {
          ...
          case (MR_Integer) 1:
            {
              MR_Word ParseTreeInt23_37;

              parse_tree__comp_unit_interface__generate_interface_int2_via_int3_3_p_0(Globals_8, AugCompUnit_23, &ParseTreeInt23_37);
              parse_tree__write_module_interface_files__actually_write_interface_file_6_p_0(Globals_8, ParseTreeInt23_37, (MR_String) ".via3", MaybeTimestamp_11);
            }
            break;
        }
...
{
  {
    ...
    parse_tree__comp_unit_interface__generate_short_interface_int3_4_p_0(Globals_6, RawCompUnit_8, &Var_13, &ParseTreeInt3_14);
