  ...
  MR_Word * STATE_VARIABLE_NoIFileItemBlocksCord_7)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      {
        MR_Word next_value_of_HeadVar__3_3 = RawItemBlocks_19;
        MR_Word next_value_of_STATE_VARIABLE_IFileItemBlocksCord_0_4 = STATE_VARIABLE_IFileItemBlocksCord_43_43;
        MR_Word next_value_of_STATE_VARIABLE_NoIFileItemBlocksCord_0_6 = STATE_VARIABLE_NoIFileItemBlocksCord_44_44;
  ...
  MR_Word * STATE_VARIABLE_NoIFileItemsCord_8)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      /* direct tailcall eliminated */
      {
        MR_Word next_value_of_HeadVar__4_4 = Items_22;
        MR_Word next_value_of_STATE_VARIABLE_IFileItemsCord_0_5 = STATE_VARIABLE_IFileItemsCord_36_36;
        MR_Word next_value_of_STATE_VARIABLE_NoIFileItemsCord_0_7 = STATE_VARIABLE_NoIFileItemsCord_37_37;
          ...
          case (MR_Integer) 5:
            {
              ...
              MR_Word AbstractItem_62;

              parse_tree__item_util__make_abstract_typeclass_2_p_0(ItemTypeClassInfo_8, &AbstractItemTypeClassInfo_9);
              {
                AbstractItem_62 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), AbstractItem_62, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 5));
                MR_hl_field(MR_mktag(3), AbstractItem_62, 1) = ((MR_Box) (AbstractItemTypeClassInfo_9));
              }
              {
                MaybeIFileItem_4 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(1), MaybeIFileItem_4, 0) = ((MR_Box) (AbstractItem_62));
              }
            }
            break;
        }
