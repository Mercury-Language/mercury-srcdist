  ...
  MR_Word * STATE_VARIABLE_Specs_91)
{
  ...
  *IntTypeCtorCheckedMap_16 = ((MR_Word) (conv11_IntTypeCtorCheckedMap_16));
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_12, (MR_Integer) 733, &Experiment1_85);
  ...
  MR_String * IntFileName_12)
{
  ...
  parse_tree__file_names__module_name_to_file_name_create_dirs_7_p_0(Globals_8, (MR_String) "predicate \140parse_tree.comp_unit_interface.construct_int_file_name\'/7", Ext_15, ModuleName_9, &IntFileName0_16);
    ...
    case (MR_Integer) 0:
      {
        ...
        parse_tree__file_names__module_name_to_file_name_create_dirs_7_p_0(Globals_9, (MR_String) "predicate \140parse_tree.comp_unit_interface.construct_int_file_name\'/7", Ext_94, ModuleName_24, &IntFileName0_95);
