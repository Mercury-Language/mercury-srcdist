...
parse_tree__comp_unit_interface__IntroducedFrom__pred__get_interface_int1_items_loop_int__1379__1_2_p_0(
  MR_Word Langs_113,
...
parse_tree__comp_unit_interface__add_foreign_enum_spec_if_needed_6_p_0(
  ...
  MR_Word STATE_VARIABLE_ImpForeignEnumSpecs_0_15,
  MR_Word * STATE_VARIABLE_ImpForeignEnumSpecs_16,
  MR_Word STATE_VARIABLE_ImpImplicitFIMLangs_0_17,
  MR_Word * STATE_VARIABLE_ImpImplicitFIMLangs_18);
...
static void MR_CALL 
parse_tree__comp_unit_interface__get_interface_int1_item_blocks_loop_49_p_0_4(
  MR_Box closure_arg,
  MR_Box wrapper_arg_1,
  MR_Box wrapper_arg_2,
  MR_Box * wrapper_arg_3);
...
static void MR_CALL 
parse_tree__comp_unit_interface__get_interface_int1_item_blocks_loop_49_p_0_3(
  MR_Box closure_arg,
  MR_Box wrapper_arg_1,
  MR_Box wrapper_arg_2,
  MR_Box * wrapper_arg_3);
...
static void MR_CALL 
parse_tree__comp_unit_interface__get_interface_int1_item_blocks_loop_49_p_0_2(
  MR_Box closure_arg,
  MR_Box wrapper_arg_1,
  MR_Box wrapper_arg_2,
  MR_Box * wrapper_arg_3);
...
static void MR_CALL 
parse_tree__comp_unit_interface__get_interface_int1_item_blocks_loop_49_p_0_1(
  MR_Box closure_arg,
  MR_Box wrapper_arg_1,
  MR_Box wrapper_arg_2,
  MR_Box * wrapper_arg_3);
...
static void MR_CALL 
parse_tree__comp_unit_interface__get_interface_int1_item_blocks_loop_49_p_0(
  MR_Word HeadVar__1_1,
...
parse_tree__comp_unit_interface__get_short_interface_int3_from_item_blocks_23_p_0(
  ...
  MR_Word STATE_VARIABLE_IntImpForeignEnumTypeCtors_0_20,
  MR_Word * STATE_VARIABLE_IntImpForeignEnumTypeCtors_21,
...
parse_tree__comp_unit_interface__get_short_interface_int3_from_items_imp_5_p_0(
  MR_Word HeadVar__1_1,
  MR_Word STATE_VARIABLE_OrigImpTypeDefns_0_2,
  MR_Word * STATE_VARIABLE_OrigImpTypeDefns_3,
  MR_Word STATE_VARIABLE_IntImpForeignEnumTypeCtors_0_4,
  MR_Word * STATE_VARIABLE_IntImpForeignEnumTypeCtors_5);
...
parse_tree__comp_unit_interface__get_short_interface_int3_from_items_int_17_p_0(
  ...
  MR_Word STATE_VARIABLE_IntImpForeignEnumTypeCtors_0_14,
  MR_Word * STATE_VARIABLE_IntImpForeignEnumTypeCtors_15,
  MR_Word STATE_VARIABLE_NeedImports_0_16,
  MR_Word * STATE_VARIABLE_NeedImports_17);

static void MR_CALL 
parse_tree__comp_unit_interface__record_foreign_enum_3_p_0(
...
static /* final */ const MR_Box parse_tree__comp_unit_interface_scalar_common_4[7][6];
...
static /* final */ const MR_Box parse_tree__comp_unit_interface_scalar_common_1[31][3] = {
  ...
  {
    ((MR_Box) (&parse_tree__comp_unit_interface_scalar_common_4[0])),
    ((MR_Box) (parse_tree__comp_unit_interface__get_interface_int1_item_blocks_loop_49_p_0_1)),
    ((MR_Box) ((MR_Integer) 0))
  },
  /* row 20 */
  {
    ((MR_Box) (&parse_tree__comp_unit_interface_scalar_common_4[1])),
    ((MR_Box) (parse_tree__comp_unit_interface__get_interface_int1_item_blocks_loop_49_p_0_2)),
    ((MR_Box) ((MR_Integer) 0))
  },
  /* row 21 */
  {
    ((MR_Box) (&parse_tree__comp_unit_interface_scalar_common_4[0])),
    ((MR_Box) (parse_tree__comp_unit_interface__get_interface_int1_item_blocks_loop_49_p_0_3)),
    ((MR_Box) ((MR_Integer) 0))
  },
  /* row 22 */
  {
    ((MR_Box) (&parse_tree__comp_unit_interface_scalar_common_4[1])),
    ((MR_Box) (parse_tree__comp_unit_interface__get_interface_int1_item_blocks_loop_49_p_0_4)),
    ((MR_Box) ((MR_Integer) 0))
  },
  /* row 23 */
  {
...
{
  {
    ...
    succeeded = mercury__builtin__unify_2_p_0((MR_Word) (&parse_tree__comp_unit_interface_scalar_common_2[10]), ((MR_Box) (Langs_113)), ((MR_Box) (HeadVar__2_155)));
    return succeeded;
  }
}
  ...
  MR_Word * STATE_VARIABLE_ImpImplicitFIMLangs_18)
{
  {
    MR_bool succeeded;
    MR_Word Lang_11 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), ForeignEnumSpec_8, (MR_Integer) 0))) & (MR_Integer) 3);
    MR_Word TypeCtor_12 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ForeignEnumSpec_8, (MR_Integer) 1))));
    MR_Word Defns_14;
    MR_Box conv0_Defns_14;

    succeeded = mercury__map__search_3_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_type_ctor_0), (MR_Word) (&parse_tree__comp_unit_interface_scalar_common_2[6]), IntTypesMap_7, ((MR_Box) (TypeCtor_12)), &conv0_Defns_14);
    if (succeeded)
    {
      Defns_14 = ((MR_Word) (conv0_Defns_14));
      succeeded = MR_TRUE;
    }
    if (succeeded)
      succeeded = parse_tree__comp_unit_interface__some_type_defn_is_non_abstract_1_p_0(Defns_14);
    if (succeeded)
    {
      {
        MR_Word base;
        base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        *STATE_VARIABLE_ImpForeignEnumSpecs_16 = base;
        MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (ForeignEnumSpec_8));
        MR_hl_field(MR_mktag(1), base, 1) = ((MR_Box) (STATE_VARIABLE_ImpForeignEnumSpecs_0_15));
      }
      mercury__set__insert_3_p_0((MR_Word) (&libs__globals__libs__globals__type_ctor_info_foreign_language_0), ((MR_Box) (Lang_11)), STATE_VARIABLE_ImpImplicitFIMLangs_0_17, STATE_VARIABLE_ImpImplicitFIMLangs_18);
    }
    else
    {
      *STATE_VARIABLE_ImpImplicitFIMLangs_18 = STATE_VARIABLE_ImpImplicitFIMLangs_0_17;
      *STATE_VARIABLE_ImpForeignEnumSpecs_16 = STATE_VARIABLE_ImpForeignEnumSpecs_0_15;
    }
  }
}
...
{
  {
            ...
            case (MR_Integer) 0:
              {
                ...
                else
                {
                    ...
                    DetailsAbs_60 = (MR_Word) ((MR_Unsigned) 0U);
                  {
                    ...
                    MR_hl_field(MR_mktag(3), TypeDefn_61, 0) = ((MR_Box) ((MR_Unsigned) 0U));
    ...
    if (succeeded)
    {
      ...
      succeeded = ((((MR_tag((MR_Word) TypeDefn_87)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(MR_mktag(3), TypeDefn_87, (MR_Integer) 0)))) == (MR_Integer) 1)));
      if (succeeded)
      {
        DetailsForeign_91 = ((MR_Word) ((MR_hl_field(MR_mktag(3), TypeDefn_87, (MR_Integer) 1))));
  ...
  MR_Word * STATE_VARIABLE_ForeignEnumTypeCtors_15)
{
  {
    MR_bool succeeded;
    MR_Word Lang_6 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), ForeignEnumSpec_4, (MR_Integer) 0))) & (MR_Integer) 3);
    MR_Word TypeCtor_7 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ForeignEnumSpec_4, (MR_Integer) 1))));
    MR_Word OoMValues_8 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ForeignEnumSpec_4, (MR_Integer) 2))));
    MR_Word TypeSymName_9 = ((MR_Word) ((MR_hl_field(MR_mktag(0), TypeCtor_7, (MR_Integer) 0))));
    MR_Integer TypeArity_10 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), TypeCtor_7, (MR_Integer) 1))));
    MR_String TypeName_11;
    MR_Word UnqualTypeCtor_12;
    MR_Word LVs0_13;
    MR_Box conv0_LVs0_13;

    TypeName_11 = mdbcomp__sym_name__unqualify_name_1_f_0(TypeSymName_9);
    {
      UnqualTypeCtor_12 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), UnqualTypeCtor_12, 0) = ((MR_Box) (TypeName_11));
      MR_hl_field(MR_mktag(0), UnqualTypeCtor_12, 1) = ((MR_Box) (TypeArity_10));
    }
    succeeded = mercury__map__search_3_p_0((MR_Word) (&parse_tree__decide_type_repn__parse_tree__decide_type_repn__type_ctor_info_unqual_type_ctor_0), (MR_Word) (&parse_tree__comp_unit_interface_scalar_common_2[1]), STATE_VARIABLE_ForeignEnumTypeCtors_0_14, ((MR_Box) (UnqualTypeCtor_12)), &conv0_LVs0_13);
    if (succeeded)
    {
      LVs0_13 = ((MR_Word) (conv0_LVs0_13));
      succeeded = MR_TRUE;
    }
    if (succeeded)
    {
...

      {
        ...
        MR_hl_field(MR_mktag(0), Var_18, 0) = ((MR_Box) (Lang_6));
        MR_hl_field(MR_mktag(0), Var_18, 1) = ((MR_Box) (OoMValues_8));
      }
      {
        Var_16 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), Var_16, 0) = ((MR_Box) (Var_18));
        MR_hl_field(MR_mktag(1), Var_16, 1) = ((MR_Box) (LVs0_13));
      }
      mercury__map__det_update_4_p_0((MR_Word) (&parse_tree__decide_type_repn__parse_tree__decide_type_repn__type_ctor_info_unqual_type_ctor_0), (MR_Word) (&parse_tree__comp_unit_interface_scalar_common_2[1]), ((MR_Box) (UnqualTypeCtor_12)), ((MR_Box) (Var_16)), STATE_VARIABLE_ForeignEnumTypeCtors_0_14, STATE_VARIABLE_ForeignEnumTypeCtors_15);
    }
    else
    {
      MR_Word Var_19;
...

      {
        ...
        MR_hl_field(MR_mktag(0), Var_21, 0) = ((MR_Box) (Lang_6));
        MR_hl_field(MR_mktag(0), Var_21, 1) = ((MR_Box) (OoMValues_8));
      }
      {
  ...
  MR_Box * wrapper_arg_3)
{
  {
    MR_Box closure = closure_arg;
    MR_Word conv6_STATE_VARIABLE_ForeignEnumTypeCtors_15;

    parse_tree__comp_unit_interface__record_foreign_enum_spec_3_p_0(((MR_Word) (wrapper_arg_1)), ((MR_Word) (wrapper_arg_2)), &conv6_STATE_VARIABLE_ForeignEnumTypeCtors_15);
    *wrapper_arg_3 = ((MR_Box) (conv6_STATE_VARIABLE_ForeignEnumTypeCtors_15));
  }
}
  ...
  MR_Box * wrapper_arg_3)
{
  {
    MR_Box closure = closure_arg;
    MR_Word conv4_STATE_VARIABLE_ForeignEnumTypeCtors_15;

    parse_tree__comp_unit_interface__record_foreign_enum_spec_3_p_0(((MR_Word) (wrapper_arg_1)), ((MR_Word) (wrapper_arg_2)), &conv4_STATE_VARIABLE_ForeignEnumTypeCtors_15);
    *wrapper_arg_3 = ((MR_Box) (conv4_STATE_VARIABLE_ForeignEnumTypeCtors_15));
  }
}
...
{
  {
    ...
    MR_Word ShortIntTypeRepnMap_56;
    MR_Word ShortIntUsedModuleNames_63;
    MR_Word ShortIntExplicitFIMSpecs_64;
    MR_Word ShortIntFIMSpecs_65;
    MR_Word ExplicitFIMSpecs_66;
    MR_Word ShortImpExplicitFIMSpecs_67;
    MR_Word ShortImpFIMSpecs0_68;
    MR_Word ShortImpFIMSpecs_69;
    MR_Word ShortIntTypeDefnMap_72;
    MR_Word ShortIntInstDefnMap_73;
    MR_Word ShortIntModeDefnMap_74;
    MR_Word ShortImpTypeDefnMap_75;
    ...
    MR_Word STATE_VARIABLE_UnqualSymNames_84_84;
    MR_Word STATE_VARIABLE_UsedModuleNames_85_85;
    MR_Word STATE_VARIABLE_UnqualSymNames_86_86;
    MR_Word STATE_VARIABLE_UsedModuleNames_87_87;
    MR_Word Var_88;
    MR_Word Var_91;
    MR_Word Var_92;
    MR_Word Var_101;
    MR_Word Var_102;
    MR_Word Var_103;
    MR_Box conv9_ShortIntFIMSpecs_65;
    MR_Box conv10_ShortImpFIMSpecs0_68;

    mercury__set__init_1_p_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), &STATE_VARIABLE_UsedModuleNames_77_77);
    Var_80 = mercury__cord__init_0_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_type_defn_info_0));
    Var_81 = mercury__set__init_0_f_0((MR_Word) (&libs__globals__libs__globals__type_ctor_info_foreign_language_0));
    parse_tree__comp_unit_interface__get_int2_items_from_int1_int_type_defn_9_p_0(IntTypeDefns_24, (MR_Integer) 0, &STATE_VARIABLE_UnqualSymNames_78_78, STATE_VARIABLE_UsedModuleNames_77_77, &STATE_VARIABLE_UsedModuleNames_79_79, Var_80, &ShortIntTypeDefnsCord_45, Var_81, &ShortIntImplicitFIMLangs_46);
    parse_tree__comp_unit_interface__get_int2_items_from_int1_int_inst_defn_5_p_0(IntInstDefns_25, STATE_VARIABLE_UnqualSymNames_78_78, &STATE_VARIABLE_UnqualSymNames_82_82, STATE_VARIABLE_UsedModuleNames_79_79, &STATE_VARIABLE_UsedModuleNames_83_83);
    parse_tree__comp_unit_interface__get_int2_items_from_int1_int_mode_defn_5_p_0(IntModeDefns_26, STATE_VARIABLE_UnqualSymNames_82_82, &STATE_VARIABLE_UnqualSymNames_84_84, STATE_VARIABLE_UsedModuleNames_83_83, &STATE_VARIABLE_UsedModuleNames_85_85);
    Var_88 = mercury__cord__init_0_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_typeclass_info_0));
    parse_tree__comp_unit_interface__get_int2_items_from_int1_int_typeclass_7_p_0(IntTypeClasses_27, STATE_VARIABLE_UnqualSymNames_84_84, &STATE_VARIABLE_UnqualSymNames_86_86, STATE_VARIABLE_UsedModuleNames_85_85, &STATE_VARIABLE_UsedModuleNames_87_87, Var_88, &ShortIntTypeClassesCord_47);
    Var_91 = mercury__cord__init_0_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_instance_info_0));
    parse_tree__comp_unit_interface__get_int2_items_from_int1_int_instance_7_p_0(IntInstances_28, STATE_VARIABLE_UnqualSymNames_86_86, &UnqualSymNames_43, STATE_VARIABLE_UsedModuleNames_87_87, &UsedModuleNames_44, Var_91, &ShortIntInstancesCord_48);
    ...
    Var_92 = mercury__set__init_0_f_0((MR_Word) (&libs__globals__libs__globals__type_ctor_info_foreign_language_0));
    parse_tree__comp_unit_interface__get_int2_items_from_int1_imp_types_3_p_0(ImpTypeDefns_29, Var_92, &ShortImpImplicitFIMLangs_54);
    libs__globals__lookup_bool_option_3_p_0(Globals_18, (MR_Integer) 695, &Experiment1_55);
    switch (Experiment1_55) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        {
          mercury__map__init_1_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_type_ctor_0), (MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_type_repn_info_0), &ShortIntTypeRepnMap_56);
        }
        break;
      case (MR_Integer) 1:
        {
          ...
          Var_99 = mercury__map__init_0_f_0((MR_Word) (&parse_tree__decide_type_repn__parse_tree__decide_type_repn__type_ctor_info_unqual_type_ctor_0), (MR_Word) (&parse_tree__comp_unit_interface_scalar_common_2[1]));
          mercury__list__foldl_4_p_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_foreign_enum_spec_0), (MR_Word) (&parse_tree__comp_unit_interface_scalar_common_1[2]), (MR_Word) (&parse_tree__comp_unit_interface_scalar_common_1[25]), IntForeignEnums_32, ((MR_Box) (Var_99)), &conv5_ForeignEnumTypeCtors0_59);
          ...
          parse_tree__decide_type_repn__decide_repns_for_simple_types_6_p_0(ModuleName_35, OrigIntTypeDefns_57, OrigImpTypeDefns_58, ForeignEnumTypeCtors_60, &ShortIntTypeRepns_61, &_ShortImpTypeRepns_62);
          ShortIntTypeRepnMap_56 = parse_tree__prog_item__type_ctor_repn_items_to_map_1_f_0(ShortIntTypeRepns_61);
        }
        break;
    }
    switch (UnqualSymNames_43) {
      ...
      case (MR_Integer) 0:
        {
          mercury__set__intersect_3_p_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), UsedModuleNames_44, IntImportsUses_21, &ShortIntUsedModuleNames_63);
        }
        break;
      case (MR_Integer) 1:
        ShortIntUsedModuleNames_63 = IntImportsUses_21;
        break;
    }
    {
      Var_101 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), Var_101, 0) = ((MR_Box) (&parse_tree__comp_unit_interface_scalar_common_5[5]));
      MR_hl_field(MR_mktag(0), Var_101, 1) = ((MR_Box) (parse_tree__comp_unit_interface__generate_interface_int2_17_p_0_5));
      MR_hl_field(MR_mktag(0), Var_101, 2) = ((MR_Box) ((MR_Integer) 1));
      MR_hl_field(MR_mktag(0), Var_101, 3) = ((MR_Box) (ShortIntImplicitFIMLangs_46));
    }
    mercury__set__filter_3_p_0((MR_Word) (&parse_tree__prog_data_foreign__parse_tree__prog_data_foreign__type_ctor_info_fim_spec_0), Var_101, IntExplicitFIMSpecs_22, &ShortIntExplicitFIMSpecs_64);
    {
      Var_102 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), Var_102, 0) = ((MR_Box) (&parse_tree__comp_unit_interface_scalar_common_11[0]));
      MR_hl_field(MR_mktag(0), Var_102, 1) = ((MR_Box) (parse_tree__comp_unit_interface__generate_interface_int2_17_p_0_6));
      MR_hl_field(MR_mktag(0), Var_102, 2) = ((MR_Box) ((MR_Integer) 1));
      MR_hl_field(MR_mktag(0), Var_102, 3) = ((MR_Box) (ModuleName_35));
    }
    mercury__set__foldl_4_p_0((MR_Word) (&libs__globals__libs__globals__type_ctor_info_foreign_language_0), (MR_Word) (&parse_tree__comp_unit_interface_scalar_common_2[5]), Var_102, ShortIntImplicitFIMLangs_46, ((MR_Box) (ShortIntExplicitFIMSpecs_64)), &conv9_ShortIntFIMSpecs_65);
    ShortIntFIMSpecs_65 = ((MR_Word) (conv9_ShortIntFIMSpecs_65));
    mercury__set__union_3_p_0((MR_Word) (&parse_tree__prog_data_foreign__parse_tree__prog_data_foreign__type_ctor_info_fim_spec_0), IntExplicitFIMSpecs_22, ImpExplicitFIMSpecs_23, &ExplicitFIMSpecs_66);
    {
      Var_103 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), Var_103, 0) = ((MR_Box) (&parse_tree__comp_unit_interface_scalar_common_5[5]));
      MR_hl_field(MR_mktag(0), Var_103, 1) = ((MR_Box) (parse_tree__comp_unit_interface__generate_interface_int2_17_p_0_7));
      MR_hl_field(MR_mktag(0), Var_103, 2) = ((MR_Box) ((MR_Integer) 1));
      MR_hl_field(MR_mktag(0), Var_103, 3) = ((MR_Box) (ShortImpImplicitFIMLangs_54));
    }
    mercury__set__filter_3_p_0((MR_Word) (&parse_tree__prog_data_foreign__parse_tree__prog_data_foreign__type_ctor_info_fim_spec_0), Var_103, ExplicitFIMSpecs_66, &ShortImpExplicitFIMSpecs_67);
    mercury__set__foldl_4_p_0((MR_Word) (&libs__globals__libs__globals__type_ctor_info_foreign_language_0), (MR_Word) (&parse_tree__comp_unit_interface_scalar_common_2[5]), Var_102, ShortImpImplicitFIMLangs_54, ((MR_Box) (ShortImpExplicitFIMSpecs_67)), &conv10_ShortImpFIMSpecs0_68);
    ShortImpFIMSpecs0_68 = ((MR_Word) (conv10_ShortImpFIMSpecs0_68));
    mercury__set__difference_3_p_0((MR_Word) (&parse_tree__prog_data_foreign__parse_tree__prog_data_foreign__type_ctor_info_fim_spec_0), ShortImpFIMSpecs0_68, ShortIntFIMSpecs_65, &ShortImpFIMSpecs_69);
    ShortIntTypeDefnMap_72 = parse_tree__prog_item__type_ctor_defn_items_to_map_1_f_0(ShortIntTypeDefns_49);
    ShortIntInstDefnMap_73 = parse_tree__prog_item__inst_ctor_defn_items_to_map_1_f_0(IntInstDefns_25);
    ShortIntModeDefnMap_74 = parse_tree__prog_item__mode_ctor_defn_items_to_map_1_f_0(IntModeDefns_26);
    ShortImpTypeDefnMap_75 = parse_tree__prog_item__type_ctor_defn_items_to_map_1_f_0(ImpTypeDefns_29);
    {
      MR_Word base;
      ...
      *ParseTreeInt2_34 = base;
      ...
      MR_hl_field(MR_mktag(0), base, 4) = ((MR_Box) (ShortIntUsedModuleNames_63));
      MR_hl_field(MR_mktag(0), base, 5) = ((MR_Box) (ShortIntFIMSpecs_65));
      MR_hl_field(MR_mktag(0), base, 6) = ((MR_Box) (ShortImpFIMSpecs_69));
      MR_hl_field(MR_mktag(0), base, 7) = ((MR_Box) (ShortIntTypeDefnMap_72));
      MR_hl_field(MR_mktag(0), base, 8) = ((MR_Box) (ShortIntInstDefnMap_73));
      MR_hl_field(MR_mktag(0), base, 9) = ((MR_Box) (ShortIntModeDefnMap_74));
      MR_hl_field(MR_mktag(0), base, 10) = ((MR_Box) (ShortIntTypeClasses_52));
      MR_hl_field(MR_mktag(0), base, 11) = ((MR_Box) (ShortIntInstances_53));
      MR_hl_field(MR_mktag(0), base, 12) = ((MR_Box) (ShortIntTypeRepnMap_56));
      MR_hl_field(MR_mktag(0), base, 13) = ((MR_Box) (ShortImpTypeDefnMap_75));
    }
  }
}
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      switch (MR_tag((MR_Word) TypeDefn_31)) {
        ...
        case (MR_Integer) 2:
          {
            MR_Word DetailsEqv_43 = ((MR_Word) ((MR_hl_field(MR_mktag(2), TypeDefn_31, (MR_Integer) 0))));
        ...
        case (MR_Integer) 3:
          switch (((MR_Integer) ((MR_hl_field(MR_mktag(3), TypeDefn_31, (MR_Integer) 0))))) {
            ...
            case (MR_Integer) 1:
              {
                MR_Word DetailsForeign_38 = ((MR_Word) ((MR_hl_field(MR_mktag(3), TypeDefn_31, (MR_Integer) 1))));
  ...
  MR_Box * wrapper_arg_5)
{
  {
    MR_Box closure = closure_arg;
    MR_Word conv5_STATE_VARIABLE_ImpForeignEnumSpecs_16;
    MR_Word conv4_STATE_VARIABLE_ImpImplicitFIMLangs_18;

    parse_tree__comp_unit_interface__add_foreign_enum_spec_if_needed_6_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) (wrapper_arg_1)), ((MR_Word) (wrapper_arg_2)), &conv5_STATE_VARIABLE_ImpForeignEnumSpecs_16, ((MR_Word) (wrapper_arg_4)), &conv4_STATE_VARIABLE_ImpImplicitFIMLangs_18);
    *wrapper_arg_3 = ((MR_Box) (conv5_STATE_VARIABLE_ImpForeignEnumSpecs_16));
    *wrapper_arg_5 = ((MR_Box) (conv4_STATE_VARIABLE_ImpImplicitFIMLangs_18));
  }
}
...
{
  {
    ...
    MR_Word IntForeignEnumsCord_60;
    ...
    MR_Word IntPragmas_69;
    MR_Word IntPromises_70;
    MR_Word ImpTypeClasses_71;
    MR_Word BothTypesMap_72;
    MR_Word NeededImpTypeCtors_73;
    MR_Word ImpModulesNeededByTypeDefns_74;
    MR_Word ImpNeededModules_75;
    MR_Word ImpImportsUses_76;
    MR_Word ImpImplicitFIMLangs2_78;
    MR_Word ImpForeignEnums_79;
    MR_Word ImpImplicitFIMLangs_80;
    MR_Word IntFIMSpecs_81;
    MR_Word ImpFIMSpecs0_82;
    MR_Word ImpFIMSpecs_83;
    MR_Word IntTypeDefnMap_84;
    MR_Word IntInstDefnMap_85;
    MR_Word IntModeDefnMap_86;
    MR_Word IntForeignEnumMap_87;
    MR_Word IntTypeRepnMap_88;
    MR_Word ImpTypeDefnMap_90;
    MR_Word ImpForeignEnumMap_91;
    MR_Word Var_93;
    MR_Word Var_94;
    MR_Word Var_95;
    MR_Word Var_96;
    ...
    MR_Box conv2_ImpImplicitFIMLangs2_78;
    MR_Box conv7_ImpForeignEnums_79;
    MR_Box conv6_ImpImplicitFIMLangs_80;
    MR_Box conv9_IntFIMSpecs_81;
    MR_Box conv10_ImpFIMSpecs0_82;
    ...
    mercury__set__init_1_p_0((MR_Word) (&parse_tree__prog_data_foreign__parse_tree__prog_data_foreign__type_ctor_info_fim_spec_0), &IntExplicitFIMSpecs0_43);
    mercury__set__init_1_p_0((MR_Word) (&parse_tree__prog_data_foreign__parse_tree__prog_data_foreign__type_ctor_info_fim_spec_0), &ImpExplicitFIMSpecs0_44);
    ...
    Var_95 = mercury__cord__init_0_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_type_defn_info_0));
    Var_96 = mercury__cord__init_0_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_inst_defn_info_0));
    Var_97 = mercury__cord__init_0_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_mode_defn_info_0));
    ...
    Var_100 = mercury__cord__init_0_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_pred_decl_info_0));
    Var_101 = mercury__cord__init_0_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_mode_decl_info_0));
    Var_102 = mercury__cord__init_0_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_foreign_enum_spec_0));
    ...
    parse_tree__comp_unit_interface__get_interface_int1_item_blocks_loop_49_p_0(SrcItemBlocks_36, Var_93, IntIncls_18, Var_94, &ImpIncls_49, IntImportsUses0_41, IntImportsUses_19, ImpImportsUses0_42, &ImpImportsUses1_50, IntExplicitFIMSpecs0_43, IntExplicitFIMSpecs_20, ImpExplicitFIMSpecs0_44, ImpExplicitFIMSpecs_21, IntImplicitFIMLangs0_45, &IntImplicitFIMLangs_51, ImpImplicitFIMLangs0_46, &ImpImplicitFIMLangs1_52, IntTypesMap0_47, IntTypesMap_28, Var_95, &IntTypeDefnsCord_53, Var_96, &IntInstDefnsCord_54, Var_97, &IntModeDefnsCord_55, Var_98, &IntTypeClassesCord_56, Var_99, &IntInstancesCord_57, Var_100, &IntPredDeclsCord_58, Var_101, &IntModeDeclsCord_59, Var_102, &IntForeignEnumsCord_60, Var_103, &IntPragmasCord_61, Var_104, &IntPromisesCord_62, Var_105, &_IntModulesNeededByTypeClassDefns_63, ImpTypesMap0_48, ImpTypesMap_29, Var_106, &ImpTypeClassesCord_64, Var_107, &ImpForeignEnumsCord_65, Var_108, &ImpModulesNeededByTypeClassDefns_66);
    ...
    *IntInstances_26 = mercury__cord__list_1_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_instance_info_0), IntInstancesCord_57);
    IntPredDecls_67 = mercury__cord__list_1_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_pred_decl_info_0), IntPredDeclsCord_58);
    IntModeDecls_68 = mercury__cord__list_1_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_mode_decl_info_0), IntModeDeclsCord_59);
    *IntForeignEnums_30 = mercury__cord__list_1_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_foreign_enum_spec_0), IntForeignEnumsCord_60);
    IntPragmas_69 = mercury__cord__list_1_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_pragma_info_0), IntPragmasCord_61);
    IntPromises_70 = mercury__cord__list_1_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_promise_info_0), IntPromisesCord_62);
    ImpTypeClasses_71 = mercury__cord__list_1_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_typeclass_info_0), ImpTypeClassesCord_64);
    *ImpForeignEnums0_31 = mercury__cord__list_1_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_foreign_enum_spec_0), ImpForeignEnumsCord_65);
    BothTypesMap_72 = mercury__multi_map__merge_2_f_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_type_ctor_0), (MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_type_defn_info_0), *IntTypesMap_28, *ImpTypesMap_29);
    parse_tree__comp_unit_interface__get_requirements_of_imp_exported_types_5_p_0(*IntTypesMap_28, *ImpTypesMap_29, BothTypesMap_72, &NeededImpTypeCtors_73, &ImpModulesNeededByTypeDefns_74);
    mercury__set__union_3_p_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), ImpModulesNeededByTypeClassDefns_66, ImpModulesNeededByTypeDefns_74, &ImpNeededModules_75);
    succeeded = mercury__set__is_empty_1_p_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), ImpNeededModules_75);
    if (succeeded)
      mercury__set__init_1_p_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), &ImpImportsUses_76);
    else
    {
      MR_Word ImpImportsUses2_77;

      ImpImportsUses2_77 = mercury__set__intersect_2_f_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), ImpImportsUses1_50, ImpNeededModules_75);
      ImpImportsUses_76 = mercury__set__difference_2_f_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), ImpImportsUses2_77, *IntImportsUses_19);
    }
    {
      Var_109 = (MR_Word) MR_new_object(MR_Word, (6 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), Var_109, 0) = ((MR_Box) (&parse_tree__comp_unit_interface_scalar_common_9[0]));
      MR_hl_field(MR_mktag(0), Var_109, 1) = ((MR_Box) (parse_tree__comp_unit_interface__generate_interface_int1_16_p_0_1));
      MR_hl_field(MR_mktag(0), Var_109, 2) = ((MR_Box) ((MR_Integer) 3));
      MR_hl_field(MR_mktag(0), Var_109, 3) = ((MR_Box) (BothTypesMap_72));
      MR_hl_field(MR_mktag(0), Var_109, 4) = ((MR_Box) (*IntTypesMap_28));
      MR_hl_field(MR_mktag(0), Var_109, 5) = ((MR_Box) (NeededImpTypeCtors_73));
    }
    mercury__map__foldl2_6_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_type_ctor_0), (MR_Word) (&parse_tree__comp_unit_interface_scalar_common_2[6]), (MR_Word) (&parse_tree__comp_unit_interface_scalar_common_2[6]), (MR_Word) (&parse_tree__comp_unit_interface_scalar_common_2[7]), Var_109, *ImpTypesMap_29, ((MR_Box) ((MR_Unsigned) 0U)), &conv3_ImpTypeDefns_27, ((MR_Box) (ImpImplicitFIMLangs1_52)), &conv2_ImpImplicitFIMLangs2_78);
    *ImpTypeDefns_27 = ((MR_Word) (conv3_ImpTypeDefns_27));
    ImpImplicitFIMLangs2_78 = ((MR_Word) (conv2_ImpImplicitFIMLangs2_78));
    {
      Var_111 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), Var_111, 0) = ((MR_Box) (&parse_tree__comp_unit_interface_scalar_common_10[0]));
      MR_hl_field(MR_mktag(0), Var_111, 1) = ((MR_Box) (parse_tree__comp_unit_interface__generate_interface_int1_16_p_0_2));
      MR_hl_field(MR_mktag(0), Var_111, 2) = ((MR_Box) ((MR_Integer) 1));
      MR_hl_field(MR_mktag(0), Var_111, 3) = ((MR_Box) (*IntTypesMap_28));
    }
    mercury__list__foldl2_6_p_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_foreign_enum_spec_0), (MR_Word) (&parse_tree__comp_unit_interface_scalar_common_2[8]), (MR_Word) (&parse_tree__comp_unit_interface_scalar_common_2[7]), Var_111, *ImpForeignEnums0_31, ((MR_Box) ((MR_Unsigned) 0U)), &conv7_ImpForeignEnums_79, ((MR_Box) (ImpImplicitFIMLangs2_78)), &conv6_ImpImplicitFIMLangs_80);
    ImpForeignEnums_79 = ((MR_Word) (conv7_ImpForeignEnums_79));
    ImpImplicitFIMLangs_80 = ((MR_Word) (conv6_ImpImplicitFIMLangs_80));
    {
      Var_113 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), Var_113, 0) = ((MR_Box) (&parse_tree__comp_unit_interface_scalar_common_11[0]));
      MR_hl_field(MR_mktag(0), Var_113, 1) = ((MR_Box) (parse_tree__comp_unit_interface__generate_interface_int1_16_p_0_3));
      MR_hl_field(MR_mktag(0), Var_113, 2) = ((MR_Box) ((MR_Integer) 1));
      MR_hl_field(MR_mktag(0), Var_113, 3) = ((MR_Box) (ModuleName_33));
    }
    mercury__set__foldl_4_p_0((MR_Word) (&libs__globals__libs__globals__type_ctor_info_foreign_language_0), (MR_Word) (&parse_tree__comp_unit_interface_scalar_common_2[5]), Var_113, IntImplicitFIMLangs_51, ((MR_Box) (*IntExplicitFIMSpecs_20)), &conv9_IntFIMSpecs_81);
    IntFIMSpecs_81 = ((MR_Word) (conv9_IntFIMSpecs_81));
    mercury__set__foldl_4_p_0((MR_Word) (&libs__globals__libs__globals__type_ctor_info_foreign_language_0), (MR_Word) (&parse_tree__comp_unit_interface_scalar_common_2[5]), Var_113, ImpImplicitFIMLangs_80, ((MR_Box) (*ImpExplicitFIMSpecs_21)), &conv10_ImpFIMSpecs0_82);
    ImpFIMSpecs0_82 = ((MR_Word) (conv10_ImpFIMSpecs0_82));
    mercury__set__difference_3_p_0((MR_Word) (&parse_tree__prog_data_foreign__parse_tree__prog_data_foreign__type_ctor_info_fim_spec_0), ImpFIMSpecs0_82, IntFIMSpecs_81, &ImpFIMSpecs_83);
    IntTypeDefnMap_84 = parse_tree__prog_item__type_ctor_defn_items_to_map_1_f_0(*IntTypeDefns_22);
    IntInstDefnMap_85 = parse_tree__prog_item__inst_ctor_defn_items_to_map_1_f_0(*IntInstDefns_23);
    IntModeDefnMap_86 = parse_tree__prog_item__mode_ctor_defn_items_to_map_1_f_0(*IntModeDefns_24);
    IntForeignEnumMap_87 = parse_tree__prog_item__type_ctor_foreign_enum_specs_to_map_1_f_0(*IntForeignEnums_30);
    ImpTypeDefnMap_90 = parse_tree__prog_item__type_ctor_defn_items_to_map_1_f_0(*ImpTypeDefns_27);
    ImpForeignEnumMap_91 = parse_tree__prog_item__type_ctor_foreign_enum_specs_to_map_1_f_0(ImpForeignEnums_79);
    IntTypeRepnMap_88 = parse_tree__prog_item__type_ctor_repn_items_to_map_1_f_0((MR_Word) ((MR_Unsigned) 0U));
    {
      MR_Word base;
      ...
      *ParseTreeInt1_32 = base;
      ...
      MR_hl_field(MR_mktag(0), base, 6) = ((MR_Box) (ImpImportsUses_76));
      MR_hl_field(MR_mktag(0), base, 7) = ((MR_Box) (IntFIMSpecs_81));
      MR_hl_field(MR_mktag(0), base, 8) = ((MR_Box) (ImpFIMSpecs_83));
      MR_hl_field(MR_mktag(0), base, 9) = ((MR_Box) (IntTypeDefnMap_84));
      MR_hl_field(MR_mktag(0), base, 10) = ((MR_Box) (IntInstDefnMap_85));
      MR_hl_field(MR_mktag(0), base, 11) = ((MR_Box) (IntModeDefnMap_86));
      ...
      MR_hl_field(MR_mktag(0), base, 16) = ((MR_Box) (IntForeignEnumMap_87));
      MR_hl_field(MR_mktag(0), base, 17) = ((MR_Box) (IntPragmas_69));
      MR_hl_field(MR_mktag(0), base, 18) = ((MR_Box) (IntPromises_70));
      MR_hl_field(MR_mktag(0), base, 19) = ((MR_Box) (IntTypeRepnMap_88));
      MR_hl_field(MR_mktag(0), base, 20) = ((MR_Box) (ImpTypeDefnMap_90));
      MR_hl_field(MR_mktag(0), base, 21) = ((MR_Box) (ImpForeignEnumMap_91));
      MR_hl_field(MR_mktag(0), base, 22) = ((MR_Box) (ImpTypeClasses_71));
    }
  }
}
  ...
  MR_Word * STATE_VARIABLE_ImpModulesNeededByTypeClassDefns_49)
{
  while (MR_TRUE)
  {
    ...
    {
      MR_Word SrcItemBlock_122 = ((MR_Word) ((MR_hl_field(MR_mktag(1), HeadVar__1_1, (MR_Integer) 0))));
      MR_Word SrcItemBlocks_123 = ((MR_Word) ((MR_hl_field(MR_mktag(1), HeadVar__1_1, (MR_Integer) 1))));
      MR_Word SrcSection_149 = ((MR_Word) ((MR_hl_field(MR_mktag(0), SrcItemBlock_122, (MR_Integer) 1))));
      MR_Word Incls_150 = ((MR_Word) ((MR_hl_field(MR_mktag(0), SrcItemBlock_122, (MR_Integer) 2))));
      MR_Word Avails_151 = ((MR_Word) ((MR_hl_field(MR_mktag(0), SrcItemBlock_122, (MR_Integer) 3))));
      MR_Word FIMs_152 = ((MR_Word) ((MR_hl_field(MR_mktag(0), SrcItemBlock_122, (MR_Integer) 4))));
      MR_Word Items_153 = ((MR_Word) ((MR_hl_field(MR_mktag(0), SrcItemBlock_122, (MR_Integer) 5))));
      MR_Word STATE_VARIABLE_ImpIncls_205_205;
      MR_Word STATE_VARIABLE_ImpImportsUses_206_206;
      MR_Word STATE_VARIABLE_ImpExplicitFIMSpecs_208_208;
      MR_Word STATE_VARIABLE_ImpImplicitFIMLangs_209_209;
      MR_Word STATE_VARIABLE_ImpTypesMap_210_210;
      MR_Word STATE_VARIABLE_ImpTypeClassesCord_211_211;
      MR_Word STATE_VARIABLE_ImpForeignEnumsCord_212_212;
      MR_Word STATE_VARIABLE_ImpModulesNeededByTypeClassDefns_213_213;
      MR_Word STATE_VARIABLE_IntIncls_215_215;
      MR_Word STATE_VARIABLE_IntImportsUses_216_216;
      MR_Word STATE_VARIABLE_IntExplicitFIMSpecs_218_218;
      MR_Word STATE_VARIABLE_IntImplicitFIMLangs_219_219;
      MR_Word STATE_VARIABLE_IntTypesMap_220_220;
      MR_Word STATE_VARIABLE_IntTypeDefnsCord_221_221;
      MR_Word STATE_VARIABLE_IntInstDefnsCord_222_222;
      MR_Word STATE_VARIABLE_IntModeDefnsCord_223_223;
      MR_Word STATE_VARIABLE_IntTypeClassesCord_224_224;
      MR_Word STATE_VARIABLE_IntInstancesCord_225_225;
      MR_Word STATE_VARIABLE_IntPredDeclsCord_226_226;
      MR_Word STATE_VARIABLE_IntModeDeclsCord_227_227;
      MR_Word STATE_VARIABLE_IntForeignEnumsCord_228_228;
      MR_Word STATE_VARIABLE_IntPragmasCord_229_229;
      MR_Word STATE_VARIABLE_IntPromisesCord_230_230;
      MR_Word STATE_VARIABLE_IntModulesNeededByTypeClassDefns_231_231;
      MR_Word next_value_of_HeadVar__1_1;
      ...
      switch (SrcSection_149) {
        default: /*NOTREACHED*/ MR_assert(0);
        case (MR_Integer) 2:
          {
            {
              mercury__require__unexpected_2_p_0((MR_String) "predicate \140parse_tree.comp_unit_interface.get_interface_int1_item_blocks_loop\'/49", (MR_String) "sms_impl_but_exported_to_submodules");
              return;
            }
          }
          break;
        case (MR_Integer) 1:
          {
            MR_Box conv1_STATE_VARIABLE_ImpIncls_205_205;
            MR_Box conv3_STATE_VARIABLE_ImpExplicitFIMSpecs_208_208;

            mercury__list__foldl_4_p_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_include_0), (MR_Word) (&parse_tree__comp_unit_interface_scalar_common_2[4]), (MR_Word) (&parse_tree__comp_unit_interface_scalar_common_1[19]), Incls_150, ((MR_Box) (STATE_VARIABLE_ImpIncls_0_4)), &conv1_STATE_VARIABLE_ImpIncls_205_205);
            STATE_VARIABLE_ImpIncls_205_205 = ((MR_Word) (conv1_STATE_VARIABLE_ImpIncls_205_205));
            parse_tree__comp_unit_interface__get_interface_int1_avails_loop_3_p_0(Avails_151, STATE_VARIABLE_ImpImportsUses_0_8, &STATE_VARIABLE_ImpImportsUses_206_206);
            mercury__list__foldl_4_p_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_fim_0), (MR_Word) (&parse_tree__comp_unit_interface_scalar_common_2[5]), (MR_Word) (&parse_tree__comp_unit_interface_scalar_common_1[20]), FIMs_152, ((MR_Box) (STATE_VARIABLE_ImpExplicitFIMSpecs_0_12)), &conv3_STATE_VARIABLE_ImpExplicitFIMSpecs_208_208);
            STATE_VARIABLE_ImpExplicitFIMSpecs_208_208 = ((MR_Word) (conv3_STATE_VARIABLE_ImpExplicitFIMSpecs_208_208));
            parse_tree__comp_unit_interface__get_interface_int1_items_loop_imp_11_p_0(Items_153, STATE_VARIABLE_ImpImplicitFIMLangs_0_16, &STATE_VARIABLE_ImpImplicitFIMLangs_209_209, STATE_VARIABLE_ImpTypesMap_0_42, &STATE_VARIABLE_ImpTypesMap_210_210, STATE_VARIABLE_ImpTypeClassesCord_0_44, &STATE_VARIABLE_ImpTypeClassesCord_211_211, STATE_VARIABLE_ImpForeignEnumsCord_0_46, &STATE_VARIABLE_ImpForeignEnumsCord_212_212, STATE_VARIABLE_ImpModulesNeededByTypeClassDefns_0_48, &STATE_VARIABLE_ImpModulesNeededByTypeClassDefns_213_213);
            STATE_VARIABLE_IntIncls_215_215 = STATE_VARIABLE_IntIncls_0_2;
            STATE_VARIABLE_IntImportsUses_216_216 = STATE_VARIABLE_IntImportsUses_0_6;
            STATE_VARIABLE_IntExplicitFIMSpecs_218_218 = STATE_VARIABLE_IntExplicitFIMSpecs_0_10;
            STATE_VARIABLE_IntImplicitFIMLangs_219_219 = STATE_VARIABLE_IntImplicitFIMLangs_0_14;
            STATE_VARIABLE_IntTypesMap_220_220 = STATE_VARIABLE_IntTypesMap_0_18;
            STATE_VARIABLE_IntTypeDefnsCord_221_221 = STATE_VARIABLE_IntTypeDefnsCord_0_20;
            STATE_VARIABLE_IntInstDefnsCord_222_222 = STATE_VARIABLE_IntInstDefnsCord_0_22;
            STATE_VARIABLE_IntModeDefnsCord_223_223 = STATE_VARIABLE_IntModeDefnsCord_0_24;
            STATE_VARIABLE_IntTypeClassesCord_224_224 = STATE_VARIABLE_IntTypeClassesCord_0_26;
            STATE_VARIABLE_IntInstancesCord_225_225 = STATE_VARIABLE_IntInstancesCord_0_28;
            STATE_VARIABLE_IntPredDeclsCord_226_226 = STATE_VARIABLE_IntPredDeclsCord_0_30;
            STATE_VARIABLE_IntModeDeclsCord_227_227 = STATE_VARIABLE_IntModeDeclsCord_0_32;
            STATE_VARIABLE_IntForeignEnumsCord_228_228 = STATE_VARIABLE_IntForeignEnumsCord_0_34;
            STATE_VARIABLE_IntPragmasCord_229_229 = STATE_VARIABLE_IntPragmasCord_0_36;
            STATE_VARIABLE_IntPromisesCord_230_230 = STATE_VARIABLE_IntPromisesCord_0_38;
            STATE_VARIABLE_IntModulesNeededByTypeClassDefns_231_231 = STATE_VARIABLE_IntModulesNeededByTypeClassDefns_0_40;
          }
          break;
        case (MR_Integer) 0:
          {
            MR_Box conv5_STATE_VARIABLE_IntIncls_215_215;
            MR_Box conv7_STATE_VARIABLE_IntExplicitFIMSpecs_218_218;

            mercury__list__foldl_4_p_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_include_0), (MR_Word) (&parse_tree__comp_unit_interface_scalar_common_2[4]), (MR_Word) (&parse_tree__comp_unit_interface_scalar_common_1[21]), Incls_150, ((MR_Box) (STATE_VARIABLE_IntIncls_0_2)), &conv5_STATE_VARIABLE_IntIncls_215_215);
            STATE_VARIABLE_IntIncls_215_215 = ((MR_Word) (conv5_STATE_VARIABLE_IntIncls_215_215));
            parse_tree__comp_unit_interface__get_interface_int1_avails_loop_3_p_0(Avails_151, STATE_VARIABLE_IntImportsUses_0_6, &STATE_VARIABLE_IntImportsUses_216_216);
            mercury__list__foldl_4_p_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_fim_0), (MR_Word) (&parse_tree__comp_unit_interface_scalar_common_2[5]), (MR_Word) (&parse_tree__comp_unit_interface_scalar_common_1[22]), FIMs_152, ((MR_Box) (STATE_VARIABLE_IntExplicitFIMSpecs_0_10)), &conv7_STATE_VARIABLE_IntExplicitFIMSpecs_218_218);
            STATE_VARIABLE_IntExplicitFIMSpecs_218_218 = ((MR_Word) (conv7_STATE_VARIABLE_IntExplicitFIMSpecs_218_218));
            parse_tree__comp_unit_interface__get_interface_int1_items_loop_int_27_p_0(Items_153, STATE_VARIABLE_IntImplicitFIMLangs_0_14, &STATE_VARIABLE_IntImplicitFIMLangs_219_219, STATE_VARIABLE_IntTypesMap_0_18, &STATE_VARIABLE_IntTypesMap_220_220, STATE_VARIABLE_IntTypeDefnsCord_0_20, &STATE_VARIABLE_IntTypeDefnsCord_221_221, STATE_VARIABLE_IntInstDefnsCord_0_22, &STATE_VARIABLE_IntInstDefnsCord_222_222, STATE_VARIABLE_IntModeDefnsCord_0_24, &STATE_VARIABLE_IntModeDefnsCord_223_223, STATE_VARIABLE_IntTypeClassesCord_0_26, &STATE_VARIABLE_IntTypeClassesCord_224_224, STATE_VARIABLE_IntInstancesCord_0_28, &STATE_VARIABLE_IntInstancesCord_225_225, STATE_VARIABLE_IntPredDeclsCord_0_30, &STATE_VARIABLE_IntPredDeclsCord_226_226, STATE_VARIABLE_IntModeDeclsCord_0_32, &STATE_VARIABLE_IntModeDeclsCord_227_227, STATE_VARIABLE_IntForeignEnumsCord_0_34, &STATE_VARIABLE_IntForeignEnumsCord_228_228, STATE_VARIABLE_IntPragmasCord_0_36, &STATE_VARIABLE_IntPragmasCord_229_229, STATE_VARIABLE_IntPromisesCord_0_38, &STATE_VARIABLE_IntPromisesCord_230_230, STATE_VARIABLE_IntModulesNeededByTypeClassDefns_0_40, &STATE_VARIABLE_IntModulesNeededByTypeClassDefns_231_231);
            STATE_VARIABLE_ImpIncls_205_205 = STATE_VARIABLE_ImpIncls_0_4;
            STATE_VARIABLE_ImpImportsUses_206_206 = STATE_VARIABLE_ImpImportsUses_0_8;
            STATE_VARIABLE_ImpExplicitFIMSpecs_208_208 = STATE_VARIABLE_ImpExplicitFIMSpecs_0_12;
            STATE_VARIABLE_ImpImplicitFIMLangs_209_209 = STATE_VARIABLE_ImpImplicitFIMLangs_0_16;
            STATE_VARIABLE_ImpTypesMap_210_210 = STATE_VARIABLE_ImpTypesMap_0_42;
            STATE_VARIABLE_ImpTypeClassesCord_211_211 = STATE_VARIABLE_ImpTypeClassesCord_0_44;
            STATE_VARIABLE_ImpForeignEnumsCord_212_212 = STATE_VARIABLE_ImpForeignEnumsCord_0_46;
            STATE_VARIABLE_ImpModulesNeededByTypeClassDefns_213_213 = STATE_VARIABLE_ImpModulesNeededByTypeClassDefns_0_48;
          }
          break;
      }
      // direct tailcall eliminated
      ;
      next_value_of_HeadVar__1_1 = SrcItemBlocks_123;
      next_value_of_STATE_VARIABLE_IntIncls_0_2 = STATE_VARIABLE_IntIncls_215_215;
      next_value_of_STATE_VARIABLE_ImpIncls_0_4 = STATE_VARIABLE_ImpIncls_205_205;
      next_value_of_STATE_VARIABLE_IntImportsUses_0_6 = STATE_VARIABLE_IntImportsUses_216_216;
      next_value_of_STATE_VARIABLE_ImpImportsUses_0_8 = STATE_VARIABLE_ImpImportsUses_206_206;
      next_value_of_STATE_VARIABLE_IntExplicitFIMSpecs_0_10 = STATE_VARIABLE_IntExplicitFIMSpecs_218_218;
      next_value_of_STATE_VARIABLE_ImpExplicitFIMSpecs_0_12 = STATE_VARIABLE_ImpExplicitFIMSpecs_208_208;
      next_value_of_STATE_VARIABLE_IntImplicitFIMLangs_0_14 = STATE_VARIABLE_IntImplicitFIMLangs_219_219;
      next_value_of_STATE_VARIABLE_ImpImplicitFIMLangs_0_16 = STATE_VARIABLE_ImpImplicitFIMLangs_209_209;
      next_value_of_STATE_VARIABLE_IntTypesMap_0_18 = STATE_VARIABLE_IntTypesMap_220_220;
      next_value_of_STATE_VARIABLE_IntTypeDefnsCord_0_20 = STATE_VARIABLE_IntTypeDefnsCord_221_221;
      next_value_of_STATE_VARIABLE_IntInstDefnsCord_0_22 = STATE_VARIABLE_IntInstDefnsCord_222_222;
      next_value_of_STATE_VARIABLE_IntModeDefnsCord_0_24 = STATE_VARIABLE_IntModeDefnsCord_223_223;
      next_value_of_STATE_VARIABLE_IntTypeClassesCord_0_26 = STATE_VARIABLE_IntTypeClassesCord_224_224;
      next_value_of_STATE_VARIABLE_IntInstancesCord_0_28 = STATE_VARIABLE_IntInstancesCord_225_225;
      next_value_of_STATE_VARIABLE_IntPredDeclsCord_0_30 = STATE_VARIABLE_IntPredDeclsCord_226_226;
      next_value_of_STATE_VARIABLE_IntModeDeclsCord_0_32 = STATE_VARIABLE_IntModeDeclsCord_227_227;
      next_value_of_STATE_VARIABLE_IntForeignEnumsCord_0_34 = STATE_VARIABLE_IntForeignEnumsCord_228_228;
      next_value_of_STATE_VARIABLE_IntPragmasCord_0_36 = STATE_VARIABLE_IntPragmasCord_229_229;
      next_value_of_STATE_VARIABLE_IntPromisesCord_0_38 = STATE_VARIABLE_IntPromisesCord_230_230;
      next_value_of_STATE_VARIABLE_IntModulesNeededByTypeClassDefns_0_40 = STATE_VARIABLE_IntModulesNeededByTypeClassDefns_231_231;
      next_value_of_STATE_VARIABLE_ImpTypesMap_0_42 = STATE_VARIABLE_ImpTypesMap_210_210;
      next_value_of_STATE_VARIABLE_ImpTypeClassesCord_0_44 = STATE_VARIABLE_ImpTypeClassesCord_211_211;
      next_value_of_STATE_VARIABLE_ImpForeignEnumsCord_0_46 = STATE_VARIABLE_ImpForeignEnumsCord_212_212;
      next_value_of_STATE_VARIABLE_ImpModulesNeededByTypeClassDefns_0_48 = STATE_VARIABLE_ImpModulesNeededByTypeClassDefns_213_213;
      HeadVar__1_1 = next_value_of_HeadVar__1_1;
  ...
  MR_Word * STATE_VARIABLE_ImpModulesNeededByTypeClassDefns_11)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      MR_Word STATE_VARIABLE_ImpForeignEnumsCord_75_75;
      MR_Word STATE_VARIABLE_ImpImplicitFIMLangs_76_76;
      MR_Word STATE_VARIABLE_ImpTypeClassesCord_77_77;
      MR_Word STATE_VARIABLE_ImpModulesNeededByTypeClassDefns_79_79;
      MR_Word STATE_VARIABLE_ImpTypesMap_81_81;
      MR_Word next_value_of_HeadVar__1_1;
      MR_Word next_value_of_STATE_VARIABLE_ImpImplicitFIMLangs_0_2;
        ...
        case (MR_Integer) 1:
          {
            ...
            Var_80 = mercury__list__length_1_f_0((MR_Word) (&parse_tree__comp_unit_interface_scalar_common_2[9]), TypeParams_36);
            {
              TypeCtor_41 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
              MR_hl_field(MR_mktag(0), TypeCtor_41, 0) = ((MR_Box) (Name_35));
              MR_hl_field(MR_mktag(0), TypeCtor_41, 1) = ((MR_Box) (Var_80));
            }
            mercury__multi_map__set_4_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_type_ctor_0), (MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_type_defn_info_0), ((MR_Box) (TypeCtor_41)), ((MR_Box) (ItemTypeDefn_34)), STATE_VARIABLE_ImpTypesMap_0_4, &STATE_VARIABLE_ImpTypesMap_81_81);
            STATE_VARIABLE_ImpImplicitFIMLangs_76_76 = STATE_VARIABLE_ImpImplicitFIMLangs_0_2;
            STATE_VARIABLE_ImpTypeClassesCord_77_77 = STATE_VARIABLE_ImpTypeClassesCord_0_6;
            STATE_VARIABLE_ImpForeignEnumsCord_75_75 = STATE_VARIABLE_ImpForeignEnumsCord_0_8;
            STATE_VARIABLE_ImpModulesNeededByTypeClassDefns_79_79 = STATE_VARIABLE_ImpModulesNeededByTypeClassDefns_0_10;
          }
          break;
        case (MR_Integer) 3:
          switch (((MR_Integer) ((MR_hl_field(MR_mktag(3), Item_27, (MR_Integer) 0))))) {
            ...
            case (MR_Integer) 3:
              {
                MR_Word ItemForeignEnum_44 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Item_27, (MR_Integer) 1))));
                MR_Word Lang_45 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), ItemForeignEnum_44, (MR_Integer) 0))) & (MR_Integer) 3);
                MR_Word Values_46 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ItemForeignEnum_44, (MR_Integer) 2))));
                MR_Word FESpec_49;
                MR_Word TypeCtor_87 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ItemForeignEnum_44, (MR_Integer) 1))));

                {
                  FESpec_49 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
                  MR_hl_field(MR_mktag(0), FESpec_49, 0) = (MR_Box) ((MR_Unsigned) (Lang_45));
                  MR_hl_field(MR_mktag(0), FESpec_49, 1) = ((MR_Box) (TypeCtor_87));
                  MR_hl_field(MR_mktag(0), FESpec_49, 2) = ((MR_Box) (Values_46));
                }
                mercury__cord__snoc_3_p_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_foreign_enum_spec_0), ((MR_Box) (FESpec_49)), STATE_VARIABLE_ImpForeignEnumsCord_0_8, &STATE_VARIABLE_ImpForeignEnumsCord_75_75);
                mercury__set__insert_3_p_0((MR_Word) (&libs__globals__libs__globals__type_ctor_info_foreign_language_0), ((MR_Box) (Lang_45)), STATE_VARIABLE_ImpImplicitFIMLangs_0_2, &STATE_VARIABLE_ImpImplicitFIMLangs_76_76);
                STATE_VARIABLE_ImpTypesMap_81_81 = STATE_VARIABLE_ImpTypesMap_0_4;
                STATE_VARIABLE_ImpTypeClassesCord_77_77 = STATE_VARIABLE_ImpTypeClassesCord_0_6;
                STATE_VARIABLE_ImpModulesNeededByTypeClassDefns_79_79 = STATE_VARIABLE_ImpModulesNeededByTypeClassDefns_0_10;
              }
              break;
            case (MR_Integer) 7:
              {
                ...
                MR_Box conv1_STATE_VARIABLE_ImpModulesNeededByTypeClassDefns_79_79;

                mercury__cord__snoc_3_p_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_typeclass_info_0), ((MR_Box) (ItemTypeClass_42)), STATE_VARIABLE_ImpTypeClassesCord_0_6, &STATE_VARIABLE_ImpTypeClassesCord_77_77);
                Constraints_43 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ItemTypeClass_42, (MR_Integer) 2))));
                mercury__list__foldl_4_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_constraint_0), (MR_Word) (&parse_tree__comp_unit_interface_scalar_common_2[4]), (MR_Word) (&parse_tree__comp_unit_interface_scalar_common_1[18]), Constraints_43, ((MR_Box) (STATE_VARIABLE_ImpModulesNeededByTypeClassDefns_0_10)), &conv1_STATE_VARIABLE_ImpModulesNeededByTypeClassDefns_79_79);
                STATE_VARIABLE_ImpModulesNeededByTypeClassDefns_79_79 = ((MR_Word) (conv1_STATE_VARIABLE_ImpModulesNeededByTypeClassDefns_79_79));
                STATE_VARIABLE_ImpImplicitFIMLangs_76_76 = STATE_VARIABLE_ImpImplicitFIMLangs_0_2;
                STATE_VARIABLE_ImpTypesMap_81_81 = STATE_VARIABLE_ImpTypesMap_0_4;
                STATE_VARIABLE_ImpForeignEnumsCord_75_75 = STATE_VARIABLE_ImpForeignEnumsCord_0_8;
              }
      ...
      next_value_of_STATE_VARIABLE_ImpImplicitFIMLangs_0_2 = STATE_VARIABLE_ImpImplicitFIMLangs_76_76;
      next_value_of_STATE_VARIABLE_ImpTypesMap_0_4 = STATE_VARIABLE_ImpTypesMap_81_81;
      next_value_of_STATE_VARIABLE_ImpTypeClassesCord_0_6 = STATE_VARIABLE_ImpTypeClassesCord_77_77;
      next_value_of_STATE_VARIABLE_ImpForeignEnumsCord_0_8 = STATE_VARIABLE_ImpForeignEnumsCord_75_75;
      next_value_of_STATE_VARIABLE_ImpModulesNeededByTypeClassDefns_0_10 = STATE_VARIABLE_ImpModulesNeededByTypeClassDefns_79_79;
      HeadVar__1_1 = next_value_of_HeadVar__1_1;
      STATE_VARIABLE_ImpImplicitFIMLangs_0_2 = next_value_of_STATE_VARIABLE_ImpImplicitFIMLangs_0_2;
...
{
  {
    ...
    succeeded = parse_tree__comp_unit_interface__IntroducedFrom__pred__get_interface_int1_items_loop_int__1379__1_2_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))));
    return succeeded;
  }
}
  ...
  MR_Word * STATE_VARIABLE_IntModulesNeededByTypeClassDefns_27)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      MR_Word STATE_VARIABLE_IntPromisesCord_150_150;
      MR_Word STATE_VARIABLE_IntPragmasCord_151_151;
      MR_Word STATE_VARIABLE_IntForeignEnumsCord_156_156;
      MR_Word STATE_VARIABLE_IntModeDeclsCord_158_158;
      MR_Word STATE_VARIABLE_IntPredDeclsCord_159_159;
      MR_Word STATE_VARIABLE_IntInstancesCord_160_160;
      MR_Word STATE_VARIABLE_IntTypeClassesCord_161_161;
      MR_Word STATE_VARIABLE_IntModulesNeededByTypeClassDefns_163_163;
      MR_Word STATE_VARIABLE_IntModeDefnsCord_164_164;
      MR_Word STATE_VARIABLE_IntInstDefnsCord_165_165;
      MR_Word STATE_VARIABLE_IntTypesMap_167_167;
      MR_Word STATE_VARIABLE_IntTypeDefnsCord_168_168;
      MR_Word STATE_VARIABLE_IntImplicitFIMLangs_169_169;
      MR_Word next_value_of_HeadVar__1_1;
      ...
      switch (MR_tag((MR_Word) Item_67)) {
        ...
        case (MR_Integer) 0:
          {
            STATE_VARIABLE_IntImplicitFIMLangs_169_169 = STATE_VARIABLE_IntImplicitFIMLangs_0_2;
            STATE_VARIABLE_IntTypesMap_167_167 = STATE_VARIABLE_IntTypesMap_0_4;
            STATE_VARIABLE_IntTypeDefnsCord_168_168 = STATE_VARIABLE_IntTypeDefnsCord_0_6;
            STATE_VARIABLE_IntInstDefnsCord_165_165 = STATE_VARIABLE_IntInstDefnsCord_0_8;
            STATE_VARIABLE_IntModeDefnsCord_164_164 = STATE_VARIABLE_IntModeDefnsCord_0_10;
            STATE_VARIABLE_IntTypeClassesCord_161_161 = STATE_VARIABLE_IntTypeClassesCord_0_12;
            STATE_VARIABLE_IntInstancesCord_160_160 = STATE_VARIABLE_IntInstancesCord_0_14;
            STATE_VARIABLE_IntPredDeclsCord_159_159 = STATE_VARIABLE_IntPredDeclsCord_0_16;
            STATE_VARIABLE_IntModeDeclsCord_158_158 = STATE_VARIABLE_IntModeDeclsCord_0_18;
            STATE_VARIABLE_IntForeignEnumsCord_156_156 = STATE_VARIABLE_IntForeignEnumsCord_0_20;
            STATE_VARIABLE_IntPragmasCord_151_151 = STATE_VARIABLE_IntPragmasCord_0_22;
            STATE_VARIABLE_IntPromisesCord_150_150 = STATE_VARIABLE_IntPromisesCord_0_24;
            STATE_VARIABLE_IntModulesNeededByTypeClassDefns_163_163 = STATE_VARIABLE_IntModulesNeededByTypeClassDefns_0_26;
          }
          break;
        case (MR_Integer) 1:
          {
            ...
            Var_166 = mercury__list__length_1_f_0((MR_Word) (&parse_tree__comp_unit_interface_scalar_common_2[9]), TypeParams_84);
            {
              TypeCtor_89 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
              MR_hl_field(MR_mktag(0), TypeCtor_89, 0) = ((MR_Box) (Name_83));
              MR_hl_field(MR_mktag(0), TypeCtor_89, 1) = ((MR_Box) (Var_166));
            }
            mercury__multi_map__set_4_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_type_ctor_0), (MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_type_defn_info_0), ((MR_Box) (TypeCtor_89)), ((MR_Box) (ItemTypeDefn_82)), STATE_VARIABLE_IntTypesMap_0_4, &STATE_VARIABLE_IntTypesMap_167_167);
            mercury__cord__snoc_3_p_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_type_defn_info_0), ((MR_Box) (ItemTypeDefn_82)), STATE_VARIABLE_IntTypeDefnsCord_0_6, &STATE_VARIABLE_IntTypeDefnsCord_168_168);
            ...
            if (succeeded)
            {
              ...
              mercury__set__insert_3_p_0((MR_Word) (&libs__globals__libs__globals__type_ctor_info_foreign_language_0), ((MR_Box) (Lang_94)), STATE_VARIABLE_IntImplicitFIMLangs_0_2, &STATE_VARIABLE_IntImplicitFIMLangs_169_169);
            }
            else
              STATE_VARIABLE_IntImplicitFIMLangs_169_169 = STATE_VARIABLE_IntImplicitFIMLangs_0_2;
            STATE_VARIABLE_IntInstDefnsCord_165_165 = STATE_VARIABLE_IntInstDefnsCord_0_8;
        ...
        case (MR_Integer) 2:
          {
            MR_Word ItemInstDefn_95 = (MR_Word) (MR_body((MR_Word) (Item_67), (MR_Integer) 2));

            mercury__cord__snoc_3_p_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_inst_defn_info_0), ((MR_Box) (ItemInstDefn_95)), STATE_VARIABLE_IntInstDefnsCord_0_8, &STATE_VARIABLE_IntInstDefnsCord_165_165);
            STATE_VARIABLE_IntImplicitFIMLangs_169_169 = STATE_VARIABLE_IntImplicitFIMLangs_0_2;
            STATE_VARIABLE_IntTypesMap_167_167 = STATE_VARIABLE_IntTypesMap_0_4;
            STATE_VARIABLE_IntTypeDefnsCord_168_168 = STATE_VARIABLE_IntTypeDefnsCord_0_6;
            STATE_VARIABLE_IntModeDefnsCord_164_164 = STATE_VARIABLE_IntModeDefnsCord_0_10;
        ...
        case (MR_Integer) 3:
          switch (((MR_Integer) ((MR_hl_field(MR_mktag(3), Item_67, (MR_Integer) 0))))) {
            ...
            case (MR_Integer) 0:
              {
                MR_Word ItemModeDefn_96 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Item_67, (MR_Integer) 1))));

                mercury__cord__snoc_3_p_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_mode_defn_info_0), ((MR_Box) (ItemModeDefn_96)), STATE_VARIABLE_IntModeDefnsCord_0_10, &STATE_VARIABLE_IntModeDefnsCord_164_164);
                STATE_VARIABLE_IntImplicitFIMLangs_169_169 = STATE_VARIABLE_IntImplicitFIMLangs_0_2;
                STATE_VARIABLE_IntTypesMap_167_167 = STATE_VARIABLE_IntTypesMap_0_4;
                STATE_VARIABLE_IntTypeDefnsCord_168_168 = STATE_VARIABLE_IntTypeDefnsCord_0_6;
                STATE_VARIABLE_IntInstDefnsCord_165_165 = STATE_VARIABLE_IntInstDefnsCord_0_8;
            ...
            case (MR_Integer) 1:
              {
                ...
                mercury__cord__snoc_3_p_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_pred_decl_info_0), ((MR_Box) (ItemPredDecl_100)), STATE_VARIABLE_IntPredDeclsCord_0_16, &STATE_VARIABLE_IntPredDeclsCord_159_159);
                STATE_VARIABLE_IntImplicitFIMLangs_169_169 = STATE_VARIABLE_IntImplicitFIMLangs_0_2;
                STATE_VARIABLE_IntTypesMap_167_167 = STATE_VARIABLE_IntTypesMap_0_4;
                STATE_VARIABLE_IntTypeDefnsCord_168_168 = STATE_VARIABLE_IntTypeDefnsCord_0_6;
                STATE_VARIABLE_IntInstDefnsCord_165_165 = STATE_VARIABLE_IntInstDefnsCord_0_8;
            ...
            case (MR_Integer) 2:
              {
                ...
                mercury__cord__snoc_3_p_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_mode_decl_info_0), ((MR_Box) (ItemModeDecl_101)), STATE_VARIABLE_IntModeDeclsCord_0_18, &STATE_VARIABLE_IntModeDeclsCord_158_158);
                STATE_VARIABLE_IntImplicitFIMLangs_169_169 = STATE_VARIABLE_IntImplicitFIMLangs_0_2;
                STATE_VARIABLE_IntTypesMap_167_167 = STATE_VARIABLE_IntTypesMap_0_4;
                STATE_VARIABLE_IntTypeDefnsCord_168_168 = STATE_VARIABLE_IntTypeDefnsCord_0_6;
                STATE_VARIABLE_IntInstDefnsCord_165_165 = STATE_VARIABLE_IntInstDefnsCord_0_8;
            ...
            case (MR_Integer) 3:
              {
                ...
                MR_Word Values_103 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ItemForeignEnum_102, (MR_Integer) 2))));
                MR_Word ForeignEnumSpec_106;
                MR_Word TypeCtor_183 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ItemForeignEnum_102, (MR_Integer) 1))));
                MR_Word Lang_184 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), ItemForeignEnum_102, (MR_Integer) 0))) & (MR_Integer) 3);

                {
                  ForeignEnumSpec_106 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
                  MR_hl_field(MR_mktag(0), ForeignEnumSpec_106, 0) = (MR_Box) ((MR_Unsigned) (Lang_184));
                  MR_hl_field(MR_mktag(0), ForeignEnumSpec_106, 1) = ((MR_Box) (TypeCtor_183));
                  MR_hl_field(MR_mktag(0), ForeignEnumSpec_106, 2) = ((MR_Box) (Values_103));
                }
                mercury__cord__snoc_3_p_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_foreign_enum_spec_0), ((MR_Box) (ForeignEnumSpec_106)), STATE_VARIABLE_IntForeignEnumsCord_0_20, &STATE_VARIABLE_IntForeignEnumsCord_156_156);
                mercury__set__insert_3_p_0((MR_Word) (&libs__globals__libs__globals__type_ctor_info_foreign_language_0), ((MR_Box) (Lang_184)), STATE_VARIABLE_IntImplicitFIMLangs_0_2, &STATE_VARIABLE_IntImplicitFIMLangs_169_169);
                STATE_VARIABLE_IntTypesMap_167_167 = STATE_VARIABLE_IntTypesMap_0_4;
                STATE_VARIABLE_IntTypeDefnsCord_168_168 = STATE_VARIABLE_IntTypeDefnsCord_0_6;
                STATE_VARIABLE_IntInstDefnsCord_165_165 = STATE_VARIABLE_IntInstDefnsCord_0_8;
                STATE_VARIABLE_IntModeDefnsCord_164_164 = STATE_VARIABLE_IntModeDefnsCord_0_10;
            ...
            case (MR_Integer) 5:
              {
                ...
                MR_Word AllowedInInterface_112;

                AllowedInInterface_112 = parse_tree__prog_item__pragma_allowed_in_interface_1_f_0(Pragma_108);
                switch (AllowedInInterface_112) {
                  default: /*NOTREACHED*/ MR_assert(0);
                  case (MR_Integer) 0:
                    STATE_VARIABLE_IntPragmasCord_151_151 = STATE_VARIABLE_IntPragmasCord_0_22;
                    break;
                  case (MR_Integer) 1:
                    {
                      ...
                      mercury__cord__snoc_3_p_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_pragma_info_0), ((MR_Box) (ItemPragma_107)), STATE_VARIABLE_IntPragmasCord_0_22, &STATE_VARIABLE_IntPragmasCord_151_151);
                      Langs_113 = parse_tree__item_util__pragma_needs_foreign_imports_1_f_0(Pragma_108);
                      {
                        Var_152 = (MR_Word) MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL);
                        MR_hl_field(MR_mktag(0), Var_152, 0) = ((MR_Box) (&parse_tree__comp_unit_interface_scalar_common_5[4]));
                        MR_hl_field(MR_mktag(0), Var_152, 1) = ((MR_Box) (parse_tree__comp_unit_interface__get_interface_int1_items_loop_int_27_p_0_1));
                        MR_hl_field(MR_mktag(0), Var_152, 2) = ((MR_Box) ((MR_Integer) 2));
                        MR_hl_field(MR_mktag(0), Var_152, 3) = ((MR_Box) (Langs_113));
                        MR_hl_field(MR_mktag(0), Var_152, 4) = ((MR_Box) ((MR_Unsigned) 0U));
                      }
                      mercury__require__expect_3_p_0(Var_152, (MR_String) "predicate \140parse_tree.comp_unit_interface.get_interface_int1_items_loop_int\'/27", (MR_String) "interface pragma needs Langs");
                    }
                    break;
                }
                STATE_VARIABLE_IntImplicitFIMLangs_169_169 = STATE_VARIABLE_IntImplicitFIMLangs_0_2;
            ...
            case (MR_Integer) 6:
              {
                MR_Word ItemPromise_114 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Item_67, (MR_Integer) 1))));
                MR_Word PromiseType_115 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), ItemPromise_114, (MR_Integer) 0))) & (MR_Integer) 3);

                switch (PromiseType_115) {
                  default: /*NOTREACHED*/ MR_assert(0);
                  case (MR_Integer) 0:
                  case (MR_Integer) 2:
                  case (MR_Integer) 1:
                    {
                      mercury__cord__snoc_3_p_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_promise_info_0), ((MR_Box) (ItemPromise_114)), STATE_VARIABLE_IntPromisesCord_0_24, &STATE_VARIABLE_IntPromisesCord_150_150);
                    }
                    break;
                  case (MR_Integer) 3:
                    STATE_VARIABLE_IntPromisesCord_150_150 = STATE_VARIABLE_IntPromisesCord_0_24;
            ...
            case (MR_Integer) 7:
              {
                ...
                MR_Box conv1_STATE_VARIABLE_IntModulesNeededByTypeClassDefns_163_163;

                mercury__cord__snoc_3_p_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_typeclass_info_0), ((MR_Box) (ItemTypeClass_97)), STATE_VARIABLE_IntTypeClassesCord_0_12, &STATE_VARIABLE_IntTypeClassesCord_161_161);
                Constraints_98 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ItemTypeClass_97, (MR_Integer) 2))));
                mercury__list__foldl_4_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_constraint_0), (MR_Word) (&parse_tree__comp_unit_interface_scalar_common_2[4]), (MR_Word) (&parse_tree__comp_unit_interface_scalar_common_1[17]), Constraints_98, ((MR_Box) (STATE_VARIABLE_IntModulesNeededByTypeClassDefns_0_26)), &conv1_STATE_VARIABLE_IntModulesNeededByTypeClassDefns_163_163);
                STATE_VARIABLE_IntModulesNeededByTypeClassDefns_163_163 = ((MR_Word) (conv1_STATE_VARIABLE_IntModulesNeededByTypeClassDefns_163_163));
                STATE_VARIABLE_IntImplicitFIMLangs_169_169 = STATE_VARIABLE_IntImplicitFIMLangs_0_2;
                STATE_VARIABLE_IntTypesMap_167_167 = STATE_VARIABLE_IntTypesMap_0_4;
                STATE_VARIABLE_IntTypeDefnsCord_168_168 = STATE_VARIABLE_IntTypeDefnsCord_0_6;
                STATE_VARIABLE_IntInstDefnsCord_165_165 = STATE_VARIABLE_IntInstDefnsCord_0_8;
            ...
            case (MR_Integer) 8:
              {
                ...
                mercury__cord__snoc_3_p_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_instance_info_0), ((MR_Box) (ItemInstance_99)), STATE_VARIABLE_IntInstancesCord_0_14, &STATE_VARIABLE_IntInstancesCord_160_160);
                STATE_VARIABLE_IntImplicitFIMLangs_169_169 = STATE_VARIABLE_IntImplicitFIMLangs_0_2;
                STATE_VARIABLE_IntTypesMap_167_167 = STATE_VARIABLE_IntTypesMap_0_4;
                STATE_VARIABLE_IntTypeDefnsCord_168_168 = STATE_VARIABLE_IntTypeDefnsCord_0_6;
                STATE_VARIABLE_IntInstDefnsCord_165_165 = STATE_VARIABLE_IntInstDefnsCord_0_8;
      ...
      next_value_of_STATE_VARIABLE_IntImplicitFIMLangs_0_2 = STATE_VARIABLE_IntImplicitFIMLangs_169_169;
      next_value_of_STATE_VARIABLE_IntTypesMap_0_4 = STATE_VARIABLE_IntTypesMap_167_167;
      next_value_of_STATE_VARIABLE_IntTypeDefnsCord_0_6 = STATE_VARIABLE_IntTypeDefnsCord_168_168;
      next_value_of_STATE_VARIABLE_IntInstDefnsCord_0_8 = STATE_VARIABLE_IntInstDefnsCord_165_165;
      next_value_of_STATE_VARIABLE_IntModeDefnsCord_0_10 = STATE_VARIABLE_IntModeDefnsCord_164_164;
      next_value_of_STATE_VARIABLE_IntTypeClassesCord_0_12 = STATE_VARIABLE_IntTypeClassesCord_161_161;
      next_value_of_STATE_VARIABLE_IntInstancesCord_0_14 = STATE_VARIABLE_IntInstancesCord_160_160;
      next_value_of_STATE_VARIABLE_IntPredDeclsCord_0_16 = STATE_VARIABLE_IntPredDeclsCord_159_159;
      next_value_of_STATE_VARIABLE_IntModeDeclsCord_0_18 = STATE_VARIABLE_IntModeDeclsCord_158_158;
      next_value_of_STATE_VARIABLE_IntForeignEnumsCord_0_20 = STATE_VARIABLE_IntForeignEnumsCord_156_156;
      next_value_of_STATE_VARIABLE_IntPragmasCord_0_22 = STATE_VARIABLE_IntPragmasCord_151_151;
      next_value_of_STATE_VARIABLE_IntPromisesCord_0_24 = STATE_VARIABLE_IntPromisesCord_150_150;
      next_value_of_STATE_VARIABLE_IntModulesNeededByTypeClassDefns_0_26 = STATE_VARIABLE_IntModulesNeededByTypeClassDefns_163_163;
      HeadVar__1_1 = next_value_of_HeadVar__1_1;
  ...
  MR_Word * STATE_VARIABLE_ImpItemsCord_3)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      MR_Word STATE_VARIABLE_ImpItemsCord_36_36;
      MR_Word next_value_of_HeadVar__1_1;
      ...
      switch (MR_tag((MR_Word) Item_7)) {
        default: /*NOTREACHED*/ MR_assert(0);
        case (MR_Integer) 0:
          STATE_VARIABLE_ImpItemsCord_36_36 = STATE_VARIABLE_ImpItemsCord_0_2;
          break;
        case (MR_Integer) 1:
          {
            ...
            mercury__cord__snoc_3_p_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_0), ((MR_Box) (AbstractItem_12)), STATE_VARIABLE_ImpItemsCord_0_2, &STATE_VARIABLE_ImpItemsCord_36_36);
          }
          break;
        case (MR_Integer) 2:
          STATE_VARIABLE_ImpItemsCord_36_36 = STATE_VARIABLE_ImpItemsCord_0_2;
        ...
        case (MR_Integer) 3:
          switch (((MR_Integer) ((MR_hl_field(MR_mktag(3), Item_7, (MR_Integer) 0))))) {
            ...
            case (MR_Integer) 3:
              {
                mercury__cord__snoc_3_p_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_0), ((MR_Box) (Item_7)), STATE_VARIABLE_ImpItemsCord_0_2, &STATE_VARIABLE_ImpItemsCord_36_36);
              }
              break;
            case (MR_Integer) 4:
              STATE_VARIABLE_ImpItemsCord_36_36 = STATE_VARIABLE_ImpItemsCord_0_2;
            ...
            case (MR_Integer) 7:
              {
                ...
                {
                  AbstractItem_38 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                  MR_hl_field(MR_mktag(3), AbstractItem_38, 0) = ((MR_Box) ((MR_Unsigned) 7U));
                  MR_hl_field(MR_mktag(3), AbstractItem_38, 1) = ((MR_Box) (AbstractItemTypeClassInfo_14));
                }
                mercury__cord__snoc_3_p_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_0), ((MR_Box) (AbstractItem_38)), STATE_VARIABLE_ImpItemsCord_0_2, &STATE_VARIABLE_ImpItemsCord_36_36);
              }
              break;
            case (MR_Integer) 8:
              STATE_VARIABLE_ImpItemsCord_36_36 = STATE_VARIABLE_ImpItemsCord_0_2;
      ...
      next_value_of_STATE_VARIABLE_ImpItemsCord_0_2 = STATE_VARIABLE_ImpItemsCord_36_36;
      HeadVar__1_1 = next_value_of_HeadVar__1_1;
    ...
    switch (MR_tag((MR_Word) TypeDefn_5)) {
      ...
      case (MR_Integer) 3:
        switch (((MR_Integer) ((MR_hl_field(MR_mktag(3), TypeDefn_5, (MR_Integer) 0))))) {
          ...
          case (MR_Integer) 1:
            {
              MR_Word DetailsForeign_17 = ((MR_Word) ((MR_hl_field(MR_mktag(3), TypeDefn_5, (MR_Integer) 1))));
              ...
              else
              {
                ...
                {
                  AbstractTypeDefn_30 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                  MR_hl_field(MR_mktag(3), AbstractTypeDefn_30, 0) = ((MR_Box) ((MR_Unsigned) 1U));
                  MR_hl_field(MR_mktag(3), AbstractTypeDefn_30, 1) = ((MR_Box) (AbstractDetailsForeign_20));
                }
                {
                  MR_Word base;
                  base = (MR_Word) MR_new_object(MR_Word, (6 * sizeof(MR_Word)), NULL, NULL);
      ...
      if (succeeded)
      {
        ItemInstance_10 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Item_7, (MR_Integer) 1))));
        {
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(3), AbstractItem_12, 0) = ((MR_Box) ((MR_Unsigned) 8U));
...
{
  {
    ...
    MR_Word IntForeignEnumsCord_43;
    MR_Word ImpForeignEnumsCord_44;
    MR_Word IntPragmasCord_45;
    MR_Word ImpPragmasCord_46;
    MR_Word IntPromisesCord_47;
    MR_Word ImpPromisesCord_48;
    MR_Word MaybeVersionNumbers_50;
    MR_Word IntUses_51;
    MR_Word IntImportsUses_52;
    ...
    MR_Word ImpInstDefns_59;
    MR_Word IntModeDefns_60;
    MR_Word ImpModeDefns_61;
    MR_Word IntTypeClasses_62;
    MR_Word ImpTypeClasses_63;
    MR_Word IntInstances_64;
    MR_Word ImpInstances_65;
    MR_Word IntPredDecls_66;
    MR_Word ImpPredDecls_67;
    MR_Word IntModeDecls_68;
    MR_Word ImpModeDecls_69;
    MR_Word IntForeignEnums_70;
    MR_Word ImpForeignEnums_71;
    MR_Word IntPragmas_72;
    MR_Word ImpPragmas_73;
    MR_Word IntPromises_74;
    MR_Word ImpPromises_75;
    MR_Word IntTypeDefnMap_76;
    MR_Word IntInstDefnMap_77;
    MR_Word IntModeDefnMap_78;
    MR_Word ImpTypeDefnMap_79;
    MR_Word ImpInstDefnMap_80;
    MR_Word ImpModeDefnMap_81;
    MR_Word IntForeignEnumMap_82;
    MR_Word ImpForeignEnumMap_83;
    MR_Word ParseTreeInt0Prime_84;
    MR_Word Var_85;
    MR_Word Var_86;
    MR_Word Var_87;
    MR_Word Var_88;
    ...
    MR_Box conv0_VersionNumbers_49;
    ...
    mercury__set__init_1_p_0((MR_Word) (&parse_tree__prog_data_foreign__parse_tree__prog_data_foreign__type_ctor_info_fim_spec_0), &IntFIMSpecs0_19);
    mercury__set__init_1_p_0((MR_Word) (&parse_tree__prog_data_foreign__parse_tree__prog_data_foreign__type_ctor_info_fim_spec_0), &ImpFIMSpecs0_20);
    Var_85 = mercury__cord__init_0_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_type_defn_info_0));
    ...
    Var_88 = mercury__cord__init_0_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_inst_defn_info_0));
    Var_89 = mercury__cord__init_0_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_mode_defn_info_0));
    Var_90 = mercury__cord__init_0_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_mode_defn_info_0));
    Var_91 = mercury__cord__init_0_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_typeclass_info_0));
    Var_92 = mercury__cord__init_0_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_typeclass_info_0));
    Var_93 = mercury__cord__init_0_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_instance_info_0));
    Var_94 = mercury__cord__init_0_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_instance_info_0));
    ...
    Var_96 = mercury__cord__init_0_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_pred_decl_info_0));
    Var_97 = mercury__cord__init_0_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_mode_decl_info_0));
    Var_98 = mercury__cord__init_0_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_mode_decl_info_0));
    Var_99 = mercury__cord__init_0_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_foreign_enum_spec_0));
    Var_100 = mercury__cord__init_0_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_foreign_enum_spec_0));
    Var_101 = mercury__cord__init_0_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_pragma_info_0));
    Var_102 = mercury__cord__init_0_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_pragma_info_0));
    Var_103 = mercury__cord__init_0_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_promise_info_0));
    Var_104 = mercury__cord__init_0_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_promise_info_0));
    parse_tree__comp_unit_interface__get_private_interface_int0_from_item_blocks_58_p_0(ModuleName_5, SrcItemBlocks_8, IntIncls0_13, &IntIncls_21, ImpIncls0_14, &ImpIncls_22, IntImports0_15, &IntImports_23, IntUses0_16, &IntUses1_24, ImpImports0_17, &ImpImports1_25, ImpUses0_18, &ImpUses1_26, IntFIMSpecs0_19, &IntFIMSpecs_27, ImpFIMSpecs0_20, &ImpFIMSpecs_28, Var_85, &IntTypeDefnsCord_29, Var_86, &ImpTypeDefnsCord_30, Var_87, &IntInstDefnsCord_31, Var_88, &ImpInstDefnsCord_32, Var_89, &IntModeDefnsCord_33, Var_90, &ImpModeDefnsCord_34, Var_91, &IntTypeClassesCord_35, Var_92, &ImpTypeClassesCord_36, Var_93, &IntInstancesCord_37, Var_94, &ImpInstancesCord_38, Var_95, &IntPredDeclsCord_39, Var_96, &ImpPredDeclsCord_40, Var_97, &IntModeDeclsCord_41, Var_98, &ImpModeDeclsCord_42, Var_99, &IntForeignEnumsCord_43, Var_100, &ImpForeignEnumsCord_44, Var_101, &IntPragmasCord_45, Var_102, &ImpPragmasCord_46, Var_103, &IntPromisesCord_47, Var_104, &ImpPromisesCord_48);
    succeeded = mercury__map__search_3_p_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), (MR_Word) (&recompilation__recompilation__type_ctor_info_version_numbers_0), ModuleVersionNumbers_7, ((MR_Box) (ModuleName_5)), &conv0_VersionNumbers_49);
    if (succeeded)
    {
      VersionNumbers_49 = ((MR_Word) (conv0_VersionNumbers_49));
      succeeded = MR_TRUE;
    }
    if (succeeded)
      {
        MaybeVersionNumbers_50 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), MaybeVersionNumbers_50, 0) = ((MR_Box) (VersionNumbers_49));
      }
    else
      MaybeVersionNumbers_50 = (MR_Word) ((MR_Unsigned) 0U);
    mercury__set__difference_3_p_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), IntUses1_24, IntImports_23, &IntUses_51);
    mercury__set__union_3_p_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), IntImports_23, IntUses_51, &IntImportsUses_52);
    mercury__set__difference_3_p_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), ImpImports1_25, IntImportsUses_52, &ImpImports_53);
    mercury__set__difference_3_p_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), ImpUses1_26, IntImportsUses_52, &ImpUses2_54);
    mercury__set__difference_3_p_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), ImpUses2_54, ImpImports_53, &ImpUses_55);
    IntTypeDefns_56 = mercury__cord__list_1_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_type_defn_info_0), IntTypeDefnsCord_29);
    ImpTypeDefns_57 = mercury__cord__list_1_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_type_defn_info_0), ImpTypeDefnsCord_30);
    IntInstDefns_58 = mercury__cord__list_1_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_inst_defn_info_0), IntInstDefnsCord_31);
    ImpInstDefns_59 = mercury__cord__list_1_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_inst_defn_info_0), ImpInstDefnsCord_32);
    IntModeDefns_60 = mercury__cord__list_1_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_mode_defn_info_0), IntModeDefnsCord_33);
    ImpModeDefns_61 = mercury__cord__list_1_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_mode_defn_info_0), ImpModeDefnsCord_34);
    IntTypeClasses_62 = mercury__cord__list_1_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_typeclass_info_0), IntTypeClassesCord_35);
    ImpTypeClasses_63 = mercury__cord__list_1_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_typeclass_info_0), ImpTypeClassesCord_36);
    IntInstances_64 = mercury__cord__list_1_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_instance_info_0), IntInstancesCord_37);
    ImpInstances_65 = mercury__cord__list_1_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_instance_info_0), ImpInstancesCord_38);
    IntPredDecls_66 = mercury__cord__list_1_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_pred_decl_info_0), IntPredDeclsCord_39);
    ImpPredDecls_67 = mercury__cord__list_1_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_pred_decl_info_0), ImpPredDeclsCord_40);
    IntModeDecls_68 = mercury__cord__list_1_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_mode_decl_info_0), IntModeDeclsCord_41);
    ImpModeDecls_69 = mercury__cord__list_1_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_mode_decl_info_0), ImpModeDeclsCord_42);
    IntForeignEnums_70 = mercury__cord__list_1_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_foreign_enum_spec_0), IntForeignEnumsCord_43);
    ImpForeignEnums_71 = mercury__cord__list_1_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_foreign_enum_spec_0), ImpForeignEnumsCord_44);
    IntPragmas_72 = mercury__cord__list_1_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_pragma_info_0), IntPragmasCord_45);
    ImpPragmas_73 = mercury__cord__list_1_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_pragma_info_0), ImpPragmasCord_46);
    IntPromises_74 = mercury__cord__list_1_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_promise_info_0), IntPromisesCord_47);
    ImpPromises_75 = mercury__cord__list_1_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_promise_info_0), ImpPromisesCord_48);
    IntTypeDefnMap_76 = parse_tree__prog_item__type_ctor_defn_items_to_map_1_f_0(IntTypeDefns_56);
    IntInstDefnMap_77 = parse_tree__prog_item__inst_ctor_defn_items_to_map_1_f_0(IntInstDefns_58);
    IntModeDefnMap_78 = parse_tree__prog_item__mode_ctor_defn_items_to_map_1_f_0(IntModeDefns_60);
    ImpTypeDefnMap_79 = parse_tree__prog_item__type_ctor_defn_items_to_map_1_f_0(ImpTypeDefns_57);
    ImpInstDefnMap_80 = parse_tree__prog_item__inst_ctor_defn_items_to_map_1_f_0(ImpInstDefns_59);
    ImpModeDefnMap_81 = parse_tree__prog_item__mode_ctor_defn_items_to_map_1_f_0(ImpModeDefns_61);
    IntForeignEnumMap_82 = parse_tree__prog_item__type_ctor_foreign_enum_specs_to_map_1_f_0(IntForeignEnums_70);
    ImpForeignEnumMap_83 = parse_tree__prog_item__type_ctor_foreign_enum_specs_to_map_1_f_0(ImpForeignEnums_71);
    {
      ParseTreeInt0Prime_84 = (MR_Word) MR_new_object(MR_Word, (31 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), ParseTreeInt0Prime_84, 0) = ((MR_Box) (ModuleName_5));
      MR_hl_field(MR_mktag(0), ParseTreeInt0Prime_84, 1) = ((MR_Box) (ModuleNameContext_6));
      MR_hl_field(MR_mktag(0), ParseTreeInt0Prime_84, 2) = ((MR_Box) (MaybeVersionNumbers_50));
      MR_hl_field(MR_mktag(0), ParseTreeInt0Prime_84, 3) = ((MR_Box) (IntIncls_21));
      MR_hl_field(MR_mktag(0), ParseTreeInt0Prime_84, 4) = ((MR_Box) (ImpIncls_22));
      MR_hl_field(MR_mktag(0), ParseTreeInt0Prime_84, 5) = ((MR_Box) (IntImports_23));
      MR_hl_field(MR_mktag(0), ParseTreeInt0Prime_84, 6) = ((MR_Box) (IntUses_51));
      MR_hl_field(MR_mktag(0), ParseTreeInt0Prime_84, 7) = ((MR_Box) (ImpImports_53));
      MR_hl_field(MR_mktag(0), ParseTreeInt0Prime_84, 8) = ((MR_Box) (ImpUses_55));
      MR_hl_field(MR_mktag(0), ParseTreeInt0Prime_84, 9) = ((MR_Box) (IntFIMSpecs_27));
      MR_hl_field(MR_mktag(0), ParseTreeInt0Prime_84, 10) = ((MR_Box) (ImpFIMSpecs_28));
      MR_hl_field(MR_mktag(0), ParseTreeInt0Prime_84, 11) = ((MR_Box) (IntTypeDefnMap_76));
      MR_hl_field(MR_mktag(0), ParseTreeInt0Prime_84, 12) = ((MR_Box) (IntInstDefnMap_77));
      MR_hl_field(MR_mktag(0), ParseTreeInt0Prime_84, 13) = ((MR_Box) (IntModeDefnMap_78));
      MR_hl_field(MR_mktag(0), ParseTreeInt0Prime_84, 14) = ((MR_Box) (IntTypeClasses_62));
      MR_hl_field(MR_mktag(0), ParseTreeInt0Prime_84, 15) = ((MR_Box) (IntInstances_64));
      MR_hl_field(MR_mktag(0), ParseTreeInt0Prime_84, 16) = ((MR_Box) (IntPredDecls_66));
      MR_hl_field(MR_mktag(0), ParseTreeInt0Prime_84, 17) = ((MR_Box) (IntModeDecls_68));
      MR_hl_field(MR_mktag(0), ParseTreeInt0Prime_84, 18) = ((MR_Box) (IntForeignEnumMap_82));
      MR_hl_field(MR_mktag(0), ParseTreeInt0Prime_84, 19) = ((MR_Box) (IntPragmas_72));
      MR_hl_field(MR_mktag(0), ParseTreeInt0Prime_84, 20) = ((MR_Box) (IntPromises_74));
      MR_hl_field(MR_mktag(0), ParseTreeInt0Prime_84, 21) = ((MR_Box) (ImpTypeDefnMap_79));
      MR_hl_field(MR_mktag(0), ParseTreeInt0Prime_84, 22) = ((MR_Box) (ImpInstDefnMap_80));
      MR_hl_field(MR_mktag(0), ParseTreeInt0Prime_84, 23) = ((MR_Box) (ImpModeDefnMap_81));
      MR_hl_field(MR_mktag(0), ParseTreeInt0Prime_84, 24) = ((MR_Box) (ImpTypeClasses_63));
      MR_hl_field(MR_mktag(0), ParseTreeInt0Prime_84, 25) = ((MR_Box) (ImpInstances_65));
      MR_hl_field(MR_mktag(0), ParseTreeInt0Prime_84, 26) = ((MR_Box) (ImpPredDecls_67));
      MR_hl_field(MR_mktag(0), ParseTreeInt0Prime_84, 27) = ((MR_Box) (ImpModeDecls_69));
      MR_hl_field(MR_mktag(0), ParseTreeInt0Prime_84, 28) = ((MR_Box) (ImpForeignEnumMap_83));
      MR_hl_field(MR_mktag(0), ParseTreeInt0Prime_84, 29) = ((MR_Box) (ImpPragmas_73));
      MR_hl_field(MR_mktag(0), ParseTreeInt0Prime_84, 30) = ((MR_Box) (ImpPromises_75));
    }
    *ParseTreeInt0_4 = parse_tree__prog_item__convert_parse_tree_int0_to_parse_tree_int_1_f_0(ParseTreeInt0Prime_84);
  }
}
        ...
        case (MR_Integer) 1:
          {
            ...
            mercury__list__foldl_4_p_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_include_0), (MR_Word) (&parse_tree__comp_unit_interface_scalar_common_2[4]), (MR_Word) (&parse_tree__comp_unit_interface_scalar_common_1[9]), Incls_177, ((MR_Box) (STATE_VARIABLE_ImpIncls_0_5)), &conv1_STATE_VARIABLE_ImpIncls_240_240);
            ...
            Var_241 = mercury__list__map_2_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_avail_import_info_0), (MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), (MR_Word) (&parse_tree__comp_unit_interface_scalar_common_1[10]), Imports_307);
            ...
            Var_244 = mercury__list__map_2_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_avail_use_info_0), (MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), (MR_Word) (&parse_tree__comp_unit_interface_scalar_common_1[11]), Uses_308);
            ...
            mercury__list__foldl_4_p_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_fim_0), (MR_Word) (&parse_tree__comp_unit_interface_scalar_common_2[5]), (MR_Word) (&parse_tree__comp_unit_interface_scalar_common_1[12]), FIMs_179, ((MR_Box) (STATE_VARIABLE_ImpFIMSpecs_0_17)), &conv5_STATE_VARIABLE_ImpFIMSpecs_248_248);
        ...
        case (MR_Integer) 0:
          {
            ...
            mercury__list__foldl_4_p_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_include_0), (MR_Word) (&parse_tree__comp_unit_interface_scalar_common_2[4]), (MR_Word) (&parse_tree__comp_unit_interface_scalar_common_1[13]), Incls_177, ((MR_Box) (STATE_VARIABLE_IntIncls_0_3)), &conv7_STATE_VARIABLE_IntIncls_260_260);
            ...
            Var_261 = mercury__list__map_2_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_avail_import_info_0), (MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), (MR_Word) (&parse_tree__comp_unit_interface_scalar_common_1[14]), Imports_181);
            ...
            Var_264 = mercury__list__map_2_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_avail_use_info_0), (MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), (MR_Word) (&parse_tree__comp_unit_interface_scalar_common_1[15]), Uses_182);
            ...
            mercury__list__foldl_4_p_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_fim_0), (MR_Word) (&parse_tree__comp_unit_interface_scalar_common_2[5]), (MR_Word) (&parse_tree__comp_unit_interface_scalar_common_1[16]), FIMs_179, ((MR_Box) (STATE_VARIABLE_IntFIMSpecs_0_15)), &conv11_STATE_VARIABLE_IntFIMSpecs_268_268);
  ...
  MR_Word * STATE_VARIABLE_Promises_22)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      MR_Word STATE_VARIABLE_Pragmas_130_130;
      MR_Word STATE_VARIABLE_ForeignEnums_131_131;
      MR_Word STATE_VARIABLE_Instances_133_133;
      MR_Word STATE_VARIABLE_TypeClasses_134_134;
      MR_Word STATE_VARIABLE_ModeDecls_135_135;
      MR_Word STATE_VARIABLE_PredDecls_136_136;
      MR_Word STATE_VARIABLE_ModeDefns_137_137;
      MR_Word STATE_VARIABLE_InstDefns_138_138;
      MR_Word STATE_VARIABLE_TypeDefns_139_139;
      MR_Word next_value_of_HeadVar__2_2;
      ...
      switch (MR_tag((MR_Word) Item_55)) {
        ...
        case (MR_Integer) 0:
          {
            STATE_VARIABLE_TypeDefns_139_139 = STATE_VARIABLE_TypeDefns_0_3;
            STATE_VARIABLE_InstDefns_138_138 = STATE_VARIABLE_InstDefns_0_5;
            STATE_VARIABLE_ModeDefns_137_137 = STATE_VARIABLE_ModeDefns_0_7;
            STATE_VARIABLE_TypeClasses_134_134 = STATE_VARIABLE_TypeClasses_0_9;
            STATE_VARIABLE_Instances_133_133 = STATE_VARIABLE_Instances_0_11;
            STATE_VARIABLE_PredDecls_136_136 = STATE_VARIABLE_PredDecls_0_13;
            STATE_VARIABLE_ModeDecls_135_135 = STATE_VARIABLE_ModeDecls_0_15;
            STATE_VARIABLE_ForeignEnums_131_131 = STATE_VARIABLE_ForeignEnums_0_17;
            STATE_VARIABLE_Pragmas_130_130 = STATE_VARIABLE_Pragmas_0_19;
            STATE_VARIABLE_Promises_129_129 = STATE_VARIABLE_Promises_0_21;
          }
          break;
        case (MR_Integer) 1:
          {
            MR_Word TypeDefn_67 = (MR_Word) (MR_body((MR_Word) (Item_55), (MR_Integer) 1));

            mercury__cord__snoc_3_p_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_type_defn_info_0), ((MR_Box) (TypeDefn_67)), STATE_VARIABLE_TypeDefns_0_3, &STATE_VARIABLE_TypeDefns_139_139);
            STATE_VARIABLE_InstDefns_138_138 = STATE_VARIABLE_InstDefns_0_5;
            STATE_VARIABLE_ModeDefns_137_137 = STATE_VARIABLE_ModeDefns_0_7;
            STATE_VARIABLE_TypeClasses_134_134 = STATE_VARIABLE_TypeClasses_0_9;
            STATE_VARIABLE_Instances_133_133 = STATE_VARIABLE_Instances_0_11;
        ...
        case (MR_Integer) 2:
          {
            MR_Word InstDefn_68 = (MR_Word) (MR_body((MR_Word) (Item_55), (MR_Integer) 2));

            mercury__cord__snoc_3_p_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_inst_defn_info_0), ((MR_Box) (InstDefn_68)), STATE_VARIABLE_InstDefns_0_5, &STATE_VARIABLE_InstDefns_138_138);
            STATE_VARIABLE_TypeDefns_139_139 = STATE_VARIABLE_TypeDefns_0_3;
            STATE_VARIABLE_ModeDefns_137_137 = STATE_VARIABLE_ModeDefns_0_7;
            STATE_VARIABLE_TypeClasses_134_134 = STATE_VARIABLE_TypeClasses_0_9;
            STATE_VARIABLE_Instances_133_133 = STATE_VARIABLE_Instances_0_11;
        ...
        case (MR_Integer) 3:
          switch (((MR_Integer) ((MR_hl_field(MR_mktag(3), Item_55, (MR_Integer) 0))))) {
            ...
            case (MR_Integer) 0:
              {
                MR_Word ModeDefn_69 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Item_55, (MR_Integer) 1))));

                mercury__cord__snoc_3_p_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_mode_defn_info_0), ((MR_Box) (ModeDefn_69)), STATE_VARIABLE_ModeDefns_0_7, &STATE_VARIABLE_ModeDefns_137_137);
                STATE_VARIABLE_TypeDefns_139_139 = STATE_VARIABLE_TypeDefns_0_3;
                STATE_VARIABLE_InstDefns_138_138 = STATE_VARIABLE_InstDefns_0_5;
                STATE_VARIABLE_TypeClasses_134_134 = STATE_VARIABLE_TypeClasses_0_9;
                STATE_VARIABLE_Instances_133_133 = STATE_VARIABLE_Instances_0_11;
            ...
            case (MR_Integer) 1:
              {
                ...
                mercury__cord__snoc_3_p_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_pred_decl_info_0), ((MR_Box) (PredDecl_70)), STATE_VARIABLE_PredDecls_0_13, &STATE_VARIABLE_PredDecls_136_136);
                STATE_VARIABLE_TypeDefns_139_139 = STATE_VARIABLE_TypeDefns_0_3;
                STATE_VARIABLE_InstDefns_138_138 = STATE_VARIABLE_InstDefns_0_5;
                STATE_VARIABLE_ModeDefns_137_137 = STATE_VARIABLE_ModeDefns_0_7;
                STATE_VARIABLE_TypeClasses_134_134 = STATE_VARIABLE_TypeClasses_0_9;
            ...
            case (MR_Integer) 2:
              {
                ...
                mercury__cord__snoc_3_p_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_mode_decl_info_0), ((MR_Box) (ModeDecl_71)), STATE_VARIABLE_ModeDecls_0_15, &STATE_VARIABLE_ModeDecls_135_135);
                STATE_VARIABLE_TypeDefns_139_139 = STATE_VARIABLE_TypeDefns_0_3;
                STATE_VARIABLE_InstDefns_138_138 = STATE_VARIABLE_InstDefns_0_5;
                STATE_VARIABLE_ModeDefns_137_137 = STATE_VARIABLE_ModeDefns_0_7;
                STATE_VARIABLE_TypeClasses_134_134 = STATE_VARIABLE_TypeClasses_0_9;
            ...
            case (MR_Integer) 3:
              {
                ...
                MR_Word Lang_76 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), ItemForeignEnumInfo_75, (MR_Integer) 0))) & (MR_Integer) 3);
                MR_Word TypeCtor_77 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ItemForeignEnumInfo_75, (MR_Integer) 1))));
                MR_Word Values_78 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ItemForeignEnumInfo_75, (MR_Integer) 2))));
                MR_Word ForeignEnumSpec_81;

                {
                  ForeignEnumSpec_81 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
                  MR_hl_field(MR_mktag(0), ForeignEnumSpec_81, 0) = (MR_Box) ((MR_Unsigned) (Lang_76));
                  MR_hl_field(MR_mktag(0), ForeignEnumSpec_81, 1) = ((MR_Box) (TypeCtor_77));
                  MR_hl_field(MR_mktag(0), ForeignEnumSpec_81, 2) = ((MR_Box) (Values_78));
                }
                mercury__cord__snoc_3_p_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_foreign_enum_spec_0), ((MR_Box) (ForeignEnumSpec_81)), STATE_VARIABLE_ForeignEnums_0_17, &STATE_VARIABLE_ForeignEnums_131_131);
                STATE_VARIABLE_TypeDefns_139_139 = STATE_VARIABLE_TypeDefns_0_3;
                STATE_VARIABLE_InstDefns_138_138 = STATE_VARIABLE_InstDefns_0_5;
                STATE_VARIABLE_ModeDefns_137_137 = STATE_VARIABLE_ModeDefns_0_7;
                STATE_VARIABLE_TypeClasses_134_134 = STATE_VARIABLE_TypeClasses_0_9;
            ...
            case (MR_Integer) 5:
              {
                MR_Word ItemPragma_82 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Item_55, (MR_Integer) 1))));
                MR_Word Pragma_83 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ItemPragma_82, (MR_Integer) 0))));
                MR_Word AllowedInInterface_87;

                AllowedInInterface_87 = parse_tree__prog_item__pragma_allowed_in_interface_1_f_0(Pragma_83);
                switch (AllowedInInterface_87) {
                  default: /*NOTREACHED*/ MR_assert(0);
                  case (MR_Integer) 0:
                    STATE_VARIABLE_Pragmas_130_130 = STATE_VARIABLE_Pragmas_0_19;
                    break;
                  case (MR_Integer) 1:
                    {
                      mercury__cord__snoc_3_p_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_pragma_info_0), ((MR_Box) (ItemPragma_82)), STATE_VARIABLE_Pragmas_0_19, &STATE_VARIABLE_Pragmas_130_130);
                    }
                    break;
                }
                STATE_VARIABLE_TypeDefns_139_139 = STATE_VARIABLE_TypeDefns_0_3;
            ...
            case (MR_Integer) 6:
              {
                MR_Word Promise_88 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Item_55, (MR_Integer) 1))));

                mercury__cord__snoc_3_p_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_promise_info_0), ((MR_Box) (Promise_88)), STATE_VARIABLE_Promises_0_21, &STATE_VARIABLE_Promises_129_129);
                STATE_VARIABLE_TypeDefns_139_139 = STATE_VARIABLE_TypeDefns_0_3;
                STATE_VARIABLE_InstDefns_138_138 = STATE_VARIABLE_InstDefns_0_5;
                STATE_VARIABLE_ModeDefns_137_137 = STATE_VARIABLE_ModeDefns_0_7;
                STATE_VARIABLE_TypeClasses_134_134 = STATE_VARIABLE_TypeClasses_0_9;
            ...
            case (MR_Integer) 7:
              {
                ...
                mercury__cord__snoc_3_p_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_typeclass_info_0), ((MR_Box) (TypeClass_72)), STATE_VARIABLE_TypeClasses_0_9, &STATE_VARIABLE_TypeClasses_134_134);
                STATE_VARIABLE_TypeDefns_139_139 = STATE_VARIABLE_TypeDefns_0_3;
                STATE_VARIABLE_InstDefns_138_138 = STATE_VARIABLE_InstDefns_0_5;
                STATE_VARIABLE_ModeDefns_137_137 = STATE_VARIABLE_ModeDefns_0_7;
                STATE_VARIABLE_Instances_133_133 = STATE_VARIABLE_Instances_0_11;
            ...
            case (MR_Integer) 8:
              {
                ...
                MR_Word Var_152 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Instance_73, (MR_Integer) 0))));
                MR_Word Var_153 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Instance_73, (MR_Integer) 1))));
                MR_Word Var_154 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Instance_73, (MR_Integer) 2))));
                MR_Word Var_155 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Instance_73, (MR_Integer) 3))));
                MR_Word Var_157 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Instance_73, (MR_Integer) 5))));
                MR_Word Var_158 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Instance_73, (MR_Integer) 6))));
                MR_Word Var_159 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Instance_73, (MR_Integer) 7))));
                MR_Integer Var_160 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), Instance_73, (MR_Integer) 8))));

                {
                  AbstractInstance_74 = (MR_Word) MR_new_object(MR_Word, (9 * sizeof(MR_Word)), NULL, NULL);
                  MR_hl_field(MR_mktag(0), AbstractInstance_74, 0) = ((MR_Box) (Var_152));
                  MR_hl_field(MR_mktag(0), AbstractInstance_74, 1) = ((MR_Box) (Var_153));
                  MR_hl_field(MR_mktag(0), AbstractInstance_74, 2) = ((MR_Box) (Var_154));
                  MR_hl_field(MR_mktag(0), AbstractInstance_74, 3) = ((MR_Box) (Var_155));
                  MR_hl_field(MR_mktag(0), AbstractInstance_74, 4) = ((MR_Box) ((MR_Unsigned) 0U));
                  MR_hl_field(MR_mktag(0), AbstractInstance_74, 5) = ((MR_Box) (Var_157));
                  MR_hl_field(MR_mktag(0), AbstractInstance_74, 6) = ((MR_Box) (Var_158));
                  MR_hl_field(MR_mktag(0), AbstractInstance_74, 7) = ((MR_Box) (Var_159));
                  MR_hl_field(MR_mktag(0), AbstractInstance_74, 8) = ((MR_Box) (Var_160));
                }
                mercury__cord__snoc_3_p_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_instance_info_0), ((MR_Box) (AbstractInstance_74)), STATE_VARIABLE_Instances_0_11, &STATE_VARIABLE_Instances_133_133);
                STATE_VARIABLE_TypeDefns_139_139 = STATE_VARIABLE_TypeDefns_0_3;
                STATE_VARIABLE_InstDefns_138_138 = STATE_VARIABLE_InstDefns_0_5;
                STATE_VARIABLE_ModeDefns_137_137 = STATE_VARIABLE_ModeDefns_0_7;
                STATE_VARIABLE_TypeClasses_134_134 = STATE_VARIABLE_TypeClasses_0_9;
            ...
            case (MR_Integer) 11:
              {
                MR_Word ItemMutable_89 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Item_55, (MR_Integer) 1))));
                MR_String MutableName_90 = ((MR_String) ((MR_hl_field(MR_mktag(0), ItemMutable_89, (MR_Integer) 0))));
                MR_Word Type_92 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ItemMutable_89, (MR_Integer) 2))));
                MR_Word Inst_94 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ItemMutable_89, (MR_Integer) 4))));
                MR_Word MutAttrs_97 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ItemMutable_89, (MR_Integer) 7))));
                MR_Word Context_98 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ItemMutable_89, (MR_Integer) 8))));
                MR_Word PublicAuxPreds_99;
                MR_Word PublicAuxPredDecls_100;
                MR_Word Var_126;
                MR_Word Var_128;

                parse_tree__prog_mutable__compute_needed_public_mutable_aux_preds_2_p_0(MutAttrs_97, &PublicAuxPreds_99);
                {
                  Var_126 = (MR_Word) MR_new_object(MR_Word, (8 * sizeof(MR_Word)), NULL, NULL);
                  MR_hl_field(MR_mktag(0), Var_126, 0) = ((MR_Box) (&parse_tree__comp_unit_interface_scalar_common_6[0]));
                  MR_hl_field(MR_mktag(0), Var_126, 1) = ((MR_Box) (parse_tree__comp_unit_interface__get_private_interface_int0_from_items_22_p_0_1));
                  MR_hl_field(MR_mktag(0), Var_126, 2) = ((MR_Box) ((MR_Integer) 5));
                  MR_hl_field(MR_mktag(0), Var_126, 3) = ((MR_Box) (HeadVar__1_1));
                  MR_hl_field(MR_mktag(0), Var_126, 4) = ((MR_Box) (MutableName_90));
                  MR_hl_field(MR_mktag(0), Var_126, 5) = ((MR_Box) (Type_92));
                  MR_hl_field(MR_mktag(0), Var_126, 6) = ((MR_Box) (Inst_94));
                  MR_hl_field(MR_mktag(0), Var_126, 7) = ((MR_Box) (Context_98));
                }
                mercury__list__map_3_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mutable_pred_kind_0), (MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_pred_decl_info_0), Var_126, PublicAuxPreds_99, &PublicAuxPredDecls_100);
                Var_128 = mercury__cord__from_list_1_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_pred_decl_info_0), PublicAuxPredDecls_100);
                STATE_VARIABLE_PredDecls_136_136 = mercury__cord__f_43_43_2_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_pred_decl_info_0), STATE_VARIABLE_PredDecls_0_13, Var_128);
                STATE_VARIABLE_TypeDefns_139_139 = STATE_VARIABLE_TypeDefns_0_3;
                STATE_VARIABLE_InstDefns_138_138 = STATE_VARIABLE_InstDefns_0_5;
                STATE_VARIABLE_ModeDefns_137_137 = STATE_VARIABLE_ModeDefns_0_7;
                STATE_VARIABLE_TypeClasses_134_134 = STATE_VARIABLE_TypeClasses_0_9;
      ...
      next_value_of_STATE_VARIABLE_TypeDefns_0_3 = STATE_VARIABLE_TypeDefns_139_139;
      next_value_of_STATE_VARIABLE_InstDefns_0_5 = STATE_VARIABLE_InstDefns_138_138;
      next_value_of_STATE_VARIABLE_ModeDefns_0_7 = STATE_VARIABLE_ModeDefns_137_137;
      next_value_of_STATE_VARIABLE_TypeClasses_0_9 = STATE_VARIABLE_TypeClasses_134_134;
      next_value_of_STATE_VARIABLE_Instances_0_11 = STATE_VARIABLE_Instances_133_133;
      next_value_of_STATE_VARIABLE_PredDecls_0_13 = STATE_VARIABLE_PredDecls_136_136;
      next_value_of_STATE_VARIABLE_ModeDecls_0_15 = STATE_VARIABLE_ModeDecls_135_135;
      next_value_of_STATE_VARIABLE_ForeignEnums_0_17 = STATE_VARIABLE_ForeignEnums_131_131;
      next_value_of_STATE_VARIABLE_Pragmas_0_19 = STATE_VARIABLE_Pragmas_130_130;
      next_value_of_STATE_VARIABLE_Promises_0_21 = STATE_VARIABLE_Promises_129_129;
      HeadVar__2_2 = next_value_of_HeadVar__2_2;
...
{
  {
    ...
    MR_Word OrigIntTypeDefnsCord_18;
    MR_Word IntTypeDefnsCord_19;
    MR_Word IntInstDefnsCord_20;
    MR_Word IntModeDefnsCord_21;
    MR_Word IntTypeClassesCord_22;
    MR_Word IntInstancesCord_23;
    MR_Word OrigImpTypeDefnsCord_24;
    MR_Word IntImpForeignEnumTypeCtors_25;
    ...
    MR_Word IntInstDefnMap_34;
    MR_Word IntModeDefnMap_35;
    ...
    Var_46 = mercury__set__init_0_f_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0));
    ...
    Var_49 = mercury__cord__init_0_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_inst_defn_info_0));
    Var_50 = mercury__cord__init_0_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_mode_defn_info_0));
    Var_51 = mercury__cord__init_0_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_typeclass_info_0));
    Var_52 = mercury__cord__init_0_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_instance_info_0));
    Var_53 = mercury__cord__init_0_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_type_defn_info_0));
    Var_54 = mercury__map__init_0_f_0((MR_Word) (&parse_tree__decide_type_repn__parse_tree__decide_type_repn__type_ctor_info_unqual_type_ctor_0), (MR_Word) (&parse_tree__comp_unit_interface_scalar_common_2[1]));
    parse_tree__comp_unit_interface__get_short_interface_int3_from_item_blocks_23_p_0(RawItemBlocks_15, Var_45, &IntInclModuleNames_16, Var_46, &IntImportModuleNames0_17, Var_47, &OrigIntTypeDefnsCord_18, Var_48, &IntTypeDefnsCord_19, Var_49, &IntInstDefnsCord_20, Var_50, &IntModeDefnsCord_21, Var_51, &IntTypeClassesCord_22, Var_52, &IntInstancesCord_23, Var_53, &OrigImpTypeDefnsCord_24, Var_54, &IntImpForeignEnumTypeCtors_25, (MR_Integer) 0, &NeedImports_26);
    ...
    IntTypeDefns_28 = mercury__cord__list_1_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_type_defn_info_0), IntTypeDefnsCord_19);
    IntInstDefns_29 = mercury__cord__list_1_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_inst_defn_info_0), IntInstDefnsCord_20);
    IntModeDefns_30 = mercury__cord__list_1_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_mode_defn_info_0), IntModeDefnsCord_21);
    IntTypeClasses_31 = mercury__cord__list_1_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_typeclass_info_0), IntTypeClassesCord_22);
    IntInstances_32 = mercury__cord__list_1_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_instance_info_0), IntInstancesCord_23);
    IntTypeDefnMap_33 = parse_tree__prog_item__type_ctor_defn_items_to_map_1_f_0(IntTypeDefns_28);
    IntInstDefnMap_34 = parse_tree__prog_item__inst_ctor_defn_items_to_map_1_f_0(IntInstDefns_29);
    IntModeDefnMap_35 = parse_tree__prog_item__mode_ctor_defn_items_to_map_1_f_0(IntModeDefns_30);
    libs__globals__lookup_bool_option_3_p_0(Globals_4, (MR_Integer) 695, &Experiment1_36);
    switch (Experiment1_36) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        {
          mercury__map__init_1_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_type_ctor_0), (MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_type_repn_info_0), &IntTypeRepnMap_37);
        }
        break;
      case (MR_Integer) 1:
        {
          ...
          MR_Word IntTypeRepnInfos_40;
          MR_Word _NonIntTypeRepnInfos_41;

          OrigIntTypeDefns_38 = mercury__cord__list_1_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_type_defn_info_0), OrigIntTypeDefnsCord_18);
          OrigImpTypeDefns_39 = mercury__cord__list_1_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_type_defn_info_0), OrigImpTypeDefnsCord_24);
          parse_tree__decide_type_repn__decide_repns_for_simple_types_6_p_0(ModuleName_7, OrigIntTypeDefns_38, OrigImpTypeDefns_39, IntImpForeignEnumTypeCtors_25, &IntTypeRepnInfos_40, &_NonIntTypeRepnInfos_41);
          IntTypeRepnMap_37 = parse_tree__prog_item__type_ctor_repn_items_to_map_1_f_0(IntTypeRepnInfos_40);
        }
        break;
    }
    {
      ParseTreeInt3_42 = (MR_Word) MR_new_object(MR_Word, (10 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), ParseTreeInt3_42, 0) = ((MR_Box) (ModuleName_7));
      MR_hl_field(MR_mktag(0), ParseTreeInt3_42, 1) = ((MR_Box) (ModuleNameContext_8));
      MR_hl_field(MR_mktag(0), ParseTreeInt3_42, 2) = ((MR_Box) (IntInclModuleNames_16));
      MR_hl_field(MR_mktag(0), ParseTreeInt3_42, 3) = ((MR_Box) (IntImportModuleNames_27));
      MR_hl_field(MR_mktag(0), ParseTreeInt3_42, 4) = ((MR_Box) (IntTypeDefnMap_33));
      MR_hl_field(MR_mktag(0), ParseTreeInt3_42, 5) = ((MR_Box) (IntInstDefnMap_34));
      MR_hl_field(MR_mktag(0), ParseTreeInt3_42, 6) = ((MR_Box) (IntModeDefnMap_35));
      MR_hl_field(MR_mktag(0), ParseTreeInt3_42, 7) = ((MR_Box) (IntTypeClasses_31));
      MR_hl_field(MR_mktag(0), ParseTreeInt3_42, 8) = ((MR_Box) (IntInstances_32));
      MR_hl_field(MR_mktag(0), ParseTreeInt3_42, 9) = ((MR_Box) (IntTypeRepnMap_37));
    }
    ParseTreeInt23Prime_43 = parse_tree__prog_item__convert_parse_tree_int3_to_parse_tree_int_1_f_0(ParseTreeInt3_42);
    Var_58 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ParseTreeInt23Prime_43, (MR_Integer) 0))));
    Var_60 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ParseTreeInt23Prime_43, (MR_Integer) 2))));
    Var_61 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ParseTreeInt23Prime_43, (MR_Integer) 3))));
    Var_62 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ParseTreeInt23Prime_43, (MR_Integer) 4))));
    Var_63 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ParseTreeInt23Prime_43, (MR_Integer) 5))));
    Var_64 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ParseTreeInt23Prime_43, (MR_Integer) 6))));
    Var_65 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ParseTreeInt23Prime_43, (MR_Integer) 7))));
    Var_66 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ParseTreeInt23Prime_43, (MR_Integer) 8))));
    Var_67 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ParseTreeInt23Prime_43, (MR_Integer) 9))));
    Var_68 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ParseTreeInt23Prime_43, (MR_Integer) 10))));
    Var_69 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ParseTreeInt23Prime_43, (MR_Integer) 11))));
    {
      MR_Word base;
...
{
  {
    ...
    MR_Word OrigIntTypeDefnsCord_14;
    MR_Word IntTypeDefnsCord_15;
    MR_Word IntInstDefnsCord_16;
    MR_Word IntModeDefnsCord_17;
    MR_Word IntTypeClassesCord_18;
    MR_Word IntInstancesCord_19;
    MR_Word OrigImpTypeDefnsCord_20;
    MR_Word IntImpForeignEnumTypeCtors_21;
    ...
    MR_Word IntTypeClasses_27;
    MR_Word IntInstances_28;
    MR_Word IntTypeDefnMap_29;
    MR_Word IntInstDefnMap_30;
    MR_Word IntModeDefnMap_31;
    MR_Word Experiment1_32;
    MR_Word IntTypeRepnMap_33;
    MR_Word ParseTreeInt0_38;
    MR_Word Var_40;
    MR_Word Var_41;
    MR_Word Var_42;
    MR_Word Var_43;
    ...
    Var_43 = mercury__cord__init_0_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_type_defn_info_0));
    Var_44 = mercury__cord__init_0_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_inst_defn_info_0));
    Var_45 = mercury__cord__init_0_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_mode_defn_info_0));
    Var_46 = mercury__cord__init_0_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_typeclass_info_0));
    Var_47 = mercury__cord__init_0_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_instance_info_0));
    Var_48 = mercury__cord__init_0_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_type_defn_info_0));
    ...
    parse_tree__comp_unit_interface__get_short_interface_int3_from_item_blocks_23_p_0(RawItemBlocks_11, Var_40, &IntInclModuleNames_12, Var_41, &IntImportModuleNames0_13, Var_42, &OrigIntTypeDefnsCord_14, Var_43, &IntTypeDefnsCord_15, Var_44, &IntInstDefnsCord_16, Var_45, &IntModeDefnsCord_17, Var_46, &IntTypeClassesCord_18, Var_47, &IntInstancesCord_19, Var_48, &OrigImpTypeDefnsCord_20, Var_49, &IntImpForeignEnumTypeCtors_21, (MR_Integer) 0, &NeedImports_22);
    ...
    IntTypeDefns_24 = mercury__cord__list_1_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_type_defn_info_0), IntTypeDefnsCord_15);
    IntInstDefns_25 = mercury__cord__list_1_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_inst_defn_info_0), IntInstDefnsCord_16);
    IntModeDefns_26 = mercury__cord__list_1_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_mode_defn_info_0), IntModeDefnsCord_17);
    IntTypeClasses_27 = mercury__cord__list_1_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_typeclass_info_0), IntTypeClassesCord_18);
    IntInstances_28 = mercury__cord__list_1_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_instance_info_0), IntInstancesCord_19);
    IntTypeDefnMap_29 = parse_tree__prog_item__type_ctor_defn_items_to_map_1_f_0(IntTypeDefns_24);
    IntInstDefnMap_30 = parse_tree__prog_item__inst_ctor_defn_items_to_map_1_f_0(IntInstDefns_25);
    IntModeDefnMap_31 = parse_tree__prog_item__mode_ctor_defn_items_to_map_1_f_0(IntModeDefns_26);
    libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 695, &Experiment1_32);
    switch (Experiment1_32) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        {
          mercury__map__init_1_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_type_ctor_0), (MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_type_repn_info_0), &IntTypeRepnMap_33);
        }
        break;
      case (MR_Integer) 1:
        {
          MR_Word OrigIntTypeDefns_34;
          MR_Word OrigImpTypeDefns_35;
          MR_Word IntTypeRepnInfos_36;
          MR_Word _NonIntTypeRepnInfos_37;

          OrigIntTypeDefns_34 = mercury__cord__list_1_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_type_defn_info_0), OrigIntTypeDefnsCord_14);
          OrigImpTypeDefns_35 = mercury__cord__list_1_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_type_defn_info_0), OrigImpTypeDefnsCord_20);
          parse_tree__decide_type_repn__decide_repns_for_simple_types_6_p_0(ModuleName_9, OrigIntTypeDefns_34, OrigImpTypeDefns_35, IntImpForeignEnumTypeCtors_21, &IntTypeRepnInfos_36, &_NonIntTypeRepnInfos_37);
          IntTypeRepnMap_33 = parse_tree__prog_item__type_ctor_repn_items_to_map_1_f_0(IntTypeRepnInfos_36);
        }
        break;
    }
    {
      ...
      *ParseTreeInt3_7 = base;
      ...
      MR_hl_field(MR_mktag(0), base, 4) = ((MR_Box) (IntTypeDefnMap_29));
      MR_hl_field(MR_mktag(0), base, 5) = ((MR_Box) (IntInstDefnMap_30));
      MR_hl_field(MR_mktag(0), base, 6) = ((MR_Box) (IntModeDefnMap_31));
      MR_hl_field(MR_mktag(0), base, 7) = ((MR_Box) (IntTypeClasses_27));
      MR_hl_field(MR_mktag(0), base, 8) = ((MR_Box) (IntInstances_28));
      MR_hl_field(MR_mktag(0), base, 9) = ((MR_Box) (IntTypeRepnMap_33));
    }
    ParseTreeInt0_38 = parse_tree__prog_item__convert_parse_tree_int3_to_parse_tree_int_1_f_0(*ParseTreeInt3_7);
    parse_tree__module_qual__module_qualify_parse_tree_int3_5_p_0(Globals_5, ParseTreeInt0_38, ParseTreeInt_8, (MR_Word) ((MR_Unsigned) 0U), &_Specs_39);
  }
}
  ...
  MR_Word * STATE_VARIABLE_NeedImports_23)
{
  while (MR_TRUE)
  {
    ...
    if ((HeadVar__1_1 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      ...
      *STATE_VARIABLE_IntImpForeignEnumTypeCtors_21 = STATE_VARIABLE_IntImpForeignEnumTypeCtors_0_20;
    ...
    else
    {
      ...
      MR_Word STATE_VARIABLE_IntInstDefns_109_109;
      MR_Word STATE_VARIABLE_IntModeDefns_110_110;
      MR_Word STATE_VARIABLE_IntTypeClasses_111_111;
      MR_Word STATE_VARIABLE_IntInstances_112_112;
      MR_Word STATE_VARIABLE_IntImpForeignEnumTypeCtors_113_113;
      ...
      MR_Word next_value_of_STATE_VARIABLE_IntImpForeignEnumTypeCtors_0_20;
      ...
      switch (Section_71) {
        ...
        case (MR_Integer) 1:
          {
            parse_tree__comp_unit_interface__get_short_interface_int3_from_items_imp_5_p_0(Items_75, STATE_VARIABLE_OrigImpTypeDefns_0_18, &STATE_VARIABLE_OrigImpTypeDefns_100_100, STATE_VARIABLE_IntImpForeignEnumTypeCtors_0_20, &STATE_VARIABLE_IntImpForeignEnumTypeCtors_113_113);
            ...
            STATE_VARIABLE_OrigIntTypeDefns_107_107 = STATE_VARIABLE_OrigIntTypeDefns_0_6;
            STATE_VARIABLE_IntTypeDefns_108_108 = STATE_VARIABLE_IntTypeDefns_0_8;
            STATE_VARIABLE_IntInstDefns_109_109 = STATE_VARIABLE_IntInstDefns_0_10;
            STATE_VARIABLE_IntModeDefns_110_110 = STATE_VARIABLE_IntModeDefns_0_12;
            STATE_VARIABLE_IntTypeClasses_111_111 = STATE_VARIABLE_IntTypeClasses_0_14;
            STATE_VARIABLE_IntInstances_112_112 = STATE_VARIABLE_IntInstances_0_16;
        ...
        case (MR_Integer) 0:
          {
            ...
            parse_tree__comp_unit_interface__get_short_interface_int3_from_items_int_17_p_0(Items_75, STATE_VARIABLE_OrigIntTypeDefns_0_6, &STATE_VARIABLE_OrigIntTypeDefns_107_107, STATE_VARIABLE_IntTypeDefns_0_8, &STATE_VARIABLE_IntTypeDefns_108_108, STATE_VARIABLE_IntInstDefns_0_10, &STATE_VARIABLE_IntInstDefns_109_109, STATE_VARIABLE_IntModeDefns_0_12, &STATE_VARIABLE_IntModeDefns_110_110, STATE_VARIABLE_IntTypeClasses_0_14, &STATE_VARIABLE_IntTypeClasses_111_111, STATE_VARIABLE_IntInstances_0_16, &STATE_VARIABLE_IntInstances_112_112, STATE_VARIABLE_IntImpForeignEnumTypeCtors_0_20, &STATE_VARIABLE_IntImpForeignEnumTypeCtors_113_113, STATE_VARIABLE_NeedImports_0_22, &STATE_VARIABLE_NeedImports_114_114);
      ...
      next_value_of_STATE_VARIABLE_OrigIntTypeDefns_0_6 = STATE_VARIABLE_OrigIntTypeDefns_107_107;
      next_value_of_STATE_VARIABLE_IntTypeDefns_0_8 = STATE_VARIABLE_IntTypeDefns_108_108;
      next_value_of_STATE_VARIABLE_IntInstDefns_0_10 = STATE_VARIABLE_IntInstDefns_109_109;
      next_value_of_STATE_VARIABLE_IntModeDefns_0_12 = STATE_VARIABLE_IntModeDefns_110_110;
      next_value_of_STATE_VARIABLE_IntTypeClasses_0_14 = STATE_VARIABLE_IntTypeClasses_111_111;
      next_value_of_STATE_VARIABLE_IntInstances_0_16 = STATE_VARIABLE_IntInstances_112_112;
      next_value_of_STATE_VARIABLE_OrigImpTypeDefns_0_18 = STATE_VARIABLE_OrigImpTypeDefns_100_100;
      next_value_of_STATE_VARIABLE_IntImpForeignEnumTypeCtors_0_20 = STATE_VARIABLE_IntImpForeignEnumTypeCtors_113_113;
      ...
      STATE_VARIABLE_IntImpForeignEnumTypeCtors_0_20 = next_value_of_STATE_VARIABLE_IntImpForeignEnumTypeCtors_0_20;
  ...
  MR_Word * STATE_VARIABLE_IntImpForeignEnumTypeCtors_5)
{
  while (MR_TRUE)
  {
    ...
    if ((HeadVar__1_1 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      *STATE_VARIABLE_IntImpForeignEnumTypeCtors_5 = STATE_VARIABLE_IntImpForeignEnumTypeCtors_0_4;
      *STATE_VARIABLE_OrigImpTypeDefns_3 = STATE_VARIABLE_OrigImpTypeDefns_0_2;
    }
    else
    {
      ...
      MR_Word STATE_VARIABLE_IntImpForeignEnumTypeCtors_36_36;
      MR_Word STATE_VARIABLE_OrigImpTypeDefns_37_37;
      MR_Word next_value_of_HeadVar__1_1;
      MR_Word next_value_of_STATE_VARIABLE_OrigImpTypeDefns_0_2;
      MR_Word next_value_of_STATE_VARIABLE_IntImpForeignEnumTypeCtors_0_4;

      switch (MR_tag((MR_Word) Item_12)) {
        default: /*NOTREACHED*/ MR_assert(0);
        case (MR_Integer) 0:
          {
            STATE_VARIABLE_OrigImpTypeDefns_37_37 = STATE_VARIABLE_OrigImpTypeDefns_0_2;
            STATE_VARIABLE_IntImpForeignEnumTypeCtors_36_36 = STATE_VARIABLE_IntImpForeignEnumTypeCtors_0_4;
          }
          break;
        case (MR_Integer) 1:
          {
            ...
            mercury__cord__snoc_3_p_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_type_defn_info_0), ((MR_Box) (ItemTypeDefnInfo_16)), STATE_VARIABLE_OrigImpTypeDefns_0_2, &STATE_VARIABLE_OrigImpTypeDefns_37_37);
            STATE_VARIABLE_IntImpForeignEnumTypeCtors_36_36 = STATE_VARIABLE_IntImpForeignEnumTypeCtors_0_4;
          }
          break;
        case (MR_Integer) 2:
            ...
            case (MR_Integer) 3:
              {
                ...
                MR_Word Lang_45 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), ItemForeignEnumInfo_17, (MR_Integer) 0))) & (MR_Integer) 3);
                MR_Word TypeCtor_46 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ItemForeignEnumInfo_17, (MR_Integer) 1))));
                MR_Word OoMValues_47 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ItemForeignEnumInfo_17, (MR_Integer) 2))));
                MR_Word TypeSymName_50 = ((MR_Word) ((MR_hl_field(MR_mktag(0), TypeCtor_46, (MR_Integer) 0))));
                MR_Integer TypeArity_51 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), TypeCtor_46, (MR_Integer) 1))));
                MR_String TypeName_52;
                MR_Word UnqualTypeCtor_53;
                MR_Word LVs0_54;
                MR_Box conv0_LVs0_54;

                TypeName_52 = mdbcomp__sym_name__unqualify_name_1_f_0(TypeSymName_50);
                {
                  UnqualTypeCtor_53 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
                  MR_hl_field(MR_mktag(0), UnqualTypeCtor_53, 0) = ((MR_Box) (TypeName_52));
                  MR_hl_field(MR_mktag(0), UnqualTypeCtor_53, 1) = ((MR_Box) (TypeArity_51));
                }
                succeeded = mercury__map__search_3_p_0((MR_Word) (&parse_tree__decide_type_repn__parse_tree__decide_type_repn__type_ctor_info_unqual_type_ctor_0), (MR_Word) (&parse_tree__comp_unit_interface_scalar_common_2[1]), STATE_VARIABLE_IntImpForeignEnumTypeCtors_0_4, ((MR_Box) (UnqualTypeCtor_53)), &conv0_LVs0_54);
                if (succeeded)
                {
                  LVs0_54 = ((MR_Word) (conv0_LVs0_54));
                  succeeded = MR_TRUE;
                }
                if (succeeded)
                {
...

                  {
                    ...
                    MR_hl_field(MR_mktag(0), Var_57, 0) = ((MR_Box) (Lang_45));
                    MR_hl_field(MR_mktag(0), Var_57, 1) = ((MR_Box) (OoMValues_47));
                  }
                  {
                    Var_55 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(MR_mktag(1), Var_55, 0) = ((MR_Box) (Var_57));
                    MR_hl_field(MR_mktag(1), Var_55, 1) = ((MR_Box) (LVs0_54));
                  }
                  mercury__map__det_update_4_p_0((MR_Word) (&parse_tree__decide_type_repn__parse_tree__decide_type_repn__type_ctor_info_unqual_type_ctor_0), (MR_Word) (&parse_tree__comp_unit_interface_scalar_common_2[1]), ((MR_Box) (UnqualTypeCtor_53)), ((MR_Box) (Var_55)), STATE_VARIABLE_IntImpForeignEnumTypeCtors_0_4, &STATE_VARIABLE_IntImpForeignEnumTypeCtors_36_36);
                }
                else
                {
                  MR_Word Var_58;
...

                  {
                    ...
                    MR_hl_field(MR_mktag(0), Var_60, 0) = ((MR_Box) (Lang_45));
                    MR_hl_field(MR_mktag(0), Var_60, 1) = ((MR_Box) (OoMValues_47));
                  }
                  {
                  ...
                  mercury__map__det_insert_4_p_0((MR_Word) (&parse_tree__decide_type_repn__parse_tree__decide_type_repn__type_ctor_info_unqual_type_ctor_0), (MR_Word) (&parse_tree__comp_unit_interface_scalar_common_2[1]), ((MR_Box) (UnqualTypeCtor_53)), ((MR_Box) (Var_58)), STATE_VARIABLE_IntImpForeignEnumTypeCtors_0_4, &STATE_VARIABLE_IntImpForeignEnumTypeCtors_36_36);
                }
                STATE_VARIABLE_OrigImpTypeDefns_37_37 = STATE_VARIABLE_OrigImpTypeDefns_0_2;
              }
              break;
      ...
      next_value_of_STATE_VARIABLE_OrigImpTypeDefns_0_2 = STATE_VARIABLE_OrigImpTypeDefns_37_37;
      next_value_of_STATE_VARIABLE_IntImpForeignEnumTypeCtors_0_4 = STATE_VARIABLE_IntImpForeignEnumTypeCtors_36_36;
      HeadVar__1_1 = next_value_of_HeadVar__1_1;
      STATE_VARIABLE_OrigImpTypeDefns_0_2 = next_value_of_STATE_VARIABLE_OrigImpTypeDefns_0_2;
      STATE_VARIABLE_IntImpForeignEnumTypeCtors_0_4 = next_value_of_STATE_VARIABLE_IntImpForeignEnumTypeCtors_0_4;
      continue;
    }
    break;
  }
  ...
  MR_Word * STATE_VARIABLE_NeedImports_17)
{
  while (MR_TRUE)
  {
    ...
    if ((HeadVar__1_1 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      ...
      *STATE_VARIABLE_IntImpForeignEnumTypeCtors_15 = STATE_VARIABLE_IntImpForeignEnumTypeCtors_0_14;
    ...
    else
    {
      ...
      MR_Word STATE_VARIABLE_IntImpForeignEnumTypeCtors_97_97;
      ...
      MR_Word next_value_of_STATE_VARIABLE_IntImpForeignEnumTypeCtors_0_14;
      ...
      switch (MR_tag((MR_Word) Item_42)) {
        ...
        case (MR_Integer) 0:
          {
            ...
            STATE_VARIABLE_IntImpForeignEnumTypeCtors_97_97 = STATE_VARIABLE_IntImpForeignEnumTypeCtors_0_14;
        ...
        case (MR_Integer) 1:
          {
            ...
            mercury__cord__snoc_3_p_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_type_defn_info_0), ((MR_Box) (ItemTypeDefnInfo_52)), STATE_VARIABLE_OrigIntTypeDefns_0_2, &STATE_VARIABLE_OrigIntTypeDefns_109_109);
            ...
            mercury__cord__snoc_3_p_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_type_defn_info_0), ((MR_Box) (AbstractOrForeignItemTypeDefnInfo_53)), STATE_VARIABLE_IntTypeDefns_0_4, &STATE_VARIABLE_IntTypeDefns_110_110);
            STATE_VARIABLE_IntInstDefns_108_108 = STATE_VARIABLE_IntInstDefns_0_6;
            STATE_VARIABLE_IntModeDefns_106_106 = STATE_VARIABLE_IntModeDefns_0_8;
            STATE_VARIABLE_IntTypeClasses_104_104 = STATE_VARIABLE_IntTypeClasses_0_10;
            STATE_VARIABLE_IntInstances_99_99 = STATE_VARIABLE_IntInstances_0_12;
        ...
        case (MR_Integer) 2:
          {
            MR_Word ItemInstInfo_54 = (MR_Word) (MR_body((MR_Word) (Item_42), (MR_Integer) 2));
        ...
        case (MR_Integer) 3:
          switch (((MR_Integer) ((MR_hl_field(MR_mktag(3), Item_42, (MR_Integer) 0))))) {
            ...
            case (MR_Integer) 0:
              {
                MR_Word ItemModeInfo_56 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Item_42, (MR_Integer) 1))));
            ...
            case (MR_Integer) 3:
              {
                ...
                parse_tree__comp_unit_interface__record_foreign_enum_3_p_0(ItemForeignEnumInfo_70, STATE_VARIABLE_IntImpForeignEnumTypeCtors_0_14, &STATE_VARIABLE_IntImpForeignEnumTypeCtors_97_97);
                STATE_VARIABLE_OrigIntTypeDefns_109_109 = STATE_VARIABLE_OrigIntTypeDefns_0_2;
                STATE_VARIABLE_IntTypeDefns_110_110 = STATE_VARIABLE_IntTypeDefns_0_4;
                STATE_VARIABLE_IntInstDefns_108_108 = STATE_VARIABLE_IntInstDefns_0_6;
                STATE_VARIABLE_IntModeDefns_106_106 = STATE_VARIABLE_IntModeDefns_0_8;
      ...
      next_value_of_STATE_VARIABLE_IntImpForeignEnumTypeCtors_0_14 = STATE_VARIABLE_IntImpForeignEnumTypeCtors_97_97;
      ...
      STATE_VARIABLE_IntImpForeignEnumTypeCtors_0_14 = next_value_of_STATE_VARIABLE_IntImpForeignEnumTypeCtors_0_14;
...
{
  {
    ...
    MR_Word OoMValues_8 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ForeignEnumInfo_4, (MR_Integer) 2))));
    MR_Word TypeSymName_11 = ((MR_Word) ((MR_hl_field(MR_mktag(0), TypeCtor_7, (MR_Integer) 0))));
    ...
    if (succeeded)
    {
...

      {
        ...
        MR_hl_field(MR_mktag(0), Var_20, 0) = ((MR_Box) (Lang_6));
        MR_hl_field(MR_mktag(0), Var_20, 1) = ((MR_Box) (OoMValues_8));
      }
      {
    ...
    else
    {
...

      {
        ...
        MR_hl_field(MR_mktag(0), Var_23, 0) = ((MR_Box) (Lang_6));
        MR_hl_field(MR_mktag(0), Var_23, 1) = ((MR_Box) (OoMValues_8));
      }
      {
    ...
    switch (MR_tag((MR_Word) TypeDefn_5)) {
      ...
      case (MR_Integer) 3:
        switch (((MR_Integer) ((MR_hl_field(MR_mktag(3), TypeDefn_5, (MR_Integer) 0))))) {
          ...
          case (MR_Integer) 1:
            {
              MR_Word DetailsForeign_15 = ((MR_Word) ((MR_hl_field(MR_mktag(3), TypeDefn_5, (MR_Integer) 1))));
              ...
              else
              {
                ...
                {
                  AbstractForeignTypeDefn_21 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                  MR_hl_field(MR_mktag(3), AbstractForeignTypeDefn_21, 0) = ((MR_Box) ((MR_Unsigned) 1U));
                  MR_hl_field(MR_mktag(3), AbstractForeignTypeDefn_21, 1) = ((MR_Box) (AbstractDetailsForeign_20));
                }
                {
                  MR_Word base;
                  base = (MR_Word) MR_new_object(MR_Word, (6 * sizeof(MR_Word)), NULL, NULL);
