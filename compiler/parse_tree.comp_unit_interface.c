        ...
        case (MR_Integer) 1:
          {
            ...
            succeeded = ((((MR_tag((MR_Word) TypeDefn_79)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(MR_mktag(3), TypeDefn_79, (MR_Integer) 0)))) == (MR_Integer) 1)));
            if (succeeded)
            {
              DetailsForeign_84 = ((MR_Word) ((MR_hl_field(MR_mktag(3), TypeDefn_79, (MR_Integer) 1))));
