  ...
  MR_Word LambdaHeadVar__1_53)
{
  ...
  Str_48 = parse_tree__parse_tree_out__item_abstract_instance_to_string_2_f_0(OutInfo_41, LambdaHeadVar__1_53);
  ...
  MR_Box wrapper_arg_1)
{
  ...
  conv1_HeadVar__3_3 = parse_tree__parse_tree_out__item_abstract_instance_to_string_2_f_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) (wrapper_arg_1)));
  wrapper_arg_2 = ((MR_Box) (conv1_HeadVar__3_3));
  return wrapper_arg_2;
}
