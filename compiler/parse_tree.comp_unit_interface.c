...
parse_tree__comp_unit_interface__IntroducedFrom__pred__find_need_imports__1902__1_2_p_0(
...
static void MR_CALL 
parse_tree__comp_unit_interface__get_short_interface_int3_from_items_13_p_0(
  MR_Word HeadVar__1_1,
...
static /* final */ const MR_Box parse_tree__comp_unit_interface_scalar_common_4[6][6];

static /* final */ const MR_Box parse_tree__comp_unit_interface_scalar_common_5[2][4];
...
{
  {
    ...
    else
    {
      ...
      mercury__builtin__compare_3_p_0((MR_Word) (&parse_tree__comp_unit_interface_scalar_common_1[0]), HeadVar__1_1, ((MR_Box) (ArgX1_4)), ((MR_Box) (ArgY1_5)));
    }
  }
}
...
{
  {
    ...
    else
    {
      ...
      succeeded = mercury__builtin__unify_2_p_0((MR_Word) (&parse_tree__comp_unit_interface_scalar_common_1[0]), ((MR_Box) (ArgX1_3)), ((MR_Box) (ArgY1_4)));
    }
    return succeeded;
  }
}
...
{
  {
    ...
    succeeded = parse_tree__comp_unit_interface__IntroducedFrom__pred__find_need_imports__1902__1_2_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))));
    return succeeded;
  }
}
      ...
      case (MR_Integer) 2:
        {
          ...
          else
          {
...

            {
              ...
              MR_hl_field(MR_mktag(0), AbstractDetailsForeign_29, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &parse_tree__comp_unit_interface_scalar_common_3[1])));
