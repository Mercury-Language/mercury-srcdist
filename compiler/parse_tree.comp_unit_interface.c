...
parse_tree__comp_unit_interface__IntroducedFrom__pred__find_need_imports__1823__1_2_p_0(
  ...
  MR_Word * STATE_VARIABLE_NoIFileItemBlocksCord_6)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      MR_Word STATE_VARIABLE_NoIFileItemBlocksCord_43_43;
      ...
      if (succeeded)
        STATE_VARIABLE_NoIFileItemBlocksCord_43_43 = STATE_VARIABLE_NoIFileItemBlocksCord_0_5;
      else
      {
...

        {
          ...
          MR_hl_field(MR_mktag(0), NoIFileItemBlock_34, 1) = ((MR_Box) ((MR_Integer) 1));
        ...
        STATE_VARIABLE_NoIFileItemBlocksCord_43_43 = mercury__cord__snoc_2_f_0((MR_Word) (&parse_tree__comp_unit_interface_scalar_common_1[3]), STATE_VARIABLE_NoIFileItemBlocksCord_0_5, ((MR_Box) (NoIFileItemBlock_34)));
      }
      // direct tailcall eliminated
      ;
      ...
      next_value_of_STATE_VARIABLE_NoIFileItemBlocksCord_0_5 = STATE_VARIABLE_NoIFileItemBlocksCord_43_43;
...
{
  {
    ...
    succeeded = parse_tree__comp_unit_interface__IntroducedFrom__pred__find_need_imports__1823__1_2_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))));
    return succeeded;
  }
}
