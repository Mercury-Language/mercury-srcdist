  ...
  MR_Word * STATE_VARIABLE_NoIFileItemBlocksCord_7)
{
  while (MR_TRUE)
  {
    ...
    else
    {
        ...
        case (MR_Integer) 1:
          {
            switch (IncludeImplTypes_1) {
              ...
              case (MR_Integer) 0:
                {
                  IFileIncls_27 = (MR_Word) ((MR_Integer) 0);
                  IFileAvails_28 = (MR_Word) ((MR_Integer) 0);
                }
                break;
              case (MR_Integer) 1:
                {
        ...
        case (MR_Integer) 0:
          {
            IFileIncls_27 = Incls_24;
            IFileAvails_28 = Avails_25;
            NoIFileIncls_29 = (MR_Word) ((MR_Integer) 0);
            NoIFileAvails_30 = (MR_Word) ((MR_Integer) 0);
          }
          break;
      }
      ...
      succeeded = (IFileIncls_27 == (MR_Word) ((MR_Integer) 0));
      if (succeeded)
      {
        succeeded = (IFileAvails_28 == (MR_Word) ((MR_Integer) 0));
        if (succeeded)
          succeeded = (IFileItems_33 == (MR_Word) ((MR_Integer) 0));
      }
      if (succeeded)
      ...
      succeeded = (NoIFileIncls_29 == (MR_Word) ((MR_Integer) 0));
      if (succeeded)
      {
        succeeded = (NoIFileAvails_30 == (MR_Word) ((MR_Integer) 0));
        if (succeeded)
          succeeded = (NoIFileItems_34 == (MR_Word) ((MR_Integer) 0));
      }
      if (succeeded)
...
{
  {
    ...
    switch (MR_tag((MR_Word) Item_3)) {
      ...
      case (MR_Integer) 0:
      case (MR_Integer) 2:
        MaybeIFileItem_4 = (MR_Word) ((MR_Integer) 0);
        break;
      case (MR_Integer) 1:
        {
...
{
  {
    ...
    if ((Langs_10 == (MR_Word) ((MR_Integer) 0)))
    ...
    else
    {
      ...
      Var_18 = mercury__term__context_init_0_f_0();
      {
        ...
        MR_hl_field(MR_mktag(0), ImportItemBlock_14, 2) = ((MR_Box) ((MR_Integer) 0));
        MR_hl_field(MR_mktag(0), ImportItemBlock_14, 3) = ((MR_Box) ((MR_Integer) 0));
