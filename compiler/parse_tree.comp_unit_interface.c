      ...
      case (MR_Integer) 0:
        {
          ...
          succeeded = parse_tree__prog_type__du_type_is_enum_2_p_0(DetailsDu_6, &NumBits_54);
          if (succeeded)
            {
              DetailsAbstract_7 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), DetailsAbstract_7, 0) = ((MR_Box) (NumBits_54));
            }
          else
          {
          ...
          case (MR_Integer) 1:
            {
              ...
              MR_Word TypeDefn_13;
              MR_Word MaybeCanonical0_57 = ((MR_Word) ((MR_hl_field(MR_mktag(0), DetailsForeign0_11, (MR_Integer) 1))));
              MR_Word Var_62 = ((MR_Word) ((MR_hl_field(MR_mktag(0), DetailsForeign0_11, (MR_Integer) 0))));
              MR_Word Var_63 = ((MR_Word) ((MR_hl_field(MR_mktag(0), DetailsForeign0_11, (MR_Integer) 2))));
