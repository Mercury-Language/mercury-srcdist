...
parse_tree__comp_unit_interface__IntroducedFrom__pred__get_interface_int1_items_loop_int__1369__1_2_p_0(
  MR_Word Langs_113,
...
parse_tree__comp_unit_interface__accumulate_abs_imp_exported_type_lhs_in_defn_10_p_0(
  ...
  MR_Word STATE_VARIABLE_AbsExpEqvLhsTypeCtors_0_37,
  MR_Word * STATE_VARIABLE_AbsExpEqvLhsTypeCtors_38,
  MR_Word STATE_VARIABLE_AbsExpEnumTypeCtors_0_39,
  MR_Word * STATE_VARIABLE_AbsExpEnumTypeCtors_40,
  MR_Word STATE_VARIABLE_DirectDummyTypeCtors_0_41,
  MR_Word * STATE_VARIABLE_DirectDummyTypeCtors_42);
...
static void MR_CALL 
parse_tree__comp_unit_interface__generate_interface_int1_18_p_0_3(
  MR_Box closure_arg,
  MR_Box wrapper_arg_1,
  MR_Box wrapper_arg_2,
  MR_Box * wrapper_arg_3);
...
static void MR_CALL 
parse_tree__comp_unit_interface__generate_interface_int1_18_p_0_2(
  MR_Box closure_arg,
  MR_Box wrapper_arg_1,
  MR_Box wrapper_arg_2,
  MR_Box * wrapper_arg_3,
...
static void MR_CALL 
parse_tree__comp_unit_interface__generate_interface_int1_18_p_0_1(
  MR_Box closure_arg,
  MR_Box wrapper_arg_1,
  MR_Box wrapper_arg_2,
  MR_Box wrapper_arg_3,
...
static void MR_CALL 
parse_tree__comp_unit_interface__generate_interface_int1_18_p_0(
  MR_Word AugCompUnit_19,
  MR_Word * IntIncls_20,
  MR_Word * IntImportsUses_21,
  MR_Word * IntExplicitFIMSpecs_22,
...
static void MR_CALL 
parse_tree__comp_unit_interface__generate_interface_int2_via_int3_5_p_0_3(
  MR_Box closure_arg,
  MR_Box wrapper_arg_1,
  MR_Box wrapper_arg_2,
  MR_Box * wrapper_arg_3);
...
static void MR_CALL 
parse_tree__comp_unit_interface__generate_interface_int2_via_int3_5_p_0_2(
  MR_Box closure_arg,
  MR_Box wrapper_arg_1,
  MR_Box wrapper_arg_2,
  MR_Box * wrapper_arg_3);
...
static void MR_CALL 
parse_tree__comp_unit_interface__generate_short_interface_int3_6_p_0_2(
  MR_Box closure_arg,
  MR_Box wrapper_arg_1,
  MR_Box wrapper_arg_2,
  MR_Box * wrapper_arg_3);
...
static void MR_CALL 
parse_tree__comp_unit_interface__generate_short_interface_int3_6_p_0_1(
  MR_Box closure_arg,
  MR_Box wrapper_arg_1,
  MR_Box wrapper_arg_2,
  MR_Box * wrapper_arg_3);
...
static /* final */ const MR_Box parse_tree__comp_unit_interface_scalar_common_1[36][3];

static /* final */ const MR_Box parse_tree__comp_unit_interface_scalar_common_2[15][2];
...
static /* final */ const MR_Box parse_tree__comp_unit_interface_scalar_common_1[36][3] = {
  ...
  /* row 8 */
  {
    ...
    ((MR_Box) (parse_tree__comp_unit_interface__generate_short_interface_int3_6_p_0_1)),
    ((MR_Box) ((MR_Integer) 0))
  },
  /* row 9 */
  {
    ((MR_Box) (&parse_tree__comp_unit_interface_scalar_common_4[1])),
    ((MR_Box) (parse_tree__comp_unit_interface__generate_short_interface_int3_6_p_0_2)),
    ((MR_Box) ((MR_Integer) 0))
  },
  /* row 10 */
  {
  ...
  {
    ((MR_Box) (&parse_tree__comp_unit_interface_scalar_common_4[1])),
    ((MR_Box) (parse_tree__comp_unit_interface__generate_interface_int2_via_int3_5_p_0_2)),
    ((MR_Box) ((MR_Integer) 0))
  },
  /* row 12 */
  {
    ((MR_Box) (&parse_tree__comp_unit_interface_scalar_common_4[1])),
    ((MR_Box) (parse_tree__comp_unit_interface__generate_interface_int2_via_int3_5_p_0_3)),
    ((MR_Box) ((MR_Integer) 0))
  },
  /* row 13 */
  {
...
static /* final */ const MR_Box parse_tree__comp_unit_interface_scalar_common_7[2][4] = {
  /* row 0 */
  {
    ((MR_Box) (MR_mkword(MR_mktag(3), &parse_tree__comp_unit_interface_scalar_common_1[21]))),
...
{
  {
    ...
    succeeded = mercury__map__search_3_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_type_ctor_0), (MR_Word) (&parse_tree__comp_unit_interface_scalar_common_2[6]), IntTypesMap_7, ((MR_Box) (TypeCtor_12)), &conv0_Defns_16);
    if (succeeded)
    {
...
{
  {
    ...
    if (succeeded)
    {
            ...
            case (MR_Integer) 0:
              {
                ...
                else
                {
                  ...
                  succeeded = parse_tree__prog_type__du_type_is_enum_3_p_0(DetailsDu0_55, &_NumFunctors_59, &NumBits_60);
                  if (succeeded)
                    {
      ...
      if (succeeded)
      {
        Var_22 = (MR_Word) (&parse_tree__comp_unit_interface_scalar_common_1[35]);
      ...
      case (MR_Integer) 0:
        {
          ...
          mercury__set__fold_4_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_type_ctor_0), (MR_Word) (&parse_tree__comp_unit_interface_scalar_common_2[4]), (MR_Word) (&parse_tree__comp_unit_interface_scalar_common_1[33]), RhsTypeCtors_51, ((MR_Box) (STATE_VARIABLE_ModulesNeededByTypeDefns_0_36)), &conv1_STATE_VARIABLE_ModulesNeededByTypeDefns_37);
      ...
      case (MR_Integer) 2:
        {
          ...
          mercury__set__fold_4_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_type_ctor_0), (MR_Word) (&parse_tree__comp_unit_interface_scalar_common_2[4]), (MR_Word) (&parse_tree__comp_unit_interface_scalar_common_1[34]), NewRhsTypeCtors_23, ((MR_Box) (STATE_VARIABLE_ModulesNeededByTypeDefns_0_36)), &conv3_STATE_VARIABLE_ModulesNeededByTypeDefns_46_46);
...
{
  {
    ...
    if (succeeded)
    {
      ...
      mercury__list__foldl_4_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0), (MR_Word) (&parse_tree__comp_unit_interface_scalar_common_2[11]), (MR_Word) (&parse_tree__comp_unit_interface_scalar_common_1[32]), ArgTypes_7, ((MR_Box) (STATE_VARIABLE_TypeCtors_15_15)), &conv1_STATE_VARIABLE_TypeCtors_14);
  ...
  MR_Box * wrapper_arg_7)
{
  {
    MR_Box closure = closure_arg;
    MR_Word conv2_STATE_VARIABLE_AbsExpEqvLhsTypeCtors_38;
    MR_Word conv1_STATE_VARIABLE_AbsExpEnumTypeCtors_40;
    MR_Word conv0_STATE_VARIABLE_DirectDummyTypeCtors_42;

    parse_tree__comp_unit_interface__accumulate_abs_imp_exported_type_lhs_in_defn_10_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 5)))), ((MR_Word) (wrapper_arg_1)), ((MR_Word) (wrapper_arg_2)), &conv2_STATE_VARIABLE_AbsExpEqvLhsTypeCtors_38, ((MR_Word) (wrapper_arg_4)), &conv1_STATE_VARIABLE_AbsExpEnumTypeCtors_40, ((MR_Word) (wrapper_arg_6)), &conv0_STATE_VARIABLE_DirectDummyTypeCtors_42);
    *wrapper_arg_3 = ((MR_Box) (conv2_STATE_VARIABLE_AbsExpEqvLhsTypeCtors_38));
    *wrapper_arg_5 = ((MR_Box) (conv1_STATE_VARIABLE_AbsExpEnumTypeCtors_40));
    *wrapper_arg_7 = ((MR_Box) (conv0_STATE_VARIABLE_DirectDummyTypeCtors_42));
  }
}
      ...
      case (MR_Integer) 0:
        {
          ...
          if (succeeded)
            succeeded = MR_TRUE;
          if (succeeded)
            succeeded = parse_tree__prog_type__du_type_is_enum_3_p_0(DetailsDu_28, &_NumFunctors_33, &_NumBits_34);
          if (succeeded)
          {
            mercury__set__insert_3_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_type_ctor_0), ((MR_Box) (TypeCtor_13)), STATE_VARIABLE_AbsExpEnumTypeCtors_0_39, STATE_VARIABLE_AbsExpEnumTypeCtors_40);
            *STATE_VARIABLE_DirectDummyTypeCtors_42 = STATE_VARIABLE_DirectDummyTypeCtors_0_41;
          }
          else
          {
            ...
            if (succeeded)
              mercury__set__insert_3_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_type_ctor_0), ((MR_Box) (TypeCtor_13)), STATE_VARIABLE_DirectDummyTypeCtors_0_41, STATE_VARIABLE_DirectDummyTypeCtors_42);
            else
              *STATE_VARIABLE_DirectDummyTypeCtors_42 = STATE_VARIABLE_DirectDummyTypeCtors_0_41;
            *STATE_VARIABLE_AbsExpEnumTypeCtors_40 = STATE_VARIABLE_AbsExpEnumTypeCtors_0_39;
          }
          *STATE_VARIABLE_AbsExpEqvLhsTypeCtors_38 = STATE_VARIABLE_AbsExpEqvLhsTypeCtors_0_37;
        }
        break;
      case (MR_Integer) 1:
        {
      ...
      case (MR_Integer) 2:
        {
          ...
          if (succeeded)
            succeeded = MR_TRUE;
          if (succeeded)
            mercury__set__insert_3_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_type_ctor_0), ((MR_Box) (TypeCtor_13)), STATE_VARIABLE_AbsExpEqvLhsTypeCtors_0_37, STATE_VARIABLE_AbsExpEqvLhsTypeCtors_38);
          else
            *STATE_VARIABLE_AbsExpEqvLhsTypeCtors_38 = STATE_VARIABLE_AbsExpEqvLhsTypeCtors_0_37;
          *STATE_VARIABLE_AbsExpEnumTypeCtors_40 = STATE_VARIABLE_AbsExpEnumTypeCtors_0_39;
          *STATE_VARIABLE_DirectDummyTypeCtors_42 = STATE_VARIABLE_DirectDummyTypeCtors_0_41;
      ...
      {
        {
          ...
          (env_ptr)->parse_tree__comp_unit_interface__constructor_list_represents_dummy_type_2_5_p_0_env_0__succeeded = mercury__multi_map__search_3_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_type_ctor_0), (MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_type_defn_info_0), (env_ptr)->parse_tree__comp_unit_interface__constructor_list_represents_dummy_type_2_5_p_0_env_0__TypeDefnMap_6, ((MR_Box) ((env_ptr)->parse_tree__comp_unit_interface__constructor_list_represents_dummy_type_2_5_p_0_env_0__TypeCtor_31)), &ItemTypeDefnInfos_32);
          if ((env_ptr)->parse_tree__comp_unit_interface__constructor_list_represents_dummy_type_2_5_p_0_env_0__succeeded)
            mercury__list__member_2_p_1((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_type_defn_info_0), &(env_ptr)->parse_tree__comp_unit_interface__constructor_list_represents_dummy_type_2_5_p_0_env_0__conv0_ItemTypeDefnInfo_33, ItemTypeDefnInfos_32, parse_tree__comp_unit_interface__constructor_list_represents_dummy_type_2_5_p_0_3, env_ptr);
        }
...
{
  {
    ...
    MR_Word IntTypesMap_22;
    MR_Word ImpTypesMap_23;
    MR_Word IntForeignEnums_24;
    MR_Word ImpForeignEnums_25;
    MR_Word ParseTreeInt1A_26;
    MR_Word ParseTreeInt2A_27;

    parse_tree__comp_unit_interface__generate_interface_int1_18_p_0(AugCompUnit_8, &IntInclModuleNames_12, &IntImportsUses_13, &IntExplicitFIMSpecs_14, &ImpExplicitFIMSpecs_15, &IntTypeDefns_16, &IntInstDefns_17, &IntModeDefns_18, &IntTypeClasses_19, &IntInstances_20, &ImpTypeDefns_21, &IntTypesMap_22, &ImpTypesMap_23, &IntForeignEnums_24, &ImpForeignEnums_25, &ParseTreeInt1A_26, STATE_VARIABLE_Specs_0_28, STATE_VARIABLE_Specs_29);
    parse_tree__comp_unit_interface__generate_interface_int2_17_p_0(Globals_7, AugCompUnit_8, IntInclModuleNames_12, IntImportsUses_13, IntExplicitFIMSpecs_14, ImpExplicitFIMSpecs_15, IntTypeDefns_16, IntInstDefns_17, IntModeDefns_18, IntTypeClasses_19, IntInstances_20, ImpTypeDefns_21, IntTypesMap_22, ImpTypesMap_23, IntForeignEnums_24, ImpForeignEnums_25, &ParseTreeInt2A_27);
    *ParseTreeInt1_9 = parse_tree__convert_interface__convert_parse_tree_int1_to_parse_tree_int_1_f_0(ParseTreeInt1A_26);
    *ParseTreeInt2_10 = parse_tree__convert_interface__convert_parse_tree_int2_to_parse_tree_int_1_f_0(ParseTreeInt2A_27);
  }
}
  ...
  MR_Box * wrapper_arg_3)
{
  {
    MR_Box closure = closure_arg;
    MR_Word conv4_STATE_VARIABLE_ForeignEnumTypeCtors_17;

    parse_tree__comp_unit_interface__record_foreign_enum_spec_3_p_0(((MR_Word) (wrapper_arg_1)), ((MR_Word) (wrapper_arg_2)), &conv4_STATE_VARIABLE_ForeignEnumTypeCtors_17);
    *wrapper_arg_3 = ((MR_Box) (conv4_STATE_VARIABLE_ForeignEnumTypeCtors_17));
  }
}
...
{
  {
      ...
      case (MR_Integer) 1:
        {
          ...
          mercury__list__foldl_4_p_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_foreign_enum_info_0), (MR_Word) (&parse_tree__comp_unit_interface_scalar_common_1[2]), (MR_Word) (&parse_tree__comp_unit_interface_scalar_common_1[30]), IntForeignEnums_32, ((MR_Box) (Var_99)), &conv5_ForeignEnumTypeCtors0_59);
          ForeignEnumTypeCtors0_59 = ((MR_Word) (conv5_ForeignEnumTypeCtors0_59));
          mercury__list__foldl_4_p_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_foreign_enum_info_0), (MR_Word) (&parse_tree__comp_unit_interface_scalar_common_1[2]), (MR_Word) (&parse_tree__comp_unit_interface_scalar_common_1[31]), ImpForeignEnums_33, ((MR_Box) (ForeignEnumTypeCtors0_59)), &conv7_ForeignEnumTypeCtors_60);
          ...
          ShortIntTypeRepnMap_56 = parse_tree__convert_interface__type_ctor_repn_items_to_map_1_f_0(ShortIntTypeRepns_61);
        }
        break;
    }
    ...
    mercury__set__filter_3_p_0((MR_Word) (&parse_tree__prog_data_foreign__parse_tree__prog_data_foreign__type_ctor_info_fim_spec_0), Var_101, IntExplicitFIMSpecs_22, &ShortIntExplicitFIMSpecs_64);
    {
      ...
      MR_hl_field(MR_mktag(0), Var_102, 0) = ((MR_Box) (&parse_tree__comp_unit_interface_scalar_common_12[0]));
    ...
    ShortIntTypeDefnMap_72 = parse_tree__convert_interface__type_ctor_defn_items_to_map_1_f_0(ShortIntTypeDefns_49);
    ShortIntInstDefnMap_73 = parse_tree__convert_interface__inst_ctor_defn_items_to_map_1_f_0(IntInstDefns_25);
    ShortIntModeDefnMap_74 = parse_tree__convert_interface__mode_ctor_defn_items_to_map_1_f_0(IntModeDefns_26);
    ShortImpTypeDefnMap_75 = parse_tree__convert_interface__type_ctor_defn_items_to_map_1_f_0(ImpTypeDefns_29);
    {
      MR_Word base;
        ...
        case (MR_Integer) 0:
          {
            ...
            mercury__cord__snoc_3_p_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_type_defn_info_0), ((MR_Box) (TypeDefnInfo_32)), STATE_VARIABLE_IntTypeDefnsCord_0_6, &STATE_VARIABLE_IntTypeDefnsCord_59_59);
        ...
        case (MR_Integer) 1:
          {
...

            {
              ...
              MR_hl_field(MR_mktag(0), TypeDefnInfo_65, 2) = ((MR_Box) (MR_mkword(MR_mktag(3), &parse_tree__comp_unit_interface_scalar_common_2[13])));
            ...
            mercury__cord__snoc_3_p_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_type_defn_info_0), ((MR_Box) (TypeDefnInfo_65)), STATE_VARIABLE_IntTypeDefnsCord_0_6, &STATE_VARIABLE_IntTypeDefnsCord_59_59);
            STATE_VARIABLE_MaybeUnqual_52_52 = STATE_VARIABLE_MaybeUnqual_0_2;
            STATE_VARIABLE_ModuleNames_53_53 = STATE_VARIABLE_ModuleNames_0_4;
            STATE_VARIABLE_IntImplicitFIMLangs_55_55 = STATE_VARIABLE_IntImplicitFIMLangs_0_8;
          }
        ...
        case (MR_Integer) 2:
          {
            ...
            mercury__cord__snoc_3_p_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_type_defn_info_0), ((MR_Box) (TypeDefnInfo0_22)), STATE_VARIABLE_IntTypeDefnsCord_0_6, &STATE_VARIABLE_IntTypeDefnsCord_59_59);
            ...
            case (MR_Integer) 1:
              {
                ...
                mercury__cord__snoc_3_p_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_type_defn_info_0), ((MR_Box) (TypeDefnInfo_67)), STATE_VARIABLE_IntTypeDefnsCord_0_6, &STATE_VARIABLE_IntTypeDefnsCord_59_59);
  ...
  MR_Word * STATE_VARIABLE_Specs_101)
{
  {
    MR_bool succeeded;
    MR_Word ModuleName_36 = ((MR_Word) ((MR_hl_field(MR_mktag(0), AugCompUnit_19, (MR_Integer) 0))));
    MR_Word ModuleNameContext_37 = ((MR_Word) ((MR_hl_field(MR_mktag(0), AugCompUnit_19, (MR_Integer) 1))));
    MR_Word SrcItemBlocks_39 = ((MR_Word) ((MR_hl_field(MR_mktag(0), AugCompUnit_19, (MR_Integer) 3))));
    MR_Word IntImportsUses0_44;
    MR_Word ImpImportsUses0_45;
    MR_Word IntExplicitFIMSpecs0_46;
    MR_Word ImpExplicitFIMSpecs0_47;
    MR_Word IntImplicitFIMLangs0_48;
    MR_Word ImpImplicitFIMLangs0_49;
    MR_Word IntTypesMap0_50;
    MR_Word ImpTypesMap0_51;
    MR_Word ImpIncls_52;
    MR_Word ImpImportsUses1_53;
    MR_Word IntImplicitFIMLangs_54;
    MR_Word ImpImplicitFIMLangs1_55;
    MR_Word IntTypeDefnsCord_56;
    MR_Word IntInstDefnsCord_57;
    MR_Word IntModeDefnsCord_58;
    MR_Word IntTypeClassesCord_59;
    MR_Word IntInstancesCord_60;
    MR_Word IntPredDeclsCord_61;
    MR_Word IntModeDeclsCord_62;
    MR_Word IntForeignEnumsCord_63;
    MR_Word IntPragmasCord_64;
    MR_Word IntPromisesCord_65;
    MR_Word OrigImpTypeDefnsCord_67;
    MR_Word ImpTypeClassesCord_68;
    MR_Word ImpForeignEnumsCord_69;
    MR_Word ImpModulesNeededByTypeClassDefns_70;
    MR_Word IntPredDecls_71;
    MR_Word IntModeDecls_72;
    MR_Word IntPragmas_73;
    MR_Word IntPromises_74;
    MR_Word OrigImpTypeDefns_75;
    MR_Word ImpTypeClasses_76;
    ...
    MR_Word IntFIMSpecs_86;
    MR_Word ImpFIMSpecs0_87;
    MR_Word ImpFIMSpecs_88;
    MR_Word IntTypeDefnMap_89;
    MR_Word IntInstDefnMap_90;
    MR_Word IntModeDefnMap_91;
    MR_Word IntForeignEnumMap_92;
    MR_Word IntTypeRepnMap_93;
    MR_Word OrigImpTypeDefnMap_95;
    MR_Word ImpTypeDefnMap_96;
    MR_Word ImpForeignEnumMap_97;
    MR_Word Var_102;
    MR_Word Var_103;
    MR_Word Var_104;
    MR_Word Var_105;
    ...
    MR_Word Var_121;
    MR_Word Var_123;
    MR_Word _IntModulesNeededByTypeClassDefns_66;
    MR_Box conv3_ImpTypeDefns_29;
    MR_Box conv2_ImpImplicitFIMLangs2_83;
    MR_Box conv7_ImpForeignEnums_84;
    MR_Box conv6_ImpImplicitFIMLangs_85;
    MR_Box conv9_IntFIMSpecs_86;
    MR_Box conv10_ImpFIMSpecs0_87;
    MR_Word _TypeCtorCheckedMap_98;

    mercury__set__init_1_p_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), &IntImportsUses0_44);
    mercury__set__init_1_p_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), &ImpImportsUses0_45);
    mercury__set__init_1_p_0((MR_Word) (&parse_tree__prog_data_foreign__parse_tree__prog_data_foreign__type_ctor_info_fim_spec_0), &IntExplicitFIMSpecs0_46);
    mercury__set__init_1_p_0((MR_Word) (&parse_tree__prog_data_foreign__parse_tree__prog_data_foreign__type_ctor_info_fim_spec_0), &ImpExplicitFIMSpecs0_47);
    mercury__set__init_1_p_0((MR_Word) (&libs__globals__libs__globals__type_ctor_info_foreign_language_0), &IntImplicitFIMLangs0_48);
    mercury__set__init_1_p_0((MR_Word) (&libs__globals__libs__globals__type_ctor_info_foreign_language_0), &ImpImplicitFIMLangs0_49);
    mercury__multi_map__init_1_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_type_ctor_0), (MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_type_defn_info_0), &IntTypesMap0_50);
    mercury__multi_map__init_1_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_type_ctor_0), (MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_type_defn_info_0), &ImpTypesMap0_51);
    ...
    Var_104 = mercury__cord__init_0_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_type_defn_info_0));
    Var_105 = mercury__cord__init_0_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_inst_defn_info_0));
    Var_106 = mercury__cord__init_0_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_mode_defn_info_0));
    Var_107 = mercury__cord__init_0_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_typeclass_info_0));
    Var_108 = mercury__cord__init_0_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_instance_info_0));
    ...
    Var_111 = mercury__cord__init_0_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_foreign_enum_info_0));
    Var_112 = mercury__cord__init_0_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_pragma_info_0));
    Var_113 = mercury__cord__init_0_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_promise_info_0));
    Var_114 = mercury__set__init_0_f_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0));
    Var_115 = mercury__cord__init_0_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_type_defn_info_0));
    Var_116 = mercury__cord__init_0_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_typeclass_info_0));
    Var_117 = mercury__cord__init_0_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_foreign_enum_info_0));
    Var_118 = mercury__set__init_0_f_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0));
    parse_tree__comp_unit_interface__get_interface_int1_item_blocks_loop_51_p_0(SrcItemBlocks_39, Var_102, IntIncls_20, Var_103, &ImpIncls_52, IntImportsUses0_44, IntImportsUses_21, ImpImportsUses0_45, &ImpImportsUses1_53, IntExplicitFIMSpecs0_46, IntExplicitFIMSpecs_22, ImpExplicitFIMSpecs0_47, ImpExplicitFIMSpecs_23, IntImplicitFIMLangs0_48, &IntImplicitFIMLangs_54, ImpImplicitFIMLangs0_49, &ImpImplicitFIMLangs1_55, IntTypesMap0_50, IntTypesMap_30, Var_104, &IntTypeDefnsCord_56, Var_105, &IntInstDefnsCord_57, Var_106, &IntModeDefnsCord_58, Var_107, &IntTypeClassesCord_59, Var_108, &IntInstancesCord_60, Var_109, &IntPredDeclsCord_61, Var_110, &IntModeDeclsCord_62, Var_111, &IntForeignEnumsCord_63, Var_112, &IntPragmasCord_64, Var_113, &IntPromisesCord_65, Var_114, &_IntModulesNeededByTypeClassDefns_66, ImpTypesMap0_51, ImpTypesMap_31, Var_115, &OrigImpTypeDefnsCord_67, Var_116, &ImpTypeClassesCord_68, Var_117, &ImpForeignEnumsCord_69, Var_118, &ImpModulesNeededByTypeClassDefns_70);
    *IntTypeDefns_24 = mercury__cord__list_1_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_type_defn_info_0), IntTypeDefnsCord_56);
    *IntInstDefns_25 = mercury__cord__list_1_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_inst_defn_info_0), IntInstDefnsCord_57);
    *IntModeDefns_26 = mercury__cord__list_1_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_mode_defn_info_0), IntModeDefnsCord_58);
    *IntTypeClasses_27 = mercury__cord__list_1_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_typeclass_info_0), IntTypeClassesCord_59);
    *IntInstances_28 = mercury__cord__list_1_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_instance_info_0), IntInstancesCord_60);
    IntPredDecls_71 = mercury__cord__list_1_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_pred_decl_info_0), IntPredDeclsCord_61);
    IntModeDecls_72 = mercury__cord__list_1_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_mode_decl_info_0), IntModeDeclsCord_62);
    *IntForeignEnums_32 = mercury__cord__list_1_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_foreign_enum_info_0), IntForeignEnumsCord_63);
    IntPragmas_73 = mercury__cord__list_1_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_pragma_info_0), IntPragmasCord_64);
    IntPromises_74 = mercury__cord__list_1_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_promise_info_0), IntPromisesCord_65);
    OrigImpTypeDefns_75 = mercury__cord__list_1_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_type_defn_info_0), OrigImpTypeDefnsCord_67);
    ImpTypeClasses_76 = mercury__cord__list_1_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_typeclass_info_0), ImpTypeClassesCord_68);
    *ImpForeignEnums0_33 = mercury__cord__list_1_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_foreign_enum_info_0), ImpForeignEnumsCord_69);
    BothTypesMap_77 = mercury__multi_map__merge_2_f_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_type_ctor_0), (MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_type_defn_info_0), *IntTypesMap_30, *ImpTypesMap_31);
    parse_tree__comp_unit_interface__get_requirements_of_imp_exported_types_5_p_0(*IntTypesMap_30, *ImpTypesMap_31, BothTypesMap_77, &NeededImpTypeCtors_78, &ImpModulesNeededByTypeDefns_79);
    mercury__set__union_3_p_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), ImpModulesNeededByTypeClassDefns_70, ImpModulesNeededByTypeDefns_79, &ImpNeededModules_80);
    ...
    else
    {
      ...
      ImpImportsUses2_82 = mercury__set__intersect_2_f_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), ImpImportsUses1_53, ImpNeededModules_80);
      ImpImportsUses_81 = mercury__set__difference_2_f_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), ImpImportsUses2_82, *IntImportsUses_21);
    }
    {
      ...
      MR_hl_field(MR_mktag(0), Var_119, 1) = ((MR_Box) (parse_tree__comp_unit_interface__generate_interface_int1_18_p_0_1));
      MR_hl_field(MR_mktag(0), Var_119, 2) = ((MR_Box) ((MR_Integer) 3));
      MR_hl_field(MR_mktag(0), Var_119, 3) = ((MR_Box) (BothTypesMap_77));
      MR_hl_field(MR_mktag(0), Var_119, 4) = ((MR_Box) (*IntTypesMap_30));
      MR_hl_field(MR_mktag(0), Var_119, 5) = ((MR_Box) (NeededImpTypeCtors_78));
    }
    mercury__map__foldl2_6_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_type_ctor_0), (MR_Word) (&parse_tree__comp_unit_interface_scalar_common_2[6]), (MR_Word) (&parse_tree__comp_unit_interface_scalar_common_2[6]), (MR_Word) (&parse_tree__comp_unit_interface_scalar_common_2[7]), Var_119, *ImpTypesMap_31, ((MR_Box) ((MR_Unsigned) 0U)), &conv3_ImpTypeDefns_29, ((MR_Box) (ImpImplicitFIMLangs1_55)), &conv2_ImpImplicitFIMLangs2_83);
    *ImpTypeDefns_29 = ((MR_Word) (conv3_ImpTypeDefns_29));
    ImpImplicitFIMLangs2_83 = ((MR_Word) (conv2_ImpImplicitFIMLangs2_83));
    {
      ...
      MR_hl_field(MR_mktag(0), Var_121, 0) = ((MR_Box) (&parse_tree__comp_unit_interface_scalar_common_11[0]));
      MR_hl_field(MR_mktag(0), Var_121, 1) = ((MR_Box) (parse_tree__comp_unit_interface__generate_interface_int1_18_p_0_2));
      MR_hl_field(MR_mktag(0), Var_121, 2) = ((MR_Box) ((MR_Integer) 1));
      MR_hl_field(MR_mktag(0), Var_121, 3) = ((MR_Box) (*IntTypesMap_30));
    }
    mercury__list__foldl2_6_p_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_foreign_enum_info_0), (MR_Word) (&parse_tree__comp_unit_interface_scalar_common_2[8]), (MR_Word) (&parse_tree__comp_unit_interface_scalar_common_2[7]), Var_121, *ImpForeignEnums0_33, ((MR_Box) ((MR_Unsigned) 0U)), &conv7_ImpForeignEnums_84, ((MR_Box) (ImpImplicitFIMLangs2_83)), &conv6_ImpImplicitFIMLangs_85);
    ...
    ImpImplicitFIMLangs_85 = ((MR_Word) (conv6_ImpImplicitFIMLangs_85));
    {
      ...
      MR_hl_field(MR_mktag(0), Var_123, 0) = ((MR_Box) (&parse_tree__comp_unit_interface_scalar_common_12[0]));
      MR_hl_field(MR_mktag(0), Var_123, 1) = ((MR_Box) (parse_tree__comp_unit_interface__generate_interface_int1_18_p_0_3));
      MR_hl_field(MR_mktag(0), Var_123, 2) = ((MR_Box) ((MR_Integer) 1));
      MR_hl_field(MR_mktag(0), Var_123, 3) = ((MR_Box) (ModuleName_36));
    }
    mercury__set__foldl_4_p_0((MR_Word) (&libs__globals__libs__globals__type_ctor_info_foreign_language_0), (MR_Word) (&parse_tree__comp_unit_interface_scalar_common_2[5]), Var_123, IntImplicitFIMLangs_54, ((MR_Box) (*IntExplicitFIMSpecs_22)), &conv9_IntFIMSpecs_86);
    IntFIMSpecs_86 = ((MR_Word) (conv9_IntFIMSpecs_86));
    mercury__set__foldl_4_p_0((MR_Word) (&libs__globals__libs__globals__type_ctor_info_foreign_language_0), (MR_Word) (&parse_tree__comp_unit_interface_scalar_common_2[5]), Var_123, ImpImplicitFIMLangs_85, ((MR_Box) (*ImpExplicitFIMSpecs_23)), &conv10_ImpFIMSpecs0_87);
    ImpFIMSpecs0_87 = ((MR_Word) (conv10_ImpFIMSpecs0_87));
    mercury__set__difference_3_p_0((MR_Word) (&parse_tree__prog_data_foreign__parse_tree__prog_data_foreign__type_ctor_info_fim_spec_0), ImpFIMSpecs0_87, IntFIMSpecs_86, &ImpFIMSpecs_88);
    IntTypeDefnMap_89 = parse_tree__convert_interface__type_ctor_defn_items_to_map_1_f_0(*IntTypeDefns_24);
    IntInstDefnMap_90 = parse_tree__convert_interface__inst_ctor_defn_items_to_map_1_f_0(*IntInstDefns_25);
    IntModeDefnMap_91 = parse_tree__convert_interface__mode_ctor_defn_items_to_map_1_f_0(*IntModeDefns_26);
    IntForeignEnumMap_92 = parse_tree__convert_interface__type_ctor_foreign_enum_items_to_map_1_f_0(*IntForeignEnums_32);
    OrigImpTypeDefnMap_95 = parse_tree__convert_interface__type_ctor_defn_items_to_map_1_f_0(OrigImpTypeDefns_75);
    ImpTypeDefnMap_96 = parse_tree__convert_interface__type_ctor_defn_items_to_map_1_f_0(*ImpTypeDefns_29);
    ImpForeignEnumMap_97 = parse_tree__convert_interface__type_ctor_foreign_enum_items_to_map_1_f_0(ImpForeignEnums_84);
    parse_tree__check_parse_tree_type_defns__create_type_ctor_checked_map_9_p_0((MR_Integer) 1, ModuleName_36, IntTypeDefnMap_89, OrigImpTypeDefnMap_95, IntForeignEnumMap_92, ImpForeignEnumMap_97, &_TypeCtorCheckedMap_98, STATE_VARIABLE_Specs_0_100, STATE_VARIABLE_Specs_101);
    IntTypeRepnMap_93 = parse_tree__convert_interface__type_ctor_repn_items_to_map_1_f_0((MR_Word) ((MR_Unsigned) 0U));
    {
      MR_Word base;
      base = (MR_Word) MR_new_object(MR_Word, (23 * sizeof(MR_Word)), NULL, NULL);
      *ParseTreeInt1_34 = base;
      MR_hl_field(MR_mktag(0), base, 0) = ((MR_Box) (ModuleName_36));
      MR_hl_field(MR_mktag(0), base, 1) = ((MR_Box) (ModuleNameContext_37));
      MR_hl_field(MR_mktag(0), base, 2) = ((MR_Box) ((MR_Unsigned) 0U));
      MR_hl_field(MR_mktag(0), base, 3) = ((MR_Box) (*IntIncls_20));
      MR_hl_field(MR_mktag(0), base, 4) = ((MR_Box) (ImpIncls_52));
      MR_hl_field(MR_mktag(0), base, 5) = ((MR_Box) (*IntImportsUses_21));
      MR_hl_field(MR_mktag(0), base, 6) = ((MR_Box) (ImpImportsUses_81));
      MR_hl_field(MR_mktag(0), base, 7) = ((MR_Box) (IntFIMSpecs_86));
      MR_hl_field(MR_mktag(0), base, 8) = ((MR_Box) (ImpFIMSpecs_88));
      MR_hl_field(MR_mktag(0), base, 9) = ((MR_Box) (IntTypeDefnMap_89));
      MR_hl_field(MR_mktag(0), base, 10) = ((MR_Box) (IntInstDefnMap_90));
      MR_hl_field(MR_mktag(0), base, 11) = ((MR_Box) (IntModeDefnMap_91));
      MR_hl_field(MR_mktag(0), base, 12) = ((MR_Box) (*IntTypeClasses_27));
      MR_hl_field(MR_mktag(0), base, 13) = ((MR_Box) (*IntInstances_28));
      MR_hl_field(MR_mktag(0), base, 14) = ((MR_Box) (IntPredDecls_71));
      MR_hl_field(MR_mktag(0), base, 15) = ((MR_Box) (IntModeDecls_72));
      MR_hl_field(MR_mktag(0), base, 16) = ((MR_Box) (IntForeignEnumMap_92));
      MR_hl_field(MR_mktag(0), base, 17) = ((MR_Box) (IntPragmas_73));
      MR_hl_field(MR_mktag(0), base, 18) = ((MR_Box) (IntPromises_74));
      MR_hl_field(MR_mktag(0), base, 19) = ((MR_Box) (IntTypeRepnMap_93));
      MR_hl_field(MR_mktag(0), base, 20) = ((MR_Box) (ImpTypeDefnMap_96));
      MR_hl_field(MR_mktag(0), base, 21) = ((MR_Box) (ImpForeignEnumMap_97));
      MR_hl_field(MR_mktag(0), base, 22) = ((MR_Box) (ImpTypeClasses_76));
    }
  }
}
        ...
        case (MR_Integer) 1:
          {
            ...
            mercury__list__foldl_4_p_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_fim_0), (MR_Word) (&parse_tree__comp_unit_interface_scalar_common_2[5]), (MR_Word) (&parse_tree__comp_unit_interface_scalar_common_1[25]), FIMs_158, ((MR_Box) (STATE_VARIABLE_ImpExplicitFIMSpecs_0_12)), &conv3_STATE_VARIABLE_ImpExplicitFIMSpecs_216_216);
        ...
        case (MR_Integer) 0:
          {
            ...
            mercury__list__foldl_4_p_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_include_0), (MR_Word) (&parse_tree__comp_unit_interface_scalar_common_2[4]), (MR_Word) (&parse_tree__comp_unit_interface_scalar_common_1[26]), Incls_156, ((MR_Box) (STATE_VARIABLE_IntIncls_0_2)), &conv5_STATE_VARIABLE_IntIncls_224_224);
            ...
            mercury__list__foldl_4_p_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_fim_0), (MR_Word) (&parse_tree__comp_unit_interface_scalar_common_2[5]), (MR_Word) (&parse_tree__comp_unit_interface_scalar_common_1[27]), FIMs_158, ((MR_Box) (STATE_VARIABLE_IntExplicitFIMSpecs_0_10)), &conv7_STATE_VARIABLE_IntExplicitFIMSpecs_227_227);
        ...
        case (MR_Integer) 1:
          {
            ...
            Var_95 = mercury__list__length_1_f_0((MR_Word) (&parse_tree__comp_unit_interface_scalar_common_2[9]), TypeParams_42);
            {
              ...
              case (MR_Integer) 1:
                {
...

                  {
                    ...
                    MR_hl_field(MR_mktag(0), ItemTypeDefn1_50, 2) = ((MR_Box) (MR_mkword(MR_mktag(3), &parse_tree__comp_unit_interface_scalar_common_2[13])));
            ...
            mercury__multi_map__set_4_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_type_ctor_0), (MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_type_defn_info_0), ((MR_Box) (TypeCtor_47)), ((MR_Box) (ItemTypeDefn1_50)), STATE_VARIABLE_ImpTypesMap_0_4, &STATE_VARIABLE_ImpTypesMap_97_97);
            mercury__cord__snoc_3_p_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_type_defn_info_0), ((MR_Box) (ItemTypeDefn_40)), STATE_VARIABLE_OrigImpTypeDefnsCord_0_6, &STATE_VARIABLE_OrigImpTypeDefnsCord_98_98);
            ...
            case (MR_Integer) 7:
              {
                ...
                mercury__list__foldl_4_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_constraint_0), (MR_Word) (&parse_tree__comp_unit_interface_scalar_common_2[4]), (MR_Word) (&parse_tree__comp_unit_interface_scalar_common_1[23]), Constraints_56, ((MR_Box) (STATE_VARIABLE_ImpModulesNeededByTypeClassDefns_0_12)), &conv1_STATE_VARIABLE_ImpModulesNeededByTypeClassDefns_94_94);
...
{
  {
    ...
    succeeded = parse_tree__comp_unit_interface__IntroducedFrom__pred__get_interface_int1_items_loop_int__1369__1_2_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))));
    return succeeded;
  }
}
            ...
            case (MR_Integer) 3:
              {
                ...
                mercury__cord__snoc_3_p_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_foreign_enum_info_0), ((MR_Box) (ItemForeignEnum_102)), STATE_VARIABLE_IntForeignEnumsCord_0_20, &STATE_VARIABLE_IntForeignEnumsCord_156_156);
                Lang_183 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), ItemForeignEnum_102, (MR_Integer) 0))) & (MR_Integer) 3);
                mercury__set__insert_3_p_0((MR_Word) (&libs__globals__libs__globals__type_ctor_info_foreign_language_0), ((MR_Box) (Lang_183)), STATE_VARIABLE_IntImplicitFIMLangs_0_2, &STATE_VARIABLE_IntImplicitFIMLangs_169_169);
                STATE_VARIABLE_IntTypesMap_167_167 = STATE_VARIABLE_IntTypesMap_0_4;
                STATE_VARIABLE_IntTypeDefnsCord_168_168 = STATE_VARIABLE_IntTypeDefnsCord_0_6;
                STATE_VARIABLE_IntInstDefnsCord_165_165 = STATE_VARIABLE_IntInstDefnsCord_0_8;
                STATE_VARIABLE_IntModeDefnsCord_164_164 = STATE_VARIABLE_IntModeDefnsCord_0_10;
            ...
            case (MR_Integer) 7:
              {
                ...
                mercury__list__foldl_4_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_constraint_0), (MR_Word) (&parse_tree__comp_unit_interface_scalar_common_2[4]), (MR_Word) (&parse_tree__comp_unit_interface_scalar_common_1[22]), Constraints_98, ((MR_Box) (STATE_VARIABLE_IntModulesNeededByTypeClassDefns_0_26)), &conv1_STATE_VARIABLE_IntModulesNeededByTypeClassDefns_163_163);
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      switch (MR_tag((MR_Word) Item_7)) {
        ...
        case (MR_Integer) 1:
          {
            MR_Word TypeDefnInfo_10 = (MR_Word) (MR_body((MR_Word) (Item_7), (MR_Integer) 1));
            ...
            Item1_12 = (MR_Word) (MR_mkword(MR_mktag(1), (MR_Word) (TypeDefnInfo1_11)));
            ...
            case (MR_Integer) 7:
              {
                ...
                }
                {
                  ...
                  MR_hl_field(MR_mktag(3), AbstractItem_15, 0) = ((MR_Box) ((MR_Unsigned) 7U));
      ...
      case (MR_Integer) 1:
        {
          ...
          *ItemTypeDefn_4 = base;
          MR_hl_field(MR_mktag(0), base, 0) = ((MR_Box) (Var_17));
          MR_hl_field(MR_mktag(0), base, 1) = ((MR_Box) (Var_18));
          MR_hl_field(MR_mktag(0), base, 2) = ((MR_Box) (MR_mkword(MR_mktag(1), ((MR_Box) (&parse_tree__comp_unit_interface_scalar_common_2[14])))));
          MR_hl_field(MR_mktag(0), base, 3) = ((MR_Box) (Var_19));
          MR_hl_field(MR_mktag(0), base, 4) = ((MR_Box) (Var_20));
          MR_hl_field(MR_mktag(0), base, 5) = ((MR_Box) (Var_21));
        }
...
{
  {
    ...
    Var_91 = mercury__cord__init_0_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_type_defn_info_0));
    Var_92 = mercury__cord__init_0_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_type_defn_info_0));
    ...
    Var_107 = mercury__cord__init_0_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_pragma_info_0));
    Var_108 = mercury__cord__init_0_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_pragma_info_0));
    ...
    IntTypeDefns_59 = mercury__cord__list_1_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_type_defn_info_0), IntTypeDefnsCord_32);
    ImpTypeDefns_60 = mercury__cord__list_1_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_type_defn_info_0), ImpTypeDefnsCord_33);
    ...
    IntPragmas_75 = mercury__cord__list_1_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_pragma_info_0), IntPragmasCord_48);
    ImpPragmas_76 = mercury__cord__list_1_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_pragma_info_0), ImpPragmasCord_49);
    ...
    IntTypeDefnMap_79 = parse_tree__convert_interface__type_ctor_defn_items_to_map_1_f_0(IntTypeDefns_59);
    IntInstDefnMap_80 = parse_tree__convert_interface__inst_ctor_defn_items_to_map_1_f_0(IntInstDefns_61);
    IntModeDefnMap_81 = parse_tree__convert_interface__mode_ctor_defn_items_to_map_1_f_0(IntModeDefns_63);
    ImpTypeDefnMap_82 = parse_tree__convert_interface__type_ctor_defn_items_to_map_1_f_0(ImpTypeDefns_60);
    ImpInstDefnMap_83 = parse_tree__convert_interface__inst_ctor_defn_items_to_map_1_f_0(ImpInstDefns_62);
    ImpModeDefnMap_84 = parse_tree__convert_interface__mode_ctor_defn_items_to_map_1_f_0(ImpModeDefns_64);
    IntForeignEnumMap_85 = parse_tree__convert_interface__type_ctor_foreign_enum_items_to_map_1_f_0(IntForeignEnums_73);
    ImpForeignEnumMap_86 = parse_tree__convert_interface__type_ctor_foreign_enum_items_to_map_1_f_0(ImpForeignEnums_74);
    ...
    *ParseTreeInt0_6 = parse_tree__convert_interface__convert_parse_tree_int0_to_parse_tree_int_1_f_0(ParseTreeInt0Prime_88);
  }
}
        ...
        case (MR_Integer) 1:
          {
            ...
            mercury__list__foldl_4_p_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_include_0), (MR_Word) (&parse_tree__comp_unit_interface_scalar_common_2[4]), (MR_Word) (&parse_tree__comp_unit_interface_scalar_common_1[13]), Incls_177, ((MR_Box) (STATE_VARIABLE_ImpIncls_0_5)), &conv1_STATE_VARIABLE_ImpIncls_240_240);
            ...
            Var_241 = mercury__list__map_2_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_avail_import_info_0), (MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), (MR_Word) (&parse_tree__comp_unit_interface_scalar_common_1[14]), Imports_307);
            ...
            Var_244 = mercury__list__map_2_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_avail_use_info_0), (MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), (MR_Word) (&parse_tree__comp_unit_interface_scalar_common_1[15]), Uses_308);
            ...
            mercury__list__foldl_4_p_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_fim_0), (MR_Word) (&parse_tree__comp_unit_interface_scalar_common_2[5]), (MR_Word) (&parse_tree__comp_unit_interface_scalar_common_1[16]), FIMs_179, ((MR_Box) (STATE_VARIABLE_ImpFIMSpecs_0_17)), &conv5_STATE_VARIABLE_ImpFIMSpecs_248_248);
        ...
        case (MR_Integer) 0:
          {
            ...
            mercury__list__foldl_4_p_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_include_0), (MR_Word) (&parse_tree__comp_unit_interface_scalar_common_2[4]), (MR_Word) (&parse_tree__comp_unit_interface_scalar_common_1[17]), Incls_177, ((MR_Box) (STATE_VARIABLE_IntIncls_0_3)), &conv7_STATE_VARIABLE_IntIncls_260_260);
            ...
            Var_261 = mercury__list__map_2_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_avail_import_info_0), (MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), (MR_Word) (&parse_tree__comp_unit_interface_scalar_common_1[18]), Imports_181);
            ...
            Var_264 = mercury__list__map_2_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_avail_use_info_0), (MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), (MR_Word) (&parse_tree__comp_unit_interface_scalar_common_1[19]), Uses_182);
            ...
            mercury__list__foldl_4_p_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_fim_0), (MR_Word) (&parse_tree__comp_unit_interface_scalar_common_2[5]), (MR_Word) (&parse_tree__comp_unit_interface_scalar_common_1[20]), FIMs_179, ((MR_Box) (STATE_VARIABLE_IntFIMSpecs_0_15)), &conv11_STATE_VARIABLE_IntFIMSpecs_268_268);
  ...
  MR_Word * STATE_VARIABLE_Promises_22)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      MR_Word STATE_VARIABLE_Promises_124_124;
      MR_Word STATE_VARIABLE_Pragmas_125_125;
      MR_Word STATE_VARIABLE_ForeignEnums_126_126;
      MR_Word STATE_VARIABLE_Instances_128_128;
      MR_Word STATE_VARIABLE_TypeClasses_129_129;
      MR_Word STATE_VARIABLE_ModeDecls_130_130;
      MR_Word STATE_VARIABLE_PredDecls_131_131;
      MR_Word STATE_VARIABLE_ModeDefns_132_132;
      MR_Word STATE_VARIABLE_InstDefns_133_133;
      ...
      switch (MR_tag((MR_Word) Item_55)) {
        ...
        case (MR_Integer) 0:
          {
            STATE_VARIABLE_TypeDefns_134_134 = STATE_VARIABLE_TypeDefns_0_3;
            STATE_VARIABLE_InstDefns_133_133 = STATE_VARIABLE_InstDefns_0_5;
            STATE_VARIABLE_ModeDefns_132_132 = STATE_VARIABLE_ModeDefns_0_7;
            STATE_VARIABLE_TypeClasses_129_129 = STATE_VARIABLE_TypeClasses_0_9;
            STATE_VARIABLE_Instances_128_128 = STATE_VARIABLE_Instances_0_11;
            STATE_VARIABLE_PredDecls_131_131 = STATE_VARIABLE_PredDecls_0_13;
            STATE_VARIABLE_ModeDecls_130_130 = STATE_VARIABLE_ModeDecls_0_15;
            STATE_VARIABLE_ForeignEnums_126_126 = STATE_VARIABLE_ForeignEnums_0_17;
            STATE_VARIABLE_Pragmas_125_125 = STATE_VARIABLE_Pragmas_0_19;
            STATE_VARIABLE_Promises_124_124 = STATE_VARIABLE_Promises_0_21;
          }
          break;
        case (MR_Integer) 1:
          {
            ...
            mercury__cord__snoc_3_p_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_type_defn_info_0), ((MR_Box) (TypeDefn_67)), STATE_VARIABLE_TypeDefns_0_3, &STATE_VARIABLE_TypeDefns_134_134);
            STATE_VARIABLE_InstDefns_133_133 = STATE_VARIABLE_InstDefns_0_5;
            STATE_VARIABLE_ModeDefns_132_132 = STATE_VARIABLE_ModeDefns_0_7;
            STATE_VARIABLE_TypeClasses_129_129 = STATE_VARIABLE_TypeClasses_0_9;
            STATE_VARIABLE_Instances_128_128 = STATE_VARIABLE_Instances_0_11;
        ...
        case (MR_Integer) 2:
          {
            ...
            mercury__cord__snoc_3_p_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_inst_defn_info_0), ((MR_Box) (InstDefn_68)), STATE_VARIABLE_InstDefns_0_5, &STATE_VARIABLE_InstDefns_133_133);
            STATE_VARIABLE_TypeDefns_134_134 = STATE_VARIABLE_TypeDefns_0_3;
            STATE_VARIABLE_ModeDefns_132_132 = STATE_VARIABLE_ModeDefns_0_7;
            STATE_VARIABLE_TypeClasses_129_129 = STATE_VARIABLE_TypeClasses_0_9;
            STATE_VARIABLE_Instances_128_128 = STATE_VARIABLE_Instances_0_11;
        ...
        case (MR_Integer) 3:
          switch (((MR_Integer) ((MR_hl_field(MR_mktag(3), Item_55, (MR_Integer) 0))))) {
            ...
            case (MR_Integer) 0:
              {
                ...
                mercury__cord__snoc_3_p_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_mode_defn_info_0), ((MR_Box) (ModeDefn_69)), STATE_VARIABLE_ModeDefns_0_7, &STATE_VARIABLE_ModeDefns_132_132);
                STATE_VARIABLE_TypeDefns_134_134 = STATE_VARIABLE_TypeDefns_0_3;
                STATE_VARIABLE_InstDefns_133_133 = STATE_VARIABLE_InstDefns_0_5;
                STATE_VARIABLE_TypeClasses_129_129 = STATE_VARIABLE_TypeClasses_0_9;
                STATE_VARIABLE_Instances_128_128 = STATE_VARIABLE_Instances_0_11;
            ...
            case (MR_Integer) 1:
              {
                ...
                mercury__cord__snoc_3_p_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_pred_decl_info_0), ((MR_Box) (PredDecl_70)), STATE_VARIABLE_PredDecls_0_13, &STATE_VARIABLE_PredDecls_131_131);
                STATE_VARIABLE_TypeDefns_134_134 = STATE_VARIABLE_TypeDefns_0_3;
                STATE_VARIABLE_InstDefns_133_133 = STATE_VARIABLE_InstDefns_0_5;
                STATE_VARIABLE_ModeDefns_132_132 = STATE_VARIABLE_ModeDefns_0_7;
                STATE_VARIABLE_TypeClasses_129_129 = STATE_VARIABLE_TypeClasses_0_9;
            ...
            case (MR_Integer) 2:
              {
                ...
                mercury__cord__snoc_3_p_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_mode_decl_info_0), ((MR_Box) (ModeDecl_71)), STATE_VARIABLE_ModeDecls_0_15, &STATE_VARIABLE_ModeDecls_130_130);
                STATE_VARIABLE_TypeDefns_134_134 = STATE_VARIABLE_TypeDefns_0_3;
                STATE_VARIABLE_InstDefns_133_133 = STATE_VARIABLE_InstDefns_0_5;
                STATE_VARIABLE_ModeDefns_132_132 = STATE_VARIABLE_ModeDefns_0_7;
                STATE_VARIABLE_TypeClasses_129_129 = STATE_VARIABLE_TypeClasses_0_9;
            ...
            case (MR_Integer) 3:
              {
                ...
                mercury__cord__snoc_3_p_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_foreign_enum_info_0), ((MR_Box) (ItemForeignEnumInfo_75)), STATE_VARIABLE_ForeignEnums_0_17, &STATE_VARIABLE_ForeignEnums_126_126);
                STATE_VARIABLE_TypeDefns_134_134 = STATE_VARIABLE_TypeDefns_0_3;
                STATE_VARIABLE_InstDefns_133_133 = STATE_VARIABLE_InstDefns_0_5;
                STATE_VARIABLE_ModeDefns_132_132 = STATE_VARIABLE_ModeDefns_0_7;
                STATE_VARIABLE_TypeClasses_129_129 = STATE_VARIABLE_TypeClasses_0_9;
            ...
            case (MR_Integer) 5:
              {
                ...
                MR_Word AllowedInInterface_81;

                AllowedInInterface_81 = parse_tree__prog_item__pragma_allowed_in_interface_1_f_0(Pragma_77);
                switch (AllowedInInterface_81) {
                  default: /*NOTREACHED*/ MR_assert(0);
                  case (MR_Integer) 0:
                    STATE_VARIABLE_Pragmas_125_125 = STATE_VARIABLE_Pragmas_0_19;
                    break;
                  case (MR_Integer) 1:
                    mercury__cord__snoc_3_p_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_pragma_info_0), ((MR_Box) (ItemPragma_76)), STATE_VARIABLE_Pragmas_0_19, &STATE_VARIABLE_Pragmas_125_125);
                    break;
                }
                STATE_VARIABLE_TypeDefns_134_134 = STATE_VARIABLE_TypeDefns_0_3;
                STATE_VARIABLE_InstDefns_133_133 = STATE_VARIABLE_InstDefns_0_5;
            ...
            case (MR_Integer) 6:
              {
                MR_Word Promise_82 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Item_55, (MR_Integer) 1))));

                mercury__cord__snoc_3_p_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_promise_info_0), ((MR_Box) (Promise_82)), STATE_VARIABLE_Promises_0_21, &STATE_VARIABLE_Promises_124_124);
                STATE_VARIABLE_TypeDefns_134_134 = STATE_VARIABLE_TypeDefns_0_3;
                STATE_VARIABLE_InstDefns_133_133 = STATE_VARIABLE_InstDefns_0_5;
                STATE_VARIABLE_ModeDefns_132_132 = STATE_VARIABLE_ModeDefns_0_7;
                STATE_VARIABLE_TypeClasses_129_129 = STATE_VARIABLE_TypeClasses_0_9;
            ...
            case (MR_Integer) 7:
              {
                ...
                mercury__cord__snoc_3_p_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_typeclass_info_0), ((MR_Box) (TypeClass_72)), STATE_VARIABLE_TypeClasses_0_9, &STATE_VARIABLE_TypeClasses_129_129);
                STATE_VARIABLE_TypeDefns_134_134 = STATE_VARIABLE_TypeDefns_0_3;
                STATE_VARIABLE_InstDefns_133_133 = STATE_VARIABLE_InstDefns_0_5;
                STATE_VARIABLE_ModeDefns_132_132 = STATE_VARIABLE_ModeDefns_0_7;
                STATE_VARIABLE_Instances_128_128 = STATE_VARIABLE_Instances_0_11;
            ...
            case (MR_Integer) 8:
              {
                ...
                MR_Word Var_145 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Instance_73, (MR_Integer) 0))));
                MR_Word Var_146 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Instance_73, (MR_Integer) 1))));
                MR_Word Var_147 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Instance_73, (MR_Integer) 2))));
                MR_Word Var_148 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Instance_73, (MR_Integer) 3))));
                MR_Word Var_150 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Instance_73, (MR_Integer) 5))));
                MR_Word Var_151 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Instance_73, (MR_Integer) 6))));
                MR_Word Var_152 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Instance_73, (MR_Integer) 7))));
                MR_Integer Var_153 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), Instance_73, (MR_Integer) 8))));

                {
                  AbstractInstance_74 = (MR_Word) MR_new_object(MR_Word, (9 * sizeof(MR_Word)), NULL, NULL);
                  MR_hl_field(MR_mktag(0), AbstractInstance_74, 0) = ((MR_Box) (Var_145));
                  MR_hl_field(MR_mktag(0), AbstractInstance_74, 1) = ((MR_Box) (Var_146));
                  MR_hl_field(MR_mktag(0), AbstractInstance_74, 2) = ((MR_Box) (Var_147));
                  MR_hl_field(MR_mktag(0), AbstractInstance_74, 3) = ((MR_Box) (Var_148));
                  MR_hl_field(MR_mktag(0), AbstractInstance_74, 4) = ((MR_Box) ((MR_Unsigned) 0U));
                  MR_hl_field(MR_mktag(0), AbstractInstance_74, 5) = ((MR_Box) (Var_150));
                  MR_hl_field(MR_mktag(0), AbstractInstance_74, 6) = ((MR_Box) (Var_151));
                  MR_hl_field(MR_mktag(0), AbstractInstance_74, 7) = ((MR_Box) (Var_152));
                  MR_hl_field(MR_mktag(0), AbstractInstance_74, 8) = ((MR_Box) (Var_153));
                }
                mercury__cord__snoc_3_p_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_instance_info_0), ((MR_Box) (AbstractInstance_74)), STATE_VARIABLE_Instances_0_11, &STATE_VARIABLE_Instances_128_128);
                STATE_VARIABLE_TypeDefns_134_134 = STATE_VARIABLE_TypeDefns_0_3;
                STATE_VARIABLE_InstDefns_133_133 = STATE_VARIABLE_InstDefns_0_5;
                STATE_VARIABLE_ModeDefns_132_132 = STATE_VARIABLE_ModeDefns_0_7;
                STATE_VARIABLE_TypeClasses_129_129 = STATE_VARIABLE_TypeClasses_0_9;
            ...
            case (MR_Integer) 11:
              {
                MR_Word ItemMutable_83 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Item_55, (MR_Integer) 1))));
                MR_String MutableName_84 = ((MR_String) ((MR_hl_field(MR_mktag(0), ItemMutable_83, (MR_Integer) 0))));
                MR_Word Type_86 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ItemMutable_83, (MR_Integer) 2))));
                MR_Word Inst_88 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ItemMutable_83, (MR_Integer) 4))));
                MR_Word MutAttrs_91 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ItemMutable_83, (MR_Integer) 7))));
                MR_Word Context_92 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ItemMutable_83, (MR_Integer) 8))));
                MR_Word PublicAuxPreds_94;
                MR_Word PublicAuxPredDecls_95;
                MR_Word Var_121;
                MR_Word Var_123;

                parse_tree__prog_mutable__compute_needed_public_mutable_aux_preds_2_p_0(MutAttrs_91, &PublicAuxPreds_94);
                {
                  Var_121 = (MR_Word) MR_new_object(MR_Word, (8 * sizeof(MR_Word)), NULL, NULL);
                  MR_hl_field(MR_mktag(0), Var_121, 0) = ((MR_Box) (&parse_tree__comp_unit_interface_scalar_common_6[0]));
                  MR_hl_field(MR_mktag(0), Var_121, 1) = ((MR_Box) (parse_tree__comp_unit_interface__get_private_interface_int0_from_items_22_p_0_1));
                  MR_hl_field(MR_mktag(0), Var_121, 2) = ((MR_Box) ((MR_Integer) 5));
                  MR_hl_field(MR_mktag(0), Var_121, 3) = ((MR_Box) (HeadVar__1_1));
                  MR_hl_field(MR_mktag(0), Var_121, 4) = ((MR_Box) (MutableName_84));
                  MR_hl_field(MR_mktag(0), Var_121, 5) = ((MR_Box) (Type_86));
                  MR_hl_field(MR_mktag(0), Var_121, 6) = ((MR_Box) (Inst_88));
                  MR_hl_field(MR_mktag(0), Var_121, 7) = ((MR_Box) (Context_92));
                }
                mercury__list__map_3_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mutable_pred_kind_0), (MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_pred_decl_info_0), Var_121, PublicAuxPreds_94, &PublicAuxPredDecls_95);
                Var_123 = mercury__cord__from_list_1_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_pred_decl_info_0), PublicAuxPredDecls_95);
                STATE_VARIABLE_PredDecls_131_131 = mercury__cord__f_43_43_2_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_pred_decl_info_0), STATE_VARIABLE_PredDecls_0_13, Var_123);
                STATE_VARIABLE_TypeDefns_134_134 = STATE_VARIABLE_TypeDefns_0_3;
                STATE_VARIABLE_InstDefns_133_133 = STATE_VARIABLE_InstDefns_0_5;
                STATE_VARIABLE_ModeDefns_132_132 = STATE_VARIABLE_ModeDefns_0_7;
                STATE_VARIABLE_TypeClasses_129_129 = STATE_VARIABLE_TypeClasses_0_9;
      ...
      next_value_of_STATE_VARIABLE_TypeDefns_0_3 = STATE_VARIABLE_TypeDefns_134_134;
      next_value_of_STATE_VARIABLE_InstDefns_0_5 = STATE_VARIABLE_InstDefns_133_133;
      next_value_of_STATE_VARIABLE_ModeDefns_0_7 = STATE_VARIABLE_ModeDefns_132_132;
      next_value_of_STATE_VARIABLE_TypeClasses_0_9 = STATE_VARIABLE_TypeClasses_129_129;
      next_value_of_STATE_VARIABLE_Instances_0_11 = STATE_VARIABLE_Instances_128_128;
      next_value_of_STATE_VARIABLE_PredDecls_0_13 = STATE_VARIABLE_PredDecls_131_131;
      next_value_of_STATE_VARIABLE_ModeDecls_0_15 = STATE_VARIABLE_ModeDecls_130_130;
      next_value_of_STATE_VARIABLE_ForeignEnums_0_17 = STATE_VARIABLE_ForeignEnums_126_126;
      next_value_of_STATE_VARIABLE_Pragmas_0_19 = STATE_VARIABLE_Pragmas_125_125;
      next_value_of_STATE_VARIABLE_Promises_0_21 = STATE_VARIABLE_Promises_124_124;
      HeadVar__2_2 = next_value_of_HeadVar__2_2;
  ...
  MR_Box * wrapper_arg_3)
{
  {
    MR_Box closure = closure_arg;
    MR_Word conv3_STATE_VARIABLE_ForeignEnumTypeCtors_17;

    parse_tree__comp_unit_interface__record_foreign_enum_3_p_0(((MR_Word) (wrapper_arg_1)), ((MR_Word) (wrapper_arg_2)), &conv3_STATE_VARIABLE_ForeignEnumTypeCtors_17);
    *wrapper_arg_3 = ((MR_Box) (conv3_STATE_VARIABLE_ForeignEnumTypeCtors_17));
  }
}
  ...
  MR_Box * wrapper_arg_3)
{
  {
    MR_Box closure = closure_arg;
    MR_Word conv1_STATE_VARIABLE_ForeignEnumTypeCtors_17;

    parse_tree__comp_unit_interface__record_foreign_enum_3_p_0(((MR_Word) (wrapper_arg_1)), ((MR_Word) (wrapper_arg_2)), &conv1_STATE_VARIABLE_ForeignEnumTypeCtors_17);
    *wrapper_arg_3 = ((MR_Box) (conv1_STATE_VARIABLE_ForeignEnumTypeCtors_17));
  }
}
...
{
  {
    ...
    MR_Word ParseTreeInt3_55;
    MR_Word ParseTreeInt23Prime_56;
    MR_Word Var_60;
    MR_Word Var_61;
    MR_Word Var_62;
    MR_Word Var_63;
    ...
    MR_Word Var_69;
    MR_Word Var_70;
    MR_Word _TypeCtorCheckedMap_48;
    MR_Word Var_79;
    MR_Word Var_81;
    MR_Word Var_82;
    MR_Word Var_83;
    ...
    mercury__list__map_3_p_0((MR_Word) (&parse_tree__comp_unit_interface_scalar_common_2[2]), (MR_Word) (&parse_tree__comp_unit_interface_scalar_common_2[3]), (MR_Word) (&parse_tree__comp_unit_interface_scalar_common_1[10]), SrcItemBlocks_13, &RawItemBlocks_18);
    ...
    Var_62 = mercury__cord__init_0_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_type_defn_info_0));
    Var_63 = mercury__cord__init_0_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_type_defn_info_0));
    ...
    Var_69 = mercury__cord__init_0_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_type_defn_info_0));
    ...
    parse_tree__comp_unit_interface__get_short_interface_int3_from_item_blocks_25_p_0(RawItemBlocks_18, Var_60, &IntInclModuleNames_19, Var_61, &IntImportModuleNames0_20, Var_62, &OrigIntTypeDefnsCord_21, Var_63, &IntTypeDefnsCord_22, Var_64, &IntInstDefnsCord_23, Var_65, &IntModeDefnsCord_24, Var_66, &IntTypeClassesCord_25, Var_67, &IntInstancesCord_26, Var_68, &OrigIntForeignEnumsCord_27, Var_69, &OrigImpTypeDefnsCord_28, Var_70, &OrigImpForeignEnumsCord_29, (MR_Integer) 0, &NeedImports_30);
    ...
    OrigIntTypeDefns_32 = mercury__cord__list_1_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_type_defn_info_0), OrigIntTypeDefnsCord_21);
    IntTypeDefns_33 = mercury__cord__list_1_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_type_defn_info_0), IntTypeDefnsCord_22);
    ...
    OrigImpTypeDefns_39 = mercury__cord__list_1_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_type_defn_info_0), OrigImpTypeDefnsCord_28);
    ...
    IntTypeDefnMap_41 = parse_tree__convert_interface__type_ctor_defn_items_to_map_1_f_0(IntTypeDefns_33);
    IntInstDefnMap_42 = parse_tree__convert_interface__inst_ctor_defn_items_to_map_1_f_0(IntInstDefns_34);
    IntModeDefnMap_43 = parse_tree__convert_interface__mode_ctor_defn_items_to_map_1_f_0(IntModeDefns_35);
    OrigIntTypeDefnMap_44 = parse_tree__convert_interface__type_ctor_defn_items_to_map_1_f_0(OrigIntTypeDefns_32);
    OrigIntForeignEnumMap_45 = parse_tree__convert_interface__type_ctor_foreign_enum_items_to_map_1_f_0(OrigIntForeignEnums_38);
    OrigImpTypeDefnMap_46 = parse_tree__convert_interface__type_ctor_defn_items_to_map_1_f_0(OrigImpTypeDefns_39);
    OrigImpForeignEnumMap_47 = parse_tree__convert_interface__type_ctor_foreign_enum_items_to_map_1_f_0(OrigImpForeignEnums_40);
    parse_tree__check_parse_tree_type_defns__create_type_ctor_checked_map_9_p_0((MR_Integer) 0, ModuleName_10, OrigIntTypeDefnMap_44, OrigImpTypeDefnMap_46, OrigIntForeignEnumMap_45, OrigImpForeignEnumMap_47, &_TypeCtorCheckedMap_48, STATE_VARIABLE_Specs_0_57, STATE_VARIABLE_Specs_58);
    libs__globals__lookup_bool_option_3_p_0(Globals_6, (MR_Integer) 695, &Experiment1_49);
    switch (Experiment1_49) {
      ...
      case (MR_Integer) 1:
        {
          MR_Word IntForeignEnumTypeMap_51;
          MR_Word IntImpForeignEnumTypeMap_52;
          MR_Word IntTypeRepnInfos_53;
          MR_Word Var_76;
          MR_Box conv2_IntForeignEnumTypeMap_51;
          MR_Box conv4_IntImpForeignEnumTypeMap_52;
          MR_Word _NonIntTypeRepnInfos_54;

          Var_76 = mercury__map__init_0_f_0((MR_Word) (&parse_tree__decide_type_repn__parse_tree__decide_type_repn__type_ctor_info_unqual_type_ctor_0), (MR_Word) (&parse_tree__comp_unit_interface_scalar_common_2[1]));
          mercury__list__foldl_4_p_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_foreign_enum_info_0), (MR_Word) (&parse_tree__comp_unit_interface_scalar_common_1[2]), (MR_Word) (&parse_tree__comp_unit_interface_scalar_common_1[11]), OrigIntForeignEnums_38, ((MR_Box) (Var_76)), &conv2_IntForeignEnumTypeMap_51);
          IntForeignEnumTypeMap_51 = ((MR_Word) (conv2_IntForeignEnumTypeMap_51));
          mercury__list__foldl_4_p_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_foreign_enum_info_0), (MR_Word) (&parse_tree__comp_unit_interface_scalar_common_1[2]), (MR_Word) (&parse_tree__comp_unit_interface_scalar_common_1[12]), OrigImpForeignEnums_40, ((MR_Box) (IntForeignEnumTypeMap_51)), &conv4_IntImpForeignEnumTypeMap_52);
          IntImpForeignEnumTypeMap_52 = ((MR_Word) (conv4_IntImpForeignEnumTypeMap_52));
          parse_tree__decide_type_repn__decide_repns_for_simple_types_6_p_0(ModuleName_10, OrigIntTypeDefns_32, OrigImpTypeDefns_39, IntImpForeignEnumTypeMap_52, &IntTypeRepnInfos_53, &_NonIntTypeRepnInfos_54);
          IntTypeRepnMap_50 = parse_tree__convert_interface__type_ctor_repn_items_to_map_1_f_0(IntTypeRepnInfos_53);
        }
        break;
    }
    {
      ParseTreeInt3_55 = (MR_Word) MR_new_object(MR_Word, (10 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), ParseTreeInt3_55, 0) = ((MR_Box) (ModuleName_10));
      MR_hl_field(MR_mktag(0), ParseTreeInt3_55, 1) = ((MR_Box) (ModuleNameContext_11));
      MR_hl_field(MR_mktag(0), ParseTreeInt3_55, 2) = ((MR_Box) (IntInclModuleNames_19));
      MR_hl_field(MR_mktag(0), ParseTreeInt3_55, 3) = ((MR_Box) (IntImportModuleNames_31));
      MR_hl_field(MR_mktag(0), ParseTreeInt3_55, 4) = ((MR_Box) (IntTypeDefnMap_41));
      MR_hl_field(MR_mktag(0), ParseTreeInt3_55, 5) = ((MR_Box) (IntInstDefnMap_42));
      MR_hl_field(MR_mktag(0), ParseTreeInt3_55, 6) = ((MR_Box) (IntModeDefnMap_43));
      MR_hl_field(MR_mktag(0), ParseTreeInt3_55, 7) = ((MR_Box) (IntTypeClasses_36));
      MR_hl_field(MR_mktag(0), ParseTreeInt3_55, 8) = ((MR_Box) (IntInstances_37));
      MR_hl_field(MR_mktag(0), ParseTreeInt3_55, 9) = ((MR_Box) (IntTypeRepnMap_50));
    }
    ParseTreeInt23Prime_56 = parse_tree__convert_interface__convert_parse_tree_int3_to_parse_tree_int_1_f_0(ParseTreeInt3_55);
    Var_79 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ParseTreeInt23Prime_56, (MR_Integer) 0))));
    Var_81 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ParseTreeInt23Prime_56, (MR_Integer) 2))));
    Var_82 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ParseTreeInt23Prime_56, (MR_Integer) 3))));
    Var_83 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ParseTreeInt23Prime_56, (MR_Integer) 4))));
    Var_84 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ParseTreeInt23Prime_56, (MR_Integer) 5))));
    Var_85 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ParseTreeInt23Prime_56, (MR_Integer) 6))));
    Var_86 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ParseTreeInt23Prime_56, (MR_Integer) 7))));
    Var_87 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ParseTreeInt23Prime_56, (MR_Integer) 8))));
    Var_88 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ParseTreeInt23Prime_56, (MR_Integer) 9))));
    Var_89 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ParseTreeInt23Prime_56, (MR_Integer) 10))));
    Var_90 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ParseTreeInt23Prime_56, (MR_Integer) 11))));
    {
      MR_Word base;
  ...
  MR_Box * wrapper_arg_3)
{
  {
    MR_Box closure = closure_arg;
    MR_Word conv2_STATE_VARIABLE_ForeignEnumTypeCtors_17;

    parse_tree__comp_unit_interface__record_foreign_enum_3_p_0(((MR_Word) (wrapper_arg_1)), ((MR_Word) (wrapper_arg_2)), &conv2_STATE_VARIABLE_ForeignEnumTypeCtors_17);
    *wrapper_arg_3 = ((MR_Box) (conv2_STATE_VARIABLE_ForeignEnumTypeCtors_17));
  }
}
  ...
  MR_Box * wrapper_arg_3)
{
  {
    MR_Box closure = closure_arg;
    MR_Word conv0_STATE_VARIABLE_ForeignEnumTypeCtors_17;

    parse_tree__comp_unit_interface__record_foreign_enum_3_p_0(((MR_Word) (wrapper_arg_1)), ((MR_Word) (wrapper_arg_2)), &conv0_STATE_VARIABLE_ForeignEnumTypeCtors_17);
    *wrapper_arg_3 = ((MR_Box) (conv0_STATE_VARIABLE_ForeignEnumTypeCtors_17));
  }
}
...
{
  {
    ...
    MR_Word Var_64;
    MR_Word Var_65;
    MR_Word _TypeCtorCheckedMap_44;
    MR_Word _Specs_52;
    ...
    Var_57 = mercury__cord__init_0_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_type_defn_info_0));
    ...
    Var_59 = mercury__cord__init_0_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_inst_defn_info_0));
    Var_60 = mercury__cord__init_0_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_mode_defn_info_0));
    Var_61 = mercury__cord__init_0_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_typeclass_info_0));
    Var_62 = mercury__cord__init_0_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_instance_info_0));
    Var_63 = mercury__cord__init_0_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_foreign_enum_info_0));
    Var_64 = mercury__cord__init_0_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_type_defn_info_0));
    ...
    parse_tree__comp_unit_interface__get_short_interface_int3_from_item_blocks_25_p_0(RawItemBlocks_14, Var_55, &IntInclModuleNames_15, Var_56, &IntImportModuleNames0_16, Var_57, &OrigIntTypeDefnsCord_17, Var_58, &IntTypeDefnsCord_18, Var_59, &IntInstDefnsCord_19, Var_60, &IntModeDefnsCord_20, Var_61, &IntTypeClassesCord_21, Var_62, &IntInstancesCord_22, Var_63, &OrigIntForeignEnumsCord_23, Var_64, &OrigImpTypeDefnsCord_24, Var_65, &OrigImpForeignEnumsCord_25, (MR_Integer) 0, &NeedImports_26);
    ...
    OrigIntTypeDefns_28 = mercury__cord__list_1_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_type_defn_info_0), OrigIntTypeDefnsCord_17);
    IntTypeDefns_29 = mercury__cord__list_1_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_type_defn_info_0), IntTypeDefnsCord_18);
    ...
    OrigImpTypeDefns_35 = mercury__cord__list_1_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_type_defn_info_0), OrigImpTypeDefnsCord_24);
    ...
    IntTypeDefnMap_37 = parse_tree__convert_interface__type_ctor_defn_items_to_map_1_f_0(IntTypeDefns_29);
    IntInstDefnMap_38 = parse_tree__convert_interface__inst_ctor_defn_items_to_map_1_f_0(IntInstDefns_30);
    IntModeDefnMap_39 = parse_tree__convert_interface__mode_ctor_defn_items_to_map_1_f_0(IntModeDefns_31);
    OrigIntTypeDefnMap_40 = parse_tree__convert_interface__type_ctor_defn_items_to_map_1_f_0(OrigIntTypeDefns_28);
    OrigIntForeignEnumMap_41 = parse_tree__convert_interface__type_ctor_foreign_enum_items_to_map_1_f_0(OrigIntForeignEnums_34);
    OrigImpTypeDefnMap_42 = parse_tree__convert_interface__type_ctor_defn_items_to_map_1_f_0(OrigImpTypeDefns_35);
    OrigImpForeignEnumMap_43 = parse_tree__convert_interface__type_ctor_foreign_enum_items_to_map_1_f_0(OrigImpForeignEnums_36);
    parse_tree__check_parse_tree_type_defns__create_type_ctor_checked_map_9_p_0((MR_Integer) 0, ModuleName_12, OrigIntTypeDefnMap_40, OrigImpTypeDefnMap_42, OrigIntForeignEnumMap_41, OrigImpForeignEnumMap_43, &_TypeCtorCheckedMap_44, STATE_VARIABLE_Specs_0_53, STATE_VARIABLE_Specs_54);
    libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 695, &Experiment1_45);
    switch (Experiment1_45) {
      ...
      case (MR_Integer) 1:
        {
          MR_Word IntForeignEnumTypeMap_47;
          MR_Word IntImpForeignEnumTypeMap_48;
          MR_Word IntTypeRepnInfos_49;
          MR_Word Var_71;
          MR_Box conv1_IntForeignEnumTypeMap_47;
          MR_Box conv3_IntImpForeignEnumTypeMap_48;
          MR_Word _NonIntTypeRepnInfos_50;

          Var_71 = mercury__map__init_0_f_0((MR_Word) (&parse_tree__decide_type_repn__parse_tree__decide_type_repn__type_ctor_info_unqual_type_ctor_0), (MR_Word) (&parse_tree__comp_unit_interface_scalar_common_2[1]));
          mercury__list__foldl_4_p_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_foreign_enum_info_0), (MR_Word) (&parse_tree__comp_unit_interface_scalar_common_1[2]), (MR_Word) (&parse_tree__comp_unit_interface_scalar_common_1[8]), OrigIntForeignEnums_34, ((MR_Box) (Var_71)), &conv1_IntForeignEnumTypeMap_47);
          IntForeignEnumTypeMap_47 = ((MR_Word) (conv1_IntForeignEnumTypeMap_47));
          mercury__list__foldl_4_p_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_foreign_enum_info_0), (MR_Word) (&parse_tree__comp_unit_interface_scalar_common_1[2]), (MR_Word) (&parse_tree__comp_unit_interface_scalar_common_1[9]), OrigImpForeignEnums_36, ((MR_Box) (IntForeignEnumTypeMap_47)), &conv3_IntImpForeignEnumTypeMap_48);
          IntImpForeignEnumTypeMap_48 = ((MR_Word) (conv3_IntImpForeignEnumTypeMap_48));
          parse_tree__decide_type_repn__decide_repns_for_simple_types_6_p_0(ModuleName_12, OrigIntTypeDefns_28, OrigImpTypeDefns_35, IntImpForeignEnumTypeMap_48, &IntTypeRepnInfos_49, &_NonIntTypeRepnInfos_50);
          IntTypeRepnMap_46 = parse_tree__convert_interface__type_ctor_repn_items_to_map_1_f_0(IntTypeRepnInfos_49);
        }
        break;
    }
    {
    ...
    ParseTreeInt0_51 = parse_tree__convert_interface__convert_parse_tree_int3_to_parse_tree_int_1_f_0(*ParseTreeInt3_9);
    parse_tree__module_qual__module_qualify_parse_tree_int3_5_p_0(Globals_7, ParseTreeInt0_51, ParseTreeInt_10, (MR_Word) ((MR_Unsigned) 0U), &_Specs_52);
  }
}
        ...
        case (MR_Integer) 0:
          {
            ...
            mercury__list__foldl_4_p_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_include_0), (MR_Word) (&parse_tree__comp_unit_interface_scalar_common_2[4]), (MR_Word) (&parse_tree__comp_unit_interface_scalar_common_1[5]), Incls_78, ((MR_Box) (STATE_VARIABLE_IntIncls_0_2)), &conv1_STATE_VARIABLE_IntIncls_111_111);
            STATE_VARIABLE_IntIncls_111_111 = ((MR_Word) (conv1_STATE_VARIABLE_IntIncls_111_111));
            mercury__list__filter_map_3_p_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_avail_0), (MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_avail_import_info_0), (MR_Word) (&parse_tree__comp_unit_interface_scalar_common_1[6]), Avails_79, &Imports_82);
            ImportModuleNames_83 = mercury__list__map_2_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_avail_import_info_0), (MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), (MR_Word) (&parse_tree__comp_unit_interface_scalar_common_1[7]), Imports_82);
        ...
        case (MR_Integer) 1:
          {
            ...
            mercury__cord__snoc_3_p_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_type_defn_info_0), ((MR_Box) (ItemTypeDefnInfo_16)), STATE_VARIABLE_ImpTypeDefns_0_2, &STATE_VARIABLE_ImpTypeDefns_37_37);
            STATE_VARIABLE_ImpForeignEnums_36_36 = STATE_VARIABLE_ImpForeignEnums_0_4;
          }
          break;
        case (MR_Integer) 2:
      ...
      case (MR_Integer) 0:
        {
          ...
          succeeded = parse_tree__prog_type__du_type_is_enum_3_p_0(DetailsDu_6, &_NumFunctors_54, &NumBits_55);
          if (succeeded)
            {
