...
static /* final */ const MR_Box parse_tree__comp_unit_interface_scalar_common_1[2][2];
...
static /* final */ const MR_Box parse_tree__comp_unit_interface_scalar_common_6[1][1];
...
{
  {
    ...
    {
      FIM_9 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), FIM_9, 0) = (MR_Box) ((MR_Unsigned) (Lang_5));
      MR_hl_field(MR_mktag(0), FIM_9, 1) = ((MR_Box) (ModuleName_4));
    }
    Info_10 = (MR_Word) (FIM_9);
    {
      Pragma_11 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(3), Pragma_11, 0) = ((MR_Box) ((MR_Unsigned) 29U));
      MR_hl_field(MR_mktag(3), Pragma_11, 1) = ((MR_Box) (Info_10));
    }
    Var_15 = mercury__term__context_init_0_f_0();
    {
      ItemPragma_12 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), ItemPragma_12, 0) = ((MR_Box) (Pragma_11));
      MR_hl_field(MR_mktag(0), ItemPragma_12, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), ((MR_Box) (&parse_tree__comp_unit_interface_scalar_common_6[0])))));
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(3), Item_6, 0) = ((MR_Box) ((MR_Unsigned) 3U));
        ...
        case (MR_Integer) 0:
          {
            ...
            succeeded = ((((MR_tag((MR_Word) Item_21)) == (MR_Integer) 3)) && ((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), Item_21, (MR_Integer) 0))) == (MR_Integer) 6)));
            if (succeeded)
            {
          ...
          case (MR_Integer) 5:
            {
              ...
              {
                AbstractItem_64 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), AbstractItem_64, 0) = ((MR_Box) ((MR_Unsigned) 5U));
