    ...
    case (MR_Integer) 1:
      {
        ...
        if (succeeded)
        {
          Var_77 = ((MR_Word) ((MR_hl_field(MR_mktag(0), RHS0_20, (MR_Integer) 0))));
          TypeInfo_78_78 = (MR_Word) (&check_hlds__simplify__simplify_goal_unify_scalar_common_1[0]);
          succeeded = mercury__builtin__unify_2_p_0(TypeInfo_78_78, ((MR_Box) (LHSVar0_19)), ((MR_Box) (Var_77)));
        }
        if (succeeded)
        {
          MR_Word Var_63;
          ...
          Context_74 = hlds__hlds_goal__goal_info_get_context_1_f_0(GoalInfo0_13);
          Var_63 = hlds__make_goal__true_goal_with_context_1_f_0(Context_74);
        ...
        else
        {
          ...
          if (succeeded)
          {
            ...
            else
            {
              ...
              check_hlds__simplify__simplify_goal_unify__f_85_110_117_115_101_100_65_114_103_115_95_95_112_114_101_100_95_95_112_114_111_99_101_115_115_95_99_111_109_112_108_95_117_110_105_102_121_95_95_91_53_93_95_48_14_p_0(LHSVar0_19, V_54, ComplMode_51, CanFail_52, UnifyContext_23, GoalInfo0_13, &GoalExpr1_55, NestedContext0_15, InstMap0_16, STATE_VARIABLE_Common_0_59, STATE_VARIABLE_Common_60, STATE_VARIABLE_Info_0_61, STATE_VARIABLE_Info_62);
            ...
            check_hlds__simplify__common__common_optimise_unification_12_p_0(RHS0_20, UnifyMode_21, Unification0_22, UnifyContext_23, GoalExpr0_11, GoalExpr_12, GoalInfo0_13, GoalInfo_14, STATE_VARIABLE_Common_0_59, STATE_VARIABLE_Common_60, STATE_VARIABLE_Info_0_61, STATE_VARIABLE_Info_62);
        }
      }
      break;
    case (MR_Integer) 2:
      {
        ...
        MR_Word VarsModes_29 = ((MR_Word) ((MR_hl_field(MR_mktag(2), RHS0_20, (MR_Integer) 3))));
        MR_Word LambdaDeclaredDetism_30 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(2), RHS0_20, (MR_Integer) 4))) & (MR_Integer) 7);
        MR_Word LambdaGoal0_31 = ((MR_Word) ((MR_hl_field(MR_mktag(2), RHS0_20, (MR_Integer) 5))));
          ...
          case (MR_Integer) 2:
            {
              ...
              Context_34 = hlds__hlds_goal__goal_info_get_context_1_f_0(GoalInfo0_13);
              {
                ...
                MR_hl_field(MR_mktag(1), Var_70, 0) = ((MR_Box) (Context_34));
              }
              {
                LambdaProcIsModelNon_33 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(1), LambdaProcIsModelNon_33, 0) = ((MR_Box) (Var_70));
              }
            }
            break;
        }
        InsideDuplForSwitch_35 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), NestedContext0_15, (MR_Integer) 0))) & (MR_Integer) 1);
        NumEnclosingBarriers_37 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), NestedContext0_15, (MR_Integer) 2))));
        succeeded = hlds__hlds_goal__goal_info_has_feature_2_p_0(GoalInfo0_13, (MR_Integer) 28);
        if (succeeded)
          LambdaNumEnclosingBarriers_38 = NumEnclosingBarriers_37;
        else
          LambdaNumEnclosingBarriers_38 = (NumEnclosingBarriers_37 + (MR_Unsigned) 1U);
        {
          LambdaNestedContext_39 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), LambdaNestedContext_39, 0) = (MR_Box) ((MR_Unsigned) (InsideDuplForSwitch_35));
          MR_hl_field(MR_mktag(0), LambdaNestedContext_39, 1) = ((MR_Box) (LambdaProcIsModelNon_33));
          MR_hl_field(MR_mktag(0), LambdaNestedContext_39, 2) = ((MR_Box) (LambdaNumEnclosingBarriers_38));
        }
        check_hlds__simplify__simplify_info__simplify_info_get_module_info_2_p_0(STATE_VARIABLE_Info_0_61, &ModuleInfo_40);
        hlds__instmap__pre_lambda_update_4_p_0(ModuleInfo_40, VarsModes_29, InstMap0_16, &LambdaInstMap0_41);
        check_hlds__simplify__simplify_info__simplify_info_get_simplify_tasks_2_p_0(STATE_VARIABLE_Info_0_61, &SimplifyTasks_42);
        LambdaCommon0_43 = check_hlds__simplify__common__common_info_init_1_f_0(SimplifyTasks_42);
        check_hlds__simplify__simplify_goal__simplify_goal_8_p_0(LambdaGoal0_31, &LambdaGoal_44, LambdaNestedContext_39, LambdaInstMap0_41, LambdaCommon0_43, &Var_45, STATE_VARIABLE_Info_0_61, STATE_VARIABLE_Info_62);
        {
          RHS_46 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, (6 * sizeof(MR_Word)), NULL, NULL));
          ...
          MR_hl_field(MR_mktag(2), RHS_46, 3) = ((MR_Box) (VarsModes_29));
          MR_hl_field(MR_mktag(2), RHS_46, 4) = (MR_Box) ((MR_Unsigned) (LambdaDeclaredDetism_30));
          MR_hl_field(MR_mktag(2), RHS_46, 5) = ((MR_Box) (LambdaGoal_44));
        }
        {
          MR_Word base;
  ...
  MR_Word * STATE_VARIABLE_Info_52)
{
  ...
  check_hlds__simplify__simplify_info__simplify_info_get_var_types_2_p_0(STATE_VARIABLE_Info_0_51, &VarTypes_28);
  ...
  if (succeeded)
  {
    ...
    Kind_31 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Type_29, (MR_Integer) 1))));
    {
      ...
      check_hlds__simplify__simplify_goal_unify__get_type_info_locn_7_p_0(TypeVar_30, Kind_31, Context_32, &TypeInfoVar_33, &ExtraGoals_34, STATE_VARIABLE_Info_0_51, STATE_VARIABLE_Info_52);
  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      Context_92 = hlds__hlds_goal__goal_info_get_context_1_f_0(GoalInfo0_21);
      Var_54 = mdbcomp__builtin_modules__mercury_private_builtin_module_0_f_0();
      {
        Var_65 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), Var_65, 0) = ((MR_Box) (YVar_16));
        MR_hl_field(MR_mktag(1), Var_65, 1) = ((MR_Box) ((MR_Unsigned) 0U));
      }
      {
        Var_60 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), Var_60, 0) = ((MR_Box) (XVar_15));
        MR_hl_field(MR_mktag(1), Var_60, 1) = ((MR_Box) (Var_65));
      }
      Var_62 = hlds__instmap__instmap_delta_bind_no_var_0_f_0();
      hlds__goal_util__generate_simple_call_12_p_0(ModuleInfo_27, Var_54, (MR_String) "builtin_unify_pred", (MR_Integer) 0, (MR_Word) (MR_mkword(MR_mktag(1), &check_hlds__simplify__simplify_goal_unify_scalar_common_2[0])), (MR_Integer) 1, (MR_Integer) 0, Var_60, (MR_Word) ((MR_Unsigned) 0U), Var_62, Context_92, &Var_63);
      Call0_36 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_63, (MR_Integer) 0))));
    ...
    else
    {
      ...
      if (succeeded)
      {
        hlds__hlds_pred__in_in_unification_proc_id_1_p_0(&Var_112);
        succeeded = (ProcId_43 == Var_112);
        if (succeeded)
      ...
      if (succeeded)
      {
        ...
        ExtraGoals_34 = (MR_Word) ((MR_Unsigned) 0U);
        Context_93 = hlds__hlds_goal__goal_info_get_context_1_f_0(GoalInfo0_21);
        Var_70 = mdbcomp__builtin_modules__mercury_private_builtin_module_0_f_0();
        {
          Var_79 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), Var_79, 0) = ((MR_Box) (YVar_16));
          MR_hl_field(MR_mktag(1), Var_79, 1) = ((MR_Box) ((MR_Unsigned) 0U));
        }
        {
          Var_76 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), Var_76, 0) = ((MR_Box) (XVar_15));
          MR_hl_field(MR_mktag(1), Var_76, 1) = ((MR_Box) (Var_79));
        }
        Var_78 = hlds__instmap__instmap_delta_bind_no_var_0_f_0();
        hlds__goal_util__generate_simple_call_12_p_0(ModuleInfo_27, Var_70, (MR_String) "builtin_compound_eq", (MR_Integer) 0, (MR_Word) ((MR_Unsigned) 0U), (MR_Integer) 1, (MR_Integer) 0, Var_76, (MR_Word) ((MR_Unsigned) 0U), Var_78, Context_93, &Call_35);
      ...
      else
      {
        ...
        hlds__hlds_pred__in_in_unification_proc_id_1_p_0(&Var_113);
        succeeded = (ProcId_43 == Var_113);
        if (succeeded)
        ...
        if (succeeded)
        {
          ...
          MR_Word Var_81;
          MR_Word TypeInfoVar_94;
          MR_Word TypeInfoVarPrime_45;
          MR_Word Var_84;

          {
            Var_81 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), Var_81, 0) = ((MR_Box) (Type_29));
            MR_hl_field(MR_mktag(1), Var_81, 1) = ((MR_Box) ((MR_Unsigned) 0U));
          }
          check_hlds__simplify__simplify_goal_unify__make_type_info_vars_5_p_0(Var_81, &TypeInfoVars_44, &ExtraGoals_34, STATE_VARIABLE_Info_0_51, STATE_VARIABLE_Info_52);
          succeeded = (TypeInfoVars_44 != (MR_Word) ((MR_Unsigned) 0U));
          if (succeeded)
          {
            TypeInfoVarPrime_45 = ((MR_Word) ((MR_hl_field(MR_mktag(1), TypeInfoVars_44, (MR_Integer) 0))));
            Var_84 = ((MR_Word) ((MR_hl_field(MR_mktag(1), TypeInfoVars_44, (MR_Integer) 1))));
            succeeded = (Var_84 == (MR_Word) ((MR_Unsigned) 0U));
          }
          if (succeeded)
            TypeInfoVar_94 = TypeInfoVarPrime_45;
          else
            {
          ...
          check_hlds__simplify__simplify_goal_unify__f_85_110_117_115_101_100_65_114_103_115_95_95_112_114_101_100_95_95_99_97_108_108_95_103_101_110_101_114_105_99_95_117_110_105_102_121_95_95_91_53_44_32_54_93_95_48_8_p_0(TypeInfoVar_94, XVar_15, YVar_16, ModuleInfo_27, GoalInfo0_21, &Call_35);
          *STATE_VARIABLE_Common_50 = STATE_VARIABLE_Common_0_49;
        }
        else
        {
          ...
          MR_Word Call0_95;
          MR_Word Call1_96;
          MR_Word TypeInfoVars_97;

          check_hlds__simplify__simplify_goal_unify__make_type_info_vars_5_p_0(TypeArgs_41, &TypeInfoVars_97, &ExtraGoals_34, STATE_VARIABLE_Info_0_51, &STATE_VARIABLE_Info_87_87);
          check_hlds__simplify__simplify_goal_unify__call_specific_unify_10_p_0(TypeCtor_40, TypeInfoVars_97, XVar_15, YVar_16, ProcId_43, ModuleInfo_27, UnifyContext_20, GoalInfo0_21, &Call0_95, &CallGoalInfo0_46);
          check_hlds__simplify__simplify_goal__simplify_goal_expr_10_p_0(Call0_95, &Call1_96, CallGoalInfo0_46, &CallGoalInfo1_47, NestedContext0_23, InstMap0_24, STATE_VARIABLE_Common_0_49, STATE_VARIABLE_Common_50, STATE_VARIABLE_Info_87_87, STATE_VARIABLE_Info_52);
          {
            Call_35 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
            MR_hl_field(MR_mktag(0), Call_35, 0) = ((MR_Box) (Call1_96));
            MR_hl_field(MR_mktag(0), Call_35, 1) = ((MR_Box) (CallGoalInfo1_47));
          }
        }
      }
    }
  }
  {
    ...
    MR_hl_field(MR_mktag(1), Var_90, 0) = ((MR_Box) (Call_35));
    MR_hl_field(MR_mktag(1), Var_90, 1) = ((MR_Box) ((MR_Unsigned) 0U));
  }
  Conjuncts_48 = mercury__list__f_43_43_2_f_0((MR_Word) (&hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_hlds_goal_0), ExtraGoals_34, Var_90);
  ...
  MR_Word * Call_16)
{
  ...
  hlds__goal_util__generate_simple_call_12_p_0(ModuleInfo_12, Var_22, (MR_String) "unify", (MR_Integer) 0, (MR_Word) (MR_mkword(MR_mktag(1), &check_hlds__simplify__simplify_goal_unify_scalar_common_2[0])), (MR_Integer) 1, (MR_Integer) 0, ArgVars_17, (MR_Word) ((MR_Unsigned) 0U), Var_29, Context_18, Call_16);
}
  ...
  MR_Word * STATE_VARIABLE_Info_19)
{
  ...
  else
  {
    ...
    check_hlds__polymorphism_type_info__gen_extract_type_info_14_p_0(ModuleInfo_31, TypeVar_8, Kind_9, TypeClassInfoVar_16, Var_38, Context_10, Goals_12, TypeInfoVar_11, VarSet0_32, &VarSet_35, VarTypes0_33, &VarTypes_36, RttiVarMaps0_34, &RttiVarMaps_37);
  ...
  MR_Word * STATE_VARIABLE_Info_24)
{
  ...
  check_hlds__simplify__simplify_info__simplify_info_get_varset_2_p_0(STATE_VARIABLE_Info_0_23, &VarSet0_10);
  check_hlds__simplify__simplify_info__simplify_info_get_var_types_2_p_0(STATE_VARIABLE_Info_0_23, &VarTypes0_11);
  check_hlds__simplify__simplify_info__simplify_info_get_rtti_varmaps_2_p_0(STATE_VARIABLE_Info_0_23, &RttiVarMaps0_12);
  check_hlds__simplify__simplify_info__simplify_info_get_module_info_2_p_0(STATE_VARIABLE_Info_0_23, &ModuleInfo0_13);
  check_hlds__simplify__simplify_info__simplify_info_get_pred_proc_id_2_p_0(STATE_VARIABLE_Info_0_23, &PredProcId_14);
  hlds__hlds_module__module_info_pred_proc_info_4_p_0(ModuleInfo0_13, PredProcId_14, &STATE_VARIABLE_PredInfo_25_25, &STATE_VARIABLE_ProcInfo_26_26);
  hlds__hlds_pred__proc_info_set_vartypes_3_p_0(VarTypes0_11, STATE_VARIABLE_ProcInfo_26_26, &STATE_VARIABLE_ProcInfo_27_27);
  hlds__hlds_pred__proc_info_set_varset_3_p_0(VarSet0_10, STATE_VARIABLE_ProcInfo_27_27, &STATE_VARIABLE_ProcInfo_28_28);
  hlds__hlds_pred__proc_info_set_rtti_varmaps_3_p_0(RttiVarMaps0_12, STATE_VARIABLE_ProcInfo_28_28, &STATE_VARIABLE_ProcInfo_29_29);
  mercury__term__context_init_1_p_0(&Context_17);
  check_hlds__polymorphism_type_info__polymorphism_make_type_info_vars_raw_10_p_0(Types_6, Context_17, TypeInfoVars_7, TypeInfoGoals_8, ModuleInfo0_13, &ModuleInfo1_18, STATE_VARIABLE_PredInfo_25_25, &STATE_VARIABLE_PredInfo_30_30, STATE_VARIABLE_ProcInfo_29_29, &STATE_VARIABLE_ProcInfo_31_31);
  hlds__hlds_pred__proc_info_get_vartypes_2_p_0(STATE_VARIABLE_ProcInfo_31_31, &VarTypes_19);
  hlds__hlds_pred__proc_info_get_varset_2_p_0(STATE_VARIABLE_ProcInfo_31_31, &VarSet_20);
  hlds__hlds_pred__proc_info_get_rtti_varmaps_2_p_0(STATE_VARIABLE_ProcInfo_31_31, &RttiVarMaps_21);
  check_hlds__simplify__simplify_info__simplify_info_set_var_types_3_p_0(VarTypes_19, STATE_VARIABLE_Info_0_23, &STATE_VARIABLE_Info_32_32);
  check_hlds__simplify__simplify_info__simplify_info_set_varset_3_p_0(VarSet_20, STATE_VARIABLE_Info_32_32, &STATE_VARIABLE_Info_33_33);
  check_hlds__simplify__simplify_info__simplify_info_set_rtti_varmaps_3_p_0(RttiVarMaps_21, STATE_VARIABLE_Info_33_33, &STATE_VARIABLE_Info_34_34);
  hlds__hlds_module__module_info_set_pred_proc_info_5_p_0(PredProcId_14, STATE_VARIABLE_PredInfo_30_30, STATE_VARIABLE_ProcInfo_31_31, ModuleInfo1_18, &ModuleInfo_22);
  check_hlds__simplify__simplify_info__simplify_info_set_module_info_3_p_0(ModuleInfo_22, STATE_VARIABLE_Info_34_34, STATE_VARIABLE_Info_24);
}
