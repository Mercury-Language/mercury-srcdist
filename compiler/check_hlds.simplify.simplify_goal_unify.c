  ...
  MR_Word * STATE_VARIABLE_Info_58)
{
  ...
  switch (MR_tag((MR_Word) RHS0_20)) {
    ...
    case (MR_Integer) 0:
      {
        MR_Word RHSVar0_47 = ((MR_Word) ((MR_hl_field(0, RHS0_20, (MR_Integer) 0))));
        ...
        if (succeeded)
        {
          ...
          Context_70 = hlds__hlds_goal__goal_info_get_context_1_f_0(GoalInfo0_13);
          Var_63 = hlds__make_goal__true_goal_with_context_1_f_0(Context_70);
          ...
          *STATE_VARIABLE_Common_56 = STATE_VARIABLE_Common_0_55;
        }
        else
        {
          ...
          if (succeeded)
          {
            ComplMode_48 = ((MR_Word) ((MR_hl_field(3, Unification0_22, (MR_Integer) 1))));
            CanFail_49 = ((MR_Unsigned) ((MR_hl_field(3, Unification0_22, (MR_Integer) 2))) & (MR_Integer) 1);
            {
              MR_Word GoalExpr1_51;

              check_hlds__simplify__simplify_goal_unify__f_85_110_117_115_101_100_65_114_103_115_95_95_112_114_101_100_95_95_112_114_111_99_101_115_115_95_99_111_109_112_108_105_99_97_116_101_100_95_117_110_105_102_121_95_95_91_53_93_95_48_14_p_0(LHSVar0_19, RHSVar0_47, ComplMode_48, CanFail_49, UnifyContext_23, GoalInfo0_13, &GoalExpr1_51, NestedContext0_15, InstMap0_16, STATE_VARIABLE_Common_0_55, STATE_VARIABLE_Common_56, STATE_VARIABLE_Info_0_57, STATE_VARIABLE_Info_58);
              *GoalExpr_12 = ((MR_Word) ((MR_hl_field(0, GoalExpr1_51, (MR_Integer) 0))));
              *GoalInfo_14 = ((MR_Word) ((MR_hl_field(0, GoalExpr1_51, (MR_Integer) 1))));
            }
          }
          else
            check_hlds__simplify__common__common_optimise_unification_12_p_0(RHS0_20, UnifyMode_21, Unification0_22, UnifyContext_23, GoalExpr0_11, GoalExpr_12, GoalInfo0_13, GoalInfo_14, STATE_VARIABLE_Common_0_55, STATE_VARIABLE_Common_56, STATE_VARIABLE_Info_0_57, STATE_VARIABLE_Info_58);
        }
      }
      break;
    case (MR_Integer) 1:
    ...
    case (MR_Integer) 2:
      {
        MR_Word NonLocals_27 = ((MR_Word) ((MR_hl_field(2, RHS0_20, (MR_Integer) 1))));
        MR_Word VarsModes_28 = ((MR_Word) ((MR_hl_field(2, RHS0_20, (MR_Integer) 2))));
        MR_Word LambdaDeclaredDetism_29 = ((MR_Unsigned) ((MR_hl_field(2, RHS0_20, (MR_Integer) 3))) & (MR_Integer) 7);
        MR_Word LambdaGoal0_30 = ((MR_Word) ((MR_hl_field(2, RHS0_20, (MR_Integer) 4))));
        ...
        MR_Word RHS_46;
        MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(2, RHS0_20, (MR_Integer) 0)));
        MR_Word Var_45;
          ...
          case (MR_Integer) 2:
            {
              ...
              Context_33 = hlds__hlds_goal__goal_info_get_context_1_f_0(GoalInfo0_13);
              {
                ...
                MR_hl_field(1, Var_59, 0) = ((MR_Box) (Context_33));
              }
              {
                LambdaProcIsModelNon_32 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(1, LambdaProcIsModelNon_32, 0) = ((MR_Box) (Var_59));
              }
            }
            break;
        }
        InsideDuplForSwitch_34 = ((MR_Unsigned) ((MR_hl_field(0, NestedContext0_15, (MR_Integer) 0))) & (MR_Integer) 1);
        NumEnclosingBarriers_36 = ((MR_Unsigned) ((MR_hl_field(0, NestedContext0_15, (MR_Integer) 2))));
        SwitchArmContexts_37 = ((MR_Word) ((MR_hl_field(0, NestedContext0_15, (MR_Integer) 3))));
        ...
        check_hlds__simplify__simplify_info__simplify_info_get_module_info_2_p_0(STATE_VARIABLE_Info_0_57, &ModuleInfo_40);
        hlds__instmap__pre_lambda_update_4_p_0(ModuleInfo_40, VarsModes_28, InstMap0_16, &LambdaInstMap0_41);
        check_hlds__simplify__simplify_info__simplify_info_get_simplify_tasks_2_p_0(STATE_VARIABLE_Info_0_57, &SimplifyTasks_42);
        LambdaCommon0_43 = check_hlds__simplify__common__common_info_init_1_f_0(SimplifyTasks_42);
        check_hlds__simplify__simplify_goal__simplify_goal_8_p_0(LambdaGoal0_30, &LambdaGoal_44, LambdaNestedContext_39, LambdaInstMap0_41, LambdaCommon0_43, &Var_45, STATE_VARIABLE_Info_0_57, STATE_VARIABLE_Info_58);
        {
          RHS_46 = (MR_Word) MR_mkword(2, MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(2, RHS_46, 0) = (MR_Box) (packed_word_0);
  ...
  MR_Word * STATE_VARIABLE_Info_52)
{
  ...
  if (succeeded)
  {
    ...
    Kind_31 = ((MR_Word) ((MR_hl_field(0, Type_29, (MR_Integer) 1))));
    {
      ...
      {
        TypeInfoVar_33 = ((MR_Word) ((MR_hl_field(0, TypeInfoLocn_91, (MR_Integer) 0))));
        ExtraGoals_34 = (MR_Word) ((MR_Unsigned) 0U);
        *STATE_VARIABLE_Info_52 = STATE_VARIABLE_Info_0_51;
      }
      else
      {
        MR_Word TypeClassInfoVar_92 = ((MR_Word) ((MR_hl_field(1, TypeInfoLocn_91, (MR_Integer) 0))));
        MR_Integer Index_93 = ((MR_Integer) ((MR_hl_field(1, TypeInfoLocn_91, (MR_Integer) 1))));
        ...
        MR_Word Var_99;
        MR_Word STATE_VARIABLE_Info_26_100;
        ...
        check_hlds__simplify__simplify_info__simplify_info_set_var_table_3_p_0(VarTable_97, STATE_VARIABLE_Info_0_51, &STATE_VARIABLE_Info_26_100);
        check_hlds__simplify__simplify_info__simplify_info_set_rtti_varmaps_3_p_0(RttiVarMaps_98, STATE_VARIABLE_Info_26_100, STATE_VARIABLE_Info_52);
      }
  ...
  else
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        MR_Word STATE_VARIABLE_PredInfo_22_109;
        MR_Word STATE_VARIABLE_ProcInfo_23_110;
        MR_Word STATE_VARIABLE_ProcInfo_24_111;
        MR_Word STATE_VARIABLE_ProcInfo_25_112;
        MR_Word Var_113;
        MR_Word STATE_VARIABLE_PredInfo_27_114;
        MR_Word STATE_VARIABLE_ProcInfo_28_115;
        MR_Word STATE_VARIABLE_Info_29_116;
        MR_Word STATE_VARIABLE_Info_30_117;
        ...
        hlds__hlds_module__module_info_pred_proc_info_4_p_0(ModuleInfo0_103, PredProcId_104, &STATE_VARIABLE_PredInfo_22_109, &STATE_VARIABLE_ProcInfo_23_110);
        hlds__hlds_pred__proc_info_set_var_table_3_p_0(VarTable0_101, STATE_VARIABLE_ProcInfo_23_110, &STATE_VARIABLE_ProcInfo_24_111);
        hlds__hlds_pred__proc_info_set_rtti_varmaps_3_p_0(RttiVarMaps0_102, STATE_VARIABLE_ProcInfo_24_111, &STATE_VARIABLE_ProcInfo_25_112);
        Var_113 = mercury__term_context__dummy_context_0_f_0();
        check_hlds__polymorphism_type_info__polymorphism_make_type_info_vars_mi_10_p_0(Var_71, Var_113, &TypeInfoVars_44, &ExtraGoals_34, ModuleInfo0_103, &ModuleInfo1_105, STATE_VARIABLE_PredInfo_22_109, &STATE_VARIABLE_PredInfo_27_114, STATE_VARIABLE_ProcInfo_25_112, &STATE_VARIABLE_ProcInfo_28_115);
        hlds__hlds_pred__proc_info_get_var_table_2_p_0(STATE_VARIABLE_ProcInfo_28_115, &VarTable_106);
        hlds__hlds_pred__proc_info_get_rtti_varmaps_2_p_0(STATE_VARIABLE_ProcInfo_28_115, &RttiVarMaps_107);
        check_hlds__simplify__simplify_info__simplify_info_set_var_table_3_p_0(VarTable_106, STATE_VARIABLE_Info_0_51, &STATE_VARIABLE_Info_29_116);
        check_hlds__simplify__simplify_info__simplify_info_set_rtti_varmaps_3_p_0(RttiVarMaps_107, STATE_VARIABLE_Info_29_116, &STATE_VARIABLE_Info_30_117);
        hlds__hlds_module__module_info_set_pred_proc_info_5_p_0(PredProcId_104, STATE_VARIABLE_PredInfo_27_114, STATE_VARIABLE_ProcInfo_28_115, ModuleInfo1_105, &ModuleInfo_108);
        check_hlds__simplify__simplify_info__simplify_info_set_module_info_3_p_0(ModuleInfo_108, STATE_VARIABLE_Info_30_117, STATE_VARIABLE_Info_52);
        succeeded = (TypeInfoVars_44 != (MR_Word) ((MR_Unsigned) 0U));
        if (succeeded)
        {
          TypeInfoVarPrime_45 = ((MR_Word) ((MR_hl_field(1, TypeInfoVars_44, (MR_Integer) 0))));
          Var_74 = ((MR_Word) ((MR_hl_field(1, TypeInfoVars_44, (MR_Integer) 1))));
      ...
      else
      {
        ...
        check_hlds__simplify__simplify_goal_unify__make_type_info_vars_5_p_0(TypeArgs_41, &TypeInfoVars_86, &ExtraGoals_34, STATE_VARIABLE_Info_0_51, &STATE_VARIABLE_Info_77_77);
        ...
        check_hlds__simplify__simplify_goal__simplify_goal_expr_10_p_0(Call0_84, &Call1_85, CallGoalInfo0_46, &CallGoalInfo1_47, NestedContext0_23, InstMap0_24, STATE_VARIABLE_Common_0_49, STATE_VARIABLE_Common_50, STATE_VARIABLE_Info_77_77, STATE_VARIABLE_Info_52);
        {
          Call_35 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
