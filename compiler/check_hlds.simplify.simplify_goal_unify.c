...
{
  {
    ...
    switch (MR_tag((MR_Word) RHS0_20)) {
      ...
      case (MR_Integer) 1:
        {
          ...
          if (succeeded)
          {
            Var_80 = ((MR_Word) ((MR_hl_field(MR_mktag(0), RHS0_20, (MR_Integer) 0))));
            TypeInfo_81_81 = (MR_Word) (&check_hlds__simplify__simplify_goal_unify_scalar_common_1[0]);
            succeeded = mercury__builtin__unify_2_p_0(TypeInfo_81_81, ((MR_Box) (LHSVar0_19)), ((MR_Box) (Var_80)));
          }
          if (succeeded)
          {
            MR_Word Var_64;
            ...
            Context_77 = hlds__hlds_goal__goal_info_get_context_1_f_0(GoalInfo0_13);
            Var_64 = hlds__make_goal__true_goal_with_context_1_f_0(Context_77);
      ...
      case (MR_Integer) 2:
        {
          MR_Word Purity_24 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(2), RHS0_20, (MR_Integer) 0))) & (MR_Integer) 3);
          MR_Word Groundness_25 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(2), RHS0_20, (MR_Integer) 0))) >> (MR_Integer) 2)) & (MR_Integer) 1);
          MR_Word PredOrFunc_26 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(2), RHS0_20, (MR_Integer) 0))) >> (MR_Integer) 3)) & (MR_Integer) 1);
          ...
          Var_74 = (MR_Integer) ((MR_Unsigned) NumEnclosingLambdas0_37 + (MR_Unsigned) (MR_Integer) 1);
          {
            ...
            MR_hl_field(MR_mktag(0), LambdaNestedContext_39, 1) = ((MR_Box) (Var_74));
          ...
          check_hlds__simplify__simplify_goal__simplify_goal_8_p_0(LambdaGoal0_32, &LambdaGoal_43, LambdaNestedContext_39, LambdaInstMap0_41, LambdaCommon0_42, &Var_44, STATE_VARIABLE_Info_0_62, STATE_VARIABLE_Info_63);
          {
            ...
            MR_hl_field(MR_mktag(2), RHS_45, 0) = (MR_Box) (((MR_Unsigned) (((MR_Box) (Purity_24))) | (((((MR_Unsigned) (((MR_Box) (Groundness_25))) << (MR_Integer) 2)) | (((MR_Unsigned) (((MR_Box) (PredOrFunc_26))) << (MR_Integer) 3))))));
...
{
  {
    ...
    else
    {
      ...
      else
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_44, (MR_Integer) 285, &CanCompareCompoundValues_45);
