...
check_hlds__simplify__simplify_goal_unify__IntroducedFrom__pred__make_type_info_vars__327__1_2_p_0(
...
{
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        Context_85 = hlds__hlds_goal__goal_info_get_context_1_f_0(GoalInfo0_21);
        ...
        hlds__goal_util__generate_simple_call_12_p_0(Var_56, (MR_String) "builtin_unify_pred", (MR_Integer) 0, (MR_Word) MR_mkword(MR_mktag(1), &check_hlds__simplify__simplify_goal_unify_scalar_common_3[0]), (MR_Integer) 1, (MR_Integer) 0, Var_62, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), Var_64, ModuleInfo_27, Context_85, &Var_65);
        Call0_36 = ((MR_Word) (MR_hl_field(MR_mktag(0), Var_65, (MR_Integer) 0)));
        Var_37 = ((MR_Word) (MR_hl_field(MR_mktag(0), Var_65, (MR_Integer) 1)));
      ...
      else
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_44, (MR_Integer) 281, &CanCompareCompoundValues_45);
        ...
        else
        {
          ...
          hlds__hlds_pred__in_in_unification_proc_id_1_p_0(&Var_103);
          succeeded = (ProcId_43 == Var_103);
          if (succeeded)
          ...
          if (succeeded)
          {
            ...
            succeeded = ((MR_tag((MR_Word) TypeInfoVars_46)) == (MR_mktag((MR_Integer) 1)));
            if (succeeded)
            {
            ...
            if (succeeded)
              TypeInfoVar_86 = TypeInfoVarPrime_47;
            else
            {
              {
            ...
            check_hlds__simplify__simplify_goal_unify__f_85_110_117_115_101_100_65_114_103_115_95_95_112_114_101_100_95_95_99_97_108_108_95_103_101_110_101_114_105_99_95_117_110_105_102_121_95_95_91_53_44_32_54_93_95_48_8_p_0(TypeInfoVar_86, XVar_15, YVar_16, ModuleInfo_27, GoalInfo0_21, &Call_35);
            *STATE_VARIABLE_Common_52 = STATE_VARIABLE_Common_0_51;
          }
          else
          {
            ...
            check_hlds__simplify__simplify_goal_unify__make_type_info_vars_5_p_0(TypeArgs_41, &TypeInfoVars_89, &ExtraGoals_34, STATE_VARIABLE_Info_0_53, &STATE_VARIABLE_Info_80_80);
            check_hlds__simplify__simplify_goal_unify__call_specific_unify_10_p_0(TypeCtor_40, TypeInfoVars_89, XVar_15, YVar_16, ProcId_43, ModuleInfo_27, UnifyContext_20, GoalInfo0_21, &Call0_87, &CallGoalInfo0_48);
            check_hlds__simplify__simplify_goal__simplify_goal_expr_10_p_0(Call0_87, &Call1_88, CallGoalInfo0_48, &CallGoalInfo1_49, NestedContext0_23, InstMap0_24, STATE_VARIABLE_Common_0_51, STATE_VARIABLE_Common_52, STATE_VARIABLE_Info_80_80, STATE_VARIABLE_Info_54);
            {
              Call_35 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
              MR_hl_field(MR_mktag(0), Call_35, 0) = ((MR_Box) (Call1_88));
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), Var_83, 0) = ((MR_Box) (Call_35));
      MR_hl_field(MR_mktag(1), Var_83, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
    }
    Conjuncts_50 = mercury__list__f_43_43_2_f_0((MR_Word) &hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_hlds_goal_0, ExtraGoals_34, Var_83);
...
{
  {
    ...
    succeeded = check_hlds__simplify__simplify_goal_unify__IntroducedFrom__pred__make_type_info_vars__327__1_2_p_0(((MR_Word) (MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3))), ((MR_Word) (MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4))));
    return succeeded;
  }
}
