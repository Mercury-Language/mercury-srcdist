      ...
      case (MR_Integer) 2:
        {
          ...
          MR_Integer NumEnclosingBarriers_38;
          MR_Integer LambdaNumEnclosingBarriers_39;
          ...
          NumEnclosingBarriers_38 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), NestedContext0_15, (MR_Integer) 2))));
          ...
          {
            LambdaNumEnclosingBarriers_39 = (MR_Integer) ((MR_Unsigned) NumEnclosingBarriers_38 + (MR_Unsigned) (MR_Integer) 1);
          }
          {
