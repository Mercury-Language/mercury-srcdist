    ...
    case (MR_Integer) 1:
      {
        ...
        if (succeeded)
        {
          ...
          TypeInfo__78_78 = (MR_Word) (&check_hlds__simplify__simplify_goal_unify_scalar_common_1[0]);
          succeeded = mercury__builtin__unify_2_p_0(TypeInfo__78_78, ((MR_Box) (LHSVar0_19)), ((MR_Box) (Var_77)));
        }
        if (succeeded)
        {
          MR_Word Var_63;
  ...
  MR_Word * STATE_VARIABLE_Info_19)
{
  ...
  else
  {
    ...
    check_hlds__simplify__simplify_info__simplify_info_get_module_info_2_p_0(STATE_VARIABLE_Info_0_18, &ModuleInfo_20);
    check_hlds__simplify__simplify_info__simplify_info_get_varset_2_p_0(STATE_VARIABLE_Info_0_18, &VarSet0_21);
    check_hlds__simplify__simplify_info__simplify_info_get_var_types_2_p_0(STATE_VARIABLE_Info_0_18, &VarTypes0_22);
    check_hlds__simplify__simplify_info__simplify_info_get_rtti_varmaps_2_p_0(STATE_VARIABLE_Info_0_18, &RttiVarMaps0_23);
    {
      Var_27 = (MR_Word) MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), Var_27, 0) = ((MR_Box) (Index_17));
    }
    check_hlds__polymorphism_type_info__gen_extract_type_info_14_p_0(ModuleInfo_20, TypeVar_8, Kind_9, TypeClassInfoVar_16, Var_27, Context_10, Goals_12, TypeInfoVar_11, VarSet0_21, &VarSet_24, VarTypes0_22, &VarTypes_25, RttiVarMaps0_23, &RttiVarMaps_26);
    check_hlds__simplify__simplify_info__simplify_info_set_var_types_3_p_0(VarTypes_25, STATE_VARIABLE_Info_0_18, &STATE_VARIABLE_Info_28_28);
    check_hlds__simplify__simplify_info__simplify_info_set_varset_3_p_0(VarSet_24, STATE_VARIABLE_Info_28_28, &STATE_VARIABLE_Info_29_29);
    check_hlds__simplify__simplify_info__simplify_info_set_rtti_varmaps_3_p_0(RttiVarMaps_26, STATE_VARIABLE_Info_29_29, STATE_VARIABLE_Info_19);
  }
}
  ...
  MR_Word * STATE_VARIABLE_Info_24)
{
  ...
  check_hlds__polymorphism_type_info__polymorphism_make_type_info_vars_mi_10_p_0(Types_6, Context_17, TypeInfoVars_7, TypeInfoGoals_8, ModuleInfo0_13, &ModuleInfo1_18, STATE_VARIABLE_PredInfo_25_25, &STATE_VARIABLE_PredInfo_29_29, STATE_VARIABLE_ProcInfo_28_28, &STATE_VARIABLE_ProcInfo_30_30);
