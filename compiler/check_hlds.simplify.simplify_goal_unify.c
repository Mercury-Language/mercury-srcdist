...
{
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        hlds__goal_util__generate_simple_call_12_p_0(ModuleInfo_27, Var_56, (MR_String) "builtin_unify_pred", (MR_Integer) 0, (MR_Word) (MR_mkword(MR_mktag(1), &check_hlds__simplify__simplify_goal_unify_scalar_common_2[0])), (MR_Integer) 1, (MR_Integer) 0, Var_62, (MR_Word) ((MR_Unsigned) 0U), Var_64, Context_84, &Var_65);
      ...
      else
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_44, (MR_Integer) 317, &CanCompareCompoundValues_45);
