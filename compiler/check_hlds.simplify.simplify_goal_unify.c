...
check_hlds__simplify__simplify_goal_unify__IntroducedFrom__pred__make_type_info_vars__326__1_2_p_0(
...
{
  {
    ...
    succeeded = check_hlds__simplify__simplify_goal_unify__IntroducedFrom__pred__make_type_info_vars__326__1_2_p_0(((MR_Word) (MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3))), ((MR_Word) (MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4))));
    return succeeded;
  }
}
