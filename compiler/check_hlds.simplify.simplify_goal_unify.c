    ...
    else
      {
        ...
        if (check_hlds__simplify__simplify_goal_unify__succeeded)
        ...
        else
          {
            ...
            {
              libs__globals__lookup_bool_option_3_p_0(check_hlds__simplify__simplify_goal_unify__Globals_44, (MR_Integer) 283, &check_hlds__simplify__simplify_goal_unify__SpecialPreds_45);
            }
            {
              libs__globals__lookup_bool_option_3_p_0(check_hlds__simplify__simplify_goal_unify__Globals_44, (MR_Integer) 279, &check_hlds__simplify__simplify_goal_unify__CanCompareCompoundValues_46);
            }
            {
