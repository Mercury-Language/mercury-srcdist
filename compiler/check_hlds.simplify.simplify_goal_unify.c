      ...
      case (MR_Integer) 1:
        {
          ...
          else
          {
            ...
            succeeded = ((((MR_tag((MR_Word) Unification0_22)) == (MR_Integer) 3)) && ((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), Unification0_22, (MR_Integer) 0))) == (MR_Integer) 1)));
            if (succeeded)
            {
              ComplMode_50 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Unification0_22, (MR_Integer) 1))));
              packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Unification0_22, (MR_Integer) 2)));
              CanFail_51 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(3), Unification0_22, (MR_Integer) 2))) & (MR_Integer) 1);
      ...
      case (MR_Integer) 2:
        {
          ...
          MR_Word RHS_45;
          MR_Integer Var_74;
          MR_Unsigned packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), RHS0_20, (MR_Integer) 0)));
          MR_Unsigned packed_args_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), RHS0_20, (MR_Integer) 5)));
          ...
          switch (LambdaCodeModel_33) {
            ...
            case (MR_Integer) 0:
            case (MR_Integer) 1:
              ProcIsModelNon_34 = (MR_Word) ((MR_Unsigned) 0U);
              break;
            case (MR_Integer) 2:
              {
                MR_Word Context_35;
          ...
          packed_args_3 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), NestedContext0_15, (MR_Integer) 0)));
          ...
          Var_74 = (MR_Integer) ((MR_Unsigned) NumEnclosingLambdas0_37 + (MR_Unsigned) (MR_Integer) 1);
          {
            ...
            MR_hl_field(MR_mktag(0), LambdaNestedContext_39, 0) = (MR_Box) (packed_args_3);
          ...
          check_hlds__simplify__simplify_goal__simplify_goal_8_p_0(LambdaGoal0_32, &LambdaGoal_43, LambdaNestedContext_39, LambdaInstMap0_41, LambdaCommon0_42, &Var_44, STATE_VARIABLE_Info_0_62, STATE_VARIABLE_Info_63);
          {
            ...
            MR_hl_field(MR_mktag(2), RHS_45, 0) = (MR_Box) (packed_args_1);
            ...
            MR_hl_field(MR_mktag(2), RHS_45, 5) = (MR_Box) (packed_args_2);
...
{
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        hlds__goal_util__generate_simple_call_12_p_0(Var_56, (MR_String) "builtin_unify_pred", (MR_Integer) 0, (MR_Word) (MR_mkword(MR_mktag(1), &check_hlds__simplify__simplify_goal_unify_scalar_common_3[0])), (MR_Integer) 1, (MR_Integer) 0, Var_62, (MR_Word) ((MR_Unsigned) 0U), Var_64, ModuleInfo_27, Context_84, &Var_65);
      ...
      else
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_44, (MR_Integer) 290, &CanCompareCompoundValues_45);
        ...
        else
        {
          ...
          if (succeeded)
          {
            ...
            succeeded = ((MR_tag((MR_Word) TypeInfoVars_46)) == (MR_Integer) 1);
            if (succeeded)
            {
...
{
  {
    ...
    hlds__goal_util__generate_simple_call_12_p_0(Var_22, (MR_String) "unify", (MR_Integer) 0, (MR_Word) (MR_mkword(MR_mktag(1), &check_hlds__simplify__simplify_goal_unify_scalar_common_3[0])), (MR_Integer) 1, (MR_Integer) 0, ArgVars_17, (MR_Word) ((MR_Unsigned) 0U), Var_29, ModuleInfo_12, Context_18, Call_16);
  }
}
...
{
  {
    ...
    hlds__goal_util__generate_simple_call_12_p_0(Var_12, (MR_String) "builtin_compound_eq", (MR_Integer) 0, (MR_Word) ((MR_Unsigned) 0U), (MR_Integer) 1, (MR_Integer) 0, Var_18, (MR_Word) ((MR_Unsigned) 0U), Var_20, ModuleInfo_8, Context_11, Call_10);
  }
}
