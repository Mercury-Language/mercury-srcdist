...
{
  {
    ...
    {
      check_hlds__simplify__simplify_goal_unify__V_36_36 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 5 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), check_hlds__simplify__simplify_goal_unify__V_36_36, 0) = ((MR_Box) (&check_hlds__simplify__simplify_goal_unify_scalar_common_2[0]));
      MR_hl_field(MR_mktag(0), check_hlds__simplify__simplify_goal_unify__V_36_36, 1) = ((MR_Box) (check_hlds__simplify__simplify_goal_unify__make_type_info_vars_5_p_0_1));
      MR_hl_field(MR_mktag(0), check_hlds__simplify__simplify_goal_unify__V_36_36, 2) = ((MR_Box) (MR_Word) ((MR_Integer) 2));
      MR_hl_field(MR_mktag(0), check_hlds__simplify__simplify_goal_unify__V_36_36, 3) = ((MR_Box) (check_hlds__simplify__simplify_goal_unify__PolySpecs_19));
      MR_hl_field(MR_mktag(0), check_hlds__simplify__simplify_goal_unify__V_36_36, 4) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
    }
    {
      mercury__require__expect_4_p_0(check_hlds__simplify__simplify_goal_unify__V_36_36, (MR_String) "check_hlds.simplify.simplify_goal_unify", (MR_String) "predicate \140check_hlds.simplify.simplify_goal_unify.make_type_info_vars\'/5", (MR_String) "got errors while making type_info_var");
    }
    {
