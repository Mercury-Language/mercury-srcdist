    ...
    case (MR_Integer) 1:
      {
        ...
        if (succeeded)
        {
          Var_75 = ((MR_Word) ((MR_hl_field(MR_mktag(0), RHS0_20, (MR_Integer) 0))));
          TypeInfo_76_76 = (MR_Word) (&check_hlds__simplify__simplify_goal_unify_scalar_common_1[0]);
          succeeded = mercury__builtin__unify_2_p_0(TypeInfo_76_76, ((MR_Box) (LHSVar0_19)), ((MR_Box) (Var_75)));
        }
        if (succeeded)
        {
          MR_Word Var_67;
  ...
  MR_Word * STATE_VARIABLE_Info_19)
{
  ...
  else
  {
    ...
    MR_Word Var_35;
    MR_Word STATE_VARIABLE_Info_26_36;

    check_hlds__simplify__simplify_info__simplify_info_get_module_info_2_p_0(STATE_VARIABLE_Info_0_18, &ModuleInfo_30);
    check_hlds__simplify__simplify_info__simplify_info_get_var_table_2_p_0(STATE_VARIABLE_Info_0_18, &VarTable0_31);
    check_hlds__simplify__simplify_info__simplify_info_get_rtti_varmaps_2_p_0(STATE_VARIABLE_Info_0_18, &RttiVarMaps0_32);
    {
      Var_35 = (MR_Word) MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), Var_35, 0) = ((MR_Box) (Index_17));
    }
    check_hlds__polymorphism_type_info__gen_extract_type_info_12_p_0(ModuleInfo_30, TypeVar_8, Kind_9, TypeClassInfoVar_16, Var_35, Context_10, Goals_12, TypeInfoVar_11, VarTable0_31, &VarTable_33, RttiVarMaps0_32, &RttiVarMaps_34);
    check_hlds__simplify__simplify_info__simplify_info_set_var_table_3_p_0(VarTable_33, STATE_VARIABLE_Info_0_18, &STATE_VARIABLE_Info_26_36);
    check_hlds__simplify__simplify_info__simplify_info_set_rtti_varmaps_3_p_0(RttiVarMaps_34, STATE_VARIABLE_Info_26_36, STATE_VARIABLE_Info_19);
  }
}
