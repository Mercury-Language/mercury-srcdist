      ...
      case (MR_Integer) 2:
        {
          ...
          switch (LambdaCodeModel_33) {
            ...
            case (MR_Integer) 0:
            case (MR_Integer) 1:
              ProcIsModelNon_34 = (MR_Word) ((MR_Integer) 0);
              break;
            case (MR_Integer) 2:
              {
                MR_Word Context_35;
...
{
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        hlds__goal_util__generate_simple_call_12_p_0(Var_56, (MR_String) "builtin_unify_pred", (MR_Integer) 0, (MR_Word) (MR_mkword(MR_mktag(1), &check_hlds__simplify__simplify_goal_unify_scalar_common_3[0])), (MR_Integer) 1, (MR_Integer) 0, Var_62, (MR_Word) ((MR_Integer) 0), Var_64, ModuleInfo_27, Context_84, &Var_65);
        ...
        ExtraGoals_34 = (MR_Word) ((MR_Integer) 0);
      }
      else
      {
        MR_Word TypeCtor_40;
...
{
  {
    ...
    hlds__goal_util__generate_simple_call_12_p_0(Var_22, (MR_String) "unify", (MR_Integer) 0, (MR_Word) (MR_mkword(MR_mktag(1), &check_hlds__simplify__simplify_goal_unify_scalar_common_3[0])), (MR_Integer) 1, (MR_Integer) 0, ArgVars_17, (MR_Word) ((MR_Integer) 0), Var_29, ModuleInfo_12, Context_18, Call_16);
  }
}
...
{
  {
    ...
    hlds__goal_util__generate_simple_call_12_p_0(Var_12, (MR_String) "builtin_compound_eq", (MR_Integer) 0, (MR_Word) ((MR_Integer) 0), (MR_Integer) 1, (MR_Integer) 0, Var_18, (MR_Word) ((MR_Integer) 0), Var_20, ModuleInfo_8, Context_11, Call_10);
  }
}
