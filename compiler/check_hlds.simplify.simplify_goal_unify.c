    ...
    case (MR_Integer) 1:
      {
        ...
        if (succeeded)
        {
          ...
          Var_67 = hlds__make_goal__true_goal_with_context_1_f_0(Context_74);
          *GoalExpr_12 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_67, (MR_Integer) 0))));
          *GoalInfo_14 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_67, (MR_Integer) 1))));
          ...
          case (MR_Integer) 2:
            {
              ...
              Context_34 = hlds__hlds_goal__goal_info_get_context_1_f_0(GoalInfo0_13);
              {
                ...
                MR_hl_field(MR_mktag(1), Var_63, 0) = ((MR_Box) (Context_34));
              }
              {
                LambdaProcIsModelNon_33 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(1), LambdaProcIsModelNon_33, 0) = ((MR_Box) (Var_63));
              }
            }
            break;
        }
  ...
  MR_Word * STATE_VARIABLE_Info_19)
{
  ...
  else
  {
    ...
    check_hlds__simplify__simplify_info__simplify_info_get_var_table_2_p_0(STATE_VARIABLE_Info_0_18, &VarTable0_32);
    check_hlds__simplify__simplify_info__simplify_info_get_rtti_varmaps_2_p_0(STATE_VARIABLE_Info_0_18, &RttiVarMaps0_33);
    {
      ...
      MR_hl_field(MR_mktag(0), Var_36, 0) = ((MR_Box) (Index_17));
    }
    check_hlds__polymorphism_type_info__gen_extract_type_info_vt_12_p_0(ModuleInfo_31, TypeVar_8, Kind_9, TypeClassInfoVar_16, Var_36, Context_10, Goals_12, TypeInfoVar_11, VarTable0_32, &VarTable_34, RttiVarMaps0_33, &RttiVarMaps_35);
    check_hlds__simplify__simplify_info__simplify_info_set_var_table_3_p_0(VarTable_34, STATE_VARIABLE_Info_0_18, &STATE_VARIABLE_Info_26_37);
    check_hlds__simplify__simplify_info__simplify_info_set_rtti_varmaps_3_p_0(RttiVarMaps_35, STATE_VARIABLE_Info_26_37, STATE_VARIABLE_Info_19);
  }
}
