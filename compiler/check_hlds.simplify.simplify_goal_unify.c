  ...
  MR_Word * STATE_VARIABLE_Info_52)
{
  ...
  if (succeeded)
  {
    ...
    Kind_31 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Type_29, (MR_Integer) 1))));
    {
      ...
      {
        TypeInfoVar_33 = ((MR_Word) ((MR_hl_field(MR_mktag(0), TypeInfoLocn_106, (MR_Integer) 0))));
        ExtraGoals_34 = (MR_Word) ((MR_Unsigned) 0U);
        *STATE_VARIABLE_Info_52 = STATE_VARIABLE_Info_0_51;
      }
      else
      {
        MR_Word TypeClassInfoVar_107 = ((MR_Word) ((MR_hl_field(MR_mktag(1), TypeInfoLocn_106, (MR_Integer) 0))));
        MR_Integer Index_108 = ((MR_Integer) ((MR_hl_field(MR_mktag(1), TypeInfoLocn_106, (MR_Integer) 1))));
        ...
        check_hlds__simplify__simplify_info__simplify_info_get_rtti_varmaps_2_p_0(STATE_VARIABLE_Info_0_51, &RttiVarMaps0_111);
        {
          ...
          MR_hl_field(MR_mktag(0), Var_114, 0) = ((MR_Box) (Index_108));
        }
        check_hlds__polymorphism_type_info__gen_extract_type_info_vt_12_p_0(ModuleInfo_109, TypeVar_30, Kind_31, TypeClassInfoVar_107, Var_114, Context_32, &ExtraGoals_34, &TypeInfoVar_33, VarTable0_110, &VarTable_112, RttiVarMaps0_111, &RttiVarMaps_113);
