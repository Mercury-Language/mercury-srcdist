      ...
      case (MR_Integer) 1:
        {
          ...
          else
          {
            ...
            if (succeeded)
            {
              ...
              packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Unification0_22, (MR_Integer) 2)));
      ...
      case (MR_Integer) 2:
        {
          ...
          MR_Unsigned packed_word_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), RHS0_20, (MR_Integer) 5)));
            ...
            case (MR_Integer) 2:
              {
                ...
                {
                  ProcIsModelNon_34 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                  MR_hl_field(MR_mktag(1), ProcIsModelNon_34, 0) = ((MR_Box) (Var_73));
                }
              }
              break;
          }
          packed_word_3 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), NestedContext0_15, (MR_Integer) 0)));
          ...
          Var_74 = (MR_Integer) ((MR_Unsigned) NumEnclosingLambdas0_37 + (MR_Unsigned) (MR_Integer) 1);
          {
            ...
            MR_hl_field(MR_mktag(0), LambdaNestedContext_39, 0) = (MR_Box) ((MR_Unsigned) (InsideDuplForSwitch_36));
          ...
          {
            RHS_45 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, (7 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(2), RHS_45, 0) = (MR_Box) (packed_word_1);
            ...
            MR_hl_field(MR_mktag(2), RHS_45, 5) = (MR_Box) ((MR_Unsigned) (LambdaDeclaredDetism_31));
