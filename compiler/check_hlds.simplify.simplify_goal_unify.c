    ...
    case (MR_Integer) 1:
      {
        ...
        if (succeeded)
        {
          Var_75 = ((MR_Word) ((MR_hl_field(0, RHS0_20, (MR_Integer) 0))));
        ...
        if (succeeded)
        {
          ...
          *GoalExpr_12 = ((MR_Word) ((MR_hl_field(0, Var_67, (MR_Integer) 0))));
          *GoalInfo_14 = ((MR_Word) ((MR_hl_field(0, Var_67, (MR_Integer) 1))));
        ...
        else
        {
          ...
          if (succeeded)
          {
            ComplMode_51 = ((MR_Word) ((MR_hl_field(3, Unification0_22, (MR_Integer) 1))));
            CanFail_52 = ((MR_Unsigned) ((MR_hl_field(3, Unification0_22, (MR_Integer) 2))) & (MR_Integer) 1);
            ...
            {
              MR_Word V_54 = ((MR_Word) ((MR_hl_field(0, RHS0_20, (MR_Integer) 0))));
              ...
              *GoalExpr_12 = ((MR_Word) ((MR_hl_field(0, GoalExpr1_55, (MR_Integer) 0))));
              *GoalInfo_14 = ((MR_Word) ((MR_hl_field(0, GoalExpr1_55, (MR_Integer) 1))));
            }
          }
          else
    ...
    case (MR_Integer) 2:
      {
        ...
        MR_Word RHS_46;
        MR_Unsigned packed_word_1 = (MR_Unsigned) ((MR_hl_field(2, RHS0_20, (MR_Integer) 0)));
        MR_Word Var_45;
          ...
          case (MR_Integer) 2:
            {
              ...
              Context_34 = hlds__hlds_goal__goal_info_get_context_1_f_0(GoalInfo0_13);
              {
                ...
                MR_hl_field(1, Var_63, 0) = ((MR_Box) (Context_34));
              }
              {
                LambdaProcIsModelNon_33 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(1, LambdaProcIsModelNon_33, 0) = ((MR_Box) (Var_63));
              }
            }
            break;
        }
          ...
          LambdaNumEnclosingBarriers_38 = (NumEnclosingBarriers_37 + (MR_Unsigned) 1U);
        {
          ...
          MR_hl_field(0, LambdaNestedContext_39, 0) = (MR_Box) ((MR_Unsigned) (InsideDuplForSwitch_35));
          MR_hl_field(0, LambdaNestedContext_39, 1) = ((MR_Box) (LambdaProcIsModelNon_33));
        ...
        {
          RHS_46 = (MR_Word) MR_mkword(2, MR_new_object(MR_Word, (6 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(2, RHS_46, 0) = (MR_Box) (packed_word_1);
          MR_hl_field(2, RHS_46, 1) = NULL;
          MR_hl_field(2, RHS_46, 2) = ((MR_Box) (NonLocals_28));
          MR_hl_field(2, RHS_46, 3) = ((MR_Box) (VarsModes_29));
          MR_hl_field(2, RHS_46, 4) = (MR_Box) ((MR_Unsigned) (LambdaDeclaredDetism_30));
          MR_hl_field(2, RHS_46, 5) = ((MR_Box) (LambdaGoal_44));
        }
        {
          MR_Word base;
