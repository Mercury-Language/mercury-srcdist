  ...
  MR_Word * STATE_VARIABLE_Info_52)
{
  ...
  parse_tree__vartypes__lookup_var_type_3_p_0(VarTypes_28, XVar_15, &Type_29);
  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(1), Var_58, 0) = ((MR_Box) (XVar_15));
        MR_hl_field(MR_mktag(1), Var_58, 1) = ((MR_Box) (Var_65));
      }
      Var_59 = hlds__instmap__instmap_delta_bind_no_var_0_f_0();
      hlds__goal_util__generate_plain_call_13_p_0(ModuleInfo_27, (MR_Integer) 0, Var_55, (MR_String) "builtin_unify_pred", (MR_Word) ((MR_Unsigned) 0U), Var_58, Var_59, (MR_Word) (MR_mkword(MR_mktag(1), &check_hlds__simplify__simplify_goal_unify_scalar_common_2[0])), (MR_Integer) 1, (MR_Integer) 0, (MR_Word) ((MR_Unsigned) 0U), Context_94, &Var_64);
      Call0_36 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_64, (MR_Integer) 0))));
    ...
    else
    {
      ...
      if (succeeded)
      {
        hlds__hlds_pred__in_in_unification_proc_id_1_p_0(&Var_114);
        succeeded = (ProcId_43 == Var_114);
        if (succeeded)
      ...
      if (succeeded)
      {
        ...
        Var_72 = mdbcomp__builtin_modules__mercury_private_builtin_module_0_f_0();
        {
          ...
          MR_hl_field(MR_mktag(1), Var_81, 0) = ((MR_Box) (YVar_16));
          MR_hl_field(MR_mktag(1), Var_81, 1) = ((MR_Box) ((MR_Unsigned) 0U));
        }
        {
          Var_75 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), Var_75, 0) = ((MR_Box) (XVar_15));
          MR_hl_field(MR_mktag(1), Var_75, 1) = ((MR_Box) (Var_81));
        }
      ...
      else
      {
        ...
        hlds__hlds_pred__in_in_unification_proc_id_1_p_0(&Var_115);
        succeeded = (ProcId_43 == Var_115);
        if (succeeded)
        ...
        if (succeeded)
        {
...

          {
            ...
            MR_hl_field(MR_mktag(1), Var_83, 0) = ((MR_Box) (Type_29));
          ...
          if (succeeded)
          {
            ...
            Var_86 = ((MR_Word) ((MR_hl_field(MR_mktag(1), TypeInfoVars_44, (MR_Integer) 1))));
        ...
        else
        {
          ...
          {
            Call_35 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
            MR_hl_field(MR_mktag(0), Call_35, 0) = ((MR_Box) (Call1_98));
  ...
  }
  {
    ...
    MR_hl_field(MR_mktag(1), Var_92, 0) = ((MR_Box) (Call_35));
  ...
  MR_Word * Call_16)
{
  ...
  Var_19 = mdbcomp__builtin_modules__mercury_public_builtin_module_0_f_0();
  {
    ...
    MR_hl_field(MR_mktag(1), Var_21, 0) = ((MR_Box) (TypeInfoVar_9));
    MR_hl_field(MR_mktag(1), Var_21, 1) = ((MR_Box) ((MR_Unsigned) 0U));
  }
  {
    Var_29 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(MR_mktag(1), Var_29, 0) = ((MR_Box) (YVar_11));
    MR_hl_field(MR_mktag(1), Var_29, 1) = ((MR_Box) ((MR_Unsigned) 0U));
  }
  {
    Var_22 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(MR_mktag(1), Var_22, 0) = ((MR_Box) (XVar_10));
    MR_hl_field(MR_mktag(1), Var_22, 1) = ((MR_Box) (Var_29));
  }
  Var_23 = hlds__instmap__instmap_delta_bind_no_var_0_f_0();
  hlds__goal_util__generate_plain_call_13_p_0(ModuleInfo_12, (MR_Integer) 0, Var_19, (MR_String) "unify", Var_21, Var_22, Var_23, (MR_Word) (MR_mkword(MR_mktag(1), &check_hlds__simplify__simplify_goal_unify_scalar_common_2[0])), (MR_Integer) 1, (MR_Integer) 0, (MR_Word) ((MR_Unsigned) 0U), Context_17, Call_16);
}
  ...
  MR_Word * STATE_VARIABLE_Info_19)
{
  ...
  else
  {
    ...
    MR_Word Var_37;
    MR_Word STATE_VARIABLE_Info_28_38;
    MR_Word STATE_VARIABLE_Info_29_39;

    check_hlds__simplify__simplify_info__simplify_info_get_module_info_2_p_0(STATE_VARIABLE_Info_0_18, &ModuleInfo_30);
    check_hlds__simplify__simplify_info__simplify_info_get_varset_2_p_0(STATE_VARIABLE_Info_0_18, &VarSet0_31);
    check_hlds__simplify__simplify_info__simplify_info_get_var_types_2_p_0(STATE_VARIABLE_Info_0_18, &VarTypes0_32);
    check_hlds__simplify__simplify_info__simplify_info_get_rtti_varmaps_2_p_0(STATE_VARIABLE_Info_0_18, &RttiVarMaps0_33);
    {
      Var_37 = (MR_Word) MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), Var_37, 0) = ((MR_Box) (Index_17));
    }
    check_hlds__polymorphism_type_info__gen_extract_type_info_14_p_0(ModuleInfo_30, TypeVar_8, Kind_9, TypeClassInfoVar_16, Var_37, Context_10, Goals_12, TypeInfoVar_11, VarSet0_31, &VarSet_34, VarTypes0_32, &VarTypes_35, RttiVarMaps0_33, &RttiVarMaps_36);
    check_hlds__simplify__simplify_info__simplify_info_set_var_types_3_p_0(VarTypes_35, STATE_VARIABLE_Info_0_18, &STATE_VARIABLE_Info_28_38);
    check_hlds__simplify__simplify_info__simplify_info_set_varset_3_p_0(VarSet_34, STATE_VARIABLE_Info_28_38, &STATE_VARIABLE_Info_29_39);
    check_hlds__simplify__simplify_info__simplify_info_set_rtti_varmaps_3_p_0(RttiVarMaps_36, STATE_VARIABLE_Info_29_39, STATE_VARIABLE_Info_19);
  }
}
  ...
  MR_Word * STATE_VARIABLE_Info_24)
{
  ...
  hlds__hlds_pred__proc_info_set_varset_vartypes_4_p_0(VarSet0_10, VarTypes0_11, STATE_VARIABLE_ProcInfo_26_26, &STATE_VARIABLE_ProcInfo_27_27);
  hlds__hlds_pred__proc_info_set_rtti_varmaps_3_p_0(RttiVarMaps0_12, STATE_VARIABLE_ProcInfo_27_27, &STATE_VARIABLE_ProcInfo_28_28);
  mercury__term__context_init_1_p_0(&Context_17);
  check_hlds__polymorphism_type_info__polymorphism_make_type_info_vars_raw_10_p_0(Types_6, Context_17, TypeInfoVars_7, TypeInfoGoals_8, ModuleInfo0_13, &ModuleInfo1_18, STATE_VARIABLE_PredInfo_25_25, &STATE_VARIABLE_PredInfo_29_29, STATE_VARIABLE_ProcInfo_28_28, &STATE_VARIABLE_ProcInfo_30_30);
  hlds__hlds_pred__proc_info_get_varset_vartypes_3_p_0(STATE_VARIABLE_ProcInfo_30_30, &VarSet_19, &VarTypes_20);
  hlds__hlds_pred__proc_info_get_rtti_varmaps_2_p_0(STATE_VARIABLE_ProcInfo_30_30, &RttiVarMaps_21);
  check_hlds__simplify__simplify_info__simplify_info_set_var_types_3_p_0(VarTypes_20, STATE_VARIABLE_Info_0_23, &STATE_VARIABLE_Info_31_31);
  check_hlds__simplify__simplify_info__simplify_info_set_varset_3_p_0(VarSet_19, STATE_VARIABLE_Info_31_31, &STATE_VARIABLE_Info_32_32);
  check_hlds__simplify__simplify_info__simplify_info_set_rtti_varmaps_3_p_0(RttiVarMaps_21, STATE_VARIABLE_Info_32_32, &STATE_VARIABLE_Info_33_33);
  hlds__hlds_module__module_info_set_pred_proc_info_5_p_0(PredProcId_14, STATE_VARIABLE_PredInfo_29_29, STATE_VARIABLE_ProcInfo_30_30, ModuleInfo1_18, &ModuleInfo_22);
  check_hlds__simplify__simplify_info__simplify_info_set_module_info_3_p_0(ModuleInfo_22, STATE_VARIABLE_Info_33_33, STATE_VARIABLE_Info_24);
}
