...
{
  {
    ...
    else
    {
      ...
      else
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_44, (MR_Integer) 285, &SpecialPreds_45);
        libs__globals__lookup_bool_option_3_p_0(Globals_44, (MR_Integer) 281, &CanCompareCompoundValues_46);
