  ...
  MR_Word * STATE_VARIABLE_Info_52)
{
  ...
  if (succeeded)
  {
    ...
    Kind_31 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Type_29, (MR_Integer) 1))));
    {
      ...
      MR_Word RttiVarMaps_118;
      MR_Word TypeInfoLocn_119;

      Context_32 = hlds__hlds_goal__goal_info_get_context_1_f_0(GoalInfo0_21);
      check_hlds__simplify__simplify_info__simplify_info_get_rtti_varmaps_2_p_0(STATE_VARIABLE_Info_0_51, &RttiVarMaps_118);
      hlds__hlds_rtti__rtti_lookup_type_info_locn_3_p_0(RttiVarMaps_118, TypeVar_30, &TypeInfoLocn_119);
      if (((MR_tag((MR_Word) TypeInfoLocn_119)) == (MR_Integer) 0))
      {
        TypeInfoVar_33 = ((MR_Word) ((MR_hl_field(MR_mktag(0), TypeInfoLocn_119, (MR_Integer) 0))));
        ExtraGoals_34 = (MR_Word) ((MR_Unsigned) 0U);
        *STATE_VARIABLE_Info_52 = STATE_VARIABLE_Info_0_51;
      }
      else
      {
        MR_Word TypeClassInfoVar_120 = ((MR_Word) ((MR_hl_field(MR_mktag(1), TypeInfoLocn_119, (MR_Integer) 0))));
        MR_Integer Index_121 = ((MR_Integer) ((MR_hl_field(MR_mktag(1), TypeInfoLocn_119, (MR_Integer) 1))));
        MR_Word ModuleInfo_122;
        MR_Word VarTable0_123;
        MR_Word RttiVarMaps0_124;
        MR_Word VarTable_125;
        MR_Word RttiVarMaps_126;
        MR_Word Var_127;
        MR_Word STATE_VARIABLE_Info_26_128;

        check_hlds__simplify__simplify_info__simplify_info_get_module_info_2_p_0(STATE_VARIABLE_Info_0_51, &ModuleInfo_122);
        check_hlds__simplify__simplify_info__simplify_info_get_var_table_2_p_0(STATE_VARIABLE_Info_0_51, &VarTable0_123);
        check_hlds__simplify__simplify_info__simplify_info_get_rtti_varmaps_2_p_0(STATE_VARIABLE_Info_0_51, &RttiVarMaps0_124);
        {
          Var_127 = (MR_Word) MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), Var_127, 0) = ((MR_Box) (Index_121));
        }
        check_hlds__polymorphism_type_info__gen_extract_type_info_vt_12_p_0(ModuleInfo_122, TypeVar_30, Kind_31, TypeClassInfoVar_120, Var_127, Context_32, &ExtraGoals_34, &TypeInfoVar_33, VarTable0_123, &VarTable_125, RttiVarMaps0_124, &RttiVarMaps_126);
        check_hlds__simplify__simplify_info__simplify_info_set_var_table_3_p_0(VarTable_125, STATE_VARIABLE_Info_0_51, &STATE_VARIABLE_Info_26_128);
        check_hlds__simplify__simplify_info__simplify_info_set_rtti_varmaps_3_p_0(RttiVarMaps_126, STATE_VARIABLE_Info_26_128, STATE_VARIABLE_Info_52);
      }
  ...
  MR_Word * STATE_VARIABLE_Info_22)
{
  ...
  check_hlds__simplify__simplify_info__simplify_info_get_var_table_2_p_0(STATE_VARIABLE_Info_0_21, &VarTable0_10);
  check_hlds__simplify__simplify_info__simplify_info_get_rtti_varmaps_2_p_0(STATE_VARIABLE_Info_0_21, &RttiVarMaps0_11);
  check_hlds__simplify__simplify_info__simplify_info_get_module_info_2_p_0(STATE_VARIABLE_Info_0_21, &ModuleInfo0_12);
  check_hlds__simplify__simplify_info__simplify_info_get_pred_proc_id_2_p_0(STATE_VARIABLE_Info_0_21, &PredProcId_13);
  hlds__hlds_module__module_info_pred_proc_info_4_p_0(ModuleInfo0_12, PredProcId_13, &STATE_VARIABLE_PredInfo_23_23, &STATE_VARIABLE_ProcInfo_24_24);
  hlds__hlds_pred__proc_info_set_var_table_3_p_0(VarTable0_10, STATE_VARIABLE_ProcInfo_24_24, &STATE_VARIABLE_ProcInfo_25_25);
  hlds__hlds_pred__proc_info_set_rtti_varmaps_3_p_0(RttiVarMaps0_11, STATE_VARIABLE_ProcInfo_25_25, &STATE_VARIABLE_ProcInfo_26_26);
  mercury__term__context_init_1_p_0(&Context_16);
  check_hlds__polymorphism_type_info__polymorphism_make_type_info_vars_mi_10_p_0(Types_6, Context_16, TypeInfoVars_7, TypeInfoGoals_8, ModuleInfo0_12, &ModuleInfo1_17, STATE_VARIABLE_PredInfo_23_23, &STATE_VARIABLE_PredInfo_27_27, STATE_VARIABLE_ProcInfo_26_26, &STATE_VARIABLE_ProcInfo_28_28);
  hlds__hlds_pred__proc_info_get_var_table_3_p_0(ModuleInfo1_17, STATE_VARIABLE_ProcInfo_28_28, &VarTable_18);
  hlds__hlds_pred__proc_info_get_rtti_varmaps_2_p_0(STATE_VARIABLE_ProcInfo_28_28, &RttiVarMaps_19);
  check_hlds__simplify__simplify_info__simplify_info_set_var_table_3_p_0(VarTable_18, STATE_VARIABLE_Info_0_21, &STATE_VARIABLE_Info_29_29);
  check_hlds__simplify__simplify_info__simplify_info_set_rtti_varmaps_3_p_0(RttiVarMaps_19, STATE_VARIABLE_Info_29_29, &STATE_VARIABLE_Info_30_30);
  hlds__hlds_module__module_info_set_pred_proc_info_5_p_0(PredProcId_13, STATE_VARIABLE_PredInfo_27_27, STATE_VARIABLE_ProcInfo_28_28, ModuleInfo1_17, &ModuleInfo_20);
  check_hlds__simplify__simplify_info__simplify_info_set_module_info_3_p_0(ModuleInfo_20, STATE_VARIABLE_Info_30_30, STATE_VARIABLE_Info_22);
}
