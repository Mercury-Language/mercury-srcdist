  ...
  MR_Word * STATE_VARIABLE_Info_52)
{
  ...
  else
  {
    ...
    else
    {
      ...
      hlds__pred_proc_id__in_in_unification_proc_id_1_p_0(&Var_88);
      ...
      if (succeeded)
      {
        ...
        hlds__hlds_proc__proc_info_set_var_table_3_p_0(VarTable0_101, STATE_VARIABLE_ProcInfo_1_110, &STATE_VARIABLE_ProcInfo_2_111);
        hlds__hlds_proc__proc_info_set_rtti_varmaps_3_p_0(RttiVarMaps0_102, STATE_VARIABLE_ProcInfo_2_111, &STATE_VARIABLE_ProcInfo_3_112);
        ...
        hlds__hlds_proc__proc_info_get_var_table_2_p_0(STATE_VARIABLE_ProcInfo_4_115, &VarTable_106);
        hlds__hlds_proc__proc_info_get_rtti_varmaps_2_p_0(STATE_VARIABLE_ProcInfo_4_115, &RttiVarMaps_107);
  ...
  hlds__goal_list_util__conj_list_to_goal_3_p_0(Conjuncts_48, GoalInfo0_21, Goal_22);
}
  ...
  MR_Word * STATE_VARIABLE_Info_21)
{
  ...
  hlds__hlds_proc__proc_info_set_var_table_3_p_0(VarTable0_10, STATE_VARIABLE_ProcInfo_1_23, &STATE_VARIABLE_ProcInfo_2_24);
  hlds__hlds_proc__proc_info_set_rtti_varmaps_3_p_0(RttiVarMaps0_11, STATE_VARIABLE_ProcInfo_2_24, &STATE_VARIABLE_ProcInfo_3_25);
  ...
  hlds__hlds_proc__proc_info_get_var_table_2_p_0(STATE_VARIABLE_ProcInfo_4_28, &VarTable_17);
  hlds__hlds_proc__proc_info_get_rtti_varmaps_2_p_0(STATE_VARIABLE_ProcInfo_4_28, &RttiVarMaps_18);
  ...
  MR_Word * CallGoalInfo_20)
{
  ...
  mercury__map__lookup_3_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_type_ctor_0), (MR_Word) (&hlds__pred_proc_id__hlds__pred_proc_id__type_ctor_info_pred_id_0), UnifyMap_23, ((MR_Box) (TypeCtor_11)), &conv0_PredId_24);
