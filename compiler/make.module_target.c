        ...
        case (MR_Integer) 0:
          {
            ...
            else
            {
              ...
              else
              {
                ...
                libs__globals__lookup_bool_option_3_p_0(Globals_10, (MR_Integer) 647, &KeepGoing_42);
...
{
  {
    ...
    if ((ArgFileNameSuccess_32 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals_13, (MR_Integer) 675, &ShowMakeTimes_41);
