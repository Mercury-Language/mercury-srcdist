...
static void MR_CALL 
make__module_target__IntroducedFrom__pred__record_made_target_given_make_lhs_files__777__1_3_p_0(
  ...
  MR_Word * Succeeded_12)
{
  ...
  switch (Var_32) {
    ...
    case (MR_Integer) 0:
      backend_libs__compile_target_code__do_compile_c_file_8_p_0(ProgressStream_9, Globals_8, PIC_10, Var_31, Var_30, Succeeded_12);
      break;
    case (MR_Integer) 1:
      {
  ...
  MR_Word * Succeeded_18)
{
  switch (Target_14) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 0:
      backend_libs__compile_target_code__compile_c_file_7_p_0(ProgressStream_11, Globals_13, PIC_15, ModuleName_16, Succeeded_18);
      break;
    case (MR_Integer) 1:
      {
        ...
        parse_tree__write_error_spec__write_diag_specs_5_p_0(ErrorStream_12, Globals_13, Specs_24);
      }
      break;
    case (MR_Integer) 2:
      {
        ...
        backend_libs__compile_target_code__compile_java_files_7_p_0(ProgressStream_11, Globals_13, JavaFile_20, (MR_Word) ((MR_Unsigned) 0U), Succeeded_18);
      }
      break;
  }
}
  ...
  MR_Box * wrapper_arg_3)
{
  ...
  make__module_target__IntroducedFrom__pred__record_made_target_given_make_lhs_files__777__1_3_p_0(((MR_Word) (wrapper_arg_1)), ((MR_Word) (wrapper_arg_2)), &conv19_HeadVar__3_117);
  ...
  MR_Box * wrapper_arg_3)
{
  ...
  make__module_target__IntroducedFrom__pred__record_made_target_given_make_lhs_files__775__1_3_p_0(((MR_Word) (wrapper_arg_1)), ((MR_Word) (wrapper_arg_2)), &conv17_HeadVar__3_111);
  ...
  MR_Word * STATE_VARIABLE_Info_57)
{
  ...
  if ((ArgFileNameRes_35 == (MR_Word) ((MR_Unsigned) 0U)))
  {
    ...
    else
    {
      ...
      parse_tree__write_error_spec__write_oom_diag_specs_5_p_0(ProgressStream_14, Globals_15, Specs_51);
      Succeeded0_48 = (MR_Integer) 0;
    }
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_15, (MR_Integer) 468, &ShowMakeTimes_53);
    ...
    case (MR_Integer) 0:
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_14, (MR_Integer) 139, &Verbose_24);
        switch (Verbose_24) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 0:
            {
        ...
        if (succeeded)
        {
          ...
          parse_tree__module_cmds__touch_module_ext_datestamp_7_p_0(ProgressStream_12, Globals_14, ModuleName_16, (MR_Word) (MR_mkword(3, &make__module_target_scalar_common_1[2])), &TouchSucceeded_30);
