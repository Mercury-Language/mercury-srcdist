        ...
        case (MR_Integer) 0:
          {
            ...
            else
            {
              ...
              else
              {
                ...
                libs__globals__lookup_bool_option_3_p_0(Globals_10, (MR_Integer) 641, &KeepGoing_41);
            ...
            case (MR_Integer) 0:
              {
                ...
                libs__globals__lookup_bool_option_3_p_0(Globals_10, (MR_Integer) 276, &HighLevelCode_33);
...
{
  {
    ...
    if ((ArgFileNameSuccess_32 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals_13, (MR_Integer) 669, &ShowMakeTimes_41);
