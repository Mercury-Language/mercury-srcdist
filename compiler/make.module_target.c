...
{
  {
...

    {
      ...
      MR_hl_field(MR_mktag(0), make__module_target__V_67_67, 4) = ((MR_Box) ((MR_Integer) 55));
    }
    ...
    make__module_target__STATE_VARIABLE_MakeInfo_68_68 = ((MR_Word) make__module_target__conv2_STATE_VARIABLE_MakeInfo_68_68);
    {
      ...
      MR_hl_field(MR_mktag(0), make__module_target__V_71_71, 4) = ((MR_Box) ((MR_Integer) 55));
    }
    {
            ...
            case (MR_Integer) 0:
              {
                ...
                {
                  libs__globals__lookup_bool_option_3_p_0(make__module_target__Globals_10, (MR_Integer) 260, &make__module_target__HighLevelCode_33);
                }
      ...
      case (MR_Integer) 0:
        {
          ...
          {
            libs__globals__lookup_bool_option_3_p_0(make__module_target__Globals_17, (MR_Integer) 60, &make__module_target__Verbose_25);
          }
    ...
    if ((make__module_target__ArgFileNameSuccess_32 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
      {
        ...
        {
          libs__globals__lookup_bool_option_3_p_0(make__module_target__Globals_13, (MR_Integer) 55, &make__module_target__VeryVerbose_39);
        }
        {
        ...
        {
          libs__globals__lookup_bool_option_3_p_0(make__module_target__Globals_13, (MR_Integer) 649, &make__module_target__ShowMakeTimes_41);
        }
