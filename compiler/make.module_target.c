  ...
  top_of_proc_2:;
    {
      ...
      else
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 654, &KeepGoing_37);
...
{
  {
    ...
    if ((ArgFileNameSuccess_31 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals_13, (MR_Integer) 682, &ShowMakeTimes_37);
