...
{
  {
    MR_bool succeeded = (LambdaHeadVar__1_54 != (MR_Word) ((MR_Unsigned) 0U));
            ...
            case (MR_Integer) 0:
              {
                ...
                switch (HighLevelCode_33) {
                  ...
                  case (MR_Integer) 1:
                    {
                      HeaderTargets0_35 = make__util__make_target_file_list_2_f_0(TargetModuleNames_29, (MR_Word) (MR_mkword(MR_mktag(1), &make__module_target_scalar_common_3[6])));
                    }
                    break;
                }
              }
            ...
            case (MR_Integer) 0:
              {
                ...
                Var_74 = make__util__make_target_file_list_2_f_0(TargetModuleNames_29, (MR_Word) (MR_mkword(MR_mktag(1), &make__module_target_scalar_common_3[2])));
