        ...
        case (MR_Integer) 0:
          {
            ...
            else
            {
              ...
              else
              {
                ...
                libs__globals__lookup_bool_option_3_p_0(Globals_10, (MR_Integer) 629, &KeepGoing_41);
...
{
  {
    ...
    if ((ArgFileNameSuccess_32 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
    {
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals_13, (MR_Integer) 657, &ShowMakeTimes_41);
