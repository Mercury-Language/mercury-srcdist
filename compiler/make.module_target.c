    ...
    case (MR_Integer) 1:
      {
        ...
        parse_tree__file_names__module_name_to_file_name_7_p_0(Globals_10, (MR_Integer) 0, (MR_Word) (((MR_Box) ((MR_String) ".cs"))), ModuleName_11, &CsharpFile_19);
        {
          Var_33 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), Var_33, 0) = ((MR_Box) (CsharpFile_19));
          MR_hl_field(MR_mktag(1), Var_33, 1) = ((MR_Box) ((MR_Unsigned) 0U));
        }
        backend_libs__compile_target_code__link_8_p_0(Globals_10, ErrorStream_14, (MR_Integer) 4, ModuleName_11, Var_33, Succeeded_16);
      }
      break;
    case (MR_Integer) 3:
      {
        ...
        parse_tree__file_names__module_name_to_file_name_7_p_0(Globals_10, (MR_Integer) 0, (MR_Word) (((MR_Box) ((MR_String) ".erl"))), ModuleName_11, &ErlangFile_20);
    ...
    case (MR_Integer) 2:
      {
        ...
        parse_tree__file_names__module_name_to_file_name_7_p_0(Globals_10, (MR_Integer) 0, (MR_Word) (((MR_Box) ((MR_String) ".java"))), ModuleName_11, &JavaFile_18);
        {
          Var_40 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), Var_40, 0) = ((MR_Box) (JavaFile_18));
          MR_hl_field(MR_mktag(1), Var_40, 1) = ((MR_Box) ((MR_Unsigned) 0U));
        }
        backend_libs__compile_target_code__compile_java_files_6_p_0(Globals_10, ErrorStream_14, Var_40, Succeeded_16);
      }
      break;
  }
}
...
{
  {
    ...
    parse_tree__file_names__fact_table_file_name_7_p_0(Globals_8, Mkdir_9, (MR_Word) (((MR_Box) ((MR_String) ".c"))), FactTableFileName_11, &FactTableCFileName_14);
    parse_tree__file_names__fact_table_file_name_7_p_0(Globals_8, Mkdir_9, ObjExt_10, FactTableFileName_11, &FactTableObjFileName_15);
    {
      MR_Word base;
...
{
  {
    ...
    switch (CompilationTarget_7) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        backend_libs__compile_target_code__maybe_pic_object_file_extension_3_p_0(Globals_4, PIC_5, &Ext_6);
        break;
      case (MR_Integer) 1:
      ...
      case (MR_Integer) 2:
        {
          ...
          MR_Word ForeignModName_65;
          MR_Word SrcExt_66;
          MR_Word ObjExt_67;
          MR_Word CompilationTarget_79;
          MR_Word ForeignModName0_63;
          MR_Word SrcExt0_64;
          MR_String SrcFileName_68;
          ...
          succeeded = parse_tree__prog_foreign__foreign_language_module_name_2_f_1(ModuleName_21, Lang_20, &ForeignModName0_63);
          if (succeeded)
            succeeded = parse_tree__prog_foreign__foreign_language_file_extension_1_f_0(Lang_20, &SrcExt0_64);
          if (succeeded)
          {
            ForeignModName_65 = ForeignModName0_63;
            SrcExt_66 = SrcExt0_64;
          }
          else
            {
              mercury__require__unexpected_2_p_0((MR_String) "predicate \140make.module_target.get_foreign_code_file\'/7", (MR_String) "unsupported foreign language");
          ...
          libs__globals__get_target_2_p_0(Globals_10, &CompilationTarget_79);
          switch (CompilationTarget_79) {
            default: /*NOTREACHED*/ MR_assert(0);
            case (MR_Integer) 0:
              backend_libs__compile_target_code__maybe_pic_object_file_extension_3_p_0(Globals_10, PIC_19, &ObjExt_67);
              break;
            case (MR_Integer) 1:
              {
                mercury__require__sorry_2_p_0((MR_String) "function \140make.module_target.get_object_extension\'/2", (MR_String) "object extension for csharp");
          ...
          parse_tree__file_names__module_name_to_file_name_7_p_0(Globals_10, (MR_Integer) 0, SrcExt_66, ForeignModName_65, &SrcFileName_68);
          parse_tree__file_names__module_name_to_file_name_7_p_0(Globals_10, (MR_Integer) 0, ObjExt_67, ForeignModName_65, &ForeignObjectFile_24);
          {
            MR_Word base;
            base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      ...
      case (MR_Integer) 3:
        {
          ...
          MR_Word PIC_42 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(3), Task_12, (MR_Integer) 0))) & (MR_Integer) 1);
          ...
          switch (CompilationTarget_48) {
            default: /*NOTREACHED*/ MR_assert(0);
            case (MR_Integer) 0:
              backend_libs__compile_target_code__maybe_pic_object_file_extension_3_p_0(Globals_10, PIC_42, &ObjExt_26);
              break;
            case (MR_Integer) 1:
              {
                mercury__require__sorry_2_p_0((MR_String) "function \140make.module_target.get_object_extension\'/2", (MR_String) "object extension for csharp");
          ...
          parse_tree__file_names__fact_table_file_name_7_p_0(Globals_10, (MR_Integer) 0, ObjExt_26, FactTableName_25, &FactTableObjectFile_27);
          {
            MR_Word base;
            base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            *TouchedFileNames_14 = base;
