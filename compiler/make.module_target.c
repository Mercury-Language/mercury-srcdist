    ...
    case (MR_Integer) 6:
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 342, &HighLevelCode_34);
  ...
  MR_Word * STATE_VARIABLE_Info_59)
{
  ...
  if ((ArgFileNameRes_35 == (MR_Word) ((MR_Unsigned) 0U)))
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_15, (MR_Integer) 742, &ShowMakeTimes_55);
