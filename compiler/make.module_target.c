      ...
      case (MR_Integer) 0:
        {
          ...
          else
          {
            ...
            if (succeeded)
            {
              ...
              make__module_target__make_module_target_extra_options_8_p_0(ExtraOptions_9, Globals_10, Var_57, Succeeded_12, STATE_VARIABLE_Info_53_53, STATE_VARIABLE_Info_45);
            }
            else
            {
