      ...
      case (MR_Integer) 0:
        {
          ...
          else
          {
            ...
            else
            {
              ...
              libs__globals__lookup_bool_option_3_p_0(make__module_target__Globals_10, (MR_Integer) 628, &make__module_target__KeepGoing_41);
            ...
            case (MR_Integer) 0:
              {
                ...
                libs__globals__lookup_bool_option_3_p_0(make__module_target__Globals_10, (MR_Integer) 264, &make__module_target__HighLevelCode_33);
...
{
  {
    ...
    if ((make__module_target__ArgFileNameSuccess_32 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
    {
      ...
      libs__globals__lookup_bool_option_3_p_0(make__module_target__Globals_13, (MR_Integer) 656, &make__module_target__ShowMakeTimes_41);
...
{
  {
...

    {
      ...
      libs__globals__lookup_bool_option_3_p_0(make__module_target__Globals_11, (MR_Integer) 628, &make__module_target__KeepGoing_19);
