          ...
          case (MR_Integer) 0:
            {
              ...
              libs__globals__lookup_bool_option_3_p_0(Globals_12, (MR_Integer) 311, &HighLevelCode_36);
  ...
  MR_Word * STATE_VARIABLE_Info_59)
{
  ...
  if ((ArgFileNameRes_36 == (MR_Word) ((MR_Unsigned) 0U)))
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_15, (MR_Integer) 693, &ShowMakeTimes_55);
