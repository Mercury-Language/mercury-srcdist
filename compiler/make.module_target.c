    ...
    case (MR_Integer) 1:
      {
        ...
        backend_libs__compile_target_code__link_files_into_executable_or_library_9_p_0(ProgressStream_11, Globals_13, (MR_Integer) 4, ModuleName_16, Var_39, &Specs_24, Succeeded_18);
