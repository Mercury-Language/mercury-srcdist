...
{
  {
...

    {
      ...
      MR_hl_field(MR_mktag(0), Var_67, 4) = ((MR_Box) ((MR_Integer) 63));
    }
    ...
    STATE_VARIABLE_MakeInfo_68_68 = ((MR_Word) (conv2_STATE_VARIABLE_MakeInfo_68_68));
    {
      ...
      MR_hl_field(MR_mktag(0), Var_71, 4) = ((MR_Box) ((MR_Integer) 63));
    }
      ...
      case (MR_Integer) 0:
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_17, (MR_Integer) 68, &Verbose_25);
          switch (Verbose_25) {
            default: /*NOTREACHED*/ MR_assert(0);
            case (MR_Integer) 0:
              {
        ...
        case (MR_Integer) 0:
          {
            ...
            else
            {
              ...
              else
              {
                ...
                libs__globals__lookup_bool_option_3_p_0(Globals_10, (MR_Integer) 649, &KeepGoing_42);
            ...
            case (MR_Integer) 0:
              {
                ...
                libs__globals__lookup_bool_option_3_p_0(Globals_10, (MR_Integer) 283, &HighLevelCode_34);
...
{
  {
    ...
    if ((ArgFileNameSuccess_32 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals_13, (MR_Integer) 63, &VeryVerbose_39);
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals_13, (MR_Integer) 677, &ShowMakeTimes_41);
