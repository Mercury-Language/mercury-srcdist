          ...
          case (MR_Integer) 0:
            {
              ...
              libs__globals__lookup_bool_option_3_p_0(Globals_10, (MR_Integer) 306, &HighLevelCode_34);
  ...
  MR_Word * STATE_VARIABLE_Info_53)
{
  ...
  if ((ArgFileNameRes_32 == (MR_Word) ((MR_Unsigned) 0U)))
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_13, (MR_Integer) 689, &ShowMakeTimes_49);
