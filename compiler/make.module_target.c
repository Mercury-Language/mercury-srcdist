...
make__module_target__IntroducedFrom__func__touched_files_process_module__992__1_1_f_0(
  MR_Word LambdaHeadVar__1_64);

static MR_bool MR_CALL 
make__module_target__IntroducedFrom__pred__touched_files_process_module__970__1_2_p_0(
    ...
    case (MR_Integer) 1:
      {
        ...
        parse_tree__file_names__module_name_to_file_name_8_p_0(Globals_10, (MR_String) "predicate \140make.module_target.build_object_code\'/9", (MR_Integer) 0, (MR_Word) (MR_mkword(MR_mktag(1), &make__module_target_scalar_common_3[9])), ModuleName_11, &CsharpFile_19);
        {
          ...
          MR_hl_field(MR_mktag(1), Var_37, 0) = ((MR_Box) (CsharpFile_19));
          MR_hl_field(MR_mktag(1), Var_37, 1) = ((MR_Box) ((MR_Unsigned) 0U));
        }
        backend_libs__compile_target_code__link_8_p_0(Globals_10, ErrorStream_14, (MR_Integer) 4, ModuleName_11, Var_37, Succeeded_16);
      }
      break;
    case (MR_Integer) 3:
      {
        ...
        parse_tree__file_names__module_name_to_file_name_8_p_0(Globals_10, (MR_String) "predicate \140make.module_target.build_object_code\'/9", (MR_Integer) 0, (MR_Word) (MR_mkword(MR_mktag(1), &make__module_target_scalar_common_3[10])), ModuleName_11, &ErlangFile_20);
    ...
    case (MR_Integer) 2:
      {
        ...
        parse_tree__file_names__module_name_to_file_name_8_p_0(Globals_10, (MR_String) "predicate \140make.module_target.build_object_code\'/9", (MR_Integer) 0, (MR_Word) (MR_mkword(MR_mktag(1), &make__module_target_scalar_common_3[11])), ModuleName_11, &JavaFile_18);
        {
          Var_46 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), Var_46, 0) = ((MR_Box) (JavaFile_18));
          MR_hl_field(MR_mktag(1), Var_46, 1) = ((MR_Box) ((MR_Unsigned) 0U));
        }
        backend_libs__compile_target_code__compile_java_files_6_p_0(Globals_10, ErrorStream_14, Var_46, Succeeded_16);
      }
      break;
  }
}
  ...
  top_of_proc_2:;
    {
      ...
      else
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 655, &KeepGoing_37);
      ...
      case (MR_Integer) 2:
        {
          ...
          MR_Word ForeignModName_66;
          MR_Word SrcExt_67;
          MR_Word ObjOtherExt_68;
          MR_Word Var_75;
          MR_Word Var_79;
          MR_Word CompilationTarget_84;
          MR_Word ForeignModName0_64;
          MR_Word SrcExt0_65;
          MR_String SrcFileName_69;
          ...
          succeeded = parse_tree__prog_foreign__foreign_language_module_name_2_f_1(ModuleName_21, Lang_20, &ForeignModName0_64);
          if (succeeded)
            succeeded = parse_tree__prog_foreign__foreign_language_file_extension_1_f_0(Lang_20, &SrcExt0_65);
          if (succeeded)
          {
            ForeignModName_66 = ForeignModName0_64;
            SrcExt_67 = SrcExt0_65;
          }
          else
            {
              mercury__require__unexpected_2_p_0((MR_String) "predicate \140make.module_target.get_foreign_code_file\'/7", (MR_String) "unsupported foreign language");
          ...
          libs__globals__get_target_2_p_0(Globals_10, &CompilationTarget_84);
          switch (CompilationTarget_84) {
            default: /*NOTREACHED*/ MR_assert(0);
            case (MR_Integer) 0:
              backend_libs__compile_target_code__pic_object_file_extension_3_p_0(Globals_10, PIC_19, &ObjOtherExt_68);
              break;
            case (MR_Integer) 1:
              {
                mercury__require__sorry_2_p_0((MR_String) "function \140make.module_target.get_object_extension\'/2", (MR_String) "object extension for csharp");
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(1), Var_75, 0) = ((MR_Box) (SrcExt_67));
          }
          parse_tree__file_names__module_name_to_file_name_8_p_0(Globals_10, (MR_String) "predicate \140make.module_target.get_foreign_code_file\'/7", (MR_Integer) 0, Var_75, ForeignModName_66, &SrcFileName_69);
          {
            Var_79 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), Var_79, 0) = ((MR_Box) (ObjOtherExt_68));
          }
          parse_tree__file_names__module_name_to_file_name_8_p_0(Globals_10, (MR_String) "predicate \140make.module_target.get_foreign_code_file\'/7", (MR_Integer) 0, Var_79, ForeignModName_66, &ForeignObjectFile_24);
          {
            MR_Word base;
            base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
...
{
  {
    ...
    conv7_LambdaHeadVar__2_65 = make__module_target__IntroducedFrom__func__touched_files_process_module__992__1_1_f_0(((MR_Word) (wrapper_arg_1)));
...
{
  {
    ...
    succeeded = make__module_target__IntroducedFrom__pred__touched_files_process_module__970__1_2_p_0(((MR_Word) (wrapper_arg_1)), &conv4_LambdaHeadVar__2_54);
    if (succeeded)
    {
            ...
            case (MR_Integer) 0:
              {
                ...
                libs__globals__lookup_bool_option_3_p_0(Globals_10, (MR_Integer) 288, &HighLevelCode_34);
...
{
  {
    ...
    if ((ArgFileNameSuccess_31 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals_13, (MR_Integer) 683, &ShowMakeTimes_37);
