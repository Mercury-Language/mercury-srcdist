  ...
  MR_Word * STATE_VARIABLE_MakeInfo_22)
{
...

  {
    ...
    MR_hl_field(0, Var_25, 6) = ((MR_Box) ((MR_Integer) 79));
  }
  ...
  STATE_VARIABLE_MakeInfo_31_31 = ((MR_Word) (conv4_STATE_VARIABLE_MakeInfo_31_31));
  {
    ...
    MR_hl_field(0, Var_35, 5) = ((MR_Box) ((MR_Integer) 79));
  }
    ...
    case (MR_Integer) 6:
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 334, &HighLevelCode_34);
  ...
  MR_Word * STATE_VARIABLE_Info_59)
{
  ...
  if ((ArgFileNameRes_35 == (MR_Word) ((MR_Unsigned) 0U)))
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_15, (MR_Integer) 79, &VeryVerbose_38);
    {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_15, (MR_Integer) 733, &ShowMakeTimes_55);
    ...
    case (MR_Integer) 0:
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_16, (MR_Integer) 84, &Verbose_27);
        switch (Verbose_27) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 0:
            {
