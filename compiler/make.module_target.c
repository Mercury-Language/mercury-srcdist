  ...
  top_of_proc_2:;
    {
      ...
      else
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 653, &KeepGoing_37);
            ...
            case (MR_Integer) 0:
              {
                ...
                libs__globals__lookup_bool_option_3_p_0(Globals_10, (MR_Integer) 291, &HighLevelCode_34);
...
{
  {
    ...
    if ((ArgFileNameSuccess_31 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals_13, (MR_Integer) 681, &ShowMakeTimes_37);
