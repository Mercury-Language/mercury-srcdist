...
{
  {
...

    {
      ...
      MR_hl_field(MR_mktag(0), Var_67, 4) = ((MR_Box) ((MR_Integer) 58));
    }
    ...
    STATE_VARIABLE_MakeInfo_68_68 = ((MR_Word) conv2_STATE_VARIABLE_MakeInfo_68_68);
    {
      ...
      MR_hl_field(MR_mktag(0), Var_71, 4) = ((MR_Box) ((MR_Integer) 58));
    }
      ...
      case (MR_Integer) 0:
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_17, (MR_Integer) 63, &Verbose_25);
          switch (Verbose_25) {
            default: /*NOTREACHED*/ MR_assert(0);
            case (MR_Integer) 0:
              {
        ...
        case (MR_Integer) 0:
          {
            ...
            else
            {
              ...
              else
              {
                ...
                libs__globals__lookup_bool_option_3_p_0(Globals_10, (MR_Integer) 631, &KeepGoing_41);
            ...
            case (MR_Integer) 0:
              {
                ...
                libs__globals__lookup_bool_option_3_p_0(Globals_10, (MR_Integer) 265, &HighLevelCode_33);
...
{
  {
    ...
    if ((ArgFileNameSuccess_32 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
    {
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals_13, (MR_Integer) 58, &VeryVerbose_39);
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals_13, (MR_Integer) 659, &ShowMakeTimes_41);
