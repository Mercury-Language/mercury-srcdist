            ...
            case (MR_Integer) 0:
              {
                ...
                libs__globals__lookup_bool_option_3_p_0(Globals_10, (MR_Integer) 303, &HighLevelCode_34);
...
{
  {
    ...
    if ((ArgFileNameRes_32 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals_13, (MR_Integer) 694, &ShowMakeTimes_50);
