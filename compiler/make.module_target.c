...
{
  {
    ...
    if ((ArgFileNameRes_32 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      ...
      libs__process_util__teardown_checking_for_interrupt_9_p_0((MR_Word) (&make__make_info__make__make_info__type_ctor_info_make_info_0), VeryVerbose_35, Cookie_37, Cleanup_36, Succeeded0_46, Succeeded_20, ((MR_Box) (STATE_VARIABLE_Info_78_78)), &conv1_STATE_VARIABLE_Info_80_80);
