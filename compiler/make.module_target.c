    ...
    case (MR_Integer) 1:
      {
        ...
        parse_tree__file_names__module_name_to_file_name_create_dirs_7_p_0(Globals_13, (MR_String) "predicate \140make.module_target.build_object_code\'/10", (MR_Word) (MR_mkword(3, &make__module_target_scalar_common_2[2])), ModuleName_16, &CsharpFile_21);
        {
    ...
    case (MR_Integer) 2:
      {
        ...
        parse_tree__file_names__module_name_to_file_name_create_dirs_7_p_0(Globals_13, (MR_String) "predicate \140make.module_target.build_object_code\'/10", (MR_Word) (MR_mkword(3, &make__module_target_scalar_common_2[3])), ModuleName_16, &JavaFile_20);
  ...
  MR_Word * STATE_VARIABLE_Info_59)
{
  ...
  if ((ArgFileNameRes_35 == (MR_Word) ((MR_Unsigned) 0U)))
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_15, (MR_Integer) 713, &ShowMakeTimes_55);
