...
{
  {
...

    {
      ...
      MR_hl_field(MR_mktag(0), Var_67, 4) = ((MR_Box) ((MR_Integer) 64));
    }
    ...
    STATE_VARIABLE_MakeInfo_68_68 = ((MR_Word) (conv2_STATE_VARIABLE_MakeInfo_68_68));
    {
      ...
      MR_hl_field(MR_mktag(0), Var_71, 4) = ((MR_Box) ((MR_Integer) 64));
    }
        ...
        case (MR_Integer) 0:
          {
            ...
            else
            {
              ...
              else
              {
                ...
                libs__globals__lookup_bool_option_3_p_0(Globals_10, (MR_Integer) 650, &KeepGoing_42);
...
{
  {
    ...
    if ((ArgFileNameSuccess_32 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals_13, (MR_Integer) 64, &VeryVerbose_39);
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals_13, (MR_Integer) 678, &ShowMakeTimes_41);
