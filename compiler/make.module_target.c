...
{
  {
...

    {
      ...
      MR_hl_field(MR_mktag(0), Var_21, 4) = ((MR_Box) ((MR_Integer) 69));
    }
    ...
    STATE_VARIABLE_MakeInfo_22_22 = ((MR_Word) (conv2_STATE_VARIABLE_MakeInfo_22_22));
    {
      ...
      MR_hl_field(MR_mktag(0), Var_25, 4) = ((MR_Box) ((MR_Integer) 69));
    }
            ...
            case (MR_Integer) 0:
              {
                ...
                libs__globals__lookup_bool_option_3_p_0(Globals_10, (MR_Integer) 300, &HighLevelCode_34);
...
{
  {
    ...
    if ((ArgFileNameRes_32 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals_13, (MR_Integer) 69, &VeryVerbose_35);
      {
      ...
      case (MR_Integer) 0:
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_17, (MR_Integer) 74, &Verbose_26);
          switch (Verbose_26) {
            default: /*NOTREACHED*/ MR_assert(0);
            case (MR_Integer) 0:
              {
