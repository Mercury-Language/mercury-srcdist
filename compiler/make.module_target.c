  ...
  void * env_ptr_arg)
{
...

  {
    ...
    (env_ptr)->make__module_target__make_dependency_files_10_p_0_env_0__succeeded = ((MR_tag((MR_Word) (env_ptr)->make__module_target__make_dependency_files_10_p_0_env_0__Var_113)) == (MR_Integer) 1);
    if ((env_ptr)->make__module_target__make_dependency_files_10_p_0_env_0__succeeded)
    {
      ArgX1_118 = ((MR_String) ((MR_hl_field(MR_mktag(1), (env_ptr)->make__module_target__make_dependency_files_10_p_0_env_0__Var_113, (MR_Integer) 0))));
