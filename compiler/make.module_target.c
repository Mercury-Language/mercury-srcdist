...
make__module_target__IntroducedFrom__func__find_files_maybe_touched_by_process_module__1094__1_1_f_0(
  MR_Word LambdaHeadVar__1_60);

static MR_bool MR_CALL 
make__module_target__IntroducedFrom__pred__find_files_maybe_touched_by_process_module__1073__1_2_p_0(
  ...
  MR_Word * STATE_VARIABLE_TimestampFileNames_16)
{
  ...
  if (succeeded)
  {
    ...
    parse_tree__file_names__module_name_to_file_name_7_p_0(Globals_7, (MR_String) "predicate \140make.module_target.gather_target_file_timestamp_file_names\'/6", TimestampExt_13, TargetModuleName_11, &TimestampFile_14);
    ...
    case (MR_Integer) 2:
      {
        ...
        parse_tree__prog_foreign__foreign_language_file_extension_2_p_0(Lang_20, &SrcExt_55);
          ...
          case (MR_Integer) 0:
            {
              ...
              backend_libs__compile_target_code__maybe_pic_object_file_extension_3_p_0(PIC_19, &ObjExt_56, &Var_64);
            }
            break;
          case (MR_Integer) 1:
            {
        ...
        parse_tree__file_names__module_name_to_file_name_create_dirs_7_p_0(Globals_10, (MR_String) "predicate \140make.module_target.get_foreign_code_file\'/7", SrcExt_55, ForeignModName_54, &SrcFileName_57);
        {
          Var_62 = (MR_Word) MR_mkword(3, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(3, Var_62, 0) = ((MR_Box) ((MR_Unsigned) 5U));
          MR_hl_field(3, Var_62, 1) = (MR_Box) ((MR_Unsigned) (ObjExt_56));
        }
        parse_tree__file_names__module_name_to_file_name_create_dirs_7_p_0(Globals_10, (MR_String) "predicate \140make.module_target.get_foreign_code_file\'/7", Var_62, ForeignModName_54, &ForeignObjectFile_24);
        {
          MR_Word base;
          base = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
    ...
    case (MR_Integer) 3:
      {
          ...
          case (MR_Integer) 0:
            {
              ...
              backend_libs__compile_target_code__maybe_pic_object_file_extension_3_p_0(PIC_45, &ObjExt_26, &Var_49);
            }
            break;
          case (MR_Integer) 1:
            {
        ...
        parse_tree__file_names__fact_table_file_name_return_dirs_8_p_0(Globals_10, (MR_String) "predicate \140make.module_target.find_files_maybe_touched_by_task\'/9", Var_41, FactTableName_25, &FactTableDirs_27, &FactTableObjectFile_28);
  ...
  MR_Box wrapper_arg_1)
{
  ...
  conv7_LambdaHeadVar__2_61 = make__module_target__IntroducedFrom__func__find_files_maybe_touched_by_process_module__1094__1_1_f_0(((MR_Word) (wrapper_arg_1)));
  ...
  MR_Box * wrapper_arg_2)
{
  ...
  succeeded = make__module_target__IntroducedFrom__pred__find_files_maybe_touched_by_process_module__1073__1_2_p_0(((MR_Word) (wrapper_arg_1)), &conv4_LambdaHeadVar__2_54);
  if (succeeded)
  {
  ...
  MR_Word * ForeignCodeFile_12)
{
  ...
  parse_tree__file_names__fact_table_file_name_return_dirs_8_p_0(Globals_8, (MR_String) "predicate \140make.module_target.get_fact_table_foreign_code_file\'/7", (MR_Word) (MR_mkword(3, &make__module_target_scalar_common_1[28])), FactTableFileName_11, &FactTableDirsC_14, &FactTableCFileName_15);
  parse_tree__file_names__maybe_create_any_dirs_on_path_4_p_0(Mkdir_9, FactTableDirsC_14);
  parse_tree__file_names__fact_table_file_name_return_dirs_8_p_0(Globals_8, (MR_String) "predicate \140make.module_target.get_fact_table_foreign_code_file\'/7", ObjExt_10, FactTableFileName_11, &FactTableDirsO_16, &FactTableObjFileName_17);
