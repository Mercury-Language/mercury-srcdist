...
{
  {
    ...
    if ((ArgFileNameRes_32 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals_13, (MR_Integer) 67, &VeryVerbose_35);
      {
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals_13, (MR_Integer) 689, &ShowMakeTimes_50);
