  ...
  MR_Box wrapper_arg_1)
{
  ...
  conv1_LambdaHeadVar__2_23 = check_hlds__xml_documentation__IntroducedFrom__func__class_methods_to_xml__842__1_2_f_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) (wrapper_arg_1)));
  ...
  MR_Word ModuleInfo_4)
{
  ...
  parse_tree__file_names__module_name_to_file_name_9_p_0(Globals_6, (MR_String) "predicate \140check_hlds.xml_documentation.xml_documentation\'/3", (MR_Integer) 0, (MR_Word) (MR_mkword(1, &check_hlds__xml_documentation_scalar_common_5[0])), (MR_Word) (MR_mkword(3, &check_hlds__xml_documentation_scalar_common_1[3])), ModuleName_7, &FileName_8);
  ...
  else
  {
    ...
    if (((MR_tag((MR_Word) SrcResult_11)) == (MR_Integer) 1))
    {
      ...
      hlds__passes_aux__get_error_output_stream_4_p_0(ModuleInfo_4, &ErrorStream_45);
      libs__file_util__unable_to_open_file_5_p_0(ErrorStream_45, SrcFileName_10, SrcErr_20);
    }
    else
    {
