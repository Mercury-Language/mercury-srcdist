      ...
      case (MR_Integer) 2:
        {
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(0), Var_44, 2) = ((MR_Box) (Var_66));
          }
          {
          ...
          case (MR_Integer) 1:
            {
              ...
              }
              {
                ...
                MR_hl_field(MR_mktag(0), Var_39, 2) = ((MR_Box) (Var_109));
              }
              {
    ...
    case (MR_Integer) 0:
      {
        ...
        Var_47 = mercury__list__map_2_f_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_constructor_0), (MR_Word) (&mercury__term_to_xml__term_to_xml__type_ctor_info_xml_0), Var_22, Ctors_14);
        {
          ...
          MR_hl_field(MR_mktag(0), Var_20, 2) = ((MR_Box) (Var_47));
        }
        {
    ...
    case (MR_Integer) 1:
      {
        ...
        if ((Decl_30 == (MR_Word) ((MR_Unsigned) 0U)))
        {
          ...
          {
            Var_19 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), Var_19, 0) = ((MR_Box) (Var_34));
          }
        }
        else
        {
          ...
          Var_35 = mercury__string__from_char_list_1_f_0(Comment_31);
          {
            ...
            MR_hl_field(MR_mktag(2), Var_19, 0) = ((MR_Box) (Var_35));
          }
        }
