  ...
  MR_Box wrapper_arg_1)
{
  ...
  conv1_LambdaHeadVar__2_23 = check_hlds__xml_documentation__IntroducedFrom__func__class_methods_to_xml__838__1_2_f_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) (wrapper_arg_1)));
  ...
  MR_Word ModuleInfo_6)
{
  ...
  {
    MR_Word SrcErr_20 = ((MR_Word) ((MR_hl_field(1, SrcResult_11, 0))));

    libs__file_util__report_unable_to_open_file_5_p_0(ProgressStream_5, SrcFileName_10, SrcErr_20);
  }
  else
  {
    ...
    Var_26 = mercury__map__init_0_f_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0), (MR_Word) (&check_hlds__xml_documentation__check_hlds__xml_documentation__type_ctor_info_typed_line_0));
    check_hlds__xml_documentation__build_line_type_map_5_p_0(SrcStream_12, Var_26, &RawLineTypeMap_13);
    ...
    {
      MR_Word Err_19 = ((MR_Word) ((MR_hl_field(1, XmlOpenResult_16, 0))));
