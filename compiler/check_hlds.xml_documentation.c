...
check_hlds__xml_documentation__IntroducedFrom__func__class_methods_to_xml__837__1_2_f_0(
  MR_Word PredTable_6,
...
{
  {
    ...
    conv1_LambdaHeadVar__2_16 = check_hlds__xml_documentation__IntroducedFrom__func__class_methods_to_xml__837__1_2_f_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) (wrapper_arg_1)));
...
{
  {
    ...
    else
    {
      ...
      else
      {
        ...
        Var_32 = mercury__map__init_0_f_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0), (MR_Word) (&check_hlds__xml_documentation__check_hlds__xml_documentation__type_ctor_info_line_type_0));
        Var_30 = (MR_Word) (Var_32);
        check_hlds__xml_documentation__build_comments_5_p_0(SrcStream_12, Var_30, &Comments_13);
