  ...
  MR_Word ModuleInfo_4)
{
  ...
  parse_tree__file_names__module_name_to_file_name_8_p_0(Globals_6, (MR_String) "predicate \140check_hlds.xml_documentation.xml_documentation\'/3", (MR_Integer) 0, (MR_Word) (MR_mkword(3, &check_hlds__xml_documentation_scalar_common_1[3])), ModuleName_7, &FileName_8);
  ...
  else
  {
    ...
    if (((MR_tag((MR_Word) SrcResult_11)) == (MR_Integer) 1))
    {
      ...
      hlds__passes_aux__get_error_output_stream_4_p_0(ModuleInfo_4, &ErrorStream_42);
      libs__file_util__unable_to_open_file_5_p_0(ErrorStream_42, SrcFileName_10, SrcErr_20);
    }
    else
    {
