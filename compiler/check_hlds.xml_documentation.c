...
{
  MR_Word Xml_6;
  MR_Word Comments_3 = ((MR_Word) ((MR_hl_field(0, HeadVar__1_1, 0))));
  ...
  MR_Word ModuleInfo_6)
{
  ...
  else
  {
    ...
    {
      MR_Word SrcErr_20 = ((MR_Word) ((MR_hl_field(1, SrcResult_12, 0))));
