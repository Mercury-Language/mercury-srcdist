  ...
  MR_Word ModuleInfo_4)
{
  ...
  parse_tree__file_names__module_name_to_file_name_create_dirs_7_p_0(Globals_6, (MR_String) "predicate \140check_hlds.xml_documentation.xml_documentation\'/3", (MR_Word) (&check_hlds__xml_documentation_scalar_common_5[0]), ModuleName_7, &FileName_8);
