...
{
  {
    ...
    if (succeeded)
    {
      succeeded = ((((MR_tag((MR_Word) Origin_11)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(MR_mktag(3), Origin_11, (MR_Integer) 0)))) == (MR_Integer) 6)));
      if (succeeded)
      {
...
{
  {
    ...
    switch (MR_tag((MR_Word) TypeDefnBody_7)) {
      ...
      case (MR_Integer) 2:
        ...
        break;
      case (MR_Integer) 3:
        switch (((MR_Integer) ((MR_hl_field(MR_mktag(3), TypeDefnBody_7, (MR_Integer) 0))))) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 0:
