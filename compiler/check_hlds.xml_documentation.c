...
check_hlds__xml_documentation__IntroducedFrom__func__class_methods_to_xml__842__1_2_f_0(
  MR_Word PredTable_6,
...
{
  {
    ...
    conv1_LambdaHeadVar__2_16 = check_hlds__xml_documentation__IntroducedFrom__func__class_methods_to_xml__842__1_2_f_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) (wrapper_arg_1)));
...
{
  {
    ...
    else
    {
      ...
      {
        MR_Word SrcErr_20 = ((MR_Word) ((MR_hl_field(MR_mktag(1), SrcResult_11, (MR_Integer) 0))));
        MR_Word ErrorStream_43;

        hlds__passes_aux__get_error_output_stream_4_p_0(ModuleInfo_4, &ErrorStream_43);
        parse_tree__error_util__unable_to_open_file_5_p_0(ErrorStream_43, SrcFileName_10, SrcErr_20);
      }
      else
      {
        ...
        Var_37 = mercury__map__init_0_f_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0), (MR_Word) (&check_hlds__xml_documentation__check_hlds__xml_documentation__type_ctor_info_line_type_0));
        Var_35 = (MR_Word) (Var_37);
        check_hlds__xml_documentation__build_comments_5_p_0(SrcStream_12, Var_35, &Comments_13);
        ...
        if (((MR_tag((MR_Word) OpenResult_15)) == (MR_Integer) 1))
        {
          ...
          parse_tree__error_util__unable_to_open_file_5_p_0(ErrorStream_19, FileName_8, Err_18);
        }
        else
        {
