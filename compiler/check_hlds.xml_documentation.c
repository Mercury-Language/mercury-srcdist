      ...
      case (MR_Integer) 1:
        {
          ...
          Var_81 = mdbcomp__sym_name__sym_name_to_string_1_f_0(TypeName_7);
          Var_79 = mercury__string__f_43_43_2_f_0((MR_String) ".", Var_81);
          Var_73 = mercury__string__f_43_43_2_f_0((MR_String) "type", Var_79);
          Var_76 = mercury__string__int_to_string_1_f_0(TypeArity_8);
          Var_74 = mercury__string__f_43_43_2_f_0((MR_String) "-", Var_76);
          Var_30 = mercury__string__f_43_43_2_f_0(Var_73, Var_74);
          {
...
{
  {
    ...
    switch (MR_tag((MR_Word) TypeDefnBody_7)) {
      ...
      case (MR_Integer) 1:
        {
          ...
          Ctors_14 = mercury__one_or_more__one_or_more_to_list_1_f_1((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_constructor_0), OoMCtors_9);
          {
            ...
            MR_hl_field(MR_mktag(0), Var_37, 0) = ((MR_Box) (&check_hlds__xml_documentation_scalar_common_7[0]));
            MR_hl_field(MR_mktag(0), Var_37, 1) = ((MR_Box) (check_hlds__xml_documentation__type_body_to_xml_3_f_0_1));
            MR_hl_field(MR_mktag(0), Var_37, 2) = ((MR_Box) ((MR_Integer) 2));
            MR_hl_field(MR_mktag(0), Var_37, 3) = ((MR_Box) (C_5));
            MR_hl_field(MR_mktag(0), Var_37, 4) = ((MR_Box) (TVarSet_6));
          }
          Var_54 = mercury__list__map_2_f_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_constructor_0), (MR_Word) (&mercury__term_to_xml__term_to_xml__type_ctor_info_xml_0), Var_37, Ctors_14);
          {
            Var_35 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
            MR_hl_field(MR_mktag(0), Var_35, 0) = ((MR_Box) ((MR_String) "constructors"));
            MR_hl_field(MR_mktag(0), Var_35, 1) = ((MR_Box) ((MR_Unsigned) 0U));
            MR_hl_field(MR_mktag(0), Var_35, 2) = ((MR_Box) (Var_54));
          }
          {
            Xmls_8 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), Xmls_8, 0) = ((MR_Box) (Var_35));
      ...
      case (MR_Integer) 2:
        {
          MR_Word EqvType_15 = ((MR_Word) ((MR_hl_field(MR_mktag(2), TypeDefnBody_7, (MR_Integer) 0))));
          MR_Word Var_28;
          MR_Word Var_31;
          MR_Word Var_32;

          Var_32 = check_hlds__xml_documentation__mer_type_to_xml_2_f_0(TVarSet_6, EqvType_15);
          {
          ...
          {
            Var_28 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
            MR_hl_field(MR_mktag(0), Var_28, 0) = ((MR_Box) ((MR_String) "equivalent_type"));
            MR_hl_field(MR_mktag(0), Var_28, 1) = ((MR_Box) ((MR_Unsigned) 0U));
            MR_hl_field(MR_mktag(0), Var_28, 2) = ((MR_Box) (Var_31));
          }
          {
            Xmls_8 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), Xmls_8, 0) = ((MR_Box) (Var_28));
            MR_hl_field(MR_mktag(1), Xmls_8, 1) = ((MR_Box) ((MR_Unsigned) 0U));
          }
        }
        break;
