...
{
  {
    ...
    else
    {
      ...
      {
        succeeded = ((((MR_tag((MR_Word) Expr_12)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(MR_mktag(3), Expr_12, (MR_Integer) 0)))) == (MR_Integer) 4)));
        if (succeeded)
        {
          *CreatedBeforeProgPoint_21 = mercury__set__init_0_f_0((MR_Word) (&transform_hlds__rbmm__points_to_graph__transform_hlds__rbmm__points_to_graph__type_ctor_info_rptg_node_0));
          *RemovedAfterProgPoint_22 = BecomeDead_15;
        ...
        {
          if (((((MR_tag((MR_Word) Expr_12)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(MR_mktag(3), Expr_12, (MR_Integer) 0)))) == (MR_Integer) 2))))
          {
          ...
          if (((((MR_tag((MR_Word) Expr_12)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(MR_mktag(3), Expr_12, (MR_Integer) 0)))) == (MR_Integer) 3))))
          {
...
{
  {
    ...
    hlds__hlds_module__module_info_get_valid_pred_ids_2_p_0(ModuleInfo_14, &PredIds_27);
    {
      ...
      MR_hl_field(MR_mktag(0), Var_28, 2) = ((MR_Box) ((MR_Integer) 9));
