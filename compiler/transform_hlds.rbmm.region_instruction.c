...
{
  {
    ...
    switch (RegionInstrType_7) {
      ...
      case (MR_Integer) 1:
        {
          RegionInstruction_13 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
    ...
    if (succeeded)
    {
      ...
      else
      {
        ...
        if (succeeded)
        {
          ...
          {
            NewInstrsBefore_16 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
...
{
  {
    ...
    if (succeeded)
    {
      ...
      packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), Expr_12, (MR_Integer) 3)));
      {
    ...
    else
    {
      ...
      else
      {
        ...
        if (succeeded)
        {
          packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Expr_12, (MR_Integer) 2)));
          *CreatedBeforeProgPoint_21 = mercury__set__init_0_f_0((MR_Word) (&transform_hlds__rbmm__points_to_graph__transform_hlds__rbmm__points_to_graph__type_ctor_info_rptg_node_0));
          *RemovedAfterProgPoint_22 = BecomeDead_15;
        }
        else
        {
          if (((((MR_tag((MR_Word) Expr_12)) == (MR_Integer) 3)) && ((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), Expr_12, (MR_Integer) 0))) == (MR_Integer) 2))))
          {
            ...
            MR_Unsigned packed_word_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Expr_12, (MR_Integer) 1)));
