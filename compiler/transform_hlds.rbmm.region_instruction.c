...
MR_decl_label1(transform_hlds__rbmm__region_instruction__annotate_expr_11_0, 39)
...
MR_BEGIN_MODULE(transform_hlds__rbmm__region_instruction_module3)
	...
	MR_init_label1(transform_hlds__rbmm__region_instruction__annotate_expr_11_0,39)
MR_BEGIN_CODE
