...
{
  {
    ...
    else
    {
      ...
      {
        Var_22 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), Var_22, 0) = ((MR_Box) ((MR_Unsigned) 0U));
...
{
  {
    MR_bool succeeded = ((MR_tag((MR_Word) Expr_12)) == (MR_Integer) 2);
    ...
    if (succeeded)
    {
      ...
      packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), Expr_12, (MR_Integer) 3)));
      {
    ...
    else
    {
      ...
      succeeded = ((MR_tag((MR_Word) Expr_12)) == (MR_Integer) 1);
      if (succeeded)
      {
      ...
      else
      {
        ...
        succeeded = ((((MR_tag((MR_Word) Expr_12)) == (MR_Integer) 3)) && ((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), Expr_12, (MR_Integer) 0))) == (MR_Integer) 4)));
        if (succeeded)
        {
          packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Expr_12, (MR_Integer) 2)));
          *CreatedBeforeProgPoint_21 = mercury__set__init_0_f_0((MR_Word) (&transform_hlds__rbmm__points_to_graph__transform_hlds__rbmm__points_to_graph__type_ctor_info_rptg_node_0));
          *RemovedAfterProgPoint_22 = BecomeDead_15;
        }
        else
        {
          if (((((MR_tag((MR_Word) Expr_12)) == (MR_Integer) 3)) && ((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), Expr_12, (MR_Integer) 0))) == (MR_Integer) 2))))
          {
            MR_Word Var_74 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Expr_12, (MR_Integer) 2))));
            MR_Unsigned packed_args_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Expr_12, (MR_Integer) 1)));

            succeeded = (Var_74 == (MR_Word) ((MR_Unsigned) 0U));
          }
          else
          if (((((MR_tag((MR_Word) Expr_12)) == (MR_Integer) 3)) && ((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), Expr_12, (MR_Integer) 0))) == (MR_Integer) 3))))
          {
