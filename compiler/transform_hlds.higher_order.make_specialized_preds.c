  ...
  MR_Word HeadVar__5_5)
{
  while (MR_TRUE)
  {
    ...
    if (!((HeadVar__5_5 == (MR_Word) ((MR_Unsigned) 0U))))
    {
      ...
      if (succeeded)
      {
        ShroudedPredProcId_31 = (MR_Word) (MR_body((MR_Word) (ConsId_22), (MR_Integer) 1));
        {
          MR_Word PredId_32;
          MR_Word PredInfo_34;
          MR_String Name_35;
  ...
  MR_Word * HeadVar__13_13)
{
  ...
  else
  {
    ...
    succeeded = ((MR_tag((MR_Word) ConsId_37)) == (MR_Integer) 1);
    if (succeeded)
    {
      ShroudedPredProcId_46 = (MR_Word) (MR_body((MR_Word) (ConsId_37), (MR_Integer) 1));
      {
        MR_Word PredId_47;
