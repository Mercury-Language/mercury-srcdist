...
static const MR_FA_PseudoTypeInfo_Struct1 transform_hlds__higher_order__make_specialized_preds__set_ordlist__pti_set_ordlist_1__plain_hlds__pred_proc_id__type_ctor_info_pred_proc_id_0;
...
static void MR_CALL 
transform_hlds__higher_order__make_specialized_preds__IntroducedFrom__pred__specialize_and_add_new_proc__607__1_4_p_0(
  MR_Word LambdaHeadVar__1_138,
  MR_Word LambdaHeadVar__2_139,
  MR_Word LambdaHeadVar__3_140,
  MR_Word * LambdaHeadVar__4_141);

static MR_bool MR_CALL 
transform_hlds__higher_order__make_specialized_preds__IntroducedFrom__pred__specialize_and_add_new_proc__547__1_2_p_0(
  MR_Word LambdaHeadVar__1_127,
  MR_Word * LambdaHeadVar__2_128);
...
transform_hlds__higher_order__make_specialized_preds__update_type_info_locn_6_p_0(
  ...
  MR_Word STATE_VARIABLE_RttiVarMaps_0_25,
  MR_Word * STATE_VARIABLE_RttiVarMaps_26);
...
transform_hlds__higher_order__make_specialized_preds__specialize_and_add_new_proc_6_p_0(
  MR_Word NewPred_7,
  MR_Word STATE_VARIABLE_NewProcInfo_0_121,
  MR_Word STATE_VARIABLE_NewPredInfo_0_122,
  MR_Word * STATE_VARIABLE_NewPredInfo_123,
  MR_Word STATE_VARIABLE_GlobalInfo_0_124,
  MR_Word * STATE_VARIABLE_GlobalInfo_125);
...
static /* final */ const MR_Box transform_hlds__higher_order__make_specialized_preds_scalar_common_4[5][7] = {
  ...
  /* row   4 */
  {
    ...
    ((MR_Box) (&transform_hlds__higher_order__higher_order_global_info__transform_hlds__higher_order__higher_order_global_info__type_ctor_info_ho_request_0)),
    ((MR_Box) (&transform_hlds__higher_order__make_specialized_preds__set_ordlist__pti_set_ordlist_1__plain_hlds__pred_proc_id__type_ctor_info_pred_proc_id_0)),
    ((MR_Box) (&transform_hlds__higher_order__make_specialized_preds__set_ordlist__pti_set_ordlist_1__plain_hlds__pred_proc_id__type_ctor_info_pred_proc_id_0))
  },
};
  ...
  MR_Word * LambdaHeadVar__4_141)
{
...

  {
    ...
    MR_hl_field(0, Locn_64, 0) = ((MR_Box) (LambdaHeadVar__2_139));
  }
  hlds__hlds_rtti__rtti_set_type_info_locn_4_p_0(LambdaHeadVar__1_138, Locn_64, LambdaHeadVar__3_140, LambdaHeadVar__4_141);
}
...
transform_hlds__higher_order__make_specialized_preds__IntroducedFrom__pred__specialize_and_add_new_proc__547__1_2_p_0(
  ...
  MR_Word * LambdaHeadVar__2_128)
{
  MR_bool succeeded = ((MR_tag((MR_Word) LambdaHeadVar__1_127)) == (MR_Integer) 0);

  if (succeeded)
    *LambdaHeadVar__2_128 = ((MR_Word) ((MR_hl_field(0, LambdaHeadVar__1_127, 0))));
  return succeeded;
}
  ...
  MR_Word * STATE_VARIABLE_HOArg_13)
{
  ...
  parse_tree__prog_type_subst__apply_rec_subst_to_types_3_p_0(Subn_4, CurriedArgTypes0_6, &CurriedArgTypes_9);
  {
    ...
    case (MR_Integer) 0:
      {
...

        {
          ...
          MR_hl_field(1, Var_28, 0) = ((MR_Box) (Var_7));
          MR_hl_field(1, Var_28, 1) = ((MR_Box) (Index_9));
        }
        succeeded = hlds__hlds_rtti__rtti_search_type_info_locn_3_p_0(STATE_VARIABLE_RttiVarMaps_0_25, ConstraintTVar_11, &Var_29);
        if (succeeded)
          *STATE_VARIABLE_RttiVarMaps_26 = STATE_VARIABLE_RttiVarMaps_0_25;
        else
          hlds__hlds_rtti__rtti_det_insert_type_info_locn_4_p_0(ConstraintTVar_11, Var_28, STATE_VARIABLE_RttiVarMaps_0_25, STATE_VARIABLE_RttiVarMaps_26);
      }
      break;
    case (MR_Integer) 1:
      *STATE_VARIABLE_RttiVarMaps_26 = STATE_VARIABLE_RttiVarMaps_0_25;
  ...
  MR_Box * wrapper_arg_5)
{
  ...
  MR_Word conv0_STATE_VARIABLE_RttiVarMaps_26;

  transform_hlds__higher_order__make_specialized_preds__update_type_info_locn_6_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) (wrapper_arg_1)), ((MR_Integer) (wrapper_arg_2)), &conv1_HeadVar__4_4, ((MR_Word) (wrapper_arg_4)), &conv0_STATE_VARIABLE_RttiVarMaps_26);
  *wrapper_arg_3 = ((MR_Box) (conv1_HeadVar__4_4));
  *wrapper_arg_5 = ((MR_Box) (conv0_STATE_VARIABLE_RttiVarMaps_26));
}
  ...
  MR_Word * STATE_VARIABLE_VarTable_17)
{
  ...
  IsDummy_10 = hlds__type_util__is_type_a_dummy_2_f_0(ModuleInfo_5, Type_9);
      ...
      case (MR_Integer) 0:
        {
          ...
          else
          {
            ...
            else
            {
              ...
              (env).transform_hlds__higher_order__make_specialized_preds__filter_request_9_p_0_env_0__succeeded = mercury__map__search_3_p_0((MR_Word) (&hlds__pred_proc_id__hlds__pred_proc_id__type_ctor_info_pred_proc_id_0), (MR_Word) (&transform_hlds__higher_order__higher_order_global_info__transform_hlds__higher_order__higher_order_global_info__type_ctor_info_version_info_0), VersionInfoMap_55, ((MR_Box) (CalleePredProcId_48)), &conv1_CalleeVersionInfo_56);
              if ((env).transform_hlds__higher_order__make_specialized_preds__filter_request_9_p_0_env_0__succeeded)
              {
  ...
  MR_Word * STATE_VARIABLE_PredProcIdsToFix_10)
{
  ...
  (env).transform_hlds__higher_order__make_specialized_preds__check_loop_request_4_p_0_env_0__Request_6 = Request_6;
  {
    ...
    (env).transform_hlds__higher_order__make_specialized_preds__check_loop_request_4_p_0_env_0__succeeded = mercury__map__search_3_p_0((MR_Word) (&hlds__pred_proc_id__hlds__pred_proc_id__type_ctor_info_pred_proc_id_0), (MR_Word) (&transform_hlds__higher_order__make_specialized_preds_scalar_common_1[3]), NewPredMap_19, ((MR_Box) (CalleePredProcId_20)), &conv0_SpecVersions_21);
    ...
    if ((env).transform_hlds__higher_order__make_specialized_preds__check_loop_request_4_p_0_env_0__succeeded)
    {
      ...
      mercury__set__insert_3_p_0((MR_Word) (&hlds__pred_proc_id__hlds__pred_proc_id__type_ctor_info_pred_proc_id_0), ((MR_Box) (CallerPredProcId_8)), STATE_VARIABLE_PredProcIdsToFix_0_9, STATE_VARIABLE_PredProcIdsToFix_10);
    }
    else
  ...
  MR_Word * STATE_VARIABLE_GlobalInfo_26)
{
  ...
  else
  {
    ...
    mercury__set__init_1_p_0((MR_Word) (&hlds__pred_proc_id__hlds__pred_proc_id__type_ctor_info_pred_proc_id_0), &PredProcIdsToFix0_17);
    ...
    *NewRequests_10 = ((MR_Word) (conv11_NewRequests_10));
    ...
    mercury__set__foldl2_6_p_0((MR_Word) (&hlds__pred_proc_id__hlds__pred_proc_id__type_ctor_info_pred_proc_id_0), (MR_Word) (&transform_hlds__higher_order__make_specialized_preds_scalar_common_1[4]), (MR_Word) (&transform_hlds__higher_order__higher_order_global_info__transform_hlds__higher_order__higher_order_global_info__type_ctor_info_higher_order_global_info_0), (MR_Word) (&transform_hlds__higher_order__make_specialized_preds_scalar_common_9[1]), PredProcIdsToFix_20, ((MR_Box) (Var_66)), &conv15__Requests_64, ((MR_Box) (STATE_VARIABLE_GlobalInfo_2_37)), &conv14_STATE_VARIABLE_GlobalInfo_3_38);
  ...
  MR_Word * STATE_VARIABLE_GlobalInfo_8)
{
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      mercury__set__insert_3_p_0((MR_Word) (&hlds__pred_proc_id__hlds__pred_proc_id__type_ctor_info_pred_proc_id_0), ((MR_Box) (Var_40)), STATE_VARIABLE_PredsToFix_0_5, &STATE_VARIABLE_PredsToFix_1_41);
      ...
      (env).transform_hlds__higher_order__make_specialized_preds__maybe_create_new_ho_spec_preds_10_p_0_env_0__succeeded = mercury__map__search_3_p_0((MR_Word) (&hlds__pred_proc_id__hlds__pred_proc_id__type_ctor_info_pred_proc_id_0), (MR_Word) (&transform_hlds__higher_order__make_specialized_preds_scalar_common_1[3]), NewPredMap_53, ((MR_Box) (CalleePredProcId_54)), &conv0_SpecVersions_55);
    ...
    case (MR_Integer) 0:
      {
        ...
        NewProcId_27 = hlds__pred_proc_id__initial_proc_id_0_f_0();
    ...
    if (!((HeadVar__5_5 == (MR_Word) ((MR_Unsigned) 0U))))
    {
      ...
      if (succeeded)
      {
        ShroudedPredProcId_31 = (MR_Word) (MR_body((MR_Word) (ConsId_22), (MR_Integer) 2));
        {
          ...
          Var_60 = hlds__pred_proc_id__unshroud_pred_proc_id_1_f_0(ShroudedPredProcId_31);
...
{
  MR_Box closure = closure_arg;
  MR_Word conv6_LambdaHeadVar__4_141;

  transform_hlds__higher_order__make_specialized_preds__IntroducedFrom__pred__specialize_and_add_new_proc__607__1_4_p_0(((MR_Word) (wrapper_arg_1)), ((MR_Word) (wrapper_arg_2)), ((MR_Word) (wrapper_arg_3)), &conv6_LambdaHeadVar__4_141);
  *wrapper_arg_4 = ((MR_Box) (conv6_LambdaHeadVar__4_141));
}
  ...
  MR_Box wrapper_arg_1)
{
  ...
  conv1_HeadVar__3_3 = hlds__type_util__is_type_a_dummy_2_f_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) (wrapper_arg_1)));
  ...
  MR_Box * wrapper_arg_2)
{
  MR_bool succeeded;
  MR_Box closure = closure_arg;
  MR_Word conv0_LambdaHeadVar__2_128;

  succeeded = transform_hlds__higher_order__make_specialized_preds__IntroducedFrom__pred__specialize_and_add_new_proc__547__1_2_p_0(((MR_Word) (wrapper_arg_1)), &conv0_LambdaHeadVar__2_128);
  if (succeeded)
  {
    *wrapper_arg_2 = ((MR_Box) (conv0_LambdaHeadVar__2_128));
    succeeded = MR_TRUE;
  }
  return succeeded;
}
  ...
  MR_Word * STATE_VARIABLE_GlobalInfo_125)
{
  ...
  MR_Word Goal_99;
  MR_Word SharingReuseInfo0_100;
  MR_Word SharingReuseInfo_102;
  MR_Word VarTable7_103;
  MR_Word ExtraHeadVarTypes0_104;
  MR_Word ModifiedOriginalArgTypes_105;
  MR_Word ArgTypes_106;
  MR_Word ArgVars_114;
  MR_Word NewRttiVarMaps_115;
  MR_Word ArgVarInfos_116;
  MR_Word ClassContext_117;
  MR_Integer NewProcId_119;
  MR_Word NewProcs_120;
  MR_Word Var_129;
  MR_Word STATE_VARIABLE_NewProcInfo_1_130;
  MR_Word Var_131;
  MR_Word STATE_VARIABLE_NewProcInfo_2_136;
  MR_Word STATE_VARIABLE_NewProcInfo_3_145;
  MR_Word STATE_VARIABLE_NewProcInfo_4_146;
  MR_Word Var_147;
  MR_Word Var_149;
  MR_Word Var_150;
  MR_Word STATE_VARIABLE_NewProcInfo_5_151;
  MR_Word STATE_VARIABLE_NewProcInfo_6_152;
  MR_Word Var_153;
  MR_Word STATE_VARIABLE_NewProcInfo_7_154;
  MR_Word STATE_VARIABLE_NewProcInfo_8_157;
  MR_Word Var_158;
  MR_Word STATE_VARIABLE_NewPredInfo_1_159;
  MR_Word STATE_VARIABLE_NewPredInfo_2_160;
  MR_Word STATE_VARIABLE_NewProcInfo_9_162;
  MR_Word Var_163;
  MR_Word STATE_VARIABLE_NewPredInfo_3_164;
  MR_Word Var_172;
  MR_Word Var_173;
  ...
  ModuleInfo_11 = transform_hlds__higher_order__higher_order_global_info__hogi_get_module_info_1_f_0(STATE_VARIABLE_GlobalInfo_0_124);
  ...
  hlds__hlds_proc__proc_info_get_headvars_2_p_0(STATE_VARIABLE_NewProcInfo_0_121, &HeadVars0_21);
  hlds__hlds_proc__proc_info_get_argmodes_2_p_0(STATE_VARIABLE_NewProcInfo_0_121, &ArgModes0_22);
  hlds__hlds_pred__pred_info_get_exist_quant_tvars_2_p_0(STATE_VARIABLE_NewPredInfo_0_122, &ExistQVars0_23);
  hlds__hlds_pred__pred_info_get_typevarset_2_p_0(STATE_VARIABLE_NewPredInfo_0_122, &TypeVarSet0_24);
  hlds__hlds_pred__pred_info_get_tvar_kind_map_2_p_0(STATE_VARIABLE_NewPredInfo_0_122, &KindMap0_25);
  hlds__hlds_pred__pred_info_get_arg_types_2_p_0(STATE_VARIABLE_NewPredInfo_0_122, &OriginalArgTypes0_26);
  ...
  hlds__hlds_proc__proc_info_get_var_table_2_p_0(STATE_VARIABLE_NewProcInfo_0_121, &VarTable0_32);
  parse_tree__prog_data__tvarset_merge_renaming_4_p_0(CallerTypeVarSet_30, TypeVarSet0_24, &TypeVarSet_33, &TypeRenaming_34);
  parse_tree__prog_type_subst__apply_renaming_to_tvar_kind_map_3_p_0(TypeRenaming_34, KindMap0_25, &KindMap_35);
  parse_tree__var_table__rename_vars_in_var_table_3_p_0(TypeRenaming_34, VarTable0_32, &VarTable1_36);
  parse_tree__prog_type_subst__apply_renaming_to_types_3_p_0(TypeRenaming_34, OriginalArgTypes0_26, &OriginalArgTypes1_37);
  parse_tree__prog_type_subst__apply_renaming_to_tvars_3_p_0(TypeRenaming_34, ExistQVars0_23, &ExistQVars1_38);
  ...
  parse_tree__prog_type_subst__apply_rec_subst_to_tvars_4_p_0(KindMap_35, TypeSubn_41, ExistQVars1_38, &ExistQTypes_42);
  mercury__list__filter_map_3_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0), (MR_Word) (&transform_hlds__higher_order__make_specialized_preds_scalar_common_1[5]), (MR_Word) (&transform_hlds__higher_order__make_specialized_preds_scalar_common_2[2]), ExistQTypes_42, &ExistQVars_46);
  {
    ...
    MR_hl_field(0, Var_129, 0) = ((MR_Box) (&transform_hlds__higher_order__make_specialized_preds_scalar_common_5[1]));
    MR_hl_field(0, Var_129, 1) = ((MR_Box) (transform_hlds__higher_order__make_specialized_preds__specialize_and_add_new_proc_6_p_0_2));
    MR_hl_field(0, Var_129, 2) = ((MR_Box) ((MR_Integer) 1));
    MR_hl_field(0, Var_129, 3) = ((MR_Box) (ModuleInfo_11));
  }
  parse_tree__var_table__apply_rec_subst_to_var_table_4_p_0(Var_129, TypeSubn_41, VarTable1_36, &VarTable2_47);
  parse_tree__prog_type_subst__apply_rec_subst_to_types_3_p_0(TypeSubn_41, OriginalArgTypes1_37, &OriginalArgTypes_48);
  hlds__hlds_proc__proc_info_set_var_table_3_p_0(VarTable2_47, STATE_VARIABLE_NewProcInfo_0_121, &STATE_VARIABLE_NewProcInfo_1_130);
  Var_131 = mercury__map__init_0_f_0((MR_Word) (&transform_hlds__higher_order__make_specialized_preds_scalar_common_1[5]), (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_kind_0));
  parse_tree__prog_type__var_list_to_type_list_3_p_0(Var_131, ExtraTypeInfoTVars0_18, &ExtraTypeInfoTVarTypes0_49);
  ...
  else
  {
...

    {
      ...
      MR_hl_field(0, Var_132, 0) = ((MR_Box) (&transform_hlds__higher_order__make_specialized_preds_scalar_common_5[2]));
      MR_hl_field(0, Var_132, 1) = ((MR_Box) (transform_hlds__higher_order__make_specialized_preds__specialize_and_add_new_proc_6_p_0_3));
      MR_hl_field(0, Var_132, 2) = ((MR_Box) ((MR_Integer) 1));
      MR_hl_field(0, Var_132, 3) = ((MR_Box) (TypeSubn_41));
    }
    mercury__list__map_3_p_0((MR_Word) (&transform_hlds__higher_order__higher_order_global_info__transform_hlds__higher_order__higher_order_global_info__type_ctor_info_higher_order_arg_0), (MR_Word) (&transform_hlds__higher_order__higher_order_global_info__transform_hlds__higher_order__higher_order_global_info__type_ctor_info_higher_order_arg_0), Var_132, HOArgs0_16, &HOArgs_50);
    parse_tree__prog_type_subst__apply_rec_subst_to_types_3_p_0(TypeSubn_41, ExtraTypeInfoTVarTypes0_49, &ExtraTypeInfoTVarTypes_51);
  ...
  hlds__hlds_proc_util__proc_info_create_vars_from_types_5_p_0(ModuleInfo_11, ExtraTypeInfoTypes_54, &ExtraTypeInfoVars_55, STATE_VARIABLE_NewProcInfo_1_130, &STATE_VARIABLE_NewProcInfo_2_136);
  hlds__hlds_proc__proc_info_get_rtti_varmaps_2_p_0(STATE_VARIABLE_NewProcInfo_2_136, &RttiVarMaps0_56);
  ...
  hlds__hlds_rtti__apply_renamings_and_subst_to_rtti_varmaps_5_p_0(TypeRenaming_34, TypeSubn_41, EmptyVarRenaming_57, RttiVarMaps0_56, &RttiVarMaps1_58);
  ...
  hlds__hlds_proc__proc_info_set_rtti_varmaps_3_p_0(RttiVarMaps_65, STATE_VARIABLE_NewProcInfo_2_136, &STATE_VARIABLE_NewProcInfo_3_145);
  ...
  transform_hlds__higher_order__make_specialized_preds__f_85_110_117_115_101_100_65_114_103_115_95_95_112_114_101_100_95_95_99_111_110_115_116_114_117_99_116_95_104_105_103_104_101_114_95_111_114_100_101_114_95_116_101_114_109_115_95_95_91_52_93_95_48_13_p_0(ModuleInfo_11, HeadVars0_21, &ExtraHeadVars_68, &ExtraArgModes_69, HOArgs_50, STATE_VARIABLE_NewProcInfo_3_145, &STATE_VARIABLE_NewProcInfo_4_146, VarRenaming0_66, &Var_70, KnownVarMap0_67, &KnownVarMap_71, &ConstGoals_72);
  VersionInfoMap0_73 = transform_hlds__higher_order__higher_order_global_info__hogi_get_version_info_map_1_f_0(STATE_VARIABLE_GlobalInfo_0_124);
    ...
    CallerParentVersions_84 = (MR_Word) ((MR_Unsigned) 0U);
  {
    ...
    MR_hl_field(0, Var_147, 0) = ((MR_Box) (OrigPredProcId_76));
    MR_hl_field(0, Var_147, 1) = ((MR_Box) (ArgsDepth_74));
  }
  {
    ParentVersions_85 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(1, ParentVersions_85, 0) = ((MR_Box) (Var_147));
  ...
  transform_hlds__higher_order__higher_order_global_info__hogi_set_version_info_map_3_p_0(VersionInfoMap_87, STATE_VARIABLE_GlobalInfo_0_124, STATE_VARIABLE_GlobalInfo_125);
  ...
  Var_149 = mercury__list__f_43_43_2_f_0((MR_Word) (&transform_hlds__higher_order__make_specialized_preds_scalar_common_1[2]), ExtraHeadVars_68, HeadVars1_91);
  HeadVars_93 = mercury__list__f_43_43_2_f_0((MR_Word) (&transform_hlds__higher_order__make_specialized_preds_scalar_common_1[2]), ExtraTypeInfoVars_55, Var_149);
  Var_150 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_mode_0), ExtraArgModes_69, ArgModes1_92);
  ArgModes_94 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_mode_0), ExtraTypeInfoModes_90, Var_150);
  hlds__hlds_proc__proc_info_set_headvars_3_p_0(HeadVars_93, STATE_VARIABLE_NewProcInfo_4_146, &STATE_VARIABLE_NewProcInfo_5_151);
  hlds__hlds_proc__proc_info_set_argmodes_3_p_0(ArgModes_94, STATE_VARIABLE_NewProcInfo_5_151, &STATE_VARIABLE_NewProcInfo_6_152);
  hlds__hlds_proc__proc_info_get_goal_2_p_0(STATE_VARIABLE_NewProcInfo_6_152, &Goal6_95);
  GoalInfo6_97 = ((MR_Word) ((MR_hl_field(0, Goal6_95, 1))));
  hlds__hlds_goal__goal_to_conj_list_2_p_0(Goal6_95, &GoalList6_98);
  Var_153 = mercury__list__f_43_43_2_f_0((MR_Word) (&hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_hlds_goal_0), ConstGoals_72, GoalList6_98);
  hlds__hlds_goal__conj_list_to_goal_3_p_0(Var_153, GoalInfo6_97, &Goal_99);
  hlds__hlds_proc__proc_info_set_goal_3_p_0(Goal_99, STATE_VARIABLE_NewProcInfo_6_152, &STATE_VARIABLE_NewProcInfo_7_154);
  hlds__hlds_proc__proc_info_get_sharing_reuse_info_2_p_0(STATE_VARIABLE_NewProcInfo_7_154, &SharingReuseInfo0_100);
  Var_172 = ((MR_Word) ((MR_hl_field(0, SharingReuseInfo0_100, 0))));
  Var_173 = ((MR_Word) ((MR_hl_field(0, SharingReuseInfo0_100, 1))));
  {
    SharingReuseInfo_102 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(0, SharingReuseInfo_102, 0) = ((MR_Box) (Var_172));
    MR_hl_field(0, SharingReuseInfo_102, 1) = ((MR_Box) (Var_173));
    MR_hl_field(0, SharingReuseInfo_102, 2) = ((MR_Box) ((MR_Unsigned) 0U));
    MR_hl_field(0, SharingReuseInfo_102, 3) = ((MR_Box) ((MR_Unsigned) 0U));
  }
  hlds__hlds_proc__proc_info_set_sharing_reuse_info_3_p_0(SharingReuseInfo_102, STATE_VARIABLE_NewProcInfo_7_154, &STATE_VARIABLE_NewProcInfo_8_157);
  hlds__hlds_proc__proc_info_get_var_table_2_p_0(STATE_VARIABLE_NewProcInfo_8_157, &VarTable7_103);
  parse_tree__var_table__lookup_var_types_3_p_0(VarTable7_103, ExtraHeadVars_68, &ExtraHeadVarTypes0_104);
  transform_hlds__higher_order__higher_order_global_info__remove_const_higher_order_args_3_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0), HOArgs_50, OriginalArgTypes_48, &ModifiedOriginalArgTypes_105);
  Var_158 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0), ExtraHeadVarTypes0_104, ModifiedOriginalArgTypes_105);
  ArgTypes_106 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0), ExtraTypeInfoTypes_54, Var_158);
  hlds__hlds_pred__pred_info_set_arg_types_5_p_0(TypeVarSet_33, ExistQVars_46, ArgTypes_106, STATE_VARIABLE_NewPredInfo_0_122, &STATE_VARIABLE_NewPredInfo_1_159);
  hlds__hlds_pred__pred_info_set_typevarset_3_p_0(TypeVarSet_33, STATE_VARIABLE_NewPredInfo_1_159, &STATE_VARIABLE_NewPredInfo_2_160);
  if ((ExistQVars_46 == (MR_Word) ((MR_Unsigned) 0U)))
    STATE_VARIABLE_NewProcInfo_9_162 = STATE_VARIABLE_NewProcInfo_8_157;
  else
  {
    MR_Word OriginalHeadTypes_109;
    MR_Word ExistentialSubn_110;
    MR_Word ExtraHeadVarTypes_111;
    MR_Word ExtraHeadVarsAndTypes_112;
    MR_Word VarTable8_113;
    MR_Word Var_161;
    MR_Box conv11_VarTable8_113;

    parse_tree__var_table__lookup_var_types_3_p_0(VarTable7_103, HeadVars0_21, &OriginalHeadTypes_109);
    parse_tree__prog_type_unify__type_list_subsumes_det_3_p_0(OriginalArgTypes_48, OriginalHeadTypes_109, &ExistentialSubn_110);
    parse_tree__prog_type_subst__apply_rec_subst_to_types_3_p_0(ExistentialSubn_110, ExtraHeadVarTypes0_104, &ExtraHeadVarTypes_111);
    mercury__assoc_list__from_corresponding_lists_3_p_0((MR_Word) (&transform_hlds__higher_order__make_specialized_preds_scalar_common_1[2]), (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0), ExtraHeadVars_68, ExtraHeadVarTypes_111, &ExtraHeadVarsAndTypes_112);
    {
      Var_161 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(0, Var_161, 0) = ((MR_Box) (&transform_hlds__higher_order__make_specialized_preds_scalar_common_4[3]));
      MR_hl_field(0, Var_161, 1) = ((MR_Box) (transform_hlds__higher_order__make_specialized_preds__specialize_and_add_new_proc_6_p_0_7));
      MR_hl_field(0, Var_161, 2) = ((MR_Box) ((MR_Integer) 1));
      MR_hl_field(0, Var_161, 3) = ((MR_Box) (ModuleInfo_11));
    }
    mercury__list__foldl_4_p_0((MR_Word) (&transform_hlds__higher_order__make_specialized_preds_scalar_common_2[0]), (MR_Word) (&parse_tree__var_table__parse_tree__var_table__type_ctor_info_var_table_0), Var_161, ExtraHeadVarsAndTypes_112, ((MR_Box) (VarTable7_103)), &conv11_VarTable8_113);
    VarTable8_113 = ((MR_Word) (conv11_VarTable8_113));
    hlds__hlds_proc__proc_info_set_var_table_3_p_0(VarTable8_113, STATE_VARIABLE_NewProcInfo_8_157, &STATE_VARIABLE_NewProcInfo_9_162);
  }
  hlds__hlds_proc__proc_info_get_headvars_2_p_0(STATE_VARIABLE_NewProcInfo_9_162, &ArgVars_114);
  hlds__hlds_proc__proc_info_get_rtti_varmaps_2_p_0(STATE_VARIABLE_NewProcInfo_9_162, &NewRttiVarMaps_115);
  {
    Var_163 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(0, Var_163, 0) = ((MR_Box) (&transform_hlds__higher_order__make_specialized_preds_scalar_common_5[3]));
    MR_hl_field(0, Var_163, 1) = ((MR_Box) (transform_hlds__higher_order__make_specialized_preds__specialize_and_add_new_proc_6_p_0_8));
    MR_hl_field(0, Var_163, 2) = ((MR_Box) ((MR_Integer) 1));
    MR_hl_field(0, Var_163, 3) = ((MR_Box) (NewRttiVarMaps_115));
  }
  mercury__list__map_3_p_0((MR_Word) (&transform_hlds__higher_order__make_specialized_preds_scalar_common_1[2]), (MR_Word) (&hlds__hlds_rtti__hlds__hlds_rtti__type_ctor_info_rtti_var_info_0), Var_163, ArgVars_114, &ArgVarInfos_116);
  transform_hlds__higher_order__make_specialized_preds__find_class_context_4_p_0(ModuleInfo_11, ArgVarInfos_116, ArgModes_94, &ClassContext_117);
  hlds__hlds_pred__pred_info_set_class_context_3_p_0(ClassContext_117, STATE_VARIABLE_NewPredInfo_2_160, &STATE_VARIABLE_NewPredInfo_3_164);
  NewProcId_119 = ((MR_Integer) ((MR_hl_field(0, NewPredProcId_12, 1))));
  NewProcs_120 = mercury__map__singleton_2_f_0((MR_Word) (&hlds__pred_proc_id__hlds__pred_proc_id__type_ctor_info_proc_id_0), (MR_Word) (&hlds__hlds_proc__hlds__hlds_proc__type_ctor_info_proc_info_0), ((MR_Box) (NewProcId_119)), ((MR_Box) (STATE_VARIABLE_NewProcInfo_9_162)));
  hlds__hlds_pred__pred_info_set_proc_table_3_p_0(NewProcs_120, STATE_VARIABLE_NewPredInfo_3_164, STATE_VARIABLE_NewPredInfo_123);
}
  ...
  else
  {
    ...
    if (succeeded)
    {
      ShroudedPredProcId_46 = (MR_Word) (MR_body((MR_Word) (ConsId_37), (MR_Integer) 2));
      {
        ...
        Var_85 = hlds__pred_proc_id__unshroud_pred_proc_id_1_f_0(ShroudedPredProcId_46);
        ...
        hlds__hlds_proc__proc_info_get_argmodes_2_p_0(CalleeProcInfo_50, &CalleeArgModes_52);
    ...
    hlds__hlds_proc__proc_info_get_rtti_varmaps_2_p_0(STATE_VARIABLE_ProcInfo_1_88, &RttiVarMaps0_59);
    ...
    hlds__hlds_proc__proc_info_set_rtti_varmaps_3_p_0(RttiVarMaps_60, STATE_VARIABLE_ProcInfo_1_88, &STATE_VARIABLE_ProcInfo_2_90);
          ...
          case (MR_Integer) 2:
            {
              ...
              succeeded = hlds__mode_test__mode_is_input_2_p_0(ModuleInfo_1, Mode_40);
              if (succeeded)
              {
  ...
  MR_Word * STATE_VARIABLE_GlobalInfo_13)
{
  ...
  succeeded = mercury__map__search_3_p_0((MR_Word) (&hlds__pred_proc_id__hlds__pred_proc_id__type_ctor_info_pred_proc_id_0), (MR_Word) (&transform_hlds__higher_order__make_specialized_preds_scalar_common_1[3]), NewPredMap0_8, ((MR_Box) (CalleePPId_5)), &conv0_SpecVersions0_9);
  if (succeeded)
  {
  ...
  if (succeeded)
  {
    ...
    mercury__map__det_update_4_p_0((MR_Word) (&hlds__pred_proc_id__hlds__pred_proc_id__type_ctor_info_pred_proc_id_0), (MR_Word) (&transform_hlds__higher_order__make_specialized_preds_scalar_common_1[3]), ((MR_Box) (CalleePPId_5)), ((MR_Box) (SpecVersions_10)), NewPredMap0_8, &NewPredMap_11);
  }
  else
  {
    ...
    mercury__map__det_insert_4_p_0((MR_Word) (&hlds__pred_proc_id__hlds__pred_proc_id__type_ctor_info_pred_proc_id_0), (MR_Word) (&transform_hlds__higher_order__make_specialized_preds_scalar_common_1[3]), ((MR_Box) (CalleePPId_5)), ((MR_Box) (SpecVersions_15)), NewPredMap0_8, &NewPredMap_11);
  }
