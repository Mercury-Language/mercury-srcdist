  ...
  MR_Box * wrapper_arg_4)
{
  ...
  transform_hlds__higher_order__make_specialized_preds__IntroducedFrom__pred__specialize_and_add_new_proc__607__1_4_p_0(((MR_Word) (wrapper_arg_1)), ((MR_Word) (wrapper_arg_2)), ((MR_Word) (wrapper_arg_3)), &conv6_LambdaHeadVar__4_138);
