      ...
      case (MR_Integer) 1:
        {
          ...
          else
          {
...

            {
              ...
              MR_hl_field(0, BoundInst_33, 0) = ((MR_Box) (ConsId_103));
      ...
      case (MR_Integer) 2:
        {
          ...
          {
            BoundInst_127 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
            MR_hl_field(0, BoundInst_127, 0) = ((MR_Box) (ConsId_126));
            MR_hl_field(0, BoundInst_127, 1) = ((MR_Box) ((MR_Unsigned) 0U));
          }
          {
            MR_Word base;
            base = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
            *MaybeBoundInst_10 = base;
            MR_hl_field(1, base, 0) = ((MR_Box) (BoundInst_127));
          }
        }
        break;
      case (MR_Integer) 3:
          ...
          case (MR_Integer) 1:
            {
              ...
              Pieces_101 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), Var_67, Var_68);
              {
                ...
                MR_hl_field(0, Spec_102, 0) = ((MR_Box) ((MR_String) "predicate \140parse_tree.parse_inst_mode_name.parse_bound_inst\'/5"));
