...
static /* final */ const MR_Box parse_tree__parse_inst_mode_name_scalar_common_2[21][1] = {
  ...
  /* row   8 */
  { ((MR_Box) (MR_mkword(1, &parse_tree__parse_inst_mode_name_scalar_common_1[48]))) },
  /* row   9 */
  { ((MR_Box) (MR_mkword(3, &parse_tree__parse_inst_mode_name_scalar_common_3[1]))) },
  /* row  10 */
  { ((MR_Box) ((MR_Unsigned) 0U)) },
  /* row  11 */
  { ((MR_Box) (MR_mkword(1, &parse_tree__parse_inst_mode_name_scalar_common_1[49]))) },
  /* row  12 */
  { ((MR_Box) (MR_mkword(1, &parse_tree__parse_inst_mode_name_scalar_common_1[50]))) },
  /* row  13 */
        ...
        case (MR_Integer) 0:
          {
...

            {
              Inst_22 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(1, Inst_22, 0) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 0));
              MR_hl_field(1, Inst_22, 1) = ((MR_Box) (Var_42));
            }
          }
          break;
        case (MR_Integer) 1:
          {
...

            {
              ...
              MR_hl_field(3, Inst_22, 0) = ((MR_Box) ((MR_Unsigned) 2U));
              MR_hl_field(3, Inst_22, 1) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 0));
              MR_hl_field(3, Inst_22, 2) = ((MR_Box) (Var_44));
            }
          }
          break;
      }
          ...
          case (MR_Integer) 0:
            {
              ...
              {
                Inst_111 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(1, Inst_111, 0) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 0));
                MR_hl_field(1, Inst_111, 1) = ((MR_Box) (Var_57));
              }
            }
            break;
          case (MR_Integer) 1:
            {
...

              {
                ...
                MR_hl_field(3, Inst_111, 0) = ((MR_Box) ((MR_Unsigned) 2U));
                MR_hl_field(3, Inst_111, 1) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 0));
                MR_hl_field(3, Inst_111, 2) = ((MR_Box) (Var_59));
              }
            }
            break;
        }
