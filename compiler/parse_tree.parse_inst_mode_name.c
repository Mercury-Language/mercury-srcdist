          ...
          else
          {
            ...
            else
            {
              ...
              if ((Var_234 == (MR_Word) ((MR_Unsigned) 0U)))
              {
                ...
                {
                  Var_44 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                  MR_hl_field(MR_mktag(1), Var_44, 0) = Var_223;
                  MR_hl_field(MR_mktag(1), Var_44, 1) = Var_235;
                }
                {
                  MR_Word base;
                  base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
          ...
          else
          {
            ...
            if ((Var_224 == (MR_Word) ((MR_Unsigned) 0U)))
            {
...

              {
                ...
                MR_hl_field(MR_mktag(2), Var_39, 0) = Var_225;
              }
              {
                MR_Word base;
                base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
          ...
          else
          {
            ...
            if ((Var_226 == (MR_Word) ((MR_Unsigned) 0U)))
            {
...

              {
                Var_35 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), Var_35, 0) = ((MR_Box) ((MR_Unsigned) 0U));
                MR_hl_field(MR_mktag(3), Var_35, 1) = Var_227;
              }
              {
                MR_Word base;
                base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
            ...
            else
            {
              ...
              if ((Var_236 == (MR_Word) ((MR_Unsigned) 0U)))
              {
...

                {
                  ...
                  MR_hl_field(MR_mktag(0), Var_51, 0) = Var_229;
                  MR_hl_field(MR_mktag(0), Var_51, 1) = Var_237;
                }
                {
                  MR_Word base;
                  base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
          ...
          else
          {
            ...
            if ((Var_230 == (MR_Word) ((MR_Unsigned) 0U)))
            {
...

              {
                ...
                MR_hl_field(MR_mktag(3), Var_59, 1) = Var_231;
              }
              {
                MR_Word base;
                base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
          ...
          else
          {
            ...
            if ((Var_232 == (MR_Word) ((MR_Unsigned) 0U)))
            {
...

              {
                ...
                MR_hl_field(MR_mktag(3), Var_66, 1) = Var_233;
              }
              {
                MR_Word base;
                base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
