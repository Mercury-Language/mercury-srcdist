      ...
      case (MR_Integer) 2:
        {
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(1), Var_45, 0) = ((MR_Box) (Context_16));
                    ...
                    else
                    {
                      ...
                      if ((AllowConstrainedInstVar_8 == (MR_Word) ((MR_Unsigned) 0U)))
                      {
                        ...
                        Var_81 = mercury__set__make_singleton_set_1_f_0((MR_Word) (&parse_tree__parse_inst_mode_name_scalar_common_1[3]), ((MR_Box) (Var_82)));
                        {
                          ...
                          MR_hl_field(MR_mktag(3), Inst_122, 0) = ((MR_Box) ((MR_Unsigned) 3U));
        ...
        case (MR_Integer) 2:
          {
            ...
            }
            {
              ...
              MR_hl_field(MR_mktag(1), Var_108, 0) = ((MR_Box) (Context_13));
      ...
      else
      {
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              ...
              succeeded = ((((MR_tag((MR_Word) Inst_149)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(MR_mktag(3), Inst_149, (MR_Integer) 0)))) == (MR_Integer) 4)));
              if (succeeded)
              {
        ...
        else
        {
          ...
          else
          {
            ...
            {
              Inst_142 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(3), Inst_142, 0) = ((MR_Box) ((MR_Unsigned) 4U));
...
{
  {
        ...
        case (MR_Integer) 1:
          {
            ...
            Var_157 = mercury__cord__list_1_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_format_component_0), ContextPieces_8);
            {
              ...
              MR_hl_field(MR_mktag(3), Var_169, 0) = ((MR_Box) ((MR_Unsigned) 0U));
            ...
            {
              Var_176 = (MR_Word) MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL);
            ...
            }
            {
              ...
              MR_hl_field(MR_mktag(1), Var_174, 0) = ((MR_Box) (Context_115));
            ...
            {
              Spec_183 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
        ...
        case (MR_Integer) 2:
          {
            ...
            }
            {
              ...
              MR_hl_field(MR_mktag(1), Var_204, 0) = ((MR_Box) (Context_115));
            ...
            {
              Spec_213 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
            ...
            case (MR_Integer) 0:
              {
                ...
                }
                {
                  ...
                  MR_hl_field(MR_mktag(1), Var_71, 0) = ((MR_Box) (Context_115));
            ...
            case (MR_Integer) 1:
              {
                ...
                }
                {
                  ...
                  MR_hl_field(MR_mktag(1), Var_144, 0) = ((MR_Box) (Context_115));
                ...
                {
                  Spec_153 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
    ...
    else
    {
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(1), Var_95, 0) = ((MR_Box) (Context_12));
      ...
      case (MR_Integer) 2:
        ...
        else
        {
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(1), Var_66, 0) = ((MR_Box) (Context_151));
          ...
          case (MR_Integer) 1:
            {
              ...
              {
                Var_95 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(1), Var_95, 0) = ((MR_Box) (Context_151));
                MR_hl_field(MR_mktag(1), Var_95, 1) = ((MR_Box) (Var_96));
              }
              {
                Var_94 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              ...
              {
                Spec_132 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            succeeded = (BeforeIsArgTerms_111 != (MR_Word) ((MR_Unsigned) 0U));
            if (succeeded)
            {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          ArgModes_112 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_mode_0), ArgModes0_32, Var_50);
          {
            ...
            MR_hl_field(MR_mktag(0), FuncInst_34, 3) = (MR_Box) ((MR_Unsigned) (Detism_116));
          }
          switch (IsAny_126) {
            default: /*NOTREACHED*/ MR_assert(0);
            case (MR_Integer) 0:
              {
                ...
                {
                  Inst_113 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
                  MR_hl_field(MR_mktag(3), Inst_113, 0) = ((MR_Box) ((MR_Unsigned) 1U));
                  MR_hl_field(MR_mktag(3), Inst_113, 1) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 0));
            ...
            case (MR_Integer) 1:
              {
...

                {
                  ...
                  MR_hl_field(MR_mktag(2), Inst_113, 0) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 0));
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            succeeded = (BeforeIsArgTerms_114 != (MR_Word) ((MR_Unsigned) 0U));
            if (succeeded)
            {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          ArgModes_115 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_mode_0), ArgModes0_33, Var_52);
          {
            ...
            MR_hl_field(MR_mktag(0), FuncInstInfo_35, 3) = (MR_Box) ((MR_Unsigned) (Detism_120));
          }
          switch (IsAny_132) {
            default: /*NOTREACHED*/ MR_assert(0);
            case (MR_Integer) 0:
              {
                ...
                {
                  Inst_116 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
                  MR_hl_field(MR_mktag(3), Inst_116, 0) = ((MR_Box) ((MR_Unsigned) 1U));
                  MR_hl_field(MR_mktag(3), Inst_116, 1) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 0));
            ...
            case (MR_Integer) 1:
              {
                ...
                {
                  Inst_116 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                  MR_hl_field(MR_mktag(2), Inst_116, 0) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 0));
          ...
          {
            Mode_117 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
...
{
  {
    ...
    else
    {
      ...
      {
        DetismSpec_12 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
