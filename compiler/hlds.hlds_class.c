  ...
  MR_Word * STATE_VARIABLE_Redundant_29)
{
  ...
  else
  {
    ...
    hlds__type_util__apply_variable_renaming_to_constraint_list_3_p_0(Renaming_23, ClassAncestors_17, &RenamedAncestors_24);
    ...
    hlds__type_util__apply_subst_to_constraint_list_3_p_0(Subst_26, RenamedAncestors_24, &Ancestors_27);
