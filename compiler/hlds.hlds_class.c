...
{
  {
    ...
    else
    {
      ...
      mercury__map__from_corresponding_lists_3_p_0((MR_Word) &hlds__hlds_class_scalar_common_1[0], TypeCtorInfo_58_72, RenamedParams_36, ArgTypes_29, &Subst_37);
...
{
  {
    ...
    mercury__map__from_corresponding_lists_3_p_0((MR_Word) &hlds__hlds_class_scalar_common_1[0], TypeCtorInfo_58_71, RenamedParams_35, ArgTypes_28, &Subst_36);
...
{
  {
    ...
    TypeCtorInfo_66_66 = (MR_Word) &hlds__hlds_class__hlds__hlds_class__type_ctor_info_hlds_constraint_0;
    mercury__list__map_3_p_0((MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_constraint_0, TypeCtorInfo_66_66, (MR_Word) &hlds__hlds_class_scalar_common_2[13], ClassAncestors0_16, &ClassAncestors_17);
    ...
    else
    {
      ...
      mercury__map__from_corresponding_lists_3_p_0((MR_Word) &hlds__hlds_class_scalar_common_1[0], TypeCtorInfo_60_60, RenamedParams_25, ArgTypes_12, &Subst_26);
      check_hlds__type_util__apply_subst_to_constraint_list_3_p_0(Subst_26, RenamedAncestors_24, &Ancestors_27);
      mercury__list__foldl_4_p_0(TypeCtorInfo_66_66, (MR_Word) &hlds__hlds_class_scalar_common_2[0], (MR_Word) &hlds__hlds_class_scalar_common_2[14], Ancestors_27, ((MR_Box) (STATE_VARIABLE_Redundant_0_28)), &conv3_STATE_VARIABLE_Redundant_29);
...
{
  {
    ...
    succeeded = hlds__hlds_class__search_hlds_constraint_list_2_6_p_0(ConstraintMap_6, ConstraintType_7, GoalId_8, Count_9, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), Constraints_10);
    return succeeded;
  }
}
...
{
  {
    ...
    succeeded = hlds__hlds_class__search_hlds_constraint_list_2_6_p_0(ConstraintMap_6, ConstraintType_7, GoalId_8, Count_9, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), &ConstraintsPrime_11);
    if (succeeded)
...
{
  {
    MR_Word TypeCtorInfo_21_21 = (MR_Word) &hlds__hlds_class__hlds__hlds_class__type_ctor_info_hlds_constraint_0;
...
{
  {
    ...
    TypeCtorInfo_24_24 = (MR_Word) &hlds__hlds_class__hlds__hlds_class__type_ctor_info_hlds_constraint_0;
    TypeInfo_25_25 = (MR_Word) &hlds__hlds_class_scalar_common_2[0];
    ...
    mercury__list__foldl_4_p_0(TypeCtorInfo_24_24, (MR_Word) &hlds__hlds_class_scalar_common_2[1], Var_17, Assumed_9, ((MR_Box) (Var_18)), &conv4_Ancestors_13);
