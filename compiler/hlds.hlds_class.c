...
static const MR_PseudoTypeInfo hlds__hlds_class__hlds__hlds_class__field_types_hlds_constraint_db_0_0[4];

static const MR_ConstString hlds__hlds_class__hlds__hlds_class__field_names_hlds_constraint_db_0_0[4];

static const MR_DuFunctorDesc hlds__hlds_class__hlds__hlds_class__du_functor_desc_hlds_constraint_db_0_0;

static const MR_DuFunctorDescPtr hlds__hlds_class__hlds__hlds_class__du_stag_ordered_hlds_constraint_db_0_0[1];

static const MR_DuPtagLayout hlds__hlds_class__hlds__hlds_class__du_ptag_ordered_hlds_constraint_db_0[1];

static const MR_DuFunctorDescPtr hlds__hlds_class__hlds__hlds_class__du_name_ordered_hlds_constraint_db_0[1];

static const MR_Integer hlds__hlds_class__hlds__hlds_class__functor_number_map_hlds_constraint_db_0[1];
...
static void MR_CALL 
hlds__hlds_class__IntroducedFrom__pred__merge_hlds_constraint_dbs__576__1_3_p_0(
  MR_Word HeadVar__1_28,
  MR_Word HeadVar__2_29,
  MR_Word * HeadVar__3_30);

static void MR_CALL 
hlds__hlds_class__IntroducedFrom__pred__merge_hlds_constraint_dbs__575__1_3_p_0(
...
static MR_bool MR_CALL 
hlds__hlds_class__search_hlds_constraint_list_loop_6_p_0(
...
static void MR_CALL 
hlds__hlds_class__merge_hlds_constraint_dbs_3_p_0_2(
  MR_Box closure_arg,
  MR_Box wrapper_arg_1,
  MR_Box wrapper_arg_2,
  MR_Box * wrapper_arg_3);
...
static void MR_CALL 
hlds__hlds_class__merge_hlds_constraint_dbs_3_p_0_1(
  MR_Box closure_arg,
  MR_Box wrapper_arg_1,
  MR_Box wrapper_arg_2,
  MR_Box * wrapper_arg_3);
...
static void MR_CALL 
hlds__hlds_class__make_hlds_constraint_db_5_p_0_2(
  MR_Box closure_arg,
  MR_Box wrapper_arg_1,
  MR_Box wrapper_arg_2,
  MR_Box * wrapper_arg_3);
...
static void MR_CALL 
hlds__hlds_class__make_hlds_constraint_db_5_p_0_1(
  MR_Box closure_arg,
  MR_Box wrapper_arg_1,
  MR_Box wrapper_arg_2,
  MR_Box * wrapper_arg_3);
...
static MR_bool MR_CALL 
hlds__hlds_class____Unify____hlds_constraint_db_0_0_10001(
  MR_Box wrapper_arg_1,
  MR_Box wrapper_arg_2);

static void MR_CALL 
hlds__hlds_class____Compare____hlds_constraint_db_0_0_10001(
  MR_Box * wrapper_arg_1,
  MR_Box wrapper_arg_2,
  MR_Box wrapper_arg_3);
...
static /* final */ const MR_Box hlds__hlds_class_scalar_common_2[15][3] = {
  ...
  /* row   8 */
  {
    ...
    ((MR_Box) (hlds__hlds_class__merge_hlds_constraint_dbs_3_p_0_1)),
    ((MR_Box) ((MR_Integer) 0))
  },
  /* row   9 */
  {
    ((MR_Box) (&hlds__hlds_class_scalar_common_5[1])),
    ((MR_Box) (hlds__hlds_class__merge_hlds_constraint_dbs_3_p_0_2)),
    ((MR_Box) ((MR_Integer) 0))
  },
  /* row  10 */
  {
...
static const MR_ConstString hlds__hlds_class__hlds__hlds_class__field_names_hlds_constraint_db_0_0[4] = {
  (MR_String) "hcd_unproven",
  (MR_String) "hcd_assumed",
  (MR_String) "hcd_redundant",
  (MR_String) "hcd_ancestors"
};

static const MR_DuFunctorDesc hlds__hlds_class__hlds__hlds_class__du_functor_desc_hlds_constraint_db_0_0 = {
  (MR_String) "hlds_constraint_db",
  INT16_C(4),
  UINT16_C(0),
  MR_SECTAG_NONE,
  UINT8_C(0),
  (MR_Integer) -1,
  INT32_C(0),
  hlds__hlds_class__hlds__hlds_class__field_types_hlds_constraint_db_0_0,
  hlds__hlds_class__hlds__hlds_class__field_names_hlds_constraint_db_0_0,
  NULL,
  NULL,
  MR_FUNCTOR_SUBTYPE_NONE,
  UINT8_C(0)
...
static const MR_DuFunctorDescPtr hlds__hlds_class__hlds__hlds_class__du_stag_ordered_hlds_constraint_db_0_0[1] = { &hlds__hlds_class__hlds__hlds_class__du_functor_desc_hlds_constraint_db_0_0 };

static const MR_DuPtagLayout hlds__hlds_class__hlds__hlds_class__du_ptag_ordered_hlds_constraint_db_0[1] = {
  {
    UINT32_C(1),
    MR_SECTAG_NONE,
    hlds__hlds_class__hlds__hlds_class__du_stag_ordered_hlds_constraint_db_0_0,
    INT8_C(-1),
    UINT8_C(0),
    UINT8_C(1)
  }
...
static const MR_DuFunctorDescPtr hlds__hlds_class__hlds__hlds_class__du_name_ordered_hlds_constraint_db_0[1] = { &hlds__hlds_class__hlds__hlds_class__du_functor_desc_hlds_constraint_db_0_0 };

static const MR_Integer hlds__hlds_class__hlds__hlds_class__functor_number_map_hlds_constraint_db_0[1] = { (MR_Integer) 0 };

const MR_TypeCtorInfo_Struct hlds__hlds_class__hlds__hlds_class__type_ctor_info_hlds_constraint_db_0 = {
  (MR_Integer) 0,
  UINT8_C(18),
  INT8_C(1),
  MR_TYPECTOR_REP_DU,
  ((MR_Box) (hlds__hlds_class____Unify____hlds_constraint_db_0_0_10001)),
  ((MR_Box) (hlds__hlds_class____Compare____hlds_constraint_db_0_0_10001)),
  (MR_String) "hlds.hlds_class",
  (MR_String) "hlds_constraint_db",
  { hlds__hlds_class__hlds__hlds_class__du_name_ordered_hlds_constraint_db_0 },
  { hlds__hlds_class__hlds__hlds_class__du_ptag_ordered_hlds_constraint_db_0 },
  (MR_Integer) 1,
  UINT16_C(12),
  hlds__hlds_class__hlds__hlds_class__functor_number_map_hlds_constraint_db_0,
  ...
  MR_Word HeadVar__3_3)
{
  ...
  else
  {
    ...
    else
    {
      ...
      parse_tree__prog_data____Compare____pf_sym_name_user_arity_0_0(&SubResult2_9, ArgX2_7, ArgY2_8);
      ...
      else
      {
        ...
        if (succeeded)
          *HeadVar__1_1 = SubResult3_12;
          ...
          hlds__pred_proc_id____Compare____pred_proc_id_0_0(HeadVar__1_1, ArgX4_13, ArgY4_14);
      }
    }
  }
}
...
void MR_CALL 
hlds__hlds_class____Compare____hlds_constraint_db_0_0(
  MR_Word * HeadVar__1_1,
  MR_Word HeadVar__2_2,
  MR_Word HeadVar__3_3)
{
...
MR_bool MR_CALL 
hlds__hlds_class____Unify____hlds_constraint_db_0_0(
  MR_Word HeadVar__1_1,
  MR_Word HeadVar__2_2)
{
  MR_bool succeeded;
  ...
  MR_Word HeadVar__3_3)
{
  ...
  else
  {
    ...
    hlds__status____Compare____new_typeclass_status_0_0(&SubResult1_6, ArgX1_4, ArgY1_5);
    succeeded = (SubResult1_6 != (MR_Integer) 0);
    if (succeeded)
      *HeadVar__1_1 = SubResult1_6;
    else
  ...
  MR_Word HeadVar__2_2)
{
  ...
  else
  {
    ...
    succeeded = hlds__status____Unify____new_typeclass_status_0_0(ArgX1_3, ArgY1_4);
    if (succeeded)
    {
  ...
  MR_Box * wrapper_arg_3)
{
  ...
  hlds__hlds_class__update_ancestor_constraints_3_6_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) ((MR_hl_field(0, closure, 4)))), ((MR_Word) ((MR_hl_field(0, closure, 5)))), ((MR_Word) (wrapper_arg_1)), ((MR_Word) (wrapper_arg_2)), &conv2_STATE_VARIABLE_Ancestors_14);
  ...
  MR_Word * STATE_VARIABLE_Ancestors_14)
{
  ...
  {
    MR_Word STATE_VARIABLE_Ancestors_1_15;
    ...
    mercury__map__set_4_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_constraint_0), (MR_Word) (&hlds__hlds_class_scalar_common_1[2]), ((MR_Box) (Constraint_10)), ((MR_Box) (Descendants_9)), STATE_VARIABLE_Ancestors_0_13, &STATE_VARIABLE_Ancestors_1_15);
    ClassName_20 = ((MR_Word) ((MR_hl_field(0, Constraint_10, 0))));
    ArgTypes_21 = ((MR_Word) ((MR_hl_field(0, Constraint_10, 1))));
    ...
    Var_32 = ((MR_Word) ((MR_hl_field(0, ClassDefn_24, 1))));
    parse_tree__prog_data__tvarset_merge_renaming_4_p_0(TVarSet_8, Var_32, &Var_25, &Renaming_26);
    Var_33 = ((MR_Word) ((MR_hl_field(0, ClassDefn_24, 4))));
    parse_tree__prog_type_subst__apply_renaming_to_prog_constraints_3_p_0(Renaming_26, Var_33, &RenamedSupers_27);
    Var_34 = ((MR_Word) ((MR_hl_field(0, ClassDefn_24, 3))));
    parse_tree__prog_type_subst__apply_renaming_to_tvars_3_p_0(Renaming_26, Var_34, &RenamedParams_28);
    ...
    parse_tree__prog_type_subst__apply_subst_to_prog_constraints_3_p_0(Subst_29, RenamedSupers_27, &Supers_30);
    {
    ...
    mercury__list__foldl_4_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_constraint_0), (MR_Word) (&hlds__hlds_class_scalar_common_2[1]), Var_35, Supers_30, ((MR_Box) (STATE_VARIABLE_Ancestors_1_15)), &conv3_STATE_VARIABLE_Ancestors_14);
  ...
  MR_Box * wrapper_arg_3)
{
  ...
  hlds__hlds_class__update_ancestor_constraints_3_6_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) ((MR_hl_field(0, closure, 4)))), ((MR_Word) ((MR_hl_field(0, closure, 5)))), ((MR_Word) (wrapper_arg_1)), ((MR_Word) (wrapper_arg_2)), &conv1_STATE_VARIABLE_Ancestors_14);
...
{
  MR_Word Constraint_10;
  MR_Word ClassName_17 = ((MR_Word) ((MR_hl_field(0, HLDSConstraint_8, 1))));
  MR_Word ArgTypes_18 = ((MR_Word) ((MR_hl_field(0, HLDSConstraint_8, 2))));
  MR_Integer Arity_19;
  MR_Word ClassId_20;
  ...
  Var_29 = ((MR_Word) ((MR_hl_field(0, ClassDefn_21, 1))));
  parse_tree__prog_data__tvarset_merge_renaming_4_p_0(TVarSet_7, Var_29, &Var_22, &Renaming_23);
  Var_30 = ((MR_Word) ((MR_hl_field(0, ClassDefn_21, 4))));
  parse_tree__prog_type_subst__apply_renaming_to_prog_constraints_3_p_0(Renaming_23, Var_30, &RenamedSupers_24);
  Var_31 = ((MR_Word) ((MR_hl_field(0, ClassDefn_21, 3))));
  parse_tree__prog_type_subst__apply_renaming_to_tvars_3_p_0(Renaming_23, Var_31, &RenamedParams_25);
  ...
  parse_tree__prog_type_subst__apply_subst_to_prog_constraints_3_p_0(Subst_26, RenamedSupers_24, &Supers_27);
  {
...
{
  MR_bool succeeded;
  MR_Word ClassName_7 = ((MR_Word) ((MR_hl_field(0, Constraint_4, 1))));
  MR_Word ArgTypes_8 = ((MR_Word) ((MR_hl_field(0, Constraint_4, 2))));
  MR_Integer Arity_9;
  MR_Word ClassId_10;
...
hlds__hlds_class__update_redundant_constraints_2_5_p_0(
  ...
  MR_Word * STATE_VARIABLE_Redundant_29)
{
  MR_Word ClassName_11 = ((MR_Word) ((MR_hl_field(0, Constraint_8, 1))));
  MR_Word ArgTypes_12 = ((MR_Word) ((MR_hl_field(0, Constraint_8, 2))));
  MR_Integer Arity_13;
  MR_Word ClassId_14;
  ...
  ClassAncestors0_16 = ((MR_Word) ((MR_hl_field(0, ClassDefn_15, 6))));
  ...
  {
    MR_Word ClassTVarSet_20 = ((MR_Word) ((MR_hl_field(0, ClassDefn_15, 1))));
    MR_Word ClassParams_21 = ((MR_Word) ((MR_hl_field(0, ClassDefn_15, 3))));
    MR_Word Renaming_23;
    ...
    hlds__type_rename__apply_renaming_to_constraints_3_p_0(Renaming_23, ClassAncestors_17, &RenamedAncestors_24);
    parse_tree__prog_type_subst__apply_renaming_to_tvars_3_p_0(Renaming_23, ClassParams_21, &RenamedParams_25);
    ...
    hlds__type_rename__apply_subst_to_constraints_3_p_0(Subst_26, RenamedAncestors_24, &Ancestors_27);
...
hlds__hlds_class__init_hlds_constraint_2_p_0(
  ...
  MR_Word * HLDSConstraint_4)
{
  MR_Word ClassName_5 = ((MR_Word) ((MR_hl_field(0, Constraint_3, 0))));
  MR_Word ArgTypes_6 = ((MR_Word) ((MR_hl_field(0, Constraint_3, 1))));
  ...
  MR_Word * Constraints_10)
{
  ...
  succeeded = hlds__hlds_class__search_hlds_constraint_list_loop_6_p_0(ConstraintMap_6, ConstraintType_7, GoalId_8, Count_9, (MR_Word) ((MR_Unsigned) 0U), Constraints_10);
  return succeeded;
}
  ...
  MR_Word * Constraints_10)
{
  ...
  succeeded = hlds__hlds_class__search_hlds_constraint_list_loop_6_p_0(ConstraintMap_6, ConstraintType_7, GoalId_8, Count_9, (MR_Word) ((MR_Unsigned) 0U), &ConstraintsPrime_11);
  if (succeeded)
  ...
  MR_Word * STATE_VARIABLE_Constraints_15)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      MR_Word STATE_VARIABLE_Constraints_1_16;
      MR_Integer Var_17;
      MR_Integer Var_19;
      ...
      if (succeeded)
      {
        ...
        {
          STATE_VARIABLE_Constraints_1_16 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(1, STATE_VARIABLE_Constraints_1_16, 0) = ((MR_Box) (Constraint_13));
          MR_hl_field(1, STATE_VARIABLE_Constraints_1_16, 1) = ((MR_Box) (STATE_VARIABLE_Constraints_0_14));
        }
        // direct tailcall eliminated
        ;
        next_value_of_Count_10 = Var_17;
        next_value_of_STATE_VARIABLE_Constraints_0_14 = STATE_VARIABLE_Constraints_1_16;
  ...
  MR_Box * wrapper_arg_3)
{
  ...
  hlds__hlds_class__update_redundant_constraints_2_5_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) ((MR_hl_field(0, closure, 4)))), ((MR_Word) (wrapper_arg_1)), ((MR_Word) (wrapper_arg_2)), &conv0_STATE_VARIABLE_Redundant_29);
  ...
  MR_Box * wrapper_arg_3)
{
  ...
  hlds__hlds_class__update_constraint_map_2_4_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) (wrapper_arg_1)), ((MR_Word) (wrapper_arg_2)), &conv0_STATE_VARIABLE_ConstraintMap_9);
...
{
  MR_Word Ids_6 = ((MR_Word) ((MR_hl_field(0, HLDSConstraint_4, 0))));
  MR_Word ClassName_7 = ((MR_Word) ((MR_hl_field(0, HLDSConstraint_4, 1))));
  MR_Word ArgTypes_8 = ((MR_Word) ((MR_hl_field(0, HLDSConstraint_4, 2))));
...
hlds__hlds_class__compare_hlds_constraints_3_p_0(
  ...
  MR_Word * CmpRes_6)
{
  MR_Word ClassNameA_8 = ((MR_Word) ((MR_hl_field(0, ConstraintA_4, 1))));
  MR_Word ArgTypesA_9 = ((MR_Word) ((MR_hl_field(0, ConstraintA_4, 2))));
  MR_Word ClassNameB_11 = ((MR_Word) ((MR_hl_field(0, ConstraintB_5, 1))));
  MR_Word ArgTypesB_12 = ((MR_Word) ((MR_hl_field(0, ConstraintB_5, 2))));
  ...
  MR_Word ConstraintB_4)
{
  ...
  MR_Word ClassName_6 = ((MR_Word) ((MR_hl_field(0, ConstraintA_3, 1))));
  MR_Word ArgTypes_7 = ((MR_Word) ((MR_hl_field(0, ConstraintA_3, 2))));
  MR_Word Var_9 = ((MR_Word) ((MR_hl_field(0, ConstraintB_4, 1))));
  MR_Word Var_10 = ((MR_Word) ((MR_hl_field(0, ConstraintB_4, 2))));
...
{
  MR_Word ClassName_6 = ((MR_Word) ((MR_hl_field(0, Constraint_3, 1))));
  MR_Word ArgTypes_7 = ((MR_Word) ((MR_hl_field(0, Constraint_3, 2))));
...
hlds__hlds_class__retrieve_univ_exist_constraints_2_p_0(
  MR_Word ConstraintDb_3,
  MR_Word * UnivExistConstraints_4)
{
  MR_Word Unproven_5 = ((MR_Word) ((MR_hl_field(0, ConstraintDb_3, 0))));
  MR_Word Assumed_6 = ((MR_Word) ((MR_hl_field(0, ConstraintDb_3, 1))));
  ...
  MR_Box * wrapper_arg_3)
{
  ...
  hlds__hlds_class__IntroducedFrom__pred__merge_hlds_constraint_dbs__576__1_3_p_0(((MR_Word) (wrapper_arg_1)), ((MR_Word) (wrapper_arg_2)), &conv1_HeadVar__3_30);
  ...
  MR_Box * wrapper_arg_3)
{
  ...
  hlds__hlds_class__IntroducedFrom__pred__merge_hlds_constraint_dbs__575__1_3_p_0(((MR_Word) (wrapper_arg_1)), ((MR_Word) (wrapper_arg_2)), &conv0_HeadVar__3_24);
  *wrapper_arg_3 = ((MR_Box) (conv0_HeadVar__3_24));
}

void MR_CALL 
hlds__hlds_class__merge_hlds_constraint_dbs_3_p_0(
  MR_Word ConstraintDbA_4,
  MR_Word ConstraintDbB_5,
  MR_Word * ConstraintDb_6)
{
  MR_Word UnprovenA_7 = ((MR_Word) ((MR_hl_field(0, ConstraintDbA_4, 0))));
  MR_Word AssumedA_8 = ((MR_Word) ((MR_hl_field(0, ConstraintDbA_4, 1))));
  MR_Word RedundantA_9 = ((MR_Word) ((MR_hl_field(0, ConstraintDbA_4, 2))));
  MR_Word AncestorsA_10 = ((MR_Word) ((MR_hl_field(0, ConstraintDbA_4, 3))));
  MR_Word UnprovenB_11 = ((MR_Word) ((MR_hl_field(0, ConstraintDbB_5, 0))));
  MR_Word AssumedB_12 = ((MR_Word) ((MR_hl_field(0, ConstraintDbB_5, 1))));
  MR_Word RedundantB_13 = ((MR_Word) ((MR_hl_field(0, ConstraintDbB_5, 2))));
  MR_Word AncestorsB_14 = ((MR_Word) ((MR_hl_field(0, ConstraintDbB_5, 3))));
  MR_Word Unproven_15;
  MR_Word Assumed_16;
...
void MR_CALL 
hlds__hlds_class__make_body_hlds_constraint_db_5_p_0(
  MR_Word ClassTable_6,
  MR_Word TVarSet_7,
  MR_Word GoalId_8,
  MR_Word ProgConstraints_9,
  MR_Word * ConstraintDb_10)
{
  MR_Word UnivConstraints_11 = ((MR_Word) ((MR_hl_field(0, ProgConstraints_9, 0))));
  MR_Word ExistConstraints_12 = ((MR_Word) ((MR_hl_field(0, ProgConstraints_9, 1))));
  ...
  hlds__hlds_class__make_hlds_constraint_db_5_p_0(ClassTable_6, TVarSet_7, UnprovenConstraints_13, AssumedConstraints_14, ConstraintDb_10);
}

void MR_CALL 
hlds__hlds_class__make_head_hlds_constraint_db_4_p_0(
  MR_Word ClassTable_5,
  MR_Word TVarSet_6,
  MR_Word ProgConstraints_7,
  MR_Word * ConstraintDb_8)
{
  MR_Word UnivConstraints_9 = ((MR_Word) ((MR_hl_field(0, ProgConstraints_7, 0))));
  MR_Word ExistConstraints_10 = ((MR_Word) ((MR_hl_field(0, ProgConstraints_7, 1))));
  MR_Word GoalId_11;
  ...
  hlds__hlds_class__make_hlds_constraint_db_5_p_0(ClassTable_5, TVarSet_6, UnprovenConstraints_13, AssumedConstraints_12, ConstraintDb_8);
}
  ...
  MR_Word * HeadVar__5_5)
{
  ...
  {
    MR_Word ProgConstraint_9 = ((MR_Word) ((MR_hl_field(1, HeadVar__1_1, 0))));
    MR_Word ProgConstraints_10 = ((MR_Word) ((MR_hl_field(1, HeadVar__1_1, 1))));
    MR_Word HLDSConstraint_14;
    MR_Word HLDSConstraints_15;
    MR_Word ClassName_16 = ((MR_Word) ((MR_hl_field(0, ProgConstraint_9, 0))));
    MR_Word ArgTypes_17 = ((MR_Word) ((MR_hl_field(0, ProgConstraint_9, 1))));
    MR_Word Id_18;
    MR_Word Var_19;
    MR_Integer Var_21;
  ...
  MR_Box * wrapper_arg_3)
{
  ...
  hlds__hlds_class__update_ancestor_constraints_5_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) ((MR_hl_field(0, closure, 4)))), ((MR_Word) (wrapper_arg_1)), ((MR_Word) (wrapper_arg_2)), &conv3_STATE_VARIABLE_Ancestors_12);
...
void MR_CALL 
hlds__hlds_class__make_hlds_constraint_db_5_p_0(
  MR_Word ClassTable_6,
  MR_Word TVarSet_7,
  MR_Word Unproven_8,
  MR_Word Assumed_9,
  MR_Word * ConstraintDb_10)
{
...

  {
    ...
    MR_hl_field(0, Var_14, 1) = ((MR_Box) (hlds__hlds_class__make_hlds_constraint_db_5_p_0_1));
  ...
  Redundant_12 = ((MR_Word) (conv2_Redundant_12));
  {
    ...
    MR_hl_field(0, Var_17, 1) = ((MR_Box) (hlds__hlds_class__make_hlds_constraint_db_5_p_0_2));
  ...
  MR_Word MethodInfos_3)
{
  ...
  Var_6 = mercury__cord__init_0_f_0((MR_Word) (&hlds__pred_proc_id__hlds__pred_proc_id__type_ctor_info_pred_proc_id_0));
  hlds__hlds_class__acc_pred_proc_ids_for_methods_3_p_0(MethodInfos_3, Var_6, &PredProcIdsCord_5);
  PredProcIds_4 = mercury__cord__list_1_f_0((MR_Word) (&hlds__pred_proc_id__hlds__pred_proc_id__type_ctor_info_pred_proc_id_0), PredProcIdsCord_5);
  ...
  MR_Word * STATE_VARIABLE_PredProcIdsCord_3)
{
  while (MR_TRUE)
  {
    ...
    {
      MR_Word MethodInfo_7 = ((MR_Word) ((MR_hl_field(1, HeadVar__1_1, 0))));
      MR_Word MethodInfos_8 = ((MR_Word) ((MR_hl_field(1, HeadVar__1_1, 1))));
      MR_Word MethodPredProcId_10 = ((MR_Word) ((MR_hl_field(0, MethodInfo_7, 3))));
      MR_Word STATE_VARIABLE_PredProcIdsCord_1_13;
      MR_Word next_value_of_HeadVar__1_1;
      MR_Word next_value_of_STATE_VARIABLE_PredProcIdsCord_0_2;

      mercury__cord__snoc_3_p_0((MR_Word) (&hlds__pred_proc_id__hlds__pred_proc_id__type_ctor_info_pred_proc_id_0), ((MR_Box) (MethodPredProcId_10)), STATE_VARIABLE_PredProcIdsCord_0_2, &STATE_VARIABLE_PredProcIdsCord_1_13);
      // direct tailcall eliminated
      ;
      next_value_of_HeadVar__1_1 = MethodInfos_8;
      next_value_of_STATE_VARIABLE_PredProcIdsCord_0_2 = STATE_VARIABLE_PredProcIdsCord_1_13;
      HeadVar__1_1 = next_value_of_HeadVar__1_1;
...
{
  MR_Word InstanceTypes_5 = ((MR_Word) ((MR_hl_field(0, InstanceDefn_3, 4))));
  MR_Word InstanceConstraints_6 = ((MR_Word) ((MR_hl_field(0, InstanceDefn_3, 5))));
  MR_Word TypeVars_7;
  ...
  MR_Word * HeadVar__4_4)
{
  while (MR_TRUE)
  {
    ...
    {
      MR_Word Var_26 = ((MR_Word) ((MR_hl_field(1, HeadVar__3_3, 1))));
      MR_Box Var_27 = (MR_hl_field(1, HeadVar__3_3, 0));

      if ((HeadVar__1_1 == (MR_Word) ((MR_Unsigned) 0U)))
        *HeadVar__4_4 = (MR_Word) ((MR_Unsigned) 0U);
      else
      {
        MR_Integer Posn_10 = ((MR_Integer) ((MR_hl_field(1, HeadVar__1_1, 0))));
        MR_Word Posns_11 = ((MR_Word) ((MR_hl_field(1, HeadVar__1_1, 1))));
  ...
  MR_Box wrapper_arg_2)
{
  ...
  succeeded = hlds__hlds_class____Unify____hlds_constraint_db_0_0(((MR_Word) (wrapper_arg_1)), ((MR_Word) (wrapper_arg_2)));
  return succeeded;
}
  ...
  MR_Box wrapper_arg_3)
{
  ...
  hlds__hlds_class____Compare____hlds_constraint_db_0_0(&conv0_HeadVar__1_1, ((MR_Word) (wrapper_arg_2)), ((MR_Word) (wrapper_arg_3)));
  *wrapper_arg_1 = ((MR_Box) (conv0_HeadVar__1_1));
}
...
void mercury__hlds__hlds_class__init_type_tables(void)
{
  ...
  MR_register_type_ctor_info(&hlds__hlds_class__hlds__hlds_class__type_ctor_info_hlds_constraint_db_0);
