  ...
  MR_Word * STATE_VARIABLE_Ancestors_14)
{
  ...
  else
  {
    ...
    ClassName_20 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Constraint_10, (MR_Integer) 0))));
    ArgTypes_21 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Constraint_10, (MR_Integer) 1))));
    mercury__list__length_2_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0), ArgTypes_21, &Arity_22);
    {
      ...
      MR_hl_field(MR_mktag(0), ClassId_23, 0) = ((MR_Box) (ClassName_20));
      MR_hl_field(MR_mktag(0), ClassId_23, 1) = ((MR_Box) (Arity_22));
    }
    ...
    {
      Descendants_31 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), Descendants_31, 0) = ((MR_Box) (Constraint_10));
      MR_hl_field(MR_mktag(1), Descendants_31, 1) = ((MR_Box) (Descendants_9));
    }
    {
      Var_35 = (MR_Word) MR_new_object(MR_Word, (6 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), Var_35, 0) = ((MR_Box) (&hlds__hlds_class_scalar_common_7[0]));
      MR_hl_field(MR_mktag(0), Var_35, 1) = ((MR_Box) (hlds__hlds_class__update_ancestor_constraints_3_6_p_0_1));
      MR_hl_field(MR_mktag(0), Var_35, 2) = ((MR_Box) ((MR_Integer) 3));
      MR_hl_field(MR_mktag(0), Var_35, 3) = ((MR_Box) (ClassTable_7));
      MR_hl_field(MR_mktag(0), Var_35, 4) = ((MR_Box) (TVarSet_8));
      MR_hl_field(MR_mktag(0), Var_35, 5) = ((MR_Box) (Descendants_31));
    }
