  ...
  MR_Word * STATE_VARIABLE_PredProcIdsCord_3)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      mercury__cord__snoc_3_p_0((MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_proc_id_0), ((MR_Box) (MethodPredProcId_10)), STATE_VARIABLE_PredProcIdsCord_0_2, &STATE_VARIABLE_PredProcIdsCord_1_13);
      // direct tailcall eliminated
      ;
