...
static const MR_EnumFunctorDescPtr hlds__hlds_class__hlds__hlds_class__enum_value_ordered_maybe_bad_class_defn_0[2];
...
const MR_TypeCtorInfo_Struct hlds__hlds_class__hlds__hlds_class__type_ctor_info_maybe_bad_class_defn_0 = {
  ...
  {     hlds__hlds_class__hlds__hlds_class__enum_value_ordered_maybe_bad_class_defn_0 },
  (MR_Integer) 2,
  UINT16_C(4),
