...
static void MR_CALL 
hlds__hlds_class__IntroducedFrom__pred__merge_hlds_constraint_dbs__574__1_3_p_0(
  MR_Word HeadVar__1_28,
  MR_Word HeadVar__2_29,
  MR_Word * HeadVar__3_30);

static void MR_CALL 
hlds__hlds_class__IntroducedFrom__pred__merge_hlds_constraint_dbs__573__1_3_p_0(
  ...
  MR_Word * STATE_VARIABLE_Redundant_29)
{
  ...
  else
  {
    ...
    hlds__type_util__apply_renaming_to_constraints_3_p_0(Renaming_23, ClassAncestors_17, &RenamedAncestors_24);
    ...
    hlds__type_util__apply_subst_to_constraints_3_p_0(Subst_26, RenamedAncestors_24, &Ancestors_27);
  ...
  MR_Box * wrapper_arg_3)
{
  ...
  hlds__hlds_class__IntroducedFrom__pred__merge_hlds_constraint_dbs__574__1_3_p_0(((MR_Word) (wrapper_arg_1)), ((MR_Word) (wrapper_arg_2)), &conv1_HeadVar__3_30);
  ...
  MR_Box * wrapper_arg_3)
{
  ...
  hlds__hlds_class__IntroducedFrom__pred__merge_hlds_constraint_dbs__573__1_3_p_0(((MR_Word) (wrapper_arg_1)), ((MR_Word) (wrapper_arg_2)), &conv0_HeadVar__3_24);
