...
static /* final */ const MR_Box hlds__hlds_class_scalar_common_1[13][2] = {
  ...
  /* row 6 */
  {
    ...
    ((MR_Box) (&hlds__hlds_class_scalar_common_1[5]))
  },
  /* row 7 */
  {
...
static /* final */ const MR_Box hlds__hlds_class_scalar_common_2[15][3] = {
  ...
  /* row 3 */
  {
    ((MR_Box) (&mercury__tree234__tree234__type_ctor_info_tree234_2)),
    ((MR_Box) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_class_id_0)),
    ((MR_Box) (&hlds__hlds_class_scalar_common_1[4]))
  },
  /* row 4 */
  {
    ((MR_Box) (&mercury__tree234__tree234__type_ctor_info_tree234_2)),
    ...
    else
    {
      ...
      else
      {
        ...
        else
        {
          ...
          mercury__builtin__compare_3_p_0((MR_Word) (&hlds__hlds_class_scalar_common_1[10]), &SubResult3_12, ((MR_Box) (ArgX3_10)), ((MR_Box) (ArgY3_11)));
          ...
          else
          {
            ...
            else
            {
              ...
              mercury__builtin__compare_3_p_0((MR_Word) (&hlds__hlds_class_scalar_common_1[12]), &SubResult5_18, ((MR_Box) (ArgX5_16)), ((MR_Box) (ArgY5_17)));
              ...
              else
              {
                ...
                else
                {
                  ...
                  else
                  {
                    ...
                    mercury__builtin__compare_3_p_0((MR_Word) (&hlds__hlds_class_scalar_common_1[5]), &SubResult8_27, ((MR_Box) (ArgX8_25)), ((MR_Box) (ArgY8_26)));
...
{
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          TypeInfo_27_27 = (MR_Word) (&hlds__hlds_class_scalar_common_1[10]);
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              TypeInfo_29_29 = (MR_Word) (&hlds__hlds_class_scalar_common_1[12]);
              ...
              if (succeeded)
              {
                ...
                if (succeeded)
                {
                  ...
                  if (succeeded)
                  {
                    TypeInfo_32_32 = (MR_Word) (&hlds__hlds_class_scalar_common_1[5]);
...
{
  {
    ...
    else
    {
      ...
      mercury__builtin__compare_3_p_0((MR_Word) (&hlds__hlds_class_scalar_common_1[11]), &SubResult1_6, ((MR_Box) (ArgX1_4)), ((MR_Box) (ArgY1_5)));
      succeeded = (SubResult1_6 != (MR_Integer) 0);
      if (succeeded)
        *HeadVar__1_1 = SubResult1_6;
      else
      {
        mercury__builtin__compare_3_p_0((MR_Word) (&hlds__hlds_class_scalar_common_1[11]), HeadVar__1_1, ((MR_Box) (ArgX2_7)), ((MR_Box) (ArgY2_8)));
      }
    }
  }
}
...
{
  {
    ...
    else
    {
      ...
      succeeded = mercury__builtin__unify_2_p_0((MR_Word) (&hlds__hlds_class_scalar_common_1[11]), ((MR_Box) (ArgX1_3)), ((MR_Box) (ArgY1_4)));
      if (succeeded)
      {
        TypeInfo_10_10 = (MR_Word) (&hlds__hlds_class_scalar_common_1[11]);
...
{
  {
    ...
    mercury__builtin__compare_3_p_0((MR_Word) (&hlds__hlds_class_scalar_common_1[10]), HeadVar__1_1, ((MR_Box) (Cast_HeadVar1_4)), ((MR_Box) (Cast_HeadVar2_5)));
  }
}
...
{
  {
    ...
    succeeded = mercury__builtin__unify_2_p_0((MR_Word) (&hlds__hlds_class_scalar_common_1[10]), ((MR_Box) (Cast_HeadVar1_3)), ((MR_Box) (Cast_HeadVar2_4)));
    return succeeded;
  }
}
...
{
  {
    ...
    mercury__builtin__compare_3_p_0((MR_Word) (&hlds__hlds_class_scalar_common_1[5]), HeadVar__1_1, ((MR_Box) (Cast_HeadVar1_4)), ((MR_Box) (Cast_HeadVar2_5)));
  }
}
...
{
  {
    ...
    succeeded = mercury__builtin__unify_2_p_0((MR_Word) (&hlds__hlds_class_scalar_common_1[5]), ((MR_Box) (Cast_HeadVar1_3)), ((MR_Box) (Cast_HeadVar2_4)));
    return succeeded;
  }
}
...
{
  {
    ...
    else
    {
      ...
      else
      {
        ...
        mercury__builtin__compare_3_p_0((MR_Word) (&hlds__hlds_class_scalar_common_1[8]), &SubResult2_9, ((MR_Box) (ArgX2_7)), ((MR_Box) (ArgY2_8)));
        succeeded = (SubResult2_9 != (MR_Integer) 0);
        if (succeeded)
          *HeadVar__1_1 = SubResult2_9;
        else
...
{
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        TypeInfo_14_14 = (MR_Word) (&hlds__hlds_class_scalar_common_1[8]);
