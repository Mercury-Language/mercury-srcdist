...
{
  {
    ...
    parse_tree__prog_type_subst__apply_subst_to_prog_constraint_list_3_p_0(Subst_36, RenamedSupers_34, &Supers_37);
    {
      ...
      MR_hl_field(MR_mktag(1), Descendants_38, 1) = ((MR_Box) ((MR_Integer) 0));
    }
    {
...
{
  {
    ...
    if ((ClassAncestors_17 == (MR_Word) ((MR_Integer) 0)))
...
{
  {
    ...
    succeeded = hlds__hlds_class__search_hlds_constraint_list_2_6_p_0(ConstraintMap_6, ConstraintType_7, GoalId_8, Count_9, (MR_Word) ((MR_Integer) 0), Constraints_10);
    return succeeded;
  }
}
...
{
  {
    ...
    succeeded = hlds__hlds_class__search_hlds_constraint_list_2_6_p_0(ConstraintMap_6, ConstraintType_7, GoalId_8, Count_9, (MR_Word) ((MR_Integer) 0), &ConstraintsPrime_11);
    if (succeeded)
