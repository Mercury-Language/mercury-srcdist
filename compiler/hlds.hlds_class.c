  ...
  MR_Word * STATE_VARIABLE_Ancestors_14)
{
  ...
  else
  {
    ...
    {
      ClassId_31 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
    ...
    {
      Descendants_39 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
