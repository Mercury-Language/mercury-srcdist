...
{
  {
    ...
    Var_2 = mercury__map__init_0_f_0((MR_Word) (&transform_hlds__term_constr_main_types_scalar_common_1[0]), (MR_Word) (&transform_hlds__term_constr_main_types_scalar_common_1[1]));
    {
      ...
      MR_hl_field(MR_mktag(0), HeadVar__1_1, 4) = ((MR_Box) ((MR_Integer) 0));
      MR_hl_field(MR_mktag(0), HeadVar__1_1, 5) = ((MR_Box) ((MR_Integer) 0));
      MR_hl_field(MR_mktag(0), HeadVar__1_1, 6) = ((MR_Box) ((MR_Integer) 0));
      MR_hl_field(MR_mktag(0), HeadVar__1_1, 7) = ((MR_Box) ((MR_Integer) 0));
      MR_hl_field(MR_mktag(0), HeadVar__1_1, 8) = ((MR_Box) ((MR_Integer) 0));
    }
    return HeadVar__1_1;
  }
}
