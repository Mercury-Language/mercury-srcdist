  ...
  MR_Word HeadVar__2_2)
{
  ...
  else
  {
    ...
    if (succeeded)
    {
      TypeInfo__24_24 = (MR_Word) (&transform_hlds__term_constr_main_types_scalar_common_1[3]);
      succeeded = mercury__builtin__unify_2_p_0(TypeInfo__24_24, ((MR_Box) (ArgX2_5)), ((MR_Box) (ArgY2_6)));
      if (succeeded)
      {
        TypeInfo__25_25 = (MR_Word) (&transform_hlds__term_constr_main_types_scalar_common_1[5]);
        succeeded = mercury__builtin__unify_2_p_0(TypeInfo__25_25, ((MR_Box) (ArgX3_7)), ((MR_Box) (ArgY3_8)));
        if (succeeded)
        {
          TypeInfo__26_26 = (MR_Word) (&transform_hlds__term_constr_main_types_scalar_common_1[5]);
          succeeded = mercury__builtin__unify_2_p_0(TypeInfo__26_26, ((MR_Box) (ArgX4_9)), ((MR_Box) (ArgY4_10)));
          if (succeeded)
          {
            TypeInfo__27_27 = (MR_Word) (&transform_hlds__term_constr_main_types_scalar_common_1[6]);
            succeeded = mercury__builtin__unify_2_p_0(TypeInfo__27_27, ((MR_Box) (ArgX5_11)), ((MR_Box) (ArgY5_12)));
            if (succeeded)
            {
              TypeInfo__28_28 = (MR_Word) (&transform_hlds__term_constr_main_types_scalar_common_1[6]);
              succeeded = mercury__builtin__unify_2_p_0(TypeInfo__28_28, ((MR_Box) (ArgX6_13)), ((MR_Box) (ArgY6_14)));
              if (succeeded)
              {
                TypeInfo__29_29 = (MR_Word) (&transform_hlds__term_constr_main_types_scalar_common_1[7]);
                succeeded = mercury__builtin__unify_2_p_0(TypeInfo__29_29, ((MR_Box) (ArgX7_15)), ((MR_Box) (ArgY7_16)));
                if (succeeded)
                {
                  TypeInfo__30_30 = (MR_Word) (&transform_hlds__term_constr_main_types_scalar_common_1[8]);
                  succeeded = mercury__builtin__unify_2_p_0(TypeInfo__30_30, ((MR_Box) (ArgX8_17)), ((MR_Box) (ArgY8_18)));
                  if (succeeded)
                  {
                    TypeInfo__31_31 = (MR_Word) (&transform_hlds__term_constr_main_types_scalar_common_1[9]);
