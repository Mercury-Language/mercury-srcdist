  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_23)
{
  ...
  else
  {
    ...
    hlds__quantification__requantify_proc_general_3_p_0((MR_Integer) 1, STATE_VARIABLE_ProcInfo_4_27, &STATE_VARIABLE_ProcInfo_5_29);
    ...
    case (MR_Integer) 2:
      {
        ...
        if (succeeded)
        {
          ...
          hlds__quantification__implicitly_quantify_goal_general_9_p_0((MR_Integer) 1, RequantifyVars_53, &Var_54, Goal1_52, Goal_10, STATE_VARIABLE_VarTable_1_84, STATE_VARIABLE_VarTable_77, STATE_VARIABLE_RttiVarMaps_0_78, STATE_VARIABLE_RttiVarMaps_79);
        }
        else
        {
          *Goal_10 = Goal0_9;
  ...
  MR_Word * STATE_VARIABLE_ProcInfo_32)
{
  ...
  hlds__quantification__requantify_proc_general_3_p_0((MR_Integer) 1, STATE_VARIABLE_ProcInfo_4_51, STATE_VARIABLE_ProcInfo_32);
}
