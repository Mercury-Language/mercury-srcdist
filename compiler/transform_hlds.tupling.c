...
MR_decl_label10(transform_hlds__tupling__prepare_proc_for_counting_5_0, 2,3,4,5,6,7,8,9,10,12)
MR_decl_label8(transform_hlds__tupling__prepare_proc_for_counting_5_0, 13,15,16,17,18,20,21,22)
...
MR_decl_static(transform_hlds__tupling__IntroducedFrom__pred__count_load_stores_in_goal__1062__1_3_0)
MR_decl_static(transform_hlds__tupling__IntroducedFrom__pred__extract_tupled_args_from_list__1883__1_3_0)
...
MR_def_label(transform_hlds__tupling__should_use_tupling_scheme_3_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_float_to_word((MR_word_to_float(MR_sv(2)) + MR_word_to_float(MR_sv(3))));
	MR_r3 = MR_float_to_word((MR_word_to_float(MR_sv(4)) + MR_word_to_float(MR_sv(1))));
...
MR_def_label(transform_hlds__tupling__should_use_tupling_scheme_3_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_word_to_float(MR_r1) >= MR_word_to_float(MR_sv(4)));
	MR_decr_sp_and_return(5);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_thread_engine_base
...
MR_BEGIN_MODULE(transform_hlds__tupling_module20)
	...
	MR_init_label10(transform_hlds__tupling__prepare_proc_for_counting_5_0,2,3,4,5,6,7,8,9,10,12)
	MR_init_label8(transform_hlds__tupling__prepare_proc_for_counting_5_0,13,15,16,17,18,20,21,22)
MR_BEGIN_CODE
...
MR_def_label(transform_hlds__tupling__prepare_proc_for_counting_5_0,10)
	...
	MR_tfield(0, MR_tempr1, 2) = ((MR_Integer) MR_sv(4) | ((MR_Integer) MR_sv(10) << (MR_Integer) 1));
	MR_tfield(0, MR_tempr1, 3) = MR_r1;
	MR_sv(4) = MR_tempr1;
	MR_r1 = MR_tempr2;
	MR_r2 = MR_tempr3;
...
MR_def_label(transform_hlds__tupling__cls_require_var_in_reg_with_cost_4_0,6)
	...
	MR_tfield(0, MR_r2, 2) = MR_float_to_word((MR_word_to_float(MR_sv(5)) + MR_word_to_float(MR_r1)));
...
MR_def_label(transform_hlds__tupling__get_disjunct_relative_frequency_4_0,2)
	...
	MR_tfield(1, MR_tempr2, 1) = (MR_Word) MR_TAG_COMMON(2,9,1);
...
MR_def_label(transform_hlds__tupling__cls_require_in_reg_4_0,20)
	...
	MR_tfield(0, MR_r2, 2) = MR_float_to_word((MR_word_to_float(MR_sv(4)) + MR_word_to_float(MR_sv(8))));
	MR_tfield(0, MR_r2, 3) = MR_sv(5);
	MR_r1 = MR_r2;
	MR_decr_sp_and_return(9);
...
MR_def_label(transform_hlds__tupling__cls_require_in_reg_4_0,24)
	...
	MR_tfield(0, MR_r2, 0) = MR_r1;
	MR_tfield(0, MR_r2, 1) = MR_sv(3);
	MR_tfield(0, MR_r2, 2) = MR_float_to_word(((MR_word_to_float(MR_sv(4)) + MR_word_to_float(MR_sv(7))) + MR_word_to_float(MR_sv(8))));
	MR_tfield(0, MR_r2, 3) = MR_sv(5);
	MR_r1 = MR_r2;
	MR_decr_sp_and_return(9);
...
MR_def_label(transform_hlds__tupling__get_ite_relative_frequencies_6_0,12)
	...
	MR_r1 = MR_sv(1);
	MR_sv(1) = MR_tfield(0, MR_r2, 1);
	MR_sv(3) = ((MR_Integer) MR_r1 + (MR_Integer) MR_sv(1));
...
MR_def_label(transform_hlds__tupling__count_load_stores_in_goal_4_0,31)
	...
	MR_tfield(0, MR_tempr1, 1) = (MR_Word) MR_ENTRY_AP(transform_hlds__tupling__IntroducedFrom__pred__count_load_stores_in_goal__1062__1_3_0);
	MR_tfield(0, MR_tempr1, 2) = (MR_Integer) 1;
	MR_tfield(0, MR_tempr1, 3) = MR_r1;
...
MR_def_label(transform_hlds__tupling__count_load_stores_for_scc_2_10_0,26)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(9) = MR_float_to_word((MR_word_to_float(MR_sv(8)) + (MR_word_to_float(MR_r1) * MR_word_to_float(MR_sv(9)))));
	MR_r1 = MR_sv(7);
	MR_np_call_localret_ent(fn__float__float_1_0,
...
MR_def_label(transform_hlds__tupling__count_load_stores_for_scc_2_10_0,27)
	...
	MR_tempr1 = MR_r1;
	MR_r1 = MR_sv(9);
	MR_r2 = MR_float_to_word((MR_word_to_float(MR_sv(10)) + (MR_word_to_float(MR_tempr1) * MR_word_to_float(MR_sv(6)))));
...
MR_def_label(transform_hlds__tupling__cls_require_flushed_with_cost_4_0,6)
	...
	MR_tfield(0, MR_r2, 3) = MR_float_to_word((MR_word_to_float(MR_sv(6)) + MR_word_to_float(MR_r1)));
	MR_r1 = MR_r2;
	MR_decr_sp_and_return(8);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
...
MR_def_static(transform_hlds__tupling__extract_tupled_args_from_list_4_0)
	...
	MR_tfield(0, MR_tempr1, 1) = (MR_Word) MR_ENTRY_AP(transform_hlds__tupling__IntroducedFrom__pred__extract_tupled_args_from_list__1883__1_3_0);
	MR_tfield(0, MR_tempr1, 2) = (MR_Integer) 1;
	MR_tfield(0, MR_tempr1, 3) = MR_r1;
	MR_sv(2) = MR_r1;
	MR_sv(1) = MR_r2;
...
MR_BEGIN_MODULE(transform_hlds__tupling_module87)
	MR_init_entry1(transform_hlds__tupling__IntroducedFrom__pred__count_load_stores_in_goal__1062__1_3_0);
	MR_INIT_PROC_LAYOUT_ADDR(mercury__transform_hlds__tupling__IntroducedFrom__pred__count_load_stores_in_goal__1062__1_3_0);
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'IntroducedFrom__pred__count_load_stores_in_goal__1062__1'/3 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(transform_hlds__tupling__IntroducedFrom__pred__count_load_stores_in_goal__1062__1_3_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tempr1 = MR_r1;
...
MR_BEGIN_MODULE(transform_hlds__tupling_module88)
	MR_init_entry1(transform_hlds__tupling__IntroducedFrom__pred__extract_tupled_args_from_list__1883__1_3_0);
	MR_INIT_PROC_LAYOUT_ADDR(mercury__transform_hlds__tupling__IntroducedFrom__pred__extract_tupled_args_from_list__1883__1_3_0);
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'IntroducedFrom__pred__extract_tupled_args_from_list__1883__1'/3 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(transform_hlds__tupling__IntroducedFrom__pred__extract_tupled_args_from_list__1883__1_3_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tempr1 = MR_r1;
