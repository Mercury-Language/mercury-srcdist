  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_33)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_16, (MR_Integer) 387, &OptNoReturnCalls_18);
  {
  ...
  MR_Word * STATE_VARIABLE_TransformMap_34)
{
  ...
  (env).transform_hlds__tupling__maybe_tuple_scc_11_p_0_env_0__SCC_16 = SCC_16;
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_20, (MR_Integer) 76, &VeryVerbose_21);
  ...
  MR_Box * wrapper_arg_3)
{
  ...
  succeeded = transform_hlds__tupling__candidate_headvars_of_proc_2_5_f_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 4)))), ((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 5)))), ((MR_Word) (wrapper_arg_1)), ((MR_Word) (wrapper_arg_2)), &conv0_HeadVar__6_6);
  if (succeeded)
  {
