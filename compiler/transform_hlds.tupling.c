...
MR_decl_static(transform_hlds__tupling__IntroducedFrom__pred__extract_tupled_args_from_list__1878__1_3_0)
...
MR_def_static(transform_hlds__tupling__extract_tupled_args_from_list_4_0)
	...
	MR_tfield(0, MR_tempr1, 1) = (MR_Word) MR_ENTRY_AP(transform_hlds__tupling__IntroducedFrom__pred__extract_tupled_args_from_list__1878__1_3_0);
	MR_tfield(0, MR_tempr1, 2) = (MR_Integer) 1;
	MR_tfield(0, MR_tempr1, 3) = MR_r1;
	MR_sv(2) = MR_r1;
	MR_sv(1) = MR_r2;
...
MR_BEGIN_MODULE(transform_hlds__tupling_module88)
	MR_init_entry1(transform_hlds__tupling__IntroducedFrom__pred__extract_tupled_args_from_list__1878__1_3_0);
	MR_INIT_PROC_LAYOUT_ADDR(mercury__transform_hlds__tupling__IntroducedFrom__pred__extract_tupled_args_from_list__1878__1_3_0);
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'IntroducedFrom__pred__extract_tupled_args_from_list__1878__1'/3 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(transform_hlds__tupling__IntroducedFrom__pred__extract_tupled_args_from_list__1878__1_3_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tempr1 = MR_r1;
