      ...
      case (MR_Integer) 0:
        {
          ...
          // direct tailcall eliminated
          next_value_of_Goal_5 = SubGoal_188;
          next_value_of_STATE_VARIABLE_CountState_0_113 = STATE_VARIABLE_CountState_133_133;
  ...
  MR_Word * STATE_VARIABLE_CountState_4)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      next_value_of_STATE_VARIABLE_CountState_0_3 = STATE_VARIABLE_CountState_29_29;
      HeadVar__1_1 = next_value_of_HeadVar__1_1;
  ...
  MR_Word * STATE_VARIABLE_CountState_4)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      next_value_of_STATE_VARIABLE_CountState_0_3 = STATE_VARIABLE_CountState_26_26;
      HeadVar__1_1 = next_value_of_HeadVar__1_1;
      STATE_VARIABLE_CountState_0_3 = next_value_of_STATE_VARIABLE_CountState_0_3;
      continue;
    }
