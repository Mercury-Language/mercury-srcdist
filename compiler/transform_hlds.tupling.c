  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_23)
{
  ...
  else
  {
    ...
    hlds__hlds_pred__proc_info_get_var_table_3_p_0(STATE_VARIABLE_ModuleInfo_0_22, STATE_VARIABLE_ProcInfo_24_24, &VarTable0_17);
  ...
  MR_Box * wrapper_arg_2)
{
  ...
  transform_hlds__tupling__IntroducedFrom__pred__extract_tupled_args_from_list__1917__1_3_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Integer) (wrapper_arg_1)), &conv0_HeadVar__3_12);
