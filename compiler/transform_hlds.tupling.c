...
static void MR_CALL 
transform_hlds__tupling__IntroducedFrom__pred__extract_tupled_args_from_list__1930__1_3_p_0(
  MR_Word ArgList_5,
...
{
  {
    ...
    transform_hlds__tupling__IntroducedFrom__pred__extract_tupled_args_from_list__1930__1_3_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Integer) (wrapper_arg_1)), &conv0_HeadVar__3_12);
...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(3), Transform_39, 0) = ((MR_Box) ((MR_Unsigned) 1U));
    ...
    parse_tree__pred_name__make_pred_name_4_p_0(PredModule_33, PredName_34, Transform_39, &AuxPredSymName_40);
    {
