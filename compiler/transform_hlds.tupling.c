...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_16, (MR_Integer) 358, &OptNoReturnCalls_18);
...
{
  {
    ...
    (env).transform_hlds__tupling__maybe_tuple_scc_10_p_0_env_0__SCC_14 = SCC_14;
    {
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals_18, (MR_Integer) 67, &VeryVerbose_19);
