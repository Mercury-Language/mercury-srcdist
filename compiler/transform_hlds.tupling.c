  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_33)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_16, (MR_Integer) 388, &OptNoReturnCalls_18);
  {
  ...
  MR_Word * STATE_VARIABLE_TransformMap_34)
{
  ...
  (env).transform_hlds__tupling__maybe_tuple_scc_11_p_0_env_0__SCC_16 = SCC_16;
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_20, (MR_Integer) 77, &VeryVerbose_21);
