...
MR_decl_label10(transform_hlds__tupling__fix_calls_in_goal_9_0, 24,23,32,34,36,37,38,41,39,48)
MR_decl_label10(transform_hlds__tupling__fix_calls_in_goal_9_0, 49,51,52,28,27,55,58,54,63,62)
MR_decl_label2(transform_hlds__tupling__fix_calls_in_goal_9_0, 158,157)
...
MR_BEGIN_MODULE(transform_hlds__tupling_module49)
	...
	MR_init_label10(transform_hlds__tupling__fix_calls_in_goal_9_0,24,23,32,34,36,37,38,41,39,48)
	MR_init_label10(transform_hlds__tupling__fix_calls_in_goal_9_0,49,51,52,28,27,55,58,54,63,62)
	MR_init_label2(transform_hlds__tupling__fix_calls_in_goal_9_0,158,157)
MR_BEGIN_CODE
...
MR_def_static(transform_hlds__tupling__fix_calls_in_goal_9_0)
	...
	if (((((MR_tag(MR_tempr1) == MR_mktag((MR_Integer) 3)) && ((MR_Integer) MR_tfield(3, MR_tempr1, 0) == (MR_Integer) 0)) || (MR_tag(MR_tempr1) == MR_mktag((MR_Integer) 2))) || (MR_tag(MR_tempr1) == MR_mktag((MR_Integer) 0)))) {
		MR_GOTO_LAB(transform_hlds__tupling__fix_calls_in_goal_9_0_i158);
	}
...
MR_def_label(transform_hlds__tupling__fix_calls_in_goal_9_0,62)
	...
	MR_r3 = (MR_Word) MR_string_const("shorthand", 9);
	MR_np_tailcall_ent(require__unexpected_3_0);
MR_def_label(transform_hlds__tupling__fix_calls_in_goal_9_0,158)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_proceed();
