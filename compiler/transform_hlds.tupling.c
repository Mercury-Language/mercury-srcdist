    ...
    if (transform_hlds__tupling__succeeded)
      {
...

        {
          ...
          MR_hl_field(MR_mktag(1), transform_hlds__tupling__RevFirstDisjGoalPath_13, 1) = ((MR_Box) (MR_mkword(MR_mktag(2), &transform_hlds__tupling_scalar_common_3[5])));
        }
        {
...
{
  {
    ...
    {
      mercury__map__lookup_3_p_0((MR_Word) &mdbcomp__trace_counts__mdbcomp__trace_counts__type_ctor_info_path_port_0, (MR_Word) &mdbcomp__trace_counts__mdbcomp__trace_counts__type_ctor_info_line_no_and_count_0, transform_hlds__tupling__ProcCounts_3, ((MR_Box) (&transform_hlds__tupling_scalar_common_3[4])), &transform_hlds__tupling__conv0_ContextCount_5);
    }
