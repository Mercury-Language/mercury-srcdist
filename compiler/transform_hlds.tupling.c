    ...
    else
    {
      ...
      else
      {
        ...
        else
        {
          ...
          mercury__builtin__compare_3_p_0((MR_Word) (&transform_hlds__tupling_scalar_common_1[13]), &SubResult3_12, ((MR_Box) (ArgX3_10)), ((MR_Box) (ArgY3_11)));
          succeeded = (SubResult3_12 != (MR_Integer) 0);
          if (succeeded)
            *HeadVar__1_1 = SubResult3_12;
          else
    ...
    else
    {
      ...
      else
      {
        ...
        else
        {
          ...
          mercury__builtin__compare_3_p_0((MR_Word) (&transform_hlds__tupling_scalar_common_1[11]), &SubResult2_15, ((MR_Box) (Var_24)), ((MR_Box) (ArgY2_14)));
          succeeded = (SubResult2_15 != (MR_Integer) 0);
          if (succeeded)
            *HeadVar__1_1 = SubResult2_15;
          else
          {
            mercury__builtin__compare_3_p_0((MR_Word) (&transform_hlds__tupling_scalar_common_1[12]), HeadVar__1_1, ((MR_Box) (Var_23)), ((MR_Box) (ArgY3_17)));
          }
        }
      }
    }
...
{
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          TypeInfo_14_14 = (MR_Word) (&transform_hlds__tupling_scalar_common_1[11]);
          succeeded = mercury__builtin__unify_2_p_0(TypeInfo_14_14, ((MR_Box) (ArgX2_7)), ((MR_Box) (ArgY2_8)));
          if (succeeded)
          {
            TypeInfo_15_15 = (MR_Word) (&transform_hlds__tupling_scalar_common_1[12]);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_16, (MR_Integer) 343, &OptNoReturnCalls_18);
...
{
  {
    ...
    {
      Origin_43 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
...
{
  {
    ...
    libs__globals__lookup_string_option_3_p_0(Globals_7, (MR_Integer) 423, &TraceCountsFile_8);
...
{
  {
    ...
    libs__globals__lookup_int_option_3_p_0(Globals_6, (MR_Integer) 400, &CellVarLoadCost_7);
    libs__globals__lookup_int_option_3_p_0(Globals_6, (MR_Integer) 399, &CellVarStoreCost_8);
    libs__globals__lookup_int_option_3_p_0(Globals_6, (MR_Integer) 402, &FieldVarLoadCost_9);
    libs__globals__lookup_int_option_3_p_0(Globals_6, (MR_Integer) 401, &FieldVarStoreCost_10);
    libs__globals__lookup_int_option_3_p_0(Globals_6, (MR_Integer) 424, &CostsRatio_11);
    libs__globals__lookup_int_option_3_p_0(Globals_6, (MR_Integer) 425, &MinArgsToTuple_12);
