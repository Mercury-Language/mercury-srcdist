  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_34)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_16, (MR_Integer) 360, &OptNoReturnCalls_18);
  ...
  MR_Word * HeadVar__8_8)
{
  ...
  else
  {
    ...
    hlds__vartypes__lookup_var_types_3_p_0(VarTypes_33, FieldVars_21, &TupleArgTypes_34);
    {
  ...
  MR_Word * STATE_VARIABLE_TransformMap_33)
{
  ...
  (env).transform_hlds__tupling__maybe_tuple_scc_10_p_0_env_0__SCC_14 = SCC_14;
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_18, (MR_Integer) 71, &VeryVerbose_19);
