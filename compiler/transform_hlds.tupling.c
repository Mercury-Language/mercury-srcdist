  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_43)
{
  ...
  mercury__term__context_line_2_p_0(Context_36, &LineNum_37);
  {
  ...
  parse_tree__pred_name__make_transformed_pred_sym_name_4_p_0(PredModule_32, PredName_33, Transform_38, &AuxPredSymName_39);
  {
    ...
    MR_hl_field(MR_mktag(3), Var_46, 1) = ((MR_Box) (ProcId_11));
    MR_hl_field(MR_mktag(3), Var_46, 2) = ((MR_Box) (LineNum_37));
    MR_hl_field(MR_mktag(3), Var_46, 3) = ((MR_Box) (SeqNum_14));
  }
  {
    Origin_40 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(MR_mktag(3), Origin_40, 0) = ((MR_Box) ((MR_Unsigned) 8U));
