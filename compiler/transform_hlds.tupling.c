...
static void MR_CALL 
transform_hlds__tupling__IntroducedFrom__pred__extract_tupled_args_from_list__1929__1_3_p_0(
  MR_Word ArgList_5,
  MR_Integer HeadVar__2_11,
  MR_Word * HeadVar__3_12);

static MR_bool MR_CALL 
transform_hlds__tupling__IntroducedFrom__func__make_transformed_proc__713__1_3_f_0(
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_24)
{
  ...
  else
  {
    ...
    check_hlds__recompute_instmap_deltas__recompute_instmap_delta_proc_5_p_0((MR_Integer) 0, STATE_VARIABLE_ProcInfo_32_32, &STATE_VARIABLE_ProcInfo_34_34, STATE_VARIABLE_ModuleInfo_0_23, &STATE_VARIABLE_ModuleInfo_35_35);
  ...
  MR_Box * wrapper_arg_2)
{
  ...
  transform_hlds__tupling__IntroducedFrom__pred__extract_tupled_args_from_list__1929__1_3_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Integer) (wrapper_arg_1)), &conv0_HeadVar__3_12);
          ...
          case (MR_Integer) 0:
            {
              ...
              hlds__arg_info__compute_in_and_out_vars_sep_regs_9_p_0(ModuleInfo_45, VarTypes_47, ArgVars_172, ArgModes_42, ArgRegTypes_48, &InputArgsR_49, &InputArgsF_50, &OutputArgsR_51, &OutputArgsF_52);
          ...
          case (MR_Integer) 1:
            {
              ...
              hlds__hlds_pred__proc_info_get_vartypes_2_p_0(CallingProcInfo_81, &VarTypes_179);
              hlds__arg_info__partition_proc_call_args_7_p_0(ProcInfo_178, VarTypes_179, ModuleInfo_177, ArgVars_174, &InputArgVarSet_82, &OutputArgVarSet_83, &Var_84);
  ...
  MR_Box wrapper_arg_1)
{
  ...
  conv0_HeadVar__3_67 = transform_hlds__tupling__IntroducedFrom__func__add_transformed_proc__683__1_2_f_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) (wrapper_arg_1)));
  ...
  MR_Word * HeadVar__8_8)
{
  ...
  else
  {
    ...
    hlds__hlds_pred__proc_info_get_headvars_2_p_0(STATE_VARIABLE_ProcInfo_54_54, &HeadVars_36);
    {
      ...
      MR_hl_field(MR_mktag(0), Var_56, 0) = ((MR_Box) (&transform_hlds__tupling_scalar_common_10[3]));
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_44)
{
  ...
  hlds__hlds_pred__proc_info_get_vartypes_2_p_0(ProcInfo_13, &VarTypes_24);
  ...
  hlds__hlds_pred__proc_info_get_varset_2_p_0(ProcInfo_13, &VarSet_27);
  ...
  hlds__hlds_pred__define_new_pred_20_p_0(AuxPredSymName_40, Origin_41, TVarSet_23, VarTypes_24, ClassContext_25, RttiVarMaps_26, InstVarSet_28, InitialAuxInstMap_22, VarSet_27, VarNameRemap_32, Markers_29, (MR_Integer) 1, HasParallelConj_31, AuxPredProcId_15, AuxHeadVars_18, &_ExtraArgs_42, Goal_19, CallAux_16, STATE_VARIABLE_ModuleInfo_0_43, STATE_VARIABLE_ModuleInfo_44);
}
  ...
  MR_Box * wrapper_arg_3)
{
  ...
  succeeded = transform_hlds__tupling__IntroducedFrom__func__make_transformed_proc__713__1_3_f_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) (wrapper_arg_1)), ((MR_Word) (wrapper_arg_2)), &conv0_LambdaHeadVar__3_39);
  if (succeeded)
  {
  ...
  MR_Word * STATE_VARIABLE_ProcInfo_35)
{
  ...
  backend_libs__interval__record_decisions_in_goal_10_p_0(Goal0_17, &Goal1_21, VarSet0_19, &VarSet1_22, VarTypes0_18, &VarTypes1_23, Var_50, &RenameMapA_24, InsertMap_8, (MR_Word) (MR_mkword(MR_mktag(1), &transform_hlds__tupling_scalar_common_3[3])));
  ...
  MR_Box * wrapper_arg_2)
{
  ...
  succeeded = transform_hlds__tupling__IntroducedFrom__func__add_tupling_proposal__591__1_3_f_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))), ((MR_Word) (wrapper_arg_1)), &conv0_LambdaHeadVar__2_31);
  if (succeeded)
  {
  ...
  MR_Word * STATE_VARIABLE_TuplingScheme_28)
{
  ...
  hlds__hlds_pred__proc_info_get_headvars_2_p_0(ProcInfo_15, &HeadVars_17);
  {
    ...
    MR_hl_field(MR_mktag(0), Var_29, 0) = ((MR_Box) (&transform_hlds__tupling_scalar_common_6[2]));
  ...
  else
  {
    ...
    {
      TuplingProposal_23 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
