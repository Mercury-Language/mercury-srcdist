...
MR_decl_label10(transform_hlds__tupling__add_transformed_proc_8_0, 34,4,5,6,7,8,11,13,14,16)
MR_decl_label6(transform_hlds__tupling__add_transformed_proc_8_0, 17,18,19,20,21,23)
...
MR_BEGIN_MODULE(transform_hlds__tupling_module15)
	...
	MR_init_label10(transform_hlds__tupling__add_transformed_proc_8_0,34,4,5,6,7,8,11,13,14,16)
	MR_init_label6(transform_hlds__tupling__add_transformed_proc_8_0,17,18,19,20,21,23)
MR_BEGIN_CODE
...
MR_def_static(transform_hlds__tupling__add_transformed_proc_8_0)
	...
	if (MR_LTAGS_TESTR(MR_r2,0,0)) {
		MR_GOTO_LAB(transform_hlds__tupling__add_transformed_proc_8_0_i34);
	}
	MR_r1 = MR_r3;
	MR_r2 = MR_r4;
	MR_r3 = MR_r5;
	MR_proceed();
MR_def_label(transform_hlds__tupling__add_transformed_proc_8_0,34)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(14);
...
void mercury__transform_hlds__tupling__write_out_proc_statics(FILE *deep_fp, FILE *procrep_fp)
{
	MR_write_out_module_proc_reps_start(procrep_fp, &mercury_data__module_layout__transform_hlds__tupling);
