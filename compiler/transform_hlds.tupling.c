...
MR_decl_label8(transform_hlds__tupling__build_interval_info_3_0, 11,12,15,16,18,19,20,21)
MR_decl_label4(transform_hlds__tupling__build_interval_info_3_0, 22,23,24,26)
...
MR_decl_label8(transform_hlds__tupling__fix_calls_in_goal_9_0, 47,49,50,52,53,28,73,108)
MR_decl_label8(transform_hlds__tupling__fix_calls_in_goal_9_0, 7,6,10,109,14,113,18,19)
MR_decl_label8(transform_hlds__tupling__fix_calls_in_goal_9_0, 20,111,24,112,56,59,114,64)
MR_decl_label4(transform_hlds__tupling__fix_calls_in_goal_9_0, 110,67,105,106)
...
MR_decl_static(transform_hlds__tupling__IntroducedFrom__pred__extract_tupled_args_from_list__1865__1_3_0)
...
MR_BEGIN_MODULE(transform_hlds__tupling_module16)
	...
	MR_init_label8(transform_hlds__tupling__build_interval_info_3_0,11,12,15,16,18,19,20,21)
	MR_init_label4(transform_hlds__tupling__build_interval_info_3_0,22,23,24,26)
MR_BEGIN_CODE
...
MR_def_static(transform_hlds__tupling__extract_tupled_args_from_list_4_0)
	...
	MR_tfield(0, MR_tempr1, 1) = (MR_Word) MR_ENTRY_AP(transform_hlds__tupling__IntroducedFrom__pred__extract_tupled_args_from_list__1865__1_3_0);
	MR_tfield(0, MR_tempr1, 2) = (MR_Integer) 1;
	MR_tempr2 = MR_r1;
	MR_tfield(0, MR_tempr1, 3) = MR_tempr2;
	MR_sv(1) = MR_tempr2;
...
MR_BEGIN_MODULE(transform_hlds__tupling_module52)
	...
	MR_init_label8(transform_hlds__tupling__fix_calls_in_goal_9_0,47,49,50,52,53,28,73,108)
	MR_init_label8(transform_hlds__tupling__fix_calls_in_goal_9_0,7,6,10,109,14,113,18,19)
	MR_init_label8(transform_hlds__tupling__fix_calls_in_goal_9_0,20,111,24,112,56,59,114,64)
	MR_init_label4(transform_hlds__tupling__fix_calls_in_goal_9_0,110,67,105,106)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(transform_hlds__tupling_module91)
	MR_init_entry1(transform_hlds__tupling__IntroducedFrom__pred__extract_tupled_args_from_list__1865__1_3_0);
MR_BEGIN_CODE
	...
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(transform_hlds__tupling__IntroducedFrom__pred__extract_tupled_args_from_list__1865__1_3_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tempr1 = MR_r1;
