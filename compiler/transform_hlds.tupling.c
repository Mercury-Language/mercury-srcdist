  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_22)
{
  ...
  if (succeeded)
  {
    Var_24 = ((MR_Word) ((MR_hl_field(MR_mktag(2), Origin_11, (MR_Integer) 0))));
  ...
  MR_Box * wrapper_arg_2)
{
  ...
  transform_hlds__tupling__IntroducedFrom__pred__extract_tupled_args_from_list__1916__1_3_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Integer) (wrapper_arg_1)), &conv0_HeadVar__3_12);
