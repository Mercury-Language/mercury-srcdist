  ...
  MR_Word Args_10)
{
  ...
  else
  {
    ...
    if (succeeded)
    {
      MR_Word StdOutStream_48;

      mercury__io__stdout_stream_3_p_0(&StdOutStream_48);
      succeeded = mercury__builtin__semidet_succeed_0_p_0();
      if (succeeded)
        libs__print_help__options_help_new_3_p_0(StdOutStream_48);
      else
        libs__options__compare_old_vs_new_3_p_0(StdOutStream_48);
    }
    else
    {
      ...
      if (succeeded)
      {
        ...
        mercury__io__write_string_4_p_0(StdOutStream_49, (MR_String) "Mercury Compiler, version ");
        mercury__io__write_string_4_p_0(StdOutStream_49, LibraryVersion_24);
        succeeded = (strcmp(PackageVersion_25, (MR_String) "") == 0);
        if (succeeded)
          mercury__io__nl_3_p_0(StdOutStream_49);
        else
        {
          mercury__io__write_string_4_p_0(StdOutStream_49, (MR_String) " (");
          mercury__io__write_string_4_p_0(StdOutStream_49, PackageVersion_25);
          mercury__io__write_string_4_p_0(StdOutStream_49, (MR_String) ")\n");
        }
        libs__handle_options__write_copyright_notice_3_p_0(StdOutStream_49);
      }
      else
      {
        MR_Word OpMode_26;
  ...
  if (!((ArgResult_9 == (MR_Word) ((MR_Unsigned) 0U))))
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        succeeded = mercury__builtin__semidet_succeed_0_p_0();
        if (succeeded)
          libs__print_help__options_help_new_3_p_0(StdOutStream_58);
        else
          libs__options__compare_old_vs_new_3_p_0(StdOutStream_58);
      }
      else
      {
        ...
        if (succeeded)
        {
          ...
          mercury__io__write_string_4_p_0(StdOutStream_59, (MR_String) "Mercury Compiler, version ");
          mercury__io__write_string_4_p_0(StdOutStream_59, LibraryVersion_34);
          succeeded = (strcmp(PackageVersion_35, (MR_String) "") == 0);
          if (succeeded)
            mercury__io__nl_3_p_0(StdOutStream_59);
          else
          {
            mercury__io__write_string_4_p_0(StdOutStream_59, (MR_String) " (");
            mercury__io__write_string_4_p_0(StdOutStream_59, PackageVersion_35);
            mercury__io__write_string_4_p_0(StdOutStream_59, (MR_String) ")\n");
          }
          libs__handle_options__write_copyright_notice_3_p_0(StdOutStream_59);
        }
        else
        {
          MR_Word OpMode_36;
