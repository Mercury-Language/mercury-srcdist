...
{
  {
    ...
    *MaybeTimestampMap_27 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Baggage1_43, (MR_Integer) 4))));
    Var_187 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Baggage1_43, (MR_Integer) 6))));
    STATE_VARIABLE_Specs_90_90 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_error_spec_0), Var_187, STATE_VARIABLE_Specs_0_78);
        ...
        switch (MR_unmkbody(OpModeAugment_15)) {
          ...
          case (MR_Integer) 1:
            if ((MaybeTransOptDeps_17 == (MR_Word) ((MR_Unsigned) 0U)))
            {
              ...
              libs__globals__lookup_bool_option_3_p_0(Globals_14, (MR_Integer) 18, &WarnNoTransOptDeps_32);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 700, &Version_24);
    libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 699, &Help_25);
...
{
  {
    ...
    else
    {
      ...
      libs__globals__lookup_accumulating_option_3_p_0(ArgsGlobals_22, (MR_Integer) 681, &OptionSearchDirectories_23);
      libs__globals__lookup_accumulating_option_3_p_0(ArgsGlobals_22, (MR_Integer) 679, &OptionsFiles_24);
      ...
      libs__globals__lookup_bool_option_3_p_0(ArgsGlobals_22, (MR_Integer) 32, &WarnUndef_28);
      switch (WarnUndef_28) {
        default: /*NOTREACHED*/ MR_assert(0);
        case (MR_Integer) 0:
              ...
              case (MR_Integer) 0:
                {
                  ...
                  if ((FlagsSpecs_37 == (MR_Word) ((MR_Unsigned) 0U)))
                  {
                    ...
                    libs__globals__lookup_maybe_string_option_3_p_0(FlagsArgsGlobals_38, (MR_Integer) 680, &MaybeConfigFile_41);
...
{
  {
          ...
          case (MR_Integer) 1:
            {
              ...
              libs__globals__lookup_bool_option_3_p_0(Globals_12, (MR_Integer) 664, &InvokedByMake_34);
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_12, (MR_Integer) 76, &Statistics_41);
              ...
              {
                {
                  ...
                  libs__globals__lookup_bool_option_3_p_0(Globals_21, (MR_Integer) 4, &HaltSyntax_72);
...
{
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        Var_114 = mdbcomp__builtin_modules__mercury_profiling_builtin_module_0_f_0();
        succeeded = mdbcomp__sym_name____Unify____sym_name_0_0(ModuleName_24, Var_114);
        if (succeeded)
      ...
      if (succeeded)
      {
        ...
        libs__globals__set_option_4_p_0((MR_Integer) 308, (MR_Word) (MR_mkword(MR_mktag(1), &top_level__mercury_compile_main_scalar_common_2[2])), Globals_23, &GlobalsNoTrace0_40);
...
{
  {
    ...
    switch (DisableSmart_16) {
      ...
      case (MR_Integer) 1:
        {
          libs__globals__set_option_4_p_0((MR_Integer) 142, (MR_Word) (MR_mkword(MR_mktag(1), &top_level__mercury_compile_main_scalar_common_2[2])), Globals0_9, Globals_10);
      ...
      case (MR_Integer) 1:
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals0_8, (MR_Integer) 143, &GenerateVersionNumbers_50);
    ...
    {
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_15, (MR_Integer) 4, &HaltSyntax_84);
      ...
      else
      {
        ...
        *ModuleName_18 = ((MR_Word) ((MR_hl_field(MR_mktag(0), *ParseTreeSrc_22, (MR_Integer) 0))));
        ...
        switch (DisableSmart_88) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 1:
            libs__globals__set_option_4_p_0((MR_Integer) 142, (MR_Word) (MR_mkword(MR_mktag(1), &top_level__mercury_compile_main_scalar_common_2[2])), Globals0_15, Globals_16);
            break;
          case (MR_Integer) 0:
            *Globals_16 = Globals0_15;
            break;
      ...
      case (MR_Integer) 1:
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_6, (MR_Integer) 68, &VerboseErrors_10);
