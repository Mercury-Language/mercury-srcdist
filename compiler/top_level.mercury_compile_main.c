        ...
        case (MR_Integer) 4:
          {
            ...
            libs__globals__lookup_bool_option_3_p_0(Globals0_18, (MR_Integer) 689, &ReportCmdLineArgsDotErr_30);
    ...
    case (MR_Integer) 0:
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals0_11, (MR_Integer) 787, &GenerateVersionNumbers_18);
    ...
    case (MR_Integer) 1:
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals0_11, (MR_Integer) 787, &GenerateVersionNumbers_63);
  ...
  MR_Word * STATE_VARIABLE_HaveParseTreeMaps_42)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(*Globals_13, (MR_Integer) 685, &Stats_40);
