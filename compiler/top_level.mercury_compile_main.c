            ...
            case (MR_Integer) 5:
              {
                ...
                libs__globals__lookup_bool_option_3_p_0(Globals_25, (MR_Integer) 12, &UnusedArgs_39);
        ...
        switch (MR_unmkbody(OpModeAugment_15)) {
          ...
          case (MR_Integer) 1:
            if ((MaybeTransOptDeps_17 == (MR_Word) ((MR_Unsigned) 0U)))
            {
              ...
              libs__globals__lookup_bool_option_3_p_0(Globals_14, (MR_Integer) 17, &WarnNoTransOptDeps_32);
...
{
  {
    ...
    else
    {
      ...
      libs__globals__lookup_bool_option_3_p_0(ArgsGlobals_22, (MR_Integer) 31, &WarnUndef_28);
      switch (WarnUndef_28) {
        default: /*NOTREACHED*/ MR_assert(0);
        case (MR_Integer) 0:
