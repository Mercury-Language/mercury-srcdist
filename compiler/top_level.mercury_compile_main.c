  ...
  MR_Word Args_10)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_9, (MR_Integer) 740, &Version_20);
  libs__globals__lookup_bool_option_3_p_0(Globals_9, (MR_Integer) 739, &Help_21);
...
#undef MR_PROC_LABEL
  ...
  if (!((ArgResult_9 == (MR_Word) ((MR_Unsigned) 0U))))
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_10, (MR_Integer) 740, &Version_30);
    libs__globals__lookup_bool_option_3_p_0(Globals_10, (MR_Integer) 739, &Help_31);
        ...
        case (MR_Integer) 0:
          {
            ...
            libs__globals__set_option_4_p_0((MR_Integer) 736, (MR_Word) (MR_mkword(1, &top_level__mercury_compile_main_scalar_common_3[0])), Globals_17, &MakeGlobals_26);
    ...
    case (MR_Integer) 3:
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_17, (MR_Integer) 736, &FileNamesFromStdin_31);
    ...
    case (MR_Integer) 15:
      {
        ...
        libs__globals__lookup_string_option_3_p_0(Globals_7, (MR_Integer) 741, &TargetArch_30);
