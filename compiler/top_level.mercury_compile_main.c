  ...
  MR_Word * STATE_VARIABLE_HaveReadModuleMaps_46)
{
    ...
    case (MR_Integer) 0:
      {
        ...
        TimestampNewExt_103 = (MR_Word) (MR_mkword(3, &top_level__mercury_compile_main_scalar_common_1[15]));
      }
      break;
    case (MR_Integer) 1:
      {
        TimestampOtherExt_102 = (MR_Word) (((MR_Box) ((MR_String) ".cs_date")));
        TimestampNewExt_103 = (MR_Word) (MR_mkword(3, &top_level__mercury_compile_main_scalar_common_1[16]));
      }
      break;
    case (MR_Integer) 2:
      {
        TimestampOtherExt_102 = (MR_Word) (((MR_Box) ((MR_String) ".java_date")));
        TimestampNewExt_103 = (MR_Word) (MR_mkword(3, &top_level__mercury_compile_main_scalar_common_1[17]));
      }
      break;
  }
  {
    ...
    MR_hl_field(0, FindTimestampFiles_41, 4) = ((MR_Box) (TimestampOtherExt_102));
    MR_hl_field(0, FindTimestampFiles_41, 5) = ((MR_Box) (TimestampNewExt_103));
  }
    ...
    GlobalsToUse_44 = Globals_19;
  {
    ...
    MR_hl_field(0, Var_105, 0) = ((MR_Box) (&top_level__mercury_compile_main_scalar_common_9[0]));
