...
top_level__mercury_compile_main__IntroducedFrom__pred__do_process_compiler_arg_make_interface__1035__1_1_p_0(
      ...
      if (succeeded)
      {
        ...
        switch (Target_87) {
          ...
          case (MR_Integer) 1:
            ...
            break;
          case (MR_Integer) 2:
            backend_libs__create_launchers__create_java_shell_script_6_p_0(ProgressStream_14, Globals_16, FirstModule_37, &Succeeded_88);
            break;
        }
  ...
  MR_Box wrapper_arg_1)
{
  ...
  succeeded = top_level__mercury_compile_main__IntroducedFrom__pred__do_process_compiler_arg_make_interface__1035__1_1_p_0(((MR_Word) (wrapper_arg_1)));
  return succeeded;
}
