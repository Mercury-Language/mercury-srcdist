...
top_level__mercury_compile_main__IntroducedFrom__pred__do_process_compiler_arg_make_interface__1153__1_1_p_0(
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      else
      {
        ...
        parse_tree__write_error_spec__write_oom_error_specs_5_p_0(ErrorStream_2, Globals_3, SetupSpecs_80);
      ...
      case (MR_Integer) 1:
        {
          ...
          else
          {
            ...
            parse_tree__write_error_spec__write_oom_error_specs_5_p_0(ErrorStream_19, Globals_21, SetupSpecs_86);
  ...
  MR_Box wrapper_arg_1)
{
  ...
  succeeded = top_level__mercury_compile_main__IntroducedFrom__pred__do_process_compiler_arg_make_interface__1153__1_1_p_0(((MR_Word) (wrapper_arg_1)));
  return succeeded;
}
          ...
          case (MR_Integer) 0:
            {
              ...
              else
              {
                ...
                Specs_51 = mercury__one_or_more__one_or_more_to_list_1_f_1((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_error_spec_0), OoMSpecs_30);
