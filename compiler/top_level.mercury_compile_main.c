...
top_level__mercury_compile_main__IntroducedFrom__pred__do_process_compiler_arg_make_interface__1160__1_1_p_0(
...
{
  MR_bool succeeded;
  MR_Word STATE_VARIABLE_MaybeWrittenSpecs_3_62;
  ...
  switch (MR_tag((MR_Word) OpModeArgs_19)) {
    ...
    case (MR_Integer) 0:
      switch (MR_unmkbody(OpModeArgs_19)) {
        ...
        case (MR_Integer) 0:
          {
            MR_Word STATE_VARIABLE_MaybeWrittenSpecs_4_65;
            MR_Word DepErrSpecs_87;
            MR_Word DepWarnSpecs_88;
            MR_Word _DepsMap_32;

            parse_tree__write_deps_file__generate_and_write_d_file_gendep_8_p_0(ProgressStream_16, Globals0_18, FileOrModule_22, &_DepsMap_32, &DepErrSpecs_87, &DepWarnSpecs_88);
            parse_tree__error_util__add_to_be_written_err_specs_3_p_0(DepErrSpecs_87, STATE_VARIABLE_MaybeWrittenSpecs_0_52, &STATE_VARIABLE_MaybeWrittenSpecs_4_65);
            parse_tree__error_util__add_to_be_written_warn_specs_3_p_0(DepWarnSpecs_88, STATE_VARIABLE_MaybeWrittenSpecs_4_65, &STATE_VARIABLE_MaybeWrittenSpecs_3_62);
        ...
        case (MR_Integer) 1:
          {
            ...
            MR_Word STATE_VARIABLE_MaybeWrittenSpecs_6_72;
            ...
            if (((MR_tag((MR_Word) HaveReadSrc_34)) == (MR_Integer) 0))
            {
              ...
              Var_129 = ((MR_Word) ((MR_hl_field(0, Errors_36, 0))));
              Var_127 = ((MR_Word) ((MR_hl_field(0, Errors_36, 2))));
              succeeded = mercury__set__is_non_empty_1_p_0((MR_Word) (&parse_tree__parse_error__parse_tree__parse_error__type_ctor_info_fatal_read_module_error_0), Var_129);
              if (!(succeeded))
              {
                MR_Word HaltSyntax_111;
                MR_Word Var_114;

                succeeded = mercury__set__is_non_empty_1_p_0((MR_Word) (&parse_tree__parse_error__parse_tree__parse_error__type_ctor_info_nonfatal_read_module_error_0), Var_127);
                if (succeeded)
                {
                  Var_114 = (MR_Integer) 253;
                  libs__globals__lookup_bool_option_3_p_0(Globals_33, Var_114, &HaltSyntax_111);
                  succeeded = (HaltSyntax_111 == (MR_Integer) 1);
                }
              }
              if (!(succeeded))
              {
            ...
            parse_tree__error_util__add_to_be_written_err_specs_3_p_0(ErrSpecs_43, STATE_VARIABLE_MaybeWrittenSpecs_0_52, &STATE_VARIABLE_MaybeWrittenSpecs_6_72);
            parse_tree__error_util__add_to_be_written_warn_specs_3_p_0(WarnSpecs_44, STATE_VARIABLE_MaybeWrittenSpecs_6_72, &STATE_VARIABLE_MaybeWrittenSpecs_3_62);
            *ModulesToLink_23 = (MR_Word) ((MR_Unsigned) 0U);
            *ExtraObjFiles_24 = (MR_Word) ((MR_Unsigned) 0U);
          }
          break;
    ...
    case (MR_Integer) 1:
      {
        ...
        if (succeeded)
        {
          Var_60 = (MR_Word) (DepErrSpecs_30);
          Var_59 = parse_tree__error_util__contains_errors_2_f_0(Globals0_18, Var_60);
          succeeded = (Var_59 == (MR_Integer) 0);
        }
        if (succeeded)
          top_level__mercury_compile_main__deps_make_ints_9_p_0(ProgressStream_16, Globals0_18, DepsMap_29, STATE_VARIABLE_HaveParseTreeMaps_0_50, STATE_VARIABLE_HaveParseTreeMaps_51, STATE_VARIABLE_MaybeWrittenSpecs_2_58, &STATE_VARIABLE_MaybeWrittenSpecs_3_62);
        else
        {
          STATE_VARIABLE_MaybeWrittenSpecs_3_62 = STATE_VARIABLE_MaybeWrittenSpecs_2_58;
          *STATE_VARIABLE_HaveParseTreeMaps_51 = STATE_VARIABLE_HaveParseTreeMaps_0_50;
        }
        *ModulesToLink_23 = (MR_Word) ((MR_Unsigned) 0U);
        *ExtraObjFiles_24 = (MR_Word) ((MR_Unsigned) 0U);
    ...
    case (MR_Integer) 2:
      {
        ...
        top_level__mercury_compile_main__do_process_compiler_arg_make_interface_10_p_0(ProgressStream_16, Globals0_18, InterfaceFile_45, FileOrModule_22, STATE_VARIABLE_HaveParseTreeMaps_0_50, STATE_VARIABLE_HaveParseTreeMaps_51, STATE_VARIABLE_MaybeWrittenSpecs_0_52, &STATE_VARIABLE_MaybeWrittenSpecs_3_62);
        *ModulesToLink_23 = (MR_Word) ((MR_Unsigned) 0U);
        *ExtraObjFiles_24 = (MR_Word) ((MR_Unsigned) 0U);
      }
      break;
    case (MR_Integer) 3:
      {
        ...
        MR_Word STATE_VARIABLE_HaveParseTreeMaps_4_77;
        MR_Word Globals_91;
        MR_Word Smart0_94;
        MR_Word DisableSmart_95;
        MR_Word Var_79;

        libs__globals__lookup_bool_option_3_p_0(Globals0_18, (MR_Integer) 654, &Smart0_94);
        libs__globals__io_get_disable_smart_recompilation_3_p_0(&DisableSmart_95);
        switch (DisableSmart_95) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 1:
            {
              libs__globals__set_option_4_p_0((MR_Integer) 654, (MR_Word) (MR_mkword(1, &top_level__mercury_compile_main_scalar_common_3[0])), Globals0_18, &Globals_91);
              WhatToRecompile_47 = (MR_Word) ((MR_Unsigned) 0U);
              STATE_VARIABLE_HaveParseTreeMaps_4_77 = STATE_VARIABLE_HaveParseTreeMaps_0_50;
            }
            break;
          case (MR_Integer) 0:
            {
              Globals_91 = Globals0_18;
              switch (Smart0_94) {
                default: /*NOTREACHED*/ MR_assert(0);
                case (MR_Integer) 0:
                  {
                ...
                case (MR_Integer) 1:
                  {
                    MR_Word ModuleName_97;

                    if (((MR_tag((MR_Word) FileOrModule_22)) == (MR_Integer) 0))
                    {
                      MR_String FileName_98 = ((MR_String) ((MR_hl_field(0, FileOrModule_22, 0))));

                      parse_tree__file_names__file_name_to_module_name_2_p_0(FileName_98, &ModuleName_97);
                    }
                    else
                      ModuleName_97 = ((MR_Word) ((MR_hl_field(1, FileOrModule_22, 0))));
                    recompilation__check__what_file_components_should_we_recompile_8_p_0(ProgressStream_16, Globals_91, ModuleName_97, &WhatToRecompile_47, STATE_VARIABLE_HaveParseTreeMaps_0_50, &STATE_VARIABLE_HaveParseTreeMaps_4_77);
                  }
                  break;
              }
            }
        ...
        if (succeeded)
        {
          Var_79 = ((MR_Word) ((MR_hl_field(1, WhatToRecompile_47, 0))));
        ...
        if (succeeded)
        {
          *ModulesToLink_23 = (MR_Word) ((MR_Unsigned) 0U);
          *ExtraObjFiles_24 = (MR_Word) ((MR_Unsigned) 0U);
          STATE_VARIABLE_MaybeWrittenSpecs_3_62 = STATE_VARIABLE_MaybeWrittenSpecs_0_52;
          *STATE_VARIABLE_HaveParseTreeMaps_51 = STATE_VARIABLE_HaveParseTreeMaps_4_77;
        }
        else
        {
          MR_Word ModuleMaybeWrittenSpecs0_48;
          MR_Word ModuleMaybeWrittenSpecs_49;
          MR_Word ToBeWrittenA_104;
          MR_Word AlreadyWrittenA_105;
          MR_Word ToBeWrittenB_106;
          MR_Word AlreadyWrittenB_107;
          MR_Word ToBeWritten_108;
          MR_Word AlreadyWritten_109;

          top_level__mercury_compile_main__read_augment_and_process_module_15_p_0(ProgressStream_16, ErrorStream_17, Globals_91, OpModeAugment_46, InvokedByMmcMake_20, OptionArgs_21, FileOrModule_22, WhatToRecompile_47, ModulesToLink_23, ExtraObjFiles_24, &ModuleMaybeWrittenSpecs0_48, STATE_VARIABLE_HaveParseTreeMaps_4_77, STATE_VARIABLE_HaveParseTreeMaps_51);
          parse_tree__write_error_spec__write_not_yet_written_specs_6_p_0(ErrorStream_17, Globals_91, ModuleMaybeWrittenSpecs0_48, &ModuleMaybeWrittenSpecs_49);
          ToBeWrittenA_104 = ((MR_Word) ((MR_hl_field(0, ModuleMaybeWrittenSpecs_49, 0))));
          AlreadyWrittenA_105 = ((MR_Word) ((MR_hl_field(0, ModuleMaybeWrittenSpecs_49, 1))));
          ToBeWrittenB_106 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_MaybeWrittenSpecs_0_52, 0))));
          AlreadyWrittenB_107 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_MaybeWrittenSpecs_0_52, 1))));
          ToBeWritten_108 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_diag_spec_0), ToBeWrittenA_104, ToBeWrittenB_106);
          AlreadyWritten_109 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_diag_spec_0), AlreadyWrittenA_105, AlreadyWrittenB_107);
          {
            STATE_VARIABLE_MaybeWrittenSpecs_3_62 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
            MR_hl_field(0, STATE_VARIABLE_MaybeWrittenSpecs_3_62, 0) = ((MR_Box) (ToBeWritten_108));
            MR_hl_field(0, STATE_VARIABLE_MaybeWrittenSpecs_3_62, 1) = ((MR_Box) (AlreadyWritten_109));
          }
        }
      }
      break;
  }
  parse_tree__write_error_spec__write_not_yet_written_specs_6_p_0(ErrorStream_17, Globals0_18, STATE_VARIABLE_MaybeWrittenSpecs_3_62, STATE_VARIABLE_MaybeWrittenSpecs_53);
  ...
  MR_Box wrapper_arg_1)
{
  ...
  succeeded = top_level__mercury_compile_main__IntroducedFrom__pred__do_process_compiler_arg_make_interface__1160__1_1_p_0(((MR_Word) (wrapper_arg_1)));
  return succeeded;
}
    ...
    case (MR_Integer) 1:
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals0_12, (MR_Integer) 788, &GenerateVersionNumbers_76);
