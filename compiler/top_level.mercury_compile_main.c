...
top_level__mercury_compile_main__IntroducedFrom__pred__read_augment_and_process_module__1341__1_2_p_0(
...
static void MR_CALL 
top_level__mercury_compile_main__read_module_or_file_13_p_0(
  MR_Word Globals0_14,
  MR_Word * Globals_15,
  MR_Word FileOrModuleName_16,
  MR_Word * ModuleName_17,
  MR_String * FileNameDotM_18,
  MR_Word ReturnTimestamp_19,
  MR_Word * MaybeTimestamp_20,
  MR_Word * ParseTreeSrc_21,
  MR_Word * Errors_22,
        ...
        case (MR_Integer) 2:
          {
            ...
            top_level__mercury_compile_main__read_module_or_file_13_p_0(Globals0_11, &Globals_21, FileOrModule_14, &ModuleName_68, &Var_22, (MR_Integer) 1, &Var_23, &ParseTreeSrc_24, &Errors_25, STATE_VARIABLE_HaveReadModuleMaps_0_34, STATE_VARIABLE_HaveReadModuleMaps_35);
            Specs_26 = parse_tree__parse_error__get_read_module_specs_1_f_0(Errors_25);
            parse_tree__error_util__write_error_specs_4_p_0(Globals_21, Specs_26);
            Var_110 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Errors_25, (MR_Integer) 0))));
            Var_108 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Errors_25, (MR_Integer) 2))));
            succeeded = mercury__set__is_non_empty_1_p_0((MR_Word) (&parse_tree__parse_error__parse_tree__parse_error__type_ctor_info_fatal_read_module_error_0), Var_110);
            if (!(succeeded))
            {
              MR_Word HaltSyntax_92;
              MR_Word Var_94;

              succeeded = mercury__set__is_non_empty_1_p_0((MR_Word) (&parse_tree__parse_error__parse_tree__parse_error__type_ctor_info_nonfatal_read_module_error_0), Var_108);
              if (succeeded)
              {
                Var_94 = (MR_Integer) 6;
                libs__globals__lookup_bool_option_3_p_0(Globals_21, Var_94, &HaltSyntax_92);
  ...
  MR_Box wrapper_arg_1)
{
  ...
  succeeded = top_level__mercury_compile_main__IntroducedFrom__pred__read_augment_and_process_module__1341__1_2_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) (wrapper_arg_1)));
  return succeeded;
}
  ...
  MR_Word * STATE_VARIABLE_HaveReadModuleMaps_44)
{
  ...
  top_level__mercury_compile_main__read_module_or_file_13_p_0(Globals0_12, &Globals_23, FileOrModule_15, &ModuleName_24, &FileName_25, (MR_Integer) 0, &MaybeTimestamp_26, &ParseTreeSrc_27, &Errors_28, STATE_VARIABLE_HaveReadModuleMaps_0_43, &STATE_VARIABLE_HaveReadModuleMaps_51_51);
  Specs0_29 = parse_tree__parse_error__get_read_module_specs_1_f_0(Errors_28);
  Var_148 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Errors_28, (MR_Integer) 0))));
  Var_146 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Errors_28, (MR_Integer) 2))));
  succeeded = mercury__set__is_non_empty_1_p_0((MR_Word) (&parse_tree__parse_error__parse_tree__parse_error__type_ctor_info_fatal_read_module_error_0), Var_148);
  if (!(succeeded))
  {
    MR_Word HaltSyntax_130;
    MR_Word Var_132;

    succeeded = mercury__set__is_non_empty_1_p_0((MR_Word) (&parse_tree__parse_error__parse_tree__parse_error__type_ctor_info_nonfatal_read_module_error_0), Var_146);
    if (succeeded)
    {
      Var_132 = (MR_Integer) 6;
      libs__globals__lookup_bool_option_3_p_0(Globals_23, Var_132, &HaltSyntax_130);
      succeeded = (HaltSyntax_130 == (MR_Integer) 1);
    }
  }
  if (succeeded)
  {
    parse_tree__error_util__write_error_specs_4_p_0(Globals_23, Specs0_29);
  ...
  else
  {
    ...
    MR_Word Var_56;
    MR_Word CompilationTarget_149;
    MR_Word TimestampOtherExt_150;
    MR_Word Var_108;

    parse_tree__split_parse_tree_src__split_into_compilation_units_perform_checks_5_p_0(Globals_23, ParseTreeSrc_27, &ParseTreeModuleSrcs0_30, Specs0_29, &Specs1_31);
    ...
    libs__globals__get_target_2_p_0(Globals_23, &CompilationTarget_149);
    switch (CompilationTarget_149) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        TimestampOtherExt_150 = (MR_Word) (((MR_Box) ((MR_String) ".c_date")));
        break;
      case (MR_Integer) 1:
        TimestampOtherExt_150 = (MR_Word) (((MR_Box) ((MR_String) ".cs_date")));
        break;
      case (MR_Integer) 2:
        TimestampOtherExt_150 = (MR_Word) (((MR_Box) ((MR_String) ".java_date")));
        break;
    }
    {
      ...
      MR_hl_field(MR_mktag(0), FindTimestampFiles_38, 4) = ((MR_Box) (TimestampOtherExt_150));
    }
  ...
  MR_Word * STATE_VARIABLE_HaveReadModuleMaps_29)
{
  ...
  MR_Word ReadErrors_20;
  MR_Word ReadSpecs_21;
  ...
  top_level__mercury_compile_main__read_module_or_file_13_p_0(Globals0_8, &Globals_15, FileOrModule_10, &ModuleName_16, &FileName_17, ReturnTimestamp_13, &MaybeTimestamp_18, &ParseTreeSrc_19, &ReadErrors_20, STATE_VARIABLE_HaveReadModuleMaps_0_28, &STATE_VARIABLE_HaveReadModuleMaps_34_34);
  ReadSpecs_21 = parse_tree__parse_error__get_read_module_specs_1_f_0(ReadErrors_20);
  Var_100 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ReadErrors_20, (MR_Integer) 0))));
  Var_98 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ReadErrors_20, (MR_Integer) 2))));
  succeeded = mercury__set__is_non_empty_1_p_0((MR_Word) (&parse_tree__parse_error__parse_tree__parse_error__type_ctor_info_fatal_read_module_error_0), Var_100);
  if (!(succeeded))
  {
    MR_Word HaltSyntax_82;
    MR_Word Var_84;

    succeeded = mercury__set__is_non_empty_1_p_0((MR_Word) (&parse_tree__parse_error__parse_tree__parse_error__type_ctor_info_nonfatal_read_module_error_0), Var_98);
    if (succeeded)
    {
      Var_84 = (MR_Integer) 6;
      libs__globals__lookup_bool_option_3_p_0(Globals_15, Var_84, &HaltSyntax_82);
      succeeded = (HaltSyntax_82 == (MR_Integer) 1);
    }
  }
  if (succeeded)
  {
    parse_tree__error_util__write_error_specs_4_p_0(Globals_15, ReadSpecs_21);
  ...
  else
  {
    ...
    MR_Word Limited_101;
    MR_Word ExtraErrorInfo_102;

    parse_tree__split_parse_tree_src__split_into_compilation_units_perform_checks_5_p_0(Globals_15, ParseTreeSrc_19, &ParseTreeModuleSrcs_22, ReadSpecs_21, &ReadSplitSpecs_23);
    ...
    libs__globals__io_get_some_errors_were_context_limited_3_p_0(&Limited_101);
    libs__globals__io_set_some_errors_were_context_limited_3_p_0((MR_Integer) 0);
    libs__globals__io_get_extra_error_info_3_p_0(&ExtraErrorInfo_102);
    libs__globals__io_set_extra_error_info_3_p_0((MR_Integer) 0);
    switch (Limited_101) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
      ...
      case (MR_Integer) 1:
        {
          ...
          Var_110 = mercury__string__f_43_43_2_f_0((MR_String) "Some error messages were suppressed ", (MR_String) "by \140--limit-error-contexts\' options.\n");
          mercury__io__write_string_4_p_0(ErrorStream_26, Var_110);
          Var_114 = mercury__string__f_43_43_2_f_0((MR_String) "You can see the suppressed messages ", (MR_String) "if you recompile without these options.\n");
          mercury__io__write_string_4_p_0(ErrorStream_26, Var_114);
        }
        break;
    }
    switch (ExtraErrorInfo_102) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        {
        }
      ...
      case (MR_Integer) 1:
        {
          MR_Word VerboseErrors_103;

          libs__globals__lookup_bool_option_3_p_0(Globals_15, (MR_Integer) 73, &VerboseErrors_103);
          switch (VerboseErrors_103) {
            default: /*NOTREACHED*/ MR_assert(0);
            case (MR_Integer) 0:
  ...
  MR_Word * STATE_VARIABLE_HaveReadModuleMaps_41)
{
  ...
  if (((MR_tag((MR_Word) FileOrModuleName_16)) == (MR_Integer) 0))
  {
    MR_String FileName_35 = ((MR_String) ((MR_hl_field(MR_mktag(0), FileOrModuleName_16, (MR_Integer) 0))));
    MR_Word DefaultModuleName_36;
    MR_Word Verbose_92;
    MR_Word Stats_99;
    MR_Word MaybeTimestampPrime_86;
    MR_Word ParseTreeSrcPrime_87;
    MR_Word ErrorsPrime_88;
    MR_Word Var_51;
    MR_String Var_37;

    *FileNameDotM_18 = mercury__string__f_43_43_2_f_0(FileName_35, (MR_String) ".m");
    libs__globals__lookup_bool_option_3_p_0(Globals0_14, (MR_Integer) 71, &Verbose_92);
    libs__file_util__maybe_write_string_4_p_0(Verbose_92, (MR_String) "% Parsing file \140");
    libs__file_util__maybe_write_string_4_p_0(Verbose_92, *FileNameDotM_18);
    libs__file_util__maybe_write_string_4_p_0(Verbose_92, (MR_String) "\' and imported interfaces...\n");
    parse_tree__file_names__file_name_to_module_name_2_p_0(FileName_35, &DefaultModuleName_36);
    Var_51 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_HaveReadModuleMaps_0_40, (MR_Integer) 0))));
    succeeded = parse_tree__read_modules__find_read_module_src_7_p_0(Var_51, DefaultModuleName_36, ReturnTimestamp_19, &Var_37, &MaybeTimestampPrime_86, &ParseTreeSrcPrime_87, &ErrorsPrime_88);
    if (succeeded)
    {
      MR_Word HaveReadModuleMapSrc0_83;
      MR_Word HaveReadModuleMapSrc_84;
      MR_Word Var_137;
      MR_Word Var_138;
      MR_Word Var_139;
      MR_Word Var_140;
      ...
      *Globals_15 = Globals0_14;
      HaveReadModuleMapSrc0_83 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_HaveReadModuleMaps_0_40, (MR_Integer) 0))));
      *ModuleName_17 = DefaultModuleName_36;
      mercury__map__delete_3_p_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), (MR_Word) (&top_level__mercury_compile_main_scalar_common_1[1]), ((MR_Box) (*ModuleName_17)), HaveReadModuleMapSrc0_83, &HaveReadModuleMapSrc_84);
      Var_137 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_HaveReadModuleMaps_0_40, (MR_Integer) 1))));
      Var_138 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_HaveReadModuleMaps_0_40, (MR_Integer) 2))));
      Var_139 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_HaveReadModuleMaps_0_40, (MR_Integer) 3))));
      Var_140 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_HaveReadModuleMaps_0_40, (MR_Integer) 4))));
      Var_141 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_HaveReadModuleMaps_0_40, (MR_Integer) 5))));
      Var_142 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_HaveReadModuleMaps_0_40, (MR_Integer) 6))));
      Var_143 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_HaveReadModuleMaps_0_40, (MR_Integer) 7))));
      {
        MR_Word base;
        base = (MR_Word) MR_new_object(MR_Word, (8 * sizeof(MR_Word)), NULL, NULL);
        *STATE_VARIABLE_HaveReadModuleMaps_41 = base;
        MR_hl_field(MR_mktag(0), base, 0) = ((MR_Box) (HaveReadModuleMapSrc_84));
        ...
        MR_hl_field(MR_mktag(0), base, 5) = ((MR_Box) (Var_141));
        MR_hl_field(MR_mktag(0), base, 6) = ((MR_Box) (Var_142));
        MR_hl_field(MR_mktag(0), base, 7) = ((MR_Box) (Var_143));
      }
      *MaybeTimestamp_20 = MaybeTimestampPrime_86;
      *ParseTreeSrc_21 = ParseTreeSrcPrime_87;
      *Errors_22 = ErrorsPrime_88;
    }
    else
    {
      MR_Word Var_55;
      MR_Word DisableSmart_85;

      {
        Var_55 = (MR_Word) MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), Var_55, 0) = (MR_Box) ((MR_Unsigned) (ReturnTimestamp_19));
      }
      parse_tree__read_modules__read_module_src_from_file_11_p_0(Globals0_14, FileName_35, *FileNameDotM_18, (MR_Word) ((MR_Unsigned) 0U), (MR_Integer) 1, Var_55, MaybeTimestamp_20, ParseTreeSrc_21, Errors_22);
      *ModuleName_17 = ((MR_Word) ((MR_hl_field(MR_mktag(0), *ParseTreeSrc_21, (MR_Integer) 0))));
      libs__globals__io_get_disable_smart_recompilation_3_p_0(&DisableSmart_85);
      switch (DisableSmart_85) {
        default: /*NOTREACHED*/ MR_assert(0);
        case (MR_Integer) 1:
          libs__globals__set_option_4_p_0((MR_Integer) 149, (MR_Word) (MR_mkword(MR_mktag(1), &top_level__mercury_compile_main_scalar_common_2[1])), Globals0_14, Globals_15);
          break;
        case (MR_Integer) 0:
          *Globals_15 = Globals0_14;
          break;
    ...
    libs__globals__lookup_bool_option_3_p_0(*Globals_15, (MR_Integer) 82, &Stats_99);
    libs__file_util__maybe_report_stats_3_p_0(Stats_99);
  }
  else
  {
    MR_Word Verbose_25;
    ...
    MR_Word Stats_34;
    MR_String FileNameDotMPrime_27;
    MR_Word MaybeTimestampPrime_28;
    MR_Word ParseTreeSrcPrime_29;
    MR_Word ErrorsPrime_30;
    MR_Word Var_69;

    *ModuleName_17 = ((MR_Word) ((MR_hl_field(MR_mktag(1), FileOrModuleName_16, (MR_Integer) 0))));
    libs__globals__lookup_bool_option_3_p_0(Globals0_14, (MR_Integer) 71, &Verbose_25);
    libs__file_util__maybe_write_string_4_p_0(Verbose_25, (MR_String) "% Parsing module \140");
    ModuleNameString_26 = mdbcomp__sym_name__sym_name_to_string_1_f_0(*ModuleName_17);
    libs__file_util__maybe_write_string_4_p_0(Verbose_25, ModuleNameString_26);
    libs__file_util__maybe_write_string_4_p_0(Verbose_25, (MR_String) "\' and imported interfaces...\n");
    Var_69 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_HaveReadModuleMaps_0_40, (MR_Integer) 0))));
    succeeded = parse_tree__read_modules__find_read_module_src_7_p_0(Var_69, *ModuleName_17, ReturnTimestamp_19, &FileNameDotMPrime_27, &MaybeTimestampPrime_28, &ParseTreeSrcPrime_29, &ErrorsPrime_30);
    if (succeeded)
    {
      ...
      *Globals_15 = Globals0_14;
      HaveReadModuleMapSrc0_31 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_HaveReadModuleMaps_0_40, (MR_Integer) 0))));
      mercury__map__delete_3_p_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), (MR_Word) (&top_level__mercury_compile_main_scalar_common_1[1]), ((MR_Box) (*ModuleName_17)), HaveReadModuleMapSrc0_31, &HaveReadModuleMapSrc_32);
      Var_115 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_HaveReadModuleMaps_0_40, (MR_Integer) 1))));
      Var_116 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_HaveReadModuleMaps_0_40, (MR_Integer) 2))));
      Var_117 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_HaveReadModuleMaps_0_40, (MR_Integer) 3))));
      Var_118 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_HaveReadModuleMaps_0_40, (MR_Integer) 4))));
      Var_119 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_HaveReadModuleMaps_0_40, (MR_Integer) 5))));
      Var_120 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_HaveReadModuleMaps_0_40, (MR_Integer) 6))));
      Var_121 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_HaveReadModuleMaps_0_40, (MR_Integer) 7))));
      {
        MR_Word base;
        base = (MR_Word) MR_new_object(MR_Word, (8 * sizeof(MR_Word)), NULL, NULL);
        *STATE_VARIABLE_HaveReadModuleMaps_41 = base;
        MR_hl_field(MR_mktag(0), base, 0) = ((MR_Box) (HaveReadModuleMapSrc_32));
      ...
      *FileNameDotM_18 = FileNameDotMPrime_27;
      *MaybeTimestamp_20 = MaybeTimestampPrime_28;
      *ParseTreeSrc_21 = ParseTreeSrcPrime_29;
      *Errors_22 = ErrorsPrime_30;
    }
    else
    {
      MR_Word DisableSmart_33;
      MR_Word Var_71;
      MR_Word Var_75;

      {
        Var_71 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), Var_71, 0) = ((MR_Box) (*ModuleName_17));
      }
      {
        Var_75 = (MR_Word) MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), Var_75, 0) = (MR_Box) ((MR_Unsigned) (ReturnTimestamp_19));
      }
      parse_tree__read_modules__read_module_src_13_p_0(Globals0_14, Var_71, (MR_Integer) 1, (MR_Integer) 1, *ModuleName_17, (MR_Word) ((MR_Unsigned) 0U), FileNameDotM_18, Var_75, MaybeTimestamp_20, ParseTreeSrc_21, Errors_22);
      libs__globals__io_get_disable_smart_recompilation_3_p_0(&DisableSmart_33);
      switch (DisableSmart_33) {
        default: /*NOTREACHED*/ MR_assert(0);
        case (MR_Integer) 1:
          libs__globals__set_option_4_p_0((MR_Integer) 149, (MR_Word) (MR_mkword(MR_mktag(1), &top_level__mercury_compile_main_scalar_common_2[1])), Globals0_14, Globals_15);
          break;
    ...
    libs__globals__lookup_bool_option_3_p_0(*Globals_15, (MR_Integer) 81, &Stats_34);
    libs__file_util__maybe_report_stats_3_p_0(Stats_34);
  }
}
