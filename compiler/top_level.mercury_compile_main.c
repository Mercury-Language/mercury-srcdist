  ...
  MR_Word * STATE_VARIABLE_HaveReadModuleMaps_39)
{
  ...
  succeeded = mercury__map__search_3_p_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), (MR_Word) (&top_level__mercury_compile_main_scalar_common_1[3]), Var_52, ((MR_Box) (ModuleName_20)), &conv0_HaveReadSrc0_24);
  if (succeeded)
  {
  ...
  if (succeeded)
  {
    ...
    *HaveReadSrc_16 = HaveReadSrc1_30;
    ...
    mercury__map__delete_3_p_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), (MR_Word) (&top_level__mercury_compile_main_scalar_common_1[3]), ((MR_Box) (ModuleName_20)), HaveReadModuleMapSrc0_31, &HaveReadModuleMapSrc_32);
