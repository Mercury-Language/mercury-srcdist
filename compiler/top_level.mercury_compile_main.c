...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_14, (MR_Integer) 267, &HighLevelCode_26);
...
{
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        libs__globals__set_option_4_p_0((MR_Integer) 278, (MR_Word) MR_mkword(MR_mktag(1), &top_level__mercury_compile_main_scalar_common_4[1]), Globals_22, &GlobalsNoTrace0_45);
