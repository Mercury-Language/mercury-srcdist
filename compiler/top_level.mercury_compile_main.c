      ...
      case (MR_Integer) 3:
        {
          ...
          {
            libs__globals__lookup_bool_option_3_p_0(top_level__mercury_compile_main__Globals_9, (MR_Integer) 647, &top_level__mercury_compile_main__FileNamesFromStdin_35);
          }
          ...
          else
            {
              ...
              if (top_level__mercury_compile_main__succeeded)
              ...
              else
                {
                  ...
                  {
                    libs__globals__lookup_bool_option_3_p_0(top_level__mercury_compile_main__Globals_9, (MR_Integer) 49, &top_level__mercury_compile_main__VerboseErrors_47);
                  }
                  {
              ...
              {
                libs__globals__lookup_bool_option_3_p_0(top_level__mercury_compile_main__Globals_9, (MR_Integer) 57, &top_level__mercury_compile_main__Statistics_49);
              }
