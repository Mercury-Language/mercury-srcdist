                  ...
                  case (MR_Integer) 1:
                    {
                      ...
                      libs__globals__set_option_4_p_0((MR_Integer) 376, (MR_Word) (MR_mkword(MR_mktag(1), &top_level__mercury_compile_main_scalar_common_4[1])), Globals_22, &NoOptUnusedArgsGlobals_37);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_14, (MR_Integer) 282, &HighLevelCode_26);
...
{
  {
    ...
    libs__globals__lookup_accumulating_option_3_p_0(Globals_8, (MR_Integer) 690, &LocalModulesList_14);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 355, &IntermodAnalysis_13);
      ...
      case (MR_Integer) 1:
        {
          ...
          libs__globals__lookup_accumulating_option_3_p_0(Globals_8, (MR_Integer) 690, &LocalModulesList_31);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_17, (MR_Integer) 651, &MMCMake_32);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_10, (MR_Integer) 350, &IntermodOpt_18);
    libs__globals__lookup_bool_option_3_p_0(Globals_10, (MR_Integer) 352, &UseOptInt_19);
    libs__globals__lookup_bool_option_3_p_0(Globals_10, (MR_Integer) 354, &TransOpt_20);
    libs__globals__lookup_bool_option_3_p_0(Globals_10, (MR_Integer) 355, &IntermodAnalysis_21);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_6, (MR_Integer) 354, &TransOpt_10);
    switch (TransOpt_10) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 687, &Version_22);
    libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 686, &Help_23);
      ...
      else
      {
        ...
        else
        {
          ...
          if ((FlagsSpecs_26 == (MR_Word) ((MR_Unsigned) 0U)))
          {
            ...
            libs__globals__lookup_maybe_string_option_3_p_0(FlagsArgsGlobals_27, (MR_Integer) 667, &MaybeConfigFile_30);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 687, &Version_14);
    libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 686, &Help_15);
      ...
      case (MR_Integer) 3:
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_9, (MR_Integer) 683, &FileNamesFromStdin_19);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_10, (MR_Integer) 651, &InvokedByMake_18);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 651, &InvokedByMake_21);
      ...
      case (MR_Integer) 1:
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_12, (MR_Integer) 651, &InvokedByMake_62);
...
{
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        libs__globals__set_option_4_p_0((MR_Integer) 293, (MR_Word) (MR_mkword(MR_mktag(1), &top_level__mercury_compile_main_scalar_common_4[1])), Globals_22, &GlobalsNoTrace0_43);
    ...
    case (MR_Integer) 1:
      {
        ...
        libs__globals__lookup_string_option_3_p_0(Globals_5, (MR_Integer) 540, &CC_Type_10);
    ...
    case (MR_Integer) 0:
      {
        ...
        libs__globals__lookup_string_option_3_p_0(Globals_5, (MR_Integer) 515, &CC_8);
    ...
    case (MR_Integer) 5:
      {
        ...
        libs__globals__lookup_string_option_3_p_0(Globals_5, (MR_Integer) 548, &CSC_11);
    ...
    case (MR_Integer) 6:
      {
        ...
        libs__globals__lookup_string_option_3_p_0(Globals_5, (MR_Integer) 541, &CSC_Type_12);
    ...
    case (MR_Integer) 12:
      {
        ...
        libs__globals__lookup_accumulating_option_3_p_0(Globals_5, (MR_Integer) 661, &LibGrades_17);
    ...
    case (MR_Integer) 7:
      {
        ...
        libs__globals__lookup_string_option_3_p_0(Globals_5, (MR_Integer) 599, &LinkCommand_13);
    ...
    case (MR_Integer) 8:
      {
        ...
        libs__globals__lookup_string_option_3_p_0(Globals_5, (MR_Integer) 600, &LinkCommand_84);
    ...
    case (MR_Integer) 13:
      {
        ...
        libs__globals__lookup_string_option_3_p_0(Globals_5, (MR_Integer) 688, &TargetArch_20);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_6, (MR_Integer) 660, &Detect_10);
    switch (Detect_10) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
      ...
      case (MR_Integer) 1:
        {
          ...
          libs__globals__lookup_maybe_string_option_3_p_0(Globals_6, (MR_Integer) 576, &MaybeStdLibDir_14);
