...
top_level__mercury_compile_main__IntroducedFrom__pred__read_dependency_file_get_modules__2100__1_1_p_0(
  MR_Char LambdaHeadVar__1_22);

static MR_bool MR_CALL 
top_level__mercury_compile_main__IntroducedFrom__pred__read_augment_and_process_module__1422__1_2_p_0(
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_14, (MR_Integer) 291, &HighLevelCode_26);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 223, &ProfileCalls_12);
    libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 224, &ProfileTime_13);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 487, &IntermodAnalysis_13);
...
{
  {
    ...
    libs__globals__lookup_string_option_3_p_0(Globals_19, (MR_Integer) 207, &EventSetFileName_44);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_12, (MR_Integer) 482, &IntermodOpt_21);
    libs__globals__lookup_bool_option_3_p_0(Globals_12, (MR_Integer) 484, &UseOptInt_22);
    libs__globals__lookup_bool_option_3_p_0(Globals_12, (MR_Integer) 486, &TransOpt_23);
    libs__globals__lookup_bool_option_3_p_0(Globals_12, (MR_Integer) 487, &IntermodAnalysis_24);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_6, (MR_Integer) 486, &TransOpt_10);
    switch (TransOpt_10) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
...
{
  {
    ...
    succeeded = top_level__mercury_compile_main__IntroducedFrom__pred__read_dependency_file_get_modules__2100__1_1_p_0(((MR_Char) (MR_Word) wrapper_arg_1));
    return succeeded;
  }
}
...
{
  {
    ...
    else
    {
      ...
      libs__globals__lookup_accumulating_option_3_p_0(ArgsGlobals_21, (MR_Integer) 673, &OptionSearchDirectories_22);
      libs__globals__lookup_accumulating_option_3_p_0(ArgsGlobals_21, (MR_Integer) 671, &OptionsFiles_23);
              ...
              case (MR_Integer) 0:
                {
                  ...
                  if ((FlagsSpecs_36 == (MR_Word) ((MR_Unsigned) 0U)))
                  {
                    ...
                    libs__globals__lookup_maybe_string_option_3_p_0(FlagsArgsGlobals_37, (MR_Integer) 672, &MaybeConfigFile_40);
...
{
  {
    ...
    succeeded = top_level__mercury_compile_main__IntroducedFrom__pred__read_augment_and_process_module__1422__1_2_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) (wrapper_arg_1)));
    return succeeded;
  }
}
...
{
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        libs__globals__set_option_4_p_0((MR_Integer) 301, (MR_Word) (MR_mkword(MR_mktag(1), &top_level__mercury_compile_main_scalar_common_4[1])), Globals_23, &GlobalsNoTrace0_43);
