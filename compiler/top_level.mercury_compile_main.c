    ...
    case (MR_Integer) 1:
      {
        ...
        libs__globals__lookup_accumulating_option_3_p_0(Globals_8, (MR_Integer) 699, &LocalModulesList_20);
            ...
            case (MR_Integer) 0:
              {
                ...
                libs__globals__set_option_4_p_0((MR_Integer) 692, (MR_Word) (MR_mkword(MR_mktag(1), &top_level__mercury_compile_main_scalar_common_2[1])), Globals_8, &MakeGlobals_33);
        ...
        case (MR_Integer) 3:
          {
            ...
            libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 692, &FileNamesFromStdin_37);
    ...
    case (MR_Integer) 2:
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals0_11, (MR_Integer) 151, &Smart0_82);
        libs__globals__io_get_disable_smart_recompilation_3_p_0(&DisableSmart_83);
        switch (DisableSmart_83) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 1:
            {
              libs__globals__set_option_4_p_0((MR_Integer) 151, (MR_Word) (MR_mkword(MR_mktag(1), &top_level__mercury_compile_main_scalar_common_2[1])), Globals0_11, &Globals_79);
    ...
    case (MR_Integer) 0:
      {
        ...
        libs__globals__lookup_string_option_3_p_0(ArgsGlobals_19, (MR_Integer) 202, &DumpOptionsFile_80);
        ...
        else
        {
          ...
          if ((FlagsSpecs_44 == (MR_Word) ((MR_Unsigned) 0U)))
          {
            ...
            libs__globals__lookup_maybe_string_option_3_p_0(FlagsArgsGlobals_45, (MR_Integer) 676, &MaybeConfigFile_48);
