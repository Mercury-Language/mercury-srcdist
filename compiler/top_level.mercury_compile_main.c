...
{
  {
    ...
    if (succeeded)
    {
      ...
      Var_70 = mercury__list__f_43_43_2_f_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))), OptionArgs_13);
      AllFlags_35 = mercury__list__f_43_43_2_f_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), DetectedGradeFlags_15, Var_70);
