  ...
  MR_Word Args_10)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_9, (MR_Integer) 749, &Version_20);
  libs__globals__lookup_bool_option_3_p_0(Globals_9, (MR_Integer) 748, &Help_21);
...
#undef MR_PROC_LABEL
  ...
  if (!((ArgResult_9 == (MR_Word) ((MR_Unsigned) 0U))))
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_10, (MR_Integer) 749, &Version_30);
    libs__globals__lookup_bool_option_3_p_0(Globals_10, (MR_Integer) 748, &Help_31);
        ...
        case (MR_Integer) 0:
          {
            ...
            libs__globals__set_option_4_p_0((MR_Integer) 745, (MR_Word) (MR_mkword(1, &top_level__mercury_compile_main_scalar_common_3[0])), Globals_17, &MakeGlobals_26);
    ...
    case (MR_Integer) 3:
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_17, (MR_Integer) 745, &FileNamesFromStdin_31);
        ...
        else
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_17, (MR_Integer) 93, &Statistics_58);
    ...
    case (MR_Integer) 3:
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals0_16, (MR_Integer) 182, &Smart0_87);
        libs__globals__io_get_disable_smart_recompilation_3_p_0(&DisableSmart_88);
        switch (DisableSmart_88) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 1:
            {
              libs__globals__set_option_4_p_0((MR_Integer) 182, (MR_Word) (MR_mkword(1, &top_level__mercury_compile_main_scalar_common_3[0])), Globals0_16, &Globals_79);
        ...
        case (MR_Integer) 4:
          {
            ...
            libs__globals__lookup_bool_option_3_p_0(Globals0_18, (MR_Integer) 92, &ReportCmdLineArgsDotErr_30);
    ...
    case (MR_Integer) 0:
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals0_11, (MR_Integer) 183, &GenerateVersionNumbers_18);
    ...
    case (MR_Integer) 1:
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals0_11, (MR_Integer) 183, &GenerateVersionNumbers_63);
  ...
  MR_Word * STATE_VARIABLE_HaveParseTreeMaps_42)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals0_12, (MR_Integer) 83, &Verbose_19);
  ...
  else
  {
    ...
    *HaveSrc_16 = (MR_Word) (HaveReadSrc_36);
    ...
    switch (DisableSmart_39) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 1:
        libs__globals__set_option_4_p_0((MR_Integer) 182, (MR_Word) (MR_mkword(1, &top_level__mercury_compile_main_scalar_common_3[0])), Globals0_12, Globals_13);
        break;
      case (MR_Integer) 0:
        *Globals_13 = Globals0_12;
        break;
  ...
  libs__globals__lookup_bool_option_3_p_0(*Globals_13, (MR_Integer) 94, &Stats_40);
    ...
    case (MR_Integer) 12:
      {
        ...
        libs__globals__lookup_accumulating_option_3_p_0(Globals_7, (MR_Integer) 707, &LibGrades_24);
        {
