    ...
    case (MR_Integer) 1:
      {
        ...
        libs__globals__lookup_accumulating_option_3_p_0(Globals_8, (MR_Integer) 699, &LocalModulesList_29);
  ...
  MR_Word Args_6)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 696, &Version_23);
  libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 695, &Help_24);
