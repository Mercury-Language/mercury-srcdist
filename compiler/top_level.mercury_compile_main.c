...
top_level__mercury_compile_main__IntroducedFrom__pred__read_augment_and_process_module_ok__1404__1_2_p_0(
  ...
  MR_Box wrapper_arg_1)
{
  ...
  succeeded = top_level__mercury_compile_main__IntroducedFrom__pred__read_augment_and_process_module_ok__1404__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) (wrapper_arg_1)));
  return succeeded;
}
    ...
    case (MR_Integer) 9:
      {
        ...
        libs__globals__lookup_string_option_3_p_0(Globals_8, (MR_Integer) 615, &LinkCommand_71);
    ...
    case (MR_Integer) 15:
      {
        ...
        libs__globals__lookup_string_option_3_p_0(Globals_8, (MR_Integer) 704, &TargetArch_31);
  ...
  MR_Word * Specs_18)
{
  ...
  libs__globals__lookup_accumulating_option_3_p_0(ArgsGlobals_21, (MR_Integer) 684, &OptionSearchDirectories_22);
  libs__globals__lookup_accumulating_option_3_p_0(ArgsGlobals_21, (MR_Integer) 682, &OptionsFiles_23);
    ...
    case (MR_Integer) 0:
      {
        ...
        else
        {
          ...
          if ((FlagsSpecs_46 == (MR_Word) ((MR_Unsigned) 0U)))
          {
            ...
            libs__globals__lookup_maybe_string_option_3_p_0(FlagsArgsGlobals_47, (MR_Integer) 683, &MaybeConfigFile_50);
