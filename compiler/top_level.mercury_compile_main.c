  ...
  MR_Word Args_10)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_9, (MR_Integer) 744, &Version_20);
  libs__globals__lookup_bool_option_3_p_0(Globals_9, (MR_Integer) 743, &Help_21);
...
#undef MR_PROC_LABEL
  ...
  if (!((ArgResult_9 == (MR_Word) ((MR_Unsigned) 0U))))
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_10, (MR_Integer) 744, &Version_30);
    libs__globals__lookup_bool_option_3_p_0(Globals_10, (MR_Integer) 743, &Help_31);
        ...
        case (MR_Integer) 0:
          {
            ...
            libs__globals__set_option_4_p_0((MR_Integer) 740, (MR_Word) (MR_mkword(1, &top_level__mercury_compile_main_scalar_common_3[0])), Globals_17, &MakeGlobals_26);
    ...
    case (MR_Integer) 3:
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_17, (MR_Integer) 740, &FileNamesFromStdin_31);
    ...
    case (MR_Integer) 3:
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals0_16, (MR_Integer) 177, &Smart0_87);
        libs__globals__io_get_disable_smart_recompilation_3_p_0(&DisableSmart_88);
        switch (DisableSmart_88) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 1:
            {
              libs__globals__set_option_4_p_0((MR_Integer) 177, (MR_Word) (MR_mkword(1, &top_level__mercury_compile_main_scalar_common_3[0])), Globals0_16, &Globals_79);
    ...
    case (MR_Integer) 0:
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals0_11, (MR_Integer) 178, &GenerateVersionNumbers_18);
    ...
    case (MR_Integer) 1:
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals0_11, (MR_Integer) 178, &GenerateVersionNumbers_63);
  ...
  else
  {
    ...
    *HaveSrc_16 = (MR_Word) (HaveReadSrc_36);
    ...
    switch (DisableSmart_39) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 1:
        libs__globals__set_option_4_p_0((MR_Integer) 177, (MR_Word) (MR_mkword(1, &top_level__mercury_compile_main_scalar_common_3[0])), Globals0_12, Globals_13);
        break;
      case (MR_Integer) 0:
        *Globals_13 = Globals0_12;
        break;
    ...
    case (MR_Integer) 1:
      {
        ...
        libs__globals__lookup_string_option_3_p_0(Globals_7, (MR_Integer) 586, &CC_Type_12);
    ...
    case (MR_Integer) 0:
      {
        ...
        libs__globals__lookup_string_option_3_p_0(Globals_7, (MR_Integer) 562, &CC_11);
    ...
    case (MR_Integer) 5:
      {
        ...
        libs__globals__lookup_string_option_3_p_0(Globals_7, (MR_Integer) 595, &CSC_15);
    ...
    case (MR_Integer) 6:
      {
        ...
        libs__globals__lookup_string_option_3_p_0(Globals_7, (MR_Integer) 587, &CSC_Type_16);
    ...
    case (MR_Integer) 12:
      {
        ...
        libs__globals__lookup_accumulating_option_3_p_0(Globals_7, (MR_Integer) 702, &LibGrades_24);
        {
    ...
    case (MR_Integer) 8:
      {
        ...
        libs__globals__lookup_string_option_3_p_0(Globals_7, (MR_Integer) 638, &LinkCommand_21);
    ...
    case (MR_Integer) 9:
      {
        ...
        libs__globals__lookup_string_option_3_p_0(Globals_7, (MR_Integer) 639, &LinkCommand_71);
    ...
    case (MR_Integer) 15:
      {
        ...
        libs__globals__lookup_string_option_3_p_0(Globals_7, (MR_Integer) 745, &TargetArch_33);
