...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_20, (MR_Integer) 75, &Stats_35);
    libs__globals__lookup_bool_option_3_p_0(Globals_20, (MR_Integer) 65, &Verbose_36);
    libs__globals__lookup_bool_option_3_p_0(Globals_20, (MR_Integer) 663, &MMCMake_37);
    ...
    *MaybeTimestampMap_27 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Baggage1_43, (MR_Integer) 4))));
    ...
    libs__globals__lookup_string_option_3_p_0(Globals_20, (MR_Integer) 213, &EventSetFileName_45);
      ...
      case (MR_Integer) 1:
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_20, (MR_Integer) 143, &OutputMMCMakeDeps_75);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_14, (MR_Integer) 489, &IntermodOpt_23);
    libs__globals__lookup_bool_option_3_p_0(Globals_14, (MR_Integer) 491, &UseOptInt_24);
    libs__globals__lookup_bool_option_3_p_0(Globals_14, (MR_Integer) 493, &TransOpt_25);
    libs__globals__lookup_bool_option_3_p_0(Globals_14, (MR_Integer) 494, &IntermodAnalysis_26);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 699, &Version_24);
    libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 698, &Help_25);
...
{
  {
    ...
    else
    {
      ...
      libs__globals__lookup_accumulating_option_3_p_0(ArgsGlobals_22, (MR_Integer) 680, &OptionSearchDirectories_23);
      libs__globals__lookup_accumulating_option_3_p_0(ArgsGlobals_22, (MR_Integer) 678, &OptionsFiles_24);
              ...
              case (MR_Integer) 0:
                {
                  ...
                  if ((FlagsSpecs_37 == (MR_Word) ((MR_Unsigned) 0U)))
                  {
                    ...
                    libs__globals__lookup_maybe_string_option_3_p_0(FlagsArgsGlobals_38, (MR_Integer) 679, &MaybeConfigFile_41);
      ...
      case (MR_Integer) 3:
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 695, &FileNamesFromStdin_22);
...
{
  {
          ...
          case (MR_Integer) 1:
            {
              ...
              libs__globals__lookup_bool_option_3_p_0(Globals_12, (MR_Integer) 663, &InvokedByMake_34);
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_12, (MR_Integer) 75, &Statistics_41);
...
{
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        libs__globals__set_option_4_p_0((MR_Integer) 307, (MR_Word) (MR_mkword(MR_mktag(1), &top_level__mercury_compile_main_scalar_common_2[2])), Globals_23, &GlobalsNoTrace0_40);
...
{
  {
    ...
    switch (DisableSmart_16) {
      ...
      case (MR_Integer) 1:
        {
          libs__globals__set_option_4_p_0((MR_Integer) 141, (MR_Word) (MR_mkword(MR_mktag(1), &top_level__mercury_compile_main_scalar_common_2[2])), Globals0_9, Globals_10);
      ...
      case (MR_Integer) 1:
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals0_8, (MR_Integer) 142, &GenerateVersionNumbers_50);
      ...
      else
      {
        ...
        *ModuleName_18 = ((MR_Word) ((MR_hl_field(MR_mktag(0), *ParseTreeSrc_22, (MR_Integer) 0))));
        ...
        switch (DisableSmart_88) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 1:
            libs__globals__set_option_4_p_0((MR_Integer) 141, (MR_Word) (MR_mkword(MR_mktag(1), &top_level__mercury_compile_main_scalar_common_2[2])), Globals0_15, Globals_16);
            break;
          case (MR_Integer) 0:
            *Globals_16 = Globals0_15;
            break;
      ...
      case (MR_Integer) 1:
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_6, (MR_Integer) 67, &VerboseErrors_10);
...
{
  {
    ...
    libs__globals__lookup_string_option_3_p_0(ArgsGlobals_5, (MR_Integer) 192, &DumpOptionsFile_8);
