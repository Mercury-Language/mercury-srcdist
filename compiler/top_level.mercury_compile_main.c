                  ...
                  case (MR_Integer) 1:
                    {
                      ...
                      libs__globals__set_option_4_p_0((MR_Integer) 379, (MR_Word) (MR_mkword(MR_mktag(1), &top_level__mercury_compile_main_scalar_common_4[1])), Globals_25, &NoOptUnusedArgsGlobals_40);
...
{
  {
    ...
    libs__globals__lookup_accumulating_option_3_p_0(Globals_8, (MR_Integer) 695, &LocalModulesList_14);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 358, &IntermodAnalysis_13);
      ...
      case (MR_Integer) 1:
        {
          ...
          libs__globals__lookup_accumulating_option_3_p_0(Globals_8, (MR_Integer) 695, &LocalModulesList_31);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_19, (MR_Integer) 656, &MMCMake_35);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_12, (MR_Integer) 353, &IntermodOpt_21);
    libs__globals__lookup_bool_option_3_p_0(Globals_12, (MR_Integer) 355, &UseOptInt_22);
    libs__globals__lookup_bool_option_3_p_0(Globals_12, (MR_Integer) 357, &TransOpt_23);
    libs__globals__lookup_bool_option_3_p_0(Globals_12, (MR_Integer) 358, &IntermodAnalysis_24);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_6, (MR_Integer) 357, &TransOpt_10);
    switch (TransOpt_10) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 692, &Version_22);
    libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 691, &Help_23);
      ...
      else
      {
        ...
        else
        {
          ...
          if ((FlagsSpecs_26 == (MR_Word) ((MR_Unsigned) 0U)))
          {
            ...
            libs__globals__lookup_maybe_string_option_3_p_0(FlagsArgsGlobals_27, (MR_Integer) 672, &MaybeConfigFile_30);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 692, &Version_14);
    libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 691, &Help_15);
      ...
      case (MR_Integer) 3:
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 688, &FileNamesFromStdin_22);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_10, (MR_Integer) 656, &InvokedByMake_18);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_13, (MR_Integer) 656, &InvokedByMake_24);
...
{
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        libs__globals__set_option_4_p_0((MR_Integer) 296, (MR_Word) (MR_mkword(MR_mktag(1), &top_level__mercury_compile_main_scalar_common_4[1])), Globals_23, &GlobalsNoTrace0_43);
    ...
    case (MR_Integer) 1:
      {
        ...
        libs__globals__lookup_string_option_3_p_0(Globals_5, (MR_Integer) 544, &CC_Type_10);
    ...
    case (MR_Integer) 0:
      {
        ...
        libs__globals__lookup_string_option_3_p_0(Globals_5, (MR_Integer) 518, &CC_8);
    ...
    case (MR_Integer) 5:
      {
        ...
        libs__globals__lookup_string_option_3_p_0(Globals_5, (MR_Integer) 552, &CSC_11);
    ...
    case (MR_Integer) 6:
      {
        ...
        libs__globals__lookup_string_option_3_p_0(Globals_5, (MR_Integer) 545, &CSC_Type_12);
    ...
    case (MR_Integer) 12:
      {
        ...
        libs__globals__lookup_accumulating_option_3_p_0(Globals_5, (MR_Integer) 666, &LibGrades_17);
    ...
    case (MR_Integer) 7:
      {
        ...
        libs__globals__lookup_string_option_3_p_0(Globals_5, (MR_Integer) 603, &LinkCommand_13);
    ...
    case (MR_Integer) 8:
      {
        ...
        libs__globals__lookup_string_option_3_p_0(Globals_5, (MR_Integer) 604, &LinkCommand_84);
    ...
    case (MR_Integer) 13:
      {
        ...
        libs__globals__lookup_string_option_3_p_0(Globals_5, (MR_Integer) 693, &TargetArch_20);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_6, (MR_Integer) 665, &Detect_10);
    switch (Detect_10) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
      ...
      case (MR_Integer) 1:
        {
          ...
          libs__globals__lookup_maybe_string_option_3_p_0(Globals_6, (MR_Integer) 580, &MaybeStdLibDir_14);
