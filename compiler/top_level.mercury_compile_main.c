...
top_level__mercury_compile_main__IntroducedFrom__pred__read_dependency_file_get_modules__1981__1_1_p_0(
  MR_Char LambdaHeadVar__1_22);

static MR_bool MR_CALL 
top_level__mercury_compile_main__IntroducedFrom__pred__read_augment_and_process_module__1307__1_2_p_0(
...
{
  {
    ...
    succeeded = top_level__mercury_compile_main__IntroducedFrom__pred__read_dependency_file_get_modules__1981__1_1_p_0(((MR_Char) (MR_Word) wrapper_arg_1));
    return succeeded;
  }
}
...
{
  {
    ...
    succeeded = top_level__mercury_compile_main__IntroducedFrom__pred__read_augment_and_process_module__1307__1_2_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) (wrapper_arg_1)));
    return succeeded;
  }
}
...
{
  {
    ...
    if (succeeded)
    {
      parse_tree__error_util__write_error_specs_ignore_4_p_0(ReadSpecs_20, Globals_15);
    ...
    else
    {
      ...
      parse_tree__error_util__write_error_specs_ignore_4_p_0(Specs_24, Globals_15);
