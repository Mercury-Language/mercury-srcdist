...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 219, &ProfileCalls_12);
    libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 220, &ProfileTime_13);
...
{
  {
    ...
    libs__globals__lookup_string_option_3_p_0(Globals_19, (MR_Integer) 203, &EventSetFileName_44);
