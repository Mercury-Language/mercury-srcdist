  ...
  MR_Word * STATE_VARIABLE_DumpInfo_61)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_14, (MR_Integer) 305, &HighLevelCode_26);
  ...
  MR_Word * STATE_VARIABLE_HLDS_21)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 238, &ProfileCalls_12);
  libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 239, &ProfileTime_13);
    ...
    case (MR_Integer) 1:
      {
        ...
        libs__globals__lookup_accumulating_option_3_p_0(Globals_8, (MR_Integer) 702, &LocalModulesList_20);
  ...
  MR_Word * STATE_VARIABLE_HLDS_20)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 186, &ShowDepGraph_12);
            ...
            case (MR_Integer) 0:
              {
                ...
                libs__globals__set_option_4_p_0((MR_Integer) 695, (MR_Word) (MR_mkword(MR_mktag(1), &top_level__mercury_compile_main_scalar_common_2[1])), Globals_8, &MakeGlobals_33);
        ...
        case (MR_Integer) 3:
          {
            ...
            libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 695, &FileNamesFromStdin_37);
  ...
  MR_Word * STATE_VARIABLE_Specs_50)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_14, (MR_Integer) 663, &InvokedByMake_24);
  ...
  MR_Word * STATE_VARIABLE_HaveReadModuleMaps_40)
{
  ...
  if (succeeded)
  {
    ...
    libs__globals__set_option_4_p_0((MR_Integer) 315, (MR_Word) (MR_mkword(MR_mktag(1), &top_level__mercury_compile_main_scalar_common_2[1])), Globals_14, &Globals1_37);
    ...
    case (MR_Integer) 1:
      {
        ...
        libs__globals__lookup_string_option_3_p_0(Globals_6, (MR_Integer) 557, &CC_Type_12);
    ...
    case (MR_Integer) 0:
      {
        ...
        libs__globals__lookup_string_option_3_p_0(Globals_6, (MR_Integer) 533, &CC_11);
    ...
    case (MR_Integer) 5:
      {
        ...
        libs__globals__lookup_string_option_3_p_0(Globals_6, (MR_Integer) 567, &CSC_13);
    ...
    case (MR_Integer) 6:
      {
        ...
        libs__globals__lookup_string_option_3_p_0(Globals_6, (MR_Integer) 558, &CSC_Type_14);
    ...
    case (MR_Integer) 12:
      {
        ...
        libs__globals__lookup_accumulating_option_3_p_0(Globals_6, (MR_Integer) 673, &LibGrades_18);
        {
    ...
    case (MR_Integer) 8:
      {
        ...
        libs__globals__lookup_string_option_3_p_0(Globals_6, (MR_Integer) 610, &LinkCommand_16);
    ...
    case (MR_Integer) 9:
      {
        ...
        libs__globals__lookup_string_option_3_p_0(Globals_6, (MR_Integer) 611, &LinkCommand_69);
    ...
    case (MR_Integer) 15:
      {
        ...
        libs__globals__lookup_string_option_3_p_0(Globals_6, (MR_Integer) 700, &TargetArch_29);
  ...
  MR_Word * Specs_16)
{
  ...
  libs__globals__lookup_accumulating_option_3_p_0(ArgsGlobals_19, (MR_Integer) 680, &OptionSearchDirectories_20);
  libs__globals__lookup_accumulating_option_3_p_0(ArgsGlobals_19, (MR_Integer) 678, &OptionsFiles_21);
    ...
    case (MR_Integer) 0:
      {
        ...
        libs__globals__lookup_string_option_3_p_0(ArgsGlobals_19, (MR_Integer) 203, &DumpOptionsFile_80);
        ...
        else
        {
          ...
          if ((FlagsSpecs_44 == (MR_Word) ((MR_Unsigned) 0U)))
          {
            ...
            libs__globals__lookup_maybe_string_option_3_p_0(FlagsArgsGlobals_45, (MR_Integer) 679, &MaybeConfigFile_48);
