    ...
    case (MR_Integer) 3:
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals0_18, (MR_Integer) 654, &Smart0_92);
        libs__globals__io_get_disable_smart_recompilation_3_p_0(&DisableSmart_93);
        switch (DisableSmart_93) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 1:
            {
              libs__globals__set_option_4_p_0((MR_Integer) 654, (MR_Word) (MR_mkword(1, &top_level__mercury_compile_main_scalar_common_3[0])), Globals0_18, &Globals_89);
