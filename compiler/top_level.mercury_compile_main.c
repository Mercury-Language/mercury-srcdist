...
{
  {
    ...
    if (succeeded)
    {
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals_13, (MR_Integer) 61, &Verbose_32);
      libs__globals__lookup_bool_option_3_p_0(Globals_13, (MR_Integer) 71, &Stats_33);
                  ...
                  case (MR_Integer) 1:
                    {
                      ...
                      libs__globals__set_option_4_p_0((MR_Integer) 374, (MR_Word) (MR_mkword(MR_mktag(1), &top_level__mercury_compile_main_scalar_common_4[1])), Globals_13, &NoOptUnusedArgsGlobals_36);
      ...
      case (MR_Integer) 3:
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_9, (MR_Integer) 681, &FileNamesFromStdin_35);
          ...
          else
          {
            ...
            else
            {
              ...
              libs__globals__lookup_bool_option_3_p_0(Globals_9, (MR_Integer) 63, &VerboseErrors_47);
            ...
            libs__globals__lookup_bool_option_3_p_0(Globals_9, (MR_Integer) 71, &Statistics_49);
