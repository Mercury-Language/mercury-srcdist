          ...
          case (MR_Integer) 1:
            {
              ...
              switch (InvokedByMmcMake_18) {
                default: /*NOTREACHED*/ MR_assert(0);
                case (MR_Integer) 1:
                  backend_libs__link_target_code__link_modules_into_executable_or_shared_library_for_c_8_p_0(ProgressStream_14, Globals_16, ModulesToLink_35, ExtraObjFiles_38, &Specs_145, &Succeeded_144);
                  break;
                case (MR_Integer) 0:
                  {
                    ...
                    if (((MR_tag((MR_Word) MayBuild_148)) == (MR_Integer) 1))
                    {
                      ...
                      backend_libs__link_target_code__link_modules_into_executable_or_shared_library_for_c_8_p_0(ProgressStream_14, BuildGlobals_150, ModulesToLink_35, ExtraObjFiles_38, &Specs_145, &Succeeded_144);
                    }
                    else
                    {
