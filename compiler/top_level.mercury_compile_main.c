    ...
    case (MR_Integer) 1:
      {
        ...
        libs__globals__lookup_accumulating_option_3_p_0(Globals_8, (MR_Integer) 702, &LocalModulesList_29);
        SymNames_30 = mercury__list__map_2_f_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), (MR_Word) (&top_level__mercury_compile_main_scalar_common_5[3]), LocalModulesList_29);
  ...
  MR_Word Args_6)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 699, &Version_23);
  libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 698, &Help_24);
  ...
  MR_Word CmdLineArgs_4)
{
  ...
  if (succeeded)
  {
    MR_Word EnvVarMap_59;
    MR_Word MaybeArgs1_62;
    MR_Word ArgsNonUndefSpecs_63;
    MR_Word ArgsUndefSpecs_64;

    mercury__io__environment__get_environment_var_map_3_p_0(&EnvVarMap_59);
    if (!((ExtraArgs_7 == (MR_Word) ((MR_Unsigned) 0U))))
    {
      MR_String Var_68;
      MR_String Var_70;

      Var_70 = mercury__string__string_1_f_0((MR_Word) (&top_level__mercury_compile_main_scalar_common_1[0]), ((MR_Box) (ExtraArgs_7)));
      Var_68 = mercury__string__f_43_43_2_f_0((MR_String) "extra arguments with --arg-file: ", Var_70);
      {
        mercury__require__unexpected_2_p_0((MR_String) "predicate \140top_level.mercury_compile_main.process_options_arg_file\'/10", Var_68);
        return;
      }
    }
    make__options_file__read_args_file_6_p_0(ArgFile_6, &MaybeArgs1_62, &ArgsNonUndefSpecs_63, &ArgsUndefSpecs_64);
    OptionSpecs_13 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_error_spec_0), ArgsNonUndefSpecs_63, ArgsUndefSpecs_64);
    if ((MaybeArgs1_62 == (MR_Word) ((MR_Unsigned) 0U)))
    {
    ...
    {
      MR_Word Args1_65 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MaybeArgs1_62, (MR_Integer) 0))));

      libs__handle_options__separate_option_args_3_p_0(Args1_65, &OptionArgs_11, &NonOptionArgs_12);
    }
    DetectedGradeFlags_8 = (MR_Word) ((MR_Unsigned) 0U);
    Variables_9 = make__options_file__options_variables_init_1_f_0(EnvVarMap_59);
        ...
        case (MR_Integer) 0:
          {
            ...
            libs__globals__set_option_4_p_0((MR_Integer) 695, (MR_Word) (MR_mkword(MR_mktag(1), &top_level__mercury_compile_main_scalar_common_2[1])), Globals_13, &MakeGlobals_22);
    ...
    case (MR_Integer) 1:
      {
        ...
        mercury__io__stderr_stream_3_p_0(&ProgressStream_50);
        libs__globals__get_target_2_p_0(Globals_13, &Target_51);
        switch (Target_51) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 0:
            backend_libs__compile_target_code__make_standalone_interface_6_p_0(Globals_13, ProgressStream_50, ProgressStream_50, StandaloneIntBasename_23);
            break;
          case (MR_Integer) 1:
          case (MR_Integer) 2:
            {
              ...
              mercury__io__progname_base_4_p_0((MR_String) "mercury_compile", &ProgName_52);
              {
                ...
                MR_hl_field(MR_mktag(2), Var_58, 0) = ((MR_Box) (ProgName_52));
              }
              Var_75 = libs__globals__compilation_target_string_1_f_0(Target_51);
              {
              ...
              }
              {
                ...
                MR_hl_field(MR_mktag(1), Var_73, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &top_level__mercury_compile_main_scalar_common_1[9])));
              }
              {
                Var_70 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(1), Var_70, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &top_level__mercury_compile_main_scalar_common_1[6])));
                MR_hl_field(MR_mktag(1), Var_70, 1) = ((MR_Box) (Var_73));
              }
              {
                Var_67 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(1), Var_67, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &top_level__mercury_compile_main_scalar_common_1[5])));
              ...
              }
              {
                ...
                MR_hl_field(MR_mktag(1), Var_59, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &top_level__mercury_compile_main_scalar_common_1[3])));
              ...
              }
              {
                ...
                MR_hl_field(MR_mktag(1), Pieces_53, 0) = ((MR_Box) (Var_58));
                MR_hl_field(MR_mktag(1), Pieces_53, 1) = ((MR_Box) (Var_59));
              }
              {
                Spec_54 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(2), Spec_54, 0) = ((MR_Box) ((MR_String) "predicate \140top_level.mercury_compile_main.do_op_mode_standalone_interface\'/4"));
                MR_hl_field(MR_mktag(2), Spec_54, 1) = ((MR_Box) ((MR_Unsigned) 0U));
                MR_hl_field(MR_mktag(2), Spec_54, 2) = ((MR_Box) ((MR_Unsigned) 0U));
                MR_hl_field(MR_mktag(2), Spec_54, 3) = ((MR_Box) (Pieces_53));
              }
              parse_tree__error_util__write_error_spec_5_p_0(ProgressStream_50, Globals_13, Spec_54);
            }
            break;
        }
        *STATE_VARIABLE_HaveReadModuleMaps_29 = STATE_VARIABLE_HaveReadModuleMaps_0_28;
    ...
    case (MR_Integer) 3:
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_13, (MR_Integer) 695, &FileNamesFromStdin_26);
  ...
  MR_Word * STATE_VARIABLE_HaveReadModuleMaps_10)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      succeeded = mercury__string__remove_suffix_3_p_0(Arg_31, (MR_String) ".m", &FileName_60);
      if (succeeded)
        {
          FileOrModule_37 = (MR_Word) MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), FileOrModule_37, 0) = ((MR_Box) (FileName_60));
        }
      else
      {
        MR_Word ModuleName_61;

        parse_tree__file_names__file_name_to_module_name_2_p_0(Arg_31, &ModuleName_61);
        {
          FileOrModule_37 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), FileOrModule_37, 0) = ((MR_Box) (ModuleName_61));
        }
      }
  ...
  MR_Word * STATE_VARIABLE_Specs_40)
{
  ...
  succeeded = mercury__string__remove_suffix_3_p_0(Arg_20, (MR_String) ".m", &FileName_51);
  if (succeeded)
  {
    {
      FileOrModule_26 = (MR_Word) MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), FileOrModule_26, 0) = ((MR_Box) (FileName_51));
    }
    parse_tree__file_names__file_name_to_module_name_2_p_0(FileName_51, &ModuleName_27);
  }
  else
  {
  ...
  MR_Word * STATE_VARIABLE_HaveReadModuleMaps_32)
{
  ...
  else
  {
    ...
    Var_93 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Errors_45, (MR_Integer) 0))));
    Var_91 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Errors_45, (MR_Integer) 2))));
    ...
    if (!(succeeded))
    {
      ...
      {
        Var_78 = (MR_Integer) 6;
        libs__globals__lookup_bool_option_3_p_0(Globals_23, Var_78, &HaltSyntax_75);
  ...
  MR_Word * STATE_VARIABLE_HaveReadModuleMaps_23)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals0_9, (MR_Integer) 152, &Smart0_15);
  libs__globals__io_get_disable_smart_recompilation_3_p_0(&DisableSmart_16);
  switch (DisableSmart_16) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 1:
      {
        libs__globals__set_option_4_p_0((MR_Integer) 152, (MR_Word) (MR_mkword(MR_mktag(1), &top_level__mercury_compile_main_scalar_common_2[1])), Globals0_9, Globals_10);
  ...
  MR_Word * Specs_20)
{
  ...
  MR_String DumpOptionsFile_72;

  libs__globals__lookup_string_option_3_p_0(ArgsGlobals_13, (MR_Integer) 203, &DumpOptionsFile_72);
  succeeded = (strcmp(DumpOptionsFile_72, (MR_String) "") == 0);
  if (!(succeeded))
  {
    MR_Word StdErrStream_73;

    mercury__io__stderr_stream_3_p_0(&StdErrStream_73);
    make__options_file__dump_options_file_5_p_0(StdErrStream_73, DumpOptionsFile_72, Variables0_17);
  }
  ...
  else
  {
    ...
    if ((FlagsSpecs_27 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      ...
      libs__globals__lookup_maybe_string_option_3_p_0(FlagsArgsGlobals_28, (MR_Integer) 679, &MaybeConfigFile_31);
      ...
      if (succeeded)
      {
        ...
        else
        {
          ...
          if (((MR_tag((MR_Word) ReadRes_16)) == (MR_Integer) 1))
          {
            ...
            Var_30 = mercury__io__make_io_error_1_f_0(Var_41);
            {
              MR_Word base;
              base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
              *HeadVar__2_2 = base;
