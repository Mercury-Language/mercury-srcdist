...
static /* final */ const MR_Box top_level__mercury_compile_main_scalar_common_2[4][1];
  ...
  MR_Word * STATE_VARIABLE_HLDS_25)
{
  ...
  if (succeeded)
  {
    ...
    parse_tree__file_names__module_name_to_file_name_create_dirs_7_p_0(Globals_15, (MR_String) "predicate \140top_level.mercury_compile_main.maybe_output_prof_call_graph\'/8", (MR_Word) (MR_mkword(3, &top_level__mercury_compile_main_scalar_common_1[19])), ModuleName_18, &ProfFileName_19);
