      ...
      else
      {
        ...
        if (succeeded)
        {
          ...
          Pieces_40 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), (MR_Word) (MR_mkword(1, &top_level__mercury_compile_main_scalar_common_1[15])), Var_90);
          {
            ...
            MR_hl_field(1, Spec_42, 2) = ((MR_Box) ((MR_Unsigned) 92U));
    ...
    case (MR_Integer) 3:
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals0_18, (MR_Integer) 656, &Smart0_92);
        libs__globals__io_get_disable_smart_recompilation_3_p_0(&DisableSmart_93);
        switch (DisableSmart_93) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 1:
            {
              libs__globals__set_option_4_p_0((MR_Integer) 656, (MR_Word) (MR_mkword(1, &top_level__mercury_compile_main_scalar_common_3[0])), Globals0_18, &Globals_89);
        ...
        case (MR_Integer) 4:
          {
            ...
            libs__globals__lookup_bool_option_3_p_0(Globals0_18, (MR_Integer) 693, &ReportCmdLineArgsDotErr_30);
    ...
    case (MR_Integer) 0:
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals0_12, (MR_Integer) 792, &GenerateVersionNumbers_19);
    ...
    case (MR_Integer) 1:
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals0_12, (MR_Integer) 792, &GenerateVersionNumbers_76);
  ...
  MR_Word * STATE_VARIABLE_HaveParseTreeMaps_42)
{
  ...
  else
  {
    ...
    *HaveSrc_16 = (MR_Word) (HaveReadSrc_36);
    ...
    switch (DisableSmart_39) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 1:
        libs__globals__set_option_4_p_0((MR_Integer) 656, (MR_Word) (MR_mkword(1, &top_level__mercury_compile_main_scalar_common_3[0])), Globals0_12, Globals_13);
        break;
      case (MR_Integer) 0:
        *Globals_13 = Globals0_12;
        break;
  ...
  libs__globals__lookup_bool_option_3_p_0(*Globals_13, (MR_Integer) 689, &Stats_40);
        ...
        case (MR_Integer) 0:
          {
            ...
            libs__globals__lookup_string_option_3_p_0(Globals_7, (MR_Integer) 474, &CC_12);
        ...
        case (MR_Integer) 1:
          {
            ...
            libs__globals__lookup_string_option_3_p_0(Globals_7, (MR_Integer) 475, &CC_Type_13);
        ...
        case (MR_Integer) 5:
          {
            ...
            libs__globals__lookup_string_option_3_p_0(Globals_7, (MR_Integer) 505, &CSC_16);
        ...
        case (MR_Integer) 6:
          {
            ...
            libs__globals__lookup_string_option_3_p_0(Globals_7, (MR_Integer) 507, &CSC_Type_17);
        ...
        case (MR_Integer) 8:
          {
            ...
            libs__globals__lookup_string_option_3_p_0(Globals_7, (MR_Integer) 547, &LinkCommand_22);
        ...
        case (MR_Integer) 9:
          {
            ...
            libs__globals__lookup_string_option_3_p_0(Globals_7, (MR_Integer) 548, &LinkCommand_78);
        ...
        case (MR_Integer) 12:
          {
            ...
            libs__globals__lookup_accumulating_option_3_p_0(Globals_7, (MR_Integer) 576, &LibGrades_26);
            {
        ...
        case (MR_Integer) 15:
          {
            ...
            libs__globals__lookup_string_option_3_p_0(Globals_7, (MR_Integer) 602, &TargetArch_35);
