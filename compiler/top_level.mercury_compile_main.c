          ...
          case (MR_Integer) 0:
            {
              ...
              if ((LibgradeCheckSpecs_28 == (MR_Word) ((MR_Unsigned) 0U)))
              {
                ...
                top_level__mercury_compile_main__setup_and_process_compiler_cmd_line_args_16_p_0(Globals_14, OpModeArgs_15, DetectedGradeFlags_17, OptionVariables_18, OptionArgs_19, Args_20, Var_60, &ModulesToLinkCord_26, Var_61, &ExtraObjFilesCord_27, STATE_VARIABLE_HaveReadModuleMaps_0_47, STATE_VARIABLE_HaveReadModuleMaps_48, STATE_VARIABLE_Specs_0_49, STATE_VARIABLE_Specs_50);
              }
              else
              {
                *STATE_VARIABLE_Specs_50 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_error_spec_0), LibgradeCheckSpecs_28, STATE_VARIABLE_Specs_0_49);
