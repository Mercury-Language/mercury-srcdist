...
{
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        libs__globals__set_option_4_p_0((MR_Integer) 275, (MR_Word) MR_mkword(MR_mktag(1), &top_level__mercury_compile_main_scalar_common_4[1]), Globals_22, &GlobalsNoTrace0_45);
