...
static /* final */ const MR_Box top_level__mercury_compile_main_scalar_common_9[6][5];
...
static /* final */ const MR_Box top_level__mercury_compile_main_scalar_common_5[8][3] = {
  ...
  /* row   6 */
  {
    ((MR_Box) (&top_level__mercury_compile_main_scalar_common_9[5])),
    ...
    case (MR_Integer) 1:
      {
        ...
        SymNames_21 = mercury__list__map_2_f_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), (MR_Word) (&top_level__mercury_compile_main_scalar_common_5[6]), LocalModulesList_20);
    ...
    case (MR_Integer) 1:
      {
        ...
        else
        {
          ...
          mercury__solutions__solutions_2_p_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), (MR_Word) (&top_level__mercury_compile_main_scalar_common_5[3]), &LibModuleNames_20);
          {
            ...
            MR_hl_field(MR_mktag(0), IsShadowed_21, 0) = ((MR_Box) (&top_level__mercury_compile_main_scalar_common_9[4]));
