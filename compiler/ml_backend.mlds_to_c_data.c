    ...
    case (MR_Integer) 1:
      {
        ...
        MR_Word QualFuncLabel_113 = ((MR_Word) ((MR_hl_field(MR_mktag(0), CodeAddr_21, (MR_Integer) 0))));
        MR_Word ModuleName_115 = ((MR_Word) ((MR_hl_field(MR_mktag(0), QualFuncLabel_113, (MR_Integer) 0))));
        MR_Word FuncLabel_116 = ((MR_Word) ((MR_hl_field(MR_mktag(0), QualFuncLabel_113, (MR_Integer) 1))));
        MR_Word ProcLabel_117 = ((MR_Word) ((MR_hl_field(MR_mktag(0), FuncLabel_116, (MR_Integer) 0))));
        MR_Word MaybeAux_118 = ((MR_Word) ((MR_hl_field(MR_mktag(0), FuncLabel_116, (MR_Integer) 1))));
        MR_Word QualProcLabel_119;
        MR_String Var_121;

        {
          QualProcLabel_119 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), QualProcLabel_119, 0) = ((MR_Box) (ModuleName_115));
          MR_hl_field(MR_mktag(0), QualProcLabel_119, 1) = ((MR_Box) (ProcLabel_117));
        }
        ml_backend__mlds_to_c_name__mlds_output_fully_qualified_proc_label_4_p_0(Stream_7, QualProcLabel_119);
        Var_121 = ml_backend__ml_util__mlds_maybe_aux_func_id_to_suffix_1_f_0(MaybeAux_118);
        mercury__io__write_string_4_p_0(Stream_7, Var_121);
      }
      break;
    case (MR_Integer) 2:
      {
        ...
        case (MR_Integer) 16:
          {
            ...
            Var_77 = ml_backend__mlds__ml_local_var_name_to_string_1_f_0(LocalVarName_22);
            MangledLocalVarName_23 = parse_tree__prog_foreign__name_mangle_1_f_0(Var_77);
            mercury__io__write_string_4_p_0(Stream_7, (MR_String) "&");
