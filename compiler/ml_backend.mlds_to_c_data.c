          ...
          if (((MR_tag((MR_Word) FieldId_13)) == (MR_Integer) 1))
          {
            ...
            else
            {
              ...
              else
              {
                ...
                ml_backend__mlds_to_c_data__mlds_output_rval_5_p_0(Opts_6, PtrRval_11, Stream_8);
                mercury__io__write_string_4_p_0(Stream_8, (MR_String) ", ");
                PtagUint8_92 = (uint8_t) (Ptag_84);
                mercury__io__write_string_4_p_0(Stream_8, (MR_String) "MR_mktag(");
                mercury__io__write_uint8_4_p_0(Stream_8, PtagUint8_92);
                mercury__io__write_string_4_p_0(Stream_8, (MR_String) ")");
              }
              mercury__io__write_string_4_p_0(Stream_8, (MR_String) "))->");
            }
          ...
          else
          {
            ...
            if (succeeded)
            {
              ...
              else
              {
                ...
                uint8_t PtagUint8_97;

                mercury__io__write_string_4_p_0(Stream_8, (MR_String) "MR_hl_field(");
                PtagUint8_97 = (uint8_t) (Ptag_20);
                mercury__io__write_string_4_p_0(Stream_8, (MR_String) "MR_mktag(");
                mercury__io__write_uint8_4_p_0(Stream_8, PtagUint8_97);
                mercury__io__write_string_4_p_0(Stream_8, (MR_String) ")");
                mercury__io__write_string_4_p_0(Stream_8, (MR_String) ", ");
              }
              ml_backend__mlds_to_c_data__mlds_output_rval_5_p_0(Opts_6, PtrRval_11, Stream_8);
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          TypeInfo__25_25 = (MR_Word) (&ml_backend__mlds_to_c_data_scalar_common_2[0]);
          {
            MR_Word base;
          ...
          succeeded = mercury__builtin__unify_2_p_0(TypeInfo__25_25, ((MR_Box) (Ptag_8)), ((MR_Box) (Var_21)));
          if (succeeded)
          {
