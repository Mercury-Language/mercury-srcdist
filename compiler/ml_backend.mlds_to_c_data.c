...
ml_backend__mlds_to_c_data__IntroducedFrom__pred__mlds_output_rval_const__971__1_2_p_0(
  MR_Word Lang_12,
  MR_Word HeadVar__2_63);

static MR_bool MR_CALL 
ml_backend__mlds_to_c_data__IntroducedFrom__pred__mlds_output_float_bits__426__1_2_p_0(
...
{
  {
    ...
    switch (MR_tag((MR_Word) Op_8)) {
          ...
          case (MR_Integer) 3:
            {
              ...
              if (succeeded)
              {
                Var_179 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Y_10, (MR_Integer) 1))));
                succeeded = ((MR_tag((MR_Word) Var_179)) == (MR_Integer) 2);
                if (succeeded)
                  YN_13 = ((MR_Integer) ((MR_hl_field(MR_mktag(2), Var_179, (MR_Integer) 0))));
              }
              if (succeeded)
          ...
          case (MR_Integer) 22:
            {
              ...
              succeeded = ml_backend__mlds_to_c_data__is_aligned_dword_field_3_p_0(X_9, Y_10, &PtrRval_33);
              if (succeeded)
              {
                mercury__io__write_string_3_p_0((MR_String) "_ptr(MR_dword_ptr(");
                ml_backend__mlds_to_c_data__mlds_output_rval_4_p_0(Opts_7, PtrRval_33);
                mercury__io__write_string_3_p_0((MR_String) "))");
              }
              else
              {
          ...
          case (MR_Integer) 23:
            {
              ...
              succeeded = ml_backend__mlds_to_c_data__is_aligned_dword_field_3_p_0(X_9, Y_10, &PtrRval_338);
              if (succeeded)
              {
                mercury__io__write_string_3_p_0((MR_String) "_ptr(MR_dword_ptr(");
                ml_backend__mlds_to_c_data__mlds_output_rval_4_p_0(Opts_7, PtrRval_338);
                mercury__io__write_string_3_p_0((MR_String) "))");
              }
              else
              {
          ...
          case (MR_Integer) 24:
            {
              ...
              succeeded = ml_backend__mlds_to_c_data__is_aligned_dword_field_3_p_0(X_9, Y_10, &PtrRval_955);
              if (succeeded)
              {
                mercury__io__write_string_3_p_0((MR_String) "_ptr(MR_dword_ptr(");
                ml_backend__mlds_to_c_data__mlds_output_rval_4_p_0(Opts_7, PtrRval_955);
                mercury__io__write_string_3_p_0((MR_String) "))");
              }
              else
              {
      ...
      case (MR_Integer) 2:
        {
          MR_Word IntType_805 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(2), Op_8, (MR_Integer) 0))) & (MR_Integer) 15);
      ...
      case (MR_Integer) 3:
        switch (((MR_Integer) ((MR_hl_field(MR_mktag(3), Op_8, (MR_Integer) 0))))) {
          ...
          case (MR_Integer) 0:
            {
              MR_Word IntType_640 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(3), Op_8, (MR_Integer) 1))) & (MR_Integer) 15);
          ...
          case (MR_Integer) 3:
            {
              ...
              if (succeeded)
              {
                Var_85 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Y_10, (MR_Integer) 1))));
                succeeded = ((MR_tag((MR_Word) Var_85)) == (MR_Integer) 2);
                if (succeeded)
                  YInt_31 = ((MR_Integer) ((MR_hl_field(MR_mktag(2), Var_85, (MR_Integer) 0))));
              }
              if (succeeded)
                mercury__io__write_int_3_p_0(YInt_31);
              else
                ml_backend__mlds_to_c_data__mlds_output_rval_as_op_arg_4_p_0(Opts_7, Y_10);
              mercury__io__write_string_3_p_0((MR_String) ")");
            }
          ...
          case (MR_Integer) 4:
            {
              ...
              if (succeeded)
              {
                Var_981 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Y_10, (MR_Integer) 1))));
                succeeded = ((MR_tag((MR_Word) Var_981)) == (MR_Integer) 2);
                if (succeeded)
                  YInt_982 = ((MR_Integer) ((MR_hl_field(MR_mktag(2), Var_981, (MR_Integer) 0))));
              }
              if (succeeded)
                mercury__io__write_int_3_p_0(YInt_982);
              else
                ml_backend__mlds_to_c_data__mlds_output_rval_as_op_arg_4_p_0(Opts_7, Y_10);
              mercury__io__write_string_3_p_0((MR_String) ")");
            }
          ...
          case (MR_Integer) 11:
            {
              MR_Integer N_32 = ((MR_Integer) ((MR_hl_field(MR_mktag(3), Op_8, (MR_Integer) 1))));

              mercury__io__write_string_3_p_0((MR_String) "MR_offset_streq(");
              mercury__io__write_int_3_p_0(N_32);
              mercury__io__write_string_3_p_0((MR_String) ", ");
              ml_backend__mlds_to_c_data__mlds_output_rval_as_op_arg_4_p_0(Opts_7, X_9);
              mercury__io__write_string_3_p_0((MR_String) ", ");
              ml_backend__mlds_to_c_data__mlds_output_rval_as_op_arg_4_p_0(Opts_7, Y_10);
...
{
  {
    ...
    succeeded = ml_backend__mlds_to_c_data__IntroducedFrom__pred__mlds_output_rval_const__971__1_2_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))));
    return succeeded;
  }
}
...
{
  {
    ...
    succeeded = ml_backend__mlds_to_c_data__IntroducedFrom__pred__mlds_output_float_bits__426__1_2_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))));
    return succeeded;
  }
}
