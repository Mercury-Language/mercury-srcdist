...
ml_backend__mlds_to_c_data__IntroducedFrom__pred__mlds_output_rval_const__1003__1_2_p_0(
  MR_Word Lang_14,
  ...
  switch (MR_tag((MR_Word) Op_10)) {
        ...
        case (MR_Integer) 7:
          {
            ...
            succeeded = ml_backend__mlds_to_c_data__is_aligned_dword_field_3_p_0(X_11, Y_12, &PtrRval_813);
            if (succeeded)
            {
              mercury__io__write_string_4_p_0(Stream_9, (MR_String) "MR_uint64_from_dword");
              mercury__io__write_string_4_p_0(Stream_9, (MR_String) "_ptr(MR_dword_ptr(");
              ml_backend__mlds_to_c_data__mlds_output_rval_5_p_0(Opts_8, PtrRval_813, Stream_9);
              mercury__io__write_string_4_p_0(Stream_9, (MR_String) "))");
            }
            else
            {
    ...
    case (MR_Integer) 3:
      switch (((MR_Integer) ((MR_hl_field(3, Op_10, 0))))) {
        ...
        case (MR_Integer) 0:
          {
            MR_Word ShiftType_866 = ((MR_Unsigned) ((MR_hl_field(3, Op_10, 1))) & (MR_Integer) 1);
            MR_Integer YInt_860;
            MR_Word Var_850;
            ...
            if (succeeded)
            {
              Var_850 = ((MR_Word) ((MR_hl_field(3, Y_12, 1))));
              succeeded = ((MR_tag((MR_Word) Var_850)) == (MR_Integer) 2);
              if (succeeded)
                YInt_860 = ((MR_Integer) ((MR_hl_field(2, Var_850, 0))));
            }
            if (succeeded)
              mercury__io__write_int_4_p_0(Stream_9, YInt_860);
            else
            {
              MR_Unsigned YUInt_856;
              MR_Word Var_851;

              succeeded = ((((MR_tag((MR_Word) Y_12)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(3, Y_12, 0)))) == (MR_Integer) 1)));
              if (succeeded)
              {
                Var_851 = ((MR_Word) ((MR_hl_field(3, Y_12, 1))));
                succeeded = ((((MR_tag((MR_Word) Var_851)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(3, Var_851, 0)))) == (MR_Integer) 0)));
                if (succeeded)
                  YUInt_856 = ((MR_Unsigned) ((MR_hl_field(3, Var_851, 1))));
              }
              if (succeeded)
                mercury__io__write_uint_4_p_0(Stream_9, YUInt_856);
              else
              {
                switch (ShiftType_866) {
                  default: /*NOTREACHED*/ MR_assert(0);
                  case (MR_Integer) 0:
                    {
                    }
        ...
        case (MR_Integer) 4:
          {
            ...
            OpStr_773 = backend_libs__builtin_ops__cmp_op_c_operator_1_f_0(CmpOp_237);
            mercury__io__write_string_4_p_0(Stream_9, (MR_String) "(");
            ml_backend__mlds_to_c_data__mlds_output_rval_as_op_arg_5_p_0(Opts_8, Stream_9, X_11);
            mercury__io__write_string_4_p_0(Stream_9, (MR_String) " ");
            mercury__io__write_string_4_p_0(Stream_9, OpStr_773);
            mercury__io__write_string_4_p_0(Stream_9, (MR_String) " ");
            ml_backend__mlds_to_c_data__mlds_output_rval_as_op_arg_5_p_0(Opts_8, Stream_9, Y_12);
            mercury__io__write_string_4_p_0(Stream_9, (MR_String) ")");
          }
        ...
        case (MR_Integer) 7:
          {
            ...
            if ((MaybeSize_33 == (MR_Word) ((MR_Unsigned) 0U)))
            {
              ...
              mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&ml_backend__mlds_to_c_data_scalar_common_1[0]), Offset_32, &Var_924);
              mercury__io__write_string_4_p_0(Stream_9, Var_924);
              mercury__io__write_string_4_p_0(Stream_9, (MR_String) ", ");
              ml_backend__mlds_to_c_data__mlds_output_rval_as_op_arg_5_p_0(Opts_8, Stream_9, X_11);
              mercury__io__write_string_4_p_0(Stream_9, (MR_String) ", ");
              ml_backend__mlds_to_c_data__mlds_output_rval_as_op_arg_5_p_0(Opts_8, Stream_9, Y_12);
            ...
            else
            {
              ...
              mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&ml_backend__mlds_to_c_data_scalar_common_1[0]), Offset_32, &Var_903);
              mercury__io__write_string_4_p_0(Stream_9, Var_903);
              mercury__io__write_string_4_p_0(Stream_9, (MR_String) ", ");
              mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&ml_backend__mlds_to_c_data_scalar_common_1[0]), Size_34, &Var_913);
              mercury__io__write_string_4_p_0(Stream_9, Var_913);
              mercury__io__write_string_4_p_0(Stream_9, (MR_String) ", ");
              ml_backend__mlds_to_c_data__mlds_output_rval_as_op_arg_5_p_0(Opts_8, Stream_9, X_11);
              mercury__io__write_string_4_p_0(Stream_9, (MR_String) ", ");
              ml_backend__mlds_to_c_data__mlds_output_rval_as_op_arg_5_p_0(Opts_8, Stream_9, Y_12);
        ...
        case (MR_Integer) 8:
          {
            MR_Word Var_85;
            MR_Word CmpOp_230 = ((MR_Unsigned) ((MR_hl_field(3, Op_10, 1))) & (MR_Integer) 7);
            MR_String OpStr_231;

            Var_85 = (MR_Word) (CmpOp_230);
            OpStr_231 = backend_libs__builtin_ops__cmp_op_c_operator_1_f_0(Var_85);
            mercury__io__write_string_4_p_0(Stream_9, (MR_String) "(((MR_Unsigned) ");
            ml_backend__mlds_to_c_data__mlds_output_rval_as_unsigned_op_arg_6_p_0(Opts_8, Stream_9, (MR_Integer) 2147483647, X_11);
            mercury__io__write_string_4_p_0(Stream_9, (MR_String) ") ");
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = ml_backend__mlds_to_c_data__IntroducedFrom__pred__mlds_output_rval_const__1003__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) ((MR_hl_field(0, closure, 4)))));
  return succeeded;
}
