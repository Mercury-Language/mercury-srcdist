...
{
  {
    ...
    succeeded = ml_backend__mlds_to_c_data__IntroducedFrom__pred__mlds_output_rval_const__1003__1_2_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))));
    return succeeded;
  }
}
