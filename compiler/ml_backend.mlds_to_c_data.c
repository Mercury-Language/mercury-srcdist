...
ml_backend__mlds_to_c_data__IntroducedFrom__pred__mlds_output_rval_const__994__1_2_p_0(
  MR_Word Lang_14,
...
top_of_proc_4:;
  {
    ...
    if (succeeded)
    {
      ...
      if (!(succeeded))
      {
        ...
        Var_48 = ml_backend__mlds_to_c_data__is_an_address_1_f_0(InnerRval_13);
  ...
  switch (MR_tag((MR_Word) Type_9)) {
    ...
    case (MR_Integer) 0:
      switch (MR_unmkbody(Type_9)) {
        ...
        case (MR_Integer) 9:
          {
            MR_String CastStr_67;

            CastStr_67 = ml_backend__mlds_to_c_type__cast_to_prefix_string_for_c_2_f_0(Opts_7, Type_9);
            mercury__io__write_string_4_p_0(Stream_8, (MR_String) "(");
            mercury__io__write_string_4_p_0(Stream_8, CastStr_67);
            mercury__io__write_string_4_p_0(Stream_8, (MR_String) "(");
            ml_backend__mlds_to_c_data__mlds_output_rval_5_p_0(Opts_7, Rval_10, Stream_8);
            mercury__io__write_string_4_p_0(Stream_8, (MR_String) "))");
          }
        ...
        case (MR_Integer) 4:
          {
            MR_String CastStr_79;

            CastStr_79 = ml_backend__mlds_to_c_type__cast_to_prefix_string_for_c_2_f_0(Opts_7, Type_9);
            mercury__io__write_string_4_p_0(Stream_8, (MR_String) "(");
            mercury__io__write_string_4_p_0(Stream_8, CastStr_79);
            mercury__io__write_string_4_p_0(Stream_8, (MR_String) "(MR_Word) ");
            ml_backend__mlds_to_c_data__mlds_output_rval_5_p_0(Opts_7, Rval_10, Stream_8);
            mercury__io__write_string_4_p_0(Stream_8, (MR_String) ")");
          }
    ...
    case (MR_Integer) 3:
      switch (((MR_Integer) ((MR_hl_field(3, Type_9, (MR_Integer) 0))))) {
        ...
        case (MR_Integer) 1:
          {
            MR_Word MercuryType_24 = ((MR_Word) ((MR_hl_field(3, Type_9, (MR_Integer) 1))));

            switch (MR_tag((MR_Word) MercuryType_24)) {
              default: /*NOTREACHED*/ MR_assert(0);
              case (MR_Integer) 0:
              case (MR_Integer) 1:
                {
                  MR_String CastStr_55;

                  CastStr_55 = ml_backend__mlds_to_c_type__cast_to_prefix_string_for_c_2_f_0(Opts_7, Type_9);
                  mercury__io__write_string_4_p_0(Stream_8, (MR_String) "(");
                  mercury__io__write_string_4_p_0(Stream_8, CastStr_55);
                  mercury__io__write_string_4_p_0(Stream_8, (MR_String) "(");
                  ml_backend__mlds_to_c_data__mlds_output_rval_5_p_0(Opts_7, Rval_10, Stream_8);
                  mercury__io__write_string_4_p_0(Stream_8, (MR_String) "))");
                }
        ...
        case (MR_Integer) 4:
          {
            MR_Word IntType_23 = ((MR_Unsigned) ((MR_hl_field(3, Type_9, (MR_Integer) 1))) & (MR_Integer) 15);
            ...
            switch (IntType_23) {
              ...
              case (MR_Integer) 1:
                {
                  MR_String CastStr_95;

                  CastStr_95 = ml_backend__mlds_to_c_type__cast_to_prefix_string_for_c_2_f_0(Opts_7, Type_9);
                  mercury__io__write_string_4_p_0(Stream_8, (MR_String) "(");
                  mercury__io__write_string_4_p_0(Stream_8, CastStr_95);
                  mercury__io__write_string_4_p_0(Stream_8, (MR_String) "(");
                  ml_backend__mlds_to_c_data__mlds_output_rval_5_p_0(Opts_7, Rval_10, Stream_8);
                  mercury__io__write_string_4_p_0(Stream_8, (MR_String) "))");
                }
              ...
              case (MR_Integer) 3:
                {
                  MR_String CastStr_107;

                  CastStr_107 = ml_backend__mlds_to_c_type__cast_to_prefix_string_for_c_2_f_0(Opts_7, Type_9);
                  mercury__io__write_string_4_p_0(Stream_8, (MR_String) "(");
                  mercury__io__write_string_4_p_0(Stream_8, CastStr_107);
                  mercury__io__write_string_4_p_0(Stream_8, (MR_String) "(MR_Word) ");
                  ml_backend__mlds_to_c_data__mlds_output_rval_5_p_0(Opts_7, Rval_10, Stream_8);
                  mercury__io__write_string_4_p_0(Stream_8, (MR_String) ")");
                }
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = ml_backend__mlds_to_c_data__IntroducedFrom__pred__mlds_output_rval_const__994__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 4)))));
  return succeeded;
}
