  ...
  MR_Word Initializer_10)
{
  switch (MR_tag((MR_Word) Initializer_10)) {
    ...
    case (MR_Integer) 2:
      {
        MR_Word Inits_255 = ((MR_Word) ((MR_hl_field(2, Initializer_10, 1))));
        ...
        {
          MR_Word HeadInit_183 = ((MR_Word) ((MR_hl_field(1, Inits_255, 0))));
          MR_Word TailInits_184 = ((MR_Word) ((MR_hl_field(1, Inits_255, 1))));
              ...
              case (MR_Integer) 1:
                {
                  ...
                  mercury__io__write_string_4_p_0(Stream_8, (MR_String) "{ ");
                  ml_backend__mlds_to_c_data__mlds_output_initializer_body_6_p_0(Opts_7, Stream_8, (MR_Unsigned) 0U, HeadInit_183);
                  mercury__io__write_string_4_p_0(Stream_8, (MR_String) " }");
                }
                break;
              case (MR_Integer) 2:
              case (MR_Integer) 3:
                {
                  ...
                  mercury__io__write_string_4_p_0(Stream_8, IndentStr_256);
                  mercury__io__write_string_4_p_0(Stream_8, (MR_String) "{\n");
                  Var_78 = (Indent_9 + (MR_Unsigned) 1U);
          ...
          else
          {
            ...
            mercury__io__write_string_4_p_0(Stream_8, IndentStr_256);
            mercury__io__write_string_4_p_0(Stream_8, (MR_String) "{\n");
            Var_142 = (Indent_9 + (MR_Unsigned) 1U);
      ...
      case (MR_Integer) 1:
        {
          ...
          mercury__io__write_string_4_p_0(Stream_8, (MR_String) "&");
          ModuleName_94 = ((MR_Word) ((MR_hl_field(0, ScalarCommon_93, 0))));
          Var_101 = ((MR_Word) ((MR_hl_field(0, ScalarCommon_93, 2))));
          RowNum_97 = ((MR_Integer) ((MR_hl_field(0, ScalarCommon_93, 3))));
  ...
  switch (MR_tag((MR_Word) Op_10)) {
        ...
        case (MR_Integer) 7:
          {
            ...
            succeeded = ml_backend__mlds_to_c_data__is_aligned_dword_field_3_p_0(X_11, Y_12, &PtrRval_293);
            if (succeeded)
            {
              mercury__io__write_string_4_p_0(Stream_9, (MR_String) "MR_int64_from_dword");
              mercury__io__write_string_4_p_0(Stream_9, (MR_String) "_ptr(MR_dword_ptr(");
              ml_backend__mlds_to_c_data__mlds_output_rval_5_p_0(Opts_8, PtrRval_293, Stream_9);
              mercury__io__write_string_4_p_0(Stream_9, (MR_String) "))");
            }
            else
            {
        ...
        case (MR_Integer) 8:
          {
            ...
            succeeded = ml_backend__mlds_to_c_data__is_aligned_dword_field_3_p_0(X_11, Y_12, &PtrRval_828);
            if (succeeded)
            {
              mercury__io__write_string_4_p_0(Stream_9, (MR_String) "MR_uint64_from_dword");
              mercury__io__write_string_4_p_0(Stream_9, (MR_String) "_ptr(MR_dword_ptr(");
              ml_backend__mlds_to_c_data__mlds_output_rval_5_p_0(Opts_8, PtrRval_828, Stream_9);
              mercury__io__write_string_4_p_0(Stream_9, (MR_String) "))");
            }
            else
            {
    ...
    case (MR_Integer) 3:
      switch (((MR_Integer) ((MR_hl_field(3, Op_10, 0))))) {
        ...
        case (MR_Integer) 0:
          {
            MR_Word ShiftType_881 = ((MR_Unsigned) ((MR_hl_field(3, Op_10, 1))) & (MR_Integer) 1);
            MR_Integer YInt_875;
            MR_Word Var_865;
            ...
            if (succeeded)
            {
              Var_865 = ((MR_Word) ((MR_hl_field(3, Y_12, 1))));
              succeeded = ((MR_tag((MR_Word) Var_865)) == (MR_Integer) 2);
              if (succeeded)
                YInt_875 = ((MR_Integer) ((MR_hl_field(2, Var_865, 0))));
            }
            if (succeeded)
              mercury__io__write_int_4_p_0(Stream_9, YInt_875);
            else
            {
              MR_Unsigned YUInt_871;
              MR_Word Var_866;

              succeeded = ((((MR_tag((MR_Word) Y_12)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(3, Y_12, 0)))) == (MR_Integer) 1)));
              if (succeeded)
              {
                Var_866 = ((MR_Word) ((MR_hl_field(3, Y_12, 1))));
                succeeded = ((((MR_tag((MR_Word) Var_866)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(3, Var_866, 0)))) == (MR_Integer) 0)));
                if (succeeded)
                  YUInt_871 = ((MR_Unsigned) ((MR_hl_field(3, Var_866, 1))));
              }
              if (succeeded)
                mercury__io__write_uint_4_p_0(Stream_9, YUInt_871);
              else
              {
                switch (ShiftType_881) {
                  default: /*NOTREACHED*/ MR_assert(0);
                  case (MR_Integer) 0:
                    {
                    }
        ...
        case (MR_Integer) 4:
          {
            ...
            OpStr_788 = backend_libs__builtin_ops__cmp_op_c_operator_1_f_0(CmpOp_237);
            mercury__io__write_string_4_p_0(Stream_9, (MR_String) "(");
            ml_backend__mlds_to_c_data__mlds_output_rval_as_op_arg_5_p_0(Opts_8, Stream_9, X_11);
            mercury__io__write_string_4_p_0(Stream_9, (MR_String) " ");
            mercury__io__write_string_4_p_0(Stream_9, OpStr_788);
            mercury__io__write_string_4_p_0(Stream_9, (MR_String) " ");
            ml_backend__mlds_to_c_data__mlds_output_rval_as_op_arg_5_p_0(Opts_8, Stream_9, Y_12);
            mercury__io__write_string_4_p_0(Stream_9, (MR_String) ")");
          }
        ...
        case (MR_Integer) 7:
          {
            ...
            if ((MaybeSize_33 == (MR_Word) ((MR_Unsigned) 0U)))
            {
              ...
              mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&ml_backend__mlds_to_c_data_scalar_common_1[0]), Offset_32, &Var_939);
              mercury__io__write_string_4_p_0(Stream_9, Var_939);
              mercury__io__write_string_4_p_0(Stream_9, (MR_String) ", ");
              ml_backend__mlds_to_c_data__mlds_output_rval_as_op_arg_5_p_0(Opts_8, Stream_9, X_11);
              mercury__io__write_string_4_p_0(Stream_9, (MR_String) ", ");
              ml_backend__mlds_to_c_data__mlds_output_rval_as_op_arg_5_p_0(Opts_8, Stream_9, Y_12);
            ...
            else
            {
              ...
              mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&ml_backend__mlds_to_c_data_scalar_common_1[0]), Offset_32, &Var_918);
              mercury__io__write_string_4_p_0(Stream_9, Var_918);
              mercury__io__write_string_4_p_0(Stream_9, (MR_String) ", ");
              mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&ml_backend__mlds_to_c_data_scalar_common_1[0]), Size_34, &Var_928);
              mercury__io__write_string_4_p_0(Stream_9, Var_928);
              mercury__io__write_string_4_p_0(Stream_9, (MR_String) ", ");
              ml_backend__mlds_to_c_data__mlds_output_rval_as_op_arg_5_p_0(Opts_8, Stream_9, X_11);
              mercury__io__write_string_4_p_0(Stream_9, (MR_String) ", ");
              ml_backend__mlds_to_c_data__mlds_output_rval_as_op_arg_5_p_0(Opts_8, Stream_9, Y_12);
        ...
        case (MR_Integer) 8:
          {
            MR_Word Var_763;
            MR_Word CmpOp_776 = ((MR_Unsigned) ((MR_hl_field(3, Op_10, 1))) & (MR_Integer) 7);
            MR_String OpStr_777;

            Var_763 = (MR_Word) (CmpOp_776);
            OpStr_777 = backend_libs__builtin_ops__cmp_op_c_operator_1_f_0(Var_763);
            mercury__io__write_string_4_p_0(Stream_9, (MR_String) "(((MR_Unsigned) ");
            ml_backend__mlds_to_c_data__mlds_output_rval_as_unsigned_op_arg_6_p_0(Opts_8, Stream_9, (MR_Integer) 2147483647, X_11);
            mercury__io__write_string_4_p_0(Stream_9, (MR_String) ") ");
            mercury__io__write_string_4_p_0(Stream_9, OpStr_777);
            mercury__io__write_string_4_p_0(Stream_9, (MR_String) " ((MR_Unsigned) ");
            ml_backend__mlds_to_c_data__mlds_output_rval_as_unsigned_op_arg_6_p_0(Opts_8, Stream_9, (MR_Integer) 2147483647, Y_12);
            mercury__io__write_string_4_p_0(Stream_9, (MR_String) "))");
          }
        ...
        case (MR_Integer) 10:
          {
            ...
            OpStr_275 = backend_libs__builtin_ops__cmp_op_c_operator_1_f_0(CmpOp_226);
            mercury__io__write_string_4_p_0(Stream_9, (MR_String) "(");
            ml_backend__mlds_to_c_data__mlds_output_bracketed_rval_5_p_0(Opts_8, Stream_9, X_11);
            mercury__io__write_string_4_p_0(Stream_9, (MR_String) " ");
            mercury__io__write_string_4_p_0(Stream_9, OpStr_275);
            mercury__io__write_string_4_p_0(Stream_9, (MR_String) " ");
            ml_backend__mlds_to_c_data__mlds_output_bracketed_rval_5_p_0(Opts_8, Stream_9, Y_12);
            mercury__io__write_string_4_p_0(Stream_9, (MR_String) ")");
          }
  ...
  MR_Word Const_8)
{
  ...
  switch (MR_tag((MR_Word) Const_8)) {
    ...
    case (MR_Integer) 1:
      {
        ...
        MR_Word QualFuncLabel_168 = ((MR_Word) ((MR_hl_field(0, CodeAddr_21, 0))));
        MR_Word ModuleName_170 = ((MR_Word) ((MR_hl_field(0, QualFuncLabel_168, 0))));
        MR_Word FuncLabel_171 = ((MR_Word) ((MR_hl_field(0, QualFuncLabel_168, 1))));
        MR_Word ProcLabel_172 = ((MR_Word) ((MR_hl_field(0, FuncLabel_171, 0))));
        MR_Word MaybeAux_173 = ((MR_Word) ((MR_hl_field(0, FuncLabel_171, 1))));
    ...
    case (MR_Integer) 2:
      {
        MR_Integer N_146 = ((MR_Integer) ((MR_hl_field(2, Const_8, 0))));

        backend_libs__c_util__output_int_as_c_expr_4_p_0(Stream_7, N_146);
      }
      break;
    case (MR_Integer) 3:
        ...
        case (MR_Integer) 18:
          {
            ...
            MR_Word MLDS_ModuleName_110 = ((MR_Word) ((MR_hl_field(3, Const_8, 1))));
        ...
        case (MR_Integer) 19:
          {
            ...
            MR_Word MLDS_ModuleName_134 = ((MR_Word) ((MR_hl_field(0, QualProcLabel_28, 0))));
