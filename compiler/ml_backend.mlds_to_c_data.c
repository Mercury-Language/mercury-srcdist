...
{
  {
    ...
    switch (MR_tag((MR_Word) Op_8)) {
          ...
          case (MR_Integer) 3:
            {
              ...
              if (succeeded)
              {
                Var_188 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Y_10, (MR_Integer) 1))));
                succeeded = ((MR_tag((MR_Word) Var_188)) == (MR_Integer) 2);
                if (succeeded)
                  YN_13 = ((MR_Integer) ((MR_hl_field(MR_mktag(2), Var_188, (MR_Integer) 0))));
              }
              if (succeeded)
          ...
          case (MR_Integer) 23:
            {
              ...
              succeeded = ml_backend__mlds_to_c_data__is_aligned_dword_field_3_p_0(X_9, Y_10, &PtrRval_347);
              if (succeeded)
              {
                mercury__io__write_string_3_p_0((MR_String) "_ptr(MR_dword_ptr(");
                ml_backend__mlds_to_c_data__mlds_output_rval_4_p_0(Opts_7, PtrRval_347);
                mercury__io__write_string_3_p_0((MR_String) "))");
              }
              else
              {
          ...
          case (MR_Integer) 24:
            {
              ...
              succeeded = ml_backend__mlds_to_c_data__is_aligned_dword_field_3_p_0(X_9, Y_10, &PtrRval_982);
              if (succeeded)
              {
                mercury__io__write_string_3_p_0((MR_String) "_ptr(MR_dword_ptr(");
                ml_backend__mlds_to_c_data__mlds_output_rval_4_p_0(Opts_7, PtrRval_982);
                mercury__io__write_string_3_p_0((MR_String) "))");
              }
              else
              {
      ...
      case (MR_Integer) 2:
        {
          MR_Word IntType_831 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(2), Op_8, (MR_Integer) 0))) & (MR_Integer) 15);
      ...
      case (MR_Integer) 3:
        switch (((MR_Integer) ((MR_hl_field(MR_mktag(3), Op_8, (MR_Integer) 0))))) {
          ...
          case (MR_Integer) 0:
            {
              MR_Word IntType_659 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(3), Op_8, (MR_Integer) 1))) & (MR_Integer) 15);
          ...
          case (MR_Integer) 4:
            {
              MR_Word ShiftType_1024 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(3), Op_8, (MR_Integer) 1))) & (MR_Integer) 1);
              MR_Integer YInt_1018;
              MR_Word Var_1008;
              ...
              if (succeeded)
              {
                Var_1008 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Y_10, (MR_Integer) 1))));
                succeeded = ((MR_tag((MR_Word) Var_1008)) == (MR_Integer) 2);
                if (succeeded)
                  YInt_1018 = ((MR_Integer) ((MR_hl_field(MR_mktag(2), Var_1008, (MR_Integer) 0))));
              }
              if (succeeded)
                mercury__io__write_int_3_p_0(YInt_1018);
              else
              {
                MR_Unsigned YUInt_1014;
                MR_Word Var_1009;

                succeeded = ((((MR_tag((MR_Word) Y_10)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(MR_mktag(3), Y_10, (MR_Integer) 0)))) == (MR_Integer) 1)));
                if (succeeded)
                {
                  Var_1009 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Y_10, (MR_Integer) 1))));
                  succeeded = ((((MR_tag((MR_Word) Var_1009)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(MR_mktag(3), Var_1009, (MR_Integer) 0)))) == (MR_Integer) 0)));
                  if (succeeded)
                    YUInt_1014 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(3), Var_1009, (MR_Integer) 1))));
                }
                if (succeeded)
                  mercury__io__write_uint_3_p_0(YUInt_1014);
                else
                {
                  switch (ShiftType_1024) {
                    default: /*NOTREACHED*/ MR_assert(0);
                    case (MR_Integer) 0:
                      {
                      }
