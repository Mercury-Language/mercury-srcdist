...
ml_backend__mlds_to_c_data__IntroducedFrom__pred__mlds_output_rval_const__1008__1_2_p_0(
  MR_Word Lang_14,
...
top_of_proc_4:;
  {
    ...
    if (succeeded)
    {
      ...
      if (!(succeeded))
      {
        ...
        Var_49 = ml_backend__mlds_to_c_data__is_an_address_1_f_0(InnerRval_13);
  ...
  switch (MR_tag((MR_Word) Type_9)) {
    ...
    case (MR_Integer) 0:
      switch (MR_unmkbody(Type_9)) {
        ...
        case (MR_Integer) 9:
          {
            MR_String CastStr_68;

            CastStr_68 = ml_backend__mlds_to_c_type__cast_to_prefix_string_for_c_2_f_0(Opts_7, Type_9);
            mercury__io__write_string_4_p_0(Stream_8, (MR_String) "(");
            mercury__io__write_string_4_p_0(Stream_8, CastStr_68);
            mercury__io__write_string_4_p_0(Stream_8, (MR_String) "(");
            ml_backend__mlds_to_c_data__mlds_output_rval_5_p_0(Opts_7, Rval_10, Stream_8);
            mercury__io__write_string_4_p_0(Stream_8, (MR_String) "))");
          }
        ...
        case (MR_Integer) 4:
          {
            MR_String CastStr_80;

            CastStr_80 = ml_backend__mlds_to_c_type__cast_to_prefix_string_for_c_2_f_0(Opts_7, Type_9);
            mercury__io__write_string_4_p_0(Stream_8, (MR_String) "(");
            mercury__io__write_string_4_p_0(Stream_8, CastStr_80);
            mercury__io__write_string_4_p_0(Stream_8, (MR_String) "(MR_Word) ");
            ml_backend__mlds_to_c_data__mlds_output_rval_5_p_0(Opts_7, Rval_10, Stream_8);
            mercury__io__write_string_4_p_0(Stream_8, (MR_String) ")");
          }
        ...
        case (MR_Integer) 3:
          {
            ...
            switch (MR_tag((MR_Word) MercuryType_26)) {
              ...
              case (MR_Integer) 3:
                {
                  MR_String CastStr_56;

                  CastStr_56 = ml_backend__mlds_to_c_type__cast_to_prefix_string_for_c_2_f_0(Opts_7, Type_9);
                  mercury__io__write_string_4_p_0(Stream_8, (MR_String) "(");
                  mercury__io__write_string_4_p_0(Stream_8, CastStr_56);
                  mercury__io__write_string_4_p_0(Stream_8, (MR_String) "(");
                  ml_backend__mlds_to_c_data__mlds_output_rval_5_p_0(Opts_7, Rval_10, Stream_8);
                  mercury__io__write_string_4_p_0(Stream_8, (MR_String) "))");
                }
        ...
        case (MR_Integer) 6:
          {
            ...
            switch (IntType_25) {
              ...
              case (MR_Integer) 1:
                {
                  MR_String CastStr_96;

                  CastStr_96 = ml_backend__mlds_to_c_type__cast_to_prefix_string_for_c_2_f_0(Opts_7, Type_9);
                  mercury__io__write_string_4_p_0(Stream_8, (MR_String) "(");
                  mercury__io__write_string_4_p_0(Stream_8, CastStr_96);
                  mercury__io__write_string_4_p_0(Stream_8, (MR_String) "(");
                  ml_backend__mlds_to_c_data__mlds_output_rval_5_p_0(Opts_7, Rval_10, Stream_8);
                  mercury__io__write_string_4_p_0(Stream_8, (MR_String) "))");
                }
              ...
              case (MR_Integer) 3:
                {
                  MR_String CastStr_108;

                  CastStr_108 = ml_backend__mlds_to_c_type__cast_to_prefix_string_for_c_2_f_0(Opts_7, Type_9);
                  mercury__io__write_string_4_p_0(Stream_8, (MR_String) "(");
                  mercury__io__write_string_4_p_0(Stream_8, CastStr_108);
                  mercury__io__write_string_4_p_0(Stream_8, (MR_String) "(MR_Word) ");
                  ml_backend__mlds_to_c_data__mlds_output_rval_5_p_0(Opts_7, Rval_10, Stream_8);
                  mercury__io__write_string_4_p_0(Stream_8, (MR_String) ")");
                }
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = ml_backend__mlds_to_c_data__IntroducedFrom__pred__mlds_output_rval_const__1008__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) ((MR_hl_field(0, closure, 4)))));
  return succeeded;
}
