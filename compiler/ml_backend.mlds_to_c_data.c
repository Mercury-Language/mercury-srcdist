  ...
  switch (MR_tag((MR_Word) Op_10)) {
        ...
        case (MR_Integer) 6:
          {
            ...
            succeeded = ml_backend__mlds_to_c_data__is_aligned_dword_field_3_p_0(X_11, Y_12, &PtrRval_295);
            if (succeeded)
            {
              mercury__io__write_string_4_p_0(Stream_9, (MR_String) "MR_int64_from_dword");
              mercury__io__write_string_4_p_0(Stream_9, (MR_String) "_ptr(MR_dword_ptr(");
              ml_backend__mlds_to_c_data__mlds_output_rval_5_p_0(Opts_8, PtrRval_295, Stream_9);
              mercury__io__write_string_4_p_0(Stream_9, (MR_String) "))");
            }
            else
            {
        ...
        case (MR_Integer) 7:
          {
            ...
            succeeded = ml_backend__mlds_to_c_data__is_aligned_dword_field_3_p_0(X_11, Y_12, &PtrRval_815);
            if (succeeded)
            {
              mercury__io__write_string_4_p_0(Stream_9, (MR_String) "MR_uint64_from_dword");
              mercury__io__write_string_4_p_0(Stream_9, (MR_String) "_ptr(MR_dword_ptr(");
              ml_backend__mlds_to_c_data__mlds_output_rval_5_p_0(Opts_8, PtrRval_815, Stream_9);
              mercury__io__write_string_4_p_0(Stream_9, (MR_String) "))");
            }
            else
            {
    ...
    case (MR_Integer) 1:
      {
        ...
        MR_Word ArithOp_238 = ((MR_Unsigned) ((MR_hl_field(1, Op_10, (MR_Integer) 0))) & (MR_Integer) 7);
    ...
    case (MR_Integer) 2:
      {
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
            YInt_30 = ((MR_Integer) ((MR_hl_field(2, Var_160, (MR_Integer) 0))));
        }
        if (succeeded)
        ...
        else
        {
          ...
          if (succeeded)
          {
            Var_162 = ((MR_Word) ((MR_hl_field(3, Y_12, (MR_Integer) 1))));
            succeeded = ((((MR_tag((MR_Word) Var_162)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(3, Var_162, (MR_Integer) 0)))) == (MR_Integer) 0)));
            if (succeeded)
              YUInt_31 = ((MR_Unsigned) ((MR_hl_field(3, Var_162, (MR_Integer) 1))));
          }
          if (succeeded)
    ...
    case (MR_Integer) 3:
      switch (((MR_Integer) ((MR_hl_field(3, Op_10, (MR_Integer) 0))))) {
        ...
        case (MR_Integer) 0:
          {
            MR_Word ShiftType_868 = ((MR_Unsigned) ((MR_hl_field(3, Op_10, (MR_Integer) 1))) & (MR_Integer) 1);
            MR_Integer YInt_862;
            MR_Word Var_852;
            ...
            if (succeeded)
            {
              Var_852 = ((MR_Word) ((MR_hl_field(3, Y_12, (MR_Integer) 1))));
              succeeded = ((MR_tag((MR_Word) Var_852)) == (MR_Integer) 2);
              if (succeeded)
                YInt_862 = ((MR_Integer) ((MR_hl_field(2, Var_852, (MR_Integer) 0))));
            }
            if (succeeded)
              mercury__io__write_int_4_p_0(Stream_9, YInt_862);
            else
            {
              MR_Unsigned YUInt_858;
              MR_Word Var_853;

              succeeded = ((((MR_tag((MR_Word) Y_12)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(3, Y_12, (MR_Integer) 0)))) == (MR_Integer) 1)));
              if (succeeded)
              {
                Var_853 = ((MR_Word) ((MR_hl_field(3, Y_12, (MR_Integer) 1))));
                succeeded = ((((MR_tag((MR_Word) Var_853)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(3, Var_853, (MR_Integer) 0)))) == (MR_Integer) 0)));
                if (succeeded)
                  YUInt_858 = ((MR_Unsigned) ((MR_hl_field(3, Var_853, (MR_Integer) 1))));
              }
              if (succeeded)
                mercury__io__write_uint_4_p_0(Stream_9, YUInt_858);
              else
              {
                switch (ShiftType_868) {
                  default: /*NOTREACHED*/ MR_assert(0);
                  case (MR_Integer) 0:
                    {
                    }
        ...
        case (MR_Integer) 4:
          {
            MR_Word CmpOp_239 = ((MR_Unsigned) ((MR_hl_field(3, Op_10, (MR_Integer) 1))) & (MR_Integer) 7);
            MR_String OpStr_775;

            OpStr_775 = backend_libs__builtin_ops__cmp_op_c_operator_1_f_0(CmpOp_239);
            mercury__io__write_string_4_p_0(Stream_9, (MR_String) "(");
            ml_backend__mlds_to_c_data__mlds_output_rval_as_op_arg_5_p_0(Opts_8, Stream_9, X_11);
            mercury__io__write_string_4_p_0(Stream_9, (MR_String) " ");
            mercury__io__write_string_4_p_0(Stream_9, OpStr_775);
            mercury__io__write_string_4_p_0(Stream_9, (MR_String) " ");
            ml_backend__mlds_to_c_data__mlds_output_rval_as_op_arg_5_p_0(Opts_8, Stream_9, Y_12);
            mercury__io__write_string_4_p_0(Stream_9, (MR_String) ")");
          }
        ...
        case (MR_Integer) 7:
          {
            ...
            if ((MaybeSize_33 == (MR_Word) ((MR_Unsigned) 0U)))
            {
              ...
              mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&ml_backend__mlds_to_c_data_scalar_common_1[0]), Offset_32, &Var_926);
              mercury__io__write_string_4_p_0(Stream_9, Var_926);
              mercury__io__write_string_4_p_0(Stream_9, (MR_String) ", ");
              ml_backend__mlds_to_c_data__mlds_output_rval_as_op_arg_5_p_0(Opts_8, Stream_9, X_11);
              mercury__io__write_string_4_p_0(Stream_9, (MR_String) ", ");
              ml_backend__mlds_to_c_data__mlds_output_rval_as_op_arg_5_p_0(Opts_8, Stream_9, Y_12);
            ...
            else
            {
              ...
              mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&ml_backend__mlds_to_c_data_scalar_common_1[0]), Offset_32, &Var_905);
              mercury__io__write_string_4_p_0(Stream_9, Var_905);
              mercury__io__write_string_4_p_0(Stream_9, (MR_String) ", ");
              mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&ml_backend__mlds_to_c_data_scalar_common_1[0]), Size_34, &Var_915);
              mercury__io__write_string_4_p_0(Stream_9, Var_915);
              mercury__io__write_string_4_p_0(Stream_9, (MR_String) ", ");
              ml_backend__mlds_to_c_data__mlds_output_rval_as_op_arg_5_p_0(Opts_8, Stream_9, X_11);
              mercury__io__write_string_4_p_0(Stream_9, (MR_String) ", ");
              ml_backend__mlds_to_c_data__mlds_output_rval_as_op_arg_5_p_0(Opts_8, Stream_9, Y_12);
        ...
        case (MR_Integer) 8:
          {
            MR_Word Var_87;
            MR_Word CmpOp_232 = ((MR_Unsigned) ((MR_hl_field(3, Op_10, (MR_Integer) 1))) & (MR_Integer) 7);
            MR_String OpStr_233;

            Var_87 = (MR_Word) (CmpOp_232);
            OpStr_233 = backend_libs__builtin_ops__cmp_op_c_operator_1_f_0(Var_87);
            mercury__io__write_string_4_p_0(Stream_9, (MR_String) "(((MR_Unsigned) ");
            ml_backend__mlds_to_c_data__mlds_output_rval_as_unsigned_op_arg_6_p_0(Opts_8, Stream_9, (MR_Integer) 2147483647, X_11);
            mercury__io__write_string_4_p_0(Stream_9, (MR_String) ") ");
            mercury__io__write_string_4_p_0(Stream_9, OpStr_233);
            mercury__io__write_string_4_p_0(Stream_9, (MR_String) " ((MR_Unsigned) ");
            ml_backend__mlds_to_c_data__mlds_output_rval_as_unsigned_op_arg_6_p_0(Opts_8, Stream_9, (MR_Integer) 2147483647, Y_12);
            mercury__io__write_string_4_p_0(Stream_9, (MR_String) "))");
          }
        ...
        case (MR_Integer) 9:
          {
            ...
            MR_Word Var_75 = (MR_Word) (ArithOp_18);
            MR_String OpStr_231;

            OpStr_231 = backend_libs__builtin_ops__arith_op_c_operator_1_f_0(Var_75);
            mercury__io__write_string_4_p_0(Stream_9, (MR_String) "(");
            ml_backend__mlds_to_c_data__mlds_output_bracketed_rval_5_p_0(Opts_8, Stream_9, X_11);
            mercury__io__write_string_4_p_0(Stream_9, (MR_String) " ");
        ...
        case (MR_Integer) 10:
          {
            MR_Word CmpOp_228 = ((MR_Unsigned) ((MR_hl_field(3, Op_10, (MR_Integer) 1))) & (MR_Integer) 7);
            MR_String OpStr_277;

            OpStr_277 = backend_libs__builtin_ops__cmp_op_c_operator_1_f_0(CmpOp_228);
            mercury__io__write_string_4_p_0(Stream_9, (MR_String) "(");
            ml_backend__mlds_to_c_data__mlds_output_bracketed_rval_5_p_0(Opts_8, Stream_9, X_11);
            mercury__io__write_string_4_p_0(Stream_9, (MR_String) " ");
            mercury__io__write_string_4_p_0(Stream_9, OpStr_277);
            mercury__io__write_string_4_p_0(Stream_9, (MR_String) " ");
            ml_backend__mlds_to_c_data__mlds_output_bracketed_rval_5_p_0(Opts_8, Stream_9, Y_12);
            mercury__io__write_string_4_p_0(Stream_9, (MR_String) ")");
          }
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = ml_backend__mlds_to_c_data__IntroducedFrom__pred__mlds_output_rval_const__1006__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 4)))));
  return succeeded;
}
