...
static const MR_DuFunctorDescPtr transform_hlds__intermod_order_pred_info__transform_hlds__intermod_order_pred_info__du_stag_ordered_order_pred_info_0_0[1] = { &transform_hlds__intermod_order_pred_info__transform_hlds__intermod_order_pred_info__du_functor_desc_order_pred_info_0_0 };
...
static const MR_DuFunctorDescPtr transform_hlds__intermod_order_pred_info__transform_hlds__intermod_order_pred_info__du_name_ordered_order_pred_info_0[1] = { &transform_hlds__intermod_order_pred_info__transform_hlds__intermod_order_pred_info__du_functor_desc_order_pred_info_0_0 };

static const MR_Integer transform_hlds__intermod_order_pred_info__transform_hlds__intermod_order_pred_info__functor_number_map_order_pred_info_0[1] = { (MR_Integer) 0 };
    ...
    else
    {
      ...
      else
      {
        ...
        else
        {
          ...
          hlds__pred_proc_id____Compare____pred_id_0_0(&SubResult4_15, ArgX4_13, ArgY4_14);
  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          succeeded = hlds__pred_proc_id____Unify____pred_id_0_0(ArgX4_9, ArgY4_10);
          if (succeeded)
  ...
  MR_Word * STATE_VARIABLE_OrderPredInfos_4)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      MR_Word STATE_VARIABLE_OrderPredInfos_1_21;
      ...
      hlds__hlds_pred__pred_info_get_orig_arity_2_p_0(PredInfo_13, &PredFormArity_16);
      parse_tree__prog_util__user_arity_pred_form_arity_3_p_1(PredOrFunc_14, &UserArity_17, PredFormArity_16);
      {
        OrderPredInfo_18 = (MR_Word) MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(0, OrderPredInfo_18, 0) = ((MR_Box) (PredName_15));
        MR_hl_field(0, OrderPredInfo_18, 1) = ((MR_Box) (UserArity_17));
        MR_hl_field(0, OrderPredInfo_18, 2) = (MR_Box) ((MR_Unsigned) (PredOrFunc_14));
        MR_hl_field(0, OrderPredInfo_18, 3) = ((MR_Box) (PredId_10));
        MR_hl_field(0, OrderPredInfo_18, 4) = ((MR_Box) (PredInfo_13));
      }
      {
        STATE_VARIABLE_OrderPredInfos_1_21 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(1, STATE_VARIABLE_OrderPredInfos_1_21, 0) = ((MR_Box) (OrderPredInfo_18));
        MR_hl_field(1, STATE_VARIABLE_OrderPredInfos_1_21, 1) = ((MR_Box) (STATE_VARIABLE_OrderPredInfos_0_3));
      }
      // direct tailcall eliminated
      ;
      next_value_of_HeadVar__2_2 = PredIds_11;
      next_value_of_STATE_VARIABLE_OrderPredInfos_0_3 = STATE_VARIABLE_OrderPredInfos_1_21;
