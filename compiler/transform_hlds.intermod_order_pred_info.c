  ...
  MR_Word * STATE_VARIABLE_OrderPredInfos_4)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      {
        STATE_VARIABLE_OrderPredInfos_22_22 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(1, STATE_VARIABLE_OrderPredInfos_22_22, 0) = ((MR_Box) (OrderPredInfo_18));
        MR_hl_field(1, STATE_VARIABLE_OrderPredInfos_22_22, 1) = ((MR_Box) (STATE_VARIABLE_OrderPredInfos_0_3));
      }
