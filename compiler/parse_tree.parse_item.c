      ...
      else
      {
        ...
        else
        {
          ...
          ClauseContext_105 = mercury__term__get_term_context_1_f_0((MR_Word) (&mercury__term__term__type_ctor_info_generic_0), HeadTerm_103);
          {
            ...
            MR_hl_field(MR_mktag(0), BodyTerm_104, 0) = ((MR_Box) (&parse_tree__parse_item_scalar_common_3[0]));
...
{
  {
    ...
    else
    {
...

      {
        ...
        MR_hl_field(MR_mktag(3), Var_37, 0) = ((MR_Box) ((MR_Unsigned) 24U));
    ...
    else
    {
      ...
      if ((Var_183 == (MR_Word) ((MR_Unsigned) 0U)))
      {
...

        {
          ...
          MR_hl_field(MR_mktag(3), Var_138, 0) = ((MR_Box) ((MR_Unsigned) 24U));
      ...
      else
      {
        ...
        if ((Var_185 == (MR_Word) ((MR_Unsigned) 0U)))
        {
...

          {
            ...
            MR_hl_field(MR_mktag(3), Var_150, 0) = ((MR_Box) ((MR_Unsigned) 24U));
        ...
        else
        {
          ...
          else
          {
...

            {
              ...
              MR_hl_field(MR_mktag(3), Var_162, 0) = ((MR_Box) ((MR_Unsigned) 24U));
  ...
  MR_Word * MaybeIOM_12)
{
  ...
  else
  {
...

    {
      ...
      MR_hl_field(MR_mktag(3), Var_21, 0) = ((MR_Box) ((MR_Unsigned) 24U));
    ...
    else
    {
          ...
          case (MR_Integer) 0:
            {
...

              {
                ...
                MR_hl_field(MR_mktag(3), Var_87, 0) = ((MR_Box) ((MR_Unsigned) 23U));
          ...
          case (MR_Integer) 1:
            {
              ...
              {
                Var_77 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), Var_77, 0) = ((MR_Box) ((MR_Unsigned) 23U));
      ...
      else
      {
...

        {
          ...
          MR_hl_field(MR_mktag(3), Var_173, 0) = ((MR_Box) ((MR_Unsigned) 24U));
