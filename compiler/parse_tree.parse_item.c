  ...
  MR_Word * MaybeModule_8)
{
  ...
  else
  {
...

    {
      ...
      MR_hl_field(MR_mktag(0), Var_30, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &parse_tree__parse_item_scalar_common_1[240])));
    }
    {
      ...
      else
      {
        ...
        else
        {
...

          {
            ...
            MR_hl_field(MR_mktag(0), Var_53, 0) = ((MR_Box) (TermContext_9));
            MR_hl_field(MR_mktag(0), Var_53, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &parse_tree__parse_item_scalar_common_1[239])));
          }
          {
              ...
              ;
              {
                ...
                else
                {
...

                  {
                    ...
                    MR_hl_field(MR_mktag(0), Var_65, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &parse_tree__parse_item_scalar_common_1[227])));
                  }
                  {
                    Var_64 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(MR_mktag(1), Var_64, 0) = ((MR_Box) (Var_65));
...
{
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            ...
            else
            {
...

              {
                ...
                MR_hl_field(MR_mktag(3), IOM_19, 0) = ((MR_Box) ((MR_Unsigned) 0U));
          ...
          else
          {
            ...
            Var_43 = mercury__term__get_term_context_1_f_0((MR_Word) (&mercury__term__term__type_ctor_info_generic_0), ModuleNameTerm_14);
            {
              ...
              MR_hl_field(MR_mktag(0), Var_42, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &parse_tree__parse_item_scalar_common_1[232])));
            }
            {
        ...
        else
        {
...

          {
            ...
            MR_hl_field(MR_mktag(0), Var_67, 0) = ((MR_Box) (Context_10));
            MR_hl_field(MR_mktag(0), Var_67, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &parse_tree__parse_item_scalar_common_1[235])));
          }
          {
      ...
      else
      {
        ...
        VersionNumberContext_24 = mercury__term__get_term_context_1_f_0((MR_Word) (&mercury__term__term__type_ctor_info_generic_0), VersionNumbersTerm_15);
        {
          ...
          MR_hl_field(MR_mktag(0), Var_94, 0) = ((MR_Box) (VersionNumberContext_24));
          MR_hl_field(MR_mktag(0), Var_94, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &parse_tree__parse_item_scalar_common_1[236])));
        }
        {
    ...
    else
    {
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(0), Var_126, 0) = ((MR_Box) (Context_10));
...
{
  {
    ...
    else
    {
...

      {
        ...
        MR_hl_field(MR_mktag(0), Var_52, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &parse_tree__parse_item_scalar_common_1[231])));
      }
      {
        Var_51 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), Var_51, 0) = ((MR_Box) (Var_52));
  ...
  MR_Word * MaybeIOM_12)
{
  if ((ArgTerms_8 == (MR_Word) ((MR_Unsigned) 0U)))
  {
...

    {
      ...
      MR_hl_field(MR_mktag(3), Marker_13, 0) = ((MR_Box) ((MR_Unsigned) 4U));
...
{
  {
    ...
    else
    {
...

      {
        ...
        MR_hl_field(MR_mktag(0), Var_35, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &parse_tree__parse_item_scalar_common_1[229])));
      }
      {
...
{
  {
    ...
    if (succeeded)
    {
      ...
      {
        Marker_11 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(3), Marker_11, 0) = ((MR_Box) ((MR_Unsigned) 2U));
        MR_hl_field(MR_mktag(3), Marker_11, 1) = ((MR_Box) (ModuleName_10));
        MR_hl_field(MR_mktag(3), Marker_11, 2) = ((MR_Box) (Context_6));
        MR_hl_field(MR_mktag(3), Marker_11, 3) = ((MR_Box) (SeqNum_7));
      }
    ...
    else
    {
...

      {
        Var_35 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), Var_35, 0) = ((MR_Box) (Context_6));
        MR_hl_field(MR_mktag(0), Var_35, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &parse_tree__parse_item_scalar_common_1[228])));
      }
      {
        Var_34 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), Var_34, 0) = ((MR_Box) (Var_35));
            ...
            ;
            {
              ...
              else
              {
...

                {
                  ...
                  MR_hl_field(MR_mktag(0), Var_44, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &parse_tree__parse_item_scalar_common_1[227])));
                }
                {
                  Var_43 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                  MR_hl_field(MR_mktag(1), Var_43, 0) = ((MR_Box) (Var_44));
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          Var_88 = mercury__term__get_term_context_1_f_0((MR_Word) (&mercury__term__term__type_ctor_info_generic_0), BaseTerm_33);
          {
            ...
            MR_hl_field(MR_mktag(0), Var_87, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &parse_tree__parse_item_scalar_common_1[203])));
          }
          {
        ...
        else
        {
          ...
          if (succeeded)
          {
            ...
            Var_119 = mercury__term__get_term_context_1_f_0((MR_Word) (&mercury__term__term__type_ctor_info_generic_0), BaseTerm_33);
            {
              ...
              MR_hl_field(MR_mktag(0), Var_118, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &parse_tree__parse_item_scalar_common_1[219])));
            }
            {
    ...
    else
    {
      ...
      else
      {
        ...
        Var_109 = mercury__term__get_term_context_1_f_0((MR_Word) (&mercury__term__term__type_ctor_info_generic_0), Term_12);
        {
          ...
          MR_hl_field(MR_mktag(0), Var_108, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &parse_tree__parse_item_scalar_common_1[214])));
        }
        {
    ...
    else
    {
      ...
      else
      {
...

        {
          ...
          MR_hl_field(MR_mktag(0), Var_84, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &parse_tree__parse_item_scalar_common_1[211])));
        }
        {
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            ...
            Var_104 = mercury__term__get_term_context_1_f_0((MR_Word) (&mercury__term__term__type_ctor_info_generic_0), PredTypeTerm_16);
            {
              ...
              MR_hl_field(MR_mktag(0), Var_103, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &parse_tree__parse_item_scalar_common_1[212])));
            }
            {
          ...
          else
          {
            ...
            if (succeeded)
            {
              ...
              Var_127 = mercury__term__get_term_context_1_f_0((MR_Word) (&mercury__term__term__type_ctor_info_generic_0), PredTypeTerm_16);
              {
                ...
                MR_hl_field(MR_mktag(0), Var_126, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &parse_tree__parse_item_scalar_common_1[213])));
              }
              {
                Var_125 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(1), Var_125, 0) = ((MR_Box) (Var_126));
  ...
  else
  {
    ...
    else
    {
...

      {
        ...
        MR_hl_field(MR_mktag(0), Var_26, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &parse_tree__parse_item_scalar_common_1[211])));
      }
      {
  ...
  MR_Word * HeadVar__4_4)
{
  ...
  else
  {
    ...
    MR_Integer Var_16 = (MR_Integer) ((MR_Unsigned) ArgNum_1 + (MR_Unsigned) (MR_Integer) 1);
...
{
  {
    ...
    else
    {
...

      {
        ...
        MR_hl_field(MR_mktag(0), Var_57, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &parse_tree__parse_item_scalar_common_1[204])));
      }
      {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        Var_71 = mercury__term__get_term_context_1_f_0((MR_Word) (&mercury__term__term__type_ctor_info_generic_0), Term_11);
        {
          ...
          MR_hl_field(MR_mktag(0), Var_70, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &parse_tree__parse_item_scalar_common_1[203])));
        }
        {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        Var_53 = mercury__term__get_term_context_1_f_0((MR_Word) (&mercury__term__term__type_ctor_info_generic_0), MaybeSugaredFuncTerm_19);
        {
          ...
          MR_hl_field(MR_mktag(0), Var_52, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &parse_tree__parse_item_scalar_common_1[192])));
        }
        {
          Var_51 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), Var_51, 0) = ((MR_Box) (Var_52));
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        Var_84 = mercury__term__get_term_context_1_f_0((MR_Word) (&mercury__term__term__type_ctor_info_generic_0), Term_12);
        {
          ...
          MR_hl_field(MR_mktag(0), Var_83, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &parse_tree__parse_item_scalar_common_1[193])));
        }
        {
