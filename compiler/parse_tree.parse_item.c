...
{
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), ItemPredDecl_13, (MR_Integer) 1)));
        MR_Unsigned packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), ItemPredDecl_13, (MR_Integer) 10)));

        {
          ...
          MR_hl_field(MR_mktag(0), ClassMethod_28, 1) = (MR_Box) (packed_args_0);
          ...
          MR_hl_field(MR_mktag(0), ClassMethod_28, 9) = (MR_Box) (packed_args_1);
    ...
    if (succeeded)
    {
      ...
      else
      {
        ...
        if (succeeded)
        {
          ...
          Var_29 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(3), Goal0_16, (MR_Integer) 1))) >> (MR_Integer) 1)) & (MR_Integer) 1);
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      if (((MR_tag((MR_Word) QuantConstrAttr_45)) == (MR_Integer) 1))
      {
        ...
        MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), QuantConstrAttr_45, (MR_Integer) 0)));
      ...
      else
      {
        ...
        MR_Word Var_106;
        MR_Unsigned packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), QuantConstrAttr_45, (MR_Integer) 0)));
