...
{
  {
    ...
    else
    {
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(1), Spec_28, 0) = ((MR_Box) ((MR_String) "predicate \140parse_tree.parse_item.parse_promise_ex_item\'/8"));
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(1), Var_50, 0) = ((MR_Box) (Spec_28));
...
{
  {
    ...
    else
    {
...

      {
        ...
        MR_hl_field(MR_mktag(3), Var_85, 0) = ((MR_Box) ((MR_Unsigned) 18U));
...
{
  {
    ...
    else
    {
...

      {
        ...
        MR_hl_field(MR_mktag(1), Spec_27, 0) = ((MR_Box) ((MR_String) "predicate \140parse_tree.parse_item.parse_promise_item\'/5"));
        MR_hl_field(MR_mktag(1), Spec_27, 1) = ((MR_Box) ((MR_Unsigned) 0U));
        MR_hl_field(MR_mktag(1), Spec_27, 2) = ((MR_Box) ((MR_Unsigned) 12U));
        MR_hl_field(MR_mktag(1), Spec_27, 3) = ((MR_Box) (Context_8));
        MR_hl_field(MR_mktag(1), Spec_27, 4) = ((MR_Box) (MR_mkword(MR_mktag(1), &parse_tree__parse_item_scalar_common_1[164])));
      }
      {
...
{
  {
    ...
    else
    {
...

      {
        ...
        MR_hl_field(MR_mktag(3), Var_123, 0) = ((MR_Box) ((MR_Unsigned) 18U));
