  ...
  if (succeeded)
  {
    ...
    if (succeeded)
    {
...

      {
        ...
        MR_hl_field(MR_mktag(1), Var_44, 0) = ((MR_Box) (Spec_25));
        MR_hl_field(MR_mktag(1), Var_44, 1) = ((MR_Box) (Var_42));
      }
      {
        MaybeFunctor_26 = (MR_Word) MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), MaybeFunctor_26, 0) = ((MR_Box) (Var_44));
      }
    }
    else
    {
      ...
      if ((MaybeModuleName_8 == (MR_Word) ((MR_Unsigned) 0U)))
        parse_tree__parse_sym_name__parse_sym_name_and_args_4_p_0((MR_Word) (&mercury__term__term__type_ctor_info_generic_0), VarSet_19, HeadContextPieces_27, FuncHeadTerm_23, &MaybeFunctor_26);
      else
      {
        MR_Word ModuleName_28 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MaybeModuleName_8, (MR_Integer) 0))));

        parse_tree__parse_sym_name__parse_implicitly_qualified_sym_name_and_args_5_p_0((MR_Word) (&mercury__term__term__type_ctor_info_generic_0), ModuleName_28, VarSet_19, HeadContextPieces_27, FuncHeadTerm_23, &MaybeFunctor_26);
      }
    }
    if (((MR_tag((MR_Word) MaybeFunctor_26)) == (MR_Integer) 0))
    {
      MR_Word FunctorSpecs_36 = ((MR_Word) ((MR_hl_field(MR_mktag(0), MaybeFunctor_26, (MR_Integer) 0))));
      MR_Word Specs_37;
      MR_Word Var_61;
    ...
    {
      MR_Word SymName_29 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MaybeFunctor_26, (MR_Integer) 0))));
      MR_Word ArgTerms0_30 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MaybeFunctor_26, (MR_Integer) 1))));
      MR_Word ArgTerms_33;
      MR_Word ProgArgTerms_34;
      MR_Word ItemClause_35;

      ArgTerms_33 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__parse_item_scalar_common_1[0]), ArgTerms0_30, Var_41);
      mercury__list__map_3_p_0((MR_Word) (&parse_tree__parse_item_scalar_common_1[0]), (MR_Word) (&parse_tree__parse_item_scalar_common_1[1]), (MR_Word) (&parse_tree__parse_item_scalar_common_2[3]), ArgTerms_33, &ProgArgTerms_34);
      {
        ItemClause_35 = (MR_Word) MR_new_object(MR_Word, (7 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), ItemClause_35, 0) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 1));
        MR_hl_field(MR_mktag(0), ItemClause_35, 1) = ((MR_Box) (SymName_29));
        MR_hl_field(MR_mktag(0), ItemClause_35, 2) = ((MR_Box) (ProgArgTerms_34));
        MR_hl_field(MR_mktag(0), ItemClause_35, 3) = ((MR_Box) (ProgVarSet_18));
        MR_hl_field(MR_mktag(0), ItemClause_35, 4) = ((MR_Box) (MaybeBodyGoal_17));
        MR_hl_field(MR_mktag(0), ItemClause_35, 5) = ((MR_Box) (Context_12));
        MR_hl_field(MR_mktag(0), ItemClause_35, 6) = ((MR_Box) (SeqNum_13));
      }
      {
        MR_Word base;
        base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
        *MaybeClause_14 = base;
        MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (ItemClause_35));
      }
    }
  }
  else
  {
    MR_Word MaybeFunctor_117;
    MR_Word Spec_69;

    succeeded = parse_tree__parse_item__is_the_name_a_variable_4_p_0(VarSet0_9, (MR_Word) ((MR_Unsigned) 8U), HeadTerm_10, &Spec_69);
    if (succeeded)
    {
      MR_Word Var_53;
      ...
      {
        Var_53 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), Var_53, 0) = ((MR_Box) (Spec_69));
        MR_hl_field(MR_mktag(1), Var_53, 1) = ((MR_Box) ((MR_Unsigned) 0U));
      }
      {
        MaybeFunctor_117 = (MR_Word) MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), MaybeFunctor_117, 0) = ((MR_Box) (Var_53));
      }
    }
    else
    {
      ...
      HeadContextPieces_67 = mercury__cord__from_list_1_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_format_component_0), (MR_Word) (MR_mkword(MR_mktag(1), &parse_tree__parse_item_scalar_common_1[140])));
      if ((MaybeModuleName_8 == (MR_Word) ((MR_Unsigned) 0U)))
        parse_tree__parse_sym_name__parse_sym_name_and_args_4_p_0((MR_Word) (&mercury__term__term__type_ctor_info_generic_0), VarSet_19, HeadContextPieces_67, HeadTerm_10, &MaybeFunctor_117);
      else
      {
        MR_Word ModuleName_65 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MaybeModuleName_8, (MR_Integer) 0))));

        parse_tree__parse_sym_name__parse_implicitly_qualified_sym_name_and_args_5_p_0((MR_Word) (&mercury__term__term__type_ctor_info_generic_0), ModuleName_65, VarSet_19, HeadContextPieces_67, HeadTerm_10, &MaybeFunctor_117);
      }
    }
    if (((MR_tag((MR_Word) MaybeFunctor_117)) == (MR_Integer) 0))
    {
      MR_Word FunctorSpecs_88 = ((MR_Word) ((MR_hl_field(MR_mktag(0), MaybeFunctor_117, (MR_Integer) 0))));
      MR_Word Specs_89;
      MR_Word Var_90;

      Var_90 = parse_tree__maybe_error__get_any_errors_warnings2_1_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_goal_0), MaybeBodyGoal_17);
      Specs_89 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_error_spec_0), FunctorSpecs_88, Var_90);
      {
        MR_Word base;
        base = (MR_Word) MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL);
        *MaybeClause_14 = base;
        MR_hl_field(MR_mktag(0), base, 0) = ((MR_Box) (Specs_89));
      }
    }
    else
    {
      MR_Word SymName_93 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MaybeFunctor_117, (MR_Integer) 0))));
      MR_Word ArgTerms_96 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MaybeFunctor_117, (MR_Integer) 1))));
      MR_Word ProgArgTerms_97;
      MR_Word ItemClause_98;

      mercury__list__map_3_p_0((MR_Word) (&parse_tree__parse_item_scalar_common_1[0]), (MR_Word) (&parse_tree__parse_item_scalar_common_1[1]), (MR_Word) (&parse_tree__parse_item_scalar_common_2[4]), ArgTerms_96, &ProgArgTerms_97);
      {
        ItemClause_98 = (MR_Word) MR_new_object(MR_Word, (7 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), ItemClause_98, 0) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 0));
        MR_hl_field(MR_mktag(0), ItemClause_98, 1) = ((MR_Box) (SymName_93));
        MR_hl_field(MR_mktag(0), ItemClause_98, 2) = ((MR_Box) (ProgArgTerms_97));
        MR_hl_field(MR_mktag(0), ItemClause_98, 3) = ((MR_Box) (ProgVarSet_18));
        MR_hl_field(MR_mktag(0), ItemClause_98, 4) = ((MR_Box) (MaybeBodyGoal_17));
        MR_hl_field(MR_mktag(0), ItemClause_98, 5) = ((MR_Box) (Context_12));
        MR_hl_field(MR_mktag(0), ItemClause_98, 6) = ((MR_Box) (SeqNum_13));
      }
      {
        MR_Word base;
        base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
        *MaybeClause_14 = base;
        MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (ItemClause_98));
      }
    }
  }
}
  ...
  MR_Box wrapper_arg_1)
{
  ...
  conv0_LambdaHeadVar__2_64 = parse_tree__parse_item__IntroducedFrom__func__parse_func_decl_base__1208__1_2_f_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Integer) (wrapper_arg_1)));
