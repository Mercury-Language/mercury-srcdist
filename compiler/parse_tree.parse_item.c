  ...
  else
  {
    ...
    if ((RestWithout_26 == (MR_Word) ((MR_Unsigned) 0U)))
    {
        ...
        }
      {
        ...
        MR_hl_field(1, Var_112, 1) = ((MR_Box) (MR_mkword(1, &parse_tree__parse_item_scalar_common_1[197])));
      }
      Var_54 = parse_tree__error_spec__color_pieces_2_f_0((MR_Integer) 3, Var_112);
    ...
    else
    {
      ...
      WithoutArgNumsPieces_34 = parse_tree__error_spec__piece_list_to_color_pieces_4_f_0((MR_Integer) 3, And_32, (MR_Word) (MR_mkword(1, &parse_tree__parse_item_scalar_common_1[197])), WithoutArgNumPieces_33);
    ...
    Pieces_35 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), (MR_Word) (MR_mkword(1, &parse_tree__parse_item_scalar_common_1[55])), Var_78);
    {
      Spec_36 = (MR_Word) MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL);
