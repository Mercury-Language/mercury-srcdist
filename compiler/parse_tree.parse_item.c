          ...
          ;
          {
            ...
            if (succeeded)
            {
...

              {
                ...
                MR_hl_field(MR_mktag(3), Marker_63, 0) = ((MR_Box) ((MR_Unsigned) 5U));
      ...
      case (MR_Integer) 8:
        {
          ...
          if ((ArgTerms_12 == (MR_Word) ((MR_Unsigned) 0U)))
          {
...

            {
              ...
              MR_hl_field(MR_mktag(3), Marker_73, 0) = ((MR_Box) ((MR_Unsigned) 6U));
      ...
      case (MR_Integer) 15:
        {
          ...
          if ((ArgTerms_12 == (MR_Word) ((MR_Unsigned) 0U)))
          {
...

            {
              ...
              MR_hl_field(MR_mktag(3), Marker_88, 0) = ((MR_Box) ((MR_Unsigned) 6U));
              ...
              if (succeeded)
              {
                ...
                else
                {
...

                  {
                    ...
                    MR_hl_field(MR_mktag(3), IOM_19, 0) = ((MR_Box) ((MR_Unsigned) 2U));
          ...
          case (MR_Integer) 0:
            {
              ...
              }
              {
                ...
                MR_hl_field(MR_mktag(2), IOM_25, 0) = ((MR_Box) (Var_67));
              }
            }
            break;
          case (MR_Integer) 2:
  ...
  if (succeeded)
  {
    ...
    if (succeeded)
    {
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(0), Var_107, 0) = ((MR_Box) (Item_41));
      }
      {
        MR_Word base;
        base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
