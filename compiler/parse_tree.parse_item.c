  ...
  MR_Word * MaybeResult_8)
{
  ...
  else
  {
    ...
    else
    {
      ...
      WithoutArgNumsPieces_34 = parse_tree__error_spec__piece_list_to_color_pieces_4_f_0((MR_Integer) 4, And_32, (MR_Word) (MR_mkword(1, &parse_tree__parse_item_scalar_common_1[197])), WithoutArgNumPieces_33);
