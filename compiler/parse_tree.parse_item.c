  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      if (((MR_tag((MR_Word) MaybeFunctor_45)) == (MR_Integer) 0))
      {
        ...
        Specs_56 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_error_spec_0), FunctorSpecs_55, Var_73);
        {
          MR_Word base;
          base = (MR_Word) MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL);
          *MaybeClause_10 = base;
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          Specs_102 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_error_spec_0), FunctorSpecs_101, Var_119);
          {
      ...
      case (MR_Integer) 17:
        {
          ...
          ;
          {
            ...
            if ((ArgTerms_14 == (MR_Word) ((MR_Unsigned) 0U)))
            {
              ...
              {
                Var_82 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(1), Var_82, 0) = ((MR_Box) (Spec_71));
              ...
              }
              {
                ...
                MR_hl_field(MR_mktag(0), MaybeIOM0_21, 0) = ((MR_Box) (Var_82));
              }
            }
            else
            {
  ...
  MR_Box wrapper_arg_1)
{
  ...
  conv1_LambdaHeadVar__2_64 = parse_tree__parse_item__IntroducedFrom__func__parse_func_decl_base__1243__1_2_f_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Integer) (wrapper_arg_1)));
