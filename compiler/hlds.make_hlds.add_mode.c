...
{
  {
    ...
    MR_Word hlds__make_hlds__add_mode__Var_28;
    MR_Word hlds__make_hlds__add_mode__SymName_52 = ((MR_Word) (MR_hl_field(MR_mktag(0), hlds__make_hlds__add_mode__LambdaHeadVar__1_26, (MR_Integer) 0)));
    MR_Integer hlds__make_hlds__add_mode__Arity_53 = ((MR_Integer) (MR_hl_field(MR_mktag(0), hlds__make_hlds__add_mode__LambdaHeadVar__1_26, (MR_Integer) 1)));

    {
      hlds__make_hlds__add_mode__Var_28 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), hlds__make_hlds__add_mode__Var_28, 0) = ((MR_Box) (hlds__make_hlds__add_mode__SymName_52));
      MR_hl_field(MR_mktag(0), hlds__make_hlds__add_mode__Var_28, 1) = ((MR_Box) (hlds__make_hlds__add_mode__Arity_53));
    }
    {
      ...
      MR_hl_field(MR_mktag(3), hlds__make_hlds__add_mode__LambdaHeadVar__2_27, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 9));
      MR_hl_field(MR_mktag(3), hlds__make_hlds__add_mode__LambdaHeadVar__2_27, 1) = ((MR_Box) (hlds__make_hlds__add_mode__Var_28));
    }
...
{
  {
    ...
    {
      MR_Word hlds__make_hlds__add_mode__ArgX1_4 = ((MR_Word) (MR_hl_field(MR_mktag(0), hlds__make_hlds__add_mode__HeadVar__2_2, (MR_Integer) 0)));
      MR_Word hlds__make_hlds__add_mode__ArgY1_5 = ((MR_Word) (MR_hl_field(MR_mktag(0), hlds__make_hlds__add_mode__HeadVar__3_3, (MR_Integer) 0)));
      MR_Integer hlds__make_hlds__add_mode__ArgX2_6 = ((MR_Integer) (MR_hl_field(MR_mktag(0), hlds__make_hlds__add_mode__HeadVar__2_2, (MR_Integer) 1)));
      MR_Integer hlds__make_hlds__add_mode__ArgY2_7 = ((MR_Integer) (MR_hl_field(MR_mktag(0), hlds__make_hlds__add_mode__HeadVar__3_3, (MR_Integer) 1)));
      MR_Word hlds__make_hlds__add_mode__Var_8;

      mdbcomp__sym_name____Compare____sym_name_0_0(&hlds__make_hlds__add_mode__Var_8, hlds__make_hlds__add_mode__ArgX1_4, hlds__make_hlds__add_mode__ArgY1_5);
      hlds__make_hlds__add_mode__succeeded = (hlds__make_hlds__add_mode__Var_8 == (MR_Integer) 0);
      hlds__make_hlds__add_mode__succeeded = !(hlds__make_hlds__add_mode__succeeded);
      if (hlds__make_hlds__add_mode__succeeded)
        *hlds__make_hlds__add_mode__HeadVar__1_1 = hlds__make_hlds__add_mode__Var_8;
      else
        mercury__private_builtin__builtin_compare_int_3_p_0(hlds__make_hlds__add_mode__HeadVar__1_1, hlds__make_hlds__add_mode__ArgX2_6, hlds__make_hlds__add_mode__ArgY2_7);
    }
  }
}
...
{
  {
    ...
    {
      MR_Word hlds__make_hlds__add_mode__ArgX1_3 = ((MR_Word) (MR_hl_field(MR_mktag(0), hlds__make_hlds__add_mode__HeadVar__1_1, (MR_Integer) 0)));
      MR_Word hlds__make_hlds__add_mode__ArgY1_4 = ((MR_Word) (MR_hl_field(MR_mktag(0), hlds__make_hlds__add_mode__HeadVar__2_2, (MR_Integer) 0)));
      MR_Integer hlds__make_hlds__add_mode__ArgX2_5 = ((MR_Integer) (MR_hl_field(MR_mktag(0), hlds__make_hlds__add_mode__HeadVar__1_1, (MR_Integer) 1)));
      MR_Integer hlds__make_hlds__add_mode__ArgY2_6 = ((MR_Integer) (MR_hl_field(MR_mktag(0), hlds__make_hlds__add_mode__HeadVar__2_2, (MR_Integer) 1)));

      hlds__make_hlds__add_mode__succeeded = mdbcomp__sym_name____Unify____sym_name_0_0(hlds__make_hlds__add_mode__ArgX1_3, hlds__make_hlds__add_mode__ArgY1_4);
      if (hlds__make_hlds__add_mode__succeeded)
        hlds__make_hlds__add_mode__succeeded = (hlds__make_hlds__add_mode__ArgX2_5 == hlds__make_hlds__add_mode__ArgY2_6);
    }
...
{
  {
    ...
    MR_Word hlds__make_hlds__add_mode__Var_53;
    ...
    hlds__make_hlds__add_mode__Var_53 = (MR_Word) hlds__make_hlds__add_mode__Body_37;
    {
      ...
      MR_hl_field(MR_mktag(0), hlds__make_hlds__add_mode__ModeDefn_42, 2) = ((MR_Box) (hlds__make_hlds__add_mode__Var_53));
    ...
    else
    {
      ...
      {
        MR_Word hlds__make_hlds__add_mode__InstModeImport_67 = ((MR_Word) (MR_hl_field(MR_mktag(1), hlds__make_hlds__add_mode__InstModeStatus_43, (MR_Integer) 0)));

        switch (MR_tag((MR_Word) hlds__make_hlds__add_mode__InstModeImport_67)) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 0:
            switch (MR_unmkbody(hlds__make_hlds__add_mode__InstModeImport_67)) {
              default: /*NOTREACHED*/ MR_assert(0);
              case (MR_Integer) 0:
                {
                  ...
                  MR_Word hlds__make_hlds__add_mode__Var_47;
                  MR_Word hlds__make_hlds__add_mode__Var_48;
                  MR_Word hlds__make_hlds__add_mode__Var_49;
                  MR_Word hlds__make_hlds__add_mode__Var_51;
                  ...
                  hlds__make_hlds__add_mode__Var_47 = ((MR_Word) (MR_hl_field(MR_mktag(0), hlds__make_hlds__add_mode__OrigModeDefn_46, (MR_Integer) 0)));
                  hlds__make_hlds__add_mode__Var_48 = ((MR_Word) (MR_hl_field(MR_mktag(0), hlds__make_hlds__add_mode__OrigModeDefn_46, (MR_Integer) 1)));
                  hlds__make_hlds__add_mode__Var_49 = ((MR_Word) (MR_hl_field(MR_mktag(0), hlds__make_hlds__add_mode__OrigModeDefn_46, (MR_Integer) 2)));
                  ...
                  hlds__make_hlds__add_mode__Var_51 = ((MR_Word) (MR_hl_field(MR_mktag(0), hlds__make_hlds__add_mode__OrigModeDefn_46, (MR_Integer) 4)));
                  hlds__make_hlds__make_hlds_error__report_multiple_def_error_8_p_0(hlds__make_hlds__add_mode__Name_13, hlds__make_hlds__add_mode__Arity_40, (MR_String) "mode", hlds__make_hlds__add_mode__Context_17, hlds__make_hlds__add_mode__OrigContext_50, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), hlds__make_hlds__add_mode__STATE_VARIABLE_Specs_0_23, &hlds__make_hlds__add_mode__STATE_VARIABLE_Specs_41_56);
                }
                break;
              case (MR_Integer) 1:
                hlds__make_hlds__add_mode__STATE_VARIABLE_Specs_41_56 = hlds__make_hlds__add_mode__STATE_VARIABLE_Specs_0_23;
      ...
      {
        MR_Word hlds__make_hlds__add_mode__ModeDefns_75;
        MR_Word hlds__make_hlds__add_mode__OrigModeDefn_76;
        MR_Word hlds__make_hlds__add_mode__OrigContext_80;
        MR_Box hlds__make_hlds__add_mode__conv1_OrigModeDefn_76;
        MR_Word hlds__make_hlds__add_mode__Var_70;
        MR_Word hlds__make_hlds__add_mode__Var_71;
        MR_Word hlds__make_hlds__add_mode__Var_72;
        MR_Word hlds__make_hlds__add_mode__Var_73;

        hlds__hlds_data__mode_table_get_mode_defns_2_p_0(hlds__make_hlds__add_mode__ModeTable0_19, &hlds__make_hlds__add_mode__ModeDefns_75);
        mercury__map__lookup_3_p_0((MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mode_id_0, (MR_Word) &hlds__hlds_data__hlds__hlds_data__type_ctor_info_hlds_mode_defn_0, hlds__make_hlds__add_mode__ModeDefns_75, ((MR_Box) (hlds__make_hlds__add_mode__ModeId_41)), &hlds__make_hlds__add_mode__conv1_OrigModeDefn_76);
        hlds__make_hlds__add_mode__OrigModeDefn_76 = ((MR_Word) hlds__make_hlds__add_mode__conv1_OrigModeDefn_76);
        hlds__make_hlds__add_mode__Var_70 = ((MR_Word) (MR_hl_field(MR_mktag(0), hlds__make_hlds__add_mode__OrigModeDefn_76, (MR_Integer) 0)));
        hlds__make_hlds__add_mode__Var_71 = ((MR_Word) (MR_hl_field(MR_mktag(0), hlds__make_hlds__add_mode__OrigModeDefn_76, (MR_Integer) 1)));
        hlds__make_hlds__add_mode__Var_72 = ((MR_Word) (MR_hl_field(MR_mktag(0), hlds__make_hlds__add_mode__OrigModeDefn_76, (MR_Integer) 2)));
        hlds__make_hlds__add_mode__OrigContext_80 = ((MR_Word) (MR_hl_field(MR_mktag(0), hlds__make_hlds__add_mode__OrigModeDefn_76, (MR_Integer) 3)));
        hlds__make_hlds__add_mode__Var_73 = ((MR_Word) (MR_hl_field(MR_mktag(0), hlds__make_hlds__add_mode__OrigModeDefn_76, (MR_Integer) 4)));
        hlds__make_hlds__make_hlds_error__report_multiple_def_error_8_p_0(hlds__make_hlds__add_mode__Name_13, hlds__make_hlds__add_mode__Arity_40, (MR_String) "mode", hlds__make_hlds__add_mode__Context_17, hlds__make_hlds__add_mode__OrigContext_80, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), hlds__make_hlds__add_mode__STATE_VARIABLE_Specs_0_23, &hlds__make_hlds__add_mode__STATE_VARIABLE_Specs_41_56);
      }
  ...
  while (MR_TRUE)
  {
    /* tailcall optimized into a loop */
    {
      ...
      else
      {
        ...
        MR_Word hlds__make_hlds__add_mode__Var_18;
        MR_Word hlds__make_hlds__add_mode__Var_19;
        MR_Word hlds__make_hlds__add_mode__Var_21;
        MR_Word hlds__make_hlds__add_mode__Var_22;
        ...
        if (hlds__make_hlds__add_mode__succeeded)
        {
          hlds__make_hlds__add_mode__Var_18 = ((MR_Word) (MR_hl_field(MR_mktag(0), hlds__make_hlds__add_mode__ModeDefn_17, (MR_Integer) 0)));
          hlds__make_hlds__add_mode__Var_19 = ((MR_Word) (MR_hl_field(MR_mktag(0), hlds__make_hlds__add_mode__ModeDefn_17, (MR_Integer) 1)));
          hlds__make_hlds__add_mode__Body_20 = ((MR_Word) (MR_hl_field(MR_mktag(0), hlds__make_hlds__add_mode__ModeDefn_17, (MR_Integer) 2)));
          hlds__make_hlds__add_mode__Var_21 = ((MR_Word) (MR_hl_field(MR_mktag(0), hlds__make_hlds__add_mode__ModeDefn_17, (MR_Integer) 3)));
          hlds__make_hlds__add_mode__Var_22 = ((MR_Word) (MR_hl_field(MR_mktag(0), hlds__make_hlds__add_mode__ModeDefn_17, (MR_Integer) 4)));
        ...
        if (hlds__make_hlds__add_mode__succeeded)
        {
          ...
          {
            MR_Word hlds__make_hlds__add_mode__next_value_of_ModeId0_11 = hlds__make_hlds__add_mode__ModeId_27;
            MR_Word hlds__make_hlds__add_mode__next_value_of_Expansions0_12 = hlds__make_hlds__add_mode__Expansions_28;

            hlds__make_hlds__add_mode__ModeId0_11 = hlds__make_hlds__add_mode__next_value_of_ModeId0_11;
            hlds__make_hlds__add_mode__Expansions0_12 = hlds__make_hlds__add_mode__next_value_of_Expansions0_12;
          }
          continue;
        }
        else
  ...
  MR_Word * hlds__make_hlds__add_mode__STATE_VARIABLE_Specs_13)
{
  {
    MR_bool hlds__make_hlds__add_mode__succeeded;
    MR_Word hlds__make_hlds__add_mode__Var_16;
    MR_Word hlds__make_hlds__add_mode__Var_17;
    MR_Word hlds__make_hlds__add_mode__Var_18;
    ...
    MR_Integer hlds__make_hlds__add_mode__CastX_81;
    MR_Integer hlds__make_hlds__add_mode__CastY_82;

    {
      hlds__make_hlds__add_mode__Var_16 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), hlds__make_hlds__add_mode__Var_16, 0) = ((MR_Box) (hlds__make_hlds__add_mode__SymName_25));
      MR_hl_field(MR_mktag(0), hlds__make_hlds__add_mode__Var_16, 1) = ((MR_Box) (hlds__make_hlds__add_mode__Arity_26));
    }
    ...
    {
      hlds__make_hlds__add_mode__Var_17 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), hlds__make_hlds__add_mode__Var_17, 0) = ((MR_Box) (hlds__make_hlds__add_mode__SymName_27));
      MR_hl_field(MR_mktag(0), hlds__make_hlds__add_mode__Var_17, 1) = ((MR_Box) (hlds__make_hlds__add_mode__Arity_28));
    }
    hlds__make_hlds__add_mode__Var_18 = mercury__list__map_2_f_0((MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mode_id_0, (MR_Word) &hlds__make_hlds__add_mode__hlds__make_hlds__add_mode__type_ctor_info_circ_id_0, (MR_Word) &hlds__make_hlds__add_mode_scalar_common_3[2], hlds__make_hlds__add_mode__Expansions_9);
    hlds__make_hlds__add_mode__CastX_81 = (MR_Integer) hlds__make_hlds__add_mode__Var_17;
    hlds__make_hlds__add_mode__CastY_82 = (MR_Integer) hlds__make_hlds__add_mode__Var_16;
    hlds__make_hlds__add_mode__succeeded = (hlds__make_hlds__add_mode__CastX_81 == hlds__make_hlds__add_mode__CastY_82);
    if (hlds__make_hlds__add_mode__succeeded)
      hlds__make_hlds__add_mode__succeeded = MR_TRUE;
    else
    {
      MR_Word hlds__make_hlds__add_mode__ArgX1_77 = ((MR_Word) (MR_hl_field(MR_mktag(0), hlds__make_hlds__add_mode__Var_17, (MR_Integer) 0)));
      MR_Word hlds__make_hlds__add_mode__ArgY1_78 = ((MR_Word) (MR_hl_field(MR_mktag(0), hlds__make_hlds__add_mode__Var_16, (MR_Integer) 0)));
      MR_Integer hlds__make_hlds__add_mode__ArgX2_79 = ((MR_Integer) (MR_hl_field(MR_mktag(0), hlds__make_hlds__add_mode__Var_17, (MR_Integer) 1)));
      MR_Integer hlds__make_hlds__add_mode__ArgY2_80 = ((MR_Integer) (MR_hl_field(MR_mktag(0), hlds__make_hlds__add_mode__Var_16, (MR_Integer) 1)));

      hlds__make_hlds__add_mode__succeeded = mdbcomp__sym_name____Unify____sym_name_0_0(hlds__make_hlds__add_mode__ArgX1_77, hlds__make_hlds__add_mode__ArgY1_78);
      if (hlds__make_hlds__add_mode__succeeded)
        hlds__make_hlds__add_mode__succeeded = (hlds__make_hlds__add_mode__ArgX2_79 == hlds__make_hlds__add_mode__ArgY2_80);
    }
    if (hlds__make_hlds__add_mode__succeeded)
    {
      MR_Word hlds__make_hlds__add_mode__TypeCtorInfo_54_74 = (MR_Word) &hlds__make_hlds__add_mode__hlds__make_hlds__add_mode__type_ctor_info_circ_id_0;
      MR_Word hlds__make_hlds__add_mode__TypeCtorInfo_56_76;
      ...
      MR_Word hlds__make_hlds__add_mode__Var_49;
      MR_Word hlds__make_hlds__add_mode__Var_52;
      MR_Word hlds__make_hlds__add_mode__Var_53;
      MR_Word hlds__make_hlds__add_mode__Var_55;
      MR_Word hlds__make_hlds__add_mode__Var_56;
      MR_Word hlds__make_hlds__add_mode__Var_64;
      MR_Word hlds__make_hlds__add_mode__Var_65;
      MR_Word hlds__make_hlds__add_mode__Var_69;
      MR_Box hlds__make_hlds__add_mode__conv1_Kinds_38;

      hlds__make_hlds__add_mode__conv1_Kinds_38 = parse_tree__error_util__choose_number_3_f_0(hlds__make_hlds__add_mode__TypeCtorInfo_54_74, (MR_Word) &mercury__builtin__builtin__type_ctor_info_string_0, hlds__make_hlds__add_mode__Var_18, ((MR_Box) ((MR_String) "mode")), ((MR_Box) ((MR_String) "modes")));
      hlds__make_hlds__add_mode__Kinds_38 = ((MR_String) hlds__make_hlds__add_mode__conv1_Kinds_38);
      hlds__make_hlds__add_mode__TypeCtorInfo_56_76 = (MR_Word) &parse_tree__error_util__parse_tree__error_util__type_ctor_info_format_component_0;
      hlds__make_hlds__add_mode__ExpansionPieces_39 = mercury__list__map_2_f_0(hlds__make_hlds__add_mode__TypeCtorInfo_54_74, hlds__make_hlds__add_mode__TypeCtorInfo_56_76, (MR_Word) &hlds__make_hlds__add_mode_scalar_common_3[3], hlds__make_hlds__add_mode__Var_18);
      {
        hlds__make_hlds__add_mode__Var_53 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(2), hlds__make_hlds__add_mode__Var_53, 0) = ((MR_Box) (hlds__make_hlds__add_mode__Kinds_38));
      }
      {
        hlds__make_hlds__add_mode__Var_52 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), hlds__make_hlds__add_mode__Var_52, 0) = ((MR_Box) (hlds__make_hlds__add_mode__Var_53));
        MR_hl_field(MR_mktag(1), hlds__make_hlds__add_mode__Var_52, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
      }
      {
        hlds__make_hlds__add_mode__Var_49 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), hlds__make_hlds__add_mode__Var_49, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__add_mode_scalar_common_1[15])));
        MR_hl_field(MR_mktag(1), hlds__make_hlds__add_mode__Var_49, 1) = ((MR_Box) (hlds__make_hlds__add_mode__Var_52));
      }
      hlds__make_hlds__add_mode__Var_56 = parse_tree__error_util__component_list_to_pieces_2_f_0((MR_String) "and", hlds__make_hlds__add_mode__ExpansionPieces_39);
      hlds__make_hlds__add_mode__Var_55 = mercury__list__f_43_43_2_f_0(hlds__make_hlds__add_mode__TypeCtorInfo_56_76, hlds__make_hlds__add_mode__Var_56, (MR_Word) MR_mkword(MR_mktag(1), &hlds__make_hlds__add_mode_scalar_common_1[13]));
      hlds__make_hlds__add_mode__Pieces_42 = mercury__list__f_43_43_2_f_0(hlds__make_hlds__add_mode__TypeCtorInfo_56_76, hlds__make_hlds__add_mode__Var_49, hlds__make_hlds__add_mode__Var_55);
      {
        hlds__make_hlds__add_mode__Var_65 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), hlds__make_hlds__add_mode__Var_65, 0) = ((MR_Box) (hlds__make_hlds__add_mode__Pieces_42));
      }
      {
        hlds__make_hlds__add_mode__Var_64 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), hlds__make_hlds__add_mode__Var_64, 0) = ((MR_Box) (hlds__make_hlds__add_mode__Var_65));
        MR_hl_field(MR_mktag(1), hlds__make_hlds__add_mode__Var_64, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
      }
      {
        ...
        MR_hl_field(MR_mktag(0), hlds__make_hlds__add_mode__Msg_43, 1) = ((MR_Box) (hlds__make_hlds__add_mode__Var_64));
      }
      {
        hlds__make_hlds__add_mode__Var_69 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), hlds__make_hlds__add_mode__Var_69, 0) = ((MR_Box) (hlds__make_hlds__add_mode__Msg_43));
        MR_hl_field(MR_mktag(1), hlds__make_hlds__add_mode__Var_69, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
      }
      {
        ...
        MR_hl_field(MR_mktag(0), hlds__make_hlds__add_mode__Spec_44, 2) = ((MR_Box) (hlds__make_hlds__add_mode__Var_69));
      }
      {
        MR_Word base;
  ...
  while (MR_TRUE)
  {
    /* tailcall optimized into a loop */
    {
      ...
      else
      {
        ...
        MR_Word hlds__make_hlds__add_mode__Var_35;
        MR_Box hlds__make_hlds__add_mode__conv0_InstDefn_18;
        MR_Word hlds__make_hlds__add_mode__Var_19;
        MR_Word hlds__make_hlds__add_mode__Var_22;
        MR_Word hlds__make_hlds__add_mode__Var_23;
        MR_Word hlds__make_hlds__add_mode__Var_24;
        ...
        if (hlds__make_hlds__add_mode__succeeded)
        {
          hlds__make_hlds__add_mode__Var_19 = ((MR_Word) (MR_hl_field(MR_mktag(0), hlds__make_hlds__add_mode__InstDefn_18, (MR_Integer) 0)));
          ...
          hlds__make_hlds__add_mode__Var_22 = ((MR_Word) (MR_hl_field(MR_mktag(0), hlds__make_hlds__add_mode__InstDefn_18, (MR_Integer) 3)));
          hlds__make_hlds__add_mode__Var_23 = ((MR_Word) (MR_hl_field(MR_mktag(0), hlds__make_hlds__add_mode__InstDefn_18, (MR_Integer) 4)));
          hlds__make_hlds__add_mode__Var_24 = ((MR_Word) (MR_hl_field(MR_mktag(0), hlds__make_hlds__add_mode__InstDefn_18, (MR_Integer) 5)));
          ...
          if (hlds__make_hlds__add_mode__succeeded)
          {
            ...
            if (hlds__make_hlds__add_mode__succeeded)
            {
              hlds__make_hlds__add_mode__Var_35 = ((MR_Word) (MR_hl_field(MR_mktag(3), hlds__make_hlds__add_mode__EqvInst_26, (MR_Integer) 1)));
              hlds__make_hlds__add_mode__succeeded = ((MR_tag((MR_Word) hlds__make_hlds__add_mode__Var_35)) == (MR_mktag((MR_Integer) 0)));
              if (hlds__make_hlds__add_mode__succeeded)
              {
                hlds__make_hlds__add_mode__Name_27 = ((MR_Word) (MR_hl_field(MR_mktag(0), hlds__make_hlds__add_mode__Var_35, (MR_Integer) 0)));
                hlds__make_hlds__add_mode__Args_28 = ((MR_Word) (MR_hl_field(MR_mktag(0), hlds__make_hlds__add_mode__Var_35, (MR_Integer) 1)));
              }
            }
          }
        }
        if (hlds__make_hlds__add_mode__succeeded)
        {
          ...
          /* direct tailcall eliminated */
          {
            MR_Word hlds__make_hlds__add_mode__next_value_of_InstId0_12 = hlds__make_hlds__add_mode__InstId_30;
            MR_Word hlds__make_hlds__add_mode__next_value_of_Args0_13 = hlds__make_hlds__add_mode__Args_28;
            MR_Word hlds__make_hlds__add_mode__next_value_of_Expansions0_14 = hlds__make_hlds__add_mode__Expansions_31;

            hlds__make_hlds__add_mode__InstId0_12 = hlds__make_hlds__add_mode__next_value_of_InstId0_12;
            hlds__make_hlds__add_mode__Args0_13 = hlds__make_hlds__add_mode__next_value_of_Args0_13;
            hlds__make_hlds__add_mode__Expansions0_14 = hlds__make_hlds__add_mode__next_value_of_Expansions0_14;
          }
          continue;
        }
        else
...
{
  {
    ...
    if (hlds__make_hlds__add_mode__succeeded)
    {
      ...
      hlds__make_hlds__add_mode__conv1_Kinds_38 = parse_tree__error_util__choose_number_3_f_0(hlds__make_hlds__add_mode__TypeCtorInfo_54_74, (MR_Word) &mercury__builtin__builtin__type_ctor_info_string_0, hlds__make_hlds__add_mode__Var_18, ((MR_Box) ((MR_String) "inst")), ((MR_Box) ((MR_String) "insts")));
      hlds__make_hlds__add_mode__Kinds_38 = ((MR_String) hlds__make_hlds__add_mode__conv1_Kinds_38);
      hlds__make_hlds__add_mode__TypeCtorInfo_56_76 = (MR_Word) &parse_tree__error_util__parse_tree__error_util__type_ctor_info_format_component_0;
      hlds__make_hlds__add_mode__ExpansionPieces_39 = mercury__list__map_2_f_0(hlds__make_hlds__add_mode__TypeCtorInfo_54_74, hlds__make_hlds__add_mode__TypeCtorInfo_56_76, (MR_Word) &hlds__make_hlds__add_mode_scalar_common_3[1], hlds__make_hlds__add_mode__Var_18);
      {
        hlds__make_hlds__add_mode__Var_53 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(2), hlds__make_hlds__add_mode__Var_53, 0) = ((MR_Box) (hlds__make_hlds__add_mode__Kinds_38));
      }
...
{
  {
    ...
    {
      MR_Word hlds__make_hlds__add_mode__EqvInst_30 = ((MR_Word) (MR_hl_field(MR_mktag(1), hlds__make_hlds__add_mode__HeadVar__5_5, (MR_Integer) 0)));
      MR_Integer hlds__make_hlds__add_mode__InstArity_35;
      MR_Word hlds__make_hlds__add_mode__InstId_36;
      MR_Word hlds__make_hlds__add_mode__IFTC_40;
      MR_Word hlds__make_hlds__add_mode__InstDefn_58;
      MR_Word hlds__make_hlds__add_mode__STATE_VARIABLE_Specs_100_100;
      MR_Word hlds__make_hlds__add_mode__Var_101;
      MR_Word hlds__make_hlds__add_mode__STATE_VARIABLE_UserInstTable_102_102;

      mercury__list__length_2_p_0((MR_Word) &hlds__make_hlds__add_mode_scalar_common_1[0], hlds__make_hlds__add_mode__InstParams_3, &hlds__make_hlds__add_mode__InstArity_35);
      {
        hlds__make_hlds__add_mode__InstId_36 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), hlds__make_hlds__add_mode__InstId_36, 0) = ((MR_Box) (hlds__make_hlds__add_mode__InstSymName_2));
        MR_hl_field(MR_mktag(0), hlds__make_hlds__add_mode__InstId_36, 1) = ((MR_Box) (hlds__make_hlds__add_mode__InstArity_35));
      }
      switch (MR_tag((MR_Word) hlds__make_hlds__add_mode__EqvInst_30)) {
        default: /*NOTREACHED*/ MR_assert(0);
        case (MR_Integer) 0:
          {
            MR_Word hlds__make_hlds__add_mode__Var_68;
            MR_Word hlds__make_hlds__add_mode___ForType_53;

            hlds__make_hlds__add_mode__IFTC_40 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
            hlds__make_hlds__add_mode__succeeded = ((MR_tag((MR_Word) hlds__make_hlds__add_mode__MaybeForType_4)) == (MR_mktag((MR_Integer) 1)));
            if (hlds__make_hlds__add_mode__succeeded)
            {
              hlds__make_hlds__add_mode___ForType_53 = ((MR_Word) (MR_hl_field(MR_mktag(1), hlds__make_hlds__add_mode__MaybeForType_4, (MR_Integer) 0)));
              hlds__make_hlds__add_mode__Var_68 = hlds__status__inst_status_defined_in_this_module_1_f_0(hlds__make_hlds__add_mode__InstStatus_7);
              hlds__make_hlds__add_mode__succeeded = (hlds__make_hlds__add_mode__Var_68 == (MR_Integer) 1);
            }
            if (hlds__make_hlds__add_mode__succeeded)
            {
              MR_Word hlds__make_hlds__add_mode__ShortInstSymName_54;
              MR_Word hlds__make_hlds__add_mode__Pieces_55;
              MR_Word hlds__make_hlds__add_mode__Msg_56;
              MR_Word hlds__make_hlds__add_mode__Spec_57;
              MR_String hlds__make_hlds__add_mode__Var_69;
              MR_Word hlds__make_hlds__add_mode__Var_72;
              MR_Word hlds__make_hlds__add_mode__Var_73;
              MR_Word hlds__make_hlds__add_mode__Var_74;
              MR_Word hlds__make_hlds__add_mode__Var_93;
              MR_Word hlds__make_hlds__add_mode__Var_94;
              MR_Word hlds__make_hlds__add_mode__Var_98;

              hlds__make_hlds__add_mode__Var_69 = mdbcomp__sym_name__unqualify_name_1_f_0(hlds__make_hlds__add_mode__InstSymName_2);
              {
                hlds__make_hlds__add_mode__ShortInstSymName_54 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL);
                MR_hl_field(MR_mktag(0), hlds__make_hlds__add_mode__ShortInstSymName_54, 0) = ((MR_Box) (hlds__make_hlds__add_mode__Var_69));
              }
              {
                hlds__make_hlds__add_mode__Var_74 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
                MR_hl_field(MR_mktag(0), hlds__make_hlds__add_mode__Var_74, 0) = ((MR_Box) (hlds__make_hlds__add_mode__ShortInstSymName_54));
                MR_hl_field(MR_mktag(0), hlds__make_hlds__add_mode__Var_74, 1) = ((MR_Box) (hlds__make_hlds__add_mode__InstArity_35));
              }
              {
                hlds__make_hlds__add_mode__Var_73 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), hlds__make_hlds__add_mode__Var_73, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 9));
                MR_hl_field(MR_mktag(3), hlds__make_hlds__add_mode__Var_73, 1) = ((MR_Box) (hlds__make_hlds__add_mode__Var_74));
              }
              {
                hlds__make_hlds__add_mode__Var_72 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(1), hlds__make_hlds__add_mode__Var_72, 0) = ((MR_Box) (hlds__make_hlds__add_mode__Var_73));
                MR_hl_field(MR_mktag(1), hlds__make_hlds__add_mode__Var_72, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &hlds__make_hlds__add_mode_scalar_common_1[11])));
              }
              {
                hlds__make_hlds__add_mode__Pieces_55 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(1), hlds__make_hlds__add_mode__Pieces_55, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__add_mode_scalar_common_1[14])));
                MR_hl_field(MR_mktag(1), hlds__make_hlds__add_mode__Pieces_55, 1) = ((MR_Box) (hlds__make_hlds__add_mode__Var_72));
              }
              {
                hlds__make_hlds__add_mode__Var_94 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL);
                MR_hl_field(MR_mktag(0), hlds__make_hlds__add_mode__Var_94, 0) = ((MR_Box) (hlds__make_hlds__add_mode__Pieces_55));
              }
              {
                hlds__make_hlds__add_mode__Var_93 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(1), hlds__make_hlds__add_mode__Var_93, 0) = ((MR_Box) (hlds__make_hlds__add_mode__Var_94));
                MR_hl_field(MR_mktag(1), hlds__make_hlds__add_mode__Var_93, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
              }
              {
                hlds__make_hlds__add_mode__Msg_56 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
                MR_hl_field(MR_mktag(0), hlds__make_hlds__add_mode__Msg_56, 0) = ((MR_Box) (hlds__make_hlds__add_mode__Context_6));
                MR_hl_field(MR_mktag(0), hlds__make_hlds__add_mode__Msg_56, 1) = ((MR_Box) (hlds__make_hlds__add_mode__Var_93));
              }
              {
                hlds__make_hlds__add_mode__Var_98 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(1), hlds__make_hlds__add_mode__Var_98, 0) = ((MR_Box) (hlds__make_hlds__add_mode__Msg_56));
                MR_hl_field(MR_mktag(1), hlds__make_hlds__add_mode__Var_98, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
              }
              {
                hlds__make_hlds__add_mode__Spec_57 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL);
                MR_hl_field(MR_mktag(0), hlds__make_hlds__add_mode__Spec_57, 0) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
                MR_hl_field(MR_mktag(0), hlds__make_hlds__add_mode__Spec_57, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 4))));
                MR_hl_field(MR_mktag(0), hlds__make_hlds__add_mode__Spec_57, 2) = ((MR_Box) (hlds__make_hlds__add_mode__Var_98));
              }
              {
                hlds__make_hlds__add_mode__STATE_VARIABLE_Specs_100_100 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(1), hlds__make_hlds__add_mode__STATE_VARIABLE_Specs_100_100, 0) = ((MR_Box) (hlds__make_hlds__add_mode__Spec_57));
                MR_hl_field(MR_mktag(1), hlds__make_hlds__add_mode__STATE_VARIABLE_Specs_100_100, 1) = ((MR_Box) (hlds__make_hlds__add_mode__STATE_VARIABLE_Specs_0_10));
              }
            }
            else
              hlds__make_hlds__add_mode__STATE_VARIABLE_Specs_100_100 = hlds__make_hlds__add_mode__STATE_VARIABLE_Specs_0_10;
          }
          break;
        case (MR_Integer) 1:
        case (MR_Integer) 2:
          ...
          break;
        case (MR_Integer) 3:
          switch (((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), hlds__make_hlds__add_mode__EqvInst_30, (MR_Integer) 0)))) {
            default: /*NOTREACHED*/ MR_assert(0);
            case (MR_Integer) 0:
              {
                if ((hlds__make_hlds__add_mode__MaybeForType_4 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
                  hlds__make_hlds__add_mode__IFTC_40 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 1));
                else
                {
                  MR_Word hlds__make_hlds__add_mode__ForType_41 = ((MR_Word) (MR_hl_field(MR_mktag(1), hlds__make_hlds__add_mode__MaybeForType_4, (MR_Integer) 0)));

                  {
                    hlds__make_hlds__add_mode__IFTC_40 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(MR_mktag(1), hlds__make_hlds__add_mode__IFTC_40, 0) = ((MR_Box) (hlds__make_hlds__add_mode__ForType_41));
                  }
                }
                hlds__make_hlds__add_mode__STATE_VARIABLE_Specs_100_100 = hlds__make_hlds__add_mode__STATE_VARIABLE_Specs_0_10;
              }
      ...
      {
        hlds__make_hlds__add_mode__Var_101 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), hlds__make_hlds__add_mode__Var_101, 0) = ((MR_Box) (hlds__make_hlds__add_mode__EqvInst_30));
      }
      {
        hlds__make_hlds__add_mode__InstDefn_58 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 6 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), hlds__make_hlds__add_mode__InstDefn_58, 0) = ((MR_Box) (hlds__make_hlds__add_mode__VarSet_1));
        MR_hl_field(MR_mktag(0), hlds__make_hlds__add_mode__InstDefn_58, 1) = ((MR_Box) (hlds__make_hlds__add_mode__InstParams_3));
        MR_hl_field(MR_mktag(0), hlds__make_hlds__add_mode__InstDefn_58, 2) = ((MR_Box) (hlds__make_hlds__add_mode__Var_101));
        MR_hl_field(MR_mktag(0), hlds__make_hlds__add_mode__InstDefn_58, 3) = ((MR_Box) (hlds__make_hlds__add_mode__IFTC_40));
        MR_hl_field(MR_mktag(0), hlds__make_hlds__add_mode__InstDefn_58, 4) = ((MR_Box) (hlds__make_hlds__add_mode__Context_6));
        MR_hl_field(MR_mktag(0), hlds__make_hlds__add_mode__InstDefn_58, 5) = ((MR_Box) (hlds__make_hlds__add_mode__InstStatus_7));
      }
      hlds__make_hlds__add_mode__succeeded = mercury__map__insert_4_p_0((MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_inst_id_0, (MR_Word) &hlds__hlds_data__hlds__hlds_data__type_ctor_info_hlds_inst_defn_0, ((MR_Box) (hlds__make_hlds__add_mode__InstId_36)), ((MR_Box) (hlds__make_hlds__add_mode__InstDefn_58)), hlds__make_hlds__add_mode__STATE_VARIABLE_UserInstTable_0_8, &hlds__make_hlds__add_mode__STATE_VARIABLE_UserInstTable_102_102);
      if (hlds__make_hlds__add_mode__succeeded)
      {
        *hlds__make_hlds__add_mode__STATE_VARIABLE_UserInstTable_9 = hlds__make_hlds__add_mode__STATE_VARIABLE_UserInstTable_102_102;
        *hlds__make_hlds__add_mode__STATE_VARIABLE_Specs_11 = hlds__make_hlds__add_mode__STATE_VARIABLE_Specs_100_100;
      }
      else
      {
        MR_Word hlds__make_hlds__add_mode__InstModeStatus_59 = (MR_Word) hlds__make_hlds__add_mode__InstStatus_7;
        MR_Word hlds__make_hlds__add_mode__ReportDup_60;

        hlds__make_hlds__add_mode__ReportDup_60 = hlds__make_hlds__add_mode__should_report_duplicate_inst_or_mode_1_f_0(hlds__make_hlds__add_mode__InstModeStatus_59);
        switch (hlds__make_hlds__add_mode__ReportDup_60) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 0:
            *hlds__make_hlds__add_mode__STATE_VARIABLE_Specs_11 = hlds__make_hlds__add_mode__STATE_VARIABLE_Specs_100_100;
            break;
          case (MR_Integer) 1:
            {
              MR_Word hlds__make_hlds__add_mode__OrigInstDefn_61;
              MR_Word hlds__make_hlds__add_mode__OrigContext_62;
              MR_Box hlds__make_hlds__add_mode__conv0_OrigInstDefn_61;
              MR_Word hlds__make_hlds__add_mode__Var_106;
              MR_Word hlds__make_hlds__add_mode__Var_107;
              MR_Word hlds__make_hlds__add_mode__Var_108;
              MR_Word hlds__make_hlds__add_mode__Var_109;
              MR_Word hlds__make_hlds__add_mode__Var_110;

              mercury__map__lookup_3_p_0((MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_inst_id_0, (MR_Word) &hlds__hlds_data__hlds__hlds_data__type_ctor_info_hlds_inst_defn_0, hlds__make_hlds__add_mode__STATE_VARIABLE_UserInstTable_0_8, ((MR_Box) (hlds__make_hlds__add_mode__InstId_36)), &hlds__make_hlds__add_mode__conv0_OrigInstDefn_61);
              hlds__make_hlds__add_mode__OrigInstDefn_61 = ((MR_Word) hlds__make_hlds__add_mode__conv0_OrigInstDefn_61);
              hlds__make_hlds__add_mode__Var_106 = ((MR_Word) (MR_hl_field(MR_mktag(0), hlds__make_hlds__add_mode__OrigInstDefn_61, (MR_Integer) 0)));
              hlds__make_hlds__add_mode__Var_107 = ((MR_Word) (MR_hl_field(MR_mktag(0), hlds__make_hlds__add_mode__OrigInstDefn_61, (MR_Integer) 1)));
              hlds__make_hlds__add_mode__Var_108 = ((MR_Word) (MR_hl_field(MR_mktag(0), hlds__make_hlds__add_mode__OrigInstDefn_61, (MR_Integer) 2)));
              hlds__make_hlds__add_mode__Var_109 = ((MR_Word) (MR_hl_field(MR_mktag(0), hlds__make_hlds__add_mode__OrigInstDefn_61, (MR_Integer) 3)));
              hlds__make_hlds__add_mode__OrigContext_62 = ((MR_Word) (MR_hl_field(MR_mktag(0), hlds__make_hlds__add_mode__OrigInstDefn_61, (MR_Integer) 4)));
              hlds__make_hlds__add_mode__Var_110 = ((MR_Word) (MR_hl_field(MR_mktag(0), hlds__make_hlds__add_mode__OrigInstDefn_61, (MR_Integer) 5)));
              hlds__make_hlds__make_hlds_error__report_multiple_def_error_8_p_0(hlds__make_hlds__add_mode__InstSymName_2, hlds__make_hlds__add_mode__InstArity_35, (MR_String) "inst", hlds__make_hlds__add_mode__Context_6, hlds__make_hlds__add_mode__OrigContext_62, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), hlds__make_hlds__add_mode__STATE_VARIABLE_Specs_100_100, hlds__make_hlds__add_mode__STATE_VARIABLE_Specs_11);
            }
            break;
        }
