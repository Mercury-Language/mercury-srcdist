...
hlds__make_hlds__add_mode__IntroducedFrom__func__report_circular_equiv_error__383__1_1_f_0(
...
static /* final */ const MR_Box hlds__make_hlds__add_mode_scalar_common_1[21][2] = {
  ...
  /* row 4 */
  {
    ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__add_mode_scalar_common_1[3]))),
    ((MR_Box) (MR_mkword(MR_mktag(1), &hlds__make_hlds__add_mode_scalar_common_1[2])))
  },
  /* row 5 */
  {
  ...
  /* row 6 */
  {
    ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__add_mode_scalar_common_1[5]))),
    ((MR_Box) (MR_mkword(MR_mktag(1), &hlds__make_hlds__add_mode_scalar_common_1[4])))
  },
  /* row 7 */
  {
    ((MR_Box) (MR_Word) ((MR_Unsigned) 5U)),
  ...
  /* row 8 */
  {
    ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__add_mode_scalar_common_1[7]))),
    ((MR_Box) (MR_mkword(MR_mktag(1), &hlds__make_hlds__add_mode_scalar_common_1[6])))
  },
  /* row 9 */
  {
    ((MR_Box) (MR_Word) ((MR_Unsigned) 5U)),
  ...
  /* row 10 */
  {
    ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__add_mode_scalar_common_1[9]))),
    ((MR_Box) (MR_mkword(MR_mktag(1), &hlds__make_hlds__add_mode_scalar_common_1[8])))
  },
  /* row 11 */
  {
    ((MR_Box) (MR_Word) ((MR_Unsigned) 5U)),
  ...
  /* row 17 */
  {
    ...
    ((MR_Box) (MR_mkword(MR_mktag(1), &hlds__make_hlds__add_mode_scalar_common_1[15])))
  },
  /* row 18 */
  {
    ((MR_Box) (MR_Word) ((MR_Unsigned) 5U)),
...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(3), LambdaHeadVar__2_26, 0) = ((MR_Box) ((MR_Unsigned) 10U));
...
void MR_CALL 
hlds__make_hlds__add_mode__module_check_mode_defn_6_p_0(
  MR_Word ModuleInfo_7,
  MR_Word ItemModeDefnInfo_8,
  MR_Word STATE_VARIABLE_FoundInvalidInstOrMode_0_22,
  MR_Word * STATE_VARIABLE_FoundInvalidInstOrMode_23,
...
{
  {
    ...
    MR_Integer Arity_18;
    MR_Word ModeCtor_19;
    MR_Word FoundInvalidMode_21;

    hlds__hlds_module__module_info_get_mode_table_2_p_0(ModuleInfo_7, &ModeTable_11);
    Name_12 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ItemModeDefnInfo_8, (MR_Integer) 0))));
    Params_13 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ItemModeDefnInfo_8, (MR_Integer) 1))));
    Context_16 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ItemModeDefnInfo_8, (MR_Integer) 4))));
    mercury__list__length_2_p_0((MR_Word) (&hlds__make_hlds__add_mode_scalar_common_1[0]), Params_13, &Arity_18);
    {
      ModeCtor_19 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), ModeCtor_19, 0) = ((MR_Box) (Name_12));
      MR_hl_field(MR_mktag(0), ModeCtor_19, 1) = ((MR_Box) (Arity_18));
    }
    hlds__make_hlds__add_mode__check_for_cyclic_mode_8_p_0(ModeTable_11, ModeCtor_19, ModeCtor_19, (MR_Word) ((MR_Unsigned) 0U), Context_16, &FoundInvalidMode_21, STATE_VARIABLE_Specs_0_24, STATE_VARIABLE_Specs_25);
    switch (FoundInvalidMode_21) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        *STATE_VARIABLE_FoundInvalidInstOrMode_23 = STATE_VARIABLE_FoundInvalidInstOrMode_0_22;
        break;
      case (MR_Integer) 1:
        *STATE_VARIABLE_FoundInvalidInstOrMode_23 = (MR_Integer) 1;
        break;
    }
  }
}
...
{
  {
    ...
    conv2_LambdaHeadVar__2_26 = hlds__make_hlds__add_mode__IntroducedFrom__func__report_circular_equiv_error__383__1_1_f_0(((MR_Word) (wrapper_arg_1)));
...
{
  {
    ...
    if (succeeded)
    {
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(1), Var_48, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__add_mode_scalar_common_1[18])));
      ...
      Var_54 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_format_component_0), Var_55, (MR_Word) (MR_mkword(MR_mktag(1), &hlds__make_hlds__add_mode_scalar_common_1[20])));
...
void MR_CALL 
hlds__make_hlds__add_mode__module_check_inst_defn_6_p_0(
  MR_Word ModuleInfo_7,
  MR_Word ItemInstDefnInfo_8,
  MR_Word STATE_VARIABLE_FoundInvalidInstOrMode_0_24,
  MR_Word * STATE_VARIABLE_FoundInvalidInstOrMode_25,
...
{
  {
    ...
    MR_Word InstCtor_21;
    MR_Word TestArgs_22;
    MR_Word FoundInvalidInst_23;

    hlds__hlds_module__module_info_get_inst_table_2_p_0(ModuleInfo_7, &InstTable_18);
    hlds__hlds_inst_mode__inst_table_get_user_insts_2_p_0(InstTable_18, &UserInstTable_19);
    InstArity_20 = mercury__list__length_1_f_0((MR_Word) (&hlds__make_hlds__add_mode_scalar_common_1[0]), InstParams_12);
    {
      InstCtor_21 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), InstCtor_21, 0) = ((MR_Box) (InstName_11));
      MR_hl_field(MR_mktag(0), InstCtor_21, 1) = ((MR_Box) (InstArity_20));
    }
    TestArgs_22 = mercury__list__duplicate_2_f_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_inst_0), InstArity_20, ((MR_Box) ((MR_Unsigned) 4U)));
    hlds__make_hlds__add_mode__check_for_cyclic_inst_9_p_0(UserInstTable_19, InstCtor_21, InstCtor_21, TestArgs_22, (MR_Word) ((MR_Unsigned) 0U), Context_16, &FoundInvalidInst_23, STATE_VARIABLE_Specs_0_26, STATE_VARIABLE_Specs_27);
    switch (FoundInvalidInst_23) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        *STATE_VARIABLE_FoundInvalidInstOrMode_25 = STATE_VARIABLE_FoundInvalidInstOrMode_0_24;
        break;
      case (MR_Integer) 1:
        *STATE_VARIABLE_FoundInvalidInstOrMode_25 = (MR_Integer) 1;
        break;
    }
  }
}
      ...
      case (MR_Integer) 0:
        {
          ...
          if (succeeded)
          {
            ...
            }
            {
              ...
              MR_hl_field(MR_mktag(1), Var_59, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &hlds__make_hlds__add_mode_scalar_common_1[10])));
            }
            {
              Pieces_113 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), Pieces_113, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__add_mode_scalar_common_1[1])));
            ...
            }
            {
              ...
              MR_hl_field(MR_mktag(1), Spec_114, 2) = ((MR_Box) ((MR_Unsigned) 24U));
                ...
                case (MR_Integer) 1:
                  {
                    ...
                    }
                    {
                      ...
                      MR_hl_field(MR_mktag(1), Var_84, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &hlds__make_hlds__add_mode_scalar_common_1[17])));
                    }
                    {
                      Pieces_29 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                      MR_hl_field(MR_mktag(1), Pieces_29, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__add_mode_scalar_common_1[11])));
                    ...
                    }
                    {
                      ...
                      MR_hl_field(MR_mktag(2), Spec_31, 3) = ((MR_Box) ((MR_Unsigned) 24U));
