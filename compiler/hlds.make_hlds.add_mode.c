  ...
  MR_Word HeadVar__1_124)
{
  ...
  {
    HeadVar__2_125 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(MR_mktag(1), HeadVar__2_125, 0) = ((MR_Box) (HeadVar__1_124));
    MR_hl_field(MR_mktag(1), HeadVar__2_125, 1) = ((MR_Box) ((MR_Unsigned) 0U));
  }
  ...
  MR_Word * Spec_8)
{
  ...
  if ((LocalSNAsContexts_13 == (MR_Word) ((MR_Unsigned) 0U)))
    ...
    else
    {
      ...
      MR_Word SNA_129 = ((MR_Word) ((MR_hl_field(MR_mktag(0), HeadOtherSNAContext_15, (MR_Integer) 0))));
      ...
      HeadContext_18 = ((MR_Word) ((MR_hl_field(MR_mktag(0), HeadOtherSNAContext_15, (MR_Integer) 1))));
      {
        ...
        MR_hl_field(MR_mktag(3), HeadSNAPiece_19, 1) = ((MR_Box) (SNA_129));
      }
  ...
  MR_Word * STATE_VARIABLE_Specs_53)
{
  ...
  else
  {
    ...
    {
      MR_Word InstModeImport_133 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(1), InstModeStatus_46, (MR_Integer) 0))) & (MR_Integer) 3);

      switch (InstModeImport_133) {
        default: /*NOTREACHED*/ MR_assert(0);
        case (MR_Integer) 1:
        case (MR_Integer) 0:
          {
    ...
    {
      MR_Word OrigInstDefn_141;
      MR_Word OrigContext_142;
      MR_Word Var_144;
      MR_Box conv1_OrigInstDefn_141;

      mercury__map__lookup_3_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_inst_ctor_0), (MR_Word) (&hlds__hlds_inst_mode__hlds__hlds_inst_mode__type_ctor_info_hlds_inst_defn_0), STATE_VARIABLE_UserInstTable_0_50, ((MR_Box) (InstCtor_22)), &conv1_OrigInstDefn_141);
      OrigInstDefn_141 = ((MR_Word) (conv1_OrigInstDefn_141));
      OrigContext_142 = ((MR_Word) ((MR_hl_field(MR_mktag(0), OrigInstDefn_141, (MR_Integer) 4))));
      Var_144 = (MR_Word) (InstArity_21);
      hlds__make_hlds_error__report_multiply_defined_8_p_0((MR_String) "inst", InstSymName_13, Var_144, Context_17, OrigContext_142, (MR_Word) ((MR_Unsigned) 0U), STATE_VARIABLE_Specs_105_105, STATE_VARIABLE_Specs_53);
    }
