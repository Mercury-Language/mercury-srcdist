  ...
  MR_Word * STATE_VARIABLE_Specs_29)
{
  {
    MR_bool succeeded;
    MR_Word Name_14 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ItemModeDefnInfo_10, (MR_Integer) 0))));
    MR_Word Params_15 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ItemModeDefnInfo_10, (MR_Integer) 1))));
    MR_Word MaybeAbstractModeDefn_16 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ItemModeDefnInfo_10, (MR_Integer) 2))));
    MR_Word VarSet_17 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ItemModeDefnInfo_10, (MR_Integer) 3))));
    MR_Word Context_18 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ItemModeDefnInfo_10, (MR_Integer) 4))));
    ...
    else
    {
      ...
      HldsModeBody_49 = (MR_Word) (EqvMode_48);
      {
        ...
        MR_hl_field(MR_mktag(0), ModeDefn_50, 4) = ((MR_Box) (ModeStatus_9));
      }
      ...
      {
        MR_Word InstModeStatus_51 = (MR_Word) (ModeStatus_9);
...
{
  {
    MR_Word InstName_14 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ItemInstDefnInfo_10, (MR_Integer) 0))));
    MR_Word InstParams_15 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ItemInstDefnInfo_10, (MR_Integer) 1))));
    MR_Word MaybeForType_16 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ItemInstDefnInfo_10, (MR_Integer) 2))));
    MR_Word MaybeAbstractInstDefn_17 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ItemInstDefnInfo_10, (MR_Integer) 3))));
    MR_Word VarSet_18 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ItemInstDefnInfo_10, (MR_Integer) 4))));
    MR_Word Context_19 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ItemInstDefnInfo_10, (MR_Integer) 5))));
    ...
    else
    {
      ...
      hlds__make_hlds__add_mode__insts_add_11_p_0(VarSet_18, InstName_14, InstParams_15, MaybeForType_16, InstDefn_21, Context_19, InstStatus_9, UserInstTable0_23, &UserInstTable_24, STATE_VARIABLE_Specs_0_34, &STATE_VARIABLE_Specs_36_36);
