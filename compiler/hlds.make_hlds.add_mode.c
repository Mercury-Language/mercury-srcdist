    ...
    else
    {
      ...
      else
      {
        ...
        else
        {
          ...
          mercury__map__lookup_3_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mode_id_0), (MR_Word) (&hlds__hlds_inst_mode__hlds__hlds_inst_mode__type_ctor_info_hlds_mode_defn_0), ModeDefns_81, ((MR_Box) (ModeId_47)), &conv1_OrigModeDefn_82);
...
{
  {
    ...
    if (succeeded)
    {
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(1), Msg_43, 0) = ((MR_Box) (Context_10));
        MR_hl_field(MR_mktag(1), Msg_43, 1) = ((MR_Box) (Var_64));
      }
      {
      ...
      case (MR_Integer) 0:
        {
          ...
          if (succeeded)
          {
            ...
            {
              Msg_126 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), Msg_126, 0) = ((MR_Box) (Context_17));
              MR_hl_field(MR_mktag(1), Msg_126, 1) = ((MR_Box) (Var_79));
            }
            {
                ...
                case (MR_Integer) 1:
                  {
                    ...
                    }
                    {
                      ...
                      MR_hl_field(MR_mktag(1), Var_106, 0) = (MR_Box) (((((MR_Unsigned) ((MR_Integer) 49) << 1)) | (MR_Unsigned) ((MR_Integer) 1)));
                    ...
                    }
                    {
                      ...
                      MR_hl_field(MR_mktag(1), Msg_31, 0) = ((MR_Box) (Context_17));
                      MR_hl_field(MR_mktag(1), Msg_31, 1) = ((MR_Box) (Var_105));
                    }
                    {
