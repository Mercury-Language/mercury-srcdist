...
static /* final */ const MR_Box hlds__make_hlds__add_mode_scalar_common_1[42][2] = {
  ...
  /* row  41 */
  {
    ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__add_mode_scalar_common_1[40]))),
    ((MR_Box) (MR_mkword(MR_mktag(1), &hlds__make_hlds__add_mode_scalar_common_1[7])))
  },
};
  ...
  MR_Word HeadVar__1_123)
{
  ...
  HeadVar__2_124 = hlds__make_hlds__add_mode__f_85_110_117_115_101_100_65_114_103_115_95_95_102_117_110_99_95_95_109_97_107_101_95_115_105_110_103_108_101_116_111_110_95_108_105_115_116_95_95_91_49_93_95_48_1_f_0(((MR_Box) (HeadVar__1_123)));
  ...
  MR_Word * Spec_8)
{
  ...
  else
  {
    ...
    hlds__make_hlds__add_mode__local_sna_and_context_to_piece_and_msg_5_p_0(ModuleInfo_5, InstOrMode_6, HeadLocalSNAContext_22, &HeadSNAPiece_19, &_HeadMsg_24);
    {
      ...
      MR_hl_field(MR_mktag(0), Var_41, 0) = ((MR_Box) (&hlds__make_hlds__add_mode_scalar_common_5[0]));
      MR_hl_field(MR_mktag(0), Var_41, 1) = ((MR_Box) (hlds__make_hlds__add_mode__cycle_to_error_spec_4_p_0_3));
      MR_hl_field(MR_mktag(0), Var_41, 2) = ((MR_Box) ((MR_Integer) 2));
      MR_hl_field(MR_mktag(0), Var_41, 3) = ((MR_Box) (ModuleInfo_5));
      MR_hl_field(MR_mktag(0), Var_41, 4) = ((MR_Box) (InstOrMode_6));
    }
  ...
  if ((LaterSNAPieces_20 == (MR_Word) ((MR_Unsigned) 0U)))
  {
    ...
    Var_71 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_format_component_0), (MR_Word) (MR_mkword(MR_mktag(1), &hlds__make_hlds__add_mode_scalar_common_1[35])), ConsequencePieces_28);
  ...
  {
    MR_Word Var_126 = ((MR_Word) ((MR_hl_field(MR_mktag(1), LaterSNAPieces_20, (MR_Integer) 1))));
    MR_Word Var_127 = ((MR_Word) ((MR_hl_field(MR_mktag(1), LaterSNAPieces_20, (MR_Integer) 0))));
    ...
    if ((Var_126 == (MR_Word) ((MR_Unsigned) 0U)))
    {
...

      {
        ...
        MR_hl_field(MR_mktag(1), Var_81, 0) = ((MR_Box) (Var_127));
        MR_hl_field(MR_mktag(1), Var_81, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &hlds__make_hlds__add_mode_scalar_common_1[35])));
      }
      {
        Var_78 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), Var_78, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__add_mode_scalar_common_1[36])));
    ...
    else
    {
      ...
      CyclePieces_35 = parse_tree__error_util__component_list_to_line_pieces_2_f_0(LaterSNAPieceLists_34, (MR_Word) (MR_mkword(MR_mktag(1), &hlds__make_hlds__add_mode_scalar_common_1[37])));
      ...
      Var_94 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_format_component_0), (MR_Word) (MR_mkword(MR_mktag(1), &hlds__make_hlds__add_mode_scalar_common_1[38])), Var_101);
  ...
  }
  {
    ...
    MR_hl_field(MR_mktag(1), Var_105, 0) = ((MR_Box) (HeadMsg_36));
    MR_hl_field(MR_mktag(1), Var_105, 1) = ((MR_Box) (ContextMsgs_21));
  }
  {
    MR_Word base;
  ...
  MR_Word * Msg_11)
{
  ...
  }
  {
    ...
    MR_hl_field(MR_mktag(1), Var_28, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &hlds__make_hlds__add_mode_scalar_common_1[41])));
  }
  {
    MsgPieces_24 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(MR_mktag(1), MsgPieces_24, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__add_mode_scalar_common_1[39])));
  ...
  MR_Word * STATE_VARIABLE_Specs_23)
{
  ...
  else
  {
    ...
    MR_Word ModeCtor_37;
    MR_Word EqvMode_38;
    MR_Word HldsModeBody_39;
    MR_Word ModeDefn_40;
    MR_Word STATE_VARIABLE_ModeTable_37_50;

    hlds__hlds_module__module_info_get_mode_table_2_p_0(STATE_VARIABLE_ModuleInfo_0_20, &ModeTable0_18);
    mercury__list__length_2_p_0((MR_Word) (&hlds__make_hlds__add_mode_scalar_common_1[0]), Params_12, &Arity_36);
    {
      ModeCtor_37 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), ModeCtor_37, 0) = ((MR_Box) (Name_11));
      MR_hl_field(MR_mktag(0), ModeCtor_37, 1) = ((MR_Box) (Arity_36));
    }
    EqvMode_38 = (MR_Word) (ModeDefn_17);
    HldsModeBody_39 = (MR_Word) (EqvMode_38);
    {
      ModeDefn_40 = (MR_Word) MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), ModeDefn_40, 0) = ((MR_Box) (VarSet_14));
      MR_hl_field(MR_mktag(0), ModeDefn_40, 1) = ((MR_Box) (Params_12));
      MR_hl_field(MR_mktag(0), ModeDefn_40, 2) = ((MR_Box) (HldsModeBody_39));
      MR_hl_field(MR_mktag(0), ModeDefn_40, 3) = ((MR_Box) (Context_15));
      MR_hl_field(MR_mktag(0), ModeDefn_40, 4) = ((MR_Box) (ModeStatus_7));
    }
    succeeded = hlds__hlds_inst_mode__mode_table_insert_4_p_0(ModeCtor_37, ModeDefn_40, ModeTable0_18, &STATE_VARIABLE_ModeTable_37_50);
    if (succeeded)
    {
      ModeTable_19 = STATE_VARIABLE_ModeTable_37_50;
      *STATE_VARIABLE_Specs_23 = STATE_VARIABLE_Specs_0_22;
    }
    else
    {
      MR_Word InstModeStatus_41 = (MR_Word) (ModeStatus_7);

      if (((MR_tag((MR_Word) InstModeStatus_41)) == (MR_Integer) 1))
      {
        MR_Word InstModeImport_60 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(1), InstModeStatus_41, (MR_Integer) 0))) & (MR_Integer) 3);

        switch (InstModeImport_60) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 1:
          case (MR_Integer) 0:
            {
              MR_Word ModeDefns_43;
              MR_Word OrigModeDefn_44;
              MR_Word OrigContext_48;
              MR_Word Var_52;
              MR_Box conv0_OrigModeDefn_44;

              hlds__hlds_inst_mode__mode_table_get_mode_defns_2_p_0(ModeTable0_18, &ModeDefns_43);
              mercury__map__lookup_3_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mode_ctor_0), (MR_Word) (&hlds__hlds_inst_mode__hlds__hlds_inst_mode__type_ctor_info_hlds_mode_defn_0), ModeDefns_43, ((MR_Box) (ModeCtor_37)), &conv0_OrigModeDefn_44);
              OrigModeDefn_44 = ((MR_Word) (conv0_OrigModeDefn_44));
              OrigContext_48 = ((MR_Word) ((MR_hl_field(MR_mktag(0), OrigModeDefn_44, (MR_Integer) 3))));
              Var_52 = (MR_Word) (Arity_36);
              hlds__make_hlds_error__report_multiply_defined_8_p_0((MR_String) "mode", Name_11, Var_52, Context_15, OrigContext_48, (MR_Word) ((MR_Unsigned) 0U), STATE_VARIABLE_Specs_0_22, STATE_VARIABLE_Specs_23);
            }
            break;
          case (MR_Integer) 2:
            *STATE_VARIABLE_Specs_23 = STATE_VARIABLE_Specs_0_22;
      ...
      {
        MR_Word ModeDefns_67;
        MR_Word OrigModeDefn_68;
        MR_Word OrigContext_72;
        MR_Word Var_75;
        MR_Box conv1_OrigModeDefn_68;

        hlds__hlds_inst_mode__mode_table_get_mode_defns_2_p_0(ModeTable0_18, &ModeDefns_67);
        mercury__map__lookup_3_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mode_ctor_0), (MR_Word) (&hlds__hlds_inst_mode__hlds__hlds_inst_mode__type_ctor_info_hlds_mode_defn_0), ModeDefns_67, ((MR_Box) (ModeCtor_37)), &conv1_OrigModeDefn_68);
        OrigModeDefn_68 = ((MR_Word) (conv1_OrigModeDefn_68));
        OrigContext_72 = ((MR_Word) ((MR_hl_field(MR_mktag(0), OrigModeDefn_68, (MR_Integer) 3))));
        Var_75 = (MR_Word) (Arity_36);
        hlds__make_hlds_error__report_multiply_defined_8_p_0((MR_String) "mode", Name_11, Var_75, Context_15, OrigContext_72, (MR_Word) ((MR_Unsigned) 0U), STATE_VARIABLE_Specs_0_22, STATE_VARIABLE_Specs_23);
      }
    ...
    case (MR_Integer) 0:
      {
        ...
        if (succeeded)
        {
          ...
          Var_81 = mdbcomp__sym_name__unqualify_name_1_f_0(InstSymName_13);
          {
            ...
            MR_hl_field(MR_mktag(0), ShortInstSymName_113, 0) = ((MR_Box) (Var_81));
          }
          {
            Var_86 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
            MR_hl_field(MR_mktag(0), Var_86, 0) = ((MR_Box) (ShortInstSymName_113));
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(1), Pieces_114, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__add_mode_scalar_common_1[6])));
            MR_hl_field(MR_mktag(1), Pieces_114, 1) = ((MR_Box) (Var_84));
          }
          {
            Spec_115 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), Spec_115, 0) = ((MR_Box) ((MR_String) "predicate \140hlds.make_hlds.add_mode.insts_add\'/11"));
            MR_hl_field(MR_mktag(1), Spec_115, 1) = ((MR_Box) ((MR_Unsigned) 0U));
            MR_hl_field(MR_mktag(1), Spec_115, 2) = ((MR_Box) ((MR_Unsigned) 40U));
            MR_hl_field(MR_mktag(1), Spec_115, 3) = ((MR_Box) (Context_17));
            MR_hl_field(MR_mktag(1), Spec_115, 4) = ((MR_Box) (Pieces_114));
          }
          {
            STATE_VARIABLE_Specs_79_79 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), STATE_VARIABLE_Specs_79_79, 0) = ((MR_Box) (Spec_115));
            MR_hl_field(MR_mktag(1), STATE_VARIABLE_Specs_79_79, 1) = ((MR_Box) (STATE_VARIABLE_Specs_0_52));
          }
        }
        else
              ...
              case (MR_Integer) 1:
                {
                  ...
                  Var_54 = mdbcomp__sym_name__unqualify_name_1_f_0(InstSymName_13);
                  {
                    ...
                    MR_hl_field(MR_mktag(0), ShortInstSymName_28, 0) = ((MR_Box) (Var_54));
                  }
                  {
                    Var_59 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
                    MR_hl_field(MR_mktag(0), Var_59, 0) = ((MR_Box) (ShortInstSymName_28));
                    MR_hl_field(MR_mktag(0), Var_59, 1) = ((MR_Box) (InstArity_21));
                  }
                  {
                  ...
                  }
                  {
                    ...
                    MR_hl_field(MR_mktag(1), Var_57, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &hlds__make_hlds__add_mode_scalar_common_1[22])));
                  }
                  {
                    ...
                    MR_hl_field(MR_mktag(1), Pieces_29, 1) = ((MR_Box) (Var_57));
                  }
                  {
                    Var_77 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
                    MR_hl_field(MR_mktag(0), Var_77, 0) = ((MR_Box) (Context_17));
                    MR_hl_field(MR_mktag(0), Var_77, 1) = ((MR_Box) (Pieces_29));
                  }
                  {
                  ...
                  }
                  {
                    ...
                    MR_hl_field(MR_mktag(3), Spec_31, 4) = ((MR_Box) (Var_76));
                  }
                  {
                    STATE_VARIABLE_Specs_79_79 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(MR_mktag(1), STATE_VARIABLE_Specs_79_79, 0) = ((MR_Box) (Spec_31));
                    MR_hl_field(MR_mktag(1), STATE_VARIABLE_Specs_79_79, 1) = ((MR_Box) (STATE_VARIABLE_Specs_0_52));
                  }
                }
                break;
