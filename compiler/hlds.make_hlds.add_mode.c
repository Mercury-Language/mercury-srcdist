      ...
      case (MR_Integer) 0:
        {
          ...
          if (succeeded)
          {
            ...
            }
            {
              ...
              MR_hl_field(MR_mktag(1), Spec_114, 2) = ((MR_Box) ((MR_Unsigned) 36U));
                ...
                case (MR_Integer) 1:
                  {
                    ...
                    }
                    {
                      ...
                      MR_hl_field(MR_mktag(2), Spec_31, 1) = (MR_Box) (((((MR_Unsigned) ((MR_Integer) 49) << 1)) | (MR_Unsigned) ((MR_Integer) 1)));
                      MR_hl_field(MR_mktag(2), Spec_31, 2) = ((MR_Box) ((MR_Unsigned) 4U));
                      MR_hl_field(MR_mktag(2), Spec_31, 3) = ((MR_Box) ((MR_Unsigned) 36U));
