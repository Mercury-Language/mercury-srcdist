...
{
  {
    ...
    if (succeeded)
    {
      ...
      ExpansionPieces_39 = mercury__list__map_2_f_0((MR_Word) (&hlds__make_hlds__add_mode__hlds__make_hlds__add_mode__type_ctor_info_circ_id_0), (MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_format_component_0), (MR_Word) (&hlds__make_hlds__add_mode_scalar_common_4[3]), Var_18);
      {
...
{
  {
    ...
    if (succeeded)
    {
      ...
      Kinds_38 = ((MR_String) (conv1_Kinds_38));
      ExpansionPieces_39 = mercury__list__map_2_f_0((MR_Word) (&hlds__make_hlds__add_mode__hlds__make_hlds__add_mode__type_ctor_info_circ_id_0), (MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_format_component_0), (MR_Word) (&hlds__make_hlds__add_mode_scalar_common_4[1]), Var_18);
      {
        Var_53 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(2), Var_53, 0) = ((MR_Box) (Kinds_38));
      }
                  ...
                  case (MR_Integer) 1:
                    {
                      ...
                      }
                      {
                        ...
                        MR_hl_field(MR_mktag(1), Var_120, 0) = (MR_Box) (((MR_Unsigned) (((MR_Box) ((MR_Integer) 47))) | (((MR_Unsigned) (((MR_Box) ((MR_Integer) 1))) << (MR_Integer) 10))));
