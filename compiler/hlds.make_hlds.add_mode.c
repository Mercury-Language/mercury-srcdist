...
{
  {
    ...
    else
    {
              ...
              case (MR_Integer) 0:
                {
                  ...
                  hlds__make_hlds_error__report_multiple_def_error_8_p_0(Name_13, Arity_40, (MR_String) "mode", Context_17, OrigContext_50, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), STATE_VARIABLE_Specs_0_23, &STATE_VARIABLE_Specs_41_56);
                }
                break;
              case (MR_Integer) 1:
                STATE_VARIABLE_Specs_41_56 = STATE_VARIABLE_Specs_0_23;
      ...
      else
      {
        ...
        hlds__make_hlds_error__report_multiple_def_error_8_p_0(Name_13, Arity_40, (MR_String) "mode", Context_17, OrigContext_80, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), STATE_VARIABLE_Specs_0_23, &STATE_VARIABLE_Specs_41_56);
      }
          ...
          case (MR_Integer) 1:
            {
              ...
              hlds__make_hlds_error__report_multiple_def_error_8_p_0(InstSymName_2, InstArity_35, (MR_String) "inst", Context_6, OrigContext_65, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), STATE_VARIABLE_Specs_132_132, STATE_VARIABLE_Specs_11);
            }
            break;
        }
