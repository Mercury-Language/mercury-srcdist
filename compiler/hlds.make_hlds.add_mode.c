...
{
  {
...

    {
      ...
      MR_hl_field(MR_mktag(0), hlds__make_hlds__add_mode__Var_28, 0) = ((MR_Box) (hlds__make_hlds__add_mode__SymName_51));
      MR_hl_field(MR_mktag(0), hlds__make_hlds__add_mode__Var_28, 1) = ((MR_Box) (hlds__make_hlds__add_mode__Arity_52));
    }
    {
...
{
  {
    ...
    hlds__make_hlds__add_mode__CastX_80 = (MR_Integer) hlds__make_hlds__add_mode__Var_17;
    hlds__make_hlds__add_mode__CastY_81 = (MR_Integer) hlds__make_hlds__add_mode__Var_16;
    hlds__make_hlds__add_mode__succeeded = (hlds__make_hlds__add_mode__CastX_80 == hlds__make_hlds__add_mode__CastY_81);
    if (hlds__make_hlds__add_mode__succeeded)
      hlds__make_hlds__add_mode__succeeded = MR_TRUE;
    else
      {
        MR_Word hlds__make_hlds__add_mode__ArgX1_76 = ((MR_Word) (MR_hl_field(MR_mktag(0), hlds__make_hlds__add_mode__Var_17, (MR_Integer) 0)));
        MR_Word hlds__make_hlds__add_mode__ArgY1_77 = ((MR_Word) (MR_hl_field(MR_mktag(0), hlds__make_hlds__add_mode__Var_16, (MR_Integer) 0)));
        MR_Integer hlds__make_hlds__add_mode__ArgX2_78 = ((MR_Integer) (MR_hl_field(MR_mktag(0), hlds__make_hlds__add_mode__Var_17, (MR_Integer) 1)));
        MR_Integer hlds__make_hlds__add_mode__ArgY2_79 = ((MR_Integer) (MR_hl_field(MR_mktag(0), hlds__make_hlds__add_mode__Var_16, (MR_Integer) 1)));

        {
          hlds__make_hlds__add_mode__succeeded = mdbcomp__sym_name____Unify____sym_name_0_0(hlds__make_hlds__add_mode__ArgX1_76, hlds__make_hlds__add_mode__ArgY1_77);
        }
        if (hlds__make_hlds__add_mode__succeeded)
          hlds__make_hlds__add_mode__succeeded = (hlds__make_hlds__add_mode__ArgX2_78 == hlds__make_hlds__add_mode__ArgY2_79);
      }
    if (hlds__make_hlds__add_mode__succeeded)
      {
        ...
        MR_Word hlds__make_hlds__add_mode__Var_63;
        ...
        {
          hlds__make_hlds__add_mode__conv1_Kinds_38 = parse_tree__error_util__choose_number_3_f_0(hlds__make_hlds__add_mode__TypeCtorInfo_53_73, (MR_Word) &mercury__builtin__builtin__type_ctor_info_string_0, hlds__make_hlds__add_mode__Var_18, ((MR_Box) ((MR_String) "mode")), ((MR_Box) ((MR_String) "modes")));
        }
        ...
        {
          hlds__make_hlds__add_mode__ExpansionPieces_39 = mercury__list__map_2_f_0(hlds__make_hlds__add_mode__TypeCtorInfo_53_73, hlds__make_hlds__add_mode__TypeCtorInfo_55_75, (MR_Word) &hlds__make_hlds__add_mode_scalar_common_3[3], hlds__make_hlds__add_mode__Var_18);
        }
        {
        ...
        {
          hlds__make_hlds__add_mode__Var_56 = parse_tree__error_util__component_list_to_pieces_1_f_0(hlds__make_hlds__add_mode__ExpansionPieces_39);
        }
        {
          hlds__make_hlds__add_mode__Var_55 = mercury__list__f_43_43_2_f_0(hlds__make_hlds__add_mode__TypeCtorInfo_55_75, hlds__make_hlds__add_mode__Var_56, (MR_Word) MR_mkword(MR_mktag(1), &hlds__make_hlds__add_mode_scalar_common_1[13]));
        }
        {
          hlds__make_hlds__add_mode__Pieces_42 = mercury__list__f_43_43_2_f_0(hlds__make_hlds__add_mode__TypeCtorInfo_55_75, hlds__make_hlds__add_mode__Var_49, hlds__make_hlds__add_mode__Var_55);
        }
        {
          hlds__make_hlds__add_mode__Var_64 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), hlds__make_hlds__add_mode__Var_64, 0) = ((MR_Box) (hlds__make_hlds__add_mode__Pieces_42));
        }
        {
          hlds__make_hlds__add_mode__Var_63 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), hlds__make_hlds__add_mode__Var_63, 0) = ((MR_Box) (hlds__make_hlds__add_mode__Var_64));
          MR_hl_field(MR_mktag(1), hlds__make_hlds__add_mode__Var_63, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
        }
        {
          ...
          MR_hl_field(MR_mktag(0), hlds__make_hlds__add_mode__Msg_43, 1) = ((MR_Box) (hlds__make_hlds__add_mode__Var_63));
        }
        {
          hlds__make_hlds__add_mode__Var_68 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), hlds__make_hlds__add_mode__Var_68, 0) = ((MR_Box) (hlds__make_hlds__add_mode__Msg_43));
          MR_hl_field(MR_mktag(1), hlds__make_hlds__add_mode__Var_68, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
        }
        {
          ...
          MR_hl_field(MR_mktag(0), hlds__make_hlds__add_mode__Spec_44, 2) = ((MR_Box) (hlds__make_hlds__add_mode__Var_68));
        }
        {
          MR_Word base;
    ...
    if (hlds__make_hlds__add_mode__succeeded)
      {
        ...
        {
          hlds__make_hlds__add_mode__conv1_Kinds_38 = parse_tree__error_util__choose_number_3_f_0(hlds__make_hlds__add_mode__TypeCtorInfo_53_73, (MR_Word) &mercury__builtin__builtin__type_ctor_info_string_0, hlds__make_hlds__add_mode__Var_18, ((MR_Box) ((MR_String) "inst")), ((MR_Box) ((MR_String) "insts")));
        }
        hlds__make_hlds__add_mode__Kinds_38 = ((MR_String) hlds__make_hlds__add_mode__conv1_Kinds_38);
        hlds__make_hlds__add_mode__TypeCtorInfo_55_75 = (MR_Word) &parse_tree__error_util__parse_tree__error_util__type_ctor_info_format_component_0;
        {
          hlds__make_hlds__add_mode__ExpansionPieces_39 = mercury__list__map_2_f_0(hlds__make_hlds__add_mode__TypeCtorInfo_53_73, hlds__make_hlds__add_mode__TypeCtorInfo_55_75, (MR_Word) &hlds__make_hlds__add_mode_scalar_common_3[1], hlds__make_hlds__add_mode__Var_18);
        }
        {
          hlds__make_hlds__add_mode__Var_53 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(2), hlds__make_hlds__add_mode__Var_53, 0) = ((MR_Box) (hlds__make_hlds__add_mode__Kinds_38));
