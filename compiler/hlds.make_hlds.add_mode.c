  ...
  MR_Box * wrapper_arg_2)
{
  ...
  hlds__make_hlds__add_mode__cycle_to_error_spec_4_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) ((MR_hl_field(0, closure, 4)))), ((MR_Word) (wrapper_arg_1)), &conv0_Spec_8);
  ...
  MR_Word * STATE_VARIABLE_InvalidInstModeSpecs_11)
{
  ...
  else
  {
    ...
    mercury__list__map_3_p_0((MR_Word) (&hlds__make_hlds__add_mode__hlds__make_hlds__add_mode__type_ctor_info_cycle_0), (MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_error_spec_0), Var_13, Var_14, &CycleSpecs_9);
    *STATE_VARIABLE_InvalidInstModeSpecs_11 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_error_spec_0), CycleSpecs_9, STATE_VARIABLE_InvalidInstModeSpecs_0_10);
  }
}
