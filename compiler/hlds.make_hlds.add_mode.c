  ...
  else
  {
    ...
    if ((Var_126 == (MR_Word) ((MR_Unsigned) 0U)))
    {
...

      {
        ...
        MR_hl_field(MR_mktag(1), Var_92, 0) = ((MR_Box) (Var_127));
  ...
  MR_Word * STATE_VARIABLE_Specs_53)
{
  ...
  else
  {
    ...
    else
    {
      ...
      hlds__make_hlds_error__report_multiply_defined_8_p_0((MR_String) "inst", InstSymName_13, Var_138, Context_17, OrigContext_136, (MR_Word) ((MR_Unsigned) 0U), STATE_VARIABLE_Specs_105_105, STATE_VARIABLE_Specs_53);
    }
