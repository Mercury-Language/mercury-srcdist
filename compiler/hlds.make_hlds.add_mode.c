...
{
  {
    ...
    if (hlds__make_hlds__add_mode__succeeded)
      *hlds__make_hlds__add_mode__HeadVar__1_1 = (MR_Integer) 0;
      ...
      {
        MR_Word hlds__make_hlds__add_mode__Var_4 = ((MR_Word) (MR_hl_field(MR_mktag(0), hlds__make_hlds__add_mode__HeadVar__2_2, (MR_Integer) 0)));
        MR_Integer hlds__make_hlds__add_mode__Var_5 = ((MR_Integer) (MR_hl_field(MR_mktag(0), hlds__make_hlds__add_mode__HeadVar__2_2, (MR_Integer) 1)));
        MR_Word hlds__make_hlds__add_mode__Var_6 = ((MR_Word) (MR_hl_field(MR_mktag(0), hlds__make_hlds__add_mode__HeadVar__3_3, (MR_Integer) 0)));
        MR_Integer hlds__make_hlds__add_mode__Var_7 = ((MR_Integer) (MR_hl_field(MR_mktag(0), hlds__make_hlds__add_mode__HeadVar__3_3, (MR_Integer) 1)));
        MR_Word hlds__make_hlds__add_mode__Var_8;

        {
          mdbcomp__sym_name____Compare____sym_name_0_0(&hlds__make_hlds__add_mode__Var_8, hlds__make_hlds__add_mode__Var_4, hlds__make_hlds__add_mode__Var_6);
        }
        ...
        if (hlds__make_hlds__add_mode__succeeded)
          *hlds__make_hlds__add_mode__HeadVar__1_1 = hlds__make_hlds__add_mode__Var_8;
          ...
          {
            mercury__private_builtin__builtin_compare_int_3_p_0(hlds__make_hlds__add_mode__HeadVar__1_1, hlds__make_hlds__add_mode__Var_5, hlds__make_hlds__add_mode__Var_7);
          }
      }
  }
}
...
{
  {
    ...
    if (hlds__make_hlds__add_mode__succeeded)
      ...
      {
        MR_Word hlds__make_hlds__add_mode__Var_3 = ((MR_Word) (MR_hl_field(MR_mktag(0), hlds__make_hlds__add_mode__HeadVar__1_1, (MR_Integer) 0)));
        MR_Integer hlds__make_hlds__add_mode__Var_4 = ((MR_Integer) (MR_hl_field(MR_mktag(0), hlds__make_hlds__add_mode__HeadVar__1_1, (MR_Integer) 1)));
        MR_Word hlds__make_hlds__add_mode__Var_5 = ((MR_Word) (MR_hl_field(MR_mktag(0), hlds__make_hlds__add_mode__HeadVar__2_2, (MR_Integer) 0)));
        MR_Integer hlds__make_hlds__add_mode__Var_6 = ((MR_Integer) (MR_hl_field(MR_mktag(0), hlds__make_hlds__add_mode__HeadVar__2_2, (MR_Integer) 1)));

        {
          hlds__make_hlds__add_mode__succeeded = mdbcomp__sym_name____Unify____sym_name_0_0(hlds__make_hlds__add_mode__Var_3, hlds__make_hlds__add_mode__Var_5);
        }
        if (hlds__make_hlds__add_mode__succeeded)
          hlds__make_hlds__add_mode__succeeded = (hlds__make_hlds__add_mode__Var_4 == hlds__make_hlds__add_mode__Var_6);
      }
    return hlds__make_hlds__add_mode__succeeded;
  }
}
...
{
  {
    ...
    if (hlds__make_hlds__add_mode__succeeded)
      ...
      {
        MR_Word hlds__make_hlds__add_mode__Var_76 = ((MR_Word) (MR_hl_field(MR_mktag(0), hlds__make_hlds__add_mode__Var_17, (MR_Integer) 0)));
        MR_Integer hlds__make_hlds__add_mode__Var_77 = ((MR_Integer) (MR_hl_field(MR_mktag(0), hlds__make_hlds__add_mode__Var_17, (MR_Integer) 1)));
        MR_Word hlds__make_hlds__add_mode__Var_78 = ((MR_Word) (MR_hl_field(MR_mktag(0), hlds__make_hlds__add_mode__Var_16, (MR_Integer) 0)));
        MR_Integer hlds__make_hlds__add_mode__Var_79 = ((MR_Integer) (MR_hl_field(MR_mktag(0), hlds__make_hlds__add_mode__Var_16, (MR_Integer) 1)));

        {
          hlds__make_hlds__add_mode__succeeded = mdbcomp__sym_name____Unify____sym_name_0_0(hlds__make_hlds__add_mode__Var_76, hlds__make_hlds__add_mode__Var_78);
        }
        if (hlds__make_hlds__add_mode__succeeded)
          hlds__make_hlds__add_mode__succeeded = (hlds__make_hlds__add_mode__Var_77 == hlds__make_hlds__add_mode__Var_79);
      }
    if (hlds__make_hlds__add_mode__succeeded)
      {
