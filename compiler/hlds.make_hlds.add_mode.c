...
MR_decl_label8(hlds__make_hlds__add_mode__check_for_cyclic_inst_9_0, 41,3,5,2,6,8,11,14)
...
MR_decl_label8(hlds__make_hlds__add_mode__module_add_mode_defn_7_0, 2,4,9,7,11,12,13,14)
MR_decl_label2(hlds__make_hlds__add_mode__module_add_mode_defn_7_0, 15,16)
...
MR_def_label(hlds__make_hlds__add_mode__report_circular_inst_equiv_error_6_0,8)
	...
	MR_sv(4) = (MR_Word) MR_CTOR0_ADDR(hlds__make_hlds__add_mode, circ_id);
	MR_r1 = MR_sv(4);
...
MR_BEGIN_MODULE(hlds__make_hlds__add_mode_module2)
	...
	MR_init_label8(hlds__make_hlds__add_mode__check_for_cyclic_inst_9_0,41,3,5,2,6,8,11,14)
...
MR_BEGIN_MODULE(hlds__make_hlds__add_mode_module7)
	...
	MR_init_label8(hlds__make_hlds__add_mode__module_add_mode_defn_7_0,2,4,9,7,11,12,13,14)
	MR_init_label2(hlds__make_hlds__add_mode__module_add_mode_defn_7_0,15,16)
MR_BEGIN_CODE
