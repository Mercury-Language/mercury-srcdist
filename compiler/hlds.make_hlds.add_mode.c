...
#line 81 "add_mode.m"
          MR_hl_field(MR_mktag(0), hlds__make_hlds__add_mode__I_64, 0) = ((MR_Box) (hlds__make_hlds__add_mode__VarSet_18));
#line 81 "add_mode.m"
          MR_hl_field(MR_mktag(0), hlds__make_hlds__add_mode__I_64, 1) = ((MR_Box) (hlds__make_hlds__add_mode__Params_16));
#line 81 "add_mode.m"
...
#line 93 "add_mode.m"
            {
#line 93 "add_mode.m"
              hlds__make_hlds__make_hlds_error__multiple_def_error_9_p_0(hlds__make_hlds__add_mode__Status_13, hlds__make_hlds__add_mode__Name_15, hlds__make_hlds__add_mode__Arity_62, (MR_String) "inst", hlds__make_hlds__add_mode__Context_19, hlds__make_hlds__add_mode__OrigContext_70, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), hlds__make_hlds__add_mode__STATE_VARIABLE_Specs_0_30, &hlds__make_hlds__add_mode__STATE_VARIABLE_Specs_32_32);
            }
#line 90 "add_mode.m"
