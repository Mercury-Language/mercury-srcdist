...
{
  {
    ...
    if ((hlds__make_hlds__add_mode__HeadVar__5_5 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
    ...
    else
      {
        ...
        MR_Word hlds__make_hlds__add_mode__Var_102;
              ...
              if (hlds__make_hlds__add_mode__succeeded)
                {
                  ...
                  {
                    hlds__make_hlds__add_mode__Var_69 = hlds__status__inst_status_defined_in_this_module_1_f_0(hlds__make_hlds__add_mode__InstStatus_7);
                  }
                  hlds__make_hlds__add_mode__succeeded = (hlds__make_hlds__add_mode__Var_69 == (MR_Integer) 1);
                }
              if (hlds__make_hlds__add_mode__succeeded)
                {
                  ...
                  MR_String hlds__make_hlds__add_mode__Var_70;
                  MR_Word hlds__make_hlds__add_mode__Var_73;
                  MR_Word hlds__make_hlds__add_mode__Var_74;
                  MR_Word hlds__make_hlds__add_mode__Var_75;
                  MR_Word hlds__make_hlds__add_mode__Var_94;
                  MR_Word hlds__make_hlds__add_mode__Var_95;
                  MR_Word hlds__make_hlds__add_mode__Var_99;

                  {
                    hlds__make_hlds__add_mode__Var_70 = mdbcomp__sym_name__unqualify_name_1_f_0(hlds__make_hlds__add_mode__InstSymName_2);
                  }
                  {
                    hlds__make_hlds__add_mode__ShortInstSymName_55 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL);
                    MR_hl_field(MR_mktag(0), hlds__make_hlds__add_mode__ShortInstSymName_55, 0) = ((MR_Box) (hlds__make_hlds__add_mode__Var_70));
                  }
                  {
                    hlds__make_hlds__add_mode__Var_75 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
                    MR_hl_field(MR_mktag(0), hlds__make_hlds__add_mode__Var_75, 0) = ((MR_Box) (hlds__make_hlds__add_mode__ShortInstSymName_55));
                    MR_hl_field(MR_mktag(0), hlds__make_hlds__add_mode__Var_75, 1) = ((MR_Box) (hlds__make_hlds__add_mode__InstArity_36));
                  }
                  {
                    hlds__make_hlds__add_mode__Var_74 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(MR_mktag(3), hlds__make_hlds__add_mode__Var_74, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 9));
                    MR_hl_field(MR_mktag(3), hlds__make_hlds__add_mode__Var_74, 1) = ((MR_Box) (hlds__make_hlds__add_mode__Var_75));
                  }
                  {
                    hlds__make_hlds__add_mode__Var_73 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(MR_mktag(1), hlds__make_hlds__add_mode__Var_73, 0) = ((MR_Box) (hlds__make_hlds__add_mode__Var_74));
                    MR_hl_field(MR_mktag(1), hlds__make_hlds__add_mode__Var_73, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &hlds__make_hlds__add_mode_scalar_common_1[11])));
                  }
                  {
                    ...
                    MR_hl_field(MR_mktag(1), hlds__make_hlds__add_mode__Pieces_56, 1) = ((MR_Box) (hlds__make_hlds__add_mode__Var_73));
                  }
                  {
                    hlds__make_hlds__add_mode__Var_95 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL);
                    MR_hl_field(MR_mktag(0), hlds__make_hlds__add_mode__Var_95, 0) = ((MR_Box) (hlds__make_hlds__add_mode__Pieces_56));
                  }
                  {
                    hlds__make_hlds__add_mode__Var_94 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(MR_mktag(1), hlds__make_hlds__add_mode__Var_94, 0) = ((MR_Box) (hlds__make_hlds__add_mode__Var_95));
                    MR_hl_field(MR_mktag(1), hlds__make_hlds__add_mode__Var_94, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
                  }
                  {
                    ...
                    MR_hl_field(MR_mktag(0), hlds__make_hlds__add_mode__Msg_57, 1) = ((MR_Box) (hlds__make_hlds__add_mode__Var_94));
                  }
                  {
                    hlds__make_hlds__add_mode__Var_99 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(MR_mktag(1), hlds__make_hlds__add_mode__Var_99, 0) = ((MR_Box) (hlds__make_hlds__add_mode__Msg_57));
                    MR_hl_field(MR_mktag(1), hlds__make_hlds__add_mode__Var_99, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
                  }
                  {
                    ...
                    MR_hl_field(MR_mktag(0), hlds__make_hlds__add_mode__Spec_58, 2) = ((MR_Box) (hlds__make_hlds__add_mode__Var_99));
                  }
                  {
        ...
        {
          hlds__make_hlds__add_mode__Var_102 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), hlds__make_hlds__add_mode__Var_102, 0) = ((MR_Box) (hlds__make_hlds__add_mode__EqvInst_31));
        }
        {
          ...
          MR_hl_field(MR_mktag(0), hlds__make_hlds__add_mode__InstDefn_59, 2) = ((MR_Box) (hlds__make_hlds__add_mode__Var_102));
              ...
              case (MR_Integer) 1:
                {
                  ...
                  MR_Word hlds__make_hlds__add_mode__Var_111;
                  MR_Word hlds__make_hlds__add_mode__Var_112;
                  ...
                  hlds__make_hlds__add_mode__Var_108 = ((MR_Word) (MR_hl_field(MR_mktag(0), hlds__make_hlds__add_mode__OrigInstDefn_62, (MR_Integer) 0)));
                  hlds__make_hlds__add_mode__Var_109 = ((MR_Word) (MR_hl_field(MR_mktag(0), hlds__make_hlds__add_mode__OrigInstDefn_62, (MR_Integer) 1)));
                  hlds__make_hlds__add_mode__Var_110 = ((MR_Word) (MR_hl_field(MR_mktag(0), hlds__make_hlds__add_mode__OrigInstDefn_62, (MR_Integer) 2)));
                  hlds__make_hlds__add_mode__Var_111 = ((MR_Word) (MR_hl_field(MR_mktag(0), hlds__make_hlds__add_mode__OrigInstDefn_62, (MR_Integer) 3)));
                  ...
                  hlds__make_hlds__add_mode__Var_112 = ((MR_Word) (MR_hl_field(MR_mktag(0), hlds__make_hlds__add_mode__OrigInstDefn_62, (MR_Integer) 5)));
                  {
    ...
    else
      {
        ...
        if (((MR_tag((MR_Word) hlds__make_hlds__add_mode__InstModeStatus_43)) == (MR_mktag((MR_Integer) 1))))
        ...
        else
          {
            ...
            hlds__make_hlds__add_mode__Var_71 = ((MR_Word) (MR_hl_field(MR_mktag(0), hlds__make_hlds__add_mode__OrigModeDefn_77, (MR_Integer) 0)));
            hlds__make_hlds__add_mode__Var_72 = ((MR_Word) (MR_hl_field(MR_mktag(0), hlds__make_hlds__add_mode__OrigModeDefn_77, (MR_Integer) 1)));
            hlds__make_hlds__add_mode__Var_73 = ((MR_Word) (MR_hl_field(MR_mktag(0), hlds__make_hlds__add_mode__OrigModeDefn_77, (MR_Integer) 2)));
            ...
            hlds__make_hlds__add_mode__Var_74 = ((MR_Word) (MR_hl_field(MR_mktag(0), hlds__make_hlds__add_mode__OrigModeDefn_77, (MR_Integer) 4)));
            {
