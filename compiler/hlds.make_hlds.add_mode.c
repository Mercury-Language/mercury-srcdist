...
hlds__make_hlds__add_mode__IntroducedFrom__func__report_circular_equiv_error__360__1_1_f_0(
...
{
  {
    ...
    else
    {
      ...
      {
        ModeId_47 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), ModeId_47, 0) = ((MR_Box) (Name_14));
        MR_hl_field(MR_mktag(0), ModeId_47, 1) = ((MR_Box) (Arity_46));
      }
      ...
      succeeded = hlds__hlds_inst_mode__mode_table_insert_4_p_0(ModeId_47, ModeDefn_50, ModeTable0_21, &STATE_VARIABLE_ModeTable_41_62);
      if (succeeded)
      {
      ...
      else
      {
        ...
        {
          MR_Word InstModeImport_74 = ((MR_Word) ((MR_hl_field(MR_mktag(1), InstModeStatus_51, (MR_Integer) 0))));

          switch (MR_tag((MR_Word) InstModeImport_74)) {
            default: /*NOTREACHED*/ MR_assert(0);
            case (MR_Integer) 0:
              switch (MR_unmkbody(InstModeImport_74)) {
                default: /*NOTREACHED*/ MR_assert(0);
                case (MR_Integer) 0:
                  {
                    ...
                    mercury__map__lookup_3_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mode_id_0), (MR_Word) (&hlds__hlds_inst_mode__hlds__hlds_inst_mode__type_ctor_info_hlds_mode_defn_0), ModeDefns_53, ((MR_Box) (ModeId_47)), &conv0_OrigModeDefn_54);
        ...
        {
          MR_Word ModeDefns_82;
          MR_Word OrigModeDefn_83;
          MR_Word OrigContext_87;
          MR_Box conv1_OrigModeDefn_83;

          hlds__hlds_inst_mode__mode_table_get_mode_defns_2_p_0(ModeTable0_21, &ModeDefns_82);
          mercury__map__lookup_3_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mode_id_0), (MR_Word) (&hlds__hlds_inst_mode__hlds__hlds_inst_mode__type_ctor_info_hlds_mode_defn_0), ModeDefns_82, ((MR_Box) (ModeId_47)), &conv1_OrigModeDefn_83);
          OrigModeDefn_83 = ((MR_Word) (conv1_OrigModeDefn_83));
          OrigContext_87 = ((MR_Word) ((MR_hl_field(MR_mktag(0), OrigModeDefn_83, (MR_Integer) 3))));
          hlds__make_hlds_error__report_multiple_def_error_8_p_0(Name_14, Arity_46, (MR_String) "mode", Context_18, OrigContext_87, (MR_Word) ((MR_Unsigned) 0U), STATE_VARIABLE_Specs_0_28, &STATE_VARIABLE_Specs_43_64);
        }
        ModeTable_23 = ModeTable0_21;
      }
      hlds__make_hlds__add_mode__check_for_cyclic_mode_8_p_0(ModeTable_23, ModeId_47, ModeId_47, (MR_Word) ((MR_Unsigned) 0U), Context_18, &InvalidMode_22, STATE_VARIABLE_Specs_43_64, STATE_VARIABLE_Specs_29);
...
{
  {
    ...
    conv2_LambdaHeadVar__2_27 = hlds__make_hlds__add_mode__IntroducedFrom__func__report_circular_equiv_error__360__1_1_f_0(((MR_Word) (wrapper_arg_1)));
...
{
  {
    ...
    else
    {
      ...
      {
        InstId_27 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), InstId_27, 0) = ((MR_Box) (InstName_14));
        MR_hl_field(MR_mktag(0), InstId_27, 1) = ((MR_Box) (InstArity_26));
      }
      ...
      hlds__make_hlds__add_mode__check_for_cyclic_inst_9_p_0(UserInstTable_24, InstId_27, InstId_27, TestArgs_28, (MR_Word) ((MR_Unsigned) 0U), Context_19, &InvalidInst_29, STATE_VARIABLE_Specs_36_36, STATE_VARIABLE_Specs_35);
