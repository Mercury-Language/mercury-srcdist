...
MR_bool MR_CALL 
parse_tree__prog_type__du_type_is_enum_3_p_0(
  MR_Word DuDetails_4,
  MR_Integer * NumFunctors_5,
  MR_Integer * NumBits_6)
{
  {
    MR_bool succeeded;
    MR_Word OoMCtors_7 = ((MR_Word) ((MR_hl_field(MR_mktag(0), DuDetails_4, (MR_Integer) 0))));
    MR_Word Ctors_10;
    MR_Integer Var_15;
    MR_Word Ctor_20;
    MR_Word Ctors_21;
    ...
    MR_Word Args_26;
    MR_Integer STATE_VARIABLE_NumFunctors_18_31;
    MR_Integer Var_32;

    Ctors_10 = mercury__list__one_or_more_to_list_1_f_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_constructor_0), OoMCtors_7);
    succeeded = (Ctors_10 != (MR_Word) ((MR_Unsigned) 0U));
    if (succeeded)
    {
      Ctor_20 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Ctors_10, (MR_Integer) 0))));
      Ctors_21 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Ctors_10, (MR_Integer) 1))));
      succeeded = (Ctors_21 != (MR_Word) ((MR_Unsigned) 0U));
      if (succeeded)
      {
        Var_15 = (MR_Integer) 0;
        MaybeExistConstraints_24 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Ctor_20, (MR_Integer) 1))));
        Args_26 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Ctor_20, (MR_Integer) 3))));
        succeeded = (Args_26 == (MR_Word) ((MR_Unsigned) 0U));
        if (succeeded)
        {
          ...
          {
            Var_32 = (MR_Integer) 1;
            STATE_VARIABLE_NumFunctors_18_31 = (MR_Integer) ((MR_Unsigned) Var_15 + (MR_Unsigned) Var_32);
            succeeded = parse_tree__prog_type__all_functors_are_enum_3_p_0(Ctors_21, STATE_VARIABLE_NumFunctors_18_31, NumFunctors_5);
            if (succeeded)
            {
              mercury__int__log2_2_p_0(*NumFunctors_5, NumBits_6);
              succeeded = MR_TRUE;
            }
          }
        }
