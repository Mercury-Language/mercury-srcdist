  ...
  MR_Word * HeadVar__3_3)
{
  while (MR_TRUE)
  {
    ...
    switch (MR_tag((MR_Word) HeadVar__1_1)) {
      ...
      case (MR_Integer) 1:
        {
          MR_Word ArgTypes_8 = ((MR_Word) ((MR_hl_field(MR_mktag(1), HeadVar__1_1, (MR_Integer) 1))));

          parse_tree__prog_type__type_vars_list_2_3_p_0(ArgTypes_8, HeadVar__2_2, HeadVar__3_3);
        }
        break;
      case (MR_Integer) 2:
      ...
      case (MR_Integer) 3:
        switch (((MR_Integer) ((MR_hl_field(MR_mktag(3), HeadVar__1_1, (MR_Integer) 0))))) {
          ...
          case (MR_Integer) 0:
            {
              MR_Word ArgTypes_27 = ((MR_Word) ((MR_hl_field(MR_mktag(3), HeadVar__1_1, (MR_Integer) 1))));

              parse_tree__prog_type__type_vars_list_2_3_p_0(ArgTypes_27, HeadVar__2_2, HeadVar__3_3);
            }
            break;
          case (MR_Integer) 1:
            {
              MR_Word ArgTypes_19 = ((MR_Word) ((MR_hl_field(MR_mktag(3), HeadVar__1_1, (MR_Integer) 2))));

              parse_tree__prog_type__type_vars_list_2_3_p_0(ArgTypes_19, HeadVar__2_2, HeadVar__3_3);
            }
            break;
          case (MR_Integer) 2:
            {
              MR_Word Var_33 = ((MR_Word) ((MR_hl_field(MR_mktag(3), HeadVar__1_1, (MR_Integer) 1))));
              MR_Word ArgTypes_34 = ((MR_Word) ((MR_hl_field(MR_mktag(3), HeadVar__1_1, (MR_Integer) 2))));
              ...
              parse_tree__prog_type__type_vars_list_2_3_p_0(ArgTypes_34, STATE_VARIABLE_V_39_39, HeadVar__3_3);
            }
            break;
          case (MR_Integer) 3:
            {
