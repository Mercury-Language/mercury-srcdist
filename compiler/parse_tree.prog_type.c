      ...
      case (MR_Integer) 1:
        {
          ...
          succeeded = parse_tree__prog_type__type_unify_rev_args_8_p_0(RevArgTypesX_77, RevArgTypesY0_78, &RevArgTypesY_79, KindY0_14, &KindY_16, HeadTypeParams_10, STATE_VARIABLE_Bindings_0_34, &STATE_VARIABLE_Bindings_50_50);
          if (succeeded)
          {
          ...
          case (MR_Integer) 0:
            {
              ...
              succeeded = parse_tree__prog_type__type_unify_rev_args_8_p_0(RevArgTypesX_81, RevArgTypesY0_82, &RevArgTypesY_83, KindY0_54, &KindY_56, HeadTypeParams_10, STATE_VARIABLE_Bindings_0_34, &STATE_VARIABLE_Bindings_45_45);
              if (succeeded)
              {
          ...
          case (MR_Integer) 2:
            {
              ...
              if (succeeded)
              {
                ...
                succeeded = parse_tree__prog_type__type_unify_rev_args_8_p_0(RevArgTypesX_65, RevArgTypesY0_66, &RevArgTypesY_67, Kind0_24, &Kind_28, HeadTypeParams_10, STATE_VARIABLE_Bindings_0_34, &STATE_VARIABLE_Bindings_42_42);
                if (succeeded)
                {
              ...
              else
              {
                ...
                if (succeeded)
                {
                  ...
                  succeeded = parse_tree__prog_type__type_unify_rev_args_8_p_0(RevArgTypesX_73, RevArgTypesY0_74, &RevArgTypesY_75, Kind0_24, &Kind_59, HeadTypeParams_10, STATE_VARIABLE_Bindings_0_34, &STATE_VARIABLE_Bindings_37_37);
                  if (succeeded)
                  {
                ...
                else
                {
                  ...
                  succeeded = parse_tree__prog_type__type_unify_rev_args_8_p_0(RevArgTypesX_69, RevArgTypesY0_70, &RevArgTypesY_71, Kind0_24, &Kind_58, HeadTypeParams_10, STATE_VARIABLE_Bindings_0_34, &STATE_VARIABLE_Bindings_40_40);
                  if (succeeded)
                  {
  ...
  MR_Word TypeCtor_3)
{
  ...
  if (succeeded)
  {
    ...
    Var_13 = mdbcomp__builtin_modules__mercury_io_module_0_f_0();
    succeeded = mdbcomp__sym_name____Unify____sym_name_0_0(ModuleName_7, Var_13);
    if (succeeded)
    {
  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      Var_15 = mdbcomp__builtin_modules__mercury_std_lib_module_name_1_f_0(Var_9);
      succeeded = mdbcomp__sym_name____Unify____sym_name_0_0(ModuleName_11, Var_15);
      if (succeeded)
      {
