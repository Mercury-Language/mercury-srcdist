      ...
      case (MR_Integer) 1:
        {
          ...
          succeeded = parse_tree__prog_type__type_unify_args_8_p_0(ArgTypesX0_9, ArgTypesY0_13, &ArgTypesY_15, KindY0_14, &KindY_16, HeadTypeParams_10, STATE_VARIABLE_Bindings_0_34, &STATE_VARIABLE_Bindings_50_50);
          if (succeeded)
          {
            {
          ...
          case (MR_Integer) 0:
            {
              ...
              succeeded = parse_tree__prog_type__type_unify_args_8_p_0(ArgTypesX0_9, ArgTypesY0_53, &ArgTypesY_55, KindY0_54, &KindY_56, HeadTypeParams_10, STATE_VARIABLE_Bindings_0_34, &STATE_VARIABLE_Bindings_45_45);
              if (succeeded)
              {
                {
          ...
          case (MR_Integer) 2:
            {
              ...
              if (succeeded)
              {
                ...
                MR_Word RevArgTypesX_75;
                MR_Word RevArgTypesY0_76;
                MR_Word RevArgTypesY_77;
                MR_Word next_value_of_tscc_proc_2_input_1_VarX_6;
                MR_Word next_value_of_tscc_proc_2_input_2_TypeY_7;
                MR_Word next_value_of_tscc_proc_2_input_3_HeadTypeParams_8;
                MR_Word next_value_of_tscc_proc_2_input_4_STATE_VARIABLE_Bindings_0_13;

                mercury__list__reverse_2_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0), ArgTypesX0_9, &RevArgTypesX_75);
                mercury__list__reverse_2_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0), ArgTypesY0_61, &RevArgTypesY0_76);
                succeeded = parse_tree__prog_type__type_unify_rev_args_8_p_0(RevArgTypesX_75, RevArgTypesY0_76, &RevArgTypesY_77, Kind0_24, &Kind_28, HeadTypeParams_10, STATE_VARIABLE_Bindings_0_34, &STATE_VARIABLE_Bindings_42_42);
                if (succeeded)
                {
                  mercury__list__reverse_2_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0), RevArgTypesY_77, &ArgTypesY_57);
                  {
              ...
              else
              {
                ...
                if (succeeded)
                {
                  ...
                  succeeded = parse_tree__prog_type__type_unify_args_8_p_0(ArgTypesY0_61, ArgTypesX0_9, &ArgTypesX_30, Kind0_24, &Kind_59, HeadTypeParams_10, STATE_VARIABLE_Bindings_0_34, &STATE_VARIABLE_Bindings_37_37);
                  if (succeeded)
                  {
                    {
                ...
                else
                {
                  ...
                  succeeded = parse_tree__prog_type__type_unify_args_8_p_0(ArgTypesX0_9, ArgTypesY0_61, &Var_29, Kind0_24, &Kind_58, HeadTypeParams_10, STATE_VARIABLE_Bindings_0_34, &STATE_VARIABLE_Bindings_40_40);
                  if (succeeded)
                  {
                    // direct tailcall eliminated
                    ;
