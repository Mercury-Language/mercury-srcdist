...
{
  {
    ...
    succeeded = libs__globals__lookup_bool_option_3_p_1(Globals_8, (MR_Integer) 265, (MR_Integer) 1);
    if (succeeded)
    {
                ...
                case (MR_Integer) 1:
                  {
                    ...
                    Arity_36 = (MR_Integer) ((MR_Unsigned) Var_29 - (MR_Unsigned) (MR_Integer) 1);
                  }
                  break;
                case (MR_Integer) 0:
                  {
