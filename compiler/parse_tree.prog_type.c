...
MR_decl_label1(parse_tree__prog_type__IntroducedFrom__pred__split_vars_typeinfo_no_typeinfo__860__1_2_0, 2)
...
MR_decl_label7(parse_tree__prog_type__is_builtin_dummy_argument_type_1_0, 5,6,4,10,11,3,1)
...
MR_decl_label2(parse_tree__prog_type__is_region_var_2_0, 2,3)
...
MR_decl_label7(parse_tree__prog_type__type_with_constructors_should_be_no_tag_8_0, 2,8,5,6,13,11,1)
...
MR_decl_label8(__Compare___parse_tree__prog_type__ctor_defn_0_0, 3,2,5,9,13,17,21,53)
...
MR_def_extern_entry(parse_tree__prog_type__is_builtin_dummy_argument_type_1_0)
...
MR_decl_static(parse_tree__prog_type__IntroducedFrom__pred__split_vars_typeinfo_no_typeinfo__860__1_2_0)
...
static const MR_EnumFunctorDesc mercury_data_parse_tree__prog_type__enum_functor_desc_type_category_0_15 = {
	"type_cat_user_ctor",
	15
};
...
const MR_EnumFunctorDescPtr mercury_data_parse_tree__prog_type__enum_value_ordered_type_category_0[] = {
	...
	&mercury_data_parse_tree__prog_type__enum_functor_desc_type_category_0_15
};
...
MR_BEGIN_MODULE(parse_tree__prog_type_module35)
	MR_init_entry1(parse_tree__prog_type__is_builtin_dummy_argument_type_1_0);
	MR_init_label7(parse_tree__prog_type__is_builtin_dummy_argument_type_1_0,5,6,4,10,11,3,1)
MR_BEGIN_CODE
	...
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_define_entry(mercury__parse_tree__prog_type__is_builtin_dummy_argument_type_1_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(4);
	MR_sv(4) = (MR_Word) MR_succip;
	{
	...
	MR_tempr1 = MR_ctfield(0, MR_r1, 0);
	if (MR_PTAG_TESTR(MR_tempr1,1)) {
		MR_GOTO_LAB(parse_tree__prog_type__is_builtin_dummy_argument_type_1_0_i1);
	}
	MR_sv(3) = MR_ctfield(1, MR_tempr1, 1);
	MR_sv(2) = MR_ctfield(1, MR_tempr1, 0);
	MR_sv(1) = MR_ctfield(0, MR_r1, 1);
	...
	MR_np_call_localret_ent(fn__mdbcomp__prim_data__mercury_std_lib_module_name_1_0,
		parse_tree__prog_type__is_builtin_dummy_argument_type_1_0_i5);
MR_def_label(parse_tree__prog_type__is_builtin_dummy_argument_type_1_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_r1;
	MR_r1 = MR_sv(2);
	MR_np_call_localret_ent(__Unify___mdbcomp__prim_data__sym_name_0_0,
		parse_tree__prog_type__is_builtin_dummy_argument_type_1_0_i6);
MR_def_label(parse_tree__prog_type__is_builtin_dummy_argument_type_1_0,6)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(parse_tree__prog_type__is_builtin_dummy_argument_type_1_0_i4);
	}
	if ((strcmp((char *)MR_sv(3), (char *)(MR_Word) MR_string_const("state", 5)) != 0)) {
		MR_GOTO_LAB(parse_tree__prog_type__is_builtin_dummy_argument_type_1_0_i4);
	}
	if (MR_INT_EQ(MR_sv(1),0)) {
		MR_GOTO_LAB(parse_tree__prog_type__is_builtin_dummy_argument_type_1_0_i3);
	}
MR_def_label(parse_tree__prog_type__is_builtin_dummy_argument_type_1_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_TAG_COMMON(0,1,5);
	MR_np_call_localret_ent(fn__mdbcomp__prim_data__mercury_std_lib_module_name_1_0,
		parse_tree__prog_type__is_builtin_dummy_argument_type_1_0_i10);
MR_def_label(parse_tree__prog_type__is_builtin_dummy_argument_type_1_0,10)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_r1;
	MR_r1 = MR_sv(2);
	MR_np_call_localret_ent(__Unify___mdbcomp__prim_data__sym_name_0_0,
		parse_tree__prog_type__is_builtin_dummy_argument_type_1_0_i11);
MR_def_label(parse_tree__prog_type__is_builtin_dummy_argument_type_1_0,11)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(parse_tree__prog_type__is_builtin_dummy_argument_type_1_0_i1);
	}
	if ((strcmp((char *)MR_sv(3), (char *)(MR_Word) MR_string_const("store", 5)) != 0)) {
		MR_GOTO_LAB(parse_tree__prog_type__is_builtin_dummy_argument_type_1_0_i1);
	}
	MR_r1 = ((MR_Integer) MR_sv(1) == (MR_Integer) 1);
	MR_decr_sp_and_return(4);
MR_def_label(parse_tree__prog_type__is_builtin_dummy_argument_type_1_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_succip_word = MR_sv(4);
	MR_decr_sp(4);
	MR_r1 = MR_TRUE;
	MR_proceed();
MR_def_label(parse_tree__prog_type__is_builtin_dummy_argument_type_1_0,1)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_succip_word = MR_sv(4);
	MR_decr_sp(4);
	MR_r1 = MR_FALSE;
...
MR_define_entry(mercury__fn__parse_tree__prog_type__put_typeinfo_vars_first_2_0);
	...
	MR_tfield(0, MR_tempr1, 1) = (MR_Word) MR_ENTRY_AP(parse_tree__prog_type__IntroducedFrom__pred__split_vars_typeinfo_no_typeinfo__860__1_2_0);
...
MR_BEGIN_MODULE(parse_tree__prog_type_module60)
	...
	MR_init_label2(parse_tree__prog_type__is_region_var_2_0,2,3)
MR_BEGIN_CODE
...
MR_define_entry(mercury__parse_tree__prog_type__is_region_var_2_0);
	...
	MR_np_call_localret_ent(f_109_97_112_95_95_84_121_112_101_83_112_101_99_79_102_95_95_112_114_101_100_95_111_114_95_102_117_110_99_95_95_108_111_111_107_117_112_95_95_91_75_32_61_32_118_97_114_40_86_95_50_41_93_95_48_95_49_3_0,
		parse_tree__prog_type__is_region_var_2_0_i2);
MR_def_label(parse_tree__prog_type__is_region_var_2_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(1) = MR_r1;
	MR_np_call_localret_ent(fn__mdbcomp__prim_data__mercury_region_builtin_module_0_0,
...
MR_BEGIN_MODULE(parse_tree__prog_type_module69)
	...
	MR_init_label7(parse_tree__prog_type__type_with_constructors_should_be_no_tag_8_0,2,8,5,6,13,11,1)
MR_BEGIN_CODE
...
MR_def_label(parse_tree__prog_type__type_with_constructors_should_be_no_tag_8_0,6)
	...
	MR_np_call_localret_ent(parse_tree__prog_type__is_builtin_dummy_argument_type_1_0,
		parse_tree__prog_type__type_with_constructors_should_be_no_tag_8_0_i13);
MR_def_label(parse_tree__prog_type__type_with_constructors_should_be_no_tag_8_0,13)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(parse_tree__prog_type__type_with_constructors_should_be_no_tag_8_0_i11);
	}
	MR_r2 = MR_sv(1);
	MR_r3 = MR_sv(3);
	MR_r4 = MR_sv(6);
	...
	MR_r1 = MR_TRUE;
	MR_proceed();
MR_def_label(parse_tree__prog_type__type_with_constructors_should_be_no_tag_8_0,11)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_sv(1);
	MR_r3 = MR_sv(3);
	MR_r4 = MR_sv(6);
...
MR_BEGIN_MODULE(parse_tree__prog_type_module87)
	...
	MR_init_label8(__Compare___parse_tree__prog_type__ctor_defn_0_0,3,2,5,9,13,17,21,53)
MR_BEGIN_CODE
...
MR_def_label(__Compare___parse_tree__prog_type__ctor_defn_0_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___parse_tree__prog_type__ctor_defn_0_0_i53);
	}
	MR_r1 = (MR_Word) MR_TAG_COMMON(0,0,0);
	MR_r2 = MR_sv(1);
	MR_r3 = MR_sv(6);
...
MR_def_label(__Compare___parse_tree__prog_type__ctor_defn_0_0,53)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(11);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
...
MR_BEGIN_MODULE(parse_tree__prog_type_module92)
	MR_init_entry1(parse_tree__prog_type__IntroducedFrom__pred__split_vars_typeinfo_no_typeinfo__860__1_2_0);
	MR_init_label1(parse_tree__prog_type__IntroducedFrom__pred__split_vars_typeinfo_no_typeinfo__860__1_2_0,2)
MR_BEGIN_CODE
	...
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(parse_tree__prog_type__IntroducedFrom__pred__split_vars_typeinfo_no_typeinfo__860__1_2_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(1);
	MR_sv(1) = (MR_Word) MR_succip;
	MR_r4 = MR_r1;
	...
	MR_np_call_localret_ent(fn__f_109_97_112_95_95_84_121_112_101_83_112_101_99_79_102_95_95_112_114_101_100_95_111_114_95_102_117_110_99_95_95_108_111_111_107_117_112_95_95_91_75_32_61_32_118_97_114_40_86_95_50_41_93_95_48_95_49_2_0,
		parse_tree__prog_type__IntroducedFrom__pred__split_vars_typeinfo_no_typeinfo__860__1_2_0_i2);
MR_def_label(parse_tree__prog_type__IntroducedFrom__pred__split_vars_typeinfo_no_typeinfo__860__1_2_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_succip_word = MR_sv(1);
	MR_decr_sp(1);
