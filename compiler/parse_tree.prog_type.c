...
{
  {
    ...
    if (parse_tree__prog_type__succeeded)
      {
        parse_tree__prog_type__V_20_20 = (MR_Integer) 252;
                    ...
                    case (MR_Integer) 1:
                      {
                        ...
                        {
                          parse_tree__prog_type__succeeded = parse_tree__prog_type__type_unify_args_8_p_0(parse_tree__prog_type__ArgsX0_9, parse_tree__prog_type__ArgsY0_61, &parse_tree__prog_type__ArgsY_57, parse_tree__prog_type__Kind0_24, &parse_tree__prog_type__Kind_28, parse_tree__prog_type__HeadTypeParams_10, parse_tree__prog_type__STATE_VARIABLE_Bindings_0_34, &parse_tree__prog_type__STATE_VARIABLE_Bindings_42_42);
                        }
                        if (parse_tree__prog_type__succeeded)
                          {
                            {
