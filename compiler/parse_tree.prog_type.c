  ...
  MR_Word * InstConsId_8)
{
  ...
  switch (MR_tag((MR_Word) ConsId0_6)) {
    ...
    case (MR_Integer) 0:
      {
        MR_Integer Var_43;
        MR_Word PrivateBuiltin_53;
        MR_Word TypeCtor_54;
        MR_Word Var_55;

        *ConsId_7 = ConsId0_6;
        Var_43 = mercury__list__length_1_f_0((MR_Word) (&parse_tree__prog_type_scalar_common_1[0]), Args_5);
        PrivateBuiltin_53 = mdbcomp__builtin_modules__mercury_private_builtin_module_0_f_0();
        TypeCtor_54 = parse_tree__prog_data__cons_id_dummy_type_ctor_0_f_0();
        {
          Var_55 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(1, Var_55, 0) = ((MR_Box) (PrivateBuiltin_53));
          MR_hl_field(1, Var_55, 1) = ((MR_Box) ((MR_String) "typeclass_info"));
        }
        {
          MR_Word base;
          ...
          *InstConsId_8 = base;
          ...
          MR_hl_field(3, base, 1) = ((MR_Box) (Var_55));
          MR_hl_field(3, base, 2) = ((MR_Box) (Var_43));
          MR_hl_field(3, base, 3) = ((MR_Box) (TypeCtor_54));
        }
      }
      break;
    case (MR_Integer) 1:
    ...
    case (MR_Integer) 2:
      {
        ...
        *ConsId_7 = ConsId0_6;
        Var_41 = mercury__list__length_1_f_0((MR_Word) (&parse_tree__prog_type_scalar_common_1[0]), Args_5);
        PrivateBuiltin_48 = mdbcomp__builtin_modules__mercury_private_builtin_module_0_f_0();
        TypeCtor_49 = parse_tree__prog_data__cons_id_dummy_type_ctor_0_f_0();
        {
          Var_50 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(1, Var_50, 0) = ((MR_Box) (PrivateBuiltin_48));
          MR_hl_field(1, Var_50, 1) = ((MR_Box) ((MR_String) "type_info"));
        }
        {
          MR_Word base;
          base = (MR_Word) MR_mkword(3, MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL));
          *InstConsId_8 = base;
          ...
          MR_hl_field(3, base, 2) = ((MR_Box) (Var_41));
          MR_hl_field(3, base, 3) = ((MR_Box) (TypeCtor_49));
        }
      }
      break;
    case (MR_Integer) 3:
        ...
        case (MR_Integer) 3:
          {
            ...
            MR_Word Var_39 = ((MR_Word) ((MR_hl_field(0, TypeCtor_11, (MR_Integer) 0))));

            succeeded = ((MR_tag((MR_Word) Var_39)) == (MR_Integer) 1);
            if (succeeded)
            {
              TypeModule_12 = ((MR_Word) ((MR_hl_field(1, Var_39, (MR_Integer) 0))));
              {
  ...
  MR_Integer Arity_5)
{
  ...
  }
  {
    ...
    MR_hl_field(3, InstConsId_6, 0) = ((MR_Box) ((MR_Unsigned) 3U));
  ...
  MR_Word HeadVar__1_1)
{
  ...
  else
  {
    ...
    HeadVar__2_2 = (MR_Word) (MR_mkword(2, (MR_Word) (Ctor_3)));
  }
  return HeadVar__2_2;
}
