...
MR_decl_label1(parse_tree__prog_type__IntroducedFrom__pred__split_vars_typeinfo_no_typeinfo__843__1_2_0, 3)
...
MR_decl_label10(parse_tree__prog_type__qualify_cons_id_4_0, 5,6,7,3,12,13,14,10,20,23)
MR_decl_label3(parse_tree__prog_type__qualify_cons_id_4_0, 18,25,17)
...
MR_decl_label10(parse_tree__prog_type__type_occurs_3_0, 130,3,8,11,6,19,23,26,16,34)
MR_decl_label4(parse_tree__prog_type__type_occurs_3_0, 30,39,63,1)
...
MR_decl_label8(parse_tree__prog_type__type_unify_head_type_param_6_0, 47,4,2,10,9,14,18,1)
...
MR_decl_label8(__Compare___parse_tree__prog_type__ctor_defn_0_0, 3,2,5,10,15,19,23,73)
...
MR_decl_static(parse_tree__prog_type__IntroducedFrom__pred__split_vars_typeinfo_no_typeinfo__843__1_2_0)
...
MR_def_label(parse_tree__prog_type__type_to_ctor_and_args_det_3_0,2)
	...
	MR_r3 = (MR_Word) MR_string_const("type_to_ctor_and_args failed", 28);
	MR_succip_word = MR_sv(1);
	MR_decr_sp(1);
...
MR_define_entry(mercury__fn__parse_tree__prog_type__put_typeinfo_vars_first_2_0);
	...
	MR_tfield(0, MR_tempr1, 1) = (MR_Word) MR_ENTRY_AP(parse_tree__prog_type__IntroducedFrom__pred__split_vars_typeinfo_no_typeinfo__843__1_2_0);
...
MR_def_label(fn__parse_tree__prog_type__remove_typeinfo_vars_from_set_2_0,3)
	...
	MR_tfield(0, MR_r2, 1) = (MR_Word) MR_ENTRY_AP(parse_tree__prog_type__IntroducedFrom__pred__split_vars_typeinfo_no_typeinfo__843__1_2_0);
...
MR_BEGIN_MODULE(parse_tree__prog_type_module51)
	...
	MR_init_label10(parse_tree__prog_type__qualify_cons_id_4_0,5,6,7,3,12,13,14,10,20,23)
	MR_init_label3(parse_tree__prog_type__qualify_cons_id_4_0,18,25,17)
MR_BEGIN_CODE
...
MR_def_label(parse_tree__prog_type__qualify_cons_id_4_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_r2,1)) {
		MR_GOTO_LAB(parse_tree__prog_type__qualify_cons_id_4_0_i10);
	}
	MR_incr_sp(4);
	MR_sv(4) = (MR_Word) MR_succip;
	MR_sv(1) = MR_r2;
...
MR_def_label(parse_tree__prog_type__qualify_cons_id_4_0,12)
	...
	MR_sv(2) = MR_r1;
	MR_np_call_localret_ent(fn__mdbcomp__prim_data__mercury_private_builtin_module_0_0,
		parse_tree__prog_type__qualify_cons_id_4_0_i13);
MR_def_label(parse_tree__prog_type__qualify_cons_id_4_0,13)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(3) = MR_r1;
	MR_np_call_localret_ent(fn__parse_tree__prog_data__cons_id_dummy_type_ctor_0_0,
		parse_tree__prog_type__qualify_cons_id_4_0_i14);
MR_def_label(parse_tree__prog_type__qualify_cons_id_4_0,14)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_tag_alloc_heap(MR_r2, 1, (MR_Integer) 2);
	MR_tfield(1, MR_r2, 0) = MR_sv(3);
...
MR_def_label(parse_tree__prog_type__qualify_cons_id_4_0,10)
	...
	if (MR_RTAGS_TESTR(MR_r2,3,2)) {
		MR_GOTO_LAB(parse_tree__prog_type__qualify_cons_id_4_0_i17);
	}
	MR_incr_sp(4);
	MR_sv(4) = (MR_Word) MR_succip;
	...
	if (MR_PTAG_TESTR(MR_tempr1,1)) {
		MR_GOTO_LAB(parse_tree__prog_type__qualify_cons_id_4_0_i18);
	}
	...
	MR_np_call_localret_ent(fn__mdbcomp__prim_data__unqualify_name_1_0,
		parse_tree__prog_type__qualify_cons_id_4_0_i20);
MR_def_label(parse_tree__prog_type__qualify_cons_id_4_0,20)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_tag_alloc_heap(MR_r2, 1, (MR_Integer) 2);
...
MR_BEGIN_MODULE(parse_tree__prog_type_module54)
	...
	MR_init_label8(parse_tree__prog_type__type_unify_head_type_param_6_0,47,4,2,10,9,14,18,1)
MR_BEGIN_CODE
...
MR_def_static(parse_tree__prog_type__type_unify_head_type_param_6_0)
	...
	MR_incr_sp(6);
	MR_sv(6) = (MR_Word) MR_succip;
MR_def_label(parse_tree__prog_type__type_unify_head_type_param_6_0,47)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(1) = MR_r1;
	MR_sv(2) = MR_r2;
	MR_sv(3) = MR_r3;
...
MR_def_label(parse_tree__prog_type__type_unify_head_type_param_6_0,4)
	...
	MR_GOTO_LAB(parse_tree__prog_type__type_unify_head_type_param_6_0_i47);
...
MR_BEGIN_MODULE(parse_tree__prog_type_module55)
	...
	MR_init_label10(parse_tree__prog_type__type_occurs_3_0,130,3,8,11,6,19,23,26,16,34)
	MR_init_label4(parse_tree__prog_type__type_occurs_3_0,30,39,63,1)
MR_BEGIN_CODE
...
MR_def_static(parse_tree__prog_type__type_occurs_3_0)
	...
	MR_incr_sp(5);
	MR_sv(5) = (MR_Word) MR_succip;
MR_def_label(parse_tree__prog_type__type_occurs_3_0,130)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_r1,1)) {
...
MR_def_label(parse_tree__prog_type__type_occurs_3_0,8)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_r1) {
		MR_GOTO_LAB(parse_tree__prog_type__type_occurs_3_0_i63);
	}
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(parse_tree__prog_data, tvar_type);
	MR_r2 = (MR_Word) MR_TAG_COMMON(0,0,0);
	MR_r3 = (MR_Word) MR_CTOR0_ADDR(parse_tree__prog_data, mer_type);
	...
	MR_r5 = MR_sv(3);
	MR_np_call_localret_ent(f_109_97_112_95_95_84_121_112_101_83_112_101_99_79_102_95_95_112_114_101_100_95_111_114_95_102_117_110_99_95_95_115_101_97_114_99_104_95_95_91_75_32_61_32_118_97_114_40_86_95_50_41_93_95_48_95_49_3_0,
		parse_tree__prog_type__type_occurs_3_0_i11);
MR_def_label(parse_tree__prog_type__type_occurs_3_0,11)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
	...
	MR_r3 = MR_sv(2);
	MR_succip_word = MR_sv(5);
	MR_GOTO_LAB(parse_tree__prog_type__type_occurs_3_0_i130);
MR_def_label(parse_tree__prog_type__type_occurs_3_0,6)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_RTAGS_TESTR(MR_r1,3,2)) {
		MR_GOTO_LAB(parse_tree__prog_type__type_occurs_3_0_i16);
	}
	...
	MR_np_call_localret_ent(__Unify___term__var_1_0,
		parse_tree__prog_type__type_occurs_3_0_i19);
MR_def_label(parse_tree__prog_type__type_occurs_3_0,19)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_r1) {
		MR_GOTO_LAB(parse_tree__prog_type__type_occurs_3_0_i63);
	}
	...
	MR_np_call_localret_ent(parse_tree__prog_type__type_occurs_list_3_0,
		parse_tree__prog_type__type_occurs_3_0_i23);
MR_def_label(parse_tree__prog_type__type_occurs_3_0,23)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_r1) {
		MR_GOTO_LAB(parse_tree__prog_type__type_occurs_3_0_i63);
	}
...
MR_def_label(parse_tree__prog_type__type_occurs_3_0,26)
	...
	MR_succip_word = MR_sv(5);
	MR_GOTO_LAB(parse_tree__prog_type__type_occurs_3_0_i130);
MR_def_label(parse_tree__prog_type__type_occurs_3_0,16)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_RTAGS_TESTR(MR_r1,3,1)) {
		MR_GOTO_LAB(parse_tree__prog_type__type_occurs_3_0_i30);
	}
...
MR_def_label(parse_tree__prog_type__type_occurs_3_0,34)
	...
	MR_succip_word = MR_sv(5);
	MR_GOTO_LAB(parse_tree__prog_type__type_occurs_3_0_i130);
MR_def_label(parse_tree__prog_type__type_occurs_3_0,30)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_RTAGS_TESTR(MR_r1,3,3)) {
		MR_GOTO_LAB(parse_tree__prog_type__type_occurs_3_0_i39);
	}
	MR_r1 = MR_tfield(3, MR_r1, 1);
	MR_succip_word = MR_sv(5);
	MR_GOTO_LAB(parse_tree__prog_type__type_occurs_3_0_i130);
MR_def_label(parse_tree__prog_type__type_occurs_3_0,39)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_RTAGS_TESTR(MR_r1,3,0)) {
		MR_GOTO_LAB(parse_tree__prog_type__type_occurs_3_0_i1);
	}
	...
	MR_decr_sp(5);
	MR_np_tailcall_ent(parse_tree__prog_type__type_occurs_list_3_0);
MR_def_label(parse_tree__prog_type__type_occurs_3_0,63)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_TRUE;
	MR_decr_sp_and_return(5);
...
MR_BEGIN_MODULE(parse_tree__prog_type_module71)
	...
	MR_init_label8(__Compare___parse_tree__prog_type__ctor_defn_0_0,3,2,5,10,15,19,23,73)
MR_BEGIN_CODE
...
MR_def_label(__Compare___parse_tree__prog_type__ctor_defn_0_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___parse_tree__prog_type__ctor_defn_0_0_i73);
	}
	MR_r1 = (MR_Word) MR_TAG_COMMON(0,0,0);
	MR_r2 = MR_sv(1);
	MR_r3 = MR_sv(6);
...
MR_def_label(__Compare___parse_tree__prog_type__ctor_defn_0_0,73)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(11);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
...
MR_BEGIN_MODULE(parse_tree__prog_type_module86)
	MR_init_entry1(parse_tree__prog_type__IntroducedFrom__pred__split_vars_typeinfo_no_typeinfo__843__1_2_0);
	MR_INIT_PROC_LAYOUT_ADDR(mercury__parse_tree__prog_type__IntroducedFrom__pred__split_vars_typeinfo_no_typeinfo__843__1_2_0);
	MR_init_label1(parse_tree__prog_type__IntroducedFrom__pred__split_vars_typeinfo_no_typeinfo__843__1_2_0,3)
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'IntroducedFrom__pred__split_vars_typeinfo_no_typeinfo__843__1'/2 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(parse_tree__prog_type__IntroducedFrom__pred__split_vars_typeinfo_no_typeinfo__843__1_2_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(1);
	MR_sv(1) = (MR_Word) MR_succip;
	{
	...
	MR_np_call_localret_ent(fn__f_109_97_112_95_95_84_121_112_101_83_112_101_99_79_102_95_95_112_114_101_100_95_111_114_95_102_117_110_99_95_95_108_111_111_107_117_112_95_95_91_75_32_61_32_118_97_114_40_86_95_50_41_93_95_48_95_49_2_0,
		parse_tree__prog_type__IntroducedFrom__pred__split_vars_typeinfo_no_typeinfo__843__1_2_0_i3);
MR_def_label(parse_tree__prog_type__IntroducedFrom__pred__split_vars_typeinfo_no_typeinfo__843__1_2_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_succip_word = MR_sv(1);
	MR_decr_sp(1);
