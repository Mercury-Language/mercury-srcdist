  ...
  MR_Box * wrapper_arg_2)
{
  ...
  parse_tree__prog_type__strip_module_names_from_type_4_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) ((MR_hl_field(0, closure, 4)))), ((MR_Word) (wrapper_arg_1)), &conv3_Type_8);
  ...
  switch (MR_tag((MR_Word) Type0_7)) {
    ...
    case (MR_Integer) 3:
      switch (((MR_Integer) ((MR_hl_field(3, Type0_7, 0))))) {
        ...
        case (MR_Integer) 0:
          {
            MR_Word ArgTypes0_26 = ((MR_Word) ((MR_hl_field(3, Type0_7, 1))));
            MR_Word Kind_27 = ((MR_Word) ((MR_hl_field(3, Type0_7, 2))));
            MR_Word ArgTypes_28;
            MR_Word Var_39;
        ...
        case (MR_Integer) 1:
          {
            ...
            MR_Word ArgTypes0_24 = ((MR_Word) ((MR_hl_field(3, Type0_7, 2))));
            MR_Word ArgTypes_25;
            MR_Word Var_37;
        ...
        case (MR_Integer) 2:
          {
            MR_Word Var_21 = ((MR_Word) ((MR_hl_field(3, Type0_7, 1))));
            MR_Word ArgTypes0_29 = ((MR_Word) ((MR_hl_field(3, Type0_7, 2))));
            MR_Word Kind_30 = ((MR_Word) ((MR_hl_field(3, Type0_7, 3))));
            MR_Word ArgTypes_31;
            MR_Word Var_33;
        ...
        case (MR_Integer) 3:
          {
            MR_Word SubType0_22 = ((MR_Word) ((MR_hl_field(3, Type0_7, 1))));
            MR_Word SubType_23;
            MR_Word Kind_32 = ((MR_Word) ((MR_hl_field(3, Type0_7, 2))));
  ...
  MR_Word * ArgTypes_6)
{
  while (MR_TRUE)
  {
    ...
    switch (MR_tag((MR_Word) Type_4)) {
      ...
      case (MR_Integer) 1:
        {
          MR_Word SymName_40 = ((MR_Word) ((MR_hl_field(1, Type_4, 0))));
          MR_Integer Arity_42;

          *ArgTypes_6 = ((MR_Word) ((MR_hl_field(1, Type_4, 1))));
          Arity_42 = mercury__list__length_1_f_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0), *ArgTypes_6);
          {
            MR_Word base;
            base = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
            *TypeCtor_5 = base;
            MR_hl_field(0, base, 0) = ((MR_Box) (SymName_40));
            MR_hl_field(0, base, 1) = ((MR_Box) (Arity_42));
          }
          succeeded = MR_TRUE;
        }
        break;
      ...
      case (MR_Integer) 3:
        switch (((MR_Integer) ((MR_hl_field(3, Type_4, 0))))) {
          ...
          case (MR_Integer) 1:
            {
              ...
              *ArgTypes_6 = ((MR_Word) ((MR_hl_field(3, Type_4, 2))));
              ...
              switch (Purity_18) {
                default: /*NOTREACHED*/ MR_assert(0);
                case (MR_Integer) 2:
                  SymName_35 = mdbcomp__sym_name__add_outermost_qualifier_2_f_0((MR_String) "impure", SymName0_22);
                  break;
                case (MR_Integer) 0:
                  SymName_35 = SymName0_22;
                  break;
                case (MR_Integer) 1:
                  SymName_35 = mdbcomp__sym_name__add_outermost_qualifier_2_f_0((MR_String) "semipure", SymName0_22);
                  break;
              }
              {
                MR_Word base;
          ...
          case (MR_Integer) 3:
            {
              MR_Word SubType_27 = ((MR_Word) ((MR_hl_field(3, Type_4, 1))));
              MR_Word next_value_of_Type_4 = SubType_27;
