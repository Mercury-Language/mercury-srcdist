...
MR_decl_label10(parse_tree__prog_type__qualify_cons_id_4_0, 5,6,7,3,13,11,18,10,23,24)
MR_decl_label2(parse_tree__prog_type__qualify_cons_id_4_0, 25,21)
...
MR_BEGIN_MODULE(parse_tree__prog_type_module51)
	...
	MR_init_label10(parse_tree__prog_type__qualify_cons_id_4_0,5,6,7,3,13,11,18,10,23,24)
	MR_init_label2(parse_tree__prog_type__qualify_cons_id_4_0,25,21)
MR_BEGIN_CODE
...
MR_def_label(parse_tree__prog_type__qualify_cons_id_4_0,3)
	...
	if (MR_PTAG_TESTR(MR_tempr1,1)) {
		MR_GOTO_LAB(parse_tree__prog_type__qualify_cons_id_4_0_i11);
	}
...
MR_def_label(parse_tree__prog_type__qualify_cons_id_4_0,10)
	...
	if (MR_RTAGS_TESTR(MR_r2,3,8)) {
		MR_GOTO_LAB(parse_tree__prog_type__qualify_cons_id_4_0_i21);
	}
	MR_incr_sp(4);
	MR_sv(4) = (MR_Word) MR_succip;
	MR_sv(1) = MR_r2;
