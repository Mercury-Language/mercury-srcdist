...
{
  {
    ...
    if (parse_tree__prog_type__succeeded)
    {
      ...
      parse_tree__prog_type__type_list_contains_var_2_p_0(parse_tree__prog_type__Var_9, parse_tree__prog_type__Var_2, parse_tree__prog_type__cont, parse_tree__prog_type__cont_env_ptr);
    }
  }
}
        ...
        case (MR_Integer) 3:
          {
            ...
            parse_tree__prog_type__type_contains_var_2_p_0(parse_tree__prog_type__Type_25, parse_tree__prog_type__Var_2, parse_tree__prog_type__cont, parse_tree__prog_type__cont_env_ptr);
          }
          break;
      }
      break;
