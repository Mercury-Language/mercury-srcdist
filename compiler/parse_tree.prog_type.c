...
{
  {
    ...
    succeeded = parse_tree__prog_data____Unify____maybe_subtype_0_0(MaybeSuperType_3, HeadVar__2_15);
    return succeeded;
  }
}
...
{
  {
    ...
    succeeded = parse_tree__prog_data____Unify____maybe_subtype_0_0(MaybeSuperType_5, HeadVar__2_16);
    return succeeded;
  }
}
