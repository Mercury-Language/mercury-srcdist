      ...
      else
      {
        ...
        switch (MR_tag((MR_Word) X_6)) {
          ...
          case (MR_Integer) 1:
            {
              ...
              MR_Word ArgTypesX_27 = ((MR_Word) ((MR_hl_field(MR_mktag(1), X_6, (MR_Integer) 1))));
              MR_Word ArgTypesY_29;
              MR_Word Var_46;
              ...
              if (succeeded)
              {
                ...
                ArgTypesY_29 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Y_7, (MR_Integer) 1))));
                succeeded = mdbcomp__sym_name____Unify____sym_name_0_0(SymName_26, Var_46);
                if (succeeded)
                  succeeded = parse_tree__prog_type__type_unify_list_5_p_0(ArgTypesX_27, ArgTypesY_29, HeadTypeParams_8, STATE_VARIABLE_Bindings_0_14, &STATE_VARIABLE_Bindings_18_18);
              }
            }
            break;
          case (MR_Integer) 2:
          ...
          case (MR_Integer) 3:
            switch (((MR_Integer) ((MR_hl_field(MR_mktag(3), X_6, (MR_Integer) 0))))) {
              ...
              case (MR_Integer) 0:
                {
                  MR_Word ArgTypesX_44 = ((MR_Word) ((MR_hl_field(MR_mktag(3), X_6, (MR_Integer) 1))));
                  ...
                  if (succeeded)
                  {
                    ArgTypesY_45 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Y_7, (MR_Integer) 1))));
                    succeeded = parse_tree__prog_type__type_unify_list_5_p_0(ArgTypesX_44, ArgTypesY_45, HeadTypeParams_8, STATE_VARIABLE_Bindings_0_14, &STATE_VARIABLE_Bindings_18_18);
                  }
                }
                break;
              case (MR_Integer) 1:
                {
                  ...
                  MR_Word ArgTypesX_42 = ((MR_Word) ((MR_hl_field(MR_mktag(3), X_6, (MR_Integer) 2))));
                  MR_Word ArgTypesY_43;
                  MR_Word Var_48;
                  MR_Word Var_49;
                  ...
                  if (succeeded)
                  {
                    ...
                    ArgTypesY_43 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Y_7, (MR_Integer) 2))));
                    ...
                    if (succeeded)
                    {
                      ...
                      if (succeeded)
                      {
                        succeeded = MR_TRUE;
                        if (succeeded)
                          succeeded = parse_tree__prog_type__type_unify_list_5_p_0(ArgTypesX_42, ArgTypesY_43, HeadTypeParams_8, STATE_VARIABLE_Bindings_0_14, &STATE_VARIABLE_Bindings_18_18);
                      }
                    }
                  }
                }
        ...
        else
        {
          ...
          if (succeeded)
          {
            ...
            ArgTypesX_60 = ((MR_Word) ((MR_hl_field(MR_mktag(3), X_6, (MR_Integer) 2))));
            {
              MR_Word next_value_of_tscc_proc_4_input_1_TypeY_7 = Y_7;
              MR_Word next_value_of_tscc_proc_4_input_2_VarX_8 = VarX_59;
              MR_Word next_value_of_tscc_proc_4_input_3_ArgTypesX0_9 = ArgTypesX_60;
          ...
          else
          {
            ...
            if (succeeded)
            {
              ...
              ArgTypesY_63 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Y_7, (MR_Integer) 2))));
              {
                MR_Word next_value_of_tscc_proc_4_input_1_TypeY_7 = X_6;
                MR_Word next_value_of_tscc_proc_4_input_2_VarX_8 = VarY_62;
                MR_Word next_value_of_tscc_proc_4_input_3_ArgTypesX0_9 = ArgTypesY_63;
                MR_Word next_value_of_tscc_proc_4_input_4_HeadTypeParams_10 = HeadTypeParams_8;
                MR_Word next_value_of_tscc_proc_4_input_5_STATE_VARIABLE_Bindings_0_34 = STATE_VARIABLE_Bindings_0_14;
          ...
          case (MR_Integer) 2:
            {
              ...
              if (succeeded)
              {
                ...
                succeeded = parse_tree__prog_type__type_unify_rev_args_8_p_0(RevArgTypesX_75, RevArgTypesY0_76, &RevArgTypesY_77, Kind0_24, &Kind_28, HeadTypeParams_10, STATE_VARIABLE_Bindings_0_34, &STATE_VARIABLE_Bindings_44_44);
                if (succeeded)
                {
              ...
              else
              {
                ...
                else
                {
                  ...
                  succeeded = parse_tree__prog_type__type_unify_args_8_p_0(ArgTypesX0_9, ArgTypesY0_61, &Var_29, Kind0_24, &Kind_58, HeadTypeParams_10, STATE_VARIABLE_Bindings_0_34, &STATE_VARIABLE_Bindings_47_47);
                  if (succeeded)
                  {
                    // direct tailcall eliminated
                    ;
