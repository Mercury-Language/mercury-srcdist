    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          {
            Var_28 = (MR_Integer) 1;
            STATE_VARIABLE_NumFunctors_17_27 = (Var_13 + Var_28);
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        {
          Var_18 = (MR_Integer) 1;
          STATE_VARIABLE_NumFunctors_17_17 = (STATE_VARIABLE_NumFunctors_0_2 + Var_18);
          // direct tailcall eliminated
...
{
  {
    ...
    succeeded = libs__globals__lookup_bool_option_3_p_1(Globals_8, (MR_Integer) 261, (MR_Integer) 1);
    if (succeeded)
    {
