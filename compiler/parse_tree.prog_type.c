...
static /* final */ const MR_Box parse_tree__prog_type_scalar_common_1[5][2] = {
  ...
  /* row   3 */
  {
    ((MR_Box) (&parse_tree__prog_type_scalar_common_2[1])),
    ((MR_Box) ((MR_Integer) 0))
  },
  /* row   4 */
  {
...
MR_bool MR_CALL 
parse_tree__prog_type__identical_up_to_renaming_2_p_0(
  ...
  MR_Word TypesList2_4)
{
  ...
  succeeded = parse_tree__prog_type__type_list_subsumes_3_p_0(TypesList1_3, TypesList2_4, &Var_5);
  if (succeeded)
    succeeded = parse_tree__prog_type__type_list_subsumes_3_p_0(TypesList2_4, TypesList1_3, &Var_6);
  return succeeded;
}
        ...
        case (MR_Integer) 0:
          {
...

            {
              ...
              MR_hl_field(0, Var_38, 1) = ((MR_Box) (parse_tree__prog_type__strip_module_names_from_type_3_p_0_4));
              MR_hl_field(0, Var_38, 2) = ((MR_Box) ((MR_Integer) 1));
              MR_hl_field(0, Var_38, 3) = ((MR_Box) (StripWhat_4));
            }
            mercury__list__map_3_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0), (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0), Var_38, ArgTypes0_25, &ArgTypes_27);
            {
              MR_Word base;
        ...
        case (MR_Integer) 1:
          {
            ...
            parse_tree__prog_mode__strip_module_names_from_ho_inst_info_3_p_0(StripWhat_4, HOInstInfo0_16, &HOInstInfo_19);
            {
              MR_Word base;
