  ...
  MR_Word Ptag_12)
{
  {
    MR_bool succeeded;
    uint8_t Var_44 = (uint8_t) (Ptag_12);
    uint8_t Var_45 = (uint8_t) (CurPtag_3);
...
{
  {
    ...
    }
    {
      RttiId_41 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), RttiId_41, 0) = ((MR_Box) (RttiTypeCtor_7));
      MR_hl_field(MR_mktag(0), RttiId_41, 1) = ((MR_Box) ((MR_Unsigned) 28U));
    }
    {
      Name_48 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), Name_48, 0) = ((MR_Box) (RttiId_41));
    }
    ml_backend__rtti_to_mlds__rtti_entity_name_and_init_to_defn_5_p_0(Name_48, RttiId_41, Initializer_17, STATE_VARIABLE_GlobalData_21_21, STATE_VARIABLE_GlobalData_19);
  }
}
...
{
  {
    ...
    else
    {
      ...
      mercury__require__expect_3_p_0(Var_26, (MR_String) "predicate \140ml_backend.rtti_to_mlds.gen_du_ptag_ordered_table_body\'/5", (MR_String) "ptag mismatch");
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(0), Var_30, 0) = ((MR_Box) (RttiId_22));
      }
      {
      ...
      Var_32 = ml_backend__ml_util__gen_init_uint32_1_f_0(NumSharers_19);
      backend_libs__rtti__sectag_locn_to_string_3_p_0(SectagLocn_17, &TargetPrefixes_46, &Name_47);
      Var_34 = ml_backend__ml_util__gen_init_builtin_const_2_f_0(TargetPrefixes_46, Name_47);
      {
        Var_37 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(3), Var_37, 0) = ((MR_Box) ((MR_Unsigned) 8U));
        MR_hl_field(MR_mktag(3), Var_37, 1) = ((MR_Box) (Ptag_12));
      }
      Var_36 = ml_backend__rtti_to_mlds__gen_init_rtti_name_3_f_0(ModuleName_1, RttiTypeCtor_2, Var_37);
      Var_39 = ml_backend__ml_util__gen_init_int8_1_f_0(NumSectagBits_18);
      {
      ...
      Var_41 = (CurPtagUint8_23 + UINT8_C(1));
      NextPtag_24 = (MR_Word) (Var_41);
