...
static void MR_CALL 
ml_backend__rtti_to_mlds__IntroducedFrom__pred__order_mlds_rtti_defns__1748__2_3_p_0(
  MR_Word HeadVar__1_18,
  MR_Word HeadVar__2_36,
  MR_Word * HeadVar__3_37);

static MR_bool MR_CALL 
ml_backend__rtti_to_mlds__IntroducedFrom__pred__order_mlds_rtti_defns__1748__1_3_p_0(
  MR_Word NameMap_6,
  MR_Word HeadVar__2_40,
  MR_Word * HeadVar__3_41);

static void MR_CALL 
ml_backend__rtti_to_mlds__IntroducedFrom__pred__order_mlds_rtti_defns__1747__1_2_p_0(
...
static /* final */ const MR_Box ml_backend__rtti_to_mlds_scalar_common_3[2][4];

static /* final */ const MR_Box ml_backend__rtti_to_mlds_scalar_common_4[7][8];

static /* final */ const MR_Box ml_backend__rtti_to_mlds_scalar_common_5[15][5];

static /* final */ const MR_Box ml_backend__rtti_to_mlds_scalar_common_6[5][6];
...
{
  {
    ...
    FunctorRttiNames_15 = mercury__list__map_2_f_0(TypeCtorInfo_23_23, (MR_Word) &backend_libs__rtti__backend_libs__rtti__type_ctor_info_ctor_rtti_name_0, (MR_Word) &ml_backend__rtti_to_mlds_scalar_common_2[35], SectagFunctors_14);
    {
...
{
  {
    ...
    *RttiId_14 = ((MR_Word) conv1_RttiId_14);
    ...
    TypeRttiDatas_23 = mercury__list__map_2_f_0(TypeCtorInfo_40_40, (MR_Word) &backend_libs__rtti__backend_libs__rtti__type_ctor_info_rtti_data_0, (MR_Word) &ml_backend__rtti_to_mlds_scalar_common_2[33], Types_18);
    TypeCtorInfo_20_57 = (MR_Word) &backend_libs__rtti__backend_libs__rtti__type_ctor_info_rtti_data_0;
    RealRttiDatas_51 = mercury__list__filter_2_f_0(TypeCtorInfo_20_57, (MR_Word) &ml_backend__rtti_to_mlds_scalar_common_2[34], TypeRttiDatas_23);
    {
...
{
  {
...

    {
      ...
      ArgTypes_19 = mercury__list__map_2_f_0(TypeCtorInfo_101_101, (MR_Word) &backend_libs__rtti__backend_libs__rtti__type_ctor_info_rtti_maybe_pseudo_type_info_or_self_0, (MR_Word) &ml_backend__rtti_to_mlds_scalar_common_2[31], ArgInfos_16);
      ...
      (env).ml_backend__rtti_to_mlds__gen_du_functor_desc_6_p_0_env_0__MaybeArgNames_20 = mercury__list__map_2_f_0(TypeCtorInfo_101_101, (env).ml_backend__rtti_to_mlds__gen_du_functor_desc_6_p_0_env_0__TypeInfo_105_105, (MR_Word) &ml_backend__rtti_to_mlds_scalar_common_2[32], ArgInfos_16);
...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(0), Var_18, 4) = ((MR_Box) (&ml_backend__rtti_to_mlds_scalar_common_2[30]));
    }
...
{
  {
    ...
    TypeRttiDatas_14 = mercury__list__map_2_f_0((MR_Word) &backend_libs__rtti__backend_libs__rtti__type_ctor_info_rtti_maybe_pseudo_type_info_or_self_0, (MR_Word) &backend_libs__rtti__backend_libs__rtti__type_ctor_info_rtti_data_0, (MR_Word) &ml_backend__rtti_to_mlds_scalar_common_2[28], Types_12);
    TypeCtorInfo_20_39 = (MR_Word) &backend_libs__rtti__backend_libs__rtti__type_ctor_info_rtti_data_0;
    RealRttiDatas_33 = mercury__list__filter_2_f_0(TypeCtorInfo_20_39, (MR_Word) &ml_backend__rtti_to_mlds_scalar_common_2[29], TypeRttiDatas_14);
    {
...
{
  {
...

    {
      ...
      MR_hl_field(MR_mktag(0), Var_16, 0) = ((MR_Box) (&ml_backend__rtti_to_mlds_scalar_common_6[4]));
...
{
  {
    ...
    ml_backend__rtti_to_mlds__IntroducedFrom__pred__order_mlds_rtti_defns__1748__2_3_p_0(((MR_Word) (MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3))), ((MR_Word) wrapper_arg_1), &conv8_HeadVar__3_37);
...
{
  {
    ...
    succeeded = ml_backend__rtti_to_mlds__IntroducedFrom__pred__order_mlds_rtti_defns__1748__1_3_p_0(((MR_Word) (MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3))), ((MR_Word) wrapper_arg_1), &conv7_HeadVar__3_41);
    if (succeeded)
    {
...
{
  {
    ...
    ml_backend__rtti_to_mlds__IntroducedFrom__pred__order_mlds_rtti_defns__1747__1_2_p_0(((MR_Word) wrapper_arg_1), &conv6_HeadVar__2_33);
...
{
  {
    ...
    mercury__list__foldl2_6_p_0(TypeCtorInfo_25_25, TypeInfo_26_26, (MR_Word) &ml_backend__rtti_to_mlds_scalar_common_2[0], (MR_Word) &ml_backend__rtti_to_mlds_scalar_common_2[25], Defns_3, ((MR_Box) (STATE_VARIABLE_Graph_10_10)), &conv3_STATE_VARIABLE_Graph_12_12, ((MR_Box) (Var_13)), &conv2_NameMap_6);
    STATE_VARIABLE_Graph_12_12 = ((MR_Word) conv3_STATE_VARIABLE_Graph_12_12);
    NameMap_6 = ((MR_Word) conv2_NameMap_6);
    mercury__list__foldl_4_p_0(TypeCtorInfo_25_25, TypeInfo_26_26, (MR_Word) &ml_backend__rtti_to_mlds_scalar_common_2[26], Defns_3, ((MR_Box) (STATE_VARIABLE_Graph_12_12)), &conv5_STATE_VARIABLE_Graph_15_15);
    ...
    mercury__list__map_3_p_0(TypeInfo_31_31, TypeInfo_35_35, (MR_Word) &ml_backend__rtti_to_mlds_scalar_common_2[27], OrdSets_8, &OrdLists_9);
    {
      Var_18 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), Var_18, 0) = ((MR_Box) (&ml_backend__rtti_to_mlds_scalar_common_6[2]));
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(0), Var_17, 0) = ((MR_Box) (&ml_backend__rtti_to_mlds_scalar_common_6[3]));
...
{
  {
    ...
    Var_30 = ml_backend__ml_util__gen_init_maybe_3_f_0((MR_Word) &mercury__builtin__builtin__type_ctor_info_string_0, Var_31, (MR_Word) &ml_backend__rtti_to_mlds_scalar_common_2[24], MaybeArgName_14);
...
{
  {
    ...
    Initializer_8 = ml_backend__ml_util__gen_init_array_2_f_0((MR_Word) &mercury__builtin__builtin__type_ctor_info_int_0, (MR_Word) &ml_backend__rtti_to_mlds_scalar_common_2[23], FunctorNumberMap_6);
    {
...
{
  {
    ...
    ml_backend__rtti_to_mlds__IntroducedFrom__pred__gen_maybe_res_name_ordered_table__1286__1_2_p_0(((MR_Word) wrapper_arg_1), &conv0_HeadVar__2_24);
...
{
  {
    ...
    mercury__list__map_3_p_0(TypeInfo_22_22, (MR_Word) &ml_backend__rtti_to_mlds_scalar_common_1[6], (MR_Word) &ml_backend__rtti_to_mlds_scalar_common_2[22], ArityMaps_10, &FunctorLists_11);
...
{
  {
    ...
    conv0_HeadVar__2_2 = backend_libs__rtti__res_functor_rtti_name_1_f_0(((MR_Word) wrapper_arg_1));
    wrapper_arg_2 = ((MR_Box) (conv0_HeadVar__2_2));
    return wrapper_arg_2;
  }
}
...
{
  {
    MR_Integer NumNumericResFunctorReps_12;
    MR_Word ResAddrInitializer_14;
    ...
    MR_Word Var_34;
    MR_Word Var_35;
    MR_Word FunctorRttiNames_46;
    MR_Word Initializer_47;
    MR_Word Var_58;
    MR_Word RttiId_68;
    MR_Word Name_75;
    MR_Word Name_82;

    mercury__list__length_2_p_0((MR_Word) &backend_libs__rtti__backend_libs__rtti__type_ctor_info_reserved_functor_0, ResFunctors_9, &NumNumericResFunctorReps_12);
    ResAddrInitializer_14 = ml_backend__ml_util__gen_init_null_pointer_1_f_0((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 6)));
    hlds__hlds_module__module_info_get_name_2_p_0(ModuleInfo_7, &ModuleName_15);
    FunctorRttiNames_46 = mercury__list__map_2_f_0((MR_Word) &backend_libs__rtti__backend_libs__rtti__type_ctor_info_reserved_functor_0, (MR_Word) &backend_libs__rtti__backend_libs__rtti__type_ctor_info_ctor_rtti_name_0, (MR_Word) &ml_backend__rtti_to_mlds_scalar_common_2[21], ResFunctors_9);
    {
      Var_58 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 5 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), Var_58, 0) = ((MR_Box) (&ml_backend__rtti_to_mlds_scalar_common_7[3]));
      MR_hl_field(MR_mktag(0), Var_58, 1) = ((MR_Box) (ml_backend__rtti_to_mlds__gen_maybe_res_value_ordered_table_6_p_0_2));
      MR_hl_field(MR_mktag(0), Var_58, 2) = ((MR_Box) (MR_Word) ((MR_Integer) 2));
      MR_hl_field(MR_mktag(0), Var_58, 3) = ((MR_Box) (ModuleName_15));
      MR_hl_field(MR_mktag(0), Var_58, 4) = ((MR_Box) (RttiTypeCtor_8));
    }
    Initializer_47 = ml_backend__ml_util__gen_init_array_2_f_0((MR_Word) &backend_libs__rtti__backend_libs__rtti__type_ctor_info_ctor_rtti_name_0, Var_58, FunctorRttiNames_46);
    {
      RttiId_68 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), RttiId_68, 0) = ((MR_Box) (RttiTypeCtor_8));
      MR_hl_field(MR_mktag(0), RttiId_68, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 2))));
    }
    {
      Name_75 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), Name_75, 0) = ((MR_Box) (RttiId_68));
    }
    ml_backend__rtti_to_mlds__rtti_entity_name_and_init_to_defn_5_p_0(Name_75, RttiId_68, Initializer_47, STATE_VARIABLE_GlobalData_0_19, &STATE_VARIABLE_GlobalData_22_22);
    ml_backend__rtti_to_mlds__gen_du_ptag_ordered_table_5_p_0(ModuleInfo_7, RttiTypeCtor_8, DuByPtag_10, STATE_VARIABLE_GlobalData_22_22, &STATE_VARIABLE_GlobalData_23_23);
    {
      RttiId_17 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), RttiId_17, 0) = ((MR_Box) (RttiTypeCtor_8));
      MR_hl_field(MR_mktag(0), RttiId_17, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 10))));
    }
    {
      Var_25 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), Var_25, 0) = ((MR_Box) (RttiId_17));
    }
    {
      Var_24 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(3), Var_24, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 7));
    ...
    Var_27 = ml_backend__ml_util__gen_init_int_1_f_0(NumNumericResFunctorReps_12);
    Var_29 = ml_backend__ml_util__gen_init_int_1_f_0((MR_Integer) 0);
    Var_32 = ml_backend__rtti_to_mlds__gen_init_rtti_name_3_f_0(ModuleName_15, RttiTypeCtor_8, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 2)));
    Var_35 = ml_backend__rtti_to_mlds__gen_init_rtti_name_3_f_0(ModuleName_15, RttiTypeCtor_8, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 9)));
    {
      Var_34 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), Var_34, 0) = ((MR_Box) (Var_35));
    ...
    {
      Var_30 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), Var_30, 0) = ((MR_Box) (ResAddrInitializer_14));
    ...
    {
      Initializer_18 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(2), Initializer_18, 0) = ((MR_Box) (Var_24));
      MR_hl_field(MR_mktag(2), Initializer_18, 1) = ((MR_Box) (Var_26));
    }
    {
      Name_82 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), Name_82, 0) = ((MR_Box) (RttiId_17));
    }
    ml_backend__rtti_to_mlds__rtti_entity_name_and_init_to_defn_5_p_0(Name_82, RttiId_17, Initializer_18, STATE_VARIABLE_GlobalData_23_23, STATE_VARIABLE_GlobalData_20);
  }
}
