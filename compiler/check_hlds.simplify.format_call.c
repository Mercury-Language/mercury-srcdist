  ...
  MR_Word * STATE_VARIABLE_VarTypes_80)
{
  ...
  if (succeeded)
  {
    ...
    TypeInfo_153_153 = (MR_Word) (&check_hlds__simplify__format_call_scalar_common_2[2]);
    TypeInfo_154_154 = (MR_Word) (&check_hlds__simplify__format_call_scalar_common_2[3]);
    {
    ...
    mercury__list__map_3_p_0(TypeInfo_153_153, TypeInfo_154_154, Var_99, PolytypeVars0_49, &MaybeAbstractPolyTypes0_51);
    TypeCtorInfo_155_155 = (MR_Word) (&check_hlds__simplify__format_call__parse_string_format__check_hlds__simplify__format_call__parse_string_format__type_ctor_info_abstract_poly_type_0);
    succeeded = check_hlds__simplify__format_call__project_all_yes_2_p_0(TypeCtorInfo_155_155, MaybeAbstractPolyTypes0_51, &AbstractPolyTypes0_52);
  }
  if (succeeded)
  {
                    ...
                    if (succeeded)
                    {
                      ...
                      if (succeeded)
                      {
                        ...
                        if (succeeded)
                        {
                          ...
                          succeeded = parse_tree__set_of_var__member_2_p_0(TypeCtorInfo_248_248, STATE_VARIABLE_RelevantVars_137_137, ResultVar_90);
                        }
                      }
                    }
                  }
                    ...
                    if (succeeded)
                    {
                      ...
                      if (succeeded)
                      {
                        ...
                        if (succeeded)
                        {
                          ...
                          succeeded = parse_tree__set_of_var__member_2_p_0(TypeCtorInfo_250_250, STATE_VARIABLE_RelevantVars_137_137, ResultVar_228);
                        }
                      }
                    }
                  }
            ...
            case (MR_Integer) 5:
              {
                ...
                if (succeeded)
                {
                  ...
                  if (succeeded)
                  {
                    ...
                    succeeded = parse_tree__set_of_var__member_2_p_0(TypeCtorInfo_246_246, STATE_VARIABLE_RelevantVars_137_137, TermVar_59);
                    succeeded = !(succeeded);
                  }
                }
                if (succeeded)
  ...
  MR_Word * HeadVar__12_12)
{
  ...
  else
  {
    ...
    MR_Word GoalConj_77;
    MR_Word STATE_VARIABLE_Counter_33_78;
    MR_Integer N_83;
    ...
    mercury__counter__allocate_3_p_0(&N_83, STATE_VARIABLE_Counter_0_6, &STATE_VARIABLE_Counter_33_78);
    DisjId_36 = (MR_Word) (N_83);
    hlds__hlds_goal__goal_to_conj_list_2_p_0(Goal_28, &GoalConj_77);
    check_hlds__simplify__format_call__format_call_traverse_conj_13_p_0(ModuleInfo_1, GoalConj_77, DisjId_36, STATE_VARIABLE_FormatCallSites_0_4, &STATE_VARIABLE_FormatCallSites_47_47, STATE_VARIABLE_Counter_33_78, &STATE_VARIABLE_Counter_48_48, STATE_VARIABLE_ConjMaps_0_8, &STATE_VARIABLE_ConjMaps_49_49, STATE_VARIABLE_PredMap_0_10, &STATE_VARIABLE_PredMap_50_50, Var_51, &HeadRelevantVars_37);
