...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_22, (MR_Integer) 399, &OptFormatCalls_31);
    libs__globals__lookup_bool_option_3_p_0(Globals_22, (MR_Integer) 213, &ExecTrace_32);
