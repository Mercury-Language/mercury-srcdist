  ...
  MR_Word * STATE_VARIABLE_VarTable_75)
{
  ...
  if (succeeded)
  {
    ...
    TypeInfo_146_146 = (MR_Word) (&check_hlds__simplify__format_call_scalar_common_2[1]);
    TypeInfo_147_147 = (MR_Word) (&check_hlds__simplify__format_call_scalar_common_2[2]);
    {
    ...
    mercury__list__map_3_p_0(TypeInfo_146_146, TypeInfo_147_147, Var_94, PolytypeVars0_46, &MaybeAbstractPolyTypes0_48);
    TypeCtorInfo_148_148 = (MR_Word) (&check_hlds__simplify__format_call__parse_string_format__check_hlds__simplify__format_call__parse_string_format__type_ctor_info_abstract_poly_type_0);
    succeeded = check_hlds__simplify__format_call__project_all_yes_2_p_0(TypeCtorInfo_148_148, MaybeAbstractPolyTypes0_48, &AbstractPolyTypes0_49);
  }
  if (succeeded)
  {
      ...
      case (MR_Integer) 1:
        {
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              ...
              succeeded = parse_tree__set_of_var__remove_3_p_0(TypeCtorInfo_222_222, LHSVar_50, STATE_VARIABLE_ToDeleteVars_0_112, &STATE_VARIABLE_ToDeleteVars_171_171);
            }
          }
          if (succeeded)
          {
              ...
              if (succeeded)
              {
                ...
                if (succeeded)
                {
                  ...
                  if (succeeded)
                  {
                    ...
                    succeeded = parse_tree__set_of_var__remove_3_p_0(TypeCtorInfo_231_231, TermVar_89, STATE_VARIABLE_ToDeleteVars_0_112, &STATE_VARIABLE_ToDeleteVars_134_134);
                  }
                }
              }
              if (succeeded)
  ...
  MR_Word * HeadVar__12_12)
{
  ...
  else
  {
    ...
    check_hlds__simplify__format_call__format_call_traverse_conj_13_p_0(ModuleInfo_1, GoalConj_55, DisjId_36, STATE_VARIABLE_FormatCallSites_0_4, &STATE_VARIABLE_FormatCallSites_47_47, STATE_VARIABLE_Counter_33_56, &STATE_VARIABLE_Counter_48_48, STATE_VARIABLE_ConjMaps_0_8, &STATE_VARIABLE_ConjMaps_49_49, STATE_VARIABLE_PredMap_0_10, &STATE_VARIABLE_PredMap_50_50, Var_51, &HeadRelevantVars_37);
              ...
              if (succeeded)
              {
                ...
                else
                {
                  ...
                  *FormattedValuesVar_14 = Var_61;
                  ...
                  Var_30 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Var_62, (MR_Integer) 1))));
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                ...
                {
                  MR_Word Var_23 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Var_65, (MR_Integer) 1))));
