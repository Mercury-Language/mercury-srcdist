              ...
              case (MR_Integer) 1:
                {
                  ...
                  mercury__private_builtin__builtin_compare_int_3_p_0(&SubResult1_19, Var_57, Var_58);
              ...
              case (MR_Integer) 2:
                {
                  ...
                  mercury__private_builtin__builtin_compare_int_3_p_0(&SubResult1_40, Var_59, Var_60);
...
{
  {
    ...
    else
    {
      ...
      mercury__private_builtin__builtin_compare_int_3_p_0(&SubResult1_6, Var_49, Var_50);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_22, (MR_Integer) 389, &OptFormatCalls_31);
