...
{
  {
    ...
    libs__globals__set_option_4_p_0((MR_Integer) 180, (MR_Word) (MR_mkword(MR_mktag(3), &check_hlds__simplify__format_call_scalar_common_2[12])), Globals0_21, &Globals_22);
