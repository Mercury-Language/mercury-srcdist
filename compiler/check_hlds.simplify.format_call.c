...
{
  {
    ...
    if ((FormatStringResult_41 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals_40, (MR_Integer) 45, &WarnUnknownFormatCallsA_45);
    ...
    else
    {
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals_40, (MR_Integer) 45, &WarnUnknownFormatCallsB_56);
    ...
    if (succeeded)
    {
      ...
      if (((MR_tag((MR_Word) MaybeSpecs_66)) == (MR_Integer) 1))
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_40, (MR_Integer) 43, &WarnKnownBadFormatCalls_69);
          ...
          case (MR_Integer) 1:
            {
              ...
              libs__globals__lookup_bool_option_3_p_0(Globals_40, (MR_Integer) 44, &WarnOnlyOneFormatStringError_71);
...
{
  {
    ...
    libs__globals__set_option_4_p_0((MR_Integer) 174, (MR_Word) (MR_mkword(MR_mktag(3), &check_hlds__simplify__format_call_scalar_common_2[12])), Globals0_21, &Globals_22);
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_22, (MR_Integer) 393, &OptFormatCalls_31);
    libs__globals__lookup_bool_option_3_p_0(Globals_22, (MR_Integer) 208, &ExecTrace_32);
