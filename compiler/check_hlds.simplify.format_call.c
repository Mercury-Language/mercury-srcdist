...
{
  {
    ...
    {
      libs__globals__set_option_4_p_0((MR_Integer) 161, (MR_Word) MR_mkword(MR_mktag(3), &check_hlds__simplify__format_call_scalar_common_2[12]), check_hlds__simplify__format_call__Globals0_21, &check_hlds__simplify__format_call__Globals_22);
    }
    {
    ...
    {
      libs__globals__lookup_bool_option_3_p_0(check_hlds__simplify__format_call__Globals_22, (MR_Integer) 370, &check_hlds__simplify__format_call__OptFormatCalls_31);
    }
    {
      libs__globals__lookup_bool_option_3_p_0(check_hlds__simplify__format_call__Globals_22, (MR_Integer) 193, &check_hlds__simplify__format_call__ExecTrace_32);
    }
