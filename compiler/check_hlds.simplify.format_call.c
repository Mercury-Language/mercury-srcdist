...
{
  {
    ...
    else
    {
      ...
      mercury__builtin__compare_3_p_0((MR_Word) &check_hlds__simplify__format_call_scalar_common_1[1], &Var_12, ((MR_Box) (ArgX1_4)), ((MR_Box) (ArgY1_5)));
      succeeded = (Var_12 == (MR_Integer) 0);
      succeeded = !(succeeded);
      if (succeeded)
        *HeadVar__1_1 = Var_12;
      else
      {
        ...
        mercury__builtin__compare_3_p_0((MR_Word) &check_hlds__simplify__format_call_scalar_common_1[2], &Var_13, ((MR_Box) (ArgX2_6)), ((MR_Box) (ArgY2_7)));
        ...
        else
        {
          ...
          mercury__builtin__compare_3_p_0((MR_Word) &check_hlds__simplify__format_call_scalar_common_1[3], &Var_14, ((MR_Box) (ArgX3_8)), ((MR_Box) (ArgY3_9)));
          ...
          {
            mercury__builtin__compare_3_p_0((MR_Word) &check_hlds__simplify__format_call_scalar_common_1[4], HeadVar__1_1, ((MR_Box) (ArgX4_10)), ((MR_Box) (ArgY4_11)));
          }
        }
      }
    }
...
{
  {
    ...
    if ((FormatStringResult_41 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
    {
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals_40, (MR_Integer) 44, &WarnUnknownFormatCallsA_45);
    ...
    else
    {
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals_40, (MR_Integer) 44, &WarnUnknownFormatCallsB_56);
    ...
    if (succeeded)
    {
      ...
      if (((MR_tag((MR_Word) MaybeSpecs_66)) == (MR_mktag((MR_Integer) 1))))
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_40, (MR_Integer) 42, &WarnKnownBadFormatCalls_69);
          ...
          case (MR_Integer) 1:
            {
              ...
              libs__globals__lookup_bool_option_3_p_0(Globals_40, (MR_Integer) 43, &WarnOnlyOneFormatStringError_71);
...
{
  {
    ...
    libs__globals__set_option_4_p_0((MR_Integer) 165, (MR_Word) MR_mkword(MR_mktag(3), &check_hlds__simplify__format_call_scalar_common_2[12]), Globals0_21, &Globals_22);
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_22, (MR_Integer) 378, &OptFormatCalls_31);
    libs__globals__lookup_bool_option_3_p_0(Globals_22, (MR_Integer) 198, &ExecTrace_32);
            ...
            case (MR_Integer) 4:
              {
                ...
                Disjuncts_224 = mercury__list__map_2_f_0((MR_Word) &hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_case_0, (MR_Word) &hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_hlds_goal_0, (MR_Word) &check_hlds__simplify__format_call_scalar_common_1[7], Cases_47);
