...
{
  {
    ...
    {
      libs__globals__lookup_bool_option_3_p_0(check_hlds__simplify__format_call__Globals_22, (MR_Integer) 376, &check_hlds__simplify__format_call__OptFormatCalls_31);
    }
    {
      libs__globals__lookup_bool_option_3_p_0(check_hlds__simplify__format_call__Globals_22, (MR_Integer) 196, &check_hlds__simplify__format_call__ExecTrace_32);
    }
