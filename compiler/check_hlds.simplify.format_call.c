  ...
  MR_Word * STATE_VARIABLE_VarTable_57)
{
  ...
  libs__globals__set_option_4_p_0((MR_Integer) 736, (MR_Word) (MR_mkword(3, &check_hlds__simplify__format_call_scalar_common_2[10])), Globals0_22, &Globals_23);
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_23, (MR_Integer) 234, &WarnUnknownFormatBool_29);
