...
{
  {
    ...
    else
    {
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals_40, (MR_Integer) 46, &WarnUnknownFormatCallsB_55);
    ...
    if (succeeded)
    {
      ...
      if (((MR_tag((MR_Word) MaybeSpecs_64)) == (MR_Integer) 1))
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_40, (MR_Integer) 44, &WarnKnownBadFormatCalls_67);
          ...
          case (MR_Integer) 1:
            {
              ...
              libs__globals__lookup_bool_option_3_p_0(Globals_40, (MR_Integer) 45, &WarnOnlyOneFormatStringError_69);
...
{
  {
    ...
    libs__globals__set_option_4_p_0((MR_Integer) 185, (MR_Word) (MR_mkword(MR_mktag(3), &check_hlds__simplify__format_call_scalar_common_2[7])), Globals0_21, &Globals_22);
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_22, (MR_Integer) 223, &ExecTrace_34);
