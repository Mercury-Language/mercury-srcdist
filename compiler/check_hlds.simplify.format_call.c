      ...
      case (MR_Integer) 1:
        {
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              ...
              succeeded = parse_tree__set_of_var__remove_3_p_0(TypeCtorInfo_227_227, LHSVar_50, STATE_VARIABLE_ToDeleteVars_0_112, &STATE_VARIABLE_ToDeleteVars_125_125);
            }
          }
          if (succeeded)
          {
              ...
              if (succeeded)
              {
                ...
                if (succeeded)
                {
                  ...
                  if (succeeded)
                  {
                    ...
                    succeeded = parse_tree__set_of_var__remove_3_p_0(TypeCtorInfo_236_236, TermVar_89, STATE_VARIABLE_ToDeleteVars_0_112, &STATE_VARIABLE_ToDeleteVars_157_157);
                  }
                }
              }
              if (succeeded)
              ...
              if (succeeded)
              {
                ...
                else
                {
                  ...
                  *FormattedValuesVar_14 = Var_64;
                  ...
                  Var_34 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Var_65, (MR_Integer) 1))));
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                ...
                {
                  MR_Word Var_27 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Var_73, (MR_Integer) 1))));
