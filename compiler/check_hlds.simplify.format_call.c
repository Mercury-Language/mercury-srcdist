  ...
  MR_Word * STATE_VARIABLE_VarTable_57)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_23, (MR_Integer) 252, &WarnUnknownFormatBool_29);
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_23, (MR_Integer) 50, &ExecTrace_42);
