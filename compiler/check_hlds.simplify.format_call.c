...
{
  {
    ...
    if ((FormatStringResult_41 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals_40, (MR_Integer) 47, &WarnUnknownFormatCallsA_45);
    ...
    else
    {
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals_40, (MR_Integer) 47, &WarnUnknownFormatCallsB_55);
    ...
    if (succeeded)
    {
      ...
      if (((MR_tag((MR_Word) MaybeSpecs_64)) == (MR_Integer) 1))
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_40, (MR_Integer) 45, &WarnKnownBadFormatCalls_67);
          ...
          case (MR_Integer) 1:
            {
              ...
              libs__globals__lookup_bool_option_3_p_0(Globals_40, (MR_Integer) 46, &WarnOnlyOneFormatStringError_69);
...
{
  {
    ...
    libs__globals__set_option_4_p_0((MR_Integer) 186, (MR_Word) (MR_mkword(MR_mktag(3), &check_hlds__simplify__format_call_scalar_common_2[7])), Globals0_21, &Globals_22);
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_22, (MR_Integer) 224, &ExecTrace_34);
