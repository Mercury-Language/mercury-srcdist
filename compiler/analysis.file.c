  ...
  MR_Word ModuleResults_10)
{
  ...
  libs__globals__lookup_string_option_3_p_0(Globals_8, (MR_Integer) 708, &CacheDir_16);
  ...
  MR_Word * Specs_12)
{
  ...
  else
  {
    ...
    libs__globals__lookup_string_option_3_p_0(Globals_9, (MR_Integer) 708, &CacheDir_17);
