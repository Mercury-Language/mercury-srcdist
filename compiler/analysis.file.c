                                                    ...
                                                    if (analysis__file__succeeded)
                                                      {
                                                        ...
                                                        {
                                                          analysis__file__succeeded = parse_tree__parse_sym_name__try_parse_sym_name_and_no_args_2_p_0(analysis__file__TypeCtorInfo_5_82, analysis__file__DependentModuleTerm_8, &analysis__file__DependentModule_20);
                                                        }
                                                        if (analysis__file__succeeded)
                                                          {
                                                            {
                                                    ...
                                                    if (analysis__file__succeeded)
                                                      {
                                                        ...
                                                        analysis__file__TypeCtorInfo_5_82 = (MR_Word) &mercury__term__term__type_ctor_info_generic_0;
                                                        {
                                                          analysis__file__succeeded = parse_tree__parse_sym_name__try_parse_sym_name_and_no_args_2_p_0(analysis__file__TypeCtorInfo_5_82, analysis__file__CallerModuleTerm_8, &analysis__file__CallerModule_20);
                                                        }
                                                        if (analysis__file__succeeded)
                                                          {
                                                            {
