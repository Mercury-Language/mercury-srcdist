  ...
  MR_Word ModuleResults_10)
{
  ...
  libs__globals__lookup_string_option_3_p_0(Globals_8, (MR_Integer) 705, &CacheDir_14);
  ...
  MR_Word * ModuleResults_10)
{
  ...
  else
  {
    ...
    libs__globals__lookup_string_option_3_p_0(Globals_8, (MR_Integer) 705, &CacheDir_15);
