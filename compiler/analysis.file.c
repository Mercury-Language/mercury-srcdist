...
{
  {
    ...
    libs__globals__lookup_string_option_3_p_0(Globals_8, (MR_Integer) 710, &CacheDir_14);
...
{
  {
    ...
    else
    {
      ...
      libs__globals__lookup_string_option_3_p_0(Globals_8, (MR_Integer) 710, &CacheDir_15);
