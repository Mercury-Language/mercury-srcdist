  ...
  MR_Word ModuleResults_12)
{
  ...
  libs__globals__lookup_string_option_3_p_0(Globals_10, (MR_Integer) 752, &CacheDir_19);
  ...
  MR_Word * Specs_14)
{
  ...
  else
  {
    ...
    libs__globals__lookup_string_option_3_p_0(Globals_11, (MR_Integer) 752, &CacheDir_20);
