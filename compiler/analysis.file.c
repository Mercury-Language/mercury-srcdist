  ...
  MR_Box * LambdaHeadVar__1_45)
{
  ...
  if (succeeded)
  {
    NumberTerm_63 = ((MR_Word) ((MR_hl_field(MR_mktag(2), TermResult_61, (MR_Integer) 1))));
    Var_66 = (MR_Integer) 6;
    succeeded = mercury__term__decimal_term_to_int_2_p_0((MR_Word) (&mercury__term__term__type_ctor_info_generic_0), NumberTerm_63, &Var_73);
    if (succeeded)
  ...
  MR_Integer * STATE_VARIABLE_State_23)
{
  ...
  if (succeeded)
  {
    ...
    mercury__private_builtin__type_info_from_typeclass_info_3_p_0(TypeClassInfo_for_analysis_36, (MR_Integer) 4, &TypeInfo__38_38);
    libs__pickle__unpickle_5_p_0(TypeInfo__38_38, Unpicklers_9, Handle_10, &Call_17, STATE_VARIABLE_State_25_25, &STATE_VARIABLE_State_29_29);
    mercury__private_builtin__type_info_from_typeclass_info_3_p_0(TypeClassInfo_for_analysis_36, (MR_Integer) 5, &TypeInfo__40_40);
    libs__pickle__unpickle_5_p_0(TypeInfo__40_40, Unpicklers_9, Handle_10, &Answer_19, STATE_VARIABLE_State_29_29, &STATE_VARIABLE_State_31_31);
  ...
  MR_Word Univ_8)
{
  ...
  mercury__private_builtin__type_info_from_typeclass_info_3_p_0(TypeClassInfo_for_analysis_21, (MR_Integer) 4, &TypeInfo__25_25);
  libs__pickle__pickle_5_p_0(TypeInfo__25_25, OutputStream_6, Pickles_7, Call_10);
  mercury__private_builtin__type_info_from_typeclass_info_3_p_0(TypeClassInfo_for_analysis_21, (MR_Integer) 5, &TypeInfo__27_27);
  libs__pickle__pickle_5_p_0(TypeInfo__27_27, OutputStream_6, Pickles_7, Answer_11);
  ...
  MR_Word FuncResultList_10)
{
  ...
  mercury__list__sort_2_p_0(TypeInfo_for_T_27, FuncResultList_10, &FuncResultListSorted_12);
  {
    ...
    MR_hl_field(MR_mktag(0), Var_16, 0) = ((MR_Box) (&analysis__file_scalar_common_11[4]));
  ...
  MR_Word FuncResults_8)
{
...

  {
    ...
    MR_hl_field(MR_mktag(0), Var_12, 0) = ((MR_Box) (&analysis__file_scalar_common_11[3]));
  ...
  }
  {
    ...
    MR_hl_field(MR_mktag(0), TypeInfo__21_21, 1) = ((MR_Box) (TypeInfo_for_T_14));
  }
  mercury__map__foldl_4_p_2((MR_Word) (&analysis__analysis__type_ctor_info_func_id_0), TypeInfo__21_21, (MR_Word) (&mercury__io__io__type_ctor_info_state_0), Var_12, FuncResults_8, ((MR_Box) ((MR_Integer) 0)), &conv0_STATE_VARIABLE_IO_11);
}
  ...
  MR_Word * STATE_VARIABLE_Arcs_35)
{
  ...
  MR_Word TypeCtorInfo__5_78;
  MR_Word TypeCtorInfo__24_98;
                      ...
                      if (succeeded)
                      {
                        ...
                        if (succeeded)
                        {
                          ...
                          if (succeeded)
                          {
                            ...
                            TypeCtorInfo__5_78 = (MR_Word) (&mercury__term__term__type_ctor_info_generic_0);
                            succeeded = parse_tree__parse_sym_name__try_parse_sym_name_and_no_args_2_p_0(TypeCtorInfo__5_78, DependentModuleTerm_8, &DependentModule_21);
                            if (succeeded)
                            {
                              succeeded = ((MR_tag((MR_Word) FuncIdTerm_13)) == (MR_Integer) 0);
                              if (succeeded)
                              {
                                Var_90 = ((MR_Word) ((MR_hl_field(MR_mktag(0), FuncIdTerm_13, (MR_Integer) 0))));
                                Var_91 = ((MR_Word) ((MR_hl_field(MR_mktag(0), FuncIdTerm_13, (MR_Integer) 1))));
                                succeeded = ((MR_tag((MR_Word) Var_90)) == (MR_Integer) 0);
                                if (succeeded)
                                {
                                  PF_79 = ((MR_String) ((MR_hl_field(MR_mktag(0), Var_90, (MR_Integer) 0))));
                                  succeeded = (Var_91 != (MR_Word) ((MR_Unsigned) 0U));
                                  if (succeeded)
                                  {
                                    NameTerm_80 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Var_91, (MR_Integer) 0))));
                                    Var_92 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Var_91, (MR_Integer) 1))));
                                    succeeded = (Var_92 != (MR_Word) ((MR_Unsigned) 0U));
                                    if (succeeded)
                                    {
                                      ArityTerm_81 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Var_92, (MR_Integer) 0))));
                                      Var_93 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Var_92, (MR_Integer) 1))));
                                      succeeded = (Var_93 != (MR_Word) ((MR_Unsigned) 0U));
                                      if (succeeded)
                                      {
                                        ProcTerm_82 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Var_93, (MR_Integer) 0))));
                                        ...
                                        if (succeeded)
                                        {
                                          ...
                                          if (succeeded)
                                          {
                                            ...
                                            if (succeeded)
                                            {
                                              Var_95 = ((MR_Word) ((MR_hl_field(MR_mktag(0), NameTerm_80, (MR_Integer) 0))));
                                              Var_96 = ((MR_Word) ((MR_hl_field(MR_mktag(0), NameTerm_80, (MR_Integer) 1))));
                                              ...
                                              if (succeeded)
                                              {
                                                ...
                                                if (succeeded)
                                                {
                                                  Name_85 = ((MR_String) ((MR_hl_field(MR_mktag(0), Var_95, (MR_Integer) 0))));
                                                  TypeCtorInfo__24_98 = (MR_Word) (&mercury__term__term__type_ctor_info_generic_0);
                                                  succeeded = mercury__term__decimal_term_to_int_2_p_0(TypeCtorInfo__24_98, ArityTerm_81, &Arity_87);
                                                  if (succeeded)
                                                  {
                                                    succeeded = mercury__term__decimal_term_to_int_2_p_0(TypeCtorInfo__24_98, ProcTerm_82, &ProcIdInt_88);
                                                    if (succeeded)
                                                    {
                                                      ...
                                                      Var_97 = (MR_Word) (Arity_87);
                                                      {
                                                        ...
                                                        MR_hl_field(MR_mktag(0), FuncId_22, 0) = (MR_Box) ((MR_Unsigned) (PredOrFunc_84));
                                                        MR_hl_field(MR_mktag(0), FuncId_22, 1) = ((MR_Box) (Name_85));
                                                        MR_hl_field(MR_mktag(0), FuncId_22, 2) = ((MR_Box) (Var_97));
                                                        MR_hl_field(MR_mktag(0), FuncId_22, 3) = ((MR_Box) (ProcId_89));
                                                      }
                      ...
                      if (succeeded)
                      {
                        ...
                        if (succeeded)
                        {
                          ...
                          if (succeeded)
                          {
                            TypeClassInfo_for_analysis_57 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Analysis_16, (MR_Integer) 0))));
                            TypeCtorInfo__5_78 = (MR_Word) (&mercury__term__term__type_ctor_info_generic_0);
                            succeeded = parse_tree__parse_sym_name__try_parse_sym_name_and_no_args_2_p_0(TypeCtorInfo__5_78, CallerModuleTerm_8, &CallerModule_21);
                            if (succeeded)
                            {
                              succeeded = ((MR_tag((MR_Word) FuncIdTerm_13)) == (MR_Integer) 0);
                              if (succeeded)
                    ...
                    if (succeeded)
                    {
                      ...
                      if (succeeded)
                      {
                        ...
                        if (succeeded)
                        {
                          ...
                          if (succeeded)
                          {
                            Var_91 = ((MR_Word) ((MR_hl_field(MR_mktag(0), FuncIdTerm_10, (MR_Integer) 0))));
                            Var_92 = ((MR_Word) ((MR_hl_field(MR_mktag(0), FuncIdTerm_10, (MR_Integer) 1))));
                            succeeded = ((MR_tag((MR_Word) Var_91)) == (MR_Integer) 0);
                            if (succeeded)
                            {
                              PF_80 = ((MR_String) ((MR_hl_field(MR_mktag(0), Var_91, (MR_Integer) 0))));
                              succeeded = (Var_92 != (MR_Word) ((MR_Unsigned) 0U));
                              if (succeeded)
                              {
                                NameTerm_81 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Var_92, (MR_Integer) 0))));
                                Var_93 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Var_92, (MR_Integer) 1))));
                                succeeded = (Var_93 != (MR_Word) ((MR_Unsigned) 0U));
                                if (succeeded)
                                {
                                  ArityTerm_82 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Var_93, (MR_Integer) 0))));
                                  Var_94 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Var_93, (MR_Integer) 1))));
                                  succeeded = (Var_94 != (MR_Word) ((MR_Unsigned) 0U));
                                  if (succeeded)
                                  {
                                    ProcTerm_83 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Var_94, (MR_Integer) 0))));
                                    ...
                                    if (succeeded)
                                    {
                                      ...
                                      if (succeeded)
                                      {
                                        ...
                                        if (succeeded)
                                        {
                                          Var_96 = ((MR_Word) ((MR_hl_field(MR_mktag(0), NameTerm_81, (MR_Integer) 0))));
                                          Var_97 = ((MR_Word) ((MR_hl_field(MR_mktag(0), NameTerm_81, (MR_Integer) 1))));
                                          ...
                                          if (succeeded)
                                          {
                                            ...
                                            if (succeeded)
                                            {
                                              Name_86 = ((MR_String) ((MR_hl_field(MR_mktag(0), Var_96, (MR_Integer) 0))));
                                              TypeCtorInfo__24_99 = (MR_Word) (&mercury__term__term__type_ctor_info_generic_0);
                                              succeeded = mercury__term__decimal_term_to_int_2_p_0(TypeCtorInfo__24_99, ArityTerm_82, &Arity_88);
                                              if (succeeded)
                                              {
                                                succeeded = mercury__term__decimal_term_to_int_2_p_0(TypeCtorInfo__24_99, ProcTerm_83, &ProcIdInt_89);
                                                if (succeeded)
                                                {
                                                  ...
                                                  {
                                                    FuncId_22 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
                                                    MR_hl_field(MR_mktag(0), FuncId_22, 0) = (MR_Box) ((MR_Unsigned) (PredOrFunc_85));
                                                    MR_hl_field(MR_mktag(0), FuncId_22, 1) = ((MR_Box) (Name_86));
                                                    MR_hl_field(MR_mktag(0), FuncId_22, 2) = ((MR_Box) (Var_98));
                                                    MR_hl_field(MR_mktag(0), FuncId_22, 3) = ((MR_Box) (ProcId_90));
                                                  }
  ...
  MR_Word ModuleEntries_10)
{
...

  {
    ...
    MR_hl_field(MR_mktag(0), Var_17, 0) = ((MR_Box) (&analysis__file_scalar_common_11[2]));
  ...
  func_0 = ((void MR_CALL (*)(MR_Box, MR_Box, MR_Box, MR_Box, MR_Box, MR_Box *, MR_Box, MR_Box *)) ((MR_hl_field(MR_mktag(0), (MR_hl_field(MR_mktag(0), TypeClassInfo_for_compiler_45, (MR_Integer) 0)), (MR_Integer) 9))));
  ...
  {
    MR_Word IOError_55 = ((MR_Word) ((MR_hl_field(MR_mktag(1), OpenResult_51, (MR_Integer) 0))));
    MR_String Var_58;
    MR_String Var_60;
    MR_String Var_61;
    MR_String Var_63;

    Var_63 = mercury__io__error_message_1_f_0(IOError_55);
    Var_61 = mercury__string__f_43_43_2_f_0((MR_String) "\' for output: ", Var_63);
    Var_60 = mercury__string__f_43_43_2_f_0(WriteFileName_48, Var_61);
    Var_58 = mercury__string__f_43_43_2_f_0((MR_String) "error opening \140", Var_60);
    {
      mercury__require__unexpected_2_p_0((MR_String) "predicate \140analysis.file.write_analysis_file\'/5", Var_58);
      return;
    }
  }
  else
  {
    MR_Word Stream_52 = ((MR_Word) ((MR_hl_field(MR_mktag(0), OpenResult_51, (MR_Integer) 0))));
    MR_Word OldOutput_53;
    MR_Word Var_71;
    MR_Box conv3_STATE_VARIABLE_IO_30_69;
    MR_Word Var_54;
    ...
    mercury__io__write_string_3_p_0((MR_String) ".\n");
    {
      ...
      MR_hl_field(MR_mktag(0), Var_71, 0) = ((MR_Box) (&analysis__file_scalar_common_7[1]));
      MR_hl_field(MR_mktag(0), Var_71, 1) = ((MR_Box) (analysis__file__write_module_imdg_6_p_0_2));
      MR_hl_field(MR_mktag(0), Var_71, 2) = ((MR_Box) ((MR_Integer) 2));
      MR_hl_field(MR_mktag(0), Var_71, 3) = ((MR_Box) (&analysis__analysis__type_ctor_info_imdg_arc_0));
      MR_hl_field(MR_mktag(0), Var_71, 4) = ((MR_Box) (Var_17));
    }
    mercury__map__foldl_4_p_2((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&analysis__file_scalar_common_2[4]), (MR_Word) (&mercury__io__io__type_ctor_info_state_0), Var_71, ModuleEntries_10, ((MR_Box) ((MR_Integer) 0)), &conv3_STATE_VARIABLE_IO_30_69);
  ...
  MR_Word * ModuleEntries_10)
{
  ...
  {
    MR_String Message_49 = ((MR_String) ((MR_hl_field(MR_mktag(1), MaybeAnalysisFileName_47, (MR_Integer) 0))));
    MR_Word Var_51;

    {
      Var_51 = (MR_Word) MR_new_object(MR_Word, (6 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), Var_51, 0) = ((MR_Box) (&analysis__file_scalar_common_6[4]));
      MR_hl_field(MR_mktag(0), Var_51, 1) = ((MR_Box) (analysis__file__read_module_imdg_6_p_0_2));
      MR_hl_field(MR_mktag(0), Var_51, 2) = ((MR_Box) ((MR_Integer) 3));
      MR_hl_field(MR_mktag(0), Var_51, 3) = ((MR_Box) (Var_16));
      MR_hl_field(MR_mktag(0), Var_51, 4) = ((MR_Box) (ModuleName_9));
      MR_hl_field(MR_mktag(0), Var_51, 5) = ((MR_Box) (Message_49));
    }
  ...
  {
    MR_String AnalysisFileName_48 = ((MR_String) ((MR_hl_field(MR_mktag(0), MaybeAnalysisFileName_47, (MR_Integer) 0))));
    ...
    if (((MR_tag((MR_Word) OpenResult_52)) == (MR_Integer) 1))
    {
...

      {
        ...
        MR_hl_field(MR_mktag(0), Var_56, 0) = ((MR_Box) (&analysis__file_scalar_common_4[0]));
        MR_hl_field(MR_mktag(0), Var_56, 1) = ((MR_Box) (analysis__file__read_module_imdg_6_p_0_3));
        MR_hl_field(MR_mktag(0), Var_56, 2) = ((MR_Box) ((MR_Integer) 1));
        MR_hl_field(MR_mktag(0), Var_56, 3) = ((MR_Box) (AnalysisFileName_48));
      }
    ...
    {
      MR_Word Stream_53 = ((MR_Word) ((MR_hl_field(MR_mktag(0), OpenResult_52, (MR_Integer) 0))));
      MR_Word Result_54;
      MR_Word Var_57;
      MR_Word Var_59;

      {
        ...
        MR_hl_field(MR_mktag(0), Var_57, 0) = ((MR_Box) (&analysis__file_scalar_common_4[0]));
        MR_hl_field(MR_mktag(0), Var_57, 1) = ((MR_Box) (analysis__file__read_module_imdg_6_p_0_4));
        MR_hl_field(MR_mktag(0), Var_57, 2) = ((MR_Box) ((MR_Integer) 1));
        MR_hl_field(MR_mktag(0), Var_57, 3) = ((MR_Box) (AnalysisFileName_48));
      }
      analysis__debug_msg_3_p_0(Var_57);
      {
        Var_59 = (MR_Word) MR_new_object(MR_Word, (7 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), Var_59, 0) = ((MR_Box) (&analysis__file_scalar_common_11[0]));
        MR_hl_field(MR_mktag(0), Var_59, 1) = ((MR_Box) (analysis__file__read_module_imdg_6_p_0_5));
        MR_hl_field(MR_mktag(0), Var_59, 2) = ((MR_Box) ((MR_Integer) 4));
        MR_hl_field(MR_mktag(0), Var_59, 3) = ((MR_Box) (&analysis__file_scalar_common_2[5]));
        MR_hl_field(MR_mktag(0), Var_59, 4) = ((MR_Box) (Var_15));
        MR_hl_field(MR_mktag(0), Var_59, 5) = ((MR_Box) (Var_17));
        MR_hl_field(MR_mktag(0), Var_59, 6) = ((MR_Box) (Stream_53));
      }
      mercury__exception__try_io_4_p_0((MR_Word) (&analysis__file_scalar_common_2[5]), Var_59, &Result_54);
      ...
      if (((MR_tag((MR_Word) Result_54)) == (MR_Integer) 2))
        ...
        *ModuleEntries_10 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Result_54, (MR_Integer) 0))));
    }
  }
}
    ...
    if (succeeded)
    {
      ...
      else
      {
        ...
        mercury__io__set_output_stream_4_p_0(AppendStream_20, &OldOutputStream_21);
        {
          ...
          MR_hl_field(MR_mktag(0), Var_47, 0) = ((MR_Box) (&analysis__file_scalar_common_11[1]));
          MR_hl_field(MR_mktag(0), Var_47, 1) = ((MR_Box) (analysis__file__write_module_analysis_requests_6_p_0_2));
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(0), Var_80, 0) = ((MR_Box) (&analysis__file_scalar_common_7[1]));
          ...
          MR_hl_field(MR_mktag(0), Var_80, 3) = ((MR_Box) (&analysis__analysis__type_ctor_info_analysis_request_0));
          MR_hl_field(MR_mktag(0), Var_80, 4) = ((MR_Box) (Var_47));
        }
    ...
    case (MR_Integer) 0:
      {
...

        {
          ...
          MR_hl_field(MR_mktag(0), Var_51, 0) = ((MR_Box) (&analysis__file_scalar_common_11[1]));
          MR_hl_field(MR_mktag(0), Var_51, 1) = ((MR_Box) (analysis__file__write_module_analysis_requests_6_p_0_4));
        ...
        {
          MR_Word IOError_92 = ((MR_Word) ((MR_hl_field(MR_mktag(1), OpenResult_88, (MR_Integer) 0))));
          MR_String Var_95;
          MR_String Var_97;
          MR_String Var_98;
          MR_String Var_100;

          Var_100 = mercury__io__error_message_1_f_0(IOError_92);
          Var_98 = mercury__string__f_43_43_2_f_0((MR_String) "\' for output: ", Var_100);
          Var_97 = mercury__string__f_43_43_2_f_0(AnalysisFileName_13, Var_98);
          Var_95 = mercury__string__f_43_43_2_f_0((MR_String) "error opening \140", Var_97);
          {
            mercury__require__unexpected_2_p_0((MR_String) "predicate \140analysis.file.write_analysis_file\'/5", Var_95);
            return;
          }
        }
        else
        {
          MR_Word Stream_89 = ((MR_Word) ((MR_hl_field(MR_mktag(0), OpenResult_88, (MR_Integer) 0))));
          MR_Word OldOutput_90;
          MR_Word Var_108;
          MR_Box conv4_STATE_VARIABLE_IO_30_106;
          MR_Word Var_91;
          ...
          mercury__io__write_string_3_p_0((MR_String) ".\n");
          {
            ...
            MR_hl_field(MR_mktag(0), Var_108, 0) = ((MR_Box) (&analysis__file_scalar_common_7[1]));
            MR_hl_field(MR_mktag(0), Var_108, 1) = ((MR_Box) (analysis__file__write_module_analysis_requests_6_p_0_5));
            MR_hl_field(MR_mktag(0), Var_108, 2) = ((MR_Box) ((MR_Integer) 2));
            MR_hl_field(MR_mktag(0), Var_108, 3) = ((MR_Box) (&analysis__analysis__type_ctor_info_analysis_request_0));
            MR_hl_field(MR_mktag(0), Var_108, 4) = ((MR_Box) (Var_51));
          }
          mercury__map__foldl_4_p_2((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&analysis__file_scalar_common_2[2]), (MR_Word) (&mercury__io__io__type_ctor_info_state_0), Var_108, ModuleRequests_10, ((MR_Box) ((MR_Integer) 0)), &conv4_STATE_VARIABLE_IO_30_106);
  ...
  MR_Word * ModuleRequests_10)
{
  ...
  {
    Var_15 = (MR_Word) MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(MR_mktag(0), Var_15, 0) = ((MR_Box) (&analysis__file_scalar_common_6[3]));
  ...
  if (((MR_tag((MR_Word) MaybeAnalysisFileName_47)) == (MR_Integer) 1))
  {
...

    {
      Var_51 = (MR_Word) MR_new_object(MR_Word, (6 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), Var_51, 0) = ((MR_Box) (&analysis__file_scalar_common_6[4]));
      MR_hl_field(MR_mktag(0), Var_51, 1) = ((MR_Box) (analysis__file__read_module_analysis_requests_6_p_0_2));
      MR_hl_field(MR_mktag(0), Var_51, 2) = ((MR_Box) ((MR_Integer) 3));
      MR_hl_field(MR_mktag(0), Var_51, 3) = ((MR_Box) (Var_16));
      MR_hl_field(MR_mktag(0), Var_51, 4) = ((MR_Box) (ModuleName_9));
      MR_hl_field(MR_mktag(0), Var_51, 5) = ((MR_Box) (Message_49));
  ...
  else
  {
    ...
    if (((MR_tag((MR_Word) OpenResult_52)) == (MR_Integer) 1))
    {
...

      {
        Var_56 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), Var_56, 0) = ((MR_Box) (&analysis__file_scalar_common_4[0]));
        MR_hl_field(MR_mktag(0), Var_56, 1) = ((MR_Box) (analysis__file__read_module_analysis_requests_6_p_0_3));
        MR_hl_field(MR_mktag(0), Var_56, 2) = ((MR_Box) ((MR_Integer) 1));
        MR_hl_field(MR_mktag(0), Var_56, 3) = ((MR_Box) (AnalysisFileName_48));
      }
      analysis__debug_msg_3_p_0(Var_56);
    ...
    else
    {
...

      {
        Var_57 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), Var_57, 0) = ((MR_Box) (&analysis__file_scalar_common_4[0]));
        MR_hl_field(MR_mktag(0), Var_57, 1) = ((MR_Box) (analysis__file__read_module_analysis_requests_6_p_0_4));
        MR_hl_field(MR_mktag(0), Var_57, 2) = ((MR_Box) ((MR_Integer) 1));
        MR_hl_field(MR_mktag(0), Var_57, 3) = ((MR_Box) (AnalysisFileName_48));
      }
      analysis__debug_msg_3_p_0(Var_57);
      {
        Var_59 = (MR_Word) MR_new_object(MR_Word, (7 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), Var_59, 0) = ((MR_Box) (&analysis__file_scalar_common_11[0]));
        MR_hl_field(MR_mktag(0), Var_59, 1) = ((MR_Box) (analysis__file__read_module_analysis_requests_6_p_0_5));
        MR_hl_field(MR_mktag(0), Var_59, 2) = ((MR_Box) ((MR_Integer) 4));
        MR_hl_field(MR_mktag(0), Var_59, 3) = ((MR_Box) (&analysis__file_scalar_common_2[3]));
        MR_hl_field(MR_mktag(0), Var_59, 4) = ((MR_Box) (Var_15));
        MR_hl_field(MR_mktag(0), Var_59, 5) = ((MR_Box) (Var_17));
        MR_hl_field(MR_mktag(0), Var_59, 6) = ((MR_Box) (Stream_53));
      }
      mercury__exception__try_io_4_p_0((MR_Word) (&analysis__file_scalar_common_2[3]), Var_59, &Result_54);
      mercury__io__close_input_3_p_0(Stream_53);
      if (((MR_tag((MR_Word) Result_54)) == (MR_Integer) 2))
        {
        ...
        *ModuleRequests_10 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Result_54, (MR_Integer) 0))));
    }
  }
}
  ...
  MR_Word ModuleResults_10)
{
  ...
  func_0 = ((void MR_CALL (*)(MR_Box, MR_Box, MR_Box, MR_Box, MR_Box, MR_Box *, MR_Box, MR_Box *)) ((MR_hl_field(MR_mktag(0), (MR_hl_field(MR_mktag(0), TypeClassInfo_for_compiler_49, (MR_Integer) 0)), (MR_Integer) 9))));
  ...
  {
    MR_Word IOError_64 = ((MR_Word) ((MR_hl_field(MR_mktag(1), OpenResult_60, (MR_Integer) 0))));
    MR_String Var_67;
    MR_String Var_69;
    MR_String Var_70;
    MR_String Var_72;

    Var_72 = mercury__io__error_message_1_f_0(IOError_64);
    Var_70 = mercury__string__f_43_43_2_f_0((MR_String) "\' for output: ", Var_72);
    Var_69 = mercury__string__f_43_43_2_f_0(WriteFileName_57, Var_70);
    Var_67 = mercury__string__f_43_43_2_f_0((MR_String) "error opening \140", Var_69);
    {
      mercury__require__unexpected_2_p_0((MR_String) "predicate \140analysis.file.write_analysis_file\'/5", Var_67);
      return;
    }
  }
  else
  {
    MR_Word Stream_61 = ((MR_Word) ((MR_hl_field(MR_mktag(0), OpenResult_60, (MR_Integer) 0))));
    MR_Word OldOutput_62;
    MR_Box conv3_STATE_VARIABLE_IO_30_78;
    MR_Word Var_63;

    mercury__io__set_output_stream_4_p_0(Stream_61, &OldOutput_62);
    mercury__io__write_int_3_p_0((MR_Integer) 6);
    mercury__io__write_string_3_p_0((MR_String) ".\n");
    mercury__map__foldl_4_p_2((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&analysis__file_scalar_common_2[0]), (MR_Word) (&mercury__io__io__type_ctor_info_state_0), (MR_Word) (&analysis__file_scalar_common_10[0]), ModuleResults_10, ((MR_Box) ((MR_Integer) 0)), &conv3_STATE_VARIABLE_IO_30_78);
  ...
  MR_Word * ModuleResults_10)
{
  ...
  else
  {
    ...
    else
    {
      ...
      MR_String EscFileName_72;
      MR_Word AnalysisTime_19;
      MR_Word CacheTime_20;
      MR_Word Var_69;

      Components_71 = mercury__string__split_at_separator_2_f_0((MR_Word) (&analysis__file_scalar_common_2[7]), AnalysisFileName_14);
      EscFileName_72 = mercury__string__join_list_2_f_0((MR_String) ":", Components_71);
      CacheFileName_16 = mercury__dir__f_slash_2_f_0(CacheDir_15, EscFileName_72);
      ...
      if (succeeded)
      {
        ...
        Type_75 = mercury__type_desc__type_ctor_1_f_0(Var_80);
        {
          ...
          MR_hl_field(MR_mktag(0), Var_81, 0) = ((MR_Box) (&analysis__file_scalar_common_9[0]));
          MR_hl_field(MR_mktag(0), Var_81, 1) = ((MR_Box) (analysis__file__read_module_analysis_results_6_p_0_2));
          MR_hl_field(MR_mktag(0), Var_81, 2) = ((MR_Box) ((MR_Integer) 2));
          MR_hl_field(MR_mktag(0), Var_81, 3) = ((MR_Box) (TypeClassInfo_for_compiler_57));
          MR_hl_field(MR_mktag(0), Var_81, 4) = Compiler_12;
        }
  ...
  MR_Word ModuleResults_6)
{
  ...
  else
  {
    ...
    MR_Word Var_20;
    MR_Word Type_42;
    MR_Word STATE_VARIABLE_Pickles_5_43;
    MR_Word Var_47;

    STATE_VARIABLE_Pickles_5_43 = libs__pickle__init_picklers_0_f_0();
    Var_47 = mercury__type_desc__type_of_1_f_0((MR_Word) (&analysis__analysis__type_ctor_info_some_analysis_result_0));
    Type_42 = mercury__type_desc__type_ctor_1_f_0(Var_47);
    libs__pickle__register_pickler_4_p_0(Type_42, (MR_Word) (&analysis__file_scalar_common_2[6]), STATE_VARIABLE_Pickles_5_43, &Var_20);
  ...
  MR_Word * ModuleResults_8)
{
  ...
  else
  {
    ...
    if (succeeded)
    {
      NumberTerm_64 = ((MR_Word) ((MR_hl_field(MR_mktag(2), TermResult_62, (MR_Integer) 1))));
      Var_67 = (MR_Integer) 6;
      succeeded = mercury__term__decimal_term_to_int_2_p_0((MR_Word) (&mercury__term__term__type_ctor_info_generic_0), NumberTerm_64, &Var_74);
      if (succeeded)
  ...
  MR_Word * ModuleStatus_10)
{
  ...
  else
  {
    ...
    mercury__io__open_input_4_p_0(FileName_13, &OpenResult_28);
    if (((MR_tag((MR_Word) OpenResult_28)) == (MR_Integer) 1))
    {
      MR_String Var_35;
      MR_Word IOError_46 = ((MR_Word) ((MR_hl_field(MR_mktag(1), OpenResult_28, (MR_Integer) 0))));

      Var_35 = mercury__io__error_message_1_f_0(IOError_46);
      {
        mercury__require__unexpected_2_p_0((MR_String) "predicate \140analysis.file.read_module_overall_status_2\'/4", Var_35);
        return;
      }
    }
    else
    {
      MR_Word Stream_29 = ((MR_Word) ((MR_hl_field(MR_mktag(0), OpenResult_28, (MR_Integer) 0))));
      ...
      switch (MR_tag((MR_Word) ReadResult_30)) {
        ...
        case (MR_Integer) 1:
          {
            MR_String String_31 = ((MR_String) ((MR_hl_field(MR_mktag(1), ReadResult_30, (MR_Integer) 0))));
        ...
        case (MR_Integer) 2:
          {
            MR_Word IOError_32 = ((MR_Word) ((MR_hl_field(MR_mktag(2), ReadResult_30, (MR_Integer) 0))));
            MR_String Var_38;

            Var_38 = mercury__io__error_message_1_f_0(IOError_32);
            {
              mercury__require__unexpected_2_p_0((MR_String) "predicate \140analysis.file.read_module_overall_status_2\'/4", Var_38);
              return;
            }
          }
          break;
