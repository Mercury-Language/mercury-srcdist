  ...
  else
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        MR_Word Type_74;
        MR_Word STATE_VARIABLE_Unpicklers_7_75;
        MR_Word Var_79;
        MR_Word Var_80;

        STATE_VARIABLE_Unpicklers_7_75 = libs__pickle__init_unpicklers_0_f_0();
        Var_79 = mercury__type_desc__type_of_1_f_0((MR_Word) (&analysis__analysis__type_ctor_info_some_analysis_result_0));
        Type_74 = mercury__type_desc__type_ctor_1_f_0(Var_79);
        {
          Var_80 = (MR_Word) MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), Var_80, 0) = ((MR_Box) (&analysis__file_scalar_common_9[0]));
          MR_hl_field(MR_mktag(0), Var_80, 1) = ((MR_Box) (analysis__file__read_module_analysis_results_6_p_0_2));
          MR_hl_field(MR_mktag(0), Var_80, 2) = ((MR_Box) ((MR_Integer) 2));
          MR_hl_field(MR_mktag(0), Var_80, 3) = ((MR_Box) (TypeClassInfo_for_compiler_56));
          MR_hl_field(MR_mktag(0), Var_80, 4) = Compiler_12;
        }
        libs__pickle__register_unpickler_4_p_0(Type_74, Var_80, STATE_VARIABLE_Unpicklers_7_75, &Unpicklers_21);
...
analysis__file__write_module_overall_status_6_p_0(
  ...
  MR_Word Status_10)
{
  MR_Word TypeClassInfo_for_compiler_39 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Info_7, (MR_Integer) 0))));
  MR_String FileName_12;
  ...
  func_0(((MR_Box) (TypeClassInfo_for_compiler_39)), Var_18, ((MR_Box) (Globals_8)), ((MR_Box) (((MR_Box) ((MR_String) ".analysis_status")))), ((MR_Box) (ModuleName_9)), &conv2_FileName_12, ((MR_Box) ((MR_Integer) 0)), &conv1_STATE_VARIABLE_IO_20_20);
  FileName_12 = ((MR_String) (conv2_FileName_12));
  ...
  MR_Word * ModuleStatus_10)
{
  ...
  else
  {
    ...
    {
      MR_String Var_34;
      MR_Word IOError_45 = ((MR_Word) ((MR_hl_field(MR_mktag(1), OpenResult_27, (MR_Integer) 0))));

      Var_34 = mercury__io__error_message_1_f_0(IOError_45);
      {
        mercury__require__unexpected_2_p_0((MR_String) "predicate \140analysis.file.read_module_overall_status_2\'/4", Var_34);
        return;
      }
    }
    else
    {
      MR_Word Stream_28 = ((MR_Word) ((MR_hl_field(MR_mktag(0), OpenResult_27, (MR_Integer) 0))));
      ...
      switch (MR_tag((MR_Word) ReadResult_29)) {
        ...
        case (MR_Integer) 1:
          {
            MR_String String_30 = ((MR_String) ((MR_hl_field(MR_mktag(1), ReadResult_29, (MR_Integer) 0))));
        ...
        case (MR_Integer) 2:
          {
            MR_Word IOError_31 = ((MR_Word) ((MR_hl_field(MR_mktag(2), ReadResult_29, (MR_Integer) 0))));
            MR_String Var_37;

            Var_37 = mercury__io__error_message_1_f_0(IOError_31);
            {
              mercury__require__unexpected_2_p_0((MR_String) "predicate \140analysis.file.read_module_overall_status_2\'/4", Var_37);
              return;
            }
          }
          break;
