...
{
  {
    ...
    if (analysis__file__succeeded)
      *analysis__file__HeadVar__1_1 = (MR_Integer) 0;
      ...
      {
        MR_String analysis__file__Var_4 = (MR_String) analysis__file__HeadVar__2_2;
        MR_String analysis__file__Var_5 = (MR_String) analysis__file__HeadVar__3_3;

        {
          mercury__private_builtin__builtin_compare_string_3_p_0(analysis__file__HeadVar__1_1, analysis__file__Var_4, analysis__file__Var_5);
        }
      }
  }
}
...
{
  {
    ...
    if (analysis__file__succeeded)
      ...
      {
        MR_String analysis__file__Var_3 = (MR_String) analysis__file__HeadVar__1_1;
        MR_String analysis__file__Var_4 = (MR_String) analysis__file__HeadVar__2_2;

        analysis__file__succeeded = (strcmp(analysis__file__Var_3, analysis__file__Var_4) == 0);
      }
    return analysis__file__succeeded;
  }
}
