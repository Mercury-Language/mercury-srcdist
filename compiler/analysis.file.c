                                            ...
                                            if (succeeded)
                                            {
                                              ...
                                              if (succeeded)
                                              {
                                                ...
                                                if (succeeded)
                                                {
                                                  ...
                                                  succeeded = mercury__term__decimal_term_to_int_2_p_0(TypeCtorInfo_24_98, ArityTerm_81, &Arity_87);
                                                  if (succeeded)
                                                  {
                                                    succeeded = mercury__term__decimal_term_to_int_2_p_0(TypeCtorInfo_24_98, ProcTerm_82, &ProcIdInt_88);
                                                    if (succeeded)
                                                    {
                                        ...
                                        if (succeeded)
                                        {
                                          ...
                                          if (succeeded)
                                          {
                                            ...
                                            if (succeeded)
                                            {
                                              ...
                                              succeeded = mercury__term__decimal_term_to_int_2_p_0(TypeCtorInfo_24_99, ArityTerm_82, &Arity_88);
                                              if (succeeded)
                                              {
                                                succeeded = mercury__term__decimal_term_to_int_2_p_0(TypeCtorInfo_24_99, ProcTerm_83, &ProcIdInt_89);
                                                if (succeeded)
                                                {
