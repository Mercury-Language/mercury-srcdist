...
static void MR_CALL 
analysis__file__IntroducedFrom__pred__write_module_analysis_func__983__1_8_p_0(
  ...
  MR_Word ModuleResults_10)
{
  ...
  libs__globals__lookup_string_option_3_p_0(Globals_8, (MR_Integer) 705, &CacheDir_16);
  ...
  MR_Word * Specs_12)
{
  ...
  else
  {
    ...
    libs__globals__lookup_string_option_3_p_0(Globals_9, (MR_Integer) 705, &CacheDir_17);
