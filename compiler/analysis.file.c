...
{
  {
    ...
    mercury__io__write_string_3_p_0((MR_String) ", ");
    PredOrFunc_60 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), FuncId_9, (MR_Integer) 0))) & (MR_Integer) 1);
    ...
    mercury__term_io__write_term_4_p_0((MR_Word) (&mercury__term__term__type_ctor_info_generic_0), Var_42, Var_43);
    mercury__io__write_string_3_p_0((MR_String) ").\n");
  }
}
...
{
  {
    ...
    *FileName_18 = ((MR_String) (conv2_FileName_18));
    ...
    else
    {
      ...
      {
        TypeInfo_20_70 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
      ...
      {
        TypeInfo_22_72 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
