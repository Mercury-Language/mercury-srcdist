            ...
            case (MR_Integer) 1:
              {
                ...
                succeeded = check_hlds__build_mode_constraints____Unify______maybemaybe_1_1((MR_Word) (&check_hlds__build_mode_constraints_scalar_common_1[4]), Var_159, Var_399);
                if (succeeded)
                {
                  MR_Word Decl_134;
                  MR_Word Var_160;
