...
{
  {
    ...
    check_hlds__build_mode_constraints__prog_var_at_path_7_p_0(ProgVarset_6, PredId_7, HeadVar_8, ((MR_Box) ((MR_Integer) 0)), &Var_10, STATE_VARIABLE_VarInfo_0_11, STATE_VARIABLE_VarInfo_12);
  }
}
...
{
  {
    ...
    else
    {
      ...
      check_hlds__build_mode_constraints__add_goal_expr_constraints_11_p_0(ModuleInfo_8, ProgVarset_18, PredId_9, MainGoal_23, Context_21, ((MR_Box) ((MR_Integer) 0)), Nonlocals_24, STATE_VARIABLE_VarInfo_31_31, STATE_VARIABLE_VarInfo_26, STATE_VARIABLE_Constraints_0_27, STATE_VARIABLE_Constraints_28);
    }
  }
}
