  ...
  MR_Word * STATE_VARIABLE_Constraints_26)
{
  ...
  hlds__hlds_pred__proc_info_get_context_2_p_0(ProcInfo_17, &Context_20);
  {
    ...
    MR_hl_field(MR_mktag(0), Var_49, 0) = ((MR_Box) (&check_hlds__build_mode_constraints_scalar_common_4[0]));
    MR_hl_field(MR_mktag(0), Var_49, 1) = ((MR_Box) (check_hlds__build_mode_constraints__add_mode_decl_constraints_9_p_0_1));
    MR_hl_field(MR_mktag(0), Var_49, 2) = ((MR_Box) ((MR_Integer) 3));
    MR_hl_field(MR_mktag(0), Var_49, 3) = ((MR_Box) (ProgVarset_18));
    MR_hl_field(MR_mktag(0), Var_49, 4) = ((MR_Box) (PredId_11));
    MR_hl_field(MR_mktag(0), Var_49, 5) = ((MR_Box) (((MR_Box) ((MR_Integer) 0))));
  }
  mercury__list__map_foldl_5_p_0((MR_Word) (&check_hlds__build_mode_constraints_scalar_common_1[0]), (MR_Word) (&check_hlds__build_mode_constraints_scalar_common_1[2]), (MR_Word) (&check_hlds__build_mode_constraints__check_hlds__build_mode_constraints__type_ctor_info_mc_var_info_0), Var_49, Args_14, &ArgsAtHead_21, ((MR_Box) (STATE_VARIABLE_VarInfo_0_23)), &conv2_STATE_VARIABLE_VarInfo_24);
  ...
  MR_Word * STATE_VARIABLE_VarInfo_19)
{
...

  {
    ...
    MR_hl_field(MR_mktag(0), Var_34, 0) = ((MR_Box) (ProgVar_10));
    MR_hl_field(MR_mktag(0), Var_34, 1) = ((MR_Box) (PredId_9));
  }
  {
    RepVar_30 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(MR_mktag(0), RepVar_30, 0) = ((MR_Box) (Var_34));
    MR_hl_field(MR_mktag(0), RepVar_30, 1) = ((MR_Box) (GoalId_11));
  }
  succeeded = mercury__bimap__search_3_p_0((MR_Word) (&check_hlds__build_mode_constraints__check_hlds__build_mode_constraints__type_ctor_info_mc_rep_var_0), (MR_Word) (&check_hlds__build_mode_constraints_scalar_common_1[2]), VarMap0_15, ((MR_Box) (RepVar_30)), &conv0_Var_31);
  if (succeeded)
    succeeded = MR_TRUE;
  if (succeeded)
  {
  ...
  {
    MR_String MCVarName_32;
    MR_Word NewMCVar_33;

    MCVarName_32 = check_hlds__build_mode_constraints__rep_var_to_string_2_f_0(ProgVarset_8, RepVar_30);
    mercury__varset__new_named_var_4_p_0((MR_Word) (&check_hlds__abstract_mode_constraints__check_hlds__abstract_mode_constraints__type_ctor_info_mc_type_0), MCVarName_32, &NewMCVar_33, MCVarset0_14, &MCVarset_16);
    mercury__bimap__det_insert_4_p_0((MR_Word) (&check_hlds__build_mode_constraints__check_hlds__build_mode_constraints__type_ctor_info_mc_rep_var_0), (MR_Word) (&check_hlds__build_mode_constraints_scalar_common_1[2]), ((MR_Box) (RepVar_30)), ((MR_Box) (NewMCVar_33)), VarMap0_15, &VarMap_17);
  }
  conv1_MCVar_12 = mercury__bimap__lookup_2_f_0((MR_Word) (&check_hlds__build_mode_constraints__check_hlds__build_mode_constraints__type_ctor_info_mc_rep_var_0), (MR_Word) (&check_hlds__build_mode_constraints_scalar_common_1[2]), VarMap_17, ((MR_Box) (RepVar_30)));
  ...
  MR_Box wrapper_arg_2)
{
  ...
  conv3_LambdaHeadVar__3_37 = check_hlds__build_mode_constraints__IntroducedFrom__func__add_call_headvar_constraints__806__1_2_f_0(((MR_Word) (wrapper_arg_1)), ((MR_Word) (wrapper_arg_2)));
