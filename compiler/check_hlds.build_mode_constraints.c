        ...
        case (MR_Integer) 0:
          {
            ...
            parse_tree__set_of_var__fold_4_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), (MR_Word) (&check_hlds__build_mode_constraints_scalar_common_1[3]), Var_214, Nonlocals_18, ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))), &conv30_NonlocalsAtId_88);
