  ...
  MR_Word * Type_6)
{
  ...
  MR_String Name_7;
  MR_Word Var_13 = ((MR_Word) ((MR_hl_field(0, TypeCtor_4, 0))));
  MR_Integer Var_14 = ((MR_Integer) ((MR_hl_field(0, TypeCtor_4, 1))));
  ...
  if (succeeded)
  {
    ...
    if (succeeded)
    {
      Name_7 = ((MR_String) ((MR_hl_field(0, Var_13, 0))));
  ...
  else
  {
    ...
    else
    {
      ...
      {
        MR_Word SymName_11 = ((MR_Word) ((MR_hl_field(0, TypeCtor_4, 0))));
