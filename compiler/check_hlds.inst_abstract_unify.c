                ...
                *Detism_20 = (MR_Integer) 0;
                {
                  ...
                  MR_hl_field(0, Var_43, 0) = ((MR_Box) (ConsIdB_16));
                  MR_hl_field(0, Var_43, 1) = ((MR_Box) (ArgInsts_26));
                }
                {
    ...
    case (MR_Integer) 1:
      {
        ...
        MR_Word ArgTypes_59;
        MR_Word ArgInsts_60;
        MR_Word UniqA_61 = ((MR_Unsigned) ((MR_hl_field(1, InstA_22, (MR_Integer) 0))) & (MR_Integer) 7);

        check_hlds__inst_util__get_cons_id_arg_types_for_inst_5_p_0(STATE_VARIABLE_ModuleInfo_0_23, Type_12, ConsIdB_16, ArgInstsB_17, &ArgTypes_59);
        switch (Live_13) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 1:
            succeeded = check_hlds__inst_abstract_unify__make_ground_inst_list_9_p_0(Live_13, Real_14, UniqA_61, ArgTypes_59, ArgInstsB_17, &ArgInsts0_35, Detism_20, STATE_VARIABLE_ModuleInfo_0_23, STATE_VARIABLE_ModuleInfo_24);
            break;
          case (MR_Integer) 0:
            succeeded = check_hlds__inst_abstract_unify__make_ground_inst_list_lives_10_p_0(Live_13, Real_14, UniqA_61, ArgTypes_59, ArgLives_18, ArgInstsB_17, &ArgInsts0_35, Detism_20, STATE_VARIABLE_ModuleInfo_0_23, STATE_VARIABLE_ModuleInfo_24);
            break;
        }
        if (succeeded)
        {
          check_hlds__inst_abstract_unify__propagate_ctor_subtypes_into_arg_insts_5_p_0(*STATE_VARIABLE_ModuleInfo_24, Type_12, ConsIdB_16, ArgInsts0_35, &ArgInsts_60);
          ...
          Var_56 = (MR_Word) ((MR_Unsigned) 0U);
          {
            ...
            MR_hl_field(0, Var_55, 0) = ((MR_Box) (ConsIdB_16));
            MR_hl_field(0, Var_55, 1) = ((MR_Box) (ArgInsts_60));
          }
          {
          ...
          }
          {
            ...
            base = (MR_Word) MR_mkword(2, MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
            *Inst_19 = base;
            MR_hl_field(2, base, 0) = (MR_Box) ((MR_Unsigned) (UniqA_61));
          ...
          case (MR_Integer) 1:
            {
...

              {
                ...
                MR_hl_field(0, Var_49, 0) = ((MR_Box) (ConsIdB_16));
                MR_hl_field(0, Var_49, 1) = ((MR_Box) (ArgInstsB_17));
              }
              {
                BoundInstsB_33 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(1, BoundInstsB_33, 0) = ((MR_Box) (Var_49));
        ...
        case (MR_Integer) 2:
          {
            ...
            if (succeeded)
            {
              check_hlds__inst_util__get_cons_id_arg_types_for_inst_5_p_0(STATE_VARIABLE_ModuleInfo_0_23, Type_12, ConsIdB_16, ArgInstsB_17, &ArgTypes_57);
              switch (Live_13) {
                default: /*NOTREACHED*/ MR_assert(0);
                case (MR_Integer) 1:
                  succeeded = check_hlds__inst_abstract_unify__make_any_inst_list_9_p_0(Live_13, Real_14, Uniq_27, ArgTypes_57, ArgInstsB_17, &ArgInsts_58, Detism_20, STATE_VARIABLE_ModuleInfo_0_23, STATE_VARIABLE_ModuleInfo_24);
                  break;
                case (MR_Integer) 0:
                  succeeded = check_hlds__inst_abstract_unify__make_any_inst_list_lives_10_p_0(Live_13, Real_14, Uniq_27, ArgTypes_57, ArgInstsB_17, ArgLives_18, &ArgInsts_58, Detism_20, STATE_VARIABLE_ModuleInfo_0_23, STATE_VARIABLE_ModuleInfo_24);
                  break;
              }
              if (succeeded)
              {
                ...
                Var_48 = (MR_Word) ((MR_Unsigned) 0U);
                {
                  ...
                  MR_hl_field(0, Var_47, 0) = ((MR_Box) (ConsIdB_16));
                  MR_hl_field(0, Var_47, 1) = ((MR_Box) (ArgInsts_58));
                }
                {
                ...
                case (MR_Integer) 2:
                  {
                    ...
                    if (succeeded)
                    {
                      succeeded = check_hlds__inst_test__inst_results_bound_inst_list_is_ground_or_any_3_p_0(STATE_VARIABLE_ModuleInfo_0_52, InstResultsB_19, BoundInstsB_20);
                      if (succeeded)
                      {
                        switch (UniqB_18) {
                          default:
                        ...
                        if (succeeded)
                          check_hlds__inst_util__make_shared_bound_inst_list_5_p_0(Type_10, BoundInstsB_20, &BoundInsts_22, STATE_VARIABLE_ModuleInfo_0_52, STATE_VARIABLE_ModuleInfo_53);
                        else
                        {
            ...
            case (MR_Integer) 2:
              {
                ...
                MR_Word BoundInstsB_158 = ((MR_Word) ((MR_hl_field(2, InstB_14, (MR_Integer) 2))));
                MR_Word Uniq_159;
                ...
                if (succeeded)
                {
                  succeeded = check_hlds__inst_abstract_unify__make_ground_bound_inst_list_9_p_0(Type_10, Live_11, Real_12, UniqA_207, BoundInstsB_158, &BoundInsts_160, &Detism1_161, STATE_VARIABLE_ModuleInfo_0_52, STATE_VARIABLE_ModuleInfo_53);
                  if (succeeded)
                  {
                    Var_97 = (MR_Integer) 1;
                    {
                      ...
                      *Inst_15 = base;
                      ...
                      MR_hl_field(2, base, 2) = ((MR_Box) (BoundInsts_160));
                    }
    ...
    case (MR_Integer) 2:
      {
        ...
        MR_Word BoundInstsA_30 = ((MR_Word) ((MR_hl_field(2, InstA_13, (MR_Integer) 2))));
                    ...
                    case (MR_Integer) 0:
                      {
                        ...
                        if (succeeded)
                        {
                          succeeded = check_hlds__inst_test__inst_results_bound_inst_list_is_ground_or_any_3_p_0(STATE_VARIABLE_ModuleInfo_0_52, InstResultsA_29, BoundInstsA_30);
                          if (succeeded)
                          {
                            check_hlds__inst_util__make_shared_bound_inst_list_5_p_0(Type_10, BoundInstsA_30, &BoundInsts_117, STATE_VARIABLE_ModuleInfo_0_52, STATE_VARIABLE_ModuleInfo_53);
                            succeeded = MR_TRUE;
                          }
                        }
                      }
                    ...
                    *Detism_16 = (MR_Integer) 0;
                    {
                      ...
                      *Inst_15 = base;
                      ...
                      MR_hl_field(2, base, 2) = ((MR_Box) (BoundInsts_117));
                    }
                    succeeded = MR_TRUE;
                  }
                }
                      ...
                      case (MR_Integer) 0:
                        {
                          ...
                          succeeded = check_hlds__inst_abstract_unify__make_ground_bound_inst_list_9_p_0(Type_10, Live_11, Real_12, UniqB_128, BoundInstsA_30, &BoundInsts_125, &Detism1_33, STATE_VARIABLE_ModuleInfo_0_52, STATE_VARIABLE_ModuleInfo_53);
                          if (succeeded)
                          {
                        ...
                        case (MR_Integer) 0:
                          {
                            ...
                            succeeded = check_hlds__inst_abstract_unify__make_ground_bound_inst_list_9_p_0(Type_10, Live_11, Real_12, UniqB_128, BoundInstsA_30, &BoundInsts_122, &Detism1_33, STATE_VARIABLE_ModuleInfo_0_52, STATE_VARIABLE_ModuleInfo_53);
                            if (succeeded)
                            {
                              Var_74 = (MR_Integer) 1;
                              Var_75 = (MR_Integer) 0;
          ...
          case (MR_Integer) 2:
            {
              ...
              MR_Word BoundInstsB_119 = ((MR_Word) ((MR_hl_field(2, InstB_14, (MR_Integer) 2))));
              MR_Word Uniq_120;
              MR_Word BoundInsts_121;

              succeeded = check_hlds__inst_abstract_unify__abstractly_unify_bound_inst_list_9_p_0(Type_10, Live_11, Real_12, BoundInstsA_30, BoundInstsB_119, &BoundInsts_121, Detism_16, STATE_VARIABLE_ModuleInfo_0_52, STATE_VARIABLE_ModuleInfo_53);
              if (succeeded)
              {
                ...
                if (succeeded)
                {
                  Var_71 = (MR_Word) ((MR_Unsigned) 0U);
                  {
                    ...
                    *Inst_15 = base;
                    ...
                    MR_hl_field(2, base, 2) = ((MR_Box) (BoundInsts_121));
                  }
                  succeeded = MR_TRUE;
                }
              }
              ...
              case (MR_Integer) 2:
                {
                  ...
                  {
                    Var_87 = (MR_Integer) 0;
                    succeeded = check_hlds__inst_abstract_unify__make_any_bound_inst_list_9_p_0(Type_10, Var_87, Real_12, UniqB_131, BoundInstsA_30, &BoundInsts_133, &Detism1_134, STATE_VARIABLE_ModuleInfo_0_52, STATE_VARIABLE_ModuleInfo_53);
                    if (succeeded)
                    {
                ...
                case (MR_Integer) 2:
                  {
                    ...
                    MR_Word BoundInstsB_213 = ((MR_Word) ((MR_hl_field(2, InstB_14, (MR_Integer) 2))));
                    MR_Word Uniq_214;
                    MR_Word BoundInsts_215;
                    MR_Word Detism1_217;

                    succeeded = check_hlds__inst_abstract_unify__unify_uniq_6_p_0(Live_11, Real_12, (MR_Integer) 1, UniqA_272, UniqB_212, &Uniq_214);
                    if (succeeded)
                    {
                      succeeded = check_hlds__inst_abstract_unify__make_any_bound_inst_list_9_p_0(Type_10, Live_11, Real_12, UniqA_272, BoundInstsB_213, &BoundInsts_215, &Detism1_217, STATE_VARIABLE_ModuleInfo_0_52, STATE_VARIABLE_ModuleInfo_53);
                      if (succeeded)
                      {
                        ...
                        Var_107 = (MR_Integer) 1;
                        {
                          ...
                          *Inst_15 = base;
                          ...
                          MR_hl_field(2, base, 2) = ((MR_Box) (BoundInsts_215));
                        }
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_9)
{
  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      succeeded = check_hlds__inst_abstract_unify__make_any_bound_inst_list_9_p_0(Type_1, Live_2, Real_3, Uniq_4, BoundInsts0_22, &BoundInsts_24, &Detism2_32, STATE_VARIABLE_ModuleInfo_35_35, STATE_VARIABLE_ModuleInfo_9);
      if (succeeded)
      {
        {
          MR_Word base;
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_9)
{
  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      succeeded = check_hlds__inst_abstract_unify__make_ground_bound_inst_list_9_p_0(Type_1, Live_2, Real_3, Uniq_4, BoundInsts0_22, &BoundInsts_24, &Detism2_32, STATE_VARIABLE_ModuleInfo_35_35, STATE_VARIABLE_ModuleInfo_9);
      if (succeeded)
      {
        {
          MR_Word base;
  ...
  else
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          succeeded = check_hlds__inst_abstract_unify__abstractly_unify_bound_inst_list_2_9_p_0(Type_1, Live_2, Real_3, Var_68, BoundInstsB_38, &BoundInstsTail_49, &Detism2_50, STATE_VARIABLE_ModuleInfo_54_54, STATE_VARIABLE_ModuleInfo_9);
          if (succeeded)
          {
            Var_56 = (MR_Integer) 0;
      ...
      else
      {
        ...
        if (succeeded)
          succeeded = check_hlds__inst_abstract_unify__abstractly_unify_bound_inst_list_2_9_p_0(Type_1, Live_2, Real_3, Var_68, HeadVar__5_5, HeadVar__6_6, &Detism1_64, STATE_VARIABLE_ModuleInfo_0_8, STATE_VARIABLE_ModuleInfo_9);
        else
          succeeded = check_hlds__inst_abstract_unify__abstractly_unify_bound_inst_list_2_9_p_0(Type_1, Live_2, Real_3, HeadVar__4_4, BoundInstsB_38, HeadVar__6_6, &Detism1_64, STATE_VARIABLE_ModuleInfo_0_8, STATE_VARIABLE_ModuleInfo_9);
        if (succeeded)
        {
          Var_63 = (MR_Integer) 7;
