  ...
  switch (MR_tag((MR_Word) InstA_22)) {
                ...
                *Detism_20 = (MR_Integer) 0;
                {
                  ...
                  MR_hl_field(0, Var_44, 0) = ((MR_Box) (ConsIdB_16));
                  MR_hl_field(0, Var_44, 1) = ((MR_Box) (ArgInsts_26));
                }
                {
                ...
                }
                {
                  ...
                  *Inst_19 = base;
                  MR_hl_field(2, base, 0) = (MR_Box) ((MR_Unsigned) (Var_41));
                  MR_hl_field(2, base, 1) = ((MR_Box) (Var_42));
                  MR_hl_field(2, base, 2) = ((MR_Box) (Var_43));
                }
                succeeded = MR_TRUE;
              }
            }
    ...
    case (MR_Integer) 1:
      {
        ...
        MR_Word ArgTypes_61;
        MR_Word ArgInsts_62;
        MR_Word UniqA_63 = ((MR_Unsigned) ((MR_hl_field(1, InstA_22, (MR_Integer) 0))) & (MR_Integer) 7);
        MR_Word DuCtorB_60;

        check_hlds__inst_util__get_cons_id_arg_types_for_inst_5_p_0(STATE_VARIABLE_ModuleInfo_0_23, Type_12, ConsIdB_16, ArgInstsB_17, &ArgTypes_61);
        switch (Live_13) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 1:
            succeeded = check_hlds__inst_abstract_unify__make_ground_inst_list_9_p_0(Live_13, Real_14, UniqA_63, ArgTypes_61, ArgInstsB_17, &ArgInsts0_36, Detism_20, STATE_VARIABLE_ModuleInfo_0_23, STATE_VARIABLE_ModuleInfo_24);
            break;
          case (MR_Integer) 0:
            succeeded = check_hlds__inst_abstract_unify__make_ground_inst_list_lives_10_p_0(Live_13, Real_14, UniqA_63, ArgTypes_61, ArgLives_18, ArgInstsB_17, &ArgInsts0_36, Detism_20, STATE_VARIABLE_ModuleInfo_0_23, STATE_VARIABLE_ModuleInfo_24);
            break;
        }
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            DuCtorB_60 = (MR_Word) (MR_body((MR_Word) (ConsIdB_16), (MR_Integer) 1));
            check_hlds__inst_abstract_unify__propagate_ho_inst_info_into_arg_insts_5_p_0(*STATE_VARIABLE_ModuleInfo_24, Type_12, DuCtorB_60, ArgInsts0_36, &ArgInsts_62);
          }
          else
            ArgInsts_62 = ArgInsts0_36;
          ...
          Var_57 = (MR_Word) ((MR_Unsigned) 0U);
          {
            ...
            MR_hl_field(0, Var_56, 0) = ((MR_Box) (ConsIdB_16));
            MR_hl_field(0, Var_56, 1) = ((MR_Box) (ArgInsts_62));
          }
          {
          ...
          }
          {
            ...
            base = (MR_Word) MR_mkword(2, MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
            *Inst_19 = base;
            MR_hl_field(2, base, 0) = (MR_Box) ((MR_Unsigned) (UniqA_63));
            MR_hl_field(2, base, 1) = ((MR_Box) (Var_54));
            MR_hl_field(2, base, 2) = ((MR_Box) (Var_55));
          }
          succeeded = MR_TRUE;
        }
      }
    ...
    case (MR_Integer) 2:
      {
        ...
        MR_Word BoundInstsA_32 = ((MR_Word) ((MR_hl_field(2, InstA_22, (MR_Integer) 2))));
        ...
        switch (Live_13) {
          ...
          case (MR_Integer) 1:
            {
              MR_Word BoundInstsB_34;
              MR_Word Var_50;

              {
                Var_50 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
                MR_hl_field(0, Var_50, 0) = ((MR_Box) (ConsIdB_16));
                MR_hl_field(0, Var_50, 1) = ((MR_Box) (ArgInstsB_17));
              }
              {
                BoundInstsB_34 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(1, BoundInstsB_34, 0) = ((MR_Box) (Var_50));
                MR_hl_field(1, BoundInstsB_34, 1) = ((MR_Box) ((MR_Unsigned) 0U));
              }
              succeeded = check_hlds__inst_abstract_unify__abstractly_unify_bound_inst_list_9_p_0(Type_12, (MR_Integer) 1, Real_14, BoundInstsA_32, BoundInstsB_34, &BoundInsts_33, Detism_20, STATE_VARIABLE_ModuleInfo_0_23, STATE_VARIABLE_ModuleInfo_24);
            }
            break;
          case (MR_Integer) 0:
            succeeded = check_hlds__inst_abstract_unify__abstractly_unify_bound_inst_list_lives_10_p_0(Type_12, Real_14, BoundInstsA_32, ConsIdB_16, ArgInstsB_17, ArgLives_18, &BoundInsts_33, Detism_20, STATE_VARIABLE_ModuleInfo_0_23, STATE_VARIABLE_ModuleInfo_24);
            break;
        }
        if (succeeded)
        {
          Var_53 = (MR_Word) ((MR_Unsigned) 0U);
          {
            ...
            *Inst_19 = base;
            ...
            MR_hl_field(2, base, 2) = ((MR_Box) (BoundInsts_33));
          }
          succeeded = MR_TRUE;
        }
      }
    ...
    case (MR_Integer) 3:
      switch (((MR_Integer) ((MR_hl_field(3, InstA_22, (MR_Integer) 0))))) {
        ...
        case (MR_Integer) 1:
          {
            MR_Word InstVars_37 = ((MR_Word) ((MR_hl_field(3, InstA_22, (MR_Integer) 1))));
            MR_Word SubInstA_38 = ((MR_Word) ((MR_hl_field(3, InstA_22, (MR_Integer) 2))));
            MR_Word Inst0_39;

            succeeded = check_hlds__inst_abstract_unify__abstractly_unify_inst_functor_11_p_0(Type_12, Live_13, Real_14, SubInstA_38, ConsIdB_16, ArgInstsB_17, ArgLives_18, &Inst0_39, Detism_20, STATE_VARIABLE_ModuleInfo_0_23, STATE_VARIABLE_ModuleInfo_24);
            if (succeeded)
            {
              succeeded = check_hlds__inst_match__inst_matches_final_4_p_0(*STATE_VARIABLE_ModuleInfo_24, Type_12, Inst0_39, SubInstA_38);
              if (succeeded)
                {
                  MR_Word base;
                  ...
                  *Inst_19 = base;
                  ...
                  MR_hl_field(3, base, 1) = ((MR_Box) (InstVars_37));
                  MR_hl_field(3, base, 2) = ((MR_Box) (Inst0_39));
                }
              else
                *Inst_19 = Inst0_39;
              succeeded = MR_TRUE;
        ...
        case (MR_Integer) 2:
          {
            ...
            if (succeeded)
            {
              check_hlds__inst_util__get_cons_id_arg_types_for_inst_5_p_0(STATE_VARIABLE_ModuleInfo_0_23, Type_12, ConsIdB_16, ArgInstsB_17, &ArgTypes_58);
              switch (Live_13) {
                default: /*NOTREACHED*/ MR_assert(0);
                case (MR_Integer) 1:
                  succeeded = check_hlds__inst_abstract_unify__make_any_inst_list_9_p_0(Live_13, Real_14, Uniq_28, ArgTypes_58, ArgInstsB_17, &ArgInsts_59, Detism_20, STATE_VARIABLE_ModuleInfo_0_23, STATE_VARIABLE_ModuleInfo_24);
                  break;
                case (MR_Integer) 0:
                  succeeded = check_hlds__inst_abstract_unify__make_any_inst_list_lives_10_p_0(Live_13, Real_14, Uniq_28, ArgTypes_58, ArgInstsB_17, ArgLives_18, &ArgInsts_59, Detism_20, STATE_VARIABLE_ModuleInfo_0_23, STATE_VARIABLE_ModuleInfo_24);
                  break;
              }
              if (succeeded)
              {
                ...
                Var_49 = (MR_Word) ((MR_Unsigned) 0U);
                {
                  ...
                  MR_hl_field(0, Var_48, 0) = ((MR_Box) (ConsIdB_16));
                  MR_hl_field(0, Var_48, 1) = ((MR_Box) (ArgInsts_59));
                }
                {
                ...
                }
                {
                  ...
                  *Inst_19 = base;
                  ...
                  MR_hl_field(2, base, 2) = ((MR_Box) (Var_47));
                }
                succeeded = MR_TRUE;
              }
            }
  ...
  MR_Word * STATE_VARIABLE_ArgInsts_22)
{
  ...
  if (succeeded)
    check_hlds__inst_abstract_unify__propagate_ho_inst_info_into_arg_insts_loop_3_p_0(ConsArgs_17, STATE_VARIABLE_ArgInsts_0_21, STATE_VARIABLE_ArgInsts_22);
  else
  ...
  else
  {
    ...
    else
    {
      ...
      if (succeeded)
        ...
        Inst_18 = Inst0_16;
      check_hlds__inst_abstract_unify__propagate_ho_inst_info_into_arg_insts_loop_3_p_0(Var_33, Insts0_17, &Insts_19);
      {
        MR_Word base;
        base = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        *HeadVar__3_3 = base;
