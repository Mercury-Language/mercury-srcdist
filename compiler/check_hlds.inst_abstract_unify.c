                ...
                *Detism_20 = (MR_Integer) 0;
                {
                  ...
                  MR_hl_field(MR_mktag(0), Var_78, 1) = ((MR_Box) (ArgInsts_37));
                }
                {
                ...
                }
                {
                  ...
                  *Inst_19 = base;
                  ...
                  MR_hl_field(MR_mktag(3), base, 1) = (MR_Box) ((MR_Unsigned) (Var_75));
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            ...
            Var_73 = (MR_Word) ((MR_Unsigned) 0U);
            {
              ...
              MR_hl_field(MR_mktag(0), Var_72, 0) = ((MR_Box) (ConsIdB_14));
              MR_hl_field(MR_mktag(0), Var_72, 1) = ((MR_Box) (ArgInsts_80));
            }
            {
              ...
              case (MR_Integer) 1:
                {
...

                  {
                    ...
                    MR_hl_field(MR_mktag(0), Var_62, 0) = ((MR_Box) (ConsIdB_14));
                    MR_hl_field(MR_mktag(0), Var_62, 1) = ((MR_Box) (ArgInstsB_15));
                  }
                  {
                    BoundInstsB_44 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(MR_mktag(1), BoundInstsB_44, 0) = ((MR_Box) (Var_62));
        ...
        case (MR_Integer) 1:
          {
            ...
            if (succeeded)
            {
              ...
              Var_61 = (MR_Word) ((MR_Unsigned) 0U);
              {
                ...
                MR_hl_field(MR_mktag(0), Var_60, 1) = ((MR_Box) (ArgInsts_81));
              }
              {
        ...
        case (MR_Integer) 3:
          {
            ...
            succeeded = check_hlds__inst_abstract_unify__abstractly_unify_constrained_inst_vars_9_p_0(Live_10, InstVars_28, SubInst0_29, Var_55, Real_12, Inst_13, Detism_14, STATE_VARIABLE_ModuleInfo_0_47, STATE_VARIABLE_ModuleInfo_48);
          }
          break;
        case (MR_Integer) 4:
          {
        ...
        case (MR_Integer) 3:
          {
            ...
            succeeded = check_hlds__inst_abstract_unify__abstractly_unify_inst_8_p_0(Live_9, SubInst0_26, Var_52, Real_11, &Inst0_86, Detism_14, STATE_VARIABLE_ModuleInfo_0_44, STATE_VARIABLE_ModuleInfo_45);
            if (succeeded)
            {
