        ...
        case (MR_Integer) 1:
          {
            ...
            if (succeeded)
            {
              succeeded = hlds__inst_match__inst_matches_final_4_p_0(*STATE_VARIABLE_ModuleInfo_24, Type_12, Inst0_41, SubInstA_40);
              if (succeeded)
                {
                  MR_Word base;
      ...
      else
      {
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            ...
            succeeded = hlds__inst_match__pred_inst_matches_4_p_0(ModuleInfo_1, ArgType_23, InstPredInst_29, TypePredInst_28);
          }
        }
        else
          succeeded = MR_TRUE;
        ...
        case (MR_Integer) 1:
          {
            ...
            if (succeeded)
            {
              succeeded = hlds__inst_match__inst_matches_final_4_p_0(*STATE_VARIABLE_ModuleInfo_45, Type_10, Inst0_70, SubInst0_28);
              succeeded = !(succeeded);
              if (succeeded)
                *Inst_15 = Inst0_70;
              else
        ...
        case (MR_Integer) 1:
          {
            ...
            if (succeeded)
            {
              succeeded = hlds__inst_match__inst_matches_final_4_p_0(*STATE_VARIABLE_ModuleInfo_44, Type_10, Inst0_69, SubInst0_27);
              succeeded = !(succeeded);
              if (succeeded)
                *Inst_15 = Inst0_69;
              else
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_24)
{
  ...
  if (succeeded)
  {
    succeeded = hlds__inst_match__inst_matches_final_4_p_0(*STATE_VARIABLE_ModuleInfo_24, Type_11, Inst0_20, SubInstA_15);
    succeeded = !(succeeded);
    if (succeeded)
      *Inst_17 = Inst0_20;
    else
