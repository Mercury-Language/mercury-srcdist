  ...
  if (succeeded)
  {
    ...
    switch (HeadLive_16) {
      ...
      case (MR_Integer) 1:
        ...
        break;
      case (MR_Integer) 0:
        check_hlds__inst_util__make_shared_inst_5_p_0(HeadType_12, HeadInst0_14, &HeadInst_18, STATE_VARIABLE_ModuleInfo_0_20, &STATE_VARIABLE_ModuleInfo_1_22);
        break;
    }
        ...
        case (MR_Integer) 0:
          {
            ...
            if ((MaybeOldMaybeInst_34 == (MR_Word) ((MR_Unsigned) 0U)))
            {
              ...
              check_hlds__inst_lookup__inst_lookup_3_p_0(STATE_VARIABLE_ModuleInfo_3_60, InstName_29, &SubInst0_69);
              check_hlds__inst_lookup__inst_expand_3_p_0(STATE_VARIABLE_ModuleInfo_3_60, SubInst0_69, &SubInst1_39);
        ...
        case (MR_Integer) 0:
          {
            ...
            if ((MaybeOldMaybeInst_33 == (MR_Word) ((MR_Unsigned) 0U)))
            {
              ...
              check_hlds__inst_lookup__inst_lookup_3_p_0(STATE_VARIABLE_ModuleInfo_3_58, InstName_28, &SubInst0_68);
              check_hlds__inst_lookup__inst_expand_3_p_0(STATE_VARIABLE_ModuleInfo_3_58, SubInst0_68, &SubInst1_38);
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_32)
{
  ...
  else
  {
    ...
    if ((MaybeOldMaybeInst_22 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      ...
      check_hlds__inst_lookup__inst_expand_3_p_0(STATE_VARIABLE_ModuleInfo_2_34, InstA_13, &ExpandedInstA_43);
      check_hlds__inst_lookup__inst_expand_3_p_0(STATE_VARIABLE_ModuleInfo_2_34, InstB_14, &ExpandedInstB_44);
