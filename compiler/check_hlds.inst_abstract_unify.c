  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      else
      {
        ...
        if (succeeded)
        {
          Var_29 = ((MR_Word) ((MR_hl_field(0, Var_33, (MR_Integer) 1))));
          succeeded = ((((MR_tag((MR_Word) Var_29)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(3, Var_29, (MR_Integer) 0)))) == (MR_Integer) 1)));
          if (succeeded)
          {
            TypeHOInstInfo_25 = ((MR_Word) ((MR_hl_field(3, Var_29, (MR_Integer) 3))));
            succeeded = (TypeHOInstInfo_25 != (MR_Word) ((MR_Unsigned) 0U));
            if (succeeded)
              TypePredInst_27 = (MR_Word) (MR_body((MR_Word) (TypeHOInstInfo_25), (MR_Integer) 1));
          }
        }
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            PredInst_28 = (MR_Word) (MR_body((MR_Word) (HOInstInfo_21), (MR_Integer) 1));
            succeeded = check_hlds__inst_match__pred_inst_matches_3_p_0(ModuleInfo_1, PredInst_28, TypePredInst_27);
          }
        }
        else
          succeeded = MR_TRUE;
