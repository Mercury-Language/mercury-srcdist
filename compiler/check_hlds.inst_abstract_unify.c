                ...
                *Detism_20 = (MR_Integer) 0;
                {
                  ...
                  MR_hl_field(MR_mktag(0), Var_46, 0) = ((MR_Box) (ConsIdB_14));
                  MR_hl_field(MR_mktag(0), Var_46, 1) = ((MR_Box) (ArgInsts_25));
                }
                {
                ...
                }
                {
                  ...
                  *Inst_19 = base;
                  ...
                  MR_hl_field(MR_mktag(3), base, 1) = (MR_Box) ((MR_Unsigned) (Var_43));
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            ...
            Var_51 = (MR_Word) ((MR_Unsigned) 0U);
            {
              ...
              MR_hl_field(MR_mktag(0), Var_50, 0) = ((MR_Box) (ConsIdB_14));
              MR_hl_field(MR_mktag(0), Var_50, 1) = ((MR_Box) (ArgInsts_60));
            }
            {
              ...
              case (MR_Integer) 1:
                {
...

                  {
                    ...
                    MR_hl_field(MR_mktag(0), Var_52, 0) = ((MR_Box) (ConsIdB_14));
                    MR_hl_field(MR_mktag(0), Var_52, 1) = ((MR_Box) (ArgInstsB_15));
                  }
                  {
                    BoundInstsB_32 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(MR_mktag(1), BoundInstsB_32, 0) = ((MR_Box) (Var_52));
        ...
        case (MR_Integer) 1:
          {
            ...
            if (succeeded)
            {
              ...
              Var_59 = (MR_Word) ((MR_Unsigned) 0U);
              {
                ...
                MR_hl_field(MR_mktag(0), Var_58, 1) = ((MR_Box) (ArgInsts_61));
              }
              {
