        ...
        case (MR_Integer) 0:
          {
              ...
              case (MR_Integer) 0:
                {
                  ...
                  if (succeeded)
                  {
                    check_hlds__inst_abstract_unify__maybe_make_shared_inst_list_5_p_0(ArgInstsB_15, ArgLives_16, &ArgInsts_38, STATE_VARIABLE_ModuleInfo_0_23, STATE_VARIABLE_ModuleInfo_24);
                    succeeded = MR_TRUE;
                  }
                }
                break;
            ...
            if (succeeded)
            {
              succeeded = check_hlds__inst_abstract_unify__arg_insts_match_ctor_subtypes_4_p_0(*STATE_VARIABLE_ModuleInfo_24, Type_18, ConsIdB_14, ArgInsts_38);
              if (succeeded)
              {
                Var_57 = (MR_Integer) 1;
                ...
                *Detism_20 = (MR_Integer) 0;
                {
                  ...
                  MR_hl_field(MR_mktag(0), Var_60, 0) = ((MR_Box) (ConsIdB_14));
                  MR_hl_field(MR_mktag(0), Var_60, 1) = ((MR_Box) (ArgInsts_38));
                }
                {
                ...
                }
                {
                  ...
                  *Inst_19 = base;
                  ...
                  MR_hl_field(MR_mktag(3), base, 1) = (MR_Box) ((MR_Unsigned) (Var_57));
    ...
    case (MR_Integer) 2:
      {
        ...
        if (succeeded)
        {
          switch (Live_12) {
            default: /*NOTREACHED*/ MR_assert(0);
            case (MR_Integer) 1:
              succeeded = check_hlds__inst_abstract_unify__make_any_inst_list_8_p_0(ArgInstsB_15, Live_12, Uniq_39, Real_17, &ArgInsts_81, Detism_20, STATE_VARIABLE_ModuleInfo_0_23, STATE_VARIABLE_ModuleInfo_24);
              break;
            case (MR_Integer) 0:
              succeeded = check_hlds__inst_abstract_unify__make_any_inst_list_lives_9_p_0(ArgInstsB_15, Live_12, ArgLives_16, Uniq_39, Real_17, &ArgInsts_81, Detism_20, STATE_VARIABLE_ModuleInfo_0_23, STATE_VARIABLE_ModuleInfo_24);
              break;
          }
          if (succeeded)
          {
            ...
            Var_67 = (MR_Word) ((MR_Unsigned) 0U);
            {
              ...
              MR_hl_field(MR_mktag(0), Var_66, 0) = ((MR_Box) (ConsIdB_14));
              MR_hl_field(MR_mktag(0), Var_66, 1) = ((MR_Box) (ArgInsts_81));
            }
            {
            ...
            }
            {
              ...
              *Inst_19 = base;
              ...
              MR_hl_field(MR_mktag(3), base, 3) = ((MR_Box) (Var_65));
            }
            succeeded = MR_TRUE;
          }
        }
              ...
              case (MR_Integer) 1:
                {
...

                  {
                    ...
                    MR_hl_field(MR_mktag(0), Var_69, 0) = ((MR_Box) (ConsIdB_14));
                    MR_hl_field(MR_mktag(0), Var_69, 1) = ((MR_Box) (ArgInstsB_15));
                  }
                  {
                    BoundInstsB_45 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(MR_mktag(1), BoundInstsB_45, 0) = ((MR_Box) (Var_69));
                    MR_hl_field(MR_mktag(1), BoundInstsB_45, 1) = ((MR_Box) ((MR_Unsigned) 0U));
                  }
                  succeeded = check_hlds__inst_abstract_unify__abstractly_unify_bound_inst_list_8_p_0((MR_Integer) 1, BoundInstsA_43, BoundInstsB_45, Real_17, &BoundInsts_44, Detism_20, STATE_VARIABLE_ModuleInfo_0_23, STATE_VARIABLE_ModuleInfo_24);
                }
                break;
              case (MR_Integer) 0:
                succeeded = check_hlds__inst_abstract_unify__abstractly_unify_bound_inst_list_lives_9_p_0(BoundInstsA_43, ConsIdB_14, ArgInstsB_15, ArgLives_16, Real_17, &BoundInsts_44, Detism_20, STATE_VARIABLE_ModuleInfo_0_23, STATE_VARIABLE_ModuleInfo_24);
                break;
            }
            if (succeeded)
            {
        ...
        case (MR_Integer) 1:
          {
            ...
            switch (Live_12) {
              default: /*NOTREACHED*/ MR_assert(0);
              case (MR_Integer) 1:
                succeeded = check_hlds__inst_abstract_unify__make_ground_inst_list_8_p_0(Live_12, UniqA_83, Real_17, ArgInstsB_15, &ArgInsts0_47, Detism_20, STATE_VARIABLE_ModuleInfo_0_23, STATE_VARIABLE_ModuleInfo_24);
                break;
              case (MR_Integer) 0:
                succeeded = check_hlds__inst_abstract_unify__make_ground_inst_list_lives_9_p_0(Live_12, UniqA_83, Real_17, ArgLives_16, ArgInstsB_15, &ArgInsts0_47, Detism_20, STATE_VARIABLE_ModuleInfo_0_23, STATE_VARIABLE_ModuleInfo_24);
                break;
            }
            if (succeeded)
            {
              check_hlds__inst_abstract_unify__propagate_ctor_subtypes_into_arg_insts_5_p_0(*STATE_VARIABLE_ModuleInfo_24, Type_18, ConsIdB_14, ArgInsts0_47, &ArgInsts_82);
              ...
              Var_79 = (MR_Word) ((MR_Unsigned) 0U);
              {
                ...
                MR_hl_field(MR_mktag(0), Var_78, 0) = ((MR_Box) (ConsIdB_14));
                MR_hl_field(MR_mktag(0), Var_78, 1) = ((MR_Box) (ArgInsts_82));
              }
              {
              ...
              }
              {
                ...
                *Inst_19 = base;
                ...
                MR_hl_field(MR_mktag(3), base, 2) = ((MR_Box) (Var_76));
        ...
        case (MR_Integer) 3:
          {
            ...
            succeeded = check_hlds__inst_abstract_unify__abstractly_unify_inst_functor_11_p_0(Live_12, SubInstA_49, ConsIdB_14, ArgInstsB_15, ArgLives_16, Real_17, Type_18, &Inst0_50, Detism_20, STATE_VARIABLE_ModuleInfo_0_23, STATE_VARIABLE_ModuleInfo_24);
            if (succeeded)
            {
        ...
        case (MR_Integer) 3:
          {
            ...
            succeeded = check_hlds__inst_abstract_unify__abstractly_unify_constrained_inst_vars_9_p_0(Live_9, InstVars_25, SubInst0_26, Var_59, Real_11, Inst_13, Detism_14, STATE_VARIABLE_ModuleInfo_0_44, STATE_VARIABLE_ModuleInfo_45);
          }
          break;
        case (MR_Integer) 4:
          {
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_30)
{
  ...
  if (succeeded)
  {
    ...
    check_hlds__inst_lookup__inst_expand_3_p_0(STATE_VARIABLE_ModuleInfo_0_29, InstA_10, &ExpandedInstA_45);
    check_hlds__inst_lookup__inst_expand_3_p_0(STATE_VARIABLE_ModuleInfo_0_29, InstB_11, &ExpandedInstB_46);
    succeeded = check_hlds__inst_abstract_unify__abstractly_unify_inst_3_8_p_0(Live_9, ExpandedInstA_45, ExpandedInstB_46, Real_12, &Inst0_47, Detism_14, STATE_VARIABLE_ModuleInfo_0_29, STATE_VARIABLE_ModuleInfo_30);
    if (succeeded)
    {
      Var_50 = (MR_Integer) 0;
  ...
  else
  {
    ...
    if ((MaybeMaybeInst_20 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      ...
      check_hlds__inst_lookup__inst_expand_3_p_0(STATE_VARIABLE_ModuleInfo_32_32, InstA_10, &ExpandedInstA_61);
      check_hlds__inst_lookup__inst_expand_3_p_0(STATE_VARIABLE_ModuleInfo_32_32, InstB_11, &ExpandedInstB_62);
      succeeded = check_hlds__inst_abstract_unify__abstractly_unify_inst_3_8_p_0(Live_9, ExpandedInstA_61, ExpandedInstB_62, Real_12, &Inst0_63, Detism_14, STATE_VARIABLE_ModuleInfo_32_32, &STATE_VARIABLE_ModuleInfo_33_33);
      if (succeeded)
      {
        Var_66 = (MR_Integer) 0;
