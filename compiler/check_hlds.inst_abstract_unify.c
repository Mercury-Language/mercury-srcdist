    ...
    case (MR_Integer) 2:
      {
        ...
        MR_Word BoundFunctorsA_32 = ((MR_Word) ((MR_hl_field(2, InstA_22, (MR_Integer) 2))));
        MR_Word BoundFunctors_33;
        MR_Word Var_53;
          ...
          case (MR_Integer) 1:
            {
              ...
              {
                BoundFunctorsB_34 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(1, BoundFunctorsB_34, 0) = ((MR_Box) (Var_50));
                MR_hl_field(1, BoundFunctorsB_34, 1) = ((MR_Box) ((MR_Unsigned) 0U));
              }
              succeeded = check_hlds__inst_abstract_unify__abstractly_unify_bound_functor_list_9_p_0(Type_12, (MR_Integer) 1, Real_14, BoundFunctorsA_32, BoundFunctorsB_34, &BoundFunctors_33, Detism_20, STATE_VARIABLE_ModuleInfo_0_23, STATE_VARIABLE_ModuleInfo_24);
            }
            break;
          case (MR_Integer) 0:
            succeeded = check_hlds__inst_abstract_unify__abstractly_unify_bound_functor_list_lives_10_p_0(Type_12, Real_14, BoundFunctorsA_32, ConsIdB_16, ArgInstsB_17, ArgLives_18, &BoundFunctors_33, Detism_20, STATE_VARIABLE_ModuleInfo_0_23, STATE_VARIABLE_ModuleInfo_24);
            break;
        }
        if (succeeded)
        {
          Var_53 = (MR_Word) ((MR_Unsigned) 0U);
          {
            ...
            *Inst_19 = base;
            ...
            MR_hl_field(2, base, 2) = ((MR_Box) (BoundFunctors_33));
          }
          succeeded = MR_TRUE;
        }
      }
