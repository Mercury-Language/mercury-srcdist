  ...
  MR_Word * Goal_11)
{
  ...
  hlds__hlds_goal__goal_info_add_feature_3_p_0((MR_Integer) 8, GoalInfo0_77, &GoalInfo_26);
  {
    MR_Word base;
    base = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
    *Goal_11 = base;
  ...
  MR_Word * Goal_4)
{
  ...
  mercury__set__insert_3_p_0((MR_Word) (&hlds__hlds_markers__hlds__hlds_markers__type_ctor_info_goal_feature_0), ((MR_Box) ((MR_Integer) 5)), Features0_7, &Features_8);
