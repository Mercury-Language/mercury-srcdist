  ...
  MR_Integer * MaxIntTag_6)
{
  ...
  if (succeeded)
  {
    ...
    MaybeSuperType_11 = ((MR_Word) ((MR_hl_field(0, TypeBodyDu_9, 1))));
    MaybeCanonical_12 = ((MR_Word) ((MR_hl_field(0, TypeBodyDu_9, 2))));
    MaybeRepn_13 = ((MR_Word) ((MR_hl_field(0, TypeBodyDu_9, 3))));
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        Var_25 = ((MR_Word) ((MR_hl_field(0, Repn_15, 0))));
        Var_19 = ((MR_Word) ((MR_hl_field(0, Repn_15, 3))));
  ...
  if (succeeded)
    ...
    else
    {
      ...
      mercury__list__foldl_4_p_0((MR_Word) (&hlds__hlds_data__hlds__hlds_data__type_ctor_info_constructor_repn_0), (MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0), (MR_Word) (&transform_hlds__table_gen_scalar_common_2[4]), Var_25, ((MR_Box) ((MR_Integer) 0)), &conv2_MaxIntTag_6);
