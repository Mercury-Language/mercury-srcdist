...
{
  {
    ...
    MR_Word Var_82 = ((MR_Word) (MR_hl_field(MR_mktag(0), HeadVar__1_77, (MR_Integer) 1)));
    MR_Integer Var_83 = ((MR_Integer) (MR_hl_field(MR_mktag(0), HeadVar__1_77, (MR_Integer) 2)));
    MR_Word Var_84 = ((MR_Word) (MR_hl_field(MR_mktag(0), HeadVar__1_77, (MR_Integer) 3)));
          ...
          case (MR_Integer) 2:
            {
              ...
              MR_Word Var_145 = ((MR_Word) (MR_hl_field(MR_mktag(0), Attributes_28, (MR_Integer) 3)));
                          ...
                          case (MR_Integer) 1:
                            {
                              ...
                              MaybeOutputSteps_126 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
                            }
                            break;
                          case (MR_Integer) 2:
                            {
...
{
  {
    ...
    parse_tree__prog_type__construct_type_3_p_0(Var_83, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), &Var_44);
    ...
    Var_72 = ((MR_Word) (MR_hl_field(MR_mktag(0), TableInfo_19, (MR_Integer) 1)));
    Var_73 = ((MR_Word) (MR_hl_field(MR_mktag(0), TableInfo_19, (MR_Integer) 2)));
    {
    ...
    Var_94 = ((MR_Word) (MR_hl_field(MR_mktag(0), TableInfo_19, (MR_Integer) 1)));
    Var_95 = ((MR_Word) (MR_hl_field(MR_mktag(0), TableInfo_19, (MR_Integer) 2)));
...
{
  {
    MR_Word TypeCtorInfo_174_174 = (MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0;
    ...
    parse_tree__set_of_var__list_to_set_2_p_0(TypeCtorInfo_174_174, HeadVars_25, &OrigNonLocals_34);
    ...
    Var_172 = ((MR_Word) (MR_hl_field(MR_mktag(0), STATE_VARIABLE_TableInfo_0_84, (MR_Integer) 1)));
    Var_173 = ((MR_Word) (MR_hl_field(MR_mktag(0), STATE_VARIABLE_TableInfo_0_84, (MR_Integer) 2)));
    ...
    TypeInfo_175_175 = (MR_Word) &transform_hlds__table_gen_scalar_common_1[3];
    mercury__list__length_2_p_0(TypeInfo_175_175, NumberedOutputVars_27, &BlockSize_47);
    TypeInfo_177_177 = (MR_Word) &transform_hlds__table_gen_scalar_common_1[2];
    OutputVars_52 = mercury__list__map_2_f_0(TypeInfo_175_175, TypeInfo_177_177, (MR_Word) &transform_hlds__table_gen_scalar_common_2[21], NumberedOutputVars_27);
      ...
      case (MR_Integer) 0:
        {
          ...
          parse_tree__set_of_var__list_to_set_2_p_0(TypeCtorInfo_174_174, Var_99, &InactiveNonLocals_51);
          {
          ...
          Var_155 = transform_hlds__table_gen__memo_det_inactive_cons_id_0_f_0();
          {
            ...
            MR_hl_field(MR_mktag(0), Var_154, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
          ...
          Var_159 = transform_hlds__table_gen__memo_det_succeeded_cons_id_0_f_0();
          {
            ...
            MR_hl_field(MR_mktag(0), Var_158, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
      ...
      case (MR_Integer) 1:
        {
          ...
          parse_tree__set_of_var__list_to_set_2_p_0(TypeCtorInfo_174_174, Var_197, &InactiveNonLocals_51);
          ...
          ThenVars_63 = mercury__list__f_43_43_2_f_0(TypeInfo_177_177, Var_105, NewVars_59);
          parse_tree__set_of_var__list_to_set_2_p_0(TypeCtorInfo_174_174, ThenVars_63, &ThenNonLocals_64);
          ...
          transform_hlds__table_gen__table_generate_foreign_proc_11_p_0((MR_String) "table_memo_mark_as_failed", (MR_Integer) 7, Var_123, Var_124, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), MarkAsFailedCode_71, (MR_Integer) 2, Var_127, ModuleInfo_39, Context_38, &ElseGoal_72);
          {
            ...
            MR_hl_field(MR_mktag(3), InactiveGoalExpr_169, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
          ...
          Var_136 = transform_hlds__table_gen__memo_semi_inactive_cons_id_0_f_0();
          {
            ...
            MR_hl_field(MR_mktag(0), Var_135, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
          ...
          Var_144 = transform_hlds__table_gen__memo_semi_failed_cons_id_0_f_0();
          {
            ...
            MR_hl_field(MR_mktag(0), Var_143, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
    ...
    parse_tree__set_of_var__insert_3_p_0(TypeCtorInfo_174_174, StatusVar_44, InactiveNonLocals_51, &SwitchNonLocals_75);
    ...
    else
    {
      ...
      else
      {
        ...
        if (succeeded)
        {
          ...
          if (((MR_tag((MR_Word) STATE_VARIABLE_MaybeSpecMethod_50_50)) == (MR_mktag((MR_Integer) 0))))
          {
          ...
          else
          {
            ...
            if (succeeded)
            {
              if ((LastMaybeArgMethod_45 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
              {
                {
        ...
        else
        {
          ...
          if (succeeded)
          {
            ...
            if (((MR_tag((MR_Word) STATE_VARIABLE_MaybeSpecMethod_56_56)) == (MR_mktag((MR_Integer) 0))))
            ...
            else
            {
              ...
              if (succeeded)
              {
...

                {
                  ...
                  MR_hl_field(MR_mktag(0), Var_57, 3) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
...
{
  {
    ...
    TypeCtorInfo_254_254 = (MR_Word) &hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_id_0;
    succeeded = mercury__map__search_3_p_0(TypeCtorInfo_254_254, TypeCtorInfo_254_254, STATE_VARIABLE_GenMap_0_97, ((MR_Box) (PredId_25)), &conv0_GeneratorPredIdPrime_40);
    if (succeeded)
    {
    ...
    else
    {
      ...
      mercury__map__det_insert_4_p_0(TypeCtorInfo_255_255, TypeCtorInfo_255_255, ((MR_Box) (PredId_25)), ((MR_Box) (GeneratorPredId_41)), STATE_VARIABLE_GenMap_0_97, STATE_VARIABLE_GenMap_98);
    }
    ...
    TypeInfo_257_257 = (MR_Word) &transform_hlds__table_gen_scalar_common_1[3];
    mercury__list__length_2_p_0(TypeInfo_257_257, NumberedInputVars_30, &NumInputVars_47);
    ModuleInfo_48 = ((MR_Word) (MR_hl_field(MR_mktag(0), STATE_VARIABLE_TableInfo_99_99, (MR_Integer) 0)));
    Var_247 = ((MR_Word) (MR_hl_field(MR_mktag(0), STATE_VARIABLE_TableInfo_99_99, (MR_Integer) 1)));
    Var_248 = ((MR_Word) (MR_hl_field(MR_mktag(0), STATE_VARIABLE_TableInfo_99_99, (MR_Integer) 2)));
    ...
    InputVarModes_62 = mercury__list__map_2_f_0(TypeInfo_257_257, TypeCtorInfo_258_258, (MR_Word) &transform_hlds__table_gen_scalar_common_2[20], NumberedInputVars_30);
    mercury__assoc_list__from_corresponding_lists_3_p_0((MR_Word) &hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_foreign_arg_0, TypeCtorInfo_258_258, LookupForeignArgs_58, InputVarModes_62, &LookupForeignArgModes_63);
    ...
    TypeCtorInfo_263_263 = (MR_Word) &hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_hlds_goal_0;
    {
    ...
    LookupSetupGoals_75 = mercury__list__f_43_43_2_f_0(TypeCtorInfo_263_263, Var_211, Var_212);
    ...
    Var_234 = transform_hlds__table_gen__tabling_c_attributes_no_dupl_0_f_0();
    {
      ...
      MR_hl_field(MR_mktag(1), Var_235, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
    }
    ...
    transform_hlds__table_gen__table_generate_foreign_proc_11_p_0((MR_String) "table_mmos_restore_answers", (MR_Integer) 0, Var_234, Var_235, RestoreArgs_81, RestoreCodeStr_82, (MR_Integer) 1, Var_237, ModuleInfo_48, Context_46, &RestoreGoal_85);
    {
      ...
      MR_hl_field(MR_mktag(1), Var_242, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
    }
    {
    ...
    Var_240 = mercury__list__f_43_43_2_f_0(TypeCtorInfo_263_263, LookupSetupGoals_75, Var_241);
    {
    ...
    Var_249 = ((MR_Word) (MR_hl_field(MR_mktag(0), GeneratorTableInfo_90, (MR_Integer) 1)));
    Var_250 = ((MR_Word) (MR_hl_field(MR_mktag(0), GeneratorTableInfo_90, (MR_Integer) 2)));
    Var_251 = ((MR_Word) (MR_hl_field(MR_mktag(0), STATE_VARIABLE_TableInfo_112_112, (MR_Integer) 0)));
  ...
  MR_String * HeadVar__6_6)
{
  ...
  else
  {
    ...
    else
    {
      ...
      _InMode_25 = ((MR_Word) (MR_hl_field(MR_mktag(0), Var_32, (MR_Integer) 1)));
    }
...
{
  {
    ...
    MR_Word Var_293 = ((MR_Word) (MR_hl_field(MR_mktag(0), STATE_VARIABLE_TableInfo_0_118, (MR_Integer) 1)));
    MR_Word Var_294 = ((MR_Word) (MR_hl_field(MR_mktag(0), STATE_VARIABLE_TableInfo_0_118, (MR_Integer) 2)));
    ...
    if (succeeded)
    {
      ...
      Var_295 = ((MR_Word) (MR_hl_field(MR_mktag(0), STATE_VARIABLE_TableInfo_0_118, (MR_Integer) 0)));
      ...
      case (MR_Integer) 0:
        {
          ...
          TypeInfo_301_301 = (MR_Word) &transform_hlds__table_gen_scalar_common_1[3];
          mercury__list__filter_4_p_0(TypeInfo_301_301, Var_122, OrigOutputVars_26, &IoStateAssignToVars_42, &MisNumberedSavedOutputVars_46);
          ...
          mercury__list__filter_4_p_0(TypeInfo_301_301, Var_122, OrigInputVars_25, &IoStateAssignFromVars_43, &_MisNumberedSavedInputVars_47);
          {
      ...
      case (MR_Integer) 2:
        {
          ...
          TypeInfo_313_313 = (MR_Word) &transform_hlds__table_gen_scalar_common_1[4];
          mercury__list__filter_3_p_0(TypeInfo_313_313, Var_195, NumberedSaveVars_61, &NumberedRestoreVars_64);
          Var_298 = ((MR_Word) (MR_hl_field(MR_mktag(0), STATE_VARIABLE_TableInfo_121_121, (MR_Integer) 0)));
          Var_299 = ((MR_Word) (MR_hl_field(MR_mktag(0), STATE_VARIABLE_TableInfo_121_121, (MR_Integer) 1)));
          ProcInfo0_65 = ((MR_Word) (MR_hl_field(MR_mktag(0), STATE_VARIABLE_TableInfo_121_121, (MR_Integer) 2)));
          Var_196 = mercury__list__map_2_f_0(TypeInfo_313_313, (MR_Word) &transform_hlds__table_gen_scalar_common_2[1], (MR_Word) &transform_hlds__table_gen_scalar_common_2[8], NumberedSavedHeadVars_60);
      ...
      case (MR_Integer) 0:
        {
          ...
          transform_hlds__table_gen__generate_new_table_var_7_p_0((MR_String) "SavedTraceEnabled", Var_239, STATE_VARIABLE_VarSet_235_235, STATE_VARIABLE_VarSet_115, STATE_VARIABLE_VarTypes_236_236, STATE_VARIABLE_VarTypes_117, &SavedTraceEnabledVar_88);
          {
            ...
            MR_hl_field(MR_mktag(1), Var_244, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
          }
    ...
    TypeCtorInfo_331_331 = (MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0;
    parse_tree__set_of_var__insert_3_p_0(TypeCtorInfo_331_331, TipVar_53, OrigNonLocals_40, &CallSaveAnswerNonLocals_93);
    ...
    parse_tree__set_of_var__insert_3_p_0(TypeCtorInfo_331_331, TipVar_53, OrigNonLocals_40, &GenIfNecNonLocals_100);
    ...
    parse_tree__set_of_var__insert_list_3_p_0(TypeCtorInfo_331_331, Var_140, OrigNonLocals_40, &CheckAndGenAnswerNonLocals_106);
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), Var_285, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
    }
    {
...
{
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        TypeCtorInfo_7_69 = (MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_tvar_type_0;
        mercury__varset__init_1_p_0(TypeCtorInfo_7_69, &DummyTVarSet0_65);
        mercury__varset__new_var_3_p_0(TypeCtorInfo_7_69, &DummyTVar_66, DummyTVarSet0_65, &Var_67);
        {
...
{
  {
    ...
    MR_String Var_242;
    MR_String Var_243;
    MR_Word Var_278 = ((MR_Word) (MR_hl_field(MR_mktag(0), STATE_VARIABLE_TableInfo_0_75, (MR_Integer) 1)));
    MR_Word Var_279 = ((MR_Word) (MR_hl_field(MR_mktag(0), STATE_VARIABLE_TableInfo_0_75, (MR_Integer) 2)));
                  ...
                  case (MR_Integer) 0:
                    {
                      ...
                      if (succeeded)
                      {
                        ...
                        _MaybeForeign_52 = ((MR_Word) (MR_hl_field(MR_mktag(1), TypeBody_48, (MR_Integer) 3)));
                        succeeded = (MaybeCanonical_50 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
                        if (succeeded)
                        {
                          succeeded = ((MR_tag((MR_Word) MaybeRepn_51)) == (MR_mktag((MR_Integer) 1)));
                          if (succeeded)
                          {
                            Repn_53 = ((MR_Word) (MR_hl_field(MR_mktag(1), MaybeRepn_51, (MR_Integer) 0)));
                            Var_280 = ((MR_Word) (MR_hl_field(MR_mktag(0), Repn_53, (MR_Integer) 0)));
                            Var_281 = ((MR_Word) (MR_hl_field(MR_mktag(0), Repn_53, (MR_Integer) 1)));
                            Var_282 = ((MR_Word) (MR_hl_field(MR_mktag(0), Repn_53, (MR_Integer) 2)));
                            Var_206 = ((MR_Word) (MR_hl_field(MR_mktag(0), Repn_53, (MR_Integer) 3)));
                            Var_283 = ((MR_Word) (MR_hl_field(MR_mktag(0), Repn_53, (MR_Integer) 4)));
...
transform_hlds__table_gen__maybe_record_overall_stats_13_p_0(
  ...
  MR_String * StatsCodeStr_24)
{
  if ((MaybeStatsRef_19 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
  {
    *PrefixGoals_22 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
    *Args_23 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
...
{
  {
    ...
    parse_tree__prog_type__construct_type_3_p_0(Var_43, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), &Var_30);
    ...
    parse_tree__prog_type__construct_type_3_p_0(Var_62, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), &Var_36);
    {
      MR_Word base;
      base = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL);
      *Arg_17 = base;
