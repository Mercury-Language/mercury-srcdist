  ...
  MR_Word * STATE_VARIABLE_Specs_16)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 160, &TraceTableIO_8);
  ...
  MR_Word * STATE_VARIABLE_Specs_31)
{
  ...
  if ((EvalMethod_20 == (MR_Word) ((MR_Unsigned) 0U)))
  {
    ...
    if (succeeded)
    {
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals_35, (MR_Integer) 164, &TransformAll_36);
      libs__globals__lookup_bool_option_3_p_0(Globals_35, (MR_Integer) 163, &Require_37);
      ...
      else
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_35, (MR_Integer) 161, &TraceTableIoOnlyRetry_44);
    ...
    case (MR_Integer) 2:
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_47, (MR_Integer) 162, &TableIoStates_48);
