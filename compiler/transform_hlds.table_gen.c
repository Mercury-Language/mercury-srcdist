  ...
  MR_Word * STATE_VARIABLE_Specs_16)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 256, &TraceTableIO_8);
  ...
  MR_Word * STATE_VARIABLE_Specs_31)
{
  ...
  if ((EvalMethod_20 == (MR_Word) ((MR_Unsigned) 0U)))
  {
    ...
    if (succeeded)
    {
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals_35, (MR_Integer) 260, &TransformAll_36);
      libs__globals__lookup_bool_option_3_p_0(Globals_35, (MR_Integer) 259, &Require_37);
      ...
      else
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_35, (MR_Integer) 257, &TraceTableIoOnlyRetry_44);
    ...
    case (MR_Integer) 2:
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_47, (MR_Integer) 258, &TableIoStates_48);
