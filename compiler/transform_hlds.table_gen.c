...
transform_hlds__table_gen__IntroducedFrom__pred__get_input_output_vars__3571__1_2_p_0(
  ...
  MR_Word * STATE_VARIABLE_GenMap_77)
{
  ...
  transform_hlds__table_gen__get_input_output_vars_7_p_0(HeadVars_22, ArgModes_25, STATE_VARIABLE_ModuleInfo_0_74, MaybeSpecMethod_30, &Var_40, &InputVarModeMethods_41, &OutputVarModeMethods_42);
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = transform_hlds__table_gen__IntroducedFrom__pred__get_input_output_vars__3571__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 4)))));
  return succeeded;
}
