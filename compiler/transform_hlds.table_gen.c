...
{
  {
    ...
    hlds__hlds_pred__pred_info_create_16_p_0(ModuleName_24, NewPredName_28, PredOrFunc_26, PredContext_27, (MR_Word) (MR_mkword(MR_mktag(3), &transform_hlds__table_gen_scalar_common_1[14])), ((MR_Box) ((MR_Unsigned) 32U)), Markers_34, PredArgTypes_29, PredTypeVarSet_30, PredExistQVars_31, PredClassContext_32, PredAssertions_33, VarNameRemap_21, NewProcInfo_23, &NewProcId_35, &NewPredInfo_36);
...
{
  {
    ...
    }
    {
      ...
      *Step_34 = base;
      ...
      MR_hl_field(MR_mktag(3), base, 1) = (MR_Box) (((((MR_Unsigned) (((MR_Box) (IsPoly_40))) << (MR_Integer) 1)) | (MR_Unsigned) (((MR_Box) (IsAddr_21)))));
    }
