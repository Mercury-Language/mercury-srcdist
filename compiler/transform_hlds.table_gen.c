...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 134, &TraceTableIO_8);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_21, (MR_Integer) 138, &TransformAll_22);
    libs__globals__lookup_bool_option_3_p_0(Globals_21, (MR_Integer) 137, &Require_23);
    ...
    else
    {
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals_21, (MR_Integer) 135, &TraceTableIoOnlyRetry_30);
      ...
      case (MR_Integer) 1:
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_46, (MR_Integer) 136, &TableIoStates_47);
