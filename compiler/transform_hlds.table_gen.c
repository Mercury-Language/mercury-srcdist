...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 142, &TraceTableIO_8);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_21, (MR_Integer) 146, &TransformAll_22);
    libs__globals__lookup_bool_option_3_p_0(Globals_21, (MR_Integer) 145, &Require_23);
      ...
      case (MR_Integer) 1:
        {
          ...
          Pieces_74 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_format_component_0), ProcPieces_73, (MR_Word) (MR_mkword(MR_mktag(1), &transform_hlds__table_gen_scalar_common_1[10])));
          {
            ...
            MR_hl_field(MR_mktag(1), Spec_28, 2) = ((MR_Box) ((MR_Unsigned) 72U));
    ...
    else
    {
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals_21, (MR_Integer) 143, &TraceTableIoOnlyRetry_30);
      ...
      case (MR_Integer) 1:
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_46, (MR_Integer) 144, &TableIoStates_47);
