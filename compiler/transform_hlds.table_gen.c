  ...
  MR_Word * STATE_VARIABLE_Specs_34)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_43, (MR_Integer) 266, &Parallel_48);
  switch (Parallel_48) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 0:
    ...
    case (MR_Integer) 3:
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_43, (MR_Integer) 309, &HighLevelCode_51);
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_43, (MR_Integer) 268, &UseTrail_53);
        switch (UseTrail_53) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 0:
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_43, (MR_Integer) 242, &ProfileCalls_55);
        libs__globals__lookup_bool_option_3_p_0(Globals_43, (MR_Integer) 245, &ProfileDeep_56);
