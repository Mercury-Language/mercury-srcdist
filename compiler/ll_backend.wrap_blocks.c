  ...
  MR_Word * HeadVar__5_5)
{
  while (MR_TRUE)
  {
    ...
    {
      MR_Word Instr0_17 = ((MR_Word) ((MR_hl_field(1, HeadVar__1_1, 0))));
      MR_Word Instrs0_18 = ((MR_Word) ((MR_hl_field(1, HeadVar__1_1, 1))));
      MR_Word Uinstr0_23 = ((MR_Word) ((MR_hl_field(0, Instr0_17, 0))));
      MR_Integer R1_25;
      MR_Integer F1_26;
      ...
      if (succeeded)
      {
        if (((((MR_tag((MR_Word) Uinstr0_23)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(3, Uinstr0_23, 0)))) == (MR_Integer) 5))))
          succeeded = MR_TRUE;
        else
        if (((((MR_tag((MR_Word) Uinstr0_23)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(3, Uinstr0_23, 0)))) == (MR_Integer) 3))))
          succeeded = MR_TRUE;
        else
          succeeded = MR_FALSE;
        if (succeeded)
