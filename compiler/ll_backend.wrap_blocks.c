...
#endif
MR_decl_label8(ll_backend__wrap_blocks__wrap_instrs_5_0, 62,7,6,5,3,12,16,15)
MR_decl_label8(ll_backend__wrap_blocks__wrap_instrs_5_0, 18,21,22,17,24,26,27,23)
MR_decl_label2(ll_backend__wrap_blocks__wrap_instrs_5_0, 14,31)
...
MR_BEGIN_MODULE(ll_backend__wrap_blocks_module0)
	...
	MR_init_label8(ll_backend__wrap_blocks__wrap_instrs_5_0,62,7,6,5,3,12,16,15)
	MR_init_label8(ll_backend__wrap_blocks__wrap_instrs_5_0,18,21,22,17,24,26,27,23)
	MR_init_label2(ll_backend__wrap_blocks__wrap_instrs_5_0,14,31)
MR_BEGIN_CODE
...
MR_def_label(ll_backend__wrap_blocks__wrap_instrs_5_0,62)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_def_label(ll_backend__wrap_blocks__wrap_instrs_5_0,17)
	...
	MR_np_call_localret_ent(fn__ll_backend__opt_util__can_instr_fall_through_1_0,
		ll_backend__wrap_blocks__wrap_instrs_5_0_i24);
MR_def_label(ll_backend__wrap_blocks__wrap_instrs_5_0,24)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(ll_backend__wrap_blocks__wrap_instrs_5_0_i23);
	}
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 2);
	...
	MR_np_call_localret_ent(list__reverse_2_0,
		ll_backend__wrap_blocks__wrap_instrs_5_0_i26);
MR_def_label(ll_backend__wrap_blocks__wrap_instrs_5_0,26)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(1) = MR_r1;
	MR_r1 = MR_sv(3);
	MR_r2 = (MR_Integer) 0;
	...
	MR_r4 = (MR_Word) MR_tbmkword(0, 0);
	MR_np_localcall_lab(ll_backend__wrap_blocks__wrap_instrs_5_0,
		ll_backend__wrap_blocks__wrap_instrs_5_0_i27);
...
MR_def_label(ll_backend__wrap_blocks__wrap_instrs_5_0,23)
	...
	MR_r3 = MR_sv(5);
	MR_succip_word = MR_sv(6);
	MR_GOTO_LAB(ll_backend__wrap_blocks__wrap_instrs_5_0_i62);
	}
