...
#endif
MR_decl_label8(ll_backend__wrap_blocks__wrap_instrs_5_0, 72,7,6,5,3,12,16,15)
MR_decl_label8(ll_backend__wrap_blocks__wrap_instrs_5_0, 18,21,22,17,28,31,32,27)
MR_decl_label2(ll_backend__wrap_blocks__wrap_instrs_5_0, 14,40)
...
MR_BEGIN_MODULE(ll_backend__wrap_blocks_module0)
	...
	MR_init_label8(ll_backend__wrap_blocks__wrap_instrs_5_0,72,7,6,5,3,12,16,15)
	MR_init_label8(ll_backend__wrap_blocks__wrap_instrs_5_0,18,21,22,17,28,31,32,27)
	MR_init_label2(ll_backend__wrap_blocks__wrap_instrs_5_0,14,40)
MR_BEGIN_CODE
