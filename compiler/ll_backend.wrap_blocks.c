  ...
  MR_Word * HeadVar__5_5)
{
  while (MR_TRUE)
  {
    ...
    {
      MR_Word Instr0_17 = ((MR_Word) ((MR_hl_field(1, HeadVar__1_1, (MR_Integer) 0))));
      MR_Word Instrs0_18 = ((MR_Word) ((MR_hl_field(1, HeadVar__1_1, (MR_Integer) 1))));
      MR_Word Uinstr0_23 = ((MR_Word) ((MR_hl_field(0, Instr0_17, (MR_Integer) 0))));
      MR_Integer R1_25;
      MR_Integer F1_26;
      ...
      if (succeeded)
      {
        if (((((MR_tag((MR_Word) Uinstr0_23)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(3, Uinstr0_23, (MR_Integer) 0)))) == (MR_Integer) 5))))
          succeeded = MR_TRUE;
        else
        if (((((MR_tag((MR_Word) Uinstr0_23)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(3, Uinstr0_23, (MR_Integer) 0)))) == (MR_Integer) 3))))
          succeeded = MR_TRUE;
        else
          succeeded = MR_FALSE;
        if (succeeded)
        {
          ...
          ll_backend__wrap_blocks__wrap_instrs_5_p_0(Instrs0_18, (MR_Integer) 0, (MR_Integer) 0, (MR_Word) ((MR_Unsigned) 0U), &Instrs1_35);
          {
            ...
            MR_hl_field(3, Var_42, 1) = ((MR_Box) (R1_25));
            MR_hl_field(3, Var_42, 2) = ((MR_Box) (F1_26));
            MR_hl_field(3, Var_42, 3) = ((MR_Box) (BlockInstrs_34));
          }
          {
            BlockInstr_36 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
            MR_hl_field(0, BlockInstr_36, 0) = ((MR_Box) (Var_42));
            MR_hl_field(0, BlockInstr_36, 1) = ((MR_Box) ((MR_String) ""));
          }
          {
            Var_44 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(1, Var_44, 0) = ((MR_Box) (Instr0_17));
            MR_hl_field(1, Var_44, 1) = ((MR_Box) (Instrs1_35));
          }
          {
            MR_Word base;
            base = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            *HeadVar__5_5 = base;
            MR_hl_field(1, base, 0) = ((MR_Box) (BlockInstr_36));
            MR_hl_field(1, base, 1) = ((MR_Box) (Var_44));
          }
        }
        else
        {
          ...
          if (succeeded)
          {
...

            {
              ...
              MR_hl_field(1, Var_46, 0) = ((MR_Box) (Instr0_17));
              MR_hl_field(1, Var_46, 1) = ((MR_Box) (RevSofar_4));
            }
            ...
            ll_backend__wrap_blocks__wrap_instrs_5_p_0(Instrs0_18, (MR_Integer) 0, (MR_Integer) 0, (MR_Word) ((MR_Unsigned) 0U), &Instrs1_57);
            {
              ...
              MR_hl_field(3, Var_50, 1) = ((MR_Box) (R1_25));
              MR_hl_field(3, Var_50, 2) = ((MR_Box) (F1_26));
              MR_hl_field(3, Var_50, 3) = ((MR_Box) (BlockInstrs_56));
            }
            {
              BlockInstr_58 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
              MR_hl_field(0, BlockInstr_58, 0) = ((MR_Box) (Var_50));
              MR_hl_field(0, BlockInstr_58, 1) = ((MR_Box) ((MR_String) ""));
            }
            {
              MR_Word base;
              base = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              *HeadVar__5_5 = base;
              MR_hl_field(1, base, 0) = ((MR_Box) (BlockInstr_58));
              MR_hl_field(1, base, 1) = ((MR_Box) (Instrs1_57));
            }
          }
          else
          {
...

            {
              ...
              MR_hl_field(1, Var_52, 0) = ((MR_Box) (Instr0_17));
              MR_hl_field(1, Var_52, 1) = ((MR_Box) (RevSofar_4));
            }
      ...
      else
      {
        ...
        ll_backend__wrap_blocks__wrap_instrs_5_p_0(Instrs0_18, (MR_Integer) 0, (MR_Integer) 0, (MR_Word) ((MR_Unsigned) 0U), &Instrs1_62);
        {
          ...
          base = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          *HeadVar__5_5 = base;
          MR_hl_field(1, base, 0) = ((MR_Box) (Instr0_17));
          MR_hl_field(1, base, 1) = ((MR_Box) (Instrs1_62));
        }
      }
    }
    break;
