...
#endif
MR_decl_label10(ll_backend__wrap_blocks__wrap_instrs_5_0, 86,7,6,5,3,12,16,15,18,21)
...
MR_BEGIN_MODULE(ll_backend__wrap_blocks_module0)
	...
	MR_init_label10(ll_backend__wrap_blocks__wrap_instrs_5_0,86,7,6,5,3,12,16,15,18,21)
...
MR_def_label(ll_backend__wrap_blocks__wrap_instrs_5_0,86)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_def_label(ll_backend__wrap_blocks__wrap_instrs_5_0,7)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_string_const("ll_backend.wrap_blocks", 22);
	MR_r2 = (MR_Word) MR_string_const("predicate \140ll_backend.wrap_blocks.wrap_instrs\'/5", 48);
	MR_r3 = (MR_Word) MR_string_const("procedure ends without closing block", 36);
...
MR_def_label(ll_backend__wrap_blocks__wrap_instrs_5_0,5)
	...
	MR_r1 = (MR_Word) MR_string_const("ll_backend.wrap_blocks", 22);
	MR_r2 = (MR_Word) MR_string_const("predicate \140ll_backend.wrap_blocks.wrap_instrs\'/5", 48);
	MR_r3 = (MR_Word) MR_string_const("procedure ends with fallthrough", 31);
	MR_succip_word = MR_sv(6);
	MR_decr_sp(6);
	MR_np_tailcall_ent(require__unexpected_3_0);
...
MR_def_label(ll_backend__wrap_blocks__wrap_instrs_5_0,27)
	...
	MR_r3 = MR_sv(4);
	MR_succip_word = MR_sv(6);
	MR_GOTO_LAB(ll_backend__wrap_blocks__wrap_instrs_5_0_i86);
	}
...
void mercury__ll_backend__wrap_blocks__init_threadscope_string_table(void);
#endif
...
void mercury__ll_backend__wrap_blocks__write_out_proc_statics(FILE *deep_fp, FILE *procrep_fp)
{
	MR_write_out_module_proc_reps_start(procrep_fp, &mercury_data__module_layout__ll_backend__wrap_blocks);
