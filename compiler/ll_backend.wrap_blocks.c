...
{
  {
    ll_backend__wrap_blocks__wrap_instrs_5_p_0(Instrs0_3, (MR_Integer) 0, (MR_Integer) 0, (MR_Word) ((MR_Integer) 0), Instrs_4);
  }
}
  ...
  while (MR_TRUE)
  {
    ...
    if ((HeadVar__1_1 == (MR_Word) ((MR_Integer) 0)))
    {
      *HeadVar__5_5 = (MR_Word) ((MR_Integer) 0);
      if ((RevSofar_4 == (MR_Word) ((MR_Integer) 0)))
      {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          ll_backend__wrap_blocks__wrap_instrs_5_p_0(Instrs0_18, (MR_Integer) 0, (MR_Integer) 0, (MR_Word) ((MR_Integer) 0), &Instrs1_35);
          {
        ...
        else
        {
          ...
          if (succeeded)
          {
            ...
            ll_backend__wrap_blocks__wrap_instrs_5_p_0(Instrs0_18, (MR_Integer) 0, (MR_Integer) 0, (MR_Word) ((MR_Integer) 0), &Instrs1_57);
            {
      ...
      else
      {
        ...
        ll_backend__wrap_blocks__wrap_instrs_5_p_0(Instrs0_18, (MR_Integer) 0, (MR_Integer) 0, (MR_Word) ((MR_Integer) 0), &Instrs1_62);
        {
          MR_Word base;
          base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
          *HeadVar__5_5 = base;
