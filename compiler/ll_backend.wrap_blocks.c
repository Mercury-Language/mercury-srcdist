      ...
      else
      {
        ...
        if (ll_backend__wrap_blocks__succeeded)
        {
          ...
          if (ll_backend__wrap_blocks__succeeded)
          {
            ...
            MR_Word ll_backend__wrap_blocks__Var_44;
            MR_Word ll_backend__wrap_blocks__Var_46;
            ...
            {
              ll_backend__wrap_blocks__Var_44 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(3), ll_backend__wrap_blocks__Var_44, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 0));
              MR_hl_field(MR_mktag(3), ll_backend__wrap_blocks__Var_44, 1) = ((MR_Box) (ll_backend__wrap_blocks__R1_27));
              MR_hl_field(MR_mktag(3), ll_backend__wrap_blocks__Var_44, 2) = ((MR_Box) (ll_backend__wrap_blocks__F1_28));
              MR_hl_field(MR_mktag(3), ll_backend__wrap_blocks__Var_44, 3) = ((MR_Box) (ll_backend__wrap_blocks__BlockInstrs_36));
            }
            {
              ll_backend__wrap_blocks__BlockInstr_38 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
              MR_hl_field(MR_mktag(0), ll_backend__wrap_blocks__BlockInstr_38, 0) = ((MR_Box) (ll_backend__wrap_blocks__Var_44));
              MR_hl_field(MR_mktag(0), ll_backend__wrap_blocks__BlockInstr_38, 1) = ((MR_Box) ((MR_String) ""));
            }
            {
              ll_backend__wrap_blocks__Var_46 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), ll_backend__wrap_blocks__Var_46, 0) = ((MR_Box) (ll_backend__wrap_blocks__Instr0_19));
              MR_hl_field(MR_mktag(1), ll_backend__wrap_blocks__Var_46, 1) = ((MR_Box) (ll_backend__wrap_blocks__Instrs1_37));
            }
            {
              MR_Word base;
              ...
              *ll_backend__wrap_blocks__HeadVar__5_5 = base;
              ...
              MR_hl_field(MR_mktag(1), base, 1) = ((MR_Box) (ll_backend__wrap_blocks__Var_46));
            }
          }
          else
          {
            MR_Word ll_backend__wrap_blocks__Var_47;

            ll_backend__wrap_blocks__Var_47 = ll_backend__opt_util__can_instr_fall_through_1_f_0(ll_backend__wrap_blocks__Uinstr0_25);
            ll_backend__wrap_blocks__succeeded = (ll_backend__wrap_blocks__Var_47 == (MR_Integer) 0);
            if (ll_backend__wrap_blocks__succeeded)
            {
              MR_Word ll_backend__wrap_blocks__Var_48;
              MR_Word ll_backend__wrap_blocks__Var_52;
              ...
              {
                ll_backend__wrap_blocks__Var_48 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(1), ll_backend__wrap_blocks__Var_48, 0) = ((MR_Box) (ll_backend__wrap_blocks__Instr0_19));
                MR_hl_field(MR_mktag(1), ll_backend__wrap_blocks__Var_48, 1) = ((MR_Box) (ll_backend__wrap_blocks__RevSofar_4));
              }
              mercury__list__reverse_2_p_0((MR_Word) &ll_backend__llds__ll_backend__llds__type_ctor_info_instruction_0, ll_backend__wrap_blocks__Var_48, &ll_backend__wrap_blocks__BlockInstrs_58);
              ...
              {
                ll_backend__wrap_blocks__Var_52 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), ll_backend__wrap_blocks__Var_52, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 0));
                MR_hl_field(MR_mktag(3), ll_backend__wrap_blocks__Var_52, 1) = ((MR_Box) (ll_backend__wrap_blocks__R1_27));
                MR_hl_field(MR_mktag(3), ll_backend__wrap_blocks__Var_52, 2) = ((MR_Box) (ll_backend__wrap_blocks__F1_28));
                MR_hl_field(MR_mktag(3), ll_backend__wrap_blocks__Var_52, 3) = ((MR_Box) (ll_backend__wrap_blocks__BlockInstrs_58));
              }
              {
                ll_backend__wrap_blocks__BlockInstr_60 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
                MR_hl_field(MR_mktag(0), ll_backend__wrap_blocks__BlockInstr_60, 0) = ((MR_Box) (ll_backend__wrap_blocks__Var_52));
            ...
            {
              MR_Word ll_backend__wrap_blocks__Var_54;

              {
                ll_backend__wrap_blocks__Var_54 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(1), ll_backend__wrap_blocks__Var_54, 0) = ((MR_Box) (ll_backend__wrap_blocks__Instr0_19));
                MR_hl_field(MR_mktag(1), ll_backend__wrap_blocks__Var_54, 1) = ((MR_Box) (ll_backend__wrap_blocks__RevSofar_4));
              }
              /* direct tailcall eliminated */
              {
                MR_Word ll_backend__wrap_blocks__next_value_of_HeadVar__1_1 = ll_backend__wrap_blocks__Instrs0_20;
                MR_Integer ll_backend__wrap_blocks__next_value_of_HeadVar__2_2 = ll_backend__wrap_blocks__R1_27;
                MR_Integer ll_backend__wrap_blocks__next_value_of_HeadVar__3_3 = ll_backend__wrap_blocks__F1_28;
                MR_Word ll_backend__wrap_blocks__next_value_of_RevSofar_4 = ll_backend__wrap_blocks__Var_54;

                ll_backend__wrap_blocks__HeadVar__1_1 = ll_backend__wrap_blocks__next_value_of_HeadVar__1_1;
                ll_backend__wrap_blocks__HeadVar__2_2 = ll_backend__wrap_blocks__next_value_of_HeadVar__2_2;
                ll_backend__wrap_blocks__HeadVar__3_3 = ll_backend__wrap_blocks__next_value_of_HeadVar__3_3;
                ll_backend__wrap_blocks__RevSofar_4 = ll_backend__wrap_blocks__next_value_of_RevSofar_4;
              }
              continue;
            }
          }
