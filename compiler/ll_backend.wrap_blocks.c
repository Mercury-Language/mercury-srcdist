  ...
  MR_Word * HeadVar__5_5)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      MR_Integer R1_25;
      MR_Integer F1_26;
      MR_String _Comment0_24 = ((MR_String) ((MR_hl_field(MR_mktag(0), Instr0_17, (MR_Integer) 1))));
      ...
      if (succeeded)
      {
        if (((((MR_tag((MR_Word) Uinstr0_23)) == (MR_mktag((MR_Integer) 3)))) && ((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), Uinstr0_23, (MR_Integer) 0))) == (MR_Integer) 5))))
          succeeded = MR_TRUE;
        else
        if (((((MR_tag((MR_Word) Uinstr0_23)) == (MR_mktag((MR_Integer) 3)))) && ((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), Uinstr0_23, (MR_Integer) 0))) == (MR_Integer) 3))))
          succeeded = MR_TRUE;
        else
          succeeded = MR_FALSE;
        if (succeeded)
        {
          ...
          ll_backend__wrap_blocks__wrap_instrs_5_p_0(Instrs0_18, (MR_Integer) 0, (MR_Integer) 0, (MR_Word) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))), &Instrs1_35);
          {
          ...
          {
            BlockInstr_36 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
        ...
        else
        {
          ...
          if (succeeded)
          {
            ...
            ll_backend__wrap_blocks__wrap_instrs_5_p_0(Instrs0_18, (MR_Integer) 0, (MR_Integer) 0, (MR_Word) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))), &Instrs1_57);
            {
              Var_50 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL));
            ...
            {
              BlockInstr_58 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
      ...
      else
      {
        ...
        ll_backend__wrap_blocks__wrap_instrs_5_p_0(Instrs0_18, (MR_Integer) 0, (MR_Integer) 0, (MR_Word) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))), &Instrs1_62);
        {
          MR_Word base;
          base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
          *HeadVar__5_5 = base;
