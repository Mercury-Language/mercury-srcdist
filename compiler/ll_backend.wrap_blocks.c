        ...
        if (succeeded)
        {
          ...
          else
          {
            ...
            else
            {
              ...
              {
                MR_Word next_value_of_HeadVar__1_1 = Instrs0_20;
                MR_Integer next_value_of_HeadVar__2_2 = R1_27;
                MR_Integer next_value_of_HeadVar__3_3 = F1_28;
                MR_Word next_value_of_RevSofar_4 = Var_54;
