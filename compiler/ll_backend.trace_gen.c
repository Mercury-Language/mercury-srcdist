...
ll_backend__trace_gen__IntroducedFrom__pred__generate_tailrec_reset_slots_code__1028__1_2_p_0(
  MR_Word MaybeFromFullLval_17,
  MR_Word HeadVar__2_60);

static MR_bool MR_CALL 
ll_backend__trace_gen__IntroducedFrom__pred__generate_tailrec_reset_slots_code__1022__1_2_p_0(
  MR_Word MaybeRedoLabelLval_16,
  MR_Word HeadVar__2_56);

static MR_bool MR_CALL 
ll_backend__trace_gen__IntroducedFrom__pred__maybe_setup_redo_event__1264__1_2_p_0(
  MR_Word Lval_8,
...
static /* final */ const MR_Box ll_backend__trace_gen_scalar_common_2[8][3] = {
  ...
  /* row   4 */
  {
    ...
    ((MR_Box) (MR_mkword(MR_mktag(1), &ll_backend__trace_gen_scalar_common_3[1])))
  },
  /* row   5 */
  {
    ((MR_Box) (MR_Word) ((MR_Unsigned) 4U)),
    ((MR_Box) (&ll_backend__trace_gen_scalar_common_3[2])),
    ((MR_Box) (MR_mkword(MR_mktag(1), &ll_backend__trace_gen_scalar_common_3[3])))
  },
  /* row   6 */
  {
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = ll_backend__trace_gen__IntroducedFrom__pred__maybe_setup_redo_event__1264__1_2_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))));
  return succeeded;
}
  ...
  MR_Word * Code_4)
{
  ...
  else
  {
...

    {
      ...
      MR_hl_field(MR_mktag(0), Var_16, 4) = ((MR_Box) (MR_mkword(MR_mktag(3), &ll_backend__trace_gen_scalar_common_1[12])));
    }
  ...
  MR_Word * STATE_VARIABLE_CLD_69)
{
  ...
  MR_Word TVarList_49;
  MR_Word VarLvals_50;
  MR_Word TVarLocnSets_51;
  MR_Word TVarLocnSet_52;
  MR_Word TVarLocns_53;
  MR_Word TVarLvals_54;
  MR_Word LiveLvals_55;
  MR_Word LiveLvalSet_56;
  MR_Word VarInfoSet_57;
  MR_Word LayoutLabelInfo_58;
  MR_String TraceStmt0_59;
  MR_String TraceStmt_61;
  MR_Word TraceComponents_64;
  MR_Word TraceCode_65;
  ...
  MR_Word Var_122;
  MR_Word InstMap_37;
  MR_Word RedoLabel_63;
  MR_Word TraceInfo_62;
  MR_Word Var_95;

  ll_backend__code_info__get_next_label_3_p_0(Label_20, STATE_VARIABLE_CI_0_66, &STATE_VARIABLE_CI_70_70);
  ll_backend__code_loc_dep__get_known_variables_2_p_0(STATE_VARIABLE_CLD_0_68, &LiveVars0_25);
    ...
    case (MR_Integer) 0:
      {
        ...
        STATE_VARIABLE_CI_74_74 = STATE_VARIABLE_CI_70_70;
      }
      break;
    case (MR_Integer) 1:
      {
        ...
        else
        {
          ...
          ll_backend__trace_gen__generate_tailrec_reset_slots_code_4_p_0(TailRecTraceInfo_31, &TailRecResetCode_28, STATE_VARIABLE_CI_70_70, &STATE_VARIABLE_CI_74_74);
        }
      }
      break;
    case (MR_Integer) 2:
      {
        ...
        ResumeVars_33 = ll_backend__code_loc_dep__current_resume_point_vars_1_f_0(STATE_VARIABLE_CLD_0_68);
  ...
  ll_backend__code_info__get_var_table_2_p_0(STATE_VARIABLE_CI_74_74, &VarTable_36);
  ll_backend__code_loc_dep__get_instmap_2_p_0(STATE_VARIABLE_CLD_0_68, &InstMap_37);
  Var_75 = mercury__set__init_0_f_0((MR_Word) (&ll_backend__trace_gen_scalar_common_1[3]));
  ll_backend__trace_gen__f_85_110_117_115_101_100_65_114_103_115_95_95_112_114_101_100_95_95_116_114_97_99_101_95_112_114_111_100_117_99_101_95_118_97_114_115_95_95_91_51_44_32_52_93_95_48_11_p_0(LiveVars_26, VarTable_36, Var_75, &TVarSet_38, (MR_Word) ((MR_Unsigned) 0U), &VarInfoList_39, &ProduceCode_40, STATE_VARIABLE_CLD_0_68, STATE_VARIABLE_CLD_69);
  ll_backend__code_loc_dep__max_reg_in_use_3_p_0(*STATE_VARIABLE_CLD_69, &MaxRegR_41, &MaxRegF_42);
  ll_backend__code_info__get_max_regs_in_use_at_trace_3_p_0(STATE_VARIABLE_CI_74_74, &MaxTraceRegR0_43, &MaxTraceRegF0_44);
  ...
  if (succeeded)
    STATE_VARIABLE_CI_78_78 = STATE_VARIABLE_CI_74_74;
  else
    ll_backend__code_info__set_max_regs_in_use_at_trace_4_p_0(MaxTraceRegR_45, MaxTraceRegF_46, STATE_VARIABLE_CI_74_74, &STATE_VARIABLE_CI_78_78);
  ll_backend__code_loc_dep__variable_locations_2_p_0(*STATE_VARIABLE_CLD_69, &VarLocs_47);
  ll_backend__code_info__get_proc_info_2_p_0(STATE_VARIABLE_CI_78_78, &ProcInfo_48);
  mercury__set__to_sorted_list_2_p_0((MR_Word) (&ll_backend__trace_gen_scalar_common_1[3]), TVarSet_38, &TVarList_49);
  ll_backend__continuation_info__find_typeinfos_for_tvars_4_p_0(ProcInfo_48, TVarList_49, VarLocs_47, TVarDataMap_21);
  VarLvals_50 = mercury__list__map_2_f_0((MR_Word) (&ll_backend__continuation_info__ll_backend__continuation_info__type_ctor_info_layout_var_info_0), (MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_lval_0), (MR_Word) (&ll_backend__trace_gen_scalar_common_2[6]), VarInfoList_39);
  mercury__map__values_2_p_0((MR_Word) (&ll_backend__trace_gen_scalar_common_1[3]), (MR_Word) (&ll_backend__trace_gen_scalar_common_1[4]), *TVarDataMap_21, &TVarLocnSets_51);
  TVarLocnSet_52 = mercury__set__union_list_1_f_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_layout_locn_0), TVarLocnSets_51);
  mercury__set__to_sorted_list_2_p_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_layout_locn_0), TVarLocnSet_52, &TVarLocns_53);
  TVarLvals_54 = mercury__list__map_2_f_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_layout_locn_0), (MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_lval_0), (MR_Word) (&ll_backend__trace_gen_scalar_common_2[7]), TVarLocns_53);
  mercury__list__append_3_p_1((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_lval_0), VarLvals_50, TVarLvals_54, &LiveLvals_55);
  LiveLvalSet_56 = mercury__set__list_to_set_1_f_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_lval_0), LiveLvals_55);
  mercury__set__list_to_set_2_p_0((MR_Word) (&ll_backend__continuation_info__ll_backend__continuation_info__type_ctor_info_layout_var_info_0), VarInfoList_39, &VarInfoSet_57);
  {
    LayoutLabelInfo_58 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(MR_mktag(0), LayoutLabelInfo_58, 0) = ((MR_Box) (VarInfoSet_57));
    MR_hl_field(MR_mktag(0), LayoutLabelInfo_58, 1) = ((MR_Box) (*TVarDataMap_21));
  }
  if ((MaybeUserInfo_19 == (MR_Word) ((MR_Unsigned) 0U)))
    TraceStmt0_59 = (MR_String) "\t\tMR_EVENT_SYS\n";
  else
    TraceStmt0_59 = (MR_String) "\t\tMR_EVENT_USER\n";
  ...
  TraceStmt_61 = mercury__string__f_43_43_2_f_0((MR_String) "\t\t/* port ", Var_82);
  ll_backend__code_info__add_trace_layout_for_label_9_p_0(*Label_20, Context_17, Port_14, HideEvent_18, Path_27, MaybeUserInfo_19, LayoutLabelInfo_58, STATE_VARIABLE_CI_78_78, &STATE_VARIABLE_CI_92_92);
  ll_backend__code_info__set_proc_trace_events_3_p_0((MR_Integer) 1, STATE_VARIABLE_CI_92_92, &STATE_VARIABLE_CI_94_94);
  ...
  if (succeeded)
  {
    ...
    if (succeeded)
    {
      TraceInfo_62 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MaybeTraceInfo_16, (MR_Integer) 0))));
      Var_95 = ((MR_Word) ((MR_hl_field(MR_mktag(0), TraceInfo_62, (MR_Integer) 8))));
      succeeded = (Var_95 != (MR_Word) ((MR_Unsigned) 0U));
      if (succeeded)
        RedoLabel_63 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Var_95, (MR_Integer) 0))));
    }
  }
  if (succeeded)
    ll_backend__code_info__add_trace_layout_for_label_9_p_0(RedoLabel_63, Context_17, (MR_Integer) 2, HideEvent_18, Path_27, (MR_Word) ((MR_Unsigned) 0U), LayoutLabelInfo_58, STATE_VARIABLE_CI_94_94, STATE_VARIABLE_CI_67);
  else
    *STATE_VARIABLE_CI_67 = STATE_VARIABLE_CI_94_94;
  {
    Var_102 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(MR_mktag(1), Var_102, 0) = ((MR_Box) (LiveLvalSet_56));
  }
  {
    Var_99 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(MR_mktag(3), Var_99, 0) = ((MR_Box) ((MR_Unsigned) 1U));
    MR_hl_field(MR_mktag(3), Var_99, 1) = (MR_Box) (((((MR_Unsigned) ((MR_Integer) 1) << 2)) | (MR_Unsigned) ((MR_Integer) 1)));
    MR_hl_field(MR_mktag(3), Var_99, 2) = ((MR_Box) (Var_102));
    MR_hl_field(MR_mktag(3), Var_99, 3) = ((MR_Box) (TraceStmt_61));
  }
  {
    TraceComponents_64 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(MR_mktag(1), TraceComponents_64, 0) = ((MR_Box) (Var_99));
    MR_hl_field(MR_mktag(1), TraceComponents_64, 1) = ((MR_Box) ((MR_Unsigned) 0U));
  }
  {
    ...
    MR_hl_field(MR_mktag(3), Var_106, 1) = ((MR_Box) (*Label_20));
  }
  {
    Var_105 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(MR_mktag(0), Var_105, 0) = ((MR_Box) (Var_106));
    MR_hl_field(MR_mktag(0), Var_105, 1) = ((MR_Box) ((MR_String) "A label to hang trace liveness on"));
  }
  {
    Var_115 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(MR_mktag(1), Var_115, 0) = ((MR_Box) (*Label_20));
  }
  {
    Var_110 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (10 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(MR_mktag(3), Var_110, 0) = ((MR_Box) ((MR_Unsigned) 27U));
    MR_hl_field(MR_mktag(3), Var_110, 1) = ((MR_Box) ((MR_Unsigned) 0U));
    MR_hl_field(MR_mktag(3), Var_110, 2) = ((MR_Box) (TraceComponents_64));
    MR_hl_field(MR_mktag(3), Var_110, 3) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 0));
    MR_hl_field(MR_mktag(3), Var_110, 4) = ((MR_Box) ((MR_Unsigned) 0U));
    MR_hl_field(MR_mktag(3), Var_110, 5) = ((MR_Box) ((MR_Unsigned) 0U));
    MR_hl_field(MR_mktag(3), Var_110, 6) = ((MR_Box) (Var_115));
    MR_hl_field(MR_mktag(3), Var_110, 7) = ((MR_Box) ((MR_Unsigned) 0U));
    MR_hl_field(MR_mktag(3), Var_110, 8) = ((MR_Box) (Var_115));
    MR_hl_field(MR_mktag(3), Var_110, 9) = (MR_Box) (((((MR_Unsigned) ((MR_Integer) 1) << 1)) | (MR_Unsigned) ((MR_Integer) 1)));
  }
  {
  ...
  TraceCode_65 = mercury__cord__from_list_1_f_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_instruction_0), Var_104);
  Var_122 = mercury__cord__f_43_43_2_f_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_instruction_0), TailRecResetCode_28, TraceCode_65);
  ...
  MR_Word * STATE_VARIABLE_CLD_11)
{
  ...
  else
  {
    ...
    MR_Word Vars_25 = ((MR_Word) ((MR_hl_field(MR_mktag(1), HeadVar__1_1, (MR_Integer) 1))));
    MR_Word VarCode_31;
    MR_Word VarsCode_32;
    MR_Word Entry_34;
    MR_Word IsDummy_35;
    ...
    hlds__var_table__lookup_var_entry_3_p_0(VarTable_2, Var_24, &Entry_34);
    IsDummy_35 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Entry_34, (MR_Integer) 2))) & (MR_Integer) 1);
    switch (IsDummy_35) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        {
      ...
      case (MR_Integer) 1:
        {
          ...
          ll_backend__code_loc_dep__produce_variable_in_reg_or_stack_5_p_0(Var_24, &VarCode_31, &Lval_64, STATE_VARIABLE_CLD_0_10, &STATE_VARIABLE_CLD_44_44);
          Name_65 = ((MR_String) ((MR_hl_field(MR_mktag(0), Entry_34, (MR_Integer) 0))));
          Type_66 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Entry_34, (MR_Integer) 1))));
          {
            LiveType_69 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), LiveType_69, 0) = ((MR_Box) (Var_24));
            MR_hl_field(MR_mktag(1), LiveType_69, 1) = ((MR_Box) (Name_65));
            MR_hl_field(MR_mktag(1), LiveType_69, 2) = ((MR_Box) (Type_66));
            MR_hl_field(MR_mktag(1), LiveType_69, 3) = NULL;
          }
          {
            Var_72 = (MR_Word) MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL);
            MR_hl_field(MR_mktag(0), Var_72, 0) = ((MR_Box) (Lval_64));
          }
          {
            VarInfo_36 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
            MR_hl_field(MR_mktag(0), VarInfo_36, 0) = ((MR_Box) (Var_72));
            MR_hl_field(MR_mktag(0), VarInfo_36, 1) = ((MR_Box) (LiveType_69));
            MR_hl_field(MR_mktag(0), VarInfo_36, 2) = ((MR_Box) ((MR_String) "trace"));
          }
          parse_tree__prog_type__type_vars_in_type_2_p_0(Type_66, &TypeVars_70);
          mercury__set__insert_list_3_p_0((MR_Word) (&ll_backend__trace_gen_scalar_common_1[3]), TypeVars_70, STATE_VARIABLE_TVars_0_5, &STATE_VARIABLE_TVars_43_43);
          {
            STATE_VARIABLE_VarInfos_45_45 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), STATE_VARIABLE_VarInfos_45_45, 0) = ((MR_Box) (VarInfo_36));
            MR_hl_field(MR_mktag(1), STATE_VARIABLE_VarInfos_45_45, 1) = ((MR_Box) (STATE_VARIABLE_VarInfos_0_7));
          }
        }
        break;
    }
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = ll_backend__trace_gen__IntroducedFrom__pred__generate_tailrec_reset_slots_code__1028__1_2_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))));
  return succeeded;
}
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = ll_backend__trace_gen__IntroducedFrom__pred__generate_tailrec_reset_slots_code__1022__1_2_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))));
  return succeeded;
}
  ...
  MR_Word * STATE_VARIABLE_CI_43)
{
  ...
  else
  {
...

    {
      ...
      MR_hl_field(MR_mktag(3), Var_74, 2) = ((MR_Box) (&ll_backend__trace_gen_scalar_common_3[0]));
    }
    {
  ...
  else
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(3), Var_83, 3) = ((MR_Box) (MR_mkword(MR_mktag(3), &ll_backend__trace_gen_scalar_common_1[14])));
    }
    {
  ...
  else
  {
    ...
    switch (CodeModel_6) {
      ...
      case (MR_Integer) 1:
        ...
        break;
      case (MR_Integer) 2:
        CallDepthLval_9 = (MR_Word) (MR_mkword(MR_mktag(3), &ll_backend__trace_gen_scalar_common_1[20]));
        break;
    }
  ...
  MR_Word * TraceCode_6)
{
  ...
  else
  {
...

    {
      ...
      MR_hl_field(MR_mktag(3), Var_115, 2) = ((MR_Box) (&ll_backend__trace_gen_scalar_common_3[0]));
    }
    {
  ...
  MR_Word * RedoLayoutSlot_4)
{
  switch (CodeModel_3) {
    ...
    case (MR_Integer) 1:
      ...
      break;
    case (MR_Integer) 2:
      *RedoLayoutSlot_4 = (MR_Word) (MR_mkword(MR_mktag(3), &ll_backend__trace_gen_scalar_common_1[21]));
      break;
  }
}
  ...
  switch (CodeModel_3) {
    ...
    case (MR_Integer) 1:
      *CallDepthSlot_4 = (MR_Word) (MR_mkword(MR_mktag(3), &ll_backend__trace_gen_scalar_common_1[19]));
      break;
    case (MR_Integer) 2:
      *CallDepthSlot_4 = (MR_Word) (MR_mkword(MR_mktag(3), &ll_backend__trace_gen_scalar_common_1[20]));
      break;
  }
}
  ...
  switch (CodeModel_3) {
    ...
    case (MR_Integer) 1:
      *CallNumSlot_4 = (MR_Word) (MR_mkword(MR_mktag(3), &ll_backend__trace_gen_scalar_common_1[17]));
      break;
    case (MR_Integer) 2:
      *CallNumSlot_4 = (MR_Word) (MR_mkword(MR_mktag(3), &ll_backend__trace_gen_scalar_common_1[18]));
      break;
  }
}
  ...
  switch (CodeModel_3) {
    ...
    case (MR_Integer) 1:
      *EventNumSlot_4 = (MR_Word) (MR_mkword(MR_mktag(3), &ll_backend__trace_gen_scalar_common_1[15]));
      break;
    case (MR_Integer) 2:
      *EventNumSlot_4 = (MR_Word) (MR_mkword(MR_mktag(3), &ll_backend__trace_gen_scalar_common_1[16]));
      break;
  }
}
  ...
  MR_Word * STATE_VARIABLE_CI_60)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_13, (MR_Integer) 155, &TraceTableIo_21);
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_13, (MR_Integer) 261, &UseTrail_36);
  switch (UseTrail_36) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 0:
      {
  ...
  MR_Word * MaybeTableVarInfo_12)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_10, (MR_Integer) 155, &TraceTableIo_15);
    ...
    case (MR_Integer) 1:
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_10, (MR_Integer) 261, &UseTrail_21);
        switch (UseTrail_21) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 0:
  ...
  MR_Word * STATE_VARIABLE_ProcInfo_15)
{
  ...
  Var_16 = libs__trace_params__is_exec_trace_enabled_at_eff_trace_level_4_f_0(ModuleInfo_7, PredInfo0_8, STATE_VARIABLE_ProcInfo_0_14, TraceLevel_10);
  ...
  MR_Word * FailVars_6)
{
  ...
  MR_Word ArgInfos_12;
  MR_Word _VarSet_8;
  MR_Word FailVarsList_13;

  hlds__hlds_pred__proc_info_get_headvars_2_p_0(ProcInfo_5, &HeadVars_7);
  hlds__hlds_pred__proc_info_get_varset_vartypes_3_p_0(ProcInfo_5, &_VarSet_8, &VarTypes_9);
  hlds__hlds_pred__proc_info_get_argmodes_2_p_0(ProcInfo_5, &Modes_10);
  check_hlds__mode_util__mode_list_get_final_insts_3_p_0(ModuleInfo_4, Modes_10, &FinalInsts_11);
  hlds__hlds_pred__proc_info_arg_info_2_p_0(ProcInfo_5, &ArgInfos_12);
  succeeded = ll_backend__trace_gen__build_fail_vars_6_p_0(ModuleInfo_4, VarTypes_9, HeadVars_7, FinalInsts_11, ArgInfos_12, &FailVarsList_13);
  if (succeeded)
    parse_tree__set_of_var__list_to_set_2_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), FailVarsList_13, FailVars_6);
  else
    {
  ...
  MR_Word * HeadVar__6_6)
{
  ...
  {
    MR_Word Var_11 = ((MR_Word) ((MR_hl_field(MR_mktag(1), HeadVar__3_3, (MR_Integer) 0))));
    MR_Word Vars_12 = ((MR_Word) ((MR_hl_field(MR_mktag(1), HeadVar__3_3, (MR_Integer) 1))));
    MR_Word Inst_13;
    MR_Word Insts_14;
    MR_Word Info_15;
    MR_Word Infos_16;
    ...
    if (succeeded)
    {
      Inst_13 = ((MR_Word) ((MR_hl_field(MR_mktag(1), HeadVar__4_4, (MR_Integer) 0))));
      Insts_14 = ((MR_Word) ((MR_hl_field(MR_mktag(1), HeadVar__4_4, (MR_Integer) 1))));
      succeeded = (HeadVar__5_5 != (MR_Word) ((MR_Unsigned) 0U));
      if (succeeded)
      {
        Info_15 = ((MR_Word) ((MR_hl_field(MR_mktag(1), HeadVar__5_5, (MR_Integer) 0))));
        Infos_16 = ((MR_Word) ((MR_hl_field(MR_mktag(1), HeadVar__5_5, (MR_Integer) 1))));
        succeeded = ll_backend__trace_gen__build_fail_vars_6_p_0(ModuleInfo_1, VarTypes_2, Vars_12, Insts_14, Infos_16, &FailVars0_18);
        if (succeeded)
        {
          ArgMode_20 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Info_15, (MR_Integer) 1))) & (MR_Integer) 3);
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              hlds__vartypes__lookup_var_type_3_p_0(VarTypes_2, Var_11, &Type_21);
              Var_22 = check_hlds__type_util__is_type_a_dummy_2_f_0(ModuleInfo_1, Type_21);
