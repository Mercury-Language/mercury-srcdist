...
{
  {
    ...
    {
      libs__globals__lookup_bool_option_3_p_0(ll_backend__trace_gen__Globals_13, (MR_Integer) 229, &ll_backend__trace_gen__UseTrail_36);
    }
      ...
      case (MR_Integer) 1:
        {
          ...
          {
            libs__globals__lookup_bool_option_3_p_0(ll_backend__trace_gen__Globals_10, (MR_Integer) 229, &ll_backend__trace_gen__UseTrail_21);
          }
