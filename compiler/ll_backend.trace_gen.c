      ...
      case (MR_Integer) 1:
        {
          ...
          Name_51 = ((MR_String) ((MR_hl_field(MR_mktag(0), Entry_34, (MR_Integer) 0))));
          Type_52 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Entry_34, (MR_Integer) 1))));
          {
            LiveType_55 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), LiveType_55, 0) = ((MR_Box) (Var_24));
            MR_hl_field(MR_mktag(1), LiveType_55, 1) = ((MR_Box) (Name_51));
            MR_hl_field(MR_mktag(1), LiveType_55, 2) = ((MR_Box) (Type_52));
            MR_hl_field(MR_mktag(1), LiveType_55, 3) = NULL;
          }
          {
            Var_57 = (MR_Word) MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL);
            MR_hl_field(MR_mktag(0), Var_57, 0) = ((MR_Box) (Lval_50));
          }
          {
            VarInfo_36 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
            MR_hl_field(MR_mktag(0), VarInfo_36, 0) = ((MR_Box) (Var_57));
            MR_hl_field(MR_mktag(0), VarInfo_36, 1) = ((MR_Box) (LiveType_55));
            MR_hl_field(MR_mktag(0), VarInfo_36, 2) = ((MR_Box) ((MR_String) "trace"));
          }
          parse_tree__prog_type__type_vars_in_type_2_p_0(Type_52, &TypeVars_56);
