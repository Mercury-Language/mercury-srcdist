  ...
  MR_Word * STATE_VARIABLE_CI_57)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_9, (MR_Integer) 296, &TraceTableIo_18);
  ...
  MR_Word * MaybeTableVarInfo_10)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_6, (MR_Integer) 296, &TraceTableIo_12);
