  ...
  MR_Word * STATE_VARIABLE_CI_60)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_13, (MR_Integer) 154, &TraceTableIo_21);
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_13, (MR_Integer) 260, &UseTrail_36);
  switch (UseTrail_36) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 0:
      {
  ...
  MR_Word * MaybeTableVarInfo_12)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_10, (MR_Integer) 154, &TraceTableIo_15);
    ...
    case (MR_Integer) 1:
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_10, (MR_Integer) 260, &UseTrail_21);
        switch (UseTrail_21) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 0:
