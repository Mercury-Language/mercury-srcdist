  ...
  MR_Word * FailVars_6)
{
  ...
  hlds__hlds_pred__proc_info_arg_info_2_p_0(ProcInfo_5, &ArgInfos_11);
  succeeded = ll_backend__trace_gen__build_fail_vars_6_p_0(ModuleInfo_4, VarTypes_8, HeadVars_7, FinalInsts_10, ArgInfos_11, &FailVarsList_12);
  if (succeeded)
