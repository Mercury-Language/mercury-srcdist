  ...
  MR_Word * STATE_VARIABLE_CLD_70)
{
  ...
  ll_backend__code_info__get_var_table_2_p_0(STATE_VARIABLE_CI_75_75, &VarTable_36);
  ...
  ll_backend__code_info__get_max_regs_in_use_at_trace_3_p_0(STATE_VARIABLE_CI_75_75, &MaxTraceRegR0_43, &MaxTraceRegF0_44);
  ...
  if (succeeded)
    ...
    ll_backend__code_info__set_max_regs_in_use_at_trace_4_p_0(MaxTraceRegR_45, MaxTraceRegF_46, STATE_VARIABLE_CI_75_75, &STATE_VARIABLE_CI_79_79);
      ...
      case (MR_Integer) 1:
        {
          ...
          ll_backend__code_loc_dep__produce_variable_in_reg_or_stack_5_p_0(Var_24, &VarCode_31, &Lval_53, STATE_VARIABLE_CLD_0_10, &STATE_VARIABLE_CLD_44_44);
          Name_54 = ((MR_String) ((MR_hl_field(MR_mktag(0), Entry_34, (MR_Integer) 0))));
          Type_55 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Entry_34, (MR_Integer) 1))));
          {
            LiveType_58 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), LiveType_58, 0) = ((MR_Box) (Var_24));
            MR_hl_field(MR_mktag(1), LiveType_58, 1) = ((MR_Box) (Name_54));
            MR_hl_field(MR_mktag(1), LiveType_58, 2) = ((MR_Box) (Type_55));
            MR_hl_field(MR_mktag(1), LiveType_58, 3) = NULL;
          }
          {
            Var_60 = (MR_Word) MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL);
            MR_hl_field(MR_mktag(0), Var_60, 0) = ((MR_Box) (Lval_53));
          }
          {
            VarInfo_36 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
            MR_hl_field(MR_mktag(0), VarInfo_36, 0) = ((MR_Box) (Var_60));
            MR_hl_field(MR_mktag(0), VarInfo_36, 1) = ((MR_Box) (LiveType_58));
            MR_hl_field(MR_mktag(0), VarInfo_36, 2) = ((MR_Box) ((MR_String) "trace"));
          }
          parse_tree__prog_type__type_vars_in_type_2_p_0(Type_55, &TypeVars_59);
          mercury__set__insert_list_3_p_0((MR_Word) (&ll_backend__trace_gen_scalar_common_1[3]), TypeVars_59, STATE_VARIABLE_TVars_0_5, &STATE_VARIABLE_TVars_43_43);
          {
