...
MR_decl_static(ll_backend__trace_gen__IntroducedFrom__pred__maybe_setup_redo_event__1164__1_2_0)
...
MR_def_label(ll_backend__trace_gen__generate_tailrec_reset_slots_code_4_0,16)
	...
	MR_tfield(0, MR_r1, 1) = (MR_Word) MR_ENTRY_AP(ll_backend__trace_gen__IntroducedFrom__pred__generate_tailrec_reset_slots_code__933__1_2_0);
	MR_tfield(0, MR_r1, 2) = (MR_Integer) 2;
	MR_tfield(0, MR_r1, 3) = MR_tfield(0, MR_sv(1), 2);
	MR_tfield(0, MR_r1, 4) = (MR_Word) MR_tbmkword(0, 0);
	MR_r2 = (MR_Word) MR_string_const("ll_backend.trace_gen", 20);
	MR_r3 = (MR_Word) MR_string_const("predicate \140ll_backend.trace_gen.generate_tailrec_reset_slots_code\'/4", 68);
...
MR_def_label(ll_backend__trace_gen__maybe_setup_redo_event_2_0,38)
	...
	MR_tfield(0, MR_r1, 1) = (MR_Word) MR_ENTRY_AP(ll_backend__trace_gen__IntroducedFrom__pred__maybe_setup_redo_event__1164__1_2_0);
	MR_tfield(0, MR_r1, 2) = (MR_Integer) 2;
...
MR_BEGIN_MODULE(ll_backend__trace_gen_module36)
	MR_init_entry1(ll_backend__trace_gen__IntroducedFrom__pred__maybe_setup_redo_event__1164__1_2_0);
	MR_INIT_PROC_LAYOUT_ADDR(mercury__ll_backend__trace_gen__IntroducedFrom__pred__maybe_setup_redo_event__1164__1_2_0);
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'IntroducedFrom__pred__maybe_setup_redo_event__1164__1'/2 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(ll_backend__trace_gen__IntroducedFrom__pred__maybe_setup_redo_event__1164__1_2_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
