...
#line 62 "ll_backend.trace_gen.c"

#endif
#line 65 "ll_backend.trace_gen.c"
...
MR_define_entry(mercury__ll_backend__trace_gen__generate_external_event_code_6_0);
	...
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tempr1 = (MR_Word) &MR_tfield(0, (MR_Word *) &mercury_vector_common_4_0, (MR_Integer) MR_r1);
	MR_sv(1) = MR_r2;
	MR_sv(2) = MR_r3;
...
MR_def_label(ll_backend__trace_gen__maybe_setup_redo_event_2_0,34)
	...
	MR_tfield(0, MR_r1, 1) = (MR_Word) MR_ENTRY_AP(ll_backend__trace_gen__IntroducedFrom__pred__maybe_setup_redo_event__1197__1_2_0);
