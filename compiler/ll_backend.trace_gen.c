...
MR_decl_label10(ll_backend__trace_gen__generate_event_code_11_0, 2,3,6,5,8,9,10,12,7,15)
MR_decl_label10(ll_backend__trace_gen__generate_event_code_11_0, 17,20,19,14,22,24,4,25,26,27)
MR_decl_label10(ll_backend__trace_gen__generate_event_code_11_0, 29,30,31,32,33,34,35,37,38,39)
MR_decl_label10(ll_backend__trace_gen__generate_event_code_11_0, 40,41,43,45,46,47,49,50,51,52)
MR_decl_label10(ll_backend__trace_gen__generate_event_code_11_0, 55,54,56,57,58,59,60,61,62,63)
MR_decl_label7(ll_backend__trace_gen__generate_event_code_11_0, 64,65,70,66,92,93,94)
...
MR_BEGIN_MODULE(ll_backend__trace_gen_module15)
	...
	MR_init_label10(ll_backend__trace_gen__generate_event_code_11_0,2,3,6,5,8,9,10,12,7,15)
	MR_init_label10(ll_backend__trace_gen__generate_event_code_11_0,17,20,19,14,22,24,4,25,26,27)
	MR_init_label10(ll_backend__trace_gen__generate_event_code_11_0,29,30,31,32,33,34,35,37,38,39)
	MR_init_label10(ll_backend__trace_gen__generate_event_code_11_0,40,41,43,45,46,47,49,50,51,52)
	MR_init_label10(ll_backend__trace_gen__generate_event_code_11_0,55,54,56,57,58,59,60,61,62,63)
	MR_init_label7(ll_backend__trace_gen__generate_event_code_11_0,64,65,70,66,92,93,94)
MR_BEGIN_CODE
...
MR_def_label(ll_backend__trace_gen__generate_event_code_11_0,34)
	...
	if ((MR_sv(12) != MR_sv(13))) {
		MR_GOTO_LAB(ll_backend__trace_gen__generate_event_code_11_0_i35);
	}
	if ((MR_sv(9) != MR_r1)) {
		MR_GOTO_LAB(ll_backend__trace_gen__generate_event_code_11_0_i35);
	}
	MR_r1 = MR_sv(15);
	MR_GOTO_LAB(ll_backend__trace_gen__generate_event_code_11_0_i37);
...
MR_def_label(ll_backend__trace_gen__generate_event_code_11_0,52)
	...
	if (MR_LTAGS_TESTR(MR_sv(14),0,0)) {
		MR_GOTO_LAB(ll_backend__trace_gen__generate_event_code_11_0_i55);
	}
	MR_r1 = MR_sv(1);
...
MR_def_label(ll_backend__trace_gen__generate_event_code_11_0,93)
	...
	MR_np_call_localret_ent(fn__f_99_111_114_100_95_95_43_43_2_0,
		ll_backend__trace_gen__generate_event_code_11_0_i94);
MR_def_label(ll_backend__trace_gen__generate_event_code_11_0,94)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
