  ...
  MR_Word * STATE_VARIABLE_CI_57)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_9, (MR_Integer) 267, &UseTrail_33);
  switch (UseTrail_33) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 0:
      {
    ...
    case (MR_Integer) 1:
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_6, (MR_Integer) 267, &UseTrail_19);
        switch (UseTrail_19) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 0:
