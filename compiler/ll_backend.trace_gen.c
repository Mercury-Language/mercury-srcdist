...
{
  {
    ...
    {
      libs__globals__lookup_bool_option_3_p_0(ll_backend__trace_gen__Globals_13, (MR_Integer) 124, &ll_backend__trace_gen__TraceTableIo_21);
    }
    {
...
{
  {
    ...
    {
      libs__globals__lookup_bool_option_3_p_0(ll_backend__trace_gen__Globals_10, (MR_Integer) 124, &ll_backend__trace_gen__TraceTableIo_15);
    }
    {
