      ...
      case (MR_Integer) 1:
        {
          ...
          ll_backend__code_loc_dep__produce_variable_in_reg_or_stack_5_p_0(Var_24, &VarCode_31, &Lval_61, STATE_VARIABLE_CLD_0_10, &STATE_VARIABLE_CLD_44_44);
          Name_62 = ((MR_String) ((MR_hl_field(MR_mktag(0), Entry_34, (MR_Integer) 0))));
          Type_63 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Entry_34, (MR_Integer) 1))));
          {
            LiveType_66 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), LiveType_66, 0) = ((MR_Box) (Var_24));
            MR_hl_field(MR_mktag(1), LiveType_66, 1) = ((MR_Box) (Name_62));
            MR_hl_field(MR_mktag(1), LiveType_66, 2) = ((MR_Box) (Type_63));
            MR_hl_field(MR_mktag(1), LiveType_66, 3) = NULL;
          }
          {
            Var_69 = (MR_Word) MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL);
            MR_hl_field(MR_mktag(0), Var_69, 0) = ((MR_Box) (Lval_61));
          }
          {
            VarInfo_36 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
            MR_hl_field(MR_mktag(0), VarInfo_36, 0) = ((MR_Box) (Var_69));
            MR_hl_field(MR_mktag(0), VarInfo_36, 1) = ((MR_Box) (LiveType_66));
            MR_hl_field(MR_mktag(0), VarInfo_36, 2) = ((MR_Box) ((MR_String) "trace"));
          }
          parse_tree__prog_type__type_vars_in_type_2_p_0(Type_63, &TypeVars_67);
          mercury__set__insert_list_3_p_0((MR_Word) (&ll_backend__trace_gen_scalar_common_1[3]), TypeVars_67, STATE_VARIABLE_TVars_0_5, &STATE_VARIABLE_TVars_43_43);
          {
