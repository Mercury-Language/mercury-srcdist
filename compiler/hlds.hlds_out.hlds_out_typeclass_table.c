...
static void MR_CALL 
hlds__hlds_out__hlds_out_typeclass_table__write_method_info_ppid_4_p_0(
  MR_Word MethodInfo_5,
  MR_Word Stream_6);
  ...
  MR_Box * wrapper_arg_4)
{
  ...
  parse_tree__parse_tree_out_type__mercury_output_constraint_6_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 4)))), ((MR_Word) (wrapper_arg_1)), ((MR_Word) (wrapper_arg_2)));
}
  ...
  MR_Word InstanceDefn_8)
{
  ...
  {
    PrintTerm_23 = (MR_Word) MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(0, PrintTerm_23, 0) = ((MR_Box) (&hlds__hlds_out__hlds_out_typeclass_table_scalar_common_6[1]));
    MR_hl_field(0, PrintTerm_23, 1) = ((MR_Box) (hlds__hlds_out__hlds_out_typeclass_table__write_instance_defn_5_p_0_1));
    MR_hl_field(0, PrintTerm_23, 2) = ((MR_Box) ((MR_Integer) 2));
    MR_hl_field(0, PrintTerm_23, 3) = ((MR_Box) (TVarSet_12));
    MR_hl_field(0, PrintTerm_23, 4) = ((MR_Box) (VarNamePrint_22));
  }
  parse_tree__parse_tree_out_misc__write_indent_4_p_0(Stream_7, (MR_Integer) 1);
  mercury__io__write_string_4_p_0(Stream_7, (MR_String) "% Types: ");
  parse_tree__parse_tree_out_info__write_out_list_6_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0), PrintTerm_23, (MR_String) ", ", Types_14, Stream_7);
  mercury__io__nl_3_p_0(Stream_7);
  parse_tree__parse_tree_out_misc__write_indent_4_p_0(Stream_7, (MR_Integer) 1);
  mercury__io__write_string_4_p_0(Stream_7, (MR_String) "% Original types: ");
  parse_tree__parse_tree_out_info__write_out_list_6_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0), PrintTerm_23, (MR_String) ", ", OriginalTypes_13, Stream_7);
  mercury__io__nl_3_p_0(Stream_7);
  parse_tree__parse_tree_out_misc__write_indent_4_p_0(Stream_7, (MR_Integer) 1);
  Var_55 = hlds__hlds_out__hlds_out_util__instance_import_status_to_string_1_f_0(InstanceStatus_11);
  mercury__io__write_string_4_p_0(Stream_7, (MR_String) "% Status: ");
  mercury__io__write_string_4_p_0(Stream_7, Var_55);
  mercury__io__write_string_4_p_0(Stream_7, (MR_String) "\n");
  if (!((MaybeSubsumedContext_16 == (MR_Word) ((MR_Unsigned) 0U))))
  {
    MR_Word SubsumedContext_24 = ((MR_Word) ((MR_hl_field(1, MaybeSubsumedContext_16, (MR_Integer) 0))));
    MR_String Var_63;

    parse_tree__parse_tree_out_misc__write_indent_4_p_0(Stream_7, (MR_Integer) 1);
    Var_63 = hlds__hlds_out__hlds_out_util__context_to_brief_string_1_f_0(SubsumedContext_24);
  ...
  mercury__io__write_string_4_p_0(Stream_7, (MR_String) "% Constraints: ");
  {
    ...
    MR_hl_field(0, Var_69, 0) = ((MR_Box) (&hlds__hlds_out__hlds_out_typeclass_table_scalar_common_6[0]));
    MR_hl_field(0, Var_69, 1) = ((MR_Box) (hlds__hlds_out__hlds_out_typeclass_table__write_instance_defn_5_p_0_2));
    MR_hl_field(0, Var_69, 2) = ((MR_Box) ((MR_Integer) 2));
    MR_hl_field(0, Var_69, 3) = ((MR_Box) (TVarSet_12));
    MR_hl_field(0, Var_69, 4) = ((MR_Box) (VarNamePrint_22));
  }
  parse_tree__parse_tree_out_info__write_out_list_6_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_constraint_0), Var_69, (MR_String) ", ", Constraints_15, Stream_7);
  mercury__io__nl_3_p_0(Stream_7);
  parse_tree__parse_tree_out_misc__write_indent_4_p_0(Stream_7, (MR_Integer) 1);
  ...
  {
    MR_Word Methods_25 = ((MR_Word) ((MR_hl_field(1, Body_18, (MR_Integer) 0))));

    mercury__io__write_string_4_p_0(Stream_7, (MR_String) "% Instance methods:\n");
    hlds__hlds_out__hlds_out_typeclass_table__write_instance_methods_5_p_0(Stream_7, Methods_25, (MR_Integer) 1);
  }
  mercury__io__nl_3_p_0(Stream_7);
  if (!((MaybeMethodInfos_19 == (MR_Word) ((MR_Unsigned) 0U))))
  {
    MR_Word MethodInfos_26 = ((MR_Word) ((MR_hl_field(1, MaybeMethodInfos_19, (MR_Integer) 0))));

    parse_tree__parse_tree_out_misc__write_indent_4_p_0(Stream_7, (MR_Integer) 1);
    mercury__io__write_string_4_p_0(Stream_7, (MR_String) "% Procedures: ");
    mercury__io__write_line_4_p_0((MR_Word) (&hlds__hlds_out__hlds_out_typeclass_table_scalar_common_2[1]), Stream_7, ((MR_Box) (MethodInfos_26)));
  }
  ...
  MR_Integer STATE_VARIABLE_CurMethodNum_0_3)
{
  while (MR_TRUE)
  {
    ...
    if (!((HeadVar__2_2 == (MR_Word) ((MR_Unsigned) 0U))))
    {
      ...
      parse_tree__parse_tree_out_misc__write_indent_4_p_0(Stream_1, (MR_Integer) 1);
      Var_36 = parse_tree__parse_tree_out_misc__pred_or_func_to_str_1_f_0(PredOrFunc_19);
      Var_39 = mdbcomp__sym_name__sym_name_to_string_1_f_0(MethodSymName_20);
      mercury__io__write_string_4_p_0(Stream_1, (MR_String) "% method ");
      mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&hlds__hlds_out__hlds_out_typeclass_table_scalar_common_3[0]), STATE_VARIABLE_CurMethodNum_0_3, &Var_51);
      ...
      mercury__io__write_string_4_p_0(Stream_1, (MR_String) "/");
      mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&hlds__hlds_out__hlds_out_typeclass_table_scalar_common_3[0]), UserArityInt_22, &Var_67);
      ...
      if (!((Methods_13 == (MR_Word) ((MR_Unsigned) 0U))))
      {
        ...
        mercury__io__write_string_4_p_0(Stream_1, (MR_String) ",\n");
        STATE_VARIABLE_CurMethodNum_46_46 = (MR_Integer) ((MR_Unsigned) STATE_VARIABLE_CurMethodNum_0_3 + (MR_Unsigned) 1);
        // direct tailcall eliminated
        ;
        next_value_of_HeadVar__2_2 = Methods_13;
        next_value_of_STATE_VARIABLE_CurMethodNum_0_3 = STATE_VARIABLE_CurMethodNum_46_46;
  ...
  MR_Word HeadVar__3_3)
{
  ...
  parse_tree__parse_tree_out_sym_name__write_class_id_4_p_0(Stream_7, ClassId_8);
  mercury__io__write_string_4_p_0(Stream_7, (MR_String) ":\n");
  {
    Var_19 = (MR_Word) MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(0, Var_19, 0) = ((MR_Box) (&hlds__hlds_out__hlds_out_typeclass_table_scalar_common_4[2]));
  ...
  MR_Word Stream_6)
{
  MR_Word PredId_8;
  MR_Integer ProcId_9;
  MR_Integer PredInt_10;
  MR_Integer ProcInt_11;
  MR_Word Var_14 = ((MR_Word) ((MR_hl_field(0, MethodInfo_5, (MR_Integer) 2))));
  MR_String Var_28;
  MR_String Var_38;

  PredId_8 = ((MR_Word) ((MR_hl_field(0, Var_14, (MR_Integer) 0))));
  ProcId_9 = ((MR_Integer) ((MR_hl_field(0, Var_14, (MR_Integer) 1))));
  hlds__hlds_pred__pred_id_to_int_2_p_0(PredId_8, &PredInt_10);
  hlds__hlds_pred__proc_id_to_int_2_p_0(ProcId_9, &ProcInt_11);
  mercury__io__write_string_4_p_0(Stream_6, (MR_String) "proc(pred_id:");
  mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&hlds__hlds_out__hlds_out_typeclass_table_scalar_common_3[0]), PredInt_10, &Var_28);
  mercury__io__write_string_4_p_0(Stream_6, Var_28);
  mercury__io__write_string_4_p_0(Stream_6, (MR_String) ", proc_id:");
  mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&hlds__hlds_out__hlds_out_typeclass_table_scalar_common_3[0]), ProcInt_11, &Var_38);
  mercury__io__write_string_4_p_0(Stream_6, Var_38);
...
hlds__hlds_out__hlds_out_typeclass_table__hlds_output_fundep_4_p_0(
  ...
  MR_Word Stream_7)
{
  MR_Word Domain_5 = ((MR_Word) ((MR_hl_field(0, HeadVar__1_1, (MR_Integer) 0))));
  MR_Word Range_6 = ((MR_Word) ((MR_hl_field(0, HeadVar__1_1, (MR_Integer) 1))));
  ...
  MR_Box * wrapper_arg_4)
{
  ...
  hlds__hlds_out__hlds_out_typeclass_table__write_method_info_ppid_4_p_0(((MR_Word) (wrapper_arg_1)), ((MR_Word) (wrapper_arg_2)));
}
  ...
  MR_Word HeadVar__3_3)
{
  ...
  parse_tree__parse_tree_out_sym_name__write_class_id_4_p_0(Stream_7, ClassId_8);
  mercury__io__write_string_4_p_0(Stream_7, (MR_String) ":\n");
  TVarSet_12 = ((MR_Word) ((MR_hl_field(0, ClassDefn_9, (MR_Integer) 1))));
  Vars_14 = ((MR_Word) ((MR_hl_field(0, ClassDefn_9, (MR_Integer) 3))));
  Constraints_15 = ((MR_Word) ((MR_hl_field(0, ClassDefn_9, (MR_Integer) 4))));
  FunDeps_16 = ((MR_Word) ((MR_hl_field(0, ClassDefn_9, (MR_Integer) 5))));
  MethodInfos_19 = ((MR_Word) ((MR_hl_field(0, ClassDefn_9, (MR_Integer) 8))));
  Context_20 = ((MR_Word) ((MR_hl_field(0, ClassDefn_9, (MR_Integer) 9))));
  ...
  parse_tree__parse_tree_out_term__mercury_output_vars_vs_6_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_tvar_type_0), TVarSet_12, VarNamePrint_23, Vars_14, Stream_7);
  mercury__io__nl_3_p_0(Stream_7);
  mercury__io__write_string_4_p_0(Stream_7, (MR_String) "% Functional dependencies: ");
  parse_tree__parse_tree_out_info__write_out_list_6_p_0((MR_Word) (&hlds__hlds_class__hlds__hlds_class__type_ctor_info_hlds_class_fundep_0), (MR_Word) (&hlds__hlds_out__hlds_out_typeclass_table_scalar_common_1[2]), (MR_String) ", ", FunDeps_16, Stream_7);
  mercury__io__nl_3_p_0(Stream_7);
  mercury__io__write_string_4_p_0(Stream_7, (MR_String) "% Constraints: ");
  {
    Var_47 = (MR_Word) MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(0, Var_47, 0) = ((MR_Box) (&hlds__hlds_out__hlds_out_typeclass_table_scalar_common_6[0]));
    MR_hl_field(0, Var_47, 1) = ((MR_Box) (hlds__hlds_out__hlds_out_typeclass_table__write_class_defn_5_p_0_2));
    MR_hl_field(0, Var_47, 2) = ((MR_Box) ((MR_Integer) 2));
    MR_hl_field(0, Var_47, 3) = ((MR_Box) (TVarSet_12));
    MR_hl_field(0, Var_47, 4) = ((MR_Box) (VarNamePrint_23));
  }
  parse_tree__parse_tree_out_info__write_out_list_6_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_constraint_0), Var_47, (MR_String) ", ", Constraints_15, Stream_7);
  mercury__io__nl_3_p_0(Stream_7);
  mercury__io__write_string_4_p_0(Stream_7, (MR_String) "% Class Methods: ");
  parse_tree__parse_tree_out_info__write_out_list_6_p_0((MR_Word) (&hlds__hlds_class__hlds__hlds_class__type_ctor_info_method_info_0), (MR_Word) (&hlds__hlds_out__hlds_out_typeclass_table_scalar_common_1[3]), (MR_String) ", ", MethodInfos_19, Stream_7);
  mercury__io__nl_3_p_0(Stream_7);
  mercury__io__nl_3_p_0(Stream_7);
}
