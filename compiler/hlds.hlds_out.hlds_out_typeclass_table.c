  ...
  MR_Word * STATE_VARIABLE_State_36)
{
  ...
  MR_Word STATE_VARIABLE_State_1_38;
  MR_Word STATE_VARIABLE_State_2_41;
  MR_Word Var_43;
  MR_Word STATE_VARIABLE_State_3_49;
  MR_Word STATE_VARIABLE_State_4_56;
  MR_Word STATE_VARIABLE_State_5_63;
  MR_Word STATE_VARIABLE_State_6_70;
  MR_Word STATE_VARIABLE_State_7_78;
  MR_Word STATE_VARIABLE_State_9_92;
  MR_Word STATE_VARIABLE_State_13_108;
  MR_Word Var_166;
  MR_Word Var_167;
  MR_Word Var_169;
  MR_Word Var_171;
  ...
  mercury__string__builder__append_string_3_p_0((MR_String) "\n", STATE_VARIABLE_State_0_35, &STATE_VARIABLE_State_1_38);
  hlds__hlds_out__hlds_out_util__maybe_format_context_comment_5_p_0((MR_Unsigned) 1U, (MR_String) "", Context_18, STATE_VARIABLE_State_1_38, &STATE_VARIABLE_State_2_41);
  ...
  IndentStr_22 = libs__indent__indent2_string_1_f_0((MR_Unsigned) 1U);
  {
    ...
    MR_hl_field(0, Var_43, 0) = ((MR_Box) (&hlds__hlds_out__hlds_out_typeclass_table_scalar_common_6[5]));
    MR_hl_field(0, Var_43, 1) = ((MR_Box) (hlds__hlds_out__hlds_out_typeclass_table__format_instance_defn_4_p_0_1));
    MR_hl_field(0, Var_43, 2) = ((MR_Box) ((MR_Integer) 2));
    MR_hl_field(0, Var_43, 3) = ((MR_Box) (TVarSet_10));
    MR_hl_field(0, Var_43, 4) = ((MR_Box) (VarNamePrint_21));
  }
  TypeStrs_23 = mercury__list__map_2_f_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0), (MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), Var_43, Types_12);
  OriginalTypeStrs_24 = mercury__list__map_2_f_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0), (MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), Var_43, OriginalTypes_11);
  ...
  mercury__string__builder__append_string_3_p_0(IndentStr_22, STATE_VARIABLE_State_2_41, &Var_166);
  mercury__string__builder__append_string_3_p_0((MR_String) "% Types: ", Var_166, &Var_167);
  mercury__string__builder__append_string_3_p_0(TypesStr_25, Var_167, &Var_169);
  mercury__string__builder__append_string_3_p_0((MR_String) "\n", Var_169, &STATE_VARIABLE_State_3_49);
  mercury__string__builder__append_string_3_p_0(IndentStr_22, STATE_VARIABLE_State_3_49, &Var_171);
  mercury__string__builder__append_string_3_p_0((MR_String) "% Original types: ", Var_171, &Var_172);
  mercury__string__builder__append_string_3_p_0(OriginalTypesStr_26, Var_172, &Var_174);
  mercury__string__builder__append_string_3_p_0((MR_String) "\n", Var_174, &STATE_VARIABLE_State_4_56);
  InstanceStatusStr_27 = hlds__hlds_out__hlds_out_util__instance_import_status_to_string_1_f_0(InstanceStatus_9);
  mercury__string__builder__append_string_3_p_0(IndentStr_22, STATE_VARIABLE_State_4_56, &Var_176);
  mercury__string__builder__append_string_3_p_0((MR_String) "% Status: ", Var_176, &Var_177);
  mercury__string__builder__append_string_3_p_0(InstanceStatusStr_27, Var_177, &Var_179);
  mercury__string__builder__append_string_3_p_0((MR_String) "\n", Var_179, &STATE_VARIABLE_State_5_63);
  if ((MaybeSubsumedContext_14 == (MR_Word) ((MR_Unsigned) 0U)))
    STATE_VARIABLE_State_6_70 = STATE_VARIABLE_State_5_63;
  else
  {
    ...
    Var_74 = hlds__hlds_out__hlds_out_util__context_to_brief_string_1_f_0(SubsumedContext_28);
    mercury__string__builder__append_string_3_p_0(IndentStr_22, STATE_VARIABLE_State_5_63, &Var_181);
    mercury__string__builder__append_string_3_p_0((MR_String) "% Subsumed context: ", Var_181, &Var_182);
    mercury__string__builder__append_string_3_p_0(Var_74, Var_182, &Var_184);
    mercury__string__builder__append_string_3_p_0((MR_String) "\n", Var_184, &STATE_VARIABLE_State_6_70);
  }
  if ((Constraints_13 == (MR_Word) ((MR_Unsigned) 0U)))
  {
    MR_Word Var_191;

    mercury__string__builder__append_string_3_p_0(IndentStr_22, STATE_VARIABLE_State_6_70, &Var_191);
    mercury__string__builder__append_string_3_p_0((MR_String) "% Constraints: none\n", Var_191, &STATE_VARIABLE_State_7_78);
  }
  else
  {
    MR_Word ConstraintStrs_31;
    MR_String ConstraintsStr_32;
    MR_Word Var_81;
    MR_Word Var_186;
    MR_Word Var_187;
    MR_Word Var_189;

    {
      ...
      MR_hl_field(0, Var_81, 0) = ((MR_Box) (&hlds__hlds_out__hlds_out_typeclass_table_scalar_common_6[6]));
      MR_hl_field(0, Var_81, 1) = ((MR_Box) (hlds__hlds_out__hlds_out_typeclass_table__format_instance_defn_4_p_0_2));
      MR_hl_field(0, Var_81, 2) = ((MR_Box) ((MR_Integer) 2));
      MR_hl_field(0, Var_81, 3) = ((MR_Box) (TVarSet_10));
      MR_hl_field(0, Var_81, 4) = ((MR_Box) (VarNamePrint_21));
    }
    ConstraintStrs_31 = mercury__list__map_2_f_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_constraint_0), (MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), Var_81, Constraints_13);
    ConstraintsStr_32 = mercury__string__join_list_2_f_0((MR_String) ", ", ConstraintStrs_31);
    mercury__string__builder__append_string_3_p_0(IndentStr_22, STATE_VARIABLE_State_6_70, &Var_186);
    mercury__string__builder__append_string_3_p_0((MR_String) "% Constraints: ", Var_186, &Var_187);
    mercury__string__builder__append_string_3_p_0(ConstraintsStr_32, Var_187, &Var_189);
    mercury__string__builder__append_string_3_p_0((MR_String) "\n", Var_189, &STATE_VARIABLE_State_7_78);
  }
  if ((Body_16 == (MR_Word) ((MR_Unsigned) 0U)))
  {
    MR_Word Var_195;

    mercury__string__builder__append_string_3_p_0(IndentStr_22, STATE_VARIABLE_State_7_78, &Var_195);
    mercury__string__builder__append_string_3_p_0((MR_String) "% abstract\n", Var_195, &STATE_VARIABLE_State_9_92);
  }
  else
  {
    MR_Word Methods_33 = ((MR_Word) ((MR_hl_field(1, Body_16, 0))));
    MR_Word STATE_VARIABLE_State_10_97;
    MR_Word Var_193;

    mercury__string__builder__append_string_3_p_0(IndentStr_22, STATE_VARIABLE_State_7_78, &Var_193);
    mercury__string__builder__append_string_3_p_0((MR_String) "% Instance methods:\n", Var_193, &STATE_VARIABLE_State_10_97);
    hlds__hlds_out__hlds_out_typeclass_table__format_instance_methods_5_p_0(IndentStr_22, Methods_33, (MR_Integer) 1, STATE_VARIABLE_State_10_97, &STATE_VARIABLE_State_9_92);
  }
  if ((MaybeMethodInfos_17 == (MR_Word) ((MR_Unsigned) 0U)))
    STATE_VARIABLE_State_13_108 = STATE_VARIABLE_State_9_92;
  else
  {
    MR_Word MethodInfos_34 = ((MR_Word) ((MR_hl_field(1, MaybeMethodInfos_17, 0))));
    MR_Word STATE_VARIABLE_State_12_104;
    MR_Word Var_107;
    MR_Word Var_197;
    MR_Box conv3_STATE_VARIABLE_State_13_108;

    mercury__string__builder__append_string_3_p_0(IndentStr_22, STATE_VARIABLE_State_9_92, &Var_197);
    mercury__string__builder__append_string_3_p_0((MR_String) "% Procedures:\n", Var_197, &STATE_VARIABLE_State_12_104);
    {
      Var_107 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(0, Var_107, 0) = ((MR_Box) (&hlds__hlds_out__hlds_out_typeclass_table_scalar_common_6[3]));
      MR_hl_field(0, Var_107, 1) = ((MR_Box) (hlds__hlds_out__hlds_out_typeclass_table__format_instance_defn_4_p_0_3));
      MR_hl_field(0, Var_107, 2) = ((MR_Box) ((MR_Integer) 1));
      MR_hl_field(0, Var_107, 3) = ((MR_Box) (IndentStr_22));
    }
    mercury__list__foldl_4_p_2((MR_Word) (&hlds__hlds_class__hlds__hlds_class__type_ctor_info_method_info_0), (MR_Word) (&mercury__string__builder__string__builder__type_ctor_info_state_0), Var_107, MethodInfos_34, ((MR_Box) (STATE_VARIABLE_State_12_104)), &conv3_STATE_VARIABLE_State_13_108);
    STATE_VARIABLE_State_13_108 = ((MR_Word) (conv3_STATE_VARIABLE_State_13_108));
  }
  hlds__hlds_out__hlds_out_util__format_constraint_proof_map_6_p_0((MR_Unsigned) 1U, VarNamePrint_21, TVarSet_10, ProofMap_15, STATE_VARIABLE_State_13_108, STATE_VARIABLE_State_36);
}
  ...
  MR_Word * STATE_VARIABLE_State_5)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      MR_Word Var_24 = ((MR_Word) ((MR_hl_field(0, MethodName_16, 2))));
      ...
      UserArityInt_21 = (MR_Integer) (Var_24);
      ...
      mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&hlds__hlds_out__hlds_out_typeclass_table_scalar_common_5[0]), UserArityInt_21, &Var_73);
...
{
  MR_Box closure = closure_arg;
  MR_Word conv0_STATE_VARIABLE_State_36;

  hlds__hlds_out__hlds_out_typeclass_table__format_instance_defn_4_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) (wrapper_arg_1)), ((MR_Word) (wrapper_arg_2)), &conv0_STATE_VARIABLE_State_36);
  *wrapper_arg_3 = ((MR_Box) (conv0_STATE_VARIABLE_State_36));
}
  ...
  MR_Word * STATE_VARIABLE_State_18)
{
  ...
  hlds__pred_proc_id__pred_id_to_int_2_p_0(OrigPredId_13, &OrigPredInt_15);
  hlds__pred_proc_id__proc_id_to_int_2_p_0(OrigProcId_14, &OrigProcInt_16);
  ...
  MR_Word InstanceTable_8)
{
  ...
  hlds__hlds_out__hlds_out_typeclass_table__format_instances_4_p_0(Info_6, InstanceTable_8, State0_10, &State_11);
