  ...
  MR_Word * STATE_VARIABLE_State_34)
{
  ...
  mercury__string__builder__append_string_3_p_0(IndentStr_22, STATE_VARIABLE_State_2_39, &Var_158);
  ...
  mercury__string__builder__append_string_3_p_0((MR_String) "\n", Var_161, &STATE_VARIABLE_State_3_47);
  mercury__string__builder__append_string_3_p_0(IndentStr_22, STATE_VARIABLE_State_3_47, &Var_163);
  ...
  mercury__string__builder__append_string_3_p_0((MR_String) "\n", Var_166, &STATE_VARIABLE_State_4_54);
  InstanceStatusStr_27 = hlds__hlds_out__hlds_out_util__instance_import_status_to_string_1_f_0(InstanceStatus_9);
  mercury__string__builder__append_string_3_p_0(IndentStr_22, STATE_VARIABLE_State_4_54, &Var_168);
  ...
  mercury__string__builder__append_string_3_p_0((MR_String) "\n", Var_171, &STATE_VARIABLE_State_5_61);
  ...
  else
  {
    ...
    mercury__string__builder__append_string_3_p_0(IndentStr_22, STATE_VARIABLE_State_5_61, &Var_173);
    ...
    mercury__string__builder__append_string_3_p_0((MR_String) "\n", Var_176, &STATE_VARIABLE_State_6_68);
  }
  {
  ...
  mercury__string__builder__append_string_3_p_0(IndentStr_22, STATE_VARIABLE_State_6_68, &Var_178);
  ...
  mercury__string__builder__append_string_3_p_0((MR_String) "\n", Var_181, &STATE_VARIABLE_State_7_78);
  if ((Body_16 == (MR_Word) ((MR_Unsigned) 0U)))
  {
    MR_Word Var_185;

    mercury__string__builder__append_string_3_p_0(IndentStr_22, STATE_VARIABLE_State_7_78, &Var_185);
    mercury__string__builder__append_string_3_p_0((MR_String) "% abstract\n", Var_185, &STATE_VARIABLE_State_8_85);
  }
  else
  {
    ...
    mercury__string__builder__append_string_3_p_0(IndentStr_22, STATE_VARIABLE_State_7_78, &Var_183);
    mercury__string__builder__append_string_3_p_0((MR_String) "% Instance methods:\n", Var_183, &STATE_VARIABLE_State_9_90);
  ...
  else
  {
    ...
    mercury__string__builder__append_string_3_p_0(IndentStr_22, STATE_VARIABLE_State_8_85, &Var_187);
    mercury__string__builder__append_string_3_p_0((MR_String) "% Procedures:\n", Var_187, &STATE_VARIABLE_State_11_97);
    {
  ...
  MR_Word * STATE_VARIABLE_State_25)
{
  ...
  mercury__string__builder__append_string_3_p_0((MR_String) ":\n", Var_109, &STATE_VARIABLE_State_1_28);
  ...
  mercury__string__builder__append_string_3_p_0((MR_String) "% Vars: ", STATE_VARIABLE_State_2_34, &Var_111);
  mercury__string__builder__append_string_3_p_0(Var_39, Var_111, &Var_113);
  mercury__string__builder__append_string_3_p_0((MR_String) "\n", Var_113, &STATE_VARIABLE_State_3_37);
