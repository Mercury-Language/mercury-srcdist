  ...
  MR_Word * STATE_VARIABLE_State_34)
{
  ...
  mercury__string__builder__append_string_3_p_0((MR_String) "\n", STATE_VARIABLE_State_0_33, &STATE_VARIABLE_State_36_36);
  hlds__hlds_out__hlds_out_util__maybe_format_context_comment_5_p_0((MR_Unsigned) 1U, (MR_String) "", Context_18, STATE_VARIABLE_State_36_36, &STATE_VARIABLE_State_39_39);
  ...
  mercury__string__builder__append_string_3_p_0(IndentStr_22, STATE_VARIABLE_State_39_39, &Var_158);
  mercury__string__builder__append_string_3_p_0((MR_String) "% Types: ", Var_158, &Var_159);
  mercury__string__builder__append_string_3_p_0(TypesStr_25, Var_159, &Var_161);
  mercury__string__builder__append_string_3_p_0((MR_String) "\n", Var_161, &STATE_VARIABLE_State_47_47);
  mercury__string__builder__append_string_3_p_0(IndentStr_22, STATE_VARIABLE_State_47_47, &Var_163);
  mercury__string__builder__append_string_3_p_0((MR_String) "% Original types: ", Var_163, &Var_164);
  mercury__string__builder__append_string_3_p_0(OriginalTypesStr_26, Var_164, &Var_166);
  mercury__string__builder__append_string_3_p_0((MR_String) "\n", Var_166, &STATE_VARIABLE_State_54_54);
  InstanceStatusStr_27 = hlds__hlds_out__hlds_out_util__instance_import_status_to_string_1_f_0(InstanceStatus_9);
  mercury__string__builder__append_string_3_p_0(IndentStr_22, STATE_VARIABLE_State_54_54, &Var_168);
  mercury__string__builder__append_string_3_p_0((MR_String) "% Status: ", Var_168, &Var_169);
  mercury__string__builder__append_string_3_p_0(InstanceStatusStr_27, Var_169, &Var_171);
  mercury__string__builder__append_string_3_p_0((MR_String) "\n", Var_171, &STATE_VARIABLE_State_61_61);
  ...
  else
  {
    ...
    mercury__string__builder__append_string_3_p_0(IndentStr_22, STATE_VARIABLE_State_61_61, &Var_173);
    mercury__string__builder__append_string_3_p_0((MR_String) "% Subsumed context: ", Var_173, &Var_174);
    mercury__string__builder__append_string_3_p_0(Var_72, Var_174, &Var_176);
    mercury__string__builder__append_string_3_p_0((MR_String) "\n", Var_176, &STATE_VARIABLE_State_68_68);
  }
  {
  ...
  mercury__string__builder__append_string_3_p_0(IndentStr_22, STATE_VARIABLE_State_68_68, &Var_178);
  mercury__string__builder__append_string_3_p_0((MR_String) "% Constraints: ", Var_178, &Var_179);
  mercury__string__builder__append_string_3_p_0(ConstraintsStr_30, Var_179, &Var_181);
  mercury__string__builder__append_string_3_p_0((MR_String) "\n", Var_181, &STATE_VARIABLE_State_78_78);
  if ((Body_16 == (MR_Word) ((MR_Unsigned) 0U)))
  {
    MR_Word Var_185;

    mercury__string__builder__append_string_3_p_0(IndentStr_22, STATE_VARIABLE_State_78_78, &Var_185);
    mercury__string__builder__append_string_3_p_0((MR_String) "% abstract\n", Var_185, &STATE_VARIABLE_State_85_85);
  }
  else
  {
    ...
    mercury__string__builder__append_string_3_p_0(IndentStr_22, STATE_VARIABLE_State_78_78, &Var_183);
    mercury__string__builder__append_string_3_p_0((MR_String) "% Instance methods:\n", Var_183, &STATE_VARIABLE_State_90_90);
    hlds__hlds_out__hlds_out_typeclass_table__format_instance_methods_5_p_0(IndentStr_22, Methods_31, (MR_Integer) 1, STATE_VARIABLE_State_90_90, &STATE_VARIABLE_State_85_85);
  }
  ...
  else
  {
    ...
    mercury__string__builder__append_string_3_p_0(IndentStr_22, STATE_VARIABLE_State_85_85, &Var_187);
    mercury__string__builder__append_string_3_p_0((MR_String) "% Procedures:\n", Var_187, &STATE_VARIABLE_State_97_97);
    {
    ...
    mercury__list__foldl_4_p_2((MR_Word) (&hlds__hlds_class__hlds__hlds_class__type_ctor_info_method_info_0), (MR_Word) (&mercury__string__builder__string__builder__type_ctor_info_state_0), Var_100, MethodInfos_32, ((MR_Box) (STATE_VARIABLE_State_97_97)), &conv3_STATE_VARIABLE_State_101_101);
    STATE_VARIABLE_State_101_101 = ((MR_Word) (conv3_STATE_VARIABLE_State_101_101));
  }
  hlds__hlds_out__hlds_out_util__format_constraint_proof_map_6_p_0((MR_Unsigned) 1U, VarNamePrint_21, TVarSet_10, ProofMap_15, STATE_VARIABLE_State_101_101, STATE_VARIABLE_State_34);
}
  ...
  MR_Word * STATE_VARIABLE_State_25)
{
  ...
  mercury__string__builder__append_string_3_p_0((MR_String) "\n% ", STATE_VARIABLE_State_0_24, &Var_107);
  mercury__string__builder__append_string_3_p_0(Var_30, Var_107, &Var_109);
  mercury__string__builder__append_string_3_p_0((MR_String) ":\n", Var_109, &STATE_VARIABLE_State_28_28);
  hlds__hlds_out__hlds_out_util__maybe_format_context_comment_5_p_0((MR_Unsigned) 0U, (MR_String) "", Context_18, STATE_VARIABLE_State_28_28, &STATE_VARIABLE_State_34_34);
  ...
  mercury__string__builder__append_string_3_p_0((MR_String) "% Vars: ", STATE_VARIABLE_State_34_34, &Var_111);
  mercury__string__builder__append_string_3_p_0(Var_39, Var_111, &Var_113);
  mercury__string__builder__append_string_3_p_0((MR_String) "\n", Var_113, &STATE_VARIABLE_State_37_37);
