  ...
  MR_Integer CurMethodNum_4)
{
  while (MR_TRUE)
  {
    ...
    if (!((HeadVar__3_3 == (MR_Word) ((MR_Unsigned) 0U))))
    {
      ...
      mercury__io__write_string_4_p_0(Stream_1, IndentStr_2);
      mercury__io__write_string_4_p_0(Stream_1, (MR_String) "%   ");
      parse_tree__parse_tree_out_item__mercury_format_instance_method_4_p_0((MR_Word) (&hlds__hlds_out__hlds_out_typeclass_table_scalar_common_3[1]), Method_15, ((MR_Box) (Stream_1)), ((MR_Box) ((MR_Integer) 0)), &conv0_STATE_VARIABLE_IO_48_48);
