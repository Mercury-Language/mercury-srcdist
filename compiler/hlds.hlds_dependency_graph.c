...
hlds__hlds_dependency_graph__add_dependency_arcs_in_cons_6_p_0(
  MR_Word hlds__hlds_dependency_graph__TypeClassInfo_for_dependency_node_50,
  MR_Word hlds__hlds_dependency_graph__DepGraph_7,
  MR_Word hlds__hlds_dependency_graph__WhatEdges_8,
  MR_Word hlds__hlds_dependency_graph__Caller_9,
  MR_Word hlds__hlds_dependency_graph__ConsId_10,
  MR_Word hlds__hlds_dependency_graph__STATE_VARIABLE_DepArcs_0_46,
  MR_Word * hlds__hlds_dependency_graph__STATE_VARIABLE_DepArcs_47);
...
{
  {
    ...
    switch (MR_tag((MR_Word) hlds__hlds_dependency_graph__ConsId_10)) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        *hlds__hlds_dependency_graph__STATE_VARIABLE_DepArcs_47 = hlds__hlds_dependency_graph__STATE_VARIABLE_DepArcs_0_46;
        break;
      case (MR_Integer) 1:
        *hlds__hlds_dependency_graph__STATE_VARIABLE_DepArcs_47 = hlds__hlds_dependency_graph__STATE_VARIABLE_DepArcs_0_46;
        break;
          ...
          case (MR_Integer) 4:
            {
              ...
              MR_Word hlds__hlds_dependency_graph__Callee_59;
              MR_Word hlds__hlds_dependency_graph__TypeInfo_22_64;
              MR_Box hlds__hlds_dependency_graph__Var_60;
              ...
              hlds__hlds_dependency_graph__func_0 = ((MR_Box MR_CALL (*)(MR_Box, MR_Box)) (MR_hl_field(MR_mktag(0), (MR_hl_field(MR_mktag(0), hlds__hlds_dependency_graph__TypeClassInfo_for_dependency_node_50, (MR_Integer) 0)), (MR_Integer) 5)));
              {
                hlds__hlds_dependency_graph__Var_60 = hlds__hlds_dependency_graph__func_0(((MR_Box) hlds__hlds_dependency_graph__TypeClassInfo_for_dependency_node_50), ((MR_Box) (hlds__hlds_dependency_graph__PredProcId_14)));
              }
              {
                mercury__private_builtin__type_info_from_typeclass_info_3_p_0(hlds__hlds_dependency_graph__TypeClassInfo_for_dependency_node_50, (MR_Integer) 1, &hlds__hlds_dependency_graph__TypeInfo_22_64);
              }
              {
                hlds__hlds_dependency_graph__succeeded = mercury__digraph__search_key_3_p_0(hlds__hlds_dependency_graph__TypeInfo_22_64, hlds__hlds_dependency_graph__DepGraph_7, hlds__hlds_dependency_graph__Var_60, &hlds__hlds_dependency_graph__Callee_59);
              }
              if (hlds__hlds_dependency_graph__succeeded)
                hlds__hlds_dependency_graph__succeeded = (hlds__hlds_dependency_graph__WhatEdges_8 == (MR_Integer) 2);
              if (hlds__hlds_dependency_graph__succeeded)
                {
                  MR_Word hlds__hlds_dependency_graph__Var_62;

                  {
                    hlds__hlds_dependency_graph__Var_62 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
                    MR_hl_field(MR_mktag(0), hlds__hlds_dependency_graph__Var_62, 0) = ((MR_Box) (hlds__hlds_dependency_graph__Caller_9));
                    MR_hl_field(MR_mktag(0), hlds__hlds_dependency_graph__Var_62, 1) = ((MR_Box) (hlds__hlds_dependency_graph__Callee_59));
                  }
                  {
                    MR_Word base;
                    base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                    *hlds__hlds_dependency_graph__STATE_VARIABLE_DepArcs_47 = base;
                    MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (hlds__hlds_dependency_graph__Var_62));
                    MR_hl_field(MR_mktag(1), base, 1) = ((MR_Box) (hlds__hlds_dependency_graph__STATE_VARIABLE_DepArcs_0_46));
                  }
                }
              else
                *hlds__hlds_dependency_graph__STATE_VARIABLE_DepArcs_47 = hlds__hlds_dependency_graph__STATE_VARIABLE_DepArcs_0_46;
...
{
  {
    ...
    {
      hlds__hlds_dependency_graph__IntroducedFrom__pred__find_scc_entry_points__706__1_3_p_0(((MR_Word) (MR_hl_field(MR_mktag(0), hlds__hlds_dependency_graph__closure, (MR_Integer) 3))), ((MR_Word) hlds__hlds_dependency_graph__wrapper_arg_1), &hlds__hlds_dependency_graph__conv1_HeadVar__3_34);
    }
