...
hlds__hlds_dependency_graph__add_dependency_arcs_in_cons_6_p_0(
  MR_Word TypeClassInfo_for_dependency_node_41,
  MR_Word DepGraph_7,
  MR_Word WhatEdges_8,
  MR_Word Caller_9,
  MR_Word ConsId_10,
  MR_Word STATE_VARIABLE_DepArcs_0_38,
  MR_Word * STATE_VARIABLE_DepArcs_39);
...
{
  MR_Box closure = closure_arg;
  MR_Word conv0_STATE_VARIABLE_DepArcs_39;

  hlds__hlds_dependency_graph__add_dependency_arcs_in_cons_6_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 4)))), ((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 5)))), ((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 6)))), ((MR_Word) (wrapper_arg_1)), ((MR_Word) (wrapper_arg_2)), &conv0_STATE_VARIABLE_DepArcs_39);
  *wrapper_arg_3 = ((MR_Box) (conv0_STATE_VARIABLE_DepArcs_39));
}
  ...
  MR_Word * STATE_VARIABLE_DepArcs_39)
{
  ...
  switch (MR_tag((MR_Word) ConsId_10)) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 0:
      *STATE_VARIABLE_DepArcs_39 = STATE_VARIABLE_DepArcs_0_38;
      break;
    case (MR_Integer) 1:
      {
        MR_Word ShroudedPredProcId_12 = (MR_Word) (MR_body((MR_Word) (ConsId_10), (MR_Integer) 1));
        MR_Word PredProcId_13;
        MR_Word Callee_42;
        MR_Word TypeInfo_22_46;
        MR_Box Var_43;
        MR_Box MR_CALL (* func_0)(MR_Box, MR_Box);

        PredProcId_13 = hlds__hlds_pred__unshroud_pred_proc_id_1_f_0(ShroudedPredProcId_12);
        func_0 = ((MR_Box MR_CALL (*)(MR_Box, MR_Box)) ((MR_hl_field(0, (MR_hl_field(0, TypeClassInfo_for_dependency_node_41, (MR_Integer) 0)), (MR_Integer) 5))));
        Var_43 = func_0(((MR_Box) (TypeClassInfo_for_dependency_node_41)), ((MR_Box) (PredProcId_13)));
        mercury__private_builtin__type_info_from_typeclass_info_3_p_0(TypeClassInfo_for_dependency_node_41, (MR_Integer) 1, &TypeInfo_22_46);
        succeeded = mercury__digraph__search_key_3_p_0(TypeInfo_22_46, DepGraph_7, Var_43, &Callee_42);
        if (succeeded)
        ...
        if (succeeded)
        {
...

          {
            ...
            MR_hl_field(0, Var_44, 0) = ((MR_Box) (Caller_9));
            MR_hl_field(0, Var_44, 1) = ((MR_Box) (Callee_42));
          }
          {
            MR_Word base;
            base = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            *STATE_VARIABLE_DepArcs_39 = base;
            MR_hl_field(1, base, 0) = ((MR_Box) (Var_44));
            MR_hl_field(1, base, 1) = ((MR_Box) (STATE_VARIABLE_DepArcs_0_38));
          }
        }
        else
          *STATE_VARIABLE_DepArcs_39 = STATE_VARIABLE_DepArcs_0_38;
