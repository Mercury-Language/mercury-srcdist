  ...
  MR_Word Child_10)
{
  ...
  ProcLabel_30 = backend_libs__proc_label__make_proc_label_3_f_0(ModuleInfo_8, PPredId_12, PProcId_13);
  Var_31 = backend_libs__name_mangle__proc_label_to_c_string_2_f_0((MR_Integer) 1, ProcLabel_30);
  mercury__io__write_string_4_p_0(Stream_7, Var_31);
  mercury__io__write_string_4_p_0(Stream_7, (MR_String) "\t");
  ProcLabel_41 = backend_libs__proc_label__make_proc_label_3_f_0(ModuleInfo_8, CPredId_14, CProcId_15);
  Var_42 = backend_libs__name_mangle__proc_label_to_c_string_2_f_0((MR_Integer) 1, ProcLabel_41);
  mercury__io__write_string_4_p_0(Stream_7, Var_42);
  mercury__io__write_string_4_p_0(Stream_7, (MR_String) "\n");
}
            ...
            case (MR_Integer) 1:
              {
                ...
                hlds__hlds_dependency_graph__maybe_add_dependency_arc_7_p_0(TypeClassInfo_for_dependency_node_103, DepGraph_7, WhatEdges_8, EdgeKind_45, Caller_9, Var_91, STATE_VARIABLE_DepArcs_0_81, STATE_VARIABLE_DepArcs_82);
              }
              break;
          }
        }
        ...
        case (MR_Integer) 4:
          {
            ...
            Var_52 = func_0(((MR_Box) (TypeClassInfo_for_dependency_node_42)), ((MR_Box) (PredProcId_14)));
            mercury__private_builtin__type_info_from_typeclass_info_3_p_0(TypeClassInfo_for_dependency_node_42, (MR_Integer) 1, &TypeInfo_22_56);
            succeeded = mercury__digraph__search_key_3_p_0(TypeInfo_22_56, DepGraph_7, Var_52, &Callee_51);
            if (succeeded)
            ...
            if (succeeded)
            {
...

              {
                ...
                MR_hl_field(MR_mktag(0), Var_54, 0) = ((MR_Box) (Caller_9));
                MR_hl_field(MR_mktag(0), Var_54, 1) = ((MR_Box) (Callee_51));
              }
              {
                MR_Word base;
                base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_11)
{
  ...
  MR_Word Var_20;
  MR_Word Var_21;
  MR_Word MaybeDepInfo_35;
  MR_Box conv0_STATE_VARIABLE_IO_13;

  hlds__hlds_module__module_info_get_maybe_dependency_info_2_p_0(STATE_VARIABLE_ModuleInfo_0_10, &MaybeDepInfo_35);
  if ((MaybeDepInfo_35 == (MR_Word) ((MR_Unsigned) 0U)))
    hlds__hlds_dependency_graph__module_info_rebuild_dependency_info_3_p_0(STATE_VARIABLE_ModuleInfo_0_10, STATE_VARIABLE_ModuleInfo_11, &DepInfo_9);
  else
  {
    DepInfo_9 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MaybeDepInfo_35, (MR_Integer) 0))));
    *STATE_VARIABLE_ModuleInfo_11 = STATE_VARIABLE_ModuleInfo_0_10;
  }
