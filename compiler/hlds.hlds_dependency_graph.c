  ...
  MR_Box * wrapper_arg_2)
{
  ...
  hlds__hlds_dependency_graph__IntroducedFrom__pred__find_scc_entry_points__602__1_3_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) (wrapper_arg_1)), &conv1_HeadVar__3_34);
