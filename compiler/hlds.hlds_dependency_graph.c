...
static void MR_CALL 
hlds__hlds_dependency_graph__IntroducedFrom__pred__find_scc_entry_points__693__1_3_p_0(
...
{
  {
    ...
    {
      hlds__hlds_dependency_graph__IntroducedFrom__pred__find_scc_entry_points__693__1_3_p_0(((MR_Word) (MR_hl_field(MR_mktag(0), hlds__hlds_dependency_graph__closure, (MR_Integer) 3))), ((MR_Word) hlds__hlds_dependency_graph__wrapper_arg_1), &hlds__hlds_dependency_graph__conv1_HeadVar__3_34);
    }
