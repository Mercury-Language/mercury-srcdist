            ...
            case (MR_Integer) 1:
              {
                ...
                mercury__private_builtin__type_info_from_typeclass_info_3_p_0(TypeClassInfo_for_dependency_node_107, (MR_Integer) 1, &TypeInfo_22_114);
                succeeded = mercury__digraph__search_key_3_p_0(TypeInfo_22_114, DepGraph_7, Var_111, &Callee_110);
                if (succeeded)
                  switch (WhatEdges_8) {
                    default: /*NOTREACHED*/ MR_assert(0);
                    case (MR_Integer) 2:
        ...
        case (MR_Integer) 4:
          {
            ...
            mercury__private_builtin__type_info_from_typeclass_info_3_p_0(TypeClassInfo_for_dependency_node_43, (MR_Integer) 1, &TypeInfo_22_48);
            succeeded = mercury__digraph__search_key_3_p_0(TypeInfo_22_48, DepGraph_7, Var_45, &Callee_44);
            if (succeeded)
