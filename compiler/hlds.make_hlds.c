...
MR_BEGIN_MODULE(hlds__make_hlds_module1)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__hlds__make_hlds__add_new_proc_11_0);
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'add_new_proc'/11 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
...
MR_BEGIN_MODULE(hlds__make_hlds_module4)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__hlds__make_hlds__produce_instance_method_clauses_14_0);
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'produce_instance_method_clauses'/14 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
