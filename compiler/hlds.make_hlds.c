...
{
  {
    ...
    else
    {
      ...
      hlds__make_hlds____Compare____sec_info_0_0(&Var_8, ArgX1_4, ArgY1_5);
      succeeded = (Var_8 == (MR_Integer) 0);
      succeeded = !(succeeded);
      if (succeeded)
        *HeadVar__1_1 = Var_8;
      else
        mercury__builtin__compare_3_p_0(TypeInfo_for_T_11, HeadVar__1_1, ArgX2_6, ArgY2_7);
    }
  }
}
...
{
  {
    ...
    else
    {
      ...
      hlds__status____Compare____item_mercury_status_0_0(&Var_8, ArgX1_4, ArgY1_5);
      succeeded = (Var_8 == (MR_Integer) 0);
      succeeded = !(succeeded);
      if (succeeded)
        *HeadVar__1_1 = Var_8;
...
{
  hlds__make_hlds__add_special_pred__do_add_special_pred_decl_for_real_8_p_0(SpecialPredId_9, TVarSet_10, Type_11, TypeCtor_12, Context_13, Status0_14, STATE_VARIABLE_ModuleInfo_0_16, STATE_VARIABLE_ModuleInfo_17);
}
...
{
  hlds__make_hlds__add_special_pred__do_add_special_pred_for_real_9_p_0(SpecialPredId_10, TVarSet_11, Type0_12, TypeCtor_13, TypeBody_14, Context_15, Status0_16, STATE_VARIABLE_ModuleInfo_0_18, STATE_VARIABLE_ModuleInfo_19);
}
...
{
  hlds__make_hlds__add_pred__do_add_new_proc_14_p_0(Context_15, ItemNumber_16, Arity_17, InstVarSet_18, ArgModes_19, MaybeDeclaredArgModes_20, MaybeArgLives_21, DetismDecl_22, MaybeDet_23, IsAddressTaken_24, HasParallelConj_25, PredInfo0_26, PredInfo_27, ModeId_28);
}
