  ...
  MR_Word * STATE_VARIABLE_TVarRenaming_8)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      {
        MR_Word next_value_of_HeadVar__1_1 = TVars_20;
        MR_Word next_value_of_STATE_VARIABLE_TVarSet_0_3 = STATE_VARIABLE_TVarSet_36_36;
        MR_Word next_value_of_STATE_VARIABLE_TVarNameMap_0_5 = STATE_VARIABLE_TVarNameMap_37_37;
        MR_Word next_value_of_STATE_VARIABLE_TVarRenaming_0_7 = STATE_VARIABLE_TVarRenaming_34_34;
...
{
  {
    ...
    switch (MR_tag((MR_Word) Functor_4)) {
      ...
      case (MR_Integer) 0:
        {
...

          {
            ...
            MR_hl_field(MR_mktag(0), Var_16, 0) = ((MR_Box) (Name_7));
          }
          Var_17 = parse_tree__prog_data__cons_id_dummy_type_ctor_0_f_0();
          {
            MR_Word base;
            base = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL));
            *ConsId_6 = base;
      ...
      case (MR_Integer) 1:
        {
          ...
          MR_Word Var_15 = ((MR_Word) (MR_hl_field(MR_mktag(1), Functor_4, (MR_Integer) 3)));
              ...
              case (MR_Integer) 0:
                {
                  ...
                  succeeded = parse_tree__prog_util__source_integer_to_int_3_p_0(Base_8, Integer_9, &Int_11);
                  if (succeeded)
                  {
                    {
                      MR_Word base;
                      ...
                      *ConsId_6 = base;
                      ...
                      MR_hl_field(MR_mktag(3), base, 1) = ((MR_Box) (Int_11));
                    }
                    succeeded = MR_TRUE;
                  }
                }
              ...
              case (MR_Integer) 1:
                {
                  ...
                  succeeded = mercury__integer__to_uint_2_p_0(Integer_9, &UInt_12);
                  if (succeeded)
                  {
                    {
                      MR_Word base;
                      ...
                      *ConsId_6 = base;
                      ...
                      MR_hl_field(MR_mktag(3), base, 1) = ((MR_Box) (UInt_12));
                    }
                    succeeded = MR_TRUE;
                  }
                }
      ...
      case (MR_Integer) 2:
        {
          MR_String String_13 = ((MR_String) (MR_hl_field(MR_mktag(2), Functor_4, (MR_Integer) 0)));

          {
            ...
            *ConsId_6 = base;
            ...
            MR_hl_field(MR_mktag(3), base, 1) = ((MR_Box) (String_13));
          }
          succeeded = MR_TRUE;
        }
        break;
      case (MR_Integer) 3:
        switch (((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), Functor_4, (MR_Integer) 0)))) {
          ...
          case (MR_Integer) 0:
            {
              MR_Float Float_14 = MR_unbox_float((MR_hl_field(MR_mktag(3), Functor_4, (MR_Integer) 1)));

              {
                ...
                *ConsId_6 = base;
                ...
                MR_hl_field(MR_mktag(3), base, 1) = MR_box_float(Float_14);
              }
              succeeded = MR_TRUE;
            }
            break;
          case (MR_Integer) 1:
            {
              MR_String Name_18 = ((MR_String) (MR_hl_field(MR_mktag(3), Functor_4, (MR_Integer) 1)));
  ...
  MR_Word * STATE_VARIABLE_Strings_4)
{
  ...
  else
  {
    ...
    else
    {
      ...
      parse_tree__prog_util__IntroducedFrom__pred__make_pred_name__583__1_3_p_0(Var_23, T_29, &String_34);
      {
    ...
    parse_tree__prog_util__IntroducedFrom__pred__make_pred_name__583__1_3_p_0(Var_23, T_10, &String_15);
    {
      MR_Word base;
      base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
