...
static void MR_CALL 
parse_tree__prog_util__IntroducedFrom__pred__make_pred_name__280__1_3_p_0(
  MR_Word VarSet_18,
  ...
  MR_Word * STATE_VARIABLE_Strings_4)
{
  ...
  else
  {
    ...
    else
    {
      ...
      parse_tree__prog_util__IntroducedFrom__pred__make_pred_name__280__1_3_p_0(Var_23, T_29, &String_34);
      {
    ...
    parse_tree__prog_util__IntroducedFrom__pred__make_pred_name__280__1_3_p_0(Var_23, T_10, &String_15);
    {
      MR_Word base;
      base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
