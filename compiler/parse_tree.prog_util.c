...
static void MR_CALL 
parse_tree__prog_util__IntroducedFrom__pred__make_pred_name__575__1_3_p_0(
  MR_Word VarSet_18,
  ...
  MR_Word * STATE_VARIABLE_Strings_4)
{
  ...
  else
  {
    ...
    else
    {
      ...
      parse_tree__prog_util__IntroducedFrom__pred__make_pred_name__575__1_3_p_0(Var_23, T_29, &String_34);
      {
    ...
    parse_tree__prog_util__IntroducedFrom__pred__make_pred_name__575__1_3_p_0(Var_23, T_10, &String_15);
    {
      MR_Word base;
      base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
  ...
  MR_Word * Term_8)
{
  if (((MR_tag((MR_Word) SymName_5)) == (MR_mktag((MR_Integer) 1))))
  {
    ...
    parse_tree__prog_util__construct_qualified_term_with_context_4_p_0(TypeInfo_for_T_22, ModuleSymName_9, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), Context_7, &ModuleTerm_11);
    {
