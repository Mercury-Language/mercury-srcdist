        ...
        case (MR_Integer) 4:
          {
            ...
            Name_132 = ((MR_String) ((MR_hl_field(0, (MR_Word) (&parse_tree__prog_util_scalar_common_2[1]), 0))));
            {
              Var_131 = (MR_Word) MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL);
              MR_hl_field(0, Var_131, 0) = ((MR_Box) (Name_132));
            }
            {
              MR_Word base;
              ...
              *Term_6 = base;
              ...
              MR_hl_field(0, base, 1) = ((MR_Box) (ArgTerms_5));
              MR_hl_field(0, base, 2) = ((MR_Box) (Context_106));
            }
            succeeded = MR_TRUE;
          }
          break;
