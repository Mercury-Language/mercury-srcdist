...
{
  {
    ...
    else
    {
      ...
      Var_19 = (MR_Integer) ((MR_Unsigned) Cur_8 + (MR_Unsigned) (MR_Integer) 1);
  ...
  MR_Integer Arity_3)
{
  switch (HeadVar__1_1) {
    ...
    case (MR_Integer) 1:
      {
        *HeadVar__2_2 = (MR_Integer) ((MR_Unsigned) Arity_3 - (MR_Unsigned) (MR_Integer) 1);
      }
      break;
    case (MR_Integer) 0:
  ...
  MR_Integer * Arity_3)
{
  switch (HeadVar__1_1) {
    ...
    case (MR_Integer) 1:
      {
        *Arity_3 = (MR_Integer) ((MR_Unsigned) (MR_Integer) 1 + (MR_Unsigned) HeadVar__2_2);
      }
      break;
    case (MR_Integer) 0:
