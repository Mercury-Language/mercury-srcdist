    ...
    case (MR_Integer) 1:
      {
        ...
        SymName_46 = ((MR_Word) ((MR_hl_field(0, Var_51, 0))));
        ...
        case (MR_Integer) 4:
          {
            ...
            Name_81 = ((MR_String) ((MR_hl_field(0, (MR_Word) (&parse_tree__prog_util_scalar_common_2[1]), 0))));
            {
        ...
        case (MR_Integer) 5:
          {
            ...
            if (succeeded)
            {
              IntConst_4 = ((MR_Word) ((MR_hl_field(3, HeadVar__1_1, 1))));
              switch (MR_tag((MR_Word) IntConst_4)) {
                default: /*NOTREACHED*/ MR_assert(0);
                case (MR_Integer) 0:
                  {
                    MR_Integer Int_6 = ((MR_Integer) ((MR_hl_field(0, IntConst_4, 0))));
                    MR_Word Var_16;
                ...
                case (MR_Integer) 1:
                  {
                    MR_Unsigned UInt_11 = ((MR_Unsigned) ((MR_hl_field(1, IntConst_4, 0))));
                    MR_Word Var_21;
                ...
                case (MR_Integer) 2:
                  {
                    int8_t Int8_7 = ((int8_t) (MR_Word) (MR_hl_field(2, IntConst_4, 0)));
                    MR_Word Var_17;
                  ...
                  break;
                case (MR_Integer) 3:
                  switch (((MR_Integer) ((MR_hl_field(3, IntConst_4, 0))))) {
                    default: /*NOTREACHED*/ MR_assert(0);
                    case (MR_Integer) 0:
                      {
                        uint8_t UInt8_12 = ((uint8_t) (MR_Word) (MR_hl_field(3, IntConst_4, 1)));
                        MR_Word Var_22;
                    ...
                    case (MR_Integer) 1:
                      {
                        int16_t Int16_8 = ((int16_t) (MR_Word) (MR_hl_field(3, IntConst_4, 1)));
                        MR_Word Var_18;
                    ...
                    case (MR_Integer) 2:
                      {
                        uint16_t UInt16_13 = ((uint16_t) (MR_Word) (MR_hl_field(3, IntConst_4, 1)));
                        MR_Word Var_23;
                    ...
                    case (MR_Integer) 3:
                      {
                        int32_t Int32_9 = ((int32_t) (MR_Word) (MR_hl_field(3, IntConst_4, 1)));
                        MR_Word Var_19;
                    ...
                    case (MR_Integer) 4:
                      {
                        uint32_t UInt32_14 = ((uint32_t) (MR_Word) (MR_hl_field(3, IntConst_4, 1)));
                        MR_Word Var_24;
                    ...
                    case (MR_Integer) 5:
                      {
                        int64_t Int64_10 = MR_unbox_int64((MR_hl_field(3, IntConst_4, 1)));
                        MR_Word Var_20;
                    ...
                    case (MR_Integer) 6:
                      {
                        uint64_t UInt64_15 = MR_unbox_uint64((MR_hl_field(3, IntConst_4, 1)));
                        MR_Word Var_25;
        ...
        case (MR_Integer) 6:
          {
            ...
            if (succeeded)
            {
              Float_26 = MR_unbox_float((MR_hl_field(3, HeadVar__1_1, 1)));
        ...
        case (MR_Integer) 7:
          {
            ...
            if (succeeded)
            {
              Char_31 = ((MR_Char) (MR_Word) (MR_hl_field(3, HeadVar__1_1, 1)));
              ...
              Name_68 = ((MR_String) ((MR_hl_field(0, SymName_33, 0))));
              {
        ...
        case (MR_Integer) 8:
          {
            ...
            if (succeeded)
            {
              String_36 = ((MR_String) ((MR_hl_field(3, HeadVar__1_1, 1))));
