...
{
  {
    ...
    succeeded = ((MR_tag((MR_Word) RevArgs0_19)) == (MR_Integer) 1);
    if (succeeded)
    {
...
{
  {
    ...
    succeeded = ((MR_tag((MR_Word) RevArgs0_9)) == (MR_Integer) 1);
    if (succeeded)
    {
...
{
  {
    MR_bool succeeded = ((((MR_tag((MR_Word) ConsId0_3)) == (MR_Integer) 3)) && ((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), ConsId0_3, (MR_Integer) 0))) == (MR_Integer) 2)));
    MR_Word Name0_5;
    MR_Integer Arity_6;
    MR_Word TypeCtor_7;
