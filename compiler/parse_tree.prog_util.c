...
MR_decl_label2(parse_tree__prog_util__IntroducedFrom__pred__make_pred_name__534__1_3_0, 2,3)
...
MR_decl_label4(fn__parse_tree__prog_util__cons_id_maybe_arity_1_0, 17,19,36,21)
...
MR_decl_label9(__Unify___parse_tree__prog_util__new_pred_id_0_0, 5,6,10,8,16,18,50,22,1)
MR_decl_label10(__Compare___parse_tree__prog_util__new_pred_id_0_0, 138,7,8,9,10,11,5,15,18,16)
MR_decl_label10(__Compare___parse_tree__prog_util__new_pred_id_0_0, 23,24,25,13,29,30,33,31,40,41)
MR_decl_label10(__Compare___parse_tree__prog_util__new_pred_id_0_0, 27,45,46,47,48,50,43,54,55,56)
MR_decl_label10(__Compare___parse_tree__prog_util__new_pred_id_0_0, 57,172,58,52,63,64,65,66,67,70)
MR_decl_label9(__Compare___parse_tree__prog_util__new_pred_id_0_0, 61,76,77,132,78,79,80,135,83)
...
MR_decl_static(parse_tree__prog_util__IntroducedFrom__pred__make_pred_name__534__1_3_0)
...
MR_def_label(parse_tree__prog_util__cons_id_and_args_to_term_3_0,9)
	...
	MR_incr_sp(6);
	MR_sv(6) = (MR_Word) MR_succip;
	* (MR_Float *) &MR_sv(3) = MR_word_to_float(MR_tfield(3, MR_r2, 1));
	MR_np_call_localret_ent(term__context_init_1_0,
...
MR_def_label(parse_tree__prog_util__cons_id_and_args_to_term_3_0,14)
	...
	MR_tfield(3, MR_r2, 1) = MR_float_to_word(MR_float_from_dword_ptr(&MR_sv(3)));
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 0, (MR_Integer) 3);
	MR_tfield(0, MR_tempr1, 0) = MR_r2;
...
MR_BEGIN_MODULE(parse_tree__prog_util_module17)
	...
	MR_init_label4(fn__parse_tree__prog_util__cons_id_maybe_arity_1_0,17,19,36,21)
MR_BEGIN_CODE
...
MR_def_label(fn__parse_tree__prog_util__cons_id_maybe_arity_1_0,36)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_tbmkword(0, 0);
	MR_proceed();
MR_def_label(fn__parse_tree__prog_util__cons_id_maybe_arity_1_0,21)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_RTAGS_TESTR(MR_r1,3,3)) {
		MR_GOTO_LAB(fn__parse_tree__prog_util__cons_id_maybe_arity_1_0_i36);
	}
	MR_tag_alloc_heap(MR_r2, 1, (MR_Integer) 1);
...
MR_def_label(parse_tree__prog_util__get_new_tvars_8_0,8)
	...
	MR_Word MR_tempr1;
	MR_tempr1 = MR_sv(9);
	MR_sv(9) = (MR_Word) MR_CTOR0_ADDR(parse_tree__prog_data, tvar_type);
	MR_r1 = MR_sv(9);
	MR_r2 = MR_tempr1;
	}
	MR_np_call_localret_ent(varset__new_var_3_0,
...
MR_BEGIN_MODULE(parse_tree__prog_util_module33)
	...
	MR_init_label9(__Unify___parse_tree__prog_util__new_pred_id_0_0,5,6,10,8,16,18,50,22,1)
MR_BEGIN_CODE
...
MR_define_entry(mercury____Unify___parse_tree__prog_util__new_pred_id_0_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if ((MR_r1 == MR_r2)) {
		MR_GOTO_LAB(__Unify___parse_tree__prog_util__new_pred_id_0_0_i50);
	}
	MR_incr_sp(3);
	MR_sv(3) = (MR_Word) MR_succip;
	{
...
MR_def_label(__Unify___parse_tree__prog_util__new_pred_id_0_0,16)
	...
	if (MR_RTAGS_TESTR(MR_sv(1),3,1)) {
		MR_GOTO_LAB(__Unify___parse_tree__prog_util__new_pred_id_0_0_i18);
	}
...
MR_def_label(__Unify___parse_tree__prog_util__new_pred_id_0_0,18)
	...
	if (MR_RTAGS_TESTR(MR_sv(1),3,2)) {
		MR_GOTO_LAB(__Unify___parse_tree__prog_util__new_pred_id_0_0_i22);
	}
...
MR_def_label(__Unify___parse_tree__prog_util__new_pred_id_0_0,50)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_TRUE;
	MR_proceed();
MR_def_label(__Unify___parse_tree__prog_util__new_pred_id_0_0,22)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_BEGIN_MODULE(parse_tree__prog_util_module34)
	...
	MR_init_label10(__Compare___parse_tree__prog_util__new_pred_id_0_0,138,7,8,9,10,11,5,15,18,16)
	MR_init_label10(__Compare___parse_tree__prog_util__new_pred_id_0_0,23,24,25,13,29,30,33,31,40,41)
	MR_init_label10(__Compare___parse_tree__prog_util__new_pred_id_0_0,27,45,46,47,48,50,43,54,55,56)
	MR_init_label10(__Compare___parse_tree__prog_util__new_pred_id_0_0,57,172,58,52,63,64,65,66,67,70)
	MR_init_label9(__Compare___parse_tree__prog_util__new_pred_id_0_0,61,76,77,132,78,79,80,135,83)
MR_BEGIN_CODE
...
MR_define_entry(mercury____Compare___parse_tree__prog_util__new_pred_id_0_0);
	...
	MR_sv(3) = (MR_Word) MR_succip;
	if ((MR_r1 == MR_r2)) {
		MR_GOTO_LAB(__Compare___parse_tree__prog_util__new_pred_id_0_0_i138);
	}
	MR_sv(2) = MR_r1;
	MR_sv(1) = MR_r2;
...
MR_def_label(__Compare___parse_tree__prog_util__new_pred_id_0_0,138)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Integer) 0;
	MR_decr_sp_and_return(3);
...
MR_def_label(__Compare___parse_tree__prog_util__new_pred_id_0_0,11)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_RTAGS_TESTR(MR_sv(1),3,2)) {
		MR_GOTO_LAB(__Compare___parse_tree__prog_util__new_pred_id_0_0_i132);
	}
	MR_r1 = (MR_Integer) 1;
	MR_decr_sp_and_return(3);
...
MR_def_label(__Compare___parse_tree__prog_util__new_pred_id_0_0,18)
	...
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___parse_tree__prog_util__new_pred_id_0_0_i83);
	}
	MR_r1 = MR_sv(1);
	MR_r2 = MR_sv(2);
	MR_succip_word = MR_sv(3);
...
MR_def_label(__Compare___parse_tree__prog_util__new_pred_id_0_0,25)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_RTAGS_TESTR(MR_sv(1),3,2)) {
		MR_GOTO_LAB(__Compare___parse_tree__prog_util__new_pred_id_0_0_i135);
	}
	MR_r1 = (MR_Integer) 1;
	MR_decr_sp_and_return(3);
...
MR_def_label(__Compare___parse_tree__prog_util__new_pred_id_0_0,31)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_RTAGS_TESTR(MR_sv(1),3,3)) {
		MR_GOTO_LAB(__Compare___parse_tree__prog_util__new_pred_id_0_0_i40);
	}
	MR_r1 = (MR_Integer) 1;
	MR_decr_sp_and_return(3);
MR_def_label(__Compare___parse_tree__prog_util__new_pred_id_0_0,40)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_RTAGS_TESTR(MR_sv(1),3,1)) {
...
MR_def_label(__Compare___parse_tree__prog_util__new_pred_id_0_0,46)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_sv(1),2)) {
		MR_GOTO_LAB(__Compare___parse_tree__prog_util__new_pred_id_0_0_i47);
	}
	MR_r1 = (MR_Integer) 2;
	MR_decr_sp_and_return(3);
MR_def_label(__Compare___parse_tree__prog_util__new_pred_id_0_0,47)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_RTAGS_TESTR(MR_sv(1),3,3)) {
...
MR_def_label(__Compare___parse_tree__prog_util__new_pred_id_0_0,56)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_RTAGS_TESTR(MR_sv(1),3,3)) {
		MR_GOTO_LAB(__Compare___parse_tree__prog_util__new_pred_id_0_0_i57);
	}
	MR_r1 = (MR_Integer) 1;
	MR_decr_sp_and_return(3);
MR_def_label(__Compare___parse_tree__prog_util__new_pred_id_0_0,57)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_RTAGS_TESTR(MR_sv(1),3,1)) {
		MR_GOTO_LAB(__Compare___parse_tree__prog_util__new_pred_id_0_0_i58);
	}
MR_def_label(__Compare___parse_tree__prog_util__new_pred_id_0_0,172)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_INT_CTOR_ADDR;
	MR_r2 = MR_tfield(3, MR_sv(2), 1);
...
MR_def_label(__Compare___parse_tree__prog_util__new_pred_id_0_0,65)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_RTAGS_TESTR(MR_sv(1),3,3)) {
		MR_GOTO_LAB(__Compare___parse_tree__prog_util__new_pred_id_0_0_i66);
	}
	MR_r1 = (MR_Integer) 1;
	MR_decr_sp_and_return(3);
MR_def_label(__Compare___parse_tree__prog_util__new_pred_id_0_0,66)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_RTAGS_TESTR(MR_sv(1),3,1)) {
		MR_GOTO_LAB(__Compare___parse_tree__prog_util__new_pred_id_0_0_i67);
	}
	MR_r1 = (MR_Integer) 2;
	MR_decr_sp_and_return(3);
MR_def_label(__Compare___parse_tree__prog_util__new_pred_id_0_0,67)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_RTAGS_TESTR(MR_sv(1),3,2)) {
		MR_GOTO_LAB(__Compare___parse_tree__prog_util__new_pred_id_0_0_i132);
	}
	...
	MR_np_call_localret_ent(private_builtin__builtin_compare_int_3_0,
		__Compare___parse_tree__prog_util__new_pred_id_0_0_i70);
...
MR_def_label(__Compare___parse_tree__prog_util__new_pred_id_0_0,132)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Integer) 2;
	MR_decr_sp_and_return(3);
MR_def_label(__Compare___parse_tree__prog_util__new_pred_id_0_0,78)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_RTAGS_TESTR(MR_sv(1),3,3)) {
		MR_GOTO_LAB(__Compare___parse_tree__prog_util__new_pred_id_0_0_i79);
	}
	MR_r1 = (MR_Integer) 1;
	MR_decr_sp_and_return(3);
MR_def_label(__Compare___parse_tree__prog_util__new_pred_id_0_0,79)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_RTAGS_TESTR(MR_sv(1),3,1)) {
		MR_GOTO_LAB(__Compare___parse_tree__prog_util__new_pred_id_0_0_i80);
	}
	MR_r1 = (MR_Integer) 1;
	MR_decr_sp_and_return(3);
MR_def_label(__Compare___parse_tree__prog_util__new_pred_id_0_0,80)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_RTAGS_TESTR(MR_sv(1),3,2)) {
		MR_GOTO_LAB(__Compare___parse_tree__prog_util__new_pred_id_0_0_i172);
	}
MR_def_label(__Compare___parse_tree__prog_util__new_pred_id_0_0,135)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Integer) 1;
	MR_decr_sp_and_return(3);
...
MR_BEGIN_MODULE(parse_tree__prog_util_module35)
	MR_init_entry1(parse_tree__prog_util__IntroducedFrom__pred__make_pred_name__534__1_3_0);
	MR_INIT_PROC_LAYOUT_ADDR(mercury__parse_tree__prog_util__IntroducedFrom__pred__make_pred_name__534__1_3_0);
	MR_init_label2(parse_tree__prog_util__IntroducedFrom__pred__make_pred_name__534__1_3_0,2,3)
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'IntroducedFrom__pred__make_pred_name__534__1'/3 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(parse_tree__prog_util__IntroducedFrom__pred__make_pred_name__534__1_3_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(3);
	MR_sv(3) = (MR_Word) MR_succip;
	MR_sv(2) = MR_r1;
	...
	MR_np_call_localret_ent(varset__lookup_name_3_0,
		parse_tree__prog_util__IntroducedFrom__pred__make_pred_name__534__1_3_0_i2);
MR_def_label(parse_tree__prog_util__IntroducedFrom__pred__make_pred_name__534__1_3_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_sv(2);
	...
	MR_np_call_localret_ent(fn__parse_tree__mercury_to_mercury__mercury_type_to_string_3_0,
		parse_tree__prog_util__IntroducedFrom__pred__make_pred_name__534__1_3_0_i3);
MR_def_label(parse_tree__prog_util__IntroducedFrom__pred__make_pred_name__534__1_3_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_tag_alloc_heap(MR_r2, 1, (MR_Integer) 2);
...
MR_def_label(f_112_97_114_115_101_95_116_114_101_101_95_95_112_114_111_103_95_117_116_105_108_95_95_85_110_117_115_101_100_65_114_103_115_95_95_112_114_101_100_95_95_108_105_115_116_95_116_111_95_115_116_114_105_110_103_95_50_95_95_104_111_51_95_95_91_50_93_95_48_4_0,20)
	...
	MR_r2 = MR_tfield(1, MR_r2, 0);
	MR_sv(1) = MR_r3;
	MR_np_call_localret_ent(parse_tree__prog_util__IntroducedFrom__pred__make_pred_name__534__1_3_0,
