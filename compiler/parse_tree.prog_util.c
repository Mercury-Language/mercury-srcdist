              ...
              case (MR_Integer) 1:
                {
                  ...
                  mercury__private_builtin__builtin_compare_int_3_p_0(&SubResult1_6, Var_145, ArgY1_5);
                  succeeded = (SubResult1_6 != (MR_Integer) 0);
                  if (succeeded)
                    *HeadVar__1_1 = SubResult1_6;
                  else
                    mercury__private_builtin__builtin_compare_int_3_p_0(HeadVar__1_1, Var_144, ArgY2_8);
                }
                break;
              case (MR_Integer) 2:
                *HeadVar__1_1 = (MR_Integer) 1;
                      ...
                      case (MR_Integer) 2:
                        {
                          ...
                          mercury__private_builtin__builtin_compare_int_3_p_0(&SubResult1_111, Var_149, ArgY1_110);
