...
MR_decl_label10(parse_tree__prog_util__cons_id_and_args_to_term_3_0, 77,29,32,3,5,7,8,12,14,17)
MR_decl_label4(parse_tree__prog_util__cons_id_and_args_to_term_3_0, 19,22,24,1)
...
MR_decl_label10(parse_tree__prog_util__get_new_tvars_8_0, 45,3,6,4,9,13,15,11,16,17)
...
MR_decl_label10(parse_tree__prog_util__make_pred_name_6_0, 3,2,6,7,8,9,20,22,27,28)
MR_decl_label10(parse_tree__prog_util__make_pred_name_6_0, 16,17,18,11,12,30,31,32,33,34)
MR_decl_label1(parse_tree__prog_util__make_pred_name_6_0, 35)
...
MR_decl_label10(parse_tree__prog_util__rename_in_goal_expr_4_0, 133,47,184,31,32,185,63,64,186,3)
MR_decl_label10(parse_tree__prog_util__rename_in_goal_expr_4_0, 4,5,7,8,9,11,12,13,15,18)
MR_decl_label10(parse_tree__prog_util__rename_in_goal_expr_4_0, 14,20,23,25,26,28,34,35,36,38)
MR_decl_label10(parse_tree__prog_util__rename_in_goal_expr_4_0, 39,40,42,43,45,48,49,50,51,52)
MR_decl_label10(parse_tree__prog_util__rename_in_goal_expr_4_0, 53,55,56,57,59,60,66,67,68,69)
MR_decl_label10(parse_tree__prog_util__rename_in_goal_expr_4_0, 70,72,73,74,75,76,78,79,80,81)
MR_decl_label10(parse_tree__prog_util__rename_in_goal_expr_4_0, 82,84,85,87,88,89,91,92,93,95)
MR_decl_label10(parse_tree__prog_util__rename_in_goal_expr_4_0, 97,99,96,102,103,106,107,108,109,111)
MR_decl_label10(parse_tree__prog_util__rename_in_goal_expr_4_0, 113,110,116,118,120,121,125,126,128,129)
...
MR_decl_label9(__Unify___parse_tree__prog_util__new_pred_id_0_0, 5,17,19,25,32,33,7,35,1)
MR_decl_label10(__Compare___parse_tree__prog_util__new_pred_id_0_0, 3,5,7,9,22,23,75,81,83,94)
MR_decl_label10(__Compare___parse_tree__prog_util__new_pred_id_0_0, 95,97,104,109,183,115,116,73,62,25)
MR_decl_label4(__Compare___parse_tree__prog_util__new_pred_id_0_0, 38,136,28,248)
...
MR_BEGIN_MODULE(parse_tree__prog_util_module4)
	...
	MR_init_label10(parse_tree__prog_util__make_pred_name_6_0,3,2,6,7,8,9,20,22,27,28)
	MR_init_label10(parse_tree__prog_util__make_pred_name_6_0,16,17,18,11,12,30,31,32,33,34)
	MR_init_label1(parse_tree__prog_util__make_pred_name_6_0,35)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(parse_tree__prog_util_module14)
	...
	MR_init_label10(parse_tree__prog_util__rename_in_goal_expr_4_0,133,47,184,31,32,185,63,64,186,3)
	MR_init_label10(parse_tree__prog_util__rename_in_goal_expr_4_0,4,5,7,8,9,11,12,13,15,18)
	MR_init_label10(parse_tree__prog_util__rename_in_goal_expr_4_0,14,20,23,25,26,28,34,35,36,38)
	MR_init_label10(parse_tree__prog_util__rename_in_goal_expr_4_0,39,40,42,43,45,48,49,50,51,52)
	MR_init_label10(parse_tree__prog_util__rename_in_goal_expr_4_0,53,55,56,57,59,60,66,67,68,69)
	MR_init_label10(parse_tree__prog_util__rename_in_goal_expr_4_0,70,72,73,74,75,76,78,79,80,81)
	MR_init_label10(parse_tree__prog_util__rename_in_goal_expr_4_0,82,84,85,87,88,89,91,92,93,95)
	MR_init_label10(parse_tree__prog_util__rename_in_goal_expr_4_0,97,99,96,102,103,106,107,108,109,111)
	MR_init_label10(parse_tree__prog_util__rename_in_goal_expr_4_0,113,110,116,118,120,121,125,126,128,129)
...
MR_BEGIN_MODULE(parse_tree__prog_util_module15)
	...
	MR_init_label10(parse_tree__prog_util__cons_id_and_args_to_term_3_0,77,29,32,3,5,7,8,12,14,17)
	MR_init_label4(parse_tree__prog_util__cons_id_and_args_to_term_3_0,19,22,24,1)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(parse_tree__prog_util_module25)
	...
	MR_init_label10(parse_tree__prog_util__get_new_tvars_8_0,45,3,6,4,9,13,15,11,16,17)
...
MR_define_entry(mercury__fn__parse_tree__prog_util__sym_name_and_args_to_term_3_0);
	...
	MR_tag_alloc_heap(MR_tempr1, 0, (MR_Integer) 1);
	MR_tempr3 = MR_r2;
	MR_tfield(0, MR_tempr1, 0) = MR_tfield(1, MR_tempr3, 1);
	MR_tag_alloc_heap(MR_tempr2, 0, (MR_Integer) 3);
	MR_tfield(0, MR_tempr2, 0) = MR_tempr1;
	MR_tfield(0, MR_tempr2, 1) = MR_r3;
	MR_tempr4 = MR_r4;
...
MR_BEGIN_MODULE(parse_tree__prog_util_module33)
	...
	MR_init_label9(__Unify___parse_tree__prog_util__new_pred_id_0_0,5,17,19,25,32,33,7,35,1)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(parse_tree__prog_util_module34)
	...
	MR_init_label10(__Compare___parse_tree__prog_util__new_pred_id_0_0,3,5,7,9,22,23,75,81,83,94)
	MR_init_label10(__Compare___parse_tree__prog_util__new_pred_id_0_0,95,97,104,109,183,115,116,73,62,25)
	MR_init_label4(__Compare___parse_tree__prog_util__new_pred_id_0_0,38,136,28,248)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(parse_tree__prog_util_module35)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__parse_tree__prog_util__IntroducedFrom__pred__make_pred_name__509__1_3_0);
