...
static void MR_CALL 
parse_tree__prog_util__IntroducedFrom__pred__make_pred_name__554__1_3_p_0(
    ...
    else
      {
        ...
        if ((parse_tree__prog_util__Ts_11 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
        ...
        else
          {
            ...
            {
              parse_tree__prog_util__IntroducedFrom__pred__make_pred_name__554__1_3_p_0(parse_tree__prog_util__V_23_23, parse_tree__prog_util__T_29, &parse_tree__prog_util__String_34);
            }
            {
        ...
        {
          parse_tree__prog_util__IntroducedFrom__pred__make_pred_name__554__1_3_p_0(parse_tree__prog_util__V_23_23, parse_tree__prog_util__T_10, &parse_tree__prog_util__String_15);
        }
        {
          MR_Word base;
