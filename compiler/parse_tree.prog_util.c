  ...
  switch (MR_tag((MR_Word) Goal0_7)) {
    ...
    case (MR_Integer) 3:
      switch (((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), Goal0_7, (MR_Integer) 0)))) {
        ...
        case (MR_Integer) 6:
          {
            MR_Word QuantType_17 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(3), Goal0_7, (MR_Integer) 1))) & (MR_Integer) 1);
            MR_Word QuantVarsKind_18 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(3), Goal0_7, (MR_Integer) 1))) >> (MR_Integer) 1)) & (MR_Integer) 1);
            ...
            parse_tree__prog_util__rename_in_goal_4_p_0(OldVar_5, NewVar_6, SubGoal0_96, &SubGoal_97);
            {
              ...
              *Goal_8 = base;
              MR_hl_field(MR_mktag(3), base, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 6));
              MR_hl_field(MR_mktag(3), base, 1) = (MR_Box) (((MR_Unsigned) (((MR_Box) (QuantType_17))) | (((MR_Unsigned) (((MR_Box) (QuantVarsKind_18))) << (MR_Integer) 1))));
