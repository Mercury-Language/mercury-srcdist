...
static /* final */ const MR_Box parse_tree__prog_util_scalar_common_3[4][7];
        ...
        case (MR_Integer) 7:
          {
            ...
            if (succeeded)
            {
              ...
              Name_67 = ((MR_String) ((MR_hl_field(MR_mktag(0), SymName_33, (MR_Integer) 0))));
              {
                ...
                MR_hl_field(MR_mktag(0), Var_59, 0) = ((MR_Box) (Name_67));
              }
              {
                MR_Word base;
                base = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
        ...
        case (MR_Integer) 15:
          {
            ...
            }
            {
              ...
              MR_hl_field(MR_mktag(0), Var_82, 0) = ((MR_Box) (&parse_tree__prog_util_scalar_common_3[2]));
        ...
        case (MR_Integer) 16:
          {
            ...
            else
            {
              ...
              mercury__list__map_3_p_0((MR_Word) (&parse_tree__prog_util_scalar_common_1[0]), (MR_Word) (&parse_tree__prog_util_scalar_common_1[0]), Var_80, TransVars0_49, &TransVars_50);
              {
        ...
        case (MR_Integer) 17:
          {
            ...
            }
            {
              ...
              MR_hl_field(MR_mktag(0), Var_77, 0) = ((MR_Box) (&parse_tree__prog_util_scalar_common_3[3]));
