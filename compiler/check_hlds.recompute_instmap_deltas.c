  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_17)
{
  ...
  hlds__hlds_pred__proc_info_get_var_table_3_p_0(STATE_VARIABLE_ModuleInfo_0_16, STATE_VARIABLE_ProcInfo_0_14, &VarTable_10);
  ...
  hlds__hlds_pred__proc_info_get_inst_varset_2_p_0(STATE_VARIABLE_ProcInfo_0_14, &InstVarSet_12);
  {
    ...
    MR_hl_field(MR_mktag(1), Var_30, 0) = ((MR_Box) (VarTable_10));
  }
  {
    Params_26 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(MR_mktag(0), Params_26, 0) = (MR_Box) ((MR_Unsigned) (RecomputeAtomic_6));
    MR_hl_field(MR_mktag(0), Params_26, 1) = ((MR_Box) (Var_30));
  }
  {
    RI0_27 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(MR_mktag(0), RI0_27, 0) = ((MR_Box) (STATE_VARIABLE_ModuleInfo_0_16));
    MR_hl_field(MR_mktag(0), RI0_27, 1) = ((MR_Box) (InstVarSet_12));
  }
  check_hlds__recompute_instmap_deltas__recompute_instmap_delta_1_7_p_0(Params_26, InstMap0_9, &Var_28, Goal0_11, &Goal_13, RI0_27, &RI_29);
  *STATE_VARIABLE_ModuleInfo_17 = ((MR_Word) ((MR_hl_field(MR_mktag(0), RI_29, (MR_Integer) 0))));
