...
static const MR_PseudoTypeInfo check_hlds__recompute_instmap_deltas__check_hlds__recompute_instmap_deltas__field_types_recompute_params_0_0[2] = {
  ...
  (MR_PseudoTypeInfo) (&hlds__var_table__hlds__var_table__type_ctor_info_var_type_source_0)
};
  ...
  else
  {
    ...
    if (succeeded)
      *HeadVar__1_1 = SubResult1_6;
      ...
      hlds__var_table____Compare____var_type_source_0_0(HeadVar__1_1, ArgX2_7, ArgY2_8);
  }
}
  ...
  MR_Word HeadVar__2_2)
{
  ...
  else
  {
    ...
    if (succeeded)
      succeeded = hlds__var_table____Unify____var_type_source_0_0(ArgX2_5, ArgY2_6);
  }
  return succeeded;
}
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_18)
{
  ...
  hlds__hlds_pred__proc_info_get_inst_varset_2_p_0(STATE_VARIABLE_ProcInfo_0_15, &InstVarSet_13);
  {
    ...
    MR_hl_field(MR_mktag(0), Var_31, 0) = ((MR_Box) (VarTypes_11));
  }
  {
    Params_27 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(MR_mktag(0), Params_27, 0) = (MR_Box) ((MR_Unsigned) (RecomputeAtomic_6));
    MR_hl_field(MR_mktag(0), Params_27, 1) = ((MR_Box) (Var_31));
  }
  {
    RI0_28 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(MR_mktag(0), RI0_28, 0) = ((MR_Box) (STATE_VARIABLE_ModuleInfo_0_17));
    MR_hl_field(MR_mktag(0), RI0_28, 1) = ((MR_Box) (InstVarSet_13));
  }
  check_hlds__recompute_instmap_deltas__recompute_instmap_delta_1_7_p_0(Params_27, InstMap0_9, &Var_29, Goal0_12, &Goal_14, RI0_28, &RI_30);
  *STATE_VARIABLE_ModuleInfo_18 = ((MR_Word) ((MR_hl_field(MR_mktag(0), RI_30, (MR_Integer) 0))));
  ...
  MR_Word * STATE_VARIABLE_RI_9)
{
  ...
  else
  {
    ...
    hlds__var_table__lookup_var_type_in_source_3_p_0(VarTypeSrc_32, HeadVar__2_2, &Type_33);
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      else
      {
        ...
        hlds__var_table__lookup_var_type_in_source_3_p_0(VarTypeSrc_1, Var_64, &Type_52);
