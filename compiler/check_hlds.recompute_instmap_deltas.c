  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_18)
{
  ...
  hlds__hlds_pred__proc_info_get_inst_varset_2_p_0(STATE_VARIABLE_ProcInfo_0_15, &InstVarSet_13);
  {
    ...
    MR_hl_field(MR_mktag(0), RI0_29, 0) = ((MR_Box) (STATE_VARIABLE_ModuleInfo_0_17));
    MR_hl_field(MR_mktag(0), RI0_29, 1) = ((MR_Box) (InstVarSet_13));
  }
  check_hlds__recompute_instmap_deltas__recompute_instmap_delta_1_8_p_0(RecomputeAtomic_6, Goal0_12, &Goal_14, VarTypes_11, InstMap0_9, &Var_30, RI0_29, &RI_31);
  *STATE_VARIABLE_ModuleInfo_18 = ((MR_Word) ((MR_hl_field(MR_mktag(0), RI_31, (MR_Integer) 0))));
