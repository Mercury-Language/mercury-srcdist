  ...
  MR_Word * STATE_VARIABLE_RI_9)
{
  ...
  else
  {
    ...
    Var_48 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_RI_0_8, (MR_Integer) 1))));
    {
      ...
      MR_hl_field(MR_mktag(0), STATE_VARIABLE_RI_43_43, 1) = ((MR_Box) (Var_48));
    }
    ...
    Var_51 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_RI_44_44, (MR_Integer) 1))));
    {
      ...
      MR_hl_field(MR_mktag(0), STATE_VARIABLE_RI_45_45, 1) = ((MR_Box) (Var_51));
    }
    {
  ...
  MR_Word * STATE_VARIABLE_RI_26)
{
  ...
  else
  {
    ...
    Var_30 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_RI_27_27, (MR_Integer) 1))));
    {
      MR_Word base;
  ...
  MR_Word * STATE_VARIABLE_RI_24)
{
  ...
  else
  {
    ...
    Var_28 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_RI_25_25, (MR_Integer) 1))));
    {
      MR_Word base;
      base = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
        ...
        case (MR_Integer) 6:
          {
            ...
            Var_189 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_RI_140_140, (MR_Integer) 1))));
            {
              MR_Word base;
              base = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
              *STATE_VARIABLE_RI_118 = base;
              MR_hl_field(MR_mktag(0), base, 0) = ((MR_Box) (ModuleInfo_47));
              MR_hl_field(MR_mktag(0), base, 1) = ((MR_Box) (Var_189));
            }
            {
    ...
    case (MR_Integer) 0:
      {
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            ...
            Var_54 = mercury__list__length_1_f_0(TypeInfo_66_66, Args_35);
    ...
    case (MR_Integer) 1:
      {
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            ...
            Var_64 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_RI_0_52, (MR_Integer) 1))));
            {
              MR_Word base;
              base = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_8)
{
  while (MR_TRUE)
  {
    ...
    {
      MR_Word Var_61 = ((MR_Word) ((MR_hl_field(MR_mktag(1), HeadVar__3_3, (MR_Integer) 1))));
      MR_Word Var_62 = ((MR_Word) ((MR_hl_field(MR_mktag(1), HeadVar__3_3, (MR_Integer) 0))));
      ...
      else
      {
        ...
        parse_tree__var_table__lookup_var_type_in_source_3_p_0(VarTypeSrc_1, Var_62, &Type_52);
