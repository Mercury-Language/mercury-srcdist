  ...
  MR_Word * STATE_VARIABLE_RI_9)
{
  ...
  else
  {
    ...
    ModuleInfo2_39 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_RI_44_44, 0))));
    ...
    Var_51 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_RI_44_44, 1))));
    {
  ...
  MR_Word * STATE_VARIABLE_RI_26)
{
  ...
  else
  {
    ...
    MR_Word ModuleInfo0_23 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_RI_27_27, 0))));
    ...
    Var_30 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_RI_27_27, 1))));
    {
      MR_Word base;
  ...
  MR_Word * STATE_VARIABLE_RI_24)
{
  ...
  else
  {
    ...
    MR_Word ModuleInfo0_21 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_RI_25_25, 0))));
    ...
    Var_28 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_RI_25_25, 1))));
    {
      MR_Word base;
      base = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
        ...
        case (MR_Integer) 6:
          {
            ...
            ModuleInfo0_44 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_RI_126_126, 0))));
            ...
            Var_188 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_RI_126_126, 1))));
            {
              MR_Word base;
              base = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
  ...
  MR_Word * STATE_VARIABLE_RI_37)
{
  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      Var_49 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_RI_39_39, 1))));
      {
        MR_Word base;
        base = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
