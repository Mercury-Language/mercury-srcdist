  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_17)
{
  ...
  hlds__hlds_pred__proc_info_get_inst_varset_2_p_0(STATE_VARIABLE_ProcInfo_0_14, &InstVarSet_12);
  {
    ...
    MR_hl_field(MR_mktag(1), Var_32, 0) = ((MR_Box) (VarTable_10));
  }
  {
    Params_28 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(MR_mktag(0), Params_28, 0) = (MR_Box) ((MR_Unsigned) (RecomputeAtomic_6));
    MR_hl_field(MR_mktag(0), Params_28, 1) = ((MR_Box) (Var_32));
  }
  {
    RI0_29 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(MR_mktag(0), RI0_29, 0) = ((MR_Box) (STATE_VARIABLE_ModuleInfo_0_16));
    MR_hl_field(MR_mktag(0), RI0_29, 1) = ((MR_Box) (InstVarSet_12));
  }
  check_hlds__recompute_instmap_deltas__recompute_instmap_delta_1_7_p_0(Params_28, InstMap0_9, &Var_30, Goal0_11, &Goal_13, RI0_29, &RI_31);
  *STATE_VARIABLE_ModuleInfo_17 = ((MR_Word) ((MR_hl_field(MR_mktag(0), RI_31, (MR_Integer) 0))));
        ...
        case (MR_Integer) 6:
          {
            ...
            Var_195 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_RI_127_127, (MR_Integer) 1))));
            {
              MR_Word base;
              base = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
    ...
    case (MR_Integer) 0:
      {
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            ...
            Var_60 = mercury__list__length_1_f_0(TypeInfo_68_68, Args_35);
