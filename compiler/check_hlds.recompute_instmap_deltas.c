        ...
        case (MR_Integer) 6:
          {
            ...
            ModuleInfo0_44 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_RI_127_127, (MR_Integer) 0))));
            ...
            Var_189 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_RI_127_127, (MR_Integer) 1))));
            {
              MR_Word base;
              base = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
    ...
    case (MR_Integer) 1:
      {
        ...
        check_hlds__recompute_instmap_deltas__pair_arg_vars_with_rhs_insts_3_p_0(RHSVars_19, ArgModes_20, &RHSTuples_32);
        {
          ...
          MR_hl_field(MR_mktag(1), Var_59, 0) = ((MR_Box) (LHSTuple_31));
          MR_hl_field(MR_mktag(1), Var_59, 1) = ((MR_Box) (RHSTuples_32));
        }
        ...
        case (MR_Integer) 4:
          {
            ...
            mercury__list__det_drop_3_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_mode_0), NumArgs_7, ProcArgModes_24, &Modes_25);
            {
              ...
              MR_hl_field(MR_mktag(0), Var_54, 0) = (MR_Box) ((MR_Unsigned) (PorF_22));
              MR_hl_field(MR_mktag(0), Var_54, 1) = ((MR_Box) (Modes_25));
              MR_hl_field(MR_mktag(0), Var_54, 2) = ((MR_Box) ((MR_Unsigned) 0U));
              MR_hl_field(MR_mktag(0), Var_54, 3) = (MR_Box) ((MR_Unsigned) (Det_23));
            }
            Var_53 = (MR_Word) (MR_mkword(MR_mktag(1), (MR_Word) (Var_54)));
            {
              ...
              MR_hl_field(MR_mktag(3), Inst_26, 2) = ((MR_Box) (Var_53));
            }
            {
        ...
        case (MR_Integer) 8:
          {
...

            {
              ...
              MR_hl_field(MR_mktag(0), Var_46, 0) = ((MR_Box) (ConsId_6));
            ...
            }
            {
              ...
              MR_hl_field(MR_mktag(3), Var_42, 1) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 0));
              MR_hl_field(MR_mktag(3), Var_42, 2) = ((MR_Box) ((MR_Unsigned) 4U));
              MR_hl_field(MR_mktag(3), Var_42, 3) = ((MR_Box) (Var_45));
            }
            {
              MaybeInst_8 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), MaybeInst_8, 0) = ((MR_Box) (Var_42));
            }
          }
          break;
        case (MR_Integer) 9:
