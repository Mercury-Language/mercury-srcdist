    ...
    case (MR_Integer) 1:
      {
        ...
        switch (RecomputeAtomic_173) {
          ...
          case (MR_Integer) 1:
            ...
            break;
          case (MR_Integer) 0:
            check_hlds__recompute_instmap_deltas__recompute_instmap_delta_unify_8_p_0(Uni_70, UniMode0_69, &UniMode_85, GoalInfo0_15, InstMap0_9, &InstMapDelta1_20, STATE_VARIABLE_RI_135_135, STATE_VARIABLE_RI_117);
            break;
        }
        {
  ...
  MR_Integer NumArgs_7)
{
  ...
  switch (MR_tag((MR_Word) ConsId_6)) {
    ...
    case (MR_Integer) 1:
      {
        MR_Word PredProcId_18 = (MR_Word) (MR_body((MR_Word) (ConsId_6), (MR_Integer) 1));
        MR_Word PredInfo_19;
        MR_Word ProcInfo_20;
        MR_Word PorF_21;
        MR_Word Det_22;
        MR_Word ProcArgModes_23;
        MR_Word Modes_24;
        MR_Word Inst_25;
        MR_Word Var_50;
        MR_Word Var_52;
        ...
        Var_50 = hlds__hlds_pred__unshroud_pred_proc_id_1_f_0(PredProcId_18);
        hlds__hlds_module__module_info_pred_proc_info_4_p_0(ModuleInfo_5, Var_50, &PredInfo_19, &ProcInfo_20);
        PorF_21 = hlds__hlds_pred__pred_info_is_pred_or_func_1_f_0(PredInfo_19);
        hlds__hlds_proc_util__proc_info_interface_determinism_2_p_0(ProcInfo_20, &Det_22);
        hlds__hlds_pred__proc_info_get_argmodes_2_p_0(ProcInfo_20, &ProcArgModes_23);
        mercury__list__det_drop_3_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_mode_0), NumArgs_7, ProcArgModes_23, &Modes_24);
        {
          Var_53 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(0, Var_53, 0) = (MR_Box) ((MR_Unsigned) (PorF_21));
          MR_hl_field(0, Var_53, 1) = ((MR_Box) (Modes_24));
          MR_hl_field(0, Var_53, 2) = ((MR_Box) ((MR_Unsigned) 0U));
          MR_hl_field(0, Var_53, 3) = (MR_Box) ((MR_Unsigned) (Det_22));
        }
        Var_52 = (MR_Word) (MR_mkword(1, (MR_Word) (Var_53)));
        {
        ...
        case (MR_Integer) 8:
          {
...

            {
              ...
              MR_hl_field(0, Var_45, 0) = ((MR_Box) (ConsId_6));
            ...
            }
            {
              ...
              MR_hl_field(2, Var_41, 0) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 0));
              MR_hl_field(2, Var_41, 1) = ((MR_Box) ((MR_Unsigned) 4U));
              MR_hl_field(2, Var_41, 2) = ((MR_Box) (Var_44));
            }
            {
              MaybeInst_8 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(1, MaybeInst_8, 0) = ((MR_Box) (Var_41));
            }
          }
          break;
        case (MR_Integer) 9:
