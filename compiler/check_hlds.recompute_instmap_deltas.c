  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_17)
{
  ...
  hlds__hlds_pred__proc_info_get_inst_varset_2_p_0(STATE_VARIABLE_ProcInfo_0_14, &InstVarSet_12);
  {
    ...
    MR_hl_field(MR_mktag(1), Var_22, 0) = ((MR_Box) (VarTable_10));
  }
  {
    Params_18 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(MR_mktag(0), Params_18, 0) = (MR_Box) ((MR_Unsigned) (RecomputeAtomic_6));
    MR_hl_field(MR_mktag(0), Params_18, 1) = ((MR_Box) (Var_22));
  }
  {
    RI0_19 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(MR_mktag(0), RI0_19, 0) = ((MR_Box) (STATE_VARIABLE_ModuleInfo_0_16));
    MR_hl_field(MR_mktag(0), RI0_19, 1) = ((MR_Box) (InstVarSet_12));
  }
  ...
  *STATE_VARIABLE_ModuleInfo_17 = ((MR_Word) ((MR_hl_field(MR_mktag(0), RI_21, (MR_Integer) 0))));
