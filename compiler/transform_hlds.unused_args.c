...
transform_hlds__unused_args__IntroducedFrom__pred__unused_args_traverse_unify__604__1_2_p_0(
  MR_Word LHSVar_8,
  MR_Word CellVar_66);

static MR_bool MR_CALL 
transform_hlds__unused_args__IntroducedFrom__pred__unused_args_traverse_unify__595__1_2_p_0(
  MR_Word LHSVar_8,
  MR_Word CellVar_16);

static MR_bool MR_CALL 
transform_hlds__unused_args__IntroducedFrom__pred__unused_args_traverse_goal__530__1_2_p_0(
  MR_Word LambdaHeadVar__1_64,
  MR_Word * LambdaHeadVar__2_65);

static void MR_CALL 
transform_hlds__unused_args__IntroducedFrom__pred__try_to_look_up_global_var_usage_map_entry_for_proc__338__1_3_p_0(
  MR_Word HeadVars_32,
  ...
  MR_Box * wrapper_arg_2)
{
  ...
  succeeded = transform_hlds__unused_args__IntroducedFrom__pred__unused_args_traverse_goal__530__1_2_p_0(((MR_Word) (wrapper_arg_1)), &conv0_LambdaHeadVar__2_65);
  if (succeeded)
  {
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = transform_hlds__unused_args__IntroducedFrom__pred__unused_args_traverse_unify__604__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) ((MR_hl_field(0, closure, 4)))));
  return succeeded;
}
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = transform_hlds__unused_args__IntroducedFrom__pred__unused_args_traverse_unify__595__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) ((MR_hl_field(0, closure, 4)))));
  return succeeded;
}
  ...
  MR_Box * wrapper_arg_2)
{
  ...
  transform_hlds__unused_args__IntroducedFrom__pred__try_to_look_up_global_var_usage_map_entry_for_proc__338__1_3_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Integer) (wrapper_arg_1)), &conv0_HeadVar__3_185);
