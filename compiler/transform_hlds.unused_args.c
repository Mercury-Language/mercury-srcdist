...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_16, (MR_Integer) 495, &Intermod_17);
    switch (Intermod_17) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        {
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 495, &IntermodAnalysis_18);
...
{
  {
    ...
    Var_58 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_format_component_0), Pieces1_16, Pieces2_17);
    {
      ...
      MR_hl_field(MR_mktag(1), Spec_8, 2) = ((MR_Box) ((MR_Unsigned) 88U));
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_19, (MR_Integer) 495, &Intermod_21);
