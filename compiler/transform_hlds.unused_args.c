  ...
  MR_Word * STATE_VARIABLE_PredInfo_44)
{
  ...
  parse_tree__pred_name__make_transformed_pred_sym_name_4_p_0(PredModule_13, Name1_26, Transform_27, &SymName_28);
