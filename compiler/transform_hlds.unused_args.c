  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      else
      {
        ...
        succeeded = check_hlds__mode_util__mode_is_output_2_p_0(ModuleInfo_7, Var_27);
        if (succeeded)
        {
...
{
  {
    ...
    succeeded = transform_hlds__unused_args__IntroducedFrom__pred__unused_args_create_new_pred__1016__1_3_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))), ((MR_Word) (wrapper_arg_1)));
    return succeeded;
  }
}
...
{
  {
    ...
    conv1_LambdaHeadVar__2_55 = transform_hlds__unused_args__IntroducedFrom__func__unused_args_create_new_pred__1009__1_1_f_0(((MR_Word) (wrapper_arg_1)));
