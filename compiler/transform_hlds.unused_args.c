                  ...
                  if (succeeded)
                  {
                    ...
                    if (succeeded)
                    {
                      ...
                      if (succeeded)
                      {
                        ...
                        succeeded = ((((MR_tag((MR_Word) Origin_49)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(MR_mktag(3), Origin_49, (MR_Integer) 0)))) == (MR_Integer) 8)));
                        if (succeeded)
                        {
                          Var_66 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Origin_49, (MR_Integer) 1))));
    ...
    else
    {
      ...
      if (!(succeeded))
      {
        ...
        if (!(succeeded))
        {
          ...
          if (((((MR_tag((MR_Word) Origin_55)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(MR_mktag(3), Origin_55, (MR_Integer) 0)))) == (MR_Integer) 1))))
            succeeded = MR_TRUE;
          else
  ...
  MR_Word * STATE_VARIABLE_PredInfo_44)
{
  ...
  if (succeeded)
  {
    ...
    succeeded = ((MR_tag((MR_Word) OrigOrigin_19)) == (MR_Integer) 2);
    if (succeeded)
    {
      TypeCtor_21 = ((MR_Word) ((MR_hl_field(MR_mktag(2), OrigOrigin_19, (MR_Integer) 1))));
      {
  ...
  {
    OriginTransform_40 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(MR_mktag(3), OriginTransform_40, 0) = ((MR_Box) ((MR_Unsigned) 1U));
    MR_hl_field(MR_mktag(3), OriginTransform_40, 1) = ((MR_Box) (ProcId_11));
    MR_hl_field(MR_mktag(3), OriginTransform_40, 2) = ((MR_Box) (UnusedArgs_8));
  }
  {
    Origin_41 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(MR_mktag(3), Origin_41, 0) = ((MR_Box) ((MR_Unsigned) 8U));
