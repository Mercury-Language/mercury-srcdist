...
{
  {
    MR_Box conv0_HeadVar__3_204;

    mercury__list__det_index1_3_p_0((MR_Word) (&transform_hlds__unused_args_scalar_common_1[1]), HeadVars_35, HeadVar__2_203, &conv0_HeadVar__3_204);
    *HeadVar__3_204 = ((MR_Word) (conv0_HeadVar__3_204));
  }
}
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_16, (MR_Integer) 494, &Intermod_17);
    switch (Intermod_17) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        {
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 494, &IntermodAnalysis_18);
  ...
  MR_Box * wrapper_arg_2)
{
  {
    MR_Box closure = closure_arg;
    MR_Word conv0_HeadVar__3_204;

    transform_hlds__unused_args__IntroducedFrom__pred__setup_proc_args__436__1_3_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Integer) (wrapper_arg_1)), &conv0_HeadVar__3_204);
    *wrapper_arg_2 = ((MR_Box) (conv0_HeadVar__3_204));
  }
}
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_19, (MR_Integer) 494, &Intermod_21);
      ...
      {
        {
          ...
          if (succeeded)
          {
            hlds__hlds_pred__in_in_unification_proc_id_1_p_0(&Var_212);
            succeeded = (ProcId_12 == Var_212);
          }
        }
        if (!(succeeded))
        {
