  ...
  MR_Word * STATE_VARIABLE_PredInfo_44)
{
  ...
  Var_58 = hlds__hlds_pred__proc_id_to_int_1_f_0(ProcId_11);
  {
    ...
    MR_hl_field(MR_mktag(3), Transform_27, 0) = ((MR_Box) ((MR_Unsigned) 15U));
