      ...
      else
      {
        ...
        else
        {
          ...
          else
          {
            ...
            mercury__builtin__compare_3_p_0((MR_Word) (&transform_hlds__unused_args_scalar_common_1[9]), &SubResult4_15, ((MR_Box) (ArgX4_13)), ((MR_Box) (ArgY4_14)));
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            TypeInfo_18_18 = (MR_Word) (&transform_hlds__unused_args_scalar_common_1[9]);
