            ...
            case (MR_Integer) 1:
              {
                ...
                if (succeeded)
                {
                  ...
                  mercury__set__insert_3_p_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_pragma_info_unused_args_0), ((MR_Box) (UnusedArgInfo_91)), STATE_VARIABLE_UnusedArgInfos_0_9, &STATE_VARIABLE_UnusedArgInfos_69_69);
                }
                else
                  STATE_VARIABLE_UnusedArgInfos_69_69 = STATE_VARIABLE_UnusedArgInfos_0_9;
              }
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      if (!(succeeded))
      {
        ...
        {
          MR_Word Origin_55;
          MR_Word OriginUser_56;

          hlds__hlds_pred__pred_info_get_origin_2_p_0(PredInfo_53, &Origin_55);
          succeeded = ((MR_tag((MR_Word) Origin_55)) == (MR_Integer) 0);
          if (succeeded)
          {
            OriginUser_56 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Origin_55, (MR_Integer) 0))));
            if (((MR_tag((MR_Word) OriginUser_56)) == (MR_Integer) 2))
              succeeded = MR_TRUE;
            else
            if (((((MR_tag((MR_Word) OriginUser_56)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(MR_mktag(3), OriginUser_56, (MR_Integer) 0)))) == (MR_Integer) 0))))
              succeeded = MR_TRUE;
            else
              succeeded = MR_FALSE;
          }
      ...
      else
      {
        ...
        ProcIds_61 = hlds__hlds_pred__pred_info_valid_procids_1_f_0(PredInfo_53);
        transform_hlds__unused_args__setup_pred_args_10_p_0(PredId_22, ProcIds_61, STATE_VARIABLE_VarUsage_0_2, &STATE_VARIABLE_VarUsage_36_36, HeadVar__4_4, &STATE_VARIABLE_PredProcList_37_37, STATE_VARIABLE_OptProcs_0_6, &STATE_VARIABLE_OptProcs_38_38, STATE_VARIABLE_ModuleInfo_0_8, &STATE_VARIABLE_ModuleInfo_39_39);
      }
      // direct tailcall eliminated
      ;
