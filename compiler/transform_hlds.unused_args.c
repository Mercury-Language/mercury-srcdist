...
{
  {
    ...
    else
    {
      ...
      succeeded = ((MR_tag((MR_Word) IntermodResultsTriples_21)) == (MR_Integer) 1);
      if (succeeded)
      {
                  ...
                  if (succeeded)
                  {
                    ...
                    if (succeeded)
                    {
                      ...
                      if (succeeded)
                      {
                        ...
                        succeeded = ((MR_tag((MR_Word) Origin_49)) == (MR_Integer) 2);
                        if (succeeded)
                        {
                          Var_64 = ((MR_Word) ((MR_hl_field(MR_mktag(2), Origin_49, (MR_Integer) 0))));
                          succeeded = ((((MR_tag((MR_Word) Var_64)) == (MR_Integer) 3)) && ((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), Var_64, (MR_Integer) 0))) == (MR_Integer) 3)));
                          if (succeeded)
                          {
                          }
                        }
            ...
            case (MR_Integer) 1:
              {
                ...
                if (succeeded)
                {
                  succeeded = ((MR_tag((MR_Word) UnusedArgs_31)) == (MR_Integer) 1);
                  if (succeeded)
                  {
                  }
                }
...
{
  {
    ...
    if (succeeded)
    {
      ...
      succeeded = ((MR_tag((MR_Word) OrigOrigin_19)) == (MR_Integer) 0);
      if (succeeded)
      {
