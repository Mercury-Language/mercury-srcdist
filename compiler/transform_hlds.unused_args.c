  ...
  else
  {
    ...
    else
    {
      ...
      Var_68 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), Pieces1_43, Pieces2_44);
      {
        ...
        MR_hl_field(1, Spec_25, 2) = ((MR_Box) ((MR_Unsigned) 108U));
  ...
  MR_Box * wrapper_arg_2)
{
  ...
  succeeded = transform_hlds__unused_args__IntroducedFrom__pred__unused_args_traverse_goal__756__1_2_p_0(((MR_Word) (wrapper_arg_1)), &conv0_LambdaHeadVar__2_105);
  if (succeeded)
  {
