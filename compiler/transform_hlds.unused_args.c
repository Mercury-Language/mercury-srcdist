  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_51)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_17, (MR_Integer) 519, &Intermod_18);
  switch (Intermod_18) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 0:
      {
  ...
  MR_Word * UnusedArgInfos_7)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 75, &VeryVerbose_9);
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 519, &IntermodAnalysis_18);
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_62)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_19, (MR_Integer) 519, &Intermod_21);
