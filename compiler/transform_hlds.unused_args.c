...
transform_hlds__unused_args__IntroducedFrom__pred__unused_args_traverse_unify__606__1_2_p_0(
  MR_Word LHSVar_8,
  MR_Word CellVar_66);

static MR_bool MR_CALL 
transform_hlds__unused_args__IntroducedFrom__pred__unused_args_traverse_unify__597__1_2_p_0(
  MR_Word LHSVar_8,
  MR_Word CellVar_16);

static MR_bool MR_CALL 
transform_hlds__unused_args__IntroducedFrom__pred__unused_args_traverse_goal__532__1_2_p_0(
  MR_Word LambdaHeadVar__1_64,
  MR_Word * LambdaHeadVar__2_65);

static void MR_CALL 
transform_hlds__unused_args__IntroducedFrom__pred__try_to_look_up_global_var_usage_map_entry_for_proc__340__1_3_p_0(
  MR_Word HeadVars_32,
  ...
  MR_Box * wrapper_arg_2)
{
  ...
  succeeded = transform_hlds__unused_args__IntroducedFrom__pred__unused_args_traverse_goal__532__1_2_p_0(((MR_Word) (wrapper_arg_1)), &conv0_LambdaHeadVar__2_65);
  if (succeeded)
  {
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = transform_hlds__unused_args__IntroducedFrom__pred__unused_args_traverse_unify__606__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) ((MR_hl_field(0, closure, 4)))));
  return succeeded;
}
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = transform_hlds__unused_args__IntroducedFrom__pred__unused_args_traverse_unify__597__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) ((MR_hl_field(0, closure, 4)))));
  return succeeded;
}
  ...
  MR_Box * wrapper_arg_2)
{
  ...
  transform_hlds__unused_args__IntroducedFrom__pred__try_to_look_up_global_var_usage_map_entry_for_proc__340__1_3_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Integer) (wrapper_arg_1)), &conv0_HeadVar__3_185);
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_27)
{
  ...
  MR_Word DoWarn_22;
  MR_Word OptTuple_24;
  MR_Word OptUnusedArgs_25;
  MR_Word STATE_VARIABLE_ModuleInfo_1_29;
  MR_Word STATE_VARIABLE_ModuleInfo_2_34;

  hlds__hlds_module__module_info_get_globals_2_p_0(STATE_VARIABLE_ModuleInfo_0_26, &Globals_12);
  libs__globals__lookup_bool_option_3_p_0(Globals_12, (MR_Integer) 132, &VeryVerbose_13);
  transform_hlds__unused_args__init_global_var_usage_map_5_p_0(&GlobalVarUsageMap0_14, &FixpointPredProcIds_15, &NewProcMap0_16, STATE_VARIABLE_ModuleInfo_0_26, &STATE_VARIABLE_ModuleInfo_1_29);
  ...
  transform_hlds__unused_args__build_proc_to_unused_args_map_5_p_0(STATE_VARIABLE_ModuleInfo_1_29, GlobalVarUsageMap_17, FixpointPredProcIds_15, ProcToUnusedArgsMap0_18, &ProcToUnusedArgsMap_19);
  mercury__map__keys_2_p_0((MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_proc_id_0), (MR_Word) (&transform_hlds__unused_args_scalar_common_1[0]), ProcToUnusedArgsMap_19, &PredProcIdsToFix_20);
  ...
  if (succeeded)
  {
    ...
    Var_33 = mercury__set__init_0_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_gen_pragma_unused_args_info_0));
    transform_hlds__unused_args_warn_pragma__gather_warnings_and_pragmas_10_p_0(STATE_VARIABLE_ModuleInfo_1_29, ProcToUnusedArgsMap_19, DoWarn_22, GatherPragmas_7, PredProcIdsToFix_20, WarnedPredIds0_23, (MR_Word) ((MR_Unsigned) 0U), Specs_9, Var_33, PragmaUnusedArgInfos_10);
  }
  else
  {
  ...
  switch (RecordAnalysis_8) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 0:
      STATE_VARIABLE_ModuleInfo_2_34 = STATE_VARIABLE_ModuleInfo_1_29;
      break;
    case (MR_Integer) 1:
      transform_hlds__unused_args_analysis__record_analysis_unused_args_4_p_0(ProcToUnusedArgsMap_19, FixpointPredProcIds_15, STATE_VARIABLE_ModuleInfo_1_29, &STATE_VARIABLE_ModuleInfo_2_34);
      break;
  }
  libs__globals__get_opt_tuple_2_p_0(Globals_12, &OptTuple_24);
  OptUnusedArgs_25 = ((((MR_Unsigned) ((MR_hl_field(0, OptTuple_24, 0))) >> 6)) & (MR_Integer) 1);
  switch (OptUnusedArgs_25) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 1:
      *STATE_VARIABLE_ModuleInfo_27 = STATE_VARIABLE_ModuleInfo_2_34;
      break;
    case (MR_Integer) 0:
      transform_hlds__unused_args_optimize__optimize_unused_args_7_p_0(VeryVerbose_13, ProcToUnusedArgsMap_19, GlobalVarUsageMap_17, FixpointPredProcIds_15, NewProcMap0_16, STATE_VARIABLE_ModuleInfo_2_34, STATE_VARIABLE_ModuleInfo_27);
      break;
  }
}
