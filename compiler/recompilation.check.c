  ...
  MR_Word * HeadVar__2_2)
{
  ...
  Var_38 = (MR_Word) (ImpTypeClasses_19);
  ItemTypeClasses_28 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_typeclass_info_0), IntTypeClasses_13, Var_38);
  {
    MR_Word base;
    base = (MR_Word) MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL);
    *HeadVar__2_2 = base;
