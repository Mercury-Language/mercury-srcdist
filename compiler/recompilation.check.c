    ...
    case (MR_Integer) 0:
      {
...

        {
          ...
          MR_hl_field(MR_mktag(0), Var_20, 3) = ((MR_Box) (RecompAvail_6));
          MR_hl_field(MR_mktag(0), Var_20, 4) = ((MR_Box) (TypeCtor_7));
        }
        Var_21 = mercury__one_or_more__one_or_more_to_list_1_f_1((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_constructor_0), Ctors_15);
