  ...
  MR_Word * HaveParseTreeMaps_18)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_12, (MR_Integer) 79, &FindAll_20);
  ...
  MR_Word * STATE_VARIABLE_Info_32)
{
  ...
  if (((MR_tag((MR_Word) ReadUsedFileResult_19)) == (MR_Integer) 1))
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_12, (MR_Integer) 78, &Verbose_144);
    switch (Verbose_144) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        {
  ...
  else
  {
    ...
    if ((MaybeStoppingReason_21 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      ...
      if ((Reasons_22 == (MR_Word) ((MR_Unsigned) 0U)))
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_12, (MR_Integer) 78, &Verbose_146);
        switch (Verbose_146) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 0:
            {
  ...
  MR_Word Globals_7)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 78, &Verbose_10);
  switch (Verbose_10) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 0:
      {
