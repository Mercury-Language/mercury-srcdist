          ...
          case (MR_Integer) 5:
            {
              ...
              if (succeeded)
              {
                ...
                mercury__list__foldl_4_p_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_class_decl_0), (MR_Word) (&recompilation__check__recompilation__check__type_ctor_info_recompilation_check_info_0), Var_82, ClassDecls_51, ((MR_Box) (STATE_VARIABLE_Info_81_81)), &conv1_STATE_VARIABLE_Info_77);
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          parse_tree__prog_item__int_imp_items_to_item_blocks_11_p_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_module_section_0), ParseTreeModuleName_38, ModuleContext_40, ((MR_Box) ((MR_Integer) 0)), ((MR_Box) ((MR_Integer) 1)), IntIncls_42, ImpIncls_43, IntAvails_44, ImpAvails_45, IntItems_46, ImplItems_47, &RawItemBlocks_49);
