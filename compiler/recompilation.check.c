          ...
          case (MR_Integer) 5:
            {
              ...
              recompilation__check__check_for_simple_item_ambiguity_9_p_0(NeedQualifier_7, OldTimestamp_8, VersionNumbers_9, (MR_Integer) 4, TypeClassSymName_42, TypeClassArity_50, &NeedsCheck_93, STATE_VARIABLE_Info_0_75, &STATE_VARIABLE_Info_80_80);
              succeeded = (NeedsCheck_93 == (MR_Integer) 1);
              if (succeeded)
              {
              ...
              if (succeeded)
              {
                ...
                mercury__list__foldl_4_p_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_class_decl_0), (MR_Word) (&recompilation__check__recompilation__check__type_ctor_info_recompilation_check_info_0), Var_81, ClassDecls_51, ((MR_Box) (STATE_VARIABLE_Info_80_80)), &conv1_STATE_VARIABLE_Info_76);
