  ...
  MR_Word * STATE_VARIABLE_Info_24)
{
  ...
  else
  {
    ...
    hlds__hlds_pred__construct_field_access_function_name_3_p_0((MR_Integer) 0, FieldName_17, &ExtractFuncSymName_19);
    hlds__hlds_pred__construct_field_access_function_name_3_p_0((MR_Integer) 1, FieldName_17, &UpdateFuncSymName_20);
