...
recompilation__check__check_class_method_for_ambiguities_6_p_0(
  ...
  MR_Word * STATE_VARIABLE_Info_32)
{
  if (((MR_tag((MR_Word) ClassMethod_10)) == (MR_Integer) 0))
  {
          ...
          case (MR_Integer) 5:
            {
              ...
              if (succeeded)
              {
                succeeded = ((MR_tag((MR_Word) Interface_46)) == (MR_Integer) 1);
                if (succeeded)
      ...
      case (MR_Integer) 0:
        {
          ...
          succeeded = ((MR_tag((MR_Word) MaybeNewTimestamp_29)) == (MR_Integer) 1);
          if (succeeded)
          {
...
{
  {
    ...
    if (succeeded)
    {
      ...
      succeeded = ((MR_tag((MR_Word) MaybeNewTimestamp_31)) == (MR_Integer) 1);
      if (succeeded)
      {
      ...
      if (succeeded)
      {
        ...
        succeeded = ((MR_tag((MR_Word) MaybeUsedItemsTerm_15)) == (MR_Integer) 1);
        if (succeeded)
        {
          ...
          succeeded = ((MR_tag((MR_Word) MaybeVersionNumbers_41)) == (MR_Integer) 1);
          if (succeeded)
