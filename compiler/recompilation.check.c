...
recompilation__check__IntroducedFrom__func__check_for_pred_or_func_item_ambiguity_2__1202__1_4_f_0(
  MR_Word ItemType_9,
  MR_Integer Arity_12,
  MR_String Name_16,
...
static /* final */ const MR_Box recompilation__check_scalar_common_5[5][11] = {
  ...
  /* row 1 */
  {
    ...
    ((MR_Box) (&parse_tree__module_imports__parse_tree__module_imports__type_ctor_info_recomp_need_qualifier_0)),
    ((MR_Box) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0)),
    ((MR_Box) (&mercury__builtin__builtin__type_ctor_info_int_0)),
    ((MR_Box) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0)),
    ((MR_Box) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0)),
...
{
  {
    MR_bool succeeded = (RecompNeedQual_9 == (MR_Integer) 0);
    MR_String Var_21;
...
{
  {
    ...
    else
    {
      ...
      if (succeeded)
        recompilation__check__check_functor_ambiguities_2_7_p_0(RecompNeedQual_6, ExtractFuncName_16, (MR_Word) (MR_mkword(MR_mktag(1), &recompilation__check_scalar_common_10[1])), ResolvedCtor_7, UsedCtorAL_38, STATE_VARIABLE_Info_0_18, &STATE_VARIABLE_Info_23_23);
      else
      ...
      if (succeeded)
        recompilation__check__check_functor_ambiguities_2_7_p_0(RecompNeedQual_6, UpdateFuncName_17, (MR_Word) (MR_mkword(MR_mktag(1), &recompilation__check_scalar_common_10[2])), ResolvedCtor_7, UsedCtorAL_69, STATE_VARIABLE_Info_23_23, STATE_VARIABLE_Info_19);
      else
...
{
  {
    ...
    if (succeeded)
      recompilation__check__check_functor_ambiguities_2_7_p_0(RecompNeedQual_6, Name_12, Var_20, ResolvedCtor_17, UsedCtorAL_41, STATE_VARIABLE_Info_0_18, &STATE_VARIABLE_Info_21_21);
    else
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(0), Var_22, 3) = ((MR_Box) (RecompNeedQual_6));
...
{
  {
    ...
    (env).recompilation__check__check_for_pred_or_func_item_ambiguity_2_8_p_0_env_0__OldMatchingModuleNames_14 = OldMatchingModuleNames_14;
    {
      ...
      (env).recompilation__check__check_for_pred_or_func_item_ambiguity_2_8_p_0_env_0__succeeded = (RecompNeedQual_10 == (MR_Integer) 0);
...
{
  {
    ...
    if (succeeded)
    {
...

      {
        ...
        MR_hl_field(MR_mktag(0), Var_20, 4) = ((MR_Box) (RecompNeedQual_11));
...
{
  {
    ...
    succeeded = (RecompNeedQual_10 == (MR_Integer) 0);
    if (succeeded)
    {
      succeeded = ((MR_tag((MR_Word) OldModuleQualifier_13)) == (MR_Integer) 0);
      if (succeeded)
  ...
  MR_Word * STATE_VARIABLE_Info_27)
{
  ...
  else
  {
    ...
    recompilation__check__check_for_pred_or_func_item_ambiguity_10_p_0((MR_Integer) 1, RecompNeedQual_7, OldTimestamp_8, VersionNumbers_9, PredOrFunc_14, MethodName_13, MethodArgs_15, MethodWithType_16, STATE_VARIABLE_Info_0_26, STATE_VARIABLE_Info_27);
  }
}
      ...
      case (MR_Integer) 1:
        {
          ...
          recompilation__check__check_for_simple_item_ambiguity_9_p_0(RecompNeedQual_7, OldTimestamp_8, VersionNumbers_9, (MR_Integer) 3, InstSymName_23, InstArity_30, &Var_31, STATE_VARIABLE_Info_0_77, STATE_VARIABLE_Info_78);
        }
        break;
      case (MR_Integer) 2:
        {
          ...
          recompilation__check__check_for_simple_item_ambiguity_9_p_0(RecompNeedQual_7, OldTimestamp_8, VersionNumbers_9, (MR_Integer) 2, ModeSymName_33, ModeArity_39, &Var_40, STATE_VARIABLE_Info_0_77, STATE_VARIABLE_Info_78);
        }
        break;
      case (MR_Integer) 3:
          ...
          case (MR_Integer) 0:
            {
              ...
              recompilation__check__check_for_pred_or_func_item_ambiguity_10_p_0((MR_Integer) 0, RecompNeedQual_7, OldTimestamp_8, VersionNumbers_9, PredOrFunc_54, PredSymName_53, Args_55, WithType_56, STATE_VARIABLE_Info_0_77, STATE_VARIABLE_Info_78);
            }
            break;
          case (MR_Integer) 1:
          ...
          case (MR_Integer) 5:
            {
              ...
              recompilation__check__check_for_simple_item_ambiguity_9_p_0(RecompNeedQual_7, OldTimestamp_8, VersionNumbers_9, (MR_Integer) 4, TypeClassSymName_42, TypeClassArity_50, &NeedsCheck_95, STATE_VARIABLE_Info_0_77, &STATE_VARIABLE_Info_82_82);
              ...
              if (succeeded)
              {
...

                {
                  ...
                  MR_hl_field(MR_mktag(0), Var_83, 3) = ((MR_Box) (RecompNeedQual_7));
          ...
          case (MR_Integer) 11:
            {
              ...
              recompilation__check__check_for_simple_item_ambiguity_9_p_0(RecompNeedQual_7, OldTimestamp_8, VersionNumbers_9, (MR_Integer) 0, TypeSymName_14, TypeArity_20, &NeedsCheck_21, STATE_VARIABLE_Info_0_77, &STATE_VARIABLE_Info_90_90);
                ...
                case (MR_Integer) 1:
                  {
                    ...
                    recompilation__check__check_type_defn_ambiguity_with_functor_5_p_0(RecompNeedQual_7, Var_91, TypeBody_16, STATE_VARIABLE_Info_90_90, STATE_VARIABLE_Info_78);
                  }
                  break;
              }
            }
    ...
    case (MR_Integer) 0:
      {
...

        {
          ...
          MR_hl_field(MR_mktag(0), Var_20, 3) = ((MR_Box) (RecompNeedQual_6));
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
...

        {
          ...
          MR_hl_field(MR_mktag(0), Var_37, 5) = ((MR_Box) (RecompNeedQual_12));
      ...
      if (((MR_tag((MR_Word) SymName_16)) == (MR_Integer) 1))
      {
        ...
        recompilation__check__check_functor_ambiguities_by_name_6_p_0(RecompNeedQual_12, SymName_16, AritiesToMatch_31, ResolvedFunctor_32, STATE_VARIABLE_Info_38_38, STATE_VARIABLE_Info_35);
      }
      else
        {
...
{
  {
    ...
    if (succeeded)
      recompilation__check__check_functor_ambiguities_2_7_p_0(RecompNeedQual_7, Name_8, MatchArity_9, ResolvedCtor_10, UsedCtorAL_15, STATE_VARIABLE_Info_0_16, STATE_VARIABLE_Info_17);
    else
        ...
        case (MR_Integer) 0:
          {
...

            {
              ...
              MR_hl_field(MR_mktag(0), Var_29, 3) = ((MR_Box) (RecompNeedQual_1));
        ...
        case (MR_Integer) 1:
          {
            ...
            if (succeeded)
            {
...

              {
                ...
                MR_hl_field(MR_mktag(0), Var_40, 3) = ((MR_Box) (RecompNeedQual_1));
        ...
        case (MR_Integer) 2:
          {
            ...
            if (succeeded)
            {
...

              {
                ...
                MR_hl_field(MR_mktag(0), Var_53, 3) = ((MR_Box) (RecompNeedQual_1));
      ...
      *NeedsCheck_16 = (MR_Integer) 1;
      ...
      if (succeeded)
      {
...

        {
          ...
          MR_hl_field(MR_mktag(0), Var_25, 4) = ((MR_Box) (RecompNeedQual_10));
...
{
  {
...

    {
      ...
      MR_hl_field(MR_mktag(0), Var_20, 3) = ((MR_Box) (RecompNeedQual_7));
...
{
  {
    ...
    RecompNeedQual_20 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), ModuleTimestamp_17, (MR_Integer) 2))) & (MR_Integer) 1);
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          recompilation__check__check_module_used_items_8_p_0(ImportedModuleName_16, RecompNeedQual_20, RecordedTimestamp_19, UsedItemsTerm_37, VersionNumbers_50, RawItemBlocks_51, STATE_VARIABLE_Info_74_74, STATE_VARIABLE_Info_54);
        }
        else
        {
          MR_Word Var_78;
...
{
  {
    ...
    STATE_VARIABLE_Info_40_40 = ((MR_Word) (conv1_STATE_VARIABLE_Info_40_40));
    {
      ...
      MR_hl_field(MR_mktag(0), Var_55, 3) = ((MR_Box) (RecompNeedQual_10));
                ...
                if (succeeded)
                {
                  ...
                  if (succeeded)
                  {
                    ...
                    if (succeeded)
                    {
                      ...
                      {
                        RecompNeedQual_20 = (MR_Integer) 1;
                        succeeded = MR_TRUE;
                      }
                      else
                      {
                          ...
                          if (succeeded)
                          {
                            ...
                            if (succeeded)
                            {
                              ...
                              if (succeeded)
                              {
                                ...
                                if (succeeded)
                                {
                                  RecompNeedQual_20 = (MR_Integer) 0;
                                  succeeded = MR_TRUE;
                                }
                              }
                            }
      ...
      *ModuleName_7 = ModuleNamePrime_14;
      {
        ...
        *ModuleTimestamp_8 = base;
        ...
        MR_hl_field(MR_mktag(0), base, 2) = (MR_Box) ((MR_Unsigned) (RecompNeedQual_20));
      }
    }
    else
    {
