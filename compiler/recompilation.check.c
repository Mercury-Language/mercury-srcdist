    ...
    else
    {
      ...
      else
      {
...

        {
          ...
          MR_hl_field(MR_mktag(0), STATE_VARIABLE_Info_66_66, 2) = ((MR_Box) (Var_109));
        ...
        mercury__list__foldl2_6_p_2((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), (MR_Word) (&recompilation__check__recompilation__check__type_ctor_info_recompilation_check_info_0), (MR_Word) (&mercury__io__io__type_ctor_info_state_0), Var_68, Var_109, ((MR_Box) (STATE_VARIABLE_Info_66_66)), &conv7_STATE_VARIABLE_Info_33, ((MR_Box) ((MR_Integer) 0)), &conv6_STATE_VARIABLE_IO_35);
