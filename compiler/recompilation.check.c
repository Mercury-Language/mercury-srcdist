                      ...
                      case (MR_Integer) 5:
                        {
                          ...
                          else
                          {
                            ...
                            mercury__private_builtin__builtin_compare_int_3_p_0(&SubResult2_258, Var_458, ArgY2_257);
                            succeeded = (SubResult2_258 != (MR_Integer) 0);
                            if (succeeded)
...
{
  {
    ...
    else
    {
      ...
      else
      {
        ...
        mercury__private_builtin__builtin_compare_int_3_p_0(&SubResult2_9, Var_41, Var_42);
