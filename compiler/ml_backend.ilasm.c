...
MR_decl_label10(ml_backend__ilasm__output_simple_type_opcode_3_0, 61,15,17,19,21,23,25,81,30,32)
MR_decl_label5(ml_backend__ilasm__output_simple_type_opcode_3_0, 34,42,44,46,48)
...
MR_BEGIN_MODULE(ml_backend__ilasm_module37)
	...
	MR_init_label10(ml_backend__ilasm__output_simple_type_opcode_3_0,61,15,17,19,21,23,25,81,30,32)
	MR_init_label5(ml_backend__ilasm__output_simple_type_opcode_3_0,34,42,44,46,48)
MR_BEGIN_CODE
...
MR_def_static(ml_backend__ilasm__output_simple_type_opcode_3_0)
	...
	if (MR_INT_NE(MR_tag(MR_r1),0)) {
		MR_GOTO_LAB(ml_backend__ilasm__output_simple_type_opcode_3_0_i61);
	}
	MR_COMPUTED_GOTO((MR_Unsigned) MR_unmkbody(MR_r1),
		...
		MR_LABEL_AP(ml_backend__ilasm__output_simple_type_opcode_3_0_i81) MR_AND
		MR_LABEL_AP(ml_backend__ilasm__output_simple_type_opcode_3_0_i21) MR_AND
		MR_LABEL_AP(ml_backend__ilasm__output_simple_type_opcode_3_0_i19) MR_AND
...
MR_def_label(ml_backend__ilasm__output_simple_type_opcode_3_0,25)
	...
	MR_np_tailcall_ent(io__write_string_3_0);
MR_def_label(ml_backend__ilasm__output_simple_type_opcode_3_0,81)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(1);
	MR_sv(1) = (MR_Word) MR_succip;
	MR_np_call_localret_ent(fn__ml_backend__ilasm__this_file_0_0,
