...
static /* final */ const MR_Box check_hlds__simplify__simplify_goal_scalar_common_1[16][2] = {
  ...
  /* row 13 */
  {
    (MR_Box) (((((MR_Unsigned) ((MR_Integer) 24) << 1)) | (MR_Unsigned) ((MR_Integer) 1))),
          ...
          case (MR_Integer) 1:
            {
              ...
              if (succeeded)
                packed_word_3 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Unify_20, (MR_Integer) 2)));
            }
            break;
          case (MR_Integer) 2:
            {
              MR_Word BuiltinState_28 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(2), GoalExpr_7, (MR_Integer) 3))) & (MR_Integer) 1);
              MR_Unsigned packed_word_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), GoalExpr_7, (MR_Integer) 3)));
              ...
              case (MR_Integer) 0:
                {
                  ...
                  MR_Unsigned packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), GoalExpr_7, (MR_Integer) 5)));
              ...
              case (MR_Integer) 2:
                {
                  ...
                  MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), GoalExpr_7, (MR_Integer) 1)));
...
{
  {
    ...
    if (succeeded)
    {
      packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), GoalExpr_2, (MR_Integer) 3)));
        ...
        case (MR_Integer) 2:
          {
            ...
            MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), STATE_VARIABLE_GoalExpr_0_66, (MR_Integer) 1)));
              ...
              case (MR_Integer) 1:
                {
                  ...
                  MR_Unsigned packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), ShortHand0_53, (MR_Integer) 0)));
