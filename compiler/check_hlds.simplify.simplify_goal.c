  ...
  void * env_ptr_arg)
{
  ...
  {
    MR_Word Var_65 = ((MR_Word) ((MR_hl_field(0, (env_ptr)->check_hlds__simplify__simplify_goal__simplify_goal_8_p_0_env_0__SubGoal_25, (MR_Integer) 0))));
    MR_Word Var_66;
    MR_Word Var_26 = ((MR_Word) ((MR_hl_field(0, (env_ptr)->check_hlds__simplify__simplify_goal__simplify_goal_8_p_0_env_0__SubGoal_25, (MR_Integer) 1))));

    (env_ptr)->check_hlds__simplify__simplify_goal__simplify_goal_8_p_0_env_0__succeeded = ((((MR_tag((MR_Word) Var_65)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(3, Var_65, (MR_Integer) 0)))) == (MR_Integer) 3)));
    if ((env_ptr)->check_hlds__simplify__simplify_goal__simplify_goal_8_p_0_env_0__succeeded)
    {
      Var_66 = ((MR_Word) ((MR_hl_field(3, Var_65, (MR_Integer) 1))));
  ...
  MR_Word * STATE_VARIABLE_Info_57)
{
  ...
  (env).check_hlds__simplify__simplify_goal__simplify_goal_8_p_0_env_0__Goal0_9 = Goal0_9;
  {
    ...
    {
      MR_Word Var_116 = ((MR_Word) ((MR_hl_field(0, NestedContext0_11, (MR_Integer) 1))));
      MR_Unsigned Var_117 = ((MR_Unsigned) ((MR_hl_field(0, NestedContext0_11, (MR_Integer) 2))));
      MR_Word Var_118 = ((MR_Word) ((MR_hl_field(0, NestedContext0_11, (MR_Integer) 3))));
      MR_Word Var_115 = ((MR_Unsigned) ((MR_hl_field(0, NestedContext0_11, (MR_Integer) 0))) & (MR_Integer) 1);
...

      {
        ...
        MR_hl_field(0, NestedContext_17, 1) = ((MR_Box) (Var_116));
        MR_hl_field(0, NestedContext_17, 2) = ((MR_Box) (Var_117));
        MR_hl_field(0, NestedContext_17, 3) = ((MR_Box) (Var_118));
      }
    }
    else
    ...
    hlds__goal_form__goal_can_loop_or_throw_imaf_4_p_0((env).check_hlds__simplify__simplify_goal__simplify_goal_8_p_0_env_0__Goal0_9, &Goal0CanLoopOrThrow_21, ModuleInfo0_20, &ModuleInfo_22);
        ...
        {
          {
            ...
            check_hlds__simplify__simplify_info__simplify_info_get_fully_strict_2_p_0(STATE_VARIABLE_Info_63_63, &Var_121);
            (env).check_hlds__simplify__simplify_goal__simplify_goal_8_p_0_env_0__succeeded = ((MR_Integer) 0 == Var_121);
          }
          if (!((env).check_hlds__simplify__simplify_goal__simplify_goal_8_p_0_env_0__succeeded))
    ...
    if ((env).check_hlds__simplify__simplify_goal__simplify_goal_8_p_0_env_0__succeeded)
    {
      ...
      if ((env).check_hlds__simplify__simplify_goal__simplify_goal_8_p_0_env_0__succeeded)
      {
...

        {
          ...
          MR_hl_field(2, Msg_29, 0) = ((MR_Box) (Context_24));
          MR_hl_field(2, Msg_29, 1) = ((MR_Box) (MR_mkword(1, &check_hlds__simplify__simplify_goal_scalar_common_1[13])));
        }
        {
          Var_94 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(1, Var_94, 0) = ((MR_Box) (Msg_29));
          MR_hl_field(1, Var_94, 1) = ((MR_Box) ((MR_Unsigned) 0U));
        }
        {
          Spec_30 = (MR_Word) MR_mkword(3, MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(3, Spec_30, 0) = ((MR_Box) ((MR_String) "predicate \140check_hlds.simplify.simplify_goal.simplify_goal\'/8"));
          MR_hl_field(3, Spec_30, 1) = (MR_Box) (((((MR_Unsigned) ((MR_Integer) 27) << 1)) | (MR_Unsigned) ((MR_Integer) 1)));
          MR_hl_field(3, Spec_30, 2) = ((MR_Box) ((MR_Unsigned) 4U));
          MR_hl_field(3, Spec_30, 3) = ((MR_Box) (MR_mkword(2, &check_hlds__simplify__simplify_goal_scalar_common_2[1])));
          MR_hl_field(3, Spec_30, 4) = ((MR_Box) (Var_94));
        }
    ...
    else
    {
      ...
      parse_tree__prog_data__determinism_components_3_p_0(Detism_19, &Var_122, &MaxSoln_34);
      (env).check_hlds__simplify__simplify_goal__simplify_goal_8_p_0_env_0__succeeded = ((MR_Integer) 1 == Var_122);
      if ((env).check_hlds__simplify__simplify_goal__simplify_goal_8_p_0_env_0__succeeded)
      {
        ...
        if ((env).check_hlds__simplify__simplify_goal__simplify_goal_8_p_0_env_0__succeeded)
        {
          ...
          check_hlds__simplify__simplify_info__simplify_info_get_module_info_2_p_0(STATE_VARIABLE_Info_63_63, &Var_123);
          (env).check_hlds__simplify__simplify_goal__simplify_goal_8_p_0_env_0__succeeded = hlds__hlds_module____Unify____module_info_0_0(ModuleInfo_22, Var_123);
          if ((env).check_hlds__simplify__simplify_goal__simplify_goal_8_p_0_env_0__succeeded)
          {
            check_hlds__simplify__simplify_info__simplify_info_get_var_table_2_p_0(STATE_VARIABLE_Info_63_63, &VarTable_37);
            (env).check_hlds__simplify__simplify_goal__simplify_goal_8_p_0_env_0__succeeded = hlds__instmap__instmap_delta_no_output_vars_5_p_0(ModuleInfo_22, VarTable_37, InstMap0_12, InstMapDelta_35, NonLocalVars_36);
            if ((env).check_hlds__simplify__simplify_goal__simplify_goal_8_p_0_env_0__succeeded)
            {
              switch (Purity_23) {
                default:
                ...
                {
                  {
                    ...
                    check_hlds__simplify__simplify_info__simplify_info_get_fully_strict_2_p_0(STATE_VARIABLE_Info_63_63, &Var_124);
                    (env).check_hlds__simplify__simplify_goal__simplify_goal_8_p_0_env_0__succeeded = ((MR_Integer) 0 == Var_124);
                  }
                  if (!((env).check_hlds__simplify__simplify_goal__simplify_goal_8_p_0_env_0__succeeded))
                    (env).check_hlds__simplify__simplify_goal__simplify_goal_8_p_0_env_0__succeeded = (Goal0CanLoopOrThrow_21 == (MR_Integer) 1);
                }
    ...
    GoalExpr1_38 = ((MR_Word) ((MR_hl_field(0, Goal1_33, (MR_Integer) 0))));
    GoalInfo1_39 = ((MR_Word) ((MR_hl_field(0, Goal1_33, (MR_Integer) 1))));
    (env).check_hlds__simplify__simplify_goal__simplify_goal_8_p_0_env_0__succeeded = ((((MR_tag((MR_Word) GoalExpr1_38)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(3, GoalExpr1_38, (MR_Integer) 0)))) == (MR_Integer) 5)));
    if ((env).check_hlds__simplify__simplify_goal__simplify_goal_8_p_0_env_0__succeeded)
    {
      Reason1_40 = ((MR_Word) ((MR_hl_field(3, GoalExpr1_38, (MR_Integer) 1))));
      SomeGoal1_41 = ((MR_Word) ((MR_hl_field(3, GoalExpr1_38, (MR_Integer) 2))));
    ...
    if ((env).check_hlds__simplify__simplify_goal__simplify_goal_8_p_0_env_0__succeeded)
    {
      Var_103 = ((MR_Word) ((MR_hl_field(0, Goal2_42, (MR_Integer) 0))));
      _GoalInfo2_45 = ((MR_Word) ((MR_hl_field(0, Goal2_42, (MR_Integer) 1))));
      (env).check_hlds__simplify__simplify_goal__simplify_goal_8_p_0_env_0__succeeded = ((((MR_tag((MR_Word) Var_103)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(3, Var_103, (MR_Integer) 0)))) == (MR_Integer) 5)));
      if ((env).check_hlds__simplify__simplify_goal__simplify_goal_8_p_0_env_0__succeeded)
      {
        Reason2_43 = ((MR_Word) ((MR_hl_field(3, Var_103, (MR_Integer) 1))));
        SomeGoal2_44 = ((MR_Word) ((MR_hl_field(3, Var_103, (MR_Integer) 2))));
        if (((((MR_tag((MR_Word) Reason2_43)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(3, Reason2_43, (MR_Integer) 0)))) == (MR_Integer) 5))))
        {
          MR_Word Var_104 = ((MR_Unsigned) ((MR_hl_field(3, Reason2_43, (MR_Integer) 1))) & (MR_Integer) 1);
          MR_Unsigned packed_word_1 = (MR_Unsigned) ((MR_hl_field(3, Reason2_43, (MR_Integer) 1)));

          (env).check_hlds__simplify__simplify_goal__simplify_goal_8_p_0_env_0__succeeded = (Var_104 == (MR_Integer) 0);
        }
        else
        if (((((MR_tag((MR_Word) Reason2_43)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(3, Reason2_43, (MR_Integer) 0)))) == (MR_Integer) 6))))
        {
          MR_Word Kind_47 = ((MR_Unsigned) ((MR_hl_field(3, Reason2_43, (MR_Integer) 2))) & (MR_Integer) 3);
          MR_Word Var_46 = ((MR_Word) ((MR_hl_field(3, Reason2_43, (MR_Integer) 1))));
          MR_Unsigned packed_word_2 = (MR_Unsigned) ((MR_hl_field(3, Reason2_43, (MR_Integer) 2)));
    ...
    if ((env).check_hlds__simplify__simplify_goal__simplify_goal_8_p_0_env_0__succeeded)
      ...
      Goal3_48 = Goal2_42;
    GoalExpr3_49 = ((MR_Word) ((MR_hl_field(0, Goal3_48, (MR_Integer) 0))));
    GoalInfo3_50 = ((MR_Word) ((MR_hl_field(0, Goal3_48, (MR_Integer) 1))));
    check_hlds__simplify__simplify_goal__maybe_handle_stack_flush_4_p_0((MR_Integer) 0, GoalExpr3_49, STATE_VARIABLE_Common_0_54, &STATE_VARIABLE_Common_106_106);
    ...
    check_hlds__simplify__simplify_goal__maybe_handle_stack_flush_4_p_0((MR_Integer) 1, GoalExpr4_51, STATE_VARIABLE_Common_107_107, STATE_VARIABLE_Common_55);
    check_hlds__simplify__simplify_goal__enforce_unreachability_invariant_4_p_0(GoalInfo4_52, &GoalInfo_53, STATE_VARIABLE_Info_108_108, STATE_VARIABLE_Info_57);
    {
      ...
      *Goal_10 = base;
      MR_hl_field(0, base, 0) = ((MR_Box) (GoalExpr4_51));
      MR_hl_field(0, base, 1) = ((MR_Box) (GoalInfo_53));
    }
  }
}
