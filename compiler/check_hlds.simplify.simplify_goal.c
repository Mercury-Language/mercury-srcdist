...
static /* final */ const MR_Box check_hlds__simplify__simplify_goal_scalar_common_1[14][2] = {
  ...
  /* row   5 */
  {
    ((MR_Box) (MR_mkword(3, &check_hlds__simplify__simplify_goal_scalar_common_1[4]))),
    ((MR_Box) (MR_mkword(1, &check_hlds__simplify__simplify_goal_scalar_common_1[3])))
  },
  /* row   6 */
  {
    ((MR_Box) (MR_Word) ((MR_Unsigned) 6U)),
  ...
  /* row   7 */
  {
    ((MR_Box) (MR_mkword(3, &check_hlds__simplify__simplify_goal_scalar_common_1[6]))),
    ((MR_Box) (MR_mkword(1, &check_hlds__simplify__simplify_goal_scalar_common_1[5])))
  },
  /* row   8 */
  {
    ((MR_Box) (MR_Word) ((MR_Unsigned) 6U)),
  ...
  /* row   9 */
  {
    ((MR_Box) (MR_mkword(3, &check_hlds__simplify__simplify_goal_scalar_common_1[8]))),
    ((MR_Box) (MR_mkword(1, &check_hlds__simplify__simplify_goal_scalar_common_1[7])))
  },
  /* row  10 */
  {
  ...
  {
    (MR_Box) ((MR_Unsigned) 0U),
    ((MR_Box) (MR_mkword(1, &check_hlds__simplify__simplify_goal_scalar_common_1[9])))
  },
  /* row  12 */
  {
    ((MR_Box) (MR_mkword(2, &check_hlds__simplify__simplify_goal_scalar_common_1[11]))),
    ((MR_Box) ((MR_Unsigned) 0U))
  },
  /* row  13 */
  {
...
static /* final */ const MR_Box check_hlds__simplify__simplify_goal_scalar_common_2[2][1] = {
  /* row   0 */
  { ((MR_Box) (MR_mkword(1, &check_hlds__simplify__simplify_goal_scalar_common_1[1]))) },
  /* row   1 */
  { (MR_Box) ((MR_Unsigned) 1U) },
};
  ...
  else
  {
    ...
    }
    {
      ...
      *GoalExpr_11 = base;
      ...
      MR_hl_field(3, base, 1) = ((MR_Box) (MR_mkword(3, &check_hlds__simplify__simplify_goal_scalar_common_1[10])));
  ...
  void * env_ptr_arg)
{
  ...
  {
    MR_Word Var_72 = ((MR_Word) ((MR_hl_field(0, (env_ptr)->check_hlds__simplify__simplify_goal__simplify_goal_8_p_0_env_0__SubGoal_24, (MR_Integer) 0))));
    MR_Word Var_73;
    ...
    (env_ptr)->check_hlds__simplify__simplify_goal__simplify_goal_8_p_0_env_0__succeeded = ((((MR_tag((MR_Word) Var_72)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(3, Var_72, (MR_Integer) 0)))) == (MR_Integer) 3)));
    if ((env_ptr)->check_hlds__simplify__simplify_goal__simplify_goal_8_p_0_env_0__succeeded)
    {
      Var_73 = ((MR_Word) ((MR_hl_field(3, Var_72, (MR_Integer) 1))));
      (env_ptr)->check_hlds__simplify__simplify_goal__simplify_goal_8_p_0_env_0__succeeded = (Var_73 == (MR_Word) ((MR_Unsigned) 0U));
    }
  }
  if (!((env_ptr)->check_hlds__simplify__simplify_goal__simplify_goal_8_p_0_env_0__succeeded))
  ...
  MR_Word * STATE_VARIABLE_Info_62)
{
  ...
  (env).check_hlds__simplify__simplify_goal__simplify_goal_8_p_0_env_0__Goal0_9 = Goal0_9;
  {
    ...
    MR_Word STATE_VARIABLE_Common_114_114;
    ...
    {
      MR_Word Var_132 = ((MR_Word) ((MR_hl_field(0, NestedContext0_11, (MR_Integer) 1))));
      MR_Unsigned Var_133 = ((MR_Unsigned) ((MR_hl_field(0, NestedContext0_11, (MR_Integer) 2))));
      MR_Word Var_134 = ((MR_Word) ((MR_hl_field(0, NestedContext0_11, (MR_Integer) 3))));
      MR_Word Var_131 = ((MR_Unsigned) ((MR_hl_field(0, NestedContext0_11, (MR_Integer) 0))) & (MR_Integer) 1);
...

      {
        ...
        MR_hl_field(0, NestedContext_17, 1) = ((MR_Box) (Var_132));
        MR_hl_field(0, NestedContext_17, 2) = ((MR_Box) (Var_133));
        MR_hl_field(0, NestedContext_17, 3) = ((MR_Box) (Var_134));
      }
    }
    else
    ...
    if ((env).check_hlds__simplify__simplify_goal__simplify_goal_8_p_0_env_0__succeeded)
    {
      check_hlds__simplify__simplify_info__simplify_info_set_found_contains_trace_3_p_0((MR_Integer) 1, STATE_VARIABLE_Info_0_61, &STATE_VARIABLE_Info_67_67);
      Goal0ContainsTrace_18 = (MR_Integer) 0;
    }
    else
    {
      Goal0ContainsTrace_18 = (MR_Integer) 1;
      STATE_VARIABLE_Info_67_67 = STATE_VARIABLE_Info_0_61;
    }
    Detism_19 = hlds__hlds_goal__goal_info_get_determinism_1_f_0(GoalInfo0_16);
    check_hlds__simplify__simplify_info__simplify_info_get_module_info_2_p_0(STATE_VARIABLE_Info_67_67, &STATE_VARIABLE_ModuleInfo_68_68);
    hlds__goal_form__goal_can_loop_or_throw_imaf_4_p_0((env).check_hlds__simplify__simplify_goal__simplify_goal_8_p_0_env_0__Goal0_9, &Goal0CanLoopOrThrow_21, STATE_VARIABLE_ModuleInfo_68_68, &STATE_VARIABLE_ModuleInfo_69_69);
    check_hlds__simplify__simplify_info__simplify_info_set_module_info_3_p_0(STATE_VARIABLE_ModuleInfo_69_69, STATE_VARIABLE_Info_67_67, &STATE_VARIABLE_Info_70_70);
        ...
        {
          {
            ...
            check_hlds__simplify__simplify_info__simplify_info_get_fully_strict_2_p_0(STATE_VARIABLE_Info_70_70, &Var_137);
            (env).check_hlds__simplify__simplify_goal__simplify_goal_8_p_0_env_0__succeeded = ((MR_Integer) 0 == Var_137);
          }
          if (!((env).check_hlds__simplify__simplify_goal__simplify_goal_8_p_0_env_0__succeeded))
    ...
    if ((env).check_hlds__simplify__simplify_goal__simplify_goal_8_p_0_env_0__succeeded)
    {
      ...
      (env).check_hlds__simplify__simplify_goal__simplify_goal_8_p_0_env_0__succeeded = check_hlds__simplify__simplify_info__simplify_do_warn_simple_code_1_p_0(STATE_VARIABLE_Info_70_70);
      if ((env).check_hlds__simplify__simplify_goal__simplify_goal_8_p_0_env_0__succeeded)
      {
      ...
      if ((env).check_hlds__simplify__simplify_goal__simplify_goal_8_p_0_env_0__succeeded)
      {
...

        {
          ...
          MR_hl_field(2, Msg_28, 1) = ((MR_Box) (MR_mkword(1, &check_hlds__simplify__simplify_goal_scalar_common_1[13])));
        }
        {
          Var_101 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(1, Var_101, 0) = ((MR_Box) (Msg_28));
        ...
        }
        {
          ...
          MR_hl_field(3, Spec_29, 3) = ((MR_Box) (MR_mkword(2, &check_hlds__simplify__simplify_goal_scalar_common_2[1])));
          MR_hl_field(3, Spec_29, 4) = ((MR_Box) (Var_101));
        }
        check_hlds__simplify__simplify_info__simplify_info_add_message_3_p_0(Spec_29, STATE_VARIABLE_Info_70_70, &STATE_VARIABLE_Info_103_103);
      }
      else
        STATE_VARIABLE_Info_103_103 = STATE_VARIABLE_Info_70_70;
      ...
      if ((env).check_hlds__simplify__simplify_goal__simplify_goal_8_p_0_env_0__succeeded)
        STATE_VARIABLE_Info_104_104 = STATE_VARIABLE_Info_103_103;
      else
        check_hlds__simplify__simplify_info__simplify_info_set_rerun_quant_instmap_delta_2_p_0(STATE_VARIABLE_Info_103_103, &STATE_VARIABLE_Info_104_104);
      ...
      check_hlds__simplify__simplify_info__simplify_info_incr_cost_delta_3_p_0(CostDelta_31, STATE_VARIABLE_Info_104_104, &STATE_VARIABLE_Info_105_105);
    ...
    else
    {
      ...
      MR_Word VarTable_36;
      MR_Word ModuleInfo_127;
      MR_Word Var_138;

      parse_tree__prog_data__determinism_components_3_p_0(Detism_19, &Var_138, &MaxSoln_33);
      (env).check_hlds__simplify__simplify_goal__simplify_goal_8_p_0_env_0__succeeded = ((MR_Integer) 1 == Var_138);
      if ((env).check_hlds__simplify__simplify_goal__simplify_goal_8_p_0_env_0__succeeded)
      {
        ...
        if ((env).check_hlds__simplify__simplify_goal__simplify_goal_8_p_0_env_0__succeeded)
        {
          ...
          check_hlds__simplify__simplify_info__simplify_info_get_module_info_2_p_0(STATE_VARIABLE_Info_70_70, &ModuleInfo_127);
          check_hlds__simplify__simplify_info__simplify_info_get_var_table_2_p_0(STATE_VARIABLE_Info_70_70, &VarTable_36);
          (env).check_hlds__simplify__simplify_goal__simplify_goal_8_p_0_env_0__succeeded = hlds__instmap__instmap_delta_no_output_vars_5_p_0(ModuleInfo_127, VarTable_36, InstMap0_12, InstMapDelta_34, NonLocalVars_35);
          if ((env).check_hlds__simplify__simplify_goal__simplify_goal_8_p_0_env_0__succeeded)
          {
            switch (Purity_22) {
              default:
              ...
              {
                {
                  ...
                  check_hlds__simplify__simplify_info__simplify_info_get_fully_strict_2_p_0(STATE_VARIABLE_Info_70_70, &Var_139);
                  (env).check_hlds__simplify__simplify_goal__simplify_goal_8_p_0_env_0__succeeded = ((MR_Integer) 0 == Var_139);
                }
                if (!((env).check_hlds__simplify__simplify_goal__simplify_goal_8_p_0_env_0__succeeded))
                  (env).check_hlds__simplify__simplify_goal__simplify_goal_8_p_0_env_0__succeeded = (Goal0CanLoopOrThrow_21 == (MR_Integer) 1);
              }
      ...
      if ((env).check_hlds__simplify__simplify_goal__simplify_goal_8_p_0_env_0__succeeded)
      {
        ...
        MR_Word Context_128;
        MR_Word NonLocals0_129;
        MR_Integer CostDelta_130;

        NonLocals0_129 = hlds__hlds_goal__goal_info_get_nonlocals_1_f_0(GoalInfo0_16);
        (env).check_hlds__simplify__simplify_goal__simplify_goal_8_p_0_env_0__succeeded = parse_tree__set_of_var__is_empty_1_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), NonLocals0_129);
        if ((env).check_hlds__simplify__simplify_goal__simplify_goal_8_p_0_env_0__succeeded)
          STATE_VARIABLE_Info_108_108 = STATE_VARIABLE_Info_70_70;
        else
          check_hlds__simplify__simplify_info__simplify_info_set_rerun_quant_instmap_delta_2_p_0(STATE_VARIABLE_Info_70_70, &STATE_VARIABLE_Info_108_108);
        transform_hlds__pd_cost__goal_cost_2_p_0((env).check_hlds__simplify__simplify_goal__simplify_goal_8_p_0_env_0__Goal0_9, &CostDelta_130);
        check_hlds__simplify__simplify_info__simplify_info_incr_cost_delta_3_p_0(CostDelta_130, STATE_VARIABLE_Info_108_108, &STATE_VARIABLE_Info_105_105);
        Context_128 = hlds__hlds_goal__goal_info_get_context_1_f_0(GoalInfo0_16);
        Goal1_32 = hlds__make_goal__true_goal_with_context_1_f_0(Context_128);
      }
      else
      {
        Goal1_32 = (env).check_hlds__simplify__simplify_goal__simplify_goal_8_p_0_env_0__Goal0_9;
        STATE_VARIABLE_Info_105_105 = STATE_VARIABLE_Info_70_70;
      }
    }
    ...
    if ((env).check_hlds__simplify__simplify_goal__simplify_goal_8_p_0_env_0__succeeded)
    {
      ...
      Goal2_41 = Goal1_32;
    (env).check_hlds__simplify__simplify_goal__simplify_goal_8_p_0_env_0__succeeded = check_hlds__simplify__simplify_info__simplify_do_elim_removable_scopes_1_p_0(STATE_VARIABLE_Info_105_105);
    if ((env).check_hlds__simplify__simplify_goal__simplify_goal_8_p_0_env_0__succeeded)
    {
      Var_110 = ((MR_Word) ((MR_hl_field(0, Goal2_41, (MR_Integer) 0))));
      _GoalInfo2_44 = ((MR_Word) ((MR_hl_field(0, Goal2_41, (MR_Integer) 1))));
      (env).check_hlds__simplify__simplify_goal__simplify_goal_8_p_0_env_0__succeeded = ((((MR_tag((MR_Word) Var_110)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(3, Var_110, (MR_Integer) 0)))) == (MR_Integer) 5)));
      if ((env).check_hlds__simplify__simplify_goal__simplify_goal_8_p_0_env_0__succeeded)
      {
        Reason2_42 = ((MR_Word) ((MR_hl_field(3, Var_110, (MR_Integer) 1))));
        SomeGoal2_43 = ((MR_Word) ((MR_hl_field(3, Var_110, (MR_Integer) 2))));
        if (((((MR_tag((MR_Word) Reason2_42)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(3, Reason2_42, (MR_Integer) 0)))) == (MR_Integer) 5))))
        {
          MR_Word Var_111 = ((MR_Unsigned) ((MR_hl_field(3, Reason2_42, (MR_Integer) 1))) & (MR_Integer) 1);
          MR_Unsigned packed_word_1 = (MR_Unsigned) ((MR_hl_field(3, Reason2_42, (MR_Integer) 1)));

          (env).check_hlds__simplify__simplify_goal__simplify_goal_8_p_0_env_0__succeeded = (Var_111 == (MR_Integer) 0);
        }
        else
    ...
    check_hlds__simplify__simplify_goal__maybe_handle_stack_flush_4_p_0((MR_Integer) 0, GoalExpr3_48, STATE_VARIABLE_Common_0_59, &STATE_VARIABLE_Common_113_113);
    check_hlds__simplify__simplify_goal__simplify_goal_expr_10_p_0(GoalExpr3_48, &GoalExpr4_50, GoalInfo3_49, &GoalInfo4_51, NestedContext_17, InstMap0_12, STATE_VARIABLE_Common_113_113, &STATE_VARIABLE_Common_114_114, STATE_VARIABLE_Info_105_105, &STATE_VARIABLE_Info_115_115);
    check_hlds__simplify__simplify_goal__maybe_handle_stack_flush_4_p_0((MR_Integer) 1, GoalExpr4_50, STATE_VARIABLE_Common_114_114, STATE_VARIABLE_Common_60);
    check_hlds__simplify__simplify_goal__enforce_unreachability_invariant_4_p_0(GoalInfo4_51, &GoalInfo_52, STATE_VARIABLE_Info_115_115, STATE_VARIABLE_Info_62);
    {
      MR_Word base;
  ...
  MR_Word * STATE_VARIABLE_Info_73)
{
  switch (MR_tag((MR_Word) STATE_VARIABLE_GoalExpr_0_66)) {
    ...
    case (MR_Integer) 2:
      ...
      break;
    case (MR_Integer) 3:
      switch (((MR_Integer) ((MR_hl_field(3, STATE_VARIABLE_GoalExpr_0_66, (MR_Integer) 0))))) {
        default: /*NOTREACHED*/ MR_assert(0);
        case (MR_Integer) 0:
        ...
        case (MR_Integer) 2:
          {
            MR_Word ConjType_17 = ((MR_Unsigned) ((MR_hl_field(3, STATE_VARIABLE_GoalExpr_0_66, (MR_Integer) 1))) & (MR_Integer) 1);
            MR_Word Goals_18 = ((MR_Word) ((MR_hl_field(3, STATE_VARIABLE_GoalExpr_0_66, (MR_Integer) 2))));
        ...
        case (MR_Integer) 7:
          {
            MR_Word ShortHand0_53 = ((MR_Word) ((MR_hl_field(3, STATE_VARIABLE_GoalExpr_0_66, (MR_Integer) 1))));
