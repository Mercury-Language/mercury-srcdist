  ...
  MR_Word * STATE_VARIABLE_Info_48)
{
  ...
  succeeded = mercury__set__contains_2_p_0((MR_Word) (&hlds__hlds_markers__hlds__hlds_markers__type_ctor_info_goal_feature_0), FeaturesSet0_17, ((MR_Box) ((MR_Integer) 16)));
  if (succeeded)
  {
  ...
  succeeded = mercury__set__contains_2_p_0((MR_Word) (&hlds__hlds_markers__hlds__hlds_markers__type_ctor_info_goal_feature_0), FeaturesSet0_17, ((MR_Box) ((MR_Integer) 20)));
  if (succeeded)
  {
  ...
  void * env_ptr_arg)
{
  ...
  {
    MR_Word Var_37 = ((MR_Word) ((MR_hl_field(0, (env_ptr)->check_hlds__simplify__simplify_goal__maybe_simplify_goal_to_true_or_fail_6_p_0_env_0__SubGoal_87, 0))));
    MR_Word Var_38;
    MR_Word Var_20;
  ...
  if (!((env_ptr)->check_hlds__simplify__simplify_goal__maybe_simplify_goal_to_true_or_fail_6_p_0_env_0__succeeded))
  {
    MR_Word GoalExpr_98 = ((MR_Word) ((MR_hl_field(0, (env_ptr)->check_hlds__simplify__simplify_goal__maybe_simplify_goal_to_true_or_fail_6_p_0_env_0__SubGoal_87, 0))));
    MR_Word SymName_105;
    MR_Word Var_106;
    MR_String Var_107;
    MR_Word Var_108;
    ...
    if ((env_ptr)->check_hlds__simplify__simplify_goal__maybe_simplify_goal_to_true_or_fail_6_p_0_env_0__succeeded)
    {
      SymName_105 = ((MR_Word) ((MR_hl_field(2, GoalExpr_98, 5))));
      ...
      if ((env_ptr)->check_hlds__simplify__simplify_goal__maybe_simplify_goal_to_true_or_fail_6_p_0_env_0__succeeded)
      {
        Var_106 = ((MR_Word) ((MR_hl_field(1, SymName_105, 0))));
        Var_107 = ((MR_String) ((MR_hl_field(1, SymName_105, 1))));
  ...
  MR_Word * STATE_VARIABLE_Info_32)
{
  ...
  (env).check_hlds__simplify__simplify_goal__maybe_simplify_goal_to_true_or_fail_6_p_0_env_0__Goal0_9 = Goal0_9;
  {
        ...
        {
          {
            ...
            check_hlds__simplify__simplify_info__simplify_info_get_fully_strict_2_p_0(STATE_VARIABLE_Info_1_35, &Var_95);
    ...
    if ((env).check_hlds__simplify__simplify_goal__maybe_simplify_goal_to_true_or_fail_6_p_0_env_0__succeeded)
    {
      ...
      (env).check_hlds__simplify__simplify_goal__maybe_simplify_goal_to_true_or_fail_6_p_0_env_0__succeeded = check_hlds__simplify__simplify_info__simplify_do_warn_simple_code_1_p_0(STATE_VARIABLE_Info_1_35);
      if ((env).check_hlds__simplify__simplify_goal__maybe_simplify_goal_to_true_or_fail_6_p_0_env_0__succeeded)
      {
      ...
      if ((env).check_hlds__simplify__simplify_goal__maybe_simplify_goal_to_true_or_fail_6_p_0_env_0__succeeded)
      {
        ...
        }
        {
          ...
          MR_hl_field(3, Spec_24, 1) = (MR_Box) (((((MR_Unsigned) ((MR_Integer) 243) << 1)) | (MR_Unsigned) ((MR_Integer) 1)));
        ...
        check_hlds__simplify__simplify_info__simplify_info_add_message_3_p_0(Spec_24, STATE_VARIABLE_Info_1_35, &STATE_VARIABLE_Info_2_80);
      }
      else
        STATE_VARIABLE_Info_2_80 = STATE_VARIABLE_Info_1_35;
      ...
      if ((env).check_hlds__simplify__simplify_goal__maybe_simplify_goal_to_true_or_fail_6_p_0_env_0__succeeded)
        STATE_VARIABLE_Info_3_81 = STATE_VARIABLE_Info_2_80;
      else
        check_hlds__simplify__simplify_info__simplify_info_set_rerun_quant_instmap_delta_2_p_0(STATE_VARIABLE_Info_2_80, &STATE_VARIABLE_Info_3_81);
      ...
      check_hlds__simplify__simplify_info__simplify_info_incr_cost_delta_3_p_0(CostDelta_26, STATE_VARIABLE_Info_3_81, STATE_VARIABLE_Info_32);
    ...
    else
    {
      ...
      if ((env).check_hlds__simplify__simplify_goal__maybe_simplify_goal_to_true_or_fail_6_p_0_env_0__succeeded)
      {
        ...
        if ((env).check_hlds__simplify__simplify_goal__maybe_simplify_goal_to_true_or_fail_6_p_0_env_0__succeeded)
        {
          ...
          check_hlds__simplify__simplify_info__simplify_info_get_module_info_2_p_0(STATE_VARIABLE_Info_1_35, &ModuleInfo_88);
              ...
              {
                {
                  ...
                  check_hlds__simplify__simplify_info__simplify_info_get_fully_strict_2_p_0(STATE_VARIABLE_Info_1_35, &Var_97);
      ...
      if ((env).check_hlds__simplify__simplify_goal__maybe_simplify_goal_to_true_or_fail_6_p_0_env_0__succeeded)
      {
        ...
        if ((env).check_hlds__simplify__simplify_goal__maybe_simplify_goal_to_true_or_fail_6_p_0_env_0__succeeded)
          STATE_VARIABLE_Info_5_85 = STATE_VARIABLE_Info_1_35;
        else
          check_hlds__simplify__simplify_info__simplify_info_set_rerun_quant_instmap_delta_2_p_0(STATE_VARIABLE_Info_1_35, &STATE_VARIABLE_Info_5_85);
        ...
        check_hlds__simplify__simplify_info__simplify_info_incr_cost_delta_3_p_0(CostDelta_91, STATE_VARIABLE_Info_5_85, STATE_VARIABLE_Info_32);
