...
static /* final */ const MR_Box check_hlds__simplify__simplify_goal_scalar_common_1[26][2] = {
  ...
  {
    ((MR_Box) (MR_mkword(3, &check_hlds__simplify__simplify_goal_scalar_common_1[2]))),
    ((MR_Box) (MR_mkword(1, &check_hlds__simplify__simplify_goal_scalar_common_1[13])))
  },
  /* row  15 */
  {
    ((MR_Box) (MR_Word) ((MR_Unsigned) 6U)),
  ...
  /* row  17 */
  {
    ((MR_Box) (MR_mkword(3, &check_hlds__simplify__simplify_goal_scalar_common_1[12]))),
    ((MR_Box) (MR_mkword(1, &check_hlds__simplify__simplify_goal_scalar_common_1[14])))
  },
  /* row  18 */
  {
    ((MR_Box) (MR_mkword(3, &check_hlds__simplify__simplify_goal_scalar_common_1[11]))),
    ((MR_Box) (MR_mkword(1, &check_hlds__simplify__simplify_goal_scalar_common_1[17])))
  },
  /* row  19 */
  {
    ((MR_Box) (MR_mkword(3, &check_hlds__simplify__simplify_goal_scalar_common_1[10]))),
  ...
  {
    ((MR_Box) (MR_mkword(3, &check_hlds__simplify__simplify_goal_scalar_common_1[11]))),
    ((MR_Box) (MR_mkword(1, &check_hlds__simplify__simplify_goal_scalar_common_1[20])))
  },
  /* row  22 */
  {
    ((MR_Box) (MR_mkword(3, &check_hlds__simplify__simplify_goal_scalar_common_1[10]))),
  ...
  /* row  24 */
  {
    ((MR_Box) (MR_mkword(2, &check_hlds__simplify__simplify_goal_scalar_common_1[23]))),
    ((MR_Box) ((MR_Unsigned) 0U))
  },
  /* row  25 */
  {
    ((MR_Box) (&check_hlds__simplify__simplify_goal_scalar_common_2[0])),
    ((MR_Box) (MR_mkword(1, &check_hlds__simplify__simplify_goal_scalar_common_1[24])))
  },
};
  ...
  else
  {
    ...
    }
    {
      ...
      *GoalExpr_11 = base;
      ...
      MR_hl_field(3, base, 1) = ((MR_Box) (MR_mkword(3, &check_hlds__simplify__simplify_goal_scalar_common_1[16])));
  ...
  MR_Word * STATE_VARIABLE_Info_64)
{
  ...
  (env).check_hlds__simplify__simplify_goal__simplify_goal_8_p_0_env_0__Goal0_9 = Goal0_9;
  {
    ...
    MR_Word STATE_VARIABLE_Common_115_115;
    MR_Word STATE_VARIABLE_Common_116_116;
    ...
    {
      MR_Word Var_134 = ((MR_Word) ((MR_hl_field(0, NestedContext0_11, (MR_Integer) 1))));
      MR_Unsigned Var_135 = ((MR_Unsigned) ((MR_hl_field(0, NestedContext0_11, (MR_Integer) 2))));
      MR_Word Var_136 = ((MR_Word) ((MR_hl_field(0, NestedContext0_11, (MR_Integer) 3))));
      MR_Word Var_133 = ((MR_Unsigned) ((MR_hl_field(0, NestedContext0_11, (MR_Integer) 0))) & (MR_Integer) 1);
...

      {
        ...
        MR_hl_field(0, NestedContext_17, 1) = ((MR_Box) (Var_134));
        MR_hl_field(0, NestedContext_17, 2) = ((MR_Box) (Var_135));
        MR_hl_field(0, NestedContext_17, 3) = ((MR_Box) (Var_136));
      }
    }
    else
        ...
        {
          {
            ...
            check_hlds__simplify__simplify_info__simplify_info_get_fully_strict_2_p_0(STATE_VARIABLE_Info_72_72, &Var_139);
    ...
    if ((env).check_hlds__simplify__simplify_goal__simplify_goal_8_p_0_env_0__succeeded)
    {
      ...
      if ((env).check_hlds__simplify__simplify_goal__simplify_goal_8_p_0_env_0__succeeded)
      {
...

        {
          ...
          MR_hl_field(2, Msg_28, 1) = ((MR_Box) (MR_mkword(1, &check_hlds__simplify__simplify_goal_scalar_common_1[25])));
        }
        {
          Var_103 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(1, Var_103, 0) = ((MR_Box) (Msg_28));
        ...
        }
        {
          ...
          MR_hl_field(3, Spec_29, 3) = ((MR_Box) (MR_mkword(3, &check_hlds__simplify__simplify_goal_scalar_common_2[1])));
          MR_hl_field(3, Spec_29, 4) = ((MR_Box) (Var_103));
        }
        check_hlds__simplify__simplify_info__simplify_info_add_message_3_p_0(Spec_29, STATE_VARIABLE_Info_72_72, &STATE_VARIABLE_Info_105_105);
      }
      else
        STATE_VARIABLE_Info_105_105 = STATE_VARIABLE_Info_72_72;
      ...
      if ((env).check_hlds__simplify__simplify_goal__simplify_goal_8_p_0_env_0__succeeded)
        STATE_VARIABLE_Info_106_106 = STATE_VARIABLE_Info_105_105;
      else
        check_hlds__simplify__simplify_info__simplify_info_set_rerun_quant_instmap_delta_2_p_0(STATE_VARIABLE_Info_105_105, &STATE_VARIABLE_Info_106_106);
      ...
      check_hlds__simplify__simplify_info__simplify_info_incr_cost_delta_3_p_0(CostDelta_31, STATE_VARIABLE_Info_106_106, &STATE_VARIABLE_Info_107_107);
    ...
    else
    {
      ...
      parse_tree__prog_data__determinism_components_3_p_0(Detism_19, &Var_140, &MaxSoln_33);
      (env).check_hlds__simplify__simplify_goal__simplify_goal_8_p_0_env_0__succeeded = ((MR_Integer) 1 == Var_140);
      if ((env).check_hlds__simplify__simplify_goal__simplify_goal_8_p_0_env_0__succeeded)
      {
        ...
        if ((env).check_hlds__simplify__simplify_goal__simplify_goal_8_p_0_env_0__succeeded)
        {
          ...
          check_hlds__simplify__simplify_info__simplify_info_get_module_info_2_p_0(STATE_VARIABLE_Info_72_72, &ModuleInfo_129);
          check_hlds__simplify__simplify_info__simplify_info_get_var_table_2_p_0(STATE_VARIABLE_Info_72_72, &VarTable_36);
          (env).check_hlds__simplify__simplify_goal__simplify_goal_8_p_0_env_0__succeeded = hlds__instmap__instmap_delta_no_output_vars_5_p_0(ModuleInfo_129, VarTable_36, InstMap0_12, InstMapDelta_34, NonLocalVars_35);
          if ((env).check_hlds__simplify__simplify_goal__simplify_goal_8_p_0_env_0__succeeded)
          {
            switch (Purity_22) {
              default:
              ...
              {
                {
                  ...
                  check_hlds__simplify__simplify_info__simplify_info_get_fully_strict_2_p_0(STATE_VARIABLE_Info_72_72, &Var_141);
                  (env).check_hlds__simplify__simplify_goal__simplify_goal_8_p_0_env_0__succeeded = ((MR_Integer) 0 == Var_141);
                }
                if (!((env).check_hlds__simplify__simplify_goal__simplify_goal_8_p_0_env_0__succeeded))
                  (env).check_hlds__simplify__simplify_goal__simplify_goal_8_p_0_env_0__succeeded = (Goal0CanLoopOrThrow_21 == (MR_Integer) 1);
              }
      ...
      if ((env).check_hlds__simplify__simplify_goal__simplify_goal_8_p_0_env_0__succeeded)
      {
        ...
        MR_Word Context_130;
        MR_Word NonLocals0_131;
        MR_Integer CostDelta_132;

        NonLocals0_131 = hlds__hlds_goal__goal_info_get_nonlocals_1_f_0(GoalInfo0_16);
        (env).check_hlds__simplify__simplify_goal__simplify_goal_8_p_0_env_0__succeeded = parse_tree__set_of_var__is_empty_1_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), NonLocals0_131);
        if ((env).check_hlds__simplify__simplify_goal__simplify_goal_8_p_0_env_0__succeeded)
          STATE_VARIABLE_Info_110_110 = STATE_VARIABLE_Info_72_72;
        else
          check_hlds__simplify__simplify_info__simplify_info_set_rerun_quant_instmap_delta_2_p_0(STATE_VARIABLE_Info_72_72, &STATE_VARIABLE_Info_110_110);
        transform_hlds__pd_cost__goal_cost_2_p_0((env).check_hlds__simplify__simplify_goal__simplify_goal_8_p_0_env_0__Goal0_9, &CostDelta_132);
        check_hlds__simplify__simplify_info__simplify_info_incr_cost_delta_3_p_0(CostDelta_132, STATE_VARIABLE_Info_110_110, &STATE_VARIABLE_Info_107_107);
        Context_130 = hlds__hlds_goal__goal_info_get_context_1_f_0(GoalInfo0_16);
        Goal1_32 = hlds__make_goal__true_goal_with_context_1_f_0(Context_130);
      }
      else
      {
        Goal1_32 = (env).check_hlds__simplify__simplify_goal__simplify_goal_8_p_0_env_0__Goal0_9;
        STATE_VARIABLE_Info_107_107 = STATE_VARIABLE_Info_72_72;
      }
    }
    ...
    if ((env).check_hlds__simplify__simplify_goal__simplify_goal_8_p_0_env_0__succeeded)
    {
      ...
      Goal2_41 = Goal1_32;
    (env).check_hlds__simplify__simplify_goal__simplify_goal_8_p_0_env_0__succeeded = check_hlds__simplify__simplify_info__simplify_do_elim_removable_scopes_1_p_0(STATE_VARIABLE_Info_107_107);
    if ((env).check_hlds__simplify__simplify_goal__simplify_goal_8_p_0_env_0__succeeded)
    {
      Var_112 = ((MR_Word) ((MR_hl_field(0, Goal2_41, (MR_Integer) 0))));
      _GoalInfo2_44 = ((MR_Word) ((MR_hl_field(0, Goal2_41, (MR_Integer) 1))));
      (env).check_hlds__simplify__simplify_goal__simplify_goal_8_p_0_env_0__succeeded = ((((MR_tag((MR_Word) Var_112)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(3, Var_112, (MR_Integer) 0)))) == (MR_Integer) 5)));
      if ((env).check_hlds__simplify__simplify_goal__simplify_goal_8_p_0_env_0__succeeded)
      {
        Reason2_42 = ((MR_Word) ((MR_hl_field(3, Var_112, (MR_Integer) 1))));
        SomeGoal2_43 = ((MR_Word) ((MR_hl_field(3, Var_112, (MR_Integer) 2))));
        if (((((MR_tag((MR_Word) Reason2_42)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(3, Reason2_42, (MR_Integer) 0)))) == (MR_Integer) 5))))
        {
          MR_Word Var_113 = ((MR_Unsigned) ((MR_hl_field(3, Reason2_42, (MR_Integer) 1))) & (MR_Integer) 1);
          MR_Unsigned packed_word_1 = (MR_Unsigned) ((MR_hl_field(3, Reason2_42, (MR_Integer) 1)));

          (env).check_hlds__simplify__simplify_goal__simplify_goal_8_p_0_env_0__succeeded = (Var_113 == (MR_Integer) 0);
        }
        else
    ...
    check_hlds__simplify__simplify_goal__maybe_handle_stack_flush_4_p_0((MR_Integer) 0, GoalExpr3_48, STATE_VARIABLE_Common_0_61, &STATE_VARIABLE_Common_115_115);
    check_hlds__simplify__simplify_goal__simplify_goal_expr_10_p_0(GoalExpr3_48, &GoalExpr4_50, GoalInfo3_49, &GoalInfo4_51, NestedContext_17, InstMap0_12, STATE_VARIABLE_Common_115_115, &STATE_VARIABLE_Common_116_116, STATE_VARIABLE_Info_107_107, &STATE_VARIABLE_Info_117_117);
    check_hlds__simplify__simplify_goal__maybe_handle_stack_flush_4_p_0((MR_Integer) 1, GoalExpr4_50, STATE_VARIABLE_Common_116_116, STATE_VARIABLE_Common_62);
    check_hlds__simplify__simplify_goal__enforce_unreachability_invariant_4_p_0(GoalInfo4_51, &GoalInfo_52, STATE_VARIABLE_Info_117_117, STATE_VARIABLE_Info_64);
    {
      MR_Word base;
                    ...
                    case (MR_Integer) 1:
                      {
                        ...
                        {
                          StmSpec_67 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL));
                          MR_hl_field(1, StmSpec_67, 0) = ((MR_Box) ((MR_String) "predicate \140check_hlds.simplify.simplify_goal.simplify_goal_expr\'/10"));
                          MR_hl_field(1, StmSpec_67, 1) = ((MR_Box) ((MR_Unsigned) 0U));
                          MR_hl_field(1, StmSpec_67, 2) = ((MR_Box) (MR_mkword(3, &check_hlds__simplify__simplify_goal_scalar_common_2[2])));
                          MR_hl_field(1, StmSpec_67, 3) = ((MR_Box) (Var_141));
                          MR_hl_field(1, StmSpec_67, 4) = ((MR_Box) (MR_mkword(1, &check_hlds__simplify__simplify_goal_scalar_common_1[19])));
                        }
                    ...
                    case (MR_Integer) 2:
                      {
                        ...
                        {
                          StmSpec_154 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL));
                          MR_hl_field(1, StmSpec_154, 0) = ((MR_Box) ((MR_String) "predicate \140check_hlds.simplify.simplify_goal.simplify_goal_expr\'/10"));
                          MR_hl_field(1, StmSpec_154, 1) = ((MR_Box) ((MR_Unsigned) 0U));
                          MR_hl_field(1, StmSpec_154, 2) = ((MR_Box) (MR_mkword(3, &check_hlds__simplify__simplify_goal_scalar_common_2[2])));
                          MR_hl_field(1, StmSpec_154, 3) = ((MR_Box) (Var_166));
                          MR_hl_field(1, StmSpec_154, 4) = ((MR_Box) (MR_mkword(1, &check_hlds__simplify__simplify_goal_scalar_common_1[22])));
                        }
