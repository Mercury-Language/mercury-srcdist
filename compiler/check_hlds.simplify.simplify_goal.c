  ...
  MR_Word * STATE_VARIABLE_Common_10)
{
  ...
  switch (MR_tag((MR_Word) GoalExpr_6)) {
    ...
    case (MR_Integer) 1:
      {
        MR_Word Unify_18 = ((MR_Word) ((MR_hl_field(MR_mktag(1), GoalExpr_6, (MR_Integer) 3))));

        succeeded = ((((MR_tag((MR_Word) Unify_18)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(MR_mktag(3), Unify_18, (MR_Integer) 0)))) == (MR_Integer) 1)));
        if (succeeded)
          check_hlds__simplify__common__common_info_stack_flush_2_p_0(STATE_VARIABLE_Common_0_9, STATE_VARIABLE_Common_10);
        else
    ...
    case (MR_Integer) 2:
      {
        MR_Word BuiltinState_26 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(2), GoalExpr_6, (MR_Integer) 3))) & (MR_Integer) 1);
    ...
    case (MR_Integer) 3:
      switch (((MR_Integer) ((MR_hl_field(MR_mktag(3), GoalExpr_6, (MR_Integer) 0))))) {
        ...
        case (MR_Integer) 0:
          {
            MR_Word GenericCall_29 = ((MR_Word) ((MR_hl_field(MR_mktag(3), GoalExpr_6, (MR_Integer) 1))));
        ...
        case (MR_Integer) 2:
          {
            MR_Word ConjType_51 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(3), GoalExpr_6, (MR_Integer) 1))) & (MR_Integer) 1);
        ...
        case (MR_Integer) 7:
          {
            MR_Word ShortHand_64 = ((MR_Word) ((MR_hl_field(MR_mktag(3), GoalExpr_6, (MR_Integer) 1))));

            switch (MR_tag((MR_Word) ShortHand_64)) {
              default: /*NOTREACHED*/ MR_assert(0);
              case (MR_Integer) 0:
                {
