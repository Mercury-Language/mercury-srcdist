...
static /* final */ const MR_Box check_hlds__simplify__simplify_goal_scalar_common_1[14][2] = {
  ...
  /* row  12 */
  {
    ((MR_Box) (MR_mkword(MR_mktag(2), &check_hlds__simplify__simplify_goal_scalar_common_1[11]))),
    ((MR_Box) ((MR_Unsigned) 0U))
  },
  /* row  13 */
  {
  ...
  else
  {
    ...
    }
    {
      ...
      *GoalExpr_11 = base;
      ...
      MR_hl_field(MR_mktag(3), base, 1) = ((MR_Box) (MR_mkword(MR_mktag(3), &check_hlds__simplify__simplify_goal_scalar_common_1[10])));
  ...
  MR_Word * STATE_VARIABLE_Info_57)
{
  ...
  (env).check_hlds__simplify__simplify_goal__simplify_goal_8_p_0_env_0__Goal0_9 = Goal0_9;
  {
    ...
    {
      MR_Word Var_116 = ((MR_Word) ((MR_hl_field(MR_mktag(0), NestedContext0_11, (MR_Integer) 1))));
      MR_Unsigned Var_117 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), NestedContext0_11, (MR_Integer) 2))));
      MR_Word Var_115 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), NestedContext0_11, (MR_Integer) 0))) & (MR_Integer) 1);
...

      {
        ...
        MR_hl_field(MR_mktag(0), NestedContext_17, 1) = ((MR_Box) (Var_116));
        MR_hl_field(MR_mktag(0), NestedContext_17, 2) = ((MR_Box) (Var_117));
      }
    }
    else
    ...
    if ((env).check_hlds__simplify__simplify_goal__simplify_goal_8_p_0_env_0__succeeded)
    {
      ...
      if ((env).check_hlds__simplify__simplify_goal__simplify_goal_8_p_0_env_0__succeeded)
      {
...

        {
          ...
          MR_hl_field(MR_mktag(2), Msg_29, 0) = ((MR_Box) (Context_24));
          MR_hl_field(MR_mktag(2), Msg_29, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &check_hlds__simplify__simplify_goal_scalar_common_1[13])));
        }
        {
        ...
        {
          Spec_30 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(3), Spec_30, 0) = ((MR_Box) ((MR_String) "predicate \140check_hlds.simplify.simplify_goal.simplify_goal\'/8"));
          MR_hl_field(MR_mktag(3), Spec_30, 1) = (MR_Box) (((((MR_Unsigned) ((MR_Integer) 27) << 1)) | (MR_Unsigned) ((MR_Integer) 1)));
          MR_hl_field(MR_mktag(3), Spec_30, 2) = ((MR_Box) ((MR_Unsigned) 4U));
          MR_hl_field(MR_mktag(3), Spec_30, 3) = ((MR_Box) (MR_mkword(MR_mktag(2), &check_hlds__simplify__simplify_goal_scalar_common_2[1])));
          MR_hl_field(MR_mktag(3), Spec_30, 4) = ((MR_Box) (Var_94));
        }
  ...
  MR_Word * STATE_VARIABLE_Common_10)
{
  ...
  switch (MR_tag((MR_Word) GoalExpr_6)) {
    ...
    case (MR_Integer) 1:
      {
        MR_Word Unify_17 = ((MR_Word) ((MR_hl_field(MR_mktag(1), GoalExpr_6, (MR_Integer) 3))));

        succeeded = ((((MR_tag((MR_Word) Unify_17)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(MR_mktag(3), Unify_17, (MR_Integer) 0)))) == (MR_Integer) 1)));
        if (succeeded)
          check_hlds__simplify__common__common_info_stack_flush_2_p_0(STATE_VARIABLE_Common_0_9, STATE_VARIABLE_Common_10);
        else
    ...
    case (MR_Integer) 2:
      {
        MR_Word BuiltinState_25 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(2), GoalExpr_6, (MR_Integer) 3))) & (MR_Integer) 1);
    ...
    case (MR_Integer) 3:
      switch (((MR_Integer) ((MR_hl_field(MR_mktag(3), GoalExpr_6, (MR_Integer) 0))))) {
        ...
        case (MR_Integer) 0:
          {
            MR_Word GenericCall_28 = ((MR_Word) ((MR_hl_field(MR_mktag(3), GoalExpr_6, (MR_Integer) 1))));
        ...
        case (MR_Integer) 2:
          {
            MR_Word ConjType_50 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(3), GoalExpr_6, (MR_Integer) 1))) & (MR_Integer) 1);
        ...
        case (MR_Integer) 7:
          {
            MR_Word ShortHand_63 = ((MR_Word) ((MR_hl_field(MR_mktag(3), GoalExpr_6, (MR_Integer) 1))));

            switch (MR_tag((MR_Word) ShortHand_63)) {
              default: /*NOTREACHED*/ MR_assert(0);
              case (MR_Integer) 0:
                {
