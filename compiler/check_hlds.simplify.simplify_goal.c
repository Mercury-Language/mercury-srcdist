      ...
      if ((env).check_hlds__simplify__simplify_goal__simplify_goal_8_p_0_env_0__succeeded)
      {
        ...
        if ((env).check_hlds__simplify__simplify_goal__simplify_goal_8_p_0_env_0__succeeded)
        {
...

          {
            ...
            MR_hl_field(MR_mktag(1), Msg_29, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &check_hlds__simplify__simplify_goal_scalar_common_1[13])));
          }
          {
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(2), Spec_30, 1) = (MR_Box) (((((MR_Unsigned) ((MR_Integer) 25) << 1)) | (MR_Unsigned) ((MR_Integer) 1)));
