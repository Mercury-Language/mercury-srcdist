    ...
    (env).check_hlds__simplify__simplify_goal__simplify_goal_8_p_0_env_0__Goal0_9 = Goal0_9;
    {
      ...
      if ((env).check_hlds__simplify__simplify_goal__simplify_goal_8_p_0_env_0__succeeded)
      {
        ...
        if ((env).check_hlds__simplify__simplify_goal__simplify_goal_8_p_0_env_0__succeeded)
          ...
          check_hlds__simplify__simplify_info__simplify_info_set_should_requantify_2_p_0(STATE_VARIABLE_Info_96_96, &STATE_VARIABLE_Info_97_97);
      ...
      else
      {
        ...
        if ((env).check_hlds__simplify__simplify_goal__simplify_goal_8_p_0_env_0__succeeded)
        {
          ...
          if ((env).check_hlds__simplify__simplify_goal__simplify_goal_8_p_0_env_0__succeeded)
            ...
            check_hlds__simplify__simplify_info__simplify_info_set_should_requantify_2_p_0(STATE_VARIABLE_Info_63_63, &STATE_VARIABLE_Info_101_101);
      ...
      check_hlds__simplify__simplify_goal__maybe_clear_common_structs_5_p_0((MR_Integer) 0, GoalExpr3_49, STATE_VARIABLE_Info_98_98, STATE_VARIABLE_Common_0_54, &STATE_VARIABLE_Common_106_106);
      ...
      check_hlds__simplify__simplify_goal__maybe_clear_common_structs_5_p_0((MR_Integer) 1, GoalExpr4_51, STATE_VARIABLE_Info_108_108, STATE_VARIABLE_Common_107_107, STATE_VARIABLE_Common_55);
