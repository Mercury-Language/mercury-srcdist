...
static /* final */ const MR_Box check_hlds__simplify__simplify_goal_scalar_common_1[16][2] = {
  ...
  /* row 13 */
  {
    (MR_Box) (((((MR_Unsigned) ((MR_Integer) 24) << (MR_Integer) 1)) | (MR_Unsigned) ((MR_Integer) 1))),
...
{
  {
...

    {
      ...
      (env_ptr)->check_hlds__simplify__simplify_goal__simplify_goal_8_p_0_env_0__succeeded = ((((MR_tag((MR_Word) Var_66)) == (MR_Integer) 3)) && ((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), Var_66, (MR_Integer) 0))) == (MR_Integer) 3)));
...
{
  {
    ...
    (env).check_hlds__simplify__simplify_goal__simplify_goal_8_p_0_env_0__Goal0_9 = Goal0_9;
    {
      ...
      if ((env).check_hlds__simplify__simplify_goal__simplify_goal_8_p_0_env_0__succeeded)
      {
        ...
        MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), NestedContext0_11, (MR_Integer) 0)));
      ...
      (env).check_hlds__simplify__simplify_goal__simplify_goal_8_p_0_env_0__succeeded = ((((MR_tag((MR_Word) GoalExpr1_39)) == (MR_Integer) 3)) && ((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), GoalExpr1_39, (MR_Integer) 0))) == (MR_Integer) 5)));
      if ((env).check_hlds__simplify__simplify_goal__simplify_goal_8_p_0_env_0__succeeded)
      {
      ...
      if ((env).check_hlds__simplify__simplify_goal__simplify_goal_8_p_0_env_0__succeeded)
      {
        ...
        (env).check_hlds__simplify__simplify_goal__simplify_goal_8_p_0_env_0__succeeded = ((((MR_tag((MR_Word) Var_109)) == (MR_Integer) 3)) && ((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), Var_109, (MR_Integer) 0))) == (MR_Integer) 5)));
        if ((env).check_hlds__simplify__simplify_goal__simplify_goal_8_p_0_env_0__succeeded)
        {
          ...
          if (((((MR_tag((MR_Word) Reason2_44)) == (MR_Integer) 3)) && ((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), Reason2_44, (MR_Integer) 0))) == (MR_Integer) 5))))
          {
            MR_Word Var_110 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(3), Reason2_44, (MR_Integer) 1))) & (MR_Integer) 1);
            MR_Unsigned packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Reason2_44, (MR_Integer) 1)));

            (env).check_hlds__simplify__simplify_goal__simplify_goal_8_p_0_env_0__succeeded = (Var_110 == (MR_Integer) 0);
          }
          else
          if (((((MR_tag((MR_Word) Reason2_44)) == (MR_Integer) 3)) && ((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), Reason2_44, (MR_Integer) 0))) == (MR_Integer) 6))))
          {
            ...
            MR_Unsigned packed_args_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Reason2_44, (MR_Integer) 2)));
          ...
          case (MR_Integer) 1:
            {
              ...
              succeeded = ((((MR_tag((MR_Word) Unify_20)) == (MR_Integer) 3)) && ((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), Unify_20, (MR_Integer) 0))) == (MR_Integer) 1)));
              if (succeeded)
                packed_args_3 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Unify_20, (MR_Integer) 2)));
            }
            break;
          case (MR_Integer) 2:
            {
              MR_Word BuiltinState_28 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(2), GoalExpr_7, (MR_Integer) 3))) & (MR_Integer) 1);
              MR_Unsigned packed_args_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), GoalExpr_7, (MR_Integer) 3)));
              ...
              case (MR_Integer) 0:
                {
                  ...
                  MR_Unsigned packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), GoalExpr_7, (MR_Integer) 5)));
              ...
              case (MR_Integer) 2:
                {
                  ...
                  MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), GoalExpr_7, (MR_Integer) 1)));
...
{
  {
    ...
    if (succeeded)
    {
      packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), GoalExpr_2, (MR_Integer) 3)));
        ...
        case (MR_Integer) 2:
          {
            ...
            MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), STATE_VARIABLE_GoalExpr_0_66, (MR_Integer) 1)));
              ...
              case (MR_Integer) 1:
                {
                  ...
                  MR_Unsigned packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), ShortHand0_53, (MR_Integer) 0)));
