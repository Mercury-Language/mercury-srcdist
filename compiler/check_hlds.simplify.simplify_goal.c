                    ...
                    case (MR_Integer) 1:
                      {
                        ...
                        Var_141 = hlds__hlds_goal__goal_info_get_context_1_f_0(STATE_VARIABLE_GoalInfo_0_75);
                        {
                          ...
                          MR_hl_field(0, StmSpec_67, 2) = ((MR_Box) (MR_mkword(3, &check_hlds__simplify__simplify_goal_scalar_common_2[2])));
                          MR_hl_field(0, StmSpec_67, 3) = ((MR_Box) (Var_141));
                          MR_hl_field(0, StmSpec_67, 4) = ((MR_Box) (MR_mkword(1, &check_hlds__simplify__simplify_goal_scalar_common_1[19])));
                        }
                    ...
                    case (MR_Integer) 2:
                      {
                        ...
                        Var_166 = hlds__hlds_goal__goal_info_get_context_1_f_0(STATE_VARIABLE_GoalInfo_0_75);
                        {
                          ...
                          MR_hl_field(0, StmSpec_154, 2) = ((MR_Box) (MR_mkword(3, &check_hlds__simplify__simplify_goal_scalar_common_2[2])));
                          MR_hl_field(0, StmSpec_154, 3) = ((MR_Box) (Var_166));
                          MR_hl_field(0, StmSpec_154, 4) = ((MR_Box) (MR_mkword(1, &check_hlds__simplify__simplify_goal_scalar_common_1[22])));
                        }
