...
{
  {
...

    {
      ...
      (env_ptr)->check_hlds__simplify__simplify_goal__simplify_goal_8_p_0_env_0__succeeded = ((((MR_tag((MR_Word) Var_66)) == (MR_mktag((MR_Integer) 3)))) && (((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), Var_66, (MR_Integer) 0)))) == (MR_Integer) 3)));
      if ((env_ptr)->check_hlds__simplify__simplify_goal__simplify_goal_8_p_0_env_0__succeeded)
      {
        ...
        (env_ptr)->check_hlds__simplify__simplify_goal__simplify_goal_8_p_0_env_0__succeeded = (Var_67 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
      }
    }
    if (!((env_ptr)->check_hlds__simplify__simplify_goal__simplify_goal_8_p_0_env_0__succeeded))
...
{
  {
    ...
    (env).check_hlds__simplify__simplify_goal__simplify_goal_8_p_0_env_0__Goal0_9 = Goal0_9;
    {
      ...
      (env).check_hlds__simplify__simplify_goal__simplify_goal_8_p_0_env_0__succeeded = hlds__hlds_goal__goal_info_has_feature_2_p_0(GoalInfo0_16, (MR_Integer) 15);
      if ((env).check_hlds__simplify__simplify_goal__simplify_goal_8_p_0_env_0__succeeded)
      {
        MR_Integer Var_125 = ((MR_Integer) (MR_hl_field(MR_mktag(0), NestedContext0_11, (MR_Integer) 1)));
        MR_Word Var_126 = ((MR_Word) (MR_hl_field(MR_mktag(0), NestedContext0_11, (MR_Integer) 2)));
        MR_Word Var_124 = ((MR_Word) (MR_hl_field(MR_mktag(0), NestedContext0_11, (MR_Integer) 0)));

        {
          NestedContext_17 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), NestedContext_17, 0) = ((MR_Box) ((MR_Integer) 1));
      ...
      (env).check_hlds__simplify__simplify_goal__simplify_goal_8_p_0_env_0__succeeded = hlds__hlds_goal__goal_info_has_feature_2_p_0(GoalInfo0_16, (MR_Integer) 19);
      if ((env).check_hlds__simplify__simplify_goal__simplify_goal_8_p_0_env_0__succeeded)
      {
      ...
      (env).check_hlds__simplify__simplify_goal__simplify_goal_8_p_0_env_0__succeeded = ((((MR_tag((MR_Word) GoalExpr1_39)) == (MR_mktag((MR_Integer) 3)))) && (((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), GoalExpr1_39, (MR_Integer) 0)))) == (MR_Integer) 5)));
      if ((env).check_hlds__simplify__simplify_goal__simplify_goal_8_p_0_env_0__succeeded)
      {
      ...
      if ((env).check_hlds__simplify__simplify_goal__simplify_goal_8_p_0_env_0__succeeded)
      {
        ...
        (env).check_hlds__simplify__simplify_goal__simplify_goal_8_p_0_env_0__succeeded = ((((MR_tag((MR_Word) Var_109)) == (MR_mktag((MR_Integer) 3)))) && (((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), Var_109, (MR_Integer) 0)))) == (MR_Integer) 5)));
        if ((env).check_hlds__simplify__simplify_goal__simplify_goal_8_p_0_env_0__succeeded)
        {
          ...
          if (((((MR_tag((MR_Word) Reason2_44)) == (MR_mktag((MR_Integer) 3)))) && (((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), Reason2_44, (MR_Integer) 0)))) == (MR_Integer) 5))))
          {
            MR_Word Var_110 = ((MR_Word) (MR_hl_field(MR_mktag(3), Reason2_44, (MR_Integer) 1)));

            (env).check_hlds__simplify__simplify_goal__simplify_goal_8_p_0_env_0__succeeded = (Var_110 == (MR_Integer) 0);
          }
          else
          if (((((MR_tag((MR_Word) Reason2_44)) == (MR_mktag((MR_Integer) 3)))) && (((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), Reason2_44, (MR_Integer) 0)))) == (MR_Integer) 6))))
          {
            MR_Word Kind_48 = ((MR_Word) (MR_hl_field(MR_mktag(3), Reason2_44, (MR_Integer) 2)));
        ...
        switch (MR_tag((MR_Word) GoalExpr_7)) {
          ...
          case (MR_Integer) 1:
            {
              ...
              MR_Word Var_17 = ((MR_Word) (MR_hl_field(MR_mktag(1), GoalExpr_7, (MR_Integer) 0)));
              MR_Word Var_18 = ((MR_Word) (MR_hl_field(MR_mktag(1), GoalExpr_7, (MR_Integer) 1)));
              MR_Word Var_19 = ((MR_Word) (MR_hl_field(MR_mktag(1), GoalExpr_7, (MR_Integer) 2)));
              MR_Word Var_21 = ((MR_Word) (MR_hl_field(MR_mktag(1), GoalExpr_7, (MR_Integer) 4)));
              MR_Word Var_22;
              MR_Word Var_23;
              MR_Word Var_24;

              succeeded = ((((MR_tag((MR_Word) Unify_20)) == (MR_mktag((MR_Integer) 3)))) && (((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), Unify_20, (MR_Integer) 0)))) == (MR_Integer) 1)));
              if (succeeded)
              {
                Var_22 = ((MR_Word) (MR_hl_field(MR_mktag(3), Unify_20, (MR_Integer) 1)));
                Var_23 = ((MR_Word) (MR_hl_field(MR_mktag(3), Unify_20, (MR_Integer) 2)));
                Var_24 = ((MR_Word) (MR_hl_field(MR_mktag(3), Unify_20, (MR_Integer) 3)));
              }
            }
            break;
          case (MR_Integer) 2:
            {
              MR_Word BuiltinState_28 = ((MR_Word) (MR_hl_field(MR_mktag(2), GoalExpr_7, (MR_Integer) 3)));
              MR_Word Var_25 = ((MR_Word) (MR_hl_field(MR_mktag(2), GoalExpr_7, (MR_Integer) 0)));
              MR_Integer Var_26 = ((MR_Integer) (MR_hl_field(MR_mktag(2), GoalExpr_7, (MR_Integer) 1)));
          ...
          case (MR_Integer) 3:
            switch (((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), GoalExpr_7, (MR_Integer) 0)))) {
              ...
              case (MR_Integer) 0:
                {
                  ...
                  MR_Word Var_32 = ((MR_Word) (MR_hl_field(MR_mktag(3), GoalExpr_7, (MR_Integer) 2)));
                  MR_Word Var_33 = ((MR_Word) (MR_hl_field(MR_mktag(3), GoalExpr_7, (MR_Integer) 3)));
                  MR_Word Var_34 = ((MR_Word) (MR_hl_field(MR_mktag(3), GoalExpr_7, (MR_Integer) 4)));
                  MR_Word Var_35 = ((MR_Word) (MR_hl_field(MR_mktag(3), GoalExpr_7, (MR_Integer) 5)));
              ...
              case (MR_Integer) 2:
                {
                  MR_Word ConjType_54 = ((MR_Word) (MR_hl_field(MR_mktag(3), GoalExpr_7, (MR_Integer) 1)));
                  MR_Word Var_55 = ((MR_Word) (MR_hl_field(MR_mktag(3), GoalExpr_7, (MR_Integer) 2)));
...
{
  {
    ...
    succeeded = ((MR_tag((MR_Word) GoalExpr_2)) == (MR_mktag((MR_Integer) 2)));
    if (succeeded)
    {
      Var_4 = ((MR_Word) (MR_hl_field(MR_mktag(2), GoalExpr_2, (MR_Integer) 0)));
      Var_5 = ((MR_Integer) (MR_hl_field(MR_mktag(2), GoalExpr_2, (MR_Integer) 1)));
      Var_6 = ((MR_Word) (MR_hl_field(MR_mktag(2), GoalExpr_2, (MR_Integer) 2)));
      Var_7 = ((MR_Word) (MR_hl_field(MR_mktag(2), GoalExpr_2, (MR_Integer) 3)));
      Var_8 = ((MR_Word) (MR_hl_field(MR_mktag(2), GoalExpr_2, (MR_Integer) 4)));
      SymName_9 = ((MR_Word) (MR_hl_field(MR_mktag(2), GoalExpr_2, (MR_Integer) 5)));
      succeeded = ((MR_tag((MR_Word) SymName_9)) == (MR_mktag((MR_Integer) 1)));
      if (succeeded)
      {
  ...
  MR_Word * STATE_VARIABLE_Info_73)
{
  switch (MR_tag((MR_Word) STATE_VARIABLE_GoalExpr_0_66)) {
    ...
    case (MR_Integer) 2:
      ...
      break;
    case (MR_Integer) 3:
      switch (((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), STATE_VARIABLE_GoalExpr_0_66, (MR_Integer) 0)))) {
        default: /*NOTREACHED*/ MR_assert(0);
        case (MR_Integer) 0:
        ...
        case (MR_Integer) 2:
          {
            MR_Word ConjType_17 = ((MR_Word) (MR_hl_field(MR_mktag(3), STATE_VARIABLE_GoalExpr_0_66, (MR_Integer) 1)));
        ...
        case (MR_Integer) 7:
          {
            ...
            switch (MR_tag((MR_Word) ShortHand0_53)) {
              ...
              case (MR_Integer) 1:
                {
                  MR_Word GoalType_54 = ((MR_Word) (MR_hl_field(MR_mktag(1), ShortHand0_53, (MR_Integer) 0)));
