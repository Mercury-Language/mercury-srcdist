        ...
        switch (MR_tag((MR_Word) GoalExpr_7)) {
          ...
          case (MR_Integer) 3:
            switch (((MR_Integer) ((MR_hl_field(MR_mktag(3), GoalExpr_7, (MR_Integer) 0))))) {
              ...
              case (MR_Integer) 0:
                {
                  ...
                  if (succeeded)
                  {
                    if (((((MR_tag((MR_Word) GenericCall_31)) == (MR_Integer) 1)) || (((MR_tag((MR_Word) GenericCall_31)) == (MR_Integer) 0))))
                      succeeded = MR_TRUE;
                    else
                      succeeded = MR_FALSE;
                  }
              ...
              case (MR_Integer) 2:
                {
                  MR_Word ConjType_53 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(3), GoalExpr_7, (MR_Integer) 1))) & (MR_Integer) 1);

                  succeeded = (ConjType_53 == (MR_Integer) 1);
                }
                break;
              case (MR_Integer) 3:
