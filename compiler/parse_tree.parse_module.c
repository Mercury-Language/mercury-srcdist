...
{
  {
    ...
    libs__globals__lookup_accumulating_option_3_p_0(Globals_10, (MR_Integer) 684, &Dirs_18);
...
{
  {
    ...
    else
    {
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(2), Spec_13, 1) = (MR_Box) (((((MR_Unsigned) ((MR_Integer) 29) << 1)) | (MR_Unsigned) ((MR_Integer) 1)));
...
{
  {
    ...
    }
    {
      ...
      *Spec_12 = base;
      ...
      MR_hl_field(MR_mktag(2), base, 1) = (MR_Box) (((((MR_Unsigned) ((MR_Integer) 29) << 1)) | (MR_Unsigned) ((MR_Integer) 1)));
