    ...
    case (MR_Integer) 2:
      {
        ...
        parse_tree__parse_error__add_nonfatal_error_4_p_0((MR_Integer) 6, ItemSpecs_29, STATE_VARIABLE_Errors_0_33, &STATE_VARIABLE_Errors_2_42);
        ...
        parse_tree__parse_error__add_nonfatal_error_4_p_0(Error_67, Var_85, STATE_VARIABLE_Errors_2_42, STATE_VARIABLE_Errors_34);
      }
      break;
    case (MR_Integer) 3:
      {
