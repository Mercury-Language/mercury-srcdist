      ...
      case (MR_Integer) 1:
        {
          ...
          {
            STATE_VARIABLE_Specs_208_208 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      ...
      case (MR_Integer) 2:
        {
          ...
          parse_tree__parse_module__add_section_component_8_p_0(CurModuleName_23, (MR_Integer) 1, SectionContext_44, InclsCord_48, AvailsCord_49, ItemsCord_50, STATE_VARIABLE_ModuleComponents_0_78, &STATE_VARIABLE_ModuleComponents_198_198);
          {
            ...
            case (MR_Integer) 2:
              {
                ...
                switch (MR_tag((MR_Word) IOM_51)) {
                  ...
                  case (MR_Integer) 2:
                    {
                      ...
                      {
                        ItemSeqInitLookAhead_247 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                  ...
                  case (MR_Integer) 3:
                    {
                      SectionKind_245 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(3), IOM_51, (MR_Integer) 1))) & (MR_Integer) 1);
                ...
                parse_tree__parse_module__add_section_component_8_p_0(CurModuleName_23, SectionKind_245, SectionContext_246, InclsCord_249, AvailsCord_250, ItemsCord_251, STATE_VARIABLE_ModuleComponents_0_78, &STATE_VARIABLE_ModuleComponents_106_106);
                {
                    ...
                    if (((MR_tag((MR_Word) RawStartModuleName_56)) == (MR_Integer) 1))
                    {
                      ...
                      else
                      {
...

                        {
                          ...
                          MR_hl_field(MR_mktag(3), Var_122, 0) = ((MR_Box) ((MR_Unsigned) 7U));
                        ...
                        }
                        {
                          ...
                          MR_hl_field(MR_mktag(3), Var_127, 0) = ((MR_Box) ((MR_Unsigned) 7U));
                        ...
                        {
                          Pieces_218 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                        ...
                        {
                          Msg_219 = (MR_Word) MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL);
...
{
  {
    ...
    if ((MaybePrevSection_25 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(1), NoSectionPieces_39, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &parse_tree__parse_module_scalar_common_1[101])));
                ...
                case (MR_Integer) 4:
                  {
                    ...
                    Var_102 = mercury__cord__list_1_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_0), ItemsCord_47);
                    {
                      ...
                      MR_hl_field(MR_mktag(0), RawItemBlock_48, 2) = ((MR_Box) (SectionContext_43));
                      MR_hl_field(MR_mktag(0), RawItemBlock_48, 3) = ((MR_Box) (Var_100));
                      MR_hl_field(MR_mktag(0), RawItemBlock_48, 4) = ((MR_Box) (Var_101));
                      MR_hl_field(MR_mktag(0), RawItemBlock_48, 5) = ((MR_Box) (Var_102));
                    }
                    {
                      MR_Word base;
...
{
  {
    ...
    {
      ItemSeqInitLookAhead_35 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
    ...
    {
      RawItemBlock_39 = (MR_Word) MR_new_object(MR_Word, (6 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), RawItemBlock_39, 0) = ((MR_Box) (CurModuleName_22));
      MR_hl_field(MR_mktag(0), RawItemBlock_39, 1) = ((MR_Box) ((MR_Integer) 0));
      MR_hl_field(MR_mktag(0), RawItemBlock_39, 2) = ((MR_Box) (SectionContext_34));
      MR_hl_field(MR_mktag(0), RawItemBlock_39, 3) = ((MR_Box) (Var_61));
      MR_hl_field(MR_mktag(0), RawItemBlock_39, 4) = ((MR_Box) (Var_62));
      MR_hl_field(MR_mktag(0), RawItemBlock_39, 5) = ((MR_Box) (Var_63));
    }
    {
      MR_Word base;
      base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
  ...
  MR_Word * HeadVar__7_7)
{
  ...
  else
  {
    ...
    Incls_25 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ItemBlock_8, (MR_Integer) 3))));
    Avails_26 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ItemBlock_8, (MR_Integer) 4))));
    Items_27 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ItemBlock_8, (MR_Integer) 5))));
    switch (Section_23) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 1:
        {
          ...
          *HeadVar__3_3 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_include_0), Incls_25, ImpIncls0_17);
          *HeadVar__5_5 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_avail_0), Avails_26, ImpAvails0_19);
          *HeadVar__7_7 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_0), Items_27, ImpItems0_21);
        }
        break;
      case (MR_Integer) 0:
        {
          *HeadVar__2_2 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_include_0), Incls_25, IntIncls0_16);
          *HeadVar__4_4 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_avail_0), Avails_26, IntAvails0_18);
          *HeadVar__6_6 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_0), Items_27, IntItems0_20);
        ...
        case (MR_Integer) 1:
          {
            ...
            {
              ItemSpecs_170 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              ...
              case (MR_Integer) 0:
                {
                  ...
                  succeeded = ((((MR_tag((MR_Word) Item0_66)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(MR_mktag(3), Item0_66, (MR_Integer) 0)))) == (MR_Integer) 12)));
                  if (succeeded)
                  {
...
{
  {
    ...
    else
    {
      ...
      {
        NoWarnItemNothingInfo_25 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
...
{
  {
    ...
    libs__globals__lookup_accumulating_option_3_p_0(Globals_12, (MR_Integer) 669, &Dirs_20);
      ...
      case (MR_Integer) 2:
        {
          ...
          {
            LookAhead_50 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            ...
            case (MR_Integer) 2:
              {
                ...
                {
                  FirstLookAhead_47 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
