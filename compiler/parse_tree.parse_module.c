            ...
            case (MR_Integer) 2:
              {
                ...
                switch (MR_tag((MR_Word) IOM_51)) {
                  ...
                  case (MR_Integer) 3:
                    {
                      MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), IOM_51, (MR_Integer) 1)));
                ...
                case (MR_Integer) 4:
                  {
                    ...
                    MR_Word Var_101;
                    MR_Word Var_102;
                    MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), IOM_41, (MR_Integer) 1)));
...
{
  {
    ...
    *ParseTreeOpt_16 = ((MR_Word) (conv4_ParseTreeOpt_16));
    ...
    packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), *ParseTreeOpt_16, (MR_Integer) 1)));
...
{
  {
    ...
    else
    {
      ...
      if (((MR_tag((MR_Word) ReadModuleAndTimestamps_18)) == (MR_Integer) 0))
      {
        ...
        MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), ReadModuleAndTimestamps_18, (MR_Integer) 0)));
