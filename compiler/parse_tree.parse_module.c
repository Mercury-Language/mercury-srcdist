...
parse_tree__parse_module__IntroducedFrom__pred__read_parse_tree_opt__684__1_2_p_0(
  MR_Word Imports_40,
  MR_Word HeadVar__2_71);

static MR_bool MR_CALL 
parse_tree__parse_module__IntroducedFrom__pred__read_parse_tree_opt__681__1_1_p_0(
                ...
                case (MR_Integer) 1:
                  {
                    ...
                    Var_181 = mercury__term__get_term_context_1_f_0((MR_Word) (&mercury__term__term__type_ctor_info_generic_0), IOMTerm_288);
                    {
                      ...
                      MR_hl_field(MR_mktag(0), Msg_60, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &parse_tree__parse_module_scalar_common_1[110])));
                    }
                    {
                  ...
                  case (MR_Integer) 0:
                    {
...

                      {
                        ...
                        MR_hl_field(MR_mktag(0), Var_103, 0) = ((MR_Box) (SectionContext_42));
                        MR_hl_field(MR_mktag(0), Var_103, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &parse_tree__parse_module_scalar_common_1[98])));
                      }
                      {
...
{
  {
    ...
    switch (MR_tag((MR_Word) ReadIOMResult_34)) {
      ...
      case (MR_Integer) 1:
        {
          MR_Word ItemSpec_35 = (MR_Word) (MR_body((MR_Word) (ReadIOMResult_34), (MR_Integer) 1));
            ...
            case (MR_Integer) 2:
              {
                ...
                }
                {
                  ...
                  MR_hl_field(MR_mktag(0), Var_102, 0) = ((MR_Box) (Context_66));
  ...
  MR_Word * STATE_VARIABLE_LinePosn_64)
{
  while (MR_TRUE)
  {
    ...
    switch (MR_tag((MR_Word) ReadIOMResult_32)) {
      ...
      case (MR_Integer) 1:
        {
          MR_Word ItemSpec_33 = (MR_Word) (MR_body((MR_Word) (ReadIOMResult_32), (MR_Integer) 1));
...
{
  {
    ...
    succeeded = parse_tree__parse_module__IntroducedFrom__pred__read_parse_tree_opt__684__1_2_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))));
    return succeeded;
  }
}
...
{
  {
    ...
    succeeded = parse_tree__parse_module__IntroducedFrom__pred__read_parse_tree_opt__681__1_1_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))));
    return succeeded;
  }
}
...
{
  {
    ...
    else
    {
      ...
      parse_tree__parse_module__check_for_unexpected_item_at_end_15_p_0(SourceFileName_35, FileString_15, MaxOffset_16, ModuleName_76, Var_62, FinalLookAhead_29, SeqNumCounter_36, STATE_VARIABLE_Specs_58_58, STATE_VARIABLE_Specs_46, STATE_VARIABLE_Errors_59_59, STATE_VARIABLE_Errors_47, STATE_VARIABLE_LineContext_60_60, &_LineContext_37, STATE_VARIABLE_LinePosn_61_61, &_LinePosn_38);
      {
        ...
        MR_hl_field(MR_mktag(0), Var_65, 0) = ((MR_Box) (&parse_tree__parse_module_scalar_common_8[0]));
        ...
        case (MR_Integer) 0:
          {
            ...
            Var_33 = mercury__term__get_term_context_1_f_0((MR_Word) (&mercury__term__term__type_ctor_info_generic_0), IOMTerm_8);
            {
              ...
              MR_hl_field(MR_mktag(0), Msg_67, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &parse_tree__parse_module_scalar_common_1[94])));
            }
            {
    ...
    case (MR_Integer) 1:
      {
        ...
        Var_56 = mercury__term__get_term_context_1_f_0((MR_Word) (&mercury__term__term__type_ctor_info_generic_0), IOMTerm_8);
        {
          ...
          MR_hl_field(MR_mktag(0), Msg_13, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &parse_tree__parse_module_scalar_common_1[93])));
        }
        {
      ...
      case (MR_Integer) 0:
        {
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(0), Var_90, 0) = ((MR_Box) (LookAheadContext_28));
            MR_hl_field(MR_mktag(0), Var_90, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &parse_tree__parse_module_scalar_common_1[84])));
          }
          {
  ...
  {
    {
      ...
      *SubMsg_4 = base;
      ...
      MR_hl_field(MR_mktag(0), base, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &parse_tree__parse_module_scalar_common_1[89])));
    }
  }
}
...
{
  {
    ...
    libs__globals__lookup_accumulating_option_3_p_0(Globals_12, (MR_Integer) 673, &Dirs_20);
...
{
  {
    ...
    parse_tree__prog_item__convert_parse_tree_int_parse_tree_int3_4_p_0(ParseTree_24, ParseTree3_20, Specs0_25, Specs_21);
  }
}
...
{
  {
    ...
    parse_tree__parse_module__actually_read_module_int_12_p_0(IntFileKind_13, Globals_14, DefaultModuleName_15, DefaultExpectationContexts_16, MaybeFileNameAndStream_17, ReadModuleAndTimestamps_18, MaybeModuleTimestampRes_19, &ParseTree_24, &Specs0_25, Errors_22);
    parse_tree__prog_item__convert_parse_tree_int_parse_tree_int2_4_p_0(ParseTree_24, ParseTree2_20, Specs0_25, Specs_21);
  }
}
...
{
  {
    ...
    parse_tree__parse_module__actually_read_module_int_12_p_0(IntFileKind_13, Globals_14, DefaultModuleName_15, DefaultExpectationContexts_16, MaybeFileNameAndStream_17, ReadModuleAndTimestamps_18, MaybeModuleTimestampRes_19, &ParseTree_24, &Specs0_25, Errors_22);
    parse_tree__prog_item__convert_parse_tree_int_parse_tree_int1_4_p_0(ParseTree_24, ParseTree1_20, Specs0_25, Specs_21);
  }
}
...
{
  {
    ...
    parse_tree__parse_module__actually_read_module_int_12_p_0(IntFileKind_13, Globals_14, DefaultModuleName_15, DefaultExpectationContexts_16, MaybeFileNameAndStream_17, ReadModuleAndTimestamps_18, MaybeModuleTimestampRes_19, &ParseTree_24, &Specs0_25, Errors_22);
    parse_tree__prog_item__convert_parse_tree_int_parse_tree_int0_4_p_0(ParseTree_24, ParseTree0_20, Specs0_25, Specs_21);
  }
}
    ...
    case (MR_Integer) 0:
      {
        ...
        parse_tree__prog_item__convert_parse_tree_int_parse_tree_int0_4_p_0(InitParseTreeInt_24, &ParseTreeInt0_26, Specs0_25, &Specs1_27);
        ...
        *ParseTreeInt_20 = parse_tree__prog_item__convert_parse_tree_int0_to_parse_tree_int_1_f_0(ParseTreeInt0_26);
      }
      break;
    case (MR_Integer) 1:
      {
        ...
        parse_tree__prog_item__convert_parse_tree_int_parse_tree_int1_4_p_0(InitParseTreeInt_50, &ParseTreeInt1_29, Specs0_51, &Specs1_52);
        ...
        *ParseTreeInt_20 = parse_tree__prog_item__convert_parse_tree_int1_to_parse_tree_int_1_f_0(ParseTreeInt1_29);
      }
      break;
    case (MR_Integer) 2:
      {
        ...
        parse_tree__prog_item__convert_parse_tree_int_parse_tree_int2_4_p_0(InitParseTreeInt_54, &ParseTreeInt2_30, Specs0_55, &Specs1_56);
        ...
        *ParseTreeInt_20 = parse_tree__prog_item__convert_parse_tree_int2_to_parse_tree_int_1_f_0(ParseTreeInt2_30);
      }
      break;
    case (MR_Integer) 3:
      {
        ...
        parse_tree__prog_item__convert_parse_tree_int_parse_tree_int3_4_p_0(InitParseTreeInt_58, &ParseTreeInt3_31, Specs0_59, &Specs1_60);
        ...
        *ParseTreeInt_20 = parse_tree__prog_item__convert_parse_tree_int3_to_parse_tree_int_1_f_0(ParseTreeInt3_31);
      }
      break;
  }
}
    ...
    if (((MR_tag((MR_Word) MaybeResult_16)) == (MR_Integer) 1))
    {
      ...
      *ModuleName_13 = DefaultModuleName_10;
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(1), Var_72, 1) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 0));
...
{
  {
...

    {
      ...
      MR_hl_field(MR_mktag(0), Var_35, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &parse_tree__parse_module_scalar_common_1[84])));
    }
    {
