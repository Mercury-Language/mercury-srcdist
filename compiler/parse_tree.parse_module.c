      ...
      case (MR_Integer) 1:
        {
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(1), Pieces_62, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &parse_tree__parse_module_scalar_common_1[7])));
          }
          {
...
{
  {
    ...
    libs__globals__lookup_accumulating_option_3_p_0(Globals_10, (MR_Integer) 681, &Dirs_18);
