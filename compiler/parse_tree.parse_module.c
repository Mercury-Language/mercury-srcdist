  ...
  MR_Word * STATE_VARIABLE_Specs_35)
{
  if ((InitLookAhead_18 == (MR_Word) ((MR_Unsigned) 0U)))
  {
    ...
    mercury__parser__read_term_from_linestr_8_p_0((MR_Word) (&mercury__term__term__type_ctor_info_generic_0), FileName_15, FileString_16, FileStringLen_17, STATE_VARIABLE_LineContext_0_30, STATE_VARIABLE_LineContext_31, STATE_VARIABLE_LinePosn_0_32, STATE_VARIABLE_LinePosn_33, &ReadTermResult_25);
...
{
  {
    ...
    libs__globals__lookup_accumulating_option_3_p_0(Globals_10, (MR_Integer) 688, &Dirs_18);
