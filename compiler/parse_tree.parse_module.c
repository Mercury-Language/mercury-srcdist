    ...
    case (MR_Integer) 1:
      {
        ...
        Context_37 = mercury__term__context_init_2_f_0(FileName_12, LineNumber_36);
        {
          ...
          MR_hl_field(MR_mktag(3), Var_42, 1) = ((MR_Box) (ErrorMsg_35));
        }
        {
          Pieces_38 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), Pieces_38, 0) = ((MR_Box) (Var_42));
    ...
    case (MR_Integer) 2:
      {
        ...
        MR_Integer SeqNum_59;
        MR_Word MaybeItemOrMarker_60;
        MR_Word Var_64;

        mercury__counter__allocate_3_p_0(&SeqNum_59, STATE_VARIABLE_SeqNumCounter_0_21, STATE_VARIABLE_SeqNumCounter_22);
        {
          Var_64 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), Var_64, 0) = ((MR_Box) (SeqNum_59));
        }
        parse_tree__parse_item__parse_item_or_marker_5_p_0(ModuleName_15, VarSet_40, Term_41, Var_64, &MaybeItemOrMarker_60);
        if (((MR_tag((MR_Word) MaybeItemOrMarker_60)) == (MR_Integer) 0))
        {
          MR_Word Specs_62 = ((MR_Word) ((MR_hl_field(MR_mktag(0), MaybeItemOrMarker_60, (MR_Integer) 0))));

          {
            ...
            *ReadIOMResult_16 = base;
            ...
            MR_hl_field(MR_mktag(2), base, 2) = ((MR_Box) (Specs_62));
          }
        }
        else
        {
          MR_Word ItemOrMarker_61 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MaybeItemOrMarker_60, (MR_Integer) 0))));

          {
            ...
            *ReadIOMResult_16 = base;
            ...
            MR_hl_field(MR_mktag(3), base, 2) = ((MR_Box) (ItemOrMarker_61));
          }
        }
      }
      break;
    ...
    case (MR_Integer) 2:
      {
        ...
        MR_Integer SeqNum_38;
        MR_Word MaybeItemOrMarker_39;
        MR_Word Var_43;

        mercury__counter__allocate_3_p_0(&SeqNum_38, STATE_VARIABLE_SeqNumCounter_0_19, STATE_VARIABLE_SeqNumCounter_20);
        {
          Var_43 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), Var_43, 0) = ((MR_Box) (SeqNum_38));
        }
        parse_tree__parse_item__parse_item_or_marker_5_p_0(ModuleName_7, VarSet_17, Term_18, Var_43, &MaybeItemOrMarker_39);
        if (((MR_tag((MR_Word) MaybeItemOrMarker_39)) == (MR_Integer) 0))
        {
          MR_Word Specs_41 = ((MR_Word) ((MR_hl_field(MR_mktag(0), MaybeItemOrMarker_39, (MR_Integer) 0))));

          {
            ...
            *ReadIOMResult_10 = base;
            ...
            MR_hl_field(MR_mktag(2), base, 2) = ((MR_Box) (Specs_41));
          }
        }
        else
        {
          MR_Word ItemOrMarker_40 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MaybeItemOrMarker_39, (MR_Integer) 0))));

          {
            ...
            *ReadIOMResult_10 = base;
            ...
            MR_hl_field(MR_mktag(3), base, 2) = ((MR_Box) (ItemOrMarker_40));
          }
        }
      }
      break;
