...
parse_tree__parse_module__IntroducedFrom__pred__read_term_msg_to_pieces__1625__1_2_p_0(
  ...
  MR_Box wrapper_arg_1)
{
  ...
  succeeded = parse_tree__parse_module__IntroducedFrom__pred__read_term_msg_to_pieces__1625__1_2_p_0(((MR_Char) (MR_Word) (MR_hl_field(0, closure, 3))), ((MR_Char) (MR_Word) wrapper_arg_1));
  return succeeded;
}
