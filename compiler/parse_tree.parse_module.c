              ...
              case (MR_Integer) 0:
                {
                  ...
                  succeeded = ((((MR_tag((MR_Word) Item0_66)) == (MR_mktag((MR_Integer) 3)))) && (((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), Item0_66, (MR_Integer) 0)))) == (MR_Integer) 11)));
                  if (succeeded)
                  {
...
{
  {
    ...
    else
    {
      ...
      TypeCtorInfo_67_67 = (MR_Word) &mercury__term__term__type_ctor_info_context_0;
      mercury__list__sort_and_remove_dups_2_p_0(TypeCtorInfo_67_67, ExpectationContexts_9, &SortedExpectationContexts0_19);
      Var_62 = mercury__term__context_init_0_f_0();
      mercury__list__delete_all_3_p_1(TypeCtorInfo_67_67, SortedExpectationContexts0_19, ((MR_Box) (Var_62)), &SortedExpectationContexts_20);
      mercury__list__map_3_p_0(TypeCtorInfo_67_67, (MR_Word) &parse_tree__error_util__parse_tree__error_util__type_ctor_info_error_msg_0, (MR_Word) &parse_tree__parse_module_scalar_common_5[0], SortedExpectationContexts_20, &SubMsgs_21);
      {
        Var_65 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(0), Spec_22, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 2))));
