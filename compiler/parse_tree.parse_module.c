...
static /* final */ const MR_Box parse_tree__parse_module_scalar_common_1[106][2] = {
  ...
  /* row 86 */
  {
    (MR_Box) (((MR_Unsigned) (((MR_Box) ((MR_Integer) 28))) | (((MR_Unsigned) (((MR_Box) ((MR_Integer) 1))) << (MR_Integer) 10)))),
...
{
  {
    ...
    else
    {
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(1), MainComponent_17, 0) = (MR_Box) (((MR_Unsigned) (((MR_Box) ((MR_Integer) 28))) | (((MR_Unsigned) (((MR_Box) ((MR_Integer) 1))) << (MR_Integer) 10))));
