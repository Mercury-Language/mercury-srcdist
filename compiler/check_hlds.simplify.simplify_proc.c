...
{
  {
    ...
    {
      libs__globals__lookup_string_option_3_p_0(check_hlds__simplify__simplify_proc__Globals_12, (MR_Integer) 354, &check_hlds__simplify__simplify_proc__CommonStructPreds_13);
    }
