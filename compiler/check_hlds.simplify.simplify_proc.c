        ...
        case (MR_Integer) 4:
          {
            // case "string"
            {
              ...
              do
              {
                ...
                result_7 = MR_strcmp(PredName_5, ((&check_hlds__simplify__simplify_proc_vector_common_6[5 + mid_6]))->check_hlds__simplify__simplify_proc__vector_common_type_6_0__vct_6_f_0);
