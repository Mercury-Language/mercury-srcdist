          ...
          case (MR_Integer) 0:
            {
              ...
              if (succeeded)
              {
...

                {
                  ...
                  MR_hl_field(0, Spec_31, 0) = ((MR_Box) ((MR_String) "predicate \140check_hlds.simplify.simplify_proc.maybe_warn_about_may_duplicate_attributes\'/5"));
                  MR_hl_field(0, Spec_31, 1) = ((MR_Box) ((MR_Unsigned) 0U));
                  MR_hl_field(0, Spec_31, 2) = ((MR_Box) (MR_mkword(3, &check_hlds__simplify__simplify_proc_scalar_common_3[1])));
                  MR_hl_field(0, Spec_31, 3) = ((MR_Box) (Context_22));
                  MR_hl_field(0, Spec_31, 4) = ((MR_Box) (MR_mkword(1, &check_hlds__simplify__simplify_proc_scalar_common_1[11])));
                }
                {
          ...
          case (MR_Integer) 1:
            {
              ...
              if (succeeded)
              {
...

                {
                  ...
                  MR_hl_field(0, Spec_43, 0) = ((MR_Box) ((MR_String) "predicate \140check_hlds.simplify.simplify_proc.maybe_warn_about_may_duplicate_attributes\'/5"));
                  MR_hl_field(0, Spec_43, 1) = ((MR_Box) ((MR_Unsigned) 0U));
                  MR_hl_field(0, Spec_43, 2) = ((MR_Box) (MR_mkword(3, &check_hlds__simplify__simplify_proc_scalar_common_3[1])));
                  MR_hl_field(0, Spec_43, 3) = ((MR_Box) (Context_22));
                  MR_hl_field(0, Spec_43, 4) = ((MR_Box) (MR_mkword(1, &check_hlds__simplify__simplify_proc_scalar_common_1[17])));
                }
                {
                  STATE_VARIABLE_Specs_29_29 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          ...
          case (MR_Integer) 0:
            {
              ...
              if (succeeded)
              {
...

                {
                  ...
                  MR_hl_field(0, Spec_45, 0) = ((MR_Box) ((MR_String) "predicate \140check_hlds.simplify.simplify_proc.maybe_warn_about_may_export_body_attribute\'/5"));
                  MR_hl_field(0, Spec_45, 1) = ((MR_Box) ((MR_Unsigned) 0U));
                  MR_hl_field(0, Spec_45, 2) = ((MR_Box) (MR_mkword(3, &check_hlds__simplify__simplify_proc_scalar_common_3[1])));
                  MR_hl_field(0, Spec_45, 3) = ((MR_Box) (Context_22));
                  MR_hl_field(0, Spec_45, 4) = ((MR_Box) (MR_mkword(1, &check_hlds__simplify__simplify_proc_scalar_common_1[20])));
                }
                {
                  MR_Word base;
                  base = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
