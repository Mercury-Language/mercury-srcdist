  ...
  MR_Word * STATE_VARIABLE_Info_32)
{
  ...
  MR_Word STATE_VARIABLE_Goal_72_72;
  ...
  if (succeeded)
  {
    ...
    {
      STATE_VARIABLE_SimplifyTasks_39_39 = (MR_Word) MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(0, STATE_VARIABLE_SimplifyTasks_39_39, 0) = (MR_Box) (((((MR_Unsigned) (Var_142) << 19)) | (((((MR_Unsigned) (Var_143) << 18)) | (((((MR_Unsigned) (Var_144) << 17)) | (((((MR_Unsigned) (Var_145) << 16)) | (((((MR_Unsigned) (Var_146) << 15)) | (((((MR_Unsigned) ((MR_Integer) 0) << 14)) | (((((MR_Unsigned) (Var_148) << 13)) | (((((MR_Unsigned) ((MR_Integer) 1) << 12)) | (((((MR_Unsigned) (Var_150) << 11)) | (((((MR_Unsigned) (Var_151) << 10)) | (((((MR_Unsigned) (Var_152) << 9)) | (((((MR_Unsigned) (Var_153) << 8)) | (((((MR_Unsigned) (Var_154) << 7)) | (((((MR_Unsigned) (Var_155) << 6)) | (((((MR_Unsigned) (Var_156) << 5)) | (((((MR_Unsigned) (Var_157) << 4)) | (((((MR_Unsigned) (Var_158) << 3)) | (((((MR_Unsigned) (Var_159) << 2)) | (((((MR_Unsigned) (Var_160) << 1)) | (MR_Unsigned) (Var_161)))))))))))))))))))))))))))))))))))))));
    }
    check_hlds__simplify__simplify_info__simplify_info_set_simplify_tasks_3_p_0(STATE_VARIABLE_SimplifyTasks_39_39, STATE_VARIABLE_Info_0_31, &STATE_VARIABLE_Info_41_41);
    check_hlds__simplify__simplify_proc__do_simplify_top_level_goal_6_p_0(NestedContext0_8, InstMap0_9, STATE_VARIABLE_Goal_0_29, &STATE_VARIABLE_Goal_42_42, STATE_VARIABLE_Info_41_41, &STATE_VARIABLE_Info_43_43);
    check_hlds__simplify__simplify_info__simplify_info_set_allow_messages_3_p_0((MR_Integer) 0, STATE_VARIABLE_Info_43_43, &STATE_VARIABLE_Info_46_46);
    ...
    {
      STATE_VARIABLE_SimplifyTasks_51_51 = (MR_Word) MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(0, STATE_VARIABLE_SimplifyTasks_51_51, 0) = (MR_Box) (((((MR_Unsigned) (Var_182) << 19)) | (((((MR_Unsigned) (Var_183) << 18)) | (((((MR_Unsigned) (Var_184) << 17)) | (((((MR_Unsigned) (Var_185) << 16)) | (((((MR_Unsigned) (Var_186) << 15)) | (((((MR_Unsigned) (Var_187) << 14)) | (((((MR_Unsigned) (Var_188) << 13)) | (((((MR_Unsigned) (Var_189) << 12)) | (((((MR_Unsigned) (Var_190) << 11)) | (((((MR_Unsigned) (Var_191) << 10)) | (((((MR_Unsigned) ((MR_Integer) 1) << 9)) | (((((MR_Unsigned) (Var_193) << 8)) | (((((MR_Unsigned) ((MR_Integer) 1) << 7)) | (((((MR_Unsigned) (Var_195) << 6)) | (((((MR_Unsigned) (Var_196) << 5)) | (((((MR_Unsigned) ((MR_Integer) 0) << 4)) | (((((MR_Unsigned) (Var_198) << 3)) | (((((MR_Unsigned) (Var_199) << 2)) | (((((MR_Unsigned) (Var_200) << 1)) | (MR_Unsigned) (Var_201)))))))))))))))))))))))))))))))))))))));
    }
    check_hlds__simplify__simplify_info__simplify_info_reinit_3_p_0(STATE_VARIABLE_SimplifyTasks_51_51, STATE_VARIABLE_Info_46_46, &STATE_VARIABLE_Info_53_53);
  }
  else
  {
    STATE_VARIABLE_Info_53_53 = STATE_VARIABLE_Info_0_31;
    STATE_VARIABLE_Goal_42_42 = STATE_VARIABLE_Goal_0_29;
  }
  check_hlds__simplify__simplify_proc__do_simplify_top_level_goal_6_p_0(NestedContext0_8, InstMap0_9, STATE_VARIABLE_Goal_42_42, &STATE_VARIABLE_Goal_54_54, STATE_VARIABLE_Info_53_53, &STATE_VARIABLE_Info_55_55);
  check_hlds__simplify__simplify_info__simplify_info_get_switch_arms_to_split_2_p_0(STATE_VARIABLE_Info_55_55, &ToSplitArms_15);
  ...
  if (succeeded)
  {
    ...
    MR_Word STATE_VARIABLE_Goal_63_63;
    MR_Word STATE_VARIABLE_Info_70_70;
    MR_Word STATE_VARIABLE_Info_71_71;
    MR_Word TVarSet_16;
    MR_Word InstVarSet_17;

    check_hlds__simplify__simplify_info__simplify_info_get_tvarset_2_p_0(STATE_VARIABLE_Info_55_55, &TVarSet_16);
    check_hlds__simplify__simplify_info__simplify_info_get_inst_varset_2_p_0(STATE_VARIABLE_Info_55_55, &InstVarSet_17);
    check_hlds__simplify__split_switch_arms__split_switch_arms_in_goal_3_p_0(ToSplitArms_15, STATE_VARIABLE_Goal_54_54, &STATE_VARIABLE_Goal_63_63);
    GoalInfo0_23 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_Goal_63_63, 1))));
    check_hlds__simplify__simplify_info__simplify_info_set_rerun_quant_instmap_delta_2_p_0(STATE_VARIABLE_Info_55_55, &STATE_VARIABLE_Info_70_70);
    check_hlds__simplify__simplify_info__simplify_info_set_rerun_det_2_p_0(STATE_VARIABLE_Info_70_70, &STATE_VARIABLE_Info_71_71);
    check_hlds__simplify__simplify_proc__maybe_recompute_fields_after_top_level_goal_6_p_0(GoalInfo0_23, InstMap0_9, STATE_VARIABLE_Goal_63_63, &STATE_VARIABLE_Goal_72_72, STATE_VARIABLE_Info_71_71, &STATE_VARIABLE_Info_73_73);
  }
  else
  {
    STATE_VARIABLE_Info_73_73 = STATE_VARIABLE_Info_55_55;
    STATE_VARIABLE_Goal_72_72 = STATE_VARIABLE_Goal_54_54;
  }
  succeeded = check_hlds__simplify__simplify_info__simplify_do_after_front_end_1_p_0(STATE_VARIABLE_Info_73_73);
  if (succeeded)
  {
    Var_74 = (MR_Integer) 1;
    check_hlds__simplify__simplify_info__simplify_info_get_found_contains_trace_2_p_0(STATE_VARIABLE_Info_73_73, &Var_265);
  ...
  if (succeeded)
  {
    ...
    check_hlds__simplify__mark_trace_goals__set_goal_contains_trace_features_in_goal_7_p_0(STATE_VARIABLE_Goal_72_72, STATE_VARIABLE_Goal_30, &_ContainsTraceGoal_24, Var_76, &_LastNonTraceGoal_25, (MR_Word) ((MR_Unsigned) 0U), &TraceSpecs_26);
    check_hlds__simplify__simplify_info__simplify_info_get_error_specs_2_p_0(STATE_VARIABLE_Info_73_73, &Specs0_27);
    ...
    check_hlds__simplify__simplify_info__simplify_info_set_error_specs_3_p_0(Specs_28, STATE_VARIABLE_Info_73_73, STATE_VARIABLE_Info_32);
  }
  else
  {
    *STATE_VARIABLE_Info_32 = STATE_VARIABLE_Info_73_73;
    *STATE_VARIABLE_Goal_30 = STATE_VARIABLE_Goal_72_72;
  }
}
  ...
  MR_Word * STATE_VARIABLE_SimplifyTasks_19)
{
  ...
  libs__globals__lookup_string_option_3_p_0(Globals_10, (MR_Integer) 241, &CommonStructPreds_11);
