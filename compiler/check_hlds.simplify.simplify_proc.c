...
static void MR_CALL 
check_hlds__simplify__simplify_proc__IntroducedFrom__pred__simplify_proc_return_msgs__287__1_4_p_0(
...
{
  {
    ...
    check_hlds__simplify__simplify_proc__IntroducedFrom__pred__simplify_proc_return_msgs__287__1_4_p_0(((MR_Word) (wrapper_arg_1)), ((MR_String) (wrapper_arg_2)), ((MR_Word) (wrapper_arg_3)), &conv0_HeadVar__4_130);
...
{
  {
    ...
    if (succeeded)
    {
...

      {
        ...
        MR_hl_field(MR_mktag(0), STATE_VARIABLE_SimplifyTasks_22_22, 0) = (MR_Box) ((((packed_word_0 & (~((MR_Unsigned) 2560U)))) | (((((MR_Unsigned) ((MR_Integer) 1) << 9)) | (((MR_Unsigned) ((MR_Integer) 0) << 11))))));
      }
      ...
      packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), OriginalSimplifyTasks_12, (MR_Integer) 0)));
      {
        ...
        MR_hl_field(MR_mktag(0), STATE_VARIABLE_SimplifyTasks_32_32, 0) = (MR_Box) ((((packed_word_1 & (~((MR_Unsigned) 80U)))) | (((((MR_Unsigned) ((MR_Integer) 1) << 4)) | (((MR_Unsigned) ((MR_Integer) 1) << 6))))));
      }
...
{
  {
    ...
    check_hlds__simplify__simplify_info__simplify_info_get_rerun_quant_instmap_delta_2_p_0(STATE_VARIABLE_Info_38_38, &RerunQuantDelta_16);
    switch (RerunQuantDelta_16) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        {
    ...
    check_hlds__simplify__simplify_info__simplify_info_get_rerun_det_2_p_0(STATE_VARIABLE_Info_54_54, &RerunDet_23);
    switch (RerunDet_23) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        {
...
{
  {
    ...
    libs__globals__lookup_string_option_3_p_0(Globals_12, (MR_Integer) 195, &CommonStructPreds_13);
