  ...
  MR_Word * STATE_VARIABLE_Specs_9)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      TypeCtorInfo_34_64 = (MR_Word) &hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_proc_id_0;
      TypeCtorInfo_35_65 = (MR_Word) &hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_proc_info_0;
      mercury__map__lookup_3_p_0(TypeCtorInfo_34_64, TypeCtorInfo_35_65, ProcTable0_52, ((MR_Box) (ProcId_23)), &conv0_ProcInfo0_53);
      ...
      mercury__map__det_update_4_p_0(TypeCtorInfo_34_64, TypeCtorInfo_35_65, ((MR_Box) (ProcId_23)), ((MR_Box) (ProcInfo_54)), ProcTable0_52, &ProcTable_58);
...
{
  {
    ...
    switch (*ContainsTrace_6) {
      ...
      case (MR_Integer) 1:
        {
          hlds__hlds_goal__goal_info_remove_feature_3_p_0((MR_Integer) 19, GoalInfo0_8, &GoalInfo_94);
        }
        break;
      case (MR_Integer) 0:
        {
          hlds__hlds_goal__goal_info_add_feature_3_p_0((MR_Integer) 19, GoalInfo0_8, &GoalInfo_94);
        }
        break;
    }
    {
...
{
  {
    ...
    if (succeeded)
    {
      ...
      hlds__hlds_goal__goal_info_add_feature_3_p_0((MR_Integer) 16, GoalInfo0_6, &GoalInfo_11);
      {
...
{
  {
    ...
    libs__globals__lookup_string_option_3_p_0(Globals_12, (MR_Integer) 357, &CommonStructPreds_13);
