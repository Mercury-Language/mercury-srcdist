  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_61)
{
  ...
  succeeded = hlds__hlds_pred__marker_is_present_2_p_0(Markers0_19, (MR_Integer) 23);
  if (succeeded)
  {
    MR_Word Goal0_160;
    ...
    STATE_VARIABLE_ProcInfo_63_63 = STATE_VARIABLE_ProcInfo_0_58;
  succeeded = hlds__hlds_pred__marker_is_present_2_p_0(Markers0_19, (MR_Integer) 27);
  if (succeeded)
  {
    ...
    Attributes_15 = ((MR_Word) ((MR_hl_field(3, GoalExpr_13, (MR_Integer) 1))));
    {
      ...
      else
      {
        ...
        switch (MayDuplicate_24) {
          ...
          case (MR_Integer) 0:
            {
              succeeded = hlds__hlds_pred__marker_is_present_2_p_0(Markers_11, (MR_Integer) 8);
              if (succeeded)
              {
                MR_Word Pieces_32;
                MR_Word Spec_33;
          ...
          case (MR_Integer) 1:
            {
              succeeded = hlds__hlds_pred__marker_is_present_2_p_0(Markers_11, (MR_Integer) 6);
              if (succeeded)
              {
                MR_Word Var_69;
                MR_Word Var_70;
  ...
  MR_Word * STATE_VARIABLE_Specs_15)
{
  ...
  switch (MayExportBody_6) {
    ...
    case (MR_Integer) 0:
      {
        succeeded = hlds__hlds_pred__marker_is_present_2_p_0(Markers_7, (MR_Integer) 8);
        if (succeeded)
        {
          MR_Word Pieces_12;
          MR_Word Spec_13;
  ...
  MR_Word * STATE_VARIABLE_SimplifyTasks_19)
{
  ...
  libs__globals__lookup_string_option_3_p_0(Globals_10, (MR_Integer) 238, &CommonStructPreds_11);
