  ...
  MR_Word * STATE_VARIABLE_Info_19)
{
  ...
  MR_Word RerunDet_39;
  MR_Word STATE_VARIABLE_Goal_42_59;
  MR_Word STATE_VARIABLE_Info_44_61;
  MR_Word _Common_15;
  ...
  switch (RerunQuantDelta_32) {
    ...
    case (MR_Integer) 0:
      {
        STATE_VARIABLE_Goal_42_59 = STATE_VARIABLE_Goal_20_20;
        STATE_VARIABLE_Info_44_61 = STATE_VARIABLE_Info_21_21;
      }
      break;
    case (MR_Integer) 1:
      {
        ...
        MR_Word STATE_VARIABLE_VarTable_32_49;
        MR_Word STATE_VARIABLE_RttiVarMaps_33_50;
        MR_Word STATE_VARIABLE_Goal_35_52;
        MR_Word STATE_VARIABLE_VarTable_36_53;
        MR_Word STATE_VARIABLE_RttiVarMaps_37_54;
        MR_Word STATE_VARIABLE_Info_38_55;
        MR_Word STATE_VARIABLE_Info_39_56;
        MR_Word STATE_VARIABLE_ModuleInfo_40_57;
        MR_Word STATE_VARIABLE_ModuleInfo_43_60;
        MR_Word Var_37;

        NonLocals_33 = hlds__hlds_goal__goal_info_get_nonlocals_1_f_0(GoalInfo0_12);
        check_hlds__simplify__simplify_info__simplify_info_get_var_table_2_p_0(STATE_VARIABLE_Info_21_21, &STATE_VARIABLE_VarTable_32_49);
        check_hlds__simplify__simplify_info__simplify_info_get_rtti_varmaps_2_p_0(STATE_VARIABLE_Info_21_21, &STATE_VARIABLE_RttiVarMaps_33_50);
        hlds__quantification__implicitly_quantify_goal_general_vt_9_p_0((MR_Integer) 0, NonLocals_33, &Var_37, STATE_VARIABLE_Goal_20_20, &STATE_VARIABLE_Goal_35_52, STATE_VARIABLE_VarTable_32_49, &STATE_VARIABLE_VarTable_36_53, STATE_VARIABLE_RttiVarMaps_33_50, &STATE_VARIABLE_RttiVarMaps_37_54);
        check_hlds__simplify__simplify_info__simplify_info_set_var_table_3_p_0(STATE_VARIABLE_VarTable_36_53, STATE_VARIABLE_Info_21_21, &STATE_VARIABLE_Info_38_55);
        check_hlds__simplify__simplify_info__simplify_info_set_rtti_varmaps_3_p_0(STATE_VARIABLE_RttiVarMaps_37_54, STATE_VARIABLE_Info_38_55, &STATE_VARIABLE_Info_39_56);
        check_hlds__simplify__simplify_info__simplify_info_get_module_info_2_p_0(STATE_VARIABLE_Info_39_56, &STATE_VARIABLE_ModuleInfo_40_57);
        check_hlds__simplify__simplify_info__simplify_info_get_inst_varset_2_p_0(STATE_VARIABLE_Info_39_56, &InstVarSet_38);
        check_hlds__recompute_instmap_deltas__recompute_instmap_delta_8_p_0((MR_Integer) 0, STATE_VARIABLE_VarTable_36_53, InstVarSet_38, InstMap0_9, STATE_VARIABLE_Goal_35_52, &STATE_VARIABLE_Goal_42_59, STATE_VARIABLE_ModuleInfo_40_57, &STATE_VARIABLE_ModuleInfo_43_60);
        check_hlds__simplify__simplify_info__simplify_info_set_module_info_3_p_0(STATE_VARIABLE_ModuleInfo_43_60, STATE_VARIABLE_Info_39_56, &STATE_VARIABLE_Info_44_61);
      }
      break;
  }
  check_hlds__simplify__simplify_info__simplify_info_get_rerun_det_2_p_0(STATE_VARIABLE_Info_44_61, &RerunDet_39);
  switch (RerunDet_39) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 0:
      {
        *STATE_VARIABLE_Goal_17 = STATE_VARIABLE_Goal_42_59;
        *STATE_VARIABLE_Info_19 = STATE_VARIABLE_Info_44_61;
      }
      break;
    case (MR_Integer) 1:
      {
        MR_Word Detism_40;
        MR_Word SolnContext_42;
        MR_Word PredProcId_43;
        MR_Word PredInfo_44;
        MR_Word DetInfo0_45;
        MR_Word DetInfo_48;
        MR_Word STATE_VARIABLE_ModuleInfo_45_62;
        MR_Word STATE_VARIABLE_VarTable_46_63;
        MR_Word STATE_VARIABLE_RttiVarMaps_47_64;
        MR_Word STATE_VARIABLE_ProcInfo_48_65;
        MR_Word STATE_VARIABLE_ProcInfo_49_66;
        MR_Word STATE_VARIABLE_ProcInfo_50_67;
        MR_Word STATE_VARIABLE_ModuleInfo_51_68;
        MR_Word STATE_VARIABLE_Info_52_69;
        MR_Word STATE_VARIABLE_ModuleInfo_58_75;
        MR_Word STATE_VARIABLE_VarTable_59_76;
        MR_Word STATE_VARIABLE_Info_60_77;
        MR_Word Var_46;
        MR_Word Var_47;

        Detism_40 = hlds__hlds_goal__goal_info_get_determinism_1_f_0(GoalInfo0_12);
        check_hlds__det_analysis__det_get_soln_context_2_p_0(Detism_40, &SolnContext_42);
        check_hlds__simplify__simplify_info__simplify_info_get_module_info_2_p_0(STATE_VARIABLE_Info_44_61, &STATE_VARIABLE_ModuleInfo_45_62);
        check_hlds__simplify__simplify_info__simplify_info_get_var_table_2_p_0(STATE_VARIABLE_Info_44_61, &STATE_VARIABLE_VarTable_46_63);
        check_hlds__simplify__simplify_info__simplify_info_get_rtti_varmaps_2_p_0(STATE_VARIABLE_Info_44_61, &STATE_VARIABLE_RttiVarMaps_47_64);
        check_hlds__simplify__simplify_info__simplify_info_get_pred_proc_id_2_p_0(STATE_VARIABLE_Info_44_61, &PredProcId_43);
        hlds__hlds_module__module_info_pred_proc_info_4_p_0(STATE_VARIABLE_ModuleInfo_45_62, PredProcId_43, &PredInfo_44, &STATE_VARIABLE_ProcInfo_48_65);
        hlds__hlds_pred__proc_info_set_var_table_3_p_0(STATE_VARIABLE_VarTable_46_63, STATE_VARIABLE_ProcInfo_48_65, &STATE_VARIABLE_ProcInfo_49_66);
        hlds__hlds_pred__proc_info_set_rtti_varmaps_3_p_0(STATE_VARIABLE_RttiVarMaps_47_64, STATE_VARIABLE_ProcInfo_49_66, &STATE_VARIABLE_ProcInfo_50_67);
        hlds__hlds_module__module_info_set_pred_proc_info_5_p_0(PredProcId_43, PredInfo_44, STATE_VARIABLE_ProcInfo_50_67, STATE_VARIABLE_ModuleInfo_45_62, &STATE_VARIABLE_ModuleInfo_51_68);
        check_hlds__simplify__simplify_info__simplify_info_set_module_info_3_p_0(STATE_VARIABLE_ModuleInfo_51_68, STATE_VARIABLE_Info_44_61, &STATE_VARIABLE_Info_52_69);
        check_hlds__det_util__det_info_init_6_p_0(STATE_VARIABLE_ModuleInfo_51_68, PredProcId_43, STATE_VARIABLE_VarTable_46_63, (MR_Integer) 0, (MR_Word) ((MR_Unsigned) 0U), &DetInfo0_45);
        check_hlds__det_analysis__det_infer_goal_10_p_0(STATE_VARIABLE_Goal_42_59, STATE_VARIABLE_Goal_17, InstMap0_9, SolnContext_42, (MR_Word) ((MR_Unsigned) 0U), (MR_Word) ((MR_Unsigned) 0U), &Var_46, &Var_47, DetInfo0_45, &DetInfo_48);
        check_hlds__det_util__det_info_get_module_info_2_p_0(DetInfo_48, &STATE_VARIABLE_ModuleInfo_58_75);
        check_hlds__det_util__det_info_get_var_table_2_p_0(DetInfo_48, &STATE_VARIABLE_VarTable_59_76);
        check_hlds__simplify__simplify_info__simplify_info_set_module_info_3_p_0(STATE_VARIABLE_ModuleInfo_58_75, STATE_VARIABLE_Info_52_69, &STATE_VARIABLE_Info_60_77);
        check_hlds__simplify__simplify_info__simplify_info_set_var_table_3_p_0(STATE_VARIABLE_VarTable_59_76, STATE_VARIABLE_Info_60_77, STATE_VARIABLE_Info_19);
      }
      break;
  }
}
          ...
          case (MR_Integer) 0:
            {
              ...
              if (succeeded)
              {
...

                {
                  ...
                  MR_hl_field(MR_mktag(1), Spec_38, 4) = ((MR_Box) (MR_mkword(MR_mktag(1), &check_hlds__simplify__simplify_proc_scalar_common_1[11])));
                }
                {
          ...
          case (MR_Integer) 1:
            {
              ...
              if (succeeded)
              {
...

                {
                  ...
                  MR_hl_field(MR_mktag(1), Spec_82, 4) = ((MR_Box) (MR_mkword(MR_mktag(1), &check_hlds__simplify__simplify_proc_scalar_common_1[17])));
                }
                {
                  STATE_VARIABLE_Specs_29_29 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
