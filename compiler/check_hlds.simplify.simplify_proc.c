...
{
  {
    ...
    if (succeeded)
    {
      packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), SimplifyTasks_15, (MR_Integer) 0)));
      Var_78 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), SimplifyTasks_15, (MR_Integer) 0))) >> 12)) & (MR_Integer) 1);
      Var_55 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), SimplifyTasks_15, (MR_Integer) 0))) >> 11)) & (MR_Integer) 1);
...
{
  {
    ...
    if (succeeded)
    {
...

      {
        ...
        MR_hl_field(MR_mktag(0), STATE_VARIABLE_SimplifyTasks_22_22, 0) = (MR_Box) ((((packed_word_0 & (~((MR_Unsigned) 640U)))) | (((((MR_Unsigned) ((MR_Integer) 0) << 7)) | (((MR_Unsigned) ((MR_Integer) 0) << 9))))));
      }
      ...
      packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), OriginalSimplifyTasks_12, (MR_Integer) 0)));
      {
        ...
        MR_hl_field(MR_mktag(0), STATE_VARIABLE_SimplifyTasks_32_32, 0) = (MR_Box) ((((packed_word_1 & (~((MR_Unsigned) 20U)))) | (((((MR_Unsigned) ((MR_Integer) 0) << 2)) | (((MR_Unsigned) ((MR_Integer) 0) << 4))))));
      }
                    ...
                    case (MR_Integer) 6:
                      {
                        ...
                        MR_Unsigned packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Reason_53, (MR_Integer) 2)));
                ...
                case (MR_Integer) 1:
                  {
                    ...
                    MR_Unsigned packed_word_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), ShortHand0_76, (MR_Integer) 0)));
        ...
        case (MR_Integer) 1:
          {
            ...
            if (succeeded)
            {
              ...
              {
                Spec_83 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
...
{
  {
    ...
    if (succeeded)
    {
...

      {
        ...
        MR_hl_field(MR_mktag(0), STATE_VARIABLE_SimplifyTasks_20_20, 0) = (MR_Box) ((((packed_word_0 & (~((MR_Unsigned) 4U)))) | (((MR_Unsigned) ((MR_Integer) 0) << 2))));
      }
    }
    else
        ...
        else
        {
...

          {
            ...
            *STATE_VARIABLE_SimplifyTasks_18 = base;
            MR_hl_field(MR_mktag(0), base, 0) = (MR_Box) ((((packed_word_1 & (~((MR_Unsigned) 4U)))) | (((MR_Unsigned) ((MR_Integer) 0) << 2))));
          }
        }
      }
      else
