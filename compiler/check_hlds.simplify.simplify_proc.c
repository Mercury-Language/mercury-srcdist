...
check_hlds__simplify__simplify_proc__IntroducedFrom__pred__simplify_proc_return_msgs__304__1_4_p_0(
  ...
  MR_String LambdaHeadVar__2_73,
  MR_Word LambdaHeadVar__3_74,
  MR_Word * LambdaHeadVar__4_75);
...
check_hlds__simplify__simplify_proc__simplify_proc_return_msgs_8_p_0(
  ...
  MR_Word STATE_VARIABLE_ProcInfo_0_57,
  MR_Word * STATE_VARIABLE_ProcInfo_58,
  ...
  MR_Word * LambdaHeadVar__4_75)
{
  ...
  parse_tree__var_table__lookup_var_entry_3_p_0(LambdaHeadVar__3_74, LambdaHeadVar__1_72, &E0_43);
  Var_150 = ((MR_Word) ((MR_hl_field(0, E0_43, (MR_Integer) 1))));
  Var_151 = ((MR_Unsigned) ((MR_hl_field(0, E0_43, (MR_Integer) 2))) & (MR_Integer) 1);
  {
    E_44 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(0, E_44, 0) = ((MR_Box) (LambdaHeadVar__2_73));
    MR_hl_field(0, E_44, 1) = ((MR_Box) (Var_150));
    MR_hl_field(0, E_44, 2) = (MR_Box) ((MR_Unsigned) (Var_151));
  }
  parse_tree__var_table__update_var_entry_4_p_0(LambdaHeadVar__1_72, E_44, LambdaHeadVar__3_74, LambdaHeadVar__4_75);
}
  ...
  MR_Integer * CostDelta_19)
{
  ...
  check_hlds__simplify__simplify_proc__simplify_top_level_goal_7_p_0((MR_Word) (&check_hlds__simplify__simplify_proc_scalar_common_2[0]), InstMap0_17, (MR_Integer) 0, STATE_VARIABLE_Goal_0_33, STATE_VARIABLE_Goal_34, SimplifyInfo0_20, &SimplifyInfo_26);
  check_hlds__simplify__simplify_info__simplify_info_get_module_info_2_p_0(SimplifyInfo_26, STATE_VARIABLE_ModuleInfo_30);
  check_hlds__simplify__simplify_info__simplify_info_get_var_table_2_p_0(SimplifyInfo_26, &VarTable_27);
  check_hlds__simplify__simplify_info__simplify_info_get_rtti_varmaps_2_p_0(SimplifyInfo_26, &RttiVarMaps_28);
  hlds__hlds_pred__proc_info_set_var_table_3_p_0(VarTable_27, STATE_VARIABLE_ProcInfo_0_31, &STATE_VARIABLE_ProcInfo_38_38);
  ...
  check_hlds__simplify__simplify_info__simplify_info_get_cost_delta_2_p_0(SimplifyInfo_26, CostDelta_19);
}
  ...
  MR_Box * wrapper_arg_4)
{
  ...
  MR_Word conv0_LambdaHeadVar__4_75;

  check_hlds__simplify__simplify_proc__IntroducedFrom__pred__simplify_proc_return_msgs__304__1_4_p_0(((MR_Word) (wrapper_arg_1)), ((MR_String) (wrapper_arg_2)), ((MR_Word) (wrapper_arg_3)), &conv0_LambdaHeadVar__4_75);
  *wrapper_arg_4 = ((MR_Box) (conv0_LambdaHeadVar__4_75));
}
  ...
  MR_Word * STATE_VARIABLE_Specs_59)
{
  ...
  MR_Word ProcIsModelNon_23;
  MR_Word NestedContext0_26;
  MR_Word InstMap0_27;
  MR_Word Goal0_28;
  MR_Word Goal_29;
  MR_Word Info_30;
  ...
  MR_Word HasUserEvent_49;
  MR_Word CurDeletedCallCallees_50;
  MR_Word DeletedCallCallees0_51;
  MR_Word DeletedCallCallees_52;
  MR_Word Status_53;
  MR_Word IsDefinedHere_54;
  ...
  check_hlds__simplify__simplify_proc__simplify_proc_maybe_vary_parameters_5_p_0(STATE_VARIABLE_ModuleInfo_0_55, PredId_10, STATE_VARIABLE_ProcInfo_0_57, SimplifyTasks0_9, &SimplifyTasks_15);
  hlds__hlds_module__module_info_pred_info_3_p_0(STATE_VARIABLE_ModuleInfo_0_55, PredId_10, &PredInfo0_16);
  ...
  {
    MR_Word Goal0_158;
    MR_Word GoalExpr0_159;
    MR_Word GoalInfo0_160;

    hlds__hlds_pred__proc_info_get_goal_2_p_0(STATE_VARIABLE_ProcInfo_0_57, &Goal0_158);
    GoalExpr0_159 = ((MR_Word) ((MR_hl_field(0, Goal0_158, (MR_Integer) 0))));
    GoalInfo0_160 = ((MR_Word) ((MR_hl_field(0, Goal0_158, (MR_Integer) 1))));
    if (((((MR_tag((MR_Word) GoalExpr0_159)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(3, GoalExpr0_159, (MR_Integer) 0)))) == (MR_Integer) 3))))
      succeeded = MR_TRUE;
    else
    if (((((MR_tag((MR_Word) GoalExpr0_159)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(3, GoalExpr0_159, (MR_Integer) 0)))) == (MR_Integer) 4))))
      succeeded = MR_TRUE;
    else
      succeeded = MR_FALSE;
    if (succeeded)
    {
      MR_Word GoalInfo_165;
      MR_Word Goal_166;

      hlds__hlds_goal__goal_info_add_feature_3_p_0((MR_Integer) 17, GoalInfo0_160, &GoalInfo_165);
      {
        Goal_166 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(0, Goal_166, 0) = ((MR_Box) (GoalExpr0_159));
        MR_hl_field(0, Goal_166, 1) = ((MR_Box) (GoalInfo_165));
      }
      hlds__hlds_pred__proc_info_set_goal_3_p_0(Goal_166, STATE_VARIABLE_ProcInfo_0_57, &STATE_VARIABLE_ProcInfo_61_61);
    }
    else
      STATE_VARIABLE_ProcInfo_61_61 = STATE_VARIABLE_ProcInfo_0_57;
  }
  else
    STATE_VARIABLE_ProcInfo_61_61 = STATE_VARIABLE_ProcInfo_0_57;
  ...
  if (succeeded)
  {
    Var_94 = ((((MR_Unsigned) ((MR_hl_field(0, SimplifyTasks_15, (MR_Integer) 0))) >> 17)) & (MR_Integer) 1);
    Var_63 = ((((MR_Unsigned) ((MR_hl_field(0, SimplifyTasks_15, (MR_Integer) 0))) >> 16)) & (MR_Integer) 1);
  ...
  if (succeeded)
  {
    ...
    check_hlds__simplify__simplify_proc__simplify_proc_analyze_and_format_calls_9_p_0(STATE_VARIABLE_ModuleInfo_0_55, &STATE_VARIABLE_ModuleInfo_66_66, PredId_10, PredInfo0_16, ProcId_11, STATE_VARIABLE_ProcInfo_61_61, &STATE_VARIABLE_ProcInfo_67_67, ImplicitStreamWarnings_18, &FormatSpecs_19);
  }
  else
  {
    FormatSpecs_19 = (MR_Word) ((MR_Unsigned) 0U);
    STATE_VARIABLE_ProcInfo_67_67 = STATE_VARIABLE_ProcInfo_61_61;
    STATE_VARIABLE_ModuleInfo_66_66 = STATE_VARIABLE_ModuleInfo_0_55;
  }
  check_hlds__simplify__simplify_info__simplify_info_init_6_p_0(STATE_VARIABLE_ModuleInfo_66_66, PredId_10, ProcId_11, STATE_VARIABLE_ProcInfo_67_67, SimplifyTasks_15, &Info0_20);
  CodeModel_22 = hlds__code_model__proc_info_interface_code_model_1_f_0(STATE_VARIABLE_ProcInfo_67_67);
  switch (CodeModel_22) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 0:
    case (MR_Integer) 1:
      ProcIsModelNon_23 = (MR_Word) ((MR_Unsigned) 0U);
      break;
    case (MR_Integer) 2:
      ProcIsModelNon_23 = (MR_Word) (MR_mkword(1, &check_hlds__simplify__simplify_proc_scalar_common_3[0]));
      break;
  }
  {
    NestedContext0_26 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(0, NestedContext0_26, 0) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 0));
    MR_hl_field(0, NestedContext0_26, 1) = ((MR_Box) (ProcIsModelNon_23));
    MR_hl_field(0, NestedContext0_26, 2) = ((MR_Box) ((MR_Unsigned) 0U));
    MR_hl_field(0, NestedContext0_26, 3) = ((MR_Box) ((MR_Unsigned) 0U));
  }
  hlds__hlds_pred__proc_info_get_initial_instmap_3_p_0(STATE_VARIABLE_ModuleInfo_66_66, STATE_VARIABLE_ProcInfo_67_67, &InstMap0_27);
  hlds__hlds_pred__proc_info_get_goal_2_p_0(STATE_VARIABLE_ProcInfo_67_67, &Goal0_28);
  check_hlds__simplify__simplify_proc__simplify_top_level_goal_7_p_0(NestedContext0_26, InstMap0_27, (MR_Integer) 1, Goal0_28, &Goal_29, Info0_20, &Info_30);
  hlds__hlds_pred__proc_info_set_goal_3_p_0(Goal_29, STATE_VARIABLE_ProcInfo_67_67, &STATE_VARIABLE_ProcInfo_70_70);
  check_hlds__simplify__simplify_info__simplify_info_get_var_table_2_p_0(Info_30, &VarTable0_31);
  check_hlds__simplify__simplify_info__simplify_info_get_rtti_varmaps_2_p_0(Info_30, &RttiVarMaps_32);
  check_hlds__simplify__simplify_info__simplify_info_get_elim_vars_2_p_0(Info_30, &ElimVarsLists0_33);
  ...
  parse_tree__var_table__delete_var_entries_3_p_0(ElimVars_35, VarTable0_31, &VarTable1_36);
  check_hlds__simplify__simplify_info__simplify_info_get_module_info_2_p_0(Info_30, &STATE_VARIABLE_ModuleInfo_71_71);
  succeeded = check_hlds__simplify__simplify_info__simplify_do_after_front_end_1_p_0(Info_30);
  if (succeeded)
  {
    ...
    MR_Word ArgModes_47;
    MR_Word Var_76;
    MR_Box conv1_VarTable_45;

    hlds__hlds_pred__proc_info_get_var_name_remap_2_p_0(STATE_VARIABLE_ProcInfo_70_70, &VarNameRemap_37);
    mercury__map__foldl_4_p_0((MR_Word) (&check_hlds__simplify__simplify_proc_scalar_common_1[0]), (MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&parse_tree__var_table__parse_tree__var_table__type_ctor_info_var_table_0), (MR_Word) (&check_hlds__simplify__simplify_proc_scalar_common_5[1]), VarNameRemap_37, ((MR_Box) (VarTable1_36)), &conv1_VarTable_45);
    VarTable_45 = ((MR_Word) (conv1_VarTable_45));
    Var_76 = mercury__map__init_0_f_0((MR_Word) (&check_hlds__simplify__simplify_proc_scalar_common_1[0]), (MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0));
    hlds__hlds_pred__proc_info_set_var_name_remap_3_p_0(Var_76, STATE_VARIABLE_ProcInfo_70_70, &STATE_VARIABLE_ProcInfo_77_77);
    hlds__hlds_pred__proc_info_get_headvars_2_p_0(STATE_VARIABLE_ProcInfo_77_77, &HeadVars_46);
    hlds__hlds_pred__proc_info_get_argmodes_2_p_0(STATE_VARIABLE_ProcInfo_77_77, &ArgModes_47);
    transform_hlds__direct_arg_in_out__find_and_record_any_direct_arg_in_out_posns_7_p_0(PredId_10, ProcId_11, VarTable_45, HeadVars_46, ArgModes_47, STATE_VARIABLE_ModuleInfo_71_71, STATE_VARIABLE_ModuleInfo_56);
  }
  else
  {
    VarTable_45 = VarTable1_36;
    STATE_VARIABLE_ProcInfo_77_77 = STATE_VARIABLE_ProcInfo_70_70;
    *STATE_VARIABLE_ModuleInfo_56 = STATE_VARIABLE_ModuleInfo_71_71;
  }
  hlds__hlds_pred__proc_info_set_var_table_3_p_0(VarTable_45, STATE_VARIABLE_ProcInfo_77_77, &STATE_VARIABLE_ProcInfo_79_79);
  hlds__hlds_pred__proc_info_set_rtti_varmaps_3_p_0(RttiVarMaps_32, STATE_VARIABLE_ProcInfo_79_79, &STATE_VARIABLE_ProcInfo_80_80);
  check_hlds__simplify__simplify_info__simplify_info_get_has_parallel_conj_2_p_0(Info_30, &HasParallelConj_48);
  hlds__hlds_pred__proc_info_set_has_parallel_conj_3_p_0(HasParallelConj_48, STATE_VARIABLE_ProcInfo_80_80, &STATE_VARIABLE_ProcInfo_81_81);
  check_hlds__simplify__simplify_info__simplify_info_get_has_user_event_2_p_0(Info_30, &HasUserEvent_49);
  hlds__hlds_pred__proc_info_set_has_user_event_3_p_0(HasUserEvent_49, STATE_VARIABLE_ProcInfo_81_81, &STATE_VARIABLE_ProcInfo_82_82);
  check_hlds__simplify__simplify_info__simplify_info_get_deleted_call_callees_2_p_0(Info_30, &CurDeletedCallCallees_50);
  hlds__hlds_pred__proc_info_get_deleted_call_callees_2_p_0(STATE_VARIABLE_ProcInfo_82_82, &DeletedCallCallees0_51);
  mercury__set__union_3_p_0((MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_proc_id_0), CurDeletedCallCallees_50, DeletedCallCallees0_51, &DeletedCallCallees_52);
  hlds__hlds_pred__proc_info_set_deleted_call_callees_3_p_0(DeletedCallCallees_52, STATE_VARIABLE_ProcInfo_82_82, STATE_VARIABLE_ProcInfo_58);
  check_hlds__simplify__simplify_info__simplify_info_get_error_specs_2_p_0(Info_30, &STATE_VARIABLE_Specs_84_84);
  STATE_VARIABLE_Specs_85_85 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_error_spec_0), FormatSpecs_19, STATE_VARIABLE_Specs_84_84);
  check_hlds__simplify__simplify_proc__simplify_proc_maybe_warn_attribute_conflict_5_p_0(*STATE_VARIABLE_ModuleInfo_56, PredId_10, *STATE_VARIABLE_ProcInfo_58, STATE_VARIABLE_Specs_85_85, &STATE_VARIABLE_Specs_86_86);
  hlds__hlds_pred__pred_info_get_status_2_p_0(PredInfo0_16, &Status_53);
  IsDefinedHere_54 = hlds__status__pred_status_defined_in_this_module_1_f_0(Status_53);
  switch (IsDefinedHere_54) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 0:
      *STATE_VARIABLE_Specs_59 = (MR_Word) ((MR_Unsigned) 0U);
      break;
    case (MR_Integer) 1:
      *STATE_VARIABLE_Specs_59 = STATE_VARIABLE_Specs_86_86;
      break;
  }
}
  ...
  MR_Word * STATE_VARIABLE_Info_27)
{
  ...
  MR_Word FoundContainsTrace_22;
  MR_Word STATE_VARIABLE_Goal_37_37;
  MR_Word STATE_VARIABLE_Info_48_48;
  MR_Word STATE_VARIABLE_Goal_49_49;
  MR_Word STATE_VARIABLE_Info_50_50;
  MR_Word STATE_VARIABLE_Goal_67_67;
  MR_Word Var_257;
  MR_Word Var_260;
  MR_Word Var_262;
  MR_Word Var_51;

  check_hlds__simplify__simplify_info__simplify_info_get_simplify_tasks_2_p_0(STATE_VARIABLE_Info_0_26, &OriginalSimplifyTasks_14);
  Var_262 = ((((MR_Unsigned) ((MR_hl_field(0, OriginalSimplifyTasks_14, (MR_Integer) 0))) >> 9)) & (MR_Integer) 1);
  Var_260 = ((((MR_Unsigned) ((MR_hl_field(0, OriginalSimplifyTasks_14, (MR_Integer) 0))) >> 7)) & (MR_Integer) 1);
  Var_257 = ((((MR_Unsigned) ((MR_hl_field(0, OriginalSimplifyTasks_14, (MR_Integer) 0))) >> 4)) & (MR_Integer) 1);
  succeeded = (Var_260 == (MR_Integer) 0);
  if (!(succeeded))
  {
    succeeded = (Var_257 == (MR_Integer) 1);
    if (!(succeeded))
      succeeded = (Var_262 == (MR_Integer) 0);
  }
  if (succeeded)
  {
    MR_Word STATE_VARIABLE_SimplifyTasks_34_34;
    MR_Word STATE_VARIABLE_Info_36_36;
    MR_Word STATE_VARIABLE_Info_38_38;
    MR_Word STATE_VARIABLE_Info_41_41;
    MR_Word STATE_VARIABLE_SimplifyTasks_46_46;
    MR_Unsigned packed_word_1 = (MR_Unsigned) ((MR_hl_field(0, OriginalSimplifyTasks_14, (MR_Integer) 0)));
    MR_Unsigned packed_word_2;

    {
      STATE_VARIABLE_SimplifyTasks_34_34 = (MR_Word) MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(0, STATE_VARIABLE_SimplifyTasks_34_34, 0) = (MR_Box) ((((packed_word_1 & (~((MR_Unsigned) 20480U)))) | (((((MR_Unsigned) ((MR_Integer) 1) << 12)) | (((MR_Unsigned) ((MR_Integer) 0) << 14))))));
    }
    check_hlds__simplify__simplify_info__simplify_info_set_simplify_tasks_3_p_0(STATE_VARIABLE_SimplifyTasks_34_34, STATE_VARIABLE_Info_0_26, &STATE_VARIABLE_Info_36_36);
    check_hlds__simplify__simplify_proc__do_simplify_top_level_goal_6_p_0(NestedContext0_8, InstMap0_9, STATE_VARIABLE_Goal_0_24, &STATE_VARIABLE_Goal_37_37, STATE_VARIABLE_Info_36_36, &STATE_VARIABLE_Info_38_38);
    check_hlds__simplify__simplify_info__simplify_info_set_allow_messages_3_p_0((MR_Integer) 0, STATE_VARIABLE_Info_38_38, &STATE_VARIABLE_Info_41_41);
    packed_word_2 = (MR_Unsigned) ((MR_hl_field(0, OriginalSimplifyTasks_14, (MR_Integer) 0)));
    {
      STATE_VARIABLE_SimplifyTasks_46_46 = (MR_Word) MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(0, STATE_VARIABLE_SimplifyTasks_46_46, 0) = (MR_Box) ((((packed_word_2 & (~((MR_Unsigned) 656U)))) | (((((MR_Unsigned) ((MR_Integer) 0) << 4)) | (((((MR_Unsigned) ((MR_Integer) 1) << 7)) | (((MR_Unsigned) ((MR_Integer) 1) << 9))))))));
    }
    check_hlds__simplify__simplify_info__simplify_info_reinit_3_p_0(STATE_VARIABLE_SimplifyTasks_46_46, STATE_VARIABLE_Info_41_41, &STATE_VARIABLE_Info_48_48);
  }
  else
  {
    STATE_VARIABLE_Info_48_48 = STATE_VARIABLE_Info_0_26;
    STATE_VARIABLE_Goal_37_37 = STATE_VARIABLE_Goal_0_24;
  }
  check_hlds__simplify__simplify_proc__do_simplify_top_level_goal_6_p_0(NestedContext0_8, InstMap0_9, STATE_VARIABLE_Goal_37_37, &STATE_VARIABLE_Goal_49_49, STATE_VARIABLE_Info_48_48, &STATE_VARIABLE_Info_50_50);
  check_hlds__simplify__simplify_info__simplify_info_get_switch_arms_to_split_2_p_0(STATE_VARIABLE_Info_50_50, &ToSplitArms_15);
  ...
  if (succeeded)
  {
    ...
    if (succeeded)
    {
      Var_51 = ((MR_Unsigned) ((MR_hl_field(0, OriginalSimplifyTasks_14, (MR_Integer) 0))) & (MR_Integer) 1);
  ...
  if (succeeded)
  {
    ...
    check_hlds__simplify__split_switch_arms__split_switch_arms_in_goal_3_p_0(ToSplitArms_15, STATE_VARIABLE_Goal_49_49, &STATE_VARIABLE_Goal_58_58);
    GoalInfo0_21 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_Goal_58_58, (MR_Integer) 1))));
    check_hlds__simplify__simplify_info__simplify_info_set_rerun_quant_instmap_delta_2_p_0(STATE_VARIABLE_Info_50_50, &STATE_VARIABLE_Info_65_65);
    check_hlds__simplify__simplify_info__simplify_info_set_rerun_det_2_p_0(STATE_VARIABLE_Info_65_65, &STATE_VARIABLE_Info_66_66);
    check_hlds__simplify__simplify_proc__maybe_recompute_fields_after_top_level_goal_6_p_0(GoalInfo0_21, InstMap0_9, STATE_VARIABLE_Goal_58_58, &STATE_VARIABLE_Goal_67_67, STATE_VARIABLE_Info_66_66, STATE_VARIABLE_Info_27);
  }
  else
  {
    *STATE_VARIABLE_Info_27 = STATE_VARIABLE_Info_50_50;
    STATE_VARIABLE_Goal_67_67 = STATE_VARIABLE_Goal_49_49;
  }
  check_hlds__simplify__simplify_info__simplify_info_get_found_contains_trace_2_p_0(*STATE_VARIABLE_Info_27, &FoundContainsTrace_22);
  switch (FoundContainsTrace_22) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 0:
      *STATE_VARIABLE_Goal_25 = STATE_VARIABLE_Goal_67_67;
      break;
    case (MR_Integer) 1:
      {
        MR_Word Var_23;

        check_hlds__simplify__simplify_proc__set_goal_contains_trace_features_in_goal_3_p_0(STATE_VARIABLE_Goal_67_67, STATE_VARIABLE_Goal_25, &Var_23);
      }
      break;
  }
}
  ...
  MR_Word * STATE_VARIABLE_Info_37)
{
    ...
    case (MR_Integer) 1:
      {
        ...
        hlds__quantification__implicitly_quantify_goal_general_9_p_0((MR_Integer) 0, NonLocals_12, &Var_22, STATE_VARIABLE_Goal_0_34, &STATE_VARIABLE_Goal_52_52, STATE_VARIABLE_VarTable_38_38, &STATE_VARIABLE_VarTable_53_53, STATE_VARIABLE_RttiVarMaps_50_50, &STATE_VARIABLE_RttiVarMaps_54_54);
        ...
        check_hlds__simplify__simplify_info__simplify_info_get_inst_varset_2_p_0(STATE_VARIABLE_Info_61_61, &InstVarSet_23);
        check_hlds__recompute_instmap_deltas__recompute_instmap_delta_8_p_0((MR_Integer) 0, STATE_VARIABLE_VarTable_53_53, InstVarSet_23, InstMap0_8, STATE_VARIABLE_Goal_52_52, &STATE_VARIABLE_Goal_64_64, STATE_VARIABLE_ModuleInfo_62_62, &STATE_VARIABLE_ModuleInfo_65_65);
  ...
  check_hlds__simplify__simplify_info__simplify_info_get_rerun_det_2_p_0(STATE_VARIABLE_Info_66_66, &RerunDet_24);
  switch (RerunDet_24) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 0:
      {
    ...
    case (MR_Integer) 1:
      {
        ...
        Detism_25 = hlds__hlds_goal__goal_info_get_determinism_1_f_0(GoalInfo0_7);
        check_hlds__det_analysis__det_get_soln_context_2_p_0(Detism_25, &SolnContext_26);
        check_hlds__simplify__simplify_info__simplify_info_get_module_info_2_p_0(STATE_VARIABLE_Info_66_66, &STATE_VARIABLE_ModuleInfo_73_73);
        check_hlds__simplify__simplify_info__simplify_info_get_var_table_2_p_0(STATE_VARIABLE_Info_66_66, &STATE_VARIABLE_VarTable_74_74);
        check_hlds__simplify__simplify_info__simplify_info_get_rtti_varmaps_2_p_0(STATE_VARIABLE_Info_66_66, &STATE_VARIABLE_RttiVarMaps_75_75);
        check_hlds__simplify__simplify_info__simplify_info_get_pred_proc_id_2_p_0(STATE_VARIABLE_Info_66_66, &PredProcId_28);
        hlds__hlds_module__module_info_pred_proc_info_4_p_0(STATE_VARIABLE_ModuleInfo_73_73, PredProcId_28, &PredInfo_29, &STATE_VARIABLE_ProcInfo_76_76);
        ...
        hlds__hlds_module__module_info_set_pred_proc_info_5_p_0(PredProcId_28, PredInfo_29, STATE_VARIABLE_ProcInfo_78_78, STATE_VARIABLE_ModuleInfo_73_73, &STATE_VARIABLE_ModuleInfo_79_79);
        check_hlds__simplify__simplify_info__simplify_info_set_module_info_3_p_0(STATE_VARIABLE_ModuleInfo_79_79, STATE_VARIABLE_Info_66_66, &STATE_VARIABLE_Info_80_80);
        check_hlds__det_util__det_info_init_6_p_0(STATE_VARIABLE_ModuleInfo_79_79, PredProcId_28, STATE_VARIABLE_VarTable_74_74, (MR_Integer) 0, (MR_Word) ((MR_Unsigned) 0U), &DetInfo0_30);
        check_hlds__det_analysis__det_infer_goal_10_p_0(STATE_VARIABLE_Goal_64_64, STATE_VARIABLE_Goal_35, InstMap0_8, SolnContext_26, (MR_Word) ((MR_Unsigned) 0U), (MR_Word) ((MR_Unsigned) 0U), &Var_31, &Var_32, DetInfo0_30, &DetInfo_33);
        check_hlds__det_util__det_info_get_module_info_2_p_0(DetInfo_33, &STATE_VARIABLE_ModuleInfo_86_86);
        check_hlds__det_util__det_info_get_var_table_2_p_0(DetInfo_33, &STATE_VARIABLE_VarTable_87_87);
        ...
        check_hlds__simplify__simplify_info__simplify_info_set_var_table_3_p_0(STATE_VARIABLE_VarTable_87_87, STATE_VARIABLE_Info_88_88, STATE_VARIABLE_Info_37);
      }
      break;
  }
}
  ...
  MR_Word * STATE_VARIABLE_Info_19)
{
    ...
    case (MR_Integer) 1:
      {
        ...
        hlds__quantification__implicitly_quantify_goal_general_9_p_0((MR_Integer) 0, NonLocals_23, &Var_26, STATE_VARIABLE_Goal_20_20, &STATE_VARIABLE_Goal_52_51, STATE_VARIABLE_VarTable_38_37, &STATE_VARIABLE_VarTable_53_52, STATE_VARIABLE_RttiVarMaps_50_49, &STATE_VARIABLE_RttiVarMaps_54_53);
        ...
        check_hlds__simplify__simplify_info__simplify_info_get_inst_varset_2_p_0(STATE_VARIABLE_Info_61_60, &InstVarSet_27);
        check_hlds__recompute_instmap_deltas__recompute_instmap_delta_8_p_0((MR_Integer) 0, STATE_VARIABLE_VarTable_53_52, InstVarSet_27, InstMap0_8, STATE_VARIABLE_Goal_52_51, &STATE_VARIABLE_Goal_64_63, STATE_VARIABLE_ModuleInfo_62_61, &STATE_VARIABLE_ModuleInfo_65_64);
  ...
  check_hlds__simplify__simplify_info__simplify_info_get_rerun_det_2_p_0(STATE_VARIABLE_Info_66_65, &RerunDet_28);
  switch (RerunDet_28) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 0:
      {
    ...
    case (MR_Integer) 1:
      {
        ...
        Detism_29 = hlds__hlds_goal__goal_info_get_determinism_1_f_0(GoalInfo0_12);
        check_hlds__det_analysis__det_get_soln_context_2_p_0(Detism_29, &SolnContext_30);
        check_hlds__simplify__simplify_info__simplify_info_get_module_info_2_p_0(STATE_VARIABLE_Info_66_65, &STATE_VARIABLE_ModuleInfo_73_72);
        check_hlds__simplify__simplify_info__simplify_info_get_var_table_2_p_0(STATE_VARIABLE_Info_66_65, &STATE_VARIABLE_VarTable_74_73);
        check_hlds__simplify__simplify_info__simplify_info_get_rtti_varmaps_2_p_0(STATE_VARIABLE_Info_66_65, &STATE_VARIABLE_RttiVarMaps_75_74);
        check_hlds__simplify__simplify_info__simplify_info_get_pred_proc_id_2_p_0(STATE_VARIABLE_Info_66_65, &PredProcId_31);
        hlds__hlds_module__module_info_pred_proc_info_4_p_0(STATE_VARIABLE_ModuleInfo_73_72, PredProcId_31, &PredInfo_32, &STATE_VARIABLE_ProcInfo_76_75);
        ...
        hlds__hlds_module__module_info_set_pred_proc_info_5_p_0(PredProcId_31, PredInfo_32, STATE_VARIABLE_ProcInfo_78_77, STATE_VARIABLE_ModuleInfo_73_72, &STATE_VARIABLE_ModuleInfo_79_78);
        check_hlds__simplify__simplify_info__simplify_info_set_module_info_3_p_0(STATE_VARIABLE_ModuleInfo_79_78, STATE_VARIABLE_Info_66_65, &STATE_VARIABLE_Info_80_79);
        check_hlds__det_util__det_info_init_6_p_0(STATE_VARIABLE_ModuleInfo_79_78, PredProcId_31, STATE_VARIABLE_VarTable_74_73, (MR_Integer) 0, (MR_Word) ((MR_Unsigned) 0U), &DetInfo0_33);
        check_hlds__det_analysis__det_infer_goal_10_p_0(STATE_VARIABLE_Goal_64_63, STATE_VARIABLE_Goal_17, InstMap0_8, SolnContext_30, (MR_Word) ((MR_Unsigned) 0U), (MR_Word) ((MR_Unsigned) 0U), &Var_34, &Var_35, DetInfo0_33, &DetInfo_36);
        check_hlds__det_util__det_info_get_module_info_2_p_0(DetInfo_36, &STATE_VARIABLE_ModuleInfo_86_84);
        check_hlds__det_util__det_info_get_var_table_2_p_0(DetInfo_36, &STATE_VARIABLE_VarTable_87_85);
  ...
  MR_Word * STATE_VARIABLE_SimplifyTasks_19)
{
  ...
  libs__globals__lookup_string_option_3_p_0(Globals_10, (MR_Integer) 217, &CommonStructPreds_11);
