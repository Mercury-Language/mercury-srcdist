...
static /* final */ const MR_Box check_hlds__simplify__simplify_proc_scalar_common_1[23][2];
...
static /* final */ const MR_Box check_hlds__simplify__simplify_proc_scalar_common_1[23][2] = {
  ...
  {
    ((MR_Box) (MR_Word) ((MR_Unsigned) 6U)),
    ((MR_Box) ((MR_String) "on the foreign_proc contradicts the"))
  },
  /* row  13 */
  {
          ...
          case (MR_Integer) 0:
            {
              ...
              if (succeeded)
              {
                ...
                Var_40 = parse_tree__error_spec__color_as_possible_cause_1_f_0((MR_Word) (MR_mkword(1, &check_hlds__simplify__simplify_proc_scalar_common_1[5])));
                Var_47 = parse_tree__error_spec__color_as_possible_cause_1_f_0((MR_Word) (MR_mkword(1, &check_hlds__simplify__simplify_proc_scalar_common_1[9])));
                Var_46 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), Var_47, (MR_Word) (MR_mkword(1, &check_hlds__simplify__simplify_proc_scalar_common_1[16])));
          ...
          case (MR_Integer) 1:
            {
              ...
              if (succeeded)
              {
                ...
                Var_59 = parse_tree__error_spec__color_as_possible_cause_1_f_0((MR_Word) (MR_mkword(1, &check_hlds__simplify__simplify_proc_scalar_common_1[18])));
                Var_66 = parse_tree__error_spec__color_as_possible_cause_1_f_0((MR_Word) (MR_mkword(1, &check_hlds__simplify__simplify_proc_scalar_common_1[20])));
                Var_65 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), Var_66, (MR_Word) (MR_mkword(1, &check_hlds__simplify__simplify_proc_scalar_common_1[16])));
                Var_60 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), (MR_Word) (MR_mkword(1, &check_hlds__simplify__simplify_proc_scalar_common_1[13])), Var_65);
                Var_58 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), Var_59, Var_60);
                Pieces_74 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), (MR_Word) (MR_mkword(1, &check_hlds__simplify__simplify_proc_scalar_common_1[11])), Var_58);
                {
                  Spec_75 = (MR_Word) MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL);
                  MR_hl_field(0, Spec_75, 0) = ((MR_Box) ((MR_String) "predicate \140check_hlds.simplify.simplify_proc.maybe_warn_about_may_duplicate_attributes\'/5"));
                  MR_hl_field(0, Spec_75, 1) = ((MR_Box) ((MR_Unsigned) 0U));
                  MR_hl_field(0, Spec_75, 2) = ((MR_Box) (MR_mkword(3, &check_hlds__simplify__simplify_proc_scalar_common_3[1])));
                  MR_hl_field(0, Spec_75, 3) = ((MR_Box) (Context_22));
                  MR_hl_field(0, Spec_75, 4) = ((MR_Box) (Pieces_74));
                }
                {
                  STATE_VARIABLE_Specs_29_29 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                  MR_hl_field(1, STATE_VARIABLE_Specs_29_29, 0) = ((MR_Box) (Spec_75));
                  MR_hl_field(1, STATE_VARIABLE_Specs_29_29, 1) = ((MR_Box) (STATE_VARIABLE_Specs_0_27));
                }
              }
              else
          ...
          case (MR_Integer) 0:
            {
              ...
              if (succeeded)
              {
                ...
                Var_88 = parse_tree__error_spec__color_as_possible_cause_1_f_0((MR_Word) (MR_mkword(1, &check_hlds__simplify__simplify_proc_scalar_common_1[22])));
                Var_95 = parse_tree__error_spec__color_as_possible_cause_1_f_0((MR_Word) (MR_mkword(1, &check_hlds__simplify__simplify_proc_scalar_common_1[9])));
                Var_94 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), Var_95, (MR_Word) (MR_mkword(1, &check_hlds__simplify__simplify_proc_scalar_common_1[16])));
                Var_89 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), (MR_Word) (MR_mkword(1, &check_hlds__simplify__simplify_proc_scalar_common_1[13])), Var_94);
                ...
                Pieces_80 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), (MR_Word) (MR_mkword(1, &check_hlds__simplify__simplify_proc_scalar_common_1[11])), Var_87);
                {
                  Spec_81 = (MR_Word) MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL);
                  MR_hl_field(0, Spec_81, 0) = ((MR_Box) ((MR_String) "predicate \140check_hlds.simplify.simplify_proc.maybe_warn_about_may_export_body_attribute\'/5"));
                  MR_hl_field(0, Spec_81, 1) = ((MR_Box) ((MR_Unsigned) 0U));
                  MR_hl_field(0, Spec_81, 2) = ((MR_Box) (MR_mkword(3, &check_hlds__simplify__simplify_proc_scalar_common_3[1])));
  ...
  MR_Word * STATE_VARIABLE_SimplifyTasks_19)
{
  ...
  libs__globals__lookup_string_option_3_p_0(Globals_10, (MR_Integer) 227, &CommonStructPreds_11);
