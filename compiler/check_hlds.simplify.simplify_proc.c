  ...
  MR_Box * wrapper_arg_4)
{
  ...
  check_hlds__simplify__simplify_proc__IntroducedFrom__pred__simplify_proc_return_msgs__305__1_4_p_0(((MR_Word) (wrapper_arg_1)), ((MR_String) (wrapper_arg_2)), ((MR_Word) (wrapper_arg_3)), &conv0_LambdaHeadVar__4_75);
  ...
  MR_Word * STATE_VARIABLE_Specs_59)
{
  ...
  hlds__hlds_proc_util__proc_info_get_initial_instmap_3_p_0(STATE_VARIABLE_ModuleInfo_66_66, STATE_VARIABLE_ProcInfo_67_67, &InstMap0_27);
          ...
          case (MR_Integer) 0:
            {
              ...
              if (succeeded)
              {
...

                {
                  ...
                  MR_hl_field(1, Spec_31, 2) = ((MR_Box) (MR_mkword(3, &check_hlds__simplify__simplify_proc_scalar_common_3[1])));
          ...
          case (MR_Integer) 1:
            {
              ...
              if (succeeded)
              {
...

                {
                  ...
                  MR_hl_field(1, Spec_43, 2) = ((MR_Box) (MR_mkword(3, &check_hlds__simplify__simplify_proc_scalar_common_3[1])));
          ...
          case (MR_Integer) 0:
            {
              ...
              if (succeeded)
              {
...

                {
                  ...
                  MR_hl_field(1, Spec_45, 2) = ((MR_Box) (MR_mkword(3, &check_hlds__simplify__simplify_proc_scalar_common_3[1])));
  ...
  MR_Word * STATE_VARIABLE_SimplifyTasks_19)
{
  ...
  libs__globals__lookup_string_option_3_p_0(Globals_10, (MR_Integer) 219, &CommonStructPreds_11);
