...
{
  {
    ...
    if (succeeded)
    {
      packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), SimplifyTasks_15, (MR_Integer) 0)));
...
{
  {
    ...
    if (succeeded)
    {
      ...
      MR_Word Var_81;
      MR_Word Var_82;
      MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), OriginalSimplifyTasks_12, (MR_Integer) 0)));
      ...
      packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), OriginalSimplifyTasks_12, (MR_Integer) 0)));
...
{
  {
    ...
    if (succeeded)
    {
      ...
      MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_SimplifyTasks_0_17, (MR_Integer) 0)));
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        else
        {
          ...
          MR_Unsigned packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_SimplifyTasks_20_20, (MR_Integer) 0)));
