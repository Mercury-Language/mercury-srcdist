  ...
  MR_Word * STATE_VARIABLE_Specs_9)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      MR_Word ProcTable0_37;
      MR_Word ProcInfo0_38;
      MR_Word ProcInfo_39;
      MR_Word ProcSpecs_40;
      MR_Word HasParallelConj_41;
      MR_Word HasUserEvent_42;
      MR_Word ProcTable_43;
      MR_Word STATE_VARIABLE_ModuleInfo_29_44;
      MR_Word STATE_VARIABLE_ModuleInfo_30_45;
      ...
      hlds__hlds_pred__pred_info_get_proc_table_2_p_0(STATE_VARIABLE_PredInfo_0_6, &ProcTable0_37);
      mercury__map__lookup_3_p_0((MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_proc_id_0), (MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_proc_info_0), ProcTable0_37, ((MR_Box) (ProcId_23)), &conv0_ProcInfo0_38);
      ProcInfo0_38 = ((MR_Word) (conv0_ProcInfo0_38));
      check_hlds__simplify__simplify_proc__simplify_proc_return_msgs_8_p_0(SimplifyTasks_1, PredId_2, ProcId_23, STATE_VARIABLE_ModuleInfo_0_4, &STATE_VARIABLE_ModuleInfo_29_44, ProcInfo0_38, &ProcInfo_39, &ProcSpecs_40);
      hlds__hlds_pred__proc_info_get_has_parallel_conj_2_p_0(ProcInfo_39, &HasParallelConj_41);
      switch (HasParallelConj_41) {
        default: /*NOTREACHED*/ MR_assert(0);
        case (MR_Integer) 1:
          STATE_VARIABLE_ModuleInfo_30_45 = STATE_VARIABLE_ModuleInfo_29_44;
          break;
        case (MR_Integer) 0:
          hlds__hlds_module__module_info_set_has_parallel_conj_2_p_0(STATE_VARIABLE_ModuleInfo_29_44, &STATE_VARIABLE_ModuleInfo_30_45);
          break;
      }
      hlds__hlds_pred__proc_info_get_has_user_event_2_p_0(ProcInfo_39, &HasUserEvent_42);
      switch (HasUserEvent_42) {
        default: /*NOTREACHED*/ MR_assert(0);
        case (MR_Integer) 1:
          STATE_VARIABLE_ModuleInfo_34_34 = STATE_VARIABLE_ModuleInfo_30_45;
          break;
        case (MR_Integer) 0:
          hlds__hlds_module__module_info_set_has_user_event_2_p_0(STATE_VARIABLE_ModuleInfo_30_45, &STATE_VARIABLE_ModuleInfo_34_34);
          break;
      }
      mercury__map__det_update_4_p_0((MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_proc_id_0), (MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_proc_info_0), ((MR_Box) (ProcId_23)), ((MR_Box) (ProcInfo_39)), ProcTable0_37, &ProcTable_43);
      hlds__hlds_pred__pred_info_set_proc_table_3_p_0(ProcTable_43, STATE_VARIABLE_PredInfo_0_6, &STATE_VARIABLE_PredInfo_35_35);
      parse_tree__error_util__accumulate_error_specs_for_proc_3_p_0(ProcSpecs_40, STATE_VARIABLE_Specs_0_8, &STATE_VARIABLE_Specs_36_36);
  ...
  MR_Word * STATE_VARIABLE_Specs_53)
{
  ...
  {
    MR_Word Goal0_144;
    MR_Word GoalExpr0_145;
    MR_Word GoalInfo0_146;

    hlds__hlds_pred__proc_info_get_goal_2_p_0(STATE_VARIABLE_ProcInfo_0_51, &Goal0_144);
    GoalExpr0_145 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Goal0_144, (MR_Integer) 0))));
    GoalInfo0_146 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Goal0_144, (MR_Integer) 1))));
    if (((((MR_tag((MR_Word) GoalExpr0_145)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(MR_mktag(3), GoalExpr0_145, (MR_Integer) 0)))) == (MR_Integer) 3))))
      succeeded = MR_TRUE;
    else
    if (((((MR_tag((MR_Word) GoalExpr0_145)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(MR_mktag(3), GoalExpr0_145, (MR_Integer) 0)))) == (MR_Integer) 4))))
      succeeded = MR_TRUE;
    else
      succeeded = MR_FALSE;
    if (succeeded)
    {
      ...
      hlds__hlds_goal__goal_info_add_feature_3_p_0((MR_Integer) 17, GoalInfo0_146, &GoalInfo_151);
      {
        Goal_152 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), Goal_152, 0) = ((MR_Box) (GoalExpr0_145));
        MR_hl_field(MR_mktag(0), Goal_152, 1) = ((MR_Box) (GoalInfo_151));
      }
      hlds__hlds_pred__proc_info_set_goal_3_p_0(Goal_152, STATE_VARIABLE_ProcInfo_0_51, &STATE_VARIABLE_ProcInfo_55_55);
    }
    else
  ...
  parse_tree__vartypes__delete_sorted_var_types_3_p_0(ElimVars_35, VarTypes0_31, &VarTypes_37);
  ...
  MR_Word * STATE_VARIABLE_Info_19)
{
  ...
  MR_Word RerunDet_26;
  MR_Word STATE_VARIABLE_Goal_46_48;
  MR_Word STATE_VARIABLE_Info_48_50;
  MR_Word _Common_15;
  ...
  switch (RerunQuantDelta_22) {
    ...
    case (MR_Integer) 0:
      {
        STATE_VARIABLE_Goal_46_48 = STATE_VARIABLE_Goal_20_20;
        STATE_VARIABLE_Info_48_50 = STATE_VARIABLE_Info_21_21;
      }
      break;
    case (MR_Integer) 1:
      {
        ...
        MR_Word STATE_VARIABLE_VarSet_33_35;
        MR_Word STATE_VARIABLE_VarTypes_34_36;
        MR_Word STATE_VARIABLE_RttiVarMaps_35_37;
        MR_Word STATE_VARIABLE_Goal_37_39;
        MR_Word STATE_VARIABLE_VarSet_38_40;
        MR_Word STATE_VARIABLE_VarTypes_39_41;
        MR_Word STATE_VARIABLE_RttiVarMaps_40_42;
        MR_Word STATE_VARIABLE_Info_41_43;
        MR_Word STATE_VARIABLE_Info_42_44;
        MR_Word STATE_VARIABLE_Info_43_45;
        MR_Word STATE_VARIABLE_ModuleInfo_44_46;
        MR_Word STATE_VARIABLE_ModuleInfo_47_49;
        MR_Word Var_24;

        NonLocals_23 = hlds__hlds_goal__goal_info_get_nonlocals_1_f_0(GoalInfo0_12);
        check_hlds__simplify__simplify_info__simplify_info_get_varset_2_p_0(STATE_VARIABLE_Info_21_21, &STATE_VARIABLE_VarSet_33_35);
        check_hlds__simplify__simplify_info__simplify_info_get_var_types_2_p_0(STATE_VARIABLE_Info_21_21, &STATE_VARIABLE_VarTypes_34_36);
        check_hlds__simplify__simplify_info__simplify_info_get_rtti_varmaps_2_p_0(STATE_VARIABLE_Info_21_21, &STATE_VARIABLE_RttiVarMaps_35_37);
        hlds__quantification__implicitly_quantify_goal_general_11_p_0((MR_Integer) 0, NonLocals_23, &Var_24, STATE_VARIABLE_Goal_20_20, &STATE_VARIABLE_Goal_37_39, STATE_VARIABLE_VarSet_33_35, &STATE_VARIABLE_VarSet_38_40, STATE_VARIABLE_VarTypes_34_36, &STATE_VARIABLE_VarTypes_39_41, STATE_VARIABLE_RttiVarMaps_35_37, &STATE_VARIABLE_RttiVarMaps_40_42);
        check_hlds__simplify__simplify_info__simplify_info_set_varset_3_p_0(STATE_VARIABLE_VarSet_38_40, STATE_VARIABLE_Info_21_21, &STATE_VARIABLE_Info_41_43);
        check_hlds__simplify__simplify_info__simplify_info_set_var_types_3_p_0(STATE_VARIABLE_VarTypes_39_41, STATE_VARIABLE_Info_41_43, &STATE_VARIABLE_Info_42_44);
        check_hlds__simplify__simplify_info__simplify_info_set_rtti_varmaps_3_p_0(STATE_VARIABLE_RttiVarMaps_40_42, STATE_VARIABLE_Info_42_44, &STATE_VARIABLE_Info_43_45);
        check_hlds__simplify__simplify_info__simplify_info_get_module_info_2_p_0(STATE_VARIABLE_Info_43_45, &STATE_VARIABLE_ModuleInfo_44_46);
        check_hlds__simplify__simplify_info__simplify_info_get_inst_varset_2_p_0(STATE_VARIABLE_Info_43_45, &InstVarSet_25);
        check_hlds__recompute_instmap_deltas__recompute_instmap_delta_8_p_0((MR_Integer) 0, STATE_VARIABLE_VarTypes_39_41, InstVarSet_25, InstMap0_9, STATE_VARIABLE_Goal_37_39, &STATE_VARIABLE_Goal_46_48, STATE_VARIABLE_ModuleInfo_44_46, &STATE_VARIABLE_ModuleInfo_47_49);
        check_hlds__simplify__simplify_info__simplify_info_set_module_info_3_p_0(STATE_VARIABLE_ModuleInfo_47_49, STATE_VARIABLE_Info_43_45, &STATE_VARIABLE_Info_48_50);
      }
      break;
  }
  check_hlds__simplify__simplify_info__simplify_info_get_rerun_det_2_p_0(STATE_VARIABLE_Info_48_50, &RerunDet_26);
  switch (RerunDet_26) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 0:
      {
        *STATE_VARIABLE_Goal_17 = STATE_VARIABLE_Goal_46_48;
        *STATE_VARIABLE_Info_19 = STATE_VARIABLE_Info_48_50;
      }
      break;
    case (MR_Integer) 1:
      {
        ...
        MR_Word DetInfo0_31;
        MR_Word DetInfo_34;
        MR_Word STATE_VARIABLE_ModuleInfo_49_51;
        MR_Word STATE_VARIABLE_VarSet_50_52;
        MR_Word STATE_VARIABLE_VarTypes_51_53;
        MR_Word STATE_VARIABLE_RttiVarMaps_52_54;
        MR_Word STATE_VARIABLE_ProcInfo_53_55;
        MR_Word STATE_VARIABLE_ProcInfo_54_56;
        MR_Word STATE_VARIABLE_ProcInfo_55_57;
        MR_Word STATE_VARIABLE_ModuleInfo_56_58;
        MR_Word STATE_VARIABLE_Info_57_59;
        MR_Word STATE_VARIABLE_ModuleInfo_63_64;
        MR_Word STATE_VARIABLE_VarTypes_64_65;
        MR_Word STATE_VARIABLE_Info_65_66;
        MR_Word Var_32;
        MR_Word Var_33;
        ...
        check_hlds__simplify__simplify_info__simplify_info_get_module_info_2_p_0(STATE_VARIABLE_Info_48_50, &STATE_VARIABLE_ModuleInfo_49_51);
        check_hlds__simplify__simplify_info__simplify_info_get_varset_2_p_0(STATE_VARIABLE_Info_48_50, &STATE_VARIABLE_VarSet_50_52);
        check_hlds__simplify__simplify_info__simplify_info_get_var_types_2_p_0(STATE_VARIABLE_Info_48_50, &STATE_VARIABLE_VarTypes_51_53);
        check_hlds__simplify__simplify_info__simplify_info_get_rtti_varmaps_2_p_0(STATE_VARIABLE_Info_48_50, &STATE_VARIABLE_RttiVarMaps_52_54);
        check_hlds__simplify__simplify_info__simplify_info_get_pred_proc_id_2_p_0(STATE_VARIABLE_Info_48_50, &PredProcId_29);
        hlds__hlds_module__module_info_pred_proc_info_4_p_0(STATE_VARIABLE_ModuleInfo_49_51, PredProcId_29, &PredInfo_30, &STATE_VARIABLE_ProcInfo_53_55);
        hlds__hlds_pred__proc_info_set_varset_vartypes_4_p_0(STATE_VARIABLE_VarSet_50_52, STATE_VARIABLE_VarTypes_51_53, STATE_VARIABLE_ProcInfo_53_55, &STATE_VARIABLE_ProcInfo_54_56);
        hlds__hlds_pred__proc_info_set_rtti_varmaps_3_p_0(STATE_VARIABLE_RttiVarMaps_52_54, STATE_VARIABLE_ProcInfo_54_56, &STATE_VARIABLE_ProcInfo_55_57);
        hlds__hlds_module__module_info_set_pred_proc_info_5_p_0(PredProcId_29, PredInfo_30, STATE_VARIABLE_ProcInfo_55_57, STATE_VARIABLE_ModuleInfo_49_51, &STATE_VARIABLE_ModuleInfo_56_58);
        check_hlds__simplify__simplify_info__simplify_info_set_module_info_3_p_0(STATE_VARIABLE_ModuleInfo_56_58, STATE_VARIABLE_Info_48_50, &STATE_VARIABLE_Info_57_59);
        check_hlds__det_util__det_info_init_7_p_0(STATE_VARIABLE_ModuleInfo_56_58, PredProcId_29, STATE_VARIABLE_VarSet_50_52, STATE_VARIABLE_VarTypes_51_53, (MR_Integer) 0, (MR_Word) ((MR_Unsigned) 0U), &DetInfo0_31);
        check_hlds__det_analysis__det_infer_goal_10_p_0(STATE_VARIABLE_Goal_46_48, STATE_VARIABLE_Goal_17, InstMap0_9, SolnContext_28, (MR_Word) ((MR_Unsigned) 0U), (MR_Word) ((MR_Unsigned) 0U), &Var_32, &Var_33, DetInfo0_31, &DetInfo_34);
        check_hlds__det_util__det_info_get_module_info_2_p_0(DetInfo_34, &STATE_VARIABLE_ModuleInfo_63_64);
        check_hlds__det_util__det_info_get_vartypes_2_p_0(DetInfo_34, &STATE_VARIABLE_VarTypes_64_65);
        check_hlds__simplify__simplify_info__simplify_info_set_module_info_3_p_0(STATE_VARIABLE_ModuleInfo_63_64, STATE_VARIABLE_Info_57_59, &STATE_VARIABLE_Info_65_66);
        check_hlds__simplify__simplify_info__simplify_info_set_var_types_3_p_0(STATE_VARIABLE_VarTypes_64_65, STATE_VARIABLE_Info_65_66, STATE_VARIABLE_Info_19);
      }
      break;
  }
}
          ...
          case (MR_Integer) 0:
            {
              ...
              if (succeeded)
              {
...

                {
                  ...
                  MR_hl_field(MR_mktag(1), Spec_31, 0) = ((MR_Box) ((MR_String) "predicate \140check_hlds.simplify.simplify_proc.maybe_warn_about_may_duplicate_attributes\'/5"));
                  MR_hl_field(MR_mktag(1), Spec_31, 1) = ((MR_Box) ((MR_Unsigned) 0U));
                  MR_hl_field(MR_mktag(1), Spec_31, 2) = ((MR_Box) (MR_mkword(MR_mktag(2), &check_hlds__simplify__simplify_proc_scalar_common_3[1])));
                  MR_hl_field(MR_mktag(1), Spec_31, 3) = ((MR_Box) (Context_22));
                  MR_hl_field(MR_mktag(1), Spec_31, 4) = ((MR_Box) (MR_mkword(MR_mktag(1), &check_hlds__simplify__simplify_proc_scalar_common_1[12])));
                }
                {
                  STATE_VARIABLE_Specs_29_29 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                  MR_hl_field(MR_mktag(1), STATE_VARIABLE_Specs_29_29, 0) = ((MR_Box) (Spec_31));
          ...
          case (MR_Integer) 1:
            {
              ...
              if (succeeded)
              {
...

                {
                  ...
                  MR_hl_field(MR_mktag(1), Spec_43, 0) = ((MR_Box) ((MR_String) "predicate \140check_hlds.simplify.simplify_proc.maybe_warn_about_may_duplicate_attributes\'/5"));
                  MR_hl_field(MR_mktag(1), Spec_43, 1) = ((MR_Box) ((MR_Unsigned) 0U));
                  MR_hl_field(MR_mktag(1), Spec_43, 2) = ((MR_Box) (MR_mkword(MR_mktag(2), &check_hlds__simplify__simplify_proc_scalar_common_3[1])));
                  MR_hl_field(MR_mktag(1), Spec_43, 3) = ((MR_Box) (Context_22));
                  MR_hl_field(MR_mktag(1), Spec_43, 4) = ((MR_Box) (MR_mkword(MR_mktag(1), &check_hlds__simplify__simplify_proc_scalar_common_1[18])));
                }
                {
                  STATE_VARIABLE_Specs_29_29 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                  MR_hl_field(MR_mktag(1), STATE_VARIABLE_Specs_29_29, 0) = ((MR_Box) (Spec_43));
                  MR_hl_field(MR_mktag(1), STATE_VARIABLE_Specs_29_29, 1) = ((MR_Box) (STATE_VARIABLE_Specs_0_27));
                }
              }
              else
          ...
          case (MR_Integer) 0:
            {
              ...
              if (succeeded)
              {
...

                {
                  ...
                  MR_hl_field(MR_mktag(1), Spec_45, 0) = ((MR_Box) ((MR_String) "predicate \140check_hlds.simplify.simplify_proc.maybe_warn_about_may_export_body_attribute\'/5"));
                  MR_hl_field(MR_mktag(1), Spec_45, 1) = ((MR_Box) ((MR_Unsigned) 0U));
                  MR_hl_field(MR_mktag(1), Spec_45, 2) = ((MR_Box) (MR_mkword(MR_mktag(2), &check_hlds__simplify__simplify_proc_scalar_common_3[1])));
                  MR_hl_field(MR_mktag(1), Spec_45, 3) = ((MR_Box) (Context_22));
                  MR_hl_field(MR_mktag(1), Spec_45, 4) = ((MR_Box) (MR_mkword(MR_mktag(1), &check_hlds__simplify__simplify_proc_scalar_common_1[21])));
                }
                {
                  MR_Word base;
                  base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
  ...
  MR_Word * STATE_VARIABLE_SimplifyTasks_20)
{
  ...
  parse_tree__vartypes__vartypes_count_2_p_0(VarTypes0_17, &NumVars_18);
