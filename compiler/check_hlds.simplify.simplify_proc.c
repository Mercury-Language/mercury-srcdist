...
static MR_bool MR_CALL 
check_hlds__simplify__simplify_proc__had_some_unknown_format_calls_1_p_0(
  MR_Word HeadVar__1_1);
  ...
  MR_Word * FormatSpecs_18)
{
  ...
  succeeded = check_hlds__simplify__simplify_proc__had_some_unknown_format_calls_1_p_0(FormatSpecs1_22);
  if (succeeded)
  {
  ...
  if (succeeded)
  {
    ...
    hlds__hlds_pred__proc_info_set_goal_3_p_0(Goal1_24, STATE_VARIABLE_ProcInfo_0_35, &STATE_VARIABLE_ProcInfo_1_37);
    hlds__hlds_pred__proc_info_set_var_table_3_p_0(VarTable1_23, STATE_VARIABLE_ProcInfo_1_37, &STATE_VARIABLE_ProcInfo_2_38);
    hlds__quantification__requantify_proc_general_3_p_0((MR_Integer) 0, STATE_VARIABLE_ProcInfo_2_38, &STATE_VARIABLE_ProcInfo_3_40);
    check_hlds__recompute_instmap_deltas__recompute_instmap_delta_proc_5_p_0((MR_Integer) 1, STATE_VARIABLE_ProcInfo_3_40, &STATE_VARIABLE_ProcInfo_4_42, STATE_VARIABLE_ModuleInfo_0_33, &STATE_VARIABLE_ModuleInfo_1_43);
    hlds__hlds_pred__pred_info_set_proc_info_4_p_0(ProcId_16, STATE_VARIABLE_ProcInfo_4_42, PredInfo0_15, &PredInfo1_25);
    check_hlds__simplify__opt_format_call__analyze_and_optimize_format_calls_10_p_0(ProgressStream_11, ImplicitStreamWarnings_12, STATE_VARIABLE_ModuleInfo_1_43, PredInfo1_25, STATE_VARIABLE_ProcInfo_4_42, Goal1_24, &MaybeGoal_26, FormatSpecs_18, VarTable0_20, &VarTable_27);
  }
  else
  {
    ...
    *FormatSpecs_18 = FormatSpecs1_22;
    ...
    STATE_VARIABLE_ProcInfo_4_42 = STATE_VARIABLE_ProcInfo_0_35;
    STATE_VARIABLE_ModuleInfo_1_43 = STATE_VARIABLE_ModuleInfo_0_33;
  }
  if ((MaybeGoal_26 == (MR_Word) ((MR_Unsigned) 0U)))
  {
    *STATE_VARIABLE_ModuleInfo_34 = STATE_VARIABLE_ModuleInfo_1_43;
    *STATE_VARIABLE_ProcInfo_36 = STATE_VARIABLE_ProcInfo_4_42;
  }
  else
  {
    ...
    MR_Word Markers_31;
    MR_Word PredInfo_32;
    MR_Word STATE_VARIABLE_ProcInfo_5_44;
    MR_Word STATE_VARIABLE_ProcInfo_6_45;
    MR_Word STATE_VARIABLE_ProcInfo_7_47;
    MR_Word STATE_VARIABLE_ModuleInfo_2_50;

    hlds__hlds_pred__proc_info_set_goal_3_p_0(Goal_28, STATE_VARIABLE_ProcInfo_4_42, &STATE_VARIABLE_ProcInfo_5_44);
    hlds__hlds_pred__proc_info_set_var_table_3_p_0(VarTable_27, STATE_VARIABLE_ProcInfo_5_44, &STATE_VARIABLE_ProcInfo_6_45);
    hlds__quantification__requantify_proc_general_3_p_0((MR_Integer) 0, STATE_VARIABLE_ProcInfo_6_45, &STATE_VARIABLE_ProcInfo_7_47);
    check_hlds__recompute_instmap_deltas__recompute_instmap_delta_proc_5_p_0((MR_Integer) 1, STATE_VARIABLE_ProcInfo_7_47, STATE_VARIABLE_ProcInfo_36, STATE_VARIABLE_ModuleInfo_1_43, &STATE_VARIABLE_ModuleInfo_2_50);
    ...
    hlds__hlds_module__module_info_set_pred_info_4_p_0(PredId_14, PredInfo_32, STATE_VARIABLE_ModuleInfo_2_50, STATE_VARIABLE_ModuleInfo_34);
  }
}
  ...
  MR_Word HeadVar__1_1)
{
  while (MR_TRUE)
  {
    ...
    if (succeeded)
    {
      Spec_2 = ((MR_Word) ((MR_hl_field(1, HeadVar__1_1, 0))));
      Specs_3 = ((MR_Word) ((MR_hl_field(1, HeadVar__1_1, 1))));
      switch (MR_tag((MR_Word) Spec_2)) {
        default: /*NOTREACHED*/ MR_assert(0);
        case (MR_Integer) 0:
          {
            MR_Word Severity_5 = ((MR_Word) ((MR_hl_field(0, Spec_2, 1))));
            MR_Word Var_17;

            succeeded = ((MR_tag((MR_Word) Severity_5)) == (MR_Integer) 2);
            if (succeeded)
            {
              Var_17 = ((MR_Unsigned) ((MR_hl_field(2, Severity_5, 0))) & (MR_Integer) 1023);
              succeeded = (Var_17 == (MR_Integer) 234);
            }
            if (succeeded)
              succeeded = MR_TRUE;
            else
            {
              MR_Word next_value_of_HeadVar__1_1 = Specs_3;
        ...
        case (MR_Integer) 2:
          {
            mercury__require__unexpected_2_p_0((MR_String) "predicate \140check_hlds.simplify.simplify_proc.had_some_unknown_format_calls\'/1", (MR_String) "unexpected form of error_spec");
            succeeded = MR_TRUE;
          }
          break;
      }
