...
{
  {
    ...
    check_hlds__simplify__simplify_proc__simplify_proc_maybe_warn_about_duplicates_5_p_0(*STATE_VARIABLE_ModuleInfo_50, PredId_10, *STATE_VARIABLE_ProcInfo_52, STATE_VARIABLE_Specs_76_76, &STATE_VARIABLE_Specs_77_77);
