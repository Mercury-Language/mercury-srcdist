  ...
  MR_Word * STATE_VARIABLE_ProcInfo_28)
{
  ...
  hlds__hlds_pred__proc_info_get_var_table_2_p_0(STATE_VARIABLE_ProcInfo_0_27, &VarTable0_16);
  ...
  else
  {
    ...
    hlds__hlds_pred__remove_marker_3_p_0((MR_Integer) 27, Markers1_22, &Markers_23);
  ...
  MR_Word * STATE_VARIABLE_SimplifyTasks_19)
{
  ...
  libs__globals__lookup_string_option_3_p_0(Globals_10, (MR_Integer) 212, &CommonStructPreds_11);
