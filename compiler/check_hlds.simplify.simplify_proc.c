  ...
  MR_Word * STATE_VARIABLE_Specs_58)
{
  ...
  if (succeeded)
  {
    ...
    GoalExpr0_154 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Goal0_153, (MR_Integer) 0))));
    GoalInfo0_155 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Goal0_153, (MR_Integer) 1))));
    if (((((MR_tag((MR_Word) GoalExpr0_154)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(MR_mktag(3), GoalExpr0_154, (MR_Integer) 0)))) == (MR_Integer) 3))))
      succeeded = MR_TRUE;
    else
    if (((((MR_tag((MR_Word) GoalExpr0_154)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(MR_mktag(3), GoalExpr0_154, (MR_Integer) 0)))) == (MR_Integer) 4))))
      succeeded = MR_TRUE;
    else
      succeeded = MR_FALSE;
    if (succeeded)
    {
      ...
      hlds__hlds_goal__goal_info_add_feature_3_p_0((MR_Integer) 17, GoalInfo0_155, &GoalInfo_160);
      {
        ...
        MR_hl_field(MR_mktag(0), Goal_161, 0) = ((MR_Box) (GoalExpr0_154));
        MR_hl_field(MR_mktag(0), Goal_161, 1) = ((MR_Box) (GoalInfo_160));
      }
    ...
    case (MR_Integer) 1:
      {
        ...
        hlds__quantification__implicitly_quantify_goal_general_vt_9_p_0((MR_Integer) 0, NonLocals_23, &Var_24, STATE_VARIABLE_Goal_20_20, &STATE_VARIABLE_Goal_35_38, STATE_VARIABLE_VarTable_32_35, &STATE_VARIABLE_VarTable_36_39, STATE_VARIABLE_RttiVarMaps_33_36, &STATE_VARIABLE_RttiVarMaps_37_40);
        ...
        check_hlds__recompute_instmap_deltas__recompute_instmap_delta_vt_8_p_0((MR_Integer) 0, STATE_VARIABLE_VarTable_36_39, InstVarSet_25, InstMap0_9, STATE_VARIABLE_Goal_35_38, &STATE_VARIABLE_Goal_42_45, STATE_VARIABLE_ModuleInfo_40_43, &STATE_VARIABLE_ModuleInfo_43_46);
          ...
          case (MR_Integer) 0:
            {
              ...
              if (succeeded)
              {
...

                {
                  ...
                  MR_hl_field(MR_mktag(1), Spec_31, 4) = ((MR_Box) (MR_mkword(MR_mktag(1), &check_hlds__simplify__simplify_proc_scalar_common_1[11])));
                }
                {
          ...
          case (MR_Integer) 1:
            {
              ...
              if (succeeded)
              {
...

                {
                  ...
                  MR_hl_field(MR_mktag(1), Spec_43, 4) = ((MR_Box) (MR_mkword(MR_mktag(1), &check_hlds__simplify__simplify_proc_scalar_common_1[17])));
                }
                {
                  STATE_VARIABLE_Specs_29_29 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          ...
          case (MR_Integer) 0:
            {
              ...
              if (succeeded)
              {
...

                {
                  ...
                  MR_hl_field(MR_mktag(1), Spec_45, 4) = ((MR_Box) (MR_mkword(MR_mktag(1), &check_hlds__simplify__simplify_proc_scalar_common_1[20])));
                }
                {
                  MR_Word base;
                  base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
