...
check_hlds__simplify__simplify_proc__IntroducedFrom__pred__simplify_proc_return_msgs__286__1_4_p_0(
  MR_Word HeadVar__1_124,
  MR_String HeadVar__2_125,
...
{
  {
    mercury__varset__name_var_4_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), HeadVar__1_124, HeadVar__2_125, HeadVar__3_126, HeadVar__4_127);
  }
}
...
{
  {
    ...
    MR_Word conv0_HeadVar__4_127;

    check_hlds__simplify__simplify_proc__IntroducedFrom__pred__simplify_proc_return_msgs__286__1_4_p_0(((MR_Word) (wrapper_arg_1)), ((MR_String) (wrapper_arg_2)), ((MR_Word) (wrapper_arg_3)), &conv0_HeadVar__4_127);
    *wrapper_arg_4 = ((MR_Box) (conv0_HeadVar__4_127));
  }
}
...
{
  {
    ...
    if (succeeded)
    {
      Var_78 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), SimplifyTasks_15, (MR_Integer) 0))) >> 13)) & (MR_Integer) 1);
      Var_55 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), SimplifyTasks_15, (MR_Integer) 0))) >> 12)) & (MR_Integer) 1);
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(0), NestedContext0_25, 2) = ((MR_Box) ((MR_Integer) 0));
    }
...
{
  {
    ...
    if (succeeded)
    {
...

      {
        ...
        MR_hl_field(MR_mktag(0), STATE_VARIABLE_SimplifyTasks_22_22, 0) = (MR_Box) ((((packed_word_0 & (~((MR_Unsigned) 1280U)))) | (((((MR_Unsigned) ((MR_Integer) 0) << 8)) | (((MR_Unsigned) ((MR_Integer) 0) << 10))))));
      }
      ...
      packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), OriginalSimplifyTasks_12, (MR_Integer) 0)));
      {
        ...
        MR_hl_field(MR_mktag(0), STATE_VARIABLE_SimplifyTasks_32_32, 0) = (MR_Box) ((((packed_word_1 & (~((MR_Unsigned) 40U)))) | (((((MR_Unsigned) ((MR_Integer) 0) << 3)) | (((MR_Unsigned) ((MR_Integer) 0) << 5))))));
      }
...
{
  {
    ...
    if (succeeded)
    {
...

      {
        ...
        MR_hl_field(MR_mktag(0), STATE_VARIABLE_SimplifyTasks_20_20, 0) = (MR_Box) ((((packed_word_0 & (~((MR_Unsigned) 8U)))) | (((MR_Unsigned) ((MR_Integer) 0) << 3))));
      }
    }
    else
    ...
    libs__globals__lookup_string_option_3_p_0(Globals_12, (MR_Integer) 371, &CommonStructPreds_13);
        ...
        else
        {
...

          {
            ...
            *STATE_VARIABLE_SimplifyTasks_18 = base;
            MR_hl_field(MR_mktag(0), base, 0) = (MR_Box) ((((packed_word_1 & (~((MR_Unsigned) 8U)))) | (((MR_Unsigned) ((MR_Integer) 0) << 3))));
          }
        }
      }
      else
