...
static void MR_CALL 
check_hlds__simplify__simplify_proc__IntroducedFrom__pred__simplify_proc_return_msgs__327__1_4_p_0(
  ...
  MR_Box * wrapper_arg_4)
{
  ...
  check_hlds__simplify__simplify_proc__IntroducedFrom__pred__simplify_proc_return_msgs__327__1_4_p_0(((MR_Word) (wrapper_arg_1)), ((MR_String) (wrapper_arg_2)), ((MR_Word) (wrapper_arg_3)), &conv0_LambdaHeadVar__4_86);
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_67)
{
  ...
  if (succeeded)
  {
    ...
    check_hlds__simplify__simplify_proc__simplify_proc_analyze_and_format_calls_9_p_0(STATE_VARIABLE_ModuleInfo_0_66, &STATE_VARIABLE_ModuleInfo_1_74, PredId_12, PredInfo0_18, ProcId_13, STATE_VARIABLE_ProcInfo_1_69, &STATE_VARIABLE_ProcInfo_2_75, ImplicitStreamWarnings_20, &FormatSpecs_21);
  }
  else
  {
