  ...
  MR_Word * STATE_VARIABLE_Specs_31)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_79, (MR_Integer) 309, &UnboxedFloats_80);
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_79, (MR_Integer) 310, &UnboxedInt64s_82);
