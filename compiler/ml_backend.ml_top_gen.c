  ...
  MR_Word * Init_6)
{
  ...
  KindStr_9 = hlds__hlds_pred__table_step_stats_kind_1_f_0(Step_8);
  {
    ...
    MR_hl_field(3, Var_10, 0) = ((MR_Box) ((MR_Unsigned) 10U));
  ...
  MR_Word StepDesc_5)
{
  ...
  }
  {
    ...
    MR_hl_field(3, StructType_6, 0) = ((MR_Box) ((MR_Unsigned) 10U));
  ...
  MR_Word Initializer_11)
{
...

  {
    ...
    MR_hl_field(3, MLDS_Type_14, 0) = ((MR_Box) ((MR_Unsigned) 10U));
  ...
  MR_Word * StatsStepDefns_16)
{
  ...
  }
  {
    ...
    MR_hl_field(3, StatsType_19, 0) = ((MR_Box) ((MR_Unsigned) 10U));
  ...
  }
  {
    ...
    MR_hl_field(3, StatsStepsType_20, 0) = ((MR_Box) ((MR_Unsigned) 10U));
  ...
  MR_Word * STATE_VARIABLE_Specs_30)
{
  ...
  MR_Word ForeignDeclCodeUserCord_31;
  MR_Word ForeignDeclCodeAuxCord_32;
  MR_Word ForeignBodyCodeCord_33;
  MR_Word CJCsEFIMs_34;
  ...
  MR_Word Var_46;
  MR_Word Var_47;
  MR_Word AllImports0_56;
  MR_Word ThisModule_57;
  MR_Word AllImports_58;
  MR_Word Var_60;
  MR_Word TableStructMap_63;
  MR_Word TableStructs_64;
  MR_Word Globals_78;
  MR_Word UnboxedFloats_79;
  MR_Word HaveUnboxedFloats_80;
  MR_Word UnboxedInt64s_81;
  MR_Word HaveUnboxedInt64s_82;
  MR_Box conv2_ForeignCode_14;

  hlds__hlds_module__module_info_get_name_2_p_0(STATE_VARIABLE_ModuleInfo_0_27, &ModuleName_13);
  hlds__hlds_module__module_info_get_foreign_decl_codes_user_2_p_0(STATE_VARIABLE_ModuleInfo_0_27, &ForeignDeclCodeUserCord_31);
  hlds__hlds_module__module_info_get_foreign_decl_codes_aux_2_p_0(STATE_VARIABLE_ModuleInfo_0_27, &ForeignDeclCodeAuxCord_32);
  hlds__hlds_module__module_info_get_foreign_body_codes_2_p_0(STATE_VARIABLE_ModuleInfo_0_27, &ForeignBodyCodeCord_33);
  hlds__hlds_module__module_info_get_c_j_cs_fims_2_p_0(STATE_VARIABLE_ModuleInfo_0_27, &CJCsEFIMs_34);
  hlds__hlds_module__module_info_get_pragma_exported_procs_2_p_0(STATE_VARIABLE_ModuleInfo_0_27, &ForeignExportsCord_35);
  Var_42 = mercury__cord__f_43_43_2_f_0((MR_Word) (&parse_tree__prog_foreign__parse_tree__prog_foreign__type_ctor_info_foreign_decl_code_0), ForeignDeclCodeUserCord_31, ForeignDeclCodeAuxCord_32);
  ForeignDeclCodes_36 = mercury__cord__list_1_f_0((MR_Word) (&parse_tree__prog_foreign__parse_tree__prog_foreign__type_ctor_info_foreign_decl_code_0), Var_42);
  ...
  hlds__hlds_module__module_info_get_globals_2_p_0(STATE_VARIABLE_ModuleInfo_0_27, &Globals_39);
  libs__globals__get_backend_foreign_languages_2_p_0(Globals_39, &BackendForeignLanguages_40);
  {
    ...
    MR_hl_field(0, Var_45, 0) = ((MR_Box) (&ml_backend__ml_top_gen_scalar_common_4[0]));
    MR_hl_field(0, Var_45, 1) = ((MR_Box) (ml_backend__ml_top_gen__ml_code_gen_7_p_0_1));
    MR_hl_field(0, Var_45, 2) = ((MR_Box) ((MR_Integer) 1));
    MR_hl_field(0, Var_45, 3) = ((MR_Box) (CJCsEFIMs_34));
  }
  Var_44 = mercury__list__map_2_f_0((MR_Word) (&libs__globals__libs__globals__type_ctor_info_foreign_language_0), (MR_Word) (&ml_backend__ml_top_gen_scalar_common_1[0]), Var_45, BackendForeignLanguages_40);
  Var_43 = mercury__set__union_list_1_f_0((MR_Word) (&parse_tree__prog_data_foreign__parse_tree__prog_data_foreign__type_ctor_info_fim_spec_0), Var_44);
  WantedForeignImports_41 = mercury__set__to_sorted_list_1_f_0((MR_Word) (&parse_tree__prog_data_foreign__parse_tree__prog_data_foreign__type_ctor_info_fim_spec_0), Var_43);
  {
    Var_46 = (MR_Word) MR_new_object(MR_Word, (8 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(0, Var_46, 0) = ((MR_Box) (&ml_backend__ml_top_gen_scalar_common_5[0]));
    MR_hl_field(0, Var_46, 1) = ((MR_Box) (ml_backend__ml_top_gen__ml_code_gen_7_p_0_2));
    MR_hl_field(0, Var_46, 2) = ((MR_Box) ((MR_Integer) 5));
    MR_hl_field(0, Var_46, 3) = ((MR_Box) (STATE_VARIABLE_ModuleInfo_0_27));
    MR_hl_field(0, Var_46, 4) = ((MR_Box) (ForeignDeclCodes_36));
    MR_hl_field(0, Var_46, 5) = ((MR_Box) (ForeignBodyCodes_37));
    MR_hl_field(0, Var_46, 6) = ((MR_Box) (WantedForeignImports_41));
    MR_hl_field(0, Var_46, 7) = ((MR_Box) (ForeignExports_38));
  }
  Var_47 = mercury__map__init_0_f_0((MR_Word) (&libs__globals__libs__globals__type_ctor_info_foreign_language_0), (MR_Word) (&ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_foreign_code_0));
  mercury__list__foldl_4_p_0((MR_Word) (&libs__globals__libs__globals__type_ctor_info_foreign_language_0), (MR_Word) (&ml_backend__ml_top_gen_scalar_common_2[0]), Var_46, BackendForeignLanguages_40, ((MR_Box) (Var_47)), &conv2_ForeignCode_14);
  ForeignCode_14 = ((MR_Word) (conv2_ForeignCode_14));
  hlds__hlds_module__module_info_get_all_deps_2_p_0(STATE_VARIABLE_ModuleInfo_0_27, &AllImports0_56);
  hlds__hlds_module__module_info_get_name_2_p_0(STATE_VARIABLE_ModuleInfo_0_27, &ThisModule_57);
  AllImports_58 = mercury__set__delete_2_f_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), AllImports0_56, ((MR_Box) (ThisModule_57)));
  Var_60 = mercury__set__to_sorted_list_1_f_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), AllImports_58);
  Imports_15 = mercury__list__map_2_f_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), (MR_Word) (&ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_import_0), (MR_Word) (&ml_backend__ml_top_gen_scalar_common_2[2]), Var_60);
  ml_backend__ml_type_gen__ml_gen_types_4_p_0(STATE_VARIABLE_ModuleInfo_0_27, Target_9, &TypeDefns_16, &EnumDefns_17);
  hlds__hlds_module__module_info_get_table_struct_map_2_p_0(STATE_VARIABLE_ModuleInfo_0_27, &TableStructMap_63);
  mercury__map__to_assoc_list_2_p_0((MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_proc_id_0), (MR_Word) (&hlds__hlds_module__hlds__hlds_module__type_ctor_info_table_struct_info_0), TableStructMap_63, &TableStructs_64);
  if ((TableStructs_64 == (MR_Word) ((MR_Unsigned) 0U)))
    TableStructDefns_18 = (MR_Word) ((MR_Unsigned) 0U);
  else
  {
    MR_Word Globals_65;
    MR_Word GC_Method_66;
    MR_Word Var_67;
    MR_Word Var_71;
    MR_Box conv5_TableStructDefns_18;

    hlds__hlds_module__module_info_get_globals_2_p_0(STATE_VARIABLE_ModuleInfo_0_27, &Globals_65);
    libs__globals__get_gc_method_2_p_0(Globals_65, &GC_Method_66);
    {
      Var_67 = (MR_Word) MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(0, Var_67, 0) = ((MR_Box) (&ml_backend__ml_top_gen_scalar_common_6[1]));
      MR_hl_field(0, Var_67, 1) = ((MR_Box) (ml_backend__ml_top_gen__ml_code_gen_7_p_0_4));
      MR_hl_field(0, Var_67, 2) = ((MR_Box) ((MR_Integer) 2));
      MR_hl_field(0, Var_67, 3) = ((MR_Box) (GC_Method_66));
      MR_hl_field(0, Var_67, 4) = ((MR_Box) ((MR_Integer) 5));
    }
    mercury__require__expect_not_3_p_0(Var_67, (MR_String) "predicate \140ml_backend.ml_top_gen.ml_gen_table_structs\'/2", (MR_String) "tabling and \140--gc accurate\'");
    {
      Var_71 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(0, Var_71, 0) = ((MR_Box) (&ml_backend__ml_top_gen_scalar_common_7[0]));
      MR_hl_field(0, Var_71, 1) = ((MR_Box) (ml_backend__ml_top_gen__ml_code_gen_7_p_0_5));
      MR_hl_field(0, Var_71, 2) = ((MR_Box) ((MR_Integer) 1));
      MR_hl_field(0, Var_71, 3) = ((MR_Box) (STATE_VARIABLE_ModuleInfo_0_27));
    }
    mercury__list__foldl_4_p_0((MR_Word) (&ml_backend__ml_top_gen_scalar_common_2[1]), (MR_Word) (&ml_backend__ml_top_gen_scalar_common_1[1]), Var_71, TableStructs_64, ((MR_Box) ((MR_Unsigned) 0U)), &conv5_TableStructDefns_18);
    TableStructDefns_18 = ((MR_Word) (conv5_TableStructDefns_18));
  }
  hlds__hlds_module__module_info_get_globals_2_p_0(STATE_VARIABLE_ModuleInfo_0_27, &Globals_78);
  libs__globals__lookup_bool_option_3_p_0(Globals_78, (MR_Integer) 289, &UnboxedFloats_79);
  switch (UnboxedFloats_79) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 0:
      HaveUnboxedFloats_80 = (MR_Integer) 1;
      break;
    case (MR_Integer) 1:
      HaveUnboxedFloats_80 = (MR_Integer) 0;
      break;
  }
  libs__globals__lookup_bool_option_3_p_0(Globals_78, (MR_Integer) 290, &UnboxedInt64s_81);
  switch (UnboxedInt64s_81) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 0:
      HaveUnboxedInt64s_82 = (MR_Integer) 1;
      break;
    case (MR_Integer) 1:
      HaveUnboxedInt64s_82 = (MR_Integer) 0;
      break;
  }
  GlobalData0_19 = ml_backend__ml_global_data__ml_global_data_init_4_f_0(Target_9, (MR_Integer) 1, HaveUnboxedFloats_80, HaveUnboxedInt64s_82);
  ml_backend__ml_unify_gen_construct__ml_generate_const_structs_5_p_0(STATE_VARIABLE_ModuleInfo_0_27, Target_9, &ConstStructMap_20, GlobalData0_19, &GlobalData1_21);
  ml_backend__ml_type_gen__ml_gen_exported_enums_2_p_0(STATE_VARIABLE_ModuleInfo_0_27, &ExportedEnums_22);
  hlds__hlds_module__module_info_user_init_pred_target_names_2_p_0(STATE_VARIABLE_ModuleInfo_0_27, &InitPreds_23);
  hlds__hlds_module__module_info_user_final_pred_target_names_2_p_0(STATE_VARIABLE_ModuleInfo_0_27, &FinalPreds_24);
  ml_backend__ml_proc_gen__ml_gen_preds_10_p_0(ProgressStream_8, Target_9, ConstStructMap_20, &PredDefns_25, GlobalData1_21, &GlobalData_26, STATE_VARIABLE_ModuleInfo_0_27, STATE_VARIABLE_ModuleInfo_28, STATE_VARIABLE_Specs_0_29, STATE_VARIABLE_Specs_30);
  {
    MR_Word base;
    ...
    *MLDS_10 = base;
    ...
    MR_hl_field(0, base, 5) = ((MR_Box) (TableStructDefns_18));
    MR_hl_field(0, base, 6) = ((MR_Box) (PredDefns_25));
    MR_hl_field(0, base, 7) = ((MR_Box) (InitPreds_23));
    MR_hl_field(0, base, 8) = ((MR_Box) (FinalPreds_24));
    MR_hl_field(0, base, 9) = ((MR_Box) (ForeignCode_14));
    MR_hl_field(0, base, 10) = ((MR_Box) (ExportedEnums_22));
  }
}
