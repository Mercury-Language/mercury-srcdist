  ...
  MR_Word * STATE_VARIABLE_DataDefns_58)
{
  ...
  else
  {
    ...
    Var_63 = mercury__list__map_2_f_0((MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_table_step_desc_0), (MR_Word) (&ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_initializer_0), (MR_Word) (&ml_backend__ml_top_gen_scalar_common_7[2]), InputSteps_20);
    {
  ...
  else
  {
    ...
    Var_81 = mercury__list__map_2_f_0((MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_table_step_desc_0), (MR_Word) (&ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_initializer_0), (MR_Word) (&ml_backend__ml_top_gen_scalar_common_7[3]), OutputSteps_43);
    {
