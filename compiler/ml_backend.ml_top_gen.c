  ...
  MR_Box closure_arg)
{
  ...
  succeeded = ml_backend__ml_top_gen__IntroducedFrom__pred__ml_gen_table_structs__264__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 4)))));
  return succeeded;
}
  ...
  MR_Word * STATE_VARIABLE_Specs_31)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_79, (MR_Integer) 308, &UnboxedFloats_80);
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_79, (MR_Integer) 309, &UnboxedInt64s_82);
