  ...
  MR_Word * STATE_VARIABLE_Specs_29)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_77, (MR_Integer) 289, &UnboxedFloats_78);
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_77, (MR_Integer) 290, &UnboxedInt64s_80);
