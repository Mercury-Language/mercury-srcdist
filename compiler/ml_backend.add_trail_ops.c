...
{
  {
    ...
    else
    {
      ...
      else
      {
        ...
        mercury__builtin__compare_3_p_0((MR_Word) &ml_backend__add_trail_ops_scalar_common_2[0], &Var_15, ((MR_Box) (ArgX2_6)), ((MR_Box) (ArgY2_7)));
...
{
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        TypeInfo_16_16 = (MR_Word) &ml_backend__add_trail_ops_scalar_common_2[0];
        ...
        case (MR_Integer) 0:
          {
            ...
            {
              MR_Word next_value_of_GoalExpr0_6 = NewOuterGoal_37;
...
{
  {
    ...
    mercury__list__map_foldl_5_p_0(TypeCtorInfo_16_16, TypeCtorInfo_16_16, (MR_Word) &ml_backend__add_trail_ops__ml_backend__add_trail_ops__type_ctor_info_trail_ops_info_0, (MR_Word) &ml_backend__add_trail_ops_scalar_common_2[1], Goals0_5, Goals_6, ((MR_Box) (STATE_VARIABLE_Info_0_8)), &conv2_STATE_VARIABLE_Info_9);
