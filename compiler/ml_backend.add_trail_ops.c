...
MR_decl_label10(ml_backend__add_trail_ops__goal_expr_add_trail_ops_5_0, 260,3,6,5,11,13,14,15,16,17)
...
MR_decl_label10(ml_backend__add_trail_ops__goal_expr_add_trail_ops_5_0, 72,73,74,75,76,79,78,71,85,86)
MR_decl_label10(ml_backend__add_trail_ops__goal_expr_add_trail_ops_5_0, 91,92,93,94,95,96,97,98,99,100)
MR_decl_label9(ml_backend__add_trail_ops__goal_expr_add_trail_ops_5_0, 101,110,87,130,134,84,140,139,143)
...
MR_BEGIN_MODULE(ml_backend__add_trail_ops_module15)
	...
	MR_init_label10(ml_backend__add_trail_ops__goal_expr_add_trail_ops_5_0,260,3,6,5,11,13,14,15,16,17)
	...
	MR_init_label10(ml_backend__add_trail_ops__goal_expr_add_trail_ops_5_0,72,73,74,75,76,79,78,71,85,86)
	MR_init_label10(ml_backend__add_trail_ops__goal_expr_add_trail_ops_5_0,91,92,93,94,95,96,97,98,99,100)
	MR_init_label9(ml_backend__add_trail_ops__goal_expr_add_trail_ops_5_0,101,110,87,130,134,84,140,139,143)
MR_BEGIN_CODE
...
MR_def_label(ml_backend__add_trail_ops__goal_expr_add_trail_ops_5_0,260)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_def_label(ml_backend__add_trail_ops__goal_expr_add_trail_ops_5_0,78)
	...
	MR_GOTO_LAB(ml_backend__add_trail_ops__goal_expr_add_trail_ops_5_0_i260);
	}
...
MR_def_label(ml_backend__add_trail_ops__goal_expr_add_trail_ops_5_0,130)
	...
	MR_r2 = MR_sv(6);
	MR_np_call_localret_ent(ml_backend__add_trail_ops__goal_add_trail_ops_4_0,
		ml_backend__add_trail_ops__goal_expr_add_trail_ops_5_0_i134);
MR_def_label(ml_backend__add_trail_ops__goal_expr_add_trail_ops_5_0,134)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 3, (MR_Integer) 3);
...
MR_def_label(ml_backend__add_trail_ops__goal_expr_add_trail_ops_5_0,84)
	...
	if (MR_RTAGS_TESTR(MR_r1,3,3)) {
		MR_GOTO_LAB(ml_backend__add_trail_ops__goal_expr_add_trail_ops_5_0_i139);
	}
	MR_sv(2) = MR_r2;
	MR_sv(1) = MR_tfield(3, MR_r1, 1);
	...
	MR_np_call_localret_ent(ml_backend__add_trail_ops__cases_add_trail_ops_4_0,
		ml_backend__add_trail_ops__goal_expr_add_trail_ops_5_0_i140);
