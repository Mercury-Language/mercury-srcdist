...
MR_decl_label10(ml_backend__add_trail_ops__disj_add_trail_ops_7_0, 59,4,6,7,13,14,12,17,18,20)
...
MR_decl_label10(ml_backend__add_trail_ops__goal_expr_add_trail_ops_5_0, 220,3,8,9,10,12,13,16,172,18)
MR_decl_label10(ml_backend__add_trail_ops__goal_expr_add_trail_ops_5_0, 20,21,22,23,24,33,34,35,36,37)
MR_decl_label10(ml_backend__add_trail_ops__goal_expr_add_trail_ops_5_0, 43,38,39,47,48,49,52,51,57,58)
MR_decl_label10(ml_backend__add_trail_ops__goal_expr_add_trail_ops_5_0, 50,64,65,78,79,80,81,82,83,86)
MR_decl_label10(ml_backend__add_trail_ops__goal_expr_add_trail_ops_5_0, 85,91,92,93,98,99,100,101,102,103)
MR_decl_label10(ml_backend__add_trail_ops__goal_expr_add_trail_ops_5_0, 104,105,106,107,108,117,94,137,141,146)
MR_decl_label3(ml_backend__add_trail_ops__goal_expr_add_trail_ops_5_0, 147,149,150)
...
MR_BEGIN_MODULE(ml_backend__add_trail_ops_module15)
	...
	MR_init_label10(ml_backend__add_trail_ops__goal_expr_add_trail_ops_5_0,220,3,8,9,10,12,13,16,172,18)
	MR_init_label10(ml_backend__add_trail_ops__goal_expr_add_trail_ops_5_0,20,21,22,23,24,33,34,35,36,37)
	MR_init_label10(ml_backend__add_trail_ops__goal_expr_add_trail_ops_5_0,43,38,39,47,48,49,52,51,57,58)
	MR_init_label10(ml_backend__add_trail_ops__goal_expr_add_trail_ops_5_0,50,64,65,78,79,80,81,82,83,86)
	MR_init_label10(ml_backend__add_trail_ops__goal_expr_add_trail_ops_5_0,85,91,92,93,98,99,100,101,102,103)
	MR_init_label10(ml_backend__add_trail_ops__goal_expr_add_trail_ops_5_0,104,105,106,107,108,117,94,137,141,146)
	MR_init_label3(ml_backend__add_trail_ops__goal_expr_add_trail_ops_5_0,147,149,150)
MR_BEGIN_CODE
...
MR_def_label(ml_backend__add_trail_ops__goal_expr_add_trail_ops_5_0,3)
	...
	if (((MR_tag(MR_tempr1) == MR_mktag((MR_Integer) 0)) || (MR_tag(MR_tempr1) == MR_mktag((MR_Integer) 2)))) {
		MR_GOTO_LAB(ml_backend__add_trail_ops__goal_expr_add_trail_ops_5_0_i172);
	}
	MR_tempr2 = MR_r3;
	MR_sv(6) = MR_tempr2;
...
MR_BEGIN_MODULE(ml_backend__add_trail_ops_module16)
	...
	MR_init_label10(ml_backend__add_trail_ops__disj_add_trail_ops_7_0,59,4,6,7,13,14,12,17,18,20)
