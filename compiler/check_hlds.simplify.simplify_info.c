...
{
  {
    ...
    else
    {
      ...
      else
      {
        ...
        {
          mercury__builtin__compare_3_p_0((MR_Word) (&check_hlds__simplify__simplify_info_scalar_common_1[5]), HeadVar__1_1, ((MR_Box) (ArgX3_10)), ((MR_Box) (ArgY3_11)));
        }
      }
    }
  }
        ...
        else
        {
          ...
          else
          {
            ...
            else
            {
              ...
              mercury__private_builtin__builtin_compare_int_3_p_0(&SubResult5_18, Var_37, Var_38);
              ...
              else
              {
                ...
                mercury__private_builtin__builtin_compare_int_3_p_0(&SubResult6_21, Var_39, Var_40);
                  ...
                  else
                  {
                    ...
                    else
                    {
                      ...
                      else
                      {
                        ...
                        mercury__private_builtin__builtin_compare_int_3_p_0(&SubResult3_49, Var_62, Var_63);
                        ...
                        else
                        {
                          ...
                          else
                          {
                            ...
                            mercury__private_builtin__builtin_compare_int_3_p_0(&SubResult7_24, Var_64, Var_65);
                            succeeded = (SubResult7_24 != (MR_Integer) 0);
                          }
                        }
                      }
          ...
          else
          {
            ...
            else
            {
              ...
              else
              {
                ...
                mercury__private_builtin__builtin_compare_int_3_p_0(&SubResult6_21, Var_43, Var_44);
                succeeded = (SubResult6_21 != (MR_Integer) 0);
                if (succeeded)
                  *HeadVar__1_1 = SubResult6_21;
                else
                {
                  ...
                  mercury__private_builtin__builtin_compare_int_3_p_0(&SubResult7_24, Var_45, Var_46);
                  succeeded = (SubResult7_24 != (MR_Integer) 0);
                  if (succeeded)
                    *HeadVar__1_1 = SubResult7_24;
                  else
                  {
                    ...
                    mercury__private_builtin__builtin_compare_int_3_p_0(&SubResult8_27, Var_47, Var_48);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_15, (MR_Integer) 185, &FullyStrict_16);
