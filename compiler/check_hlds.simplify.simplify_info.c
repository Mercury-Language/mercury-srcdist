...
#line 262 "simplify_info.m"
    {
#line 262 "simplify_info.m"
      libs__globals__lookup_bool_option_3_p_0(check_hlds__simplify__simplify_info__Globals_13, (MR_Integer) 162, &check_hlds__simplify__simplify_info__FullyStrict_14);
    }
