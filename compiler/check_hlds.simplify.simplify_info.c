...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_15, (MR_Integer) 203, &FullyStrict0_16);
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_15, (MR_Integer) 144, &TraceOptimized0_19);
