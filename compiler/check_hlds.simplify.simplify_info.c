  ...
  MR_Word * Info_14)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_17, (MR_Integer) 249, &FullyStrict0_18);
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_17, (MR_Integer) 186, &TraceOptimized0_24);
