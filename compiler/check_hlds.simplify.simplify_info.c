...
{
  {
    ...
    MR_Word WarnDuplicateCalls_6 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), SimplifyTasks_5, (MR_Integer) 0))) >> 14)) & (MR_Integer) 1);

    *OptDuplicateCalls_4 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), SimplifyTasks_5, (MR_Integer) 0))) >> 5)) & (MR_Integer) 1);
...
MR_bool MR_CALL 
check_hlds__simplify__simplify_info__simplify_do_warn_inf_rec_modulo_svar_1_p_0(
  MR_Word Info_2)
{
  {
    MR_bool succeeded;
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_15, (MR_Integer) 189, &FullyStrict_16);
    libs__globals__get_trace_level_2_p_0(Globals_15, &TraceLevel_17);
    libs__globals__lookup_bool_option_3_p_0(Globals_15, (MR_Integer) 136, &TraceOptimized_18);
    {
