...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_15, (MR_Integer) 207, &FullyStrict0_16);
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_15, (MR_Integer) 148, &TraceOptimized0_19);
