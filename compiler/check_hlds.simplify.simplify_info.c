      ...
      else
      {
        ...
        else
        {
          ...
          else
          {
            ...
            mercury__builtin__compare_3_p_0((MR_Word) &check_hlds__simplify__simplify_info_scalar_common_2[0], &Var_23, ((MR_Box) (ArgX4_10)), ((MR_Box) (ArgY4_11)));
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            TypeInfo_24_24 = (MR_Word) &check_hlds__simplify__simplify_info_scalar_common_2[0];
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_15, (MR_Integer) 178, &FullyStrict_16);
    libs__globals__get_trace_level_2_p_0(Globals_15, &TraceLevel_17);
    libs__globals__lookup_bool_option_3_p_0(Globals_15, (MR_Integer) 131, &TraceOptimized_18);
    {
