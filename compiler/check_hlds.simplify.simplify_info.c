            ...
            else
            {
              ...
              else
              {
                ...
                else
                {
                  ...
                  hlds__hlds_pred____Compare____pred_proc_id_0_0(&SubResult2_42, ArgX2_40, ArgY2_41);
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              ...
              else
              {
                ...
                if (succeeded)
                {
                  succeeded = hlds__hlds_pred____Unify____pred_proc_id_0_0(ArgX2_24, ArgY2_25);
                  if (succeeded)
                  {
  ...
  MR_Word * Info_14)
{
  ...
  hlds__hlds_pred__proc_info_get_inst_varset_2_p_0(ProcInfo_12, &InstVarSet_16);
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_17, (MR_Integer) 279, &TraceOptimized0_24);
  ...
  hlds__hlds_pred__proc_info_get_rtti_varmaps_2_p_0(ProcInfo_12, &RttiVarMaps_29);
  mercury__set__init_1_p_0((MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_proc_id_0), &TraceGoalProcs_37);
  ...
  hlds__hlds_pred__proc_info_get_var_table_2_p_0(ProcInfo_12, &VarTable_44);
  {
    MR_Word base;
    base = (MR_Word) MR_new_object(MR_Word, (6 * sizeof(MR_Word)), NULL, NULL);
    *Info_14 = base;
