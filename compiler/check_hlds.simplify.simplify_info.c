  ...
  MR_Word * Info_12)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_15, (MR_Integer) 214, &FullyStrict0_16);
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_15, (MR_Integer) 155, &TraceOptimized0_21);
