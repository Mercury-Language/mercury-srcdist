...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_15, (MR_Integer) 190, &FullyStrict_16);
    libs__globals__get_trace_level_2_p_0(Globals_15, &TraceLevel_17);
    libs__globals__lookup_bool_option_3_p_0(Globals_15, (MR_Integer) 137, &TraceOptimized_18);
    {
