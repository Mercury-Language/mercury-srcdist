  ...
  MR_Word * STATE_VARIABLE_Info_18)
{
  ...
  hlds__hlds_rtti__apply_substitutions_to_rtti_varmaps_5_p_0(Var_20, TSubst_8, Renaming_14, RttiVarMaps0_12, &RttiVarMaps1_15);
  ...
  MR_Word * Info_14)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_17, (MR_Integer) 278, &TraceOptimized0_24);
