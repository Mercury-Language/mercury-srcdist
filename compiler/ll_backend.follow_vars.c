...
{
  {
    ...
    MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Var_5, (MR_Integer) 1)));
...
{
  {
    ...
    else
    {
      ...
      if (((MR_tag((MR_Word) GoalExpr0_34)) == (MR_Integer) 2))
      {
        ...
        MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), GoalExpr0_34, (MR_Integer) 3)));
      ...
      if (((MR_tag((MR_Word) GoalExpr0_34)) == (MR_Integer) 1))
      {
        ...
        if (succeeded)
          packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Unification_45, (MR_Integer) 2)));
        succeeded = !(succeeded);
      }
      else
        succeeded = MR_FALSE;
      ...
      case (MR_Integer) 2:
        {
          ...
          MR_Unsigned packed_args_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), GoalExpr0_13, (MR_Integer) 3)));
          ...
          case (MR_Integer) 0:
            {
              ...
              MR_Unsigned packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), GoalExpr0_13, (MR_Integer) 5)));
          ...
          case (MR_Integer) 4:
            {
              ...
              MR_Word Cases_27;
              MR_Unsigned packed_args_4 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), GoalExpr0_13, (MR_Integer) 2)));
          ...
          case (MR_Integer) 5:
            {
              ...
              if (succeeded)
              {
                packed_args_3 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Reason_55, (MR_Integer) 2)));
  ...
  MR_Integer * STATE_VARIABLE_NextNonReservedF_7)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Var_34, (MR_Integer) 1)));
        ...
        case (MR_Integer) 0:
          {
            ...
            MR_Word Locn_26;
            MR_Unsigned packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), ArgLoc_18, (MR_Integer) 0)));
...

            {
              ...
              MR_hl_field(MR_mktag(1), Locn_26, 0) = (MR_Box) (packed_args_1);
        ...
        case (MR_Integer) 1:
          {
            ...
            MR_Word Locn_26;
            MR_Unsigned packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), ArgLoc_17, (MR_Integer) 0)));
