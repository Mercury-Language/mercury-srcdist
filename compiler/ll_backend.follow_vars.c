...
MR_decl_label10(ll_backend__follow_vars__find_follow_vars_in_goal_expr_10_0, 3,7,6,9,4,12,13,11,205,18)
...
MR_decl_label10(ll_backend__follow_vars__find_follow_vars_in_goal_expr_10_0, 47,46,209,51,48,56,53,58,52,62)
MR_decl_label7(ll_backend__follow_vars__find_follow_vars_in_goal_expr_10_0, 63,61,70,72,66,67,65)
...
MR_BEGIN_MODULE(ll_backend__follow_vars_module6)
	...
	MR_init_label10(ll_backend__follow_vars__find_follow_vars_in_goal_expr_10_0,3,7,6,9,4,12,13,11,205,18)
	...
	MR_init_label10(ll_backend__follow_vars__find_follow_vars_in_goal_expr_10_0,47,46,209,51,48,56,53,58,52,62)
	MR_init_label7(ll_backend__follow_vars__find_follow_vars_in_goal_expr_10_0,63,61,70,72,66,67,65)
MR_BEGIN_CODE
...
MR_def_label(ll_backend__follow_vars__find_follow_vars_in_goal_expr_10_0,11)
	...
	if (MR_PTAG_TESTR(MR_r7,3)) {
		MR_GOTO_LAB(ll_backend__follow_vars__find_follow_vars_in_goal_expr_10_0_i205);
	}
	MR_r3 = MR_r5;
	MR_r4 = MR_r6;
	MR_proceed();
MR_def_label(ll_backend__follow_vars__find_follow_vars_in_goal_expr_10_0,205)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(11);
	MR_sv(11) = (MR_Word) MR_succip;
	MR_sv(6) = MR_r1;
...
MR_def_label(ll_backend__follow_vars__find_follow_vars_in_goal_expr_10_0,21)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(7) = (MR_Word) MR_CTOR0_ADDR(hlds__hlds_pred, arg_info);
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
	MR_r1 = MR_sv(3);
...
MR_def_label(ll_backend__follow_vars__find_follow_vars_in_goal_expr_10_0,46)
	...
	if (MR_PTAG_TESTR(MR_r1,2)) {
		MR_GOTO_LAB(ll_backend__follow_vars__find_follow_vars_in_goal_expr_10_0_i48);
	}
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_tfield(2, MR_r1, 3);
	if (MR_INT_NE(MR_tempr1,0)) {
		MR_GOTO_LAB(ll_backend__follow_vars__find_follow_vars_in_goal_expr_10_0_i209);
	}
	MR_r3 = MR_r5;
	MR_r4 = MR_r6;
	MR_proceed();
	}
MR_def_label(ll_backend__follow_vars__find_follow_vars_in_goal_expr_10_0,209)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(11);
	MR_sv(11) = (MR_Word) MR_succip;
	{
...
MR_def_label(ll_backend__follow_vars__find_follow_vars_in_goal_expr_10_0,48)
	...
	if (MR_RTAGS_TESTR(MR_r1,3,5)) {
		MR_GOTO_LAB(ll_backend__follow_vars__find_follow_vars_in_goal_expr_10_0_i52);
	}
	MR_incr_sp(11);
	MR_sv(11) = (MR_Word) MR_succip;
	...
	if (MR_INT_NE(MR_r8,1)) {
		MR_GOTO_LAB(ll_backend__follow_vars__find_follow_vars_in_goal_expr_10_0_i56);
	}
	MR_sv(7) = MR_r3;
	MR_sv(5) = MR_r4;
	MR_r3 = MR_r5;
...
MR_def_label(ll_backend__follow_vars__find_follow_vars_in_goal_expr_10_0,52)
	...
	if (MR_RTAGS_TESTR(MR_r1,3,4)) {
		MR_GOTO_LAB(ll_backend__follow_vars__find_follow_vars_in_goal_expr_10_0_i61);
	}
	MR_incr_sp(11);
	MR_sv(11) = (MR_Word) MR_succip;
	MR_sv(7) = MR_r3;
...
MR_def_label(ll_backend__follow_vars__find_follow_vars_in_goal_expr_10_0,62)
	...
	MR_np_call_localret_ent(ll_backend__follow_vars__find_follow_vars_in_cases_8_0,
		ll_backend__follow_vars__find_follow_vars_in_goal_expr_10_0_i63);
...
MR_def_label(ll_backend__follow_vars__find_follow_vars_in_goal_expr_10_0,61)
	...
	if (MR_PTAG_TESTR(MR_tempr1,2)) {
		MR_GOTO_LAB(ll_backend__follow_vars__find_follow_vars_in_goal_expr_10_0_i67);
	}
	MR_sv(6) = MR_r1;
