...
MR_decl_label10(ll_backend__follow_vars__find_follow_vars_in_goal_expr_10_0, 15,32,35,36,39,40,43,44,31,47)
MR_decl_label10(ll_backend__follow_vars__find_follow_vars_in_goal_expr_10_0, 46,202,52,201,54,57,53,61,62,60)
MR_decl_label6(ll_backend__follow_vars__find_follow_vars_in_goal_expr_10_0, 69,71,65,66,64,73)
...
MR_BEGIN_MODULE(ll_backend__follow_vars_module7)
	...
	MR_init_label10(ll_backend__follow_vars__find_follow_vars_in_goal_expr_10_0,15,32,35,36,39,40,43,44,31,47)
	MR_init_label10(ll_backend__follow_vars__find_follow_vars_in_goal_expr_10_0,46,202,52,201,54,57,53,61,62,60)
	MR_init_label6(ll_backend__follow_vars__find_follow_vars_in_goal_expr_10_0,69,71,65,66,64,73)
MR_BEGIN_CODE
...
MR_def_label(ll_backend__follow_vars__find_follow_vars_in_goal_expr_10_0,46)
	...
	if (MR_INT_NE(MR_tempr1,0)) {
		MR_GOTO_LAB(ll_backend__follow_vars__find_follow_vars_in_goal_expr_10_0_i202);
	}
	MR_r3 = MR_r5;
	MR_r4 = MR_r6;
	MR_proceed();
	}
MR_def_label(ll_backend__follow_vars__find_follow_vars_in_goal_expr_10_0,202)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(11);
	MR_sv(11) = (MR_Word) MR_succip;
	{
