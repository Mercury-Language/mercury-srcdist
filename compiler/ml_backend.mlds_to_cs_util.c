        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                TypeInfo__27_27 = (MR_Word) (&ml_backend__mlds_to_cs_util_scalar_common_1[0]);
                ...
                if (succeeded)
                {
                  ...
                  if (succeeded)
                  {
                    ...
                    if (succeeded)
                    {
                      TypeInfo__28_28 = (MR_Word) (&ml_backend__mlds_to_cs_util_scalar_common_2[1]);
                      succeeded = mercury__builtin__unify_2_p_0(TypeInfo__28_28, ((MR_Box) (ArgX10_21)), ((MR_Box) (ArgY10_22)));
                    }
                  }
                }
              }
  ...
  MR_Word CodeAddrs_7)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_9, (MR_Integer) 174, &AutoComments_10);
  libs__globals__lookup_bool_option_3_p_0(Globals_9, (MR_Integer) 170, &LineNumbers_11);
  libs__globals__lookup_bool_option_3_p_0(Globals_9, (MR_Integer) 171, &ForeignLineNumbers_12);
