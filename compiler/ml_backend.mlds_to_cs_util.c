...
static const MR_DuFunctorDescPtr ml_backend__mlds_to_cs_util__ml_backend__mlds_to_cs_util__du_stag_ordered_csharp_out_info_0_0[1] = { &ml_backend__mlds_to_cs_util__ml_backend__mlds_to_cs_util__du_functor_desc_csharp_out_info_0_0 };
...
static const MR_DuFunctorDescPtr ml_backend__mlds_to_cs_util__ml_backend__mlds_to_cs_util__du_name_ordered_csharp_out_info_0[1] = { &ml_backend__mlds_to_cs_util__ml_backend__mlds_to_cs_util__du_functor_desc_csharp_out_info_0_0 };

static const MR_Integer ml_backend__mlds_to_cs_util__ml_backend__mlds_to_cs_util__functor_number_map_csharp_out_info_0[1] = { (MR_Integer) 0 };
  ...
  MR_Word HeadVar__3_3)
{
  ...
  else
  {
    ...
    MR_Word ArgX8_25 = ((((MR_Unsigned) ((MR_hl_field(0, HeadVar__2_2, 5))) >> 2)) & (MR_Integer) 1);
    MR_Word ArgY8_26 = ((((MR_Unsigned) ((MR_hl_field(0, HeadVar__3_3, 5))) >> 2)) & (MR_Integer) 1);
    MR_Word ArgX9_28 = ((MR_Unsigned) ((MR_hl_field(0, HeadVar__2_2, 5))) & (MR_Integer) 3);
    MR_Word ArgY9_29 = ((MR_Unsigned) ((MR_hl_field(0, HeadVar__3_3, 5))) & (MR_Integer) 3);
  ...
  MR_Word HeadVar__2_2)
{
  ...
  else
  {
    ...
    MR_Word ArgX8_17 = ((((MR_Unsigned) ((MR_hl_field(0, HeadVar__1_1, 5))) >> 2)) & (MR_Integer) 1);
    MR_Word ArgY8_18 = ((((MR_Unsigned) ((MR_hl_field(0, HeadVar__2_2, 5))) >> 2)) & (MR_Integer) 1);
    MR_Word ArgX9_19 = ((MR_Unsigned) ((MR_hl_field(0, HeadVar__1_1, 5))) & (MR_Integer) 3);
    MR_Word ArgY9_20 = ((MR_Unsigned) ((MR_hl_field(0, HeadVar__2_2, 5))) & (MR_Integer) 3);
...
void MR_CALL 
ml_backend__mlds_to_cs_util__maybe_output_inline_comment_for_csharp_5_p_0(
  MR_Word Info_6,
  MR_Word Stream_7,
  MR_String Comment_8)
{
  MR_Word AutoComments_10 = ((((MR_Unsigned) ((MR_hl_field(0, Info_6, 1))) >> 2)) & (MR_Integer) 1);
  ...
  MR_Word Context_8)
{
  ...
  switch (OutputLineNumbers_7) {
    ...
    case (MR_Integer) 1:
      {
        succeeded = mercury__term_context__is_dummy_context_1_p_0(Context_8);
        if (!(succeeded))
        {
          MR_String File_10 = ((MR_String) ((MR_hl_field(0, Context_8, 0))));
          MR_Integer Line_11 = ((MR_Integer) ((MR_hl_field(0, Context_8, 1))));
          MR_String Var_24;

          mercury__io__write_string_4_p_0(Stream_6, (MR_String) "#line ");
          mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&ml_backend__mlds_to_cs_util_scalar_common_3[0]), Line_11, &Var_24);
  ...
  MR_Word CodeAddrs_7)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_9, (MR_Integer) 462, &AutoComments_10);
  libs__globals__lookup_bool_option_3_p_0(Globals_9, (MR_Integer) 458, &LineNumbers_11);
  libs__globals__lookup_bool_option_3_p_0(Globals_9, (MR_Integer) 459, &ForeignLineNumbers_12);
  ...
  MLDS_ModuleName_14 = ml_backend__mlds__mercury_module_name_to_mlds_1_f_0(ModuleName_13);
  {
    ...
    MR_hl_field(0, Info_8, 4) = ((MR_Box) (CodeAddrs_7));
