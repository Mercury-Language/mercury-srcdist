    ...
    case (MR_Integer) 1:
      {
        ...
        if (!(succeeded))
        {
          MR_String File_10 = ((MR_String) ((MR_hl_field(0, Context_8, (MR_Integer) 0))));
          MR_Integer Line_11 = ((MR_Integer) ((MR_hl_field(0, Context_8, (MR_Integer) 1))));
          MR_String Var_24;
  ...
  MR_Word CodeAddrs_7)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_9, (MR_Integer) 178, &AutoComments_10);
  libs__globals__lookup_bool_option_3_p_0(Globals_9, (MR_Integer) 174, &LineNumbers_11);
  libs__globals__lookup_bool_option_3_p_0(Globals_9, (MR_Integer) 175, &ForeignLineNumbers_12);
