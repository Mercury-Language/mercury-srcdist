...
{
  {
    ...
    else
    {
      ...
      else
      {
        ...
        mercury__private_builtin__builtin_compare_int_3_p_0(&SubResult2_9, Var_45, Var_46);
        ...
        else
        {
          ...
          mercury__private_builtin__builtin_compare_int_3_p_0(&SubResult3_12, Var_47, Var_48);
          ...
          else
          {
            ...
            mercury__private_builtin__builtin_compare_int_3_p_0(&SubResult4_15, Var_49, Var_50);
              ...
              else
              {
                ...
                else
                {
                  ...
                  else
                  {
                    ...
                    mercury__private_builtin__builtin_compare_int_3_p_0(&SubResult8_27, Var_51, Var_52);
                    ...
                    else
                    {
                      ...
                      mercury__private_builtin__builtin_compare_int_3_p_0(&SubResult9_30, Var_53, Var_54);
