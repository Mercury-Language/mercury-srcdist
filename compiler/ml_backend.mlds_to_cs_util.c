  ...
  MR_Word CodeAddrs_7)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_9, (MR_Integer) 188, &AutoComments_10);
  libs__globals__lookup_bool_option_3_p_0(Globals_9, (MR_Integer) 184, &LineNumbers_11);
  libs__globals__lookup_bool_option_3_p_0(Globals_9, (MR_Integer) 185, &ForeignLineNumbers_12);
