...
{
  {
    ...
    MLDS_ModuleName_14 = ml_backend__mlds__mercury_module_name_to_mlds_1_f_0(ModuleName_13);
    {
      ...
      MR_hl_field(MR_mktag(0), Info_8, 1) = (MR_Box) (((((MR_Unsigned) (AutoComments_10) << (MR_Integer) 2)) | (((((MR_Unsigned) (LineNumbers_11) << (MR_Integer) 1)) | (MR_Unsigned) (ForeignLineNumbers_12)))));
      ...
      MR_hl_field(MR_mktag(0), Info_8, 5) = (MR_Box) (((((MR_Unsigned) ((MR_Integer) 1) << (MR_Integer) 2)) | (MR_Unsigned) ((MR_Integer) 0)));
