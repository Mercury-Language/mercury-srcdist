  ...
  MR_Word CodeAddrs_7)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_9, (MR_Integer) 463, &AutoComments_10);
  libs__globals__lookup_bool_option_3_p_0(Globals_9, (MR_Integer) 459, &LineNumbers_11);
  libs__globals__lookup_bool_option_3_p_0(Globals_9, (MR_Integer) 460, &ForeignLineNumbers_12);
