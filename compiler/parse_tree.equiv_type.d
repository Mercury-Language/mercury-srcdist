...
parse_tree.equiv_type.optdate parse_tree.equiv_type.trans_opt_date equiv_type.err parse_tree.equiv_type.c_date parse_tree.equiv_type.s_date parse_tree.equiv_type.pic_s_date parse_tree.equiv_type.il_date parse_tree.equiv_type.java_date : equiv_type.m \
	parse_tree.int0 \
	assoc_list.int \
	bool.int \
	builtin.int \
...
ifeq ($(TARGET_ASM),yes)
parse_tree.equiv_type.mh parse_tree.equiv_type.mih : parse_tree.equiv_type.s
else
parse_tree.equiv_type.mh parse_tree.equiv_type.mih : parse_tree.equiv_type.c
endif

ifeq ($(TARGET_ASM),yes)
parse_tree.equiv_type.module_dep : parse_tree.equiv_type.s
else
 ifeq ($(findstring il,$(GRADE)),il)
parse_tree.equiv_type.module_dep : parse_tree.equiv_type.il
  ifeq ($(findstring java,$(GRADE)),java)
parse_tree.equiv_type.module_dep : mercury/parse_tree_/equiv_type.java
  else
...
ifeq ($(TARGET_ASM),yes)
parse_tree.equiv_type.s_date : equiv_type.m
	$(MCG) $(ALL_GRADEFLAGS) $(ALL_MCGFLAGS) --target-code-only parse_tree.equiv_type $(ERR_REDIRECT)
parse_tree.equiv_type.pic_s_date : equiv_type.m
	$(MCG) $(ALL_GRADEFLAGS) $(ALL_MCGFLAGS) --target-code-only --pic \
		--cflags "$(GCCFLAGS_FOR_PIC)" parse_tree.equiv_type $(ERR_REDIRECT)
endif # TARGET_ASM
parse_tree.equiv_type.il_date : equiv_type.m
	$(MCG) $(ALL_GRADEFLAGS) $(ALL_MCGFLAGS) --il-only parse_tree.equiv_type $(ERR_REDIRECT)
