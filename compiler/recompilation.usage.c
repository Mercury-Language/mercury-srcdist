  ...
  MR_Word * STATE_VARIABLE_Info_21)
{
  ...
  MR_Word TypeCtorInfo_75_70;
  MR_Word TypeInfo_76_71;
  ...
  if (succeeded)
  {
    ...
    if (succeeded)
    {
      ...
      TypeCtorInfo_75_70 = (MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0);
      TypeInfo_76_71 = (MR_Word) (&recompilation__usage_scalar_common_2[6]);
      succeeded = mercury__map__search_3_p_0(TypeCtorInfo_75_70, TypeInfo_76_71, CtorFields_52, ((MR_Box) (FieldName_51)), &conv2_FieldDefns_53);
      if (succeeded)
      {
