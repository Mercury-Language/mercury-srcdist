  ...
  MR_Word * STATE_VARIABLE_Info_14)
{
  ...
  if (succeeded)
  {
    succeeded = parse_tree__prog_type_test__type_ctor_is_higher_order_4_p_0(TypeCtor_4, &Var_9, &Var_10);
    succeeded = !(succeeded);
  }
  if (succeeded)
  {
    ...
    TypeCtorItem_12 = recompilation__item_types__type_ctor_to_recomp_item_name_1_f_0(TypeCtor_4);
