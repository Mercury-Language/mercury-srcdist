...
{
  {
    ...
    if (succeeded)
    {
      ...
      parse_tree__file_names__module_name_to_file_name_7_p_0(Globals_13, (MR_Integer) 0, (MR_Word) (((MR_Box) ((MR_String) ".used"))), ModuleName_15, &FileName_16);
      ...
      else
      {
        ...
        recompilation__usage__write_usage_file_2_6_p_0(ModuleInfo_6, Var_44, RecompInfo_11, TimestampMap_12);
