...
recompilation__usage__IntroducedFrom__func__find_matching_functors__806__1_1_f_0(
  MR_Word LambdaHeadVar__1_47);

static MR_Word MR_CALL 
recompilation__usage__IntroducedFrom__func__find_matching_functors__783__1_1_f_0(
  MR_Word LambdaHeadVar__1_41);

static MR_Word MR_CALL 
recompilation__usage__IntroducedFrom__func__do_record_used_pred_or_func__713__1_2_f_0(
  MR_Word ModuleInfo_17,
  MR_Word LambdaHeadVar__1_35);

static MR_Word MR_CALL 
recompilation__usage__IntroducedFrom__func__write_module_name_and_used_items__292__1_3_f_0(
...
{
  {
    ...
    conv3_LambdaHeadVar__2_48 = recompilation__usage__IntroducedFrom__func__find_matching_functors__806__1_1_f_0(((MR_Word) (wrapper_arg_1)));
...
{
  {
    ...
    conv0_LambdaHeadVar__2_42 = recompilation__usage__IntroducedFrom__func__find_matching_functors__783__1_1_f_0(((MR_Word) (wrapper_arg_1)));
...
{
  {
    ...
    conv2_LambdaHeadVar__3_63 = recompilation__usage__IntroducedFrom__func__write_module_name_and_used_items__292__1_3_f_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) (wrapper_arg_1)), ((MR_Word) (wrapper_arg_2)));
...
{
  {
    ...
    if (succeeded)
    {
      ...
      parse_tree__file_names__module_name_to_file_name_8_p_0(Globals_13, (MR_String) "predicate \140recompilation.usage.write_usage_file\'/5", (MR_Integer) 0, (MR_Word) (MR_mkword(MR_mktag(1), &recompilation__usage_scalar_common_11[0])), ModuleName_15, &FileName_16);
      mercury__io__open_output_4_p_0(FileName_16, &FileResult_17);
      if (((MR_tag((MR_Word) FileResult_17)) == (MR_Integer) 1))
      {
        MR_Word IOError_19 = ((MR_Word) ((MR_hl_field(MR_mktag(1), FileResult_17, (MR_Integer) 0))));
        MR_String IOErrorMessage_20;
        MR_Word CurStream_21;

        mercury__io__error_message_2_p_0(IOError_19, &IOErrorMessage_20);
        mercury__io__output_stream_3_p_0(&CurStream_21);
        mercury__io__write_string_4_p_0(CurStream_21, (MR_String) "\nError opening \140");
        mercury__io__write_string_4_p_0(CurStream_21, FileName_16);
        mercury__io__write_string_4_p_0(CurStream_21, (MR_String) "\' for output: ");
        mercury__io__write_string_4_p_0(CurStream_21, IOErrorMessage_20);
        mercury__io__write_string_4_p_0(CurStream_21, (MR_String) ".\n");
        mercury__io__set_exit_status_3_p_0((MR_Integer) 1);
      }
      else
      {
        MR_Word FileStream_18 = ((MR_Word) ((MR_hl_field(MR_mktag(0), FileResult_17, (MR_Integer) 0))));
        MR_Word Var_44;
        ...
        recompilation__usage__write_usage_file_2_7_p_0(FileStream_18, ModuleInfo_6, Var_44, RecompInfo_11, TimestampMap_12);
...
{
  {
    ...
    conv0_LambdaHeadVar__2_36 = recompilation__usage__IntroducedFrom__func__do_record_used_pred_or_func__713__1_2_f_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) (wrapper_arg_1)));
