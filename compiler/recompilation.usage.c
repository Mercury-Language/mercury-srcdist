            ...
            case (MR_Integer) 0:
              {
                ...
                MR_Unsigned packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), InstName_4, (MR_Integer) 2)));
            ...
            case (MR_Integer) 1:
              {
                ...
                MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), InstName_4, (MR_Integer) 2)));
