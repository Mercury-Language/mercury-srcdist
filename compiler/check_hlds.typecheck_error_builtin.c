...
check_hlds__typecheck_error_builtin__IntroducedFrom__func__report_any_invisible_int_types__232__1_1_f_0(
  MR_Word LambdaHeadVar__1_29);

static MR_bool MR_CALL 
check_hlds__typecheck_error_builtin__IntroducedFrom__pred__report_any_invisible_int_types__215__1_2_p_0(
  MR_Word LambdaHeadVar__1_26,
  MR_Word * LambdaHeadVar__2_27);

static void MR_CALL 
check_hlds__typecheck_error_builtin__IntroducedFrom__pred__acc_builtin_types_of_var__159__1_3_p_0(
...
static /* final */ const MR_Box check_hlds__typecheck_error_builtin_scalar_common_3[2][6];

static /* final */ const MR_Box check_hlds__typecheck_error_builtin_scalar_common_4[5][3];

static /* final */ const MR_Box check_hlds__typecheck_error_builtin_scalar_common_5[3][5];
...
static /* final */ const MR_Box check_hlds__typecheck_error_builtin_scalar_common_4[5][3] = {
  ...
  /* row   3 */
  {
    ((MR_Box) (&check_hlds__typecheck_error_builtin_scalar_common_5[1])),
    ((MR_Box) (check_hlds__typecheck_error_builtin__report_any_invisible_int_types_2_f_0_2)),
    ((MR_Box) ((MR_Integer) 0))
  },
  /* row   4 */
  {
    ((MR_Box) (&check_hlds__typecheck_error_builtin_scalar_common_5[2])),
  ...
  MR_Word * LambdaHeadVar__3_17)
{
  ...
  Type_12 = check_hlds__typecheck_error_type_assign__typestuff_to_type_1_f_0(LambdaHeadVar__1_15);
  check_hlds__typecheck_error_builtin__acc_builtin_type_3_p_0(Type_12, LambdaHeadVar__2_16, LambdaHeadVar__3_17);
}
  ...
  MR_Box wrapper_arg_1)
{
  ...
  conv2_LambdaHeadVar__2_30 = check_hlds__typecheck_error_builtin__IntroducedFrom__func__report_any_invisible_int_types__232__1_1_f_0(((MR_Word) (wrapper_arg_1)));
  ...
  MR_Box * wrapper_arg_2)
{
  ...
  succeeded = check_hlds__typecheck_error_builtin__IntroducedFrom__pred__report_any_invisible_int_types__215__1_2_p_0(((MR_Word) (wrapper_arg_1)), &conv0_LambdaHeadVar__2_27);
  if (succeeded)
  {
  ...
  MR_Word BuiltinTypes_5)
{
  ...
  mercury__set__filter_map_3_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_builtin_type_0), (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_int_type_0), (MR_Word) (&check_hlds__typecheck_error_builtin_scalar_common_4[2]), BuiltinTypes_5, &IntTypes_8);
  ...
  if (succeeded)
  {
    ...
    Var_28 = (MR_Word) (&check_hlds__typecheck_error_builtin_scalar_common_4[3]);
  ...
  if (succeeded)
  {
    ...
    TailInvisIntTypePieces_20 = mercury__list__map_2_f_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_int_type_0), (MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), (MR_Word) (&check_hlds__typecheck_error_builtin_scalar_common_4[4]), TailInvisIntTypes_15);
...
{
  MR_Box closure = closure_arg;
  MR_Word conv0_STATE_VARIABLE_BuiltinTypes_21;

  check_hlds__typecheck_error_builtin__acc_builtin_type_3_p_0(((MR_Word) (wrapper_arg_1)), ((MR_Word) (wrapper_arg_2)), &conv0_STATE_VARIABLE_BuiltinTypes_21);
  *wrapper_arg_3 = ((MR_Box) (conv0_STATE_VARIABLE_BuiltinTypes_21));
}
...
check_hlds__typecheck_error_builtin__acc_builtin_type_3_p_0(
  MR_Word Type_4,
  MR_Word STATE_VARIABLE_BuiltinTypes_0_20,
  MR_Word * STATE_VARIABLE_BuiltinTypes_21)
{
  while (MR_TRUE)
  {
    // setup for model_det tailcalls optimized into a loop
    ...
    switch (MR_tag((MR_Word) Type_4)) {
      ...
      case (MR_Integer) 0:
        *STATE_VARIABLE_BuiltinTypes_21 = STATE_VARIABLE_BuiltinTypes_0_20;
        break;
      case (MR_Integer) 1:
        *STATE_VARIABLE_BuiltinTypes_21 = STATE_VARIABLE_BuiltinTypes_0_20;
        break;
      case (MR_Integer) 2:
        {
          ...
          mercury__set__insert_3_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_builtin_type_0), ((MR_Box) (BuiltinType_6)), STATE_VARIABLE_BuiltinTypes_0_20, STATE_VARIABLE_BuiltinTypes_21);
        }
        break;
      case (MR_Integer) 3:
        switch (((MR_Integer) ((MR_hl_field(3, Type_4, 0))))) {
          ...
          case (MR_Integer) 2:
            {
              MR_Word SubType_18 = ((MR_Word) ((MR_hl_field(3, Type_4, 1))));
  ...
  MR_Box * wrapper_arg_3)
{
  ...
  check_hlds__typecheck_error_builtin__IntroducedFrom__pred__acc_builtin_types_of_var__159__1_3_p_0(((MR_Word) (wrapper_arg_1)), ((MR_Word) (wrapper_arg_2)), &conv0_LambdaHeadVar__3_17);
...
check_hlds__typecheck_error_builtin__acc_builtin_types_of_var_4_p_0(
  ...
  MR_Word Var_6,
  MR_Word STATE_VARIABLE_BuiltinTypes_0_13,
  MR_Word * STATE_VARIABLE_BuiltinTypes_14)
{
  MR_Box conv1_STATE_VARIABLE_BuiltinTypes_14;

  check_hlds__typecheck_error_type_assign__acc_transformed_type_stuffs_5_p_0((MR_Word) (&check_hlds__typecheck_error_builtin_scalar_common_1[0]), (MR_Word) (&check_hlds__typecheck_error_builtin_scalar_common_4[0]), TypeAssignSet_5, Var_6, ((MR_Box) (STATE_VARIABLE_BuiltinTypes_0_13)), &conv1_STATE_VARIABLE_BuiltinTypes_14);
  *STATE_VARIABLE_BuiltinTypes_14 = ((MR_Word) (conv1_STATE_VARIABLE_BuiltinTypes_14));
}
