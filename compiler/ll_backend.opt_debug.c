...
ll_backend__opt_debug__IntroducedFrom__pred__write_instrs__211__1_4_p_0(
  ...
  MR_Word HeadVar__2_54)
{
  void MR_CALL (* func_0)(MR_Box, MR_Box, MR_Box, MR_Box, MR_Box *) = ((void MR_CALL (*)(MR_Box, MR_Box, MR_Box, MR_Box, MR_Box *)) ((MR_hl_field(0, (MR_hl_field(0, (MR_Word) (&ll_backend__opt_debug_scalar_common_1[0]), (MR_Integer) 0)), (MR_Integer) 6))));
