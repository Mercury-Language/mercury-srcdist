...
MR_decl_label10(fn__ll_backend__opt_debug__dump_instr_3_0, 150,157,156,161,162,164,165,160,166,167)
MR_decl_label10(fn__ll_backend__opt_debug__dump_instr_3_0, 168,169,170,171,172,159,175,176,174,179)
MR_decl_label10(fn__ll_backend__opt_debug__dump_instr_3_0, 180,178,184,183,189,190,191,192,193,194)
MR_decl_label10(fn__ll_backend__opt_debug__dump_instr_3_0, 195,196,197,198,199,200,201,187,205,204)
MR_decl_label10(fn__ll_backend__opt_debug__dump_instr_3_0, 207,182,210,211,209,214,215,216,217,218)
MR_decl_label10(fn__ll_backend__opt_debug__dump_instr_3_0, 213,222,223,224,225,227,228,229,230,231)
MR_decl_label10(fn__ll_backend__opt_debug__dump_instr_3_0, 232,233,234,235,236,237,238,239,240,220)
MR_decl_label10(fn__ll_backend__opt_debug__dump_instr_3_0, 244,245,246,247,248,249,250,251,252,253)
MR_decl_label10(fn__ll_backend__opt_debug__dump_instr_3_0, 254,242,257,258,256,261,262,260,265,266)
MR_decl_label10(fn__ll_backend__opt_debug__dump_instr_3_0, 264,269,270,268,273,274,272,277,278,279)
MR_decl_label10(fn__ll_backend__opt_debug__dump_instr_3_0, 280,281,282,285,283,287,288,289,290,291)
...
MR_def_label(fn__ll_backend__opt_debug__dump_components_2_0,8)
	...
	MR_r2 = MR_tfield(1, MR_r2, 1);
	MR_sv(1) = (MR_Word) MR_string_const("<alloc_id>", 10);
	MR_np_localcall_lab(fn__ll_backend__opt_debug__dump_components_2_0,
		fn__ll_backend__opt_debug__dump_components_2_0_i46);
...
MR_BEGIN_MODULE(ll_backend__opt_debug_module36)
	...
	MR_init_label10(fn__ll_backend__opt_debug__dump_instr_3_0,150,157,156,161,162,164,165,160,166,167)
	MR_init_label10(fn__ll_backend__opt_debug__dump_instr_3_0,168,169,170,171,172,159,175,176,174,179)
	MR_init_label10(fn__ll_backend__opt_debug__dump_instr_3_0,180,178,184,183,189,190,191,192,193,194)
	MR_init_label10(fn__ll_backend__opt_debug__dump_instr_3_0,195,196,197,198,199,200,201,187,205,204)
	MR_init_label10(fn__ll_backend__opt_debug__dump_instr_3_0,207,182,210,211,209,214,215,216,217,218)
	MR_init_label10(fn__ll_backend__opt_debug__dump_instr_3_0,213,222,223,224,225,227,228,229,230,231)
	MR_init_label10(fn__ll_backend__opt_debug__dump_instr_3_0,232,233,234,235,236,237,238,239,240,220)
	MR_init_label10(fn__ll_backend__opt_debug__dump_instr_3_0,244,245,246,247,248,249,250,251,252,253)
	MR_init_label10(fn__ll_backend__opt_debug__dump_instr_3_0,254,242,257,258,256,261,262,260,265,266)
	MR_init_label10(fn__ll_backend__opt_debug__dump_instr_3_0,264,269,270,268,273,274,272,277,278,279)
	MR_init_label10(fn__ll_backend__opt_debug__dump_instr_3_0,280,281,282,285,283,287,288,289,290,291)
MR_BEGIN_CODE
...
MR_def_label(fn__ll_backend__opt_debug__dump_instr_3_0,162)
	...
	if (MR_INT_NE(MR_r5,1)) {
		MR_GOTO_LAB(fn__ll_backend__opt_debug__dump_instr_3_0_i164);
	}
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r3;
...
MR_def_label(fn__ll_backend__opt_debug__dump_instr_3_0,164)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r5,0)) {
		MR_GOTO_LAB(fn__ll_backend__opt_debug__dump_instr_3_0_i165);
	}
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r3;
...
MR_def_label(fn__ll_backend__opt_debug__dump_instr_3_0,174)
	...
	if (MR_RTAGS_TESTR(MR_r3,3,22)) {
		MR_GOTO_LAB(fn__ll_backend__opt_debug__dump_instr_3_0_i178);
	}
	MR_r2 = MR_tfield(3, MR_r3, 1);
	MR_np_call_localret_ent(fn__ll_backend__opt_debug__dump_lval_2_0,
...
MR_def_label(fn__ll_backend__opt_debug__dump_instr_3_0,183)
	...
	if (MR_PTAG_TESTR(MR_sv(1),1)) {
		MR_GOTO_LAB(fn__ll_backend__opt_debug__dump_instr_3_0_i187);
	}
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_sv(1);
	...
	if (MR_LTAGS_TESTR(MR_r2,0,0)) {
		MR_GOTO_LAB(fn__ll_backend__opt_debug__dump_instr_3_0_i189);
	}
	MR_r2 = MR_tempr1;
	MR_sv(1) = MR_r1;
	MR_sv(2) = MR_tfield(1, MR_r2, 0);
...
MR_def_label(fn__ll_backend__opt_debug__dump_instr_3_0,187)
	...
	if (MR_INT_NE(MR_tempr1,0)) {
		MR_GOTO_LAB(fn__ll_backend__opt_debug__dump_instr_3_0_i204);
	}
	MR_r2 = (MR_Word) MR_string_const(")", 1);
	}
	MR_np_call_localret_ent(fn__f_115_116_114_105_110_103_95_95_43_43_2_0,
...
MR_def_label(fn__ll_backend__opt_debug__dump_instr_3_0,242)
	...
	if (MR_RTAGS_TESTR(MR_r3,3,21)) {
		MR_GOTO_LAB(fn__ll_backend__opt_debug__dump_instr_3_0_i256);
	}
	MR_r2 = MR_tfield(3, MR_r3, 1);
	MR_np_call_localret_ent(fn__ll_backend__opt_debug__dump_rval_2_0,
...
MR_def_label(fn__ll_backend__opt_debug__dump_instr_3_0,256)
	...
	if (MR_RTAGS_TESTR(MR_r3,3,14)) {
		MR_GOTO_LAB(fn__ll_backend__opt_debug__dump_instr_3_0_i260);
	}
	MR_r2 = MR_tfield(3, MR_r3, 1);
	MR_np_call_localret_ent(fn__ll_backend__opt_debug__dump_rval_2_0,
...
MR_def_label(fn__ll_backend__opt_debug__dump_instr_3_0,260)
	...
	if (MR_RTAGS_TESTR(MR_r3,3,11)) {
		MR_GOTO_LAB(fn__ll_backend__opt_debug__dump_instr_3_0_i264);
	}
	MR_r2 = MR_tfield(3, MR_r3, 1);
	MR_np_call_localret_ent(fn__ll_backend__opt_debug__dump_lval_2_0,
...
MR_def_label(fn__ll_backend__opt_debug__dump_instr_3_0,264)
	...
	if (MR_RTAGS_TESTR(MR_r3,3,10)) {
		MR_GOTO_LAB(fn__ll_backend__opt_debug__dump_instr_3_0_i268);
	}
	MR_r2 = MR_tfield(3, MR_r3, 1);
	MR_np_call_localret_ent(fn__ll_backend__opt_debug__dump_lval_2_0,
