  ...
  while (MR_TRUE)
  {
    /* tailcall optimized into a loop */
    {
      ...
      if (!((HeadVar__1_1 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))))))
      {
        ...
        {
          MR_Word next_value_of_HeadVar__1_1 = Instrs_12;
    ...
    switch (MR_tag((MR_Word) Const_5)) {
      ...
      case (MR_Integer) 3:
        switch (((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), Const_5, (MR_Integer) 0)))) {
          ...
          case (MR_Integer) 0:
            {
              MR_Integer I8_9 = ((MR_Integer) (MR_hl_field(MR_mktag(3), Const_5, (MR_Integer) 1)));

              Str_6 = mercury__string__int_to_string_1_f_0(I8_9);
            }
            break;
          case (MR_Integer) 1:
            {
              MR_Integer U8_10 = ((MR_Integer) (MR_hl_field(MR_mktag(3), Const_5, (MR_Integer) 1)));

              Str_6 = mercury__string__int_to_string_1_f_0(U8_10);
            }
            break;
          case (MR_Integer) 2:
            {
              MR_Integer I16_11 = ((MR_Integer) (MR_hl_field(MR_mktag(3), Const_5, (MR_Integer) 1)));

              Str_6 = mercury__string__int_to_string_1_f_0(I16_11);
            }
            break;
          case (MR_Integer) 3:
            {
              MR_Integer U16_12 = ((MR_Integer) (MR_hl_field(MR_mktag(3), Const_5, (MR_Integer) 1)));

              Str_6 = mercury__string__int_to_string_1_f_0(U16_12);
            }
            break;
          case (MR_Integer) 4:
            {
              MR_Integer I32_13 = ((MR_Integer) (MR_hl_field(MR_mktag(3), Const_5, (MR_Integer) 1)));

              Str_6 = mercury__string__int_to_string_1_f_0(I32_13);
            }
            break;
          case (MR_Integer) 5:
            {
              MR_Integer U32_14 = ((MR_Integer) (MR_hl_field(MR_mktag(3), Const_5, (MR_Integer) 1)));

              Str_6 = mercury__string__int_to_string_1_f_0(U32_14);
            }
            break;
          case (MR_Integer) 6:
            {
