...
MR_decl_label10(fn__ll_backend__opt_debug__dump_layout_name_1_0, 28,29,25,32,33,31,36,37,38,39)
MR_decl_label10(fn__ll_backend__opt_debug__dump_layout_name_1_0, 40,35,43,44,42,47,48,46,51,52)
MR_decl_label10(fn__ll_backend__opt_debug__dump_layout_name_1_0, 53,54,55,56,57,58,50,61,62,63)
MR_decl_label10(fn__ll_backend__opt_debug__dump_layout_name_1_0, 64,65,66,67,68,60,71,72,73,74)
MR_decl_label10(fn__ll_backend__opt_debug__dump_layout_name_1_0, 75,70,78,79,80,81,82,77,85,86)
MR_decl_label10(fn__ll_backend__opt_debug__dump_layout_name_1_0, 84,89,90,91,92,93,88,96,97,95)
MR_decl_label8(fn__ll_backend__opt_debug__dump_layout_name_1_0, 100,101,99,104,105,103,107,108)
...
MR_decl_label10(fn__ll_backend__opt_debug__dump_rval_2_0, 17,109,46,47,45,50,51,49,53,54)
MR_decl_label2(fn__ll_backend__opt_debug__dump_rval_2_0, 55,56)
...
MR_BEGIN_MODULE(ll_backend__opt_debug_module9)
	...
	MR_init_label10(fn__ll_backend__opt_debug__dump_layout_name_1_0,28,29,25,32,33,31,36,37,38,39)
	MR_init_label10(fn__ll_backend__opt_debug__dump_layout_name_1_0,40,35,43,44,42,47,48,46,51,52)
	MR_init_label10(fn__ll_backend__opt_debug__dump_layout_name_1_0,53,54,55,56,57,58,50,61,62,63)
	MR_init_label10(fn__ll_backend__opt_debug__dump_layout_name_1_0,64,65,66,67,68,60,71,72,73,74)
	MR_init_label10(fn__ll_backend__opt_debug__dump_layout_name_1_0,75,70,78,79,80,81,82,77,85,86)
	MR_init_label10(fn__ll_backend__opt_debug__dump_layout_name_1_0,84,89,90,91,92,93,88,96,97,95)
	MR_init_label8(fn__ll_backend__opt_debug__dump_layout_name_1_0,100,101,99,104,105,103,107,108)
MR_BEGIN_CODE
...
MR_def_label(fn__ll_backend__opt_debug__dump_layout_name_1_0,35)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_RTAGS_TESTR(MR_r1,3,6)) {
		MR_GOTO_LAB(fn__ll_backend__opt_debug__dump_layout_name_1_0_i42);
	}
	MR_r1 = MR_tfield(3, MR_r1, 1);
	MR_np_call_localret_ent(fn__parse_tree__prog_foreign__sym_name_mangle_1_0,
...
MR_def_label(fn__ll_backend__opt_debug__dump_layout_name_1_0,50)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_RTAGS_TESTR(MR_r1,3,10)) {
		MR_GOTO_LAB(fn__ll_backend__opt_debug__dump_layout_name_1_0_i60);
	}
	MR_sv(1) = MR_tfield(3, MR_r1, 2);
	MR_sv(2) = MR_tfield(3, MR_r1, 3);
	MR_r1 = MR_tfield(3, MR_r1, 1);
...
MR_def_label(fn__ll_backend__opt_debug__dump_layout_name_1_0,60)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_RTAGS_TESTR(MR_r1,3,8)) {
		MR_GOTO_LAB(fn__ll_backend__opt_debug__dump_layout_name_1_0_i70);
	}
	MR_sv(1) = MR_tfield(3, MR_r1, 2);
	MR_r1 = MR_tfield(3, MR_r1, 1);
	MR_np_call_localret_ent(fn__parse_tree__prog_foreign__sym_name_mangle_1_0,
...
MR_def_label(fn__ll_backend__opt_debug__dump_layout_name_1_0,70)
	...
	if (MR_RTAGS_TESTR(MR_r1,3,11)) {
		MR_GOTO_LAB(fn__ll_backend__opt_debug__dump_layout_name_1_0_i77);
	}
	MR_sv(1) = MR_tfield(3, MR_r1, 2);
	MR_r1 = MR_tfield(3, MR_r1, 1);
	MR_np_call_localret_ent(fn__parse_tree__prog_foreign__sym_name_mangle_1_0,
...
MR_def_label(fn__ll_backend__opt_debug__dump_layout_name_1_0,77)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_RTAGS_TESTR(MR_r1,3,3)) {
		MR_GOTO_LAB(fn__ll_backend__opt_debug__dump_layout_name_1_0_i84);
	}
	MR_r1 = MR_tfield(3, MR_r1, 1);
	MR_np_call_localret_ent(fn__parse_tree__prog_foreign__sym_name_mangle_1_0,
...
MR_def_label(fn__ll_backend__opt_debug__dump_layout_name_1_0,88)
	...
	if (MR_RTAGS_TESTR(MR_r1,3,13)) {
		MR_GOTO_LAB(fn__ll_backend__opt_debug__dump_layout_name_1_0_i95);
	}
	MR_r1 = MR_tfield(3, MR_r1, 1);
	MR_np_call_localret_ent(fn__parse_tree__prog_foreign__sym_name_mangle_1_0,
...
MR_def_label(fn__ll_backend__opt_debug__dump_layout_name_1_0,97)
	...
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
	MR_r1 = (MR_Word) MR_string_const("module_layout_oisu_bytes(", 25);
	MR_r2 = MR_tempr1;
	MR_succip_word = MR_sv(3);
	MR_decr_sp(3);
	MR_np_tailcall_ent(fn__f_115_116_114_105_110_103_95_95_43_43_2_0);
...
MR_def_label(fn__ll_backend__opt_debug__dump_layout_name_1_0,99)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_RTAGS_TESTR(MR_r1,3,2)) {
		MR_GOTO_LAB(fn__ll_backend__opt_debug__dump_layout_name_1_0_i103);
	}
	MR_r1 = MR_tfield(3, MR_r1, 1);
	MR_np_call_localret_ent(fn__parse_tree__prog_foreign__sym_name_mangle_1_0,
...
MR_def_label(fn__ll_backend__opt_debug__dump_layout_name_1_0,108)
	...
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
	MR_r1 = (MR_Word) MR_string_const("module_layout_type_table_bytes(", 31);
	MR_r2 = MR_tempr1;
	MR_succip_word = MR_sv(3);
	MR_decr_sp(3);
	MR_np_tailcall_ent(fn__f_115_116_114_105_110_103_95_95_43_43_2_0);
...
MR_BEGIN_MODULE(ll_backend__opt_debug_module17)
	...
	MR_init_label10(fn__ll_backend__opt_debug__dump_rval_2_0,17,109,46,47,45,50,51,49,53,54)
	MR_init_label2(fn__ll_backend__opt_debug__dump_rval_2_0,55,56)
MR_BEGIN_CODE
...
MR_def_label(fn__ll_backend__opt_debug__dump_rval_2_0,17)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_RTAGS_TESTR(MR_r2,3,1)) {
		MR_GOTO_LAB(fn__ll_backend__opt_debug__dump_rval_2_0_i109);
	}
	MR_r2 = MR_tfield(3, MR_r2, 1);
	MR_np_tailcall_ent(fn__ll_backend__opt_debug__dump_const_2_0);
MR_def_label(fn__ll_backend__opt_debug__dump_rval_2_0,109)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(5);
	MR_sv(5) = (MR_Word) MR_succip;
	if (MR_RTAGS_TESTR(MR_r2,3,4)) {
...
MR_def_label(fn__ll_backend__opt_debug__dump_rval_2_0,45)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_RTAGS_TESTR(MR_r2,3,0)) {
		MR_GOTO_LAB(fn__ll_backend__opt_debug__dump_rval_2_0_i49);
	}
	MR_r1 = MR_tfield(3, MR_r2, 1);
	MR_np_call_localret_ent(fn__string__int_to_string_1_0,
...
MR_def_label(fn__ll_backend__opt_debug__dump_rval_2_0,51)
	...
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
	MR_r1 = (MR_Word) MR_string_const("mkword_hole(", 12);
	MR_r2 = MR_tempr1;
	MR_succip_word = MR_sv(5);
	MR_decr_sp(5);
	MR_np_tailcall_ent(fn__f_115_116_114_105_110_103_95_95_43_43_2_0);
...
MR_def_label(fn__ll_backend__opt_debug__dump_rval_2_0,49)
	...
	MR_np_call_localret_ent(fn__ll_backend__opt_debug__dump_unop_1_0,
		fn__ll_backend__opt_debug__dump_rval_2_0_i53);
MR_def_label(fn__ll_backend__opt_debug__dump_rval_2_0,53)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_sv(4);
	...
	MR_np_localcall_lab(fn__ll_backend__opt_debug__dump_rval_2_0,
		fn__ll_backend__opt_debug__dump_rval_2_0_i54);
MR_def_label(fn__ll_backend__opt_debug__dump_rval_2_0,54)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = (MR_Word) MR_string_const(")", 1);
	MR_np_call_localret_ent(fn__f_115_116_114_105_110_103_95_95_43_43_2_0,
		fn__ll_backend__opt_debug__dump_rval_2_0_i55);
MR_def_label(fn__ll_backend__opt_debug__dump_rval_2_0,55)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
	...
	MR_np_call_localret_ent(fn__f_115_116_114_105_110_103_95_95_43_43_2_0,
		fn__ll_backend__opt_debug__dump_rval_2_0_i56);
...
void mercury__ll_backend__opt_debug__write_out_proc_statics(FILE *deep_fp, FILE *procrep_fp)
{
	MR_write_out_module_proc_reps_start(procrep_fp, &mercury_data__module_layout__ll_backend__opt_debug);
