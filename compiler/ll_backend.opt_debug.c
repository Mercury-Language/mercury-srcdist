          ...
          case (MR_Integer) 4:
            {
              ...
              succeeded = ((((MR_tag((MR_Word) N1_13)) == (MR_mktag((MR_Integer) 3)))) && ((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), N1_13, (MR_Integer) 0))) == (MR_Integer) 4)));
              if (succeeded)
              {
              }
              if (!(succeeded))
              {
                succeeded = ((((MR_tag((MR_Word) N2_14)) == (MR_mktag((MR_Integer) 3)))) && ((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), N2_14, (MR_Integer) 0))) == (MR_Integer) 4)));
                if (succeeded)
                {
                }
              }
