    ...
    switch (MR_tag((MR_Word) Const_5)) {
      ...
      case (MR_Integer) 3:
        switch (((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), Const_5, (MR_Integer) 0)))) {
          ...
          case (MR_Integer) 6:
            {
              MR_Integer I64_15 = ((MR_Integer) (MR_hl_field(MR_mktag(3), Const_5, (MR_Integer) 1)));

              Str_6 = mercury__string__int_to_string_1_f_0(I64_15);
            }
            break;
          case (MR_Integer) 7:
            {
              MR_Integer U64_16 = ((MR_Integer) (MR_hl_field(MR_mktag(3), Const_5, (MR_Integer) 1)));

              Str_6 = mercury__string__int_to_string_1_f_0(U64_16);
            }
            break;
          case (MR_Integer) 8:
            {
