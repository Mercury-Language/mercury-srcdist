...
MR_decl_label8(fn__ll_backend__opt_debug__dump_const_2_0, 4,5,6,8,9,10,56,13)
MR_decl_label8(fn__ll_backend__opt_debug__dump_const_2_0, 15,57,17,18,58,21,23,26)
MR_decl_label3(fn__ll_backend__opt_debug__dump_const_2_0, 27,28,29)
...
MR_BEGIN_MODULE(ll_backend__opt_debug_module14)
	...
	MR_init_label8(fn__ll_backend__opt_debug__dump_const_2_0,4,5,6,8,9,10,56,13)
	MR_init_label8(fn__ll_backend__opt_debug__dump_const_2_0,15,57,17,18,58,21,23,26)
	MR_init_label3(fn__ll_backend__opt_debug__dump_const_2_0,27,28,29)
MR_BEGIN_CODE
...
MR_def_label(fn__ll_backend__opt_debug__dump_const_2_0,9)
	...
	MR_COMPUTED_GOTO((MR_Unsigned) MR_ctfield(3, MR_r2, 0),
		...
		MR_LABEL_AP(fn__ll_backend__opt_debug__dump_const_2_0_i56) MR_AND
		MR_LABEL_AP(fn__ll_backend__opt_debug__dump_const_2_0_i15) MR_AND
		MR_LABEL_AP(fn__ll_backend__opt_debug__dump_const_2_0_i57) MR_AND
		MR_LABEL_AP(fn__ll_backend__opt_debug__dump_const_2_0_i58));
MR_def_label(fn__ll_backend__opt_debug__dump_const_2_0,10)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_ctfield(3, MR_r2, 1);
	MR_np_tailcall_ent(fn__string__float_to_string_1_0);
MR_def_label(fn__ll_backend__opt_debug__dump_const_2_0,56)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(2);
	MR_sv(2) = (MR_Word) MR_succip;
	MR_r1 = MR_ctfield(3, MR_r2, 1);
