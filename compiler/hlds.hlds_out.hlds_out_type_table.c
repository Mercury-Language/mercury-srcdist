    ...
    switch (AnyFieldName_12) {
      ...
      case (MR_Integer) 1:
        ...
        else
        {
          ...
          mercury__string__format__format_string_component_width_noprec_4_p_0((MR_Word) (&hlds__hlds_out__hlds_out_type_table_scalar_common_2[1]), (MR_Integer) 20, Var_37, &Var_47);
