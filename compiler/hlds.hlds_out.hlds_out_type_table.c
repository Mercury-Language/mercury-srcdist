  ...
  MR_Word TVarSet_12)
{
  ...
  IndentStr_15 = parse_tree__parse_tree_out_misc__indent_string_1_f_0((MR_Integer) 1);
    ...
    case (MR_Integer) 1:
      {
        ...
        Indent1Str_72 = parse_tree__parse_tree_out_misc__indent_string_1_f_0((MR_Integer) ((MR_Unsigned) 1 + (MR_Unsigned) 1));
  ...
  MR_Word TailCtorRepns_12)
{
  while (MR_TRUE)
  {
    // setup for model_det tailcalls optimized into a loop
    ;
    parse_tree__parse_tree_out_misc__write_indent_4_p_0(Stream_8, (MR_Integer) 1);
  ...
  MR_Word CtorRepn_8)
{
  ...
  Var_32 = parse_tree__parse_tree_out_misc__indent_string_1_f_0((MR_Integer) ((MR_Unsigned) 1 + (MR_Unsigned) 4));
  ...
  Var_40 = parse_tree__parse_tree_out_misc__indent_string_1_f_0((MR_Integer) ((MR_Unsigned) 1 + (MR_Unsigned) 4));
  ...
  {
    MR_Word HeadArgRepn_26 = ((MR_Word) ((MR_hl_field(1, ArgRepns_14, (MR_Integer) 0))));
    MR_Word TailArgRepns_27 = ((MR_Word) ((MR_hl_field(1, ArgRepns_14, (MR_Integer) 1))));
    ...
    parse_tree__parse_tree_out_misc__write_indent_4_p_0(Stream_6, (MR_Integer) ((MR_Unsigned) 1 + (MR_Unsigned) 4));
    mercury__io__write_string_4_p_0(Stream_6, (MR_String) ")");
    mercury__io__write_string_4_p_0(Stream_6, BraceSuffix_24);
    mercury__io__write_string_4_p_0(Stream_6, (MR_String) "\n");
  }
  ...
  MR_Word TailArgRepns_16)
{
  while (MR_TRUE)
  {
    ...
    // setup for model_det tailcalls optimized into a loop
    ;
    parse_tree__parse_tree_out_misc__write_indent_4_p_0(Stream_10, Indent_12);
...
hlds__hlds_out__hlds_out_type_table__write_arg_pos_width_6_p_0(
  ...
  MR_Word ArgPosWidth_10)
{
  parse_tree__parse_tree_out_misc__write_indent_4_p_0(Stream_7, Indent_8);
  ...
  MR_Word TailCtors_12)
{
  while (MR_TRUE)
  {
    ...
    if ((TailCtors_12 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      ...
      Var_42 = parse_tree__parse_tree_out_misc__indent_string_1_f_0((MR_Integer) ((MR_Unsigned) 1 + (MR_Unsigned) 4));
      parse_tree__parse_tree_out__maybe_cons_exist_constraints_to_prefix_suffix_6_p_0(TVarSet_9, Var_42, (MR_String) "\n", MaybeExistConstraints_25, &ExistConstraintsPrefix_34, &ExistConstraintsSuffix_35);
      parse_tree__parse_tree_out__maybe_brace_for_name_prefix_suffix_4_p_0(Arity_28, Name_30, &BracePrefix_36, &BraceSuffix_37);
      mercury__io__write_string_4_p_0(Stream_8, ExistConstraintsPrefix_34);
      if ((Args_27 == (MR_Word) ((MR_Unsigned) 0U)))
      {
        mercury__io__write_string_4_p_0(Stream_8, BracePrefix_36);
        mercury__io__write_string_4_p_0(Stream_8, NameStr_31);
        mercury__io__write_string_4_p_0(Stream_8, BraceSuffix_37);
      }
      else
      {
        MR_Word HeadArg_38 = ((MR_Word) ((MR_hl_field(1, Args_27, (MR_Integer) 0))));
        MR_Word TailArgs_39 = ((MR_Word) ((MR_hl_field(1, Args_27, (MR_Integer) 1))));
        MR_Word AnyFieldName_40;
        MR_Word Arg_84;
        MR_Word Args_85;
        MR_Word MaybeFieldName_87;

        mercury__io__write_string_4_p_0(Stream_8, BracePrefix_36);
        mercury__io__write_string_4_p_0(Stream_8, NameStr_31);
        mercury__io__write_string_4_p_0(Stream_8, (MR_String) "(\n");
        Arg_84 = ((MR_Word) ((MR_hl_field(1, Args_27, (MR_Integer) 0))));
        Args_85 = ((MR_Word) ((MR_hl_field(1, Args_27, (MR_Integer) 1))));
        MaybeFieldName_87 = ((MR_Word) ((MR_hl_field(0, Arg_84, (MR_Integer) 0))));
        if ((MaybeFieldName_87 == (MR_Word) ((MR_Unsigned) 0U)))
          AnyFieldName_40 = hlds__hlds_out__hlds_out_type_table__does_any_arg_have_a_field_name_1_f_0(Args_85);
        else
          AnyFieldName_40 = (MR_Integer) 1;
        hlds__hlds_out__hlds_out_type_table__mercury_output_ctor_args_8_p_0(Stream_8, TVarSet_9, (MR_Integer) ((MR_Unsigned) ((MR_Integer) ((MR_Unsigned) 1 + (MR_Unsigned) 4)) + (MR_Unsigned) 1), AnyFieldName_40, HeadArg_38, TailArgs_39);
        parse_tree__parse_tree_out_misc__write_indent_4_p_0(Stream_8, (MR_Integer) ((MR_Unsigned) 1 + (MR_Unsigned) 4));
        mercury__io__write_string_4_p_0(Stream_8, (MR_String) ")");
        mercury__io__write_string_4_p_0(Stream_8, BraceSuffix_37);
        mercury__io__write_string_4_p_0(Stream_8, (MR_String) "\n");
      }
      mercury__io__write_string_4_p_0(Stream_8, BraceSuffix_37);
      mercury__io__write_string_4_p_0(Stream_8, ExistConstraintsSuffix_35);
      mercury__io__write_string_4_p_0(Stream_8, (MR_String) "\n");
    }
    else
    {
  ...
  MR_Word Ctor_8)
{
  ...
  Var_30 = parse_tree__parse_tree_out_misc__indent_string_1_f_0((MR_Integer) ((MR_Unsigned) 1 + (MR_Unsigned) 4));
  ...
  {
    MR_Word HeadArg_24 = ((MR_Word) ((MR_hl_field(1, Args_13, (MR_Integer) 0))));
    MR_Word TailArgs_25 = ((MR_Word) ((MR_hl_field(1, Args_13, (MR_Integer) 1))));
    ...
    mercury__io__write_string_4_p_0(Stream_6, NameStr_17);
    mercury__io__write_string_4_p_0(Stream_6, (MR_String) "(\n");
    Arg_73 = ((MR_Word) ((MR_hl_field(1, Args_13, (MR_Integer) 0))));
    Args_74 = ((MR_Word) ((MR_hl_field(1, Args_13, (MR_Integer) 1))));
    MaybeFieldName_76 = ((MR_Word) ((MR_hl_field(0, Arg_73, (MR_Integer) 0))));
  ...
  MR_Word TailArgs_14)
{
  while (MR_TRUE)
  {
    ...
    // setup for model_det tailcalls optimized into a loop
    ;
    parse_tree__parse_tree_out_misc__write_indent_4_p_0(Stream_9, Indent_11);
