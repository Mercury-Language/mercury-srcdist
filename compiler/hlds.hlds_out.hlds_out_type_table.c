  ...
  MR_Word HeadVar__3_3)
{
  while (MR_TRUE)
  {
    ...
    if (!((HeadVar__3_3 == (MR_Word) ((MR_Unsigned) 0U))))
    {
      ...
      {
        MR_Word HeadParam_67 = ((MR_Word) ((MR_hl_field(MR_mktag(1), TypeParams_27, (MR_Integer) 0))));
        MR_Word TailParams_68 = ((MR_Word) ((MR_hl_field(MR_mktag(1), TypeParams_27, (MR_Integer) 1))));

        mercury__io__write_string_4_p_0(Stream_2, (MR_String) "(");
        parse_tree__parse_tree_out_term__mercury_output_var_6_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_tvar_type_0), TVarSet_26, (MR_Integer) 0, HeadParam_67, Stream_2);
        hlds__hlds_out__hlds_out_type_table__write_comma_type_params_loop_5_p_0(Stream_2, TVarSet_26, TailParams_68);
        mercury__io__write_string_4_p_0(Stream_2, (MR_String) ")");
      }
  ...
  MR_Word TailCtors_12)
{
  while (MR_TRUE)
  {
    ...
    {
      MR_Word MaybeExistConstraints_30 = ((MR_Word) ((MR_hl_field(MR_mktag(0), HeadCtor_11, (MR_Integer) 1))));
      MR_Word SymName_31 = ((MR_Word) ((MR_hl_field(MR_mktag(0), HeadCtor_11, (MR_Integer) 2))));
      MR_Word Args_32 = ((MR_Word) ((MR_hl_field(MR_mktag(0), HeadCtor_11, (MR_Integer) 3))));
      MR_Integer Arity_33 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), HeadCtor_11, (MR_Integer) 4))));
      MR_String Name_35;
      MR_String NameStr_36;
      MR_String ExistConstraintsPrefix_39;
      MR_String ExistConstraintsSuffix_40;
      MR_String BracePrefix_41;
      MR_String BraceSuffix_42;
      MR_String Var_47;

      Name_35 = mdbcomp__sym_name__unqualify_name_1_f_0(SymName_31);
      NameStr_36 = parse_tree__parse_tree_out_term__mercury_bracketed_atom_to_string_2_f_0((MR_Integer) 1, Name_35);
      Var_47 = hlds__hlds_out__hlds_out_util__indent_string_1_f_0((MR_Integer) ((MR_Unsigned) 1 + (MR_Unsigned) 4));
      parse_tree__parse_tree_out__maybe_cons_exist_constraints_to_prefix_suffix_6_p_0(TVarSet_9, Var_47, (MR_String) "\n", MaybeExistConstraints_30, &ExistConstraintsPrefix_39, &ExistConstraintsSuffix_40);
      parse_tree__parse_tree_out__maybe_brace_for_name_prefix_suffix_4_p_0(Arity_33, Name_35, &BracePrefix_41, &BraceSuffix_42);
      mercury__io__write_string_4_p_0(Stream_8, ExistConstraintsPrefix_39);
      if ((Args_32 == (MR_Word) ((MR_Unsigned) 0U)))
      {
        mercury__io__write_string_4_p_0(Stream_8, BracePrefix_41);
        mercury__io__write_string_4_p_0(Stream_8, NameStr_36);
        mercury__io__write_string_4_p_0(Stream_8, BraceSuffix_42);
      }
      else
      {
        MR_Word HeadArg_43 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Args_32, (MR_Integer) 0))));
        MR_Word TailArgs_44 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Args_32, (MR_Integer) 1))));
        MR_Word AnyFieldName_45;
        MR_Word Arg_91;
        MR_Word Args_92;
        ...
        Arg_91 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Args_32, (MR_Integer) 0))));
        Args_92 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Args_32, (MR_Integer) 1))));
        MaybeFieldName_94 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Arg_91, (MR_Integer) 0))));
        if ((MaybeFieldName_94 == (MR_Word) ((MR_Unsigned) 0U)))
          AnyFieldName_45 = hlds__hlds_out__hlds_out_type_table__does_any_arg_have_a_field_name_1_f_0(Args_92);
        else
          AnyFieldName_45 = (MR_Integer) 1;
        hlds__hlds_out__hlds_out_type_table__mercury_output_ctor_args_8_p_0(Stream_8, TVarSet_9, (MR_Integer) ((MR_Unsigned) ((MR_Integer) ((MR_Unsigned) 1 + (MR_Unsigned) 4)) + (MR_Unsigned) 1), AnyFieldName_45, HeadArg_43, TailArgs_44);
      ...
      mercury__io__write_string_4_p_0(Stream_8, BraceSuffix_42);
      mercury__io__write_string_4_p_0(Stream_8, ExistConstraintsSuffix_40);
      mercury__io__write_string_4_p_0(Stream_8, (MR_String) "\n");
    }
    else
    {
