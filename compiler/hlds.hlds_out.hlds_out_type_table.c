    ...
    case (MR_Integer) 1:
      {
        ...
        mercury__string__builder__append_string_3_p_0((MR_String) "% status ", STATE_VARIABLE_State_2_23, &Var_80);
        mercury__string__builder__append_string_3_p_0(Var_28, Var_80, &Var_82);
        mercury__string__builder__append_string_3_p_0((MR_String) "\n", Var_82, &STATE_VARIABLE_State_3_26);
      }
      break;
  }
