      ...
      case (MR_Integer) 2:
        {
          ...
          mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&hlds__hlds_out__hlds_out_type_table_scalar_common_2[0]), Var_77, &Var_389);
          mercury__io__write_string_4_p_0(Stream_7, Var_389);
          mercury__io__write_string_4_p_0(Stream_7, (MR_String) "/");
          mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&hlds__hlds_out__hlds_out_type_table_scalar_common_2[0]), Var_81, &Var_399);
          ...
          case (MR_Integer) 0:
            {
              ...
              mercury__string__format__format_cast_int_to_uint_2_p_0(MaskInt_25, &Var_267);
              mercury__string__format__format_uint_component_nowidth_noprec_4_p_0((MR_Word) (&hlds__hlds_out__hlds_out_type_table_scalar_common_2[0]), (MR_Integer) 2, Var_267, &Var_268);
              mercury__io__write_string_4_p_0(Stream_7, Var_268);
              mercury__io__write_string_4_p_0(Stream_7, (MR_String) " ");
          ...
          case (MR_Integer) 1:
            {
              ...
              mercury__io__write_string_4_p_0(Stream_7, (MR_String) " mask ");
              mercury__string__format__format_cast_int_to_uint_2_p_0(MaskInt_112, &Var_196);
              mercury__string__format__format_uint_component_nowidth_noprec_4_p_0((MR_Word) (&hlds__hlds_out__hlds_out_type_table_scalar_common_2[0]), (MR_Integer) 2, Var_196, &Var_197);
