  ...
  MR_Word HeadVar__3_3)
{
  while (MR_TRUE)
  {
    ...
    if (!((HeadVar__3_3 == (MR_Word) ((MR_Unsigned) 0U))))
    {
      ...
      MR_Word TypeCtor_19 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Type_13, (MR_Integer) 0))));
      MR_Word TypeDefn_20 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Type_13, (MR_Integer) 1))));
      MR_Word TVarSet_21;
      ...
      DumpOptions_26 = ((MR_String) ((MR_hl_field(MR_mktag(0), Info_1, (MR_Integer) 0))));
      ...
      if (((((MR_tag((MR_Word) TypeBody_23)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(MR_mktag(3), TypeBody_23, (MR_Integer) 0)))) == (MR_Integer) 1))))
      {
        MR_Word Var_40 = ((MR_Word) ((MR_hl_field(MR_mktag(3), TypeBody_23, (MR_Integer) 1))));

        succeeded = (Var_40 == (MR_Word) ((MR_Unsigned) 12U));
      }
      else
      if (((((MR_tag((MR_Word) TypeBody_23)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(MR_mktag(3), TypeBody_23, (MR_Integer) 0)))) == (MR_Integer) 0))))
        succeeded = MR_TRUE;
      else
        succeeded = MR_FALSE;
      if (succeeded)
      ...
      {
        MR_Word HeadParam_54 = ((MR_Word) ((MR_hl_field(MR_mktag(1), TypeParams_22, (MR_Integer) 0))));
        MR_Word TailParams_55 = ((MR_Word) ((MR_hl_field(MR_mktag(1), TypeParams_22, (MR_Integer) 1))));

        mercury__io__write_string_4_p_0(Stream_2, (MR_String) "(");
        parse_tree__parse_tree_out_term__mercury_output_var_6_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_tvar_type_0), TVarSet_21, (MR_Integer) 0, HeadParam_54, Stream_2);
    ...
    switch (AnyFieldName_13) {
      ...
      case (MR_Integer) 1:
        if ((MaybeFieldName_18 == (MR_Word) ((MR_Unsigned) 0U)))
        {
          ...
          mercury__string__format__format_string_component_width_noprec_4_p_0((MR_Word) (&hlds__hlds_out__hlds_out_type_table_scalar_common_2[0]), (MR_Integer) 24, (MR_String) "", &Var_62);
        ...
        else
        {
          ...
          mercury__string__format__format_string_component_width_noprec_4_p_0((MR_Word) (&hlds__hlds_out__hlds_out_type_table_scalar_common_2[1]), (MR_Integer) 20, Var_34, &Var_53);
  ...
  MR_Word TailCtors_12)
{
  while (MR_TRUE)
  {
    ...
    {
      MR_Word MaybeExistConstraints_24 = ((MR_Word) ((MR_hl_field(MR_mktag(0), HeadCtor_11, (MR_Integer) 1))));
      MR_Word SymName_25 = ((MR_Word) ((MR_hl_field(MR_mktag(0), HeadCtor_11, (MR_Integer) 2))));
      MR_Word Args_26 = ((MR_Word) ((MR_hl_field(MR_mktag(0), HeadCtor_11, (MR_Integer) 3))));
      MR_Integer Arity_27 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), HeadCtor_11, (MR_Integer) 4))));
      MR_String Name_29;
      ...
      Name_29 = mdbcomp__sym_name__unqualify_name_1_f_0(SymName_25);
      NameStr_30 = parse_tree__parse_tree_out_term__mercury_bracketed_atom_to_string_2_f_0((MR_Integer) 1, Name_29);
      Var_41 = hlds__hlds_out__hlds_out_util__indent_string_1_f_0((MR_Integer) ((MR_Unsigned) 1 + (MR_Unsigned) 4));
      parse_tree__parse_tree_out__maybe_cons_exist_constraints_to_prefix_suffix_6_p_0(TVarSet_9, Var_41, (MR_String) "\n", MaybeExistConstraints_24, &ExistConstraintsPrefix_33, &ExistConstraintsSuffix_34);
      parse_tree__parse_tree_out__maybe_brace_for_name_prefix_suffix_4_p_0(Arity_27, Name_29, &BracePrefix_35, &BraceSuffix_36);
      mercury__io__write_string_4_p_0(Stream_8, ExistConstraintsPrefix_33);
      if ((Args_26 == (MR_Word) ((MR_Unsigned) 0U)))
      {
        mercury__io__write_string_4_p_0(Stream_8, BracePrefix_35);
        mercury__io__write_string_4_p_0(Stream_8, NameStr_30);
        mercury__io__write_string_4_p_0(Stream_8, BraceSuffix_36);
      }
      else
      {
        MR_Word HeadArg_37 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Args_26, (MR_Integer) 0))));
        MR_Word TailArgs_38 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Args_26, (MR_Integer) 1))));
        MR_Word AnyFieldName_39;
        MR_Word Arg_83;
        MR_Word Args_84;
        MR_Word MaybeFieldName_86;

        mercury__io__write_string_4_p_0(Stream_8, BracePrefix_35);
        mercury__io__write_string_4_p_0(Stream_8, NameStr_30);
        mercury__io__write_string_4_p_0(Stream_8, (MR_String) "(\n");
        Arg_83 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Args_26, (MR_Integer) 0))));
        Args_84 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Args_26, (MR_Integer) 1))));
        MaybeFieldName_86 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Arg_83, (MR_Integer) 0))));
        if ((MaybeFieldName_86 == (MR_Word) ((MR_Unsigned) 0U)))
          AnyFieldName_39 = hlds__hlds_out__hlds_out_type_table__does_any_arg_have_a_field_name_1_f_0(Args_84);
        else
          AnyFieldName_39 = (MR_Integer) 1;
        hlds__hlds_out__hlds_out_type_table__mercury_output_ctor_args_8_p_0(Stream_8, TVarSet_9, (MR_Integer) ((MR_Unsigned) ((MR_Integer) ((MR_Unsigned) 1 + (MR_Unsigned) 4)) + (MR_Unsigned) 1), AnyFieldName_39, HeadArg_37, TailArgs_38);
      ...
      mercury__io__write_string_4_p_0(Stream_8, BraceSuffix_36);
      mercury__io__write_string_4_p_0(Stream_8, ExistConstraintsSuffix_34);
      mercury__io__write_string_4_p_0(Stream_8, (MR_String) "\n");
    }
    else
    {
    ...
    switch (AnyFieldName_12) {
      ...
      case (MR_Integer) 1:
        ...
        else
        {
          ...
          mercury__string__format__format_string_component_width_noprec_4_p_0((MR_Word) (&hlds__hlds_out__hlds_out_type_table_scalar_common_2[1]), (MR_Integer) 20, Var_31, &Var_46);
