...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), Msg_17, 0) = ((MR_Box) (Context_15));
      MR_hl_field(MR_mktag(1), Msg_17, 1) = ((MR_Box) (Var_51));
    }
    {
        ...
        {
          {
            ...
            succeeded = libs__globals__lookup_bool_option_3_p_1(Globals_28, (MR_Integer) 351, (MR_Integer) 0);
            if (succeeded)
            {
              Var_39 = (MR_Integer) 356;
              Var_40 = (MR_Integer) 0;
    ...
    if (succeeded)
    {
      ...
      else
      {
        ...
        hlds__hlds_pred__pred_info_get_context_2_p_0(PredInfo_4, &Context_9);
        {
          ...
          MR_hl_field(MR_mktag(1), Msg_11, 0) = ((MR_Box) (Context_9));
          MR_hl_field(MR_mktag(1), Msg_11, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &check_hlds__post_typecheck_scalar_common_1[66])));
        }
        {
...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), Msg_16, 0) = ((MR_Box) (Context_13));
      MR_hl_field(MR_mktag(1), Msg_16, 1) = ((MR_Box) (Var_59));
    }
    ...
    else
    {
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(2), ContextMsgsPrefix_22, 0) = ((MR_Box) (Var_64));
        ...
        MR_hl_field(MR_mktag(2), ContextMsgsPrefix_22, 3) = ((MR_Box) (Var_67));
      }
