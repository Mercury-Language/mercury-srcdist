  ...
  MR_Box * wrapper_arg_3)
{
  ...
  check_hlds__post_typecheck__IntroducedFrom__pred__bind_type_vars_to_void__503__1_3_p_0(((MR_Word) (wrapper_arg_1)), ((MR_Word) (wrapper_arg_2)), &conv3_LambdaHeadVar__3_25);
  ...
  MR_Word * STATE_VARIABLE_NoTypeErrorSpecs_28)
{
  ...
  if (succeeded)
  {
    ...
    else
    {
      ...
      MR_Word VarSet_137;
      MR_Word VarTypesMap0_138;
      MR_Word VarTypesList_139;
      MR_Word BindToVoidTVars0_140;
      MR_Word UnresolvedVarsTypes_141;
      MR_Word BindToVoidTVars_142;
      ...
      else
      {
        ...
        MR_Word TVarSet_67;
        MR_Word Context_68;
        MR_Word PredIdPieces_69;
        MR_Word MainPieces_70;
        MR_Word MainMsg_71;
        MR_Word ConstrainedGoals_72;
        MR_Word ContextMsgs_73;
        MR_Word Spec_79;
        MR_Word Var_85;
        MR_Word Var_86;
        MR_Word Var_87;
        ...
        hlds__hlds_pred__pred_info_get_typevarset_2_p_0(STATE_VARIABLE_PredInfo_0_21, &TVarSet_67);
        hlds__hlds_pred__pred_info_get_context_2_p_0(STATE_VARIABLE_PredInfo_0_21, &Context_68);
        PredIdPieces_69 = hlds__hlds_error_util__describe_one_pred_name_3_f_0(ModuleInfo_12, (MR_Integer) 1, PredId_14);
        conv0_Var_96 = parse_tree__error_util__choose_number_3_f_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_constraint_0), (MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), UnprovenConstraints_55, ((MR_Box) ((MR_String) "constraint:")), ((MR_Box) ((MR_String) "constraints:")));
        Var_96 = ((MR_String) (conv0_Var_96));
        Var_94 = mercury__string__f_43_43_2_f_0((MR_String) "type error: unsatisfied typeclass ", Var_96);
        {
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(1), Var_92, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &check_hlds__post_typecheck_scalar_common_1[23])));
        }
        {
          Var_90 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), Var_90, 0) = ((MR_Box) ((MR_Unsigned) 4U));
          MR_hl_field(MR_mktag(1), Var_90, 1) = ((MR_Box) (Var_92));
        }
        {
          Var_87 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), Var_87, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &check_hlds__post_typecheck_scalar_common_1[19])));
          MR_hl_field(MR_mktag(1), Var_87, 1) = ((MR_Box) (Var_90));
        }
        {
          Var_105 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), Var_105, 0) = ((MR_Box) (&check_hlds__post_typecheck_scalar_common_7[1]));
          MR_hl_field(MR_mktag(0), Var_105, 1) = ((MR_Box) (check_hlds__post_typecheck__post_typecheck_do_finish_pred_11_p_0_1));
          MR_hl_field(MR_mktag(0), Var_105, 2) = ((MR_Box) ((MR_Integer) 1));
          MR_hl_field(MR_mktag(0), Var_105, 3) = ((MR_Box) (TVarSet_67));
        }
        Var_104 = mercury__list__map_2_f_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_constraint_0), (MR_Word) (&check_hlds__post_typecheck_scalar_common_1[1]), Var_105, UnprovenConstraints_55);
        Var_103 = parse_tree__error_util__component_list_to_line_pieces_2_f_0(Var_104, (MR_Word) (MR_mkword(MR_mktag(1), &check_hlds__post_typecheck_scalar_common_1[25])));
        Var_86 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_format_component_0), Var_87, Var_103);
        Var_85 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_format_component_0), PredIdPieces_69, Var_86);
        MainPieces_70 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_format_component_0), (MR_Word) (MR_mkword(MR_mktag(1), &check_hlds__post_typecheck_scalar_common_1[21])), Var_85);
        {
          MainMsg_71 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), MainMsg_71, 0) = ((MR_Box) (Context_68));
          MR_hl_field(MR_mktag(0), MainMsg_71, 1) = ((MR_Box) (MainPieces_70));
        }
        ConstrainedGoals_72 = check_hlds__post_typecheck__find_constrained_goals_2_f_0(STATE_VARIABLE_PredInfo_0_21, UnprovenConstraints_55);
        if ((ConstrainedGoals_72 == (MR_Word) ((MR_Unsigned) 0U)))
          ContextMsgs_73 = (MR_Word) ((MR_Unsigned) 0U);
        else
        {
          MR_Word DueToPieces_76;
          MR_Word ContextMsgsPrefix_77;
          MR_Word ContextMsgsList_78;
          MR_Box conv2_DueToPieces_76;

          conv2_DueToPieces_76 = parse_tree__error_util__choose_number_3_f_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_constraint_0), (MR_Word) (&check_hlds__post_typecheck_scalar_common_1[1]), UnprovenConstraints_55, ((MR_Box) (MR_mkword(MR_mktag(1), &check_hlds__post_typecheck_scalar_common_1[27]))), ((MR_Box) (MR_mkword(MR_mktag(1), &check_hlds__post_typecheck_scalar_common_1[29]))));
          DueToPieces_76 = ((MR_Word) (conv2_DueToPieces_76));
          {
            ContextMsgsPrefix_77 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
            MR_hl_field(MR_mktag(0), ContextMsgsPrefix_77, 0) = ((MR_Box) (Context_68));
            MR_hl_field(MR_mktag(0), ContextMsgsPrefix_77, 1) = ((MR_Box) (DueToPieces_76));
          }
          ContextMsgsList_78 = check_hlds__post_typecheck__constrained_goals_to_error_msgs_2_f_0(ModuleInfo_12, ConstrainedGoals_72);
          {
            ContextMsgs_73 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), ContextMsgs_73, 0) = ((MR_Box) (ContextMsgsPrefix_77));
            MR_hl_field(MR_mktag(1), ContextMsgs_73, 1) = ((MR_Box) (ContextMsgsList_78));
          }
        }
        {
          Var_121 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), Var_121, 0) = ((MR_Box) (MainMsg_71));
          MR_hl_field(MR_mktag(1), Var_121, 1) = ((MR_Box) (ContextMsgs_73));
        }
        {
          Spec_79 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), Spec_79, 0) = ((MR_Box) ((MR_String) "predicate \140check_hlds.post_typecheck.report_unsatisfied_constraints\'/6"));
          MR_hl_field(MR_mktag(0), Spec_79, 1) = ((MR_Box) ((MR_Unsigned) 0U));
          MR_hl_field(MR_mktag(0), Spec_79, 2) = ((MR_Box) ((MR_Unsigned) 48U));
          MR_hl_field(MR_mktag(0), Spec_79, 3) = ((MR_Box) (Var_121));
        }
        {
          STATE_VARIABLE_NoTypeErrorSpecs_31_31 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), STATE_VARIABLE_NoTypeErrorSpecs_31_31, 0) = ((MR_Box) (Spec_79));
      ...
      hlds__hlds_pred__pred_info_get_clauses_info_2_p_0(STATE_VARIABLE_PredInfo_0_21, &ClausesInfo0_135);
      hlds__hlds_pred__pred_info_get_external_type_params_2_p_0(STATE_VARIABLE_PredInfo_0_21, &ExternalTypeParams_136);
      hlds__hlds_clauses__clauses_info_get_varset_2_p_0(ClausesInfo0_135, &VarSet_137);
      hlds__hlds_clauses__clauses_info_get_vartypes_2_p_0(ClausesInfo0_135, &VarTypesMap0_138);
      parse_tree__vartypes__vartypes_to_sorted_assoc_list_2_p_0(VarTypesMap0_138, &VarTypesList_139);
      mercury__set__init_1_p_0((MR_Word) (&check_hlds__post_typecheck_scalar_common_1[4]), &BindToVoidTVars0_140);
      check_hlds__post_typecheck__find_unresolved_types_in_vars_6_p_0(VarTypesList_139, ExternalTypeParams_136, (MR_Word) ((MR_Unsigned) 0U), &UnresolvedVarsTypes_141, BindToVoidTVars0_140, &BindToVoidTVars_142);
      if ((UnresolvedVarsTypes_141 == (MR_Word) ((MR_Unsigned) 0U)))
      {
      ...
      {
        MR_Word ProofMap0_145;
        MR_Word ConstraintMap0_146;
        MR_Word VarTypesMap_147;
        MR_Word ProofMap_148;
        MR_Word ConstraintMap_149;
        MR_Word ClausesInfo_150;
        MR_Word STATE_VARIABLE_PredInfo_33_153;
        MR_Word STATE_VARIABLE_PredInfo_34_154;
        MR_Word VoidSubst_171;
        MR_Word Var_176;
        MR_Box conv4_VoidSubst_171;

        check_hlds__post_typecheck__report_unresolved_type_warning_7_p_0(ModuleInfo_12, PredId_14, STATE_VARIABLE_PredInfo_0_21, VarSet_137, UnresolvedVarsTypes_141, STATE_VARIABLE_NoTypeErrorSpecs_31_31, &STATE_VARIABLE_NoTypeErrorSpecs_33_33);
        hlds__hlds_pred__pred_info_get_constraint_proof_map_2_p_0(STATE_VARIABLE_PredInfo_0_21, &ProofMap0_145);
        hlds__hlds_pred__pred_info_get_constraint_map_2_p_0(STATE_VARIABLE_PredInfo_0_21, &ConstraintMap0_146);
        Var_176 = mercury__map__init_0_f_0((MR_Word) (&check_hlds__post_typecheck_scalar_common_1[4]), (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0));
        mercury__set__fold_4_p_0((MR_Word) (&check_hlds__post_typecheck_scalar_common_1[4]), (MR_Word) (&check_hlds__post_typecheck_scalar_common_2[1]), (MR_Word) (&check_hlds__post_typecheck_scalar_common_2[4]), BindToVoidTVars_142, ((MR_Box) (Var_176)), &conv4_VoidSubst_171);
        VoidSubst_171 = ((MR_Word) (conv4_VoidSubst_171));
        parse_tree__vartypes__apply_subst_to_vartypes_3_p_0(VoidSubst_171, VarTypesMap0_138, &VarTypesMap_147);
        check_hlds__type_util__apply_subst_to_constraint_proof_map_3_p_0(VoidSubst_171, ProofMap0_145, &ProofMap_148);
        check_hlds__type_util__apply_subst_to_constraint_map_3_p_0(VoidSubst_171, ConstraintMap0_146, &ConstraintMap_149);
        hlds__hlds_clauses__clauses_info_set_vartypes_3_p_0(VarTypesMap_147, ClausesInfo0_135, &ClausesInfo_150);
        hlds__hlds_pred__pred_info_set_clauses_info_3_p_0(ClausesInfo_150, STATE_VARIABLE_PredInfo_0_21, &STATE_VARIABLE_PredInfo_33_153);
        hlds__hlds_pred__pred_info_set_constraint_proof_map_3_p_0(ProofMap_148, STATE_VARIABLE_PredInfo_33_153, &STATE_VARIABLE_PredInfo_34_154);
        hlds__hlds_pred__pred_info_set_constraint_map_3_p_0(ConstraintMap_149, STATE_VARIABLE_PredInfo_34_154, &STATE_VARIABLE_PredInfo_29_29);
      }
  ...
  MR_Word * STATE_VARIABLE_Specs_6)
{
  ...
  else
  {
    ...
    if ((Lang_29 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      ...
      check_hlds__post_typecheck__propagate_checked_types_into_lambda_modes_in_goal_6_p_0(ModuleInfo_1, VarTypes_2, Goal0_30, &Goal_31, STATE_VARIABLE_Specs_0_5, &STATE_VARIABLE_Specs_21_21);
      Var_38 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Clause0_14, (MR_Integer) 0))));
      Var_40 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Clause0_14, (MR_Integer) 2))));
      Var_41 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Clause0_14, (MR_Integer) 3))));
      Var_42 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Clause0_14, (MR_Integer) 4))));
      {
        Clause_16 = (MR_Word) MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), Clause_16, 0) = ((MR_Box) (Var_38));
        MR_hl_field(MR_mktag(0), Clause_16, 1) = ((MR_Box) (Goal_31));
        MR_hl_field(MR_mktag(0), Clause_16, 2) = ((MR_Box) (Var_40));
        MR_hl_field(MR_mktag(0), Clause_16, 3) = ((MR_Box) (Var_41));
        MR_hl_field(MR_mktag(0), Clause_16, 4) = ((MR_Box) (Var_42));
      }
    }
    else
    {
