...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(0), Spec_18, 1) = ((MR_Box) ((MR_Integer) 24));
...
{
  {
    ...
    if (succeeded)
    {
      ...
      else
      {
        ...
        if ((UnprovenConstraints0_49 == (MR_Word) ((MR_Integer) 0)))
        {
          *STATE_VARIABLE_NumBadErrors_23 = STATE_VARIABLE_NumBadErrors_0_22;
        ...
        check_hlds__post_typecheck__find_unresolved_types_in_vars_6_p_0(VarTypesList_69, ExternalTypeParams_66, (MR_Word) ((MR_Integer) 0), &UnresolvedVarsTypes_71, BindToVoidTVars0_70, &BindToVoidTVars_72);
        if ((UnresolvedVarsTypes_71 == (MR_Word) ((MR_Integer) 0)))
        {
...
{
  {
    ...
    else
    {
      ...
      check_hlds__post_typecheck__check_for_indistinguishable_modes_in_procs_8_p_0(ModuleInfo_7, PredId_8, ProcIds_13, (MR_Word) ((MR_Integer) 0), STATE_VARIABLE_PredInfo_0_14, STATE_VARIABLE_PredInfo_15, STATE_VARIABLE_Specs_0_16, STATE_VARIABLE_Specs_17);
    }
  }
}
...
check_hlds__post_typecheck__report_unbound_inst_vars_7_p_0(
  ...
  MR_Word * STATE_VARIABLE_Specs_20)
{
  if ((ErrorProcIds_10 == (MR_Word) ((MR_Integer) 0)))
  {
    ...
    if (succeeded)
    {
      ...
      else
      {
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(0), Spec_12, 1) = ((MR_Box) ((MR_Integer) 24));
...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), Var_42, 0) = ((MR_Box) ((MR_Integer) 4));
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), Var_37, 0) = ((MR_Box) ((MR_Integer) 4));
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(0), Spec_23, 1) = ((MR_Box) ((MR_Integer) 24));
  ...
  MR_Word * STATE_VARIABLE_BindToVoidTVars_17)
{
  while (MR_TRUE)
  {
    ...
    if ((LeftOverVarTypes_11 == (MR_Word) ((MR_Integer) 0)))
    {
...
{
  {
    ...
    Var_51 = parse_tree__error_util__component_list_to_line_pieces_2_f_0(Var_52, (MR_Word) ((MR_Integer) 0));
    ...
    if ((ConstrainedGoals_17 == (MR_Word) ((MR_Integer) 0)))
      ContextMsgs_18 = (MR_Word) ((MR_Integer) 0);
    else
    {
      MR_String DueTo_21;
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(0), Spec_24, 1) = ((MR_Box) ((MR_Integer) 24));
                ...
                case (MR_Integer) 1:
                  {
                    ...
                    }
                    {
                      ...
                      MR_hl_field(MR_mktag(1), CallPieces_93, 1) = ((MR_Box) ((MR_Integer) 0));
                    }
                    {
                      Pieces_6 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                      MR_hl_field(MR_mktag(1), Pieces_6, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &check_hlds__post_typecheck_scalar_common_1[47])));
...
{
  {
    ...
    mercury__list__foldl_4_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_constraint_0), (MR_Word) (&check_hlds__post_typecheck_scalar_common_1[3]), Var_25, Constraints_5, ((MR_Box) ((MR_Integer) 0)), &conv1_ConstraintIdSets_13);
...
{
  {
    ...
    check_hlds__post_typecheck__propagate_types_into_proc_modes_7_p_0(ModuleInfo_5, ProcIds_10, ArgTypes_8, (MR_Word) ((MR_Integer) 0), &RevErrorProcIds_11, Procs0_9, &Procs_12);
