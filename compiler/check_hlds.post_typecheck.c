                  ...
                  {
                    {
                      ...
                      {
                        check_hlds__post_typecheck__succeeded = libs__globals__lookup_bool_option_3_p_1(check_hlds__post_typecheck__Globals_28, (MR_Integer) 328, (MR_Integer) 0);
                      }
                      if (check_hlds__post_typecheck__succeeded)
                        {
                          check_hlds__post_typecheck__V_39_39 = (MR_Integer) 333;
...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), check_hlds__post_typecheck__V_99_99, 0) = ((MR_Box) (((MR_Integer) 48 | (((MR_Integer) 1 << (MR_Integer) 10)))));
