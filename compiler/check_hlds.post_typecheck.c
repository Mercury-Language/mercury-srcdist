        ...
        {
          {
            ...
            succeeded = libs__globals__lookup_bool_option_3_p_1(Globals_28, (MR_Integer) 355, (MR_Integer) 0);
            if (succeeded)
            {
              Var_39 = (MR_Integer) 360;
              Var_40 = (MR_Integer) 0;
...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(2), Spec_22, 3) = ((MR_Box) ((MR_Unsigned) 24U));
