  ...
  MR_Word * STATE_VARIABLE_NoTypeErrorSpecs_12)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      MR_Integer next_value_of_STATE_VARIABLE_NumBadErrors_0_7;
      ...
      *AddrOfHeadVar__4_53 = HeadVar__4_54;
      ...
      next_value_of_STATE_VARIABLE_NumBadErrors_0_7 = STATE_VARIABLE_NumBadErrors_1_49;
      ...
      STATE_VARIABLE_NumBadErrors_0_7 = next_value_of_STATE_VARIABLE_NumBadErrors_0_7;
    ...
    else
    {
      ...
      else
      {
        ...
        }
        {
          ...
          MR_hl_field(2, Spec_68, 2) = ((MR_Box) ((MR_Unsigned) 56U));
      ...
      else
      {
        ...
        hlds__type_util__apply_subst_to_constraint_proof_map_3_p_0(VoidSubst_140, ProofMap0_129, &ProofMap_131);
        hlds__type_util__apply_subst_to_constraint_map_3_p_0(VoidSubst_140, ConstraintMap0_130, &ConstraintMap_132);
