...
{
  {
    ...
    Pieces_16 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_format_component_0), (MR_Word) (MR_mkword(MR_mktag(1), &check_hlds__post_typecheck_scalar_common_1[57])), Var_31);
    {
      ...
      MR_hl_field(MR_mktag(1), Spec_17, 2) = ((MR_Box) ((MR_Unsigned) 32U));
...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(2), Spec_22, 3) = ((MR_Box) ((MR_Unsigned) 32U));
...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(0), Spec_24, 2) = ((MR_Box) ((MR_Unsigned) 32U));
