...
{
  {
    ...
    {
      MR_Word Var_18 = ((MR_Word) (MR_hl_field(MR_mktag(0), (env_ptr)->check_hlds__post_typecheck__IntroducedFrom__pred__find_constrained_goals__264__1_3_p_0_env_0__ConstraintId_17, (MR_Integer) 0)));
      MR_Integer Var_20;
        ...
        {
          {
            ...
            succeeded = libs__globals__lookup_bool_option_3_p_1(Globals_28, (MR_Integer) 336, (MR_Integer) 0);
            if (succeeded)
            {
              Var_39 = (MR_Integer) 341;
              Var_40 = (MR_Integer) 0;
