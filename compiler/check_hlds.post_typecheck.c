        ...
        {
          {
            ...
            succeeded = libs__globals__lookup_bool_option_3_p_1(Globals_28, (MR_Integer) 338, (MR_Integer) 0);
            if (succeeded)
            {
              Var_39 = (MR_Integer) 343;
              Var_40 = (MR_Integer) 0;
...
{
  {
    ...
    if (succeeded)
    {
      ...
      succeeded = ((MR_tag((MR_Word) ArgTypes_6)) == (MR_Integer) 1);
      if (succeeded)
      {
