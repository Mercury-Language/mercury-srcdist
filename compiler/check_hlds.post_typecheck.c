  ...
  MR_Word * STATE_VARIABLE_NoTypeErrorSpecs_28)
{
  ...
  if (succeeded)
  {
    ...
    else
    {
      ...
      hlds__vartypes__vartypes_to_sorted_assoc_list_2_p_0(VarTypesMap0_138, &VarTypesList_139);
      ...
      else
      {
        ...
        hlds__vartypes__apply_subst_to_vartypes_3_p_0(VoidSubst_171, VarTypesMap0_138, &VarTypesMap_147);
