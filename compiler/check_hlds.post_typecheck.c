...
MR_decl_label10(check_hlds__post_typecheck__resolve_unify_functor_16_0, 4,25,29,31,32,33,34,36,37,38)
...
MR_decl_static(fn__check_hlds__post_typecheck__IntroducedFrom__func__find_matching_constructor__1245__1_1_0)
MR_decl_static(fn__check_hlds__post_typecheck__IntroducedFrom__func__get_cons_id_arg_types_adding_existq_tvars__1413__1_1_0)
...
{
MR_COMMON(9,0),
MR_ENTRY_AP(fn__check_hlds__post_typecheck__IntroducedFrom__func__find_matching_constructor__1245__1_1_0),
0
},
{
MR_COMMON(9,1),
MR_ENTRY_AP(fn__check_hlds__post_typecheck__IntroducedFrom__func__get_cons_id_arg_types_adding_existq_tvars__1413__1_1_0),
0
},
};
...
MR_BEGIN_MODULE(check_hlds__post_typecheck_module38)
	...
	MR_init_label10(check_hlds__post_typecheck__resolve_unify_functor_16_0,4,25,29,31,32,33,34,36,37,38)
...
MR_def_label(check_hlds__post_typecheck__resolve_unify_functor_16_0,25)
	...
	MR_np_call_localret_ent(hlds__hlds_pred__pred_info_is_field_access_function_2_0,
		check_hlds__post_typecheck__resolve_unify_functor_16_0_i29);
MR_def_label(check_hlds__post_typecheck__resolve_unify_functor_16_0,29)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_r1) {
		MR_GOTO_LAB(check_hlds__post_typecheck__resolve_unify_functor_16_0_i20);
	}
	...
	MR_r1 = MR_sv(17);
	MR_np_call_localret_ent(hlds__hlds_pred__pred_info_get_markers_2_0,
		check_hlds__post_typecheck__resolve_unify_functor_16_0_i31);
MR_def_label(check_hlds__post_typecheck__resolve_unify_functor_16_0,31)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(9) = MR_r1;
	MR_r1 = MR_sv(16);
	MR_np_call_localret_ent(hlds__hlds_module__module_info_get_predicate_table_2_0,
		check_hlds__post_typecheck__resolve_unify_functor_16_0_i32);
MR_def_label(check_hlds__post_typecheck__resolve_unify_functor_16_0,32)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_sv(9);
	MR_sv(9) = MR_r1;
	MR_r1 = MR_r2;
	MR_np_call_localret_ent(fn__hlds__hlds_pred__calls_are_fully_qualified_1_0,
		check_hlds__post_typecheck__resolve_unify_functor_16_0_i33);
MR_def_label(check_hlds__post_typecheck__resolve_unify_functor_16_0,33)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
...
MR_BEGIN_MODULE(check_hlds__post_typecheck_module47)
	MR_init_entry1(fn__check_hlds__post_typecheck__IntroducedFrom__func__find_matching_constructor__1245__1_1_0);
	MR_INIT_PROC_LAYOUT_ADDR(mercury__fn__check_hlds__post_typecheck__IntroducedFrom__func__find_matching_constructor__1245__1_1_0);
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'IntroducedFrom__func__find_matching_constructor__1245__1'/2 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(fn__check_hlds__post_typecheck__IntroducedFrom__func__find_matching_constructor__1245__1_1_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_tfield(0, MR_r1, 1);
	MR_proceed();
#ifdef MR_maybe_local_thread_engine_base
...
MR_BEGIN_MODULE(check_hlds__post_typecheck_module48)
	MR_init_entry1(fn__check_hlds__post_typecheck__IntroducedFrom__func__get_cons_id_arg_types_adding_existq_tvars__1413__1_1_0);
	MR_INIT_PROC_LAYOUT_ADDR(mercury__fn__check_hlds__post_typecheck__IntroducedFrom__func__get_cons_id_arg_types_adding_existq_tvars__1413__1_1_0);
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'IntroducedFrom__func__get_cons_id_arg_types_adding_existq_tvars__1413__1'/2 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(fn__check_hlds__post_typecheck__IntroducedFrom__func__get_cons_id_arg_types_adding_existq_tvars__1413__1_1_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_tfield(0, MR_r1, 1);
	MR_proceed();
#ifdef MR_maybe_local_thread_engine_base
