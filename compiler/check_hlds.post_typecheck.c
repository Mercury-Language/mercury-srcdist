...
static void MR_CALL 
check_hlds__post_typecheck__LCMC__func__constrained_goals_to_error_msgs__1_3_p_0(
  MR_Word ModuleInfo_1,
  MR_Word HeadVar__2_2,
  ...
  MR_Word * STATE_VARIABLE_AnonVarMsgsCord_18)
{
  ...
  if (succeeded)
  {
    ...
    mercury__cord__snoc_list_3_p_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_error_msg_0), VarOriginMsgs_16, STATE_VARIABLE_AnonVarMsgsCord_0_17, STATE_VARIABLE_AnonVarMsgsCord_18);
  }
  else
  ...
  MR_Word * STATE_VARIABLE_NoTypeErrorSpecs_36)
{
  ...
  if (succeeded)
  {
    ...
    else
    {
      ...
      else
      {
        ...
        else
        {
          ...
          ContextMsgsList_66 = check_hlds__post_typecheck__constrained_goals_to_error_msgs_2_f_0(ModuleInfo_14, ConstrainedGoals_62);
          {
    ...
    *STATE_VARIABLE_NoTypeErrorSpecs_36 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_error_spec_0), InstForTypeSpecs_26, STATE_VARIABLE_NoTypeErrorSpecs_1_41);
  ...
  MR_Word HeadVar__2_2)
{
  ...
  else
  {
    ...
    check_hlds__post_typecheck__LCMC__func__constrained_goals_to_error_msgs__1_3_p_0(ModuleInfo_1, Goals_7, AddrMsgs_39);
  }
  return HeadVar__3_3;
}
