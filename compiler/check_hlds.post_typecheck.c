        ...
        {
          {
            ...
            succeeded = libs__globals__lookup_bool_option_3_p_1(Globals_28, (MR_Integer) 313, (MR_Integer) 0);
            if (succeeded)
            {
              Var_39 = (MR_Integer) 318;
              Var_40 = (MR_Integer) 0;
  ...
  MR_Word * STATE_VARIABLE_Specs_48)
{
  ...
  }
  {
    ...
    MR_hl_field(3, Spec_46, 1) = (MR_Box) (((((MR_Unsigned) ((MR_Integer) 212) << 1)) | (MR_Unsigned) ((MR_Integer) 1)));
