...
{
  {
    ...
    Pieces_16 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_format_component_0), (MR_Word) (MR_mkword(MR_mktag(1), &check_hlds__post_typecheck_scalar_common_1[38])), Var_31);
    {
      ...
      MR_hl_field(MR_mktag(1), Spec_17, 1) = ((MR_Box) ((MR_Unsigned) 24U));
      MR_hl_field(MR_mktag(1), Spec_17, 2) = ((MR_Box) (Context_15));
        ...
        {
          {
            ...
            succeeded = libs__globals__lookup_bool_option_3_p_1(Globals_28, (MR_Integer) 352, (MR_Integer) 0);
            if (succeeded)
            {
              Var_39 = (MR_Integer) 357;
              Var_40 = (MR_Integer) 0;
    ...
    if (succeeded)
    {
      ...
      else
      {
        ...
        hlds__hlds_pred__pred_info_get_context_2_p_0(PredInfo_4, &Context_9);
        {
          ...
          MR_hl_field(MR_mktag(1), Spec_11, 1) = ((MR_Box) ((MR_Unsigned) 24U));
          MR_hl_field(MR_mktag(1), Spec_11, 2) = ((MR_Box) (Context_9));
          MR_hl_field(MR_mktag(1), Spec_11, 3) = ((MR_Box) (MR_mkword(MR_mktag(1), &check_hlds__post_typecheck_scalar_common_1[32])));
        }
        {
          MR_Word base;
          base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), Var_99, 0) = (MR_Box) (((((MR_Unsigned) ((MR_Integer) 54) << 1)) | (MR_Unsigned) ((MR_Integer) 1)));
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), Msg_21, 1) = ((MR_Box) (Var_98));
    }
    {
...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), Var_72, 0) = ((MR_Box) (Msg_16));
      MR_hl_field(MR_mktag(1), Var_72, 1) = ((MR_Box) (ContextMsgs_18));
    }
    {
      ...
      MR_hl_field(MR_mktag(0), Spec_24, 2) = ((MR_Box) (Var_72));
    }
    {
      MR_Word base;
      base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
