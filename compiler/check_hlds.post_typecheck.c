...
MR_decl_label10(check_hlds__post_typecheck__in_interface_check_5_0, 145,4,5,7,9,10,11,13,3,19)
...
MR_decl_label3(check_hlds__post_typecheck__in_interface_check_5_0, 56,55,58)
...
MR_decl_label10(check_hlds__post_typecheck__post_typecheck_finish_promise_6_0, 4,5,6,7,11,8,3,15,16,17)
MR_decl_label10(check_hlds__post_typecheck__post_typecheck_finish_promise_6_0, 18,14,20,21,22,23,24,29,30,31)
MR_decl_label8(check_hlds__post_typecheck__post_typecheck_finish_promise_6_0, 33,34,2,35,36,39,41,38)
...
MR_decl_label10(fn__check_hlds__post_typecheck__describe_constrained_goal_2_0, 5,8,52,13,3,19,18,22,26,25)
MR_decl_label5(fn__check_hlds__post_typecheck__describe_constrained_goal_2_0, 29,32,35,38,41)
...
MR_BEGIN_MODULE(check_hlds__post_typecheck_module6)
	...
	MR_init_label10(fn__check_hlds__post_typecheck__describe_constrained_goal_2_0,5,8,52,13,3,19,18,22,26,25)
	MR_init_label5(fn__check_hlds__post_typecheck__describe_constrained_goal_2_0,29,32,35,38,41)
MR_BEGIN_CODE
...
MR_def_static(fn__check_hlds__post_typecheck__describe_constrained_goal_2_0)
	...
	if (MR_PTAG_TESTR(MR_r5,3)) {
		MR_GOTO_LAB(fn__check_hlds__post_typecheck__describe_constrained_goal_2_0_i5);
	}
	MR_r1 = (MR_Word) MR_TAG_COMMON(1,0,6);
	MR_proceed();
	}
MR_def_label(fn__check_hlds__post_typecheck__describe_constrained_goal_2_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_r5,1)) {
		MR_GOTO_LAB(fn__check_hlds__post_typecheck__describe_constrained_goal_2_0_i8);
	}
	{
	MR_Word MR_tempr1, MR_tempr2;
...
MR_def_label(fn__check_hlds__post_typecheck__describe_constrained_goal_2_0,8)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_r5,2)) {
		MR_GOTO_LAB(fn__check_hlds__post_typecheck__describe_constrained_goal_2_0_i13);
	}
MR_def_label(fn__check_hlds__post_typecheck__describe_constrained_goal_2_0,52)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_TAG_COMMON(1,0,6);
	MR_proceed();
...
MR_def_label(fn__check_hlds__post_typecheck__describe_constrained_goal_2_0,3)
	...
	if (MR_PTAG_TESTR(MR_r4,1)) {
		MR_GOTO_LAB(fn__check_hlds__post_typecheck__describe_constrained_goal_2_0_i18);
	}
	MR_incr_sp(1);
	...
	MR_np_call_localret_ent(fn__hlds__hlds_error_util__describe_one_pred_name_3_0,
		fn__check_hlds__post_typecheck__describe_constrained_goal_2_0_i19);
MR_def_label(fn__check_hlds__post_typecheck__describe_constrained_goal_2_0,19)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 2);
...
MR_def_label(fn__check_hlds__post_typecheck__describe_constrained_goal_2_0,18)
	...
	if (MR_PTAG_TESTR(MR_r4,0)) {
		MR_GOTO_LAB(fn__check_hlds__post_typecheck__describe_constrained_goal_2_0_i22);
	}
	MR_r1 = (MR_Word) MR_TAG_COMMON(1,0,6);
	MR_proceed();
MR_def_label(fn__check_hlds__post_typecheck__describe_constrained_goal_2_0,22)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	...
	MR_np_call_localret_ent(fn__hlds__hlds_error_util__describe_one_pred_name_3_0,
		fn__check_hlds__post_typecheck__describe_constrained_goal_2_0_i26);
...
MR_def_label(fn__check_hlds__post_typecheck__describe_constrained_goal_2_0,25)
	...
	if (MR_RTAGS_TESTR(MR_r4,3,1)) {
		MR_GOTO_LAB(fn__check_hlds__post_typecheck__describe_constrained_goal_2_0_i29);
	}
	MR_r1 = (MR_Word) MR_TAG_COMMON(1,0,6);
	MR_proceed();
MR_def_label(fn__check_hlds__post_typecheck__describe_constrained_goal_2_0,29)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_RTAGS_TESTR(MR_r4,3,2)) {
		MR_GOTO_LAB(fn__check_hlds__post_typecheck__describe_constrained_goal_2_0_i32);
	}
	MR_r1 = (MR_Word) MR_TAG_COMMON(1,0,6);
	MR_proceed();
MR_def_label(fn__check_hlds__post_typecheck__describe_constrained_goal_2_0,32)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_RTAGS_TESTR(MR_r4,3,6)) {
		MR_GOTO_LAB(fn__check_hlds__post_typecheck__describe_constrained_goal_2_0_i35);
	}
	MR_r1 = (MR_Word) MR_TAG_COMMON(1,0,6);
	MR_proceed();
MR_def_label(fn__check_hlds__post_typecheck__describe_constrained_goal_2_0,35)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_def_label(fn__check_hlds__post_typecheck__describe_constrained_goal_2_0,41)
	...
	if (MR_RTAGS_TESTR(MR_r4,3,7)) {
		MR_GOTO_LAB(fn__check_hlds__post_typecheck__describe_constrained_goal_2_0_i52);
	}
	MR_r1 = (MR_Word) MR_TAG_COMMON(1,0,6);
	MR_proceed();
#ifdef MR_maybe_local_thread_engine_base
...
MR_BEGIN_MODULE(check_hlds__post_typecheck_module22)
	...
	MR_init_label10(check_hlds__post_typecheck__in_interface_check_5_0,145,4,5,7,9,10,11,13,3,19)
	...
	MR_init_label3(check_hlds__post_typecheck__in_interface_check_5_0,56,55,58)
MR_BEGIN_CODE
...
MR_def_static(check_hlds__post_typecheck__in_interface_check_5_0)
	...
	MR_incr_sp(7);
	MR_sv(7) = (MR_Word) MR_succip;
MR_def_label(check_hlds__post_typecheck__in_interface_check_5_0,145)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tempr2 = MR_r3;
...
MR_def_label(check_hlds__post_typecheck__in_interface_check_5_0,26)
	...
	MR_r4 = MR_tempr1;
	MR_succip_word = MR_sv(7);
	MR_GOTO_LAB(check_hlds__post_typecheck__in_interface_check_5_0_i145);
	}
...
MR_def_label(check_hlds__post_typecheck__in_interface_check_5_0,55)
	...
	MR_np_call_localret_ent(fn__check_hlds__post_typecheck__this_file_0_0,
		check_hlds__post_typecheck__in_interface_check_5_0_i58);
...
MR_BEGIN_MODULE(check_hlds__post_typecheck_module25)
	...
	MR_init_label10(check_hlds__post_typecheck__post_typecheck_finish_promise_6_0,4,5,6,7,11,8,3,15,16,17)
	MR_init_label10(check_hlds__post_typecheck__post_typecheck_finish_promise_6_0,18,14,20,21,22,23,24,29,30,31)
	MR_init_label8(check_hlds__post_typecheck__post_typecheck_finish_promise_6_0,33,34,2,35,36,39,41,38)
MR_BEGIN_CODE
...
MR_def_label(check_hlds__post_typecheck__post_typecheck_finish_promise_6_0,3)
	...
	if (MR_INT_NE(MR_r1,3)) {
		MR_GOTO_LAB(check_hlds__post_typecheck__post_typecheck_finish_promise_6_0_i14);
	}
	MR_sv(1) = MR_r2;
	{
	MR_Word MR_tempr1;
...
MR_def_label(check_hlds__post_typecheck__post_typecheck_finish_promise_6_0,29)
	...
	MR_np_call_localret_ent(hlds__goal_util__predids_from_goal_2_0,
		check_hlds__post_typecheck__post_typecheck_finish_promise_6_0_i30);
...
MR_def_label(check_hlds__post_typecheck__post_typecheck_finish_promise_6_0,39)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(check_hlds__post_typecheck__post_typecheck_finish_promise_6_0_i38);
	}
	MR_r1 = MR_sv(3);
	MR_r2 = MR_sv(1);
	MR_r3 = MR_sv(2);
