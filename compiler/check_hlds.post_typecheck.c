  ...
  MR_Word * STATE_VARIABLE_Specs_25)
{
  ...
  Pieces_21 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), (MR_Word) (MR_mkword(1, &check_hlds__post_typecheck_scalar_common_1[14])), Var_42);
  {
    ...
    MR_hl_field(0, Spec_22, 0) = ((MR_Box) ((MR_String) "predicate \140check_hlds.post_typecheck.report_unbound_inst_var_error\'/7"));
    MR_hl_field(0, Spec_22, 1) = ((MR_Box) ((MR_Unsigned) 0U));
    MR_hl_field(0, Spec_22, 2) = ((MR_Box) ((MR_Unsigned) 52U));
    ...
    else
    {
      ...
      else
      {
        ...
        }
        {
          ...
          MR_hl_field(2, Spec_68, 3) = ((MR_Box) (Var_94));
        }
        {
      ...
      if (succeeded)
      {
        ...
        {
          {
            ...
            succeeded = libs__globals__lookup_bool_option_3_p_1(Globals_28, (MR_Integer) 510, (MR_Integer) 0);
            if (succeeded)
            {
              Var_39 = (MR_Integer) 515;
              Var_40 = (MR_Integer) 0;
        ...
        if (succeeded)
        {
          ...
          }
          {
            ...
            MR_hl_field(2, Spec_31, 0) = ((MR_Box) ((MR_String) "function \140check_hlds.post_typecheck.report_indistinguishable_modes_error\'/5"));
            MR_hl_field(2, Spec_31, 1) = ((MR_Box) ((MR_Unsigned) 0U));
            MR_hl_field(2, Spec_31, 2) = ((MR_Box) (MR_mkword(2, &check_hlds__post_typecheck_scalar_common_3[0])));
            MR_hl_field(2, Spec_31, 3) = ((MR_Box) (Var_83));
          }
          {
            MR_Word base;
            base = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
  ...
  if (succeeded)
  {
    ...
    else
    {
      ...
      hlds__hlds_pred__pred_info_get_context_2_p_0(PredInfo_4, &Context_9);
      {
        ...
        MR_hl_field(0, Spec_11, 4) = ((MR_Box) (MR_mkword(1, &check_hlds__post_typecheck_scalar_common_1[69])));
      }
      {
        MR_Word base;
        base = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
