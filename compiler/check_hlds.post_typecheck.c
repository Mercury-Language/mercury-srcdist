...
static /* final */ const MR_Box check_hlds__post_typecheck_scalar_common_2[5][3] = {
  ...
  /* row 3 */
  {
    (MR_Box) (((((MR_Unsigned) ((MR_Integer) 52) << (MR_Integer) 1)) | (MR_Unsigned) ((MR_Integer) 1))),
    ((MR_Box) ((MR_Unsigned) 4U)),
    ((MR_Box) ((MR_Unsigned) 0U))
  },
  /* row 4 */
...
{
  {
...

    {
      ...
      MR_Integer Var_20;
      MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), (env_ptr)->check_hlds__post_typecheck__IntroducedFrom__pred__find_constrained_goals__264__1_3_p_0_env_0__ConstraintId_17, (MR_Integer) 0)));
        ...
        {
          {
            ...
            succeeded = libs__globals__lookup_bool_option_3_p_1(Globals_28, (MR_Integer) 342, (MR_Integer) 0);
            if (succeeded)
            {
              Var_39 = (MR_Integer) 347;
              Var_40 = (MR_Integer) 0;
