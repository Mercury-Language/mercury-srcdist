  ...
  MR_Word * STATE_VARIABLE_NoTypeErrorSpecs_28)
{
  ...
  if (succeeded)
  {
    ...
    else
    {
      ...
      MR_Word UnprovenConstraints0_43;
      MR_Word ClausesInfo0_105;
      MR_Word ExternalTypeParams_106;
      MR_Word VarSet_107;
      MR_Word VarTypesMap0_108;
      MR_Word VarTypesList_109;
      MR_Word BindToVoidTVars0_110;
      MR_Word UnresolvedVarsTypes_111;
      MR_Word BindToVoidTVars_112;

      hlds__hlds_pred__pred_info_get_unproven_body_constraints_2_p_0(STATE_VARIABLE_PredInfo_0_21, &UnprovenConstraints0_43);
      if ((UnprovenConstraints0_43 == (MR_Word) ((MR_Unsigned) 0U)))
      {
        *STATE_VARIABLE_NumBadErrors_24 = STATE_VARIABLE_NumBadErrors_0_23;
      ...
      {
        MR_Word UnprovenConstraints_46;
        MR_Integer NumUnprovenConstraints_47;
        MR_Word TVarSet_49;
        MR_Word Context_50;
        MR_Word PredIdPieces_51;
        MR_Word MainPieces_52;
        MR_Word MainMsg_53;
        MR_Word ConstrainedGoals_54;
        MR_Word ContextMsgs_55;
        MR_Word Spec_59;
        MR_Word Var_62;
        MR_Word Var_63;
        MR_Word Var_64;
        ...
        MR_Word Var_78;
        MR_Word Var_85;
        MR_Word ClausesInfo_90;
        MR_Word ClausesRep_91;
        MR_Word Clauses_93;
        MR_Word ConstraintMap_94;
        MR_Word ReverseConstraintMap_95;
        MR_Word ConstraintIdSets_96;
        MR_Word ConstraintIds_97;
        MR_Word FindGoals_98;
        MR_Word Var_99;
        MR_Box conv0_Var_72;
        MR_Word _ItemNumbers_92;
        MR_Box conv3_ConstraintIdSets_96;

        mercury__list__sort_and_remove_dups_2_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_constraint_0), UnprovenConstraints0_43, &UnprovenConstraints_46);
        hlds__hlds_pred__pred_info_get_typevarset_2_p_0(STATE_VARIABLE_PredInfo_0_21, &TVarSet_49);
        hlds__hlds_pred__pred_info_get_context_2_p_0(STATE_VARIABLE_PredInfo_0_21, &Context_50);
        PredIdPieces_51 = hlds__hlds_error_util__describe_one_pred_name_3_f_0(ModuleInfo_12, (MR_Integer) 1, PredId_14);
        conv0_Var_72 = parse_tree__error_util__choose_number_3_f_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_constraint_0), (MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), UnprovenConstraints_46, ((MR_Box) ((MR_String) "constraint:")), ((MR_Box) ((MR_String) "constraints:")));
        Var_72 = ((MR_String) (conv0_Var_72));
        Var_70 = mercury__string__f_43_43_2_f_0((MR_String) "type error: unsatisfied typeclass ", Var_72);
        {
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(1), Var_68, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &check_hlds__post_typecheck_scalar_common_1[23])));
        }
        {
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(1), Var_64, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &check_hlds__post_typecheck_scalar_common_1[19])));
          MR_hl_field(MR_mktag(1), Var_64, 1) = ((MR_Box) (Var_66));
        }
        {
          Var_78 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), Var_78, 0) = ((MR_Box) (&check_hlds__post_typecheck_scalar_common_6[0]));
          MR_hl_field(MR_mktag(0), Var_78, 1) = ((MR_Box) (check_hlds__post_typecheck__post_typecheck_do_finish_pred_11_p_0_1));
          MR_hl_field(MR_mktag(0), Var_78, 2) = ((MR_Box) ((MR_Integer) 1));
          MR_hl_field(MR_mktag(0), Var_78, 3) = ((MR_Box) (TVarSet_49));
        }
        Var_77 = mercury__list__map_2_f_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_constraint_0), (MR_Word) (&check_hlds__post_typecheck_scalar_common_1[1]), Var_78, UnprovenConstraints_46);
        Var_76 = parse_tree__error_util__component_list_to_line_pieces_2_f_0(Var_77, (MR_Word) (MR_mkword(MR_mktag(1), &check_hlds__post_typecheck_scalar_common_1[25])));
        Var_63 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_format_component_0), Var_64, Var_76);
        Var_62 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_format_component_0), PredIdPieces_51, Var_63);
        MainPieces_52 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_format_component_0), (MR_Word) (MR_mkword(MR_mktag(1), &check_hlds__post_typecheck_scalar_common_1[21])), Var_62);
        {
          MainMsg_53 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), MainMsg_53, 0) = ((MR_Box) (Context_50));
          MR_hl_field(MR_mktag(0), MainMsg_53, 1) = ((MR_Box) (MainPieces_52));
        }
        hlds__hlds_pred__pred_info_get_clauses_info_2_p_0(STATE_VARIABLE_PredInfo_0_21, &ClausesInfo_90);
        hlds__hlds_clauses__clauses_info_get_clauses_rep_3_p_0(ClausesInfo_90, &ClausesRep_91, &_ItemNumbers_92);
        hlds__hlds_clauses__get_clause_list_maybe_repeated_2_p_0(ClausesRep_91, &Clauses_93);
        hlds__hlds_pred__pred_info_get_constraint_map_2_p_0(STATE_VARIABLE_PredInfo_0_21, &ConstraintMap_94);
        ReverseConstraintMap_95 = mercury__map__reverse_map_1_f_0((MR_Word) (&hlds__hlds_class__hlds__hlds_class__type_ctor_info_constraint_id_0), (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_constraint_0), ConstraintMap_94);
        {
          Var_99 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), Var_99, 0) = ((MR_Box) (&check_hlds__post_typecheck_scalar_common_7[0]));
          MR_hl_field(MR_mktag(0), Var_99, 1) = ((MR_Box) (check_hlds__post_typecheck__post_typecheck_do_finish_pred_11_p_0_2));
          MR_hl_field(MR_mktag(0), Var_99, 2) = ((MR_Box) ((MR_Integer) 1));
          MR_hl_field(MR_mktag(0), Var_99, 3) = ((MR_Box) (ReverseConstraintMap_95));
        }
        mercury__list__foldl_4_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_constraint_0), (MR_Word) (&check_hlds__post_typecheck_scalar_common_1[3]), Var_99, UnprovenConstraints_46, ((MR_Box) ((MR_Unsigned) 0U)), &conv3_ConstraintIdSets_96);
        ConstraintIdSets_96 = ((MR_Word) (conv3_ConstraintIdSets_96));
        ConstraintIds_97 = mercury__set__union_list_1_f_0((MR_Word) (&hlds__hlds_class__hlds__hlds_class__type_ctor_info_constraint_id_0), ConstraintIdSets_96);
        {
          FindGoals_98 = (MR_Word) MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), FindGoals_98, 0) = ((MR_Box) (&check_hlds__post_typecheck_scalar_common_6[1]));
          MR_hl_field(MR_mktag(0), FindGoals_98, 1) = ((MR_Box) (check_hlds__post_typecheck__post_typecheck_do_finish_pred_11_p_0_4));
          MR_hl_field(MR_mktag(0), FindGoals_98, 2) = ((MR_Box) ((MR_Integer) 2));
          MR_hl_field(MR_mktag(0), FindGoals_98, 3) = ((MR_Box) (Clauses_93));
          MR_hl_field(MR_mktag(0), FindGoals_98, 4) = ((MR_Box) (ConstraintIds_97));
        }
        mercury__solutions__solutions_2_p_1((MR_Word) (&hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_hlds_goal_0), FindGoals_98, &ConstrainedGoals_54);
        if ((ConstrainedGoals_54 == (MR_Word) ((MR_Unsigned) 0U)))
          ContextMsgs_55 = (MR_Word) ((MR_Unsigned) 0U);
        else
        {
          MR_Word DueToPieces_56;
          MR_Word ContextMsgsPrefix_57;
          MR_Word ContextMsgsList_58;
          MR_Box conv5_DueToPieces_56;

          conv5_DueToPieces_56 = parse_tree__error_util__choose_number_3_f_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_constraint_0), (MR_Word) (&check_hlds__post_typecheck_scalar_common_1[1]), UnprovenConstraints_46, ((MR_Box) (MR_mkword(MR_mktag(1), &check_hlds__post_typecheck_scalar_common_1[27]))), ((MR_Box) (MR_mkword(MR_mktag(1), &check_hlds__post_typecheck_scalar_common_1[29]))));
          DueToPieces_56 = ((MR_Word) (conv5_DueToPieces_56));
          {
            ContextMsgsPrefix_57 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
            MR_hl_field(MR_mktag(0), ContextMsgsPrefix_57, 0) = ((MR_Box) (Context_50));
            MR_hl_field(MR_mktag(0), ContextMsgsPrefix_57, 1) = ((MR_Box) (DueToPieces_56));
          }
          ContextMsgsList_58 = check_hlds__post_typecheck__constrained_goals_to_error_msgs_2_f_0(ModuleInfo_12, ConstrainedGoals_54);
          {
            ContextMsgs_55 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), ContextMsgs_55, 0) = ((MR_Box) (ContextMsgsPrefix_57));
            MR_hl_field(MR_mktag(1), ContextMsgs_55, 1) = ((MR_Box) (ContextMsgsList_58));
          }
        }
        {
          Var_85 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), Var_85, 0) = ((MR_Box) (MainMsg_53));
          MR_hl_field(MR_mktag(1), Var_85, 1) = ((MR_Box) (ContextMsgs_55));
        }
        {
          Spec_59 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), Spec_59, 0) = ((MR_Box) ((MR_String) "predicate \140check_hlds.post_typecheck.report_unsatisfied_constraints\'/6"));
          MR_hl_field(MR_mktag(0), Spec_59, 1) = ((MR_Box) ((MR_Unsigned) 0U));
          MR_hl_field(MR_mktag(0), Spec_59, 2) = ((MR_Box) ((MR_Unsigned) 48U));
          MR_hl_field(MR_mktag(0), Spec_59, 3) = ((MR_Box) (Var_85));
        }
        {
          STATE_VARIABLE_NoTypeErrorSpecs_31_31 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), STATE_VARIABLE_NoTypeErrorSpecs_31_31, 0) = ((MR_Box) (Spec_59));
          MR_hl_field(MR_mktag(1), STATE_VARIABLE_NoTypeErrorSpecs_31_31, 1) = ((MR_Box) (STATE_VARIABLE_NoTypeErrorSpecs_0_27));
        }
        mercury__list__length_2_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_constraint_0), UnprovenConstraints_46, &NumUnprovenConstraints_47);
        *STATE_VARIABLE_NumBadErrors_24 = (MR_Integer) ((MR_Unsigned) STATE_VARIABLE_NumBadErrors_0_23 + (MR_Unsigned) NumUnprovenConstraints_47);
      }
      hlds__hlds_pred__pred_info_get_clauses_info_2_p_0(STATE_VARIABLE_PredInfo_0_21, &ClausesInfo0_105);
      hlds__hlds_pred__pred_info_get_external_type_params_2_p_0(STATE_VARIABLE_PredInfo_0_21, &ExternalTypeParams_106);
      hlds__hlds_clauses__clauses_info_get_varset_2_p_0(ClausesInfo0_105, &VarSet_107);
      hlds__hlds_clauses__clauses_info_get_vartypes_2_p_0(ClausesInfo0_105, &VarTypesMap0_108);
      parse_tree__vartypes__vartypes_to_sorted_assoc_list_2_p_0(VarTypesMap0_108, &VarTypesList_109);
      mercury__set__init_1_p_0((MR_Word) (&check_hlds__post_typecheck_scalar_common_1[4]), &BindToVoidTVars0_110);
      check_hlds__post_typecheck__find_unresolved_types_in_vars_6_p_0(VarTypesList_109, ExternalTypeParams_106, (MR_Word) ((MR_Unsigned) 0U), &UnresolvedVarsTypes_111, BindToVoidTVars0_110, &BindToVoidTVars_112);
      if ((UnresolvedVarsTypes_111 == (MR_Word) ((MR_Unsigned) 0U)))
      {
      ...
      {
        MR_Word ProofMap0_115;
        MR_Word ConstraintMap0_116;
        MR_Word VarTypesMap_117;
        MR_Word ProofMap_118;
        MR_Word ConstraintMap_119;
        MR_Word ClausesInfo_120;
        MR_Word STATE_VARIABLE_PredInfo_33_122;
        MR_Word STATE_VARIABLE_PredInfo_34_123;
        MR_Word TypeVarSet_125;
        MR_Word Context_126;
        MR_Word PredIdPieces_127;
        MR_Word VarTypePieceLists_128;
        MR_Word VarTypePieces_129;
        MR_Word MainPieces_130;
        MR_Word Msg_132;
        MR_Word Spec_133;
        MR_Word Var_135;
        MR_Word Var_137;
        ...
        MR_Word Var_164;
        MR_Word Var_174;
        MR_Word VoidSubst_180;
        MR_Word Var_181;
        MR_Box conv7_Var_148;
        MR_Box conv8_Var_159;
        MR_Box conv10_VoidSubst_180;

        hlds__hlds_pred__pred_info_get_typevarset_2_p_0(STATE_VARIABLE_PredInfo_0_21, &TypeVarSet_125);
        hlds__hlds_pred__pred_info_get_context_2_p_0(STATE_VARIABLE_PredInfo_0_21, &Context_126);
        PredIdPieces_127 = hlds__hlds_error_util__describe_one_pred_name_3_f_0(ModuleInfo_12, (MR_Integer) 1, PredId_14);
        {
          Var_135 = (MR_Word) MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), Var_135, 0) = ((MR_Box) (&check_hlds__post_typecheck_scalar_common_7[1]));
          MR_hl_field(MR_mktag(0), Var_135, 1) = ((MR_Box) (check_hlds__post_typecheck__post_typecheck_do_finish_pred_11_p_0_5));
          MR_hl_field(MR_mktag(0), Var_135, 2) = ((MR_Box) ((MR_Integer) 2));
          MR_hl_field(MR_mktag(0), Var_135, 3) = ((MR_Box) (VarSet_107));
          MR_hl_field(MR_mktag(0), Var_135, 4) = ((MR_Box) (TypeVarSet_125));
        }
        VarTypePieceLists_128 = mercury__list__map_2_f_0((MR_Word) (&check_hlds__post_typecheck_scalar_common_2[2]), (MR_Word) (&check_hlds__post_typecheck_scalar_common_1[1]), Var_135, UnresolvedVarsTypes_111);
        mercury__list__condense_2_p_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_format_component_0), VarTypePieceLists_128, &VarTypePieces_129);
        conv7_Var_148 = parse_tree__error_util__choose_number_3_f_0((MR_Word) (&check_hlds__post_typecheck_scalar_common_2[2]), (MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), UnresolvedVarsTypes_111, ((MR_Box) ((MR_String) "The variable with an unbound type was:")), ((MR_Box) ((MR_String) "The variables with unbound types were:")));
        Var_148 = ((MR_String) (conv7_Var_148));
        {
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(1), Var_146, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &check_hlds__post_typecheck_scalar_common_1[23])));
        }
        {
          Var_144 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), Var_144, 0) = ((MR_Box) ((MR_Unsigned) 4U));
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(1), Var_142, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &check_hlds__post_typecheck_scalar_common_1[38])));
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(1), Var_141, 0) = ((MR_Box) ((MR_Unsigned) 4U));
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(1), Var_139, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &check_hlds__post_typecheck_scalar_common_1[19])));
          MR_hl_field(MR_mktag(1), Var_139, 1) = ((MR_Box) (Var_141));
        }
        conv8_Var_159 = parse_tree__error_util__choose_number_3_f_0((MR_Word) (&check_hlds__post_typecheck_scalar_common_2[2]), (MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), UnresolvedVarsTypes_111, ((MR_Box) ((MR_String) "variable")), ((MR_Box) ((MR_String) "variables")));
        Var_159 = ((MR_String) (conv8_Var_159));
        {
          Var_158 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(3), Var_158, 0) = ((MR_Box) ((MR_Unsigned) 5U));
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(1), Var_157, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &check_hlds__post_typecheck_scalar_common_1[44])));
        }
        {
          Var_155 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), Var_155, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &check_hlds__post_typecheck_scalar_common_1[39])));
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(1), Var_153, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &check_hlds__post_typecheck_scalar_common_1[24])));
          MR_hl_field(MR_mktag(1), Var_153, 1) = ((MR_Box) (Var_155));
        }
        Var_152 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_format_component_0), VarTypePieces_129, Var_153);
        Var_138 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_format_component_0), Var_139, Var_152);
        Var_137 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_format_component_0), PredIdPieces_127, Var_138);
        MainPieces_130 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_format_component_0), (MR_Word) (MR_mkword(MR_mktag(1), &check_hlds__post_typecheck_scalar_common_1[21])), Var_137);
        {
          Var_164 = (MR_Word) MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), Var_164, 0) = ((MR_Box) (MainPieces_130));
        }
        {
          ...
          MR_hl_field(MR_mktag(1), Var_163, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &check_hlds__post_typecheck_scalar_common_1[80])));
        }
        {
          Msg_132 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(2), Msg_132, 0) = ((MR_Box) (Context_126));
          MR_hl_field(MR_mktag(2), Msg_132, 1) = ((MR_Box) (Var_163));
        }
        {
          Var_174 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), Var_174, 0) = ((MR_Box) (Msg_132));
          MR_hl_field(MR_mktag(1), Var_174, 1) = ((MR_Box) ((MR_Unsigned) 0U));
        }
        {
          Spec_133 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(3), Spec_133, 0) = ((MR_Box) ((MR_String) "predicate \140check_hlds.post_typecheck.report_unresolved_type_warning\'/7"));
          MR_hl_field(MR_mktag(3), Spec_133, 1) = (MR_Box) (((((MR_Unsigned) ((MR_Integer) 57) << 1)) | (MR_Unsigned) ((MR_Integer) 1)));
          MR_hl_field(MR_mktag(3), Spec_133, 2) = ((MR_Box) ((MR_Unsigned) 4U));
          MR_hl_field(MR_mktag(3), Spec_133, 3) = ((MR_Box) ((MR_Unsigned) 48U));
          MR_hl_field(MR_mktag(3), Spec_133, 4) = ((MR_Box) (Var_174));
        }
        {
          STATE_VARIABLE_NoTypeErrorSpecs_33_33 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), STATE_VARIABLE_NoTypeErrorSpecs_33_33, 0) = ((MR_Box) (Spec_133));
          MR_hl_field(MR_mktag(1), STATE_VARIABLE_NoTypeErrorSpecs_33_33, 1) = ((MR_Box) (STATE_VARIABLE_NoTypeErrorSpecs_31_31));
        }
        hlds__hlds_pred__pred_info_get_constraint_proof_map_2_p_0(STATE_VARIABLE_PredInfo_0_21, &ProofMap0_115);
        hlds__hlds_pred__pred_info_get_constraint_map_2_p_0(STATE_VARIABLE_PredInfo_0_21, &ConstraintMap0_116);
        Var_181 = mercury__map__init_0_f_0((MR_Word) (&check_hlds__post_typecheck_scalar_common_1[4]), (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0));
        mercury__set__fold_4_p_0((MR_Word) (&check_hlds__post_typecheck_scalar_common_1[4]), (MR_Word) (&check_hlds__post_typecheck_scalar_common_2[1]), (MR_Word) (&check_hlds__post_typecheck_scalar_common_2[4]), BindToVoidTVars_112, ((MR_Box) (Var_181)), &conv10_VoidSubst_180);
        VoidSubst_180 = ((MR_Word) (conv10_VoidSubst_180));
        parse_tree__vartypes__apply_subst_to_vartypes_3_p_0(VoidSubst_180, VarTypesMap0_108, &VarTypesMap_117);
        check_hlds__type_util__apply_subst_to_constraint_proof_map_3_p_0(VoidSubst_180, ProofMap0_115, &ProofMap_118);
        check_hlds__type_util__apply_subst_to_constraint_map_3_p_0(VoidSubst_180, ConstraintMap0_116, &ConstraintMap_119);
        hlds__hlds_clauses__clauses_info_set_vartypes_3_p_0(VarTypesMap_117, ClausesInfo0_105, &ClausesInfo_120);
        hlds__hlds_pred__pred_info_set_clauses_info_3_p_0(ClausesInfo_120, STATE_VARIABLE_PredInfo_0_21, &STATE_VARIABLE_PredInfo_33_122);
        hlds__hlds_pred__pred_info_set_constraint_proof_map_3_p_0(ProofMap_118, STATE_VARIABLE_PredInfo_33_122, &STATE_VARIABLE_PredInfo_34_123);
        hlds__hlds_pred__pred_info_set_constraint_map_3_p_0(ConstraintMap_119, STATE_VARIABLE_PredInfo_34_123, &STATE_VARIABLE_PredInfo_29_29);
      }
