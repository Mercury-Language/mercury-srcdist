...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), check_hlds__post_typecheck__Var_12, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &check_hlds__post_typecheck_scalar_common_1[57])));
                  ...
                  {
                    {
                      ...
                      {
                        check_hlds__post_typecheck__succeeded = libs__globals__lookup_bool_option_3_p_1(check_hlds__post_typecheck__Globals_28, (MR_Integer) 332, (MR_Integer) 0);
                      }
                      if (check_hlds__post_typecheck__succeeded)
                        {
                          check_hlds__post_typecheck__Var_39 = (MR_Integer) 337;
...
{
  {
    ...
    check_hlds__post_typecheck__TypeInfo_117_117 = (MR_Word) &check_hlds__post_typecheck_scalar_common_2[1];
    {
      ...
      MR_hl_field(MR_mktag(0), check_hlds__post_typecheck__Var_27, 0) = ((MR_Box) (&check_hlds__post_typecheck_scalar_common_5[1]));
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), check_hlds__post_typecheck__Var_44, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &check_hlds__post_typecheck_scalar_common_1[59])));
    }
    {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), check_hlds__post_typecheck__Var_34, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &check_hlds__post_typecheck_scalar_common_1[57])));
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), check_hlds__post_typecheck__Var_54, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &check_hlds__post_typecheck_scalar_common_1[60])));
    ...
    {
      check_hlds__post_typecheck__MainPieces_19 = mercury__list__f_43_43_2_f_0(check_hlds__post_typecheck__TypeCtorInfo_121_121, (MR_Word) MR_mkword(MR_mktag(1), &check_hlds__post_typecheck_scalar_common_1[56]), check_hlds__post_typecheck__Var_32);
    }
    {
...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), check_hlds__post_typecheck__Var_39, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &check_hlds__post_typecheck_scalar_common_1[59])));
    }
    {
      check_hlds__post_typecheck__Var_37 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), check_hlds__post_typecheck__Var_37, 0) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 1))));
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(0), check_hlds__post_typecheck__Var_53, 0) = ((MR_Box) (&check_hlds__post_typecheck_scalar_common_6[1]));
    ...
    {
      check_hlds__post_typecheck__Var_50 = mercury__list__f_43_43_2_f_0(check_hlds__post_typecheck__TypeCtorInfo_77_77, check_hlds__post_typecheck__Var_51, (MR_Word) MR_mkword(MR_mktag(1), &check_hlds__post_typecheck_scalar_common_1[61]));
    }
    {
    ...
    {
      check_hlds__post_typecheck__Pieces_15 = mercury__list__f_43_43_2_f_0(check_hlds__post_typecheck__TypeCtorInfo_77_77, (MR_Word) MR_mkword(MR_mktag(1), &check_hlds__post_typecheck_scalar_common_1[56]), check_hlds__post_typecheck__Var_32);
    }
    {
        ...
        if ((check_hlds__post_typecheck__Goals_7 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
          {
            ...
            check_hlds__post_typecheck__Suffix_14 = (MR_Word) MR_mkword(MR_mktag(3), &check_hlds__post_typecheck_scalar_common_1[52]);
          }
        else
          {
...
{
  {
    ...
    switch (MR_tag((MR_Word) check_hlds__post_typecheck__GoalExpr_7)) {
      ...
      case (MR_Integer) 0:
        {
          check_hlds__post_typecheck__Pieces_6 = (MR_Word) MR_mkword(MR_mktag(1), &check_hlds__post_typecheck_scalar_common_1[49]);
        }
        break;
      case (MR_Integer) 1:
        {
      ...
      case (MR_Integer) 2:
        {
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(1), check_hlds__post_typecheck__Pieces_6, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &check_hlds__post_typecheck_scalar_common_1[47])));
          ...
          case (MR_Integer) 0:
            {
              ...
              switch (MR_tag((MR_Word) check_hlds__post_typecheck__Var_127)) {
                ...
                case (MR_Integer) 0:
                  {
                    check_hlds__post_typecheck__Pieces_6 = (MR_Word) MR_mkword(MR_mktag(1), &check_hlds__post_typecheck_scalar_common_1[51]);
                  }
                  break;
                case (MR_Integer) 1:
                  {
...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(0), check_hlds__post_typecheck__Var_25, 0) = ((MR_Box) (&check_hlds__post_typecheck_scalar_common_5[0]));
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(0), check_hlds__post_typecheck__FindGoals_15, 0) = ((MR_Box) (&check_hlds__post_typecheck_scalar_common_6[0]));
