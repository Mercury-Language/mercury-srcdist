...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), Var_99, 0) = (MR_Box) (((MR_Unsigned) (((MR_Box) ((MR_Integer) 52))) | (((MR_Unsigned) (((MR_Box) ((MR_Integer) 1))) << (MR_Integer) 10))));
...
{
  {
    ...
    mercury__list__foldl_4_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_constraint_0), (MR_Word) (&check_hlds__post_typecheck_scalar_common_1[3]), Var_25, Constraints_5, ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))), &conv1_ConstraintIdSets_13);
