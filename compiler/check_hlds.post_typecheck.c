...
static /* final */ const MR_Box check_hlds__post_typecheck_scalar_common_2[5][3] = {
  ...
  /* row 3 */
  {
    (MR_Box) (((((MR_Unsigned) ((MR_Integer) 52) << 1)) | (MR_Unsigned) ((MR_Integer) 1))),
    ((MR_Box) ((MR_Unsigned) 4U)),
    ((MR_Box) ((MR_Unsigned) 0U))
  },
  /* row 4 */
...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), Var_99, 0) = (MR_Box) (((((MR_Unsigned) ((MR_Integer) 52) << 1)) | (MR_Unsigned) ((MR_Integer) 1)));
