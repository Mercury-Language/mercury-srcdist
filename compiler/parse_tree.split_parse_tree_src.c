    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(0), Spec_46, 2) = ((MR_Box) ((MR_Unsigned) 16U));
    ...
    if (succeeded)
    {
      ...
      }
      {
        ...
        *Spec_12 = base;
        ...
        MR_hl_field(MR_mktag(0), base, 2) = ((MR_Box) ((MR_Unsigned) 16U));
...
{
  {
    ...
    }
    {
      ...
      *Spec_8 = base;
      ...
      MR_hl_field(MR_mktag(1), base, 2) = ((MR_Box) ((MR_Unsigned) 16U));
    ...
    else
    {
      ...
      if (succeeded)
      {
...

        {
          ...
          MR_hl_field(MR_mktag(1), Spec_38, 2) = ((MR_Box) ((MR_Unsigned) 16U));
