...
{
  {
    ...
    if (((MR_tag((MR_Word) Component_11)) == (MR_Integer) 1))
    {
      ...
      {
        RawItemBlock_106 = (MR_Word) MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL);
        ...
        MR_hl_field(MR_mktag(0), RawItemBlock_106, 2) = ((MR_Box) (Var_57));
        MR_hl_field(MR_mktag(0), RawItemBlock_106, 3) = ((MR_Box) ((MR_Unsigned) 0U));
    ...
    else
    {
      ...
      {
        RawItemBlock_28 = (MR_Word) MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL);
        ...
        MR_hl_field(MR_mktag(0), RawItemBlock_28, 2) = ((MR_Box) (OKIncludes_27));
        MR_hl_field(MR_mktag(0), RawItemBlock_28, 3) = ((MR_Box) (Avails_24));
        MR_hl_field(MR_mktag(0), RawItemBlock_28, 4) = ((MR_Box) (Items_25));
      }
