...
static /* final */ const MR_Box parse_tree__split_parse_tree_src_scalar_common_1[94][2];
  ...
  MR_Word * STATE_VARIABLE_Specs_66)
{
  ...
  if (((MR_tag((MR_Word) Component_15)) == (MR_Integer) 1))
  {
...

    {
      ...
      MR_hl_field(MR_mktag(0), Var_67, 0) = ((MR_Box) (&parse_tree__split_parse_tree_src_scalar_common_7[0]));
      ...
      case (MR_Integer) 1:
        {
          ...
          else
          {
            ...
            }
            {
              ...
              MR_hl_field(MR_mktag(3), Var_100, 1) = ((MR_Box) (InterfaceAncestor_37));
            }
            {
        ...
        case (MR_Integer) 0:
          {
            ...
            mercury__term____Compare____context_0_0(&CmpResult_13, ContextA_8, ContextB_10);
            switch (CmpResult_13) {
              default: /*NOTREACHED*/ MR_assert(0);
              case (MR_Integer) 1:
                *Entry_6 = EntryA_4;
  ...
  MR_Word * STATE_VARIABLE_Specs_39)
{
  ...
  else
  {
    ...
    MR_Word STATE_VARIABLE_ParseTreeModuleSrcCord_58_58;
    MR_Word SubModulesCord_30;
    MR_Word STATE_VARIABLE_SubModulesMap_59_59;
      ...
      case (MR_Integer) 0:
        {
          ...
          parse_tree__convert_parse_tree__check_convert_raw_comp_unit_to_module_src_5_p_0(Globals_11, RawCompUnit_96, &ParseTreeModuleSrc_97, STATE_VARIABLE_Specs_0_38, &STATE_VARIABLE_Specs_57_57);
          mercury__cord__snoc_3_p_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_parse_tree_module_src_0), ((MR_Box) (ParseTreeModuleSrc_97)), STATE_VARIABLE_ParseTreeModuleSrcCord_0_36, &STATE_VARIABLE_ParseTreeModuleSrcCord_58_58);
        }
        break;
      case (MR_Integer) 1:
        {
          ...
          parse_tree__convert_parse_tree__check_convert_raw_comp_unit_to_module_src_5_p_0(Globals_11, RawCompUnit_68, &ParseTreeModuleSrc_69, STATE_VARIABLE_Specs_0_38, &STATE_VARIABLE_Specs_57_57);
          mercury__cord__snoc_3_p_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_parse_tree_module_src_0), ((MR_Box) (ParseTreeModuleSrc_69)), STATE_VARIABLE_ParseTreeModuleSrcCord_0_36, &STATE_VARIABLE_ParseTreeModuleSrcCord_58_58);
        }
        break;
      case (MR_Integer) 2:
        {
          ...
          parse_tree__convert_parse_tree__check_convert_raw_comp_unit_to_module_src_5_p_0(Globals_11, RawCompUnit_92, &ParseTreeModuleSrc_93, STATE_VARIABLE_Specs_0_38, &STATE_VARIABLE_Specs_57_57);
          mercury__cord__snoc_3_p_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_parse_tree_module_src_0), ((MR_Box) (ParseTreeModuleSrc_93)), STATE_VARIABLE_ParseTreeModuleSrcCord_0_36, &STATE_VARIABLE_ParseTreeModuleSrcCord_58_58);
        }
        break;
      case (MR_Integer) 3:
          ...
          case (MR_Integer) 0:
            {
              ...
              }
              {
                ...
                MR_hl_field(MR_mktag(1), STATE_VARIABLE_Specs_57_57, 0) = ((MR_Box) (Spec_29));
                MR_hl_field(MR_mktag(1), STATE_VARIABLE_Specs_57_57, 1) = ((MR_Box) (STATE_VARIABLE_Specs_0_38));
              }
              STATE_VARIABLE_ParseTreeModuleSrcCord_58_58 = STATE_VARIABLE_ParseTreeModuleSrcCord_0_36;
            }
            break;
          case (MR_Integer) 1:
            {
              ...
              parse_tree__convert_parse_tree__check_convert_raw_comp_unit_to_module_src_5_p_0(Globals_11, RawCompUnit_26, &ParseTreeModuleSrc_27, STATE_VARIABLE_Specs_0_38, &STATE_VARIABLE_Specs_57_57);
              mercury__cord__snoc_3_p_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_parse_tree_module_src_0), ((MR_Box) (ParseTreeModuleSrc_27)), STATE_VARIABLE_ParseTreeModuleSrcCord_0_36, &STATE_VARIABLE_ParseTreeModuleSrcCord_58_58);
            }
            break;
        }
        break;
    }
    succeeded = mercury__map__remove_4_p_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), (MR_Word) (&parse_tree__split_parse_tree_src_scalar_common_1[0]), ((MR_Box) (ModuleName_12)), &conv1_SubModulesCord_30, STATE_VARIABLE_SubModulesMap_0_34, &STATE_VARIABLE_SubModulesMap_59_59);
    if (succeeded)
    {
    ...
    if (succeeded)
    {
      ...
      Var_60 = mercury__cord__list_1_f_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), SubModulesCord_30);
      mercury__list__sort_and_remove_dups_2_p_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), Var_60, &SubModules_31);
      {
        Var_61 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), Var_61, 0) = ((MR_Box) (&parse_tree__split_parse_tree_src_scalar_common_5[0]));
        MR_hl_field(MR_mktag(0), Var_61, 1) = ((MR_Box) (parse_tree__split_parse_tree_src__create_split_compilation_units_depth_first_10_p_0_1));
        MR_hl_field(MR_mktag(0), Var_61, 2) = ((MR_Box) ((MR_Integer) 1));
        MR_hl_field(MR_mktag(0), Var_61, 3) = ((MR_Box) (Globals_11));
      }
      mercury__list__foldl4_10_p_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), (MR_Word) (&parse_tree__split_parse_tree_src_scalar_common_2[0]), (MR_Word) (&parse_tree__split_parse_tree_src_scalar_common_2[1]), (MR_Word) (&parse_tree__split_parse_tree_src_scalar_common_1[2]), (MR_Word) (&parse_tree__split_parse_tree_src_scalar_common_1[3]), Var_61, SubModules_31, ((MR_Box) (STATE_VARIABLE_SplitModuleMap_40_40)), &conv9_STATE_VARIABLE_SplitModuleMap_33, ((MR_Box) (STATE_VARIABLE_SubModulesMap_59_59)), &conv8_STATE_VARIABLE_SubModulesMap_35, ((MR_Box) (STATE_VARIABLE_ParseTreeModuleSrcCord_58_58)), &conv7_STATE_VARIABLE_ParseTreeModuleSrcCord_37, ((MR_Box) (STATE_VARIABLE_Specs_57_57)), &conv6_STATE_VARIABLE_Specs_39);
    ...
    else
    {
      ...
      *STATE_VARIABLE_ParseTreeModuleSrcCord_37 = STATE_VARIABLE_ParseTreeModuleSrcCord_58_58;
