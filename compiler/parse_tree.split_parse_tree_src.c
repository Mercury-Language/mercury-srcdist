    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(0), Spec_46, 2) = ((MR_Box) ((MR_Unsigned) 20U));
...
{
  {
    ...
    if (((MR_tag((MR_Word) OldEntry_12)) == (MR_Integer) 0))
    {
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(0), Spec_19, 2) = ((MR_Box) ((MR_Unsigned) 20U));
    ...
    if (succeeded)
    {
      ...
      }
      {
        ...
        *Spec_12 = base;
        ...
        MR_hl_field(MR_mktag(0), base, 2) = ((MR_Box) ((MR_Unsigned) 20U));
...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(0), Spec_16, 2) = ((MR_Box) ((MR_Unsigned) 20U));
