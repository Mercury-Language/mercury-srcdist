...
{
  {
    ...
    // The code for TSCC PROC 1: pred parse_tree.split_parse_tree_src.compare_for_parse_tree.split_parse_tree_src.section_ancestors_0/3-0.
    ;
    ...
    ;
    ;
    // proc 1 in TSCC: pred parse_tree.split_parse_tree_src.compare_for_parse_tree.split_parse_tree_src.section_ancestors_0/3-0
    ;
    // proc 2 in TSCC: pred parse_tree.split_parse_tree_src.compare_for_parse_tree.split_parse_tree_src.module_ancestors_0/3-0
    ;
    ;
    goto top_of_proc_1;
  top_of_proc_1:;
    {
      ...
      else
      {
        ...
        {
          MR_Word next_value_of_tscc_proc_2_input_1_HeadVar__2_2 = ArgX2_7;
          MR_Word next_value_of_tscc_proc_2_input_2_HeadVar__3_3 = ArgY2_8;
      ...
      else
      {
        ...
        else
        {
          ...
          else
          {
            ...
            {
              MR_Word next_value_of_tscc_proc_1_input_1_HeadVar__2_2 = Var_23;
              MR_Word next_value_of_tscc_proc_1_input_2_HeadVar__3_3 = ArgY3_17;
...
{
  {
    ...
    // The code for TSCC PROC 2: pred parse_tree.split_parse_tree_src.compare_for_parse_tree.split_parse_tree_src.module_ancestors_0/3-0.
    ;
    // Setup for mutual tailcalls optimized into a loop.
    ;
    // The mutually recursive procedures are:
...
{
  {
    ...
    // The code for TSCC PROC 1: pred parse_tree.split_parse_tree_src.unify_for_parse_tree.split_parse_tree_src.section_ancestors_0/2-0.
    ;
    // Setup for mutual tailcalls optimized into a loop.
    ;
    // The mutually recursive procedures are:
    ;
    ;
    // proc 1 in TSCC: pred parse_tree.split_parse_tree_src.unify_for_parse_tree.split_parse_tree_src.section_ancestors_0/2-0
    ;
    // proc 2 in TSCC: pred parse_tree.split_parse_tree_src.unify_for_parse_tree.split_parse_tree_src.module_ancestors_0/2-0
    ;
    ;
    goto top_of_proc_1;
  top_of_proc_1:;
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              // direct tailcall eliminated
              ;
              next_value_of_tscc_proc_1_input_1_HeadVar__1_1 = ArgX3_9;
              next_value_of_tscc_proc_1_input_2_HeadVar__2_2 = ArgY3_10;
...
{
  {
    ...
    // The code for TSCC PROC 2: pred parse_tree.split_parse_tree_src.unify_for_parse_tree.split_parse_tree_src.module_ancestors_0/2-0.
    ;
    // Setup for mutual tailcalls optimized into a loop.
    ;
    // The mutually recursive procedures are:
