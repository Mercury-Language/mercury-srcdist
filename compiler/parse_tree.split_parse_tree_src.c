...
parse_tree__split_parse_tree_src__IntroducedFrom__pred__split_component_discover_submodules__555__1_2_p_0(
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = parse_tree__split_parse_tree_src__IntroducedFrom__pred__split_component_discover_submodules__555__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) ((MR_hl_field(0, closure, 4)))));
  return succeeded;
}
