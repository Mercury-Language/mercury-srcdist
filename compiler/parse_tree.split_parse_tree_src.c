...
{
  {
    ...
    if (((MR_tag((MR_Word) Component_11)) == (MR_Integer) 1))
    {
      ...
      MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), Component_11, (MR_Integer) 0)));
      ...
      *STATE_VARIABLE_RawItemBlockCord_52 = mercury__cord__snoc_2_f_0((MR_Word) (&parse_tree__split_parse_tree_src_scalar_common_1[1]), STATE_VARIABLE_RawItemBlockCord_0_51, ((MR_Box) (RawItemBlock_104)));
      {
        ...
        MR_hl_field(MR_mktag(1), NestedModuleAncestors_46, 0) = (MR_Box) (packed_args_0);
    ...
    else
    {
      ...
      MR_Unsigned packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Component_11, (MR_Integer) 0)));
        ...
        case (MR_Integer) 1:
          {
            ...
            else
            {
              ...
              else
              {
                ...
                MR_Unsigned packed_args_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), ModuleAncestors_31, (MR_Integer) 0)));
...
{
  {
    ...
    else
    {
      ...
      MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), ModuleAncestors_10, (MR_Integer) 0)));
  ...
  MR_Word * MaybeProblemAncestor_4)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), ModuleAncestors_6, (MR_Integer) 0)));
...
{
  {
    ...
    else
    {
      ...
      MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), ModuleAncestors_5, (MR_Integer) 0)));
