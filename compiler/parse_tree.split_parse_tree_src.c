  ...
  MR_Word * STATE_VARIABLE_Specs_39)
{
  ...
  else
  {
    ...
    else
    {
      ...
      STATE_VARIABLE_RawItemBlockCord_1_111 = mercury__cord__snoc_2_f_0((MR_Word) (&parse_tree__convert_parse_tree__parse_tree__convert_parse_tree__type_ctor_info_raw_item_block_0), RawItemBlockCord0_20, ((MR_Box) (IntItemBlock_100)));
    }
    ...
    else
    {
      ...
      RawItemBlockCord_22 = mercury__cord__snoc_2_f_0((MR_Word) (&parse_tree__convert_parse_tree__parse_tree__convert_parse_tree__type_ctor_info_raw_item_block_0), STATE_VARIABLE_RawItemBlockCord_1_111, ((MR_Box) (ImpItemBlock_101)));
    }
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      else
      {
        ...
        STATE_VARIABLE_OKIncludesCord_1_125 = mercury__cord__snoc_2_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_include_0), STATE_VARIABLE_OKIncludesCord_0_3, ((MR_Box) (Include_24)));
