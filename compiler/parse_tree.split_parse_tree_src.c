        ...
        case (MR_Integer) 1:
          {
            ...
            else
            {
              ...
              }
              {
                ...
                MR_hl_field(MR_mktag(1), Spec_47, 2) = ((MR_Box) ((MR_Unsigned) 36U));
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(0), Spec_46, 2) = ((MR_Box) ((MR_Unsigned) 36U));
...
{
  {
    ...
    if (((MR_tag((MR_Word) OldEntry_12)) == (MR_Integer) 0))
    {
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(0), Spec_19, 2) = ((MR_Box) ((MR_Unsigned) 36U));
    ...
    if (succeeded)
    {
      ...
      }
      {
        ...
        *Spec_12 = base;
        ...
        MR_hl_field(MR_mktag(0), base, 2) = ((MR_Box) ((MR_Unsigned) 36U));
...
{
  {
    ...
    }
    {
      ...
      *Spec_8 = base;
      ...
      MR_hl_field(MR_mktag(1), base, 2) = ((MR_Box) ((MR_Unsigned) 36U));
...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(0), Spec_16, 2) = ((MR_Box) ((MR_Unsigned) 36U));
