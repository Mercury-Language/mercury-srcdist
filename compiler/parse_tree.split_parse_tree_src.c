  ...
  MR_Word * STATE_VARIABLE_Specs_39)
{
  ...
  else
  {
    ...
    mercury__cord__snoc_3_p_0((MR_Word) (&parse_tree__prog_parse_tree__parse_tree__prog_parse_tree__type_ctor_info_parse_tree_module_src_0), ((MR_Box) (ParseTreeModuleSrc_29)), STATE_VARIABLE_ParseTreeModuleSrcCord_0_36, &STATE_VARIABLE_ParseTreeModuleSrcCord_70_70);
