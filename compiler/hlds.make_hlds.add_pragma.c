  ...
  MR_Word * STATE_VARIABLE_Specs_32)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_16, (MR_Integer) 721, &TypeLayout_17);
          ...
          case (MR_Integer) 0:
            {
              ...
              libs__globals__lookup_bool_option_3_p_0(Globals_36, (MR_Integer) 174, &WarnActual_37);
      ...
      case (MR_Integer) 0:
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_28, (MR_Integer) 664, &InformIgnored_29);
        ...
        case (MR_Integer) 0:
          {
            ...
            libs__globals__lookup_bool_option_3_p_0(Globals_142, (MR_Integer) 664, &InformIgnored_143);
