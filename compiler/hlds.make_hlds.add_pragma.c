      ...
      case (MR_Integer) 2:
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_17, (MR_Integer) 59, &Warn_19);
      ...
      case (MR_Integer) 2:
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_15, (MR_Integer) 59, &Warn_17);
          ...
          case (MR_Integer) 2:
            {
              ...
              }
              {
                ...
                MR_hl_field(MR_mktag(1), Spec_140, 2) = ((MR_Box) ((MR_Unsigned) 36U));
          ...
          case (MR_Integer) 1:
            {
              ...
              }
              {
                ...
                MR_hl_field(MR_mktag(0), Spec_138, 2) = ((MR_Box) ((MR_Unsigned) 36U));
