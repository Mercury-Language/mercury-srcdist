  ...
  MR_Word * STATE_VARIABLE_Specs_30)
{
  ...
  if (succeeded)
  {
      ...
      case (MR_Integer) 1:
        {
          ...
          MissingPieces_22 = (MR_Word) (MR_mkword(1, &hlds__make_hlds__add_pragma_scalar_common_1[71]));
        }
        break;
      case (MR_Integer) 0:
        {
          ...
          MissingPieces_22 = (MR_Word) (MR_mkword(1, &hlds__make_hlds__add_pragma_scalar_common_1[73]));
        }
        break;
    }
    if ((PredIds_20 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      ...
      hlds__make_hlds_error__report_undefined_pred_or_func_error_8_p_0(Var_50, SymName_18, UserArity_19, OtherUserArities_26, Context_11, MissingPieces_22, STATE_VARIABLE_Specs_0_29, STATE_VARIABLE_Specs_30);
      *STATE_VARIABLE_ModuleInfo_28 = STATE_VARIABLE_ModuleInfo_0_27;
    }
    else
    {
  ...
  if (((MR_tag((MR_Word) SymName_16)) == (MR_Integer) 1))
  {
    ...
    if ((PredIds_23 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      ...
      }
      {
        ...
        MR_hl_field(1, Pieces_29, 1) = ((MR_Box) (MR_mkword(1, &hlds__make_hlds__add_pragma_scalar_common_1[20])));
      }
      ...
      case (MR_Integer) 1:
        {
          ...
          }
          {
            ...
            MR_hl_field(1, DescPieces_25, 0) = ((MR_Box) (Var_40));
            MR_hl_field(1, DescPieces_25, 1) = ((MR_Box) (MR_mkword(1, &hlds__make_hlds__add_pragma_scalar_common_1[20])));
          }
          {
            Var_45 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(1, Var_45, 0) = ((MR_Box) (PredOrFunc_15));
          }
          hlds__make_hlds_error__report_undefined_pred_or_func_error_8_p_0(Var_45, SymName_16, UserArity_17, OtherUserArities_24, Context_13, DescPieces_25, (MR_Word) ((MR_Unsigned) 0U), &Specs_26);
        }
        break;
    }
    {
