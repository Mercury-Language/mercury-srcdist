          ...
          case (MR_Integer) 15:
            {
              ...
              {
                libs__globals__lookup_bool_option_3_p_0(hlds__make_hlds__add_pragma__Globals_23, (MR_Integer) 226, &hlds__make_hlds__add_pragma__TypeLayout_24);
              }
      ...
      case (MR_Integer) 6:
        {
          ...
          {
            libs__globals__lookup_bool_option_3_p_0(hlds__make_hlds__add_pragma__Globals_6, (MR_Integer) 166, &hlds__make_hlds__add_pragma__ReorderConj_19);
          }
          {
            libs__globals__lookup_bool_option_3_p_0(hlds__make_hlds__add_pragma__Globals_6, (MR_Integer) 167, &hlds__make_hlds__add_pragma__ReorderDisj_20);
          }
          {
            libs__globals__lookup_bool_option_3_p_0(hlds__make_hlds__add_pragma__Globals_6, (MR_Integer) 168, &hlds__make_hlds__add_pragma__FullyStrict_21);
          }
