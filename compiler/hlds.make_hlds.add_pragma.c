      ...
      case (MR_Integer) 0:
        {
          ...
          MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), FDInfo_15, (MR_Integer) 0)));
...
{
  {
    ...
    else
    {
      ...
      {
        MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), RequireTailrecOrig_17, (MR_Integer) 0)));
