...
hlds__make_hlds__add_pragma__IntroducedFrom__pred__look_up_pragma_pf_sym_arity__1886__1_2_p_0(
...
{
  {
    ...
    hlds__make_hlds__add_pragma__look_up_pragma_pf_sym_arity_mode_num_10_p_0(STATE_VARIABLE_ModuleInfo_0_24, (MR_Integer) 0, (MR_Integer) 0, Context_8, (MR_String) "mm_tabling_info", PredOrFunc_13, SymName_14, UserArity_15, ModeNum_16, &MaybePredProc_17);
    if (((MR_tag((MR_Word) MaybePredProc_17)) == (MR_Integer) 0))
    {
      MR_Word Specs_10 = ((MR_Word) ((MR_hl_field(MR_mktag(0), MaybePredProc_17, (MR_Integer) 0))));

      *STATE_VARIABLE_Specs_27 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_error_spec_0), Specs_10, STATE_VARIABLE_Specs_0_26);
      *STATE_VARIABLE_ModuleInfo_25 = STATE_VARIABLE_ModuleInfo_0_24;
    }
    else
    {
      MR_Word PredId_18 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MaybePredProc_17, (MR_Integer) 0))));
      MR_Integer ProcId_19 = ((MR_Integer) ((MR_hl_field(MR_mktag(1), MaybePredProc_17, (MR_Integer) 1))));
      MR_Word PredInfo0_20 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MaybePredProc_17, (MR_Integer) 2))));
      MR_Word ProcInfo0_21 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MaybePredProc_17, (MR_Integer) 3))));
...
{
  {
    ...
    hlds__make_hlds__add_pragma__look_up_pragma_pf_sym_arity_mode_num_10_p_0(STATE_VARIABLE_ModuleInfo_0_24, (MR_Integer) 0, (MR_Integer) 0, Context_8, (MR_String) "trailing_info", PredOrFunc_13, SymName_14, UserArity_15, ModeNum_16, &MaybePredProc_17);
    if (((MR_tag((MR_Word) MaybePredProc_17)) == (MR_Integer) 0))
    {
      MR_Word Specs_10 = ((MR_Word) ((MR_hl_field(MR_mktag(0), MaybePredProc_17, (MR_Integer) 0))));
...
{
  {
    ...
    hlds__make_hlds__add_pragma__look_up_pragma_pf_sym_arity_mode_num_10_p_0(STATE_VARIABLE_ModuleInfo_0_24, (MR_Integer) 0, (MR_Integer) 0, Context_8, (MR_String) "exceptions", PredOrFunc_13, SymName_14, UserArity_15, ModeNum_16, &MaybePredProc_17);
    if (((MR_tag((MR_Word) MaybePredProc_17)) == (MR_Integer) 0))
    {
      MR_Word Specs_10 = ((MR_Word) ((MR_hl_field(MR_mktag(0), MaybePredProc_17, (MR_Integer) 0))));
...
{
  {
    ...
    succeeded = hlds__make_hlds__add_pragma__IntroducedFrom__pred__look_up_pragma_pf_sym_arity__1886__1_2_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))));
    return succeeded;
  }
}
    ...
    else
    {
      ...
      else
      {
...

        {
          ...
          MR_hl_field(MR_mktag(0), Var_44, 0) = ((MR_Box) (&hlds__make_hlds__add_pragma_scalar_common_7[1]));
          ...
          case (MR_Integer) 1:
            {
              ...
              }
              {
                ...
                MR_hl_field(MR_mktag(0), Var_74, 0) = ((MR_Box) (&hlds__make_hlds__add_pragma_scalar_common_8[0]));
