  ...
  MR_Word * STATE_VARIABLE_Specs_32)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_16, (MR_Integer) 747, &TypeLayout_17);
      ...
      case (MR_Integer) 0:
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_28, (MR_Integer) 690, &InformIgnored_29);
        ...
        case (MR_Integer) 0:
          {
            ...
            libs__globals__lookup_bool_option_3_p_0(Globals_143, (MR_Integer) 690, &InformIgnored_144);
