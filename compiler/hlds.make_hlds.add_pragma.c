              ...
              case (MR_Integer) 1:
                {
                  ...
                  {
                    Var_92 = (MR_Word) MR_mkword(3, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(3, Var_92, 0) = ((MR_Box) ((MR_Unsigned) 32U));
              ...
              case (MR_Integer) 0:
                {
                  ...
                  {
                    Var_70 = (MR_Word) MR_mkword(3, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(3, Var_70, 0) = ((MR_Box) ((MR_Unsigned) 32U));
  ...
  MR_Word * MaybePredId_18)
{
            ...
            case (MR_Integer) 1:
              {
                ...
                Spec_129 = hlds__make_hlds__add_pragma__report_unknown_pred_or_func_6_f_0((MR_Word) ((MR_Unsigned) 0U), PragmaName_14, Context_13, PredOrFunc_15, SymName_16, UserArity_17);
                {
                  Specs_26 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                  MR_hl_field(1, Specs_26, 0) = ((MR_Box) (Spec_129));
  ...
  {
    MR_Word Var_149 = ((MR_Word) ((MR_hl_field(1, PredIds_21, (MR_Integer) 1))));
    MR_Word Var_150 = ((MR_Word) ((MR_hl_field(1, PredIds_21, (MR_Integer) 0))));
    ...
    else
    {
      ...
      switch (FailHandling_12) {
        ...
        case (MR_Integer) 0:
          {
            MR_Word Globals_137;
            MR_Word InformIgnored_138;

            hlds__hlds_module__module_info_get_globals_2_p_0(ModuleInfo_10, &Globals_137);
            libs__globals__lookup_bool_option_3_p_0(Globals_137, (MR_Integer) 71, &InformIgnored_138);
            switch (InformIgnored_138) {
              default: /*NOTREACHED*/ MR_assert(0);
              case (MR_Integer) 0:
                Specs_142 = (MR_Word) ((MR_Unsigned) 0U);
                break;
              case (MR_Integer) 1:
                {
                  MR_Word Spec_134;

                  Spec_134 = hlds__make_hlds__add_pragma__report_ambiguous_pred_or_func_6_f_0((MR_Word) ((MR_Unsigned) 8U), PragmaName_14, Context_13, PredOrFunc_15, SymName_16, UserArity_17);
                  {
                    Specs_142 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(1, Specs_142, 0) = ((MR_Box) (Spec_134));
                    MR_hl_field(1, Specs_142, 1) = ((MR_Box) ((MR_Unsigned) 0U));
                  }
                }
                break;
            }
        ...
        case (MR_Integer) 2:
          {
            ...
            Spec_133 = hlds__make_hlds__add_pragma__report_ambiguous_pred_or_func_6_f_0((MR_Word) ((MR_Unsigned) 0U), PragmaName_14, Context_13, PredOrFunc_15, SymName_16, UserArity_17);
            {
              Specs_142 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(1, Specs_142, 0) = ((MR_Box) (Spec_133));
              MR_hl_field(1, Specs_142, 1) = ((MR_Box) ((MR_Unsigned) 0U));
            }
          }
          break;
        case (MR_Integer) 1:
          {
            ...
            }
            {
              Var_75 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(1, Var_75, 0) = ((MR_Box) (Var_76));
              MR_hl_field(1, Var_75, 1) = ((MR_Box) (MR_mkword(1, &hlds__make_hlds__add_pragma_scalar_common_1[169])));
            }
            {
              Var_72 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(1, Var_72, 0) = ((MR_Box) (MR_mkword(3, &hlds__make_hlds__add_pragma_scalar_common_1[168])));
              MR_hl_field(1, Var_72, 1) = ((MR_Box) (Var_75));
            }
            Var_71 = parse_tree__error_spec__color_as_incorrect_1_f_0(Var_72);
            {
              ...
              MR_hl_field(3, Var_86, 0) = ((MR_Box) ((MR_Unsigned) 32U));
              MR_hl_field(3, Var_86, 1) = ((MR_Box) (PragmaName_14));
            }
            {
              Var_85 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(1, Var_85, 0) = ((MR_Box) (Var_86));
              MR_hl_field(1, Var_85, 1) = ((MR_Box) (MR_mkword(1, &hlds__make_hlds__add_pragma_scalar_common_1[177])));
            }
            {
              Var_82 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(1, Var_82, 0) = ((MR_Box) (MR_mkword(3, &hlds__make_hlds__add_pragma_scalar_common_1[170])));
              MR_hl_field(1, Var_82, 1) = ((MR_Box) (Var_85));
            }
            Var_99 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), PredIdPieces_35, (MR_Word) (MR_mkword(1, &hlds__make_hlds__add_pragma_scalar_common_1[179])));
            Var_81 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), Var_82, Var_99);
            ...
            MainPieces_36 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), (MR_Word) (MR_mkword(1, &hlds__make_hlds__add_pragma_scalar_common_1[8])), Var_70);
            {
              Var_113 = (MR_Word) MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL);
              MR_hl_field(0, Var_113, 0) = ((MR_Box) (MainPieces_36));
            }
            {
              Var_112 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(1, Var_112, 0) = ((MR_Box) (Var_113));
              MR_hl_field(1, Var_112, 1) = ((MR_Box) (MR_mkword(1, &hlds__make_hlds__add_pragma_scalar_common_1[238])));
            }
            {
              Msg_38 = (MR_Word) MR_mkword(2, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(2, Msg_38, 0) = ((MR_Box) (Context_13));
              MR_hl_field(2, Msg_38, 1) = ((MR_Box) (Var_112));
            }
            {
              Var_121 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(1, Var_121, 0) = ((MR_Box) (Msg_38));
              MR_hl_field(1, Var_121, 1) = ((MR_Box) ((MR_Unsigned) 0U));
            }
            {
              Spec_132 = (MR_Word) MR_mkword(2, MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(2, Spec_132, 0) = ((MR_Box) ((MR_String) "predicate \140hlds.make_hlds.add_pragma.look_up_pragma_pf_sym_arity\'/9"));
              MR_hl_field(2, Spec_132, 1) = ((MR_Box) ((MR_Unsigned) 0U));
              MR_hl_field(2, Spec_132, 2) = ((MR_Box) ((MR_Unsigned) 44U));
              MR_hl_field(2, Spec_132, 3) = ((MR_Box) (Var_121));
            }
            {
              Specs_142 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(1, Specs_142, 0) = ((MR_Box) (Spec_132));
              MR_hl_field(1, Specs_142, 1) = ((MR_Box) ((MR_Unsigned) 0U));
            }
          }
          break;
