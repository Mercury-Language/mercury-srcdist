      ...
      case (MR_Integer) 0:
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_28, (MR_Integer) 666, &InformIgnored_29);
        ...
        case (MR_Integer) 0:
          {
            ...
            libs__globals__lookup_bool_option_3_p_0(Globals_142, (MR_Integer) 666, &InformIgnored_143);
