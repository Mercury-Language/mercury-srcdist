        ...
        case (MR_Integer) 0:
          {
            ...
            libs__globals__lookup_bool_option_3_p_0(Globals_142, (MR_Integer) 71, &InformIgnored_143);
        ...
        case (MR_Integer) 1:
          {
            ...
            PredIdPieces_37 = parse_tree__error_spec__pieces_list_to_color_line_pieces_3_f_0((MR_Integer) 3, (MR_Word) (MR_mkword(1, &hlds__make_hlds__add_pragma_scalar_common_1[22])), PredIdPiecesList_36);
            {
              Var_76 = (MR_Word) MR_mkword(3, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            ...
            }
            {
              ...
              MR_hl_field(1, Var_117, 1) = ((MR_Box) (MR_mkword(1, &hlds__make_hlds__add_pragma_scalar_common_1[243])));
            }
            {
