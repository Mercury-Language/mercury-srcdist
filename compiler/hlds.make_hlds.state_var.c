...
{
  {
    ...
    if (((MR_tag((MR_Word) ProcDef0_7)) == (MR_mktag((MR_Integer) 1))))
    {
      ...
      mercury__list__map_3_p_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_clause_info_0), (MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_clause_info_0), (MR_Word) (&hlds__make_hlds__state_var_scalar_common_2[7]), ItemClauses0_11, &ItemClauses_12);
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(1), Var_62, 0) = (MR_Box) (((MR_Unsigned) (((MR_Box) ((MR_Integer) 54))) | (((MR_Unsigned) (((MR_Box) ((MR_Integer) 1))) << (MR_Integer) 10))));
