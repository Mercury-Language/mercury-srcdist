...
hlds__make_hlds__state_var__IntroducedFrom__pred__delete_unneeded_copy_goals__2093__1_2_p_0(
  MR_Word OrElseInners_90,
  MR_Word HeadVar__2_117);

static MR_bool MR_CALL 
hlds__make_hlds__state_var__IntroducedFrom__pred__handle_state_vars_in_ite__1355__1_2_p_0(
  MR_Word StatusBefore_82,
  MR_Word StatusAfterThen_84);

static MR_bool MR_CALL 
hlds__make_hlds__state_var__IntroducedFrom__pred__handle_arm_updated_state_vars__1135__1_2_p_0(
  MR_Word AfterAllArmsStatus_23,
  MR_Word AfterArmStatus_25);

static MR_bool MR_CALL 
hlds__make_hlds__state_var__IntroducedFrom__pred__get_disjuncts_with_empty_states__1026__1_1_p_0(
...
static MR_bool MR_CALL 
hlds__make_hlds__state_var__IntroducedFrom__pred__svar_finish_if_then_else__1267__1_2_p_0(
  MR_Word SVarsBefore_42,
  ...
  MR_Word * STATE_VARIABLE_Specs_34)
{
      ...
      case (MR_Integer) 0:
        {
          ...
          }
          {
            Var_64 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), Var_64, 0) = ((MR_Box) (Var_65));
            MR_hl_field(MR_mktag(1), Var_64, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &hlds__make_hlds__state_var_scalar_common_1[13])));
          }
          {
            Pieces_60 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), Pieces_60, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__state_var_scalar_common_1[31])));
            MR_hl_field(MR_mktag(1), Pieces_60, 1) = ((MR_Box) (Var_64));
          }
          {
            Spec_61 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), Spec_61, 0) = ((MR_Box) ((MR_String) "predicate \140hlds.make_hlds.state_var.report_uninitialized_state_var\'/5"));
            MR_hl_field(MR_mktag(1), Spec_61, 1) = ((MR_Box) ((MR_Unsigned) 4U));
            MR_hl_field(MR_mktag(1), Spec_61, 2) = ((MR_Box) ((MR_Unsigned) 40U));
            MR_hl_field(MR_mktag(1), Spec_61, 3) = ((MR_Box) (Context_12));
            MR_hl_field(MR_mktag(1), Spec_61, 4) = ((MR_Box) (Pieces_60));
          }
          {
            MR_Word base;
  ...
  else
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), Var_78, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &hlds__make_hlds__state_var_scalar_common_1[30])));
    }
    {
      Pieces_74 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), Pieces_74, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__state_var_scalar_common_1[28])));
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), Spec_75, 0) = ((MR_Box) ((MR_String) "predicate \140hlds.make_hlds.state_var.report_non_visible_state_var\'/6"));
      MR_hl_field(MR_mktag(1), Spec_75, 1) = ((MR_Box) ((MR_Unsigned) 0U));
      MR_hl_field(MR_mktag(1), Spec_75, 2) = ((MR_Box) ((MR_Unsigned) 40U));
      MR_hl_field(MR_mktag(1), Spec_75, 3) = ((MR_Box) (Context_12));
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = hlds__make_hlds__state_var__IntroducedFrom__pred__svar_finish_if_then_else__1271__1_2_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))));
  return succeeded;
}
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = hlds__make_hlds__state_var__IntroducedFrom__pred__svar_finish_if_then_else__1269__1_2_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))));
  return succeeded;
}
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = hlds__make_hlds__state_var__IntroducedFrom__pred__svar_finish_if_then_else__1267__1_2_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))));
  return succeeded;
}
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = hlds__make_hlds__state_var__IntroducedFrom__pred__handle_state_vars_in_ite__1355__1_2_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))));
  return succeeded;
}
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      else
      {
        ...
        if (succeeded)
        {
          Var_80 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(3), ArmExpr0_45, (MR_Integer) 1))) & (MR_Integer) 1);
          Conjuncts0_77 = ((MR_Word) ((MR_hl_field(MR_mktag(3), ArmExpr0_45, (MR_Integer) 2))));
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
...

            {
              ...
              MR_hl_field(MR_mktag(0), Var_81, 0) = ((MR_Box) (&hlds__make_hlds__state_var_scalar_common_7[0]));
              MR_hl_field(MR_mktag(0), Var_81, 1) = ((MR_Box) (hlds__make_hlds__state_var__merge_changes_made_by_arms_12_p_0_1));
              MR_hl_field(MR_mktag(0), Var_81, 2) = ((MR_Box) ((MR_Integer) 1));
              MR_hl_field(MR_mktag(0), Var_81, 3) = ((MR_Box) (GoalDelayedRenaming_79));
            }
      ...
      else
      {
        ...
        Var_95 = parse_tree__error_util__list_to_pieces_1_f_0(UninitVarNames_42);
        Var_94 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_format_component_0), Var_95, (MR_Word) (MR_mkword(MR_mktag(1), &hlds__make_hlds__state_var_scalar_common_1[51])));
        Pieces_88 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_format_component_0), (MR_Word) (MR_mkword(MR_mktag(1), &hlds__make_hlds__state_var_scalar_common_1[48])), Var_94);
        {
          Spec_89 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), Spec_89, 0) = ((MR_Box) ((MR_String) "predicate \140hlds.make_hlds.state_var.report_missing_inits_in_disjunct\'/4"));
          MR_hl_field(MR_mktag(1), Spec_89, 1) = ((MR_Box) ((MR_Unsigned) 8U));
          MR_hl_field(MR_mktag(1), Spec_89, 2) = ((MR_Box) ((MR_Unsigned) 40U));
          MR_hl_field(MR_mktag(1), Spec_89, 3) = ((MR_Box) (ArmContext_53));
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(1), STATE_VARIABLE_Specs_70_70, 0) = ((MR_Box) (Spec_89));
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = hlds__make_hlds__state_var__IntroducedFrom__pred__handle_arm_updated_state_vars__1135__1_2_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))));
  return succeeded;
}
                  ...
                  case (MR_Integer) 0:
                    {
...

                      {
                        ...
                        MR_hl_field(MR_mktag(0), Var_101, 0) = ((MR_Box) (BeforeVar_87));
                      }
                      Var_102 = mercury__term_context__dummy_context_0_f_0();
                      hlds__make_goal__create_pure_atomic_complicated_unification_6_p_0(AfterAllVar_79, Var_101, Var_102, (MR_Word) (MR_mkword(MR_mktag(3), &hlds__make_hlds__state_var_scalar_common_3[2])), (MR_Word) ((MR_Unsigned) 0U), &CopyGoal0_100);
                      hlds__hlds_goal__goal_add_features_3_p_0((MR_Word) (MR_mkword(MR_mktag(1), &hlds__make_hlds__state_var_scalar_common_1[27])), CopyGoal0_100, &CopyGoal_80);
                      {
                        MR_Word base;
                        base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                        *HeadVar__6_6 = base;
                      ...
                      case (MR_Integer) 0:
                        {
...

                          {
                            ...
                            MR_hl_field(MR_mktag(0), Var_94, 0) = ((MR_Box) (BeforeVar_26));
                          }
                          Var_95 = mercury__term_context__dummy_context_0_f_0();
                          hlds__make_goal__create_pure_atomic_complicated_unification_6_p_0(AfterAllVar_29, Var_94, Var_95, (MR_Word) (MR_mkword(MR_mktag(3), &hlds__make_hlds__state_var_scalar_common_3[2])), (MR_Word) ((MR_Unsigned) 0U), &CopyGoal0_93);
                          hlds__hlds_goal__goal_add_features_3_p_0((MR_Word) (MR_mkword(MR_mktag(1), &hlds__make_hlds__state_var_scalar_common_1[27])), CopyGoal0_93, &CopyGoal_30);
                          {
                            MR_Word base;
                            base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                            *HeadVar__6_6 = base;
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = hlds__make_hlds__state_var__IntroducedFrom__pred__get_disjuncts_with_empty_states__1026__1_1_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))));
  return succeeded;
}
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        {
          Var_43 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(2), Var_43, 0) = ((MR_Box) (Name_37));
        }
        {
          Var_42 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), Var_42, 0) = ((MR_Box) (Var_43));
          MR_hl_field(MR_mktag(1), Var_42, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &hlds__make_hlds__state_var_scalar_common_1[37])));
        }
        {
          Pieces_38 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), Pieces_38, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__state_var_scalar_common_1[35])));
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(0), Var_51, 1) = ((MR_Box) (Pieces_38));
        }
        {
        ...
        {
          Spec_39 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(3), Spec_39, 0) = ((MR_Box) ((MR_String) "predicate \140hlds.make_hlds.state_var.report_state_var_shadow\'/5"));
          MR_hl_field(MR_mktag(3), Spec_39, 1) = (MR_Box) (((((MR_Unsigned) ((MR_Integer) 60) << 1)) | (MR_Unsigned) ((MR_Integer) 1)));
          MR_hl_field(MR_mktag(3), Spec_39, 2) = ((MR_Box) ((MR_Unsigned) 4U));
          MR_hl_field(MR_mktag(3), Spec_39, 3) = ((MR_Box) ((MR_Unsigned) 40U));
          MR_hl_field(MR_mktag(3), Spec_39, 4) = ((MR_Box) (Var_50));
        }
        {
          STATE_VARIABLE_Specs_27_27 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), STATE_VARIABLE_Specs_27_27, 0) = ((MR_Box) (Spec_39));
            ...
            case (MR_Integer) 0:
              {
                ...
                if (succeeded)
                {
...

                  {
                    ...
                    MR_hl_field(MR_mktag(0), Var_48, 0) = ((MR_Box) (LastVar_26));
                  }
                  Var_49 = mercury__term_context__dummy_context_0_f_0();
                  hlds__make_goal__create_pure_atomic_complicated_unification_6_p_0(FinalHeadVar_23, Var_48, Var_49, (MR_Word) (MR_mkword(MR_mktag(3), &hlds__make_hlds__state_var_scalar_common_3[2])), (MR_Word) ((MR_Unsigned) 0U), &CopyGoal0_47);
                  hlds__hlds_goal__goal_add_features_3_p_0((MR_Word) (MR_mkword(MR_mktag(1), &hlds__make_hlds__state_var_scalar_common_1[27])), CopyGoal0_47, &CopyGoal_27);
                  {
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = hlds__make_hlds__state_var__IntroducedFrom__pred__delete_unneeded_copy_goals__2093__1_2_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))));
  return succeeded;
}
