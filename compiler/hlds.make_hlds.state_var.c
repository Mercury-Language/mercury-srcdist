...
{
  {
    ...
    succeeded = ((((MR_tag((MR_Word) GoalExpr_8)) == (MR_Integer) 3)) && ((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), GoalExpr_8, (MR_Integer) 0))) == (MR_Integer) 2)));
    if (succeeded)
    {
...
{
  {
    ...
    if (((MR_tag((MR_Word) Term0_11)) == (MR_Integer) 0))
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          succeeded = ((MR_tag((MR_Word) SubTerms0_20)) == (MR_Integer) 1);
          if (succeeded)
          {
