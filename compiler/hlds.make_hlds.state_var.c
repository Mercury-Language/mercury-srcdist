  ...
  MR_Word * STATE_VARIABLE_Specs_16)
{
  ...
  Var_36 = parse_tree__error_spec__color_as_possible_cause_1_f_0((MR_Word) (MR_mkword(1, &hlds__make_hlds__state_var_scalar_common_1[68])));
  {
  ...
  Var_53 = parse_tree__error_spec__color_as_possible_cause_1_f_0((MR_Word) (MR_mkword(1, &hlds__make_hlds__state_var_scalar_common_1[71])));
