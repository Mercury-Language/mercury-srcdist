...
static /* final */ const MR_Box hlds__make_hlds__state_var_scalar_common_2[9][3] = {
  ...
  /* row 3 */
  {
    (MR_Box) (((((MR_Unsigned) ((MR_Integer) 55) << 1)) | (MR_Unsigned) ((MR_Integer) 1))),
    ((MR_Box) ((MR_Unsigned) 4U)),
    ((MR_Box) ((MR_Unsigned) 0U))
  },
  /* row 4 */
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(1), Var_62, 0) = (MR_Box) (((((MR_Unsigned) ((MR_Integer) 55) << 1)) | (MR_Unsigned) ((MR_Integer) 1)));
