...
{
  {
    ...
    hlds__make_goal__create_pure_atomic_complicated_unification_6_p_0(ToVar_5, Var_8, Var_9, (MR_Word) (MR_mkword(MR_mktag(3), &hlds__make_hlds__state_var_scalar_common_4[2])), (MR_Word) ((MR_Unsigned) 0U), &CopyGoal0_7);
            ...
            case (MR_Integer) 0:
              {
                ...
                if (succeeded)
                {
                  ...
                  hlds__make_goal__create_pure_atomic_complicated_unification_6_p_0(FinalHeadVar_23, Var_53, Var_54, (MR_Word) (MR_mkword(MR_mktag(3), &hlds__make_hlds__state_var_scalar_common_4[2])), (MR_Word) ((MR_Unsigned) 0U), &CopyGoal0_52);
