  ...
  MR_Word * STATE_VARIABLE_Specs_16)
{
  ...
  NextStateVarsPieces_12 = parse_tree__error_spec__list_to_color_pieces_4_f_0((MR_Word) (MR_mkword(1, &hlds__make_hlds__state_var_scalar_common_3[3])), (MR_String) "and", (MR_Word) (MR_mkword(1, &hlds__make_hlds__state_var_scalar_common_1[54])), NextStateVars_8);
  {
    Var_28 = (MR_Word) MR_mkword(3, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
