        ...
        case (MR_Integer) 0:
          {
            ...
            }
            {
              ...
              MR_hl_field(3, Spec_14, 1) = (MR_Box) (((((MR_Unsigned) ((MR_Integer) 211) << 1)) | (MR_Unsigned) ((MR_Integer) 1)));
    ...
    case (MR_Integer) 1:
      {
        ...
        }
        {
          Spec_14 = (MR_Word) MR_mkword(3, MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(3, Spec_14, 0) = ((MR_Box) ((MR_String) "predicate \140hlds.make_hlds.state_var.report_unused_svar_in_lambda\'/5"));
          MR_hl_field(3, Spec_14, 1) = (MR_Box) (((((MR_Unsigned) ((MR_Integer) 194) << 1)) | (MR_Unsigned) ((MR_Integer) 1)));
          MR_hl_field(3, Spec_14, 2) = ((MR_Box) ((MR_Unsigned) 4U));
          MR_hl_field(3, Spec_14, 3) = ((MR_Box) ((MR_Unsigned) 44U));
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        }
        {
          ...
          MR_hl_field(3, Spec_37, 1) = (MR_Box) (((((MR_Unsigned) ((MR_Integer) 209) << 1)) | (MR_Unsigned) ((MR_Integer) 1)));
