  ...
  MR_Word * MaybeFileName_13)
{
  ...
  libs__globals__lookup_accumulating_option_3_p_0(Globals_10, (MR_Integer) 711, &Dirs_20);
  parse_tree__find_module__search_for_file_5_p_0(Dirs_20, FileName0_18, MaybeFileName_13);
}
