  ...
  MR_String * FileName_15)
{
  ...
  parse_tree__file_names__module_name_to_file_name_8_p_0(Globals_10, (MR_String) "predicate \140transform_hlds.mmc_analysis.mmc_module_name_to_write_file_name\'/6", (MR_Integer) 0, Var_20, ModuleName_12, FileName_15);
}
  ...
  MR_Word * MaybeFileName_13)
{
  ...
  parse_tree__file_names__module_name_to_search_file_name_7_p_0(Globals_10, (MR_String) "predicate \140transform_hlds.mmc_analysis.mmc_module_name_to_read_file_name\'/6", Var_21, ModuleName_12, &FileName0_18);
  libs__globals__lookup_accumulating_option_3_p_0(Globals_10, (MR_Integer) 685, &Dirs_19);
  parse_tree__find_module__search_for_file_5_p_0(Dirs_19, FileName0_18, MaybeFileName_13);
}
  ...
  MR_Word * FuncId_9)
{
  ...
  *PredModule_8 = hlds__hlds_pred__pred_info_module_1_f_0(PredInfo_10);
  ...
  PredFormArity_13 = hlds__hlds_pred__pred_info_pred_form_arity_1_f_0(PredInfo_10);
  {
    ...
    base = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
    *FuncId_9 = base;
    MR_hl_field(MR_mktag(0), base, 0) = (MR_Box) ((MR_Unsigned) (PredOrFunc_12));
    MR_hl_field(MR_mktag(0), base, 1) = ((MR_Box) (PredName_11));
    MR_hl_field(MR_mktag(0), base, 2) = ((MR_Box) (PredFormArity_13));
