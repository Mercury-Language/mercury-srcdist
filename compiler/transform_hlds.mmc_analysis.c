...
static void MR_CALL 
transform_hlds__mmc_analysis__ClassMethod_for_analysis__compiler____transform_hlds__mmc_analysis__mmc__arity0______analysis__module_name_to_write_file_name_8_8_p_0(
  MR_Word Globals_11,
  MR_Word OtherExt_12,
  MR_Word NewExt_13,
...
static void MR_CALL 
transform_hlds__mmc_analysis__ClassMethod_for_analysis__compiler____transform_hlds__mmc_analysis__mmc__arity0______analysis__module_name_to_read_file_name_8_8_p_0(
  MR_Word Globals_11,
  MR_Word OtherExt_12,
  MR_Word NewExt_13,
  MR_Word ModuleName_14,
  MR_Word * MaybeFileName_15);
...
static void MR_CALL 
transform_hlds__mmc_analysis__ClassMethod_for_analysis__compiler____transform_hlds__mmc_analysis__mmc__arity0______analysis__module_name_to_read_file_name_8_8_p_0_10001(
  MR_Box closure_arg,
  MR_Box wrapper_arg_1,
  MR_Box wrapper_arg_2,
  MR_Box wrapper_arg_3,
...
static void MR_CALL 
transform_hlds__mmc_analysis__ClassMethod_for_analysis__compiler____transform_hlds__mmc_analysis__mmc__arity0______analysis__module_name_to_write_file_name_8_8_p_0_10001(
  MR_Box closure_arg,
  MR_Box wrapper_arg_1,
  MR_Box wrapper_arg_2,
  MR_Box wrapper_arg_3,
...
const MR_BaseTypeclassInfo base_typeclass_info_analysis__compiler__arity1__transform_hlds__mmc_analysis__mmc__arity0__[10] = {
  ...
  ((MR_Box) (transform_hlds__mmc_analysis__ClassMethod_for_analysis__compiler____transform_hlds__mmc_analysis__mmc__arity0______analysis__module_name_to_read_file_name_8_8_p_0_10001)),
  ((MR_Box) (transform_hlds__mmc_analysis__ClassMethod_for_analysis__compiler____transform_hlds__mmc_analysis__mmc__arity0______analysis__module_name_to_write_file_name_8_8_p_0_10001))
};
  ...
  MR_String * FileName_17)
{
...

  {
    ...
    MR_hl_field(1, Var_22, 0) = ((MR_Box) (OtherExt_12));
  }
  parse_tree__file_names__module_name_to_file_name_9_p_0(Globals_11, (MR_String) "predicate \140transform_hlds.mmc_analysis.mmc_module_name_to_write_file_name\'/7", (MR_Integer) 0, Var_22, NewExt_13, ModuleName_14, FileName_17);
}
  ...
  MR_Word * MaybeFileName_15)
{
...

  {
    ...
    MR_hl_field(1, Var_23, 0) = ((MR_Box) (OtherExt_12));
  }
  parse_tree__file_names__module_name_to_search_file_name_8_p_0(Globals_11, (MR_String) "predicate \140transform_hlds.mmc_analysis.mmc_module_name_to_read_file_name\'/7", Var_23, NewExt_13, ModuleName_14, &FileName0_20);
  libs__globals__lookup_accumulating_option_3_p_0(Globals_11, (MR_Integer) 687, &Dirs_21);
  parse_tree__find_module__search_for_file_5_p_0(Dirs_21, FileName0_20, MaybeFileName_15);
}
...
{
  MR_Box closure = closure_arg;
  MR_Word conv0_MaybeFileName_15;

  transform_hlds__mmc_analysis__ClassMethod_for_analysis__compiler____transform_hlds__mmc_analysis__mmc__arity0______analysis__module_name_to_read_file_name_8_8_p_0(((MR_Word) (wrapper_arg_2)), ((MR_Word) (wrapper_arg_3)), ((MR_Word) (wrapper_arg_4)), ((MR_Word) (wrapper_arg_5)), &conv0_MaybeFileName_15);
  *wrapper_arg_6 = ((MR_Box) (conv0_MaybeFileName_15));
}
...
{
  MR_Box closure = closure_arg;
  MR_String conv0_FileName_17;

  transform_hlds__mmc_analysis__ClassMethod_for_analysis__compiler____transform_hlds__mmc_analysis__mmc__arity0______analysis__module_name_to_write_file_name_8_8_p_0(((MR_Word) (wrapper_arg_2)), ((MR_Word) (wrapper_arg_3)), ((MR_Word) (wrapper_arg_4)), ((MR_Word) (wrapper_arg_5)), &conv0_FileName_17);
  *wrapper_arg_6 = ((MR_Box) (conv0_FileName_17));
}
