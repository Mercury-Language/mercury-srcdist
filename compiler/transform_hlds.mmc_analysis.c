...
{
  {
    ...
    libs__globals__lookup_accumulating_option_3_p_0(Globals_10, (MR_Integer) 664, &Dirs_27);
...
{
  {
    ...
    MR_Word PredIds_14;
    MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), FuncId_7, (MR_Integer) 0)));
