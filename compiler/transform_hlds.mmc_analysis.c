...
transform_hlds__mmc_analysis__ClassMethod_for_analysis__compiler____transform_hlds__mmc_analysis__mmc__arity0______analysis__module_name_to_write_file_name_7_7_p_0(
  ...
  MR_String * FileName_15)
{
  parse_tree__file_names__module_name_to_file_name_create_dirs_7_p_0(Globals_10, (MR_String) "predicate \140transform_hlds.mmc_analysis.mmc_module_name_to_write_file_name\'/6", Ext_11, ModuleName_12, FileName_15);
}
  ...
  MR_Word * MaybeFileName_13)
{
  ...
  parse_tree__file_names__module_name_to_search_file_name_5_p_0(Globals_10, (MR_String) "predicate \140transform_hlds.mmc_analysis.mmc_module_name_to_read_file_name\'/6", Ext_11, ModuleName_12, &FileName0_18);
  libs__globals__lookup_accumulating_option_3_p_0(Globals_10, (MR_Integer) 692, &Dirs_19);
