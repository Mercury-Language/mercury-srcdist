...
{
  {
    ...
    libs__globals__lookup_accumulating_option_3_p_0(Globals_10, (MR_Integer) 654, &Dirs_27);
...
{
  {
    MR_Word PredOrFunc_9 = ((MR_Word) (MR_hl_field(MR_mktag(0), FuncId_7, (MR_Integer) 0)));
    ...
    {
      MR_Word Var_28 = ((MR_Word) (MR_hl_field(MR_mktag(1), PredIds_14, (MR_Integer) 1)));
      MR_Word Var_29 = ((MR_Word) (MR_hl_field(MR_mktag(1), PredIds_14, (MR_Integer) 0)));
...
{
  {
    ...
    *PredModule_8 = hlds__hlds_pred__pred_info_module_1_f_0(PredInfo_10);
    ...
    PredArity_17 = hlds__hlds_pred__pred_info_orig_arity_1_f_0(PredInfo_10);
    {
      ...
      base = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL);
      *FuncId_9 = base;
      MR_hl_field(MR_mktag(0), base, 0) = ((MR_Box) (PredOrFunc_16));
