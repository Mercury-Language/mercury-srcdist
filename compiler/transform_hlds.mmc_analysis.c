  ...
  MR_Word * MaybeFileName_13)
{
  ...
  MR_Word Var_23;
  MR_String _FileName0Proposed_19;
  MR_Word _SearchDirs_21;

  parse_tree__file_names__module_name_to_search_file_name_6_p_0(Globals_10, (MR_String) "predicate \140transform_hlds.mmc_analysis.mmc_module_name_to_read_file_name\'/6", Ext_11, ModuleName_12, &FileName0_18, &_FileName0Proposed_19);
  libs__globals__get_options_2_p_0(Globals_10, &OptionTable_20);
  {
    Var_23 = (MR_Word) MR_mkword(3, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(3, Var_23, 0) = ((MR_Box) ((MR_Unsigned) 1U));
    MR_hl_field(3, Var_23, 1) = ((MR_Box) (OptionTable_20));
  }
  parse_tree__find_module__search_for_file_6_p_0(Var_23, FileName0_18, &_SearchDirs_21, MaybeFileName_13);
}
