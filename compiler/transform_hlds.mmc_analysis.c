...
{
  {
    ...
    libs__globals__lookup_accumulating_option_3_p_0(transform_hlds__mmc_analysis__Globals_10, (MR_Integer) 653, &transform_hlds__mmc_analysis__Dirs_27);
  ...
  MR_Word * transform_hlds__mmc_analysis__Analysis_5)
{
  {
    MR_bool transform_hlds__mmc_analysis__succeeded;
    MR_Integer transform_hlds__mmc_analysis__lo_0 = (MR_Integer) 0;
    MR_Integer transform_hlds__mmc_analysis__hi_1 = (MR_Integer) 5;
