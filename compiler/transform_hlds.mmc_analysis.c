  ...
  MR_Word * MaybeFileName_13)
{
  ...
  MR_Word SearchWhichDirs_19;
  MR_Word SearchAuthDirs_20;
  MR_String FileName0_21;
  MR_String _FileName0Proposed_22;
  MR_Word _SearchDirs_23;

  libs__globals__get_options_2_p_0(Globals_10, &OptionTable_18);
  {
    SearchWhichDirs_19 = (MR_Word) MR_mkword(3, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(3, SearchWhichDirs_19, 0) = ((MR_Box) ((MR_Unsigned) 2U));
    MR_hl_field(3, SearchWhichDirs_19, 1) = ((MR_Box) (OptionTable_18));
  }
  parse_tree__file_names__module_name_to_search_file_name_8_p_2(Globals_10, (MR_String) "predicate \140transform_hlds.mmc_analysis.mmc_module_name_to_read_file_name\'/6", Ext_11, ModuleName_12, SearchWhichDirs_19, &SearchAuthDirs_20, &FileName0_21, &_FileName0Proposed_22);
  parse_tree__find_module__search_for_file_6_p_0(SearchAuthDirs_20, FileName0_21, &_SearchDirs_23, MaybeFileName_13);
}
