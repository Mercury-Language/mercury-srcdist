  ...
  MR_Word * MaybeFileName_13)
{
  ...
  libs__globals__lookup_accumulating_option_3_p_0(Globals_10, (MR_Integer) 679, &Dirs_26);
  libs__file_util__search_for_file_5_p_0(Dirs_26, FileName0_25, MaybeFileName_13);
}
