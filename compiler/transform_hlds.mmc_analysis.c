  ...
  MR_String * FileName_15)
{
...

  {
    ...
    MR_hl_field(MR_mktag(1), Var_27, 0) = ((MR_Box) (OtherExt_11));
  }
  parse_tree__file_names__module_name_to_file_name_8_p_0(Globals_10, (MR_String) "predicate \140transform_hlds.mmc_analysis.mmc_module_name_to_write_file_name\'/6", (MR_Integer) 0, Var_27, ModuleName_12, FileName_15);
}
...
transform_hlds__mmc_analysis__ClassMethod_for_analysis__compiler____transform_hlds__mmc_analysis__mmc__arity0______analysis__module_name_to_read_file_name_7_7_p_0(
  ...
  MR_Word * MaybeFileName_13)
{
  MR_String FileName0_25;
  MR_Word Dirs_26;
  MR_Word Var_28;

  {
    Var_28 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(MR_mktag(1), Var_28, 0) = ((MR_Box) (OtherExt_11));
  }
  parse_tree__file_names__module_name_to_search_file_name_7_p_0(Globals_10, (MR_String) "predicate \140transform_hlds.mmc_analysis.mmc_module_name_to_read_file_name\'/6", Var_28, ModuleName_12, &FileName0_25);
  libs__globals__lookup_accumulating_option_3_p_0(Globals_10, (MR_Integer) 681, &Dirs_26);
  parse_tree__find_module__search_for_file_5_p_0(Dirs_26, FileName0_25, MaybeFileName_13);
}
  ...
  MR_Word * PPId_8)
{
  ...
  MR_Word PredFormArity_11 = ((MR_Word) ((MR_hl_field(MR_mktag(0), FuncId_7, (MR_Integer) 2))));
  ...
  *PredModule_7 = hlds__hlds_pred__pred_info_module_1_f_0(PredInfo_5);
  ...
  PredFormArity_11 = hlds__hlds_pred__pred_info_pred_form_arity_1_f_0(PredInfo_5);
  {
    ...
    *FuncId_8 = base;
    ...
    MR_hl_field(MR_mktag(0), base, 2) = ((MR_Box) (PredFormArity_11));
  ...
  MR_Word * FuncId_9)
{
  ...
  *PredModule_8 = hlds__hlds_pred__pred_info_module_1_f_0(PredInfo_10);
  ...
  PredFormArity_17 = hlds__hlds_pred__pred_info_pred_form_arity_1_f_0(PredInfo_10);
  {
    MR_Word base;
    base = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
    *FuncId_9 = base;
    ...
    MR_hl_field(MR_mktag(0), base, 2) = ((MR_Box) (PredFormArity_17));
  ...
  MR_Box * wrapper_arg_7)
{
  ...
  transform_hlds__mmc_analysis__ClassMethod_for_analysis__compiler____transform_hlds__mmc_analysis__mmc__arity0______analysis__module_name_to_read_file_name_7_7_p_0(((MR_Word) (wrapper_arg_2)), ((MR_Word) (wrapper_arg_3)), ((MR_Word) (wrapper_arg_4)), &conv0_MaybeFileName_13);
  ...
  MR_Box * wrapper_arg_7)
{
  ...
  transform_hlds__mmc_analysis__ClassMethod_for_analysis__compiler____transform_hlds__mmc_analysis__mmc__arity0______analysis__module_name_to_write_file_name_7_7_p_0(((MR_Word) (wrapper_arg_2)), ((MR_Word) (wrapper_arg_3)), ((MR_Word) (wrapper_arg_4)), &conv0_FileName_15);
