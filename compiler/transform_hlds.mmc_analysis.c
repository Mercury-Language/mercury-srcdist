  ...
  MR_String * FileName_15)
{
  ...
  parse_tree__file_names__module_name_to_file_name_8_p_0(Globals_10, (MR_String) "predicate \140transform_hlds.mmc_analysis.mmc_module_name_to_write_file_name\'/6", (MR_Integer) 0, Var_28, ModuleName_12, FileName_15);
}
  ...
  MR_Word * MaybeFileName_13)
{
...

  {
    ...
    MR_hl_field(MR_mktag(1), Var_29, 0) = ((MR_Box) (OtherExt_11));
  }
  parse_tree__file_names__module_name_to_search_file_name_7_p_0(Globals_10, (MR_String) "predicate \140transform_hlds.mmc_analysis.mmc_module_name_to_read_file_name\'/6", Var_29, ModuleName_12, &FileName0_26);
  libs__globals__lookup_accumulating_option_3_p_0(Globals_10, (MR_Integer) 681, &Dirs_27);
  parse_tree__find_module__search_for_file_5_p_0(Dirs_27, FileName0_26, MaybeFileName_13);
}
