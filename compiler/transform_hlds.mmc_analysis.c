...
transform_hlds__mmc_analysis__func_id_to_ppid_4_p_0(
  ...
  MR_Word * PPId_8)
{
  MR_Word PredOrFunc_9 = ((MR_Unsigned) ((MR_hl_field(0, FuncId_7, 0))) & (MR_Integer) 1);
  MR_String FuncName_10 = ((MR_String) ((MR_hl_field(0, FuncId_7, 1))));
  MR_Word PredFormArity_11 = ((MR_Word) ((MR_hl_field(0, FuncId_7, 2))));
  MR_Integer ProcId_12 = ((MR_Integer) ((MR_hl_field(0, FuncId_7, 3))));
  MR_Word PredTable_13;
  MR_Word PredId_14;

  hlds__hlds_module__module_info_get_predicate_table_2_p_0(ModuleInfo_5, &PredTable_13);
  hlds__pred_table__predicate_table_lookup_pf_fqm_n_pfa_6_p_0(PredTable_13, PredOrFunc_9, ModuleName_6, FuncName_10, PredFormArity_11, &PredId_14);
  {
    MR_Word base;
    base = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
    *PPId_8 = base;
    MR_hl_field(0, base, 0) = ((MR_Box) (PredId_14));
    MR_hl_field(0, base, 1) = ((MR_Box) (ProcId_12));
  }
}

void MR_CALL 
transform_hlds__mmc_analysis__pred_info_proc_id_to_module_name_func_id_4_p_0(
  MR_Word PredInfo_5,
  MR_Integer ProcId_6,
...
void MR_CALL 
transform_hlds__mmc_analysis__ppid_to_module_name_func_id_4_p_0(
  MR_Word ModuleInfo_5,
