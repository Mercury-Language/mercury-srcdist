  ...
  MR_Word * STATE_VARIABLE_Info_33)
{
  ...
  else
  {
    ...
    hlds__hlds_clauses__get_clause_list_for_replacement_2_p_0(ClausesRep0_17, &Clauses0_26);
    {
      ...
      MR_hl_field(MR_mktag(0), Var_35, 1) = ((MR_Box) (check_hlds__polymorphism_clause__polymorphism_process_clause_info_6_p_0_1));
  ...
  MR_Word * STATE_VARIABLE_Info_67)
{
  ...
  if (succeeded)
  {
    OriginUser_18 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Origin_17, (MR_Integer) 0))));
    succeeded = ((((MR_tag((MR_Word) OriginUser_18)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(MR_mktag(3), OriginUser_18, (MR_Integer) 0)))) == (MR_Integer) 0)));
    if (succeeded)
      InstanceMethodConstraints_20 = ((MR_Word) ((MR_hl_field(MR_mktag(3), OriginUser_18, (MR_Integer) 2))));
  }
  if (succeeded)
  ...
  UnivConstraints_28 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ClassContext_21, (MR_Integer) 0))));
  ExistConstraints_29 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ClassContext_21, (MR_Integer) 1))));
  ...
  *AllExtraHeadTypeInfoVars_14 = mercury__list__f_43_43_2_f_0((MR_Word) (&check_hlds__polymorphism_clause_scalar_common_1[1]), InstanceUnconstrainedTypeInfoVars_24, ExtraHeadTypeInfoVars_48);
  {
    ...
    MR_hl_field(MR_mktag(1), Var_80, 0) = ((MR_Box) (UnconstrainedExistTVars_43));
    MR_hl_field(MR_mktag(1), Var_80, 1) = ((MR_Box) ((MR_Unsigned) 0U));
  }
  {
    Var_79 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(MR_mktag(1), Var_79, 0) = ((MR_Box) (UnconstrainedUnivTVars_42));
    MR_hl_field(MR_mktag(1), Var_79, 1) = ((MR_Box) (Var_80));
  }
  {
    Var_78 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(MR_mktag(1), Var_78, 0) = ((MR_Box) (InstanceUnconstrainedTVars_23));
...
check_hlds__polymorphism_clause__setup_instance_method_headvars_12_p_0(
  ...
  MR_Word * STATE_VARIABLE_Info_39)
{
  MR_Word InstanceTypes_23 = ((MR_Word) ((MR_hl_field(MR_mktag(0), InstanceMethodConstraints_14, (MR_Integer) 1))));
  MR_Word InstanceConstraints_24 = ((MR_Word) ((MR_hl_field(MR_mktag(0), InstanceMethodConstraints_14, (MR_Integer) 2))));
  MR_Word ArgTypeVarSet_25;
  ...
  *ClassContext_15 = ((MR_Word) ((MR_hl_field(MR_mktag(0), InstanceMethodConstraints_14, (MR_Integer) 3))));
  ...
  MR_Word * STATE_VARIABLE_Info_5)
{
  ...
  {
    MR_Word TypeVar_11 = ((MR_Word) ((MR_hl_field(MR_mktag(1), HeadVar__2_2, (MR_Integer) 0))));
    MR_Word TypeVars_12 = ((MR_Word) ((MR_hl_field(MR_mktag(1), HeadVar__2_2, (MR_Integer) 1))));
    ...
    parse_tree__prog_data__get_tvar_kind_3_p_0(TVarKindMap_16, TypeVar_11, &Kind_17);
    {
      ...
      MR_hl_field(MR_mktag(0), Type_18, 0) = ((MR_Box) (TypeVar_11));
      MR_hl_field(MR_mktag(0), Type_18, 1) = ((MR_Box) (Kind_17));
    }
    ...
    check_hlds__polymorphism_clause__make_head_vars_5_p_0(TypeVarSet_1, TypeVars_12, &TypeInfoVars_14, STATE_VARIABLE_Info_28_28, STATE_VARIABLE_Info_5);
    {
      ...
      *HeadVar__3_3 = base;
      MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (TypeInfoVar_13));
      MR_hl_field(MR_mktag(1), base, 1) = ((MR_Box) (TypeInfoVars_14));
    }
  }
}
