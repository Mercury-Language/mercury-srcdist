  ...
  MR_Word * STATE_VARIABLE_Info_27)
{
  ...
  check_hlds__polymorphism_type_class_info__make_typeclass_info_vars_7_p_0(ActualExistConstraints_46, (MR_Word) ((MR_Unsigned) 0U), Context_50, &ExistTypeClassVarsMCAs_51, &ExtraTypeClassGoals_52, STATE_VARIABLE_Info_3_31, &STATE_VARIABLE_Info_1_67);
  ...
  check_hlds__polymorphism_info__poly_info_get_rtti_varmaps_2_p_0(STATE_VARIABLE_Info_1_67, &RttiVarMaps0_54);
  ...
  check_hlds__polymorphism_info__poly_info_set_rtti_varmaps_3_p_0(RttiVarMaps_55, STATE_VARIABLE_Info_1_67, &STATE_VARIABLE_Info_2_69);
  ...
  else
  {
    ...
    parse_tree__var_table__lookup_var_types_3_p_0(VarTable0_40, HeadVarList_58, &ActualArgTypes_59);
    succeeded = parse_tree__prog_type_unify__type_list_subsumes_3_p_0(ArgTypes_42, ActualArgTypes_59, &ArgTypeSubst_60);
    if (succeeded)
      PredToActualTypeSubst_57 = ArgTypeSubst_60;
    else
      mercury__map__init_1_p_0((MR_Word) (&check_hlds__polymorphism_clause_scalar_common_1[0]), (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0), &PredToActualTypeSubst_57);
  }
  parse_tree__prog_type_subst__apply_subst_to_tvars_4_p_0(KindMap_43, PredToActualTypeSubst_57, UnconstrainedTVars_14, &ActualTypes_61);
  check_hlds__polymorphism_type_info__polymorphism_do_make_type_info_vars_6_p_0(ActualTypes_61, Context_50, &TypeInfoVarsMCAs_62, &ExtraTypeInfoGoals_63, STATE_VARIABLE_Info_2_69, &STATE_VARIABLE_Info_4_32);
  ...
  hlds__make_goal__make_complicated_unify_assigns_3_p_0(ExtraTypeInfoHeadVars_15, TypeInfoVars_64, &ExtraTypeInfoUnifyGoals_65);
  {
    ...
    MR_hl_field(1, Var_71, 1) = ((MR_Box) (ExtraTypeClassGoals_52));
  }
  {
  ...
  }
  {
    ...
    MR_hl_field(1, Var_72, 0) = ((MR_Box) (ExtraTypeClassUnifyGoals_56));
  ...
  hlds__goal_list_util__conj_list_to_goal_3_p_0(GoalList_66, GoalInfo_49, &Goal2_21);
