  ...
  MR_Word * STATE_VARIABLE_Info_27)
{
  ...
  MR_Word RttiVarMaps0_91;
  MR_Integer NumReuses_92;
  MR_Word MustRequantify_93;
  MR_Word Var_33;
  MR_Word Var_35;
  MR_Word Var_36;
  MR_Word Var_37;
  ...
  check_hlds__polymorphism_info__poly_info_get_var_table_2_p_0(STATE_VARIABLE_Info_3_31, &VarTable0_40);
  check_hlds__polymorphism_info__poly_info_get_constraint_map_2_p_0(STATE_VARIABLE_Info_3_31, &ConstraintMap_41);
  ...
  PredExistConstraints_45 = ((MR_Word) ((MR_hl_field(0, PredClassContext_44, 1))));
  ...
  GoalInfo_49 = ((MR_Word) ((MR_hl_field(0, Goal1_20, 1))));
  Context_50 = hlds__hlds_goal__goal_info_get_context_1_f_0(GoalInfo_49);
  check_hlds__polymorphism_type_class_info__make_typeclass_info_vars_7_p_0(ActualExistConstraints_46, (MR_Word) ((MR_Unsigned) 0U), Context_50, &ExistTypeClassVarsMCAs_51, &ExtraTypeClassGoals_52, STATE_VARIABLE_Info_3_31, &STATE_VARIABLE_Info_1_68);
  mercury__assoc_list__keys_2_p_0((MR_Word) (&check_hlds__polymorphism_clause_scalar_common_1[1]), (MR_Word) (&check_hlds__polymorphism_clause_scalar_common_1[2]), ExistTypeClassVarsMCAs_51, &ExistTypeClassVars_53);
  check_hlds__polymorphism_info__poly_info_get_rtti_varmaps_2_p_0(STATE_VARIABLE_Info_1_68, &RttiVarMaps0_54);
  mercury__list__foldl_4_p_0((MR_Word) (&check_hlds__polymorphism_clause_scalar_common_1[1]), (MR_Word) (&hlds__hlds_rtti__hlds__hlds_rtti__type_ctor_info_rtti_varmaps_0), (MR_Word) (&check_hlds__polymorphism_clause_scalar_common_3[8]), ExistTypeClassVars_53, ((MR_Box) (RttiVarMaps0_54)), &conv1_RttiVarMaps_55);
  RttiVarMaps_55 = ((MR_Word) (conv1_RttiVarMaps_55));
  check_hlds__polymorphism_info__poly_info_set_rtti_varmaps_3_p_0(RttiVarMaps_55, STATE_VARIABLE_Info_1_68, &STATE_VARIABLE_Info_2_70);
  ...
  parse_tree__var_table__var_table_count_2_p_0(VarTable0_40, &NumVarsInDb0_57);
  succeeded = (NumVarsInDb0_57 == (MR_Integer) 0);
  if (succeeded)
    mercury__map__init_1_p_0((MR_Word) (&check_hlds__polymorphism_clause_scalar_common_1[0]), (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0), &PredToActualTypeSubst_58);
  else
  {
    ...
    HeadVarList_59 = hlds__hlds_args__proc_arg_vector_to_list_1_f_0((MR_Word) (&check_hlds__polymorphism_clause_scalar_common_1[1]), OldHeadVars_12);
    parse_tree__var_table__lookup_var_types_3_p_0(VarTable0_40, HeadVarList_59, &ActualArgTypes_60);
    succeeded = parse_tree__prog_type_unify__type_list_subsumes_3_p_0(ArgTypes_42, ActualArgTypes_60, &ArgTypeSubst_61);
    if (succeeded)
      PredToActualTypeSubst_58 = ArgTypeSubst_61;
    else
      mercury__map__init_1_p_0((MR_Word) (&check_hlds__polymorphism_clause_scalar_common_1[0]), (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0), &PredToActualTypeSubst_58);
  }
  parse_tree__prog_type_subst__apply_subst_to_tvars_4_p_0(KindMap_43, PredToActualTypeSubst_58, UnconstrainedTVars_14, &ActualTypes_62);
  check_hlds__polymorphism_type_info__polymorphism_do_make_type_info_vars_6_p_0(ActualTypes_62, Context_50, &TypeInfoVarsMCAs_63, &ExtraTypeInfoGoals_64, STATE_VARIABLE_Info_2_70, &STATE_VARIABLE_Info_4_32);
  mercury__assoc_list__keys_2_p_0((MR_Word) (&check_hlds__polymorphism_clause_scalar_common_1[1]), (MR_Word) (&check_hlds__polymorphism_clause_scalar_common_1[2]), TypeInfoVarsMCAs_63, &TypeInfoVars_65);
  hlds__make_goal__make_complicated_unify_assigns_3_p_0(ExtraTypeInfoHeadVars_15, TypeInfoVars_65, &ExtraTypeInfoUnifyGoals_66);
  {
    ...
    MR_hl_field(1, Var_72, 0) = ((MR_Box) (Goal1_20));
    MR_hl_field(1, Var_72, 1) = ((MR_Box) (ExtraTypeClassGoals_52));
  }
  {
    Var_75 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(1, Var_75, 0) = ((MR_Box) (ExtraTypeInfoUnifyGoals_66));
    MR_hl_field(1, Var_75, 1) = ((MR_Box) ((MR_Unsigned) 0U));
  }
  {
    Var_74 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(1, Var_74, 0) = ((MR_Box) (ExtraTypeInfoGoals_64));
    MR_hl_field(1, Var_74, 1) = ((MR_Box) (Var_75));
  }
  {
    Var_73 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(1, Var_73, 0) = ((MR_Box) (ExtraTypeClassUnifyGoals_56));
  ...
  if (succeeded)
  {
    check_hlds__polymorphism_info__poly_info_get_rtti_varmaps_2_p_0(STATE_VARIABLE_Info_4_32, &RttiVarMaps0_91);
    succeeded = hlds__hlds_rtti__rtti_varmaps_no_tvars_1_p_0(RttiVarMaps0_91);
    if (succeeded)
    {
      check_hlds__polymorphism_info__poly_info_get_num_reuses_2_p_0(STATE_VARIABLE_Info_4_32, &NumReuses_92);
      succeeded = (NumReuses_92 == (MR_Integer) 0);
      if (succeeded)
      {
        check_hlds__polymorphism_info__poly_info_get_must_requantify_2_p_0(STATE_VARIABLE_Info_4_32, &MustRequantify_93);
        succeeded = (MustRequantify_93 == (MR_Integer) 0);
      }
    }
  }
  if (succeeded)
  ...
  {
    MR_Word VarTable0_94;
    MR_Word OutsideVars_95;
    MR_Word VarTable_97;
    MR_Word RttiVarMaps_98;
    MR_Word Var_100;
    MR_Word RttiVarMaps0_101;
    MR_Word _Warnings_96;

    check_hlds__polymorphism_info__poly_info_get_var_table_2_p_0(STATE_VARIABLE_Info_4_32, &VarTable0_94);
    check_hlds__polymorphism_info__poly_info_get_rtti_varmaps_2_p_0(STATE_VARIABLE_Info_4_32, &RttiVarMaps0_101);
    OutsideVars_95 = hlds__hlds_args__proc_arg_vector_to_set_1_f_0((MR_Word) (&check_hlds__polymorphism_clause_scalar_common_1[1]), NewHeadVars_13);
    Var_100 = parse_tree__set_of_var__set_to_bitset_1_f_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), OutsideVars_95);
    hlds__quantification__implicitly_quantify_goal_general_9_p_0((MR_Integer) 0, Var_100, &_Warnings_96, Goal2_21, &Goal_23, VarTable0_94, &VarTable_97, RttiVarMaps0_101, &RttiVarMaps_98);
    check_hlds__polymorphism_info__poly_info_set_var_table_rtti_4_p_0(VarTable_97, RttiVarMaps_98, STATE_VARIABLE_Info_4_32, STATE_VARIABLE_Info_27);
  }
  ...
  Var_39 = ((MR_Unsigned) ((MR_hl_field(0, STATE_VARIABLE_Clause_0_24, 6))) & (MR_Integer) 1);
  {
    MR_Word base;
    ...
    *STATE_VARIABLE_Clause_25 = base;
    ...
    MR_hl_field(0, base, 6) = (MR_Box) ((MR_Unsigned) (Var_39));
  }
}
  ...
  MR_Word * STATE_VARIABLE_Info_67)
{
  ...
  succeeded = hlds__hlds_markers__marker_is_present_2_p_0(PredMarkers_34, (MR_Integer) 12);
  if (succeeded)
