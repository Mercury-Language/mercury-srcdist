  ...
  MR_Word * STATE_VARIABLE_Info_27)
{
  ...
  MR_Word ArgTypes_41;
  MR_Word KindMap_42;
  MR_Word PredClassContext_43;
  MR_Word PredExistConstraints_44;
  MR_Word ActualExistConstraints_45;
  MR_Word GoalInfo_48;
  MR_Word Context_49;
  MR_Word ExistTypeClassVarsMCAs_50;
  MR_Word ExtraTypeClassGoals_51;
  MR_Word ExistTypeClassVars_52;
  MR_Word RttiVarMaps0_53;
  MR_Word RttiVarMaps_54;
  MR_Word ExtraTypeClassUnifyGoals_55;
  MR_Integer NumVarsInDb0_56;
  ...
  check_hlds__polymorphism_info__empty_cache_maps_2_p_0(STATE_VARIABLE_Info_0_26, &STATE_VARIABLE_Info_1_28);
  check_hlds__polymorphism_info__poly_info_set_num_reuses_3_p_0((MR_Integer) 0, STATE_VARIABLE_Info_1_28, &STATE_VARIABLE_Info_2_30);
  check_hlds__polymorphism_goal__polymorphism_process_goal_4_p_0(Goal0_19, &Goal1_20, STATE_VARIABLE_Info_2_30, &STATE_VARIABLE_Info_3_31);
  check_hlds__polymorphism_info__poly_info_get_var_table_2_p_0(STATE_VARIABLE_Info_3_31, &VarTable0_39);
  check_hlds__polymorphism_info__poly_info_get_constraint_map_2_p_0(STATE_VARIABLE_Info_3_31, &ConstraintMap_40);
  hlds__hlds_pred__pred_info_get_arg_types_2_p_0(PredInfo0_11, &ArgTypes_41);
  hlds__hlds_pred__pred_info_get_tvar_kind_map_2_p_0(PredInfo0_11, &KindMap_42);
  hlds__hlds_pred__pred_info_get_class_context_2_p_0(PredInfo0_11, &PredClassContext_43);
  PredExistConstraints_44 = ((MR_Word) ((MR_hl_field(0, PredClassContext_43, 1))));
  mercury__list__length_2_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_constraint_0), PredExistConstraints_44, &NumExistConstraints_85);
  Var_88 = mdbcomp__goal_path__goal_id_for_head_constraints_0_f_0();
  succeeded = hlds__hlds_class__search_hlds_constraint_list_5_p_0(ConstraintMap_40, (MR_Integer) 0, Var_88, NumExistConstraints_85, &ActualExistConstraintsPrime_86);
  if (succeeded)
    ActualExistConstraints_45 = ActualExistConstraintsPrime_86;
  else
    ActualExistConstraints_45 = PredExistConstraints_44;
  GoalInfo_48 = ((MR_Word) ((MR_hl_field(0, Goal1_20, 1))));
  Context_49 = hlds__hlds_goal__goal_info_get_context_1_f_0(GoalInfo_48);
  check_hlds__polymorphism_type_class_info__make_typeclass_info_vars_7_p_0(ActualExistConstraints_45, (MR_Word) ((MR_Unsigned) 0U), Context_49, &ExistTypeClassVarsMCAs_50, &ExtraTypeClassGoals_51, STATE_VARIABLE_Info_3_31, &STATE_VARIABLE_Info_1_67);
  mercury__assoc_list__keys_2_p_0((MR_Word) (&check_hlds__polymorphism_clause_scalar_common_1[1]), (MR_Word) (&check_hlds__polymorphism_clause_scalar_common_1[2]), ExistTypeClassVarsMCAs_50, &ExistTypeClassVars_52);
  check_hlds__polymorphism_info__poly_info_get_rtti_varmaps_2_p_0(STATE_VARIABLE_Info_1_67, &RttiVarMaps0_53);
  mercury__list__foldl_4_p_0((MR_Word) (&check_hlds__polymorphism_clause_scalar_common_1[1]), (MR_Word) (&hlds__hlds_rtti__hlds__hlds_rtti__type_ctor_info_rtti_varmaps_0), (MR_Word) (&check_hlds__polymorphism_clause_scalar_common_3[8]), ExistTypeClassVars_52, ((MR_Box) (RttiVarMaps0_53)), &conv1_RttiVarMaps_54);
  RttiVarMaps_54 = ((MR_Word) (conv1_RttiVarMaps_54));
  check_hlds__polymorphism_info__poly_info_set_rtti_varmaps_3_p_0(RttiVarMaps_54, STATE_VARIABLE_Info_1_67, &STATE_VARIABLE_Info_2_69);
  hlds__make_goal__make_complicated_unify_assigns_3_p_0(ExistTypeClassInfoHeadVars_16, ExistTypeClassVars_52, &ExtraTypeClassUnifyGoals_55);
  parse_tree__var_table__var_table_count_2_p_0(VarTable0_39, &NumVarsInDb0_56);
  succeeded = (NumVarsInDb0_56 == (MR_Integer) 0);
  if (succeeded)
    mercury__map__init_1_p_0((MR_Word) (&check_hlds__polymorphism_clause_scalar_common_1[0]), (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0), &PredToActualTypeSubst_57);
  else
  {
    ...
    HeadVarList_58 = hlds__hlds_args__proc_arg_vector_to_list_1_f_0((MR_Word) (&check_hlds__polymorphism_clause_scalar_common_1[1]), OldHeadVars_12);
    parse_tree__var_table__lookup_var_types_3_p_0(VarTable0_39, HeadVarList_58, &ActualArgTypes_59);
    succeeded = parse_tree__prog_type_unify__type_list_subsumes_3_p_0(ArgTypes_41, ActualArgTypes_59, &ArgTypeSubst_60);
    if (succeeded)
      PredToActualTypeSubst_57 = ArgTypeSubst_60;
    else
      mercury__map__init_1_p_0((MR_Word) (&check_hlds__polymorphism_clause_scalar_common_1[0]), (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0), &PredToActualTypeSubst_57);
  }
  parse_tree__prog_type_subst__apply_subst_to_tvar_list_4_p_0(KindMap_42, PredToActualTypeSubst_57, UnconstrainedTVars_14, &ActualTypes_61);
  check_hlds__polymorphism_type_info__polymorphism_do_make_type_info_vars_6_p_0(ActualTypes_61, Context_49, &TypeInfoVarsMCAs_62, &ExtraTypeInfoGoals_63, STATE_VARIABLE_Info_2_69, &STATE_VARIABLE_Info_4_32);
  mercury__assoc_list__keys_2_p_0((MR_Word) (&check_hlds__polymorphism_clause_scalar_common_1[1]), (MR_Word) (&check_hlds__polymorphism_clause_scalar_common_1[2]), TypeInfoVarsMCAs_62, &TypeInfoVars_64);
  hlds__make_goal__make_complicated_unify_assigns_3_p_0(ExtraTypeInfoHeadVars_15, TypeInfoVars_64, &ExtraTypeInfoUnifyGoals_65);
  {
    ...
    MR_hl_field(1, Var_71, 0) = ((MR_Box) (Goal1_20));
    MR_hl_field(1, Var_71, 1) = ((MR_Box) (ExtraTypeClassGoals_51));
  }
  {
    Var_74 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(1, Var_74, 0) = ((MR_Box) (ExtraTypeInfoUnifyGoals_65));
    MR_hl_field(1, Var_74, 1) = ((MR_Box) ((MR_Unsigned) 0U));
  }
  {
    Var_73 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(1, Var_73, 0) = ((MR_Box) (ExtraTypeInfoGoals_63));
    MR_hl_field(1, Var_73, 1) = ((MR_Box) (Var_74));
  }
  {
    Var_72 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(1, Var_72, 0) = ((MR_Box) (ExtraTypeClassUnifyGoals_55));
  ...
  hlds__hlds_goal__conj_list_to_goal_3_p_0(GoalList_66, GoalInfo_48, &Goal2_21);
  ...
  if (succeeded)
  {
    check_hlds__polymorphism_info__poly_info_get_rtti_varmaps_2_p_0(STATE_VARIABLE_Info_4_32, &RttiVarMaps0_90);
    succeeded = hlds__hlds_rtti__rtti_varmaps_no_tvars_1_p_0(RttiVarMaps0_90);
    if (succeeded)
    {
      check_hlds__polymorphism_info__poly_info_get_num_reuses_2_p_0(STATE_VARIABLE_Info_4_32, &NumReuses_91);
      succeeded = (NumReuses_91 == (MR_Integer) 0);
      if (succeeded)
      {
        check_hlds__polymorphism_info__poly_info_get_must_requantify_2_p_0(STATE_VARIABLE_Info_4_32, &MustRequantify_92);
  ...
  {
    Goal_23 = Goal2_21;
    *STATE_VARIABLE_Info_27 = STATE_VARIABLE_Info_4_32;
  }
  else
  {
    MR_Word VarTable0_93;
    MR_Word OutsideVars_94;
    MR_Word VarTable_96;
    MR_Word RttiVarMaps_97;
    MR_Word Var_99;
    MR_Word RttiVarMaps0_100;
    MR_Word _Warnings_95;

    check_hlds__polymorphism_info__poly_info_get_var_table_2_p_0(STATE_VARIABLE_Info_4_32, &VarTable0_93);
    check_hlds__polymorphism_info__poly_info_get_rtti_varmaps_2_p_0(STATE_VARIABLE_Info_4_32, &RttiVarMaps0_100);
    OutsideVars_94 = hlds__hlds_args__proc_arg_vector_to_set_1_f_0((MR_Word) (&check_hlds__polymorphism_clause_scalar_common_1[1]), NewHeadVars_13);
    Var_99 = parse_tree__set_of_var__set_to_bitset_1_f_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), OutsideVars_94);
    hlds__quantification__implicitly_quantify_goal_general_9_p_0((MR_Integer) 0, Var_99, &_Warnings_95, Goal2_21, &Goal_23, VarTable0_93, &VarTable_96, RttiVarMaps0_100, &RttiVarMaps_97);
    check_hlds__polymorphism_info__poly_info_set_var_table_rtti_4_p_0(VarTable_96, RttiVarMaps_97, STATE_VARIABLE_Info_4_32, STATE_VARIABLE_Info_27);
  }
  Var_33 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_Clause_0_24, 0))));
  Var_35 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_Clause_0_24, 2))));
  Var_36 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_Clause_0_24, 3))));
  Var_37 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_Clause_0_24, 4))));
  Var_38 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_Clause_0_24, 5))));
  {
    MR_Word base;
  ...
  MR_Box * wrapper_arg_4)
{
  ...
  check_hlds__polymorphism_clause__polymorphism_process_clause_10_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) ((MR_hl_field(0, closure, 4)))), ((MR_Word) ((MR_hl_field(0, closure, 5)))), ((MR_Word) ((MR_hl_field(0, closure, 6)))), ((MR_Word) ((MR_hl_field(0, closure, 7)))), ((MR_Word) ((MR_hl_field(0, closure, 8)))), ((MR_Word) (wrapper_arg_1)), &conv1_STATE_VARIABLE_Clause_25, ((MR_Word) (wrapper_arg_3)), &conv0_STATE_VARIABLE_Info_27);
...
{
  MR_bool succeeded;
  MR_Word VarSet_11 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_ClausesInfo_0_30, 0))));
  MR_Word ExplicitVarTypes_12 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_ClausesInfo_0_30, 1))));
  MR_Word TVarNameMap_15 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_ClausesInfo_0_30, 4))));
  MR_Word HeadVars0_16 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_ClausesInfo_0_30, 5))));
  MR_Word ClausesRep0_17 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_ClausesInfo_0_30, 6))));
  MR_Word ItemNumbers_18 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_ClausesInfo_0_30, 7))));
  MR_Word HeadVars_21;
  ...
  MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(0, STATE_VARIABLE_ClausesInfo_0_30, 8)));

  check_hlds__polymorphism_clause__setup_headvars_9_p_0(PredInfo0_7, HeadVars0_16, &HeadVars_21, ExtraArgModes_8, &UnconstrainedTVars_22, &ExtraTypeInfoHeadVars_23, &ExistTypeClassInfoHeadVars_24, STATE_VARIABLE_Info_0_32, &STATE_VARIABLE_Info_1_34);
  ...
  MR_Word * STATE_VARIABLE_Info_67)
{
  ...
  MR_Word STATE_VARIABLE_ExtraArgModes_1_68;
  MR_Word STATE_VARIABLE_HeadVars_1_69;
  MR_Word STATE_VARIABLE_ExtraArgModes_2_70;
  MR_Word STATE_VARIABLE_Info_1_71;
  MR_Word STATE_VARIABLE_Info_2_73;
  MR_Word STATE_VARIABLE_Info_3_75;
  MR_Word STATE_VARIABLE_Info_4_76;
  MR_Word STATE_VARIABLE_Info_5_77;
  MR_Word Var_78;
  MR_Word Var_79;
  MR_Word Var_80;
  MR_Word STATE_VARIABLE_HeadVars_2_82;
  MR_Word STATE_VARIABLE_HeadVars_3_83;
  MR_Word STATE_VARIABLE_HeadVars_4_84;
  MR_Word STATE_VARIABLE_ExtraArgModes_3_86;
  MR_Word STATE_VARIABLE_ExtraArgModes_4_87;
  MR_Word STATE_VARIABLE_ExtraArgModes_5_88;
  MR_Word STATE_VARIABLE_RttiVarMaps_1_90;
  MR_Word STATE_VARIABLE_RttiVarMaps_2_93;
  MR_Word STATE_VARIABLE_RttiVarMaps_3_96;
  MR_Word STATE_VARIABLE_RttiVarMaps_4_99;
  MR_Word STATE_VARIABLE_RttiVarMaps_5_101;
  ...
  MR_Box conv2_STATE_VARIABLE_RttiVarMaps_2_93;
  MR_Box conv5_STATE_VARIABLE_RttiVarMaps_3_96;
  MR_Box conv8_STATE_VARIABLE_RttiVarMaps_4_99;
  MR_Box conv10_STATE_VARIABLE_RttiVarMaps_5_101;

  hlds__hlds_pred__pred_info_get_origin_2_p_0(PredInfo_10, &Origin_17);
  STATE_VARIABLE_ExtraArgModes_1_68 = hlds__hlds_args__poly_arg_vector_init_0_f_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_mode_0));
  succeeded = ((MR_tag((MR_Word) Origin_17)) == (MR_Integer) 0);
  if (succeeded)
  {
    OriginUser_18 = ((MR_Word) ((MR_hl_field(0, Origin_17, 0))));
    succeeded = ((((MR_tag((MR_Word) OriginUser_18)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(3, OriginUser_18, 0)))) == (MR_Integer) 0)));
    if (succeeded)
      InstanceMethodConstraints_20 = ((MR_Word) ((MR_hl_field(3, OriginUser_18, 2))));
  }
  if (succeeded)
    check_hlds__polymorphism_clause__setup_instance_method_headvars_12_p_0(PredInfo_10, InstanceMethodConstraints_20, &ClassContext_21, &InstanceTVars_22, &InstanceUnconstrainedTVars_23, &InstanceUnconstrainedTypeInfoVars_24, STATE_VARIABLE_HeadVars_0_63, &STATE_VARIABLE_HeadVars_1_69, STATE_VARIABLE_ExtraArgModes_1_68, &STATE_VARIABLE_ExtraArgModes_2_70, STATE_VARIABLE_Info_0_66, &STATE_VARIABLE_Info_1_71);
  else
  {
    ...
    STATE_VARIABLE_Info_1_71 = STATE_VARIABLE_Info_0_66;
    STATE_VARIABLE_ExtraArgModes_2_70 = STATE_VARIABLE_ExtraArgModes_1_68;
    STATE_VARIABLE_HeadVars_1_69 = STATE_VARIABLE_HeadVars_0_63;
  }
  hlds__hlds_pred__pred_info_get_arg_types_4_p_0(PredInfo_10, &ArgTypeVarSet_25, &ExistQVars_26, &ArgTypes_27);
  UnivConstraints_28 = ((MR_Word) ((MR_hl_field(0, ClassContext_21, 0))));
  ExistConstraints_29 = ((MR_Word) ((MR_hl_field(0, ClassContext_21, 1))));
  ...
  check_hlds__polymorphism_info__poly_info_get_constraint_map_2_p_0(STATE_VARIABLE_Info_1_71, &ConstraintMap_32);
  ...
  check_hlds__polymorphism_type_class_info__make_typeclass_info_head_vars_5_p_0(RecordExistQLocns_35, ActualExistConstraints_33, ExistHeadTypeClassInfoVars_15, STATE_VARIABLE_Info_1_71, &STATE_VARIABLE_Info_2_73);
  check_hlds__polymorphism_type_class_info__make_typeclass_info_head_vars_5_p_0((MR_Integer) 0, UnivConstraints_28, &UnivHeadTypeClassInfoVars_36, STATE_VARIABLE_Info_2_73, &STATE_VARIABLE_Info_3_75);
  ...
  if ((ExistQVars_26 == (MR_Word) ((MR_Unsigned) 0U)))
  {
    ...
    STATE_VARIABLE_Info_4_76 = STATE_VARIABLE_Info_3_75;
  }
  else
  {
    ...
    check_hlds__polymorphism_clause__make_head_vars_5_p_0(ArgTypeVarSet_25, UnconstrainedExistTVars_43, &ExistHeadTypeInfoVars_44, STATE_VARIABLE_Info_3_75, &STATE_VARIABLE_Info_4_76);
  }
  check_hlds__polymorphism_clause__make_head_vars_5_p_0(ArgTypeVarSet_25, UnconstrainedUnivTVars_42, &UnivHeadTypeInfoVars_47, STATE_VARIABLE_Info_4_76, &STATE_VARIABLE_Info_5_77);
  ...
  *AllExtraHeadTypeInfoVars_14 = mercury__list__f_43_43_2_f_0((MR_Word) (&check_hlds__polymorphism_clause_scalar_common_1[1]), InstanceUnconstrainedTypeInfoVars_24, ExtraHeadTypeInfoVars_48);
  ...
  hlds__hlds_args__proc_arg_vector_set_univ_type_infos_3_p_0((MR_Word) (&check_hlds__polymorphism_clause_scalar_common_1[1]), UnivHeadTypeInfoVars_47, STATE_VARIABLE_HeadVars_1_69, &STATE_VARIABLE_HeadVars_2_82);
  hlds__hlds_args__proc_arg_vector_set_exist_type_infos_3_p_0((MR_Word) (&check_hlds__polymorphism_clause_scalar_common_1[1]), ExistHeadTypeInfoVars_44, STATE_VARIABLE_HeadVars_2_82, &STATE_VARIABLE_HeadVars_3_83);
  hlds__hlds_args__proc_arg_vector_set_univ_typeclass_infos_3_p_0((MR_Word) (&check_hlds__polymorphism_clause_scalar_common_1[1]), UnivHeadTypeClassInfoVars_36, STATE_VARIABLE_HeadVars_3_83, &STATE_VARIABLE_HeadVars_4_84);
  hlds__hlds_args__proc_arg_vector_set_exist_typeclass_infos_3_p_0((MR_Word) (&check_hlds__polymorphism_clause_scalar_common_1[1]), *ExistHeadTypeClassInfoVars_15, STATE_VARIABLE_HeadVars_4_84, STATE_VARIABLE_HeadVars_64);
  ...
  hlds__hlds_args__poly_arg_vector_set_univ_type_infos_3_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_mode_0), UnivTypeInfoModes_55, STATE_VARIABLE_ExtraArgModes_2_70, &STATE_VARIABLE_ExtraArgModes_3_86);
  hlds__hlds_args__poly_arg_vector_set_exist_type_infos_3_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_mode_0), ExistTypeInfoModes_56, STATE_VARIABLE_ExtraArgModes_3_86, &STATE_VARIABLE_ExtraArgModes_4_87);
  hlds__hlds_args__poly_arg_vector_set_univ_typeclass_infos_3_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_mode_0), UnivTypeClassInfoModes_57, STATE_VARIABLE_ExtraArgModes_4_87, &STATE_VARIABLE_ExtraArgModes_5_88);
  hlds__hlds_args__poly_arg_vector_set_exist_typeclass_infos_3_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_mode_0), ExistTypeClassInfoModes_58, STATE_VARIABLE_ExtraArgModes_5_88, STATE_VARIABLE_ExtraArgModes_65);
  check_hlds__polymorphism_info__poly_info_get_rtti_varmaps_2_p_0(STATE_VARIABLE_Info_5_77, &STATE_VARIABLE_RttiVarMaps_1_90);
  ...
  mercury__list__foldl_corresponding_5_p_0((MR_Word) (&check_hlds__polymorphism_clause_scalar_common_1[0]), (MR_Word) (&hlds__hlds_rtti__hlds__hlds_rtti__type_ctor_info_type_info_locn_0), (MR_Word) (&hlds__hlds_rtti__hlds__hlds_rtti__type_ctor_info_rtti_varmaps_0), (MR_Word) (&check_hlds__polymorphism_clause_scalar_common_3[2]), UnconstrainedUnivTVars_42, UnivTypeLocns_60, ((MR_Box) (STATE_VARIABLE_RttiVarMaps_1_90)), &conv2_STATE_VARIABLE_RttiVarMaps_2_93);
  STATE_VARIABLE_RttiVarMaps_2_93 = ((MR_Word) (conv2_STATE_VARIABLE_RttiVarMaps_2_93));
  ...
  mercury__list__foldl_corresponding_5_p_0((MR_Word) (&check_hlds__polymorphism_clause_scalar_common_1[0]), (MR_Word) (&hlds__hlds_rtti__hlds__hlds_rtti__type_ctor_info_type_info_locn_0), (MR_Word) (&hlds__hlds_rtti__hlds__hlds_rtti__type_ctor_info_rtti_varmaps_0), (MR_Word) (&check_hlds__polymorphism_clause_scalar_common_3[4]), UnconstrainedExistTVars_43, ExistTypeLocns_61, ((MR_Box) (STATE_VARIABLE_RttiVarMaps_2_93)), &conv5_STATE_VARIABLE_RttiVarMaps_3_96);
  STATE_VARIABLE_RttiVarMaps_3_96 = ((MR_Word) (conv5_STATE_VARIABLE_RttiVarMaps_3_96));
  ...
  mercury__list__foldl_corresponding_5_p_0((MR_Word) (&check_hlds__polymorphism_clause_scalar_common_1[0]), (MR_Word) (&hlds__hlds_rtti__hlds__hlds_rtti__type_ctor_info_type_info_locn_0), (MR_Word) (&hlds__hlds_rtti__hlds__hlds_rtti__type_ctor_info_rtti_varmaps_0), (MR_Word) (&check_hlds__polymorphism_clause_scalar_common_3[6]), InstanceUnconstrainedTVars_23, InstanceUnconstrainedTypeLocns_62, ((MR_Box) (STATE_VARIABLE_RttiVarMaps_3_96)), &conv8_STATE_VARIABLE_RttiVarMaps_4_99);
  STATE_VARIABLE_RttiVarMaps_4_99 = ((MR_Word) (conv8_STATE_VARIABLE_RttiVarMaps_4_99));
  mercury__list__foldl_4_p_0((MR_Word) (&check_hlds__polymorphism_clause_scalar_common_1[1]), (MR_Word) (&hlds__hlds_rtti__hlds__hlds_rtti__type_ctor_info_rtti_varmaps_0), (MR_Word) (&check_hlds__polymorphism_clause_scalar_common_3[7]), UnivHeadTypeClassInfoVars_36, ((MR_Box) (STATE_VARIABLE_RttiVarMaps_4_99)), &conv10_STATE_VARIABLE_RttiVarMaps_5_101);
  STATE_VARIABLE_RttiVarMaps_5_101 = ((MR_Word) (conv10_STATE_VARIABLE_RttiVarMaps_5_101));
  check_hlds__polymorphism_info__poly_info_set_rtti_varmaps_3_p_0(STATE_VARIABLE_RttiVarMaps_5_101, STATE_VARIABLE_Info_5_77, STATE_VARIABLE_Info_67);
}
...
check_hlds__polymorphism_clause__setup_instance_method_headvars_12_p_0(
  ...
  MR_Word * STATE_VARIABLE_Info_39)
{
  MR_Word InstanceTypes_23 = ((MR_Word) ((MR_hl_field(0, InstanceMethodConstraints_14, 1))));
  MR_Word InstanceConstraints_24 = ((MR_Word) ((MR_hl_field(0, InstanceMethodConstraints_14, 2))));
  MR_Word ArgTypeVarSet_25;
  ...
  MR_Word STATE_VARIABLE_HeadVars_1_43;
  MR_Integer Var_47;
  MR_Integer Var_48;
  MR_Word STATE_VARIABLE_ExtraArgModes_1_49;
  MR_Word Var_26;
  MR_Word Var_27;
  MR_Box conv1_RttiVarMaps_30;

  *ClassContext_15 = ((MR_Word) ((MR_hl_field(0, InstanceMethodConstraints_14, 3))));
  ...
  check_hlds__polymorphism_clause__make_head_vars_5_p_0(ArgTypeVarSet_25, *InstanceUnconstrainedTVars_17, InstanceUnconstrainedTypeInfoVars_18, STATE_VARIABLE_Info_0_38, &STATE_VARIABLE_Info_1_40);
  check_hlds__polymorphism_type_class_info__make_typeclass_info_head_vars_5_p_0((MR_Integer) 0, InstanceConstraints_24, &InstanceHeadTypeClassInfoVars_28, STATE_VARIABLE_Info_1_40, &STATE_VARIABLE_Info_2_42);
  hlds__hlds_args__proc_arg_vector_set_instance_type_infos_3_p_0((MR_Word) (&check_hlds__polymorphism_clause_scalar_common_1[1]), *InstanceUnconstrainedTypeInfoVars_18, STATE_VARIABLE_HeadVars_0_34, &STATE_VARIABLE_HeadVars_1_43);
  hlds__hlds_args__proc_arg_vector_set_instance_typeclass_infos_3_p_0((MR_Word) (&check_hlds__polymorphism_clause_scalar_common_1[1]), InstanceHeadTypeClassInfoVars_28, STATE_VARIABLE_HeadVars_1_43, STATE_VARIABLE_HeadVars_35);
  check_hlds__polymorphism_info__poly_info_get_rtti_varmaps_2_p_0(STATE_VARIABLE_Info_2_42, &RttiVarMaps0_29);
  ...
  check_hlds__polymorphism_info__poly_info_set_rtti_varmaps_3_p_0(RttiVarMaps_30, STATE_VARIABLE_Info_2_42, STATE_VARIABLE_Info_39);
  ...
  hlds__hlds_args__poly_arg_vector_set_instance_type_infos_3_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_mode_0), InstanceUnconstrainedTypeInfoModes_32, STATE_VARIABLE_ExtraArgModes_0_36, &STATE_VARIABLE_ExtraArgModes_1_49);
  hlds__hlds_args__poly_arg_vector_set_instance_typeclass_infos_3_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_mode_0), InstanceHeadTypeClassInfoModes_33, STATE_VARIABLE_ExtraArgModes_1_49, STATE_VARIABLE_ExtraArgModes_37);
}
  ...
  MR_Word * STATE_VARIABLE_Info_5)
{
  ...
  {
    MR_Word TypeVar_11 = ((MR_Word) ((MR_hl_field(1, HeadVar__2_2, 0))));
    MR_Word TypeVars_12 = ((MR_Word) ((MR_hl_field(1, HeadVar__2_2, 1))));
    ...
    check_hlds__polymorphism_type_info__new_type_info_var_5_p_0(Type_18, (MR_Integer) 0, &TypeInfoVar_13, STATE_VARIABLE_Info_0_4, &STATE_VARIABLE_Info_1_26);
    ...
    if (succeeded)
    {
      ...
      check_hlds__polymorphism_info__poly_info_get_var_table_2_p_0(STATE_VARIABLE_Info_1_26, &VarTable0_21);
      parse_tree__var_table__update_var_name_4_p_0(TypeInfoVar_13, VarName_20, VarTable0_21, &VarTable_22);
      check_hlds__polymorphism_info__poly_info_set_var_table_3_p_0(VarTable_22, STATE_VARIABLE_Info_1_26, &STATE_VARIABLE_Info_2_28);
    }
    else
      STATE_VARIABLE_Info_2_28 = STATE_VARIABLE_Info_1_26;
    check_hlds__polymorphism_clause__make_head_vars_5_p_0(TypeVarSet_1, TypeVars_12, &TypeInfoVars_14, STATE_VARIABLE_Info_2_28, STATE_VARIABLE_Info_5);
    {
      MR_Word base;
