...
{
  {
    ...
    {
      Var_39 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), Var_39, 0) = (MR_Box) (((((MR_Unsigned) ((MR_Integer) 77) << 1)) | (MR_Unsigned) ((MR_Integer) 1)));
      MR_hl_field(MR_mktag(1), Var_39, 1) = ((MR_Box) (Var_42));
    }
    {
      Var_38 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), Var_50, 0) = (MR_Box) (((((MR_Unsigned) ((MR_Integer) 63) << 1)) | (MR_Unsigned) ((MR_Integer) 1)));
...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(0), Var_63, 0) = ((MR_Box) (NewContext_17));
      MR_hl_field(MR_mktag(0), Var_63, 1) = ((MR_Box) (Var_64));
    }
    {
      Var_71 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), Var_71, 0) = ((MR_Box) (OldContext_16));
      MR_hl_field(MR_mktag(0), Var_71, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &check_hlds__mode_errors_scalar_common_2[229])));
    }
    {
      Var_70 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
