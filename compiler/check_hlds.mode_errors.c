      ...
      case (MR_Integer) 0:
        {
          ...
          Var_64 = hlds__error_msg_inst__error_msg_inst_8_f_0(ModuleInfo_89, InstVarSet_90, (MR_Integer) 1, (MR_Integer) 1, (MR_Word) (MR_mkword(MR_mktag(1), &check_hlds__mode_errors_scalar_common_2[210])), (MR_Word) ((MR_Unsigned) 0U), (MR_Word) (MR_mkword(MR_mktag(1), &check_hlds__mode_errors_scalar_common_2[210])), Inst_10);
          {
...
{
  {
    ...
    Var_15 = hlds__error_msg_inst__error_msg_inst_8_f_0(ModuleInfo_40, InstVarSet_41, (MR_Integer) 1, (MR_Integer) 1, (MR_Word) (MR_mkword(MR_mktag(1), &check_hlds__mode_errors_scalar_common_2[210])), (MR_Word) ((MR_Unsigned) 0U), (MR_Word) (MR_mkword(MR_mktag(1), &check_hlds__mode_errors_scalar_common_2[210])), Inst_7);
    {
      ...
      case (MR_Integer) 2:
        {
          ...
          hlds__hlds_out__hlds_out_util__unify_context_first_to_pieces_5_p_0((MR_Integer) 1, &Var_63, UnifyContext_59, (MR_Word) ((MR_Unsigned) 0U), &ModeContextPieces_24);
        }
        break;
    }
    {
