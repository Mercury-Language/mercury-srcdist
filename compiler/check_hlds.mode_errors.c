...
MR_def_label(fn__check_hlds__mode_errors__mode_error_bind_var_to_spec_5_0,61)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_tag_alloc_heap(MR_r2, 1, (MR_Integer) 2);
	MR_tfield(1, MR_r2, 0) = (MR_Word) MR_TAG_COMMON(3,0,47);
	MR_tfield(1, MR_r2, 1) = MR_sv(1);
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 2);
...
MR_def_label(fn__check_hlds__mode_errors__mode_error_implied_mode_to_spec_4_0,40)
	...
	MR_tfield(1, MR_r2, 0) = (MR_Integer) 88;
...
MR_def_label(fn__check_hlds__mode_errors__mode_error_conjunct_to_msgs_3_0,6)
	...
	MR_tfield(1, MR_tempr1, 0) = (MR_Integer) 51;
...
MR_def_label(fn__check_hlds__mode_errors__mode_error_in_callee_to_spec_6_0,49)
	...
	MR_tfield(1, MR_tempr1, 3) = MR_tfield(1, MR_r1, 3);
	MR_tag_alloc_heap(MR_r1, 1, (MR_Integer) 2);
	MR_tfield(1, MR_r1, 0) = MR_tempr1;
...
MR_def_label(fn__check_hlds__mode_errors__mode_error_in_callee_to_spec_6_0,54)
	...
	MR_tfield(1, MR_tempr2, 3) = MR_tfield(0, MR_r1, 1);
	MR_tag_alloc_heap(MR_r1, 1, (MR_Integer) 2);
