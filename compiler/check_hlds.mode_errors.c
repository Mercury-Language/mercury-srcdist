...
check_hlds__mode_errors__IntroducedFrom__pred__named_and_unnamed_vars_to_pieces__1334__1_3_p_0(
  MR_Word VarSet_4,
...
{
  {
    ...
    succeeded = check_hlds__mode_errors__IntroducedFrom__pred__named_and_unnamed_vars_to_pieces__1334__1_3_p_0(((MR_Word) (MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3))), ((MR_Word) wrapper_arg_1), &conv0_HeadVar__3_18);
    if (succeeded)
    {
...
{
  {
    ...
    conv0_LambdaHeadVar__2_50 = check_hlds__mode_errors__IntroducedFrom__func__report_mode_inference_message__458__1_1_f_0(((MR_Word) wrapper_arg_1));
