...
MR_decl_static(fn__check_hlds__mode_errors__IntroducedFrom__func__report_mode_inference_message__1378__1_1_0)
...
{
MR_COMMON(7,0),
MR_ENTRY_AP(fn__check_hlds__mode_errors__IntroducedFrom__func__report_mode_inference_message__1378__1_1_0),
0
},
{
MR_COMMON(12,0),
...
MR_BEGIN_MODULE(check_hlds__mode_errors_module70)
	MR_init_entry1(fn__check_hlds__mode_errors__IntroducedFrom__func__report_mode_inference_message__1378__1_1_0);
	MR_INIT_PROC_LAYOUT_ADDR(mercury__fn__check_hlds__mode_errors__IntroducedFrom__func__report_mode_inference_message__1378__1_1_0);
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'IntroducedFrom__func__report_mode_inference_message__1378__1'/2 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(fn__check_hlds__mode_errors__IntroducedFrom__func__report_mode_inference_message__1378__1_1_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tag_alloc_heap(MR_tempr1, 0, (MR_Integer) 2);
