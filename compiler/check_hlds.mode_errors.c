      ...
      case (MR_Integer) 1:
        {
          ...
          if (((MR_tag((MR_Word) ModeCallId_16)) == (MR_Integer) 1))
          {
            ...
            switch (MR_tag((MR_Word) GenericCallId_18)) {
              ...
              case (MR_Integer) 1:
                {
                  MR_Word SimpleCallId_24 = ((MR_Word) ((MR_hl_field(MR_mktag(1), GenericCallId_18, (MR_Integer) 1))));

                  PredOrFunc_21 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), SimpleCallId_24, (MR_Integer) 0))) & (MR_Integer) 1);
                }
                break;
              case (MR_Integer) 2:
              case (MR_Integer) 3:
          ...
          else
          {
            ...
            MR_Word SimpleCallId_93;

            check_hlds__mode_info__mode_info_get_simple_call_id_3_p_0(ModeInfo_6, PredId_30, &SimpleCallId_93);
            {
              CallId_19 = (MR_Word) MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL);
              MR_hl_field(MR_mktag(0), CallId_19, 0) = ((MR_Box) (SimpleCallId_93));
            }
