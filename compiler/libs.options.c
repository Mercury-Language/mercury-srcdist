...
static const struct mercury_type_1 mercury_common_1[700] =
{
{
148,
MR_TAG_COMMON(1,0,0)
...
static const struct mercury_type_2 mercury_common_2[701] =
{
{
{
MR_TAG_COMMON(0,1,0),
...
MR_def_label(libs__options__option_defaults_2_2_0,11)
	...
	MR_r1 = (MR_Word) MR_TAG_COMMON(1,2,473);
	MR_proceed();
MR_def_label(libs__options__option_defaults_2_2_0,12)
	...
	MR_r1 = (MR_Word) MR_TAG_COMMON(1,2,513);
	MR_proceed();
MR_def_label(libs__options__option_defaults_2_2_0,13)
	...
	MR_r1 = (MR_Word) MR_TAG_COMMON(1,2,564);
	MR_proceed();
MR_def_label(libs__options__option_defaults_2_2_0,14)
	...
	MR_r1 = (MR_Word) MR_TAG_COMMON(1,2,601);
	MR_proceed();
MR_def_label(libs__options__option_defaults_2_2_0,15)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_TAG_COMMON(1,2,642);
	MR_proceed();
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_thread_engine_base
...
MR_def_static(libs__options__opt_level_3_0)
	...
	MR_r2 = (MR_Word) MR_TAG_COMMON(1,2,653);
	MR_r1 = MR_TRUE;
	MR_proceed();
MR_def_label(libs__options__opt_level_3_0,3)
	...
	MR_sv(1) = (MR_Word) MR_TAG_COMMON(0,1,659);
	MR_sv(2) = (MR_Word) MR_TAG_COMMON(0,1,660);
	MR_sv(3) = (MR_Word) MR_TAG_COMMON(0,1,661);
	MR_sv(4) = (MR_Word) MR_TAG_COMMON(1,2,656);
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(libs__options, option);
...
MR_def_label(libs__options__opt_level_3_0,24)
	...
	MR_r2 = (MR_Word) MR_TAG_COMMON(1,2,684);
	MR_r1 = MR_TRUE;
	MR_proceed();
MR_def_label(libs__options__opt_level_3_0,25)
	...
	MR_r2 = (MR_Word) MR_TAG_COMMON(1,2,687);
	MR_r1 = MR_TRUE;
	MR_proceed();
...
MR_def_static(libs__options__opt_space_1_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_TAG_COMMON(1,2,697);
	MR_proceed();
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_thread_engine_base
...
MR_def_label(libs__options__special_handler_4_0,307)
	...
	MR_incr_sp(6);
	MR_sv(6) = (MR_Word) MR_succip;
	MR_r1 = (MR_Word) MR_TAG_COMMON(1,2,700);
	MR_r2 = MR_r3;
	MR_np_call_localret_ent(libs__options__override_options_3_0,
		libs__options__special_handler_4_0_i334);
