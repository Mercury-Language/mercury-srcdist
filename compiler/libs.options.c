...
static const struct mercury_type_1 mercury_common_1[692] =
{
{
146,
MR_TAG_COMMON(1,0,0)
...
static const struct mercury_type_2 mercury_common_2[693] =
{
{
{
MR_TAG_COMMON(0,1,0),
...
MR_def_label(libs__options__option_defaults_2_2_0,6)
	...
	MR_r1 = (MR_Word) MR_TAG_COMMON(1,2,226);
	MR_proceed();
MR_def_label(libs__options__option_defaults_2_2_0,7)
	...
	MR_r1 = (MR_Word) MR_TAG_COMMON(1,2,238);
	MR_proceed();
MR_def_label(libs__options__option_defaults_2_2_0,8)
	...
	MR_r1 = (MR_Word) MR_TAG_COMMON(1,2,314);
	MR_proceed();
MR_def_label(libs__options__option_defaults_2_2_0,9)
	...
	MR_r1 = (MR_Word) MR_TAG_COMMON(1,2,329);
	MR_proceed();
MR_def_label(libs__options__option_defaults_2_2_0,10)
	...
	MR_r1 = (MR_Word) MR_TAG_COMMON(1,2,446);
	MR_proceed();
MR_def_label(libs__options__option_defaults_2_2_0,11)
	...
	MR_r1 = (MR_Word) MR_TAG_COMMON(1,2,471);
	MR_proceed();
MR_def_label(libs__options__option_defaults_2_2_0,12)
	...
	MR_r1 = (MR_Word) MR_TAG_COMMON(1,2,511);
	MR_proceed();
MR_def_label(libs__options__option_defaults_2_2_0,13)
	...
	MR_r1 = (MR_Word) MR_TAG_COMMON(1,2,556);
	MR_proceed();
MR_def_label(libs__options__option_defaults_2_2_0,14)
	...
	MR_r1 = (MR_Word) MR_TAG_COMMON(1,2,593);
	MR_proceed();
MR_def_label(libs__options__option_defaults_2_2_0,15)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_TAG_COMMON(1,2,634);
	MR_proceed();
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_thread_engine_base
...
MR_def_label(fn__libs__options__option_table_add_mercury_library_directory_2_0,4)
	...
	MR_sv(3) = MR_tempr1;
	MR_tfield(0, MR_tempr1, 0) = (MR_Integer) 610;
...
MR_def_label(fn__libs__options__option_table_add_mercury_library_directory_2_0,6)
	...
	MR_tag_alloc_heap(MR_tempr1, 0, (MR_Integer) 2);
	MR_sv(4) = MR_tempr1;
	MR_tfield(0, MR_tempr1, 0) = (MR_Integer) 469;
	MR_tfield(0, MR_tempr1, 1) = MR_r1;
	MR_r1 = MR_sv(2);
	MR_r2 = (MR_Word) MR_string_const("inc", 3);
	}
...
MR_def_label(fn__libs__options__option_table_add_mercury_library_directory_2_0,8)
	...
	MR_tfield(0, MR_tempr2, 0) = (MR_Integer) 519;
...
MR_define_entry(mercury__fn__libs__options__option_table_add_search_library_files_directory_2_0);
	...
	MR_tfield(0, MR_tempr3, 0) = (MR_Integer) 506;
	MR_tfield(0, MR_tempr3, 1) = MR_r2;
	MR_tag_alloc_heap(MR_tempr4, 0, (MR_Integer) 2);
	MR_tfield(0, MR_tempr4, 0) = (MR_Integer) 521;
...
MR_def_static(libs__options__opt_level_3_0)
	...
	MR_r2 = (MR_Word) MR_TAG_COMMON(1,2,645);
	MR_r1 = MR_TRUE;
	MR_proceed();
MR_def_label(libs__options__opt_level_3_0,3)
	...
	MR_sv(1) = (MR_Word) MR_TAG_COMMON(0,1,651);
	MR_sv(2) = (MR_Word) MR_TAG_COMMON(0,1,652);
	MR_sv(3) = (MR_Word) MR_TAG_COMMON(0,1,653);
	MR_sv(4) = (MR_Word) MR_TAG_COMMON(1,2,648);
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(libs__options, option);
...
MR_def_label(libs__options__opt_level_3_0,4)
	...
	MR_r2 = (MR_Word) MR_TAG_COMMON(1,2,659);
	MR_r1 = MR_TRUE;
	MR_proceed();
...
MR_def_label(libs__options__opt_level_3_0,23)
	...
	MR_r2 = (MR_Word) MR_TAG_COMMON(1,2,670);
	MR_r1 = MR_TRUE;
	MR_proceed();
MR_def_label(libs__options__opt_level_3_0,24)
	...
	MR_r2 = (MR_Word) MR_TAG_COMMON(1,2,676);
	MR_r1 = MR_TRUE;
	MR_proceed();
...
MR_def_static(libs__options__opt_space_1_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_TAG_COMMON(1,2,689);
	MR_proceed();
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_thread_engine_base
...
MR_def_label(libs__options__special_handler_4_0,194)
	...
	MR_tag_alloc_heap(MR_tempr2, 0, (MR_Integer) 2);
	MR_sv(3) = MR_tempr2;
	MR_tfield(0, MR_tempr2, 0) = (MR_Integer) 523;
...
MR_def_label(libs__options__special_handler_4_0,204)
	...
	MR_Word MR_tempr1, MR_tempr2, MR_tempr3;
	MR_tag_alloc_heap(MR_tempr1, 0, (MR_Integer) 2);
	MR_tfield(0, MR_tempr1, 0) = (MR_Integer) 528;
	MR_tfield(0, MR_tempr1, 1) = MR_r1;
	MR_tag_alloc_heap(MR_tempr2, 1, (MR_Integer) 2);
	MR_tfield(1, MR_tempr2, 0) = MR_tempr1;
...
MR_def_label(libs__options__special_handler_4_0,295)
	...
	MR_incr_sp(6);
	MR_sv(6) = (MR_Word) MR_succip;
	MR_r1 = (MR_Word) MR_TAG_COMMON(1,2,692);
	MR_r2 = MR_r3;
	MR_np_call_localret_ent(libs__options__override_options_3_0,
		libs__options__special_handler_4_0_i322);
