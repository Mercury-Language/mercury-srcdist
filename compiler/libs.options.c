...
MR_decl_label5(libs__options__long_option_2_0, 773,774,775,776,1)
...
static const struct mercury_type_1 mercury_common_1[704] =
{
{
148,
MR_TAG_COMMON(1,0,0)
...
static const struct mercury_type_2 mercury_common_2[705] =
{
{
{
MR_TAG_COMMON(0,1,0),
...
MR_BEGIN_MODULE(libs__options_module1)
	...
	MR_init_label5(libs__options__long_option_2_0,773,774,775,776,1)
MR_BEGIN_CODE
...
MR_def_label(libs__options__option_defaults_2_2_0,8)
	...
	MR_r1 = (MR_Word) MR_TAG_COMMON(1,2,316);
	MR_proceed();
MR_def_label(libs__options__option_defaults_2_2_0,9)
	...
	MR_r1 = (MR_Word) MR_TAG_COMMON(1,2,334);
	MR_proceed();
MR_def_label(libs__options__option_defaults_2_2_0,10)
	...
	MR_r1 = (MR_Word) MR_TAG_COMMON(1,2,451);
	MR_proceed();
MR_def_label(libs__options__option_defaults_2_2_0,11)
	...
	MR_r1 = (MR_Word) MR_TAG_COMMON(1,2,477);
	MR_proceed();
MR_def_label(libs__options__option_defaults_2_2_0,12)
	...
	MR_r1 = (MR_Word) MR_TAG_COMMON(1,2,517);
	MR_proceed();
MR_def_label(libs__options__option_defaults_2_2_0,13)
	...
	MR_r1 = (MR_Word) MR_TAG_COMMON(1,2,568);
	MR_proceed();
MR_def_label(libs__options__option_defaults_2_2_0,14)
	...
	MR_r1 = (MR_Word) MR_TAG_COMMON(1,2,605);
	MR_proceed();
MR_def_label(libs__options__option_defaults_2_2_0,15)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_TAG_COMMON(1,2,646);
	MR_proceed();
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_thread_engine_base
...
MR_def_label(fn__libs__options__option_table_add_mercury_library_directory_2_0,4)
	...
	MR_sv(3) = MR_tempr1;
	MR_tfield(0, MR_tempr1, 0) = (MR_Integer) 619;
...
MR_def_label(fn__libs__options__option_table_add_mercury_library_directory_2_0,6)
	...
	MR_tag_alloc_heap(MR_tempr1, 0, (MR_Integer) 2);
	MR_sv(4) = MR_tempr1;
	MR_tfield(0, MR_tempr1, 0) = (MR_Integer) 472;
	MR_tfield(0, MR_tempr1, 1) = MR_r1;
	MR_r1 = MR_sv(2);
	MR_r2 = (MR_Word) MR_string_const("inc", 3);
	}
...
MR_def_label(fn__libs__options__option_table_add_mercury_library_directory_2_0,8)
	...
	MR_tfield(0, MR_tempr2, 0) = (MR_Integer) 528;
...
MR_define_entry(mercury__fn__libs__options__option_table_add_search_library_files_directory_2_0);
	...
	MR_tag_alloc_heap(MR_tempr2, 0, (MR_Integer) 2);
	MR_tfield(0, MR_tempr2, 0) = (MR_Integer) 472;
	MR_tfield(0, MR_tempr2, 1) = MR_r2;
	MR_tag_alloc_heap(MR_tempr3, 0, (MR_Integer) 2);
	MR_tfield(0, MR_tempr3, 0) = (MR_Integer) 515;
	MR_tfield(0, MR_tempr3, 1) = MR_r2;
	MR_tag_alloc_heap(MR_tempr4, 0, (MR_Integer) 2);
	MR_tfield(0, MR_tempr4, 0) = (MR_Integer) 530;
...
MR_def_label(libs__options__opt_level_3_0,3)
	...
	MR_sv(1) = (MR_Word) MR_TAG_COMMON(0,1,663);
	MR_sv(2) = (MR_Word) MR_TAG_COMMON(0,1,664);
	MR_sv(3) = (MR_Word) MR_TAG_COMMON(0,1,665);
	MR_sv(4) = (MR_Word) MR_TAG_COMMON(1,2,660);
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(libs__options, option);
	MR_r3 = (MR_Integer) 295;
...
MR_def_label(libs__options__opt_level_3_0,4)
	...
	MR_r2 = (MR_Word) MR_TAG_COMMON(1,2,671);
	MR_r1 = MR_TRUE;
	MR_proceed();
MR_def_label(libs__options__opt_level_3_0,22)
	...
	MR_r2 = (MR_Word) MR_TAG_COMMON(1,2,679);
	MR_r1 = MR_TRUE;
	MR_proceed();
MR_def_label(libs__options__opt_level_3_0,23)
	...
	MR_r2 = (MR_Word) MR_TAG_COMMON(1,2,682);
	MR_r1 = MR_TRUE;
	MR_proceed();
MR_def_label(libs__options__opt_level_3_0,24)
	...
	MR_r2 = (MR_Word) MR_TAG_COMMON(1,2,688);
	MR_r1 = MR_TRUE;
	MR_proceed();
MR_def_label(libs__options__opt_level_3_0,25)
	...
	MR_r2 = (MR_Word) MR_TAG_COMMON(1,2,691);
	MR_r1 = MR_TRUE;
	MR_proceed();
...
MR_def_static(libs__options__opt_space_1_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_TAG_COMMON(1,2,701);
	MR_proceed();
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_thread_engine_base
...
MR_def_label(libs__options__special_handler_4_0,194)
	...
	MR_tag_alloc_heap(MR_tempr2, 0, (MR_Integer) 2);
	MR_sv(3) = MR_tempr2;
	MR_tfield(0, MR_tempr2, 0) = (MR_Integer) 532;
...
MR_def_label(libs__options__special_handler_4_0,307)
	...
	MR_incr_sp(6);
	MR_sv(6) = (MR_Word) MR_succip;
	MR_r1 = (MR_Word) MR_TAG_COMMON(1,2,704);
	MR_r2 = MR_r3;
	MR_np_call_localret_ent(libs__options__override_options_3_0,
		libs__options__special_handler_4_0_i334);
