...
MR_decl_label10(libs__options__long_option_2_0, 753,754,755,756,757,758,759,760,761,1)
...
static const struct mercury_type_1 mercury_common_1[691] =
{
{
146,
MR_TAG_COMMON(1,0,0)
...
static const struct mercury_type_2 mercury_common_2[692] =
{
{
{
MR_TAG_COMMON(0,1,0),
...
static const struct mercury_type_4 mercury_common_4[1393] =
{
{
MR_string_const(".", 1),
MR_tbmkword(0, 0)
...
MR_BEGIN_MODULE(libs__options_module1)
	...
	MR_init_label10(libs__options__long_option_2_0,753,754,755,756,757,758,759,760,761,1)
MR_BEGIN_CODE
...
MR_def_label(libs__options__option_defaults_2_2_0,10)
	...
	MR_r1 = (MR_Word) MR_TAG_COMMON(1,2,445);
	MR_proceed();
MR_def_label(libs__options__option_defaults_2_2_0,11)
	...
	MR_r1 = (MR_Word) MR_TAG_COMMON(1,2,470);
	MR_proceed();
MR_def_label(libs__options__option_defaults_2_2_0,12)
	...
	MR_r1 = (MR_Word) MR_TAG_COMMON(1,2,510);
	MR_proceed();
MR_def_label(libs__options__option_defaults_2_2_0,13)
	...
	MR_r1 = (MR_Word) MR_TAG_COMMON(1,2,555);
	MR_proceed();
MR_def_label(libs__options__option_defaults_2_2_0,14)
	...
	MR_r1 = (MR_Word) MR_TAG_COMMON(1,2,592);
	MR_proceed();
MR_def_label(libs__options__option_defaults_2_2_0,15)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_TAG_COMMON(1,2,633);
	MR_proceed();
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_thread_engine_base
...
MR_def_label(fn__libs__options__option_table_add_mercury_library_directory_2_0,4)
	...
	MR_sv(3) = MR_tempr1;
	MR_tfield(0, MR_tempr1, 0) = (MR_Integer) 609;
...
MR_def_label(fn__libs__options__option_table_add_mercury_library_directory_2_0,6)
	...
	MR_tag_alloc_heap(MR_tempr1, 0, (MR_Integer) 2);
	MR_sv(4) = MR_tempr1;
	MR_tfield(0, MR_tempr1, 0) = (MR_Integer) 468;
	MR_tfield(0, MR_tempr1, 1) = MR_r1;
	MR_r1 = MR_sv(2);
	MR_r2 = (MR_Word) MR_string_const("inc", 3);
	}
...
MR_def_label(fn__libs__options__option_table_add_mercury_library_directory_2_0,8)
	...
	MR_tag_alloc_heap(MR_tempr1, 0, (MR_Integer) 2);
	MR_tfield(0, MR_tempr1, 0) = (MR_Integer) 505;
	MR_tfield(0, MR_tempr1, 1) = MR_r1;
	MR_tag_alloc_heap(MR_tempr2, 0, (MR_Integer) 2);
	MR_tfield(0, MR_tempr2, 0) = (MR_Integer) 518;
...
MR_define_entry(mercury__fn__libs__options__option_table_add_search_library_files_directory_2_0);
	...
	MR_tfield(0, MR_tempr3, 0) = (MR_Integer) 505;
	MR_tfield(0, MR_tempr3, 1) = MR_r2;
	MR_tag_alloc_heap(MR_tempr4, 0, (MR_Integer) 2);
	MR_tfield(0, MR_tempr4, 0) = (MR_Integer) 520;
...
MR_def_static(libs__options__opt_level_3_0)
	...
	MR_r2 = (MR_Word) MR_TAG_COMMON(1,2,644);
	MR_r1 = MR_TRUE;
	MR_proceed();
MR_def_label(libs__options__opt_level_3_0,3)
	...
	MR_sv(1) = (MR_Word) MR_TAG_COMMON(0,1,650);
	MR_sv(2) = (MR_Word) MR_TAG_COMMON(0,1,651);
	MR_sv(3) = (MR_Word) MR_TAG_COMMON(0,1,652);
	MR_sv(4) = (MR_Word) MR_TAG_COMMON(1,2,647);
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(libs__options, option);
...
MR_def_label(libs__options__opt_level_3_0,4)
	...
	MR_r2 = (MR_Word) MR_TAG_COMMON(1,2,658);
	MR_r1 = MR_TRUE;
	MR_proceed();
...
MR_def_label(libs__options__opt_level_3_0,23)
	...
	MR_r2 = (MR_Word) MR_TAG_COMMON(1,2,669);
	MR_r1 = MR_TRUE;
	MR_proceed();
MR_def_label(libs__options__opt_level_3_0,24)
	...
	MR_r2 = (MR_Word) MR_TAG_COMMON(1,2,675);
	MR_r1 = MR_TRUE;
	MR_proceed();
MR_def_label(libs__options__opt_level_3_0,25)
	...
	MR_r2 = (MR_Word) MR_TAG_COMMON(1,2,678);
	MR_r1 = MR_TRUE;
	MR_proceed();
...
MR_def_static(libs__options__opt_space_1_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_TAG_COMMON(1,2,688);
	MR_proceed();
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_thread_engine_base
...
MR_def_label(libs__options__special_handler_4_0,194)
	...
	MR_tag_alloc_heap(MR_tempr1, 0, (MR_Integer) 2);
	MR_sv(2) = MR_tempr1;
	MR_tfield(0, MR_tempr1, 0) = (MR_Integer) 516;
	MR_tfield(0, MR_tempr1, 1) = MR_tfield(3, MR_r2, 1);
	MR_tag_alloc_heap(MR_tempr2, 0, (MR_Integer) 2);
	MR_sv(3) = MR_tempr2;
	MR_tfield(0, MR_tempr2, 0) = (MR_Integer) 522;
...
MR_def_label(libs__options__special_handler_4_0,231)
	...
	MR_r4 = (MR_Word) MR_TAG_COMMON(2,0,5);
	MR_r3 = (MR_Integer) 308;
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(libs__options, option);
	MR_r2 = (MR_Word) MR_CTOR0_ADDR(getopt_io, option_data);
	MR_np_call_localret_ent(map__set_4_0,
...
MR_def_label(libs__options__special_handler_4_0,295)
	...
	MR_incr_sp(6);
	MR_sv(6) = (MR_Word) MR_succip;
	MR_r1 = (MR_Word) MR_TAG_COMMON(1,2,691);
	MR_r2 = MR_r3;
	MR_np_call_localret_ent(libs__options__override_options_3_0,
		libs__options__special_handler_4_0_i322);
...
MR_def_label(libs__options__options_help_target_code_compilation_2_0,2)
	...
	MR_sv(2) = (MR_Word) MR_TAG_COMMON(1,4,1080);
	MR_r1 = (MR_Integer) 9;
	MR_np_call_localret_ent(io__write_char_3_0,
...
MR_def_label(libs__options__options_help_target_code_compilation_2_0,5)
	...
	MR_sv(2) = (MR_Word) MR_TAG_COMMON(1,4,1079);
	MR_r1 = (MR_Integer) 9;
	MR_np_call_localret_ent(io__write_char_3_0,
...
MR_def_label(libs__options__options_help_target_code_compilation_2_0,8)
	...
	MR_sv(2) = (MR_Word) MR_TAG_COMMON(1,4,1078);
	MR_r1 = (MR_Integer) 9;
	MR_np_call_localret_ent(io__write_char_3_0,
...
MR_def_label(libs__options__options_help_link_2_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_TAG_COMMON(1,4,1190);
	MR_succip_word = MR_sv(1);
	MR_decr_sp(1);
	MR_np_tailcall_ent(libs__options__write_tabbed_lines_3_0);
#ifdef MR_maybe_local_thread_engine_base
...
MR_def_label(libs__options__options_help_build_system_2_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_TAG_COMMON(1,4,1326);
	MR_succip_word = MR_sv(1);
	MR_decr_sp(1);
	MR_np_tailcall_ent(libs__options__write_tabbed_lines_3_0);
#ifdef MR_maybe_local_thread_engine_base
