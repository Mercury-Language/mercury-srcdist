...
MR_decl_label2(libs__options__long_option_2_0, 743,1)
...
MR_decl_label4(libs__options__short_option_2_0, 33,34,35,1)
...
static const struct mercury_type_1 mercury_common_1[676] =
{
{
142,
MR_TAG_COMMON(1,0,0)
...
static const struct mercury_type_2 mercury_common_2[677] =
{
{
{
MR_TAG_COMMON(0,1,0),
...
static const struct mercury_type_4 mercury_common_4[1379] =
{
{
MR_string_const(".", 1),
MR_tbmkword(0, 0)
...
MR_BEGIN_MODULE(libs__options_module0)
	...
	MR_init_label4(libs__options__short_option_2_0,33,34,35,1)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(libs__options_module1)
	...
	MR_init_label2(libs__options__long_option_2_0,743,1)
MR_BEGIN_CODE
...
MR_def_label(libs__options__long_option_2_0,404)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if ((strcmp((char *) (MR_Word *) MR_r1, MR_string_const("parallelism-target", 18)) != 0)) {
...
MR_def_label(libs__options__long_option_2_0,578)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if ((strcmp((char *) (MR_Word *) MR_r1, MR_string_const("old-implicit-parallelism", 24)) != 0)) {
...
MR_def_label(libs__options__option_defaults_2_2_0,3)
	...
	MR_r1 = (MR_Word) MR_TAG_COMMON(1,2,75);
	MR_proceed();
MR_def_label(libs__options__option_defaults_2_2_0,4)
	...
	MR_r1 = (MR_Word) MR_TAG_COMMON(1,2,100);
	MR_proceed();
MR_def_label(libs__options__option_defaults_2_2_0,5)
	...
	MR_r1 = (MR_Word) MR_TAG_COMMON(1,2,182);
	MR_proceed();
MR_def_label(libs__options__option_defaults_2_2_0,6)
	...
	MR_r1 = (MR_Word) MR_TAG_COMMON(1,2,217);
	MR_proceed();
MR_def_label(libs__options__option_defaults_2_2_0,7)
	...
	MR_r1 = (MR_Word) MR_TAG_COMMON(1,2,229);
	MR_proceed();
MR_def_label(libs__options__option_defaults_2_2_0,8)
	...
	MR_r1 = (MR_Word) MR_TAG_COMMON(1,2,303);
	MR_proceed();
...
MR_def_label(libs__options__option_defaults_2_2_0,10)
	...
	MR_r1 = (MR_Word) MR_TAG_COMMON(1,2,435);
	MR_proceed();
MR_def_label(libs__options__option_defaults_2_2_0,11)
	...
	MR_r1 = (MR_Word) MR_TAG_COMMON(1,2,460);
	MR_proceed();
MR_def_label(libs__options__option_defaults_2_2_0,12)
	...
	MR_r1 = (MR_Word) MR_TAG_COMMON(1,2,500);
	MR_proceed();
MR_def_label(libs__options__option_defaults_2_2_0,13)
	...
	MR_r1 = (MR_Word) MR_TAG_COMMON(1,2,544);
	MR_proceed();
MR_def_label(libs__options__option_defaults_2_2_0,14)
	...
	MR_r1 = (MR_Word) MR_TAG_COMMON(1,2,579);
	MR_proceed();
MR_def_label(libs__options__option_defaults_2_2_0,15)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_TAG_COMMON(1,2,618);
	MR_proceed();
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_thread_engine_base
...
MR_def_label(fn__libs__options__option_table_add_mercury_library_directory_2_0,4)
	...
	MR_sv(3) = MR_tempr1;
	MR_tfield(0, MR_tempr1, 0) = (MR_Integer) 600;
...
MR_def_label(fn__libs__options__option_table_add_mercury_library_directory_2_0,6)
	...
	MR_tag_alloc_heap(MR_tempr1, 0, (MR_Integer) 2);
	MR_sv(4) = MR_tempr1;
	MR_tfield(0, MR_tempr1, 0) = (MR_Integer) 462;
	MR_tfield(0, MR_tempr1, 1) = MR_r1;
	MR_r1 = MR_sv(2);
	MR_r2 = (MR_Word) MR_string_const("inc", 3);
	}
...
MR_def_label(fn__libs__options__option_table_add_mercury_library_directory_2_0,8)
	...
	MR_tag_alloc_heap(MR_tempr1, 0, (MR_Integer) 2);
	MR_tfield(0, MR_tempr1, 0) = (MR_Integer) 498;
	MR_tfield(0, MR_tempr1, 1) = MR_r1;
	MR_tag_alloc_heap(MR_tempr2, 0, (MR_Integer) 2);
	MR_tfield(0, MR_tempr2, 0) = (MR_Integer) 511;
...
MR_define_entry(mercury__fn__libs__options__option_table_add_search_library_files_directory_2_0);
	...
	MR_tag_alloc_heap(MR_tempr2, 0, (MR_Integer) 2);
	MR_tfield(0, MR_tempr2, 0) = (MR_Integer) 462;
	MR_tfield(0, MR_tempr2, 1) = MR_r2;
	MR_tag_alloc_heap(MR_tempr3, 0, (MR_Integer) 2);
	MR_tfield(0, MR_tempr3, 0) = (MR_Integer) 498;
	MR_tfield(0, MR_tempr3, 1) = MR_r2;
	MR_tag_alloc_heap(MR_tempr4, 0, (MR_Integer) 2);
	MR_tfield(0, MR_tempr4, 0) = (MR_Integer) 513;
...
MR_def_static(libs__options__opt_level_3_0)
	...
	MR_r2 = (MR_Word) MR_TAG_COMMON(1,2,629);
	MR_r1 = MR_TRUE;
	MR_proceed();
MR_def_label(libs__options__opt_level_3_0,3)
	...
	MR_sv(1) = (MR_Word) MR_TAG_COMMON(0,1,635);
	MR_sv(2) = (MR_Word) MR_TAG_COMMON(0,1,636);
	MR_sv(3) = (MR_Word) MR_TAG_COMMON(0,1,637);
	MR_sv(4) = (MR_Word) MR_TAG_COMMON(1,2,632);
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(libs__options, option);
...
MR_def_label(libs__options__opt_level_3_0,22)
	...
	MR_r2 = (MR_Word) MR_TAG_COMMON(1,2,651);
	MR_r1 = MR_TRUE;
	MR_proceed();
MR_def_label(libs__options__opt_level_3_0,23)
	...
	MR_r2 = (MR_Word) MR_TAG_COMMON(1,2,654);
	MR_r1 = MR_TRUE;
	MR_proceed();
...
MR_def_label(libs__options__opt_level_3_0,25)
	...
	MR_r2 = (MR_Word) MR_TAG_COMMON(1,2,663);
	MR_r1 = MR_TRUE;
	MR_proceed();
...
MR_def_static(libs__options__opt_space_1_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_TAG_COMMON(1,2,673);
	MR_proceed();
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_thread_engine_base
...
MR_define_entry(mercury__libs__options__special_handler_4_0);
	...
	MR_r5 = (MR_Word) MR_TAG_COMMON(3,3,8);
...
MR_def_label(libs__options__special_handler_4_0,10)
	...
	MR_r2 = (MR_Word) MR_CTOR0_ADDR(getopt_io, option_data);
	MR_r4 = (MR_Integer) 156;
	MR_r5 = (MR_Word) MR_TAG_COMMON(3,3,43);
	MR_np_call_localret_ent(map__set_4_0,
		libs__options__special_handler_4_0_i304);
...
MR_def_label(libs__options__special_handler_4_0,123)
	...
	MR_r2 = (MR_Word) MR_CTOR0_ADDR(getopt_io, option_data);
	MR_r4 = (MR_Integer) 156;
	MR_r5 = (MR_Word) MR_TAG_COMMON(3,3,38);
	MR_np_call_localret_ent(map__set_4_0,
		libs__options__special_handler_4_0_i304);
...
MR_def_label(libs__options__special_handler_4_0,176)
	...
	MR_tag_alloc_heap(MR_tempr2, 0, (MR_Integer) 2);
	MR_sv(3) = MR_tempr2;
	MR_tfield(0, MR_tempr2, 0) = (MR_Integer) 515;
...
MR_def_label(libs__options__special_handler_4_0,277)
	...
	MR_incr_sp(6);
	MR_sv(6) = (MR_Word) MR_succip;
	MR_r1 = (MR_Word) MR_TAG_COMMON(1,2,676);
	MR_r2 = MR_r3;
	MR_np_call_localret_ent(libs__options__override_options_3_0,
		libs__options__special_handler_4_0_i304);
...
MR_def_label(libs__options__options_help_warning_2_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_TAG_COMMON(1,4,121);
...
MR_def_label(libs__options__options_help_verbosity_2_0,2)
	...
	MR_sv(2) = (MR_Word) MR_TAG_COMMON(1,4,188);
	MR_r1 = (MR_Integer) 9;
	MR_np_call_localret_ent(io__write_char_3_0,
...
MR_def_label(libs__options__options_help_verbosity_2_0,5)
	...
	MR_sv(2) = (MR_Word) MR_TAG_COMMON(1,4,187);
	MR_r1 = (MR_Integer) 9;
	MR_np_call_localret_ent(io__write_char_3_0,
...
MR_def_label(libs__options__options_help_verbosity_2_0,8)
	...
	MR_sv(2) = (MR_Word) MR_TAG_COMMON(1,4,186);
	MR_r1 = (MR_Integer) 9;
	MR_np_call_localret_ent(io__write_char_3_0,
...
MR_def_label(libs__options__options_help_verbosity_2_0,11)
	...
	MR_sv(2) = (MR_Word) MR_TAG_COMMON(1,4,185);
	MR_r1 = (MR_Integer) 9;
	MR_np_call_localret_ent(io__write_char_3_0,
...
MR_def_label(libs__options__options_help_output_2_0,2)
	...
	MR_sv(2) = (MR_Word) MR_TAG_COMMON(1,4,279);
	MR_r1 = (MR_Integer) 9;
	MR_np_call_localret_ent(io__write_char_3_0,
...
MR_def_label(libs__options__options_help_aux_output_2_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_TAG_COMMON(1,4,384);
	MR_succip_word = MR_sv(1);
	MR_decr_sp(1);
	MR_np_tailcall_ent(libs__options__write_tabbed_lines_3_0);
#ifdef MR_maybe_local_thread_engine_base
...
MR_def_label(libs__options__options_help_compilation_model_2_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_TAG_COMMON(1,4,456);
...
MR_def_label(libs__options__options_help_hlds_hlds_optimization_2_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_TAG_COMMON(1,4,892);
	MR_succip_word = MR_sv(1);
	MR_decr_sp(1);
	MR_np_tailcall_ent(libs__options__write_tabbed_lines_3_0);
#ifdef MR_maybe_local_thread_engine_base
...
MR_def_label(libs__options__options_help_hlds_llds_optimization_2_0,2)
	...
	MR_sv(2) = (MR_Word) MR_TAG_COMMON(1,4,932);
	MR_r1 = (MR_Integer) 9;
	MR_np_call_localret_ent(io__write_char_3_0,
...
MR_def_label(libs__options__options_help_hlds_llds_optimization_2_0,5)
	...
	MR_sv(2) = (MR_Word) MR_TAG_COMMON(1,4,931);
	MR_r1 = (MR_Integer) 9;
	MR_np_call_localret_ent(io__write_char_3_0,
...
MR_def_label(libs__options__options_help_hlds_llds_optimization_2_0,8)
	...
	MR_sv(2) = (MR_Word) MR_TAG_COMMON(1,4,930);
	MR_r1 = (MR_Integer) 9;
	MR_np_call_localret_ent(io__write_char_3_0,
...
MR_def_label(libs__options__options_help_hlds_llds_optimization_2_0,11)
	...
	MR_sv(2) = (MR_Word) MR_TAG_COMMON(1,4,929);
	MR_r1 = (MR_Integer) 9;
	MR_np_call_localret_ent(io__write_char_3_0,
...
MR_def_label(libs__options__options_help_hlds_llds_optimization_2_0,14)
	...
	MR_sv(2) = (MR_Word) MR_TAG_COMMON(1,4,928);
	MR_r1 = (MR_Integer) 9;
	MR_np_call_localret_ent(io__write_char_3_0,
...
MR_def_label(libs__options__options_help_hlds_llds_optimization_2_0,17)
	...
	MR_sv(2) = (MR_Word) MR_TAG_COMMON(1,4,927);
	MR_r1 = (MR_Integer) 9;
	MR_np_call_localret_ent(io__write_char_3_0,
...
MR_def_label(libs__options__options_help_hlds_llds_optimization_2_0,20)
	...
	MR_sv(2) = (MR_Word) MR_TAG_COMMON(1,4,926);
	MR_r1 = (MR_Integer) 9;
	MR_np_call_localret_ent(io__write_char_3_0,
...
MR_def_label(libs__options__options_help_output_optimization_2_0,2)
	...
	MR_sv(2) = (MR_Word) MR_TAG_COMMON(1,4,1012);
	MR_r1 = (MR_Integer) 9;
	MR_np_call_localret_ent(io__write_char_3_0,
...
MR_def_label(libs__options__options_help_output_optimization_2_0,5)
	...
	MR_sv(2) = (MR_Word) MR_TAG_COMMON(1,4,1011);
	MR_r1 = (MR_Integer) 9;
	MR_np_call_localret_ent(io__write_char_3_0,
...
MR_def_label(libs__options__options_help_output_optimization_2_0,8)
	...
	MR_sv(2) = (MR_Word) MR_TAG_COMMON(1,4,1010);
	MR_r1 = (MR_Integer) 9;
	MR_np_call_localret_ent(io__write_char_3_0,
...
MR_def_label(libs__options__options_help_target_code_compilation_2_0,2)
	...
	MR_sv(2) = (MR_Word) MR_TAG_COMMON(1,4,1097);
	MR_r1 = (MR_Integer) 9;
	MR_np_call_localret_ent(io__write_char_3_0,
...
MR_def_label(libs__options__options_help_target_code_compilation_2_0,5)
	...
	MR_sv(2) = (MR_Word) MR_TAG_COMMON(1,4,1096);
	MR_r1 = (MR_Integer) 9;
	MR_np_call_localret_ent(io__write_char_3_0,
...
MR_def_label(libs__options__options_help_build_system_2_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_TAG_COMMON(1,4,1325);
	MR_succip_word = MR_sv(1);
	MR_decr_sp(1);
	MR_np_tailcall_ent(libs__options__write_tabbed_lines_3_0);
#ifdef MR_maybe_local_thread_engine_base
...
MR_def_label(libs__options__options_help_misc_2_0,2)
	...
	MR_sv(2) = (MR_Word) MR_TAG_COMMON(1,4,1346);
	MR_r1 = (MR_Integer) 9;
	MR_np_call_localret_ent(io__write_char_3_0,
...
MR_def_label(libs__options__options_help_misc_2_0,5)
	...
	MR_sv(2) = (MR_Word) MR_TAG_COMMON(1,4,1345);
	MR_r1 = (MR_Integer) 9;
	MR_np_call_localret_ent(io__write_char_3_0,
...
MR_def_label(libs__options__options_help_misc_2_0,8)
	...
	MR_sv(2) = (MR_Word) MR_TAG_COMMON(1,4,1344);
	MR_r1 = (MR_Integer) 9;
	MR_np_call_localret_ent(io__write_char_3_0,
...
MR_def_label(libs__options__options_help_misc_2_0,11)
	...
	MR_sv(2) = (MR_Word) MR_TAG_COMMON(1,4,1343);
	MR_r1 = (MR_Integer) 9;
	MR_np_call_localret_ent(io__write_char_3_0,
...
MR_def_label(libs__options__options_help_misc_2_0,14)
	...
	MR_sv(2) = (MR_Word) MR_TAG_COMMON(1,4,1342);
	MR_r1 = (MR_Integer) 9;
	MR_np_call_localret_ent(io__write_char_3_0,
...
MR_def_label(libs__options__options_help_misc_2_0,17)
	...
	MR_sv(2) = (MR_Word) MR_TAG_COMMON(1,4,1341);
	MR_r1 = (MR_Integer) 9;
	MR_np_call_localret_ent(io__write_char_3_0,
...
MR_def_label(libs__options__options_help_misc_2_0,20)
	...
	MR_sv(2) = (MR_Word) MR_TAG_COMMON(1,4,1340);
	MR_r1 = (MR_Integer) 9;
	MR_np_call_localret_ent(io__write_char_3_0,
...
MR_def_label(libs__options__options_help_misc_2_0,23)
	...
	MR_sv(2) = (MR_Word) MR_TAG_COMMON(1,4,1339);
	MR_r1 = (MR_Integer) 9;
	MR_np_call_localret_ent(io__write_char_3_0,
...
MR_def_label(libs__options__options_help_misc_2_0,26)
	...
	MR_sv(2) = (MR_Word) MR_TAG_COMMON(1,4,1338);
	MR_r1 = (MR_Integer) 9;
	MR_np_call_localret_ent(io__write_char_3_0,
...
MR_def_label(libs__options__options_help_misc_2_0,29)
	...
	MR_sv(2) = (MR_Word) MR_TAG_COMMON(1,4,1337);
	MR_r1 = (MR_Integer) 9;
	MR_np_call_localret_ent(io__write_char_3_0,
...
MR_def_label(libs__options__options_help_2_0,9)
	...
	MR_sv(2) = (MR_Word) MR_TAG_COMMON(1,4,1377);
	MR_r1 = (MR_Integer) 9;
	MR_np_call_localret_ent(io__write_char_3_0,
...
MR_def_label(libs__options__options_help_2_0,12)
	...
	MR_sv(2) = (MR_Word) MR_TAG_COMMON(1,4,1376);
	MR_r1 = (MR_Integer) 9;
	MR_np_call_localret_ent(io__write_char_3_0,
...
MR_def_label(libs__options__options_help_2_0,15)
	...
	MR_sv(2) = (MR_Word) MR_TAG_COMMON(1,4,1375);
	MR_r1 = (MR_Integer) 9;
	MR_np_call_localret_ent(io__write_char_3_0,
...
MR_def_label(libs__options__options_help_2_0,18)
	...
	MR_sv(2) = (MR_Word) MR_TAG_COMMON(1,4,1374);
	MR_r1 = (MR_Integer) 9;
	MR_np_call_localret_ent(io__write_char_3_0,
...
MR_def_label(libs__options__options_help_2_0,21)
	...
	MR_sv(2) = (MR_Word) MR_TAG_COMMON(1,4,1373);
	MR_r1 = (MR_Integer) 9;
	MR_np_call_localret_ent(io__write_char_3_0,
...
MR_def_label(libs__options__options_help_2_0,24)
	...
	MR_sv(2) = (MR_Word) MR_TAG_COMMON(1,4,1372);
	MR_r1 = (MR_Integer) 9;
	MR_np_call_localret_ent(io__write_char_3_0,
