...
ll_backend__unify_gen__IntroducedFrom__pred__generate_unification__70__1_2_p_0(
  MR_Word CodeModel_9,
  MR_Word HeadVar__2_51);

static MR_bool MR_CALL 
ll_backend__unify_gen__IntroducedFrom__pred__generate_unification__75__1_2_p_0(
  MR_Word CodeModel_9,
  MR_Word HeadVar__2_45);

static MR_bool MR_CALL 
ll_backend__unify_gen__IntroducedFrom__pred__generate_unification__66__1_2_p_0(
  MR_Word CodeModel_9,
...
{
  {
    ...
    succeeded = ll_backend__unify_gen__IntroducedFrom__pred__generate_unification__70__1_2_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))));
    return succeeded;
  }
}
...
{
  {
    ...
    succeeded = ll_backend__unify_gen__IntroducedFrom__pred__generate_unification__75__1_2_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))));
    return succeeded;
  }
}
...
{
  {
    ...
    succeeded = ll_backend__unify_gen__IntroducedFrom__pred__generate_unification__66__1_2_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))));
    return succeeded;
  }
}
      ...
      case (MR_Integer) 1:
        {
          ...
          if (succeeded)
          {
            ...
            switch (MR_tag((MR_Word) BuiltinType_16)) {
              ...
              case (MR_Integer) 0:
                switch (MR_unmkbody(BuiltinType_16)) {
                  default: /*NOTREACHED*/ MR_assert(0);
                  case (MR_Integer) 0:
                    EqOp_17 = (MR_Word) ((MR_Unsigned) 68U);
                    break;
                  case (MR_Integer) 1:
            ...
            EqOp_17 = (MR_Word) (MR_mkword(MR_mktag(3), &ll_backend__unify_gen_scalar_common_1[0]));
          ll_backend__code_loc_dep__produce_variable_5_p_0(VarA_8, &VarCodeA_19, &VarRvalA_20, STATE_VARIABLE_CLD_0_26, &STATE_VARIABLE_CLD_30_30);
          ll_backend__code_loc_dep__produce_variable_5_p_0(VarB_9, &VarCodeB_21, &VarRvalB_22, STATE_VARIABLE_CLD_30_30, &STATE_VARIABLE_CLD_31_31);
          {
