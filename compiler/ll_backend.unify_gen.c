          ...
          case (MR_Integer) 9:
            {
              ...
              packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), RttiProcLabel_76, (MR_Integer) 10)));
              Origin_77 = ((MR_Word) ((MR_hl_field(MR_mktag(0), RttiProcLabel_76, (MR_Integer) 11))));
              packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), RttiProcLabel_76, (MR_Integer) 12)));
