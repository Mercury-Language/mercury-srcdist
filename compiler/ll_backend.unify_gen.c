              ...
              case (MR_Integer) 1:
                {
                      ...
                      case (MR_Integer) 1:
                        {
...

                          {
                            ...
                            MR_hl_field(3, EqOp_74, 0) = ((MR_Box) ((MR_Unsigned) 8U));
                            MR_hl_field(3, EqOp_74, 1) = (MR_Box) ((MR_Unsigned) (IntType_75));
                          }
                        }
                        break;
                    }
                  ...
                  ll_backend__code_loc_dep__produce_variable_5_p_0(VarB_18, &VarCodeB_78, &VarRvalB_79, STATE_VARIABLE_CLD_30_83, &STATE_VARIABLE_CLD_31_84);
                  {
                    ...
                    MR_hl_field(3, Var_85, 1) = ((MR_Box) (EqOp_74));
                    MR_hl_field(3, Var_85, 2) = ((MR_Box) (VarRvalA_77));
                    MR_hl_field(3, Var_85, 3) = ((MR_Box) (VarRvalB_79));
                  }
