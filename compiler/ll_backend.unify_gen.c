...
{
  {
    ...
    switch (MR_tag((MR_Word) Unification_10)) {
      ...
      case (MR_Integer) 0:
        {
          ...
          if (!(succeeded))
          {
            succeeded = ((MR_tag((MR_Word) MaybeTakeAddr_25)) == (MR_Integer) 1);
            if (succeeded)
            {
            }
          }
      ...
      case (MR_Integer) 1:
        {
          MR_Word CanFail_29 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Unification_10, (MR_Integer) 4))));
          MR_Word CanCGC_30 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Unification_10, (MR_Integer) 5))));
      ...
      case (MR_Integer) 1:
        {
          ...
          if (succeeded)
          {
            ...
            switch (MR_tag((MR_Word) BuiltinType_16)) {
              ...
              case (MR_Integer) 1:
                {
                  MR_Word IntType_18 = ((MR_Word) ((MR_hl_field(MR_mktag(1), BuiltinType_16, (MR_Integer) 0))));

                  {
                    EqOp_17 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(MR_mktag(3), EqOp_17, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 8));
                    MR_hl_field(MR_mktag(3), EqOp_17, 1) = ((MR_Box) (IntType_18));
                  }
                }
                break;
            }
