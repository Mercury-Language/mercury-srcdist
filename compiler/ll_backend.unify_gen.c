...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 255, &UB_9);
    switch (UB_9) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 461, &UseAtomicCells_6);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_63, (MR_Integer) 206, &ProfileMemory_64);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_31, (MR_Integer) 461, &UseAtomicCells_32);
