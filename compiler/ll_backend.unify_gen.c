                            ...
                            if (ll_backend__unify_gen__succeeded)
                              {
                                ...
                                if (ll_backend__unify_gen__succeeded)
                                  {
                                    ll_backend__unify_gen__V_106_106 = (MR_Integer) 253;
                                    {
...
{
  {
    ...
    {
      libs__globals__lookup_bool_option_3_p_0(ll_backend__unify_gen__Globals_5, (MR_Integer) 447, &ll_backend__unify_gen__UseAtomicCells_6);
    }
...
{
  {
    ...
    {
      libs__globals__lookup_bool_option_3_p_0(ll_backend__unify_gen__Globals_31, (MR_Integer) 447, &ll_backend__unify_gen__UseAtomicCells_32);
    }
