...
{
  {
    ...
    switch (MR_tag((MR_Word) Unification_10)) {
      ...
      case (MR_Integer) 1:
        {
          MR_Word CanFail_29 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(1), Unification_10, (MR_Integer) 4))) >> (MR_Integer) 1)) & (MR_Integer) 1);
          ...
          MR_Unsigned packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), Unification_10, (MR_Integer) 4)));
      ...
      case (MR_Integer) 1:
        {
          ...
          if (succeeded)
          {
            ...
            switch (MR_tag((MR_Word) BuiltinType_16)) {
              ...
              case (MR_Integer) 1:
                {
                  MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), BuiltinType_16, (MR_Integer) 0)));

                  {
                    ...
                    MR_hl_field(MR_mktag(3), EqOp_17, 1) = (MR_Box) (packed_args_0);
                  }
                }
                break;
            }
