...
make__check_up_to_date__IntroducedFrom__pred__describe_newer_dependencies__402__1_2_p_0(
  MR_Word MaybeTimestamp_7,
  MR_Word LambdaHeadVar__1_29);

static MR_String MR_CALL 
make__check_up_to_date__IntroducedFrom__func__check_dependencies_timestamps_missing_deps_msg__298__1_1_f_0(
  MR_Word LambdaHeadVar__1_28);

static MR_bool MR_CALL 
make__check_up_to_date__IntroducedFrom__pred__check_dependencies_timestamps_missing_deps_msg__294__1_2_p_0(
  MR_Word LambdaHeadVar__1_25,
  MR_Word * LambdaHeadVar__2_26);

static MR_bool MR_CALL 
make__check_up_to_date__IntroducedFrom__pred__check_dependencies__223__1_1_p_0(
  ...
  MR_Box wrapper_arg_1)
{
  ...
  succeeded = make__check_up_to_date__IntroducedFrom__pred__describe_newer_dependencies__402__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) (wrapper_arg_1)));
  return succeeded;
}
  ...
  MR_Box wrapper_arg_1)
{
  ...
  succeeded = make__check_up_to_date__IntroducedFrom__pred__check_dependencies__223__1_1_p_0(((MR_Word) (wrapper_arg_1)));
  return succeeded;
}
  ...
  MR_Box * wrapper_arg_6)
{
  ...
  make__check_up_to_date__get_dependency_status_8_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 4)))), ((MR_Word) (wrapper_arg_1)), &conv1_Result_12, ((MR_Word) (wrapper_arg_3)), &conv0_STATE_VARIABLE_Info_37);
  ...
  MR_Word * DepsResult_18)
{
  ...
  else
  {
    ...
    else
    {
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals_12, (MR_Integer) 665, &Rebuild_26);
      switch (Rebuild_26) {
        default: /*NOTREACHED*/ MR_assert(0);
        case (MR_Integer) 0:
          {
  ...
  MR_Box wrapper_arg_1)
{
  ...
  conv1_LambdaHeadVar__2_29 = make__check_up_to_date__IntroducedFrom__func__check_dependencies_timestamps_missing_deps_msg__298__1_1_f_0(((MR_Word) (wrapper_arg_1)));
  ...
  MR_Box * wrapper_arg_2)
{
  ...
  succeeded = make__check_up_to_date__IntroducedFrom__pred__check_dependencies_timestamps_missing_deps_msg__294__1_2_p_0(((MR_Word) (wrapper_arg_1)), &conv0_LambdaHeadVar__2_26);
  if (succeeded)
  {
...
void MR_CALL 
make__check_up_to_date__get_dependency_status_8_p_0(
  ...
  MR_Word * STATE_VARIABLE_Info_37)
{
  ...
  if (((MR_tag((MR_Word) Dep_11)) == (MR_Integer) 1))
  {
    ...
    succeeded = mercury__version_hash_table__search_3_p_0((MR_Word) (&make__make_info__make__make_info__type_ctor_info_dependency_file_0), (MR_Word) (&make__make_info__make__make_info__type_ctor_info_dependency_status_0), DepStatusMap0_17, ((MR_Box) (Dep_11)), &conv0_StatusPrime_18);
    if (succeeded)
    {
    ...
    else
    {
      ...
      mercury__version_hash_table__det_insert_4_p_0((MR_Word) (&make__make_info__make__make_info__type_ctor_info_dependency_file_0), (MR_Word) (&make__make_info__make__make_info__type_ctor_info_dependency_status_0), ((MR_Box) (Dep_11)), ((MR_Box) (Status_19)), DepStatusMap0_17, &DepStatusMap_23);
      make__make_info__make_info_set_dependency_status_3_p_0(DepStatusMap_23, STATE_VARIABLE_Info_40_40, STATE_VARIABLE_Info_37);
    }
  }
  else
  {
    MR_Word Target_24 = (MR_Word) ((MR_Word) (Dep_11));
    ...
    if (succeeded)
    {
...

      {
        ...
        MR_hl_field(0, TopTargetFile_28, 1) = ((MR_Box) (&make__check_up_to_date_scalar_common_3[0]));
      }
      make__file_names__get_make_target_file_name_6_p_0(Globals_10, (MR_String) "predicate \140make.check_up_to_date.get_dependency_status\'/8", Target_24, &TargetFileName_68);
      {
        MaybeTargetFileName_16 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
    ...
    else
    {
      ...
      succeeded = mercury__version_hash_table__search_3_p_0((MR_Word) (&make__make_info__make__make_info__type_ctor_info_dependency_file_0), (MR_Word) (&make__make_info__make__make_info__type_ctor_info_dependency_status_0), DepStatusMap0_69, ((MR_Box) (Dep_11)), &conv1_StatusPrime_86);
      if (succeeded)
      {
      ...
      else
      {
        ...
        make__file_names__get_make_target_file_name_6_p_0(Globals_10, (MR_String) "predicate \140make.check_up_to_date.get_dependency_status\'/8", Target_24, &TargetFileName_80);
        {
          MaybeTargetFileName_16 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(1, MaybeTargetFileName_16, 0) = ((MR_Box) (TargetFileName_80));
        }
        make__get_module_dep_info__get_maybe_module_dep_info_8_p_0(ProgressStream_9, Globals_10, ModuleName_25, &MaybeModuleDepInfo_30, STATE_VARIABLE_Info_0_36, &STATE_VARIABLE_Info_55_55);
        ...
        mercury__version_hash_table__det_insert_4_p_0((MR_Word) (&make__make_info__make__make_info__type_ctor_info_dependency_file_0), (MR_Word) (&make__make_info__make__make_info__type_ctor_info_dependency_status_0), ((MR_Box) (Dep_11)), ((MR_Box) (Status_19)), DepStatusMap1_35, &DepStatusMap_83);
