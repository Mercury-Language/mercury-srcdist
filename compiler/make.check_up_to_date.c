...
make__check_up_to_date__IntroducedFrom__pred__describe_newer_dependencies__464__1_2_p_0(
  MR_Word MaybeTimestamp_7,
  MR_Word LambdaHeadVar__1_29);

static MR_String MR_CALL 
make__check_up_to_date__IntroducedFrom__func__check_dependencies_timestamps_missing_deps_msg__398__1_1_f_0(
  MR_Word LambdaHeadVar__1_28);

static MR_bool MR_CALL 
make__check_up_to_date__IntroducedFrom__pred__check_dependencies_timestamps_missing_deps_msg__394__1_2_p_0(
  MR_Word LambdaHeadVar__1_25,
  MR_Word * LambdaHeadVar__2_26);

static MR_bool MR_CALL 
make__check_up_to_date__IntroducedFrom__pred__check_dependencies__100__1_1_p_0(
  ...
  MR_Box wrapper_arg_1)
{
  ...
  succeeded = make__check_up_to_date__IntroducedFrom__pred__describe_newer_dependencies__464__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) (wrapper_arg_1)));
  return succeeded;
}
          ...
          case (MR_Integer) 8:
            {
              ...
              make__file_names__module_target_file_to_file_name_6_p_0(Globals_10, (MR_String) "predicate \140make.check_up_to_date.get_dependency_file_status\'/8", Target_23, &TargetFileName_75);
              {
          ...
          case (MR_Integer) 13:
            {
              ...
              else
              {
                ...
                make__file_names__module_target_file_to_file_name_6_p_0(Globals_10, (MR_String) "predicate \140make.check_up_to_date.get_dependency_file_status\'/8", Target_23, &TargetFileName_86);
                {
                  MaybeTargetFileName_28 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
  ...
  MR_Box wrapper_arg_1)
{
  ...
  succeeded = make__check_up_to_date__IntroducedFrom__pred__check_dependencies__100__1_1_p_0(((MR_Word) (wrapper_arg_1)));
  return succeeded;
}
  ...
  MR_Box wrapper_arg_1)
{
  ...
  conv1_LambdaHeadVar__2_29 = make__check_up_to_date__IntroducedFrom__func__check_dependencies_timestamps_missing_deps_msg__398__1_1_f_0(((MR_Word) (wrapper_arg_1)));
  ...
  MR_Box * wrapper_arg_2)
{
  ...
  succeeded = make__check_up_to_date__IntroducedFrom__pred__check_dependencies_timestamps_missing_deps_msg__394__1_2_p_0(((MR_Word) (wrapper_arg_1)), &conv0_LambdaHeadVar__2_26);
  if (succeeded)
  {
