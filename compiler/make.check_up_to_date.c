    ...
    else
    {
      ...
      if ((env).make__check_up_to_date__must_or_should_we_rebuild_lhs_11_p_0_env_0__succeeded)
      {
        ...
        if ((env).make__check_up_to_date__must_or_should_we_rebuild_lhs_11_p_0_env_0__succeeded)
        {
          ...
          analysis__operations__do_read_module_overall_status_6_p_0((MR_Word) (&make__check_up_to_date_scalar_common_2[0]), ((MR_Box) ((MR_Integer) 0)), Globals_13, ModuleName_30, &AnalysisStatus_113);
