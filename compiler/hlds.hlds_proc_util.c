...
hlds__hlds_proc_util__IntroducedFrom__pred__proc_info_uninstantiated_head_vars__251__1_4_p_0(
...
static MR_bool MR_CALL 
hlds__hlds_proc_util__IntroducedFrom__pred__proc_info_instantiated_head_vars__236__1_4_p_0(
  MR_Word ModuleInfo_4,
  MR_Word VarTable_9,
  MR_Word LambdaHeadVar__1_18,
  MR_Word * LambdaHeadVar__2_19);
  ...
  MR_Word * LambdaHeadVar__2_19)
{
  ...
  *LambdaHeadVar__2_19 = ((MR_Word) ((MR_hl_field(0, LambdaHeadVar__1_18, 0))));
  Mode_14 = ((MR_Word) ((MR_hl_field(0, LambdaHeadVar__1_18, 1))));
  parse_tree__var_table__lookup_var_type_3_p_0(VarTable_9, *LambdaHeadVar__2_19, &Type_15);
  hlds__mode_util__mode_get_insts_4_p_0(ModuleInfo_4, Mode_14, &Inst1_16, &Inst2_17);
  succeeded = hlds__inst_match__inst_matches_binding_4_p_0(ModuleInfo_4, Type_15, Inst1_16, Inst2_17);
  return succeeded;
}
  ...
  MR_Integer * CloneProcId_6)
{
  while (MR_TRUE)
  {
    ...
    ;
    hlds__pred_proc_id__proc_id_to_int_2_p_1(&TrialProcId_7, TrialProcIdInt_5);
    succeeded = mercury__map__search_3_p_0((MR_Word) (&hlds__pred_proc_id__hlds__pred_proc_id__type_ctor_info_proc_id_0), (MR_Word) (&hlds__hlds_proc__hlds__hlds_proc__type_ctor_info_proc_info_0), ProcTable_4, ((MR_Box) (TrialProcId_7)), &conv0_Var_8);
    if (succeeded)
      succeeded = MR_TRUE;
    if (succeeded)
    {
  ...
  MR_Integer * OutArgNum_8)
{
  ...
  hlds__hlds_proc__proc_info_get_headvars_2_p_0(ProcInfo_6, &HeadVars_9);
  hlds__hlds_proc__proc_info_get_argmodes_2_p_0(ProcInfo_6, &ArgModes_10);
  hlds__hlds_proc__proc_info_get_var_table_2_p_0(ProcInfo_6, &VarTable_11);
  ...
  MR_Integer * OutArgNum_12)
{
  ...
  if (succeeded)
  {
    ...
    if (succeeded)
    {
      *InArgNum_11 = ((MR_Integer) ((MR_hl_field(1, MaybeIn_14, 0))));
      succeeded = (MaybeOut_15 != (MR_Word) ((MR_Unsigned) 0U));
      if (succeeded)
        *OutArgNum_12 = ((MR_Integer) ((MR_hl_field(1, MaybeOut_15, 0))));
    }
  }
  return succeeded;
}
  ...
  MR_Word * STATE_VARIABLE_MaybeOut_8)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      MR_Word Var_21;
      MR_Word Mode_22;
      MR_Word VarModes_23 = ((MR_Word) ((MR_hl_field(1, HeadVar__4_4, 1))));
      MR_Word Var_33 = ((MR_Word) ((MR_hl_field(1, HeadVar__4_4, 0))));
      MR_Word STATE_VARIABLE_MaybeIn_1_34;
      MR_Word STATE_VARIABLE_MaybeOut_1_35;
      MR_Integer Var_36;
      MR_Integer Var_39;
      MR_Word VarType_26;
      ...
      Var_21 = ((MR_Word) ((MR_hl_field(0, Var_33, 0))));
      Mode_22 = ((MR_Word) ((MR_hl_field(0, Var_33, 1))));
      ...
      if (succeeded)
      {
        succeeded = hlds__mode_test__mode_is_fully_input_3_p_0(ModuleInfo_1, VarType_26, Mode_22);
        if (succeeded)
        {
          succeeded = (STATE_VARIABLE_MaybeIn_0_5 == (MR_Word) ((MR_Unsigned) 0U));
          if (succeeded)
          {
            STATE_VARIABLE_MaybeOut_1_35 = STATE_VARIABLE_MaybeOut_0_7;
            {
              STATE_VARIABLE_MaybeIn_1_34 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(1, STATE_VARIABLE_MaybeIn_1_34, 0) = ((MR_Box) (ArgNum_3));
            }
            succeeded = MR_TRUE;
          }
        }
        ...
        {
          succeeded = hlds__mode_test__mode_is_fully_output_3_p_0(ModuleInfo_1, VarType_26, Mode_22);
          if (succeeded)
          {
            succeeded = (STATE_VARIABLE_MaybeOut_0_7 == (MR_Word) ((MR_Unsigned) 0U));
            if (succeeded)
            {
              STATE_VARIABLE_MaybeIn_1_34 = STATE_VARIABLE_MaybeIn_0_5;
              {
                STATE_VARIABLE_MaybeOut_1_35 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(1, STATE_VARIABLE_MaybeOut_1_35, 0) = ((MR_Box) (ArgNum_3));
              }
              succeeded = MR_TRUE;
            }
          }
      ...
      if (succeeded)
      {
        ...
        next_value_of_STATE_VARIABLE_MaybeIn_0_5 = STATE_VARIABLE_MaybeIn_1_34;
        next_value_of_STATE_VARIABLE_MaybeOut_0_7 = STATE_VARIABLE_MaybeOut_1_35;
  ...
  MR_Word * STATE_VARIABLE_ProcInfo_8)
{
  ...
  hlds__hlds_proc__proc_info_get_headvars_2_p_0(STATE_VARIABLE_ProcInfo_0_7, &HeadVars_4);
  hlds__hlds_proc__proc_info_get_var_table_2_p_0(STATE_VARIABLE_ProcInfo_0_7, &VarTable0_5);
  hlds__hlds_proc_util__ensure_all_headvars_are_named_loop_4_p_0(HeadVars_4, (MR_Integer) 1, VarTable0_5, &VarTable_6);
  hlds__hlds_proc__proc_info_set_var_table_3_p_0(VarTable_6, STATE_VARIABLE_ProcInfo_0_7, STATE_VARIABLE_ProcInfo_8);
}
  ...
  MR_Word * STATE_VARIABLE_VarTable_4)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      MR_Word Type_15;
      MR_Word IsDummy_16;
      MR_Word STATE_VARIABLE_VarTable_1_23;
      MR_Integer Var_24;
      ...
      Name0_14 = ((MR_String) ((MR_hl_field(0, Entry0_13, 0))));
      Type_15 = ((MR_Word) ((MR_hl_field(0, Entry0_13, 1))));
      IsDummy_16 = ((MR_Unsigned) ((MR_hl_field(0, Entry0_13, 2))) & (MR_Integer) 1);
      ...
      if (succeeded)
      {
        ...
        parse_tree__var_table__update_var_entry_4_p_0(Var_9, Entry_18, STATE_VARIABLE_VarTable_0_3, &STATE_VARIABLE_VarTable_1_23);
      }
      else
        STATE_VARIABLE_VarTable_1_23 = STATE_VARIABLE_VarTable_0_3;
      Var_24 = (MR_Integer) ((MR_Unsigned) SeqNum_2 + (MR_Unsigned) 1);
      // direct tailcall eliminated
      ;
      next_value_of_HeadVar__1_1 = Vars_10;
      next_value_of_SeqNum_2 = Var_24;
      next_value_of_STATE_VARIABLE_VarTable_0_3 = STATE_VARIABLE_VarTable_1_23;
  ...
  MR_Word * STATE_VARIABLE_ProcInfo_13)
{
  ...
  hlds__hlds_proc__proc_info_get_var_table_2_p_0(STATE_VARIABLE_ProcInfo_0_12, &VarTable0_10);
  hlds__var_table_hlds__create_fresh_vars_5_p_0(ModuleInfo_6, Types_7, Vars_8, VarTable0_10, &VarTable_11);
  hlds__hlds_proc__proc_info_set_var_table_3_p_0(VarTable_11, STATE_VARIABLE_ProcInfo_0_12, STATE_VARIABLE_ProcInfo_13);
}
  ...
  MR_Word * STATE_VARIABLE_ProcInfo_16)
{
  ...
  hlds__hlds_proc__proc_info_get_var_table_2_p_0(STATE_VARIABLE_ProcInfo_0_15, &VarTable0_12);
  {
  ...
  hlds__hlds_proc__proc_info_set_var_table_3_p_0(VarTable_14, STATE_VARIABLE_ProcInfo_0_15, STATE_VARIABLE_ProcInfo_16);
}
  ...
  MR_Box * wrapper_arg_2)
{
  ...
  succeeded = hlds__hlds_proc_util__IntroducedFrom__pred__proc_info_uninstantiated_head_vars__251__1_4_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) ((MR_hl_field(0, closure, 4)))), ((MR_Word) (wrapper_arg_1)), &conv0_LambdaHeadVar__2_19);
  if (succeeded)
  {
  ...
  MR_Word * UnchangedInstHeadVars_6)
{
  ...
  hlds__hlds_proc__proc_info_get_headvars_2_p_0(ProcInfo_5, &HeadVars_7);
  hlds__hlds_proc__proc_info_get_argmodes_2_p_0(ProcInfo_5, &ArgModes_8);
  hlds__hlds_proc__proc_info_get_var_table_2_p_0(ProcInfo_5, &VarTable_9);
  ...
  MR_Box * wrapper_arg_2)
{
  ...
  succeeded = hlds__hlds_proc_util__IntroducedFrom__pred__proc_info_instantiated_head_vars__236__1_4_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) ((MR_hl_field(0, closure, 4)))), ((MR_Word) (wrapper_arg_1)), &conv0_LambdaHeadVar__2_19);
  if (succeeded)
  {
    *wrapper_arg_2 = ((MR_Box) (conv0_LambdaHeadVar__2_19));
    succeeded = MR_TRUE;
  ...
  MR_Word * InstMap_6)
{
  ...
  hlds__hlds_proc__proc_info_get_headvars_2_p_0(ProcInfo_5, &HeadVars_7);
  hlds__hlds_proc__proc_info_get_argmodes_2_p_0(ProcInfo_5, &ArgModes_8);
  hlds__mode_util__mode_list_get_initial_insts_3_p_0(ModuleInfo_4, ArgModes_8, &InitialInsts_9);
  ...
  MR_Word * ArgInfo_4)
{
  ...
  hlds__hlds_proc__proc_info_get_maybe_arg_info_2_p_0(ProcInfo_3, &MaybeArgInfo0_5);
  if ((MaybeArgInfo0_5 == (MR_Word) ((MR_Unsigned) 0U)))
    ...
    *ArgInfo_4 = ((MR_Word) ((MR_hl_field(1, MaybeArgInfo0_5, 0))));
}
  ...
  MR_Word * ArgLives_6)
{
  ...
  hlds__hlds_proc__proc_info_get_maybe_arglives_2_p_0(ProcInfo_5, &MaybeArgLives_7);
  if ((MaybeArgLives_7 == (MR_Word) ((MR_Unsigned) 0U)))
  {
    MR_Word Modes_9;

    hlds__hlds_proc__proc_info_get_argmodes_2_p_0(ProcInfo_5, &Modes_9);
    hlds__mode_util__get_arg_lives_3_p_0(ModuleInfo_4, Modes_9, ArgLives_6);
  }
  else
    *ArgLives_6 = ((MR_Word) ((MR_hl_field(1, MaybeArgLives_7, 0))));
}

void MR_CALL 
hlds__hlds_proc_util__can_proc_info_ever_succeed_2_p_0(
  MR_Word ProcInfo_3,
  MR_Word * CanSucceed_4)
{
  MR_Word DeclaredDeterminism_5;

  hlds__hlds_proc__proc_info_get_declared_determinism_2_p_0(ProcInfo_3, &DeclaredDeterminism_5);
  if ((DeclaredDeterminism_5 == (MR_Word) ((MR_Unsigned) 0U)))
    *CanSucceed_4 = (MR_Integer) 0;
  else
  {
    MR_Word Determinism_6 = ((MR_Word) ((MR_hl_field(1, DeclaredDeterminism_5, 0))));
    MR_Word MaxSoln_8;
    MR_Word Var_7;
  ...
  MR_Word * Determinism_4)
{
  ...
  hlds__hlds_proc__proc_info_get_declared_determinism_2_p_0(ProcInfo_3, &MaybeDeterminism_5);
  if ((MaybeDeterminism_5 == (MR_Word) ((MR_Unsigned) 0U)))
    hlds__hlds_proc__proc_info_get_inferred_determinism_2_p_0(ProcInfo_3, Determinism_4);
  else
    *Determinism_4 = ((MR_Word) ((MR_hl_field(1, MaybeDeterminism_5, 0))));
}
  ...
  MR_Word * ArgModes_4)
{
  ...
  hlds__hlds_proc__proc_info_get_maybe_declared_argmodes_2_p_0(ProcInfo_3, &MaybeArgModes_5);
  if ((MaybeArgModes_5 == (MR_Word) ((MR_Unsigned) 0U)))
    hlds__hlds_proc__proc_info_get_argmodes_2_p_0(ProcInfo_3, ArgModes_4);
  else
    *ArgModes_4 = ((MR_Word) ((MR_hl_field(1, MaybeArgModes_5, 0))));
}
  ...
  MR_Word * HeadModesConstraint_4)
{
  ...
  hlds__hlds_proc__proc_info_get_maybe_head_modes_constr_2_p_0(ProcInfo_3, &MaybeHeadModesConstraint_5);
  if ((MaybeHeadModesConstraint_5 == (MR_Word) ((MR_Unsigned) 0U)))
    ...
    *HeadModesConstraint_4 = ((MR_Word) ((MR_hl_field(1, MaybeHeadModesConstraint_5, 0))));
}
