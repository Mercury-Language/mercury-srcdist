  ...
  MR_Word * STATE_VARIABLE_MaybeOut_8)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        succeeded = check_hlds__mode_test__mode_is_fully_input_3_p_0(ModuleInfo_1, VarType_26, Mode_22);
        if (succeeded)
        {
        ...
        {
          succeeded = check_hlds__mode_test__mode_is_fully_output_3_p_0(ModuleInfo_1, VarType_26, Mode_22);
          if (succeeded)
          {
