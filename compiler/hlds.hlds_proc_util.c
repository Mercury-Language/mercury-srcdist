...
hlds__hlds_proc_util__IntroducedFrom__pred__proc_info_uninstantiated_head_vars__248__1_4_p_0(
...
static MR_bool MR_CALL 
hlds__hlds_proc_util__IntroducedFrom__pred__proc_info_instantiated_head_vars__233__1_4_p_0(
  MR_Word ModuleInfo_4,
  MR_Word VarTable_9,
  MR_Word LambdaHeadVar__1_18,
  MR_Word * LambdaHeadVar__2_19);
  ...
  MR_Word * STATE_VARIABLE_ProcInfo_13)
{
  ...
  hlds__hlds_pred__proc_info_get_var_table_2_p_0(STATE_VARIABLE_ProcInfo_0_12, &VarTable0_10);
  hlds__var_table_hlds__create_fresh_vars_5_p_0(ModuleInfo_6, Types_7, Vars_8, VarTable0_10, &VarTable_11);
  hlds__hlds_pred__proc_info_set_var_table_3_p_0(VarTable_11, STATE_VARIABLE_ProcInfo_0_12, STATE_VARIABLE_ProcInfo_13);
}
  ...
  MR_Box * wrapper_arg_2)
{
  ...
  succeeded = hlds__hlds_proc_util__IntroducedFrom__pred__proc_info_uninstantiated_head_vars__248__1_4_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) ((MR_hl_field(0, closure, 4)))), ((MR_Word) (wrapper_arg_1)), &conv0_LambdaHeadVar__2_19);
  if (succeeded)
  {
  ...
  MR_Box * wrapper_arg_2)
{
  ...
  succeeded = hlds__hlds_proc_util__IntroducedFrom__pred__proc_info_instantiated_head_vars__233__1_4_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) ((MR_hl_field(0, closure, 4)))), ((MR_Word) (wrapper_arg_1)), &conv0_LambdaHeadVar__2_19);
  if (succeeded)
  {
    *wrapper_arg_2 = ((MR_Box) (conv0_LambdaHeadVar__2_19));
    succeeded = MR_TRUE;
