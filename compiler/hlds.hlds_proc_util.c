...
static void MR_CALL 
hlds__hlds_proc_util__IntroducedFrom__pred__proc_info_create_vars_from_types__265__1_5_p_0(
...
hlds__hlds_proc_util__IntroducedFrom__pred__proc_info_uninstantiated_head_vars__246__1_4_p_0(
...
static MR_bool MR_CALL 
hlds__hlds_proc_util__IntroducedFrom__pred__proc_info_instantiated_head_vars__231__1_4_p_0(
  MR_Word ModuleInfo_4,
  MR_Word VarTable_9,
  MR_Word LambdaHeadVar__1_18,
  MR_Word * LambdaHeadVar__2_19);
  ...
  MR_Word * STATE_VARIABLE_MaybeOut_8)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      succeeded = parse_tree__prog_type__type_is_io_state_1_p_0(VarType_26);
      if (succeeded)
      {
  ...
  MR_Box * wrapper_arg_4)
{
  ...
  hlds__hlds_proc_util__IntroducedFrom__pred__proc_info_create_vars_from_types__265__1_5_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) (wrapper_arg_1)), &conv1_LambdaHeadVar__2_22, ((MR_Word) (wrapper_arg_3)), &conv0_LambdaHeadVar__4_24);
  ...
  MR_Box * wrapper_arg_2)
{
  ...
  succeeded = hlds__hlds_proc_util__IntroducedFrom__pred__proc_info_uninstantiated_head_vars__246__1_4_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 4)))), ((MR_Word) (wrapper_arg_1)), &conv0_LambdaHeadVar__2_19);
  if (succeeded)
  {
  ...
  MR_Box * wrapper_arg_2)
{
  ...
  succeeded = hlds__hlds_proc_util__IntroducedFrom__pred__proc_info_instantiated_head_vars__231__1_4_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 4)))), ((MR_Word) (wrapper_arg_1)), &conv0_LambdaHeadVar__2_19);
  if (succeeded)
  {
    *wrapper_arg_2 = ((MR_Box) (conv0_LambdaHeadVar__2_19));
    succeeded = MR_TRUE;
