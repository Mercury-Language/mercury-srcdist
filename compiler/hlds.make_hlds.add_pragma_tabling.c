  ...
  MR_Word * STATE_VARIABLE_Specs_74)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_30, (MR_Integer) 131, &VeryVerbose_43);
  ...
  MR_Integer ProcId_7)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_9, (MR_Integer) 117, &HighLevelCode_11);
