  ...
  if ((OldEvalMethod_41 == (MR_Word) ((MR_Unsigned) 0U)))
  {
    ...
    else
    {
      ...
      else
      {
        ...
        MR_Word Strictness_252 = ((MR_Word) ((MR_hl_field(0, Attributes_53, 0))));
        ...
        switch (MR_tag((MR_Word) Strictness_252)) {
          ...
          case (MR_Integer) 1:
            {
              MR_Word MaybeArgMethods_57 = ((MR_Word) ((MR_hl_field(1, Strictness_252, 0))));
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = hlds__make_hlds__add_pragma_tabling__IntroducedFrom__pred__table_info_c_global_var_name__756__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) ((MR_hl_field(0, closure, 4)))));
  return succeeded;
}
