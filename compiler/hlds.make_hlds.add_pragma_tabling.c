  ...
  MR_Word * STATE_VARIABLE_Specs_74)
{
  ...
  if (succeeded)
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_30, (MR_Integer) 292, &OwnStacks_32);
    switch (OwnStacks_32) {
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_30, (MR_Integer) 78, &VeryVerbose_43);
  ...
  succeeded = hlds__hlds_pred__marker_is_present_2_p_0(Markers_46, (MR_Integer) 6);
  if (succeeded)
  {
  ...
  MR_Integer ProcId_7)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_9, (MR_Integer) 331, &HighLevelCode_11);
