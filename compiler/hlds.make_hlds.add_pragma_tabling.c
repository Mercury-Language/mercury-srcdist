  ...
  MR_Word * STATE_VARIABLE_Specs_74)
{
  ...
  if (succeeded)
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_30, (MR_Integer) 290, &OwnStacks_32);
    switch (OwnStacks_32) {
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_30, (MR_Integer) 76, &VeryVerbose_43);
  ...
  MR_Word * STATE_VARIABLE_Specs_76)
{
  ...
  if ((OldEvalMethod_41 == (MR_Word) ((MR_Unsigned) 0U)))
  {
    ...
    else
    {
      ...
      {
        Statistics_55 = (MR_Integer) 1;
        AllowReset_56 = (MR_Integer) 1;
  ...
  MR_Integer ProcId_7)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_9, (MR_Integer) 329, &HighLevelCode_11);
