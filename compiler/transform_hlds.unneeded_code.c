...
static void MR_CALL 
transform_hlds__unneeded_code__IntroducedFrom__pred__adjust_where_needed__546__1_2_p_0(
  ...
  MR_Word RefinedGoals_49)
{
  ...
  succeeded = mercury__map__is_empty_1_p_0((MR_Word) (&transform_hlds__unneeded_code_scalar_common_2[1]), (MR_Word) (&transform_hlds__unneeded_code_scalar_common_1[1]), RefinedGoals_49);
  return succeeded;
}
...
transform_hlds__unneeded_code__IntroducedFrom__pred__unneeded_process_proc__315__1_3_p_0(
  ...
  MR_Word * LambdaHeadVar__3_66)
{
  mercury__map__det_insert_4_p_0((MR_Word) (&transform_hlds__unneeded_code_scalar_common_1[0]), (MR_Word) (&transform_hlds__unneeded_code__transform_hlds__unneeded_code__type_ctor_info_where_needed_0), ((MR_Box) (LambdaHeadVar__1_64)), ((MR_Box) ((MR_Unsigned) 0U)), LambdaHeadVar__2_65, LambdaHeadVar__3_66);
}
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_18)
{
  ...
  MR_Word STATE_VARIABLE_ProcInfo_15_35;
  MR_Word STATE_VARIABLE_ProcInfo_16_36;
  ...
  hlds__hlds_pred__proc_info_get_headvars_2_p_0(STATE_VARIABLE_ProcInfo_0_15, &HeadVars_26);
  hlds__hlds_pred__proc_info_get_goal_2_p_0(STATE_VARIABLE_ProcInfo_0_15, &Goal0_27);
  hlds__hlds_pred__proc_info_get_var_table_2_p_0(STATE_VARIABLE_ProcInfo_0_15, &VarTable0_28);
  hlds__hlds_pred__proc_info_get_rtti_varmaps_2_p_0(STATE_VARIABLE_ProcInfo_0_15, &RttiVarMaps0_29);
  hlds__quantification__implicitly_quantify_clause_body_general_9_p_0((MR_Integer) 1, HeadVars_26, &_Warnings_30, Goal0_27, &Goal_31, VarTable0_28, &VarTable_32, RttiVarMaps0_29, &RttiVarMaps_33);
  hlds__hlds_pred__proc_info_set_goal_3_p_0(Goal_31, STATE_VARIABLE_ProcInfo_0_15, &STATE_VARIABLE_ProcInfo_15_35);
  hlds__hlds_pred__proc_info_set_var_table_3_p_0(VarTable_32, STATE_VARIABLE_ProcInfo_15_35, &STATE_VARIABLE_ProcInfo_16_36);
  hlds__hlds_pred__proc_info_set_rtti_varmaps_3_p_0(RttiVarMaps_33, STATE_VARIABLE_ProcInfo_16_36, &STATE_VARIABLE_ProcInfo_22_22);
  PredId_12 = ((MR_Word) ((MR_hl_field(0, PredProcId_8, (MR_Integer) 0))));
  transform_hlds__unneeded_code__unneeded_process_proc_7_p_0(STATE_VARIABLE_ProcInfo_22_22, STATE_VARIABLE_ProcInfo_16, STATE_VARIABLE_ModuleInfo_0_17, STATE_VARIABLE_ModuleInfo_18, PredId_12, (MR_Integer) 1, &_Successful_14);
}
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = transform_hlds__unneeded_code__IntroducedFrom__pred__unneeded_process_proc__363__1_1_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))));
  return succeeded;
}
  ...
  MR_Box * wrapper_arg_3)
{
  ...
  transform_hlds__unneeded_code__IntroducedFrom__pred__unneeded_process_proc__315__1_3_p_0(((MR_Word) (wrapper_arg_1)), ((MR_Word) (wrapper_arg_2)), &conv0_LambdaHeadVar__3_66);
  ...
  MR_Word * Successful_12)
{
  ...
  MR_Word Debug_33;
  MR_Word Options_34;
  MR_Word UnneededInfo_43;
  MR_Word Goal1_44;
  MR_Word RefinedGoals1_46;
  MR_Word Changed_47;
  MR_Word Goal2_48;
  MR_Word RefinedGoals_49;
  ...
  hlds__hlds_pred__proc_info_get_var_table_2_p_0(STATE_VARIABLE_ProcInfo_63_63, &VarTable0_15);
  hlds__hlds_pred__proc_info_get_initial_instmap_3_p_0(STATE_VARIABLE_ModuleInfo_0_61, STATE_VARIABLE_ProcInfo_63_63, &InitInstMap_16);
  GoalInfo0_18 = ((MR_Word) ((MR_hl_field(0, Goal0_14, (MR_Integer) 1))));
  ...
  hlds__hlds_pred__proc_info_instantiated_head_vars_3_p_0(STATE_VARIABLE_ModuleInfo_0_61, STATE_VARIABLE_ProcInfo_63_63, &NeededVarsList_21);
  ...
  hlds__hlds_module__module_info_get_globals_2_p_0(STATE_VARIABLE_ModuleInfo_0_61, &Globals_28);
  libs__globals__lookup_bool_option_3_p_0(Globals_28, (MR_Integer) 218, &ReorderConj_29);
  libs__globals__lookup_bool_option_3_p_0(Globals_28, (MR_Integer) 220, &FullyStrict_30);
  libs__globals__get_opt_tuple_2_p_0(Globals_28, &OptTuple_31);
  Limit_32 = ((MR_Integer) ((MR_hl_field(0, OptTuple_31, (MR_Integer) 19))));
  libs__globals__lookup_bool_option_3_p_0(Globals_28, (MR_Integer) 215, &Debug_33);
  {
    Options_34 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(0, Options_34, 0) = (MR_Box) (((((MR_Unsigned) (FullyStrict_30) << 2)) | (((((MR_Unsigned) (ReorderConj_29) << 1)) | (MR_Unsigned) (Debug_33)))));
    MR_hl_field(0, Options_34, 1) = ((MR_Box) (Limit_32));
  }
  switch (Debug_33) {
    ...
    case (MR_Integer) 1:
      {
        ...
        mercury__io__output_stream_3_p_0(&Stream_36);
        hlds__hlds_module__module_info_pred_info_3_p_0(STATE_VARIABLE_ModuleInfo_0_61, PredId_10, &PredInfo_37);
        PredName_38 = hlds__hlds_pred__pred_info_name_1_f_0(PredInfo_37);
        libs__globals__lookup_accumulating_option_3_p_0(Globals_28, (MR_Integer) 216, &DebugPredNames_39);
        if ((DebugPredNames_39 == (MR_Word) ((MR_Unsigned) 0U)))
        {
          MR_String Var_257;

          mercury__io__write_string_4_p_0(Stream_36, (MR_String) "% Starting unneededed code pass ");
          mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&transform_hlds__unneeded_code_scalar_common_3[0]), Pass_11, &Var_257);
          mercury__io__write_string_4_p_0(Stream_36, Var_257);
          mercury__io__write_string_4_p_0(Stream_36, (MR_String) "\n");
        }
        else
        {
          ...
          if (succeeded)
          {
            ...
            mercury__io__write_string_4_p_0(Stream_36, (MR_String) "% Starting unneededed code pass ");
            mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&transform_hlds__unneeded_code_scalar_common_3[0]), Pass_11, &Var_246);
            mercury__io__write_string_4_p_0(Stream_36, Var_246);
            mercury__io__write_string_4_p_0(Stream_36, (MR_String) "\n");
            ...
            hlds__hlds_out__hlds_out_goal__write_goal_10_p_0(OutInfo_42, Stream_36, STATE_VARIABLE_ModuleInfo_0_61, Var_85, (MR_Integer) 1, (MR_Integer) 0, (MR_String) ".\n", Goal0_14);
          }
        }
      }
      break;
  ...
  {
    UnneededInfo_43 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(0, UnneededInfo_43, 0) = ((MR_Box) (STATE_VARIABLE_ModuleInfo_0_61));
    MR_hl_field(0, UnneededInfo_43, 1) = ((MR_Box) (VarTable0_15));
    MR_hl_field(0, UnneededInfo_43, 2) = ((MR_Box) (Options_34));
    MR_hl_field(0, UnneededInfo_43, 3) = ((MR_Box) (ContainingGoalMap_13));
  }
  ...
  transform_hlds__unneeded_code__unneeded_process_goal_11_p_0(UnneededInfo_43, Goal0_14, &Goal1_44, InitInstMap_16, FinalInstMap_20, WhereNeededMap1_27, &Var_45, Var_90, &RefinedGoals1_46, (MR_Integer) 0, &Changed_47);
  transform_hlds__unneeded_code__unneeded_refine_goal_4_p_0(Goal1_44, &Goal2_48, RefinedGoals1_46, &RefinedGoals_49);
  {
    ...
    MR_hl_field(0, Var_92, 3) = ((MR_Box) (RefinedGoals_49));
  }
    ...
    case (MR_Integer) 1:
      {
        ...
        hlds__hlds_pred__proc_info_get_headvars_2_p_0(STATE_VARIABLE_ProcInfo_63_63, &HeadVars_50);
        hlds__hlds_pred__proc_info_get_inst_varset_2_p_0(STATE_VARIABLE_ProcInfo_63_63, &InstVarSet_51);
        hlds__hlds_pred__proc_info_get_rtti_varmaps_2_p_0(STATE_VARIABLE_ProcInfo_63_63, &RttiVarMaps0_52);
        hlds__quantification__implicitly_quantify_clause_body_general_9_p_0((MR_Integer) 1, HeadVars_50, &_Warnings_53, Goal2_48, &Goal3_54, VarTable0_15, &VarTable_55, RttiVarMaps0_52, &RttiVarMaps_56);
        check_hlds__recompute_instmap_deltas__recompute_instmap_delta_8_p_0((MR_Integer) 1, VarTable_55, InstVarSet_51, InitInstMap_16, Goal3_54, &Goal_57, STATE_VARIABLE_ModuleInfo_0_61, &STATE_VARIABLE_ModuleInfo_97_97);
        hlds__hlds_pred__proc_info_set_goal_3_p_0(Goal_57, STATE_VARIABLE_ProcInfo_63_63, &STATE_VARIABLE_ProcInfo_98_98);
        hlds__hlds_pred__proc_info_set_var_table_3_p_0(VarTable_55, STATE_VARIABLE_ProcInfo_98_98, &STATE_VARIABLE_ProcInfo_99_99);
        ...
        else
        {
          ...
          transform_hlds__unneeded_code__unneeded_process_proc_7_p_0(STATE_VARIABLE_ProcInfo_100_100, STATE_VARIABLE_ProcInfo_60, STATE_VARIABLE_ModuleInfo_97_97, STATE_VARIABLE_ModuleInfo_62, PredId_10, Var_104, &Var_58);
        }
  ...
  MR_Box * wrapper_arg_2)
{
  ...
  transform_hlds__unneeded_code__IntroducedFrom__pred__adjust_where_needed__546__1_2_p_0(((MR_Word) (wrapper_arg_1)), &conv2_HeadVar__2_41);
