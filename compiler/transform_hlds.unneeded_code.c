...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_29, (MR_Integer) 192, &ReorderConj_30);
    libs__globals__lookup_bool_option_3_p_0(Globals_29, (MR_Integer) 194, &FullyStrict_31);
