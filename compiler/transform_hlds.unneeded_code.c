  ...
  MR_Word * STATE_VARIABLE_WhereInfo_14)
{
  ...
  if (succeeded)
    ...
    {
      MR_Word BranchesA_17 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Where_12, (MR_Integer) 0))));

      if ((STATE_VARIABLE_WhereInfo_0_13 == (MR_Word) ((MR_Unsigned) 0U)))
        *STATE_VARIABLE_WhereInfo_14 = (MR_Word) ((MR_Unsigned) 0U);
      else
      {
        MR_Word BranchesB_18 = ((MR_Word) ((MR_hl_field(MR_mktag(1), STATE_VARIABLE_WhereInfo_0_13, (MR_Integer) 0))));
  ...
  MR_Word * Successful_12)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_28, (MR_Integer) 212, &ReorderConj_29);
  libs__globals__lookup_bool_option_3_p_0(Globals_28, (MR_Integer) 214, &FullyStrict_30);
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_28, (MR_Integer) 209, &Debug_33);
  {
    ...
    case (MR_Integer) 1:
      {
        ...
        libs__globals__lookup_accumulating_option_3_p_0(Globals_28, (MR_Integer) 210, &DebugPredNames_39);
        ...
        else
        {
          ...
          if (succeeded)
          {
            ...
            OutInfo_42 = hlds__hlds_out__hlds_out_util__init_hlds_out_info_2_f_0(Globals_28, (MR_Integer) 1);
            {
              ...
              MR_hl_field(MR_mktag(1), Var_85, 0) = ((MR_Box) (VarTable0_15));
            }
        ...
        case (MR_Integer) 5:
          {
            ...
            if (succeeded)
            {
              Var_67 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(3), Reason_53, (MR_Integer) 2))) & (MR_Integer) 3);
        ...
        case (MR_Integer) 4:
          {
            ...
            GoalId_67 = hlds__hlds_goal__goal_info_get_goal_id_1_f_0(GoalInfo0_21);
            {
              ...
              MR_hl_field(MR_mktag(1), Var_104, 0) = ((MR_Box) (MaybeNumAlt_66));
            }
            {
              ...
              MR_hl_field(MR_mktag(0), BranchPoint_68, 1) = ((MR_Box) (Var_104));
            }
        ...
        case (MR_Integer) 5:
          {
            ...
            if (succeeded)
            {
              Var_128 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(3), Reason_83, (MR_Integer) 2))) & (MR_Integer) 3);
  ...
  MR_Word * STATE_VARIABLE_Changed_36)
{
  ...
  else
  {
    ...
    MR_Word Debug_24;
    MR_Word Var_41;
    MR_Word GoalInfo_87 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Goal0_13, (MR_Integer) 1))));
    ...
    ModuleInfo_91 = ((MR_Word) ((MR_hl_field(MR_mktag(0), UnneededInfo_12, (MR_Integer) 0))));
    {
      Var_94 = (MR_Word) MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), Var_94, 0) = ((MR_Box) (&transform_hlds__unneeded_code_scalar_common_6[1]));
      MR_hl_field(MR_mktag(0), Var_94, 1) = ((MR_Box) (transform_hlds__unneeded_code__unneeded_process_goal_11_p_0_1));
      MR_hl_field(MR_mktag(0), Var_94, 2) = ((MR_Box) ((MR_Integer) 2));
      MR_hl_field(MR_mktag(0), Var_94, 3) = ((MR_Box) (ModuleInfo_91));
      MR_hl_field(MR_mktag(0), Var_94, 4) = ((MR_Box) (InitInstMap_15));
    }
    mercury__list__filter_3_p_0((MR_Word) (&transform_hlds__unneeded_code_scalar_common_1[0]), Var_94, NonLocals_90, &Inputs_92);
    ContainingGoalMap_93 = ((MR_Word) ((MR_hl_field(MR_mktag(0), UnneededInfo_12, (MR_Integer) 3))));
    {
      Var_95 = (MR_Word) MR_new_object(MR_Word, (6 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), Var_95, 0) = ((MR_Box) (&transform_hlds__unneeded_code_scalar_common_4[1]));
      MR_hl_field(MR_mktag(0), Var_95, 1) = ((MR_Box) (transform_hlds__unneeded_code__unneeded_process_goal_11_p_0_2));
      MR_hl_field(MR_mktag(0), Var_95, 2) = ((MR_Box) ((MR_Integer) 3));
      MR_hl_field(MR_mktag(0), Var_95, 3) = ((MR_Box) (ContainingGoalMap_93));
      MR_hl_field(MR_mktag(0), Var_95, 4) = ((MR_Box) (GoalId_89));
      MR_hl_field(MR_mktag(0), Var_95, 5) = ((MR_Box) (WhereInfo_20));
    }
    ...
    mercury__map__to_assoc_list_2_p_0((MR_Word) (&transform_hlds__unneeded_code__transform_hlds__unneeded_code__type_ctor_info_branch_point_0), (MR_Word) (&transform_hlds__unneeded_code_scalar_common_1[2]), Branches_21, &BranchList_22);
    {
      ...
      MR_hl_field(MR_mktag(0), Var_41, 0) = ((MR_Box) (&transform_hlds__unneeded_code_scalar_common_7[0]));
      MR_hl_field(MR_mktag(0), Var_41, 1) = ((MR_Box) (transform_hlds__unneeded_code__unneeded_process_goal_11_p_0_3));
      MR_hl_field(MR_mktag(0), Var_41, 2) = ((MR_Box) ((MR_Integer) 1));
      MR_hl_field(MR_mktag(0), Var_41, 3) = ((MR_Box) (Goal0_13));
    }
  ...
  GoalInfo_106 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Goal0_13, (MR_Integer) 1))));
  ...
  parse_tree__set_of_var__to_sorted_list_2_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), NonLocalSet_107, &NonLocals_108);
  {
    ...
    MR_hl_field(MR_mktag(0), Var_110, 0) = ((MR_Box) (&transform_hlds__unneeded_code_scalar_common_6[1]));
    MR_hl_field(MR_mktag(0), Var_110, 1) = ((MR_Box) (transform_hlds__unneeded_code__unneeded_process_goal_11_p_0_4));
    MR_hl_field(MR_mktag(0), Var_110, 2) = ((MR_Box) ((MR_Integer) 2));
    MR_hl_field(MR_mktag(0), Var_110, 3) = ((MR_Box) (ModuleInfo_30));
    MR_hl_field(MR_mktag(0), Var_110, 4) = ((MR_Box) (InitInstMap_15));
  }
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        MR_Word BranchesA_42 = ((MR_Word) ((MR_hl_field(MR_mktag(1), BranchWhere_25, (MR_Integer) 0))));

        if ((OldWhere_27 == (MR_Word) ((MR_Unsigned) 0U)))
          CombinedWhere_28 = (MR_Word) ((MR_Unsigned) 0U);
        else
        {
          MR_Word BranchesB_43 = ((MR_Word) ((MR_hl_field(MR_mktag(1), OldWhere_27, (MR_Integer) 0))));
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        {
          MR_Word BranchesA_29 = ((MR_Word) ((MR_hl_field(MR_mktag(1), BranchWhere_13, (MR_Integer) 0))));

          if ((OldWhere_17 == (MR_Word) ((MR_Unsigned) 0U)))
            CombinedWhere_18 = (MR_Word) ((MR_Unsigned) 0U);
          else
          {
            MR_Word BranchesB_30 = ((MR_Word) ((MR_hl_field(MR_mktag(1), OldWhere_17, (MR_Integer) 0))));
  ...
  MR_Word * STATE_VARIABLE_WhereNeededMap_15)
{
  ...
  if (succeeded)
  {
    ...
    {
      MR_Word BranchesA_22 = ((MR_Word) ((MR_hl_field(MR_mktag(1), WhereNeeded_9, (MR_Integer) 0))));

      if ((Where0_12 == (MR_Word) ((MR_Unsigned) 0U)))
        Where_13 = (MR_Word) ((MR_Unsigned) 0U);
      else
      {
        MR_Word BranchesB_23 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Where0_12, (MR_Integer) 0))));
  ...
  MR_Word * STATE_VARIABLE_WhereInfo_23)
{
  ...
  GoalExpr_47 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Goal_8, (MR_Integer) 0))));
  GoalInfo_48 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Goal_8, (MR_Integer) 1))));
  {
    MR_Word Detism_49;
  ...
  if (!(succeeded))
  {
    ...
    {
      {
        MR_Word Var_56 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Options_22, (MR_Integer) 0))) >> 2)) & (MR_Integer) 1);
      ...
      {
        {
          ...
          MR_Word Var_57 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Options_22, (MR_Integer) 0))) >> 1)) & (MR_Integer) 1);
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                BranchMap_50 = ((MR_Word) ((MR_hl_field(MR_mktag(1), STATE_VARIABLE_WhereInfo_26_26, (MR_Integer) 0))));
        ...
        if (!(succeeded))
        {
          ...
          if (!(succeeded))
          {
            ...
            if (succeeded)
            {
              BranchMap_62 = ((MR_Word) ((MR_hl_field(MR_mktag(1), STATE_VARIABLE_WhereInfo_26_26, (MR_Integer) 0))));
              ...
              Var_61 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), Options_22, (MR_Integer) 1))));
