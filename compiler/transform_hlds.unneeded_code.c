  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_66)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_30, (MR_Integer) 228, &ReorderConj_31);
  libs__globals__lookup_bool_option_3_p_0(Globals_30, (MR_Integer) 230, &FullyStrict_32);
  libs__globals__get_opt_tuple_2_p_0(Globals_30, &OptTuple_33);
  Limit_34 = ((MR_Integer) ((MR_hl_field(0, OptTuple_33, (MR_Integer) 19))));
  libs__globals__lookup_bool_option_3_p_0(Globals_30, (MR_Integer) 225, &Debug_35);
  switch (Debug_35) {
    ...
    case (MR_Integer) 1:
      {
        ...
        libs__globals__lookup_accumulating_option_3_p_0(Globals_30, (MR_Integer) 226, &DebugPredNames_41);
