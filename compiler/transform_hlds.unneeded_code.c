  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_63)
{
  while (MR_TRUE)
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_28, (MR_Integer) 245, &ReorderConj_29);
    libs__globals__lookup_bool_option_3_p_0(Globals_28, (MR_Integer) 247, &FullyStrict_30);
    libs__globals__get_opt_tuple_2_p_0(Globals_28, &OptTuple_31);
    Limit_32 = ((MR_Integer) ((MR_hl_field(0, OptTuple_31, 19))));
    libs__globals__lookup_bool_option_3_p_0(Globals_28, (MR_Integer) 242, &Debug_33);
    switch (Debug_33) {
      ...
      case (MR_Integer) 1:
        {
          ...
          libs__globals__lookup_accumulating_option_3_p_0(Globals_28, (MR_Integer) 243, &DebugPredNames_39);
