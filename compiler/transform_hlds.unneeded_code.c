...
static void MR_CALL 
transform_hlds__unneeded_code__IntroducedFrom__pred__adjust_where_needed__544__1_2_p_0(
  MR_Word HeadVar__1_40,
  MR_Integer * HeadVar__2_41);

static MR_bool MR_CALL 
transform_hlds__unneeded_code__IntroducedFrom__pred__unneeded_process_proc__361__1_1_p_0(
  MR_Word RefinedGoals_49);

static void MR_CALL 
transform_hlds__unneeded_code__IntroducedFrom__pred__unneeded_process_proc__313__1_3_p_0(
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_16)
{
  ...
  hlds__hlds_pred__proc_info_get_headvars_2_p_0(STATE_VARIABLE_ProcInfo_0_13, &HeadVars_24);
  hlds__hlds_pred__proc_info_get_goal_2_p_0(STATE_VARIABLE_ProcInfo_0_13, &Goal0_25);
  hlds__hlds_pred__proc_info_get_var_table_2_p_0(STATE_VARIABLE_ProcInfo_0_13, &VarTable0_26);
  hlds__hlds_pred__proc_info_get_rtti_varmaps_2_p_0(STATE_VARIABLE_ProcInfo_0_13, &RttiVarMaps0_27);
  ...
  hlds__hlds_pred__proc_info_set_goal_3_p_0(Goal_29, STATE_VARIABLE_ProcInfo_0_13, &STATE_VARIABLE_ProcInfo_15_33);
  hlds__hlds_pred__proc_info_set_var_table_3_p_0(VarTable_30, STATE_VARIABLE_ProcInfo_15_33, &STATE_VARIABLE_ProcInfo_16_34);
  hlds__hlds_pred__proc_info_set_rtti_varmaps_3_p_0(RttiVarMaps_31, STATE_VARIABLE_ProcInfo_16_34, &STATE_VARIABLE_ProcInfo_20_20);
  PredId_10 = ((MR_Word) ((MR_hl_field(0, PredProcId_6, (MR_Integer) 0))));
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = transform_hlds__unneeded_code__IntroducedFrom__pred__unneeded_process_proc__361__1_1_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))));
  return succeeded;
}
  ...
  MR_Box * wrapper_arg_3)
{
  ...
  transform_hlds__unneeded_code__IntroducedFrom__pred__unneeded_process_proc__313__1_3_p_0(((MR_Word) (wrapper_arg_1)), ((MR_Word) (wrapper_arg_2)), &conv0_LambdaHeadVar__3_66);
  ...
  MR_Word * Successful_12)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_28, (MR_Integer) 214, &ReorderConj_29);
  libs__globals__lookup_bool_option_3_p_0(Globals_28, (MR_Integer) 216, &FullyStrict_30);
  libs__globals__get_opt_tuple_2_p_0(Globals_28, &OptTuple_31);
  Limit_32 = ((MR_Integer) ((MR_hl_field(0, OptTuple_31, (MR_Integer) 19))));
  libs__globals__lookup_bool_option_3_p_0(Globals_28, (MR_Integer) 211, &Debug_33);
  {
    ...
    case (MR_Integer) 1:
      {
        ...
        libs__globals__lookup_accumulating_option_3_p_0(Globals_28, (MR_Integer) 212, &DebugPredNames_39);
  ...
  MR_Box * wrapper_arg_2)
{
  ...
  transform_hlds__unneeded_code__IntroducedFrom__pred__adjust_where_needed__544__1_2_p_0(((MR_Word) (wrapper_arg_1)), &conv2_HeadVar__2_41);
