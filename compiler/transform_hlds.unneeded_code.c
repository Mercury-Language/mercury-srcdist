  ...
  {
    {
      ...
      Var_61 = hlds__hlds_goal__goal_info_get_purity_1_f_0(GoalInfo_54);
      succeeded = (Var_61 != (MR_Integer) 0);
    }
    if (!(succeeded))
    {
      {
        MR_Word Var_62 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Options_22, (MR_Integer) 0))) >> 2)) & (MR_Integer) 1);
      ...
      {
        {
          ...
          MR_Word Var_63 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Options_22, (MR_Integer) 0))) >> 1)) & (MR_Integer) 1);
        ...
        if (!(succeeded))
        {
          ...
          if (!(succeeded))
          {
            ...
            if (succeeded)
            {
              ...
              Var_64 = (MR_Word) (&transform_hlds__unneeded_code_scalar_common_2[6]);
              TypeCtorInfo_43_86 = (MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0);
              mercury__list__map_3_p_0(TypeInfo_39_82, TypeCtorInfo_43_86, Var_64, BranchArms_57, &BranchArmCounts_58);
              Var_65 = (MR_Word) (&transform_hlds__unneeded_code_scalar_common_2[7]);
              Var_66 = (MR_Integer) 0;
              conv4_BranchArmCount_59 = mercury__list__foldl_3_f_0(TypeCtorInfo_43_86, TypeCtorInfo_43_86, Var_65, BranchArmCounts_58, ((MR_Box) (Var_66)));
              BranchArmCount_59 = ((MR_Integer) (conv4_BranchArmCount_59));
              Var_67 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), Options_22, (MR_Integer) 1))));
              succeeded = (BranchArmCount_59 > Var_67);
            }
          }
        }
      }
