...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_29, (MR_Integer) 180, &ReorderConj_30);
    libs__globals__lookup_bool_option_3_p_0(Globals_29, (MR_Integer) 182, &FullyStrict_31);
