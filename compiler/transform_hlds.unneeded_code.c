...
static void MR_CALL 
transform_hlds__unneeded_code__IntroducedFrom__pred__adjust_where_needed__545__1_2_p_0(
  ...
  MR_Word HeadVar__2_2)
{
  ...
  else
  {
    ...
    if (succeeded)
    {
      TypeCtorInfo_14_14 = (MR_Word) (&parse_tree__vartypes__parse_tree__vartypes__type_ctor_info_vartypes_0);
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_16)
{
  ...
  hlds__hlds_pred__proc_info_get_varset_vartypes_3_p_0(STATE_VARIABLE_ProcInfo_0_13, &VarSet0_29, &VarTypes0_30);
  ...
  hlds__hlds_pred__proc_info_set_varset_vartypes_4_p_0(VarSet_34, VarTypes_35, STATE_VARIABLE_ProcInfo_17_38, &STATE_VARIABLE_ProcInfo_18_39);
  hlds__hlds_pred__proc_info_set_rtti_varmaps_3_p_0(RttiVarMaps_36, STATE_VARIABLE_ProcInfo_18_39, &STATE_VARIABLE_ProcInfo_20_20);
  ...
  MR_Box * wrapper_arg_3)
{
  ...
  transform_hlds__unneeded_code__IntroducedFrom__pred__unneeded_process_proc__313__1_3_p_0(((MR_Word) (wrapper_arg_1)), ((MR_Word) (wrapper_arg_2)), &conv0_LambdaHeadVar__3_68);
  ...
  MR_Word * Successful_12)
{
  ...
  hlds__hlds_pred__proc_info_get_varset_vartypes_3_p_0(STATE_VARIABLE_ProcInfo_65_65, &VarSet0_15, &VarTypes0_16);
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_29, (MR_Integer) 210, &ReorderConj_30);
  libs__globals__lookup_bool_option_3_p_0(Globals_29, (MR_Integer) 212, &FullyStrict_31);
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_29, (MR_Integer) 207, &Debug_34);
  {
    ...
    case (MR_Integer) 1:
      {
        ...
        libs__globals__lookup_accumulating_option_3_p_0(Globals_29, (MR_Integer) 208, &DebugPredNames_40);
        ...
        else
        {
          ...
          if (succeeded)
          {
            ...
            OutInfo_43 = hlds__hlds_out__hlds_out_util__init_hlds_out_info_2_f_0(Globals_29, (MR_Integer) 1);
            {
              ...
              MR_hl_field(MR_mktag(0), Var_82, 0) = ((MR_Box) (VarSet0_15));
            }
            hlds__hlds_out__hlds_out_goal__write_goal_10_p_0(OutInfo_43, Stream_37, STATE_VARIABLE_ModuleInfo_0_63, Var_82, (MR_Integer) 1, (MR_Integer) 0, (MR_String) ".\n", Goal0_14);
          }
        }
      }
      break;
  ...
  transform_hlds__unneeded_code__unneeded_process_goal_11_p_0(UnneededInfo_44, Goal0_14, &Goal1_45, InitInstMap_17, FinalInstMap_21, WhereNeededMap1_28, &Var_46, Var_92, &RefinedGoals1_47, (MR_Integer) 0, &Changed_48);
  transform_hlds__unneeded_code__unneeded_refine_goal_4_p_0(Goal1_45, &Goal2_49, RefinedGoals1_47, &RefinedGoals_50);
  {
    ...
    MR_hl_field(MR_mktag(0), Var_94, 0) = ((MR_Box) (&transform_hlds__unneeded_code_scalar_common_8[0]));
    MR_hl_field(MR_mktag(0), Var_94, 1) = ((MR_Box) (transform_hlds__unneeded_code__unneeded_process_proc_7_p_0_2));
    MR_hl_field(MR_mktag(0), Var_94, 2) = ((MR_Box) ((MR_Integer) 1));
    MR_hl_field(MR_mktag(0), Var_94, 3) = ((MR_Box) (RefinedGoals_50));
  }
    ...
    case (MR_Integer) 1:
      {
        ...
        check_hlds__recompute_instmap_deltas__recompute_instmap_delta_8_p_0((MR_Integer) 1, VarTypes_57, InstVarSet_52, InitInstMap_17, Goal3_55, &Goal_59, STATE_VARIABLE_ModuleInfo_0_63, &STATE_VARIABLE_ModuleInfo_99_99);
        hlds__hlds_pred__proc_info_set_goal_3_p_0(Goal_59, STATE_VARIABLE_ProcInfo_65_65, &STATE_VARIABLE_ProcInfo_100_100);
        hlds__hlds_pred__proc_info_set_varset_vartypes_4_p_0(VarSet_56, VarTypes_57, STATE_VARIABLE_ProcInfo_100_100, &STATE_VARIABLE_ProcInfo_101_101);
  ...
  MR_Box * wrapper_arg_2)
{
  ...
  transform_hlds__unneeded_code__IntroducedFrom__pred__adjust_where_needed__545__1_2_p_0(((MR_Word) (wrapper_arg_1)), &conv2_HeadVar__2_41);
