  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_63)
{
  while (MR_TRUE)
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_28, (MR_Integer) 716, &Debug_33);
    switch (Debug_33) {
      ...
      case (MR_Integer) 1:
        {
          ...
          libs__globals__lookup_accumulating_option_3_p_0(Globals_28, (MR_Integer) 717, &DebugPredNames_39);
