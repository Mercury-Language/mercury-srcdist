...
{
  {
    ...
    libs__globals__lookup_int_option_3_p_0(Globals_29, (MR_Integer) 382, &Limit_32);
    libs__globals__lookup_bool_option_3_p_0(Globals_29, (MR_Integer) 383, &Debug_33);
    {
      ...
      case (MR_Integer) 1:
        {
          ...
          libs__globals__lookup_accumulating_option_3_p_0(Globals_29, (MR_Integer) 384, &DebugPredNames_38);
