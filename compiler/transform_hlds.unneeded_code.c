...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_29, (MR_Integer) 178, &ReorderConj_30);
    libs__globals__lookup_bool_option_3_p_0(Globals_29, (MR_Integer) 180, &FullyStrict_31);
