  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_63)
{
  while (MR_TRUE)
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_28, (MR_Integer) 248, &ReorderConj_29);
    libs__globals__lookup_bool_option_3_p_0(Globals_28, (MR_Integer) 250, &FullyStrict_30);
    libs__globals__get_opt_tuple_2_p_0(Globals_28, &OptTuple_31);
    Limit_32 = ((MR_Integer) ((MR_hl_field(0, OptTuple_31, 19))));
    libs__globals__lookup_bool_option_3_p_0(Globals_28, (MR_Integer) 245, &Debug_33);
    switch (Debug_33) {
      ...
      case (MR_Integer) 1:
        {
          MR_Word MaybeDebugStream_267;
          MR_Word PredInfo_37;
          MR_String PredName_38;
          MR_Word DebugPredNames_39;

          {
            MaybeDebugStream_267 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(1, MaybeDebugStream_267, 0) = ((MR_Box) (ProgressStream_8));
          }
          {
            Options_35 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
            MR_hl_field(0, Options_35, 0) = (MR_Box) (((((MR_Unsigned) (FullyStrict_30) << 1)) | (MR_Unsigned) (ReorderConj_29)));
            MR_hl_field(0, Options_35, 1) = ((MR_Box) (MaybeDebugStream_267));
            MR_hl_field(0, Options_35, 2) = ((MR_Box) (Limit_32));
          }
          ...
          libs__globals__lookup_accumulating_option_3_p_0(Globals_28, (MR_Integer) 246, &DebugPredNames_39);
          if ((DebugPredNames_39 == (MR_Word) ((MR_Unsigned) 0U)))
          {
            ...
            mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&transform_hlds__unneeded_code_scalar_common_3[0]), Pass_10, &Var_259);
            mercury__io__write_string_4_p_0(ProgressStream_8, Var_259);
          ...
          else
          {
            ...
            if (succeeded)
            {
              ...
              mercury__io__write_string_4_p_0(ProgressStream_8, (MR_String) "% Starting unneededed code pass ");
              mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&transform_hlds__unneeded_code_scalar_common_3[0]), Pass_10, &Var_248);
              mercury__io__write_string_4_p_0(ProgressStream_8, Var_248);
              mercury__io__write_string_4_p_0(ProgressStream_8, (MR_String) "\n");
