  ...
  MR_Word * STATE_VARIABLE_WhereInfo_14)
{
  ...
  if (succeeded)
    ...
    {
      MR_Word BranchesA_22 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Where_12, (MR_Integer) 0))));

      if ((STATE_VARIABLE_WhereInfo_0_13 == (MR_Word) ((MR_Unsigned) 0U)))
        *STATE_VARIABLE_WhereInfo_14 = (MR_Word) ((MR_Unsigned) 0U);
      else
      {
        MR_Word BranchesB_23 = ((MR_Word) ((MR_hl_field(MR_mktag(1), STATE_VARIABLE_WhereInfo_0_13, (MR_Integer) 0))));
        MR_Word BranchesList_29;

        mercury__map__to_assoc_list_2_p_0((MR_Word) (&transform_hlds__unneeded_code__transform_hlds__unneeded_code__type_ctor_info_branch_point_0), (MR_Word) (&transform_hlds__unneeded_code_scalar_common_1[2]), BranchesA_22, &BranchesList_29);
        transform_hlds__unneeded_code__where_needed_branches_upper_bound_2_5_p_0(ContainingGoalMap_7, CurrentId_8, BranchesList_29, BranchesB_23, STATE_VARIABLE_WhereInfo_14);
      }
    }
  else
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_16)
{
  ...
  MR_Word STATE_VARIABLE_ProcInfo_17_37;
  MR_Word STATE_VARIABLE_ProcInfo_18_38;
  ...
  hlds__hlds_pred__proc_info_get_headvars_2_p_0(STATE_VARIABLE_ProcInfo_0_13, &HeadVars_28);
  hlds__hlds_pred__proc_info_get_goal_2_p_0(STATE_VARIABLE_ProcInfo_0_13, &Goal0_29);
  hlds__hlds_pred__proc_info_get_var_table_3_p_0(STATE_VARIABLE_ModuleInfo_0_15, STATE_VARIABLE_ProcInfo_0_13, &VarTable0_30);
  hlds__hlds_pred__proc_info_get_rtti_varmaps_2_p_0(STATE_VARIABLE_ProcInfo_0_13, &RttiVarMaps0_31);
  hlds__quantification__implicitly_quantify_clause_body_general_vt_9_p_0((MR_Integer) 1, HeadVars_28, &_Warnings_32, Goal0_29, &Goal_33, VarTable0_30, &VarTable_34, RttiVarMaps0_31, &RttiVarMaps_35);
  hlds__hlds_pred__proc_info_set_goal_3_p_0(Goal_33, STATE_VARIABLE_ProcInfo_0_13, &STATE_VARIABLE_ProcInfo_17_37);
  hlds__hlds_pred__proc_info_set_var_table_3_p_0(VarTable_34, STATE_VARIABLE_ProcInfo_17_37, &STATE_VARIABLE_ProcInfo_18_38);
  hlds__hlds_pred__proc_info_set_rtti_varmaps_3_p_0(RttiVarMaps_35, STATE_VARIABLE_ProcInfo_18_38, &STATE_VARIABLE_ProcInfo_20_20);
  ...
  MR_Word * STATE_VARIABLE_Changed_50)
{
  ...
  mercury__map__to_assoc_list_2_p_0((MR_Word) (&transform_hlds__unneeded_code_scalar_common_1[0]), (MR_Word) (&transform_hlds__unneeded_code__transform_hlds__unneeded_code__type_ctor_info_where_needed_0), STATE_VARIABLE_WhereNeededMap_0_45, &WhereNeededList1_67);
  transform_hlds__unneeded_code__add_where_needed_list_5_p_0(ContainingGoalMap_38, WhereNeededList1_67, CurrentId_28, BranchNeededMap_43, &WhereNeededMapCond_44);
  ...
  MR_Word * STATE_VARIABLE_Changed_36)
{
  ...
  else
  {
    ...
    transform_hlds__unneeded_code__demand_inputs_6_p_0(UnneededInfo_12, Goal0_13, InitInstMap_15, WhereInfo_20, STATE_VARIABLE_WhereNeededMap_0_31, &STATE_VARIABLE_WhereNeededMap_37_37);
    mercury__map__to_assoc_list_2_p_0((MR_Word) (&transform_hlds__unneeded_code__transform_hlds__unneeded_code__type_ctor_info_branch_point_0), (MR_Word) (&transform_hlds__unneeded_code_scalar_common_1[2]), Branches_21, &BranchList_22);
    {
      ...
      MR_hl_field(MR_mktag(0), Var_41, 1) = ((MR_Box) (transform_hlds__unneeded_code__unneeded_process_goal_11_p_0_1));
      MR_hl_field(MR_mktag(0), Var_41, 2) = ((MR_Box) ((MR_Integer) 1));
      MR_hl_field(MR_mktag(0), Var_41, 3) = ((MR_Box) (Goal0_13));
    }
    mercury__list__foldl_4_p_0((MR_Word) (&transform_hlds__unneeded_code_scalar_common_2[2]), (MR_Word) (&transform_hlds__unneeded_code_scalar_common_2[3]), Var_41, BranchList_22, ((MR_Box) (STATE_VARIABLE_RefinedGoals_0_33)), &conv1_STATE_VARIABLE_RefinedGoals_34);
  ...
  transform_hlds__unneeded_code__undemand_virgin_outputs_5_p_0(Goal0_13, ModuleInfo_30, InitInstMap_15, STATE_VARIABLE_WhereNeededMap_37_37, &STATE_VARIABLE_WhereNeededMap_52_52);
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        MR_Word BranchesA_47 = ((MR_Word) ((MR_hl_field(MR_mktag(1), BranchWhere_25, (MR_Integer) 0))));

        if ((OldWhere_27 == (MR_Word) ((MR_Unsigned) 0U)))
          CombinedWhere_28 = (MR_Word) ((MR_Unsigned) 0U);
        else
        {
          MR_Word BranchesB_48 = ((MR_Word) ((MR_hl_field(MR_mktag(1), OldWhere_27, (MR_Integer) 0))));
          MR_Word BranchesList_54;

          mercury__map__to_assoc_list_2_p_0((MR_Word) (&transform_hlds__unneeded_code__transform_hlds__unneeded_code__type_ctor_info_branch_point_0), (MR_Word) (&transform_hlds__unneeded_code_scalar_common_1[2]), BranchesA_47, &BranchesList_54);
          transform_hlds__unneeded_code__where_needed_branches_upper_bound_2_5_p_0(ContainingGoalMap_1, CurrentId_5, BranchesList_54, BranchesB_48, &CombinedWhere_28);
        }
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        {
          MR_Word BranchesA_34 = ((MR_Word) ((MR_hl_field(MR_mktag(1), BranchWhere_13, (MR_Integer) 0))));

          if ((OldWhere_17 == (MR_Word) ((MR_Unsigned) 0U)))
            CombinedWhere_18 = (MR_Word) ((MR_Unsigned) 0U);
          else
          {
            MR_Word BranchesB_35 = ((MR_Word) ((MR_hl_field(MR_mktag(1), OldWhere_17, (MR_Integer) 0))));
            MR_Word BranchesList_41;

            mercury__map__to_assoc_list_2_p_0((MR_Word) (&transform_hlds__unneeded_code__transform_hlds__unneeded_code__type_ctor_info_branch_point_0), (MR_Word) (&transform_hlds__unneeded_code_scalar_common_1[2]), BranchesA_34, &BranchesList_41);
            transform_hlds__unneeded_code__where_needed_branches_upper_bound_2_5_p_0(ContainingGoalMap_1, CurrentId_3, BranchesList_41, BranchesB_35, &CombinedWhere_18);
          }
        }
  ...
  MR_Word * STATE_VARIABLE_WhereNeededMap_15)
{
  ...
  if (succeeded)
  {
    ...
    {
      MR_Word BranchesA_27 = ((MR_Word) ((MR_hl_field(MR_mktag(1), WhereNeeded_9, (MR_Integer) 0))));

      if ((Where0_12 == (MR_Word) ((MR_Unsigned) 0U)))
        Where_13 = (MR_Word) ((MR_Unsigned) 0U);
      else
      {
        MR_Word BranchesB_28 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Where0_12, (MR_Integer) 0))));
        MR_Word BranchesList_34;

        mercury__map__to_assoc_list_2_p_0((MR_Word) (&transform_hlds__unneeded_code__transform_hlds__unneeded_code__type_ctor_info_branch_point_0), (MR_Word) (&transform_hlds__unneeded_code_scalar_common_1[2]), BranchesA_27, &BranchesList_34);
        transform_hlds__unneeded_code__where_needed_branches_upper_bound_2_5_p_0(ContainingGoalMap_7, CurrentId_8, BranchesList_34, BranchesB_28, &Where_13);
      }
    }
  ...
  MR_Word * STATE_VARIABLE_WhereInfo_23)
{
  ...
  GoalExpr_52 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Goal_8, (MR_Integer) 0))));
  GoalInfo_53 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Goal_8, (MR_Integer) 1))));
  {
    MR_Word Detism_54;

    Detism_54 = hlds__hlds_goal__goal_info_get_determinism_1_f_0(GoalInfo_53);
    switch (Detism_54) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 4:
  ...
  {
    {
      ...
      Var_60 = hlds__hlds_goal__goal_info_get_purity_1_f_0(GoalInfo_53);
      succeeded = (Var_60 != (MR_Integer) 0);
    }
    if (!(succeeded))
    {
      {
        MR_Word Var_61 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Options_22, (MR_Integer) 0))) >> 2)) & (MR_Integer) 1);
      ...
      {
        {
          MR_Word BranchMap_55;
          MR_Word Var_62 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Options_22, (MR_Integer) 0))) >> 1)) & (MR_Integer) 1);
          MR_Word TypeCtorInfo_36_78;
          MR_Word TypeInfo_37_79;
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                BranchMap_55 = ((MR_Word) ((MR_hl_field(MR_mktag(1), STATE_VARIABLE_WhereInfo_26_26, (MR_Integer) 0))));
                TypeCtorInfo_36_78 = (MR_Word) (&transform_hlds__unneeded_code__transform_hlds__unneeded_code__type_ctor_info_branch_point_0);
                TypeInfo_37_79 = (MR_Word) (&transform_hlds__unneeded_code_scalar_common_1[2]);
                succeeded = mercury__map__is_empty_1_p_0(TypeCtorInfo_36_78, TypeInfo_37_79, BranchMap_55);
                succeeded = !(succeeded);
              }
            }
          }
        ...
        {
          {
            ...
            Var_90 = hlds__make_goal__true_goal_expr_0_f_0();
            succeeded = hlds__hlds_goal____Unify____hlds_goal_expr_0_0(GoalExpr_52, Var_90);
          }
          if (!(succeeded))
          {
            MR_Word TypeCtorInfo_38_80;
            MR_Word TypeInfo_39_81;
            MR_Word TypeCtorInfo_43_85;
            MR_Word BranchArms_56;
            MR_Word BranchArmCounts_57;
            MR_Integer BranchArmCount_58;
            MR_Word Var_63;
            MR_Word Var_64;
            MR_Integer Var_65;
            MR_Integer Var_66;
            MR_Word BranchMap_68;
            MR_Box conv4_BranchArmCount_58;

            succeeded = (STATE_VARIABLE_WhereInfo_26_26 != (MR_Word) ((MR_Unsigned) 0U));
            if (succeeded)
            {
              BranchMap_68 = ((MR_Word) ((MR_hl_field(MR_mktag(1), STATE_VARIABLE_WhereInfo_26_26, (MR_Integer) 0))));
              TypeCtorInfo_38_80 = (MR_Word) (&transform_hlds__unneeded_code__transform_hlds__unneeded_code__type_ctor_info_branch_point_0);
              TypeInfo_39_81 = (MR_Word) (&transform_hlds__unneeded_code_scalar_common_1[2]);
              mercury__map__values_2_p_0(TypeCtorInfo_38_80, TypeInfo_39_81, BranchMap_68, &BranchArms_56);
              Var_63 = (MR_Word) (&transform_hlds__unneeded_code_scalar_common_2[6]);
              TypeCtorInfo_43_85 = (MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0);
              mercury__list__map_3_p_0(TypeInfo_39_81, TypeCtorInfo_43_85, Var_63, BranchArms_56, &BranchArmCounts_57);
              Var_64 = (MR_Word) (&transform_hlds__unneeded_code_scalar_common_2[7]);
              Var_65 = (MR_Integer) 0;
              conv4_BranchArmCount_58 = mercury__list__foldl_3_f_0(TypeCtorInfo_43_85, TypeCtorInfo_43_85, Var_64, BranchArmCounts_57, ((MR_Box) (Var_65)));
              BranchArmCount_58 = ((MR_Integer) (conv4_BranchArmCount_58));
              Var_66 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), Options_22, (MR_Integer) 1))));
              succeeded = (BranchArmCount_58 > Var_66);
            }
          }
        }
      }
