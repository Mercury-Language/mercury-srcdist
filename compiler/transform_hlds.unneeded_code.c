...
{
  {
    ...
    if (succeeded)
    {
      mercury__map__map_values_only_3_p_0((MR_Word) (&transform_hlds__unneeded_code__transform_hlds__unneeded_code__type_ctor_info_where_needed_0), (MR_Word) (&transform_hlds__unneeded_code__transform_hlds__unneeded_code__type_ctor_info_where_needed_0), (MR_Word) (&transform_hlds__unneeded_code_scalar_common_1[0]), (MR_Word) (&transform_hlds__unneeded_code_scalar_common_2[9]), STATE_VARIABLE_WhereNeededMap_50_50, STATE_VARIABLE_WhereNeededMap_31);
    }
    else
