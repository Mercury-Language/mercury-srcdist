...
transform_hlds__unneeded_code__IntroducedFrom__pred__unneeded_process_proc__359__1_1_p_0(
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = transform_hlds__unneeded_code__IntroducedFrom__pred__unneeded_process_proc__359__1_1_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))));
  return succeeded;
}
  ...
  MR_Box * wrapper_arg_3)
{
  ...
  transform_hlds__unneeded_code__IntroducedFrom__pred__unneeded_process_proc__312__1_3_p_0(((MR_Word) (wrapper_arg_1)), ((MR_Word) (wrapper_arg_2)), &conv0_LambdaHeadVar__3_68);
    ...
    case (MR_Integer) 1:
      {
        ...
        if ((DebugPredNames_40 == (MR_Word) ((MR_Unsigned) 0U)))
        {
          ...
          mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&transform_hlds__unneeded_code_scalar_common_3[0]), Pass_11, &Var_258);
        ...
        else
        {
          ...
          if (succeeded)
          {
            ...
            mercury__io__write_string_4_p_0(Stream_37, (MR_String) "% Starting unneededed code pass ");
            mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&transform_hlds__unneeded_code_scalar_common_3[0]), Pass_11, &Var_247);
    ...
    case (MR_Integer) 1:
      {
        ...
        check_hlds__recompute_instmap_deltas__recompute_instmap_delta_8_p_0((MR_Integer) 1, VarTypes_57, InstVarSet_52, InitInstMap_17, Goal3_55, &Goal_59, STATE_VARIABLE_ModuleInfo_0_63, &STATE_VARIABLE_ModuleInfo_98_98);
        hlds__hlds_pred__proc_info_set_goal_3_p_0(Goal_59, STATE_VARIABLE_ProcInfo_65_65, &STATE_VARIABLE_ProcInfo_99_99);
        hlds__hlds_pred__proc_info_set_varset_vartypes_4_p_0(VarSet_56, VarTypes_57, STATE_VARIABLE_ProcInfo_99_99, &STATE_VARIABLE_ProcInfo_100_100);
        hlds__hlds_pred__proc_info_set_rtti_varmaps_3_p_0(RttiVarMaps_58, STATE_VARIABLE_ProcInfo_100_100, &STATE_VARIABLE_ProcInfo_101_101);
        succeeded = (Pass_11 > (MR_Integer) 3);
        if (succeeded)
        {
          *STATE_VARIABLE_ModuleInfo_64 = STATE_VARIABLE_ModuleInfo_98_98;
          *STATE_VARIABLE_ProcInfo_62 = STATE_VARIABLE_ProcInfo_101_101;
        }
        else
        {
          ...
          transform_hlds__unneeded_code__unneeded_process_proc_7_p_0(STATE_VARIABLE_ProcInfo_101_101, STATE_VARIABLE_ProcInfo_62, STATE_VARIABLE_ModuleInfo_98_98, STATE_VARIABLE_ModuleInfo_64, PredId_10, Var_105, &Var_60);
        }
