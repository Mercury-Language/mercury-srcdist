...
{
  {
    ...
    {
      libs__globals__lookup_bool_option_3_p_0(transform_hlds__unneeded_code__Globals_29, (MR_Integer) 170, &transform_hlds__unneeded_code__ReorderConj_30);
    }
    {
      libs__globals__lookup_bool_option_3_p_0(transform_hlds__unneeded_code__Globals_29, (MR_Integer) 172, &transform_hlds__unneeded_code__FullyStrict_31);
    }
    {
