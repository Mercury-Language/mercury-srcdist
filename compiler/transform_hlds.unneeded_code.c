...
transform_hlds__unneeded_code__unneeded_process_proc_7_p_0(
  MR_Word STATE_VARIABLE_ProcInfo_0_59,
  MR_Word * STATE_VARIABLE_ProcInfo_60,
...
transform_hlds__unneeded_code__unneeded_process_goal_11_p_0(
  ...
  MR_Word InitInstMap_15,
  MR_Word FinalInstMap_16,
  MR_Word STATE_VARIABLE_WhereNeededMap_0_30,
  MR_Word * STATE_VARIABLE_WhereNeededMap_31,
  MR_Word STATE_VARIABLE_RefinedGoals_0_32,
  MR_Word * STATE_VARIABLE_RefinedGoals_33,
...
static /* final */ const MR_Box transform_hlds__unneeded_code_scalar_common_3[2][9];

static /* final */ const MR_Box transform_hlds__unneeded_code_scalar_common_4[2][5];

static /* final */ const MR_Box transform_hlds__unneeded_code_scalar_common_5[3][6];

static /* final */ const MR_Box transform_hlds__unneeded_code_scalar_common_6[1][7];

static /* final */ const MR_Box transform_hlds__unneeded_code_scalar_common_7[1][1];
...
static /* final */ const MR_Box transform_hlds__unneeded_code_scalar_common_2[15][3] = {
  ...
  /* row 7 */
  {
    ((MR_Box) (&transform_hlds__unneeded_code_scalar_common_4[0])),
  ...
  /* row 9 */
  {
    ((MR_Box) (&transform_hlds__unneeded_code_scalar_common_5[2])),
    ((MR_Box) (transform_hlds__unneeded_code__undemand_virgin_outputs_5_p_0_2)),
    ((MR_Box) (MR_Word) ((MR_Integer) 0))
  },
  /* row 10 */
  {
    ((MR_Box) (&transform_hlds__unneeded_code_scalar_common_4[1])),
...
{
  {
    ...
    succeeded = mercury__map__is_empty_1_p_0((MR_Word) &transform_hlds__unneeded_code_scalar_common_2[1], (MR_Word) &transform_hlds__unneeded_code_scalar_common_1[1], RefinedGoals_48);
    return succeeded;
  }
}
...
{
  {
    mercury__map__det_insert_4_p_0((MR_Word) &transform_hlds__unneeded_code_scalar_common_1[0], (MR_Word) &transform_hlds__unneeded_code__transform_hlds__unneeded_code__type_ctor_info_where_needed_0, ((MR_Box) (LambdaHeadVar__1_64)), ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))), LambdaHeadVar__2_65, LambdaHeadVar__3_66);
  }
}
...
{
  {
    ...
    mercury__builtin__compare_3_p_0((MR_Word) &transform_hlds__unneeded_code_scalar_common_2[6], HeadVar__1_1, ((MR_Box) (Cast_HeadVar1_4)), ((MR_Box) (Cast_HeadVar2_5)));
  }
}
...
{
  {
    ...
    succeeded = mercury__builtin__unify_2_p_0((MR_Word) &transform_hlds__unneeded_code_scalar_common_2[6], ((MR_Box) (Cast_HeadVar1_3)), ((MR_Box) (Cast_HeadVar2_4)));
    return succeeded;
  }
}
...
{
  {
    ...
    else
    {
      ...
      else
      {
        ...
        mercury__builtin__compare_3_p_0((MR_Word) &transform_hlds__unneeded_code_scalar_common_2[6], HeadVar__1_1, ((MR_Box) (Var_11)), ((MR_Box) (ArgY1_7)));
      }
    }
  }
}
...
{
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        TypeInfo_9_9 = (MR_Word) &transform_hlds__unneeded_code_scalar_common_2[6];
...
{
  {
    ...
    else
    {
      ...
      else
      {
        ...
        mercury__builtin__compare_3_p_0((MR_Word) &transform_hlds__unneeded_code_scalar_common_2[4], &Var_13, ((MR_Box) (ArgX2_6)), ((MR_Box) (ArgY2_7)));
        ...
        else
        {
          ...
          transform_hlds__unneeded_code____Compare____uc_option_values_0_0(&Var_14, ArgX3_8, ArgY3_9);
          ...
          {
            mercury__builtin__compare_3_p_0((MR_Word) &transform_hlds__unneeded_code_scalar_common_2[5], HeadVar__1_1, ((MR_Box) (ArgX4_10)), ((MR_Box) (ArgY4_11)));
          }
        }
      }
    }
...
{
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        TypeInfo_14_14 = (MR_Word) &transform_hlds__unneeded_code_scalar_common_2[4];
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            TypeInfo_15_15 = (MR_Word) &transform_hlds__unneeded_code_scalar_common_2[5];
...
{
  {
    ...
    else
    {
      ...
      transform_hlds__unneeded_code____Compare____branch_point_0_0(&Var_8, ArgX1_4, ArgY1_5);
    ...
    else
    {
      ...
      if (succeeded)
        *HeadVar__1_1 = Var_8;
        ...
        transform_hlds__unneeded_code____Compare____branch_alts_0_0(HeadVar__1_1, ArgX2_6, ArgY2_7);
    }
  }
}
...
{
  {
    ...
    else
    {
      ...
      hlds__hlds_goal____Compare____hlds_goal_0_0(&Var_10, ArgX1_4, ArgY1_5);
      ...
      else
      {
        ...
        hlds__instmap____Compare____instmap_0_0(&Var_11, ArgX2_6, ArgY2_7);
        succeeded = (Var_11 == (MR_Integer) 0);
        succeeded = !(succeeded);
        if (succeeded)
          *HeadVar__1_1 = Var_11;
        else
          hlds__instmap____Compare____instmap_0_0(HeadVar__1_1, ArgX3_8, ArgY3_9);
      }
    }
  }
}
...
{
  {
    ...
    if (succeeded)
      if ((Where_12 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
        *STATE_VARIABLE_WhereInfo_14 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
      else
      {
        MR_Word BranchesA_23 = ((MR_Word) (MR_hl_field(MR_mktag(1), Where_12, (MR_Integer) 0)));

        if ((STATE_VARIABLE_WhereInfo_0_13 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
          *STATE_VARIABLE_WhereInfo_14 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
        else
        {
...
{
  {
    ...
    {
      Key_10 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
    ...
    if (succeeded)
    {
      ...
      {
        Goals_12 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
...
{
  {
    ...
    MR_Word Var_14;
    MR_Word Var_10 = ((MR_Word) (MR_hl_field(MR_mktag(0), BranchPoint_6, (MR_Integer) 1)));
    MR_Box conv1_STATE_VARIABLE_RefinedGoals_13;

    mercury__set__to_sorted_list_2_p_0(TypeCtorInfo_16_16, BranchNumSet_7, &BranchNums_11);
    {
    ...
    mercury__list__foldl_4_p_0(TypeCtorInfo_16_16, (MR_Word) &transform_hlds__unneeded_code_scalar_common_2[3], Var_14, BranchNums_11, ((MR_Box) (STATE_VARIABLE_RefinedGoals_0_12)), &conv1_STATE_VARIABLE_RefinedGoals_13);
...
{
  {
    ...
    MR_Word STATE_VARIABLE_ProcInfo_17_43;
    MR_Word STATE_VARIABLE_ProcInfo_18_44;
    MR_Word STATE_VARIABLE_ProcInfo_19_45;
    MR_Word _Warnings_37;
    MR_Integer Var_11;

    hlds__passes_aux__write_proc_progress_message_5_p_0((MR_String) "% Removing dead code in ", PredProcId_6, STATE_VARIABLE_ModuleInfo_0_15);
    hlds__hlds_pred__proc_info_get_headvars_2_p_0(STATE_VARIABLE_ProcInfo_0_13, &HeadVars_32);
    hlds__hlds_pred__proc_info_get_goal_2_p_0(STATE_VARIABLE_ProcInfo_0_13, &Goal0_33);
    hlds__hlds_pred__proc_info_get_varset_2_p_0(STATE_VARIABLE_ProcInfo_0_13, &VarSet0_34);
    hlds__hlds_pred__proc_info_get_vartypes_2_p_0(STATE_VARIABLE_ProcInfo_0_13, &VarTypes0_35);
    hlds__hlds_pred__proc_info_get_rtti_varmaps_2_p_0(STATE_VARIABLE_ProcInfo_0_13, &RttiVarMaps0_36);
    hlds__quantification__implicitly_quantify_clause_body_general_11_p_0((MR_Integer) 1, HeadVars_32, &_Warnings_37, Goal0_33, &Goal_38, VarSet0_34, &VarSet_39, VarTypes0_35, &VarTypes_40, RttiVarMaps0_36, &RttiVarMaps_41);
    hlds__hlds_pred__proc_info_set_goal_3_p_0(Goal_38, STATE_VARIABLE_ProcInfo_0_13, &STATE_VARIABLE_ProcInfo_17_43);
    hlds__hlds_pred__proc_info_set_varset_3_p_0(VarSet_39, STATE_VARIABLE_ProcInfo_17_43, &STATE_VARIABLE_ProcInfo_18_44);
    hlds__hlds_pred__proc_info_set_vartypes_3_p_0(VarTypes_40, STATE_VARIABLE_ProcInfo_18_44, &STATE_VARIABLE_ProcInfo_19_45);
    hlds__hlds_pred__proc_info_set_rtti_varmaps_3_p_0(RttiVarMaps_41, STATE_VARIABLE_ProcInfo_19_45, &STATE_VARIABLE_ProcInfo_20_20);
    PredId_10 = ((MR_Word) (MR_hl_field(MR_mktag(0), PredProcId_6, (MR_Integer) 0)));
    Var_11 = ((MR_Integer) (MR_hl_field(MR_mktag(0), PredProcId_6, (MR_Integer) 1)));
    transform_hlds__unneeded_code__unneeded_process_proc_7_p_0(STATE_VARIABLE_ProcInfo_20_20, STATE_VARIABLE_ProcInfo_14, STATE_VARIABLE_ModuleInfo_0_15, STATE_VARIABLE_ModuleInfo_16, PredId_10, (MR_Integer) 1, &Successful_12);
    switch (Successful_12) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        {
          hlds__passes_aux__write_proc_progress_message_5_p_0((MR_String) "% none found.\n", PredProcId_6, *STATE_VARIABLE_ModuleInfo_16);
        }
        break;
      case (MR_Integer) 1:
        {
...
{
  {
    ...
    succeeded = transform_hlds__unneeded_code__IntroducedFrom__pred__unneeded_process_proc__370__1_1_p_0(((MR_Word) (MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3))));
    return succeeded;
  }
}
  ...
  MR_Box * wrapper_arg_3)
{
  {
    MR_Box closure = closure_arg;
    MR_Word conv0_LambdaHeadVar__3_66;

    transform_hlds__unneeded_code__IntroducedFrom__pred__unneeded_process_proc__326__1_3_p_0(((MR_Word) wrapper_arg_1), ((MR_Word) wrapper_arg_2), &conv0_LambdaHeadVar__3_66);
    *wrapper_arg_3 = ((MR_Box) (conv0_LambdaHeadVar__3_66));
  }
}
...
{
  {
    ...
    MR_Word Debug_33;
    MR_Word Options_34;
    MR_Word UnneededInfo_42;
    MR_Word Goal1_43;
    MR_Word RefinedGoals1_45;
    MR_Word Changed_46;
    MR_Word Goal2_47;
    MR_Word RefinedGoals_48;
    ...
    hlds__goal_path__fill_goal_id_slots_in_proc_4_p_0(STATE_VARIABLE_ModuleInfo_0_61, &ContainingGoalMap_13, STATE_VARIABLE_ProcInfo_0_59, &STATE_VARIABLE_ProcInfo_63_63);
    hlds__hlds_pred__proc_info_get_goal_2_p_0(STATE_VARIABLE_ProcInfo_63_63, &Goal0_14);
    hlds__hlds_pred__proc_info_get_varset_2_p_0(STATE_VARIABLE_ProcInfo_63_63, &VarSet0_15);
    hlds__hlds_pred__proc_info_get_vartypes_2_p_0(STATE_VARIABLE_ProcInfo_63_63, &VarTypes0_16);
    hlds__hlds_pred__proc_info_get_initial_instmap_3_p_0(STATE_VARIABLE_ProcInfo_63_63, STATE_VARIABLE_ModuleInfo_0_61, &InitInstMap_17);
    Var_18 = ((MR_Word) (MR_hl_field(MR_mktag(0), Goal0_14, (MR_Integer) 0)));
    ...
    hlds__instmap__apply_instmap_delta_3_p_0(InitInstMap_17, InstMapDelta_20, &FinalInstMap_21);
    hlds__hlds_pred__proc_info_instantiated_head_vars_3_p_0(STATE_VARIABLE_ModuleInfo_0_61, STATE_VARIABLE_ProcInfo_63_63, &NeededVarsList_22);
    TypeInfo_110_110 = (MR_Word) &transform_hlds__unneeded_code_scalar_common_1[0];
    mercury__map__init_1_p_0(TypeInfo_110_110, (MR_Word) &transform_hlds__unneeded_code__transform_hlds__unneeded_code__type_ctor_info_where_needed_0, &WhereNeededMap0_23);
    mercury__list__foldl_4_p_0(TypeInfo_110_110, (MR_Word) &transform_hlds__unneeded_code_scalar_common_2[0], (MR_Word) &transform_hlds__unneeded_code_scalar_common_2[14], NeededVarsList_22, ((MR_Box) (WhereNeededMap0_23)), &conv1_WhereNeededMap1_28);
    WhereNeededMap1_28 = ((MR_Word) conv1_WhereNeededMap1_28);
    hlds__hlds_module__module_info_get_globals_2_p_0(STATE_VARIABLE_ModuleInfo_0_61, &Globals_29);
    libs__globals__lookup_bool_option_3_p_0(Globals_29, (MR_Integer) 176, &ReorderConj_30);
    libs__globals__lookup_bool_option_3_p_0(Globals_29, (MR_Integer) 178, &FullyStrict_31);
    libs__globals__lookup_int_option_3_p_0(Globals_29, (MR_Integer) 364, &Limit_32);
    libs__globals__lookup_bool_option_3_p_0(Globals_29, (MR_Integer) 365, &Debug_33);
    {
      Options_34 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), Options_34, 0) = ((MR_Box) (FullyStrict_31));
      MR_hl_field(MR_mktag(0), Options_34, 1) = ((MR_Box) (ReorderConj_30));
      MR_hl_field(MR_mktag(0), Options_34, 2) = ((MR_Box) (Limit_32));
      MR_hl_field(MR_mktag(0), Options_34, 3) = ((MR_Box) (Debug_33));
    }
    switch (Debug_33) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
      ...
      case (MR_Integer) 1:
        {
          ...
          MR_Word DebugPredNames_38;

          hlds__hlds_module__module_info_pred_info_3_p_0(STATE_VARIABLE_ModuleInfo_0_61, PredId_10, &PredInfo_36);
          PredName_37 = hlds__hlds_pred__pred_info_name_1_f_0(PredInfo_36);
          libs__globals__lookup_accumulating_option_3_p_0(Globals_29, (MR_Integer) 366, &DebugPredNames_38);
          if ((DebugPredNames_38 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
          {
            MR_String Var_134;

            mercury__io__write_string_3_p_0((MR_String) "% Starting unneededed code pass ");
            mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) &transform_hlds__unneeded_code_scalar_common_7[0], Pass_11, &Var_134);
            mercury__io__write_string_3_p_0(Var_134);
            mercury__io__write_string_3_p_0((MR_String) "\n");
          }
          else
          {
            succeeded = mercury__list__member_2_p_0((MR_Word) &mercury__builtin__builtin__type_ctor_info_string_0, ((MR_Box) (PredName_37)), DebugPredNames_38);
            if (succeeded)
            {
              MR_Word OutInfo_41;
              MR_String Var_123;
              ...
              mercury__io__write_string_3_p_0((MR_String) "% Starting unneededed code pass ");
              mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) &transform_hlds__unneeded_code_scalar_common_7[0], Pass_11, &Var_123);
              mercury__io__write_string_3_p_0(Var_123);
              mercury__io__write_string_3_p_0((MR_String) "\n");
              OutInfo_41 = hlds__hlds_out__hlds_out_util__init_hlds_out_info_2_f_0(Globals_29, (MR_Integer) 1);
              hlds__hlds_out__hlds_out_goal__write_goal_9_p_0(OutInfo_41, STATE_VARIABLE_ModuleInfo_0_61, VarSet0_15, (MR_Integer) 1, (MR_Integer) 0, (MR_String) ".\n", Goal0_14);
            }
            else
            {
            }
    ...
    {
      UnneededInfo_42 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), UnneededInfo_42, 0) = ((MR_Box) (STATE_VARIABLE_ModuleInfo_0_61));
      MR_hl_field(MR_mktag(0), UnneededInfo_42, 1) = ((MR_Box) (VarTypes0_16));
      MR_hl_field(MR_mktag(0), UnneededInfo_42, 2) = ((MR_Box) (Options_34));
      MR_hl_field(MR_mktag(0), UnneededInfo_42, 3) = ((MR_Box) (ContainingGoalMap_13));
    }
    Var_89 = mercury__map__init_0_f_0((MR_Word) &transform_hlds__unneeded_code_scalar_common_2[1], (MR_Word) &transform_hlds__unneeded_code_scalar_common_1[1]);
    transform_hlds__unneeded_code__unneeded_process_goal_11_p_0(UnneededInfo_42, Goal0_14, &Goal1_43, InitInstMap_17, FinalInstMap_21, WhereNeededMap1_28, &Var_44, Var_89, &RefinedGoals1_45, (MR_Integer) 0, &Changed_46);
    transform_hlds__unneeded_code__unneeded_refine_goal_4_p_0(Goal1_43, &Goal2_47, RefinedGoals1_45, &RefinedGoals_48);
    {
      Var_91 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), Var_91, 0) = ((MR_Box) (&transform_hlds__unneeded_code_scalar_common_8[0]));
      MR_hl_field(MR_mktag(0), Var_91, 1) = ((MR_Box) (transform_hlds__unneeded_code__unneeded_process_proc_7_p_0_2));
      MR_hl_field(MR_mktag(0), Var_91, 2) = ((MR_Box) (MR_Word) ((MR_Integer) 1));
      MR_hl_field(MR_mktag(0), Var_91, 3) = ((MR_Box) (RefinedGoals_48));
    }
    mercury__require__expect_4_p_0(Var_91, (MR_String) "transform_hlds.unneeded_code", (MR_String) "predicate \140transform_hlds.unneeded_code.unneeded_process_proc\'/7", (MR_String) "goal reattachment unsuccessful");
    switch (Changed_46) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        {
          *Successful_12 = (MR_Integer) 0;
          *STATE_VARIABLE_ProcInfo_60 = STATE_VARIABLE_ProcInfo_63_63;
      ...
      case (MR_Integer) 1:
        {
          ...
          hlds__hlds_pred__proc_info_get_headvars_2_p_0(STATE_VARIABLE_ProcInfo_63_63, &HeadVars_49);
          hlds__hlds_pred__proc_info_get_inst_varset_2_p_0(STATE_VARIABLE_ProcInfo_63_63, &InstVarSet_50);
          hlds__hlds_pred__proc_info_get_rtti_varmaps_2_p_0(STATE_VARIABLE_ProcInfo_63_63, &RttiVarMaps0_51);
          hlds__quantification__implicitly_quantify_clause_body_general_11_p_0((MR_Integer) 1, HeadVars_49, &_Warnings_52, Goal2_47, &Goal3_53, VarSet0_15, &VarSet_54, VarTypes0_16, &VarTypes_55, RttiVarMaps0_51, &RttiVarMaps_56);
          check_hlds__mode_util__recompute_instmap_delta_8_p_0((MR_Integer) 1, Goal3_53, &Goal_57, VarTypes_55, InstVarSet_50, InitInstMap_17, STATE_VARIABLE_ModuleInfo_0_61, &STATE_VARIABLE_ModuleInfo_97_97);
          hlds__hlds_pred__proc_info_set_goal_3_p_0(Goal_57, STATE_VARIABLE_ProcInfo_63_63, &STATE_VARIABLE_ProcInfo_98_98);
          hlds__hlds_pred__proc_info_set_varset_3_p_0(VarSet_54, STATE_VARIABLE_ProcInfo_98_98, &STATE_VARIABLE_ProcInfo_99_99);
          hlds__hlds_pred__proc_info_set_vartypes_3_p_0(VarTypes_55, STATE_VARIABLE_ProcInfo_99_99, &STATE_VARIABLE_ProcInfo_100_100);
          hlds__hlds_pred__proc_info_set_rtti_varmaps_3_p_0(RttiVarMaps_56, STATE_VARIABLE_ProcInfo_100_100, &STATE_VARIABLE_ProcInfo_101_101);
          succeeded = (Pass_11 > (MR_Integer) 3);
          if (succeeded)
          {
            *STATE_VARIABLE_ModuleInfo_62 = STATE_VARIABLE_ModuleInfo_97_97;
            *STATE_VARIABLE_ProcInfo_60 = STATE_VARIABLE_ProcInfo_101_101;
          }
          else
          {
            MR_Integer Var_105 = (Pass_11 + (MR_Integer) 1);
            MR_Word Var_58;

            transform_hlds__unneeded_code__unneeded_process_proc_7_p_0(STATE_VARIABLE_ProcInfo_101_101, STATE_VARIABLE_ProcInfo_60, STATE_VARIABLE_ModuleInfo_97_97, STATE_VARIABLE_ModuleInfo_62, PredId_10, Var_105, &Var_58);
          }
...
{
  {
    ...
    if (succeeded)
    {
      ...
      Var_49 = ((MR_Word) (MR_hl_field(MR_mktag(0), Then1_18, (MR_Integer) 0)));
    ...
    if (succeeded)
    {
      ...
      Var_58 = ((MR_Word) (MR_hl_field(MR_mktag(0), Else1_19, (MR_Integer) 0)));
...
{
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        Var_38 = ((MR_Word) (MR_hl_field(MR_mktag(0), Goal1_19, (MR_Integer) 0)));
      ...
      Var_28 = (BranchNum_6 + (MR_Integer) 1);
...
{
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        Var_42 = ((MR_Word) (MR_hl_field(MR_mktag(0), Goal1_22, (MR_Integer) 0)));
      ...
      Var_32 = (BranchNum_6 + (MR_Integer) 1);
...
{
  {
    ...
    else
    {
      ...
      Var_15 = ((MR_Word) (MR_hl_field(MR_mktag(0), HeadGoal_12, (MR_Integer) 1)));
...
{
  {
    ...
    switch (MR_tag((MR_Word) GoalExpr0_8)) {
      ...
      case (MR_Integer) 0:
        {
          MR_Word NegGoal0_51 = (MR_Word) MR_body(((MR_Word) GoalExpr0_8), (MR_Integer) 0);
          MR_Word NegGoal_52;
          MR_Word GoalExpr_77;
          ...
          GoalExpr_77 = (MR_Word) MR_mkword(MR_mktag(0), (MR_Word) NegGoal_52);
          {
            MR_Word base;
          ...
          case (MR_Integer) 3:
            {
              ...
              GoalId_74 = hlds__hlds_goal__goal_info_get_goal_id_1_f_0(GoalInfo0_9);
              transform_hlds__unneeded_code__unneeded_refine_disj_6_p_0(Disjuncts0_42, &Disjuncts_43, STATE_VARIABLE_RefinedGoals_0_58, STATE_VARIABLE_RefinedGoals_59, GoalId_74, (MR_Integer) 1);
              {
                GoalExpr_73 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), GoalExpr_73, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 3));
                MR_hl_field(MR_mktag(3), GoalExpr_73, 1) = ((MR_Box) (Disjuncts_43));
              }
              {
                MR_Word base;
                base = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
          ...
          case (MR_Integer) 4:
            {
              ...
              transform_hlds__unneeded_code__unneeded_refine_cases_6_p_0(Cases0_39, &Cases_41, STATE_VARIABLE_RefinedGoals_0_58, STATE_VARIABLE_RefinedGoals_59, GoalId_40, (MR_Integer) 1);
              {
                ...
                MR_hl_field(MR_mktag(3), GoalExpr_72, 1) = ((MR_Box) (SwitchVar_37));
                MR_hl_field(MR_mktag(3), GoalExpr_72, 2) = ((MR_Box) (CanFail_38));
                MR_hl_field(MR_mktag(3), GoalExpr_72, 3) = ((MR_Box) (Cases_41));
              }
              {
                MR_Word base;
                base = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
          ...
          case (MR_Integer) 5:
            {
              ...
              if (succeeded)
              {
                Var_55 = ((MR_Word) (MR_hl_field(MR_mktag(3), Reason_53, (MR_Integer) 1)));
                Var_63 = ((MR_Word) (MR_hl_field(MR_mktag(3), Reason_53, (MR_Integer) 2)));
              ...
              else
              {
                ...
                transform_hlds__unneeded_code__unneeded_refine_goal_4_p_0(SomeGoal0_54, &SomeGoal_56, STATE_VARIABLE_RefinedGoals_0_58, STATE_VARIABLE_RefinedGoals_59);
                {
                  ...
                  MR_hl_field(MR_mktag(3), GoalExpr_78, 1) = ((MR_Box) (Reason_53));
                  MR_hl_field(MR_mktag(3), GoalExpr_78, 2) = ((MR_Box) (SomeGoal_56));
                }
                {
                  MR_Word base;
                  base = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
          ...
          case (MR_Integer) 6:
            {
              ...
              GoalId_76 = hlds__hlds_goal__goal_info_get_goal_id_1_f_0(GoalInfo0_9);
              transform_hlds__unneeded_code__unneeded_refine_ite_9_p_0(Cond0_45, &Cond_48, Then0_46, &Then_49, Else0_47, &Else_50, STATE_VARIABLE_RefinedGoals_0_58, STATE_VARIABLE_RefinedGoals_59, GoalId_76);
              {
                GoalExpr_75 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 5 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), GoalExpr_75, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 6));
                MR_hl_field(MR_mktag(3), GoalExpr_75, 1) = ((MR_Box) (Quant_44));
                MR_hl_field(MR_mktag(3), GoalExpr_75, 2) = ((MR_Box) (Cond_48));
                MR_hl_field(MR_mktag(3), GoalExpr_75, 3) = ((MR_Box) (Then_49));
                MR_hl_field(MR_mktag(3), GoalExpr_75, 4) = ((MR_Box) (Else_50));
              }
              {
                MR_Word base;
                base = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
...
{
  {
    ...
    MR_Word Var_32 = ((MR_Word) (MR_hl_field(MR_mktag(0), Cond0_19, (MR_Integer) 0)));
    MR_Word Var_60;
    MR_Word Var_61;
    MR_Word Var_62;

    InstMapDelta_34 = hlds__hlds_goal__goal_info_get_instmap_delta_1_f_0(CondInfo0_33);
    hlds__instmap__apply_instmap_delta_3_p_0(InitInstMap_26, InstMapDelta_34, &InstMapCond_35);
    ...
    Var_60 = ((MR_Word) (MR_hl_field(MR_mktag(0), UnneededInfo_18, (MR_Integer) 0)));
    Var_61 = ((MR_Word) (MR_hl_field(MR_mktag(0), UnneededInfo_18, (MR_Integer) 1)));
    Var_62 = ((MR_Word) (MR_hl_field(MR_mktag(0), UnneededInfo_18, (MR_Integer) 2)));
    ContainingGoalMap_38 = ((MR_Word) (MR_hl_field(MR_mktag(0), UnneededInfo_18, (MR_Integer) 3)));
    TypeInfo_63_63 = (MR_Word) &transform_hlds__unneeded_code_scalar_common_1[0];
    TypeCtorInfo_64_64 = (MR_Word) &transform_hlds__unneeded_code__transform_hlds__unneeded_code__type_ctor_info_where_needed_0;
    mercury__map__init_1_p_0(TypeInfo_63_63, TypeCtorInfo_64_64, &BranchNeededMap0_39);
    mercury__map__to_assoc_list_2_p_0(TypeInfo_63_63, TypeCtorInfo_64_64, WhereNeededMapElse_36, &WhereNeededListElse_40);
    ...
    mercury__map__to_assoc_list_2_p_0(TypeInfo_63_63, TypeCtorInfo_64_64, WhereNeededMapThen_37, &WhereNeededListThen_42);
  ...
  MR_Word * STATE_VARIABLE_Changed_15)
{
  ...
  else
  {
    ...
    {
      Case_35 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL);
    ...
    Var_67 = ((MR_Word) (MR_hl_field(MR_mktag(0), UnneededInfo_1, (MR_Integer) 0)));
    Var_68 = ((MR_Word) (MR_hl_field(MR_mktag(0), UnneededInfo_1, (MR_Integer) 1)));
    Var_69 = ((MR_Word) (MR_hl_field(MR_mktag(0), UnneededInfo_1, (MR_Integer) 2)));
    ...
    Var_62 = (BranchNum_5 + (MR_Integer) 1);
  ...
  MR_Word * STATE_VARIABLE_Changed_13)
{
  ...
  else
  {
    ...
    Var_55 = ((MR_Word) (MR_hl_field(MR_mktag(0), UnneededInfo_1, (MR_Integer) 0)));
    Var_56 = ((MR_Word) (MR_hl_field(MR_mktag(0), UnneededInfo_1, (MR_Integer) 1)));
    Var_57 = ((MR_Word) (MR_hl_field(MR_mktag(0), UnneededInfo_1, (MR_Integer) 2)));
...
{
  {
    ...
    else
    {
      ...
      Var_32 = ((MR_Word) (MR_hl_field(MR_mktag(0), Goal1_30, (MR_Integer) 1)));
...
{
  {
    ...
    switch (MR_tag((MR_Word) GoalExpr0_20)) {
      ...
      case (MR_Integer) 0:
        {
          MR_Word NegGoal0_81 = (MR_Word) MR_body(((MR_Word) GoalExpr0_20), (MR_Integer) 0);
          MR_Word NegGoal_82;
          ...
          GoalExpr_142 = (MR_Word) MR_mkword(MR_mktag(0), (MR_Word) NegGoal_82);
          {
            MR_Word base;
            base = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
            *Goal_14 = base;
      ...
      case (MR_Integer) 2:
        {
          *Goal_14 = Goal0_13;
          transform_hlds__unneeded_code__demand_inputs_6_p_0(UnneededInfo_12, *Goal_14, InitInstMap_15, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), STATE_VARIABLE_WhereNeededMap_0_88, STATE_VARIABLE_WhereNeededMap_89);
      ...
      case (MR_Integer) 3:
        switch (((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), GoalExpr0_20, (MR_Integer) 0)))) {
          ...
          case (MR_Integer) 2:
            {
              MR_Word ConjType_45 = ((MR_Word) (MR_hl_field(MR_mktag(3), GoalExpr0_20, (MR_Integer) 1)));
                ...
                case (MR_Integer) 0:
                  {
                    ...
                    {
                      GoalExpr_48 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL));
                      MR_hl_field(MR_mktag(3), GoalExpr_48, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 2));
                      MR_hl_field(MR_mktag(3), GoalExpr_48, 1) = ((MR_Box) ((MR_Integer) 0));
          ...
          case (MR_Integer) 3:
            {
              ...
              MR_Word STATE_VARIABLE_WhereNeededMap_111_111;
              MR_Word GoalExpr_137;
              MR_Word GoalId_138;

              GoalId_138 = hlds__hlds_goal__goal_info_get_goal_id_1_f_0(GoalInfo0_21);
              TypeCtorInfo_157_157 = (MR_Word) &transform_hlds__unneeded_code__transform_hlds__unneeded_code__type_ctor_info_where_needed_0;
              mercury__map__map_values_only_3_p_0(TypeCtorInfo_157_157, TypeCtorInfo_157_157, (MR_Word) &transform_hlds__unneeded_code_scalar_common_1[0], (MR_Word) &transform_hlds__unneeded_code_scalar_common_2[11], STATE_VARIABLE_WhereNeededMap_0_88, &STATE_VARIABLE_WhereNeededMap_111_111);
              transform_hlds__unneeded_code__unneeded_process_disj_13_p_0(UnneededInfo_12, Disjuncts0_72, &Disjuncts_73, InitInstMap_15, FinalInstMap_16, GoalId_138, STATE_VARIABLE_WhereNeededMap_111_111, STATE_VARIABLE_WhereNeededMap_111_111, STATE_VARIABLE_WhereNeededMap_89, STATE_VARIABLE_RefinedGoals_0_90, STATE_VARIABLE_RefinedGoals_91, STATE_VARIABLE_Changed_0_92, STATE_VARIABLE_Changed_93);
              {
                GoalExpr_137 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), GoalExpr_137, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 3));
                MR_hl_field(MR_mktag(3), GoalExpr_137, 1) = ((MR_Box) (Disjuncts_73));
              }
              {
                MR_Word base;
                base = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
          ...
          case (MR_Integer) 4:
            {
              ...
              MR_Word CanFail_50 = ((MR_Word) (MR_hl_field(MR_mktag(3), GoalExpr0_20, (MR_Integer) 2)));
              ...
              MR_Word Var_119;
              MR_Word STATE_VARIABLE_WhereNeededMap_121_121;
              MR_Word STATE_VARIABLE_WhereNeededMap_125_125;
              MR_Word GoalExpr_136;
              MR_Word Var_146 = ((MR_Word) (MR_hl_field(MR_mktag(0), UnneededInfo_12, (MR_Integer) 0)));
              MR_Word Var_147 = ((MR_Word) (MR_hl_field(MR_mktag(0), UnneededInfo_12, (MR_Integer) 1)));
              MR_Word Var_148 = ((MR_Word) (MR_hl_field(MR_mktag(0), UnneededInfo_12, (MR_Integer) 2)));
              ...
              MR_Word _ContainingGoalId_62;
              MR_Integer Var_64;

              succeeded = ((MR_tag((MR_Word) Cases0_51)) == (MR_mktag((MR_Integer) 1)));
              if (succeeded)
              {
                FirstCase0_53 = ((MR_Word) (MR_hl_field(MR_mktag(1), Cases0_51, (MR_Integer) 0)));
                Var_54 = ((MR_Word) (MR_hl_field(MR_mktag(1), Cases0_51, (MR_Integer) 1)));
                Var_55 = ((MR_Word) (MR_hl_field(MR_mktag(0), FirstCase0_53, (MR_Integer) 0)));
                Var_56 = ((MR_Word) (MR_hl_field(MR_mktag(0), FirstCase0_53, (MR_Integer) 1)));
                FirstCaseGoal0_57 = ((MR_Word) (MR_hl_field(MR_mktag(0), FirstCase0_53, (MR_Integer) 2)));
                Var_58 = ((MR_Word) (MR_hl_field(MR_mktag(0), FirstCaseGoal0_57, (MR_Integer) 0)));
                ...
                TypeCtorInfo_149_149 = (MR_Word) &mdbcomp__goal_path__mdbcomp__goal_path__type_ctor_info_goal_id_0;
                TypeCtorInfo_150_150 = (MR_Word) &mdbcomp__goal_path__mdbcomp__goal_path__type_ctor_info_containing_goal_0;
                mercury__map__lookup_3_p_0(TypeCtorInfo_149_149, TypeCtorInfo_150_150, ContainingGoalMap_52, ((MR_Box) (FirstCaseGoalId0_60)), &conv2_GoalContaining0_61);
                GoalContaining0_61 = ((MR_Word) conv2_GoalContaining0_61);
                succeeded = ((MR_tag((MR_Word) GoalContaining0_61)) == (MR_mktag((MR_Integer) 1)));
                if (succeeded)
                {
                  _ContainingGoalId_62 = ((MR_Word) (MR_hl_field(MR_mktag(1), GoalContaining0_61, (MR_Integer) 0)));
                  FirstCaseLastStep_63 = ((MR_Word) (MR_hl_field(MR_mktag(1), GoalContaining0_61, (MR_Integer) 1)));
                  succeeded = ((((MR_tag((MR_Word) FirstCaseLastStep_63)) == (MR_mktag((MR_Integer) 3)))) && (((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), FirstCaseLastStep_63, (MR_Integer) 0)))) == (MR_Integer) 0)));
                  if (succeeded)
                  {
                    Var_64 = ((MR_Integer) (MR_hl_field(MR_mktag(3), FirstCaseLastStep_63, (MR_Integer) 1)));
              ...
              GoalId_67 = hlds__hlds_goal__goal_info_get_goal_id_1_f_0(GoalInfo0_21);
              {
                ...
                MR_hl_field(MR_mktag(1), Var_119, 0) = ((MR_Box) (MaybeNumAlt_66));
              }
              {
                BranchPoint_68 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
                MR_hl_field(MR_mktag(0), BranchPoint_68, 0) = ((MR_Box) (GoalId_67));
                MR_hl_field(MR_mktag(0), BranchPoint_68, 1) = ((MR_Box) (Var_119));
              }
              TypeCtorInfo_153_153 = (MR_Word) &transform_hlds__unneeded_code__transform_hlds__unneeded_code__type_ctor_info_where_needed_0;
              TypeInfo_154_154 = (MR_Word) &transform_hlds__unneeded_code_scalar_common_1[0];
              mercury__map__map_values_only_3_p_0(TypeCtorInfo_153_153, TypeCtorInfo_153_153, TypeInfo_154_154, (MR_Word) &transform_hlds__unneeded_code_scalar_common_2[13], STATE_VARIABLE_WhereNeededMap_0_88, &STATE_VARIABLE_WhereNeededMap_121_121);
              mercury__map__init_1_p_0(TypeInfo_154_154, TypeCtorInfo_153_153, &BranchNeededMap0_69);
              transform_hlds__unneeded_code__unneeded_process_cases_15_p_0(UnneededInfo_12, Cases0_51, &Cases_70, BranchPoint_68, (MR_Integer) 1, InitInstMap_15, FinalInstMap_16, GoalId_67, STATE_VARIABLE_WhereNeededMap_121_121, BranchNeededMap0_69, &BranchNeededMap_71, STATE_VARIABLE_RefinedGoals_0_90, STATE_VARIABLE_RefinedGoals_91, STATE_VARIABLE_Changed_0_92, STATE_VARIABLE_Changed_93);
              transform_hlds__unneeded_code__merge_where_needed_maps_5_p_0(ContainingGoalMap_52, GoalId_67, STATE_VARIABLE_WhereNeededMap_121_121, BranchNeededMap_71, &STATE_VARIABLE_WhereNeededMap_125_125);
              transform_hlds__unneeded_code__demand_var_6_p_0(ContainingGoalMap_52, GoalId_67, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), SwitchVar_49, STATE_VARIABLE_WhereNeededMap_125_125, STATE_VARIABLE_WhereNeededMap_89);
              {
                GoalExpr_136 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), GoalExpr_136, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 4));
                MR_hl_field(MR_mktag(3), GoalExpr_136, 1) = ((MR_Box) (SwitchVar_49));
                MR_hl_field(MR_mktag(3), GoalExpr_136, 2) = ((MR_Box) (CanFail_50));
                MR_hl_field(MR_mktag(3), GoalExpr_136, 3) = ((MR_Box) (Cases_70));
              }
              {
                MR_Word base;
                base = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
          ...
          case (MR_Integer) 5:
            {
              ...
              succeeded = ((((MR_tag((MR_Word) Reason_83)) == (MR_mktag((MR_Integer) 3)))) && (((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), Reason_83, (MR_Integer) 0)))) == (MR_Integer) 6)));
              if (succeeded)
              {
                Var_85 = ((MR_Word) (MR_hl_field(MR_mktag(3), Reason_83, (MR_Integer) 1)));
                Var_97 = ((MR_Word) (MR_hl_field(MR_mktag(3), Reason_83, (MR_Integer) 2)));
              ...
              else
              {
                ...
                {
                  GoalExpr_143 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL));
                  MR_hl_field(MR_mktag(3), GoalExpr_143, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 5));
                  MR_hl_field(MR_mktag(3), GoalExpr_143, 1) = ((MR_Box) (Reason_83));
                  MR_hl_field(MR_mktag(3), GoalExpr_143, 2) = ((MR_Box) (SomeGoal_86));
                }
                {
                  MR_Word base;
                  base = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
          ...
          case (MR_Integer) 6:
            {
              ...
              MR_Word Then_79;
              MR_Word Else_80;
              MR_Word STATE_VARIABLE_WhereNeededMap_106_106;
              MR_Word GoalExpr_139;
              MR_Word GoalId_140;
              MR_Word BranchPoint_141;

              GoalId_140 = hlds__hlds_goal__goal_info_get_goal_id_1_f_0(GoalInfo0_21);
              {
                BranchPoint_141 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
                MR_hl_field(MR_mktag(0), BranchPoint_141, 0) = ((MR_Box) (GoalId_140));
                MR_hl_field(MR_mktag(0), BranchPoint_141, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
              }
              TypeCtorInfo_161_161 = (MR_Word) &transform_hlds__unneeded_code__transform_hlds__unneeded_code__type_ctor_info_where_needed_0;
              mercury__map__map_values_only_3_p_0(TypeCtorInfo_161_161, TypeCtorInfo_161_161, (MR_Word) &transform_hlds__unneeded_code_scalar_common_1[0], (MR_Word) &transform_hlds__unneeded_code_scalar_common_2[12], STATE_VARIABLE_WhereNeededMap_0_88, &STATE_VARIABLE_WhereNeededMap_106_106);
              transform_hlds__unneeded_code__unneeded_process_ite_17_p_0(UnneededInfo_12, Cond0_75, &Cond_78, Then0_76, &Then_79, Else0_77, &Else_80, BranchPoint_141, InitInstMap_15, FinalInstMap_16, GoalId_140, STATE_VARIABLE_WhereNeededMap_106_106, STATE_VARIABLE_WhereNeededMap_89, STATE_VARIABLE_RefinedGoals_0_90, STATE_VARIABLE_RefinedGoals_91, STATE_VARIABLE_Changed_0_92, STATE_VARIABLE_Changed_93);
              {
                GoalExpr_139 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 5 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), GoalExpr_139, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 6));
                MR_hl_field(MR_mktag(3), GoalExpr_139, 1) = ((MR_Box) (Quant_74));
                MR_hl_field(MR_mktag(3), GoalExpr_139, 2) = ((MR_Box) (Cond_78));
                MR_hl_field(MR_mktag(3), GoalExpr_139, 3) = ((MR_Box) (Then_79));
                MR_hl_field(MR_mktag(3), GoalExpr_139, 4) = ((MR_Box) (Else_80));
              }
              {
                MR_Word base;
                base = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
...
{
  {
    ...
    MR_Word STATE_VARIABLE_WhereNeededMap_47_47;
    MR_Word STATE_VARIABLE_WhereNeededMap_50_50;
    MR_Word Var_60;
    MR_Word Var_61;
    MR_Word Var_62;
    MR_Word Var_51;

    transform_hlds__unneeded_code__can_eliminate_or_move_6_p_0(UnneededInfo_12, Goal0_13, InitInstMap_15, FinalInstMap_16, STATE_VARIABLE_WhereNeededMap_0_30, &WhereInfo_20);
    if ((WhereInfo_20 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
      transform_hlds__unneeded_code__unneeded_process_goal_internal_11_p_0(UnneededInfo_12, Goal0_13, Goal_14, InitInstMap_15, FinalInstMap_16, STATE_VARIABLE_WhereNeededMap_0_30, &STATE_VARIABLE_WhereNeededMap_47_47, STATE_VARIABLE_RefinedGoals_0_32, STATE_VARIABLE_RefinedGoals_33, STATE_VARIABLE_Changed_0_34, STATE_VARIABLE_Changed_35);
    else
    {
      ...
      MR_Word Debug_24;
      MR_Word Var_37;
      MR_Box conv1_STATE_VARIABLE_RefinedGoals_33;
      MR_Word Var_54;
      MR_Word Var_55;
      MR_Word Var_56;
      MR_Word Var_57;
      ...
      transform_hlds__unneeded_code__demand_inputs_6_p_0(UnneededInfo_12, Goal0_13, InitInstMap_15, WhereInfo_20, STATE_VARIABLE_WhereNeededMap_0_30, &STATE_VARIABLE_WhereNeededMap_47_47);
      mercury__map__to_assoc_list_2_p_0((MR_Word) &transform_hlds__unneeded_code__transform_hlds__unneeded_code__type_ctor_info_branch_point_0, (MR_Word) &transform_hlds__unneeded_code_scalar_common_1[2], Branches_21, &BranchList_22);
      {
        ...
        MR_hl_field(MR_mktag(0), Var_37, 0) = ((MR_Box) (&transform_hlds__unneeded_code_scalar_common_6[0]));
        MR_hl_field(MR_mktag(0), Var_37, 1) = ((MR_Box) (transform_hlds__unneeded_code__unneeded_process_goal_11_p_0_1));
        MR_hl_field(MR_mktag(0), Var_37, 2) = ((MR_Box) (MR_Word) ((MR_Integer) 1));
        MR_hl_field(MR_mktag(0), Var_37, 3) = ((MR_Box) (Goal0_13));
      }
      mercury__list__foldl_4_p_0((MR_Word) &transform_hlds__unneeded_code_scalar_common_2[2], (MR_Word) &transform_hlds__unneeded_code_scalar_common_2[3], Var_37, BranchList_22, ((MR_Box) (STATE_VARIABLE_RefinedGoals_0_32)), &conv1_STATE_VARIABLE_RefinedGoals_33);
      *STATE_VARIABLE_RefinedGoals_33 = ((MR_Word) conv1_STATE_VARIABLE_RefinedGoals_33);
      *Goal_14 = hlds__make_goal__true_goal_0_f_0();
      *STATE_VARIABLE_Changed_35 = (MR_Integer) 1;
      Var_54 = ((MR_Word) (MR_hl_field(MR_mktag(0), UnneededInfo_12, (MR_Integer) 0)));
      Var_55 = ((MR_Word) (MR_hl_field(MR_mktag(0), UnneededInfo_12, (MR_Integer) 1)));
      Options_23 = ((MR_Word) (MR_hl_field(MR_mktag(0), UnneededInfo_12, (MR_Integer) 2)));
      Var_56 = ((MR_Word) (MR_hl_field(MR_mktag(0), UnneededInfo_12, (MR_Integer) 3)));
      Var_57 = ((MR_Word) (MR_hl_field(MR_mktag(0), Options_23, (MR_Integer) 0)));
      Var_58 = ((MR_Word) (MR_hl_field(MR_mktag(0), Options_23, (MR_Integer) 1)));
      Var_59 = ((MR_Integer) (MR_hl_field(MR_mktag(0), Options_23, (MR_Integer) 2)));
      Debug_24 = ((MR_Word) (MR_hl_field(MR_mktag(0), Options_23, (MR_Integer) 3)));
      switch (Debug_24) {
        default: /*NOTREACHED*/ MR_assert(0);
        case (MR_Integer) 0:
          {
        ...
        case (MR_Integer) 1:
          {
            ...
            MR_Word Var_40;
            MR_Word _GoalExpr0_25 = ((MR_Word) (MR_hl_field(MR_mktag(0), Goal0_13, (MR_Integer) 0)));
            MR_String Var_77;

            Var_40 = hlds__hlds_goal__goal_info_get_goal_id_1_f_0(GoalInfo0_26);
            GoalIdNum0_27 = (MR_Integer) Var_40;
            mercury__io__write_string_3_p_0((MR_String) "unneeded code at goal id ");
            mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) &transform_hlds__unneeded_code_scalar_common_7[0], GoalIdNum0_27, &Var_77);
    ...
    ModuleInfo_29 = ((MR_Word) (MR_hl_field(MR_mktag(0), UnneededInfo_12, (MR_Integer) 0)));
    Var_60 = ((MR_Word) (MR_hl_field(MR_mktag(0), UnneededInfo_12, (MR_Integer) 1)));
    Var_61 = ((MR_Word) (MR_hl_field(MR_mktag(0), UnneededInfo_12, (MR_Integer) 2)));
    Var_62 = ((MR_Word) (MR_hl_field(MR_mktag(0), UnneededInfo_12, (MR_Integer) 3)));
    transform_hlds__unneeded_code__undemand_virgin_outputs_5_p_0(Goal0_13, ModuleInfo_29, InitInstMap_15, STATE_VARIABLE_WhereNeededMap_47_47, &STATE_VARIABLE_WhereNeededMap_50_50);
    Var_51 = hlds__hlds_goal__goal_get_purity_1_f_0(*Goal_14);
    succeeded = (Var_51 == (MR_Integer) 2);
    if (succeeded)
    {
      MR_Word TypeCtorInfo_72_72 = (MR_Word) &transform_hlds__unneeded_code__transform_hlds__unneeded_code__type_ctor_info_where_needed_0;

      mercury__map__map_values_only_3_p_0(TypeCtorInfo_72_72, TypeCtorInfo_72_72, (MR_Word) &transform_hlds__unneeded_code_scalar_common_1[0], (MR_Word) &transform_hlds__unneeded_code_scalar_common_2[10], STATE_VARIABLE_WhereNeededMap_50_50, STATE_VARIABLE_WhereNeededMap_31);
    }
    else
      *STATE_VARIABLE_WhereNeededMap_31 = STATE_VARIABLE_WhereNeededMap_50_50;
  }
}
...
{
  {
    ...
    else
    {
      ...
      else
      {
        ...
        MR_Word Var_9 = ((MR_Word) (MR_hl_field(MR_mktag(0), Goal_5, (MR_Integer) 0)));

        InstMapDelta_11 = hlds__hlds_goal__goal_info_get_instmap_delta_1_f_0(GoalInfo_10);
        hlds__instmap__apply_instmap_delta_3_p_0(InitInstMap_2, InstMapDelta_11, &FinalInstMap_12);
        transform_hlds__unneeded_code__build_bracketed_conj_3_p_0(Goals_6, FinalInstMap_12, &BracketedTail_13);
        {
          BracketedGoal_14 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL);
  ...
  while (MR_TRUE)
  {
    /* tailcall optimized into a loop */
    {
      ...
      else
      {
        ...
        if ((BranchWhere0_17 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
        {
          ...
          {
            BranchWhere_25 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
        ...
        if (succeeded)
        {
          ...
          if ((OldWhere_27 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
            CombinedWhere_28 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
          else
          {
        ...
        {
          MR_Word next_value_of_HeadVar__2_2 = WhereNeededList_18;
          MR_Word next_value_of_STATE_VARIABLE_WhereNeededMap_0_6 = STATE_VARIABLE_WhereNeededMap_32_32;
    ...
    /* tailcall optimized into a loop */
    {
      ...
      else
      {
        ...
        if (succeeded)
        {
          ...
          if ((BranchWhere_13 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
            CombinedWhere_18 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
          else
          {
            MR_Word BranchesA_36 = ((MR_Word) (MR_hl_field(MR_mktag(1), BranchWhere_13, (MR_Integer) 0)));

            if ((OldWhere_17 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
              CombinedWhere_18 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
            else
            {
        ...
        /* direct tailcall eliminated */
        {
          MR_Word next_value_of_HeadVar__2_2 = WhereNeededList_14;
          MR_Word next_value_of_STATE_VARIABLE_WhereNeededMap_0_4 = STATE_VARIABLE_WhereNeededMap_22_22;
...
{
  {
    ...
    if (succeeded)
    {
      ...
      if ((WhereNeeded_9 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
        Where_13 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
      else
      {
        MR_Word BranchesA_29 = ((MR_Word) (MR_hl_field(MR_mktag(1), WhereNeeded_9, (MR_Integer) 0)));

        if ((Where0_12 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
          Where_13 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
        else
        {
  ...
  while (MR_TRUE)
  {
    /* tailcall optimized into a loop */
    {
      ...
      else
      {
        ...
        if (succeeded)
        {
          MR_Word TypeCtorInfo_34_34 = (MR_Word) &mercury__builtin__builtin__type_ctor_info_int_0;
          MR_Word Alts_18;
          MR_Word BranchGoalId_19;
          MR_Word BranchAlts_20;

          mercury__set__union_3_p_0(TypeCtorInfo_34_34, OldAlts_17, NewAlts_16, &Alts_18);
          ...
          if ((BranchAlts_20 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
          {
          ...
          else
          {
            ...
            succeeded = ((MR_tag((MR_Word) MaybeSwitchNumFunctors_44)) == (MR_mktag((MR_Integer) 1)));
            if (succeeded)
            {
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              ...
              {
                ParentBranchPoint_26 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
              ...
              ParentAlts_27 = mercury__set__make_singleton_set_1_f_0(TypeCtorInfo_34_34, ((MR_Box) (ParentBranchNum_24)));
              {
              ...
              /* direct tailcall eliminated */
              {
                MR_Word next_value_of_HeadVar__3_3 = Var_28;
                MR_Word next_value_of_HeadVar__4_4 = Branches1_25;
          ...
          else
          {
            ...
            /* direct tailcall eliminated */
            {
              MR_Word next_value_of_HeadVar__3_3 = Rest_12;
              MR_Word next_value_of_HeadVar__4_4 = Branches1_30;
        ...
        else
        {
          ...
          {
            MR_Word next_value_of_HeadVar__3_3 = Rest_12;
            MR_Word next_value_of_HeadVar__4_4 = Branches1_31;
  ...
  MR_Integer * BranchNum_12)
{
  while (MR_TRUE)
  {
    /* tailcall optimized into a loop */
    {
      ...
      succeeded = ((MR_tag((MR_Word) GoalContaining_13)) == (MR_mktag((MR_Integer) 1)));
      if (succeeded)
      {
        ...
        switch (MR_tag((MR_Word) LastStep_15)) {
              ...
              case (MR_Integer) 1:
                {
                  ...
                  *BranchAlt_11 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
          ...
          case (MR_Integer) 2:
            ...
            break;
          case (MR_Integer) 3:
            switch (((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), LastStep_15, (MR_Integer) 0)))) {
              default:
                succeeded = MR_FALSE;
                break;
              case (MR_Integer) 0:
...
{
  {
    ...
    MR_Word Var_17;
    MR_Word Var_10 = ((MR_Word) (MR_hl_field(MR_mktag(0), Goal_6, (MR_Integer) 0)));
    ...
    parse_tree__set_of_var__to_sorted_list_2_p_0((MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0, NonLocalSet_12, &NonLocals_13);
    {
      ...
      MR_hl_field(MR_mktag(0), Var_17, 0) = ((MR_Box) (&transform_hlds__unneeded_code_scalar_common_5[1]));
    ...
    TypeInfo_22_22 = (MR_Word) &transform_hlds__unneeded_code_scalar_common_1[0];
    mercury__list__filter_3_p_0(TypeInfo_22_22, Var_17, NonLocals_13, &VirginOutputs_14);
    mercury__list__foldl_4_p_0(TypeInfo_22_22, (MR_Word) &transform_hlds__unneeded_code_scalar_common_2[0], (MR_Word) &transform_hlds__unneeded_code_scalar_common_2[9], VirginOutputs_14, ((MR_Box) (STATE_VARIABLE_WhereNeededMap_0_15)), &conv1_STATE_VARIABLE_WhereNeededMap_16);
...
{
  {
    ...
    MR_Word Var_22;
    MR_Word Var_23;
    MR_Word Var_12 = ((MR_Word) (MR_hl_field(MR_mktag(0), Goal_8, (MR_Integer) 0)));
    MR_Word Var_25;
    MR_Word Var_26;
    MR_Word Var_27;
    MR_Word Var_28;
    ...
    Var_25 = ((MR_Word) (MR_hl_field(MR_mktag(0), UnneededInfo_7, (MR_Integer) 1)));
    Var_26 = ((MR_Word) (MR_hl_field(MR_mktag(0), UnneededInfo_7, (MR_Integer) 2)));
    Var_27 = ((MR_Word) (MR_hl_field(MR_mktag(0), UnneededInfo_7, (MR_Integer) 3)));
    {
      Var_22 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 5 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), Var_22, 0) = ((MR_Box) (&transform_hlds__unneeded_code_scalar_common_5[1]));
    ...
    TypeInfo_33_33 = (MR_Word) &transform_hlds__unneeded_code_scalar_common_1[0];
    mercury__list__filter_3_p_0(TypeInfo_33_33, Var_22, NonLocals_16, &Inputs_18);
    Var_28 = ((MR_Word) (MR_hl_field(MR_mktag(0), UnneededInfo_7, (MR_Integer) 0)));
    Var_29 = ((MR_Word) (MR_hl_field(MR_mktag(0), UnneededInfo_7, (MR_Integer) 1)));
    Var_30 = ((MR_Word) (MR_hl_field(MR_mktag(0), UnneededInfo_7, (MR_Integer) 2)));
    ContainingGoalMap_19 = ((MR_Word) (MR_hl_field(MR_mktag(0), UnneededInfo_7, (MR_Integer) 3)));
    {
      ...
      MR_hl_field(MR_mktag(0), Var_23, 0) = ((MR_Box) (&transform_hlds__unneeded_code_scalar_common_3[1]));
    ...
    mercury__list__foldl_4_p_0(TypeInfo_33_33, (MR_Word) &transform_hlds__unneeded_code_scalar_common_2[0], Var_23, Inputs_18, ((MR_Box) (STATE_VARIABLE_WhereNeededMap_0_20)), &conv1_STATE_VARIABLE_WhereNeededMap_21);
...
{
  {
    ...
    transform_hlds__unneeded_code__IntroducedFrom__pred__adjust_where_needed__554__1_2_p_0(((MR_Word) wrapper_arg_1), &conv2_HeadVar__2_41);
...
{
  {
    ...
    MR_Word Var_29 = ((MR_Word) (MR_hl_field(MR_mktag(0), UnneededInfo_7, (MR_Integer) 2)));
    MR_Word Var_30 = ((MR_Word) (MR_hl_field(MR_mktag(0), UnneededInfo_7, (MR_Integer) 3)));
    MR_Word Var_18;
    MR_Word Var_34;
    MR_Word Var_35;
    MR_Word Var_36;
    ...
    hlds__instmap__instmap_changed_vars_5_p_0(InitInstMap_9, FinalInstMap_10, VarTypes_14, ModuleInfo_13, &ChangedVarSet_15);
    ...
    {
      STATE_VARIABLE_WhereInfo_24_24 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), STATE_VARIABLE_WhereInfo_24_24, 0) = ((MR_Box) (Empty_17));
    }
    Var_18 = ((MR_Word) (MR_hl_field(MR_mktag(0), Goal_8, (MR_Integer) 0)));
    ...
    Var_34 = ((MR_Word) (MR_hl_field(MR_mktag(0), UnneededInfo_7, (MR_Integer) 0)));
    Var_35 = ((MR_Word) (MR_hl_field(MR_mktag(0), UnneededInfo_7, (MR_Integer) 1)));
    Var_36 = ((MR_Word) (MR_hl_field(MR_mktag(0), UnneededInfo_7, (MR_Integer) 2)));
    ContainingGoalMap_21 = ((MR_Word) (MR_hl_field(MR_mktag(0), UnneededInfo_7, (MR_Integer) 3)));
    {
      ...
      MR_hl_field(MR_mktag(0), Var_25, 0) = ((MR_Box) (&transform_hlds__unneeded_code_scalar_common_3[0]));
    ...
    Var_37 = ((MR_Word) (MR_hl_field(MR_mktag(0), UnneededInfo_7, (MR_Integer) 0)));
    Var_38 = ((MR_Word) (MR_hl_field(MR_mktag(0), UnneededInfo_7, (MR_Integer) 1)));
    Options_22 = ((MR_Word) (MR_hl_field(MR_mktag(0), UnneededInfo_7, (MR_Integer) 2)));
    Var_39 = ((MR_Word) (MR_hl_field(MR_mktag(0), UnneededInfo_7, (MR_Integer) 3)));
    ...
    if (!(succeeded))
    {
      ...
      {
        {
          MR_Word Var_65 = ((MR_Word) (MR_hl_field(MR_mktag(0), Options_22, (MR_Integer) 0)));
          MR_Word Var_70 = ((MR_Word) (MR_hl_field(MR_mktag(0), Options_22, (MR_Integer) 1)));
          MR_Integer Var_71 = ((MR_Integer) (MR_hl_field(MR_mktag(0), Options_22, (MR_Integer) 2)));
          MR_Word Var_72 = ((MR_Word) (MR_hl_field(MR_mktag(0), Options_22, (MR_Integer) 3)));
        ...
        {
          {
            ...
            MR_Word Var_64 = ((MR_Word) (MR_hl_field(MR_mktag(0), Options_22, (MR_Integer) 1)));
            MR_Word Var_73 = ((MR_Word) (MR_hl_field(MR_mktag(0), Options_22, (MR_Integer) 0)));
            MR_Integer Var_74 = ((MR_Integer) (MR_hl_field(MR_mktag(0), Options_22, (MR_Integer) 2)));
            MR_Word Var_75 = ((MR_Word) (MR_hl_field(MR_mktag(0), Options_22, (MR_Integer) 3)));
            ...
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                succeeded = ((MR_tag((MR_Word) STATE_VARIABLE_WhereInfo_26_26)) == (MR_mktag((MR_Integer) 1)));
                if (succeeded)
                {
          ...
          if (!(succeeded))
          {
            ...
            if (!(succeeded))
            {
              ...
              if (succeeded)
              {
                ...
                Var_60 = (MR_Word) &transform_hlds__unneeded_code_scalar_common_2[7];
                ...
                Var_61 = (MR_Word) &transform_hlds__unneeded_code_scalar_common_2[8];
                Var_62 = (MR_Integer) 0;
                ...
                Var_76 = ((MR_Word) (MR_hl_field(MR_mktag(0), Options_22, (MR_Integer) 0)));
                Var_77 = ((MR_Word) (MR_hl_field(MR_mktag(0), Options_22, (MR_Integer) 1)));
                Var_63 = ((MR_Integer) (MR_hl_field(MR_mktag(0), Options_22, (MR_Integer) 2)));
                Var_78 = ((MR_Word) (MR_hl_field(MR_mktag(0), Options_22, (MR_Integer) 3)));
    ...
    if (succeeded)
      *STATE_VARIABLE_WhereInfo_23 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
    else
