...
{
  {
    ...
    succeeded = ((MR_tag((MR_Word) ModeReportControl_9)) == (MR_Integer) 1);
    if (succeeded)
    {
...
{
  {
    ...
    succeeded = ((MR_tag((MR_Word) Components_13)) == (MR_Integer) 1);
    if (succeeded)
    {
      {
        MR_Word base;
...
{
  {
    ...
    succeeded = ((MR_tag((MR_Word) Msgs_11)) == (MR_Integer) 1);
    if (succeeded)
    {
      succeeded = ((MR_tag((MR_Word) MaybeActualSeverity_10)) == (MR_Integer) 1);
      if (succeeded)
      {
...
{
  {
    ...
    succeeded = ((MR_tag((MR_Word) Chars0_5)) == (MR_Integer) 1);
    if (succeeded)
    {
...
{
  {
    ...
    else
    {
      ...
      succeeded = ((MR_tag((MR_Word) Components_6)) == (MR_Integer) 1);
      if (succeeded)
      {
