...
parse_tree__error_util__IntroducedFrom__pred__accumulate_error_specs_for_proc__458__1_1_p_0(
  MR_Word LambdaHeadVar__1_20);

static void MR_CALL 
parse_tree__error_util__IntroducedFrom__pred__construct_sorted_line_pieces__416__1_3_p_0(
  ...
  MR_Box wrapper_arg_1)
{
  ...
  succeeded = parse_tree__error_util__IntroducedFrom__pred__accumulate_error_specs_for_proc__458__1_1_p_0(((MR_Word) (wrapper_arg_1)));
  return succeeded;
}
  ...
  MR_Box * wrapper_arg_2)
{
  ...
  parse_tree__error_util__IntroducedFrom__pred__construct_sorted_line_pieces__416__1_3_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) (wrapper_arg_1)), &conv4_HeadVar__3_33);
  ...
  MR_Word * MaybeActualSeverity_6)
{
  switch (MR_tag((MR_Word) Severity_5)) {
    ...
    case (MR_Integer) 2:
      {
        MR_Word Option_13 = ((MR_Unsigned) ((MR_hl_field(2, Severity_5, 0))) & (MR_Integer) 1023);
        MR_Word OptionValue_14;

        mercury__getopt__lookup_bool_option_3_p_0((MR_Word) (&libs__options__libs__options__type_ctor_info_option_0), OptionTable_4, ((MR_Box) (Option_13)), &OptionValue_14);
    ...
    case (MR_Integer) 3:
      {
        MR_Word Option_15 = ((MR_Unsigned) ((MR_hl_field(3, Severity_5, 0))) & (MR_Integer) 1023);
        MR_Word OptionValue_16;

        mercury__getopt__lookup_bool_option_3_p_0((MR_Word) (&libs__options__libs__options__type_ctor_info_option_0), OptionTable_4, ((MR_Box) (Option_15)), &OptionValue_16);
