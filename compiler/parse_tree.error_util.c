    ...
    switch (MR_tag((MR_Word) Phase_31)) {
      ...
      case (MR_Integer) 0:
        switch (MR_unmkbody(Phase_31)) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 0:
            ModeReportControl_9 = (MR_Word) ((MR_Integer) 0);
            break;
          case (MR_Integer) 1:
            ModeReportControl_9 = (MR_Word) ((MR_Integer) 0);
            break;
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        switch (ActualSeverity_12) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 0:
            Severity_15 = (MR_Word) ((MR_Integer) 0);
            break;
          case (MR_Integer) 2:
            Severity_15 = (MR_Word) ((MR_Integer) 8);
            break;
          case (MR_Integer) 1:
            Severity_15 = (MR_Word) ((MR_Integer) 4);
            break;
        }
        {
          MR_Word base;
...
{
  {
    ...
    if (((MR_tag((MR_Word) MsgA_4)) == (MR_mktag((MR_Integer) 1))))
    {
      ...
      if ((Var_28 == (MR_Word) ((MR_Integer) 0)))
        MaybeContextA_7 = (MR_Word) ((MR_Integer) 0);
      else
    ...
    if (((MR_tag((MR_Word) MsgB_5)) == (MR_mktag((MR_Integer) 1))))
    {
      ...
      if ((Var_45 == (MR_Word) ((MR_Integer) 0)))
        MaybeContextB_8 = (MR_Word) ((MR_Integer) 0);
      else
...
{
  {
    ...
    parse_tree__error_util__do_write_error_pieces_params_9_p_0(Stream_6, (MR_Integer) 0, (MR_Word) ((MR_Integer) 0), (MR_Integer) 0, (MR_Word) (MR_mkword(MR_mktag(1), &parse_tree__error_util_scalar_common_3[4])), Var_24, Components_13);
  }
}
  ...
  MR_Word * HeadVar__2_2)
{
  ...
  else
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), Var_8, 0) = ((MR_Box) ((MR_Integer) 4));
...
{
  {
    ...
    parse_tree__error_util__do_write_error_pieces_params_9_p_0(Stream_6, (MR_Integer) 0, (MR_Word) ((MR_Integer) 0), (MR_Integer) 0, MaybeMaxWidth_25, LimitErrorContextsMap_26, Components_8);
  }
}
...
{
  {
    ...
    parse_tree__error_util__do_write_error_pieces_params_9_p_0(Stream_8, (MR_Integer) 0, (MR_Word) ((MR_Integer) 0), (MR_Integer) 0, MaybeMaxWidth_32, LimitErrorContextsMap_33, Components_6);
  }
}
...
{
  {
    ...
    else
    {
      ...
      if ((Var_12 == (MR_Word) ((MR_Integer) 0)))
...
{
  {
    ...
    else
    {
      ...
      if ((Var_18 == (MR_Word) ((MR_Integer) 0)))
      {
        {
          HeadVar__2_2 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
...
{
  {
    ...
    else
    {
      ...
      if ((Var_34 == (MR_Word) ((MR_Integer) 0)))
      {
        {
...
{
  {
    ...
    else
    {
      ...
      if ((Var_17 == (MR_Word) ((MR_Integer) 0)))
        HeadVar__2_2 = Var_18;
      else
      {
        MR_Word Var_9;
        ...
        if ((Var_33 == (MR_Word) ((MR_Integer) 0)))
          Var_14 = Var_34;
        else
        {
          MR_Word Var_25;
...
{
  {
    ...
    switch (PrintedSome_22) {
      ...
      case (MR_Integer) 1:
        ...
        break;
      case (MR_Integer) 0:
        if ((MaybeActual_23 == (MR_Word) ((MR_Integer) 0)))
        {
          {
...
{
  {
    ...
    if ((MaybeContext_12 == (MR_Word) ((MR_Integer) 0)))
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        MaybeContextLength_22 = (MR_Word) ((MR_Integer) 0);
      }
      else
      {
    ...
    if (!((MaybeContextLength_22 == (MR_Word) ((MR_Integer) 0))))
    {
      ...
      if (!((Components_16 == (MR_Word) ((MR_Integer) 0))))
      {
        ...
        parse_tree__error_util__convert_components_to_paragraphs_acc_5_p_0((MR_Integer) 0, Components_16, (MR_Word) ((MR_Integer) 0), Var_62, &ParasCord_59);
        ...
        if ((MaybeMaxWidth_14 == (MR_Word) ((MR_Integer) 0)))
          MaybeRemain_34 = (MR_Word) ((MR_Integer) 0);
        else
        {
...
parse_tree__error_util__divide_paragraphs_into_lines_5_p_0(
  ...
  MR_Word * Lines_10)
{
  if ((Paras_8 == (MR_Word) ((MR_Integer) 0)))
    *Lines_10 = (MR_Word) ((MR_Integer) 0);
  else
  {
    ...
    NextIndent_17 = (MR_Integer) ((MR_Unsigned) RestIndent_16 + (MR_Unsigned) FirstIndentDelta_15);
    {
      ...
      MR_hl_field(MR_mktag(0), BlankLine_18, 1) = ((MR_Box) ((MR_Integer) 0));
    }
    ...
    if ((FirstParaWords_13 == (MR_Word) ((MR_Integer) 0)))
    {
      NextTreatAsFirst_20 = TreatAsFirst_6;
      FirstParaLines_21 = (MR_Word) ((MR_Integer) 0);
    }
    else
    {
      ...
      if ((MaybeMax_9 == (MR_Word) ((MR_Integer) 0)))
      {
        MR_Word Var_32;
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(1), FirstParaLines_21, 1) = ((MR_Box) ((MR_Integer) 0));
        }
      }
      else
      {
...
parse_tree__error_util__group_nonfirst_line_words_4_p_0(
  ...
  MR_Word * Lines_8)
{
  if ((Words_5 == (MR_Word) ((MR_Integer) 0)))
    *Lines_8 = (MR_Word) ((MR_Integer) 0);
  else
  {
                    ...
                    {
                      {
                        ...
                        MR_hl_field(MR_mktag(1), RevWords1_22, 0) = ((MR_Box) ((MR_Integer) 0));
            ...
            case (MR_Integer) 1:
              {
                ...
                RevWords1_22 = (MR_Word) ((MR_Integer) 0);
              }
              break;
            case (MR_Integer) 2:
              {
...
{
  {
    ...
    else
    {
      ...
      switch (MR_tag((MR_Word) Head_3)) {
        default: /*NOTREACHED*/ MR_assert(0);
        case (MR_Integer) 0:
          if ((TailStrings_6 == (MR_Word) ((MR_Integer) 0)))
        ...
        case (MR_Integer) 0:
          {
            ...
            {
              HeadVar__2_2 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), HeadVar__2_2, 0) = ((MR_Box) ((MR_Integer) 0));
        ...
        case (MR_Integer) 3:
          {
            ...
            if ((Words_4 == (MR_Word) ((MR_Integer) 0)))
            {
              MR_Word Var_27;
  ...
  MR_Integer FixedIndent_4)
{
  while (MR_TRUE)
  {
    ...
    if (!((HeadVar__2_2 == (MR_Word) ((MR_Integer) 0))))
    {
      ...
      if (!((MaybeContext_3 == (MR_Word) ((MR_Integer) 0))))
      {
      ...
      if ((LineWords_21 == (MR_Word) ((MR_Integer) 0)))
      {
  ...
  MR_Integer LineNumber_2)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      if ((MaybeMin_9 == (MR_Word) ((MR_Integer) 0)))
        succeeded = MR_TRUE;
      else
      {
      ...
      if (succeeded)
      {
        if ((MaybeMax_10 == (MR_Word) ((MR_Integer) 0)))
          succeeded = MR_TRUE;
        else
        {
    ...
    case (MR_Integer) 1:
      {
        ...
        *STATE_VARIABLE_Specs_16 = (MR_Word) ((MR_Integer) 0);
      }
      break;
  }
}
      ...
      case (MR_Integer) 1:
        {
          ...
          *STATE_VARIABLE_Specs_13 = (MR_Word) ((MR_Integer) 0);
        }
        break;
    }
  }
...
{
  {
    ...
    if ((STATE_VARIABLE_MaybeSpecs_0_18 == (MR_Word) ((MR_Integer) 0)))
    {
      MR_Word Var_24;
...
{
  {
    ...
    parse_tree__error_util__worst_severity_in_specs_2_4_p_0(Globals_4, Specs_5, (MR_Word) ((MR_Integer) 0), &MaybeWorstActual_7);
    if ((MaybeWorstActual_7 == (MR_Word) ((MR_Integer) 0)))
...
{
  {
    ...
    parse_tree__error_util__worst_severity_in_specs_2_4_p_0(Globals_4, Specs_5, (MR_Word) ((MR_Integer) 0), &MaybeWorst_6);
    return MaybeWorst_6;
  }
}
  ...
  MR_Word * STATE_VARIABLE_MaybeWorst_4)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      if ((STATE_VARIABLE_MaybeWorst_0_3 == (MR_Word) ((MR_Integer) 0)))
      ...
      else
      {
        ...
        if ((MaybeThis_16 == (MR_Word) ((MR_Integer) 0)))
      ...
      case (MR_Integer) 1:
        {
          ...
          if ((MaybeNoMatch_10 == (MR_Word) ((MR_Integer) 0)))
            MaybeActual_6 = (MR_Word) ((MR_Integer) 0);
          else
          {
