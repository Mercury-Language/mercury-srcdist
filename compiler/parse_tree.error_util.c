...
parse_tree__error_util__IntroducedFrom__pred__accumulate_error_specs_for_proc__410__1_1_p_0(
  ...
  MR_Box wrapper_arg_1)
{
  ...
  succeeded = parse_tree__error_util__IntroducedFrom__pred__accumulate_error_specs_for_proc__410__1_1_p_0(((MR_Word) (wrapper_arg_1)));
  return succeeded;
}
  ...
  MR_Word Spec_5)
{
  ...
  switch (MR_tag((MR_Word) Spec_5)) {
    ...
    case (MR_Integer) 1:
      {
        MR_Word Severity_27 = ((MR_Word) ((MR_hl_field(1, Spec_5, (MR_Integer) 1))));
    ...
    case (MR_Integer) 2:
      {
        MR_Word Severity_26 = ((MR_Word) ((MR_hl_field(2, Spec_5, (MR_Integer) 1))));
