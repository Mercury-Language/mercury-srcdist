...
parse_tree__error_util__IntroducedFrom__pred__accumulate_error_specs_for_proc__1130__1_1_p_0(
...
{
  {
    ...
    succeeded = parse_tree__error_util__IntroducedFrom__pred__accumulate_error_specs_for_proc__1130__1_1_p_0(((MR_Word) (wrapper_arg_1)));
    return succeeded;
  }
}
...
{
  {
    MR_Word PrintErrors_7;

    libs__globals__lookup_bool_option_3_p_0(Globals_4, (MR_Integer) 7, &PrintErrors_7);
    switch (PrintErrors_7) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        *SpecsToPrint_6 = (MR_Word) ((MR_Unsigned) 0U);
        break;
      case (MR_Integer) 1:
        *SpecsToPrint_6 = Specs_5;
        break;
    }
  }
}
