...
parse_tree__error_util__IntroducedFrom__pred__accumulate_error_specs_for_proc__469__1_1_p_0(
  MR_Word LambdaHeadVar__1_20);

static void MR_CALL 
parse_tree__error_util__IntroducedFrom__pred__construct_sorted_line_pieces__427__1_3_p_0(
...
static /* final */ const MR_Box parse_tree__error_util_scalar_common_7[1][5];
  ...
  MR_Word LambdaHeadVar__1_20)
{
  ...
  switch (MR_tag((MR_Word) LambdaHeadVar__1_20)) {
    ...
    case (MR_Integer) 2:
      ...
      break;
    case (MR_Integer) 3:
      Phase_7 = ((MR_Word) ((MR_hl_field(3, LambdaHeadVar__1_20, 3))));
      break;
  }
  switch (MR_tag((MR_Word) Phase_7)) {
    ...
    case (MR_Integer) 2:
      {
        MR_Word Control_38 = ((MR_Unsigned) ((MR_hl_field(2, Phase_7, 0))) & (MR_Integer) 1);
    ...
    case (MR_Integer) 3:
      {
        MR_Word Control_39 = ((MR_Unsigned) ((MR_hl_field(3, Phase_7, 0))) & (MR_Integer) 1);
  ...
  MR_Box wrapper_arg_1)
{
  ...
  conv0_Prints_6 = parse_tree__error_util__does_msg_component_print_anything_2_f_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) (wrapper_arg_1)));
  ...
  MR_Word MsgComponent_5)
{
  ...
  switch (MR_tag((MR_Word) MsgComponent_5)) {
    ...
    case (MR_Integer) 1:
      {
        MR_Word Option_12 = ((((MR_Unsigned) ((MR_hl_field(1, MsgComponent_5, 0))) >> 1)) & (MR_Integer) 1023);
        MR_Word MatchValue_13 = ((MR_Unsigned) ((MR_hl_field(1, MsgComponent_5, 0))) & (MR_Integer) 1);
        MR_Word MsgComponents_14 = ((MR_Word) ((MR_hl_field(1, MsgComponent_5, 1))));
        ...
        if (succeeded)
        {
...

          {
            ...
            MR_hl_field(0, Var_17, 0) = ((MR_Box) (&parse_tree__error_util_scalar_common_4[2]));
  ...
  MR_Box wrapper_arg_1)
{
  ...
  conv1_Prints_6 = parse_tree__error_util__does_msg_component_print_anything_2_f_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) (wrapper_arg_1)));
  ...
  MR_Word Msg_5)
{
  ...
  switch (MR_tag((MR_Word) Msg_5)) {
    ...
    case (MR_Integer) 2:
      {
        MR_Word MsgComponents_24 = ((MR_Word) ((MR_hl_field(2, Msg_5, 1))));
        MR_Word PrintsList_25;
        MR_Word Var_26;

        {
          Var_26 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(0, Var_26, 0) = ((MR_Box) (&parse_tree__error_util_scalar_common_4[2]));
      ...
      break;
    case (MR_Integer) 3:
      switch (((MR_Integer) ((MR_hl_field(3, Msg_5, 0))))) {
        default: /*NOTREACHED*/ MR_assert(0);
        case (MR_Integer) 0:
          {
            MR_Word MsgComponents_12 = ((MR_Word) ((MR_hl_field(3, Msg_5, 4))));
            MR_Word PrintsList_16;
            MR_Word Var_17;
  ...
  MR_Box wrapper_arg_1)
{
  ...
  succeeded = parse_tree__error_util__IntroducedFrom__pred__accumulate_error_specs_for_proc__469__1_1_p_0(((MR_Word) (wrapper_arg_1)));
  return succeeded;
}
  ...
  MR_Word * SpecsToPrint_6)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_4, (MR_Integer) 253, &HaltInvalidInterface_7);
    ...
    case (MR_Integer) 1:
      {
...

        {
          ...
          MR_hl_field(0, Var_9, 0) = ((MR_Box) (&parse_tree__error_util_scalar_common_7[0]));
  ...
  MR_Box * wrapper_arg_2)
{
  ...
  parse_tree__error_util__IntroducedFrom__pred__construct_sorted_line_pieces__427__1_3_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) (wrapper_arg_1)), &conv4_HeadVar__3_33);
  ...
  MR_Word * Pieces_6)
{
  ...
  else
  {
    ...
    LastItem_13 = (MR_hl_field(0, Var_18, 1));
    {
      ...
      MR_hl_field(0, Var_19, 0) = ((MR_Box) (&parse_tree__error_util_scalar_common_4[1]));
      ...
      case (MR_Integer) 1:
        {
          ...
          mercury__getopt__lookup_bool_option_3_p_0((MR_Word) (&libs__options__libs__options__type_ctor_info_option_0), OptionTable_4, ((MR_Box) ((MR_Integer) 249)), &HaltAtWarn_9);
          switch (HaltAtWarn_9) {
            default: /*NOTREACHED*/ MR_assert(0);
            case (MR_Integer) 0:
              Halt_6 = (MR_Integer) 0;
  ...
  MR_Word Spec_4)
{
  ...
  Var_5 = parse_tree__error_util__actual_spec_severity_opt_table_2_f_0(OptionTable_7, Spec_4);
  ...
  MR_Word Spec_5)
{
  ...
  switch (MR_tag((MR_Word) Spec_5)) {
    ...
    case (MR_Integer) 0:
      {
        MR_Word Severity_27 = ((MR_Word) ((MR_hl_field(0, Spec_5, 1))));

        switch (MR_tag((MR_Word) Severity_27)) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 0:
          ...
          case (MR_Integer) 1:
            {
              MR_Word Option_55 = ((MR_Unsigned) ((MR_hl_field(1, Severity_27, 0))) & (MR_Integer) 1023);
              MR_Word OptionValue_56;

              mercury__getopt__lookup_bool_option_3_p_0((MR_Word) (&libs__options__libs__options__type_ctor_info_option_0), OptionTable_4, ((MR_Box) (Option_55)), &OptionValue_56);
              switch (OptionValue_56) {
                default: /*NOTREACHED*/ MR_assert(0);
                case (MR_Integer) 0:
          ...
          case (MR_Integer) 2:
            {
              MR_Word Option_60 = ((MR_Unsigned) ((MR_hl_field(2, Severity_27, 0))) & (MR_Integer) 1023);
              MR_Word OptionValue_61;

              mercury__getopt__lookup_bool_option_3_p_0((MR_Word) (&libs__options__libs__options__type_ctor_info_option_0), OptionTable_4, ((MR_Box) (Option_60)), &OptionValue_61);
              switch (OptionValue_61) {
                default: /*NOTREACHED*/ MR_assert(0);
                case (MR_Integer) 0:
                  MaybeActualSeverity_6 = (MR_Word) ((MR_Unsigned) 0U);
                  break;
    ...
    case (MR_Integer) 1:
      {
        MR_Word Severity_26 = ((MR_Word) ((MR_hl_field(1, Spec_5, 1))));

        switch (MR_tag((MR_Word) Severity_26)) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 0:
            MaybeActualSeverity_6 = (MR_Word) (MR_mkword(1, &parse_tree__error_util_scalar_common_3[0]));
            break;
          case (MR_Integer) 1:
            {
              MR_Word Option_46 = ((MR_Unsigned) ((MR_hl_field(1, Severity_26, 0))) & (MR_Integer) 1023);
              MR_Word OptionValue_47;

              mercury__getopt__lookup_bool_option_3_p_0((MR_Word) (&libs__options__libs__options__type_ctor_info_option_0), OptionTable_4, ((MR_Box) (Option_46)), &OptionValue_47);
              switch (OptionValue_47) {
                default: /*NOTREACHED*/ MR_assert(0);
                case (MR_Integer) 0:
                  MaybeActualSeverity_6 = (MR_Word) ((MR_Unsigned) 0U);
                  break;
          ...
          case (MR_Integer) 2:
            {
              MR_Word Option_51 = ((MR_Unsigned) ((MR_hl_field(2, Severity_26, 0))) & (MR_Integer) 1023);
              MR_Word OptionValue_52;

              mercury__getopt__lookup_bool_option_3_p_0((MR_Word) (&libs__options__libs__options__type_ctor_info_option_0), OptionTable_4, ((MR_Box) (Option_51)), &OptionValue_52);
              switch (OptionValue_52) {
                default: /*NOTREACHED*/ MR_assert(0);
                case (MR_Integer) 0:
                  MaybeActualSeverity_6 = (MR_Word) ((MR_Unsigned) 0U);
                  break;
    ...
    case (MR_Integer) 2:
      {
        MR_Word Severity_8 = ((MR_Word) ((MR_hl_field(2, Spec_5, 1))));

        switch (MR_tag((MR_Word) Severity_8)) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 0:
            MaybeActualSeverity_6 = (MR_Word) (MR_mkword(1, &parse_tree__error_util_scalar_common_3[0]));
            break;
          case (MR_Integer) 1:
            {
              MR_Word Option_37 = ((MR_Unsigned) ((MR_hl_field(1, Severity_8, 0))) & (MR_Integer) 1023);
              MR_Word OptionValue_38;

              mercury__getopt__lookup_bool_option_3_p_0((MR_Word) (&libs__options__libs__options__type_ctor_info_option_0), OptionTable_4, ((MR_Box) (Option_37)), &OptionValue_38);
          ...
          case (MR_Integer) 2:
            {
              MR_Word Option_42 = ((MR_Unsigned) ((MR_hl_field(2, Severity_8, 0))) & (MR_Integer) 1023);
              MR_Word OptionValue_43;

              mercury__getopt__lookup_bool_option_3_p_0((MR_Word) (&libs__options__libs__options__type_ctor_info_option_0), OptionTable_4, ((MR_Box) (Option_42)), &OptionValue_43);
              switch (OptionValue_43) {
                default: /*NOTREACHED*/ MR_assert(0);
                case (MR_Integer) 0:
                  MaybeActualSeverity_6 = (MR_Word) ((MR_Unsigned) 0U);
                  break;
    ...
    case (MR_Integer) 3:
      {
        MR_Word Option_19 = ((((MR_Unsigned) ((MR_hl_field(3, Spec_5, 1))) >> 1)) & (MR_Integer) 1023);
        MR_Word MatchValue_20 = ((MR_Unsigned) ((MR_hl_field(3, Spec_5, 1))) & (MR_Integer) 1);
        MR_Word Value_23;
        MR_Word Severity_24 = ((MR_Word) ((MR_hl_field(3, Spec_5, 2))));

        mercury__getopt__lookup_bool_option_3_p_0((MR_Word) (&libs__options__libs__options__type_ctor_info_option_0), OptionTable_4, ((MR_Box) (Option_19)), &Value_23);
        succeeded = (Value_23 == MatchValue_20);
        if (succeeded)
          switch (MR_tag((MR_Word) Severity_24)) {
            default: /*NOTREACHED*/ MR_assert(0);
            case (MR_Integer) 0:
              MaybeActualSeverity_6 = (MR_Word) (MR_mkword(1, &parse_tree__error_util_scalar_common_3[0]));
              break;
            case (MR_Integer) 1:
              {
                MR_Word Option_28 = ((MR_Unsigned) ((MR_hl_field(1, Severity_24, 0))) & (MR_Integer) 1023);
                MR_Word OptionValue_29;

                mercury__getopt__lookup_bool_option_3_p_0((MR_Word) (&libs__options__libs__options__type_ctor_info_option_0), OptionTable_4, ((MR_Box) (Option_28)), &OptionValue_29);
            ...
            case (MR_Integer) 2:
              {
                MR_Word Option_33 = ((MR_Unsigned) ((MR_hl_field(2, Severity_24, 0))) & (MR_Integer) 1023);
                MR_Word OptionValue_34;

                mercury__getopt__lookup_bool_option_3_p_0((MR_Word) (&libs__options__libs__options__type_ctor_info_option_0), OptionTable_4, ((MR_Box) (Option_33)), &OptionValue_34);
                switch (OptionValue_34) {
                  default: /*NOTREACHED*/ MR_assert(0);
                  case (MR_Integer) 0:
                    MaybeActualSeverity_6 = (MR_Word) ((MR_Unsigned) 0U);
                    break;
  ...
  MR_Box wrapper_arg_1)
{
  ...
  conv1_Prints_6 = parse_tree__error_util__does_msg_print_anything_2_f_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) (wrapper_arg_1)));
  wrapper_arg_2 = ((MR_Box) (conv1_Prints_6));
  return wrapper_arg_2;
}
  ...
  MR_Box wrapper_arg_1)
{
  ...
  conv0_Prints_6 = parse_tree__error_util__does_msg_print_anything_2_f_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) (wrapper_arg_1)));
  wrapper_arg_2 = ((MR_Box) (conv0_Prints_6));
  return wrapper_arg_2;
}
    ...
    case (MR_Integer) 3:
      {
        ...
        MR_Word Var_5;
        MR_Word Option_12 = ((((MR_Unsigned) ((MR_hl_field(3, Spec_4, 1))) >> 1)) & (MR_Integer) 1023);
        MR_Word MatchValue_13 = ((MR_Unsigned) ((MR_hl_field(3, Spec_4, 1))) & (MR_Integer) 1);
        MR_Word OptionValue_16;
        MR_Word Var_18;
        MR_Word PrintsList_19;
        MR_Word Msgs_20 = ((MR_Word) ((MR_hl_field(3, Spec_4, 4))));
