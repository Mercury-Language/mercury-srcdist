...
MR_decl_label4(parse_tree__error_util__IntroducedFrom__pred__accumulate_error_specs_for_proc__636__1_1_0, 15,19,2,1)
...
MR_decl_label10(parse_tree__error_util__write_msg_components_10_0, 62,3,5,6,8,9,11,23,24,27)
MR_decl_label9(parse_tree__error_util__write_msg_components_10_0, 26,28,33,16,17,20,19,13,14)
...
MR_decl_static(parse_tree__error_util__IntroducedFrom__pred__accumulate_error_specs_for_proc__636__1_1_0)
...
{
MR_COMMON(3,0),
MR_ENTRY_AP(parse_tree__error_util__IntroducedFrom__pred__accumulate_error_specs_for_proc__636__1_1_0),
0
},
{
MR_COMMON(1,1),
...
MR_BEGIN_MODULE(parse_tree__error_util_module31)
	...
	MR_init_label10(parse_tree__error_util__write_msg_components_10_0,62,3,5,6,8,9,11,23,24,27)
	MR_init_label9(parse_tree__error_util__write_msg_components_10_0,26,28,33,16,17,20,19,13,14)
MR_BEGIN_CODE
...
MR_def_label(parse_tree__error_util__write_msg_components_10_0,62)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
...
MR_def_label(parse_tree__error_util__write_msg_components_10_0,3)
	...
	MR_COMPUTED_GOTO((MR_Unsigned) MR_tag(MR_r8),
		...
		MR_LABEL_AP(parse_tree__error_util__write_msg_components_10_0_i8) MR_AND
		MR_LABEL_AP(parse_tree__error_util__write_msg_components_10_0_i23) MR_AND
		MR_LABEL_AP(parse_tree__error_util__write_msg_components_10_0_i33));
...
MR_def_label(parse_tree__error_util__write_msg_components_10_0,9)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if ((MR_r1 != MR_sv(7))) {
		MR_GOTO_LAB(parse_tree__error_util__write_msg_components_10_0_i27);
	}
	MR_r1 = MR_sv(8);
	MR_r2 = MR_sv(1);
	MR_r3 = MR_sv(2);
...
MR_def_label(parse_tree__error_util__write_msg_components_10_0,11)
	...
	MR_GOTO_LAB(parse_tree__error_util__write_msg_components_10_0_i62);
	}
MR_def_label(parse_tree__error_util__write_msg_components_10_0,23)
	...
	MR_np_call_localret_ent(libs__globals__lookup_bool_option_3_0,
		parse_tree__error_util__write_msg_components_10_0_i24);
MR_def_label(parse_tree__error_util__write_msg_components_10_0,24)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(parse_tree__error_util__write_msg_components_10_0_i26);
	}
	MR_r1 = (MR_Integer) 1;
...
MR_def_label(parse_tree__error_util__write_msg_components_10_0,28)
	...
	MR_np_call_localret_ent(parse_tree__error_util__do_write_error_pieces_7_0,
		parse_tree__error_util__write_msg_components_10_0_i14);
MR_def_label(parse_tree__error_util__write_msg_components_10_0,33)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	...
	MR_np_call_localret_ent(libs__globals__lookup_bool_option_3_0,
		parse_tree__error_util__write_msg_components_10_0_i16);
...
MR_def_label(parse_tree__error_util__write_msg_components_10_0,17)
	...
	if (MR_INT_NE(MR_sv(8),0)) {
		MR_GOTO_LAB(parse_tree__error_util__write_msg_components_10_0_i19);
	}
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
	...
	MR_np_call_localret_ent(parse_tree__error_util__do_write_error_pieces_7_0,
		parse_tree__error_util__write_msg_components_10_0_i20);
MR_def_label(parse_tree__error_util__write_msg_components_10_0,20)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Integer) 1;
	MR_np_call_localret_ent(libs__globals__io_set_extra_error_info_3_0,
		parse_tree__error_util__write_msg_components_10_0_i14);
MR_def_label(parse_tree__error_util__write_msg_components_10_0,19)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
...
MR_def_label(parse_tree__error_util__write_msg_components_10_0,13)
	...
	MR_noprof_call_localret(MR_ENTRY(mercury__do_call_class_method_2),
		mercury__parse_tree__error_util__write_msg_components_10_0_i14);
...
MR_BEGIN_MODULE(parse_tree__error_util_module95)
	MR_init_entry1(parse_tree__error_util__IntroducedFrom__pred__accumulate_error_specs_for_proc__636__1_1_0);
	MR_INIT_PROC_LAYOUT_ADDR(mercury__parse_tree__error_util__IntroducedFrom__pred__accumulate_error_specs_for_proc__636__1_1_0);
	MR_init_label4(parse_tree__error_util__IntroducedFrom__pred__accumulate_error_specs_for_proc__636__1_1_0,15,19,2,1)
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'IntroducedFrom__pred__accumulate_error_specs_for_proc__636__1'/1 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(parse_tree__error_util__IntroducedFrom__pred__accumulate_error_specs_for_proc__636__1_1_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_tfield(0, MR_r1, 1);
	MR_r1 = MR_tag(MR_r2);
	if ((MR_r1 == MR_mktag((MR_Integer) 2))) {
		MR_GOTO_LAB(parse_tree__error_util__IntroducedFrom__pred__accumulate_error_specs_for_proc__636__1_1_0_i15);
	}
	if ((MR_r1 != MR_mktag((MR_Integer) 1))) {
		MR_GOTO_LAB(parse_tree__error_util__IntroducedFrom__pred__accumulate_error_specs_for_proc__636__1_1_0_i19);
	}
MR_def_label(parse_tree__error_util__IntroducedFrom__pred__accumulate_error_specs_for_proc__636__1_1_0,15)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_tag_alloc_heap(MR_r1, 1, (MR_Integer) 1);
	MR_tfield(1, MR_r1, 0) = MR_mask_field(MR_r2, 0);
	MR_GOTO_LAB(parse_tree__error_util__IntroducedFrom__pred__accumulate_error_specs_for_proc__636__1_1_0_i2);
MR_def_label(parse_tree__error_util__IntroducedFrom__pred__accumulate_error_specs_for_proc__636__1_1_0,19)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_tbmkword(0, 0);
MR_def_label(parse_tree__error_util__IntroducedFrom__pred__accumulate_error_specs_for_proc__636__1_1_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TEST(MR_r1,0,0)) {
		MR_GOTO_LAB(parse_tree__error_util__IntroducedFrom__pred__accumulate_error_specs_for_proc__636__1_1_0_i1);
	}
	MR_r2 = MR_tfield(1, MR_r1, 0);
	MR_r1 = ((MR_Integer) MR_r2 == (MR_Integer) 1);
	MR_proceed();
MR_def_label(parse_tree__error_util__IntroducedFrom__pred__accumulate_error_specs_for_proc__636__1_1_0,1)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_FALSE;
	MR_proceed();
#ifdef MR_maybe_local_thread_engine_base
