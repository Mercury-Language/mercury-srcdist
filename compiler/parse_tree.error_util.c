...
parse_tree__error_util__IntroducedFrom__pred__accumulate_error_specs_for_proc__490__1_1_p_0(
  MR_Word LambdaHeadVar__1_20);

static void MR_CALL 
parse_tree__error_util__IntroducedFrom__pred__construct_sorted_line_pieces__448__1_3_p_0(
  ...
  MR_Box wrapper_arg_1)
{
  ...
  succeeded = parse_tree__error_util__IntroducedFrom__pred__accumulate_error_specs_for_proc__490__1_1_p_0(((MR_Word) (wrapper_arg_1)));
  return succeeded;
}
  ...
  MR_Box * wrapper_arg_2)
{
  ...
  parse_tree__error_util__IntroducedFrom__pred__construct_sorted_line_pieces__448__1_3_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) (wrapper_arg_1)), &conv4_HeadVar__3_33);
  ...
  MR_Word * MaybeActualSeverity_6)
{
  switch (MR_tag((MR_Word) Severity_5)) {
    ...
    case (MR_Integer) 2:
      {
        MR_Word Option_28 = ((MR_Unsigned) ((MR_hl_field(2, Severity_5, 0))) & (MR_Integer) 1023);
    ...
    case (MR_Integer) 3:
      {
        ...
        MR_Word Option_33 = ((MR_Unsigned) ((MR_hl_field(3, Severity_5, 0))) & (MR_Integer) 1023);
        MR_Box conv0_OptionData_9;

        mercury__map__lookup_3_p_0((MR_Word) (&libs__options__libs__options__type_ctor_info_option_0), (MR_Word) (&mercury__getopt__getopt__type_ctor_info_option_data_0), OptionTable_4, ((MR_Box) (Option_33)), &conv0_OptionData_9);
        ...
        switch (MR_tag((MR_Word) OptionData_9)) {
          ...
          case (MR_Integer) 2:
            {
              ...
              Var_25 = mercury__string__string_1_f_0((MR_Word) (&libs__options__libs__options__type_ctor_info_option_0), ((MR_Box) (Option_33)));
              Msg_16 = mercury__string__f_43_43_2_f_0(Var_25, (MR_String) " is not a bool or accumulating option");
              {
          ...
          case (MR_Integer) 1:
            {
              MR_Word OptionValue_30 = ((MR_Unsigned) ((MR_hl_field(1, OptionData_9, 0))) & (MR_Integer) 1);

              switch (OptionValue_30) {
                default: /*NOTREACHED*/ MR_assert(0);
                case (MR_Integer) 0:
                  *MaybeActualSeverity_6 = (MR_Word) ((MR_Unsigned) 0U);
                  break;
          ...
          case (MR_Integer) 3:
            switch (((MR_Integer) ((MR_hl_field(3, OptionData_9, 0))))) {
              ...
              case (MR_Integer) 3:
                {
                  MR_Word OptionValue_31 = ((MR_Word) ((MR_hl_field(3, OptionData_9, 1))));

                  if ((OptionValue_31 == (MR_Word) ((MR_Unsigned) 0U)))
                    *MaybeActualSeverity_6 = (MR_Word) ((MR_Unsigned) 0U);
                  else
                    *MaybeActualSeverity_6 = (MR_Word) (MR_mkword(1, &parse_tree__error_util_scalar_common_3[1]));
                }
    ...
    case (MR_Integer) 2:
      {
...

        {
          ...
          MR_hl_field(0, Var_11, 0) = ((MR_Box) (&parse_tree__error_util_scalar_common_4[0]));
          MR_hl_field(0, Var_11, 1) = ((MR_Box) (parse_tree__error_util__does_spec_print_anything_2_p_0_1));
          MR_hl_field(0, Var_11, 2) = ((MR_Box) ((MR_Integer) 1));
          MR_hl_field(0, Var_11, 3) = ((MR_Box) (Globals_3));
        }
        PrintsList_10 = mercury__list__map_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_error_msg_0), (MR_Word) (&mercury__bool__bool__type_ctor_info_bool_0), Var_11, Msgs_9);
