...
parse_tree__error_util__IntroducedFrom__pred__accumulate_error_specs_for_proc__480__1_1_p_0(
  MR_Word LambdaHeadVar__1_20);

static void MR_CALL 
parse_tree__error_util__IntroducedFrom__pred__construct_sorted_line_pieces__438__1_3_p_0(
  ...
  MR_Box wrapper_arg_1)
{
  ...
  succeeded = parse_tree__error_util__IntroducedFrom__pred__accumulate_error_specs_for_proc__480__1_1_p_0(((MR_Word) (wrapper_arg_1)));
  return succeeded;
}
  ...
  MR_Word * SpecsToPrint_6)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_4, (MR_Integer) 274, &HaltInvalidInterface_7);
  ...
  MR_Box * wrapper_arg_2)
{
  ...
  parse_tree__error_util__IntroducedFrom__pred__construct_sorted_line_pieces__438__1_3_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) (wrapper_arg_1)), &conv4_HeadVar__3_33);
      ...
      case (MR_Integer) 1:
        {
          ...
          mercury__getopt__lookup_bool_option_3_p_0((MR_Word) (&libs__options__libs__options__type_ctor_info_option_0), OptionTable_4, ((MR_Box) ((MR_Integer) 270)), &HaltAtWarn_9);
          switch (HaltAtWarn_9) {
            default: /*NOTREACHED*/ MR_assert(0);
            case (MR_Integer) 0:
              Halt_6 = (MR_Integer) 0;
  ...
  MR_Word Severity_5)
{
  while (MR_TRUE)
  {
    ...
    switch (MR_tag((MR_Word) Severity_5)) {
      ...
      case (MR_Integer) 1:
        {
          MR_Word Option_7 = ((((MR_Unsigned) ((MR_hl_field(1, Severity_5, 0))) >> 1)) & (MR_Integer) 1023);
          MR_Word MatchValue_8 = ((MR_Unsigned) ((MR_hl_field(1, Severity_5, 0))) & (MR_Integer) 1);
          MR_Word Match_9 = ((MR_Word) ((MR_hl_field(1, Severity_5, 1))));
          MR_Word MaybeNoMatch_10 = ((MR_Word) ((MR_hl_field(1, Severity_5, 2))));
          MR_Word Value_11;
          ...
          {
            MR_Word NoMatch_12 = ((MR_Word) ((MR_hl_field(1, MaybeNoMatch_10, 0))));
