  ...
  MR_Word * SpecsToPrint_6)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_4, (MR_Integer) 273, &HaltInvalidInterface_7);
      ...
      case (MR_Integer) 1:
        {
          ...
          mercury__getopt__lookup_bool_option_3_p_0((MR_Word) (&libs__options__libs__options__type_ctor_info_option_0), OptionTable_4, ((MR_Box) ((MR_Integer) 269)), &HaltAtWarn_9);
          switch (HaltAtWarn_9) {
            default: /*NOTREACHED*/ MR_assert(0);
            case (MR_Integer) 0:
              Halt_6 = (MR_Integer) 0;
