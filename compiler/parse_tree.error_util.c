...
parse_tree__error_util__IntroducedFrom__pred__accumulate_error_specs_for_proc__1001__1_1_p_0(
...
{
  {
    MR_bool succeeded = ((MR_tag((MR_Word) Spec0_5)) == (MR_Integer) 0);
    ...
    if (succeeded)
    {
      ...
      TypeCtorInfo_19_19 = (MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_error_msg_0);
      {
      ...
      mercury__list__filter_map_3_p_0(TypeCtorInfo_19_19, TypeCtorInfo_19_19, Var_16, Msgs0_9, &Msgs_11);
...
{
  {
    ...
    succeeded = parse_tree__error_util__IntroducedFrom__pred__accumulate_error_specs_for_proc__1001__1_1_p_0(((MR_Word) (wrapper_arg_1)));
    return succeeded;
  }
}
