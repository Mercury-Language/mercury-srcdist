  ...
  MR_Word Components_14)
{
  ...
  else
  {
    ...
    mercury__term__context_line_2_p_0(Context_31, &LineNumber_33);
    {
      ...
      if (succeeded)
      {
        Var_52 = parse_tree__error_util__line_number_is_in_a_range_2_f_0(LineNumberRanges_34, LineNumber_33);
    ...
    else
    {
      ...
      Var_58 = (MR_Integer) ((MR_Unsigned) FileNameLength_36 + (MR_Unsigned) 1);
      Var_57 = (MR_Integer) ((MR_Unsigned) Var_58 + (MR_Unsigned) LineNumberStrLength_39);
      Var_56 = (MR_Integer) ((MR_Unsigned) Var_57 + (MR_Unsigned) 2);
      {
        ...
        MR_hl_field(MR_mktag(1), MaybeContextLength_35, 0) = ((MR_Box) (Var_56));
      }
    }
  }
  ...
  MR_Word Type_13)
{
  ...
  else
  {
    ...
    else
    {
      ...
      ExistQVarStrs_26 = mercury__list__map_2_f_0((MR_Word) (&parse_tree__error_util_scalar_common_1[0]), (MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), Var_31, ExistQVars_96);
