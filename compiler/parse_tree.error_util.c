...
MR_decl_label10(__Compare___parse_tree__error_util__format_component_0_0, 4,5,6,7,84,11,31,57,14,19)
MR_decl_label10(__Compare___parse_tree__error_util__format_component_0_0, 22,25,28,34,37,40,43,46,49,8)
...
MR_def_label(fn__parse_tree__error_util__join_prefixes_1_0,41)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_tag_alloc_heap(MR_r2, 1, (MR_Integer) 2);
	MR_tfield(1, MR_r2, 0) = MR_mask_field(MR_sv(1), 0);
	MR_tfield(1, MR_r2, 1) = MR_r1;
	MR_r1 = MR_r2;
	MR_decr_sp_and_return(5);
...
MR_BEGIN_MODULE(parse_tree__error_util_module78)
	...
	MR_init_label10(__Compare___parse_tree__error_util__format_component_0_0,4,5,6,7,84,11,31,57,14,19)
	MR_init_label10(__Compare___parse_tree__error_util__format_component_0_0,22,25,28,34,37,40,43,46,49,8)
MR_BEGIN_CODE
...
MR_def_label(__Compare___parse_tree__error_util__format_component_0_0,7)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_COMPUTED_GOTO((MR_Unsigned) MR_tag(MR_sv(1)),
		MR_LABEL_AP(__Compare___parse_tree__error_util__format_component_0_0_i84) MR_AND
