...
static const MR_PseudoTypeInfo parse_tree__error_util__parse_tree__error_util__field_types_maybe_written_spec_0_0[1];

static const MR_DuFunctorDesc parse_tree__error_util__parse_tree__error_util__du_functor_desc_maybe_written_spec_0_0;

static const MR_PseudoTypeInfo parse_tree__error_util__parse_tree__error_util__field_types_maybe_written_spec_0_1[1];

static const MR_DuFunctorDesc parse_tree__error_util__parse_tree__error_util__du_functor_desc_maybe_written_spec_0_1;

static const MR_DuFunctorDescPtr parse_tree__error_util__parse_tree__error_util__du_stag_ordered_maybe_written_spec_0_0[1];

static const MR_DuFunctorDescPtr parse_tree__error_util__parse_tree__error_util__du_stag_ordered_maybe_written_spec_0_1[1];

static const MR_DuPtagLayout parse_tree__error_util__parse_tree__error_util__du_ptag_ordered_maybe_written_spec_0[2];

static const MR_DuFunctorDescPtr parse_tree__error_util__parse_tree__error_util__du_name_ordered_maybe_written_spec_0[2];

static const MR_Integer parse_tree__error_util__parse_tree__error_util__functor_number_map_maybe_written_spec_0[2];

static MR_bool MR_CALL 
parse_tree__error_util__IntroducedFrom__pred__accumulate_error_specs_for_proc__511__1_1_p_0(
  MR_Word LambdaHeadVar__1_20);

static void MR_CALL 
parse_tree__error_util__IntroducedFrom__pred__construct_sorted_line_pieces__469__1_3_p_0(
...
parse_tree__error_util__maybe_written_specs_to_specs_1_f_0_1(
  MR_Box closure_arg,
  MR_Box wrapper_arg_1);
...
static MR_bool MR_CALL 
parse_tree__error_util____Unify____maybe_written_spec_0_0_10001(
  MR_Box wrapper_arg_1,
  MR_Box wrapper_arg_2);

static void MR_CALL 
parse_tree__error_util____Compare____maybe_written_spec_0_0_10001(
  MR_Box * wrapper_arg_1,
  MR_Box wrapper_arg_2,
  MR_Box wrapper_arg_3);


static /* final */ const MR_Box parse_tree__error_util_scalar_common_1[8][2];
...
static /* final */ const MR_Box parse_tree__error_util_scalar_common_4[3][5];
...
static /* final */ const MR_Box parse_tree__error_util_scalar_common_1[8][2] = {
  ...
  /* row   5 */
  {
    ((MR_Box) (MR_mkword(3, &parse_tree__error_util_scalar_common_1[4]))),
    ((MR_Box) (MR_mkword(1, &parse_tree__error_util_scalar_common_1[3])))
  },
  /* row   6 */
  {
    ((MR_Box) (MR_Word) ((MR_Unsigned) 8U)),
...
static /* final */ const MR_Box parse_tree__error_util_scalar_common_2[4][3] = {
  ...
  /* row   2 */
  {
    ...
    ((MR_Box) (parse_tree__error_util__maybe_written_specs_to_specs_1_f_0_1)),
    ((MR_Box) ((MR_Integer) 0))
  },
  /* row   3 */
  {
...
static /* final */ const MR_Box parse_tree__error_util_scalar_common_4[3][5] = {
  ...
  /* row   1 */
  {
    ...
    ((MR_Box) (NULL)),
    ((MR_Box) ((MR_Integer) 2)),
    ((MR_Box) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_maybe_written_spec_0)),
    ((MR_Box) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_error_spec_0))
  },
  /* row   2 */
  {
...
static const MR_PseudoTypeInfo parse_tree__error_util__parse_tree__error_util__field_types_maybe_written_spec_0_0[1] = { (MR_PseudoTypeInfo) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_error_spec_0) };

static const MR_DuFunctorDesc parse_tree__error_util__parse_tree__error_util__du_functor_desc_maybe_written_spec_0_0 = {
  (MR_String) "to_be_written_spec",
  INT16_C(1),
  UINT16_C(0),
  MR_SECTAG_NONE,
  UINT8_C(0),
  (MR_Integer) -1,
  INT32_C(0),
  parse_tree__error_util__parse_tree__error_util__field_types_maybe_written_spec_0_0,
  NULL,
  NULL,
  NULL,
...
static const MR_PseudoTypeInfo parse_tree__error_util__parse_tree__error_util__field_types_maybe_written_spec_0_1[1] = { (MR_PseudoTypeInfo) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_std_error_spec_0) };

static const MR_DuFunctorDesc parse_tree__error_util__parse_tree__error_util__du_functor_desc_maybe_written_spec_0_1 = {
  (MR_String) "already_written_spec",
  INT16_C(1),
  UINT16_C(0),
  MR_SECTAG_NONE,
  UINT8_C(1),
  (MR_Integer) -1,
  INT32_C(1),
  parse_tree__error_util__parse_tree__error_util__field_types_maybe_written_spec_0_1,
  NULL,
  NULL,
  NULL,
  MR_FUNCTOR_SUBTYPE_NONE,
...
static const MR_DuFunctorDescPtr parse_tree__error_util__parse_tree__error_util__du_stag_ordered_maybe_written_spec_0_0[1] = { &parse_tree__error_util__parse_tree__error_util__du_functor_desc_maybe_written_spec_0_0 };

static const MR_DuFunctorDescPtr parse_tree__error_util__parse_tree__error_util__du_stag_ordered_maybe_written_spec_0_1[1] = { &parse_tree__error_util__parse_tree__error_util__du_functor_desc_maybe_written_spec_0_1 };

static const MR_DuPtagLayout parse_tree__error_util__parse_tree__error_util__du_ptag_ordered_maybe_written_spec_0[2] = {
  {
    UINT32_C(1),
    MR_SECTAG_NONE,
    parse_tree__error_util__parse_tree__error_util__du_stag_ordered_maybe_written_spec_0_0,
    INT8_C(-1),
    UINT8_C(0),
    UINT8_C(1)
  },
  {
    UINT32_C(1),
    MR_SECTAG_NONE,
    parse_tree__error_util__parse_tree__error_util__du_stag_ordered_maybe_written_spec_0_1,
    INT8_C(-1),
    UINT8_C(1),
    UINT8_C(1)
  }
...
static const MR_DuFunctorDescPtr parse_tree__error_util__parse_tree__error_util__du_name_ordered_maybe_written_spec_0[2] = {
  &parse_tree__error_util__parse_tree__error_util__du_functor_desc_maybe_written_spec_0_1,
  &parse_tree__error_util__parse_tree__error_util__du_functor_desc_maybe_written_spec_0_0
};
...
const MR_TypeCtorInfo_Struct parse_tree__error_util__parse_tree__error_util__type_ctor_info_maybe_written_spec_0 = {
  (MR_Integer) 0,
  UINT8_C(18),
  INT8_C(2),
  MR_TYPECTOR_REP_DU,
  ((MR_Box) (parse_tree__error_util____Unify____maybe_written_spec_0_0_10001)),
  ((MR_Box) (parse_tree__error_util____Compare____maybe_written_spec_0_0_10001)),
  (MR_String) "parse_tree.error_util",
  (MR_String) "maybe_written_spec",
  { parse_tree__error_util__parse_tree__error_util__du_name_ordered_maybe_written_spec_0 },
  { parse_tree__error_util__parse_tree__error_util__du_ptag_ordered_maybe_written_spec_0 },
  (MR_Integer) 2,
  UINT16_C(12),
  parse_tree__error_util__parse_tree__error_util__functor_number_map_maybe_written_spec_0,
...
void MR_CALL 
parse_tree__error_util____Compare____maybe_written_spec_0_0(
  MR_Word * HeadVar__1_1,
  MR_Word HeadVar__2_2,
  MR_Word HeadVar__3_3)
{
  ...
  if (((MR_tag((MR_Word) HeadVar__2_2)) == (MR_Integer) 1))
    if (((MR_tag((MR_Word) HeadVar__3_3)) == (MR_Integer) 1))
    {
      ...
      parse_tree__error_spec____Compare____std_error_spec_0_0(HeadVar__1_1, ArgX1_6, ArgY1_7);
    }
    else
...
MR_bool MR_CALL 
parse_tree__error_util____Unify____maybe_written_spec_0_0(
  MR_Word HeadVar__1_1,
  MR_Word HeadVar__2_2)
{
  MR_bool succeeded;
  ...
  if (((MR_tag((MR_Word) HeadVar__1_1)) == (MR_Integer) 1))
  {
    ...
    if (succeeded)
    {
      ...
      succeeded = parse_tree__error_spec____Unify____std_error_spec_0_0(ArgX1_5, ArgY1_6);
    }
  }
  else
  {
  ...
  MR_Word * HeadVar__3_3)
{
  ...
  conv1_ItemPieces_6 = func_0(((MR_Box) (MakeItemPiecesFunc_4)), ((MR_Box) (MR_mkword(1, &parse_tree__error_util_scalar_common_1[7]))), Item_5);
  ...
  MR_Box wrapper_arg_1)
{
  ...
  succeeded = parse_tree__error_util__IntroducedFrom__pred__accumulate_error_specs_for_proc__511__1_1_p_0(((MR_Word) (wrapper_arg_1)));
  return succeeded;
}
  ...
  MR_Word * STATE_VARIABLE_MaybeSpecs_18)
{
  ...
  mercury__list__filter_4_p_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_error_spec_0), (MR_Word) (&parse_tree__error_util_scalar_common_2[3]), ProcSpecs_4, &ProcAllModeSpecs_9, &ProcAnyModeSpecs_10);
    ...
    case (MR_Integer) 1:
      {
...

        {
          ...
          MR_hl_field(0, Var_9, 0) = ((MR_Box) (&parse_tree__error_util_scalar_common_4[2]));
  ...
  MR_Box * wrapper_arg_2)
{
  ...
  parse_tree__error_util__IntroducedFrom__pred__construct_sorted_line_pieces__469__1_3_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) (wrapper_arg_1)), &conv4_HeadVar__3_33);
  ...
  MR_Word * Pieces_6)
{
  ...
  else
  {
    ...
    conv6_LastPieces_16 = func_5(((MR_Box) (MakeItemPiecesFunc_4)), ((MR_Box) (MR_mkword(1, &parse_tree__error_util_scalar_common_1[5]))), LastItem_13);
  ...
  MR_Box wrapper_arg_1)
{
  MR_Box wrapper_arg_2;
  MR_Box closure = closure_arg;
  MR_Word conv0_Spec_4;

  conv0_Spec_4 = parse_tree__error_util__maybe_written_spec_to_spec_1_f_0(((MR_Word) (wrapper_arg_1)));
  wrapper_arg_2 = ((MR_Box) (conv0_Spec_4));
  ...
  MR_Word MaybeWrittenSpecs_3)
{
  ...
  Specs_4 = mercury__list__map_2_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_maybe_written_spec_0), (MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_error_spec_0), (MR_Word) (&parse_tree__error_util_scalar_common_2[2]), MaybeWrittenSpecs_3);
  return Specs_4;
}

MR_Word MR_CALL 
parse_tree__error_util__maybe_written_spec_to_spec_1_f_0(
  MR_Word MaybeWrittenSpec_3)
{
  MR_Word Spec_4;

  if (((MR_tag((MR_Word) MaybeWrittenSpec_3)) == (MR_Integer) 1))
  {
    MR_Word StdSpec_5 = ((MR_Word) ((MR_hl_field(1, MaybeWrittenSpec_3, 0))));

    Spec_4 = (MR_Word) (StdSpec_5);
  }
  else
    Spec_4 = ((MR_Word) ((MR_hl_field(0, MaybeWrittenSpec_3, 0))));
  return Spec_4;
}
  ...
  MR_Box wrapper_arg_2)
{
  ...
  succeeded = parse_tree__error_util____Unify____maybe_written_spec_0_0(((MR_Word) (wrapper_arg_1)), ((MR_Word) (wrapper_arg_2)));
  return succeeded;
}
  ...
  MR_Box wrapper_arg_3)
{
  ...
  parse_tree__error_util____Compare____maybe_written_spec_0_0(&conv0_HeadVar__1_1, ((MR_Word) (wrapper_arg_2)), ((MR_Word) (wrapper_arg_3)));
  *wrapper_arg_1 = ((MR_Box) (conv0_HeadVar__1_1));
}
...
void mercury__parse_tree__error_util__init_type_tables(void)
{
  ...
  MR_register_type_ctor_info(&parse_tree__error_util__parse_tree__error_util__type_ctor_info_maybe_written_spec_0);
}
