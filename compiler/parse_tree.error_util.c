...
static const MR_EnumFunctorDescPtr parse_tree__error_util__parse_tree__error_util__enum_value_ordered_maybe_add_quotes_0[2];
...
const MR_TypeCtorInfo_Struct parse_tree__error_util__parse_tree__error_util__type_ctor_info_maybe_add_quotes_0 = {
  ...
  {     parse_tree__error_util__parse_tree__error_util__enum_value_ordered_maybe_add_quotes_0 },
  (MR_Integer) 2,
  UINT16_C(4),
