...
parse_tree__error_util__IntroducedFrom__pred__accumulate_error_specs_for_proc__357__1_1_p_0(
  ...
  MR_Word LambdaHeadVar__1_20)
{
  ...
  switch (MR_tag((MR_Word) Phase_7)) {
    ...
    case (MR_Integer) 1:
      {
        MR_Word Control_37 = ((MR_Unsigned) ((MR_hl_field(1, Phase_7, (MR_Integer) 0))) & (MR_Integer) 1);

        {
          ModeReportControl_8 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(1, ModeReportControl_8, 0) = ((MR_Box) (Control_37));
        }
      }
      break;
    case (MR_Integer) 2:
  ...
  MR_Word MsgComponent_5)
{
  ...
  switch (MR_tag((MR_Word) MsgComponent_5)) {
    ...
    case (MR_Integer) 1:
      {
        MR_Word Option_13 = ((((MR_Unsigned) ((MR_hl_field(1, MsgComponent_5, (MR_Integer) 0))) >> 1)) & (MR_Integer) 1023);
        MR_Word MatchValue_14 = ((MR_Unsigned) ((MR_hl_field(1, MsgComponent_5, (MR_Integer) 0))) & (MR_Integer) 1);
        MR_Word MsgComponents_15 = ((MR_Word) ((MR_hl_field(1, MsgComponent_5, (MR_Integer) 1))));
        MR_Word OptionValue_16;

        libs__globals__lookup_bool_option_3_p_0(Globals_4, Option_13, &OptionValue_16);
        succeeded = (OptionValue_16 == MatchValue_14);
        if (succeeded)
        {
          MR_Word PrintsList_17;
          MR_Word Var_18;

          {
            Var_18 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
            MR_hl_field(0, Var_18, 0) = ((MR_Box) (&parse_tree__error_util_scalar_common_4[1]));
            MR_hl_field(0, Var_18, 1) = ((MR_Box) (parse_tree__error_util__does_msg_component_print_anything_2_f_0_1));
            MR_hl_field(0, Var_18, 2) = ((MR_Box) ((MR_Integer) 1));
            MR_hl_field(0, Var_18, 3) = ((MR_Box) (Globals_4));
          }
          PrintsList_17 = mercury__list__map_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_error_msg_component_0), (MR_Word) (&mercury__bool__bool__type_ctor_info_bool_0), Var_18, MsgComponents_15);
          mercury__bool__or_list_2_p_0(PrintsList_17, &Prints_6);
        }
        else
  ...
  MR_Word Msg_5)
{
  ...
  switch (MR_tag((MR_Word) Msg_5)) {
    ...
    case (MR_Integer) 2:
      {
        MR_Word MsgComponents_23 = ((MR_Word) ((MR_hl_field(2, Msg_5, (MR_Integer) 1))));
        MR_Word PrintsList_24;
        MR_Word Var_25;

        {
          Var_25 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(0, Var_25, 0) = ((MR_Box) (&parse_tree__error_util_scalar_common_4[1]));
          MR_hl_field(0, Var_25, 1) = ((MR_Box) (parse_tree__error_util__does_msg_print_anything_2_f_0_2));
          MR_hl_field(0, Var_25, 2) = ((MR_Box) ((MR_Integer) 1));
          MR_hl_field(0, Var_25, 3) = ((MR_Box) (Globals_4));
        }
        PrintsList_24 = mercury__list__map_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_error_msg_component_0), (MR_Word) (&mercury__bool__bool__type_ctor_info_bool_0), Var_25, MsgComponents_23);
        mercury__bool__or_list_2_p_0(PrintsList_24, &Prints_6);
      }
      break;
    case (MR_Integer) 3:
      {
        MR_Word MsgComponents_11 = ((MR_Word) ((MR_hl_field(3, Msg_5, (MR_Integer) 3))));
        MR_Word PrintsList_15;
        MR_Word Var_16;

        {
          Var_16 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(0, Var_16, 0) = ((MR_Box) (&parse_tree__error_util_scalar_common_4[1]));
          MR_hl_field(0, Var_16, 1) = ((MR_Box) (parse_tree__error_util__does_msg_print_anything_2_f_0_1));
          MR_hl_field(0, Var_16, 2) = ((MR_Box) ((MR_Integer) 1));
          MR_hl_field(0, Var_16, 3) = ((MR_Box) (Globals_4));
        }
        PrintsList_15 = mercury__list__map_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_error_msg_component_0), (MR_Word) (&mercury__bool__bool__type_ctor_info_bool_0), Var_16, MsgComponents_11);
        mercury__bool__or_list_2_p_0(PrintsList_15, &Prints_6);
      }
      break;
  }
  return Prints_6;
  ...
  MR_Box wrapper_arg_1)
{
  ...
  succeeded = parse_tree__error_util__IntroducedFrom__pred__accumulate_error_specs_for_proc__357__1_1_p_0(((MR_Word) (wrapper_arg_1)));
  return succeeded;
}
  ...
  MR_Word Spec_5)
{
  ...
  switch (MR_tag((MR_Word) Spec_5)) {
    ...
    case (MR_Integer) 0:
      {
        MR_Word Severity_8 = ((MR_Word) ((MR_hl_field(0, Spec_5, (MR_Integer) 1))));
    ...
    case (MR_Integer) 1:
      {
        ...
        MaybeSeverity_6 = parse_tree__error_util__actual_error_severity_2_f_0(Globals_4, Severity_26);
      }
      break;
    case (MR_Integer) 2:
      {
        MR_Word Severity_25 = ((MR_Word) ((MR_hl_field(2, Spec_5, (MR_Integer) 1))));

        MaybeSeverity_6 = parse_tree__error_util__actual_error_severity_2_f_0(Globals_4, Severity_25);
      }
      break;
    case (MR_Integer) 3:
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_4, Option_19, &OptionValue_23);
        succeeded = (OptionValue_23 == MatchValue_20);
        if (succeeded)
          MaybeSeverity_6 = parse_tree__error_util__actual_error_severity_2_f_0(Globals_4, Severity_24);
        else
  ...
  MR_Word Spec_4)
{
  ...
  switch (MR_tag((MR_Word) Spec_4)) {
    ...
    case (MR_Integer) 0:
      {
        MR_Word Msgs_9 = ((MR_Word) ((MR_hl_field(0, Spec_4, (MR_Integer) 3))));
