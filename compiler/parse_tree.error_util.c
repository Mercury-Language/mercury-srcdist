  ...
  MR_Word * HeadVar__3_3)
{
  ...
  MR_Box MR_CALL (* func_0)(MR_Box, MR_Box, MR_Box) = ((MR_Box MR_CALL (*)(MR_Box, MR_Box, MR_Box)) ((MR_hl_field(0, MakeItemPiecesFunc_4, (MR_Integer) 1))));
  ...
  MR_Box * wrapper_arg_2)
{
  ...
  parse_tree__error_util__IntroducedFrom__pred__construct_sorted_line_pieces__438__1_3_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) (wrapper_arg_1)), &conv4_HeadVar__3_33);
  ...
  MR_Box * wrapper_arg_2)
{
  ...
  parse_tree__error_util__construct_sorted_line_pieces_pair_3_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 4)))), wrapper_arg_1, &conv0_HeadVar__3_3);
  ...
  MR_Word * Pieces_6)
{
  ...
  else
  {
    ...
    LastItem_13 = (MR_hl_field(0, Var_18, (MR_Integer) 1));
    {
    ...
    func_5 = ((MR_Box MR_CALL (*)(MR_Box, MR_Box, MR_Box)) ((MR_hl_field(0, MakeItemPiecesFunc_4, (MR_Integer) 1))));
