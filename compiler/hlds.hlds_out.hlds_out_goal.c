...
{
  {
    ...
    switch (MR_tag((MR_Word) RHS_20)) {
      ...
      case (MR_Integer) 2:
        {
          MR_Word Purity_34 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(2), RHS_20, (MR_Integer) 0))) & (MR_Integer) 3);
          MR_Word Groundness_35 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(2), RHS_20, (MR_Integer) 0))) >> (MR_Integer) 2)) & (MR_Integer) 1);
          MR_Word PredOrFunc_36 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(2), RHS_20, (MR_Integer) 0))) >> (MR_Integer) 3)) & (MR_Integer) 1);
...
{
  {
    ...
    if (succeeded)
    {
      ...
      if (!((MaybeRbmmInfo_49 == (MR_Word) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))))))
      {
        ...
        Var_163 = mercury__set__to_sorted_list_1_f_0((MR_Word) (&hlds__hlds_out__hlds_out_goal_scalar_common_1[0]), Created_51);
        mercury__io__write_list_5_p_0((MR_Word) (&hlds__hlds_out__hlds_out_goal_scalar_common_1[0]), Var_163, (MR_String) ", ", (MR_Word) (&hlds__hlds_out__hlds_out_goal_scalar_common_4[2]));
        mercury__io__nl_2_p_0();
        hlds__hlds_out__hlds_out_util__write_indent_3_p_0(Indent_16);
        mercury__io__write_string_3_p_0((MR_String) "% Removed regions: ");
        Var_171 = mercury__set__to_sorted_list_1_f_0((MR_Word) (&hlds__hlds_out__hlds_out_goal_scalar_common_1[0]), Removed_52);
        mercury__io__write_list_5_p_0((MR_Word) (&hlds__hlds_out__hlds_out_goal_scalar_common_1[0]), Var_171, (MR_String) ", ", (MR_Word) (&hlds__hlds_out__hlds_out_goal_scalar_common_4[3]));
        mercury__io__nl_2_p_0();
        hlds__hlds_out__hlds_out_util__write_indent_3_p_0(Indent_16);
        mercury__io__write_string_3_p_0((MR_String) "% Carried regions: ");
        Var_179 = mercury__set__to_sorted_list_1_f_0((MR_Word) (&hlds__hlds_out__hlds_out_goal_scalar_common_1[0]), Carried_53);
        mercury__io__write_list_5_p_0((MR_Word) (&hlds__hlds_out__hlds_out_goal_scalar_common_1[0]), Var_179, (MR_String) ", ", (MR_Word) (&hlds__hlds_out__hlds_out_goal_scalar_common_4[4]));
        mercury__io__nl_2_p_0();
        hlds__hlds_out__hlds_out_util__write_indent_3_p_0(Indent_16);
        mercury__io__write_string_3_p_0((MR_String) "% Allocated into regions: ");
        Var_187 = mercury__set__to_sorted_list_1_f_0((MR_Word) (&hlds__hlds_out__hlds_out_goal_scalar_common_1[0]), Alloc_54);
        mercury__io__write_list_5_p_0((MR_Word) (&hlds__hlds_out__hlds_out_goal_scalar_common_1[0]), Var_187, (MR_String) ", ", (MR_Word) (&hlds__hlds_out__hlds_out_goal_scalar_common_4[5]));
        mercury__io__nl_2_p_0();
        hlds__hlds_out__hlds_out_util__write_indent_3_p_0(Indent_16);
        mercury__io__write_string_3_p_0((MR_String) "% Used regions: ");
        Var_195 = mercury__set__to_sorted_list_1_f_0((MR_Word) (&hlds__hlds_out__hlds_out_goal_scalar_common_1[0]), Used_55);
        mercury__io__write_list_5_p_0((MR_Word) (&hlds__hlds_out__hlds_out_goal_scalar_common_1[0]), Var_195, (MR_String) ", ", (MR_Word) (&hlds__hlds_out__hlds_out_goal_scalar_common_4[6]));
        mercury__io__nl_2_p_0();
      }
    }
    else
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        parse_tree__parse_tree_out_term__mercury_output_vars_5_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), VarSet_13, VarNamePrint_15, ListLFU_76);
        mercury__io__write_string_3_p_0((MR_String) "\n");
        hlds__hlds_out__hlds_out_util__write_indent_3_p_0(Indent_16);
        mercury__io__write_string_3_p_0((MR_String) "% LBU: ");
        parse_tree__parse_tree_out_term__mercury_output_vars_5_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), VarSet_13, VarNamePrint_15, ListLBU_77);
        mercury__io__write_string_3_p_0((MR_String) "\n");
        hlds__hlds_out__hlds_out_util__write_indent_3_p_0(Indent_16);
