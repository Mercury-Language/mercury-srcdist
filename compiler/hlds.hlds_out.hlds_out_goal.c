...
static void MR_CALL 
hlds__hlds_out__hlds_out_goal__IntroducedFrom__pred__do_write_goal__528__1_4_p_0(
  ...
  MR_Box * wrapper_arg_4)
{
  ...
  hlds__hlds_out__hlds_out_goal__IntroducedFrom__pred__do_write_goal__528__1_4_p_0(((MR_String) (wrapper_arg_1)), ((MR_Word) (wrapper_arg_2)));
}
    ...
    case (MR_Integer) 2:
      {
        ...
        mercury__term_subst__var_list_to_term_list_2_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), ArgVars_23, &ArgTerms_130);
        {
