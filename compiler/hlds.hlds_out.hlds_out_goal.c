...
static void MR_CALL 
hlds__hlds_out__hlds_out_goal__IntroducedFrom__pred__do_write_goal__531__1_4_p_0(
  ...
  MR_Word * STATE_VARIABLE_AddCommaNewline_16)
{
  ...
  parse_tree__parse_tree_out_misc__write_indent_4_p_0(Stream_8, Indent_9);
  ...
  MR_Word ConsId_6)
{
  ...
  Var_12 = parse_tree__parse_tree_out_cons_id__cons_id_and_arity_to_string_1_f_0(ConsId_6);
        ...
        case (MR_Integer) 2:
          {
            ...
            {
              parse_tree__parse_tree_out_misc__write_indent_4_p_0(Stream_13, Indent_18);
              switch (ConjType_61) {
                default: /*NOTREACHED*/ MR_assert(0);
                case (MR_Integer) 1:
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      else
      {
        ...
        parse_tree__parse_tree_out_misc__write_indent_4_p_0(Stream_15, Indent_20);
  ...
  MR_Word CasesList_20)
{
  while (MR_TRUE)
  {
    ...
    if (!((CasesList_20 == (MR_Word) ((MR_Unsigned) 0U))))
    {
      ...
      parse_tree__parse_tree_out_misc__write_indent_4_p_0(Stream_13, Var_29);
      mercury__io__write_string_4_p_0(Stream_13, (MR_String) "% ");
      ...
      Var_41 = parse_tree__parse_tree_out_cons_id__cons_id_and_arity_to_string_1_f_0(MainConsId_32);
    ...
    case (MR_Integer) 2:
      {
        ...
        if (!((MaybeIO_31 == (MR_Word) ((MR_Unsigned) 0U))))
        {
          ...
          parse_tree__parse_tree_out_misc__write_indent_4_p_0(Stream_13, Var_73);
        ...
        case (MR_Integer) 7:
          {
            ...
            else
            {
              ...
              parse_tree__parse_tree_out_misc__write_indent_4_p_0(Stream_13, Var_136);
            ...
            else
            {
              ...
              parse_tree__parse_tree_out_misc__write_indent_4_p_0(Stream_13, Var_147);
              ...
              case (MR_Integer) 1:
                {
                  ...
                  else
                  {
                    ...
                    parse_tree__parse_tree_out_misc__write_indent_4_p_0(Stream_13, Var_159);
                    mercury__io__write_string_4_p_0(Stream_13, (MR_String) "io(!");
              ...
              case (MR_Integer) 1:
                {
                  ...
                  parse_tree__parse_tree_out_misc__write_indent_4_p_0(Stream_13, Var_174);
  ...
  MR_Word GoalExpr_20)
{
  ...
  CanFailStr_25 = parse_tree__parse_tree_out_misc__can_fail_to_string_1_f_0(CanFail_23);
  ...
  {
    parse_tree__parse_tree_out_misc__write_indent_4_p_0(Stream_13, Indent1_27);
  ...
  else
  {
    ...
    mercury__io__write_string_4_p_0(Stream_13, (MR_String) " has functor ");
    Var_65 = parse_tree__parse_tree_out_cons_id__cons_id_and_arity_to_string_1_f_0(MainConsId_56);
  ...
  MR_Word GoalExpr_20)
{
  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      Var_53 = parse_tree__parse_tree_out_misc__purity_prefix_to_string_1_f_0(Purity_32);
    ...
    case (MR_Integer) 1:
      {
        ...
        if (succeeded)
        {
          ...
          parse_tree__parse_tree_out_type__mercury_output_type_6_p_0(TVarSet_34, VarNamePrint_19, Type_33, Stream_14);
        }
      }
      break;
    case (MR_Integer) 2:
      {
        ...
        Var_70 = parse_tree__parse_tree_out_misc__purity_prefix_to_string_1_f_0(Purity_36);
              ...
              case (MR_Integer) 1:
                {
                  ...
                  DetStr_133 = parse_tree__parse_tree_out_misc__mercury_det_to_string_1_f_0(Det_42);
                  mercury__io__write_string_4_p_0(Stream_14, (MR_String) " = (");
                  ...
                  parse_tree__parse_tree_out_misc__write_indent_4_p_0(Stream_14, Indent_20);
                  mercury__io__write_string_4_p_0(Stream_14, (MR_String) ")");
                }
                break;
              case (MR_Integer) 0:
                {
                  ...
                  DetStr_50 = parse_tree__parse_tree_out_misc__mercury_det_to_string_1_f_0(Det_42);
                  mercury__io__write_string_4_p_0(Stream_14, (MR_String) " is ");
              ...
              case (MR_Integer) 1:
                {
                  ...
                  DetStr_204 = parse_tree__parse_tree_out_misc__mercury_det_to_string_1_f_0(Det_42);
                  mercury__io__write_string_4_p_0(Stream_14, (MR_String) " = (");
              ...
              case (MR_Integer) 0:
                {
                  ...
                  DetStr_238 = parse_tree__parse_tree_out_misc__mercury_det_to_string_1_f_0(Det_42);
                  mercury__io__write_string_4_p_0(Stream_14, (MR_String) " is ");
        ...
        {
          mercury__io__write_string_4_p_0(Stream_14, (MR_String) " : ");
          parse_tree__parse_tree_out_type__mercury_output_type_6_p_0(TVarSet_135, VarNamePrint_19, Type_134, Stream_14);
        }
  ...
  MR_Box * wrapper_arg_4)
{
  ...
  hlds__hlds_out__hlds_out_goal__IntroducedFrom__pred__do_write_goal__531__1_4_p_0(((MR_String) (wrapper_arg_1)), ((MR_Word) (wrapper_arg_2)));
}
  ...
  MR_Word Goal_20)
{
  ...
  if (succeeded)
  {
    ...
    Var_154 = parse_tree__parse_tree_out_misc__determinism_to_string_1_f_0(Determinism_48);
  ...
  MR_Word HeadVar__7_7)
{
  while (MR_TRUE)
  {
    ...
    if (!((HeadVar__7_7 == (MR_Word) ((MR_Unsigned) 0U))))
    {
      ...
      parse_tree__parse_tree_out_type__mercury_output_type_6_p_0(TVarSet_3, VarNamePrint_5, Type_30, Stream_1);
      if (!((Args_26 == (MR_Word) ((MR_Unsigned) 0U))))
      {
        MR_Word next_value_of_HeadVar__7_7;

        mercury__io__write_string_4_p_0(Stream_1, (MR_String) ",\n");
        parse_tree__parse_tree_out_misc__write_indent_4_p_0(Stream_1, Indent_6);
        // direct tailcall eliminated
        ;
          ...
          case (MR_Integer) 1:
            {
              ...
              parse_tree__parse_tree_out_misc__write_indent_4_p_0(Stream_13, Indent_18);
              Var_70 = parse_tree__parse_tree_out_misc__purity_prefix_to_string_1_f_0(Purity_29);
          ...
          case (MR_Integer) 0:
            {
              ...
              parse_tree__parse_tree_out_misc__write_indent_4_p_0(Stream_13, Indent_18);
              Var_56 = parse_tree__parse_tree_out_misc__purity_prefix_to_string_1_f_0(Purity_29);
    ...
    case (MR_Integer) 1:
      {
        ...
        MR_Word ArgTerms_42;
        MR_Word Term_43;
        MR_Word Var_80 = ((MR_Word) ((MR_hl_field(1, GenericCall_22, (MR_Integer) 1))));
        MR_Word Var_87;
        MR_Word Var_88;

        MethodNum_35 = (MR_Integer) (Var_80);
        succeeded = mercury__string__contains_char_2_p_0(DumpOptions_27, (MR_Char) 108);
        if (succeeded)
        {
          parse_tree__parse_tree_out_misc__write_indent_4_p_0(Stream_13, Indent_18);
        ...
        mercury__term_subst__var_list_to_term_list_2_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), ArgVars_23, &ArgTerms_42);
        {
          ...
          MR_hl_field(1, Var_88, 0) = ((MR_Box) (MethodNumTerm_41));
          MR_hl_field(1, Var_88, 1) = ((MR_Box) (ArgTerms_42));
        }
        {
          Var_87 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(1, Var_87, 0) = ((MR_Box) (TCInfoTerm_40));
        ...
        }
        {
          ...
          MR_hl_field(0, Term_43, 1) = ((MR_Box) (Var_87));
    ...
    case (MR_Integer) 2:
      {
        ...
        {
          Functor_131 = (MR_Word) MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(0, Functor_131, 0) = ((MR_Box) (EventName_44));
        }
        mercury__term_subst__var_list_to_term_list_2_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), ArgVars_23, &ArgTerms_132);
        Var_100 = mercury__term_context__dummy_context_0_f_0();
        {
          Term_133 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(0, Term_133, 0) = ((MR_Box) (Functor_131));
          MR_hl_field(0, Term_133, 1) = ((MR_Box) (ArgTerms_132));
          MR_hl_field(0, Term_133, 2) = ((MR_Box) (Var_100));
        }
        parse_tree__parse_tree_out_term__mercury_output_term_src_6_p_0(VarNameSrc_15, VarNamePrint_17, Term_133, Stream_13);
        mercury__io__write_string_4_p_0(Stream_13, Follow_19);
      }
      break;
    case (MR_Integer) 3:
      {
        ...
        if (succeeded)
        {
          ...
          parse_tree__parse_tree_out_misc__write_indent_4_p_0(Stream_13, Indent_18);
          {
            ...
            MR_hl_field(1, Var_108, 0) = ((MR_Box) (CastTypeString_46));
            MR_hl_field(1, Var_108, 1) = ((MR_Box) (MR_mkword(1, &hlds__hlds_out__hlds_out_goal_scalar_common_1[3])));
          }
          {
          ...
          mercury__io__write_strings_4_p_0(Stream_13, Var_105);
          hlds__hlds_out__hlds_out_goal__write_ho_arg_regs_5_p_0(Stream_13, Indent_18, MaybeArgRegs_25);
        }
          ...
          case (MR_Integer) 1:
            {
              MR_String Var_127;
              MR_Word Var_129;
              MR_Word FuncArgVars_137;
              MR_Word FuncRetVar_138;
              MR_Box conv0_FuncRetVar_138;

              parse_tree__prog_util__pred_args_to_func_args_3_p_0((MR_Word) (&hlds__hlds_out__hlds_out_goal_scalar_common_1[0]), ArgVars_23, &FuncArgVars_137, &conv0_FuncRetVar_138);
              FuncRetVar_138 = ((MR_Word) (conv0_FuncRetVar_138));
              parse_tree__parse_tree_out_misc__write_indent_4_p_0(Stream_13, Indent_18);
              parse_tree__parse_tree_out_term__mercury_output_var_src_6_p_0(VarNameSrc_15, VarNamePrint_17, FuncRetVar_138, Stream_13);
              mercury__io__write_string_4_p_0(Stream_13, (MR_String) " = ");
              {
                Var_129 = (MR_Word) MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL);
                MR_hl_field(0, Var_129, 0) = ((MR_Box) (CastTypeString_46));
              }
              Var_127 = hlds__hlds_out__hlds_out_util__functor_to_string_4_f_0(VarNameSrc_15, VarNamePrint_17, Var_129, FuncArgVars_137);
              mercury__io__write_string_4_p_0(Stream_13, Var_127);
            }
            break;
          case (MR_Integer) 0:
            {
              MR_Word Var_120;
              MR_Word Functor_134;
              MR_Word ArgTerms_135;
              MR_Word Term_136;

              {
                Functor_134 = (MR_Word) MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL);
                MR_hl_field(0, Functor_134, 0) = ((MR_Box) (CastTypeString_46));
              }
              mercury__term_subst__var_list_to_term_list_2_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), ArgVars_23, &ArgTerms_135);
              Var_120 = mercury__term_context__dummy_context_0_f_0();
              {
                Term_136 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
                MR_hl_field(0, Term_136, 0) = ((MR_Box) (Functor_134));
                MR_hl_field(0, Term_136, 1) = ((MR_Box) (ArgTerms_135));
                MR_hl_field(0, Term_136, 2) = ((MR_Box) (Var_120));
              }
              parse_tree__parse_tree_out_misc__write_indent_4_p_0(Stream_13, Indent_18);
              parse_tree__parse_tree_out_term__mercury_output_term_src_6_p_0(VarNameSrc_15, VarNamePrint_17, Term_136, Stream_13);
            }
            break;
        }
        mercury__io__write_string_4_p_0(Stream_13, Follow_19);
  ...
  MR_Word MaybeArgRegs_8)
{
  if (!((MaybeArgRegs_8 == (MR_Word) ((MR_Unsigned) 0U))))
  {
    ...
    parse_tree__parse_tree_out_misc__write_indent_4_p_0(Stream_6, Indent_7);
    ...
    case (MR_Integer) 0:
      {
        ...
        parse_tree__parse_tree_out_misc__write_indent_4_p_0(Stream_12, Indent_17);
        ...
        case (MR_Integer) 1:
          {
            ...
            hlds__hlds_out__hlds_out_mode__mercury_output_unify_mode_5_p_0(Stream_12, InstVarSet_15, Mode_49);
            mercury__io__write_string_4_p_0(Stream_12, (MR_String) "\n");
            parse_tree__parse_tree_out_misc__write_indent_4_p_0(Stream_12, Indent_17);
  ...
  MR_Word ArgModes_22)
{
  ...
  Var_29 = parse_tree__parse_tree_out_cons_id__cons_id_and_arity_to_string_1_f_0(ConsId_20);
  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        parse_tree__parse_tree_out_misc__write_indent_4_p_0(Stream_14, Indent_19);
  ...
  MR_Word HeadVar__5_5)
{
  while (MR_TRUE)
  {
    ...
    if (!((HeadVar__5_5 == (MR_Word) ((MR_Unsigned) 0U))))
    {
      ...
      parse_tree__parse_tree_out_misc__write_indent_4_p_0(HeadVar__1_1, HeadVar__3_3);
      ...
      hlds__hlds_out__hlds_out_mode__mercury_output_unify_mode_5_p_0(HeadVar__1_1, HeadVar__2_2, UnifyMode_19);
  ...
  MR_Integer Indent_14)
{
  ...
  if (succeeded)
  {
    ...
    if (!((MaybeFollowVars_17 == (MR_Word) ((MR_Unsigned) 0U))))
    {
      ...
      parse_tree__parse_tree_out_misc__write_indent_4_p_0(Stream_10, Indent_14);
  ...
  MR_Word HeadVar__5_5)
{
  while (MR_TRUE)
  {
    ...
    if (!((HeadVar__5_5 == (MR_Word) ((MR_Unsigned) 0U))))
    {
      ...
      parse_tree__parse_tree_out_misc__write_indent_4_p_0(Stream_1, Indent_4);
      mercury__io__write_string_4_p_0(Stream_1, (MR_String) "%\t");
  ...
  MR_Word HeadVar__5_5)
{
  while (MR_TRUE)
  {
    ...
    if (!((HeadVar__5_5 == (MR_Word) ((MR_Unsigned) 0U))))
    {
      ...
      parse_tree__parse_tree_out_misc__write_indent_4_p_0(Stream_1, HeadVar__4_4);
      mercury__io__write_string_4_p_0(Stream_1, (MR_String) "%   ");
