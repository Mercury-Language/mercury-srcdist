    ...
    case (MR_Integer) 2:
      {
        ...
        mercury__io__write_string_4_p_0(Stream_13, (MR_String) "event ");
        {
          ...
          MR_hl_field(MR_mktag(0), Functor_130, 0) = ((MR_Box) (EventName_44));
        }
        ...
        Var_99 = mercury__term_context__dummy_context_0_f_0();
        {
          ...
          MR_hl_field(MR_mktag(0), Term_132, 0) = ((MR_Box) (Functor_130));
          MR_hl_field(MR_mktag(0), Term_132, 1) = ((MR_Box) (ArgTerms_131));
          MR_hl_field(MR_mktag(0), Term_132, 2) = ((MR_Box) (Var_99));
        }
    ...
    case (MR_Integer) 3:
      {
        ...
        if (succeeded)
        {
          ...
          hlds__hlds_out__hlds_out_util__write_indent_4_p_0(Stream_13, Indent_18);
          {
            ...
            MR_hl_field(MR_mktag(1), Var_107, 0) = ((MR_Box) (CastTypeString_46));
            MR_hl_field(MR_mktag(1), Var_107, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &hlds__hlds_out__hlds_out_goal_scalar_common_1[3])));
          }
          {
          ...
          case (MR_Integer) 1:
            {
              ...
              mercury__io__write_string_4_p_0(Stream_13, (MR_String) " = ");
              {
                ...
                MR_hl_field(MR_mktag(0), Var_128, 0) = ((MR_Box) (CastTypeString_46));
              }
          ...
          case (MR_Integer) 0:
            {
              ...
              Var_119 = mercury__term_context__dummy_context_0_f_0();
              {
                ...
                MR_hl_field(MR_mktag(0), Term_135, 2) = ((MR_Box) (Var_119));
              }
              hlds__hlds_out__hlds_out_util__write_indent_4_p_0(Stream_13, Indent_18);
