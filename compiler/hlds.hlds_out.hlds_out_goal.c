...
MR_decl_label10(hlds__hlds_out__hlds_out_goal__write_goal_scope_10_0, 55,57,58,44,60,61,62,59,65,67)
MR_decl_label10(hlds__hlds_out__hlds_out_goal__write_goal_scope_10_0, 69,71,73,75,77,79,80,63,81,82)
MR_decl_label10(hlds__hlds_out__hlds_out_goal__write_goal_scope_10_0, 83,139,85,86,87,89,84,93,94,96)
MR_decl_label10(hlds__hlds_out__hlds_out_goal__write_goal_scope_10_0, 97,91,99,101,102,103,104,106,107,108)
MR_decl_label5(hlds__hlds_out__hlds_out_goal__write_goal_scope_10_0, 109,110,111,112,113)
...
MR_BEGIN_MODULE(hlds__hlds_out__hlds_out_goal_module24)
	...
	MR_init_label10(hlds__hlds_out__hlds_out_goal__write_goal_scope_10_0,55,57,58,44,60,61,62,59,65,67)
	MR_init_label10(hlds__hlds_out__hlds_out_goal__write_goal_scope_10_0,69,71,73,75,77,79,80,63,81,82)
	MR_init_label10(hlds__hlds_out__hlds_out_goal__write_goal_scope_10_0,83,139,85,86,87,89,84,93,94,96)
	MR_init_label10(hlds__hlds_out__hlds_out_goal__write_goal_scope_10_0,97,91,99,101,102,103,104,106,107,108)
	MR_init_label5(hlds__hlds_out__hlds_out_goal__write_goal_scope_10_0,109,110,111,112,113)
MR_BEGIN_CODE
...
MR_def_label(hlds__hlds_out__hlds_out_goal__write_goal_scope_10_0,60)
	...
	MR_r4 = MR_sv(13);
	MR_np_call_localret_ent(parse_tree__mercury_to_mercury__mercury_output_var_5_0,
		hlds__hlds_out__hlds_out_goal__write_goal_scope_10_0_i61);
...
MR_def_label(hlds__hlds_out__hlds_out_goal__write_goal_scope_10_0,139)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r4 = MR_sv(11);
...
MR_def_label(hlds__hlds_out__hlds_out_goal__write_goal_scope_10_0,89)
	...
	MR_r1 = (MR_Word) MR_string_const(")\n", 2);
	MR_np_call_localret_ent(io__write_string_3_0,
		hlds__hlds_out__hlds_out_goal__write_goal_scope_10_0_i139);
...
MR_def_label(hlds__hlds_out__hlds_out_goal__write_goal_scope_10_0,91)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_sv(10),0,0)) {
		MR_GOTO_LAB(hlds__hlds_out__hlds_out_goal__write_goal_scope_10_0_i99);
	}
	{
	MR_Word MR_tempr1;
