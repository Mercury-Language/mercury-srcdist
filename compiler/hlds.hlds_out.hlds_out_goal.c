...
{
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        succeeded = ((MR_tag((MR_Word) PostDeathList_66)) == (MR_Integer) 1);
        if (succeeded)
        {
        }
      }
      ...
      if (succeeded)
      {
        ...
        succeeded = ((MR_tag((MR_Word) PostBirthList_70)) == (MR_Integer) 1);
        if (succeeded)
        {
        }
      }
    ...
    if (succeeded)
    {
      ...
      succeeded = ((MR_tag((MR_Word) Var_250)) == (MR_Integer) 1);
      if (succeeded)
      {
        ...
        succeeded = ((MR_tag((MR_Word) Var_251)) == (MR_Integer) 1);
        if (succeeded)
        {
          ...
          succeeded = ((MR_tag((MR_Word) Var_252)) == (MR_Integer) 1);
          if (succeeded)
          {
