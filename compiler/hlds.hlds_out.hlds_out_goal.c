        ...
        if (hlds__hlds_out__hlds_out_goal__succeeded)
          {
            ...
            if (hlds__hlds_out__hlds_out_goal__succeeded)
              {
                hlds__hlds_out__hlds_out_goal__V_43_43 = ((MR_Word) (MR_hl_field(MR_mktag(0), hlds__hlds_out__hlds_out_goal__ComplMode_31, (MR_Integer) 0)));
                hlds__hlds_out__hlds_out_goal__V_46_46 = ((MR_Word) (MR_hl_field(MR_mktag(0), hlds__hlds_out__hlds_out_goal__ComplMode_31, (MR_Integer) 1)));
