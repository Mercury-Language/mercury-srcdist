          ...
          case (MR_Integer) 7:
            {
              ...
              if ((hlds__hlds_out__hlds_out_goal__MaybeCompileTime_30 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
              ...
              else
                {
                  ...
                  {
                    parse_tree__parse_tree_out_clause__mercury_output_trace_expr_4_p_0((MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_trace_compiletime_0, (MR_Word) &hlds__hlds_out__hlds_out_goal_scalar_common_3[8], hlds__hlds_out__hlds_out_goal__CompileTime_36);
                  }
                  {
                    mercury__io__write_string_3_p_0((MR_String) ")");
                  }
              ...
              if ((hlds__hlds_out__hlds_out_goal__MaybeRunTime_31 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
              ...
              else
                {
                  ...
                  {
                    parse_tree__parse_tree_out_clause__mercury_output_trace_expr_4_p_0((MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_trace_runtime_0, (MR_Word) &hlds__hlds_out__hlds_out_goal_scalar_common_3[9], hlds__hlds_out__hlds_out_goal__RunTime_37);
                  }
                  {
                    mercury__io__write_string_3_p_0((MR_String) ")");
                  }
...
{
  {
    ...
    MR_String hlds__hlds_out__hlds_out_goal__V_76_76 = ((MR_String) (MR_hl_field(MR_mktag(0), hlds__hlds_out__hlds_out_goal__Info_11, (MR_Integer) 1)));
    MR_Word hlds__hlds_out__hlds_out_goal__V_77_77 = ((MR_Word) (MR_hl_field(MR_mktag(0), hlds__hlds_out__hlds_out_goal__Info_11, (MR_Integer) 2)));
    MR_Word hlds__hlds_out__hlds_out_goal__V_78_78 = ((MR_Word) (MR_hl_field(MR_mktag(0), hlds__hlds_out__hlds_out_goal__Info_11, (MR_Integer) 3)));
    MR_Word hlds__hlds_out__hlds_out_goal__V_79_79 = ((MR_Word) (MR_hl_field(MR_mktag(0), hlds__hlds_out__hlds_out_goal__Info_11, (MR_Integer) 4)));
    MR_Word hlds__hlds_out__hlds_out_goal__V_84_84;
    ...
    {
      hlds__hlds_out__hlds_out_goal__V_84_84 = hlds__hlds_pred__invalid_pred_id_0_f_0();
    }
    {
      hlds__hlds_out__hlds_out_goal__succeeded = hlds__hlds_pred____Unify____pred_id_0_0(hlds__hlds_out__hlds_out_goal__PredId_20, hlds__hlds_out__hlds_out_goal__V_84_84);
    }
    if (hlds__hlds_out__hlds_out_goal__succeeded)
    ...
    else
      {
        ...
        MR_Word hlds__hlds_out__hlds_out_goal__PredOrFunc_86;
        ...
        {
          hlds__hlds_out__hlds_out_goal__PredOrFunc_86 = hlds__hlds_pred__pred_info_is_pred_or_func_1_f_0(hlds__hlds_out__hlds_out_goal__PredInfo_28);
        }
        {
          parse_tree__prog_out__write_purity_prefix_3_p_0(hlds__hlds_out__hlds_out_goal__Purity_29);
        }
        switch (hlds__hlds_out__hlds_out_goal__PredOrFunc_86) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 1:
            {
