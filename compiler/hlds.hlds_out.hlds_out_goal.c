...
hlds__hlds_out__hlds_out_goal__IntroducedFrom__pred__do_write_goal__527__1_4_p_0(
  ...
  MR_Word HeadVar__2_396)
{
  void MR_CALL (* func_0)(MR_Box, MR_Box, MR_Box, MR_Box, MR_Box *) = ((void MR_CALL (*)(MR_Box, MR_Box, MR_Box, MR_Box, MR_Box *)) ((MR_hl_field(0, (MR_hl_field(0, (MR_Word) (&hlds__hlds_out__hlds_out_goal_scalar_common_2[1]), (MR_Integer) 0)), (MR_Integer) 6))));
