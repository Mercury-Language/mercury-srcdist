...
ml_backend__mlds_to_cs_class__IntroducedFrom__pred__output_enum_constant_for_csharp__293__1_2_p_0(
  MR_Word Lang_17,
  MR_Word HeadVar__2_35);

static MR_bool MR_CALL 
ml_backend__mlds_to_cs_class__IntroducedFrom__pred__output_enum_class_defn_for_csharp__155__1_2_p_0(
  MR_Word Implements_16,
  MR_Word HeadVar__2_68);

static MR_bool MR_CALL 
ml_backend__mlds_to_cs_class__IntroducedFrom__pred__output_enum_class_defn_for_csharp__153__1_2_p_0(
  MR_Word Inherits_15,
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = ml_backend__mlds_to_cs_class__IntroducedFrom__pred__output_enum_constant_for_csharp__293__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 4)))));
  return succeeded;
}
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = ml_backend__mlds_to_cs_class__IntroducedFrom__pred__output_enum_class_defn_for_csharp__155__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 4)))));
  return succeeded;
}
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = ml_backend__mlds_to_cs_class__IntroducedFrom__pred__output_enum_class_defn_for_csharp__153__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 4)))));
  return succeeded;
}
  ...
  MR_Word ClassDefn_10)
{
  ...
  MR_Word Kind_16 = ((MR_Unsigned) ((MR_hl_field(0, ClassDefn_10, (MR_Integer) 4))) & (MR_Integer) 1);
    ...
    case (MR_Integer) 0:
      {
        ...
        *Serializable_11 = (MR_Integer) 1;
        Overridability_21 = Overridability0_18;
