    ...
    case (MR_Integer) 1:
      {
        ...
        if (succeeded)
        {
          Var_32 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Rval_18, (MR_Integer) 1))));
          succeeded = ((((MR_tag((MR_Word) Var_32)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(MR_mktag(3), Var_32, (MR_Integer) 0)))) == (MR_Integer) 9)));
          if (succeeded)
            N_19 = ((MR_Integer) ((MR_hl_field(MR_mktag(3), Var_32, (MR_Integer) 1))));
        }
        if (succeeded)
        ...
        else
        {
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              ...
              String_21 = ((MR_String) ((MR_hl_field(MR_mktag(3), Var_34, (MR_Integer) 2))));
              Type_22 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Var_34, (MR_Integer) 3))));
  ...
  MR_Word FieldVarDefn_10)
{
  ...
  Var_38 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Flags_14, (MR_Integer) 0))) & (MR_Integer) 1);
  switch (Var_35) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 0:
    ...
    case (MR_Integer) 2:
      {
...

        {
          ...
          MR_hl_field(MR_mktag(0), Var_50, 0) = ((MR_Box) (&ml_backend__mlds_to_cs_class_scalar_common_5[1]));
          MR_hl_field(MR_mktag(0), Var_50, 1) = ((MR_Box) (ml_backend__mlds_to_cs_class__output_class_defn_for_csharp_6_p_0_2));
          MR_hl_field(MR_mktag(0), Var_50, 2) = ((MR_Box) ((MR_Integer) 3));
          MR_hl_field(MR_mktag(0), Var_50, 3) = ((MR_Box) (STATE_VARIABLE_Info_39_39));
          MR_hl_field(MR_mktag(0), Var_50, 4) = ((MR_Box) (Stream_8));
          MR_hl_field(MR_mktag(0), Var_50, 5) = ((MR_Box) (Var_52));
        }
        ...
        Var_56 = (MR_Integer) ((MR_Unsigned) Indent_9 + (MR_Unsigned) 1);
        {
          ...
          MR_hl_field(MR_mktag(0), Var_54, 0) = ((MR_Box) (&ml_backend__mlds_to_cs_class_scalar_common_5[2]));
          MR_hl_field(MR_mktag(0), Var_54, 1) = ((MR_Box) (ml_backend__mlds_to_cs_class__output_class_defn_for_csharp_6_p_0_3));
    ...
    case (MR_Integer) 3:
      {
        ...
        ml_backend__mlds_to_cs_class__output_enum_constants_for_csharp_6_p_0(STATE_VARIABLE_Info_39_39, Stream_8, Var_59, EnumConstMemberFields_26);
      }
      break;
  }
  mercury__io__nl_3_p_0(Stream_8);
