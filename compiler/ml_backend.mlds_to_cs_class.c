      ...
      case (MR_Integer) 1:
        {
          ...
          else
          {
            ...
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Var_34, (MR_Integer) 1)));
...
{
  {
    ...
    Var_32 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Flags_14, (MR_Integer) 0))) >> (MR_Integer) 1)) & (MR_Integer) 1);
...
{
  {
    ...
    MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), InterfaceId_3, (MR_Integer) 2)));
    MR_Unsigned packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), QualClassName_5, (MR_Integer) 1)));
...
{
  {
    ...
    packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), ClassDefn_8, (MR_Integer) 4)));
    ...
    packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_Info_0_25, (MR_Integer) 1)));
    ...
    packed_args_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_Info_0_25, (MR_Integer) 5)));
    {
      ...
      MR_hl_field(MR_mktag(0), STATE_VARIABLE_Info_37_37, 1) = (MR_Box) (packed_args_1);
      ...
      MR_hl_field(MR_mktag(0), STATE_VARIABLE_Info_37_37, 5) = (MR_Box) (packed_args_2);
    ...
    packed_args_3 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_Info_37_37, (MR_Integer) 1)));
    packed_args_4 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_Info_37_37, (MR_Integer) 5)));
    OutputGenerics_23 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_Info_37_37, (MR_Integer) 5))) >> (MR_Integer) 2)) & (MR_Integer) 1);
...
{
  {
    MR_Word Access_10 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Flags_7, (MR_Integer) 0))) >> (MR_Integer) 2)) & (MR_Integer) 1);
    MR_Word Overridability0_11 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Flags_7, (MR_Integer) 0))) >> (MR_Integer) 1)) & (MR_Integer) 1);
          ...
          case (MR_Integer) 1:
            {
              ...
              ml_backend__mlds_to_cs_type__type_to_string_for_csharp_4_p_0(Info_7, (MR_Word) ((MR_Unsigned) 28U), &EnvPtrTypeString_18, &_ArrayDims_32);
              {
