    ...
    case (MR_Integer) 0:
      {
        ...
        Var_49 = mercury__string__string_1_f_0((MR_Word) (&ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_initializer_0), ((MR_Box) (Initializer_16)));
        {
          mercury__require__unexpected_2_p_0((MR_String) "predicate \140ml_backend.mlds_to_cs_class.output_enum_constant_for_csharp\'/6", Var_49);
          return;
        }
      }
      break;
    case (MR_Integer) 1:
      {
        ...
        else
        {
          ...
          if (succeeded)
          {
            ...
            Var_40 = ml_backend__mlds_to_cs_type__type_to_string_for_csharp_2_f_0(Info_7, Type_22);
            mercury__io__write_string_4_p_0(Stream_10, (MR_String) "(");
  ...
  MR_Word FieldVarDefn_10)
{
  ...
  ml_backend__mlds_to_cs_type__output_type_for_csharp_5_p_0(Info_7, Stream_8, Type_15);
  ...
  MR_Word Interfaces_12)
{
  ...
  AfterColonStrings0_14 = mercury__list__map_2_f_0((MR_Word) (&ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_interface_id_0), (MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&ml_backend__mlds_to_cs_class_scalar_common_4[0]), Interfaces_12);
  switch (MR_tag((MR_Word) Inherits_11)) {
    ...
    case (MR_Integer) 0:
      switch (MR_unmkbody(Inherits_11)) {
        ...
        case (MR_Integer) 1:
          {
            MR_String EnvPtrTypeName_19;

            EnvPtrTypeName_19 = ml_backend__mlds_to_cs_type__type_to_string_for_csharp_2_f_0(Info_8, (MR_Word) ((MR_Unsigned) 24U));
            {
              AfterColonStrings_15 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(1, AfterColonStrings_15, 0) = ((MR_Box) (EnvPtrTypeName_19));
    ...
    case (MR_Integer) 1:
      {
        ...
        MR_String BaseClassTypeName_18;

        BaseClassTypeName_18 = ml_backend__mlds_to_cs_type__type_to_string_for_csharp_2_f_0(Info_8, BaseClassType_17);
        {
          AfterColonStrings_15 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(1, AfterColonStrings_15, 0) = ((MR_Box) (BaseClassTypeName_18));
          MR_hl_field(1, AfterColonStrings_15, 1) = ((MR_Box) (AfterColonStrings0_14));
        }
      }
      break;
  ...
  {
    MR_String AfterColonString_22;

    AfterColonString_22 = mercury__string__join_list_2_f_0((MR_String) ", ", AfterColonStrings_15);
    ml_backend__mlds_to_target_util__output_n_indents_4_p_0(Stream_9, Indent_10);
    mercury__io__write_string_4_p_0(Stream_9, (MR_String) ": ");
    mercury__io__write_string_4_p_0(Stream_9, AfterColonString_22);
    mercury__io__write_string_4_p_0(Stream_9, (MR_String) "\n");
  }
}
