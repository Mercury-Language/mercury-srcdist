  ...
  MR_Word ClassDefn_10)
{
  ...
  Ctors_24 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ClassDefn_10, (MR_Integer) 12))));
  {
    ...
    MR_hl_field(MR_mktag(0), Var_31, 0) = ((MR_Box) (&ml_backend__mlds_to_cs_class_scalar_common_3[1]));
    ...
    case (MR_Integer) 2:
      {
...

        {
          ...
          MR_hl_field(MR_mktag(0), Var_54, 0) = ((MR_Box) (&ml_backend__mlds_to_cs_class_scalar_common_5[1]));
        ...
        Var_60 = (MR_Integer) ((MR_Unsigned) Indent_9 + (MR_Unsigned) 1);
        {
          ...
          MR_hl_field(MR_mktag(0), Var_58, 0) = ((MR_Box) (&ml_backend__mlds_to_cs_class_scalar_common_5[2]));
  ...
  }
  {
    ...
    MR_hl_field(MR_mktag(0), Var_63, 0) = ((MR_Box) (&ml_backend__mlds_to_cs_class_scalar_common_7[0]));
  ...
  MR_Word EnumConsts_10)
{
...

  {
    ...
    MR_hl_field(MR_mktag(0), Var_14, 0) = ((MR_Box) (&ml_backend__mlds_to_cs_class_scalar_common_5[0]));
