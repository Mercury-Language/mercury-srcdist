    ...
    case (MR_Integer) 3:
      {
        ...
        Var_51 = (MR_Integer) ((MR_Unsigned) Indent_9 + (MR_Unsigned) 2);
        {
          ...
          MR_hl_field(MR_mktag(0), Var_111, 0) = ((MR_Box) (&ml_backend__mlds_to_cs_class_scalar_common_5[2]));
          MR_hl_field(MR_mktag(0), Var_111, 1) = ((MR_Box) (ml_backend__mlds_to_cs_class__output_class_defn_for_csharp_6_p_0_5));
          MR_hl_field(MR_mktag(0), Var_111, 2) = ((MR_Box) ((MR_Integer) 2));
          MR_hl_field(MR_mktag(0), Var_111, 3) = ((MR_Box) (STATE_VARIABLE_Info_39_39));
          MR_hl_field(MR_mktag(0), Var_111, 4) = ((MR_Box) (Var_51));
        }
        parse_tree__parse_tree_out_info__write_out_list_6_p_0((MR_Word) (&ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_field_var_defn_0), Var_111, (MR_String) "\n", EnumConstMemberFields_26, Stream_8);
        mercury__io__nl_3_p_0(Stream_8);
      }
      break;
  }
