...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 493, &EmitCLoops_20);
    libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 147, &GenerateBytecode_21);
    libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 496, &LocalThreadEngineBase_22);
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 492, &UseMacroForRedoFail_30);
