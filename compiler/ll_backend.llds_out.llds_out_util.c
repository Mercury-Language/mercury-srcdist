  ...
  MR_Word AllocSiteMap_15)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 478, &AutoCommentsOption_18);
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 475, &ForeignLineNumbers_20);
