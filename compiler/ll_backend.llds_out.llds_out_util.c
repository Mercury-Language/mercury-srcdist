  ...
  MR_Word AllocSiteMap_17)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_13, (MR_Integer) 461, &AutoCommentsOption_20);
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_13, (MR_Integer) 458, &ForeignLineNumbers_22);
