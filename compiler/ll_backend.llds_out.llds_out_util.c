...
MR_decl_label2(__Compare___ll_backend__llds_out__llds_out_util__llds_out_info_0_0, 77,165)
...
MR_BEGIN_MODULE(ll_backend__llds_out__llds_out_util_module12)
	...
	MR_init_label2(__Compare___ll_backend__llds_out__llds_out_util__llds_out_info_0_0,77,165)
MR_BEGIN_CODE
...
MR_def_label(__Compare___ll_backend__llds_out__llds_out_util__llds_out_info_0_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___ll_backend__llds_out__llds_out_util__llds_out_info_0_0_i165);
	}
	MR_r1 = MR_sv(1);
	MR_r2 = MR_sv(20);
...
MR_def_label(__Compare___ll_backend__llds_out__llds_out_util__llds_out_info_0_0,165)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(39);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
