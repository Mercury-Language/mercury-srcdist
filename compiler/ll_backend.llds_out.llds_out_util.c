  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          TypeInfo__54_54 = (MR_Word) (&ll_backend__llds_out__llds_out_util_scalar_common_2[0]);
          succeeded = mercury__builtin__unify_2_p_0(TypeInfo__54_54, ((MR_Box) (ArgX4_9)), ((MR_Box) (ArgY4_10)));
          if (succeeded)
          {
            TypeInfo__55_55 = (MR_Word) (&ll_backend__llds_out__llds_out_util_scalar_common_2[1]);
            succeeded = mercury__builtin__unify_2_p_0(TypeInfo__55_55, ((MR_Box) (ArgX5_11)), ((MR_Box) (ArgY5_12)));
            if (succeeded)
            {
              TypeInfo__56_56 = (MR_Word) (&ll_backend__llds_out__llds_out_util_scalar_common_2[2]);
              succeeded = mercury__builtin__unify_2_p_0(TypeInfo__56_56, ((MR_Box) (ArgX6_13)), ((MR_Box) (ArgY6_14)));
              if (succeeded)
              {
                TypeInfo__57_57 = (MR_Word) (&ll_backend__llds_out__llds_out_util_scalar_common_2[3]);
                succeeded = mercury__builtin__unify_2_p_0(TypeInfo__57_57, ((MR_Box) (ArgX7_15)), ((MR_Box) (ArgY7_16)));
                if (succeeded)
                {
  ...
  MR_Word AllocSiteMap_15)
{
  ...
  libs__globals__get_trace_level_2_p_0(Globals_11, &TraceLevel_35);
  {
    ...
    MR_hl_field(MR_mktag(0), Info_16, 7) = (MR_Box) (((((MR_Unsigned) (AutoComments_19) << 17)) | (((((MR_Unsigned) (ForeignLineNumbers_20) << 16)) | (((((MR_Unsigned) (EmitCLoops_22) << 15)) | (((((MR_Unsigned) (GenerateBytecode_23) << 14)) | (((((MR_Unsigned) (LocalThreadEngineBase_24) << 13)) | (((((MR_Unsigned) (ProfileCalls_25) << 12)) | (((((MR_Unsigned) (ProfileTime_26) << 11)) | (((((MR_Unsigned) (ProfileMemory_27) << 10)) | (((((MR_Unsigned) (ProfileDeep_28) << 9)) | (((((MR_Unsigned) (UnboxedFloat_29) << 8)) | (((((MR_Unsigned) (DetStackDwordAligment_30) << 7)) | (((((MR_Unsigned) (StaticGroundFloats_31) << 6)) | (((((MR_Unsigned) (UnboxedInt64s_32) << 5)) | (((((MR_Unsigned) (StaticGroundInt64s_33) << 4)) | (((((MR_Unsigned) (UseMacroForRedoFail_34) << 3)) | (MR_Unsigned) (TraceLevel_35)))))))))))))))))))))))))))))));
