...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 495, &EmitCLoops_20);
    libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 150, &GenerateBytecode_21);
    libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 498, &LocalThreadEngineBase_22);
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 494, &UseMacroForRedoFail_32);
