...
{
  {
    ...
    MR_Word EmitCLoops_21;
    MR_Word GenerateBytecode_22;
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 514, &EmitCLoops_21);
    libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 155, &GenerateBytecode_22);
    libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 517, &LocalThreadEngineBase_23);
    libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 220, &ProfileCalls_24);
    libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 221, &ProfileTime_25);
    libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 222, &ProfileMemory_26);
    libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 223, &ProfileDeep_27);
    libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 268, &UnboxedFloat_28);
    libs__globals__double_width_floats_on_det_stack_2_p_0(Globals_11, &DetStackDwordAligment_29);
    libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 481, &StaticGroundFloats_30);
    libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 269, &UnboxedInt64s_31);
    libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 482, &StaticGroundInt64s_32);
    libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 513, &UseMacroForRedoFail_33);
    libs__globals__get_trace_level_2_p_0(Globals_11, &TraceLevel_34);
    {
      ...
      MR_hl_field(MR_mktag(0), Info_16, 7) = (MR_Box) (((((MR_Unsigned) (AutoComments_19) << 17)) | (((((MR_Unsigned) (ForeignLineNumbers_20) << 16)) | (((((MR_Unsigned) (EmitCLoops_21) << 15)) | (((((MR_Unsigned) (GenerateBytecode_22) << 14)) | (((((MR_Unsigned) (LocalThreadEngineBase_23) << 13)) | (((((MR_Unsigned) (ProfileCalls_24) << 12)) | (((((MR_Unsigned) (ProfileTime_25) << 11)) | (((((MR_Unsigned) (ProfileMemory_26) << 10)) | (((((MR_Unsigned) (ProfileDeep_27) << 9)) | (((((MR_Unsigned) (UnboxedFloat_28) << 8)) | (((((MR_Unsigned) (DetStackDwordAligment_29) << 7)) | (((((MR_Unsigned) (StaticGroundFloats_30) << 6)) | (((((MR_Unsigned) (UnboxedInt64s_31) << 5)) | (((((MR_Unsigned) (StaticGroundInt64s_32) << 4)) | (((((MR_Unsigned) (UseMacroForRedoFail_33) << 3)) | (MR_Unsigned) (TraceLevel_34)))))))))))))))))))))))))))))));
