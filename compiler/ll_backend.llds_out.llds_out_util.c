...
{
  {
    ...
    {
      libs__globals__lookup_bool_option_3_p_0(ll_backend__llds_out__llds_out_util__Globals_11, (MR_Integer) 147, &ll_backend__llds_out__llds_out_util__AutoComments_18);
    }
    {
      libs__globals__lookup_bool_option_3_p_0(ll_backend__llds_out__llds_out_util__Globals_11, (MR_Integer) 145, &ll_backend__llds_out__llds_out_util__ForeignLineNumbers_19);
    }
    {
    ...
    {
      libs__globals__lookup_bool_option_3_p_0(ll_backend__llds_out__llds_out_util__Globals_11, (MR_Integer) 143, &ll_backend__llds_out__llds_out_util__GenerateBytecode_21);
    }
    {
    ...
    {
      libs__globals__lookup_bool_option_3_p_0(ll_backend__llds_out__llds_out_util__Globals_11, (MR_Integer) 197, &ll_backend__llds_out__llds_out_util__ProfileCalls_23);
    }
    {
      libs__globals__lookup_bool_option_3_p_0(ll_backend__llds_out__llds_out_util__Globals_11, (MR_Integer) 198, &ll_backend__llds_out__llds_out_util__ProfileTime_24);
    }
    {
      libs__globals__lookup_bool_option_3_p_0(ll_backend__llds_out__llds_out_util__Globals_11, (MR_Integer) 199, &ll_backend__llds_out__llds_out_util__ProfileMemory_25);
    }
    {
      libs__globals__lookup_bool_option_3_p_0(ll_backend__llds_out__llds_out_util__Globals_11, (MR_Integer) 200, &ll_backend__llds_out__llds_out_util__ProfileDeep_26);
    }
    {
      libs__globals__lookup_bool_option_3_p_0(ll_backend__llds_out__llds_out_util__Globals_11, (MR_Integer) 248, &ll_backend__llds_out__llds_out_util__UnboxedFloat_27);
    }
    {
