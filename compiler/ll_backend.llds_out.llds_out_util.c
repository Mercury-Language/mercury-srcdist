  ...
  MR_Word AllocSiteMap_15)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 461, &AutoCommentsOption_18);
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 458, &ForeignLineNumbers_20);
