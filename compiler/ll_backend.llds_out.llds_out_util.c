...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(ll_backend__llds_out__llds_out_util__Globals_11, (MR_Integer) 490, &ll_backend__llds_out__llds_out_util__EmitCLoops_20);
    ...
    libs__globals__lookup_bool_option_3_p_0(ll_backend__llds_out__llds_out_util__Globals_11, (MR_Integer) 493, &ll_backend__llds_out__llds_out_util__LocalThreadEngineBase_22);
    ...
    libs__globals__lookup_bool_option_3_p_0(ll_backend__llds_out__llds_out_util__Globals_11, (MR_Integer) 489, &ll_backend__llds_out__llds_out_util__UseMacroForRedoFail_30);
