  ...
  MR_Word AllocSiteMap_15)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 438, &AutoCommentsOption_18);
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 435, &ForeignLineNumbers_20);
