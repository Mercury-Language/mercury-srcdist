  ...
  MR_Word PredLabel_6)
{
  ...
  {
    MR_String PredName_19 = ((MR_String) ((MR_hl_field(1, PredLabel_6, (MR_Integer) 0))));
    MR_Word MaybeTypeModule_20 = ((MR_Word) ((MR_hl_field(1, PredLabel_6, (MR_Integer) 1))));
    MR_String TypeName_21 = ((MR_String) ((MR_hl_field(1, PredLabel_6, (MR_Integer) 2))));
    MR_Integer TypeArity_22 = ((MR_Integer) ((MR_hl_field(1, PredLabel_6, (MR_Integer) 3))));
    MR_String MangledPredName_23;
    MR_String MangledTypeName_24;
    MR_String Var_70;

    MangledPredName_23 = parse_tree__prog_foreign__name_mangle_no_leading_digit_1_f_0(PredName_19);
    ...
    {
      MR_Word TypeModule_25 = ((MR_Word) ((MR_hl_field(1, MaybeTypeModule_20, (MR_Integer) 0))));
      MR_String Var_77;

      Var_77 = parse_tree__prog_foreign__sym_name_mangle_1_f_0(TypeModule_25);
      mercury__io__write_string_4_p_0(Stream_5, Var_77);
      mercury__io__write_string_4_p_0(Stream_5, (MR_String) "__");
    }
    mercury__io__write_string_4_p_0(Stream_5, MangledTypeName_24);
    mercury__io__write_string_4_p_0(Stream_5, (MR_String) "_");
    mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&ml_backend__mlds_to_java_name_scalar_common_1[0]), TypeArity_22, &Var_70);
    mercury__io__write_string_4_p_0(Stream_5, Var_70);
  }
  else
  {
    MR_Word PredOrFunc_8 = ((MR_Unsigned) ((MR_hl_field(0, PredLabel_6, (MR_Integer) 0))) & (MR_Integer) 1);
    MR_Word MaybeDefiningModule_9 = ((MR_Word) ((MR_hl_field(0, PredLabel_6, (MR_Integer) 1))));
    MR_String Name_10 = ((MR_String) ((MR_hl_field(0, PredLabel_6, (MR_Integer) 2))));
    MR_Word PredFormArity_11 = ((MR_Word) ((MR_hl_field(0, PredLabel_6, (MR_Integer) 3))));
    MR_Integer PredFormArityInt_14 = (MR_Integer) (PredFormArity_11);
    MR_String Suffix_15;
    ...
    switch (PredOrFunc_8) {
      ...
      case (MR_Integer) 1:
        {
          Suffix_15 = (MR_String) "f";
          UserArityInt_16 = (MR_Integer) ((MR_Unsigned) PredFormArityInt_14 - (MR_Unsigned) 1);
        }
        break;
      case (MR_Integer) 0:
        {
          Suffix_15 = (MR_String) "p";
          UserArityInt_16 = PredFormArityInt_14;
        }
        break;
    }
    MangledName_17 = parse_tree__prog_foreign__name_mangle_no_leading_digit_1_f_0(Name_10);
    mercury__io__write_string_4_p_0(Stream_5, MangledName_17);
    mercury__io__write_string_4_p_0(Stream_5, (MR_String) "_");
    mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&ml_backend__mlds_to_java_name_scalar_common_1[0]), UserArityInt_16, &Var_58);
    mercury__io__write_string_4_p_0(Stream_5, Var_58);
    mercury__io__write_string_4_p_0(Stream_5, (MR_String) "_");
    mercury__io__write_string_4_p_0(Stream_5, Suffix_15);
    if (!((MaybeDefiningModule_9 == (MR_Word) ((MR_Unsigned) 0U))))
    {
      MR_Word DefiningModule_18 = ((MR_Word) ((MR_hl_field(1, MaybeDefiningModule_9, (MR_Integer) 0))));
      MR_String Var_78;

      mercury__io__write_string_4_p_0(Stream_5, (MR_String) "_in__");
      Var_78 = parse_tree__prog_foreign__sym_name_mangle_1_f_0(DefiningModule_18);
