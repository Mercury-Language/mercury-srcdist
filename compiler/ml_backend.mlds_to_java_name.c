  ...
  MR_Word FunctionName_6)
{
  ...
  else
  {
    ...
    mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&ml_backend__mlds_to_java_name_scalar_common_1[0]), ModeNum_15, &Var_29);
    ...
    case (MR_Integer) 3:
      {
        ...
        MR_String JavaSafeName_25;

        NameStr_10 = ml_backend__mlds__ml_global_const_var_name_to_string_2_f_0(ConstVar_8, Num_9);
        MangledName_24 = parse_tree__prog_foreign__name_mangle_1_f_0(NameStr_10);
        JavaSafeName_25 = parse_tree__java_names__make_valid_java_symbol_name_1_f_0(MangledName_24);
        mercury__io__write_string_4_p_0(Stream_5, JavaSafeName_25);
      }
      break;
  }
}
  ...
  MR_Word PredLabel_6)
{
  if (((MR_tag((MR_Word) PredLabel_6)) == (MR_Integer) 1))
  {
    ...
    if (!((MaybeTypeModule_19 == (MR_Word) ((MR_Unsigned) 0U))))
    {
      ...
      Var_75 = parse_tree__prog_foreign__sym_name_mangle_1_f_0(TypeModule_24);
      mercury__io__write_string_4_p_0(Stream_5, Var_75);
      mercury__io__write_string_4_p_0(Stream_5, (MR_String) "__");
    }
    mercury__io__write_string_4_p_0(Stream_5, MangledTypeName_23);
    mercury__io__write_string_4_p_0(Stream_5, (MR_String) "_");
    mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&ml_backend__mlds_to_java_name_scalar_common_1[0]), TypeArity_21, &Var_68);
  ...
  else
  {
    ...
    mercury__io__write_string_4_p_0(Stream_5, (MR_String) "_");
    mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&ml_backend__mlds_to_java_name_scalar_common_1[0]), OrigArity_15, &Var_56);
    ...
    if (!((MaybeDefiningModule_9 == (MR_Word) ((MR_Unsigned) 0U))))
    {
      ...
      Var_76 = parse_tree__prog_foreign__sym_name_mangle_1_f_0(DefiningModule_17);
      mercury__io__write_string_4_p_0(Stream_5, Var_76);
    }
  }
}
