...
{
  {
    ...
    MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), QualClassName_4, (MR_Integer) 1)));
    MR_Word SymName_10;
    MR_Word Var_16;
    ...
    case (MR_Integer) 3:
      {
        ...
        MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), GlobalVarName_4, (MR_Integer) 0)));
  ...
  MR_Word PredLabel_4)
{
  ...
  else
  {
    ...
    MR_String MangledName_14;
    MR_String Var_55;
    MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), PredLabel_4, (MR_Integer) 0)));
    MR_Unsigned packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), PredLabel_4, (MR_Integer) 4)));
