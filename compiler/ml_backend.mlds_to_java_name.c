  ...
  MR_Word QualFuncName_5)
{
  ...
  MR_Word FuncModule_7 = ((MR_Word) ((MR_hl_field(0, QualFuncName_5, 0))));
  MR_Word FuncName_8 = ((MR_Word) ((MR_hl_field(0, QualFuncName_5, 1))));
  ...
  CurrentModule_10 = ((MR_Word) ((MR_hl_field(0, Info_4, 2))));
  ...
  MR_Word FunctionName_3)
{
  ...
  if (((MR_tag((MR_Word) FunctionName_3)) == (MR_Integer) 1))
    FunctionNameStr_4 = ((MR_String) ((MR_hl_field(1, FunctionName_3, 0))));
  else
  {
    MR_Word PlainFuncName_5 = (MR_Word) ((MR_Word) (FunctionName_3));
    MR_Word FuncLabel_6 = ((MR_Word) ((MR_hl_field(0, PlainFuncName_5, 0))));
    MR_Word ProcLabel_8 = ((MR_Word) ((MR_hl_field(0, FuncLabel_6, 0))));
    MR_Word MaybeAux_9 = ((MR_Word) ((MR_hl_field(0, FuncLabel_6, 1))));
    MR_Word PredLabel_10 = ((MR_Word) ((MR_hl_field(0, ProcLabel_8, 0))));
    MR_Integer ProcId_11 = ((MR_Integer) ((MR_hl_field(0, ProcLabel_8, 1))));
    ...
    hlds__pred_proc_id__proc_id_to_int_2_p_0(ProcId_11, &ModeNum_13);
  ...
  MR_Integer Arity_5)
{
  ...
  MR_Word MLDS_ModuleName_7 = ((MR_Word) ((MR_hl_field(0, QualClassName_4, 0))));
  MR_Word QualKind_8 = ((MR_Unsigned) ((MR_hl_field(0, QualClassName_4, 1))) & (MR_Integer) 1);
  MR_String ClassName_9 = ((MR_String) ((MR_hl_field(0, QualClassName_4, 2))));
  MR_Word SymName_10;
  MR_Word Var_20;
  ...
  MR_Word QualGlobalVarName_5)
{
  ...
  MR_Word GlobalVarModule_7 = ((MR_Word) ((MR_hl_field(0, QualGlobalVarName_5, 0))));
  MR_Word GlobalVarName_8 = ((MR_Word) ((MR_hl_field(0, QualGlobalVarName_5, 1))));
  ...
  MR_Word GlobalVarName_3)
{
  ...
  switch (MR_tag((MR_Word) GlobalVarName_3)) {
    ...
    case (MR_Integer) 1:
      {
        MR_Word RttiId_8 = ((MR_Word) ((MR_hl_field(1, GlobalVarName_3, 0))));
    ...
    case (MR_Integer) 2:
      {
        MR_Word ProcLabel_10 = ((MR_Word) ((MR_hl_field(2, GlobalVarName_3, 0))));
        MR_Word TablingStructId_11 = ((MR_Word) ((MR_hl_field(2, GlobalVarName_3, 1))));
    ...
    case (MR_Integer) 3:
      {
        MR_Word ConstVar_5 = ((MR_Unsigned) ((MR_hl_field(3, GlobalVarName_3, 0))) & (MR_Integer) 7);
        MR_Unsigned Num_6 = ((MR_Unsigned) ((MR_hl_field(3, GlobalVarName_3, 1))));
        MR_String NameStr_7;
  ...
  MR_Word ProcLabel_3)
{
  ...
  MR_Word PredLabel_5 = ((MR_Word) ((MR_hl_field(0, ProcLabel_3, 0))));
  MR_Integer ProcId_6 = ((MR_Integer) ((MR_hl_field(0, ProcLabel_3, 1))));
  ...
  hlds__pred_proc_id__proc_id_to_int_2_p_0(ProcId_6, &ModeNum_8);
  ...
  MR_Word PredLabel_3)
{
  ...
  {
    MR_String PredName_14 = ((MR_String) ((MR_hl_field(1, PredLabel_3, 0))));
    MR_Word MaybeTypeModule_15 = ((MR_Word) ((MR_hl_field(1, PredLabel_3, 1))));
    MR_String TypeName_16 = ((MR_String) ((MR_hl_field(1, PredLabel_3, 2))));
    MR_Integer TypeArity_17 = ((MR_Integer) ((MR_hl_field(1, PredLabel_3, 3))));
    ...
    {
      MR_Word TypeModule_20 = ((MR_Word) ((MR_hl_field(1, MaybeTypeModule_15, 0))));
  ...
  {
    MR_Word PredOrFunc_5 = ((MR_Unsigned) ((MR_hl_field(0, PredLabel_3, 0))) & (MR_Integer) 1);
    MR_Word MaybeDefiningModule_6 = ((MR_Word) ((MR_hl_field(0, PredLabel_3, 1))));
    MR_String Name_7 = ((MR_String) ((MR_hl_field(0, PredLabel_3, 2))));
    MR_Word PredFormArity_8 = ((MR_Word) ((MR_hl_field(0, PredLabel_3, 3))));
    ...
    {
      MR_Word DefiningModule_13 = ((MR_Word) ((MR_hl_field(1, MaybeDefiningModule_6, 0))));
      MR_String Var_32;
      MR_String Var_61;
      MR_String Var_62;
      MR_String Var_64;
