...
{
  {
    ...
    MR_Word ml_backend__ml_disj_gen__Var_78;
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), ml_backend__ml_disj_gen__Var_76, 0) = ((MR_Box) (ml_backend__ml_disj_gen__SlotVarDefn_32));
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), ml_backend__ml_disj_gen__Var_79, 0) = ((MR_Box) (ml_backend__ml_disj_gen__LoopStatement_45));
      MR_hl_field(MR_mktag(1), ml_backend__ml_disj_gen__Var_79, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
    }
    {
      ml_backend__ml_disj_gen__Var_78 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), ml_backend__ml_disj_gen__Var_78, 0) = ((MR_Box) (ml_backend__ml_disj_gen__InitSlotVarStatement_38));
      MR_hl_field(MR_mktag(1), ml_backend__ml_disj_gen__Var_78, 1) = ((MR_Box) (ml_backend__ml_disj_gen__Var_79));
    }
    {
      ...
      MR_hl_field(MR_mktag(0), ml_backend__ml_disj_gen__Stmt_46, 1) = ((MR_Box) (ml_backend__ml_disj_gen__Var_78));
    }
    {
