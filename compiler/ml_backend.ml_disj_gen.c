...
{
  {
    ...
    MR_Word ml_backend__ml_disj_gen__Var_57;
    MR_Word ml_backend__ml_disj_gen__Var_61;
    ...
    MR_Word ml_backend__ml_disj_gen__Var_77;
    MR_Word ml_backend__ml_disj_gen__Var_79;
    MR_Word ml_backend__ml_disj_gen__Var_80;
    ...
    {
      ml_backend__ml_disj_gen__Var_50 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), ml_backend__ml_disj_gen__Var_50, 0) = ((MR_Box) (&ml_backend__ml_disj_gen_scalar_common_4[0]));
      MR_hl_field(MR_mktag(0), ml_backend__ml_disj_gen__Var_50, 1) = ((MR_Box) (ml_backend__ml_disj_gen__ml_gen_lookup_disj_6_p_0_1));
      MR_hl_field(MR_mktag(0), ml_backend__ml_disj_gen__Var_50, 2) = ((MR_Box) (MR_Word) ((MR_Integer) 1));
      MR_hl_field(MR_mktag(0), ml_backend__ml_disj_gen__Var_50, 3) = ((MR_Box) (ml_backend__ml_disj_gen__ModuleInfo_12));
    }
    {
      ml_backend__ml_disj_gen__MLDS_FieldTypes_19 = mercury__list__map_2_f_0((MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0, (MR_Word) &ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_type_0, ml_backend__ml_disj_gen__Var_50, ml_backend__ml_disj_gen__FieldTypes_18);
    }
    {
    ...
    {
      ml_backend__ml_gen_info__ml_gen_info_new_aux_var_name_4_p_0((MR_Integer) 1, &ml_backend__ml_disj_gen__SlotVar_29, ml_backend__ml_disj_gen__STATE_VARIABLE_Info_51_51, &ml_backend__ml_disj_gen__STATE_VARIABLE_Info_53_53);
    }
    ml_backend__ml_disj_gen__SlotVarType_30 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 2));
    {
      ml_backend__ml_disj_gen__Var_54 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(3), ml_backend__ml_disj_gen__Var_54, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 0));
      MR_hl_field(MR_mktag(3), ml_backend__ml_disj_gen__Var_54, 1) = ((MR_Box) (ml_backend__ml_disj_gen__SlotVar_29));
    }
    {
      ml_backend__ml_disj_gen__SlotVarDefn_32 = ml_backend__ml_code_util__ml_gen_mlds_var_decl_4_f_0(ml_backend__ml_disj_gen__Var_54, ml_backend__ml_disj_gen__SlotVarType_30, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), ml_backend__ml_disj_gen__MLDS_Context_15);
    }
    {
    ...
    {
      ml_backend__ml_disj_gen__Var_57 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(2), ml_backend__ml_disj_gen__Var_57, 0) = ((MR_Box) (ml_backend__ml_disj_gen__SlotVarLval_33));
      MR_hl_field(MR_mktag(2), ml_backend__ml_disj_gen__Var_57, 1) = ((MR_Box) (MR_mkword(MR_mktag(3), &ml_backend__ml_disj_gen_scalar_common_1[1])));
    }
    {
      ...
      MR_hl_field(MR_mktag(3), ml_backend__ml_disj_gen__InitSlotVarStmt_37, 1) = ((MR_Box) (ml_backend__ml_disj_gen__Var_57));
    }
    {
    ...
    {
      ml_backend__ml_disj_gen__Var_62 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(3), ml_backend__ml_disj_gen__Var_62, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 2));
      MR_hl_field(MR_mktag(3), ml_backend__ml_disj_gen__Var_62, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
      MR_hl_field(MR_mktag(3), ml_backend__ml_disj_gen__Var_62, 2) = ((MR_Box) (ml_backend__ml_disj_gen__SlotVarRval_34));
      MR_hl_field(MR_mktag(3), ml_backend__ml_disj_gen__Var_62, 3) = ((MR_Box) (MR_mkword(MR_mktag(3), &ml_backend__ml_disj_gen_scalar_common_1[2])));
    }
    {
      ml_backend__ml_disj_gen__Var_61 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(2), ml_backend__ml_disj_gen__Var_61, 0) = ((MR_Box) (ml_backend__ml_disj_gen__SlotVarLval_33));
      MR_hl_field(MR_mktag(2), ml_backend__ml_disj_gen__Var_61, 1) = ((MR_Box) (ml_backend__ml_disj_gen__Var_62));
    }
    {
      ...
      MR_hl_field(MR_mktag(3), ml_backend__ml_disj_gen__IncrSlotVarStmt_39, 1) = ((MR_Box) (ml_backend__ml_disj_gen__Var_61));
    }
    {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), ml_backend__ml_disj_gen__Var_70, 0) = ((MR_Box) (ml_backend__ml_disj_gen__IncrSlotVarStatement_40));
      MR_hl_field(MR_mktag(1), ml_backend__ml_disj_gen__Var_70, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
    }
    {
      ml_backend__ml_disj_gen__Var_69 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), ml_backend__ml_disj_gen__Var_69, 0) = ((MR_Box) (ml_backend__ml_disj_gen__CallContStatement_36));
      MR_hl_field(MR_mktag(1), ml_backend__ml_disj_gen__Var_69, 1) = ((MR_Box) (ml_backend__ml_disj_gen__Var_70));
    }
    {
      ml_backend__ml_disj_gen__Var_68 = mercury__list__f_43_43_2_f_0((MR_Word) &ml_backend__mlds__ml_backend__mlds__type_ctor_info_statement_0, ml_backend__ml_disj_gen__LookupStatements_35, ml_backend__ml_disj_gen__Var_69);
    }
    {
      ...
      MR_hl_field(MR_mktag(0), ml_backend__ml_disj_gen__LoopBodyStmt_41, 1) = ((MR_Box) (ml_backend__ml_disj_gen__Var_68));
    }
    {
    ...
    {
      ml_backend__ml_disj_gen__Var_74 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(2), ml_backend__ml_disj_gen__Var_74, 0) = ((MR_Box) (ml_backend__ml_disj_gen__NumRows_26));
    }
    {
      ml_backend__ml_disj_gen__Var_73 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(3), ml_backend__ml_disj_gen__Var_73, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 0));
      MR_hl_field(MR_mktag(3), ml_backend__ml_disj_gen__Var_73, 1) = ((MR_Box) (ml_backend__ml_disj_gen__Var_74));
    }
    {
      ...
      MR_hl_field(MR_mktag(3), ml_backend__ml_disj_gen__LoopCond_43, 3) = ((MR_Box) (ml_backend__ml_disj_gen__Var_73));
    }
    {
    ...
    ml_backend__ml_disj_gen__Var_77 = (MR_Word) MR_mkword(MR_mktag(0), (MR_Word) ml_backend__ml_disj_gen__SlotVarDefn_32);
    {
      ml_backend__ml_disj_gen__Var_76 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), ml_backend__ml_disj_gen__Var_76, 0) = ((MR_Box) (ml_backend__ml_disj_gen__Var_77));
      MR_hl_field(MR_mktag(1), ml_backend__ml_disj_gen__Var_76, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
    }
    {
      ml_backend__ml_disj_gen__Var_80 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), ml_backend__ml_disj_gen__Var_80, 0) = ((MR_Box) (ml_backend__ml_disj_gen__LoopStatement_45));
      MR_hl_field(MR_mktag(1), ml_backend__ml_disj_gen__Var_80, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
    }
    {
      ml_backend__ml_disj_gen__Var_79 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), ml_backend__ml_disj_gen__Var_79, 0) = ((MR_Box) (ml_backend__ml_disj_gen__InitSlotVarStatement_38));
      MR_hl_field(MR_mktag(1), ml_backend__ml_disj_gen__Var_79, 1) = ((MR_Box) (ml_backend__ml_disj_gen__Var_80));
    }
    {
      ml_backend__ml_disj_gen__Stmt_46 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), ml_backend__ml_disj_gen__Stmt_46, 0) = ((MR_Box) (ml_backend__ml_disj_gen__Var_76));
      MR_hl_field(MR_mktag(0), ml_backend__ml_disj_gen__Stmt_46, 1) = ((MR_Box) (ml_backend__ml_disj_gen__Var_79));
    }
    {
          ...
          case (MR_Integer) 1:
            {
              ...
              MR_Word ml_backend__ml_disj_gen__Var_40;
              ...
              }
              {
                ...
                MR_hl_field(MR_mktag(3), ml_backend__ml_disj_gen__Var_35, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 1));
                MR_hl_field(MR_mktag(3), ml_backend__ml_disj_gen__Var_35, 1) = ((MR_Box) (MR_mkword(MR_mktag(3), &ml_backend__ml_disj_gen_scalar_common_3[0])));
              ...
              {
                ml_backend__ml_disj_gen__Var_39 = ml_backend__mlds__mlds_make_context_1_f_0(ml_backend__ml_disj_gen__Context_11);
              }
              {
                ...
                MR_hl_field(MR_mktag(0), ml_backend__ml_disj_gen__IfStatement_25, 1) = ((MR_Box) (ml_backend__ml_disj_gen__Var_39));
              }
              {
                ml_backend__ml_disj_gen__Var_40 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(1), ml_backend__ml_disj_gen__Var_40, 0) = ((MR_Box) (ml_backend__ml_disj_gen__IfStatement_25));
                MR_hl_field(MR_mktag(1), ml_backend__ml_disj_gen__Var_40, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
              }
              {
                MR_Word base;
                base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                *ml_backend__ml_disj_gen__Statements_12 = base;
                ...
                MR_hl_field(MR_mktag(1), base, 1) = ((MR_Box) (ml_backend__ml_disj_gen__Var_40));
              }
            }
            break;
        }
                ...
                if (ml_backend__ml_disj_gen__succeeded)
                  {
                    ...
                    ml_backend__ml_disj_gen__Var_30 = (MR_Integer) 455;
                    {
                ...
                if (ml_backend__ml_disj_gen__succeeded)
                  {
                    ...
                    }
                    {
                      ...
                      MR_hl_field(MR_mktag(0), ml_backend__ml_disj_gen__Var_31, 0) = ((MR_Box) (&ml_backend__ml_disj_gen_scalar_common_2[0]));
                  ...
                  {
                    MR_Word ml_backend__ml_disj_gen__FirstLaterDisjunct_55 = ((MR_Word) (MR_hl_field(MR_mktag(1), ml_backend__ml_disj_gen__LaterDisjuncts_15, (MR_Integer) 0)));
                    MR_Word ml_backend__ml_disj_gen__LaterLaterDisjuncts_56 = ((MR_Word) (MR_hl_field(MR_mktag(1), ml_backend__ml_disj_gen__LaterDisjuncts_15, (MR_Integer) 1)));
                    MR_Word ml_backend__ml_disj_gen__FirstStatement_57;
                    MR_Word ml_backend__ml_disj_gen__LaterStatements_58;
                    MR_Word ml_backend__ml_disj_gen__STATE_VARIABLE_Info_20_60;

                    {
                      ml_backend__ml_code_gen__ml_gen_goal_as_branch_block_5_p_0((MR_Integer) 2, ml_backend__ml_disj_gen__FirstDisjunct_14, &ml_backend__ml_disj_gen__FirstStatement_57, ml_backend__ml_disj_gen__STATE_VARIABLE_Info_0_26, &ml_backend__ml_disj_gen__STATE_VARIABLE_Info_20_60);
                    }
                    {
                      ml_backend__ml_disj_gen__f_85_110_117_115_101_100_65_114_103_115_95_95_112_114_101_100_95_95_109_108_95_103_101_110_95_111_114_100_105_110_97_114_121_95_109_111_100_101_108_95_110_111_110_95_100_105_115_106_95_95_91_51_93_95_48_6_p_0(ml_backend__ml_disj_gen__FirstLaterDisjunct_55, ml_backend__ml_disj_gen__LaterLaterDisjuncts_56, &ml_backend__ml_disj_gen__LaterStatements_58, ml_backend__ml_disj_gen__STATE_VARIABLE_Info_20_60, ml_backend__ml_disj_gen__STATE_VARIABLE_Info_27);
                    }
                    {
                      MR_Word base;
                      base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                      *ml_backend__ml_disj_gen__Statements_12 = base;
                      MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (ml_backend__ml_disj_gen__FirstStatement_57));
                      MR_hl_field(MR_mktag(1), base, 1) = ((MR_Box) (ml_backend__ml_disj_gen__LaterStatements_58));
                    }
                  }
              }
              break;
