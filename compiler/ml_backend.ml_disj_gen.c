...
{
  {
    ...
    if ((LaterDisjuncts_10 == (MR_Word) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
    {
      MR_Word Stmt_16;
        ...
        case (MR_Integer) 1:
          {
            ...
            LaterStmt_25 = ml_backend__ml_code_util__ml_gen_block_4_f_0((MR_Word) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))), (MR_Word) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))), LaterStmts_24, Context_13);
            {
            ...
            }
            {
              ...
              MR_hl_field(MR_mktag(2), IfStmt_26, 2) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
