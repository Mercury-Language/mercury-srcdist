          ...
          case (MR_Integer) 2:
            {
              ...
              libs__globals__lookup_bool_option_3_p_0(Globals_20, (MR_Integer) 462, &StaticGroundCells_21);
      ...
      case (MR_Integer) 0:
        {
          ...
          ml_backend__ml_code_gen__ml_gen_goal_as_branch_block_5_p_0((MR_Integer) 0, FirstDisjunct_8, &Stmt_45, STATE_VARIABLE_Info_0_25, STATE_VARIABLE_Info_26);
          {
            MR_Word base;
            base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
            *Stmts_12 = base;
            MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (Stmt_45));
            MR_hl_field(MR_mktag(1), base, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
          }
        }
        break;
      ...
      case (MR_Integer) 1:
        {
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(1), Var_38, 0) = ((MR_Box) (IfStmt_24));
