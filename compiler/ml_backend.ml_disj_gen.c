...
MR_decl_label10(ml_backend__ml_disj_gen__ml_gen_disj_7_0, 3,10,12,13,14,16,17,19,21,24)
MR_decl_label5(ml_backend__ml_disj_gen__ml_gen_disj_7_0, 9,26,27,8,6)
...
MR_decl_static(ml_backend__ml_disj_gen__IntroducedFrom__pred__ml_gen_lookup_disj__315__1_3_0)
...
MR_def_label(ml_backend__ml_disj_gen__ml_gen_lookup_disj_6_0,7)
	...
	MR_tfield(0, MR_tempr1, 1) = (MR_Word) MR_ENTRY_AP(ml_backend__ml_disj_gen__IntroducedFrom__pred__ml_gen_lookup_disj__315__1_3_0);
...
MR_BEGIN_MODULE(ml_backend__ml_disj_gen_module2)
	...
	MR_init_label10(ml_backend__ml_disj_gen__ml_gen_disj_7_0,3,10,12,13,14,16,17,19,21,24)
	MR_init_label5(ml_backend__ml_disj_gen__ml_gen_disj_7_0,9,26,27,8,6)
MR_BEGIN_CODE
...
MR_def_label(ml_backend__ml_disj_gen__ml_gen_disj_7_0,10)
	...
	MR_r1 = MR_sv(6);
	MR_np_call_localret_ent(ml_backend__ml_gen_info__ml_gen_info_get_module_info_2_0,
		ml_backend__ml_disj_gen__ml_gen_disj_7_0_i12);
MR_def_label(ml_backend__ml_disj_gen__ml_gen_disj_7_0,12)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_np_call_localret_ent(hlds__hlds_module__module_info_get_globals_2_0,
		ml_backend__ml_disj_gen__ml_gen_disj_7_0_i13);
...
MR_def_label(ml_backend__ml_disj_gen__ml_gen_disj_7_0,9)
	...
	MR_np_call_localret_ent(ml_backend__ml_code_gen__ml_gen_goal_as_branch_block_5_0,
		ml_backend__ml_disj_gen__ml_gen_disj_7_0_i26);
MR_def_label(ml_backend__ml_disj_gen__ml_gen_disj_7_0,26)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tempr1 = MR_sv(1);
...
MR_BEGIN_MODULE(ml_backend__ml_disj_gen_module3)
	MR_init_entry1(ml_backend__ml_disj_gen__IntroducedFrom__pred__ml_gen_lookup_disj__315__1_3_0);
	MR_INIT_PROC_LAYOUT_ADDR(mercury__ml_backend__ml_disj_gen__IntroducedFrom__pred__ml_gen_lookup_disj__315__1_3_0);
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'IntroducedFrom__pred__ml_gen_lookup_disj__315__1'/3 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(ml_backend__ml_disj_gen__IntroducedFrom__pred__ml_gen_lookup_disj__315__1_3_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tempr1 = MR_r1;
