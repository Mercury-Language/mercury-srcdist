...
MR_decl_label1(libs__compiler_util__sorry_2_0, 2)
MR_decl_label1(libs__compiler_util__unexpected_2_0, 2)
...
MR_BEGIN_MODULE(libs__compiler_util_module0)
	...
	MR_init_label1(libs__compiler_util__sorry_2_0,2)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(libs__compiler_util_module2)
	...
	MR_init_label1(libs__compiler_util__unexpected_2_0,2)
MR_BEGIN_CODE
...
void mercury__libs__compiler_util__write_out_proc_statics(FILE *fp);
#endif
