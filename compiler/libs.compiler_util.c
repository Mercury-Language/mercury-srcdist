...
libs__compiler_util__report_warning_5_p_0(
  ...
  MR_String Message_8)
{
  MR_Word HaltAtWarn_17;

  libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 3, &HaltAtWarn_17);
  switch (HaltAtWarn_17) {
  ...
  MR_Word * STATE_VARIABLE_Specs_10)
{
  ...
  {
    Spec_8 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(MR_mktag(2), Spec_8, 0) = ((MR_Box) ((MR_String) "predicate \140libs.compiler_util.add_warning\'/4"));
    MR_hl_field(MR_mktag(2), Spec_8, 1) = ((MR_Box) ((MR_Unsigned) 4U));
    MR_hl_field(MR_mktag(2), Spec_8, 2) = ((MR_Box) (Phase_5));
    MR_hl_field(MR_mktag(2), Spec_8, 3) = ((MR_Box) (Pieces_6));
  }
  {
    MR_Word base;
  ...
  MR_Word * STATE_VARIABLE_Specs_10)
{
  ...
  {
    Spec_8 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(MR_mktag(2), Spec_8, 0) = ((MR_Box) ((MR_String) "predicate \140libs.compiler_util.add_error\'/4"));
    MR_hl_field(MR_mktag(2), Spec_8, 1) = ((MR_Box) ((MR_Unsigned) 0U));
    MR_hl_field(MR_mktag(2), Spec_8, 2) = ((MR_Box) (Phase_5));
    MR_hl_field(MR_mktag(2), Spec_8, 3) = ((MR_Box) (Pieces_6));
  }
  {
