  ...
  MR_String Message_8)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 269, &HaltAtWarn_13);
  ...
  MR_Word OptionTable_4)
{
  ...
  mercury__getopt__lookup_bool_option_3_p_0((MR_Word) (&libs__options__libs__options__type_ctor_info_option_0), OptionTable_4, ((MR_Box) ((MR_Integer) 269)), &HaltAtWarn_6);
  switch (HaltAtWarn_6) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 0:
      {
  ...
  MR_Word Globals_4)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_4, (MR_Integer) 269, &HaltAtWarn_6);
  switch (HaltAtWarn_6) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 0:
      {
