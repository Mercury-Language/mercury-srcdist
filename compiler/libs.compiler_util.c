...
#endif
MR_decl_label2(libs__compiler_util__expect_3_0, 4,7)
MR_decl_label2(libs__compiler_util__record_warning_2_0, 2,3)
MR_decl_label3(libs__compiler_util__report_warning_3_0, 2,8,4)
MR_decl_label3(libs__compiler_util__report_warning_4_0, 2,8,4)
MR_decl_label1(libs__compiler_util__sorry_2_0, 6)
MR_decl_label1(libs__compiler_util__unexpected_2_0, 6)
...
MR_def_extern_entry(libs__compiler_util__record_warning_2_0)
MR_def_extern_entry(libs__compiler_util__report_warning_3_0)
...
MR_BEGIN_MODULE(libs__compiler_util_module0)
	...
	MR_init_label1(libs__compiler_util__sorry_2_0,6)
MR_BEGIN_CODE
...
MR_define_entry(mercury__libs__compiler_util__sorry_2_0);
	...
	MR_r1 = (MR_Word) MR_string_const("%s: Sorry, not implemented: %s", 30);
	}
	MR_np_call_localret_ent(string__format_3_0,
		libs__compiler_util__sorry_2_0_i6);
MR_def_label(libs__compiler_util__sorry_2_0,6)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_BEGIN_MODULE(libs__compiler_util_module2)
	...
	MR_init_label1(libs__compiler_util__unexpected_2_0,6)
MR_BEGIN_CODE
...
MR_define_entry(mercury__libs__compiler_util__unexpected_2_0);
	...
	MR_tfield(1, MR_tempr4, 0) = MR_tempr1;
	MR_tfield(1, MR_tempr4, 1) = MR_tempr3;
	MR_r1 = (MR_Word) MR_string_const("%s: Unexpected: %s", 18);
	}
	MR_np_call_localret_ent(string__format_3_0,
		libs__compiler_util__unexpected_2_0_i6);
MR_def_label(libs__compiler_util__unexpected_2_0,6)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_succip_word = MR_sv(1);
	MR_decr_sp(1);
	MR_np_tailcall_ent(require__error_1_0);
...
MR_BEGIN_MODULE(libs__compiler_util_module4)
	...
	MR_init_label2(libs__compiler_util__expect_3_0,4,7)
MR_BEGIN_CODE
...
MR_def_label(libs__compiler_util__expect_3_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_r1) {
		MR_GOTO_LAB(libs__compiler_util__expect_3_0_i7);
	}
	MR_r2 = MR_sv(1);
	{
	MR_Word MR_tempr1;
...
MR_BEGIN_MODULE(libs__compiler_util_module5)
	MR_init_entry1(libs__compiler_util__record_warning_2_0);
	MR_init_label2(libs__compiler_util__record_warning_2_0,2,3)
MR_BEGIN_CODE
	...
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_define_entry(mercury__libs__compiler_util__record_warning_2_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(1);
	MR_sv(1) = (MR_Word) MR_succip;
	MR_r1 = (MR_Integer) 2;
	MR_np_call_localret_ent(libs__globals__io_lookup_bool_option_4_0,
		libs__compiler_util__record_warning_2_0_i2);
MR_def_label(libs__compiler_util__record_warning_2_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_EQ(MR_r1,0)) {
		MR_GOTO_LAB(libs__compiler_util__record_warning_2_0_i3);
	}
	MR_r1 = (MR_Integer) 1;
	MR_succip_word = MR_sv(1);
	MR_decr_sp(1);
	MR_np_tailcall_ent(io__set_exit_status_3_0);
MR_def_label(libs__compiler_util__record_warning_2_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_BEGIN_MODULE(libs__compiler_util_module6)
	MR_init_entry1(libs__compiler_util__report_warning_3_0);
	MR_init_label3(libs__compiler_util__report_warning_3_0,2,8,4)
MR_BEGIN_CODE
	...
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_define_entry(mercury__libs__compiler_util__report_warning_3_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(2);
	...
	MR_r1 = (MR_Integer) 2;
	MR_np_call_localret_ent(libs__globals__io_lookup_bool_option_4_0,
		libs__compiler_util__report_warning_3_0_i2);
MR_def_label(libs__compiler_util__report_warning_3_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(libs__compiler_util__report_warning_3_0_i4);
	}
MR_def_label(libs__compiler_util__report_warning_3_0,8)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(1);
	MR_succip_word = MR_sv(2);
	MR_decr_sp(2);
	MR_np_tailcall_ent(io__write_string_3_0);
MR_def_label(libs__compiler_util__report_warning_3_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Integer) 1;
	MR_np_call_localret_ent(io__set_exit_status_3_0,
		libs__compiler_util__report_warning_3_0_i8);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_thread_engine_base
#endif
