...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), Var_20, 0) = ((MR_Box) (Msg_8));
      MR_hl_field(MR_mktag(1), Var_20, 1) = ((MR_Box) ((MR_Unsigned) 0U));
    }
    {
      Spec_9 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), Spec_9, 0) = ((MR_Box) ((MR_String) "predicate \140libs.compiler_util.add_warning\'/4"));
      MR_hl_field(MR_mktag(0), Spec_9, 1) = ((MR_Box) ((MR_Unsigned) 4U));
      MR_hl_field(MR_mktag(0), Spec_9, 2) = ((MR_Box) (Phase_5));
      MR_hl_field(MR_mktag(0), Spec_9, 3) = ((MR_Box) (Var_20));
    }
    {
      MR_Word base;
...
{
  {
    ...
    {
      Spec_9 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), Spec_9, 0) = ((MR_Box) ((MR_String) "predicate \140libs.compiler_util.add_error\'/4"));
