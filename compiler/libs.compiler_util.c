...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), Msg_8, 0) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
      MR_hl_field(MR_mktag(1), Msg_8, 1) = ((MR_Box) ((MR_Integer) 1));
      MR_hl_field(MR_mktag(1), Msg_8, 2) = ((MR_Box) ((MR_Integer) 0));
      MR_hl_field(MR_mktag(1), Msg_8, 3) = ((MR_Box) (Var_15));
    }
    {
    ...
    {
      Spec_9 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), Spec_9, 0) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 1))));
...
{
  {
    ...
    {
      Spec_9 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), Spec_9, 0) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
      MR_hl_field(MR_mktag(0), Spec_9, 1) = ((MR_Box) (Phase_5));
      MR_hl_field(MR_mktag(0), Spec_9, 2) = ((MR_Box) (Var_19));
    }
    {
