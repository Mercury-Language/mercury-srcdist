  ...
  MR_Word OptionTable_4)
{
  ...
  mercury__getopt__lookup_bool_option_3_p_0((MR_Word) (&libs__options__libs__options__type_ctor_info_option_0), OptionTable_4, ((MR_Box) ((MR_Integer) 3)), &HaltAtWarn_6);
  switch (HaltAtWarn_6) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 0:
      {
  ...
  MR_Word * STATE_VARIABLE_Specs_10)
{
...

  {
    ...
    MR_hl_field(2, Spec_8, 0) = ((MR_Box) ((MR_String) "predicate \140libs.compiler_util.add_warning\'/4"));
    MR_hl_field(2, Spec_8, 1) = ((MR_Box) ((MR_Unsigned) 4U));
    MR_hl_field(2, Spec_8, 2) = ((MR_Box) (Phase_5));
    MR_hl_field(2, Spec_8, 3) = ((MR_Box) (Pieces_6));
  }
  {
    MR_Word base;
  ...
  MR_Word * STATE_VARIABLE_Specs_10)
{
  ...
  {
    Spec_8 = (MR_Word) MR_mkword(2, MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(2, Spec_8, 0) = ((MR_Box) ((MR_String) "predicate \140libs.compiler_util.add_error\'/4"));
  ...
  MR_String * Error_3)
{
  ...
  if (succeeded)
    *Error_3 = ((MR_String) ((MR_hl_field(1, HeadVar__1_1, (MR_Integer) 0))));
  return succeeded;
}
