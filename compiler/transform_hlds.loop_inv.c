...
MR_decl_static(fn__transform_hlds__loop_inv__IntroducedFrom__func__rhs_modes__1352__1_1_0)
...
{
MR_COMMON(0,5),
MR_ENTRY_AP(fn__transform_hlds__loop_inv__IntroducedFrom__func__rhs_modes__1352__1_1_0),
0
},
{
MR_COMMON(0,6),
...
MR_BEGIN_MODULE(transform_hlds__loop_inv_module52)
	MR_init_entry1(fn__transform_hlds__loop_inv__IntroducedFrom__func__rhs_modes__1352__1_1_0);
MR_BEGIN_CODE
	...
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(fn__transform_hlds__loop_inv__IntroducedFrom__func__rhs_modes__1352__1_1_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 0, (MR_Integer) 2);
