...
MR_decl_label8(transform_hlds__loop_inv__create_aux_pred_10_0, 3,4,5,6,7,8,9,10)
MR_decl_label8(transform_hlds__loop_inv__create_aux_pred_10_0, 11,12,13,14,15,16,17,18)
MR_decl_label8(transform_hlds__loop_inv__create_aux_pred_10_0, 19,20,21,22,23,25,30,31)
MR_decl_label8(transform_hlds__loop_inv__dont_hoist_2_6_0, 10,6,13,17,16,20,21,19)
MR_decl_label8(transform_hlds__loop_inv__dont_hoist_2_6_0, 24,26,27,23,30,31,35,33)
...
MR_decl_label8(transform_hlds__loop_inv__hoist_loop_invariants_7_0, 3,5,6,7,9,10,12,14)
MR_decl_label8(transform_hlds__loop_inv__hoist_loop_invariants_7_0, 16,18,15,19,20,21,22,23)
MR_decl_label7(transform_hlds__loop_inv__hoist_loop_invariants_7_0, 24,26,27,29,30,31,2)
MR_decl_label8(transform_hlds__loop_inv__inv_goals_vars_2_7_0, 8,12,17,9,6,24,26,27)
MR_decl_label8(transform_hlds__loop_inv__inv_goals_vars_2_7_0, 22,30,36,39,34,44,47,2)
MR_decl_label8(transform_hlds__loop_inv__invariant_goal_candidates_2_4_0, 58,24,25,41,5,7,12,72)
MR_decl_label7(transform_hlds__loop_inv__invariant_goal_candidates_2_4_0, 20,22,29,73,32,71,36)
...
MR_decl_label8(fn__transform_hlds__loop_inv__gen_aux_proc_goal_2_0, 53,64,65,28,26,47,66,7)
MR_decl_label8(fn__transform_hlds__loop_inv__gen_aux_proc_goal_2_0, 67,12,71,16,17,18,69,22)
MR_decl_label5(fn__transform_hlds__loop_inv__gen_aux_proc_goal_2_0, 70,34,37,68,41)
...
MR_decl_label8(fn__transform_hlds__loop_inv__gen_out_proc_goal_3_0, 52,24,25,42,64,6,65,11)
MR_decl_label8(fn__transform_hlds__loop_inv__gen_out_proc_goal_3_0, 69,15,16,17,67,21,68,29)
MR_decl_label3(fn__transform_hlds__loop_inv__gen_out_proc_goal_3_0, 32,66,36)
MR_decl_label8(fn__transform_hlds__loop_inv__goal_inputs_2_0, 22,95,96,46,47,24,55,26)
MR_decl_label8(fn__transform_hlds__loop_inv__goal_inputs_2_0, 31,33,28,93,20,13,94,7)
MR_decl_label3(fn__transform_hlds__loop_inv__goal_inputs_2_0, 8,10,11)
MR_decl_label8(fn__transform_hlds__loop_inv__goal_outputs_2_0, 22,61,24,38,59,20,13,60)
MR_decl_label4(fn__transform_hlds__loop_inv__goal_outputs_2_0, 7,8,10,11)
...
MR_decl_label8(fn__transform_hlds__loop_inv__used_vars_2_0, 61,55,38,41,25,59,3,7)
MR_decl_label8(fn__transform_hlds__loop_inv__used_vars_2_0, 8,9,11,13,19,23,29,31)
MR_decl_label8(fn__transform_hlds__loop_inv__used_vars_2_0, 32,33,34,36,43,45,46,48)
MR_decl_label2(fn__transform_hlds__loop_inv__used_vars_2_0, 52,53)
...
MR_decl_static(fn__transform_hlds__loop_inv__IntroducedFrom__func__rhs_modes__1285__1_1_0)
...
{
MR_COMMON(0,5),
MR_ENTRY_AP(fn__transform_hlds__loop_inv__IntroducedFrom__func__rhs_modes__1285__1_1_0),
0
},
{
MR_COMMON(0,6),
...
MR_BEGIN_MODULE(transform_hlds__loop_inv_module4)
	...
	MR_init_label8(transform_hlds__loop_inv__invariant_goal_candidates_2_4_0,58,24,25,41,5,7,12,72)
	MR_init_label7(transform_hlds__loop_inv__invariant_goal_candidates_2_4_0,20,22,29,73,32,71,36)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(transform_hlds__loop_inv_module9)
	...
	MR_init_label8(transform_hlds__loop_inv__create_aux_pred_10_0,3,4,5,6,7,8,9,10)
	MR_init_label8(transform_hlds__loop_inv__create_aux_pred_10_0,11,12,13,14,15,16,17,18)
	MR_init_label8(transform_hlds__loop_inv__create_aux_pred_10_0,19,20,21,22,23,25,30,31)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(transform_hlds__loop_inv_module12)
	...
	MR_init_label8(fn__transform_hlds__loop_inv__gen_aux_proc_goal_2_0,53,64,65,28,26,47,66,7)
	MR_init_label8(fn__transform_hlds__loop_inv__gen_aux_proc_goal_2_0,67,12,71,16,17,18,69,22)
	MR_init_label5(fn__transform_hlds__loop_inv__gen_aux_proc_goal_2_0,70,34,37,68,41)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(transform_hlds__loop_inv_module14)
	...
	MR_init_label8(fn__transform_hlds__loop_inv__gen_out_proc_goal_3_0,52,24,25,42,64,6,65,11)
	MR_init_label8(fn__transform_hlds__loop_inv__gen_out_proc_goal_3_0,69,15,16,17,67,21,68,29)
	MR_init_label3(fn__transform_hlds__loop_inv__gen_out_proc_goal_3_0,32,66,36)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(transform_hlds__loop_inv_module17)
	...
	MR_init_label8(fn__transform_hlds__loop_inv__used_vars_2_0,61,55,38,41,25,59,3,7)
	MR_init_label8(fn__transform_hlds__loop_inv__used_vars_2_0,8,9,11,13,19,23,29,31)
	MR_init_label8(fn__transform_hlds__loop_inv__used_vars_2_0,32,33,34,36,43,45,46,48)
	MR_init_label2(fn__transform_hlds__loop_inv__used_vars_2_0,52,53)
MR_BEGIN_CODE
...
MR_def_label(fn__transform_hlds__loop_inv__used_vars_2_0,3)
	...
	MR_sv(1) = MR_tempr2;
	MR_tempr3 = MR_r5;
	MR_sv(2) = MR_ctfield(3, MR_tempr3, 5);
	...
	MR_r4 = MR_ctfield(3, MR_tempr3, 4);
	}
	MR_np_call_localret_ent(fn__list__map_2_0,
...
MR_BEGIN_MODULE(transform_hlds__loop_inv_module18)
	...
	MR_init_label8(transform_hlds__loop_inv__hoist_loop_invariants_7_0,3,5,6,7,9,10,12,14)
	MR_init_label8(transform_hlds__loop_inv__hoist_loop_invariants_7_0,16,18,15,19,20,21,22,23)
	MR_init_label7(transform_hlds__loop_inv__hoist_loop_invariants_7_0,24,26,27,29,30,31,2)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(transform_hlds__loop_inv_module25)
	...
	MR_init_label8(fn__transform_hlds__loop_inv__goal_inputs_2_0,22,95,96,46,47,24,55,26)
	MR_init_label8(fn__transform_hlds__loop_inv__goal_inputs_2_0,31,33,28,93,20,13,94,7)
	MR_init_label3(fn__transform_hlds__loop_inv__goal_inputs_2_0,8,10,11)
MR_BEGIN_CODE
...
MR_def_label(fn__transform_hlds__loop_inv__goal_inputs_2_0,24)
	...
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 2);
	MR_r1 = MR_tempr1;
	MR_tfield(1, MR_tempr1, 0) = MR_ctfield(2, MR_r4, 1);
	MR_tfield(1, MR_tempr1, 1) = (MR_Word) MR_tbmkword(0, 0);
	MR_proceed();
	}
MR_def_label(fn__transform_hlds__loop_inv__goal_inputs_2_0,55)
	...
	MR_Word MR_tempr1, MR_tempr2;
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 2);
	MR_tfield(1, MR_tempr1, 0) = MR_ctfield(3, MR_r4, 2);
	MR_tfield(1, MR_tempr1, 1) = (MR_Word) MR_tbmkword(0, 0);
	MR_tag_alloc_heap(MR_tempr2, 1, (MR_Integer) 2);
	MR_r1 = MR_tempr2;
	MR_tfield(1, MR_tempr2, 0) = MR_ctfield(0, MR_r5, 0);
	MR_tfield(1, MR_tempr2, 1) = MR_tempr1;
	MR_proceed();
	}
...
MR_def_label(fn__transform_hlds__loop_inv__goal_inputs_2_0,28)
	...
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 2);
	MR_r1 = MR_tempr1;
	MR_tfield(1, MR_tempr1, 0) = MR_ctfield(0, MR_r5, 0);
	MR_tfield(1, MR_tempr1, 1) = (MR_Word) MR_tbmkword(0, 0);
	MR_proceed();
	}
...
MR_BEGIN_MODULE(transform_hlds__loop_inv_module26)
	...
	MR_init_label8(fn__transform_hlds__loop_inv__goal_outputs_2_0,22,61,24,38,59,20,13,60)
	MR_init_label4(fn__transform_hlds__loop_inv__goal_outputs_2_0,7,8,10,11)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(transform_hlds__loop_inv_module28)
	...
	MR_init_label8(transform_hlds__loop_inv__inv_goals_vars_2_7_0,8,12,17,9,6,24,26,27)
	MR_init_label8(transform_hlds__loop_inv__inv_goals_vars_2_7_0,22,30,36,39,34,44,47,2)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(transform_hlds__loop_inv_module29)
	...
	MR_init_label8(transform_hlds__loop_inv__dont_hoist_2_6_0,24,26,27,23,30,31,35,33)
...
MR_BEGIN_MODULE(transform_hlds__loop_inv_module48)
	MR_init_entry1(fn__transform_hlds__loop_inv__IntroducedFrom__func__rhs_modes__1285__1_1_0);
MR_BEGIN_CODE


/*-------------------------------------------------------------------------*/
/* code for 'IntroducedFrom__func__rhs_modes__1285__1'/2 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(fn__transform_hlds__loop_inv__IntroducedFrom__func__rhs_modes__1285__1_1_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tag_alloc_heap(MR_tempr1, 0, (MR_Integer) 2);
