...
static /* final */ const MR_Box transform_hlds__loop_inv_scalar_common_3[1][1];

static /* final */ const MR_Box transform_hlds__loop_inv_scalar_common_4[1][10];

static /* final */ const MR_Box transform_hlds__loop_inv_scalar_common_5[1][9];
...
static /* final */ const MR_Box transform_hlds__loop_inv_scalar_common_2[13][3] = {
  ...
  /* row 5 */
  {
    ((MR_Box) (&transform_hlds__loop_inv_scalar_common_6[4])),
  ...
  /* row 7 */
  {
    ((MR_Box) (&transform_hlds__loop_inv_scalar_common_6[5])),
...
{
  {
    ...
    if ((env).transform_hlds__loop_inv__inv_goals_vars_2_7_p_0_env_0__succeeded)
    {
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(0), Var_34, 0) = ((MR_Box) (&transform_hlds__loop_inv_scalar_common_7[4]));
            ...
            case (MR_Integer) 1:
              {
...

                {
                  ...
                  MR_hl_field(MR_mktag(0), Var_83, 0) = ((MR_Box) (&transform_hlds__loop_inv_scalar_common_7[2]));
          ...
          case (MR_Integer) 0:
            {
              ...
              hlds__goal_util__generic_call_vars_2_p_0(GenericCall_15, &GenericCallVars_19);
              {
                ...
                MR_hl_field(MR_mktag(0), Var_93, 0) = ((MR_Box) (&transform_hlds__loop_inv_scalar_common_7[2]));
...
{
  {
    ...
    succeeded = transform_hlds__loop_inv__IntroducedFrom__pred__inv_args__498__1_2_p_0(((MR_Word) (wrapper_arg_1)), &conv3_HeadVar__2_28);
    if (succeeded)
    {
          ...
          case (MR_Integer) 2:
            {
...

              {
                ...
                MR_hl_field(MR_mktag(0), Var_56, 0) = ((MR_Box) (&transform_hlds__loop_inv_scalar_common_6[3]));
          ...
          case (MR_Integer) 3:
            {
...

              {
                ...
                MR_hl_field(MR_mktag(0), Var_54, 0) = ((MR_Box) (&transform_hlds__loop_inv_scalar_common_6[3]));
          ...
          case (MR_Integer) 4:
            {
...

              {
                ...
                MR_hl_field(MR_mktag(0), Var_51, 0) = ((MR_Box) (&transform_hlds__loop_inv_scalar_common_6[3]));
          ...
          case (MR_Integer) 3:
            {
              ...
              {
                Var_56 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
                MR_hl_field(MR_mktag(0), Var_56, 0) = ((MR_Box) (&transform_hlds__loop_inv_scalar_common_6[1]));
          ...
          case (MR_Integer) 4:
            {
...

              {
                ...
                MR_hl_field(MR_mktag(0), Var_55, 0) = ((MR_Box) (&transform_hlds__loop_inv_scalar_common_6[2]));
...
{
  {
    ...
    mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&transform_hlds__loop_inv_scalar_common_3[0]), ProcNo_46, &Var_62);
...
{
  {
...

    {
      ...
      MR_hl_field(MR_mktag(0), Var_9, 0) = ((MR_Box) (&transform_hlds__loop_inv_scalar_common_5[0]));
...
{
  {
...

    {
      ...
      MR_hl_field(MR_mktag(0), Var_13, 0) = ((MR_Box) (&transform_hlds__loop_inv_scalar_common_4[0]));
