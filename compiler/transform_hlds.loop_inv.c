    ...
    (env).transform_hlds__loop_inv__do_not_hoist_2_6_p_0_env_0__ModuleInfo_7 = ModuleInfo_7;
    {
      ...
      if ((env).transform_hlds__loop_inv__do_not_hoist_2_6_p_0_env_0__succeeded)
      {
        ...
        if ((env).transform_hlds__loop_inv__do_not_hoist_2_6_p_0_env_0__succeeded)
        {
          ...
          packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Construction_21, (MR_Integer) 5)));
    ...
    {
      {
        ...
        if ((env).transform_hlds__loop_inv__do_not_hoist_2_6_p_0_env_0__succeeded)
        {
          ...
          if ((env).transform_hlds__loop_inv__do_not_hoist_2_6_p_0_env_0__succeeded)
          {
            ...
            packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), Var_55, (MR_Integer) 4)));
            Var_53 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(1), Var_55, (MR_Integer) 4))) >> (MR_Integer) 1)) & (MR_Integer) 1);
        ...
        if (!((env).transform_hlds__loop_inv__do_not_hoist_2_6_p_0_env_0__succeeded))
        {
          ...
          if (!((env).transform_hlds__loop_inv__do_not_hoist_2_6_p_0_env_0__succeeded))
          {
            ...
            if (((MR_tag((MR_Word) GoalExpr_69)) == (MR_Integer) 2))
            {
              ...
              MR_Unsigned packed_args_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), GoalExpr_69, (MR_Integer) 3)));
              MR_Word Var_91;
            ...
            if (((((MR_tag((MR_Word) GoalExpr_69)) == (MR_Integer) 3)) && ((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), GoalExpr_69, (MR_Integer) 0))) == (MR_Integer) 0))))
            {
              ...
              packed_args_3 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), GoalExpr_69, (MR_Integer) 5)));
...

    {
      ...
      if (!((env_ptr)->transform_hlds__loop_inv__inv_goals_vars_2_7_p_0_env_0__succeeded))
      {
        ...
        if ((env_ptr)->transform_hlds__loop_inv__inv_goals_vars_2_7_p_0_env_0__succeeded)
        {
          ...
          packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), (env_ptr)->transform_hlds__loop_inv__inv_goals_vars_2_7_p_0_env_0__GoalExprX_19, (MR_Integer) 3)));
          ...
          if ((env_ptr)->transform_hlds__loop_inv__inv_goals_vars_2_7_p_0_env_0__succeeded)
          {
            ...
            packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), (env_ptr)->transform_hlds__loop_inv__inv_goals_vars_2_7_p_0_env_0__GoalExprY_21, (MR_Integer) 3)));
            ...
            case (MR_Integer) 1:
              {
                ...
                MR_Unsigned packed_args_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), Kind_27, (MR_Integer) 4)));
            ...
            case (MR_Integer) 0:
              {
                ...
                MR_Unsigned packed_args_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Kind_29, (MR_Integer) 5)));
            ...
            case (MR_Integer) 1:
              {
                ...
                MR_Unsigned packed_args_3 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), Kind_29, (MR_Integer) 4)));
...
{
  {
    ...
    if (succeeded)
    {
      ...
      packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), RecCall_4, (MR_Integer) 3)));
...

    {
      ...
      if (!((env_ptr)->transform_hlds__loop_inv__common_goal_2_p_0_env_0__succeeded))
      {
        ...
        if ((env_ptr)->transform_hlds__loop_inv__common_goal_2_p_0_env_0__succeeded)
        {
          ...
          packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), (env_ptr)->transform_hlds__loop_inv__common_goal_2_p_0_env_0__GoalExprX_9, (MR_Integer) 3)));
          ...
          if ((env_ptr)->transform_hlds__loop_inv__common_goal_2_p_0_env_0__succeeded)
          {
            ...
            packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), (env_ptr)->transform_hlds__loop_inv__common_goal_2_p_0_env_0__GoalExprY_11, (MR_Integer) 3)));
          ...
          case (MR_Integer) 2:
            {
              ...
              mercury__list__map_3_p_0((MR_Word) (&hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_hlds_goal_0), (MR_Word) (&hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_hlds_goal_0), Var_59, Conjuncts_35, &AuxConjuncts_36);
              {
                ...
                MR_hl_field(MR_mktag(3), AuxGoalExpr_37, 1) = (MR_Box) (packed_args_0);
          ...
          case (MR_Integer) 4:
            {
              ...
              MR_Unsigned packed_args_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), GoalExpr_9, (MR_Integer) 2)));
              ...
              mercury__list__map_3_p_0((MR_Word) (&hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_case_0), (MR_Word) (&hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_case_0), Var_57, Cases_42, &AuxCases_43);
              {
                ...
                MR_hl_field(MR_mktag(3), AuxGoalExpr_61, 2) = (MR_Box) (packed_args_2);
          ...
          case (MR_Integer) 2:
            {
              ...
              mercury__list__map_3_p_0((MR_Word) (&hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_hlds_goal_0), (MR_Word) (&hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_hlds_goal_0), Var_57, Conjuncts_33, &AuxConjuncts_34);
              {
                ...
                MR_hl_field(MR_mktag(3), AuxGoalExpr_35, 1) = (MR_Box) (packed_args_0);
...
{
  {
    ...
    if (succeeded)
    {
      ...
      packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), ReplacementExpr_7, (MR_Integer) 3)));
      succeeded = ((MR_tag((MR_Word) CallExpr_9)) == (MR_Integer) 2);
      if (succeeded)
      {
        Args0_12 = ((MR_Word) ((MR_hl_field(MR_mktag(2), CallExpr_9, (MR_Integer) 2))));
        packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), CallExpr_9, (MR_Integer) 3)));
        ...
        packed_args_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), ReplacementExpr_7, (MR_Integer) 3)));
        ...
        Var_32 = ((MR_Word) ((MR_hl_field(MR_mktag(2), ReplacementExpr_7, (MR_Integer) 5))));
        {
          ...
          MR_hl_field(MR_mktag(2), AuxCallGoalExpr_14, 3) = (MR_Box) (packed_args_2);
...

    {
      ...
      if (!((env_ptr)->transform_hlds__loop_inv__gen_aux_proc_handle_non_recursive_call_3_p_0_env_0__succeeded))
      {
        ...
        if ((env_ptr)->transform_hlds__loop_inv__gen_aux_proc_handle_non_recursive_call_3_p_0_env_0__succeeded)
        {
          ...
          packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), (env_ptr)->transform_hlds__loop_inv__gen_aux_proc_handle_non_recursive_call_3_p_0_env_0__GoalExprX_15, (MR_Integer) 3)));
          ...
          if ((env_ptr)->transform_hlds__loop_inv__gen_aux_proc_handle_non_recursive_call_3_p_0_env_0__succeeded)
          {
            ...
            packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), (env_ptr)->transform_hlds__loop_inv__gen_aux_proc_handle_non_recursive_call_3_p_0_env_0__GoalExprY_17, (MR_Integer) 3)));
      ...
      case (MR_Integer) 2:
        {
          ...
          MR_Unsigned packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), GoalExpr_8, (MR_Integer) 3)));
