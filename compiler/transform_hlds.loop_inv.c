  ...
  void * env_ptr_arg)
{
  ...
  check_hlds__mode_util__mode_get_insts_4_p_0((env_ptr)->transform_hlds__loop_inv__do_not_hoist_2_7_p_0_env_0__ModuleInfo_8, (env_ptr)->transform_hlds__loop_inv__do_not_hoist_2_7_p_0_env_0__Mode_83, &(env_ptr)->transform_hlds__loop_inv__do_not_hoist_2_7_p_0_env_0__InitialInst_81, &(env_ptr)->transform_hlds__loop_inv__do_not_hoist_2_7_p_0_env_0__FinalInst_82);
  (env_ptr)->transform_hlds__loop_inv__do_not_hoist_2_7_p_0_env_0__succeeded = check_hlds__inst_test__inst_contains_any_2_p_0((env_ptr)->transform_hlds__loop_inv__do_not_hoist_2_7_p_0_env_0__ModuleInfo_8, (env_ptr)->transform_hlds__loop_inv__do_not_hoist_2_7_p_0_env_0__InitialInst_81);
  if (!((env_ptr)->transform_hlds__loop_inv__do_not_hoist_2_7_p_0_env_0__succeeded))
    (env_ptr)->transform_hlds__loop_inv__do_not_hoist_2_7_p_0_env_0__succeeded = check_hlds__inst_test__inst_contains_any_2_p_0((env_ptr)->transform_hlds__loop_inv__do_not_hoist_2_7_p_0_env_0__ModuleInfo_8, (env_ptr)->transform_hlds__loop_inv__do_not_hoist_2_7_p_0_env_0__FinalInst_82);
  if ((env_ptr)->transform_hlds__loop_inv__do_not_hoist_2_7_p_0_env_0__succeeded)
  ...
  MR_Word HeadVar__3_3)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      succeeded = check_hlds__inst_test__inst_is_ground_3_p_0(ModuleInfo_1, Type_11, Inst_9);
      if (succeeded)
      {
        // direct tailcall eliminated
        ;
