...
{
  {
    ...
    (env).transform_hlds__loop_inv__do_not_hoist_2_6_p_0_env_0__ModuleInfo_7 = ModuleInfo_7;
    {
      ...
      if ((env).transform_hlds__loop_inv__do_not_hoist_2_6_p_0_env_0__succeeded)
      {
        ...
        if ((env).transform_hlds__loop_inv__do_not_hoist_2_6_p_0_env_0__succeeded)
        {
          ...
          (env).transform_hlds__loop_inv__do_not_hoist_2_6_p_0_env_0__succeeded = (Var_44 == (MR_Word) ((MR_Integer) 0));
          if (!((env).transform_hlds__loop_inv__do_not_hoist_2_6_p_0_env_0__succeeded))
            (env).transform_hlds__loop_inv__do_not_hoist_2_6_p_0_env_0__succeeded = (Var_42 == (MR_Word) ((MR_Integer) 0));
        }
      }
    }
    if (!((env).transform_hlds__loop_inv__do_not_hoist_2_6_p_0_env_0__succeeded))
    ...
    if ((env).transform_hlds__loop_inv__do_not_hoist_2_6_p_0_env_0__succeeded)
    {
      ...
      transform_hlds__loop_inv__add_outputs_5_p_0((env).transform_hlds__loop_inv__do_not_hoist_2_6_p_0_env_0__ModuleInfo_7, (MR_Word) ((MR_Integer) 0), Goal_8, STATE_VARIABLE_DHVs_0_13, STATE_VARIABLE_DHVs_14);
    }
    else
    {
          ...
          switch (MR_tag((MR_Word) Kind_27)) {
              ...
              {
                {
                  ...
                  MR_hl_field(MR_mktag(1), Outputs_6, 1) = ((MR_Box) ((MR_Integer) 0));
                }
              }
              break;
            case (MR_Integer) 1:
            ...
            case (MR_Integer) 3:
              switch (((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), Kind_27, (MR_Integer) 0)))) {
                default: /*NOTREACHED*/ MR_assert(0);
                case (MR_Integer) 0:
                  Outputs_6 = (MR_Word) ((MR_Integer) 0);
                  break;
                case (MR_Integer) 1:
                  Outputs_6 = (MR_Word) ((MR_Integer) 0);
                  break;
            ...
            case (MR_Integer) 2:
              {
...

                {
                  ...
                  MR_hl_field(MR_mktag(1), Inputs_6, 1) = ((MR_Box) ((MR_Integer) 0));
                }
              }
              break;
            case (MR_Integer) 3:
...
{
  {
    ...
    if (succeeded)
    {
      ...
      if ((CandidateInvGoalsList_61 == (MR_Word) ((MR_Integer) 0)))
        InvGoals0_15 = (MR_Word) ((MR_Integer) 0);
      else
      {
  ...
  while (MR_TRUE)
  {
    ...
    switch (MR_tag((MR_Word) GoalExpr_7)) {
      ...
      case (MR_Integer) 0:
        ...
        break;
      case (MR_Integer) 1:
        UsedVars_6 = (MR_Word) ((MR_Integer) 0);
        break;
      case (MR_Integer) 2:
        {
          MR_Word PredId_9 = ((MR_Word) ((MR_hl_field(MR_mktag(2), GoalExpr_7, (MR_Integer) 0))));
...
{
  {
    ...
    mercury__list__foldl2_6_p_0((MR_Word) (&hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_hlds_goal_0), (MR_Word) (&transform_hlds__loop_inv_scalar_common_1[1]), (MR_Word) (&transform_hlds__loop_inv_scalar_common_1[4]), Var_9, InvGoals_6, ((MR_Box) ((MR_Integer) 0)), &conv3_DontHoistGoals_7, ((MR_Box) ((MR_Integer) 0)), &conv2_DontHoistVars_8);
...
{
  {
    ...
    mercury__list__foldl2_6_p_0((MR_Word) (&hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_hlds_goal_0), (MR_Word) (&transform_hlds__loop_inv_scalar_common_1[1]), (MR_Word) (&transform_hlds__loop_inv_scalar_common_1[4]), Var_13, InvGoals0_9, ((MR_Box) ((MR_Integer) 0)), &conv3_InvGoals_10, ((MR_Box) (InvVars0_11)), &conv2_InvVars_12);
