  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_51)
{
  ...
  hlds__hlds_module__module_info_next_loop_inv_count_4_p_0(Context_40, &SeqNum_42, STATE_VARIABLE_ModuleInfo_0_50, &STATE_VARIABLE_ModuleInfo_1_53);
