...
MR_def_label(transform_hlds__loop_inv__invariant_goal_candidates_handle_non_recursive_call_3_0,7)
	...
	MR_tempr3 = MR_sv(3);
	MR_tfield(1, MR_tempr1, 1) = MR_tfield(0, MR_tempr3, 0);
...
MR_def_label(fn__transform_hlds__loop_inv__gen_aux_call_2_0,5)
	...
	MR_tfield(1, MR_tempr1, 3) = MR_tfield(1, MR_tempr3, 3);
	MR_tfield(1, MR_tempr1, 4) = MR_tfield(1, MR_tempr3, 4);
	MR_tfield(1, MR_tempr1, 5) = MR_tfield(1, MR_tempr3, 5);
	MR_tag_alloc_heap(MR_tempr2, 0, (MR_Integer) 2);
	MR_r1 = MR_tempr2;
	MR_tfield(0, MR_tempr2, 0) = MR_tempr1;
...
MR_def_label(fn__transform_hlds__loop_inv__used_vars_2_0,3)
	...
	MR_sv(1) = MR_tempr2;
	MR_tempr3 = MR_r5;
	MR_sv(2) = MR_tfield(3, MR_tempr3, 5);
...
MR_def_label(fn__transform_hlds__loop_inv__goal_inputs_2_0,24)
	...
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 2);
	MR_r1 = MR_tempr1;
	MR_tfield(1, MR_tempr1, 0) = MR_tfield(2, MR_r4, 1);
	MR_tfield(1, MR_tempr1, 1) = (MR_Word) MR_tbmkword(0, 0);
	MR_proceed();
	}
MR_def_label(fn__transform_hlds__loop_inv__goal_inputs_2_0,55)
	...
	MR_Word MR_tempr1, MR_tempr2;
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 2);
	MR_tfield(1, MR_tempr1, 0) = MR_tfield(3, MR_r4, 2);
	MR_tfield(1, MR_tempr1, 1) = (MR_Word) MR_tbmkword(0, 0);
	MR_tag_alloc_heap(MR_tempr2, 1, (MR_Integer) 2);
	MR_r1 = MR_tempr2;
	MR_tfield(1, MR_tempr2, 0) = MR_tfield(0, MR_r5, 0);
	MR_tfield(1, MR_tempr2, 1) = MR_tempr1;
	MR_proceed();
	}
...
MR_def_label(fn__transform_hlds__loop_inv__goal_inputs_2_0,28)
	...
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 2);
	MR_r1 = MR_tempr1;
	MR_tfield(1, MR_tempr1, 0) = MR_tfield(0, MR_r5, 0);
	MR_tfield(1, MR_tempr1, 1) = (MR_Word) MR_tbmkword(0, 0);
	MR_proceed();
	}
