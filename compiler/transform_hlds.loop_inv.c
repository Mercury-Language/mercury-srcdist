...
transform_hlds__loop_inv__IntroducedFrom__func__case_goals__1138__1_1_f_0(
  ...
  MR_Box wrapper_arg_1)
{
  ...
  conv0_LambdaHeadVar__2_9 = transform_hlds__loop_inv__IntroducedFrom__func__case_goals__1138__1_1_f_0(((MR_Word) (wrapper_arg_1)));
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_51)
{
  ...
  hlds__hlds_pred__proc_info_get_var_table_3_p_0(STATE_VARIABLE_ModuleInfo_0_50, ProcInfo_24, &VarTable_29);
  ...
  parse_tree__pred_name__make_transformed_pred_sym_name_4_p_0(PredModule_37, PredName_38, Transform_44, &AuxPredSymName_45);
  {
    Var_55 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(MR_mktag(3), Var_55, 0) = ((MR_Box) ((MR_Unsigned) 3U));
    MR_hl_field(MR_mktag(3), Var_55, 1) = ((MR_Box) (ProcId_21));
    MR_hl_field(MR_mktag(3), Var_55, 2) = ((MR_Box) (LineNum_41));
    MR_hl_field(MR_mktag(3), Var_55, 3) = ((MR_Box) (SeqNum_42));
  }
  {
    Origin_46 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(MR_mktag(3), Origin_46, 0) = ((MR_Box) ((MR_Unsigned) 8U));
    MR_hl_field(MR_mktag(3), Origin_46, 1) = ((MR_Box) (Var_55));
    MR_hl_field(MR_mktag(3), Origin_46, 2) = ((MR_Box) (OrigOrigin_34));
    MR_hl_field(MR_mktag(3), Origin_46, 3) = ((MR_Box) (PredId_20));
  }
