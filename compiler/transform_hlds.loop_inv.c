...
MR_decl_label7(transform_hlds__loop_inv__create_aux_pred_10_0, 19,20,23,24,26,31,32)
...
MR_decl_label7(transform_hlds__loop_inv__hoist_loop_invariants_7_0, 24,26,27,28,29,30,2)
...
MR_decl_label8(fn__transform_hlds__loop_inv__goal_inputs_2_0, 99,31,28,93,20,13,94,7)
...
MR_BEGIN_MODULE(transform_hlds__loop_inv_module10)
	...
	MR_init_label7(transform_hlds__loop_inv__create_aux_pred_10_0,19,20,23,24,26,31,32)
MR_BEGIN_CODE
...
MR_def_label(transform_hlds__loop_inv__create_aux_pred_10_0,24)
	...
	if (MR_PTAG_TESTR(MR_r1,1)) {
		MR_GOTO_LAB(transform_hlds__loop_inv__create_aux_pred_10_0_i26);
	}
	{
	MR_Word MR_tempr1, MR_tempr2;
...
MR_BEGIN_MODULE(transform_hlds__loop_inv_module19)
	...
	MR_init_label7(transform_hlds__loop_inv__hoist_loop_invariants_7_0,24,26,27,28,29,30,2)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(transform_hlds__loop_inv_module26)
	...
	MR_init_label8(fn__transform_hlds__loop_inv__goal_inputs_2_0,99,31,28,93,20,13,94,7)
...
MR_def_label(fn__transform_hlds__loop_inv__goal_inputs_2_0,26)
	...
	if ((MR_tempr2 == MR_mktag((MR_Integer) 2))) {
		MR_GOTO_LAB(fn__transform_hlds__loop_inv__goal_inputs_2_0_i99);
	}
	MR_tag_alloc_heap(MR_tempr3, 1, (MR_Integer) 2);
	MR_r1 = MR_tempr3;
	MR_tfield(1, MR_tempr3, 0) = MR_ctfield(0, MR_tempr1, 0);
	MR_tfield(1, MR_tempr3, 1) = (MR_Word) MR_tbmkword(0, 0);
	MR_tag_alloc_heap(MR_tempr4, 1, (MR_Integer) 2);
	MR_tfield(1, MR_tempr4, 0) = MR_ctfield(0, MR_tempr5, 0);
