      ...
      case (MR_Integer) 1:
        {
          ...
          {
            mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) &parse_tree__parse_tree_to_term_scalar_common_4[7], parse_tree__parse_tree_to_term__Arity_122, &parse_tree__parse_tree_to_term__Var_150);
          }
          {
          ...
          case (MR_Integer) 11:
            {
              ...
              {
                mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) &parse_tree__parse_tree_to_term_scalar_common_4[7], parse_tree__parse_tree_to_term__Arity_21, &parse_tree__parse_tree_to_term__Var_161);
              }
              {
