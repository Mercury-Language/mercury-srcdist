...
{
  {
    ...
    if (((MR_tag((MR_Word) Mode_7)) == (MR_Integer) 0))
    {
      ...
      if (succeeded)
      {
        packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), InstA_9, (MR_Integer) 1)));
      ...
      case (MR_Integer) 2:
        {
          ...
          MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), Inst_7, (MR_Integer) 0)));
          ...
          case (MR_Integer) 0:
            {
              ...
              MR_Unsigned packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Inst_7, (MR_Integer) 1)));
          ...
          case (MR_Integer) 1:
            {
              ...
              MR_Unsigned packed_args_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Inst_7, (MR_Integer) 1)));
  ...
  MR_Word InstName_7)
{
  while (MR_TRUE)
  {
    ...
    switch (MR_tag((MR_Word) InstName_7)) {
      ...
      case (MR_Integer) 1:
        {
          MR_Word Liveness_11 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(1), InstName_7, (MR_Integer) 0))) >> (MR_Integer) 1)) & (MR_Integer) 1);
          ...
          MR_Unsigned packed_args_3 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), InstName_7, (MR_Integer) 0)));
          ...
          case (MR_Integer) 0:
            {
              ...
              MR_Word Uniq_16 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(3), InstName_7, (MR_Integer) 2))) >> (MR_Integer) 2)) & (MR_Integer) 7);
              MR_Word IsLive_17 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(3), InstName_7, (MR_Integer) 2))) >> (MR_Integer) 1)) & (MR_Integer) 1);
          ...
          case (MR_Integer) 1:
            {
              ...
              MR_Word Uniq_117 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(3), InstName_7, (MR_Integer) 2))) >> (MR_Integer) 2)) & (MR_Integer) 7);
              MR_Word IsLive_118 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(3), InstName_7, (MR_Integer) 2))) >> (MR_Integer) 1)) & (MR_Integer) 1);
          ...
          case (MR_Integer) 4:
            {
              ...
              MR_Unsigned packed_args_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), InstName_7, (MR_Integer) 1)));
...
{
  {
    ...
    MR_String Var_52;
    MR_Word Var_55;
    MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), PredInstInfo_9, (MR_Integer) 0)));
    MR_Unsigned packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), PredInstInfo_9, (MR_Integer) 3)));
          ...
          case (MR_Integer) 1:
            {
              ...
              MR_Word Term2_28;
              MR_Word Term3_31;
              MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Type_3, (MR_Integer) 1)));
              MR_Unsigned packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Type_3, (MR_Integer) 4)));
              ...
              else
              {
                ...
                MR_Unsigned packed_args_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Var_44, (MR_Integer) 0)));
                MR_Unsigned packed_args_3;

                PredArgModes_22 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_44, (MR_Integer) 1))));
                packed_args_3 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Var_44, (MR_Integer) 3)));
...
{
  {
    ...
    switch (MR_tag((MR_Word) InstResults_5)) {
      ...
      case (MR_Integer) 1:
        {
          MR_Word GroundnessResult_7 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(1), InstResults_5, (MR_Integer) 0))) >> (MR_Integer) 2)) & (MR_Integer) 3);
          ...
          MR_Word Var_31;
          MR_Word Var_32;
          MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), InstResults_5, (MR_Integer) 0)));
  ...
  MR_Word * Term_3)
{
  ...
  else
  {
    ...
    MR_String Var_24;
    MR_Word Var_27;
    MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Var_14, (MR_Integer) 0)));
    MR_Unsigned packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Var_14, (MR_Integer) 3)));
