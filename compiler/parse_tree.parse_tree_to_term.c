    ...
    case (MR_Integer) 2:
      {
        ...
        if ((HOInstInfo_10 == (MR_Word) ((MR_Unsigned) 0U)))
        {
...

          {
            ...
            MR_hl_field(MR_mktag(0), Var_76, 0) = ((MR_Box) (Var_58));
          }
          {
            Term_8 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
        ...
        case (MR_Integer) 0:
          {
              ...
              case (MR_Integer) 1:
                {
                  ...
                  else
                  {
                    ...
                    Var_46 = parse_tree__parse_tree_to_term__bound_insts_to_term_2_4_f_0(Lang_5, Context_6, BoundInst_85, BoundInsts_86);
                  }
                  {
                  ...
                  if ((BoundInsts_16 == (MR_Word) ((MR_Unsigned) 0U)))
                    {
                      ...
                      MR_hl_field(MR_mktag(0), Var_48, 0) = ((MR_Box) (&parse_tree__parse_tree_to_term_scalar_common_2[41]));
                      MR_hl_field(MR_mktag(0), Var_48, 1) = ((MR_Box) ((MR_Unsigned) 0U));
                      MR_hl_field(MR_mktag(0), Var_48, 2) = ((MR_Box) (Context_6));
                    }
                  else
                  {
                    ...
                    Var_48 = parse_tree__parse_tree_to_term__bound_insts_to_term_2_4_f_0(Lang_5, Context_6, BoundInst_94, BoundInsts_95);
                  }
                  {
                    ArgTerms_17 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            ...
            Var_51 = parse_tree__parse_tree_to_term__inst_uniqueness_2_f_0(Uniq_59, (MR_String) "bound");
            {
