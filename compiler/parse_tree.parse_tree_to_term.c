    ...
    case (MR_Integer) 2:
      {
        ...
        if ((HOInstInfo_10 == (MR_Word) ((MR_Unsigned) 0U)))
        {
...

          {
            ...
            MR_hl_field(0, Var_105, 0) = ((MR_Box) (Var_25));
          }
          {
            Term_8 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
            MR_hl_field(0, Term_8, 0) = ((MR_Box) (Var_105));
            MR_hl_field(0, Term_8, 1) = ((MR_Box) ((MR_Unsigned) 0U));
            MR_hl_field(0, Term_8, 2) = ((MR_Box) (Context_6));
          }
        }
        else
        {
            ...
            case (MR_Integer) 1:
              {
                ...
                RetMode_80 = ((MR_Word) (conv0_RetMode_80));
                {
                  ...
                  MR_hl_field(0, Var_87, 0) = ((MR_Box) (&parse_tree__parse_tree_to_term_scalar_common_5[1]));
                  MR_hl_field(0, Var_87, 1) = ((MR_Box) (parse_tree__parse_tree_to_term__inst_to_term_with_context_3_f_0_1));
                  MR_hl_field(0, Var_87, 2) = ((MR_Box) ((MR_Integer) 2));
                  MR_hl_field(0, Var_87, 3) = ((MR_Box) (Lang_5));
                  MR_hl_field(0, Var_87, 4) = ((MR_Box) (Context_6));
                }
                Var_86 = mercury__list__map_2_f_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_mode_0), (MR_Word) (&parse_tree__parse_tree_to_term_scalar_common_1[1]), Var_87, ArgModes_79);
                parse_tree__prog_util__construct_qualified_term_with_context_4_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), (MR_Word) (&parse_tree__parse_tree_to_term_scalar_common_2[39]), Var_86, Context_6, &ArgModesTerm_81);
                Var_91 = parse_tree__parse_tree_to_term__mode_to_term_with_context_3_f_0(Lang_5, Context_6, RetMode_80);
                {
                ...
                }
                {
                  ...
                  MR_hl_field(1, Var_89, 0) = ((MR_Box) (ArgModesTerm_81));
                  MR_hl_field(1, Var_89, 1) = ((MR_Box) (Var_90));
                }
                parse_tree__prog_util__construct_qualified_term_with_context_4_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), (MR_Word) (&parse_tree__parse_tree_to_term_scalar_common_2[2]), Var_89, Context_6, &ModesTerm_78);
              }
              break;
            case (MR_Integer) 0:
              {
...

                {
                  ...
                  MR_hl_field(0, Var_84, 1) = ((MR_Box) (parse_tree__parse_tree_to_term__inst_to_term_with_context_3_f_0_2));
                  MR_hl_field(0, Var_84, 2) = ((MR_Box) ((MR_Integer) 2));
                  MR_hl_field(0, Var_84, 3) = ((MR_Box) (Lang_5));
                  MR_hl_field(0, Var_84, 4) = ((MR_Box) (Context_6));
                }
                Var_83 = mercury__list__map_2_f_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_mode_0), (MR_Word) (&parse_tree__parse_tree_to_term_scalar_common_1[1]), Var_84, Modes_75);
          ...
          Var_96 = parse_tree__parse_tree_to_term__det_to_term_2_f_0(Context_6, Det_77);
          {
          ...
          }
          {
            ...
            MR_hl_field(1, Var_94, 0) = ((MR_Box) (ModesTerm_78));
            MR_hl_field(1, Var_94, 1) = ((MR_Box) (Var_95));
          }
          parse_tree__prog_util__construct_qualified_term_with_context_4_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), (MR_Word) (&parse_tree__parse_tree_to_term_scalar_common_2[13]), Var_94, Context_6, &Term_8);
        }
      }
      break;
    case (MR_Integer) 3:
                  ...
                  if ((BoundInsts_16 == (MR_Word) ((MR_Unsigned) 0U)))
                    {
                      ...
                      MR_hl_field(0, Var_35, 0) = ((MR_Box) (&parse_tree__parse_tree_to_term_scalar_common_2[41]));
                      MR_hl_field(0, Var_35, 1) = ((MR_Box) ((MR_Unsigned) 0U));
                      MR_hl_field(0, Var_35, 2) = ((MR_Box) (Context_6));
                    }
                  else
                  {
                    MR_Word BoundInst_114 = ((MR_Word) ((MR_hl_field(1, BoundInsts_16, (MR_Integer) 0))));
                    MR_Word BoundInsts_115 = ((MR_Word) ((MR_hl_field(1, BoundInsts_16, (MR_Integer) 1))));

                    Var_35 = parse_tree__parse_tree_to_term__bound_insts_to_term_2_4_f_0(Lang_5, Context_6, BoundInst_114, BoundInsts_115);
                  }
                  {
