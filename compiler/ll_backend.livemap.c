      ...
      case (MR_Integer) 2:
        {
          ...
          MR_Integer Var_13 = ((MR_Integer) (MR_hl_field(MR_mktag(2), Rval_4, (MR_Integer) 0)));
          ...
          case (MR_Integer) 3:
            {
              ...
              MR_Word Var_16 = ((MR_Word) (MR_hl_field(MR_mktag(3), Rval_4, (MR_Integer) 1)));
                ...
                case (MR_Integer) 2:
                  {
                    ...
                    MR_Word _MaybeTag_41 = ((MR_Word) (MR_hl_field(MR_mktag(2), MemRef_21, (MR_Integer) 1)));
                    MR_Word next_value_of_Rval_4;
                    MR_Word next_value_of_STATE_VARIABLE_Live_0_22;
