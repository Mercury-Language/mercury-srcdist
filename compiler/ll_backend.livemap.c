          ...
          case (MR_Integer) 7:
            {
              ...
              }
              {
                ...
                MR_hl_field(MR_mktag(0), ll_backend__livemap__Var_160, 0) = ((MR_Box) (&ll_backend__livemap_scalar_common_4[0]));
    ...
    switch (MR_tag((MR_Word) ll_backend__livemap__CodeAddr_3)) {
      ...
      case (MR_Integer) 0:
        switch (MR_unmkbody(ll_backend__livemap__CodeAddr_3)) {
          ...
          case (MR_Integer) 0:
            {
              *ll_backend__livemap__MaybeSpecial_4 = (MR_Word) MR_mkword(MR_mktag(1), &ll_backend__livemap_scalar_common_3[0]);
            }
            break;
          case (MR_Integer) 1:
            {
              *ll_backend__livemap__MaybeSpecial_4 = (MR_Word) MR_mkword(MR_mktag(1), &ll_backend__livemap_scalar_common_3[2]);
            }
            break;
          case (MR_Integer) 2:
          case (MR_Integer) 3:
      ...
      case (MR_Integer) 3:
        switch (((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), ll_backend__livemap__CodeAddr_3, (MR_Integer) 0)))) {
          ...
          case (MR_Integer) 0:
            {
              *ll_backend__livemap__MaybeSpecial_4 = (MR_Word) MR_mkword(MR_mktag(1), &ll_backend__livemap_scalar_common_3[4]);
            }
            break;
          case (MR_Integer) 1:
          case (MR_Integer) 2:
