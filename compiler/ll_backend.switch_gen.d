...
ifeq ($(TARGET_ASM),yes)
ll_backend.switch_gen.mh ll_backend.switch_gen.mih : ll_backend.switch_gen.s
else
ll_backend.switch_gen.mh ll_backend.switch_gen.mih : ll_backend.switch_gen.c
endif

ifeq ($(TARGET_ASM),yes)
ll_backend.switch_gen.module_dep : ll_backend.switch_gen.s
else
 ifeq ($(findstring il,$(GRADE)),il)
ll_backend.switch_gen.module_dep : ll_backend.switch_gen.il
  ifeq ($(findstring java,$(GRADE)),java)
ll_backend.switch_gen.module_dep : mercury/ll_backend_/switch_gen.java
  else
...
ifeq ($(TARGET_ASM),yes)
ll_backend.switch_gen.s_date : switch_gen.m
	$(MCG) $(ALL_GRADEFLAGS) $(ALL_MCGFLAGS) --target-code-only ll_backend.switch_gen $(ERR_REDIRECT)
ll_backend.switch_gen.pic_s_date : switch_gen.m
	$(MCG) $(ALL_GRADEFLAGS) $(ALL_MCGFLAGS) --target-code-only --pic \
		--cflags "$(GCCFLAGS_FOR_PIC)" ll_backend.switch_gen $(ERR_REDIRECT)
endif # TARGET_ASM
