...
#line 27 "transform_hlds.rbmm.points_to_info.c"
#line 538 "../library/io.int"
#include "string.mh"

#line 31 "transform_hlds.rbmm.points_to_info.c"
#line 87 "../library/table_builtin.int2"
#include "table_builtin.mh"

#line 35 "transform_hlds.rbmm.points_to_info.c"
#line 29 "../library/bitmap.int2"
#include "bitmap.mh"

#line 39 "transform_hlds.rbmm.points_to_info.c"
#line 28 "../library/time.int2"
#include "time.mh"

#line 43 "transform_hlds.rbmm.points_to_info.c"
#line 17 "../mdbcomp/mdbcomp.rtti_access.int2"
#include "mdbcomp.rtti_access.mh"

#line 47 "transform_hlds.rbmm.points_to_info.c"
#line 31 "../library/array.int2"
#include "array.mh"

#line 51 "transform_hlds.rbmm.points_to_info.c"
#line 52 "transform_hlds.rbmm.points_to_info.c"
#include "transform_hlds.rbmm.points_to_info.mh"

#line 55 "transform_hlds.rbmm.points_to_info.c"
#line 56 "transform_hlds.rbmm.points_to_info.c"
#ifndef TRANSFORM_HLDS__RBMM__POINTS_TO_INFO_DECL_GUARD
#define TRANSFORM_HLDS__RBMM__POINTS_TO_INFO_DECL_GUARD

#line 60 "transform_hlds.rbmm.points_to_info.c"
#line 61 "transform_hlds.rbmm.points_to_info.c"

#endif
#line 64 "transform_hlds.rbmm.points_to_info.c"
...
MR_decl_label7(transform_hlds__rbmm__points_to_info__add_node_from_var_6_0, 2,3,4,5,6,7,8)
MR_decl_label5(transform_hlds__rbmm__points_to_info__rpt_alpha_mapping_at_call_site_equal_2_3_0, 22,4,6,2,1)
MR_decl_label8(transform_hlds__rbmm__points_to_info__rpt_alpha_mapping_equal_2_3_0, 31,4,6,7,8,9,10,2)
MR_decl_label1(transform_hlds__rbmm__points_to_info__rpt_alpha_mapping_equal_2_3_0, 1)
MR_decl_label5(transform_hlds__rbmm__points_to_info__rpta_info_equal_2_0, 2,4,5,6,1)
MR_decl_label5(fn__transform_hlds__rbmm__points_to_info__rpta_info_init_1_0, 2,3,4,5,6)
MR_decl_label3(__Unify___transform_hlds__rbmm__points_to_info__rpta_info_0_0, 4,8,1)
MR_decl_label4(__Compare___transform_hlds__rbmm__points_to_info__rpta_info_0_0, 3,2,5,21)
...
MR_BEGIN_MODULE(transform_hlds__rbmm__points_to_info_module3)
	...
	MR_init_label5(fn__transform_hlds__rbmm__points_to_info__rpta_info_init_1_0,2,3,4,5,6)
MR_BEGIN_CODE
...
MR_def_label(fn__transform_hlds__rbmm__points_to_info__rpta_info_init_1_0,2)
	...
	MR_np_call_localret_ent(map__keys_2_0,
		fn__transform_hlds__rbmm__points_to_info__rpta_info_init_1_0_i3);
MR_def_label(fn__transform_hlds__rbmm__points_to_info__rpta_info_init_1_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
...
MR_def_label(fn__transform_hlds__rbmm__points_to_info__rpta_info_init_1_0,4)
	...
	MR_np_call_localret_ent(list__foldl2_6_0,
		fn__transform_hlds__rbmm__points_to_info__rpta_info_init_1_0_i5);
MR_def_label(fn__transform_hlds__rbmm__points_to_info__rpta_info_init_1_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(1) = MR_r2;
...
MR_BEGIN_MODULE(transform_hlds__rbmm__points_to_info_module5)
	...
	MR_init_label8(transform_hlds__rbmm__points_to_info__rpt_alpha_mapping_equal_2_3_0,31,4,6,7,8,9,10,2)
	MR_init_label1(transform_hlds__rbmm__points_to_info__rpt_alpha_mapping_equal_2_3_0,1)
MR_BEGIN_CODE
...
MR_def_label(transform_hlds__rbmm__points_to_info__rpt_alpha_mapping_equal_2_3_0,31)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TEST(MR_r1,0,0)) {
	...
	MR_r4 = MR_sv(3);
	MR_np_call_localret_ent(map__search_3_0,
		transform_hlds__rbmm__points_to_info__rpt_alpha_mapping_equal_2_3_0_i4);
MR_def_label(transform_hlds__rbmm__points_to_info__rpt_alpha_mapping_equal_2_3_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
	...
	MR_r3 = MR_sv(1);
	MR_np_call_localret_ent(map__lookup_3_0,
		transform_hlds__rbmm__points_to_info__rpt_alpha_mapping_equal_2_3_0_i6);
MR_def_label(transform_hlds__rbmm__points_to_info__rpt_alpha_mapping_equal_2_3_0,6)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(5) = MR_r1;
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(transform_hlds__rbmm__points_to_graph, rptg_node);
	MR_r2 = (MR_Word) MR_CTOR0_ADDR(transform_hlds__rbmm__points_to_graph, rptg_node);
...
MR_def_label(transform_hlds__rbmm__points_to_info__rpt_alpha_mapping_equal_2_3_0,10)
	...
	MR_GOTO_LAB(transform_hlds__rbmm__points_to_info__rpt_alpha_mapping_equal_2_3_0_i31);
...
MR_BEGIN_MODULE(transform_hlds__rbmm__points_to_info_module6)
	...
	MR_init_label5(transform_hlds__rbmm__points_to_info__rpta_info_equal_2_0,2,4,5,6,1)
MR_BEGIN_CODE
...
MR_def_label(transform_hlds__rbmm__points_to_info__rpta_info_equal_2_0,2)
	...
	MR_r3 = MR_sv(1);
	MR_np_call_localret_ent(map__count_2_0,
		transform_hlds__rbmm__points_to_info__rpta_info_equal_2_0_i4);
MR_def_label(transform_hlds__rbmm__points_to_info__rpta_info_equal_2_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(3) = MR_r1;
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(transform_hlds__smm_common, program_point);
	MR_r2 = MR_sv(4);
...
MR_BEGIN_MODULE(transform_hlds__rbmm__points_to_info_module7)
	...
	MR_init_label7(transform_hlds__rbmm__points_to_info__add_node_from_var_6_0,2,3,4,5,6,7,8)
MR_BEGIN_CODE
...
MR_def_static(transform_hlds__rbmm__points_to_info__add_node_from_var_6_0)
	...
	MR_np_call_localret_ent(f_109_97_112_95_95_84_121_112_101_83_112_101_99_79_102_95_95_112_114_101_100_95_111_114_95_102_117_110_99_95_95_108_111_111_107_117_112_95_95_91_75_32_61_32_118_97_114_40_86_95_50_41_93_95_48_95_49_3_0,
		transform_hlds__rbmm__points_to_info__add_node_from_var_6_0_i2);
MR_def_label(transform_hlds__rbmm__points_to_info__add_node_from_var_6_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(3) = MR_r1;
	MR_r1 = MR_sv(6);
...
MR_BEGIN_MODULE(transform_hlds__rbmm__points_to_info_module10)
	...
	MR_init_label3(__Unify___transform_hlds__rbmm__points_to_info__rpta_info_0_0,4,8,1)
MR_BEGIN_CODE
...
MR_define_entry(mercury____Unify___transform_hlds__rbmm__points_to_info__rpta_info_0_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if ((MR_r1 == MR_r2)) {
		MR_GOTO_LAB(__Unify___transform_hlds__rbmm__points_to_info__rpta_info_0_0_i8);
	}
	MR_incr_sp(3);
...
MR_def_label(__Unify___transform_hlds__rbmm__points_to_info__rpta_info_0_0,4)
	...
	MR_decr_sp(3);
	MR_np_tailcall_ent(__Unify___tree234__tree234_2_0);
MR_def_label(__Unify___transform_hlds__rbmm__points_to_info__rpta_info_0_0,8)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_TRUE;
	MR_proceed();
...
MR_BEGIN_MODULE(transform_hlds__rbmm__points_to_info_module11)
	...
	MR_init_label4(__Compare___transform_hlds__rbmm__points_to_info__rpta_info_0_0,3,2,5,21)
MR_BEGIN_CODE
...
MR_def_label(__Compare___transform_hlds__rbmm__points_to_info__rpta_info_0_0,5)
	...
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___transform_hlds__rbmm__points_to_info__rpta_info_0_0_i21);
	}
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(transform_hlds__smm_common, program_point);
	MR_r2 = (MR_Word) MR_TAG_COMMON(0,1,1);
	MR_r3 = MR_sv(1);
	...
	MR_decr_sp(3);
	MR_np_tailcall_ent(__Compare___tree234__tree234_2_0);
MR_def_label(__Compare___transform_hlds__rbmm__points_to_info__rpta_info_0_0,21)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(3);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
...
void mercury__transform_hlds__rbmm__points_to_info__write_out_proc_statics(FILE *fp);
#endif
