...
{
  {
    ...
    if (transform_hlds__rbmm__points_to_info__succeeded)
      *transform_hlds__rbmm__points_to_info__HeadVar__1_1 = (MR_Integer) 0;
      ...
      {
        MR_Word transform_hlds__rbmm__points_to_info__Var_4 = ((MR_Word) (MR_hl_field(MR_mktag(0), transform_hlds__rbmm__points_to_info__HeadVar__2_2, (MR_Integer) 0)));
        MR_Word transform_hlds__rbmm__points_to_info__Var_5 = ((MR_Word) (MR_hl_field(MR_mktag(0), transform_hlds__rbmm__points_to_info__HeadVar__2_2, (MR_Integer) 1)));
        MR_Word transform_hlds__rbmm__points_to_info__Var_6 = ((MR_Word) (MR_hl_field(MR_mktag(0), transform_hlds__rbmm__points_to_info__HeadVar__3_3, (MR_Integer) 0)));
        MR_Word transform_hlds__rbmm__points_to_info__Var_7 = ((MR_Word) (MR_hl_field(MR_mktag(0), transform_hlds__rbmm__points_to_info__HeadVar__3_3, (MR_Integer) 1)));
        MR_Word transform_hlds__rbmm__points_to_info__Var_8;

        {
          transform_hlds__rbmm__points_to_graph____Compare____rpt_graph_0_0(&transform_hlds__rbmm__points_to_info__Var_8, transform_hlds__rbmm__points_to_info__Var_4, transform_hlds__rbmm__points_to_info__Var_6);
        }
        ...
        if (transform_hlds__rbmm__points_to_info__succeeded)
          *transform_hlds__rbmm__points_to_info__HeadVar__1_1 = transform_hlds__rbmm__points_to_info__Var_8;
          ...
          {
            {
              mercury__builtin__compare_3_p_0((MR_Word) &transform_hlds__rbmm__points_to_info_scalar_common_2[1], transform_hlds__rbmm__points_to_info__HeadVar__1_1, ((MR_Box) (transform_hlds__rbmm__points_to_info__Var_5)), ((MR_Box) (transform_hlds__rbmm__points_to_info__Var_7)));
            }
          }
      }
  }
...
{
  {
    ...
    if (transform_hlds__rbmm__points_to_info__succeeded)
    ...
    else
      {
        ...
        MR_Word transform_hlds__rbmm__points_to_info__Var_3 = ((MR_Word) (MR_hl_field(MR_mktag(0), transform_hlds__rbmm__points_to_info__HeadVar__1_1, (MR_Integer) 0)));
        MR_Word transform_hlds__rbmm__points_to_info__Var_4 = ((MR_Word) (MR_hl_field(MR_mktag(0), transform_hlds__rbmm__points_to_info__HeadVar__1_1, (MR_Integer) 1)));
        MR_Word transform_hlds__rbmm__points_to_info__Var_5 = ((MR_Word) (MR_hl_field(MR_mktag(0), transform_hlds__rbmm__points_to_info__HeadVar__2_2, (MR_Integer) 0)));
        MR_Word transform_hlds__rbmm__points_to_info__Var_6 = ((MR_Word) (MR_hl_field(MR_mktag(0), transform_hlds__rbmm__points_to_info__HeadVar__2_2, (MR_Integer) 1)));

        {
          transform_hlds__rbmm__points_to_info__succeeded = transform_hlds__rbmm__points_to_graph____Unify____rpt_graph_0_0(transform_hlds__rbmm__points_to_info__Var_3, transform_hlds__rbmm__points_to_info__Var_5);
        }
        if (transform_hlds__rbmm__points_to_info__succeeded)
          {
            transform_hlds__rbmm__points_to_info__TypeInfo_10_10 = (MR_Word) &transform_hlds__rbmm__points_to_info_scalar_common_2[1];
            {
              transform_hlds__rbmm__points_to_info__succeeded = mercury__builtin__unify_2_p_0(transform_hlds__rbmm__points_to_info__TypeInfo_10_10, ((MR_Box) (transform_hlds__rbmm__points_to_info__Var_4)), ((MR_Box) (transform_hlds__rbmm__points_to_info__Var_6)));
            }
          }
      }
    return transform_hlds__rbmm__points_to_info__succeeded;
