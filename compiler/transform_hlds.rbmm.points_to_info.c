  ...
  MR_Word HeadVar__2_2)
{
  ...
  else
  {
    ...
    if (succeeded)
    {
      TypeInfo__10_10 = (MR_Word) (&transform_hlds__rbmm__points_to_info_scalar_common_2[1]);
  ...
  MR_Word * STATE_VARIABLE_Graph_19)
{
  ...
  parse_tree__vartypes__lookup_var_type_3_p_0(VarTypes_7, Var_8, &NodeType_12);
...
{
  MR_bool succeeded;
  MR_Word TypeCtorInfo__8_12;
  MR_Word TypeInfo__9_13;
  ...
  if (succeeded)
  {
    TypeCtorInfo__8_12 = (MR_Word) (&transform_hlds__smm_common__transform_hlds__smm_common__type_ctor_info_program_point_0);
    TypeInfo__9_13 = (MR_Word) (&transform_hlds__rbmm__points_to_info_scalar_common_2[0]);
    mercury__map__count_2_p_0(TypeCtorInfo__8_12, TypeInfo__9_13, AlphaA_6, &CA_9);
    mercury__map__count_2_p_0(TypeCtorInfo__8_12, TypeInfo__9_13, AlphaB_8, &CB_10);
    succeeded = (CA_9 == CB_10);
    if (succeeded)
    {
      mercury__map__keys_2_p_0(TypeCtorInfo__8_12, TypeInfo__9_13, AlphaA_6, &CallSitesA_11);
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        TypeCtorInfo__8_17 = (MR_Word) (&transform_hlds__rbmm__points_to_graph__transform_hlds__rbmm__points_to_graph__type_ctor_info_rptg_node_0);
        mercury__map__count_2_p_0(TypeCtorInfo__8_17, TypeCtorInfo__8_17, AlphaMappingAtCallSiteA_11, &CA_14);
        mercury__map__count_2_p_0(TypeCtorInfo__8_17, TypeCtorInfo__8_17, AlphaMappingAtCallSiteB_10, &CB_15);
        succeeded = (CA_14 == CB_15);
        if (succeeded)
        {
          mercury__map__keys_2_p_0(TypeCtorInfo__8_17, TypeCtorInfo__8_17, AlphaMappingAtCallSiteA_11, &NodesA_16);
  ...
  MR_Word ProcInfo_3)
{
  ...
  MR_Word Vars_7;
  MR_Word Graph_9;
  MR_Word AlphaMapping_10;
  MR_Word Var_11;
  MR_Word Var_13;
  MR_Word _VarSet_5;
  MR_Box conv3__Reg_8;
  MR_Box conv2_Graph_9;

  hlds__hlds_pred__proc_info_get_varset_vartypes_3_p_0(ProcInfo_3, &_VarSet_5, &VarTypes_6);
  parse_tree__vartypes__vartypes_vars_2_p_0(VarTypes_6, &Vars_7);
  {
    Var_11 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(MR_mktag(0), Var_11, 0) = ((MR_Box) (&transform_hlds__rbmm__points_to_info_scalar_common_3[0]));
    MR_hl_field(MR_mktag(0), Var_11, 1) = ((MR_Box) (transform_hlds__rbmm__points_to_info__rpta_info_init_1_f_0_1));
    MR_hl_field(MR_mktag(0), Var_11, 2) = ((MR_Box) ((MR_Integer) 1));
    MR_hl_field(MR_mktag(0), Var_11, 3) = ((MR_Box) (VarTypes_6));
  }
  Var_13 = transform_hlds__rbmm__points_to_graph__rpt_graph_init_0_f_0();
  mercury__list__foldl2_6_p_0((MR_Word) (&transform_hlds__rbmm__points_to_info_scalar_common_1[0]), (MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0), (MR_Word) (&transform_hlds__rbmm__points_to_graph__transform_hlds__rbmm__points_to_graph__type_ctor_info_rpt_graph_0), Var_11, Vars_7, ((MR_Box) ((MR_Integer) 1)), &conv3__Reg_8, ((MR_Box) (Var_13)), &conv2_Graph_9);
  Graph_9 = ((MR_Word) (conv2_Graph_9));
  mercury__map__init_1_p_0((MR_Word) (&transform_hlds__smm_common__transform_hlds__smm_common__type_ctor_info_program_point_0), (MR_Word) (&transform_hlds__rbmm__points_to_info_scalar_common_2[0]), &AlphaMapping_10);
  {
    RptaInfo_4 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(MR_mktag(0), RptaInfo_4, 0) = ((MR_Box) (Graph_9));
    MR_hl_field(MR_mktag(0), RptaInfo_4, 1) = ((MR_Box) (AlphaMapping_10));
  }
  return RptaInfo_4;
}
