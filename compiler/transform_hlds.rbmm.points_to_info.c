...
MR_decl_label7(transform_hlds__rbmm__points_to_info__add_node_from_var_6_0, 2,3,4,5,6,7,9)
MR_decl_label5(transform_hlds__rbmm__points_to_info__rpt_alpha_mapping_at_call_site_equal_2_3_0, 22,4,6,2,1)
MR_decl_label9(transform_hlds__rbmm__points_to_info__rpt_alpha_mapping_equal_2_3_0, 39,4,6,7,8,9,10,2,1)
MR_decl_label5(transform_hlds__rbmm__points_to_info__rpta_info_equal_2_0, 2,4,5,6,1)
MR_decl_label5(fn__transform_hlds__rbmm__points_to_info__rpta_info_init_1_0, 2,3,5,6,7)
MR_decl_label3(__Unify___transform_hlds__rbmm__points_to_info__rpta_info_0_0, 4,8,1)
MR_decl_label4(__Compare___transform_hlds__rbmm__points_to_info__rpta_info_0_0, 3,2,5,27)
...
MR_BEGIN_MODULE(transform_hlds__rbmm__points_to_info_module3)
	...
	MR_init_label5(fn__transform_hlds__rbmm__points_to_info__rpta_info_init_1_0,2,3,5,6,7)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(transform_hlds__rbmm__points_to_info_module5)
	...
	MR_init_label9(transform_hlds__rbmm__points_to_info__rpt_alpha_mapping_equal_2_3_0,39,4,6,7,8,9,10,2,1)
MR_BEGIN_CODE
...
MR_def_label(transform_hlds__rbmm__points_to_info__rpt_alpha_mapping_equal_2_3_0,39)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TEST(MR_r1,0,0)) {
	...
	MR_sv(4) = MR_tfield(1, MR_r1, 0);
	MR_sv(3) = MR_tfield(1, MR_r1, 1);
	MR_sv(5) = (MR_Word) MR_CTOR0_ADDR(transform_hlds__smm_common, program_point);
...
MR_def_label(transform_hlds__rbmm__points_to_info__rpt_alpha_mapping_equal_2_3_0,10)
	...
	MR_GOTO_LAB(transform_hlds__rbmm__points_to_info__rpt_alpha_mapping_equal_2_3_0_i39);
...
MR_def_label(transform_hlds__rbmm__points_to_info__rpta_info_equal_2_0,2)
	...
	MR_sv(4) = (MR_Word) MR_CTOR0_ADDR(transform_hlds__smm_common, program_point);
...
MR_BEGIN_MODULE(transform_hlds__rbmm__points_to_info_module7)
	...
	MR_init_label7(transform_hlds__rbmm__points_to_info__add_node_from_var_6_0,2,3,4,5,6,7,9)
MR_BEGIN_CODE
...
MR_def_label(transform_hlds__rbmm__points_to_info__add_node_from_var_6_0,7)
	...
	MR_np_call_localret_ent(transform_hlds__rbmm__points_to_graph__rptg_add_node_4_0,
		transform_hlds__rbmm__points_to_info__add_node_from_var_6_0_i9);
MR_def_label(transform_hlds__rbmm__points_to_info__add_node_from_var_6_0,9)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(1);
	MR_decr_sp_and_return(6);
#ifdef MR_maybe_local_thread_engine_base
...
MR_BEGIN_MODULE(transform_hlds__rbmm__points_to_info_module13)
	...
	MR_init_label4(__Compare___transform_hlds__rbmm__points_to_info__rpta_info_0_0,3,2,5,27)
MR_BEGIN_CODE
...
MR_def_label(__Compare___transform_hlds__rbmm__points_to_info__rpta_info_0_0,5)
	...
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___transform_hlds__rbmm__points_to_info__rpta_info_0_0_i27);
	}
	MR_r1 = (MR_Word) MR_TAG_COMMON(0,1,1);
	MR_r2 = MR_sv(1);
	MR_r3 = MR_sv(2);
	...
	MR_decr_sp(3);
	MR_np_tailcall_ent(builtin__compare_3_0);
MR_def_label(__Compare___transform_hlds__rbmm__points_to_info__rpta_info_0_0,27)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(3);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
...
void mercury__transform_hlds__rbmm__points_to_info__write_out_proc_statics(FILE *deep_fp, FILE *procrep_fp)
{
	MR_write_out_module_proc_reps_start(procrep_fp, &mercury_data__module_layout__transform_hlds__rbmm__points_to_info);
