...
static const MR_FA_TypeInfo_Struct2 transform_hlds__rbmm__points_to_info__tree234__ti_tree234_2hlds__pred_proc_id__type_ctor_info_pred_proc_id_0transform_hlds__rbmm__points_to_info__type_ctor_info_rpta_info_0;
...
static const MR_DuFunctorDescPtr transform_hlds__rbmm__points_to_info__transform_hlds__rbmm__points_to_info__du_stag_ordered_rpta_info_0_0[1] = { &transform_hlds__rbmm__points_to_info__transform_hlds__rbmm__points_to_info__du_functor_desc_rpta_info_0_0 };
...
static const MR_DuFunctorDescPtr transform_hlds__rbmm__points_to_info__transform_hlds__rbmm__points_to_info__du_name_ordered_rpta_info_0[1] = { &transform_hlds__rbmm__points_to_info__transform_hlds__rbmm__points_to_info__du_functor_desc_rpta_info_0_0 };

static const MR_Integer transform_hlds__rbmm__points_to_info__transform_hlds__rbmm__points_to_info__functor_number_map_rpta_info_0[1] = { (MR_Integer) 0 };
...
const MR_TypeCtorInfo_Struct transform_hlds__rbmm__points_to_info__transform_hlds__rbmm__points_to_info__type_ctor_info_rpta_info_table_0 = {
  ...
  { NULL },
  { (MR_PseudoTypeInfo) (&transform_hlds__rbmm__points_to_info__tree234__ti_tree234_2hlds__pred_proc_id__type_ctor_info_pred_proc_id_0transform_hlds__rbmm__points_to_info__type_ctor_info_rpta_info_0) },
  (MR_Integer) -1,
  UINT16_C(0),
  NULL,
  ...
  MR_Word * STATE_VARIABLE_Graph_19)
{
  ...
  parse_tree__var_table__lookup_var_type_3_p_0(VarTable_7, Var_8, &NodeType_12);
  ...
  *Reg_10 = (MR_Integer) ((MR_Unsigned) Reg0_9 + (MR_Unsigned) 1);
  ...
  Var_23 = mercury__set__init_0_f_0((MR_Word) (&transform_hlds__rbmm__points_to_graph__transform_hlds__rbmm__points_to_graph__type_ctor_info_rptg_node_0));
  {
    ...
    MR_hl_field(0, NodeInfo_16, 0) = ((MR_Box) (Varset_14));
    MR_hl_field(0, NodeInfo_16, 1) = ((MR_Box) (RegName_15));
    MR_hl_field(0, NodeInfo_16, 2) = ((MR_Box) (Var_23));
    MR_hl_field(0, NodeInfo_16, 3) = ((MR_Box) (NodeType_12));
    MR_hl_field(0, NodeInfo_16, 4) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 0));
  }
...
{
  MR_bool succeeded;
  MR_Word TypeCtorInfo_8_12;
  MR_Word TypeInfo_9_13;
  MR_Word GraphA_5 = ((MR_Word) ((MR_hl_field(0, RptaInfoA_3, 0))));
  MR_Word AlphaA_6 = ((MR_Word) ((MR_hl_field(0, RptaInfoA_3, 1))));
  MR_Word GraphB_7 = ((MR_Word) ((MR_hl_field(0, RptaInfoB_4, 0))));
  MR_Word AlphaB_8 = ((MR_Word) ((MR_hl_field(0, RptaInfoB_4, 1))));
  MR_Integer CA_9;
  MR_Integer CB_10;
  MR_Word CallSitesA_11;

  succeeded = transform_hlds__rbmm__points_to_graph__rptg_equal_2_p_0(GraphA_5, GraphB_7);
  if (succeeded)
  {
    TypeCtorInfo_8_12 = (MR_Word) (&transform_hlds__smm_common__transform_hlds__smm_common__type_ctor_info_program_point_0);
    TypeInfo_9_13 = (MR_Word) (&transform_hlds__rbmm__points_to_info_scalar_common_2[0]);
    mercury__map__count_2_p_0(TypeCtorInfo_8_12, TypeInfo_9_13, AlphaA_6, &CA_9);
    mercury__map__count_2_p_0(TypeCtorInfo_8_12, TypeInfo_9_13, AlphaB_8, &CB_10);
    succeeded = (CA_9 == CB_10);
    if (succeeded)
    {
      mercury__map__keys_2_p_0(TypeCtorInfo_8_12, TypeInfo_9_13, AlphaA_6, &CallSitesA_11);
      succeeded = transform_hlds__rbmm__points_to_info__rpt_alpha_mapping_equal_2_3_p_0(CallSitesA_11, AlphaA_6, AlphaB_8);
    }
  }
  return succeeded;
}
  ...
  MR_Word AlphaMappingB_3)
{
  while (MR_TRUE)
  {
    ...
    {
      MR_Word TypeCtorInfo_8_17;
      MR_Word CallSiteA_6 = ((MR_Word) ((MR_hl_field(1, HeadVar__1_1, 0))));
      MR_Word CallSiteAs_7 = ((MR_Word) ((MR_hl_field(1, HeadVar__1_1, 1))));
      ...
      if (succeeded)
      {
        ...
        TypeCtorInfo_8_17 = (MR_Word) (&transform_hlds__rbmm__points_to_graph__transform_hlds__rbmm__points_to_graph__type_ctor_info_rptg_node_0);
        mercury__map__count_2_p_0(TypeCtorInfo_8_17, TypeCtorInfo_8_17, AlphaMappingAtCallSiteA_11, &CA_14);
        mercury__map__count_2_p_0(TypeCtorInfo_8_17, TypeCtorInfo_8_17, AlphaMappingAtCallSiteB_10, &CB_15);
        succeeded = (CA_14 == CB_15);
        if (succeeded)
        {
          mercury__map__keys_2_p_0(TypeCtorInfo_8_17, TypeCtorInfo_8_17, AlphaMappingAtCallSiteA_11, &NodesA_16);
          succeeded = transform_hlds__rbmm__points_to_info__rpt_alpha_mapping_at_call_site_equal_2_3_p_0(NodesA_16, AlphaMappingAtCallSiteA_11, AlphaMappingAtCallSiteB_10);
          if (succeeded)
          {
  ...
  MR_Word AMAtCallSiteB_3)
{
  while (MR_TRUE)
  {
    ...
    {
      MR_Word N_6 = ((MR_Word) ((MR_hl_field(1, HeadVar__1_1, 0))));
      MR_Word Ns_7 = ((MR_Word) ((MR_hl_field(1, HeadVar__1_1, 1))));
      MR_Word NPrimeB_10;
      MR_Word NPrimeA_11;
      MR_Integer Var_14;
      MR_Integer Var_15;
  ...
  MR_Box * wrapper_arg_5)
{
  ...
  transform_hlds__rbmm__points_to_info__add_node_from_var_6_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) (wrapper_arg_1)), ((MR_Integer) (wrapper_arg_2)), &conv1_Reg_10, ((MR_Word) (wrapper_arg_4)), &conv0_STATE_VARIABLE_Graph_19);
  ...
  MR_Word ProcInfo_3)
{
  ...
  hlds__hlds_proc__proc_info_get_var_table_2_p_0(ProcInfo_3, &VarTable_5);
  parse_tree__var_table__var_table_vars_2_p_0(VarTable_5, &Vars_6);
  {
    Var_10 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(0, Var_10, 0) = ((MR_Box) (&transform_hlds__rbmm__points_to_info_scalar_common_3[0]));
    MR_hl_field(0, Var_10, 1) = ((MR_Box) (transform_hlds__rbmm__points_to_info__rpta_info_init_1_f_0_1));
    MR_hl_field(0, Var_10, 2) = ((MR_Box) ((MR_Integer) 1));
    MR_hl_field(0, Var_10, 3) = ((MR_Box) (VarTable_5));
  }
  ...
  mercury__map__init_1_p_0((MR_Word) (&transform_hlds__smm_common__transform_hlds__smm_common__type_ctor_info_program_point_0), (MR_Word) (&transform_hlds__rbmm__points_to_info_scalar_common_2[0]), &AlphaMapping_9);
  {
    ...
    MR_hl_field(0, RptaInfo_4, 0) = ((MR_Box) (Graph_8));
    MR_hl_field(0, RptaInfo_4, 1) = ((MR_Box) (AlphaMapping_9));
  }
  return RptaInfo_4;
}
...
{
  mercury__map__set_4_p_0((MR_Word) (&hlds__pred_proc_id__hlds__pred_proc_id__type_ctor_info_pred_proc_id_0), (MR_Word) (&transform_hlds__rbmm__points_to_info__transform_hlds__rbmm__points_to_info__type_ctor_info_rpta_info_0), ((MR_Box) (PredProcId_5)), ((MR_Box) (RptaInfo_6)), STATE_VARIABLE_Table_0_8, STATE_VARIABLE_Table_9);
}

MR_bool MR_CALL 
transform_hlds__rbmm__points_to_info__rpta_info_table_search_rpta_info_3_p_0(
  MR_Word Table_4,
  MR_Word PredProcId_5,
  MR_Word * RptaInfo_6)
{
  ...
  succeeded = mercury__map__search_3_p_0((MR_Word) (&hlds__pred_proc_id__hlds__pred_proc_id__type_ctor_info_pred_proc_id_0), (MR_Word) (&transform_hlds__rbmm__points_to_info__transform_hlds__rbmm__points_to_info__type_ctor_info_rpta_info_0), Table_4, ((MR_Box) (PredProcId_5)), &conv0_RptaInfo_6);
  if (succeeded)
  {
...
transform_hlds__rbmm__points_to_info__rpta_info_table_init_0_f_0(void)
{
  ...
  HeadVar__1_1 = mercury__map__init_0_f_0((MR_Word) (&hlds__pred_proc_id__hlds__pred_proc_id__type_ctor_info_pred_proc_id_0), (MR_Word) (&transform_hlds__rbmm__points_to_info__transform_hlds__rbmm__points_to_info__type_ctor_info_rpta_info_0));
  return HeadVar__1_1;
}
