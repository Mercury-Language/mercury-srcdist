...
{
  {
    ...
    else
    {
      ...
      transform_hlds__rbmm__points_to_graph____Compare____rpt_graph_0_0(&Var_8, ArgX1_4, ArgY1_5);
      ...
      {
        mercury__builtin__compare_3_p_0((MR_Word) &transform_hlds__rbmm__points_to_info_scalar_common_2[1], HeadVar__1_1, ((MR_Box) (ArgX2_6)), ((MR_Box) (ArgY2_7)));
      }
    }
  }
}
...
{
  {
    ...
    TypeInfo_26_26 = (MR_Word) &transform_hlds__rbmm__points_to_info_scalar_common_1[0];
    mercury__set__init_1_p_0(TypeInfo_26_26, &Varset0_13);
    mercury__set__insert_3_p_0(TypeInfo_26_26, ((MR_Box) (Var_8)), Varset0_13, &Varset_14);
    *Reg_10 = (Reg0_9 + (MR_Integer) 1);
    ...
    {
      NodeInfo_16 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 5 * sizeof(MR_Word)), NULL, NULL);
      ...
      MR_hl_field(MR_mktag(0), NodeInfo_16, 4) = ((MR_Box) ((MR_Integer) 0));
    }
  ...
  MR_Word AlphaMappingB_3)
{
  while (MR_TRUE)
  {
    /* tailcall optimized into a loop */
    {
      ...
      {
        MR_Word TypeCtorInfo_12_12 = (MR_Word) &transform_hlds__smm_common__transform_hlds__smm_common__type_ctor_info_program_point_0;
        MR_Word TypeInfo_13_13 = (MR_Word) &transform_hlds__rbmm__points_to_info_scalar_common_2[0];
        ...
        succeeded = mercury__map__search_3_p_0(TypeCtorInfo_12_12, TypeInfo_13_13, AlphaMappingB_3, ((MR_Box) (CallSiteA_6)), &conv0_AlphaMappingAtCallSiteB_10);
        if (succeeded)
        {
        ...
        if (succeeded)
        {
          mercury__map__lookup_3_p_0(TypeCtorInfo_12_12, TypeInfo_13_13, AlphaMappingA_2, ((MR_Box) (CallSiteA_6)), &conv1_AlphaMappingAtCallSiteA_11);
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              ...
              {
                MR_Word next_value_of_HeadVar__1_1 = CallSiteAs_7;
  ...
  MR_Word AMAtCallSiteB_3)
{
  while (MR_TRUE)
  {
    /* tailcall optimized into a loop */
    {
      ...
      {
        MR_Word TypeCtorInfo_12_12 = (MR_Word) &transform_hlds__rbmm__points_to_graph__transform_hlds__rbmm__points_to_graph__type_ctor_info_rptg_node_0;
        ...
        succeeded = mercury__map__search_3_p_0(TypeCtorInfo_12_12, TypeCtorInfo_12_12, AMAtCallSiteB_3, ((MR_Box) (N_6)), &conv0_NPrimeB_10);
        if (succeeded)
        {
        ...
        if (succeeded)
        {
          mercury__map__lookup_3_p_0(TypeCtorInfo_12_12, TypeCtorInfo_12_12, AMAtCallSiteA_2, ((MR_Box) (N_6)), &conv1_NPrimeA_11);
          ...
          if (succeeded)
          {
            /* direct tailcall eliminated */
            {
              MR_Word next_value_of_HeadVar__1_1 = Ns_7;
...
{
  {
    ...
    _Reg_7 = ((MR_Integer) conv3__Reg_7);
    ...
    {
      RptaInfo_4 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
