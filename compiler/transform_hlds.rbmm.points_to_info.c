...
MR_decl_label8(transform_hlds__rbmm__points_to_info__rpt_alpha_mapping_equal_2_3_0, 32,5,7,8,9,10,11,2)
...
MR_decl_label4(__Compare___transform_hlds__rbmm__points_to_info__rpta_info_0_0, 3,2,5,22)
...
MR_BEGIN_MODULE(transform_hlds__rbmm__points_to_info_module5)
	...
	MR_init_label8(transform_hlds__rbmm__points_to_info__rpt_alpha_mapping_equal_2_3_0,32,5,7,8,9,10,11,2)
...
MR_def_label(transform_hlds__rbmm__points_to_info__rpt_alpha_mapping_equal_2_3_0,32)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TEST(MR_r1,0,0)) {
...
MR_def_label(transform_hlds__rbmm__points_to_info__rpt_alpha_mapping_equal_2_3_0,11)
	...
	MR_GOTO_LAB(transform_hlds__rbmm__points_to_info__rpt_alpha_mapping_equal_2_3_0_i32);
...
MR_BEGIN_MODULE(transform_hlds__rbmm__points_to_info_module11)
	...
	MR_init_label4(__Compare___transform_hlds__rbmm__points_to_info__rpta_info_0_0,3,2,5,22)
MR_BEGIN_CODE
...
MR_def_label(__Compare___transform_hlds__rbmm__points_to_info__rpta_info_0_0,5)
	...
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___transform_hlds__rbmm__points_to_info__rpta_info_0_0_i22);
	}
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(transform_hlds__smm_common, program_point);
	MR_r2 = (MR_Word) MR_TAG_COMMON(0,1,1);
	MR_r3 = MR_sv(1);
	...
	MR_decr_sp(3);
	MR_np_tailcall_ent(__Compare___tree234__tree234_2_0);
MR_def_label(__Compare___transform_hlds__rbmm__points_to_info__rpta_info_0_0,22)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(3);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
