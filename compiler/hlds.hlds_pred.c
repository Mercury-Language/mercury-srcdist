...
void MR_CALL 
hlds__hlds_pred__pred_info_get_pf_sym_name_user_arity_2_p_0(
  MR_Word PredInfo_3,
  MR_Word * PFSymNameArity_4)
{
  ...
  MR_Word PredOrFunc_52 = ((MR_Unsigned) ((MR_hl_field(0, PredInfo_3, 1))) & (MR_Integer) 1);
  MR_Word PredFormArity_53 = ((MR_Word) ((MR_hl_field(0, PredInfo_3, 3))));
  ...
  parse_tree__prog_util__user_arity_pred_form_arity_3_p_1(PredOrFunc_52, &UserArity_7, PredFormArity_53);
  {
    MR_Word base;
    base = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
    *PFSymNameArity_4 = base;
    MR_hl_field(0, base, 0) = (MR_Box) ((MR_Unsigned) (PredOrFunc_52));
    MR_hl_field(0, base, 1) = ((MR_Box) (SymName_6));
    MR_hl_field(0, base, 2) = ((MR_Box) (UserArity_7));
  }
}
