...
MR_decl_label8(ll_backend__lookup_util__figure_out_output_vars_3_0, 2,5,3,7,8,9,10,12)
...
MR_decl_label4(ll_backend__lookup_util__set_liveness_and_end_branch_7_0, 2,3,4,5)
...
MR_decl_static(ll_backend__lookup_util__IntroducedFrom__pred__generate_offset_assigns__218__1_1_0)
...
MR_BEGIN_MODULE(ll_backend__lookup_util_module0)
	...
	MR_init_label8(ll_backend__lookup_util__figure_out_output_vars_3_0,2,5,3,7,8,9,10,12)
MR_BEGIN_CODE
...
MR_def_label(ll_backend__lookup_util__figure_out_output_vars_3_0,10)
	...
	MR_np_call_localret_ent(fn__parse_tree__set_of_var__to_sorted_list_1_0,
		ll_backend__lookup_util__figure_out_output_vars_3_0_i12);
MR_def_label(ll_backend__lookup_util__figure_out_output_vars_3_0,12)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
...
MR_BEGIN_MODULE(ll_backend__lookup_util_module6)
	...
	MR_init_label4(ll_backend__lookup_util__set_liveness_and_end_branch_7_0,2,3,4,5)
MR_BEGIN_CODE
...
MR_def_label(ll_backend__lookup_util__set_liveness_and_end_branch_7_0,3)
	...
	MR_np_call_localret_ent(parse_tree__set_of_var__difference_3_0,
		ll_backend__lookup_util__set_liveness_and_end_branch_7_0_i4);
MR_def_label(ll_backend__lookup_util__set_liveness_and_end_branch_7_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = (MR_Integer) 0;
	MR_r3 = MR_sv(4);
...
MR_def_label(ll_backend__lookup_util__generate_offset_assigns_5_0,9)
	...
	MR_tfield(0, MR_tempr1, 1) = (MR_Word) MR_ENTRY_AP(ll_backend__lookup_util__IntroducedFrom__pred__generate_offset_assigns__218__1_1_0);
...
MR_BEGIN_MODULE(ll_backend__lookup_util_module9)
	MR_init_entry1(ll_backend__lookup_util__IntroducedFrom__pred__generate_offset_assigns__218__1_1_0);
	MR_INIT_PROC_LAYOUT_ADDR(mercury__ll_backend__lookup_util__IntroducedFrom__pred__generate_offset_assigns__218__1_1_0);
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'IntroducedFrom__pred__generate_offset_assigns__218__1'/1 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(ll_backend__lookup_util__IntroducedFrom__pred__generate_offset_assigns__218__1_1_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
...
void mercury__ll_backend__lookup_util__write_out_proc_statics(FILE *deep_fp, FILE *procrep_fp)
{
	MR_write_out_module_proc_reps_start(procrep_fp, &mercury_data__module_layout__ll_backend__lookup_util);
