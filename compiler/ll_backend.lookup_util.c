...
#line 55 "ll_backend.lookup_util.c"
...
#endif
#line 64 "ll_backend.lookup_util.c"
...
MR_decl_label4(ll_backend__lookup_util__IntroducedFrom__pred__figure_out_output_vars__103__1_5_0, 1,2,3,4)
...
MR_decl_label8(ll_backend__lookup_util__generate_constants_for_arm_9_0, 2,3,4,5,7,8,9,10)
MR_decl_label4(ll_backend__lookup_util__generate_constants_for_arm_9_0, 11,13,14,1)
MR_decl_label8(ll_backend__lookup_util__generate_constants_for_disjuncts_9_0, 38,4,5,6,7,8,10,11)
MR_decl_label8(ll_backend__lookup_util__generate_constants_for_disjuncts_9_0, 12,13,14,16,17,18,19,1)
MR_decl_label4(ll_backend__lookup_util__generate_offset_assigns_5_0, 12,4,5,3)
MR_decl_label6(ll_backend__lookup_util__get_arm_rvals_5_0, 28,4,5,7,9,1)
MR_decl_label3(ll_backend__lookup_util__goal_is_conj_of_unify_1_0, 2,4,1)
MR_decl_label2(ll_backend__lookup_util__only_constant_goals_1_0, 2,1)
MR_decl_label7(ll_backend__lookup_util__rval_is_constant_2_0, 47,11,7,5,6,4,1)
...
MR_decl_static(ll_backend__lookup_util__IntroducedFrom__pred__figure_out_output_vars__103__1_5_0)
MR_decl_static(ll_backend__lookup_util__IntroducedFrom__pred__generate_offset_assigns__230__1_1_0)
...
MR_def_label(ll_backend__lookup_util__figure_out_output_vars_3_0,10)
	...
	MR_tfield(0, MR_tempr1, 1) = (MR_Word) MR_ENTRY_AP(ll_backend__lookup_util__IntroducedFrom__pred__figure_out_output_vars__103__1_5_0);
...
MR_BEGIN_MODULE(ll_backend__lookup_util_module1)
	...
	MR_init_label2(ll_backend__lookup_util__only_constant_goals_1_0,2,1)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(ll_backend__lookup_util_module4)
	...
	MR_init_label7(ll_backend__lookup_util__rval_is_constant_2_0,47,11,7,5,6,4,1)
MR_BEGIN_CODE
...
MR_def_static(ll_backend__lookup_util__rval_is_constant_2_0)
	...
	MR_incr_sp(3);
	MR_sv(3) = (MR_Word) MR_succip;
MR_def_label(ll_backend__lookup_util__rval_is_constant_2_0,47)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_r1,3)) {
		MR_GOTO_LAB(ll_backend__lookup_util__rval_is_constant_2_0_i4);
	}
	if (MR_INT_EQ(MR_ctfield(3, MR_r1, 0),0)) {
		MR_GOTO_LAB(ll_backend__lookup_util__rval_is_constant_2_0_i5);
	}
	if (MR_INT_EQ(MR_ctfield(3, MR_r1, 0),1)) {
		MR_GOTO_LAB(ll_backend__lookup_util__rval_is_constant_2_0_i7);
	}
	...
	MR_np_localcall_lab(ll_backend__lookup_util__rval_is_constant_2_0,
		ll_backend__lookup_util__rval_is_constant_2_0_i11);
MR_def_label(ll_backend__lookup_util__rval_is_constant_2_0,11)
	...
	MR_r2 = MR_sv(1);
	MR_succip_word = MR_sv(3);
	MR_GOTO_LAB(ll_backend__lookup_util__rval_is_constant_2_0_i47);
MR_def_label(ll_backend__lookup_util__rval_is_constant_2_0,7)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_ctfield(3, MR_r1, 2);
	MR_succip_word = MR_sv(3);
	MR_GOTO_LAB(ll_backend__lookup_util__rval_is_constant_2_0_i47);
MR_def_label(ll_backend__lookup_util__rval_is_constant_2_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_ctfield(3, MR_r1, 1);
	MR_np_call_localret_ent(ll_backend__exprn_aux__const_is_constant_3_0,
		ll_backend__lookup_util__rval_is_constant_2_0_i6);
...
MR_decl_entry(libs__tree__tree_of_lists_is_empty_1_0);

MR_BEGIN_MODULE(ll_backend__lookup_util_module5)
	MR_init_entry1(ll_backend__lookup_util__get_arm_rvals_5_0);
	MR_init_label6(ll_backend__lookup_util__get_arm_rvals_5_0,28,4,5,7,9,1)
MR_BEGIN_CODE
...
MR_def_static(ll_backend__lookup_util__get_arm_rvals_5_0)
	...
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
		MR_GOTO_LAB(ll_backend__lookup_util__get_arm_rvals_5_0_i28);
	}
	MR_r3 = MR_r2;
	MR_r2 = (MR_Word) MR_tbmkword(0, 0);
	MR_r1 = MR_TRUE;
	MR_proceed();
MR_def_label(ll_backend__lookup_util__get_arm_rvals_5_0,28)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(5);
...
MR_def_label(ll_backend__lookup_util__get_arm_rvals_5_0,4)
	...
	MR_np_call_localret_ent(libs__tree__tree_of_lists_is_empty_1_0,
...
MR_BEGIN_MODULE(ll_backend__lookup_util_module6)
	...
	MR_init_label8(ll_backend__lookup_util__generate_constants_for_arm_9_0,2,3,4,5,7,8,9,10)
	MR_init_label4(ll_backend__lookup_util__generate_constants_for_arm_9_0,11,13,14,1)
MR_BEGIN_CODE
...
MR_def_label(ll_backend__lookup_util__generate_constants_for_arm_9_0,9)
	...
	MR_np_call_localret_ent(ll_backend__exprn_aux__init_exprn_opts_2_0,
		ll_backend__lookup_util__generate_constants_for_arm_9_0_i10);
MR_def_label(ll_backend__lookup_util__generate_constants_for_arm_9_0,10)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r3 = MR_r1;
	MR_r1 = MR_sv(2);
	MR_r2 = MR_sv(1);
...
MR_def_label(ll_backend__lookup_util__generate_constants_for_arm_9_0,11)
	...
	MR_np_call_localret_ent(ll_backend__code_info__generate_branch_end_6_0,
		ll_backend__lookup_util__generate_constants_for_arm_9_0_i13);
MR_def_label(ll_backend__lookup_util__generate_constants_for_arm_9_0,13)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(1) = MR_r1;
	MR_r1 = MR_sv(6);
	MR_r2 = MR_r3;
	MR_np_call_localret_ent(ll_backend__code_info__reset_to_position_3_0,
		ll_backend__lookup_util__generate_constants_for_arm_9_0_i14);
MR_def_label(ll_backend__lookup_util__generate_constants_for_arm_9_0,14)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_sv(2);
	MR_r3 = MR_sv(1);
	MR_r4 = MR_sv(4);
...
MR_BEGIN_MODULE(ll_backend__lookup_util_module7)
	...
	MR_init_label8(ll_backend__lookup_util__generate_constants_for_disjuncts_9_0,38,4,5,6,7,8,10,11)
	MR_init_label8(ll_backend__lookup_util__generate_constants_for_disjuncts_9_0,12,13,14,16,17,18,19,1)
MR_BEGIN_CODE
...
MR_define_entry(mercury__ll_backend__lookup_util__generate_constants_for_disjuncts_9_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
		MR_GOTO_LAB(ll_backend__lookup_util__generate_constants_for_disjuncts_9_0_i38);
	}
	MR_r2 = (MR_Word) MR_tbmkword(0, 0);
	MR_r3 = MR_r4;
	...
	MR_r1 = MR_TRUE;
	MR_proceed();
MR_def_label(ll_backend__lookup_util__generate_constants_for_disjuncts_9_0,38)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(8);
...
MR_def_label(ll_backend__lookup_util__generate_constants_for_disjuncts_9_0,4)
	...
	MR_np_call_localret_ent(ll_backend__code_info__remember_position_2_0,
		ll_backend__lookup_util__generate_constants_for_disjuncts_9_0_i5);
MR_def_label(ll_backend__lookup_util__generate_constants_for_disjuncts_9_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(7) = MR_r1;
...
MR_def_label(ll_backend__lookup_util__generate_constants_for_disjuncts_9_0,8)
	...
	MR_r1 = MR_sv(4);
	MR_np_call_localret_ent(ll_backend__code_info__get_forward_live_vars_2_0,
		ll_backend__lookup_util__generate_constants_for_disjuncts_9_0_i10);
MR_def_label(ll_backend__lookup_util__generate_constants_for_disjuncts_9_0,10)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(6) = MR_r1;
	MR_r1 = MR_sv(4);
	MR_np_call_localret_ent(ll_backend__code_info__get_globals_2_0,
...
MR_def_label(ll_backend__lookup_util__generate_constants_for_disjuncts_9_0,13)
	...
	MR_r2 = MR_sv(4);
	MR_np_call_localret_ent(ll_backend__lookup_util__get_arm_rvals_5_0,
		ll_backend__lookup_util__generate_constants_for_disjuncts_9_0_i14);
MR_def_label(ll_backend__lookup_util__generate_constants_for_disjuncts_9_0,14)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(ll_backend__lookup_util__generate_constants_for_disjuncts_9_0_i1);
	}
...
MR_def_label(ll_backend__lookup_util__generate_constants_for_disjuncts_9_0,17)
	...
	MR_r2 = MR_r3;
	MR_np_call_localret_ent(ll_backend__code_info__reset_to_position_3_0,
		ll_backend__lookup_util__generate_constants_for_disjuncts_9_0_i18);
MR_def_label(ll_backend__lookup_util__generate_constants_for_disjuncts_9_0,18)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
...
MR_BEGIN_MODULE(ll_backend__lookup_util_module9)
	...
	MR_init_label4(ll_backend__lookup_util__generate_offset_assigns_5_0,12,4,5,3)
MR_BEGIN_CODE
...
MR_define_entry(mercury__ll_backend__lookup_util__generate_offset_assigns_5_0);
	...
	MR_incr_sp(5);
	MR_sv(5) = (MR_Word) MR_succip;
MR_def_label(ll_backend__lookup_util__generate_offset_assigns_5_0,12)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TEST(MR_r1,0,0)) {
	...
	MR_np_call_localret_ent(ll_backend__code_info__assign_lval_to_var_5_0,
		ll_backend__lookup_util__generate_offset_assigns_5_0_i4);
MR_def_label(ll_backend__lookup_util__generate_offset_assigns_5_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 0, (MR_Integer) 4);
	MR_tfield(0, MR_tempr1, 0) = (MR_Word) MR_COMMON(3,0);
	MR_tfield(0, MR_tempr1, 1) = (MR_Word) MR_ENTRY_AP(ll_backend__lookup_util__IntroducedFrom__pred__generate_offset_assigns__230__1_1_0);
	...
	MR_np_call_localret_ent(libs__compiler_util__expect_3_0,
		ll_backend__lookup_util__generate_offset_assigns_5_0_i5);
MR_def_label(ll_backend__lookup_util__generate_offset_assigns_5_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(3);
	...
	MR_GOTO_LAB(ll_backend__lookup_util__generate_offset_assigns_5_0_i12);
...
MR_BEGIN_MODULE(ll_backend__lookup_util_module10)
	MR_init_entry1(ll_backend__lookup_util__IntroducedFrom__pred__figure_out_output_vars__103__1_5_0);
	MR_init_label4(ll_backend__lookup_util__IntroducedFrom__pred__figure_out_output_vars__103__1_5_0,1,2,3,4)
MR_BEGIN_CODE
	...
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(ll_backend__lookup_util__IntroducedFrom__pred__figure_out_output_vars__103__1_5_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_mkframe("pred ll_backend.lookup_util.IntroducedFrom__pred__figure_out_output_vars__103__1/5-0", 5,
		MR_ENTRY(MR_do_fail));
	MR_fv(1) = MR_r1;
	MR_fv(2) = MR_r2;
	MR_fv(3) = MR_r4;
	...
	MR_np_call_localret_ent(set__member_2_1,
		ll_backend__lookup_util__IntroducedFrom__pred__figure_out_output_vars__103__1_5_0_i1);
MR_def_label(ll_backend__lookup_util__IntroducedFrom__pred__figure_out_output_vars__103__1_5_0,1)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_fv(5) = MR_r1;
	MR_r1 = MR_fv(1);
	MR_r2 = MR_fv(5);
	MR_np_call_localret_ent(hlds__instmap__lookup_var_3_0,
		ll_backend__lookup_util__IntroducedFrom__pred__figure_out_output_vars__103__1_5_0_i2);
MR_def_label(ll_backend__lookup_util__IntroducedFrom__pred__figure_out_output_vars__103__1_5_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_fv(4) = MR_r1;
	MR_r1 = MR_fv(3);
	MR_r2 = MR_fv(5);
	MR_np_call_localret_ent(hlds__instmap__lookup_var_3_0,
		ll_backend__lookup_util__IntroducedFrom__pred__figure_out_output_vars__103__1_5_0_i3);
MR_def_label(ll_backend__lookup_util__IntroducedFrom__pred__figure_out_output_vars__103__1_5_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 0, (MR_Integer) 2);
	...
	MR_np_call_localret_ent(check_hlds__mode_util__mode_is_output_2_0,
		ll_backend__lookup_util__IntroducedFrom__pred__figure_out_output_vars__103__1_5_0_i4);
MR_def_label(ll_backend__lookup_util__IntroducedFrom__pred__figure_out_output_vars__103__1_5_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
...
MR_decl_entry(libs__tree__is_empty_1_0);

MR_BEGIN_MODULE(ll_backend__lookup_util_module11)
	MR_init_entry1(ll_backend__lookup_util__IntroducedFrom__pred__generate_offset_assigns__230__1_1_0);
MR_BEGIN_CODE
	...
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(ll_backend__lookup_util__IntroducedFrom__pred__generate_offset_assigns__230__1_1_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_r1;
	MR_r1 = (MR_Word) MR_TAG_COMMON(0,0,6);
	MR_np_tailcall_ent(libs__tree__is_empty_1_0);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_thread_engine_base
#endif
...
void mercury__ll_backend__lookup_util__write_out_proc_statics(FILE *fp);
#endif
