  ...
  MR_Box closure_arg)
{
  ...
  succeeded = ll_backend__lookup_util__IntroducedFrom__pred__generate_offset_assigns__226__1_1_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))));
  return succeeded;
}
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(3), LookupLval_19, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &ll_backend__lookup_util_scalar_common_2[0])));
  ...
  MR_Word * STATE_VARIABLE_CI_26)
{
  ...
  MR_Word Disjunct_22;
  MR_Word _GoalExpr_42 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Disjunct0_12, (MR_Integer) 0))));
  MR_Word GoalInfo_43;
  MR_Word CodeModel_44;
  MR_Word Code_46;
  MR_Word ExprnOpts_47;
  MR_Word STATE_VARIABLE_CLD_32_49;
  MR_Word STATE_VARIABLE_CLD_34_51;
  MR_Word STATE_VARIABLE_CLD_35_52;
  MR_Word STATE_VARIABLE_CLD_36_53;
  MR_Word _EndCode_48;

  hlds__hlds_llds__goal_info_set_resume_point_3_p_0((MR_Word) ((MR_Unsigned) 0U), DisjunctGoalInfo0_20, &GoalInfo_43);
  {
    Disjunct_22 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(MR_mktag(0), Disjunct_22, 0) = ((MR_Box) (_GoalExpr_42));
    MR_hl_field(MR_mktag(0), Disjunct_22, 1) = ((MR_Box) (GoalInfo_43));
  }
  CodeModel_44 = hlds__code_model__goal_info_get_code_model_1_f_0(GoalInfo_43);
  ll_backend__code_loc_dep__reset_to_position_3_p_0(BranchStart_11, STATE_VARIABLE_CI_0_25, &STATE_VARIABLE_CLD_32_49);
  ll_backend__code_gen__generate_goal_7_p_0(CodeModel_44, Disjunct_22, &Code_46, STATE_VARIABLE_CI_0_25, STATE_VARIABLE_CI_26, STATE_VARIABLE_CLD_32_49, &STATE_VARIABLE_CLD_34_51);
  succeeded = mercury__cord__is_empty_1_p_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_instruction_0), Code_46);
  if (succeeded)
  {
    ll_backend__code_loc_dep__get_forward_live_vars_2_p_0(STATE_VARIABLE_CLD_34_51, Liveness_17);
    ll_backend__code_info__get_exprn_opts_2_p_0(*STATE_VARIABLE_CI_26, &ExprnOpts_47);
    succeeded = ll_backend__lookup_util__get_arm_rvals_5_p_0(Vars_13, Soln_15, STATE_VARIABLE_CLD_34_51, &STATE_VARIABLE_CLD_35_52, ExprnOpts_47);
    if (succeeded)
    {
      ll_backend__code_loc_dep__set_resume_point_to_unknown_2_p_0(STATE_VARIABLE_CLD_35_52, &STATE_VARIABLE_CLD_36_53);
      ll_backend__code_loc_dep__generate_branch_end_5_p_0(StoreMap_14, STATE_VARIABLE_MaybeEnd_0_23, STATE_VARIABLE_MaybeEnd_24, &_EndCode_48, STATE_VARIABLE_CLD_36_53);
      succeeded = MR_TRUE;
    }
  }
  return succeeded;
...
{
  MR_bool succeeded;
  MR_Word GoalInfo_38 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Goal_12, (MR_Integer) 1))));
  MR_Word CodeModel_39;
  MR_Word Code_41;
  MR_Word ExprnOpts_42;
  MR_Word STATE_VARIABLE_CLD_32_44;
  MR_Word STATE_VARIABLE_CLD_34_46;
  MR_Word STATE_VARIABLE_CLD_36_48;
  MR_Word _EndCode_43;

  CodeModel_39 = hlds__code_model__goal_info_get_code_model_1_f_0(GoalInfo_38);
  ll_backend__code_loc_dep__reset_to_position_3_p_0(BranchStart_11, STATE_VARIABLE_CI_0_21, &STATE_VARIABLE_CLD_32_44);
  ll_backend__code_gen__generate_goal_7_p_0(CodeModel_39, Goal_12, &Code_41, STATE_VARIABLE_CI_0_21, STATE_VARIABLE_CI_22, STATE_VARIABLE_CLD_32_44, &STATE_VARIABLE_CLD_34_46);
  succeeded = mercury__cord__is_empty_1_p_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_instruction_0), Code_41);
  if (succeeded)
  {
    ll_backend__code_loc_dep__get_forward_live_vars_2_p_0(STATE_VARIABLE_CLD_34_46, Liveness_17);
    ll_backend__code_info__get_exprn_opts_2_p_0(*STATE_VARIABLE_CI_22, &ExprnOpts_42);
    succeeded = ll_backend__lookup_util__get_arm_rvals_5_p_0(Vars_13, STATE_VARIABLE_MaybeEnd_0_19, STATE_VARIABLE_CLD_34_46, &STATE_VARIABLE_CLD_36_48, ExprnOpts_42);
    if (succeeded)
    {
      ll_backend__code_loc_dep__generate_branch_end_5_p_0(StoreMap_14, STATE_VARIABLE_MaybeEnd_20, CaseRvals_16, &_EndCode_43, STATE_VARIABLE_CLD_36_48);
      succeeded = MR_TRUE;
    }
  }
  return succeeded;
  ...
  MR_Word HeadVar__5_5)
{
  ...
  else
  {
    ...
    MR_Word Vars_11 = ((MR_Word) ((MR_hl_field(MR_mktag(1), HeadVar__1_1, (MR_Integer) 1))));
    MR_Word Rval_12;
    MR_Word Rvals_13;
    MR_Word Code_16;
    MR_Word STATE_VARIABLE_CLD_19_19;
        ...
        {
          {
            ...
            *HeadVar__2_2 = base;
            ...
            MR_hl_field(MR_mktag(1), base, 1) = ((MR_Box) (Rvals_13));
          }
          succeeded = MR_TRUE;
        }
      }
  ...
  MR_Word * OutVars_8)
{
  ...
  else
  {
    ...
    hlds__instmap__apply_instmap_delta_3_p_0(InstMapDelta_9, CurrentInstMap_10, &InstMapAfter_13);
    {
      ...
      MR_hl_field(MR_mktag(0), Var_14, 0) = ((MR_Box) (&ll_backend__lookup_util_scalar_common_3[0]));
