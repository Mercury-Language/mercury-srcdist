...
MR_decl_label4(ll_backend__lookup_util__generate_constants_for_disjuncts_8_0, 23,4,6,1)
...
MR_decl_static(ll_backend__lookup_util__IntroducedFrom__pred__generate_offset_assigns__207__1_1_0)
...
MR_BEGIN_MODULE(ll_backend__lookup_util_module5)
	...
	MR_init_label4(ll_backend__lookup_util__generate_constants_for_disjuncts_8_0,23,4,6,1)
MR_BEGIN_CODE
...
MR_define_entry(mercury__ll_backend__lookup_util__generate_constants_for_disjuncts_8_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
		MR_GOTO_LAB(ll_backend__lookup_util__generate_constants_for_disjuncts_8_0_i23);
	}
	MR_r2 = (MR_Word) MR_tbmkword(0, 0);
	MR_r3 = MR_r4;
	MR_r4 = MR_r5;
	MR_r1 = MR_TRUE;
	MR_proceed();
MR_def_label(ll_backend__lookup_util__generate_constants_for_disjuncts_8_0,23)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(4);
	MR_sv(4) = (MR_Word) MR_succip;
	MR_sv(1) = MR_r2;
...
MR_BEGIN_MODULE(ll_backend__lookup_util_module6)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__ll_backend__lookup_util__set_liveness_and_end_branch_6_0);
	MR_init_label2(ll_backend__lookup_util__set_liveness_and_end_branch_6_0,2,3)
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'set_liveness_and_end_branch'/6 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
...
MR_def_label(ll_backend__lookup_util__generate_offset_assigns_5_0,9)
	...
	MR_tfield(0, MR_tempr1, 1) = (MR_Word) MR_ENTRY_AP(ll_backend__lookup_util__IntroducedFrom__pred__generate_offset_assigns__207__1_1_0);
...
MR_BEGIN_MODULE(ll_backend__lookup_util_module9)
	MR_init_entry1(ll_backend__lookup_util__IntroducedFrom__pred__generate_offset_assigns__207__1_1_0);
	MR_INIT_PROC_LAYOUT_ADDR(mercury__ll_backend__lookup_util__IntroducedFrom__pred__generate_offset_assigns__207__1_1_0);
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'IntroducedFrom__pred__generate_offset_assigns__207__1'/1 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(ll_backend__lookup_util__IntroducedFrom__pred__generate_offset_assigns__207__1_1_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
