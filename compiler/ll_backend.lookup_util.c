...
{
  {
    ...
    if (succeeded)
    {
      ...
      succeeded = ll_backend__lookup_util__get_arm_rvals_5_p_0(Vars_13, Soln_15, STATE_VARIABLE_CLD_34_53, &STATE_VARIABLE_CLD_35_54, ExprnOpts_49);
      if (succeeded)
      {
        ll_backend__code_loc_dep__set_resume_point_to_unknown_2_p_0(STATE_VARIABLE_CLD_35_54, &STATE_VARIABLE_CLD_36_55);
        ll_backend__code_loc_dep__generate_branch_end_5_p_0(StoreMap_14, STATE_VARIABLE_MaybeEnd_0_23, STATE_VARIABLE_MaybeEnd_24, &_EndCode_50, STATE_VARIABLE_CLD_36_55);
        succeeded = MR_TRUE;
      }
    }
    return succeeded;
...
{
  {
    ...
    if (succeeded)
    {
      ...
      succeeded = ll_backend__lookup_util__get_arm_rvals_5_p_0(Vars_13, STATE_VARIABLE_MaybeEnd_0_19, STATE_VARIABLE_CLD_34_48, &STATE_VARIABLE_CLD_36_50, ExprnOpts_44);
      if (succeeded)
      {
        ll_backend__code_loc_dep__generate_branch_end_5_p_0(StoreMap_14, STATE_VARIABLE_MaybeEnd_20, CaseRvals_16, &_EndCode_45, STATE_VARIABLE_CLD_36_50);
        succeeded = MR_TRUE;
      }
    }
    return succeeded;
