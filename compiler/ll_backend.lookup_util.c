  ...
  MR_Word * STATE_VARIABLE_CLD_6)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      mercury__require__expect_3_p_0(Var_29, (MR_String) "predicate \140ll_backend.lookup_util.generate_offset_assigns\'/6", (MR_String) "nonempty code");
      Var_32 = (MR_Integer) ((MR_Unsigned) Offset_2 + (MR_Unsigned) (MR_Integer) 1);
      // direct tailcall eliminated
      next_value_of_HeadVar__1_1 = Vars_14;
      next_value_of_Offset_2 = Var_32;
      next_value_of_STATE_VARIABLE_CLD_0_5 = STATE_VARIABLE_CLD_28_28;
