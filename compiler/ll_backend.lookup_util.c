...
{
  {
    ...
    succeeded = ll_backend__lookup_util__IntroducedFrom__pred__generate_offset_assigns__228__1_1_p_0(((MR_Word) (MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3))));
    return succeeded;
  }
}
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
...

      {
        ...
        MR_hl_field(MR_mktag(0), Var_25, 0) = ((MR_Box) (BaseReg_3));
      }
      {
        Var_27 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), Var_27, 0) = ((MR_Box) (Offset_2));
      }
      {
      ...
      {
        LookupLval_19 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(3), LookupLval_19, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 9));
        MR_hl_field(MR_mktag(3), LookupLval_19, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &ll_backend__lookup_util_scalar_common_3[0])));
        MR_hl_field(MR_mktag(3), LookupLval_19, 2) = ((MR_Box) (Var_25));
        MR_hl_field(MR_mktag(3), LookupLval_19, 3) = ((MR_Box) (Var_26));
      }
      ll_backend__code_loc_dep__assign_lval_to_var_6_p_0(Var_13, LookupLval_19, &Code_20, HeadVar__4_4, STATE_VARIABLE_CLD_0_5, &STATE_VARIABLE_CLD_28_28);
      {
        Var_29 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), Var_29, 0) = ((MR_Box) (&ll_backend__lookup_util_scalar_common_4[0]));
        MR_hl_field(MR_mktag(0), Var_29, 1) = ((MR_Box) (ll_backend__lookup_util__generate_offset_assigns_6_p_0_1));
        MR_hl_field(MR_mktag(0), Var_29, 2) = ((MR_Box) (MR_Word) ((MR_Integer) 1));
        MR_hl_field(MR_mktag(0), Var_29, 3) = ((MR_Box) (Code_20));
      }
      mercury__require__expect_4_p_0(Var_29, (MR_String) "ll_backend.lookup_util", (MR_String) "predicate \140ll_backend.lookup_util.generate_offset_assigns\'/6", (MR_String) "nonempty code");
      Var_33 = (Offset_2 + (MR_Integer) 1);
      /* direct tailcall eliminated */
      {
        MR_Word next_value_of_HeadVar__1_1 = Vars_14;
        MR_Integer next_value_of_Offset_2 = Var_33;
        MR_Word next_value_of_STATE_VARIABLE_CLD_0_5 = STATE_VARIABLE_CLD_28_28;
...
{
  {
    ...
    hlds__hlds_llds__goal_info_set_resume_point_3_p_0((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), DisjunctGoalInfo0_20, &GoalInfo_45);
    {
      Disjunct_22 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
...
{
  {
    ...
    MR_Word _GoalExpr_39 = ((MR_Word) (MR_hl_field(MR_mktag(0), Goal_12, (MR_Integer) 0)));
    MR_Word _EndCode_45;
      ...
      case (MR_Integer) 2:
        {
          ...
          MR_Integer Var_13 = ((MR_Integer) (MR_hl_field(MR_mktag(2), HeadVar__1_1, (MR_Integer) 0)));
          ...
          case (MR_Integer) 3:
            {
              ...
              if (succeeded)
              {
                /* direct tailcall eliminated */
                {
                  MR_Word next_value_of_HeadVar__1_1 = Exprn1_11;
...
{
  {
    ...
    if (succeeded)
      *OutVars_8 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
    else
    {
