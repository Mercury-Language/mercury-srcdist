  ...
  MR_Word * STATE_VARIABLE_CI_26)
{
  ...
  MR_Word Disjunct_22;
  MR_Word _GoalExpr_29 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Disjunct0_12, (MR_Integer) 0))));
  MR_Word GoalInfo_30;
  ...
  hlds__hlds_llds__goal_info_set_resume_point_3_p_0((MR_Word) ((MR_Unsigned) 0U), DisjunctGoalInfo0_20, &GoalInfo_30);
  {
    ...
    MR_hl_field(MR_mktag(0), Disjunct_22, 0) = ((MR_Box) (_GoalExpr_29));
    MR_hl_field(MR_mktag(0), Disjunct_22, 1) = ((MR_Box) (GoalInfo_30));
  }
