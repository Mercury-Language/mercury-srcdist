...
ll_backend__lookup_util__IntroducedFrom__pred__record_offset_assigns__226__1_1_p_0(
  MR_Word Code_20);
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = ll_backend__lookup_util__IntroducedFrom__pred__record_offset_assigns__226__1_1_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))));
  return succeeded;
}
