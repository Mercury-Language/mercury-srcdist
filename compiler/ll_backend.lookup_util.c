...
ll_backend__lookup_util__IntroducedFrom__pred__generate_offset_assigns__229__1_1_p_0(
  MR_Word Code_20);
...
{
  {
    ...
    succeeded = ll_backend__lookup_util__IntroducedFrom__pred__generate_offset_assigns__229__1_1_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))));
    return succeeded;
  }
}
