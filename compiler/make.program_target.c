  ...
  MR_Word * STATE_VARIABLE_Info_39)
{
  ...
  libs__globals__lookup_maybe_string_option_3_p_0(Globals_19, (MR_Integer) 485, &MaybePreLinkCommand_33);
  ...
  MR_Word * STATE_VARIABLE_Info_53)
{
...

  {
    ...
    libs__globals__lookup_accumulating_option_3_p_0(Globals0_19, (MR_Integer) 536, &LinkObjects_33);
    libs__globals__set_option_4_p_0((MR_Integer) 536, (MR_Word) (MR_mkword(3, &make__program_target_scalar_common_1[8])), Globals0_19, &NoLinkObjsGlobals_34);
  ...
  MR_Word * STATE_VARIABLE_Info_20)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_10, (MR_Integer) 481, &OrderByTimestamp_15);
