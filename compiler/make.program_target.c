      ...
      case (MR_Integer) 0:
        {
          ...
          *ObjectTargets_12 = mercury__list__f_43_43_2_f_0((MR_Word) (&make__dependencies__make__dependencies__type_ctor_info_dependency_file_0), FactObjectTargets_19, ForeignObjectTargets_18);
        }
        break;
      case (MR_Integer) 1:
      case (MR_Integer) 3:
