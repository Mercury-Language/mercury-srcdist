  ...
  MR_Box * wrapper_arg_4)
{
  ...
  make__program_target__remove_cache_dir_7_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) ((MR_hl_field(0, closure, 4)))), ((MR_String) ((MR_hl_field(0, closure, 5)))), ((MR_Word) (wrapper_arg_1)), &conv0_STATE_VARIABLE_Info_16);
  ...
  MR_Box wrapper_arg_1)
{
  ...
  succeeded = make__program_target__IntroducedFrom__pred__build_analysis_files_1__1417__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) (wrapper_arg_1)));
  return succeeded;
}
