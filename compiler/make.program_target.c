...
{
  {
    ...
    if ((OptionsSpecs_30 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      ...
      libs__globals__lookup_bool_option_3_p_0(LibGlobals_31, (MR_Integer) 67, &VeryVerbose_36);
...
{
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 67, &VeryVerbose_39);
          ...
          case (MR_Integer) 0:
            {
              ...
              *Succeeded_12 = (MR_Integer) 1;
              ...
              make__program_target__remove_init_files_7_p_0(Globals_9, (MR_Integer) 67, MainModuleName_10, STATE_VARIABLE_Info_73_73, STATE_VARIABLE_Info_27);
            }
            break;
          case (MR_Integer) 1:
            {
