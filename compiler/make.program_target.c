  ...
  MR_Word * UseAnalysisCacheDir_10)
{
  ...
  libs__globals__lookup_string_option_3_p_0(Globals_8, (MR_Integer) 743, &CacheDir0_14);
  ...
  MR_Word * STATE_VARIABLE_Info_20)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_10, (MR_Integer) 727, &OrderByTimestamp_15);
