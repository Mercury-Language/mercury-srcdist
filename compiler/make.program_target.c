  ...
  MR_Word * STATE_VARIABLE_Specs_33)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_12, (MR_Integer) 436, &IntermodAnalysis_22);
  ...
  MR_Word * STATE_VARIABLE_Info_39)
{
  ...
  libs__globals__lookup_maybe_string_option_3_p_0(Globals_19, (MR_Integer) 470, &MaybePreLinkCommand_33);
  ...
  MR_Word * STATE_VARIABLE_Info_53)
{
...

  {
    ...
    libs__globals__lookup_accumulating_option_3_p_0(Globals0_19, (MR_Integer) 522, &LinkObjects_33);
    libs__globals__set_option_4_p_0((MR_Integer) 522, (MR_Word) (MR_mkword(3, &make__program_target_scalar_common_1[3])), Globals0_19, &NoLinkObjsGlobals_34);
