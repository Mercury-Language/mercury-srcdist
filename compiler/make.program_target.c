  ...
  MR_Word * UseAnalysisCacheDir_8)
{
  ...
  else
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_6, (MR_Integer) 684, &UseGradeSubdirs_64);
    libs__globals__lookup_string_option_3_p_0(Globals_6, (MR_Integer) 702, &TargetArch_65);
