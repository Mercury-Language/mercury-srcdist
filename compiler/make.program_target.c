  ...
  MR_Word * STATE_VARIABLE_Info_53)
{
...

  {
    ...
    libs__globals__lookup_accumulating_option_3_p_0(Globals0_19, (MR_Integer) 495, &LinkObjects_33);
    libs__globals__set_option_4_p_0((MR_Integer) 495, (MR_Word) (MR_mkword(3, &make__program_target_scalar_common_1[8])), Globals0_19, &NoLinkObjsGlobals_34);
