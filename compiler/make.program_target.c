  ...
  MR_Box * wrapper_arg_4)
{
  ...
  make__program_target__reinsert_timestamps_for_non_class_files_4_p_0(((MR_String) (wrapper_arg_1)), ((MR_Word) (wrapper_arg_2)), ((MR_Word) (wrapper_arg_3)), &conv4_STATE_VARIABLE_Timestamps_9);
  ...
  MR_Word * STATE_VARIABLE_Info_45)
{
  ...
  switch (*Succeeded_28) {
    ...
    case (MR_Integer) 1:
      {
        MR_Word FileTimestamps0_41;
        MR_Word FileTimestamps_42;

        FileTimestamps0_41 = make__make_info__make_info_get_file_timestamps_1_f_0(STATE_VARIABLE_Info_62_62);
        mercury__map__delete_3_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&make__program_target_scalar_common_2[2]), ((MR_Box) (FullMainModuleLinkedFileName_21)), FileTimestamps0_41, &FileTimestamps_42);
