  ...
  switch (MR_tag((MR_Word) UseAnalysisCacheDir_13)) {
    ...
    case (MR_Integer) 0:
      switch (MR_unmkbody(UseAnalysisCacheDir_13)) {
        default: /*NOTREACHED*/ MR_assert(0);
        case (MR_Integer) 0:
          make__build__foldl2_make_module_targets_maybe_parallel_9_p_0(Var_111, Var_112, Var_113, Var_114, Succeeded_10, STATE_VARIABLE_Info_0_21, STATE_VARIABLE_Info_22);
          break;
        case (MR_Integer) 1:
          {
    ...
    case (MR_Integer) 1:
      {
        ...
        make__build__foldl2_make_module_targets_maybe_parallel_9_p_0(Var_111, Var_112, Var_113, Var_114, &Succeeded1_19, STATE_VARIABLE_Info_28_28, &STATE_VARIABLE_Info_35_35);
        {
