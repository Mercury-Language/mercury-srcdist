  ...
  MR_Word * STATE_VARIABLE_Specs_28)
{
  ...
  else
  {
    ...
    {
      *STATE_VARIABLE_Specs_28 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_diag_spec_0), LibgradeCheckSpecs_22, STATE_VARIABLE_Specs_0_27);
