  ...
  MR_Word * STATE_VARIABLE_Info_30)
{
  ...
  else
  {
    ...
    libs__globals__lookup_string_option_3_p_0(Globals_9, (MR_Integer) 669, &Prefix_21);
                ...
                case (MR_Integer) 1:
                  {
                    ...
                    libs__globals__set_option_4_p_0((MR_Integer) 662, (MR_Word) (MR_mkword(1, &make__program_target_scalar_common_4[0])), Globals_8, &NoRebuildGlobals_34);
