...
{
  {
    ...
    else
    {
      ...
      libs__globals__lookup_string_option_3_p_0(Globals_10, (MR_Integer) 638, &Prefix_19);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_14, (MR_Integer) 654, &UseGradeSubdirs_19);
...
{
  {
    ...
    else
    {
      ...
      libs__globals__lookup_string_option_3_p_0(Globals_9, (MR_Integer) 638, &Prefix_19);
      ...
      case (MR_Integer) 0:
        {
          ...
          libs__globals__lookup_string_option_3_p_0(Globals_9, (MR_Integer) 522, &ObjExt_34);
          libs__globals__lookup_string_option_3_p_0(Globals_9, (MR_Integer) 523, &PicObjExt_35);
          libs__globals__lookup_string_option_3_p_0(Globals_9, (MR_Integer) 541, &BeamExt_36);
          {
...
{
  {
    ...
    libs__globals__lookup_maybe_string_option_3_p_0(Globals_28, (MR_Integer) 637, &MaybePreLinkCommand_33);
...
{
  {
    ...
    libs__globals__lookup_accumulating_option_3_p_0(Globals_18, (MR_Integer) 553, &LinkObjects_33);
    libs__globals__set_option_4_p_0((MR_Integer) 553, (MR_Word) MR_mkword(MR_mktag(3), &make__program_target_scalar_common_1[51]), Globals_18, &NoLinkObjsGlobals_34);
            ...
            case (MR_Integer) 1:
              {
                ...
                switch (CompilationTarget_25) {
                  ...
                  case (MR_Integer) 3:
                    {
                      libs__globals__lookup_string_option_3_p_0(NoLinkObjsGlobals_34, (MR_Integer) 541, &ObjExtToUse_65);
                    }
                    break;
                  case (MR_Integer) 2:
                    {
                      libs__globals__lookup_string_option_3_p_0(NoLinkObjsGlobals_34, (MR_Integer) 531, &ObjExtToUse_65);
                    }
                    break;
                }
                {
            ...
            case (MR_Integer) 0:
              {
                ...
                libs__globals__lookup_bool_option_3_p_0(NoLinkObjsGlobals_34, (MR_Integer) 654, &UseGradeSubdirs_52);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_10, (MR_Integer) 632, &KeepGoing_19);
                  ...
                  case (MR_Integer) 1:
                    {
                      ...
                      libs__globals__set_option_4_p_0((MR_Integer) 631, (MR_Word) MR_mkword(MR_mktag(1), &make__program_target_scalar_common_3[2]), Globals_10, &NoRebuildGlobals_36);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 659, &OrderByTimestamp_13);
          ...
          case (MR_Integer) 5:
            {
              ...
              libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 632, &KeepGoing_84);
      ...
      case (MR_Integer) 1:
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 632, &KeepGoing_22);
          succeeded = (Succeeded0_17 == (MR_Integer) 0);
          if (succeeded)
...
{
  {
    ...
    libs__globals__lookup_string_option_3_p_0(Globals_8, (MR_Integer) 675, &CacheDir0_15);
...
{
  {
    ...
    libs__globals__lookup_accumulating_option_3_p_0(Globals_8, (MR_Integer) 648, &LibLinkages_16);
    switch (FileType_14) {
      default:
        succeeded = MR_FALSE;
        break;
    ...
    else
    {
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 658, &LibgradeCheck_17);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_10, (MR_Integer) 632, &KeepGoing_17);
  ...
  MR_Word * STATE_VARIABLE_Info_26)
{
  while (MR_TRUE)
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 632, &KeepGoing_19);
    {
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_6, (MR_Integer) 654, &UseGradeSubdirs_42);
    libs__globals__lookup_string_option_3_p_0(Globals_6, (MR_Integer) 672, &TargetArch_43);
...
{
  {
    ...
    libs__globals__set_option_4_p_0((MR_Integer) 654, (MR_Word) MR_mkword(MR_mktag(1), &make__program_target_scalar_common_3[2]), Globals_7, &NoSubdirGlobals_13);
    {
...
{
  {
    ...
    libs__globals__lookup_string_option_3_p_0(Globals_8, (MR_Integer) 522, &ObjExt_13);
    libs__globals__lookup_string_option_3_p_0(Globals_8, (MR_Integer) 523, &PicObjExt_14);
    libs__globals__lookup_string_option_3_p_0(Globals_8, (MR_Integer) 541, &BeamExt_15);
    {
      Var_23 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 6 * sizeof(MR_Word)), NULL, NULL);
...
{
  {
    ...
    if (succeeded)
    {
      ...
      libs__globals__lookup_accumulating_option_3_p_0(Globals_8, (MR_Integer) 661, &ExtraHdrs_68);
      libs__globals__lookup_string_option_3_p_0(Globals_8, (MR_Integer) 638, &Prefix_69);
      ...
      if (succeeded)
      {
        ...
        libs__globals__lookup_accumulating_option_3_p_0(Globals_8, (MR_Integer) 645, &LibGrades0_22);
        libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 632, &KeepGoing_23);
...
{
  {
    ...
    libs__globals__lookup_string_option_3_p_0(Globals_6, (MR_Integer) 638, &Prefix_10);
      ...
      case (MR_Integer) 1:
        {
          ...
          libs__globals__lookup_string_option_3_p_0(Globals_11, (MR_Integer) 638, &Prefix_27);
...
{
  {
    ...
    libs__globals__lookup_string_option_3_p_0(Globals_7, (MR_Integer) 638, &Prefix_12);
...
{
  {
    ...
    libs__globals__lookup_accumulating_option_3_p_0(Globals_8, (MR_Integer) 648, &LibLinkages_14);
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        libs__globals__lookup_string_option_3_p_0(Globals_8, (MR_Integer) 588, &RanLibCommand_57);
        libs__globals__lookup_string_option_3_p_0(Globals_8, (MR_Integer) 589, &RanLibFlags_58);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 632, &KeepGoing_20);
    {
      Var_37 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 5 * sizeof(MR_Word)), NULL, NULL);
...
{
  {
    ...
    libs__globals__lookup_accumulating_option_3_p_0(Globals_5, (MR_Integer) 558, &Libs_8);
    libs__globals__lookup_accumulating_option_3_p_0(Globals_5, (MR_Integer) 562, &InitFileDirs_9);
    ...
    libs__globals__lookup_maybe_string_option_3_p_0(Globals_5, (MR_Integer) 560, &MaybeStdLibDir_33);
