                  ...
                  case (MR_Integer) 1:
                    {
                      ...
                      libs__globals__set_option_4_p_0((MR_Integer) 641, (MR_Word) (MR_mkword(MR_mktag(1), &make__program_target_scalar_common_3[1])), Globals_10, &NoRebuildGlobals_36);
...
{
  {
    ...
    libs__globals__set_option_4_p_0((MR_Integer) 664, (MR_Word) (MR_mkword(MR_mktag(1), &make__program_target_scalar_common_3[1])), Globals_7, &NoSubdirGlobals_13);
    {
