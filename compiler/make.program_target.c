...
{
  {
    ...
    switch (LibSucceeded_18) {
      ...
      case (MR_Integer) 0:
        {
          parse_tree__error_util__write_error_specs_ignore_4_p_0(Globals_10, Specs_20);
...
{
  {
    ...
    else
    {
      ...
      parse_tree__error_util__write_error_specs_ignore_5_p_0(ErrorStream_25, Globals_10, Specs_15);
      ...
      case (MR_Integer) 1:
        {
          ...
          else
          {
            ...
            parse_tree__error_util__write_error_specs_ignore_5_p_0(ErrorStream_29, Globals_11, Specs_16);
            *Succeeded_14 = (MR_Integer) 0;
            *STATE_VARIABLE_Info_31 = STATE_VARIABLE_Info_38_38;
          }
        }
