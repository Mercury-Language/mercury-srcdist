...
{
  {
    ...
    make__util__verbose_make_msg_option_5_p_0(Globals_7, (MR_Integer) 65, Var_19);
    {
      ...
      MR_hl_field(MR_mktag(0), Var_49, 4) = ((MR_Box) ((MR_Integer) 61));
    ...
    make__util__make_remove_module_file_8_p_0(Globals_7, (MR_Integer) 61, ModuleName_8, Var_54, STATE_VARIABLE_Info_50_50, &STATE_VARIABLE_Info_55_55);
    ...
    make__util__make_remove_module_file_8_p_0(Globals_7, (MR_Integer) 61, ModuleName_8, (MR_String) ".request", STATE_VARIABLE_Info_59_59, STATE_VARIABLE_Info_13);
  }
}
...
{
  {
    ...
    else
    {
      ...
      libs__globals__lookup_string_option_3_p_0(Globals_9, (MR_Integer) 651, &Prefix_22);
