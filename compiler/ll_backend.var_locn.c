...
{
  {
    ...
    else
    {
      ...
      mercury__builtin__compare_3_p_0((MR_Word) (&ll_backend__var_locn_scalar_common_1[6]), &SubResult1_6, ((MR_Box) (ArgX1_4)), ((MR_Box) (ArgY1_5)));
                        ...
                        else
                        {
                          ...
                          else
                          {
                            ...
                            else
                            {
                              ...
                              {
                                mercury__builtin__compare_3_p_0((MR_Word) (&ll_backend__var_locn_scalar_common_1[7]), HeadVar__1_1, ((MR_Box) (ArgX14_43)), ((MR_Box) (ArgY14_44)));
                              }
                            }
                          }
                        }
...
{
  {
    ...
    else
    {
      ...
      succeeded = mercury__builtin__unify_2_p_0((MR_Word) (&ll_backend__var_locn_scalar_common_1[6]), ((MR_Box) (ArgX1_3)), ((MR_Box) (ArgY1_4)));
      if (succeeded)
      {
                        ...
                        if (succeeded)
                        {
                          ...
                          if (succeeded)
                          {
                            ...
                            if (succeeded)
                            {
                              ...
                              if (succeeded)
                              {
                                TypeInfo_41_41 = (MR_Word) (&ll_backend__var_locn_scalar_common_1[7]);
...
{
  {
    ...
    else
    {
      ...
      else
      {
        ...
        mercury__builtin__compare_3_p_0((MR_Word) (&ll_backend__var_locn_scalar_common_1[5]), &SubResult2_9, ((MR_Box) (ArgX2_7)), ((MR_Box) (ArgY2_8)));
        succeeded = (SubResult2_9 != (MR_Integer) 0);
        if (succeeded)
          *HeadVar__1_1 = SubResult2_9;
        else
        {
          ...
          mercury__builtin__compare_3_p_0((MR_Word) (&ll_backend__var_locn_scalar_common_1[5]), &SubResult3_12, ((MR_Box) (ArgX3_10)), ((MR_Box) (ArgY3_11)));
          succeeded = (SubResult3_12 != (MR_Integer) 0);
          if (succeeded)
            *HeadVar__1_1 = SubResult3_12;
          else
...
{
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        TypeInfo_16_16 = (MR_Word) (&ll_backend__var_locn_scalar_common_1[5]);
        succeeded = mercury__builtin__unify_2_p_0(TypeInfo_16_16, ((MR_Box) (ArgX2_5)), ((MR_Box) (ArgY2_6)));
        if (succeeded)
        {
          TypeInfo_17_17 = (MR_Word) (&ll_backend__var_locn_scalar_common_1[5]);
