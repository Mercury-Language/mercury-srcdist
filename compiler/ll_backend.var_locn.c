...
MR_def_label(ll_backend__var_locn__var_locn_var_becomes_dead_4_0,7)
	...
	MR_tfield(0, MR_tempr1, 1) = (MR_Word) MR_ENTRY_AP(ll_backend__var_locn__IntroducedFrom__pred__var_locn_var_becomes_dead__1757__1_2_0);
...
MR_def_label(ll_backend__var_locn__var_locn_var_becomes_dead_4_0,2)
	...
	MR_tfield(0, MR_tempr1, 1) = (MR_Word) MR_ENTRY_AP(ll_backend__var_locn__IntroducedFrom__pred__var_locn_var_becomes_dead__1780__1_2_0);
	MR_tfield(0, MR_tempr1, 2) = (MR_Integer) 2;
	MR_tfield(0, MR_tempr1, 3) = MR_sv(2);
	MR_tfield(0, MR_tempr1, 4) = (MR_Integer) 0;
	MR_r2 = (MR_Word) MR_string_const("var_locn.m", 10);
...
MR_def_static(ll_backend__var_locn__reg_is_not_locked_for_var_3_0)
	...
	MR_tempr4 = MR_r1;
	MR_sv(4) = MR_tfield(0, MR_tempr4, 9);
	MR_sv(3) = MR_tfield(0, MR_tempr4, 8);
	MR_sv(1) = MR_tempr3;
	MR_sv(2) = MR_r3;
	MR_sv(5) = MR_tempr1;
	MR_tempr2 = MR_tempr4;
...
MR_def_label(ll_backend__var_locn__actually_place_var_7_0,41)
	...
	MR_r1 = MR_tempr3;
	MR_tfield(1, MR_tempr3, 0) = (MR_Word) MR_string_const("Placing ", 8);
...
MR_def_label(ll_backend__var_locn__free_up_lval_with_copy_7_0,42)
	...
	MR_tfield(0, MR_tempr3, 1) = (MR_Word) MR_string_const("Freeing up the source lval", 26);
	MR_sv(1) = MR_r1;
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(ll_backend__llds, instruction);
	}
	MR_np_call_localret_ent(fn__cord__singleton_1_0,
...
MR_def_label(ll_backend__var_locn__var_locn_assign_lval_to_var_7_0,2)
	...
	MR_tempr3 = MR_tfield(3, MR_tempr5, 3);
...
MR_def_label(ll_backend__var_locn__expr_is_constant_4_0,21)
	...
	MR_tfield(0, MR_tempr2, 1) = (MR_Word) MR_ENTRY_AP(ll_backend__var_locn__IntroducedFrom__pred__expr_is_constant__2135__1_3_0);
	MR_tfield(0, MR_tempr2, 2) = (MR_Integer) 3;
	MR_tfield(0, MR_tempr2, 3) = MR_sv(1);
	MR_tfield(0, MR_tempr2, 4) = MR_sv(2);
	MR_tfield(0, MR_tempr2, 5) = MR_tfield(1, MR_tempr1, 0);
...
MR_def_label(ll_backend__var_locn__assign_reused_cell_to_var_14_0,39)
	...
	MR_r2 = MR_tempr2;
	MR_tfield(0, MR_tempr2, 0) = MR_tempr1;
	MR_tfield(0, MR_tempr2, 1) = (MR_Word) MR_string_const("past skipped field assignments", 30);
	MR_sv(4) = MR_r1;
	MR_r1 = MR_sv(14);
	}
	MR_np_call_localret_ent(fn__cord__singleton_1_0,
...
MR_def_label(ll_backend__var_locn__var_locn_assign_dynamic_cell_to_var_13_0,32)
	...
	MR_tfield(3, MR_tempr3, 6) = MR_sv(9);
...
MR_def_label(ll_backend__var_locn__var_locn_assign_dynamic_cell_to_var_13_0,50)
	...
	MR_tfield(3, MR_tempr2, 5) = MR_sv(8);
	MR_tfield(3, MR_tempr2, 6) = MR_sv(9);
	MR_tfield(3, MR_tempr2, 7) = (MR_Word) MR_tbmkword(0, 0);
	MR_tfield(3, MR_tempr2, 8) = MR_sv(1);
	MR_r2 = MR_sv(12);
	MR_sv(1) = MR_r1;
...
MR_def_static(ll_backend__var_locn__convert_live_to_lval_set_2_0)
	...
	MR_tfield(0, MR_tempr3, 1) = MR_tfield(0, MR_tempr1, 0);
	MR_r1 = MR_TRUE;
	MR_proceed();
	}
