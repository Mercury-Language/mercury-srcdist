  ...
  MR_Word HeadVar__2_2)
{
  ...
  else
  {
    ...
    if (succeeded)
    {
      TypeCtorInfo_34_34 = (MR_Word) (&parse_tree__vartypes__parse_tree__vartypes__type_ctor_info_vartypes_0);
  ...
  MR_Word * STATE_VARIABLE_VLI_13)
{
  ...
  if (succeeded)
  {
    TypeCtorInfo_22_77 = (MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_lval_0);
    TypeInfo_23_78 = (MR_Word) (&ll_backend__var_locn_scalar_common_1[1]);
    succeeded = mercury__map__search_3_p_0(TypeCtorInfo_22_77, TypeInfo_23_78, LocVarMap0_8, ((MR_Box) (Reg_4)), &conv0_DependentVarsSet_74);
    if (succeeded)
    {
  ...
  MR_Word * STATE_VARIABLE_VLI_11)
{
  ...
  if (succeeded)
  {
    ...
    if (succeeded)
    {
      TypeCtorInfo_43_91 = (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0);
      parse_tree__set_of_var__delete_list_3_p_0(TypeCtorInfo_43_91, (MR_Word) ((MR_Unsigned) 0U), AffectedVarSet_65, &EffAffectedVarSet_66);
      parse_tree__set_of_var__to_sorted_list_2_p_0(TypeCtorInfo_43_91, EffAffectedVarSet_66, &EffAffectedVars_67);
  ...
  MR_Word * STATE_VARIABLE_VLI_18)
{
  ...
  if (succeeded)
  {
    ...
    if (succeeded)
    {
      TypeCtorInfo_43_84 = (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0);
      parse_tree__set_of_var__delete_list_3_p_0(TypeCtorInfo_43_84, ToBeAssignedVars_8, AffectedVarSet_58, &EffAffectedVarSet_59);
      parse_tree__set_of_var__to_sorted_list_2_p_0(TypeCtorInfo_43_84, EffAffectedVarSet_59, &EffAffectedVars_60);
