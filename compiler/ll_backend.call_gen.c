  ...
  MR_Word * STATE_VARIABLE_CLD_7)
{
  switch (MR_tag((MR_Word) HeadVar__1_1)) {
    ...
    case (MR_Integer) 1:
      {
        MR_Integer Method_35 = ((MR_Integer) ((MR_hl_field(1, HeadVar__1_1, (MR_Integer) 1))));
          ...
          case (MR_Integer) 0:
            {
              ...
              ll_backend__code_loc_dep__clobber_reg_3_p_0((MR_Word) (MR_mkword(1, &ll_backend__call_gen_scalar_common_1[5])), STATE_VARIABLE_CLD_0_6, STATE_VARIABLE_CLD_7);
              {
                ...
                MR_hl_field(1, Var_62, 0) = ((MR_Box) (Method_35));
              }
              {
              ...
              }
              {
                ...
                MR_hl_field(3, Var_57, 1) = ((MR_Box) (MR_mkword(1, &ll_backend__call_gen_scalar_common_1[5])));
                MR_hl_field(3, Var_57, 2) = ((MR_Box) (Var_61));
              }
              {
                Var_56 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
                MR_hl_field(0, Var_56, 0) = ((MR_Box) (Var_57));
                MR_hl_field(0, Var_56, 1) = ((MR_Box) ((MR_String) "Index of class method in typeclass info"));
              }
              *Code_5 = mercury__cord__singleton_1_f_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_instruction_0), ((MR_Box) (Var_56)));
            }
            break;
          case (MR_Integer) 1:
            {
              ...
              NumInVars_47 = ll_backend__code_util__encode_num_generic_call_vars_2_f_0(NumInVarsR_45, (MR_Integer) 0);
              {
                ...
                MR_hl_field(1, Var_81, 0) = ((MR_Box) (Method_35));
              }
              {
              ...
              }
              {
                ...
                MR_hl_field(3, Var_76, 1) = ((MR_Box) (MR_mkword(1, &ll_backend__call_gen_scalar_common_1[5])));
                MR_hl_field(3, Var_76, 2) = ((MR_Box) (Var_80));
              }
              {
                Var_75 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
                MR_hl_field(0, Var_75, 0) = ((MR_Box) (Var_76));
                MR_hl_field(0, Var_75, 1) = ((MR_Box) ((MR_String) "Index of class method in typeclass info"));
              }
              {
                Var_90 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(1, Var_90, 0) = ((MR_Box) (NumInVars_47));
              }
              {
              ...
              *Code_5 = mercury__cord__from_list_1_f_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_instruction_0), Var_74);
            }
            break;
        }
      }
