...
MR_decl_label10(ll_backend__call_gen__generate_simple_test_5_0, 4,5,8,9,10,16,17,19,20,26)
MR_decl_label5(ll_backend__call_gen__generate_simple_test_5_0, 3,27,30,32,33)
...
MR_BEGIN_MODULE(ll_backend__call_gen_module15)
	...
	MR_init_label10(ll_backend__call_gen__generate_simple_test_5_0,4,5,8,9,10,16,17,19,20,26)
	MR_init_label5(ll_backend__call_gen__generate_simple_test_5_0,3,27,30,32,33)
MR_BEGIN_CODE
...
MR_def_label(ll_backend__call_gen__generate_simple_test_5_0,5)
	...
	if (MR_INT_EQ(MR_tag(MR_sv(2)),1)) {
		MR_GOTO_LAB(ll_backend__call_gen__generate_simple_test_5_0_i9);
	}
	MR_sv(3) = MR_sv(2);
	MR_sv(2) = MR_r1;
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(ll_backend__llds, instruction);
...
MR_def_label(ll_backend__call_gen__generate_simple_test_5_0,27)
	...
	if (MR_INT_EQ(MR_tag(MR_r1),1)) {
		MR_GOTO_LAB(ll_backend__call_gen__generate_simple_test_5_0_i32);
	}
	MR_sv(2) = MR_r1;
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(ll_backend__llds, instruction);
	MR_np_call_localret_ent(fn__cord__empty_0_0,
