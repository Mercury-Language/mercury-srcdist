          ...
          case (MR_Integer) 0:
            {
              ...
              if (succeeded)
              {
                succeeded = ll_backend__code_loc_dep__variable_is_forward_live_2_p_0(STATE_VARIABLE_CLD_0_48, Var_23);
                if (succeeded)
                {
                  MR_Word Rval_86;

                  Rval_86 = ll_backend__call_gen__convert_simple_expr_1_f_0(AssignExpr_24);
                  ll_backend__code_loc_dep__assign_expr_to_var_5_p_0(Var_23, Rval_86, Code_16, STATE_VARIABLE_CLD_0_48, STATE_VARIABLE_CLD_49);
                }
                else
                {
        ...
        case (MR_Integer) 2:
          {
            ...
            ll_backend__call_gen__generate_simple_test_5_p_0(TestExpr_37, &Rval_38, &ArgCode_39, STATE_VARIABLE_CLD_0_48, &STATE_VARIABLE_CLD_62_62);
