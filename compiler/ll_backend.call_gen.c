      ...
      case (MR_Integer) 2:
        {
          ...
          {
            ll_backend__call_gen__V_7_7 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(2), ll_backend__call_gen__V_7_7, 0) = ((MR_Box) (ll_backend__call_gen__UInt_6));
          }
          {
            ll_backend__call_gen__HeadVar__2_2 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(3), ll_backend__call_gen__HeadVar__2_2, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 1));
          ...
          case (MR_Integer) 0:
            {
              ...
              {
                ll_backend__call_gen__V_9_9 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), ll_backend__call_gen__V_9_9, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 1));
                MR_hl_field(MR_mktag(3), ll_backend__call_gen__V_9_9, 1) = MR_box_float(ll_backend__call_gen__Float_8);
              }
              {
                ll_backend__call_gen__HeadVar__2_2 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), ll_backend__call_gen__HeadVar__2_2, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 1));
                MR_hl_field(MR_mktag(3), ll_backend__call_gen__HeadVar__2_2, 1) = ((MR_Box) (ll_backend__call_gen__V_9_9));
              }
            }
            break;
          case (MR_Integer) 1:
            {
              ...
              MR_Word ll_backend__call_gen__V_12_12;

              {
                ll_backend__call_gen__V_12_12 = ll_backend__call_gen__convert_simple_expr_1_f_0(ll_backend__call_gen__Expr_11);
              }
              {
                ...
                MR_hl_field(MR_mktag(3), ll_backend__call_gen__HeadVar__2_2, 2) = ((MR_Box) (ll_backend__call_gen__V_12_12));
              }
            }
            break;
          case (MR_Integer) 2:
            {
              ...
              {
                ll_backend__call_gen__V_16_16 = ll_backend__call_gen__convert_simple_expr_1_f_0(ll_backend__call_gen__Expr1_14);
              }
              {
                ll_backend__call_gen__V_17_17 = ll_backend__call_gen__convert_simple_expr_1_f_0(ll_backend__call_gen__Expr2_15);
              }
              {
                ...
                MR_hl_field(MR_mktag(3), ll_backend__call_gen__HeadVar__2_2, 2) = ((MR_Box) (ll_backend__call_gen__V_16_16));
                MR_hl_field(MR_mktag(3), ll_backend__call_gen__HeadVar__2_2, 3) = ((MR_Box) (ll_backend__call_gen__V_17_17));
              }
            }
            break;
        }
