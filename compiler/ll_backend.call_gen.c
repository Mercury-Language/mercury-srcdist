...
ll_backend__call_gen__generate_simple_test_6_p_0(
  ...
  MR_Word * STATE_VARIABLE_CLD_23)
{
  if (((((MR_tag((MR_Word) TestExpr_7)) == (MR_Integer) 3)) && ((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), TestExpr_7, (MR_Integer) 0))) == (MR_Integer) 10))))
  {
...
{
  {
    ...
    if (succeeded)
    {
      ...
      succeeded = ((MR_tag((MR_Word) MaybeTraceInfo_43)) == (MR_Integer) 1);
      if (succeeded)
