...
ll_backend__call_gen__IntroducedFrom__pred__generate_builtin__724__1_2_p_0(
  ...
  MR_Box wrapper_arg_1)
{
  ...
  succeeded = ll_backend__call_gen__IntroducedFrom__pred__generate_builtin__724__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) (wrapper_arg_1)));
  return succeeded;
}
  ...
  MR_Word * STATE_VARIABLE_CLD_20)
{
  ...
  succeeded = hlds__hlds_goal__goal_info_has_feature_2_p_0(GoalInfo_10, (MR_Integer) 26);
  if (succeeded)
    ...
    case (MR_Integer) 0:
      {
        ...
        libs__globals__lookup_int_option_3_p_0(Globals_9, (MR_Integer) 786, &MaxSpec_23);
    ...
    case (MR_Integer) 1:
      {
        ...
        if (succeeded)
        {
          ...
          libs__globals__lookup_int_option_3_p_0(Globals_9, (MR_Integer) 787, &MaxSpec_52);
  ...
  MR_Word * STATE_VARIABLE_CLD_51)
{
  ...
  mercury__assoc_list__from_corresponding_lists_3_p_0((MR_Word) (&ll_backend__call_gen_scalar_common_1[0]), (MR_Word) (&hlds__pred_info_types__hlds__pred_info_types__type_ctor_info_arg_info_0), ArgVars_14, ArgInfo_19, &ArgsInfos_20);
  ...
  succeeded = hlds__hlds_goal__goal_info_has_feature_2_p_0(GoalInfo_15, (MR_Integer) 26);
  if (succeeded)
  ...
  succeeded = hlds__hlds_goal__goal_info_has_feature_2_p_0(GoalInfo_15, (MR_Integer) 11);
  if (succeeded)
  {
