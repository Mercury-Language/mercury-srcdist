...
{
  {
    ...
    if (((((MR_tag((MR_Word) ll_backend__call_gen__TestExpr_7)) == (MR_mktag((MR_Integer) 3)))) && (((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), ll_backend__call_gen__TestExpr_7, (MR_Integer) 0)))) == (MR_Integer) 2))))
      {
    ...
    switch (MR_tag((MR_Word) ll_backend__call_gen__HeadVar__1_1)) {
      ...
      case (MR_Integer) 3:
        switch (((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), ll_backend__call_gen__HeadVar__1_1, (MR_Integer) 0)))) {
          ...
          case (MR_Integer) 0:
            {
              MR_Float ll_backend__call_gen__Float_8 = MR_unbox_float((MR_hl_field(MR_mktag(3), ll_backend__call_gen__HeadVar__1_1, (MR_Integer) 1)));
              MR_Word ll_backend__call_gen__Var_9;

              {
                ll_backend__call_gen__Var_9 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), ll_backend__call_gen__Var_9, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 1));
                MR_hl_field(MR_mktag(3), ll_backend__call_gen__Var_9, 1) = MR_box_float(ll_backend__call_gen__Float_8);
              }
              {
                ll_backend__call_gen__HeadVar__2_2 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), ll_backend__call_gen__HeadVar__2_2, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 1));
          ...
          case (MR_Integer) 1:
            {
              MR_Word ll_backend__call_gen__UnOp_10 = ((MR_Word) (MR_hl_field(MR_mktag(3), ll_backend__call_gen__HeadVar__1_1, (MR_Integer) 1)));
              MR_Word ll_backend__call_gen__Expr_11 = ((MR_Word) (MR_hl_field(MR_mktag(3), ll_backend__call_gen__HeadVar__1_1, (MR_Integer) 2)));
              MR_Word ll_backend__call_gen__Var_12;

              {
                ll_backend__call_gen__Var_12 = ll_backend__call_gen__convert_simple_expr_1_f_0(ll_backend__call_gen__Expr_11);
              }
              {
                ...
                MR_hl_field(MR_mktag(3), ll_backend__call_gen__HeadVar__2_2, 1) = ((MR_Box) (ll_backend__call_gen__UnOp_10));
                MR_hl_field(MR_mktag(3), ll_backend__call_gen__HeadVar__2_2, 2) = ((MR_Box) (ll_backend__call_gen__Var_12));
              }
            }
            break;
          case (MR_Integer) 2:
            {
              MR_Word ll_backend__call_gen__BinOp_13 = ((MR_Word) (MR_hl_field(MR_mktag(3), ll_backend__call_gen__HeadVar__1_1, (MR_Integer) 1)));
              MR_Word ll_backend__call_gen__Expr1_14 = ((MR_Word) (MR_hl_field(MR_mktag(3), ll_backend__call_gen__HeadVar__1_1, (MR_Integer) 2)));
              MR_Word ll_backend__call_gen__Expr2_15 = ((MR_Word) (MR_hl_field(MR_mktag(3), ll_backend__call_gen__HeadVar__1_1, (MR_Integer) 3)));
              MR_Word ll_backend__call_gen__Var_16;
              MR_Word ll_backend__call_gen__Var_17;

              {
                ll_backend__call_gen__Var_16 = ll_backend__call_gen__convert_simple_expr_1_f_0(ll_backend__call_gen__Expr1_14);
              }
              {
                ll_backend__call_gen__Var_17 = ll_backend__call_gen__convert_simple_expr_1_f_0(ll_backend__call_gen__Expr2_15);
              }
              {
                ...
                MR_hl_field(MR_mktag(3), ll_backend__call_gen__HeadVar__2_2, 1) = ((MR_Box) (ll_backend__call_gen__BinOp_13));
                MR_hl_field(MR_mktag(3), ll_backend__call_gen__HeadVar__2_2, 2) = ((MR_Box) (ll_backend__call_gen__Var_16));
                MR_hl_field(MR_mktag(3), ll_backend__call_gen__HeadVar__2_2, 3) = ((MR_Box) (ll_backend__call_gen__Var_17));
              }
            }
            break;
        }
