...
ll_backend__call_gen__generate_simple_test_6_p_0(
  ...
  MR_Word * STATE_VARIABLE_CLD_23)
{
  if (((((MR_tag((MR_Word) TestExpr_7)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(MR_mktag(3), TestExpr_7, (MR_Integer) 0)))) == (MR_Integer) 10))))
  {
      ...
      case (MR_Integer) 0:
        {
          ...
          libs__globals__lookup_int_option_3_p_0(Globals_9, (MR_Integer) 331, &MaxSpec_22);
      ...
      case (MR_Integer) 1:
        {
          ...
          if (succeeded)
          {
            ...
            libs__globals__lookup_int_option_3_p_0(Globals_9, (MR_Integer) 332, &MaxSpec_51);
