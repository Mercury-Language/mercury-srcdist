...
MR_decl_label8(ll_backend__call_gen__generate_builtin_7_0, 2,3,4,7,5,10,15,17)
MR_decl_label8(ll_backend__call_gen__generate_builtin_7_0, 21,28,29,30,34,35,37,23)
MR_decl_label7(ll_backend__call_gen__generate_builtin_7_0, 26,19,52,53,54,47,43)
MR_decl_label8(ll_backend__call_gen__generate_call_8_0, 2,4,5,6,7,8,9,10)
MR_decl_label8(ll_backend__call_gen__generate_call_8_0, 11,12,13,20,21,22,23,28)
MR_decl_label8(ll_backend__call_gen__generate_call_8_0, 29,30,32,35,41,42,43,31)
MR_decl_label3(ll_backend__call_gen__generate_call_8_0, 44,45,46)
MR_decl_label8(ll_backend__call_gen__generate_event_attributes_6_0, 5,40,11,10,8,15,7,16)
MR_decl_label8(ll_backend__call_gen__generate_simple_test_5_0, 4,5,8,7,9,6,12,11)
MR_decl_label7(ll_backend__call_gen__generate_simple_test_5_0, 14,16,3,17,20,19,22)
...
MR_BEGIN_MODULE(ll_backend__call_gen_module6)
	...
	MR_init_label8(ll_backend__call_gen__generate_call_8_0,2,4,5,6,7,8,9,10)
	MR_init_label8(ll_backend__call_gen__generate_call_8_0,11,12,13,20,21,22,23,28)
	MR_init_label8(ll_backend__call_gen__generate_call_8_0,29,30,32,35,41,42,43,31)
	MR_init_label3(ll_backend__call_gen__generate_call_8_0,44,45,46)
MR_BEGIN_CODE
...
MR_def_label(ll_backend__call_gen__generate_call_8_0,30)
	...
	MR_np_call_localret_ent(hlds__hlds_goal__goal_info_has_feature_2_0,
		ll_backend__call_gen__generate_call_8_0_i32);
MR_def_label(ll_backend__call_gen__generate_call_8_0,32)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(ll_backend__call_gen__generate_call_8_0_i31);
	}
...
MR_def_label(ll_backend__call_gen__generate_call_8_0,31)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(ll_backend__llds, instruction);
	MR_r2 = MR_sv(1);
	MR_r3 = MR_sv(3);
...
MR_BEGIN_MODULE(ll_backend__call_gen_module16)
	...
	MR_init_label8(ll_backend__call_gen__generate_simple_test_5_0,4,5,8,7,9,6,12,11)
	MR_init_label7(ll_backend__call_gen__generate_simple_test_5_0,14,16,3,17,20,19,22)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(ll_backend__call_gen_module17)
	...
	MR_init_label8(ll_backend__call_gen__generate_builtin_7_0,2,3,4,7,5,10,15,17)
	MR_init_label8(ll_backend__call_gen__generate_builtin_7_0,21,28,29,30,34,35,37,23)
	MR_init_label7(ll_backend__call_gen__generate_builtin_7_0,26,19,52,53,54,47,43)
MR_BEGIN_CODE
...
MR_def_label(ll_backend__call_gen__generate_builtin_7_0,7)
	...
	MR_r1 = MR_r2;
	MR_r3 = MR_sv(6);
	MR_GOTO_LAB(ll_backend__call_gen__generate_builtin_7_0_i17);
...
MR_def_label(ll_backend__call_gen__generate_builtin_7_0,10)
	...
	MR_np_call_localret_ent(string__format_3_0,
		ll_backend__call_gen__generate_builtin_7_0_i15);
MR_def_label(ll_backend__call_gen__generate_builtin_7_0,15)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
	...
	MR_np_call_localret_ent(libs__compiler_util__unexpected_2_0,
		ll_backend__call_gen__generate_builtin_7_0_i17);
MR_def_label(ll_backend__call_gen__generate_builtin_7_0,17)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_sv(1),0)) {
		MR_GOTO_LAB(ll_backend__call_gen__generate_builtin_7_0_i19);
	}
	MR_COMPUTED_GOTO((MR_Unsigned) MR_tag(MR_r1),
		MR_LABEL_AP(ll_backend__call_gen__generate_builtin_7_0_i21) MR_AND
		MR_LABEL_AP(ll_backend__call_gen__generate_builtin_7_0_i28) MR_AND
		MR_LABEL_AP(ll_backend__call_gen__generate_builtin_7_0_i37) MR_AND
...
MR_def_label(ll_backend__call_gen__generate_builtin_7_0,34)
	...
	MR_np_call_localret_ent(fn__f_99_111_114_100_95_95_43_43_2_0,
		ll_backend__call_gen__generate_builtin_7_0_i35);
MR_def_label(ll_backend__call_gen__generate_builtin_7_0,35)
	...
	MR_np_call_localret_ent(fn__f_99_111_114_100_95_95_43_43_2_0,
		ll_backend__call_gen__generate_builtin_7_0_i54);
...
MR_def_label(ll_backend__call_gen__generate_builtin_7_0,19)
	...
	if (MR_INT_NE(MR_sv(1),1)) {
		MR_GOTO_LAB(ll_backend__call_gen__generate_builtin_7_0_i43);
	}
	if (MR_INT_NE(MR_tag(MR_r1),2)) {
		MR_GOTO_LAB(ll_backend__call_gen__generate_builtin_7_0_i47);
	}
...
MR_def_label(ll_backend__call_gen__generate_builtin_7_0,53)
	...
	MR_np_call_localret_ent(fn__f_99_111_114_100_95_95_43_43_2_0,
		ll_backend__call_gen__generate_builtin_7_0_i54);
MR_def_label(ll_backend__call_gen__generate_builtin_7_0,54)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_sv(3);
	MR_decr_sp_and_return(7);
MR_def_label(ll_backend__call_gen__generate_builtin_7_0,47)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_string_const("call_gen.m", 10);
	...
	MR_decr_sp(7);
	MR_np_tailcall_ent(libs__compiler_util__unexpected_2_0);
MR_def_label(ll_backend__call_gen__generate_builtin_7_0,43)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_string_const("call_gen.m", 10);
