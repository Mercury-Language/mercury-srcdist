          ...
          if (ll_backend__call_gen__succeeded)
          ...
          else
            {
              ...
              }
              {
                ...
                MR_hl_field(MR_mktag(3), ll_backend__call_gen__Var_23, 1) = ((MR_Box) (&ll_backend__call_gen_scalar_common_4[0]));
      ...
      case (MR_Integer) 0:
        {
          ...
          {
            libs__globals__lookup_int_option_3_p_0(ll_backend__call_gen__Globals_9, (MR_Integer) 318, &ll_backend__call_gen__MaxSpec_22);
          }
          ...
          if (ll_backend__call_gen__succeeded)
            {
              ...
              {
                libs__globals__lookup_int_option_3_p_0(ll_backend__call_gen__Globals_9, (MR_Integer) 319, &ll_backend__call_gen__MaxSpec_52);
              }
