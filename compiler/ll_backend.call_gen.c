  ...
  else
  {
    ...
    if ((SynthCall_27 == (MR_Word) ((MR_Unsigned) 0U)))
      ...
      else
      {
        ...
        STATE_VARIABLE_Vars_35_35 = ((MR_Word) ((MR_hl_field(1, STATE_VARIABLE_Vars_0_2, 1))));
    ...
    case (MR_Integer) 0:
      {
        ...
        libs__globals__lookup_int_option_3_p_0(Globals_9, (MR_Integer) 383, &MaxSpec_23);
    ...
    case (MR_Integer) 1:
      {
        ...
        if (succeeded)
        {
          ...
          libs__globals__lookup_int_option_3_p_0(Globals_9, (MR_Integer) 384, &MaxSpec_52);
