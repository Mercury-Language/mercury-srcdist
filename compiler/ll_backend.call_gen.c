  ...
  MR_Box wrapper_arg_1)
{
  ...
  succeeded = ll_backend__call_gen__IntroducedFrom__pred__generate_builtin__722__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) (wrapper_arg_1)));
  return succeeded;
}
    ...
    case (MR_Integer) 0:
      {
        ...
        libs__globals__lookup_int_option_3_p_0(Globals_9, (MR_Integer) 381, &MaxSpec_23);
    ...
    case (MR_Integer) 1:
      {
        ...
        if (succeeded)
        {
          ...
          libs__globals__lookup_int_option_3_p_0(Globals_9, (MR_Integer) 382, &MaxSpec_52);
