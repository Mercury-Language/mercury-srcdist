...
static void MR_CALL 
ll_backend__call_gen__generate_builtin_arg_6_p_0(
  MR_Word Rval0_7,
  MR_Word * Rval_8,
  MR_Word * Code_9,
  MR_Word CI_10,
...
{
  {
    ...
    TypeInfo_68_68 = (MR_Word) &ll_backend__call_gen_scalar_common_1[0];
    backend_libs__builtin_ops__translate_builtin_5_p_0(TypeInfo_68_68, ModuleName_18, PredName_19, ProcId_12, Args_13, &SimpleCode_20);
    switch (CodeModel_10) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        {
            ...
            case (MR_Integer) 1:
              {
                ...
                ll_backend__code_loc_dep__produce_variable_6_p_0(AddrVar_23, &AddrVarCode_25, &AddrRval_26, STATE_VARIABLE_CI_0_42, STATE_VARIABLE_CLD_0_44, &STATE_VARIABLE_CLD_61_61);
                ll_backend__code_loc_dep__produce_variable_6_p_0(ValueVar_24, &ValueVarCode_27, &ValueRval_28, STATE_VARIABLE_CI_0_42, STATE_VARIABLE_CLD_61_61, STATE_VARIABLE_CLD_45);
                {
                ...
                StoreCode_30 = mercury__cord__singleton_1_f_0(TypeCtorInfo_69_69, ((MR_Box) (StoreInstr_29)));
                Var_66 = mercury__cord__f_43_43_2_f_0(TypeCtorInfo_69_69, ValueVarCode_27, StoreCode_30);
                *Code_14 = mercury__cord__f_43_43_2_f_0(TypeCtorInfo_69_69, AddrVarCode_25, Var_66);
              }
              break;
            case (MR_Integer) 2:
              {
            ...
            case (MR_Integer) 3:
              {
                ...
                mercury__list__foldl_4_p_0(TypeInfo_68_68, (MR_Word) &ll_backend__code_loc_dep__ll_backend__code_loc_dep__type_ctor_info_code_loc_dep_0, (MR_Word) &ll_backend__call_gen_scalar_common_2[1], DefinedVars_32, ((MR_Box) (STATE_VARIABLE_CLD_0_44)), &conv1_STATE_VARIABLE_CLD_45);
          ...
          case (MR_Integer) 2:
            {
              ...
              ll_backend__call_gen__generate_simple_test_6_p_0(TestExpr_33, &Rval_34, &ArgCode_35, STATE_VARIABLE_CI_0_42, STATE_VARIABLE_CLD_0_44, &STATE_VARIABLE_CLD_54_54);
  ...
  MR_Word * STATE_VARIABLE_CLD_23)
{
  if (((((MR_tag((MR_Word) TestExpr_7)) == (MR_mktag((MR_Integer) 3)))) && (((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), TestExpr_7, (MR_Integer) 0)))) == (MR_Integer) 10))))
  {
    ...
    switch (MR_tag((MR_Word) Y1_16)) {
      ...
      case (MR_Integer) 1:
        {
          MR_Word Var_61 = ((MR_Word) (MR_hl_field(MR_mktag(1), Y1_16, (MR_Integer) 0)));

          ll_backend__code_loc_dep__produce_variable_6_p_0(Var_61, &CodeY_20, &Y_19, CI_10, STATE_VARIABLE_CLD_25_25, STATE_VARIABLE_CLD_23);
        }
        break;
      case (MR_Integer) 3:
        {
  ...
  else
  {
    ...
    ll_backend__call_gen__generate_builtin_arg_6_p_0(X1_28, &X_29, ArgCode_9, CI_10, STATE_VARIABLE_CLD_0_22, STATE_VARIABLE_CLD_23);
    {
      MR_Word base;
  ...
  MR_Word * STATE_VARIABLE_CLD_27)
{
  switch (MR_tag((MR_Word) Rval0_7)) {
    ...
    case (MR_Integer) 1:
      {
        MR_Word Var_12 = ((MR_Word) (MR_hl_field(MR_mktag(1), Rval0_7, (MR_Integer) 0)));

        ll_backend__code_loc_dep__produce_variable_6_p_0(Var_12, Code_9, Rval_8, CI_10, STATE_VARIABLE_CLD_0_26, STATE_VARIABLE_CLD_27);
      }
      break;
    case (MR_Integer) 3:
      {
      ...
      case (MR_Integer) 2:
        {
          ...
          Var_87 = ((MR_String) (MR_hl_field(MR_mktag(0), EventSet_73, (MR_Integer) 0)));
          ...
          if (succeeded)
          {
            ...
            ll_backend__call_gen__generate_event_attributes_7_p_0(Attributes_75, Args_15, &MaybeUserAttributes_77, &AttrCodes_78, STATE_VARIABLE_CI_0_39, STATE_VARIABLE_CLD_0_41, &STATE_VARIABLE_CLD_28_81);
            {
              UserEventInfo_79 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
            ...
            TypeCtorInfo_35_88 = (MR_Word) &ll_backend__llds__ll_backend__llds__type_ctor_info_instruction_0;
            Var_84 = mercury__cord__cord_list_to_cord_1_f_0(TypeCtorInfo_35_88, AttrCodes_78);
            *Code_20 = mercury__cord__f_43_43_2_f_0(TypeCtorInfo_35_88, Var_84, EventCode_80);
          }
          else
          {
            {
  ...
  MR_Word * HeadVar__5_5)
{
  ...
  else
  {
    ...
    Var_18 = (MR_Integer) ((MR_Unsigned) HeadVar__3_3 + (MR_Unsigned) (MR_Integer) 1);
        ...
        case (MR_Integer) 1:
          {
            ...
            TypeInfo_114_114 = (MR_Word) &ll_backend__call_gen_scalar_common_1[0];
            mercury__list__length_2_p_0(TypeInfo_114_114, InVarsR_3, &NumInVarsR_17);
            mercury__list__length_2_p_0(TypeInfo_114_114, InVarsF_4, &NumInVarsF_18);
    ...
    case (MR_Integer) 1:
      {
        ...
        switch (HoCallVariant_2) {
          ...
          case (MR_Integer) 0:
            {
              MR_Word Var_81 = (MR_Word) MR_mkword(MR_mktag(1), &ll_backend__call_gen_scalar_common_1[3]);
              MR_Word Var_85;
              MR_Word Var_86;
              MR_Word Var_90;
              MR_Word Var_91;

              ll_backend__code_loc_dep__clobber_reg_3_p_0(Var_81, STATE_VARIABLE_CLD_0_6, STATE_VARIABLE_CLD_7);
              {
              ...
              }
              {
                ...
                MR_hl_field(MR_mktag(3), Var_86, 1) = ((MR_Box) (Var_81));
          ...
          case (MR_Integer) 1:
            {
              ...
              }
              {
                ...
                MR_hl_field(MR_mktag(3), Var_64, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &ll_backend__call_gen_scalar_common_1[3])));
              ...
              }
              {
                ...
                MR_hl_field(MR_mktag(3), Var_73, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &ll_backend__call_gen_scalar_common_1[1])));
...
{
  {
    ...
    if (succeeded)
    {
      ...
      NextReg_8 = (MR_Integer) ((MR_Unsigned) Reg_4 + (MR_Unsigned) (MR_Integer) 1);
      ...
      case (MR_Integer) 0:
        {
...

          {
            ...
            MR_hl_field(MR_mktag(0), Var_43, 1) = ((MR_Box) (&ll_backend__call_gen_scalar_common_1[6]));
          }
          {
            MR_Word base;
            base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
          ...
          libs__globals__lookup_int_option_3_p_0(Globals_9, (MR_Integer) 324, &MaxSpec_22);
      ...
      case (MR_Integer) 1:
        {
          ...
          if (succeeded)
          {
            ...
            libs__globals__lookup_int_option_3_p_0(Globals_9, (MR_Integer) 325, &MaxSpec_51);
          ...
          case (MR_Integer) 10:
            {
              ...
              Var_33 = ll_backend__call_gen__convert_simple_expr_1_f_0(Expr2_31);
              {
                ...
                MR_hl_field(MR_mktag(3), HeadVar__2_2, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 4));
  ...
  MR_Word * STATE_VARIABLE_CLD_7)
{
  ...
  else
  {
    ...
    MR_Integer Var_40 = ((MR_Integer) (MR_hl_field(MR_mktag(0), Attribute_18, (MR_Integer) 0)));
    MR_String Var_41 = ((MR_String) (MR_hl_field(MR_mktag(0), Attribute_18, (MR_Integer) 1)));
    MR_Word Var_42 = ((MR_Word) (MR_hl_field(MR_mktag(0), Attribute_18, (MR_Integer) 2)));
    MR_Word Var_43 = ((MR_Word) (MR_hl_field(MR_mktag(0), Attribute_18, (MR_Integer) 3)));

    if ((SynthCall_27 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
      if ((STATE_VARIABLE_Vars_0_2 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
      {
        {
      ...
      else
      {
        ...
        ll_backend__code_loc_dep__produce_variable_6_p_0(Var_28, &Code_23, &Rval_29, HeadVar__5_5, STATE_VARIABLE_CLD_0_6, &STATE_VARIABLE_CLD_38_38);
        {
          UserAttr_30 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), UserAttr_30, 0) = ((MR_Box) (Rval_29));
          MR_hl_field(MR_mktag(0), UserAttr_30, 1) = ((MR_Box) (Var_28));
        }
        {
          MaybeUserAttr_21 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), MaybeUserAttr_21, 0) = ((MR_Box) (UserAttr_30));
        }
      }
    else
    {
      MaybeUserAttr_21 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
    ...
    ll_backend__call_gen__generate_event_attributes_7_p_0(Attributes_19, STATE_VARIABLE_Vars_37_37, &MaybeUserAttrs_22, &Codes_24, HeadVar__5_5, STATE_VARIABLE_CLD_38_38, STATE_VARIABLE_CLD_7);
    {
      MR_Word base;
      base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      *HeadVar__3_3 = base;
