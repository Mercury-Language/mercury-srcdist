          ...
          case (MR_Integer) 1:
            {
              ...
              ll_backend__code_loc_dep__produce_variable_5_p_0(ValueVar_24, &ValueVarCode_27, &ValueRval_28, STATE_VARIABLE_CLD_47_47, STATE_VARIABLE_CLD_45);
              {
                ...
                MR_hl_field(MR_mktag(3), Var_50, 1) = ((MR_Box) (AddrRval_26));
              }
              {
                ...
                MR_hl_field(MR_mktag(3), Var_49, 2) = ((MR_Box) (ValueRval_28));
              }
              {
                StoreInstr_29 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
                MR_hl_field(MR_mktag(0), StoreInstr_29, 0) = ((MR_Box) (Var_49));
  ...
  MR_Word * STATE_VARIABLE_CLD_21)
{
  if (((((MR_tag((MR_Word) TestExpr_6)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(MR_mktag(3), TestExpr_6, (MR_Integer) 0)))) == (MR_Integer) 10))))
  {
    ...
    switch (MR_tag((MR_Word) X1_13)) {
      ...
      case (MR_Integer) 1:
        {
          MR_Word Var_29 = ((MR_Word) ((MR_hl_field(MR_mktag(1), X1_13, (MR_Integer) 0))));
    ...
    switch (MR_tag((MR_Word) Y1_14)) {
      ...
      case (MR_Integer) 1:
        {
          MR_Word Var_44 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Y1_14, (MR_Integer) 0))));
  ...
  else
  {
    ...
    switch (MR_tag((MR_Word) X1_26)) {
      ...
      case (MR_Integer) 1:
        {
          MR_Word Var_59 = ((MR_Word) ((MR_hl_field(MR_mktag(1), X1_26, (MR_Integer) 0))));
    ...
    case (MR_Integer) 2:
      {
        ...
        EventSpecMap_59 = ((MR_Word) ((MR_hl_field(MR_mktag(0), EventSet_58, (MR_Integer) 1))));
        ...
        if (succeeded)
        {
          ...
          ll_backend__call_gen__f_85_110_117_115_101_100_65_114_103_115_95_95_112_114_101_100_95_95_103_101_110_101_114_97_116_101_95_101_118_101_110_116_95_97_116_116_114_105_98_117_116_101_115_95_95_91_53_93_95_48_7_p_0(Attributes_60, ArgVars_15, &MaybeUserAttributes_62, &AttrCodes_63, STATE_VARIABLE_CLD_0_41, &STATE_VARIABLE_CLD_28_66);
          {
            ...
            MR_hl_field(MR_mktag(0), UserEventInfo_64, 0) = ((MR_Box) (EventNumber_61));
            MR_hl_field(MR_mktag(0), UserEventInfo_64, 1) = ((MR_Box) (MaybeUserAttributes_62));
          }
    ...
    case (MR_Integer) 3:
      {
        ...
        if (succeeded)
        {
          InputArgVar_33 = ((MR_Word) ((MR_hl_field(MR_mktag(1), ArgVars_15, (MR_Integer) 0))));
          Var_47 = ((MR_Word) ((MR_hl_field(MR_mktag(1), ArgVars_15, (MR_Integer) 1))));
          succeeded = (Var_47 != (MR_Word) ((MR_Unsigned) 0U));
          if (succeeded)
          {
            OutputArgVar_34 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Var_47, (MR_Integer) 0))));
        ...
        if (succeeded)
        {
          ...
          InputArgVarIsDummy_37 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), InputArgEntry_36, (MR_Integer) 2))) & (MR_Integer) 1);
          switch (InputArgVarIsDummy_37) {
            default: /*NOTREACHED*/ MR_assert(0);
            case (MR_Integer) 0:
              InputArgRval_38 = (MR_Word) (MR_mkword(MR_mktag(1), &ll_backend__call_gen_scalar_common_3[0]));
              break;
            case (MR_Integer) 1:
              {
                InputArgRval_38 = (MR_Word) MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL);
                MR_hl_field(MR_mktag(0), InputArgRval_38, 0) = ((MR_Box) (InputArgVar_33));
              }
              break;
          }
  ...
  else
  {
    ...
    if ((SynthCall_27 == (MR_Word) ((MR_Unsigned) 0U)))
      ...
      else
      {
        ...
        STATE_VARIABLE_Vars_35_35 = ((MR_Word) ((MR_hl_field(MR_mktag(1), STATE_VARIABLE_Vars_0_2, (MR_Integer) 1))));
  ...
  MR_Word * STATE_VARIABLE_CLD_70)
{
  ...
  hlds__arg_info__compute_in_and_out_vars_sep_regs_table_9_p_0(ModuleInfo_23, VarTable_25, ArgVars_15, Modes_16, ArgRegTypes_24, &InVarsR_26, &InVarsF_27, &OutVarsR_28, &OutVarsF_29);
  ...
  ll_backend__call_gen__give_vars_consecutive_arg_infos_5_p_0(OutVarsF_29, (MR_Integer) 1, (MR_Integer) 1, (MR_Integer) 1, &OutArgsInfosF_42);
  {
    ...
    MR_hl_field(MR_mktag(1), Var_85, 0) = ((MR_Box) (OutArgsInfosF_42));
    MR_hl_field(MR_mktag(1), Var_85, 1) = ((MR_Box) ((MR_Unsigned) 0U));
  }
  {
    Var_84 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(MR_mktag(1), Var_84, 0) = ((MR_Box) (OutArgsInfosR_41));
    MR_hl_field(MR_mktag(1), Var_84, 1) = ((MR_Box) (Var_85));
  }
  {
    Var_83 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(MR_mktag(1), Var_83, 0) = ((MR_Box) (InVarArgInfosF_40));
    MR_hl_field(MR_mktag(1), Var_83, 1) = ((MR_Box) (Var_84));
  }
  {
    Var_82 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(MR_mktag(1), Var_82, 0) = ((MR_Box) (InVarArgInfosR_39));
    MR_hl_field(MR_mktag(1), Var_82, 1) = ((MR_Box) (Var_83));
  }
  {
    Var_81 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(MR_mktag(1), Var_81, 0) = ((MR_Box) (SpecifierArgInfos_32));
  ...
  {
    MR_Word ContainingGoalMap_61 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MaybeContainingGoalMap_60, (MR_Integer) 0))));
    MR_Word GoalPath_62;

    GoalPath_62 = mdbcomp__goal_path__goal_id_to_forward_path_2_f_0(ContainingGoalMap_61, GoalId_54);
    {
      MaybeGoalPath_63 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), MaybeGoalPath_63, 0) = ((MR_Box) (GoalPath_62));
    }
  }
  {
    Var_96 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(MR_mktag(2), Var_96, 0) = ((MR_Box) (LiveVals_49));
  }
  {
    Var_95 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(MR_mktag(0), Var_95, 0) = ((MR_Box) (Var_96));
    MR_hl_field(MR_mktag(0), Var_95, 1) = ((MR_Box) ((MR_String) ""));
  }
  {
    Var_101 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(MR_mktag(1), Var_101, 0) = ((MR_Box) (ReturnLabel_52));
  }
  {
    Var_100 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (7 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(MR_mktag(3), Var_100, 0) = ((MR_Box) ((MR_Unsigned) 3U));
    MR_hl_field(MR_mktag(3), Var_100, 1) = ((MR_Box) (CodeAddr_31));
    MR_hl_field(MR_mktag(3), Var_100, 2) = ((MR_Box) (Var_101));
    MR_hl_field(MR_mktag(3), Var_100, 3) = ((MR_Box) (ReturnLiveLvalues_59));
    MR_hl_field(MR_mktag(3), Var_100, 4) = ((MR_Box) (Context_53));
    MR_hl_field(MR_mktag(3), Var_100, 5) = ((MR_Box) (MaybeGoalPath_63));
    MR_hl_field(MR_mktag(3), Var_100, 6) = ((MR_Box) (CallModel_50));
  }
  {
    Var_99 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(MR_mktag(0), Var_99, 0) = ((MR_Box) (Var_100));
    MR_hl_field(MR_mktag(0), Var_99, 1) = ((MR_Box) ((MR_String) "Setup and call"));
  }
  {
    ...
    MR_hl_field(MR_mktag(3), Var_105, 1) = ((MR_Box) (ReturnLabel_52));
  }
  {
    Var_104 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(MR_mktag(0), Var_104, 0) = ((MR_Box) (Var_105));
    MR_hl_field(MR_mktag(0), Var_104, 1) = ((MR_Box) ((MR_String) "Continuation label"));
  }
  {
          ...
          case (MR_Integer) 0:
            {
              ...
              ll_backend__code_loc_dep__clobber_reg_3_p_0((MR_Word) (MR_mkword(MR_mktag(1), &ll_backend__call_gen_scalar_common_1[5])), STATE_VARIABLE_CLD_0_6, STATE_VARIABLE_CLD_7);
              {
                ...
                MR_hl_field(MR_mktag(1), Var_62, 0) = ((MR_Box) (Method_35));
              }
              {
              ...
              }
              {
                ...
                MR_hl_field(MR_mktag(3), Var_57, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &ll_backend__call_gen_scalar_common_1[5])));
                MR_hl_field(MR_mktag(3), Var_57, 2) = ((MR_Box) (Var_61));
              }
              {
                Var_56 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
                MR_hl_field(MR_mktag(0), Var_56, 0) = ((MR_Box) (Var_57));
                MR_hl_field(MR_mktag(0), Var_56, 1) = ((MR_Box) ((MR_String) "Index of class method in typeclass info"));
              }
          ...
          case (MR_Integer) 1:
            {
              ...
              NumInVars_47 = ll_backend__code_util__encode_num_generic_call_vars_2_f_0(NumInVarsR_45, (MR_Integer) 0);
              {
                ...
                MR_hl_field(MR_mktag(1), Var_81, 0) = ((MR_Box) (Method_35));
              }
              {
              ...
              }
              {
                ...
                MR_hl_field(MR_mktag(3), Var_76, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &ll_backend__call_gen_scalar_common_1[5])));
                MR_hl_field(MR_mktag(3), Var_76, 2) = ((MR_Box) (Var_80));
              }
              {
                Var_75 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
                MR_hl_field(MR_mktag(0), Var_75, 0) = ((MR_Box) (Var_76));
                MR_hl_field(MR_mktag(0), Var_75, 1) = ((MR_Box) ((MR_String) "Index of class method in typeclass info"));
              }
              {
                Var_90 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(1), Var_90, 0) = ((MR_Box) (NumInVars_47));
              }
              {
              ...
              }
              {
                ...
                MR_hl_field(MR_mktag(3), Var_85, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &ll_backend__call_gen_scalar_common_1[6])));
                MR_hl_field(MR_mktag(3), Var_85, 2) = ((MR_Box) (Var_89));
              }
              {
                Var_84 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
                MR_hl_field(MR_mktag(0), Var_84, 0) = ((MR_Box) (Var_85));
                MR_hl_field(MR_mktag(0), Var_84, 1) = ((MR_Box) ((MR_String) "Assign number of immediate regular input arguments"));
              }
              {
                Var_83 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              ...
              }
              {
                ...
                MR_hl_field(MR_mktag(1), Var_74, 1) = ((MR_Box) (Var_83));
              }
    ...
    case (MR_Integer) 0:
      {
...

        {
          ...
          MR_hl_field(MR_mktag(0), Var_31, 0) = ((MR_Box) (PredVar_17));
        ...
        libs__globals__lookup_int_option_3_p_0(Globals_9, (MR_Integer) 354, &MaxSpec_22);
    ...
    case (MR_Integer) 1:
      {
...

        {
          ...
          MR_hl_field(MR_mktag(0), Var_41, 0) = ((MR_Box) (TCVar_23));
          MR_hl_field(MR_mktag(0), Var_41, 1) = ((MR_Box) (&ll_backend__call_gen_scalar_common_1[2]));
        }
        {
          MR_Word base;
          base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        ...
        if (succeeded)
        {
          ...
          libs__globals__lookup_int_option_3_p_0(Globals_9, (MR_Integer) 355, &MaxSpec_51);
          ...
          if (succeeded)
          {
...

            {
              ...
              MR_hl_field(MR_mktag(1), Var_47, 0) = ((MR_Box) (NumInputArgsR_11));
            }
            {
              MR_Word base;
              base = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
  ...
  MR_Word * STATE_VARIABLE_CLD_51)
{
  ...
  switch (CodeModel_11) {
      ...
      {
        {
          ...
          MR_hl_field(MR_mktag(0), CallModel_24, 0) = (MR_Box) ((MR_Unsigned) (AllowLCO_98));
        }
    ...
    case (MR_Integer) 2:
      {
        ...
        {
          CallModel_24 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(2), CallModel_24, 0) = (MR_Box) ((MR_Unsigned) (TailCallStatus_99));
        }
    ...
    case (MR_Integer) 1:
      {
        {
          CallModel_24 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), CallModel_24, 0) = (MR_Box) ((MR_Unsigned) (AllowLCO_98));
        }
        STATE_VARIABLE_CLD_55_55 = STATE_VARIABLE_CLD_53_53;
