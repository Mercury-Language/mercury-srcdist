      ...
      case (MR_Integer) 0:
        {
          ...
          {
            libs__globals__lookup_int_option_3_p_0(ll_backend__call_gen__Globals_9, (MR_Integer) 314, &ll_backend__call_gen__MaxSpec_22);
          }
          ...
          if (ll_backend__call_gen__succeeded)
            {
              ...
              {
                libs__globals__lookup_int_option_3_p_0(ll_backend__call_gen__Globals_9, (MR_Integer) 315, &ll_backend__call_gen__MaxSpec_52);
              }
