...
ll_backend__call_gen__IntroducedFrom__pred__generate_builtin__723__1_2_p_0(
  ...
  MR_Box wrapper_arg_1)
{
  ...
  succeeded = ll_backend__call_gen__IntroducedFrom__pred__generate_builtin__723__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) (wrapper_arg_1)));
  return succeeded;
}
  ...
  MR_Word * STATE_VARIABLE_CLD_51)
{
  ...
  mercury__assoc_list__from_corresponding_lists_3_p_0((MR_Word) (&ll_backend__call_gen_scalar_common_1[0]), (MR_Word) (&hlds__hlds_llds__hlds__hlds_llds__type_ctor_info_arg_info_0), ArgVars_14, ArgInfo_19, &ArgsInfos_20);
