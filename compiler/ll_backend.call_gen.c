  ...
  MR_Word * ll_backend__call_gen__HeadVar__2_2)
{
  ...
  else
  {
    ...
    ll_backend__call_gen__Var_3 = ((MR_Word) (MR_hl_field(MR_mktag(0), ll_backend__call_gen__Var_9, (MR_Integer) 0)));
    ll_backend__call_gen__Var_10 = ((MR_Word) (MR_hl_field(MR_mktag(0), ll_backend__call_gen__Var_9, (MR_Integer) 1)));
    ll_backend__call_gen__Loc_4 = ((MR_Word) (MR_hl_field(MR_mktag(0), ll_backend__call_gen__Var_10, (MR_Integer) 0)));
    ll_backend__call_gen__Mode_5 = ((MR_Word) (MR_hl_field(MR_mktag(0), ll_backend__call_gen__Var_10, (MR_Integer) 1)));
    ...
    switch (ll_backend__call_gen__Mode_5) {
      ...
      case (MR_Integer) 1:
        {
          MR_Word ll_backend__call_gen__Var_11;

          {
            ll_backend__call_gen__Var_11 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
            MR_hl_field(MR_mktag(0), ll_backend__call_gen__Var_11, 0) = ((MR_Box) (ll_backend__call_gen__Var_3));
            MR_hl_field(MR_mktag(0), ll_backend__call_gen__Var_11, 1) = ((MR_Box) (ll_backend__call_gen__Loc_4));
          }
          {
            MR_Word base;
            base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
            *ll_backend__call_gen__HeadVar__2_2 = base;
            MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (ll_backend__call_gen__Var_11));
            ...
            case (MR_Integer) 1:
              {
                ...
                MR_Word ll_backend__call_gen__Var_68;
                MR_Word ll_backend__call_gen__Var_69;
                MR_Word ll_backend__call_gen__Var_71;
                ...
                {
                  ll_backend__call_gen__Var_69 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                  MR_hl_field(MR_mktag(3), ll_backend__call_gen__Var_69, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 10));
                  MR_hl_field(MR_mktag(3), ll_backend__call_gen__Var_69, 1) = ((MR_Box) (ll_backend__call_gen__AddrRval_26));
                }
                {
                  ll_backend__call_gen__Var_68 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL));
                  MR_hl_field(MR_mktag(3), ll_backend__call_gen__Var_68, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 1));
                  MR_hl_field(MR_mktag(3), ll_backend__call_gen__Var_68, 1) = ((MR_Box) (ll_backend__call_gen__Var_69));
                  MR_hl_field(MR_mktag(3), ll_backend__call_gen__Var_68, 2) = ((MR_Box) (ll_backend__call_gen__ValueRval_28));
                }
                {
                  ll_backend__call_gen__StoreInstr_29 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
                  MR_hl_field(MR_mktag(0), ll_backend__call_gen__StoreInstr_29, 0) = ((MR_Box) (ll_backend__call_gen__Var_68));
                ...
                ll_backend__call_gen__Var_71 = mercury__cord__f_43_43_2_f_0(ll_backend__call_gen__TypeCtorInfo_74_74, ll_backend__call_gen__ValueVarCode_27, ll_backend__call_gen__StoreCode_30);
                *ll_backend__call_gen__Code_14 = mercury__cord__f_43_43_2_f_0(ll_backend__call_gen__TypeCtorInfo_74_74, ll_backend__call_gen__AddrVarCode_25, ll_backend__call_gen__Var_71);
              }
              break;
            case (MR_Integer) 2:
              {
...
ll_backend__call_gen__generate_simple_test_6_p_0(
  ...
  MR_Word * ll_backend__call_gen__STATE_VARIABLE_CLD_23)
{
  if (((((MR_tag((MR_Word) ll_backend__call_gen__TestExpr_7)) == (MR_mktag((MR_Integer) 3)))) && (((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), ll_backend__call_gen__TestExpr_7, (MR_Integer) 0)))) == (MR_Integer) 8))))
  {
      ...
      case (MR_Integer) 2:
        {
          ...
          MR_String ll_backend__call_gen__Var_89;
          ...
          ll_backend__call_gen__Var_89 = ((MR_String) (MR_hl_field(MR_mktag(0), ll_backend__call_gen__EventSet_74, (MR_Integer) 0)));
          ...
          if (ll_backend__call_gen__succeeded)
          {
            ...
            MR_Word ll_backend__call_gen__Var_85;
            ...
            ll_backend__call_gen__Var_85 = mercury__cord__cord_list_to_cord_1_f_0(ll_backend__call_gen__TypeCtorInfo_36_90, ll_backend__call_gen__AttrCodes_79);
            *ll_backend__call_gen__Code_20 = mercury__cord__f_43_43_2_f_0(ll_backend__call_gen__TypeCtorInfo_36_90, ll_backend__call_gen__Var_85, ll_backend__call_gen__EventCode_81);
          }
          else
          {
            {
      ...
      case (MR_Integer) 3:
        {
          ...
          MR_Word ll_backend__call_gen__Var_43;
          MR_Word ll_backend__call_gen__Var_44;
          ...
          if (ll_backend__call_gen__succeeded)
          {
            ...
            ll_backend__call_gen__Var_43 = ((MR_Word) (MR_hl_field(MR_mktag(1), ll_backend__call_gen__Args_15, (MR_Integer) 1)));
            ll_backend__call_gen__succeeded = ((MR_tag((MR_Word) ll_backend__call_gen__Var_43)) == (MR_mktag((MR_Integer) 1)));
            if (ll_backend__call_gen__succeeded)
            {
              ll_backend__call_gen__OutputArg_34 = ((MR_Word) (MR_hl_field(MR_mktag(1), ll_backend__call_gen__Var_43, (MR_Integer) 0)));
              ll_backend__call_gen__Var_44 = ((MR_Word) (MR_hl_field(MR_mktag(1), ll_backend__call_gen__Var_43, (MR_Integer) 1)));
              ll_backend__call_gen__succeeded = (ll_backend__call_gen__Var_44 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
            }
          }
          if (ll_backend__call_gen__succeeded)
          {
            ...
            if (ll_backend__call_gen__succeeded)
            {
              ll_backend__call_gen__Rval_38 = (MR_Word) MR_mkword(MR_mktag(1), &ll_backend__call_gen_scalar_common_3[1]);
            }
            else
              {
...
{
  {
    ...
    MR_Integer ll_backend__call_gen__Var_72;
    MR_Integer ll_backend__call_gen__Var_73;
    MR_Word ll_backend__call_gen__Var_82;
    MR_Word ll_backend__call_gen__Var_83;
    MR_Word ll_backend__call_gen__Var_84;
    MR_Word ll_backend__call_gen__Var_85;
    MR_Word ll_backend__call_gen__Var_86;
    ...
    MR_Word ll_backend__call_gen__Var_95;
    MR_Word ll_backend__call_gen__Var_96;
    MR_Word ll_backend__call_gen__Var_97;
    MR_Word ll_backend__call_gen__Var_99;
    MR_Word ll_backend__call_gen__Var_100;
    MR_Word ll_backend__call_gen__Var_101;
    MR_Word ll_backend__call_gen__Var_102;
    MR_Word ll_backend__call_gen__Var_104;
    MR_Word ll_backend__call_gen__Var_105;
    MR_Word ll_backend__call_gen__Var_106;
    MR_Word ll_backend__call_gen__Var_111;
    MR_Word ll_backend__call_gen__Var_112;
    MR_Word ll_backend__call_gen__Var_113;
    ...
    ll_backend__call_gen__Var_72 = mercury__list__length_1_f_0(ll_backend__call_gen__TypeInfo_114_114, ll_backend__call_gen__InVarsR_27);
    ll_backend__call_gen__Var_73 = mercury__list__length_1_f_0(ll_backend__call_gen__TypeInfo_114_114, ll_backend__call_gen__InVarsF_28);
    ll_backend__call_gen__generic_call_info_8_p_0(ll_backend__call_gen__Globals_31, ll_backend__call_gen__GenericCall_14, ll_backend__call_gen__Var_72, ll_backend__call_gen__Var_73, &ll_backend__call_gen__CodeAddr_32, &ll_backend__call_gen__SpecifierArgInfos_33, &ll_backend__call_gen__FirstImmInputR_34, &ll_backend__call_gen__HoCallVariant_35);
    ...
    {
      ll_backend__call_gen__Var_86 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), ll_backend__call_gen__Var_86, 0) = ((MR_Box) (ll_backend__call_gen__OutArgsInfosF_43));
      MR_hl_field(MR_mktag(1), ll_backend__call_gen__Var_86, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
    }
    {
      ll_backend__call_gen__Var_85 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), ll_backend__call_gen__Var_85, 0) = ((MR_Box) (ll_backend__call_gen__OutArgsInfosR_42));
      MR_hl_field(MR_mktag(1), ll_backend__call_gen__Var_85, 1) = ((MR_Box) (ll_backend__call_gen__Var_86));
    }
    {
      ll_backend__call_gen__Var_84 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), ll_backend__call_gen__Var_84, 0) = ((MR_Box) (ll_backend__call_gen__InVarArgInfosF_41));
      MR_hl_field(MR_mktag(1), ll_backend__call_gen__Var_84, 1) = ((MR_Box) (ll_backend__call_gen__Var_85));
    }
    {
      ll_backend__call_gen__Var_83 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), ll_backend__call_gen__Var_83, 0) = ((MR_Box) (ll_backend__call_gen__InVarArgInfosR_40));
      MR_hl_field(MR_mktag(1), ll_backend__call_gen__Var_83, 1) = ((MR_Box) (ll_backend__call_gen__Var_84));
    }
    {
      ll_backend__call_gen__Var_82 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), ll_backend__call_gen__Var_82, 0) = ((MR_Box) (ll_backend__call_gen__SpecifierArgInfos_33));
      MR_hl_field(MR_mktag(1), ll_backend__call_gen__Var_82, 1) = ((MR_Box) (ll_backend__call_gen__Var_83));
    }
    ll_backend__call_gen__ArgInfos_44 = mercury__list__condense_1_f_0(ll_backend__call_gen__TypeInfo_115_115, ll_backend__call_gen__Var_82);
    ...
    {
      ll_backend__call_gen__Var_97 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(2), ll_backend__call_gen__Var_97, 0) = ((MR_Box) (ll_backend__call_gen__LiveVals_50));
    }
    {
      ll_backend__call_gen__Var_96 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), ll_backend__call_gen__Var_96, 0) = ((MR_Box) (ll_backend__call_gen__Var_97));
      MR_hl_field(MR_mktag(0), ll_backend__call_gen__Var_96, 1) = ((MR_Box) ((MR_String) ""));
    }
    {
      ll_backend__call_gen__Var_102 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), ll_backend__call_gen__Var_102, 0) = ((MR_Box) (ll_backend__call_gen__ReturnLabel_53));
    }
    {
      ll_backend__call_gen__Var_101 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 7 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(3), ll_backend__call_gen__Var_101, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 3));
      MR_hl_field(MR_mktag(3), ll_backend__call_gen__Var_101, 1) = ((MR_Box) (ll_backend__call_gen__CodeAddr_32));
      MR_hl_field(MR_mktag(3), ll_backend__call_gen__Var_101, 2) = ((MR_Box) (ll_backend__call_gen__Var_102));
      MR_hl_field(MR_mktag(3), ll_backend__call_gen__Var_101, 3) = ((MR_Box) (ll_backend__call_gen__ReturnLiveLvalues_60));
      MR_hl_field(MR_mktag(3), ll_backend__call_gen__Var_101, 4) = ((MR_Box) (ll_backend__call_gen__Context_54));
      MR_hl_field(MR_mktag(3), ll_backend__call_gen__Var_101, 5) = ((MR_Box) (ll_backend__call_gen__MaybeGoalPath_64));
      MR_hl_field(MR_mktag(3), ll_backend__call_gen__Var_101, 6) = ((MR_Box) (ll_backend__call_gen__CallModel_51));
    }
    {
      ll_backend__call_gen__Var_100 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), ll_backend__call_gen__Var_100, 0) = ((MR_Box) (ll_backend__call_gen__Var_101));
      MR_hl_field(MR_mktag(0), ll_backend__call_gen__Var_100, 1) = ((MR_Box) ((MR_String) "Setup and call"));
    }
    {
      ll_backend__call_gen__Var_106 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(3), ll_backend__call_gen__Var_106, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 5));
      MR_hl_field(MR_mktag(3), ll_backend__call_gen__Var_106, 1) = ((MR_Box) (ll_backend__call_gen__ReturnLabel_53));
    }
    {
      ll_backend__call_gen__Var_105 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), ll_backend__call_gen__Var_105, 0) = ((MR_Box) (ll_backend__call_gen__Var_106));
      MR_hl_field(MR_mktag(0), ll_backend__call_gen__Var_105, 1) = ((MR_Box) ((MR_String) "Continuation label"));
    }
    {
      ll_backend__call_gen__Var_104 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), ll_backend__call_gen__Var_104, 0) = ((MR_Box) (ll_backend__call_gen__Var_105));
      MR_hl_field(MR_mktag(1), ll_backend__call_gen__Var_104, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
    }
    {
      ll_backend__call_gen__Var_99 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), ll_backend__call_gen__Var_99, 0) = ((MR_Box) (ll_backend__call_gen__Var_100));
      MR_hl_field(MR_mktag(1), ll_backend__call_gen__Var_99, 1) = ((MR_Box) (ll_backend__call_gen__Var_104));
    }
    {
      ll_backend__call_gen__Var_95 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), ll_backend__call_gen__Var_95, 0) = ((MR_Box) (ll_backend__call_gen__Var_96));
      MR_hl_field(MR_mktag(1), ll_backend__call_gen__Var_95, 1) = ((MR_Box) (ll_backend__call_gen__Var_99));
    }
    ll_backend__call_gen__CallCode_65 = mercury__cord__from_list_1_f_0(ll_backend__call_gen__TypeCtorInfo_117_117, ll_backend__call_gen__Var_95);
    ...
    ll_backend__call_gen__Var_113 = mercury__cord__f_43_43_2_f_0(ll_backend__call_gen__TypeCtorInfo_117_117, ll_backend__call_gen__CallCode_65, ll_backend__call_gen__FailHandlingCode_67);
    ll_backend__call_gen__Var_112 = mercury__cord__f_43_43_2_f_0(ll_backend__call_gen__TypeCtorInfo_117_117, ll_backend__call_gen__TraceCode_52, ll_backend__call_gen__Var_113);
    ll_backend__call_gen__Var_111 = mercury__cord__f_43_43_2_f_0(ll_backend__call_gen__TypeCtorInfo_117_117, ll_backend__call_gen__NonVarCode_48, ll_backend__call_gen__Var_112);
    *ll_backend__call_gen__Code_20 = mercury__cord__f_43_43_2_f_0(ll_backend__call_gen__TypeCtorInfo_117_117, ll_backend__call_gen__SetupCode_46, ll_backend__call_gen__Var_111);
  }
}
  ...
  MR_Word * ll_backend__call_gen__HeadVar__5_5)
{
  ...
  else
  {
    ...
    MR_Word ll_backend__call_gen__Var_16;
    MR_Word ll_backend__call_gen__Var_17;
    MR_Integer ll_backend__call_gen__Var_18;

    {
      ll_backend__call_gen__Var_17 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), ll_backend__call_gen__Var_17, 0) = ((MR_Box) (ll_backend__call_gen__HeadVar__2_2));
      MR_hl_field(MR_mktag(0), ll_backend__call_gen__Var_17, 1) = ((MR_Box) (ll_backend__call_gen__HeadVar__3_3));
    }
    {
      ll_backend__call_gen__ArgInfo_14 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), ll_backend__call_gen__ArgInfo_14, 0) = ((MR_Box) (ll_backend__call_gen__Var_17));
      MR_hl_field(MR_mktag(0), ll_backend__call_gen__ArgInfo_14, 1) = ((MR_Box) (ll_backend__call_gen__HeadVar__4_4));
    }
    {
      ll_backend__call_gen__Var_16 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), ll_backend__call_gen__Var_16, 0) = ((MR_Box) (ll_backend__call_gen__Var_9));
      MR_hl_field(MR_mktag(0), ll_backend__call_gen__Var_16, 1) = ((MR_Box) (ll_backend__call_gen__ArgInfo_14));
    }
    ll_backend__call_gen__Var_18 = (ll_backend__call_gen__HeadVar__3_3 + (MR_Integer) 1);
    ll_backend__call_gen__give_vars_consecutive_arg_infos_5_p_0(ll_backend__call_gen__Vars_10, ll_backend__call_gen__HeadVar__2_2, ll_backend__call_gen__Var_18, ll_backend__call_gen__HeadVar__4_4, &ll_backend__call_gen__ArgInfos_15);
    {
      MR_Word base;
      base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      *ll_backend__call_gen__HeadVar__5_5 = base;
      MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (ll_backend__call_gen__Var_16));
        ...
        case (MR_Integer) 1:
          {
            ...
            MR_Word ll_backend__call_gen__Var_22 = (MR_Word) MR_mkword(MR_mktag(1), &ll_backend__call_gen_scalar_common_1[3]);
            MR_Word ll_backend__call_gen__Var_26;
            MR_Word ll_backend__call_gen__Var_27;
            MR_Word ll_backend__call_gen__Var_31;
            MR_Word ll_backend__call_gen__Var_32;

            ll_backend__code_loc_dep__clobber_reg_3_p_0(ll_backend__call_gen__Var_22, ll_backend__call_gen__STATE_VARIABLE_CLD_0_6, ll_backend__call_gen__STATE_VARIABLE_CLD_7);
            ...
            {
              ll_backend__call_gen__Var_32 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), ll_backend__call_gen__Var_32, 0) = ((MR_Box) (ll_backend__call_gen__NumInVars_19));
            }
            {
              ll_backend__call_gen__Var_31 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(3), ll_backend__call_gen__Var_31, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 1));
              MR_hl_field(MR_mktag(3), ll_backend__call_gen__Var_31, 1) = ((MR_Box) (ll_backend__call_gen__Var_32));
            }
            {
              ll_backend__call_gen__Var_27 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(3), ll_backend__call_gen__Var_27, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 1));
              MR_hl_field(MR_mktag(3), ll_backend__call_gen__Var_27, 1) = ((MR_Box) (ll_backend__call_gen__Var_22));
              MR_hl_field(MR_mktag(3), ll_backend__call_gen__Var_27, 2) = ((MR_Box) (ll_backend__call_gen__Var_31));
            }
            {
              ll_backend__call_gen__Var_26 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
              MR_hl_field(MR_mktag(0), ll_backend__call_gen__Var_26, 0) = ((MR_Box) (ll_backend__call_gen__Var_27));
              MR_hl_field(MR_mktag(0), ll_backend__call_gen__Var_26, 1) = ((MR_Box) ((MR_String) "Assign number of immediate input arguments"));
            }
            *ll_backend__call_gen__Code_5 = mercury__cord__singleton_1_f_0((MR_Word) &ll_backend__llds__ll_backend__llds__type_ctor_info_instruction_0, ((MR_Box) (ll_backend__call_gen__Var_26)));
          }
          break;
      }
      break;
    case (MR_Integer) 1:
      {
        ...
        MR_Word ll_backend__call_gen__Var_34 = ((MR_Word) (MR_hl_field(MR_mktag(1), ll_backend__call_gen__HeadVar__1_1, (MR_Integer) 0)));
        MR_Word ll_backend__call_gen__Var_36 = ((MR_Word) (MR_hl_field(MR_mktag(1), ll_backend__call_gen__HeadVar__1_1, (MR_Integer) 2)));
        MR_Word ll_backend__call_gen__Var_37 = ((MR_Word) (MR_hl_field(MR_mktag(1), ll_backend__call_gen__HeadVar__1_1, (MR_Integer) 3)));
        ...
        switch (ll_backend__call_gen__HoCallVariant_2) {
          ...
          case (MR_Integer) 0:
            {
              MR_Word ll_backend__call_gen__Var_82 = (MR_Word) MR_mkword(MR_mktag(1), &ll_backend__call_gen_scalar_common_1[3]);
              MR_Word ll_backend__call_gen__Var_86;
              MR_Word ll_backend__call_gen__Var_87;
              MR_Word ll_backend__call_gen__Var_91;
              MR_Word ll_backend__call_gen__Var_92;

              ll_backend__code_loc_dep__clobber_reg_3_p_0(ll_backend__call_gen__Var_82, ll_backend__call_gen__STATE_VARIABLE_CLD_0_6, ll_backend__call_gen__STATE_VARIABLE_CLD_7);
              {
                ll_backend__call_gen__Var_92 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(1), ll_backend__call_gen__Var_92, 0) = ((MR_Box) (ll_backend__call_gen__Method_35));
              }
              {
                ll_backend__call_gen__Var_91 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), ll_backend__call_gen__Var_91, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 1));
                MR_hl_field(MR_mktag(3), ll_backend__call_gen__Var_91, 1) = ((MR_Box) (ll_backend__call_gen__Var_92));
              }
              {
                ll_backend__call_gen__Var_87 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), ll_backend__call_gen__Var_87, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 1));
                MR_hl_field(MR_mktag(3), ll_backend__call_gen__Var_87, 1) = ((MR_Box) (ll_backend__call_gen__Var_82));
                MR_hl_field(MR_mktag(3), ll_backend__call_gen__Var_87, 2) = ((MR_Box) (ll_backend__call_gen__Var_91));
              }
              {
                ll_backend__call_gen__Var_86 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
                MR_hl_field(MR_mktag(0), ll_backend__call_gen__Var_86, 0) = ((MR_Box) (ll_backend__call_gen__Var_87));
                MR_hl_field(MR_mktag(0), ll_backend__call_gen__Var_86, 1) = ((MR_Box) ((MR_String) "Index of class method in typeclass info"));
              }
              *ll_backend__call_gen__Code_5 = mercury__cord__singleton_1_f_0((MR_Word) &ll_backend__llds__ll_backend__llds__type_ctor_info_instruction_0, ((MR_Box) (ll_backend__call_gen__Var_86)));
            }
            break;
          case (MR_Integer) 1:
            {
              ...
              MR_Word ll_backend__call_gen__Var_63;
              MR_Word ll_backend__call_gen__Var_64;
              MR_Word ll_backend__call_gen__Var_65;
              MR_Word ll_backend__call_gen__Var_69;
              MR_Word ll_backend__call_gen__Var_70;
              MR_Word ll_backend__call_gen__Var_72;
              MR_Word ll_backend__call_gen__Var_73;
              MR_Word ll_backend__call_gen__Var_74;
              MR_Word ll_backend__call_gen__Var_78;
              MR_Word ll_backend__call_gen__Var_79;
              ...
              {
                ll_backend__call_gen__Var_70 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(1), ll_backend__call_gen__Var_70, 0) = ((MR_Box) (ll_backend__call_gen__Method_35));
              }
              {
                ll_backend__call_gen__Var_69 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), ll_backend__call_gen__Var_69, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 1));
                MR_hl_field(MR_mktag(3), ll_backend__call_gen__Var_69, 1) = ((MR_Box) (ll_backend__call_gen__Var_70));
              }
              {
                ll_backend__call_gen__Var_65 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), ll_backend__call_gen__Var_65, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 1));
                MR_hl_field(MR_mktag(3), ll_backend__call_gen__Var_65, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &ll_backend__call_gen_scalar_common_1[3])));
                MR_hl_field(MR_mktag(3), ll_backend__call_gen__Var_65, 2) = ((MR_Box) (ll_backend__call_gen__Var_69));
              }
              {
                ll_backend__call_gen__Var_64 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
                MR_hl_field(MR_mktag(0), ll_backend__call_gen__Var_64, 0) = ((MR_Box) (ll_backend__call_gen__Var_65));
                MR_hl_field(MR_mktag(0), ll_backend__call_gen__Var_64, 1) = ((MR_Box) ((MR_String) "Index of class method in typeclass info"));
              }
              {
                ll_backend__call_gen__Var_79 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(1), ll_backend__call_gen__Var_79, 0) = ((MR_Box) (ll_backend__call_gen__NumInVars_47));
              }
              {
                ll_backend__call_gen__Var_78 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), ll_backend__call_gen__Var_78, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 1));
                MR_hl_field(MR_mktag(3), ll_backend__call_gen__Var_78, 1) = ((MR_Box) (ll_backend__call_gen__Var_79));
              }
              {
                ll_backend__call_gen__Var_74 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), ll_backend__call_gen__Var_74, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 1));
                MR_hl_field(MR_mktag(3), ll_backend__call_gen__Var_74, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &ll_backend__call_gen_scalar_common_1[1])));
                MR_hl_field(MR_mktag(3), ll_backend__call_gen__Var_74, 2) = ((MR_Box) (ll_backend__call_gen__Var_78));
              }
              {
                ll_backend__call_gen__Var_73 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
                MR_hl_field(MR_mktag(0), ll_backend__call_gen__Var_73, 0) = ((MR_Box) (ll_backend__call_gen__Var_74));
                MR_hl_field(MR_mktag(0), ll_backend__call_gen__Var_73, 1) = ((MR_Box) ((MR_String) "Assign number of immediate regular input arguments"));
              }
              {
                ll_backend__call_gen__Var_72 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(1), ll_backend__call_gen__Var_72, 0) = ((MR_Box) (ll_backend__call_gen__Var_73));
                MR_hl_field(MR_mktag(1), ll_backend__call_gen__Var_72, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
              }
              {
                ll_backend__call_gen__Var_63 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(1), ll_backend__call_gen__Var_63, 0) = ((MR_Box) (ll_backend__call_gen__Var_64));
                MR_hl_field(MR_mktag(1), ll_backend__call_gen__Var_63, 1) = ((MR_Box) (ll_backend__call_gen__Var_72));
              }
              *ll_backend__call_gen__Code_5 = mercury__cord__from_list_1_f_0((MR_Word) &ll_backend__llds__ll_backend__llds__type_ctor_info_instruction_0, ll_backend__call_gen__Var_63);
            }
            break;
        }
      }
...
{
  {
    ...
    if (ll_backend__call_gen__succeeded)
    {
      ...
      {
        ll_backend__call_gen__Var_9 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), ll_backend__call_gen__Var_9, 0) = ((MR_Box) ((MR_Integer) 0));
        MR_hl_field(MR_mktag(1), ll_backend__call_gen__Var_9, 1) = ((MR_Box) (ll_backend__call_gen__Reg_4));
      }
      ...
      ll_backend__call_gen__extra_livevals_from_3_p_0(ll_backend__call_gen__NextReg_8, ll_backend__call_gen__FirstInput_5, &ll_backend__call_gen__ExtraLiveVals1_7);
      {
        ...
        *ll_backend__call_gen__ExtraLiveVals_6 = base;
        MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (ll_backend__call_gen__Var_9));
      ...
      case (MR_Integer) 0:
        {
          ...
          MR_Word ll_backend__call_gen__Var_44;
          MR_Word ll_backend__call_gen__Var_18 = ((MR_Word) (MR_hl_field(MR_mktag(0), ll_backend__call_gen__GenericCall_10, (MR_Integer) 1)));
          MR_Word ll_backend__call_gen__Var_19 = ((MR_Word) (MR_hl_field(MR_mktag(0), ll_backend__call_gen__GenericCall_10, (MR_Integer) 2)));
          MR_Integer ll_backend__call_gen__Var_20 = ((MR_Integer) (MR_hl_field(MR_mktag(0), ll_backend__call_gen__GenericCall_10, (MR_Integer) 3)));

          {
            ll_backend__call_gen__Var_44 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
            MR_hl_field(MR_mktag(0), ll_backend__call_gen__Var_44, 0) = ((MR_Box) (ll_backend__call_gen__PredVar_17));
            MR_hl_field(MR_mktag(0), ll_backend__call_gen__Var_44, 1) = ((MR_Box) (&ll_backend__call_gen_scalar_common_1[6]));
          }
          {
            MR_Word base;
            base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
            *ll_backend__call_gen__SpecifierArgInfos_14 = base;
            MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (ll_backend__call_gen__Var_44));
            MR_hl_field(MR_mktag(1), base, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
          }
          libs__globals__lookup_int_option_3_p_0(ll_backend__call_gen__Globals_9, (MR_Integer) 320, &ll_backend__call_gen__MaxSpec_22);
          ...
          if (ll_backend__call_gen__succeeded)
          {
            MR_Word ll_backend__call_gen__Var_50;

            {
              ll_backend__call_gen__Var_50 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), ll_backend__call_gen__Var_50, 0) = ((MR_Box) (ll_backend__call_gen__NumInputArgsR_11));
            }
            {
              MR_Word base;
              ...
              *ll_backend__call_gen__CodeAddr_13 = base;
              ...
              MR_hl_field(MR_mktag(3), base, 1) = ((MR_Box) (ll_backend__call_gen__Var_50));
            }
      ...
      case (MR_Integer) 1:
        {
          ...
          MR_Word ll_backend__call_gen__Var_31;
          MR_Integer ll_backend__call_gen__Var_24 = ((MR_Integer) (MR_hl_field(MR_mktag(1), ll_backend__call_gen__GenericCall_10, (MR_Integer) 1)));
          MR_Word ll_backend__call_gen__Var_25 = ((MR_Word) (MR_hl_field(MR_mktag(1), ll_backend__call_gen__GenericCall_10, (MR_Integer) 2)));
          MR_Word ll_backend__call_gen__Var_26 = ((MR_Word) (MR_hl_field(MR_mktag(1), ll_backend__call_gen__GenericCall_10, (MR_Integer) 3)));

          {
            ll_backend__call_gen__Var_31 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
            MR_hl_field(MR_mktag(0), ll_backend__call_gen__Var_31, 0) = ((MR_Box) (ll_backend__call_gen__TCVar_23));
            MR_hl_field(MR_mktag(0), ll_backend__call_gen__Var_31, 1) = ((MR_Box) (&ll_backend__call_gen_scalar_common_1[6]));
          }
          {
            MR_Word base;
            base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
            *ll_backend__call_gen__SpecifierArgInfos_14 = base;
            MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (ll_backend__call_gen__Var_31));
            MR_hl_field(MR_mktag(1), base, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
          }
          ll_backend__call_gen__succeeded = (ll_backend__call_gen__NumInputArgsF_12 == (MR_Integer) 0);
          if (ll_backend__call_gen__succeeded)
          {
            ...
            libs__globals__lookup_int_option_3_p_0(ll_backend__call_gen__Globals_9, (MR_Integer) 321, &ll_backend__call_gen__MaxSpec_52);
            ...
            if (ll_backend__call_gen__succeeded)
            {
              MR_Word ll_backend__call_gen__Var_37;

              {
                ll_backend__call_gen__Var_37 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(1), ll_backend__call_gen__Var_37, 0) = ((MR_Box) (ll_backend__call_gen__NumInputArgsR_11));
              }
              {
                MR_Word base;
                base = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                *ll_backend__call_gen__CodeAddr_13 = base;
                MR_hl_field(MR_mktag(3), base, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 2));
                MR_hl_field(MR_mktag(3), base, 1) = ((MR_Box) (ll_backend__call_gen__Var_37));
              }
              *ll_backend__call_gen__HoCallVariant_16 = (MR_Integer) 0;
              *ll_backend__call_gen__FirstImmediateInputReg_15 = (MR_Integer) 3;
            }
      ...
      case (MR_Integer) 1:
        {
          ...
          MR_Word ll_backend__call_gen__Var_5;

          {
            ll_backend__call_gen__Var_5 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), ll_backend__call_gen__Var_5, 0) = ((MR_Box) (ll_backend__call_gen__Int_4));
          }
          {
            ...
            MR_hl_field(MR_mktag(3), ll_backend__call_gen__HeadVar__2_2, 1) = ((MR_Box) (ll_backend__call_gen__Var_5));
          }
        }
        break;
      case (MR_Integer) 2:
        {
          MR_Unsigned ll_backend__call_gen__UInt_6 = ((MR_Unsigned) (MR_hl_field(MR_mktag(2), ll_backend__call_gen__HeadVar__1_1, (MR_Integer) 0)));
          MR_Word ll_backend__call_gen__Var_7;

          {
            ll_backend__call_gen__Var_7 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(2), ll_backend__call_gen__Var_7, 0) = ((MR_Box) (ll_backend__call_gen__UInt_6));
          }
          {
            ll_backend__call_gen__HeadVar__2_2 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(3), ll_backend__call_gen__HeadVar__2_2, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 1));
            MR_hl_field(MR_mktag(3), ll_backend__call_gen__HeadVar__2_2, 1) = ((MR_Box) (ll_backend__call_gen__Var_7));
          }
        }
        break;
      case (MR_Integer) 3:
        switch (((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), ll_backend__call_gen__HeadVar__1_1, (MR_Integer) 0)))) {
          ...
          case (MR_Integer) 0:
            {
              MR_Integer ll_backend__call_gen__Int8_8 = ((MR_Integer) (MR_hl_field(MR_mktag(3), ll_backend__call_gen__HeadVar__1_1, (MR_Integer) 1)));
              MR_Word ll_backend__call_gen__Var_9;

              {
                ll_backend__call_gen__Var_9 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), ll_backend__call_gen__Var_9, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 0));
                MR_hl_field(MR_mktag(3), ll_backend__call_gen__Var_9, 1) = ((MR_Box) (ll_backend__call_gen__Int8_8));
              }
              {
                ll_backend__call_gen__HeadVar__2_2 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), ll_backend__call_gen__HeadVar__2_2, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 1));
                MR_hl_field(MR_mktag(3), ll_backend__call_gen__HeadVar__2_2, 1) = ((MR_Box) (ll_backend__call_gen__Var_9));
              }
            }
            break;
          case (MR_Integer) 1:
            {
              MR_Integer ll_backend__call_gen__UInt8_10 = ((MR_Integer) (MR_hl_field(MR_mktag(3), ll_backend__call_gen__HeadVar__1_1, (MR_Integer) 1)));
              MR_Word ll_backend__call_gen__Var_11;

              {
                ll_backend__call_gen__Var_11 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), ll_backend__call_gen__Var_11, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 1));
                MR_hl_field(MR_mktag(3), ll_backend__call_gen__Var_11, 1) = ((MR_Box) (ll_backend__call_gen__UInt8_10));
              }
              {
                ll_backend__call_gen__HeadVar__2_2 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), ll_backend__call_gen__HeadVar__2_2, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 1));
                MR_hl_field(MR_mktag(3), ll_backend__call_gen__HeadVar__2_2, 1) = ((MR_Box) (ll_backend__call_gen__Var_11));
              }
            }
            break;
          case (MR_Integer) 2:
            {
              MR_Integer ll_backend__call_gen__Int16_12 = ((MR_Integer) (MR_hl_field(MR_mktag(3), ll_backend__call_gen__HeadVar__1_1, (MR_Integer) 1)));
              MR_Word ll_backend__call_gen__Var_13;

              {
                ll_backend__call_gen__Var_13 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), ll_backend__call_gen__Var_13, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 2));
                MR_hl_field(MR_mktag(3), ll_backend__call_gen__Var_13, 1) = ((MR_Box) (ll_backend__call_gen__Int16_12));
              }
              {
                ll_backend__call_gen__HeadVar__2_2 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), ll_backend__call_gen__HeadVar__2_2, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 1));
                MR_hl_field(MR_mktag(3), ll_backend__call_gen__HeadVar__2_2, 1) = ((MR_Box) (ll_backend__call_gen__Var_13));
              }
            }
            break;
          case (MR_Integer) 3:
            {
              MR_Integer ll_backend__call_gen__UInt16_14 = ((MR_Integer) (MR_hl_field(MR_mktag(3), ll_backend__call_gen__HeadVar__1_1, (MR_Integer) 1)));
              MR_Word ll_backend__call_gen__Var_15;

              {
                ll_backend__call_gen__Var_15 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), ll_backend__call_gen__Var_15, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 3));
                MR_hl_field(MR_mktag(3), ll_backend__call_gen__Var_15, 1) = ((MR_Box) (ll_backend__call_gen__UInt16_14));
              }
              {
                ll_backend__call_gen__HeadVar__2_2 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), ll_backend__call_gen__HeadVar__2_2, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 1));
                MR_hl_field(MR_mktag(3), ll_backend__call_gen__HeadVar__2_2, 1) = ((MR_Box) (ll_backend__call_gen__Var_15));
              }
            }
            break;
          case (MR_Integer) 4:
            {
              MR_Integer ll_backend__call_gen__Int32_16 = ((MR_Integer) (MR_hl_field(MR_mktag(3), ll_backend__call_gen__HeadVar__1_1, (MR_Integer) 1)));
              MR_Word ll_backend__call_gen__Var_17;

              {
                ll_backend__call_gen__Var_17 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), ll_backend__call_gen__Var_17, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 4));
                MR_hl_field(MR_mktag(3), ll_backend__call_gen__Var_17, 1) = ((MR_Box) (ll_backend__call_gen__Int32_16));
              }
              {
                ll_backend__call_gen__HeadVar__2_2 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), ll_backend__call_gen__HeadVar__2_2, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 1));
                MR_hl_field(MR_mktag(3), ll_backend__call_gen__HeadVar__2_2, 1) = ((MR_Box) (ll_backend__call_gen__Var_17));
              }
            }
            break;
          case (MR_Integer) 5:
            {
              MR_Integer ll_backend__call_gen__UInt32_18 = ((MR_Integer) (MR_hl_field(MR_mktag(3), ll_backend__call_gen__HeadVar__1_1, (MR_Integer) 1)));
              MR_Word ll_backend__call_gen__Var_19;

              {
                ll_backend__call_gen__Var_19 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), ll_backend__call_gen__Var_19, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 5));
                MR_hl_field(MR_mktag(3), ll_backend__call_gen__Var_19, 1) = ((MR_Box) (ll_backend__call_gen__UInt32_18));
              }
              {
                ll_backend__call_gen__HeadVar__2_2 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), ll_backend__call_gen__HeadVar__2_2, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 1));
                MR_hl_field(MR_mktag(3), ll_backend__call_gen__HeadVar__2_2, 1) = ((MR_Box) (ll_backend__call_gen__Var_19));
              }
            }
            break;
          case (MR_Integer) 6:
            {
              MR_Float ll_backend__call_gen__Float_20 = MR_unbox_float((MR_hl_field(MR_mktag(3), ll_backend__call_gen__HeadVar__1_1, (MR_Integer) 1)));
              MR_Word ll_backend__call_gen__Var_21;

              {
                ll_backend__call_gen__Var_21 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), ll_backend__call_gen__Var_21, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 7));
                MR_hl_field(MR_mktag(3), ll_backend__call_gen__Var_21, 1) = MR_box_float(ll_backend__call_gen__Float_20);
              }
              {
                ll_backend__call_gen__HeadVar__2_2 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), ll_backend__call_gen__HeadVar__2_2, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 1));
                MR_hl_field(MR_mktag(3), ll_backend__call_gen__HeadVar__2_2, 1) = ((MR_Box) (ll_backend__call_gen__Var_21));
              }
            }
            break;
          case (MR_Integer) 7:
            {
              MR_Word ll_backend__call_gen__UnOp_22 = ((MR_Word) (MR_hl_field(MR_mktag(3), ll_backend__call_gen__HeadVar__1_1, (MR_Integer) 1)));
              MR_Word ll_backend__call_gen__Expr_23 = ((MR_Word) (MR_hl_field(MR_mktag(3), ll_backend__call_gen__HeadVar__1_1, (MR_Integer) 2)));
              MR_Word ll_backend__call_gen__Var_24;

              ll_backend__call_gen__Var_24 = ll_backend__call_gen__convert_simple_expr_1_f_0(ll_backend__call_gen__Expr_23);
              {
                ...
                MR_hl_field(MR_mktag(3), ll_backend__call_gen__HeadVar__2_2, 1) = ((MR_Box) (ll_backend__call_gen__UnOp_22));
                MR_hl_field(MR_mktag(3), ll_backend__call_gen__HeadVar__2_2, 2) = ((MR_Box) (ll_backend__call_gen__Var_24));
              }
            }
            break;
          case (MR_Integer) 8:
            {
              MR_Word ll_backend__call_gen__BinOp_25 = ((MR_Word) (MR_hl_field(MR_mktag(3), ll_backend__call_gen__HeadVar__1_1, (MR_Integer) 1)));
              MR_Word ll_backend__call_gen__Expr1_26 = ((MR_Word) (MR_hl_field(MR_mktag(3), ll_backend__call_gen__HeadVar__1_1, (MR_Integer) 2)));
              MR_Word ll_backend__call_gen__Expr2_27 = ((MR_Word) (MR_hl_field(MR_mktag(3), ll_backend__call_gen__HeadVar__1_1, (MR_Integer) 3)));
              MR_Word ll_backend__call_gen__Var_28;
              MR_Word ll_backend__call_gen__Var_29;

              ll_backend__call_gen__Var_28 = ll_backend__call_gen__convert_simple_expr_1_f_0(ll_backend__call_gen__Expr1_26);
              ll_backend__call_gen__Var_29 = ll_backend__call_gen__convert_simple_expr_1_f_0(ll_backend__call_gen__Expr2_27);
              {
                ...
                MR_hl_field(MR_mktag(3), ll_backend__call_gen__HeadVar__2_2, 1) = ((MR_Box) (ll_backend__call_gen__BinOp_25));
                MR_hl_field(MR_mktag(3), ll_backend__call_gen__HeadVar__2_2, 2) = ((MR_Box) (ll_backend__call_gen__Var_28));
                MR_hl_field(MR_mktag(3), ll_backend__call_gen__HeadVar__2_2, 3) = ((MR_Box) (ll_backend__call_gen__Var_29));
              }
            }
            break;
        }
  ...
  MR_Word * ll_backend__call_gen__STATE_VARIABLE_CLD_7)
{
  ...
  else
  {
    ...
    MR_Integer ll_backend__call_gen__Var_42 = ((MR_Integer) (MR_hl_field(MR_mktag(0), ll_backend__call_gen__Attribute_19, (MR_Integer) 0)));
    MR_String ll_backend__call_gen__Var_43 = ((MR_String) (MR_hl_field(MR_mktag(0), ll_backend__call_gen__Attribute_19, (MR_Integer) 1)));
    MR_Word ll_backend__call_gen__Var_44 = ((MR_Word) (MR_hl_field(MR_mktag(0), ll_backend__call_gen__Attribute_19, (MR_Integer) 2)));
    MR_Word ll_backend__call_gen__Var_45 = ((MR_Word) (MR_hl_field(MR_mktag(0), ll_backend__call_gen__Attribute_19, (MR_Integer) 3)));
...
{
  {
    ...
    MR_Word ll_backend__call_gen__Var_58;
    MR_Word ll_backend__call_gen__Var_59;
    MR_Word ll_backend__call_gen__Var_60;
    MR_Word ll_backend__call_gen__Var_62;
    MR_Word ll_backend__call_gen__Var_63;
    MR_Word ll_backend__call_gen__Var_64;
    MR_Word ll_backend__call_gen__Var_65;
    MR_Word ll_backend__call_gen__Var_66;
    MR_Word ll_backend__call_gen__Var_67;
    MR_Word ll_backend__call_gen__Var_68;
    ...
    {
      ll_backend__call_gen__Var_60 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(2), ll_backend__call_gen__Var_60, 0) = ((MR_Box) (ll_backend__call_gen__LiveVals_21));
    }
    {
      ll_backend__call_gen__Var_59 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), ll_backend__call_gen__Var_59, 0) = ((MR_Box) (ll_backend__call_gen__Var_60));
      MR_hl_field(MR_mktag(0), ll_backend__call_gen__Var_59, 1) = ((MR_Box) ((MR_String) ""));
    }
    {
      ll_backend__call_gen__Var_65 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), ll_backend__call_gen__Var_65, 0) = ((MR_Box) (ll_backend__call_gen__ReturnLabel_28));
    }
    {
      ll_backend__call_gen__Var_68 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(3), ll_backend__call_gen__Var_68, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 5));
      MR_hl_field(MR_mktag(3), ll_backend__call_gen__Var_68, 1) = ((MR_Box) (ll_backend__call_gen__ReturnLabel_28));
    }
    {
      ll_backend__call_gen__Var_67 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), ll_backend__call_gen__Var_67, 0) = ((MR_Box) (ll_backend__call_gen__Var_68));
      MR_hl_field(MR_mktag(0), ll_backend__call_gen__Var_67, 1) = ((MR_Box) ((MR_String) "continuation label"));
    }
    {
      ll_backend__call_gen__Var_66 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), ll_backend__call_gen__Var_66, 0) = ((MR_Box) (ll_backend__call_gen__Var_67));
      MR_hl_field(MR_mktag(1), ll_backend__call_gen__Var_66, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
    }
    ...
    {
      ll_backend__call_gen__Var_64 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 7 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(3), ll_backend__call_gen__Var_64, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 3));
      MR_hl_field(MR_mktag(3), ll_backend__call_gen__Var_64, 1) = ((MR_Box) (ll_backend__call_gen__Address_27));
      MR_hl_field(MR_mktag(3), ll_backend__call_gen__Var_64, 2) = ((MR_Box) (ll_backend__call_gen__Var_65));
      MR_hl_field(MR_mktag(3), ll_backend__call_gen__Var_64, 3) = ((MR_Box) (ll_backend__call_gen__ReturnLiveLvalues_37));
      MR_hl_field(MR_mktag(3), ll_backend__call_gen__Var_64, 4) = ((MR_Box) (ll_backend__call_gen__Context_30));
      MR_hl_field(MR_mktag(3), ll_backend__call_gen__Var_64, 5) = ((MR_Box) (ll_backend__call_gen__MaybeGoalPath_35));
      MR_hl_field(MR_mktag(3), ll_backend__call_gen__Var_64, 6) = ((MR_Box) (ll_backend__call_gen__CallModel_24));
    }
    {
      ll_backend__call_gen__Var_63 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), ll_backend__call_gen__Var_63, 0) = ((MR_Box) (ll_backend__call_gen__Var_64));
      MR_hl_field(MR_mktag(0), ll_backend__call_gen__Var_63, 1) = ((MR_Box) (ll_backend__call_gen__CallComment_29));
    }
    {
      ll_backend__call_gen__Var_62 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), ll_backend__call_gen__Var_62, 0) = ((MR_Box) (ll_backend__call_gen__Var_63));
      MR_hl_field(MR_mktag(1), ll_backend__call_gen__Var_62, 1) = ((MR_Box) (ll_backend__call_gen__Var_66));
    }
    {
      ll_backend__call_gen__Var_58 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), ll_backend__call_gen__Var_58, 0) = ((MR_Box) (ll_backend__call_gen__Var_59));
      MR_hl_field(MR_mktag(1), ll_backend__call_gen__Var_58, 1) = ((MR_Box) (ll_backend__call_gen__Var_62));
    }
    ll_backend__call_gen__CallCode_36 = mercury__cord__from_list_1_f_0(ll_backend__call_gen__TypeCtorInfo_92_92, ll_backend__call_gen__Var_58);
    ...
    if (ll_backend__call_gen__succeeded)
    {
      ...
      MR_Word ll_backend__call_gen__Var_77;
      MR_Word ll_backend__call_gen__Var_81;
      MR_Word ll_backend__call_gen__Var_82;
      MR_Word ll_backend__call_gen__Var_83;
      MR_Word ll_backend__call_gen__Var_84;
      MR_Word ll_backend__call_gen__Var_87;
      ...
      {
        ll_backend__call_gen__Var_84 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), ll_backend__call_gen__Var_84, 0) = ((MR_Box) (ll_backend__call_gen__TailRecLabel_46));
      }
      {
        ll_backend__call_gen__Var_83 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(3), ll_backend__call_gen__Var_83, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 6));
        MR_hl_field(MR_mktag(3), ll_backend__call_gen__Var_83, 1) = ((MR_Box) (ll_backend__call_gen__Var_84));
      }
      {
        ll_backend__call_gen__Var_82 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), ll_backend__call_gen__Var_82, 0) = ((MR_Box) (ll_backend__call_gen__Var_83));
        MR_hl_field(MR_mktag(0), ll_backend__call_gen__Var_82, 1) = ((MR_Box) ((MR_String) "tail recursive jump"));
      }
      {
        ll_backend__call_gen__Var_81 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), ll_backend__call_gen__Var_81, 0) = ((MR_Box) (ll_backend__call_gen__Var_82));
        MR_hl_field(MR_mktag(1), ll_backend__call_gen__Var_81, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
      }
      {
        ll_backend__call_gen__Var_77 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), ll_backend__call_gen__Var_77, 0) = ((MR_Box) (ll_backend__call_gen__Var_59));
        MR_hl_field(MR_mktag(1), ll_backend__call_gen__Var_77, 1) = ((MR_Box) (ll_backend__call_gen__Var_81));
      }
      ll_backend__call_gen__JumpCode_47 = mercury__cord__from_list_1_f_0(ll_backend__call_gen__TypeCtorInfo_92_92, ll_backend__call_gen__Var_77);
      ll_backend__call_gen__Var_87 = mercury__cord__f_43_43_2_f_0(ll_backend__call_gen__TypeCtorInfo_92_92, ll_backend__call_gen__TraceTailRecResetAndEventCode_45, ll_backend__call_gen__JumpCode_47);
      *ll_backend__call_gen__Code_16 = mercury__cord__f_43_43_2_f_0(ll_backend__call_gen__TypeCtorInfo_92_92, ll_backend__call_gen__SetupCode_22, ll_backend__call_gen__Var_87);
    }
    else
    {
      MR_Word ll_backend__call_gen__Var_88;
      MR_Word ll_backend__call_gen__Var_89;

      ll_backend__call_gen__Var_89 = mercury__cord__f_43_43_2_f_0(ll_backend__call_gen__TypeCtorInfo_92_92, ll_backend__call_gen__CallCode_36, ll_backend__call_gen__FailHandlingCode_42);
      ll_backend__call_gen__Var_88 = mercury__cord__f_43_43_2_f_0(ll_backend__call_gen__TypeCtorInfo_92_92, ll_backend__call_gen__TraceResetCode_25, ll_backend__call_gen__Var_89);
      *ll_backend__call_gen__Code_16 = mercury__cord__f_43_43_2_f_0(ll_backend__call_gen__TypeCtorInfo_92_92, ll_backend__call_gen__SetupCode_22, ll_backend__call_gen__Var_88);
...
{
  {
    ...
    else
    {
      ...
      MR_Word ll_backend__call_gen__Var_21 = ((MR_Word) (MR_hl_field(MR_mktag(1), ll_backend__call_gen__HeadVar__1_1, (MR_Integer) 0)));
      MR_Word ll_backend__call_gen__Var_22;
      MR_Word ll_backend__call_gen__STATE_VARIABLE_CLD_23_23;
      MR_Word ll_backend__call_gen__TypeCtorInfo_26_26;

      ll_backend__call_gen__Var_10 = ((MR_Word) (MR_hl_field(MR_mktag(0), ll_backend__call_gen__Var_21, (MR_Integer) 0)));
      ll_backend__call_gen__Var_22 = ((MR_Word) (MR_hl_field(MR_mktag(0), ll_backend__call_gen__Var_21, (MR_Integer) 1)));
      ll_backend__call_gen__ArgLoc_11 = ((MR_Word) (MR_hl_field(MR_mktag(0), ll_backend__call_gen__Var_22, (MR_Integer) 0)));
      ll_backend__call_gen__Mode_12 = ((MR_Word) (MR_hl_field(MR_mktag(0), ll_backend__call_gen__Var_22, (MR_Integer) 1)));
      ...
      if (ll_backend__call_gen__succeeded)
      {
        ...
        MR_Word ll_backend__call_gen__Var_25;
        ...
        {
          ll_backend__call_gen__Var_25 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), ll_backend__call_gen__Var_25, 0) = ((MR_Box) (ll_backend__call_gen__Var_10));
          MR_hl_field(MR_mktag(0), ll_backend__call_gen__Var_25, 1) = ((MR_Box) (ll_backend__call_gen__ArgLoc_11));
        }
        {
          MR_Word base;
          base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
          *ll_backend__call_gen__HeadVar__3_3 = base;
          MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (ll_backend__call_gen__Var_25));
...
{
  {
    ...
    ll_backend__call_gen__Var_15 = parse_tree__set_of_var__init_0_f_0(ll_backend__call_gen__TypeCtorInfo_17_17);
    ll_backend__call_gen__find_nonlive_outputs_4_p_0(ll_backend__call_gen__ArgsInfos_6, ll_backend__call_gen__Liveness_10, ll_backend__call_gen__Var_15, ll_backend__call_gen__NonLiveOutputs_8);
  ...
  while (MR_TRUE)
  {
    /* tailcall optimized into a loop */
    {
      ...
      else
      {
        ...
        MR_Word ll_backend__call_gen__Var_17 = ((MR_Word) (MR_hl_field(MR_mktag(1), ll_backend__call_gen__HeadVar__1_1, (MR_Integer) 0)));
        MR_Word ll_backend__call_gen__Var_18;
        MR_Word ll_backend__call_gen__STATE_VARIABLE_NonLiveOutputs_19_19;
        MR_Word ll_backend__call_gen___ArgLoc_10;

        ll_backend__call_gen__Var_9 = ((MR_Word) (MR_hl_field(MR_mktag(0), ll_backend__call_gen__Var_17, (MR_Integer) 0)));
        ll_backend__call_gen__Var_18 = ((MR_Word) (MR_hl_field(MR_mktag(0), ll_backend__call_gen__Var_17, (MR_Integer) 1)));
        ll_backend__call_gen___ArgLoc_10 = ((MR_Word) (MR_hl_field(MR_mktag(0), ll_backend__call_gen__Var_18, (MR_Integer) 0)));
        ll_backend__call_gen__Mode_11 = ((MR_Word) (MR_hl_field(MR_mktag(0), ll_backend__call_gen__Var_18, (MR_Integer) 1)));
        ...
        {
          MR_Word ll_backend__call_gen__next_value_of_HeadVar__1_1 = ll_backend__call_gen__Args_12;
          MR_Word ll_backend__call_gen__next_value_of_STATE_VARIABLE_NonLiveOutputs_0_3 = ll_backend__call_gen__STATE_VARIABLE_NonLiveOutputs_19_19;

          ll_backend__call_gen__STATE_VARIABLE_NonLiveOutputs_0_3 = ll_backend__call_gen__next_value_of_STATE_VARIABLE_NonLiveOutputs_0_3;
          ll_backend__call_gen__HeadVar__1_1 = ll_backend__call_gen__next_value_of_HeadVar__1_1;
        }
        continue;
      }
    }
      ...
      case (MR_Integer) 1:
        {
          ...
          MR_String ll_backend__call_gen__Var_14;
          ...
          ll_backend__call_gen__Var_14 = mercury__string__f_43_43_2_f_0((MR_String) " ", ll_backend__call_gen__PredName_13);
          *ll_backend__call_gen__Msg_8 = mercury__string__f_43_43_2_f_0(ll_backend__call_gen__BaseMsg_9, ll_backend__call_gen__Var_14);
        }
        break;
    }
  }
      ...
      case (MR_Integer) 1:
        {
          ...
          else
          {
            ...
            MR_Word ll_backend__call_gen__Var_22;
            MR_Word ll_backend__call_gen__Var_23;
            MR_Word ll_backend__call_gen__Var_28;
            MR_Word ll_backend__call_gen__Var_31;
            MR_Word ll_backend__call_gen__Var_32;
            MR_Word ll_backend__call_gen__Var_34;
            ...
            {
              ll_backend__call_gen__Var_28 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), ll_backend__call_gen__Var_28, 0) = ((MR_Box) (ll_backend__call_gen__ContLab_13));
            }
            {
              ll_backend__call_gen__Var_23 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(3), ll_backend__call_gen__Var_23, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 9));
              MR_hl_field(MR_mktag(3), ll_backend__call_gen__Var_23, 1) = ((MR_Box) (&ll_backend__call_gen_scalar_common_3[0]));
              MR_hl_field(MR_mktag(3), ll_backend__call_gen__Var_23, 2) = ((MR_Box) (ll_backend__call_gen__Var_28));
            }
            {
              ll_backend__call_gen__Var_22 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
              MR_hl_field(MR_mktag(0), ll_backend__call_gen__Var_22, 0) = ((MR_Box) (ll_backend__call_gen__Var_23));
              MR_hl_field(MR_mktag(0), ll_backend__call_gen__Var_22, 1) = ((MR_Box) ((MR_String) "test for success"));
            }
            ll_backend__call_gen__FailTestCode_14 = mercury__cord__singleton_1_f_0(ll_backend__call_gen__TypeCtorInfo_35_35, ((MR_Box) (ll_backend__call_gen__Var_22)));
            ...
            {
              ll_backend__call_gen__Var_32 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(3), ll_backend__call_gen__Var_32, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 5));
              MR_hl_field(MR_mktag(3), ll_backend__call_gen__Var_32, 1) = ((MR_Box) (ll_backend__call_gen__ContLab_13));
            }
            {
              ll_backend__call_gen__Var_31 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
              MR_hl_field(MR_mktag(0), ll_backend__call_gen__Var_31, 0) = ((MR_Box) (ll_backend__call_gen__Var_32));
              MR_hl_field(MR_mktag(0), ll_backend__call_gen__Var_31, 1) = ((MR_Box) ((MR_String) ""));
            }
            ll_backend__call_gen__ContLabelCode_16 = mercury__cord__singleton_1_f_0(ll_backend__call_gen__TypeCtorInfo_35_35, ((MR_Box) (ll_backend__call_gen__Var_31)));
            ll_backend__call_gen__Var_34 = mercury__cord__f_43_43_2_f_0(ll_backend__call_gen__TypeCtorInfo_35_35, ll_backend__call_gen__FailCode_15, ll_backend__call_gen__ContLabelCode_16);
            *ll_backend__call_gen__FailHandlingCode_9 = mercury__cord__f_43_43_2_f_0(ll_backend__call_gen__TypeCtorInfo_35_35, ll_backend__call_gen__FailTestCode_14, ll_backend__call_gen__Var_34);
          }
        }
        break;
    }
...
{
  {
    ...
    ll_backend__call_gen__succeeded = hlds__hlds_goal__goal_info_has_feature_2_p_0(ll_backend__call_gen__GoalInfo_10, (MR_Integer) 23);
    if (ll_backend__call_gen__succeeded)
