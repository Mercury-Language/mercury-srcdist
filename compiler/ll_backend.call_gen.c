    ...
    case (MR_Integer) 3:
      {
        ...
        if (succeeded)
        {
          ...
          hlds__var_table__lookup_var_entry_3_p_0(VarTable_35, InputArgVar_33, &InputArgEntry_36);
    ...
    case (MR_Integer) 0:
      {
        ...
        libs__globals__lookup_int_option_3_p_0(Globals_9, (MR_Integer) 351, &MaxSpec_22);
    ...
    case (MR_Integer) 1:
      {
        ...
        if (succeeded)
        {
          ...
          libs__globals__lookup_int_option_3_p_0(Globals_9, (MR_Integer) 352, &MaxSpec_51);
