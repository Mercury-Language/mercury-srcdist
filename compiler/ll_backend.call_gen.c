...
{
  {
    ...
    switch (MR_tag((MR_Word) GenericCall_14)) {
      ...
      case (MR_Integer) 0:
        {
          mercury__require__sorry_2_p_0((MR_String) "predicate \140ll_backend.call_gen.generate_generic_call\'/12", (MR_String) "coerce");
          return;
        }
        break;
      case (MR_Integer) 1:
      case (MR_Integer) 2:
        ...
        break;
      case (MR_Integer) 3:
        switch (((MR_Integer) ((MR_hl_field(MR_mktag(3), GenericCall_14, (MR_Integer) 0))))) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 0:
            {
              MR_String EventName_31 = ((MR_String) ((MR_hl_field(MR_mktag(3), GenericCall_14, (MR_Integer) 1))));
          ...
          case (MR_Integer) 1:
            {
              ...
              if (succeeded)
              {
                ...
                Var_45 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Args_15, (MR_Integer) 1))));
                succeeded = (Var_45 != (MR_Word) ((MR_Unsigned) 0U));
                if (succeeded)
                {
                  OutputArg_34 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Var_45, (MR_Integer) 0))));
              ...
              if (succeeded)
              {
                ...
                if (succeeded)
                {
                  ...
                  Rval_61 = ll_backend__call_gen__convert_simple_expr_1_f_0(Rval_38);
                  ll_backend__code_loc_dep__assign_expr_to_var_5_p_0(OutputArg_34, Rval_61, Code_20, STATE_VARIABLE_CLD_0_41, STATE_VARIABLE_CLD_42);
                }
                else
                {
  ...
  MR_Word * STATE_VARIABLE_CLD_7)
{
  switch (MR_tag((MR_Word) HeadVar__1_1)) {
    ...
    case (MR_Integer) 0:
      {
        mercury__require__unexpected_2_p_0((MR_String) "predicate \140ll_backend.call_gen.generic_call_nonvar_setup\'/7", (MR_String) "coerce");
        return;
      }
      break;
    case (MR_Integer) 1:
    ...
    case (MR_Integer) 2:
      {
        MR_Integer Method_35 = ((MR_Integer) ((MR_hl_field(MR_mktag(2), HeadVar__1_1, (MR_Integer) 1))));
...
{
  {
    ...
    switch (MR_tag((MR_Word) GenericCall_10)) {
      ...
      case (MR_Integer) 0:
        {
          mercury__require__sorry_2_p_0((MR_String) "predicate \140ll_backend.call_gen.generic_call_info\'/8", (MR_String) "coerce");
          return;
        }
        break;
      case (MR_Integer) 1:
        {
          MR_Word PredVar_17 = ((MR_Word) ((MR_hl_field(MR_mktag(1), GenericCall_10, (MR_Integer) 0))));
          MR_Integer MaxSpec_22;
          MR_Word Var_45;

          {
            Var_45 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
            MR_hl_field(MR_mktag(0), Var_45, 0) = ((MR_Box) (PredVar_17));
            MR_hl_field(MR_mktag(0), Var_45, 1) = ((MR_Box) (&ll_backend__call_gen_scalar_common_1[6]));
          }
          {
            MR_Word base;
            base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          ...
          libs__globals__lookup_int_option_3_p_0(Globals_9, (MR_Integer) 347, &MaxSpec_22);
          ...
          if (succeeded)
          {
...

            {
              ...
              MR_hl_field(MR_mktag(1), Var_51, 0) = ((MR_Box) (NumInputArgsR_11));
            }
            {
              MR_Word base;
      ...
      case (MR_Integer) 2:
        {
          MR_Word TCVar_23 = ((MR_Word) ((MR_hl_field(MR_mktag(2), GenericCall_10, (MR_Integer) 0))));
          MR_Word Var_33;

          {
            Var_33 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
            MR_hl_field(MR_mktag(0), Var_33, 0) = ((MR_Box) (TCVar_23));
            MR_hl_field(MR_mktag(0), Var_33, 1) = ((MR_Box) (&ll_backend__call_gen_scalar_common_1[6]));
          }
          {
            MR_Word base;
            base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          ...
          if (succeeded)
          {
            MR_Integer MaxSpec_53;

            libs__globals__lookup_int_option_3_p_0(Globals_9, (MR_Integer) 348, &MaxSpec_53);
            succeeded = (MaxSpec_53 >= (MR_Integer) 0);
            if (succeeded)
              succeeded = (NumInputArgsR_11 <= MaxSpec_53);
            if (succeeded)
            {
              MR_Word Var_39;

              {
                ...
                MR_hl_field(MR_mktag(1), Var_39, 0) = ((MR_Box) (NumInputArgsR_11));
              }
              {
                MR_Word base;
                base = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
