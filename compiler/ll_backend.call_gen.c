  ...
  MR_Word * STATE_VARIABLE_CLD_5)
{
  ...
  else
  {
    ...
    if (succeeded)
    {
      TypeCtorInfo__26_26 = (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0);
      succeeded = parse_tree__set_of_var__member_2_p_0(TypeCtorInfo__26_26, Liveness_2, Var_10);
    }
    if (succeeded)
    {
      MR_Word Register_18;
