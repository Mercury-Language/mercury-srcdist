  ...
  MR_Word * STATE_VARIABLE_Sub_15)
{
  if (((MR_tag((MR_Word) TypeAndMode_6)) == (MR_Integer) 1))
  {
    ...
    if (((MR_tag((MR_Word) Mode_11)) == (MR_Integer) 0))
    {
      ...
      MR_Word STATE_VARIABLE_InconsistentVars_19_29;
      MR_Word STATE_VARIABLE_Sub_20_30;

      parse_tree__prog_mode__gather_inconsistent_constrained_inst_vars_in_inst_5_p_0(InitialInst_23, STATE_VARIABLE_InconsistentVars_0_12, &STATE_VARIABLE_InconsistentVars_19_29, STATE_VARIABLE_Sub_0_14, &STATE_VARIABLE_Sub_20_30);
      parse_tree__prog_mode__gather_inconsistent_constrained_inst_vars_in_inst_5_p_0(FinalInst_24, STATE_VARIABLE_InconsistentVars_19_29, STATE_VARIABLE_InconsistentVars_13, STATE_VARIABLE_Sub_20_30, STATE_VARIABLE_Sub_15);
    }
    else
    {
