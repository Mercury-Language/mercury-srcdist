...
MR_decl_label3(parse_tree__prog_mode__alt_list_apply_substitution_3_0, 13,4,5)
...
MR_decl_label3(parse_tree__prog_mode__inst_list_apply_substitution_2_3_0, 13,4,5)
...
MR_decl_label6(parse_tree__prog_mode__mode_list_apply_substitution_2_3_0, 20,6,7,5,8,9)
...
MR_BEGIN_MODULE(parse_tree__prog_mode_module20)
	...
	MR_init_label3(parse_tree__prog_mode__inst_list_apply_substitution_2_3_0,13,4,5)
MR_BEGIN_CODE
...
MR_def_static(parse_tree__prog_mode__inst_list_apply_substitution_2_3_0)
	...
	if (MR_LTAGS_TESTR(MR_r2,0,0)) {
		MR_GOTO_LAB(parse_tree__prog_mode__inst_list_apply_substitution_2_3_0_i13);
	}
	MR_r1 = (MR_Word) MR_tbmkword(0, 0);
	MR_proceed();
MR_def_label(parse_tree__prog_mode__inst_list_apply_substitution_2_3_0,13)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(3);
	MR_sv(3) = (MR_Word) MR_succip;
	MR_sv(1) = MR_r1;
...
MR_BEGIN_MODULE(parse_tree__prog_mode_module23)
	...
	MR_init_label3(parse_tree__prog_mode__alt_list_apply_substitution_3_0,13,4,5)
MR_BEGIN_CODE
...
MR_def_static(parse_tree__prog_mode__alt_list_apply_substitution_3_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r2,0,0)) {
		MR_GOTO_LAB(parse_tree__prog_mode__alt_list_apply_substitution_3_0_i13);
	}
	MR_r1 = (MR_Word) MR_tbmkword(0, 0);
	MR_proceed();
MR_def_label(parse_tree__prog_mode__alt_list_apply_substitution_3_0,13)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(4);
	MR_sv(4) = (MR_Word) MR_succip;
	MR_sv(1) = MR_r1;
...
MR_BEGIN_MODULE(parse_tree__prog_mode_module25)
	...
	MR_init_label6(parse_tree__prog_mode__mode_list_apply_substitution_2_3_0,20,6,7,5,8,9)
MR_BEGIN_CODE
...
MR_def_static(parse_tree__prog_mode__mode_list_apply_substitution_2_3_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r2,0,0)) {
		MR_GOTO_LAB(parse_tree__prog_mode__mode_list_apply_substitution_2_3_0_i20);
	}
	MR_r1 = (MR_Word) MR_tbmkword(0, 0);
	MR_proceed();
MR_def_label(parse_tree__prog_mode__mode_list_apply_substitution_2_3_0,20)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(4);
	MR_sv(4) = (MR_Word) MR_succip;
	{
