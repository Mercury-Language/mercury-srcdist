...
{
  {
    ...
    if (succeeded)
    {
      ...
      succeeded = ((((MR_tag((MR_Word) Final_5)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(MR_mktag(3), Final_5, (MR_Integer) 0)))) == (MR_Integer) 1)));
      if (succeeded)
      {
    ...
    else
    {
      ...
      succeeded = ((((MR_tag((MR_Word) Initial_4)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(MR_mktag(3), Initial_4, (MR_Integer) 0)))) == (MR_Integer) 1)));
      if (succeeded)
      {
