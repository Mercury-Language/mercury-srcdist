...
MR_decl_label2(parse_tree__prog_mode__ho_inst_info_apply_substitution_3_0, 17,4)
...
MR_decl_label10(parse_tree__prog_mode__rename_apart_inst_vars_in_inst_3_0, 138,3,4,155,10,5,14,17,15,21)
MR_decl_label10(parse_tree__prog_mode__rename_apart_inst_vars_in_inst_3_0, 19,24,27,23,32,30,29,163,41,162)
MR_decl_label2(parse_tree__prog_mode__rename_apart_inst_vars_in_inst_3_0, 48,45)
...
MR_decl_label2(parse_tree__prog_mode__strip_builtin_qualifiers_from_ho_inst_info_2_0, 18,5)
...
MR_BEGIN_MODULE(parse_tree__prog_mode_module28)
	...
	MR_init_label2(parse_tree__prog_mode__ho_inst_info_apply_substitution_3_0,17,4)
MR_BEGIN_CODE
...
MR_def_static(parse_tree__prog_mode__ho_inst_info_apply_substitution_3_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r2,0,0)) {
		MR_GOTO_LAB(parse_tree__prog_mode__ho_inst_info_apply_substitution_3_0_i17);
	}
	MR_r1 = (MR_Word) MR_tbmkword(0, 0);
	MR_proceed();
MR_def_label(parse_tree__prog_mode__ho_inst_info_apply_substitution_3_0,17)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(3);
	MR_sv(3) = (MR_Word) MR_succip;
	{
...
MR_BEGIN_MODULE(parse_tree__prog_mode_module46)
	...
	MR_init_label2(parse_tree__prog_mode__strip_builtin_qualifiers_from_ho_inst_info_2_0,18,5)
MR_BEGIN_CODE
...
MR_def_static(parse_tree__prog_mode__strip_builtin_qualifiers_from_ho_inst_info_2_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
		MR_GOTO_LAB(parse_tree__prog_mode__strip_builtin_qualifiers_from_ho_inst_info_2_0_i18);
	}
	MR_r1 = (MR_Word) MR_tbmkword(0, 0);
	MR_proceed();
MR_def_label(parse_tree__prog_mode__strip_builtin_qualifiers_from_ho_inst_info_2_0,18)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(3);
	MR_sv(3) = (MR_Word) MR_succip;
	{
...
MR_BEGIN_MODULE(parse_tree__prog_mode_module50)
	...
	MR_init_label10(parse_tree__prog_mode__rename_apart_inst_vars_in_inst_3_0,138,3,4,155,10,5,14,17,15,21)
	MR_init_label10(parse_tree__prog_mode__rename_apart_inst_vars_in_inst_3_0,19,24,27,23,32,30,29,163,41,162)
	MR_init_label2(parse_tree__prog_mode__rename_apart_inst_vars_in_inst_3_0,48,45)
MR_BEGIN_CODE
...
MR_def_static(parse_tree__prog_mode__rename_apart_inst_vars_in_inst_3_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
MR_def_label(parse_tree__prog_mode__rename_apart_inst_vars_in_inst_3_0,138)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r2,0,0)) {
...
MR_def_label(parse_tree__prog_mode__rename_apart_inst_vars_in_inst_3_0,4)
	...
	if (MR_LTAGS_TESTR(MR_r5,0,0)) {
		MR_GOTO_LAB(parse_tree__prog_mode__rename_apart_inst_vars_in_inst_3_0_i155);
	}
	MR_tag_alloc_heap(MR_r1, 2, (MR_Integer) 2);
	MR_tfield(2, MR_r1, 0) = MR_tfield(2, MR_r2, 0);
	MR_tfield(2, MR_r1, 1) = (MR_Word) MR_tbmkword(0, 0);
	MR_proceed();
MR_def_label(parse_tree__prog_mode__rename_apart_inst_vars_in_inst_3_0,155)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(4);
	MR_sv(4) = (MR_Word) MR_succip;
	{
...
MR_def_label(parse_tree__prog_mode__rename_apart_inst_vars_in_inst_3_0,14)
	...
	MR_tfield(0, MR_tempr1, 1) = (MR_Word) MR_LABEL_AP(parse_tree__prog_mode__rename_apart_inst_vars_in_inst_3_0_i138);
	MR_tfield(0, MR_tempr1, 2) = (MR_Integer) 1;
	MR_tfield(0, MR_tempr1, 3) = MR_r1;
	MR_sv(1) = MR_tfield(3, MR_r2, 1);
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(parse_tree__prog_data, mer_inst);
...
MR_def_label(parse_tree__prog_mode__rename_apart_inst_vars_in_inst_3_0,15)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_RTAGS_TESTR(MR_r2,3,0)) {
		MR_GOTO_LAB(parse_tree__prog_mode__rename_apart_inst_vars_in_inst_3_0_i19);
	}
	MR_incr_sp(4);
	MR_sv(4) = (MR_Word) MR_succip;
	{
...
MR_def_label(parse_tree__prog_mode__rename_apart_inst_vars_in_inst_3_0,19)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_RTAGS_TESTR(MR_r2,3,3)) {
		MR_GOTO_LAB(parse_tree__prog_mode__rename_apart_inst_vars_in_inst_3_0_i23);
	}
	MR_incr_sp(4);
	MR_sv(4) = (MR_Word) MR_succip;
	MR_sv(1) = MR_r1;
...
MR_def_label(parse_tree__prog_mode__rename_apart_inst_vars_in_inst_3_0,23)
	...
	MR_np_call_localret_ent(parse_tree__prog_mode__rename_apart_inst_vars_in_inst_name_3_0,
		parse_tree__prog_mode__rename_apart_inst_vars_in_inst_3_0_i32);
MR_def_label(parse_tree__prog_mode__rename_apart_inst_vars_in_inst_3_0,32)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(parse_tree__prog_mode__rename_apart_inst_vars_in_inst_3_0_i30);
	}
	MR_tag_alloc_heap(MR_r1, 3, (MR_Integer) 2);
	MR_tfield(3, MR_r1, 0) = (MR_Integer) 4;
	MR_tfield(3, MR_r1, 1) = MR_r2;
	MR_decr_sp_and_return(4);
MR_def_label(parse_tree__prog_mode__rename_apart_inst_vars_in_inst_3_0,30)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_sv(1);
	MR_r1 = MR_r2;
	MR_decr_sp_and_return(4);
MR_def_label(parse_tree__prog_mode__rename_apart_inst_vars_in_inst_3_0,29)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_RTAGS_TESTR(MR_r2,3,1)) {
		MR_GOTO_LAB(parse_tree__prog_mode__rename_apart_inst_vars_in_inst_3_0_i162);
	}
	MR_r5 = MR_tfield(3, MR_r2, 2);
	if (MR_LTAGS_TESTR(MR_r5,0,0)) {
		MR_GOTO_LAB(parse_tree__prog_mode__rename_apart_inst_vars_in_inst_3_0_i163);
	}
	...
	MR_proceed();
MR_def_label(parse_tree__prog_mode__rename_apart_inst_vars_in_inst_3_0,163)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(4);
	MR_sv(4) = (MR_Word) MR_succip;
	{
	...
	MR_np_call_localret_ent(list__map_3_0,
		parse_tree__prog_mode__rename_apart_inst_vars_in_inst_3_0_i41);
MR_def_label(parse_tree__prog_mode__rename_apart_inst_vars_in_inst_3_0,41)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tag_alloc_heap(MR_tempr1, 0, (MR_Integer) 3);
...
MR_def_label(parse_tree__prog_mode__rename_apart_inst_vars_in_inst_3_0,162)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(4);
	MR_sv(4) = (MR_Word) MR_succip;
	MR_sv(1) = MR_r2;
