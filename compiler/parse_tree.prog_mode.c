...
static void MR_CALL 
parse_tree__prog_mode__IntroducedFrom__pred__report_inconsistent_constrained_inst_vars__1142__1_3_p_0(
...
{
  {
    ...
    {
      parse_tree__prog_mode__IntroducedFrom__pred__report_inconsistent_constrained_inst_vars__1142__1_3_p_0(((MR_Word) (MR_hl_field(MR_mktag(0), parse_tree__prog_mode__closure, (MR_Integer) 3))), ((MR_Word) parse_tree__prog_mode__wrapper_arg_1), &parse_tree__prog_mode__conv0_HeadVar__3_50);
    }
