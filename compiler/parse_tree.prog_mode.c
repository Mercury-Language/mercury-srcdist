...
static /* final */ const MR_Box parse_tree__prog_mode_scalar_common_2[21][3];
...
{
  {
    ...
    {
      mercury__list__foldl2_6_p_0((MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_inst_0, (MR_Word) &parse_tree__prog_mode_scalar_common_1[1], (MR_Word) &parse_tree__prog_mode_scalar_common_2[0], (MR_Word) &parse_tree__prog_mode_scalar_common_2[20], parse_tree__prog_mode__ArgInsts_10, ((MR_Box) (parse_tree__prog_mode__STATE_VARIABLE_InconsistentVars_0_11)), &parse_tree__prog_mode__conv3_STATE_VARIABLE_InconsistentVars_12, ((MR_Box) (parse_tree__prog_mode__STATE_VARIABLE_Sub_0_13)), &parse_tree__prog_mode__conv2_STATE_VARIABLE_Sub_14);
    }
...
{
  {
    ...
    {
      mercury__list__foldl2_6_p_0((MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_inst_0, (MR_Word) &parse_tree__prog_mode_scalar_common_1[1], (MR_Word) &parse_tree__prog_mode_scalar_common_2[0], (MR_Word) &parse_tree__prog_mode_scalar_common_2[17], parse_tree__prog_mode__Insts_6, ((MR_Box) (parse_tree__prog_mode__STATE_VARIABLE_InconsistentVars_0_9)), &parse_tree__prog_mode__conv3_STATE_VARIABLE_InconsistentVars_10, ((MR_Box) (parse_tree__prog_mode__STATE_VARIABLE_Sub_0_11)), &parse_tree__prog_mode__conv2_STATE_VARIABLE_Sub_12);
    }
...
{
  {
    ...
    if (((MR_tag((MR_Word) parse_tree__prog_mode__Mode_6)) == (MR_mktag((MR_Integer) 0))))
    ...
    else
      {
        ...
        {
          parse_tree__prog_mode__gather_inconsistent_constrained_inst_vars_in_insts_5_p_0(parse_tree__prog_mode__ArgInsts_12, parse_tree__prog_mode__STATE_VARIABLE_InconsistentVars_0_13, parse_tree__prog_mode__STATE_VARIABLE_InconsistentVars_14, parse_tree__prog_mode__STATE_VARIABLE_Sub_0_15, parse_tree__prog_mode__STATE_VARIABLE_Sub_16);
        }
      }
  }
}
    ...
    if (((MR_tag((MR_Word) parse_tree__prog_mode__TypeAndMode_6)) == (MR_mktag((MR_Integer) 1))))
      {
        ...
        if (((MR_tag((MR_Word) parse_tree__prog_mode__Mode_11)) == (MR_mktag((MR_Integer) 0))))
        ...
        else
          {
            ...
            {
              parse_tree__prog_mode__gather_inconsistent_constrained_inst_vars_in_insts_5_p_0(parse_tree__prog_mode__ArgInsts_28, parse_tree__prog_mode__STATE_VARIABLE_InconsistentVars_0_12, parse_tree__prog_mode__STATE_VARIABLE_InconsistentVars_13, parse_tree__prog_mode__STATE_VARIABLE_Sub_0_14, parse_tree__prog_mode__STATE_VARIABLE_Sub_15);
            }
          }
      }
    else
...
{
  {
...

    {
      ...
      MR_hl_field(MR_mktag(0), parse_tree__prog_mode__V_12_12, 0) = ((MR_Box) (&parse_tree__prog_mode_scalar_common_3[7]));
                      ...
                      *parse_tree__prog_mode__Inst_6 = parse_tree__prog_mode__Inst0_5;
                    else
                      {
...

                        {
                          ...
                          MR_hl_field(MR_mktag(0), parse_tree__prog_mode__V_43_43, 0) = ((MR_Box) (&parse_tree__prog_mode_scalar_common_3[6]));
    ...
    if ((parse_tree__prog_mode__HOInstInfo0_3 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
      *parse_tree__prog_mode__HOInstInfo_4 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
    else
      {
        ...
        {
          mercury__list__map_3_p_0(parse_tree__prog_mode__TypeCtorInfo_8_17, parse_tree__prog_mode__TypeCtorInfo_8_17, (MR_Word) &parse_tree__prog_mode_scalar_common_2[15], parse_tree__prog_mode__Modes0_7, &parse_tree__prog_mode__Modes_10);
        }
        {
...
{
  {
    ...
    {
      mercury__list__map_3_p_0(parse_tree__prog_mode__TypeCtorInfo_8_8, parse_tree__prog_mode__TypeCtorInfo_8_8, (MR_Word) &parse_tree__prog_mode_scalar_common_2[12], parse_tree__prog_mode__Insts0_3, parse_tree__prog_mode__Insts_4);
    }
  }
}
...
{
  {
    ...
    if (((MR_tag((MR_Word) parse_tree__prog_mode__Mode0_3)) == (MR_mktag((MR_Integer) 0))))
    ...
    else
      {
        ...
        {
          mercury__list__map_3_p_0(parse_tree__prog_mode__TypeCtorInfo_8_18, parse_tree__prog_mode__TypeCtorInfo_8_18, (MR_Word) &parse_tree__prog_mode_scalar_common_2[11], parse_tree__prog_mode__Insts0_10, &parse_tree__prog_mode__Insts_11);
        }
        {
...
{
  {
    ...
    {
      mercury__list__foldl2_6_p_0((MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_type_and_mode_0, (MR_Word) &parse_tree__prog_mode_scalar_common_1[1], (MR_Word) &parse_tree__prog_mode_scalar_common_2[0], (MR_Word) &parse_tree__prog_mode_scalar_common_2[10], parse_tree__prog_mode__TypeAndModes_3, ((MR_Box) (parse_tree__prog_mode__V_8_8)), &parse_tree__prog_mode__conv3_InconsistentVarsSet_5, ((MR_Box) (parse_tree__prog_mode__V_9_9)), &parse_tree__prog_mode__conv2_V_6_6);
    }
...
{
  {
    ...
    {
      mercury__list__foldl2_6_p_0((MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_mode_0, (MR_Word) &parse_tree__prog_mode_scalar_common_1[1], (MR_Word) &parse_tree__prog_mode_scalar_common_2[0], (MR_Word) &parse_tree__prog_mode_scalar_common_2[9], parse_tree__prog_mode__Modes_3, ((MR_Box) (parse_tree__prog_mode__V_8_8)), &parse_tree__prog_mode__conv3_InconsistentVarsSet_5, ((MR_Box) (parse_tree__prog_mode__V_9_9)), &parse_tree__prog_mode__conv2_V_6_6);
    }
    parse_tree__prog_mode__InconsistentVarsSet_5 = ((MR_Word) parse_tree__prog_mode__conv3_InconsistentVarsSet_5);
    parse_tree__prog_mode__V_6_6 = ((MR_Word) parse_tree__prog_mode__conv2_V_6_6);
    {
