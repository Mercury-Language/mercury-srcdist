...
MR_decl_label8(transform_hlds__term_constr_pass2__collapse_cycle_2_7_0, 22,3,5,6,7,8,10,11)
MR_decl_label4(transform_hlds__term_constr_pass2__collapse_cycle_2_7_0, 12,14,15,16)
...
MR_decl_label8(transform_hlds__term_constr_pass2__find_edges_in_goal_13_0, 118,43,130,46,47,49,50,52)
MR_decl_label8(transform_hlds__term_constr_pass2__find_edges_in_goal_13_0, 53,56,57,34,132,39,129,5)
MR_decl_label8(transform_hlds__term_constr_pass2__find_edges_in_goal_13_0, 6,8,9,10,11,16,14,18)
MR_decl_label8(transform_hlds__term_constr_pass2__find_edges_in_goal_13_0, 20,22,19,24,25,26,27,28)
MR_decl_label7(transform_hlds__term_constr_pass2__find_edges_in_goal_13_0, 29,13,31,59,134,62,128)
...
MR_decl_label8(transform_hlds__term_constr_pass2__prove_termination_in_scc_6_0, 27,3,5,7,10,12,15,17)
MR_decl_label4(transform_hlds__term_constr_pass2__prove_termination_in_scc_6_0, 18,19,20,21)
MR_decl_label5(transform_hlds__term_constr_pass2__search_for_cycles_3_7_0, 3,2,11,14,9)
MR_decl_label8(transform_hlds__term_constr_pass2__strict_decrease_around_loop_4_0, 8,11,4,2,14,15,18,20)
MR_decl_label8(transform_hlds__term_constr_pass2__strict_decrease_around_loop_4_0, 22,23,25,26,27,28,29,30)
MR_decl_label2(transform_hlds__term_constr_pass2__strict_decrease_around_loop_4_0, 31,32)
...
MR_BEGIN_MODULE(transform_hlds__term_constr_pass2_module7)
	...
	MR_init_label8(transform_hlds__term_constr_pass2__strict_decrease_around_loop_4_0,8,11,4,2,14,15,18,20)
	MR_init_label8(transform_hlds__term_constr_pass2__strict_decrease_around_loop_4_0,22,23,25,26,27,28,29,30)
	MR_init_label2(transform_hlds__term_constr_pass2__strict_decrease_around_loop_4_0,31,32)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(transform_hlds__term_constr_pass2_module10)
	...
	MR_init_label8(transform_hlds__term_constr_pass2__prove_termination_in_scc_6_0,27,3,5,7,10,12,15,17)
	MR_init_label4(transform_hlds__term_constr_pass2__prove_termination_in_scc_6_0,18,19,20,21)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(transform_hlds__term_constr_pass2_module11)
	...
	MR_init_label8(transform_hlds__term_constr_pass2__find_edges_in_goal_13_0,118,43,130,46,47,49,50,52)
	MR_init_label8(transform_hlds__term_constr_pass2__find_edges_in_goal_13_0,53,56,57,34,132,39,129,5)
	MR_init_label8(transform_hlds__term_constr_pass2__find_edges_in_goal_13_0,6,8,9,10,11,16,14,18)
	MR_init_label8(transform_hlds__term_constr_pass2__find_edges_in_goal_13_0,20,22,19,24,25,26,27,28)
	MR_init_label7(transform_hlds__term_constr_pass2__find_edges_in_goal_13_0,29,13,31,59,134,62,128)
MR_BEGIN_CODE
...
MR_def_label(transform_hlds__term_constr_pass2__find_edges_in_goal_13_0,52)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(1) = MR_ctfield(0, MR_sv(1), 7);
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_sv(6);
	MR_sv(6) = MR_r1;
...
MR_def_label(transform_hlds__term_constr_pass2__find_edges_in_goal_13_0,132)
	...
	MR_sv(1) = MR_tempr6;
	MR_tempr7 = MR_r5;
	MR_sv(2) = MR_ctfield(1, MR_tempr7, 1);
...
MR_def_label(transform_hlds__term_constr_pass2__find_edges_in_goal_13_0,129)
	...
	MR_tempr3 = MR_r5;
	MR_tfield(0, MR_tempr1, 1) = MR_ctfield(2, MR_tempr3, 0);
	MR_tfield(0, MR_tempr1, 2) = MR_ctfield(0, MR_tempr2, 3);
	MR_tfield(0, MR_tempr1, 3) = MR_ctfield(2, MR_tempr3, 2);
	MR_tfield(0, MR_tempr1, 4) = MR_ctfield(0, MR_tempr2, 8);
	MR_tempr4 = MR_r7;
...
MR_def_label(transform_hlds__term_constr_pass2__find_edges_in_goal_13_0,5)
	...
	MR_r5 = MR_tempr1;
	MR_tempr2 = MR_ctfield(0, MR_sv(1), 10);
...
MR_def_label(transform_hlds__term_constr_pass2__find_edges_in_goal_13_0,18)
	...
	MR_r4 = MR_sv(4);
	MR_r3 = MR_ctfield(0, MR_ctfield(1, MR_r1, 0), 3);
	MR_r1 = (MR_Word) MR_TAG_COMMON(0,0,6);
...
MR_BEGIN_MODULE(transform_hlds__term_constr_pass2_module17)
	...
	MR_init_label8(transform_hlds__term_constr_pass2__collapse_cycle_2_7_0,22,3,5,6,7,8,10,11)
	MR_init_label4(transform_hlds__term_constr_pass2__collapse_cycle_2_7_0,12,14,15,16)
MR_BEGIN_CODE
