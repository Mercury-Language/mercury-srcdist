  ...
  MR_Word HeadVar__3_3)
{
  while (MR_TRUE)
  {
    ...
    if (!((HeadVar__3_3 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))))))
    {
      ...
      {
        MR_Word next_value_of_HeadVar__3_3 = Cycles_14;
  ...
  MR_Word HeadVar__2_2)
{
  while (MR_TRUE)
  {
    ...
    if (!((HeadVar__2_2 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))))))
    {
      ...
      /* direct tailcall eliminated */
      {
        MR_Word next_value_of_HeadVar__2_2 = Procs_11;
  ...
  MR_Word * STATE_VARIABLE_Polyhedron_7)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      /* direct tailcall eliminated */
      {
        MR_Word next_value_of_HeadVar__1_1 = Edges_18;
        MR_Word next_value_of_STATE_VARIABLE_Zeros_0_2 = STATE_VARIABLE_Zeros_36_36;
        MR_Word next_value_of_STATE_VARIABLE_CallVars_0_4 = STATE_VARIABLE_CallVars_38_38;
        MR_Word next_value_of_STATE_VARIABLE_Polyhedron_0_6 = STATE_VARIABLE_Polyhedron_43_43;
    ...
    while (MR_TRUE)
    {
      ...
      else
      {
        ...
        if ((env).transform_hlds__term_constr_pass2__total_sum_decrease_3_p_0_env_0__succeeded)
        {
          /* direct tailcall eliminated */
          {
            MR_Word next_value_of_HeadVar__3_3 = CycleSets_9;
