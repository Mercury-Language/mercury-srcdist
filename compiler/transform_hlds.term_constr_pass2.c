...
{
  {
    ...
    transform_hlds__term_constr_pass2__find_edges_in_goal_13_p_0(LambdaHeadVar__1_15, AbstractSCC_5, ModuleInfo_6, MaxMatrixSize_7, Var_20, (MR_Integer) 1, &Var_11, Var_22, &Var_12, (MR_Word) ((MR_Integer) 0), &ProcEdges_13, (MR_Integer) 1, &Var_14);
...
{
  {
    ...
    if ((Edges0_8 == (MR_Word) ((MR_Integer) 0)))
    {
    ...
    else
    {
      ...
      if ((Var_32 == (MR_Word) ((MR_Integer) 0)))
...
{
  {
    ...
    if (succeeded)
    {
      ...
      Var_8 = (MR_Word) ((MR_Integer) 0);
      Var_10 = (MR_Word) ((MR_Integer) 0);
      {
            ...
            case (MR_Integer) 1:
              {
                ...
                transform_hlds__term_constr_pass2__find_edges_in_disj_14_p_0(Proc_14, AbstractSCC_15, ModuleInfo_16, MaxMatrixSize_17, Var_89, Goals_23, STATE_VARIABLE_Calls_0_60, STATE_VARIABLE_Calls_61, (MR_Word) ((MR_Integer) 0), &DisjConstrs0_27, (MR_Word) ((MR_Integer) 0), &Edges1_28, STATE_VARIABLE_Continue_0_66, STATE_VARIABLE_Continue_67);
                {
              ...
              case (MR_Integer) 1:
                {
                  ...
                  if ((MaybeArgSizeInfo_46 == (MR_Word) ((MR_Integer) 0)))
                  {
                    {
                  ...
                  else
                  {
                    ...
                    else
                    {
                      ...
                      if ((MaybeCallProc_48 == (MR_Word) ((MR_Integer) 0)))
                      {
                        {
...
{
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        mercury__set__foldl_4_p_0((MR_Word) (&transform_hlds__term_constr_data__transform_hlds__term_constr_data__type_ctor_info_abstract_proc_0), (MR_Word) (&transform_hlds__term_constr_pass2_scalar_common_1[0]), FindEdges_31, AbstractSCC_9, ((MR_Box) ((MR_Integer) 0)), &conv2_Edges_14);
        ...
        else
        {
          ...
          Var_87 = mercury__term__context_init_0_f_0();
          {
            ...
            MR_hl_field(MR_mktag(0), Error_85, 1) = ((MR_Box) ((MR_Integer) 4));
          }
          {
...
{
  {
    ...
    while (MR_TRUE)
    {
      ...
      else
      {
        ...
        if (((env).transform_hlds__term_constr_pass2__total_sum_decrease_3_p_0_env_0__Loops_11 == (MR_Word) ((MR_Integer) 0)))
          (env).transform_hlds__term_constr_pass2__total_sum_decrease_3_p_0_env_0__succeeded = MR_TRUE;
        else
        {
...
{
  {
    ...
    else
    {
      ...
      if ((PEdges_12 == (MR_Word) ((MR_Integer) 0)))
...
{
  {
    ...
    else
    {
      ...
      InitialEdges_18 = ((MR_Word) (conv0_InitialEdges_18));
      {
        ...
        MR_hl_field(MR_mktag(0), Var_19, 6) = ((MR_Box) ((MR_Integer) 0));
      }
      mercury__list__foldl_4_p_0((MR_Word) (&transform_hlds__term_constr_pass2__transform_hlds__term_constr_pass2__type_ctor_info_edge_0), (MR_Word) (&transform_hlds__term_constr_pass2_scalar_common_1[2]), Var_19, InitialEdges_18, ((MR_Box) ((MR_Integer) 0)), &conv2_HeadCycles_9);
