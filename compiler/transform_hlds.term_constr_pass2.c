  ...
  MR_Word HeadVar__2_2)
{
  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        TypeInfo__19_19 = (MR_Word) (&transform_hlds__term_constr_pass2_scalar_common_1[4]);
        succeeded = mercury__builtin__unify_2_p_0(TypeInfo__19_19, ((MR_Box) (ArgX3_7)), ((MR_Box) (ArgY3_8)));
        if (succeeded)
        {
          TypeInfo__20_20 = (MR_Word) (&transform_hlds__term_constr_pass2_scalar_common_1[4]);
          succeeded = mercury__builtin__unify_2_p_0(TypeInfo__20_20, ((MR_Box) (ArgX4_9)), ((MR_Box) (ArgY4_10)));
          if (succeeded)
          {
            TypeInfo__21_21 = (MR_Word) (&transform_hlds__term_constr_pass2_scalar_common_1[5]);
  ...
  MR_Word HeadVar__2_2)
{
  ...
  else
  {
    ...
    if (succeeded)
    {
      TypeInfo__10_10 = (MR_Word) (&transform_hlds__term_constr_pass2_scalar_common_1[0]);
  ...
  MR_Word Edge_10)
{
  ...
  MR_String Var_36;
  MR_Word Var_38;
  MR_Word Var_42 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Edge_10, (MR_Integer) 1))));

  PredProcId_12 = (MR_Word) (Var_16);
  CallPredProcId_13 = (MR_Word) (Var_42);
          ...
          case (MR_Integer) 1:
            {
              ...
              transform_hlds__term_constr_pass2__find_edges_in_disj_14_p_0(Proc_14, AbstractSCC_15, ModuleInfo_16, MaxMatrixSize_17, Var_89, Goals_23, STATE_VARIABLE_Calls_0_60, STATE_VARIABLE_Calls_61, (MR_Word) ((MR_Unsigned) 0U), &DisjConstrs0_27, (MR_Word) ((MR_Unsigned) 0U), &Edges1_28, STATE_VARIABLE_Continue_0_66, STATE_VARIABLE_Continue_67);
              {
                ...
                MR_hl_field(MR_mktag(0), Var_94, 0) = ((MR_Box) (&transform_hlds__term_constr_pass2_scalar_common_6[3]));
                ...
                case (MR_Integer) 1:
                  {
                    ...
                    libs__polyhedron__project_polyhedron_4_p_0(Var_87, Locals_101, STATE_VARIABLE_Polyhedron_84_84, STATE_VARIABLE_Polyhedron_63);
                  }
                  break;
              }
            }
