...
#line 60 "transform_hlds.term_constr_pass2.c"
#line 61 "transform_hlds.term_constr_pass2.c"

#endif
#line 64 "transform_hlds.term_constr_pass2.c"
...
MR_decl_label4(__Compare___transform_hlds__term_constr_pass2__cycle_0_0, 3,2,5,21)
MR_decl_label4(__Compare___transform_hlds__term_constr_pass2__cycle_set_0_0, 3,2,5,21)
MR_decl_label8(__Compare___transform_hlds__term_constr_pass2__edge_0_0, 3,2,5,9,13,17,21,53)
...
MR_BEGIN_MODULE(transform_hlds__term_constr_pass2_module25)
	...
	MR_init_label4(__Compare___transform_hlds__term_constr_pass2__cycle_0_0,3,2,5,21)
MR_BEGIN_CODE
...
MR_def_label(__Compare___transform_hlds__term_constr_pass2__cycle_0_0,5)
	...
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___transform_hlds__term_constr_pass2__cycle_0_0_i21);
	}
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(transform_hlds__term_constr_pass2, edge);
	MR_r2 = MR_sv(1);
	MR_r3 = MR_sv(2);
...
MR_def_label(__Compare___transform_hlds__term_constr_pass2__cycle_0_0,21)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(3);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
...
MR_BEGIN_MODULE(transform_hlds__term_constr_pass2_module27)
	...
	MR_init_label4(__Compare___transform_hlds__term_constr_pass2__cycle_set_0_0,3,2,5,21)
MR_BEGIN_CODE
...
MR_def_label(__Compare___transform_hlds__term_constr_pass2__cycle_set_0_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___transform_hlds__term_constr_pass2__cycle_set_0_0_i21);
	}
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(transform_hlds__term_constr_pass2, edge);
	MR_r2 = MR_sv(1);
	MR_r3 = MR_sv(2);
	...
	MR_decr_sp(3);
	MR_np_tailcall_ent(__Compare___list__list_1_0);
MR_def_label(__Compare___transform_hlds__term_constr_pass2__cycle_set_0_0,21)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(3);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
...
MR_BEGIN_MODULE(transform_hlds__term_constr_pass2_module31)
	...
	MR_init_label8(__Compare___transform_hlds__term_constr_pass2__edge_0_0,3,2,5,9,13,17,21,53)
MR_BEGIN_CODE
...
MR_def_label(__Compare___transform_hlds__term_constr_pass2__edge_0_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___transform_hlds__term_constr_pass2__edge_0_0_i53);
	}
	MR_r1 = (MR_Word) MR_TAG_COMMON(0,1,6);
	MR_r2 = MR_sv(1);
	MR_r3 = MR_sv(6);
...
MR_def_label(__Compare___transform_hlds__term_constr_pass2__edge_0_0,21)
	...
	MR_decr_sp(11);
	MR_np_tailcall_ent(__Compare___list__list_1_0);
MR_def_label(__Compare___transform_hlds__term_constr_pass2__edge_0_0,53)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(11);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
...
void mercury__transform_hlds__term_constr_pass2__write_out_proc_statics(FILE *deep_fp, FILE *procrep_fp)
{
	MR_write_out_module_proc_reps_start(procrep_fp, &mercury_data__module_common_layout__transform_hlds__term_constr_pass2);
