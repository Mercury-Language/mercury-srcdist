...
{
  {
    ...
    {
      libs__globals__lookup_bool_option_3_p_0(ll_backend__coverage_profiling__Globals_58, (MR_Integer) 206, &ll_backend__coverage_profiling__Static_59);
    }
    ...
    {
      libs__globals__lookup_bool_option_3_p_0(ll_backend__coverage_profiling__Globals_58, (MR_Integer) 205, &ll_backend__coverage_profiling__UseCalls_61);
    }
    {
      libs__globals__lookup_bool_option_3_p_0(ll_backend__coverage_profiling__Globals_58, (MR_Integer) 207, &ll_backend__coverage_profiling__CoverageAfterGoal_62);
    }
    {
      libs__globals__lookup_bool_option_3_p_0(ll_backend__coverage_profiling__Globals_58, (MR_Integer) 208, &ll_backend__coverage_profiling__BranchIf_63);
    }
    {
      libs__globals__lookup_bool_option_3_p_0(ll_backend__coverage_profiling__Globals_58, (MR_Integer) 209, &ll_backend__coverage_profiling__BranchSwitch_64);
    }
    {
      libs__globals__lookup_bool_option_3_p_0(ll_backend__coverage_profiling__Globals_58, (MR_Integer) 210, &ll_backend__coverage_profiling__BranchDisj_65);
    }
    {
      libs__globals__lookup_bool_option_3_p_0(ll_backend__coverage_profiling__Globals_58, (MR_Integer) 211, &ll_backend__coverage_profiling__UsePortCounts_66);
    }
    {
      libs__globals__lookup_bool_option_3_p_0(ll_backend__coverage_profiling__Globals_58, (MR_Integer) 212, &ll_backend__coverage_profiling__UseTrivial_67);
    }
    {
