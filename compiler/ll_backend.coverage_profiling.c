...
MR_decl_label10(__Compare___ll_backend__coverage_profiling__proc_coverage_info_0_0, 3,2,5,9,13,17,21,25,29,93)
...
MR_BEGIN_MODULE(ll_backend__coverage_profiling_module29)
	...
	MR_init_label10(__Compare___ll_backend__coverage_profiling__proc_coverage_info_0_0,3,2,5,9,13,17,21,25,29,93)
MR_BEGIN_CODE
...
MR_def_label(__Compare___ll_backend__coverage_profiling__proc_coverage_info_0_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___ll_backend__coverage_profiling__proc_coverage_info_0_0_i93);
	}
	MR_r1 = MR_sv(1);
	MR_r2 = MR_sv(8);
...
MR_def_label(__Compare___ll_backend__coverage_profiling__proc_coverage_info_0_0,93)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(15);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
