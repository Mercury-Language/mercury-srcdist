...
static const MR_FA_TypeInfo_Struct1 ll_backend__coverage_profiling__maybe__ti_maybe_1hlds__proc_info_types__type_ctor_info_deep_recursion_info_0;
...
static const MR_PseudoTypeInfo ll_backend__coverage_profiling__ll_backend__coverage_profiling__field_types_proc_coverage_info_0_0[8] = {
  ...
  (MR_PseudoTypeInfo) (&ll_backend__coverage_profiling__maybe__ti_maybe_1hlds__proc_info_types__type_ctor_info_deep_recursion_info_0),
      ...
      case (MR_Integer) 1:
        {
          ...
          hlds__goal_list_util__create_conj_from_list_3_p_0(Goals_100, (MR_Integer) 0, &Then_50);
  ...
  MR_Word * HeadVar__9_9)
{
  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      hlds__goal_list_util__create_conj_from_list_3_p_0(Goals_79, (MR_Integer) 0, &HeadDisjunct_23);
      ...
      case (MR_Integer) 1:
        {
          ...
          *NextCoverageBeforeKnown_11 = (MR_Integer) 0;
          ...
          hlds__goal_list_util__create_conj_from_list_3_p_0(Var_109, (MR_Integer) 0, Goal_9);
  ...
  MR_Word * STATE_VARIABLE_Info_18)
{
  ...
  hlds__goal_list_util__create_conj_from_list_3_p_0(Goals_14, (MR_Integer) 0, STATE_VARIABLE_Goal_16);
}
  ...
  MR_Word * ProcStaticConsId_4)
{
  ...
  if (succeeded)
  {
    ...
    if (succeeded)
      OuterPredProcId_12 = ((MR_Word) ((MR_hl_field(0, Var_13, 0))));
  }
  if (succeeded)
  {
  ...
  ShroudedPredProcId_7 = hlds__pred_proc_id__shroud_pred_proc_id_1_f_0(Var_8);
  {
    MR_Word base;
