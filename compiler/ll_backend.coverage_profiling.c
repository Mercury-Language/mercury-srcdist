    ...
    else
    {
      ...
      else
      {
        ...
        else
        {
          ...
          mercury__private_builtin__builtin_compare_int_3_p_0(&SubResult3_12, Var_45, Var_46);
          succeeded = (SubResult3_12 != (MR_Integer) 0);
          if (succeeded)
            *HeadVar__1_1 = SubResult3_12;
          else
          {
            ...
            mercury__private_builtin__builtin_compare_int_3_p_0(&SubResult4_15, Var_47, Var_48);
            succeeded = (SubResult4_15 != (MR_Integer) 0);
            if (succeeded)
              *HeadVar__1_1 = SubResult4_15;
            else
            {
              ...
              mercury__private_builtin__builtin_compare_int_3_p_0(&SubResult5_18, Var_49, Var_50);
              succeeded = (SubResult5_18 != (MR_Integer) 0);
              if (succeeded)
                *HeadVar__1_1 = SubResult5_18;
              else
              {
                ...
                mercury__private_builtin__builtin_compare_int_3_p_0(&SubResult6_21, Var_51, Var_52);
                succeeded = (SubResult6_21 != (MR_Integer) 0);
                if (succeeded)
                  *HeadVar__1_1 = SubResult6_21;
                else
                {
                  ...
                  mercury__private_builtin__builtin_compare_int_3_p_0(&SubResult7_24, Var_53, Var_54);
                  succeeded = (SubResult7_24 != (MR_Integer) 0);
                  if (succeeded)
                    *HeadVar__1_1 = SubResult7_24;
                  else
                  {
                    ...
                    mercury__private_builtin__builtin_compare_int_3_p_0(&SubResult8_27, Var_55, Var_56);
