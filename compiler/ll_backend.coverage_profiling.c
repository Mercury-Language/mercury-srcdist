...
{
  {
    ...
    if ((MaybeDPInfo0_77 == (MR_Word) ((MR_Integer) 0)))
    {
      {
...
{
  {
    ...
    else
    {
      ...
      if ((Cases0_25 == (MR_Word) ((MR_Integer) 0)))
...
{
  {
    ...
    if ((MaybeDPInfo_5 == (MR_Word) ((MR_Integer) 0)))
    {
      ...
      case (MR_Integer) 1:
        {
          ...
          PredName_26 = (MR_String) "increment_dynamic_coverage_point_count";
          {
            ...
            MR_hl_field(MR_mktag(1), ArgVars_27, 1) = ((MR_Box) ((MR_Integer) 0));
          }
      ...
      case (MR_Integer) 0:
        {
          ...
          ll_backend__coverage_profiling__coverage_point_ll_code_3_p_0(DataType_24, &ForeignCallAttrs_32, &ForeignProc_33);
          {
            ...
            MR_hl_field(MR_mktag(3), CallGoalExpr_34, 5) = ((MR_Box) ((MR_Integer) 0));
            MR_hl_field(MR_mktag(3), CallGoalExpr_34, 6) = ((MR_Box) ((MR_Integer) 0));
          ...
          InstMapDelta_36 = hlds__instmap__instmap_delta_from_assoc_list_1_f_0((MR_Word) ((MR_Integer) 0));
