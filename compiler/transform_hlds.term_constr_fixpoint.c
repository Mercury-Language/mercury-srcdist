  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      else
      {
        ...
        MR_Word Var_83 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_23, (MR_Integer) 0))));
        MR_Word Var_84 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_23, (MR_Integer) 1))));
        MR_Word Var_85 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_23, (MR_Integer) 2))));
        MR_Word Var_86 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_23, (MR_Integer) 4))));
        MR_Word Var_87 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_23, (MR_Integer) 5))));
        ...
        {
          STATE_VARIABLE_Acc_21_41 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), STATE_VARIABLE_Acc_21_41, 0) = ((MR_Box) (Var_42));
          MR_hl_field(MR_mktag(1), STATE_VARIABLE_Acc_21_41, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
        }
...
{
  {
    ...
    MR_Word STATE_VARIABLE_Polyhedron_64_64;
    MR_Word Var_68 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Proc_10, (MR_Integer) 1))));
    MR_Word Var_69 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Proc_10, (MR_Integer) 2))));
    MR_Word Var_71 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Proc_10, (MR_Integer) 4))));
    MR_Word Var_72 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Proc_10, (MR_Integer) 5))));
    MR_Word Var_73 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Proc_10, (MR_Integer) 6))));
    MR_Word Var_76 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Proc_10, (MR_Integer) 9))));
    MR_Integer Var_77 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), Proc_10, (MR_Integer) 10))));
    MR_Word Var_78 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Proc_10, (MR_Integer) 11))));
    MR_Word Var_112;
    MR_Word Var_113;
    MR_Word Var_114;
    MR_Word Var_115;
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_19, (MR_Integer) 83, &DebugTerm_20);
    switch (DebugTerm_20) {
      ...
      case (MR_Integer) 1:
        {
          ...
          mercury__io__write_string_3_p_0((MR_String) "\nIteration ");
          mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&transform_hlds__term_constr_fixpoint_scalar_common_8[0]), Iteration_7, &Var_139);
    ...
    Var_112 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Proc_10, (MR_Integer) 0))));
    Var_113 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Proc_10, (MR_Integer) 1))));
    Var_114 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Proc_10, (MR_Integer) 2))));
    Var_115 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Proc_10, (MR_Integer) 3))));
    Var_116 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Proc_10, (MR_Integer) 4))));
    Var_51 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Proc_10, (MR_Integer) 5))));
    Var_117 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Proc_10, (MR_Integer) 6))));
    Var_118 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Proc_10, (MR_Integer) 7))));
    Var_119 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Proc_10, (MR_Integer) 8))));
    Var_120 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Proc_10, (MR_Integer) 9))));
    Var_121 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), Proc_10, (MR_Integer) 10))));
    Var_122 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Proc_10, (MR_Integer) 11))));
    ...
    HeadVarSet_26 = mercury__set__from_list_1_f_0((MR_Word) (&transform_hlds__term_constr_fixpoint_scalar_common_1[1]), HeadVars_18);
    BadVarsSet_27 = mercury__set__difference_2_f_0((MR_Word) (&transform_hlds__term_constr_fixpoint_scalar_common_1[1]), ConstrVarsSet_25, HeadVarSet_26);
    BadVars_28 = mercury__set__to_sorted_list_1_f_0((MR_Word) (&transform_hlds__term_constr_fixpoint_scalar_common_1[1]), BadVarsSet_27);
    ...
    if (succeeded)
    {
      ...
      STATE_VARIABLE_Polyhedron_64_64 = STATE_VARIABLE_Polyhedron_56_56;
    }
    else
    {
      MR_Word Var_63 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Proc_10, (MR_Integer) 9))));
      MR_Word Var_123 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Proc_10, (MR_Integer) 0))));
      MR_Word Var_124 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Proc_10, (MR_Integer) 1))));
      MR_Word Var_125 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Proc_10, (MR_Integer) 2))));
      MR_Word Var_126 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Proc_10, (MR_Integer) 3))));
      MR_Word Var_127 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Proc_10, (MR_Integer) 4))));
      MR_Word Var_128 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Proc_10, (MR_Integer) 5))));
      MR_Word Var_129 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Proc_10, (MR_Integer) 6))));
      MR_Word Var_130 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Proc_10, (MR_Integer) 7))));
      MR_Word Var_131 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Proc_10, (MR_Integer) 8))));
      MR_Integer Var_132 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), Proc_10, (MR_Integer) 10))));
      MR_Word Var_133 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Proc_10, (MR_Integer) 11))));
      ...
      else
      {
        ...
        if (succeeded)
        {
          ...
          transform_hlds__term_constr_fixpoint__test_fixpoint_and_perhaps_widen_7_p_0(WideningInfo_12, SizeVarSet_16, Iteration_7, OldPolyhedron_30, STATE_VARIABLE_Polyhedron_56_56, &STATE_VARIABLE_Polyhedron_64_64, &ChangeFlag_32);
      }
    }
    {
      ...
      MR_hl_field(MR_mktag(0), ThisIterationInfo_33, 1) = ((MR_Box) (STATE_VARIABLE_Polyhedron_64_64));
        ...
        case (MR_Integer) 1:
          {
            ...
            Var_34 = (MR_Integer) ((MR_Unsigned) Iteration_9 + (MR_Unsigned) (MR_Integer) 1);
