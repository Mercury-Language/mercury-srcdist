    ...
    else
    {
      ...
      else
      {
        ...
        libs__polyhedron__convex_union_5_p_0(Var_24, Var_70, Var_22, Y_35, &Var_42);
        {
          ...
          MR_hl_field(MR_mktag(1), STATE_VARIABLE_Acc_21_41, 1) = ((MR_Box) ((MR_Integer) 0));
        }
...
{
  {
    ...
    if ((ArgSizeInfo_29 == (MR_Word) ((MR_Integer) 0)))
      ...
      case (MR_Integer) 2:
        {
          ...
          if ((CallArgSizeInfo_25 == (MR_Word) ((MR_Integer) 0)))
...
{
  {
...

    {
      ...
      *HeadVar__4_4 = (MR_Word) ((MR_Integer) 0);
      ...
      mercury__set__foldl_4_p_0((MR_Word) (&transform_hlds__term_constr_data__transform_hlds__term_constr_data__type_ctor_info_abstract_proc_0), (MR_Word) (&transform_hlds__term_constr_fixpoint_scalar_common_1[0]), Var_22, AbstractSCC_11, ((MR_Box) ((MR_Integer) 0)), &conv1_IterationInfos_12);
