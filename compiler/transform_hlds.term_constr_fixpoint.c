...
MR_decl_label10(transform_hlds__term_constr_fixpoint__term_iterate_over_abstract_proc_6_0, 33,36,35,34,39,42,41,46,37,49)
MR_decl_label3(transform_hlds__term_constr_fixpoint__term_iterate_over_abstract_proc_6_0, 55,53,59)
...
MR_BEGIN_MODULE(transform_hlds__term_constr_fixpoint_module10)
	...
	MR_init_label10(transform_hlds__term_constr_fixpoint__term_iterate_over_abstract_proc_6_0,33,36,35,34,39,42,41,46,37,49)
	MR_init_label3(transform_hlds__term_constr_fixpoint__term_iterate_over_abstract_proc_6_0,55,53,59)
MR_BEGIN_CODE
...
MR_def_label(transform_hlds__term_constr_fixpoint__term_iterate_over_abstract_proc_6_0,41)
	...
	MR_np_call_localret_ent(fn__transform_hlds__term_constr_fixpoint__this_file_0_0,
		transform_hlds__term_constr_fixpoint__term_iterate_over_abstract_proc_6_0_i46);
MR_def_label(transform_hlds__term_constr_fixpoint__term_iterate_over_abstract_proc_6_0,46)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_def_label(transform_hlds__term_constr_fixpoint__term_iterate_over_abstract_proc_6_0,37)
	...
	if (MR_INT_NE(MR_r2,0)) {
		MR_GOTO_LAB(transform_hlds__term_constr_fixpoint__term_iterate_over_abstract_proc_6_0_i49);
	}
	MR_tag_alloc_heap(MR_r2, 0, (MR_Integer) 3);
	MR_tfield(0, MR_r2, 0) = MR_sv(6);
	...
	MR_tfield(1, MR_r1, 1) = MR_sv(11);
	MR_decr_sp_and_return(13);
MR_def_label(transform_hlds__term_constr_fixpoint__term_iterate_over_abstract_proc_6_0,49)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(5) = MR_r1;
	MR_r1 = MR_sv(2);
	MR_np_call_localret_ent(libs__polyhedron__is_empty_1_0,
		transform_hlds__term_constr_fixpoint__term_iterate_over_abstract_proc_6_0_i55);
MR_def_label(transform_hlds__term_constr_fixpoint__term_iterate_over_abstract_proc_6_0,55)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(transform_hlds__term_constr_fixpoint__term_iterate_over_abstract_proc_6_0_i53);
	}
	MR_tag_alloc_heap(MR_r2, 0, (MR_Integer) 3);
	MR_tfield(0, MR_r2, 0) = MR_sv(6);
	MR_tfield(0, MR_r2, 1) = MR_sv(5);
...
MR_def_label(transform_hlds__term_constr_fixpoint__term_iterate_over_abstract_proc_6_0,53)
	...
	MR_np_call_localret_ent(transform_hlds__term_constr_fixpoint__test_fixpoint_and_perhaps_widen_7_0,
		transform_hlds__term_constr_fixpoint__term_iterate_over_abstract_proc_6_0_i59);
MR_def_label(transform_hlds__term_constr_fixpoint__term_iterate_over_abstract_proc_6_0,59)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
