...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_19, (MR_Integer) 95, &DebugTerm_20);
    switch (DebugTerm_20) {
      ...
      case (MR_Integer) 1:
        {
...

          {
            ...
            MR_hl_field(MR_mktag(0), Var_40, 0) = ((MR_Box) (&transform_hlds__term_constr_fixpoint_scalar_common_8[0]));
          ...
          else
          {
            ...
            libs__polyhedron__project_polyhedron_4_p_0(Var_86, Locals_45, Polyhedron0_46, &GoalPolyhedron_85);
          }
