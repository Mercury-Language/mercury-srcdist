...
{
  {
    ...
    {
      libs__globals__lookup_bool_option_3_p_0(transform_hlds__term_constr_fixpoint__Globals_19, (MR_Integer) 78, &transform_hlds__term_constr_fixpoint__DebugTerm_20);
    }
