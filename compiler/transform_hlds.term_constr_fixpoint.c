...
MR_decl_label10(transform_hlds__term_constr_fixpoint__do_fixpoint_calculation_6_0, 2,4,5,12,13,11,15,17,9,21)
MR_decl_label3(transform_hlds__term_constr_fixpoint__do_fixpoint_calculation_6_0, 7,24,25)
...
MR_decl_label10(transform_hlds__term_constr_fixpoint__term_iterate_over_abstract_proc_6_0, 22,23,24,25,26,28,29,30,31,27)
MR_decl_label10(transform_hlds__term_constr_fixpoint__term_iterate_over_abstract_proc_6_0, 32,35,34,33,38,41,40,36,47,53)
MR_decl_label2(transform_hlds__term_constr_fixpoint__term_iterate_over_abstract_proc_6_0, 51,57)
...
MR_decl_label8(__Compare___transform_hlds__term_constr_fixpoint__fixpoint_info_0_0, 3,2,5,9,13,17,21,71)
...
MR_BEGIN_MODULE(transform_hlds__term_constr_fixpoint_module1)
	...
	MR_init_label10(transform_hlds__term_constr_fixpoint__do_fixpoint_calculation_6_0,2,4,5,12,13,11,15,17,9,21)
	MR_init_label3(transform_hlds__term_constr_fixpoint__do_fixpoint_calculation_6_0,7,24,25)
MR_BEGIN_CODE
...
MR_def_label(transform_hlds__term_constr_fixpoint__do_fixpoint_calculation_6_0,2)
	...
	MR_np_call_localret_ent(list__foldl_4_0,
		transform_hlds__term_constr_fixpoint__do_fixpoint_calculation_6_0_i4);
MR_def_label(transform_hlds__term_constr_fixpoint__do_fixpoint_calculation_6_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(3) = MR_r1;
...
MR_def_label(transform_hlds__term_constr_fixpoint__do_fixpoint_calculation_6_0,5)
	...
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(transform_hlds__term_constr_fixpoint__do_fixpoint_calculation_6_0_i7);
	}
	MR_sv(6) = (MR_Word) MR_redoip_slot(MR_maxfr);
	MR_sv(7) = (MR_Word) MR_redofr_slot(MR_maxfr);
	MR_save_maxfr(MR_sv(8));
	MR_redofr_slot_word(MR_maxfr) = (MR_Word) MR_curfr;
	MR_redoip_slot_word(MR_maxfr) = (MR_Word) MR_LABEL_AP(transform_hlds__term_constr_fixpoint__do_fixpoint_calculation_6_0_i11);
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(transform_hlds__term_constr_fixpoint, iteration_info);
	MR_r2 = MR_sv(3);
	MR_np_call_localret_ent(list__member_2_1,
		transform_hlds__term_constr_fixpoint__do_fixpoint_calculation_6_0_i12);
...
MR_def_label(transform_hlds__term_constr_fixpoint__do_fixpoint_calculation_6_0,13)
	...
	MR_GOTO_LAB(transform_hlds__term_constr_fixpoint__do_fixpoint_calculation_6_0_i15);
MR_def_label(transform_hlds__term_constr_fixpoint__do_fixpoint_calculation_6_0,11)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_redoip_slot_word(MR_maxfr) = MR_sv(6);
	MR_redofr_slot_word(MR_maxfr) = MR_sv(7);
	MR_GOTO_LAB(transform_hlds__term_constr_fixpoint__do_fixpoint_calculation_6_0_i9);
MR_def_label(transform_hlds__term_constr_fixpoint__do_fixpoint_calculation_6_0,15)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(5) = (MR_Word) MR_CTOR0_ADDR(transform_hlds__term_constr_fixpoint, iteration_info);
	MR_r1 = MR_sv(5);
	MR_r2 = MR_r1;
	MR_r3 = (MR_Word) MR_TAG_COMMON(0,3,0);
	MR_r4 = MR_sv(3);
	MR_np_call_localret_ent(fn__list__map_2_0,
		transform_hlds__term_constr_fixpoint__do_fixpoint_calculation_6_0_i17);
MR_def_label(transform_hlds__term_constr_fixpoint__do_fixpoint_calculation_6_0,17)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
	...
	MR_np_call_localret_ent(list__foldl_4_0,
		transform_hlds__term_constr_fixpoint__do_fixpoint_calculation_6_0_i21);
MR_def_label(transform_hlds__term_constr_fixpoint__do_fixpoint_calculation_6_0,9)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(transform_hlds__term_constr_fixpoint, iteration_info);
	MR_r2 = (MR_Word) MR_CTOR0_ADDR(hlds__hlds_module, module_info);
	...
	MR_np_call_localret_ent(list__foldl_4_0,
		transform_hlds__term_constr_fixpoint__do_fixpoint_calculation_6_0_i21);
MR_def_label(transform_hlds__term_constr_fixpoint__do_fixpoint_calculation_6_0,21)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
...
MR_def_label(transform_hlds__term_constr_fixpoint__do_fixpoint_calculation_6_0,7)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(transform_hlds__term_constr_fixpoint, iteration_info);
	MR_r2 = (MR_Word) MR_CTOR0_ADDR(hlds__hlds_module, module_info);
	...
	MR_r5 = MR_sv(4);
	MR_np_call_localret_ent(list__foldl_4_0,
		transform_hlds__term_constr_fixpoint__do_fixpoint_calculation_6_0_i24);
MR_def_label(transform_hlds__term_constr_fixpoint__do_fixpoint_calculation_6_0,24)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
...
MR_BEGIN_MODULE(transform_hlds__term_constr_fixpoint_module9)
	...
	MR_init_label10(transform_hlds__term_constr_fixpoint__term_iterate_over_abstract_proc_6_0,22,23,24,25,26,28,29,30,31,27)
	MR_init_label10(transform_hlds__term_constr_fixpoint__term_iterate_over_abstract_proc_6_0,32,35,34,33,38,41,40,36,47,53)
	MR_init_label2(transform_hlds__term_constr_fixpoint__term_iterate_over_abstract_proc_6_0,51,57)
MR_BEGIN_CODE
...
MR_def_label(transform_hlds__term_constr_fixpoint__term_iterate_over_abstract_proc_6_0,26)
	...
	MR_r1 = MR_sv(8);
	MR_r2 = MR_sv(4);
	MR_GOTO_LAB(transform_hlds__term_constr_fixpoint__term_iterate_over_abstract_proc_6_0_i27);
...
MR_def_label(transform_hlds__term_constr_fixpoint__term_iterate_over_abstract_proc_6_0,32)
	...
	MR_np_call_localret_ent(fn__libs__polyhedron__empty_0_0,
		transform_hlds__term_constr_fixpoint__term_iterate_over_abstract_proc_6_0_i35);
...
MR_def_label(transform_hlds__term_constr_fixpoint__term_iterate_over_abstract_proc_6_0,33)
	...
	MR_sv(11) = MR_r1;
	MR_np_call_localret_ent(libs__polyhedron__is_empty_1_0,
		transform_hlds__term_constr_fixpoint__term_iterate_over_abstract_proc_6_0_i38);
MR_def_label(transform_hlds__term_constr_fixpoint__term_iterate_over_abstract_proc_6_0,38)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(transform_hlds__term_constr_fixpoint__term_iterate_over_abstract_proc_6_0_i36);
	}
	MR_r1 = MR_sv(8);
	MR_np_call_localret_ent(libs__polyhedron__is_empty_1_0,
		transform_hlds__term_constr_fixpoint__term_iterate_over_abstract_proc_6_0_i41);
MR_def_label(transform_hlds__term_constr_fixpoint__term_iterate_over_abstract_proc_6_0,41)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(transform_hlds__term_constr_fixpoint__term_iterate_over_abstract_proc_6_0_i40);
	}
...
MR_BEGIN_MODULE(transform_hlds__term_constr_fixpoint_module12)
	...
	MR_init_label8(__Compare___transform_hlds__term_constr_fixpoint__fixpoint_info_0_0,3,2,5,9,13,17,21,71)
MR_BEGIN_CODE
...
MR_def_label(__Compare___transform_hlds__term_constr_fixpoint__fixpoint_info_0_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___transform_hlds__term_constr_fixpoint__fixpoint_info_0_0_i71);
	}
	MR_r1 = (MR_Word) MR_TAG_COMMON(0,0,2);
	MR_r2 = MR_sv(1);
	MR_r3 = MR_sv(6);
...
MR_def_label(__Compare___transform_hlds__term_constr_fixpoint__fixpoint_info_0_0,71)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(11);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
...
void mercury__transform_hlds__term_constr_fixpoint__write_out_proc_statics(FILE *deep_fp, FILE *procrep_fp)
{
	MR_write_out_module_proc_reps_start(procrep_fp, &mercury_data__module_layout__transform_hlds__term_constr_fixpoint);
