      ...
      case (MR_Integer) 1:
        {
          ...
          mercury__io__write_string_4_p_0(DebugStream_70, (MR_String) "\nIteration ");
          mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&transform_hlds__term_constr_fixpoint_scalar_common_8[0]), Iteration_9, &Var_149);
