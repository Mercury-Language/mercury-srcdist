    ...
    /* tailcall optimized into a loop */
    {
      ...
      else
      {
        ...
        else
        {
          ...
          {
            MR_Word next_value_of_HeadVar__2_2 = X0_18;
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      else
      {
        ...
        /* direct tailcall eliminated */
        {
          MR_Word next_value_of_HeadVar__2_2 = Rest_16;
          MR_Word next_value_of_HeadVar__3_3 = STATE_VARIABLE_Acc_21_21;
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_19, (MR_Integer) 80, &DebugTerm_20);
    switch (DebugTerm_20) {
