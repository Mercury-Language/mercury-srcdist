...
MR_decl_label8(transform_hlds__term_constr_fixpoint__do_fixpoint_calculation_8_0, 2,3,4,7,8,5,13,14)
MR_decl_label5(transform_hlds__term_constr_fixpoint__do_fixpoint_calculation_8_0, 12,16,17,10,19)
...
MR_decl_label2(transform_hlds__term_constr_fixpoint__traverse_abstract_disj_linearly_5_0, 2,3)
MR_decl_label3(transform_hlds__term_constr_fixpoint__traverse_abstract_disj_linearly_2_5_0, 2,3,4)
MR_decl_label8(transform_hlds__term_constr_fixpoint__traverse_abstract_goal_4_0, 72,79,5,80,9,10,81,13)
MR_decl_label8(transform_hlds__term_constr_fixpoint__traverse_abstract_goal_4_0, 14,15,17,21,19,28,30,31)
MR_decl_label8(transform_hlds__term_constr_fixpoint__traverse_abstract_goal_4_0, 32,33,34,37,35,40,25,45)
MR_decl_label8(transform_hlds__term_constr_fixpoint__traverse_abstract_proc_8_0, 2,3,4,5,6,7,8,9)
MR_decl_label8(transform_hlds__term_constr_fixpoint__traverse_abstract_proc_8_0, 10,11,12,13,14,15,16,17)
MR_decl_label8(transform_hlds__term_constr_fixpoint__traverse_abstract_proc_8_0, 18,19,20,21,24,23,22,27)
MR_decl_label8(transform_hlds__term_constr_fixpoint__traverse_abstract_proc_8_0, 31,30,33,25,36,40,38,42)
MR_decl_label1(transform_hlds__term_constr_fixpoint__traverse_abstract_proc_8_0, 45)
MR_decl_label1(fn__transform_hlds__term_constr_fixpoint__IntroducedFrom__func__do_fixpoint_calculation__132__1_1_0, 2)
MR_decl_label2(fn__transform_hlds__term_constr_fixpoint__or_flags_1_0, 4,3)
MR_decl_label5(__Unify___transform_hlds__term_constr_fixpoint__fixpoint_info_0_0, 2,4,6,8,1)
MR_decl_label1(__Unify___transform_hlds__term_constr_fixpoint__fixpoint_options_0_0, 1)
MR_decl_label3(__Unify___transform_hlds__term_constr_fixpoint__iteration_info_0_0, 2,4,1)
MR_decl_label6(__Compare___transform_hlds__term_constr_fixpoint__fixpoint_info_0_0, 3,7,11,15,19,27)
MR_decl_label2(__Compare___transform_hlds__term_constr_fixpoint__fixpoint_options_0_0, 3,7)
MR_decl_label3(__Compare___transform_hlds__term_constr_fixpoint__iteration_info_0_0, 3,7,12)
...
MR_decl_static(transform_hlds__term_constr_fixpoint__IntroducedFrom__pred__traverse_abstract_proc__173__1_3_0)
...
"transform_hlds.term_constr_fixpoint",
"transform_hlds.term_constr_fixpoint",
"lambda_term_constr_fixpoint_m_173",
3,
0
},
"transform_hlds.term_constr_fixpoint",
...
MR_BEGIN_MODULE(transform_hlds__term_constr_fixpoint_module0)
	...
	MR_init_label2(fn__transform_hlds__term_constr_fixpoint__or_flags_1_0,4,3)
MR_BEGIN_CODE
...
MR_def_static(fn__transform_hlds__term_constr_fixpoint__or_flags_1_0)
	...
	if (MR_LTAGS_TEST(MR_r1,0,0)) {
		MR_GOTO_LAB(fn__transform_hlds__term_constr_fixpoint__or_flags_1_0_i3);
	}
	MR_incr_sp(2);
...
MR_def_label(fn__transform_hlds__term_constr_fixpoint__or_flags_1_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Integer) 0;
	MR_proceed();
#ifdef MR_maybe_local_thread_engine_base
...
MR_BEGIN_MODULE(transform_hlds__term_constr_fixpoint_module1)
	...
	MR_init_label8(transform_hlds__term_constr_fixpoint__do_fixpoint_calculation_8_0,2,3,4,7,8,5,13,14)
	MR_init_label5(transform_hlds__term_constr_fixpoint__do_fixpoint_calculation_8_0,12,16,17,10,19)
MR_BEGIN_CODE
...
MR_def_label(transform_hlds__term_constr_fixpoint__do_fixpoint_calculation_8_0,2)
	...
	MR_np_call_localret_ent(list__foldl2_6_5,
		transform_hlds__term_constr_fixpoint__do_fixpoint_calculation_8_0_i3);
MR_def_label(transform_hlds__term_constr_fixpoint__do_fixpoint_calculation_8_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(4) = MR_r1;
	MR_np_call_localret_ent(fn__transform_hlds__term_constr_fixpoint__or_flags_1_0,
		transform_hlds__term_constr_fixpoint__do_fixpoint_calculation_8_0_i4);
MR_def_label(transform_hlds__term_constr_fixpoint__do_fixpoint_calculation_8_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,1)) {
		MR_GOTO_LAB(transform_hlds__term_constr_fixpoint__do_fixpoint_calculation_8_0_i5);
	}
	...
	MR_np_call_localret_ent(list__foldl_4_1,
		transform_hlds__term_constr_fixpoint__do_fixpoint_calculation_8_0_i7);
MR_def_label(transform_hlds__term_constr_fixpoint__do_fixpoint_calculation_8_0,7)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r4 = MR_r1;
	MR_r1 = MR_sv(1);
	MR_r2 = MR_sv(2);
	...
	MR_np_localcall_lab(transform_hlds__term_constr_fixpoint__do_fixpoint_calculation_8_0,
		transform_hlds__term_constr_fixpoint__do_fixpoint_calculation_8_0_i8);
...
MR_def_label(transform_hlds__term_constr_fixpoint__do_fixpoint_calculation_8_0,16)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(transform_hlds__term_constr_fixpoint, iteration_info);
	MR_r2 = (MR_Word) MR_CTOR0_ADDR(transform_hlds__term_constr_fixpoint, iteration_info);
	MR_r3 = (MR_Word) MR_TAG_COMMON(0,3,1);
	MR_r4 = MR_sv(4);
	MR_np_call_localret_ent(fn__list__map_2_0,
		transform_hlds__term_constr_fixpoint__do_fixpoint_calculation_8_0_i17);
MR_def_label(transform_hlds__term_constr_fixpoint__do_fixpoint_calculation_8_0,17)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r4 = MR_r1;
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(transform_hlds__term_constr_fixpoint, iteration_info);
	MR_r2 = (MR_Word) MR_CTOR0_ADDR(hlds__hlds_module, module_info);
	...
	MR_r5 = MR_sv(5);
	MR_np_call_localret_ent(list__foldl_4_1,
		transform_hlds__term_constr_fixpoint__do_fixpoint_calculation_8_0_i19);
MR_def_label(transform_hlds__term_constr_fixpoint__do_fixpoint_calculation_8_0,10)
	...
	MR_np_call_localret_ent(list__foldl_4_1,
		transform_hlds__term_constr_fixpoint__do_fixpoint_calculation_8_0_i19);
MR_def_label(transform_hlds__term_constr_fixpoint__do_fixpoint_calculation_8_0,19)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_r1;
	MR_r1 = (MR_Word) MR_tbmkword(0, 0);
	MR_decr_sp_and_return(9);
...
MR_BEGIN_MODULE(transform_hlds__term_constr_fixpoint_module6)
	...
	MR_init_label2(transform_hlds__term_constr_fixpoint__traverse_abstract_disj_linearly_5_0,2,3)
MR_BEGIN_CODE
...
MR_def_static(transform_hlds__term_constr_fixpoint__traverse_abstract_disj_linearly_5_0)
	...
	MR_np_call_localret_ent(fn__libs__polyhedron__empty_0_0,
		transform_hlds__term_constr_fixpoint__traverse_abstract_disj_linearly_5_0_i2);
MR_def_label(transform_hlds__term_constr_fixpoint__traverse_abstract_disj_linearly_5_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r5 = MR_r1;
...
MR_BEGIN_MODULE(transform_hlds__term_constr_fixpoint_module7)
	...
	MR_init_label8(transform_hlds__term_constr_fixpoint__traverse_abstract_goal_4_0,72,79,5,80,9,10,81,13)
	MR_init_label8(transform_hlds__term_constr_fixpoint__traverse_abstract_goal_4_0,14,15,17,21,19,28,30,31)
	MR_init_label8(transform_hlds__term_constr_fixpoint__traverse_abstract_goal_4_0,32,33,34,37,35,40,25,45)
MR_BEGIN_CODE
...
MR_def_static(transform_hlds__term_constr_fixpoint__traverse_abstract_goal_4_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
MR_def_label(transform_hlds__term_constr_fixpoint__traverse_abstract_goal_4_0,72)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_COMPUTED_GOTO((MR_Unsigned) MR_tag(MR_r2),
		MR_LABEL_AP(transform_hlds__term_constr_fixpoint__traverse_abstract_goal_4_0_i79) MR_AND
		MR_LABEL_AP(transform_hlds__term_constr_fixpoint__traverse_abstract_goal_4_0_i80) MR_AND
		MR_LABEL_AP(transform_hlds__term_constr_fixpoint__traverse_abstract_goal_4_0_i81) MR_AND
		MR_LABEL_AP(transform_hlds__term_constr_fixpoint__traverse_abstract_goal_4_0_i45));
MR_def_label(transform_hlds__term_constr_fixpoint__traverse_abstract_goal_4_0,79)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(9);
	MR_sv(9) = (MR_Word) MR_succip;
	MR_sv(1) = MR_r1;
...
MR_def_label(transform_hlds__term_constr_fixpoint__traverse_abstract_goal_4_0,5)
	...
	MR_np_call_localret_ent(transform_hlds__term_constr_fixpoint__traverse_abstract_disj_linearly_5_0,
		transform_hlds__term_constr_fixpoint__traverse_abstract_goal_4_0_i10);
MR_def_label(transform_hlds__term_constr_fixpoint__traverse_abstract_goal_4_0,80)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(9);
	MR_sv(9) = (MR_Word) MR_succip;
	{
	...
	MR_tfield(0, MR_tempr1, 1) = (MR_Word) MR_LABEL_AP(transform_hlds__term_constr_fixpoint__traverse_abstract_goal_4_0_i72);
	...
	MR_np_call_localret_ent(fn__libs__polyhedron__universe_0_0,
		transform_hlds__term_constr_fixpoint__traverse_abstract_goal_4_0_i9);
MR_def_label(transform_hlds__term_constr_fixpoint__traverse_abstract_goal_4_0,9)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r5 = MR_r1;
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(transform_hlds__term_constr_data, abstract_goal);
	MR_r2 = (MR_Word) MR_CTOR0_ADDR(libs__polyhedron, polyhedron);
...
MR_def_label(transform_hlds__term_constr_fixpoint__traverse_abstract_goal_4_0,81)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(9);
	MR_sv(9) = (MR_Word) MR_succip;
	MR_sv(1) = MR_r1;
	...
	MR_np_call_localret_ent(hlds__hlds_module__module_info_pred_proc_info_4_0,
		transform_hlds__term_constr_fixpoint__traverse_abstract_goal_4_0_i13);
MR_def_label(transform_hlds__term_constr_fixpoint__traverse_abstract_goal_4_0,13)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_r2;
	MR_np_call_localret_ent(hlds__hlds_pred__proc_info_get_termination2_info_2_0,
		transform_hlds__term_constr_fixpoint__traverse_abstract_goal_4_0_i14);
MR_def_label(transform_hlds__term_constr_fixpoint__traverse_abstract_goal_4_0,14)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(7) = MR_r1;
	MR_np_call_localret_ent(fn__transform_hlds__term_constr_main__success_constrs_1_0,
		transform_hlds__term_constr_fixpoint__traverse_abstract_goal_4_0_i15);
MR_def_label(transform_hlds__term_constr_fixpoint__traverse_abstract_goal_4_0,15)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
		MR_GOTO_LAB(transform_hlds__term_constr_fixpoint__traverse_abstract_goal_4_0_i17);
	}
	MR_succip_word = MR_sv(9);
	MR_decr_sp(9);
...
MR_def_label(transform_hlds__term_constr_fixpoint__traverse_abstract_goal_4_0,21)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(transform_hlds__term_constr_fixpoint__traverse_abstract_goal_4_0_i19);
	}
	MR_succip_word = MR_sv(9);
	MR_decr_sp(9);
	MR_np_tailcall_ent(fn__libs__polyhedron__empty_0_0);
MR_def_label(transform_hlds__term_constr_fixpoint__traverse_abstract_goal_4_0,19)
	...
	MR_np_call_localret_ent(libs__polyhedron__is_universe_1_0,
		transform_hlds__term_constr_fixpoint__traverse_abstract_goal_4_0_i28);
MR_def_label(transform_hlds__term_constr_fixpoint__traverse_abstract_goal_4_0,28)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_r1) {
		MR_GOTO_LAB(transform_hlds__term_constr_fixpoint__traverse_abstract_goal_4_0_i25);
	}
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_sv(8);
	...
	MR_np_call_localret_ent(fn__transform_hlds__term_constr_main__head_vars_1_0,
		transform_hlds__term_constr_fixpoint__traverse_abstract_goal_4_0_i30);
MR_def_label(transform_hlds__term_constr_fixpoint__traverse_abstract_goal_4_0,30)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_r1;
	MR_r1 = MR_sv(3);
	MR_np_call_localret_ent(fn__transform_hlds__term_constr_util__create_var_substitution_2_0,
		transform_hlds__term_constr_fixpoint__traverse_abstract_goal_4_0_i31);
MR_def_label(transform_hlds__term_constr_fixpoint__traverse_abstract_goal_4_0,31)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_sv(8);
	MR_np_call_localret_ent(fn__libs__polyhedron__substitute_vars_2_0,
		transform_hlds__term_constr_fixpoint__traverse_abstract_goal_4_0_i32);
MR_def_label(transform_hlds__term_constr_fixpoint__traverse_abstract_goal_4_0,32)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_sv(6);
	MR_np_call_localret_ent(fn__libs__polyhedron__intersection_2_0,
		transform_hlds__term_constr_fixpoint__traverse_abstract_goal_4_0_i33);
MR_def_label(transform_hlds__term_constr_fixpoint__traverse_abstract_goal_4_0,33)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_r1;
	MR_r1 = MR_sv(4);
	MR_np_call_localret_ent(fn__libs__polyhedron__zero_vars_2_0,
		transform_hlds__term_constr_fixpoint__traverse_abstract_goal_4_0_i34);
MR_def_label(transform_hlds__term_constr_fixpoint__traverse_abstract_goal_4_0,34)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(3) = MR_r1;
	MR_np_call_localret_ent(libs__polyhedron__is_empty_1_0,
...
MR_def_label(transform_hlds__term_constr_fixpoint__traverse_abstract_goal_4_0,37)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(transform_hlds__term_constr_fixpoint__traverse_abstract_goal_4_0_i35);
	}
	MR_np_call_localret_ent(fn__libs__polyhedron__empty_0_0,
		transform_hlds__term_constr_fixpoint__traverse_abstract_goal_4_0_i40);
MR_def_label(transform_hlds__term_constr_fixpoint__traverse_abstract_goal_4_0,35)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(3);
	MR_r3 = MR_r1;
	MR_r1 = MR_sv(5);
...
MR_def_label(transform_hlds__term_constr_fixpoint__traverse_abstract_goal_4_0,40)
	...
	MR_decr_sp(9);
	MR_np_tailcall_ent(libs__polyhedron__intersection_3_0);
MR_def_label(transform_hlds__term_constr_fixpoint__traverse_abstract_goal_4_0,25)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(2);
	MR_decr_sp_and_return(9);
MR_def_label(transform_hlds__term_constr_fixpoint__traverse_abstract_goal_4_0,45)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r2;
...
MR_BEGIN_MODULE(transform_hlds__term_constr_fixpoint_module10)
	...
	MR_init_label8(transform_hlds__term_constr_fixpoint__traverse_abstract_proc_8_0,2,3,4,5,6,7,8,9)
	MR_init_label8(transform_hlds__term_constr_fixpoint__traverse_abstract_proc_8_0,10,11,12,13,14,15,16,17)
	MR_init_label8(transform_hlds__term_constr_fixpoint__traverse_abstract_proc_8_0,18,19,20,21,24,23,22,27)
	MR_init_label8(transform_hlds__term_constr_fixpoint__traverse_abstract_proc_8_0,31,30,33,25,36,40,38,42)
	MR_init_label1(transform_hlds__term_constr_fixpoint__traverse_abstract_proc_8_0,45)
MR_BEGIN_CODE
...
MR_def_static(transform_hlds__term_constr_fixpoint__traverse_abstract_proc_8_0)
	...
	MR_tfield(0, MR_tempr1, 1) = (MR_Word) MR_ENTRY_AP(transform_hlds__term_constr_fixpoint__IntroducedFrom__pred__traverse_abstract_proc__173__1_3_0);
	MR_tfield(0, MR_tempr1, 2) = (MR_Integer) 1;
	MR_tempr2 = MR_r4;
	...
	MR_np_call_localret_ent(transform_hlds__term_constr_util__maybe_write_trace_3_0,
		transform_hlds__term_constr_fixpoint__traverse_abstract_proc_8_0_i2);
MR_def_label(transform_hlds__term_constr_fixpoint__traverse_abstract_proc_8_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_def_label(transform_hlds__term_constr_fixpoint__traverse_abstract_proc_8_0,3)
	...
	MR_np_call_localret_ent(transform_hlds__term_constr_util__maybe_write_trace_3_0,
		transform_hlds__term_constr_fixpoint__traverse_abstract_proc_8_0_i4);
MR_def_label(transform_hlds__term_constr_fixpoint__traverse_abstract_proc_8_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_def_label(transform_hlds__term_constr_fixpoint__traverse_abstract_proc_8_0,5)
	...
	MR_np_call_localret_ent(transform_hlds__term_constr_util__maybe_write_trace_3_0,
		transform_hlds__term_constr_fixpoint__traverse_abstract_proc_8_0_i6);
MR_def_label(transform_hlds__term_constr_fixpoint__traverse_abstract_proc_8_0,6)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2, MR_tempr3;
...
MR_def_label(transform_hlds__term_constr_fixpoint__traverse_abstract_proc_8_0,7)
	...
	MR_np_call_localret_ent(fn__transform_hlds__term_constr_fixpoint__init_fixpoint_info_6_0,
		transform_hlds__term_constr_fixpoint__traverse_abstract_proc_8_0_i8);
MR_def_label(transform_hlds__term_constr_fixpoint__traverse_abstract_proc_8_0,8)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(5) = MR_r1;
	MR_sv(8) = MR_ctfield(0, MR_sv(3), 7);
	MR_np_call_localret_ent(fn__libs__polyhedron__universe_0_0,
...
MR_def_label(transform_hlds__term_constr_fixpoint__traverse_abstract_proc_8_0,9)
	...
	MR_np_call_localret_ent(transform_hlds__term_constr_fixpoint__traverse_abstract_goal_4_0,
		transform_hlds__term_constr_fixpoint__traverse_abstract_proc_8_0_i10);
MR_def_label(transform_hlds__term_constr_fixpoint__traverse_abstract_proc_8_0,10)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_r1;
	MR_r1 = MR_sv(7);
...
MR_def_label(transform_hlds__term_constr_fixpoint__traverse_abstract_proc_8_0,11)
	...
	MR_np_call_localret_ent(fn__libs__polyhedron__constraints_1_0,
		transform_hlds__term_constr_fixpoint__traverse_abstract_proc_8_0_i12);
MR_def_label(transform_hlds__term_constr_fixpoint__traverse_abstract_proc_8_0,12)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_np_call_localret_ent(fn__libs__lp_rational__get_vars_from_constraints_1_0,
		transform_hlds__term_constr_fixpoint__traverse_abstract_proc_8_0_i13);
MR_def_label(transform_hlds__term_constr_fixpoint__traverse_abstract_proc_8_0,13)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(5) = MR_r1;
	MR_r2 = MR_sv(9);
	...
	MR_np_call_localret_ent(fn__set__from_list_1_0,
		transform_hlds__term_constr_fixpoint__traverse_abstract_proc_8_0_i14);
MR_def_label(transform_hlds__term_constr_fixpoint__traverse_abstract_proc_8_0,14)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r4 = MR_r1;
	MR_r1 = MR_sv(9);
	MR_r2 = MR_sv(11);
...
MR_def_label(transform_hlds__term_constr_fixpoint__traverse_abstract_proc_8_0,21)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
		MR_GOTO_LAB(transform_hlds__term_constr_fixpoint__traverse_abstract_proc_8_0_i23);
	}
	MR_np_call_localret_ent(fn__libs__polyhedron__empty_0_0,
...
MR_def_label(transform_hlds__term_constr_fixpoint__traverse_abstract_proc_8_0,24)
	...
	MR_sv(2) = MR_r1;
	MR_r1 = MR_sv(5);
	MR_GOTO_LAB(transform_hlds__term_constr_fixpoint__traverse_abstract_proc_8_0_i22);
MR_def_label(transform_hlds__term_constr_fixpoint__traverse_abstract_proc_8_0,23)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(2) = MR_ctfield(1, MR_r1, 0);
	MR_r1 = MR_sv(5);
MR_def_label(transform_hlds__term_constr_fixpoint__traverse_abstract_proc_8_0,22)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(5) = MR_r1;
	MR_np_call_localret_ent(libs__polyhedron__is_empty_1_0,
...
MR_def_label(transform_hlds__term_constr_fixpoint__traverse_abstract_proc_8_0,27)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(transform_hlds__term_constr_fixpoint__traverse_abstract_proc_8_0_i25);
	}
	MR_r1 = MR_sv(2);
	MR_np_call_localret_ent(libs__polyhedron__is_empty_1_0,
...
MR_def_label(transform_hlds__term_constr_fixpoint__traverse_abstract_proc_8_0,31)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(transform_hlds__term_constr_fixpoint__traverse_abstract_proc_8_0_i30);
	}
	{
	MR_Word MR_tempr1;
...
MR_def_label(transform_hlds__term_constr_fixpoint__traverse_abstract_proc_8_0,30)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_np_call_localret_ent(fn__transform_hlds__term_constr_fixpoint__this_file_0_0,
		transform_hlds__term_constr_fixpoint__traverse_abstract_proc_8_0_i33);
...
MR_def_label(transform_hlds__term_constr_fixpoint__traverse_abstract_proc_8_0,36)
	...
	MR_r1 = MR_sv(2);
	MR_np_call_localret_ent(libs__polyhedron__is_empty_1_0,
		transform_hlds__term_constr_fixpoint__traverse_abstract_proc_8_0_i40);
MR_def_label(transform_hlds__term_constr_fixpoint__traverse_abstract_proc_8_0,40)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(transform_hlds__term_constr_fixpoint__traverse_abstract_proc_8_0_i38);
	}
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 0, (MR_Integer) 3);
...
MR_BEGIN_MODULE(transform_hlds__term_constr_fixpoint_module12)
	...
	MR_init_label5(__Unify___transform_hlds__term_constr_fixpoint__fixpoint_info_0_0,2,4,6,8,1)
MR_BEGIN_CODE
...
MR_def_static(__Unify___transform_hlds__term_constr_fixpoint__fixpoint_info_0_0)
	...
	MR_np_call_localret_ent(__Unify___hlds__hlds_module__module_info_0_0,
		__Unify___transform_hlds__term_constr_fixpoint__fixpoint_info_0_0_i2);
MR_def_label(__Unify___transform_hlds__term_constr_fixpoint__fixpoint_info_0_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
...
MR_BEGIN_MODULE(transform_hlds__term_constr_fixpoint_module13)
	...
	MR_init_label6(__Compare___transform_hlds__term_constr_fixpoint__fixpoint_info_0_0,3,7,11,15,19,27)
MR_BEGIN_CODE
...
MR_def_static(__Compare___transform_hlds__term_constr_fixpoint__fixpoint_info_0_0)
	...
	MR_np_call_localret_ent(__Compare___hlds__hlds_module__module_info_0_0,
		__Compare___transform_hlds__term_constr_fixpoint__fixpoint_info_0_0_i3);
MR_def_label(__Compare___transform_hlds__term_constr_fixpoint__fixpoint_info_0_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___transform_hlds__term_constr_fixpoint__fixpoint_info_0_0_i27);
	}
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(term, generic);
	MR_r2 = MR_sv(1);
	MR_r3 = MR_sv(6);
	MR_np_call_localret_ent(__Compare___varset__varset_1_0,
		__Compare___transform_hlds__term_constr_fixpoint__fixpoint_info_0_0_i7);
MR_def_label(__Compare___transform_hlds__term_constr_fixpoint__fixpoint_info_0_0,7)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___transform_hlds__term_constr_fixpoint__fixpoint_info_0_0_i27);
	}
	...
	MR_np_call_localret_ent(__Compare___hlds__hlds_pred__pred_proc_id_0_0,
		__Compare___transform_hlds__term_constr_fixpoint__fixpoint_info_0_0_i11);
MR_def_label(__Compare___transform_hlds__term_constr_fixpoint__fixpoint_info_0_0,11)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___transform_hlds__term_constr_fixpoint__fixpoint_info_0_0_i27);
	}
	...
	MR_np_call_localret_ent(private_builtin__builtin_compare_int_3_0,
		__Compare___transform_hlds__term_constr_fixpoint__fixpoint_info_0_0_i15);
MR_def_label(__Compare___transform_hlds__term_constr_fixpoint__fixpoint_info_0_0,15)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___transform_hlds__term_constr_fixpoint__fixpoint_info_0_0_i27);
	}
	...
	MR_np_call_localret_ent(__Compare___list__list_1_0,
		__Compare___transform_hlds__term_constr_fixpoint__fixpoint_info_0_0_i19);
MR_def_label(__Compare___transform_hlds__term_constr_fixpoint__fixpoint_info_0_0,19)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___transform_hlds__term_constr_fixpoint__fixpoint_info_0_0_i27);
	}
...
MR_def_label(__Compare___transform_hlds__term_constr_fixpoint__fixpoint_info_0_0,27)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_BEGIN_MODULE(transform_hlds__term_constr_fixpoint_module14)
	...
	MR_init_label1(__Unify___transform_hlds__term_constr_fixpoint__fixpoint_options_0_0,1)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(transform_hlds__term_constr_fixpoint_module15)
	...
	MR_init_label2(__Compare___transform_hlds__term_constr_fixpoint__fixpoint_options_0_0,3,7)
MR_BEGIN_CODE
...
MR_define_entry(mercury____Compare___transform_hlds__term_constr_fixpoint__fixpoint_options_0_0);
	...
	MR_r2 = MR_ctfield(0, MR_r2, 0);
	MR_np_call_localret_ent(private_builtin__builtin_compare_int_3_0,
		__Compare___transform_hlds__term_constr_fixpoint__fixpoint_options_0_0_i3);
MR_def_label(__Compare___transform_hlds__term_constr_fixpoint__fixpoint_options_0_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___transform_hlds__term_constr_fixpoint__fixpoint_options_0_0_i7);
	}
	MR_r1 = MR_sv(1);
	MR_r2 = MR_sv(2);
...
MR_def_label(__Compare___transform_hlds__term_constr_fixpoint__fixpoint_options_0_0,7)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_BEGIN_MODULE(transform_hlds__term_constr_fixpoint_module16)
	...
	MR_init_label3(__Unify___transform_hlds__term_constr_fixpoint__iteration_info_0_0,2,4,1)
MR_BEGIN_CODE
...
MR_def_static(__Unify___transform_hlds__term_constr_fixpoint__iteration_info_0_0)
	...
	MR_np_call_localret_ent(__Unify___hlds__hlds_pred__pred_proc_id_0_0,
		__Unify___transform_hlds__term_constr_fixpoint__iteration_info_0_0_i2);
MR_def_label(__Unify___transform_hlds__term_constr_fixpoint__iteration_info_0_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
...
MR_BEGIN_MODULE(transform_hlds__term_constr_fixpoint_module17)
	...
	MR_init_label3(__Compare___transform_hlds__term_constr_fixpoint__iteration_info_0_0,3,7,12)
MR_BEGIN_CODE
...
MR_def_static(__Compare___transform_hlds__term_constr_fixpoint__iteration_info_0_0)
	...
	MR_np_call_localret_ent(__Compare___hlds__hlds_pred__pred_proc_id_0_0,
		__Compare___transform_hlds__term_constr_fixpoint__iteration_info_0_0_i3);
MR_def_label(__Compare___transform_hlds__term_constr_fixpoint__iteration_info_0_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___transform_hlds__term_constr_fixpoint__iteration_info_0_0_i12);
	}
	MR_r1 = MR_sv(1);
	MR_r2 = MR_sv(3);
	MR_np_call_localret_ent(__Compare___libs__polyhedron__polyhedron_0_0,
		__Compare___transform_hlds__term_constr_fixpoint__iteration_info_0_0_i7);
MR_def_label(__Compare___transform_hlds__term_constr_fixpoint__iteration_info_0_0,7)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___transform_hlds__term_constr_fixpoint__iteration_info_0_0_i12);
	}
	...
	MR_decr_sp(5);
	MR_np_tailcall_ent(private_builtin__builtin_compare_int_3_0);
MR_def_label(__Compare___transform_hlds__term_constr_fixpoint__iteration_info_0_0,12)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(5);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
...
MR_BEGIN_MODULE(transform_hlds__term_constr_fixpoint_module21)
	MR_init_entry1(transform_hlds__term_constr_fixpoint__IntroducedFrom__pred__traverse_abstract_proc__173__1_3_0);
MR_BEGIN_CODE
	...
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(transform_hlds__term_constr_fixpoint__IntroducedFrom__pred__traverse_abstract_proc__173__1_3_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_r1;
...
void mercury__transform_hlds__term_constr_fixpoint__write_out_proc_statics(FILE *fp);
#endif
