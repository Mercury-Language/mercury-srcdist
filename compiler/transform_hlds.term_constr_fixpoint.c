...
static /* final */ const MR_Box transform_hlds__term_constr_fixpoint_scalar_common_8[1][7];
  ...
  MR_Word LambdaHeadVar__1_30)
{
  ...
  Var_40 = ((MR_Word) ((MR_hl_field(MR_mktag(0), LambdaHeadVar__1_30, (MR_Integer) 0))));
  Var_42 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), LambdaHeadVar__1_30, (MR_Integer) 2))) & (MR_Integer) 1);
  {
    LambdaHeadVar__2_31 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(MR_mktag(0), LambdaHeadVar__2_31, 0) = ((MR_Box) (Var_40));
    MR_hl_field(MR_mktag(0), LambdaHeadVar__2_31, 1) = ((MR_Box) (Identity_19));
    MR_hl_field(MR_mktag(0), LambdaHeadVar__2_31, 2) = (MR_Box) ((MR_Unsigned) (Var_42));
  }
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      else
      {
        ...
        MR_Word Var_42;
        MR_Word Var_69;
        MR_Integer Var_70 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), Var_23, (MR_Integer) 3))));
        ...
        libs__polyhedron__convex_union_5_p_0(Var_24, Var_69, Var_22, Y_35, &Var_42);
        {
  ...
  MR_Word * HeadVar__4_4)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      {
        MR_Word Y_15 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Var_24, (MR_Integer) 0))));
        MR_Word Rest_16 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Var_24, (MR_Integer) 1))));
        MR_Word STATE_VARIABLE_Acc_21_21;
        MR_Word Var_22;
        MR_Word Var_51;
        MR_Integer Var_52 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), Var_26, (MR_Integer) 3))));
        MR_Word next_value_of_HeadVar__2_2;
        ...
        libs__polyhedron__convex_union_5_p_0(Var_27, Var_51, Var_25, Y_15, &Var_22);
        {
  ...
  MR_Word * STATE_VARIABLE_IterationInfo_37)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_19, (MR_Integer) 98, &DebugTerm_20);
  switch (DebugTerm_20) {
    ...
    case (MR_Integer) 1:
      {
...

        {
          ...
          MR_hl_field(MR_mktag(0), Var_36, 0) = ((MR_Box) (&transform_hlds__term_constr_fixpoint_scalar_common_8[0]));
          MR_hl_field(MR_mktag(0), Var_36, 1) = ((MR_Box) (transform_hlds__term_constr_fixpoint__term_traverse_abstract_goal_4_p_0_1));
        ...
        else
        {
          ...
          libs__polyhedron__project_polyhedron_4_p_0(Var_85, Locals_45, Polyhedron0_46, &GoalPolyhedron_84);
        }
    ...
    case (MR_Integer) 2:
      {
        ...
        MR_Word Var_39 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Info_5, (MR_Integer) 0))));
          ...
          else
          {
            ...
            else
            {
              ...
              else
              {
                ...
                libs__polyhedron__project_polyhedron_4_p_0(Var_72, Locals_52, Polyhedron2_30, &GoalPolyhedron_71);
              }
  ...
  MR_Word * STATE_VARIABLE_Polyhedron_12)
{
...

  {
    ...
    MR_hl_field(MR_mktag(0), Var_13, 0) = ((MR_Box) (&transform_hlds__term_constr_fixpoint_scalar_common_7[0]));
  ...
  MR_Word * STATE_VARIABLE_Polyhedron_12)
{
  ...
  else
  {
    ...
    libs__polyhedron__project_polyhedron_4_p_0(Var_13, Locals_6, GoalPolyhedron0_8, &GoalPolyhedron_10);
  }
  ...
  void * env_ptr_arg)
{
...

  {
    ...
    (env_ptr)->transform_hlds__term_constr_fixpoint__do_fixpoint_calculation_6_p_0_env_0__Var_29 = ((MR_Word) ((MR_hl_field(MR_mktag(0), (env_ptr)->transform_hlds__term_constr_fixpoint__do_fixpoint_calculation_6_p_0_env_0__OneInfo_15, (MR_Integer) 1))));
