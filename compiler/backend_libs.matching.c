...
MR_decl_label9(fn__backend_libs__matching__augpath_bf_4_0, 31,2,5,6,10,13,11,17,1)
MR_decl_label7(fn__backend_libs__matching__compute_via_cell_vars_2_0, 38,6,7,10,8,15,14)
...
MR_BEGIN_MODULE(backend_libs__matching_module6)
	...
	MR_init_label9(fn__backend_libs__matching__augpath_bf_4_0,31,2,5,6,10,13,11,17,1)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(backend_libs__matching_module12)
	...
	MR_init_label7(fn__backend_libs__matching__compute_via_cell_vars_2_0,38,6,7,10,8,15,14)
MR_BEGIN_CODE
...
MR_def_static(fn__backend_libs__matching__compute_via_cell_vars_2_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
		MR_GOTO_LAB(fn__backend_libs__matching__compute_via_cell_vars_2_0_i38);
	}
	MR_r1 = (MR_Word) MR_TAG_COMMON(0,0,7);
	MR_np_tailcall_ent(fn__set__init_0_0);
MR_def_label(fn__backend_libs__matching__compute_via_cell_vars_2_0,38)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(6);
...
MR_define_entry(mercury__backend_libs__matching__find_via_cell_vars_9_0);
	...
	MR_sv(14) = (MR_Word) MR_TAG_COMMON(0,0,7);
	MR_r1 = MR_sv(14);
	MR_r2 = MR_tempr1;
	}
...
MR_def_label(fn__backend_libs__matching__find_costs_benefits_6_0,23)
	...
	MR_r2 = MR_tempr1;
	MR_tfield(0, MR_tempr1, 0) = MR_sv(3);
	MR_tfield(0, MR_tempr1, 1) = (MR_Word) MR_CTOR0_ADDR(backend_libs__matching, benefit_node);
	MR_tag_alloc_heap(MR_tempr2, 0, (MR_Integer) 5);
	MR_r3 = MR_tempr2;
	MR_tfield(0, MR_tempr2, 0) = (MR_Word) MR_COMMON(5,4);
	MR_tfield(0, MR_tempr2, 1) = (MR_Word) MR_ENTRY_AP(fn__backend_libs__matching__replicate_benefit_op_3_0);
	MR_tfield(0, MR_tempr2, 2) = (MR_Integer) 2;
	MR_tempr4 = MR_sv(4);
	MR_tfield(0, MR_tempr2, 3) = MR_tfield(0, MR_tempr4, 2);
	MR_tfield(0, MR_tempr2, 4) = MR_tfield(0, MR_tempr4, 3);
	MR_tempr3 = MR_sv(1);
	MR_sv(1) = MR_r1;
...
MR_BEGIN_MODULE(backend_libs__matching_module52)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__fn__backend_libs__matching__IntroducedFrom__func__reachable_by_alternating_path__586__1_2_0);
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'IntroducedFrom__func__reachable_by_alternating_path__586__1'/3 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
