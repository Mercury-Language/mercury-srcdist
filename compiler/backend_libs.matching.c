...
{
  {
    ...
    else
    {
      ...
      if ((ArgX1_4 == (MR_Word) ((MR_Integer) 0)))
        if ((ArgY1_5 == (MR_Word) ((MR_Integer) 0)))
        {
          succeeded = MR_TRUE;
          succeeded = !(succeeded);
          if (succeeded)
...
{
  {
    ...
    else
    {
      ...
      if ((ArgX1_3 == (MR_Word) ((MR_Integer) 0)))
      {
    ...
    {
      {
        Match_6 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), Match_6, 0) = ((MR_Box) (CostNode_5));
        MR_hl_field(MR_mktag(0), Match_6, 1) = ((MR_Box) ((MR_Integer) 0));
      }
    }
    return Match_6;
  }
...
{
  {
    ...
    if ((HeadVar__3_3 == (MR_Word) ((MR_Integer) 0)))
    {
      HeadVar__4_4 = backend_libs__matching__make_cost_op_copies_2_f_0(HeadVar__1_1, (MR_Word) ((MR_Integer) 0));
    }
    else
...
{
  {
    ...
    backend_libs__matching__find_cell_var_loads_for_field_4_p_0(AfterFlush_10, FieldVar_13, (MR_Word) ((MR_Integer) 0), &CostOps0_15);
        ...
        {
          {
            ...
            MR_hl_field(MR_mktag(1), CostOps_16, 0) = ((MR_Box) ((MR_Integer) 0));
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), BenefitOps0_17, 1) = ((MR_Box) ((MR_Integer) 0));
    }
  ...
  MR_Word * STATE_VARIABLE_BenefitNodes_21)
{
  while (MR_TRUE)
  {
    // setup for model_det tailcalls optimized into a loop
    ;
    if ((SelectedCostNodes_6 == (MR_Word) ((MR_Integer) 0)))
  ...
  MR_Word * Unmatched_6)
{
  while (MR_TRUE)
  {
    ...
    if (succeeded)
    {
      ...
      if ((MaybeBenefitNode_4 == (MR_Word) ((MR_Integer) 0)))
      {
