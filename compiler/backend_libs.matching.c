...
MR_decl_label4(backend_libs__matching__find_cell_var_loads_for_field_4_0, 25,3,6,4)
MR_decl_label10(backend_libs__matching__find_via_cell_vars_9_0, 6,7,3,10,11,14,15,17,18,21)
MR_decl_label10(backend_libs__matching__find_via_cell_vars_9_0, 22,25,26,27,28,29,30,31,32,34)
MR_decl_label10(backend_libs__matching__find_via_cell_vars_9_0, 35,37,38,40,42,44,45,46,47,48)
MR_decl_label7(backend_libs__matching__find_via_cell_vars_9_0, 49,50,51,52,53,54,56)
...
MR_decl_label7(fn__backend_libs__matching__compute_via_cell_vars_2_0, 44,6,7,10,8,15,14)
MR_decl_label3(fn__backend_libs__matching__create_graph_1_0, 3,5,9)
MR_decl_label10(fn__backend_libs__matching__find_costs_benefits_6_0, 2,4,3,12,10,21,22,23,26,27)
MR_decl_label1(fn__backend_libs__matching__find_costs_benefits_6_0, 28)
...
MR_decl_static(fn__backend_libs__matching__IntroducedFrom__func__reachable_by_alternating_path__579__1_2_0)
...
MR_def_static(fn__backend_libs__matching__create_graph_1_0)
	...
	MR_sv(1) = MR_r1;
	MR_sv(3) = (MR_Word) MR_CTOR0_ADDR(backend_libs__matching, benefit_node);
	MR_sv(2) = (MR_Word) MR_CTOR1_ADDR(set_ordlist, set_ordlist);
...
MR_def_label(backend_libs__matching__reachable_by_alternating_path_5_0,10)
	...
	MR_tfield(0, MR_tempr1, 1) = (MR_Word) MR_ENTRY_AP(fn__backend_libs__matching__IntroducedFrom__func__reachable_by_alternating_path__579__1_2_0);
	MR_tfield(0, MR_tempr1, 2) = (MR_Integer) 1;
	MR_tfield(0, MR_tempr1, 3) = MR_tfield(0, MR_sv(3), 1);
	MR_tempr2 = MR_r1;
	MR_r1 = MR_sv(6);
	MR_r2 = (MR_Word) MR_CTOR0_ADDR(backend_libs__matching, cost_node);
	MR_r4 = MR_tempr2;
...
MR_BEGIN_MODULE(backend_libs__matching_module12)
	...
	MR_init_label7(fn__backend_libs__matching__compute_via_cell_vars_2_0,44,6,7,10,8,15,14)
MR_BEGIN_CODE
...
MR_def_static(fn__backend_libs__matching__compute_via_cell_vars_2_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
		MR_GOTO_LAB(fn__backend_libs__matching__compute_via_cell_vars_2_0_i44);
	}
	MR_r1 = (MR_Word) MR_TAG_COMMON(0,0,7);
	MR_np_tailcall_ent(fn__set__init_0_0);
MR_def_label(fn__backend_libs__matching__compute_via_cell_vars_2_0,44)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(6);
	MR_sv(6) = (MR_Word) MR_succip;
	MR_sv(1) = MR_r2;
...
MR_def_label(fn__backend_libs__matching__compute_via_cell_vars_2_0,7)
	...
	MR_np_call_localret_ent(set__empty_1_0,
		fn__backend_libs__matching__compute_via_cell_vars_2_0_i10);
...
MR_def_label(fn__backend_libs__matching__compute_via_cell_vars_2_0,8)
	...
	MR_np_call_localret_ent(set__equal_2_0,
		fn__backend_libs__matching__compute_via_cell_vars_2_0_i15);
MR_def_label(fn__backend_libs__matching__compute_via_cell_vars_2_0,15)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(fn__backend_libs__matching__compute_via_cell_vars_2_0_i14);
	}
	MR_r1 = MR_sv(1);
	MR_decr_sp_and_return(6);
...
MR_BEGIN_MODULE(backend_libs__matching_module14)
	...
	MR_init_label10(backend_libs__matching__find_via_cell_vars_9_0,6,7,3,10,11,14,15,17,18,21)
	MR_init_label10(backend_libs__matching__find_via_cell_vars_9_0,22,25,26,27,28,29,30,31,32,34)
	MR_init_label10(backend_libs__matching__find_via_cell_vars_9_0,35,37,38,40,42,44,45,46,47,48)
	MR_init_label7(backend_libs__matching__find_via_cell_vars_9_0,49,50,51,52,53,54,56)
MR_BEGIN_CODE
...
MR_def_label(backend_libs__matching__find_via_cell_vars_9_0,17)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(1) = MR_r1;
	MR_sv(11) = (MR_Word) MR_CTOR0_ADDR(backend_libs__matching, benefit_node);
	MR_r1 = MR_sv(11);
	MR_np_call_localret_ent(fn__set__init_0_0,
...
MR_def_label(backend_libs__matching__find_via_cell_vars_9_0,21)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(2) = MR_r1;
	MR_sv(12) = (MR_Word) MR_CTOR0_ADDR(backend_libs__matching, cost_node);
	MR_r1 = MR_sv(12);
	MR_np_call_localret_ent(fn__set__init_0_0,
...
MR_def_label(backend_libs__matching__find_via_cell_vars_9_0,40)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(2) = MR_r1;
	MR_sv(13) = (MR_Word) MR_CTOR0_ADDR(backend_libs__matching, benefit_operation);
	MR_r1 = MR_sv(11);
	MR_r2 = MR_sv(13);
...
MR_def_label(backend_libs__matching__find_via_cell_vars_9_0,42)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(4) = MR_r1;
	MR_sv(14) = (MR_Word) MR_CTOR0_ADDR(backend_libs__matching, cost_operation);
	MR_r1 = MR_sv(12);
	MR_r2 = MR_sv(14);
...
MR_BEGIN_MODULE(backend_libs__matching_module16)
	...
	MR_init_label4(backend_libs__matching__find_cell_var_loads_for_field_4_0,25,3,6,4)
MR_BEGIN_CODE
...
MR_def_static(backend_libs__matching__find_cell_var_loads_for_field_4_0)
	...
	MR_incr_sp(5);
	MR_sv(5) = (MR_Word) MR_succip;
MR_def_label(backend_libs__matching__find_cell_var_loads_for_field_4_0,25)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
...
MR_def_label(backend_libs__matching__find_cell_var_loads_for_field_4_0,6)
	...
	MR_r1 = MR_sv(4);
	MR_succip_word = MR_sv(5);
	MR_GOTO_LAB(backend_libs__matching__find_cell_var_loads_for_field_4_0_i25);
	}
...
MR_BEGIN_MODULE(backend_libs__matching_module17)
	...
	MR_init_label10(fn__backend_libs__matching__find_costs_benefits_6_0,2,4,3,12,10,21,22,23,26,27)
	MR_init_label1(fn__backend_libs__matching__find_costs_benefits_6_0,28)
MR_BEGIN_CODE
...
MR_def_label(fn__backend_libs__matching__find_costs_benefits_6_0,12)
	...
	MR_r4 = MR_sv(1);
	MR_sv(1) = MR_sv(2);
	MR_sv(2) = (MR_Word) MR_CTOR0_ADDR(backend_libs__matching, cost_node);
...
MR_BEGIN_MODULE(backend_libs__matching_module52)
	MR_init_entry1(fn__backend_libs__matching__IntroducedFrom__func__reachable_by_alternating_path__579__1_2_0);
	MR_INIT_PROC_LAYOUT_ADDR(mercury__fn__backend_libs__matching__IntroducedFrom__func__reachable_by_alternating_path__579__1_2_0);
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'IntroducedFrom__func__reachable_by_alternating_path__579__1'/3 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(fn__backend_libs__matching__IntroducedFrom__func__reachable_by_alternating_path__579__1_2_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tempr1 = MR_r1;
