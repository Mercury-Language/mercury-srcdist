...
MR_decl_static(fn__backend_libs__matching__IntroducedFrom__func__reachable_by_alternating_path__581__1_2_0)
...
MR_def_label(backend_libs__matching__reachable_by_alternating_path_5_0,10)
	...
	MR_tfield(0, MR_tempr1, 1) = (MR_Word) MR_ENTRY_AP(fn__backend_libs__matching__IntroducedFrom__func__reachable_by_alternating_path__581__1_2_0);
	MR_tfield(0, MR_tempr1, 2) = (MR_Integer) 1;
...
MR_BEGIN_MODULE(backend_libs__matching_module52)
	MR_init_entry1(fn__backend_libs__matching__IntroducedFrom__func__reachable_by_alternating_path__581__1_2_0);
	MR_INIT_PROC_LAYOUT_ADDR(mercury__fn__backend_libs__matching__IntroducedFrom__func__reachable_by_alternating_path__581__1_2_0);
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'IntroducedFrom__func__reachable_by_alternating_path__581__1'/3 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(fn__backend_libs__matching__IntroducedFrom__func__reachable_by_alternating_path__581__1_2_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tempr1 = MR_r1;
