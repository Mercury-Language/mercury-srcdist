  ...
  MR_Word * STATE_VARIABLE_Matching_10)
{
  while (MR_TRUE)
  {
    MR_bool succeeded;
    MR_Word Path_8;
    MR_Word MatchingBenefitToCost_17 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_Matching_0_9, (MR_Integer) 1))));
    MR_Word UnMatchedBenefitNodes_18;
    MR_Word Queue_23;
    MR_Word Var_24;

    // setup for model_det tailcalls optimized into a loop
    ;
    UnMatchedBenefitNodes_18 = backend_libs__matching__get_unmatched_benefit_nodes_2_f_0(BenefitNodes_5, MatchingBenefitToCost_17);
    Var_24 = mercury__queue__init_0_f_0((MR_Word) (&backend_libs__matching__backend_libs__matching__type_ctor_info_benefit_node_and_edge_list_0));
    Queue_23 = backend_libs__matching__initial_queue_2_f_0(UnMatchedBenefitNodes_18, Var_24);
    succeeded = backend_libs__matching__augpath_bf_4_f_0(Queue_23, UnMatchedBenefitNodes_18, Graph_6, STATE_VARIABLE_Matching_0_9, &Path_8);
    if (succeeded)
    {
