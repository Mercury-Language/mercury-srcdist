...
{
  {
    ...
    else
    {
      ...
      mercury__builtin__compare_3_p_0((MR_Word) &backend_libs__matching_scalar_common_2[0], &Var_8, ((MR_Box) (ArgX1_4)), ((MR_Box) (ArgY1_5)));
      ...
      {
        mercury__builtin__compare_3_p_0((MR_Word) &backend_libs__matching_scalar_common_2[1], HeadVar__1_1, ((MR_Box) (ArgX2_6)), ((MR_Box) (ArgY2_7)));
      }
    }
  }
}
...
{
  {
    ...
    else
    {
      ...
      mercury__builtin__compare_3_p_0((MR_Word) &backend_libs__matching_scalar_common_2[4], &Var_8, ((MR_Box) (ArgX1_4)), ((MR_Box) (ArgY1_5)));
      succeeded = (Var_8 == (MR_Integer) 0);
      succeeded = !(succeeded);
      if (succeeded)
        *HeadVar__1_1 = Var_8;
      ...
      {
        mercury__builtin__compare_3_p_0((MR_Word) &backend_libs__matching_scalar_common_2[5], HeadVar__1_1, ((MR_Box) (ArgX2_6)), ((MR_Box) (ArgY2_7)));
      }
    }
  }
}
...
{
  {
    ...
    else
    {
      ...
      mercury__builtin__compare_3_p_0((MR_Word) &backend_libs__matching_scalar_common_1[0], &Var_10, ((MR_Box) (ArgX1_4)), ((MR_Box) (ArgY1_5)));
      ...
      else
      {
        ...
        mercury__builtin__compare_3_p_0((MR_Word) &backend_libs__matching_scalar_common_1[3], &Var_11, ((MR_Box) (ArgX2_6)), ((MR_Box) (ArgY2_7)));
        ...
        {
          mercury__builtin__compare_3_p_0((MR_Word) &backend_libs__matching_scalar_common_1[2], HeadVar__1_1, ((MR_Box) (ArgX3_8)), ((MR_Box) (ArgY3_9)));
        }
      }
    }
  }
...
{
  {
    ...
    else
    {
      ...
      succeeded = mercury__builtin__unify_2_p_0((MR_Word) &backend_libs__matching_scalar_common_1[0], ((MR_Box) (ArgX1_3)), ((MR_Box) (ArgY1_4)));
      if (succeeded)
      {
...
{
  {
    ...
    else
    {
      ...
      else
      {
        ...
        mercury__private_builtin__builtin_compare_int_3_p_0(HeadVar__1_1, Var_11, ArgY1_5);
      }
    }
  }
}
...
{
  {
    ...
    else
    {
      ...
      if ((ArgX1_4 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
        if ((ArgY1_5 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
        {
          succeeded = MR_TRUE;
          succeeded = !(succeeded);
          if (succeeded)
      ...
      else
      {
        ...
        else
        {
          ...
          mercury__private_builtin__builtin_compare_int_3_p_0(&Var_8, Var_20, ArgY1_14);
          succeeded = (Var_8 == (MR_Integer) 0);
          succeeded = !(succeeded);
        }
      }
...
{
  {
    ...
    else
    {
      ...
      if ((ArgX1_3 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
      {
      ...
      else
      {
        ...
        succeeded = ((MR_tag((MR_Word) ArgY1_4)) == (MR_mktag((MR_Integer) 1)));
        if (succeeded)
        {
...
{
  {
    ...
    if (((MR_tag((MR_Word) HeadVar__2_2)) == (MR_mktag((MR_Integer) 0))))
    {
      ...
      if (((MR_tag((MR_Word) HeadVar__3_3)) == (MR_mktag((MR_Integer) 0))))
      {
        ...
        mercury__builtin__compare_3_p_0((MR_Word) &backend_libs__matching_scalar_common_1[0], HeadVar__1_1, ((MR_Box) (Var_16)), ((MR_Box) (ArgY1_5)));
      }
      else
        *HeadVar__1_1 = (MR_Integer) 1;
    }
    else
    {
      ...
      else
      {
        ...
        mercury__builtin__compare_3_p_0((MR_Word) &backend_libs__matching_scalar_common_1[0], HeadVar__1_1, ((MR_Box) (Var_17)), ((MR_Box) (ArgY1_11)));
      }
    }
  }
}
...
{
  {
    ...
    if (((MR_tag((MR_Word) HeadVar__1_1)) == (MR_mktag((MR_Integer) 0))))
    {
      ...
      if (succeeded)
      {
        ...
        TypeInfo_9_9 = (MR_Word) &backend_libs__matching_scalar_common_1[0];
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        TypeInfo_10_10 = (MR_Word) &backend_libs__matching_scalar_common_1[0];
...
{
  {
    ...
    else
    {
      ...
      backend_libs__matching____Compare____benefit_node_0_0(&Var_8, ArgX1_4, ArgY1_5);
      succeeded = (Var_8 == (MR_Integer) 0);
      succeeded = !(succeeded);
      if (succeeded)
        *HeadVar__1_1 = Var_8;
      ...
      {
        mercury__builtin__compare_3_p_0((MR_Word) &backend_libs__matching_scalar_common_1[7], HeadVar__1_1, ((MR_Box) (ArgX2_6)), ((MR_Box) (ArgY2_7)));
      }
    }
  }
}
...
{
  {
    ...
    else
    {
      ...
      if (((MR_tag((MR_Word) ArgX1_4)) == (MR_mktag((MR_Integer) 0))))
      {
        MR_Word Var_25 = ((MR_Word) (MR_hl_field(MR_mktag(0), ArgX1_4, (MR_Integer) 0)));

        if (((MR_tag((MR_Word) ArgY1_5)) == (MR_mktag((MR_Integer) 0))))
        {
          MR_Word ArgY1_14 = ((MR_Word) (MR_hl_field(MR_mktag(0), ArgY1_5, (MR_Integer) 0)));

          mercury__builtin__compare_3_p_0((MR_Word) &backend_libs__matching_scalar_common_1[0], &Var_8, ((MR_Box) (Var_25)), ((MR_Box) (ArgY1_14)));
          succeeded = (Var_8 == (MR_Integer) 0);
          succeeded = !(succeeded);
        }
        else
      ...
      else
      {
        ...
        else
        {
          ...
          mercury__builtin__compare_3_p_0((MR_Word) &backend_libs__matching_scalar_common_1[0], &Var_8, ((MR_Box) (Var_26)), ((MR_Box) (ArgY1_20)));
          succeeded = (Var_8 == (MR_Integer) 0);
          succeeded = !(succeeded);
        }
      }
...
{
  {
    ...
    else
    {
      ...
      if (((MR_tag((MR_Word) ArgX1_3)) == (MR_mktag((MR_Integer) 0))))
      {
        MR_Word TypeInfo_9_15;
        MR_Word ArgX1_9 = ((MR_Word) (MR_hl_field(MR_mktag(0), ArgX1_3, (MR_Integer) 0)));
        MR_Word ArgY1_10;

        succeeded = ((MR_tag((MR_Word) ArgY1_4)) == (MR_mktag((MR_Integer) 0)));
        if (succeeded)
        {
          ArgY1_10 = ((MR_Word) (MR_hl_field(MR_mktag(0), ArgY1_4, (MR_Integer) 0)));
          TypeInfo_9_15 = (MR_Word) &backend_libs__matching_scalar_common_1[0];
      ...
      else
      {
        ...
        if (succeeded)
        {
          ...
          TypeInfo_10_16 = (MR_Word) &backend_libs__matching_scalar_common_1[0];
...
{
  {
    ...
    MR_Integer _CopyNum_4 = ((MR_Integer) (MR_hl_field(MR_mktag(0), HeadVar__1_1, (MR_Integer) 1)));
...
{
  {
    ...
    MR_Word Var_6 = ((MR_Word) (MR_hl_field(MR_mktag(0), FieldCostsBenefits_4, (MR_Integer) 1)));
    MR_Word Var_7 = ((MR_Word) (MR_hl_field(MR_mktag(0), FieldCostsBenefits_4, (MR_Integer) 2)));
...
{
  {
    ...
    if (succeeded)
    {
      ...
      {
        Match_6 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
    ...
    {
      {
        Match_6 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), Match_6, 0) = ((MR_Box) (CostNode_5));
        MR_hl_field(MR_mktag(0), Match_6, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
      }
    }
    return Match_6;
  }
...
{
  {
    ...
    MR_Word Var_18;
    MR_Word Var_19;
    MR_Word _FieldVar_6 = ((MR_Word) (MR_hl_field(MR_mktag(0), HeadVar__1_1, (MR_Integer) 0)));
    ...
    TypeCtorInfo_24_24 = (MR_Word) &backend_libs__matching__backend_libs__matching__type_ctor_info_cost_node_0;
    Var_16 = mercury__set__to_sorted_list_1_f_0(TypeCtorInfo_24_24, Costs_7);
    mercury__list__foldl_4_p_0(TypeCtorInfo_24_24, (MR_Word) &backend_libs__matching_scalar_common_2[0], Var_15, Var_16, ((MR_Box) (STATE_VARIABLE_CostToBenefitsMap_0_11)), &conv1_STATE_VARIABLE_CostToBenefitsMap_12);
    *STATE_VARIABLE_CostToBenefitsMap_12 = ((MR_Word) conv1_STATE_VARIABLE_CostToBenefitsMap_12);
    ...
    TypeCtorInfo_29_29 = (MR_Word) &backend_libs__matching__backend_libs__matching__type_ctor_info_benefit_node_0;
    Var_19 = mercury__set__to_sorted_list_1_f_0(TypeCtorInfo_29_29, Benefits_8);
    mercury__list__foldl_4_p_0(TypeCtorInfo_29_29, (MR_Word) &backend_libs__matching_scalar_common_2[1], Var_18, Var_19, ((MR_Box) (STATE_VARIABLE_BenefitToCostsMap_0_13)), &conv3_STATE_VARIABLE_BenefitToCostsMap_14);
...
{
  {
    ...
    if ((HeadVar__3_3 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
    {
      HeadVar__4_4 = backend_libs__matching__make_cost_op_copies_2_f_0(HeadVar__1_1, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)));
    }
    else
...
{
  {
    ...
    backend_libs__matching__find_cell_var_loads_for_field_4_p_0(AfterFlush_10, FieldVar_13, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), &CostOps0_15);
    switch (CellVarFlushedLater_11) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        {
          {
            CostOps_16 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), CostOps_16, 0) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
    ...
    {
      BenefitOps0_17 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), BenefitOps0_17, 0) = ((MR_Box) (Var_31));
      MR_hl_field(MR_mktag(1), BenefitOps0_17, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
    }
    ...
    else
    {
      ...
      {
        BenefitOps_18 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
    ...
    Var_37 = ((MR_Integer) (MR_hl_field(MR_mktag(0), MatchingParams_12, (MR_Integer) 2)));
    Var_38 = ((MR_Integer) (MR_hl_field(MR_mktag(0), MatchingParams_12, (MR_Integer) 3)));
    Var_39 = ((MR_Integer) (MR_hl_field(MR_mktag(0), MatchingParams_12, (MR_Integer) 4)));
    Var_40 = ((MR_Integer) (MR_hl_field(MR_mktag(0), MatchingParams_12, (MR_Integer) 5)));
    Var_41 = ((MR_Word) (MR_hl_field(MR_mktag(0), MatchingParams_12, (MR_Integer) 6)));
    {
    ...
    TypeCtorInfo_65_65 = (MR_Word) &backend_libs__matching__backend_libs__matching__type_ctor_info_cost_node_0;
    mercury__list__condense_2_p_0(TypeCtorInfo_65_65, CostNodeLists_21, &CostNodes_22);
    mercury__set__list_to_set_2_p_0(TypeCtorInfo_65_65, CostNodes_22, &CostNodeSet_23);
    Var_48 = ((MR_Integer) (MR_hl_field(MR_mktag(0), MatchingParams_12, (MR_Integer) 0)));
    Var_49 = ((MR_Integer) (MR_hl_field(MR_mktag(0), MatchingParams_12, (MR_Integer) 1)));
    ...
    Var_51 = ((MR_Integer) (MR_hl_field(MR_mktag(0), MatchingParams_12, (MR_Integer) 4)));
    Var_52 = ((MR_Integer) (MR_hl_field(MR_mktag(0), MatchingParams_12, (MR_Integer) 5)));
    Var_53 = ((MR_Word) (MR_hl_field(MR_mktag(0), MatchingParams_12, (MR_Integer) 6)));
    {
    ...
    TypeCtorInfo_70_70 = (MR_Word) &backend_libs__matching__backend_libs__matching__type_ctor_info_benefit_node_0;
    mercury__list__condense_2_p_0(TypeCtorInfo_70_70, BenefitNodeLists_26, &BenefitNodes_27);
    mercury__set__list_to_set_2_p_0(TypeCtorInfo_70_70, BenefitNodes_27, &BenefitNodeSet_28);
    {
      FieldCostsBenefits_14 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL);
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        {
          STATE_VARIABLE_CostOps_17_17 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      ...
      {
        MR_Word next_value_of_HeadVar__1_1 = AfterFlush_11;
        MR_Word next_value_of_STATE_VARIABLE_CostOps_0_3 = STATE_VARIABLE_CostOps_17_17;
...
backend_libs__matching__find_via_cell_vars_9_p_0(
  MR_Word CellVar_10,
  MR_Word CandidateFieldVars_11,
  MR_Word CellVarFlushedLater_12,
  MR_Word BeforeFlush_13,
  MR_Word AfterFlush_14,
  MR_Word MatchingParams_15,
  MR_Word * RealizedBenefitNodes_16,
  MR_Word * RealizedCostNodes_17,
...
{
  {
    ...
    MR_Word InclAllCand_19 = ((MR_Word) (MR_hl_field(MR_mktag(0), MatchingParams_15, (MR_Integer) 6)));
    MR_Word OccurringCandidateFieldVars_21;
    MR_Word NonOccurringCandidateFieldVars_22;
    MR_Word OccurringCandidateFieldVarList_23;
    MR_Word FilteredAfterFlush_24;
    MR_Word NumberedAfterFlush_25;
    MR_Word CostsBenefits_26;
    MR_Word BenefitNodes_27;
    MR_Word CostNodes_28;
    MR_Word BenefitNodeList_29;
    MR_Word CostNodeList_30;
    MR_Word Graph_31;
    MR_Word MaximalMatching_32;
    MR_Word MaximalMatchingCostToBenefit_33;
    MR_Word UnMatchedCostNodes_35;
    MR_Word MarkedBenefitNodes_36;
    MR_Word ViaCellOccurringVars0_37;
    MR_Word RealizedCostsBenefits_38;
    MR_Word RealizedBenefitOps_39;
    MR_Word RealizedCostOps_40;
    MR_Word RealizedBenefitNodeList_41;
    MR_Word RealizedCostNodeList_42;
    MR_Word RealizedBenefitOpList_43;
    MR_Word RealizedCostOpList_44;
    MR_Integer RealizedBenefitNodeCount_45;
    MR_Integer RealizedBenefitOpCount_46;
    MR_Integer RealizedCostNodeCount_47;
    MR_Integer RealizedCostOpCount_48;
    MR_Integer OpRatio_49;
    MR_Integer NodeRatio_50;
    MR_Word ViaCellOccurringVars_51;
    MR_Word Var_55;
    MR_Word Var_57;
    MR_Word Var_59;
    MR_Word Var_61;
    ...
    MR_Word Var_64;
    MR_Word Var_66;
    MR_Integer Var_77 = ((MR_Integer) (MR_hl_field(MR_mktag(0), MatchingParams_15, (MR_Integer) 0)));
    MR_Integer Var_78 = ((MR_Integer) (MR_hl_field(MR_mktag(0), MatchingParams_15, (MR_Integer) 1)));
    MR_Integer Var_79 = ((MR_Integer) (MR_hl_field(MR_mktag(0), MatchingParams_15, (MR_Integer) 2)));
    MR_Integer Var_80 = ((MR_Integer) (MR_hl_field(MR_mktag(0), MatchingParams_15, (MR_Integer) 3)));
    MR_Integer Var_81 = ((MR_Integer) (MR_hl_field(MR_mktag(0), MatchingParams_15, (MR_Integer) 4)));
    MR_Integer Var_82 = ((MR_Integer) (MR_hl_field(MR_mktag(0), MatchingParams_15, (MR_Integer) 5)));
    MR_Box conv3_BenefitNodes_27;
    MR_Box conv5_CostNodes_28;
    MR_Word Var_34;
    MR_Box conv7_RealizedBenefitNodes_16;
    MR_Box conv9_RealizedCostNodes_17;
    MR_Integer Var_83;
    MR_Integer Var_84;
    MR_Integer Var_85;
    MR_Integer Var_86;
    ...
    switch (InclAllCand_19) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        {
          MR_Word TypeCtorInfo_95_95 = (MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0;
          MR_Word AllSegmentVars_20;
          MR_Word Var_54;

          {
            Var_54 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), Var_54, 0) = ((MR_Box) (BeforeFlush_13));
            MR_hl_field(MR_mktag(1), Var_54, 1) = ((MR_Box) (AfterFlush_14));
          }
          AllSegmentVars_20 = parse_tree__set_of_var__union_list_1_f_0(TypeCtorInfo_95_95, Var_54);
          parse_tree__set_of_var__intersect_3_p_0(TypeCtorInfo_95_95, CandidateFieldVars_11, AllSegmentVars_20, &OccurringCandidateFieldVars_21);
          parse_tree__set_of_var__difference_3_p_0(TypeCtorInfo_95_95, CandidateFieldVars_11, OccurringCandidateFieldVars_21, &NonOccurringCandidateFieldVars_22);
        }
        break;
      case (MR_Integer) 1:
        {
          OccurringCandidateFieldVars_21 = CandidateFieldVars_11;
          NonOccurringCandidateFieldVars_22 = parse_tree__set_of_var__init_0_f_0((MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0);
        }
        break;
    }
    TypeCtorInfo_97_97 = (MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0;
    OccurringCandidateFieldVarList_23 = parse_tree__set_of_var__to_sorted_list_1_f_0(TypeCtorInfo_97_97, OccurringCandidateFieldVars_21);
    {
      Var_55 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 5 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), Var_55, 0) = ((MR_Box) (&backend_libs__matching_scalar_common_5[1]));
      MR_hl_field(MR_mktag(0), Var_55, 1) = ((MR_Box) (backend_libs__matching__find_via_cell_vars_9_p_0_1));
      MR_hl_field(MR_mktag(0), Var_55, 2) = ((MR_Box) (MR_Word) ((MR_Integer) 2));
      MR_hl_field(MR_mktag(0), Var_55, 3) = ((MR_Box) (CellVar_10));
      MR_hl_field(MR_mktag(0), Var_55, 4) = ((MR_Box) (OccurringCandidateFieldVars_21));
    }
    TypeInfo_100_100 = (MR_Word) &backend_libs__matching_scalar_common_1[1];
    mercury__list__filter_map_3_p_0(TypeInfo_100_100, TypeInfo_100_100, Var_55, AfterFlush_14, &FilteredAfterFlush_24);
    NumberedAfterFlush_25 = backend_libs__matching__number_segments_2_f_0((MR_Integer) 2, FilteredAfterFlush_24);
    TypeCtorInfo_102_102 = (MR_Word) &backend_libs__matching__backend_libs__matching__type_ctor_info_field_costs_benefits_0;
    {
      Var_57 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 8 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), Var_57, 0) = ((MR_Box) (&backend_libs__matching_scalar_common_6[0]));
      MR_hl_field(MR_mktag(0), Var_57, 1) = ((MR_Box) (backend_libs__matching__find_via_cell_vars_9_p_0_2));
      MR_hl_field(MR_mktag(0), Var_57, 2) = ((MR_Box) (MR_Word) ((MR_Integer) 5));
      MR_hl_field(MR_mktag(0), Var_57, 3) = ((MR_Box) (CellVar_10));
      MR_hl_field(MR_mktag(0), Var_57, 4) = ((MR_Box) (BeforeFlush_13));
      MR_hl_field(MR_mktag(0), Var_57, 5) = ((MR_Box) (NumberedAfterFlush_25));
      MR_hl_field(MR_mktag(0), Var_57, 6) = ((MR_Box) (CellVarFlushedLater_12));
      MR_hl_field(MR_mktag(0), Var_57, 7) = ((MR_Box) (MatchingParams_15));
    }
    CostsBenefits_26 = mercury__list__map_2_f_0((MR_Word) &backend_libs__matching_scalar_common_1[0], TypeCtorInfo_102_102, Var_57, OccurringCandidateFieldVarList_23);
    TypeCtorInfo_108_108 = (MR_Word) &backend_libs__matching__backend_libs__matching__type_ctor_info_benefit_node_0;
    Var_59 = mercury__set__init_0_f_0(TypeCtorInfo_108_108);
    TypeInfo_109_109 = (MR_Word) &backend_libs__matching_scalar_common_1[2];
    mercury__list__foldl_4_p_0(TypeCtorInfo_102_102, TypeInfo_109_109, (MR_Word) &backend_libs__matching_scalar_common_2[7], CostsBenefits_26, ((MR_Box) (Var_59)), &conv3_BenefitNodes_27);
    BenefitNodes_27 = ((MR_Word) conv3_BenefitNodes_27);
    TypeCtorInfo_113_113 = (MR_Word) &backend_libs__matching__backend_libs__matching__type_ctor_info_cost_node_0;
    Var_61 = mercury__set__init_0_f_0(TypeCtorInfo_113_113);
    TypeInfo_114_114 = (MR_Word) &backend_libs__matching_scalar_common_1[3];
    mercury__list__foldl_4_p_0(TypeCtorInfo_102_102, TypeInfo_114_114, (MR_Word) &backend_libs__matching_scalar_common_2[8], CostsBenefits_26, ((MR_Box) (Var_61)), &conv5_CostNodes_28);
    CostNodes_28 = ((MR_Word) conv5_CostNodes_28);
    mercury__set__to_sorted_list_2_p_0(TypeCtorInfo_108_108, BenefitNodes_27, &BenefitNodeList_29);
    mercury__set__to_sorted_list_2_p_0(TypeCtorInfo_113_113, CostNodes_28, &CostNodeList_30);
    Graph_31 = backend_libs__matching__create_graph_1_f_0(CostsBenefits_26);
    MaximalMatching_32 = backend_libs__matching__maximal_matching_2_f_0(BenefitNodeList_29, Graph_31);
    MaximalMatchingCostToBenefit_33 = ((MR_Word) (MR_hl_field(MR_mktag(0), MaximalMatching_32, (MR_Integer) 0)));
    Var_34 = ((MR_Word) (MR_hl_field(MR_mktag(0), MaximalMatching_32, (MR_Integer) 1)));
    UnMatchedCostNodes_35 = backend_libs__matching__get_unmatched_cost_nodes_2_f_0(CostNodeList_30, MaximalMatchingCostToBenefit_33);
    MarkedBenefitNodes_36 = backend_libs__matching__reachable_by_alternating_path_3_f_0(UnMatchedCostNodes_35, Graph_31, MaximalMatching_32);
    ViaCellOccurringVars0_37 = backend_libs__matching__compute_via_cell_vars_2_f_0(CostsBenefits_26, MarkedBenefitNodes_36);
    {
      Var_62 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), Var_62, 0) = ((MR_Box) (&backend_libs__matching_scalar_common_7[0]));
      MR_hl_field(MR_mktag(0), Var_62, 1) = ((MR_Box) (backend_libs__matching__find_via_cell_vars_9_p_0_5));
      MR_hl_field(MR_mktag(0), Var_62, 2) = ((MR_Box) (MR_Word) ((MR_Integer) 1));
      MR_hl_field(MR_mktag(0), Var_62, 3) = ((MR_Box) (ViaCellOccurringVars0_37));
    }
    mercury__list__filter_3_p_0(TypeCtorInfo_102_102, Var_62, CostsBenefits_26, &RealizedCostsBenefits_38);
    Var_64 = mercury__set__init_0_f_0(TypeCtorInfo_108_108);
    mercury__list__foldl_4_p_0(TypeCtorInfo_102_102, TypeInfo_109_109, (MR_Word) &backend_libs__matching_scalar_common_2[9], RealizedCostsBenefits_38, ((MR_Box) (Var_64)), &conv7_RealizedBenefitNodes_16);
    *RealizedBenefitNodes_16 = ((MR_Word) conv7_RealizedBenefitNodes_16);
    Var_66 = mercury__set__init_0_f_0(TypeCtorInfo_113_113);
    mercury__list__foldl_4_p_0(TypeCtorInfo_102_102, TypeInfo_114_114, (MR_Word) &backend_libs__matching_scalar_common_2[10], RealizedCostsBenefits_38, ((MR_Box) (Var_66)), &conv9_RealizedCostNodes_17);
    *RealizedCostNodes_17 = ((MR_Word) conv9_RealizedCostNodes_17);
    TypeCtorInfo_122_122 = (MR_Word) &backend_libs__matching__backend_libs__matching__type_ctor_info_benefit_operation_0;
    RealizedBenefitOps_39 = mercury__set__map_2_f_0(TypeCtorInfo_108_108, TypeCtorInfo_122_122, (MR_Word) &backend_libs__matching_scalar_common_2[11], *RealizedBenefitNodes_16);
    TypeCtorInfo_125_125 = (MR_Word) &backend_libs__matching__backend_libs__matching__type_ctor_info_cost_operation_0;
    RealizedCostOps_40 = mercury__set__map_2_f_0(TypeCtorInfo_113_113, TypeCtorInfo_125_125, (MR_Word) &backend_libs__matching_scalar_common_2[12], *RealizedCostNodes_17);
    mercury__set__to_sorted_list_2_p_0(TypeCtorInfo_108_108, *RealizedBenefitNodes_16, &RealizedBenefitNodeList_41);
    mercury__set__to_sorted_list_2_p_0(TypeCtorInfo_113_113, *RealizedCostNodes_17, &RealizedCostNodeList_42);
    mercury__set__to_sorted_list_2_p_0(TypeCtorInfo_122_122, RealizedBenefitOps_39, &RealizedBenefitOpList_43);
    mercury__set__to_sorted_list_2_p_0(TypeCtorInfo_125_125, RealizedCostOps_40, &RealizedCostOpList_44);
    mercury__list__length_2_p_0(TypeCtorInfo_108_108, RealizedBenefitNodeList_41, &RealizedBenefitNodeCount_45);
    mercury__list__length_2_p_0(TypeCtorInfo_122_122, RealizedBenefitOpList_43, &RealizedBenefitOpCount_46);
    mercury__list__length_2_p_0(TypeCtorInfo_113_113, RealizedCostNodeList_42, &RealizedCostNodeCount_47);
    mercury__list__length_2_p_0(TypeCtorInfo_125_125, RealizedCostOpList_44, &RealizedCostOpCount_48);
    Var_83 = ((MR_Integer) (MR_hl_field(MR_mktag(0), MatchingParams_15, (MR_Integer) 0)));
    Var_84 = ((MR_Integer) (MR_hl_field(MR_mktag(0), MatchingParams_15, (MR_Integer) 1)));
    Var_85 = ((MR_Integer) (MR_hl_field(MR_mktag(0), MatchingParams_15, (MR_Integer) 2)));
    Var_86 = ((MR_Integer) (MR_hl_field(MR_mktag(0), MatchingParams_15, (MR_Integer) 3)));
    OpRatio_49 = ((MR_Integer) (MR_hl_field(MR_mktag(0), MatchingParams_15, (MR_Integer) 4)));
    NodeRatio_50 = ((MR_Integer) (MR_hl_field(MR_mktag(0), MatchingParams_15, (MR_Integer) 5)));
    Var_88 = ((MR_Word) (MR_hl_field(MR_mktag(0), MatchingParams_15, (MR_Integer) 6)));
    Var_69 = (RealizedBenefitOpCount_46 * (MR_Integer) 100);
    Var_70 = (RealizedCostOpCount_48 * OpRatio_49);
    succeeded = (Var_69 >= Var_70);
    if (succeeded)
    {
      Var_74 = (MR_Integer) 100;
      Var_72 = (RealizedBenefitNodeCount_45 * Var_74);
      Var_73 = (RealizedCostNodeCount_47 * NodeRatio_50);
      succeeded = (Var_72 >= Var_73);
    }
    if (succeeded)
      ViaCellOccurringVars_51 = ViaCellOccurringVars0_37;
    else
      ViaCellOccurringVars_51 = parse_tree__set_of_var__init_0_f_0(TypeCtorInfo_97_97);
    *ViaCellVars_18 = parse_tree__set_of_var__union_2_f_0(TypeCtorInfo_97_97, ViaCellOccurringVars_51, NonOccurringCandidateFieldVars_22);
  }
}
...
{
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        _Match_10 = ((MR_Word) conv0__Match_10);
        succeeded = MR_TRUE;
      }
      if (succeeded)
...
{
  {
    ...
    else
    {
      ...
      Var_11 = ((MR_Word) (MR_hl_field(MR_mktag(0), FieldCostsBenefits_5, (MR_Integer) 1)));
      FieldBenefits_12 = ((MR_Word) (MR_hl_field(MR_mktag(0), FieldCostsBenefits_5, (MR_Integer) 2)));
      TypeCtorInfo_18_18 = (MR_Word) &backend_libs__matching__backend_libs__matching__type_ctor_info_benefit_node_0;
      mercury__set__intersect_3_p_0(TypeCtorInfo_18_18, FieldBenefits_12, HeadVar__2_2, &MarkedFieldBenefits_13);
      succeeded = mercury__set__is_empty_1_p_0(TypeCtorInfo_18_18, MarkedFieldBenefits_13);
      if (succeeded)
      {
      ...
      {
        succeeded = mercury__set__equal_2_p_0(TypeCtorInfo_18_18, MarkedFieldBenefits_13, FieldBenefits_12);
        if (succeeded)
...
{
  {
    ...
    conv2_HeadVar__3_34 = backend_libs__matching__IntroducedFrom__func__reachable_by_alternating_path__573__1_2_f_0(((MR_Word) (MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3))), ((MR_Word) wrapper_arg_1));
  ...
  MR_Word * STATE_VARIABLE_BenefitNodes_21)
{
  ...
  {
    /* setup for tailcalls optimized into a loop */
    if ((SelectedCostNodes_6 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
    ...
    else
    {
      ...
      MR_Word Var_25;
      MR_Word Var_13 = ((MR_Word) (MR_hl_field(MR_mktag(0), Graph_7, (MR_Integer) 1)));
      ...
      TypeCtorInfo_30_30 = (MR_Word) &backend_libs__matching__backend_libs__matching__type_ctor_info_benefit_node_0;
      Var_23 = mercury__set__init_0_f_0(TypeCtorInfo_30_30);
      TypeCtorInfo_31_31 = (MR_Word) &backend_libs__matching__backend_libs__matching__type_ctor_info_cost_node_0;
      mercury__list__foldl_4_p_0(TypeCtorInfo_31_31, (MR_Word) &backend_libs__matching_scalar_common_1[2], Var_22, SelectedCostNodes_6, ((MR_Box) (Var_23)), &conv1_AdjBenefitNodes_14);
      AdjBenefitNodes_14 = ((MR_Word) conv1_AdjBenefitNodes_14);
      mercury__set__difference_3_p_0(TypeCtorInfo_30_30, STATE_VARIABLE_BenefitNodes_0_20, AdjBenefitNodes_14, &NewBenefitNodes_15);
      mercury__set__union_3_p_0(TypeCtorInfo_30_30, AdjBenefitNodes_14, STATE_VARIABLE_BenefitNodes_0_20, &STATE_VARIABLE_BenefitNodes_24_24);
      mercury__set__to_sorted_list_2_p_0(TypeCtorInfo_30_30, NewBenefitNodes_15, &NewBenefitNodeList_16);
      Var_17 = ((MR_Word) (MR_hl_field(MR_mktag(0), Matching_8, (MR_Integer) 0)));
      ...
      LinkedCostNodes_19 = mercury__list__map_2_f_0(TypeCtorInfo_30_30, TypeCtorInfo_31_31, Var_25, NewBenefitNodeList_16);
      /* direct tailcall eliminated */
      {
        MR_Word next_value_of_SelectedCostNodes_6 = LinkedCostNodes_19;
        MR_Word next_value_of_STATE_VARIABLE_BenefitNodes_0_20 = STATE_VARIABLE_BenefitNodes_24_24;
  ...
  MR_Word Graph_5)
{
  {
    MR_Word Matching_6;
    MR_Word TypeCtorInfo_10_10 = (MR_Word) &backend_libs__matching__backend_libs__matching__type_ctor_info_cost_node_0;
    MR_Word TypeCtorInfo_11_11 = (MR_Word) &backend_libs__matching__backend_libs__matching__type_ctor_info_benefit_node_0;
    MR_Word Matching0_7;
    MR_Word Var_8;
    MR_Word Var_9;

    Var_8 = mercury__map__init_0_f_0(TypeCtorInfo_10_10, TypeCtorInfo_11_11);
    Var_9 = mercury__map__init_0_f_0(TypeCtorInfo_11_11, TypeCtorInfo_10_10);
    {
      Matching0_7 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
  ...
  MR_Word * STATE_VARIABLE_Matching_10)
{
  while (MR_TRUE)
  {
    ...
    MR_Word Queue_24;
    MR_Word Var_25;
    MR_Word Var_17 = ((MR_Word) (MR_hl_field(MR_mktag(0), STATE_VARIABLE_Matching_0_9, (MR_Integer) 0)));
    ...
    if (succeeded)
    {
      ...
      /* direct tailcall eliminated */
      {
        MR_Word next_value_of_STATE_VARIABLE_Matching_0_9 = STATE_VARIABLE_Matching_11_11;
  ...
  MR_Word * Path_10)
{
  while (MR_TRUE)
  {
    ...
    if (succeeded)
    {
      ...
      Var_15 = ((MR_Word) (MR_hl_field(MR_mktag(0), Graph_8, (MR_Integer) 0)));
      ...
      Var_19 = ((MR_Word) (MR_hl_field(MR_mktag(0), Matching_9, (MR_Integer) 1)));
      ...
      else
      {
        ...
        /* direct tailcall eliminated */
        {
          MR_Word next_value_of_Queue0_6 = Queue2_23;
          MR_Word next_value_of_Seen0_7 = Seen_22;
  ...
  MR_Word * STATE_VARIABLE_Queue_7)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      succeeded = ((MR_tag((MR_Word) MaybeAdjBenefitNode_23)) == (MR_mktag((MR_Integer) 1)));
      if (succeeded)
      {
      ...
      if (succeeded)
      {
        ...
        {
          STATE_VARIABLE_Seen_31_31 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
        ...
        {
          NewPath_25 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), NewPath_25, 0) = ((MR_Box) (Var_32));
          MR_hl_field(MR_mktag(1), NewPath_25, 1) = ((MR_Box) (Path_5));
        }
        {
          BenefitNodeAndEdgeList_26 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
      ...
      /* direct tailcall eliminated */
      {
        MR_Word next_value_of_HeadVar__1_1 = CostMatches_17;
        MR_Word next_value_of_STATE_VARIABLE_Seen_0_2 = STATE_VARIABLE_Seen_31_31;
        MR_Word next_value_of_STATE_VARIABLE_Queue_0_6 = STATE_VARIABLE_Queue_33_33;
  ...
  MR_Word * Unmatched_6)
{
  while (MR_TRUE)
  {
    ...
    if (succeeded)
    {
      ...
      if ((MaybeBenefitNode_4 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
      {
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      /* direct tailcall eliminated */
      {
        ...
        MR_Word next_value_of_HeadVar__2_2 = Q1_9;
  ...
  MR_Word Matching0_2)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      TypeCtorInfo_16_16 = (MR_Word) &backend_libs__matching__backend_libs__matching__type_ctor_info_cost_node_0;
      TypeCtorInfo_17_17 = (MR_Word) &backend_libs__matching__backend_libs__matching__type_ctor_info_benefit_node_0;
      mercury__map__set_4_p_0(TypeCtorInfo_16_16, TypeCtorInfo_17_17, ((MR_Box) (CostNode_6)), ((MR_Box) (BenefitNode_5)), CostToBenefitMap0_10, &CostToBenefitMap1_12);
      mercury__map__set_4_p_0(TypeCtorInfo_17_17, TypeCtorInfo_16_16, ((MR_Box) (BenefitNode_5)), ((MR_Box) (CostNode_6)), BenefitToCostMap0_11, &BenefitToCostMap1_13);
      {
        Matching1_14 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
      ...
      /* direct tailcall eliminated */
      {
        MR_Word next_value_of_HeadVar__1_1 = Path_7;
        MR_Word next_value_of_Matching0_2 = Matching1_14;
...
{
  {
    ...
    {
      Graph_4 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
...
{
  {
    ...
    else
    {
      ...
      {
        Var_8 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), Var_8, 0) = ((MR_Box) (HeadVar__1_1));
        MR_hl_field(MR_mktag(0), Var_8, 1) = ((MR_Box) (Segment_6));
      }
      Var_10 = (HeadVar__1_1 + (MR_Integer) 1);
