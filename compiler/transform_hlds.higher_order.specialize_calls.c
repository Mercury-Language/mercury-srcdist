...
transform_hlds__higher_order__specialize_calls__IntroducedFrom__pred__find_typeclass_info_components__1852__1_2_p_0(
  MR_Word TCIConstConsId_27,
  MR_Word HeadVar__2_38);

static MR_bool MR_CALL 
transform_hlds__higher_order__specialize_calls__IntroducedFrom__pred__arg_contains_type_info_for_tvar__1594__1_2_p_0(
  ...
  MR_Box * wrapper_arg_2)
{
  ...
  succeeded = transform_hlds__higher_order__specialize_calls__IntroducedFrom__pred__arg_contains_type_info_for_tvar__1594__1_2_p_0(((MR_Word) (wrapper_arg_1)), &conv0_LambdaHeadVar__2_24);
  if (succeeded)
  {
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = transform_hlds__higher_order__specialize_calls__IntroducedFrom__pred__find_typeclass_info_components__1852__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 4)))));
  return succeeded;
}
        ...
        {
          {
            ...
            if ((env).transform_hlds__higher_order__specialize_calls__find_matching_version_7_p_0_env_0__succeeded)
            {
              ...
              (env).transform_hlds__higher_order__specialize_calls__find_matching_version_7_p_0_env_0__succeeded = hlds__hlds_pred__marker_is_present_2_p_0(Markers_40, (MR_Integer) 11);
              if (!((env).transform_hlds__higher_order__specialize_calls__find_matching_version_7_p_0_env_0__succeeded))
                (env).transform_hlds__higher_order__specialize_calls__find_matching_version_7_p_0_env_0__succeeded = hlds__hlds_pred__marker_is_present_2_p_0(Markers_40, (MR_Integer) 12);
            }
          }
          if (!((env).transform_hlds__higher_order__specialize_calls__find_matching_version_7_p_0_env_0__succeeded))
          {
