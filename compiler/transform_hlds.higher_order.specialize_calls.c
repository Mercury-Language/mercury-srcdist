...
transform_hlds__higher_order__specialize_calls__IntroducedFrom__pred__find_typeclass_info_components__1855__1_2_p_0(
  MR_Word TCIConstConsId_27,
  MR_Word HeadVar__2_38);

static MR_bool MR_CALL 
transform_hlds__higher_order__specialize_calls__IntroducedFrom__pred__arg_contains_type_info_for_tvar__1597__1_2_p_0(
  ...
  MR_Box * wrapper_arg_2)
{
  ...
  succeeded = transform_hlds__higher_order__specialize_calls__IntroducedFrom__pred__arg_contains_type_info_for_tvar__1597__1_2_p_0(((MR_Word) (wrapper_arg_1)), &conv0_LambdaHeadVar__2_24);
  if (succeeded)
  {
  ...
  MR_Word * STATE_VARIABLE_Info_74)
{
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          TypeInfo_98_98 = (MR_Word) (&transform_hlds__higher_order__specialize_calls_scalar_common_1[4]);
  ...
  if (succeeded)
  {
    ...
    Args1_37 = mercury__list__f_43_43_2_f_0((MR_Word) (&transform_hlds__higher_order__specialize_calls_scalar_common_1[1]), Args0_21, UncurriedArgs_35);
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        succeeded = mercury__list__remove_suffix_3_p_0((MR_Word) (&transform_hlds__higher_order__specialize_calls_scalar_common_1[1]), NewArgs0_47, UncurriedArgs_35, &NewArgs1_51);
      }
      if (succeeded)
      {
      ...
      Var_82 = mercury__list__length_1_f_0((MR_Word) (&transform_hlds__higher_order__specialize_calls_scalar_common_1[1]), NewArgs_54);
  ...
  MR_Word * STATE_VARIABLE_Info_23)
{
  ...
  if (succeeded)
  {
    ...
    AllArgs_19 = mercury__list__f_43_43_2_f_0((MR_Word) (&transform_hlds__higher_order__specialize_calls_scalar_common_1[1]), CurriedArgs_14, Args_8);
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = transform_hlds__higher_order__specialize_calls__IntroducedFrom__pred__find_typeclass_info_components__1855__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 4)))));
  return succeeded;
}
  ...
  MR_Word * STATE_VARIABLE_Info_77)
{
  ...
  Var_78 = transform_hlds__higher_order__higher_order_info__hoi_get_global_info_1_f_0(STATE_VARIABLE_Info_0_76);
  ModuleInfo0_22 = transform_hlds__higher_order__higher_order_global_info__hogi_get_module_info_1_f_0(Var_78);
  ...
  CallerProcInfo0_27 = transform_hlds__higher_order__higher_order_info__hoi_get_proc_info_1_f_0(STATE_VARIABLE_Info_0_76);
  ...
  Var_79 = transform_hlds__higher_order__higher_order_info__hoi_get_known_var_map_1_f_0(STATE_VARIABLE_Info_0_76);
  Var_81 = mercury__cord__init_0_f_0((MR_Word) (&transform_hlds__higher_order__higher_order_global_info__transform_hlds__higher_order__higher_order_global_info__type_ctor_info_higher_order_arg_0));
  transform_hlds__higher_order__specialize_calls__find_higher_order_args_10_p_0(ModuleInfo0_22, CalleeStatus_23, Args0_16, CalleeArgTypes_26, VarTable_28, RttiVarMaps_29, Var_79, (MR_Integer) 1, Var_81, &HigherOrderArgsCord_30);
  ...
  Var_82 = transform_hlds__higher_order__higher_order_info__hoi_get_pred_proc_id_1_f_0(STATE_VARIABLE_Info_0_76);
  CallerPredId_32 = ((MR_Word) ((MR_hl_field(0, Var_82, (MR_Integer) 0))));
  ...
  if (!(succeeded))
  {
    ...
    if (!(succeeded))
    {
      ...
      MR_Word Var_84;
      MR_Word TVarSet_96;
      MR_Word TypeRenaming_97;
      MR_Word CalleeArgTypes1_98;
      MR_Word TypeSubn_99;
      MR_Word CalleeUnivConstraints1_100;
      MR_Word CalleeUnivConstraints_101;

      Var_83 = transform_hlds__higher_order__higher_order_info__hoi_get_global_info_1_f_0(STATE_VARIABLE_Info_0_76);
      Params_42 = transform_hlds__higher_order__higher_order_global_info__hogi_get_params_1_f_0(Var_83);
      Var_84 = ((MR_Unsigned) ((MR_hl_field(0, Params_42, (MR_Integer) 0))) & (MR_Integer) 1);
      ...
      if (succeeded)
      {
        ...
        CallerPredInfo0_49 = transform_hlds__higher_order__higher_order_info__hoi_get_pred_info_1_f_0(STATE_VARIABLE_Info_0_76);
        ...
        if (succeeded)
        {
          parse_tree__prog_data__tvarset_merge_renaming_4_p_0(TVarSet_50, CalleeTVarSet_47, &TVarSet_96, &TypeRenaming_97);
          parse_tree__prog_type_subst__apply_variable_renaming_to_type_list_3_p_0(TypeRenaming_97, CalleeArgTypes_26, &CalleeArgTypes1_98);
          parse_tree__prog_type_unify__compute_caller_callee_type_substitution_5_p_0(CalleeArgTypes1_98, ArgTypes_43, CallerUnivQTVars_51, CalleeExistQTVars_48, &TypeSubn_99);
          parse_tree__prog_type_subst__apply_variable_renaming_to_prog_constraint_list_3_p_0(TypeRenaming_97, CalleeUnivConstraints0_45, &CalleeUnivConstraints1_100);
          parse_tree__prog_type_subst__apply_rec_subst_to_prog_constraint_list_3_p_0(TypeSubn_99, CalleeUnivConstraints1_100, &CalleeUnivConstraints_101);
          succeeded = transform_hlds__higher_order__specialize_calls__some_updated_constraint_makes_an_instance_known_loop_4_p_0(ModuleInfo0_22, TVarSet_96, CalleeUnivConstraints0_45, CalleeUnivConstraints_101);
        }
      }
    }
  }
  if (succeeded)
  {
    ...
    transform_hlds__higher_order__specialize_calls__find_matching_version_7_p_0(STATE_VARIABLE_Info_0_76, CalleePredProcId_13, Args0_16, HigherOrderArgs_31, RequestKind_39, Context_52, &FindResult_53);
      ...
      case (MR_Integer) 1:
        {
          ...
          transform_hlds__higher_order__specialize_calls__construct_extra_type_infos_5_p_0(ExtraTypeInfoTypes_58, &ExtraTypeInfoVars_69, &ExtraTypeInfoGoals_70, STATE_VARIABLE_Info_0_76, &STATE_VARIABLE_Info_85_85);
          ...
          Args_73 = mercury__list__f_43_43_2_f_0((MR_Word) (&transform_hlds__higher_order__specialize_calls_scalar_common_1[1]), ExtraTypeInfoVars_69, Args1_57);
          {
          ...
          transform_hlds__higher_order__higher_order_info__hoi_set_changed_3_p_0((MR_Integer) 0, STATE_VARIABLE_Info_85_85, STATE_VARIABLE_Info_77);
        }
        break;
      case (MR_Integer) 2:
        {
          ...
          switch (CanRequest_12) {
            ...
            case (MR_Integer) 1:
              *STATE_VARIABLE_Info_77 = STATE_VARIABLE_Info_0_76;
              break;
            case (MR_Integer) 0:
              transform_hlds__higher_order__higher_order_info__hoi_add_request_3_p_0(Request_75, STATE_VARIABLE_Info_0_76, STATE_VARIABLE_Info_77);
              break;
          }
        }
        break;
  ...
  MR_Box * wrapper_arg_2)
{
  ...
  transform_hlds__higher_order__specialize_calls__IntroducedFrom__pred__find_matching_version__1486__1_3_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) (wrapper_arg_1)), &conv2_LambdaHeadVar__2_45);
  ...
  MR_Word * Result_14)
{
  ...
  (env).transform_hlds__higher_order__specialize_calls__find_matching_version_7_p_0_env_0__HigherOrderArgs_11 = HigherOrderArgs_11;
  {
    ...
    else
    {
      ...
      mercury__list__foldl_4_p_0((MR_Word) (&transform_hlds__higher_order__specialize_calls_scalar_common_1[1]), (MR_Word) (&transform_hlds__higher_order__specialize_calls_scalar_common_1[5]), Var_86, Args_22, ((MR_Box) ((MR_Unsigned) 0U)), &conv1_TypeInfoTVars_84);
      TypeInfoTVars_84 = ((MR_Word) (conv1_TypeInfoTVars_84));
      mercury__list__delete_elems_3_p_0((MR_Word) (&transform_hlds__higher_order__specialize_calls_scalar_common_1[3]), AllTVars_82, TypeInfoTVars_84, &ExtraTypeInfoTVars0_85);
      mercury__list__remove_dups_2_p_0((MR_Word) (&transform_hlds__higher_order__specialize_calls_scalar_common_1[3]), ExtraTypeInfoTVars0_85, &ExtraTypeInfoTVars_23);
    }
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      else
      {
        ...
        succeeded = mercury__map__search_3_p_0((MR_Word) (&transform_hlds__higher_order__specialize_calls_scalar_common_1[1]), (MR_Word) (&transform_hlds__higher_order__higher_order_global_info__transform_hlds__higher_order__higher_order_global_info__type_ctor_info_known_const_0), KnownVarMap_7, ((MR_Box) (Var_86)), &conv0_Var_69);
        if (succeeded)
        {
        ...
        if (succeeded)
        {
          ...
          mercury__list__map_3_p_0((MR_Word) (&transform_hlds__higher_order__specialize_calls_scalar_common_1[1]), (MR_Word) (&hlds__hlds_rtti__hlds__hlds_rtti__type_ctor_info_rtti_var_info_0), Var_73, CurriedArgs_46, &CurriedArgRttiInfo_53);
          succeeded = ((((MR_tag((MR_Word) ConsId_45)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(3, ConsId_45, (MR_Integer) 0)))) == (MR_Integer) 4)));
          if (succeeded)
          {
          ...
          mercury__list__length_2_p_0((MR_Word) (&transform_hlds__higher_order__specialize_calls_scalar_common_1[1]), CurriedArgs_46, &NumCurriedArgs_62);
