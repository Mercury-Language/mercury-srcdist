...
transform_hlds__higher_order__specialize_calls__IntroducedFrom__pred__find_typeclass_info_components__1861__1_2_p_0(
  MR_Word TCIConstConsId_27,
  MR_Word HeadVar__2_38);

static MR_bool MR_CALL 
transform_hlds__higher_order__specialize_calls__IntroducedFrom__pred__arg_contains_type_info_for_tvar__1599__1_2_p_0(
  MR_Word LambdaHeadVar__1_23,
  MR_Word * LambdaHeadVar__2_24);

static void MR_CALL 
transform_hlds__higher_order__specialize_calls__IntroducedFrom__pred__find_matching_version__1492__1_3_p_0(
  MR_Word VarTable_24,
  MR_Word LambdaHeadVar__1_43,
  MR_Word * LambdaHeadVar__2_44);

static MR_bool MR_CALL 
transform_hlds__higher_order__specialize_calls__IntroducedFrom__pred__merge_common_var_const_list__603__1_2_p_0(
  MR_Word VarA_22,
  MR_Word VarB_25);

static MR_bool MR_CALL 
transform_hlds__higher_order__specialize_calls__IntroducedFrom__pred__merge_post_branch_infos_into_one__510__1_2_p_0(
  ...
  MR_Box * wrapper_arg_2)
{
  ...
  succeeded = transform_hlds__higher_order__specialize_calls__IntroducedFrom__pred__arg_contains_type_info_for_tvar__1599__1_2_p_0(((MR_Word) (wrapper_arg_1)), &conv0_LambdaHeadVar__2_24);
  if (succeeded)
  {
  ...
  MR_Word * STATE_VARIABLE_GlobalInfo_19)
{
  ...
  succeeded = mercury__map__search_3_p_0((MR_Word) (&hlds__pred_proc_id__hlds__pred_proc_id__type_ctor_info_pred_proc_id_0), (MR_Word) (&transform_hlds__higher_order__higher_order_global_info__transform_hlds__higher_order__higher_order_global_info__type_ctor_info_version_info_0), VersionInfoMap_21, ((MR_Box) (Var_30)), &conv0_VersionInfo_22);
  if (succeeded)
  {
  ...
  hlds__hlds_proc__proc_info_get_goal_2_p_0(Var_32, &Goal0_27);
  ...
  if (succeeded)
  {
    ...
    hlds__hlds_proc__proc_info_set_goal_3_p_0(Goal_28, STATE_VARIABLE_ProcInfo_1_45, &STATE_VARIABLE_ProcInfo_2_46);
    hlds__quantification__requantify_proc_general_3_p_1((MR_Integer) 1, STATE_VARIABLE_ProcInfo_2_46, &STATE_VARIABLE_ProcInfo_3_48);
    hlds__hlds_proc__proc_info_get_goal_2_p_0(STATE_VARIABLE_ProcInfo_3_48, &STATE_VARIABLE_Goal_1_49);
    hlds__hlds_proc_util__proc_info_get_initial_instmap_3_p_0(ModuleInfo0_36, STATE_VARIABLE_ProcInfo_3_48, &InstMap_37);
    hlds__hlds_proc__proc_info_get_var_table_2_p_0(STATE_VARIABLE_ProcInfo_3_48, &VarTable_38);
    hlds__hlds_proc__proc_info_get_inst_varset_2_p_0(STATE_VARIABLE_ProcInfo_3_48, &InstVarSet_39);
    ...
    hlds__hlds_proc__proc_info_set_goal_3_p_0(STATE_VARIABLE_Goal_2_51, STATE_VARIABLE_ProcInfo_3_48, &STATE_VARIABLE_ProcInfo_4_52);
  ...
  MR_Box * wrapper_arg_2)
{
  ...
  succeeded = transform_hlds__higher_order__specialize_calls__IntroducedFrom__pred__merge_post_branch_infos_into_one__510__1_2_p_0(((MR_Word) (wrapper_arg_1)), &conv0_LambdaHeadVar__2_13);
  if (succeeded)
  {
  ...
  MR_Word * STATE_VARIABLE_Info_72)
{
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          CalleePredProcId_27 = hlds__pred_proc_id__unshroud_pred_proc_id_1_f_0(ShroudedPredProcId_26);
          TypeCtorInfo_95_95 = (MR_Word) (&hlds__pred_proc_id__hlds__pred_proc_id__type_ctor_info_pred_proc_id_0);
          ...
          if (succeeded)
          {
            hlds__hlds_proc__proc_info_get_var_table_2_p_0(ProcInfo0_13, &VarTable0_28);
  ...
  if (succeeded)
  {
    ...
    else
    {
      ...
      hlds__hlds_proc__proc_info_get_argmodes_2_p_0(NewCalleeProcInfo_53, &NewCalleeArgModes_54);
      ...
      hlds__hlds_proc__proc_info_get_var_table_2_p_0(ProcInfo2_58, &VarTable2_59);
      parse_tree__var_table__delete_var_entries_3_p_0(UncurriedArgs_33, VarTable2_59, &VarTable_60);
      hlds__hlds_proc__proc_info_set_var_table_3_p_0(VarTable_60, ProcInfo2_58, &ProcInfo_61);
      ...
      NewShroudedPredProcId_63 = hlds__pred_proc_id__shroud_pred_proc_id_1_f_0(NewPredProcId_62);
    ...
    {
      {
        ...
        if (succeeded)
        {
          ...
          TypeCtorInfo_44_44 = (MR_Word) (&hlds__pred_proc_id__hlds__pred_proc_id__type_ctor_info_pred_proc_id_0);
          {
      ...
      {
        {
          ...
          if (succeeded)
          {
            hlds__pred_proc_id__in_in_unification_proc_id_1_p_0(&Var_46);
      ...
      else
      {
        ...
        else
        {
          ...
          hlds__goal_list_util__goal_to_conj_list_2_p_0(Var_41, &GoalList1_29);
  ...
  MR_Word * STATE_VARIABLE_Info_73)
{
  ...
  else
  {
    ...
    hlds__hlds_proc__proc_info_get_rtti_varmaps_2_p_0(CallerProcInfo0_52, &CallerRttiVarMaps_53);
    ...
    if (succeeded)
    {
      ...
      hlds__goal_list_util__conj_list_to_goal_3_p_0(Var_94, GoalInfo0_16, Goal_12);
    }
    else
    {
      *Goal_12 = Goal0_11;
  ...
  MR_Word * STATE_VARIABLE_Info_22)
{
  ...
  if (succeeded)
  {
    ...
    Var_24 = hlds__pred_proc_id__unshroud_pred_proc_id_1_f_0(ShroudedPredProcId_15);
  ...
  MR_Word * STATE_VARIABLE_Info_25)
{
  ...
  Builtin_21 = hlds__hlds_pred_tests__builtin_state_4_f_0(ModuleInfo_14, CallerPredId_19, PredId_8, ProcId_9);
  {
    ...
    {
      {
        ...
        if (succeeded)
        {
          ...
          TypeCtorInfo_44_59 = (MR_Word) (&hlds__pred_proc_id__hlds__pred_proc_id__type_ctor_info_pred_proc_id_0);
          {
      ...
      {
        {
          ...
          if (succeeded)
          {
            hlds__pred_proc_id__in_in_unification_proc_id_1_p_0(&Var_61);
      ...
      else
      {
        ...
        else
        {
          ...
          hlds__goal_list_util__goal_to_conj_list_2_p_0(Var_56, &GoalList1_49);
  ...
  MR_Word * STATE_VARIABLE_Info_60)
{
  ...
  if (succeeded)
  {
    ...
    else
    {
      ...
      hlds__hlds_proc__proc_info_get_rtti_varmaps_2_p_0(ProcInfo0_35, &RttiVarMaps0_36);
      hlds__hlds_rtti__rtti_var_info_duplicate_replace_4_p_0(SelectedArg_32, OutputVar_16, RttiVarMaps0_36, &RttiVarMaps_37);
      hlds__hlds_proc__proc_info_set_rtti_varmaps_3_p_0(RttiVarMaps_37, ProcInfo0_35, &ProcInfo_38);
      ...
      hlds__hlds_proc__proc_info_get_var_table_2_p_0(ProcInfo_38, &VarTable_39);
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = transform_hlds__higher_order__specialize_calls__IntroducedFrom__pred__find_typeclass_info_components__1861__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) ((MR_hl_field(0, closure, 4)))));
  return succeeded;
}
  ...
  MR_Word * STATE_VARIABLE_Info_76)
{
  ...
  hlds__hlds_proc__proc_info_get_var_table_2_p_0(CalleeProcInfo_15, &CalleeVarTable_24);
  hlds__hlds_proc__proc_info_get_headvars_2_p_0(CalleeProcInfo_15, &CalleeHeadVars_25);
  ...
  hlds__hlds_proc__proc_info_get_var_table_2_p_0(CallerProcInfo0_27, &VarTable_28);
  hlds__hlds_proc__proc_info_get_rtti_varmaps_2_p_0(CallerProcInfo0_27, &RttiVarMaps_29);
  ...
  succeeded = mercury__set__contains_2_p_0((MR_Word) (&hlds__pred_proc_id__hlds__pred_proc_id__type_ctor_info_pred_id_0), ForceVersions_36, ((MR_Box) (CallerPredId_32)));
  if (succeeded)
  ...
  MR_Box * wrapper_arg_2)
{
  ...
  transform_hlds__higher_order__specialize_calls__IntroducedFrom__pred__find_matching_version__1492__1_3_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) (wrapper_arg_1)), &conv2_LambdaHeadVar__2_44);
  ...
  MR_Word * Result_14)
{
  ...
  (env).transform_hlds__higher_order__specialize_calls__find_matching_version_7_p_0_env_0__HigherOrderArgs_11 = HigherOrderArgs_11;
  {
    ...
    hlds__hlds_proc__proc_info_get_var_table_2_p_0(ProcInfo_76, &VarTable_77);
    ...
    else
    {
      ...
      hlds__hlds_proc__proc_info_get_rtti_varmaps_2_p_0(ProcInfo_76, &RttiVarMaps_80);
      {
        Var_83 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
    ...
    hlds__hlds_proc__proc_info_get_var_table_2_p_0(ProcInfo_21, &VarTable_24);
    {
    ...
    (env).transform_hlds__higher_order__specialize_calls__find_matching_version_7_p_0_env_0__succeeded = mercury__map__search_3_p_0((MR_Word) (&hlds__pred_proc_id__hlds__pred_proc_id__type_ctor_info_pred_proc_id_0), (MR_Word) (&transform_hlds__higher_order__specialize_calls_scalar_common_1[4]), NewPredMap_18, ((MR_Box) (CalleePredProcId_9)), &conv3_VersionSet_31);
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            ShroudedPredProcId_53 = (MR_Word) (MR_body((MR_Word) (ConsId_45), (MR_Integer) 2));
            {
              ...
              Var_72 = hlds__pred_proc_id__unshroud_pred_proc_id_1_f_0(ShroudedPredProcId_53);
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = transform_hlds__higher_order__specialize_calls__IntroducedFrom__pred__merge_common_var_const_list__603__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) ((MR_hl_field(0, closure, 4)))));
  return succeeded;
}
  ...
  MR_Word * STATE_VARIABLE_GlobalInfo_23)
{
  ...
  CodegenProcIds_11 = hlds__hlds_pred__pred_info_will_codegen_proc_ids_1_f_0(PredInfo0_10);
  if ((CodegenProcIds_11 == (MR_Word) ((MR_Unsigned) 0U)))
  {
  ...
  {
    MR_Integer FirstProcId_12 = ((MR_Integer) ((MR_hl_field(1, CodegenProcIds_11, 0))));
    ...
    mercury__list__map_foldl_5_p_0((MR_Word) (&hlds__pred_proc_id__hlds__pred_proc_id__type_ctor_info_proc_id_0), (MR_Word) (&transform_hlds__higher_order__specialize_calls_scalar_common_1[0]), (MR_Word) (&transform_hlds__higher_order__higher_order_global_info__transform_hlds__higher_order__higher_order_global_info__type_ctor_info_higher_order_global_info_0), Var_24, CodegenProcIds_11, &NewRequestSets_14, ((MR_Box) (STATE_VARIABLE_GlobalInfo_0_22)), &conv2_STATE_VARIABLE_GlobalInfo_1_25);
    ...
    hlds__hlds_proc__proc_info_get_goal_2_p_0(FirstProcInfo_17, &FirstProcGoal_18);
