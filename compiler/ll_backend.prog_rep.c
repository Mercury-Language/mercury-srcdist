    ...
    switch (MR_tag((MR_Word) HeadVar__1_1)) {
      ...
      case (MR_Integer) 3:
        switch (((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), HeadVar__1_1, (MR_Integer) 0)))) {
          ...
          case (MR_Integer) 2:
            {
              ...
              {
                MR_Word Var_43 = ((MR_Word) (MR_hl_field(MR_mktag(1), SymName_3, (MR_Integer) 0)));
          ...
          case (MR_Integer) 13:
            {
              MR_Integer Int64_15 = ((MR_Integer) (MR_hl_field(MR_mktag(3), HeadVar__1_1, (MR_Integer) 1)));

              HeadVar__2_2 = mercury__string__int_to_string_1_f_0(Int64_15);
            }
            break;
          case (MR_Integer) 14:
            {
              MR_Integer UInt64_16 = ((MR_Integer) (MR_hl_field(MR_mktag(3), HeadVar__1_1, (MR_Integer) 1)));

              HeadVar__2_2 = mercury__string__int_to_string_1_f_0(UInt64_16);
            }
            break;
          case (MR_Integer) 15:
            {
