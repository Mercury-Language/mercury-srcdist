    ...
    switch (MR_tag((MR_Word) HeadVar__1_1)) {
      ...
      case (MR_Integer) 3:
        switch (((MR_Integer) ((MR_hl_field(MR_mktag(3), HeadVar__1_1, (MR_Integer) 0))))) {
          ...
          case (MR_Integer) 18:
            {
              MR_Word IDCKind_23 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(3), HeadVar__1_1, (MR_Integer) 1))) & (MR_Integer) 7);

              HeadVar__2_2 = parse_tree__prog_data__impl_defined_const_kind_to_str_1_f_0(IDCKind_23);
            }
            break;
          case (MR_Integer) 19:
