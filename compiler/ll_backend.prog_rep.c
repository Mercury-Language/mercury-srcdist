  ...
  MR_Word * STATE_VARIABLE_StringTable_17)
{
  ...
  *STATE_VARIABLE_StringTable_17 = ((MR_Word) (conv2_STATE_VARIABLE_StringTable_17));
  Var_53 = mercury__list__length_1_f_0((MR_Word) (&mdbcomp__program_representation__mdbcomp__program_representation__type_ctor_info_cons_id_arity_rep_0), OtherConsIds_11);
  mdbcomp__rtti_access__encode_int32_det_2_p_0(Var_53, &Var_23);
          ...
          case (MR_Integer) 1:
            {
...

              {
                ...
                MR_hl_field(MR_mktag(0), Var_37, 4) = ((MR_Box) (VarTable_13));
              }
