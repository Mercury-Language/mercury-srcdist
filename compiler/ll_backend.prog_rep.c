...
MR_decl_label8(ll_backend__prog_rep__cons_id_and_arity_to_byte_list_4_0, 25,7,9,22,29,3,4,6)
MR_decl_label8(ll_backend__prog_rep__cons_id_and_arity_to_byte_list_4_0, 10,11,13,15,17,18,19,20)
MR_decl_label8(ll_backend__prog_rep__cons_id_and_arity_to_byte_list_4_0, 21,23,24,30,31,32,34,35)
MR_decl_label1(ll_backend__prog_rep__cons_id_and_arity_to_byte_list_4_0, 36)
MR_decl_label8(ll_backend__prog_rep__cons_id_to_byte_list_4_0, 25,7,9,22,29,3,4,6)
MR_decl_label8(ll_backend__prog_rep__cons_id_to_byte_list_4_0, 10,11,13,15,17,18,19,20)
MR_decl_label5(ll_backend__prog_rep__cons_id_to_byte_list_4_0, 21,23,24,30,31)
...
MR_BEGIN_MODULE(ll_backend__prog_rep_module7)
	...
	MR_init_label8(ll_backend__prog_rep__cons_id_to_byte_list_4_0,25,7,9,22,29,3,4,6)
	MR_init_label8(ll_backend__prog_rep__cons_id_to_byte_list_4_0,10,11,13,15,17,18,19,20)
	MR_init_label5(ll_backend__prog_rep__cons_id_to_byte_list_4_0,21,23,24,30,31)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(ll_backend__prog_rep_module8)
	...
	MR_init_label8(ll_backend__prog_rep__cons_id_and_arity_to_byte_list_4_0,25,7,9,22,29,3,4,6)
	MR_init_label8(ll_backend__prog_rep__cons_id_and_arity_to_byte_list_4_0,10,11,13,15,17,18,19,20)
	MR_init_label8(ll_backend__prog_rep__cons_id_and_arity_to_byte_list_4_0,21,23,24,30,31,32,34,35)
	MR_init_label1(ll_backend__prog_rep__cons_id_and_arity_to_byte_list_4_0,36)
MR_BEGIN_CODE
