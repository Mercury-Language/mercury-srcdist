...
MR_def_label(ll_backend__prog_rep__goal_to_goal_rep_4_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!((((((MR_tag(MR_sv(3)) == MR_mktag((MR_Integer) 3)) && ((MR_Integer) MR_tfield(3, MR_sv(3), 0) == (MR_Integer) 1)) || ((MR_tag(MR_sv(3)) == MR_mktag((MR_Integer) 3)) && ((MR_Integer) MR_tfield(3, MR_sv(3), 0) == (MR_Integer) 0))) || (MR_tag(MR_sv(3)) == MR_mktag((MR_Integer) 2))) || (MR_tag(MR_sv(3)) == MR_mktag((MR_Integer) 1))))) {
...
MR_def_label(ll_backend__prog_rep__goal_to_goal_rep_4_0,8)
	...
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_tfield(1, MR_sv(3), 3);
	MR_r4 = MR_tempr1;
