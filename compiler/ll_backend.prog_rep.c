    ...
    switch (MR_tag((MR_Word) ll_backend__prog_rep__HeadVar__1_1)) {
      ...
      case (MR_Integer) 3:
        switch (((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), ll_backend__prog_rep__HeadVar__1_1, (MR_Integer) 0)))) {
          ...
          case (MR_Integer) 6:
            {
              MR_Integer ll_backend__prog_rep__UInt_8 = ((MR_Integer) (MR_hl_field(MR_mktag(3), ll_backend__prog_rep__HeadVar__1_1, (MR_Integer) 1)));

              {
                ll_backend__prog_rep__HeadVar__2_2 = mercury__string__int_to_string_1_f_0(ll_backend__prog_rep__UInt_8);
              }
            }
            break;
          case (MR_Integer) 7:
    ...
    switch (MR_tag((MR_Word) ll_backend__prog_rep__ConsId_3)) {
      ...
      case (MR_Integer) 3:
        switch (((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), ll_backend__prog_rep__ConsId_3, (MR_Integer) 0)))) {
          ...
          case (MR_Integer) 6:
            {
              MR_Integer ll_backend__prog_rep__UInt_12 = ((MR_Integer) (MR_hl_field(MR_mktag(3), ll_backend__prog_rep__ConsId_3, (MR_Integer) 1)));

              {
                ll_backend__prog_rep__ConsIdName_4 = mercury__string__int_to_string_1_f_0(ll_backend__prog_rep__UInt_12);
              }
            }
            break;
          case (MR_Integer) 7:
