...
MR_decl_label8(ll_backend__prog_rep__cases_to_byte_list_6_0, 6,7,9,10,12,13,15,16)
MR_decl_label8(ll_backend__prog_rep__cases_to_byte_list_6_0, 17,18,19,20,21,22,23,24)
MR_decl_label8(ll_backend__prog_rep__cases_to_byte_list_6_0, 25,26,28,29,30,31,32,33)
MR_decl_label2(ll_backend__prog_rep__cases_to_byte_list_6_0, 34,3)
...
MR_decl_label8(ll_backend__prog_rep__goal_expr_to_byte_list_7_0, 153,154,155,156,157,158,159,161)
MR_decl_label8(ll_backend__prog_rep__goal_expr_to_byte_list_7_0, 162,163,165,166,167,168,170,171)
MR_decl_label8(ll_backend__prog_rep__goal_expr_to_byte_list_7_0, 172,174,175,176,177,178,179,180)
MR_decl_label5(ll_backend__prog_rep__goal_expr_to_byte_list_7_0, 181,182,183,184,185)
...
MR_BEGIN_MODULE(ll_backend__prog_rep_module11)
	...
	MR_init_label8(ll_backend__prog_rep__goal_expr_to_byte_list_7_0,153,154,155,156,157,158,159,161)
	MR_init_label8(ll_backend__prog_rep__goal_expr_to_byte_list_7_0,162,163,165,166,167,168,170,171)
	MR_init_label8(ll_backend__prog_rep__goal_expr_to_byte_list_7_0,172,174,175,176,177,178,179,180)
	MR_init_label5(ll_backend__prog_rep__goal_expr_to_byte_list_7_0,181,182,183,184,185)
MR_BEGIN_CODE
...
MR_def_label(ll_backend__prog_rep__goal_expr_to_byte_list_7_0,131)
	...
	MR_COMPUTED_GOTO((MR_Unsigned) MR_ctfield(3, MR_r1, 0),
		...
		MR_LABEL_AP(ll_backend__prog_rep__goal_expr_to_byte_list_7_0_i161) MR_AND
		MR_LABEL_AP(ll_backend__prog_rep__goal_expr_to_byte_list_7_0_i165) MR_AND
		MR_LABEL_AP(ll_backend__prog_rep__goal_expr_to_byte_list_7_0_i174) MR_AND
		MR_LABEL_AP(ll_backend__prog_rep__goal_expr_to_byte_list_7_0_i184));
...
MR_def_label(ll_backend__prog_rep__goal_expr_to_byte_list_7_0,157)
	...
	MR_r3 = MR_sv(5);
	MR_np_call_localret_ent(fn__f_108_105_115_116_95_95_43_43_2_0,
		ll_backend__prog_rep__goal_expr_to_byte_list_7_0_i158);
MR_def_label(ll_backend__prog_rep__goal_expr_to_byte_list_7_0,158)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r3 = MR_r1;
	MR_r1 = (MR_Word) MR_INT_CTOR_ADDR;
	MR_r2 = MR_sv(3);
...
MR_def_label(ll_backend__prog_rep__goal_expr_to_byte_list_7_0,167)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if ((MR_r1 != MR_sv(5))) {
		MR_GOTO_LAB(ll_backend__prog_rep__goal_expr_to_byte_list_7_0_i168);
	}
	MR_r2 = MR_sv(2);
	MR_r3 = MR_sv(3);
	MR_r4 = MR_sv(4);
...
MR_def_label(ll_backend__prog_rep__goal_expr_to_byte_list_7_0,170)
	...
	MR_r1 = (MR_Integer) 5;
	MR_np_call_localret_ent(fn__mdbcomp__program_representation__goal_type_to_byte_1_0,
		ll_backend__prog_rep__goal_expr_to_byte_list_7_0_i171);
...
MR_BEGIN_MODULE(ll_backend__prog_rep_module14)
	...
	MR_init_label8(ll_backend__prog_rep__cases_to_byte_list_6_0,6,7,9,10,12,13,15,16)
	MR_init_label8(ll_backend__prog_rep__cases_to_byte_list_6_0,17,18,19,20,21,22,23,24)
	MR_init_label8(ll_backend__prog_rep__cases_to_byte_list_6_0,25,26,28,29,30,31,32,33)
	MR_init_label2(ll_backend__prog_rep__cases_to_byte_list_6_0,34,3)
MR_BEGIN_CODE
