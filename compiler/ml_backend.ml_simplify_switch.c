...
static /* final */ const MR_Box ml_backend__ml_simplify_switch_scalar_common_4[4][2];

static /* final */ const MR_Box ml_backend__ml_simplify_switch_scalar_common_5[1][7];

static /* final */ const MR_Box ml_backend__ml_simplify_switch_scalar_common_6[5][1];
            ...
            case (MR_Integer) 0:
              {
                ...
                {
                  MR_Word Var_94 = ((MR_Word) (MR_hl_field(MR_mktag(1), CtorCat_79, (MR_Integer) 0)));

                  if ((Var_94 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 1)))))
                    succeeded = MR_TRUE;
                  else
                  if (((MR_tag((MR_Word) Var_94)) == (MR_mktag((MR_Integer) 1))))
                    succeeded = MR_TRUE;
                  else
                    succeeded = MR_FALSE;
                }
                ...
                {
                  MR_Word Var_95 = ((MR_Word) (MR_hl_field(MR_mktag(2), CtorCat_79, (MR_Integer) 0)));
...
{
  {
    ...
    else
    {
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(3), Index_22, 1) = ((MR_Box) (MR_mkword(MR_mktag(2), &ml_backend__ml_simplify_switch_scalar_common_6[2])));
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(3), StartComment_32, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &ml_backend__ml_simplify_switch_scalar_common_6[3])));
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(3), EndComment_35, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &ml_backend__ml_simplify_switch_scalar_common_6[4])));
  ...
  MR_Word * STATE_VARIABLE_Info_7)
{
  ...
  else
  {
    ...
    Context_45 = ml_backend__ml_util__get_mlds_stmt_context_1_f_0(CaseStmt_43);
    {
      ...
      MR_hl_field(MR_mktag(3), LabelComment_46, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &ml_backend__ml_simplify_switch_scalar_common_6[0])));
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(3), JumpComment_48, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &ml_backend__ml_simplify_switch_scalar_common_6[1])));
...
{
  {
    ...
    if ((HeadVar__1_1 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
    {
      HeadVar__3_3 = (MR_Word) MR_mkword(MR_mktag(3), &ml_backend__ml_simplify_switch_scalar_common_4[0]);
    }
    else
    {
      ...
      if ((Var_18 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
        if (((MR_tag((MR_Word) Var_19)) == (MR_mktag((MR_Integer) 1))))
        {
...

          {
            ...
            MR_hl_field(MR_mktag(3), Var_28, 1) = ((MR_Box) (MR_mkword(MR_mktag(3), &ml_backend__ml_simplify_switch_scalar_common_4[1])));
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(3), Var_31, 1) = ((MR_Box) (MR_mkword(MR_mktag(3), &ml_backend__ml_simplify_switch_scalar_common_4[2])));
        ...
        else
        {
...

          {
            HeadVar__3_3 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(3), HeadVar__3_3, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 3));
            MR_hl_field(MR_mktag(3), HeadVar__3_3, 1) = ((MR_Box) (MR_mkword(MR_mktag(3), &ml_backend__ml_simplify_switch_scalar_common_4[3])));
      ...
      else
      {
        ...
        if (((MR_tag((MR_Word) Var_19)) == (MR_mktag((MR_Integer) 1))))
        {
...

          {
            ...
            MR_hl_field(MR_mktag(3), Var_42, 1) = ((MR_Box) (MR_mkword(MR_mktag(3), &ml_backend__ml_simplify_switch_scalar_common_4[1])));
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(3), Var_45, 1) = ((MR_Box) (MR_mkword(MR_mktag(3), &ml_backend__ml_simplify_switch_scalar_common_4[2])));
        ...
        else
        {
...

          {
            Var_15 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(3), Var_15, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 3));
            MR_hl_field(MR_mktag(3), Var_15, 1) = ((MR_Box) (MR_mkword(MR_mktag(3), &ml_backend__ml_simplify_switch_scalar_common_4[3])));
          ...
          case (MR_Integer) 0:
            {
              ...
              switch (MR_tag((MR_Word) CtorCat_16)) {
                ...
                case (MR_Integer) 1:
                  {
                    MR_Word Var_31 = ((MR_Word) (MR_hl_field(MR_mktag(1), CtorCat_16, (MR_Integer) 0)));

                    switch (MR_tag((MR_Word) Var_31)) {
                      default: /*NOTREACHED*/ MR_assert(0);
                      case (MR_Integer) 0:
                        switch (MR_unmkbody(Var_31)) {
                          default: /*NOTREACHED*/ MR_assert(0);
                          case (MR_Integer) 0:
                            IsIntegral_4 = (MR_Integer) 0;
                            break;
                ...
                case (MR_Integer) 2:
                  {
                    MR_Word Var_32 = ((MR_Word) (MR_hl_field(MR_mktag(2), CtorCat_16, (MR_Integer) 0)));
                ...
                case (MR_Integer) 3:
                  switch (((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), CtorCat_16, (MR_Integer) 0)))) {
                    ...
                    case (MR_Integer) 1:
                      {
                        MR_Word Var_33 = ((MR_Word) (MR_hl_field(MR_mktag(3), CtorCat_16, (MR_Integer) 1)));

                        IsIntegral_4 = ((&ml_backend__ml_simplify_switch_vector_common_2[0 + Var_33]))->ml_backend__ml_simplify_switch__vector_common_type_2_0__vct_2_f_0;
                      }
                      break;
                  }
                  break;
