  ...
  MR_Word * STATE_VARIABLE_Info_7)
{
  ...
  else
  {
    ...
    ml_backend__ml_simplify_switch__insert_case_into_map_4_p_0(ThisLabel_44, FirstCond_41, STATE_VARIABLE_CaseLabelsMap_0_3, &STATE_VARIABLE_CaseLabelsMap_27_51);
    {
      ...
      MR_hl_field(MR_mktag(0), Var_52, 0) = ((MR_Box) (&ml_backend__ml_simplify_switch_scalar_common_5[0]));
    ...
    {
      LabelComment_46 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(3), LabelComment_46, 0) = ((MR_Box) ((MR_Unsigned) 8U));
      MR_hl_field(MR_mktag(3), LabelComment_46, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &ml_backend__ml_simplify_switch_scalar_common_2[3])));
      MR_hl_field(MR_mktag(3), LabelComment_46, 2) = ((MR_Box) (Context_45));
    }
    {
      LabelCode_47 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(3), LabelCode_47, 0) = ((MR_Box) ((MR_Unsigned) 1U));
      MR_hl_field(MR_mktag(3), LabelCode_47, 1) = ((MR_Box) (ThisLabel_44));
      MR_hl_field(MR_mktag(3), LabelCode_47, 2) = ((MR_Box) (Context_45));
    }
    {
      JumpComment_48 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(3), JumpComment_48, 0) = ((MR_Box) ((MR_Unsigned) 8U));
      MR_hl_field(MR_mktag(3), JumpComment_48, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &ml_backend__ml_simplify_switch_scalar_common_2[4])));
    ...
    {
      JumpCode_49 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(3), JumpCode_49, 0) = ((MR_Box) ((MR_Unsigned) 2U));
