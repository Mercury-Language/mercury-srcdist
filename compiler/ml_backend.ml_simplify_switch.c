...
MR_decl_label7(ml_backend__ml_simplify_switch__generate_cases_8_0, 37,4,5,7,24,25,26)
...
MR_BEGIN_MODULE(ml_backend__ml_simplify_switch_module5)
	...
	MR_init_label7(ml_backend__ml_simplify_switch__generate_cases_8_0,37,4,5,7,24,25,26)
MR_BEGIN_CODE
...
MR_def_static(ml_backend__ml_simplify_switch__generate_cases_8_0)
	...
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
		MR_GOTO_LAB(ml_backend__ml_simplify_switch__generate_cases_8_0_i37);
	}
	MR_r1 = MR_r3;
	MR_r2 = (MR_Word) MR_tbmkword(0, 0);
	MR_r3 = (MR_Word) MR_tbmkword(0, 0);
	MR_proceed();
MR_def_label(ml_backend__ml_simplify_switch__generate_cases_8_0,37)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(7);
	MR_sv(7) = (MR_Word) MR_succip;
	MR_sv(1) = MR_r2;
...
void mercury__ml_backend__ml_simplify_switch__write_out_proc_statics(FILE *deep_fp, FILE *procrep_fp)
{
	MR_write_out_module_proc_reps_start(procrep_fp, &mercury_data__module_layout__ml_backend__ml_simplify_switch);
