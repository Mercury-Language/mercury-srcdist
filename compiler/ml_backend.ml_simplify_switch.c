...
{
  {
    ...
    if (succeeded)
    {
      ...
      switch (MR_tag((MR_Word) Type_9)) {
        ...
        case (MR_Integer) 2:
          {
            MR_Word CtorCat_81 = ((MR_Word) (MR_hl_field(MR_mktag(2), Type_9, (MR_Integer) 1)));
            MR_Word Var_80 = ((MR_Word) (MR_hl_field(MR_mktag(2), Type_9, (MR_Integer) 0)));
            MR_Word Var_82 = ((MR_Word) (MR_hl_field(MR_mktag(2), Type_9, (MR_Integer) 2)));

            if (((MR_tag((MR_Word) CtorCat_81)) == (MR_mktag((MR_Integer) 1))))
            {
              MR_Word Var_94 = ((MR_Word) (MR_hl_field(MR_mktag(1), CtorCat_81, (MR_Integer) 0)));
            ...
            {
              MR_Word Var_95 = ((MR_Word) (MR_hl_field(MR_mktag(2), CtorCat_81, (MR_Integer) 0)));
  ...
  MR_Word * STATE_VARIABLE_CaseLabelsMap_11)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      {
        MR_Integer next_value_of_Min_6 = Var_13;
        MR_Word next_value_of_STATE_VARIABLE_CaseLabelsMap_0_10 = STATE_VARIABLE_CaseLabelsMap_12_12;
...
{
  {
    ...
    switch (MR_tag((MR_Word) MLDSType_3)) {
      ...
      case (MR_Integer) 2:
        {
          MR_Word CtorCat_18 = ((MR_Word) (MR_hl_field(MR_mktag(2), MLDSType_3, (MR_Integer) 1)));
          MR_Word Var_17 = ((MR_Word) (MR_hl_field(MR_mktag(2), MLDSType_3, (MR_Integer) 0)));
          MR_Word Var_19 = ((MR_Word) (MR_hl_field(MR_mktag(2), MLDSType_3, (MR_Integer) 2)));

          switch (MR_tag((MR_Word) CtorCat_18)) {
            default: /*NOTREACHED*/ MR_assert(0);
            case (MR_Integer) 0:
              switch (MR_unmkbody(CtorCat_18)) {
                default: /*NOTREACHED*/ MR_assert(0);
                case (MR_Integer) 0:
                  IsIntegral_4 = (MR_Integer) 0;
                  break;
            ...
            case (MR_Integer) 1:
              {
                MR_Word Var_31 = ((MR_Word) (MR_hl_field(MR_mktag(1), CtorCat_18, (MR_Integer) 0)));
            ...
            case (MR_Integer) 2:
              {
                MR_Word Var_32 = ((MR_Word) (MR_hl_field(MR_mktag(2), CtorCat_18, (MR_Integer) 0)));
              ...
              break;
            case (MR_Integer) 3:
              switch (((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), CtorCat_18, (MR_Integer) 0)))) {
                default: /*NOTREACHED*/ MR_assert(0);
                case (MR_Integer) 0:
                  IsIntegral_4 = (MR_Integer) 0;
                  break;
                case (MR_Integer) 1:
                  {
                    MR_Word Var_33 = ((MR_Word) (MR_hl_field(MR_mktag(3), CtorCat_18, (MR_Integer) 1)));
