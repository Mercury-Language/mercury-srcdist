  ...
  MR_Box * wrapper_arg_3)
{
  ...
  ml_backend__ml_simplify_switch__insert_case_into_map_4_p_0(((MR_String) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) (wrapper_arg_1)), ((MR_Word) (wrapper_arg_2)), &conv0_STATE_VARIABLE_CaseLabelsMap_15);
  ...
  MR_Word * STATE_VARIABLE_Info_7)
{
  ...
  else
  {
    ...
    }
    {
      ...
      MR_hl_field(3, JumpCode_38, 1) = ((MR_Box) (Var_45));
      MR_hl_field(3, JumpCode_38, 2) = ((MR_Box) (Context_34));
    }
    {
      Var_49 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(1, Var_49, 0) = ((MR_Box) (JumpCode_38));
      MR_hl_field(1, Var_49, 1) = ((MR_Box) ((MR_Unsigned) 0U));
    }
    {
      Var_48 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(1, Var_48, 0) = ((MR_Box) (JumpComment_37));
      MR_hl_field(1, Var_48, 1) = ((MR_Box) (Var_49));
    }
    {
      Var_47 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(1, Var_47, 0) = ((MR_Box) (CaseStmt_32));
      MR_hl_field(1, Var_47, 1) = ((MR_Box) (Var_48));
    }
    {
      Var_46 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(1, Var_46, 0) = ((MR_Box) (LabelCode_36));
    ...
    }
    {
      ...
      MR_hl_field(1, CaseStmts_21, 1) = ((MR_Box) (Var_46));
    }
  ...
  switch (MR_tag((MR_Word) MLDSType_3)) {
    ...
    case (MR_Integer) 3:
      switch (((MR_Integer) ((MR_hl_field(3, MLDSType_3, (MR_Integer) 0))))) {
        ...
        case (MR_Integer) 0:
          {
            MR_Word CtorCat_16 = ((MR_Word) ((MR_hl_field(3, MLDSType_3, (MR_Integer) 2))));
            ...
            {
              MR_Word Var_28 = ((MR_Unsigned) ((MR_hl_field(2, CtorCat_16, (MR_Integer) 0))) & (MR_Integer) 1);
