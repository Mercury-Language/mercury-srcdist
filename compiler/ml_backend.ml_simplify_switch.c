      ...
      switch (MR_tag((MR_Word) Type_9)) {
        ...
        case (MR_Integer) 3:
          switch (((MR_Integer) ((MR_hl_field(MR_mktag(3), Type_9, (MR_Integer) 0))))) {
            ...
            case (MR_Integer) 0:
              {
                MR_Word CtorCat_81 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Type_9, (MR_Integer) 2))));

                if (((MR_tag((MR_Word) CtorCat_81)) == (MR_Integer) 1))
                {
                  {
                ...
                if (((MR_tag((MR_Word) CtorCat_81)) == (MR_Integer) 2))
                {
                  MR_Word Var_93 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(2), CtorCat_81, (MR_Integer) 0))) & (MR_Integer) 1);
            ...
            case (MR_Integer) 3:
              {
                IntType_15 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(3), Type_9, (MR_Integer) 1))) & (MR_Integer) 15);
                succeeded = MR_TRUE;
              }
              break;
          }
