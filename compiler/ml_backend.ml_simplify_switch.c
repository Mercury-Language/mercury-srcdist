      ...
      case (MR_Integer) 2:
        {
          ...
          switch (MR_tag((MR_Word) ml_backend__ml_simplify_switch__CtorCat_18)) {
            ...
            case (MR_Integer) 1:
              {
                MR_Word ml_backend__ml_simplify_switch__V_31_31 = ((MR_Word) (MR_hl_field(MR_mktag(1), ml_backend__ml_simplify_switch__CtorCat_18, (MR_Integer) 0)));

                ml_backend__ml_simplify_switch__IsIntegral_4 = ((&ml_backend__ml_simplify_switch_vector_common_2[0 + ml_backend__ml_simplify_switch__V_31_31]))->ml_backend__ml_simplify_switch__vector_common_type_2_0__vct_2_f_0;
              }
              break;
            case (MR_Integer) 2:
              {
                MR_Word ml_backend__ml_simplify_switch__V_32_32 = ((MR_Word) (MR_hl_field(MR_mktag(2), ml_backend__ml_simplify_switch__CtorCat_18, (MR_Integer) 0)));
            ...
            case (MR_Integer) 3:
              switch (((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), ml_backend__ml_simplify_switch__CtorCat_18, (MR_Integer) 0)))) {
                ...
                case (MR_Integer) 1:
                  {
                    MR_Word ml_backend__ml_simplify_switch__V_33_33 = ((MR_Word) (MR_hl_field(MR_mktag(3), ml_backend__ml_simplify_switch__CtorCat_18, (MR_Integer) 1)));

                    switch (ml_backend__ml_simplify_switch__V_33_33) {
                      default: /*NOTREACHED*/ MR_assert(0);
                      case (MR_Integer) 0:
                        ml_backend__ml_simplify_switch__IsIntegral_4 = (MR_Integer) 0;
                        break;
          ...
          case (MR_Integer) 2:
            {
              ...
              if (((MR_tag((MR_Word) ml_backend__ml_simplify_switch__CtorCat_83)) == (MR_mktag((MR_Integer) 1))))
                {
                  MR_Word ml_backend__ml_simplify_switch__V_96_96 = ((MR_Word) (MR_hl_field(MR_mktag(1), ml_backend__ml_simplify_switch__CtorCat_83, (MR_Integer) 0)));

                  switch (ml_backend__ml_simplify_switch__V_96_96) {
                    default:
                      ml_backend__ml_simplify_switch__succeeded = MR_FALSE;
                      break;
                    case (MR_Integer) 3:
              ...
              if (((MR_tag((MR_Word) ml_backend__ml_simplify_switch__CtorCat_83)) == (MR_mktag((MR_Integer) 2))))
                {
                  MR_Word ml_backend__ml_simplify_switch__V_97_97 = ((MR_Word) (MR_hl_field(MR_mktag(2), ml_backend__ml_simplify_switch__CtorCat_83, (MR_Integer) 0)));

                  ml_backend__ml_simplify_switch__succeeded = (ml_backend__ml_simplify_switch__V_97_97 == (MR_Integer) 0);
                }
              else
                ml_backend__ml_simplify_switch__succeeded = MR_FALSE;
            }
            ...
            if (ml_backend__ml_simplify_switch__succeeded)
              {
                ...
                if (ml_backend__ml_simplify_switch__succeeded)
                  {
                    ml_backend__ml_simplify_switch__V_37_37 = (MR_Integer) 321;
                ...
                if (ml_backend__ml_simplify_switch__succeeded)
                  {
                    ...
                    ml_backend__ml_simplify_switch__V_39_39 = (MR_Integer) 434;
                    {
                    ...
                    if (ml_backend__ml_simplify_switch__succeeded)
                      {
                        ml_backend__ml_simplify_switch__V_40_40 = (MR_Integer) 432;
                        {
            ...
            if (ml_backend__ml_simplify_switch__succeeded)
              {
                ...
                if (ml_backend__ml_simplify_switch__succeeded)
                  {
                    ml_backend__ml_simplify_switch__V_44_44 = (MR_Integer) 321;
