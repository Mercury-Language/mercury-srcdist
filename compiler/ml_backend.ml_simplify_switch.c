            ...
            if (ml_backend__ml_simplify_switch__succeeded)
              {
                ...
                if (ml_backend__ml_simplify_switch__succeeded)
                  {
                    ml_backend__ml_simplify_switch__Var_37 = (MR_Integer) 326;
                ...
                if (ml_backend__ml_simplify_switch__succeeded)
                  {
                    ...
                    ml_backend__ml_simplify_switch__Var_39 = (MR_Integer) 442;
                    {
                    ...
                    if (ml_backend__ml_simplify_switch__succeeded)
                      {
                        ml_backend__ml_simplify_switch__Var_40 = (MR_Integer) 440;
                        {
