...
{
  {
    ...
    if (((MR_tag((MR_Word) HeadVar__1_1)) == (MR_Integer) 1))
    {
      ...
      succeeded = ((((MR_tag((MR_Word) MinRval_19)) == (MR_Integer) 3)) && ((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), MinRval_19, (MR_Integer) 0))) == (MR_Integer) 1)));
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          succeeded = ((((MR_tag((MR_Word) MaxRval_20)) == (MR_Integer) 3)) && ((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), MaxRval_20, (MR_Integer) 0))) == (MR_Integer) 1)));
          if (succeeded)
          {
...
{
  {
    ...
    ml_backend__ml_gen_info__ml_gen_info_get_globals_2_p_0(STATE_VARIABLE_Info_0_31, &Globals_8);
    succeeded = ((((MR_tag((MR_Word) Stmt0_5)) == (MR_Integer) 3)) && ((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), Stmt0_5, (MR_Integer) 0))) == (MR_Integer) 0)));
    if (succeeded)
    {
      ...
      switch (MR_tag((MR_Word) Type_9)) {
        ...
        case (MR_Integer) 0:
          switch (MR_unmkbody(Type_9)) {
            ...
            case (MR_Integer) 5:
              {
                IntType_15 = (MR_Integer) 0;
                succeeded = MR_TRUE;
              }
              break;
            case (MR_Integer) 3:
              {
                IntType_15 = (MR_Integer) 1;
                succeeded = MR_TRUE;
              }
              break;
          }
        ...
        case (MR_Integer) 3:
          switch (((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), Type_9, (MR_Integer) 0)))) {
            ...
            case (MR_Integer) 0:
              {
                MR_Word CtorCat_82 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Type_9, (MR_Integer) 3))));

                if (((MR_tag((MR_Word) CtorCat_82)) == (MR_Integer) 1))
                {
                  MR_Word Var_95 = ((MR_Word) ((MR_hl_field(MR_mktag(1), CtorCat_82, (MR_Integer) 0))));

                  if ((Var_95 == (MR_Word) ((MR_Unsigned) 4U)))
                  {
                    IntType_15 = (MR_Integer) 0;
                    succeeded = MR_TRUE;
                  }
                  ...
                  {
                    MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), Var_95, (MR_Integer) 0)));

                    IntType_15 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(1), Var_95, (MR_Integer) 0))) & (MR_Integer) 15);
                    succeeded = MR_TRUE;
                  }
                  else
                    succeeded = MR_FALSE;
                ...
                if (((MR_tag((MR_Word) CtorCat_82)) == (MR_Integer) 2))
                {
                  MR_Word Var_96 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(2), CtorCat_82, (MR_Integer) 0))) & (MR_Integer) 1);
                  MR_Unsigned packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), CtorCat_82, (MR_Integer) 0)));
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          Var_34 = ml_backend__ml_target_util__globals_target_supports_int_type_switch_2_f_0(Globals_8, IntType_15);
          succeeded = (Var_34 == (MR_Integer) 1);
          if (succeeded)
          {
            Var_35 = (MR_Integer) 335;
            Var_36 = (MR_Integer) 1;
          ...
          if (succeeded)
          {
            TypeCtorInfo_67_67 = (MR_Word) (&ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_switch_case_0);
            mercury__list__length_2_p_0(TypeCtorInfo_67_67, Cases_12, &NumCases_16);
            Var_37 = (MR_Integer) 453;
            libs__globals__lookup_int_option_3_p_0(Globals_8, Var_37, &DenseSize_17);
            succeeded = (NumCases_16 >= DenseSize_17);
            if (succeeded)
            {
              Var_38 = (MR_Integer) 451;
              libs__globals__lookup_int_option_3_p_0(Globals_8, Var_38, &ReqDensity_18);
              succeeded = ml_backend__ml_simplify_switch__is_dense_switch_2_p_0(Cases_12, ReqDensity_18);
            }
          }
        }
      }
    ...
    if (succeeded)
    {
      MR_Integer FirstVal_19;
      MR_Integer LastVal_20;
      MR_Word NeedRangeCheck_21;
      MR_Word Stmts_22;

      ml_backend__ml_simplify_switch__maybe_eliminate_default_7_p_0(Range_11, Cases_12, Default_13, ReqDensity_18, &FirstVal_19, &LastVal_20, &NeedRangeCheck_21);
      ml_backend__ml_simplify_switch__f_85_110_117_115_101_100_65_114_103_115_95_95_112_114_101_100_95_95_103_101_110_101_114_97_116_101_95_100_101_110_115_101_95_115_119_105_116_99_104_95_95_91_54_93_95_48_11_p_0(Cases_12, Default_13, FirstVal_19, LastVal_20, NeedRangeCheck_21, Rval_10, Context_14, &Stmts_22, STATE_VARIABLE_Info_0_31, STATE_VARIABLE_Info_32);
      {
        MR_Word base;
        ...
        *Stmt_6 = base;
        ...
        MR_hl_field(MR_mktag(0), base, 2) = ((MR_Box) (Stmts_22));
    ...
    else
    {
      ...
      if (succeeded)
      {
        Type_46 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Stmt0_5, (MR_Integer) 1))));
      ...
      else
      {
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            succeeded = ((MR_tag((MR_Word) Cases_49)) == (MR_Integer) 1);
            if (succeeded)
            {
              SingleCase_27 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Cases_49, (MR_Integer) 0))));
              Var_45 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Cases_49, (MR_Integer) 1))));
              succeeded = (Var_45 == (MR_Word) ((MR_Unsigned) 0U));
            }
          }
        }
        if (succeeded)
          *Stmt_6 = ((MR_Word) ((MR_hl_field(MR_mktag(0), SingleCase_27, (MR_Integer) 2))));
        else
          *Stmt_6 = Stmt0_5;
      }
      ...
      case (MR_Integer) 1:
        {
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(3), InRange_37, 1) = ((MR_Box) ((MR_Unsigned) 44U));
...
{
  {
    ...
    else
    {
      ...
      Var_14 = (MR_Integer) ((MR_Unsigned) ThisVal_6 + (MR_Unsigned) (MR_Integer) 1);
...
{
  {
    ...
    if (((MR_tag((MR_Word) Cond_6)) == (MR_Integer) 1))
    {
      ...
      succeeded = ((((MR_tag((MR_Word) MinRval_10)) == (MR_Integer) 3)) && ((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), MinRval_10, (MR_Integer) 0))) == (MR_Integer) 1)));
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          succeeded = ((((MR_tag((MR_Word) MaxRval_11)) == (MR_Integer) 3)) && ((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), MaxRval_11, (MR_Integer) 0))) == (MR_Integer) 1)));
          if (succeeded)
          {
  ...
  MR_Word * STATE_VARIABLE_CaseLabelsMap_11)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      Var_13 = (MR_Integer) ((MR_Unsigned) Min_6 + (MR_Unsigned) (MR_Integer) 1);
...
{
  {
    ...
    if (succeeded)
    {
      succeeded = ((MR_tag((MR_Word) Range_8)) == (MR_Integer) 1);
      if (succeeded)
      {
    ...
    switch (MR_tag((MR_Word) MLDSType_3)) {
      ...
      case (MR_Integer) 3:
        switch (((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), MLDSType_3, (MR_Integer) 0)))) {
          ...
          case (MR_Integer) 0:
            {
              MR_Word CtorCat_17 = ((MR_Word) ((MR_hl_field(MR_mktag(3), MLDSType_3, (MR_Integer) 3))));

              if (((MR_tag((MR_Word) CtorCat_17)) == (MR_Integer) 1))
              {
                MR_Word Var_30 = ((MR_Word) ((MR_hl_field(MR_mktag(1), CtorCat_17, (MR_Integer) 0))));

                if ((Var_30 == (MR_Word) ((MR_Unsigned) 4U)))
                {
                  *IntType_4 = (MR_Integer) 0;
                  succeeded = MR_TRUE;
                }
                ...
                {
                  MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), Var_30, (MR_Integer) 0)));

                  *IntType_4 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(1), Var_30, (MR_Integer) 0))) & (MR_Integer) 15);
                  succeeded = MR_TRUE;
                }
                else
                  succeeded = MR_FALSE;
              ...
              if (((MR_tag((MR_Word) CtorCat_17)) == (MR_Integer) 2))
              {
                MR_Word Var_31 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(2), CtorCat_17, (MR_Integer) 0))) & (MR_Integer) 1);
                MR_Unsigned packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), CtorCat_17, (MR_Integer) 0)));
