...
{
  {
            ...
            case (MR_Integer) 0:
              {
                ...
                MR_Word Var_80 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Type_9, (MR_Integer) 1))));
                MR_Word Var_81 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Type_9, (MR_Integer) 2))));

                if (((MR_tag((MR_Word) CtorCat_82)) == (MR_mktag((MR_Integer) 1))))
                {
                  MR_Word Var_95 = ((MR_Word) ((MR_hl_field(MR_mktag(1), CtorCat_82, (MR_Integer) 0))));

                  if ((Var_95 == (MR_Word) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 1)))))
                  {
                    IntType_15 = (MR_Integer) 0;
                    succeeded = MR_TRUE;
                  }
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        _Range_23 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Stmt0_5, (MR_Integer) 3))));
      ...
      else
      {
        ...
        if (succeeded)
        {
          _Type_24 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Stmt0_5, (MR_Integer) 1))));
          _Rval_25 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Stmt0_5, (MR_Integer) 2))));
          ...
          _Context_26 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Stmt0_5, (MR_Integer) 6))));
        ...
        if (succeeded)
        {
          MR_Word _FirstCond_28 = ((MR_Word) ((MR_hl_field(MR_mktag(0), SingleCase_27, (MR_Integer) 0))));
          MR_Word _LaterConds_29 = ((MR_Word) ((MR_hl_field(MR_mktag(0), SingleCase_27, (MR_Integer) 1))));
          ...
          case (MR_Integer) 0:
            {
              ...
              MR_Word Var_16 = ((MR_Word) ((MR_hl_field(MR_mktag(3), MLDSType_3, (MR_Integer) 2))));

              if (((MR_tag((MR_Word) CtorCat_17)) == (MR_mktag((MR_Integer) 1))))
              {
                MR_Word Var_30 = ((MR_Word) ((MR_hl_field(MR_mktag(1), CtorCat_17, (MR_Integer) 0))));

                if ((Var_30 == (MR_Word) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 1)))))
                {
                  *IntType_4 = (MR_Integer) 0;
                  succeeded = MR_TRUE;
                }
