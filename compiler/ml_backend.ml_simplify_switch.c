  ...
  MR_Integer * STATE_VARIABLE_Max_5)
{
  ...
  if (((MR_tag((MR_Word) HeadVar__1_1)) == (MR_Integer) 1))
  {
    ...
    succeeded = ((((MR_tag((MR_Word) MinRval_19)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(MR_mktag(3), MinRval_19, (MR_Integer) 0)))) == (MR_Integer) 1)));
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        succeeded = ((((MR_tag((MR_Word) MaxRval_20)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(MR_mktag(3), MaxRval_20, (MR_Integer) 0)))) == (MR_Integer) 1)));
        if (succeeded)
        {
  ...
  MR_Word * STATE_VARIABLE_Info_33)
{
  ...
  succeeded = ((((MR_tag((MR_Word) Stmt0_5)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(MR_mktag(3), Stmt0_5, (MR_Integer) 0)))) == (MR_Integer) 0)));
  if (succeeded)
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          ReqDensity_19 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), OptTuple_17, (MR_Integer) 26))));
          DenseSize_18 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), OptTuple_17, (MR_Integer) 28))));
  ...
  if (succeeded)
  {
    ...
    ml_backend__ml_simplify_switch__f_85_110_117_115_101_100_65_114_103_115_95_95_112_114_101_100_95_95_103_101_110_101_114_97_116_101_95_100_101_110_115_101_95_115_119_105_116_99_104_95_95_91_54_93_95_48_11_p_0(Cases_12, Default_13, FirstVal_20, LastVal_21, NeedRangeCheck_22, Rval_10, Context_14, &Stmts_23, STATE_VARIABLE_Info_0_32, STATE_VARIABLE_Info_33);
    {
      ...
      *Stmt_6 = base;
      ...
      MR_hl_field(MR_mktag(0), base, 2) = ((MR_Box) (Stmts_23));
  ...
  else
  {
    ...
    if (succeeded)
    {
      Type_45 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Stmt0_5, (MR_Integer) 1))));
      Rval_55 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Stmt0_5, (MR_Integer) 2))));
      Cases_56 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Stmt0_5, (MR_Integer) 4))));
      Default_57 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Stmt0_5, (MR_Integer) 5))));
      Context_58 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Stmt0_5, (MR_Integer) 6))));
    ...
    else
    {
      ...
      if (succeeded)
      {
        Cases_48 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Stmt0_5, (MR_Integer) 4))));
        Default_49 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Stmt0_5, (MR_Integer) 5))));
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            SingleCase_28 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Cases_48, (MR_Integer) 0))));
            Var_44 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Cases_48, (MR_Integer) 1))));
            succeeded = (Var_44 == (MR_Word) ((MR_Unsigned) 0U));
          }
        }
      }
      if (succeeded)
        *Stmt_6 = ((MR_Word) ((MR_hl_field(MR_mktag(0), SingleCase_28, (MR_Integer) 2))));
      else
        *Stmt_6 = Stmt0_5;
    }
  ...
  MR_Word * STATE_VARIABLE_Info_42)
{
  ...
  else
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(3), Index_22, 0) = ((MR_Box) ((MR_Unsigned) 6U));
      MR_hl_field(MR_mktag(3), Index_22, 1) = ((MR_Box) (MR_mkword(MR_mktag(2), &ml_backend__ml_simplify_switch_scalar_common_2[0])));
  ...
  {
    DefaultLabelStmt_29 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(MR_mktag(3), DefaultLabelStmt_29, 0) = ((MR_Box) ((MR_Unsigned) 1U));
  ...
  switch (MR_tag((MR_Word) Default_13)) {
    ...
    case (MR_Integer) 0:
      switch (MR_unmkbody(Default_13)) {
        ...
        case (MR_Integer) 0:
          {
            DefaultStmts_30 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), DefaultStmts_30, 0) = ((MR_Box) (DefaultLabelStmt_29));
            MR_hl_field(MR_mktag(1), DefaultStmts_30, 1) = ((MR_Box) ((MR_Unsigned) 0U));
          }
          break;
        case (MR_Integer) 1:
          {
    ...
    case (MR_Integer) 1:
      {
...

        {
          ...
          MR_hl_field(MR_mktag(1), Var_52, 0) = ((MR_Box) (DefaultCase_31));
          MR_hl_field(MR_mktag(1), Var_52, 1) = ((MR_Box) ((MR_Unsigned) 0U));
        }
        {
          DefaultStmts_30 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), DefaultStmts_30, 0) = ((MR_Box) (DefaultLabelStmt_29));
          MR_hl_field(MR_mktag(1), DefaultStmts_30, 1) = ((MR_Box) (Var_52));
        }
      }
      break;
  }
  {
    StartComment_32 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(MR_mktag(3), StartComment_32, 0) = ((MR_Box) ((MR_Unsigned) 8U));
    MR_hl_field(MR_mktag(3), StartComment_32, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &ml_backend__ml_simplify_switch_scalar_common_2[1])));
    MR_hl_field(MR_mktag(3), StartComment_32, 2) = ((MR_Box) (Context_19));
  }
  {
    DoJump_33 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(MR_mktag(3), DoJump_33, 0) = ((MR_Box) ((MR_Unsigned) 3U));
  ...
  {
    EndLabelStmt_34 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(MR_mktag(3), EndLabelStmt_34, 0) = ((MR_Box) ((MR_Unsigned) 1U));
    MR_hl_field(MR_mktag(3), EndLabelStmt_34, 1) = ((MR_Box) (EndLabel_23));
    MR_hl_field(MR_mktag(3), EndLabelStmt_34, 2) = ((MR_Box) (Context_19));
  }
  {
    EndComment_35 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(MR_mktag(3), EndComment_35, 0) = ((MR_Box) ((MR_Unsigned) 8U));
    MR_hl_field(MR_mktag(3), EndComment_35, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &ml_backend__ml_simplify_switch_scalar_common_2[2])));
    ...
    case (MR_Integer) 1:
      {
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(1), Var_71, 0) = ((MR_Box) (StartComment_32));
    ...
    case (MR_Integer) 0:
      {
...

        {
          ...
          MR_hl_field(MR_mktag(2), Var_60, 0) = ((MR_Box) (Difference_36));
        }
        {
        ...
        {
          InRange_37 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(3), InRange_37, 0) = ((MR_Box) ((MR_Unsigned) 6U));
          MR_hl_field(MR_mktag(3), InRange_37, 1) = ((MR_Box) ((MR_Unsigned) 48U));
          MR_hl_field(MR_mktag(3), InRange_37, 2) = ((MR_Box) (Index_22));
          MR_hl_field(MR_mktag(3), InRange_37, 3) = ((MR_Box) (Var_59));
        }
        {
          Var_61 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), Var_61, 0) = ((MR_Box) ((MR_Unsigned) 0U));
          MR_hl_field(MR_mktag(0), Var_61, 1) = ((MR_Box) ((MR_Unsigned) 0U));
          MR_hl_field(MR_mktag(0), Var_61, 2) = ((MR_Box) (DefaultStmts_30));
          MR_hl_field(MR_mktag(0), Var_61, 3) = ((MR_Box) (Context_19));
        }
        {
          Else_38 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), Else_38, 0) = ((MR_Box) (Var_61));
        }
        {
          Var_66 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), Var_66, 0) = ((MR_Box) (DoJump_33));
          MR_hl_field(MR_mktag(1), Var_66, 1) = ((MR_Box) (CasesCode_26));
        }
        {
          SwitchBody_39 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), SwitchBody_39, 0) = ((MR_Box) ((MR_Unsigned) 0U));
          MR_hl_field(MR_mktag(0), SwitchBody_39, 1) = ((MR_Box) ((MR_Unsigned) 0U));
          MR_hl_field(MR_mktag(0), SwitchBody_39, 2) = ((MR_Box) (Var_66));
          MR_hl_field(MR_mktag(0), SwitchBody_39, 3) = ((MR_Box) (Context_19));
        }
        {
          DoSwitch_40 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL));
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(1), Var_69, 0) = ((MR_Box) (EndComment_35));
          MR_hl_field(MR_mktag(1), Var_69, 1) = ((MR_Box) ((MR_Unsigned) 0U));
        }
        {
          Var_68 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), Var_68, 0) = ((MR_Box) (EndLabelStmt_34));
          MR_hl_field(MR_mktag(1), Var_68, 1) = ((MR_Box) (Var_69));
        }
        {
          Var_67 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), Var_67, 0) = ((MR_Box) (DoSwitch_40));
  ...
  MR_String DefaultLabel_9)
{
  ...
  else
  {
    ...
    succeeded = mercury__map__f_84_121_112_101_83_112_101_99_79_102_95_95_112_114_101_100_95_95_115_101_97_114_99_104_95_95_91_75_32_61_32_105_110_116_93_95_48_95_49_3_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), CaseLabelsMap_8, ThisVal_6, &conv0_CaseLabel0_11);
    if (succeeded)
    {
    ...
    {
      CaseLabels_10 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
  ...
  MR_Word * STATE_VARIABLE_Info_7)
{
  ...
  else
  {
    ...
    MR_Word FirstCond_39 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Case_15, (MR_Integer) 0))));
    MR_Word LaterConds_40 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Case_15, (MR_Integer) 1))));
    MR_Word CaseStmt_41 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Case_15, (MR_Integer) 2))));
    MR_String ThisLabel_42;
    MR_Word Context_43;
    MR_Word LabelComment_44;
    MR_Word LabelCode_45;
    MR_Word JumpComment_46;
    MR_Word JumpCode_47;
    MR_Word STATE_VARIABLE_CaseLabelsMap_27_49;
    MR_Word Var_50;
    MR_Word Var_56;
    MR_Word Var_57;
    MR_Word Var_58;
    ...
    ml_backend__ml_code_util__ml_gen_new_label_3_p_0(&ThisLabel_42, STATE_VARIABLE_Info_0_6, &STATE_VARIABLE_Info_28_28);
    ml_backend__ml_simplify_switch__insert_case_into_map_4_p_0(ThisLabel_42, FirstCond_39, STATE_VARIABLE_CaseLabelsMap_0_3, &STATE_VARIABLE_CaseLabelsMap_27_49);
    {
      Var_50 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), Var_50, 0) = ((MR_Box) (&ml_backend__ml_simplify_switch_scalar_common_5[0]));
      MR_hl_field(MR_mktag(0), Var_50, 1) = ((MR_Box) (ml_backend__ml_simplify_switch__generate_cases_7_p_0_1));
      MR_hl_field(MR_mktag(0), Var_50, 2) = ((MR_Box) ((MR_Integer) 1));
      MR_hl_field(MR_mktag(0), Var_50, 3) = ((MR_Box) (ThisLabel_42));
    }
    mercury__list__foldl_4_p_0((MR_Word) (&ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_case_match_cond_0), (MR_Word) (&ml_backend__ml_simplify_switch_scalar_common_1[0]), Var_50, LaterConds_40, ((MR_Box) (STATE_VARIABLE_CaseLabelsMap_27_49)), &conv1_STATE_VARIABLE_CaseLabelsMap_27_27);
    STATE_VARIABLE_CaseLabelsMap_27_27 = ((MR_Word) (conv1_STATE_VARIABLE_CaseLabelsMap_27_27));
    Context_43 = ml_backend__ml_util__get_mlds_stmt_context_1_f_0(CaseStmt_41);
    {
      LabelComment_44 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(3), LabelComment_44, 0) = ((MR_Box) ((MR_Unsigned) 8U));
      MR_hl_field(MR_mktag(3), LabelComment_44, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &ml_backend__ml_simplify_switch_scalar_common_2[3])));
      MR_hl_field(MR_mktag(3), LabelComment_44, 2) = ((MR_Box) (Context_43));
    }
    {
      LabelCode_45 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(3), LabelCode_45, 0) = ((MR_Box) ((MR_Unsigned) 1U));
      MR_hl_field(MR_mktag(3), LabelCode_45, 1) = ((MR_Box) (ThisLabel_42));
      MR_hl_field(MR_mktag(3), LabelCode_45, 2) = ((MR_Box) (Context_43));
    }
    {
      JumpComment_46 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(3), JumpComment_46, 0) = ((MR_Box) ((MR_Unsigned) 8U));
      MR_hl_field(MR_mktag(3), JumpComment_46, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &ml_backend__ml_simplify_switch_scalar_common_2[4])));
      MR_hl_field(MR_mktag(3), JumpComment_46, 2) = ((MR_Box) (Context_43));
    }
    {
      Var_56 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), Var_56, 0) = ((MR_Box) (HeadVar__2_2));
    }
    {
      JumpCode_47 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(3), JumpCode_47, 0) = ((MR_Box) ((MR_Unsigned) 2U));
      MR_hl_field(MR_mktag(3), JumpCode_47, 1) = ((MR_Box) (Var_56));
      MR_hl_field(MR_mktag(3), JumpCode_47, 2) = ((MR_Box) (Context_43));
    }
    {
      Var_60 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), Var_60, 0) = ((MR_Box) (JumpCode_47));
      MR_hl_field(MR_mktag(1), Var_60, 1) = ((MR_Box) ((MR_Unsigned) 0U));
    }
    {
      Var_59 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), Var_59, 0) = ((MR_Box) (JumpComment_46));
      MR_hl_field(MR_mktag(1), Var_59, 1) = ((MR_Box) (Var_60));
    }
    {
      Var_58 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), Var_58, 0) = ((MR_Box) (CaseStmt_41));
      MR_hl_field(MR_mktag(1), Var_58, 1) = ((MR_Box) (Var_59));
    }
    {
      Var_57 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), Var_57, 0) = ((MR_Box) (LabelCode_45));
      MR_hl_field(MR_mktag(1), Var_57, 1) = ((MR_Box) (Var_58));
    }
    {
      CaseStmts_21 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), CaseStmts_21, 0) = ((MR_Box) (LabelComment_44));
      MR_hl_field(MR_mktag(1), CaseStmts_21, 1) = ((MR_Box) (Var_57));
    }
  ...
  MR_Word * STATE_VARIABLE_CaseLabelsMap_15)
{
  ...
  if (((MR_tag((MR_Word) Cond_6)) == (MR_Integer) 1))
  {
    ...
    succeeded = ((((MR_tag((MR_Word) MinRval_10)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(MR_mktag(3), MinRval_10, (MR_Integer) 0)))) == (MR_Integer) 1)));
    if (succeeded)
    {
      Var_20 = ((MR_Word) ((MR_hl_field(MR_mktag(3), MinRval_10, (MR_Integer) 1))));
      succeeded = ((MR_tag((MR_Word) Var_20)) == (MR_Integer) 2);
      if (succeeded)
      {
        Min_12 = ((MR_Integer) ((MR_hl_field(MR_mktag(2), Var_20, (MR_Integer) 0))));
        succeeded = ((((MR_tag((MR_Word) MaxRval_11)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(MR_mktag(3), MaxRval_11, (MR_Integer) 0)))) == (MR_Integer) 1)));
        if (succeeded)
        {
          Var_21 = ((MR_Word) ((MR_hl_field(MR_mktag(3), MaxRval_11, (MR_Integer) 1))));
          succeeded = ((MR_tag((MR_Word) Var_21)) == (MR_Integer) 2);
          if (succeeded)
            Max_13 = ((MR_Integer) ((MR_hl_field(MR_mktag(2), Var_21, (MR_Integer) 0))));
        }
      }
    }
    if (succeeded)
  ...
  else
  {
    ...
    if (succeeded)
    {
      Var_16 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Rval_8, (MR_Integer) 1))));
      succeeded = ((MR_tag((MR_Word) Var_16)) == (MR_Integer) 2);
      if (succeeded)
        Val_9 = ((MR_Integer) ((MR_hl_field(MR_mktag(2), Var_16, (MR_Integer) 0))));
    }
    if (succeeded)
  ...
  MR_Word Context_4)
{
          ...
          case (MR_Integer) 0:
            {
              ...
              MR_hl_field(MR_mktag(0), Stmt_5, 0) = ((MR_Box) ((MR_Unsigned) 0U));
              MR_hl_field(MR_mktag(0), Stmt_5, 1) = ((MR_Box) ((MR_Unsigned) 0U));
              MR_hl_field(MR_mktag(0), Stmt_5, 2) = ((MR_Box) ((MR_Unsigned) 0U));
  ...
  else
  {
    ...
    else
    {
      ...
      {
        AllMatchConds_25 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      ...
      {
        Stmt_5 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL));
  ...
  else
  {
    ...
    if ((Var_18 == (MR_Word) ((MR_Unsigned) 0U)))
      if (((MR_tag((MR_Word) Var_19)) == (MR_Integer) 1))
      {
        ...
        {
          Var_31 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL));
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(3), HeadVar__3_3, 1) = ((MR_Box) ((MR_Unsigned) 0U));
    ...
    else
    {
      ...
      if (((MR_tag((MR_Word) Var_19)) == (MR_Integer) 1))
      {
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(3), Var_45, 0) = ((MR_Box) ((MR_Unsigned) 6U));
        ...
        {
          Var_15 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(3), Var_15, 0) = ((MR_Box) ((MR_Unsigned) 6U));
          MR_hl_field(MR_mktag(3), Var_15, 1) = ((MR_Box) ((MR_Unsigned) 0U));
      ...
      Var_16 = ml_backend__ml_simplify_switch__ml_gen_case_match_conds_2_f_0(Var_18, SwitchRval_2);
      {
        HeadVar__3_3 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(3), HeadVar__3_3, 0) = ((MR_Box) ((MR_Unsigned) 6U));
        MR_hl_field(MR_mktag(3), HeadVar__3_3, 1) = ((MR_Box) ((MR_Unsigned) 4U));
  ...
  MR_Word * IntType_4)
{
  ...
  switch (MR_tag((MR_Word) MLDSType_3)) {
    ...
    case (MR_Integer) 0:
      ...
      break;
    case (MR_Integer) 3:
      switch (((MR_Integer) ((MR_hl_field(MR_mktag(3), MLDSType_3, (MR_Integer) 0))))) {
        default:
          succeeded = MR_FALSE;
          break;
        case (MR_Integer) 0:
          {
            ...
            if (((MR_tag((MR_Word) CtorCat_16)) == (MR_Integer) 1))
            {
              mercury__require__unexpected_2_p_0((MR_String) "predicate \140ml_backend.ml_simplify_switch.is_integral_type\'/2", (MR_String) "mercury_nb_type but ctor_cat_builtin");
              succeeded = MR_TRUE;
            }
            else
            if (((MR_tag((MR_Word) CtorCat_16)) == (MR_Integer) 2))
            {
              MR_Word Var_28 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(2), CtorCat_16, (MR_Integer) 0))) & (MR_Integer) 1);
        ...
        case (MR_Integer) 3:
          {
            *IntType_4 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(3), MLDSType_3, (MR_Integer) 1))) & (MR_Integer) 15);
            succeeded = MR_TRUE;
          }
          break;
      }
