  ...
  switch (MR_tag((MR_Word) MLDSType_3)) {
    ...
    case (MR_Integer) 3:
      switch (((MR_Integer) ((MR_hl_field(3, MLDSType_3, (MR_Integer) 0))))) {
        ...
        case (MR_Integer) 1:
          {
            MR_Word CtorCat_18 = ((MR_Word) ((MR_hl_field(3, MLDSType_3, (MR_Integer) 2))));

            if (((MR_tag((MR_Word) CtorCat_18)) == (MR_Integer) 1))
            {
            ...
            if (((MR_tag((MR_Word) CtorCat_18)) == (MR_Integer) 2))
            {
              MR_Word Var_30 = ((MR_Unsigned) ((MR_hl_field(2, CtorCat_18, (MR_Integer) 0))) & (MR_Integer) 1);
