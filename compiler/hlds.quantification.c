          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                ...
                if (succeeded)
                {
                  TypeInfo__28_28 = (MR_Word) (&hlds__quantification_scalar_common_1[5]);
