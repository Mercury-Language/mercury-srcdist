...
ml_backend__mlds_to_java_data__IntroducedFrom__pred__output_rval_const_for_java__965__1_2_p_0(
  MR_Word Lang_19,
  MR_Word HeadVar__2_87);

static void MR_CALL 
ml_backend__mlds_to_java_data__output_initializer_body_list_for_java_7_p_0(
  MR_Word Info_8,
  MR_Integer Indent_9,
  MR_Word HeadInit_10,
...
void MR_CALL 
ml_backend__mlds_to_java_data__output_nonempty_initializer_body_list_for_java_6_p_0(
  MR_Word Info_7,
  MR_Integer Indent_8,
  MR_Word Inits_9,
  MR_String Suffix_10)
{
  {
    ...
    ml_backend__mlds_to_java_data__output_initializer_body_list_for_java_7_p_0(Info_7, Indent_8, HeadInit_12, TailInits_13, Suffix_10);
  }
}

void MR_CALL 
ml_backend__mlds_to_java_data__output_initializer_for_java_8_p_0(
  MR_Word Info_9,
              ...
              case (MR_Integer) 2:
                {
                  ...
                  Var_28 = ml_backend__mlds_to_java_data__get_default_initializer_for_java_1_f_0(Type_12);
              ...
              case (MR_Integer) 2:
                {
                  ...
                  ml_backend__mlds_to_java_data__output_initializer_body_for_java_8_p_0(Info_9, (MR_Integer) 0, Var_40, Initializer_13, Var_41, Suffix_14);
                }
                break;
              case (MR_Integer) 1:
                {
                  ...
                  ml_backend__mlds_to_java_data__output_initializer_alloc_only_for_java_6_p_0(Info_9, Initializer_13, Var_37, Suffix_14);
                }
                break;
            }
            break;
  ...
  MR_String Suffix_12)
{
  while (MR_TRUE)
  {
    ...
    if ((TailInits_11 == (MR_Word) ((MR_Unsigned) 0U)))
      ml_backend__mlds_to_java_data__output_initializer_body_for_java_8_p_0(Info_8, (MR_Integer) 1, Indent_9, HeadInit_10, (MR_Word) ((MR_Unsigned) 0U), Suffix_12);
    else
    {
      ...
      ml_backend__mlds_to_java_data__output_initializer_body_for_java_8_p_0(Info_8, (MR_Integer) 1, Indent_9, HeadInit_10, (MR_Word) ((MR_Unsigned) 0U), (MR_String) ",");
...
void MR_CALL 
ml_backend__mlds_to_java_data__output_initializer_body_for_java_8_p_0(
  MR_Word Info_9,
  ...
  MR_String Suffix_14)
{
  switch (MR_tag((MR_Word) Initializer_12)) {
    ...
    case (MR_Integer) 0:
      {
        mercury__require__unexpected_2_p_0((MR_String) "predicate \140ml_backend.mlds_to_java_data.output_initializer_body_for_java\'/8", (MR_String) "no_initializer");
        return;
      }
      break;
    case (MR_Integer) 1:
      {
        ...
        ml_backend__mlds_to_java_data__output_rval_for_java_4_p_0(Info_9, Rval_16);
        mercury__io__write_string_3_p_0(Suffix_14);
        mercury__io__write_string_3_p_0((MR_String) "\n");
      }
      break;
    case (MR_Integer) 2:
      {
        ...
        ml_backend__mlds_to_java_type__output_type_for_java_4_p_0(Info_9, StructType_17);
        ...
        else
        {
          ...
          ml_backend__mlds_to_java_data__output_initializer_body_list_for_java_7_p_0(Info_9, Var_64, HeadFieldInit_22, TailFieldInits_23, (MR_String) "");
          ml_backend__mlds_to_target_util__output_n_indents_3_p_0(Indent_11);
          mercury__io__write_string_3_p_0(End_21);
          mercury__io__write_string_3_p_0(Suffix_14);
          mercury__io__write_string_3_p_0((MR_String) "\n");
    ...
    case (MR_Integer) 3:
      {
        ...
        else
        {
          ...
          ml_backend__mlds_to_java_type__output_type_for_java_4_p_0(Info_9, Type_25);
        }
        ...
        else
        {
          ...
          ml_backend__mlds_to_java_data__output_initializer_body_list_for_java_7_p_0(Info_9, Var_39, HeadElementInit_26, TailElementInits_27, (MR_String) "");
          ml_backend__mlds_to_target_util__output_n_indents_3_p_0(Indent_11);
          mercury__io__write_string_3_p_0((MR_String) "}");
          mercury__io__write_string_3_p_0(Suffix_14);
          mercury__io__write_string_3_p_0((MR_String) "\n");
...
void MR_CALL 
ml_backend__mlds_to_java_data__output_initializer_alloc_only_for_java_6_p_0(
  MR_Word Info_7,
...
{
  {
    ...
    switch (MR_tag((MR_Word) Initializer_8)) {
      ...
      case (MR_Integer) 0:
        {
          mercury__require__unexpected_2_p_0((MR_String) "predicate \140ml_backend.mlds_to_java_data.output_initializer_alloc_only_for_java\'/6", (MR_String) "no_initializer");
          return;
        }
        break;
      case (MR_Integer) 1:
        {
          mercury__require__unexpected_2_p_0((MR_String) "predicate \140ml_backend.mlds_to_java_data.output_initializer_alloc_only_for_java\'/6", (MR_String) "init_obj");
          return;
        }
        break;
      case (MR_Integer) 2:
        {
          ...
          if (succeeded)
          {
            ...
            mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&ml_backend__mlds_to_java_data_scalar_common_2[0]), Size_17, &Var_76);
          ...
          {
            ml_backend__mlds_to_java_type__output_type_for_java_4_p_0(Info_7, StructType_13);
            mercury__io__write_string_3_p_0((MR_String) "()");
            mercury__io__write_string_3_p_0(Suffix_10);
            mercury__io__write_string_3_p_0((MR_String) "\n");
          }
      ...
      case (MR_Integer) 3:
        {
          ...
          if ((MaybeType_9 == (MR_Word) ((MR_Unsigned) 0U)))
          {
            ...
            mercury__io__write_string_3_p_0((MR_String) "/* XXX init_array */ Object[");
            mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&ml_backend__mlds_to_java_data_scalar_common_2[0]), Size_67, &Var_96);
          ...
          else
          {
            ...
            ml_backend__mlds_to_java_type__type_to_string_for_java_4_p_0(Info_7, Type_19, &String_20, &ArrayDims_21);
            ...
            if (succeeded)
            {
              ...
              {
                mercury__require__unexpected_2_p_0((MR_String) "predicate \140ml_backend.mlds_to_java_data.output_initializer_alloc_only_for_java\'/6", (MR_String) "missing array dimension");
                return;
              }
          }
        }
...
{
  {
    ...
    switch (MR_tag((MR_Word) Op_8)) {
          ...
          case (MR_Integer) 11:
            {
              ...
              if (succeeded)
              {
                mercury__io__write_string_3_p_0((MR_String) "((");
                ml_backend__mlds_to_java_data__output_rval_for_java_4_p_0(Info_7, X_9);
                mercury__io__write_string_3_p_0((MR_String) ".MR_value & 0xffffffffL) ");
                mercury__io__write_string_3_p_0((MR_String) "<");
                mercury__io__write_string_3_p_0((MR_String) " (");
                ml_backend__mlds_to_java_data__output_rval_for_java_4_p_0(Info_7, Y_10);
                mercury__io__write_string_3_p_0((MR_String) ".MR_value) & 0xffffffffL)");
      ...
      case (MR_Integer) 1:
        {
          MR_Word Var_7335 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(1), Op_8, (MR_Integer) 0))) & (MR_Integer) 15);
      ...
      case (MR_Integer) 2:
        {
          MR_Word Var_7343 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(2), Op_8, (MR_Integer) 0))) & (MR_Integer) 15);
      ...
      case (MR_Integer) 3:
        switch (((MR_Integer) ((MR_hl_field(MR_mktag(3), Op_8, (MR_Integer) 0))))) {
          ...
          case (MR_Integer) 0:
            {
              MR_Word Var_7342 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(3), Op_8, (MR_Integer) 1))) & (MR_Integer) 15);
          ...
          case (MR_Integer) 1:
            {
              MR_Word Var_7336 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(3), Op_8, (MR_Integer) 1))) & (MR_Integer) 15);
          ...
          case (MR_Integer) 2:
            {
              MR_Word Var_7341 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(3), Op_8, (MR_Integer) 1))) & (MR_Integer) 15);
          ...
          case (MR_Integer) 3:
            {
              MR_Word Var_7345 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(3), Op_8, (MR_Integer) 1))) >> 1)) & (MR_Integer) 15);
          ...
          case (MR_Integer) 4:
            {
              MR_Word Var_7347 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(3), Op_8, (MR_Integer) 1))) >> 1)) & (MR_Integer) 15);
          ...
          case (MR_Integer) 5:
            {
              MR_Word Var_7332 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(3), Op_8, (MR_Integer) 1))) & (MR_Integer) 15);
          ...
          case (MR_Integer) 6:
            {
              MR_Word Var_7333 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(3), Op_8, (MR_Integer) 1))) & (MR_Integer) 15);
          ...
          case (MR_Integer) 7:
            {
              MR_Word Var_7334 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(3), Op_8, (MR_Integer) 1))) & (MR_Integer) 15);
          ...
          case (MR_Integer) 12:
            {
              MR_Word Var_7340 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(3), Op_8, (MR_Integer) 1))) & (MR_Integer) 15);
          ...
          case (MR_Integer) 13:
            {
              MR_Word Var_7338 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(3), Op_8, (MR_Integer) 1))) & (MR_Integer) 15);
          ...
          case (MR_Integer) 14:
            {
              MR_Word Var_7339 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(3), Op_8, (MR_Integer) 1))) & (MR_Integer) 15);
          ...
          case (MR_Integer) 15:
            {
              MR_Word Var_7337 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(3), Op_8, (MR_Integer) 1))) & (MR_Integer) 15);
...
{
  {
    ...
    succeeded = ml_backend__mlds_to_java_data__IntroducedFrom__pred__output_rval_const_for_java__965__1_2_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))));
    return succeeded;
  }
}
...
{
  {
    ...
    if (succeeded)
    {
      ...
      mercury__string__format__format_unsigned_int_component_nowidth_noprec_4_p_0((MR_Word) (&ml_backend__mlds_to_java_data_scalar_common_2[0]), (MR_Integer) 2, N32_8, &Var_20);
  ...
  switch (MR_tag((MR_Word) Op_4)) {
    ...
    case (MR_Integer) 3:
      switch (((MR_Integer) ((MR_hl_field(MR_mktag(3), Op_4, (MR_Integer) 0))))) {
        ...
        case (MR_Integer) 4:
          {
            MR_Word IntType_23 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(3), Op_4, (MR_Integer) 1))) >> 1)) & (MR_Integer) 15);
            MR_String OpStr_33 = ((&ml_backend__mlds_to_java_data_vector_common_1[0 + IntType_23]))->ml_backend__mlds_to_java_data__vector_common_type_1_0__vct_1_f_0;

            mercury__io__write_string_3_p_0(OpStr_33);
          }
          break;
        case (MR_Integer) 5:
          mercury__io__write_string_3_p_0((MR_String) "&");
