  ...
  MR_Word Stream_8)
{
  ...
  if (succeeded)
  {
    ...
    Var_36 = ml_backend__ml_util__mlds_maybe_aux_func_id_to_suffix_1_f_0(MaybeAux_32);
    ...
    else
    {
      ...
      else
      {
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            Lval_61 = ((MR_Word) ((MR_hl_field(MR_mktag(2), Expr_9, (MR_Integer) 0))));
            switch (MR_tag((MR_Word) Lval_61)) {
              default:
                succeeded = MR_FALSE;
                break;
              case (MR_Integer) 0:
                {
                  Type_63 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Lval_61, (MR_Integer) 4))));
                  succeeded = MR_TRUE;
                }
                break;
              case (MR_Integer) 3:
                switch (((MR_Integer) ((MR_hl_field(MR_mktag(3), Lval_61, (MR_Integer) 0))))) {
                  default: /*NOTREACHED*/ MR_assert(0);
                  case (MR_Integer) 0:
                    {
                      Type_63 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Lval_61, (MR_Integer) 2))));
                      succeeded = MR_TRUE;
                    }
                    break;
                  case (MR_Integer) 1:
            ...
            if (succeeded)
            {
              succeeded = ((((MR_tag((MR_Word) Type_63)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(MR_mktag(3), Type_63, (MR_Integer) 0)))) == (MR_Integer) 0)));
              if (succeeded)
              {
                CtorCat_71 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Type_63, (MR_Integer) 2))));
  ...
  MR_Integer N_6)
{
  ...
  if (succeeded)
  {
    ...
    mercury__string__format__format_unsigned_int_component_nowidth_noprec_4_p_0((MR_Word) (&ml_backend__mlds_to_java_data_scalar_common_1[0]), (MR_Integer) 2, N32_10, &Var_23);
