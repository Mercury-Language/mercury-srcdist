    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
            packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), CtorCat_25, (MR_Integer) 0)));
        }
      }
    }
    if (succeeded)
  ...
  top_of_proc_4:;
    {
      ...
      else
      {
        ...
        if (((((MR_tag((MR_Word) Type_7)) == (MR_Integer) 3)) && ((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), Type_7, (MR_Integer) 0))) == (MR_Integer) 0))))
        {
          ...
          if (succeeded)
          {
            packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Var_28, (MR_Integer) 1)));
            ...
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                ...
                if (succeeded)
                {
                  ...
                  if (succeeded)
                    packed_args_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), CtorCat_71, (MR_Integer) 0)));
                }
              }
            }
            if (succeeded)
      ...
      case (MR_Integer) 2:
        {
          ...
          MR_Unsigned packed_args_11 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), Op_8, (MR_Integer) 0)));
          ...
          case (MR_Integer) 0:
            {
              ...
              MR_Unsigned packed_args_10 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Op_8, (MR_Integer) 1)));
          ...
          case (MR_Integer) 3:
            {
              ...
              MR_Unsigned packed_args_12 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Op_8, (MR_Integer) 1)));
          ...
          case (MR_Integer) 4:
            {
              ...
              MR_Unsigned packed_args_13 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Op_8, (MR_Integer) 1)));
          ...
          case (MR_Integer) 14:
            {
              ...
              MR_Unsigned packed_args_7 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Op_8, (MR_Integer) 1)));
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
            packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), CtorCat_14, (MR_Integer) 0)));
        }
      }
    }
    return succeeded;
        ...
        case (MR_Integer) 4:
          {
            ...
            MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Op_4, (MR_Integer) 1)));
