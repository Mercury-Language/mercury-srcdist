        ...
        case (MR_Integer) 10:
          {
            ...
            OpStr_119 = backend_libs__builtin_ops__cmp_op_c_operator_1_f_0(CmpOp_114);
            ml_backend__mlds_to_java_data__output_basic_binop_maybe_with_enum_for_java_7_p_0(Info_8, Stream_9, OpStr_119, X_11, Y_12);
          }
          break;
      }
      break;
