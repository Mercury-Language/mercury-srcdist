...
ml_backend__mlds_to_java_data__IntroducedFrom__pred__output_rval_const_for_java__912__1_2_p_0(
  MR_Word Lang_21,
  ...
  MR_Word Stream_8)
{
  ...
  if (succeeded)
  {
    ...
    if (succeeded)
    {
      succeeded = ((((MR_tag((MR_Word) Type_16)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(3, Type_16, (MR_Integer) 0)))) == (MR_Integer) 3)));
      if (succeeded)
      {
      ...
      else
      {
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              succeeded = ((((MR_tag((MR_Word) Type_59)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(3, Type_59, (MR_Integer) 0)))) == (MR_Integer) 3)));
              if (succeeded)
              {
  ...
  switch (MR_tag((MR_Word) Op_10)) {
    ...
    case (MR_Integer) 3:
      switch (((MR_Integer) ((MR_hl_field(3, Op_10, (MR_Integer) 0))))) {
        ...
        case (MR_Integer) 4:
          {
            MR_Word CmpOp_98 = ((MR_Unsigned) ((MR_hl_field(3, Op_10, (MR_Integer) 1))) & (MR_Integer) 7);
            MR_Word IntType_99 = ((((MR_Unsigned) ((MR_hl_field(3, Op_10, (MR_Integer) 1))) >> 3)) & (MR_Integer) 15);

            ml_backend__mlds_to_java_data__output_int_cmp_binop_for_java_8_p_0(Info_8, Stream_9, IntType_99, CmpOp_98, X_11, Y_12);
          }
          break;
        case (MR_Integer) 5:
          {
        ...
        case (MR_Integer) 8:
          {
            MR_Word CmpOp_100 = ((MR_Unsigned) ((MR_hl_field(3, Op_10, (MR_Integer) 1))) & (MR_Integer) 7);
            MR_String OpStr_101;
            ...
            if (succeeded)
            {
              ...
              mercury__io__write_string_4_p_0(Stream_9, OpStr_101);
              mercury__io__write_string_4_p_0(Stream_9, (MR_String) " (");
              ml_backend__mlds_to_java_data__output_rval_for_java_5_p_0(Info_8, Y_12, Stream_9);
              mercury__io__write_string_4_p_0(Stream_9, (MR_String) ".MR_value) & 0xffffffffL)");
            }
        ...
        case (MR_Integer) 9:
          {
            MR_Word Var_94;
            MR_Word ArithOp_102 = ((MR_Unsigned) ((MR_hl_field(3, Op_10, (MR_Integer) 1))) & (MR_Integer) 7);
            MR_String OpStr_107;

            Var_94 = (MR_Word) (ArithOp_102);
            OpStr_107 = backend_libs__builtin_ops__arith_op_c_operator_1_f_0(Var_94);
            ml_backend__mlds_to_java_data__output_basic_binop_maybe_with_enum_for_java_7_p_0(Info_8, Stream_9, OpStr_107, X_11, Y_12);
          }
          break;
        case (MR_Integer) 10:
          {
            MR_Word CmpOp_103 = ((MR_Unsigned) ((MR_hl_field(3, Op_10, (MR_Integer) 1))) & (MR_Integer) 7);
            MR_String OpStr_108;

            OpStr_108 = backend_libs__builtin_ops__cmp_op_c_operator_1_f_0(CmpOp_103);
            ml_backend__mlds_to_java_data__output_basic_binop_maybe_with_enum_for_java_7_p_0(Info_8, Stream_9, OpStr_108, X_11, Y_12);
          }
          break;
      }
      break;
  ...
  MR_Word Y_12)
{
  switch (MR_tag((MR_Word) Op_10)) {
    ...
    case (MR_Integer) 2:
      {
        MR_Word Type_46 = ((((MR_Unsigned) ((MR_hl_field(2, Op_10, (MR_Integer) 0))) >> 1)) & (MR_Integer) 15);
    ...
    case (MR_Integer) 3:
      switch (((MR_Integer) ((MR_hl_field(3, Op_10, (MR_Integer) 0))))) {
        ...
        case (MR_Integer) 0:
          {
            MR_Word Type_445 = ((((MR_Unsigned) ((MR_hl_field(3, Op_10, (MR_Integer) 1))) >> 1)) & (MR_Integer) 15);
        ...
        case (MR_Integer) 2:
          {
            MR_Word Type_64 = ((MR_Unsigned) ((MR_hl_field(3, Op_10, (MR_Integer) 1))) & (MR_Integer) 15);
        ...
        case (MR_Integer) 3:
          {
            MR_Word Type_78 = ((MR_Unsigned) ((MR_hl_field(3, Op_10, (MR_Integer) 1))) & (MR_Integer) 15);
  ...
  MR_Word Y_12)
{
  ...
  if (succeeded)
  {
    ...
    if (succeeded)
    {
      succeeded = ((((MR_tag((MR_Word) Type_32)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(3, Type_32, (MR_Integer) 0)))) == (MR_Integer) 3)));
      if (succeeded)
      {
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = ml_backend__mlds_to_java_data__IntroducedFrom__pred__output_rval_const_for_java__912__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 4)))));
  return succeeded;
}
  ...
  switch (MR_tag((MR_Word) Const_8)) {
    ...
    case (MR_Integer) 3:
      switch (((MR_Integer) ((MR_hl_field(3, Const_8, (MR_Integer) 0))))) {
        ...
        case (MR_Integer) 10:
          {
            MR_Integer N_145 = ((MR_Integer) ((MR_hl_field(3, Const_8, (MR_Integer) 1))));
        ...
        case (MR_Integer) 13:
          {
            MR_Word String_147 = ((MR_Word) ((MR_hl_field(3, Const_8, (MR_Integer) 1))));
        ...
        case (MR_Integer) 15:
          {
            ...
            MR_String Var_110 = ((MR_String) ((MR_hl_field(0, TargetPrefixes_26, (MR_Integer) 0))));
        ...
        case (MR_Integer) 18:
          {
            ...
            MR_Word ModuleName_148 = ((MR_Word) ((MR_hl_field(3, Const_8, (MR_Integer) 1))));
            MR_Word SymName_149;
        ...
        case (MR_Integer) 19:
          {
            ...
            MR_Word ModuleName_151 = ((MR_Word) ((MR_hl_field(0, QualProcLabel_38, (MR_Integer) 0))));
            MR_Word SymName_152;
        ...
        case (MR_Integer) 20:
          {
            MR_Word Type_43 = ((MR_Word) ((MR_hl_field(3, Const_8, (MR_Integer) 1))));
  ...
  switch (MR_tag((MR_Word) Type_3)) {
    ...
    case (MR_Integer) 3:
      switch (((MR_Integer) ((MR_hl_field(3, Type_3, (MR_Integer) 0))))) {
        ...
        case (MR_Integer) 7:
          {
            MR_Word ForeignLangType_11 = ((MR_Word) ((MR_hl_field(3, Type_3, (MR_Integer) 1))));
  ...
  MR_Word Rval_2)
{
  ...
  if (succeeded)
  {
    ...
    if (succeeded)
    {
      succeeded = ((((MR_tag((MR_Word) Type_5)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(3, Type_5, (MR_Integer) 0)))) == (MR_Integer) 3)));
      if (succeeded)
      {
