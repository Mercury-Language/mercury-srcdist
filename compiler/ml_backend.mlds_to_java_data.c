    ...
    else
    {
      ...
      else
      {
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            Lval_53 = ((MR_Word) ((MR_hl_field(MR_mktag(2), Expr_9, (MR_Integer) 0))));
            switch (MR_tag((MR_Word) Lval_53)) {
              default:
                succeeded = MR_FALSE;
                break;
              case (MR_Integer) 0:
                {
                  Type_55 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Lval_53, (MR_Integer) 4))));
                  succeeded = MR_TRUE;
                }
                break;
              case (MR_Integer) 3:
                switch (((MR_Integer) ((MR_hl_field(MR_mktag(3), Lval_53, (MR_Integer) 0))))) {
                  default: /*NOTREACHED*/ MR_assert(0);
                  case (MR_Integer) 0:
                    {
                      Type_55 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Lval_53, (MR_Integer) 2))));
                      succeeded = MR_TRUE;
                    }
                    break;
                  case (MR_Integer) 1:
            ...
            if (succeeded)
            {
              succeeded = ((((MR_tag((MR_Word) Type_55)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(MR_mktag(3), Type_55, (MR_Integer) 0)))) == (MR_Integer) 0)));
              if (succeeded)
              {
                CtorCat_62 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Type_55, (MR_Integer) 2))));
                succeeded = ((MR_tag((MR_Word) CtorCat_62)) == (MR_Integer) 2);
                if (succeeded)
                {
                }
              }
