...
MR_decl_label2(ml_backend__mlds_to_managed__write_csharp_initializer_3_0, 47,60)
...
MR_BEGIN_MODULE(ml_backend__mlds_to_managed_module19)
	...
	MR_init_label2(ml_backend__mlds_to_managed__write_csharp_initializer_3_0,47,60)
MR_BEGIN_CODE
...
MR_def_static(ml_backend__mlds_to_managed__write_csharp_initializer_3_0)
	...
	MR_COMPUTED_GOTO((MR_Unsigned) MR_tag(MR_r1),
		...
		MR_LABEL_AP(ml_backend__mlds_to_managed__write_csharp_initializer_3_0_i47));
