...
MR_decl_label10(ml_backend__mlds_to_managed__output_csharp_code_4_0, 14,15,17,18,19,22,23,24,25,27)
...
MR_BEGIN_MODULE(ml_backend__mlds_to_managed_module6)
	...
	MR_init_label10(ml_backend__mlds_to_managed__output_csharp_code_4_0,14,15,17,18,19,22,23,24,25,27)
...
MR_def_label(ml_backend__mlds_to_managed__write_rval_const_3_0,19)
	...
	MR_f(1) = MR_float_from_dword_ptr(&MR_tfield(3, MR_r1, 1));
...
MR_def_static(ml_backend__mlds_to_managed__generate_method_code_5_0)
	...
	MR_tempr3 = MR_tfield(2, MR_tempr2, 2);
	...
	MR_sv(4) = MR_body((MR_Integer) MR_tempr3, (MR_Integer) 1);
...
MR_def_static(ml_backend__mlds_to_managed__write_defn_decl_4_0)
	...
	MR_incr_sp(3);
	MR_sv(3) = (MR_Word) MR_succip;
	MR_sv(2) = MR_body((MR_Integer) MR_tempr3, (MR_Integer) 1);
...
void mercury__ml_backend__mlds_to_managed__write_out_proc_statics(FILE *deep_fp, FILE *procrep_fp)
{
	MR_write_out_module_proc_reps_start(procrep_fp, &mercury_data__module_layout__ml_backend__mlds_to_managed);
