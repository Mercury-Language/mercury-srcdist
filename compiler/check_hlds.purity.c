  ...
  MR_Word * STATE_VARIABLE_Info_37)
{
  ...
  if (!(succeeded))
  {
    ...
    if (!(succeeded))
    {
      ...
      succeeded = hlds__hlds_pred__check_marker_2_p_0(Markers_22, (MR_Integer) 18);
    }
  }
  if (succeeded)
        ...
        case (MR_Integer) 1:
          {
            ...
            if (!(succeeded))
            {
              ...
              if (!(succeeded))
              {
                succeeded = hlds__hlds_pred__check_marker_2_p_0(Markers_134, (MR_Integer) 12);
                if (!(succeeded))
        ...
        case (MR_Integer) 2:
          {
            ...
            if (!(succeeded))
            {
              ...
              if (!(succeeded))
              {
                succeeded = hlds__hlds_pred__check_marker_2_p_0(Markers_86, (MR_Integer) 12);
                if (!(succeeded))
