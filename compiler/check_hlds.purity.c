      ...
      case (MR_Integer) 0:
        {
          ...
          hlds__hlds_markers__remove_marker_3_p_0((MR_Integer) 17, Markers0_29, &Markers1_30);
          hlds__hlds_markers__add_marker_3_p_0((MR_Integer) 16, Markers1_30, &Markers_31);
        }
        break;
      case (MR_Integer) 1:
        hlds__hlds_markers__add_marker_3_p_0((MR_Integer) 17, Markers0_29, &Markers_31);
        break;
    }
        ...
        case (MR_Integer) 0:
          {
            ...
            hlds__hlds_markers__remove_marker_3_p_0((MR_Integer) 14, Markers0_29, &Markers1_53);
            hlds__hlds_markers__remove_marker_3_p_0((MR_Integer) 15, Markers1_53, &Markers_57);
          }
          break;
        case (MR_Integer) 1:
          {
            ...
            hlds__hlds_markers__remove_marker_3_p_0((MR_Integer) 14, Markers0_29, &Markers1_54);
            hlds__hlds_markers__add_marker_3_p_0((MR_Integer) 15, Markers1_54, &Markers_57);
          }
          break;
      }
  ...
  MR_Word * STATE_VARIABLE_Info_37)
{
  ...
  if (!(succeeded))
  {
    ...
    if (!(succeeded))
    {
      ...
      succeeded = hlds__hlds_markers__marker_is_present_2_p_0(Markers_22, (MR_Integer) 18);
    }
  }
  if (succeeded)
                          ...
                          case (MR_Integer) 1:
                            {
                              ...
                              Threshold_37 = ((MR_Integer) ((MR_hl_field(0, OptTuple_36, 9))));
                          ...
                          case (MR_Integer) 1:
                            {
                              ...
                              Threshold_403 = ((MR_Integer) ((MR_hl_field(0, OptTuple_402, 9))));
  ...
  MR_Word * Specs_12)
{
  ...
  switch (DeclaredPurity_36) {
    ...
    case (MR_Integer) 1:
      {
        succeeded = hlds__hlds_markers__marker_is_present_2_p_0(CallerMarkers_16, (MR_Integer) 24);
        if (succeeded)
  ...
  else
  {
    ...
    else
    {
      ...
      else
      {
        ...
        succeeded = hlds__hlds_markers__marker_is_present_2_p_0(Markers_16, (MR_Integer) 11);
        if (!(succeeded))
        {
          succeeded = hlds__hlds_markers__marker_is_present_2_p_0(Markers_16, (MR_Integer) 12);
          if (!(succeeded))
            succeeded = hlds__hlds_markers__marker_is_present_2_p_0(Markers_16, (MR_Integer) 24);
        }
        if (succeeded)
          *STATE_VARIABLE_Info_18 = STATE_VARIABLE_Info_0_17;
        else
        ...
        case (MR_Integer) 2:
          {
            ...
            if (!(succeeded))
            {
              succeeded = hlds__hlds_markers__marker_is_present_2_p_0(Markers_22, (MR_Integer) 11);
              if (!(succeeded))
              {
        ...
        case (MR_Integer) 1:
          {
            ...
            if (!(succeeded))
            {
              succeeded = hlds__hlds_markers__marker_is_present_2_p_0(Markers_158, (MR_Integer) 11);
              if (!(succeeded))
              {
        ...
        case (MR_Integer) 2:
          {
            ...
            if (!(succeeded))
            {
              succeeded = hlds__hlds_markers__marker_is_present_2_p_0(Markers_110, (MR_Integer) 11);
              if (!(succeeded))
              {
