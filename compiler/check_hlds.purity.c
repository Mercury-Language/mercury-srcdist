...
static MR_bool MR_CALL 
check_hlds__purity____Unify______listlist_1_1(
  ...
  MR_Word * STATE_VARIABLE_PredInfo_37)
{
  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      Var_65 = hlds__hlds_pred__pred_info_valid_procids_1_f_0(STATE_VARIABLE_PredInfo_44_44);
      TypeCtorInfo_66_66 = (MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_proc_id_0);
      succeeded = check_hlds__purity____Unify______listlist_1_1(TypeCtorInfo_66_66, Var_49, Var_65);
    }
    if (succeeded)
    {
      MR_Word Markers_60;
