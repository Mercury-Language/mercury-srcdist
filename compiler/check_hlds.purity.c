...
MR_decl_label6(__Unify___check_hlds__purity__purity_info_0_0, 2,4,6,8,10,1)
MR_decl_label7(__Compare___check_hlds__purity__purity_info_0_0, 3,7,11,15,19,23,32)
...
MR_BEGIN_MODULE(check_hlds__purity_module24)
	...
	MR_init_label6(__Unify___check_hlds__purity__purity_info_0_0,2,4,6,8,10,1)
MR_BEGIN_CODE
...
MR_def_static(__Unify___check_hlds__purity__purity_info_0_0)
	...
	MR_np_call_localret_ent(__Unify___hlds__hlds_module__module_info_0_0,
		__Unify___check_hlds__purity__purity_info_0_0_i2);
MR_def_label(__Unify___check_hlds__purity__purity_info_0_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
...
MR_BEGIN_MODULE(check_hlds__purity_module25)
	...
	MR_init_label7(__Compare___check_hlds__purity__purity_info_0_0,3,7,11,15,19,23,32)
MR_BEGIN_CODE
...
MR_def_static(__Compare___check_hlds__purity__purity_info_0_0)
	...
	MR_np_call_localret_ent(__Compare___hlds__hlds_module__module_info_0_0,
		__Compare___check_hlds__purity__purity_info_0_0_i3);
MR_def_label(__Compare___check_hlds__purity__purity_info_0_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___check_hlds__purity__purity_info_0_0_i32);
	}
	MR_r1 = MR_sv(1);
	MR_r2 = MR_sv(7);
	MR_np_call_localret_ent(private_builtin__builtin_compare_int_3_0,
		__Compare___check_hlds__purity__purity_info_0_0_i7);
MR_def_label(__Compare___check_hlds__purity__purity_info_0_0,7)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___check_hlds__purity__purity_info_0_0_i32);
	}
	...
	MR_np_call_localret_ent(__Compare___hlds__hlds_pred__pred_info_0_0,
		__Compare___check_hlds__purity__purity_info_0_0_i11);
MR_def_label(__Compare___check_hlds__purity__purity_info_0_0,11)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___check_hlds__purity__purity_info_0_0_i32);
	}
	...
	MR_np_call_localret_ent(__Compare___tree234__tree234_2_0,
		__Compare___check_hlds__purity__purity_info_0_0_i15);
MR_def_label(__Compare___check_hlds__purity__purity_info_0_0,15)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___check_hlds__purity__purity_info_0_0_i32);
	}
	...
	MR_np_call_localret_ent(__Compare___varset__varset_1_0,
		__Compare___check_hlds__purity__purity_info_0_0_i19);
MR_def_label(__Compare___check_hlds__purity__purity_info_0_0,19)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___check_hlds__purity__purity_info_0_0_i32);
	}
	...
	MR_np_call_localret_ent(__Compare___list__list_1_0,
		__Compare___check_hlds__purity__purity_info_0_0_i23);
MR_def_label(__Compare___check_hlds__purity__purity_info_0_0,23)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___check_hlds__purity__purity_info_0_0_i32);
	}
	...
	MR_decr_sp(13);
	MR_np_tailcall_ent(private_builtin__builtin_compare_int_3_0);
MR_def_label(__Compare___check_hlds__purity__purity_info_0_0,32)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(13);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
