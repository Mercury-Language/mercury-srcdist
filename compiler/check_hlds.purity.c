            ...
            case (MR_Integer) 0:
              {
                ...
                if (succeeded)
                {
                  ...
                  Var_74 = ((MR_Word) (MR_hl_field(MR_mktag(1), GoalExpr1_59, (MR_Integer) 4)));
                  {
                    ...
                    hlds__hlds_goal__goal_info_remove_feature_3_p_0((MR_Integer) 20, STATE_VARIABLE_GoalInfo_10_194, &GoalInfo_128);
                    {
            ...
            case (MR_Integer) 1:
              {
                ...
                hlds__hlds_goal__goal_info_remove_feature_3_p_0((MR_Integer) 20, STATE_VARIABLE_GoalInfo_10_204, &GoalInfo_67);
                {
