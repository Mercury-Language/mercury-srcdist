  ...
  MR_Word * STATE_VARIABLE_Specs_26)
{
  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      if (((((((((MR_tag((MR_Word) PredOrigin_17)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(MR_mktag(3), PredOrigin_17, (MR_Integer) 0)))) == (MR_Integer) 1)))) || (((((MR_tag((MR_Word) PredOrigin_17)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(MR_mktag(3), PredOrigin_17, (MR_Integer) 0)))) == (MR_Integer) 0)))))) || (((MR_tag((MR_Word) PredOrigin_17)) == (MR_Integer) 1))))
        succeeded = MR_TRUE;
      else
        succeeded = MR_FALSE;
    }
    ...
    case (MR_Integer) 2:
      switch (DeclaredPurity_12) {
        ...
        case (MR_Integer) 1:
          if ((MaybePromisedPurity_13 == (MR_Word) ((MR_Unsigned) 0U)))
          {
            MR_Word NotPureEnoughSpec_107;

            NotPureEnoughSpec_107 = check_hlds__purity__error_not_pure_enough_4_f_0(ModuleInfo_8, PredInfo_10, PredId_9, ActualPurity_11);
            {
              MR_Word base;
              base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              *STATE_VARIABLE_Specs_26 = base;
              MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (NotPureEnoughSpec_107));
              MR_hl_field(MR_mktag(1), base, 1) = ((MR_Box) (STATE_VARIABLE_Specs_30_30));
            }
          }
          else
    ...
    case (MR_Integer) 0:
      switch (DeclaredPurity_12) {
        ...
        case (MR_Integer) 1:
          {
            MR_Word Markers_128;
            MR_Word GoalType_129;

            hlds__hlds_pred__pred_info_get_markers_2_p_0(PredInfo_10, &Markers_128);
            hlds__hlds_pred__pred_info_get_goal_type_2_p_0(PredInfo_10, &GoalType_129);
            {
              MR_Word NPGoalType_114;

              succeeded = ((MR_tag((MR_Word) GoalType_129)) == (MR_Integer) 0);
              if (succeeded)
              {
                NPGoalType_114 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), GoalType_129, (MR_Integer) 0))) & (MR_Integer) 3);
                switch (NPGoalType_114) {
                  default:
                    succeeded = MR_FALSE;
                    break;
                  case (MR_Integer) 3:
            ...
            if (!(succeeded))
            {
              succeeded = hlds__hlds_pred__check_marker_2_p_0(Markers_128, (MR_Integer) 10);
              if (!(succeeded))
              {
                succeeded = hlds__hlds_pred__check_marker_2_p_0(Markers_128, (MR_Integer) 11);
                if (!(succeeded))
                  succeeded = hlds__hlds_pred__check_marker_2_p_0(Markers_128, (MR_Integer) 0);
              }
            }
            if (succeeded)
              *STATE_VARIABLE_Specs_26 = STATE_VARIABLE_Specs_30_30;
            ...
            {
              MR_Word TooPureSpec_122;

              TooPureSpec_122 = check_hlds__purity__warn_pred_body_too_pure_5_f_0(ModuleInfo_8, PredInfo_10, PredId_9, ActualPurity_11, DeclaredPurity_12);
              {
                MR_Word base;
                base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                *STATE_VARIABLE_Specs_26 = base;
                MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (TooPureSpec_122));
                MR_hl_field(MR_mktag(1), base, 1) = ((MR_Box) (STATE_VARIABLE_Specs_30_30));
              }
            }
          }
    ...
    case (MR_Integer) 1:
      switch (DeclaredPurity_12) {
        ...
        case (MR_Integer) 2:
          {
            ...
            hlds__hlds_pred__pred_info_get_markers_2_p_0(PredInfo_10, &Markers_80);
            hlds__hlds_pred__pred_info_get_goal_type_2_p_0(PredInfo_10, &GoalType_81);
            {
              MR_Word NPGoalType_66;

              succeeded = ((MR_tag((MR_Word) GoalType_81)) == (MR_Integer) 0);
              if (succeeded)
              {
                NPGoalType_66 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), GoalType_81, (MR_Integer) 0))) & (MR_Integer) 3);
                switch (NPGoalType_66) {
                  default:
                    succeeded = MR_FALSE;
                    break;
                  case (MR_Integer) 3:
            ...
            if (!(succeeded))
            {
              succeeded = hlds__hlds_pred__check_marker_2_p_0(Markers_80, (MR_Integer) 10);
              if (!(succeeded))
              {
                succeeded = hlds__hlds_pred__check_marker_2_p_0(Markers_80, (MR_Integer) 11);
                if (!(succeeded))
                  succeeded = hlds__hlds_pred__check_marker_2_p_0(Markers_80, (MR_Integer) 0);
              }
            }
            if (succeeded)
              *STATE_VARIABLE_Specs_26 = STATE_VARIABLE_Specs_30_30;
            ...
            {
              MR_Word TooPureSpec_74;

              TooPureSpec_74 = check_hlds__purity__warn_pred_body_too_pure_5_f_0(ModuleInfo_8, PredInfo_10, PredId_9, ActualPurity_11, DeclaredPurity_12);
              {
                MR_Word base;
                base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                *STATE_VARIABLE_Specs_26 = base;
                MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (TooPureSpec_74));
                MR_hl_field(MR_mktag(1), base, 1) = ((MR_Box) (STATE_VARIABLE_Specs_30_30));
              }
            }
          }
        ...
        case (MR_Integer) 0:
          if ((MaybePromisedPurity_13 == (MR_Word) ((MR_Unsigned) 0U)))
          {
            MR_Word NotPureEnoughSpec_64;

            NotPureEnoughSpec_64 = check_hlds__purity__error_not_pure_enough_4_f_0(ModuleInfo_8, PredInfo_10, PredId_9, ActualPurity_11);
            {
              MR_Word base;
              base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              *STATE_VARIABLE_Specs_26 = base;
              MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (NotPureEnoughSpec_64));
              MR_hl_field(MR_mktag(1), base, 1) = ((MR_Box) (STATE_VARIABLE_Specs_30_30));
            }
          }
          else
