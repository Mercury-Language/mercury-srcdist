    ...
    case (MR_Integer) 2:
      switch (DeclaredPurity_12) {
        ...
        case (MR_Integer) 1:
          if ((MaybePromisedPurity_13 == (MR_Word) ((MR_Unsigned) 0U)))
          {
            MR_Word NotPureEnoughSpec_113;

            NotPureEnoughSpec_113 = check_hlds__purity__error_not_pure_enough_4_f_0(ModuleInfo_8, PredInfo_10, PredId_9, ActualPurity_11);
            {
              MR_Word base;
              base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              *STATE_VARIABLE_Specs_26 = base;
              MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (NotPureEnoughSpec_113));
              MR_hl_field(MR_mktag(1), base, 1) = ((MR_Box) (STATE_VARIABLE_Specs_30_30));
            }
          }
          else
    ...
    case (MR_Integer) 0:
      switch (DeclaredPurity_12) {
        ...
        case (MR_Integer) 1:
          {
            MR_Word Markers_134;
            MR_Word GoalType_135;

            hlds__hlds_pred__pred_info_get_markers_2_p_0(PredInfo_10, &Markers_134);
            hlds__hlds_pred__pred_info_get_goal_type_2_p_0(PredInfo_10, &GoalType_135);
            {
              MR_Word NPGoalType_120;

              succeeded = ((MR_tag((MR_Word) GoalType_135)) == (MR_Integer) 0);
              if (succeeded)
              {
                NPGoalType_120 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), GoalType_135, (MR_Integer) 0))) & (MR_Integer) 3);
                switch (NPGoalType_120) {
                  default:
                    succeeded = MR_FALSE;
                    break;
                  case (MR_Integer) 3:
            ...
            if (!(succeeded))
            {
              succeeded = hlds__hlds_pred__check_marker_2_p_0(Markers_134, (MR_Integer) 10);
              if (!(succeeded))
              {
                succeeded = hlds__hlds_pred__check_marker_2_p_0(Markers_134, (MR_Integer) 11);
                if (!(succeeded))
                  succeeded = hlds__hlds_pred__check_marker_2_p_0(Markers_134, (MR_Integer) 0);
              }
            }
            if (succeeded)
              *STATE_VARIABLE_Specs_26 = STATE_VARIABLE_Specs_30_30;
            ...
            {
              MR_Word TooPureSpec_128;

              TooPureSpec_128 = check_hlds__purity__warn_pred_body_too_pure_5_f_0(ModuleInfo_8, PredInfo_10, PredId_9, ActualPurity_11, DeclaredPurity_12);
              {
                MR_Word base;
                base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                *STATE_VARIABLE_Specs_26 = base;
                MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (TooPureSpec_128));
                MR_hl_field(MR_mktag(1), base, 1) = ((MR_Box) (STATE_VARIABLE_Specs_30_30));
              }
            }
          }
    ...
    case (MR_Integer) 1:
      switch (DeclaredPurity_12) {
        ...
        case (MR_Integer) 2:
          {
            ...
            hlds__hlds_pred__pred_info_get_markers_2_p_0(PredInfo_10, &Markers_86);
            hlds__hlds_pred__pred_info_get_goal_type_2_p_0(PredInfo_10, &GoalType_87);
            {
              MR_Word NPGoalType_72;

              succeeded = ((MR_tag((MR_Word) GoalType_87)) == (MR_Integer) 0);
              if (succeeded)
              {
                NPGoalType_72 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), GoalType_87, (MR_Integer) 0))) & (MR_Integer) 3);
                switch (NPGoalType_72) {
                  default:
                    succeeded = MR_FALSE;
                    break;
                  case (MR_Integer) 3:
            ...
            if (!(succeeded))
            {
              succeeded = hlds__hlds_pred__check_marker_2_p_0(Markers_86, (MR_Integer) 10);
              if (!(succeeded))
              {
                succeeded = hlds__hlds_pred__check_marker_2_p_0(Markers_86, (MR_Integer) 11);
                if (!(succeeded))
                  succeeded = hlds__hlds_pred__check_marker_2_p_0(Markers_86, (MR_Integer) 0);
              }
            }
            if (succeeded)
              *STATE_VARIABLE_Specs_26 = STATE_VARIABLE_Specs_30_30;
            ...
            {
              MR_Word TooPureSpec_80;

              TooPureSpec_80 = check_hlds__purity__warn_pred_body_too_pure_5_f_0(ModuleInfo_8, PredInfo_10, PredId_9, ActualPurity_11, DeclaredPurity_12);
              {
                MR_Word base;
                base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                *STATE_VARIABLE_Specs_26 = base;
                MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (TooPureSpec_80));
                MR_hl_field(MR_mktag(1), base, 1) = ((MR_Box) (STATE_VARIABLE_Specs_30_30));
              }
            }
          }
        ...
        case (MR_Integer) 0:
          if ((MaybePromisedPurity_13 == (MR_Word) ((MR_Unsigned) 0U)))
          {
            MR_Word NotPureEnoughSpec_70;

            NotPureEnoughSpec_70 = check_hlds__purity__error_not_pure_enough_4_f_0(ModuleInfo_8, PredInfo_10, PredId_9, ActualPurity_11);
            {
              MR_Word base;
              base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              *STATE_VARIABLE_Specs_26 = base;
              MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (NotPureEnoughSpec_70));
              MR_hl_field(MR_mktag(1), base, 1) = ((MR_Box) (STATE_VARIABLE_Specs_30_30));
            }
          }
          else
