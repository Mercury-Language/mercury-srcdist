  ...
  MR_Word * Specs_12)
{
  ...
  if (succeeded)
  {
    ...
    succeeded = parse_tree__prog_type_test__type_is_higher_order_details_5_p_0(TypeOfVar_14, &TypePurity_21, &PredOrFunc_22, &VarArgTypes_24);
  }
  if (succeeded)
  {
    MR_Word TVarSet_25;
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        }
        {
          ...
          MR_hl_field(0, Spec_62, 0) = ((MR_Box) ((MR_String) "function \140check_hlds.purity.report_error_closure_purity\'/3"));
          MR_hl_field(0, Spec_62, 1) = ((MR_Box) ((MR_Unsigned) 0U));
          MR_hl_field(0, Spec_62, 2) = ((MR_Box) ((MR_Unsigned) 64U));
          MR_hl_field(0, Spec_62, 3) = ((MR_Box) (Context_61));
          MR_hl_field(0, Spec_62, 4) = ((MR_Box) (Pieces_65));
        }
        {
