...
{
  {
...

    {
      ...
      MR_hl_field(MR_mktag(1), Spec_4, 2) = ((MR_Box) ((MR_Unsigned) 24U));
...
{
  {
    ...
    if (succeeded)
    {
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(1), Spec_10, 2) = ((MR_Box) ((MR_Unsigned) 36U));
...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), Spec_6, 2) = ((MR_Box) ((MR_Unsigned) 36U));
      ...
      case (MR_Integer) 2:
        {
          ...
          else
          {
            ...
            Pieces_48 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_format_component_0), PredContextPieces_45, Var_49);
            {
              ...
              MR_hl_field(MR_mktag(1), TooPureSpec_28, 2) = ((MR_Box) ((MR_Unsigned) 36U));
...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(0), Spec_10, 2) = ((MR_Box) ((MR_Unsigned) 36U));
