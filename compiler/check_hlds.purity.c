    ...
    case (MR_Integer) 2:
      {
        ...
        AddrSubGoal_1019 = (MR_Word *) (&(MR_hl_field(3, *GoalExpr_9, 2)));
        check_hlds__purity__LCMC__pred__compute_goal_purity__1_6_p_0(SubGoal0_15, AddrSubGoal_1019, Purity_11, ContainsTrace_12, STATE_VARIABLE_Info_0_64, STATE_VARIABLE_Info_65);
      }
      break;
    case (MR_Integer) 3:
        ...
        case (MR_Integer) 6:
          {
            ...
            switch (Kind0_20) {
              ...
              case (MR_Integer) 0:
                {
                  MR_Word SubGoalExpr0_1014 = ((MR_Word) ((MR_hl_field(0, SubGoal0_15, 0))));
                  MR_Word SubGoalInfo0_1015 = ((MR_Word) ((MR_hl_field(0, SubGoal0_15, 1))));
                  MR_Word SubGoals0_1017;
                  MR_Word PostTypeCheck_1018;
                  MR_Word SubGoals0Prime_257;
                  MR_Word Var_254;

                  succeeded = ((((MR_tag((MR_Word) SubGoalExpr0_1014)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(3, SubGoalExpr0_1014, 0)))) == (MR_Integer) 2)));
                  if (succeeded)
                  {
                    Var_254 = ((MR_Unsigned) ((MR_hl_field(3, SubGoalExpr0_1014, 1))) & (MR_Integer) 1);
                    SubGoals0Prime_257 = ((MR_Word) ((MR_hl_field(3, SubGoalExpr0_1014, 2))));
                    succeeded = (Var_254 == (MR_Integer) 0);
                  }
                  if (succeeded)
                    SubGoals0_1017 = SubGoals0Prime_257;
                  else
                    {
                      mercury__require__unexpected_2_p_0((MR_String) "predicate \140check_hlds.purity.compute_scope_expr_purity\'/7", (MR_String) "from_ground_term_initial goal is not plain conj");
                      return;
                    }
                  PostTypeCheck_1018 = ((((MR_Unsigned) ((MR_hl_field(0, STATE_VARIABLE_Info_0_64, 1))) >> 2)) & (MR_Integer) 1);
                  switch (PostTypeCheck_1018) {
                    default: /*NOTREACHED*/ MR_assert(0);
                    case (MR_Integer) 1:
                      {
                        MR_Word Specs_267;
                        ...
                        *GoalExpr_9 = GoalExpr0_8;
                        check_hlds__purity__compute_goal_purity_in_fgt_no_ptc_4_p_0(SubGoals0_1017, STATE_VARIABLE_Info_0_64, (MR_Word) ((MR_Unsigned) 0U), &Specs_267);
                        check_hlds__purity__purity_info_add_messages_3_p_0(Specs_267, STATE_VARIABLE_Info_0_64, STATE_VARIABLE_Info_65);
                        *Purity_11 = (MR_Integer) 0;
                        *ContainsTrace_12 = (MR_Integer) 1;
                      }
                      break;
                    case (MR_Integer) 0:
                      {
                        MR_Word RevMarkedSubGoals_702;
                        MR_Word Invariants_703;

                        check_hlds__purity__compute_goal_purity_in_fgt_ptc_11_p_0(SubGoals0_1017, (MR_Word) ((MR_Unsigned) 0U), &RevMarkedSubGoals_702, (MR_Integer) 0, Purity_11, (MR_Integer) 1, ContainsTrace_12, STATE_VARIABLE_Info_0_64, STATE_VARIABLE_Info_65, (MR_Integer) 0, &Invariants_703);
                        switch (Invariants_703) {
                          default: /*NOTREACHED*/ MR_assert(0);
                          case (MR_Integer) 1:
                            {
                              MR_Word ModuleInfo_404 = ((MR_Word) ((MR_hl_field(0, *STATE_VARIABLE_Info_65, 0))));
                              MR_Word Globals_405;
                              MR_Word OptTuple_406;
                              MR_Integer Threshold_407;
                              MR_Word SubGoal_409;

                              hlds__hlds_module__module_info_get_globals_2_p_0(ModuleInfo_404, &Globals_405);
                              libs__globals__get_opt_tuple_2_p_0(Globals_405, &OptTuple_406);
                              Threshold_407 = ((MR_Integer) ((MR_hl_field(0, OptTuple_406, 9))));
                              hlds__from_ground_term_util__introduce_partial_fgt_scopes_6_p_0(Threshold_407, (MR_Integer) 1, GoalInfo_10, SubGoalInfo0_1015, RevMarkedSubGoals_702, &SubGoal_409);
                              *GoalExpr_9 = ((MR_Word) ((MR_hl_field(0, SubGoal_409, 0))));
                            }
                            break;
                          case (MR_Integer) 0:
                            {
                              MR_Word RevSubGoals_544;
                              MR_Word SubGoals_545;
                              MR_Word SubGoalExpr_546;
                              MR_Word SubGoalInfo_547;
                              MR_Word SubGoal_550;

                              mercury__list__map_3_p_0((MR_Word) (&hlds__from_ground_term_util__hlds__from_ground_term_util__type_ctor_info_fgt_marked_goal_0), (MR_Word) (&hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_hlds_goal_0), (MR_Word) (&check_hlds__purity_scalar_common_1[2]), RevMarkedSubGoals_702, &RevSubGoals_544);
                              mercury__list__reverse_2_p_0((MR_Word) (&hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_hlds_goal_0), RevSubGoals_544, &SubGoals_545);
                              {
                                SubGoalExpr_546 = (MR_Word) MR_mkword(3, MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
                                MR_hl_field(3, SubGoalExpr_546, 0) = ((MR_Box) ((MR_Unsigned) 2U));
                                MR_hl_field(3, SubGoalExpr_546, 1) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 0));
                                MR_hl_field(3, SubGoalExpr_546, 2) = ((MR_Box) (SubGoals_545));
                              }
                              check_hlds__purity__update_purity_ct_in_goal_info_4_p_0(*Purity_11, *ContainsTrace_12, SubGoalInfo0_1015, &SubGoalInfo_547);
                              {
                                SubGoal_550 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
                                MR_hl_field(0, SubGoal_550, 0) = ((MR_Box) (SubGoalExpr_546));
                                MR_hl_field(0, SubGoal_550, 1) = ((MR_Box) (SubGoalInfo_547));
                              }
                              {
                                MR_Word base;
                                base = (MR_Word) MR_mkword(3, MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
                                *GoalExpr_9 = base;
                                MR_hl_field(3, base, 0) = ((MR_Box) ((MR_Unsigned) 5U));
                                MR_hl_field(3, base, 1) = ((MR_Box) (Reason0_14));
                                MR_hl_field(3, base, 2) = ((MR_Box) (SubGoal_550));
                              }
                            }
                            break;
                        }
              ...
              case (MR_Integer) 3:
                {
                  ...
                  MR_Word SubGoal_93;
                  MR_Word Var_236 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_Info_0_64, 0))));
                  MR_Word Var_237 = ((((MR_Unsigned) ((MR_hl_field(0, STATE_VARIABLE_Info_0_64, 1))) >> 2)) & (MR_Integer) 1);
                  MR_Word Var_238 = ((((MR_Unsigned) ((MR_hl_field(0, STATE_VARIABLE_Info_0_64, 1))) >> 1)) & (MR_Integer) 1);
                  MR_Word Var_240 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_Info_0_64, 2))));
                  MR_Word Var_241 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_Info_0_64, 3))));
                  MR_Word Var_242 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_Info_0_64, 4))));

                  {
                    STATE_VARIABLE_Info_4_79 = (MR_Word) MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL);
                    MR_hl_field(0, STATE_VARIABLE_Info_4_79, 0) = ((MR_Box) (Var_236));
                    MR_hl_field(0, STATE_VARIABLE_Info_4_79, 1) = (MR_Box) (((((MR_Unsigned) (Var_237) << 2)) | (((((MR_Unsigned) (Var_238) << 1)) | (MR_Unsigned) ((MR_Integer) 0)))));
                    MR_hl_field(0, STATE_VARIABLE_Info_4_79, 2) = ((MR_Box) (Var_240));
                    MR_hl_field(0, STATE_VARIABLE_Info_4_79, 3) = ((MR_Box) (Var_241));
                    MR_hl_field(0, STATE_VARIABLE_Info_4_79, 4) = ((MR_Box) (Var_242));
                  }
