...
MR_def_label(check_hlds__purity__compute_expr_purity_7_0,149)
	...
	MR_tempr3 = MR_r6;
	MR_sv(6) = MR_tfield(2, MR_tempr3, 0);
	MR_sv(7) = MR_tfield(2, MR_tempr3, 1);
	MR_sv(8) = MR_tfield(2, MR_tempr3, 2);
	MR_sv(9) = MR_tfield(2, MR_tempr3, 4);
	MR_sv(10) = MR_tfield(2, MR_tempr3, 5);
	MR_sv(11) = MR_tfield(2, MR_tempr3, 6);
	MR_sv(12) = MR_tfield(2, MR_tempr3, 7);
	MR_tempr2 = MR_tfield(2, MR_tempr3, 8);
...
MR_def_label(check_hlds__purity__compute_expr_purity_7_0,10)
	...
	MR_tfield(3, MR_r2, 3) = MR_tfield(3, MR_tempr1, 3);
	MR_tfield(3, MR_r2, 4) = MR_tfield(3, MR_tempr1, 4);
	MR_tfield(3, MR_r2, 5) = MR_tfield(3, MR_tempr1, 5);
	MR_tfield(3, MR_r2, 6) = MR_tfield(3, MR_tempr1, 6);
	MR_tfield(3, MR_r2, 7) = MR_tfield(3, MR_tempr1, 7);
	MR_r1 = MR_r2;
	MR_r2 = MR_sv(2);
	MR_r3 = (MR_Integer) 1;
	MR_r4 = MR_sv(12);
...
MR_def_label(check_hlds__purity__compute_purity_for_clause_6_0,22)
	...
	MR_tfield(0, MR_tempr1, 1) = MR_r1;
	MR_tempr3 = MR_sv(9);
	MR_tempr2 = MR_tfield(0, MR_tempr3, 6);
