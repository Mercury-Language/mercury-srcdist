...
MR_decl_label10(check_hlds__purity__wrap_inner_outer_goals_5_0, 2,3,4,13,14,15,22,23,30,31)
MR_decl_label1(check_hlds__purity__wrap_inner_outer_goals_5_0, 32)
...
MR_BEGIN_MODULE(check_hlds__purity_module24)
	...
	MR_init_label10(check_hlds__purity__wrap_inner_outer_goals_5_0,2,3,4,13,14,15,22,23,30,31)
	MR_init_label1(check_hlds__purity__wrap_inner_outer_goals_5_0,32)
MR_BEGIN_CODE
...
MR_def_label(check_hlds__purity__wrap_inner_outer_goals_5_0,3)
	...
	MR_sv(9) = MR_tfield(0, MR_sv(10), 0);
	}
...
MR_def_label(check_hlds__purity__wrap_inner_outer_goals_5_0,4)
	...
	MR_tfield(0, MR_tempr4, 1) = (MR_Word) MR_TAG_COMMON(3,8,1);
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 2);
	MR_tfield(1, MR_tempr1, 0) = MR_tempr4;
	MR_tfield(1, MR_tempr1, 1) = (MR_Word) MR_tbmkword(0, 0);
	MR_tag_alloc_heap(MR_tempr5, 1, (MR_Integer) 2);
	...
	MR_sv(13) = (MR_Word) MR_TAG_COMMON(3,8,1);
	MR_r1 = MR_tempr5;
	}
...
MR_def_label(check_hlds__purity__wrap_inner_outer_goals_5_0,31)
	...
	MR_np_call_localret_ent(hlds__hlds_goal__goal_info_add_feature_3_0,
		check_hlds__purity__wrap_inner_outer_goals_5_0_i32);
MR_def_label(check_hlds__purity__wrap_inner_outer_goals_5_0,32)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 0, (MR_Integer) 2);
