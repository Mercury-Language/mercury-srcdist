  ...
  else
  {
    ...
    if ((Var_581 == (MR_Word) ((MR_Unsigned) 0U)))
    {
...

      {
        ...
        MR_hl_field(MR_mktag(3), Var_80, 0) = ((MR_Box) ((MR_Unsigned) 22U));
    ...
    else
    {
      ...
      if ((Var_583 == (MR_Word) ((MR_Unsigned) 0U)))
      {
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(3), Var_536, 0) = ((MR_Box) ((MR_Unsigned) 22U));
      ...
      else
      {
...

        {
          ...
          MR_hl_field(MR_mktag(3), Var_150, 0) = ((MR_Box) ((MR_Unsigned) 22U));
