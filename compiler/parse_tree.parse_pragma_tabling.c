                ...
                {
                  {
                    ...
                    MR_hl_field(MR_mktag(0), STATE_VARIABLE_Attributes_27_27, 0) = ((MR_Box) (Var_165));
                    MR_hl_field(MR_mktag(0), STATE_VARIABLE_Attributes_27_27, 1) = ((MR_Box) (Var_166));
            ...
            case (MR_Integer) 1:
              {
                ...
                if (succeeded)
                {
                  {
                    STATE_VARIABLE_Attributes_27_27 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
                    MR_hl_field(MR_mktag(0), STATE_VARIABLE_Attributes_27_27, 0) = ((MR_Box) (Var_174));
                    MR_hl_field(MR_mktag(0), STATE_VARIABLE_Attributes_27_27, 1) = ((MR_Box) (Var_175));
            ...
            case (MR_Integer) 2:
              {
                ...
                if (succeeded)
                {
                  {
                    STATE_VARIABLE_Attributes_27_27 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
                    MR_hl_field(MR_mktag(0), STATE_VARIABLE_Attributes_27_27, 0) = ((MR_Box) (Var_183));
                    MR_hl_field(MR_mktag(0), STATE_VARIABLE_Attributes_27_27, 1) = ((MR_Box) (Var_184));
            ...
            {
              {
                ...
                MR_hl_field(MR_mktag(0), STATE_VARIABLE_Attributes_27_27, 1) = ((MR_Box) (Var_147));
        ...
        case (MR_Integer) 2:
          {
            ...
            if (succeeded)
            {
              ...
              {
                STATE_VARIABLE_Attributes_27_27 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
                MR_hl_field(MR_mktag(0), STATE_VARIABLE_Attributes_27_27, 0) = ((MR_Box) (Var_156));
