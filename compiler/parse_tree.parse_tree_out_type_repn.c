...
parse_tree__parse_tree_out_type_repn__IntroducedFrom__func__mercury_output_item_type_repn__78__1_2_f_0(
  MR_Word Context_12,
...
static void MR_CALL 
parse_tree__parse_tree_out_type_repn__mercury_output_item_type_repn_4_p_0_2(
  MR_Box closure_arg,
  MR_Box wrapper_arg_1,
  MR_Box wrapper_arg_2,
  MR_Box * wrapper_arg_3);
...
static /* final */ const MR_Box parse_tree__parse_tree_out_type_repn_scalar_common_3[4][6];

static /* final */ const MR_Box parse_tree__parse_tree_out_type_repn_scalar_common_4[7][3];
...
static /* final */ const MR_Box parse_tree__parse_tree_out_type_repn_scalar_common_4[7][3] = {
  ...
  /* row 6 */
  {
    ((MR_Box) (&parse_tree__parse_tree_out_type_repn_scalar_common_3[3])),
    ((MR_Box) (parse_tree__parse_tree_out_type_repn__mercury_output_item_type_repn_4_p_0_2)),
    ((MR_Box) ((MR_Integer) 0))
  },
};
...
{
  {
    ...
    {
      LambdaHeadVar__2_33 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), LambdaHeadVar__2_33, 0) = ((MR_Box) (LambdaHeadVar__1_32));
      MR_hl_field(MR_mktag(1), LambdaHeadVar__2_33, 1) = ((MR_Box) (Context_12));
    }
...
{
  {
    ...
    conv0_LambdaHeadVar__2_33 = parse_tree__parse_tree_out_type_repn__IntroducedFrom__func__mercury_output_item_type_repn__78__1_2_f_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) (wrapper_arg_1)));
...
{
  {
    ...
    parse_tree__parse_tree_out_info__maybe_unqualify_sym_name_3_p_0(Info_5, TypeCtorSymName0_8, &TypeCtorSymName_14);
    {
      ...
      MR_hl_field(MR_mktag(0), Var_31, 0) = ((MR_Box) (&parse_tree__parse_tree_out_type_repn_scalar_common_3[2]));
      MR_hl_field(MR_mktag(0), Var_31, 1) = ((MR_Box) (parse_tree__parse_tree_out_type_repn__mercury_output_item_type_repn_4_p_0_1));
      MR_hl_field(MR_mktag(0), Var_31, 2) = ((MR_Box) ((MR_Integer) 1));
      MR_hl_field(MR_mktag(0), Var_31, 3) = ((MR_Box) (Context_12));
    }
    Args_15 = mercury__list__map_2_f_0((MR_Word) (&parse_tree__parse_tree_out_type_repn_scalar_common_1[0]), (MR_Word) (&parse_tree__parse_tree_out_type_repn_scalar_common_1[1]), Var_31, TypeParams_9);
    ...
    switch (MR_tag((MR_Word) RepnInfo_10)) {
      ...
      case (MR_Integer) 1:
        {
          MR_Integer NumBits_18 = ((MR_Integer) ((MR_hl_field(MR_mktag(1), RepnInfo_10, (MR_Integer) 0))));
          MR_Word FillKind_19 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(1), RepnInfo_10, (MR_Integer) 1))) & (MR_Integer) 7);
          MR_String FillKindStr_20;
          MR_String Var_128;

          parse_tree__prog_data__fill_kind_string_2_p_0(FillKind_19, &FillKindStr_20);
          mercury__io__write_string_3_p_0((MR_String) " fits_in_n_bits(");
          mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&parse_tree__parse_tree_out_type_repn_scalar_common_7[0]), NumBits_18, &Var_128);
          mercury__io__write_string_3_p_0(Var_128);
          mercury__io__write_string_3_p_0((MR_String) ", ");
          mercury__io__write_string_3_p_0(FillKindStr_20);
          mercury__io__write_string_3_p_0((MR_String) ")");
        }
        break;
      case (MR_Integer) 2:
        {
          MR_Word SymNameAndArities_22 = ((MR_Word) ((MR_hl_field(MR_mktag(2), RepnInfo_10, (MR_Integer) 0))));

          mercury__io__write_string_3_p_0((MR_String) " has_direct_arg_functors([");
          mercury__io__write_list_5_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_sym_name_arity_0), SymNameAndArities_22, (MR_String) ", ", (MR_Word) (&parse_tree__parse_tree_out_type_repn_scalar_common_4[6]));
          mercury__io__write_string_3_p_0((MR_String) "])");
        }
        break;
      case (MR_Integer) 3:
        switch (((MR_Integer) ((MR_hl_field(MR_mktag(3), RepnInfo_10, (MR_Integer) 0))))) {
          ...
          case (MR_Integer) 0:
            {
              MR_Word EqvType_21 = ((MR_Word) ((MR_hl_field(MR_mktag(3), RepnInfo_10, (MR_Integer) 1))));

              mercury__io__write_string_3_p_0((MR_String) " is_eqv_to(");
              parse_tree__mercury_to_mercury__mercury_output_type_5_p_0(TVarSet_11, (MR_Integer) 2, EqvType_21);
              mercury__io__write_string_3_p_0((MR_String) ")");
            }
            break;
          case (MR_Integer) 1:
            {
              MR_Word DuRepn_23 = ((MR_Word) ((MR_hl_field(MR_mktag(3), RepnInfo_10, (MR_Integer) 1))));
              MR_Word TypeRepnFor_24;

              TypeRepnFor_24 = parse_tree__parse_tree_out_info__get_type_repn_for_1_f_0(Info_5);
              switch (TypeRepnFor_24) {
                default: /*NOTREACHED*/ MR_assert(0);
                case (MR_Integer) 1:
                  {
                    MR_String I_25;

                    I_25 = parse_tree__parse_tree_out_type_repn__indent_1_f_0((MR_Integer) 1);
                    mercury__io__write_string_3_p_0((MR_String) "\n");
                    mercury__io__write_string_3_p_0(I_25);
                    mercury__io__write_string_3_p_0((MR_String) "du_repn(");
                    parse_tree__parse_tree_out_type_repn__mercury_output_du_type_repn_6_p_0(TypeRepnFor_24, (MR_Integer) 2, TVarSet_11, DuRepn_23);
                    mercury__io__write_string_3_p_0((MR_String) "\n");
                    mercury__io__write_string_3_p_0(I_25);
                    mercury__io__write_string_3_p_0((MR_String) ")");
                  }
          ...
          case (MR_Integer) 2:
            {
              MR_Word MaybeCJCsERepn_26 = ((MR_Word) ((MR_hl_field(MR_mktag(3), RepnInfo_10, (MR_Integer) 1))));
              MR_Word TypeRepnFor_108;

              TypeRepnFor_108 = parse_tree__parse_tree_out_info__get_type_repn_for_1_f_0(Info_5);
              switch (TypeRepnFor_108) {
                default: /*NOTREACHED*/ MR_assert(0);
                case (MR_Integer) 1:
                  {
                    MR_String I_106;

                    I_106 = parse_tree__parse_tree_out_type_repn__indent_1_f_0((MR_Integer) 1);
                    mercury__io__write_string_3_p_0((MR_String) "\n");
                    mercury__io__write_string_3_p_0(I_106);
                    mercury__io__write_string_3_p_0((MR_String) "foreign_type_repn(\n");
                    parse_tree__parse_tree_out_type_repn__mercury_output_c_j_cs_e_repn_5_p_0(TypeRepnFor_108, (MR_Integer) 2, MaybeCJCsERepn_26);
                    mercury__io__write_string_3_p_0((MR_String) "\n");
                    mercury__io__write_string_3_p_0(I_106);
                    mercury__io__write_string_3_p_0((MR_String) ")");
                  }
