...
#line 27 "hlds.make_hlds.make_hlds_error.c"
#line 538 "../library/io.int"
#include "string.mh"

#line 31 "hlds.make_hlds.make_hlds_error.c"
#line 87 "../library/table_builtin.int2"
#include "table_builtin.mh"

#line 35 "hlds.make_hlds.make_hlds_error.c"
#line 29 "../library/bitmap.int2"
#include "bitmap.mh"

#line 39 "hlds.make_hlds.make_hlds_error.c"
#line 28 "../library/time.int2"
#include "time.mh"

#line 43 "hlds.make_hlds.make_hlds_error.c"
#line 17 "../mdbcomp/mdbcomp.rtti_access.int2"
#include "mdbcomp.rtti_access.mh"

#line 47 "hlds.make_hlds.make_hlds_error.c"
#line 48 "hlds.make_hlds.make_hlds_error.c"
#include "hlds.make_hlds.make_hlds_error.mh"

#line 51 "hlds.make_hlds.make_hlds_error.c"
...
#line 56 "hlds.make_hlds.make_hlds_error.c"
#line 57 "hlds.make_hlds.make_hlds_error.c"

#endif
#line 60 "hlds.make_hlds.make_hlds_error.c"
...
MR_decl_label5(hlds__make_hlds__make_hlds_error__maybe_undefined_pred_error_10_0, 2,3,4,5,10)
MR_decl_label3(hlds__make_hlds__make_hlds_error__multiple_def_error_9_0, 18,5,6)
...
MR_BEGIN_MODULE(hlds__make_hlds__make_hlds_error_module0)
	...
	MR_init_label3(hlds__make_hlds__make_hlds_error__multiple_def_error_9_0,18,5,6)
MR_BEGIN_CODE
...
MR_define_entry(mercury__hlds__make_hlds__make_hlds_error__multiple_def_error_9_0);
	...
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
		MR_GOTO_LAB(hlds__make_hlds__make_hlds_error__multiple_def_error_9_0_i18);
	}
	MR_r1 = MR_r8;
	MR_proceed();
MR_def_label(hlds__make_hlds__make_hlds_error__multiple_def_error_9_0,18)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(2);
	...
	MR_tfield(1, MR_tempr12, 1) = (MR_Integer) 1;
	MR_tfield(1, MR_tempr12, 2) = (MR_Integer) 0;
	MR_tfield(1, MR_tempr12, 3) = MR_tempr1;
	if (MR_LTAGS_TESTR(MR_r7,0,0)) {
		MR_GOTO_LAB(hlds__make_hlds__make_hlds_error__multiple_def_error_9_0_i5);
	}
	...
	MR_np_call_localret_ent(fn__f_108_105_115_116_95_95_43_43_2_0,
		hlds__make_hlds__make_hlds_error__multiple_def_error_9_0_i6);
MR_def_label(hlds__make_hlds__make_hlds_error__multiple_def_error_9_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	...
	MR_np_call_localret_ent(fn__f_108_105_115_116_95_95_43_43_2_0,
		hlds__make_hlds__make_hlds_error__multiple_def_error_9_0_i6);
MR_def_label(hlds__make_hlds__make_hlds_error__multiple_def_error_9_0,6)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
...
MR_BEGIN_MODULE(hlds__make_hlds__make_hlds_error_module3)
	...
	MR_init_label5(hlds__make_hlds__make_hlds_error__maybe_undefined_pred_error_10_0,2,3,4,5,10)
MR_BEGIN_CODE
...
MR_def_label(hlds__make_hlds__make_hlds_error__maybe_undefined_pred_error_10_0,5)
	...
	MR_sv(2) = MR_tempr1;
	MR_sv(3) = (MR_Word) MR_TAG_COMMON(3,0,4);
	MR_sv(4) = MR_tempr3;
	MR_sv(5) = (MR_Word) MR_TAG_COMMON(3,0,7);
	MR_r1 = MR_ctfield(0, MR_tempr2, 0);
	}
	MR_np_call_localret_ent(fn__parse_tree__prog_out__pred_or_func_to_str_1_0,
		hlds__make_hlds__make_hlds_error__maybe_undefined_pred_error_10_0_i10);
MR_def_label(hlds__make_hlds__make_hlds_error__maybe_undefined_pred_error_10_0,10)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
...
void mercury__hlds__make_hlds__make_hlds_error__write_out_proc_statics(FILE *fp);
#endif
