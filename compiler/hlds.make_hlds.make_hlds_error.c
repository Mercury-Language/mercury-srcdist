...
{
  {
    ...
    else
    {
      ...
      Var_66 = mercury__list__map_2_f_0((MR_Word) &mercury__builtin__builtin__type_ctor_info_int_0, (MR_Word) &hlds__make_hlds__make_hlds_error_scalar_common_1[0], Var_67, ProcIds_22);
