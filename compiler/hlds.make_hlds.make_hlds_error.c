...
{
  {
    ...
    {
      libs__globals__lookup_bool_option_3_p_0(hlds__make_hlds__make_hlds_error__Globals_22, (MR_Integer) 180, &hlds__make_hlds__make_hlds_error__InferTypes_23);
    }
...
{
  {
    ...
    }
    {
      hlds__make_hlds__make_hlds_error__Var_30 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), hlds__make_hlds__make_hlds_error__Var_30, 0) = ((MR_Box) (hlds__make_hlds__make_hlds_error__Var_31));
      MR_hl_field(MR_mktag(1), hlds__make_hlds__make_hlds_error__Var_30, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &hlds__make_hlds__make_hlds_error_scalar_common_1[2])));
    }
    {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), hlds__make_hlds__make_hlds_error__Pieces1_16, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__make_hlds_error_scalar_common_1[18])));
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), hlds__make_hlds__make_hlds_error__Var_43, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &hlds__make_hlds__make_hlds_error_scalar_common_1[4])));
    }
    {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), hlds__make_hlds__make_hlds_error__Pieces2_17, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__make_hlds_error_scalar_common_1[19])));
