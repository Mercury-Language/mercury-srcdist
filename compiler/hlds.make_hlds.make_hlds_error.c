...
{
  {
    ...
    {
      hlds__make_hlds__make_hlds_error__Var_17 = mercury__list__f_43_43_2_f_0(hlds__make_hlds__make_hlds_error__TypeCtorInfo_32_32, hlds__make_hlds__make_hlds_error__ItemPieces_6, (MR_Word) MR_mkword(MR_mktag(1), &hlds__make_hlds__make_hlds_error_scalar_common_1[17]));
    }
    {
      hlds__make_hlds__make_hlds_error__Pieces_8 = mercury__list__f_43_43_2_f_0(hlds__make_hlds__make_hlds_error__TypeCtorInfo_32_32, (MR_Word) MR_mkword(MR_mktag(1), &hlds__make_hlds__make_hlds_error_scalar_common_1[30]), hlds__make_hlds__make_hlds_error__Var_17);
    }
    {
...
{
  {
    ...
    {
      libs__globals__lookup_bool_option_3_p_0(hlds__make_hlds__make_hlds_error__Globals_22, (MR_Integer) 179, &hlds__make_hlds__make_hlds_error__InferTypes_23);
    }
      ...
      *hlds__make_hlds__make_hlds_error__STATE_VARIABLE_Specs_41 = hlds__make_hlds__make_hlds_error__STATE_VARIABLE_Specs_0_40;
    else
      {
        ...
        hlds__make_hlds__make_hlds_error__TypeCtorInfo_122_122 = (MR_Word) &parse_tree__error_util__parse_tree__error_util__type_ctor_info_format_component_0;
        {
          ...
          MR_hl_field(MR_mktag(1), hlds__make_hlds__make_hlds_error__Var_43, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__make_hlds_error_scalar_common_1[18])));
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(3), hlds__make_hlds__make_hlds_error__Var_50, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 14));
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(3), hlds__make_hlds__make_hlds_error__Var_58, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 15));
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(1), hlds__make_hlds__make_hlds_error__Var_57, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &hlds__make_hlds__make_hlds_error_scalar_common_1[15])));
        }
        {
          ...
          MR_hl_field(MR_mktag(1), hlds__make_hlds__make_hlds_error__Var_54, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__make_hlds_error_scalar_common_1[23])));
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(1), hlds__make_hlds__make_hlds_error__Var_46, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__make_hlds_error_scalar_common_1[20])));
            ...
            if ((hlds__make_hlds__make_hlds_error__Var_136 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
              {
                ...
                }
                {
                  ...
                  MR_hl_field(MR_mktag(1), hlds__make_hlds__make_hlds_error__Var_101, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &hlds__make_hlds__make_hlds_error_scalar_common_1[4])));
                }
                {
                  ...
                  MR_hl_field(MR_mktag(1), hlds__make_hlds__make_hlds_error__Var_98, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__make_hlds_error_scalar_common_1[26])));
                ...
                }
                {
                  ...
                  MR_hl_field(MR_mktag(1), hlds__make_hlds__make_hlds_error__Var_95, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__make_hlds_error_scalar_common_1[25])));
            ...
            else
              {
                ...
                }
                {
                  ...
                  MR_hl_field(MR_mktag(1), hlds__make_hlds__make_hlds_error__Var_78, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__make_hlds_error_scalar_common_1[29])));
                ...
                }
                {
                  ...
                  MR_hl_field(MR_mktag(1), hlds__make_hlds__make_hlds_error__Var_75, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__make_hlds_error_scalar_common_1[28])));
                ...
                }
                {
                  ...
                  MR_hl_field(MR_mktag(1), hlds__make_hlds__make_hlds_error__Var_70, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__make_hlds_error_scalar_common_1[27])));
                  MR_hl_field(MR_mktag(1), hlds__make_hlds__make_hlds_error__Var_70, 1) = ((MR_Box) (hlds__make_hlds__make_hlds_error__Var_73));
                }
                {
                  hlds__make_hlds__make_hlds_error__OtherAritiesPieces_126 = mercury__list__f_43_43_2_f_0(hlds__make_hlds__make_hlds_error__TypeCtorInfo_122_122, hlds__make_hlds__make_hlds_error__Var_70, (MR_Word) MR_mkword(MR_mktag(1), &hlds__make_hlds__make_hlds_error_scalar_common_1[4]));
                }
                {
...
{
  {
...

    {
      ...
      MR_hl_field(MR_mktag(1), hlds__make_hlds__make_hlds_error__Var_17, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__make_hlds_error_scalar_common_1[18])));
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), hlds__make_hlds__make_hlds_error__Var_23, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &hlds__make_hlds__make_hlds_error_scalar_common_1[22])));
    }
    {
      ...
      MR_hl_field(MR_mktag(1), hlds__make_hlds__make_hlds_error__Var_20, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__make_hlds_error_scalar_common_1[20])));
...
{
  {
    ...
    }
    {
      hlds__make_hlds__make_hlds_error__Var_23 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), hlds__make_hlds__make_hlds_error__Var_23, 0) = ((MR_Box) (hlds__make_hlds__make_hlds_error__Var_24));
      MR_hl_field(MR_mktag(1), hlds__make_hlds__make_hlds_error__Var_23, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &hlds__make_hlds__make_hlds_error_scalar_common_1[14])));
    }
    {
      hlds__make_hlds__make_hlds_error__Var_20 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), hlds__make_hlds__make_hlds_error__Var_20, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__make_hlds_error_scalar_common_1[20])));
      ...
      case (MR_Integer) 0:
        {
          ...
          MR_Word hlds__make_hlds__make_hlds_error__Var_33;
          MR_Word hlds__make_hlds__make_hlds_error__Var_34;
          MR_Word hlds__make_hlds__make_hlds_error__Var_43;
          MR_Word hlds__make_hlds__make_hlds_error__Var_45;
          MR_Word hlds__make_hlds__make_hlds_error__Var_54;
          MR_Word hlds__make_hlds__make_hlds_error__Var_55;
          MR_Word hlds__make_hlds__make_hlds_error__Var_57;
          MR_Word hlds__make_hlds__make_hlds_error__Var_60;
          MR_Word hlds__make_hlds__make_hlds_error__Var_61;
          MR_Word hlds__make_hlds__make_hlds_error__Var_70;
          MR_Word hlds__make_hlds__make_hlds_error__Var_71;
          MR_Word hlds__make_hlds__make_hlds_error__Var_72;

          {
            hlds__make_hlds__make_hlds_error__Var_31 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(2), hlds__make_hlds__make_hlds_error__Var_31, 0) = ((MR_Box) (hlds__make_hlds__make_hlds_error__DefType_13));
          }
          {
            hlds__make_hlds__make_hlds_error__Var_34 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
            MR_hl_field(MR_mktag(0), hlds__make_hlds__make_hlds_error__Var_34, 0) = ((MR_Box) (hlds__make_hlds__make_hlds_error__Name_11));
            MR_hl_field(MR_mktag(0), hlds__make_hlds__make_hlds_error__Var_34, 1) = ((MR_Box) (hlds__make_hlds__make_hlds_error__Arity_12));
          }
          {
            hlds__make_hlds__make_hlds_error__Var_33 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(3), hlds__make_hlds__make_hlds_error__Var_33, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 9));
            MR_hl_field(MR_mktag(3), hlds__make_hlds__make_hlds_error__Var_33, 1) = ((MR_Box) (hlds__make_hlds__make_hlds_error__Var_34));
          }
          {
            hlds__make_hlds__make_hlds_error__Var_32 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), hlds__make_hlds__make_hlds_error__Var_32, 0) = ((MR_Box) (hlds__make_hlds__make_hlds_error__Var_33));
            MR_hl_field(MR_mktag(1), hlds__make_hlds__make_hlds_error__Var_32, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &hlds__make_hlds__make_hlds_error_scalar_common_1[2])));
          }
          {
            hlds__make_hlds__make_hlds_error__Var_30 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), hlds__make_hlds__make_hlds_error__Var_30, 0) = ((MR_Box) (hlds__make_hlds__make_hlds_error__Var_31));
            MR_hl_field(MR_mktag(1), hlds__make_hlds__make_hlds_error__Var_30, 1) = ((MR_Box) (hlds__make_hlds__make_hlds_error__Var_32));
          }
          {
            ...
            MR_hl_field(MR_mktag(1), hlds__make_hlds__make_hlds_error__Pieces1_18, 1) = ((MR_Box) (hlds__make_hlds__make_hlds_error__Var_30));
          }
          {
            hlds__make_hlds__make_hlds_error__Var_45 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), hlds__make_hlds__make_hlds_error__Var_45, 0) = ((MR_Box) (hlds__make_hlds__make_hlds_error__Var_33));
            MR_hl_field(MR_mktag(1), hlds__make_hlds__make_hlds_error__Var_45, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &hlds__make_hlds__make_hlds_error_scalar_common_1[4])));
          }
          {
            hlds__make_hlds__make_hlds_error__Var_43 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), hlds__make_hlds__make_hlds_error__Var_43, 0) = ((MR_Box) (hlds__make_hlds__make_hlds_error__Var_31));
            MR_hl_field(MR_mktag(1), hlds__make_hlds__make_hlds_error__Var_43, 1) = ((MR_Box) (hlds__make_hlds__make_hlds_error__Var_45));
          }
          {
            ...
            MR_hl_field(MR_mktag(1), hlds__make_hlds__make_hlds_error__Pieces2_19, 1) = ((MR_Box) (hlds__make_hlds__make_hlds_error__Var_43));
          }
          {
            hlds__make_hlds__make_hlds_error__Var_55 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL);
            MR_hl_field(MR_mktag(0), hlds__make_hlds__make_hlds_error__Var_55, 0) = ((MR_Box) (hlds__make_hlds__make_hlds_error__Pieces1_18));
          }
          {
            hlds__make_hlds__make_hlds_error__Var_54 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), hlds__make_hlds__make_hlds_error__Var_54, 0) = ((MR_Box) (hlds__make_hlds__make_hlds_error__Var_55));
            MR_hl_field(MR_mktag(1), hlds__make_hlds__make_hlds_error__Var_54, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
          }
          {
            ...
            MR_hl_field(MR_mktag(0), hlds__make_hlds__make_hlds_error__Msg1_20, 1) = ((MR_Box) (hlds__make_hlds__make_hlds_error__Var_54));
          }
          {
            hlds__make_hlds__make_hlds_error__Var_57 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), hlds__make_hlds__make_hlds_error__Var_57, 0) = ((MR_Box) (hlds__make_hlds__make_hlds_error__OrigContext_15));
          }
          {
            hlds__make_hlds__make_hlds_error__Var_61 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL);
            MR_hl_field(MR_mktag(0), hlds__make_hlds__make_hlds_error__Var_61, 0) = ((MR_Box) (hlds__make_hlds__make_hlds_error__Pieces2_19));
          }
          {
            hlds__make_hlds__make_hlds_error__Var_60 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), hlds__make_hlds__make_hlds_error__Var_60, 0) = ((MR_Box) (hlds__make_hlds__make_hlds_error__Var_61));
            MR_hl_field(MR_mktag(1), hlds__make_hlds__make_hlds_error__Var_60, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
          }
          {
            ...
            MR_hl_field(MR_mktag(1), hlds__make_hlds__make_hlds_error__Msg2_21, 0) = ((MR_Box) (hlds__make_hlds__make_hlds_error__Var_57));
            ...
            MR_hl_field(MR_mktag(1), hlds__make_hlds__make_hlds_error__Msg2_21, 3) = ((MR_Box) (hlds__make_hlds__make_hlds_error__Var_60));
          }
          if ((hlds__make_hlds__make_hlds_error__ExtraPieces_16 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
          ...
          else
            {
              ...
              {
                hlds__make_hlds__make_hlds_error__Var_65 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL);
                MR_hl_field(MR_mktag(0), hlds__make_hlds__make_hlds_error__Var_65, 0) = ((MR_Box) (hlds__make_hlds__make_hlds_error__ExtraPieces_16));
              }
              {
                hlds__make_hlds__make_hlds_error__Var_64 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(1), hlds__make_hlds__make_hlds_error__Var_64, 0) = ((MR_Box) (hlds__make_hlds__make_hlds_error__Var_65));
                MR_hl_field(MR_mktag(1), hlds__make_hlds__make_hlds_error__Var_64, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
              }
              {
                hlds__make_hlds__make_hlds_error__Var_63 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
                MR_hl_field(MR_mktag(0), hlds__make_hlds__make_hlds_error__Var_63, 0) = ((MR_Box) (hlds__make_hlds__make_hlds_error__Context_14));
                MR_hl_field(MR_mktag(0), hlds__make_hlds__make_hlds_error__Var_63, 1) = ((MR_Box) (hlds__make_hlds__make_hlds_error__Var_64));
              }
              {
                ...
                MR_hl_field(MR_mktag(1), hlds__make_hlds__make_hlds_error__ExtraMsgs_22, 0) = ((MR_Box) (hlds__make_hlds__make_hlds_error__Var_63));
          ...
          {
            hlds__make_hlds__make_hlds_error__Var_72 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), hlds__make_hlds__make_hlds_error__Var_72, 0) = ((MR_Box) (hlds__make_hlds__make_hlds_error__Msg2_21));
            MR_hl_field(MR_mktag(1), hlds__make_hlds__make_hlds_error__Var_72, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
          }
          {
            hlds__make_hlds__make_hlds_error__Var_71 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), hlds__make_hlds__make_hlds_error__Var_71, 0) = ((MR_Box) (hlds__make_hlds__make_hlds_error__Msg1_20));
            MR_hl_field(MR_mktag(1), hlds__make_hlds__make_hlds_error__Var_71, 1) = ((MR_Box) (hlds__make_hlds__make_hlds_error__Var_72));
          }
          {
            hlds__make_hlds__make_hlds_error__Var_70 = mercury__list__f_43_43_2_f_0((MR_Word) &parse_tree__error_util__parse_tree__error_util__type_ctor_info_error_msg_0, hlds__make_hlds__make_hlds_error__Var_71, hlds__make_hlds__make_hlds_error__ExtraMsgs_22);
          }
          {
            ...
            MR_hl_field(MR_mktag(0), hlds__make_hlds__make_hlds_error__Spec_25, 2) = ((MR_Box) (hlds__make_hlds__make_hlds_error__Var_70));
          }
          {
            MR_Word base;
            base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
