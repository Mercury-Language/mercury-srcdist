...
MR_decl_label3(hlds__make_hlds__make_hlds_error__multiple_def_error_9_0, 51,28,37)
...
MR_BEGIN_MODULE(hlds__make_hlds__make_hlds_error_module0)
	...
	MR_init_label3(hlds__make_hlds__make_hlds_error__multiple_def_error_9_0,51,28,37)
MR_BEGIN_CODE
...
MR_define_entry(mercury__hlds__make_hlds__make_hlds_error__multiple_def_error_9_0);
	...
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
		MR_GOTO_LAB(hlds__make_hlds__make_hlds_error__multiple_def_error_9_0_i51);
	}
	MR_r1 = MR_r8;
	MR_proceed();
MR_def_label(hlds__make_hlds__make_hlds_error__multiple_def_error_9_0,51)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(2);
