...
ll_backend__layout_out__IntroducedFrom__pred__output_layout_slot_chunk__3244__1_4_p_0(
  ...
  MR_Word HeadVar__2_28)
{
  void MR_CALL (* func_0)(MR_Box, MR_Box, MR_Box, MR_Box, MR_Box *) = ((void MR_CALL (*)(MR_Box, MR_Box, MR_Box, MR_Box, MR_Box *)) ((MR_hl_field(0, (MR_hl_field(0, (MR_Word) (&ll_backend__layout_out_scalar_common_2[0]), (MR_Integer) 0)), (MR_Integer) 8))));
