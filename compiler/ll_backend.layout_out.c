...
{
  {
    ...
    mercury__list__foldl2_6_p_2(TypeCtorInfo_61_61, (MR_Word) &ll_backend__llds_out__llds_out_util__ll_backend__llds_out__llds_out_util__type_ctor_info_decl_set_0, TypeCtorInfo_63_63, Var_19, CallSiteStatics_8, ((MR_Box) (STATE_VARIABLE_DeclSet_0_15)), &conv2_STATE_VARIABLE_DeclSet_16, ((MR_Box) ((MR_Integer) 0)), &conv1_STATE_VARIABLE_IO_21_21);
