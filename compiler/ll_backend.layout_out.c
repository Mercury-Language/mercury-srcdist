  ...
  MR_Word * STATE_VARIABLE_DeclSet_23)
{
  ...
  else
  {
    ...
    switch (AutoComments_21) {
      ...
      case (MR_Integer) 0:
        {
          MR_Word LeftOverVarNums_94;
          MR_Integer STATE_VARIABLE_Slot_22_99;

          ll_backend__layout_out__output_upto_n_numbers_in_vector_noac_8_p_0(Stream_12, LineNumbers_15, (MR_Integer) 1000, &LeftOverVarNums_94, (MR_Integer) 0, &STATE_VARIABLE_Slot_22_99);
          ll_backend__layout_out__output_numbers_in_vector_noac_5_p_0(Stream_12, LeftOverVarNums_94, STATE_VARIABLE_Slot_22_99);
        }
        break;
    }
  }
