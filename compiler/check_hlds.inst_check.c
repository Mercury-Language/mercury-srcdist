...
MR_def_label(fn__check_hlds__inst_check__index_types_by_unqualified_functors_1_0,19)
	...
	MR_tfield(0, MR_r2, 2) = (MR_Word) MR_TAG_COMMON(0,2,0);
	MR_tag_alloc_heap(MR_tempr1, 0, (MR_Integer) 4);
	MR_r3 = MR_tempr1;
	MR_tfield(0, MR_tempr1, 0) = (MR_Word) MR_COMMON(4,0);
	MR_tfield(0, MR_tempr1, 1) = (MR_Word) MR_ENTRY_AP(fn__check_hlds__inst_check__IntroducedFrom__func__index_types_by_unqualified_functors__340__1_3_0);
