        ...
        Arity_25 = ((MR_Integer) ((MR_hl_field(3, ConsId_22, (MR_Integer) 2))));
        {
          ...
          else
          {
            ...
            else
            {
              ...
              mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&check_hlds__inst_check_scalar_common_3[17]), HeadVar__2_2, &Var_81);
              ...
              ExpectedAritiesPieces_48 = parse_tree__error_spec__piece_list_to_color_pieces_4_f_0((MR_Integer) 1, (MR_String) "or", (MR_Word) (MR_mkword(1, &check_hlds__inst_check_scalar_common_1[41])), ExpectedArityPieces_46);
              {
