          ...
          else
          {
            ...
            else
            {
              ...
              }
              {
                ...
                MR_hl_field(MR_mktag(1), Spec_115, 2) = ((MR_Box) ((MR_Unsigned) 36U));
...
{
  {
      ...
      case (MR_Integer) 1:
        {
          ...
          if (succeeded)
          {
            ...
            }
            {
              ...
              MR_hl_field(MR_mktag(1), VisSpec_25, 2) = ((MR_Box) ((MR_Unsigned) 36U));
    ...
    else
    {
      ...
      Var_122 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_format_component_0), MismatchPieces_33, NearMissPieces_34);
      {
        ...
        MR_hl_field(MR_mktag(1), MismatchSpec_39, 2) = ((MR_Box) ((MR_Unsigned) 36U));
