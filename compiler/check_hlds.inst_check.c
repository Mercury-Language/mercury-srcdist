...
MR_decl_label8(check_hlds__inst_check__bound_inst_to_functor_2_0, 3,6,9,11,13,15,2,1)
MR_decl_label10(check_hlds__inst_check__check_inst_4_0, 3,5,6,7,8,69,9,13,17,11)
...
MR_decl_label7(fn__check_hlds__inst_check__index_types_by_unqualified_functors_1_0, 34,5,6,10,8,7,13)
...
MR_BEGIN_MODULE(check_hlds__inst_check_module0)
	...
	MR_init_label7(fn__check_hlds__inst_check__index_types_by_unqualified_functors_1_0,34,5,6,10,8,7,13)
MR_BEGIN_CODE
...
MR_def_static(fn__check_hlds__inst_check__index_types_by_unqualified_functors_1_0)
	...
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
		MR_GOTO_LAB(fn__check_hlds__inst_check__index_types_by_unqualified_functors_1_0_i34);
	}
...
MR_def_label(fn__check_hlds__inst_check__index_types_by_unqualified_functors_1_0,34)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(4);
...
MR_BEGIN_MODULE(check_hlds__inst_check_module5)
	...
	MR_init_label10(check_hlds__inst_check__check_inst_4_0,3,5,6,7,8,69,9,13,17,11)
MR_BEGIN_CODE
...
MR_def_label(check_hlds__inst_check__check_inst_4_0,69)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_r3;
	MR_proceed();
MR_def_label(check_hlds__inst_check__check_inst_4_0,9)
	...
	if (MR_RTAGS_TESTR(MR_r5,3,0)) {
		MR_GOTO_LAB(check_hlds__inst_check__check_inst_4_0_i69);
	}
	MR_incr_sp(5);
	MR_sv(5) = (MR_Word) MR_succip;
	MR_sv(1) = MR_r1;
...
MR_def_label(check_hlds__inst_check__check_inst_4_0,13)
	...
	MR_np_call_localret_ent(list__map_3_0,
		check_hlds__inst_check__check_inst_4_0_i17);
MR_def_label(check_hlds__inst_check__check_inst_4_0,17)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
...
MR_BEGIN_MODULE(check_hlds__inst_check_module7)
	...
	MR_init_label8(check_hlds__inst_check__bound_inst_to_functor_2_0,3,6,9,11,13,15,2,1)
MR_BEGIN_CODE
...
MR_def_label(check_hlds__inst_check__bound_inst_to_functor_2_0,3)
	...
	if (MR_PTAG_TESTR(MR_r3,2)) {
		MR_GOTO_LAB(check_hlds__inst_check__bound_inst_to_functor_2_0_i6);
	}
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tag_alloc_heap(MR_tempr1, 2, (MR_Integer) 1);
...
MR_def_label(check_hlds__inst_check__bound_inst_to_functor_2_0,6)
	...
	if (MR_RTAGS_TESTR(MR_r3,3,3)) {
		MR_GOTO_LAB(check_hlds__inst_check__bound_inst_to_functor_2_0_i9);
	}
...
MR_def_label(check_hlds__inst_check__bound_inst_to_functor_2_0,9)
	...
	if (MR_RTAGS_TESTR(MR_r3,3,2)) {
		MR_GOTO_LAB(check_hlds__inst_check__bound_inst_to_functor_2_0_i11);
	}
...
MR_def_label(check_hlds__inst_check__bound_inst_to_functor_2_0,11)
	...
	if (MR_RTAGS_TESTR(MR_r3,3,1)) {
		MR_GOTO_LAB(check_hlds__inst_check__bound_inst_to_functor_2_0_i13);
	}
...
MR_def_label(check_hlds__inst_check__bound_inst_to_functor_2_0,13)
	...
	if (MR_RTAGS_TESTR(MR_r3,3,4)) {
		MR_GOTO_LAB(check_hlds__inst_check__bound_inst_to_functor_2_0_i15);
	}
