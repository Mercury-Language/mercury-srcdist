            ...
            case (MR_Integer) 2:
              {
                ...
                Var_70 = mercury__string__count_codepoints_1_f_0(Name_34);
                  ...
                  UserCharTypes_38 = UserTypes_37;
                {
                  ...
                  MR_hl_field(MR_mktag(0), Var_73, 0) = ((MR_Box) (SymName_31));
                  MR_hl_field(MR_mktag(0), Var_73, 1) = ((MR_Box) (Arity_32));
                }
                succeeded = parse_tree__prog_type__type_ctor_is_tuple_1_p_0(Var_73);
                if (succeeded)
                {
                  MR_Word Var_74;

                  {
                    ...
                    MR_hl_field(MR_mktag(2), Var_74, 0) = ((MR_Box) (Arity_32));
                  }
                  {
                    Types_39 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(MR_mktag(1), Types_39, 0) = ((MR_Box) (Var_74));
            ...
            case (MR_Integer) 3:
              {
...

                {
                  ...
                  MR_hl_field(MR_mktag(2), Var_68, 0) = ((MR_Box) (Arity_75));
                }
                {
                ...
                {
                  MaybePossibleTypes_19 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                  MR_hl_field(MR_mktag(1), MaybePossibleTypes_19, 0) = ((MR_Box) (Var_67));
                }
              }
              break;
            case (MR_Integer) 5:
              {
                ...
                IntType_41 = parse_tree__prog_data__type_of_int_const_1_f_0(IntConst_40);
                {
                  ...
                  MR_hl_field(MR_mktag(1), Var_65, 0) = (MR_Box) ((MR_Unsigned) (IntType_41));
                }
                {
                ...
                {
                  MaybePossibleTypes_19 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                  MR_hl_field(MR_mktag(1), MaybePossibleTypes_19, 0) = ((MR_Box) (Var_63));
                }
              }
              break;
            case (MR_Integer) 6:
            ...
            case (MR_Integer) 5:
              {
                ...
                if (succeeded)
                {
                  ...
                  if (succeeded)
                  {
                    Var_117 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(1), Var_86, (MR_Integer) 0))) & (MR_Integer) 15);
