        ...
        case (MR_Integer) 1:
          ...
          else
          {
            ...
            else
            {
              ...
              MR_Word InstName_112 = ((MR_Word) ((MR_hl_field(MR_mktag(0), InstId_8, (MR_Integer) 0))));
              MR_Integer InstArity_113 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), InstId_8, (MR_Integer) 1))));
              MR_Word Pieces_114;
              MR_Word Spec_115;
