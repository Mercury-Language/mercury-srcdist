      ...
      case (MR_Integer) 0:
        {
...

          {
            ...
            MR_hl_field(MR_mktag(0), Var_70, 0) = ((MR_Box) (&check_hlds__inst_check_scalar_common_4[3]));
            MR_hl_field(MR_mktag(0), Var_70, 1) = ((MR_Box) (check_hlds__inst_check__check_inst_defns_have_matching_types_7_p_0_1));
            MR_hl_field(MR_mktag(0), Var_70, 2) = ((MR_Box) ((MR_Integer) 2));
            MR_hl_field(MR_mktag(0), Var_70, 3) = ((MR_Box) (IFTC0_31));
            MR_hl_field(MR_mktag(0), Var_70, 4) = ((MR_Box) ((MR_Unsigned) 0U));
          }
          mercury__require__expect_3_p_0(Var_70, (MR_String) "predicate \140check_hlds.inst_check.check_inst_defn_has_matching_type\'/8", (MR_String) "not bound, IFTC0 != iftc_not_applicable");
                ...
                case (MR_Integer) 1:
                  {
                    ...
                    if (succeeded)
                    {
                      ...
                      check_hlds__inst_check__check_for_type_bound_insts_4_p_0(ForTypeKind0_42, BoundInsts_37, Var_60, &MismatchesCord_47);
                    ...
                    else
                    {
                      ...
                      if (succeeded)
                      {
                        ...
                        if (succeeded)
                        {
                          Var_55 = ((MR_Word) ((MR_hl_field(MR_mktag(1), ForTypeCtorSymName_39, (MR_Integer) 0))));
                          Var_57 = ((MR_String) ((MR_hl_field(MR_mktag(1), ForTypeCtorSymName_39, (MR_Integer) 1))));
                      ...
                      if (succeeded)
                      {
                        ...
                        Var_58 = parse_tree__builtin_lib_types__char_type_ctor_0_f_0();
                        {
                          ...
                          MR_hl_field(MR_mktag(1), ForTypeKind_93, 0) = ((MR_Box) (Var_58));
    ...
    case (MR_Integer) 0:
      {
        ...
        MR_Word TypeStatus_142;
        MR_Word Status_144;
        MR_Word Var_32 = ((MR_Word) ((MR_hl_field(MR_mktag(0), TypeCtorAndDefn_31, (MR_Integer) 0))));

        hlds__hlds_data__get_type_defn_status_2_p_0(TypeDefn_33, &TypeStatus_142);
        Status_144 = (MR_Word) (TypeStatus_142);
        if ((((Status_144 == (MR_Word) ((MR_Unsigned) 12U))) || (((MR_tag((MR_Word) Status_144)) == (MR_Integer) 2))))
  ...
  MR_Word * STATE_VARIABLE_PossibleTypeSets_6)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      MR_Word ConsId_29 = ((MR_Word) ((MR_hl_field(MR_mktag(0), BoundInst_15, (MR_Integer) 0))));
      ...
      switch (MR_tag((MR_Word) ConsId_29)) {
        ...
        case (MR_Integer) 2:
          ...
          break;
        case (MR_Integer) 3:
          switch (((MR_Integer) ((MR_hl_field(MR_mktag(3), ConsId_29, (MR_Integer) 0))))) {
            default: /*NOTREACHED*/ MR_assert(0);
            case (MR_Integer) 0:
            case (MR_Integer) 1:
            case (MR_Integer) 4:
            ...
            case (MR_Integer) 2:
              {
                MR_Word SymName_31 = ((MR_Word) ((MR_hl_field(MR_mktag(3), ConsId_29, (MR_Integer) 1))));
                MR_Integer Arity_32 = ((MR_Integer) ((MR_hl_field(MR_mktag(3), ConsId_29, (MR_Integer) 2))));
                MR_String Name_34;
                ...
                Name_34 = mdbcomp__sym_name__unqualify_name_1_f_0(SymName_31);
                {
                  ...
                  MR_hl_field(MR_mktag(0), FunctorNameAndArity_35, 0) = ((MR_Box) (Name_34));
                  MR_hl_field(MR_mktag(0), FunctorNameAndArity_35, 1) = ((MR_Box) (Arity_32));
                }
                ...
                Var_63 = mercury__string__count_codepoints_1_f_0(Name_34);
                succeeded = (Var_63 == (MR_Integer) 1);
                if (succeeded)
                  {
                    UserCharTypes_38 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(MR_mktag(1), UserCharTypes_38, 0) = ((MR_Box) (MR_mkword(MR_mktag(1), &check_hlds__inst_check_scalar_common_3[24])));
                    MR_hl_field(MR_mktag(1), UserCharTypes_38, 1) = ((MR_Box) (UserTypes_37));
                  }
                else
                  UserCharTypes_38 = UserTypes_37;
                {
                  Var_66 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
                  MR_hl_field(MR_mktag(0), Var_66, 0) = ((MR_Box) (SymName_31));
                  MR_hl_field(MR_mktag(0), Var_66, 1) = ((MR_Box) (Arity_32));
                }
                succeeded = parse_tree__prog_type__type_ctor_is_tuple_1_p_0(Var_66);
                if (succeeded)
                {
                  MR_Word Var_67;

                  {
                    ...
                    MR_hl_field(MR_mktag(2), Var_67, 0) = ((MR_Box) (Arity_32));
                  }
                  {
                    Types_39 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(MR_mktag(1), Types_39, 0) = ((MR_Box) (Var_67));
                    MR_hl_field(MR_mktag(1), Types_39, 1) = ((MR_Box) (UserCharTypes_38));
                  }
                }
                else
                  Types_39 = UserCharTypes_38;
                {
                  ...
                  MR_hl_field(MR_mktag(1), MaybePossibleTypes_19, 0) = ((MR_Box) (Types_39));
                }
              }
              break;
            case (MR_Integer) 3:
              {
                MR_Word Var_68;
                MR_Word Var_69;
                MR_Integer Arity_75 = ((MR_Integer) ((MR_hl_field(MR_mktag(3), ConsId_29, (MR_Integer) 1))));

                {
                  Var_69 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                  MR_hl_field(MR_mktag(2), Var_69, 0) = ((MR_Box) (Arity_75));
                }
                {
                ...
                {
                  MaybePossibleTypes_19 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                  MR_hl_field(MR_mktag(1), MaybePossibleTypes_19, 0) = ((MR_Box) (Var_68));
                }
              }
              break;
            case (MR_Integer) 5:
              {
                MR_Word IntConst_40 = ((MR_Word) ((MR_hl_field(MR_mktag(3), ConsId_29, (MR_Integer) 1))));
                MR_Word IntType_41;
                MR_Word Var_71;
                MR_Word Var_72;
                MR_Word Var_73;
                ...
                IntType_41 = parse_tree__prog_data__type_of_int_const_1_f_0(IntConst_40);
                {
                  ...
                  MR_hl_field(MR_mktag(1), Var_73, 0) = (MR_Box) ((MR_Unsigned) (IntType_41));
                }
                {
  ...
  MR_Word * STATE_VARIABLE_Mismatches_15)
{
  ...
  else
  {
...

    {
      ...
      MR_hl_field(MR_mktag(0), Var_19, 0) = ((MR_Box) (&check_hlds__inst_check_scalar_common_5[1]));
      MR_hl_field(MR_mktag(0), Var_19, 1) = ((MR_Box) (check_hlds__inst_check__check_arity_and_maybe_report_near_misses_7_p_0_1));
      MR_hl_field(MR_mktag(0), Var_19, 2) = ((MR_Box) ((MR_Integer) 2));
      MR_hl_field(MR_mktag(0), Var_19, 3) = ((MR_Box) (TypeCtor_8));
      MR_hl_field(MR_mktag(0), Var_19, 4) = ((MR_Box) (SymName_10));
    }
    NearMisses_17 = mercury__list__map_2_f_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0), (MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_format_component_0), Var_19, CtorArities_12);
    {
      Var_20 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(3), Var_20, 0) = ((MR_Box) ((MR_Unsigned) 24U));
      MR_hl_field(MR_mktag(3), Var_20, 1) = ((MR_Box) (ConsId_9));
    }
    {
      Mismatch_18 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), Mismatch_18, 0) = ((MR_Box) (Var_20));
      MR_hl_field(MR_mktag(0), Mismatch_18, 1) = ((MR_Box) (NearMisses_17));
    }
    *STATE_VARIABLE_Mismatches_15 = mercury__cord__snoc_2_f_0((MR_Word) (&check_hlds__inst_check__check_hlds__inst_check__type_ctor_info_cons_mismatch_0), STATE_VARIABLE_Mismatches_0_14, ((MR_Box) (Mismatch_18)));
  }
}
          ...
          case (MR_Integer) 0:
            {
              ...
              Constructors_32 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_37, (MR_Integer) 0))));
