                        ...
                        case (MR_Integer) 1:
                          {
                            ...
                            {
                              IFTC_110 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
              ...
              case (MR_Integer) 1:
                {
                                    ...
                                    else
                                    {
                                      ...
                                      else
                                      {
                                        ...
                                        if (succeeded)
                                        {
                                          ...
                                          {
                                            MR_Word Var_102 = ((MR_Word) ((MR_hl_field(MR_mktag(1), ForTypeCtorName_25, (MR_Integer) 0))));
                                            MR_String Var_103;

                                            CName_29 = ((MR_String) ((MR_hl_field(MR_mktag(1), ForTypeCtorName_25, (MR_Integer) 1))));
                                            succeeded = ((MR_tag((MR_Word) Var_102)) == (MR_Integer) 0);
                                            if (succeeded)
                                            {
                                              Var_103 = ((MR_String) ((MR_hl_field(MR_mktag(0), Var_102, (MR_Integer) 0))));
                                              succeeded = (strcmp(Var_103, (MR_String) "char") == 0);
                                            }
                                          }
                                          else
                                          {
                  ...
                  else
                  {
                    ...
                    Var_107 = mercury__cord__init_0_f_0((MR_Word) (&check_hlds__inst_check__check_hlds__inst_check__type_ctor_info_cons_mismatch_0));
  ...
  MR_String TypeName_4)
{
  ...
  {
    MR_Word Var_5 = ((MR_Word) ((MR_hl_field(MR_mktag(1), SymName_3, (MR_Integer) 0))));
    MR_String Var_7 = ((MR_String) ((MR_hl_field(MR_mktag(1), SymName_3, (MR_Integer) 1))));
    MR_String Var_8;

    succeeded = (strcmp(TypeName_4, Var_7) == 0);
    if (succeeded)
    {
      succeeded = ((MR_tag((MR_Word) Var_5)) == (MR_Integer) 0);
      if (succeeded)
      {
        Var_8 = ((MR_String) ((MR_hl_field(MR_mktag(0), Var_5, (MR_Integer) 0))));
  ...
  {
    MR_String Var_6 = ((MR_String) ((MR_hl_field(MR_mktag(0), SymName_3, (MR_Integer) 0))));

    succeeded = (strcmp(TypeName_4, Var_6) == 0);
  }
  return succeeded;
}
