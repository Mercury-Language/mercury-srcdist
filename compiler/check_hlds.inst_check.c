              ...
              case (MR_Integer) 1:
                {
                  ...
                  else
                  {
                    ...
                    {
                      MR_Word Var_61;
                      MR_Word ForTypeKind_94;
                      MR_Word MismatchesCord_95;
                      MR_Word Mismatches_96;
                      MR_Word MatchSpecs_97;
                      MR_Word Var_98;

                      Var_61 = parse_tree__builtin_lib_types__char_type_ctor_0_f_0();
                      {
                        ForTypeKind_94 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                        MR_hl_field(MR_mktag(1), ForTypeKind_94, 0) = ((MR_Box) (Var_61));
                        MR_hl_field(MR_mktag(1), ForTypeKind_94, 1) = ((MR_Box) ((MR_Unsigned) 8U));
                      }
                      Var_98 = mercury__cord__init_0_f_0((MR_Word) (&check_hlds__inst_check__check_hlds__inst_check__type_ctor_info_cons_mismatch_0));
                      check_hlds__inst_check__check_for_type_bound_insts_4_p_0(ForTypeKind_94, BoundInsts_25, Var_98, &MismatchesCord_95);
                      Mismatches_96 = mercury__cord__list_1_f_0((MR_Word) (&check_hlds__inst_check__check_hlds__inst_check__type_ctor_info_cons_mismatch_0), MismatchesCord_95);
                      check_hlds__inst_check__maybe_issue_type_match_error_7_p_0(WarnInstsWithoutMatchingType_9, InstCtor_12, InstDefn0_13, ForTypeKind_94, Mismatches_96, &IFTC_34, &MatchSpecs_97);
                      *STATE_VARIABLE_Specs_57 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_error_spec_0), MatchSpecs_97, STATE_VARIABLE_Specs_0_56);
                    }
                    else
                    {
                      ...
                      if (succeeded)
                      {
                        MR_Word ForTypeKind_116;
                        MR_Word MismatchesCord_117;
                        MR_Word Mismatches_118;
                        MR_Word MatchSpecs_119;
                        MR_Word Var_120;

                        {
                          ForTypeKind_116 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
                          MR_hl_field(MR_mktag(0), ForTypeKind_116, 0) = ((MR_Box) (ForTypeCtor0_26));
                          MR_hl_field(MR_mktag(0), ForTypeKind_116, 1) = ((MR_Box) (ForTypeDefn_33));
                        }
                        Var_120 = mercury__cord__init_0_f_0((MR_Word) (&check_hlds__inst_check__check_hlds__inst_check__type_ctor_info_cons_mismatch_0));
                        check_hlds__inst_check__check_for_type_bound_insts_4_p_0(ForTypeKind_116, BoundInsts_25, Var_120, &MismatchesCord_117);
                        Mismatches_118 = mercury__cord__list_1_f_0((MR_Word) (&check_hlds__inst_check__check_hlds__inst_check__type_ctor_info_cons_mismatch_0), MismatchesCord_117);
                        check_hlds__inst_check__maybe_issue_type_match_error_7_p_0(WarnInstsWithoutMatchingType_9, InstCtor_12, InstDefn0_13, ForTypeKind_116, Mismatches_118, &IFTC_34, &MatchSpecs_119);
                        *STATE_VARIABLE_Specs_57 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_error_spec_0), MatchSpecs_119, STATE_VARIABLE_Specs_0_56);
                      }
                      else
                      {
            ...
            case (MR_Integer) 2:
              {
                ...
                Var_68 = mercury__string__count_codepoints_1_f_0(Name_39);
                ...
                if (succeeded)
                  {
                    ...
                    MR_hl_field(MR_mktag(1), UserCharTypes_43, 0) = ((MR_Box) (MR_mkword(MR_mktag(1), &check_hlds__inst_check_scalar_common_3[24])));
                  ...
                  UserCharTypes_43 = UserTypes_42;
                {
                  ...
                  MR_hl_field(MR_mktag(0), Var_71, 0) = ((MR_Box) (SymName_36));
                  MR_hl_field(MR_mktag(0), Var_71, 1) = ((MR_Box) (Arity_37));
                }
                succeeded = parse_tree__prog_type__type_ctor_is_tuple_1_p_0(Var_71);
                if (succeeded)
                {
                  MR_Word Var_72;

                  {
                    ...
                    MR_hl_field(MR_mktag(2), Var_72, 0) = ((MR_Box) (Arity_37));
                  }
                  {
                    Types_44 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(MR_mktag(1), Types_44, 0) = ((MR_Box) (Var_72));
            ...
            case (MR_Integer) 3:
              {
...

                {
                  ...
                  MR_hl_field(MR_mktag(2), Var_74, 0) = ((MR_Box) (Arity_92));
                }
                {
                ...
                {
                  MaybePossibleTypes_19 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                  MR_hl_field(MR_mktag(1), MaybePossibleTypes_19, 0) = ((MR_Box) (Var_73));
                }
              }
              break;
            case (MR_Integer) 5:
              {
                ...
                IntType_46 = parse_tree__prog_data__type_of_int_const_1_f_0(IntConst_45);
                {
                  ...
                  MR_hl_field(MR_mktag(1), Var_78, 0) = (MR_Box) ((MR_Unsigned) (IntType_46));
                }
                {
                ...
                {
                  MaybePossibleTypes_19 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                  MR_hl_field(MR_mktag(1), MaybePossibleTypes_19, 0) = ((MR_Box) (Var_76));
                }
              }
              break;
            case (MR_Integer) 6:
            ...
            case (MR_Integer) 5:
              {
                ...
                if (succeeded)
                {
                  ...
                  if (succeeded)
                  {
                    Var_121 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(1), Var_87, (MR_Integer) 0))) & (MR_Integer) 15);
