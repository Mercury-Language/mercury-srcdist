...
MR_decl_label8(check_hlds__inst_check__bound_inst_to_functor_2_0, 3,6,15,21,4,9,11,13)
MR_decl_label2(check_hlds__inst_check__bound_inst_to_functor_2_0, 2,1)
MR_decl_label5(check_hlds__inst_check__check_inst_4_0, 34,3,10,14,8)
MR_decl_label8(check_hlds__inst_check__check_insts_have_matching_types_3_0, 2,3,4,5,6,7,9,10)
MR_decl_label2(check_hlds__inst_check__check_insts_have_matching_types_3_0, 13,14)
MR_decl_label8(check_hlds__inst_check__find_types_for_functor_3_0, 96,15,19,22,13,23,27,25)
MR_decl_label7(check_hlds__inst_check__find_types_for_functor_3_0, 31,34,32,42,3,6,9)
MR_decl_label1(check_hlds__inst_check__inst_is_defined_in_current_module_1_0, 2)
MR_decl_label8(check_hlds__inst_check__maybe_issue_inst_check_warning_5_0, 2,10,16,19,13,27,22,9)
MR_decl_label1(check_hlds__inst_check__maybe_issue_inst_check_warning_5_0, 4)
MR_decl_label5(check_hlds__inst_check__type_is_user_visible_2_0, 2,8,14,4,12)
MR_decl_label1(fn__check_hlds__inst_check__IntroducedFrom__func__index_types_by_unqualified_functors__338__1_1_0, 2)
MR_decl_label1(fn__check_hlds__inst_check__constructor_to_sym_name_and_arity_1_0, 2)
MR_decl_label7(fn__check_hlds__inst_check__index_types_by_unqualified_functors_1_0, 39,5,6,12,8,7,19)
MR_decl_label5(__Unify___check_hlds__inst_check__bound_inst_functor_0_0, 8,10,13,17,1)
MR_decl_label4(__Unify___check_hlds__inst_check__type_defn_or_builtin_0_0, 7,5,15,1)
MR_decl_label8(__Compare___check_hlds__inst_check__bound_inst_functor_0_0, 85,35,40,42,61,68,5,15)
MR_decl_label5(__Compare___check_hlds__inst_check__bound_inst_functor_0_0, 19,25,111,32,74)
MR_decl_label8(__Compare___check_hlds__inst_check__type_defn_or_builtin_0_0, 3,2,36,13,16,5,48,9)
...
MR_decl_static(fn__check_hlds__inst_check__IntroducedFrom__func__index_types_by_unqualified_functors__338__1_1_0)
MR_decl_static(fn__check_hlds__inst_check__IntroducedFrom__func__index_types_by_unqualified_functors__340__1_3_0)
...
{
MR_COMMON(0,0),
MR_ENTRY_AP(fn__check_hlds__inst_check__IntroducedFrom__func__index_types_by_unqualified_functors__338__1_1_0),
0
},
{
MR_COMMON(0,1),
...
MR_BEGIN_MODULE(check_hlds__inst_check_module0)
	...
	MR_init_label7(fn__check_hlds__inst_check__index_types_by_unqualified_functors_1_0,39,5,6,12,8,7,19)
MR_BEGIN_CODE
...
MR_def_static(fn__check_hlds__inst_check__index_types_by_unqualified_functors_1_0)
	...
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
		MR_GOTO_LAB(fn__check_hlds__inst_check__index_types_by_unqualified_functors_1_0_i39);
	}
...
MR_def_label(fn__check_hlds__inst_check__index_types_by_unqualified_functors_1_0,39)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(4);
...
MR_def_label(fn__check_hlds__inst_check__index_types_by_unqualified_functors_1_0,6)
	...
	MR_np_call_localret_ent(fn__list__map_2_0,
		fn__check_hlds__inst_check__index_types_by_unqualified_functors_1_0_i12);
...
MR_def_label(fn__check_hlds__inst_check__index_types_by_unqualified_functors_1_0,7)
	...
	MR_np_call_localret_ent(fn__list__map_2_0,
		fn__check_hlds__inst_check__index_types_by_unqualified_functors_1_0_i19);
MR_def_label(fn__check_hlds__inst_check__index_types_by_unqualified_functors_1_0,19)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	...
	MR_tfield(0, MR_tempr2, 1) = (MR_Word) MR_ENTRY_AP(fn__check_hlds__inst_check__IntroducedFrom__func__index_types_by_unqualified_functors__340__1_3_0);
...
MR_BEGIN_MODULE(check_hlds__inst_check_module1)
	...
	MR_init_label8(check_hlds__inst_check__check_insts_have_matching_types_3_0,2,3,4,5,6,7,9,10)
	MR_init_label2(check_hlds__inst_check__check_insts_have_matching_types_3_0,13,14)
MR_BEGIN_CODE
...
MR_def_label(check_hlds__inst_check__check_insts_have_matching_types_3_0,9)
	...
	MR_tempr1 = MR_sv(1);
	MR_sv(1) = MR_r1;
	MR_sv(3) = (MR_Word) MR_CTOR0_ADDR(parse_tree__prog_data, inst_id);
	MR_sv(4) = (MR_Word) MR_CTOR0_ADDR(hlds__hlds_data, hlds_inst_defn);
	MR_r1 = MR_sv(3);
	MR_r2 = MR_sv(4);
	MR_r3 = MR_tempr1;
	}
...
MR_def_label(check_hlds__inst_check__check_insts_have_matching_types_3_0,13)
	...
	MR_np_call_localret_ent(fn__check_hlds__inst_check__index_types_by_unqualified_functors_1_0,
		check_hlds__inst_check__check_insts_have_matching_types_3_0_i14);
MR_def_label(check_hlds__inst_check__check_insts_have_matching_types_3_0,14)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
...
MR_BEGIN_MODULE(check_hlds__inst_check_module3)
	...
	MR_init_label5(check_hlds__inst_check__type_is_user_visible_2_0,2,8,14,4,12)
MR_BEGIN_CODE
...
MR_def_label(check_hlds__inst_check__type_is_user_visible_2_0,2)
	...
	if ((MR_r2 != MR_mktag((MR_Integer) 0))) {
		MR_GOTO_LAB(check_hlds__inst_check__type_is_user_visible_2_0_i8);
	}
	MR_COMPUTED_GOTO((MR_Unsigned) MR_unmkbody(MR_tempr1),
		MR_LABEL_AP(check_hlds__inst_check__type_is_user_visible_2_0_i14) MR_AND
		MR_LABEL_AP(check_hlds__inst_check__type_is_user_visible_2_0_i14) MR_AND
		MR_LABEL_AP(check_hlds__inst_check__type_is_user_visible_2_0_i14) MR_AND
		MR_LABEL_AP(check_hlds__inst_check__type_is_user_visible_2_0_i12) MR_AND
		MR_LABEL_AP(check_hlds__inst_check__type_is_user_visible_2_0_i4) MR_AND
		MR_LABEL_AP(check_hlds__inst_check__type_is_user_visible_2_0_i4) MR_AND
		MR_LABEL_AP(check_hlds__inst_check__type_is_user_visible_2_0_i4) MR_AND
		MR_LABEL_AP(check_hlds__inst_check__type_is_user_visible_2_0_i4) MR_AND
		MR_LABEL_AP(check_hlds__inst_check__type_is_user_visible_2_0_i4));
	}
MR_def_label(check_hlds__inst_check__type_is_user_visible_2_0,8)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_r2 == MR_mktag((MR_Integer) 2));
	MR_decr_sp_and_return(2);
MR_def_label(check_hlds__inst_check__type_is_user_visible_2_0,14)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_succip_word = MR_sv(2);
	MR_decr_sp(2);
	MR_r1 = MR_FALSE;
	MR_proceed();
MR_def_label(check_hlds__inst_check__type_is_user_visible_2_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = ((MR_Integer) MR_sv(1) == (MR_Integer) 0);
	MR_decr_sp_and_return(2);
MR_def_label(check_hlds__inst_check__type_is_user_visible_2_0,12)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_succip_word = MR_sv(2);
	MR_decr_sp(2);
	MR_r1 = MR_TRUE;
...
MR_BEGIN_MODULE(check_hlds__inst_check_module4)
	...
	MR_init_label8(check_hlds__inst_check__maybe_issue_inst_check_warning_5_0,2,10,16,19,13,27,22,9)
	MR_init_label1(check_hlds__inst_check__maybe_issue_inst_check_warning_5_0,4)
MR_BEGIN_CODE
...
MR_def_label(check_hlds__inst_check__maybe_issue_inst_check_warning_5_0,10)
	...
	MR_sv(6) = MR_r1;
	MR_sv(7) = (MR_Word) MR_CTOR0_ADDR(check_hlds__inst_check, type_defn_or_builtin);
	MR_r1 = (MR_Word) MR_TAG_COMMON(0,2,4);
	MR_r2 = MR_sv(3);
	MR_np_call_localret_ent(list__member_2_1,
		check_hlds__inst_check__maybe_issue_inst_check_warning_5_0_i16);
MR_def_label(check_hlds__inst_check__maybe_issue_inst_check_warning_5_0,16)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
	...
	MR_np_call_localret_ent(list__member_2_0,
		check_hlds__inst_check__maybe_issue_inst_check_warning_5_0_i19);
MR_def_label(check_hlds__inst_check__maybe_issue_inst_check_warning_5_0,19)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_r1) {
...
MR_def_label(check_hlds__inst_check__maybe_issue_inst_check_warning_5_0,13)
	...
	if (MR_INT_EQ(MR_sv(4),0)) {
		MR_GOTO_LAB(check_hlds__inst_check__maybe_issue_inst_check_warning_5_0_i22);
	}
	...
	MR_np_call_localret_ent(check_hlds__inst_check__type_is_user_visible_2_0,
		check_hlds__inst_check__maybe_issue_inst_check_warning_5_0_i27);
MR_def_label(check_hlds__inst_check__maybe_issue_inst_check_warning_5_0,27)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO(MR_ENTRY(MR_do_redo));
	}
MR_def_label(check_hlds__inst_check__maybe_issue_inst_check_warning_5_0,22)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_def_label(check_hlds__inst_check__maybe_issue_inst_check_warning_5_0,9)
	...
	MR_tfield(1, MR_tempr2, 0) = (MR_Word) MR_TAG_COMMON(3,7,0);
	...
	MR_tag_alloc_heap(MR_tempr1, 0, (MR_Integer) 2);
	MR_tfield(0, MR_tempr1, 0) = MR_ctfield(0, MR_sv(2), 3);
...
MR_BEGIN_MODULE(check_hlds__inst_check_module5)
	...
	MR_init_label5(check_hlds__inst_check__check_inst_4_0,34,3,10,14,8)
MR_BEGIN_CODE
...
MR_def_static(check_hlds__inst_check__check_inst_4_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r4 = MR_ctfield(0, MR_ctfield(0, MR_r2, 1), 2);
	if (MR_LTAGS_TESTR(MR_r4,0,0)) {
		MR_GOTO_LAB(check_hlds__inst_check__check_inst_4_0_i3);
	}
MR_def_label(check_hlds__inst_check__check_inst_4_0,34)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_r3;
	MR_proceed();
MR_def_label(check_hlds__inst_check__check_inst_4_0,3)
	...
	if (MR_INT_NE(MR_tag(MR_tempr1),3)) {
		MR_GOTO_LAB(check_hlds__inst_check__check_inst_4_0_i34);
	}
	...
	MR_np_call_localret_ent(list__map_3_2,
		check_hlds__inst_check__check_inst_4_0_i10);
MR_def_label(check_hlds__inst_check__check_inst_4_0,10)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
	...
	MR_np_call_localret_ent(list__map_3_0,
		check_hlds__inst_check__check_inst_4_0_i14);
MR_def_label(check_hlds__inst_check__check_inst_4_0,14)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
...
MR_BEGIN_MODULE(check_hlds__inst_check_module6)
	...
	MR_init_label8(check_hlds__inst_check__find_types_for_functor_3_0,96,15,19,22,13,23,27,25)
	MR_init_label7(check_hlds__inst_check__find_types_for_functor_3_0,31,34,32,42,3,6,9)
MR_BEGIN_CODE
...
MR_def_static(check_hlds__inst_check__find_types_for_functor_3_0)
	...
	if ((MR_tempr1 == MR_mktag((MR_Integer) 2))) {
		MR_GOTO_LAB(check_hlds__inst_check__find_types_for_functor_3_0_i42);
	}
	if ((MR_tempr1 == MR_mktag((MR_Integer) 1))) {
		MR_GOTO_LAB(check_hlds__inst_check__find_types_for_functor_3_0_i96);
	}
...
MR_def_label(check_hlds__inst_check__find_types_for_functor_3_0,96)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(4);
	MR_sv(4) = (MR_Word) MR_succip;
	{
	...
	MR_np_call_localret_ent(multi_map__search_3_0,
		check_hlds__inst_check__find_types_for_functor_3_0_i19);
...
MR_def_label(check_hlds__inst_check__find_types_for_functor_3_0,22)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(3) = MR_r1;
	MR_GOTO_LAB(check_hlds__inst_check__find_types_for_functor_3_0_i23);
MR_def_label(check_hlds__inst_check__find_types_for_functor_3_0,13)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(3) = (MR_Word) MR_tbmkword(0, 0);
MR_def_label(check_hlds__inst_check__find_types_for_functor_3_0,23)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_sv(1),0)) {
		MR_GOTO_LAB(check_hlds__inst_check__find_types_for_functor_3_0_i25);
	}
	MR_r1 = MR_ctfield(0, MR_sv(1), 0);
	MR_np_call_localret_ent(fn__string__length_1_0,
		check_hlds__inst_check__find_types_for_functor_3_0_i27);
MR_def_label(check_hlds__inst_check__find_types_for_functor_3_0,27)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	...
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 2);
	MR_r2 = MR_tempr1;
	MR_tfield(1, MR_tempr1, 0) = (MR_Word) MR_TAG_COMMON(1,9,0);
	MR_tfield(1, MR_tempr1, 1) = MR_sv(3);
	MR_r1 = MR_tempr1;
	MR_GOTO_LAB(check_hlds__inst_check__find_types_for_functor_3_0_i31);
	}
MR_def_label(check_hlds__inst_check__find_types_for_functor_3_0,25)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(3);
MR_def_label(check_hlds__inst_check__find_types_for_functor_3_0,31)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 0, (MR_Integer) 2);
	...
	MR_np_call_localret_ent(parse_tree__prog_type__type_ctor_is_tuple_1_0,
		check_hlds__inst_check__find_types_for_functor_3_0_i34);
MR_def_label(check_hlds__inst_check__find_types_for_functor_3_0,34)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(check_hlds__inst_check__find_types_for_functor_3_0_i32);
	}
	{
	MR_Word MR_tempr1, MR_tempr2;
...
MR_def_label(check_hlds__inst_check__find_types_for_functor_3_0,32)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(1);
	MR_decr_sp_and_return(4);
MR_def_label(check_hlds__inst_check__find_types_for_functor_3_0,42)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tag_alloc_heap(MR_tempr1, 2, (MR_Integer) 1);
...
MR_BEGIN_MODULE(check_hlds__inst_check_module7)
	...
	MR_init_label8(check_hlds__inst_check__bound_inst_to_functor_2_0,3,6,15,21,4,9,11,13)
	MR_init_label2(check_hlds__inst_check__bound_inst_to_functor_2_0,2,1)
MR_BEGIN_CODE
...
MR_def_static(check_hlds__inst_check__bound_inst_to_functor_2_0)
	...
	MR_COMPUTED_GOTO((MR_Unsigned) MR_tag(MR_r3),
		MR_LABEL_AP(check_hlds__inst_check__bound_inst_to_functor_2_0_i3) MR_AND
		MR_LABEL_AP(check_hlds__inst_check__bound_inst_to_functor_2_0_i6) MR_AND
		MR_LABEL_AP(check_hlds__inst_check__bound_inst_to_functor_2_0_i15) MR_AND
		MR_LABEL_AP(check_hlds__inst_check__bound_inst_to_functor_2_0_i21));
...
MR_def_label(check_hlds__inst_check__bound_inst_to_functor_2_0,15)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tag_alloc_heap(MR_tempr1, 2, (MR_Integer) 1);
...
MR_def_label(check_hlds__inst_check__bound_inst_to_functor_2_0,21)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_COMPUTED_GOTO((MR_Unsigned) MR_ctfield(3, MR_r3, 0),
		MR_LABEL_AP(check_hlds__inst_check__bound_inst_to_functor_2_0_i3) MR_AND
		MR_LABEL_AP(check_hlds__inst_check__bound_inst_to_functor_2_0_i11) MR_AND
		MR_LABEL_AP(check_hlds__inst_check__bound_inst_to_functor_2_0_i9) MR_AND
		MR_LABEL_AP(check_hlds__inst_check__bound_inst_to_functor_2_0_i4) MR_AND
		MR_LABEL_AP(check_hlds__inst_check__bound_inst_to_functor_2_0_i13) MR_AND
		MR_LABEL_AP(check_hlds__inst_check__bound_inst_to_functor_2_0_i3) MR_AND
		MR_LABEL_AP(check_hlds__inst_check__bound_inst_to_functor_2_0_i3) MR_AND
		MR_LABEL_AP(check_hlds__inst_check__bound_inst_to_functor_2_0_i3) MR_AND
		MR_LABEL_AP(check_hlds__inst_check__bound_inst_to_functor_2_0_i3) MR_AND
		MR_LABEL_AP(check_hlds__inst_check__bound_inst_to_functor_2_0_i3) MR_AND
		MR_LABEL_AP(check_hlds__inst_check__bound_inst_to_functor_2_0_i3) MR_AND
		MR_LABEL_AP(check_hlds__inst_check__bound_inst_to_functor_2_0_i3));
MR_def_label(check_hlds__inst_check__bound_inst_to_functor_2_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_def_label(check_hlds__inst_check__bound_inst_to_functor_2_0,9)
	...
	MR_GOTO_LAB(check_hlds__inst_check__bound_inst_to_functor_2_0_i2);
MR_def_label(check_hlds__inst_check__bound_inst_to_functor_2_0,11)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_TAG_COMMON(1,10,2);
	MR_GOTO_LAB(check_hlds__inst_check__bound_inst_to_functor_2_0_i2);
MR_def_label(check_hlds__inst_check__bound_inst_to_functor_2_0,13)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_BEGIN_MODULE(check_hlds__inst_check_module9)
	...
	MR_init_label5(__Unify___check_hlds__inst_check__bound_inst_functor_0_0,8,10,13,17,1)
MR_BEGIN_CODE
...
MR_def_static(__Unify___check_hlds__inst_check__bound_inst_functor_0_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if ((MR_r1 == MR_r2)) {
		MR_GOTO_LAB(__Unify___check_hlds__inst_check__bound_inst_functor_0_0_i17);
	}
	MR_incr_sp(3);
	...
	if ((MR_tempr2 == MR_mktag((MR_Integer) 2))) {
		MR_GOTO_LAB(__Unify___check_hlds__inst_check__bound_inst_functor_0_0_i13);
	}
	if ((MR_tempr2 == MR_mktag((MR_Integer) 1))) {
...
MR_def_label(__Unify___check_hlds__inst_check__bound_inst_functor_0_0,13)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_def_label(__Unify___check_hlds__inst_check__bound_inst_functor_0_0,17)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_TRUE;
	MR_proceed();
...
MR_BEGIN_MODULE(check_hlds__inst_check_module10)
	...
	MR_init_label8(__Compare___check_hlds__inst_check__bound_inst_functor_0_0,85,35,40,42,61,68,5,15)
	MR_init_label5(__Compare___check_hlds__inst_check__bound_inst_functor_0_0,19,25,111,32,74)
MR_BEGIN_CODE
...
MR_def_static(__Compare___check_hlds__inst_check__bound_inst_functor_0_0)
	...
	MR_sv(3) = (MR_Word) MR_succip;
	if ((MR_r1 == MR_r2)) {
		MR_GOTO_LAB(__Compare___check_hlds__inst_check__bound_inst_functor_0_0_i85);
	}
	{
	MR_Word MR_tempr1, MR_tempr2, MR_tempr3, MR_tempr4;
	MR_tempr1 = MR_r1;
	...
	if ((MR_tempr3 == MR_mktag((MR_Integer) 2))) {
		MR_GOTO_LAB(__Compare___check_hlds__inst_check__bound_inst_functor_0_0_i61);
	}
	...
	if (MR_INT_EQ(MR_tempr4,0)) {
		MR_GOTO_LAB(__Compare___check_hlds__inst_check__bound_inst_functor_0_0_i25);
	}
	...
	if ((MR_tempr3 == MR_mktag((MR_Integer) 2))) {
		MR_GOTO_LAB(__Compare___check_hlds__inst_check__bound_inst_functor_0_0_i32);
	}
	if ((MR_tempr3 == MR_mktag((MR_Integer) 1))) {
		MR_GOTO_LAB(__Compare___check_hlds__inst_check__bound_inst_functor_0_0_i32);
	}
...
MR_def_label(__Compare___check_hlds__inst_check__bound_inst_functor_0_0,85)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Integer) 0;
	MR_decr_sp_and_return(3);
MR_def_label(__Compare___check_hlds__inst_check__bound_inst_functor_0_0,35)
	...
	MR_tempr1 = MR_tag(MR_tempr3);
	if ((MR_tempr1 == MR_mktag((MR_Integer) 2))) {
		MR_GOTO_LAB(__Compare___check_hlds__inst_check__bound_inst_functor_0_0_i111);
	}
	if ((MR_tempr1 == MR_mktag((MR_Integer) 1))) {
		MR_GOTO_LAB(__Compare___check_hlds__inst_check__bound_inst_functor_0_0_i40);
	}
	MR_tempr2 = MR_unmkbody(MR_tempr3);
	if (MR_INT_EQ(MR_tempr2,0)) {
		MR_GOTO_LAB(__Compare___check_hlds__inst_check__bound_inst_functor_0_0_i111);
...
MR_def_label(__Compare___check_hlds__inst_check__bound_inst_functor_0_0,40)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	...
	MR_np_call_localret_ent(__Compare___mdbcomp__prim_data__sym_name_0_0,
		__Compare___check_hlds__inst_check__bound_inst_functor_0_0_i42);
MR_def_label(__Compare___check_hlds__inst_check__bound_inst_functor_0_0,42)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___check_hlds__inst_check__bound_inst_functor_0_0_i74);
	}
	MR_r1 = MR_sv(2);
	MR_r2 = MR_sv(1);
...
MR_def_label(__Compare___check_hlds__inst_check__bound_inst_functor_0_0,61)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2, MR_tempr3;
	MR_tempr3 = MR_sv(2);
	MR_tempr1 = MR_tag(MR_tempr3);
	if ((MR_tempr1 == MR_mktag((MR_Integer) 2))) {
		MR_GOTO_LAB(__Compare___check_hlds__inst_check__bound_inst_functor_0_0_i68);
	}
	if ((MR_tempr1 == MR_mktag((MR_Integer) 1))) {
		MR_GOTO_LAB(__Compare___check_hlds__inst_check__bound_inst_functor_0_0_i32);
	}
...
MR_def_label(__Compare___check_hlds__inst_check__bound_inst_functor_0_0,68)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_def_label(__Compare___check_hlds__inst_check__bound_inst_functor_0_0,19)
	...
	MR_r1 = (MR_Integer) 2;
	MR_decr_sp_and_return(3);
MR_def_label(__Compare___check_hlds__inst_check__bound_inst_functor_0_0,25)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2, MR_tempr3;
	MR_tempr3 = MR_sv(2);
...
MR_def_label(__Compare___check_hlds__inst_check__bound_inst_functor_0_0,111)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Integer) 1;
	MR_decr_sp_and_return(3);
MR_def_label(__Compare___check_hlds__inst_check__bound_inst_functor_0_0,32)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Integer) 2;
MR_def_label(__Compare___check_hlds__inst_check__bound_inst_functor_0_0,74)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(3);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
...
MR_BEGIN_MODULE(check_hlds__inst_check_module13)
	...
	MR_init_label4(__Unify___check_hlds__inst_check__type_defn_or_builtin_0_0,7,5,15,1)
MR_BEGIN_CODE
...
MR_def_static(__Unify___check_hlds__inst_check__type_defn_or_builtin_0_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if ((MR_r1 == MR_r2)) {
		MR_GOTO_LAB(__Unify___check_hlds__inst_check__type_defn_or_builtin_0_0_i15);
	}
	MR_incr_sp(3);
	MR_sv(3) = (MR_Word) MR_succip;
	{
...
MR_def_label(__Unify___check_hlds__inst_check__type_defn_or_builtin_0_0,15)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_TRUE;
	MR_proceed();
...
MR_BEGIN_MODULE(check_hlds__inst_check_module14)
	...
	MR_init_label8(__Compare___check_hlds__inst_check__type_defn_or_builtin_0_0,3,2,36,13,16,5,48,9)
MR_BEGIN_CODE
...
MR_def_label(__Compare___check_hlds__inst_check__type_defn_or_builtin_0_0,2)
	...
	if ((MR_tempr1 == MR_mktag((MR_Integer) 0))) {
		MR_GOTO_LAB(__Compare___check_hlds__inst_check__type_defn_or_builtin_0_0_i13);
	}
...
MR_def_label(__Compare___check_hlds__inst_check__type_defn_or_builtin_0_0,36)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	...
	MR_decr_sp(3);
	MR_np_tailcall_ent(private_builtin__builtin_compare_int_3_0);
MR_def_label(__Compare___check_hlds__inst_check__type_defn_or_builtin_0_0,13)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_tag(MR_sv(2));
	if ((MR_tempr1 == MR_mktag((MR_Integer) 1))) {
		MR_GOTO_LAB(__Compare___check_hlds__inst_check__type_defn_or_builtin_0_0_i48);
	}
	if ((MR_tempr1 == MR_mktag((MR_Integer) 0))) {
...
MR_def_label(__Compare___check_hlds__inst_check__type_defn_or_builtin_0_0,5)
	...
	MR_tempr1 = MR_tag(MR_sv(2));
	if ((MR_tempr1 == MR_mktag((MR_Integer) 1))) {
		MR_GOTO_LAB(__Compare___check_hlds__inst_check__type_defn_or_builtin_0_0_i36);
	}
	if ((MR_tempr1 == MR_mktag((MR_Integer) 0))) {
		MR_GOTO_LAB(__Compare___check_hlds__inst_check__type_defn_or_builtin_0_0_i9);
	}
	}
MR_def_label(__Compare___check_hlds__inst_check__type_defn_or_builtin_0_0,48)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Integer) 1;
	MR_decr_sp_and_return(3);
...
MR_BEGIN_MODULE(check_hlds__inst_check_module16)
	MR_init_entry1(fn__check_hlds__inst_check__IntroducedFrom__func__index_types_by_unqualified_functors__338__1_1_0);
	MR_init_label1(fn__check_hlds__inst_check__IntroducedFrom__func__index_types_by_unqualified_functors__338__1_1_0,2)
MR_BEGIN_CODE


/*-------------------------------------------------------------------------*/
/* code for 'IntroducedFrom__func__index_types_by_unqualified_functors__338__1'/2 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(fn__check_hlds__inst_check__IntroducedFrom__func__index_types_by_unqualified_functors__338__1_1_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2, MR_tempr3;
	MR_tempr3 = MR_r1;
	...
	if (MR_PTAG_TESTR(MR_tempr1,1)) {
		MR_GOTO_LAB(fn__check_hlds__inst_check__IntroducedFrom__func__index_types_by_unqualified_functors__338__1_1_0_i2);
	}
	MR_tag_alloc_heap(MR_tempr2, 0, (MR_Integer) 1);
	MR_tfield(0, MR_tempr2, 0) = MR_ctfield(1, MR_tempr1, 1);
	MR_tag_alloc_heap(MR_tempr1, 0, (MR_Integer) 2);
...
MR_def_label(fn__check_hlds__inst_check__IntroducedFrom__func__index_types_by_unqualified_functors__338__1_1_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_proceed();
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
...
MR_BEGIN_MODULE(check_hlds__inst_check_module17)
	MR_init_entry1(fn__check_hlds__inst_check__IntroducedFrom__func__index_types_by_unqualified_functors__340__1_3_0);
MR_BEGIN_CODE


/*-------------------------------------------------------------------------*/
/* code for 'IntroducedFrom__func__index_types_by_unqualified_functors__340__1'/4 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(fn__check_hlds__inst_check__IntroducedFrom__func__index_types_by_unqualified_functors__340__1_3_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tempr1 = MR_r1;
