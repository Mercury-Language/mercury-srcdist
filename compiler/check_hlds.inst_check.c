      ...
      if (succeeded)
      {
        ...
        else
        {
          ...
          else
          {
            ...
            mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&check_hlds__inst_check_scalar_common_3[19]), HeadVar__2_2, &Var_82);
            ...
            STATE_VARIABLE_PiecesCord_1_36 = mercury__cord__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), STATE_VARIABLE_PiecesCord_0_6, Var_78);
          }
        }
      }
      else
  ...
  MR_Word * STATE_VARIABLE_PiecesCord_21)
{
  ...
  *STATE_VARIABLE_NumMismatches_19 = (MR_Integer) ((MR_Unsigned) STATE_VARIABLE_NumMismatches_0_18 + (MR_Unsigned) 1);
  ...
  mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&check_hlds__inst_check_scalar_common_3[19]), CurNum_7, &Var_57);
  ...
  mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&check_hlds__inst_check_scalar_common_3[19]), NumSubInsts_14, &Var_67);
