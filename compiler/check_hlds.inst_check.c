      ...
      case (MR_Integer) 0:
        {
          ...
          check_hlds__inst_check__find_mismatches_from_user_7_p_0(Constructors_11, (MR_Integer) 1, BoundInsts_4, (MR_Integer) 0, &NumMismatches_19, Var_34, &MismatchPiecesCord_20);
        }
        break;
      case (MR_Integer) 1:
        {
  ...
  MR_Word * STATE_VARIABLE_PiecesCord_7)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      Var_82 = (MR_Integer) ((MR_Unsigned) HeadVar__2_2 + (MR_Unsigned) (MR_Integer) 1);
      // direct tailcall eliminated
...
{
  {
    ...
    *STATE_VARIABLE_NumMismatches_17 = (MR_Integer) ((MR_Unsigned) STATE_VARIABLE_NumMismatches_0_16 + (MR_Unsigned) (MR_Integer) 1);
...
{
  {
    ...
    *STATE_VARIABLE_NumMismatches_23 = (MR_Integer) ((MR_Unsigned) STATE_VARIABLE_NumMismatches_0_22 + (MR_Unsigned) (MR_Integer) 1);
                      ...
                      case (MR_Integer) 1:
                        {
                          ...
                          switch (TypeableFunctors_37) {
                            ...
                            case (MR_Integer) 1:
                              {
                                MR_Word TypeCtorInfo_117_117 = (MR_Word) &check_hlds__inst_check__check_hlds__inst_check__type_ctor_info_type_defn_or_builtin_0;
                                MR_Word PossibleTypesSet_39;
                                MR_Word PossibleTypes_40;
                                MR_Word PossibleTypeCtors_41;
                                MR_Word IFTC_112;

                                PossibleTypesSet_39 = mercury__set__intersect_list_1_f_0(TypeCtorInfo_117_117, PossibleTypeSets_38);
                                PossibleTypes_40 = mercury__set__to_sorted_list_1_f_0(TypeCtorInfo_117_117, PossibleTypesSet_39);
                                ...
                                mercury__list__map_3_p_0(TypeCtorInfo_117_117, (MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_type_ctor_0, (MR_Word) &check_hlds__inst_check_scalar_common_2[5], PossibleTypes_40, &PossibleTypeCtors_41);
                                {
                                  IFTC_112 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
                  ...
                  case (MR_Integer) 1:
                    {
                      ...
                      if (succeeded)
                      {
                        ...
                        TypeCtorInfo_115_115 = (MR_Word) &check_hlds__inst_check__check_hlds__inst_check__type_ctor_info_cons_mismatch_0;
                        Var_109 = mercury__cord__init_0_f_0(TypeCtorInfo_115_115);
                        check_hlds__inst_check__check_for_type_bound_insts_4_p_0(ForTypeKind_33, BoundInsts_23, Var_109, &MismatchesCord_34);
                        Mismatches_35 = mercury__cord__list_1_f_0(TypeCtorInfo_115_115, MismatchesCord_34);
                      ...
                      else
                      {
                                          ...
                                          else
                                          {
                                            ...
                                            if (succeeded)
                                            {
                                              if (((MR_tag((MR_Word) ForTypeCtorName_25)) == (MR_mktag((MR_Integer) 1))))
                                              {
                                                ...
                                                succeeded = ((MR_tag((MR_Word) Var_123)) == (MR_mktag((MR_Integer) 0)));
                                                if (succeeded)
                                                {
                                            ...
                                            else
                                            {
                                              ...
                                              else
                                              {
                                                ...
                                                if (succeeded)
                                                {
                                                  ...
                                                  {
                                                    MaybeForTypeKind_140 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
                                                    MR_hl_field(MR_mktag(1), MaybeForTypeKind_140, 0) = ((MR_Box) (ForTypeKind0_31));
                                                  }
                                                }
                                                else
                                                  MaybeForTypeKind_140 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
                                              }
                                            }
                                          }
                                        }
                        ...
                        if ((MaybeForTypeKind_140 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
                        {
                        ...
                        {
                          MR_Word TypeCtorInfo_115_130 = (MR_Word) &check_hlds__inst_check__check_hlds__inst_check__type_ctor_info_cons_mismatch_0;
                          ...
                          Var_129 = mercury__cord__init_0_f_0(TypeCtorInfo_115_130);
                          check_hlds__inst_check__check_for_type_bound_insts_4_p_0(ForTypeKind_125, BoundInsts_23, Var_129, &MismatchesCord_126);
                          Mismatches_127 = mercury__cord__list_1_f_0(TypeCtorInfo_115_130, MismatchesCord_126);
...
{
  {
    ...
    else
    {
      ...
      if (((MR_tag((MR_Word) HeadVar__1_1)) == (MR_mktag((MR_Integer) 1))))
      {
        ...
        if (succeeded)
        {
          MR_Word Var_22 = (MR_Word) MR_mkword(MR_mktag(0), (MR_Word) TypeCtorAndDefn_6);
