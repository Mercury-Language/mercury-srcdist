...
check_hlds__inst_check__IntroducedFrom__func__record_arity_mismatch__1263__1_1_f_0(
  ...
  MR_Box wrapper_arg_1)
{
  ...
  conv0_LambdaHeadVar__2_33 = check_hlds__inst_check__IntroducedFrom__func__record_arity_mismatch__1263__1_1_f_0(((MR_Integer) (wrapper_arg_1)));
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        else
        {
          ...
          if (succeeded)
            check_hlds__inst_check__record_mismatch_6_p_0(HeadVar__2_2, BoundInst_18, STATE_VARIABLE_NumMismatches_0_4, &STATE_VARIABLE_NumMismatches_35_35, STATE_VARIABLE_PiecesCord_0_6, &STATE_VARIABLE_PiecesCord_36_36);
          else
          {
