...
MR_decl_label8(fn__check_hlds__inst_check__index_types_by_unqualified_functors_1_0, 29,5,6,9,10,11,12,13)
MR_decl_label2(fn__check_hlds__inst_check__index_types_by_unqualified_functors_1_0, 14,15)
...
MR_BEGIN_MODULE(check_hlds__inst_check_module0)
	...
	MR_init_label8(fn__check_hlds__inst_check__index_types_by_unqualified_functors_1_0,29,5,6,9,10,11,12,13)
	MR_init_label2(fn__check_hlds__inst_check__index_types_by_unqualified_functors_1_0,14,15)
MR_BEGIN_CODE
...
MR_def_static(fn__check_hlds__inst_check__index_types_by_unqualified_functors_1_0)
	...
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
		MR_GOTO_LAB(fn__check_hlds__inst_check__index_types_by_unqualified_functors_1_0_i29);
	}
...
MR_def_label(fn__check_hlds__inst_check__index_types_by_unqualified_functors_1_0,29)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(3);
...
MR_def_label(fn__check_hlds__inst_check__index_types_by_unqualified_functors_1_0,6)
	...
	MR_COMPUTED_GOTO((MR_Unsigned) MR_tag(MR_r1),
		MR_LABEL_AP(fn__check_hlds__inst_check__index_types_by_unqualified_functors_1_0_i9) MR_AND
		MR_LABEL_AP(fn__check_hlds__inst_check__index_types_by_unqualified_functors_1_0_i11) MR_AND
		MR_LABEL_AP(fn__check_hlds__inst_check__index_types_by_unqualified_functors_1_0_i12) MR_AND
		MR_LABEL_AP(fn__check_hlds__inst_check__index_types_by_unqualified_functors_1_0_i13));
...
MR_def_label(fn__check_hlds__inst_check__index_types_by_unqualified_functors_1_0,10)
	...
	MR_r2 = (MR_Word) MR_CTOR0_ADDR(parse_tree__prog_data, sym_name_and_arity);
	MR_np_call_localret_ent(fn__list__map_2_0,
		fn__check_hlds__inst_check__index_types_by_unqualified_functors_1_0_i15);
...
MR_def_label(fn__check_hlds__inst_check__index_types_by_unqualified_functors_1_0,13)
	...
	if (MR_INT_NE(MR_ctfield(3, MR_r1, 0),0)) {
		MR_GOTO_LAB(fn__check_hlds__inst_check__index_types_by_unqualified_functors_1_0_i14);
	}
	MR_r4 = (MR_Word) MR_tbmkword(0, 0);
...
MR_def_label(fn__check_hlds__inst_check__index_types_by_unqualified_functors_1_0,14)
	...
	MR_np_call_localret_ent(fn__list__map_2_0,
		fn__check_hlds__inst_check__index_types_by_unqualified_functors_1_0_i15);
MR_def_label(fn__check_hlds__inst_check__index_types_by_unqualified_functors_1_0,15)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
