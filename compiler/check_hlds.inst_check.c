        ...
        if ((check_hlds__inst_check__HeadVar__3_3 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
        ...
        else
          {
            ...
            switch (check_hlds__inst_check__HeadVar__1_1) {
              ...
              case (MR_Integer) 1:
                {
                  MR_Integer check_hlds__inst_check__V_25_25;
                  ...
                  if (check_hlds__inst_check__succeeded)
                    {
                      check_hlds__inst_check__V_25_25 = ((MR_Integer) (MR_hl_field(MR_mktag(3), check_hlds__inst_check__ConsId_22, (MR_Integer) 1)));
                      check_hlds__inst_check__STATE_VARIABLE_PiecesCord_47_47 = check_hlds__inst_check__STATE_VARIABLE_PiecesCord_0_6;
                      check_hlds__inst_check__STATE_VARIABLE_NumMismatches_46_46 = check_hlds__inst_check__STATE_VARIABLE_NumMismatches_0_4;
                    }
                  else
