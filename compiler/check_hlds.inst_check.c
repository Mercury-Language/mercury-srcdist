...
MR_decl_label8(check_hlds__inst_check__maybe_issue_inst_check_warning_5_0, 2,10,16,18,13,26,21,9)
...
MR_BEGIN_MODULE(check_hlds__inst_check_module4)
	...
	MR_init_label8(check_hlds__inst_check__maybe_issue_inst_check_warning_5_0,2,10,16,18,13,26,21,9)
...
MR_def_label(check_hlds__inst_check__maybe_issue_inst_check_warning_5_0,16)
	...
	MR_np_call_localret_ent(list__member_2_0,
		check_hlds__inst_check__maybe_issue_inst_check_warning_5_0_i18);
MR_def_label(check_hlds__inst_check__maybe_issue_inst_check_warning_5_0,18)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_r1) {
...
MR_def_label(check_hlds__inst_check__maybe_issue_inst_check_warning_5_0,13)
	...
	if (MR_INT_EQ(MR_sv(4),0)) {
		MR_GOTO_LAB(check_hlds__inst_check__maybe_issue_inst_check_warning_5_0_i21);
	}
	...
	MR_np_call_localret_ent(check_hlds__inst_check__type_is_user_visible_2_0,
		check_hlds__inst_check__maybe_issue_inst_check_warning_5_0_i26);
MR_def_label(check_hlds__inst_check__maybe_issue_inst_check_warning_5_0,26)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO(MR_ENTRY(MR_do_redo));
	}
MR_def_label(check_hlds__inst_check__maybe_issue_inst_check_warning_5_0,21)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
