              ...
              case (MR_Integer) 1:
                {
                  ...
                  MR_Integer check_hlds__inst_check__Var_31 = (MR_Integer) check_hlds__inst_check__ArgY1_13;
            ...
            if (check_hlds__inst_check__succeeded)
              {
                ...
                check_hlds__inst_check__succeeded = (check_hlds__inst_check__ArgX1_5 == check_hlds__inst_check__ArgY1_6);
              }
          }
          break;
        case (MR_Integer) 2:
              ...
              case (MR_Integer) 1:
                {
                  ...
                  {
                    parse_tree__prog_data____Compare____type_ctor_0_0(&check_hlds__inst_check__Var_8, check_hlds__inst_check__Var_34, check_hlds__inst_check__ArgY1_5);
                  }
                  check_hlds__inst_check__succeeded = (check_hlds__inst_check__Var_8 == (MR_Integer) 0);
                  check_hlds__inst_check__succeeded = !(check_hlds__inst_check__succeeded);
                  if (check_hlds__inst_check__succeeded)
                    *check_hlds__inst_check__HeadVar__1_1 = check_hlds__inst_check__Var_8;
                    ...
                    {
                      hlds__hlds_data____Compare____hlds_type_defn_0_0(check_hlds__inst_check__HeadVar__1_1, check_hlds__inst_check__Var_33, check_hlds__inst_check__ArgY2_7);
                    }
                }
                break;
            }
