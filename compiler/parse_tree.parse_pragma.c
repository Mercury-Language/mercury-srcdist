...
static /* final */ const MR_Box parse_tree__parse_pragma_scalar_common_1[137][2];
                ...
                if ((ConflictSpecs_87 == (MR_Word) ((MR_Unsigned) 0U)))
                  ...
                  else
                  {
                    ...
                    }
                    {
                      ...
                      MR_hl_field(MR_mktag(0), Var_104, 0) = ((MR_Box) (Item_92));
                    }
                    {
                      MR_Word base;
                      base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
            ...
            if (succeeded)
            {
              ...
              if (succeeded)
              {
...

                {
                  ...
                  MR_hl_field(MR_mktag(3), Marker_122, 0) = ((MR_Box) ((MR_Unsigned) 3U));
        ...
        case (MR_Integer) 0:
          {
            ...
            else
            {
              ...
              }
              {
                ...
                MR_hl_field(MR_mktag(1), Var_78, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &parse_tree__parse_pragma_scalar_common_1[136])));
