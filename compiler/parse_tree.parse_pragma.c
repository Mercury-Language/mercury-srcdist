        ...
        if (succeeded)
        {
          ...
          if ((MaybeSpecSymName_17 == (MR_Word) ((MR_Unsigned) 0U)))
          {
            ...
            parse_tree__prog_item__pfumm_to_maybe_pf_arity_maybe_modes_4_p_0(PFUMM_28, &MaybePredOrFunc_35, &_Arity_36, &_MaybeModes_37);
            {
              ...
              MR_hl_field(MR_mktag(3), Transform_38, 0) = ((MR_Box) ((MR_Unsigned) 7U));
            ...
            parse_tree__pred_name__make_pred_name_4_p_0(ModuleName_8, UnqualName_34, Transform_38, &SpecSymName_33);
          }
          else
