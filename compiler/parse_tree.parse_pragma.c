          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                ...
                TypeCtorInfo__19_19 = (MR_Word) (&mercury__term__term__type_ctor_info_generic_0);
                TypeCtorInfo__20_20 = (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_tvar_type_0);
                mercury__term__coerce_var_2_p_0(TypeCtorInfo__19_19, TypeCtorInfo__20_20, TypeVar0_8, &TypeVar_10);
      ...
      case (MR_Integer) 29:
        {
          ...
          if ((PragmaTerms_13 == (MR_Word) ((MR_Unsigned) 0U)))
          {
            ...
            Var_98 = mercury__term__get_term_context_1_f_0((MR_Word) (&mercury__term__term__type_ctor_info_generic_0), ErrorTerm_11);
            {
              ...
              MR_hl_field(MR_mktag(1), Spec_94, 3) = ((MR_Box) (Var_98));
            ...
            }
            {
              ...
              MR_hl_field(MR_mktag(1), Var_99, 0) = ((MR_Box) (Spec_94));
                ...
                if ((ConflictSpecs_87 == (MR_Word) ((MR_Unsigned) 0U)))
                  ...
                  else
                  {
                    ...
                    }
                    {
                      ...
                      MR_hl_field(MR_mktag(1), Var_104, 0) = ((MR_Box) (Item_92));
                    }
                    {
                      MR_Word base;
                      base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
    ...
    if ((Var_79 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      ...
      else
      {
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(1), Var_49, 0) = ((MR_Box) (Item_24));
        }
        {
          MR_Word base;
          base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
        ...
        else
        {
          ...
          if (succeeded)
          {
            ...
            }
            {
              ...
              MR_hl_field(MR_mktag(1), Var_59, 0) = ((MR_Box) (Item_24));
            }
            {
              MR_Word base;
              base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
  ...
  if (succeeded)
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          TypeCtorInfo__146_146 = (MR_Word) (&mercury__term__term__type_ctor_info_generic_0);
          succeeded = parse_tree__parse_sym_name__try_parse_sym_name_and_no_args_2_p_0(TypeCtorInfo__146_146, SpecSymNameTerm_23, &SpecializedSymName0_29);
          if (succeeded)
        ...
        if ((Var_166 == (MR_Word) ((MR_Unsigned) 0U)))
        {
          ...
          if (succeeded)
          {
            ...
            }
            {
              ...
              MR_hl_field(MR_mktag(1), Var_112, 0) = ((MR_Box) (Item_38));
            }
            {
              MR_Word base;
              base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
    ...
    if ((Var_157 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      ...
      if (succeeded)
      {
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(1), Var_72, 0) = ((MR_Box) (Item_28));
        }
        {
          MR_Word base;
          base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
    ...
    if ((Var_122 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      ...
      if (succeeded)
      {
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(1), Var_56, 0) = ((MR_Box) (Item_24));
        }
        {
          MR_Word base;
          base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
