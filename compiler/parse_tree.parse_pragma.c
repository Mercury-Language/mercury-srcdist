...
static /* final */ const MR_Box parse_tree__parse_pragma_scalar_common_1[126][2];
...
static /* final */ const MR_Box parse_tree__parse_pragma_scalar_common_1[126][2] = {
  ...
  /* row 106 */
  {
    ((MR_Box) (MR_mkword(MR_mktag(3), &parse_tree__parse_pragma_scalar_common_1[105]))),
    ((MR_Box) (MR_mkword(MR_mktag(1), &parse_tree__parse_pragma_scalar_common_1[104])))
  },
  /* row 107 */
  {
    ((MR_Box) (MR_mkword(MR_mktag(3), &parse_tree__parse_pragma_scalar_common_1[18]))),
    ((MR_Box) (MR_mkword(MR_mktag(1), &parse_tree__parse_pragma_scalar_common_1[106])))
  },
  /* row 108 */
  {
    ((MR_Box) (MR_Word) ((MR_Unsigned) 5U)),
  ...
  /* row 113 */
  {
    ...
    ((MR_Box) (MR_mkword(MR_mktag(1), &parse_tree__parse_pragma_scalar_common_1[112])))
  },
  /* row 114 */
  {
...
static /* final */ const MR_Box parse_tree__parse_pragma_scalar_common_3[7][1] = {
  ...
  /* row 6 */
  {
    ((MR_Box) (MR_mkword(MR_mktag(3), &parse_tree__parse_pragma_scalar_common_1[114])))
  },
};
...
{
  {
    ...
    else
    {
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(1), Var_65, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &parse_tree__parse_pragma_scalar_common_1[125])));
        MR_hl_field(MR_mktag(1), Var_65, 1) = ((MR_Box) (Var_68));
      }
      {
        Var_62 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), Var_62, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &parse_tree__parse_pragma_scalar_common_1[124])));
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(1), Var_56, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &parse_tree__parse_pragma_scalar_common_1[123])));
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(1), Var_50, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &parse_tree__parse_pragma_scalar_common_1[122])));
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(1), Var_44, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &parse_tree__parse_pragma_scalar_common_1[121])));
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(1), Var_38, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &parse_tree__parse_pragma_scalar_common_1[120])));
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(1), Var_32, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &parse_tree__parse_pragma_scalar_common_1[119])));
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(1), Var_26, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &parse_tree__parse_pragma_scalar_common_1[118])));
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(1), Var_20, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &parse_tree__parse_pragma_scalar_common_1[117])));
        MR_hl_field(MR_mktag(1), Var_20, 1) = ((MR_Box) (Var_23));
      }
      {
        Var_17 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), Var_17, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &parse_tree__parse_pragma_scalar_common_1[116])));
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(1), Pieces_11, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &parse_tree__parse_pragma_scalar_common_1[115])));
  ...
  MR_Word * MaybeIOM_12)
{
  if ((PragmaTerms_9 == (MR_Word) ((MR_Unsigned) 0U)))
  {
    ...
    Var_49 = mercury__term__get_term_context_1_f_0((MR_Word) (&mercury__term__term__type_ctor_info_generic_0), ErrorTerm_8);
    {
      ...
      MR_hl_field(MR_mktag(1), Spec_33, 4) = ((MR_Box) (MR_mkword(MR_mktag(1), &parse_tree__parse_pragma_scalar_common_1[111])));
    }
    {
      Var_50 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
  ...
  else
  {
    ...
    if ((Var_93 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      ...
      else
      {
        ...
        parse_tree__parse_util__report_any_conflicts_5_p_0((MR_Word) (&parse_tree__prog_data_pragma__parse_tree__prog_data_pragma__type_ctor_info_required_feature_0), FeatureListContext_17, (MR_String) "conflicting features in feature set", (MR_Word) (MR_mkword(MR_mktag(1), &parse_tree__parse_pragma_scalar_common_1[113])), FeatureList_15, &ConflictSpecs_18);
    ...
    else
    {
      ...
      Var_80 = mercury__term__get_term_context_1_f_0((MR_Word) (&mercury__term__term__type_ctor_info_generic_0), ErrorTerm_8);
      {
        ...
        MR_hl_field(MR_mktag(1), Spec_76, 4) = ((MR_Box) (MR_mkword(MR_mktag(1), &parse_tree__parse_pragma_scalar_common_1[111])));
      }
      {
...
{
  {
    ...
    if ((PragmaTerms_11 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      ...
      Var_51 = mercury__term__get_term_context_1_f_0((MR_Word) (&mercury__term__term__type_ctor_info_generic_0), ErrorTerm_10);
      {
        ...
        MR_hl_field(MR_mktag(1), Spec_91, 4) = ((MR_Box) (MR_mkword(MR_mktag(1), &parse_tree__parse_pragma_scalar_common_1[107])));
      }
      {
    ...
    else
    {
      ...
      if ((Var_121 == (MR_Word) ((MR_Unsigned) 0U)))
      {
        ...
        Var_97 = mercury__term__get_term_context_1_f_0((MR_Word) (&mercury__term__term__type_ctor_info_generic_0), ErrorTerm_10);
        {
          ...
          MR_hl_field(MR_mktag(1), Spec_101, 4) = ((MR_Box) (MR_mkword(MR_mktag(1), &parse_tree__parse_pragma_scalar_common_1[107])));
        }
        {
      ...
      else
      {
          ...
          else
          {
            ...
            else
            {
              ...
              }
              {
                ...
                MR_hl_field(MR_mktag(1), Var_70, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &parse_tree__parse_pragma_scalar_common_1[108])));
              ...
              {
                Var_62 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(1), Var_62, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &parse_tree__parse_pragma_scalar_common_1[105])));
                MR_hl_field(MR_mktag(1), Var_62, 1) = ((MR_Box) (Var_65));
              }
              {
        ...
        else
        {
          ...
          Var_106 = mercury__term__get_term_context_1_f_0((MR_Word) (&mercury__term__term__type_ctor_info_generic_0), ErrorTerm_10);
          {
            ...
            MR_hl_field(MR_mktag(1), Spec_110, 4) = ((MR_Box) (MR_mkword(MR_mktag(1), &parse_tree__parse_pragma_scalar_common_1[107])));
          }
          {
...
{
  {
    ...
    if (succeeded)
    {
      Var_125 = ((MR_Word) ((MR_hl_field(MR_mktag(1), PragmaTerms_11, (MR_Integer) 0))));
      Var_124 = ((MR_Word) ((MR_hl_field(MR_mktag(1), PragmaTerms_11, (MR_Integer) 1))));
      succeeded = (Var_124 != (MR_Word) ((MR_Unsigned) 0U));
      if (succeeded)
      {
        Var_127 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Var_124, (MR_Integer) 0))));
        Var_126 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Var_124, (MR_Integer) 1))));
        if ((Var_126 == (MR_Word) ((MR_Unsigned) 0U)))
        {
          PredAndModesTerm_15 = Var_125;
          TypeSubnTerm_16 = Var_127;
          MaybeSpecSymName_17 = (MR_Word) ((MR_Unsigned) 0U);
          succeeded = MR_TRUE;
        }
        else
        {
          MR_Word TypeCtorInfo_114_114;
          MR_Word SpecSymNameTerm_18;
          MR_Word SpecContext_21;
          MR_String FileName_22;
          MR_Word SpecializedSymName_24;
          MR_Word Var_50;
          MR_String Var_51;
          MR_String Var_23;
          ...
          PredAndModesTerm_15 = Var_125;
          TypeSubnTerm_16 = Var_127;
          SpecSymNameTerm_18 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Var_126, (MR_Integer) 0))));
          Var_50 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Var_126, (MR_Integer) 1))));
          succeeded = (Var_50 == (MR_Word) ((MR_Unsigned) 0U));
          if (succeeded)
          {
            succeeded = ((MR_tag((MR_Word) SpecSymNameTerm_18)) == (MR_Integer) 0);
            if (succeeded)
            {
              SpecContext_21 = ((MR_Word) ((MR_hl_field(MR_mktag(0), SpecSymNameTerm_18, (MR_Integer) 2))));
              mercury__term__context_file_2_p_0(SpecContext_21, &FileName_22);
              Var_51 = (MR_String) ".m";
              succeeded = mercury__string__remove_suffix_3_p_0(FileName_22, Var_51, &Var_23);
              succeeded = !(succeeded);
              if (succeeded)
              {
                TypeCtorInfo_114_114 = (MR_Word) (&mercury__term__term__type_ctor_info_generic_0);
                succeeded = parse_tree__parse_sym_name__try_parse_implicitly_qualified_sym_name_and_no_args_3_p_0(TypeCtorInfo_114_114, ModuleName_8, SpecSymNameTerm_18, &SpecializedSymName_24);
                if (succeeded)
                {
                  {
                    MaybeSpecSymName_17 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(MR_mktag(1), MaybeSpecSymName_17, 0) = ((MR_Box) (SpecializedSymName_24));
                  }
                  succeeded = MR_TRUE;
                }
              }
    ...
    if (succeeded)
    {
      ...
      ArityOrModesContextPieces_25 = mercury__cord__from_list_1_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_format_component_0), (MR_Word) (MR_mkword(MR_mktag(1), &parse_tree__parse_pragma_scalar_common_1[97])));
      ...
      else
      {
        ...
        if (succeeded)
        {
          ...
          if ((MaybeSpecSymName_17 == (MR_Word) ((MR_Unsigned) 0U)))
          {
            ...
            parse_tree__prog_item__pfumm_to_maybe_pf_arity_maybe_modes_4_p_0(PFUMM_28, &MaybePredOrFunc_35, &_Arity_36, &_MaybeModes_37);
            {
              ...
              MR_hl_field(MR_mktag(3), Transform_38, 0) = ((MR_Box) ((MR_Unsigned) 9U));
              MR_hl_field(MR_mktag(3), Transform_38, 1) = ((MR_Box) (MaybePredOrFunc_35));
              MR_hl_field(MR_mktag(3), Transform_38, 2) = ((MR_Box) (TVarSet_31));
              MR_hl_field(MR_mktag(3), Transform_38, 3) = ((MR_Box) (TypeSubns_32));
            }
            parse_tree__pred_name__make_transformed_pred_sym_name_4_p_0(ModuleName_8, UnqualName_34, Transform_38, &SpecSymName_33);
          }
          else
            SpecSymName_33 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MaybeSpecSymName_17, (MR_Integer) 0))));
          Var_67 = mercury__set__init_0_f_0((MR_Word) (&recompilation__recompilation__type_ctor_info_item_id_0));
          {
            TypeSpecInfo_39 = (MR_Word) MR_new_object(MR_Word, (6 * sizeof(MR_Word)), NULL, NULL);
            MR_hl_field(MR_mktag(0), TypeSpecInfo_39, 0) = ((MR_Box) (PFUMM_28));
            MR_hl_field(MR_mktag(0), TypeSpecInfo_39, 1) = ((MR_Box) (PredName_29));
            MR_hl_field(MR_mktag(0), TypeSpecInfo_39, 2) = ((MR_Box) (SpecSymName_33));
            MR_hl_field(MR_mktag(0), TypeSpecInfo_39, 3) = ((MR_Box) (TypeSubns_32));
            MR_hl_field(MR_mktag(0), TypeSpecInfo_39, 4) = ((MR_Box) (TVarSet_31));
            MR_hl_field(MR_mktag(0), TypeSpecInfo_39, 5) = ((MR_Box) (Var_67));
          }
          Pragma_40 = (MR_Word) (MR_mkword(MR_mktag(2), (MR_Word) (TypeSpecInfo_39)));
          {
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(0), Var_68, 0) = ((MR_Box) (Item_42));
          }
          {
            MR_Word base;
            base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
        ...
        {
          MR_String TypeSubnTermStr_43;
          MR_Word Pieces_44;
          MR_Word TypeSubnContext_45;
          MR_Word Spec_46;
          MR_Word Var_71;
          MR_Word Var_74;
          MR_Word Var_77;
          ...
          TypeSubnTermStr_43 = parse_tree__parse_tree_out_term__describe_error_term_2_f_0((MR_Word) (&mercury__term__term__type_ctor_info_generic_0), VarSet_9, TypeSubnTerm_16);
          {
            Var_83 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(3), Var_83, 0) = ((MR_Box) ((MR_Unsigned) 0U));
            MR_hl_field(MR_mktag(3), Var_83, 1) = ((MR_Box) (TypeSubnTermStr_43));
          }
          {
            Var_82 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), Var_82, 0) = ((MR_Box) (Var_83));
          ...
          {
            Var_79 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), Var_79, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &parse_tree__parse_pragma_scalar_common_1[98])));
            MR_hl_field(MR_mktag(1), Var_79, 1) = ((MR_Box) (Var_82));
          }
          {
          ...
          {
            Var_74 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), Var_74, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &parse_tree__parse_pragma_scalar_common_1[62])));
            MR_hl_field(MR_mktag(1), Var_74, 1) = ((MR_Box) (Var_77));
          }
          {
            Var_71 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), Var_71, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &parse_tree__parse_pragma_scalar_common_1[94])));
            MR_hl_field(MR_mktag(1), Var_71, 1) = ((MR_Box) (Var_74));
          }
          {
            Pieces_44 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), Pieces_44, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &parse_tree__parse_pragma_scalar_common_1[79])));
            MR_hl_field(MR_mktag(1), Pieces_44, 1) = ((MR_Box) (Var_71));
          }
          TypeSubnContext_45 = mercury__term__get_term_context_1_f_0((MR_Word) (&mercury__term__term__type_ctor_info_generic_0), TypeSubnTerm_16);
          {
            Spec_46 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), Spec_46, 0) = ((MR_Box) ((MR_String) "predicate \140parse_tree.parse_pragma.parse_pragma_type_spec\'/7"));
            MR_hl_field(MR_mktag(1), Spec_46, 1) = ((MR_Box) ((MR_Unsigned) 0U));
            MR_hl_field(MR_mktag(1), Spec_46, 2) = ((MR_Box) ((MR_Unsigned) 20U));
            MR_hl_field(MR_mktag(1), Spec_46, 3) = ((MR_Box) (TypeSubnContext_45));
            MR_hl_field(MR_mktag(1), Spec_46, 4) = ((MR_Box) (Pieces_44));
          }
          {
            Var_93 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), Var_93, 0) = ((MR_Box) (Spec_46));
    ...
    else
    {
      ...
      Var_109 = mercury__term__get_term_context_1_f_0((MR_Word) (&mercury__term__term__type_ctor_info_generic_0), ErrorTerm_10);
      {
        ...
        MR_hl_field(MR_mktag(1), Spec_113, 0) = ((MR_Box) ((MR_String) "predicate \140parse_tree.parse_pragma.parse_pragma_type_spec\'/7"));
        MR_hl_field(MR_mktag(1), Spec_113, 1) = ((MR_Box) ((MR_Unsigned) 0U));
        MR_hl_field(MR_mktag(1), Spec_113, 2) = ((MR_Box) ((MR_Unsigned) 20U));
        MR_hl_field(MR_mktag(1), Spec_113, 3) = ((MR_Box) (Var_109));
        MR_hl_field(MR_mktag(1), Spec_113, 4) = ((MR_Box) (MR_mkword(MR_mktag(1), &parse_tree__parse_pragma_scalar_common_1[102])));
      }
      {
        Var_110 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), Var_110, 0) = ((MR_Box) (Spec_113));
