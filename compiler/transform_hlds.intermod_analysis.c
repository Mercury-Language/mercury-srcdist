  ...
  MR_Word * STATE_VARIABLE_ReuseInfosCord_33)
{
  ...
  if (succeeded)
  {
    ...
    hlds__hlds_pred__proc_info_get_varset_vartypes_3_p_0(ProcInfo_10, &VarSet_20, &VarTypes_21);
    hlds__hlds_pred__pred_info_get_typevarset_2_p_0(PredInfo_16, &TypeVarSet_22);
    ModuleName_23 = hlds__hlds_pred__pred_info_module_1_f_0(PredInfo_16);
    {
      ...
      MR_hl_field(MR_mktag(1), PredSymName_24, 1) = ((MR_Box) (PredName_12));
    }
    hlds__hlds_pred__proc_info_declared_argmodes_2_p_0(ProcInfo_10, &ArgModes_25);
    {
      PredNameModesPF_26 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), PredNameModesPF_26, 0) = (MR_Box) ((MR_Unsigned) (PredOrFunc_14));
      MR_hl_field(MR_mktag(0), PredNameModesPF_26, 1) = ((MR_Box) (PredSymName_24));
      MR_hl_field(MR_mktag(0), PredNameModesPF_26, 2) = ((MR_Box) (ArgModes_25));
    }
    hlds__hlds_pred__proc_info_get_headvars_2_p_0(ProcInfo_10, &HeadVars_27);
    parse_tree__vartypes__lookup_var_types_3_p_0(VarTypes_21, HeadVars_27, &HeadVarTypes_28);
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(0), ReuseInfo_31, 0) = ((MR_Box) (PredNameModesPF_26));
      MR_hl_field(MR_mktag(0), ReuseInfo_31, 1) = ((MR_Box) (HeadVars_27));
      MR_hl_field(MR_mktag(0), ReuseInfo_31, 2) = ((MR_Box) (HeadVarTypes_28));
      MR_hl_field(MR_mktag(0), ReuseInfo_31, 3) = ((MR_Box) (VarSet_20));
      MR_hl_field(MR_mktag(0), ReuseInfo_31, 4) = ((MR_Box) (TypeVarSet_22));
  ...
  MR_Word * STATE_VARIABLE_SharingInfosCord_33)
{
  ...
  if (succeeded)
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(0), SharingInfo_31, 0) = ((MR_Box) (PredNameModesPF_26));
      MR_hl_field(MR_mktag(0), SharingInfo_31, 1) = ((MR_Box) (HeadVars_27));
      MR_hl_field(MR_mktag(0), SharingInfo_31, 2) = ((MR_Box) (HeadVarTypes_28));
      MR_hl_field(MR_mktag(0), SharingInfo_31, 3) = ((MR_Box) (VarSet_20));
      MR_hl_field(MR_mktag(0), SharingInfo_31, 4) = ((MR_Box) (TypeVarSet_22));
  ...
  if (succeeded)
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        TypeCtorInfo__37_37 = (MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_id_0);
        succeeded = mercury__set__member_2_p_0(TypeCtorInfo__37_37, ((MR_Box) (PredId_15)), TypeSpecForcePreds_19);
        succeeded = !(succeeded);
        if (succeeded)
        {
  ...
  MR_Word * STATE_VARIABLE_TermInfo2sCord_21)
{
  ...
  if (succeeded)
  {
    ...
    if (succeeded)
    {
      TypeCtorInfo__26_26 = (MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_id_0);
      succeeded = mercury__set__member_2_p_0(TypeCtorInfo__26_26, ((MR_Box) (PredId_11)), TypeSpecForcePreds_16);
      succeeded = !(succeeded);
    }
  }
  if (succeeded)
  ...
  MR_Word * STATE_VARIABLE_ParseTreePlainOpt_25)
{
  ...
  if (succeeded)
  {
    TypeCtorInfo__257_257 = (MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_pragma_info_unused_args_0);
    succeeded = mercury__set__is_empty_1_p_0(TypeCtorInfo__257_257, UnusedArgsInfosSet_10);
  }
  if (succeeded)
