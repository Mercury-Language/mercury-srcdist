...
static const MR_FA_TypeInfo_Struct1 ll_backend__fact_table_gen__list__ti_list_1parse_tree__error_spec__type_ctor_info_err_spec_0;
...
static const MR_PseudoTypeInfo ll_backend__fact_table_gen__ll_backend__fact_table_gen__field_types_fact_table_arg_check_result_0_1[1] = { (MR_PseudoTypeInfo) (&ll_backend__fact_table_gen__list__ti_list_1parse_tree__error_spec__type_ctor_info_err_spec_0) };
  ...
  MR_String * ExtraCode_20)
{
  ...
  libs__globals__lookup_int_option_3_p_0(Globals_21, (MR_Integer) 665, &FactTableSize_22);
  ...
  MR_Word * STATE_VARIABLE_Specs_46)
{
  ...
  else
  {
    ...
    else
    {
      ...
      libs__globals__lookup_int_option_3_p_0(Globals_24, (MR_Integer) 665, &FactTableSize_36);
  ...
  MR_Word * STATE_VARIABLE_Specs_53)
{
  ...
  libs__globals__lookup_int_option_3_p_0(Globals_46, (MR_Integer) 666, &PercentFull_61);
  ...
  else
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        libs__globals__lookup_int_option_3_p_0(Globals_16, (MR_Integer) 666, &PercentFull_78);
