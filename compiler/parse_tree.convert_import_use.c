  ...
  MR_Word * STATE_VARIABLE_Specs_30)
{
  ...
  if (succeeded)
  {
    switch (MR_tag((MR_Word) OldEntry_11)) {
      ...
      case (MR_Integer) 0:
        {
          MR_Word PrevContext_117 = ((MR_Word) ((MR_hl_field(0, OldEntry_11, 0))));
      ...
      case (MR_Integer) 1:
        {
          MR_Word PrevContext_151 = ((MR_Word) ((MR_hl_field(1, OldEntry_11, 0))));
      ...
      case (MR_Integer) 3:
        switch (((MR_Integer) ((MR_hl_field(3, OldEntry_11, 0))))) {
          ...
          case (MR_Integer) 1:
            {
              MR_Word PrevContext_185 = ((MR_Word) ((MR_hl_field(3, OldEntry_11, 1))));
