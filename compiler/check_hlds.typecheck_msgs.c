...
static /* final */ const MR_Box check_hlds__typecheck_msgs_scalar_common_1[33][2];
  ...
  if ((MaybeActualReturnType_8 == (MR_Word) ((MR_Unsigned) 0U)))
  {
    ...
    if (succeeded)
    {
      ...
      Var_69 = mercury__string__f_43_43_2_f_0((MR_String) "    ", LastArgTypeStr_59);
      {
        ...
        MR_hl_field(1, Var_68, 1) = ((MR_Box) (MR_mkword(1, &check_hlds__typecheck_msgs_scalar_common_1[32])));
      }
      ...
      ActualLines_15 = mercury__list__f_43_43_2_f_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (MR_mkword(1, &check_hlds__typecheck_msgs_scalar_common_1[31])), Var_67);
    }
    else
    ...
    if (succeeded)
    {
      ...
      Var_97 = mercury__string__f_43_43_2_f_0((MR_String) "    ", LastArgTypeStr_87);
      {
        ...
        MR_hl_field(1, Var_96, 1) = ((MR_Box) (MR_mkword(1, &check_hlds__typecheck_msgs_scalar_common_1[32])));
      }
      ...
      OtherLines_16 = mercury__list__f_43_43_2_f_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (MR_mkword(1, &check_hlds__typecheck_msgs_scalar_common_1[31])), Var_95);
    }
    else
  ...
  MR_Word * Lines_8)
{
  ...
  if (succeeded)
  {
    ...
    *Lines_8 = mercury__list__f_43_43_2_f_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (MR_mkword(1, &check_hlds__typecheck_msgs_scalar_common_1[30])), Var_31);
  }
  else
  {
    MR_String Var_16;
