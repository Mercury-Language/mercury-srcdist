  ...
  MR_Word LambdaHeadVar__1_54)
{
  ...
  succeeded = hlds__hlds_pred__marker_is_present_2_p_0(OtherPredMarkers_34, (MR_Integer) 2);
  succeeded = !(succeeded);
  return succeeded;
}
  ...
  MR_Word * STATE_VARIABLE_Specs_5)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      succeeded = hlds__hlds_pred__marker_is_present_2_p_0(Markers_17, (MR_Integer) 2);
      if (succeeded)
      {
