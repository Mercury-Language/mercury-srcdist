          ...
          case (MR_Integer) 1:
            {
              ...
              if (succeeded)
              {
                ...
                }
                {
                  ...
                  MR_hl_field(2, Spec_21, 3) = ((MR_Box) (Msgs_28));
                }
                {
                  MR_Word base;
                  base = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
    ...
    case (MR_Integer) 1:
      {
        ...
        if (succeeded)
        {
          ...
          }
          {
            ...
            MR_hl_field(2, Spec_42, 0) = ((MR_Box) ((MR_String) "function \140check_hlds.typecheck_msgs.report_non_contiguous_clauses\'/6"));
            MR_hl_field(2, Spec_42, 1) = ((MR_Box) ((MR_Unsigned) 4U));
            MR_hl_field(2, Spec_42, 2) = ((MR_Box) ((MR_Unsigned) 52U));
            MR_hl_field(2, Spec_42, 3) = ((MR_Box) (Msgs_49));
          }
          {
            MR_Word base;
            base = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
