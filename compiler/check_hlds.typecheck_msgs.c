  ...
  MR_Word PredInfo_7)
{
  ...
  if ((AllOtherDeclaredPredIds_35 == (MR_Word) ((MR_Unsigned) 0U)))
  {
...

    {
      ...
      MR_hl_field(MR_mktag(0), Var_59, 0) = ((MR_Box) (Context_12));
      MR_hl_field(MR_mktag(0), Var_59, 1) = ((MR_Box) (InferredPieces_25));
    }
    {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(3), Spec_8, 1) = (MR_Box) (((((MR_Unsigned) ((MR_Integer) 67) << 1)) | (MR_Unsigned) ((MR_Integer) 1)));
  ...
  else
  {
...

    {
      ...
      MR_hl_field(MR_mktag(0), Var_61, 0) = ((MR_Box) (&check_hlds__typecheck_msgs_scalar_common_5[0]));
      MR_hl_field(MR_mktag(0), Var_61, 1) = ((MR_Box) (check_hlds__typecheck_msgs__construct_type_inference_message_3_f_0_2));
      MR_hl_field(MR_mktag(0), Var_61, 2) = ((MR_Box) ((MR_Integer) 3));
      MR_hl_field(MR_mktag(0), Var_61, 3) = ((MR_Box) (ModuleInfo_5));
      MR_hl_field(MR_mktag(0), Var_61, 4) = ((MR_Box) (ArgTypes_21));
      MR_hl_field(MR_mktag(0), Var_61, 5) = ((MR_Box) (MaybeReturnType_22));
    }
    mercury__list__map_3_p_0((MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_id_0), (MR_Word) (&check_hlds__typecheck_msgs_scalar_common_1[0]), Var_61, AllOtherDeclaredPredIds_35, &DiffPieceLists_38);
    Var_67 = mercury__list__condense_1_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_format_component_0), DiffPieceLists_38);
    Var_66 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_format_component_0), InferredPieces_25, Var_67);
    Pieces_39 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_format_component_0), (MR_Word) (MR_mkword(MR_mktag(1), &check_hlds__typecheck_msgs_scalar_common_1[16])), Var_66);
    {
