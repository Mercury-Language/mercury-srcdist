...
check_hlds__typecheck_msgs__IntroducedFrom__pred__construct_type_inference_message__137__1_2_p_0(
  ...
  MR_Box wrapper_arg_1)
{
  ...
  conv5_LambdaHeadVar__2_21 = check_hlds__typecheck_msgs__IntroducedFrom__func__arg_decl_lines__247__1_1_f_0(((MR_String) (wrapper_arg_1)));
  ...
  MR_Word * Specs_10)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 25, &WarnNonContiguousForeignProcs_12);
    ...
    case (MR_Integer) 0:
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 24, &WarnNonContiguousClauses_13);
  ...
  MR_Box wrapper_arg_1)
{
  ...
  succeeded = check_hlds__typecheck_msgs__IntroducedFrom__pred__construct_type_inference_message__137__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) (wrapper_arg_1)));
  return succeeded;
}
      ...
      if (succeeded)
      {
        ...
        if ((AllOtherDeclaredPredIds_48 == (MR_Word) ((MR_Unsigned) 0U)))
        {
          ...
          }
          {
            ...
            MR_hl_field(3, Spec_19, 1) = (MR_Box) (((((MR_Unsigned) ((MR_Integer) 69) << 1)) | (MR_Unsigned) ((MR_Integer) 1)));
