  ...
  MR_Word * Specs_10)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 29, &WarnNonContiguousForeignProcs_12);
    ...
    case (MR_Integer) 0:
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 28, &WarnNonContiguousClauses_13);
      ...
      if (succeeded)
      {
        ...
        if ((AllOtherDeclaredPredIds_48 == (MR_Word) ((MR_Unsigned) 0U)))
        {
          ...
          }
          {
            ...
            MR_hl_field(3, Spec_19, 1) = (MR_Box) (((((MR_Unsigned) ((MR_Integer) 73) << 1)) | (MR_Unsigned) ((MR_Integer) 1)));
