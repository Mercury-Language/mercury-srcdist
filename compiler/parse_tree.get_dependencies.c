...
{
  {
      ...
      case (MR_Integer) 0:
        {
          ...
          if (!(succeeded))
          {
            ...
            if (!(succeeded))
            {
              succeeded = libs__globals__lookup_bool_option_3_p_1(Globals_5, (MR_Integer) 136, (MR_Integer) 1);
            }
          }
          if (succeeded)
          {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 211, &Deep_16);
    switch (Deep_16) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
    ...
    if (!(succeeded))
    {
      succeeded = libs__globals__lookup_bool_option_3_p_1(Globals_5, (MR_Integer) 229, (MR_Integer) 1);
    }
    if (succeeded)
    {
      MR_Word Var_85;
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 270, &HighLevelCode_18);
    libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 232, &Parallel_19);
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 245, &UseRegions_20);
      ...
      case (MR_Integer) 1:
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 149, &DisableSSDB_22);
