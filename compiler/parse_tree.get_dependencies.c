  ...
  MR_Word * STATE_VARIABLE_ImplicitlyUsedModules_21)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_4, (MR_Integer) 117, &HighLevelCode_16);
    ...
    case (MR_Integer) 1:
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_4, (MR_Integer) 307, &DisableSSDB_20);
