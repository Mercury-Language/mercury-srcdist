  ...
  MR_Word * STATE_VARIABLE_ImplicitlyUsedModules_21)
{
    ...
    case (MR_Integer) 0:
      {
        ...
        if (!(succeeded))
        {
          ...
          if (!(succeeded))
            succeeded = libs__globals__lookup_bool_option_3_p_1(Globals_4, (MR_Integer) 169, (MR_Integer) 1);
        }
        if (succeeded)
        {
          MR_Word Var_38;
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_4, (MR_Integer) 256, &Deep_14);
  switch (Deep_14) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 0:
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_4, (MR_Integer) 320, &HighLevelCode_16);
  libs__globals__lookup_bool_option_3_p_0(Globals_4, (MR_Integer) 277, &Parallel_17);
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_4, (MR_Integer) 289, &UseRegions_18);
    ...
    case (MR_Integer) 1:
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_4, (MR_Integer) 182, &DisableSSDB_20);
