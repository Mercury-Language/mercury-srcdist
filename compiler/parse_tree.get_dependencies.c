...
{
  {
    ...
    *STATE_VARIABLE_ImportDeps_23 = mercury__set__make_singleton_set_1_f_0(TypeCtorInfo_85_85, ((MR_Box) (Var_26)));
      ...
      case (MR_Integer) 0:
        {
          ...
          if (!(succeeded))
          {
            ...
            if (!(succeeded))
            {
              succeeded = libs__globals__lookup_bool_option_3_p_1(Globals_5, (MR_Integer) 135, (MR_Integer) 1);
            }
          }
          if (succeeded)
          {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 208, &Deep_16);
    switch (Deep_16) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
    ...
    if (!(succeeded))
    {
      succeeded = libs__globals__lookup_bool_option_3_p_1(Globals_5, (MR_Integer) 226, (MR_Integer) 1);
    }
    if (succeeded)
    {
      MR_Word Var_73;
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 266, &HighLevelCode_18);
    libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 229, &Parallel_19);
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 242, &UseRegions_20);
      ...
      case (MR_Integer) 1:
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 148, &DisableSSDB_22);
