  ...
  top_of_proc_1:;
    {
      ...
      MR_Word * STATE_VARIABLE_ImplicitImportNeeds_70 = tscc_output_1_STATE_VARIABLE_ImplicitImportNeeds_70;
      MR_bool succeeded;
  ...
  top_of_proc_2:;
    {
      ...
      MR_Word * STATE_VARIABLE_ImplicitImportNeeds_3 = tscc_output_1_STATE_VARIABLE_ImplicitImportNeeds_70;
