  ...
  MR_Word * STATE_VARIABLE_ImplicitlyUsedModules_21)
{
    ...
    case (MR_Integer) 0:
      {
        ...
        if (!(succeeded))
        {
          succeeded = libs__globals__lookup_bool_option_3_p_1(Globals_4, (MR_Integer) 267, (MR_Integer) 1);
          if (!(succeeded))
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_4, (MR_Integer) 242, &Deep_14);
  switch (Deep_14) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 0:
  ...
  if (!(succeeded))
    succeeded = libs__globals__lookup_bool_option_3_p_1(Globals_4, (MR_Integer) 260, (MR_Integer) 1);
  if (succeeded)
  {
    MR_Word Var_63;
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_4, (MR_Integer) 306, &HighLevelCode_16);
  libs__globals__lookup_bool_option_3_p_0(Globals_4, (MR_Integer) 263, &Parallel_17);
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_4, (MR_Integer) 275, &UseRegions_18);
