...
{
  {
      ...
      case (MR_Integer) 0:
        {
          ...
          {
            parse_tree__get_dependencies__succeeded = libs__globals__lookup_bool_option_3_p_1(parse_tree__get_dependencies__Globals_5, (MR_Integer) 229, (MR_Integer) 1);
          }
          if (!(parse_tree__get_dependencies__succeeded))
            {
              {
    ...
    {
      libs__globals__lookup_bool_option_3_p_0(parse_tree__get_dependencies__Globals_5, (MR_Integer) 204, &parse_tree__get_dependencies__Deep_16);
    }
    ...
    {
      libs__globals__lookup_bool_option_3_p_0(parse_tree__get_dependencies__Globals_5, (MR_Integer) 262, &parse_tree__get_dependencies__HighLevelCode_18);
    }
    {
      libs__globals__lookup_bool_option_3_p_0(parse_tree__get_dependencies__Globals_5, (MR_Integer) 225, &parse_tree__get_dependencies__Parallel_19);
    }
    ...
    {
      libs__globals__lookup_bool_option_3_p_0(parse_tree__get_dependencies__Globals_5, (MR_Integer) 238, &parse_tree__get_dependencies__UseRegions_20);
    }
