  ...
  MR_Word * STATE_VARIABLE_ImplicitlyUsedModules_21)
{
    ...
    case (MR_Integer) 0:
      {
        ...
        if (!(succeeded))
        {
          ...
          if (!(succeeded))
            succeeded = libs__globals__lookup_bool_option_3_p_1(Globals_4, (MR_Integer) 186, (MR_Integer) 1);
        }
        if (succeeded)
        {
          MR_Word Var_38;
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_4, (MR_Integer) 273, &Deep_14);
  switch (Deep_14) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 0:
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_4, (MR_Integer) 337, &HighLevelCode_16);
  libs__globals__lookup_bool_option_3_p_0(Globals_4, (MR_Integer) 294, &Parallel_17);
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_4, (MR_Integer) 306, &UseRegions_18);
    ...
    case (MR_Integer) 1:
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_4, (MR_Integer) 199, &DisableSSDB_20);
