  ...
  MR_Word * STATE_VARIABLE_ImplicitlyUsedModules_21)
{
    ...
    case (MR_Integer) 0:
      {
        ...
        succeeded = libs__globals__lookup_bool_option_3_p_1(Globals_4, (MR_Integer) 272, (MR_Integer) 1);
        if (!(succeeded))
        {
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_4, (MR_Integer) 248, &Deep_14);
  switch (Deep_14) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 0:
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_4, (MR_Integer) 312, &HighLevelCode_16);
  libs__globals__lookup_bool_option_3_p_0(Globals_4, (MR_Integer) 269, &Parallel_17);
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_4, (MR_Integer) 281, &UseRegions_18);
