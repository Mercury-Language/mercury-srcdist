...
{
  {
          ...
          if (!(parse_tree__get_dependencies__succeeded))
            {
              ...
              if (!(parse_tree__get_dependencies__succeeded))
                {
                  {
                    parse_tree__get_dependencies__succeeded = libs__globals__lookup_bool_option_3_p_1(parse_tree__get_dependencies__Globals_5, (MR_Integer) 125, (MR_Integer) 1);
                  }
                }
            }
          if (parse_tree__get_dependencies__succeeded)
    ...
    {
      libs__globals__lookup_bool_option_3_p_0(parse_tree__get_dependencies__Globals_5, (MR_Integer) 138, &parse_tree__get_dependencies__DisableSSDB_22);
    }
