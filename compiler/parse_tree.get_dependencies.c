    ...
    case (MR_Integer) 0:
      {
        ...
        if (!(succeeded))
        {
          ...
          if (!(succeeded))
            succeeded = libs__globals__lookup_bool_option_3_p_1(Globals_4, (MR_Integer) 280, (MR_Integer) 1);
        }
        if (succeeded)
        {
          MR_Word Var_38;
    ...
    case (MR_Integer) 1:
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_4, (MR_Integer) 291, &DisableSSDB_20);
