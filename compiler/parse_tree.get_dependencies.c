...
parse_tree__get_dependencies__IntroducedFrom__func__get_fim_specs__1120__1_2_f_0(
  MR_Word ModuleName_17,
  MR_Word LambdaHeadVar__1_34);

static MR_bool MR_CALL 
parse_tree__get_dependencies__IntroducedFrom__pred__compute_implicit_avail_needs__945__1_2_p_0(
  ...
  MR_Box wrapper_arg_1)
{
  ...
  conv8_LambdaHeadVar__2_35 = parse_tree__get_dependencies__IntroducedFrom__func__get_fim_specs__1120__1_2_f_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) (wrapper_arg_1)));
    ...
    switch (MR_tag((MR_Word) Goal_4)) {
      ...
      case (MR_Integer) 0:
        {
          ...
          MR_Word STATE_VARIABLE_ImplicitAvailNeeds_127_127;

          parse_tree__get_dependencies__acc_implicit_avail_needs_in_term_3_p_0(TermA_71, STATE_VARIABLE_ImplicitAvailNeeds_0_73, &STATE_VARIABLE_ImplicitAvailNeeds_127_127);
          parse_tree__get_dependencies__acc_implicit_avail_needs_in_term_3_p_0(TermB_72, STATE_VARIABLE_ImplicitAvailNeeds_127_127, &STATE_VARIABLE_ImplicitAvailNeeds_74);
        }
        break;
      case (MR_Integer) 1:
        {
          ...
          MR_Word STATE_VARIABLE_ImplicitAvailNeeds_109_109;
          ...
          if (succeeded)
          {
            ...
            {
              MR_Word Var_106 = ((MR_Word) ((MR_hl_field(1, ModuleName_66, (MR_Integer) 0))));
              MR_String Var_107;
              MR_String Var_108 = ((MR_String) ((MR_hl_field(1, ModuleName_66, (MR_Integer) 1))));

              succeeded = (strcmp(Var_108, (MR_String) "builder") == 0);
              if (succeeded)
              {
                ...
                if (succeeded)
                {
                  ...
                  succeeded = (strcmp(Var_107, (MR_String) "string") == 0);
                }
              }
            }
            else
            {
              MR_String Var_228 = ((MR_String) ((MR_hl_field(0, ModuleName_66, (MR_Integer) 0))));

              if ((strcmp(Var_228, (MR_String) "io") == 0))
                succeeded = MR_TRUE;
              else
              if ((strcmp(Var_228, (MR_String) "string") == 0))
                succeeded = MR_TRUE;
              else
              if ((strcmp(Var_228, (MR_String) "builder") == 0))
                succeeded = MR_TRUE;
              else
                succeeded = MR_FALSE;
            }
            if (succeeded)
            {
              ...
              {
                STATE_VARIABLE_ImplicitAvailNeeds_109_109 = (MR_Word) MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL);
                MR_hl_field(0, STATE_VARIABLE_ImplicitAvailNeeds_109_109, 0) = (MR_Box) ((((packed_word_2 & (~((MR_Unsigned) 4U)))) | (((MR_Unsigned) ((MR_Integer) 1) << 2))));
              }
            }
            else
            {
              if (((MR_tag((MR_Word) ModuleName_66)) == (MR_Integer) 1))
              {
                MR_Word Var_113 = ((MR_Word) ((MR_hl_field(1, ModuleName_66, (MR_Integer) 0))));
                MR_String Var_114;
                MR_String Var_115 = ((MR_String) ((MR_hl_field(1, ModuleName_66, (MR_Integer) 1))));

                succeeded = (strcmp(Var_115, (MR_String) "string_writer") == 0);
                if (succeeded)
                {
                  succeeded = ((MR_tag((MR_Word) Var_113)) == (MR_Integer) 0);
                  if (succeeded)
                  {
                    Var_114 = ((MR_String) ((MR_hl_field(0, Var_113, (MR_Integer) 0))));
                    succeeded = (strcmp(Var_114, (MR_String) "stream") == 0);
                  }
                }
              }
              else
              {
                MR_String Var_229 = ((MR_String) ((MR_hl_field(0, ModuleName_66, (MR_Integer) 0))));

                if ((strcmp(Var_229, (MR_String) "stream") == 0))
                  succeeded = MR_TRUE;
                else
                if ((strcmp(Var_229, (MR_String) "string_writer") == 0))
                  succeeded = MR_TRUE;
                else
                  succeeded = MR_FALSE;
              }
              if (succeeded)
              {
                ...
                {
                  STATE_VARIABLE_ImplicitAvailNeeds_109_109 = (MR_Word) MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL);
                  MR_hl_field(0, STATE_VARIABLE_ImplicitAvailNeeds_109_109, 0) = (MR_Box) ((((packed_word_3 & (~((MR_Unsigned) 6U)))) | (((((MR_Unsigned) ((MR_Integer) 1) << 1)) | (((MR_Unsigned) ((MR_Integer) 1) << 2))))));
                }
              }
              else
                STATE_VARIABLE_ImplicitAvailNeeds_109_109 = STATE_VARIABLE_ImplicitAvailNeeds_0_73;
            }
          }
          else
          {
            ...
            if (succeeded)
            {
              Var_120 = ((MR_String) ((MR_hl_field(0, CalleeSymName_64, (MR_Integer) 0))));
              succeeded = (strcmp(Var_120, (MR_String) "format") == 0);
            }
            if (succeeded)
            {
              ...
              {
                STATE_VARIABLE_ImplicitAvailNeeds_109_109 = (MR_Word) MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL);
                MR_hl_field(0, STATE_VARIABLE_ImplicitAvailNeeds_109_109, 0) = (MR_Box) ((((packed_word_4 & (~((MR_Unsigned) 6U)))) | (((((MR_Unsigned) ((MR_Integer) 1) << 1)) | (((MR_Unsigned) ((MR_Integer) 1) << 2))))));
              }
            }
            else
              STATE_VARIABLE_ImplicitAvailNeeds_109_109 = STATE_VARIABLE_ImplicitAvailNeeds_0_73;
          }
          parse_tree__get_dependencies__acc_implicit_avail_needs_in_terms_3_p_0(Args_65, STATE_VARIABLE_ImplicitAvailNeeds_109_109, &STATE_VARIABLE_ImplicitAvailNeeds_74);
        }
        break;
      case (MR_Integer) 2:
        {
      ...
      case (MR_Integer) 3:
        switch (((MR_Integer) ((MR_hl_field(3, Goal_4, (MR_Integer) 0))))) {
          ...
          case (MR_Integer) 1:
            {
              ...
              MR_Word Then_146 = ((MR_Word) ((MR_hl_field(3, Goal_4, (MR_Integer) 5))));
              ...
              parse_tree__get_dependencies__acc_implicit_avail_needs_in_goal_3_p_0(Then_146, STATE_VARIABLE_ImplicitAvailNeeds_93_93, &STATE_VARIABLE_ImplicitAvailNeeds_94_94);
          ...
          case (MR_Integer) 3:
            {
              MR_Word SubGoal_216 = ((MR_Word) ((MR_hl_field(3, Goal_4, (MR_Integer) 2))));
          ...
          case (MR_Integer) 5:
            {
              MR_Word SubGoalA_217 = ((MR_Word) ((MR_hl_field(3, Goal_4, (MR_Integer) 2))));
              MR_Word SubGoalsB_218 = ((MR_Word) ((MR_hl_field(3, Goal_4, (MR_Integer) 3))));
              MR_Word STATE_VARIABLE_ImplicitAvailNeeds_75_219;

              parse_tree__get_dependencies__acc_implicit_avail_needs_in_goal_3_p_0(SubGoalA_217, STATE_VARIABLE_ImplicitAvailNeeds_0_73, &STATE_VARIABLE_ImplicitAvailNeeds_75_219);
              parse_tree__get_dependencies__acc_implicit_avail_needs_in_goals_3_p_0(SubGoalsB_218, STATE_VARIABLE_ImplicitAvailNeeds_75_219, &STATE_VARIABLE_ImplicitAvailNeeds_74);
            }
            break;
          case (MR_Integer) 6:
            {
              MR_Word SubGoal_224 = ((MR_Word) ((MR_hl_field(3, Goal_4, (MR_Integer) 4))));
          ...
          case (MR_Integer) 7:
            {
              MR_Word SubGoal_223 = ((MR_Word) ((MR_hl_field(3, Goal_4, (MR_Integer) 3))));
          ...
          case (MR_Integer) 8:
            {
              MR_Word SubGoal_222 = ((MR_Word) ((MR_hl_field(3, Goal_4, (MR_Integer) 6))));
          ...
          case (MR_Integer) 9:
            {
              MR_Word SubGoal_221 = ((MR_Word) ((MR_hl_field(3, Goal_4, (MR_Integer) 6))));
          ...
          case (MR_Integer) 10:
            {
              MR_Word SubGoal_220 = ((MR_Word) ((MR_hl_field(3, Goal_4, (MR_Integer) 6))));
          ...
          case (MR_Integer) 11:
            {
              MR_Word SubGoal_226 = ((MR_Word) ((MR_hl_field(3, Goal_4, (MR_Integer) 3))));
              MR_Word next_value_of_tscc_proc_1_input_1_Goal_4 = SubGoal_226;
              MR_Word next_value_of_tscc_proc_1_input_2_STATE_VARIABLE_ImplicitAvailNeeds_0_73 = STATE_VARIABLE_ImplicitAvailNeeds_0_73;
          ...
          case (MR_Integer) 12:
            {
              MR_Word SubGoal_225 = ((MR_Word) ((MR_hl_field(3, Goal_4, (MR_Integer) 3))));
              MR_Word next_value_of_tscc_proc_1_input_1_Goal_4 = SubGoal_225;
              MR_Word next_value_of_tscc_proc_1_input_2_STATE_VARIABLE_ImplicitAvailNeeds_0_73 = STATE_VARIABLE_ImplicitAvailNeeds_0_73;
          ...
          case (MR_Integer) 13:
            {
              MR_Word SubGoal_227 = ((MR_Word) ((MR_hl_field(3, Goal_4, (MR_Integer) 4))));
              MR_Word next_value_of_tscc_proc_1_input_1_Goal_4 = SubGoal_227;
              MR_Word next_value_of_tscc_proc_1_input_2_STATE_VARIABLE_ImplicitAvailNeeds_0_73 = STATE_VARIABLE_ImplicitAvailNeeds_0_73;
          ...
          case (MR_Integer) 15:
            {
              ...
              MR_Word SubGoal_140 = ((MR_Word) ((MR_hl_field(3, Goal_4, (MR_Integer) 6))));
              MR_Word next_value_of_tscc_proc_1_input_1_Goal_4;
              MR_Word next_value_of_tscc_proc_1_input_2_STATE_VARIABLE_ImplicitAvailNeeds_0_73;
              ...
              // direct tailcall eliminated
              ;
              next_value_of_tscc_proc_1_input_1_Goal_4 = SubGoal_140;
          ...
          case (MR_Integer) 17:
            {
              ...
              MR_Word SubGoal_141 = ((MR_Word) ((MR_hl_field(3, Goal_4, (MR_Integer) 3))));
              ...
              parse_tree__get_dependencies__acc_implicit_avail_needs_in_goal_3_p_0(SubGoal_141, STATE_VARIABLE_ImplicitAvailNeeds_86_86, &STATE_VARIABLE_ImplicitAvailNeeds_88_88);
          ...
          case (MR_Integer) 18:
            {
              MR_Word SubGoalB_213 = ((MR_Word) ((MR_hl_field(3, Goal_4, (MR_Integer) 3))));
              MR_Word STATE_VARIABLE_ImplicitAvailNeeds_77_214;
              MR_Word SubGoalA_215 = ((MR_Word) ((MR_hl_field(3, Goal_4, (MR_Integer) 2))));
              MR_Word next_value_of_tscc_proc_1_input_1_Goal_4;
              MR_Word next_value_of_tscc_proc_1_input_2_STATE_VARIABLE_ImplicitAvailNeeds_0_73;

              parse_tree__get_dependencies__acc_implicit_avail_needs_in_goal_3_p_0(SubGoalA_215, STATE_VARIABLE_ImplicitAvailNeeds_0_73, &STATE_VARIABLE_ImplicitAvailNeeds_77_214);
              // direct tailcall eliminated
              ;
              next_value_of_tscc_proc_1_input_1_Goal_4 = SubGoalB_213;
              next_value_of_tscc_proc_1_input_2_STATE_VARIABLE_ImplicitAvailNeeds_0_73 = STATE_VARIABLE_ImplicitAvailNeeds_77_214;
              tscc_proc_1_input_1_Goal_4 = next_value_of_tscc_proc_1_input_1_Goal_4;
              tscc_proc_1_input_2_STATE_VARIABLE_ImplicitAvailNeeds_0_73 = next_value_of_tscc_proc_1_input_2_STATE_VARIABLE_ImplicitAvailNeeds_0_73;
              goto top_of_proc_1;
            }
          ...
          case (MR_Integer) 19:
            {
              ...
              MR_Word SubGoalA_129 = ((MR_Word) ((MR_hl_field(3, Goal_4, (MR_Integer) 2))));
              MR_Word next_value_of_tscc_proc_1_input_1_Goal_4;
              MR_Word next_value_of_tscc_proc_1_input_2_STATE_VARIABLE_ImplicitAvailNeeds_0_73;

              parse_tree__get_dependencies__acc_implicit_avail_needs_in_goal_3_p_0(SubGoalA_129, STATE_VARIABLE_ImplicitAvailNeeds_0_73, &STATE_VARIABLE_ImplicitAvailNeeds_77_77);
              // direct tailcall eliminated
              ;
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = parse_tree__get_dependencies__IntroducedFrom__pred__compute_implicit_avail_needs__945__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 4)))));
  return succeeded;
}
  ...
  MR_Word * STATE_VARIABLE_ImplicitlyUsedModules_21)
{
    ...
    case (MR_Integer) 0:
      {
        ...
        succeeded = libs__globals__lookup_bool_option_3_p_1(Globals_4, (MR_Integer) 273, (MR_Integer) 1);
        if (!(succeeded))
        {
          succeeded = libs__globals__lookup_bool_option_3_p_1(Globals_4, (MR_Integer) 274, (MR_Integer) 1);
          if (!(succeeded))
            succeeded = libs__globals__lookup_bool_option_3_p_1(Globals_4, (MR_Integer) 161, (MR_Integer) 1);
        }
        if (succeeded)
        {
          MR_Word Var_38;
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_4, (MR_Integer) 249, &Deep_14);
  switch (Deep_14) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 0:
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_4, (MR_Integer) 313, &HighLevelCode_16);
  libs__globals__lookup_bool_option_3_p_0(Globals_4, (MR_Integer) 270, &Parallel_17);
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_4, (MR_Integer) 282, &UseRegions_18);
    ...
    case (MR_Integer) 1:
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_4, (MR_Integer) 174, &DisableSSDB_20);
