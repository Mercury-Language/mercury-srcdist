...
{
  {
      ...
      case (MR_Integer) 0:
        {
          ...
          if (!(succeeded))
          {
            ...
            if (!(succeeded))
              succeeded = libs__globals__lookup_bool_option_3_p_1(Globals_4, (MR_Integer) 150, (MR_Integer) 1);
          }
          if (succeeded)
          {
            MR_Word Var_34;
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_4, (MR_Integer) 235, &Deep_14);
    switch (Deep_14) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
    ...
    if (!(succeeded))
      succeeded = libs__globals__lookup_bool_option_3_p_1(Globals_4, (MR_Integer) 253, (MR_Integer) 1);
    if (succeeded)
    {
      MR_Word Var_63;
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_4, (MR_Integer) 300, &HighLevelCode_16);
    libs__globals__lookup_bool_option_3_p_0(Globals_4, (MR_Integer) 256, &Parallel_17);
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_4, (MR_Integer) 269, &UseRegions_18);
      ...
      case (MR_Integer) 1:
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_4, (MR_Integer) 163, &DisableSSDB_20);
