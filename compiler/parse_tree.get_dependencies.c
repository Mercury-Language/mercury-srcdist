...
{
  {
      ...
      case (MR_Integer) 0:
        {
          ...
          if (!(succeeded))
          {
            ...
            if (!(succeeded))
              succeeded = libs__globals__lookup_bool_option_3_p_1(Globals_4, (MR_Integer) 153, (MR_Integer) 1);
          }
          if (succeeded)
          {
            MR_Word Var_34;
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_4, (MR_Integer) 303, &HighLevelCode_16);
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_4, (MR_Integer) 272, &UseRegions_18);
      ...
      case (MR_Integer) 1:
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_4, (MR_Integer) 166, &DisableSSDB_20);
