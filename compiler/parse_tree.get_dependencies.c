        ...
        case (MR_Integer) 0:
          {
            ...
            label_0:;
              ...
              else
              {
                ...
                parse_tree__get_dependencies__str_5 = ((&parse_tree__get_dependencies_vector_common_4[4 + parse_tree__get_dependencies__slot_4]))->parse_tree__get_dependencies__vector_common_type_4_0__vct_4_f_0;
                /* did we find a match? */
