...
{
  {
...

    {
      ...
      MR_hl_field(MR_mktag(0), parse_tree__get_dependencies__Var_5, 0) = ((MR_Box) (&parse_tree__get_dependencies_scalar_common_8[0]));
        ...
        case (MR_Integer) 0:
          {
            ...
            {
              MR_Integer parse_tree__get_dependencies__lo_0 = (MR_Integer) 0;
              MR_Integer parse_tree__get_dependencies__hi_1 = (MR_Integer) 3;
              ...
              do
              {
                ...
                parse_tree__get_dependencies__result_3 = MR_strcmp(parse_tree__get_dependencies__Atom_10, ((&parse_tree__get_dependencies_vector_common_4[0 + parse_tree__get_dependencies__mid_2]))->parse_tree__get_dependencies__vector_common_type_4_0__vct_4_f_0);
            ...
            label_0:;
              ...
              {
                MR_Integer parse_tree__get_dependencies__slot_4 = ((MR_hash_string5(parse_tree__get_dependencies__Atom_10)) & (MR_Integer) 31);
                MR_String parse_tree__get_dependencies__str_5 = ((&parse_tree__get_dependencies_vector_common_4[4 + parse_tree__get_dependencies__slot_4]))->parse_tree__get_dependencies__vector_common_type_4_0__vct_4_f_0;
...
{
  {
    ...
    *parse_tree__get_dependencies__STATE_VARIABLE_ImportDeps_23 = mercury__set__make_singleton_set_1_f_0(parse_tree__get_dependencies__TypeCtorInfo_85_85, ((MR_Box) (parse_tree__get_dependencies__Var_26)));
      ...
      case (MR_Integer) 0:
        {
...

          {
            ...
            MR_hl_field(MR_mktag(0), parse_tree__get_dependencies__Var_29, 0) = ((MR_Box) (&parse_tree__get_dependencies_scalar_common_3[0]));
          ...
          if (!(parse_tree__get_dependencies__succeeded))
          {
            parse_tree__get_dependencies__succeeded = libs__globals__lookup_bool_option_3_p_1(parse_tree__get_dependencies__Globals_5, (MR_Integer) 232, (MR_Integer) 1);
            if (!(parse_tree__get_dependencies__succeeded))
            {
    ...
    libs__globals__lookup_bool_option_3_p_0(parse_tree__get_dependencies__Globals_5, (MR_Integer) 206, &parse_tree__get_dependencies__Deep_16);
    ...
    if (!(parse_tree__get_dependencies__succeeded))
    {
      parse_tree__get_dependencies__succeeded = libs__globals__lookup_bool_option_3_p_1(parse_tree__get_dependencies__Globals_5, (MR_Integer) 224, (MR_Integer) 1);
    }
    if (parse_tree__get_dependencies__succeeded)
    {
    ...
    libs__globals__lookup_bool_option_3_p_0(parse_tree__get_dependencies__Globals_5, (MR_Integer) 264, &parse_tree__get_dependencies__HighLevelCode_18);
    libs__globals__lookup_bool_option_3_p_0(parse_tree__get_dependencies__Globals_5, (MR_Integer) 227, &parse_tree__get_dependencies__Parallel_19);
    ...
    libs__globals__lookup_bool_option_3_p_0(parse_tree__get_dependencies__Globals_5, (MR_Integer) 240, &parse_tree__get_dependencies__UseRegions_20);
