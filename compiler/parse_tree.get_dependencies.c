...
{
  {
      ...
      case (MR_Integer) 0:
        {
          ...
          succeeded = libs__globals__lookup_bool_option_3_p_1(Globals_4, (MR_Integer) 247, (MR_Integer) 1);
          if (!(succeeded))
          {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_4, (MR_Integer) 222, &Deep_14);
    switch (Deep_14) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
    ...
    succeeded = libs__globals__lookup_bool_option_3_p_1(Globals_4, (MR_Integer) 239, (MR_Integer) 1);
    if (!(succeeded))
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_4, (MR_Integer) 287, &HighLevelCode_16);
    libs__globals__lookup_bool_option_3_p_0(Globals_4, (MR_Integer) 243, &Parallel_17);
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_4, (MR_Integer) 256, &UseRegions_18);
