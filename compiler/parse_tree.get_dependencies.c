  ...
  MR_Word * STATE_VARIABLE_ImplicitlyUsedModules_21)
{
    ...
    case (MR_Integer) 0:
      {
        ...
        succeeded = libs__globals__lookup_bool_option_3_p_1(Globals_4, (MR_Integer) 87, (MR_Integer) 1);
        if (!(succeeded))
        {
          succeeded = libs__globals__lookup_bool_option_3_p_1(Globals_4, (MR_Integer) 88, (MR_Integer) 1);
          if (!(succeeded))
            succeeded = libs__globals__lookup_bool_option_3_p_1(Globals_4, (MR_Integer) 299, (MR_Integer) 1);
        }
        if (succeeded)
        {
          MR_Word Var_38;
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_4, (MR_Integer) 60, &Deep_14);
  switch (Deep_14) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 0:
  ...
  succeeded = libs__globals__lookup_bool_option_3_p_1(Globals_4, (MR_Integer) 76, (MR_Integer) 1);
  if (!(succeeded))
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_4, (MR_Integer) 120, &HighLevelCode_16);
  libs__globals__lookup_bool_option_3_p_0(Globals_4, (MR_Integer) 85, &Parallel_17);
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_4, (MR_Integer) 90, &UseRegions_18);
    ...
    case (MR_Integer) 1:
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_4, (MR_Integer) 309, &DisableSSDB_20);
