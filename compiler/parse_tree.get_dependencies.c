...
{
  {
      ...
      case (MR_Integer) 0:
        {
          ...
          if (!(succeeded))
          {
            ...
            if (!(succeeded))
              succeeded = libs__globals__lookup_bool_option_3_p_1(Globals_4, (MR_Integer) 146, (MR_Integer) 1);
          }
          if (succeeded)
          {
            MR_Word Var_34;
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_4, (MR_Integer) 231, &Deep_14);
    switch (Deep_14) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_4, (MR_Integer) 296, &HighLevelCode_16);
    libs__globals__lookup_bool_option_3_p_0(Globals_4, (MR_Integer) 252, &Parallel_17);
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_4, (MR_Integer) 265, &UseRegions_18);
      ...
      case (MR_Integer) 1:
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_4, (MR_Integer) 159, &DisableSSDB_20);
