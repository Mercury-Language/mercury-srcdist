            ...
            case (MR_Integer) 4:
              {
                ...
                parse_tree__get_dependencies__gather_implicit_import_needs_in_goal_3_p_0(Goal_57, STATE_VARIABLE_ImplicitImportNeeds_0_2, &STATE_VARIABLE_ImplicitImportNeeds_109_109);
              }
              break;
            case (MR_Integer) 5:
              STATE_VARIABLE_ImplicitImportNeeds_109_109 = STATE_VARIABLE_ImplicitImportNeeds_0_2;
            ...
            case (MR_Integer) 9:
              {
                ...
                parse_tree__get_dependencies__gather_implicit_import_needs_in_mutable_3_p_0(ItemMutableInfo_68, STATE_VARIABLE_ImplicitImportNeeds_0_2, &STATE_VARIABLE_ImplicitImportNeeds_109_109);
              }
              break;
            case (MR_Integer) 10:
              STATE_VARIABLE_ImplicitImportNeeds_109_109 = STATE_VARIABLE_ImplicitImportNeeds_0_2;
