...
{
  {
    ...
    *STATE_VARIABLE_ImplicitlyImportedModules_23 = mercury__set__make_singleton_set_1_f_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), ((MR_Box) (Var_26)));
      ...
      case (MR_Integer) 0:
        {
          ...
          if (!(succeeded))
          {
            succeeded = libs__globals__lookup_bool_option_3_p_1(Globals_5, (MR_Integer) 249, (MR_Integer) 1);
            if (!(succeeded))
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 223, &Deep_16);
    switch (Deep_16) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 244, &Parallel_19);
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 257, &UseRegions_20);
