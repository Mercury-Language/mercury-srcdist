  ...
  MR_Word * STATE_VARIABLE_ImplicitlyUsedModules_21)
{
    ...
    case (MR_Integer) 0:
      {
        ...
        if (!(succeeded))
        {
          ...
          if (!(succeeded))
            succeeded = libs__globals__lookup_bool_option_3_p_1(Globals_4, (MR_Integer) 173, (MR_Integer) 1);
        }
        if (succeeded)
        {
          MR_Word Var_38;
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_4, (MR_Integer) 260, &Deep_14);
  switch (Deep_14) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 0:
  ...
  succeeded = libs__globals__lookup_bool_option_3_p_1(Globals_4, (MR_Integer) 277, (MR_Integer) 1);
  if (!(succeeded))
    succeeded = libs__globals__lookup_bool_option_3_p_1(Globals_4, (MR_Integer) 278, (MR_Integer) 1);
  if (succeeded)
  {
    MR_Word Var_63;
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_4, (MR_Integer) 324, &HighLevelCode_16);
  libs__globals__lookup_bool_option_3_p_0(Globals_4, (MR_Integer) 281, &Parallel_17);
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_4, (MR_Integer) 293, &UseRegions_18);
    ...
    case (MR_Integer) 1:
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_4, (MR_Integer) 186, &DisableSSDB_20);
