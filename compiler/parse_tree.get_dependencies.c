    ...
    switch (MR_tag((MR_Word) Goal_4)) {
      ...
      case (MR_Integer) 1:
        {
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              Var_225 = ((MR_String) ((MR_hl_field(MR_mktag(0), ModuleName_66, (MR_Integer) 0))));
              if ((strcmp(Var_225, (MR_String) "io") == 0))
                succeeded = MR_TRUE;
              else
              if ((strcmp(Var_225, (MR_String) "string") == 0))
                succeeded = MR_TRUE;
              else
                succeeded = MR_FALSE;
            }
            ...
            else
            {
              ...
              {
                MR_String Var_226 = ((MR_String) ((MR_hl_field(MR_mktag(0), ModuleName_66, (MR_Integer) 0))));

                if ((strcmp(Var_226, (MR_String) "stream") == 0))
                  succeeded = MR_TRUE;
                else
                if ((strcmp(Var_226, (MR_String) "string_writer") == 0))
                  succeeded = MR_TRUE;
                else
                  succeeded = MR_FALSE;
              }
      ...
      case (MR_Integer) 3:
        switch (((MR_Integer) ((MR_hl_field(MR_mktag(3), Goal_4, (MR_Integer) 0))))) {
          ...
          case (MR_Integer) 3:
            {
              MR_Word SubGoal_213 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Goal_4, (MR_Integer) 2))));
          ...
          case (MR_Integer) 5:
            {
              MR_Word SubGoalA_214 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Goal_4, (MR_Integer) 2))));
              MR_Word SubGoalsB_215 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Goal_4, (MR_Integer) 3))));
              MR_Word STATE_VARIABLE_ImplicitAvailNeeds_75_216;

              parse_tree__get_dependencies__acc_implicit_avail_needs_in_goal_3_p_0(SubGoalA_214, STATE_VARIABLE_ImplicitAvailNeeds_0_73, &STATE_VARIABLE_ImplicitAvailNeeds_75_216);
              parse_tree__get_dependencies__acc_implicit_avail_needs_in_goals_3_p_0(SubGoalsB_215, STATE_VARIABLE_ImplicitAvailNeeds_75_216, &STATE_VARIABLE_ImplicitAvailNeeds_74);
            }
            break;
          case (MR_Integer) 6:
            {
              MR_Word SubGoal_221 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Goal_4, (MR_Integer) 4))));
          ...
          case (MR_Integer) 8:
            {
              MR_Word SubGoal_219 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Goal_4, (MR_Integer) 6))));
          ...
          case (MR_Integer) 11:
            {
              MR_Word SubGoal_223 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Goal_4, (MR_Integer) 3))));
          ...
          case (MR_Integer) 13:
            {
              MR_Word SubGoal_224 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Goal_4, (MR_Integer) 4))));
              MR_Word next_value_of_tscc_proc_1_input_1_Goal_4 = SubGoal_224;
              MR_Word next_value_of_tscc_proc_1_input_2_STATE_VARIABLE_ImplicitAvailNeeds_0_73 = STATE_VARIABLE_ImplicitAvailNeeds_0_73;
          ...
          case (MR_Integer) 18:
            {
              ...
              MR_Word STATE_VARIABLE_ImplicitAvailNeeds_77_211;
              MR_Word SubGoalA_212 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Goal_4, (MR_Integer) 2))));
              MR_Word next_value_of_tscc_proc_1_input_1_Goal_4;
              MR_Word next_value_of_tscc_proc_1_input_2_STATE_VARIABLE_ImplicitAvailNeeds_0_73;

              parse_tree__get_dependencies__acc_implicit_avail_needs_in_goal_3_p_0(SubGoalA_212, STATE_VARIABLE_ImplicitAvailNeeds_0_73, &STATE_VARIABLE_ImplicitAvailNeeds_77_211);
              // direct tailcall eliminated
              ;
              next_value_of_tscc_proc_1_input_1_Goal_4 = SubGoalB_210;
              next_value_of_tscc_proc_1_input_2_STATE_VARIABLE_ImplicitAvailNeeds_0_73 = STATE_VARIABLE_ImplicitAvailNeeds_77_211;
              tscc_proc_1_input_1_Goal_4 = next_value_of_tscc_proc_1_input_1_Goal_4;
              tscc_proc_1_input_2_STATE_VARIABLE_ImplicitAvailNeeds_0_73 = next_value_of_tscc_proc_1_input_2_STATE_VARIABLE_ImplicitAvailNeeds_0_73;
              goto top_of_proc_1;
            }
