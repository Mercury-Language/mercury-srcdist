...
{
  {
    ...
    *STATE_VARIABLE_ImplicitlyImportedModules_23 = mercury__set__make_singleton_set_1_f_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), ((MR_Box) (Var_26)));
      ...
      case (MR_Integer) 0:
        {
          ...
          if (!(succeeded))
          {
            succeeded = libs__globals__lookup_bool_option_3_p_1(Globals_5, (MR_Integer) 248, (MR_Integer) 1);
            if (!(succeeded))
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 222, &Deep_16);
    switch (Deep_16) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
    ...
    if (!(succeeded))
      succeeded = libs__globals__lookup_bool_option_3_p_1(Globals_5, (MR_Integer) 240, (MR_Integer) 1);
    if (succeeded)
    {
      MR_Word Var_68;
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 287, &HighLevelCode_18);
    libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 243, &Parallel_19);
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 256, &UseRegions_20);
