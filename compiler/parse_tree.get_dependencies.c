...
{
  {
      ...
      case (MR_Integer) 0:
        {
          ...
          {
            parse_tree__get_dependencies__succeeded = libs__globals__lookup_bool_option_3_p_1(parse_tree__get_dependencies__Globals_5, (MR_Integer) 227, (MR_Integer) 1);
          }
          if (!(parse_tree__get_dependencies__succeeded))
            {
              {
                parse_tree__get_dependencies__succeeded = libs__globals__lookup_bool_option_3_p_1(parse_tree__get_dependencies__Globals_5, (MR_Integer) 228, (MR_Integer) 1);
              }
              if (!(parse_tree__get_dependencies__succeeded))
                {
                  {
                    parse_tree__get_dependencies__succeeded = libs__globals__lookup_bool_option_3_p_1(parse_tree__get_dependencies__Globals_5, (MR_Integer) 131, (MR_Integer) 1);
                  }
                }
            }
          if (parse_tree__get_dependencies__succeeded)
    ...
    {
      libs__globals__lookup_bool_option_3_p_0(parse_tree__get_dependencies__Globals_5, (MR_Integer) 202, &parse_tree__get_dependencies__Deep_16);
    }
    ...
    {
      libs__globals__lookup_bool_option_3_p_0(parse_tree__get_dependencies__Globals_5, (MR_Integer) 260, &parse_tree__get_dependencies__HighLevelCode_18);
    }
    {
      libs__globals__lookup_bool_option_3_p_0(parse_tree__get_dependencies__Globals_5, (MR_Integer) 223, &parse_tree__get_dependencies__Parallel_19);
    }
    ...
    {
      libs__globals__lookup_bool_option_3_p_0(parse_tree__get_dependencies__Globals_5, (MR_Integer) 236, &parse_tree__get_dependencies__UseRegions_20);
    }
    ...
    {
      libs__globals__lookup_bool_option_3_p_0(parse_tree__get_dependencies__Globals_5, (MR_Integer) 144, &parse_tree__get_dependencies__DisableSSDB_22);
    }
