    ...
    case (MR_Integer) 2:
      {
        ...
        if (succeeded)
        {
...

          {
            ...
            MR_hl_field(MR_mktag(0), Var_72, 0) = ((MR_Box) (&backend_libs__pseudo_type_info_scalar_common_3[0]));
            MR_hl_field(MR_mktag(0), Var_72, 1) = ((MR_Box) (backend_libs__pseudo_type_info__construct_pseudo_type_info_4_p_0_1));
            MR_hl_field(MR_mktag(0), Var_72, 2) = ((MR_Box) ((MR_Integer) 2));
            MR_hl_field(MR_mktag(0), Var_72, 3) = ((MR_Box) (NumUnivQTvars_6));
            MR_hl_field(MR_mktag(0), Var_72, 4) = ((MR_Box) (ExistQTvars_7));
          }
        ...
        else
        {
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(0), Var_75, 0) = ((MR_Box) (&backend_libs__pseudo_type_info_scalar_common_3[0]));
            MR_hl_field(MR_mktag(0), Var_75, 1) = ((MR_Box) (backend_libs__pseudo_type_info__construct_pseudo_type_info_4_p_0_3));
            MR_hl_field(MR_mktag(0), Var_75, 2) = ((MR_Box) ((MR_Integer) 2));
            MR_hl_field(MR_mktag(0), Var_75, 3) = ((MR_Box) (NumUnivQTvars_6));
            MR_hl_field(MR_mktag(0), Var_75, 4) = ((MR_Box) (ExistQTvars_7));
          }
