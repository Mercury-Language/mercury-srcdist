  ...
  MR_Integer HeadVar__2_30)
{
  ...
  mercury__list__length_2_p_0((MR_Word) (&backend_libs__rtti__backend_libs__rtti__type_ctor_info_rtti_type_info_0), TypeInfoArgs_27, &NumPseudoArgs_33);
  succeeded = (NumPseudoArgs_33 == HeadVar__2_30);
  return succeeded;
}
  ...
  MR_Integer HeadVar__3_30)
{
  ...
  switch (VarArityId_7) {
    ...
    case (MR_Integer) 1:
      {
        MR_Integer Var_35 = (MR_Integer) ((MR_Unsigned) NumPseudoArgs_34 - (MR_Unsigned) HeadVar__3_30);
    ...
    case (MR_Integer) 0:
    case (MR_Integer) 2:
      succeeded = (NumPseudoArgs_34 == HeadVar__3_30);
      break;
  }
  return succeeded;
}
  ...
  MR_Integer HeadVar__2_65)
{
  ...
  mercury__list__length_2_p_0((MR_Word) (&backend_libs__rtti__backend_libs__rtti__type_ctor_info_rtti_maybe_pseudo_type_info_0), PseudoArgs_60, &NumPseudoArgs_68);
  succeeded = (NumPseudoArgs_68 == HeadVar__2_65);
  return succeeded;
}
  ...
  MR_Integer HeadVar__3_65)
{
  ...
  switch (VarArityId_27) {
    ...
    case (MR_Integer) 1:
      {
        MR_Integer Var_70 = (MR_Integer) ((MR_Unsigned) NumPseudoArgs_69 - (MR_Unsigned) HeadVar__3_65);
    ...
    case (MR_Integer) 0:
    case (MR_Integer) 2:
      succeeded = (NumPseudoArgs_69 == HeadVar__3_65);
      break;
  }
  return succeeded;
}
    ...
    case (MR_Integer) 0:
      {
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(0), Var_56, 0) = ((MR_Box) (&backend_libs__pseudo_type_info_scalar_common_5[1]));
          MR_hl_field(MR_mktag(0), Var_56, 1) = ((MR_Box) (backend_libs__pseudo_type_info__construct_pseudo_type_info_4_p_0_5));
          MR_hl_field(MR_mktag(0), Var_56, 2) = ((MR_Box) ((MR_Integer) 2));
          MR_hl_field(MR_mktag(0), Var_56, 3) = ((MR_Box) (VarInt_41));
          MR_hl_field(MR_mktag(0), Var_56, 4) = ((MR_Box) ((MR_Integer) 1024));
        }
    ...
    case (MR_Integer) 2:
      {
        ...
        if (succeeded)
        {
          ...
          mercury__list__map_3_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0), (MR_Word) (&backend_libs__rtti__backend_libs__rtti__type_ctor_info_rtti_maybe_pseudo_type_info_0), Var_78, TypeArgs_26, &PseudoArgs_30);
          {
            ...
            MR_hl_field(MR_mktag(0), Var_43, 0) = ((MR_Box) (&backend_libs__pseudo_type_info_scalar_common_4[0]));
            MR_hl_field(MR_mktag(0), Var_43, 1) = ((MR_Box) (backend_libs__pseudo_type_info__construct_pseudo_type_info_4_p_0_2));
            MR_hl_field(MR_mktag(0), Var_43, 2) = ((MR_Box) ((MR_Integer) 3));
            MR_hl_field(MR_mktag(0), Var_43, 3) = ((MR_Box) (VarArityId_27));
            MR_hl_field(MR_mktag(0), Var_43, 4) = ((MR_Box) (PseudoArgs_30));
            MR_hl_field(MR_mktag(0), Var_43, 5) = ((MR_Box) (Var_65));
          }
        ...
        else
        {
          ...
          Var_48 = mercury__uint16__det_from_int_1_f_0(Var_65);
          {
            ...
            MR_hl_field(MR_mktag(0), RttiTypeCtor_35, 2) = ((MR_Box) (MR_Word) (Var_48));
          }
          {
          ...
          mercury__list__map_3_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0), (MR_Word) (&backend_libs__rtti__backend_libs__rtti__type_ctor_info_rtti_maybe_pseudo_type_info_0), Var_87, TypeArgs_26, &PseudoArgs_60);
          {
            ...
            MR_hl_field(MR_mktag(0), Var_49, 0) = ((MR_Box) (&backend_libs__pseudo_type_info_scalar_common_5[0]));
            MR_hl_field(MR_mktag(0), Var_49, 1) = ((MR_Box) (backend_libs__pseudo_type_info__construct_pseudo_type_info_4_p_0_4));
            MR_hl_field(MR_mktag(0), Var_49, 2) = ((MR_Box) ((MR_Integer) 2));
            MR_hl_field(MR_mktag(0), Var_49, 3) = ((MR_Box) (PseudoArgs_60));
            MR_hl_field(MR_mktag(0), Var_49, 4) = ((MR_Box) (Var_65));
          }
