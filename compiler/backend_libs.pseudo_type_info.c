  ...
  MR_Word * TypeInfo_4)
{
  ...
  if (succeeded)
  {
    ...
    mercury__list__map_3_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0), (MR_Word) (&backend_libs__rtti__backend_libs__rtti__type_ctor_info_rtti_type_info_0), (MR_Word) (&backend_libs__pseudo_type_info_scalar_common_6[0]), TypeArgs_6, &TypeInfoArgs_10);
    {
      ...
      MR_hl_field(MR_mktag(0), Var_18, 0) = ((MR_Box) (&backend_libs__pseudo_type_info_scalar_common_4[1]));
    ...
    case (MR_Integer) 2:
      {
        ...
        if (succeeded)
        {
...

          {
            ...
            MR_hl_field(MR_mktag(0), Var_78, 0) = ((MR_Box) (&backend_libs__pseudo_type_info_scalar_common_3[0]));
          ...
          mercury__list__map_3_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0), (MR_Word) (&backend_libs__rtti__backend_libs__rtti__type_ctor_info_rtti_maybe_pseudo_type_info_0), Var_78, TypeArgs_26, &PseudoArgs_30);
          {
            ...
            MR_hl_field(MR_mktag(0), Var_51, 0) = ((MR_Box) (&backend_libs__pseudo_type_info_scalar_common_4[0]));
        ...
        else
        {
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(0), Var_87, 0) = ((MR_Box) (&backend_libs__pseudo_type_info_scalar_common_3[0]));
