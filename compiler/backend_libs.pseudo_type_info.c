  ...
  MR_Word * TypeInfo_4)
{
  ...
  succeeded = parse_tree__prog_type_test__type_is_higher_order_details_5_p_0(Type_3, &_Purity_32, &PredOrFunc_33, &Var_35);
  if (succeeded)
  {
  ...
  else
  {
    ...
    succeeded = parse_tree__prog_type_test__type_is_tuple_2_p_0(Type_3, &Var_36);
    if (succeeded)
    {
    ...
    case (MR_Integer) 2:
      {
        ...
        succeeded = parse_tree__prog_type_test__type_is_higher_order_details_5_p_0(Type_5, &_Purity_67, &PredOrFunc_68, &Var_70);
        if (succeeded)
        {
        ...
        else
        {
          ...
          succeeded = parse_tree__prog_type_test__type_is_tuple_2_p_0(Type_5, &Var_71);
          if (succeeded)
          {
