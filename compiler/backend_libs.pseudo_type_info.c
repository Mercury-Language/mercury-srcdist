...
{
  {
    ...
    switch (VarArityId_7) {
      ...
      case (MR_Integer) 1:
        {
          MR_Integer Var_35 = (NumPseudoArgs_34 - HeadVar__3_29);
...
{
  {
    ...
    switch (VarArityId_27) {
      ...
      case (MR_Integer) 1:
        {
          MR_Integer Var_70 = (NumPseudoArgs_69 - HeadVar__3_64);
...
{
  {
    ...
    else
    {
      ...
      if ((TypeInfoArgs_26 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
      ...
      case (MR_Integer) 2:
        {
          ...
          else
          {
            ...
            if ((PseudoArgs_59 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
