...
{
  {
    ...
    mercury__list__length_2_p_0((MR_Word) (&backend_libs__rtti__backend_libs__rtti__type_ctor_info_rtti_type_info_0), TypeInfoArgs_27, &NumPseudoArgs_34);
    succeeded = (NumPseudoArgs_34 == HeadVar__2_30);
    return succeeded;
  }
}
...
{
  {
    ...
    mercury__list__length_2_p_0((MR_Word) (&backend_libs__rtti__backend_libs__rtti__type_ctor_info_rtti_type_info_0), TypeInfoArgs_10, &NumPseudoArgs_35);
    switch (VarArityId_7) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 1:
        {
          MR_Integer Var_36 = (MR_Integer) ((MR_Unsigned) NumPseudoArgs_35 - (MR_Unsigned) HeadVar__3_30);
      ...
      case (MR_Integer) 0:
      case (MR_Integer) 2:
        succeeded = (NumPseudoArgs_35 == HeadVar__3_30);
        break;
    }
    return succeeded;
  }
...
{
  {
    ...
    mercury__list__length_2_p_0((MR_Word) (&backend_libs__rtti__backend_libs__rtti__type_ctor_info_rtti_maybe_pseudo_type_info_0), PseudoArgs_60, &NumPseudoArgs_69);
    succeeded = (NumPseudoArgs_69 == HeadVar__2_65);
    return succeeded;
  }
}
  ...
  MR_Integer HeadVar__3_65)
{
  {
    MR_bool succeeded;
    MR_Integer NumPseudoArgs_70;

    mercury__list__length_2_p_0((MR_Word) (&backend_libs__rtti__backend_libs__rtti__type_ctor_info_rtti_maybe_pseudo_type_info_0), PseudoArgs_30, &NumPseudoArgs_70);
    switch (VarArityId_27) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 1:
        {
          MR_Integer Var_71 = (MR_Integer) ((MR_Unsigned) NumPseudoArgs_70 - (MR_Unsigned) HeadVar__3_65);
      ...
      case (MR_Integer) 0:
      case (MR_Integer) 2:
        succeeded = (NumPseudoArgs_70 == HeadVar__3_65);
        break;
    }
    return succeeded;
  }
...
{
  {
    ...
    succeeded = backend_libs__pseudo_type_info__IntroducedFrom__pred__construct_type_info__180__1_2_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Integer) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))));
    return succeeded;
  }
}
...
{
  {
    ...
    succeeded = backend_libs__pseudo_type_info__IntroducedFrom__pred__construct_type_info__169__1_3_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))), ((MR_Integer) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 5)))));
    return succeeded;
  }
}
...
{
  {
    ...
    Var_31 = ((MR_Word) ((MR_hl_field(MR_mktag(0), TypeCtor_5, (MR_Integer) 0))));
    Var_30 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), TypeCtor_5, (MR_Integer) 1))));
    succeeded = parse_tree__prog_type__type_is_higher_order_details_5_p_0(Type_3, &_Purity_34, &PredOrFunc_35, &Var_37);
    if (succeeded)
    {
    ...
    else
    {
      ...
      succeeded = parse_tree__prog_type__type_is_tuple_2_p_0(Type_3, &Var_38);
      if (succeeded)
      {
    ...
    if (succeeded)
    {
      ...
      mercury__list__map_3_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0), (MR_Word) (&backend_libs__rtti__backend_libs__rtti__type_ctor_info_rtti_type_info_0), (MR_Word) (&backend_libs__pseudo_type_info_scalar_common_6[0]), TypeArgs_6, &TypeInfoArgs_10);
      {
        ...
        MR_hl_field(MR_mktag(0), Var_18, 5) = ((MR_Box) (Var_30));
      }
    ...
    else
    {
      ...
      mdbcomp__sym_name__sym_name_get_module_name_default_3_p_0(Var_31, (MR_Word) (&backend_libs__pseudo_type_info_scalar_common_4[0]), &TypeModule_14);
      Var_23 = mercury__uint16__det_from_int_1_f_0(Var_30);
      {
        ...
        MR_hl_field(MR_mktag(0), RttiTypeCtor_15, 2) = ((MR_Box) (MR_Word) (Var_23));
      }
      mercury__list__map_3_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0), (MR_Word) (&backend_libs__rtti__backend_libs__rtti__type_ctor_info_rtti_type_info_0), (MR_Word) (&backend_libs__pseudo_type_info_scalar_common_6[1]), TypeArgs_6, &TypeInfoArgs_27);
      {
        ...
        MR_hl_field(MR_mktag(0), Var_24, 3) = ((MR_Box) (TypeInfoArgs_27));
        MR_hl_field(MR_mktag(0), Var_24, 4) = ((MR_Box) (Var_30));
      }
        ...
        *TypeInfo_4 = (MR_Word) ((MR_Word) (RttiTypeCtor_15));
      else
        {
          ...
          *TypeInfo_4 = base;
          ...
          MR_hl_field(MR_mktag(1), base, 1) = ((MR_Box) (TypeInfoArgs_27));
        }
    }
  }
}
...
{
  {
    ...
    succeeded = backend_libs__pseudo_type_info__IntroducedFrom__pred__construct_pseudo_type_info__116__1_2_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Integer) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))));
    return succeeded;
  }
}
...
{
  {
    ...
    succeeded = backend_libs__pseudo_type_info__IntroducedFrom__pred__construct_pseudo_type_info__104__1_3_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))), ((MR_Integer) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 5)))));
    return succeeded;
  }
}
      ...
      case (MR_Integer) 2:
        {
          ...
          Var_66 = ((MR_Word) ((MR_hl_field(MR_mktag(0), TypeCtor_25, (MR_Integer) 0))));
          Var_65 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), TypeCtor_25, (MR_Integer) 1))));
          succeeded = parse_tree__prog_type__type_is_higher_order_details_5_p_0(Type_5, &_Purity_69, &PredOrFunc_70, &Var_72);
          if (succeeded)
          {
            switch (PredOrFunc_70) {
              default: /*NOTREACHED*/ MR_assert(0);
              case (MR_Integer) 1:
          ...
          else
          {
            ...
            succeeded = parse_tree__prog_type__type_is_tuple_2_p_0(Type_5, &Var_73);
            if (succeeded)
            {
          ...
          if (succeeded)
          {
...

            {
              ...
              MR_hl_field(MR_mktag(0), Var_78, 0) = ((MR_Box) (&backend_libs__pseudo_type_info_scalar_common_2[0]));
              MR_hl_field(MR_mktag(0), Var_78, 1) = ((MR_Box) (backend_libs__pseudo_type_info__construct_pseudo_type_info_4_p_0_1));
              MR_hl_field(MR_mktag(0), Var_78, 2) = ((MR_Box) ((MR_Integer) 2));
              MR_hl_field(MR_mktag(0), Var_78, 3) = ((MR_Box) (NumUnivQTvars_6));
              MR_hl_field(MR_mktag(0), Var_78, 4) = ((MR_Box) (ExistQTvars_7));
            }
            mercury__list__map_3_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0), (MR_Word) (&backend_libs__rtti__backend_libs__rtti__type_ctor_info_rtti_maybe_pseudo_type_info_0), Var_78, TypeArgs_26, &PseudoArgs_30);
            {
              ...
              MR_hl_field(MR_mktag(0), Var_51, 5) = ((MR_Box) (Var_65));
            }
          ...
          else
          {
            ...
            mdbcomp__sym_name__sym_name_get_module_name_default_3_p_0(Var_66, (MR_Word) (&backend_libs__pseudo_type_info_scalar_common_4[0]), &TypeModule_34);
            Var_56 = mercury__uint16__det_from_int_1_f_0(Var_65);
            {
              ...
              MR_hl_field(MR_mktag(0), RttiTypeCtor_35, 2) = ((MR_Box) (MR_Word) (Var_56));
            }
            {
              Var_87 = (MR_Word) MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL);
              MR_hl_field(MR_mktag(0), Var_87, 0) = ((MR_Box) (&backend_libs__pseudo_type_info_scalar_common_2[0]));
              MR_hl_field(MR_mktag(0), Var_87, 1) = ((MR_Box) (backend_libs__pseudo_type_info__construct_pseudo_type_info_4_p_0_3));
              MR_hl_field(MR_mktag(0), Var_87, 2) = ((MR_Box) ((MR_Integer) 2));
              MR_hl_field(MR_mktag(0), Var_87, 3) = ((MR_Box) (NumUnivQTvars_6));
              MR_hl_field(MR_mktag(0), Var_87, 4) = ((MR_Box) (ExistQTvars_7));
            }
            mercury__list__map_3_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0), (MR_Word) (&backend_libs__rtti__backend_libs__rtti__type_ctor_info_rtti_maybe_pseudo_type_info_0), Var_87, TypeArgs_26, &PseudoArgs_60);
            {
              Var_57 = (MR_Word) MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL);
              MR_hl_field(MR_mktag(0), Var_57, 0) = ((MR_Box) (&backend_libs__pseudo_type_info_scalar_common_5[0]));
              MR_hl_field(MR_mktag(0), Var_57, 1) = ((MR_Box) (backend_libs__pseudo_type_info__construct_pseudo_type_info_4_p_0_4));
              MR_hl_field(MR_mktag(0), Var_57, 2) = ((MR_Box) ((MR_Integer) 2));
              MR_hl_field(MR_mktag(0), Var_57, 3) = ((MR_Box) (PseudoArgs_60));
              MR_hl_field(MR_mktag(0), Var_57, 4) = ((MR_Box) (Var_65));
            }
            mercury__require__expect_3_p_0(Var_57, (MR_String) "predicate \140backend_libs.pseudo_type_info.construct_pseudo_type_info\'/4", (MR_String) "arity mismatch");
              ...
              *PseudoTypeInfo_8 = (MR_Word) ((MR_Word) (RttiTypeCtor_35));
            else
              {
                ...
                *PseudoTypeInfo_8 = base;
                ...
                MR_hl_field(MR_mktag(1), base, 1) = ((MR_Box) (PseudoArgs_60));
              }
          }
        }
        break;
