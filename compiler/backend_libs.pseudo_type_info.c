...
{
  {
    ...
    switch (backend_libs__pseudo_type_info__VarArityId_7) {
      ...
      case (MR_Integer) 1:
        {
          MR_Integer backend_libs__pseudo_type_info__Var_37 = (backend_libs__pseudo_type_info__NumPseudoArgs_36 - backend_libs__pseudo_type_info__HeadVar__3_31);

          backend_libs__pseudo_type_info__succeeded = (backend_libs__pseudo_type_info__Var_37 == (MR_Integer) 1);
        }
        break;
      case (MR_Integer) 0:
      case (MR_Integer) 2:
...
{
  {
    ...
    switch (backend_libs__pseudo_type_info__VarArityId_27) {
      ...
      case (MR_Integer) 1:
        {
          MR_Integer backend_libs__pseudo_type_info__Var_74 = (backend_libs__pseudo_type_info__NumPseudoArgs_73 - backend_libs__pseudo_type_info__HeadVar__3_68);

          backend_libs__pseudo_type_info__succeeded = (backend_libs__pseudo_type_info__Var_74 == (MR_Integer) 1);
        }
        break;
      case (MR_Integer) 0:
      case (MR_Integer) 2:
  ...
  MR_Box * backend_libs__pseudo_type_info__wrapper_arg_2)
{
  {
    MR_Box backend_libs__pseudo_type_info__closure = backend_libs__pseudo_type_info__closure_arg;
    MR_Word backend_libs__pseudo_type_info__conv1_TypeInfo_4;

    backend_libs__pseudo_type_info__construct_type_info_2_p_0(((MR_Word) backend_libs__pseudo_type_info__wrapper_arg_1), &backend_libs__pseudo_type_info__conv1_TypeInfo_4);
    *backend_libs__pseudo_type_info__wrapper_arg_2 = ((MR_Box) (backend_libs__pseudo_type_info__conv1_TypeInfo_4));
  }
}
...
{
  {
    ...
    MR_Integer backend_libs__pseudo_type_info__Var_31;
    MR_Word backend_libs__pseudo_type_info__Var_32;
    MR_Word backend_libs__pseudo_type_info__VarArityId_7;
    MR_Word backend_libs__pseudo_type_info__PredOrFunc_36;
    MR_Word backend_libs__pseudo_type_info___Purity_35;
    MR_Word backend_libs__pseudo_type_info__Var_38;
    ...
    backend_libs__pseudo_type_info__Var_32 = ((MR_Word) (MR_hl_field(MR_mktag(0), backend_libs__pseudo_type_info__TypeCtor_5, (MR_Integer) 0)));
    backend_libs__pseudo_type_info__Var_31 = ((MR_Integer) (MR_hl_field(MR_mktag(0), backend_libs__pseudo_type_info__TypeCtor_5, (MR_Integer) 1)));
    backend_libs__pseudo_type_info__succeeded = parse_tree__prog_type__type_is_higher_order_details_5_p_0(backend_libs__pseudo_type_info__Type_3, &backend_libs__pseudo_type_info___Purity_35, &backend_libs__pseudo_type_info__PredOrFunc_36, &backend_libs__pseudo_type_info__Var_38);
    if (backend_libs__pseudo_type_info__succeeded)
    {
    ...
    {
      MR_Word backend_libs__pseudo_type_info__Var_39;

      backend_libs__pseudo_type_info__succeeded = parse_tree__prog_type__type_is_tuple_2_p_0(backend_libs__pseudo_type_info__Type_3, &backend_libs__pseudo_type_info__Var_39);
      if (backend_libs__pseudo_type_info__succeeded)
      {
    ...
    {
      MR_Word backend_libs__pseudo_type_info__TypeInfoArgs_10;
      MR_Word backend_libs__pseudo_type_info__Var_18;

      mercury__list__map_3_p_0((MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0, (MR_Word) &backend_libs__rtti__backend_libs__rtti__type_ctor_info_rtti_type_info_0, (MR_Word) &backend_libs__pseudo_type_info_scalar_common_6[0], backend_libs__pseudo_type_info__TypeArgs_6, &backend_libs__pseudo_type_info__TypeInfoArgs_10);
      {
        backend_libs__pseudo_type_info__Var_18 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 6 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), backend_libs__pseudo_type_info__Var_18, 0) = ((MR_Box) (&backend_libs__pseudo_type_info_scalar_common_3[1]));
        MR_hl_field(MR_mktag(0), backend_libs__pseudo_type_info__Var_18, 1) = ((MR_Box) (backend_libs__pseudo_type_info__construct_type_info_2_p_0_2));
        MR_hl_field(MR_mktag(0), backend_libs__pseudo_type_info__Var_18, 2) = ((MR_Box) (MR_Word) ((MR_Integer) 3));
        MR_hl_field(MR_mktag(0), backend_libs__pseudo_type_info__Var_18, 3) = ((MR_Box) (backend_libs__pseudo_type_info__VarArityId_7));
        MR_hl_field(MR_mktag(0), backend_libs__pseudo_type_info__Var_18, 4) = ((MR_Box) (backend_libs__pseudo_type_info__TypeInfoArgs_10));
        MR_hl_field(MR_mktag(0), backend_libs__pseudo_type_info__Var_18, 5) = ((MR_Box) (backend_libs__pseudo_type_info__Var_31));
      }
      mercury__require__expect_4_p_0(backend_libs__pseudo_type_info__Var_18, (MR_String) "backend_libs.pseudo_type_info", (MR_String) "predicate \140backend_libs.pseudo_type_info.construct_type_info\'/2", (MR_String) "arity mismatch");
      {
        MR_Word base;
    ...
    else
    {
      ...
      MR_Word backend_libs__pseudo_type_info__Var_24;
      MR_Word backend_libs__pseudo_type_info__TypeInfoArgs_28;

      backend_libs__pseudo_type_info__TypeName_13 = mdbcomp__sym_name__unqualify_name_1_f_0(backend_libs__pseudo_type_info__Var_32);
      mdbcomp__sym_name__sym_name_get_module_name_default_3_p_0(backend_libs__pseudo_type_info__Var_32, (MR_Word) &backend_libs__pseudo_type_info_scalar_common_4[0], &backend_libs__pseudo_type_info__TypeModule_14);
      {
        ...
        MR_hl_field(MR_mktag(0), backend_libs__pseudo_type_info__RttiTypeCtor_15, 2) = ((MR_Box) (backend_libs__pseudo_type_info__Var_31));
      }
      mercury__list__map_3_p_0((MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0, (MR_Word) &backend_libs__rtti__backend_libs__rtti__type_ctor_info_rtti_type_info_0, (MR_Word) &backend_libs__pseudo_type_info_scalar_common_6[1], backend_libs__pseudo_type_info__TypeArgs_6, &backend_libs__pseudo_type_info__TypeInfoArgs_28);
      {
        backend_libs__pseudo_type_info__Var_24 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 5 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), backend_libs__pseudo_type_info__Var_24, 0) = ((MR_Box) (&backend_libs__pseudo_type_info_scalar_common_5[3]));
        MR_hl_field(MR_mktag(0), backend_libs__pseudo_type_info__Var_24, 1) = ((MR_Box) (backend_libs__pseudo_type_info__construct_type_info_2_p_0_4));
        MR_hl_field(MR_mktag(0), backend_libs__pseudo_type_info__Var_24, 2) = ((MR_Box) (MR_Word) ((MR_Integer) 2));
        MR_hl_field(MR_mktag(0), backend_libs__pseudo_type_info__Var_24, 3) = ((MR_Box) (backend_libs__pseudo_type_info__TypeInfoArgs_28));
        MR_hl_field(MR_mktag(0), backend_libs__pseudo_type_info__Var_24, 4) = ((MR_Box) (backend_libs__pseudo_type_info__Var_31));
      }
      mercury__require__expect_4_p_0(backend_libs__pseudo_type_info__Var_24, (MR_String) "backend_libs.pseudo_type_info", (MR_String) "predicate \140backend_libs.pseudo_type_info.construct_type_info\'/2", (MR_String) "arity mismatch");
      ...
      case (MR_Integer) 0:
        {
          ...
          MR_Word backend_libs__pseudo_type_info__Var_48;
          MR_Word backend_libs__pseudo_type_info__Var_39 = ((MR_Word) (MR_hl_field(MR_mktag(0), backend_libs__pseudo_type_info__Type_5, (MR_Integer) 1)));
          ...
          {
            backend_libs__pseudo_type_info__Var_48 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 5 * sizeof(MR_Word)), NULL, NULL);
            MR_hl_field(MR_mktag(0), backend_libs__pseudo_type_info__Var_48, 0) = ((MR_Box) (&backend_libs__pseudo_type_info_scalar_common_5[1]));
            MR_hl_field(MR_mktag(0), backend_libs__pseudo_type_info__Var_48, 1) = ((MR_Box) (backend_libs__pseudo_type_info__construct_pseudo_type_info_4_p_0_5));
            MR_hl_field(MR_mktag(0), backend_libs__pseudo_type_info__Var_48, 2) = ((MR_Box) (MR_Word) ((MR_Integer) 2));
            MR_hl_field(MR_mktag(0), backend_libs__pseudo_type_info__Var_48, 3) = ((MR_Box) (backend_libs__pseudo_type_info__VarInt_41));
            MR_hl_field(MR_mktag(0), backend_libs__pseudo_type_info__Var_48, 4) = ((MR_Box) ((MR_Integer) 1024));
          }
          mercury__require__expect_4_p_0(backend_libs__pseudo_type_info__Var_48, (MR_String) "backend_libs.pseudo_type_info", (MR_String) "predicate \140backend_libs.pseudo_type_info.construct_pseudo_type_info\'/4", (MR_String) "type var exceeds limit");
          {
            MR_Word base;
      ...
      case (MR_Integer) 2:
        {
          ...
          MR_Integer backend_libs__pseudo_type_info__Var_68;
          MR_Word backend_libs__pseudo_type_info__Var_69;
          MR_Word backend_libs__pseudo_type_info__VarArityId_27;
          MR_Word backend_libs__pseudo_type_info__PredOrFunc_73;
          MR_Word backend_libs__pseudo_type_info___Purity_72;
          MR_Word backend_libs__pseudo_type_info__Var_75;
          ...
          backend_libs__pseudo_type_info__Var_69 = ((MR_Word) (MR_hl_field(MR_mktag(0), backend_libs__pseudo_type_info__TypeCtor_25, (MR_Integer) 0)));
          backend_libs__pseudo_type_info__Var_68 = ((MR_Integer) (MR_hl_field(MR_mktag(0), backend_libs__pseudo_type_info__TypeCtor_25, (MR_Integer) 1)));
          backend_libs__pseudo_type_info__succeeded = parse_tree__prog_type__type_is_higher_order_details_5_p_0(backend_libs__pseudo_type_info__Type_5, &backend_libs__pseudo_type_info___Purity_72, &backend_libs__pseudo_type_info__PredOrFunc_73, &backend_libs__pseudo_type_info__Var_75);
          if (backend_libs__pseudo_type_info__succeeded)
          {
          ...
          {
            MR_Word backend_libs__pseudo_type_info__Var_76;

            backend_libs__pseudo_type_info__succeeded = parse_tree__prog_type__type_is_tuple_2_p_0(backend_libs__pseudo_type_info__Type_5, &backend_libs__pseudo_type_info__Var_76);
            if (backend_libs__pseudo_type_info__succeeded)
            {
          ...
          {
            MR_Word backend_libs__pseudo_type_info__PseudoArgs_30;
            MR_Word backend_libs__pseudo_type_info__Var_53;
            MR_Word backend_libs__pseudo_type_info__Var_81;

            {
              backend_libs__pseudo_type_info__Var_81 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 5 * sizeof(MR_Word)), NULL, NULL);
              MR_hl_field(MR_mktag(0), backend_libs__pseudo_type_info__Var_81, 0) = ((MR_Box) (&backend_libs__pseudo_type_info_scalar_common_2[0]));
              MR_hl_field(MR_mktag(0), backend_libs__pseudo_type_info__Var_81, 1) = ((MR_Box) (backend_libs__pseudo_type_info__construct_pseudo_type_info_4_p_0_1));
              MR_hl_field(MR_mktag(0), backend_libs__pseudo_type_info__Var_81, 2) = ((MR_Box) (MR_Word) ((MR_Integer) 2));
              MR_hl_field(MR_mktag(0), backend_libs__pseudo_type_info__Var_81, 3) = ((MR_Box) (backend_libs__pseudo_type_info__NumUnivQTvars_6));
              MR_hl_field(MR_mktag(0), backend_libs__pseudo_type_info__Var_81, 4) = ((MR_Box) (backend_libs__pseudo_type_info__ExistQTvars_7));
            }
            mercury__list__map_3_p_0((MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0, (MR_Word) &backend_libs__rtti__backend_libs__rtti__type_ctor_info_rtti_maybe_pseudo_type_info_0, backend_libs__pseudo_type_info__Var_81, backend_libs__pseudo_type_info__TypeArgs_26, &backend_libs__pseudo_type_info__PseudoArgs_30);
            {
              backend_libs__pseudo_type_info__Var_53 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 6 * sizeof(MR_Word)), NULL, NULL);
              MR_hl_field(MR_mktag(0), backend_libs__pseudo_type_info__Var_53, 0) = ((MR_Box) (&backend_libs__pseudo_type_info_scalar_common_3[0]));
              MR_hl_field(MR_mktag(0), backend_libs__pseudo_type_info__Var_53, 1) = ((MR_Box) (backend_libs__pseudo_type_info__construct_pseudo_type_info_4_p_0_2));
              MR_hl_field(MR_mktag(0), backend_libs__pseudo_type_info__Var_53, 2) = ((MR_Box) (MR_Word) ((MR_Integer) 3));
              MR_hl_field(MR_mktag(0), backend_libs__pseudo_type_info__Var_53, 3) = ((MR_Box) (backend_libs__pseudo_type_info__VarArityId_27));
              MR_hl_field(MR_mktag(0), backend_libs__pseudo_type_info__Var_53, 4) = ((MR_Box) (backend_libs__pseudo_type_info__PseudoArgs_30));
              MR_hl_field(MR_mktag(0), backend_libs__pseudo_type_info__Var_53, 5) = ((MR_Box) (backend_libs__pseudo_type_info__Var_68));
            }
            mercury__require__expect_4_p_0(backend_libs__pseudo_type_info__Var_53, (MR_String) "backend_libs.pseudo_type_info", (MR_String) "predicate \140backend_libs.pseudo_type_info.construct_pseudo_type_info\'/4", (MR_String) "var arity mismatch");
            {
              MR_Word base;
              base = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
              *backend_libs__pseudo_type_info__PseudoTypeInfo_8 = base;
          ...
          else
          {
            ...
            MR_Word backend_libs__pseudo_type_info__Var_59;
            MR_Word backend_libs__pseudo_type_info__PseudoArgs_63;
            MR_Word backend_libs__pseudo_type_info__Var_90;

            backend_libs__pseudo_type_info__TypeName_33 = mdbcomp__sym_name__unqualify_name_1_f_0(backend_libs__pseudo_type_info__Var_69);
            mdbcomp__sym_name__sym_name_get_module_name_default_3_p_0(backend_libs__pseudo_type_info__Var_69, (MR_Word) &backend_libs__pseudo_type_info_scalar_common_4[0], &backend_libs__pseudo_type_info__TypeModule_34);
            {
              ...
              MR_hl_field(MR_mktag(0), backend_libs__pseudo_type_info__RttiTypeCtor_35, 2) = ((MR_Box) (backend_libs__pseudo_type_info__Var_68));
            }
            {
              backend_libs__pseudo_type_info__Var_90 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 5 * sizeof(MR_Word)), NULL, NULL);
              MR_hl_field(MR_mktag(0), backend_libs__pseudo_type_info__Var_90, 0) = ((MR_Box) (&backend_libs__pseudo_type_info_scalar_common_2[0]));
              MR_hl_field(MR_mktag(0), backend_libs__pseudo_type_info__Var_90, 1) = ((MR_Box) (backend_libs__pseudo_type_info__construct_pseudo_type_info_4_p_0_3));
              MR_hl_field(MR_mktag(0), backend_libs__pseudo_type_info__Var_90, 2) = ((MR_Box) (MR_Word) ((MR_Integer) 2));
              MR_hl_field(MR_mktag(0), backend_libs__pseudo_type_info__Var_90, 3) = ((MR_Box) (backend_libs__pseudo_type_info__NumUnivQTvars_6));
              MR_hl_field(MR_mktag(0), backend_libs__pseudo_type_info__Var_90, 4) = ((MR_Box) (backend_libs__pseudo_type_info__ExistQTvars_7));
            }
            mercury__list__map_3_p_0((MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0, (MR_Word) &backend_libs__rtti__backend_libs__rtti__type_ctor_info_rtti_maybe_pseudo_type_info_0, backend_libs__pseudo_type_info__Var_90, backend_libs__pseudo_type_info__TypeArgs_26, &backend_libs__pseudo_type_info__PseudoArgs_63);
            {
              backend_libs__pseudo_type_info__Var_59 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 5 * sizeof(MR_Word)), NULL, NULL);
              MR_hl_field(MR_mktag(0), backend_libs__pseudo_type_info__Var_59, 0) = ((MR_Box) (&backend_libs__pseudo_type_info_scalar_common_5[0]));
              MR_hl_field(MR_mktag(0), backend_libs__pseudo_type_info__Var_59, 1) = ((MR_Box) (backend_libs__pseudo_type_info__construct_pseudo_type_info_4_p_0_4));
              MR_hl_field(MR_mktag(0), backend_libs__pseudo_type_info__Var_59, 2) = ((MR_Box) (MR_Word) ((MR_Integer) 2));
              MR_hl_field(MR_mktag(0), backend_libs__pseudo_type_info__Var_59, 3) = ((MR_Box) (backend_libs__pseudo_type_info__PseudoArgs_63));
              MR_hl_field(MR_mktag(0), backend_libs__pseudo_type_info__Var_59, 4) = ((MR_Box) (backend_libs__pseudo_type_info__Var_68));
            }
            mercury__require__expect_4_p_0(backend_libs__pseudo_type_info__Var_59, (MR_String) "backend_libs.pseudo_type_info", (MR_String) "predicate \140backend_libs.pseudo_type_info.construct_pseudo_type_info\'/4", (MR_String) "arity mismatch");
