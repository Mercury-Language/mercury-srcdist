...
{
  {
    ...
    Var_9 = mercury__integer__two_0_f_0();
    Var_11 = (MR_Integer) ((MR_Unsigned) BitsPerInt_4 - (MR_Unsigned) 1);
    Var_10 = mercury__integer__integer_1_f_0(Var_11);
    Var_8 = mercury__integer__pow_2_f_0(Var_9, Var_10);
    Var_7 = mercury__integer__f_minus_1_f_0(Var_8);
    succeeded = mercury__integer__f_greater_or_equal_2_p_0(Integer_5, Var_7);
    if (succeeded)
    {
      Var_15 = mercury__integer__two_0_f_0();
      Var_18 = (MR_Integer) 1;
      Var_17 = (MR_Integer) ((MR_Unsigned) BitsPerInt_4 - (MR_Unsigned) Var_18);
      Var_16 = mercury__integer__integer_1_f_0(Var_17);
      Var_14 = mercury__integer__pow_2_f_0(Var_15, Var_16);
      Var_19 = mercury__integer__one_0_f_0();
      Var_13 = mercury__integer__f_minus_2_f_0(Var_14, Var_19);
      succeeded = mercury__integer__f_less_or_equal_2_p_0(Integer_5, Var_13);
      if (succeeded)
