...
MR_bool MR_CALL 
libs__int_emu__right_ushift_4_p_0(
  MR_Word BitsPerInt_5,
  MR_Integer X_6,
  MR_Unsigned UY_7,
  MR_Integer * Z_8)
...
MR_bool MR_CALL 
libs__int_emu__left_ushift_4_p_0(
  MR_Word BitsPerInt_5,
  MR_Integer X_6,
  MR_Unsigned UY_7,
  MR_Integer * Z_8)
  ...
  MR_Word * HeadVar__2_2)
{
  ...
  switch (Target_5) {
    ...
    case (MR_Integer) 0:
      libs__globals__lookup_int_option_3_p_0(Globals_3, (MR_Integer) 285, &BitsPerInt_4);
      break;
    case (MR_Integer) 1:
    case (MR_Integer) 2:
