...
{
  {
    ...
    if (succeeded)
    {
      MR_Integer Var_10 = (MR_Integer) ((MR_Unsigned) (MR_Integer) 0 - (MR_Unsigned) Y_7);
...
{
  {
    ...
    Var_12 = (MR_Integer) ((MR_Unsigned) BitsPerInt_4 - (MR_Unsigned) (MR_Integer) 1);
...
{
  {
    ...
    switch (Target_5) {
      ...
      case (MR_Integer) 0:
        {
          libs__globals__lookup_int_option_3_p_0(Globals_3, (MR_Integer) 254, &BitsPerInt_4);
        }
        break;
      case (MR_Integer) 1:
      case (MR_Integer) 3:
