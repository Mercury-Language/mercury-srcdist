...
{
  {
    ...
    if (succeeded)
    {
      MR_Integer Var_10 = ((MR_Integer) 0 - Y_7);
...
{
  {
    ...
    Var_12 = (BitsPerInt_4 - (MR_Integer) 1);
...
{
  {
    ...
    switch (Target_5) {
      ...
      case (MR_Integer) 0:
        {
          libs__globals__lookup_int_option_3_p_0(Globals_3, (MR_Integer) 251, &BitsPerInt_4);
        }
        break;
      case (MR_Integer) 1:
      case (MR_Integer) 3:
