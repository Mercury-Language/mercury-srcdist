    ...
    else
    {
      ...
      if (succeeded)
      {
        LiveLvals_21 = ((MR_Word) ((MR_hl_field(MR_mktag(2), Uinstr_19, (MR_Integer) 0))));
        {
          ...
          {
            MR_Word OldCompulsoryLvals_67 = ((MR_Word) ((MR_hl_field(MR_mktag(1), STATE_VARIABLE_MaybeCompulsoryLvals_40_40, (MR_Integer) 0))));
            ...
            mercury__set__union_3_p_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_lval_0), LiveLvals_21, OldCompulsoryLvals_67, &AllCompulsoryLvals_68);
            {
              ...
              base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
              *HeadVar__5_5 = base;
              MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (AllCompulsoryLvals_68));
            }
          }
        }
      }
          ...
          else
          {
            ...
            if ((NonLabelCodeAddrs_30 == (MR_Word) ((MR_Unsigned) 0U)))
              ...
              else
              {
                ...
                {
                  MR_Word OldCompulsoryLvals_70 = ((MR_Word) ((MR_hl_field(MR_mktag(1), STATE_VARIABLE_MaybeCompulsoryLvals_54_54, (MR_Integer) 0))));
