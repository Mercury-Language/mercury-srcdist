    ...
    else
      {
        ...
        if ((ll_backend__use_local_vars__HeadVar__3_3 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
          *ll_backend__use_local_vars__HeadVar__1_1 = (MR_Integer) 1;
          ...
          {
            MR_Word ll_backend__use_local_vars__Var_5 = ((MR_Word) (MR_hl_field(MR_mktag(1), ll_backend__use_local_vars__HeadVar__3_3, (MR_Integer) 0)));

            {
              mercury__builtin__compare_3_p_0((MR_Word) &ll_backend__use_local_vars_scalar_common_2[0], ll_backend__use_local_vars__HeadVar__1_1, ((MR_Box) (ll_backend__use_local_vars__Var_11)), ((MR_Box) (ll_backend__use_local_vars__Var_5)));
            }
          }
      }
  }
...
{
  {
    ...
    if ((ll_backend__use_local_vars__HeadVar__1_1 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
    ...
    else
      {
        ...
        MR_Word ll_backend__use_local_vars__Var_3 = ((MR_Word) (MR_hl_field(MR_mktag(1), ll_backend__use_local_vars__HeadVar__1_1, (MR_Integer) 0)));
        MR_Word ll_backend__use_local_vars__Var_4;

        ll_backend__use_local_vars__succeeded = ((MR_tag((MR_Word) ll_backend__use_local_vars__HeadVar__2_2)) == (MR_mktag((MR_Integer) 1)));
        if (ll_backend__use_local_vars__succeeded)
          {
            ll_backend__use_local_vars__Var_4 = ((MR_Word) (MR_hl_field(MR_mktag(1), ll_backend__use_local_vars__HeadVar__2_2, (MR_Integer) 0)));
            ll_backend__use_local_vars__TypeInfo_9_9 = (MR_Word) &ll_backend__use_local_vars_scalar_common_2[0];
            {
              ll_backend__use_local_vars__succeeded = mercury__builtin__unify_2_p_0(ll_backend__use_local_vars__TypeInfo_9_9, ((MR_Box) (ll_backend__use_local_vars__Var_3)), ((MR_Box) (ll_backend__use_local_vars__Var_4)));
            }
          }
      }
    return ll_backend__use_local_vars__succeeded;
    ...
    if (ll_backend__use_local_vars__succeeded)
      {
        ...
        ll_backend__use_local_vars__FromRval_12 = ((MR_Word) (MR_hl_field(MR_mktag(3), ll_backend__use_local_vars__Uinstr0_9, (MR_Integer) 2)));
        {
...

          {
            ...
            MR_hl_field(MR_mktag(0), ll_backend__use_local_vars__Var_33, 0) = ((MR_Box) (&ll_backend__use_local_vars_scalar_common_4[2]));
        ...
        if (ll_backend__use_local_vars__succeeded)
          {
            ...
            ll_backend__use_local_vars__MaybeReuse_20 = ((MR_Word) (MR_hl_field(MR_mktag(3), ll_backend__use_local_vars__Uinstr0_9, (MR_Integer) 8)));
            {
...

              {
                ...
                MR_hl_field(MR_mktag(0), ll_backend__use_local_vars__Var_37, 0) = ((MR_Box) (&ll_backend__use_local_vars_scalar_common_4[2]));
            ...
            if (ll_backend__use_local_vars__succeeded)
              {
                ...
                ll_backend__use_local_vars__MD_30 = ((MR_Word) (MR_hl_field(MR_mktag(3), ll_backend__use_local_vars__Uinstr0_9, (MR_Integer) 10)));
                {
                  ...
                  }
                  {
                    ...
                    MR_hl_field(MR_mktag(0), ll_backend__use_local_vars__Var_42, 0) = ((MR_Box) (&ll_backend__use_local_vars_scalar_common_4[3]));
            ...
            if (ll_backend__use_local_vars__succeeded)
              {
                ...
                }
                {
                  ...
                  MR_hl_field(MR_mktag(0), ll_backend__use_local_vars__Var_48, 0) = ((MR_Box) (&ll_backend__use_local_vars_scalar_common_4[1]));
