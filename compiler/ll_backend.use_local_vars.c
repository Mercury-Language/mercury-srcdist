...
ll_backend__use_local_vars__IntroducedFrom__pred__find_compulsory_lvals__373__1_3_p_0(
  ...
  MR_Word * HeadVar__3_63)
{
  MR_Box conv0_HeadVar__3_63;

  mercury__map__lookup_3_p_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_label_0), (MR_Word) (&ll_backend__use_local_vars_scalar_common_2[0]), LiveMap_33, ((MR_Box) (HeadVar__2_62)), &conv0_HeadVar__3_63);
  *HeadVar__3_63 = ((MR_Word) (conv0_HeadVar__3_63));
}
  ...
  MR_Box * wrapper_arg_2)
{
  ...
  ll_backend__use_local_vars__IntroducedFrom__pred__find_compulsory_lvals__373__1_3_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) (wrapper_arg_1)), &conv1_HeadVar__3_63);
    ...
    else
    {
      ...
      if (succeeded)
      {
        LiveLvals_21 = ((MR_Word) ((MR_hl_field(MR_mktag(2), Uinstr_19, (MR_Integer) 0))));
        {
          ...
          {
            MR_Word OldCompulsoryLvals_69 = ((MR_Word) ((MR_hl_field(MR_mktag(1), STATE_VARIABLE_MaybeCompulsoryLvals_40_40, (MR_Integer) 0))));
            MR_Word AllCompulsoryLvals_70;

            mercury__set__union_3_p_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_lval_0), LiveLvals_21, OldCompulsoryLvals_69, &AllCompulsoryLvals_70);
            {
              MR_Word base;
              base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
              *HeadVar__5_5 = base;
              MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (AllCompulsoryLvals_70));
            }
          }
        }
      }
          ...
          else
          {
            ...
            if ((NonLabelCodeAddrs_30 == (MR_Word) ((MR_Unsigned) 0U)))
              ...
              else
              {
                ...
                {
                  MR_Word OldCompulsoryLvals_72 = ((MR_Word) ((MR_hl_field(MR_mktag(1), STATE_VARIABLE_MaybeCompulsoryLvals_54_54, (MR_Integer) 0))));
                  MR_Word AllCompulsoryLvals_73;

                  mercury__set__union_3_p_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_lval_0), AllLabelsLiveLvals_35, OldCompulsoryLvals_72, &AllCompulsoryLvals_73);
                  {
                    MR_Word base;
                    base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                    *HeadVar__5_5 = base;
                    MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (AllCompulsoryLvals_73));
                  }
                }
              }
            else
