            ...
            else
            {
              ...
              else
              {
                ...
                else
                {
                  ...
                  {
                    mercury__builtin__compare_3_p_0((MR_Word) (&parse_tree__module_qual_scalar_common_1[4]), HeadVar__1_1, ((MR_Box) (ArgX8_25)), ((MR_Box) (ArgY8_26)));
                  }
                }
              }
            }
            ...
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                ...
                if (succeeded)
                {
                  ...
                  if (succeeded)
                  {
                    TypeInfo_27_27 = (MR_Word) (&parse_tree__module_qual_scalar_common_1[4]);
