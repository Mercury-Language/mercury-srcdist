...
static const MR_FA_TypeInfo_Struct1 parse_tree__module_qual__maybe__ti_maybe_1recompilation__record_uses__type_ctor_info_recompilation_info_0;
...
static const MR_PseudoTypeInfo parse_tree__module_qual__parse_tree__module_qual__field_types_mq_info_0_0[8] = {
  ...
  (MR_PseudoTypeInfo) (&parse_tree__module_qual__maybe__ti_maybe_1recompilation__record_uses__type_ctor_info_recompilation_info_0)
};
  ...
  MR_Word * Info_8)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 155, &SmartRecompilation_21);
    ...
    case (MR_Integer) 1:
      {
        ...
        Var_32 = recompilation__record_uses__init_recompilation_info_1_f_0(ModuleName_6);
        {
