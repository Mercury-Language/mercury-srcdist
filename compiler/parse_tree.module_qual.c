...
{
  {
    ...
    {
      libs__globals__lookup_bool_option_3_p_0(parse_tree__module_qual__Globals_9, (MR_Integer) 122, &parse_tree__module_qual__SmartRecompilation_37);
    }
...
{
  {
    ...
    if (parse_tree__module_qual__succeeded)
      {
        parse_tree__module_qual__V_58_58 = (MR_Integer) 12;
