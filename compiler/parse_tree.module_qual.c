...
static MR_bool MR_CALL 
parse_tree__module_qual__IntroducedFrom__pred__module_qualify_parse_tree_int3__340__1_2_p_0(
  MR_Word ImpIncls_15,
...
{
  {
    ...
    succeeded = parse_tree__module_qual__IntroducedFrom__pred__module_qualify_parse_tree_int3__340__1_2_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))));
    return succeeded;
  }
}
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_9, (MR_Integer) 132, &SmartRecompilation_37);
