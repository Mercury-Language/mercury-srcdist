  ...
  MR_Word * STATE_VARIABLE_Specs_41)
{
  ...
  Var_99 = ((MR_Word) ((MR_hl_field(0, *STATE_VARIABLE_Info_39, (MR_Integer) 0))));
  *UndefTypes_21 = ((MR_Word) ((MR_hl_field(0, Var_99, (MR_Integer) 5))));
  ...
  MR_Word * Info_8)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 153, &SmartRecompilation_21);
