...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 14, &WarnInterfaceImportsInParents_11);
...
{
  {
    ...
    MR_Word Var_53 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_33, (MR_Integer) 3))));

    ModuleExportsInstances_11 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Var_33, (MR_Integer) 4))) >> 7)) & (MR_Integer) 1);
      ...
      case (MR_Integer) 1:
        {
          ...
          Var_18 = mercury__set__to_sorted_list_1_f_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), Var_53);
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_6, (MR_Integer) 13, &WarnInterfaceImports_14);
