...
{
  {
    ...
    else
    {
      ...
      mercury__builtin__compare_3_p_0((MR_Word) &parse_tree__module_qual_scalar_common_2[3], HeadVar__1_1, ((MR_Box) (ArgX1_4)), ((MR_Box) (ArgY1_5)));
    }
  }
}
...
{
  {
    ...
    else
    {
      ...
      succeeded = mercury__builtin__unify_2_p_0((MR_Word) &parse_tree__module_qual_scalar_common_2[3], ((MR_Box) (ArgX1_3)), ((MR_Box) (ArgY1_4)));
    }
    return succeeded;
  }
}
...
{
  {
    ...
    else
    {
      ...
      else
      {
        ...
        mercury__builtin__compare_3_p_0((MR_Word) &parse_tree__module_qual_scalar_common_2[3], &Var_21, ((MR_Box) (ArgX2_6)), ((MR_Box) (ArgY2_7)));
        ...
        else
        {
          ...
          mercury__builtin__compare_3_p_0((MR_Word) &parse_tree__module_qual_scalar_common_2[3], &Var_22, ((MR_Box) (ArgX3_8)), ((MR_Box) (ArgY3_9)));
          ...
          else
          {
            ...
            mercury__builtin__compare_3_p_0((MR_Word) &parse_tree__module_qual_scalar_common_2[3], &Var_23, ((MR_Box) (ArgX4_10)), ((MR_Box) (ArgY4_11)));
            ...
            else
            {
              ...
              mercury__builtin__compare_3_p_0((MR_Word) &parse_tree__module_qual_scalar_common_2[3], &Var_24, ((MR_Box) (ArgX5_12)), ((MR_Box) (ArgY5_13)));
              ...
              else
              {
                ...
                mercury__builtin__compare_3_p_0((MR_Word) &parse_tree__module_qual_scalar_common_2[3], &Var_25, ((MR_Box) (ArgX6_14)), ((MR_Box) (ArgY6_15)));
                ...
                else
                {
                  ...
                  mercury__builtin__compare_3_p_0((MR_Word) &parse_tree__module_qual_scalar_common_2[4], &Var_26, ((MR_Box) (ArgX7_16)), ((MR_Box) (ArgY7_17)));
  ...
  MR_Word * STATE_VARIABLE_Qualifiers_18)
{
  while (MR_TRUE)
  {
    ...
    if (((MR_tag((MR_Word) ImplicitPart_8)) == (MR_mktag((MR_Integer) 1))))
    {
      ...
      /* direct tailcall eliminated */
      {
        MR_Word next_value_of_ImplicitPart_8 = NextImplicitPart_14;
        MR_Word next_value_of_ExplicitPart_9 = NextExplicitPart_15;
        MR_Word next_value_of_STATE_VARIABLE_Qualifiers_0_17 = STATE_VARIABLE_Qualifiers_19_19;
...
{
  {
    ...
    parse_tree__module_qual__collect_mq_info__collect_mq_info_in_item_blocks_4_p_0(TypeCtorInfo_55_55, (MR_Word) &parse_tree__module_qual_scalar_common_2[7], IntSrcItemBlocks0_20, STATE_VARIABLE_IntInfo_42_42, &STATE_VARIABLE_IntInfo_44_44);
    ...
    parse_tree__module_qual__collect_mq_info__collect_mq_info_in_item_blocks_4_p_0(TypeCtorInfo_59_59, (MR_Word) &parse_tree__module_qual_scalar_common_2[8], ImpSrcItemBlocks0_21, STATE_VARIABLE_ImpInfo_50_50, &STATE_VARIABLE_ImpInfo_52_52);
...
{
  {
    ...
    parse_tree__module_qual__collect_mq_info__collect_mq_info_in_item_blocks_4_p_0(TypeCtorInfo_63_63, (MR_Word) &parse_tree__module_qual_scalar_common_2[5], SrcItemBlocks0_29, STATE_VARIABLE_Info_47_47, &STATE_VARIABLE_Info_49_49);
    parse_tree__module_qual__collect_mq_info__collect_mq_info_in_item_blocks_4_p_0(TypeCtorInfo_64_64, (MR_Word) &parse_tree__module_qual_scalar_common_2[6], DirectIntItemBlocks_30, STATE_VARIABLE_Info_49_49, &STATE_VARIABLE_Info_51_51);
