  ...
  MR_Word Fill_7)
{
  ...
  if (succeeded)
  ...
  else
    {
      ...
      MR_hl_field(3, CastRval_10, 1) = ((MR_Box) (MR_mkword(3, &ml_backend__ml_unify_gen_util_scalar_common_1[15])));
    ...
    case (MR_Integer) 1:
      {
        ...
        }
        {
          ...
          MR_hl_field(0, ClassId_55, 2) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 0));
        }
        Var_67 = (MR_Word) (MR_mkword(1, (MR_Word) (ClassId_55)));
        {
          ClassPtrType_56 = (MR_Word) MR_mkword(3, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(3, ClassPtrType_56, 0) = ((MR_Box) ((MR_Unsigned) 7U));
          MR_hl_field(3, ClassPtrType_56, 1) = ((MR_Box) (Var_67));
        }
  ...
  MR_Word * FieldGen_14)
{
        ...
        else
        {
          ...
          if (succeeded)
          {
            ...
            ConsTypeCtor_22 = ((MR_Word) ((MR_hl_field(3, ConsId_11, (MR_Integer) 3))));
            {
                ...
                case (MR_Integer) 0:
                  {
                    ...
                    }
                    {
                      ...
                      MR_hl_field(0, ClassId_36, 2) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 0));
                    }
              ...
              Var_48 = (MR_Word) (MR_mkword(1, (MR_Word) (ClassId_36)));
              {
                ClassPtrType_40 = (MR_Word) MR_mkword(3, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(3, ClassPtrType_40, 0) = ((MR_Box) ((MR_Unsigned) 7U));
                MR_hl_field(3, ClassPtrType_40, 1) = ((MR_Box) (Var_48));
              }
              {
  ...
  }
  {
    ...
    MR_hl_field(1, Var_51, 0) = ((MR_Box) (Ptag_13));
  }
  {
    MR_Word base;
