  ...
  MR_Word * STATE_VARIABLE_PredLineCounts_36)
{
  ...
  if (succeeded)
  {
    ...
    else
    {
      ...
      Var_37 = hlds__hlds_clauses__clause_body_1_f_0(FirstClause_19);
      hlds__hlds_defns__find_first_context_2_p_0(Var_37, &FirstContext_22);
      Var_38 = hlds__hlds_clauses__clause_body_1_f_0(LastClause_21);
      hlds__hlds_defns__find_last_context_2_p_0(Var_38, &LastContext_23);
      ...
      if (succeeded)
      {
        ...
        mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&hlds__hlds_defns_scalar_common_2[0]), PredArity_31, &Var_48);
        Var_56 = mercury__string__f_43_43_2_f_0((MR_String) "/", Var_48);
        PredNameArityStr_32 = mercury__string__f_43_43_2_f_0(PredName_30, Var_56);
        Var_45 = (MR_Integer) ((MR_Unsigned) LastLineNumber_29 - (MR_Unsigned) FirstLineNumber_28);
        LineCount_33 = (MR_Integer) ((MR_Unsigned) Var_45 + (MR_Unsigned) 1);
        {
  ...
  MR_Word * STATE_VARIABLE_PredNameArities_6)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      MR_Word Origin_22;
      MR_Word STATE_VARIABLE_FuncNameArities_34_34;
      MR_Word STATE_VARIABLE_PredNameArities_35_35;
      MR_Word next_value_of_HeadVar__2_2;
      ...
      if (succeeded)
      {
        ...
        switch (PorF_29) {
          ...
          case (MR_Integer) 1:
            {
              mercury__set__insert_3_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_name_arity_0), ((MR_Box) (NameArity_28)), STATE_VARIABLE_FuncNameArities_0_3, &STATE_VARIABLE_FuncNameArities_34_34);
              STATE_VARIABLE_PredNameArities_35_35 = STATE_VARIABLE_PredNameArities_0_5;
            }
            break;
          case (MR_Integer) 0:
            {
              mercury__set__insert_3_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_name_arity_0), ((MR_Box) (NameArity_28)), STATE_VARIABLE_PredNameArities_0_5, &STATE_VARIABLE_PredNameArities_35_35);
              STATE_VARIABLE_FuncNameArities_34_34 = STATE_VARIABLE_FuncNameArities_0_3;
            }
            break;
        }
      }
      ...
      next_value_of_STATE_VARIABLE_FuncNameArities_0_3 = STATE_VARIABLE_FuncNameArities_34_34;
      next_value_of_STATE_VARIABLE_PredNameArities_0_5 = STATE_VARIABLE_PredNameArities_35_35;
      HeadVar__2_2 = next_value_of_HeadVar__2_2;
