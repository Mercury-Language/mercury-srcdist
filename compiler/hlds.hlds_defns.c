  ...
  MR_Word * STATE_VARIABLE_PredLineCounts_36)
{
  ...
  if (succeeded)
  {
    ...
    if (succeeded)
    {
      Var_37 = ((MR_Word) ((MR_hl_field(0, Origin_9, (MR_Integer) 0))));
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        LineCount_33 = (MR_Integer) ((MR_Unsigned) Var_46 + (MR_Unsigned) 1);
        {
          ...
          MR_hl_field(0, PLC_34, 0) = ((MR_Box) (PredNameArityStr_32));
          MR_hl_field(0, PLC_34, 1) = ((MR_Box) (FirstFileName_24));
          MR_hl_field(0, PLC_34, 2) = ((MR_Box) (FirstLineNumber_28));
          MR_hl_field(0, PLC_34, 3) = ((MR_Box) (LastLineNumber_29));
          MR_hl_field(0, PLC_34, 4) = ((MR_Box) (LineCount_33));
        }
        {
          MR_Word base;
          base = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          *STATE_VARIABLE_PredLineCounts_36 = base;
          MR_hl_field(1, base, 0) = ((MR_Box) (PLC_34));
          MR_hl_field(1, base, 1) = ((MR_Box) (STATE_VARIABLE_PredLineCounts_0_35));
        }
      }
      else
        *STATE_VARIABLE_PredLineCounts_36 = STATE_VARIABLE_PredLineCounts_0_35;
  ...
  MR_Box * wrapper_arg_3)
{
  ...
  hlds__hlds_defns__gather_pred_line_counts_4_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) (wrapper_arg_1)), ((MR_Word) (wrapper_arg_2)), &conv0_STATE_VARIABLE_PredLineCounts_36);
  ...
  MR_Word * STATE_VARIABLE_InstanceDescs_5)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      MR_Word OrigTypes_17 = ((MR_Word) ((MR_hl_field(0, InstanceDefn_13, (MR_Integer) 2))));
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        PredArity_27 = hlds__hlds_pred__pred_info_orig_arity_1_f_0(PredInfo_20);
        {
          ...
          MR_hl_field(0, NameArity_28, 1) = ((MR_Box) (PredArity_27));
        }
