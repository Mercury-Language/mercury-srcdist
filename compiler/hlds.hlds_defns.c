...
{
  {
    ...
    if (succeeded)
    {
      succeeded = ((((MR_tag((MR_Word) Origin_9)) == (MR_Integer) 3)) && ((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), Origin_9, (MR_Integer) 0))) == (MR_Integer) 6)));
      if (succeeded)
      {
      }
    }
  ...
  MR_Word * STATE_VARIABLE_PredNameArities_6)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        succeeded = ((((MR_tag((MR_Word) Origin_22)) == (MR_Integer) 3)) && ((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), Origin_22, (MR_Integer) 0))) == (MR_Integer) 6)));
        if (succeeded)
        {
        }
      }
