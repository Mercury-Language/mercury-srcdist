    ...
    else
    {
      ...
      if (((MR_tag((MR_Word) ClassSymName_13)) == (MR_Integer) 1))
      {
        ...
        if (succeeded)
        {
          ...
          mercury__set__insert_3_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_name_arity_0), ((MR_Box) (Var_20)), STATE_VARIABLE_ClassNameArities_0_3, &STATE_VARIABLE_ClassNameArities_21_21);
        }
        else
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        switch (PorF_27) {
          ...
          case (MR_Integer) 1:
            {
              mercury__set__insert_3_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_name_arity_0), ((MR_Box) (NameArity_26)), STATE_VARIABLE_FuncNameArities_0_3, &STATE_VARIABLE_FuncNameArities_33_33);
              STATE_VARIABLE_PredNameArities_32_32 = STATE_VARIABLE_PredNameArities_0_5;
            }
            break;
          case (MR_Integer) 0:
            {
              mercury__set__insert_3_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_name_arity_0), ((MR_Box) (NameArity_26)), STATE_VARIABLE_PredNameArities_0_5, &STATE_VARIABLE_PredNameArities_32_32);
    ...
    else
    {
      ...
      if (((MR_tag((MR_Word) ModeSymName_13)) == (MR_Integer) 1))
      {
        ...
        if (succeeded)
        {
          ...
          mercury__set__insert_3_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_name_arity_0), ((MR_Box) (Var_20)), STATE_VARIABLE_ModeNameArities_0_3, &STATE_VARIABLE_ModeNameArities_21_21);
        }
        else
    ...
    else
    {
      ...
      if (((MR_tag((MR_Word) InstSymName_13)) == (MR_Integer) 1))
      {
        ...
        if (succeeded)
        {
          ...
          mercury__set__insert_3_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_name_arity_0), ((MR_Box) (Var_20)), STATE_VARIABLE_InstNameArities_0_3, &STATE_VARIABLE_InstNameArities_21_21);
        }
        else
    ...
    else
    {
      ...
      if (((MR_tag((MR_Word) TypeCtorSymName_14)) == (MR_Integer) 1))
      {
        ...
        if (succeeded)
        {
          ...
          mercury__set__insert_3_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_name_arity_0), ((MR_Box) (Var_22)), STATE_VARIABLE_TypeNameArities_0_3, &STATE_VARIABLE_TypeNameArities_23_23);
        }
        else
