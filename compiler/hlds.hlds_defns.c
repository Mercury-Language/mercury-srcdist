  ...
  if (succeeded)
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&hlds__hlds_defns_scalar_common_2[0]), PredArity_29, &Var_46);
        Var_54 = mercury__string__f_43_43_2_f_0((MR_String) "/", Var_46);
        PredNameArityStr_30 = mercury__string__f_43_43_2_f_0(PredName_28, Var_54);
  ...
  switch (MR_tag((MR_Word) GoalExpr_5)) {
    ...
    case (MR_Integer) 3:
      switch (((MR_Integer) ((MR_hl_field(MR_mktag(3), GoalExpr_5, (MR_Integer) 0))))) {
        ...
        case (MR_Integer) 3:
          {
            MR_Word SubGoals_66 = ((MR_Word) ((MR_hl_field(MR_mktag(3), GoalExpr_5, (MR_Integer) 1))));
          ...
          case (MR_Integer) 3:
            {
              ...
              {
                MR_Word HeadSubGoal_62 = ((MR_Word) ((MR_hl_field(MR_mktag(1), SubGoals_66, (MR_Integer) 0))));
