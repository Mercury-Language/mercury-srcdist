...
hlds__hlds_defns__write_pred_line_count_4_p_0(
  ...
  MR_Word hlds__hlds_defns__PredLineCount_6);

static void MR_CALL 
hlds__hlds_defns__find_last_context_2_p_0(
  MR_Word hlds__hlds_defns__Goal_3,
  MR_Word * hlds__hlds_defns__FirstContext_4);
...
hlds__hlds_defns__gather_pred_line_counts_4_p_0(
  MR_Word hlds__hlds_defns__ModuleName_5,
  MR_Word hlds__hlds_defns__PredInfo_6,
  MR_Word hlds__hlds_defns__STATE_VARIABLE_PredLineCounts_0_32,
  MR_Word * hlds__hlds_defns__STATE_VARIABLE_PredLineCounts_33);
...
static /* final */ const MR_Box hlds__hlds_defns_scalar_common_2[2][7];

static /* final */ const MR_Box hlds__hlds_defns_scalar_common_3[1][5];

static /* final */ const MR_Box hlds__hlds_defns_scalar_common_4[1][3];

static /* final */ const MR_Box hlds__hlds_defns_scalar_common_5[2][1];
...
{
  {
    ...
    {
      hlds__hlds_defns__succeeded = hlds__hlds_defns____Unify____pred_line_count_0_0(((MR_Word) hlds__hlds_defns__wrapper_arg_1), ((MR_Word) hlds__hlds_defns__wrapper_arg_2));
    }
    return hlds__hlds_defns__succeeded;
  }
}
...
{
  {
    ...
    {
      hlds__hlds_defns____Compare____pred_line_count_0_0(&hlds__hlds_defns__conv0_HeadVar__1_1, ((MR_Word) hlds__hlds_defns__wrapper_arg_2), ((MR_Word) hlds__hlds_defns__wrapper_arg_3));
    }
    *hlds__hlds_defns__wrapper_arg_1 = ((MR_Box) (hlds__hlds_defns__conv0_HeadVar__1_1));
  }
}
  ...
  MR_Word hlds__hlds_defns__HeadVar__3_3)
{
  {
    MR_bool hlds__hlds_defns__succeeded;
    MR_Integer hlds__hlds_defns__CastX_12 = (MR_Integer) hlds__hlds_defns__HeadVar__2_2;
    MR_Integer hlds__hlds_defns__CastY_13 = (MR_Integer) hlds__hlds_defns__HeadVar__3_3;

    hlds__hlds_defns__succeeded = (hlds__hlds_defns__CastX_12 == hlds__hlds_defns__CastY_13);
    if (hlds__hlds_defns__succeeded)
      *hlds__hlds_defns__HeadVar__1_1 = (MR_Integer) 0;
    else
      {
        MR_Word hlds__hlds_defns__ArgX1_4 = ((MR_Word) (MR_hl_field(MR_mktag(0), hlds__hlds_defns__HeadVar__2_2, (MR_Integer) 0)));
        MR_Word hlds__hlds_defns__ArgY1_5 = ((MR_Word) (MR_hl_field(MR_mktag(0), hlds__hlds_defns__HeadVar__3_3, (MR_Integer) 0)));
        MR_String hlds__hlds_defns__ArgX2_6 = ((MR_String) (MR_hl_field(MR_mktag(0), hlds__hlds_defns__HeadVar__2_2, (MR_Integer) 1)));
        MR_String hlds__hlds_defns__ArgY2_7 = ((MR_String) (MR_hl_field(MR_mktag(0), hlds__hlds_defns__HeadVar__3_3, (MR_Integer) 1)));
        MR_Integer hlds__hlds_defns__ArgX3_8 = ((MR_Integer) (MR_hl_field(MR_mktag(0), hlds__hlds_defns__HeadVar__2_2, (MR_Integer) 2)));
        MR_Integer hlds__hlds_defns__ArgY3_9 = ((MR_Integer) (MR_hl_field(MR_mktag(0), hlds__hlds_defns__HeadVar__3_3, (MR_Integer) 2)));
        MR_Word hlds__hlds_defns__Var_10;

        {
          hlds__hlds_defns____Compare____name_arity_0_0(&hlds__hlds_defns__Var_10, hlds__hlds_defns__ArgX1_4, hlds__hlds_defns__ArgY1_5);
        }
        hlds__hlds_defns__succeeded = (hlds__hlds_defns__Var_10 == (MR_Integer) 0);
        hlds__hlds_defns__succeeded = !(hlds__hlds_defns__succeeded);
        if (hlds__hlds_defns__succeeded)
          *hlds__hlds_defns__HeadVar__1_1 = hlds__hlds_defns__Var_10;
        else
          {
            MR_Word hlds__hlds_defns__Var_11;

            {
              mercury__private_builtin__builtin_compare_string_3_p_0(&hlds__hlds_defns__Var_11, hlds__hlds_defns__ArgX2_6, hlds__hlds_defns__ArgY2_7);
            }
            hlds__hlds_defns__succeeded = (hlds__hlds_defns__Var_11 == (MR_Integer) 0);
            hlds__hlds_defns__succeeded = !(hlds__hlds_defns__succeeded);
            if (hlds__hlds_defns__succeeded)
              *hlds__hlds_defns__HeadVar__1_1 = hlds__hlds_defns__Var_11;
            else
              {
                mercury__private_builtin__builtin_compare_int_3_p_0(hlds__hlds_defns__HeadVar__1_1, hlds__hlds_defns__ArgX3_8, hlds__hlds_defns__ArgY3_9);
              }
          }
      }
  }
  ...
  MR_Word hlds__hlds_defns__HeadVar__2_2)
{
  {
    MR_bool hlds__hlds_defns__succeeded;
    MR_Integer hlds__hlds_defns__CastX_9 = (MR_Integer) hlds__hlds_defns__HeadVar__1_1;
    MR_Integer hlds__hlds_defns__CastY_10 = (MR_Integer) hlds__hlds_defns__HeadVar__2_2;
    ...
    if (hlds__hlds_defns__succeeded)
      ...
      {
        MR_Word hlds__hlds_defns__ArgX1_3 = ((MR_Word) (MR_hl_field(MR_mktag(0), hlds__hlds_defns__HeadVar__1_1, (MR_Integer) 0)));
        MR_Word hlds__hlds_defns__ArgY1_4 = ((MR_Word) (MR_hl_field(MR_mktag(0), hlds__hlds_defns__HeadVar__2_2, (MR_Integer) 0)));
        MR_String hlds__hlds_defns__ArgX2_5 = ((MR_String) (MR_hl_field(MR_mktag(0), hlds__hlds_defns__HeadVar__1_1, (MR_Integer) 1)));
        MR_String hlds__hlds_defns__ArgY2_6 = ((MR_String) (MR_hl_field(MR_mktag(0), hlds__hlds_defns__HeadVar__2_2, (MR_Integer) 1)));
        MR_Integer hlds__hlds_defns__ArgX3_7 = ((MR_Integer) (MR_hl_field(MR_mktag(0), hlds__hlds_defns__HeadVar__1_1, (MR_Integer) 2)));
        MR_Integer hlds__hlds_defns__ArgY3_8 = ((MR_Integer) (MR_hl_field(MR_mktag(0), hlds__hlds_defns__HeadVar__2_2, (MR_Integer) 2)));

        {
          hlds__hlds_defns__succeeded = hlds__hlds_defns____Unify____name_arity_0_0(hlds__hlds_defns__ArgX1_3, hlds__hlds_defns__ArgY1_4);
        }
        if (hlds__hlds_defns__succeeded)
          {
            hlds__hlds_defns__succeeded = (strcmp(hlds__hlds_defns__ArgX2_5, hlds__hlds_defns__ArgY2_6) == 0);
            if (hlds__hlds_defns__succeeded)
              hlds__hlds_defns__succeeded = (hlds__hlds_defns__ArgX3_7 == hlds__hlds_defns__ArgY3_8);
          }
      }
    return hlds__hlds_defns__succeeded;
  }
...
{
  {
    ...
    if (hlds__hlds_defns__succeeded)
      *hlds__hlds_defns__HeadVar__1_1 = (MR_Integer) 0;
      ...
      {
        MR_String hlds__hlds_defns__ArgX1_4 = ((MR_String) (MR_hl_field(MR_mktag(0), hlds__hlds_defns__HeadVar__2_2, (MR_Integer) 0)));
        MR_String hlds__hlds_defns__ArgY1_5 = ((MR_String) (MR_hl_field(MR_mktag(0), hlds__hlds_defns__HeadVar__3_3, (MR_Integer) 0)));
        MR_Integer hlds__hlds_defns__ArgX2_6 = ((MR_Integer) (MR_hl_field(MR_mktag(0), hlds__hlds_defns__HeadVar__2_2, (MR_Integer) 1)));
        MR_Integer hlds__hlds_defns__ArgY2_7 = ((MR_Integer) (MR_hl_field(MR_mktag(0), hlds__hlds_defns__HeadVar__3_3, (MR_Integer) 1)));
        MR_Word hlds__hlds_defns__Var_8;

        {
          mercury__private_builtin__builtin_compare_string_3_p_0(&hlds__hlds_defns__Var_8, hlds__hlds_defns__ArgX1_4, hlds__hlds_defns__ArgY1_5);
        }
        ...
        if (hlds__hlds_defns__succeeded)
          *hlds__hlds_defns__HeadVar__1_1 = hlds__hlds_defns__Var_8;
          ...
          {
            mercury__private_builtin__builtin_compare_int_3_p_0(hlds__hlds_defns__HeadVar__1_1, hlds__hlds_defns__ArgX2_6, hlds__hlds_defns__ArgY2_7);
          }
      }
  }
}
...
{
  {
    ...
    if (hlds__hlds_defns__succeeded)
      ...
      {
        MR_String hlds__hlds_defns__ArgX1_3 = ((MR_String) (MR_hl_field(MR_mktag(0), hlds__hlds_defns__HeadVar__1_1, (MR_Integer) 0)));
        MR_String hlds__hlds_defns__ArgY1_4 = ((MR_String) (MR_hl_field(MR_mktag(0), hlds__hlds_defns__HeadVar__2_2, (MR_Integer) 0)));
        MR_Integer hlds__hlds_defns__ArgX2_5 = ((MR_Integer) (MR_hl_field(MR_mktag(0), hlds__hlds_defns__HeadVar__1_1, (MR_Integer) 1)));
        MR_Integer hlds__hlds_defns__ArgY2_6 = ((MR_Integer) (MR_hl_field(MR_mktag(0), hlds__hlds_defns__HeadVar__2_2, (MR_Integer) 1)));

        hlds__hlds_defns__succeeded = (strcmp(hlds__hlds_defns__ArgX1_3, hlds__hlds_defns__ArgY1_4) == 0);
        if (hlds__hlds_defns__succeeded)
          hlds__hlds_defns__succeeded = (hlds__hlds_defns__ArgX2_5 == hlds__hlds_defns__ArgY2_6);
      }
    return hlds__hlds_defns__succeeded;
  }
}
  ...
  MR_Word hlds__hlds_defns__PredLineCount_6)
{
  {
    MR_bool hlds__hlds_defns__succeeded;
    MR_Word hlds__hlds_defns__PredNameArity_8 = ((MR_Word) (MR_hl_field(MR_mktag(0), hlds__hlds_defns__PredLineCount_6, (MR_Integer) 0)));
    MR_String hlds__hlds_defns__FileName_9 = ((MR_String) (MR_hl_field(MR_mktag(0), hlds__hlds_defns__PredLineCount_6, (MR_Integer) 1)));
    MR_Integer hlds__hlds_defns__LineCount_10 = ((MR_Integer) (MR_hl_field(MR_mktag(0), hlds__hlds_defns__PredLineCount_6, (MR_Integer) 2)));
    MR_String hlds__hlds_defns__PredName_11 = ((MR_String) (MR_hl_field(MR_mktag(0), hlds__hlds_defns__PredNameArity_8, (MR_Integer) 0)));
    MR_Integer hlds__hlds_defns__PredArity_12 = ((MR_Integer) (MR_hl_field(MR_mktag(0), hlds__hlds_defns__PredNameArity_8, (MR_Integer) 1)));
    MR_String hlds__hlds_defns__PredNameArityStr_13;
    MR_String hlds__hlds_defns__Var_31;
    MR_Word hlds__hlds_defns__Var_37 = (MR_Word) &hlds__hlds_defns_scalar_common_5[0];
    MR_String hlds__hlds_defns__Var_39;
    MR_String hlds__hlds_defns__Var_41;
    MR_Word hlds__hlds_defns__Var_47;
    MR_String hlds__hlds_defns__Var_52;
    MR_String hlds__hlds_defns__Var_63;

    {
      mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0(hlds__hlds_defns__Var_37, hlds__hlds_defns__PredArity_12, &hlds__hlds_defns__Var_31);
    }
    {
      hlds__hlds_defns__Var_39 = mercury__string__f_43_43_2_f_0((MR_String) "/", hlds__hlds_defns__Var_31);
    }
    {
      hlds__hlds_defns__PredNameArityStr_13 = mercury__string__f_43_43_2_f_0(hlds__hlds_defns__PredName_11, hlds__hlds_defns__Var_39);
    }
    hlds__hlds_defns__Var_47 = (MR_Word) &hlds__hlds_defns_scalar_common_5[1];
    {
      mercury__string__format__format_string_component_width_noprec_4_p_0(hlds__hlds_defns__Var_47, (MR_Integer) 40, hlds__hlds_defns__PredNameArityStr_13, &hlds__hlds_defns__Var_41);
    }
    {
      mercury__io__write_string_4_p_0(hlds__hlds_defns__Stream_5, hlds__hlds_defns__Var_41);
    }
    {
      mercury__io__write_string_4_p_0(hlds__hlds_defns__Stream_5, (MR_String) " ");
    }
    {
      mercury__string__format__format_string_component_width_noprec_4_p_0(hlds__hlds_defns__Var_47, (MR_Integer) 30, hlds__hlds_defns__FileName_9, &hlds__hlds_defns__Var_52);
    }
    {
      mercury__io__write_string_4_p_0(hlds__hlds_defns__Stream_5, hlds__hlds_defns__Var_52);
    }
    {
      mercury__io__write_string_4_p_0(hlds__hlds_defns__Stream_5, (MR_String) " ");
    }
    {
      mercury__string__format__format_signed_int_component_width_noprec_4_p_0(hlds__hlds_defns__Var_37, (MR_Integer) 6, hlds__hlds_defns__LineCount_10, &hlds__hlds_defns__Var_63);
    }
    {
      mercury__io__write_string_4_p_0(hlds__hlds_defns__Stream_5, hlds__hlds_defns__Var_63);
    }
    {
      mercury__io__write_string_4_p_0(hlds__hlds_defns__Stream_5, (MR_String) "\n");
    }
  ...
  MR_Word * hlds__hlds_defns__FirstContext_4)
{
  {
    MR_bool hlds__hlds_defns__succeeded;
    MR_Word hlds__hlds_defns__GoalExpr_5 = ((MR_Word) (MR_hl_field(MR_mktag(0), hlds__hlds_defns__Goal_3, (MR_Integer) 0)));
    MR_Word hlds__hlds_defns__GoalInfo_6 = ((MR_Word) (MR_hl_field(MR_mktag(0), hlds__hlds_defns__Goal_3, (MR_Integer) 1)));

    switch (MR_tag((MR_Word) hlds__hlds_defns__GoalExpr_5)) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        {
          MR_Word hlds__hlds_defns__SubGoal_58 = (MR_Word) MR_body(((MR_Word) hlds__hlds_defns__GoalExpr_5), (MR_Integer) 0);

          {
            hlds__hlds_defns__find_first_context_2_p_0(hlds__hlds_defns__SubGoal_58, hlds__hlds_defns__FirstContext_4);
          }
        }
        break;
      case (MR_Integer) 1:
      case (MR_Integer) 2:
        {
          *hlds__hlds_defns__FirstContext_4 = hlds__hlds_goal__goal_info_get_context_1_f_0(hlds__hlds_defns__GoalInfo_6);
        }
        break;
      case (MR_Integer) 3:
        switch (((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), hlds__hlds_defns__GoalExpr_5, (MR_Integer) 0)))) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 0:
          case (MR_Integer) 1:
            {
          ...
          case (MR_Integer) 2:
            {
              MR_Word hlds__hlds_defns__SubGoals_31 = ((MR_Word) (MR_hl_field(MR_mktag(3), hlds__hlds_defns__GoalExpr_5, (MR_Integer) 2)));
              MR_Word hlds__hlds_defns___Kind_30 = ((MR_Word) (MR_hl_field(MR_mktag(3), hlds__hlds_defns__GoalExpr_5, (MR_Integer) 1)));
              MR_Word hlds__hlds_defns__LastSubGoal_32;
              MR_Box hlds__hlds_defns__conv0_LastSubGoal_32;

              {
                hlds__hlds_defns__succeeded = mercury__list__last_2_p_0((MR_Word) &hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_hlds_goal_0, hlds__hlds_defns__SubGoals_31, &hlds__hlds_defns__conv0_LastSubGoal_32);
              }
              if (hlds__hlds_defns__succeeded)
                {
                  hlds__hlds_defns__LastSubGoal_32 = ((MR_Word) hlds__hlds_defns__conv0_LastSubGoal_32);
                  hlds__hlds_defns__succeeded = MR_TRUE;
                }
              if (hlds__hlds_defns__succeeded)
                {
                  hlds__hlds_defns__find_first_context_2_p_0(hlds__hlds_defns__LastSubGoal_32, hlds__hlds_defns__FirstContext_4);
                }
              else
                {
                  *hlds__hlds_defns__FirstContext_4 = hlds__hlds_goal__goal_info_get_context_1_f_0(hlds__hlds_defns__GoalInfo_6);
          ...
          case (MR_Integer) 3:
            {
              MR_Word hlds__hlds_defns__SubGoals_68 = ((MR_Word) (MR_hl_field(MR_mktag(3), hlds__hlds_defns__GoalExpr_5, (MR_Integer) 1)));
              MR_Word hlds__hlds_defns__LastSubGoal_66;
              MR_Box hlds__hlds_defns__conv1_LastSubGoal_66;

              {
                hlds__hlds_defns__succeeded = mercury__list__last_2_p_0((MR_Word) &hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_hlds_goal_0, hlds__hlds_defns__SubGoals_68, &hlds__hlds_defns__conv1_LastSubGoal_66);
              }
              if (hlds__hlds_defns__succeeded)
                {
                  hlds__hlds_defns__LastSubGoal_66 = ((MR_Word) hlds__hlds_defns__conv1_LastSubGoal_66);
                  hlds__hlds_defns__succeeded = MR_TRUE;
                }
              if (hlds__hlds_defns__succeeded)
                {
                  hlds__hlds_defns__find_first_context_2_p_0(hlds__hlds_defns__LastSubGoal_66, hlds__hlds_defns__FirstContext_4);
                }
              else
                {
                  *hlds__hlds_defns__FirstContext_4 = hlds__hlds_goal__goal_info_get_context_1_f_0(hlds__hlds_defns__GoalInfo_6);
          ...
          case (MR_Integer) 4:
            {
              MR_Word hlds__hlds_defns__Cases_35 = ((MR_Word) (MR_hl_field(MR_mktag(3), hlds__hlds_defns__GoalExpr_5, (MR_Integer) 3)));
              MR_Word hlds__hlds_defns__Var_33 = ((MR_Word) (MR_hl_field(MR_mktag(3), hlds__hlds_defns__GoalExpr_5, (MR_Integer) 1)));
              MR_Word hlds__hlds_defns__Var_34 = ((MR_Word) (MR_hl_field(MR_mktag(3), hlds__hlds_defns__GoalExpr_5, (MR_Integer) 2)));
              MR_Word hlds__hlds_defns__LastCase_36;
              MR_Box hlds__hlds_defns__conv3_LastCase_36;

              {
                hlds__hlds_defns__succeeded = mercury__list__last_2_p_0((MR_Word) &hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_case_0, hlds__hlds_defns__Cases_35, &hlds__hlds_defns__conv3_LastCase_36);
              }
              if (hlds__hlds_defns__succeeded)
                {
                  hlds__hlds_defns__LastCase_36 = ((MR_Word) hlds__hlds_defns__conv3_LastCase_36);
                  hlds__hlds_defns__succeeded = MR_TRUE;
                }
              if (hlds__hlds_defns__succeeded)
                {
                  MR_Word hlds__hlds_defns__SubGoal_39 = ((MR_Word) (MR_hl_field(MR_mktag(0), hlds__hlds_defns__LastCase_36, (MR_Integer) 2)));
                  MR_Word hlds__hlds_defns___MainConsId_37 = ((MR_Word) (MR_hl_field(MR_mktag(0), hlds__hlds_defns__LastCase_36, (MR_Integer) 0)));
                  MR_Word hlds__hlds_defns___OtherConsIds_38 = ((MR_Word) (MR_hl_field(MR_mktag(0), hlds__hlds_defns__LastCase_36, (MR_Integer) 1)));

                  {
                    hlds__hlds_defns__find_first_context_2_p_0(hlds__hlds_defns__SubGoal_39, hlds__hlds_defns__FirstContext_4);
                  }
                }
              else
                {
          ...
          case (MR_Integer) 5:
            {
              MR_Word hlds__hlds_defns__SubGoal_71 = ((MR_Word) (MR_hl_field(MR_mktag(3), hlds__hlds_defns__GoalExpr_5, (MR_Integer) 2)));
              MR_Word hlds__hlds_defns___Reason_40 = ((MR_Word) (MR_hl_field(MR_mktag(3), hlds__hlds_defns__GoalExpr_5, (MR_Integer) 1)));

              {
                hlds__hlds_defns__find_first_context_2_p_0(hlds__hlds_defns__SubGoal_71, hlds__hlds_defns__FirstContext_4);
              }
            }
            break;
          case (MR_Integer) 6:
            {
              MR_Word hlds__hlds_defns__Else_44 = ((MR_Word) (MR_hl_field(MR_mktag(3), hlds__hlds_defns__GoalExpr_5, (MR_Integer) 4)));
              MR_Word hlds__hlds_defns___Vars_41 = ((MR_Word) (MR_hl_field(MR_mktag(3), hlds__hlds_defns__GoalExpr_5, (MR_Integer) 1)));
              MR_Word hlds__hlds_defns___Cond_42 = ((MR_Word) (MR_hl_field(MR_mktag(3), hlds__hlds_defns__GoalExpr_5, (MR_Integer) 2)));
              MR_Word hlds__hlds_defns___Then_43 = ((MR_Word) (MR_hl_field(MR_mktag(3), hlds__hlds_defns__GoalExpr_5, (MR_Integer) 3)));

              {
                hlds__hlds_defns__find_first_context_2_p_0(hlds__hlds_defns__Else_44, hlds__hlds_defns__FirstContext_4);
              }
            }
            break;
          case (MR_Integer) 7:
            {
              MR_Word hlds__hlds_defns__Shorthand_45 = ((MR_Word) (MR_hl_field(MR_mktag(3), hlds__hlds_defns__GoalExpr_5, (MR_Integer) 1)));

              switch (MR_tag((MR_Word) hlds__hlds_defns__Shorthand_45)) {
                default: /*NOTREACHED*/ MR_assert(0);
                case (MR_Integer) 0:
                  {
                    MR_Word hlds__hlds_defns__SubGoalB_47 = ((MR_Word) (MR_hl_field(MR_mktag(0), hlds__hlds_defns__Shorthand_45, (MR_Integer) 1)));
                    MR_Word hlds__hlds_defns___SubGoalA_46 = ((MR_Word) (MR_hl_field(MR_mktag(0), hlds__hlds_defns__Shorthand_45, (MR_Integer) 0)));

                    {
                      hlds__hlds_defns__find_first_context_2_p_0(hlds__hlds_defns__SubGoalB_47, hlds__hlds_defns__FirstContext_4);
                    }
                  }
                  break;
                case (MR_Integer) 1:
                  {
                    MR_Word hlds__hlds_defns__MainGoal_52 = ((MR_Word) (MR_hl_field(MR_mktag(1), hlds__hlds_defns__Shorthand_45, (MR_Integer) 4)));
                    MR_Word hlds__hlds_defns__OrElseGoals_53 = ((MR_Word) (MR_hl_field(MR_mktag(1), hlds__hlds_defns__Shorthand_45, (MR_Integer) 5)));
                    MR_Word hlds__hlds_defns___Type_48 = ((MR_Word) (MR_hl_field(MR_mktag(1), hlds__hlds_defns__Shorthand_45, (MR_Integer) 0)));
                    MR_Word hlds__hlds_defns___Outer_49 = ((MR_Word) (MR_hl_field(MR_mktag(1), hlds__hlds_defns__Shorthand_45, (MR_Integer) 1)));
                    MR_Word hlds__hlds_defns___Inner_50 = ((MR_Word) (MR_hl_field(MR_mktag(1), hlds__hlds_defns__Shorthand_45, (MR_Integer) 2)));
                    MR_Word hlds__hlds_defns___OutputVars_51 = ((MR_Word) (MR_hl_field(MR_mktag(1), hlds__hlds_defns__Shorthand_45, (MR_Integer) 3)));
                    MR_Word hlds__hlds_defns___Inners_54 = ((MR_Word) (MR_hl_field(MR_mktag(1), hlds__hlds_defns__Shorthand_45, (MR_Integer) 6)));
                    MR_Word hlds__hlds_defns__LastOrElseGoal_55;
                    MR_Box hlds__hlds_defns__conv2_LastOrElseGoal_55;

                    {
                      hlds__hlds_defns__succeeded = mercury__list__last_2_p_0((MR_Word) &hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_hlds_goal_0, hlds__hlds_defns__OrElseGoals_53, &hlds__hlds_defns__conv2_LastOrElseGoal_55);
                    }
                    if (hlds__hlds_defns__succeeded)
                      {
                        hlds__hlds_defns__LastOrElseGoal_55 = ((MR_Word) hlds__hlds_defns__conv2_LastOrElseGoal_55);
                        hlds__hlds_defns__succeeded = MR_TRUE;
                      }
                    if (hlds__hlds_defns__succeeded)
                      {
                        hlds__hlds_defns__find_first_context_2_p_0(hlds__hlds_defns__LastOrElseGoal_55, hlds__hlds_defns__FirstContext_4);
                      }
                    else
                      {
                        hlds__hlds_defns__find_first_context_2_p_0(hlds__hlds_defns__MainGoal_52, hlds__hlds_defns__FirstContext_4);
                      }
                  }
                  break;
                case (MR_Integer) 2:
                  {
                    MR_Word hlds__hlds_defns__SubGoal_59 = ((MR_Word) (MR_hl_field(MR_mktag(2), hlds__hlds_defns__Shorthand_45, (MR_Integer) 2)));
                    MR_Word hlds__hlds_defns___MaybeIO_56 = ((MR_Word) (MR_hl_field(MR_mktag(2), hlds__hlds_defns__Shorthand_45, (MR_Integer) 0)));
                    MR_Word hlds__hlds_defns___ResultVar_57 = ((MR_Word) (MR_hl_field(MR_mktag(2), hlds__hlds_defns__Shorthand_45, (MR_Integer) 1)));

                    {
                      hlds__hlds_defns__find_first_context_2_p_0(hlds__hlds_defns__SubGoal_59, hlds__hlds_defns__FirstContext_4);
                    }
                  }
                  break;
              }
  ...
  while (MR_TRUE)
    {
      /* tailcall optimized into a loop */
      {
        ...
        switch (MR_tag((MR_Word) hlds__hlds_defns__GoalExpr_5)) {
          ...
          case (MR_Integer) 0:
            {
              MR_Word hlds__hlds_defns__SubGoal_59 = (MR_Word) MR_body(((MR_Word) hlds__hlds_defns__GoalExpr_5), (MR_Integer) 0);

              /* direct tailcall eliminated */
              {
                MR_Word hlds__hlds_defns__next_value_of_Goal_3 = hlds__hlds_defns__SubGoal_59;

                hlds__hlds_defns__Goal_3 = hlds__hlds_defns__next_value_of_Goal_3;
              }
              continue;
            }
            break;
          ...
          case (MR_Integer) 3:
            switch (((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), hlds__hlds_defns__GoalExpr_5, (MR_Integer) 0)))) {
              ...
              case (MR_Integer) 2:
                {
                  ...
                  if ((hlds__hlds_defns__SubGoals_31 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
                    {
                      *hlds__hlds_defns__FirstContext_4 = hlds__hlds_goal__goal_info_get_context_1_f_0(hlds__hlds_defns__GoalInfo_6);
                    }
                  else
                    {
                      MR_Word hlds__hlds_defns__HeadSubGoal_32 = ((MR_Word) (MR_hl_field(MR_mktag(1), hlds__hlds_defns__SubGoals_31, (MR_Integer) 0)));
                      MR_Word hlds__hlds_defns___TailSubGoal_33 = ((MR_Word) (MR_hl_field(MR_mktag(1), hlds__hlds_defns__SubGoals_31, (MR_Integer) 1)));

                      /* direct tailcall eliminated */
                      {
                        MR_Word hlds__hlds_defns__next_value_of_Goal_3 = hlds__hlds_defns__HeadSubGoal_32;
              ...
              case (MR_Integer) 3:
                {
                  ...
                  if ((hlds__hlds_defns__SubGoals_68 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
                    {
                      *hlds__hlds_defns__FirstContext_4 = hlds__hlds_goal__goal_info_get_context_1_f_0(hlds__hlds_defns__GoalInfo_6);
                    }
                  else
                    {
                      MR_Word hlds__hlds_defns__HeadSubGoal_64 = ((MR_Word) (MR_hl_field(MR_mktag(1), hlds__hlds_defns__SubGoals_68, (MR_Integer) 0)));
                      MR_Word hlds__hlds_defns___TailSubGoal_63 = ((MR_Word) (MR_hl_field(MR_mktag(1), hlds__hlds_defns__SubGoals_68, (MR_Integer) 1)));

                      /* direct tailcall eliminated */
                      {
                        MR_Word hlds__hlds_defns__next_value_of_Goal_3 = hlds__hlds_defns__HeadSubGoal_64;
              ...
              case (MR_Integer) 4:
                {
                  MR_Word hlds__hlds_defns__Cases_36 = ((MR_Word) (MR_hl_field(MR_mktag(3), hlds__hlds_defns__GoalExpr_5, (MR_Integer) 3)));
                  MR_Word hlds__hlds_defns__Var_34 = ((MR_Word) (MR_hl_field(MR_mktag(3), hlds__hlds_defns__GoalExpr_5, (MR_Integer) 1)));
                  MR_Word hlds__hlds_defns__Var_35 = ((MR_Word) (MR_hl_field(MR_mktag(3), hlds__hlds_defns__GoalExpr_5, (MR_Integer) 2)));

                  if ((hlds__hlds_defns__Cases_36 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
                    {
                      *hlds__hlds_defns__FirstContext_4 = hlds__hlds_goal__goal_info_get_context_1_f_0(hlds__hlds_defns__GoalInfo_6);
                    }
                  else
                    {
                      MR_Word hlds__hlds_defns__HeadCase_37 = ((MR_Word) (MR_hl_field(MR_mktag(1), hlds__hlds_defns__Cases_36, (MR_Integer) 0)));
                      MR_Word hlds__hlds_defns__SubGoal_41 = ((MR_Word) (MR_hl_field(MR_mktag(0), hlds__hlds_defns__HeadCase_37, (MR_Integer) 2)));
                      MR_Word hlds__hlds_defns___TailCases_38 = ((MR_Word) (MR_hl_field(MR_mktag(1), hlds__hlds_defns__Cases_36, (MR_Integer) 1)));
                      MR_Word hlds__hlds_defns___MainConsId_39 = ((MR_Word) (MR_hl_field(MR_mktag(0), hlds__hlds_defns__HeadCase_37, (MR_Integer) 0)));
                      MR_Word hlds__hlds_defns___OtherConsIds_40 = ((MR_Word) (MR_hl_field(MR_mktag(0), hlds__hlds_defns__HeadCase_37, (MR_Integer) 1)));

                      /* direct tailcall eliminated */
                      {
                        MR_Word hlds__hlds_defns__next_value_of_Goal_3 = hlds__hlds_defns__SubGoal_41;
              ...
              case (MR_Integer) 5:
                {
                  MR_Word hlds__hlds_defns__SubGoal_71 = ((MR_Word) (MR_hl_field(MR_mktag(3), hlds__hlds_defns__GoalExpr_5, (MR_Integer) 2)));
                  MR_Word hlds__hlds_defns___Reason_42 = ((MR_Word) (MR_hl_field(MR_mktag(3), hlds__hlds_defns__GoalExpr_5, (MR_Integer) 1)));

                  /* direct tailcall eliminated */
                  {
                    MR_Word hlds__hlds_defns__next_value_of_Goal_3 = hlds__hlds_defns__SubGoal_71;
              ...
              case (MR_Integer) 6:
                {
                  MR_Word hlds__hlds_defns__Cond_44 = ((MR_Word) (MR_hl_field(MR_mktag(3), hlds__hlds_defns__GoalExpr_5, (MR_Integer) 2)));
                  MR_Word hlds__hlds_defns___Vars_43 = ((MR_Word) (MR_hl_field(MR_mktag(3), hlds__hlds_defns__GoalExpr_5, (MR_Integer) 1)));
                  MR_Word hlds__hlds_defns___Then_45 = ((MR_Word) (MR_hl_field(MR_mktag(3), hlds__hlds_defns__GoalExpr_5, (MR_Integer) 3)));
                  MR_Word hlds__hlds_defns___Else_46 = ((MR_Word) (MR_hl_field(MR_mktag(3), hlds__hlds_defns__GoalExpr_5, (MR_Integer) 4)));

                  /* direct tailcall eliminated */
                  {
                    MR_Word hlds__hlds_defns__next_value_of_Goal_3 = hlds__hlds_defns__Cond_44;
              ...
              case (MR_Integer) 7:
                {
                  MR_Word hlds__hlds_defns__Shorthand_47 = ((MR_Word) (MR_hl_field(MR_mktag(3), hlds__hlds_defns__GoalExpr_5, (MR_Integer) 1)));

                  switch (MR_tag((MR_Word) hlds__hlds_defns__Shorthand_47)) {
                    default: /*NOTREACHED*/ MR_assert(0);
                    case (MR_Integer) 0:
                      {
                        MR_Word hlds__hlds_defns__SubGoalA_48 = ((MR_Word) (MR_hl_field(MR_mktag(0), hlds__hlds_defns__Shorthand_47, (MR_Integer) 0)));
                        MR_Word hlds__hlds_defns___SubGoalB_49 = ((MR_Word) (MR_hl_field(MR_mktag(0), hlds__hlds_defns__Shorthand_47, (MR_Integer) 1)));

                        /* direct tailcall eliminated */
                        {
                          MR_Word hlds__hlds_defns__next_value_of_Goal_3 = hlds__hlds_defns__SubGoalA_48;
                    ...
                    case (MR_Integer) 1:
                      {
                        MR_Word hlds__hlds_defns__MainGoal_54 = ((MR_Word) (MR_hl_field(MR_mktag(1), hlds__hlds_defns__Shorthand_47, (MR_Integer) 4)));
                        MR_Word hlds__hlds_defns___Type_50 = ((MR_Word) (MR_hl_field(MR_mktag(1), hlds__hlds_defns__Shorthand_47, (MR_Integer) 0)));
                        MR_Word hlds__hlds_defns___Outer_51 = ((MR_Word) (MR_hl_field(MR_mktag(1), hlds__hlds_defns__Shorthand_47, (MR_Integer) 1)));
                        MR_Word hlds__hlds_defns___Inner_52 = ((MR_Word) (MR_hl_field(MR_mktag(1), hlds__hlds_defns__Shorthand_47, (MR_Integer) 2)));
                        MR_Word hlds__hlds_defns___OutputVars_53 = ((MR_Word) (MR_hl_field(MR_mktag(1), hlds__hlds_defns__Shorthand_47, (MR_Integer) 3)));
                        MR_Word hlds__hlds_defns___OrElseGoals_55 = ((MR_Word) (MR_hl_field(MR_mktag(1), hlds__hlds_defns__Shorthand_47, (MR_Integer) 5)));
                        MR_Word hlds__hlds_defns___Inners_56 = ((MR_Word) (MR_hl_field(MR_mktag(1), hlds__hlds_defns__Shorthand_47, (MR_Integer) 6)));

                        /* direct tailcall eliminated */
                        {
                          MR_Word hlds__hlds_defns__next_value_of_Goal_3 = hlds__hlds_defns__MainGoal_54;
                    ...
                    case (MR_Integer) 2:
                      {
                        MR_Word hlds__hlds_defns__SubGoal_60 = ((MR_Word) (MR_hl_field(MR_mktag(2), hlds__hlds_defns__Shorthand_47, (MR_Integer) 2)));
                        MR_Word hlds__hlds_defns___MaybeIO_57 = ((MR_Word) (MR_hl_field(MR_mktag(2), hlds__hlds_defns__Shorthand_47, (MR_Integer) 0)));
                        MR_Word hlds__hlds_defns___ResultVar_58 = ((MR_Word) (MR_hl_field(MR_mktag(2), hlds__hlds_defns__Shorthand_47, (MR_Integer) 1)));

                        /* direct tailcall eliminated */
                        {
                          MR_Word hlds__hlds_defns__next_value_of_Goal_3 = hlds__hlds_defns__SubGoal_60;
  ...
  MR_Word * hlds__hlds_defns__STATE_VARIABLE_PredLineCounts_33)
{
  {
    MR_bool hlds__hlds_defns__succeeded;
    MR_Word hlds__hlds_defns__PredModuleName_8;
    MR_Word hlds__hlds_defns__Origin_9;
    MR_Word hlds__hlds_defns__Var_10;

    {
      hlds__hlds_pred__pred_info_get_module_name_2_p_0(hlds__hlds_defns__PredInfo_6, &hlds__hlds_defns__PredModuleName_8);
    }
    {
      hlds__hlds_pred__pred_info_get_origin_2_p_0(hlds__hlds_defns__PredInfo_6, &hlds__hlds_defns__Origin_9);
    }
    {
      hlds__hlds_defns__succeeded = mdbcomp__sym_name____Unify____sym_name_0_0(hlds__hlds_defns__PredModuleName_8, hlds__hlds_defns__ModuleName_5);
    }
    if (hlds__hlds_defns__succeeded)
      {
        hlds__hlds_defns__succeeded = ((((MR_tag((MR_Word) hlds__hlds_defns__Origin_9)) == (MR_mktag((MR_Integer) 3)))) && (((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), hlds__hlds_defns__Origin_9, (MR_Integer) 0)))) == (MR_Integer) 6)));
        if (hlds__hlds_defns__succeeded)
          hlds__hlds_defns__Var_10 = ((MR_Word) (MR_hl_field(MR_mktag(3), hlds__hlds_defns__Origin_9, (MR_Integer) 1)));
      }
    if (hlds__hlds_defns__succeeded)
      {
        MR_Word hlds__hlds_defns__ClausesInfo_11;
        MR_Word hlds__hlds_defns__ClausesRep_12;
        MR_Word hlds__hlds_defns__Clauses_14;
        MR_Word hlds__hlds_defns___ItemNumbers_13;

        {
          hlds__hlds_pred__pred_info_get_clauses_info_2_p_0(hlds__hlds_defns__PredInfo_6, &hlds__hlds_defns__ClausesInfo_11);
        }
        {
          hlds__hlds_clauses__clauses_info_get_clauses_rep_3_p_0(hlds__hlds_defns__ClausesInfo_11, &hlds__hlds_defns__ClausesRep_12, &hlds__hlds_defns___ItemNumbers_13);
        }
        {
          hlds__hlds_clauses__get_clause_list_maybe_repeated_2_p_0(hlds__hlds_defns__ClausesRep_12, &hlds__hlds_defns__Clauses_14);
        }
        if ((hlds__hlds_defns__Clauses_14 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
          *hlds__hlds_defns__STATE_VARIABLE_PredLineCounts_33 = hlds__hlds_defns__STATE_VARIABLE_PredLineCounts_0_32;
        else
          {
            MR_Word hlds__hlds_defns__TailClauses_16 = ((MR_Word) (MR_hl_field(MR_mktag(1), hlds__hlds_defns__Clauses_14, (MR_Integer) 1)));
            MR_Word hlds__hlds_defns__FirstClause_17 = ((MR_Word) (MR_hl_field(MR_mktag(1), hlds__hlds_defns__Clauses_14, (MR_Integer) 0)));
            MR_Word hlds__hlds_defns__LastClause_19;
            MR_Word hlds__hlds_defns__FirstContext_20;
            MR_Word hlds__hlds_defns__LastContext_21;
            MR_String hlds__hlds_defns__FirstFileName_22;
            MR_Integer hlds__hlds_defns__FirstLineNumber_23;
            MR_String hlds__hlds_defns__LastFileName_24;
            MR_Integer hlds__hlds_defns__LastLineNumber_25;
            MR_Word hlds__hlds_defns__Var_34;
            MR_Word hlds__hlds_defns__Var_35;
            MR_Word hlds__hlds_defns__LastClausePrime_18;
            MR_Box hlds__hlds_defns__conv0_LastClausePrime_18;

            {
              hlds__hlds_defns__succeeded = mercury__list__last_2_p_0((MR_Word) &hlds__hlds_clauses__hlds__hlds_clauses__type_ctor_info_clause_0, hlds__hlds_defns__TailClauses_16, &hlds__hlds_defns__conv0_LastClausePrime_18);
            }
            if (hlds__hlds_defns__succeeded)
              {
                hlds__hlds_defns__LastClausePrime_18 = ((MR_Word) hlds__hlds_defns__conv0_LastClausePrime_18);
                hlds__hlds_defns__succeeded = MR_TRUE;
              }
            if (hlds__hlds_defns__succeeded)
              hlds__hlds_defns__LastClause_19 = hlds__hlds_defns__LastClausePrime_18;
            else
              hlds__hlds_defns__LastClause_19 = hlds__hlds_defns__FirstClause_17;
            {
              hlds__hlds_defns__Var_34 = hlds__hlds_clauses__clause_body_1_f_0(hlds__hlds_defns__FirstClause_17);
            }
            {
              hlds__hlds_defns__find_first_context_2_p_0(hlds__hlds_defns__Var_34, &hlds__hlds_defns__FirstContext_20);
            }
            {
              hlds__hlds_defns__Var_35 = hlds__hlds_clauses__clause_body_1_f_0(hlds__hlds_defns__LastClause_19);
            }
            {
              hlds__hlds_defns__find_last_context_2_p_0(hlds__hlds_defns__Var_35, &hlds__hlds_defns__LastContext_21);
            }
            hlds__hlds_defns__FirstFileName_22 = ((MR_String) (MR_hl_field(MR_mktag(0), hlds__hlds_defns__FirstContext_20, (MR_Integer) 0)));
            hlds__hlds_defns__FirstLineNumber_23 = ((MR_Integer) (MR_hl_field(MR_mktag(0), hlds__hlds_defns__FirstContext_20, (MR_Integer) 1)));
            hlds__hlds_defns__LastFileName_24 = ((MR_String) (MR_hl_field(MR_mktag(0), hlds__hlds_defns__LastContext_21, (MR_Integer) 0)));
            hlds__hlds_defns__LastLineNumber_25 = ((MR_Integer) (MR_hl_field(MR_mktag(0), hlds__hlds_defns__LastContext_21, (MR_Integer) 1)));
            hlds__hlds_defns__succeeded = (strcmp(hlds__hlds_defns__FirstFileName_22, hlds__hlds_defns__LastFileName_24) == 0);
            if (hlds__hlds_defns__succeeded)
              {
                MR_String hlds__hlds_defns__PredName_26;
                MR_Integer hlds__hlds_defns__PredArity_27;
                MR_Word hlds__hlds_defns__PredNameArity_28;
                MR_Integer hlds__hlds_defns__Extent_29;
                MR_Integer hlds__hlds_defns__LineCount_30;
                MR_Word hlds__hlds_defns__PLC_31;
                MR_Integer hlds__hlds_defns__Var_36;

                {
                  hlds__hlds_pred__pred_info_get_name_2_p_0(hlds__hlds_defns__PredInfo_6, &hlds__hlds_defns__PredName_26);
                }
                {
                  hlds__hlds_defns__PredArity_27 = hlds__hlds_pred__pred_info_orig_arity_1_f_0(hlds__hlds_defns__PredInfo_6);
                }
                {
                  hlds__hlds_defns__PredNameArity_28 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
                  MR_hl_field(MR_mktag(0), hlds__hlds_defns__PredNameArity_28, 0) = ((MR_Box) (hlds__hlds_defns__PredName_26));
                  MR_hl_field(MR_mktag(0), hlds__hlds_defns__PredNameArity_28, 1) = ((MR_Box) (hlds__hlds_defns__PredArity_27));
                }
                hlds__hlds_defns__Var_36 = (hlds__hlds_defns__LastLineNumber_25 - hlds__hlds_defns__FirstLineNumber_23);
                hlds__hlds_defns__Extent_29 = (hlds__hlds_defns__Var_36 + (MR_Integer) 1);
                {
                  hlds__hlds_defns__LineCount_30 = mercury__int__abs_1_f_0(hlds__hlds_defns__Extent_29);
                }
                {
                  hlds__hlds_defns__PLC_31 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL);
                  MR_hl_field(MR_mktag(0), hlds__hlds_defns__PLC_31, 0) = ((MR_Box) (hlds__hlds_defns__PredNameArity_28));
                  MR_hl_field(MR_mktag(0), hlds__hlds_defns__PLC_31, 1) = ((MR_Box) (hlds__hlds_defns__FirstFileName_22));
                  MR_hl_field(MR_mktag(0), hlds__hlds_defns__PLC_31, 2) = ((MR_Box) (hlds__hlds_defns__LineCount_30));
                }
                {
                  MR_Word base;
                  base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                  *hlds__hlds_defns__STATE_VARIABLE_PredLineCounts_33 = base;
                  MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (hlds__hlds_defns__PLC_31));
                  MR_hl_field(MR_mktag(1), base, 1) = ((MR_Box) (hlds__hlds_defns__STATE_VARIABLE_PredLineCounts_0_32));
                }
              }
            else
              *hlds__hlds_defns__STATE_VARIABLE_PredLineCounts_33 = hlds__hlds_defns__STATE_VARIABLE_PredLineCounts_0_32;
            ...
            if (hlds__hlds_defns__succeeded)
              {
                ...
                {
                  mercury__list__map_3_p_0((MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0, hlds__hlds_defns__TypeCtorInfo_49_49, (MR_Word) &hlds__hlds_defns_scalar_common_4[0], hlds__hlds_defns__OrigTypes_18, &hlds__hlds_defns__OrigTypeDescs_29);
                }
                {
                ...
                {
                  mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) &hlds__hlds_defns_scalar_common_5[0], hlds__hlds_defns__ClassArity_27, &hlds__hlds_defns__Var_54);
                }
                {
...
{
  {
    ...
    {
      hlds__hlds_defns__write_pred_line_count_4_p_0(((MR_Word) (MR_hl_field(MR_mktag(0), hlds__hlds_defns__closure, (MR_Integer) 3))), ((MR_Word) hlds__hlds_defns__wrapper_arg_1));
    }
  }
}
  ...
  MR_Box * hlds__hlds_defns__wrapper_arg_3)
{
  {
    MR_Box hlds__hlds_defns__closure = hlds__hlds_defns__closure_arg;
    MR_Word hlds__hlds_defns__conv0_STATE_VARIABLE_PredLineCounts_33;

    {
      hlds__hlds_defns__gather_pred_line_counts_4_p_0(((MR_Word) (MR_hl_field(MR_mktag(0), hlds__hlds_defns__closure, (MR_Integer) 3))), ((MR_Word) hlds__hlds_defns__wrapper_arg_1), ((MR_Word) hlds__hlds_defns__wrapper_arg_2), &hlds__hlds_defns__conv0_STATE_VARIABLE_PredLineCounts_33);
    }
    *hlds__hlds_defns__wrapper_arg_3 = ((MR_Box) (hlds__hlds_defns__conv0_STATE_VARIABLE_PredLineCounts_33));
  }
}
  ...
  MR_Word hlds__hlds_defns__ModuleInfo_6)
{
  {
    MR_bool hlds__hlds_defns__succeeded;
    MR_Word hlds__hlds_defns__TypeCtorInfo_20_20;
    MR_Word hlds__hlds_defns__TypeCtorInfo_25_25;
    MR_Word hlds__hlds_defns__ModuleName_8;
    MR_Word hlds__hlds_defns__Preds_9;
    MR_Word hlds__hlds_defns__PredInfos_10;
    MR_Word hlds__hlds_defns__PredLineCounts_11;
    MR_Word hlds__hlds_defns__SortedPredLineCounts_12;
    MR_Word hlds__hlds_defns__Var_15;
    MR_Word hlds__hlds_defns__Var_17;
    MR_Box hlds__hlds_defns__conv1_PredLineCounts_11;
    MR_Box hlds__hlds_defns__conv2_STATE_VARIABLE_IO_14;

    {
      hlds__hlds_module__module_info_get_name_2_p_0(hlds__hlds_defns__ModuleInfo_6, &hlds__hlds_defns__ModuleName_8);
    }
    {
      hlds__hlds_module__module_info_get_preds_2_p_0(hlds__hlds_defns__ModuleInfo_6, &hlds__hlds_defns__Preds_9);
    }
    hlds__hlds_defns__TypeCtorInfo_20_20 = (MR_Word) &hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_info_0;
    {
      mercury__map__values_2_p_0((MR_Word) &hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_id_0, hlds__hlds_defns__TypeCtorInfo_20_20, hlds__hlds_defns__Preds_9, &hlds__hlds_defns__PredInfos_10);
    }
    {
      hlds__hlds_defns__Var_15 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), hlds__hlds_defns__Var_15, 0) = ((MR_Box) (&hlds__hlds_defns_scalar_common_2[0]));
      MR_hl_field(MR_mktag(0), hlds__hlds_defns__Var_15, 1) = ((MR_Box) (hlds__hlds_defns__write_hlds_defn_line_counts_4_p_0_1));
      MR_hl_field(MR_mktag(0), hlds__hlds_defns__Var_15, 2) = ((MR_Box) (MR_Word) ((MR_Integer) 1));
      MR_hl_field(MR_mktag(0), hlds__hlds_defns__Var_15, 3) = ((MR_Box) (hlds__hlds_defns__ModuleName_8));
    }
    {
      mercury__list__foldl_4_p_0(hlds__hlds_defns__TypeCtorInfo_20_20, (MR_Word) &hlds__hlds_defns_scalar_common_1[1], hlds__hlds_defns__Var_15, hlds__hlds_defns__PredInfos_10, ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))), &hlds__hlds_defns__conv1_PredLineCounts_11);
    }
    hlds__hlds_defns__PredLineCounts_11 = ((MR_Word) hlds__hlds_defns__conv1_PredLineCounts_11);
    hlds__hlds_defns__TypeCtorInfo_25_25 = (MR_Word) &hlds__hlds_defns__hlds__hlds_defns__type_ctor_info_pred_line_count_0;
    {
      mercury__list__sort_2_p_0(hlds__hlds_defns__TypeCtorInfo_25_25, hlds__hlds_defns__PredLineCounts_11, &hlds__hlds_defns__SortedPredLineCounts_12);
    }
    {
      hlds__hlds_defns__Var_17 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), hlds__hlds_defns__Var_17, 0) = ((MR_Box) (&hlds__hlds_defns_scalar_common_2[1]));
      MR_hl_field(MR_mktag(0), hlds__hlds_defns__Var_17, 1) = ((MR_Box) (hlds__hlds_defns__write_hlds_defn_line_counts_4_p_0_2));
      MR_hl_field(MR_mktag(0), hlds__hlds_defns__Var_17, 2) = ((MR_Box) (MR_Word) ((MR_Integer) 1));
      MR_hl_field(MR_mktag(0), hlds__hlds_defns__Var_17, 3) = ((MR_Box) (hlds__hlds_defns__Stream_5));
    }
    {
      mercury__list__foldl_4_p_2(hlds__hlds_defns__TypeCtorInfo_25_25, (MR_Word) &mercury__io__io__type_ctor_info_state_0, hlds__hlds_defns__Var_17, hlds__hlds_defns__SortedPredLineCounts_12, ((MR_Box) ((MR_Integer) 0)), &hlds__hlds_defns__conv2_STATE_VARIABLE_IO_14);
    }
  }
}
