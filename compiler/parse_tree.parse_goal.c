...
static void MR_CALL 
parse_tree__parse_goal__IntroducedFrom__pred__parse_atomic_component__2369__1_2_p_0(
...
{
  {
    ...
    parse_tree__parse_goal__IntroducedFrom__pred__parse_atomic_component__2369__1_2_p_0(((MR_Word) (wrapper_arg_1)), &conv0_HeadVar__2_140);
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
...

            {
              ...
              MR_hl_field(MR_mktag(0), Var_72, 0) = ((MR_Box) (&parse_tree__parse_goal_scalar_common_5[1]));
