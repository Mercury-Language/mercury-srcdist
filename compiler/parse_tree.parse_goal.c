            ...
            /* case "catch_any" */
            {
              ...
              else
              {
...

                {
                  ...
                  MR_hl_field(MR_mktag(0), Var_305, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &parse_tree__parse_goal_scalar_common_1[371])));
                }
                {
                  ...
                  if ((DuplicateSpecs_30 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
                    if ((NonDuplicateWarnings_29 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
                    {
                      ...
                      }
                      {
                        ...
                        MR_hl_field(MR_mktag(1), Var_751, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &parse_tree__parse_goal_scalar_common_1[372])));
            ...
            /* case "else" */
            {
                ...
                else
                {
                  ...
                  if (succeeded)
                  {
...

                    {
                      ...
                      MR_hl_field(MR_mktag(0), Var_574, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &parse_tree__parse_goal_scalar_common_1[373])));
                    }
                    {
                  ...
                  else
                  {
                    ...
                    if (succeeded)
                    {
...

                      {
                        ...
                        MR_hl_field(MR_mktag(0), Var_618, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &parse_tree__parse_goal_scalar_common_1[374])));
                      }
                      {
              ...
              else
              {
...

                {
                  ...
                  MR_hl_field(MR_mktag(0), Var_653, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &parse_tree__parse_goal_scalar_common_1[375])));
                }
                {
            ...
            /* case "if" */
            {
              ...
              if (succeeded)
              {
                ...
                if (succeeded)
                {
...

                  {
                    ...
                    MR_hl_field(MR_mktag(0), Var_459, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &parse_tree__parse_goal_scalar_common_1[376])));
                  }
                  {
                ...
                else
                {
...

                  {
                    ...
                    MR_hl_field(MR_mktag(0), Var_487, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &parse_tree__parse_goal_scalar_common_1[377])));
                  }
                  {
              ...
              else
              {
...

                {
                  ...
                  MR_hl_field(MR_mktag(0), Var_515, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &parse_tree__parse_goal_scalar_common_1[378])));
                }
                {
            ...
            /* case "then" */
            {
              ...
              if (succeeded)
              {
                ...
                if (succeeded)
                {
...

                  {
                    ...
                    MR_hl_field(MR_mktag(0), Var_344, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &parse_tree__parse_goal_scalar_common_1[376])));
                  }
                  {
              ...
              else
              {
...

                {
                  ...
                  MR_hl_field(MR_mktag(0), Var_417, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &parse_tree__parse_goal_scalar_common_1[379])));
                }
                {
...
{
  {
    ...
    else
    {
...

      {
        ...
        MR_hl_field(MR_mktag(0), Var_59, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &parse_tree__parse_goal_scalar_common_1[370])));
      }
      {
      ...
      else
      {
        ...
        if (succeeded)
        {
...

          {
            ...
            MR_hl_field(MR_mktag(0), Var_67, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &parse_tree__parse_goal_scalar_common_1[369])));
          }
          {
            Var_66 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
...
{
  {
    ...
    else
    {
      ...
      Var_103 = mercury__term__get_term_context_1_f_0((MR_Word) &mercury__term__term__type_ctor_info_generic_0, ThenTryTerm_10);
      {
        ...
        MR_hl_field(MR_mktag(0), Var_102, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &parse_tree__parse_goal_scalar_common_1[368])));
      }
      {
...
{
  {
    ...
    else
    {
      ...
      Var_54 = mercury__term__get_term_context_1_f_0((MR_Word) &mercury__term__term__type_ctor_info_generic_0, ArrowTerm_7);
      {
        ...
        MR_hl_field(MR_mktag(0), Var_53, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &parse_tree__parse_goal_scalar_common_1[367])));
      }
      {
...
{
  {
    ...
    if (succeeded)
    {
      ...
      else
      {
        ...
        Var_59 = mercury__term__get_term_context_1_f_0((MR_Word) &mercury__term__term__type_ctor_info_generic_0, ArrowTerm_7);
        {
          ...
          MR_hl_field(MR_mktag(0), Var_58, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &parse_tree__parse_goal_scalar_common_1[365])));
        }
        {
    ...
    else
    {
      ...
      Var_90 = mercury__term__get_term_context_1_f_0((MR_Word) &mercury__term__term__type_ctor_info_generic_0, ArrowTerm_7);
      {
        ...
        MR_hl_field(MR_mktag(0), Var_89, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &parse_tree__parse_goal_scalar_common_1[366])));
      }
      {
    ...
    else
    {
      ...
      if ((GoalList_9 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
      {
        ...
        Context_11 = mercury__term__get_term_context_1_f_0((MR_Word) &mercury__term__term__type_ctor_info_generic_0, Term_5);
        {
          ...
          MR_hl_field(MR_mktag(0), Var_27, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &parse_tree__parse_goal_scalar_common_1[364])));
        }
        {
