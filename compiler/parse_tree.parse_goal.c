...
static void MR_CALL 
parse_tree__parse_goal__IntroducedFrom__pred__parse_atomic_component__2936__1_2_p_0(
  ...
  MR_Box * wrapper_arg_2)
{
  ...
  parse_tree__parse_goal__IntroducedFrom__pred__parse_atomic_component__2936__1_2_p_0(((MR_Word) (wrapper_arg_1)), &conv0_HeadVar__2_172);
  ...
  MR_Word * WarningSpecs_14)
{
  ...
  else
  {
    ...
    Var_74 = mercury__term__get_term_context_1_f_0((MR_Word) (&mercury__term__term__type_ctor_info_generic_0), Term_9);
    {
      ...
      MR_hl_field(0, Spec_20, 1) = ((MR_Box) (MR_mkword(1, &parse_tree__parse_goal_scalar_common_3[6])));
      MR_hl_field(0, Spec_20, 2) = ((MR_Box) ((MR_Unsigned) 24U));
