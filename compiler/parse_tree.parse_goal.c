...
{
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        else
        {
          ...
          {
            Spec_219 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
      ...
      else
      {
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              ...
              {
                Compiletime_220 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
          ...
          else
          {
            ...
            {
              Spec_227 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
        ...
        else
        {
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                ...
                {
                  Compiletime_232 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
              ...
              else
              {
                ...
                {
                  Spec_234 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
          ...
          else
          {
            ...
            {
              Pieces_244 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            ...
            {
              Spec_245 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
    ...
    else
    {
      ...
      {
        Spec_255 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
              ...
              if (succeeded)
              {
                ...
                else
                {
                  ...
                  if (succeeded)
                  {
                    ...
                    packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), SubGoal_1374, (MR_Integer) 3)));
      ...
      case (MR_Integer) 0:
        {
          ...
          MR_Unsigned packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Goal0_9, (MR_Integer) 3)));
      ...
      case (MR_Integer) 1:
        {
          ...
          MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), Goal0_9, (MR_Integer) 3)));
