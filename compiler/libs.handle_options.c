  ...
  MR_Word * STATE_VARIABLE_Globals_10)
{
  ...
  libs__globals__lookup_int_option_3_p_0(STATE_VARIABLE_Globals_0_9, (MR_Integer) 364, &CompareSpec_4);
  ...
  if (succeeded)
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(STATE_VARIABLE_Globals_0_9, (MR_Integer) 313, &HighLevelCode_5);
    ...
    libs__globals__lookup_bool_option_3_p_0(STATE_VARIABLE_Globals_0_9, (MR_Integer) 212, &ModeConstraints_7);
    ...
    libs__globals__set_option_4_p_0((MR_Integer) 364, Var_16, STATE_VARIABLE_Globals_0_9, STATE_VARIABLE_Globals_10);
  }
  else
