...
{
  {
      ...
      case (MR_Integer) 2:
        {
          ...
          libs__globals__set_option_4_p_0((MR_Integer) 232, (MR_Word) (MR_mkword(MR_mktag(3), &libs__handle_options_scalar_common_1[221])), STATE_VARIABLE_Globals_439_439, &STATE_VARIABLE_Globals_442_442);
          ...
          switch (Target_27) {
            ...
            case (MR_Integer) 1:
              {
                libs__globals__set_option_4_p_0((MR_Integer) 588, (MR_Word) (MR_mkword(MR_mktag(3), &libs__handle_options_scalar_common_1[222])), STATE_VARIABLE_Globals_494_494, &STATE_VARIABLE_Globals_498_498);
              }
              break;
            case (MR_Integer) 2:
      ...
      case (MR_Integer) 3:
        {
          ...
          libs__globals__set_option_4_p_0((MR_Integer) 232, (MR_Word) (MR_mkword(MR_mktag(3), &libs__handle_options_scalar_common_1[221])), STATE_VARIABLE_Globals_373_373, &STATE_VARIABLE_Globals_376_376);
    ...
    {
      libs__globals__set_option_4_p_0((MR_Integer) 654, (MR_Word) (MR_mkword(MR_mktag(3), &libs__handle_options_scalar_common_1[172])), STATE_VARIABLE_Globals_533_533, &STATE_VARIABLE_Globals_538_538);
    }
    else
    ...
    if (succeeded)
      if ((MaybeConfDir_153 == (MR_Word) ((MR_Unsigned) 0U)))
      {
        libs__globals__set_option_4_p_0((MR_Integer) 657, (MR_Word) (MR_mkword(MR_mktag(3), &libs__handle_options_scalar_common_1[231])), STATE_VARIABLE_Globals_1441_1441, &STATE_VARIABLE_Globals_1453_1453);
      }
      else
      {
...
{
  {
    ...
    libs__handle_options__raw_lookup_string_option_3_p_0(STATE_VARIABLE_OptionTable_0_117, (MR_Integer) 195, &TargetStr_43);
    ...
    libs__handle_options__raw_lookup_string_option_3_p_0(STATE_VARIABLE_OptionTable_0_117, (MR_Integer) 232, &GC_MethodStr_46);
      ...
      *GC_Method_25 = (MR_Integer) 1;
      {
        ...
        MR_hl_field(MR_mktag(3), Var_163, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 0));
    ...
    libs__handle_options__raw_lookup_string_option_3_p_0(STATE_VARIABLE_OptionTable_0_117, (MR_Integer) 253, &TagsMethodStr_49);
      ...
      *TagsMethod_26 = (MR_Integer) 0;
      {
        ...
        MR_hl_field(MR_mktag(3), Var_202, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 0));
    ...
    libs__handle_options__raw_lookup_int_option_3_p_0(STATE_VARIABLE_OptionTable_0_117, (MR_Integer) 332, &FactTablePercentFull_52);
    ...
    else
    {
      ...
      {
        Var_236 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(3), Var_236, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 1));
    ...
    else
    {
...

      {
        ...
        MR_hl_field(MR_mktag(3), Var_257, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 1));
    ...
    libs__handle_options__raw_lookup_string_option_3_p_0(STATE_VARIABLE_OptionTable_0_117, (MR_Integer) 435, &TermNormStr_56);
    ...
    else
    {
      ...
      *TermNorm_27 = (MR_Integer) 0;
      {
        Var_277 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(3), Var_277, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 0));
    ...
    libs__handle_options__raw_lookup_string_option_3_p_0(STATE_VARIABLE_OptionTable_0_117, (MR_Integer) 441, &Term2NormStr_59);
    ...
    else
    {
      ...
      *Term2Norm_28 = (MR_Integer) 0;
      {
        Var_310 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(3), Var_310, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 0));
    ...
    libs__handle_options__raw_lookup_bool_option_3_p_0(STATE_VARIABLE_OptionTable_0_117, (MR_Integer) 145, &ForceDisableTracing_62);
      ...
      case (MR_Integer) 0:
        {
          ...
          libs__handle_options__raw_lookup_string_option_3_p_0(STATE_VARIABLE_OptionTable_0_117, (MR_Integer) 133, &Trace_63);
          libs__handle_options__raw_lookup_bool_option_3_p_0(STATE_VARIABLE_OptionTable_0_117, (MR_Integer) 203, &ExecTrace_64);
          libs__handle_options__raw_lookup_bool_option_3_p_0(STATE_VARIABLE_OptionTable_0_117, (MR_Integer) 204, &DeclDebug_65);
          ...
          if (succeeded)
            if ((MaybeTraceLevel_66 == (MR_Word) ((MR_Unsigned) 0U)))
            {
              ...
              *TraceLevel_29 = libs__trace_params__trace_level_none_0_f_0();
              {
                Var_345 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), Var_345, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 0));
          ...
          else
          {
            ...
            *TraceLevel_29 = libs__trace_params__trace_level_none_0_f_0();
            {
              Var_364 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(3), Var_364, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 0));
              MR_hl_field(MR_mktag(3), Var_364, 1) = ((MR_Box) (Trace_63));
            }
            {
              Var_363 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
    ...
    libs__handle_options__raw_lookup_string_option_3_p_0(STATE_VARIABLE_OptionTable_0_117, (MR_Integer) 144, &SuppressStr_69);
    ...
    else
    {
      ...
      *TraceSuppress_30 = libs__trace_params__default_trace_suppress_0_f_0();
      {
        Var_402 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(3), Var_402, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 0));
    ...
    libs__handle_options__raw_lookup_bool_option_3_p_0(STATE_VARIABLE_OptionTable_0_117, (MR_Integer) 149, &ForceDisableSSDB_72);
      ...
      case (MR_Integer) 0:
        {
          ...
          libs__handle_options__raw_lookup_string_option_3_p_0(STATE_VARIABLE_OptionTable_0_117, (MR_Integer) 251, &SSTrace_73);
          libs__handle_options__raw_lookup_bool_option_3_p_0(STATE_VARIABLE_OptionTable_0_117, (MR_Integer) 250, &SSDB_74);
          ...
          else
          {
            ...
            *SSTraceLevel_31 = (MR_Integer) 0;
            {
              Var_424 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(3), Var_424, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 0));
              MR_hl_field(MR_mktag(3), Var_424, 1) = ((MR_Box) (SSTrace_73));
            }
            {
              Var_423 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
    ...
    libs__handle_options__raw_lookup_string_option_3_p_0(STATE_VARIABLE_OptionTable_0_117, (MR_Integer) 243, &MaybeThreadSafeStr_77);
    ...
    else
    {
      ...
      *MaybeThreadSafe_32 = (MR_Integer) 0;
      {
        Var_459 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(3), Var_459, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 0));
    ...
    libs__handle_options__raw_lookup_string_option_3_p_0(STATE_VARIABLE_OptionTable_0_117, (MR_Integer) 168, &DumpAlias_80);
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        {
          Var_490 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(3), Var_490, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 0));
          MR_hl_field(MR_mktag(3), Var_490, 1) = ((MR_Box) (AliasDumpOptions_81));
        }
        mercury__map__set_4_p_0((MR_Word) (&libs__options__libs__options__type_ctor_info_option_0), (MR_Word) (&mercury__getopt_io__getopt_io__type_ctor_info_option_data_0), ((MR_Box) ((MR_Integer) 169)), ((MR_Box) (Var_490)), STATE_VARIABLE_OptionTable_0_117, &STATE_VARIABLE_OptionTable_491_491);
        STATE_VARIABLE_Specs_518_518 = STATE_VARIABLE_Specs_487_487;
      }
      else
      {
        ...
        {
          Var_495 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(3), Var_495, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 0));
          MR_hl_field(MR_mktag(3), Var_495, 1) = ((MR_Box) (DumpAlias_80));
        }
        {
          Var_494 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
    ...
    mercury__getopt_io__lookup_string_option_3_p_0((MR_Word) (&libs__options__libs__options__type_ctor_info_option_0), STATE_VARIABLE_OptionTable_491_491, ((MR_Box) ((MR_Integer) 169)), &STATE_VARIABLE_DumpOptions_520_520);
    ...
    {
      Var_555 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(3), Var_555, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 0));
      MR_hl_field(MR_mktag(3), Var_555, 1) = ((MR_Box) (STATE_VARIABLE_DumpOptions_552_552));
    }
    mercury__map__set_4_p_0((MR_Word) (&libs__options__libs__options__type_ctor_info_option_0), (MR_Word) (&mercury__getopt_io__getopt_io__type_ctor_info_option_data_0), ((MR_Box) ((MR_Integer) 169)), ((MR_Box) (Var_555)), STATE_VARIABLE_OptionTable_491_491, STATE_VARIABLE_OptionTable_118);
    libs__handle_options__raw_lookup_string_option_3_p_0(*STATE_VARIABLE_OptionTable_118, (MR_Integer) 530, &C_CompilerTypeStr_84);
    ...
    else
    {
      ...
      *C_CompilerType_33 = (MR_Word) ((MR_Unsigned) 0U);
      {
        Var_562 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(3), Var_562, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 0));
    ...
    libs__handle_options__raw_lookup_string_option_3_p_0(*STATE_VARIABLE_OptionTable_118, (MR_Integer) 531, &CSharp_CompilerTypeStr_87);
    ...
    else
    {
      ...
      *CSharp_CompilerType_34 = (MR_Integer) 2;
      {
        Var_600 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(3), Var_600, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 0));
    ...
    libs__handle_options__raw_lookup_string_option_3_p_0(*STATE_VARIABLE_OptionTable_118, (MR_Integer) 426, &ReuseConstraintStr_90);
    libs__handle_options__raw_lookup_int_option_3_p_0(*STATE_VARIABLE_OptionTable_118, (MR_Integer) 427, &ReuseConstraintArgNum_91);
    ...
    else
    {
      ...
      *ReuseStrategy_35 = (MR_Word) ((MR_Unsigned) 0U);
      {
        Var_637 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(3), Var_637, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 0));
        MR_hl_field(MR_mktag(3), Var_637, 1) = ((MR_Box) (ReuseConstraintStr_90));
      }
      {
        Var_636 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      ...
      {
        Var_633 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
    ...
    libs__handle_options__raw_lookup_string_option_3_p_0(*STATE_VARIABLE_OptionTable_118, (MR_Integer) 688, &FeedbackFile_94);
    ...
    else
    {
      ...
      if (((MR_tag((MR_Word) FeedbackReadResult_96)) == (MR_Integer) 1))
      {
        ...
        {
          Var_668 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(3), Var_668, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 5));
          MR_hl_field(MR_mktag(3), Var_668, 1) = ((MR_Box) (ErrorMessage_99));
        }
        {
          Var_666 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
    ...
    libs__handle_options__raw_lookup_string_option_3_p_0(*STATE_VARIABLE_OptionTable_118, (MR_Integer) 670, &HostEnvTypeStr_100);
    ...
    else
    {
      ...
      *HostEnvType_37 = (MR_Integer) 0;
      {
        Var_675 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(3), Var_675, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 0));
      ...
      {
        Var_671 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
    ...
    libs__handle_options__raw_lookup_string_option_3_p_0(*STATE_VARIABLE_OptionTable_118, (MR_Integer) 671, &SystemEnvTypeStr_103);
    ...
    else
    {
      ...
      *SystemEnvType_38 = (MR_Integer) 0;
      {
        Var_710 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(3), Var_710, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 0));
        MR_hl_field(MR_mktag(3), Var_710, 1) = ((MR_Box) (SystemEnvTypeStr_103));
      }
      {
        Var_709 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      ...
      {
        Var_706 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
    ...
    libs__handle_options__raw_lookup_string_option_3_p_0(*STATE_VARIABLE_OptionTable_118, (MR_Integer) 672, &TargetEnvTypeStr_106);
    ...
    else
    {
      ...
      *TargetEnvType_39 = (MR_Integer) 0;
      {
        Var_748 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(3), Var_748, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 0));
        MR_hl_field(MR_mktag(3), Var_748, 1) = ((MR_Box) (TargetEnvTypeStr_106));
      }
      {
        Var_747 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      ...
      {
        Var_744 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
    ...
    libs__handle_options__raw_lookup_accumulating_option_3_p_0(*STATE_VARIABLE_OptionTable_118, (MR_Integer) 72, &LimitErrorContextsOptionStrs_109);
    ...
    else
    {
      ...
      if ((Var_841 == (MR_Word) ((MR_Unsigned) 0U)))
      {
        ...
        {
          Var_806 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(3), Var_806, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 0));
          MR_hl_field(MR_mktag(3), Var_806, 1) = ((MR_Box) (Var_842));
        }
        {
          Var_805 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
        ...
        {
          LECSpec_112 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
