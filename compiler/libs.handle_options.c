      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), Var_42, (MR_Integer) 0)));
...
{
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
          packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), Var_700, (MR_Integer) 0)));
      }
    }
    if (succeeded)
      ...
      case (MR_Integer) 1:
        {
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), Var_739, (MR_Integer) 0)));
...
{
  {
    ...
    if (succeeded)
    {
      packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), OptionValue_7, (MR_Integer) 0)));
