  ...
  MR_Word * STATE_VARIABLE_Globals_8)
{
  ...
  MR_Word SourceOptionValue_50;
  MR_Word SourceOptionValue_57;

  libs__globals__lookup_bool_option_3_p_0(STATE_VARIABLE_Globals_0_7, (MR_Integer) 130, &SourceOptionValue_43);
  ...
  libs__globals__lookup_bool_option_3_p_0(STATE_VARIABLE_Globals_12_12, (MR_Integer) 130, &SourceOptionValue_50);
  switch (SourceOptionValue_50) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 0:
  ...
  libs__globals__lookup_bool_option_3_p_0(STATE_VARIABLE_Globals_22_22, (MR_Integer) 532, &SourceOptionValue_57);
    ...
    case (MR_Integer) 1:
      {
        ...
        if (succeeded)
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(STATE_VARIABLE_Globals_18_18, (MR_Integer) 32, &WarnSmart_36);
          switch (WarnSmart_36) {
            default: /*NOTREACHED*/ MR_assert(0);
            case (MR_Integer) 0:
              {
            ...
            case (MR_Integer) 1:
              {
                ...
                mercury__io__write_string_4_p_0(StdErr_37, (MR_String) "Warning: smart recompilation does not yet work with ");
                mercury__io__write_string_4_p_0(StdErr_37, (MR_String) "\140--intermodule-optimization\'");
                mercury__io__write_string_4_p_0(StdErr_37, (MR_String) ".\n");
                libs__globals__lookup_bool_option_3_p_0(STATE_VARIABLE_Globals_18_18, (MR_Integer) 3, &Halt_38);
                switch (Halt_38) {
                  default: /*NOTREACHED*/ MR_assert(0);
                  case (MR_Integer) 0:
                    {
        ...
        if (succeeded)
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(STATE_VARIABLE_Globals_23_23, (MR_Integer) 32, &WarnSmart_65);
          switch (WarnSmart_65) {
            default: /*NOTREACHED*/ MR_assert(0);
            case (MR_Integer) 0:
              {
            ...
            case (MR_Integer) 1:
              {
                ...
                mercury__io__write_string_4_p_0(StdErr_66, (MR_String) "Warning: smart recompilation does not yet work with ");
                mercury__io__write_string_4_p_0(StdErr_66, (MR_String) "\140--use-opt-files\'");
                mercury__io__write_string_4_p_0(StdErr_66, (MR_String) ".\n");
                libs__globals__lookup_bool_option_3_p_0(STATE_VARIABLE_Globals_23_23, (MR_Integer) 3, &Halt_67);
                switch (Halt_67) {
                  default: /*NOTREACHED*/ MR_assert(0);
                  case (MR_Integer) 0:
                    {
  ...
  MR_Word * STATE_VARIABLE_Globals_13)
{
  ...
  libs__globals__io_set_disable_smart_recompilation_3_p_0((MR_Integer) 1);
  libs__globals__set_option_4_p_0((MR_Integer) 152, (MR_Word) (MR_mkword(MR_mktag(1), &libs__handle_options_scalar_common_2[3])), STATE_VARIABLE_Globals_0_12, STATE_VARIABLE_Globals_13);
  ...
  MR_Word * OT_StdLabels_11)
{
  ...
  MR_Word SourceOptionValue_53;
  MR_Word SourceOptionValue_60;
  MR_Word SourceOptionValue_67;

  libs__globals__lookup_bool_option_3_p_0(STATE_VARIABLE_Globals_0_15, (MR_Integer) 311, &SourceOptionValue_46);
  ...
  libs__globals__lookup_bool_option_3_p_0(STATE_VARIABLE_Globals_20_20, (MR_Integer) 315, &SourceOptionValue_53);
  switch (SourceOptionValue_53) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 0:
  ...
  libs__globals__lookup_bool_option_3_p_0(STATE_VARIABLE_Globals_25_25, (MR_Integer) 314, &SourceOptionValue_60);
  switch (SourceOptionValue_60) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 0:
  ...
  libs__globals__lookup_bool_option_3_p_0(STATE_VARIABLE_Globals_30_30, (MR_Integer) 313, &SourceOptionValue_67);
  switch (SourceOptionValue_67) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 0:
  ...
  MR_Word * STATE_VARIABLE_Specs_26)
{
  ...
  MR_Word SourceOptionValue_93;

  libs__globals__lookup_bool_option_3_p_0(STATE_VARIABLE_Globals_0_22, (MR_Integer) 254, &SourceOptionValue_79);
  ...
  libs__globals__lookup_bool_option_3_p_0(STATE_VARIABLE_Globals_30_30, (MR_Integer) 245, &SourceOptionValue_86);
  ...
  libs__globals__lookup_bool_option_3_p_0(STATE_VARIABLE_Globals_35_35, (MR_Integer) 241, &SourceOptionValue_93);
  switch (SourceOptionValue_93) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 0:
  ...
  libs__handle_options__option_implies_5_p_0((MR_Integer) 241, (MR_Integer) 314, (MR_Word) (MR_mkword(MR_mktag(1), &libs__handle_options_scalar_common_2[0])), STATE_VARIABLE_Globals_40_40, &STATE_VARIABLE_Globals_45_45);
    ...
    case (MR_Integer) 1:
      {
        ...
        libs__handle_options__option_implies_5_p_0((MR_Integer) 254, (MR_Integer) 164, (MR_Word) (MR_mkword(MR_mktag(1), &libs__handle_options_scalar_common_2[0])), STATE_VARIABLE_Globals_60_60, STATE_VARIABLE_Globals_23);
  ...
  MR_Word * STATE_VARIABLE_Specs_25)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(STATE_VARIABLE_Globals_0_22, (MR_Integer) 233, &SourceOptionValue_90);
  ...
  libs__handle_options__option_implies_5_p_0((MR_Integer) 232, (MR_Integer) 162, (MR_Word) (MR_mkword(MR_mktag(1), &libs__handle_options_scalar_common_2[0])), STATE_VARIABLE_Globals_29_29, &STATE_VARIABLE_Globals_34_34);
  libs__handle_options__option_implies_5_p_0((MR_Integer) 162, (MR_Integer) 158, (MR_Word) (MR_mkword(MR_mktag(1), &libs__handle_options_scalar_common_2[0])), STATE_VARIABLE_Globals_34_34, &STATE_VARIABLE_Globals_39_39);
  libs__handle_options__option_implies_5_p_0((MR_Integer) 161, (MR_Integer) 158, (MR_Word) (MR_mkword(MR_mktag(1), &libs__handle_options_scalar_common_2[0])), STATE_VARIABLE_Globals_39_39, &STATE_VARIABLE_Globals_44_44);
  ...
  libs__handle_options__option_implies_5_p_0((MR_Integer) 278, (MR_Integer) 280, (MR_Word) (MR_mkword(MR_mktag(1), &libs__handle_options_scalar_common_2[0])), STATE_VARIABLE_Globals_71_71, STATE_VARIABLE_Globals_23);
}
  ...
  MR_Word * STATE_VARIABLE_Specs_18)
{
  ...
  libs__handle_options__option_implies_5_p_0((MR_Integer) 714, (MR_Integer) 244, (MR_Word) (MR_mkword(MR_mktag(1), &libs__handle_options_scalar_common_2[0])), STATE_VARIABLE_Globals_79_79, &STATE_VARIABLE_Globals_84_84);
  switch (GradeSupportsParConj_7) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 0:
  ...
  libs__handle_options__option_implies_5_p_0((MR_Integer) 262, (MR_Integer) 537, (MR_Word) (MR_mkword(MR_mktag(1), &libs__handle_options_scalar_common_2[3])), STATE_VARIABLE_Globals_88_88, STATE_VARIABLE_Globals_16);
}
