...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(STATE_VARIABLE_Globals_296_296, (MR_Integer) 696, &ImplicitParallelism_64);
          ...
          case (MR_Integer) 0:
            {
              ...
              libs__globals__set_option_4_p_0((MR_Integer) 696, (MR_Word) (MR_mkword(MR_mktag(1), &libs__handle_options_scalar_common_3[2])), STATE_VARIABLE_Globals_296_296, &STATE_VARIABLE_Globals_337_337);
            }
            break;
          case (MR_Integer) 1:
            {
              ...
              libs__globals__lookup_string_option_3_p_0(STATE_VARIABLE_Globals_296_296, (MR_Integer) 697, &FeedbackFile_65);
    ...
    libs__handle_options__option_implies_5_p_0((MR_Integer) 696, (MR_Integer) 220, Var_361, STATE_VARIABLE_Globals_337_337, &STATE_VARIABLE_Globals_362_362);
    switch (GradeSupportsParConj_60) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        {
          libs__globals__set_option_4_p_0((MR_Integer) 698, (MR_Word) (MR_mkword(MR_mktag(1), &libs__handle_options_scalar_common_3[2])), STATE_VARIABLE_Globals_362_362, &STATE_VARIABLE_Globals_366_366);
        }
        break;
      case (MR_Integer) 1:
...
{
  {
    ...
    libs__handle_options__raw_lookup_string_option_3_p_0(*STATE_VARIABLE_OptionTable_118, (MR_Integer) 697, &FeedbackFile_94);
