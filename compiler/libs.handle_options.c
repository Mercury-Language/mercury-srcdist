  ...
  if (succeeded)
  {
    ...
    switch (OT_PessimizeTailCalls0_15) {
      ...
      case (MR_Integer) 1:
        ...
        break;
      case (MR_Integer) 0:
        libs__compiler_util__add_error_4_p_0((MR_Word) ((MR_Unsigned) 0U), (MR_Word) (MR_mkword(1, &libs__handle_options_scalar_common_1[244])), STATE_VARIABLE_Specs_0_22, &STATE_VARIABLE_Specs_30_30);
        break;
    }
    ...
    if (succeeded)
      libs__compiler_util__add_error_4_p_0((MR_Word) ((MR_Unsigned) 0U), (MR_Word) (MR_mkword(1, &libs__handle_options_scalar_common_1[246])), STATE_VARIABLE_Specs_35_35, STATE_VARIABLE_Specs_23);
    else
