  ...
  MR_Word * STATE_VARIABLE_Specs_22)
{
  ...
  if ((MaybeOptionsStdLibDir_9 == (MR_Word) ((MR_Unsigned) 0U)))
    if (((MR_tag((MR_Word) MaybeEnvOptFileMerStdLibDir_6)) == (MR_Integer) 0))
    {
      ...
      *STATE_VARIABLE_Specs_22 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_diag_spec_0), EnvOptFileSpecs_18, STATE_VARIABLE_Specs_0_21);
    }
    else
    {
  ...
  libs__globals__set_option_4_p_0((MR_Integer) 785, Var_106, STATE_VARIABLE_Globals_0_19, STATE_VARIABLE_Globals_20);
}
