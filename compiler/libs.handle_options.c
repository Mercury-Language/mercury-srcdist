  ...
  MR_Word * STATE_VARIABLE_Specs_18)
{
  ...
  libs__handle_options__option_implies_5_p_0((MR_Integer) 711, (MR_Integer) 243, (MR_Word) (MR_mkword(MR_mktag(1), &libs__handle_options_scalar_common_2[0])), STATE_VARIABLE_Globals_79_79, &STATE_VARIABLE_Globals_84_84);
  switch (GradeSupportsParConj_7) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 0:
