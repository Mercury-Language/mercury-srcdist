  ...
  MR_Word * STATE_VARIABLE_Globals_5)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(STATE_VARIABLE_Globals_0_4, (MR_Integer) 446, &SourceOptionValue_15);
  switch (SourceOptionValue_15) {
    ...
    case (MR_Integer) 0:
      ...
      break;
    case (MR_Integer) 1:
      libs__globals__set_option_4_p_0((MR_Integer) 512, (MR_Word) (MR_mkword(1, &libs__handle_options_scalar_common_2[4])), STATE_VARIABLE_Globals_0_4, &STATE_VARIABLE_Globals_1_9);
      break;
  }
  ...
  if (succeeded)
    *STATE_VARIABLE_Globals_5 = STATE_VARIABLE_Globals_1_9;
    ...
    libs__globals__set_option_4_p_0((MR_Integer) 620, (MR_Word) (MR_mkword(1, &libs__handle_options_scalar_common_2[4])), STATE_VARIABLE_Globals_1_9, STATE_VARIABLE_Globals_5);
}
