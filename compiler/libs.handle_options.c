...
MR_def_label(libs__handle_options__check_option_values_22_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_string_const("Invalid target option (must be \140c\', \140il\', \140java\', \'csharp\', or \140erlang\')", 72);
	MR_r2 = MR_sv(1);
