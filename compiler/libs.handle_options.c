  ...
  MR_Word * STATE_VARIABLE_Globals_10)
{
  ...
  libs__handle_options__option_implies_5_p_0((MR_Integer) 474, (MR_Integer) 416, (MR_Word) (MR_mkword(1, &libs__handle_options_scalar_common_2[0])), STATE_VARIABLE_Globals_7_43, &STATE_VARIABLE_Globals_8_48);
  ...
  MR_Word * STATE_VARIABLE_Globals_20)
{
    ...
    case (MR_Integer) 3:
      {
        ...
        switch (MR_tag((MR_Word) OpModeArgs_8)) {
          ...
          case (MR_Integer) 1:
            {
              libs__handle_options__turn_off_all_only_codegen_warnings_3_p_0((MR_Integer) 270, STATE_VARIABLE_Globals_0_19, &STATE_VARIABLE_Globals_2_27);
              Smart_11 = (MR_Integer) 0;
              Inform_12 = (MR_Integer) 0;
            }
            break;
              ...
              switch (MR_tag((MR_Word) OpModeAugment_13)) {
                ...
                case (MR_Integer) 0:
                  switch (MR_unmkbody(OpModeAugment_13)) {
                    ...
                    case (MR_Integer) 0:
                      {
                        libs__handle_options__turn_off_all_only_codegen_warnings_3_p_0((MR_Integer) 272, STATE_VARIABLE_Globals_0_19, &STATE_VARIABLE_Globals_2_27);
                        Smart_11 = (MR_Integer) 0;
                        Inform_12 = (MR_Integer) 0;
                      }
                      break;
  ...
  else
  {
    ...
    libs__globals__set_option_4_p_0((MR_Integer) 671, Var_49, STATE_VARIABLE_Globals_2_27, &STATE_VARIABLE_Globals_10_50);
  }
  ...
  else
  {
    ...
    libs__globals__set_option_4_p_0((MR_Integer) 145, Var_52, STATE_VARIABLE_Globals_10_50, STATE_VARIABLE_Globals_20);
  }
}
