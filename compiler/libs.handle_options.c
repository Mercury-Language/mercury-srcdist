...
{
  {
    ...
    if (succeeded)
    {
      ...
      libs__compiler_util__add_warning_4_p_0((MR_Word) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))), (MR_Word) (MR_mkword(MR_mktag(1), &libs__handle_options_scalar_common_1[152])), STATE_VARIABLE_Specs_222_222, &STATE_VARIABLE_Specs_291_291);
    }
    else
    {
    ...
    if (succeeded)
    {
      libs__compiler_util__add_error_4_p_0((MR_Word) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))), (MR_Word) (MR_mkword(MR_mktag(1), &libs__handle_options_scalar_common_1[160])), STATE_VARIABLE_Specs_291_291, &STATE_VARIABLE_Specs_313_313);
    }
    else
          ...
          case (MR_Integer) 0:
            {
              switch (Parallel_61) {
                ...
                case (MR_Integer) 1:
                  {
                    libs__compiler_util__add_error_4_p_0((MR_Word) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))), (MR_Word) (MR_mkword(MR_mktag(1), &libs__handle_options_scalar_common_1[169])), STATE_VARIABLE_Specs_313_313, &STATE_VARIABLE_Specs_357_357);
                  }
                  break;
              }
          ...
          case (MR_Integer) 1:
            {
              ...
              if (succeeded)
              {
                libs__compiler_util__add_error_4_p_0((MR_Word) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))), (MR_Word) (MR_mkword(MR_mktag(1), &libs__handle_options_scalar_common_1[175])), STATE_VARIABLE_Specs_313_313, &STATE_VARIABLE_Specs_357_357);
              }
              else
                STATE_VARIABLE_Specs_357_357 = STATE_VARIABLE_Specs_313_313;
              STATE_VARIABLE_Globals_336_336 = STATE_VARIABLE_Globals_295_295;
      ...
      case (MR_Integer) 1:
        {
          ...
          if (succeeded)
          {
            libs__compiler_util__add_error_4_p_0((MR_Word) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))), (MR_Word) (MR_mkword(MR_mktag(1), &libs__handle_options_scalar_common_1[185])), STATE_VARIABLE_Specs_357_357, &STATE_VARIABLE_Specs_577_577);
          }
          else
            STATE_VARIABLE_Specs_577_577 = STATE_VARIABLE_Specs_357_357;
        }
    ...
    if (succeeded)
    {
      libs__compiler_util__add_error_4_p_0((MR_Word) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))), (MR_Word) (MR_mkword(MR_mktag(1), &libs__handle_options_scalar_common_1[191])), STATE_VARIABLE_Specs_577_577, &STATE_VARIABLE_Specs_598_598);
    }
    else
    ...
    if (succeeded)
    {
      libs__compiler_util__add_error_4_p_0((MR_Word) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))), (MR_Word) (MR_mkword(MR_mktag(1), &libs__handle_options_scalar_common_1[197])), STATE_VARIABLE_Specs_598_598, &STATE_VARIABLE_Specs_623_623);
    }
    else
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        succeeded = (Var_660 == (MR_Word) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 1))));
      }
    }
    if (succeeded)
    {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
          Var_81 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Var_700, (MR_Integer) 0))));
      }
    }
    if (succeeded)
        ...
        case (MR_Integer) 1:
          {
            ...
            if ((Var_1692 == (MR_Word) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
              succeeded = MR_TRUE;
            else
            if ((Var_1692 == (MR_Word) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 1)))))
              succeeded = MR_TRUE;
            else
              succeeded = MR_FALSE;
          }
    ...
    if (succeeded)
    {
      ...
      succeeded = (Var_716 == (MR_Word) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 3))));
    }
    if (succeeded)
    {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        succeeded = (Var_722 == (MR_Word) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 3))));
      }
    }
    if (succeeded)
    {
    ...
    if (succeeded)
    {
      libs__compiler_util__add_error_4_p_0((MR_Word) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))), (MR_Word) (MR_mkword(MR_mktag(1), &libs__handle_options_scalar_common_1[201])), STATE_VARIABLE_Specs_623_623, &STATE_VARIABLE_Specs_853_853);
    }
    else
    {
      ...
      if (succeeded)
      {
        libs__compiler_util__add_error_4_p_0((MR_Word) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))), (MR_Word) (MR_mkword(MR_mktag(1), &libs__handle_options_scalar_common_1[205])), STATE_VARIABLE_Specs_623_623, &STATE_VARIABLE_Specs_853_853);
      }
      else
      {
        succeeded = (UseMinimalModel_110 == (MR_Integer) 1);
        ...
        if (succeeded)
        {
          libs__compiler_util__add_error_4_p_0((MR_Word) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))), (MR_Word) (MR_mkword(MR_mktag(1), &libs__handle_options_scalar_common_1[208])), STATE_VARIABLE_Specs_623_623, &STATE_VARIABLE_Specs_853_853);
        }
        else
    ...
    if (succeeded)
    {
      ...
      else
      {
        ...
        if (succeeded)
        {
          ...
          libs__compiler_util__add_error_4_p_0((MR_Word) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))), ArgPackBitsSpec_118, STATE_VARIABLE_Specs_853_853, &STATE_VARIABLE_Specs_910_910);
        }
        else
        {
      ...
      case (MR_Integer) 1:
        {
          ...
          {
            libs__compiler_util__add_error_4_p_0((MR_Word) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))), (MR_Word) (MR_mkword(MR_mktag(1), &libs__handle_options_scalar_common_1[210])), STATE_VARIABLE_Specs_910_910, &STATE_VARIABLE_Specs_1151_1151);
          }
    ...
    if (succeeded)
    {
      libs__compiler_util__add_error_4_p_0((MR_Word) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))), (MR_Word) (MR_mkword(MR_mktag(1), &libs__handle_options_scalar_common_1[212])), STATE_VARIABLE_Specs_1151_1151, &STATE_VARIABLE_Specs_1173_1173);
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        switch (HighLevelCode_107) {
          ...
          case (MR_Integer) 1:
            {
              libs__compiler_util__add_error_4_p_0((MR_Word) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))), (MR_Word) (MR_mkword(MR_mktag(1), &libs__handle_options_scalar_common_1[214])), STATE_VARIABLE_Specs_1151_1151, &STATE_VARIABLE_Specs_1173_1173);
            }
            break;
        }
      }
    ...
    {
      libs__compiler_util__add_error_4_p_0((MR_Word) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))), (MR_Word) (MR_mkword(MR_mktag(1), &libs__handle_options_scalar_common_1[216])), STATE_VARIABLE_Specs_1173_1173, &STATE_VARIABLE_Specs_1199_1199);
    }
    ...
    if (succeeded)
    {
      libs__compiler_util__add_error_4_p_0((MR_Word) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))), (MR_Word) (MR_mkword(MR_mktag(1), &libs__handle_options_scalar_common_1[221])), STATE_VARIABLE_Specs_1199_1199, &STATE_VARIABLE_Specs_1300_1300);
    }
    else
    ...
    libs__globals__lookup_bool_option_3_p_0(STATE_VARIABLE_Globals_1359_1359, (MR_Integer) 314, &ParallelCodeGen_139);
    {
      ...
      if (succeeded)
      {
        Var_140 = ((MR_String) ((MR_hl_field(MR_mktag(1), DumpHLDSStages_136, (MR_Integer) 0))));
        Var_141 = ((MR_Word) ((MR_hl_field(MR_mktag(1), DumpHLDSStages_136, (MR_Integer) 1))));
      }
    }
    if (!(succeeded))
    {
      {
        ...
        if (succeeded)
        {
          Var_142 = ((MR_String) ((MR_hl_field(MR_mktag(1), DumpTraceStages_137, (MR_Integer) 0))));
          Var_143 = ((MR_Word) ((MR_hl_field(MR_mktag(1), DumpTraceStages_137, (MR_Integer) 1))));
        }
      }
      if (!(succeeded))
      {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        succeeded = (Var_1400 == (MR_Word) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
      }
    }
    if (succeeded)
    {
    ...
    if ((MaybeStdLibDir_147 == (MR_Word) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
    ...
    if ((MaybeConfDir_153 == (MR_Word) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
    ...
    if ((MercuryLibDirs_158 == (MR_Word) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
      ...
      case (MR_Integer) 1:
        {
          ...
          SearchLibFilesGradeSubdirs_182 = mercury__list__map_2_f_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), ToGradeSubdir_179, SearchLibFilesDirs_177);
          {
            ...
            MR_hl_field(MR_mktag(1), Var_1529, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
          }
    ...
    if (succeeded)
    {
      ...
      switch (PessimizeTailCalls_204) {
        ...
        case (MR_Integer) 1:
          {
            libs__compiler_util__add_error_4_p_0((MR_Word) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))), (MR_Word) (MR_mkword(MR_mktag(1), &libs__handle_options_scalar_common_1[238])), STATE_VARIABLE_Specs_1300_1300, &STATE_VARIABLE_Specs_1608_1608);
          }
          break;
      }
      switch (OptimizeTailCalls_205) {
        ...
        case (MR_Integer) 0:
          {
            libs__compiler_util__add_error_4_p_0((MR_Word) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))), (MR_Word) (MR_mkword(MR_mktag(1), &libs__handle_options_scalar_common_1[240])), STATE_VARIABLE_Specs_1608_1608, &STATE_VARIABLE_Specs_1613_1613);
          }
          break;
        case (MR_Integer) 1:
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          succeeded = (Var_1617 == (MR_Word) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 5))));
        }
      }
      if (succeeded)
      {
        libs__compiler_util__add_error_4_p_0((MR_Word) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))), (MR_Word) (MR_mkword(MR_mktag(1), &libs__handle_options_scalar_common_1[242])), STATE_VARIABLE_Specs_1613_1613, &STATE_VARIABLE_Specs_1622_1622);
      }
      else
    ...
    if ((CurrentBackendForeignLanguage_210 == (MR_Word) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
    {
      MR_Word Var_1643;
