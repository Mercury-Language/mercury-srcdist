    ...
    case (MR_Integer) 1:
      {
        ...
        libs__globals__set_option_4_p_0((MR_Integer) 601, (MR_Word) (MR_mkword(3, &libs__handle_options_scalar_common_1[70])), STATE_VARIABLE_Globals_33_219, &STATE_VARIABLE_Globals_34_225);
