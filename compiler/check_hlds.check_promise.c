        ...
        case (MR_Integer) 2:
          {
            ...
            hlds__hlds_module__module_info_get_exclusive_table_2_p_0(STATE_VARIABLE_ModuleInfo_0_20, &Table0_41);
            {
              ...
              MR_hl_field(MR_mktag(0), Var_45, 1) = ((MR_Box) (check_hlds__check_promise__check_promises_in_pred_7_p_0_1));
              MR_hl_field(MR_mktag(0), Var_45, 2) = ((MR_Box) ((MR_Integer) 1));
              MR_hl_field(MR_mktag(0), Var_45, 3) = ((MR_Box) (PredId_8));
            }
            mercury__list__foldl_4_p_0((MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_id_0), (MR_Word) (&hlds__hlds_promise__hlds__hlds_promise__type_ctor_info_exclusive_table_0), Var_45, CalleePredIds_40, ((MR_Box) (Table0_41)), &conv1_Table_42);
        ...
        case (MR_Integer) 3:
          {
            ...
            hlds__hlds_module__module_info_set_assertion_table_3_p_0(AssertTable_39, STATE_VARIABLE_ModuleInfo_0_20, &STATE_VARIABLE_ModuleInfo_20_43);
            hlds__assertion__assert_id_goal_3_p_0(STATE_VARIABLE_ModuleInfo_20_43, AssertionId_38, &Goal_16);
            hlds__assertion__record_preds_used_in_4_p_0(Goal_16, AssertionId_38, STATE_VARIABLE_ModuleInfo_20_43, STATE_VARIABLE_ModuleInfo_21);
          }
          break;
      }
      {
