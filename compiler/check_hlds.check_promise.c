              ...
              case (MR_Integer) 2:
                {
                  ...
                  succeeded = ((MR_tag((MR_Word) Clauses_56)) == (MR_Integer) 1);
                  if (succeeded)
                  {
              ...
              case (MR_Integer) 1:
                {
                  ...
                  succeeded = ((MR_tag((MR_Word) Clauses_68)) == (MR_Integer) 1);
                  if (succeeded)
                  {
  ...
  top_of_proc_1:;
    {
      ...
      switch (MR_tag((MR_Word) GoalExpr_10)) {
        ...
        case (MR_Integer) 0:
          {
            MR_Word SubGoal_49 = (MR_Word) (MR_body((MR_Word) (GoalExpr_10), (MR_Integer) 0));
        ...
        case (MR_Integer) 1:
          {
            ...
            Context_90 = hlds__hlds_goal__goal_info_get_context_1_f_0(GoalInfo_11);
            // direct tailcall eliminated
            ;
            ...
            next_value_of_tscc_proc_2_input_5_Context_12 = Context_90;
              ...
              case (MR_Integer) 1:
                {
                  ...
                  {
                    SimpleCallId_24 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
                    MR_hl_field(MR_mktag(0), SimpleCallId_24, 0) = (MR_Box) ((MR_Unsigned) (PredOrFunc_22));
                    MR_hl_field(MR_mktag(0), SimpleCallId_24, 1) = ((MR_Box) (SymName_17));
                    MR_hl_field(MR_mktag(0), SimpleCallId_24, 2) = ((MR_Box) (Arity_23));
                  }
                  {
                    Var_87 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(MR_mktag(3), Var_87, 0) = ((MR_Box) ((MR_Unsigned) 15U));
                    MR_hl_field(MR_mktag(3), Var_87, 1) = ((MR_Box) (SimpleCallId_24));
                  }
                  {
                    IdPieces_25 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(MR_mktag(1), IdPieces_25, 0) = ((MR_Box) (Var_87));
        ...
        case (MR_Integer) 3:
          switch (((MR_Integer) ((MR_hl_field(MR_mktag(3), GoalExpr_10, (MR_Integer) 0))))) {
            ...
            case (MR_Integer) 1:
              {
                ...
                MR_Word PredId_103 = ((MR_Word) ((MR_hl_field(MR_mktag(3), GoalExpr_10, (MR_Integer) 2))));
                MR_Word PredStatus_105;
                MR_Word DefnInImplSection_106;

                hlds__hlds_module__module_info_pred_info_3_p_0(ModuleInfo_6, PredId_103, &PragmaPredInfo_42);
                hlds__hlds_pred__pred_info_get_status_2_p_0(PragmaPredInfo_42, &PredStatus_105);
                DefnInImplSection_106 = hlds__status__pred_status_defined_in_impl_section_1_f_0(PredStatus_105);
                switch (DefnInImplSection_106) {
                  default: /*NOTREACHED*/ MR_assert(0);
                  case (MR_Integer) 0:
                    STATE_VARIABLE_Specs_67 = STATE_VARIABLE_Specs_0_66;
                    break;
                  case (MR_Integer) 1:
                    {
                      ...
                      MR_Integer Arity_94;
                      MR_Word SimpleCallId_95;
                      MR_Word IdPieces_96;

                      Context_92 = hlds__hlds_goal__goal_info_get_context_1_f_0(GoalInfo_11);
                      PredOrFunc_93 = hlds__hlds_pred__pred_info_is_pred_or_func_1_f_0(PragmaPredInfo_42);
                      Name_43 = hlds__hlds_pred__pred_info_name_1_f_0(PragmaPredInfo_42);
                      {
                        SymName_91 = (MR_Word) MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL);
                        MR_hl_field(MR_mktag(0), SymName_91, 0) = ((MR_Box) (Name_43));
                      }
                      Arity_94 = hlds__hlds_pred__pred_info_orig_arity_1_f_0(PragmaPredInfo_42);
                      {
                        SimpleCallId_95 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
                        MR_hl_field(MR_mktag(0), SimpleCallId_95, 0) = (MR_Box) ((MR_Unsigned) (PredOrFunc_93));
                        MR_hl_field(MR_mktag(0), SimpleCallId_95, 1) = ((MR_Box) (SymName_91));
                        MR_hl_field(MR_mktag(0), SimpleCallId_95, 2) = ((MR_Box) (Arity_94));
                      }
                      {
                        ...
                        MR_hl_field(MR_mktag(3), Var_83, 1) = ((MR_Box) (SimpleCallId_95));
                      }
                      {
                        IdPieces_96 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                        MR_hl_field(MR_mktag(1), IdPieces_96, 0) = ((MR_Box) (Var_83));
                        MR_hl_field(MR_mktag(1), IdPieces_96, 1) = ((MR_Box) ((MR_Unsigned) 0U));
                      }
                      check_hlds__check_promise__report_assertion_interface_error_5_p_0(ModuleInfo_6, Context_92, IdPieces_96, STATE_VARIABLE_Specs_0_66, &STATE_VARIABLE_Specs_67);
                    }
                    break;
                }
              }
            ...
            case (MR_Integer) 3:
              {
                MR_Word Goals_112 = ((MR_Word) ((MR_hl_field(MR_mktag(3), GoalExpr_10, (MR_Integer) 1))));

                check_hlds__check_promise__check_in_interface_promise_goals_5_p_0(ModuleInfo_6, PredInfo_7, Goals_112, STATE_VARIABLE_Specs_0_66, &STATE_VARIABLE_Specs_67);
              }
              break;
            case (MR_Integer) 4:
              {
            ...
            case (MR_Integer) 5:
              {
                MR_Word SubGoal_113 = ((MR_Word) ((MR_hl_field(MR_mktag(3), GoalExpr_10, (MR_Integer) 2))));
                MR_Word next_value_of_tscc_proc_1_input_1_ModuleInfo_6 = ModuleInfo_6;
                MR_Word next_value_of_tscc_proc_1_input_2_PredInfo_7 = PredInfo_7;
            ...
            case (MR_Integer) 7:
              {
                ...
                switch (MR_tag((MR_Word) ShortHand_55)) {
                  ...
                  case (MR_Integer) 0:
                    {
                      ...
                      MR_Word RHS_115 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ShortHand_55, (MR_Integer) 1))));
                      MR_Word next_value_of_tscc_proc_1_input_1_ModuleInfo_6;
                      MR_Word next_value_of_tscc_proc_1_input_2_PredInfo_7;
                      MR_Word next_value_of_tscc_proc_1_input_3_Goal_8;
                      MR_Word next_value_of_tscc_proc_1_input_4_STATE_VARIABLE_Specs_0_66;
                      ...
                      next_value_of_tscc_proc_1_input_1_ModuleInfo_6 = ModuleInfo_6;
                      next_value_of_tscc_proc_1_input_2_PredInfo_7 = PredInfo_7;
                      next_value_of_tscc_proc_1_input_3_Goal_8 = RHS_115;
                  ...
                  case (MR_Integer) 2:
                    {
                      MR_Word SubGoal_114 = ((MR_Word) ((MR_hl_field(MR_mktag(2), ShortHand_55, (MR_Integer) 2))));
                      MR_Word next_value_of_tscc_proc_1_input_1_ModuleInfo_6 = ModuleInfo_6;
                      MR_Word next_value_of_tscc_proc_1_input_2_PredInfo_7 = PredInfo_7;
                      MR_Word next_value_of_tscc_proc_1_input_3_Goal_8 = SubGoal_114;
                      MR_Word next_value_of_tscc_proc_1_input_4_STATE_VARIABLE_Specs_0_66 = STATE_VARIABLE_Specs_0_66;
              ...
              case (MR_Integer) 1:
                {
...

                  {
                    ...
                    MR_hl_field(MR_mktag(3), Var_42, 0) = ((MR_Box) ((MR_Unsigned) 11U));
