              ...
              case (MR_Integer) 1:
                {
                  ...
                  }
                  {
                    ...
                    MR_hl_field(MR_mktag(3), Var_86, 0) = ((MR_Box) ((MR_Unsigned) 17U));
                    MR_hl_field(MR_mktag(3), Var_86, 1) = ((MR_Box) (SimpleCallId_24));
                  }
                  {
                  ...
                  case (MR_Integer) 1:
                    {
                      ...
                      {
                        SimpleCallId_94 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
                        MR_hl_field(MR_mktag(0), SimpleCallId_94, 0) = (MR_Box) ((MR_Unsigned) (PredOrFunc_92));
                        MR_hl_field(MR_mktag(0), SimpleCallId_94, 1) = ((MR_Box) (SymName_90));
                        MR_hl_field(MR_mktag(0), SimpleCallId_94, 2) = ((MR_Box) (Arity_93));
                      }
                      {
                        Var_82 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                        MR_hl_field(MR_mktag(3), Var_82, 0) = ((MR_Box) ((MR_Unsigned) 17U));
                        MR_hl_field(MR_mktag(3), Var_82, 1) = ((MR_Box) (SimpleCallId_94));
                      }
                      {
              ...
              case (MR_Integer) 1:
                {
...

                  {
                    ...
                    MR_hl_field(MR_mktag(3), Var_42, 0) = ((MR_Box) ((MR_Unsigned) 13U));
...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), Var_59, 0) = ((MR_Box) (Context_7));
      MR_hl_field(MR_mktag(1), Var_59, 1) = ((MR_Box) (Msgs_13));
    }
    {
