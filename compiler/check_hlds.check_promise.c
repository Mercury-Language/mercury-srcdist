...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), check_hlds__check_promise__Var_17, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &check_hlds__check_promise_scalar_common_1[14])));
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), check_hlds__check_promise__Var_32, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &check_hlds__check_promise_scalar_common_1[15])));
                ...
                case (MR_Integer) 1:
                  {
                    ...
                    }
                    {
                      ...
                      MR_hl_field(MR_mktag(3), check_hlds__check_promise__Var_87, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 14));
                    ...
                    case (MR_Integer) 1:
                      {
                        ...
                        }
                        {
                          ...
                          MR_hl_field(MR_mktag(3), check_hlds__check_promise__Var_82, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 14));
