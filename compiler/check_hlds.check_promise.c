...
{
  {
    ...
    check_hlds__check_promise__check_promises_in_preds_7_p_0(ValidPredIds0_7, (MR_Word) ((MR_Integer) 0), &ToInvalidatePredIds_8, STATE_VARIABLE_ModuleInfo_0_9, &STATE_VARIABLE_ModuleInfo_14_14, STATE_VARIABLE_Specs_0_11, STATE_VARIABLE_Specs_12);
              ...
              case (MR_Integer) 1:
                {
                  ...
                  }
                  {
                    ...
                    MR_hl_field(MR_mktag(1), IdPieces_24, 1) = ((MR_Box) ((MR_Integer) 0));
                  }
                  ...
                  case (MR_Integer) 1:
                    {
                      ...
                      }
                      {
                        ...
                        MR_hl_field(MR_mktag(1), IdPieces_96, 1) = ((MR_Box) ((MR_Integer) 0));
                      }
...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(0), Spec_14, 1) = ((MR_Box) ((MR_Integer) 24));
