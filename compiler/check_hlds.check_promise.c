      ...
      case (MR_Integer) 2:
        {
          ...
          hlds__hlds_module__module_info_get_exclusive_table_2_p_0(STATE_VARIABLE_ModuleInfo_0_14, &Table0_32);
          {
            ...
            MR_hl_field(MR_mktag(0), Var_34, 0) = ((MR_Box) (&check_hlds__check_promise_scalar_common_3[0]));
          ...
          mercury__list__foldl_4_p_0((MR_Word) &hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_id_0, (MR_Word) &check_hlds__check_promise_scalar_common_2[0], Var_34, PredIds_31, ((MR_Box) (Table0_32)), &conv1_Table_33);
  ...
  MR_Word * STATE_VARIABLE_Specs_5)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      {
        MR_Word next_value_of_HeadVar__3_3 = Goal0s_14;
        MR_Word next_value_of_STATE_VARIABLE_Specs_0_4 = STATE_VARIABLE_Specs_18_18;
          ...
          case (MR_Integer) 1:
            {
              ...
              }
              {
                ...
                MR_hl_field(MR_mktag(1), IdPieces_26, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &check_hlds__check_promise_scalar_common_1[17])));
    ...
    case (MR_Integer) 2:
      {
        ...
        check_hlds__check_promise__check_in_interface_promise_goal_5_p_0(ModuleInfo_8, PredInfo_9, Goal_35, STATE_VARIABLE_Specs_0_36, STATE_VARIABLE_Specs_37);
      }
      break;
  }
}
        ...
        case (MR_Integer) 1:
          {
            ...
            check_hlds__check_promise__check_in_interface_promise_unify_rhs_7_p_0(ModuleInfo_6, PredInfo_7, Var_30, RHS_31, Context_91, STATE_VARIABLE_Specs_0_65, STATE_VARIABLE_Specs_66);
          }
          break;
        case (MR_Integer) 2:
          {
            ...
            case (MR_Integer) 5:
              {
                ...
                /* direct tailcall eliminated */
                {
                  MR_Word next_value_of_Goal_8 = SubGoal_111;
            ...
            case (MR_Integer) 6:
              {
                ...
                /* direct tailcall eliminated */
                {
                  MR_Word next_value_of_Goal_8 = Else_53;
                  MR_Word next_value_of_STATE_VARIABLE_Specs_0_65 = STATE_VARIABLE_Specs_73_73;

                  Goal_8 = next_value_of_Goal_8;
                  STATE_VARIABLE_Specs_0_65 = next_value_of_STATE_VARIABLE_Specs_0_65;
                }
                continue;
              }
              break;
                  ...
                  case (MR_Integer) 0:
                    {
                      ...
                      /* direct tailcall eliminated */
                      {
                        MR_Word next_value_of_Goal_8 = RHS_113;
                        MR_Word next_value_of_STATE_VARIABLE_Specs_0_65 = STATE_VARIABLE_Specs_67_67;
                  ...
                  case (MR_Integer) 2:
                    {
                      ...
                      /* direct tailcall eliminated */
                      {
                        MR_Word next_value_of_Goal_8 = SubGoal_112;
...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), Var_20, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &check_hlds__check_promise_scalar_common_1[5])));
    }
    {
      Var_17 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), Var_17, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &check_hlds__check_promise_scalar_common_1[13])));
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), Var_35, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &check_hlds__check_promise_scalar_common_1[8])));
    }
    {
      Var_32 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), Var_32, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &check_hlds__check_promise_scalar_common_1[14])));
