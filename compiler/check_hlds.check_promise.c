                ...
                case (MR_Integer) 1:
                  {
                    ...
                    {
                      Spec_59 = (MR_Word) MR_mkword(2, MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL));
                      MR_hl_field(2, Spec_59, 0) = ((MR_Box) ((MR_String) "predicate \140check_hlds.check_promise.report_assertion_interface_error\'/5"));
                      MR_hl_field(2, Spec_59, 1) = ((MR_Box) ((MR_Unsigned) 0U));
                      MR_hl_field(2, Spec_59, 2) = ((MR_Box) ((MR_Unsigned) 52U));
                      MR_hl_field(2, Spec_59, 3) = ((MR_Box) (Var_84));
                    }
                    {
