...
{
  {
    ...
    check_hlds__check_promise__check_promises_in_preds_7_p_0(ValidPredIds0_7, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), &ToInvalidatePredIds_8, STATE_VARIABLE_ModuleInfo_0_9, &STATE_VARIABLE_ModuleInfo_14_14, STATE_VARIABLE_Specs_0_11, STATE_VARIABLE_Specs_12);
            ...
            case (MR_Integer) 2:
              {
                ...
                succeeded = ((MR_tag((MR_Word) Clauses_52)) == (MR_mktag((MR_Integer) 1)));
                if (succeeded)
                {
                ...
                mercury__list__foldl_4_p_0((MR_Word) &hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_id_0, (MR_Word) &hlds__hlds_data__hlds__hlds_data__type_ctor_info_exclusive_table_0, Var_38, PredIds_35, ((MR_Box) (Table0_36)), &conv1_Table_37);
            ...
            case (MR_Integer) 1:
              {
                ...
                succeeded = ((MR_tag((MR_Word) Clauses_64)) == (MR_mktag((MR_Integer) 1)));
                if (succeeded)
                {
            ...
            case (MR_Integer) 3:
              {
                ...
                hlds__hlds_data__assertion_table_add_assertion_4_p_0(PredId_8, &AssertionId_33, AssertTable0_32, &AssertTable_34);
