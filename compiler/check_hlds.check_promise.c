...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), Var_72, 0) = ((MR_Box) (Context_8));
      MR_hl_field(MR_mktag(1), Var_72, 1) = ((MR_Box) (Msgs_14));
    }
    {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(0), Spec_15, 2) = ((MR_Box) ((MR_Unsigned) 44U));
...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), Var_62, 0) = ((MR_Box) (Context_7));
      MR_hl_field(MR_mktag(1), Var_62, 1) = ((MR_Box) (Msgs_12));
    }
    {
