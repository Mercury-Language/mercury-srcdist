...
static const MR_EnumFunctorDescPtr check_hlds__type_assign__check_hlds__type_assign__enum_ordinal_ordered_coerce_constraint_status_0[3];

static const MR_EnumFunctorDescPtr check_hlds__type_assign__check_hlds__type_assign__enum_name_ordered_coerce_constraint_status_0[3];

static const MR_Integer check_hlds__type_assign__check_hlds__type_assign__functor_number_map_coerce_constraint_status_0[3];
