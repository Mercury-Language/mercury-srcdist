...
static const MR_PseudoTypeInfo check_hlds__type_assign__check_hlds__type_assign__field_types_coerce_constraint_0_0[5];

static const MR_ConstString check_hlds__type_assign__check_hlds__type_assign__field_names_coerce_constraint_0_0[5];

static const MR_DuArgLocn check_hlds__type_assign__check_hlds__type_assign__field_locns_coerce_constraint_0_0[5];
  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          TypeInfo_18_18 = (MR_Word) (&check_hlds__type_assign_scalar_common_1[4]);
  ...
  MR_Word HeadVar__1_1)
{
  ...
  else
  {
    ...
    hlds__type_util__apply_rec_subst_to_constraint_db_3_p_0(Bindings_12, ConstraintDb0_9, &ConstraintDb_13);
  ...
  MR_Word * ExistTypeRenaming_24)
{
  ...
  else
  {
    ...
    hlds__type_util__apply_rec_subst_to_constraint_proof_map_3_p_0(TypeBindings_30, ConstraintProofMap0_33, &ConstraintProofMap_36);
    hlds__type_util__apply_rec_subst_to_constraint_map_3_p_0(TypeBindings_30, ConstraintMap0_34, &ConstraintMap1_37);
  }
  ...
  *ExistTypeRenaming_24 = ((MR_Word) (conv8_ExistTypeRenaming_24));
  ...
  {
    parse_tree__vartypes__rename_vars_in_vartypes_3_p_0(*TSubst_23, VarTypes1_35, NewVarTypes_19);
    ...
    parse_tree__prog_type_subst__apply_renaming_to_univ_exist_constraints_3_p_0(*TSubst_23, TypeConstraints_53, NewTypeConstraints_20);
    hlds__type_util__apply_renaming_to_constraint_proof_map_3_p_0(*TSubst_23, ConstraintProofMap_36, NewConstraintProofMap_21);
    hlds__type_util__apply_renaming_to_constraint_map_3_p_0(*TSubst_23, ConstraintMap_46, NewConstraintMap_22);
  }
}
