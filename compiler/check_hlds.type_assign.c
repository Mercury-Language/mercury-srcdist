...
static const MR_PseudoTypeInfo check_hlds__type_assign__check_hlds__type_assign__field_types_coerce_fail_0_2[2];

static const MR_ConstString check_hlds__type_assign__check_hlds__type_assign__field_names_coerce_fail_0_2[2];
...
static const MR_PseudoTypeInfo check_hlds__type_assign__check_hlds__type_assign__field_types_coerce_fail_0_4[4];

static const MR_ConstString check_hlds__type_assign__check_hlds__type_assign__field_names_coerce_fail_0_4[4];

static const MR_DuFunctorDesc check_hlds__type_assign__check_hlds__type_assign__du_functor_desc_coerce_fail_0_4;

static const MR_PseudoTypeInfo check_hlds__type_assign__check_hlds__type_assign__field_types_coerce_fail_0_5[2];

static const MR_ConstString check_hlds__type_assign__check_hlds__type_assign__field_names_coerce_fail_0_5[2];
...
static const MR_DuFunctorDescPtr check_hlds__type_assign__check_hlds__type_assign__du_stag_ordered_coerce_fail_0_3[3];

static const MR_DuPtagLayout check_hlds__type_assign__check_hlds__type_assign__du_ptag_ordered_coerce_fail_0[4];

static const MR_DuFunctorDescPtr check_hlds__type_assign__check_hlds__type_assign__du_name_ordered_coerce_fail_0[6];

static const MR_Integer check_hlds__type_assign__check_hlds__type_assign__functor_number_map_coerce_fail_0[6];
...
static const MR_ConstString check_hlds__type_assign__check_hlds__type_assign__field_names_coerce_fail_0_2[2] = {
  (MR_String) "it_from_type",
  (MR_String) "it_to_type"
};

static const MR_DuFunctorDesc check_hlds__type_assign__check_hlds__type_assign__du_functor_desc_coerce_fail_0_2 = {
  (MR_String) "incompatible_types",
  INT16_C(2),
  UINT16_C(0),
  MR_SECTAG_NONE,
  UINT8_C(2),
          ...
          case (MR_Integer) 2:
            {
              ...
              parse_tree__prog_data____Compare____mer_type_0_0(&SubResult1_25, ArgX1_23, ArgY1_24);
              succeeded = (SubResult1_25 != (MR_Integer) 0);
              if (succeeded)
                *HeadVar__1_1 = SubResult1_25;
              else
                parse_tree__prog_data____Compare____mer_type_0_0(HeadVar__1_1, ArgX2_26, ArgY2_27);
            }
            break;
          case (MR_Integer) 3:
            *HeadVar__1_1 = (MR_Integer) 1;
                  ...
                  case (MR_Integer) 0:
                    {
                      ...
                      parse_tree__prog_data____Compare____mer_type_0_0(&SubResult1_30, ArgX1_28, ArgY1_29);
                      succeeded = (SubResult1_30 != (MR_Integer) 0);
                      if (succeeded)
                        *HeadVar__1_1 = SubResult1_30;
                      else
                        parse_tree__prog_data____Compare____mer_type_0_0(HeadVar__1_1, ArgX2_31, ArgY2_32);
                    }
                    break;
                  case (MR_Integer) 1:
                  case (MR_Integer) 2:
                  ...
                  case (MR_Integer) 1:
                    {
                      ...
                      MR_String ArgX2_36 = ((MR_String) ((MR_hl_field(3, HeadVar__2_2, 2))));
                      MR_String ArgY2_37 = ((MR_String) ((MR_hl_field(3, HeadVar__3_3, 2))));
                      MR_Word ArgX3_39 = ((MR_Word) ((MR_hl_field(3, HeadVar__2_2, 3))));
                      MR_Word ArgY3_40 = ((MR_Word) ((MR_hl_field(3, HeadVar__3_3, 3))));
                      MR_String ArgX4_42 = ((MR_String) ((MR_hl_field(3, HeadVar__2_2, 4))));
                      MR_String ArgY4_43 = ((MR_String) ((MR_hl_field(3, HeadVar__3_3, 4))));
                      MR_Word SubResult1_35;

                      parse_tree__prog_data____Compare____mer_type_0_0(&SubResult1_35, ArgX1_33, ArgY1_34);
                      ...
                      else
                      {
                        ...
                        mercury__private_builtin__builtin_compare_string_3_p_0(&SubResult2_38, ArgX2_36, ArgY2_37);
                        ...
                        else
                        {
                          ...
                          parse_tree__prog_data____Compare____mer_type_0_0(&SubResult3_41, ArgX3_39, ArgY3_40);
                          succeeded = (SubResult3_41 != (MR_Integer) 0);
                          if (succeeded)
                            *HeadVar__1_1 = SubResult3_41;
                          else
                            mercury__private_builtin__builtin_compare_string_3_p_0(HeadVar__1_1, ArgX4_42, ArgY4_43);
                        }
                      }
                    }
                    break;
                  ...
                  case (MR_Integer) 2:
                    {
                      ...
                      parse_tree__prog_data____Compare____mer_type_0_0(&SubResult1_46, ArgX1_44, ArgY1_45);
                      succeeded = (SubResult1_46 != (MR_Integer) 0);
                      if (succeeded)
                        *HeadVar__1_1 = SubResult1_46;
                      else
                        parse_tree__prog_data____Compare____mer_type_0_0(HeadVar__1_1, ArgX2_47, ArgY2_48);
                    }
                    break;
                }
                break;
      ...
      case (MR_Integer) 1:
        {
          ...
          if (succeeded)
          {
            ...
            TypeInfo_51_51 = (MR_Word) (&check_hlds__type_assign_scalar_common_1[6]);
            succeeded = mercury__builtin__unify_2_p_0(TypeInfo_51_51, ((MR_Box) (ArgX1_11)), ((MR_Box) (ArgY1_12)));
            if (succeeded)
            {
              TypeInfo_52_52 = (MR_Word) (&check_hlds__type_assign_scalar_common_1[7]);
              succeeded = mercury__builtin__unify_2_p_0(TypeInfo_52_52, ((MR_Box) (ArgX2_13)), ((MR_Box) (ArgY2_14)));
              if (succeeded)
              {
                TypeInfo_53_53 = (MR_Word) (&check_hlds__type_assign_scalar_common_1[7]);
                succeeded = mercury__builtin__unify_2_p_0(TypeInfo_53_53, ((MR_Box) (ArgX3_15)), ((MR_Box) (ArgY3_16)));
              }
            }
          }
        }
      ...
      case (MR_Integer) 2:
        {
          ...
          if (succeeded)
          {
            ...
            succeeded = parse_tree__prog_data____Unify____mer_type_0_0(ArgX1_17, ArgY1_18);
            if (succeeded)
          ...
          case (MR_Integer) 0:
            {
              ...
              if (succeeded)
              {
                ...
                if (succeeded)
                  succeeded = parse_tree__prog_data____Unify____mer_type_0_0(ArgX2_23, ArgY2_24);
              }
            }
            break;
          case (MR_Integer) 1:
            {
              ...
              MR_Word ArgY3_30;
              MR_String ArgX4_31 = ((MR_String) ((MR_hl_field(3, HeadVar__1_1, 4))));
              MR_String ArgY4_32;
              ...
              if (succeeded)
              {
                ...
                ArgY4_32 = ((MR_String) ((MR_hl_field(3, HeadVar__2_2, 4))));
                succeeded = parse_tree__prog_data____Unify____mer_type_0_0(ArgX1_25, ArgY1_26);
                if (succeeded)
                {
                  succeeded = (strcmp(ArgX2_27, ArgY2_28) == 0);
                  if (succeeded)
                  {
                    succeeded = parse_tree__prog_data____Unify____mer_type_0_0(ArgX3_29, ArgY3_30);
                    if (succeeded)
                      succeeded = (strcmp(ArgX4_31, ArgY4_32) == 0);
                  }
                }
              }
            }
