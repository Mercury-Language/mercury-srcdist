  ...
  MR_Word * ExistTypeRenaming_24)
{
  ...
  *ExistTypeRenaming_24 = ((MR_Word) (conv8_ExistTypeRenaming_24));
  ...
  else
  {
    ...
    hlds__type_util__apply_renaming_to_constraint_proof_map_3_p_0(*OldToNewTRename_23, ConstraintProofMap_36, NewConstraintProofMap_21);
    hlds__type_util__apply_renaming_to_constraint_map_3_p_0(*OldToNewTRename_23, ConstraintMap_46, NewConstraintMap_22);
  }
}
