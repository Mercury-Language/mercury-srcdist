  ...
  MR_Word HeadVar__2_2)
{
  ...
  else
  {
    ...
    if (succeeded)
    {
      TypeInfo__11_11 = (MR_Word) (&check_hlds__type_assign_scalar_common_1[2]);
  ...
  MR_Word HeadVar__2_2)
{
  ...
  else
  {
    ...
    if (succeeded)
    {
      TypeInfo__22_22 = (MR_Word) (&check_hlds__type_assign_scalar_common_1[4]);
      succeeded = mercury__builtin__unify_2_p_0(TypeInfo__22_22, ((MR_Box) (ArgX2_5)), ((MR_Box) (ArgY2_6)));
      if (succeeded)
      {
        TypeInfo__23_23 = (MR_Word) (&check_hlds__type_assign_scalar_common_1[5]);
        succeeded = mercury__builtin__unify_2_p_0(TypeInfo__23_23, ((MR_Box) (ArgX3_7)), ((MR_Box) (ArgY3_8)));
        if (succeeded)
        {
          TypeInfo__24_24 = (MR_Word) (&check_hlds__type_assign_scalar_common_2[2]);
          succeeded = mercury__builtin__unify_2_p_0(TypeInfo__24_24, ((MR_Box) (ArgX4_9)), ((MR_Box) (ArgY4_10)));
          if (succeeded)
          {
            TypeInfo__25_25 = (MR_Word) (&check_hlds__type_assign_scalar_common_1[6]);
            ...
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                TypeInfo__27_27 = (MR_Word) (&check_hlds__type_assign_scalar_common_2[3]);
                succeeded = mercury__builtin__unify_2_p_0(TypeInfo__27_27, ((MR_Box) (ArgX7_15)), ((MR_Box) (ArgY7_16)));
                if (succeeded)
                {
                  TypeInfo__28_28 = (MR_Word) (&check_hlds__type_assign_scalar_common_2[0]);
  ...
  MR_Word * STATE_VARIABLE_Renaming_12)
{
  ...
  if (succeeded)
  {
    TypeInfo__16_16 = (MR_Word) (&check_hlds__type_assign_scalar_common_1[0]);
    succeeded = mercury__builtin__unify_2_p_0(TypeInfo__16_16, ((MR_Box) (NewTVar_10)), ((MR_Box) (TVar_8)));
    succeeded = !(succeeded);
    if (succeeded)
    {
      TypeInfo__14_14 = (MR_Word) (&check_hlds__type_assign_scalar_common_1[0]);
      succeeded = mercury__list__member_2_p_0(TypeInfo__14_14, ((MR_Box) (NewTVar_10)), OldExternalTypeParams_6);
      succeeded = !(succeeded);
    }
  }
  if (succeeded)
  ...
  MR_Word * STATE_VARIABLE_TypeVarsSet_12)
{
  ...
  parse_tree__prog_type__type_vars_in_type_2_p_0(*Type_8, &TypeVars_10);
  ...
  MR_Word HeadVar__1_1)
{
  ...
  else
  {
    ...
    if ((Args_7 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      MR_Word Var_13;
      MR_Word Var_14;
      MR_Word OldConstraints_18 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_6, (MR_Integer) 5))));
      MR_Word Bindings_19 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_6, (MR_Integer) 3))));
      MR_Word Constraints_20;
      MR_Word NewConstraints_21;
      MR_Word Var_36;
      MR_Word Var_37;
      MR_Word Var_38;
      MR_Word Var_39;
      ...
      check_hlds__type_util__apply_rec_subst_to_constraints_3_p_0(Bindings_19, Var_8, &Constraints_20);
      hlds__hlds_class__merge_hlds_constraints_3_p_0(Constraints_20, OldConstraints_18, &NewConstraints_21);
      Var_36 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_6, (MR_Integer) 0))));
      Var_37 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_6, (MR_Integer) 1))));
      Var_38 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_6, (MR_Integer) 2))));
      Var_39 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_6, (MR_Integer) 3))));
      Var_40 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_6, (MR_Integer) 4))));
      Var_42 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_6, (MR_Integer) 6))));
      Var_43 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_6, (MR_Integer) 7))));
      {
        Var_13 = (MR_Word) MR_new_object(MR_Word, (8 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), Var_13, 0) = ((MR_Box) (Var_36));
        MR_hl_field(MR_mktag(0), Var_13, 1) = ((MR_Box) (Var_37));
        MR_hl_field(MR_mktag(0), Var_13, 2) = ((MR_Box) (Var_38));
        MR_hl_field(MR_mktag(0), Var_13, 3) = ((MR_Box) (Var_39));
        MR_hl_field(MR_mktag(0), Var_13, 4) = ((MR_Box) (Var_40));
        MR_hl_field(MR_mktag(0), Var_13, 5) = ((MR_Box) (NewConstraints_21));
        MR_hl_field(MR_mktag(0), Var_13, 6) = ((MR_Box) (Var_42));
        MR_hl_field(MR_mktag(0), Var_13, 7) = ((MR_Box) (Var_43));
      }
  ...
  MR_Word HeadVar__1_1)
{
  ...
  else
  {
    ...
    MR_Word Var_5;
    MR_Word Var_6;
    MR_Word TypeAssign0_7 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ArgsTypeAssign_3, (MR_Integer) 0))));
    MR_Word Constraints0_9 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ArgsTypeAssign_3, (MR_Integer) 2))));
    MR_Word OldConstraints_10 = ((MR_Word) ((MR_hl_field(MR_mktag(0), TypeAssign0_7, (MR_Integer) 5))));
    MR_Word Bindings_11 = ((MR_Word) ((MR_hl_field(MR_mktag(0), TypeAssign0_7, (MR_Integer) 3))));
    MR_Word Constraints_12;
    MR_Word NewConstraints_13;
    MR_Word Var_28;
    MR_Word Var_29;
    MR_Word Var_30;
    MR_Word Var_31;
    ...
    check_hlds__type_util__apply_rec_subst_to_constraints_3_p_0(Bindings_11, Constraints0_9, &Constraints_12);
    hlds__hlds_class__merge_hlds_constraints_3_p_0(Constraints_12, OldConstraints_10, &NewConstraints_13);
    Var_28 = ((MR_Word) ((MR_hl_field(MR_mktag(0), TypeAssign0_7, (MR_Integer) 0))));
    Var_29 = ((MR_Word) ((MR_hl_field(MR_mktag(0), TypeAssign0_7, (MR_Integer) 1))));
    Var_30 = ((MR_Word) ((MR_hl_field(MR_mktag(0), TypeAssign0_7, (MR_Integer) 2))));
    Var_31 = ((MR_Word) ((MR_hl_field(MR_mktag(0), TypeAssign0_7, (MR_Integer) 3))));
    Var_32 = ((MR_Word) ((MR_hl_field(MR_mktag(0), TypeAssign0_7, (MR_Integer) 4))));
    Var_34 = ((MR_Word) ((MR_hl_field(MR_mktag(0), TypeAssign0_7, (MR_Integer) 6))));
    Var_35 = ((MR_Word) ((MR_hl_field(MR_mktag(0), TypeAssign0_7, (MR_Integer) 7))));
    {
      Var_5 = (MR_Word) MR_new_object(MR_Word, (8 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), Var_5, 0) = ((MR_Box) (Var_28));
      MR_hl_field(MR_mktag(0), Var_5, 1) = ((MR_Box) (Var_29));
      MR_hl_field(MR_mktag(0), Var_5, 2) = ((MR_Box) (Var_30));
      MR_hl_field(MR_mktag(0), Var_5, 3) = ((MR_Box) (Var_31));
      MR_hl_field(MR_mktag(0), Var_5, 4) = ((MR_Box) (Var_32));
      MR_hl_field(MR_mktag(0), Var_5, 5) = ((MR_Box) (NewConstraints_13));
      MR_hl_field(MR_mktag(0), Var_5, 6) = ((MR_Box) (Var_34));
      MR_hl_field(MR_mktag(0), Var_5, 7) = ((MR_Box) (Var_35));
    }
  ...
  MR_Word * ExistTypeRenaming_24)
{
  ...
  if (succeeded)
  {
    ...
    parse_tree__prog_type__type_vars_in_types_2_p_0(Types1_38, &TypeVars1_39);
  }
  else
  {
  ...
  ConstraintMap_46 = ((MR_Word) (conv6_ConstraintMap_46));
  {
    ...
    MR_hl_field(MR_mktag(0), Var_83, 0) = ((MR_Box) (&check_hlds__type_assign_scalar_common_3[1]));
    MR_hl_field(MR_mktag(0), Var_83, 1) = ((MR_Box) (check_hlds__type_assign__type_assign_set_get_final_info_12_p_0_4));
    MR_hl_field(MR_mktag(0), Var_83, 2) = ((MR_Box) ((MR_Integer) 2));
    MR_hl_field(MR_mktag(0), Var_83, 3) = ((MR_Box) (OldExternalTypeParams_14));
    MR_hl_field(MR_mktag(0), Var_83, 4) = ((MR_Box) (TypeBindings_30));
  }
  ...
  *ExistTypeRenaming_24 = ((MR_Word) (conv8_ExistTypeRenaming_24));
  ...
  parse_tree__prog_type__type_vars_in_types_2_p_0(ExplicitTypes_47, &ExplicitTypeVars0_48);
