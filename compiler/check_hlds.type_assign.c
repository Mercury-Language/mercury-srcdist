...
static const MR_EnumFunctorDescPtr check_hlds__type_assign__check_hlds__type_assign__enum_value_ordered_coerce_constraint_status_0[2];
...
const MR_TypeCtorInfo_Struct check_hlds__type_assign__check_hlds__type_assign__type_ctor_info_coerce_constraint_status_0 = {
  ...
  {     check_hlds__type_assign__check_hlds__type_assign__enum_value_ordered_coerce_constraint_status_0 },
  (MR_Integer) 2,
  UINT16_C(4),
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_14, (MR_Integer) 76, &Statistics_15);
    libs__file_util__maybe_report_stats_3_p_0(Statistics_15);
    ...
    if (succeeded)
    {
      ...
      mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&check_hlds__type_assign_scalar_common_5[0]), VarTypesCount_19, &Var_52);
      ...
      mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&check_hlds__type_assign_scalar_common_5[0]), TypeBindingsCount_21, &Var_63);
...
{
  {
    ...
    Var_48 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_format_component_0), ConstraintPieces_23, (MR_Word) (MR_mkword(MR_mktag(1), &check_hlds__type_assign_scalar_common_1[9])));
