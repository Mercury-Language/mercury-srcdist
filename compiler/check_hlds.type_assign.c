...
static const MR_DuFunctorDescPtr check_hlds__type_assign__check_hlds__type_assign__du_stag_ordered_coerce_fail_0_3[4];

static const MR_DuPtagLayout check_hlds__type_assign__check_hlds__type_assign__du_ptag_ordered_coerce_fail_0[4];

static const MR_DuFunctorDescPtr check_hlds__type_assign__check_hlds__type_assign__du_name_ordered_coerce_fail_0[7];

static const MR_Integer check_hlds__type_assign__check_hlds__type_assign__functor_number_map_coerce_fail_0[7];
...
static const MR_ConstString check_hlds__type_assign__check_hlds__type_assign__field_names_coerce_fail_0_3[2] = {
  (MR_String) "cctv_from_type",
  (MR_String) "cctv_to_type"
};

static const MR_DuFunctorDesc check_hlds__type_assign__check_hlds__type_assign__du_functor_desc_coerce_fail_0_3 = {
  (MR_String) "cannot_coerce_type_vars",
  INT16_C(2),
  UINT16_C(0),
                  ...
                  case (MR_Integer) 1:
                    {
                      ...
                      if (succeeded)
                        *HeadVar__1_1 = SubResult1_35;
                        ...
                        parse_tree__prog_data____Compare____mer_type_0_0(HeadVar__1_1, ArgX2_36, ArgY2_37);
                    }
                    break;
                  case (MR_Integer) 2:
                  case (MR_Integer) 3:
                  ...
                  case (MR_Integer) 2:
                    {
                      ...
                      parse_tree__prog_data____Compare____mer_type_0_0(&SubResult1_40, ArgX1_38, ArgY1_39);
                      succeeded = (SubResult1_40 != (MR_Integer) 0);
                      if (succeeded)
                        *HeadVar__1_1 = SubResult1_40;
                      else
                        parse_tree__prog_data____Compare____mer_type_0_0(HeadVar__1_1, ArgX2_41, ArgY2_42);
                    }
                    break;
                  case (MR_Integer) 3:
                    *HeadVar__1_1 = (MR_Integer) 1;
      ...
      case (MR_Integer) 1:
        {
          ...
          if (succeeded)
          {
            ...
            TypeInfo_53_53 = (MR_Word) (&check_hlds__type_assign_scalar_common_1[6]);
            succeeded = mercury__builtin__unify_2_p_0(TypeInfo_53_53, ((MR_Box) (ArgX1_11)), ((MR_Box) (ArgY1_12)));
            if (succeeded)
            {
              TypeInfo_54_54 = (MR_Word) (&check_hlds__type_assign_scalar_common_1[7]);
              succeeded = mercury__builtin__unify_2_p_0(TypeInfo_54_54, ((MR_Box) (ArgX2_13)), ((MR_Box) (ArgY2_14)));
              if (succeeded)
              {
                TypeInfo_55_55 = (MR_Word) (&check_hlds__type_assign_scalar_common_1[7]);
                succeeded = mercury__builtin__unify_2_p_0(TypeInfo_55_55, ((MR_Box) (ArgX3_15)), ((MR_Box) (ArgY3_16)));
              }
            }
          }
        }
          ...
          case (MR_Integer) 1:
            {
              ...
              if (succeeded)
              {
                ...
                if (succeeded)
                  succeeded = parse_tree__prog_data____Unify____mer_type_0_0(ArgX2_27, ArgY2_28);
              }
            }
            break;
          case (MR_Integer) 2:
            {
              ...
              if (succeeded)
              {
                ...
                succeeded = parse_tree__prog_data____Unify____mer_type_0_0(ArgX1_29, ArgY1_30);
                if (succeeded)
                  succeeded = parse_tree__prog_data____Unify____mer_type_0_0(ArgX2_31, ArgY2_32);
              }
            }
            break;
          case (MR_Integer) 3:
