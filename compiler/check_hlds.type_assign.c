  ...
  else
  {
    ...
    if ((Args_7 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      ...
      Var_54 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_6, (MR_Integer) 7))));
      {
        ...
        MR_hl_field(MR_mktag(0), Var_11, 0) = ((MR_Box) (Var_47));
        MR_hl_field(MR_mktag(0), Var_11, 1) = ((MR_Box) (Var_48));
        MR_hl_field(MR_mktag(0), Var_11, 2) = ((MR_Box) (Var_49));
        MR_hl_field(MR_mktag(0), Var_11, 3) = ((MR_Box) (Var_50));
        MR_hl_field(MR_mktag(0), Var_11, 4) = ((MR_Box) (Var_51));
        MR_hl_field(MR_mktag(0), Var_11, 5) = ((MR_Box) (NewConstraints_23));
        MR_hl_field(MR_mktag(0), Var_11, 6) = ((MR_Box) (Var_53));
        MR_hl_field(MR_mktag(0), Var_11, 7) = ((MR_Box) (Var_54));
      }
