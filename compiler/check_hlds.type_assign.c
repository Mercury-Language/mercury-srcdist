      ...
      else
      {
        ...
        if (succeeded)
          *HeadVar__1_1 = Var_11;
          ...
          hlds__hlds_class____Compare____hlds_constraints_0_0(HeadVar__1_1, ArgX3_8, ArgY3_9);
      }
    }
  }
}
        ...
        else
        {
          ...
          else
          {
            ...
            else
            {
              ...
              hlds__hlds_class____Compare____hlds_constraints_0_0(&Var_22, ArgX5_12, ArgY5_13);
...
{
  {
    ...
    else
    {
      ...
      if ((Args_7 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
      {
        ...
        hlds__hlds_class__merge_hlds_constraints_3_p_0(Constraints_23, OldConstraints_21, &NewConstraints_24);
...
{
  {
    ...
    TypeCtorInfo_76_76 = (MR_Word) &hlds__hlds_class__hlds__hlds_class__type_ctor_info_hlds_constraint_0;
...
{
  {
    ...
    mercury__map__init_1_p_0(TypeCtorInfo_18_18, (MR_Word) &hlds__hlds_class__hlds__hlds_class__type_ctor_info_constraint_proof_0, &ProofMap_12);
    mercury__map__init_1_p_0((MR_Word) &hlds__hlds_class__hlds__hlds_class__type_ctor_info_constraint_id_0, TypeCtorInfo_18_18, &ConstraintMap_13);
    {
      Var_14 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 7 * sizeof(MR_Word)), NULL, NULL);
