  ...
  else
  {
    ...
    if ((Args_7 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      ...
      Var_43 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_6, (MR_Integer) 7))));
      {
        ...
        MR_hl_field(MR_mktag(0), Var_11, 0) = ((MR_Box) (Var_36));
        MR_hl_field(MR_mktag(0), Var_11, 1) = ((MR_Box) (Var_37));
        MR_hl_field(MR_mktag(0), Var_11, 2) = ((MR_Box) (Var_38));
        MR_hl_field(MR_mktag(0), Var_11, 3) = ((MR_Box) (Var_39));
        MR_hl_field(MR_mktag(0), Var_11, 4) = ((MR_Box) (Var_40));
        MR_hl_field(MR_mktag(0), Var_11, 5) = ((MR_Box) (NewConstraints_21));
        MR_hl_field(MR_mktag(0), Var_11, 6) = ((MR_Box) (Var_42));
        MR_hl_field(MR_mktag(0), Var_11, 7) = ((MR_Box) (Var_43));
      }
      Var_12 = check_hlds__type_assign__convert_args_type_assign_set_check_empty_args_1_f_0(ArgTypeAssigns_4);
      {
...
{
  MR_Word Var_8 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_TA_0_6, (MR_Integer) 0))));
  MR_Word Var_9 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_TA_0_6, (MR_Integer) 1))));
  MR_Word Var_10 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_TA_0_6, (MR_Integer) 2))));
  MR_Word Var_11 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_TA_0_6, (MR_Integer) 3))));
  MR_Word Var_12 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_TA_0_6, (MR_Integer) 4))));
  MR_Word Var_13 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_TA_0_6, (MR_Integer) 5))));
  MR_Word Var_14 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_TA_0_6, (MR_Integer) 6))));
  ...
  MR_Word * STATE_VARIABLE_TA_7)
{
  ...
  MR_Word Var_12 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_TA_0_6, (MR_Integer) 4))));
  MR_Word Var_13 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_TA_0_6, (MR_Integer) 5))));
  MR_Word Var_15 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_TA_0_6, (MR_Integer) 7))));
