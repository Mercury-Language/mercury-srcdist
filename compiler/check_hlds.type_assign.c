...
{
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        TypeInfo_11_11 = (MR_Word) (&check_hlds__type_assign_scalar_common_1[7]);
...
{
  {
    ...
    mercury__builtin__compare_3_p_0((MR_Word) (&check_hlds__type_assign_scalar_common_1[6]), HeadVar__1_1, ((MR_Box) (Cast_HeadVar1_4)), ((MR_Box) (Cast_HeadVar2_5)));
  }
}
...
{
  {
    ...
    succeeded = mercury__builtin__unify_2_p_0((MR_Word) (&check_hlds__type_assign_scalar_common_1[6]), ((MR_Box) (Cast_HeadVar1_3)), ((MR_Box) (Cast_HeadVar2_4)));
    return succeeded;
  }
}
