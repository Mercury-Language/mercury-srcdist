  ...
  MR_Word HeadVar__1_1)
{
  ...
  else
  {
    ...
    MR_Word Constraints0_9 = ((MR_Word) ((MR_hl_field(0, ArgsTypeAssign_3, 2))));
    MR_Word OldConstraints_11 = ((MR_Word) ((MR_hl_field(0, TypeAssign0_7, 5))));
    ...
    hlds__type_util__apply_rec_subst_to_constraints_3_p_0(Bindings_12, Constraints0_9, &Constraints_13);
  ...
  MR_Word * ExistTypeRenaming_24)
{
  ...
  *ExistTypeRenaming_24 = ((MR_Word) (conv8_ExistTypeRenaming_24));
  ...
  else
  {
    ...
    hlds__type_util__apply_variable_renaming_to_constraint_proof_map_3_p_0(*TSubst_23, ConstraintProofMap_36, NewConstraintProofMap_21);
    hlds__type_util__apply_variable_renaming_to_constraint_map_3_p_0(*TSubst_23, ConstraintMap_46, NewConstraintMap_22);
  }
}
