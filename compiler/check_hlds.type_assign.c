  ...
  MR_Word HeadVar__1_1)
{
  ...
  else
  {
    ...
    if ((Args_7 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      ...
      Var_53 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_6, (MR_Integer) 7))));
      {
        Var_11 = (MR_Word) MR_new_object(MR_Word, (8 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), Var_11, 0) = ((MR_Box) (Var_46));
        MR_hl_field(MR_mktag(0), Var_11, 1) = ((MR_Box) (Var_47));
        MR_hl_field(MR_mktag(0), Var_11, 2) = ((MR_Box) (Var_48));
        MR_hl_field(MR_mktag(0), Var_11, 3) = ((MR_Box) (Var_49));
        MR_hl_field(MR_mktag(0), Var_11, 4) = ((MR_Box) (Var_50));
        MR_hl_field(MR_mktag(0), Var_11, 5) = ((MR_Box) (NewConstraints_23));
        MR_hl_field(MR_mktag(0), Var_11, 6) = ((MR_Box) (Var_52));
        MR_hl_field(MR_mktag(0), Var_11, 7) = ((MR_Box) (Var_53));
      }
  ...
  MR_Word HeadVar__1_1)
{
  ...
  else
  {
    ...
    Var_38 = ((MR_Word) ((MR_hl_field(MR_mktag(0), TypeAssign0_9, (MR_Integer) 0))));
    Var_39 = ((MR_Word) ((MR_hl_field(MR_mktag(0), TypeAssign0_9, (MR_Integer) 1))));
    Var_40 = ((MR_Word) ((MR_hl_field(MR_mktag(0), TypeAssign0_9, (MR_Integer) 2))));
    Var_41 = ((MR_Word) ((MR_hl_field(MR_mktag(0), TypeAssign0_9, (MR_Integer) 3))));
    Var_42 = ((MR_Word) ((MR_hl_field(MR_mktag(0), TypeAssign0_9, (MR_Integer) 4))));
    Var_44 = ((MR_Word) ((MR_hl_field(MR_mktag(0), TypeAssign0_9, (MR_Integer) 6))));
    Var_45 = ((MR_Word) ((MR_hl_field(MR_mktag(0), TypeAssign0_9, (MR_Integer) 7))));
    {
      Var_5 = (MR_Word) MR_new_object(MR_Word, (8 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), Var_5, 0) = ((MR_Box) (Var_38));
      MR_hl_field(MR_mktag(0), Var_5, 1) = ((MR_Box) (Var_39));
      MR_hl_field(MR_mktag(0), Var_5, 2) = ((MR_Box) (Var_40));
      MR_hl_field(MR_mktag(0), Var_5, 3) = ((MR_Box) (Var_41));
      MR_hl_field(MR_mktag(0), Var_5, 4) = ((MR_Box) (Var_42));
      MR_hl_field(MR_mktag(0), Var_5, 5) = ((MR_Box) (NewConstraints_15));
      MR_hl_field(MR_mktag(0), Var_5, 6) = ((MR_Box) (Var_44));
      MR_hl_field(MR_mktag(0), Var_5, 7) = ((MR_Box) (Var_45));
    }
