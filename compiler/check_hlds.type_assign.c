...
static void MR_CALL 
check_hlds__type_assign__do_type_checkpoint_7_p_0(
  MR_Word Stream_8,
  MR_String Msg_9,
...
static void MR_CALL 
check_hlds__type_assign__write_type_assign_set_5_p_0(
  MR_Word Stream_1,
  MR_Word HeadVar__2_2,
  MR_Word VarSet_3);

static void MR_CALL 
check_hlds__type_assign__write_type_assign_5_p_0(
  MR_Word Stream_6,
...
static void MR_CALL 
check_hlds__type_assign__write_type_assign_types_9_p_0(
  MR_Word Stream_1,
  MR_Word VarSet_2,
...
static /* final */ const MR_Box check_hlds__type_assign_scalar_common_1[15][2];

static /* final */ const MR_Box check_hlds__type_assign_scalar_common_2[6][3];

static /* final */ const MR_Box check_hlds__type_assign_scalar_common_3[1][1];

static /* final */ const MR_Box check_hlds__type_assign_scalar_common_4[2][8];

static /* final */ const MR_Box check_hlds__type_assign_scalar_common_5[1][6];
...
static /* final */ const MR_Box check_hlds__type_assign_scalar_common_1[15][2] = {
  ...
  /* row 12 */
  {
    ...
    ((MR_Box) (MR_mkword(MR_mktag(1), &check_hlds__type_assign_scalar_common_1[10])))
  },
  /* row 13 */
  {
    ((MR_Box) (MR_Word) ((MR_Unsigned) 5U)),
...
static /* final */ const MR_Box check_hlds__type_assign_scalar_common_2[6][3] = {
  ...
  /* row 4 */
  {
    ((MR_Box) (&check_hlds__type_assign_scalar_common_5[0])),
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_12, (MR_Integer) 80, &DoCheckPoint_13);
      ...
      case (MR_Integer) 1:
        {
          ...
          check_hlds__type_assign__do_type_checkpoint_7_p_0(Stream_14, Msg_7, ModuleInfo_8, VarSet_9, TypeAssignSet_10);
        }
        break;
    }
  }
...
{
  {
    ...
    MR_Word TypeAssign_16;
    MR_Word Var_17;

    mercury__io__write_string_4_p_0(Stream_8, (MR_String) "At ");
    mercury__io__write_string_4_p_0(Stream_8, Msg_9);
    mercury__io__write_string_4_p_0(Stream_8, (MR_String) ":");
    hlds__hlds_module__module_info_get_globals_2_p_0(ModuleInfo_10, &Globals_14);
    libs__globals__lookup_bool_option_3_p_0(Globals_14, (MR_Integer) 77, &Statistics_15);
    libs__file_util__maybe_report_stats_4_p_0(Stream_8, Statistics_15);
    mercury__io__nl_3_p_0(Stream_8);
    succeeded = (Statistics_15 == (MR_Integer) 1);
    if (succeeded)
    {
      succeeded = (TypeAssignSet_12 != (MR_Word) ((MR_Unsigned) 0U));
      if (succeeded)
      {
        TypeAssign_16 = ((MR_Word) ((MR_hl_field(MR_mktag(1), TypeAssignSet_12, (MR_Integer) 0))));
        Var_17 = ((MR_Word) ((MR_hl_field(MR_mktag(1), TypeAssignSet_12, (MR_Integer) 1))));
      }
    }
    if (succeeded)
    {
      MR_Word VarTypes_18 = ((MR_Word) ((MR_hl_field(MR_mktag(0), TypeAssign_16, (MR_Integer) 0))));
      MR_Integer VarTypesCount_19;
      MR_Word TypeBindings_20 = ((MR_Word) ((MR_hl_field(MR_mktag(0), TypeAssign_16, (MR_Integer) 3))));
      MR_Integer TypeBindingsCount_21;
      MR_String Var_52;
      MR_String Var_63;

      hlds__vartypes__vartypes_count_2_p_0(VarTypes_18, &VarTypesCount_19);
      mercury__io__write_string_4_p_0(Stream_8, (MR_String) "\t\140var -> type\' map: count = ");
      mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&check_hlds__type_assign_scalar_common_3[0]), VarTypesCount_19, &Var_52);
      mercury__io__write_string_4_p_0(Stream_8, Var_52);
      mercury__io__write_string_4_p_0(Stream_8, (MR_String) "\n");
      mercury__map__count_2_p_0((MR_Word) (&check_hlds__type_assign_scalar_common_1[0]), (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0), TypeBindings_20, &TypeBindingsCount_21);
      mercury__io__write_string_4_p_0(Stream_8, (MR_String) "\t\140type var -> type\' map: count = ");
      mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&check_hlds__type_assign_scalar_common_3[0]), TypeBindingsCount_21, &Var_63);
      mercury__io__write_string_4_p_0(Stream_8, Var_63);
      mercury__io__write_string_4_p_0(Stream_8, (MR_String) "\n");
      mercury__io__write_string_4_p_0(Stream_8, (MR_String) "\t");
      check_hlds__type_assign__write_type_assign_5_p_0(Stream_8, TypeAssign_16, VarSet_11);
      mercury__io__write_string_4_p_0(Stream_8, (MR_String) "\n");
      check_hlds__type_assign__write_type_assign_set_5_p_0(Stream_8, Var_17, VarSet_11);
    }
    else
      check_hlds__type_assign__write_type_assign_set_5_p_0(Stream_8, TypeAssignSet_12, VarSet_11);
  }
}
  ...
  MR_Word VarSet_3)
{
  while (MR_TRUE)
  {
    ...
    if (!((HeadVar__2_2 == (MR_Word) ((MR_Unsigned) 0U))))
    {
      ...
      check_hlds__type_assign__write_type_assign_5_p_0(Stream_1, TypeAssign_12, VarSet_3);
      mercury__io__write_string_4_p_0(Stream_1, (MR_String) "\n");
      // direct tailcall eliminated
      ;
...
{
  {
    MR_Word ExternalTypeParams_10 = ((MR_Word) ((MR_hl_field(MR_mktag(0), TypeAssign_7, (MR_Integer) 2))));
    MR_Word VarTypes_11 = ((MR_Word) ((MR_hl_field(MR_mktag(0), TypeAssign_7, (MR_Integer) 0))));
    MR_Word Constraints_12 = ((MR_Word) ((MR_hl_field(MR_mktag(0), TypeAssign_7, (MR_Integer) 5))));
    MR_Word TypeBindings_13 = ((MR_Word) ((MR_hl_field(MR_mktag(0), TypeAssign_7, (MR_Integer) 3))));
    MR_Word TypeVarSet_14 = ((MR_Word) ((MR_hl_field(MR_mktag(0), TypeAssign_7, (MR_Integer) 1))));
    MR_Word Vars_15;
    MR_Word ConstraintsToProve_84;
    MR_Word AssumedConstraints_85;

    hlds__vartypes__vartypes_vars_2_p_0(VarTypes_11, &Vars_15);
    if (!((ExternalTypeParams_10 == (MR_Word) ((MR_Unsigned) 0U))))
    {
      mercury__io__write_string_4_p_0(Stream_6, (MR_String) "some [");
      parse_tree__parse_tree_out_term__mercury_output_vars_6_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_tvar_type_0), TypeVarSet_14, (MR_Integer) 1, ExternalTypeParams_10, Stream_6);
      mercury__io__write_string_4_p_0(Stream_6, (MR_String) "]\n\t");
    }
    check_hlds__type_assign__write_type_assign_types_9_p_0(Stream_6, VarSet_8, TypeVarSet_14, VarTypes_11, TypeBindings_13, (MR_Integer) 0, Vars_15);
    ConstraintsToProve_84 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Constraints_12, (MR_Integer) 0))));
    AssumedConstraints_85 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Constraints_12, (MR_Integer) 1))));
    check_hlds__type_assign__write_type_assign_constraints_7_p_0(Stream_6, TypeVarSet_14, TypeBindings_13, AssumedConstraints_85, (MR_String) "&");
    check_hlds__type_assign__write_type_assign_constraints_7_p_0(Stream_6, TypeVarSet_14, TypeBindings_13, ConstraintsToProve_84, (MR_String) "<=");
    mercury__io__write_string_4_p_0(Stream_6, (MR_String) "\n");
  }
}
...
{
  {
    ...
    else
    {
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(1), Var_26, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &check_hlds__type_assign_scalar_common_1[12])));
      }
      {
        SeqPieces0_10 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), SeqPieces0_10, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &check_hlds__type_assign_scalar_common_1[9])));
    ...
    Constraints_14 = ((MR_Word) ((MR_hl_field(MR_mktag(0), TypeAssign_5, (MR_Integer) 5))));
    ...
    else
    {
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(1), HeadPieces_18, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &check_hlds__type_assign_scalar_common_1[10])));
      }
    }
    ...
    Var_48 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_format_component_0), ConstraintPieces_23, (MR_Word) (MR_mkword(MR_mktag(1), &check_hlds__type_assign_scalar_common_1[10])));
  ...
  while (MR_TRUE)
  {
    ...
    if ((HeadVar__1_1 == (MR_Word) ((MR_Unsigned) 0U)))
      switch (FoundOne_6) {
        default: /*NOTREACHED*/ MR_assert(0);
        case (MR_Integer) 0:
          Pieces_7 = (MR_Word) (MR_mkword(MR_mktag(1), &check_hlds__type_assign_scalar_common_1[14]));
          break;
        case (MR_Integer) 1:
      ...
      if (succeeded)
      {
        ...
        switch (FoundOne_6) {
          ...
          case (MR_Integer) 0:
            ...
            break;
          case (MR_Integer) 1:
            PrefixPieces_26 = (MR_Word) (MR_mkword(MR_mktag(1), &check_hlds__type_assign_scalar_common_1[10]));
            break;
        }
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(1), Var_35, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &check_hlds__type_assign_scalar_common_1[11])));
...
{
  {
    ...
    else
    {
...

      {
        ...
        MR_hl_field(MR_mktag(0), Var_56, 0) = ((MR_Box) (&check_hlds__type_assign_scalar_common_4[0]));
    ...
    ConstraintMap_46 = ((MR_Word) (conv6_ConstraintMap_46));
    {
      ...
      MR_hl_field(MR_mktag(0), Var_87, 0) = ((MR_Box) (&check_hlds__type_assign_scalar_common_4[1]));
