...
{
  {
    ...
    {
      libs__globals__lookup_bool_option_3_p_0(check_hlds__type_assign__Globals_12, (MR_Integer) 62, &check_hlds__type_assign__DoCheckPoint_13);
    }
      ...
      case (MR_Integer) 1:
        {
          ...
          {
            libs__globals__lookup_bool_option_3_p_0(check_hlds__type_assign__Globals_25, (MR_Integer) 59, &check_hlds__type_assign__Statistics_26);
          }
          {
