...
static /* final */ const MR_Box parse_tree__parse_tree_out_misc_scalar_common_2[1][1];

static /* final */ const MR_Integer parse_tree__parse_tree_out_misc_scalar_common_6[1][2];

static /* final */ const MR_Box parse_tree__parse_tree_out_misc_scalar_common_7[1][10];


struct parse_tree__parse_tree_out_misc__vector_common_type_3_0_s {
  const MR_String parse_tree__parse_tree_out_misc__vector_common_type_3_0__vct_3_f_0;
};

static /* final */ const struct parse_tree__parse_tree_out_misc__vector_common_type_3_0_s parse_tree__parse_tree_out_misc_vector_common_3[26];

struct parse_tree__parse_tree_out_misc__vector_common_type_4_0_s {
  const MR_String parse_tree__parse_tree_out_misc__vector_common_type_4_0__vct_4_f_0;
  const MR_Word parse_tree__parse_tree_out_misc__vector_common_type_4_0__vct_4_f_1;
};

static /* final */ const struct parse_tree__parse_tree_out_misc__vector_common_type_4_0_s parse_tree__parse_tree_out_misc_vector_common_4[4];

struct parse_tree__parse_tree_out_misc__vector_common_type_5_0_s {
  const MR_Word parse_tree__parse_tree_out_misc__vector_common_type_5_0__vct_5_f_0;
  const MR_String parse_tree__parse_tree_out_misc__vector_common_type_5_0__vct_5_f_1;
};

static /* final */ const struct parse_tree__parse_tree_out_misc__vector_common_type_5_0_s parse_tree__parse_tree_out_misc_vector_common_5[4];
...
static /* final */ const MR_Box parse_tree__parse_tree_out_misc_scalar_common_7[1][10] = {
  ...
  {
    NULL,
    ((MR_Box) (&parse_tree__parse_tree_out_misc_scalar_common_6[0])),
    ((MR_Box) ((MR_Integer) 7)),
  ...
  MR_Word Stream_6)
{
  ...
  parse_tree__parse_tree_out_misc__mercury_format_tabs_4_p_0((MR_Word) (&parse_tree__parse_tree_out_misc_scalar_common_1[1]), Indent_5, ((MR_Box) (Stream_6)), ((MR_Box) ((MR_Integer) 0)), &conv0_STATE_VARIABLE_IO_9);
}
  ...
  MR_Box * STATE_VARIABLE_U_9)
{
  while (MR_TRUE)
  {
    ...
    if (succeeded)
    {
      ...
      MR_Integer Var_13;
      void MR_CALL (* func_0)(MR_Box, MR_Box, MR_Box, MR_Box, MR_Box *) = ((void MR_CALL (*)(MR_Box, MR_Box, MR_Box, MR_Box, MR_Box *)) ((MR_hl_field(0, (MR_hl_field(0, TypeClassInfo_for_output_16, (MR_Integer) 0)), (MR_Integer) 6))));
  ...
  MR_String * ContextStr_4)
{
  ...
  else
  {
    ...
    mercury__string__format__format_signed_int_component_width_noprec_4_p_0((MR_Word) (&parse_tree__parse_tree_out_misc_scalar_common_2[0]), (MR_Integer) 3, LineNumber_6, &Var_14);
  ...
  MR_Box * STATE_VARIABLE_U_9)
{
  ...
  func_0 = ((void MR_CALL (*)(MR_Box, MR_Box, MR_Box, MR_Box, MR_Box *)) ((MR_hl_field(0, (MR_hl_field(0, TypeClassInfo_for_output_16, (MR_Integer) 0)), (MR_Integer) 6))));
  ...
  MR_Word Stream_6)
{
  ...
  func_0 = ((void MR_CALL (*)(MR_Box, MR_Box, MR_Box, MR_Box, MR_Box *)) ((MR_hl_field(0, (MR_hl_field(0, (MR_Word) (&parse_tree__parse_tree_out_misc_scalar_common_1[1]), (MR_Integer) 0)), (MR_Integer) 6))));
  func_0(((MR_Box) ((MR_Word) (&parse_tree__parse_tree_out_misc_scalar_common_1[1]))), ((MR_Box) (Var_11)), ((MR_Box) (Stream_6)), ((MR_Box) ((MR_Integer) 0)), &conv1_STATE_VARIABLE_IO_9);
}
  ...
  MR_Word Lang_3)
{
  ...
  func_0 = ((void MR_CALL (*)(MR_Box, MR_Box, MR_Box, MR_Box, MR_Box *)) ((MR_hl_field(0, (MR_hl_field(0, (MR_Word) (&parse_tree__parse_tree_out_misc_scalar_common_1[0]), (MR_Integer) 0)), (MR_Integer) 6))));
  func_0(((MR_Box) ((MR_Word) (&parse_tree__parse_tree_out_misc_scalar_common_1[0]))), ((MR_Box) (Var_8)), ((MR_Box) ((MR_Integer) 0)), ((MR_Box) ((MR_String) "")), &conv1_String_4);
  ...
  MR_Word Stream_10)
{
...

  {
    ...
    MR_hl_field(0, Var_14, 0) = ((MR_Box) (&parse_tree__parse_tree_out_misc_scalar_common_7[0]));
  ...
  MR_Word Stream_10)
{
  ...
  parse_tree__parse_tree_out_misc__mercury_format_quantifier_6_p_0((MR_Word) (&parse_tree__parse_tree_out_misc_scalar_common_1[1]), TypeVarSet_7, VarNamePrint_8, ExistQVars_9, ((MR_Box) (Stream_10)), ((MR_Box) ((MR_Integer) 0)), &conv0_STATE_VARIABLE_IO_13);
}
  ...
  MR_Word ExistQVars_7)
{
  ...
  parse_tree__parse_tree_out_misc__mercury_format_quantifier_6_p_0((MR_Word) (&parse_tree__parse_tree_out_misc_scalar_common_1[0]), TypeVarSet_5, VarNamePrint_6, ExistQVars_7, ((MR_Box) ((MR_Integer) 0)), ((MR_Box) ((MR_String) "")), &conv0_String_8);
  ...
  MR_Box * STATE_VARIABLE_U_15)
{
  ...
  else
  {
    ...
    void MR_CALL (* func_0)(MR_Box, MR_Box, MR_Box, MR_Box, MR_Box *) = ((void MR_CALL (*)(MR_Box, MR_Box, MR_Box, MR_Box, MR_Box *)) ((MR_hl_field(0, (MR_hl_field(0, TypeClassInfo_for_output_20, (MR_Integer) 0)), (MR_Integer) 6))));
    ...
    func_1 = ((void MR_CALL (*)(MR_Box, MR_Box, MR_Box, MR_Box, MR_Box *)) ((MR_hl_field(0, (MR_hl_field(0, TypeClassInfo_for_output_20, (MR_Integer) 0)), (MR_Integer) 6))));
...
parse_tree__parse_tree_out_misc__goal_warning_to_string_1_f_0(
  MR_Word Warning_3)
{
  MR_String Str_4 = ((&parse_tree__parse_tree_out_misc_vector_common_3[20 + Warning_3]))->parse_tree__parse_tree_out_misc__vector_common_type_3_0__vct_3_f_0;
...
parse_tree__parse_tree_out_misc__determinism_to_string_1_f_0(
  MR_Word HeadVar__1_1)
{
  MR_String HeadVar__2_2 = ((&parse_tree__parse_tree_out_misc_vector_common_3[12 + HeadVar__1_1]))->parse_tree__parse_tree_out_misc__vector_common_type_3_0__vct_3_f_0;
  ...
  void * cont_env_ptr)
{
  ...
  do
  {
    *HeadVar__1_1 = ((&parse_tree__parse_tree_out_misc_vector_common_5[0 + slot_0]))->parse_tree__parse_tree_out_misc__vector_common_type_5_0__vct_5_f_0;
    *HeadVar__2_2 = ((&parse_tree__parse_tree_out_misc_vector_common_5[0 + slot_0]))->parse_tree__parse_tree_out_misc__vector_common_type_5_0__vct_5_f_1;
    cont(cont_env_ptr);
  ...
  MR_String HeadVar__2_2)
{
  ...
  do
  {
    ...
    result_3 = MR_strcmp(HeadVar__2_2, ((&parse_tree__parse_tree_out_misc_vector_common_4[0 + mid_2]))->parse_tree__parse_tree_out_misc__vector_common_type_4_0__vct_4_f_0);
    if ((result_3 == (MR_Integer) 0))
    {
      *HeadVar__1_1 = ((&parse_tree__parse_tree_out_misc_vector_common_4[0 + mid_2]))->parse_tree__parse_tree_out_misc__vector_common_type_4_0__vct_4_f_1;
      succeeded = MR_TRUE;
...
parse_tree__parse_tree_out_misc__promise_to_string_1_f_0(
  MR_Word HeadVar__1_1)
{
  MR_String HeadVar__2_2 = ((&parse_tree__parse_tree_out_misc_vector_common_3[8 + HeadVar__1_1]))->parse_tree__parse_tree_out_misc__vector_common_type_3_0__vct_3_f_0;
...
parse_tree__parse_tree_out_misc__mercury_det_to_string_1_f_0(
  MR_Word HeadVar__1_1)
{
  MR_String HeadVar__2_2 = ((&parse_tree__parse_tree_out_misc_vector_common_3[0 + HeadVar__1_1]))->parse_tree__parse_tree_out_misc__vector_common_type_3_0__vct_3_f_0;
