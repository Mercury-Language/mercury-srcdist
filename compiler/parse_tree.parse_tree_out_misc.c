...
static /* final */ const struct parse_tree__parse_tree_out_misc__vector_common_type_3_0_s parse_tree__parse_tree_out_misc_vector_common_3[36];
  ...
  MR_Integer Indent_3)
{
  ...
  {
    Str0_5 = ((&parse_tree__parse_tree_out_misc_vector_common_3[26 + Indent_3]))->parse_tree__parse_tree_out_misc__vector_common_type_3_0__vct_3_f_0;
    succeeded = MR_TRUE;
  }
  else
    succeeded = MR_FALSE;
