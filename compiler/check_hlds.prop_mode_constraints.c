...
{
  {
    ...
    if (succeeded)
    {
      packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Var_10, (MR_Integer) 1)));
      ...
      case (MR_Integer) 2:
        {
          ...
          MR_Word Args_27;
          MR_Unsigned packed_args_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), STATE_VARIABLE_GoalExpr_86_86, (MR_Integer) 3)));
          ...
          else
          {
...

            {
              ...
              MR_hl_field(MR_mktag(2), CallGoalExpr_30, 3) = (MR_Box) (packed_args_2);
          ...
          case (MR_Integer) 0:
            {
              ...
              MR_Word Args_156;
              MR_Unsigned packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), STATE_VARIABLE_GoalExpr_86_86, (MR_Integer) 5)));
              ...
              else
              {
...

                {
                  ...
                  MR_hl_field(MR_mktag(3), CallGoalExpr_151, 5) = (MR_Box) (packed_args_1);
                }
          ...
          case (MR_Integer) 2:
            {
              ...
              MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), STATE_VARIABLE_GoalExpr_86_86, (MR_Integer) 1)));
                ...
                case (MR_Integer) 1:
                  {
                    ...
                    MR_Unsigned packed_args_3 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), ShortHand0_61, (MR_Integer) 0)));
                    ...
                    *STATE_VARIABLE_VarTypes_85 = ((MR_Word) (conv25_STATE_VARIABLE_VarTypes_85));
                    {
                      ...
                      MR_hl_field(MR_mktag(1), ShortHand_71, 0) = (MR_Box) (packed_args_3);
