...
MR_decl_label10(check_hlds__prop_mode_constraints__ensure_unique_arguments_3_0, 2,3,4,5,6,7,9,10,12,17)
MR_decl_label6(check_hlds__prop_mode_constraints__ensure_unique_arguments_3_0, 19,20,21,22,23,24)
MR_decl_label10(check_hlds__prop_mode_constraints__ensure_unique_arguments_in_goal_8_0, 12,6,20,21,4,30,24,34,35,37)
MR_decl_label10(check_hlds__prop_mode_constraints__ensure_unique_arguments_in_goal_8_0, 39,33,42,43,44,41,48,47,52,53)
MR_decl_label10(check_hlds__prop_mode_constraints__ensure_unique_arguments_in_goal_8_0, 55,57,51,60,59,66,72,65,77,76)
MR_decl_label4(check_hlds__prop_mode_constraints__ensure_unique_arguments_in_goal_8_0, 81,63,84,193)
MR_decl_label10(check_hlds__prop_mode_constraints__make_unification_11_0, 4,6,7,8,9,10,13,16,17,19)
MR_decl_label3(check_hlds__prop_mode_constraints__make_unification_11_0, 2,21,22)
...
MR_decl_label10(check_hlds__prop_mode_constraints__prop_mode_constraints_in_pred_7_0, 2,3,6,8,9,4,11,12,13,15)
MR_decl_label3(check_hlds__prop_mode_constraints__prop_mode_constraints_in_pred_7_0, 17,18,20)
...
MR_decl_static(fn__check_hlds__prop_mode_constraints__IntroducedFrom__func__ensure_unique_arguments__241__1_1_0)
MR_decl_static(fn__check_hlds__prop_mode_constraints__IntroducedFrom__func__ensure_unique_arguments__245__1_2_0)
...
{
MR_COMMON(0,1),
MR_ENTRY_AP(fn__check_hlds__prop_mode_constraints__IntroducedFrom__func__ensure_unique_arguments__241__1_1_0),
0
},
{
MR_COMMON(5,0),
...
{
MR_COMMON(6,0),
MR_ENTRY_AP(fn__check_hlds__prop_mode_constraints__IntroducedFrom__func__ensure_unique_arguments__245__1_2_0),
0
},
{
MR_COMMON(6,2),
...
"check_hlds.prop_mode_constraints",
"check_hlds.prop_mode_constraints",
"lambda_prop_mode_constraints_m_245",
3,
0
},
"check_hlds.prop_mode_constraints",
...
"check_hlds.prop_mode_constraints",
"check_hlds.prop_mode_constraints",
"lambda_prop_mode_constraints_m_241",
2,
0
},
"check_hlds.prop_mode_constraints",
...
MR_BEGIN_MODULE(check_hlds__prop_mode_constraints_module1)
	...
	MR_init_label10(check_hlds__prop_mode_constraints__ensure_unique_arguments_3_0,2,3,4,5,6,7,9,10,12,17)
	MR_init_label6(check_hlds__prop_mode_constraints__ensure_unique_arguments_3_0,19,20,21,22,23,24)
MR_BEGIN_CODE
...
MR_def_label(check_hlds__prop_mode_constraints__ensure_unique_arguments_3_0,7)
	...
	MR_sv(13) = (MR_Word) MR_TAG_COMMON(0,4,0);
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
	MR_r1 = MR_sv(13);
...
MR_BEGIN_MODULE(check_hlds__prop_mode_constraints_module4)
	...
	MR_init_label10(check_hlds__prop_mode_constraints__prop_mode_constraints_in_pred_7_0,2,3,6,8,9,4,11,12,13,15)
	MR_init_label3(check_hlds__prop_mode_constraints__prop_mode_constraints_in_pred_7_0,17,18,20)
MR_BEGIN_CODE
...
MR_def_label(check_hlds__prop_mode_constraints__prop_mode_constraints_in_pred_7_0,15)
	...
	MR_tempr2 = MR_sv(4);
	MR_sv(4) = (MR_Word) MR_CTOR0_ADDR(check_hlds__abstract_mode_constraints, pred_p_c_constraints);
	MR_tempr3 = MR_r1;
	MR_r1 = MR_sv(8);
	MR_r2 = MR_sv(9);
	MR_r3 = (MR_Word) MR_CTOR0_ADDR(check_hlds__build_mode_constraints, mc_var_info);
...
MR_BEGIN_MODULE(check_hlds__prop_mode_constraints_module9)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__fn__check_hlds__prop_mode_constraints__this_file_0_0);
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(check_hlds__prop_mode_constraints_module10)
	...
	MR_init_label10(check_hlds__prop_mode_constraints__ensure_unique_arguments_in_goal_8_0,39,33,42,43,44,41,48,47,52,53)
	MR_init_label10(check_hlds__prop_mode_constraints__ensure_unique_arguments_in_goal_8_0,55,57,51,60,59,66,72,65,77,76)
	MR_init_label4(check_hlds__prop_mode_constraints__ensure_unique_arguments_in_goal_8_0,81,63,84,193)
MR_BEGIN_CODE
...
MR_def_static(check_hlds__prop_mode_constraints__ensure_unique_arguments_in_goal_8_0)
	...
	if (MR_RTAGS_TEST(MR_tempr1,3,0)) {
		MR_GOTO_LAB(check_hlds__prop_mode_constraints__ensure_unique_arguments_in_goal_8_0_i193);
	}
...
MR_def_label(check_hlds__prop_mode_constraints__ensure_unique_arguments_in_goal_8_0,47)
	...
	if (MR_PTAG_TESTR(MR_r5,1)) {
		MR_GOTO_LAB(check_hlds__prop_mode_constraints__ensure_unique_arguments_in_goal_8_0_i51);
	}
	MR_incr_sp(12);
	MR_sv(12) = (MR_Word) MR_succip;
	{
...
MR_def_label(check_hlds__prop_mode_constraints__ensure_unique_arguments_in_goal_8_0,59)
	...
	if (MR_RTAGS_TESTR(MR_r5,3,7)) {
		MR_GOTO_LAB(check_hlds__prop_mode_constraints__ensure_unique_arguments_in_goal_8_0_i63);
	}
	MR_incr_sp(12);
	MR_sv(12) = (MR_Word) MR_succip;
	{
...
MR_def_label(check_hlds__prop_mode_constraints__ensure_unique_arguments_in_goal_8_0,65)
	...
	if (MR_PTAG_TESTR(MR_r6,2)) {
		MR_GOTO_LAB(check_hlds__prop_mode_constraints__ensure_unique_arguments_in_goal_8_0_i76);
	}
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r6;
...
MR_def_label(check_hlds__prop_mode_constraints__ensure_unique_arguments_in_goal_8_0,76)
	...
	MR_np_call_localret_ent(fn__check_hlds__prop_mode_constraints__this_file_0_0,
		check_hlds__prop_mode_constraints__ensure_unique_arguments_in_goal_8_0_i81);
MR_def_label(check_hlds__prop_mode_constraints__ensure_unique_arguments_in_goal_8_0,81)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = (MR_Word) MR_string_const("bi_implication", 14);
	MR_succip_word = MR_sv(12);
	MR_decr_sp(12);
	MR_np_tailcall_ent(libs__compiler_util__unexpected_2_0);
MR_def_label(check_hlds__prop_mode_constraints__ensure_unique_arguments_in_goal_8_0,63)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	...
	MR_sv(12) = (MR_Word) MR_succip;
	MR_np_call_localret_ent(fn__check_hlds__prop_mode_constraints__this_file_0_0,
		check_hlds__prop_mode_constraints__ensure_unique_arguments_in_goal_8_0_i84);
MR_def_label(check_hlds__prop_mode_constraints__ensure_unique_arguments_in_goal_8_0,84)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = (MR_Word) MR_string_const("switch", 6);
	MR_succip_word = MR_sv(12);
	MR_decr_sp(12);
	MR_np_tailcall_ent(libs__compiler_util__unexpected_2_0);
MR_def_label(check_hlds__prop_mode_constraints__ensure_unique_arguments_in_goal_8_0,193)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_proceed();
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
...
MR_BEGIN_MODULE(check_hlds__prop_mode_constraints_module11)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__check_hlds__prop_mode_constraints__add_to_conjunction_3_0);
	MR_init_label1(check_hlds__prop_mode_constraints__add_to_conjunction_3_0,2)
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'add_to_conjunction'/3 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
...
MR_BEGIN_MODULE(check_hlds__prop_mode_constraints_module12)
	...
	MR_init_label10(check_hlds__prop_mode_constraints__make_unification_11_0,4,6,7,8,9,10,13,16,17,19)
	MR_init_label3(check_hlds__prop_mode_constraints__make_unification_11_0,2,21,22)
MR_BEGIN_CODE
...
MR_def_label(check_hlds__prop_mode_constraints__pretty_print_pred_constraints_6_0,6)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(6) = MR_r1;
	MR_sv(7) = (MR_Word) MR_TAG_COMMON(1,4,11);
	MR_r1 = (MR_Integer) 0;
	MR_r2 = MR_sv(6);
...
MR_BEGIN_MODULE(check_hlds__prop_mode_constraints_module17)
	MR_init_entry1(fn__check_hlds__prop_mode_constraints__IntroducedFrom__func__ensure_unique_arguments__241__1_1_0);
	MR_INIT_PROC_LAYOUT_ADDR(mercury__fn__check_hlds__prop_mode_constraints__IntroducedFrom__func__ensure_unique_arguments__241__1_1_0);
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'IntroducedFrom__func__ensure_unique_arguments__241__1'/2 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(fn__check_hlds__prop_mode_constraints__IntroducedFrom__func__ensure_unique_arguments__241__1_1_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_BEGIN_MODULE(check_hlds__prop_mode_constraints_module18)
	MR_init_entry1(fn__check_hlds__prop_mode_constraints__IntroducedFrom__func__ensure_unique_arguments__245__1_2_0);
	MR_INIT_PROC_LAYOUT_ADDR(mercury__fn__check_hlds__prop_mode_constraints__IntroducedFrom__func__ensure_unique_arguments__245__1_2_0);
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'IntroducedFrom__func__ensure_unique_arguments__245__1'/3 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(fn__check_hlds__prop_mode_constraints__IntroducedFrom__func__ensure_unique_arguments__245__1_2_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 0, (MR_Integer) 4);
