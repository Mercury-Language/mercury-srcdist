    ...
    switch (MR_tag((MR_Word) STATE_VARIABLE_GoalExpr_86_86)) {
      ...
      case (MR_Integer) 0:
        {
          ...
          STATE_VARIABLE_GoalExpr_147_147 = (MR_Word) MR_mkword(MR_mktag(0), (MR_Word) Goal_9);
      ...
      case (MR_Integer) 3:
        switch (((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), STATE_VARIABLE_GoalExpr_86_86, (MR_Integer) 0)))) {
          ...
          case (MR_Integer) 0:
            {
              ...
              if ((Unifications_155 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
              {
                STATE_VARIABLE_GoalExpr_147_147 = STATE_VARIABLE_GoalExpr_86_86;
                STATE_VARIABLE_GoalInfo_136_136 = STATE_VARIABLE_GoalInfo_87_87;
              }
              else
              {
                ...
                {
                  CallGoalExpr_151 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 6 * sizeof(MR_Word)), NULL, NULL));
                  MR_hl_field(MR_mktag(3), CallGoalExpr_151, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 0));
                  ...
                  MR_hl_field(MR_mktag(3), CallGoalExpr_151, 5) = ((MR_Box) (Determinism_34));
                }
          ...
          case (MR_Integer) 2:
            {
              ...
              switch (ConjType_15) {
                ...
                case (MR_Integer) 1:
                  {
                    ...
                    *STATE_VARIABLE_VarTypes_85 = ((MR_Word) conv4_STATE_VARIABLE_VarTypes_85);
                    {
                      STATE_VARIABLE_GoalExpr_147_147 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL));
                      MR_hl_field(MR_mktag(3), STATE_VARIABLE_GoalExpr_147_147, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 2));
                      MR_hl_field(MR_mktag(3), STATE_VARIABLE_GoalExpr_147_147, 1) = ((MR_Box) ((MR_Integer) 1));
                ...
                case (MR_Integer) 0:
                  {
                    MR_Word TypeCtorInfo_171_171 = (MR_Word) &hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_hlds_goal_0;
                    MR_Word Goals1_17;
                    MR_Word Goals_18;
                    ...
                    *STATE_VARIABLE_VarTypes_85 = ((MR_Word) conv11_STATE_VARIABLE_VarTypes_85);
                    check_hlds__prop_mode_constraints__flatten_conjunction_2_p_0(Goals1_17, &Goals_18);
                    {
                      STATE_VARIABLE_GoalExpr_147_147 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL));
                      MR_hl_field(MR_mktag(3), STATE_VARIABLE_GoalExpr_147_147, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 2));
                      MR_hl_field(MR_mktag(3), STATE_VARIABLE_GoalExpr_147_147, 1) = ((MR_Box) ((MR_Integer) 0));
          ...
          case (MR_Integer) 3:
            {
              MR_Word TypeCtorInfo_195_195 = (MR_Word) &hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_hlds_goal_0;
              ...
              *STATE_VARIABLE_VarTypes_85 = ((MR_Word) conv18_STATE_VARIABLE_VarTypes_85);
              {
                STATE_VARIABLE_GoalExpr_147_147 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), STATE_VARIABLE_GoalExpr_147_147, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 3));
          ...
          case (MR_Integer) 5:
            {
              ...
              {
                STATE_VARIABLE_GoalExpr_147_147 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), STATE_VARIABLE_GoalExpr_147_147, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 5));
          ...
          case (MR_Integer) 6:
            {
              ...
              {
                STATE_VARIABLE_GoalExpr_147_147 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 5 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), STATE_VARIABLE_GoalExpr_147_147, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 6));
                ...
                case (MR_Integer) 1:
                  {
                    ...
                    *STATE_VARIABLE_VarTypes_85 = ((MR_Word) conv25_STATE_VARIABLE_VarTypes_85);
                    ...
                    {
                      STATE_VARIABLE_GoalExpr_147_147 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                      MR_hl_field(MR_mktag(3), STATE_VARIABLE_GoalExpr_147_147, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 7));
                ...
                case (MR_Integer) 2:
                  {
                    ...
                    {
                      ShortHand_162 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL));
