...
check_hlds__prop_mode_constraints__IntroducedFrom__func__ensure_unique_arguments__250__1_2_f_0(
  ...
  MR_Integer ProcId_14)
{
  ...
  ProcNamePieces_18 = hlds__hlds_error_util__describe_one_proc_name_3_f_0(ModuleInfo_10, (MR_Integer) 0, PredProcId_17);
  Var_28 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), ProcNamePieces_18, (MR_Word) (MR_mkword(1, &check_hlds__prop_mode_constraints_scalar_common_3[8])));
  parse_tree__write_error_spec__write_error_pieces_plain_5_p_0(OutputStream_9, Globals_16, Var_28);
  ...
  MR_Word PredId_12)
{
  ...
  Var_33 = hlds__hlds_error_util__describe_one_pred_info_name_2_f_0((MR_Integer) 0, PredInfo_15);
  ...
  mercury__map__lookup_3_p_0((MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_id_0), (MR_Word) (&check_hlds__prop_mode_constraints_scalar_common_2[0]), PredConstraintsMap_11, ((MR_Box) (PredId_12)), &conv0_Var_39);
  Var_39 = ((MR_Tuple) (conv0_Var_39));
  PredConstraints_17 = ((MR_Word) ((MR_hl_field(0, Var_39, (MR_Integer) 1))));
  ...
  check_hlds__abstract_mode_constraints__dump_constraints_and_annotations_6_p_0(OutputStream_8, Globals_14, ConstraintVarSet_10, AllProcAnnConstraints_18);
  {
    ...
    MR_hl_field(0, Var_41, 0) = ((MR_Box) (&check_hlds__prop_mode_constraints_scalar_common_7[2]));
    MR_hl_field(0, Var_41, 1) = ((MR_Box) (check_hlds__prop_mode_constraints__pretty_print_pred_constraints_7_p_0_1));
    MR_hl_field(0, Var_41, 2) = ((MR_Box) ((MR_Integer) 5));
    MR_hl_field(0, Var_41, 3) = ((MR_Box) (OutputStream_8));
    MR_hl_field(0, Var_41, 4) = ((MR_Box) (ModuleInfo_9));
    MR_hl_field(0, Var_41, 5) = ((MR_Box) (ConstraintVarSet_10));
    MR_hl_field(0, Var_41, 6) = ((MR_Box) (PredConstraints_17));
    MR_hl_field(0, Var_41, 7) = ((MR_Box) (PredId_12));
  }
  Var_42 = hlds__hlds_pred__pred_info_all_procids_1_f_0(PredInfo_15);
  mercury__list__foldl_4_p_2((MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_proc_id_0), (MR_Word) (&mercury__io__io__type_ctor_info_state_0), Var_41, Var_42, ((MR_Box) ((MR_Integer) 0)), &conv1_STATE_VARIABLE_IO_20);
}
  ...
  MR_Box wrapper_arg_2)
{
  ...
  conv8_LambdaHeadVar__3_39 = check_hlds__prop_mode_constraints__IntroducedFrom__func__ensure_unique_arguments__250__1_2_f_0(((MR_Word) (wrapper_arg_1)), ((MR_Word) (wrapper_arg_2)));
