  ...
  MR_Word LambdaHeadVar__2_38)
{
  ...
  MR_Word Var_47 = ((MR_Word) ((MR_hl_field(MR_mktag(0), LambdaHeadVar__1_37, (MR_Integer) 0))));
  MR_Word Var_49 = ((MR_Word) ((MR_hl_field(MR_mktag(0), LambdaHeadVar__1_37, (MR_Integer) 2))));
  MR_Word Var_50 = ((MR_Word) ((MR_hl_field(MR_mktag(0), LambdaHeadVar__1_37, (MR_Integer) 3))));
  MR_Word Var_51 = ((MR_Word) ((MR_hl_field(MR_mktag(0), LambdaHeadVar__1_37, (MR_Integer) 4))));

  {
    LambdaHeadVar__3_39 = (MR_Word) MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(MR_mktag(0), LambdaHeadVar__3_39, 0) = ((MR_Box) (Var_47));
    MR_hl_field(MR_mktag(0), LambdaHeadVar__3_39, 1) = ((MR_Box) (LambdaHeadVar__2_38));
    MR_hl_field(MR_mktag(0), LambdaHeadVar__3_39, 2) = ((MR_Box) (Var_49));
    MR_hl_field(MR_mktag(0), LambdaHeadVar__3_39, 3) = ((MR_Box) (Var_50));
    MR_hl_field(MR_mktag(0), LambdaHeadVar__3_39, 4) = ((MR_Box) (Var_51));
  }
  ...
  MR_Word * STATE_VARIABLE_VarTypes_85)
{
              ...
              case (MR_Integer) 1:
                {
                  ...
                  *STATE_VARIABLE_VarTypes_85 = ((MR_Word) (conv4_STATE_VARIABLE_VarTypes_85));
                  {
                    STATE_VARIABLE_GoalExpr_92_92 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(MR_mktag(3), STATE_VARIABLE_GoalExpr_92_92, 0) = ((MR_Box) ((MR_Unsigned) 2U));
                    MR_hl_field(MR_mktag(3), STATE_VARIABLE_GoalExpr_92_92, 1) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 1));
                    MR_hl_field(MR_mktag(3), STATE_VARIABLE_GoalExpr_92_92, 2) = ((MR_Box) (Goals_150));
                  }
                }
                break;
              case (MR_Integer) 0:
                {
                  ...
                  *STATE_VARIABLE_VarTypes_85 = ((MR_Word) (conv11_STATE_VARIABLE_VarTypes_85));
                  check_hlds__prop_mode_constraints__flatten_conjunction_2_p_0(Goals1_17, &Goals_18);
                  {
                    STATE_VARIABLE_GoalExpr_92_92 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(MR_mktag(3), STATE_VARIABLE_GoalExpr_92_92, 0) = ((MR_Box) ((MR_Unsigned) 2U));
                    MR_hl_field(MR_mktag(3), STATE_VARIABLE_GoalExpr_92_92, 1) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 0));
                    MR_hl_field(MR_mktag(3), STATE_VARIABLE_GoalExpr_92_92, 2) = ((MR_Box) (Goals_18));
                  }
                }
                break;
            }
        ...
        case (MR_Integer) 3:
          {
            ...
            *STATE_VARIABLE_VarTypes_85 = ((MR_Word) (conv18_STATE_VARIABLE_VarTypes_85));
            {
              STATE_VARIABLE_GoalExpr_92_92 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(3), STATE_VARIABLE_GoalExpr_92_92, 0) = ((MR_Box) ((MR_Unsigned) 3U));
              MR_hl_field(MR_mktag(3), STATE_VARIABLE_GoalExpr_92_92, 1) = ((MR_Box) (Goals_159));
            }
            STATE_VARIABLE_GoalInfo_104_104 = STATE_VARIABLE_GoalInfo_87_87;
          }
          break;
        ...
        case (MR_Integer) 5:
          {
            ...
            {
              STATE_VARIABLE_GoalExpr_92_92 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(3), STATE_VARIABLE_GoalExpr_92_92, 0) = ((MR_Box) ((MR_Unsigned) 5U));
              MR_hl_field(MR_mktag(3), STATE_VARIABLE_GoalExpr_92_92, 1) = ((MR_Box) (Reason_46));
              MR_hl_field(MR_mktag(3), STATE_VARIABLE_GoalExpr_92_92, 2) = ((MR_Box) (Goal_160));
            }
            STATE_VARIABLE_GoalInfo_104_104 = STATE_VARIABLE_GoalInfo_87_87;
          }
          break;
        case (MR_Integer) 6:
          {
            ...
            {
              STATE_VARIABLE_GoalExpr_92_92 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(3), STATE_VARIABLE_GoalExpr_92_92, 0) = ((MR_Box) ((MR_Unsigned) 6U));
              MR_hl_field(MR_mktag(3), STATE_VARIABLE_GoalExpr_92_92, 1) = ((MR_Box) (ExistVars_47));
              MR_hl_field(MR_mktag(3), STATE_VARIABLE_GoalExpr_92_92, 2) = ((MR_Box) (Cond_51));
              MR_hl_field(MR_mktag(3), STATE_VARIABLE_GoalExpr_92_92, 3) = ((MR_Box) (Then_52));
              MR_hl_field(MR_mktag(3), STATE_VARIABLE_GoalExpr_92_92, 4) = ((MR_Box) (Else_53));
            }
            STATE_VARIABLE_GoalInfo_104_104 = STATE_VARIABLE_GoalInfo_87_87;
          }
          break;
              ...
              case (MR_Integer) 1:
                {
                  ...
                  *STATE_VARIABLE_VarTypes_85 = ((MR_Word) (conv25_STATE_VARIABLE_VarTypes_85));
                  ...
                  {
                    STATE_VARIABLE_GoalExpr_92_92 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(MR_mktag(3), STATE_VARIABLE_GoalExpr_92_92, 0) = ((MR_Box) ((MR_Unsigned) 7U));
                    MR_hl_field(MR_mktag(3), STATE_VARIABLE_GoalExpr_92_92, 1) = ((MR_Box) (ShortHand_71));
                  }
                }
                break;
              case (MR_Integer) 2:
                {
                  ...
                  }
                  {
                    STATE_VARIABLE_GoalExpr_92_92 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(MR_mktag(3), STATE_VARIABLE_GoalExpr_92_92, 0) = ((MR_Box) ((MR_Unsigned) 7U));
                    MR_hl_field(MR_mktag(3), STATE_VARIABLE_GoalExpr_92_92, 1) = ((MR_Box) (ShortHand_162));
                  }
                }
                break;
            }
  ...
  }
  {
    ...
    *STATE_VARIABLE_Goal_79 = base;
    MR_hl_field(MR_mktag(0), base, 0) = ((MR_Box) (STATE_VARIABLE_GoalExpr_92_92));
  ...
  MR_Word * STATE_VARIABLE_Constraints_19)
{
  ...
  MR_Word BodyConstraints_34;
  MR_Tuple Var_39;

  hlds__hlds_module__module_info_pred_info_3_p_0(STATE_VARIABLE_ModuleInfo_0_14, PredId_8, &PredInfo0_12);
  hlds__hlds_pred__pred_info_get_clauses_info_2_p_0(PredInfo0_12, &ClausesInfo0_31);
  hlds__goal_path__fill_goal_id_slots_in_clauses_4_p_0(STATE_VARIABLE_ModuleInfo_0_14, &ContainingGoalMap_32, ClausesInfo0_31, &ClausesInfo_33);
  hlds__hlds_pred__pred_info_set_clauses_info_3_p_0(ClausesInfo_33, PredInfo0_12, &PredInfo_13);
  succeeded = hlds__hlds_pred__pred_info_infer_modes_1_p_0(PredInfo_13);
  if (succeeded)
  {
    MR_Word Var_37;

    Var_37 = check_hlds__abstract_mode_constraints__init_pred_p_c_constraints_0_f_0();
    check_hlds__build_mode_constraints__add_clauses_constraints_7_p_0(STATE_VARIABLE_ModuleInfo_0_14, PredId_8, PredInfo_13, STATE_VARIABLE_VarInfo_0_16, STATE_VARIABLE_VarInfo_17, Var_37, &BodyConstraints_34);
  }
  else
  {
    MR_Word ProcIds_49;
    MR_Word BodyConstr_50;
    MR_Word ProcInfos_51;
    MR_Word STATE_VARIABLE_VarInfo_17_52;
    MR_Word Var_53;
    MR_Word Var_54;
    MR_Word Var_55;
    MR_Box conv4_STATE_VARIABLE_VarInfo_17;
    MR_Box conv3_BodyConstraints_34;

    ProcIds_49 = hlds__hlds_pred__pred_info_all_procids_1_f_0(PredInfo_13);
    Var_53 = check_hlds__abstract_mode_constraints__init_pred_p_c_constraints_0_f_0();
    check_hlds__build_mode_constraints__add_clauses_constraints_7_p_0(STATE_VARIABLE_ModuleInfo_0_14, PredId_8, PredInfo_13, STATE_VARIABLE_VarInfo_0_16, &STATE_VARIABLE_VarInfo_17_52, Var_53, &BodyConstr_50);
    {
      Var_54 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), Var_54, 0) = ((MR_Box) (&check_hlds__prop_mode_constraints_scalar_common_8[1]));
      MR_hl_field(MR_mktag(0), Var_54, 1) = ((MR_Box) (check_hlds__prop_mode_constraints__prop_mode_constraints_in_pred_7_p_0_1));
      MR_hl_field(MR_mktag(0), Var_54, 2) = ((MR_Box) ((MR_Integer) 1));
      MR_hl_field(MR_mktag(0), Var_54, 3) = ((MR_Box) (PredInfo_13));
    }
    mercury__list__map_3_p_0((MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_proc_id_0), (MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_proc_info_0), Var_54, ProcIds_49, &ProcInfos_51);
    {
      Var_55 = (MR_Word) MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), Var_55, 0) = ((MR_Box) (&check_hlds__prop_mode_constraints_scalar_common_7[1]));
      MR_hl_field(MR_mktag(0), Var_55, 1) = ((MR_Box) (check_hlds__prop_mode_constraints__prop_mode_constraints_in_pred_7_p_0_2));
      MR_hl_field(MR_mktag(0), Var_55, 2) = ((MR_Box) ((MR_Integer) 2));
      MR_hl_field(MR_mktag(0), Var_55, 3) = ((MR_Box) (STATE_VARIABLE_ModuleInfo_0_14));
      MR_hl_field(MR_mktag(0), Var_55, 4) = ((MR_Box) (PredId_8));
    }
    mercury__list__foldl2_corresponding_7_p_0((MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_proc_id_0), (MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_proc_info_0), (MR_Word) (&check_hlds__build_mode_constraints__check_hlds__build_mode_constraints__type_ctor_info_mc_var_info_0), (MR_Word) (&check_hlds__abstract_mode_constraints__check_hlds__abstract_mode_constraints__type_ctor_info_pred_p_c_constraints_0), Var_55, ProcIds_49, ProcInfos_51, ((MR_Box) (STATE_VARIABLE_VarInfo_17_52)), &conv4_STATE_VARIABLE_VarInfo_17, ((MR_Box) (BodyConstr_50)), &conv3_BodyConstraints_34);
    *STATE_VARIABLE_VarInfo_17 = ((MR_Word) (conv4_STATE_VARIABLE_VarInfo_17));
    BodyConstraints_34 = ((MR_Word) (conv3_BodyConstraints_34));
  }
  {
    Var_39 = (MR_Tuple) MR_new_object(MR_Tuple, (2 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(MR_mktag(0), Var_39, 0) = ((MR_Box) (ContainingGoalMap_32));
    MR_hl_field(MR_mktag(0), Var_39, 1) = ((MR_Box) (BodyConstraints_34));
  }
  mercury__map__set_4_p_0((MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_id_0), (MR_Word) (&check_hlds__prop_mode_constraints_scalar_common_2[0]), ((MR_Box) (PredId_8)), ((MR_Box) (Var_39)), STATE_VARIABLE_Constraints_0_18, STATE_VARIABLE_Constraints_19);
  ...
  MR_Box wrapper_arg_2)
{
  ...
  conv8_LambdaHeadVar__3_39 = check_hlds__prop_mode_constraints__IntroducedFrom__func__ensure_unique_arguments__247__1_2_f_0(((MR_Word) (wrapper_arg_1)), ((MR_Word) (wrapper_arg_2)));
