...
{
  {
    ...
    MR_Word Var_47 = ((MR_Word) (MR_hl_field(MR_mktag(0), LambdaHeadVar__1_35, (MR_Integer) 1)));

    {
      LambdaHeadVar__3_37 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 5 * sizeof(MR_Word)), NULL, NULL);
...
{
  {
    ...
    TypeCtorInfo_42_42 = (MR_Word) &parse_tree__error_util__parse_tree__error_util__type_ctor_info_format_component_0;
    Var_31 = hlds__hlds_error_util__describe_one_pred_info_name_2_f_0((MR_Integer) 0, PredInfo_13);
    Var_30 = mercury__list__f_43_43_2_f_0(TypeCtorInfo_42_42, Var_31, (MR_Word) MR_mkword(MR_mktag(1), &check_hlds__prop_mode_constraints_scalar_common_3[8]));
    Var_24 = mercury__list__f_43_43_2_f_0(TypeCtorInfo_42_42, (MR_Word) MR_mkword(MR_mktag(1), &check_hlds__prop_mode_constraints_scalar_common_3[6]), Var_30);
    ...
    Var_14 = ((MR_Word) (MR_hl_field(MR_mktag(0), Var_37, (MR_Integer) 0)));
    ...
    check_hlds__abstract_mode_constraints__dump_constraints_and_annotations_5_p_0(Globals_12, ConstraintVarSet_8, AllProcAnnConstraints_16);
    {
      ...
      MR_hl_field(MR_mktag(0), Var_39, 0) = ((MR_Box) (&check_hlds__prop_mode_constraints_scalar_common_5[1]));
    ...
    mercury__list__foldl_4_p_2((MR_Word) &mercury__builtin__builtin__type_ctor_info_int_0, (MR_Word) &mercury__io__io__type_ctor_info_state_0, Var_39, Var_40, ((MR_Box) ((MR_Integer) 0)), &conv1_STATE_VARIABLE_IO_18);
  }
}
...
{
  {
    ...
    if (succeeded)
    {
      MR_Word TypeCtorInfo_50_50 = (MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0;
      ...
      OldVarName_19 = mercury__varset__lookup_name_2_f_0(TypeCtorInfo_50_50, STATE_VARIABLE_VarSet_0_31, Var0_13);
      ...
      mercury__varset__new_uniquely_named_var_4_p_0(TypeCtorInfo_50_50, NewVarName_21, Var_14, STATE_VARIABLE_VarSet_0_31, STATE_VARIABLE_VarSet_32);
      ...
      hlds__make_goal__create_atomic_complicated_unification_7_p_0(Var0_13, Var_38, Context_12, (MR_Word) MR_mkword(MR_mktag(3), &check_hlds__prop_mode_constraints_scalar_common_10[0]), (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), (MR_Integer) 0, &UnificationGoal0_22);
      ...
      Var_43 = parse_tree__set_of_var__list_to_set_1_f_0(TypeCtorInfo_50_50, Var_44);
      hlds__hlds_goal__goal_info_set_nonlocals_3_p_0(Var_43, UnificationGoalInfo0_24, &UnificationGoalInfo_25);
      {
        UnificationGoal_26 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
...
{
  {
    ...
    succeeded = ((((MR_tag((MR_Word) Var_10)) == (MR_mktag((MR_Integer) 3)))) && (((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), Var_10, (MR_Integer) 0)))) == (MR_Integer) 2)));
    if (succeeded)
    {
      Var_11 = ((MR_Word) (MR_hl_field(MR_mktag(3), Var_10, (MR_Integer) 1)));
...
{
  {
    ...
    MR_Word STATE_VARIABLE_GoalExpr_149_149;
    ...
    switch (MR_tag((MR_Word) STATE_VARIABLE_GoalExpr_86_86)) {
      ...
      case (MR_Integer) 0:
        {
          MR_Word Goal_9;
          MR_Word Goal0_45 = (MR_Word) MR_body(((MR_Word) STATE_VARIABLE_GoalExpr_86_86), (MR_Integer) 0);
          ...
          STATE_VARIABLE_GoalExpr_149_149 = (MR_Word) MR_mkword(MR_mktag(0), (MR_Word) Goal_9);
          STATE_VARIABLE_GoalInfo_138_138 = STATE_VARIABLE_GoalInfo_87_87;
        }
        break;
      case (MR_Integer) 1:
        {
          ...
          *STATE_VARIABLE_VarTypes_85 = STATE_VARIABLE_VarTypes_0_84;
          STATE_VARIABLE_GoalExpr_149_149 = STATE_VARIABLE_GoalExpr_86_86;
          STATE_VARIABLE_GoalInfo_138_138 = STATE_VARIABLE_GoalInfo_87_87;
        }
        break;
      case (MR_Integer) 2:
        {
          ...
          MR_Word Builtin_22 = ((MR_Word) (MR_hl_field(MR_mktag(2), STATE_VARIABLE_GoalExpr_86_86, (MR_Integer) 3)));
          ...
          if ((Unifications_26 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
          {
            STATE_VARIABLE_GoalExpr_149_149 = STATE_VARIABLE_GoalExpr_86_86;
            STATE_VARIABLE_GoalInfo_138_138 = STATE_VARIABLE_GoalInfo_87_87;
          }
          else
          {
            ...
            {
              CallGoalExpr_30 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, ((MR_Integer) 6 * sizeof(MR_Word)), NULL, NULL));
              ...
              MR_hl_field(MR_mktag(2), CallGoalExpr_30, 3) = ((MR_Box) (Builtin_22));
            ...
            check_hlds__prop_mode_constraints__replace_call_with_conjunction_6_p_0(CallGoalExpr_30, Unifications_26, Args_27, &STATE_VARIABLE_GoalExpr_149_149, STATE_VARIABLE_GoalInfo_87_87, &STATE_VARIABLE_GoalInfo_138_138);
          }
        }
        break;
      case (MR_Integer) 3:
        switch (((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), STATE_VARIABLE_GoalExpr_86_86, (MR_Integer) 0)))) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 0:
            {
              ...
              MR_Word Determinism_34 = ((MR_Word) (MR_hl_field(MR_mktag(3), STATE_VARIABLE_GoalExpr_86_86, (MR_Integer) 5)));
              MR_Word Args0_155 = ((MR_Word) (MR_hl_field(MR_mktag(3), STATE_VARIABLE_GoalExpr_86_86, (MR_Integer) 2)));
              MR_Word Context_156;
              MR_Word Unifications_157;
              MR_Word Args_158;

              Context_156 = hlds__hlds_goal__goal_info_get_context_1_f_0(STATE_VARIABLE_GoalInfo_87_87);
              check_hlds__prop_mode_constraints__make_unifications_10_p_0(Context_156, &Unifications_157, Args0_155, &Args_158, STATE_VARIABLE_SeenSoFar_0_80, STATE_VARIABLE_SeenSoFar_81, STATE_VARIABLE_VarSet_0_82, STATE_VARIABLE_VarSet_83, STATE_VARIABLE_VarTypes_0_84, STATE_VARIABLE_VarTypes_85);
              if ((Unifications_157 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
              {
                STATE_VARIABLE_GoalExpr_149_149 = STATE_VARIABLE_GoalExpr_86_86;
                STATE_VARIABLE_GoalInfo_138_138 = STATE_VARIABLE_GoalInfo_87_87;
              }
              ...
              {
                MR_Word CallGoalExpr_153;

                {
                  CallGoalExpr_153 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 6 * sizeof(MR_Word)), NULL, NULL));
                  MR_hl_field(MR_mktag(3), CallGoalExpr_153, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 0));
                  MR_hl_field(MR_mktag(3), CallGoalExpr_153, 1) = ((MR_Box) (Details_31));
                  MR_hl_field(MR_mktag(3), CallGoalExpr_153, 2) = ((MR_Box) (Args_158));
                  MR_hl_field(MR_mktag(3), CallGoalExpr_153, 3) = ((MR_Box) (Modes_32));
                  MR_hl_field(MR_mktag(3), CallGoalExpr_153, 4) = ((MR_Box) (MaybeArgRegs_33));
                  MR_hl_field(MR_mktag(3), CallGoalExpr_153, 5) = ((MR_Box) (Determinism_34));
                }
                check_hlds__prop_mode_constraints__replace_call_with_conjunction_6_p_0(CallGoalExpr_153, Unifications_157, Args_158, &STATE_VARIABLE_GoalExpr_149_149, STATE_VARIABLE_GoalInfo_87_87, &STATE_VARIABLE_GoalInfo_138_138);
              }
            }
            break;
          case (MR_Integer) 1:
          ...
          case (MR_Integer) 2:
            {
              MR_Word ConjType_15 = ((MR_Word) (MR_hl_field(MR_mktag(3), STATE_VARIABLE_GoalExpr_86_86, (MR_Integer) 1)));
              ...
              switch (ConjType_15) {
                ...
                case (MR_Integer) 1:
                  {
                    MR_Word TypeCtorInfo_185_185 = (MR_Word) &hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_hlds_goal_0;
                    MR_Word Goals_152;
                    MR_Box conv6_STATE_VARIABLE_SeenSoFar_81;
                    MR_Box conv5_STATE_VARIABLE_VarSet_83;
                    MR_Box conv4_STATE_VARIABLE_VarTypes_85;

                    mercury__list__map_foldl3_9_p_1(TypeCtorInfo_185_185, TypeCtorInfo_185_185, (MR_Word) &check_hlds__prop_mode_constraints_scalar_common_3[1], (MR_Word) &check_hlds__prop_mode_constraints_scalar_common_3[2], (MR_Word) &check_hlds__prop_mode_constraints_scalar_common_1[2], (MR_Word) &check_hlds__prop_mode_constraints_scalar_common_1[8], Goals0_16, &Goals_152, ((MR_Box) (STATE_VARIABLE_SeenSoFar_0_80)), &conv6_STATE_VARIABLE_SeenSoFar_81, ((MR_Box) (STATE_VARIABLE_VarSet_0_82)), &conv5_STATE_VARIABLE_VarSet_83, ((MR_Box) (STATE_VARIABLE_VarTypes_0_84)), &conv4_STATE_VARIABLE_VarTypes_85);
                    ...
                    *STATE_VARIABLE_VarTypes_85 = ((MR_Word) conv4_STATE_VARIABLE_VarTypes_85);
                    {
                      STATE_VARIABLE_GoalExpr_149_149 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL));
                      MR_hl_field(MR_mktag(3), STATE_VARIABLE_GoalExpr_149_149, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 2));
                      MR_hl_field(MR_mktag(3), STATE_VARIABLE_GoalExpr_149_149, 1) = ((MR_Box) ((MR_Integer) 1));
                      MR_hl_field(MR_mktag(3), STATE_VARIABLE_GoalExpr_149_149, 2) = ((MR_Box) (Goals_152));
                    }
                  }
                  break;
                case (MR_Integer) 0:
                  {
                    MR_Word TypeCtorInfo_173_173 = (MR_Word) &hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_hlds_goal_0;
                    MR_Word Goals1_17;
                    MR_Word Goals_18;
                    ...
                    mercury__list__map_foldl3_9_p_1(TypeCtorInfo_173_173, TypeCtorInfo_173_173, (MR_Word) &check_hlds__prop_mode_constraints_scalar_common_3[1], (MR_Word) &check_hlds__prop_mode_constraints_scalar_common_3[2], (MR_Word) &check_hlds__prop_mode_constraints_scalar_common_1[2], (MR_Word) &check_hlds__prop_mode_constraints_scalar_common_1[9], Goals0_16, &Goals1_17, ((MR_Box) (STATE_VARIABLE_SeenSoFar_0_80)), &conv13_STATE_VARIABLE_SeenSoFar_81, ((MR_Box) (STATE_VARIABLE_VarSet_0_82)), &conv12_STATE_VARIABLE_VarSet_83, ((MR_Box) (STATE_VARIABLE_VarTypes_0_84)), &conv11_STATE_VARIABLE_VarTypes_85);
                    ...
                    *STATE_VARIABLE_VarTypes_85 = ((MR_Word) conv11_STATE_VARIABLE_VarTypes_85);
                    check_hlds__prop_mode_constraints__flatten_conjunction_2_p_0(Goals1_17, &Goals_18);
                    {
                      STATE_VARIABLE_GoalExpr_149_149 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL));
                      MR_hl_field(MR_mktag(3), STATE_VARIABLE_GoalExpr_149_149, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 2));
                      MR_hl_field(MR_mktag(3), STATE_VARIABLE_GoalExpr_149_149, 1) = ((MR_Box) ((MR_Integer) 0));
                      MR_hl_field(MR_mktag(3), STATE_VARIABLE_GoalExpr_149_149, 2) = ((MR_Box) (Goals_18));
                    }
                  }
                  break;
              }
          ...
          case (MR_Integer) 3:
            {
              MR_Word TypeCtorInfo_197_197 = (MR_Word) &hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_hlds_goal_0;
              MR_Word Goals0_160 = ((MR_Word) (MR_hl_field(MR_mktag(3), STATE_VARIABLE_GoalExpr_86_86, (MR_Integer) 1)));
              MR_Word Goals_161;
              MR_Box conv20_STATE_VARIABLE_SeenSoFar_81;
              MR_Box conv19_STATE_VARIABLE_VarSet_83;
              MR_Box conv18_STATE_VARIABLE_VarTypes_85;

              mercury__list__map_foldl3_9_p_1(TypeCtorInfo_197_197, TypeCtorInfo_197_197, (MR_Word) &check_hlds__prop_mode_constraints_scalar_common_3[1], (MR_Word) &check_hlds__prop_mode_constraints_scalar_common_3[2], (MR_Word) &check_hlds__prop_mode_constraints_scalar_common_1[2], (MR_Word) &check_hlds__prop_mode_constraints_scalar_common_1[10], Goals0_160, &Goals_161, ((MR_Box) (STATE_VARIABLE_SeenSoFar_0_80)), &conv20_STATE_VARIABLE_SeenSoFar_81, ((MR_Box) (STATE_VARIABLE_VarSet_0_82)), &conv19_STATE_VARIABLE_VarSet_83, ((MR_Box) (STATE_VARIABLE_VarTypes_0_84)), &conv18_STATE_VARIABLE_VarTypes_85);
              ...
              *STATE_VARIABLE_VarTypes_85 = ((MR_Word) conv18_STATE_VARIABLE_VarTypes_85);
              {
                STATE_VARIABLE_GoalExpr_149_149 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), STATE_VARIABLE_GoalExpr_149_149, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 3));
                MR_hl_field(MR_mktag(3), STATE_VARIABLE_GoalExpr_149_149, 1) = ((MR_Box) (Goals_161));
              }
              STATE_VARIABLE_GoalInfo_138_138 = STATE_VARIABLE_GoalInfo_87_87;
            }
            break;
          ...
          case (MR_Integer) 5:
            {
              ...
              MR_Word Goal_162;
              MR_Word Goal0_163 = ((MR_Word) (MR_hl_field(MR_mktag(3), STATE_VARIABLE_GoalExpr_86_86, (MR_Integer) 2)));

              check_hlds__prop_mode_constraints__ensure_unique_arguments_in_goal_8_p_0(Goal0_163, &Goal_162, STATE_VARIABLE_SeenSoFar_0_80, STATE_VARIABLE_SeenSoFar_81, STATE_VARIABLE_VarSet_0_82, STATE_VARIABLE_VarSet_83, STATE_VARIABLE_VarTypes_0_84, STATE_VARIABLE_VarTypes_85);
              {
                STATE_VARIABLE_GoalExpr_149_149 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), STATE_VARIABLE_GoalExpr_149_149, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 5));
                MR_hl_field(MR_mktag(3), STATE_VARIABLE_GoalExpr_149_149, 1) = ((MR_Box) (Reason_46));
                MR_hl_field(MR_mktag(3), STATE_VARIABLE_GoalExpr_149_149, 2) = ((MR_Box) (Goal_162));
              }
              STATE_VARIABLE_GoalInfo_138_138 = STATE_VARIABLE_GoalInfo_87_87;
            }
            break;
          case (MR_Integer) 6:
            {
              ...
              MR_Word Then_52;
              MR_Word Else_53;
              MR_Word STATE_VARIABLE_SeenSoFar_103_103;
              MR_Word STATE_VARIABLE_VarSet_104_104;
              MR_Word STATE_VARIABLE_VarTypes_105_105;
              MR_Word STATE_VARIABLE_SeenSoFar_106_106;
              MR_Word STATE_VARIABLE_VarSet_107_107;
              MR_Word STATE_VARIABLE_VarTypes_108_108;

              check_hlds__prop_mode_constraints__ensure_unique_arguments_in_goal_8_p_0(Cond0_48, &Cond_51, STATE_VARIABLE_SeenSoFar_0_80, &STATE_VARIABLE_SeenSoFar_103_103, STATE_VARIABLE_VarSet_0_82, &STATE_VARIABLE_VarSet_104_104, STATE_VARIABLE_VarTypes_0_84, &STATE_VARIABLE_VarTypes_105_105);
              check_hlds__prop_mode_constraints__ensure_unique_arguments_in_goal_8_p_0(Then0_49, &Then_52, STATE_VARIABLE_SeenSoFar_103_103, &STATE_VARIABLE_SeenSoFar_106_106, STATE_VARIABLE_VarSet_104_104, &STATE_VARIABLE_VarSet_107_107, STATE_VARIABLE_VarTypes_105_105, &STATE_VARIABLE_VarTypes_108_108);
              check_hlds__prop_mode_constraints__ensure_unique_arguments_in_goal_8_p_0(Else0_50, &Else_53, STATE_VARIABLE_SeenSoFar_106_106, STATE_VARIABLE_SeenSoFar_81, STATE_VARIABLE_VarSet_107_107, STATE_VARIABLE_VarSet_83, STATE_VARIABLE_VarTypes_108_108, STATE_VARIABLE_VarTypes_85);
              {
                STATE_VARIABLE_GoalExpr_149_149 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 5 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), STATE_VARIABLE_GoalExpr_149_149, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 6));
                MR_hl_field(MR_mktag(3), STATE_VARIABLE_GoalExpr_149_149, 1) = ((MR_Box) (ExistVars_47));
                MR_hl_field(MR_mktag(3), STATE_VARIABLE_GoalExpr_149_149, 2) = ((MR_Box) (Cond_51));
                MR_hl_field(MR_mktag(3), STATE_VARIABLE_GoalExpr_149_149, 3) = ((MR_Box) (Then_52));
                MR_hl_field(MR_mktag(3), STATE_VARIABLE_GoalExpr_149_149, 4) = ((MR_Box) (Else_53));
              }
              STATE_VARIABLE_GoalInfo_138_138 = STATE_VARIABLE_GoalInfo_87_87;
            }
            break;
                ...
                case (MR_Integer) 1:
                  {
                    ...
                    MR_Word GoalType_62 = ((MR_Word) (MR_hl_field(MR_mktag(1), ShortHand0_61, (MR_Integer) 0)));
                    ...
                    MR_Word STATE_VARIABLE_SeenSoFar_95_95;
                    ...
                    check_hlds__prop_mode_constraints__ensure_unique_arguments_in_goal_8_p_0(MainGoal0_66, &MainGoal_69, STATE_VARIABLE_SeenSoFar_0_80, &STATE_VARIABLE_SeenSoFar_95_95, STATE_VARIABLE_VarSet_0_82, &STATE_VARIABLE_VarSet_96_96, STATE_VARIABLE_VarTypes_0_84, &STATE_VARIABLE_VarTypes_97_97);
                    TypeCtorInfo_209_209 = (MR_Word) &hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_hlds_goal_0;
                    mercury__list__map_foldl3_9_p_1(TypeCtorInfo_209_209, TypeCtorInfo_209_209, (MR_Word) &check_hlds__prop_mode_constraints_scalar_common_3[1], (MR_Word) &check_hlds__prop_mode_constraints_scalar_common_3[2], (MR_Word) &check_hlds__prop_mode_constraints_scalar_common_1[2], (MR_Word) &check_hlds__prop_mode_constraints_scalar_common_1[11], OrElseGoals0_67, &OrElseGoals_70, ((MR_Box) (STATE_VARIABLE_SeenSoFar_95_95)), &conv27_STATE_VARIABLE_SeenSoFar_81, ((MR_Box) (STATE_VARIABLE_VarSet_96_96)), &conv26_STATE_VARIABLE_VarSet_83, ((MR_Box) (STATE_VARIABLE_VarTypes_97_97)), &conv25_STATE_VARIABLE_VarTypes_85);
                    ...
                    *STATE_VARIABLE_VarTypes_85 = ((MR_Word) conv25_STATE_VARIABLE_VarTypes_85);
                    {
                      ShortHand_71 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 7 * sizeof(MR_Word)), NULL, NULL));
                      MR_hl_field(MR_mktag(1), ShortHand_71, 0) = ((MR_Box) (GoalType_62));
                    ...
                    {
                      STATE_VARIABLE_GoalExpr_149_149 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                      MR_hl_field(MR_mktag(3), STATE_VARIABLE_GoalExpr_149_149, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 7));
                      MR_hl_field(MR_mktag(3), STATE_VARIABLE_GoalExpr_149_149, 1) = ((MR_Box) (ShortHand_71));
                    }
                  }
                  break;
                case (MR_Integer) 2:
                  {
                    ...
                    {
                      ShortHand_164 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL));
                      MR_hl_field(MR_mktag(2), ShortHand_164, 0) = ((MR_Box) (MaybeIO_72));
                      MR_hl_field(MR_mktag(2), ShortHand_164, 1) = ((MR_Box) (ResultVar_73));
                      MR_hl_field(MR_mktag(2), ShortHand_164, 2) = ((MR_Box) (SubGoal_75));
                    }
                    {
                      STATE_VARIABLE_GoalExpr_149_149 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                      MR_hl_field(MR_mktag(3), STATE_VARIABLE_GoalExpr_149_149, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 7));
                      MR_hl_field(MR_mktag(3), STATE_VARIABLE_GoalExpr_149_149, 1) = ((MR_Box) (ShortHand_164));
                    }
                  }
                  break;
              }
    ...
    }
    {
      ...
      *STATE_VARIABLE_Goal_79 = base;
      MR_hl_field(MR_mktag(0), base, 0) = ((MR_Box) (STATE_VARIABLE_GoalExpr_149_149));
      MR_hl_field(MR_mktag(0), base, 1) = ((MR_Box) (STATE_VARIABLE_GoalInfo_138_138));
    }
  }
}
...
{
  {
    ...
    {
      Goals_17 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
...
{
  {
...

    {
      ...
      MR_hl_field(MR_mktag(0), Var_25, 0) = ((MR_Box) (&check_hlds__prop_mode_constraints_scalar_common_9[0]));
    ...
    TypeInfo_41_41 = (MR_Word) &check_hlds__prop_mode_constraints_scalar_common_3[0];
    mercury__list__map_foldl4_11_p_1(TypeInfo_41_41, TypeInfo_41_41, (MR_Word) &check_hlds__prop_mode_constraints_scalar_common_3[3], (MR_Word) &check_hlds__prop_mode_constraints_scalar_common_3[1], (MR_Word) &check_hlds__prop_mode_constraints_scalar_common_3[2], (MR_Word) &check_hlds__prop_mode_constraints_scalar_common_1[2], Var_25, STATE_VARIABLE_Args_0_17, STATE_VARIABLE_Args_18, ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))), &conv8_Unifications_12, ((MR_Box) (STATE_VARIABLE_SeenSoFar_0_19)), &conv7_STATE_VARIABLE_SeenSoFar_20, ((MR_Box) (STATE_VARIABLE_VarSet_0_21)), &conv6_STATE_VARIABLE_VarSet_22, ((MR_Box) (STATE_VARIABLE_VarTypes_0_23)), &conv5_STATE_VARIABLE_VarTypes_24);
...
{
  {
    ...
    mercury__list__foldr_4_p_0((MR_Word) &hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_hlds_goal_0, (MR_Word) &check_hlds__prop_mode_constraints_scalar_common_3[3], (MR_Word) &check_hlds__prop_mode_constraints_scalar_common_1[7], STATE_VARIABLE_Goals_0_4, ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))), &conv1_STATE_VARIABLE_Goals_5);
...
{
  {
    ...
    else
    {
      ...
      check_hlds__build_mode_constraints__add_clauses_constraints_7_p_0(STATE_VARIABLE_ModuleInfo_0_14, PredId_8, PredInfo_13, STATE_VARIABLE_VarInfo_0_16, &STATE_VARIABLE_VarInfo_17_56, Var_57, &BodyConstr_54);
      {
        ...
        MR_hl_field(MR_mktag(0), Var_58, 0) = ((MR_Box) (&check_hlds__prop_mode_constraints_scalar_common_7[1]));
      ...
      TypeCtorInfo_24_63 = (MR_Word) &mercury__builtin__builtin__type_ctor_info_int_0;
      TypeCtorInfo_25_64 = (MR_Word) &hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_proc_info_0;
      mercury__list__map_3_p_0(TypeCtorInfo_24_63, TypeCtorInfo_25_64, Var_58, ProcIds_53, &ProcInfos_55);
      {
        Var_59 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 5 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), Var_59, 0) = ((MR_Box) (&check_hlds__prop_mode_constraints_scalar_common_6[1]));
...
{
  {
    MR_Word TypeCtorInfo_15_15 = (MR_Word) &hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_id_0;
    MR_Word ConstrainedPreds_10;
    MR_Word Var_13;
    MR_Box conv0_STATE_VARIABLE_IO_12;

    ConstrainedPreds_10 = mercury__map__keys_1_f_0(TypeCtorInfo_15_15, (MR_Word) &check_hlds__prop_mode_constraints_scalar_common_2[0], PredConstraintsMap_8);
    {
      Var_13 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 6 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), Var_13, 0) = ((MR_Box) (&check_hlds__prop_mode_constraints_scalar_common_8[0]));
    ...
    mercury__list__foldl_4_p_2(TypeCtorInfo_15_15, (MR_Word) &mercury__io__io__type_ctor_info_state_0, Var_13, ConstrainedPreds_10, ((MR_Box) ((MR_Integer) 0)), &conv0_STATE_VARIABLE_IO_12);
  }
}
...
{
  {
    ...
    TypeCtorInfo_53_53 = (MR_Word) &hlds__hlds_clauses__hlds__hlds_clauses__type_ctor_info_clause_0;
    TypeCtorInfo_54_54 = (MR_Word) &hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_hlds_goal_0;
    BodyGoals0_15 = mercury__list__map_2_f_0(TypeCtorInfo_53_53, TypeCtorInfo_54_54, (MR_Word) &check_hlds__prop_mode_constraints_scalar_common_1[4], Clauses0_14);
    mercury__list__map_foldl3_9_p_1(TypeCtorInfo_54_54, TypeCtorInfo_54_54, (MR_Word) &check_hlds__prop_mode_constraints_scalar_common_3[1], (MR_Word) &check_hlds__prop_mode_constraints_scalar_common_3[2], (MR_Word) &check_hlds__prop_mode_constraints_scalar_common_1[2], (MR_Word) &check_hlds__prop_mode_constraints_scalar_common_1[5], BodyGoals0_15, &BodyGoals_17, ((MR_Box) (SeenSoFar_13)), &conv7_Var_18, ((MR_Box) (VarSet0_10)), &conv6_VarSet_19, ((MR_Box) (VarTypes0_11)), &conv5_VarTypes_20);
    Var_18 = ((MR_Word) conv7_Var_18);
    VarSet_19 = ((MR_Word) conv6_VarSet_19);
    VarTypes_20 = ((MR_Word) conv5_VarTypes_20);
    Clauses_21 = mercury__list__map_corresponding_3_f_0(TypeCtorInfo_53_53, TypeCtorInfo_54_54, TypeCtorInfo_53_53, (MR_Word) &check_hlds__prop_mode_constraints_scalar_common_1[6], Clauses0_14, BodyGoals_17);
...
{
  {
...

    {
      ...
      MR_hl_field(MR_mktag(0), Var_20, 0) = ((MR_Box) (&check_hlds__prop_mode_constraints_scalar_common_4[0]));
    ...
    mercury__list__filter_4_p_0(TypeCtorInfo_27_27, Var_20, SCC0_8, &Var_12, &SCC_13);
    ...
    mercury__list__foldl3_8_p_0(TypeCtorInfo_27_27, (MR_Word) &hlds__hlds_module__hlds__hlds_module__type_ctor_info_module_info_0, (MR_Word) &check_hlds__build_mode_constraints__check_hlds__build_mode_constraints__type_ctor_info_mc_var_info_0, (MR_Word) &check_hlds__prop_mode_constraints_scalar_common_1[1], (MR_Word) &check_hlds__prop_mode_constraints_scalar_common_1[3], SCC_13, ((MR_Box) (STATE_VARIABLE_ModuleInfo_0_14)), &conv5_STATE_VARIABLE_ModuleInfo_15, ((MR_Box) (STATE_VARIABLE_VarInfo_21_21)), &conv4_STATE_VARIABLE_VarInfo_17, ((MR_Box) (STATE_VARIABLE_Constraints_0_18)), &conv3_STATE_VARIABLE_Constraints_19);
