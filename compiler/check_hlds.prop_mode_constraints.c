...
MR_decl_label2(check_hlds__prop_mode_constraints__ensure_unique_arguments_in_goal_8_0, 63,191)
...
MR_BEGIN_MODULE(check_hlds__prop_mode_constraints_module9)
	...
	MR_init_label2(check_hlds__prop_mode_constraints__ensure_unique_arguments_in_goal_8_0,63,191)
MR_BEGIN_CODE
...
MR_def_static(check_hlds__prop_mode_constraints__ensure_unique_arguments_in_goal_8_0)
	...
	if (MR_RTAGS_TEST(MR_tempr1,3,0)) {
		MR_GOTO_LAB(check_hlds__prop_mode_constraints__ensure_unique_arguments_in_goal_8_0_i191);
	}
...
MR_def_label(check_hlds__prop_mode_constraints__ensure_unique_arguments_in_goal_8_0,63)
	...
	MR_np_tailcall_ent(require__unexpected_3_0);
MR_def_label(check_hlds__prop_mode_constraints__ensure_unique_arguments_in_goal_8_0,191)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_proceed();
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
