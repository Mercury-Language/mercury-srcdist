...
{
  {
    ...
    if (succeeded)
    {
      ...
      hlds__make_goal__create_atomic_complicated_unification_7_p_0(Var0_13, Var_38, Context_12, (MR_Word) (MR_mkword(MR_mktag(3), &check_hlds__prop_mode_constraints_scalar_common_10[0])), (MR_Word) ((MR_Unsigned) 0U), (MR_Integer) 0, &UnificationGoal0_22);
