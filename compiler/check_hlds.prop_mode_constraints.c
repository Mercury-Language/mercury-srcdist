...
MR_decl_label10(check_hlds__prop_mode_constraints__make_unification_11_0, 4,6,7,8,9,10,13,16,17,2)
MR_decl_label2(check_hlds__prop_mode_constraints__make_unification_11_0, 21,22)
...
MR_decl_label7(check_hlds__prop_mode_constraints__replace_call_with_conjunction_6_0, 2,3,5,6,10,11,12)
...
MR_decl_static(fn__check_hlds__prop_mode_constraints__IntroducedFrom__func__ensure_unique_arguments__247__1_2_0)
...
{
MR_COMMON(7,0),
MR_ENTRY_AP(fn__check_hlds__prop_mode_constraints__IntroducedFrom__func__ensure_unique_arguments__247__1_2_0),
0
},
{
MR_COMMON(7,2),
...
"check_hlds.prop_mode_constraints",
"check_hlds.prop_mode_constraints",
"lambda_prop_mode_constraints_m_247",
3,
0
},
"check_hlds.prop_mode_constraints",
...
MR_def_label(check_hlds__prop_mode_constraints__ensure_unique_arguments_3_0,10)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(7) = MR_r1;
	MR_sv(12) = (MR_Word) MR_CTOR0_ADDR(hlds__hlds_clauses, clause);
	MR_sv(13) = (MR_Word) MR_CTOR0_ADDR(hlds__hlds_goal, hlds_goal);
	MR_r1 = MR_sv(12);
	MR_r2 = MR_sv(13);
...
MR_BEGIN_MODULE(check_hlds__prop_mode_constraints_module8)
	...
	MR_init_label7(check_hlds__prop_mode_constraints__replace_call_with_conjunction_6_0,2,3,5,6,10,11,12)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(check_hlds__prop_mode_constraints_module12)
	...
	MR_init_label10(check_hlds__prop_mode_constraints__make_unification_11_0,4,6,7,8,9,10,13,16,17,2)
	MR_init_label2(check_hlds__prop_mode_constraints__make_unification_11_0,21,22)
MR_BEGIN_CODE
...
MR_def_label(check_hlds__prop_mode_constraints__pretty_print_pred_constraints_6_0,6)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(6) = MR_r1;
	MR_sv(7) = (MR_Word) MR_TAG_COMMON(1,5,11);
	MR_r1 = (MR_Integer) 0;
	MR_r2 = MR_sv(6);
...
MR_BEGIN_MODULE(check_hlds__prop_mode_constraints_module17)
	MR_init_entry1(fn__check_hlds__prop_mode_constraints__IntroducedFrom__func__ensure_unique_arguments__247__1_2_0);
	MR_INIT_PROC_LAYOUT_ADDR(mercury__fn__check_hlds__prop_mode_constraints__IntroducedFrom__func__ensure_unique_arguments__247__1_2_0);
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'IntroducedFrom__func__ensure_unique_arguments__247__1'/3 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(fn__check_hlds__prop_mode_constraints__IntroducedFrom__func__ensure_unique_arguments__247__1_2_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 0, (MR_Integer) 5);
