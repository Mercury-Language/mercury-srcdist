...
{
  {
    ...
    mercury__list__foldr_4_p_0((MR_Word) &hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_hlds_goal_0, (MR_Word) &check_hlds__prop_mode_constraints_scalar_common_3[3], (MR_Word) &check_hlds__prop_mode_constraints_scalar_common_1[6], STATE_VARIABLE_Goals_0_4, ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))), &conv1_STATE_VARIABLE_Goals_5);
...
{
  {
    ...
    else
    {
      ...
      TypeCtorInfo_24_63 = (MR_Word) &hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_proc_id_0;
...
{
  {
    ...
    BodyGoals0_15 = mercury__list__map_2_f_0(TypeCtorInfo_53_53, TypeCtorInfo_54_54, (MR_Word) &check_hlds__prop_mode_constraints_scalar_common_1[3], Clauses0_14);
    ...
    Clauses_21 = mercury__list__map_corresponding_3_f_0(TypeCtorInfo_53_53, TypeCtorInfo_54_54, TypeCtorInfo_53_53, (MR_Word) &check_hlds__prop_mode_constraints_scalar_common_1[5], Clauses0_14, BodyGoals_17);
