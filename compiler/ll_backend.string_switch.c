  ...
  MR_Word CLD_20)
{
  ...
  else
  {
    ...
    mercury__map__to_assoc_list_2_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&ll_backend__string_switch_scalar_common_1[2]), CaseSolnMap_27, &CaseSolns_30);
