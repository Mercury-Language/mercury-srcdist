  ...
  MR_Integer * STATE_VARIABLE_SeveralSolnsCaseCount_12)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      MR_Word STATE_VARIABLE_MainRvalsCord_1_77;
      MR_Integer Var_78;
      MR_Word next_value_of_HeadVar__2_2;
      ...
      else
      {
        ...
        mercury__cord__snoc_list_3_p_0((MR_Word) (&ll_backend__string_switch_scalar_common_1[0]), LaterSolns_44, STATE_VARIABLE_LaterSolnsRowsCord_0_7, &STATE_VARIABLE_LaterSolnsRowsCord_1_76);
        STATE_VARIABLE_OneSolnCaseCount_1_62 = STATE_VARIABLE_OneSolnCaseCount_0_9;
      }
      mercury__cord__snoc_3_p_0((MR_Word) (&ll_backend__string_switch_scalar_common_1[0]), ((MR_Box) (MainRowRvals_42)), STATE_VARIABLE_MainRvalsCord_0_4, &STATE_VARIABLE_MainRvalsCord_1_77);
      Var_78 = (MR_Integer) ((MR_Unsigned) MainRowNum_3 + (MR_Unsigned) 1);
      // direct tailcall eliminated
      ;
      next_value_of_HeadVar__2_2 = CasesValues_30;
      next_value_of_MainRowNum_3 = Var_78;
      next_value_of_STATE_VARIABLE_MainRvalsCord_0_4 = STATE_VARIABLE_MainRvalsCord_1_77;
