  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      if (((MR_tag((MR_Word) Soln_27)) == (MR_Integer) 0))
      {
        ...
        STATE_VARIABLE_OneSolnCaseCount_69_69 = (MR_Integer) ((MR_Unsigned) STATE_VARIABLE_OneSolnCaseCount_0_8 + (MR_Unsigned) 1);
      ...
      else
      {
        ...
        STATE_VARIABLE_SeveralSolnsCaseCount_57_57 = (MR_Integer) ((MR_Unsigned) HeadVar__10_10 + (MR_Unsigned) 1);
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        if (((MR_tag((MR_Word) Soln_30)) == (MR_Integer) 0))
        {
          ...
          STATE_VARIABLE_OneSolnCaseCount_67_67 = (MR_Integer) ((MR_Unsigned) STATE_VARIABLE_OneSolnCaseCount_0_49 + (MR_Unsigned) 1);
        ...
        else
        {
          ...
          STATE_VARIABLE_SeveralSolnsCaseCount_55_55 = (MR_Integer) ((MR_Unsigned) STATE_VARIABLE_SeveralSolnsCaseCount_0_51 + (MR_Unsigned) 1);
