...
static MR_bool MR_CALL 
ll_backend__string_switch__IntroducedFrom__pred__generate_string_hash_several_soln_lookup_switch__423__1_2_p_0(
  MR_Word OutVars_21,
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = ll_backend__string_switch__IntroducedFrom__pred__generate_string_hash_several_soln_lookup_switch__423__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 4)))));
  return succeeded;
}
  ...
  MR_Word STATE_VARIABLE_CLD_0_74)
{
  ...
  backend_libs__string_switch_util__construct_string_hash_cases_6_p_0((MR_Word) (&ll_backend__string_switch_scalar_common_1[3]), CaseSolns_18, (MR_Integer) 1, &TableSize_33, &HashSlotsMap_34, &HashOp_35, &NumCollisions_36);
