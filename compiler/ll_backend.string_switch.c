...
MR_decl_static(ll_backend__string_switch__IntroducedFrom__pred__generate_string_hash_several_soln_lookup_switch__367__1_2_0)
...
MR_def_static(ll_backend__string_switch__generate_string_hash_switch_search_9_0)
	...
	MR_sv(4) = MR_tfield(1, MR_tempr14, 0);
...
MR_def_label(ll_backend__string_switch__generate_string_hash_switch_11_0,22)
	...
	MR_tfield(0, MR_tempr1, 0) = MR_tfield(0, MR_sv(9), 0);
	MR_tag_alloc_heap(MR_tempr3, 3, (MR_Integer) 3);
	...
	MR_sv(11) = (MR_Word) MR_TAG_COMMON(1,7,0);
	MR_sv(10) = MR_r2;
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(ll_backend__llds, instruction);
	MR_r2 = MR_tempr3;
	}
...
MR_def_label(ll_backend__string_switch__generate_string_hash_simple_lookup_switch_13_0,10)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(15) = ((MR_Integer) 2 * (MR_Integer) MR_r1);
	MR_sv(4) = ((MR_Integer) MR_sv(15) - (MR_Integer) 1);
...
MR_def_label(ll_backend__string_switch__generate_string_hash_simple_lookup_switch_13_0,12)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(5) = ((MR_Integer) 2 + (MR_Integer) MR_r1);
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
...
MR_def_label(ll_backend__string_switch__generate_string_hash_several_soln_lookup_switch_15_0,10)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(17) = ((MR_Integer) 2 * (MR_Integer) MR_r1);
	MR_sv(9) = ((MR_Integer) MR_sv(17) - (MR_Integer) 1);
	MR_r1 = (MR_Word) MR_TAG_COMMON(0,0,10);
	MR_r2 = MR_sv(3);
	MR_np_call_localret_ent(list__length_2_0,
...
MR_def_label(ll_backend__string_switch__generate_string_hash_several_soln_lookup_switch_15_0,12)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(18) = MR_r1;
	MR_sv(10) = ((MR_Integer) 4 + (MR_Integer) MR_r1);
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(backend_libs__builtin_ops, scalar_array_elem_type);
	MR_r2 = MR_sv(18);
	MR_r3 = (MR_Integer) 2;
	MR_np_call_localret_ent(list__duplicate_3_0,
...
MR_def_label(ll_backend__string_switch__generate_string_hash_several_soln_lookup_switch_15_0,13)
	...
	MR_tfield(1, MR_sv(11), 0) = MR_tempr2;
	MR_tag_alloc_heap(MR_tempr1, 0, (MR_Integer) 5);
	MR_tfield(0, MR_tempr1, 0) = (MR_Word) MR_COMMON(10,1);
	MR_tfield(0, MR_tempr1, 1) = (MR_Word) MR_ENTRY_AP(ll_backend__string_switch__IntroducedFrom__pred__generate_string_hash_several_soln_lookup_switch__367__1_2_0);
...
MR_def_label(ll_backend__string_switch__generate_string_hash_several_soln_lookup_switch_15_0,32)
	...
	MR_sv(14) = (MR_Word) MR_CTOR0_ADDR(ll_backend__lookup_switch, case_kind);
...
MR_def_label(ll_backend__string_switch__generate_string_binary_switch_11_0,19)
	...
	MR_tfield(3, MR_tempr2, 1) = MR_tempr1;
	MR_tempr1 = MR_sv(5);
	MR_sv(5) = (MR_Word) MR_TAG_COMMON(1,7,0);
	MR_tempr3 = MR_sv(4);
	MR_sv(4) = MR_tempr2;
	MR_sv(9) = MR_r2;
	MR_r1 = MR_sv(6);
...
MR_def_label(ll_backend__string_switch__generate_string_binary_several_soln_lookup_switch_15_0,11)
	...
	MR_tfield(0, MR_tempr1, 1) = (MR_Word) MR_ENTRY_AP(ll_backend__string_switch__IntroducedFrom__pred__generate_string_binary_several_soln_lookup_switch__815__1_2_0);
	MR_tfield(0, MR_tempr1, 2) = (MR_Integer) 2;
...
MR_BEGIN_MODULE(ll_backend__string_switch_module22)
	MR_init_entry1(ll_backend__string_switch__IntroducedFrom__pred__generate_string_hash_several_soln_lookup_switch__367__1_2_0);
	MR_INIT_PROC_LAYOUT_ADDR(mercury__ll_backend__string_switch__IntroducedFrom__pred__generate_string_hash_several_soln_lookup_switch__367__1_2_0);
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'IntroducedFrom__pred__generate_string_hash_several_soln_lookup_switch__367__1'/2 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(ll_backend__string_switch__IntroducedFrom__pred__generate_string_hash_several_soln_lookup_switch__367__1_2_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tempr1 = MR_r1;
