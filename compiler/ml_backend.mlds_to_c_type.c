      ...
      switch (MR_tag((MR_Word) MLDS_Type_6)) {
              ...
              case (MR_Integer) 2:
                {
                  ...
                  mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&ml_backend__mlds_to_c_type_scalar_common_2[1]), Arity_15, &Var_173);
              ...
              case (MR_Integer) 3:
                {
                  ...
                  mercury__io__write_string_3_p_0((MR_String) "_");
                  mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&ml_backend__mlds_to_c_type_scalar_common_2[1]), Arity_15, &Var_158);
        ...
        case (MR_Integer) 3:
          switch (((MR_Integer) ((MR_hl_field(MR_mktag(3), MLDS_Type_6, (MR_Integer) 0))))) {
            ...
            case (MR_Integer) 1:
              {
                MR_Word HighLevelData_11 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Opts_5, (MR_Integer) 2))) >> 14)) & (MR_Integer) 1);
                ...
                switch (HighLevelData_11) {
                  ...
                  case (MR_Integer) 1:
                    {
                      MR_Word ClassName_187;
                      MR_Integer ClassArity_188;
                      MR_Word MLDS_Type_191;
                      MR_Word Type_195;
                      MR_Word ClassId_199;
                      MR_Word next_value_of_tscc_proc_1_input_1_Opts_5;
                      MR_Word next_value_of_tscc_proc_1_input_2_MLDS_Type_6;

                      ml_backend__ml_type_gen__ml_gen_type_name_3_p_0((MR_Word) (&ml_backend__mlds_to_c_type_scalar_common_3[1]), &ClassName_187, &ClassArity_188);
                      {
                        ClassId_199 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
                        MR_hl_field(MR_mktag(0), ClassId_199, 0) = ((MR_Box) (ClassName_187));
                        MR_hl_field(MR_mktag(0), ClassId_199, 1) = ((MR_Box) (ClassArity_188));
                        MR_hl_field(MR_mktag(0), ClassId_199, 2) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 0));
                      }
                      Type_195 = (MR_Word) (MR_mkword(MR_mktag(1), (MR_Word) (ClassId_199)));
                      {
                        MLDS_Type_191 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                        MR_hl_field(MR_mktag(3), MLDS_Type_191, 0) = ((MR_Box) ((MR_Unsigned) 7U));
                        MR_hl_field(MR_mktag(3), MLDS_Type_191, 1) = ((MR_Box) (Type_195));
                      }
                      // direct tailcall eliminated
                      ;
                      next_value_of_tscc_proc_1_input_1_Opts_5 = Opts_5;
                      next_value_of_tscc_proc_1_input_2_MLDS_Type_6 = MLDS_Type_191;
            ...
            case (MR_Integer) 3:
              {
                MR_Word Var_150 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(3), MLDS_Type_6, (MR_Integer) 1))) & (MR_Integer) 15);
      ...
      switch (MR_tag((MR_Word) CtorCat_8)) {
        ...
        case (MR_Integer) 0:
          switch (MR_unmkbody(CtorCat_8)) {
            ...
            case (MR_Integer) 0:
              {
                MR_Word HighLevelData_11 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Opts_6, (MR_Integer) 2))) >> 14)) & (MR_Integer) 1);
            ...
            case (MR_Integer) 2:
              {
                MR_Word HighLevelData_51 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Opts_6, (MR_Integer) 2))) >> 14)) & (MR_Integer) 1);
                  ...
                  case (MR_Integer) 1:
                    {
                      ...
                      parse_tree__prog_type__type_to_ctor_det_2_p_0(Type_7, &TypeCtor_52);
                      // direct tailcall eliminated
                      ;
                      next_value_of_tscc_proc_3_input_1_Opts_6 = Opts_6;
                      next_value_of_tscc_proc_3_input_2_TypeCtor_7 = TypeCtor_52;
