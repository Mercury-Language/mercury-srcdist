  ...
  switch (MR_tag((MR_Word) Type0_4)) {
    ...
    case (MR_Integer) 3:
      switch (((MR_Integer) ((MR_hl_field(3, Type0_4, (MR_Integer) 0))))) {
        ...
        case (MR_Integer) 1:
          {
            MR_Word MerType0_18 = ((MR_Word) ((MR_hl_field(3, Type0_4, (MR_Integer) 1))));
            MR_Word CtorCat0_19 = ((MR_Word) ((MR_hl_field(3, Type0_4, (MR_Integer) 2))));

            switch (MR_tag((MR_Word) CtorCat0_19)) {
              default: /*NOTREACHED*/ MR_assert(0);
              case (MR_Integer) 0:
                switch (MR_unmkbody(CtorCat0_19)) {
                  default: /*NOTREACHED*/ MR_assert(0);
                  case (MR_Integer) 0:
                  case (MR_Integer) 1:
                  case (MR_Integer) 3:
                    {
                      ...
                      MerType_31 = parse_tree__builtin_lib_types__void_type_0_f_0();
                      succeeded = parse_tree__prog_data____Unify____mer_type_0_0(MerType_31, MerType0_18);
                      if (succeeded)
                        succeeded = parse_tree__prog_type____Unify____type_ctor_category_0_0((MR_Word) ((MR_Unsigned) 4U), CtorCat0_19);
                      if (succeeded)
                      {
                        *Type_5 = Type0_4;
                        *Changed_6 = (MR_Integer) 0;
                      ...
                      {
                        {
                          ...
                          *Type_5 = base;
                          ...
                          MR_hl_field(3, base, 1) = ((MR_Box) (MerType_31));
                  ...
                  case (MR_Integer) 4:
                    {
                      ...
                      MerType_21 = parse_tree__builtin_lib_types__void_type_0_f_0();
                      succeeded = parse_tree__prog_data____Unify____mer_type_0_0(MerType_21, MerType0_18);
                      if (succeeded)
                      {
                        *Type_5 = Type0_4;
                        *Changed_6 = (MR_Integer) 0;
                      ...
                      {
                        {
                          ...
                          *Type_5 = base;
                          MR_hl_field(3, base, 0) = ((MR_Box) ((MR_Unsigned) 1U));
                          MR_hl_field(3, base, 1) = ((MR_Box) (MerType_21));
                          MR_hl_field(3, base, 2) = ((MR_Box) (CtorCat0_19));
                        }
                        *Changed_6 = (MR_Integer) 1;
                      }
                    }
        ...
        case (MR_Integer) 6:
          {
            MR_Word SubType0_29 = ((MR_Word) ((MR_hl_field(3, Type0_4, (MR_Integer) 1))));
            MR_Word SubType_30;

            ml_backend__mlds_to_c_type__semicanonicalize_types_in_type_for_c_3_p_0(SubType0_29, &SubType_30, Changed_6);
            switch (*Changed_6) {
              default: /*NOTREACHED*/ MR_assert(0);
              case (MR_Integer) 1:
                {
                  ...
                  *Type_5 = base;
                  MR_hl_field(3, base, 0) = ((MR_Box) ((MR_Unsigned) 6U));
                  MR_hl_field(3, base, 1) = ((MR_Box) (SubType_30));
                }
                break;
              case (MR_Integer) 0:
                *Type_5 = Type0_4;
        ...
        case (MR_Integer) 8:
          {
            MR_Word SubType0_16 = ((MR_Word) ((MR_hl_field(3, Type0_4, (MR_Integer) 1))));
            MR_Word SubType_17;

            ml_backend__mlds_to_c_type__semicanonicalize_types_in_type_for_c_3_p_0(SubType0_16, &SubType_17, Changed_6);
            switch (*Changed_6) {
              default: /*NOTREACHED*/ MR_assert(0);
              case (MR_Integer) 1:
                {
                  ...
                  *Type_5 = base;
                  ...
                  MR_hl_field(3, base, 1) = ((MR_Box) (SubType_17));
                }
                break;
              case (MR_Integer) 0:
                *Type_5 = Type0_4;
    ...
    case (MR_Integer) 1:
      {
        ...
        mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&ml_backend__mlds_to_c_type_scalar_common_1[0]), Arity_20, &Var_102);
        Var_109 = mercury__string__f_43_43_2_f_0(Var_102, (MR_String) "_s");
        Var_111 = mercury__string__f_43_43_2_f_0((MR_String) "_", Var_109);
        Var_112 = mercury__string__f_43_43_2_f_0(MangledClassName_26, Var_111);
        Var_114 = mercury__string__f_43_43_2_f_0((MR_String) "__", Var_112);
        Var_115 = mercury__string__f_43_43_2_f_0(Qualifier_25, Var_114);
        *TypePrefix_9 = mercury__string__f_43_43_2_f_0((MR_String) "struct ", Var_115);
        *TypeSuffix_10 = (MR_String) "";
      }
      break;
    case (MR_Integer) 2:
      {
        ...
        MR_Word QualClassName_68 = ((MR_Word) ((MR_hl_field(0, EnumClassId_27, (MR_Integer) 0))));
        MR_Integer Arity_69 = ((MR_Integer) ((MR_hl_field(0, EnumClassId_27, (MR_Integer) 1))));
        MR_Word ModuleName_70 = ((MR_Word) ((MR_hl_field(0, QualClassName_68, (MR_Integer) 0))));
        MR_String ClassName_72 = ((MR_String) ((MR_hl_field(0, QualClassName_68, (MR_Integer) 2))));
        MR_String Qualifier_73;
        MR_String MangledClassName_74;
        MR_String Var_83;
        MR_String Var_90;
        MR_String Var_92;
        MR_String Var_93;
        ...
        Qualifier_73 = ml_backend__mlds_to_c_name__qualifier_to_string_for_c_1_f_0(ModuleName_70);
        MangledClassName_74 = parse_tree__prog_foreign__name_mangle_1_f_0(ClassName_72);
        mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&ml_backend__mlds_to_c_type_scalar_common_1[0]), Arity_69, &Var_83);
        Var_90 = mercury__string__f_43_43_2_f_0(Var_83, (MR_String) "_e\' */");
        Var_92 = mercury__string__f_43_43_2_f_0((MR_String) "_", Var_90);
        Var_93 = mercury__string__f_43_43_2_f_0(MangledClassName_74, Var_92);
        Var_95 = mercury__string__f_43_43_2_f_0((MR_String) "__", Var_93);
        Var_96 = mercury__string__f_43_43_2_f_0(Qualifier_73, Var_95);
        *TypePrefix_9 = mercury__string__f_43_43_2_f_0((MR_String) "MR_Integer /* actually \140enum ", Var_96);
        *TypeSuffix_10 = (MR_String) "";
      }
      break;
    case (MR_Integer) 3:
      switch (((MR_Integer) ((MR_hl_field(3, MLDS_Type_7, (MR_Integer) 0))))) {
        ...
        case (MR_Integer) 0:
          {
            MR_Word FuncParams_29 = ((MR_Word) ((MR_hl_field(3, MLDS_Type_7, (MR_Integer) 1))));

            ml_backend__mlds_to_c_type__func_type_prefix_suffix_for_c_4_p_0(Opts_6, FuncParams_29, TypePrefix_9, TypeSuffix_10);
          }
          break;
        case (MR_Integer) 1:
          {
        ...
        case (MR_Integer) 3:
          {
            MR_Word ArgTypes_30 = ((MR_Word) ((MR_hl_field(3, MLDS_Type_7, (MR_Integer) 1))));

            if ((ArgTypes_30 == (MR_Word) ((MR_Unsigned) 0U)))
            {
            ...
            {
              MR_Word ArgTypeStrs_33;
              MR_String ArgTypesStr_34;
              MR_Word Var_59;
              MR_String Var_99;

              {
                Var_59 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
                MR_hl_field(0, Var_59, 0) = ((MR_Box) (&ml_backend__mlds_to_c_type_scalar_common_2[0]));
                MR_hl_field(0, Var_59, 1) = ((MR_Box) (ml_backend__mlds_to_c_type__type_to_prefix_suffix_for_c_5_p_0_1));
                MR_hl_field(0, Var_59, 2) = ((MR_Box) ((MR_Integer) 1));
                MR_hl_field(0, Var_59, 3) = ((MR_Box) (Opts_6));
              }
              ArgTypeStrs_33 = mercury__list__map_2_f_0((MR_Word) (&ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_type_0), (MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), Var_59, ArgTypes_30);
              ArgTypesStr_34 = mercury__string__join_list_2_f_0((MR_String) ", ", ArgTypeStrs_33);
              *TypePrefix_9 = (MR_String) "void MR_CALL (*";
              Var_99 = mercury__string__f_43_43_2_f_0(ArgTypesStr_34, (MR_String) ", void *)");
              *TypeSuffix_10 = mercury__string__f_43_43_2_f_0((MR_String) ")(", Var_99);
            }
          }
          break;
        case (MR_Integer) 4:
        ...
        case (MR_Integer) 6:
          {
            ...
            MR_String TypePrefix_123;
            MR_String TypeSuffix_124;

            ml_backend__mlds_to_c_type__type_to_prefix_suffix_for_c_5_p_0(Opts_6, BaseType_16, (MR_Word) ((MR_Unsigned) 0U), &TypePrefix_123, &TypeSuffix_124);
            *TypePrefix_9 = mercury__string__f_43_43_2_f_0(TypePrefix_123, TypeSuffix_124);
            if ((InitSize_8 == (MR_Word) ((MR_Unsigned) 0U)))
              *TypeSuffix_10 = (MR_String) "[]";
            else
            {
              MR_Integer Size0_126 = ((MR_Integer) ((MR_hl_field(1, InitSize_8, (MR_Integer) 0))));
              MR_Integer Size_127;
              MR_String Var_134;
              MR_String Var_141;

              mercury__int__max_3_p_0(Size0_126, (MR_Integer) 1, &Size_127);
              mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&ml_backend__mlds_to_c_type_scalar_common_1[0]), Size_127, &Var_134);
              Var_141 = mercury__string__f_43_43_2_f_0(Var_134, (MR_String) "]");
              *TypeSuffix_10 = mercury__string__f_43_43_2_f_0((MR_String) "[", Var_141);
            }
          }
          break;
        case (MR_Integer) 7:
          {
            *TypePrefix_9 = ml_backend__mlds_to_c_type__type_to_string_for_c_2_f_0(Opts_6, (MR_Word) ((MR_Unsigned) 20U));
            *TypeSuffix_10 = (MR_String) "";
          }
          break;
        case (MR_Integer) 8:
          {
            MR_String BaseTypeStr_28;
            MR_Word BaseType_75 = ((MR_Word) ((MR_hl_field(3, MLDS_Type_7, (MR_Integer) 1))));

            BaseTypeStr_28 = ml_backend__mlds_to_c_type__type_to_string_for_c_2_f_0(Opts_6, BaseType_75);
            *TypePrefix_9 = mercury__string__f_43_43_2_f_0(BaseTypeStr_28, (MR_String) " *");
            *TypeSuffix_10 = (MR_String) "";
          }
          break;
        case (MR_Integer) 9:
          {
            MR_Word RttiIdMaybeElement_35 = ((MR_Word) ((MR_hl_field(3, MLDS_Type_7, (MR_Integer) 1))));
            MR_Word IsArray_36;

            backend_libs__rtti__rtti_id_maybe_element_c_type_3_p_0(RttiIdMaybeElement_35, TypePrefix_9, &IsArray_36);
            switch (IsArray_36) {
              default: /*NOTREACHED*/ MR_assert(0);
              case (MR_Integer) 0:
        ...
        case (MR_Integer) 10:
          {
            MR_Word TablingId_37 = ((MR_Word) ((MR_hl_field(3, MLDS_Type_7, (MR_Integer) 1))));
            MR_Word IsArray_76;

            backend_libs__rtti__tabling_id_c_type_3_p_0(TablingId_37, TypePrefix_9, &IsArray_76);
            switch (IsArray_76) {
              default: /*NOTREACHED*/ MR_assert(0);
              case (MR_Integer) 0:
                *TypeSuffix_10 = ml_backend__mlds_to_c_type__array_type_suffix_for_c_1_f_0(InitSize_8);
