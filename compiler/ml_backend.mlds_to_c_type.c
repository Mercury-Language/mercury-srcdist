...
static /* final */ const MR_Box ml_backend__mlds_to_c_type_scalar_common_2[2][8];
  ...
  MR_Word MLDS_Type_8)
{
  switch (MR_tag((MR_Word) MLDS_Type_8)) {
    ...
    case (MR_Integer) 1:
      {
        MR_Word ClassId_14 = (MR_Word) (MR_body((MR_Word) (MLDS_Type_8), (MR_Integer) 1));
        ...
        MR_Word ClassKind_17 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), ClassId_14, (MR_Integer) 2))) & (MR_Integer) 3);
          ...
          case (MR_Integer) 2:
            {
              ...
              Var_61 = ml_backend__mlds_to_c_name__qual_name_prefix_c_1_f_0(ModuleName_18);
              Var_64 = parse_tree__prog_foreign__name_mangle_1_f_0(ClassName_20);
              ...
              mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&ml_backend__mlds_to_c_type_scalar_common_3[0]), Arity_16, &Var_150);
          ...
          case (MR_Integer) 3:
            {
              ...
              Var_72 = ml_backend__mlds_to_c_name__qual_name_prefix_c_1_f_0(ModuleName_18);
              Var_75 = parse_tree__prog_foreign__name_mangle_1_f_0(ClassName_20);
              ...
              mercury__io__write_string_4_p_0(Stream_7, (MR_String) "_");
              mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&ml_backend__mlds_to_c_type_scalar_common_3[0]), Arity_16, &Var_135);
              mercury__io__write_string_4_p_0(Stream_7, Var_135);
    ...
    case (MR_Integer) 2:
      {
        MR_Word FuncParams_23 = (MR_Word) (MR_body((MR_Word) (MLDS_Type_8), (MR_Integer) 2));

        ml_backend__mlds_to_c_type__mlds_output_func_type_prefix_5_p_0(Opts_6, Stream_7, FuncParams_23);
      }
      break;
    case (MR_Integer) 3:
      switch (((MR_Integer) ((MR_hl_field(MR_mktag(3), MLDS_Type_8, (MR_Integer) 0))))) {
        ...
        case (MR_Integer) 2:
          {
            MR_Word ArgTypes_24 = ((MR_Word) ((MR_hl_field(MR_mktag(3), MLDS_Type_8, (MR_Integer) 1))));

            if ((ArgTypes_24 == (MR_Word) ((MR_Unsigned) 0U)))
        ...
        case (MR_Integer) 3:
          {
            MR_Word Var_127 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(3), MLDS_Type_8, (MR_Integer) 1))) & (MR_Integer) 15);
        ...
        case (MR_Integer) 5:
          {
            MR_Word Type_122 = ((MR_Word) ((MR_hl_field(MR_mktag(3), MLDS_Type_8, (MR_Integer) 1))));

            ml_backend__mlds_to_c_type__mlds_output_type_5_p_0(Opts_6, Type_122, Stream_7);
          }
          break;
        case (MR_Integer) 6:
        ...
        case (MR_Integer) 7:
          {
            MR_Word Type_21 = ((MR_Word) ((MR_hl_field(MR_mktag(3), MLDS_Type_8, (MR_Integer) 1))));

            ml_backend__mlds_to_c_type__mlds_output_type_5_p_0(Opts_6, Type_21, Stream_7);
            mercury__io__write_string_4_p_0(Stream_7, (MR_String) " *");
          }
          break;
        case (MR_Integer) 8:
          {
            MR_Word RttiIdMaybeElement_27 = ((MR_Word) ((MR_hl_field(MR_mktag(3), MLDS_Type_8, (MR_Integer) 1))));
            MR_String CType_28;
            MR_Word _IsArray_29;

            backend_libs__rtti__rtti_id_maybe_element_c_type_3_p_0(RttiIdMaybeElement_27, &CType_28, &_IsArray_29);
            mercury__io__write_string_4_p_0(Stream_7, CType_28);
          }
          break;
        case (MR_Integer) 9:
          {
            MR_Word TablingId_30 = ((MR_Word) ((MR_hl_field(MR_mktag(3), MLDS_Type_8, (MR_Integer) 1))));
            MR_String CType_125;
            MR_Word _IsArray_124;

            backend_libs__rtti__tabling_id_c_type_3_p_0(TablingId_30, &CType_125, &_IsArray_124);
            mercury__io__write_string_4_p_0(Stream_7, CType_125);
          }
          break;
      }
      break;
    ...
    else
    {
      ...
      else
      {
...

        {
          ...
          MR_hl_field(MR_mktag(0), Var_19, 0) = ((MR_Box) (&ml_backend__mlds_to_c_type_scalar_common_2[1]));
      ...
      switch (((MR_Integer) ((MR_hl_field(MR_mktag(3), MLDS_Type_9, (MR_Integer) 0))))) {
        ...
        case (MR_Integer) 2:
          {
            ...
            if (!((ArgTypes_15 == (MR_Word) ((MR_Unsigned) 0U))))
            {
              ...
              mercury__io__write_string_4_p_0(Stream_8, (MR_String) ")(");
              {
                ...
                MR_hl_field(MR_mktag(0), Var_36, 0) = ((MR_Box) (&ml_backend__mlds_to_c_type_scalar_common_2[1]));
        ...
        case (MR_Integer) 5:
          ...
          else
          {
            ...
            mercury__io__write_string_4_p_0(Stream_8, (MR_String) "[");
            mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&ml_backend__mlds_to_c_type_scalar_common_3[0]), Size_58, &Var_70);
  ...
  MR_Word HeadVar__2_2)
{
  ...
  else
  {
    ...
    mercury__io__write_string_4_p_0(Stream_1, (MR_String) "[");
    mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&ml_backend__mlds_to_c_type_scalar_common_3[0]), Size_14, &Var_26);
...
{
  {
    ...
    else
    {
...

      {
        ...
        MR_hl_field(MR_mktag(0), Var_16, 0) = ((MR_Box) (&ml_backend__mlds_to_c_type_scalar_common_2[0]));
