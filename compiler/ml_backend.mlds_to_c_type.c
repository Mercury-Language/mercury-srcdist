  ...
  switch (MR_tag((MR_Word) Type0_4)) {
    ...
    case (MR_Integer) 3:
      switch (((MR_Integer) ((MR_hl_field(3, Type0_4, (MR_Integer) 0))))) {
        ...
        case (MR_Integer) 1:
          {
            MR_Word MerType0_19 = ((MR_Word) ((MR_hl_field(3, Type0_4, (MR_Integer) 1))));
            MR_Word CtorCat0_20 = ((MR_Word) ((MR_hl_field(3, Type0_4, (MR_Integer) 2))));

            switch (MR_tag((MR_Word) CtorCat0_20)) {
              default: /*NOTREACHED*/ MR_assert(0);
              case (MR_Integer) 0:
                switch (MR_unmkbody(CtorCat0_20)) {
                  default: /*NOTREACHED*/ MR_assert(0);
                  case (MR_Integer) 0:
                  case (MR_Integer) 1:
                  case (MR_Integer) 3:
                    {
                      ...
                      MerType_32 = parse_tree__builtin_lib_types__void_type_0_f_0();
                      succeeded = parse_tree__prog_data____Unify____mer_type_0_0(MerType_32, MerType0_19);
                      if (succeeded)
                        succeeded = parse_tree__prog_type____Unify____type_ctor_category_0_0((MR_Word) ((MR_Unsigned) 4U), CtorCat0_20);
                      if (succeeded)
                      {
                        *Type_5 = Type0_4;
                        *Changed_6 = (MR_Integer) 0;
                      ...
                      {
                        {
                          ...
                          *Type_5 = base;
                          ...
                          MR_hl_field(3, base, 1) = ((MR_Box) (MerType_32));
                  ...
                  case (MR_Integer) 4:
                    {
                      ...
                      succeeded = parse_tree__prog_data____Unify____mer_type_0_0(MerType_22, MerType0_19);
                      if (succeeded)
                      {
                        *Type_5 = Type0_4;
                        *Changed_6 = (MR_Integer) 0;
                      ...
                      {
                        {
                          ...
                          *Type_5 = base;
                          ...
                          MR_hl_field(3, base, 2) = ((MR_Box) (CtorCat0_20));
                        }
                        *Changed_6 = (MR_Integer) 1;
                      }
                    }
        ...
        case (MR_Integer) 7:
          {
            MR_Word SubType0_30 = ((MR_Word) ((MR_hl_field(3, Type0_4, (MR_Integer) 1))));
            MR_Word SubType_31;

            ml_backend__mlds_to_c_type__semicanonicalize_types_in_type_for_c_3_p_0(SubType0_30, &SubType_31, Changed_6);
            switch (*Changed_6) {
              default: /*NOTREACHED*/ MR_assert(0);
              case (MR_Integer) 1:
                {
                  ...
                  *Type_5 = base;
                  ...
                  MR_hl_field(3, base, 1) = ((MR_Box) (SubType_31));
                }
                break;
              case (MR_Integer) 0:
                *Type_5 = Type0_4;
        ...
        case (MR_Integer) 9:
          {
            MR_Word SubType0_17 = ((MR_Word) ((MR_hl_field(3, Type0_4, (MR_Integer) 1))));
            MR_Word SubType_18;

            ml_backend__mlds_to_c_type__semicanonicalize_types_in_type_for_c_3_p_0(SubType0_17, &SubType_18, Changed_6);
            switch (*Changed_6) {
              default: /*NOTREACHED*/ MR_assert(0);
              case (MR_Integer) 1:
                {
                  ...
                  *Type_5 = base;
                  ...
                  MR_hl_field(3, base, 1) = ((MR_Box) (SubType_18));
                }
                break;
              case (MR_Integer) 0:
                *Type_5 = Type0_4;
    ...
    case (MR_Integer) 1:
      {
        ...
        MR_Word ModuleName_22 = ((MR_Word) ((MR_hl_field(0, QualClassName_19, (MR_Integer) 0))));
        MR_String ClassName_24 = ((MR_String) ((MR_hl_field(0, QualClassName_19, (MR_Integer) 2))));
        MR_String Qualifier_25;
        MR_String MangledClassName_26;
        MR_String Var_122;
        MR_String Var_129;
        MR_String Var_131;
        MR_String Var_132;
        ...
        Qualifier_25 = ml_backend__mlds_to_c_name__qualifier_to_string_for_c_1_f_0(ModuleName_22);
        MangledClassName_26 = parse_tree__prog_foreign__name_mangle_1_f_0(ClassName_24);
        mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&ml_backend__mlds_to_c_type_scalar_common_1[0]), Arity_20, &Var_122);
        Var_129 = mercury__string__f_43_43_2_f_0(Var_122, (MR_String) "_s");
        Var_131 = mercury__string__f_43_43_2_f_0((MR_String) "_", Var_129);
        Var_132 = mercury__string__f_43_43_2_f_0(MangledClassName_26, Var_131);
        Var_134 = mercury__string__f_43_43_2_f_0((MR_String) "__", Var_132);
        Var_135 = mercury__string__f_43_43_2_f_0(Qualifier_25, Var_134);
        *TypePrefix_9 = mercury__string__f_43_43_2_f_0((MR_String) "struct ", Var_135);
        *TypeSuffix_10 = (MR_String) "";
      }
      break;
    case (MR_Integer) 2:
      {
        MR_Word EnumClassId_27 = (MR_Word) (MR_body((MR_Word) (MLDS_Type_7), (MR_Integer) 2));
        MR_Word QualClassName_78 = ((MR_Word) ((MR_hl_field(0, EnumClassId_27, (MR_Integer) 0))));
        MR_Integer Arity_79 = ((MR_Integer) ((MR_hl_field(0, EnumClassId_27, (MR_Integer) 1))));
        MR_Word ModuleName_80 = ((MR_Word) ((MR_hl_field(0, QualClassName_78, (MR_Integer) 0))));
        MR_String ClassName_82 = ((MR_String) ((MR_hl_field(0, QualClassName_78, (MR_Integer) 2))));
        MR_String Qualifier_83;
        MR_String MangledClassName_84;
        MR_String Var_103;
        MR_String Var_110;
        MR_String Var_112;
        MR_String Var_113;
        ...
        Qualifier_83 = ml_backend__mlds_to_c_name__qualifier_to_string_for_c_1_f_0(ModuleName_80);
        MangledClassName_84 = parse_tree__prog_foreign__name_mangle_1_f_0(ClassName_82);
        mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&ml_backend__mlds_to_c_type_scalar_common_1[0]), Arity_79, &Var_103);
        Var_110 = mercury__string__f_43_43_2_f_0(Var_103, (MR_String) "_e\' */");
        Var_112 = mercury__string__f_43_43_2_f_0((MR_String) "_", Var_110);
        Var_113 = mercury__string__f_43_43_2_f_0(MangledClassName_84, Var_112);
        Var_115 = mercury__string__f_43_43_2_f_0((MR_String) "__", Var_113);
        Var_116 = mercury__string__f_43_43_2_f_0(Qualifier_83, Var_115);
        *TypePrefix_9 = mercury__string__f_43_43_2_f_0((MR_String) "MR_Integer /* actually \140enum ", Var_116);
        *TypeSuffix_10 = (MR_String) "";
      }
      break;
    case (MR_Integer) 3:
      switch (((MR_Integer) ((MR_hl_field(3, MLDS_Type_7, (MR_Integer) 0))))) {
        ...
        case (MR_Integer) 0:
          {
            MR_Word FuncParams_33 = ((MR_Word) ((MR_hl_field(3, MLDS_Type_7, (MR_Integer) 1))));

            ml_backend__mlds_to_c_type__func_type_prefix_suffix_for_c_4_p_0(Opts_6, FuncParams_33, TypePrefix_9, TypeSuffix_10);
          }
          break;
        case (MR_Integer) 1:
          {
        ...
        case (MR_Integer) 3:
          {
            MR_Word ArgTypes_34 = ((MR_Word) ((MR_hl_field(3, MLDS_Type_7, (MR_Integer) 1))));

            if ((ArgTypes_34 == (MR_Word) ((MR_Unsigned) 0U)))
            {
            ...
            {
              MR_Word ArgTypeStrs_37;
              MR_String ArgTypesStr_38;
              MR_Word Var_69;
              MR_String Var_119;

              {
                Var_69 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
                MR_hl_field(0, Var_69, 0) = ((MR_Box) (&ml_backend__mlds_to_c_type_scalar_common_2[0]));
                MR_hl_field(0, Var_69, 1) = ((MR_Box) (ml_backend__mlds_to_c_type__type_to_prefix_suffix_for_c_5_p_0_1));
                MR_hl_field(0, Var_69, 2) = ((MR_Box) ((MR_Integer) 1));
                MR_hl_field(0, Var_69, 3) = ((MR_Box) (Opts_6));
              }
              ArgTypeStrs_37 = mercury__list__map_2_f_0((MR_Word) (&ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_type_0), (MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), Var_69, ArgTypes_34);
              ArgTypesStr_38 = mercury__string__join_list_2_f_0((MR_String) ", ", ArgTypeStrs_37);
              *TypePrefix_9 = (MR_String) "void MR_CALL (*";
              Var_119 = mercury__string__f_43_43_2_f_0(ArgTypesStr_38, (MR_String) ", void *)");
              *TypeSuffix_10 = mercury__string__f_43_43_2_f_0((MR_String) ")(", Var_119);
            }
          }
          break;
        case (MR_Integer) 4:
        ...
        case (MR_Integer) 6:
          {
            MR_Word EnvId_28 = ((MR_Word) ((MR_hl_field(3, MLDS_Type_7, (MR_Integer) 1))));
            MR_Word QualEnvName_29 = (MR_Word) (EnvId_28);
            MR_String EnvName_30 = ((MR_String) ((MR_hl_field(0, QualEnvName_29, (MR_Integer) 2))));
            MR_String MangledEnvName_31;
            MR_Word ModuleName_86 = ((MR_Word) ((MR_hl_field(0, QualEnvName_29, (MR_Integer) 0))));
            MR_String Qualifier_88;
            MR_String Var_97;
            MR_String Var_99;
            MR_String Var_100;

            Qualifier_88 = ml_backend__mlds_to_c_name__qualifier_to_string_for_c_1_f_0(ModuleName_86);
            MangledEnvName_31 = parse_tree__prog_foreign__name_mangle_1_f_0(EnvName_30);
            Var_97 = mercury__string__f_43_43_2_f_0(MangledEnvName_31, (MR_String) "_0_s");
            Var_99 = mercury__string__f_43_43_2_f_0((MR_String) "__", Var_97);
            Var_100 = mercury__string__f_43_43_2_f_0(Qualifier_88, Var_99);
            *TypePrefix_9 = mercury__string__f_43_43_2_f_0((MR_String) "struct ", Var_100);
            *TypeSuffix_10 = (MR_String) "";
          }
          break;
        case (MR_Integer) 7:
          {
            ...
            MR_String TypePrefix_143;
            MR_String TypeSuffix_144;

            ml_backend__mlds_to_c_type__type_to_prefix_suffix_for_c_5_p_0(Opts_6, BaseType_16, (MR_Word) ((MR_Unsigned) 0U), &TypePrefix_143, &TypeSuffix_144);
            *TypePrefix_9 = mercury__string__f_43_43_2_f_0(TypePrefix_143, TypeSuffix_144);
            *TypeSuffix_10 = ml_backend__mlds_to_c_type__array_type_suffix_for_c_1_f_0(InitSize_8);
          }
          break;
        case (MR_Integer) 8:
          {
            MR_String TypePrefix_146;
            MR_String TypeSuffix_147;

            ml_backend__mlds_to_c_type__type_to_prefix_suffix_for_c_5_p_0(Opts_6, (MR_Word) ((MR_Unsigned) 20U), (MR_Word) ((MR_Unsigned) 0U), &TypePrefix_146, &TypeSuffix_147);
            *TypePrefix_9 = mercury__string__f_43_43_2_f_0(TypePrefix_146, TypeSuffix_147);
            *TypeSuffix_10 = (MR_String) "";
          }
          break;
        case (MR_Integer) 9:
          {
            MR_String BaseTypeStr_32;
            MR_Word BaseType_89 = ((MR_Word) ((MR_hl_field(3, MLDS_Type_7, (MR_Integer) 1))));
            MR_String TypePrefix_149;
            MR_String TypeSuffix_150;

            ml_backend__mlds_to_c_type__type_to_prefix_suffix_for_c_5_p_0(Opts_6, BaseType_89, (MR_Word) ((MR_Unsigned) 0U), &TypePrefix_149, &TypeSuffix_150);
            BaseTypeStr_32 = mercury__string__f_43_43_2_f_0(TypePrefix_149, TypeSuffix_150);
            *TypePrefix_9 = mercury__string__f_43_43_2_f_0(BaseTypeStr_32, (MR_String) " *");
            *TypeSuffix_10 = (MR_String) "";
          }
          break;
        case (MR_Integer) 10:
          {
            MR_Word RttiIdMaybeElement_39 = ((MR_Word) ((MR_hl_field(3, MLDS_Type_7, (MR_Integer) 1))));
            MR_Word IsArray_40;

            backend_libs__rtti__rtti_id_maybe_element_c_type_3_p_0(RttiIdMaybeElement_39, TypePrefix_9, &IsArray_40);
            switch (IsArray_40) {
              default: /*NOTREACHED*/ MR_assert(0);
              case (MR_Integer) 0:
                *TypeSuffix_10 = ml_backend__mlds_to_c_type__array_type_suffix_for_c_1_f_0(InitSize_8);
        ...
        case (MR_Integer) 11:
          {
            MR_Word TablingId_41 = ((MR_Word) ((MR_hl_field(3, MLDS_Type_7, (MR_Integer) 1))));
            MR_Word IsArray_90;

            backend_libs__rtti__tabling_id_c_type_3_p_0(TablingId_41, TypePrefix_9, &IsArray_90);
            switch (IsArray_90) {
              default: /*NOTREACHED*/ MR_assert(0);
              case (MR_Integer) 0:
                *TypeSuffix_10 = ml_backend__mlds_to_c_type__array_type_suffix_for_c_1_f_0(InitSize_8);
