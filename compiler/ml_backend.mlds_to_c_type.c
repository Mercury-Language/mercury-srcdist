      ...
      switch (MR_tag((MR_Word) MLDS_Type_6)) {
        ...
        case (MR_Integer) 1:
          {
            ...
            MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), ClassId_14, (MR_Integer) 2)));
            MR_Unsigned packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), QualClassName_15, (MR_Integer) 1)));
        ...
        case (MR_Integer) 3:
          switch (((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), MLDS_Type_6, (MR_Integer) 0)))) {
            ...
            case (MR_Integer) 1:
              {
                MR_Word HighLevelData_12 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Opts_5, (MR_Integer) 2))) >> 13)) & (MR_Integer) 1);
                MR_Unsigned packed_word_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Opts_5, (MR_Integer) 2)));
                  ...
                  case (MR_Integer) 1:
                    {
                      ...
                      {
                        ClassId_170 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
                        MR_hl_field(MR_mktag(0), ClassId_170, 0) = ((MR_Box) (ClassName_158));
                        MR_hl_field(MR_mktag(0), ClassId_170, 1) = ((MR_Box) (ClassArity_159));
                        MR_hl_field(MR_mktag(0), ClassId_170, 2) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 0));
                      }
                      Type_166 = (MR_Word) (MR_mkword(MR_mktag(1), (MR_Word) (ClassId_170)));
                      {
                        MLDS_Type_162 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                        MR_hl_field(MR_mktag(3), MLDS_Type_162, 0) = ((MR_Box) ((MR_Unsigned) 6U));
            ...
            case (MR_Integer) 2:
              {
                ...
                if ((ArgTypes_23 == (MR_Word) ((MR_Unsigned) 0U)))
                {
            ...
            case (MR_Integer) 5:
              {
                ml_backend__mlds_to_c_type__mlds_output_type_4_p_0(Opts_5, (MR_Word) ((MR_Unsigned) 24U));
              }
              break;
            case (MR_Integer) 6:
              {
      ...
      switch (MR_tag((MR_Word) CtorCat_8)) {
        ...
        case (MR_Integer) 0:
          switch (MR_unmkbody(CtorCat_8)) {
            ...
            case (MR_Integer) 0:
              {
                MR_Word HighLevelData_10 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Opts_6, (MR_Integer) 2))) >> 13)) & (MR_Integer) 1);
                MR_Unsigned packed_word_4 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Opts_6, (MR_Integer) 2)));
        ...
        case (MR_Integer) 1:
          {
            ...
            switch (MR_tag((MR_Word) Var_90)) {
              ...
              case (MR_Integer) 1:
                {
                  MR_Word Var_91 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(1), Var_90, (MR_Integer) 0))) & (MR_Integer) 15);
                  MR_Unsigned packed_word_3 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), Var_90, (MR_Integer) 0)));
  ...
  top_of_proc_3:;
    {
      ...
      MR_Word HighLevelData_10 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Opts_6, (MR_Integer) 2))) >> 13)) & (MR_Integer) 1);
      MR_Unsigned packed_word_5 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Opts_6, (MR_Integer) 2)));
              ...
              case (MR_Integer) 0:
                {
...

                  {
                    ...
                    MR_hl_field(MR_mktag(0), ClassId_49, 2) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 0));
                  }
                  Type_45 = (MR_Word) (MR_mkword(MR_mktag(1), (MR_Word) (ClassId_49)));
                  {
                    MLDS_Type_41 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(MR_mktag(3), MLDS_Type_41, 0) = ((MR_Box) ((MR_Unsigned) 6U));
              ...
              case (MR_Integer) 2:
                {
                  ...
                  {
                    ClassId_40 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
                    MR_hl_field(MR_mktag(0), ClassId_40, 0) = ((MR_Box) (ClassName_37));
                    MR_hl_field(MR_mktag(0), ClassId_40, 1) = ((MR_Box) (ClassArity_38));
                    MR_hl_field(MR_mktag(0), ClassId_40, 2) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 3));
                  }
