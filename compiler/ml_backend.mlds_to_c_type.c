          ...
          case (MR_Integer) 2:
            {
              ...
              mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&ml_backend__mlds_to_c_type_scalar_common_3[0]), Arity_17, &Var_140);
          ...
          case (MR_Integer) 3:
            {
              ...
              mercury__io__write_string_4_p_0(Stream_7, (MR_String) "_");
              mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&ml_backend__mlds_to_c_type_scalar_common_3[0]), Arity_17, &Var_125);
