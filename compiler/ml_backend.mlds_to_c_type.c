  ...
  MR_Word * STATE_VARIABLE_Changed_4)
{
  ...
  else
  {
    ...
    switch (MR_tag((MR_Word) Init0_8)) {
      ...
      case (MR_Integer) 1:
        {
          MR_Word Rval0_20 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Init0_8, (MR_Integer) 0))));
          MR_Word Rval_21;
          MR_Word InitChanged_29;

          ml_backend__mlds_to_c_type__semicanonicalize_types_in_rval_for_c_3_p_0(Rval0_20, &Rval_21, &InitChanged_29);
          switch (InitChanged_29) {
            default: /*NOTREACHED*/ MR_assert(0);
            case (MR_Integer) 1:
              {
                {
                  Init_10 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                  MR_hl_field(MR_mktag(1), Init_10, 0) = ((MR_Box) (Rval_21));
                }
      ...
      case (MR_Integer) 2:
        {
          MR_Word StructType_22 = ((MR_Word) ((MR_hl_field(MR_mktag(2), Init0_8, (MR_Integer) 0))));
          MR_Word Inits0_23 = ((MR_Word) ((MR_hl_field(MR_mktag(2), Init0_8, (MR_Integer) 1))));
          MR_Word Inits_24;
          MR_Word InitChanged_30;

          ml_backend__mlds_to_c_type__semicanonicalize_types_in_initializers_for_c_4_p_0(Inits0_23, &Inits_24, (MR_Integer) 0, &InitChanged_30);
              ...
              {
                {
                  ...
                  MR_hl_field(MR_mktag(2), Init_10, 0) = ((MR_Box) (StructType_22));
                  MR_hl_field(MR_mktag(2), Init_10, 1) = ((MR_Box) (Inits_24));
                }
                STATE_VARIABLE_Changed_16_16 = (MR_Integer) 1;
              }
              break;
      ...
      case (MR_Integer) 3:
        {
          ...
          MR_Word Inits0_27 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Init0_8, (MR_Integer) 0))));
          MR_Word Inits_28;

          ml_backend__mlds_to_c_type__semicanonicalize_types_in_initializers_for_c_4_p_0(Inits0_27, &Inits_28, (MR_Integer) 0, &InitChanged_13);
              ...
              {
                {
                  ...
                  MR_hl_field(MR_mktag(3), Init_10, 0) = ((MR_Box) (Inits_28));
                }
                STATE_VARIABLE_Changed_16_16 = (MR_Integer) 1;
              }
              break;
