    ...
    case (MR_Integer) 1:
      {
        ...
        if (succeeded)
        {
          ...
          mercury__list__map_corresponding_4_p_0(TypeCtorInfo_130_130, TypeCtorInfo_131_131, TypeCtorInfo_131_131, Var_80, ArgInsts_59, ArgUnifyModes0_113, &ArgUnifyModes_107);
