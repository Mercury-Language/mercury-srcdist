                  ...
                  if (transform_hlds__float_regs__succeeded)
                    {
                      transform_hlds__float_regs__ShroudedPredProcId_90 = ((MR_Word) (MR_hl_field(MR_mktag(3), transform_hlds__float_regs__ConsId_9, (MR_Integer) 1)));
                      {
                        ...
                        {
                          mercury__list__map_3_p_0(transform_hlds__float_regs__TypeCtorInfo_67_88, (MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_ho_arg_reg_0, (MR_Word) &transform_hlds__float_regs_scalar_common_3[10], transform_hlds__float_regs__MissingArgTypes_81, &transform_hlds__float_regs__ArgRegs_82);
                        }
                        {
