...
static /* final */ const MR_Box transform_hlds__float_regs_scalar_common_5[6][8] = {
  ...
  /* row   4 */
  {
    ...
    ((MR_Box) (NULL)),
    ((MR_Box) ((MR_Integer) 5)),
    ((MR_Box) (&hlds__var_table__hlds__var_table__type_ctor_info_var_table_0)),
    ((MR_Box) (&transform_hlds__float_regs__term__pti_var_1__plain_parse_tree__prog_data__type_ctor_info_prog_var_type_0)),
    ((MR_Box) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_ho_arg_reg_0)),
    ...
    case (MR_Integer) 0:
      {
        ...
        hlds__var_table__lookup_var_entry_3_p_0(VarTable_6, Var_7, &Entry_10);
  ...
  MR_Word * STATE_VARIABLE_Specs_41)
{
  ...
  check_hlds__recompute_instmap_deltas__recompute_instmap_delta_vt_8_p_0((MR_Integer) 1, VarTable_31, InstVarSet0_20, InstMap0_18, Goal2_30, &Goal_33, STATE_VARIABLE_ModuleInfo_43_43, STATE_VARIABLE_ModuleInfo_39);
  ...
  MR_Word * STATE_VARIABLE_Specs_39)
{
  ...
  hlds__var_table__lookup_var_type_3_p_0(VarTable_24, CallVar_13, &CallVarType_25);
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      else
      {
        ...
        hlds__var_table__lookup_var_type_3_p_0(VarTable_52, Var_19, &VarType_53);
  ...
  MR_Word * STATE_VARIABLE_Specs_28)
{
  ...
  hlds__var_table__lookup_var_type_3_p_0(VarTable_19, Var_11, &Type_20);
  {
    ...
    case (MR_Integer) 0:
      {
        ...
        else
        {
          ...
          else
          {
            ...
            transform_hlds__float_regs__update_construct_goal_instmap_delta_8_p_0(ModuleInfo_97, CellVar_21, ConsId_22, Args_45, GoalInfo0_11, &GoalInfo1_49, STATE_VARIABLE_InstMap_91_91, STATE_VARIABLE_InstMap_71);
            {
  ...
  MR_Word * STATE_VARIABLE_Specs_48)
{
  ...
  hlds__var_table__lookup_var_type_3_p_0(VarTable_26, CellVar_14, &CellType_27);
  ...
  MR_Word * STATE_VARIABLE_Specs_48)
{
  ...
  if (succeeded)
  {
    ...
    hlds__var_table__lookup_var_type_3_p_0(VarTable_23, OrigVar_17, &OrigVarType_30);
  ...
  MR_Word * STATE_VARIABLE_Info_64)
{
  ...
  hlds__var_table__lookup_var_entry_3_p_0(VarTable0_18, OrigVar_10, &OrigVarEntry_20);
  ...
  hlds__var_table__add_var_entry_4_p_0(ReplacementEntry_42, LHSVar_15, VarTable1_29, &VarTable_43);
  ...
  MR_Word * STATE_VARIABLE_VarTable_5)
{
  ...
  else
  {
    ...
    hlds__var_table__add_var_entry_4_p_0(Entry_17, &Var_13, STATE_VARIABLE_VarTable_0_4, &STATE_VARIABLE_VarTable_21_21);
  ...
  MR_Word * STATE_VARIABLE_Specs_21)
{
  ...
  if (succeeded)
  {
    ...
    hlds__var_table__lookup_var_entry_3_p_0(VarTable_10, Var_11, &Entry_34);
    VarName_35 = hlds__var_table__var_entry_name_2_f_0(Var_11, Entry_34);
    {
      Var_41 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
  ...
  MR_Word * STATE_VARIABLE_Info_15)
{
  ...
  check_hlds__recompute_instmap_deltas__recompute_instmap_delta_vt_8_p_0((MR_Integer) 0, VarTable_10, InstVarSet_11, InstMap_8, Goal0_6, Goal_7, ModuleInfo0_12, &ModuleInfo_13);
  ...
  MR_Word * STATE_VARIABLE_Info_22)
{
  ...
  check_hlds__recompute_instmap_deltas__recompute_instmap_delta_vt_8_p_0((MR_Integer) 0, VarTable_35, InstVarSet_36, STATE_VARIABLE_InstMap_0_19, CallGoal0_15, &CallGoal_16, ModuleInfo0_37, &ModuleInfo_38);
