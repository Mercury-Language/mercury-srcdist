...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(0), transform_hlds__float_regs__Var_68, 0) = ((MR_Box) (&transform_hlds__float_regs_scalar_common_4[5]));
...
{
  {
...

    {
      ...
      MR_hl_field(MR_mktag(0), transform_hlds__float_regs__Var_22, 0) = ((MR_Box) (&transform_hlds__float_regs_scalar_common_5[6]));
...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(0), transform_hlds__float_regs__Var_29, 0) = ((MR_Box) (&transform_hlds__float_regs_scalar_common_10[0]));
    ...
    transform_hlds__float_regs__STATE_VARIABLE_Specs_31_31 = ((MR_Word) transform_hlds__float_regs__conv4_STATE_VARIABLE_Specs_31_31);
    {
      ...
      MR_hl_field(MR_mktag(0), transform_hlds__float_regs__Var_69, 0) = ((MR_Box) (&transform_hlds__float_regs_scalar_common_5[6]));
    ...
    if (transform_hlds__float_regs__succeeded)
      {
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(0), transform_hlds__float_regs__Var_33, 0) = ((MR_Box) (&transform_hlds__float_regs_scalar_common_9[3]));
...
{
  {
...

    {
      ...
      MR_hl_field(MR_mktag(0), transform_hlds__float_regs__Var_25, 0) = ((MR_Box) (&transform_hlds__float_regs_scalar_common_9[1]));
    ...
    transform_hlds__float_regs__STATE_VARIABLE_Specs_27_27 = ((MR_Word) transform_hlds__float_regs__conv4_STATE_VARIABLE_Specs_27_27);
    {
      ...
      MR_hl_field(MR_mktag(0), transform_hlds__float_regs__Var_65, 0) = ((MR_Box) (&transform_hlds__float_regs_scalar_common_5[6]));
    ...
    if (transform_hlds__float_regs__succeeded)
      {
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(0), transform_hlds__float_regs__Var_29, 0) = ((MR_Box) (&transform_hlds__float_regs_scalar_common_9[2]));
    ...
    if (transform_hlds__float_regs__succeeded)
      {
...

        {
          ...
          MR_hl_field(MR_mktag(0), transform_hlds__float_regs__Var_14, 0) = ((MR_Box) (&transform_hlds__float_regs_scalar_common_5[5]));
          ...
          case (MR_Integer) 0:
            {
...

              {
                ...
                MR_hl_field(MR_mktag(0), transform_hlds__float_regs__Var_61, 0) = ((MR_Box) (&transform_hlds__float_regs_scalar_common_4[4]));
    ...
    if (transform_hlds__float_regs__succeeded)
      {
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(0), transform_hlds__float_regs__Var_51, 0) = ((MR_Box) (&transform_hlds__float_regs_scalar_common_5[4]));
          ...
          if (transform_hlds__float_regs__succeeded)
            {
              ...
              transform_hlds__float_regs__TypeCtorInfo_135_135 = (MR_Word) &hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_unify_mode_0;
              {
                ...
                MR_hl_field(MR_mktag(0), transform_hlds__float_regs__Var_82, 0) = ((MR_Box) (&transform_hlds__float_regs_scalar_common_5[2]));
