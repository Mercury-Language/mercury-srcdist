  ...
  MR_Word * STATE_VARIABLE_Specs_19)
{
  ...
  hlds__hlds_pred__proc_info_set_goal_3_p_0(Goal_41, ProcInfo0_12, &STATE_VARIABLE_ProcInfo_1_45);
  hlds__hlds_pred__proc_info_set_var_table_3_p_0(VarTable_39, STATE_VARIABLE_ProcInfo_1_45, &STATE_VARIABLE_ProcInfo_2_46);
  hlds__hlds_pred__proc_info_set_rtti_varmaps_3_p_0(RttiVarMaps_40, STATE_VARIABLE_ProcInfo_2_46, &STATE_VARIABLE_ProcInfo_3_47);
  hlds__hlds_pred__proc_info_set_headvars_3_p_0(HeadVars_22, STATE_VARIABLE_ProcInfo_3_47, &STATE_VARIABLE_ProcInfo_4_48);
  ...
  MR_Box * wrapper_arg_2)
{
  ...
  succeeded = transform_hlds__float_regs__IntroducedFrom__pred__common_instmap_delta__1504__1_4_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) ((MR_hl_field(0, closure, 4)))), ((MR_Word) (wrapper_arg_1)), &conv0_LambdaHeadVar__2_24);
  if (succeeded)
  {
  ...
  MR_Box * wrapper_arg_2)
{
  ...
  succeeded = transform_hlds__float_regs__IntroducedFrom__pred__common_instmap_delta__1504__1_4_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) ((MR_hl_field(0, closure, 4)))), ((MR_Word) (wrapper_arg_1)), &conv6_LambdaHeadVar__2_24);
  if (succeeded)
  {
  ...
  MR_Word * STATE_VARIABLE_Specs_21)
{
  ...
  if (succeeded)
  {
    ...
    }
    {
      ...
      MR_hl_field(2, Spec_19, 2) = ((MR_Box) ((MR_Unsigned) 112U));
