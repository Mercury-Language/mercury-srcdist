    ...
    case (MR_Integer) 0:
      {
        ...
        transform_hlds__float_regs__update_instmap_if_unreachable_3_p_0(*Goal_10, STATE_VARIABLE_InstMap_0_74, STATE_VARIABLE_InstMap_75);
      }
      break;
    case (MR_Integer) 1:
        ...
        case (MR_Integer) 0:
          {
            ...
            switch (MR_tag((MR_Word) GenericCall_50)) {
              ...
              case (MR_Integer) 3:
                {
                  *Goal_10 = Goal0_9;
                  hlds__goal_util__update_instmap_3_p_0(*Goal_10, STATE_VARIABLE_InstMap_0_74, STATE_VARIABLE_InstMap_75);
        ...
        case (MR_Integer) 2:
          {
            ...
            transform_hlds__float_regs__update_instmap_if_unreachable_3_p_0(*Goal_10, STATE_VARIABLE_InstMap_83_83, STATE_VARIABLE_InstMap_75);
          }
          break;
        case (MR_Integer) 3:
          {
  ...
  MR_Word * PredInfo_8)
{
  ...
  succeeded = hlds__hlds_pred__marker_is_present_2_p_0(PredMarkers_9, (MR_Integer) 12);
  if (succeeded)
  {
