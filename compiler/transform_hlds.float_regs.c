  ...
  MR_Word * STATE_VARIABLE_Specs_21)
{
  ...
  if (succeeded)
  {
    ...
    InPieces_31 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), Var_36, (MR_Word) (MR_mkword(1, &transform_hlds__float_regs_scalar_common_1[9])));
    {
