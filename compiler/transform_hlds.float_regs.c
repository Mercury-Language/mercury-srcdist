...
{
  {
    ...
    mercury__list__length_2_p_0((MR_Word) (&transform_hlds__float_regs_scalar_common_1[1]), Vars0_16, &Len_70);
    ...
    else
    {
      succeeded = (StartLen_71 > (MR_Integer) 0);
      if (succeeded)
        mercury__list__det_split_list_4_p_0((MR_Word) (&transform_hlds__float_regs_scalar_common_1[1]), StartLen_71, Vars0_16, &StartVars_38, &EndVars0_39);
      else
      {
        {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        mercury__list__det_split_list_4_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_mode_0), StartLen_81, Modes0_18, &StartModes_40, &Var_96);
      }
      else
      {
        {
    ...
    mercury__list__length_2_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_mode_0), ProcArgModes_35, &Len_90);
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        mercury__list__det_split_list_4_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_mode_0), StartLen_91, ProcArgModes_35, &Var_98, &EndProcArgModes_43);
      }
      else
      {
        {
      ...
      case (MR_Integer) 0:
        {
          ...
          else
          {
            ...
            else
            {
              ...
              mercury__list__foldl_4_p_0((MR_Word) (&hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_hlds_goal_0), (MR_Word) (&hlds__instmap__hlds__instmap__type_ctor_info_instmap_0), (MR_Word) (&transform_hlds__float_regs_scalar_common_3[11]), WrapGoals_49, ((MR_Box) (STATE_VARIABLE_InstMap_0_71)), &conv1_STATE_VARIABLE_InstMap_95_95);
              ...
              Var_97 = mercury__list__f_43_43_2_f_0((MR_Word) (&hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_hlds_goal_0), WrapGoals_49, Var_98);
          ...
          case (MR_Integer) 0:
            {
              ...
              mercury__list__map_3_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_bound_inst_0), (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_bound_inst_0), Var_61, BoundInsts0_15, &BoundInsts_16);
              {
                MR_Word base;
              ...
              else
              {
                ...
                if (succeeded)
                {
                  ShroudedPredProcId_112 = ((MR_Word) ((MR_hl_field(MR_mktag(3), ConsId_9, (MR_Integer) 1))));
                  {
                    ...
                    mercury__list__det_drop_3_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0), NumArgs_96, ArgTypes_95, &MissingArgTypes_97);
                    mercury__list__map_3_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0), (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_ho_arg_reg_0), (MR_Word) (&transform_hlds__float_regs_scalar_common_3[10]), MissingArgTypes_97, &ArgRegs_98);
                    {
