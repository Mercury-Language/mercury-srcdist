...
{
  {
    ...
    {
      MR_Word Var_76 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Errors_8, (MR_Integer) 1))));
      MR_Word Var_77 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Errors_8, (MR_Integer) 0))));
      ...
      if ((Var_76 == (MR_Word) ((MR_Unsigned) 0U)))
      {
        ...
        transform_hlds__term_errors__describe_term_error_8_p_0(ModuleInfo_6, Single_13, Var_77, (MR_Word) ((MR_Unsigned) 0U), Var_54, &ReasonMsgsCord_16, STATE_VARIABLE_Specs_0_24, &STATE_VARIABLE_Specs_55_55);
      }
      else
      {
        MR_Word Var_47;
        MR_Word Error_89;
        MR_Word Errors_90;
        MR_Word STATE_VARIABLE_Msgs_30_99;
        ...
        Error_89 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Errors_8, (MR_Integer) 0))));
        Errors_90 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Errors_8, (MR_Integer) 1))));
        transform_hlds__term_errors__describe_term_error_8_p_0(ModuleInfo_6, Single_13, Error_89, (MR_Word) (MR_mkword(MR_mktag(1), &transform_hlds__term_errors_scalar_common_4[0])), Var_47, &STATE_VARIABLE_Msgs_30_99, STATE_VARIABLE_Specs_0_24, &STATE_VARIABLE_Specs_31_100);
        transform_hlds__term_errors__describe_term_errors_8_p_0(ModuleInfo_6, Single_13, Errors_90, (MR_Integer) ((MR_Unsigned) 1 + (MR_Unsigned) 1), STATE_VARIABLE_Msgs_30_99, &ReasonMsgsCord_16, STATE_VARIABLE_Specs_31_100, &STATE_VARIABLE_Specs_55_55);
      }
    }
...
{
  {
    ...
    else
    {
      ...
      if ((Var_76 == (MR_Word) ((MR_Unsigned) 0U)))
      {
        ...
        transform_hlds__term_errors__describe_term_error_8_p_0(ModuleInfo_6, Single_13, Var_77, (MR_Word) ((MR_Unsigned) 0U), Var_58, &ReasonMsgsCord_18, STATE_VARIABLE_Specs_0_25, &STATE_VARIABLE_Specs_59_59);
      }
      else
      {
        MR_Word Var_50;
        ...
        Error_89 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Errors_8, (MR_Integer) 0))));
        Errors_90 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Errors_8, (MR_Integer) 1))));
        transform_hlds__term_errors__describe_term_error_8_p_0(ModuleInfo_6, Single_13, Error_89, (MR_Word) (MR_mkword(MR_mktag(1), &transform_hlds__term_errors_scalar_common_4[0])), Var_50, &STATE_VARIABLE_Msgs_30_99, STATE_VARIABLE_Specs_0_25, &STATE_VARIABLE_Specs_31_100);
        transform_hlds__term_errors__describe_term_errors_8_p_0(ModuleInfo_6, Single_13, Errors_90, (MR_Integer) ((MR_Unsigned) 1 + (MR_Unsigned) 1), STATE_VARIABLE_Msgs_30_99, &ReasonMsgsCord_18, STATE_VARIABLE_Specs_31_100, &STATE_VARIABLE_Specs_59_59);
      }
    }
