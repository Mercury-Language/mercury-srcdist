...
MR_decl_label8(transform_hlds__term_errors__output_term_error_7_0, 2,4,5,6,7,10,11,8)
MR_decl_label3(transform_hlds__term_errors__output_term_errors_7_0, 10,4,12)
MR_decl_label8(transform_hlds__term_errors__report_arg_size_errors_5_0, 2,6,7,3,8,9,10,15)
MR_decl_label6(transform_hlds__term_errors__report_arg_size_errors_5_0, 16,14,18,19,20,12)
...
MR_decl_label3(fn__transform_hlds__term_errors__is_fatal_error_1_0, 4,14,23)
MR_decl_label4(fn__transform_hlds__term_errors__is_indirect_error_1_0, 4,15,22,23)
...
MR_BEGIN_MODULE(transform_hlds__term_errors_module4)
	...
	MR_init_label8(transform_hlds__term_errors__report_arg_size_errors_5_0,2,6,7,3,8,9,10,15)
	MR_init_label6(transform_hlds__term_errors__report_arg_size_errors_5_0,16,14,18,19,20,12)
MR_BEGIN_CODE
...
MR_def_label(transform_hlds__term_errors__report_arg_size_errors_5_0,10)
	...
	if (MR_LTAGS_TESTR(MR_tempr1,0,0)) {
		MR_GOTO_LAB(transform_hlds__term_errors__report_arg_size_errors_5_0_i14);
	}
	MR_tag_alloc_heap(MR_tempr2, 1, (MR_Integer) 2);
	MR_r3 = MR_tempr2;
	...
	MR_np_call_localret_ent(list__append_3_1,
		transform_hlds__term_errors__report_arg_size_errors_5_0_i15);
...
MR_BEGIN_MODULE(transform_hlds__term_errors_module5)
	...
	MR_init_label3(transform_hlds__term_errors__output_term_errors_7_0,10,4,12)
MR_BEGIN_CODE
...
MR_def_static(transform_hlds__term_errors__output_term_errors_7_0)
	...
	MR_incr_sp(6);
	MR_sv(6) = (MR_Word) MR_succip;
MR_def_label(transform_hlds__term_errors__output_term_errors_7_0,10)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TEST(MR_r1,0,0)) {
		MR_GOTO_LAB(transform_hlds__term_errors__output_term_errors_7_0_i12);
	}
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 1);
...
MR_def_label(transform_hlds__term_errors__output_term_errors_7_0,4)
	...
	MR_r5 = MR_sv(4);
	MR_succip_word = MR_sv(6);
	MR_GOTO_LAB(transform_hlds__term_errors__output_term_errors_7_0_i10);
MR_def_label(transform_hlds__term_errors__output_term_errors_7_0,12)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_BEGIN_MODULE(transform_hlds__term_errors_module6)
	...
	MR_init_label8(transform_hlds__term_errors__output_term_error_7_0,2,4,5,6,7,10,11,8)
MR_BEGIN_CODE
...
MR_def_label(transform_hlds__term_errors__output_term_error_7_0,2)
	...
	MR_r1 = MR_sv(4);
	MR_np_call_localret_ent(parse_tree__error_util__write_error_pieces_5_0,
		transform_hlds__term_errors__output_term_error_7_0_i7);
...
MR_def_label(transform_hlds__term_errors__output_term_error_7_0,6)
	...
	MR_np_call_localret_ent(parse_tree__error_util__write_error_pieces_5_0,
		transform_hlds__term_errors__output_term_error_7_0_i7);
MR_def_label(transform_hlds__term_errors__output_term_error_7_0,7)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TEST(MR_sv(5),0,0)) {
		MR_GOTO_LAB(transform_hlds__term_errors__output_term_error_7_0_i8);
	}
	MR_sv(1) = MR_ctfield(1, MR_sv(5), 0);
	MR_r1 = MR_sv(3);
	MR_r2 = MR_sv(1);
	MR_np_call_localret_ent(transform_hlds__term_util__lookup_proc_arg_size_info_3_0,
		transform_hlds__term_errors__output_term_error_7_0_i10);
MR_def_label(transform_hlds__term_errors__output_term_error_7_0,10)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TEST(MR_r1,0,0)) {
		MR_GOTO_LAB(transform_hlds__term_errors__output_term_error_7_0_i11);
	}
	{
	MR_Word MR_tempr1, MR_tempr2;
...
MR_BEGIN_MODULE(transform_hlds__term_errors_module8)
	...
	MR_init_label4(fn__transform_hlds__term_errors__is_indirect_error_1_0,4,15,22,23)
MR_BEGIN_CODE
...
MR_define_entry(mercury__fn__transform_hlds__term_errors__is_indirect_error_1_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_COMPUTED_GOTO((MR_Unsigned) MR_tag(MR_r1),
		MR_LABEL_AP(fn__transform_hlds__term_errors__is_indirect_error_1_0_i4) MR_AND
		MR_LABEL_AP(fn__transform_hlds__term_errors__is_indirect_error_1_0_i22) MR_AND
		MR_LABEL_AP(fn__transform_hlds__term_errors__is_indirect_error_1_0_i22) MR_AND
		MR_LABEL_AP(fn__transform_hlds__term_errors__is_indirect_error_1_0_i15));
MR_def_label(fn__transform_hlds__term_errors__is_indirect_error_1_0,4)
	...
	MR_COMPUTED_GOTO((MR_Unsigned) MR_unmkbody(MR_r1),
		...
		MR_LABEL_AP(fn__transform_hlds__term_errors__is_indirect_error_1_0_i22) MR_AND
		MR_LABEL_AP(fn__transform_hlds__term_errors__is_indirect_error_1_0_i22) MR_AND
		MR_LABEL_AP(fn__transform_hlds__term_errors__is_indirect_error_1_0_i23) MR_AND
		MR_LABEL_AP(fn__transform_hlds__term_errors__is_indirect_error_1_0_i23) MR_AND
		MR_LABEL_AP(fn__transform_hlds__term_errors__is_indirect_error_1_0_i23) MR_AND
		MR_LABEL_AP(fn__transform_hlds__term_errors__is_indirect_error_1_0_i23));
MR_def_label(fn__transform_hlds__term_errors__is_indirect_error_1_0,15)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_ctfield(3, MR_r1, 0),6)) {
		MR_GOTO_LAB(fn__transform_hlds__term_errors__is_indirect_error_1_0_i23);
	}
MR_def_label(fn__transform_hlds__term_errors__is_indirect_error_1_0,22)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Integer) 1;
	MR_proceed();
MR_def_label(fn__transform_hlds__term_errors__is_indirect_error_1_0,23)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Integer) 0;
	MR_proceed();
#ifdef MR_maybe_local_thread_engine_base
...
MR_BEGIN_MODULE(transform_hlds__term_errors_module9)
	...
	MR_init_label3(fn__transform_hlds__term_errors__is_fatal_error_1_0,4,14,23)
MR_BEGIN_CODE
...
MR_define_entry(mercury__fn__transform_hlds__term_errors__is_fatal_error_1_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_COMPUTED_GOTO((MR_Unsigned) MR_tag(MR_r1),
		MR_LABEL_AP(fn__transform_hlds__term_errors__is_fatal_error_1_0_i4) MR_AND
		MR_LABEL_AP(fn__transform_hlds__term_errors__is_fatal_error_1_0_i23) MR_AND
		MR_LABEL_AP(fn__transform_hlds__term_errors__is_fatal_error_1_0_i14) MR_AND
		MR_LABEL_AP(fn__transform_hlds__term_errors__is_fatal_error_1_0_i23));
...
MR_def_label(fn__transform_hlds__term_errors__is_fatal_error_1_0,14)
	...
	MR_r1 = (MR_Integer) 1;
	MR_proceed();
MR_def_label(fn__transform_hlds__term_errors__is_fatal_error_1_0,23)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Integer) 0;
	MR_proceed();
#ifdef MR_maybe_local_thread_engine_base
