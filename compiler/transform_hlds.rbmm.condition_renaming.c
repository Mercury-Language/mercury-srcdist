          ...
          case (MR_Integer) 6:
            {
              ...
              next_value_of_STATE_VARIABLE_IteRenamingProc_0_48 = STATE_VARIABLE_IteRenamingProc_54_54;
              Goal_8 = next_value_of_Goal_8;
