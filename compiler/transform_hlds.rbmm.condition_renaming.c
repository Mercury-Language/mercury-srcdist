  ...
  MR_Word * STATE_VARIABLE_IteAnnotationProc_10)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        succeeded = mercury__list__member_2_p_0((MR_Word) (&mdbcomp__goal_path__mdbcomp__goal_path__type_ctor_info_goal_path_step_0), ((MR_Box) ((MR_Integer) 0)), FromThenSteps_38);
        if (succeeded)
        {
...
{
  {
    ...
    if ((RevPathToCond_11 == (MR_Word) ((MR_Integer) 0)))
    {
      {
    ...
    else
    {
      ...
      mercury__require__expect_3_p_0(Var_26, (MR_String) "predicate \140transform_hlds.rbmm.condition_renaming.collect_ite_annotation_region_names\'/8", (MR_String) "not step_ite_cond");
      {
        ...
        MR_hl_field(MR_mktag(1), RevPathToThen_17, 1) = ((MR_Box) ((MR_Integer) 4));
      }
      ...
      succeeded = (LastStep_50 == (MR_Word) ((MR_Integer) 0));
      if (succeeded)
      {
  ...
  MR_Integer * STATE_VARIABLE_HowMany_12)
{
  while (MR_TRUE)
  {
    ...
    // setup for model_det tailcalls optimized into a loop
    ;
    if ((RevPath_5 == (MR_Word) ((MR_Integer) 0)))
    {
      *RevPathToCond_6 = (MR_Word) ((MR_Integer) 0);
    ...
    else
    {
      ...
      succeeded = (LastStep_9 == (MR_Word) ((MR_Integer) 0));
      if (succeeded)
      {
        ...
        case (MR_Integer) 1:
          {
            ...
            if (succeeded)
              ...
              ResurRenamingAnnos_29 = (MR_Word) ((MR_Integer) 0);
            ...
            case (MR_Integer) 3:
              {
                ...
                if ((Var_112 == (MR_Word) ((MR_Integer) 0)))
                {
                  {
                    mercury__require__unexpected_2_p_0((MR_String) "predicate \140transform_hlds.rbmm.condition_renaming.collect_regions_created_in_condition_compound_goal\'/8", (MR_String) "atomic or unsupported goal");
                    return;
        ...
        case (MR_Integer) 1:
          {
            ...
            if (succeeded)
              ...
              ResurRenamingAnnos_31 = (MR_Word) ((MR_Integer) 0);
  ...
  MR_Word * STATE_VARIABLE_NonLocalRegionProc_17)
{
  while (MR_TRUE)
  {
    ...
    // setup for model_det tailcalls optimized into a loop
    ;
    if ((RevPath_6 == (MR_Word) ((MR_Integer) 0)))
    ...
    else
    {
      ...
      succeeded = (LastStep_11 == (MR_Word) ((MR_Integer) 8));
      if (succeeded)
      {
...

        {
          ...
          MR_hl_field(MR_mktag(1), RevPathToCond_12, 1) = ((MR_Box) ((MR_Integer) 0));
        }
