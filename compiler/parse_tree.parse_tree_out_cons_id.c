...
static void MR_CALL 
parse_tree__parse_tree_out_cons_id__IntroducedFrom__pred__cons_id_and_arity_to_string_maybe_quoted__261__1_3_p_0(
  ...
  MR_Box * wrapper_arg_3)
{
  ...
  parse_tree__parse_tree_out_cons_id__IntroducedFrom__pred__cons_id_and_arity_to_string_maybe_quoted__261__1_3_p_0(((MR_Char) (MR_Word) wrapper_arg_1), ((MR_String) (wrapper_arg_2)), &conv0_LambdaHeadVar__3_45);
  ...
  MR_Word ConsId_7)
{
  ...
  parse_tree__parse_tree_out_cons_id__mercury_format_cons_id_6_p_0((MR_Word) (&parse_tree__parse_tree_out_cons_id_scalar_common_2[1]), Lang_5, NeedsBrackets_6, ConsId_7, ((MR_Box) ((MR_Integer) 0)), ((MR_Box) (State0_9)), &conv0_State_10);
