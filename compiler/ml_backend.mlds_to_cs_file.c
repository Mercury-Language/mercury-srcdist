    ...
    case (MR_Integer) 1:
      {
        ...
        {
          MR_String IncludeFileName_23 = ((MR_String) ((MR_hl_field(MR_mktag(1), LiteralOrInclude_15, (MR_Integer) 0))));
          MR_String IncludePath_25;
          MR_Word Var_29;
          MR_Word Var_30;

          parse_tree__file_names__make_include_file_path_3_p_0(Var_75, IncludeFileName_23, &IncludePath_25);
          Var_29 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Info_8, (MR_Integer) 1))) & (MR_Integer) 1);
          {
            Var_30 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
            MR_hl_field(MR_mktag(0), Var_30, 0) = ((MR_Box) (IncludePath_25));
        ...
        {
          MR_String Code_22 = ((MR_String) ((MR_hl_field(MR_mktag(0), LiteralOrInclude_15, (MR_Integer) 0))));
  ...
  MR_Word * Res_12)
{
  ...
  switch (Lang_14) {
    ...
    case (MR_Integer) 1:
      {
        MR_Word Var_35;
        MR_String Var_76 = ((MR_String) ((MR_hl_field(MR_mktag(0), Info_8, (MR_Integer) 3))));
        MR_Word Var_78 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Info_8, (MR_Integer) 1))) & (MR_Integer) 1);

        if (((MR_tag((MR_Word) LiteralOrInclude_16)) == (MR_Integer) 1))
        {
          MR_String IncludeFileName_24 = ((MR_String) ((MR_hl_field(MR_mktag(1), LiteralOrInclude_16, (MR_Integer) 0))));
          MR_String IncludePath_26;
          MR_Word Var_30;
          MR_Word Var_31;

          parse_tree__file_names__make_include_file_path_3_p_0(Var_76, IncludeFileName_24, &IncludePath_26);
          Var_30 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Info_8, (MR_Integer) 1))) & (MR_Integer) 1);
          {
            Var_31 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
            MR_hl_field(MR_mktag(0), Var_31, 0) = ((MR_Box) (IncludePath_26));
        ...
        {
          MR_String Code_23 = ((MR_String) ((MR_hl_field(MR_mktag(0), LiteralOrInclude_16, (MR_Integer) 0))));
