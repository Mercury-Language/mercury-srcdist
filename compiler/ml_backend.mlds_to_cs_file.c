  ...
  MR_Word * Res_12)
{
  ...
  switch (Lang_14) {
    ...
    case (MR_Integer) 1:
      {
        MR_Word Var_43;
        MR_String Var_85 = ((MR_String) ((MR_hl_field(MR_mktag(0), Info_8, (MR_Integer) 3))));
        MR_Word Var_87 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Info_8, (MR_Integer) 1))) & (MR_Integer) 1);

        if (((MR_tag((MR_Word) LiteralOrInclude_15)) == (MR_Integer) 1))
        {
          MR_String IncludeFileName_31 = ((MR_String) ((MR_hl_field(MR_mktag(1), LiteralOrInclude_15, (MR_Integer) 0))));
          MR_String IncludePath_33;
          MR_Word Var_34;
          MR_Word Var_35;

          parse_tree__file_names__make_include_file_path_3_p_0(Var_85, IncludeFileName_31, &IncludePath_33);
          Var_34 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Info_8, (MR_Integer) 1))) & (MR_Integer) 1);
          {
            ...
            MR_hl_field(MR_mktag(0), Var_35, 0) = ((MR_Box) (IncludePath_33));
            MR_hl_field(MR_mktag(0), Var_35, 1) = ((MR_Box) ((MR_Integer) 1));
          }
          ml_backend__mlds_to_cs_util__cs_output_context_5_p_0(Stream_9, Var_34, Var_35);
          libs__file_util__write_include_file_contents_5_p_0(Stream_9, IncludePath_33, Res_12);
        }
        else
        {
          MR_String Code_30 = ((MR_String) ((MR_hl_field(MR_mktag(0), LiteralOrInclude_15, (MR_Integer) 0))));

          ml_backend__mlds_to_cs_util__indent_line_after_context_6_p_0(Stream_9, Var_87, Context_16, Indent_10);
          mercury__io__write_string_4_p_0(Stream_9, Code_30);
          *Res_12 = (MR_Word) ((MR_Unsigned) 0U);
        }
        mercury__io__nl_3_p_0(Stream_9);
        Var_43 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Info_8, (MR_Integer) 1))) & (MR_Integer) 1);
        ml_backend__mlds_to_cs_util__cs_output_default_context_4_p_0(Stream_9, Var_43);
      }
      break;
  }
}
    ...
    case (MR_Integer) 1:
      {
        ...
        {
          MR_String IncludeFileName_32 = ((MR_String) ((MR_hl_field(MR_mktag(1), LiteralOrInclude_16, (MR_Integer) 0))));
        ...
        {
          MR_String Code_31 = ((MR_String) ((MR_hl_field(MR_mktag(0), LiteralOrInclude_16, (MR_Integer) 0))));

          ml_backend__mlds_to_cs_util__indent_line_after_context_6_p_0(Stream_9, Var_88, Context_17, Indent_10);
