...
{
  {
    MR_Word Lang_12 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ForeignBodyCode_9, (MR_Integer) 0))));
...
{
  {
    MR_Word Lang_12 = ((MR_Word) ((MR_hl_field(MR_mktag(0), DeclCode_9, (MR_Integer) 0))));
    MR_Word LiteralOrInclude_14 = ((MR_Word) ((MR_hl_field(MR_mktag(0), DeclCode_9, (MR_Integer) 2))));
    MR_Word Context_15 = ((MR_Word) ((MR_hl_field(MR_mktag(0), DeclCode_9, (MR_Integer) 3))));
