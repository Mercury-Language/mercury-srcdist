  ...
  MR_Word * Succeeded_8)
{
  ...
  parse_tree__file_names__module_name_to_file_name_8_p_0(Globals_10, (MR_String) "predicate \140ml_backend.mlds_to_cs_file.output_csharp_mlds\'/5", (MR_Integer) 0, (MR_Word) (MR_mkword(3, &ml_backend__mlds_to_cs_file_scalar_common_1[2])), ModuleName_11, &SourceFileName_12);
  {
    Var_20 = (MR_Word) MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(0, Var_20, 0) = ((MR_Box) (&ml_backend__mlds_to_cs_file_scalar_common_2[0]));
    MR_hl_field(0, Var_20, 1) = ((MR_Box) (ml_backend__mlds_to_cs_file__output_csharp_mlds_5_p_0_1));
    MR_hl_field(0, Var_20, 2) = ((MR_Box) ((MR_Integer) 2));
    MR_hl_field(0, Var_20, 3) = ((MR_Box) (ModuleInfo_6));
    MR_hl_field(0, Var_20, 4) = ((MR_Box) (MLDS_7));
  }
  libs__file_util__output_to_file_stream_7_p_0(Globals_10, ModuleName_11, SourceFileName_12, Var_20, Succeeded_8);
}
