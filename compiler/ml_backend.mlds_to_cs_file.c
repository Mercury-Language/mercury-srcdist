  ...
  MR_Word * Errors_18)
{
  ...
  parse_tree__parse_tree_out_sym_name__write_sym_name_4_p_0(Stream_12, MercuryModuleName_14);
  ...
  MR_Word ModuleName_8)
{
  ...
  parse_tree__parse_tree_out_sym_name__write_sym_name_4_p_0(Stream_6, ModuleName_8);
  mercury__io__write_string_4_p_0(Stream_6, (MR_String) ".\n");
}
