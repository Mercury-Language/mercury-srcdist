    ...
    case (MR_Integer) 1:
      {
        ...
        if (((MR_tag((MR_Word) LiteralOrInclude_15)) == (MR_Integer) 1))
        {
          ...
          parse_tree__file_names__make_include_file_path_3_p_0(Var_85, IncludeFileName_32, &IncludePath_34);
          Var_38 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Info_8, (MR_Integer) 1))) & (MR_Integer) 1);
          {
            Var_39 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
            MR_hl_field(MR_mktag(0), Var_39, 0) = ((MR_Box) (IncludePath_34));
            MR_hl_field(MR_mktag(0), Var_39, 1) = ((MR_Box) ((MR_Integer) 1));
          }
          ml_backend__mlds_to_cs_util__cs_output_context_5_p_0(Stream_9, Var_38, Var_39);
    ...
    case (MR_Integer) 1:
      {
        ...
        if (((MR_tag((MR_Word) LiteralOrInclude_16)) == (MR_Integer) 1))
        {
          ...
          parse_tree__file_names__make_include_file_path_3_p_0(Var_86, IncludeFileName_33, &IncludePath_35);
          Var_39 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Info_8, (MR_Integer) 1))) & (MR_Integer) 1);
          {
            Var_40 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
            MR_hl_field(MR_mktag(0), Var_40, 0) = ((MR_Box) (IncludePath_35));
            MR_hl_field(MR_mktag(0), Var_40, 1) = ((MR_Box) ((MR_Integer) 1));
          }
          ml_backend__mlds_to_cs_util__cs_output_context_5_p_0(Stream_9, Var_39, Var_40);
