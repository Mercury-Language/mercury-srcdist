...
static void MR_CALL 
ml_backend__mlds_to_cs_file__IntroducedFrom__pred__output_static_constructor__392__1_5_p_0_1(
  MR_Box closure_arg,
...
static void MR_CALL 
ml_backend__mlds_to_cs_file__IntroducedFrom__pred__output_static_constructor__392__1_5_p_0(
  MR_Word Stream_8,
...
{
  {
    ...
    ml_backend__mlds_to_target_util__output_n_indents_4_p_0(Stream_8, Var_46);
    {
      ...
      MR_hl_field(MR_mktag(0), Var_49, 1) = ((MR_Box) (ml_backend__mlds_to_cs_file__IntroducedFrom__pred__output_static_constructor__392__1_5_p_0_1));
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), Var_55, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &ml_backend__mlds_to_cs_file_scalar_common_1[13])));
    }
    {
...
{
  {
    ...
    conv0_LambdaHeadVar__2_64 = ml_backend__mlds_to_cs_file__IntroducedFrom__func__output_csharp_src_file__108__1_1_f_0(((MR_Word) (wrapper_arg_1)));
...
{
  {
    ...
    Var_25 = mercury__string__f_43_43_2_f_0((MR_String) "   ", Var_27);
    {
      ...
      MR_hl_field(MR_mktag(1), Var_24, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &ml_backend__mlds_to_cs_file_scalar_common_1[12])));
    }
    {
...
{
  {
    ...
    ml_backend__mlds_to_cs_file__IntroducedFrom__pred__output_static_constructor__392__1_5_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Integer) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))), ((MR_String) (wrapper_arg_1)));
  }
}
...
{
  {
    ...
    ml_backend__mlds_to_cs_file__IntroducedFrom__pred__output_static_constructor__385__1_5_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Integer) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))), ((MR_String) (wrapper_arg_1)));
  }
}
...
{
  {
    ...
    libs__file_util__output_to_file_stream_6_p_0(Globals_10, SourceFileName_12, Var_22, Succeeded_8);
  }
}
