...
{
  {
    ...
    MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), ForeignBodyCode_9, (MR_Integer) 0)));
      ...
      case (MR_Integer) 1:
        {
          ...
          MR_Unsigned packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Info_7, (MR_Integer) 1)));
          MR_Unsigned packed_args_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Info_7, (MR_Integer) 5)));
          ...
          if (((MR_tag((MR_Word) LiteralOrInclude_13)) == (MR_Integer) 1))
          {
            ...
            packed_args_4 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Info_7, (MR_Integer) 5)));
            {
          ...
          packed_args_5 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Info_7, (MR_Integer) 1)));
          Var_41 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Info_7, (MR_Integer) 1))) & (MR_Integer) 1);
          packed_args_6 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Info_7, (MR_Integer) 5)));
...
{
  {
    MR_Word Lang_12 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), DeclCode_9, (MR_Integer) 0))) >> (MR_Integer) 1)) & (MR_Integer) 3);
    ...
    MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), DeclCode_9, (MR_Integer) 0)));
...
{
  {
    ...
    mercury__io__write_string_3_p_0((MR_String) "\n// RttiDefns\n");
    Var_77 = (MR_Integer) ((MR_Unsigned) Indent_8 + (MR_Unsigned) (MR_Integer) 1);
    {
      Var_75 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 6 * sizeof(MR_Word)), NULL, NULL);
      ...
      MR_hl_field(MR_mktag(0), Var_75, 2) = ((MR_Box) (MR_Word) ((MR_Integer) 3));
    ...
    Var_80 = (MR_Integer) ((MR_Unsigned) Indent_8 + (MR_Unsigned) (MR_Integer) 1);
    ...
    Var_115 = (MR_Integer) ((MR_Unsigned) Indent_8 + (MR_Unsigned) (MR_Integer) 1);
    {
      Var_113 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 6 * sizeof(MR_Word)), NULL, NULL);
      ...
      MR_hl_field(MR_mktag(0), Var_113, 2) = ((MR_Box) (MR_Word) ((MR_Integer) 3));
    ...
    Var_122 = (MR_Integer) ((MR_Unsigned) Indent_8 + (MR_Unsigned) (MR_Integer) 1);
    {
    ...
    mercury__io__write_string_3_p_0((MR_String) "\n// ExportDefns\n");
    Var_126 = (MR_Integer) ((MR_Unsigned) Indent_8 + (MR_Unsigned) (MR_Integer) 1);
    ml_backend__mlds_to_cs_export__output_exports_for_csharp_5_p_0(Info_43, Var_126, ExportDefns_40);
    mercury__io__write_string_3_p_0((MR_String) "\n// ExportedEnums\n");
    Var_131 = (MR_Integer) ((MR_Unsigned) Indent_8 + (MR_Unsigned) (MR_Integer) 1);
    ...
    Var_140 = (MR_Integer) ((MR_Unsigned) Indent_8 + (MR_Unsigned) (MR_Integer) 1);
    {
    ...
    {
      StaticCtorCalls_52 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
    ...
    Var_149 = (MR_Integer) ((MR_Unsigned) Indent_8 + (MR_Unsigned) (MR_Integer) 1);
...
{
  {
    ...
    MR_Word Var_33;
    MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Info_10, (MR_Integer) 1)));
    MR_Unsigned packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Info_10, (MR_Integer) 5)));
    ...
    if (succeeded)
    {
      MR_Integer Var_43 = (MR_Integer) ((MR_Unsigned) Indent_11 + (MR_Unsigned) (MR_Integer) 1);
