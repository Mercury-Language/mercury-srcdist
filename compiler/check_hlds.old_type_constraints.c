      ...
      case (MR_Integer) 1:
        {
          ...
          if (succeeded)
          {
            ...
            mercury__set__count_2_p_0(TypeCtorInfo_13_42, B_36, &Var_44);
            succeeded = (C_37 == Var_44);
            if (succeeded)
            {
              Var_39 = (MR_Word) (&check_hlds__old_type_constraints_scalar_common_2[71]);
              TypeCtorInfo_17_43 = (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0);
              Var_40 = mercury__set__to_sorted_list_1_f_0(TypeCtorInfo_17_43, A_35);
              Var_41 = mercury__set__to_sorted_list_1_f_0(TypeCtorInfo_17_43, B_36);
              succeeded = mercury__list__map_corresponding_4_p_1(TypeCtorInfo_17_43, TypeCtorInfo_17_43, TypeCtorInfo_17_43, Var_39, Var_40, Var_41, &Var_38);
            }
          }
        }
        break;
  ...
  PredInfo_13 = ((MR_Word) (conv0_PredInfo_13));
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        TypeCtorInfo_12_53 = (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_type_ctor_0);
        succeeded = mercury__list__member_2_p_0(TypeCtorInfo_12_53, ((MR_Box) (TypeCtor_48)), Var_52);
        succeeded = !(succeeded);
        if (succeeded)
        {
