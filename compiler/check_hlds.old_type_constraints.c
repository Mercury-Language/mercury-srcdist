  ...
  MR_Word * STATE_VARIABLE_Specs_27)
{
  ...
  PredInfo_13 = ((MR_Word) (conv0_PredInfo_13));
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        SpecialPredId_44 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(1), Origin_43, (MR_Integer) 0))) & (MR_Integer) 3);
        TypeCtor_45 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Origin_43, (MR_Integer) 1))));
