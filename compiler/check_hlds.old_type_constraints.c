          ...
          else
          {
            ...
            if (succeeded)
            {
              ...
              if ((Constraints_19 == (MR_Word) ((MR_Unsigned) 0U)))
              {
                ...
                }
                {
                  ...
                  MR_hl_field(MR_mktag(1), Var_89, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &check_hlds__old_type_constraints_scalar_common_1[26])));
                }
                {
            ...
            else
            {
...

              {
                ...
                MR_hl_field(MR_mktag(0), ErrMsg_122, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &check_hlds__old_type_constraints_scalar_common_1[30])));
              }
