...
{
  {
    ...
    else
    {
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(0), ErrMsg_33, 1) = ((MR_Box) (Var_55));
      }
          ...
          else
          {
            ...
            else
            {
...

              {
                ...
                MR_hl_field(MR_mktag(0), ErrMsg_128, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &check_hlds__old_type_constraints_scalar_common_1[66])));
              }
      ...
      case (MR_Integer) 2:
        {
          ...
          if (succeeded)
          {
...

            {
              ...
              MR_hl_field(MR_mktag(0), ErrMsg_142, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &check_hlds__old_type_constraints_scalar_common_1[63])));
            }
...
{
  {
    ...
    else
    {
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(0), ErrMsg_25, 1) = ((MR_Box) (Var_43));
      }
      {
