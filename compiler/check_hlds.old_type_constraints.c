          ...
          case (MR_Integer) 2:
            {
              ...
              parse_tree__prog_out__type_to_debug_string_3_p_0(TVarSet_6, Type_70, &DomainName_54);
            }
            break;
        }
      ...
      case (MR_Integer) 2:
        {
          ...
          parse_tree__prog_out__type_to_debug_string_3_p_0(TVarSet_5, Type_36, &DomainName_20);
        }
        break;
    }
      ...
      case (MR_Integer) 2:
        {
          ...
          mercury__list__map_foldl_5_p_0((MR_Word) (&check_hlds__old_type_constraints_scalar_common_1[1]), (MR_Word) (&check_hlds__old_type_constraints_scalar_common_1[2]), (MR_Word) (&check_hlds__old_type_constraints__check_hlds__old_type_constraints__type_ctor_info_type_constraint_info_0), (MR_Word) (&check_hlds__old_type_constraints_scalar_common_2[41]), ArgVars_53, &ArgTVars_54, ((MR_Box) (STATE_VARIABLE_TCInfo_59_59)), &conv11_STATE_VARIABLE_TCInfo_61_61);
...
{
  {
    ...
    else
    {
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(0), Spec_70, 2) = ((MR_Box) ((MR_Unsigned) 48U));
