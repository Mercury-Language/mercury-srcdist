...
static /* final */ const MR_Box check_hlds__inst_lookup_scalar_common_1[1][2];
          ...
          case (MR_Integer) 4:
            {
              ...
              mercury__map__init_1_p_0((MR_Word) (&check_hlds__inst_lookup_scalar_common_1[0]), (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0), &Subst_44);
              {
              ...
              check_hlds__inst_mode_type_prop__propagate_type_into_inst_5_p_0(ModuleInfo_4, Subst_44, Type_43, Var_46, Inst_6);
            }
            break;
          case (MR_Integer) 5:
            {
              ...
              check_hlds__inst_lookup__inst_lookup_3_p_0(ModuleInfo_4, TypedInstName_45, &Inst0_68);
              mercury__map__init_1_p_0((MR_Word) (&check_hlds__inst_lookup_scalar_common_1[0]), (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0), &Subst_70);
              check_hlds__inst_mode_type_prop__propagate_type_into_inst_5_p_0(ModuleInfo_4, Subst_70, Type_69, Inst0_68, Inst_6);
            }
            break;
        }
        break;
