...
{
  MR_bool succeeded = ((((MR_tag((MR_Word) STATE_VARIABLE_Inst_0_8)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(3, STATE_VARIABLE_Inst_0_8, (MR_Integer) 0)))) == (MR_Integer) 0)));
  MR_Word InstName_6;
  ...
  else
  {
    ...
    succeeded = ((((MR_tag((MR_Word) STATE_VARIABLE_Inst_0_8)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(3, STATE_VARIABLE_Inst_0_8, (MR_Integer) 0)))) == (MR_Integer) 1)));
    if (succeeded)
    {
  ...
  MR_Word * STATE_VARIABLE_Inst_8)
{
  while (MR_TRUE)
  {
    MR_bool succeeded = ((((MR_tag((MR_Word) STATE_VARIABLE_Inst_0_7)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(3, STATE_VARIABLE_Inst_0_7, (MR_Integer) 0)))) == (MR_Integer) 0)));
    MR_Word InstName_6;
        ...
        case (MR_Integer) 4:
          {
            ...
            {
              Inst0_66 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(1, Inst0_66, 0) = (MR_Box) ((MR_Unsigned) (Uniq_65));
              MR_hl_field(1, Inst0_66, 1) = ((MR_Box) ((MR_Unsigned) 0U));
            }
