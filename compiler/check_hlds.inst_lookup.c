          ...
          case (MR_Integer) 0:
            {
              ...
              check_hlds__inst_lookup__inst_lookup_3_p_0(ModuleInfo_4, InstName_6, &STATE_VARIABLE_Inst_1_18);
          ...
          case (MR_Integer) 0:
            {
              ...
              check_hlds__inst_lookup__inst_lookup_3_p_0(ModuleInfo_4, InstName_6, &STATE_VARIABLE_Inst_1_19);
              // direct tailcall eliminated
              ;
