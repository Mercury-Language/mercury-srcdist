  ...
  MR_Word * STATE_VARIABLE_AddrOfMap_50)
{
  ...
  ClassContext_47 = mercury__term_context__dummy_context_0_f_0();
  {
  ...
  else
  {
    ...
    else
    {
...

      {
        ...
        MR_hl_field(MR_mktag(0), Wrapper_35, 0) = ((MR_Box) (FlippedClassName_8));
        MR_hl_field(MR_mktag(0), Wrapper_35, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &ml_backend__mlds_to_java_wrap_scalar_common_2[7])));
      }
