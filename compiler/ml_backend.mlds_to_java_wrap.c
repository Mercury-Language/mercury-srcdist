...
ml_backend__mlds_to_java_wrap__IntroducedFrom__func__generate_call_method__190__1_2_f_0(
...
static /* final */ const MR_Box ml_backend__mlds_to_java_wrap_scalar_common_5[8][1];
...
static /* final */ const MR_Box ml_backend__mlds_to_java_wrap_scalar_common_1[12][2] = {
  ...
  /* row 10 */
  {
    ...
    ((MR_Box) (&ml_backend__mlds_to_java_wrap_scalar_common_5[7]))
  },
  /* row 11 */
  {
    ((MR_Box) ((MR_Unsigned) 8U)),
...
ml_backend__mlds_to_java_wrap__generate_addr_wrapper_class_5_p_0(
  ...
  MR_Word HeadVar__2_2,
  MR_Word * ClassDefn_9,
  MR_Word STATE_VARIABLE_AddrOfMap_0_49,
  MR_Word * STATE_VARIABLE_AddrOfMap_50)
{
  {
    MR_bool succeeded;
    ...
    MR_Word Interface_41;
    MR_Word InterfaceId_44;
    MR_Word ClassImplements_45;
    MR_Word ClassContext_47;
    MR_String Var_52;
    MR_Word Var_86;
    MR_Word Var_97;

    Var_52 = mercury__string__from_int_1_f_0(Arity_7);
    ClassName_11 = mercury__string__f_43_43_2_f_0((MR_String) "addrOf", Var_52);
    ...
    else
    {
      ...
      else
      {
        ...
        IntType_19 = (MR_Word) (MR_mkword(MR_mktag(3), &ml_backend__mlds_to_java_wrap_scalar_common_1[4]));
        {
          ...
          MR_hl_field(MR_mktag(0), FieldVarDefn_22, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &ml_backend__mlds_to_java_wrap_scalar_common_1[7])));
          MR_hl_field(MR_mktag(0), FieldVarDefn_22, 1) = ((MR_Box) (Context_18));
          MR_hl_field(MR_mktag(0), FieldVarDefn_22, 2) = ((MR_Box) (&ml_backend__mlds_to_java_wrap_scalar_common_5[4]));
          MR_hl_field(MR_mktag(0), FieldVarDefn_22, 3) = ((MR_Box) (IntType_19));
          MR_hl_field(MR_mktag(0), FieldVarDefn_22, 4) = ((MR_Box) ((MR_Unsigned) 0U));
          MR_hl_field(MR_mktag(0), FieldVarDefn_22, 5) = ((MR_Box) ((MR_Unsigned) 0U));
        }
        {
          FieldVarDefns_13 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), FieldVarDefns_13, 0) = ((MR_Box) (FieldVarDefn_22));
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(0), QualClassName_23, 0) = ((MR_Box) (MLDS_ModuleName_6));
          MR_hl_field(MR_mktag(0), QualClassName_23, 1) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 0));
          MR_hl_field(MR_mktag(0), QualClassName_23, 2) = ((MR_Box) (ClassName_11));
        }
        {
          Var_63 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), Var_63, 0) = ((MR_Box) (QualClassName_23));
          MR_hl_field(MR_mktag(0), Var_63, 1) = ((MR_Box) ((MR_Integer) 0));
          MR_hl_field(MR_mktag(0), Var_63, 2) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 0));
        }
        ClassType_24 = (MR_Word) (MR_mkword(MR_mktag(1), (MR_Word) (Var_63)));
        {
          FieldName_25 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), FieldName_25, 0) = ((MR_Box) (MLDS_ModuleName_6));
          MR_hl_field(MR_mktag(0), FieldName_25, 1) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 1));
          MR_hl_field(MR_mktag(0), FieldName_25, 2) = ((MR_Box) ((MR_Unsigned) 8U));
        }
        {
          FieldId_26 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), FieldId_26, 0) = ((MR_Box) (FieldName_25));
          MR_hl_field(MR_mktag(1), FieldId_26, 1) = ((MR_Box) (ClassType_24));
        }
        {
          ...
          MR_hl_field(MR_mktag(3), Var_69, 1) = ((MR_Box) (ClassType_24));
        }
        {
          FieldLval_27 = (MR_Word) MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), FieldLval_27, 0) = ((MR_Box) ((MR_Unsigned) 0U));
          MR_hl_field(MR_mktag(0), FieldLval_27, 1) = ((MR_Box) (Var_69));
          MR_hl_field(MR_mktag(0), FieldLval_27, 2) = ((MR_Box) (ClassType_24));
          MR_hl_field(MR_mktag(0), FieldLval_27, 3) = ((MR_Box) (FieldId_26));
          MR_hl_field(MR_mktag(0), FieldLval_27, 4) = ((MR_Box) (IntType_19));
        }
        {
          Var_73 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(2), Var_73, 0) = ((MR_Box) (FieldLval_27));
          MR_hl_field(MR_mktag(2), Var_73, 1) = ((MR_Box) (MR_mkword(MR_mktag(2), &ml_backend__mlds_to_java_wrap_scalar_common_5[1])));
        }
        {
          CtorStmt_32 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(3), CtorStmt_32, 0) = ((MR_Box) ((MR_Unsigned) 8U));
          MR_hl_field(MR_mktag(3), CtorStmt_32, 1) = ((MR_Box) (Var_73));
          MR_hl_field(MR_mktag(3), CtorStmt_32, 2) = ((MR_Box) (Context_18));
        }
        EnvVarNames_36 = mercury__set__init_0_f_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0));
        {
          ...
          MR_hl_field(MR_mktag(1), Var_78, 0) = ((MR_Box) (CtorStmt_32));
        }
        {
          CtorDefn_37 = (MR_Word) MR_new_object(MR_Word, (8 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), CtorDefn_37, 0) = ((MR_Box) (MR_mkword(MR_mktag(1), &ml_backend__mlds_to_java_wrap_scalar_common_5[5])));
          MR_hl_field(MR_mktag(0), CtorDefn_37, 1) = ((MR_Box) (Context_18));
          MR_hl_field(MR_mktag(0), CtorDefn_37, 2) = ((MR_Box) (&ml_backend__mlds_to_java_wrap_scalar_common_5[2]));
          MR_hl_field(MR_mktag(0), CtorDefn_37, 3) = ((MR_Box) ((MR_Unsigned) 0U));
          MR_hl_field(MR_mktag(0), CtorDefn_37, 4) = ((MR_Box) (&ml_backend__mlds_to_java_wrap_scalar_common_1[9]));
          MR_hl_field(MR_mktag(0), CtorDefn_37, 5) = ((MR_Box) (Var_78));
          MR_hl_field(MR_mktag(0), CtorDefn_37, 6) = ((MR_Box) (EnvVarNames_36));
          MR_hl_field(MR_mktag(0), CtorDefn_37, 7) = ((MR_Box) ((MR_Unsigned) 0U));
        }
        {
          CtorDefns_14 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), CtorDefns_14, 0) = ((MR_Box) (CtorDefn_37));
    ...
    if (succeeded)
    {
      ...
      InterfaceName_39 = mercury__string__f_43_43_2_f_0((MR_String) "MethodPtr", Var_85);
    }
    else
      InterfaceName_39 = (MR_String) "MethodPtrN";
    Var_86 = parse_tree__java_names__java_mercury_runtime_package_name_0_f_0();
    InterfaceModuleName_40 = ml_backend__mlds__mercury_module_name_to_mlds_1_f_0(Var_86);
    {
      Interface_41 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), Interface_41, 0) = ((MR_Box) (InterfaceModuleName_40));
      MR_hl_field(MR_mktag(0), Interface_41, 1) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 0));
      MR_hl_field(MR_mktag(0), Interface_41, 2) = ((MR_Box) (InterfaceName_39));
    }
    {
      InterfaceId_44 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), InterfaceId_44, 0) = ((MR_Box) (Interface_41));
      MR_hl_field(MR_mktag(0), InterfaceId_44, 1) = ((MR_Box) ((MR_Integer) 0));
      MR_hl_field(MR_mktag(0), InterfaceId_44, 2) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 1));
    }
    {
      ClassImplements_45 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), ClassImplements_45, 0) = ((MR_Box) (InterfaceId_44));
      MR_hl_field(MR_mktag(1), ClassImplements_45, 1) = ((MR_Box) ((MR_Unsigned) 0U));
    }
    ClassContext_47 = mercury__term__context_init_0_f_0();
    {
      Var_97 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), Var_97, 0) = ((MR_Box) (MethodDefn_38));
    ...
    }
    {
      ...
      *ClassDefn_9 = base;
      ...
      MR_hl_field(MR_mktag(0), base, 2) = ((MR_Box) (ClassContext_47));
      MR_hl_field(MR_mktag(0), base, 3) = ((MR_Box) (&ml_backend__mlds_to_java_wrap_scalar_common_5[6]));
      ...
      MR_hl_field(MR_mktag(0), base, 7) = ((MR_Box) (ClassImplements_45));
    ...
    ml_backend__mlds_to_java_wrap__add_to_address_map_4_p_0(ClassName_11, CodeAddrs_8, STATE_VARIABLE_AddrOfMap_0_49, STATE_VARIABLE_AddrOfMap_50);
  }
}
    ...
    else
    {
      ...
      else
      {
...

        {
          ...
          MR_hl_field(MR_mktag(0), Wrapper_38, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &ml_backend__mlds_to_java_wrap_scalar_common_5[3])));
        }
...
{
  {
    ...
    conv3_LambdaHeadVar__3_56 = ml_backend__mlds_to_java_wrap__IntroducedFrom__func__generate_call_method__190__1_2_f_0(((MR_Integer) (wrapper_arg_1)), ((MR_Word) (wrapper_arg_2)));
...
{
  {
    ...
    {
      MR_Word Var_95 = ((MR_Word) ((MR_hl_field(MR_mktag(1), CodeAddrStmts_13, (MR_Integer) 1))));
      MR_Word Var_96 = ((MR_Word) ((MR_hl_field(MR_mktag(1), CodeAddrStmts_13, (MR_Integer) 0))));
    ...
    {
      Var_78 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), Var_78, 0) = ((MR_Box) (Stmt_15));
    }
    {
      MR_Word base;
      ...
      *MethodDefn_6 = base;
      ...
      MR_hl_field(MR_mktag(0), base, 2) = ((MR_Box) (&ml_backend__mlds_to_java_wrap_scalar_common_5[2]));
