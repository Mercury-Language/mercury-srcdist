...
static /* final */ const MR_Box ml_backend__mlds_to_java_wrap_scalar_common_5[6][1];
...
static /* final */ const MR_Box ml_backend__mlds_to_java_wrap_scalar_common_1[12][2] = {
  ...
  /* row 10 */
  {
    ...
    ((MR_Box) (&ml_backend__mlds_to_java_wrap_scalar_common_5[5]))
  },
  /* row 11 */
  {
    ((MR_Box) (MR_Word) ((MR_Integer) 8)),
...
static /* final */ const MR_Box ml_backend__mlds_to_java_wrap_scalar_common_5[6][1] = {
  ...
  /* row 4 */
  {
    (MR_Box) (((MR_Unsigned) (((MR_Box) ((MR_Integer) 1))) | (((((MR_Unsigned) (((MR_Box) ((MR_Integer) 1))) << (MR_Integer) 1)) | (((MR_Unsigned) (((MR_Box) ((MR_Integer) 1))) << (MR_Integer) 2))))))
  },
  /* row 5 */
  {
    ((MR_Box) ((MR_Integer) 2))
...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(0), LambdaHeadVar__3_55, 1) = ((MR_Box) ((MR_Integer) 0));
...
{
  {
...

    {
      ...
      MR_hl_field(MR_mktag(3), Var_8, 2) = ((MR_Box) ((MR_Integer) 24));
    }
    {
...
{
  {
    ...
    if (((MR_tag((MR_Word) InputArgs_4)) == (MR_Integer) 1))
    {
      ...
      ml_backend__mlds_to_java_wrap__generate_call_method_args_from_array_5_p_0(OrigArgTypes_9, ArrayVarName_13, (MR_Integer) 0, (MR_Word) ((MR_Integer) 0), &CallArgs_12);
    }
    else
    {
    ...
    if ((OrigRetTypes_10 == (MR_Word) ((MR_Integer) 0)))
      ReturnVarType_15 = (MR_Word) ((MR_Integer) 24);
    else
    {
    ...
    Context_21 = mercury__term__context_init_0_f_0();
    {
      ...
      MR_hl_field(MR_mktag(0), ReturnVarDefn_23, 3) = ((MR_Box) ((MR_Integer) 0));
      MR_hl_field(MR_mktag(0), ReturnVarDefn_23, 4) = ((MR_Box) ((MR_Integer) 0));
    }
    ...
    if ((OrigRetTypes_10 == (MR_Word) ((MR_Integer) 0)))
      CallRetLvals_25 = (MR_Word) ((MR_Integer) 0);
    else
    {
      {
        ...
        MR_hl_field(MR_mktag(1), CallRetLvals_25, 1) = ((MR_Box) ((MR_Integer) 0));
      }
    }
    {
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
...

      {
        ...
        MR_hl_field(MR_mktag(3), Var_21, 2) = ((MR_Box) ((MR_Integer) 8));
      }
      {
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(3), Rval_18, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 6));
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(3), UnBoxedRval_19, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 3));
...
{
  {
    ...
    if ((CodeAddrs_8 == (MR_Word) ((MR_Integer) 0)))
    {
      {
    ...
    else
    {
      ...
      if ((Var_101 == (MR_Word) ((MR_Integer) 0)))
      {
        FieldVarDefns_13 = (MR_Word) ((MR_Integer) 0);
        CtorDefns_14 = (MR_Word) ((MR_Integer) 0);
      }
      else
      {
        MR_Word Context_18;
        ...
        Var_54 = ml_backend__ml_type_gen__ml_gen_const_member_data_decl_flags_0_f_0();
        {
          ...
          MR_hl_field(MR_mktag(0), FieldVarDefn_20, 3) = ((MR_Box) ((MR_Integer) 8));
          MR_hl_field(MR_mktag(0), FieldVarDefn_20, 4) = ((MR_Box) ((MR_Integer) 0));
          MR_hl_field(MR_mktag(0), FieldVarDefn_20, 5) = ((MR_Box) ((MR_Integer) 0));
        }
        {
          ...
          MR_hl_field(MR_mktag(1), FieldVarDefns_13, 1) = ((MR_Box) ((MR_Integer) 0));
        }
        {
        ...
        ClassType_22 = (MR_Word) (MR_mkword(MR_mktag(1), (MR_Word) (Var_60)));
        {
          ...
          MR_hl_field(MR_mktag(0), FieldName_23, 2) = ((MR_Box) ((MR_Integer) 8));
        }
        {
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(0), FieldLval_25, 0) = ((MR_Box) ((MR_Integer) 0));
          ...
          MR_hl_field(MR_mktag(0), FieldLval_25, 4) = ((MR_Box) ((MR_Integer) 8));
        }
        {
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(0), CtorDefn_35, 2) = ((MR_Box) (&ml_backend__mlds_to_java_wrap_scalar_common_1[8]));
          MR_hl_field(MR_mktag(0), CtorDefn_35, 3) = ((MR_Box) ((MR_Integer) 0));
          MR_hl_field(MR_mktag(0), CtorDefn_35, 4) = ((MR_Box) (&ml_backend__mlds_to_java_wrap_scalar_common_1[9]));
          MR_hl_field(MR_mktag(0), CtorDefn_35, 5) = ((MR_Box) (Var_78));
          MR_hl_field(MR_mktag(0), CtorDefn_35, 6) = ((MR_Box) (EnvVarNames_34));
          MR_hl_field(MR_mktag(0), CtorDefn_35, 7) = ((MR_Box) ((MR_Integer) 0));
        }
        {
          ...
          MR_hl_field(MR_mktag(1), CtorDefns_14, 1) = ((MR_Box) ((MR_Integer) 0));
        }
      }
    }
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), ClassImplements_43, 1) = ((MR_Box) ((MR_Integer) 0));
    }
    ClassContext_45 = mercury__term__context_init_0_f_0();
    {
      ...
      MR_hl_field(MR_mktag(1), Var_97, 1) = ((MR_Box) ((MR_Integer) 0));
    }
    {
      MR_Word base;
      ...
      *ClassDefn_9 = base;
      ...
      MR_hl_field(MR_mktag(0), base, 3) = ((MR_Box) (&ml_backend__mlds_to_java_wrap_scalar_common_5[4]));
...
{
  {
    ...
    if ((CodeAddrs_6 == (MR_Word) ((MR_Integer) 0)))
    {
      {
    ...
    else
    {
      ...
      if ((Var_26 == (MR_Word) ((MR_Integer) 0)))
      {
        MR_Word Wrapper_10;

        {
          ...
          MR_hl_field(MR_mktag(0), Wrapper_10, 1) = ((MR_Box) ((MR_Integer) 0));
        }
...
{
  {
    ...
    if ((CodeAddrStmts_13 == (MR_Word) ((MR_Integer) 0)))
    {
      {
    ...
    else
    {
      ...
      if ((Var_93 == (MR_Word) ((MR_Integer) 0)))
        Stmt_15 = Var_94;
      else
      {
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(3), Stmt_15, 1) = ((MR_Box) ((MR_Integer) 8));
          ...
          MR_hl_field(MR_mktag(3), Stmt_15, 5) = ((MR_Box) ((MR_Integer) 0));
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(0), FuncLabel_33, 1) = ((MR_Box) ((MR_Integer) 0));
    }
    {
