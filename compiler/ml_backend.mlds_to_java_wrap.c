  ...
  MR_Word * STATE_VARIABLE_AddrOfMap_50)
{
  ...
  {
    MR_Word Var_100 = ((MR_Word) ((MR_hl_field(1, CodeAddrs_8, (MR_Integer) 1))));
    ...
    else
    {
      ...
      }
      {
        ...
        MR_hl_field(0, Var_66, 0) = ((MR_Box) (QualClassName_23));
        MR_hl_field(0, Var_66, 1) = ((MR_Box) ((MR_Integer) 0));
        MR_hl_field(0, Var_66, 2) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 0));
      }
      ClassType_24 = (MR_Word) (MR_mkword(1, (MR_Word) (Var_66)));
      {
      ...
      }
      {
        ...
        MR_hl_field(2, Var_76, 0) = ((MR_Box) (FieldLval_27));
        MR_hl_field(2, Var_76, 1) = ((MR_Box) (MR_mkword(2, &ml_backend__mlds_to_java_wrap_scalar_common_2[1])));
      }
      {
        ...
        MR_hl_field(3, CtorStmt_32, 1) = ((MR_Box) (Var_76));
      ...
      EnvVarNames_36 = mercury__set__init_0_f_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0));
      {
        ...
        MR_hl_field(1, Var_81, 0) = ((MR_Box) (CtorStmt_32));
      }
      {
        ...
        MR_hl_field(0, CtorDefn_37, 5) = ((MR_Box) (Var_81));
  ...
  InterfaceModuleName_40 = ml_backend__mlds__mercury_module_name_to_mlds_1_f_0(Var_86);
  {
    ...
    MR_hl_field(0, Interface_41, 0) = ((MR_Box) (InterfaceModuleName_40));
    MR_hl_field(0, Interface_41, 1) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 0));
    MR_hl_field(0, Interface_41, 2) = ((MR_Box) (InterfaceName_39));
  }
  {
    InterfaceId_44 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(0, InterfaceId_44, 0) = ((MR_Box) (Interface_41));
    MR_hl_field(0, InterfaceId_44, 1) = ((MR_Box) ((MR_Integer) 0));
    MR_hl_field(0, InterfaceId_44, 2) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 1));
  }
  {
    ClassImplements_45 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(1, ClassImplements_45, 0) = ((MR_Box) (InterfaceId_44));
    MR_hl_field(1, ClassImplements_45, 1) = ((MR_Box) ((MR_Unsigned) 0U));
  }
  ClassContext_47 = mercury__term_context__dummy_context_0_f_0();
  {
    Var_97 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(1, Var_97, 0) = ((MR_Box) (MethodDefn_38));
  ...
  }
  {
    ...
    *ClassDefn_9 = base;
    ...
    MR_hl_field(0, base, 2) = ((MR_Box) (ClassContext_47));
    ...
    MR_hl_field(0, base, 7) = ((MR_Box) (ClassImplements_45));
    MR_hl_field(0, base, 8) = ((MR_Box) ((MR_Unsigned) 0U));
    MR_hl_field(0, base, 9) = ((MR_Box) (FieldVarDefns_13));
    MR_hl_field(0, base, 10) = ((MR_Box) ((MR_Unsigned) 0U));
    MR_hl_field(0, base, 11) = ((MR_Box) (Var_97));
    MR_hl_field(0, base, 12) = ((MR_Box) (CtorDefns_14));
  }
