      ...
      case (MR_Integer) 1:
        {
          ...
          hlds__hlds_pred__pred_info_get_context_2_p_0(PredInfo_7, &Context_14);
          {
            ...
            MR_hl_field(0, Spec_15, 1) = ((MR_Box) (MR_mkword(1, &check_hlds__typecheck_error_undef_scalar_common_2[1])));
  ...
  MR_Word * Spec_12)
{
  ...
  if ((OtherConsFuncArities_29 == (MR_Word) ((MR_Unsigned) 0U)))
  {
    ...
    else
    {
      ...
      if (succeeded)
        check_hlds__typecheck_error_undef__maybe_report_missing_import_addendum_4_p_0(ClauseContext_7, (MR_Word) (&check_hlds__typecheck_error_undef_scalar_common_2[2]), &AddeddumPieces_39, &MissingImportModules_40);
      else
      {
        MR_String Var_97;
