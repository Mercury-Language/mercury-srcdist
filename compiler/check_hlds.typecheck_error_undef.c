  ...
  MR_Word PredInfo_7)
{
  ...
  if (!(succeeded))
  {
    succeeded = hlds__hlds_markers__marker_is_present_2_p_0(PredMarkers_48, (MR_Integer) 30);
    if (!(succeeded))
    {
  ...
  else
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_10, (MR_Integer) 172, &WarnStubs_11);
    switch (WarnStubs_11) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        Specs_8 = (MR_Word) ((MR_Unsigned) 0U);
  ...
  MR_Word * Spec_12)
{
  ...
  succeeded = hlds__hlds_markers__marker_is_present_2_p_0(PredMarkers_59, (MR_Integer) 14);
  if (succeeded)
