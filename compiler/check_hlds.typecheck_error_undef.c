...
static /* final */ const MR_Box check_hlds__typecheck_error_undef_scalar_common_1[410][2] = {
  ...
  /* row 403 */
  {
    ((MR_Box) (MR_mkword(2, &check_hlds__typecheck_error_undef_scalar_common_1[402]))),
    ((MR_Box) ((MR_Unsigned) 0U))
  },
  /* row 404 */
  {
                ...
                ;
                {
                  ...
                  }
                  {
                    ...
                    *Components_6 = base;
                    ...
                    MR_hl_field(1, base, 1) = ((MR_Box) (MR_mkword(1, &check_hlds__typecheck_error_undef_scalar_common_1[403])));
                  }
                  succeeded = MR_TRUE;
                }
              }
            ...
            case (MR_Integer) 21:
              {
                // case ":-"
                ;
                *Components_6 = (MR_Word) (MR_mkword(1, &check_hlds__typecheck_error_undef_scalar_common_1[404]));
                succeeded = MR_TRUE;
              }
              break;
            case (MR_Integer) 27:
