...
static void MR_CALL 
check_hlds__typecheck_error_undef__IntroducedFrom__pred__arity_error_to_pieces__1064__1_2_p_0(
  MR_Integer LambdaHeadVar__1_16,
  MR_Integer * LambdaHeadVar__2_17);

static MR_Word MR_CALL 
check_hlds__typecheck_error_undef__IntroducedFrom__func__maybe_report_missing_import_addendum__999__1_2_f_0(
  MR_Word ModuleQualifierList_16,
  MR_Word LambdaHeadVar__1_36);

static MR_Word MR_CALL 
check_hlds__typecheck_error_undef__IntroducedFrom__func__report_any_missing_module_qualifiers__949__1_1_f_0(
  MR_Word LambdaHeadVar__1_58);

static MR_bool MR_CALL 
check_hlds__typecheck_error_undef__IntroducedFrom__pred__report_error_undef_cons_std__590__1_2_p_0(
  MR_Integer Arity_13,
  MR_Integer FunctorArity_23);

static MR_bool MR_CALL 
check_hlds__typecheck_error_undef__IntroducedFrom__pred__report_error_undef_cons__445__1_2_p_0(
  MR_Integer Arity_13,
  MR_Integer FunctorArity_47);

static MR_bool MR_CALL 
check_hlds__typecheck_error_undef__IntroducedFrom__pred__report_error_undef_cons__436__1_2_p_0(
  MR_Integer Arity_13,
...
struct check_hlds__typecheck_error_undef__vector_common_type_9_0_s {
  const MR_String check_hlds__typecheck_error_undef__vector_common_type_9_0__vct_9_f_0;
};

static /* final */ const struct check_hlds__typecheck_error_undef__vector_common_type_9_0_s check_hlds__typecheck_error_undef_vector_common_9[96];
...
static /* final */ const MR_Box check_hlds__typecheck_error_undef_scalar_common_1[344][2] = {
  ...
  /* row  72 */
  {
    ...
    ((MR_Box) (MR_mkword(1, &check_hlds__typecheck_error_undef_scalar_common_1[70])))
  },
  /* row  73 */
  {
    ((MR_Box) (MR_Word) ((MR_Unsigned) 6U)),
  ...
  /* row 117 */
  {
    ((MR_Box) (MR_mkword(3, &check_hlds__typecheck_error_undef_scalar_common_1[116]))),
...
static /* final */ const MR_Box check_hlds__typecheck_error_undef_scalar_common_2[20][1] = {
  ...
  /* row   5 */
  { ((MR_Box) (MR_mkword(1, &check_hlds__typecheck_error_undef_scalar_common_1[42]))) },
  /* row   6 */
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = check_hlds__typecheck_error_undef__IntroducedFrom__pred__report_error_undef_cons__445__1_2_p_0(((MR_Integer) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Integer) ((MR_hl_field(0, closure, (MR_Integer) 4)))));
  return succeeded;
}
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = check_hlds__typecheck_error_undef__IntroducedFrom__pred__report_error_undef_cons__436__1_2_p_0(((MR_Integer) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Integer) ((MR_hl_field(0, closure, (MR_Integer) 4)))));
  return succeeded;
}
  ...
  MR_Integer Arity_13)
{
  ...
  if (succeeded)
  {
    ...
    if (succeeded)
    {
      ...
      ;
      str_1 = ((&check_hlds__typecheck_error_undef_vector_common_9[32 + slot_0]))->check_hlds__typecheck_error_undef__vector_common_type_9_0__vct_9_f_0;
      // did we find a match?
      ;
  ...
  if (succeeded)
  {
    ...
    }
    {
      ...
      MR_hl_field(1, MainPieces_53, 0) = ((MR_Box) (MR_mkword(3, &check_hlds__typecheck_error_undef_scalar_common_1[81])));
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = check_hlds__typecheck_error_undef__IntroducedFrom__pred__report_error_undef_cons_std__590__1_2_p_0(((MR_Integer) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Integer) ((MR_hl_field(0, closure, (MR_Integer) 4)))));
  return succeeded;
}
    ...
    if (succeeded)
    {
      FunctorName_43 = ((MR_Word) ((MR_hl_field(3, Functor_12, (MR_Integer) 1))));
      {
        ...
        hlds__hlds_cons__return_cons_defns_with_given_name_3_p_0(ConsTable_20, BaseName_46, &ConsDefns_47);
        {
          ...
          MR_hl_field(0, Var_91, 0) = ((MR_Box) (&check_hlds__typecheck_error_undef_scalar_common_7[1]));
  ...
  MR_Word * Components_3)
{
  ...
  MR_String str_1 = ((&check_hlds__typecheck_error_undef_vector_common_9[0 + slot_0]))->check_hlds__typecheck_error_undef__vector_common_type_9_0__vct_9_f_0;
      ...
      case (MR_Integer) 13:
        {
          ...
          if (succeeded)
          {
            *Components_3 = (MR_Word) (MR_mkword(1, &check_hlds__typecheck_error_undef_scalar_common_1[313]));
            succeeded = MR_TRUE;
          }
        }
        break;
  ...
  MR_Word AddeddumPieces_13)
{
  ...
  hlds__pred_table__predicate_table_lookup_pf_raw_name_4_p_0(PredicateTable_10, (MR_Integer) 0, Var_73, &PredIds_72);
  {
    ...
    MR_hl_field(0, Var_74, 0) = ((MR_Box) (&check_hlds__typecheck_error_undef_scalar_common_6[0]));
  ...
  if (succeeded)
  {
    ...
    mercury__list__foldl_4_p_0((MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_info_0), (MR_Word) (&check_hlds__typecheck_error_undef_scalar_common_1[4]), (MR_Word) (&check_hlds__typecheck_error_undef_scalar_common_8[0]), PredInfos_79, ((MR_Box) ((MR_Unsigned) 0U)), &conv3_KnownNames0_80);
  ...
  MR_Box wrapper_arg_1)
{
  ...
  conv0_LambdaHeadVar__2_59 = check_hlds__typecheck_error_undef__IntroducedFrom__func__report_any_missing_module_qualifiers__949__1_1_f_0(((MR_Word) (wrapper_arg_1)));
  ...
  MR_Word ModuleNamesSet0_9)
{
  ...
  else
  {
    ...
    if ((TailModuleNames_17 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      ...
      {
        Var_34 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(1, Var_34, 0) = ((MR_Box) (MR_mkword(3, &check_hlds__typecheck_error_undef_scalar_common_1[87])));
          ...
          else
          {
            ...
            if (succeeded)
            {
              ...
              }
              {
                ...
                MR_hl_field(1, Var_157, 1) = ((MR_Box) (MR_mkword(1, &check_hlds__typecheck_error_undef_scalar_common_1[64])));
              }
              {
                MainPieces_215 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(1, MainPieces_215, 0) = ((MR_Box) (MR_mkword(3, &check_hlds__typecheck_error_undef_scalar_common_1[19])));
              ...
              }
              {
                ...
                MR_hl_field(1, Var_171, 1) = ((MR_Box) (MR_mkword(1, &check_hlds__typecheck_error_undef_scalar_common_1[321])));
              }
              {
                MR_Word base;
              ...
              else
              {
                ...
                if (succeeded)
                {
                  ...
                  }
                  {
                    ...
                    MR_hl_field(1, Var_202, 1) = ((MR_Box) (MR_mkword(1, &check_hlds__typecheck_error_undef_scalar_common_1[13])));
                  }
                  {
                    Var_199 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(1, Var_199, 0) = ((MR_Box) (MR_mkword(3, &check_hlds__typecheck_error_undef_scalar_common_1[76])));
                  ...
                  }
                  {
                    ...
                    MR_hl_field(1, Var_194, 0) = ((MR_Box) (MR_mkword(3, &check_hlds__typecheck_error_undef_scalar_common_1[75])));
                  ...
                  }
                  {
                    ...
                    MR_hl_field(1, GetoptPieces_27, 0) = ((MR_Box) (MR_mkword(3, &check_hlds__typecheck_error_undef_scalar_common_1[22])));
  ...
  MR_Box wrapper_arg_1)
{
  ...
  conv2_LambdaHeadVar__2_37 = check_hlds__typecheck_error_undef__IntroducedFrom__func__maybe_report_missing_import_addendum__999__1_2_f_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) (wrapper_arg_1)));
  ...
  MR_Box * wrapper_arg_2)
{
  ...
  check_hlds__typecheck_error_undef__IntroducedFrom__pred__arity_error_to_pieces__1064__1_2_p_0(((MR_Integer) (wrapper_arg_1)), &conv1_LambdaHeadVar__2_17);
  ...
  else
  {
    ...
    else
    {
      ...
      else
      {
        ...
        {
          Var_18 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(1, Var_18, 0) = ((MR_Box) (MR_mkword(3, &check_hlds__typecheck_error_undef_scalar_common_1[111])));
