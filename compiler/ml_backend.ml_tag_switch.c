...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(3), PtagRval_20, 1) = ((MR_Box) ((MR_Integer) 0));
      ...
      case (MR_Integer) 3:
        {
          ...
          if (succeeded)
          {
            succeeded = ((MR_tag((MR_Word) GroupedGoalList_37)) == (MR_Integer) 1);
            if (succeeded)
            {
        ...
        {
          {
            ...
            MR_hl_field(MR_mktag(3), StagRval_25, 1) = ((MR_Box) ((MR_Integer) 12));
