...
{
  {
    ...
    else
    {
      ...
      {
        mercury__builtin__compare_3_p_0((MR_Word) (&ml_backend__ml_tag_switch_scalar_common_2[2]), HeadVar__1_1, ((MR_Box) (ArgX2_7)), ((MR_Box) (ArgY2_8)));
      }
    }
  }
}
...
{
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        TypeInfo_9_9 = (MR_Word) (&ml_backend__ml_tag_switch_scalar_common_2[2]);
