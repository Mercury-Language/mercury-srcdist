...
{
  {
    ...
    mercury__map__to_assoc_list_2_p_0(TypeCtorInfo_67_67, (MR_Word) &hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_case_id_0, GoalMap_23, &GoalList_27);
      ...
      case (MR_Integer) 3:
        {
          ...
          TypeCtorInfo_7_82 = (MR_Word) &hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_case_id_0;
          TypeCtorInfo_8_83 = (MR_Word) &ml_backend__ml_tag_switch__ml_backend__ml_tag_switch__type_ctor_info_stags_0;
          Var_81 = mercury__map__init_0_f_0(TypeCtorInfo_7_82, TypeCtorInfo_8_83);
          ml_backend__ml_tag_switch__build_stag_rev_map_3_p_0(GoalList_27, Var_81, &RevMap_80);
          mercury__map__to_assoc_list_2_p_0(TypeCtorInfo_7_82, TypeCtorInfo_8_83, RevMap_80, &GroupedGoalList_37);
    ...
    OtherPtagMatches_40 = mercury__list__map_2_f_0(TypeCtorInfo_67_67, (MR_Word) &ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_case_match_cond_0, (MR_Word) &ml_backend__ml_tag_switch_scalar_common_1[5], OtherPtags_21);
    {
      MR_Word base;
...
{
  {
        ...
        {
          {
            ...
            MR_hl_field(MR_mktag(3), StagRval_25, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 2));
            MR_hl_field(MR_mktag(3), StagRval_25, 1) = ((MR_Box) (MR_mkword(MR_mktag(3), &ml_backend__ml_tag_switch_scalar_common_4[0])));
    ...
    ml_backend__ml_tag_switch__gen_stag_cases_6_p_0(Cases_12, CodeMap_13, CodeModel_17, &StagCases0_26, STATE_VARIABLE_Info_0_31, &STATE_VARIABLE_Info_37_37);
    ...
    ml_backend__ml_switch_gen__ml_switch_generate_default_6_p_0(CanFail_18, CodeModel_17, Context_19, &Default_28, STATE_VARIABLE_Info_37_37, &STATE_VARIABLE_Info_38_38);
    {
    ...
    ml_backend__ml_simplify_switch__ml_simplify_switch_4_p_0(SwitchStmt_30, Stmt_20, STATE_VARIABLE_Info_38_38, STATE_VARIABLE_Info_32);
  }
}
