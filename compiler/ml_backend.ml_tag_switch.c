...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(3), ml_backend__ml_tag_switch__Var_4, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 0));
...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(3), ml_backend__ml_tag_switch__Var_89, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 0));
    ...
    if ((ml_backend__ml_tag_switch__HeadVar__1_1 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
    ...
    else
      {
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(3), ml_backend__ml_tag_switch__Var_45, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 0));
