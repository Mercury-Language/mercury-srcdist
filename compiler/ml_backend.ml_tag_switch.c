  ...
  MR_Word * STATE_VARIABLE_Info_30)
{
  ...
  if (succeeded)
  {
    ...
    ml_backend__ml_tag_switch__gen_ptag_cases_12_p_0(Var_11, VarEntry_12, CanFail_15, CodeModel_14, Context_16, CodeMap_22, PtagCaseGroups_25, &MLDS_Cases0_57, ReachableConstVarMaps0_23, &ReachableConstVarMaps_58, STATE_VARIABLE_Info_35_35, &STATE_VARIABLE_Info_37_65);
