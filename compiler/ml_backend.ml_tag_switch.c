...
ml_backend__ml_tag_switch__gen_stag_switch_11_p_0(
  ...
  MR_Word * ml_backend__ml_tag_switch__Stmt_20,
...
ml_backend__ml_tag_switch__lookup_code_map_6_p_0(
  ...
  MR_Word * ml_backend__ml_tag_switch__Stmt_10,
...
{
  {
    ...
    {
      MR_Integer ml_backend__ml_tag_switch__ArgX1_4 = ((MR_Integer) (MR_hl_field(MR_mktag(0), ml_backend__ml_tag_switch__HeadVar__2_2, (MR_Integer) 0)));
      MR_Integer ml_backend__ml_tag_switch__ArgY1_5 = ((MR_Integer) (MR_hl_field(MR_mktag(0), ml_backend__ml_tag_switch__HeadVar__3_3, (MR_Integer) 0)));
      MR_Word ml_backend__ml_tag_switch__ArgX2_6 = ((MR_Word) (MR_hl_field(MR_mktag(0), ml_backend__ml_tag_switch__HeadVar__2_2, (MR_Integer) 1)));
      MR_Word ml_backend__ml_tag_switch__ArgY2_7 = ((MR_Word) (MR_hl_field(MR_mktag(0), ml_backend__ml_tag_switch__HeadVar__3_3, (MR_Integer) 1)));
      MR_Word ml_backend__ml_tag_switch__Var_8;

      mercury__private_builtin__builtin_compare_int_3_p_0(&ml_backend__ml_tag_switch__Var_8, ml_backend__ml_tag_switch__ArgX1_4, ml_backend__ml_tag_switch__ArgY1_5);
      ml_backend__ml_tag_switch__succeeded = (ml_backend__ml_tag_switch__Var_8 == (MR_Integer) 0);
      ml_backend__ml_tag_switch__succeeded = !(ml_backend__ml_tag_switch__succeeded);
      if (ml_backend__ml_tag_switch__succeeded)
        *ml_backend__ml_tag_switch__HeadVar__1_1 = ml_backend__ml_tag_switch__Var_8;
      else
      {
        mercury__builtin__compare_3_p_0((MR_Word) &ml_backend__ml_tag_switch_scalar_common_2[1], ml_backend__ml_tag_switch__HeadVar__1_1, ((MR_Box) (ml_backend__ml_tag_switch__ArgX2_6)), ((MR_Box) (ml_backend__ml_tag_switch__ArgY2_7)));
      }
    }
  }
}
...
{
  {
    ...
    else
    {
      ...
      MR_Integer ml_backend__ml_tag_switch__ArgX1_3 = ((MR_Integer) (MR_hl_field(MR_mktag(0), ml_backend__ml_tag_switch__HeadVar__1_1, (MR_Integer) 0)));
      MR_Integer ml_backend__ml_tag_switch__ArgY1_4 = ((MR_Integer) (MR_hl_field(MR_mktag(0), ml_backend__ml_tag_switch__HeadVar__2_2, (MR_Integer) 0)));
      MR_Word ml_backend__ml_tag_switch__ArgX2_5 = ((MR_Word) (MR_hl_field(MR_mktag(0), ml_backend__ml_tag_switch__HeadVar__1_1, (MR_Integer) 1)));
      MR_Word ml_backend__ml_tag_switch__ArgY2_6 = ((MR_Word) (MR_hl_field(MR_mktag(0), ml_backend__ml_tag_switch__HeadVar__2_2, (MR_Integer) 1)));

      ml_backend__ml_tag_switch__succeeded = (ml_backend__ml_tag_switch__ArgX1_3 == ml_backend__ml_tag_switch__ArgY1_4);
      if (ml_backend__ml_tag_switch__succeeded)
      {
        ml_backend__ml_tag_switch__TypeInfo_9_9 = (MR_Word) &ml_backend__ml_tag_switch_scalar_common_2[1];
        ml_backend__ml_tag_switch__succeeded = mercury__builtin__unify_2_p_0(ml_backend__ml_tag_switch__TypeInfo_9_9, ((MR_Box) (ml_backend__ml_tag_switch__ArgX2_5)), ((MR_Box) (ml_backend__ml_tag_switch__ArgY2_6)));
      }
    }
    return ml_backend__ml_tag_switch__succeeded;
  }
...
{
  {
    ...
    if (((MR_tag((MR_Word) ml_backend__ml_tag_switch__HeadVar__2_2)) == (MR_mktag((MR_Integer) 0))))
    {
      MR_Word ml_backend__ml_tag_switch__Var_16 = (MR_Word) MR_body(((MR_Word) ml_backend__ml_tag_switch__HeadVar__2_2), (MR_Integer) 0);

      if (((MR_tag((MR_Word) ml_backend__ml_tag_switch__HeadVar__3_3)) == (MR_mktag((MR_Integer) 0))))
      {
        MR_Word ml_backend__ml_tag_switch__ArgY1_11 = (MR_Word) MR_body(((MR_Word) ml_backend__ml_tag_switch__HeadVar__3_3), (MR_Integer) 0);

        hlds__hlds_goal____Compare____hlds_goal_0_0(ml_backend__ml_tag_switch__HeadVar__1_1, ml_backend__ml_tag_switch__Var_16, ml_backend__ml_tag_switch__ArgY1_11);
      }
      else
    ...
    {
      MR_Word ml_backend__ml_tag_switch__Var_17 = ((MR_Word) (MR_hl_field(MR_mktag(1), ml_backend__ml_tag_switch__HeadVar__2_2, (MR_Integer) 0)));

      if (((MR_tag((MR_Word) ml_backend__ml_tag_switch__HeadVar__3_3)) == (MR_mktag((MR_Integer) 0))))
        *ml_backend__ml_tag_switch__HeadVar__1_1 = (MR_Integer) 1;
      else
      {
        MR_Word ml_backend__ml_tag_switch__ArgY1_5 = ((MR_Word) (MR_hl_field(MR_mktag(1), ml_backend__ml_tag_switch__HeadVar__3_3, (MR_Integer) 0)));

        ml_backend__mlds____Compare____mlds_stmt_0_0(ml_backend__ml_tag_switch__HeadVar__1_1, ml_backend__ml_tag_switch__Var_17, ml_backend__ml_tag_switch__ArgY1_5);
      }
    }
  }
}
...
{
  {
    ...
    if (((MR_tag((MR_Word) ml_backend__ml_tag_switch__HeadVar__1_1)) == (MR_mktag((MR_Integer) 0))))
    {
      MR_Word ml_backend__ml_tag_switch__ArgX1_5 = (MR_Word) MR_body(((MR_Word) ml_backend__ml_tag_switch__HeadVar__1_1), (MR_Integer) 0);
      MR_Word ml_backend__ml_tag_switch__ArgY1_6;

      ml_backend__ml_tag_switch__succeeded = ((MR_tag((MR_Word) ml_backend__ml_tag_switch__HeadVar__2_2)) == (MR_mktag((MR_Integer) 0)));
      if (ml_backend__ml_tag_switch__succeeded)
      {
        ml_backend__ml_tag_switch__ArgY1_6 = (MR_Word) MR_body(((MR_Word) ml_backend__ml_tag_switch__HeadVar__2_2), (MR_Integer) 0);
        ml_backend__ml_tag_switch__succeeded = hlds__hlds_goal____Unify____hlds_goal_0_0(ml_backend__ml_tag_switch__ArgX1_5, ml_backend__ml_tag_switch__ArgY1_6);
      }
    }
    else
    {
      MR_Word ml_backend__ml_tag_switch__ArgX1_3 = ((MR_Word) (MR_hl_field(MR_mktag(1), ml_backend__ml_tag_switch__HeadVar__1_1, (MR_Integer) 0)));
      MR_Word ml_backend__ml_tag_switch__ArgY1_4;

      ml_backend__ml_tag_switch__succeeded = ((MR_tag((MR_Word) ml_backend__ml_tag_switch__HeadVar__2_2)) == (MR_mktag((MR_Integer) 1)));
      if (ml_backend__ml_tag_switch__succeeded)
      {
        ml_backend__ml_tag_switch__ArgY1_4 = ((MR_Word) (MR_hl_field(MR_mktag(1), ml_backend__ml_tag_switch__HeadVar__2_2, (MR_Integer) 0)));
        ml_backend__ml_tag_switch__succeeded = ml_backend__mlds____Unify____mlds_stmt_0_0(ml_backend__ml_tag_switch__ArgX1_3, ml_backend__ml_tag_switch__ArgY1_4);
      }
    }
    return ml_backend__ml_tag_switch__succeeded;
  }
  ...
  MR_Integer ml_backend__ml_tag_switch__Stag_3)
{
  {
    MR_Word ml_backend__ml_tag_switch__HeadVar__2_2;
    MR_Word ml_backend__ml_tag_switch__Var_4;
    MR_Word ml_backend__ml_tag_switch__Var_5;

    {
      ml_backend__ml_tag_switch__Var_5 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(2), ml_backend__ml_tag_switch__Var_5, 0) = ((MR_Box) (ml_backend__ml_tag_switch__Stag_3));
    }
    {
      ml_backend__ml_tag_switch__Var_4 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(3), ml_backend__ml_tag_switch__Var_4, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 1));
      MR_hl_field(MR_mktag(3), ml_backend__ml_tag_switch__Var_4, 1) = ((MR_Box) (ml_backend__ml_tag_switch__Var_5));
    }
    {
      ml_backend__ml_tag_switch__HeadVar__2_2 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), ml_backend__ml_tag_switch__HeadVar__2_2, 0) = ((MR_Box) (ml_backend__ml_tag_switch__Var_4));
    }
...
{
  {
    ...
    {
      ml_backend__ml_tag_switch__Var_5 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(2), ml_backend__ml_tag_switch__Var_5, 0) = ((MR_Box) (ml_backend__ml_tag_switch__Ptag_3));
    }
    {
      ml_backend__ml_tag_switch__Var_4 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(3), ml_backend__ml_tag_switch__Var_4, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 1));
...
{
  {
    ...
    {
      MR_String ml_backend__ml_tag_switch__Var_34;
      MR_Word ml_backend__ml_tag_switch__Var_35;

      (ml_backend__ml_tag_switch__env_ptr)->ml_backend__ml_tag_switch__gen_tagged_case_code_9_p_0_env_0__succeeded = ((((MR_tag((MR_Word) (ml_backend__ml_tag_switch__env_ptr)->ml_backend__ml_tag_switch__gen_tagged_case_code_9_p_0_env_0__SubStmt_33)) == (MR_mktag((MR_Integer) 3)))) && (((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), (ml_backend__ml_tag_switch__env_ptr)->ml_backend__ml_tag_switch__gen_tagged_case_code_9_p_0_env_0__SubStmt_33, (MR_Integer) 0)))) == (MR_Integer) 1)));
      if ((ml_backend__ml_tag_switch__env_ptr)->ml_backend__ml_tag_switch__gen_tagged_case_code_9_p_0_env_0__succeeded)
      {
        ml_backend__ml_tag_switch__Var_34 = ((MR_String) (MR_hl_field(MR_mktag(3), (ml_backend__ml_tag_switch__env_ptr)->ml_backend__ml_tag_switch__gen_tagged_case_code_9_p_0_env_0__SubStmt_33, (MR_Integer) 1)));
        ml_backend__ml_tag_switch__Var_35 = ((MR_Word) (MR_hl_field(MR_mktag(3), (ml_backend__ml_tag_switch__env_ptr)->ml_backend__ml_tag_switch__gen_tagged_case_code_9_p_0_env_0__SubStmt_33, (MR_Integer) 2)));
...
{
  {
    ...
    if (MR_builtin_setjmp((ml_backend__ml_tag_switch__env_ptr)->ml_backend__ml_tag_switch__gen_tagged_case_code_9_p_0_env_0__commit_0) == 0)
      {
        ml_backend__ml_util__statement_is_or_contains_statement_2_p_0((ml_backend__ml_tag_switch__env_ptr)->ml_backend__ml_tag_switch__gen_tagged_case_code_9_p_0_env_0__Stmt_20, &(ml_backend__ml_tag_switch__env_ptr)->ml_backend__ml_tag_switch__gen_tagged_case_code_9_p_0_env_0__SubStmt_33, ml_backend__ml_tag_switch__gen_tagged_case_code_9_p_0_2, ml_backend__ml_tag_switch__env_ptr);
...
{
  {
...

    {
      ...
      MR_Word ml_backend__ml_tag_switch__Var_22;
      MR_Word ml_backend__ml_tag_switch__Var_23;
      ...
      *ml_backend__ml_tag_switch__CaseId_12 = ((MR_Word) (MR_hl_field(MR_mktag(0), ml_backend__ml_tag_switch__TaggedCase_11, (MR_Integer) 2)));
      ...
      ml_backend__ml_code_gen__ml_gen_goal_as_branch_block_5_p_0(ml_backend__ml_tag_switch__CodeModel_10, ml_backend__ml_tag_switch__Goal_19, &(ml_backend__ml_tag_switch__env).ml_backend__ml_tag_switch__gen_tagged_case_code_9_p_0_env_0__Stmt_20, ml_backend__ml_tag_switch__Info0_15, &ml_backend__ml_tag_switch__Info1_21);
      ...
      {
        ml_backend__ml_tag_switch__Var_22 = ((MR_Word) (MR_hl_field(MR_mktag(1), ml_backend__ml_tag_switch__OtherTaggedConsIds_18, (MR_Integer) 0)));
        ml_backend__ml_tag_switch__Var_23 = ((MR_Word) (MR_hl_field(MR_mktag(1), ml_backend__ml_tag_switch__OtherTaggedConsIds_18, (MR_Integer) 1)));
        ml_backend__ml_tag_switch__gen_tagged_case_code_9_p_0_3(&ml_backend__ml_tag_switch__env);
      }
      if ((ml_backend__ml_tag_switch__env).ml_backend__ml_tag_switch__gen_tagged_case_code_9_p_0_env_0__succeeded)
      {
        ml_backend__ml_tag_switch__MaybeCode_24 = (MR_Word) MR_mkword(MR_mktag(0), (MR_Word) ml_backend__ml_tag_switch__Goal_19);
        *ml_backend__ml_tag_switch__Info_16 = ml_backend__ml_tag_switch__Info0_15;
      }
      else
      {
        {
          ml_backend__ml_tag_switch__MaybeCode_24 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), ml_backend__ml_tag_switch__MaybeCode_24, 0) = ((MR_Box) ((ml_backend__ml_tag_switch__env).ml_backend__ml_tag_switch__gen_tagged_case_code_9_p_0_env_0__Stmt_20));
        }
...
ml_backend__ml_tag_switch__ml_generate_tag_switch_8_p_0(
  ...
  MR_Word * ml_backend__ml_tag_switch__Stmts_14,
  MR_Word ml_backend__ml_tag_switch__STATE_VARIABLE_Info_0_34,
  MR_Word * ml_backend__ml_tag_switch__STATE_VARIABLE_Info_35)
{
  {
    MR_Word ml_backend__ml_tag_switch__TypeCtorInfo_56_56;
    ...
    MR_Word ml_backend__ml_tag_switch__SwitchStmt_33;
    MR_Word ml_backend__ml_tag_switch__Var_38;
    MR_Word ml_backend__ml_tag_switch__Var_39;
    ...
    MR_Box ml_backend__ml_tag_switch__conv4_Var_24;
    MR_Box ml_backend__ml_tag_switch__conv3_STATE_VARIABLE_Info_41_41;

    ml_backend__ml_code_util__ml_gen_var_3_p_0(ml_backend__ml_tag_switch__STATE_VARIABLE_Info_0_34, ml_backend__ml_tag_switch__Var_10, &ml_backend__ml_tag_switch__VarLval_16);
    {
      ml_backend__ml_tag_switch__VarRval_17 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(2), ml_backend__ml_tag_switch__VarRval_17, 0) = ((MR_Box) (ml_backend__ml_tag_switch__VarLval_16));
    }
    {
      ...
      MR_hl_field(MR_mktag(3), ml_backend__ml_tag_switch__PTagRval_18, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 2));
      MR_hl_field(MR_mktag(3), ml_backend__ml_tag_switch__PTagRval_18, 1) = ((MR_Box) (MR_mkword(MR_mktag(3), &ml_backend__ml_tag_switch_scalar_common_4[1])));
      MR_hl_field(MR_mktag(3), ml_backend__ml_tag_switch__PTagRval_18, 2) = ((MR_Box) (ml_backend__ml_tag_switch__VarRval_17));
    }
    ml_backend__ml_gen_info__ml_gen_info_get_module_info_2_p_0(ml_backend__ml_tag_switch__STATE_VARIABLE_Info_0_34, &ml_backend__ml_tag_switch__ModuleInfo_19);
    ml_backend__ml_code_util__ml_variable_type_3_p_0(ml_backend__ml_tag_switch__STATE_VARIABLE_Info_0_34, ml_backend__ml_tag_switch__Var_10, &ml_backend__ml_tag_switch__Type_20);
    ...
    {
      ml_backend__ml_tag_switch__Var_38 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), ml_backend__ml_tag_switch__Var_38, 0) = ((MR_Box) (&ml_backend__ml_tag_switch_scalar_common_5[0]));
      MR_hl_field(MR_mktag(0), ml_backend__ml_tag_switch__Var_38, 1) = ((MR_Box) (ml_backend__ml_tag_switch__ml_generate_tag_switch_8_p_0_1));
      MR_hl_field(MR_mktag(0), ml_backend__ml_tag_switch__Var_38, 2) = ((MR_Box) (MR_Word) ((MR_Integer) 1));
      MR_hl_field(MR_mktag(0), ml_backend__ml_tag_switch__Var_38, 3) = ((MR_Box) (ml_backend__ml_tag_switch__CodeModel_11));
    }
    ml_backend__ml_tag_switch__TypeCtorInfo_56_56 = (MR_Word) &hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_case_id_0;
    ml_backend__ml_tag_switch__Var_39 = mercury__map__init_0_f_0(ml_backend__ml_tag_switch__TypeCtorInfo_56_56, (MR_Word) &ml_backend__ml_tag_switch__ml_backend__ml_tag_switch__type_ctor_info_maybe_code_0);
    mercury__private_builtin__dummy_var = (MR_Integer) 0;
    backend_libs__switch_util__group_cases_by_ptag_10_p_0(ml_backend__ml_tag_switch__TypeCtorInfo_56_56, (MR_Word) &ml_backend__ml_tag_switch_scalar_common_1[0], (MR_Word) &mercury__unit__unit__type_ctor_info_unit_0, (MR_Word) &ml_backend__ml_gen_info__ml_backend__ml_gen_info__type_ctor_info_ml_gen_info_0, ml_backend__ml_tag_switch__TaggedCases_9, ml_backend__ml_tag_switch__Var_38, ((MR_Box) (ml_backend__ml_tag_switch__Var_39)), &ml_backend__ml_tag_switch__conv5_CodeMap_23, ((MR_Box) ((MR_Integer) 0)), &ml_backend__ml_tag_switch__conv4_Var_24, ((MR_Box) (ml_backend__ml_tag_switch__STATE_VARIABLE_Info_0_34)), &ml_backend__ml_tag_switch__conv3_STATE_VARIABLE_Info_41_41, &ml_backend__ml_tag_switch___CaseIdPtagsMap_25, &ml_backend__ml_tag_switch__PtagCaseMap_26);
    ml_backend__ml_tag_switch__CodeMap_23 = ((MR_Word) ml_backend__ml_tag_switch__conv5_CodeMap_23);
    ml_backend__ml_tag_switch__STATE_VARIABLE_Info_41_41 = ((MR_Word) ml_backend__ml_tag_switch__conv3_STATE_VARIABLE_Info_41_41);
    backend_libs__switch_util__order_ptags_by_count_3_p_0(ml_backend__ml_tag_switch__TypeCtorInfo_56_56, ml_backend__ml_tag_switch__PtagCountMap_22, ml_backend__ml_tag_switch__PtagCaseMap_26, &ml_backend__ml_tag_switch__PtagCaseList_27);
    ml_backend__ml_tag_switch__gen_ptag_cases_10_p_0(ml_backend__ml_tag_switch__PtagCaseList_27, ml_backend__ml_tag_switch__CodeMap_23, ml_backend__ml_tag_switch__Var_10, ml_backend__ml_tag_switch__CanFail_12, ml_backend__ml_tag_switch__CodeModel_11, ml_backend__ml_tag_switch__PtagCountMap_22, ml_backend__ml_tag_switch__Context_13, &ml_backend__ml_tag_switch__PtagCases0_28, ml_backend__ml_tag_switch__STATE_VARIABLE_Info_41_41, &ml_backend__ml_tag_switch__STATE_VARIABLE_Info_42_42);
    ...
    {
      ml_backend__ml_tag_switch__SwitchStmt0_32 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 7 * sizeof(MR_Word)), NULL, NULL));
      ...
      MR_hl_field(MR_mktag(3), ml_backend__ml_tag_switch__SwitchStmt0_32, 6) = ((MR_Box) (ml_backend__ml_tag_switch__Context_13));
    }
    ml_backend__ml_simplify_switch__ml_simplify_switch_4_p_0(ml_backend__ml_tag_switch__SwitchStmt0_32, &ml_backend__ml_tag_switch__SwitchStmt_33, ml_backend__ml_tag_switch__STATE_VARIABLE_Info_43_43, ml_backend__ml_tag_switch__STATE_VARIABLE_Info_35);
    {
      MR_Word base;
      base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      *ml_backend__ml_tag_switch__Stmts_14 = base;
      MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (ml_backend__ml_tag_switch__SwitchStmt_33));
...
{
  {
    ...
    ml_backend__ml_tag_switch__succeeded = ml_backend__ml_tag_switch__IntroducedFrom__pred__gen_ptag_case__221__1_2_p_0(((MR_Word) (MR_hl_field(MR_mktag(0), ml_backend__ml_tag_switch__closure, (MR_Integer) 3))), ((MR_Word) (MR_hl_field(MR_mktag(0), ml_backend__ml_tag_switch__closure, (MR_Integer) 4))));
    return ml_backend__ml_tag_switch__succeeded;
  }
}
...
{
  {
    ...
    ml_backend__ml_tag_switch__succeeded = ml_backend__ml_tag_switch__IntroducedFrom__pred__gen_ptag_case__199__1_2_p_0(((MR_Word) (MR_hl_field(MR_mktag(0), ml_backend__ml_tag_switch__closure, (MR_Integer) 3))), ((MR_Word) (MR_hl_field(MR_mktag(0), ml_backend__ml_tag_switch__closure, (MR_Integer) 4))));
    return ml_backend__ml_tag_switch__succeeded;
  }
}
...
{
  {
    ...
    MR_Word ml_backend__ml_tag_switch__Stmt_30;
    MR_Word ml_backend__ml_tag_switch__MainPtagMatch_39;
    MR_Word ml_backend__ml_tag_switch__OtherPtagMatches_40;
    MR_Word ml_backend__ml_tag_switch__Var_43 = ((MR_Word) (MR_hl_field(MR_mktag(0), ml_backend__ml_tag_switch__PtagCase_11, (MR_Integer) 2)));
    MR_Word ml_backend__ml_tag_switch__Var_44;
    MR_Word ml_backend__ml_tag_switch__Var_89;
    MR_Word ml_backend__ml_tag_switch__Var_90;
    MR_Box ml_backend__ml_tag_switch__conv0_CountInfo_24;

    ml_backend__ml_tag_switch__SecTagLocn_22 = ((MR_Word) (MR_hl_field(MR_mktag(0), ml_backend__ml_tag_switch__Var_43, (MR_Integer) 0)));
    ml_backend__ml_tag_switch__GoalMap_23 = ((MR_Word) (MR_hl_field(MR_mktag(0), ml_backend__ml_tag_switch__Var_43, (MR_Integer) 1)));
    ...
    {
      ml_backend__ml_tag_switch__Var_44 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 5 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), ml_backend__ml_tag_switch__Var_44, 0) = ((MR_Box) (&ml_backend__ml_tag_switch_scalar_common_3[1]));
      MR_hl_field(MR_mktag(0), ml_backend__ml_tag_switch__Var_44, 1) = ((MR_Box) (ml_backend__ml_tag_switch__gen_ptag_case_10_p_0_1));
      MR_hl_field(MR_mktag(0), ml_backend__ml_tag_switch__Var_44, 2) = ((MR_Box) (MR_Word) ((MR_Integer) 2));
      MR_hl_field(MR_mktag(0), ml_backend__ml_tag_switch__Var_44, 3) = ((MR_Box) (ml_backend__ml_tag_switch__SecTagLocn_22));
      MR_hl_field(MR_mktag(0), ml_backend__ml_tag_switch__Var_44, 4) = ((MR_Box) (ml_backend__ml_tag_switch__SecTagLocn1_25));
    }
    mercury__require__expect_4_p_0(ml_backend__ml_tag_switch__Var_44, (MR_String) "ml_backend.ml_tag_switch", (MR_String) "predicate \140ml_backend.ml_tag_switch.gen_ptag_case\'/10", (MR_String) "secondary tag locations differ");
      ...
      case (MR_Integer) 3:
        {
          ...
          MR_Word ml_backend__ml_tag_switch__Var_48;
          MR_Word ml_backend__ml_tag_switch__RevMap_84;
          MR_Word ml_backend__ml_tag_switch__Var_85;
          MR_Word ml_backend__ml_tag_switch__CaseId_69;
          MR_Word ml_backend__ml_tag_switch__Var_54;
          MR_Word ml_backend__ml_tag_switch__Var_55;
          MR_Word ml_backend__ml_tag_switch___Stags_38;

          {
            ml_backend__ml_tag_switch__Var_48 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 5 * sizeof(MR_Word)), NULL, NULL);
            MR_hl_field(MR_mktag(0), ml_backend__ml_tag_switch__Var_48, 0) = ((MR_Box) (&ml_backend__ml_tag_switch_scalar_common_3[2]));
            MR_hl_field(MR_mktag(0), ml_backend__ml_tag_switch__Var_48, 1) = ((MR_Box) (ml_backend__ml_tag_switch__gen_ptag_case_10_p_0_2));
            MR_hl_field(MR_mktag(0), ml_backend__ml_tag_switch__Var_48, 2) = ((MR_Box) (MR_Word) ((MR_Integer) 2));
            MR_hl_field(MR_mktag(0), ml_backend__ml_tag_switch__Var_48, 3) = ((MR_Box) (ml_backend__ml_tag_switch__OtherPtags_21));
            MR_hl_field(MR_mktag(0), ml_backend__ml_tag_switch__Var_48, 4) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
          }
          mercury__require__expect_4_p_0(ml_backend__ml_tag_switch__Var_48, (MR_String) "ml_backend.ml_tag_switch", (MR_String) "predicate \140ml_backend.ml_tag_switch.gen_ptag_case\'/10", (MR_String) ">1 ptag with secondary tag");
          ...
          ml_backend__ml_tag_switch__Var_85 = mercury__map__init_0_f_0(ml_backend__ml_tag_switch__TypeCtorInfo_7_86, ml_backend__ml_tag_switch__TypeCtorInfo_8_87);
          ml_backend__ml_tag_switch__build_stag_rev_map_3_p_0(ml_backend__ml_tag_switch__GoalList_27, ml_backend__ml_tag_switch__Var_85, &ml_backend__ml_tag_switch__RevMap_84);
          ...
          if (ml_backend__ml_tag_switch__succeeded)
          {
            ...
            if (ml_backend__ml_tag_switch__succeeded)
            {
              ml_backend__ml_tag_switch__Var_54 = ((MR_Word) (MR_hl_field(MR_mktag(1), ml_backend__ml_tag_switch__GroupedGoalList_37, (MR_Integer) 0)));
              ml_backend__ml_tag_switch__Var_55 = ((MR_Word) (MR_hl_field(MR_mktag(1), ml_backend__ml_tag_switch__GroupedGoalList_37, (MR_Integer) 1)));
              ml_backend__ml_tag_switch__succeeded = (ml_backend__ml_tag_switch__Var_55 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
              if (ml_backend__ml_tag_switch__succeeded)
              {
                ml_backend__ml_tag_switch__CaseId_69 = ((MR_Word) (MR_hl_field(MR_mktag(0), ml_backend__ml_tag_switch__Var_54, (MR_Integer) 0)));
                ml_backend__ml_tag_switch___Stags_38 = ((MR_Word) (MR_hl_field(MR_mktag(0), ml_backend__ml_tag_switch__Var_54, (MR_Integer) 1)));
                ml_backend__ml_tag_switch__succeeded = MR_TRUE;
              }
            }
          }
          if (ml_backend__ml_tag_switch__succeeded)
            ml_backend__ml_tag_switch__lookup_code_map_6_p_0(ml_backend__ml_tag_switch__CodeMap_12, ml_backend__ml_tag_switch__CaseId_69, ml_backend__ml_tag_switch__CodeModel_15, &ml_backend__ml_tag_switch__Stmt_30, ml_backend__ml_tag_switch__STATE_VARIABLE_Info_0_41, ml_backend__ml_tag_switch__STATE_VARIABLE_Info_42);
          else
            ml_backend__ml_tag_switch__gen_stag_switch_11_p_0(ml_backend__ml_tag_switch__GroupedGoalList_37, ml_backend__ml_tag_switch__CodeMap_12, ml_backend__ml_tag_switch__MainPtag_20, ml_backend__ml_tag_switch__SecTagLocn_22, ml_backend__ml_tag_switch__Var_13, ml_backend__ml_tag_switch__CodeModel_15, ml_backend__ml_tag_switch__CaseCanFail_34, ml_backend__ml_tag_switch__Context_17, &ml_backend__ml_tag_switch__Stmt_30, ml_backend__ml_tag_switch__STATE_VARIABLE_Info_0_41, ml_backend__ml_tag_switch__STATE_VARIABLE_Info_42);
        }
        break;
      case (MR_Integer) 0:
      case (MR_Integer) 1:
        ...
        {
          MR_Word ml_backend__ml_tag_switch__Var_80 = ((MR_Word) (MR_hl_field(MR_mktag(1), ml_backend__ml_tag_switch__GoalList_27, (MR_Integer) 1)));
          MR_Word ml_backend__ml_tag_switch__Var_81 = ((MR_Word) (MR_hl_field(MR_mktag(1), ml_backend__ml_tag_switch__GoalList_27, (MR_Integer) 0)));

          if ((ml_backend__ml_tag_switch__Var_80 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
          {
            MR_Word ml_backend__ml_tag_switch__CaseId_29 = ((MR_Word) (MR_hl_field(MR_mktag(0), ml_backend__ml_tag_switch__Var_81, (MR_Integer) 1)));
            MR_Integer ml_backend__ml_tag_switch___Stag_28 = ((MR_Integer) (MR_hl_field(MR_mktag(0), ml_backend__ml_tag_switch__Var_81, (MR_Integer) 0)));

            ml_backend__ml_tag_switch__lookup_code_map_6_p_0(ml_backend__ml_tag_switch__CodeMap_12, ml_backend__ml_tag_switch__CaseId_29, ml_backend__ml_tag_switch__CodeModel_15, &ml_backend__ml_tag_switch__Stmt_30, ml_backend__ml_tag_switch__STATE_VARIABLE_Info_0_41, ml_backend__ml_tag_switch__STATE_VARIABLE_Info_42);
          }
          else
          {
            {
    ...
    {
      ml_backend__ml_tag_switch__Var_90 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(2), ml_backend__ml_tag_switch__Var_90, 0) = ((MR_Box) (ml_backend__ml_tag_switch__MainPtag_20));
    }
    {
      ml_backend__ml_tag_switch__Var_89 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(3), ml_backend__ml_tag_switch__Var_89, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 1));
      MR_hl_field(MR_mktag(3), ml_backend__ml_tag_switch__Var_89, 1) = ((MR_Box) (ml_backend__ml_tag_switch__Var_90));
    }
    {
      ml_backend__ml_tag_switch__MainPtagMatch_39 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), ml_backend__ml_tag_switch__MainPtagMatch_39, 0) = ((MR_Box) (ml_backend__ml_tag_switch__Var_89));
    }
    ml_backend__ml_tag_switch__OtherPtagMatches_40 = mercury__list__map_2_f_0(ml_backend__ml_tag_switch__TypeCtorInfo_71_71, (MR_Word) &ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_case_match_cond_0, (MR_Word) &ml_backend__ml_tag_switch_scalar_common_1[5], ml_backend__ml_tag_switch__OtherPtags_21);
    {
      ...
      *ml_backend__ml_tag_switch__MLDS_Case_18 = base;
      ...
      MR_hl_field(MR_mktag(0), base, 2) = ((MR_Box) (ml_backend__ml_tag_switch__Stmt_30));
    }
  }
}
...
{
  {
    ...
    MR_Word ml_backend__ml_tag_switch__StagCases0_28;
    MR_Word ml_backend__ml_tag_switch__StagCases_29;
    MR_Word ml_backend__ml_tag_switch__Default_30;
    MR_Word ml_backend__ml_tag_switch__SwitchStmt_32;
    ...
    {
      ml_backend__ml_tag_switch__VarRval_25 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(2), ml_backend__ml_tag_switch__VarRval_25, 0) = ((MR_Box) (ml_backend__ml_tag_switch__VarLval_24));
    }
    switch (ml_backend__ml_tag_switch__StagLocn_15) {
        ...
        {
          {
            ...
            MR_hl_field(MR_mktag(3), ml_backend__ml_tag_switch__STagRval_26, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 2));
            MR_hl_field(MR_mktag(3), ml_backend__ml_tag_switch__STagRval_26, 1) = ((MR_Box) (MR_mkword(MR_mktag(3), &ml_backend__ml_tag_switch_scalar_common_4[0])));
      ...
      case (MR_Integer) 3:
        {
          MR_Word ml_backend__ml_tag_switch__Target_27;

          ml_backend__ml_gen_info__ml_gen_info_get_target_2_p_0(ml_backend__ml_tag_switch__STATE_VARIABLE_Info_0_33, &ml_backend__ml_tag_switch__Target_27);
          ml_backend__ml_tag_switch__STagRval_26 = ml_backend__ml_unify_gen__ml_gen_secondary_tag_rval_5_f_0(ml_backend__ml_tag_switch__ModuleInfo_22, ml_backend__ml_tag_switch__Target_27, ml_backend__ml_tag_switch__PrimaryTag_14, ml_backend__ml_tag_switch__VarType_23, ml_backend__ml_tag_switch__VarRval_25);
        }
        break;
    }
    ml_backend__ml_tag_switch__gen_stag_cases_6_p_0(ml_backend__ml_tag_switch__Cases_12, ml_backend__ml_tag_switch__CodeMap_13, ml_backend__ml_tag_switch__CodeModel_17, &ml_backend__ml_tag_switch__StagCases0_28, ml_backend__ml_tag_switch__STATE_VARIABLE_Info_0_33, &ml_backend__ml_tag_switch__STATE_VARIABLE_Info_40_40);
    mercury__list__sort_2_p_0((MR_Word) &ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_switch_case_0, ml_backend__ml_tag_switch__StagCases0_28, &ml_backend__ml_tag_switch__StagCases_29);
    ml_backend__ml_switch_gen__ml_switch_generate_default_6_p_0(ml_backend__ml_tag_switch__CanFail_18, ml_backend__ml_tag_switch__CodeModel_17, ml_backend__ml_tag_switch__Context_19, &ml_backend__ml_tag_switch__Default_30, ml_backend__ml_tag_switch__STATE_VARIABLE_Info_40_40, &ml_backend__ml_tag_switch__STATE_VARIABLE_Info_41_41);
    {
      ml_backend__ml_tag_switch__SwitchStmt_32 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 7 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(3), ml_backend__ml_tag_switch__SwitchStmt_32, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 0));
      MR_hl_field(MR_mktag(3), ml_backend__ml_tag_switch__SwitchStmt_32, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 2))));
      MR_hl_field(MR_mktag(3), ml_backend__ml_tag_switch__SwitchStmt_32, 2) = ((MR_Box) (ml_backend__ml_tag_switch__STagRval_26));
      MR_hl_field(MR_mktag(3), ml_backend__ml_tag_switch__SwitchStmt_32, 3) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
      MR_hl_field(MR_mktag(3), ml_backend__ml_tag_switch__SwitchStmt_32, 4) = ((MR_Box) (ml_backend__ml_tag_switch__StagCases_29));
      MR_hl_field(MR_mktag(3), ml_backend__ml_tag_switch__SwitchStmt_32, 5) = ((MR_Box) (ml_backend__ml_tag_switch__Default_30));
      MR_hl_field(MR_mktag(3), ml_backend__ml_tag_switch__SwitchStmt_32, 6) = ((MR_Box) (ml_backend__ml_tag_switch__Context_19));
    }
    ml_backend__ml_simplify_switch__ml_simplify_switch_4_p_0(ml_backend__ml_tag_switch__SwitchStmt_32, ml_backend__ml_tag_switch__Stmt_20, ml_backend__ml_tag_switch__STATE_VARIABLE_Info_41_41, ml_backend__ml_tag_switch__STATE_VARIABLE_Info_34);
  }
}
  ...
  MR_Word * ml_backend__ml_tag_switch__STATE_VARIABLE_Info_6)
{
  ...
  else
  {
    ...
    MR_Word ml_backend__ml_tag_switch__Stmt_37;
    MR_Word ml_backend__ml_tag_switch__Var_45;
    MR_Word ml_backend__ml_tag_switch__Var_46;
    ...
    {
      ml_backend__ml_tag_switch__Var_46 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(2), ml_backend__ml_tag_switch__Var_46, 0) = ((MR_Box) (ml_backend__ml_tag_switch__FirstStag_32));
    }
    {
      ml_backend__ml_tag_switch__Var_45 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(3), ml_backend__ml_tag_switch__Var_45, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 1));
      MR_hl_field(MR_mktag(3), ml_backend__ml_tag_switch__Var_45, 1) = ((MR_Box) (ml_backend__ml_tag_switch__Var_46));
    }
    {
      ml_backend__ml_tag_switch__FirstMatch_35 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), ml_backend__ml_tag_switch__FirstMatch_35, 0) = ((MR_Box) (ml_backend__ml_tag_switch__Var_45));
    }
    ml_backend__ml_tag_switch__LaterMatches_36 = mercury__list__map_2_f_0(ml_backend__ml_tag_switch__TypeCtorInfo_24_40, (MR_Word) &ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_case_match_cond_0, (MR_Word) &ml_backend__ml_tag_switch_scalar_common_1[4], ml_backend__ml_tag_switch__LaterStags_34);
    ...
    if (((MR_tag((MR_Word) ml_backend__ml_tag_switch__MaybeCode_54)) == (MR_mktag((MR_Integer) 0))))
    {
      MR_Word ml_backend__ml_tag_switch__Goal_55 = (MR_Word) MR_body(((MR_Word) ml_backend__ml_tag_switch__MaybeCode_54), (MR_Integer) 0);

      ml_backend__ml_code_gen__ml_gen_goal_as_branch_block_5_p_0(ml_backend__ml_tag_switch__CodeModel_3, ml_backend__ml_tag_switch__Goal_55, &ml_backend__ml_tag_switch__Stmt_37, ml_backend__ml_tag_switch__STATE_VARIABLE_Info_0_5, &ml_backend__ml_tag_switch__STATE_VARIABLE_Info_21_21);
    }
    else
    {
      ml_backend__ml_tag_switch__Stmt_37 = ((MR_Word) (MR_hl_field(MR_mktag(1), ml_backend__ml_tag_switch__MaybeCode_54, (MR_Integer) 0)));
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(0), ml_backend__ml_tag_switch__Case_16, 2) = ((MR_Box) (ml_backend__ml_tag_switch__Stmt_37));
    }
    ...
    /* tailcall optimized into a loop */
    {
      ...
      else
      {
        ...
        if (ml_backend__ml_tag_switch__succeeded)
        {
          ...
          MR_Word ml_backend__ml_tag_switch__Var_18;

          {
            ml_backend__ml_tag_switch__Var_18 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), ml_backend__ml_tag_switch__Var_18, 0) = ((MR_Box) (ml_backend__ml_tag_switch__Stag_10));
            MR_hl_field(MR_mktag(1), ml_backend__ml_tag_switch__Var_18, 1) = ((MR_Box) (ml_backend__ml_tag_switch__OldLaterStags_14));
          }
          {
            ...
            MR_hl_field(MR_mktag(0), ml_backend__ml_tag_switch__NewEntry_15, 1) = ((MR_Box) (ml_backend__ml_tag_switch__Var_18));
          }
        ...
        {
          MR_Word ml_backend__ml_tag_switch__next_value_of_HeadVar__1_1 = ml_backend__ml_tag_switch__Entries_8;
          MR_Word ml_backend__ml_tag_switch__next_value_of_STATE_VARIABLE_RevMap_0_2 = ml_backend__ml_tag_switch__STATE_VARIABLE_RevMap_19_19;

          ml_backend__ml_tag_switch__HeadVar__1_1 = ml_backend__ml_tag_switch__next_value_of_HeadVar__1_1;
          ml_backend__ml_tag_switch__STATE_VARIABLE_RevMap_0_2 = ml_backend__ml_tag_switch__next_value_of_STATE_VARIABLE_RevMap_0_2;
        }
        continue;
      }
    }
...
{
  {
    ...
    if (((MR_tag((MR_Word) ml_backend__ml_tag_switch__MaybeCode_12)) == (MR_mktag((MR_Integer) 0))))
    {
      MR_Word ml_backend__ml_tag_switch__Goal_13 = (MR_Word) MR_body(((MR_Word) ml_backend__ml_tag_switch__MaybeCode_12), (MR_Integer) 0);

      ml_backend__ml_code_gen__ml_gen_goal_as_branch_block_5_p_0(ml_backend__ml_tag_switch__CodeModel_9, ml_backend__ml_tag_switch__Goal_13, ml_backend__ml_tag_switch__Stmt_10, ml_backend__ml_tag_switch__STATE_VARIABLE_Info_0_14, ml_backend__ml_tag_switch__STATE_VARIABLE_Info_15);
    }
    else
    {
      *ml_backend__ml_tag_switch__Stmt_10 = ((MR_Word) (MR_hl_field(MR_mktag(1), ml_backend__ml_tag_switch__MaybeCode_12, (MR_Integer) 0)));
