...
{
  MR_bool succeeded;
  MR_Word TypeCtorInfo_49_75;
  MR_Word TypeCtorInfo_50_76;
  ...
  if (succeeded)
  {
    ...
    TypeCtorInfo_49_75 = (MR_Word) (&hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_case_id_0);
    {
    ...
    backend_libs__switch_util__order_ptags_by_count_3_p_0(TypeCtorInfo_49_75, PtagCountMap_22, PtagCaseMap_27, &PtagCaseList_58);
    ...
    TypeCtorInfo_50_76 = (MR_Word) (&ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_switch_case_0);
    {
    ...
    mercury__list__sort_2_p_0(TypeCtorInfo_50_76, PtagCases0_59, &PtagCases_62);
