...
{
  {
          ...
          case (MR_Integer) 3:
            {
                ...
                case (MR_Integer) 0:
                  {
                    ...
                    FullGoalCount_40 = (MR_Integer) ((MR_Unsigned) MaxSecondary_26 + (MR_Unsigned) (MR_Integer) 1);
              ...
              if (succeeded)
              {
                succeeded = ((MR_tag((MR_Word) GroupedGoalList_41)) == (MR_Integer) 1);
                if (succeeded)
                {
    ...
    {
      MainPtagMatch_43 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL);
...
{
  {
      ...
      case (MR_Integer) 2:
        {
          ...
          MR_Word Var_41;
          MR_Word Var_42;
          MR_Unsigned Mask_54 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(2), StagLocn_15, (MR_Integer) 1))));
          ...
          ml_backend__ml_unify_gen_util__ml_gen_secondary_tag_rval_5_p_0(STATE_VARIABLE_Info_0_35, VarType_22, VarRval_24, Ptag_14, &StagWordRval_29);
          {
            ...
            MR_hl_field(MR_mktag(3), Var_42, 1) = ((MR_Box) (Mask_54));
          }
          {
    ...
    {
      SwitchStmt_34 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 7 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(3), SwitchStmt_34, 0) = ((MR_Box) ((MR_Unsigned) 0U));
      MR_hl_field(MR_mktag(3), SwitchStmt_34, 1) = ((MR_Box) ((MR_Unsigned) 8U));
