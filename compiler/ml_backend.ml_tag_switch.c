...
ml_backend__ml_tag_switch__gen_stag_switch_11_p_0(
  ...
  MR_Word ml_backend__ml_tag_switch__STATE_VARIABLE_Info_0_32,
  MR_Word * ml_backend__ml_tag_switch__STATE_VARIABLE_Info_33);
...
{
  {
    ...
    MR_Word ml_backend__ml_tag_switch__STATE_VARIABLE_Info_39_39;
    MR_Word ml_backend__ml_tag_switch__STATE_VARIABLE_Info_40_40;

    {
      ml_backend__ml_gen_info__ml_gen_info_get_module_info_2_p_0(ml_backend__ml_tag_switch__STATE_VARIABLE_Info_0_32, &ml_backend__ml_tag_switch__ModuleInfo_22);
    }
    {
      ml_backend__ml_code_util__ml_variable_type_3_p_0(ml_backend__ml_tag_switch__STATE_VARIABLE_Info_0_32, ml_backend__ml_tag_switch__Var_16, &ml_backend__ml_tag_switch__VarType_23);
    }
    {
      ml_backend__ml_code_util__ml_gen_var_3_p_0(ml_backend__ml_tag_switch__STATE_VARIABLE_Info_0_32, ml_backend__ml_tag_switch__Var_16, &ml_backend__ml_tag_switch__VarLval_24);
    }
    {
    ...
    {
      ml_backend__ml_tag_switch__gen_stag_cases_6_p_0(ml_backend__ml_tag_switch__Cases_12, ml_backend__ml_tag_switch__CodeMap_13, ml_backend__ml_tag_switch__CodeModel_17, &ml_backend__ml_tag_switch__StagCases0_27, ml_backend__ml_tag_switch__STATE_VARIABLE_Info_0_32, &ml_backend__ml_tag_switch__STATE_VARIABLE_Info_39_39);
    }
    {
    ...
    {
      ml_backend__ml_switch_gen__ml_switch_generate_default_6_p_0(ml_backend__ml_tag_switch__CanFail_18, ml_backend__ml_tag_switch__CodeModel_17, ml_backend__ml_tag_switch__Context_19, &ml_backend__ml_tag_switch__Default_29, ml_backend__ml_tag_switch__STATE_VARIABLE_Info_39_39, &ml_backend__ml_tag_switch__STATE_VARIABLE_Info_40_40);
    }
    {
      ml_backend__ml_tag_switch__SwitchStmt_31 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 7 * sizeof(MR_Word)), NULL, NULL));
      ...
      MR_hl_field(MR_mktag(3), ml_backend__ml_tag_switch__SwitchStmt_31, 6) = ((MR_Box) (ml_backend__ml_tag_switch__Context_19));
    }
    {
      ml_backend__ml_simplify_switch__ml_simplify_switch_4_p_0(ml_backend__ml_tag_switch__SwitchStmt_31, ml_backend__ml_tag_switch__Stmt_20, ml_backend__ml_tag_switch__STATE_VARIABLE_Info_40_40, ml_backend__ml_tag_switch__STATE_VARIABLE_Info_33);
    }
  }
}
