...
ml_backend__ml_tag_switch__IntroducedFrom__pred__gen_ptag_case__253__1_2_p_0(
  MR_Word OtherPtags_24,
  MR_Word HeadVar__2_59);

static MR_bool MR_CALL 
ml_backend__ml_tag_switch__IntroducedFrom__pred__gen_ptag_case__228__1_2_p_0(
...
{
  {
    ...
    switch (MR_tag((MR_Word) (env_ptr)->ml_backend__ml_tag_switch__gen_tagged_case_code_10_p_0_env_0__SubStmt_37)) {
      default:
        (env_ptr)->ml_backend__ml_tag_switch__gen_tagged_case_code_10_p_0_env_0__succeeded = MR_FALSE;
        break;
      case (MR_Integer) 0:
        {
          MR_Word FuncDefns_41 = ((MR_Word) ((MR_hl_field(MR_mktag(0), (env_ptr)->ml_backend__ml_tag_switch__gen_tagged_case_code_10_p_0_env_0__SubStmt_37, (MR_Integer) 1))));
          MR_Word _LocalVarDefns_40 = ((MR_Word) ((MR_hl_field(MR_mktag(0), (env_ptr)->ml_backend__ml_tag_switch__gen_tagged_case_code_10_p_0_env_0__SubStmt_37, (MR_Integer) 0))));
          MR_Word _Stmts_42 = ((MR_Word) ((MR_hl_field(MR_mktag(0), (env_ptr)->ml_backend__ml_tag_switch__gen_tagged_case_code_10_p_0_env_0__SubStmt_37, (MR_Integer) 2))));
          MR_Word _Ctxt_43 = ((MR_Word) ((MR_hl_field(MR_mktag(0), (env_ptr)->ml_backend__ml_tag_switch__gen_tagged_case_code_10_p_0_env_0__SubStmt_37, (MR_Integer) 3))));
          MR_Word Var_44;
          MR_Word Var_45;

          (env_ptr)->ml_backend__ml_tag_switch__gen_tagged_case_code_10_p_0_env_0__succeeded = (FuncDefns_41 != (MR_Word) ((MR_Unsigned) 0U));
          if ((env_ptr)->ml_backend__ml_tag_switch__gen_tagged_case_code_10_p_0_env_0__succeeded)
          {
            Var_44 = ((MR_Word) ((MR_hl_field(MR_mktag(1), FuncDefns_41, (MR_Integer) 0))));
            Var_45 = ((MR_Word) ((MR_hl_field(MR_mktag(1), FuncDefns_41, (MR_Integer) 1))));
          }
        }
        break;
      case (MR_Integer) 3:
        switch (((MR_Integer) ((MR_hl_field(MR_mktag(3), (env_ptr)->ml_backend__ml_tag_switch__gen_tagged_case_code_10_p_0_env_0__SubStmt_37, (MR_Integer) 0))))) {
          default:
            (env_ptr)->ml_backend__ml_tag_switch__gen_tagged_case_code_10_p_0_env_0__succeeded = MR_FALSE;
            break;
          case (MR_Integer) 1:
...
{
  {
    ...
    succeeded = ml_backend__ml_tag_switch__IntroducedFrom__pred__gen_ptag_case__253__1_2_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))));
    return succeeded;
  }
}
...
{
  {
    ...
    succeeded = ml_backend__ml_tag_switch__IntroducedFrom__pred__gen_ptag_case__228__1_2_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))));
    return succeeded;
  }
}
