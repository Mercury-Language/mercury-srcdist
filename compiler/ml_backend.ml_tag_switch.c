  ...
  MR_Word * STATE_VARIABLE_Info_8)
{
  ...
  else
  {
    ...
    MR_Word Var_57;
    MR_Word Var_58;
    MR_Word MaybeCode_69;
    MR_Box conv1_MaybeCode_69;
    ...
    mercury__list__reverse_2_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0), RevLaterStags_46, &LaterStags_47);
    {
      ...
      MR_hl_field(MR_mktag(2), Var_58, 0) = ((MR_Box) (FirstStag_45));
    }
    {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(0), FirstMatch_48, 0) = ((MR_Box) (Var_57));
    }
    ...
    mercury__map__lookup_3_p_0((MR_Word) (&hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_case_id_0), (MR_Word) (&ml_backend__ml_tag_switch__ml_backend__ml_tag_switch__type_ctor_info_maybe_code_0), CodeMap_2, ((MR_Box) (CaseId_43)), &conv1_MaybeCode_69);
    MaybeCode_69 = ((MR_Word) (conv1_MaybeCode_69));
    if (((MR_tag((MR_Word) MaybeCode_69)) == (MR_Integer) 1))
    {
      MR_Word EntryPackedArgsMap_70 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MaybeCode_69, (MR_Integer) 0))));
      MR_Word Goal_71 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MaybeCode_69, (MR_Integer) 1))));
      MR_Word STATE_VARIABLE_Info_22_72;

      ml_backend__ml_gen_info__ml_gen_info_set_packed_word_map_3_p_0(EntryPackedArgsMap_70, STATE_VARIABLE_Info_0_7, &STATE_VARIABLE_Info_22_72);
      ml_backend__ml_code_gen__ml_gen_goal_as_branch_block_7_p_0(CodeModel_3, Goal_71, &Stmt_50, STATE_VARIABLE_ReachableConstVarMaps_0_5, &STATE_VARIABLE_ReachableConstVarMaps_29_29, STATE_VARIABLE_Info_22_72, &STATE_VARIABLE_Info_30_30);
    }
    else
    {
      Stmt_50 = ((MR_Word) ((MR_hl_field(MR_mktag(0), MaybeCode_69, (MR_Integer) 0))));
