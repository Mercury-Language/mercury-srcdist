...
static void MR_CALL 
ml_backend__ml_tag_switch__ml_generate_tag_switch_13_p_0(
  MR_Word Var_14,
  MR_Word VarEntry_15,
  MR_Word CodeModel_16,
  MR_Word CanFail_17,
  MR_Word Context_18,
  uint8_t MaxPrimary_19,
  MR_Word CodeMap_20,
  MR_Word PtagCountMap_21,
  MR_Word ReachableConstVarMaps0_22,
  MR_Word PtagCaseMap_23,
  MR_Word * Stmts_24,
  ...
  MR_Word * STATE_VARIABLE_Info_29)
{
  ...
  if (succeeded)
  {
    ml_backend__ml_tag_switch__ml_generate_tag_switch_13_p_0(Var_11, VarEntry_12, CodeModel_13, CanFail_14, Context_15, MaxPrimary_21, CodeMap_23, PtagCountMap_22, ReachableConstVarMaps0_24, PtagCaseMap_27, Stmts_18, STATE_VARIABLE_Info_35_35, STATE_VARIABLE_Info_29);
    succeeded = MR_TRUE;
  }
  return succeeded;
}
  ...
  MR_Word * STATE_VARIABLE_Info_38)
{
  ...
  ml_backend__ml_code_util__ml_gen_var_4_p_0(STATE_VARIABLE_Info_0_37, Var_14, VarEntry_15, &VarLval_26);
  {
  ...
  {
    PtagRval_28 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(MR_mktag(3), PtagRval_28, 0) = ((MR_Box) ((MR_Unsigned) 5U));
    MR_hl_field(MR_mktag(3), PtagRval_28, 1) = ((MR_Box) ((MR_Unsigned) 0U));
    MR_hl_field(MR_mktag(3), PtagRval_28, 2) = ((MR_Box) (VarRval_27));
  }
  backend_libs__switch_util__order_ptags_by_count_3_p_0((MR_Word) (&hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_case_id_0), PtagCountMap_21, PtagCaseMap_23, &PtagCaseList_29);
  ml_backend__ml_tag_switch__gen_ptag_cases_13_p_0(Var_14, VarEntry_15, CanFail_17, CodeModel_16, Context_18, CodeMap_20, PtagCountMap_21, PtagCaseList_29, &PtagCases0_30, ReachableConstVarMaps0_22, &ReachableConstVarMaps_31, STATE_VARIABLE_Info_0_37, &STATE_VARIABLE_Info_40_40);
  ml_backend__ml_code_gen__ml_gen_record_consensus_const_var_map_3_p_0(ReachableConstVarMaps_31, STATE_VARIABLE_Info_40_40, &STATE_VARIABLE_Info_41_41);
  Var_43 = mercury__uint8__cast_to_int_1_f_0(MaxPrimary_19);
  {
    ...
    MR_hl_field(MR_mktag(1), Range_32, 1) = ((MR_Box) (Var_43));
  }
  ...
  ml_backend__ml_switch_gen__ml_switch_generate_default_6_p_0(CanFail_17, CodeModel_16, Context_18, &Default_34, STATE_VARIABLE_Info_41_41, &STATE_VARIABLE_Info_44_44);
  {
    ...
    MR_hl_field(MR_mktag(3), SwitchStmt0_35, 2) = ((MR_Box) (PtagRval_28));
    ...
    MR_hl_field(MR_mktag(3), SwitchStmt0_35, 6) = ((MR_Box) (Context_18));
  }
  ml_backend__ml_simplify_switch__ml_simplify_switch_4_p_0(SwitchStmt0_35, &SwitchStmt_36, STATE_VARIABLE_Info_44_44, STATE_VARIABLE_Info_38);
  {
    MR_Word base;
  ...
  MR_Word * STATE_VARIABLE_Info_53)
{
        ...
        case (MR_Integer) 1:
          ...
          else
          {
            ...
            if ((Var_91 == (MR_Word) ((MR_Unsigned) 0U)))
            {
              ...
              ml_backend__ml_tag_switch__lookup_code_map_8_p_0(CodeMap_19, CaseId_34, CodeModel_17, &Stmt_35, STATE_VARIABLE_ReachableConstVarMaps_0_50, STATE_VARIABLE_ReachableConstVarMaps_51, STATE_VARIABLE_Info_0_52, STATE_VARIABLE_Info_53);
            }
            else
              {
        ...
        case (MR_Integer) 3:
          {
            ...
            Var_96 = mercury__map__init_0_f_0((MR_Word) (&hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_case_id_0), (MR_Word) (&ml_backend__ml_tag_switch__ml_backend__ml_tag_switch__type_ctor_info_stags_0));
            ml_backend__ml_tag_switch__build_stag_rev_map_3_p_0(GoalList_32, Var_96, &RevMap_95);
            mercury__map__to_assoc_list_2_p_0((MR_Word) (&hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_case_id_0), (MR_Word) (&ml_backend__ml_tag_switch__ml_backend__ml_tag_switch__type_ctor_info_stags_0), RevMap_95, &GroupedGoalList_46);
            ...
            if (succeeded)
              ml_backend__ml_tag_switch__lookup_code_map_8_p_0(CodeMap_19, CaseId_79, CodeModel_17, &Stmt_35, STATE_VARIABLE_ReachableConstVarMaps_0_50, STATE_VARIABLE_ReachableConstVarMaps_51, STATE_VARIABLE_Info_0_52, STATE_VARIABLE_Info_53);
            else
  ...
  MainPtagMatch_48 = ml_backend__ml_tag_switch__make_ptag_match_1_f_0(MainPtag_25);
  ...
  MR_Word * STATE_VARIABLE_Info_8)
{
  ...
  else
  {
    ...
    MR_Word CaseId_41 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Group_17, (MR_Integer) 0))));
    MR_Word Stags_42 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Group_17, (MR_Integer) 1))));
    MR_Integer FirstStag_43 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), Stags_42, (MR_Integer) 0))));
    MR_Word RevLaterStags_44 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Stags_42, (MR_Integer) 1))));
    MR_Word LaterStags_45;
    MR_Word FirstMatch_46;
    MR_Word LaterMatches_47;
    MR_Word Stmt_48;
    MR_Word Var_55;
    MR_Word Var_56;
    MR_Word MaybeCode_67;
    MR_Box conv1_MaybeCode_67;

    mercury__list__reverse_2_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0), RevLaterStags_44, &LaterStags_45);
    {
      Var_56 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(2), Var_56, 0) = ((MR_Box) (FirstStag_43));
    }
    {
      Var_55 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
    ...
    {
      FirstMatch_46 = (MR_Word) MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), FirstMatch_46, 0) = ((MR_Box) (Var_55));
    }
    LaterMatches_47 = mercury__list__map_2_f_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0), (MR_Word) (&ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_case_match_cond_0), (MR_Word) (&ml_backend__ml_tag_switch_scalar_common_1[6]), LaterStags_45);
    mercury__map__lookup_3_p_0((MR_Word) (&hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_case_id_0), (MR_Word) (&ml_backend__ml_tag_switch__ml_backend__ml_tag_switch__type_ctor_info_maybe_code_0), CodeMap_2, ((MR_Box) (CaseId_41)), &conv1_MaybeCode_67);
    MaybeCode_67 = ((MR_Word) (conv1_MaybeCode_67));
    if (((MR_tag((MR_Word) MaybeCode_67)) == (MR_Integer) 1))
    {
      MR_Word EntryPackedArgsMap_68 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MaybeCode_67, (MR_Integer) 0))));
      MR_Word Goal_69 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MaybeCode_67, (MR_Integer) 1))));
      MR_Word STATE_VARIABLE_Info_22_70;

      ml_backend__ml_gen_info__ml_gen_info_set_packed_word_map_3_p_0(EntryPackedArgsMap_68, STATE_VARIABLE_Info_0_7, &STATE_VARIABLE_Info_22_70);
      ml_backend__ml_code_gen__ml_gen_goal_as_branch_block_7_p_0(CodeModel_3, Goal_69, &Stmt_48, STATE_VARIABLE_ReachableConstVarMaps_0_5, &STATE_VARIABLE_ReachableConstVarMaps_29_29, STATE_VARIABLE_Info_22_70, &STATE_VARIABLE_Info_30_30);
    }
    else
    {
      Stmt_48 = ((MR_Word) ((MR_hl_field(MR_mktag(0), MaybeCode_67, (MR_Integer) 0))));
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(0), Case_21, 0) = ((MR_Box) (FirstMatch_46));
      MR_hl_field(MR_mktag(0), Case_21, 1) = ((MR_Box) (LaterMatches_47));
      MR_hl_field(MR_mktag(0), Case_21, 2) = ((MR_Box) (Stmt_48));
    }
