...
MR_decl_static(ml_backend__ml_tag_switch__IntroducedFrom__pred__gen_ptag_case__188__1_2_0)
...
MR_def_label(ml_backend__ml_tag_switch__gen_ptag_case_10_0,8)
	...
	MR_tfield(0, MR_tempr1, 1) = (MR_Word) MR_ENTRY_AP(ml_backend__ml_tag_switch__IntroducedFrom__pred__gen_ptag_case__188__1_2_0);
	MR_tfield(0, MR_tempr1, 2) = (MR_Integer) 2;
...
MR_BEGIN_MODULE(ml_backend__ml_tag_switch_module16)
	MR_init_entry1(ml_backend__ml_tag_switch__IntroducedFrom__pred__gen_ptag_case__188__1_2_0);
	MR_INIT_PROC_LAYOUT_ADDR(mercury__ml_backend__ml_tag_switch__IntroducedFrom__pred__gen_ptag_case__188__1_2_0);
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'IntroducedFrom__pred__gen_ptag_case__188__1'/2 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(ml_backend__ml_tag_switch__IntroducedFrom__pred__gen_ptag_case__188__1_2_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tempr1 = MR_r1;
