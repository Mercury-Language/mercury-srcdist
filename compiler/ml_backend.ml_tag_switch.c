...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(3), SwitchStmt0_34, 1) = ((MR_Box) (MR_mkword(MR_mktag(3), &ml_backend__ml_tag_switch_scalar_common_2[5])));
...
{
  {
    ...
    mercury__map__lookup_3_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_ptag_0), (MR_Word) (&ml_backend__ml_tag_switch_scalar_common_1[1]), PtagCountMap_16, ((MR_Box) (MainPtag_20)), &conv0_CountInfo_24);
    ...
    OtherPtagMatches_44 = mercury__list__map_2_f_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_ptag_0), (MR_Word) (&ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_case_match_cond_0), (MR_Word) (&ml_backend__ml_tag_switch_scalar_common_1[6]), OtherPtags_21);
    {
      MR_Word base;
...
{
  {
      ...
      case (MR_Integer) 1:
        {
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(3), StagRval_25, 1) = ((MR_Box) (MR_mkword(MR_mktag(3), &ml_backend__ml_tag_switch_scalar_common_2[6])));
    ...
    ml_backend__ml_switch_gen__ml_switch_generate_default_6_p_0(CanFail_18, CodeModel_17, Context_19, &Default_32, STATE_VARIABLE_Info_50_50, &STATE_VARIABLE_Info_51_51);
    {
      ...
      MR_hl_field(MR_mktag(3), SwitchStmt_34, 1) = ((MR_Box) (MR_mkword(MR_mktag(3), &ml_backend__ml_tag_switch_scalar_common_2[5])));
