...
{
  {
    ...
    {
      ml_backend__ml_tag_switch__Var_5 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), ml_backend__ml_tag_switch__Var_5, 0) = ((MR_Box) (ml_backend__ml_tag_switch__Stag_3));
    }
    {
...
{
  {
    ...
    {
      ml_backend__ml_tag_switch__Var_5 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), ml_backend__ml_tag_switch__Var_5, 0) = ((MR_Box) (ml_backend__ml_tag_switch__Ptag_3));
    }
    {
      ml_backend__ml_tag_switch__Var_4 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(3), ml_backend__ml_tag_switch__Var_4, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 1));
...
{
  {
    ...
    {
      ml_backend__ml_tag_switch__Var_90 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), ml_backend__ml_tag_switch__Var_90, 0) = ((MR_Box) (ml_backend__ml_tag_switch__MainPtag_20));
    }
    {
  ...
  MR_Word * ml_backend__ml_tag_switch__STATE_VARIABLE_Info_6)
{
  if ((ml_backend__ml_tag_switch__HeadVar__1_1 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
  ...
  else
    {
      ...
      {
        ml_backend__ml_tag_switch__Var_46 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), ml_backend__ml_tag_switch__Var_46, 0) = ((MR_Box) (ml_backend__ml_tag_switch__FirstStag_32));
      }
      {
