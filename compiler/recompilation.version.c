...
{
  {
    ...
    else
    {
      ...
      Var_38 = mercury__term__get_term_context_1_f_0((MR_Word) (&mercury__term__term__type_ctor_info_generic_0), Term_5);
      {
        ...
        MR_hl_field(MR_mktag(1), Spec_17, 4) = ((MR_Box) (MR_mkword(MR_mktag(1), &recompilation__version_scalar_common_2[35])));
      }
      {
    ...
    else
    {
      ...
      else
      {
        ...
        Var_42 = mercury__term__get_term_context_1_f_0((MR_Word) (&mercury__term__term__type_ctor_info_generic_0), Term_3);
        {
          ...
          MR_hl_field(MR_mktag(1), Spec_21, 4) = ((MR_Box) (MR_mkword(MR_mktag(1), &recompilation__version_scalar_common_2[33])));
        }
        {
      ...
      case (MR_Integer) 0:
        {
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                TypeInfo_303_303 = (MR_Word) (&recompilation__version_scalar_common_2[15]);
      ...
      case (MR_Integer) 1:
        {
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              TypeInfo_321_321 = (MR_Word) (&recompilation__version_scalar_common_2[20]);
              ...
              if (succeeded)
              {
                ...
                if (succeeded)
                {
                  TypeInfo_323_323 = (MR_Word) (&recompilation__version_scalar_common_2[21]);
      ...
      case (MR_Integer) 2:
        {
          ...
          if (succeeded)
          {
            ...
            TypeInfo_333_333 = (MR_Word) (&recompilation__version_scalar_common_2[19]);
            ...
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                TypeInfo_335_335 = (MR_Word) (&recompilation__version_scalar_common_2[21]);
                  ...
                  if (succeeded)
                  {
                    ...
                    if (succeeded)
                    {
                      switch (PredOrFunc_47) {
                        default: /*NOTREACHED*/ MR_assert(0);
                        case (MR_Integer) 1:
                          succeeded = mercury__builtin__unify_2_p_0((MR_Word) (&recompilation__version_scalar_common_2[24]), ((MR_Box) (Det1_51)), ((MR_Box) (Det2_64)));
                          break;
                        case (MR_Integer) 0:
                          succeeded = MR_TRUE;
                          break;
          ...
          case (MR_Integer) 1:
            {
              ...
              if (succeeded)
              {
                ...
                if (succeeded)
                {
                  ...
                  if (succeeded)
                  {
                    TypeInfo_332_332 = (MR_Word) (&recompilation__version_scalar_common_2[24]);
          ...
          case (MR_Integer) 2:
            {
              ...
              if (succeeded)
              {
                ...
                if (succeeded)
                {
                  ...
                  if (succeeded)
                  {
                    TypeInfo_312_312 = (MR_Word) (&recompilation__version_scalar_common_2[17]);
          ...
          case (MR_Integer) 4:
            {
              ...
              if (succeeded)
              {
                ...
                if (succeeded)
                {
                  ...
                  if (succeeded)
                  {
                    TypeInfo_344_344 = (MR_Word) (&recompilation__version_scalar_common_2[27]);
          ...
          case (MR_Integer) 5:
            {
              ...
              if (succeeded)
              {
                ...
                if (succeeded)
                {
                  TypeInfo_349_349 = (MR_Word) (&recompilation__version_scalar_common_2[28]);
                  succeeded = mercury__builtin__unify_2_p_0(TypeInfo_349_349, ((MR_Box) (FunDeps_180)), ((MR_Box) (Var_293)));
                  if (succeeded)
                  {
                    TypeInfo_350_350 = (MR_Word) (&recompilation__version_scalar_common_2[23]);
                    succeeded = mercury__builtin__unify_2_p_0(TypeInfo_350_350, ((MR_Box) (Name_239)), ((MR_Box) (Var_294)));
                    if (succeeded)
                    {
                      TypeInfo_351_351 = (MR_Word) (&recompilation__version_scalar_common_2[30]);
          ...
          case (MR_Integer) 6:
            {
              ...
              if (succeeded)
              {
                ...
                if (succeeded)
                {
                  TypeInfo_325_325 = (MR_Word) (&recompilation__version_scalar_common_2[22]);
                  succeeded = mercury__builtin__unify_2_p_0(TypeInfo_325_325, ((MR_Box) (Name_240)), ((MR_Box) (Var_297)));
                  if (succeeded)
                  {
                    TypeInfo_326_326 = (MR_Word) (&recompilation__version_scalar_common_2[22]);
                    succeeded = mercury__builtin__unify_2_p_0(TypeInfo_326_326, ((MR_Box) (Types_192)), ((MR_Box) (Var_298)));
                    if (succeeded)
                    {
                      TypeInfo_327_327 = (MR_Word) (&recompilation__version_scalar_common_2[23]);
                ...
                if (succeeded)
                {
                  ...
                  if (succeeded)
                  {
                    ...
                    if (succeeded)
                    {
                      ...
                      if (succeeded)
                      {
                        TypeInfo_339_339 = (MR_Word) (&recompilation__version_scalar_common_2[25]);
          ...
          case (MR_Integer) 10:
            {
              ...
              if (succeeded)
              {
                ...
                TypeInfo_345_345 = (MR_Word) (&recompilation__version_scalar_common_2[28]);
                ...
                if (succeeded)
                {
                  ...
                  if (succeeded)
                  {
                    TypeInfo_347_347 = (MR_Word) (&recompilation__version_scalar_common_2[29]);
      ...
      case (MR_Integer) 0:
        {
...

          {
            ...
            MR_hl_field(MR_mktag(0), NameItemTypeDefn_18, 2) = ((MR_Box) (MR_mkword(MR_mktag(3), &recompilation__version_scalar_common_2[14])));
