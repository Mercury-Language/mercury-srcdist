            ...
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                ...
                if (succeeded)
                {
                  ...
                  if (succeeded)
                  {
                    mercury__term__apply_renaming_in_terms_3_p_0(TypeCtorInfo_39_80, InstRenaming_57, AllModeTerms2_65, &SubstAllModeTerms2_66);
                    succeeded = mercury__term__list_subsumes_3_p_0(TypeCtorInfo_39_80, AllModeTerms1_64, SubstAllModeTerms2_66, &Var_67);
                    if (succeeded)
                      succeeded = mercury__term__list_subsumes_3_p_0(TypeCtorInfo_39_80, SubstAllModeTerms2_66, AllModeTerms1_64, &Var_68);
                  }
                }
              }
            }
