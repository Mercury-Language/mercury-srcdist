      ...
      case (MR_Integer) 2:
        {
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                succeeded = parse_tree__prog_data____Unify____inst_defn_0_0(MaybeForTypeCtor_33, Var_233);
                if (succeeded)
                {
          ...
          case (MR_Integer) 0:
            {
              ...
              if (succeeded)
              {
                ...
                if (succeeded)
                {
                  succeeded = parse_tree__prog_data____Unify____mode_defn_0_0(Args_194, Var_236);
                  if (succeeded)
                  {
