...
{
  {
    ...
    else
    {
      ...
      Var_39 = mercury__term__get_term_context_1_f_0((MR_Word) (&mercury__term__term__type_ctor_info_generic_0), Term_5);
      {
        ...
        MR_hl_field(MR_mktag(0), Var_38, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &recompilation__version_scalar_common_2[39])));
      }
      {
    ...
    else
    {
      ...
      else
      {
        ...
        Var_43 = mercury__term__get_term_context_1_f_0((MR_Word) (&mercury__term__term__type_ctor_info_generic_0), Term_3);
        {
          ...
          MR_hl_field(MR_mktag(0), Var_42, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &recompilation__version_scalar_common_2[38])));
        }
        {
