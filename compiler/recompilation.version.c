      ...
      else
      {
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            /* direct tailcall eliminated */
            {
              MR_Word next_value_of_HeadVar__1_1 = Methods1_4;
              MR_Word next_value_of_HeadVar__2_2 = Methods2_6;
  ...
  MR_Word * STATE_VARIABLE_Info_4)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      /* direct tailcall eliminated */
      {
        MR_Word next_value_of_HeadVar__2_2 = Items_11;
        MR_Word next_value_of_STATE_VARIABLE_Info_0_3 = STATE_VARIABLE_Info_15_15;
