  ...
  MR_Word * STATE_VARIABLE_Specs_20)
{
  ...
  if (succeeded)
  {
    ...
    STATE_VARIABLE_Specs_1_54 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_diag_spec_0), ColorSchemeSpecs_13, STATE_VARIABLE_Specs_0_19);
  }
  else
    {
  ...
  if (((MR_tag((MR_Word) MaybeConvertColorSpecs_14)) == (MR_Integer) 0))
  {
    ...
    Var_58 = mercury__one_or_more__one_or_more_to_list_1_f_1((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_diag_spec_0), ConvertColorSpecs_16);
    *STATE_VARIABLE_Specs_20 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_diag_spec_0), Var_58, STATE_VARIABLE_Specs_1_54);
  }
  else
