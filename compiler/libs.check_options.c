  ...
  MR_Word * STATE_VARIABLE_Specs_31)
{
  ...
  mercury__getopt__lookup_string_option_3_p_0((MR_Word) (&libs__options__libs__options__type_ctor_info_option_0), OptionTable_9, ((MR_Box) ((MR_Integer) 765)), &FeedbackFile_24);
