  ...
  MR_Word * STATE_VARIABLE_Specs_19)
{
  ...
  mercury__getopt__lookup_int_option_3_p_0((MR_Word) (&libs__options__libs__options__type_ctor_info_option_0), OptionTable_5, ((MR_Box) ((MR_Integer) 248)), &IncompleteSwitchThreshold_8);
