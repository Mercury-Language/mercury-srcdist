...
{
  {
    ...
    {
      transform_hlds__trailing_analysis__conv0_LambdaHeadVar__2_126 = transform_hlds__trailing_analysis__IntroducedFrom__func__check_goal_for_trail_mods__453__1_1_f_0(((MR_Word) transform_hlds__trailing_analysis__wrapper_arg_1));
    }
...
{
  {
    ...
    {
      libs__globals__lookup_bool_option_3_p_0(transform_hlds__trailing_analysis__Globals_4, (MR_Integer) 223, &transform_hlds__trailing_analysis__UseTrail_5);
    }
      ...
      case (MR_Integer) 1:
        {
          ...
          {
            transform_hlds__dependency_graph__module_info_ensure_dependency_info_2_p_0(transform_hlds__trailing_analysis__STATE_VARIABLE_ModuleInfo_0_17, &transform_hlds__trailing_analysis__STATE_VARIABLE_ModuleInfo_21_21);
          }
          {
            hlds__hlds_module__module_info_dependency_info_2_p_0(transform_hlds__trailing_analysis__STATE_VARIABLE_ModuleInfo_21_21, &transform_hlds__trailing_analysis__DepInfo_9);
          }
          {
            hlds__hlds_module__hlds_dependency_info_get_dependency_ordering_2_p_0((MR_Word) &hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_proc_id_0, transform_hlds__trailing_analysis__DepInfo_9, &transform_hlds__trailing_analysis__SCCs_10);
          }
          {
            libs__globals__lookup_bool_option_3_p_0(transform_hlds__trailing_analysis__Globals_4, (MR_Integer) 84, &transform_hlds__trailing_analysis__Debug_11);
          }
          {
