        ...
        case (MR_Integer) 4:
          {
            ...
            MR_Word Cases_87;
            MR_Unsigned packed_word_2 = (MR_Unsigned) ((MR_hl_field(3, STATE_VARIABLE_GoalExpr_0_110, (MR_Integer) 2)));
        ...
        case (MR_Integer) 5:
          {
            ...
            if ((env).transform_hlds__trailing_analysis__trail_annotate_goal_2_7_p_0_env_0__succeeded)
            {
              packed_word_1 = (MR_Unsigned) ((MR_hl_field(3, Reason_100, (MR_Integer) 2)));
                ...
                else
                {
                  ...
                  else
                  {
                    ...
                    else
                    {
                      ...
                      MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(0, Var_122, (MR_Integer) 0)));
          ...
          case (MR_Integer) 5:
            {
              ...
              if ((env).transform_hlds__trailing_analysis__check_goal_for_trail_mods_7_p_0_env_0__succeeded)
              {
                packed_word_1 = (MR_Unsigned) ((MR_hl_field(3, Reason_101, (MR_Integer) 2)));
