...
transform_hlds__trailing_analysis__IntroducedFrom__func__check_goal_for_trail_mods__460__1_1_f_0(
        ...
        else
        {
          ...
          else
          {
            ...
            else
            {
              ...
              libs__globals__lookup_bool_option_3_p_0(Globals_52, (MR_Integer) 502, &IntermodAnalysis_53);
  ...
  MR_Box wrapper_arg_1)
{
  ...
  conv2_LambdaHeadVar__2_130 = transform_hlds__trailing_analysis__IntroducedFrom__func__check_goal_for_trail_mods__460__1_1_f_0(((MR_Word) (wrapper_arg_1)));
            ...
            else
            {
              ...
              else
              {
                ...
                else
                {
                  ...
                  libs__globals__lookup_bool_option_3_p_0(Globals_57, (MR_Integer) 502, &Intermod_58);
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_18)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_4, (MR_Integer) 266, &UseTrail_5);
  switch (UseTrail_5) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 0:
