...
{
  {
    ...
    switch (*Status_9) {
      ...
      case (MR_Integer) 1:
        {
          hlds__hlds_goal__goal_info_add_feature_3_p_0((MR_Integer) 17, GoalInfo0_30, &GoalInfo_32);
        }
        break;
    }
    {
...
{
  {
    ...
    switch (_Status_10) {
      ...
      case (MR_Integer) 1:
        {
          hlds__hlds_goal__goal_info_add_feature_3_p_0((MR_Integer) 17, GoalInfo0_28, &GoalInfo_30);
        }
        break;
    }
    {
...
{
  {
    ...
    switch (*Status_9) {
      ...
      case (MR_Integer) 1:
        {
          hlds__hlds_goal__goal_info_add_feature_3_p_0((MR_Integer) 17, GoalInfo0_12, &GoalInfo_14);
        }
        break;
    }
    {
