        ...
        else
        {
          ...
          else
          {
            ...
            else
            {
              ...
              libs__globals__lookup_bool_option_3_p_0(Globals_52, (MR_Integer) 410, &IntermodAnalysis_53);
            ...
            else
            {
              ...
              else
              {
                ...
                else
                {
                  ...
                  libs__globals__lookup_bool_option_3_p_0(Globals_57, (MR_Integer) 410, &Intermod_58);
    ...
    case (MR_Integer) 1:
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_4, (MR_Integer) 690, &Debug_12);
        {
