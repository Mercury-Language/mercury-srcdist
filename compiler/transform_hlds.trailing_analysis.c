        ...
        else
        {
          ...
          else
          {
            ...
            else
            {
              ...
              libs__globals__lookup_bool_option_3_p_0(Globals_52, (MR_Integer) 435, &IntermodAnalysis_53);
  ...
  MR_Word * STATE_VARIABLE_Status_9)
{
  ...
  else
  {
    ...
    TypeCtorCategory_11 = hlds__type_util__classify_type_2_f_0(ModuleInfo_5, Type_6);
            ...
            else
            {
              ...
              else
              {
                ...
                else
                {
                  ...
                  libs__globals__lookup_bool_option_3_p_0(Globals_57, (MR_Integer) 435, &Intermod_58);
    ...
    case (MR_Integer) 1:
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_4, (MR_Integer) 716, &Debug_12);
        {
