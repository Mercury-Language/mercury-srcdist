...
static /* final */ const MR_Box transform_hlds__trailing_analysis_scalar_common_5[2][8];
          ...
          else
          {
            ...
            else
            {
              ...
              else
              {
                ...
                libs__globals__lookup_bool_option_3_p_0(Globals_52, (MR_Integer) 491, &IntermodAnalysis_53);
          ...
          case (MR_Integer) 1:
            {
              ...
              else
              {
...

                {
                  ...
                  MR_hl_field(MR_mktag(0), Var_61, 0) = ((MR_Box) (&transform_hlds__trailing_analysis_scalar_common_6[2]));
      ...
      case (MR_Integer) 2:
        {
          ...
          else
          {
...

            {
              ...
              MR_hl_field(MR_mktag(0), Var_51, 0) = ((MR_Box) (&transform_hlds__trailing_analysis_scalar_common_6[2]));
                ...
                case (MR_Integer) 3:
                  {
                    ...
                    else
                    {
...

                      {
                        ...
                        MR_hl_field(MR_mktag(0), Var_71, 0) = ((MR_Box) (&transform_hlds__trailing_analysis_scalar_common_6[2]));
                ...
                case (MR_Integer) 4:
                  {
                    ...
                    else
                    {
...

                      {
                        ...
                        MR_hl_field(MR_mktag(0), Var_81, 0) = ((MR_Box) (&transform_hlds__trailing_analysis_scalar_common_6[2]));
                ...
                case (MR_Integer) 2:
                  {
                    ...
                    else
                    {
...

                      {
                        ...
                        MR_hl_field(MR_mktag(0), Var_91, 0) = ((MR_Box) (&transform_hlds__trailing_analysis_scalar_common_6[2]));
        ...
        case (MR_Integer) 2:
          {
            ...
            hlds__vartypes__lookup_var_types_3_p_0(VarTypes_7, Args_9, &Types_31);
            {
              ...
              MR_hl_field(MR_mktag(0), Var_35, 0) = ((MR_Box) (&transform_hlds__trailing_analysis_scalar_common_6[2]));
              ...
              else
              {
                ...
                else
                {
                  ...
                  else
                  {
                    ...
                    libs__globals__lookup_bool_option_3_p_0(Globals_57, (MR_Integer) 491, &Intermod_58);
...
{
  {
    ...
    {
      Var_7 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), Var_7, 0) = ((MR_Box) (&transform_hlds__trailing_analysis_scalar_common_6[2]));
...
{
  {
    ...
    hlds__vartypes__lookup_var_types_3_p_0(VarTypes_6, Vars_7, &Types_9);
    {
      ...
      MR_hl_field(MR_mktag(0), Var_13, 0) = ((MR_Box) (&transform_hlds__trailing_analysis_scalar_common_6[2]));
        ...
        case (MR_Integer) 2:
          {
            ...
            hlds__vartypes__lookup_var_types_3_p_0(VarTypes_7, Args_9, &Types_23);
            {
              ...
              MR_hl_field(MR_mktag(0), Var_27, 0) = ((MR_Box) (&transform_hlds__trailing_analysis_scalar_common_6[2]));
...
{
  {
...

    {
...

      {
        ...
        MR_hl_field(MR_mktag(0), Var_39, 0) = ((MR_Box) (&transform_hlds__trailing_analysis_scalar_common_7[0]));
      ...
      else
      {
        ...
        mercury__list__foldl_4_p_0((MR_Word) (&transform_hlds__trailing_analysis_scalar_common_1[2]), (MR_Word) (&transform_hlds__trailing_analysis_scalar_common_1[2]), (MR_Word) (&transform_hlds__trailing_analysis_scalar_common_2[3]), MaybeAnalysisStatuses_77, ((MR_Box) (MR_mkword(MR_mktag(1), &transform_hlds__trailing_analysis_scalar_common_8[0]))), &conv9_MaybeAnalysisStatus_12);
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(0), Var_22, 0) = ((MR_Box) (&transform_hlds__trailing_analysis_scalar_common_6[1]));
...
{
  {
    ...
    mercury__io__write_line_4_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_trailing_status_0), Stream_7, ((MR_Box) (Status_10)));
    {
      ...
      MR_hl_field(MR_mktag(0), Var_26, 0) = ((MR_Box) (&transform_hlds__trailing_analysis_scalar_common_5[1]));
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_4, (MR_Integer) 254, &UseTrail_5);
    switch (UseTrail_5) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
      ...
      case (MR_Integer) 1:
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_4, (MR_Integer) 97, &Debug_11);
          {
