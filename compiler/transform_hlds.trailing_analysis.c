...
{
  {
...

    {
      ...
      else
      {
        ...
        TypeInfo_13_83 = (MR_Word) &transform_hlds__trailing_analysis_scalar_common_1[2];
        mercury__list__map_3_p_0((MR_Word) &transform_hlds__trailing_analysis__transform_hlds__trailing_analysis__type_ctor_info_trail_proc_result_0, TypeInfo_13_83, (MR_Word) &transform_hlds__trailing_analysis_scalar_common_2[2], (env).transform_hlds__trailing_analysis__trail_analyse_scc_5_p_0_env_0__ProcResults_10, &MaybeAnalysisStatuses_75);
        mercury__list__foldl_4_p_0(TypeInfo_13_83, TypeInfo_13_83, (MR_Word) &transform_hlds__trailing_analysis_scalar_common_2[3], MaybeAnalysisStatuses_75, ((MR_Box) (MR_mkword(MR_mktag(1), &transform_hlds__trailing_analysis_scalar_common_8[0]))), &conv9_MaybeAnalysisStatus_12);
