      ...
      case (MR_Integer) 1:
        {
          ...
          mercury__io__write_line_4_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_trailing_status_0), DebugStream_14, ((MR_Box) (TrailingStatus_11)));
          {
            ...
            MR_hl_field(0, Var_71, 0) = ((MR_Box) (&transform_hlds__trailing_analysis_scalar_common_6[1]));
            MR_hl_field(0, Var_71, 1) = ((MR_Box) (transform_hlds__trailing_analysis__trail_analyse_scc_5_p_0_16));
            MR_hl_field(0, Var_71, 2) = ((MR_Box) ((MR_Integer) 2));
            MR_hl_field(0, Var_71, 3) = ((MR_Box) (DebugStream_14));
            MR_hl_field(0, Var_71, 4) = ((MR_Box) (STATE_VARIABLE_ModuleInfo_18_18));
          }
    ...
    case (MR_Integer) 1:
      {
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            OpModeAugment_7 = ((MR_Word) ((MR_hl_field(2, Var_20, (MR_Integer) 0))));
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_4, (MR_Integer) 107, &Debug_11);
        {
          ...
          MR_hl_field(0, Var_23, 0) = ((MR_Box) (&transform_hlds__trailing_analysis_scalar_common_6[0]));
          MR_hl_field(0, Var_23, 1) = ((MR_Box) (transform_hlds__trailing_analysis__analyse_trail_usage_in_module_2_p_0_1));
          MR_hl_field(0, Var_23, 2) = ((MR_Box) ((MR_Integer) 2));
          MR_hl_field(0, Var_23, 3) = ((MR_Box) (Debug_11));
          MR_hl_field(0, Var_23, 4) = ((MR_Box) (Pass1Only_8));
        }
        ...
        if (succeeded)
        {
          Var_27 = ((MR_Word) ((MR_hl_field(3, OpMode_6, (MR_Integer) 0))));
          succeeded = ((MR_tag((MR_Word) Var_27)) == (MR_Integer) 2);
          if (succeeded)
          {
            Var_28 = ((MR_Word) ((MR_hl_field(2, Var_27, (MR_Integer) 0))));
        ...
        if (succeeded)
        {
          ...
          hlds__hlds_module__module_info_get_valid_pred_ids_2_p_0(STATE_VARIABLE_ModuleInfo_26_26, &PredIds_15);
          {
            ...
            MR_hl_field(0, Var_29, 0) = ((MR_Box) (&transform_hlds__trailing_analysis_scalar_common_7[0]));
            MR_hl_field(0, Var_29, 1) = ((MR_Box) (transform_hlds__trailing_analysis__analyse_trail_usage_in_module_2_p_0_2));
            MR_hl_field(0, Var_29, 2) = ((MR_Box) ((MR_Integer) 1));
            MR_hl_field(0, Var_29, 3) = ((MR_Box) (STATE_VARIABLE_ModuleInfo_26_26));
          }
