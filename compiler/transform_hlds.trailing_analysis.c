          ...
          else
          {
            ...
            else
            {
              ...
              else
              {
                ...
                libs__globals__lookup_bool_option_3_p_0(Globals_52, (MR_Integer) 358, &IntermodAnalysis_53);
...
{
  {
    ...
    conv0_LambdaHeadVar__2_125 = transform_hlds__trailing_analysis__IntroducedFrom__func__check_goal_for_trail_mods__454__1_1_f_0(((MR_Word) (wrapper_arg_1)));
              ...
              else
              {
                ...
                else
                {
                  ...
                  else
                  {
                    ...
                    libs__globals__lookup_bool_option_3_p_0(Globals_57, (MR_Integer) 358, &Intermod_58);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_4, (MR_Integer) 245, &UseTrail_5);
    switch (UseTrail_5) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
