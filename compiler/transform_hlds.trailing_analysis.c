      ...
      case (MR_Integer) 1:
        {
          ...
          if ((MaybeProcTrailingInfo_31 == (MR_Word) ((MR_Integer) 0)))
          {
          ...
          else
          {
            ...
            if ((MaybeResultStatus_33 == (MR_Word) ((MR_Integer) 0)))
            {
              {
          ...
          else
          {
            ...
            else
            {
              ...
              else
              {
                ...
                libs__globals__lookup_bool_option_3_p_0(Globals_52, (MR_Integer) 342, &IntermodAnalysis_53);
          ...
          case (MR_Integer) 5:
            {
              ...
              if ((env).transform_hlds__trailing_analysis__trail_annotate_goal_2_7_p_0_env_0__succeeded)
              {
                ...
                Var_115 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Reason_99, (MR_Integer) 2))));
    ...
    switch (MR_tag((MR_Word) TypeCtorCat_7)) {
      ...
      case (MR_Integer) 3:
        switch (((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), TypeCtorCat_7, (MR_Integer) 0)))) {
          ...
          case (MR_Integer) 1:
            {
              MR_Word Var_47 = ((MR_Word) ((MR_hl_field(MR_mktag(3), TypeCtorCat_7, (MR_Integer) 1))));
...
{
  {
    ...
    if ((MaybeCalleeTrailingInfo_21 == (MR_Word) ((MR_Integer) 0)))
      MaybeResult_11 = (MR_Word) ((MR_Integer) 0);
    else
    {
...
{
  {
    ...
    if (succeeded)
    {
      ...
      *MaybeStatus_6 = (MR_Word) ((MR_Integer) 0);
  }
}
...
{
  {
    ...
    succeeded = mercury__set__fold_4_p_3((MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_proc_id_0), (MR_Word) (&transform_hlds__trailing_analysis_scalar_common_1[3]), Var_7, Closures_5, ((MR_Box) ((MR_Integer) 0)), &conv1_Conditionals_6);
    if (succeeded)
    {
              ...
              else
              {
                ...
                else
                {
                  ...
                  else
                  {
                    ...
                    libs__globals__lookup_bool_option_3_p_0(Globals_57, (MR_Integer) 342, &Intermod_58);
                    ...
                    else
                    {
                      ...
                      if ((MaybeResult_60 == (MR_Word) ((MR_Integer) 0)))
                      {
                        *Result_11 = (MR_Integer) 0;
                        switch (Intermod_58) {
                          default: /*NOTREACHED*/ MR_assert(0);
                          case (MR_Integer) 0:
                            *MaybeAnalysisStatus_12 = (MR_Word) ((MR_Integer) 0);
                            break;
                          case (MR_Integer) 1:
                            {
                              *MaybeAnalysisStatus_12 = (MR_Word) (MR_mkword(MR_mktag(1), &transform_hlds__trailing_analysis_scalar_common_8[0]));
                      ...
                      else
                      {
                        ...
                        *Result_11 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_140, (MR_Integer) 0))));
            ...
            case (MR_Integer) 5:
              {
                ...
                if ((env).transform_hlds__trailing_analysis__check_goal_for_trail_mods_7_p_0_env_0__succeeded)
                {
                  ...
                  Var_113 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Reason_100, (MR_Integer) 2))));
...
{
  {
    ...
    if ((MaybeBestStatus_25 == (MR_Word) ((MR_Integer) 0)))
    {
      MR_Word Answer_28;
...
{
  {
    ...
    if ((MaybeCalleeTrailingInfo_13 == (MR_Word) ((MR_Integer) 0)))
      *MaybeResult_10 = (MR_Word) ((MR_Integer) 0);
    else
    {
...
{
  {
    ...
    {
      MR_Word Var_60 = ((MR_Word) ((MR_hl_field(MR_mktag(0), (env_ptr)->transform_hlds__trailing_analysis__trail_analyse_scc_5_p_0_env_0__ProcResult_57, (MR_Integer) 1))));
...
{
  {
...

    {
      ...
      (env_ptr)->transform_hlds__trailing_analysis__trail_analyse_scc_5_p_0_env_0__Var_61 = ((MR_Word) ((MR_hl_field(MR_mktag(0), (env_ptr)->transform_hlds__trailing_analysis__trail_analyse_scc_5_p_0_env_0__EResult_58, (MR_Integer) 1))));
...
{
  {
...

    {
      ...
      (env_ptr)->transform_hlds__trailing_analysis__trail_analyse_scc_5_p_0_env_0__Var_62 = ((MR_Word) ((MR_hl_field(MR_mktag(0), (env_ptr)->transform_hlds__trailing_analysis__trail_analyse_scc_5_p_0_env_0__CResult_63, (MR_Integer) 1))));
...
{
  {
...

    {
      ...
      if (((env).transform_hlds__trailing_analysis__trail_analyse_scc_5_p_0_env_0__ProcResults_10 == (MR_Word) ((MR_Integer) 0)))
      {
        {
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_4, (MR_Integer) 234, &UseTrail_5);
    switch (UseTrail_5) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
      ...
      case (MR_Integer) 1:
        {
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              ...
              succeeded = (Var_28 == (MR_Word) ((MR_Integer) 8));
            }
          }
          if (succeeded)
          {
