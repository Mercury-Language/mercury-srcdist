  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_18)
{
  ...
  transform_hlds__trailing_analysis__trail_annotate_goal_2_7_p_0(VarTable_7, GoalInfo0_30, GoalExpr0_29, &GoalExpr_31, Status_9, STATE_VARIABLE_ModuleInfo_0_17, STATE_VARIABLE_ModuleInfo_18);
  switch (*Status_9) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 2:
    case (MR_Integer) 0:
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_12)
{
  ...
  transform_hlds__trailing_analysis__trail_annotate_goal_2_7_p_0(VarTable_9, GoalInfo0_28, GoalExpr0_27, &GoalExpr_29, &_Status_10, STATE_VARIABLE_ModuleInfo_0_11, &STATE_VARIABLE_ModuleInfo_16_16);
  switch (_Status_10) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 2:
    case (MR_Integer) 0:
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_13)
{
  ...
  {
    MR_Word Var_30 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MaybeBestStatus_25, (MR_Integer) 0))));
    MR_Word Var_31 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_30, (MR_Integer) 1))));

    *AnalysisStatus_8 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Var_30, (MR_Integer) 2))) & (MR_Integer) 3);
    *Result_7 = (MR_Word) (Var_31);
