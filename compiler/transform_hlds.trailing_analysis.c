        ...
        else
        {
          ...
          else
          {
            ...
            else
            {
              ...
              libs__globals__lookup_bool_option_3_p_0(Globals_52, (MR_Integer) 517, &IntermodAnalysis_53);
            ...
            else
            {
              ...
              else
              {
                ...
                else
                {
                  ...
                  libs__globals__lookup_bool_option_3_p_0(Globals_57, (MR_Integer) 517, &Intermod_58);
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_21)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_4, (MR_Integer) 281, &UseTrail_5);
  switch (UseTrail_5) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 0:
    ...
    case (MR_Integer) 1:
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_4, (MR_Integer) 119, &Debug_12);
        {
