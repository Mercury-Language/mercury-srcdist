...
{
  {
    ...
    packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_QualInfo_0_11, (MR_Integer) 6)));
    ...
    else
    {
      ...
      packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_QualInfo_0_11, (MR_Integer) 6)));
      {
        MR_Word base;
      ...
      case (MR_Integer) 1:
        {
          ...
          if (succeeded)
          {
            ...
            Arity_39 = ((MR_Integer) ((MR_hl_field(MR_mktag(3), ConsId_28, (MR_Integer) 2))));
            {
              ...
              packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_QualInfo_0_31, (MR_Integer) 6)));
              ...
              else
              {
                ...
                packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_QualInfo_0_31, (MR_Integer) 6)));
                {
                  MR_Word base;
                  base = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 7 * sizeof(MR_Word)), NULL, NULL);
...
{
  {
    ...
    MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_QualInfo_0_42, (MR_Integer) 6)));
    MR_Word Var_36;
    MR_Word Var_38;
    MR_Word Type0_59;
...
{
  {
    ...
    MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), QualInfo_4, (MR_Integer) 6)));
...
{
  {
    ...
    MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_QualInfo_0_11, (MR_Integer) 6)));
...
{
  {
    ...
    MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_Info_0_6, (MR_Integer) 6)));
...
{
  {
    MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Info_3, (MR_Integer) 6)));
...
{
  {
    ...
    *X_4 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Info_3, (MR_Integer) 5))));
    packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Info_3, (MR_Integer) 6)));
  }
}
...
{
  {
    ...
    MR_Word Renaming_21;
    MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_QualInfo_0_22, (MR_Integer) 6)));
