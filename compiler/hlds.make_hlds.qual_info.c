...
MR_decl_label2(hlds__make_hlds__qual_info__process_type_qualification_10_0, 10,27)
...
MR_BEGIN_MODULE(hlds__make_hlds__qual_info_module12)
	...
	MR_init_label2(hlds__make_hlds__qual_info__process_type_qualification_10_0,10,27)
MR_BEGIN_CODE
...
MR_def_label(hlds__make_hlds__qual_info__process_type_qualification_10_0,10)
	...
	MR_np_call_localret_ent(parse_tree__prog_data__add_var_type_4_0,
		hlds__make_hlds__qual_info__process_type_qualification_10_0_i27);
MR_def_label(hlds__make_hlds__qual_info__process_type_qualification_10_0,27)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_tag_alloc_heap(MR_r2, 0, (MR_Integer) 8);
	MR_tfield(0, MR_r2, 0) = MR_sv(3);
	MR_tfield(0, MR_r2, 1) = MR_sv(12);
...
void mercury__hlds__make_hlds__qual_info__write_out_proc_statics(FILE *deep_fp, FILE *procrep_fp)
{
	MR_write_out_module_proc_reps_start(procrep_fp, &mercury_data__module_layout__hlds__make_hlds__qual_info);
