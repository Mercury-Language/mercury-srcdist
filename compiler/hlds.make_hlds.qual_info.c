    ...
    case (MR_Integer) 1:
      {
        ...
        Context_19 = hlds__hlds_goal__goal_info_get_context_1_f_0(GoalInfo_11);
        {
          ...
          MR_hl_field(MR_mktag(1), RHS_20, 2) = ((MR_Box) (FuncArgVars_14));
        }
        ...
        GoalExpr_29 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_28, (MR_Integer) 0))));
        {
          MR_Word base;
    ...
    case (MR_Integer) 0:
      {
        ...
        Var_22 = hlds__hlds_pred__invalid_proc_id_0_f_0();
        {
          ...
          MR_hl_field(MR_mktag(2), GoalExpr_13, 1) = ((MR_Box) (Var_22));
          MR_hl_field(MR_mktag(2), GoalExpr_13, 2) = ((MR_Box) (ArgVars_10));
  ...
  MR_Word * STATE_VARIABLE_QualInfo_14)
{
  ...
  MR_Word MQInfo0_20;
  MR_Word MaybeRecompInfo0_21;

  {
    Id_11 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(MR_mktag(0), Id_11, 0) = ((MR_Box) (SymName_7));
    MR_hl_field(MR_mktag(0), Id_11, 1) = ((MR_Box) (UserArityInt_10));
  }
  switch (PredOrFunc_6) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 1:
  ...
  MQInfo0_20 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_QualInfo_0_13, (MR_Integer) 5))));
  parse_tree__module_qual__mq_info_get_recompilation_info_2_p_0(MQInfo0_20, &MaybeRecompInfo0_21);
  if ((MaybeRecompInfo0_21 == (MR_Word) ((MR_Unsigned) 0U)))
    *STATE_VARIABLE_QualInfo_14 = STATE_VARIABLE_QualInfo_0_13;
  else
  {
    MR_Word RecompInfo0_22 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MaybeRecompInfo0_21, (MR_Integer) 0))));
    MR_Word RecompInfo_23;
    MR_Word MQInfo_24;
    MR_Word Var_25;
    MR_Word Var_40;
    MR_Word Var_41;
    ...
    recompilation__record_used_item_5_p_0(UsedItemType_12, Id_11, Id_11, RecompInfo0_22, &RecompInfo_23);
    {
      Var_25 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), Var_25, 0) = ((MR_Box) (RecompInfo_23));
    }
    parse_tree__module_qual__mq_info_set_recompilation_info_3_p_0(Var_25, MQInfo0_20, &MQInfo_24);
    Var_40 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_QualInfo_0_13, (MR_Integer) 0))));
    Var_41 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_QualInfo_0_13, (MR_Integer) 1))));
    Var_42 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_QualInfo_0_13, (MR_Integer) 2))));
    Var_43 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_QualInfo_0_13, (MR_Integer) 3))));
    Var_44 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_QualInfo_0_13, (MR_Integer) 4))));
    packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_QualInfo_0_13, (MR_Integer) 6)));
    {
      MR_Word base;
      ...
      *STATE_VARIABLE_QualInfo_14 = base;
      ...
      MR_hl_field(MR_mktag(0), base, 5) = ((MR_Box) (MQInfo_24));
    ...
    case (MR_Integer) 1:
      {
        ...
        if (succeeded)
        {
          SymName_36 = ((MR_Word) ((MR_hl_field(MR_mktag(3), ConsId_27, (MR_Integer) 1))));
          Arity_37 = ((MR_Integer) ((MR_hl_field(MR_mktag(3), ConsId_27, (MR_Integer) 2))));
          {
            MR_Word Id_39;
            MR_Word MQInfo0_47;
            MR_Word MaybeRecompInfo0_48;

            {
              Id_39 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
              MR_hl_field(MR_mktag(0), Id_39, 0) = ((MR_Box) (SymName_36));
              MR_hl_field(MR_mktag(0), Id_39, 1) = ((MR_Box) (Arity_37));
            }
            MQInfo0_47 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_QualInfo_0_30, (MR_Integer) 5))));
            parse_tree__module_qual__mq_info_get_recompilation_info_2_p_0(MQInfo0_47, &MaybeRecompInfo0_48);
            if ((MaybeRecompInfo0_48 == (MR_Word) ((MR_Unsigned) 0U)))
              *STATE_VARIABLE_QualInfo_31 = STATE_VARIABLE_QualInfo_0_30;
            else
            {
              MR_Word RecompInfo0_49 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MaybeRecompInfo0_48, (MR_Integer) 0))));
              ...
              recompilation__record_used_item_5_p_0((MR_Integer) 5, Id_39, Id_39, RecompInfo0_49, &RecompInfo_50);
              {
                Var_52 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(1), Var_52, 0) = ((MR_Box) (RecompInfo_50));
              }
              parse_tree__module_qual__mq_info_set_recompilation_info_3_p_0(Var_52, MQInfo0_47, &MQInfo_51);
              Var_67 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_QualInfo_0_30, (MR_Integer) 0))));
              Var_68 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_QualInfo_0_30, (MR_Integer) 1))));
              Var_69 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_QualInfo_0_30, (MR_Integer) 2))));
              Var_70 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_QualInfo_0_30, (MR_Integer) 3))));
              Var_71 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_QualInfo_0_30, (MR_Integer) 4))));
              packed_word_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_QualInfo_0_30, (MR_Integer) 6)));
              {
                ...
                *STATE_VARIABLE_QualInfo_31 = base;
                ...
                MR_hl_field(MR_mktag(0), base, 5) = ((MR_Box) (MQInfo_51));
  ...
  MR_Word * STATE_VARIABLE_Specs_45)
{
  ...
  succeeded = parse_tree__vartypes__search_var_type_3_p_0(VarTypes0_22, Var_11, &Type0_57);
  if (succeeded)
  {
    succeeded = parse_tree__prog_data____Unify____mer_type_0_0(Type_35, Type0_57);
    if (succeeded)
    ...
    else
    {
...

      {
        ...
        MR_hl_field(MR_mktag(1), Spec_59, 0) = ((MR_Box) ((MR_String) "predicate \140hlds.make_hlds.qual_info.update_var_types\'/7"));
        MR_hl_field(MR_mktag(1), Spec_59, 1) = ((MR_Box) ((MR_Unsigned) 0U));
        MR_hl_field(MR_mktag(1), Spec_59, 2) = ((MR_Box) ((MR_Unsigned) 40U));
        MR_hl_field(MR_mktag(1), Spec_59, 3) = ((MR_Box) (Context_14));
        MR_hl_field(MR_mktag(1), Spec_59, 4) = ((MR_Box) (MR_mkword(MR_mktag(1), &hlds__make_hlds__qual_info_scalar_common_1[7])));
      }
      {
        MR_Word base;
  ...
  MR_Word * STATE_VARIABLE_QualInfo_12)
{
  ...
  else
  {
    ...
    Var_28 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_QualInfo_0_11, (MR_Integer) 0))));
    Var_29 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_QualInfo_0_11, (MR_Integer) 1))));
    Var_30 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_QualInfo_0_11, (MR_Integer) 2))));
    Var_31 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_QualInfo_0_11, (MR_Integer) 3))));
    Var_32 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_QualInfo_0_11, (MR_Integer) 4))));
