...
static /* final */ const MR_Box hlds__make_hlds__qual_info_scalar_common_1[8][2] = {
  ...
  /* row   5 */
  {
    ((MR_Box) (MR_mkword(3, &hlds__make_hlds__qual_info_scalar_common_1[4]))),
    ((MR_Box) (MR_mkword(1, &hlds__make_hlds__qual_info_scalar_common_1[3])))
  },
  /* row   6 */
  {
    ((MR_Box) (MR_Word) ((MR_Unsigned) 6U)),
  ...
  /* row   7 */
  {
    ((MR_Box) (MR_mkword(3, &hlds__make_hlds__qual_info_scalar_common_1[6]))),
    ((MR_Box) (MR_mkword(1, &hlds__make_hlds__qual_info_scalar_common_1[5])))
  },
};
  ...
  if (succeeded)
  {
    ...
    else
    {
...

      {
        ...
        MR_hl_field(0, Spec_50, 4) = ((MR_Box) (MR_mkword(1, &hlds__make_hlds__qual_info_scalar_common_1[7])));
      }
      {
        MR_Word base;
