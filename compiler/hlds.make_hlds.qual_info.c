  ...
  MR_Word * STATE_VARIABLE_QualInfo_14)
{
  ...
  parse_tree__module_qual__mq_info_get_recompilation_info_2_p_0(MQInfo0_16, &MaybeRecompInfo0_17);
  ...
  else
  {
    ...
    parse_tree__module_qual__mq_info_set_recompilation_info_3_p_0(Var_21, MQInfo0_16, &MQInfo_20);
    ...
    case (MR_Integer) 1:
      {
        ...
        if (succeeded)
        {
          ...
          Arity_32 = ((MR_Integer) ((MR_hl_field(3, ConsId_26, (MR_Integer) 2))));
          {
            ...
            parse_tree__module_qual__mq_info_get_recompilation_info_2_p_0(MQInfo0_37, &MaybeRecompInfo0_38);
            ...
            else
            {
              ...
              parse_tree__module_qual__mq_info_set_recompilation_info_3_p_0(Var_42, MQInfo0_37, &MQInfo_41);
