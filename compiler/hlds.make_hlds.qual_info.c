...
MR_decl_label8(__Unify___hlds__make_hlds__qual_info__qual_info_0_0, 2,4,6,8,10,12,14,1)
MR_decl_label8(__Compare___hlds__make_hlds__qual_info__qual_info_0_0, 3,7,11,15,19,23,27,37)
...
MR_BEGIN_MODULE(hlds__make_hlds__qual_info_module18)
	...
	MR_init_label8(__Unify___hlds__make_hlds__qual_info__qual_info_0_0,2,4,6,8,10,12,14,1)
MR_BEGIN_CODE
...
MR_define_entry(mercury____Unify___hlds__make_hlds__qual_info__qual_info_0_0);
	...
	MR_np_call_localret_ent(__Unify___tree234__tree234_2_0,
		__Unify___hlds__make_hlds__qual_info__qual_info_0_0_i2);
MR_def_label(__Unify___hlds__make_hlds__qual_info__qual_info_0_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
...
MR_BEGIN_MODULE(hlds__make_hlds__qual_info_module19)
	...
	MR_init_label8(__Compare___hlds__make_hlds__qual_info__qual_info_0_0,3,7,11,15,19,23,27,37)
MR_BEGIN_CODE
...
MR_define_entry(mercury____Compare___hlds__make_hlds__qual_info__qual_info_0_0);
	...
	MR_np_call_localret_ent(__Compare___tree234__tree234_2_0,
		__Compare___hlds__make_hlds__qual_info__qual_info_0_0_i3);
MR_def_label(__Compare___hlds__make_hlds__qual_info__qual_info_0_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___hlds__make_hlds__qual_info__qual_info_0_0_i37);
	}
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(parse_tree__prog_data, tvar_type);
	MR_r2 = MR_sv(1);
	MR_r3 = MR_sv(8);
	MR_np_call_localret_ent(__Compare___varset__varset_1_0,
		__Compare___hlds__make_hlds__qual_info__qual_info_0_0_i7);
MR_def_label(__Compare___hlds__make_hlds__qual_info__qual_info_0_0,7)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___hlds__make_hlds__qual_info__qual_info_0_0_i37);
	}
	...
	MR_r4 = MR_sv(9);
	MR_np_call_localret_ent(__Compare___tree234__tree234_2_0,
		__Compare___hlds__make_hlds__qual_info__qual_info_0_0_i11);
MR_def_label(__Compare___hlds__make_hlds__qual_info__qual_info_0_0,11)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___hlds__make_hlds__qual_info__qual_info_0_0_i37);
	}
	...
	MR_r4 = MR_sv(10);
	MR_np_call_localret_ent(__Compare___tree234__tree234_2_0,
		__Compare___hlds__make_hlds__qual_info__qual_info_0_0_i15);
MR_def_label(__Compare___hlds__make_hlds__qual_info__qual_info_0_0,15)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___hlds__make_hlds__qual_info__qual_info_0_0_i37);
	}
...
MR_def_label(__Compare___hlds__make_hlds__qual_info__qual_info_0_0,19)
	...
	MR_np_call_localret_ent(__Compare___parse_tree__module_qual__mq_info_0_0,
		__Compare___hlds__make_hlds__qual_info__qual_info_0_0_i23);
MR_def_label(__Compare___hlds__make_hlds__qual_info__qual_info_0_0,23)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___hlds__make_hlds__qual_info__qual_info_0_0_i37);
	}
	...
	MR_np_call_localret_ent(__Compare___hlds__hlds_pred__import_status_0_0,
		__Compare___hlds__make_hlds__qual_info__qual_info_0_0_i27);
MR_def_label(__Compare___hlds__make_hlds__qual_info__qual_info_0_0,27)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___hlds__make_hlds__qual_info__qual_info_0_0_i37);
	}
...
MR_def_label(__Compare___hlds__make_hlds__qual_info__qual_info_0_0,37)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(15);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
...
void mercury__hlds__make_hlds__qual_info__write_out_proc_statics(FILE *fp);
#endif
