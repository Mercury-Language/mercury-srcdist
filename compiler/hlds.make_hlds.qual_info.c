...
MR_decl_label10(__Compare___hlds__make_hlds__qual_info__qual_info_0_0, 3,2,5,9,14,19,24,28,32,96)
...
MR_BEGIN_MODULE(hlds__make_hlds__qual_info_module19)
	...
	MR_init_label10(__Compare___hlds__make_hlds__qual_info__qual_info_0_0,3,2,5,9,14,19,24,28,32,96)
MR_BEGIN_CODE
...
MR_def_label(__Compare___hlds__make_hlds__qual_info__qual_info_0_0,5)
	...
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___hlds__make_hlds__qual_info__qual_info_0_0_i96);
	}
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(parse_tree__prog_data, tvar_type);
	MR_r2 = MR_sv(1);
	MR_r3 = MR_sv(8);
...
MR_def_label(__Compare___hlds__make_hlds__qual_info__qual_info_0_0,96)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(15);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
