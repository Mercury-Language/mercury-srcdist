    ...
    case (MR_Integer) 1:
      {
        ...
        hlds__make_goal__create_pure_atomic_complicated_unification_6_p_0(RetArg_15, RHS_20, Context_19, (MR_Word) ((MR_Integer) 0), (MR_Word) ((MR_Integer) 0), &Var_25);
    ...
    case (MR_Integer) 0:
      {
        ...
        Var_26 = hlds__hlds_pred__invalid_proc_id_0_f_0();
        {
          ...
          MR_hl_field(MR_mktag(2), GoalExpr_13, 4) = ((MR_Box) ((MR_Integer) 0));
...
{
  {
    ...
    if ((MaybeRecompInfo0_24 == (MR_Word) ((MR_Integer) 0)))
      ...
      case (MR_Integer) 1:
        {
          ...
          if (succeeded)
          {
            ...
            Arity_39 = ((MR_Integer) ((MR_hl_field(MR_mktag(3), ConsId_28, (MR_Integer) 2))));
            {
              ...
              if ((MaybeRecompInfo0_53 == (MR_Word) ((MR_Integer) 0)))
                *STATE_VARIABLE_QualInfo_32 = STATE_VARIABLE_QualInfo_0_31;
              else
              {
...
{
  {
    ...
    parse_tree__equiv_type__replace_in_type_8_p_0(TypeEqvMap_18, Type2_33, &Type_35, &Var_36, TVarSet1_30, &TVarSet_37, (MR_Word) ((MR_Integer) 0), &Var_38);
    ...
    if (succeeded)
    {
      ...
      else
      {
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(0), Spec_62, 0) = ((MR_Box) ((MR_Integer) 0));
          MR_hl_field(MR_mktag(0), Spec_62, 1) = ((MR_Box) ((MR_Integer) 16));
...
{
  {
    ...
    if ((MaybeRecompInfo0_7 == (MR_Word) ((MR_Integer) 0)))
      *STATE_VARIABLE_QualInfo_12 = STATE_VARIABLE_QualInfo_0_11;
    else
    {
