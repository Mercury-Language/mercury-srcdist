...
#line 28 "hlds.make_hlds.qual_info.c"
#line 150 "../library/io.int2"
#include "time.mh"

#line 32 "hlds.make_hlds.qual_info.c"
#line 151 "../library/io.int2"
#include "string.mh"

#line 36 "hlds.make_hlds.qual_info.c"
#line 31 "../library/bitmap.int2"
#include "bitmap.mh"

#line 40 "hlds.make_hlds.qual_info.c"
#line 33 "../library/array.int2"
#include "array.mh"

#line 44 "hlds.make_hlds.qual_info.c"
#line 39 "../mdbcomp/mdbcomp.rtti_access.int2"
#include "mdbcomp.rtti_access.mh"

#line 48 "hlds.make_hlds.qual_info.c"
#line 49 "hlds.make_hlds.qual_info.c"
#include "hlds.make_hlds.qual_info.mh"

#line 52 "hlds.make_hlds.qual_info.c"
#line 53 "hlds.make_hlds.qual_info.c"
...
#line 58 "hlds.make_hlds.qual_info.c"

#endif
#line 61 "hlds.make_hlds.qual_info.c"
...
MR_decl_label7(hlds__make_hlds__qual_info__do_construct_pred_or_func_call_6_0, 4,5,6,8,10,3,12)
MR_decl_label5(hlds__make_hlds__qual_info__init_qual_info_3_0, 2,3,4,5,6)
MR_decl_label6(hlds__make_hlds__qual_info__make_atomic_unification_9_0, 7,9,10,12,20,16)
MR_decl_label10(hlds__make_hlds__qual_info__process_type_qualification_10_0, 2,4,5,6,7,8,9,11,15,14)
MR_decl_label2(hlds__make_hlds__qual_info__process_type_qualification_10_0, 10,26)
...
MR_decl_label9(__Unify___hlds__make_hlds__qual_info__qual_info_0_0, 4,6,8,10,12,14,16,18,1)
MR_decl_label10(__Compare___hlds__make_hlds__qual_info__qual_info_0_0, 3,2,5,9,13,17,21,25,29,93)
...
MR_def_label(hlds__make_hlds__qual_info__init_qual_info_3_0,6)
	...
	MR_tfield(0, MR_r2, 6) = (MR_Word) MR_tbmkword(0, 8);
...
MR_BEGIN_MODULE(hlds__make_hlds__qual_info_module12)
	...
	MR_init_label10(hlds__make_hlds__qual_info__process_type_qualification_10_0,2,4,5,6,7,8,9,11,15,14)
	MR_init_label2(hlds__make_hlds__qual_info__process_type_qualification_10_0,10,26)
MR_BEGIN_CODE
...
MR_def_label(hlds__make_hlds__qual_info__process_type_qualification_10_0,14)
	...
	MR_tfield(0, MR_tempr1, 0) = (MR_Word) MR_TAG_COMMON(1,0,5);
...
MR_def_label(hlds__make_hlds__qual_info__process_type_qualification_10_0,10)
	...
	MR_np_call_localret_ent(map__det_insert_4_0,
		hlds__make_hlds__qual_info__process_type_qualification_10_0_i26);
MR_def_label(hlds__make_hlds__qual_info__process_type_qualification_10_0,26)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_tag_alloc_heap(MR_r2, 0, (MR_Integer) 8);
	MR_tfield(0, MR_r2, 0) = MR_sv(3);
	MR_tfield(0, MR_r2, 1) = MR_sv(12);
...
MR_BEGIN_MODULE(hlds__make_hlds__qual_info_module13)
	...
	MR_init_label6(hlds__make_hlds__qual_info__make_atomic_unification_9_0,7,9,10,12,20,16)
MR_BEGIN_CODE
...
MR_define_entry(mercury__hlds__make_hlds__qual_info__make_atomic_unification_9_0);
	...
	if (MR_PTAG_TESTR(MR_r2,1)) {
		MR_GOTO_LAB(hlds__make_hlds__qual_info__make_atomic_unification_9_0_i20);
	}
	{
	MR_Word MR_tempr1, MR_tempr2, MR_tempr3;
	...
	MR_sv(8) = MR_tempr2;
	MR_tfield(0, MR_tempr2, 0) = MR_tfield(3, MR_tempr1, 1);
...
MR_def_label(hlds__make_hlds__qual_info__make_atomic_unification_9_0,7)
	...
	MR_np_call_localret_ent(hlds__hlds_goal__create_atomic_complicated_unification_7_0,
		hlds__make_hlds__qual_info__make_atomic_unification_9_0_i16);
...
MR_def_label(hlds__make_hlds__qual_info__make_atomic_unification_9_0,12)
	...
	MR_np_call_localret_ent(hlds__hlds_goal__create_atomic_complicated_unification_7_0,
		hlds__make_hlds__qual_info__make_atomic_unification_9_0_i16);
MR_def_label(hlds__make_hlds__qual_info__make_atomic_unification_9_0,20)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(7) = MR_r7;
	MR_np_call_localret_ent(hlds__hlds_goal__create_atomic_complicated_unification_7_0,
		hlds__make_hlds__qual_info__make_atomic_unification_9_0_i16);
...
MR_BEGIN_MODULE(hlds__make_hlds__qual_info_module16)
	...
	MR_init_label7(hlds__make_hlds__qual_info__do_construct_pred_or_func_call_6_0,4,5,6,8,10,3,12)
MR_BEGIN_CODE
...
MR_def_label(hlds__make_hlds__qual_info__do_construct_pred_or_func_call_6_0,8)
	...
	MR_np_call_localret_ent(hlds__hlds_goal__create_pure_atomic_complicated_unification_6_0,
		hlds__make_hlds__qual_info__do_construct_pred_or_func_call_6_0_i10);
MR_def_label(hlds__make_hlds__qual_info__do_construct_pred_or_func_call_6_0,10)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_def_label(hlds__make_hlds__qual_info__do_construct_pred_or_func_call_6_0,3)
	...
	MR_np_call_localret_ent(fn__hlds__hlds_pred__invalid_proc_id_0_0,
		hlds__make_hlds__qual_info__do_construct_pred_or_func_call_6_0_i12);
MR_def_label(hlds__make_hlds__qual_info__do_construct_pred_or_func_call_6_0,12)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
...
MR_BEGIN_MODULE(hlds__make_hlds__qual_info_module18)
	...
	MR_init_label9(__Unify___hlds__make_hlds__qual_info__qual_info_0_0,4,6,8,10,12,14,16,18,1)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(hlds__make_hlds__qual_info_module19)
	...
	MR_init_label10(__Compare___hlds__make_hlds__qual_info__qual_info_0_0,3,2,5,9,13,17,21,25,29,93)
MR_BEGIN_CODE
...
MR_def_label(__Compare___hlds__make_hlds__qual_info__qual_info_0_0,5)
	...
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___hlds__make_hlds__qual_info__qual_info_0_0_i93);
	}
	MR_r1 = (MR_Word) MR_TAG_COMMON(0,0,2);
	MR_r2 = MR_sv(1);
	MR_r3 = MR_sv(8);
...
MR_def_label(__Compare___hlds__make_hlds__qual_info__qual_info_0_0,93)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(15);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
...
void mercury__hlds__make_hlds__qual_info__init_threadscope_string_table(void);
#endif
