...
{
  {
    ...
    else
    {
      ...
      MR_Word ArgX7_16 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), HeadVar__2_2, (MR_Integer) 6))) >> 2)) & (MR_Integer) 1);
      MR_Word ArgY7_17 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), HeadVar__3_3, (MR_Integer) 6))) >> 2)) & (MR_Integer) 1);
      MR_Word ArgX8_18 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), HeadVar__2_2, (MR_Integer) 6))) >> 1)) & (MR_Integer) 1);
      MR_Word ArgY8_19 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), HeadVar__3_3, (MR_Integer) 6))) >> 1)) & (MR_Integer) 1);
...
{
  {
    ...
    packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_QualInfo_0_11, (MR_Integer) 6)));
      ...
      case (MR_Integer) 1:
        {
          ...
          MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), RHS_11, (MR_Integer) 1)));
          MR_Word SymName_38;
          MR_Integer Arity_39;
          ...
          if (succeeded)
          {
            ...
            Arity_39 = ((MR_Integer) ((MR_hl_field(MR_mktag(3), ConsId_28, (MR_Integer) 2))));
            {
              ...
              {
                Id_41 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
              ...
              packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_QualInfo_0_31, (MR_Integer) 6)));
              ...
              else
              {
                ...
                packed_word_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_QualInfo_0_31, (MR_Integer) 6)));
                {
                  MR_Word base;
                  base = (MR_Word) MR_new_object(MR_Word, (7 * sizeof(MR_Word)), NULL, NULL);
...
{
  {
    ...
    if (succeeded)
    {
      ...
      else
      {
        ...
        {
          Msg_61 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
...
{
  {
    ...
    MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), QualInfo_4, (MR_Integer) 6)));
...
{
  {
    ...
    MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_QualInfo_0_11, (MR_Integer) 6)));
...
{
  {
    MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Info_3, (MR_Integer) 6)));
...
{
  {
    ...
    *X_4 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Info_3, (MR_Integer) 5))));
    packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Info_3, (MR_Integer) 6)));
  }
}
...
{
  {
    ...
    MR_Word Renaming_21;
    MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_QualInfo_0_22, (MR_Integer) 6)));
