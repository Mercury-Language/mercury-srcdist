  ...
  MR_Word * STATE_VARIABLE_QualInfo_14)
{
  ...
  MQInfo0_24 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_QualInfo_0_13, (MR_Integer) 5))));
  parse_tree__module_qual__mq_info_get_recompilation_info_2_p_0(MQInfo0_24, &MaybeRecompInfo0_25);
  if ((MaybeRecompInfo0_25 == (MR_Word) ((MR_Unsigned) 0U)))
    *STATE_VARIABLE_QualInfo_14 = STATE_VARIABLE_QualInfo_0_13;
  else
  {
    MR_Word RecompInfo0_26 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MaybeRecompInfo0_25, (MR_Integer) 0))));
    MR_Word RecompInfo_27;
    MR_Word MQInfo_28;
    MR_Word Var_29;
    MR_Word Var_46;
    MR_Word Var_47;
    ...
    recompilation__record_used_item_5_p_0(UsedItemType_12, Id_11, Id_11, RecompInfo0_26, &RecompInfo_27);
    {
      Var_29 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), Var_29, 0) = ((MR_Box) (RecompInfo_27));
    }
    parse_tree__module_qual__mq_info_set_recompilation_info_3_p_0(Var_29, MQInfo0_24, &MQInfo_28);
    Var_46 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_QualInfo_0_13, (MR_Integer) 0))));
    Var_47 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_QualInfo_0_13, (MR_Integer) 1))));
    Var_48 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_QualInfo_0_13, (MR_Integer) 2))));
    Var_49 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_QualInfo_0_13, (MR_Integer) 3))));
    Var_50 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_QualInfo_0_13, (MR_Integer) 4))));
