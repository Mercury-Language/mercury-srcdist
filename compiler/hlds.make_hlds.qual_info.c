    ...
    case (MR_Integer) 1:
      {
        ...
        TypeCtor_17 = parse_tree__prog_data__cons_id_dummy_type_ctor_0_f_0();
        {
          ...
          MR_hl_field(3, ConsId_18, 0) = ((MR_Box) ((MR_Unsigned) 2U));
  ...
  MR_Word * STATE_VARIABLE_QualInfo_14)
{
  ...
  else
  {
    ...
    recompilation__record_used_item_5_p_0(UsedItemType_12, Id_11, Id_11, RecompInfo0_18, &RecompInfo_19);
    {
  ...
  MR_Word * STATE_VARIABLE_QualInfo_31)
{
  ...
  switch (MR_tag((MR_Word) RHS_11)) {
    ...
    case (MR_Integer) 1:
      {
        MR_Word ConsId_27 = ((MR_Word) ((MR_hl_field(1, RHS_11, (MR_Integer) 0))));
        MR_Word SymName_32;
        MR_Integer Arity_33;

        succeeded = ((((MR_tag((MR_Word) ConsId_27)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(3, ConsId_27, (MR_Integer) 0)))) == (MR_Integer) 2)));
        if (succeeded)
        {
          SymName_32 = ((MR_Word) ((MR_hl_field(3, ConsId_27, (MR_Integer) 1))));
          Arity_33 = ((MR_Integer) ((MR_hl_field(3, ConsId_27, (MR_Integer) 2))));
          {
            MR_Word Id_35;
            MR_Word MQInfo0_38;
            ...
            MQInfo0_38 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_QualInfo_0_30, (MR_Integer) 5))));
            parse_tree__module_qual__mq_info_get_recompilation_info_2_p_0(MQInfo0_38, &MaybeRecompInfo0_39);
            if ((MaybeRecompInfo0_39 == (MR_Word) ((MR_Unsigned) 0U)))
              *STATE_VARIABLE_QualInfo_31 = STATE_VARIABLE_QualInfo_0_30;
            else
            {
              MR_Word RecompInfo0_40 = ((MR_Word) ((MR_hl_field(1, MaybeRecompInfo0_39, (MR_Integer) 0))));
              ...
              recompilation__record_used_item_5_p_0((MR_Integer) 5, Id_35, Id_35, RecompInfo0_40, &RecompInfo_41);
              {
                Var_43 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(1, Var_43, 0) = ((MR_Box) (RecompInfo_41));
              }
              parse_tree__module_qual__mq_info_set_recompilation_info_3_p_0(Var_43, MQInfo0_38, &MQInfo_42);
              Var_52 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_QualInfo_0_30, (MR_Integer) 0))));
              Var_53 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_QualInfo_0_30, (MR_Integer) 1))));
              Var_54 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_QualInfo_0_30, (MR_Integer) 2))));
              Var_55 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_QualInfo_0_30, (MR_Integer) 3))));
              Var_56 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_QualInfo_0_30, (MR_Integer) 4))));
              packed_word_2 = (MR_Unsigned) ((MR_hl_field(0, STATE_VARIABLE_QualInfo_0_30, (MR_Integer) 6)));
              {
                MR_Word base;
                base = (MR_Word) MR_new_object(MR_Word, (7 * sizeof(MR_Word)), NULL, NULL);
  ...
  if (succeeded)
  {
    ...
    else
    {
...

      {
        ...
        MR_hl_field(1, Spec_50, 0) = ((MR_Box) ((MR_String) "predicate \140hlds.make_hlds.qual_info.update_var_types\'/7"));
        MR_hl_field(1, Spec_50, 1) = ((MR_Box) ((MR_Unsigned) 0U));
        MR_hl_field(1, Spec_50, 2) = ((MR_Box) ((MR_Unsigned) 44U));
        MR_hl_field(1, Spec_50, 3) = ((MR_Box) (Context_14));
        MR_hl_field(1, Spec_50, 4) = ((MR_Box) (MR_mkword(1, &hlds__make_hlds__qual_info_scalar_common_1[7])));
      }
      {
        MR_Word base;
