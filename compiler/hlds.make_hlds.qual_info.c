    ...
    case (MR_Integer) 0:
      {
        ...
        Var_22 = hlds__pred_proc_id__invalid_proc_id_0_f_0();
        {
  ...
  MR_Word * STATE_VARIABLE_Specs_40)
{
  ...
  switch (MaybeOptImported_21) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 0:
      parse_tree__module_qual__qualify_items__qualify_type_qualification_6_p_0((MR_Integer) 0, Context_12, Type0_10, &Type1_24, MQInfo0_20, &MQInfo_25);
      break;
    case (MR_Integer) 1:
      {
        Type1_24 = Type0_10;
  ...
  succeeded = parse_tree__vartypes__search_var_type_3_p_0(VarTypes0_19, Var_9, &Type0_42);
  if (succeeded)
  {
    succeeded = parse_tree__prog_data____Unify____mer_type_0_0(Type_32, Type0_42);
    if (succeeded)
    ...
    else
    {
      ...
      Var_50 = parse_tree__error_spec__color_as_incorrect_1_f_0((MR_Word) (MR_mkword(1, &hlds__make_hlds__qual_info_scalar_common_1[6])));
      Var_49 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), Var_50, (MR_Word) (MR_mkword(1, &hlds__make_hlds__qual_info_scalar_common_1[7])));
      Pieces_43 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), (MR_Word) (MR_mkword(1, &hlds__make_hlds__qual_info_scalar_common_1[4])), Var_49);
      {
        Spec_44 = (MR_Word) MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(0, Spec_44, 0) = ((MR_Box) ((MR_String) "predicate \140hlds.make_hlds.qual_info.update_var_types\'/7"));
        MR_hl_field(0, Spec_44, 1) = ((MR_Box) ((MR_Unsigned) 0U));
        MR_hl_field(0, Spec_44, 2) = ((MR_Box) ((MR_Unsigned) 48U));
        MR_hl_field(0, Spec_44, 3) = ((MR_Box) (Context_12));
