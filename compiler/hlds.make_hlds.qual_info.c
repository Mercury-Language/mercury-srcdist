    ...
    if (succeeded)
    {
      ...
      else
      {
...

        {
          ...
          MR_hl_field(MR_mktag(1), Msg_61, 0) = ((MR_Box) (Context_14));
          MR_hl_field(MR_mktag(1), Msg_61, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &hlds__make_hlds__qual_info_scalar_common_1[8])));
        }
        {
