  ...
  MR_Word * STATE_VARIABLE_Specs_47)
{
  ...
  else
  {
    ...
    parse_tree__module_cmds__touch_interface_datestamp_8_p_0(Globals_16, ProgressStream_13, ErrorStream_14, ModuleName_21, (MR_Word) (MR_mkword(2, &top_level__mercury_compile_front_end_scalar_common_4[0])), &_TouchSucceeded_36);
