      ...
      case (MR_Integer) 1:
        {
          ...
          libs__globals__lookup_accumulating_option_3_p_0(Globals_10, (MR_Integer) 691, &IntermodDirs_18);
  ...
  MR_Word * STATE_VARIABLE_Specs_47)
{
  ...
  else
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_16, (MR_Integer) 717, &Experiment5_37);
    ...
    case (MR_Integer) 1:
      {
        ...
        libs__globals__lookup_string_option_3_p_0(Globals_21, (MR_Integer) 712, &Experiment_30);
