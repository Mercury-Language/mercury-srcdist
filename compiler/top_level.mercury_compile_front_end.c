      ...
      case (MR_Integer) 1:
        {
          ...
          *SafeToContinue_15 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_39, (MR_Integer) 1))));
          ...
          mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&top_level__mercury_compile_front_end_scalar_common_4[1]), Repeats_20, &Var_68);
          mercury__io__write_string_3_p_0(Var_68);
          mercury__io__write_string_3_p_0((MR_String) " repeats: ");
          mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&top_level__mercury_compile_front_end_scalar_common_4[1]), Time_22, &Var_78);
...
{
  {
    ...
    check_hlds__polymorphism_post_copy__post_copy_polymorphism_3_p_0(ExistsCastPredIds_12, STATE_VARIABLE_HLDS_23_23, STATE_VARIABLE_HLDS_18);
    libs__file_util__maybe_write_string_4_p_0(Verbose_10, (MR_String) " done.\n");
    libs__file_util__maybe_report_stats_3_p_0(Stats_11);
  }
}
...
{
  {
    ...
    else
    {
      ...
      hlds__hlds_error_util__maybe_write_out_errors_8_p_0(Verbose_13, Globals_18, STATE_VARIABLE_HLDS_0_33, &STATE_VARIABLE_HLDS_67_67, STATE_VARIABLE_Specs_0_35, &STATE_VARIABLE_Specs_68_68);
      ...
      SimplifyTasks_31 = check_hlds__simplify__simplify_tasks__list_to_simplify_tasks_2_f_0(Globals_18, SimpList_19);
      {
        ...
        MR_hl_field(MR_mktag(0), Var_77, 0) = ((MR_Box) (&top_level__mercury_compile_front_end_scalar_common_5[0]));
        MR_hl_field(MR_mktag(0), Var_77, 1) = ((MR_Box) (top_level__mercury_compile_front_end__maybe_simplify_10_p_0_1));
        MR_hl_field(MR_mktag(0), Var_77, 2) = ((MR_Box) ((MR_Integer) 1));
        MR_hl_field(MR_mktag(0), Var_77, 3) = ((MR_Box) (SimplifyTasks_31));
      }
      Var_73 = (MR_Word) (Var_77);
      hlds__passes_aux__process_valid_nonimported_preds_errors_7_p_0(Var_73, STATE_VARIABLE_HLDS_67_67, &STATE_VARIABLE_HLDS_74_74, (MR_Word) ((MR_Unsigned) 0U), &SimplifySpecs_32);
      switch (SimplifyPass_12) {
        default: /*NOTREACHED*/ MR_assert(0);
        case (MR_Integer) 0:
          {
            ...
            STATE_VARIABLE_Specs_78_78 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_error_spec_0), SimplifySpecs_32, STATE_VARIABLE_Specs_68_68);
            hlds__hlds_error_util__maybe_write_out_errors_8_p_0(Verbose_13, Globals_18, STATE_VARIABLE_HLDS_74_74, STATE_VARIABLE_HLDS_34, STATE_VARIABLE_Specs_78_78, STATE_VARIABLE_Specs_36);
          }
          break;
        case (MR_Integer) 5:
          {
            *STATE_VARIABLE_HLDS_34 = STATE_VARIABLE_HLDS_74_74;
            *STATE_VARIABLE_Specs_36 = STATE_VARIABLE_Specs_68_68;
          }
          break;
        case (MR_Integer) 4:
          {
      ...
      case (MR_Integer) 0:
        {
          ...
          check_hlds__typecheck__typecheck_module_5_p_0(STATE_VARIABLE_HLDS_44_44, &STATE_VARIABLE_HLDS_47_47, &TypeCheckSpecs_27, FoundSyntaxError_18, NumberOfIterations_20);
        }
        break;
      case (MR_Integer) 1:
        {
