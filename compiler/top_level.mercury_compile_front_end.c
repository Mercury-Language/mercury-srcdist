      ...
      case (MR_Integer) 1:
        {
          ...
          libs__globals__lookup_accumulating_option_3_p_0(Globals_10, (MR_Integer) 692, &IntermodDirs_18);
  ...
  MR_Word * STATE_VARIABLE_Specs_47)
{
  ...
  if (((MR_tag((MR_Word) OpenResult_24)) == (MR_Integer) 1))
  {
    ...
    mercury__io__write_string_4_p_0(ProgressStream_13, ProgName_26);
    mercury__io__write_string_4_p_0(ProgressStream_13, (MR_String) ": cannot open \140");
    mercury__io__write_string_4_p_0(ProgressStream_13, TmpOptFileName_23);
    mercury__io__write_string_4_p_0(ProgressStream_13, (MR_String) "\' for output: ");
    mercury__io__write_string_4_p_0(ProgressStream_13, ErrorMsg_27);
  ...
  else
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_16, (MR_Integer) 718, &Experiment5_37);
    ...
    case (MR_Integer) 1:
      {
        ...
        libs__globals__lookup_string_option_3_p_0(Globals_21, (MR_Integer) 713, &Experiment_30);
