...
top_level__mercury_compile_front_end__IntroducedFrom__pred__maybe_simplify__1498__1_2_p_0(
  ...
  MR_Word * STATE_VARIABLE_Specs_42)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_24, (MR_Integer) 501, &IntermodOpt_78);
  libs__globals__lookup_bool_option_3_p_0(Globals_24, (MR_Integer) 506, &IntermodAnalysis_79);
  libs__globals__lookup_bool_option_3_p_0(Globals_24, (MR_Integer) 503, &UseOptFiles_80);
        ...
        case (MR_Integer) 0:
          {
            ...
            libs__globals__lookup_bool_option_3_p_0(Globals_23, (MR_Integer) 506, &IntermodAnalysis_82);
            switch ((MR_Integer) 1) {
              default: /*NOTREACHED*/ MR_assert(0);
              case (MR_Integer) 0:
                {
        ...
        case (MR_Integer) 5:
          {
            ...
            libs__globals__lookup_bool_option_3_p_0(Globals_23, (MR_Integer) 506, &IntermodAnalysis_34);
            switch ((MR_Integer) 0) {
              default: /*NOTREACHED*/ MR_assert(0);
              case (MR_Integer) 0:
                {
  ...
  MR_Word * STATE_VARIABLE_HLDS_21)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 501, &IntermodOpt_11);
  ...
  else
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 503, &UseOptFiles_13);
      ...
      case (MR_Integer) 1:
        {
          ...
          libs__globals__lookup_accumulating_option_3_p_0(Globals_8, (MR_Integer) 689, &IntermodDirs_16);
  ...
  MR_Word * STATE_VARIABLE_Specs_47)
{
  ...
  else
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_16, (MR_Integer) 715, &Experiment5_37);
  ...
  MR_Word * STATE_VARIABLE_Specs_36)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_17, (MR_Integer) 185, &ShowCallTree_18);
  libs__globals__lookup_accumulating_option_3_p_0(Globals_17, (MR_Integer) 190, &ShowMovability_19);
  ...
  if (succeeded)
  {
      ...
      case (MR_Integer) 1:
        {
          ...
          MR_String TreeFileName_24;
          MR_String OrderFileName_25;
          MR_Word TreeResult_26;

          libs__file_util__maybe_write_string_5_p_0(ProgressStream_10, Verbose_12, (MR_String) "% Writing call_tree...");
          hlds__hlds_module__module_info_get_name_2_p_0(HLDS_14, &ModuleName_23);
          parse_tree__file_names__module_name_to_file_name_create_dirs_7_p_0(Globals_17, (MR_String) "predicate \140top_level.mercury_compile_front_end.maybe_write_call_tree\'/9", (MR_Word) (&top_level__mercury_compile_front_end_scalar_common_4[1]), ModuleName_23, &TreeFileName_24);
          parse_tree__file_names__module_name_to_file_name_create_dirs_7_p_0(Globals_17, (MR_String) "predicate \140top_level.mercury_compile_front_end.maybe_write_call_tree\'/9", (MR_Word) (&top_level__mercury_compile_front_end_scalar_common_4[2]), ModuleName_23, &OrderFileName_25);
          mercury__io__open_output_4_p_0(TreeFileName_24, &TreeResult_26);
          if (((MR_tag((MR_Word) TreeResult_26)) == (MR_Integer) 1))
          {
            MR_String Var_63;
            MR_Word IOError_67 = ((MR_Word) ((MR_hl_field(1, TreeResult_26, (MR_Integer) 0))));
            MR_String ErrorMsg_68;

            Var_63 = mercury__io__error_message_1_f_0(IOError_67);
            ErrorMsg_68 = mercury__string__f_43_43_2_f_0((MR_String) "unable to write local call tree: ", Var_63);
            libs__file_util__report_error_4_p_0(ErrorStream_11, ErrorMsg_68);
          }
          else
          {
            MR_Word TreeFileStream_27 = ((MR_Word) ((MR_hl_field(0, TreeResult_26, (MR_Integer) 0))));
            MR_Word OrderResult_28;

            mercury__io__open_output_4_p_0(OrderFileName_25, &OrderResult_28);
            if (((MR_tag((MR_Word) OrderResult_28)) == (MR_Integer) 1))
            {
              MR_Word IOError_30 = ((MR_Word) ((MR_hl_field(1, OrderResult_28, (MR_Integer) 0))));
              MR_String ErrorMsg_31;
              MR_String Var_60;

              mercury__io__close_output_3_p_0(TreeFileStream_27);
              Var_60 = mercury__io__error_message_1_f_0(IOError_30);
              ErrorMsg_31 = mercury__string__f_43_43_2_f_0((MR_String) "unable to write local call tree order: ", Var_60);
              libs__file_util__report_error_4_p_0(ErrorStream_11, ErrorMsg_31);
            }
            else
            {
              MR_Word OrderFileStream_29 = ((MR_Word) ((MR_hl_field(0, OrderResult_28, (MR_Integer) 0))));

              hlds__hlds_call_tree__write_local_call_tree_6_p_0(TreeFileStream_27, OrderFileStream_29, HLDS_14, CallTreeInfo_22);
              mercury__io__close_output_3_p_0(TreeFileStream_27);
              mercury__io__close_output_3_p_0(OrderFileStream_29);
    ...
    {
      MR_Word MovabilitySpecs_34;

      hlds__hlds_call_tree__generate_movability_report_4_p_0(HLDS_14, CallTreeInfo_22, ShowMovability_19, &MovabilitySpecs_34);
      *STATE_VARIABLE_Specs_36 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_error_spec_0), MovabilitySpecs_34, STATE_VARIABLE_Specs_0_35);
    }
  ...
  MR_Word * STATE_VARIABLE_Specs_23)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_18, (MR_Integer) 213, &ComputeGoalModes_19);
  ...
  MR_Word * STATE_VARIABLE_Specs_34)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_22, (MR_Integer) 214, &BenchmarkModes_23);
    ...
    case (MR_Integer) 1:
      {
        ...
        libs__globals__lookup_int_option_3_p_0(Globals_22, (MR_Integer) 215, &Repeats_24);
        {
  ...
  MR_Word * STATE_VARIABLE_HLDS_16)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_13, (MR_Integer) 210, &ModeConstraints_14);
    ...
    case (MR_Integer) 1:
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_29, (MR_Integer) 214, &BenchmarkModes_30);
          ...
          case (MR_Integer) 1:
            {
              ...
              libs__globals__lookup_int_option_3_p_0(Globals_29, (MR_Integer) 215, &Repeats_31);
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = top_level__mercury_compile_front_end__IntroducedFrom__pred__maybe_simplify__1498__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 4)))));
  return succeeded;
}
    ...
    case (MR_Integer) 5:
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_22, (MR_Integer) 247, &DeepProf_30);
        libs__globals__lookup_bool_option_3_p_0(Globals_22, (MR_Integer) 264, &TSWProf_31);
        libs__globals__lookup_bool_option_3_p_0(Globals_22, (MR_Integer) 265, &TSCProf_32);
    ...
    case (MR_Integer) 3:
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_22, (MR_Integer) 250, &PreParSimplify_27);
    ...
    case (MR_Integer) 2:
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_22, (MR_Integer) 249, &PreProfSimplify_26);
  ...
  MR_Word * NeedMiddlePassForOptFile_4)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 521, &Termination_7);
  libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 528, &Termination2_8);
  libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 513, &SharingAnalysis_9);
  libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 515, &ReuseAnalysis_10);
  libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 536, &ExceptionAnalysis_11);
  libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 537, &ClosureAnalysis_12);
  libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 509, &TrailingAnalysis_13);
  libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 512, &TablingAnalysis_14);
  ...
  MR_Word * STATE_VARIABLE_Specs_37)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_21, (MR_Integer) 346, &TypeCheckConstraints_29);
    ...
    case (MR_Integer) 1:
      {
        ...
        libs__globals__lookup_string_option_3_p_0(Globals_21, (MR_Integer) 710, &Experiment_30);
