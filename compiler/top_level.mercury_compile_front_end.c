    ...
    case (MR_Integer) 1:
      {
        ...
        parse_tree__file_names__module_name_to_file_name_create_dirs_7_p_0(Globals_14, (MR_String) "predicate \140top_level.mercury_compile_front_end.maybe_write_call_tree\'/7", (MR_Word) (&top_level__mercury_compile_front_end_scalar_common_4[1]), ModuleName_16, &TreeFileName_17);
        parse_tree__file_names__module_name_to_file_name_create_dirs_7_p_0(Globals_14, (MR_String) "predicate \140top_level.mercury_compile_front_end.maybe_write_call_tree\'/7", (MR_Word) (&top_level__mercury_compile_front_end_scalar_common_4[2]), ModuleName_16, &OrderFileName_18);
