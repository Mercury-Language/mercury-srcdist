...
static void MR_CALL 
top_level__mercury_compile_front_end__IntroducedFrom__pred__modecheck__1117__1_3_p_0(
  MR_Word ProgressStream_13,
  MR_Word LambdaHeadVar__1_43,
  MR_Tuple * LambdaHeadVar__2_44);

static MR_bool MR_CALL 
top_level__mercury_compile_front_end__IntroducedFrom__pred__maybe_simplify__1612__1_2_p_0(
  ...
  MR_Word * STATE_VARIABLE_MaybeWrittenSpecs_39)
{
  ...
  parse_tree__write_error_spec__maybe_write_not_yet_written_specs_7_p_0(ErrorStream_17, Globals_60, Verbose_27, STATE_VARIABLE_MaybeWrittenSpecs_0_38, &STATE_VARIABLE_MaybeWrittenSpecs_1_62);
  libs__file_util__maybe_write_string_5_p_0(ProgressStream_16, Verbose_27, (MR_String) "% Deciding type representations...\n");
  hlds__du_type_layout__decide_type_repns_6_p_0(STATE_VARIABLE_HLDS_0_34, &STATE_VARIABLE_HLDS_1_44, (MR_Word) ((MR_Unsigned) 0U), &RepnSpecs_61);
  parse_tree__error_util__add_to_be_written_specs_3_p_0(RepnSpecs_61, STATE_VARIABLE_MaybeWrittenSpecs_1_62, &STATE_VARIABLE_MaybeWrittenSpecs_1_45);
  ...
  MR_Box * wrapper_arg_2)
{
  ...
  top_level__mercury_compile_front_end__IntroducedFrom__pred__modecheck__1117__1_3_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) (wrapper_arg_1)), &conv0_LambdaHeadVar__2_44);
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = top_level__mercury_compile_front_end__IntroducedFrom__pred__maybe_simplify__1612__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) ((MR_hl_field(0, closure, 4)))));
  return succeeded;
}
