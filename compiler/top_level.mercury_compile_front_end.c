          ...
          case (MR_Integer) 5:
            {
              ...
              libs__globals__lookup_bool_option_3_p_0(Globals_19, (MR_Integer) 487, &IntermodAnalysis_30);
              switch (MR_tag((MR_Word) OpModeAugment_16)) {
                default: /*NOTREACHED*/ MR_assert(0);
                case (MR_Integer) 0:
                  switch (MR_unmkbody(OpModeAugment_16)) {
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 482, &IntermodOpt_11);
    ...
    else
    {
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 484, &UseOptFiles_13);
        ...
        case (MR_Integer) 1:
          {
            ...
            libs__globals__lookup_accumulating_option_3_p_0(Globals_8, (MR_Integer) 677, &IntermodDirs_16);
...
{
  {
    ...
    else
    {
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals_12, (MR_Integer) 703, &Experiment5_31);
        ...
        case (MR_Integer) 1:
          {
            ...
            Var_72 = mercury__string__f_43_43_2_f_0(OptFileName_18, (MR_String) "x");
            mercury__io__open_output_4_p_0(Var_72, &OptXResult_32);
      ...
      case (MR_Integer) 5:
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_18, (MR_Integer) 226, &DeepProf_25);
          libs__globals__lookup_bool_option_3_p_0(Globals_18, (MR_Integer) 243, &TSWProf_26);
          libs__globals__lookup_bool_option_3_p_0(Globals_18, (MR_Integer) 244, &TSCProf_27);
      ...
      case (MR_Integer) 3:
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_18, (MR_Integer) 229, &PreParSimplify_22);
      ...
      case (MR_Integer) 2:
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_18, (MR_Integer) 228, &PreProfSimplify_21);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 502, &Termination_7);
    libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 509, &Termination2_8);
    libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 494, &SharingAnalysis_9);
    libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 496, &ReuseAnalysis_10);
    libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 517, &ExceptionAnalysis_11);
    libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 518, &ClosureAnalysis_12);
    libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 490, &TrailingAnalysis_13);
    libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 493, &TablingAnalysis_14);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_17, (MR_Integer) 328, &TypeCheckConstraints_25);
      ...
      case (MR_Integer) 1:
        {
          ...
          libs__globals__lookup_string_option_3_p_0(Globals_17, (MR_Integer) 698, &Experiment_26);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_16, (MR_Integer) 482, &IntermodOpt_21);
    libs__globals__lookup_bool_option_3_p_0(Globals_16, (MR_Integer) 487, &IntermodAnalysis_22);
    libs__globals__lookup_bool_option_3_p_0(Globals_16, (MR_Integer) 484, &UseOptFiles_23);
