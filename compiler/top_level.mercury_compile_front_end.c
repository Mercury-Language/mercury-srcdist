    ...
    case (MR_Integer) 1:
      {
        ...
        else
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_16, (MR_Integer) 741, &Experiment5_42);
    ...
    case (MR_Integer) 1:
      {
        ...
        libs__globals__lookup_string_option_3_p_0(Globals_21, (MR_Integer) 736, &Experiment_30);
