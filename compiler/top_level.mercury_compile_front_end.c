          ...
          if (top_level__mercury_compile_front_end__succeeded)
            {
              ...
              {
                top_level__mercury_compile_front_end__frontend_pass_by_phases_9_p_0(top_level__mercury_compile_front_end__STATE_VARIABLE_HLDS_62_62, &top_level__mercury_compile_front_end__STATE_VARIABLE_HLDS_64_64, &top_level__mercury_compile_front_end__FoundError_29, top_level__mercury_compile_front_end__STATE_VARIABLE_DumpInfo_0_38, top_level__mercury_compile_front_end__STATE_VARIABLE_DumpInfo_39, top_level__mercury_compile_front_end__STATE_VARIABLE_Specs_0_40, top_level__mercury_compile_front_end__STATE_VARIABLE_Specs_41);
              }
...
{
  {
    ...
    {
      libs__globals__lookup_bool_option_3_p_0(top_level__mercury_compile_front_end__Globals_20, (MR_Integer) 321, &top_level__mercury_compile_front_end__IntermodOpt_23);
    }
    {
      libs__globals__lookup_bool_option_3_p_0(top_level__mercury_compile_front_end__Globals_20, (MR_Integer) 326, &top_level__mercury_compile_front_end__IntermodAnalysis_24);
    }
    {
      libs__globals__lookup_bool_option_3_p_0(top_level__mercury_compile_front_end__Globals_20, (MR_Integer) 323, &top_level__mercury_compile_front_end__UseOptFiles_25);
    }
    {
      libs__globals__lookup_bool_option_3_p_0(top_level__mercury_compile_front_end__Globals_20, (MR_Integer) 294, &top_level__mercury_compile_front_end__TypeCheckConstraints_26);
    }
