  ...
  MR_Word * STATE_VARIABLE_Specs_42)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_24, (MR_Integer) 498, &IntermodOpt_78);
  libs__globals__lookup_bool_option_3_p_0(Globals_24, (MR_Integer) 503, &IntermodAnalysis_79);
  libs__globals__lookup_bool_option_3_p_0(Globals_24, (MR_Integer) 500, &UseOptFiles_80);
        ...
        case (MR_Integer) 5:
          {
            ...
            libs__globals__lookup_bool_option_3_p_0(Globals_23, (MR_Integer) 503, &IntermodAnalysis_34);
            switch (MR_tag((MR_Word) OpModeAugment_20)) {
              default: /*NOTREACHED*/ MR_assert(0);
              case (MR_Integer) 0:
                switch (MR_unmkbody(OpModeAugment_20)) {
                        ...
                        case (MR_Integer) 1:
                          {
                            ...
                            libs__globals__lookup_bool_option_3_p_0(Globals_23, (MR_Integer) 498, &IntermodOpt_105);
                            ...
                            else
                            {
                              ...
                              libs__globals__lookup_bool_option_3_p_0(Globals_23, (MR_Integer) 500, &UseOptFiles_107);
                                ...
                                case (MR_Integer) 1:
                                  {
                                    ...
                                    libs__globals__lookup_accumulating_option_3_p_0(Globals_23, (MR_Integer) 686, &IntermodDirs_110);
  ...
  MR_Word * NeedMiddlePassForOptFile_4)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 518, &Termination_7);
  libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 525, &Termination2_8);
  libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 510, &SharingAnalysis_9);
  libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 512, &ReuseAnalysis_10);
  libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 533, &ExceptionAnalysis_11);
  libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 534, &ClosureAnalysis_12);
  libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 506, &TrailingAnalysis_13);
  libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 509, &TablingAnalysis_14);
  ...
  MR_Word * STATE_VARIABLE_Specs_37)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_21, (MR_Integer) 344, &TypeCheckConstraints_29);
