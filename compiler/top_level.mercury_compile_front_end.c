          ...
          case (MR_Integer) 0:
            {
              ...
              transform_hlds__intermod__append_analysis_pragmas_to_opt_file_7_p_0(TmpOptStream_24, *STATE_VARIABLE_HLDS_41, UnusedArgsInfos_29, ParseTreePlainOpt0_26, &ParseTreePlainOpt_30);
            }
            break;
          case (MR_Integer) 1:
            {
