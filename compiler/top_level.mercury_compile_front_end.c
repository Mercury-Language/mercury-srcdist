      ...
      case (MR_Integer) 0:
        {
          ...
          check_hlds__check_typeclass__check_typeclasses_6_p_0(STATE_VARIABLE_HLDS_45_45, &STATE_VARIABLE_HLDS_54_54, QualInfo0_16, &QualInfo_27, (MR_Word) ((MR_Integer) 0), &TypeClassSpecs_28);
...
{
  {
    ...
    if (succeeded)
    {
      succeeded = (OpModeAugment_13 == (MR_Word) ((MR_Integer) 0));
      succeeded = !(succeeded);
    }
    if (succeeded)
    {
    ...
    else
    {
      ...
      else
      {
        ...
        else
        {
          ...
          succeeded = (OpModeAugment_13 == (MR_Word) ((MR_Integer) 16));
          if (succeeded)
          {
...
{
  {
    ...
    check_hlds__check_promise__check_promises_in_module_4_p_0(STATE_VARIABLE_HLDS_0_17, &STATE_VARIABLE_HLDS_25_25, (MR_Word) ((MR_Integer) 0), &PromiseSpecs_14);
...
{
  {
    ...
    check_hlds__purity__puritycheck_module_4_p_0(STATE_VARIABLE_HLDS_0_17, &STATE_VARIABLE_HLDS_25_25, (MR_Word) ((MR_Integer) 0), &PuritySpecs_14);
                    ...
                    if (succeeded)
                    {
                      ...
                      if (succeeded)
                      {
                        ...
                        if (succeeded)
                        {
                          ...
                          if (succeeded)
                          {
                            if ((MaybeWorstSpecsSeverity_26 == (MR_Word) ((MR_Integer) 0)))
                              succeeded = MR_TRUE;
                            else
                            {
...
{
  {
    ...
    switch (InconsistentPredOrderForeignProcs_17) {
      ...
      case (MR_Integer) 0:
        switch (InconsistentPredOrderClauses_16) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 0:
            InconsistentPredOrder_18 = (MR_Word) ((MR_Integer) 0);
            break;
          case (MR_Integer) 1:
    ...
    switch (NonContiguousDecls_15) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        if ((InconsistentPredOrder_18 == (MR_Word) ((MR_Integer) 0)))
          MaybeTask_19 = (MR_Word) ((MR_Integer) 0);
        else
        {
    ...
    if ((MaybeTask_19 == (MR_Word) ((MR_Integer) 0)))
...
{
  {
    ...
    check_hlds__try_expand__expand_try_goals_in_module_4_p_0(STATE_VARIABLE_HLDS_24_24, &STATE_VARIABLE_HLDS_29_29, (MR_Word) ((MR_Integer) 0), &TryExpandSpecs_17);
...
{
  {
    ...
    if ((ModuleOISUPairs_19 == (MR_Word) ((MR_Integer) 0)))
    {
...
{
  {
      ...
      case (MR_Integer) 3:
        {
          ...
          switch (PreParSimplify_22) {
            default: /*NOTREACHED*/ MR_assert(0);
            case (MR_Integer) 0:
              SimpList_19 = (MR_Word) ((MR_Integer) 0);
              break;
            case (MR_Integer) 1:
              {
                mercury__list__cons_3_p_0((MR_Word) (&check_hlds__simplify__simplify_tasks__check_hlds__simplify__simplify_tasks__type_ctor_info_simplify_task_0), ((MR_Box) ((MR_Integer) 5)), STATE_VARIABLE_SimpList_37_37, &SimpList_19);
    ...
    if ((SimpList_19 == (MR_Word) ((MR_Integer) 0)))
    {
    ...
    else
    {
      ...
      hlds__passes_aux__process_all_nonimported_preds_errors_7_p_0(Var_70, STATE_VARIABLE_HLDS_64_64, &STATE_VARIABLE_HLDS_71_71, (MR_Word) ((MR_Integer) 0), &SimplifySpecs_30);
      switch (SimplifyPass_12) {
        default: /*NOTREACHED*/ MR_assert(0);
        case (MR_Integer) 0:
          {
