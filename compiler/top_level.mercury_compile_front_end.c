  ...
  MR_Word * STATE_VARIABLE_Specs_47)
{
  ...
  parse_tree__file_names__module_name_to_file_name_create_dirs_7_p_0(Globals_16, (MR_String) "predicate \140top_level.mercury_compile_front_end.create_and_write_opt_file\'/12", (MR_Word) (MR_mkword(2, &top_level__mercury_compile_front_end_scalar_common_4[0])), ModuleName_21, &OptFileName_22);
