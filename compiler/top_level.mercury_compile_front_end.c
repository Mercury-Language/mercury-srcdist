...
top_level__mercury_compile_front_end__IntroducedFrom__pred__maybe_simplify__1553__1_2_p_0(
    ...
    case (MR_Integer) 1:
      {
        ...
        else
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_16, (MR_Integer) 719, &Experiment5_41);
  ...
  MR_Word * STATE_VARIABLE_Specs_40)
{
  ...
  if (succeeded)
  {
      ...
      case (MR_Integer) 1:
        {
          ...
          MR_String OrderFileStr_24;
          MR_Word ModuleName_25;
          MR_String TreeFileName_26;
          MR_String OrderFileName_27;
          MR_Word TreeResult_28;
          MR_String TreeErrorMsg_30;
          MR_Word OrderResult_32;
          MR_String OrderErrorMsg_34;

          libs__file_util__maybe_write_string_5_p_0(ProgressStream_10, Verbose_12, (MR_String) "% Writing call_tree...");
          hlds__hlds_call_tree__construct_local_call_tree_file_contents_4_p_0(HLDS_14, CallTreeInfo_22, &TreeFileStr_23, &OrderFileStr_24);
          hlds__hlds_module__module_info_get_name_2_p_0(HLDS_14, &ModuleName_25);
          parse_tree__file_names__module_name_to_file_name_create_dirs_7_p_0(Globals_17, (MR_String) "predicate \140top_level.mercury_compile_front_end.maybe_write_call_tree\'/9", (MR_Word) (&top_level__mercury_compile_front_end_scalar_common_5[1]), ModuleName_25, &TreeFileName_26);
          parse_tree__file_names__module_name_to_file_name_create_dirs_7_p_0(Globals_17, (MR_String) "predicate \140top_level.mercury_compile_front_end.maybe_write_call_tree\'/9", (MR_Word) (&top_level__mercury_compile_front_end_scalar_common_5[2]), ModuleName_25, &OrderFileName_27);
          mercury__io__open_output_4_p_0(TreeFileName_26, &TreeResult_28);
          if (((MR_tag((MR_Word) TreeResult_28)) == (MR_Integer) 1))
          {
            MR_Word TreeIOError_31 = ((MR_Word) ((MR_hl_field(1, TreeResult_28, (MR_Integer) 0))));
            MR_String Var_63;
            MR_String Var_81;
            MR_String Var_83;
            MR_String Var_84;

            Var_63 = mercury__io__error_message_1_f_0(TreeIOError_31);
            Var_81 = mercury__string__f_43_43_2_f_0(Var_63, (MR_String) "\n");
            Var_83 = mercury__string__f_43_43_2_f_0((MR_String) ": ", Var_81);
            Var_84 = mercury__string__f_43_43_2_f_0(TreeFileName_26, Var_83);
            TreeErrorMsg_30 = mercury__string__f_43_43_2_f_0((MR_String) "unable to write to ", Var_84);
            libs__file_util__report_error_4_p_0(ErrorStream_11, TreeErrorMsg_30);
          }
          else
          {
            MR_Word TreeFileStream_29 = ((MR_Word) ((MR_hl_field(0, TreeResult_28, (MR_Integer) 0))));

            TreeErrorMsg_30 = (MR_String) "";
            mercury__io__write_string_4_p_0(TreeFileStream_29, TreeFileStr_23);
            mercury__io__close_output_3_p_0(TreeFileStream_29);
          }
          mercury__io__open_output_4_p_0(OrderFileName_27, &OrderResult_32);
          if (((MR_tag((MR_Word) OrderResult_32)) == (MR_Integer) 1))
          {
            MR_Word OrderIOError_35 = ((MR_Word) ((MR_hl_field(1, OrderResult_32, (MR_Integer) 0))));
            MR_String Var_74;
            MR_String Var_87;
            MR_String Var_89;
            MR_String Var_90;

            Var_74 = mercury__io__error_message_1_f_0(OrderIOError_35);
            Var_87 = mercury__string__f_43_43_2_f_0(Var_74, (MR_String) "\n");
            Var_89 = mercury__string__f_43_43_2_f_0((MR_String) ": ", Var_87);
            Var_90 = mercury__string__f_43_43_2_f_0(OrderFileName_27, Var_89);
            OrderErrorMsg_34 = mercury__string__f_43_43_2_f_0((MR_String) "unable to write to ", Var_90);
            libs__file_util__report_error_4_p_0(ErrorStream_11, OrderErrorMsg_34);
          }
          else
          {
            MR_Word OrderFileStream_33 = ((MR_Word) ((MR_hl_field(0, OrderResult_32, (MR_Integer) 0))));

            OrderErrorMsg_34 = (MR_String) "";
            mercury__io__write_string_4_p_0(OrderFileStream_33, OrderFileStr_24);
            mercury__io__close_output_3_p_0(OrderFileStream_33);
          }
          succeeded = (strcmp(TreeErrorMsg_30, (MR_String) "") == 0);
          if (succeeded)
            succeeded = (strcmp(OrderErrorMsg_34, (MR_String) "") == 0);
          if (succeeded)
    ...
    {
      MR_Word MovabilitySpecs_38;

      hlds__hlds_call_tree__generate_movability_report_4_p_0(HLDS_14, CallTreeInfo_22, ShowMovability_19, &MovabilitySpecs_38);
      *STATE_VARIABLE_Specs_40 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_error_spec_0), MovabilitySpecs_38, STATE_VARIABLE_Specs_0_39);
    }
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = top_level__mercury_compile_front_end__IntroducedFrom__pred__maybe_simplify__1553__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 4)))));
  return succeeded;
}
