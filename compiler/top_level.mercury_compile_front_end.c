  ...
  MR_Word * STATE_VARIABLE_Specs_42)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_24, (MR_Integer) 534, &IntermodOpt_78);
  libs__globals__lookup_bool_option_3_p_0(Globals_24, (MR_Integer) 539, &IntermodAnalysis_79);
  libs__globals__lookup_bool_option_3_p_0(Globals_24, (MR_Integer) 536, &UseOptFiles_80);
        ...
        case (MR_Integer) 0:
          {
            ...
            libs__globals__lookup_bool_option_3_p_0(Globals_23, (MR_Integer) 539, &IntermodAnalysis_82);
            switch ((MR_Integer) 1) {
              default: /*NOTREACHED*/ MR_assert(0);
              case (MR_Integer) 0:
                {
        ...
        case (MR_Integer) 3:
          {
            ...
            libs__globals__lookup_bool_option_3_p_0(Globals_23, (MR_Integer) 539, &IntermodAnalysis_34);
            switch ((MR_Integer) 0) {
              default: /*NOTREACHED*/ MR_assert(0);
              case (MR_Integer) 0:
                {
  ...
  MR_Word * STATE_VARIABLE_HLDS_27)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_10, (MR_Integer) 534, &IntermodOpt_13);
  ...
  else
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_10, (MR_Integer) 536, &UseOptFiles_15);
    ...
    case (MR_Integer) 1:
      {
        ...
        else
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_16, (MR_Integer) 762, &Experiment5_42);
  ...
  MR_Word * STATE_VARIABLE_Specs_46)
{
  ...
  hlds__hlds_module__module_info_get_globals_2_p_0(HLDS_14, &Globals_17);
  libs__globals__lookup_bool_option_3_p_0(Globals_17, (MR_Integer) 216, &ShowCallTree_18);
  libs__globals__lookup_accumulating_option_3_p_0(Globals_17, (MR_Integer) 222, &ShowMovability_19);
  ...
  MR_Word * STATE_VARIABLE_Specs_23)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_18, (MR_Integer) 244, &ComputeGoalModes_19);
  ...
  MR_Word * STATE_VARIABLE_Specs_34)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_22, (MR_Integer) 245, &BenchmarkModes_23);
    ...
    case (MR_Integer) 1:
      {
        ...
        libs__globals__lookup_int_option_3_p_0(Globals_22, (MR_Integer) 246, &Repeats_24);
        {
  ...
  MR_Word * STATE_VARIABLE_HLDS_16)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_13, (MR_Integer) 241, &ModeConstraints_14);
    ...
    case (MR_Integer) 1:
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_29, (MR_Integer) 245, &BenchmarkModes_30);
          ...
          case (MR_Integer) 1:
            {
              ...
              libs__globals__lookup_int_option_3_p_0(Globals_29, (MR_Integer) 246, &Repeats_31);
    ...
    case (MR_Integer) 5:
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_22, (MR_Integer) 278, &DeepProf_30);
        libs__globals__lookup_bool_option_3_p_0(Globals_22, (MR_Integer) 295, &TSWProf_31);
        libs__globals__lookup_bool_option_3_p_0(Globals_22, (MR_Integer) 296, &TSCProf_32);
    ...
    case (MR_Integer) 3:
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_22, (MR_Integer) 281, &PreParSimplify_27);
    ...
    case (MR_Integer) 2:
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_22, (MR_Integer) 280, &PreProfSimplify_26);
  ...
  MR_Word * NeedMiddlePassForOptFile_4)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 554, &Termination_7);
  libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 561, &Termination2_8);
  libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 546, &SharingAnalysis_9);
  libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 548, &ReuseAnalysis_10);
  libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 569, &ExceptionAnalysis_11);
  libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 570, &ClosureAnalysis_12);
  libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 542, &TrailingAnalysis_13);
  libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 545, &TablingAnalysis_14);
  ...
  MR_Word * STATE_VARIABLE_Specs_37)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_21, (MR_Integer) 377, &TypeCheckUsingConstraints_29);
    ...
    case (MR_Integer) 1:
      {
        ...
        libs__globals__lookup_string_option_3_p_0(Globals_21, (MR_Integer) 757, &Experiment_30);
