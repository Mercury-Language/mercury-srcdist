...
{
  {
    ...
    *STATE_VARIABLE_Specs_27 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_error_spec_0), SpecsList_20, STATE_VARIABLE_Specs_0_26);
    libs__globals__lookup_bool_option_3_p_0(Globals_19, (MR_Integer) 80, &Statistics_21);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_24, (MR_Integer) 69, &Verbose_25);
      ...
      case (MR_Integer) 0:
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_24, (MR_Integer) 79, &Stats_26);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_20, (MR_Integer) 69, &Verbose_21);
    libs__globals__lookup_bool_option_3_p_0(Globals_20, (MR_Integer) 79, &Stats_22);
          ...
          case (MR_Integer) 5:
            {
              ...
              libs__globals__lookup_bool_option_3_p_0(Globals_19, (MR_Integer) 498, &IntermodAnalysis_30);
              switch (MR_tag((MR_Word) OpModeAugment_16)) {
                default: /*NOTREACHED*/ MR_assert(0);
                case (MR_Integer) 0:
                  switch (MR_unmkbody(OpModeAugment_16)) {
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 493, &IntermodOpt_11);
    ...
    else
    {
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 495, &UseOptFiles_13);
...
{
  {
    ...
    else
    {
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals_12, (MR_Integer) 714, &Experiment5_35);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_15, (MR_Integer) 69, &Verbose_16);
    libs__globals__lookup_bool_option_3_p_0(Globals_15, (MR_Integer) 79, &Stats_17);
...
{
  {
    ...
    libs__globals__lookup_string_option_3_p_0(Globals_16, (MR_Integer) 81, &StatsFileName_17);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_14, (MR_Integer) 200, &ComputeGoalModes_15);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_18, (MR_Integer) 201, &BenchmarkModes_19);
      ...
      case (MR_Integer) 1:
        {
          ...
          libs__globals__lookup_int_option_3_p_0(Globals_18, (MR_Integer) 202, &Repeats_20);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 197, &ModeConstraints_12);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 201, &BenchmarkModes_12);
      ...
      case (MR_Integer) 1:
        {
          ...
          libs__globals__lookup_int_option_3_p_0(Globals_11, (MR_Integer) 202, &Repeats_13);
      ...
      case (MR_Integer) 5:
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_18, (MR_Integer) 236, &DeepProf_26);
          libs__globals__lookup_bool_option_3_p_0(Globals_18, (MR_Integer) 253, &TSWProf_27);
          libs__globals__lookup_bool_option_3_p_0(Globals_18, (MR_Integer) 254, &TSCProf_28);
      ...
      case (MR_Integer) 3:
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_18, (MR_Integer) 239, &PreParSimplify_23);
      ...
      case (MR_Integer) 2:
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_18, (MR_Integer) 238, &PreProfSimplify_22);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 513, &Termination_7);
    libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 520, &Termination2_8);
    libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 505, &SharingAnalysis_9);
    libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 507, &ReuseAnalysis_10);
    libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 528, &ExceptionAnalysis_11);
    libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 529, &ClosureAnalysis_12);
    libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 501, &TrailingAnalysis_13);
    libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 504, &TablingAnalysis_14);
      ...
      case (MR_Integer) 1:
        {
          ...
          libs__globals__lookup_string_option_3_p_0(Globals_17, (MR_Integer) 709, &Experiment_26);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_16, (MR_Integer) 493, &IntermodOpt_21);
    libs__globals__lookup_bool_option_3_p_0(Globals_16, (MR_Integer) 498, &IntermodAnalysis_22);
    libs__globals__lookup_bool_option_3_p_0(Globals_16, (MR_Integer) 495, &UseOptFiles_23);
