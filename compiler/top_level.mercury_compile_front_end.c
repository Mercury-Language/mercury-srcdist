...
top_level__mercury_compile_front_end__frontend_pass_after_typeclass_check_12_p_0(
  ...
  MR_Word STATE_VARIABLE_FoundError_0_40,
  MR_Word * STATE_VARIABLE_FoundError_41,
...
{
  {
    ...
    if (succeeded)
    {
...

      {
        ...
        MR_hl_field(MR_mktag(0), SimplifyTasks_16, 0) = (MR_Box) ((((packed_word_0 & (~((MR_Unsigned) 32768U)))) | (((MR_Unsigned) ((MR_Integer) 0) << 15))));
      }
    }
    else
    ...
    *STATE_VARIABLE_Specs_27 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_error_spec_0), SpecsList_20, STATE_VARIABLE_Specs_0_26);
    libs__globals__lookup_bool_option_3_p_0(Globals_19, (MR_Integer) 73, &Statistics_21);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_24, (MR_Integer) 62, &Verbose_25);
      ...
      case (MR_Integer) 0:
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_24, (MR_Integer) 72, &Stats_26);
...
{
  {
    ...
    MR_Word TypeCheckSpecs_29;
    MR_Word FoundSyntaxError_30;
    MR_Word ExceededTypeCheckIterationLimit_31;
    ...
    hlds__hlds_module__module_info_get_globals_2_p_0(STATE_VARIABLE_HLDS_0_42, &Globals_20);
    libs__globals__lookup_bool_option_3_p_0(Globals_20, (MR_Integer) 62, &Verbose_21);
    libs__globals__lookup_bool_option_3_p_0(Globals_20, (MR_Integer) 72, &Stats_22);
    libs__globals__lookup_bool_option_3_p_0(Globals_20, (MR_Integer) 351, &IntermodOpt_23);
    libs__globals__lookup_bool_option_3_p_0(Globals_20, (MR_Integer) 356, &IntermodAnalysis_24);
    libs__globals__lookup_bool_option_3_p_0(Globals_20, (MR_Integer) 353, &UseOptFiles_25);
    libs__globals__lookup_bool_option_3_p_0(Globals_20, (MR_Integer) 322, &TypeCheckConstraints_26);
    ...
    if (succeeded)
    {
      ...
      hlds__hlds_error_util__maybe_write_out_errors_8_p_0(Verbose_21, Globals_20, STATE_VARIABLE_HLDS_0_42, &STATE_VARIABLE_HLDS_56_56, STATE_VARIABLE_Specs_0_46, &STATE_VARIABLE_Specs_57_57);
      libs__file_util__maybe_write_string_4_p_0(Verbose_21, (MR_String) "% Eliminating dead predicates... ");
      transform_hlds__dead_proc_elim__dead_pred_elim_2_p_0(STATE_VARIABLE_HLDS_56_56, &STATE_VARIABLE_HLDS_61_61);
      hlds__hlds_error_util__maybe_write_out_errors_8_p_0(Verbose_21, Globals_20, STATE_VARIABLE_HLDS_61_61, &STATE_VARIABLE_HLDS_62_62, STATE_VARIABLE_Specs_57_57, &STATE_VARIABLE_Specs_63_63);
      libs__file_util__maybe_write_string_4_p_0(Verbose_21, (MR_String) "done.\n");
      hlds__passes_aux__maybe_dump_hlds_7_p_0(STATE_VARIABLE_HLDS_62_62, (MR_Integer) 10, (MR_String) "dead_pred_elim", STATE_VARIABLE_DumpInfo_0_44, &STATE_VARIABLE_DumpInfo_69_69);
    }
    else
    {
      STATE_VARIABLE_Specs_63_63 = STATE_VARIABLE_Specs_0_46;
      STATE_VARIABLE_DumpInfo_69_69 = STATE_VARIABLE_DumpInfo_0_44;
      STATE_VARIABLE_HLDS_62_62 = STATE_VARIABLE_HLDS_0_42;
    }
    libs__globals__lookup_bool_option_3_p_0(Globals_20, (MR_Integer) 48, &WarnInstsWithNoMatchingType_27);
    switch (WarnInstsWithNoMatchingType_27) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        {
          STATE_VARIABLE_HLDS_79_79 = STATE_VARIABLE_HLDS_62_62;
          STATE_VARIABLE_DumpInfo_86_86 = STATE_VARIABLE_DumpInfo_69_69;
          STATE_VARIABLE_Specs_80_80 = STATE_VARIABLE_Specs_63_63;
        }
        break;
      case (MR_Integer) 1:
        {
          ...
          hlds__hlds_error_util__maybe_write_out_errors_8_p_0(Verbose_21, Globals_20, STATE_VARIABLE_HLDS_62_62, &STATE_VARIABLE_HLDS_72_72, STATE_VARIABLE_Specs_63_63, &STATE_VARIABLE_Specs_73_73);
          libs__file_util__maybe_write_string_4_p_0(Verbose_21, (MR_String) "% Checking that insts have matching types... ");
          check_hlds__inst_check__check_insts_have_matching_types_4_p_0(STATE_VARIABLE_HLDS_72_72, &STATE_VARIABLE_HLDS_77_77, STATE_VARIABLE_Specs_73_73, &STATE_VARIABLE_Specs_78_78);
          hlds__hlds_error_util__maybe_write_out_errors_8_p_0(Verbose_21, Globals_20, STATE_VARIABLE_HLDS_77_77, &STATE_VARIABLE_HLDS_79_79, STATE_VARIABLE_Specs_78_78, &STATE_VARIABLE_Specs_80_80);
          libs__file_util__maybe_write_string_4_p_0(Verbose_21, (MR_String) "done.\n");
          hlds__passes_aux__maybe_dump_hlds_7_p_0(STATE_VARIABLE_HLDS_79_79, (MR_Integer) 12, (MR_String) "warn_insts_without_matching_type", STATE_VARIABLE_DumpInfo_69_69, &STATE_VARIABLE_DumpInfo_86_86);
        }
        break;
    }
    hlds__hlds_error_util__maybe_write_out_errors_8_p_0(Verbose_21, Globals_20, STATE_VARIABLE_HLDS_79_79, &STATE_VARIABLE_HLDS_88_88, STATE_VARIABLE_Specs_80_80, &STATE_VARIABLE_Specs_89_89);
      ...
      case (MR_Integer) 0:
        {
          ...
          check_hlds__pre_typecheck__prepare_for_typecheck_module_2_p_0(STATE_VARIABLE_HLDS_88_88, &STATE_VARIABLE_HLDS_95_95);
          check_hlds__typecheck__typecheck_module_5_p_0(STATE_VARIABLE_HLDS_95_95, &STATE_VARIABLE_HLDS_98_98, &TypeCheckSpecs_29, &FoundSyntaxError_30, &ExceededTypeCheckIterationLimit_31);
        }
        break;
      case (MR_Integer) 1:
        {
          MR_String Experiment_28;

          libs__globals__lookup_string_option_3_p_0(Globals_20, (MR_Integer) 694, &Experiment_28);
          succeeded = (strcmp(Experiment_28, (MR_String) "old_type_constraints") == 0);
          if (succeeded)
            check_hlds__old_type_constraints__old_typecheck_constraints_3_p_0(STATE_VARIABLE_HLDS_88_88, &STATE_VARIABLE_HLDS_98_98, &TypeCheckSpecs_29);
          else
            check_hlds__type_constraints__typecheck_constraints_3_p_0(STATE_VARIABLE_HLDS_88_88, &STATE_VARIABLE_HLDS_98_98, &TypeCheckSpecs_29);
          FoundSyntaxError_30 = (MR_Integer) 0;
          ExceededTypeCheckIterationLimit_31 = (MR_Integer) 0;
        }
        break;
    }
    STATE_VARIABLE_Specs_100_100 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_error_spec_0), TypeCheckSpecs_29, STATE_VARIABLE_Specs_89_89);
    hlds__hlds_error_util__maybe_write_out_errors_8_p_0(Verbose_21, Globals_20, STATE_VARIABLE_HLDS_98_98, &STATE_VARIABLE_HLDS_101_101, STATE_VARIABLE_Specs_100_100, &STATE_VARIABLE_Specs_102_102);
    FoundTypeError_32 = parse_tree__error_util__contains_errors_2_f_0(Globals_20, TypeCheckSpecs_29);
    ...
    hlds__passes_aux__maybe_dump_hlds_7_p_0(STATE_VARIABLE_HLDS_101_101, (MR_Integer) 15, (MR_String) "typecheck", STATE_VARIABLE_DumpInfo_86_86, &STATE_VARIABLE_DumpInfo_111_111);
    succeeded = (FoundUndefModeError_14 == (MR_Integer) 1);
    if (succeeded)
    {
      *STATE_VARIABLE_FoundError_41 = (MR_Integer) 1;
      libs__file_util__maybe_write_string_4_p_0(Verbose_21, (MR_String) "% Program contains undefined inst or undefined mode error(s).\n");
      mercury__io__set_exit_status_3_p_0((MR_Integer) 1);
      *STATE_VARIABLE_Specs_47 = STATE_VARIABLE_Specs_102_102;
      *STATE_VARIABLE_DumpInfo_45 = STATE_VARIABLE_DumpInfo_111_111;
      *STATE_VARIABLE_HLDS_43 = STATE_VARIABLE_HLDS_101_101;
    }
    else
    {
      succeeded = (ExceededTypeCheckIterationLimit_31 == (MR_Integer) 1);
      if (succeeded)
      {
        *STATE_VARIABLE_FoundError_41 = (MR_Integer) 1;
        mercury__io__set_exit_status_3_p_0((MR_Integer) 1);
      ...
      else
      {
        ...
        MR_Word SomeMissingTypeDefns_34;
        MR_Integer NumPostTypeCheckErrors_35;
        MR_Word PostTypeCheckAlwaysSpecs_36;
        MR_Word PostTypeCheckNoTypeErrorSpecs_37;
        ...
        check_hlds__check_for_missing_type_defns__check_for_missing_type_defns_2_p_0(STATE_VARIABLE_HLDS_101_101, &MissingTypeDefnSpecs_33);
        STATE_VARIABLE_Specs_123_123 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_error_spec_0), STATE_VARIABLE_Specs_102_102, MissingTypeDefnSpecs_33);
        SomeMissingTypeDefns_34 = parse_tree__error_util__contains_errors_2_f_0(Globals_20, MissingTypeDefnSpecs_33);
        check_hlds__inst_user__pretest_user_inst_table_2_p_0(STATE_VARIABLE_HLDS_101_101, &STATE_VARIABLE_HLDS_124_124);
        check_hlds__post_typecheck__post_typecheck_finish_preds_5_p_0(STATE_VARIABLE_HLDS_124_124, &STATE_VARIABLE_HLDS_125_125, &NumPostTypeCheckErrors_35, &PostTypeCheckAlwaysSpecs_36, &PostTypeCheckNoTypeErrorSpecs_37);
        hlds__passes_aux__maybe_dump_hlds_7_p_0(STATE_VARIABLE_HLDS_125_125, (MR_Integer) 19, (MR_String) "post_typecheck", STATE_VARIABLE_DumpInfo_111_111, &STATE_VARIABLE_DumpInfo_128_128);
        STATE_VARIABLE_Specs_130_130 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_error_spec_0), STATE_VARIABLE_Specs_123_123, PostTypeCheckAlwaysSpecs_36);
        switch (FoundTypeError_32) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 0:
            STATE_VARIABLE_Specs_131_131 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_error_spec_0), STATE_VARIABLE_Specs_130_130, PostTypeCheckNoTypeErrorSpecs_37);
            break;
          case (MR_Integer) 1:
            STATE_VARIABLE_Specs_131_131 = STATE_VARIABLE_Specs_130_130;
            break;
        }
        succeeded = (FoundTypeError_32 == (MR_Integer) 1);
        if (!(succeeded))
        {
          succeeded = (FoundSyntaxError_30 == (MR_Integer) 1);
          if (!(succeeded))
          {
            succeeded = (SomeMissingTypeDefns_34 == (MR_Integer) 1);
            if (!(succeeded))
            {
              succeeded = (NumPostTypeCheckErrors_35 > (MR_Integer) 0);
            }
          }
        }
        if (succeeded)
        {
          *STATE_VARIABLE_FoundError_41 = (MR_Integer) 1;
          *STATE_VARIABLE_Specs_47 = STATE_VARIABLE_Specs_131_131;
          *STATE_VARIABLE_DumpInfo_45 = STATE_VARIABLE_DumpInfo_128_128;
          *STATE_VARIABLE_HLDS_43 = STATE_VARIABLE_HLDS_125_125;
        }
        else
        {
          ...
          top_level__mercury_compile_front_end__puritycheck_8_p_0(Verbose_21, Stats_22, STATE_VARIABLE_HLDS_125_125, &STATE_VARIABLE_HLDS_134_134, STATE_VARIABLE_Specs_131_131, &STATE_VARIABLE_Specs_135_135);
          hlds__passes_aux__maybe_dump_hlds_7_p_0(STATE_VARIABLE_HLDS_134_134, (MR_Integer) 20, (MR_String) "puritycheck", STATE_VARIABLE_DumpInfo_128_128, &STATE_VARIABLE_DumpInfo_139_139);
          top_level__mercury_compile_front_end__check_promises_8_p_0(Verbose_21, Stats_22, STATE_VARIABLE_HLDS_134_134, &STATE_VARIABLE_HLDS_141_141, STATE_VARIABLE_Specs_135_135, &STATE_VARIABLE_Specs_142_142);
          hlds__passes_aux__maybe_dump_hlds_7_p_0(STATE_VARIABLE_HLDS_141_141, (MR_Integer) 22, (MR_String) "check_promises", STATE_VARIABLE_DumpInfo_139_139, &STATE_VARIABLE_DumpInfo_146_146);
          succeeded = (OpModeAugment_13 == (MR_Word) ((MR_Unsigned) 16U));
          if (succeeded)
          {
            *STATE_VARIABLE_Specs_47 = STATE_VARIABLE_Specs_142_142;
            *STATE_VARIABLE_DumpInfo_45 = STATE_VARIABLE_DumpInfo_146_146;
            *STATE_VARIABLE_HLDS_43 = STATE_VARIABLE_HLDS_141_141;
            *STATE_VARIABLE_FoundError_41 = STATE_VARIABLE_FoundError_0_40;
          }
          else
          {
            MR_Word MakeOptInt_38;
            ...
            top_level__mercury_compile_front_end__subst_implementation_defined_literals_8_p_0(Verbose_21, Stats_22, STATE_VARIABLE_HLDS_141_141, &STATE_VARIABLE_HLDS_148_148, STATE_VARIABLE_Specs_142_142, &STATE_VARIABLE_Specs_149_149);
            hlds__passes_aux__maybe_dump_hlds_7_p_0(STATE_VARIABLE_HLDS_148_148, (MR_Integer) 25, (MR_String) "implementation_defined_literals", STATE_VARIABLE_DumpInfo_146_146, &STATE_VARIABLE_DumpInfo_153_153);
            succeeded = (OpModeAugment_13 == (MR_Word) ((MR_Unsigned) 0U));
            if (succeeded)
              MakeOptInt_38 = (MR_Integer) 1;
            else
              MakeOptInt_38 = (MR_Integer) 0;
            succeeded = (STATE_VARIABLE_FoundError_0_40 == (MR_Integer) 0);
            if (succeeded)
              succeeded = (FoundUndefModeError_14 == (MR_Integer) 0);
            if (succeeded)
              top_level__mercury_compile_front_end__maybe_write_initial_optfile_9_p_0(MakeOptInt_38, STATE_VARIABLE_HLDS_148_148, &STATE_VARIABLE_HLDS_155_155, STATE_VARIABLE_DumpInfo_153_153, &STATE_VARIABLE_DumpInfo_156_156, STATE_VARIABLE_Specs_149_149, &STATE_VARIABLE_Specs_157_157);
            else
            {
              STATE_VARIABLE_Specs_157_157 = STATE_VARIABLE_Specs_149_149;
              STATE_VARIABLE_DumpInfo_156_156 = STATE_VARIABLE_DumpInfo_153_153;
              STATE_VARIABLE_HLDS_155_155 = STATE_VARIABLE_HLDS_148_148;
            }
            switch (MakeOptInt_38) {
              default: /*NOTREACHED*/ MR_assert(0);
              case (MR_Integer) 0:
                {
                  MR_Word FoundModeOrDetError_39;

                  top_level__mercury_compile_front_end__frontend_pass_by_phases_9_p_0(STATE_VARIABLE_HLDS_155_155, STATE_VARIABLE_HLDS_43, &FoundModeOrDetError_39, STATE_VARIABLE_DumpInfo_156_156, STATE_VARIABLE_DumpInfo_45, STATE_VARIABLE_Specs_157_157, STATE_VARIABLE_Specs_47);
                  *STATE_VARIABLE_FoundError_41 = mercury__bool__or_2_f_0(STATE_VARIABLE_FoundError_0_40, FoundModeOrDetError_39);
                }
                break;
              case (MR_Integer) 1:
                {
                  *STATE_VARIABLE_FoundError_41 = STATE_VARIABLE_FoundError_0_40;
                  *STATE_VARIABLE_HLDS_43 = STATE_VARIABLE_HLDS_155_155;
                  *STATE_VARIABLE_DumpInfo_45 = STATE_VARIABLE_DumpInfo_156_156;
                  *STATE_VARIABLE_Specs_47 = STATE_VARIABLE_Specs_157_157;
                }
                break;
            }
          }
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_15, (MR_Integer) 351, &IntermodOpt_16);
    libs__globals__lookup_bool_option_3_p_0(Globals_15, (MR_Integer) 356, &IntermodAnalysis_17);
    libs__globals__lookup_bool_option_3_p_0(Globals_15, (MR_Integer) 378, &IntermodArgs_18);
    libs__globals__lookup_accumulating_option_3_p_0(Globals_15, (MR_Integer) 673, &IntermodDirs_19);
    libs__globals__lookup_bool_option_3_p_0(Globals_15, (MR_Integer) 353, &UseOptFiles_20);
    libs__globals__lookup_bool_option_3_p_0(Globals_15, (MR_Integer) 442, &Termination_21);
    libs__globals__lookup_bool_option_3_p_0(Globals_15, (MR_Integer) 449, &Termination2_22);
    libs__globals__lookup_bool_option_3_p_0(Globals_15, (MR_Integer) 434, &SharingAnalysis_23);
    libs__globals__lookup_bool_option_3_p_0(Globals_15, (MR_Integer) 436, &ReuseAnalysis_24);
    libs__globals__lookup_bool_option_3_p_0(Globals_15, (MR_Integer) 457, &ExceptionAnalysis_25);
    libs__globals__lookup_bool_option_3_p_0(Globals_15, (MR_Integer) 458, &ClosureAnalysis_26);
    libs__globals__lookup_bool_option_3_p_0(Globals_15, (MR_Integer) 421, &TrailingAnalysis_27);
    libs__globals__lookup_bool_option_3_p_0(Globals_15, (MR_Integer) 424, &TablingAnalysis_28);
              ...
              case (MR_Integer) 1:
                {
                  ...
                  MR_String OptName_79;

                  hlds__hlds_module__module_info_get_name_2_p_0(STATE_VARIABLE_HLDS_0_36, &ModuleName_78);
                  parse_tree__file_names__module_name_to_search_file_name_6_p_0(Globals_15, (MR_String) ".opt", ModuleName_78, &OptName_79);
                  libs__file_util__search_for_file_returning_dir_5_p_0(IntermodDirs_19, OptName_79, &MaybeDir_33);
      ...
      case (MR_Integer) 1:
        {
          ...
          if (succeeded)
          {
            ...
            top_level__mercury_compile_front_end__frontend_pass_by_phases_9_p_0(STATE_VARIABLE_HLDS_61_61, &STATE_VARIABLE_HLDS_63_63, &FoundError_29, STATE_VARIABLE_DumpInfo_0_38, STATE_VARIABLE_DumpInfo_39, STATE_VARIABLE_Specs_0_40, &STATE_VARIABLE_Specs_65_65);
            switch (FoundError_29) {
              default: /*NOTREACHED*/ MR_assert(0);
              case (MR_Integer) 0:
                top_level__mercury_compile_middle_passes__middle_pass_for_opt_file_6_p_0(STATE_VARIABLE_HLDS_63_63, STATE_VARIABLE_HLDS_37, STATE_VARIABLE_Specs_65_65, STATE_VARIABLE_Specs_41);
                break;
              case (MR_Integer) 1:
                {
                  mercury__io__set_exit_status_3_p_0((MR_Integer) 1);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_15, (MR_Integer) 62, &Verbose_16);
    libs__globals__lookup_bool_option_3_p_0(Globals_15, (MR_Integer) 72, &Stats_17);
...
{
  {
    ...
    libs__globals__lookup_string_option_3_p_0(Globals_16, (MR_Integer) 74, &StatsFileName_17);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_14, (MR_Integer) 20, &NonContiguousDecls_15);
    libs__globals__lookup_bool_option_3_p_0(Globals_14, (MR_Integer) 18, &InconsistentPredOrderClauses_16);
    libs__globals__lookup_bool_option_3_p_0(Globals_14, (MR_Integer) 19, &InconsistentPredOrderForeignProcs_17);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_17, (MR_Integer) 23, &Warn_18);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_14, (MR_Integer) 185, &ComputeGoalModes_15);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_18, (MR_Integer) 186, &BenchmarkModes_19);
      ...
      case (MR_Integer) 1:
        {
          ...
          libs__globals__lookup_int_option_3_p_0(Globals_18, (MR_Integer) 187, &Repeats_20);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 182, &ModeConstraints_12);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 186, &BenchmarkModes_12);
      ...
      case (MR_Integer) 1:
        {
          ...
          libs__globals__lookup_int_option_3_p_0(Globals_11, (MR_Integer) 187, &Repeats_13);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_14, (MR_Integer) 50, &WarnUnusedImports_15);
      ...
      case (MR_Integer) 5:
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_18, (MR_Integer) 393, &ConstProp_23);
          libs__globals__lookup_bool_option_3_p_0(Globals_18, (MR_Integer) 218, &DeepProf_24);
          libs__globals__lookup_bool_option_3_p_0(Globals_18, (MR_Integer) 235, &TSWProf_25);
          libs__globals__lookup_bool_option_3_p_0(Globals_18, (MR_Integer) 236, &TSCProf_26);
      ...
      case (MR_Integer) 3:
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_18, (MR_Integer) 221, &PreParSimplify_22);
      ...
      case (MR_Integer) 2:
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_18, (MR_Integer) 220, &PreProfSimplify_21);
