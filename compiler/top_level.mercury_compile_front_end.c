...
static void MR_CALL 
top_level__mercury_compile_front_end__IntroducedFrom__pred__modecheck__1034__1_3_p_0(
  MR_Word ProgressStream_13,
  MR_Word LambdaHeadVar__1_43,
  MR_Tuple * LambdaHeadVar__2_44);

static MR_bool MR_CALL 
top_level__mercury_compile_front_end__IntroducedFrom__pred__maybe_simplify__1477__1_2_p_0(
...
static /* final */ const MR_Box top_level__mercury_compile_front_end_scalar_common_1[4][2];
...
static /* final */ const MR_Box top_level__mercury_compile_front_end_scalar_common_4[3][1];
  ...
  MR_Word * STATE_VARIABLE_Specs_42)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_24, (MR_Integer) 500, &IntermodOpt_78);
  libs__globals__lookup_bool_option_3_p_0(Globals_24, (MR_Integer) 505, &IntermodAnalysis_79);
  libs__globals__lookup_bool_option_3_p_0(Globals_24, (MR_Integer) 502, &UseOptFiles_80);
        ...
        case (MR_Integer) 0:
          {
            ...
            libs__globals__lookup_bool_option_3_p_0(Globals_23, (MR_Integer) 505, &IntermodAnalysis_82);
            switch ((MR_Integer) 1) {
              default: /*NOTREACHED*/ MR_assert(0);
              case (MR_Integer) 0:
                {
                  ...
                  switch (MakeOptIntEnabled_81) {
                    ...
                    case (MR_Integer) 0:
                      ...
                      break;
                    case (MR_Integer) 1:
                      top_level__mercury_compile_front_end__mark_entities_in_opt_file_as_opt_exported_6_p_0(IntermodAnalysis_82, Globals_23, STATE_VARIABLE_HLDS_60_84, &STATE_VARIABLE_HLDS_72_75);
                      break;
                  }
        ...
        case (MR_Integer) 5:
          {
            ...
            libs__globals__lookup_bool_option_3_p_0(Globals_23, (MR_Integer) 505, &IntermodAnalysis_34);
            switch ((MR_Integer) 0) {
              default: /*NOTREACHED*/ MR_assert(0);
              case (MR_Integer) 0:
                {
  ...
  MR_Word * STATE_VARIABLE_HLDS_21)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 500, &IntermodOpt_11);
  succeeded = (IntermodOpt_11 == (MR_Integer) 1);
  if (!(succeeded))
    succeeded = (IntermodAnalysis_7 == (MR_Integer) 1);
  if (succeeded)
    transform_hlds__intermod_mark_exported__maybe_opt_export_entities_2_p_0(STATE_VARIABLE_HLDS_0_20, STATE_VARIABLE_HLDS_21);
  else
  {
    MR_Word UseOptFiles_13;

    libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 502, &UseOptFiles_13);
      ...
      case (MR_Integer) 1:
        {
          ...
          parse_tree__file_names__module_name_to_search_file_name_5_p_0(Globals_8, (MR_String) "predicate \140top_level.mercury_compile_front_end.mark_entities_in_opt_file_as_opt_exported\'/6", (MR_Word) (MR_mkword(2, &top_level__mercury_compile_front_end_scalar_common_4[0])), ModuleName_14, &OptFileName_15);
  ...
  MR_Word * STATE_VARIABLE_Specs_47)
{
  ...
  else
  {
    ...
    transform_hlds__intermod_mark_exported__maybe_opt_export_listed_entities_3_p_0(IntermodInfo_29, STATE_VARIABLE_HLDS_0_42, &STATE_VARIABLE_HLDS_70_70);
    ...
    parse_tree__module_cmds__copy_dot_tmp_to_base_file_report_any_error_7_p_0(Globals_16, (MR_String) ".opt", ModuleName_21, OptFileName_22, &_UpdateSucceeded_35);
    parse_tree__module_cmds__touch_module_ext_datestamp_8_p_0(Globals_16, ProgressStream_13, ErrorStream_14, ModuleName_21, (MR_Word) (MR_mkword(3, &top_level__mercury_compile_front_end_scalar_common_1[1])), &_TouchSucceeded_36);
  ...
  MR_Word * STATE_VARIABLE_Specs_28)
{
  ...
  switch (InconsistentPredOrderForeignProcs_21) {
    ...
    case (MR_Integer) 0:
      ...
      break;
    case (MR_Integer) 1:
      WarnPredDeclDefnOrder_22 = (MR_Word) (MR_mkword(1, &top_level__mercury_compile_front_end_scalar_common_4[2]));
      break;
  }
    ...
    case (MR_Integer) 1:
      {
        ...
        parse_tree__file_names__module_name_to_file_name_create_dirs_7_p_0(Globals_14, (MR_String) "predicate \140top_level.mercury_compile_front_end.maybe_write_call_tree\'/7", (MR_Word) (MR_mkword(3, &top_level__mercury_compile_front_end_scalar_common_1[2])), ModuleName_16, &TreeFileName_17);
        parse_tree__file_names__module_name_to_file_name_create_dirs_7_p_0(Globals_14, (MR_String) "predicate \140top_level.mercury_compile_front_end.maybe_write_call_tree\'/7", (MR_Word) (MR_mkword(3, &top_level__mercury_compile_front_end_scalar_common_1[3])), ModuleName_16, &OrderFileName_18);
  ...
  MR_Box * wrapper_arg_2)
{
  ...
  top_level__mercury_compile_front_end__IntroducedFrom__pred__modecheck__1034__1_3_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) (wrapper_arg_1)), &conv0_LambdaHeadVar__2_44);
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = top_level__mercury_compile_front_end__IntroducedFrom__pred__maybe_simplify__1477__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 4)))));
  return succeeded;
}
  ...
  MR_Word * NeedMiddlePassForOptFile_4)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 520, &Termination_7);
  libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 527, &Termination2_8);
  libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 512, &SharingAnalysis_9);
  libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 514, &ReuseAnalysis_10);
  libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 535, &ExceptionAnalysis_11);
  libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 536, &ClosureAnalysis_12);
  libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 508, &TrailingAnalysis_13);
  libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 511, &TablingAnalysis_14);
