...
static void MR_CALL 
top_level__mercury_compile_front_end__IntroducedFrom__pred__modecheck__1036__1_3_p_0(
  MR_Word ProgressStream_13,
  MR_Word LambdaHeadVar__1_43,
  MR_Tuple * LambdaHeadVar__2_44);

static MR_bool MR_CALL 
top_level__mercury_compile_front_end__IntroducedFrom__pred__maybe_simplify__1479__1_2_p_0(
      ...
      case (MR_Integer) 1:
        {
          ...
          parse_tree__file_names__module_name_to_search_file_name_5_p_0(Globals_8, (MR_String) "predicate \140top_level.mercury_compile_front_end.mark_entities_in_opt_file_as_opt_exported\'/6", (MR_Word) (MR_mkword(3, &top_level__mercury_compile_front_end_scalar_common_1[1])), ModuleName_14, &OptFileName_15);
  ...
  MR_Word * STATE_VARIABLE_Specs_47)
{
  ...
  parse_tree__file_names__module_name_to_file_name_create_dirs_7_p_0(Globals_16, (MR_String) "predicate \140top_level.mercury_compile_front_end.create_and_write_opt_file\'/12", (MR_Word) (MR_mkword(3, &top_level__mercury_compile_front_end_scalar_common_1[1])), ModuleName_21, &OptFileName_22);
  ...
  else
  {
    ...
    parse_tree__module_cmds__touch_module_ext_datestamp_8_p_0(Globals_16, ProgressStream_13, ErrorStream_14, ModuleName_21, (MR_Word) (MR_mkword(3, &top_level__mercury_compile_front_end_scalar_common_1[2])), &_TouchSucceeded_36);
    ...
    case (MR_Integer) 1:
      {
        ...
        parse_tree__file_names__module_name_to_file_name_create_dirs_7_p_0(Globals_14, (MR_String) "predicate \140top_level.mercury_compile_front_end.maybe_write_call_tree\'/7", (MR_Word) (MR_mkword(1, &top_level__mercury_compile_front_end_scalar_common_4[1])), ModuleName_16, &TreeFileName_17);
        parse_tree__file_names__module_name_to_file_name_create_dirs_7_p_0(Globals_14, (MR_String) "predicate \140top_level.mercury_compile_front_end.maybe_write_call_tree\'/7", (MR_Word) (MR_mkword(1, &top_level__mercury_compile_front_end_scalar_common_4[2])), ModuleName_16, &OrderFileName_18);
  ...
  MR_Box * wrapper_arg_2)
{
  ...
  top_level__mercury_compile_front_end__IntroducedFrom__pred__modecheck__1036__1_3_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) (wrapper_arg_1)), &conv0_LambdaHeadVar__2_44);
    ...
    case (MR_Integer) 1:
      {
        ...
        *SafeToContinue_19 = ((MR_Word) ((MR_hl_field(0, Var_45, (MR_Integer) 1))));
        ...
        mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&top_level__mercury_compile_front_end_scalar_common_4[0]), Repeats_24, &Var_75);
        ...
        mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&top_level__mercury_compile_front_end_scalar_common_4[0]), Time_26, &Var_85);
          ...
          case (MR_Integer) 1:
            {
              ...
              mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&top_level__mercury_compile_front_end_scalar_common_4[0]), Repeats_31, &Var_53);
              ...
              *STATE_VARIABLE_HLDS_16 = ((MR_Word) (conv2_STATE_VARIABLE_HLDS_16));
              mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&top_level__mercury_compile_front_end_scalar_common_4[0]), Time_32, &Var_62);
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = top_level__mercury_compile_front_end__IntroducedFrom__pred__maybe_simplify__1479__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 4)))));
  return succeeded;
}
