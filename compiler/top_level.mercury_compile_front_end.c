      ...
      case (MR_Integer) 1:
        {
          ...
          libs__globals__lookup_accumulating_option_3_p_0(Globals_8, (MR_Integer) 683, &IntermodDirs_16);
  ...
  MR_Word * STATE_VARIABLE_Specs_45)
{
  ...
  else
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_12, (MR_Integer) 709, &Experiment5_35);
    ...
    case (MR_Integer) 1:
      {
        ...
        libs__globals__lookup_string_option_3_p_0(Globals_17, (MR_Integer) 704, &Experiment_26);
