...
{
  {
    ...
    hlds__hlds_module__module_info_get_name_2_p_0(STATE_VARIABLE_HLDS_0_36, &ModuleName_17);
    ...
    else
    {
      ...
      transform_hlds__intermod__write_initial_opt_file_6_p_0(TmpOptStream_24, STATE_VARIABLE_HLDS_0_36, &IntermodInfo_25, &ParseTreePlainOpt0_26);
      transform_hlds__intermod__maybe_opt_export_listed_entities_3_p_0(IntermodInfo_25, STATE_VARIABLE_HLDS_0_36, &STATE_VARIABLE_HLDS_53_53);
      ...
      if (succeeded)
      {
        ...
        top_level__mercury_compile_front_end__frontend_pass_by_phases_9_p_0(STATE_VARIABLE_HLDS_53_53, &STATE_VARIABLE_HLDS_54_54, &FoundError_28, STATE_VARIABLE_DumpInfo_0_38, STATE_VARIABLE_DumpInfo_39, STATE_VARIABLE_Specs_0_40, &STATE_VARIABLE_Specs_56_56);
          ...
          case (MR_Integer) 0:
            {
              ...
              top_level__mercury_compile_middle_passes__middle_pass_for_opt_file_7_p_0(STATE_VARIABLE_HLDS_54_54, STATE_VARIABLE_HLDS_37, &UnusedArgsInfos_29, STATE_VARIABLE_Specs_56_56, STATE_VARIABLE_Specs_41);
              transform_hlds__intermod__append_analysis_pragmas_to_opt_file_7_p_0(TmpOptStream_24, *STATE_VARIABLE_HLDS_37, UnusedArgsInfos_29, ParseTreePlainOpt0_26, &ParseTreePlainOpt_30);
            }
            break;
          case (MR_Integer) 1:
            {
              ...
              *STATE_VARIABLE_HLDS_37 = STATE_VARIABLE_HLDS_54_54;
              *STATE_VARIABLE_Specs_41 = STATE_VARIABLE_Specs_56_56;
            }
            break;
        }
      }
      else
      {
        ...
        *STATE_VARIABLE_Specs_41 = STATE_VARIABLE_Specs_0_40;
        *STATE_VARIABLE_DumpInfo_39 = STATE_VARIABLE_DumpInfo_0_38;
        *STATE_VARIABLE_HLDS_37 = STATE_VARIABLE_HLDS_53_53;
      }
      ...
      parse_tree__module_cmds__touch_interface_datestamp_5_p_0(Globals_12, ModuleName_17, (MR_Word) (((MR_Box) ((MR_String) ".optdate"))));
      libs__globals__lookup_bool_option_3_p_0(Globals_12, (MR_Integer) 707, &Experiment5_31);
        ...
        case (MR_Integer) 1:
          {
            ...
            Var_70 = mercury__string__f_43_43_2_f_0(OptFileName_18, (MR_String) "x");
            ...
            if (!(((MR_tag((MR_Word) OptXResult_32)) == (MR_Integer) 1)))
            {
              ...
              parse_tree__parse_tree_out__mercury_output_parse_tree_plain_opt_5_p_0(Info_35, OptXStream_34, ParseTreePlainOpt_30);
