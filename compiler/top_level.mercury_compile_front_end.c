  ...
  MR_Word * STATE_VARIABLE_Specs_38)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_20, (MR_Integer) 492, &IntermodOpt_76);
  libs__globals__lookup_bool_option_3_p_0(Globals_20, (MR_Integer) 497, &IntermodAnalysis_77);
  libs__globals__lookup_bool_option_3_p_0(Globals_20, (MR_Integer) 494, &UseOptFiles_78);
        ...
        case (MR_Integer) 5:
          {
            ...
            libs__globals__lookup_bool_option_3_p_0(Globals_19, (MR_Integer) 497, &IntermodAnalysis_30);
            switch (MR_tag((MR_Word) OpModeAugment_16)) {
              default: /*NOTREACHED*/ MR_assert(0);
              case (MR_Integer) 0:
                switch (MR_unmkbody(OpModeAugment_16)) {
                        ...
                        case (MR_Integer) 1:
                          {
                            ...
                            libs__globals__lookup_bool_option_3_p_0(Globals_19, (MR_Integer) 492, &IntermodOpt_101);
                            ...
                            else
                            {
                              ...
                              libs__globals__lookup_bool_option_3_p_0(Globals_19, (MR_Integer) 494, &UseOptFiles_103);
                                ...
                                case (MR_Integer) 1:
                                  {
                                    ...
                                    libs__globals__lookup_accumulating_option_3_p_0(Globals_19, (MR_Integer) 679, &IntermodDirs_106);
  ...
  MR_Word * STATE_VARIABLE_Specs_45)
{
  ...
  else
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_12, (MR_Integer) 705, &Experiment5_35);
  ...
  MR_Word * STATE_VARIABLE_Specs_19)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_14, (MR_Integer) 204, &ComputeGoalModes_15);
  ...
  MR_Word * STATE_VARIABLE_Specs_26)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_18, (MR_Integer) 205, &BenchmarkModes_19);
    ...
    case (MR_Integer) 1:
      {
        ...
        libs__globals__lookup_int_option_3_p_0(Globals_18, (MR_Integer) 206, &Repeats_20);
  ...
  MR_Word * STATE_VARIABLE_HLDS_14)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 201, &ModeConstraints_12);
    ...
    case (MR_Integer) 1:
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_28, (MR_Integer) 205, &BenchmarkModes_29);
          ...
          case (MR_Integer) 1:
            {
              ...
              libs__globals__lookup_int_option_3_p_0(Globals_28, (MR_Integer) 206, &Repeats_30);
    ...
    case (MR_Integer) 5:
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_18, (MR_Integer) 238, &DeepProf_26);
        libs__globals__lookup_bool_option_3_p_0(Globals_18, (MR_Integer) 255, &TSWProf_27);
        libs__globals__lookup_bool_option_3_p_0(Globals_18, (MR_Integer) 256, &TSCProf_28);
    ...
    case (MR_Integer) 3:
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_18, (MR_Integer) 241, &PreParSimplify_23);
    ...
    case (MR_Integer) 2:
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_18, (MR_Integer) 240, &PreProfSimplify_22);
  ...
  MR_Word * NeedMiddlePassForOptFile_4)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 512, &Termination_7);
  libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 519, &Termination2_8);
  libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 504, &SharingAnalysis_9);
  libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 506, &ReuseAnalysis_10);
  libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 527, &ExceptionAnalysis_11);
  libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 528, &ClosureAnalysis_12);
  libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 500, &TrailingAnalysis_13);
  libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 503, &TablingAnalysis_14);
  ...
  MR_Word * STATE_VARIABLE_Specs_33)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_17, (MR_Integer) 337, &TypeCheckConstraints_25);
    ...
    case (MR_Integer) 1:
      {
        ...
        libs__globals__lookup_string_option_3_p_0(Globals_17, (MR_Integer) 700, &Experiment_26);
