...
top_level__mercury_compile_front_end__create_and_write_opt_file_10_p_0(
  ...
  MR_Word STATE_VARIABLE_DumpInfo_0_23,
  MR_Word * STATE_VARIABLE_DumpInfo_24,
...
{
  {
    ...
    *STATE_VARIABLE_Specs_27 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_error_spec_0), SpecsList_20, STATE_VARIABLE_Specs_0_26);
    libs__globals__lookup_bool_option_3_p_0(Globals_19, (MR_Integer) 74, &Statistics_21);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_24, (MR_Integer) 63, &Verbose_25);
      ...
      case (MR_Integer) 0:
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_24, (MR_Integer) 73, &Stats_26);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_20, (MR_Integer) 63, &Verbose_21);
    libs__globals__lookup_bool_option_3_p_0(Globals_20, (MR_Integer) 73, &Stats_22);
          ...
          case (MR_Integer) 5:
            {
              ...
              libs__globals__lookup_bool_option_3_p_0(Globals_19, (MR_Integer) 357, &IntermodAnalysis_30);
              switch (MR_tag((MR_Word) OpModeAugment_16)) {
                default: /*NOTREACHED*/ MR_assert(0);
                case (MR_Integer) 0:
                  switch (MR_unmkbody(OpModeAugment_16)) {
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 352, &IntermodOpt_11);
    ...
    else
    {
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 354, &UseOptFiles_13);
        ...
        case (MR_Integer) 1:
          {
            ...
            libs__globals__lookup_accumulating_option_3_p_0(Globals_8, (MR_Integer) 674, &IntermodDirs_16);
...
{
  {
    ...
    MR_Word IntermodArgs_48;
    MR_Word Termination_49;
    MR_Word Termination2_50;
    MR_Word SharingAnalysis_51;
    MR_Word ReuseAnalysis_52;
    MR_Word ExceptionAnalysis_53;
    MR_Word ClosureAnalysis_54;
    MR_Word TrailingAnalysis_55;
    MR_Word TablingAnalysis_56;
    MR_Word Var_57;
    MR_Word Var_58;
    MR_Word Var_59;
    MR_Word Var_60;
    ...
    transform_hlds__intermod__write_initial_opt_file_4_p_0(STATE_VARIABLE_HLDS_0_21, &STATE_VARIABLE_HLDS_29_29);
    succeeded = (IntermodAnalysis_11 == (MR_Integer) 0);
    if (succeeded)
    {
      Var_57 = (MR_Integer) 379;
      libs__globals__lookup_bool_option_3_p_0(Globals_12, Var_57, &IntermodArgs_48);
      Var_58 = (MR_Integer) 443;
      libs__globals__lookup_bool_option_3_p_0(Globals_12, Var_58, &Termination_49);
      Var_59 = (MR_Integer) 450;
      libs__globals__lookup_bool_option_3_p_0(Globals_12, Var_59, &Termination2_50);
      Var_60 = (MR_Integer) 435;
      libs__globals__lookup_bool_option_3_p_0(Globals_12, Var_60, &SharingAnalysis_51);
      Var_61 = (MR_Integer) 437;
      libs__globals__lookup_bool_option_3_p_0(Globals_12, Var_61, &ReuseAnalysis_52);
      Var_62 = (MR_Integer) 458;
      libs__globals__lookup_bool_option_3_p_0(Globals_12, Var_62, &ExceptionAnalysis_53);
      Var_63 = (MR_Integer) 459;
      libs__globals__lookup_bool_option_3_p_0(Globals_12, Var_63, &ClosureAnalysis_54);
      Var_64 = (MR_Integer) 422;
      libs__globals__lookup_bool_option_3_p_0(Globals_12, Var_64, &TrailingAnalysis_55);
      Var_65 = (MR_Integer) 425;
      libs__globals__lookup_bool_option_3_p_0(Globals_12, Var_65, &TablingAnalysis_56);
      succeeded = (IntermodArgs_48 == (MR_Integer) 1);
      if (!(succeeded))
      {
        succeeded = (Termination_49 == (MR_Integer) 1);
        if (!(succeeded))
        {
          succeeded = (Termination2_50 == (MR_Integer) 1);
          if (!(succeeded))
          {
            succeeded = (ExceptionAnalysis_53 == (MR_Integer) 1);
            if (!(succeeded))
            {
              succeeded = (TrailingAnalysis_55 == (MR_Integer) 1);
              if (!(succeeded))
              {
                succeeded = (TablingAnalysis_56 == (MR_Integer) 1);
                if (!(succeeded))
                {
                  succeeded = (ClosureAnalysis_54 == (MR_Integer) 1);
                  if (!(succeeded))
                  {
                    succeeded = (SharingAnalysis_51 == (MR_Integer) 1);
                    if (!(succeeded))
                      succeeded = (ReuseAnalysis_52 == (MR_Integer) 1);
                  }
                }
              }
            }
    ...
    if (succeeded)
    {
      MR_Word FoundError_18;
      MR_Word STATE_VARIABLE_HLDS_31_31;
      MR_Word STATE_VARIABLE_Specs_33_33;

      top_level__mercury_compile_front_end__frontend_pass_by_phases_9_p_0(STATE_VARIABLE_HLDS_29_29, &STATE_VARIABLE_HLDS_31_31, &FoundError_18, STATE_VARIABLE_DumpInfo_0_23, STATE_VARIABLE_DumpInfo_24, STATE_VARIABLE_Specs_0_25, &STATE_VARIABLE_Specs_33_33);
      switch (FoundError_18) {
        default: /*NOTREACHED*/ MR_assert(0);
        case (MR_Integer) 0:
          top_level__mercury_compile_middle_passes__middle_pass_for_opt_file_6_p_0(STATE_VARIABLE_HLDS_31_31, STATE_VARIABLE_HLDS_22, STATE_VARIABLE_Specs_33_33, STATE_VARIABLE_Specs_26);
          break;
        case (MR_Integer) 1:
          {
            mercury__io__set_exit_status_3_p_0((MR_Integer) 1);
            *STATE_VARIABLE_HLDS_22 = STATE_VARIABLE_HLDS_31_31;
            *STATE_VARIABLE_Specs_26 = STATE_VARIABLE_Specs_33_33;
          }
          break;
      }
    }
    else
    {
      ...
      *STATE_VARIABLE_DumpInfo_24 = STATE_VARIABLE_DumpInfo_0_23;
      *STATE_VARIABLE_HLDS_22 = STATE_VARIABLE_HLDS_29_29;
    }
    hlds__hlds_module__module_info_get_name_2_p_0(*STATE_VARIABLE_HLDS_22, &ModuleName_19);
    parse_tree__file_names__module_name_to_file_name_7_p_0(Globals_12, (MR_Integer) 0, (MR_String) ".opt", ModuleName_19, &OptName_20);
    parse_tree__module_cmds__update_interface_4_p_0(Globals_12, OptName_20);
    parse_tree__module_cmds__touch_interface_datestamp_5_p_0(Globals_12, ModuleName_19, (MR_String) ".optdate");
  }
}
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_15, (MR_Integer) 63, &Verbose_16);
    libs__globals__lookup_bool_option_3_p_0(Globals_15, (MR_Integer) 73, &Stats_17);
...
{
  {
    ...
    libs__globals__lookup_string_option_3_p_0(Globals_16, (MR_Integer) 75, &StatsFileName_17);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_14, (MR_Integer) 186, &ComputeGoalModes_15);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_18, (MR_Integer) 187, &BenchmarkModes_19);
      ...
      case (MR_Integer) 1:
        {
          ...
          libs__globals__lookup_int_option_3_p_0(Globals_18, (MR_Integer) 188, &Repeats_20);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 183, &ModeConstraints_12);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 187, &BenchmarkModes_12);
      ...
      case (MR_Integer) 1:
        {
          ...
          libs__globals__lookup_int_option_3_p_0(Globals_11, (MR_Integer) 188, &Repeats_13);
      ...
      case (MR_Integer) 5:
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_18, (MR_Integer) 394, &ConstProp_23);
          libs__globals__lookup_bool_option_3_p_0(Globals_18, (MR_Integer) 219, &DeepProf_24);
          libs__globals__lookup_bool_option_3_p_0(Globals_18, (MR_Integer) 236, &TSWProf_25);
          libs__globals__lookup_bool_option_3_p_0(Globals_18, (MR_Integer) 237, &TSCProf_26);
      ...
      case (MR_Integer) 3:
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_18, (MR_Integer) 222, &PreParSimplify_22);
      ...
      case (MR_Integer) 2:
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_18, (MR_Integer) 221, &PreProfSimplify_21);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_17, (MR_Integer) 323, &TypeCheckConstraints_25);
      ...
      case (MR_Integer) 1:
        {
          ...
          libs__globals__lookup_string_option_3_p_0(Globals_17, (MR_Integer) 695, &Experiment_26);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_16, (MR_Integer) 352, &IntermodOpt_21);
    libs__globals__lookup_bool_option_3_p_0(Globals_16, (MR_Integer) 357, &IntermodAnalysis_22);
    libs__globals__lookup_bool_option_3_p_0(Globals_16, (MR_Integer) 354, &UseOptFiles_23);
