...
MR_decl_label10(top_level__mercury_compile_front_end__maybe_simplify_10_0, 21,8,23,25,27,29,30,5,33,34)
MR_decl_label9(top_level__mercury_compile_front_end__maybe_simplify_10_0, 35,36,39,42,43,41,47,48,31)
...
MR_BEGIN_MODULE(top_level__mercury_compile_front_end_module0)
	...
	MR_init_label10(top_level__mercury_compile_front_end__maybe_simplify_10_0,21,8,23,25,27,29,30,5,33,34)
	MR_init_label9(top_level__mercury_compile_front_end__maybe_simplify_10_0,35,36,39,42,43,41,47,48,31)
MR_BEGIN_CODE
...
MR_def_label(top_level__mercury_compile_front_end__maybe_simplify_10_0,4)
	...
	MR_np_call_localret_ent(list__cons_3_0,
		top_level__mercury_compile_front_end__maybe_simplify_10_0_i30);
...
MR_def_label(top_level__mercury_compile_front_end__maybe_simplify_10_0,25)
	...
	MR_np_call_localret_ent(libs__globals__lookup_bool_option_3_0,
		top_level__mercury_compile_front_end__maybe_simplify_10_0_i27);
MR_def_label(top_level__mercury_compile_front_end__maybe_simplify_10_0,27)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(top_level__mercury_compile_front_end__maybe_simplify_10_0_i29);
	}
	MR_sv(5) = (MR_Word) MR_tbmkword(0, 0);
	MR_r1 = MR_sv(8);
	MR_r2 = MR_sv(9);
	MR_GOTO_LAB(top_level__mercury_compile_front_end__maybe_simplify_10_0_i5);
MR_def_label(top_level__mercury_compile_front_end__maybe_simplify_10_0,29)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(check_hlds__simplify, simplification);
	MR_r2 = (MR_Integer) 4;
	MR_r3 = MR_sv(10);
...
MR_def_label(top_level__mercury_compile_front_end__maybe_simplify_10_0,5)
	...
	if (MR_LTAGS_TEST(MR_sv(5),0,0)) {
		MR_GOTO_LAB(top_level__mercury_compile_front_end__maybe_simplify_10_0_i31);
	}
	{
	...
	MR_np_call_localret_ent(hlds__hlds_error_util__maybe_write_out_errors_8_0,
		top_level__mercury_compile_front_end__maybe_simplify_10_0_i33);
MR_def_label(top_level__mercury_compile_front_end__maybe_simplify_10_0,33)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(6) = MR_r1;
	MR_sv(7) = MR_r2;
	MR_r1 = MR_sv(3);
...
MR_def_label(top_level__mercury_compile_front_end__maybe_simplify_10_0,39)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_sv(2),0)) {
		MR_GOTO_LAB(top_level__mercury_compile_front_end__maybe_simplify_10_0_i41);
	}
	MR_sv(2) = MR_r1;
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(parse_tree__error_util, error_spec);
	MR_r3 = MR_sv(7);
	MR_np_call_localret_ent(fn__f_108_105_115_116_95_95_43_43_2_0,
		top_level__mercury_compile_front_end__maybe_simplify_10_0_i42);
MR_def_label(top_level__mercury_compile_front_end__maybe_simplify_10_0,42)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
...
MR_def_label(top_level__mercury_compile_front_end__maybe_simplify_10_0,47)
	...
	MR_np_call_localret_ent(libs__file_util__maybe_report_stats_3_0,
		top_level__mercury_compile_front_end__maybe_simplify_10_0_i48);
