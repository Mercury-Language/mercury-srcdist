          ...
          case (MR_Integer) 5:
            {
              ...
              libs__globals__lookup_bool_option_3_p_0(Globals_19, (MR_Integer) 360, &IntermodAnalysis_30);
              switch (MR_tag((MR_Word) OpModeAugment_16)) {
                default: /*NOTREACHED*/ MR_assert(0);
                case (MR_Integer) 0:
                  switch (MR_unmkbody(OpModeAugment_16)) {
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 355, &IntermodOpt_11);
    ...
    else
    {
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 357, &UseOptFiles_13);
...
{
  {
    ...
    else
    {
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals_12, (MR_Integer) 705, &Experiment5_31);
...
{
  {
      ...
      case (MR_Integer) 5:
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_18, (MR_Integer) 397, &ConstProp_23);
          ...
          if (succeeded)
            ...
            mercury__list__delete_all_3_p_1((MR_Word) (&check_hlds__simplify__simplify_tasks__check_hlds__simplify__simplify_tasks__type_ctor_info_simplify_task_0), STATE_VARIABLE_SimpList_37_37, ((MR_Box) ((MR_Integer) 11)), &STATE_VARIABLE_SimpList_43_43);
    ...
    else
    {
      ...
      hlds__passes_aux__process_valid_nonimported_preds_errors_7_p_0(Var_70, STATE_VARIABLE_HLDS_64_64, &STATE_VARIABLE_HLDS_71_71, (MR_Word) ((MR_Unsigned) 0U), &SimplifySpecs_30);
      switch (SimplifyPass_12) {
        default: /*NOTREACHED*/ MR_assert(0);
        case (MR_Integer) 0:
          {
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 382, &IntermodArgs_5);
    libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 446, &Termination_6);
    libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 453, &Termination2_7);
    libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 438, &SharingAnalysis_8);
    libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 440, &ReuseAnalysis_9);
    libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 461, &ExceptionAnalysis_10);
    libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 462, &ClosureAnalysis_11);
    libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 425, &TrailingAnalysis_12);
    libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 428, &TablingAnalysis_13);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_17, (MR_Integer) 326, &TypeCheckConstraints_25);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_16, (MR_Integer) 355, &IntermodOpt_21);
    libs__globals__lookup_bool_option_3_p_0(Globals_16, (MR_Integer) 360, &IntermodAnalysis_22);
    libs__globals__lookup_bool_option_3_p_0(Globals_16, (MR_Integer) 357, &UseOptFiles_23);
