  ...
  MR_Word * STATE_VARIABLE_Specs_29)
{
  ...
  *STATE_VARIABLE_Specs_29 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_diag_spec_0), PredSpecs_21, STATE_VARIABLE_Specs_0_28);
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_22, (MR_Integer) 687, &Statistics_23);
  ...
  MR_Word * STATE_VARIABLE_MaybeWrittenSpecs_39)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_26, (MR_Integer) 133, &Stats_28);
        ...
        case (MR_Integer) 0:
          {
            ...
            libs__globals__lookup_bool_option_3_p_0(Globals_21, (MR_Integer) 435, &IntermodAnalysis_82);
            switch ((MR_Integer) 1) {
              default: /*NOTREACHED*/ MR_assert(0);
              case (MR_Integer) 0:
                {
        ...
        case (MR_Integer) 3:
          {
            ...
            libs__globals__lookup_bool_option_3_p_0(Globals_21, (MR_Integer) 435, &IntermodAnalysis_34);
            switch ((MR_Integer) 0) {
              default: /*NOTREACHED*/ MR_assert(0);
              case (MR_Integer) 0:
                {
