...
static void MR_CALL 
top_level__mercury_compile_front_end__IntroducedFrom__pred__modecheck__955__1_3_p_0(
  MR_Word ProgressStream_13,
  MR_Word LambdaHeadVar__1_43,
  MR_Tuple * LambdaHeadVar__2_44);

static MR_bool MR_CALL 
top_level__mercury_compile_front_end__IntroducedFrom__pred__maybe_simplify__1424__1_2_p_0(
...
static /* final */ const MR_Box top_level__mercury_compile_front_end_scalar_common_2[4][5];

static /* final */ const MR_Box top_level__mercury_compile_front_end_scalar_common_3[2][3];
  ...
  MR_Word * STATE_VARIABLE_MaybeWrittenSpecs_43)
{
  ...
  MR_Word STATE_VARIABLE_MaybeWrittenSpecs_1_100;
  MR_Word PromiseSpecs_105;
  MR_Word Globals_106;
  MR_Word PromiseErrors_107;
  MR_Word STATE_VARIABLE_MaybeWrittenSpecs_1_111;

  libs__file_util__maybe_write_string_5_p_0(ProgressStream_18, Verbose_22, (MR_String) "% Purity-checking clauses...\n");
  ...
  parse_tree__error_util__add_to_be_written_specs_3_p_0(PuritySpecs_94, STATE_VARIABLE_MaybeWrittenSpecs_0_42, &STATE_VARIABLE_MaybeWrittenSpecs_1_100);
  ...
  parse_tree__write_error_spec__maybe_write_not_yet_written_specs_7_p_0(ErrorStream_19, Globals_95, Verbose_22, STATE_VARIABLE_MaybeWrittenSpecs_1_100, &STATE_VARIABLE_MaybeWrittenSpecs_1_47);
  switch (PurityErrors_96) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 0:
      libs__file_util__maybe_write_string_5_p_0(ProgressStream_18, Verbose_22, (MR_String) "% Program is purity-correct.\n");
      break;
    case (MR_Integer) 1:
      libs__file_util__maybe_write_string_5_p_0(ProgressStream_18, Verbose_22, (MR_String) "% Program contains purity error(s).\n");
      break;
  }
  ...
  libs__file_util__maybe_write_string_5_p_0(ProgressStream_18, Verbose_22, (MR_String) "% Checking any promises...\n");
  check_hlds__check_promise__check_promises_in_module_5_p_0(ProgressStream_18, STATE_VARIABLE_HLDS_1_46, &STATE_VARIABLE_HLDS_2_53, (MR_Word) ((MR_Unsigned) 0U), &PromiseSpecs_105);
  parse_tree__error_util__add_to_be_written_specs_3_p_0(PromiseSpecs_105, STATE_VARIABLE_MaybeWrittenSpecs_1_47, &STATE_VARIABLE_MaybeWrittenSpecs_1_111);
  hlds__hlds_module__module_info_get_globals_2_p_0(STATE_VARIABLE_HLDS_2_53, &Globals_106);
  PromiseErrors_107 = parse_tree__error_util__contains_errors_2_f_0(Globals_106, PromiseSpecs_105);
  parse_tree__write_error_spec__maybe_write_not_yet_written_specs_7_p_0(ErrorStream_19, Globals_106, Verbose_22, STATE_VARIABLE_MaybeWrittenSpecs_1_111, &STATE_VARIABLE_MaybeWrittenSpecs_2_54);
  switch (PromiseErrors_107) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 0:
      libs__file_util__maybe_write_string_5_p_0(ProgressStream_18, Verbose_22, (MR_String) "% All promises are correct.\n");
      break;
    case (MR_Integer) 1:
      libs__file_util__maybe_write_string_5_p_0(ProgressStream_18, Verbose_22, (MR_String) "% Program contains error(s) in promises.\n");
      break;
  }
  libs__file_util__maybe_report_stats_4_p_0(ProgressStream_18, Stats_23);
        ...
        case (MR_Integer) 0:
          {
            ...
            MR_Word STATE_VARIABLE_MaybeWrittenSpecs_3_85;
            MR_Word STATE_VARIABLE_DumpInfo_3_89;

            top_level__mercury_compile_front_end__subst_implementation_defined_literals_10_p_0(ProgressStream_18, ErrorStream_19, Verbose_22, Stats_23, STATE_VARIABLE_HLDS_2_53, &STATE_VARIABLE_HLDS_3_84, STATE_VARIABLE_MaybeWrittenSpecs_2_54, &STATE_VARIABLE_MaybeWrittenSpecs_3_85);
            ...
            libs__globals__lookup_bool_option_3_p_0(Globals_21, (MR_Integer) 436, &IntermodAnalysis_82);
            switch ((MR_Integer) 1) {
              default: /*NOTREACHED*/ MR_assert(0);
              case (MR_Integer) 0:
                {
                  ...
                  switch (MakeOptIntEnabled_81) {
                    ...
                    case (MR_Integer) 0:
                      ...
                      break;
                    case (MR_Integer) 1:
                      top_level__mercury_compile_front_end__mark_entities_in_opt_file_as_opt_exported_7_p_0(ProgressStream_18, IntermodAnalysis_82, Globals_21, STATE_VARIABLE_HLDS_3_84, &STATE_VARIABLE_HLDS_5_75);
                      break;
                  }
                  top_level__mercury_compile_front_end__frontend_pass_by_phases_11_p_0(ProgressStream_18, ErrorStream_19, STATE_VARIABLE_HLDS_5_75, STATE_VARIABLE_HLDS_39, &FoundModeOrDetError_74, STATE_VARIABLE_DumpInfo_3_89, STATE_VARIABLE_DumpInfo_41, STATE_VARIABLE_MaybeWrittenSpecs_3_85, STATE_VARIABLE_MaybeWrittenSpecs_43);
                    ...
                    case (MR_Integer) 0:
                      {
                        ...
                        *STATE_VARIABLE_MaybeWrittenSpecs_43 = STATE_VARIABLE_MaybeWrittenSpecs_3_85;
                      }
                      break;
                    case (MR_Integer) 1:
                      top_level__mercury_compile_front_end__create_and_write_opt_file_12_p_0(ProgressStream_18, ErrorStream_19, IntermodAnalysis_82, Globals_21, STATE_VARIABLE_HLDS_3_84, STATE_VARIABLE_HLDS_39, STATE_VARIABLE_DumpInfo_3_89, STATE_VARIABLE_DumpInfo_41, STATE_VARIABLE_MaybeWrittenSpecs_3_85, STATE_VARIABLE_MaybeWrittenSpecs_43);
                      break;
                  }
        ...
        case (MR_Integer) 3:
          {
            ...
            top_level__mercury_compile_front_end__subst_implementation_defined_literals_10_p_0(ProgressStream_18, ErrorStream_19, Verbose_22, Stats_23, STATE_VARIABLE_HLDS_2_53, &STATE_VARIABLE_HLDS_3_60, STATE_VARIABLE_MaybeWrittenSpecs_2_54, &STATE_VARIABLE_MaybeWrittenSpecs_3_61);
              ...
              case (MR_Integer) 0:
                {
                  ...
                  switch (MakeOptIntEnabled_33) {
                    ...
                    case (MR_Integer) 0:
                      ...
                      break;
                    case (MR_Integer) 1:
                      top_level__mercury_compile_front_end__mark_entities_in_opt_file_as_opt_exported_7_p_0(ProgressStream_18, IntermodAnalysis_34, Globals_21, STATE_VARIABLE_HLDS_3_60, &STATE_VARIABLE_HLDS_5_72);
                      break;
                  }
                  top_level__mercury_compile_front_end__frontend_pass_by_phases_11_p_0(ProgressStream_18, ErrorStream_19, STATE_VARIABLE_HLDS_5_72, STATE_VARIABLE_HLDS_39, &FoundModeOrDetError_35, STATE_VARIABLE_DumpInfo_3_65, STATE_VARIABLE_DumpInfo_41, STATE_VARIABLE_MaybeWrittenSpecs_3_61, STATE_VARIABLE_MaybeWrittenSpecs_43);
                    ...
                    case (MR_Integer) 0:
                      {
                        ...
                        *STATE_VARIABLE_MaybeWrittenSpecs_43 = STATE_VARIABLE_MaybeWrittenSpecs_3_61;
                      }
                      break;
                    case (MR_Integer) 1:
                      top_level__mercury_compile_front_end__create_and_write_opt_file_12_p_0(ProgressStream_18, ErrorStream_19, IntermodAnalysis_34, Globals_21, STATE_VARIABLE_HLDS_3_60, STATE_VARIABLE_HLDS_39, STATE_VARIABLE_DumpInfo_3_65, STATE_VARIABLE_DumpInfo_41, STATE_VARIABLE_MaybeWrittenSpecs_3_61, STATE_VARIABLE_MaybeWrittenSpecs_43);
                      break;
                  }
                  *STATE_VARIABLE_FoundError_37 = STATE_VARIABLE_FoundError_0_36;
                }
  ...
  MR_Word * STATE_VARIABLE_MaybeWrittenSpecs_31)
{
  ...
  hlds__hlds_module__module_info_get_name_2_p_0(STATE_VARIABLE_HLDS_0_28, &ModuleName_22);
  {
    ...
    MR_hl_field(0, Var_34, 0) = ((MR_Box) (&top_level__mercury_compile_front_end_scalar_common_2[3]));
  ...
  mercury__list__filter_3_p_0((MR_Word) (&top_level__mercury_compile_front_end_scalar_common_3[0]), Var_34, OISUPairs_21, &ModuleOISUPairs_23);
  ...
  MR_Box * wrapper_arg_2)
{
  ...
  top_level__mercury_compile_front_end__IntroducedFrom__pred__modecheck__955__1_3_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) (wrapper_arg_1)), &conv0_LambdaHeadVar__2_44);
    ...
    case (MR_Integer) 1:
      {
        ...
        mercury__benchmarking__benchmark_det_5_p_0((MR_Word) (&hlds__hlds_module__hlds__hlds_module__type_ctor_info_module_info_0), (MR_Word) (&top_level__mercury_compile_front_end_scalar_common_2[0]), ModecheckModuleBench_27, ((MR_Box) (STATE_VARIABLE_HLDS_0_31)), &conv1_Var_45, Repeats_24, &Time_26);
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = top_level__mercury_compile_front_end__IntroducedFrom__pred__maybe_simplify__1424__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) ((MR_hl_field(0, closure, 4)))));
  return succeeded;
}
      ...
      case (MR_Integer) 0:
        if ((MaybeErrorStream_14 == (MR_Word) ((MR_Unsigned) 0U)))
        {
...

          {
            ...
            MR_hl_field(0, Var_85, 0) = ((MR_Box) (&top_level__mercury_compile_front_end_scalar_common_2[2]));
