  ...
  MR_Word * STATE_VARIABLE_Specs_29)
{
  ...
  *STATE_VARIABLE_Specs_29 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_error_spec_0), SpecsList_22, STATE_VARIABLE_Specs_0_28);
  libs__globals__lookup_bool_option_3_p_0(Globals_21, (MR_Integer) 661, &Statistics_23);
    ...
    case (MR_Integer) 1:
      {
        ...
        else
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_16, (MR_Integer) 651, &Experiment5_42);
  ...
  MR_Word * STATE_VARIABLE_Specs_25)
{
  ...
  libs__globals__lookup_string_option_3_p_0(Globals_17, (MR_Integer) 669, &StatsFileName_18);
  ...
  MR_Word * STATE_VARIABLE_Specs_27)
{
  ...
  libs__globals__lookup_string_option_3_p_0(Globals_19, (MR_Integer) 668, &StatsFileName_20);
  ...
  MR_Word * STATE_VARIABLE_Specs_23)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_18, (MR_Integer) 628, &ComputeGoalModes_19);
  ...
  MR_Word * STATE_VARIABLE_Specs_34)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_22, (MR_Integer) 662, &BenchmarkModes_23);
    ...
    case (MR_Integer) 1:
      {
        ...
        libs__globals__lookup_int_option_3_p_0(Globals_22, (MR_Integer) 663, &Repeats_24);
        {
  ...
  MR_Word * STATE_VARIABLE_HLDS_16)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_13, (MR_Integer) 625, &ModeConstraints_14);
    ...
    case (MR_Integer) 1:
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_29, (MR_Integer) 662, &BenchmarkModes_30);
          ...
          case (MR_Integer) 1:
            {
              ...
              libs__globals__lookup_int_option_3_p_0(Globals_29, (MR_Integer) 663, &Repeats_31);
    ...
    case (MR_Integer) 2:
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_22, (MR_Integer) 630, &PreProfSimplify_26);
  ...
  MR_Word * STATE_VARIABLE_Specs_37)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_21, (MR_Integer) 634, &TypeCheckUsingConstraints_29);
    ...
    case (MR_Integer) 1:
      {
        ...
        libs__globals__lookup_string_option_3_p_0(Globals_21, (MR_Integer) 646, &Experiment_30);
