  ...
  MR_Word * STATE_VARIABLE_Specs_29)
{
  ...
  PredSpecsAcc0_19 = parse_tree__error_util__init_error_spec_accumulator_0_f_0();
  ...
  PredSpecs_21 = parse_tree__error_util__error_spec_accumulator_to_list_1_f_0(PredSpecsAcc_20);
  *STATE_VARIABLE_Specs_29 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_error_spec_0), PredSpecs_21, STATE_VARIABLE_Specs_0_28);
    ...
    case (MR_Integer) 0:
      {
        ...
        parse_tree__module_cmds__touch_module_ext_datestamp_7_p_0(Globals_16, ProgressStream_13, ModuleName_21, (MR_Word) (MR_mkword(3, &top_level__mercury_compile_front_end_scalar_common_1[2])), &_TouchSucceeded_52);
      }
      break;
    case (MR_Integer) 1:
      {
          ...
          case (MR_Integer) 1:
            {
              ...
              parse_tree__module_cmds__touch_module_ext_datestamp_7_p_0(Globals_16, ProgressStream_13, ModuleName_21, (MR_Word) (MR_mkword(3, &top_level__mercury_compile_front_end_scalar_common_1[2])), &_TouchSucceeded_247);
            }
            break;
        }
      }
