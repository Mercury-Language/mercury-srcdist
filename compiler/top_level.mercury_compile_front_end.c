...
{
  {
    ...
    *STATE_VARIABLE_Specs_27 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_error_spec_0), SpecsList_20, STATE_VARIABLE_Specs_0_26);
    libs__globals__lookup_bool_option_3_p_0(Globals_19, (MR_Integer) 79, &Statistics_21);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_24, (MR_Integer) 68, &Verbose_25);
      ...
      case (MR_Integer) 0:
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_24, (MR_Integer) 78, &Stats_26);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_20, (MR_Integer) 78, &Stats_22);
...
{
  {
    ...
    else
    {
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals_12, (MR_Integer) 713, &Experiment5_35);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_15, (MR_Integer) 68, &Verbose_16);
    libs__globals__lookup_bool_option_3_p_0(Globals_15, (MR_Integer) 78, &Stats_17);
...
{
  {
    ...
    libs__globals__lookup_string_option_3_p_0(Globals_16, (MR_Integer) 80, &StatsFileName_17);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_14, (MR_Integer) 199, &ComputeGoalModes_15);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_18, (MR_Integer) 200, &BenchmarkModes_19);
      ...
      case (MR_Integer) 1:
        {
          ...
          libs__globals__lookup_int_option_3_p_0(Globals_18, (MR_Integer) 201, &Repeats_20);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 196, &ModeConstraints_12);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 200, &BenchmarkModes_12);
      ...
      case (MR_Integer) 1:
        {
          ...
          libs__globals__lookup_int_option_3_p_0(Globals_11, (MR_Integer) 201, &Repeats_13);
      ...
      case (MR_Integer) 5:
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_18, (MR_Integer) 235, &DeepProf_26);
          libs__globals__lookup_bool_option_3_p_0(Globals_18, (MR_Integer) 252, &TSWProf_27);
          libs__globals__lookup_bool_option_3_p_0(Globals_18, (MR_Integer) 253, &TSCProf_28);
      ...
      case (MR_Integer) 3:
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_18, (MR_Integer) 238, &PreParSimplify_23);
      ...
      case (MR_Integer) 2:
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_18, (MR_Integer) 237, &PreProfSimplify_22);
      ...
      case (MR_Integer) 1:
        {
          ...
          libs__globals__lookup_string_option_3_p_0(Globals_17, (MR_Integer) 708, &Experiment_26);
