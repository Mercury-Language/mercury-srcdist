  ...
  MR_Word * STATE_VARIABLE_Specs_47)
{
  ...
  else
  {
    ...
    parse_tree__module_cmds__touch_module_ext_datestamp_7_p_0(Globals_16, ProgressStream_13, ModuleName_21, (MR_Word) (MR_mkword(3, &top_level__mercury_compile_front_end_scalar_common_1[2])), &_TouchSucceeded_36);
