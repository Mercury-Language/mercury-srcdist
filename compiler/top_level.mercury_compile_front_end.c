...
static /* final */ const MR_Box top_level__mercury_compile_front_end_scalar_common_4[5][1];
      ...
      case (MR_Integer) 0:
        {
          ...
          hlds__make_hlds__set_module_recomp_info_3_p_0(QualInfo_27, STATE_VARIABLE_HLDS_53_53, &STATE_VARIABLE_HLDS_60_60);
...
{
  {
    ...
    hlds__hlds_error_util__maybe_write_out_errors_6_p_0(Verbose_9, Globals_14, STATE_VARIABLE_Specs_0_25, &STATE_VARIABLE_Specs_29_29);
      ...
      case (MR_Integer) 0:
        switch (InconsistentPredOrderClauses_16) {
          ...
          case (MR_Integer) 0:
            ...
            break;
          case (MR_Integer) 1:
            InconsistentPredOrder_18 = (MR_Word) (MR_mkword(MR_mktag(1), &top_level__mercury_compile_front_end_scalar_common_4[2]));
            break;
        }
        break;
      case (MR_Integer) 1:
        InconsistentPredOrder_18 = (MR_Word) (MR_mkword(MR_mktag(1), &top_level__mercury_compile_front_end_scalar_common_4[3]));
        break;
    }
      ...
      case (MR_Integer) 0:
        ...
        else
        {
...

          {
            ...
            MR_hl_field(MR_mktag(1), Var_38, 0) = (MR_Box) ((MR_Unsigned) (DefnKinds_20));
          }
          {
            MaybeTask_19 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), MaybeTask_19, 0) = ((MR_Box) (Var_38));
          }
        }
        break;
      case (MR_Integer) 1:
        if ((InconsistentPredOrder_18 == (MR_Word) ((MR_Unsigned) 0U)))
          MaybeTask_19 = (MR_Word) (MR_mkword(MR_mktag(1), &top_level__mercury_compile_front_end_scalar_common_4[4]));
        else
        {
          MR_Word Var_36;
          MR_Word DefnKinds_45 = ((MR_Word) ((MR_hl_field(MR_mktag(1), InconsistentPredOrder_18, (MR_Integer) 0))));

          {
            Var_36 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(2), Var_36, 0) = (MR_Box) ((MR_Unsigned) (DefnKinds_45));
          }
          {
            MaybeTask_19 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), MaybeTask_19, 0) = ((MR_Box) (Var_36));
          }
        }
        break;
    }
    if ((MaybeTask_19 == (MR_Word) ((MR_Unsigned) 0U)))
      *STATE_VARIABLE_Specs_26 = STATE_VARIABLE_Specs_29_29;
    else
    {
      ...
      check_hlds__style_checks__generate_style_warnings_3_p_0(STATE_VARIABLE_HLDS_0_23, Task_21, &StyleSpecs_22);
      *STATE_VARIABLE_Specs_26 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_error_spec_0), StyleSpecs_22, STATE_VARIABLE_Specs_29_29);
      libs__file_util__maybe_write_string_4_p_0(Verbose_9, (MR_String) "% done.\n");
      libs__file_util__maybe_report_stats_3_p_0(Stats_10);
    }
      ...
      case (MR_Integer) 1:
        {
          ...
          hlds__hlds_error_util__maybe_write_out_errors_6_p_0(Verbose_12, Globals_14, STATE_VARIABLE_Specs_0_24, &STATE_VARIABLE_Specs_29_29);
          libs__file_util__maybe_write_string_4_p_0(Verbose_12, (MR_String) "% Checking that insts have matching types... ");
          check_hlds__inst_check__check_insts_have_matching_types_4_p_0(STATE_VARIABLE_HLDS_0_20, STATE_VARIABLE_HLDS_21, STATE_VARIABLE_Specs_29_29, &STATE_VARIABLE_Specs_34_34);
