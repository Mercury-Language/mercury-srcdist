...
static /* final */ const MR_Box top_level__mercury_compile_front_end_scalar_common_1[5][2];
      ...
      case (MR_Integer) 1:
        {
          ...
          parse_tree__file_names__module_name_to_search_file_name_8_p_0(Globals_8, (MR_String) "predicate \140top_level.mercury_compile_front_end.mark_entities_in_opt_file_as_opt_exported\'/6", (MR_Word) (MR_mkword(1, &top_level__mercury_compile_front_end_scalar_common_4[0])), (MR_Word) (MR_mkword(3, &top_level__mercury_compile_front_end_scalar_common_1[1])), ModuleName_14, &OptFileName_15);
          libs__globals__lookup_accumulating_option_3_p_0(Globals_8, (MR_Integer) 688, &IntermodDirs_16);
  ...
  MR_Word * STATE_VARIABLE_Specs_47)
{
  ...
  else
  {
    ...
    parse_tree__module_cmds__touch_interface_datestamp_9_p_0(Globals_16, ProgressStream_13, ErrorStream_14, ModuleName_21, (MR_Word) (((MR_Box) ((MR_String) ".optdate"))), (MR_Word) (MR_mkword(3, &top_level__mercury_compile_front_end_scalar_common_1[2])), &_TouchSucceeded_36);
    libs__globals__lookup_bool_option_3_p_0(Globals_16, (MR_Integer) 714, &Experiment5_37);
    ...
    case (MR_Integer) 1:
      {
        ...
        parse_tree__file_names__module_name_to_file_name_9_p_0(Globals_14, (MR_String) "predicate \140top_level.mercury_compile_front_end.maybe_write_call_tree\'/7", (MR_Integer) 0, (MR_Word) (MR_mkword(1, &top_level__mercury_compile_front_end_scalar_common_4[2])), (MR_Word) (MR_mkword(3, &top_level__mercury_compile_front_end_scalar_common_1[3])), ModuleName_16, &TreeFileName_17);
        parse_tree__file_names__module_name_to_file_name_9_p_0(Globals_14, (MR_String) "predicate \140top_level.mercury_compile_front_end.maybe_write_call_tree\'/7", (MR_Integer) 0, (MR_Word) (MR_mkword(1, &top_level__mercury_compile_front_end_scalar_common_4[3])), (MR_Word) (MR_mkword(3, &top_level__mercury_compile_front_end_scalar_common_1[4])), ModuleName_16, &OrderFileName_18);
    ...
    case (MR_Integer) 1:
      {
        ...
        libs__globals__lookup_string_option_3_p_0(Globals_21, (MR_Integer) 709, &Experiment_30);
