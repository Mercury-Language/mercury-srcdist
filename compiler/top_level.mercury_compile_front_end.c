...
static void MR_CALL 
top_level__mercury_compile_front_end__IntroducedFrom__pred__modecheck__987__1_3_p_0(
  MR_Word ProgressStream_13,
  MR_Word LambdaHeadVar__1_43,
  MR_Tuple * LambdaHeadVar__2_44);

static MR_bool MR_CALL 
top_level__mercury_compile_front_end__IntroducedFrom__pred__maybe_simplify__1456__1_2_p_0(
  ...
  MR_Word * STATE_VARIABLE_MaybeWrittenSpecs_23)
{
  ...
  hlds__hlds_module__module_info_get_input_spec_table_2_p_0(STATE_VARIABLE_HLDS_0_20, &InputSpecTable_18);
  ...
  else
  {
    ...
    hlds__hlds_module__module_info_get_globals_2_p_0(STATE_VARIABLE_HLDS_0_20, &Globals_19);
    parse_tree__write_error_spec__maybe_write_not_yet_written_specs_7_p_0(ErrorStream_12, Globals_19, Verbose_13, STATE_VARIABLE_MaybeWrittenSpecs_0_22, STATE_VARIABLE_MaybeWrittenSpecs_23);
    ...
    hlds__input_specialization__input_specialize_in_module_2_p_0(STATE_VARIABLE_HLDS_0_20, STATE_VARIABLE_HLDS_21);
  ...
  MR_Box * wrapper_arg_2)
{
  ...
  top_level__mercury_compile_front_end__IntroducedFrom__pred__modecheck__987__1_3_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) (wrapper_arg_1)), &conv0_LambdaHeadVar__2_44);
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = top_level__mercury_compile_front_end__IntroducedFrom__pred__maybe_simplify__1456__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) ((MR_hl_field(0, closure, 4)))));
  return succeeded;
}
