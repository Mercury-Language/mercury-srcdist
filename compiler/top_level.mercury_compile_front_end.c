...
static /* final */ const MR_Box top_level__mercury_compile_front_end_scalar_common_2[3][3];
  ...
  MR_Word * STATE_VARIABLE_Specs_29)
{
  ...
  ProcIds_17 = hlds__hlds_pred__pred_info_will_codegen_proc_ids_1_f_0(STATE_VARIABLE_PredInfo_0_26);
  succeeded = hlds__hlds_pred_tests__is_unify_index_or_compare_pred_1_p_0(STATE_VARIABLE_PredInfo_0_26);
  if (succeeded)
  {
  ...
  check_hlds__simplify__simplify_proc__simplify_pred_procs_10_p_0(ProgressStream_10, SimplifyTasks_18, PredId_12, ProcIds_17, STATE_VARIABLE_PredInfo_0_26, STATE_VARIABLE_PredInfo_27, STATE_VARIABLE_ModuleInfo_0_24, STATE_VARIABLE_ModuleInfo_25, PredSpecsAcc0_19, &PredSpecsAcc_20);
  PredSpecs_21 = parse_tree__error_util__diag_spec_accumulator_to_list_1_f_0(PredSpecsAcc_20);
  *STATE_VARIABLE_Specs_29 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_diag_spec_0), PredSpecs_21, STATE_VARIABLE_Specs_0_28);
  hlds__hlds_module__module_info_get_globals_2_p_0(*STATE_VARIABLE_ModuleInfo_25, &Globals_22);
  libs__globals__lookup_bool_option_3_p_0(Globals_22, (MR_Integer) 689, &Statistics_23);
