...
{
  {
    ...
    libs__globals__lookup_accumulating_option_3_p_0(top_level__mercury_compile_front_end__Globals_15, (MR_Integer) 653, &top_level__mercury_compile_front_end__IntermodDirs_19);
