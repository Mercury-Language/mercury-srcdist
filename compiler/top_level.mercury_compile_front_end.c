...
{
  {
    ...
    else
    {
      ...
      transform_hlds__intermod__maybe_opt_export_listed_entities_3_p_0(IntermodInfo_25, STATE_VARIABLE_HLDS_0_38, &STATE_VARIABLE_HLDS_55_55);
      ...
      if (succeeded)
      {
        ...
        top_level__mercury_compile_front_end__frontend_pass_by_phases_9_p_0(STATE_VARIABLE_HLDS_55_55, &STATE_VARIABLE_HLDS_56_56, &FoundError_28, STATE_VARIABLE_DumpInfo_0_40, STATE_VARIABLE_DumpInfo_41, STATE_VARIABLE_Specs_0_42, &STATE_VARIABLE_Specs_58_58);
          ...
          case (MR_Integer) 0:
            {
              ...
              top_level__mercury_compile_middle_passes__middle_pass_for_opt_file_7_p_0(STATE_VARIABLE_HLDS_56_56, STATE_VARIABLE_HLDS_39, &UnusedArgsInfos_29, STATE_VARIABLE_Specs_58_58, STATE_VARIABLE_Specs_43);
          ...
          case (MR_Integer) 1:
            {
              ...
              *STATE_VARIABLE_HLDS_39 = STATE_VARIABLE_HLDS_56_56;
              *STATE_VARIABLE_Specs_43 = STATE_VARIABLE_Specs_58_58;
            }
            break;
        }
      }
      ...
      parse_tree__module_cmds__update_interface_5_p_0(Globals_12, ModuleName_17, OptFileName_18);
      hlds__passes_aux__get_progress_output_stream_4_p_0(*STATE_VARIABLE_HLDS_39, &ProgressStream_31);
      hlds__passes_aux__get_error_output_stream_4_p_0(*STATE_VARIABLE_HLDS_39, &ErrorStream_32);
      parse_tree__module_cmds__touch_interface_datestamp_7_p_0(Globals_12, ProgressStream_31, ErrorStream_32, ModuleName_17, (MR_Word) (((MR_Box) ((MR_String) ".optdate"))));
      libs__globals__lookup_bool_option_3_p_0(Globals_12, (MR_Integer) 710, &Experiment5_33);
      switch (Experiment5_33) {
        ...
        case (MR_Integer) 1:
          {
            MR_Word OptXResult_34;
            MR_String Var_74;

            Var_74 = mercury__string__f_43_43_2_f_0(OptFileName_18, (MR_String) "x");
            mercury__io__open_output_4_p_0(Var_74, &OptXResult_34);
            if (!(((MR_tag((MR_Word) OptXResult_34)) == (MR_Integer) 1)))
            {
              MR_Word OptXStream_36 = ((MR_Word) ((MR_hl_field(MR_mktag(0), OptXResult_34, (MR_Integer) 0))));
              MR_Word Info_37;

              Info_37 = parse_tree__parse_tree_out_info__init_merc_out_info_3_f_0(Globals_12, (MR_Integer) 0, (MR_Integer) 0);
              parse_tree__parse_tree_out__mercury_output_parse_tree_plain_opt_5_p_0(Info_37, OptXStream_36, ParseTreePlainOpt_30);
              mercury__io__close_output_3_p_0(OptXStream_36);
            }
          }
          break;
      }
