                                ...
                                case (MR_Integer) 1:
                                  {
                                    ...
                                    parse_tree__file_names__module_name_to_search_file_name_7_p_0(Globals_23, (MR_String) "predicate \140top_level.mercury_compile_front_end.mark_entities_in_opt_file_as_opt_exported\'/6", (MR_Word) (MR_mkword(2, &top_level__mercury_compile_front_end_scalar_common_4[0])), ModuleName_108, &OptFileName_109);
  ...
  MR_Word * STATE_VARIABLE_Specs_47)
{
  ...
  parse_tree__file_names__module_name_to_file_name_8_p_0(Globals_16, (MR_String) "predicate \140top_level.mercury_compile_front_end.create_and_write_opt_file\'/12", (MR_Integer) 0, (MR_Word) (MR_mkword(2, &top_level__mercury_compile_front_end_scalar_common_4[0])), ModuleName_21, &OptFileName_22);
  ...
  else
  {
    ...
    transform_hlds__intermod__maybe_opt_export_listed_entities_3_p_0(IntermodInfo_29, STATE_VARIABLE_HLDS_0_42, &STATE_VARIABLE_HLDS_71_71);
    ...
    if (succeeded)
    {
      ...
      top_level__mercury_compile_front_end__frontend_pass_by_phases_11_p_0(ProgressStream_13, ErrorStream_14, STATE_VARIABLE_HLDS_71_71, &STATE_VARIABLE_HLDS_72_72, &FoundError_32, STATE_VARIABLE_DumpInfo_0_44, STATE_VARIABLE_DumpInfo_45, STATE_VARIABLE_Specs_0_46, &STATE_VARIABLE_Specs_74_74);
        ...
        case (MR_Integer) 0:
          {
            ...
            top_level__mercury_compile_middle_passes__middle_pass_for_opt_file_8_p_0(ProgressStream_13, STATE_VARIABLE_HLDS_72_72, STATE_VARIABLE_HLDS_43, &UnusedArgsInfos_33, STATE_VARIABLE_Specs_74_74, STATE_VARIABLE_Specs_47);
        ...
        case (MR_Integer) 1:
          {
            ...
            *STATE_VARIABLE_Specs_47 = STATE_VARIABLE_Specs_74_74;
          }
          break;
      }
    }
    ...
    parse_tree__module_cmds__touch_interface_datestamp_8_p_0(Globals_16, ProgressStream_13, ErrorStream_14, ModuleName_21, (MR_Word) (MR_mkword(2, &top_level__mercury_compile_front_end_scalar_common_4[1])), &_TouchSucceeded_36);
      ...
      case (MR_Integer) 1:
        {
          ...
          Var_88 = mercury__string__f_43_43_2_f_0(OptFileName_22, (MR_String) "x");
          mercury__io__open_output_4_p_0(Var_88, &OptXResult_38);
    ...
    case (MR_Integer) 1:
      {
        ...
        parse_tree__file_names__module_name_to_file_name_8_p_0(Globals_14, (MR_String) "predicate \140top_level.mercury_compile_front_end.maybe_write_call_tree\'/7", (MR_Integer) 0, (MR_Word) (MR_mkword(3, &top_level__mercury_compile_front_end_scalar_common_1[1])), ModuleName_16, &TreeFileName_17);
        parse_tree__file_names__module_name_to_file_name_8_p_0(Globals_14, (MR_String) "predicate \140top_level.mercury_compile_front_end.maybe_write_call_tree\'/7", (MR_Integer) 0, (MR_Word) (MR_mkword(3, &top_level__mercury_compile_front_end_scalar_common_1[2])), ModuleName_16, &OrderFileName_18);
        mercury__io__open_output_4_p_0(TreeFileName_17, &TreeResult_19);
        if (((MR_tag((MR_Word) TreeResult_19)) == (MR_Integer) 1))
        {
          MR_String Var_52;
          MR_Word IOError_55 = ((MR_Word) ((MR_hl_field(1, TreeResult_19, (MR_Integer) 0))));
          MR_String ErrorMsg_56;

          Var_52 = mercury__io__error_message_1_f_0(IOError_55);
          ErrorMsg_56 = mercury__string__f_43_43_2_f_0((MR_String) "unable to write local call tree: ", Var_52);
          libs__file_util__report_error_4_p_0(ErrorStream_9, ErrorMsg_56);
        }
        else
        {
          ...
          if (((MR_tag((MR_Word) OrderResult_21)) == (MR_Integer) 1))
          {
            ...
            Var_49 = mercury__io__error_message_1_f_0(IOError_23);
            ErrorMsg_24 = mercury__string__f_43_43_2_f_0((MR_String) "unable to write local call tree order: ", Var_49);
  ...
  MR_Word * STATE_VARIABLE_Specs_23)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_18, (MR_Integer) 211, &ComputeGoalModes_19);
  ...
  MR_Word * STATE_VARIABLE_Specs_34)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_22, (MR_Integer) 212, &BenchmarkModes_23);
    ...
    case (MR_Integer) 1:
      {
        ...
        libs__globals__lookup_int_option_3_p_0(Globals_22, (MR_Integer) 213, &Repeats_24);
        {
  ...
  MR_Word * STATE_VARIABLE_HLDS_16)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_13, (MR_Integer) 208, &ModeConstraints_14);
    ...
    case (MR_Integer) 1:
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_29, (MR_Integer) 212, &BenchmarkModes_30);
          ...
          case (MR_Integer) 1:
            {
              ...
              libs__globals__lookup_int_option_3_p_0(Globals_29, (MR_Integer) 213, &Repeats_31);
    ...
    case (MR_Integer) 5:
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_22, (MR_Integer) 245, &DeepProf_30);
        libs__globals__lookup_bool_option_3_p_0(Globals_22, (MR_Integer) 262, &TSWProf_31);
        libs__globals__lookup_bool_option_3_p_0(Globals_22, (MR_Integer) 263, &TSCProf_32);
    ...
    case (MR_Integer) 3:
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_22, (MR_Integer) 248, &PreParSimplify_27);
    ...
    case (MR_Integer) 2:
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_22, (MR_Integer) 247, &PreProfSimplify_26);
