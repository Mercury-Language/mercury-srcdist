...
static void MR_CALL 
top_level__mercury_compile_front_end__IntroducedFrom__pred__modecheck__1084__1_3_p_0(
  ...
  MR_Word * STATE_VARIABLE_HLDS_24)
{
  ...
  if (succeeded)
    transform_hlds__intermod_mark_exported__maybe_opt_export_entities_3_p_0(ProgressStream_8, STATE_VARIABLE_HLDS_0_23, STATE_VARIABLE_HLDS_24);
  else
  {
      ...
      case (MR_Integer) 1:
        {
          ...
          MR_Word MaybeDir_20;
          MR_String _OptFileNameProposed_18;

          hlds__hlds_module__module_info_get_name_2_p_0(STATE_VARIABLE_HLDS_0_23, &ModuleName_16);
          parse_tree__file_names__module_name_to_search_file_name_6_p_0(Globals_10, (MR_String) "predicate \140top_level.mercury_compile_front_end.mark_entities_in_opt_file_as_opt_exported\'/7", (MR_Word) (MR_mkword(3, &top_level__mercury_compile_front_end_scalar_common_1[1])), ModuleName_16, &OptFileName_17, &_OptFileNameProposed_18);
          libs__globals__lookup_accumulating_option_3_p_0(Globals_10, (MR_Integer) 711, &IntermodDirs_19);
          parse_tree__find_module__search_for_file_returning_dir_5_p_0(IntermodDirs_19, OptFileName_17, &MaybeDir_20);
          if (((MR_tag((MR_Word) MaybeDir_20)) == (MR_Integer) 1))
            *STATE_VARIABLE_HLDS_24 = STATE_VARIABLE_HLDS_0_23;
          else
            transform_hlds__intermod_mark_exported__maybe_opt_export_entities_3_p_0(ProgressStream_8, STATE_VARIABLE_HLDS_0_23, STATE_VARIABLE_HLDS_24);
        }
  ...
  MR_Box * wrapper_arg_2)
{
  ...
  top_level__mercury_compile_front_end__IntroducedFrom__pred__modecheck__1084__1_3_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) (wrapper_arg_1)), &conv0_LambdaHeadVar__2_44);
