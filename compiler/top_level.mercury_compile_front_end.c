  ...
  MR_Word * STATE_VARIABLE_Specs_42)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_24, (MR_Integer) 518, &IntermodOpt_78);
  libs__globals__lookup_bool_option_3_p_0(Globals_24, (MR_Integer) 523, &IntermodAnalysis_79);
  libs__globals__lookup_bool_option_3_p_0(Globals_24, (MR_Integer) 520, &UseOptFiles_80);
        ...
        case (MR_Integer) 0:
          {
            ...
            libs__globals__lookup_bool_option_3_p_0(Globals_23, (MR_Integer) 523, &IntermodAnalysis_82);
            switch ((MR_Integer) 1) {
              default: /*NOTREACHED*/ MR_assert(0);
              case (MR_Integer) 0:
                {
        ...
        case (MR_Integer) 5:
          {
            ...
            libs__globals__lookup_bool_option_3_p_0(Globals_23, (MR_Integer) 523, &IntermodAnalysis_34);
            switch ((MR_Integer) 0) {
              default: /*NOTREACHED*/ MR_assert(0);
              case (MR_Integer) 0:
                {
  ...
  MR_Word * STATE_VARIABLE_HLDS_23)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_10, (MR_Integer) 518, &IntermodOpt_13);
  ...
  else
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_10, (MR_Integer) 520, &UseOptFiles_15);
      ...
      case (MR_Integer) 1:
        {
          ...
          libs__globals__lookup_accumulating_option_3_p_0(Globals_10, (MR_Integer) 708, &IntermodDirs_18);
    ...
    case (MR_Integer) 1:
      {
        ...
        else
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_16, (MR_Integer) 735, &Experiment5_41);
  ...
  MR_Word * STATE_VARIABLE_Specs_46)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_17, (MR_Integer) 202, &ShowCallTree_18);
  libs__globals__lookup_accumulating_option_3_p_0(Globals_17, (MR_Integer) 207, &ShowMovability_19);
  ...
  MR_Word * STATE_VARIABLE_Specs_23)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_18, (MR_Integer) 230, &ComputeGoalModes_19);
  ...
  MR_Word * STATE_VARIABLE_Specs_34)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_22, (MR_Integer) 231, &BenchmarkModes_23);
    ...
    case (MR_Integer) 1:
      {
        ...
        libs__globals__lookup_int_option_3_p_0(Globals_22, (MR_Integer) 232, &Repeats_24);
        {
  ...
  MR_Word * STATE_VARIABLE_HLDS_16)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_13, (MR_Integer) 227, &ModeConstraints_14);
    ...
    case (MR_Integer) 1:
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_29, (MR_Integer) 231, &BenchmarkModes_30);
          ...
          case (MR_Integer) 1:
            {
              ...
              libs__globals__lookup_int_option_3_p_0(Globals_29, (MR_Integer) 232, &Repeats_31);
    ...
    case (MR_Integer) 5:
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_22, (MR_Integer) 264, &DeepProf_30);
        libs__globals__lookup_bool_option_3_p_0(Globals_22, (MR_Integer) 281, &TSWProf_31);
        libs__globals__lookup_bool_option_3_p_0(Globals_22, (MR_Integer) 282, &TSCProf_32);
    ...
    case (MR_Integer) 3:
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_22, (MR_Integer) 267, &PreParSimplify_27);
    ...
    case (MR_Integer) 2:
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_22, (MR_Integer) 266, &PreProfSimplify_26);
  ...
  MR_Word * NeedMiddlePassForOptFile_4)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 538, &Termination_7);
  libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 545, &Termination2_8);
  libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 530, &SharingAnalysis_9);
  libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 532, &ReuseAnalysis_10);
  libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 553, &ExceptionAnalysis_11);
  libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 554, &ClosureAnalysis_12);
  libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 526, &TrailingAnalysis_13);
  libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 529, &TablingAnalysis_14);
  ...
  MR_Word * STATE_VARIABLE_Specs_37)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_21, (MR_Integer) 363, &TypeCheckConstraints_29);
    ...
    case (MR_Integer) 1:
      {
        ...
        libs__globals__lookup_string_option_3_p_0(Globals_21, (MR_Integer) 730, &Experiment_30);
