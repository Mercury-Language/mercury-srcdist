  ...
  MR_Word * STATE_VARIABLE_Specs_29)
{
  ...
  *STATE_VARIABLE_Specs_29 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_error_spec_0), SpecsList_22, STATE_VARIABLE_Specs_0_28);
  libs__globals__lookup_bool_option_3_p_0(Globals_21, (MR_Integer) 87, &Statistics_23);
  ...
  MR_Word * STATE_VARIABLE_Specs_41)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_28, (MR_Integer) 76, &Verbose_29);
    ...
    case (MR_Integer) 0:
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_28, (MR_Integer) 86, &Stats_30);
  ...
  MR_Word * STATE_VARIABLE_Specs_42)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_24, (MR_Integer) 76, &Verbose_25);
  libs__globals__lookup_bool_option_3_p_0(Globals_24, (MR_Integer) 86, &Stats_26);
  libs__globals__lookup_bool_option_3_p_0(Globals_24, (MR_Integer) 520, &IntermodOpt_78);
  libs__globals__lookup_bool_option_3_p_0(Globals_24, (MR_Integer) 525, &IntermodAnalysis_79);
  libs__globals__lookup_bool_option_3_p_0(Globals_24, (MR_Integer) 522, &UseOptFiles_80);
        ...
        case (MR_Integer) 0:
          {
            ...
            libs__globals__lookup_bool_option_3_p_0(Globals_23, (MR_Integer) 525, &IntermodAnalysis_82);
            switch ((MR_Integer) 1) {
              default: /*NOTREACHED*/ MR_assert(0);
              case (MR_Integer) 0:
                {
        ...
        case (MR_Integer) 5:
          {
            ...
            libs__globals__lookup_bool_option_3_p_0(Globals_23, (MR_Integer) 525, &IntermodAnalysis_34);
            switch ((MR_Integer) 0) {
              default: /*NOTREACHED*/ MR_assert(0);
              case (MR_Integer) 0:
                {
  ...
  MR_Word * STATE_VARIABLE_HLDS_28)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_10, (MR_Integer) 520, &IntermodOpt_13);
  succeeded = (IntermodOpt_13 == (MR_Integer) 1);
  if (!(succeeded))
    succeeded = (IntermodAnalysis_9 == (MR_Integer) 1);
  if (succeeded)
    transform_hlds__intermod_mark_exported__maybe_opt_export_entities_3_p_0(ProgressStream_8, STATE_VARIABLE_HLDS_0_27, STATE_VARIABLE_HLDS_28);
  else
  {
    MR_Word UseOptFiles_15;

    libs__globals__lookup_bool_option_3_p_0(Globals_10, (MR_Integer) 522, &UseOptFiles_15);
      ...
      case (MR_Integer) 1:
        {
          ...
          MR_Word SearchWhichDir_17;
          MR_Word ModuleName_18;
          MR_Word SearchAuthDir_20;
          MR_String OptFileName_21;
          MR_Word MaybeDir_24;
          MR_String _OptFileNameProposed_22;
          MR_Word _SearchDirs_23;

          libs__globals__get_options_2_p_0(Globals_10, &OptionTable_16);
          {
            SearchWhichDir_17 = (MR_Word) MR_mkword(3, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(3, SearchWhichDir_17, 0) = ((MR_Box) ((MR_Unsigned) 2U));
            MR_hl_field(3, SearchWhichDir_17, 1) = ((MR_Box) (OptionTable_16));
          }
          hlds__hlds_module__module_info_get_name_2_p_0(STATE_VARIABLE_HLDS_0_27, &ModuleName_18);
          parse_tree__file_names__module_name_to_search_file_name_8_p_1(Globals_10, (MR_String) "predicate \140top_level.mercury_compile_front_end.mark_entities_in_opt_file_as_opt_exported\'/7", (MR_Word) (MR_mkword(3, &top_level__mercury_compile_front_end_scalar_common_1[1])), ModuleName_18, SearchWhichDir_17, &SearchAuthDir_20, &OptFileName_21, &_OptFileNameProposed_22);
          parse_tree__find_module__search_for_file_returning_dir_6_p_0(SearchAuthDir_20, OptFileName_21, &_SearchDirs_23, &MaybeDir_24);
          if (((MR_tag((MR_Word) MaybeDir_24)) == (MR_Integer) 1))
            *STATE_VARIABLE_HLDS_28 = STATE_VARIABLE_HLDS_0_27;
          else
            transform_hlds__intermod_mark_exported__maybe_opt_export_entities_3_p_0(ProgressStream_8, STATE_VARIABLE_HLDS_0_27, STATE_VARIABLE_HLDS_28);
        }
    ...
    case (MR_Integer) 1:
      {
        ...
        else
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_16, (MR_Integer) 738, &Experiment5_42);
  ...
  MR_Word * STATE_VARIABLE_Specs_38)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_19, (MR_Integer) 76, &Verbose_20);
  libs__globals__lookup_bool_option_3_p_0(Globals_19, (MR_Integer) 86, &Stats_21);
  ...
  MR_Word * STATE_VARIABLE_Specs_28)
{
  ...
  libs__globals__lookup_string_option_3_p_0(Globals_18, (MR_Integer) 89, &StatsFileName_19);
  ...
  MR_Word * STATE_VARIABLE_Specs_30)
{
  ...
  libs__globals__lookup_string_option_3_p_0(Globals_20, (MR_Integer) 88, &StatsFileName_21);
  ...
  MR_Word * STATE_VARIABLE_Specs_46)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_17, (MR_Integer) 204, &ShowCallTree_18);
  libs__globals__lookup_accumulating_option_3_p_0(Globals_17, (MR_Integer) 209, &ShowMovability_19);
  ...
  MR_Word * STATE_VARIABLE_Specs_23)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_18, (MR_Integer) 232, &ComputeGoalModes_19);
  ...
  MR_Box * wrapper_arg_2)
{
  ...
  top_level__mercury_compile_front_end__IntroducedFrom__pred__modecheck__1086__1_3_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) (wrapper_arg_1)), &conv0_LambdaHeadVar__2_44);
  ...
  MR_Word * STATE_VARIABLE_Specs_34)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_22, (MR_Integer) 233, &BenchmarkModes_23);
    ...
    case (MR_Integer) 1:
      {
        ...
        libs__globals__lookup_int_option_3_p_0(Globals_22, (MR_Integer) 234, &Repeats_24);
        {
  ...
  MR_Word * STATE_VARIABLE_HLDS_16)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_13, (MR_Integer) 229, &ModeConstraints_14);
    ...
    case (MR_Integer) 1:
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_29, (MR_Integer) 233, &BenchmarkModes_30);
          ...
          case (MR_Integer) 1:
            {
              ...
              libs__globals__lookup_int_option_3_p_0(Globals_29, (MR_Integer) 234, &Repeats_31);
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = top_level__mercury_compile_front_end__IntroducedFrom__pred__maybe_simplify__1571__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 4)))));
  return succeeded;
}
    ...
    case (MR_Integer) 5:
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_22, (MR_Integer) 266, &DeepProf_30);
        libs__globals__lookup_bool_option_3_p_0(Globals_22, (MR_Integer) 283, &TSWProf_31);
        libs__globals__lookup_bool_option_3_p_0(Globals_22, (MR_Integer) 284, &TSCProf_32);
    ...
    case (MR_Integer) 3:
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_22, (MR_Integer) 269, &PreParSimplify_27);
    ...
    case (MR_Integer) 2:
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_22, (MR_Integer) 268, &PreProfSimplify_26);
  ...
  MR_Word * NeedMiddlePassForOptFile_4)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 540, &Termination_7);
  libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 547, &Termination2_8);
  libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 532, &SharingAnalysis_9);
  libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 534, &ReuseAnalysis_10);
  libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 555, &ExceptionAnalysis_11);
  libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 556, &ClosureAnalysis_12);
  libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 528, &TrailingAnalysis_13);
  libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 531, &TablingAnalysis_14);
  ...
  MR_Word * STATE_VARIABLE_Specs_37)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_21, (MR_Integer) 365, &TypeCheckConstraints_29);
    ...
    case (MR_Integer) 1:
      {
        ...
        libs__globals__lookup_string_option_3_p_0(Globals_21, (MR_Integer) 733, &Experiment_30);
