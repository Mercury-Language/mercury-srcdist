...
MR_decl_label10(top_level__mercury_compile_front_end__frontend_pass_by_phases_9_0, 24,25,26,27,28,29,30,31,32,14)
MR_decl_label2(top_level__mercury_compile_front_end__frontend_pass_by_phases_9_0, 13,40)
...
MR_BEGIN_MODULE(top_level__mercury_compile_front_end_module12)
	...
	MR_init_label10(top_level__mercury_compile_front_end__frontend_pass_by_phases_9_0,24,25,26,27,28,29,30,31,32,14)
	MR_init_label2(top_level__mercury_compile_front_end__frontend_pass_by_phases_9_0,13,40)
MR_BEGIN_CODE
...
MR_def_label(top_level__mercury_compile_front_end__frontend_pass_by_phases_9_0,31)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_sv(4),0)) {
		MR_GOTO_LAB(top_level__mercury_compile_front_end__frontend_pass_by_phases_9_0_i32);
	}
	if (MR_INT_NE(MR_sv(7),0)) {
		MR_GOTO_LAB(top_level__mercury_compile_front_end__frontend_pass_by_phases_9_0_i32);
	}
...
MR_def_label(top_level__mercury_compile_front_end__frontend_pass_by_phases_9_0,13)
	...
	MR_sv(2) = MR_r1;
	MR_np_call_localret_ent(hlds__passes_aux__maybe_dump_hlds_7_0,
		top_level__mercury_compile_front_end__frontend_pass_by_phases_9_0_i40);
MR_def_label(top_level__mercury_compile_front_end__frontend_pass_by_phases_9_0,40)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
