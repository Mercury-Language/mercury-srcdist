          ...
          case (MR_Integer) 5:
            {
              ...
              libs__globals__lookup_bool_option_3_p_0(Globals_19, (MR_Integer) 491, &IntermodAnalysis_30);
              switch (MR_tag((MR_Word) OpModeAugment_16)) {
                default: /*NOTREACHED*/ MR_assert(0);
                case (MR_Integer) 0:
                  switch (MR_unmkbody(OpModeAugment_16)) {
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 486, &IntermodOpt_11);
    ...
    else
    {
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals_8, (MR_Integer) 488, &UseOptFiles_13);
        ...
        case (MR_Integer) 1:
          {
            ...
            parse_tree__file_names__module_name_to_search_file_name_7_p_0(Globals_8, (MR_String) "predicate \140top_level.mercury_compile_front_end.mark_entities_in_opt_file_as_opt_exported\'/6", (MR_Word) (MR_mkword(MR_mktag(1), &top_level__mercury_compile_front_end_scalar_common_5[4])), ModuleName_14, &OptFileName_15);
...
{
  {
    ...
    parse_tree__file_names__module_name_to_file_name_8_p_0(Globals_12, (MR_String) "predicate \140top_level.mercury_compile_front_end.create_and_write_opt_file\'/10", (MR_Integer) 0, (MR_Word) (MR_mkword(MR_mktag(1), &top_level__mercury_compile_front_end_scalar_common_5[4])), ModuleName_17, &OptFileName_18);
    ...
    else
    {
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals_12, (MR_Integer) 707, &Experiment5_33);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_14, (MR_Integer) 195, &ComputeGoalModes_15);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_18, (MR_Integer) 196, &BenchmarkModes_19);
      ...
      case (MR_Integer) 1:
        {
          ...
          libs__globals__lookup_int_option_3_p_0(Globals_18, (MR_Integer) 197, &Repeats_20);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 192, &ModeConstraints_12);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 196, &BenchmarkModes_12);
      ...
      case (MR_Integer) 1:
        {
          ...
          libs__globals__lookup_int_option_3_p_0(Globals_11, (MR_Integer) 197, &Repeats_13);
...
{
  {
    ...
    MR_Word STATE_VARIABLE_SimpList_38_38;

    hlds__hlds_module__module_info_get_globals_2_p_0(STATE_VARIABLE_HLDS_0_32, &Globals_18);
    check_hlds__simplify__simplify_tasks__find_simplify_tasks_3_p_0(Warn_11, Globals_18, &SimplifyTasks0_20);
    STATE_VARIABLE_SimpList_38_38 = check_hlds__simplify__simplify_tasks__simplify_tasks_to_list_1_f_0(SimplifyTasks0_20);
    switch (SimplifyPass_12) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        mercury__list__cons_3_p_0((MR_Word) (&check_hlds__simplify__simplify_tasks__check_hlds__simplify__simplify_tasks__type_ctor_info_simplify_task_0), ((MR_Box) ((MR_Integer) 6)), STATE_VARIABLE_SimpList_38_38, &SimpList_19);
        break;
      case (MR_Integer) 5:
        {
          MR_Word OptTuple_23;
          MR_Word ConstProp_24;
          MR_Word DeepProf_25;
          MR_Word TSWProf_26;
          MR_Word TSCProf_27;
          ...
          libs__globals__get_opt_tuple_2_p_0(Globals_18, &OptTuple_23);
          ConstProp_24 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), OptTuple_23, (MR_Integer) 0))) >> 21)) & (MR_Integer) 1);
          libs__globals__lookup_bool_option_3_p_0(Globals_18, (MR_Integer) 231, &DeepProf_25);
          libs__globals__lookup_bool_option_3_p_0(Globals_18, (MR_Integer) 248, &TSWProf_26);
          libs__globals__lookup_bool_option_3_p_0(Globals_18, (MR_Integer) 249, &TSCProf_27);
          succeeded = (ConstProp_24 == (MR_Integer) 0);
          if (succeeded)
          {
            succeeded = (DeepProf_25 == (MR_Integer) 0);
            if (succeeded)
            {
              succeeded = (TSWProf_26 == (MR_Integer) 0);
              if (succeeded)
                succeeded = (TSCProf_27 == (MR_Integer) 0);
            }
          }
          if (succeeded)
            mercury__list__cons_3_p_0((MR_Word) (&check_hlds__simplify__simplify_tasks__check_hlds__simplify__simplify_tasks__type_ctor_info_simplify_task_0), ((MR_Box) ((MR_Integer) 11)), STATE_VARIABLE_SimpList_38_38, &STATE_VARIABLE_SimpList_43_43);
          else
            mercury__list__delete_all_3_p_1((MR_Word) (&check_hlds__simplify__simplify_tasks__check_hlds__simplify__simplify_tasks__type_ctor_info_simplify_task_0), STATE_VARIABLE_SimpList_38_38, ((MR_Box) ((MR_Integer) 11)), &STATE_VARIABLE_SimpList_43_43);
        ...
        break;
      case (MR_Integer) 4:
        mercury__list__cons_3_p_0((MR_Word) (&check_hlds__simplify__simplify_tasks__check_hlds__simplify__simplify_tasks__type_ctor_info_simplify_task_0), ((MR_Box) ((MR_Integer) 5)), STATE_VARIABLE_SimpList_38_38, &SimpList_19);
        break;
      case (MR_Integer) 1:
        mercury__list__cons_3_p_0((MR_Word) (&check_hlds__simplify__simplify_tasks__check_hlds__simplify__simplify_tasks__type_ctor_info_simplify_task_0), ((MR_Box) ((MR_Integer) 5)), STATE_VARIABLE_SimpList_38_38, &SimpList_19);
        break;
      case (MR_Integer) 3:
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_18, (MR_Integer) 234, &PreParSimplify_22);
      ...
      case (MR_Integer) 2:
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_18, (MR_Integer) 233, &PreProfSimplify_21);
    ...
    {
      MR_Word SimplifyTasks_30;
      MR_Word SimplifySpecs_31;
      MR_Word STATE_VARIABLE_HLDS_64_64;
      MR_Word STATE_VARIABLE_Specs_65_65;
      MR_Word Var_70;
      ...
      hlds__hlds_error_util__maybe_write_out_errors_8_p_0(Verbose_13, Globals_18, STATE_VARIABLE_HLDS_0_32, &STATE_VARIABLE_HLDS_64_64, STATE_VARIABLE_Specs_0_34, &STATE_VARIABLE_Specs_65_65);
      ...
      SimplifyTasks_30 = check_hlds__simplify__simplify_tasks__list_to_simplify_tasks_1_f_0(SimpList_19);
      {
        ...
        MR_hl_field(MR_mktag(0), Var_74, 3) = ((MR_Box) (SimplifyTasks_30));
      }
      Var_70 = (MR_Word) (Var_74);
      hlds__passes_aux__process_valid_nonimported_preds_errors_7_p_0(Var_70, STATE_VARIABLE_HLDS_64_64, &STATE_VARIABLE_HLDS_71_71, (MR_Word) ((MR_Unsigned) 0U), &SimplifySpecs_31);
      switch (SimplifyPass_12) {
        default: /*NOTREACHED*/ MR_assert(0);
        case (MR_Integer) 0:
          {
            ...
            STATE_VARIABLE_Specs_75_75 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_error_spec_0), SimplifySpecs_31, STATE_VARIABLE_Specs_65_65);
            hlds__hlds_error_util__maybe_write_out_errors_8_p_0(Verbose_13, Globals_18, STATE_VARIABLE_HLDS_71_71, STATE_VARIABLE_HLDS_33, STATE_VARIABLE_Specs_75_75, STATE_VARIABLE_Specs_35);
          }
          break;
        case (MR_Integer) 5:
          {
            *STATE_VARIABLE_HLDS_33 = STATE_VARIABLE_HLDS_71_71;
            *STATE_VARIABLE_Specs_35 = STATE_VARIABLE_Specs_65_65;
          }
          break;
        case (MR_Integer) 4:
          {
...
{
  {
    ...
    IntermodArgs_6 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), OptTuple_5, (MR_Integer) 0))) >> 6)) & (MR_Integer) 1);
    libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 506, &Termination_7);
    libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 513, &Termination2_8);
    libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 498, &SharingAnalysis_9);
    libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 500, &ReuseAnalysis_10);
    libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 521, &ExceptionAnalysis_11);
    libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 522, &ClosureAnalysis_12);
    libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 494, &TrailingAnalysis_13);
    libs__globals__lookup_bool_option_3_p_0(Globals_3, (MR_Integer) 497, &TablingAnalysis_14);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_17, (MR_Integer) 332, &TypeCheckConstraints_25);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_16, (MR_Integer) 486, &IntermodOpt_21);
    libs__globals__lookup_bool_option_3_p_0(Globals_16, (MR_Integer) 491, &IntermodAnalysis_22);
    libs__globals__lookup_bool_option_3_p_0(Globals_16, (MR_Integer) 488, &UseOptFiles_23);
