  ...
  MR_Word * STATE_VARIABLE_HLDS_26)
{
  ...
  if (succeeded)
    transform_hlds__intermod_mark_exported__maybe_opt_export_entities_3_p_0(ProgressStream_8, STATE_VARIABLE_HLDS_0_25, STATE_VARIABLE_HLDS_26);
  else
  {
      ...
      case (MR_Integer) 1:
        {
          ...
          MR_Word MaybeDir_22;
          MR_Word Var_33;
          MR_String _OptFileNameProposed_19;
          MR_Word _SearchDirs_21;

          hlds__hlds_module__module_info_get_name_2_p_0(STATE_VARIABLE_HLDS_0_25, &ModuleName_16);
          parse_tree__file_names__module_name_to_search_file_name_6_p_0(Globals_10, (MR_String) "predicate \140top_level.mercury_compile_front_end.mark_entities_in_opt_file_as_opt_exported\'/7", (MR_Word) (MR_mkword(3, &top_level__mercury_compile_front_end_scalar_common_1[1])), ModuleName_16, &OptFileName_18, &_OptFileNameProposed_19);
          libs__globals__get_options_2_p_0(Globals_10, &OptionTable_20);
          {
            ...
            MR_hl_field(3, Var_33, 1) = ((MR_Box) (OptionTable_20));
          }
          parse_tree__find_module__search_for_file_returning_dir_6_p_0(Var_33, OptFileName_18, &_SearchDirs_21, &MaybeDir_22);
          if (((MR_tag((MR_Word) MaybeDir_22)) == (MR_Integer) 1))
            *STATE_VARIABLE_HLDS_26 = STATE_VARIABLE_HLDS_0_25;
          else
            transform_hlds__intermod_mark_exported__maybe_opt_export_entities_3_p_0(ProgressStream_8, STATE_VARIABLE_HLDS_0_25, STATE_VARIABLE_HLDS_26);
        }
