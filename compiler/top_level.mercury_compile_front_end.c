...
static void MR_CALL 
top_level__mercury_compile_front_end__IntroducedFrom__pred__modecheck__1091__1_3_p_0(
  MR_Word ProgressStream_13,
  MR_Word LambdaHeadVar__1_43,
  MR_Tuple * LambdaHeadVar__2_44);

static MR_bool MR_CALL 
top_level__mercury_compile_front_end__IntroducedFrom__pred__maybe_simplify__1576__1_2_p_0(
  ...
  MR_Word * STATE_VARIABLE_Specs_22)
{
  ...
  hlds__hlds_module__module_info_get_globals_2_p_0(HLDS_14, &Globals_17);
  parse_tree__write_error_spec__maybe_write_out_errors_7_p_0(ErrorStream_11, Verbose_12, Globals_17, STATE_VARIABLE_Specs_0_21, &STATE_VARIABLE_Specs_1_25);
  check_hlds__style_checks__do_we_want_style_warnings_2_p_0(Globals_17, &DoWeWantStyleWarnings_18);
  if ((DoWeWantStyleWarnings_18 == (MR_Word) ((MR_Unsigned) 0U)))
    *STATE_VARIABLE_Specs_22 = STATE_VARIABLE_Specs_1_25;
  else
  {
    MR_Word WarningsWeWant_19 = ((MR_Word) ((MR_hl_field(1, DoWeWantStyleWarnings_18, 0))));
    ...
    check_hlds__style_checks__generate_any_style_warnings_3_p_0(HLDS_14, WarningsWeWant_19, &StyleSpecs_20);
    *STATE_VARIABLE_Specs_22 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_error_spec_0), StyleSpecs_20, STATE_VARIABLE_Specs_1_25);
    libs__file_util__maybe_write_string_5_p_0(ProgressStream_10, Verbose_12, (MR_String) "% done.\n");
    libs__file_util__maybe_report_stats_4_p_0(ProgressStream_10, Stats_13);
  }
}
  ...
  MR_Box * wrapper_arg_2)
{
  ...
  top_level__mercury_compile_front_end__IntroducedFrom__pred__modecheck__1091__1_3_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) (wrapper_arg_1)), &conv0_LambdaHeadVar__2_44);
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = top_level__mercury_compile_front_end__IntroducedFrom__pred__maybe_simplify__1576__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) ((MR_hl_field(0, closure, 4)))));
  return succeeded;
}
