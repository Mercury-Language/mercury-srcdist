...
top_level__mercury_compile_front_end__IntroducedFrom__pred__maybe_simplify__1585__1_2_p_0(
  ...
  MR_Word * STATE_VARIABLE_Specs_27)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_21, (MR_Integer) 177, &Warn_22);
  ...
  MR_Word * STATE_VARIABLE_Specs_44)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_15, (MR_Integer) 264, &ShowCallTree_16);
  libs__globals__lookup_accumulating_option_3_p_0(Globals_15, (MR_Integer) 260, &ShowMovability_17);
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = top_level__mercury_compile_front_end__IntroducedFrom__pred__maybe_simplify__1585__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) ((MR_hl_field(0, closure, 4)))));
  return succeeded;
}
