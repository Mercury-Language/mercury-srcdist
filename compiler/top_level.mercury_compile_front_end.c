      ...
      case (MR_Integer) 1:
        {
          ...
          parse_tree__file_names__module_name_to_search_file_name_5_p_0(Globals_8, (MR_String) "predicate \140top_level.mercury_compile_front_end.mark_entities_in_opt_file_as_opt_exported\'/6", (MR_Word) (MR_mkword(1, &top_level__mercury_compile_front_end_scalar_common_4[0])), ModuleName_14, &OptFileName_15);
  ...
  MR_Word * STATE_VARIABLE_Specs_47)
{
  ...
  else
  {
    ...
    parse_tree__module_cmds__touch_module_ext_datestamp_8_p_0(Globals_16, ProgressStream_13, ErrorStream_14, ModuleName_21, (MR_Word) (MR_mkword(2, &top_level__mercury_compile_front_end_scalar_common_4[0])), &_TouchSucceeded_36);
