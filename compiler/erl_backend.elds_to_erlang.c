      ...
      case (MR_Integer) 0:
        {
            ...
            InstanceModule_13 = ModuleName_10;
          {
            ...
            MR_hl_field(MR_mktag(0), CRttiId_14, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 11))));
          }
...
{
  {
    ...
    _Detism_35 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), RttiProcName_24, (MR_Integer) 10))) & (MR_Integer) 7);
    PredIsImported0_36 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), RttiProcName_24, (MR_Integer) 10))) >> (MR_Integer) 3)) & (MR_Integer) 1);
    _PredIsPseudoImported_37 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), RttiProcName_24, (MR_Integer) 10))) >> (MR_Integer) 4)) & (MR_Integer) 1);
    Origin_38 = ((MR_Word) ((MR_hl_field(MR_mktag(0), RttiProcName_24, (MR_Integer) 11))));
    _ProcIsExported_39 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), RttiProcName_24, (MR_Integer) 12))) & (MR_Integer) 1);
    _ProcIsImported_40 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), RttiProcName_24, (MR_Integer) 12))) >> (MR_Integer) 1)) & (MR_Integer) 1);
