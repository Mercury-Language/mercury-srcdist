...
MR_decl_label7(erl_backend__elds_to_erlang__output_hrl_file_5_0, 2,10,11,12,13,20,22)
...
MR_decl_label1(fn__erl_backend__elds_to_erlang__elds_get_env_var_names_1_0, 3)
...
MR_decl_label9(fn__erl_backend__elds_to_erlang__should_add_main_wrapper_1_0, 2,3,6,7,8,9,5,11,4)
...
MR_def_label(erl_backend__elds_to_erlang__output_term_6_0,69)
	...
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r4;
	MR_f(1) = MR_float_from_dword_ptr(&MR_tfield(3, MR_tempr1, 1));
	}
...
MR_def_label(erl_backend__elds_to_erlang__output_tuple_6_0,12)
	...
	MR_r1 = MR_tfield(1, MR_tempr1, 0);
	MR_r2 = (MR_Word) MR_TAG_COMMON(2,10,0);
	}
...
MR_decl_entry(hlds__pred_table__predicate_table_lookup_pred_name_arity_4_0);
...
MR_BEGIN_MODULE(erl_backend__elds_to_erlang_module30)
	...
	MR_init_label9(fn__erl_backend__elds_to_erlang__should_add_main_wrapper_1_0,2,3,6,7,8,9,5,11,4)
MR_BEGIN_CODE
...
MR_def_label(fn__erl_backend__elds_to_erlang__should_add_main_wrapper_1_0,2)
	...
	MR_r3 = (MR_Integer) 2;
	MR_np_call_localret_ent(hlds__pred_table__predicate_table_lookup_pred_name_arity_4_0,
		fn__erl_backend__elds_to_erlang__should_add_main_wrapper_1_0_i3);
MR_def_label(fn__erl_backend__elds_to_erlang__should_add_main_wrapper_1_0,3)
	...
	MR_redoip_slot_word(MR_maxfr) = (MR_Word) MR_LABEL_AP(fn__erl_backend__elds_to_erlang__should_add_main_wrapper_1_0_i5);
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
	...
	MR_np_call_localret_ent(list__member_2_1,
		fn__erl_backend__elds_to_erlang__should_add_main_wrapper_1_0_i6);
MR_def_label(fn__erl_backend__elds_to_erlang__should_add_main_wrapper_1_0,6)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
...
MR_def_label(fn__erl_backend__elds_to_erlang__should_add_main_wrapper_1_0,9)
	...
	MR_GOTO_LAB(fn__erl_backend__elds_to_erlang__should_add_main_wrapper_1_0_i11);
...
MR_def_label(fn__erl_backend__elds_to_erlang__should_add_main_wrapper_1_0,11)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Integer) 1;
	MR_decr_sp_and_return(5);
...
MR_BEGIN_MODULE(erl_backend__elds_to_erlang_module32)
	...
	MR_init_label1(fn__erl_backend__elds_to_erlang__elds_get_env_var_names_1_0,3)
MR_BEGIN_CODE
...
MR_def_static(fn__erl_backend__elds_to_erlang__elds_get_env_var_names_1_0)
	...
	MR_np_call_localret_ent(fn__list__map_2_0,
		fn__erl_backend__elds_to_erlang__elds_get_env_var_names_1_0_i3);
MR_def_label(fn__erl_backend__elds_to_erlang__elds_get_env_var_names_1_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
...
MR_def_label(erl_backend__elds_to_erlang__output_foreign_decl_code_3_0,2)
	...
	MR_Word MR_tempr1;
	MR_tempr1 = MR_sv(1);
	MR_sv(1) = (MR_Word) MR_TAG_COMMON(0,4,6);
	MR_r1 = (MR_Word) MR_IO_CTOR_ADDR;
	MR_r2 = MR_sv(1);
	MR_r3 = MR_tempr1;
	}
...
MR_def_label(erl_backend__elds_to_erlang__output_foreign_body_code_3_0,2)
	...
	MR_Word MR_tempr1;
	MR_tempr1 = MR_sv(1);
	MR_sv(1) = (MR_Word) MR_TAG_COMMON(0,4,7);
	MR_r1 = (MR_Word) MR_IO_CTOR_ADDR;
	MR_r2 = MR_sv(1);
	MR_r3 = MR_tempr1;
	}
...
MR_BEGIN_MODULE(erl_backend__elds_to_erlang_module49)
	...
	MR_init_label7(erl_backend__elds_to_erlang__output_hrl_file_5_0,2,10,11,12,13,20,22)
MR_BEGIN_CODE
...
MR_def_label(erl_backend__elds_to_erlang__output_hrl_file_5_0,2)
	...
	MR_np_call_localret_ent(io__write_strings_3_0,
		erl_backend__elds_to_erlang__output_hrl_file_5_0_i10);
MR_def_label(erl_backend__elds_to_erlang__output_hrl_file_5_0,10)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(1);
	MR_np_call_localret_ent(fn__parse_tree__prog_foreign__sym_name_mangle_1_0,
		erl_backend__elds_to_erlang__output_hrl_file_5_0_i11);
MR_def_label(erl_backend__elds_to_erlang__output_hrl_file_5_0,11)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_np_call_localret_ent(string__to_upper_2_0,
		erl_backend__elds_to_erlang__output_hrl_file_5_0_i12);
MR_def_label(erl_backend__elds_to_erlang__output_hrl_file_5_0,12)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = (MR_Word) MR_string_const("_HRL", 4);
	MR_np_call_localret_ent(string__append_3_2,
		erl_backend__elds_to_erlang__output_hrl_file_5_0_i13);
MR_def_label(erl_backend__elds_to_erlang__output_hrl_file_5_0,13)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2, MR_tempr3;
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 2);
	...
	MR_np_call_localret_ent(io__write_strings_3_0,
		erl_backend__elds_to_erlang__output_hrl_file_5_0_i20);
MR_def_label(erl_backend__elds_to_erlang__output_hrl_file_5_0,20)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(parse_tree__prog_foreign, foreign_decl_code);
	MR_r2 = (MR_Word) MR_IO_CTOR_ADDR;
	...
	MR_np_call_localret_ent(list__foldl_4_2,
		erl_backend__elds_to_erlang__output_hrl_file_5_0_i22);
MR_def_label(erl_backend__elds_to_erlang__output_hrl_file_5_0,22)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
void mercury__erl_backend__elds_to_erlang__write_out_proc_statics(FILE *deep_fp, FILE *procrep_fp)
{
	MR_write_out_module_proc_reps_start(procrep_fp, &mercury_data__module_layout__erl_backend__elds_to_erlang);
