...
static /* final */ const struct erl_backend__elds_to_erlang__vector_common_type_7_0_s erl_backend__elds_to_erlang_vector_common_7[25];
...
{
  {
    ...
    parse_tree__file_names__module_name_to_search_file_name_6_p_0(Globals_5, (MR_Word) (((MR_Box) ((MR_String) ".hrl"))), ImportedModuleName_6, &HeaderFileName_8);
    mercury__io__write_string_3_p_0((MR_String) "-include(\"");
    mercury__string__foldl_4_p_0((MR_Word) (&mercury__io__io__type_ctor_info_state_0), (MR_Word) (&erl_backend__elds_to_erlang_scalar_common_4[4]), HeaderFileName_8, ((MR_Box) ((MR_Integer) 0)), &conv0_STATE_VARIABLE_IO_17_17);
    mercury__io__write_string_3_p_0((MR_String) "\").\n");
  }
}
...
{
  {
    ...
    parse_tree__file_names__module_name_to_file_name_7_p_0(Globals_11, (MR_Integer) 0, (MR_Word) (((MR_Box) ((MR_String) ".erl"))), Name_10, &TargetFileName_13);
    parse_tree__file_names__module_name_to_file_name_7_p_0(Globals_11, (MR_Integer) 0, (MR_Word) (((MR_Box) ((MR_String) ".hrl"))), Name_10, &HeaderFileName_14);
    {
      Var_28 = (MR_Word) MR_new_object(MR_Word, (6 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), Var_28, 0) = ((MR_Box) (&erl_backend__elds_to_erlang_scalar_common_2[0]));
      MR_hl_field(MR_mktag(0), Var_28, 1) = ((MR_Box) (erl_backend__elds_to_erlang__output_elds_5_p_0_1));
      MR_hl_field(MR_mktag(0), Var_28, 2) = ((MR_Box) ((MR_Integer) 3));
      MR_hl_field(MR_mktag(0), Var_28, 3) = ((MR_Box) (ModuleInfo_6));
      MR_hl_field(MR_mktag(0), Var_28, 4) = ((MR_Box) (ELDS_7));
      MR_hl_field(MR_mktag(0), Var_28, 5) = ((MR_Box) (SourceFileName_12));
    }
    libs__file_util__output_to_file_6_p_0(Globals_11, TargetFileName_13, Var_28, &TargetCodeSucceeded_15);
      ...
      case (MR_Integer) 1:
        {
          ...
          TmpHeaderFileName_16 = mercury__string__f_43_43_2_f_0(HeaderFileName_14, (MR_String) ".tmp");
          {
            ...
            MR_hl_field(MR_mktag(0), Var_31, 0) = ((MR_Box) (&erl_backend__elds_to_erlang_scalar_common_2[1]));
            MR_hl_field(MR_mktag(0), Var_31, 1) = ((MR_Box) (erl_backend__elds_to_erlang__output_elds_5_p_0_2));
            MR_hl_field(MR_mktag(0), Var_31, 2) = ((MR_Box) ((MR_Integer) 3));
            MR_hl_field(MR_mktag(0), Var_31, 3) = ((MR_Box) (Name_10));
            MR_hl_field(MR_mktag(0), Var_31, 4) = ((MR_Box) (ELDS_7));
            MR_hl_field(MR_mktag(0), Var_31, 5) = ((MR_Box) (SourceFileName_12));
          }
          libs__file_util__output_to_file_6_p_0(Globals_11, TmpHeaderFileName_16, Var_31, Succeeded_8);
          switch (*Succeeded_8) {
            default: /*NOTREACHED*/ MR_assert(0);
            case (MR_Integer) 0:
              {
