    ...
    switch (MR_tag((MR_Word) Term_10)) {
      ...
      case (MR_Integer) 3:
        switch (((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), Term_10, (MR_Integer) 0)))) {
          ...
          case (MR_Integer) 7:
            {
              MR_Integer Int64_21 = ((MR_Integer) (MR_hl_field(MR_mktag(3), Term_10, (MR_Integer) 1)));

              mercury__io__write_int_3_p_0(Int64_21);
              erl_backend__elds_to_erlang__space_2_p_0();
            }
            break;
          case (MR_Integer) 8:
            {
              MR_Integer UInt64_22 = ((MR_Integer) (MR_hl_field(MR_mktag(3), Term_10, (MR_Integer) 1)));

              mercury__io__write_int_3_p_0(UInt64_22);
              erl_backend__elds_to_erlang__space_2_p_0();
            }
            break;
          case (MR_Integer) 9:
