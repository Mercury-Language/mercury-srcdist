...
MR_decl_label10(erl_backend__elds_to_erlang__output_expr_6_0, 196,6,7,8,5,3,13,12,16,19)
MR_decl_label10(erl_backend__elds_to_erlang__output_expr_6_0, 20,18,24,26,28,29,22,33,34,35)
MR_decl_label10(erl_backend__elds_to_erlang__output_expr_6_0, 36,37,39,32,43,42,46,47,45,51)
...
MR_BEGIN_MODULE(erl_backend__elds_to_erlang_module22)
	...
	MR_init_label10(erl_backend__elds_to_erlang__output_expr_6_0,196,6,7,8,5,3,13,12,16,19)
	MR_init_label10(erl_backend__elds_to_erlang__output_expr_6_0,20,18,24,26,28,29,22,33,34,35)
	MR_init_label10(erl_backend__elds_to_erlang__output_expr_6_0,36,37,39,32,43,42,46,47,45,51)
...
MR_def_label(erl_backend__elds_to_erlang__output_expr_6_0,12)
	...
	if (MR_PTAG_TESTR(MR_r4,1)) {
		MR_GOTO_LAB(erl_backend__elds_to_erlang__output_expr_6_0_i16);
	}
	MR_r4 = MR_tfield(1, MR_r4, 0);
	MR_succip_word = MR_sv(8);
	MR_decr_sp(8);
...
MR_def_label(erl_backend__elds_to_erlang__output_expr_6_0,16)
	...
	if (MR_RTAGS_TESTR(MR_r4,3,1)) {
		MR_GOTO_LAB(erl_backend__elds_to_erlang__output_expr_6_0_i18);
	}
	MR_sv(1) = MR_r1;
	MR_sv(2) = MR_r2;
	MR_sv(3) = MR_r3;
	...
	MR_np_localcall_lab(erl_backend__elds_to_erlang__output_expr_6_0,
		erl_backend__elds_to_erlang__output_expr_6_0_i19);
...
MR_def_label(erl_backend__elds_to_erlang__output_expr_6_0,18)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_RTAGS_TESTR(MR_r4,3,2)) {
		MR_GOTO_LAB(erl_backend__elds_to_erlang__output_expr_6_0_i22);
	}
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tempr2 = MR_r4;
	...
	if (MR_PTAG_TESTR(MR_tempr1,2)) {
		MR_GOTO_LAB(erl_backend__elds_to_erlang__output_expr_6_0_i24);
	}
	MR_sv(1) = MR_r1;
	MR_sv(2) = MR_r2;
	MR_sv(3) = MR_r3;
	...
	MR_np_call_localret_ent(erl_backend__elds_to_erlang__output_atom_3_0,
		erl_backend__elds_to_erlang__output_expr_6_0_i28);
MR_def_label(erl_backend__elds_to_erlang__output_expr_6_0,24)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_r6,1)) {
		MR_GOTO_LAB(erl_backend__elds_to_erlang__output_expr_6_0_i26);
	}
	MR_sv(1) = MR_r1;
	MR_sv(2) = MR_r2;
	MR_sv(3) = MR_r3;
...
MR_def_label(erl_backend__elds_to_erlang__output_expr_6_0,26)
	...
	MR_np_call_localret_ent(erl_backend__elds_to_erlang__output_pred_proc_id_4_0,
		erl_backend__elds_to_erlang__output_expr_6_0_i28);
MR_def_label(erl_backend__elds_to_erlang__output_expr_6_0,28)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_string_const("(", 1);
	MR_np_call_localret_ent(io__write_string_3_0,
...
MR_def_label(erl_backend__elds_to_erlang__output_expr_6_0,37)
	...
	MR_np_call_localret_ent(io__write_list_5_0,
		erl_backend__elds_to_erlang__output_expr_6_0_i39);
MR_def_label(erl_backend__elds_to_erlang__output_expr_6_0,39)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(3);
	MR_np_call_localret_ent(erl_backend__elds_to_erlang__nl_indent_line_3_0,
		erl_backend__elds_to_erlang__output_expr_6_0_i94);
MR_def_label(erl_backend__elds_to_erlang__output_expr_6_0,32)
	...
	if (MR_RTAGS_TESTR(MR_r4,3,8)) {
		MR_GOTO_LAB(erl_backend__elds_to_erlang__output_expr_6_0_i42);
	}
	MR_sv(3) = MR_r3;
	MR_r1 = MR_tfield(3, MR_r4, 1);
	MR_np_call_localret_ent(io__write_string_3_0,
		erl_backend__elds_to_erlang__output_expr_6_0_i43);
...
MR_def_label(erl_backend__elds_to_erlang__output_expr_6_0,42)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_RTAGS_TESTR(MR_r4,3,4)) {
		MR_GOTO_LAB(erl_backend__elds_to_erlang__output_expr_6_0_i45);
	}
	MR_sv(1) = MR_r1;
	MR_sv(2) = MR_r2;
	MR_sv(3) = MR_r3;
	...
	MR_np_call_localret_ent(io__write_string_3_0,
		erl_backend__elds_to_erlang__output_expr_6_0_i46);
