...
MR_def_label(erl_backend__elds_to_erlang__output_pred_proc_id_4_0,2)
	...
	MR_sv(7) = MR_tfield(0, MR_r1, 11);
	MR_sv(8) = MR_tfield(0, MR_r1, 13);
	MR_r1 = MR_tempr1;
	MR_r2 = MR_tempr2;
	}
...
MR_def_label(erl_backend__elds_to_erlang__output_rtti_id_4_0,41)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(4) = ((MR_Integer) MR_r1 & (MR_Integer) 4294967295);
	MR_r1 = MR_sv(3);
	MR_r2 = (MR_Integer) 64;
	MR_np_call_localret_ent(fn__string__left_2_0,
...
MR_def_static(erl_backend__elds_to_erlang__output_elds_binop_3_0)
	...
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tempr1 = (MR_Word) &MR_tfield(0, (MR_Word *) &mercury_vector_common_8_1, (MR_Integer) MR_r1);
	MR_tempr2 = MR_r1;
