    ...
    switch (MR_tag((MR_Word) erl_backend__elds_to_erlang__Term_10)) {
      ...
      case (MR_Integer) 3:
        switch (((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), erl_backend__elds_to_erlang__Term_10, (MR_Integer) 0)))) {
          ...
          case (MR_Integer) 0:
            {
              MR_Integer erl_backend__elds_to_erlang__UInt_13 = ((MR_Integer) (MR_hl_field(MR_mktag(3), erl_backend__elds_to_erlang__Term_10, (MR_Integer) 1)));

              {
                mercury__io__write_int_3_p_0(erl_backend__elds_to_erlang__UInt_13);
              }
              {
                erl_backend__elds_to_erlang__space_2_p_0();
              }
