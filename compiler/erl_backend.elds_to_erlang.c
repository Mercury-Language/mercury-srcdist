...
{
  {
    MR_Word IsLocal_10 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ForeignDecl_7, (MR_Integer) 1))));
...
{
  {
    MR_Word LiteralOrInclude_12 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ForeignDecl_7, (MR_Integer) 2))));
    MR_Word Context_13 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ForeignDecl_7, (MR_Integer) 3))));
