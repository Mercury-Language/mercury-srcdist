...
MR_decl_label8(erl_backend__elds_to_erlang__digit_then_e_4_0, 48,2,8,7,6,13,12,1)
...
MR_BEGIN_MODULE(erl_backend__elds_to_erlang_module4)
	...
	MR_init_label8(erl_backend__elds_to_erlang__digit_then_e_4_0,48,2,8,7,6,13,12,1)
MR_BEGIN_CODE
...
MR_def_label(erl_backend__elds_to_erlang__digit_then_e_4_0,13)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(erl_backend__elds_to_erlang__digit_then_e_4_0_i12);
	}
	MR_r1 = MR_sv(1);
	MR_r2 = (MR_Integer) 1;
...
MR_def_label(erl_backend__elds_to_erlang__digit_then_e_4_0,12)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(1);
	MR_r2 = (MR_Integer) 0;
	MR_r3 = ((MR_Integer) MR_sv(3) + (MR_Integer) 1);
...
MR_decl_entry(fn__string__substring_3_0);
...
MR_def_label(erl_backend__elds_to_erlang__output_float_3_0,4)
	...
	MR_r2 = (MR_Integer) 0;
	MR_r3 = MR_sv(2);
	MR_np_call_localret_ent(fn__string__substring_3_0,
...
MR_def_label(erl_backend__elds_to_erlang__output_foreign_body_code_3_0,2)
	...
	MR_Word MR_tempr1;
	MR_tempr1 = MR_sv(2);
	MR_sv(2) = (MR_Word) MR_TAG_COMMON(0,2,7);
	MR_r1 = (MR_Word) MR_IO_CTOR_ADDR;
	MR_r2 = MR_sv(2);
	MR_r3 = MR_tempr1;
	}
...
MR_BEGIN_MODULE(erl_backend__elds_to_erlang_module55)
...
static void mercury__erl_backend__elds_to_erlang_maybe_bunch_1(void)
{
	...
	erl_backend__elds_to_erlang_module55();
}
