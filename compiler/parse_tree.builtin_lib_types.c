...
parse_tree__builtin_lib_types__stm_dummy_output_functor_0_f_0(void)
{
  ...
  Var_5 = mdbcomp__builtin_modules__mercury_stm_builtin_module_0_f_0();
  {
    ...
    MR_hl_field(1, Name_2, 0) = ((MR_Box) (Var_5));
    MR_hl_field(1, Name_2, 1) = ((MR_Box) ((MR_String) "stm_dummy_output"));
  }
  Var_9 = mdbcomp__builtin_modules__mercury_stm_builtin_module_0_f_0();
  {
    Name_7 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(1, Name_7, 0) = ((MR_Box) (Var_9));
    MR_hl_field(1, Name_7, 1) = ((MR_Box) ((MR_String) "stm_dummy_output"));
  }
  {
    TypeCtor_3 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(0, TypeCtor_3, 0) = ((MR_Box) (Name_7));
  ...
  }
  {
    ...
    MR_hl_field(3, HeadVar__1_1, 1) = ((MR_Box) (Name_2));
...
parse_tree__builtin_lib_types__stm_rollback_retry_functor_0_f_0(void)
{
  ...
  Var_9 = mdbcomp__builtin_modules__mercury_stm_builtin_module_0_f_0();
  {
    Name_7 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(1, Name_7, 0) = ((MR_Box) (Var_9));
    MR_hl_field(1, Name_7, 1) = ((MR_Box) ((MR_String) "rollback_exception"));
  }
  {
    TypeCtor_3 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(0, TypeCtor_3, 0) = ((MR_Box) (Name_7));
...
parse_tree__builtin_lib_types__stm_validres_invalid_functor_0_f_0(void)
{
  ...
  Var_9 = mdbcomp__builtin_modules__mercury_stm_builtin_module_0_f_0();
  {
    Name_7 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(1, Name_7, 0) = ((MR_Box) (Var_9));
    MR_hl_field(1, Name_7, 1) = ((MR_Box) ((MR_String) "stm_validation_result"));
  }
  {
    TypeCtor_3 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(0, TypeCtor_3, 0) = ((MR_Box) (Name_7));
...
parse_tree__builtin_lib_types__exception_exception_functor_0_f_0(void)
{
  ...
  Var_9 = mdbcomp__builtin_modules__mercury_exception_module_0_f_0();
  {
    Name_7 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(1, Name_7, 0) = ((MR_Box) (Var_9));
    MR_hl_field(1, Name_7, 1) = ((MR_Box) ((MR_String) "exception_result"));
  }
  {
    TypeCtor_3 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(0, TypeCtor_3, 0) = ((MR_Box) (Name_7));
  ...
  }
  {
    ...
    MR_hl_field(3, HeadVar__1_1, 0) = ((MR_Box) ((MR_Unsigned) 2U));
    MR_hl_field(3, HeadVar__1_1, 1) = ((MR_Box) (Name_2));
    MR_hl_field(3, HeadVar__1_1, 2) = ((MR_Box) ((MR_Integer) 1));
    MR_hl_field(3, HeadVar__1_1, 3) = ((MR_Box) (TypeCtor_3));
  }
  return HeadVar__1_1;
}
  ...
  if (succeeded)
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ModuleName_4 = ((MR_Word) ((MR_hl_field(1, Var_6, (MR_Integer) 0))));
  ...
  if (succeeded)
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ModuleName_4 = ((MR_Word) ((MR_hl_field(1, Var_7, (MR_Integer) 0))));
          TypeName_5 = ((MR_String) ((MR_hl_field(1, Var_7, (MR_Integer) 1))));
          Var_10 = mdbcomp__builtin_modules__mercury_private_builtin_module_0_f_0();
          succeeded = mdbcomp__sym_name____Unify____sym_name_0_0(ModuleName_4, Var_10);
          if (succeeded)
          {
...
parse_tree__builtin_lib_types__string_builder_state_type_0_f_0(void)
{
  ...
  Module_3 = mdbcomp__builtin_modules__mercury_std_lib_module_name_1_f_0(Var_6);
  {
    Name_2 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(1, Name_2, 0) = ((MR_Box) (Module_3));
    MR_hl_field(1, Name_2, 1) = ((MR_Box) ((MR_String) "state"));
