...
{
  {
          ...
          case (MR_Integer) 2:
            {
              ...
              libs__globals__lookup_bool_option_3_p_0(Globals_15, (MR_Integer) 259, &AllowDoubleWords_32);
                ...
                case (MR_Integer) 1:
                  {
                    ...
                    libs__globals__lookup_int_option_3_p_0(Globals_15, (MR_Integer) 252, &TargetWordBits_33);
                    libs__globals__lookup_bool_option_3_p_0(Globals_15, (MR_Integer) 236, &SinglePrec_34);
    ...
    libs__globals__lookup_int_option_3_p_0(Globals_15, (MR_Integer) 258, &ArgPackBits_22);
