...
{
  {
          ...
          case (MR_Integer) 2:
            {
              ...
              libs__globals__lookup_bool_option_3_p_0(Globals_15, (MR_Integer) 261, &AllowDoubleWords_32);
    ...
    libs__globals__lookup_int_option_3_p_0(Globals_15, (MR_Integer) 260, &ArgPackBits_22);
