                    ...
                    if (hlds__make_hlds__make_hlds_passes__du_type_layout__succeeded)
                      {
                        ...
                        hlds__make_hlds__make_hlds_passes__du_type_layout__Var_56 = (MR_Word) &hlds__make_hlds__make_hlds_passes__du_type_layout_scalar_common_4[0];
...
{
  {
          ...
          case (MR_Integer) 2:
            {
              ...
              {
                libs__globals__lookup_bool_option_3_p_0(hlds__make_hlds__make_hlds_passes__du_type_layout__Globals_15, (MR_Integer) 256, &hlds__make_hlds__make_hlds_passes__du_type_layout__AllowDoubleWords_32);
              }
                ...
                case (MR_Integer) 1:
                  {
                    ...
                    {
                      libs__globals__lookup_int_option_3_p_0(hlds__make_hlds__make_hlds_passes__du_type_layout__Globals_15, (MR_Integer) 249, &hlds__make_hlds__make_hlds_passes__du_type_layout__TargetWordBits_33);
                    }
                    {
                      libs__globals__lookup_bool_option_3_p_0(hlds__make_hlds__make_hlds_passes__du_type_layout__Globals_15, (MR_Integer) 233, &hlds__make_hlds__make_hlds_passes__du_type_layout__SinglePrec_34);
                    }
    ...
    {
      libs__globals__lookup_int_option_3_p_0(hlds__make_hlds__make_hlds_passes__du_type_layout__Globals_15, (MR_Integer) 255, &hlds__make_hlds__make_hlds_passes__du_type_layout__ArgPackBits_22);
    }
    ...
    if (hlds__make_hlds__make_hlds_passes__du_type_layout__succeeded)
      {
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(0), hlds__make_hlds__make_hlds_passes__du_type_layout__Var_45, 0) = ((MR_Box) (&hlds__make_hlds__make_hlds_passes__du_type_layout_scalar_common_2[0]));
      ...
      case (MR_Integer) 1:
        {
          ...
          {
            hlds__make_hlds__make_hlds_passes__du_type_layout__Var_30 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 5 * sizeof(MR_Word)), NULL, NULL);
            MR_hl_field(MR_mktag(0), hlds__make_hlds__make_hlds_passes__du_type_layout__Var_30, 0) = ((MR_Box) (&hlds__make_hlds__make_hlds_passes__du_type_layout_scalar_common_1[0]));
            MR_hl_field(MR_mktag(0), hlds__make_hlds__make_hlds_passes__du_type_layout__Var_30, 1) = ((MR_Box) (hlds__make_hlds__make_hlds_passes__du_type_layout__decide_du_type_layout_5_p_0_1));
            MR_hl_field(MR_mktag(0), hlds__make_hlds__make_hlds_passes__du_type_layout__Var_30, 2) = ((MR_Box) (MR_Word) ((MR_Integer) 2));
            MR_hl_field(MR_mktag(0), hlds__make_hlds__make_hlds_passes__du_type_layout__Var_30, 3) = ((MR_Box) (hlds__make_hlds__make_hlds_passes__du_type_layout__ModuleInfo_6));
            MR_hl_field(MR_mktag(0), hlds__make_hlds__make_hlds_passes__du_type_layout__Var_30, 4) = ((MR_Box) (hlds__make_hlds__make_hlds_passes__du_type_layout__DuKind_14));
          }
          ...
          {
            mercury__list__map_3_p_0(hlds__make_hlds__make_hlds_passes__du_type_layout__TypeCtorInfo_34_34, hlds__make_hlds__make_hlds_passes__du_type_layout__TypeCtorInfo_34_34, hlds__make_hlds__make_hlds_passes__du_type_layout__Var_30, hlds__make_hlds__make_hlds_passes__du_type_layout__Ctors0_11, &hlds__make_hlds__make_hlds_passes__du_type_layout__Ctors_20);
          }
          {
