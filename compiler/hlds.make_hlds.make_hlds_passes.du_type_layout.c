...
{
  {
          ...
          case (MR_Integer) 2:
            {
              ...
              libs__globals__lookup_bool_option_3_p_0(Globals_15, (MR_Integer) 263, &AllowDoubleWords_32);
                ...
                case (MR_Integer) 1:
                  {
                    ...
                    libs__globals__lookup_int_option_3_p_0(Globals_15, (MR_Integer) 255, &TargetWordBits_33);
                    libs__globals__lookup_bool_option_3_p_0(Globals_15, (MR_Integer) 239, &SinglePrec_34);
    ...
    libs__globals__lookup_int_option_3_p_0(Globals_15, (MR_Integer) 262, &ArgPackBits_22);
