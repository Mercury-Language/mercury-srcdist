...
{
  {
          ...
          case (MR_Integer) 2:
            {
              ...
              {
                libs__globals__lookup_bool_option_3_p_0(hlds__make_hlds__make_hlds_passes__du_type_layout__Globals_15, (MR_Integer) 252, &hlds__make_hlds__make_hlds_passes__du_type_layout__AllowDoubleWords_32);
              }
                ...
                case (MR_Integer) 1:
                  {
                    ...
                    {
                      libs__globals__lookup_int_option_3_p_0(hlds__make_hlds__make_hlds_passes__du_type_layout__Globals_15, (MR_Integer) 245, &hlds__make_hlds__make_hlds_passes__du_type_layout__TargetWordBits_33);
                    }
                    {
                      libs__globals__lookup_bool_option_3_p_0(hlds__make_hlds__make_hlds_passes__du_type_layout__Globals_15, (MR_Integer) 229, &hlds__make_hlds__make_hlds_passes__du_type_layout__SinglePrec_34);
                    }
    ...
    {
      libs__globals__lookup_int_option_3_p_0(hlds__make_hlds__make_hlds_passes__du_type_layout__Globals_15, (MR_Integer) 251, &hlds__make_hlds__make_hlds_passes__du_type_layout__ArgPackBits_22);
    }
