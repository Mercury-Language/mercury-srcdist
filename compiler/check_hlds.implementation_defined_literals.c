            ...
            case (MR_Integer) 1:
              {
                ...
                MR_Unsigned packed_word_3 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), RHS0_10, (MR_Integer) 1)));
            ...
            case (MR_Integer) 2:
              {
                ...
                MR_Unsigned packed_word_5 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), RHS0_10, (MR_Integer) 5)));
          ...
          case (MR_Integer) 4:
            {
              ...
              MR_Unsigned packed_word_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), GoalExpr0_7, (MR_Integer) 2)));
                ...
                case (MR_Integer) 1:
                  {
                    ...
                    MR_Word Var_121;
                    MR_Unsigned packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), Shorthand0_84, (MR_Integer) 0)));
