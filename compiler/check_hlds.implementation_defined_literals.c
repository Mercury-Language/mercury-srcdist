            ...
            case (MR_Integer) 1:
              {
                ...
                MR_Unsigned packed_args_3 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), RHS0_10, (MR_Integer) 1)));
            ...
            case (MR_Integer) 2:
              {
                ...
                MR_Unsigned packed_args_4 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), RHS0_10, (MR_Integer) 0)));
                MR_Unsigned packed_args_5 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), RHS0_10, (MR_Integer) 5)));
                ...
                check_hlds__implementation_defined_literals__subst_literals_in_goal_3_p_0(Info_4, LambdaGoal0_64, &LambdaGoal_65);
                {
                  ...
                  MR_hl_field(MR_mktag(2), RHS_66, 0) = (MR_Box) (packed_args_4);
                  ...
                  MR_hl_field(MR_mktag(2), RHS_66, 5) = (MR_Box) (packed_args_5);
          ...
          case (MR_Integer) 2:
            {
              ...
              mercury__list__map_3_p_0((MR_Word) (&hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_hlds_goal_0), (MR_Word) (&hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_hlds_goal_0), Var_124, Goals0_72, &Goals_73);
              {
                ...
                MR_hl_field(MR_mktag(3), GoalExpr_130, 1) = (MR_Box) (packed_args_0);
          ...
          case (MR_Integer) 4:
            {
              ...
              mercury__list__map_3_p_0((MR_Word) (&hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_case_0), (MR_Word) (&hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_case_0), Var_122, Cases0_75, &Cases_76);
              {
                ...
                MR_hl_field(MR_mktag(3), GoalExpr_135, 2) = (MR_Box) (packed_args_2);
                ...
                case (MR_Integer) 1:
                  {
                    ...
                    MR_Word Var_121;
                    MR_Unsigned packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), Shorthand0_84, (MR_Integer) 0)));
                    ...
                    mercury__list__map_3_p_0((MR_Word) (&hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_hlds_goal_0), (MR_Word) (&hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_hlds_goal_0), Var_121, OrElseGoals0_95, &OrElseGoals_98);
                    {
                      ...
                      MR_hl_field(MR_mktag(1), Shorthand_89, 0) = (MR_Box) (packed_args_1);
