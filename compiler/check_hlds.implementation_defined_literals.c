      ...
      case (MR_Integer) 1:
        {
          ...
          switch (MR_tag((MR_Word) RHS0_10)) {
            ...
            case (MR_Integer) 2:
              {
                MR_Word LambdaPurity_56 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(2), RHS0_10, (MR_Integer) 0))) & (MR_Integer) 3);
                MR_Word Groundness_57 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(2), RHS0_10, (MR_Integer) 0))) >> (MR_Integer) 2)) & (MR_Integer) 1);
                MR_Word PredOrFunc_58 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(2), RHS0_10, (MR_Integer) 0))) >> (MR_Integer) 3)) & (MR_Integer) 1);
                ...
                check_hlds__implementation_defined_literals__subst_literals_in_goal_3_p_0(Info_4, LambdaGoal0_64, &LambdaGoal_65);
                {
                  ...
                  MR_hl_field(MR_mktag(2), RHS_66, 0) = (MR_Box) (((MR_Unsigned) (((MR_Box) (LambdaPurity_56))) | (((((MR_Unsigned) (((MR_Box) (Groundness_57))) << (MR_Integer) 2)) | (((MR_Unsigned) (((MR_Box) (PredOrFunc_58))) << (MR_Integer) 3))))));
