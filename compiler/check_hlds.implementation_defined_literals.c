...
{
  {
    ...
    switch (MR_tag((MR_Word) GoalExpr0_7)) {
      ...
      case (MR_Integer) 0:
        {
          MR_Word SubGoal0_59 = (MR_Word) ((MR_Word) (GoalExpr0_7));
          MR_Word SubGoal_60;
          MR_Word GoalExpr_117;

          check_hlds__implementation_defined_literals__subst_literals_in_goal_3_p_0(Info_4, SubGoal0_59, &SubGoal_60);
          GoalExpr_117 = (MR_Word) ((MR_Word) (SubGoal_60));
          {
            MR_Word base;
      ...
      case (MR_Integer) 1:
        {
          ...
          switch (MR_tag((MR_Word) RHS0_10)) {
                ...
                switch (MR_tag((MR_Word) ConsId_14)) {
                  ...
                  case (MR_Integer) 3:
                    switch (((MR_Integer) ((MR_hl_field(MR_mktag(3), ConsId_14, (MR_Integer) 0))))) {
                      ...
                      case (MR_Integer) 9:
                        {
                          MR_Word IDCKind_17 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(3), ConsId_14, (MR_Integer) 1))) & (MR_Integer) 7);
                          MR_Word Context_18;
                          MR_Word Goal1_19;
                          MR_Word GoalExpr_20;

                          Context_18 = hlds__hlds_goal__goal_info_get_context_1_f_0(GoalInfo0_8);
                          check_hlds__implementation_defined_literals__make_impl_defined_literal_5_p_0(Var_9, IDCKind_17, Context_18, Info_4, &Goal1_19);
            ...
            case (MR_Integer) 2:
              {
                MR_Word LambdaNonLocals_51 = ((MR_Word) ((MR_hl_field(MR_mktag(2), RHS0_10, (MR_Integer) 2))));
                MR_Word LambdaQuantVars_52 = ((MR_Word) ((MR_hl_field(MR_mktag(2), RHS0_10, (MR_Integer) 3))));
                MR_Word LambdaModes_53 = ((MR_Word) ((MR_hl_field(MR_mktag(2), RHS0_10, (MR_Integer) 4))));
                MR_Word LambdaDetism_54 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(2), RHS0_10, (MR_Integer) 5))) & (MR_Integer) 7);
                MR_Word LambdaGoal0_55 = ((MR_Word) ((MR_hl_field(MR_mktag(2), RHS0_10, (MR_Integer) 6))));
                MR_Word LambdaGoal_56;
                MR_Word RHS_57;
                MR_Word GoalExpr_116;
                MR_Unsigned packed_word_5 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), RHS0_10, (MR_Integer) 0)));

                check_hlds__implementation_defined_literals__subst_literals_in_goal_3_p_0(Info_4, LambdaGoal0_55, &LambdaGoal_56);
                {
                  RHS_57 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, (7 * sizeof(MR_Word)), NULL, NULL));
                  MR_hl_field(MR_mktag(2), RHS_57, 0) = (MR_Box) (packed_word_5);
                  MR_hl_field(MR_mktag(2), RHS_57, 1) = NULL;
                  MR_hl_field(MR_mktag(2), RHS_57, 2) = ((MR_Box) (LambdaNonLocals_51));
                  MR_hl_field(MR_mktag(2), RHS_57, 3) = ((MR_Box) (LambdaQuantVars_52));
                  MR_hl_field(MR_mktag(2), RHS_57, 4) = ((MR_Box) (LambdaModes_53));
                  MR_hl_field(MR_mktag(2), RHS_57, 5) = (MR_Box) ((MR_Unsigned) (LambdaDetism_54));
                  MR_hl_field(MR_mktag(2), RHS_57, 6) = ((MR_Box) (LambdaGoal_56));
                }
                {
                  GoalExpr_116 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL));
                  MR_hl_field(MR_mktag(1), GoalExpr_116, 0) = ((MR_Box) (Var_9));
                  MR_hl_field(MR_mktag(1), GoalExpr_116, 1) = ((MR_Box) (RHS_57));
                  MR_hl_field(MR_mktag(1), GoalExpr_116, 2) = ((MR_Box) (Mode_11));
                  MR_hl_field(MR_mktag(1), GoalExpr_116, 3) = ((MR_Box) (Kind_12));
                  MR_hl_field(MR_mktag(1), GoalExpr_116, 4) = ((MR_Box) (UnifyContext_13));
                }
                {
                  MR_Word base;
                  base = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
      ...
      case (MR_Integer) 3:
        switch (((MR_Integer) ((MR_hl_field(MR_mktag(3), GoalExpr0_7, (MR_Integer) 0))))) {
          ...
          case (MR_Integer) 2:
            {
              MR_Word ConjType_62 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(3), GoalExpr0_7, (MR_Integer) 1))) & (MR_Integer) 1);
              MR_Word Goals0_63 = ((MR_Word) ((MR_hl_field(MR_mktag(3), GoalExpr0_7, (MR_Integer) 2))));
              MR_Word Goals_64;
              MR_Word Var_115;
...

              {
                ...
                MR_hl_field(MR_mktag(0), Var_115, 0) = ((MR_Box) (&check_hlds__implementation_defined_literals_scalar_common_2[1]));
                MR_hl_field(MR_mktag(0), Var_115, 1) = ((MR_Box) (check_hlds__implementation_defined_literals__subst_literals_in_goal_3_p_0_1));
                MR_hl_field(MR_mktag(0), Var_115, 2) = ((MR_Box) ((MR_Integer) 1));
                MR_hl_field(MR_mktag(0), Var_115, 3) = ((MR_Box) (Info_4));
              }
              mercury__list__map_3_p_0((MR_Word) (&hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_hlds_goal_0), (MR_Word) (&hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_hlds_goal_0), Var_115, Goals0_63, &Goals_64);
              {
                ...
                MR_hl_field(MR_mktag(3), GoalExpr_121, 1) = (MR_Box) ((MR_Unsigned) (ConjType_62));
                MR_hl_field(MR_mktag(3), GoalExpr_121, 2) = ((MR_Box) (Goals_64));
              }
              {
                MR_Word base;
                base = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
          ...
          case (MR_Integer) 3:
            {
              ...
              MR_Word Goals0_123 = ((MR_Word) ((MR_hl_field(MR_mktag(3), GoalExpr0_7, (MR_Integer) 1))));
              MR_Word Goals_124;

              {
                Var_114 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
                MR_hl_field(MR_mktag(0), Var_114, 0) = ((MR_Box) (&check_hlds__implementation_defined_literals_scalar_common_2[1]));
                MR_hl_field(MR_mktag(0), Var_114, 1) = ((MR_Box) (check_hlds__implementation_defined_literals__subst_literals_in_goal_3_p_0_2));
                MR_hl_field(MR_mktag(0), Var_114, 2) = ((MR_Box) ((MR_Integer) 1));
                MR_hl_field(MR_mktag(0), Var_114, 3) = ((MR_Box) (Info_4));
              }
              mercury__list__map_3_p_0((MR_Word) (&hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_hlds_goal_0), (MR_Word) (&hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_hlds_goal_0), Var_114, Goals0_123, &Goals_124);
              {
                GoalExpr_122 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), GoalExpr_122, 0) = ((MR_Box) ((MR_Unsigned) 3U));
                MR_hl_field(MR_mktag(3), GoalExpr_122, 1) = ((MR_Box) (Goals_124));
              }
              {
                MR_Word base;
                base = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
          ...
          case (MR_Integer) 4:
            {
              MR_Word CanFail_65 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(3), GoalExpr0_7, (MR_Integer) 2))) & (MR_Integer) 1);
              MR_Word Cases0_66 = ((MR_Word) ((MR_hl_field(MR_mktag(3), GoalExpr0_7, (MR_Integer) 3))));
              MR_Word Cases_67;
              MR_Word Var_113;
              MR_Word Var_125 = ((MR_Word) ((MR_hl_field(MR_mktag(3), GoalExpr0_7, (MR_Integer) 1))));
              MR_Word GoalExpr_126;

              {
                Var_113 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
                MR_hl_field(MR_mktag(0), Var_113, 0) = ((MR_Box) (&check_hlds__implementation_defined_literals_scalar_common_2[2]));
                MR_hl_field(MR_mktag(0), Var_113, 1) = ((MR_Box) (check_hlds__implementation_defined_literals__subst_literals_in_goal_3_p_0_4));
                MR_hl_field(MR_mktag(0), Var_113, 2) = ((MR_Box) ((MR_Integer) 1));
                MR_hl_field(MR_mktag(0), Var_113, 3) = ((MR_Box) (Info_4));
              }
              mercury__list__map_3_p_0((MR_Word) (&hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_case_0), (MR_Word) (&hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_case_0), Var_113, Cases0_66, &Cases_67);
              {
                ...
                MR_hl_field(MR_mktag(3), GoalExpr_126, 1) = ((MR_Box) (Var_125));
                MR_hl_field(MR_mktag(3), GoalExpr_126, 2) = (MR_Box) ((MR_Unsigned) (CanFail_65));
                MR_hl_field(MR_mktag(3), GoalExpr_126, 3) = ((MR_Box) (Cases_67));
              }
              {
                MR_Word base;
                base = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
          ...
          case (MR_Integer) 5:
            {
              MR_Word Reason_61 = ((MR_Word) ((MR_hl_field(MR_mktag(3), GoalExpr0_7, (MR_Integer) 1))));
              MR_Word GoalExpr_118;
              MR_Word SubGoal0_119 = ((MR_Word) ((MR_hl_field(MR_mktag(3), GoalExpr0_7, (MR_Integer) 2))));
              MR_Word SubGoal_120;

              check_hlds__implementation_defined_literals__subst_literals_in_goal_3_p_0(Info_4, SubGoal0_119, &SubGoal_120);
              {
                GoalExpr_118 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), GoalExpr_118, 0) = ((MR_Box) ((MR_Unsigned) 5U));
                MR_hl_field(MR_mktag(3), GoalExpr_118, 1) = ((MR_Box) (Reason_61));
                MR_hl_field(MR_mktag(3), GoalExpr_118, 2) = ((MR_Box) (SubGoal_120));
              }
              {
                MR_Word base;
                base = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
          ...
          case (MR_Integer) 6:
            {
              MR_Word Vars_68 = ((MR_Word) ((MR_hl_field(MR_mktag(3), GoalExpr0_7, (MR_Integer) 1))));
              MR_Word Cond0_69 = ((MR_Word) ((MR_hl_field(MR_mktag(3), GoalExpr0_7, (MR_Integer) 2))));
              MR_Word Then0_70 = ((MR_Word) ((MR_hl_field(MR_mktag(3), GoalExpr0_7, (MR_Integer) 3))));
              MR_Word Else0_71 = ((MR_Word) ((MR_hl_field(MR_mktag(3), GoalExpr0_7, (MR_Integer) 4))));
              MR_Word Cond_72;
              MR_Word Then_73;
              MR_Word Else_74;
              MR_Word GoalExpr_127;

              check_hlds__implementation_defined_literals__subst_literals_in_goal_3_p_0(Info_4, Cond0_69, &Cond_72);
              check_hlds__implementation_defined_literals__subst_literals_in_goal_3_p_0(Info_4, Then0_70, &Then_73);
              check_hlds__implementation_defined_literals__subst_literals_in_goal_3_p_0(Info_4, Else0_71, &Else_74);
              {
                GoalExpr_127 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), GoalExpr_127, 0) = ((MR_Box) ((MR_Unsigned) 6U));
                MR_hl_field(MR_mktag(3), GoalExpr_127, 1) = ((MR_Box) (Vars_68));
                MR_hl_field(MR_mktag(3), GoalExpr_127, 2) = ((MR_Box) (Cond_72));
                MR_hl_field(MR_mktag(3), GoalExpr_127, 3) = ((MR_Box) (Then_73));
                MR_hl_field(MR_mktag(3), GoalExpr_127, 4) = ((MR_Box) (Else_74));
              }
              {
                MR_Word base;
                base = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
          ...
          case (MR_Integer) 7:
            {
              MR_Word Shorthand0_75 = ((MR_Word) ((MR_hl_field(MR_mktag(3), GoalExpr0_7, (MR_Integer) 1))));
              ...
              switch (MR_tag((MR_Word) Shorthand0_75)) {
                ...
                case (MR_Integer) 0:
                  {
                    MR_Word A0_76 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Shorthand0_75, (MR_Integer) 0))));
                    MR_Word B0_77 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Shorthand0_75, (MR_Integer) 1))));
                    MR_Word A_78;
                    MR_Word B_79;

                    check_hlds__implementation_defined_literals__subst_literals_in_goal_3_p_0(Info_4, A0_76, &A_78);
                    check_hlds__implementation_defined_literals__subst_literals_in_goal_3_p_0(Info_4, B0_77, &B_79);
                    {
                      Shorthand_80 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
                      MR_hl_field(MR_mktag(0), Shorthand_80, 0) = ((MR_Box) (A_78));
                      MR_hl_field(MR_mktag(0), Shorthand_80, 1) = ((MR_Box) (B_79));
                    }
                  }
                  break;
                case (MR_Integer) 1:
                  {
                    MR_Word GoalType_81 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(1), Shorthand0_75, (MR_Integer) 0))) & (MR_Integer) 3);
                    MR_Word OuterVars_82 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Shorthand0_75, (MR_Integer) 1))));
                    MR_Word InnerVars_83 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Shorthand0_75, (MR_Integer) 2))));
                    MR_Word OutputVars_84 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Shorthand0_75, (MR_Integer) 3))));
                    ...
                    MR_Word OrElseInners_87 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Shorthand0_75, (MR_Integer) 6))));
                    MR_Word MainGoal_88;
                    MR_Word OrElseGoals_89;
                    MR_Word Var_112;

                    check_hlds__implementation_defined_literals__subst_literals_in_goal_3_p_0(Info_4, MainGoal0_85, &MainGoal_88);
                    {
                      Var_112 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
                      MR_hl_field(MR_mktag(0), Var_112, 0) = ((MR_Box) (&check_hlds__implementation_defined_literals_scalar_common_2[1]));
                      MR_hl_field(MR_mktag(0), Var_112, 1) = ((MR_Box) (check_hlds__implementation_defined_literals__subst_literals_in_goal_3_p_0_3));
                      MR_hl_field(MR_mktag(0), Var_112, 2) = ((MR_Box) ((MR_Integer) 1));
                      MR_hl_field(MR_mktag(0), Var_112, 3) = ((MR_Box) (Info_4));
                    }
                    mercury__list__map_3_p_0((MR_Word) (&hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_hlds_goal_0), (MR_Word) (&hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_hlds_goal_0), Var_112, OrElseGoals0_86, &OrElseGoals_89);
                    {
                      Shorthand_80 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (7 * sizeof(MR_Word)), NULL, NULL));
                      MR_hl_field(MR_mktag(1), Shorthand_80, 0) = (MR_Box) ((MR_Unsigned) (GoalType_81));
                      MR_hl_field(MR_mktag(1), Shorthand_80, 1) = ((MR_Box) (OuterVars_82));
                      MR_hl_field(MR_mktag(1), Shorthand_80, 2) = ((MR_Box) (InnerVars_83));
                      MR_hl_field(MR_mktag(1), Shorthand_80, 3) = ((MR_Box) (OutputVars_84));
                      MR_hl_field(MR_mktag(1), Shorthand_80, 4) = ((MR_Box) (MainGoal_88));
                      MR_hl_field(MR_mktag(1), Shorthand_80, 5) = ((MR_Box) (OrElseGoals_89));
                      MR_hl_field(MR_mktag(1), Shorthand_80, 6) = ((MR_Box) (OrElseInners_87));
                    }
                  }
                  break;
                case (MR_Integer) 2:
                  {
                    MR_Word MaybeIOVars_90 = ((MR_Word) ((MR_hl_field(MR_mktag(2), Shorthand0_75, (MR_Integer) 0))));
                    MR_Word ResultVar_91 = ((MR_Word) ((MR_hl_field(MR_mktag(2), Shorthand0_75, (MR_Integer) 1))));
                    MR_Word TryGoal0_92 = ((MR_Word) ((MR_hl_field(MR_mktag(2), Shorthand0_75, (MR_Integer) 2))));
                    MR_Word TryGoal_93;

                    check_hlds__implementation_defined_literals__subst_literals_in_goal_3_p_0(Info_4, TryGoal0_92, &TryGoal_93);
                    {
                      Shorthand_80 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
                      MR_hl_field(MR_mktag(2), Shorthand_80, 0) = ((MR_Box) (MaybeIOVars_90));
                      MR_hl_field(MR_mktag(2), Shorthand_80, 1) = ((MR_Box) (ResultVar_91));
                      MR_hl_field(MR_mktag(2), Shorthand_80, 2) = ((MR_Box) (TryGoal_93));
                    }
                  }
                  break;
              }
              {
                ...
                MR_hl_field(MR_mktag(3), GoalExpr_128, 0) = ((MR_Box) ((MR_Unsigned) 7U));
                MR_hl_field(MR_mktag(3), GoalExpr_128, 1) = ((MR_Box) (Shorthand_80));
              }
              {
                MR_Word base;
                base = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
      ...
      case (MR_Integer) 3:
        {
          ...
          Str_20 = hlds__hlds_out__hlds_out_util__pred_id_to_string_2_f_0(ModuleInfo_13, PredId_15);
          hlds__make_goal__make_string_const_construction_4_p_0(Context_8, Var_6, Str_20, Goal_10);
        }
        break;
    }
  }
