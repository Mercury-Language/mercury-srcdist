  ...
  switch (MR_tag((MR_Word) GoalExpr0_7)) {
                    ...
                    case (MR_Integer) 9:
                      {
                        ...
                        File_140 = ((MR_String) ((MR_hl_field(MR_mktag(0), Context_18, (MR_Integer) 0))));
                        Line_141 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), Context_18, (MR_Integer) 1))));
                        ModuleInfo_142 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Info_4, (MR_Integer) 0))));
                        PredInfo_143 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Info_4, (MR_Integer) 1))));
                        PredId_144 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Info_4, (MR_Integer) 2))));
                        switch (IDCKind_17) {
                          default: /*NOTREACHED*/ MR_assert(0);
                          case (MR_Integer) 0:
                          ...
                          case (MR_Integer) 3:
                            {
                              ...
                              Str_149 = hlds__hlds_out__hlds_out_util__pred_id_to_string_2_f_0(ModuleInfo_142, PredId_144);
          ...
          case (MR_Integer) 2:
            {
              ...
              MR_Word LambdaArgVarsModes_52 = ((MR_Word) ((MR_hl_field(MR_mktag(2), RHS0_10, (MR_Integer) 3))));
              MR_Word LambdaDetism_53 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(2), RHS0_10, (MR_Integer) 4))) & (MR_Integer) 7);
              MR_Word LambdaGoal0_54 = ((MR_Word) ((MR_hl_field(MR_mktag(2), RHS0_10, (MR_Integer) 5))));
              ...
              check_hlds__implementation_defined_literals__subst_literals_in_goal_3_p_0(Info_4, LambdaGoal0_54, &LambdaGoal_55);
              {
                ...
                MR_hl_field(MR_mktag(2), RHS_56, 0) = (MR_Box) (packed_word_5);
                MR_hl_field(MR_mktag(2), RHS_56, 1) = NULL;
                MR_hl_field(MR_mktag(2), RHS_56, 2) = ((MR_Box) (LambdaNonLocals_51));
                MR_hl_field(MR_mktag(2), RHS_56, 3) = ((MR_Box) (LambdaArgVarsModes_52));
                MR_hl_field(MR_mktag(2), RHS_56, 4) = (MR_Box) ((MR_Unsigned) (LambdaDetism_53));
                MR_hl_field(MR_mktag(2), RHS_56, 5) = ((MR_Box) (LambdaGoal_55));
              }
              {
                GoalExpr_115 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(1), GoalExpr_115, 0) = ((MR_Box) (Var_9));
                MR_hl_field(MR_mktag(1), GoalExpr_115, 1) = ((MR_Box) (RHS_56));
                MR_hl_field(MR_mktag(1), GoalExpr_115, 2) = ((MR_Box) (Mode_11));
                MR_hl_field(MR_mktag(1), GoalExpr_115, 3) = ((MR_Box) (Kind_12));
                MR_hl_field(MR_mktag(1), GoalExpr_115, 4) = ((MR_Box) (UnifyContext_13));
              }
              {
                MR_Word base;
                base = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
    ...
    case (MR_Integer) 3:
      switch (((MR_Integer) ((MR_hl_field(MR_mktag(3), GoalExpr0_7, (MR_Integer) 0))))) {
        ...
        case (MR_Integer) 2:
          {
            MR_Word ConjType_61 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(3), GoalExpr0_7, (MR_Integer) 1))) & (MR_Integer) 1);
            MR_Word Goals0_62 = ((MR_Word) ((MR_hl_field(MR_mktag(3), GoalExpr0_7, (MR_Integer) 2))));
            MR_Word Goals_63;
            MR_Word Var_114;
...

            {
              ...
              MR_hl_field(MR_mktag(0), Var_114, 1) = ((MR_Box) (check_hlds__implementation_defined_literals__subst_literals_in_goal_3_p_0_1));
              MR_hl_field(MR_mktag(0), Var_114, 2) = ((MR_Box) ((MR_Integer) 1));
              MR_hl_field(MR_mktag(0), Var_114, 3) = ((MR_Box) (Info_4));
            }
            mercury__list__map_3_p_0((MR_Word) (&hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_hlds_goal_0), (MR_Word) (&hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_hlds_goal_0), Var_114, Goals0_62, &Goals_63);
            {
              GoalExpr_120 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(3), GoalExpr_120, 0) = ((MR_Box) ((MR_Unsigned) 2U));
              MR_hl_field(MR_mktag(3), GoalExpr_120, 1) = (MR_Box) ((MR_Unsigned) (ConjType_61));
              MR_hl_field(MR_mktag(3), GoalExpr_120, 2) = ((MR_Box) (Goals_63));
            }
            {
              MR_Word base;
              base = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
        ...
        case (MR_Integer) 3:
          {
            ...
            MR_Word Goals0_122 = ((MR_Word) ((MR_hl_field(MR_mktag(3), GoalExpr0_7, (MR_Integer) 1))));
            MR_Word Goals_123;

            {
              Var_113 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
              MR_hl_field(MR_mktag(0), Var_113, 0) = ((MR_Box) (&check_hlds__implementation_defined_literals_scalar_common_2[1]));
              MR_hl_field(MR_mktag(0), Var_113, 1) = ((MR_Box) (check_hlds__implementation_defined_literals__subst_literals_in_goal_3_p_0_2));
              MR_hl_field(MR_mktag(0), Var_113, 2) = ((MR_Box) ((MR_Integer) 1));
              MR_hl_field(MR_mktag(0), Var_113, 3) = ((MR_Box) (Info_4));
            }
            mercury__list__map_3_p_0((MR_Word) (&hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_hlds_goal_0), (MR_Word) (&hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_hlds_goal_0), Var_113, Goals0_122, &Goals_123);
            {
              GoalExpr_121 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(3), GoalExpr_121, 0) = ((MR_Box) ((MR_Unsigned) 3U));
              MR_hl_field(MR_mktag(3), GoalExpr_121, 1) = ((MR_Box) (Goals_123));
            }
            {
              MR_Word base;
              base = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
        ...
        case (MR_Integer) 4:
          {
            MR_Word CanFail_64 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(3), GoalExpr0_7, (MR_Integer) 2))) & (MR_Integer) 1);
            MR_Word Cases0_65 = ((MR_Word) ((MR_hl_field(MR_mktag(3), GoalExpr0_7, (MR_Integer) 3))));
            MR_Word Cases_66;
            MR_Word Var_112;
            MR_Word Var_124 = ((MR_Word) ((MR_hl_field(MR_mktag(3), GoalExpr0_7, (MR_Integer) 1))));
            MR_Word GoalExpr_125;

            {
              Var_112 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
              MR_hl_field(MR_mktag(0), Var_112, 0) = ((MR_Box) (&check_hlds__implementation_defined_literals_scalar_common_2[2]));
              MR_hl_field(MR_mktag(0), Var_112, 1) = ((MR_Box) (check_hlds__implementation_defined_literals__subst_literals_in_goal_3_p_0_4));
              MR_hl_field(MR_mktag(0), Var_112, 2) = ((MR_Box) ((MR_Integer) 1));
              MR_hl_field(MR_mktag(0), Var_112, 3) = ((MR_Box) (Info_4));
            }
            mercury__list__map_3_p_0((MR_Word) (&hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_case_0), (MR_Word) (&hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_case_0), Var_112, Cases0_65, &Cases_66);
            {
              ...
              MR_hl_field(MR_mktag(3), GoalExpr_125, 1) = ((MR_Box) (Var_124));
              MR_hl_field(MR_mktag(3), GoalExpr_125, 2) = (MR_Box) ((MR_Unsigned) (CanFail_64));
              MR_hl_field(MR_mktag(3), GoalExpr_125, 3) = ((MR_Box) (Cases_66));
            }
            {
              MR_Word base;
              base = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
        ...
        case (MR_Integer) 5:
          {
            MR_Word Reason_60 = ((MR_Word) ((MR_hl_field(MR_mktag(3), GoalExpr0_7, (MR_Integer) 1))));
            MR_Word GoalExpr_117;
            MR_Word SubGoal0_118 = ((MR_Word) ((MR_hl_field(MR_mktag(3), GoalExpr0_7, (MR_Integer) 2))));
            MR_Word SubGoal_119;
            ...
            check_hlds__implementation_defined_literals__subst_literals_in_goal_3_p_0(Info_4, SubGoal0_118, &SubGoal_119);
            {
              ...
              MR_hl_field(MR_mktag(3), GoalExpr_117, 1) = ((MR_Box) (Reason_60));
              MR_hl_field(MR_mktag(3), GoalExpr_117, 2) = ((MR_Box) (SubGoal_119));
            }
            {
              MR_Word base;
              base = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
        ...
        case (MR_Integer) 6:
          {
            MR_Word Vars_67 = ((MR_Word) ((MR_hl_field(MR_mktag(3), GoalExpr0_7, (MR_Integer) 1))));
            MR_Word Cond0_68 = ((MR_Word) ((MR_hl_field(MR_mktag(3), GoalExpr0_7, (MR_Integer) 2))));
            MR_Word Then0_69 = ((MR_Word) ((MR_hl_field(MR_mktag(3), GoalExpr0_7, (MR_Integer) 3))));
            MR_Word Else0_70 = ((MR_Word) ((MR_hl_field(MR_mktag(3), GoalExpr0_7, (MR_Integer) 4))));
            MR_Word Cond_71;
            MR_Word Then_72;
            MR_Word Else_73;
            ...
            {
              GoalExpr_126 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(3), GoalExpr_126, 0) = ((MR_Box) ((MR_Unsigned) 6U));
              MR_hl_field(MR_mktag(3), GoalExpr_126, 1) = ((MR_Box) (Vars_67));
              MR_hl_field(MR_mktag(3), GoalExpr_126, 2) = ((MR_Box) (Cond_71));
              MR_hl_field(MR_mktag(3), GoalExpr_126, 3) = ((MR_Box) (Then_72));
              MR_hl_field(MR_mktag(3), GoalExpr_126, 4) = ((MR_Box) (Else_73));
            }
            {
              MR_Word base;
              base = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
        ...
        case (MR_Integer) 7:
          {
            MR_Word Shorthand0_74 = ((MR_Word) ((MR_hl_field(MR_mktag(3), GoalExpr0_7, (MR_Integer) 1))));
            ...
            switch (MR_tag((MR_Word) Shorthand0_74)) {
              ...
              case (MR_Integer) 0:
                {
                  MR_Word A0_75 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Shorthand0_74, (MR_Integer) 0))));
                  MR_Word B0_76 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Shorthand0_74, (MR_Integer) 1))));
                  MR_Word A_77;
                  MR_Word B_78;
                  ...
                  check_hlds__implementation_defined_literals__subst_literals_in_goal_3_p_0(Info_4, B0_76, &B_78);
                  {
                    ...
                    MR_hl_field(MR_mktag(0), Shorthand_79, 0) = ((MR_Box) (A_77));
                    MR_hl_field(MR_mktag(0), Shorthand_79, 1) = ((MR_Box) (B_78));
                  }
                }
                break;
              case (MR_Integer) 1:
                {
                  MR_Word GoalType_80 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(1), Shorthand0_74, (MR_Integer) 0))) & (MR_Integer) 3);
                  MR_Word OuterVars_81 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Shorthand0_74, (MR_Integer) 1))));
                  MR_Word InnerVars_82 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Shorthand0_74, (MR_Integer) 2))));
                  MR_Word OutputVars_83 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Shorthand0_74, (MR_Integer) 3))));
                  MR_Word MainGoal0_84 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Shorthand0_74, (MR_Integer) 4))));
                  MR_Word OrElseGoals0_85 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Shorthand0_74, (MR_Integer) 5))));
                  MR_Word OrElseInners_86 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Shorthand0_74, (MR_Integer) 6))));
                  MR_Word MainGoal_87;
                  ...
                  check_hlds__implementation_defined_literals__subst_literals_in_goal_3_p_0(Info_4, MainGoal0_84, &MainGoal_87);
                  {
                    ...
                    MR_hl_field(MR_mktag(0), Var_111, 0) = ((MR_Box) (&check_hlds__implementation_defined_literals_scalar_common_2[1]));
                    MR_hl_field(MR_mktag(0), Var_111, 1) = ((MR_Box) (check_hlds__implementation_defined_literals__subst_literals_in_goal_3_p_0_3));
                    MR_hl_field(MR_mktag(0), Var_111, 2) = ((MR_Box) ((MR_Integer) 1));
                    MR_hl_field(MR_mktag(0), Var_111, 3) = ((MR_Box) (Info_4));
                  }
                  mercury__list__map_3_p_0((MR_Word) (&hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_hlds_goal_0), (MR_Word) (&hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_hlds_goal_0), Var_111, OrElseGoals0_85, &OrElseGoals_88);
                  {
                    Shorthand_79 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (7 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(MR_mktag(1), Shorthand_79, 0) = (MR_Box) ((MR_Unsigned) (GoalType_80));
                    MR_hl_field(MR_mktag(1), Shorthand_79, 1) = ((MR_Box) (OuterVars_81));
                    MR_hl_field(MR_mktag(1), Shorthand_79, 2) = ((MR_Box) (InnerVars_82));
                    MR_hl_field(MR_mktag(1), Shorthand_79, 3) = ((MR_Box) (OutputVars_83));
                    MR_hl_field(MR_mktag(1), Shorthand_79, 4) = ((MR_Box) (MainGoal_87));
                    MR_hl_field(MR_mktag(1), Shorthand_79, 5) = ((MR_Box) (OrElseGoals_88));
                    MR_hl_field(MR_mktag(1), Shorthand_79, 6) = ((MR_Box) (OrElseInners_86));
                  }
                }
                break;
              case (MR_Integer) 2:
                {
                  MR_Word MaybeIOVars_89 = ((MR_Word) ((MR_hl_field(MR_mktag(2), Shorthand0_74, (MR_Integer) 0))));
                  MR_Word ResultVar_90 = ((MR_Word) ((MR_hl_field(MR_mktag(2), Shorthand0_74, (MR_Integer) 1))));
                  MR_Word TryGoal0_91 = ((MR_Word) ((MR_hl_field(MR_mktag(2), Shorthand0_74, (MR_Integer) 2))));
                  MR_Word TryGoal_92;

                  check_hlds__implementation_defined_literals__subst_literals_in_goal_3_p_0(Info_4, TryGoal0_91, &TryGoal_92);
                  {
                    Shorthand_79 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(MR_mktag(2), Shorthand_79, 0) = ((MR_Box) (MaybeIOVars_89));
                    MR_hl_field(MR_mktag(2), Shorthand_79, 1) = ((MR_Box) (ResultVar_90));
                    MR_hl_field(MR_mktag(2), Shorthand_79, 2) = ((MR_Box) (TryGoal_92));
                  }
                }
                break;
            }
            {
              ...
              MR_hl_field(MR_mktag(3), GoalExpr_127, 0) = ((MR_Box) ((MR_Unsigned) 7U));
              MR_hl_field(MR_mktag(3), GoalExpr_127, 1) = ((MR_Box) (Shorthand_79));
            }
            {
              MR_Word base;
              base = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
