        ...
        case (MR_Integer) 2:
          {
...

            {
              ...
              MR_hl_field(MR_mktag(0), Var_111, 1) = ((MR_Box) (check_hlds__implementation_defined_literals__subst_literals_in_goal_3_p_0_1));
        ...
        case (MR_Integer) 3:
          {
...

            {
              ...
              MR_hl_field(MR_mktag(0), Var_112, 1) = ((MR_Box) (check_hlds__implementation_defined_literals__subst_literals_in_goal_3_p_0_2));
              ...
              case (MR_Integer) 1:
                {
                  ...
                  check_hlds__implementation_defined_literals__subst_literals_in_goal_3_p_0(Info_4, MainGoal0_84, &MainGoal_87);
                  {
                    ...
                    MR_hl_field(MR_mktag(0), Var_114, 1) = ((MR_Box) (check_hlds__implementation_defined_literals__subst_literals_in_goal_3_p_0_3));
