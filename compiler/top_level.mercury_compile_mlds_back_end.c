...
{
  {
    ...
    {
      libs__globals__lookup_accumulating_option_3_p_0(top_level__mercury_compile_mlds_back_end__Globals_7, (MR_Integer) 169, &top_level__mercury_compile_mlds_back_end__VerboseDumpStages_14);
    }
    {
...
{
  {
    ...
    {
      libs__globals__lookup_bool_option_3_p_0(top_level__mercury_compile_mlds_back_end__Globals_8, (MR_Integer) 287, &top_level__mercury_compile_mlds_back_end__NewTypeClassRtti_9);
    }
    {
...
{
  {
    ...
    {
      libs__globals__lookup_bool_option_3_p_0(top_level__mercury_compile_mlds_back_end__Globals_11, (MR_Integer) 311, &top_level__mercury_compile_mlds_back_end__SemidetReclaim_13);
    }
    {
      libs__globals__lookup_bool_option_3_p_0(top_level__mercury_compile_mlds_back_end__Globals_11, (MR_Integer) 312, &top_level__mercury_compile_mlds_back_end__NondetReclaim_14);
    }
    {
...
{
  {
    ...
    {
      libs__globals__lookup_bool_option_3_p_0(top_level__mercury_compile_mlds_back_end__Globals_11, (MR_Integer) 228, &top_level__mercury_compile_mlds_back_end__UseTrail_12);
    }
      ...
      case (MR_Integer) 1:
        {
          ...
          {
            libs__globals__lookup_bool_option_3_p_0(top_level__mercury_compile_mlds_back_end__Globals_11, (MR_Integer) 293, &top_level__mercury_compile_mlds_back_end__DisableTrailOps_14);
          }
            ...
            case (MR_Integer) 0:
              {
                ...
                {
                  libs__globals__lookup_bool_option_3_p_0(top_level__mercury_compile_mlds_back_end__Globals_11, (MR_Integer) 402, &top_level__mercury_compile_mlds_back_end__OptTrailUse_15);
                }
                {
                ...
                switch (top_level__mercury_compile_mlds_back_end__Target_16) {
                  ...
                  case (MR_Integer) 0:
                    {
                      {
                        libs__globals__lookup_bool_option_3_p_0(top_level__mercury_compile_mlds_back_end__Globals_11, (MR_Integer) 466, &top_level__mercury_compile_mlds_back_end__GenerateInline_17);
                      }
                    }
                    break;
                  case (MR_Integer) 1:
...
{
  {
    ...
    {
      libs__globals__lookup_bool_option_3_p_0(top_level__mercury_compile_mlds_back_end__Globals_11, (MR_Integer) 456, &top_level__mercury_compile_mlds_back_end__SGCells_12);
    }
...
{
  {
    ...
    {
      libs__globals__lookup_bool_option_3_p_0(top_level__mercury_compile_mlds_back_end__Globals_14, (MR_Integer) 463, &top_level__mercury_compile_mlds_back_end__OptimizeTailCalls_18);
    }
    ...
    {
      libs__globals__lookup_bool_option_3_p_0(top_level__mercury_compile_mlds_back_end__Globals_14, (MR_Integer) 469, &top_level__mercury_compile_mlds_back_end__Optimize_19);
    }
      ...
      case (MR_Integer) 1:
        {
          ...
          {
            libs__globals__set_option_4_p_0((MR_Integer) 464, (MR_Word) MR_mkword(MR_mktag(1), &top_level__mercury_compile_mlds_back_end_scalar_common_3[0]), top_level__mercury_compile_mlds_back_end__Globals_14, &top_level__mercury_compile_mlds_back_end__NoInitOptGlobals_20);
          }
          {
    ...
    {
      libs__globals__lookup_bool_option_3_p_0(top_level__mercury_compile_mlds_back_end__Globals_14, (MR_Integer) 265, &top_level__mercury_compile_mlds_back_end__NestedFuncs_22);
    }
