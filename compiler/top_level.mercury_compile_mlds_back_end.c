...
{
  {
    ...
    Var_45 = parse_tree__error_util__contains_errors_2_f_0(Globals_14, SimplifySpecs_17);
    {
      ...
      MR_hl_field(MR_mktag(0), Var_41, 0) = ((MR_Box) (&top_level__mercury_compile_mlds_back_end_scalar_common_6[1]));
...
{
  {
    ...
    succeeded = ml_backend__mlds_to_c__func_defn_has_name_in_list_2_p_0(((MR_Word) (MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3))), ((MR_Word) wrapper_arg_1));
    return succeeded;
  }
}
...
{
  {
    ...
    if (succeeded)
    {
      ...
      if ((DumpPredNames_15 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
      {
        ...
        ml_backend__mlds_to_c__output_c_mlds_6_p_0(MLDS_8, Globals_7, DumpSuffix_18, &_Succeeded_19);
      }
      else
        ml_backend__mlds_to_c__output_c_dump_preds_6_p_0(MLDS_8, Globals_7, DumpSuffix_18, DumpPredNames_15);
    ...
    if (succeeded)
    {
      ...
      else
      {
        ...
        MR_Word Var_47;
        MR_Word Var_61 = ((MR_Word) (MR_hl_field(MR_mktag(0), MLDS_8, (MR_Integer) 0)));
        MR_Word Var_62 = ((MR_Word) (MR_hl_field(MR_mktag(0), MLDS_8, (MR_Integer) 1)));
        MR_Word Var_63 = ((MR_Word) (MR_hl_field(MR_mktag(0), MLDS_8, (MR_Integer) 2)));
        MR_Word Var_64 = ((MR_Word) (MR_hl_field(MR_mktag(0), MLDS_8, (MR_Integer) 3)));
        MR_Word Var_65 = ((MR_Word) (MR_hl_field(MR_mktag(0), MLDS_8, (MR_Integer) 4)));
        MR_Word Var_66 = ((MR_Word) (MR_hl_field(MR_mktag(0), MLDS_8, (MR_Integer) 6)));
        MR_Word Var_67 = ((MR_Word) (MR_hl_field(MR_mktag(0), MLDS_8, (MR_Integer) 7)));
        MR_Word Var_68 = ((MR_Word) (MR_hl_field(MR_mktag(0), MLDS_8, (MR_Integer) 8)));
        MR_Word Var_69 = ((MR_Word) (MR_hl_field(MR_mktag(0), MLDS_8, (MR_Integer) 9)));
