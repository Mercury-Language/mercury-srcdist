...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_10, (MR_Integer) 73, &Stats_12);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_6, (MR_Integer) 63, &Verbose_10);
    libs__globals__lookup_bool_option_3_p_0(Globals_6, (MR_Integer) 73, &Stats_11);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_14, (MR_Integer) 63, &Verbose_15);
    libs__globals__lookup_bool_option_3_p_0(Globals_14, (MR_Integer) 73, &Stats_16);
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_14, (MR_Integer) 492, &Optimize_20);
    switch (Optimize_20) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
      ...
      case (MR_Integer) 1:
        {
          ...
          libs__globals__set_option_4_p_0((MR_Integer) 486, (MR_Word) (MR_mkword(MR_mktag(1), &top_level__mercury_compile_mlds_back_end_scalar_common_4[2])), Globals_14, &NoInitOptGlobals_21);
...
{
  {
    ...
    libs__globals__lookup_accumulating_option_3_p_0(Globals_7, (MR_Integer) 180, &DumpStages_13);
    libs__globals__lookup_accumulating_option_3_p_0(Globals_7, (MR_Integer) 182, &VerboseDumpStages_14);
    libs__globals__lookup_accumulating_option_3_p_0(Globals_7, (MR_Integer) 181, &DumpPredNames_15);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_10, (MR_Integer) 306, &NewTypeClassRtti_11);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_14, (MR_Integer) 485, &OptimizeTailCalls_15);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 330, &SemidetReclaim_13);
    libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 331, &NondetReclaim_14);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 242, &UseTrail_12);
    switch (UseTrail_12) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
      ...
      case (MR_Integer) 1:
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 312, &DisableTrailOps_14);
            ...
            case (MR_Integer) 0:
              {
                ...
                libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 423, &OptTrailUse_15);
                libs__globals__get_target_2_p_0(Globals_11, &Target_16);
                switch (Target_16) {
                  default: /*NOTREACHED*/ MR_assert(0);
                  case (MR_Integer) 0:
                    libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 489, &GenerateInline_17);
                    break;
                  case (MR_Integer) 1:
                  case (MR_Integer) 3:
                  case (MR_Integer) 2:
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 477, &SGCells_12);
    switch (SGCells_12) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
