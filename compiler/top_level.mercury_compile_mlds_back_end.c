...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_10, (MR_Integer) 57, &Verbose_11);
    libs__globals__lookup_bool_option_3_p_0(Globals_10, (MR_Integer) 67, &Stats_12);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_6, (MR_Integer) 57, &Verbose_10);
    libs__globals__lookup_bool_option_3_p_0(Globals_6, (MR_Integer) 67, &Stats_11);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_14, (MR_Integer) 57, &Verbose_15);
    libs__globals__lookup_bool_option_3_p_0(Globals_14, (MR_Integer) 67, &Stats_16);
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_14, (MR_Integer) 465, &OptimizeTailCalls_20);
    libs__globals__lookup_bool_option_3_p_0(Globals_14, (MR_Integer) 466, &OptimizeTailCallsCodegen_21);
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_14, (MR_Integer) 473, &Optimize_23);
    switch (Optimize_23) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
      ...
      case (MR_Integer) 1:
        {
          ...
          libs__globals__set_option_4_p_0((MR_Integer) 468, (MR_Word) MR_mkword(MR_mktag(1), &top_level__mercury_compile_mlds_back_end_scalar_common_4[2]), Globals_14, &NoInitOptGlobals_24);
...
{
  {
    ...
    libs__globals__lookup_accumulating_option_3_p_0(Globals_7, (MR_Integer) 169, &DumpStages_13);
    libs__globals__lookup_accumulating_option_3_p_0(Globals_7, (MR_Integer) 171, &VerboseDumpStages_14);
    libs__globals__lookup_accumulating_option_3_p_0(Globals_7, (MR_Integer) 170, &DumpPredNames_15);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_14, (MR_Integer) 465, &OptimizeTailCalls_15);
    libs__globals__lookup_bool_option_3_p_0(Globals_14, (MR_Integer) 466, &OptimizeTailCallsCodegen_16);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 230, &UseTrail_12);
    switch (UseTrail_12) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        *STATE_VARIABLE_HLDS_19 = STATE_VARIABLE_HLDS_0_18;
            ...
            case (MR_Integer) 0:
              {
                ...
                libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 404, &OptTrailUse_15);
                libs__globals__get_target_2_p_0(Globals_11, &Target_16);
                switch (Target_16) {
                  default: /*NOTREACHED*/ MR_assert(0);
                  case (MR_Integer) 0:
                    {
                      libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 470, &GenerateInline_17);
                    }
                    break;
                  case (MR_Integer) 1:
                  case (MR_Integer) 3:
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 458, &SGCells_12);
    switch (SGCells_12) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
