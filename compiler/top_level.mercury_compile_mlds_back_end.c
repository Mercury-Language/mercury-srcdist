...
{
  {
    ...
    MR_Word STATE_VARIABLE_MLDS_87_87;
    MR_Word STATE_VARIABLE_Specs_89_89;
    MR_Word STATE_VARIABLE_MLDS_102_102;
    MR_Word STATE_VARIABLE_MLDS_113_113;
    MR_Word STATE_VARIABLE_MLDS_127_127;
    MR_Word STATE_VARIABLE_MLDS_137_137;
    MR_Word STATE_VARIABLE_MLDS_147_147;

    hlds__hlds_module__module_info_get_globals_2_p_0(STATE_VARIABLE_HLDS_0_26, &Globals_14);
    ...
    top_level__mercury_compile_front_end__maybe_simplify_10_p_0((MR_Integer) 0, (MR_Integer) 4, Verbose_15, Stats_16, STATE_VARIABLE_HLDS_0_26, &STATE_VARIABLE_HLDS_38_38, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), &SimplifySpecs_17);
    Var_45 = parse_tree__error_util__contains_errors_2_f_0(Globals_14, SimplifySpecs_17);
    {
      Var_41 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 5 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), Var_41, 0) = ((MR_Box) (&top_level__mercury_compile_mlds_back_end_scalar_common_6[0]));
      MR_hl_field(MR_mktag(0), Var_41, 1) = ((MR_Box) (top_level__mercury_compile_mlds_back_end__mlds_backend_8_p_0_1));
      MR_hl_field(MR_mktag(0), Var_41, 2) = ((MR_Box) (MR_Word) ((MR_Integer) 2));
      MR_hl_field(MR_mktag(0), Var_41, 3) = ((MR_Box) (Var_45));
      MR_hl_field(MR_mktag(0), Var_41, 4) = ((MR_Box) ((MR_Integer) 0));
    }
    mercury__require__expect_4_p_0(Var_41, (MR_String) "top_level.mercury_compile_mlds_back_end", (MR_String) "predicate \140top_level.mercury_compile_mlds_back_end.mlds_backend\'/8", (MR_String) "simplify has errors");
    hlds__passes_aux__maybe_dump_hlds_7_p_0(STATE_VARIABLE_HLDS_38_38, (MR_Integer) 405, (MR_String) "ml_backend_simplify", STATE_VARIABLE_DumpInfo_0_30, &STATE_VARIABLE_DumpInfo_49_49);
    top_level__mercury_compile_mlds_back_end__maybe_add_trail_ops_6_p_0(Verbose_15, Stats_16, STATE_VARIABLE_HLDS_38_38, &STATE_VARIABLE_HLDS_51_51);
    hlds__passes_aux__maybe_dump_hlds_7_p_0(STATE_VARIABLE_HLDS_51_51, (MR_Integer) 410, (MR_String) "add_trail_ops", STATE_VARIABLE_DumpInfo_49_49, &STATE_VARIABLE_DumpInfo_55_55);
    top_level__mercury_compile_mlds_back_end__maybe_add_heap_ops_6_p_0(Verbose_15, Stats_16, STATE_VARIABLE_HLDS_51_51, &STATE_VARIABLE_HLDS_57_57);
    hlds__passes_aux__maybe_dump_hlds_7_p_0(STATE_VARIABLE_HLDS_57_57, (MR_Integer) 415, (MR_String) "add_heap_ops", STATE_VARIABLE_DumpInfo_55_55, &STATE_VARIABLE_DumpInfo_61_61);
    top_level__mercury_compile_mlds_back_end__maybe_mark_static_terms_6_p_0(Verbose_15, Stats_16, STATE_VARIABLE_HLDS_57_57, &STATE_VARIABLE_HLDS_63_63);
    hlds__passes_aux__maybe_dump_hlds_7_p_0(STATE_VARIABLE_HLDS_63_63, (MR_Integer) 420, (MR_String) "mark_static", STATE_VARIABLE_DumpInfo_61_61, &STATE_VARIABLE_DumpInfo_67_67);
    top_level__mercury_compile_llds_back_end__map_args_to_regs_6_p_0(Verbose_15, Stats_16, STATE_VARIABLE_HLDS_63_63, &STATE_VARIABLE_HLDS_69_69);
    hlds__passes_aux__maybe_dump_hlds_7_p_0(STATE_VARIABLE_HLDS_69_69, (MR_Integer) 425, (MR_String) "args_to_regs", STATE_VARIABLE_DumpInfo_67_67, &STATE_VARIABLE_DumpInfo_73_73);
    top_level__mercury_compile_mlds_back_end__maybe_mark_tail_rec_calls_hlds_8_p_0(Verbose_15, Stats_16, STATE_VARIABLE_HLDS_69_69, &STATE_VARIABLE_HLDS_76_76, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), &STATE_VARIABLE_Specs_77_77);
    hlds__passes_aux__maybe_dump_hlds_7_p_0(STATE_VARIABLE_HLDS_76_76, (MR_Integer) 430, (MR_String) "mark_tail_calls", STATE_VARIABLE_DumpInfo_73_73, &STATE_VARIABLE_DumpInfo_81_81);
    ...
    ml_backend__ml_top_gen__ml_code_gen_6_p_0(MLDS_Target_19, &STATE_VARIABLE_MLDS_87_87, STATE_VARIABLE_HLDS_76_76, STATE_VARIABLE_HLDS_27, STATE_VARIABLE_Specs_77_77, &STATE_VARIABLE_Specs_89_89);
    libs__file_util__maybe_write_string_4_p_0(Verbose_15, (MR_String) "% done.\n");
    libs__file_util__maybe_report_stats_3_p_0(Stats_16);
    hlds__passes_aux__maybe_dump_hlds_7_p_0(*STATE_VARIABLE_HLDS_27, (MR_Integer) 499, (MR_String) "final", STATE_VARIABLE_DumpInfo_81_81, STATE_VARIABLE_DumpInfo_31);
    top_level__mercury_compile_mlds_back_end__maybe_dump_mlds_6_p_0(Globals_14, STATE_VARIABLE_MLDS_87_87, (MR_Integer) 0, (MR_String) "initial");
    libs__file_util__maybe_write_string_4_p_0(Verbose_15, (MR_String) "% Generating RTTI data...\n");
    top_level__mercury_compile_mlds_back_end__mlds_gen_rtti_data_4_p_0(*STATE_VARIABLE_HLDS_27, MLDS_Target_19, STATE_VARIABLE_MLDS_87_87, &STATE_VARIABLE_MLDS_102_102);
    libs__file_util__maybe_write_string_4_p_0(Verbose_15, (MR_String) "% done.\n");
    libs__file_util__maybe_report_stats_3_p_0(Stats_16);
    top_level__mercury_compile_mlds_back_end__maybe_dump_mlds_6_p_0(Globals_14, STATE_VARIABLE_MLDS_102_102, (MR_Integer) 10, (MR_String) "rtti");
    ...
    if (succeeded)
    {
      ...
      ml_backend__ml_tailcall__ml_mark_tailcalls_5_p_0(Globals_14, *STATE_VARIABLE_HLDS_27, &TailCallSpecs_22, STATE_VARIABLE_MLDS_102_102, &STATE_VARIABLE_MLDS_113_113);
      *STATE_VARIABLE_Specs_29 = mercury__list__f_43_43_2_f_0((MR_Word) &parse_tree__error_util__parse_tree__error_util__type_ctor_info_error_spec_0, TailCallSpecs_22, STATE_VARIABLE_Specs_89_89);
      libs__file_util__maybe_write_string_4_p_0(Verbose_15, (MR_String) "% done.\n");
    }
    else
    {
      *STATE_VARIABLE_Specs_29 = STATE_VARIABLE_Specs_89_89;
      STATE_VARIABLE_MLDS_113_113 = STATE_VARIABLE_MLDS_102_102;
    }
    libs__file_util__maybe_report_stats_3_p_0(Stats_16);
    top_level__mercury_compile_mlds_back_end__maybe_dump_mlds_6_p_0(Globals_14, STATE_VARIABLE_MLDS_113_113, (MR_Integer) 20, (MR_String) "tailcalls");
    libs__globals__lookup_bool_option_3_p_0(Globals_14, (MR_Integer) 472, &Optimize_23);
    switch (Optimize_23) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        STATE_VARIABLE_MLDS_127_127 = STATE_VARIABLE_MLDS_113_113;
        break;
      case (MR_Integer) 1:
        {
          MR_Word NoInitOptGlobals_24;

          libs__globals__set_option_4_p_0((MR_Integer) 467, (MR_Word) MR_mkword(MR_mktag(1), &top_level__mercury_compile_mlds_back_end_scalar_common_4[2]), Globals_14, &NoInitOptGlobals_24);
          libs__file_util__maybe_write_string_4_p_0(Verbose_15, (MR_String) "% Optimizing MLDS...\n");
          ml_backend__ml_optimize__mlds_optimize_3_p_0(NoInitOptGlobals_24, STATE_VARIABLE_MLDS_113_113, &STATE_VARIABLE_MLDS_127_127);
          libs__file_util__maybe_write_string_4_p_0(Verbose_15, (MR_String) "% done.\n");
        }
        break;
    }
    libs__file_util__maybe_report_stats_3_p_0(Stats_16);
    top_level__mercury_compile_mlds_back_end__maybe_dump_mlds_6_p_0(Globals_14, STATE_VARIABLE_MLDS_127_127, (MR_Integer) 25, (MR_String) "optimize1");
      ...
      case (MR_Integer) 5:
        {
          ...
          ml_backend__ml_elim_nested__ml_elim_nested_5_p_1((MR_Integer) 1, Globals_14, MLDS_Target_19, STATE_VARIABLE_MLDS_127_127, &STATE_VARIABLE_MLDS_137_137);
          libs__file_util__maybe_write_string_4_p_0(Verbose_15, (MR_String) "% done.\n");
        }
        break;
      case (MR_Integer) 0:
        STATE_VARIABLE_MLDS_137_137 = STATE_VARIABLE_MLDS_127_127;
        break;
      case (MR_Integer) 2:
        STATE_VARIABLE_MLDS_137_137 = STATE_VARIABLE_MLDS_127_127;
        break;
    ...
    libs__file_util__maybe_report_stats_3_p_0(Stats_16);
    top_level__mercury_compile_mlds_back_end__maybe_dump_mlds_6_p_0(Globals_14, STATE_VARIABLE_MLDS_137_137, (MR_Integer) 30, (MR_String) "gc_frames");
    libs__file_util__maybe_write_string_4_p_0(Verbose_15, (MR_String) "% Flattening nested functions...\n");
    ml_backend__ml_elim_nested__ml_elim_nested_5_p_0((MR_Integer) 0, Globals_14, MLDS_Target_19, STATE_VARIABLE_MLDS_137_137, &STATE_VARIABLE_MLDS_147_147);
    libs__file_util__maybe_write_string_4_p_0(Verbose_15, (MR_String) "% done.\n");
    libs__file_util__maybe_report_stats_3_p_0(Stats_16);
    top_level__mercury_compile_mlds_back_end__maybe_dump_mlds_6_p_0(Globals_14, STATE_VARIABLE_MLDS_147_147, (MR_Integer) 35, (MR_String) "nested_funcs");
    switch (Optimize_23) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        *STATE_VARIABLE_MLDS_28 = STATE_VARIABLE_MLDS_147_147;
        break;
      case (MR_Integer) 1:
        {
          libs__file_util__maybe_write_string_4_p_0(Verbose_15, (MR_String) "% Optimizing MLDS again...\n");
          ml_backend__ml_optimize__mlds_optimize_3_p_0(Globals_14, STATE_VARIABLE_MLDS_147_147, STATE_VARIABLE_MLDS_28);
          libs__file_util__maybe_write_string_4_p_0(Verbose_15, (MR_String) "% done.\n");
        }
        break;
    }
    libs__file_util__maybe_report_stats_3_p_0(Stats_16);
    top_level__mercury_compile_mlds_back_end__maybe_dump_mlds_6_p_0(Globals_14, *STATE_VARIABLE_MLDS_28, (MR_Integer) 40, (MR_String) "optimize2");
    top_level__mercury_compile_mlds_back_end__maybe_dump_mlds_6_p_0(Globals_14, *STATE_VARIABLE_MLDS_28, (MR_Integer) 99, (MR_String) "final");
  }
}
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_10, (MR_Integer) 287, &NewTypeClassRtti_11);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 311, &SemidetReclaim_13);
    libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 312, &NondetReclaim_14);
      ...
      case (MR_Integer) 1:
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 293, &DisableTrailOps_14);
            ...
            case (MR_Integer) 0:
              {
                ...
                switch (Target_16) {
                  ...
                  case (MR_Integer) 0:
                    {
                      libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 469, &GenerateInline_17);
                    }
                    break;
                  case (MR_Integer) 1:
                  case (MR_Integer) 3:
