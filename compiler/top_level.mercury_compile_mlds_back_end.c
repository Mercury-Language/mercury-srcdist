      ...
      case (MR_Integer) 1:
        {
          ...
          libs__globals__set_option_4_p_0((MR_Integer) 488, (MR_Word) (MR_mkword(MR_mktag(1), &top_level__mercury_compile_mlds_back_end_scalar_common_4[3])), Globals_14, &NoInitOptGlobals_21);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_10, (MR_Integer) 308, &NewTypeClassRtti_11);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 245, &UseTrail_12);
    switch (UseTrail_12) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
      ...
      case (MR_Integer) 1:
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 314, &DisableTrailOps_14);
