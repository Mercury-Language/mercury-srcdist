...
MR_decl_label10(top_level__mercury_compile_mlds_back_end__maybe_dump_mlds_6_0, 39,40,41,42,37,44,45,46,47,48)
MR_decl_label4(top_level__mercury_compile_mlds_back_end__maybe_dump_mlds_6_0, 49,50,51,53)
...
MR_decl_static(top_level__mercury_compile_mlds_back_end__IntroducedFrom__pred__mlds_backend__107__1_2_0)
...
"top_level.mercury_compile_mlds_back_end",
"lambda_mercury_compile_mlds_back_end_m_107",
2,
0
},
"top_level.mercury_compile_mlds_back_end",
...
MR_BEGIN_MODULE(top_level__mercury_compile_mlds_back_end_module5)
	...
	MR_init_label10(top_level__mercury_compile_mlds_back_end__maybe_dump_mlds_6_0,39,40,41,42,37,44,45,46,47,48)
	MR_init_label4(top_level__mercury_compile_mlds_back_end__maybe_dump_mlds_6_0,49,50,51,53)
MR_BEGIN_CODE
...
MR_def_label(top_level__mercury_compile_mlds_back_end__maybe_dump_mlds_6_0,20)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(top_level__mercury_compile_mlds_back_end__maybe_dump_mlds_6_0_i53);
	}
	MR_r1 = MR_sv(1);
...
MR_def_label(top_level__mercury_compile_mlds_back_end__maybe_dump_mlds_6_0,45)
	...
	MR_np_call_localret_ent(pprint__write_4_0,
		top_level__mercury_compile_mlds_back_end__maybe_dump_mlds_6_0_i46);
MR_def_label(top_level__mercury_compile_mlds_back_end__maybe_dump_mlds_6_0,46)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_def_label(top_level__mercury_compile_mlds_back_end__maybe_dump_mlds_6_0,53)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(8);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
...
MR_def_label(top_level__mercury_compile_mlds_back_end__mlds_backend_7_0,6)
	...
	MR_tfield(0, MR_tempr1, 1) = (MR_Word) MR_ENTRY_AP(top_level__mercury_compile_mlds_back_end__IntroducedFrom__pred__mlds_backend__107__1_2_0);
	MR_tfield(0, MR_tempr1, 2) = (MR_Integer) 2;
...
MR_BEGIN_MODULE(top_level__mercury_compile_mlds_back_end_module11)
	MR_init_entry1(top_level__mercury_compile_mlds_back_end__IntroducedFrom__pred__mlds_backend__107__1_2_0);
	MR_INIT_PROC_LAYOUT_ADDR(mercury__top_level__mercury_compile_mlds_back_end__IntroducedFrom__pred__mlds_backend__107__1_2_0);
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'IntroducedFrom__pred__mlds_backend__107__1'/2 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(top_level__mercury_compile_mlds_back_end__IntroducedFrom__pred__mlds_backend__107__1_2_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_r1 == MR_r2);
	MR_proceed();
#ifdef MR_maybe_local_thread_engine_base
...
void mercury__top_level__mercury_compile_mlds_back_end__write_out_proc_statics(FILE *deep_fp, FILE *procrep_fp)
{
	MR_write_out_module_proc_reps_start(procrep_fp, &mercury_data__module_layout__top_level__mercury_compile_mlds_back_end);
