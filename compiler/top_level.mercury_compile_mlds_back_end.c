...
static /* final */ const MR_Box top_level__mercury_compile_mlds_back_end_scalar_common_2[2][1];
...
static /* final */ const MR_Box top_level__mercury_compile_mlds_back_end_scalar_common_6[1][4];
...
{
  {
    ...
    libs__globals__lookup_accumulating_option_3_p_0(Globals_7, (MR_Integer) 195, &DumpStages_13);
    libs__globals__lookup_accumulating_option_3_p_0(Globals_7, (MR_Integer) 197, &VerboseDumpStages_14);
    libs__globals__lookup_accumulating_option_3_p_0(Globals_7, (MR_Integer) 196, &DumpPredNames_15);
...
{
  {
    ...
    else
    {
      ...
      else
      {
        ...
        {
          parse_tree__error_util__write_error_spec_ignore_4_p_0(Globals_11, (MR_Word) (MR_mkword(MR_mktag(2), &top_level__mercury_compile_mlds_back_end_scalar_common_6[0])));
          *STATE_VARIABLE_HLDS_18 = STATE_VARIABLE_HLDS_0_17;
        }
      }
    }
