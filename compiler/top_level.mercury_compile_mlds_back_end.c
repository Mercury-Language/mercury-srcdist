    ...
    else
    {
      ...
      else
      {
        ...
        if (succeeded)
        {
          ...
          hlds__passes_aux__process_all_nonimported_procs_3_p_0((MR_Word) (&top_level__mercury_compile_mlds_back_end_scalar_common_4[1]), STATE_VARIABLE_HLDS_0_17, STATE_VARIABLE_HLDS_18);
