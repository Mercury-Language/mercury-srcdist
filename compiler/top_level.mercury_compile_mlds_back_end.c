  ...
  MR_String StageName_12)
{
  ...
  libs__globals__lookup_accumulating_option_3_p_0(Globals_9, (MR_Integer) 219, &DumpStages_15);
  libs__globals__lookup_accumulating_option_3_p_0(Globals_9, (MR_Integer) 221, &VerboseDumpStages_16);
  libs__globals__lookup_accumulating_option_3_p_0(Globals_9, (MR_Integer) 220, &DumpPredNames_17);
  ...
  MR_Word * STATE_VARIABLE_MLDS_17)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_10, (MR_Integer) 343, &NewTypeClassRtti_11);
  ...
  MR_Word * STATE_VARIABLE_HLDS_16)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_13, (MR_Integer) 365, &SemidetReclaim_14);
  ...
  MR_Word * STATE_VARIABLE_HLDS_22)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_13, (MR_Integer) 283, &UseTrail_14);
  switch (UseTrail_14) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 0:
    ...
    case (MR_Integer) 1:
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_13, (MR_Integer) 349, &DisableTrailOps_16);
          ...
          case (MR_Integer) 0:
            {
              ...
              libs__globals__lookup_bool_option_3_p_0(Globals_13, (MR_Integer) 523, &OptTrailUse_17);
