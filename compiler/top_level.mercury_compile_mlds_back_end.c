...
{
  {
    MR_bool succeeded = (HeadVar__1_46 == HeadVar__2_47);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_10, (MR_Integer) 56, &Verbose_11);
    libs__globals__lookup_bool_option_3_p_0(Globals_10, (MR_Integer) 66, &Stats_12);
    libs__file_util__maybe_write_string_4_p_0(Verbose_11, (MR_String) "% Converting MLDS to C#...\n");
    ml_backend__mlds_to_cs__output_csharp_mlds_5_p_0(HLDS_6, MLDS_7, Succeeded_8);
...
{
  {
    ...
    ml_backend__mlds_to_java__output_java_mlds_5_p_0(HLDS_6, MLDS_7, Succeeded_8);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_6, (MR_Integer) 56, &Verbose_10);
    libs__globals__lookup_bool_option_3_p_0(Globals_6, (MR_Integer) 66, &Stats_11);
    libs__file_util__maybe_write_string_4_p_0(Verbose_10, (MR_String) "% Converting MLDS to C...\n");
    ml_backend__mlds_to_c__output_c_mlds_6_p_0(MLDS_7, Globals_6, (MR_String) "", Succeeded_8);
...
top_level__mercury_compile_mlds_back_end__mlds_backend_8_p_0(
  ...
  MR_Word * STATE_VARIABLE_MLDS_29,
...
{
  {
    ...
    MR_Word OptimizeTailCalls_20;
    MR_Word OptimizeTailCallsCodegen_21;
    MR_Word Optimize_23;
    MR_Word GC_25;
    MR_Word NestedFuncs_26;
    ...
    MR_Word STATE_VARIABLE_MLDS_88_88;
    MR_Word STATE_VARIABLE_Specs_90_90;
    MR_Word STATE_VARIABLE_MLDS_103_103;
    MR_Word STATE_VARIABLE_MLDS_114_114;
    MR_Word STATE_VARIABLE_MLDS_128_128;
    MR_Word STATE_VARIABLE_MLDS_138_138;
    MR_Word STATE_VARIABLE_MLDS_149_149;

    hlds__hlds_module__module_info_get_globals_2_p_0(STATE_VARIABLE_HLDS_0_27, &Globals_14);
    libs__globals__lookup_bool_option_3_p_0(Globals_14, (MR_Integer) 56, &Verbose_15);
    libs__globals__lookup_bool_option_3_p_0(Globals_14, (MR_Integer) 66, &Stats_16);
    top_level__mercury_compile_front_end__maybe_simplify_10_p_0((MR_Integer) 0, (MR_Integer) 4, Verbose_15, Stats_16, STATE_VARIABLE_HLDS_0_27, &STATE_VARIABLE_HLDS_39_39, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), &SimplifySpecs_17);
    Var_46 = parse_tree__error_util__contains_errors_2_f_0(Globals_14, SimplifySpecs_17);
    {
      Var_42 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 5 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), Var_42, 0) = ((MR_Box) (&top_level__mercury_compile_mlds_back_end_scalar_common_6[0]));
      MR_hl_field(MR_mktag(0), Var_42, 1) = ((MR_Box) (top_level__mercury_compile_mlds_back_end__mlds_backend_8_p_0_1));
    ...
    mercury__require__expect_4_p_0(Var_42, (MR_String) "top_level.mercury_compile_mlds_back_end", (MR_String) "predicate \140top_level.mercury_compile_mlds_back_end.mlds_backend\'/8", (MR_String) "simplify has errors");
    hlds__passes_aux__maybe_dump_hlds_7_p_0(STATE_VARIABLE_HLDS_39_39, (MR_Integer) 405, (MR_String) "ml_backend_simplify", STATE_VARIABLE_DumpInfo_0_31, &STATE_VARIABLE_DumpInfo_50_50);
    top_level__mercury_compile_mlds_back_end__maybe_add_trail_ops_6_p_0(Verbose_15, Stats_16, STATE_VARIABLE_HLDS_39_39, &STATE_VARIABLE_HLDS_52_52);
    hlds__passes_aux__maybe_dump_hlds_7_p_0(STATE_VARIABLE_HLDS_52_52, (MR_Integer) 410, (MR_String) "add_trail_ops", STATE_VARIABLE_DumpInfo_50_50, &STATE_VARIABLE_DumpInfo_56_56);
    top_level__mercury_compile_mlds_back_end__maybe_add_heap_ops_6_p_0(Verbose_15, Stats_16, STATE_VARIABLE_HLDS_52_52, &STATE_VARIABLE_HLDS_58_58);
    hlds__passes_aux__maybe_dump_hlds_7_p_0(STATE_VARIABLE_HLDS_58_58, (MR_Integer) 415, (MR_String) "add_heap_ops", STATE_VARIABLE_DumpInfo_56_56, &STATE_VARIABLE_DumpInfo_62_62);
    top_level__mercury_compile_mlds_back_end__maybe_mark_static_terms_6_p_0(Verbose_15, Stats_16, STATE_VARIABLE_HLDS_58_58, &STATE_VARIABLE_HLDS_64_64);
    hlds__passes_aux__maybe_dump_hlds_7_p_0(STATE_VARIABLE_HLDS_64_64, (MR_Integer) 420, (MR_String) "mark_static", STATE_VARIABLE_DumpInfo_62_62, &STATE_VARIABLE_DumpInfo_68_68);
    top_level__mercury_compile_llds_back_end__map_args_to_regs_6_p_0(Verbose_15, Stats_16, STATE_VARIABLE_HLDS_64_64, &STATE_VARIABLE_HLDS_70_70);
    hlds__passes_aux__maybe_dump_hlds_7_p_0(STATE_VARIABLE_HLDS_70_70, (MR_Integer) 425, (MR_String) "args_to_regs", STATE_VARIABLE_DumpInfo_68_68, &STATE_VARIABLE_DumpInfo_74_74);
    top_level__mercury_compile_mlds_back_end__maybe_mark_tail_rec_calls_hlds_8_p_0(Verbose_15, Stats_16, STATE_VARIABLE_HLDS_70_70, &STATE_VARIABLE_HLDS_77_77, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), &STATE_VARIABLE_Specs_78_78);
    hlds__passes_aux__maybe_dump_hlds_7_p_0(STATE_VARIABLE_HLDS_77_77, (MR_Integer) 430, (MR_String) "mark_tail_calls", STATE_VARIABLE_DumpInfo_74_74, &STATE_VARIABLE_DumpInfo_82_82);
    ...
    ml_backend__ml_proc_gen__ml_code_gen_6_p_0(MLDS_Target_19, &STATE_VARIABLE_MLDS_88_88, STATE_VARIABLE_HLDS_77_77, STATE_VARIABLE_HLDS_28, STATE_VARIABLE_Specs_78_78, &STATE_VARIABLE_Specs_90_90);
    libs__file_util__maybe_write_string_4_p_0(Verbose_15, (MR_String) "% done.\n");
    libs__file_util__maybe_report_stats_3_p_0(Stats_16);
    hlds__passes_aux__maybe_dump_hlds_7_p_0(*STATE_VARIABLE_HLDS_28, (MR_Integer) 499, (MR_String) "final", STATE_VARIABLE_DumpInfo_82_82, STATE_VARIABLE_DumpInfo_32);
    top_level__mercury_compile_mlds_back_end__maybe_dump_mlds_6_p_0(Globals_14, STATE_VARIABLE_MLDS_88_88, (MR_Integer) 0, (MR_String) "initial");
    libs__file_util__maybe_write_string_4_p_0(Verbose_15, (MR_String) "% Generating RTTI data...\n");
    top_level__mercury_compile_mlds_back_end__mlds_gen_rtti_data_4_p_0(*STATE_VARIABLE_HLDS_28, MLDS_Target_19, STATE_VARIABLE_MLDS_88_88, &STATE_VARIABLE_MLDS_103_103);
    libs__file_util__maybe_write_string_4_p_0(Verbose_15, (MR_String) "% done.\n");
    libs__file_util__maybe_report_stats_3_p_0(Stats_16);
    top_level__mercury_compile_mlds_back_end__maybe_dump_mlds_6_p_0(Globals_14, STATE_VARIABLE_MLDS_103_103, (MR_Integer) 10, (MR_String) "rtti");
    libs__globals__lookup_bool_option_3_p_0(Globals_14, (MR_Integer) 464, &OptimizeTailCalls_20);
    libs__globals__lookup_bool_option_3_p_0(Globals_14, (MR_Integer) 465, &OptimizeTailCallsCodegen_21);
    succeeded = (OptimizeTailCalls_20 == (MR_Integer) 1);
    if (succeeded)
      succeeded = (OptimizeTailCallsCodegen_21 == (MR_Integer) 0);
    if (succeeded)
    {
      MR_Word TailCallSpecs_22;

      libs__file_util__maybe_write_string_4_p_0(Verbose_15, (MR_String) "% Detecting tail calls...\n");
      ml_backend__ml_tailcall__ml_mark_tailcalls_5_p_0(Globals_14, *STATE_VARIABLE_HLDS_28, &TailCallSpecs_22, STATE_VARIABLE_MLDS_103_103, &STATE_VARIABLE_MLDS_114_114);
      *STATE_VARIABLE_Specs_30 = mercury__list__f_43_43_2_f_0((MR_Word) &parse_tree__error_util__parse_tree__error_util__type_ctor_info_error_spec_0, TailCallSpecs_22, STATE_VARIABLE_Specs_90_90);
      libs__file_util__maybe_write_string_4_p_0(Verbose_15, (MR_String) "% done.\n");
    }
    else
    {
      *STATE_VARIABLE_Specs_30 = STATE_VARIABLE_Specs_90_90;
      STATE_VARIABLE_MLDS_114_114 = STATE_VARIABLE_MLDS_103_103;
    }
    libs__file_util__maybe_report_stats_3_p_0(Stats_16);
    top_level__mercury_compile_mlds_back_end__maybe_dump_mlds_6_p_0(Globals_14, STATE_VARIABLE_MLDS_114_114, (MR_Integer) 20, (MR_String) "tailcalls");
    libs__globals__lookup_bool_option_3_p_0(Globals_14, (MR_Integer) 471, &Optimize_23);
    switch (Optimize_23) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        STATE_VARIABLE_MLDS_128_128 = STATE_VARIABLE_MLDS_114_114;
        break;
      case (MR_Integer) 1:
        {
          MR_Word NoInitOptGlobals_24;

          libs__globals__set_option_4_p_0((MR_Integer) 466, (MR_Word) MR_mkword(MR_mktag(1), &top_level__mercury_compile_mlds_back_end_scalar_common_4[2]), Globals_14, &NoInitOptGlobals_24);
          libs__file_util__maybe_write_string_4_p_0(Verbose_15, (MR_String) "% Optimizing MLDS...\n");
          ml_backend__ml_optimize__mlds_optimize_3_p_0(NoInitOptGlobals_24, STATE_VARIABLE_MLDS_114_114, &STATE_VARIABLE_MLDS_128_128);
          libs__file_util__maybe_write_string_4_p_0(Verbose_15, (MR_String) "% done.\n");
        }
        break;
    }
    libs__file_util__maybe_report_stats_3_p_0(Stats_16);
    top_level__mercury_compile_mlds_back_end__maybe_dump_mlds_6_p_0(Globals_14, STATE_VARIABLE_MLDS_128_128, (MR_Integer) 25, (MR_String) "optimize1");
    libs__globals__get_gc_method_2_p_0(Globals_14, &GC_25);
    switch (GC_25) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 5:
        {
          libs__file_util__maybe_write_string_4_p_0(Verbose_15, (MR_String) "% Threading GC stack frames...\n");
          ml_backend__ml_elim_nested__ml_elim_nested_5_p_1((MR_Integer) 1, Globals_14, MLDS_Target_19, STATE_VARIABLE_MLDS_128_128, &STATE_VARIABLE_MLDS_138_138);
          libs__file_util__maybe_write_string_4_p_0(Verbose_15, (MR_String) "% done.\n");
        }
        break;
      case (MR_Integer) 0:
        STATE_VARIABLE_MLDS_138_138 = STATE_VARIABLE_MLDS_128_128;
        break;
      case (MR_Integer) 2:
        STATE_VARIABLE_MLDS_138_138 = STATE_VARIABLE_MLDS_128_128;
        break;
    ...
    libs__file_util__maybe_report_stats_3_p_0(Stats_16);
    top_level__mercury_compile_mlds_back_end__maybe_dump_mlds_6_p_0(Globals_14, STATE_VARIABLE_MLDS_138_138, (MR_Integer) 30, (MR_String) "gc_frames");
    libs__globals__lookup_bool_option_3_p_0(Globals_14, (MR_Integer) 266, &NestedFuncs_26);
    switch (NestedFuncs_26) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        {
          libs__file_util__maybe_write_string_4_p_0(Verbose_15, (MR_String) "% Flattening nested functions...\n");
          ml_backend__ml_elim_nested__ml_elim_nested_5_p_0((MR_Integer) 0, Globals_14, MLDS_Target_19, STATE_VARIABLE_MLDS_138_138, &STATE_VARIABLE_MLDS_149_149);
          libs__file_util__maybe_write_string_4_p_0(Verbose_15, (MR_String) "% done.\n");
        }
        break;
      case (MR_Integer) 1:
        STATE_VARIABLE_MLDS_149_149 = STATE_VARIABLE_MLDS_138_138;
        break;
    }
    libs__file_util__maybe_report_stats_3_p_0(Stats_16);
    top_level__mercury_compile_mlds_back_end__maybe_dump_mlds_6_p_0(Globals_14, STATE_VARIABLE_MLDS_149_149, (MR_Integer) 35, (MR_String) "nested_funcs");
    switch (Optimize_23) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        *STATE_VARIABLE_MLDS_29 = STATE_VARIABLE_MLDS_149_149;
        break;
      case (MR_Integer) 1:
        {
          libs__file_util__maybe_write_string_4_p_0(Verbose_15, (MR_String) "% Optimizing MLDS again...\n");
          ml_backend__ml_optimize__mlds_optimize_3_p_0(Globals_14, STATE_VARIABLE_MLDS_149_149, STATE_VARIABLE_MLDS_29);
          libs__file_util__maybe_write_string_4_p_0(Verbose_15, (MR_String) "% done.\n");
        }
        break;
    }
    libs__file_util__maybe_report_stats_3_p_0(Stats_16);
    top_level__mercury_compile_mlds_back_end__maybe_dump_mlds_6_p_0(Globals_14, *STATE_VARIABLE_MLDS_29, (MR_Integer) 40, (MR_String) "optimize2");
    top_level__mercury_compile_mlds_back_end__maybe_dump_mlds_6_p_0(Globals_14, *STATE_VARIABLE_MLDS_29, (MR_Integer) 99, (MR_String) "final");
  }
}
...
{
  {
    ...
    libs__globals__lookup_accumulating_option_3_p_0(Globals_7, (MR_Integer) 168, &DumpStages_13);
    libs__globals__lookup_accumulating_option_3_p_0(Globals_7, (MR_Integer) 170, &VerboseDumpStages_14);
    libs__globals__lookup_accumulating_option_3_p_0(Globals_7, (MR_Integer) 169, &DumpPredNames_15);
    ...
    if (succeeded)
    {
      ...
      Var_35 = mercury__string__f_43_43_2_f_0((MR_String) "-", StageName_10);
      Var_34 = mercury__string__f_43_43_2_f_0(StageNumStr_16, Var_35);
      DumpSuffix_17 = mercury__string__f_43_43_2_f_0((MR_String) "_dump.", Var_34);
      if ((DumpPredNames_15 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
      {
        MR_Word _Succeeded_18;

        ml_backend__mlds_to_c__output_c_mlds_6_p_0(MLDS_8, Globals_7, DumpSuffix_17, &_Succeeded_18);
      }
      else
        ml_backend__mlds_to_c__output_c_dump_preds_6_p_0(MLDS_8, Globals_7, DumpSuffix_17, DumpPredNames_15);
    ...
    if (succeeded)
    {
      ...
      MR_String DumpFile_23;
      MR_String Var_46;
      MR_String Var_48;
      MR_String Var_49;

      libs__file_util__maybe_write_string_4_p_0(Verbose_12, (MR_String) "% Dumping out raw MLDS...\n");
      ModuleName_21 = ml_backend__mlds__mlds_get_module_name_1_f_0(MLDS_8);
      parse_tree__file_names__module_name_to_file_name_7_p_0(Globals_7, (MR_Integer) 0, (MR_String) ".mlds_dump", ModuleName_21, &BaseFileName_22);
      Var_49 = mercury__string__f_43_43_2_f_0((MR_String) "-", StageName_10);
      Var_48 = mercury__string__f_43_43_2_f_0(StageNumStr_16, Var_49);
      Var_46 = mercury__string__f_43_43_2_f_0((MR_String) ".", Var_48);
      DumpFile_23 = mercury__string__f_43_43_2_f_0(BaseFileName_22, Var_46);
      top_level__mercury_compile_mlds_back_end__dump_mlds_5_p_0(Globals_7, DumpFile_23, MLDS_8);
      libs__file_util__maybe_write_string_4_p_0(Verbose_12, (MR_String) "% done.\n");
    }
    else
    {
...
{
  {
    ...
    if (((MR_tag((MR_Word) Res_12)) == (MR_mktag((MR_Integer) 1))))
    {
    ...
    else
    {
      ...
      Var_39 = mercury__pprint__to_doc_1_f_0((MR_Word) &ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_0, ((MR_Box) (MLDS_8)));
      mercury__pprint__write_4_p_0((MR_Word) &top_level__mercury_compile_mlds_back_end_scalar_common_1[0], (MR_Integer) 80, ((MR_Box) (Var_39)));
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_10, (MR_Integer) 288, &NewTypeClassRtti_11);
    ...
    TypeCtorInfo_40_40 = (MR_Word) &backend_libs__rtti__backend_libs__rtti__type_ctor_info_rtti_data_0;
    Var_19 = mercury__list__f_43_43_2_f_0(TypeCtorInfo_40_40, TypeClassInfoRtti_9, NewTypeClassInfoRttiData_12);
    RttiDatas_13 = mercury__list__f_43_43_2_f_0(TypeCtorInfo_40_40, TypeCtorRtti_8, Var_19);
    Var_21 = ((MR_Word) (MR_hl_field(MR_mktag(0), STATE_VARIABLE_MLDS_0_16, (MR_Integer) 0)));
    Var_22 = ((MR_Word) (MR_hl_field(MR_mktag(0), STATE_VARIABLE_MLDS_0_16, (MR_Integer) 1)));
    Var_23 = ((MR_Word) (MR_hl_field(MR_mktag(0), STATE_VARIABLE_MLDS_0_16, (MR_Integer) 2)));
    GlobalData0_14 = ((MR_Word) (MR_hl_field(MR_mktag(0), STATE_VARIABLE_MLDS_0_16, (MR_Integer) 3)));
    Var_24 = ((MR_Word) (MR_hl_field(MR_mktag(0), STATE_VARIABLE_MLDS_0_16, (MR_Integer) 4)));
    Var_25 = ((MR_Word) (MR_hl_field(MR_mktag(0), STATE_VARIABLE_MLDS_0_16, (MR_Integer) 5)));
    Var_26 = ((MR_Word) (MR_hl_field(MR_mktag(0), STATE_VARIABLE_MLDS_0_16, (MR_Integer) 6)));
    Var_27 = ((MR_Word) (MR_hl_field(MR_mktag(0), STATE_VARIABLE_MLDS_0_16, (MR_Integer) 7)));
    Var_28 = ((MR_Word) (MR_hl_field(MR_mktag(0), STATE_VARIABLE_MLDS_0_16, (MR_Integer) 8)));
    Var_29 = ((MR_Word) (MR_hl_field(MR_mktag(0), STATE_VARIABLE_MLDS_0_16, (MR_Integer) 9)));
    ...
    Var_32 = ((MR_Word) (MR_hl_field(MR_mktag(0), STATE_VARIABLE_MLDS_0_16, (MR_Integer) 2)));
    ...
    Var_39 = ((MR_Word) (MR_hl_field(MR_mktag(0), STATE_VARIABLE_MLDS_0_16, (MR_Integer) 9)));
    {
      ...
      *STATE_VARIABLE_MLDS_17 = base;
      ...
      MR_hl_field(MR_mktag(0), base, 3) = ((MR_Box) (GlobalData_15));
...
{
  {
    ...
    MR_Word OptimizeTailCallsCodegen_16;

    hlds__hlds_module__module_info_get_globals_2_p_0(STATE_VARIABLE_HLDS_0_18, &Globals_14);
    libs__globals__lookup_bool_option_3_p_0(Globals_14, (MR_Integer) 464, &OptimizeTailCalls_15);
    libs__globals__lookup_bool_option_3_p_0(Globals_14, (MR_Integer) 465, &OptimizeTailCallsCodegen_16);
    succeeded = (OptimizeTailCalls_15 == (MR_Integer) 1);
    if (succeeded)
      succeeded = (OptimizeTailCallsCodegen_16 == (MR_Integer) 1);
    if (succeeded)
    {
      MR_Word DepInfo_17;
      ...
      hlds__hlds_dependency_graph__module_info_rebuild_dependency_info_3_p_0(STATE_VARIABLE_HLDS_0_18, &STATE_VARIABLE_HLDS_29_29, &DepInfo_17);
      hlds__mark_tail_calls__mark_self_and_mutual_tail_rec_calls_in_module_for_mlds_code_gen_5_p_0(DepInfo_17, STATE_VARIABLE_HLDS_29_29, STATE_VARIABLE_HLDS_19, STATE_VARIABLE_Specs_0_20, STATE_VARIABLE_Specs_21);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 312, &SemidetReclaim_13);
    libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 313, &NondetReclaim_14);
    ...
    else
    {
      ...
      else
      {
        ...
        {
          parse_tree__error_util__write_error_pieces_plain_4_p_0(Globals_11, (MR_Word) MR_mkword(MR_mktag(1), &top_level__mercury_compile_mlds_back_end_scalar_common_1[2]));
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 229, &UseTrail_12);
    switch (UseTrail_12) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        *STATE_VARIABLE_HLDS_19 = STATE_VARIABLE_HLDS_0_18;
      ...
      case (MR_Integer) 1:
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 294, &DisableTrailOps_14);
            ...
            case (MR_Integer) 0:
              {
                ...
                libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 403, &OptTrailUse_15);
                libs__globals__get_target_2_p_0(Globals_11, &Target_16);
                switch (Target_16) {
                  default: /*NOTREACHED*/ MR_assert(0);
                  case (MR_Integer) 0:
                    {
                      libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 468, &GenerateInline_17);
                    }
                    break;
                  case (MR_Integer) 1:
                  case (MR_Integer) 3:
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 457, &SGCells_12);
    switch (SGCells_12) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
