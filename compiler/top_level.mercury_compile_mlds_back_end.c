      ...
      case (MR_Integer) 1:
        {
          ...
          libs__globals__set_option_4_p_0((MR_Integer) 488, (MR_Word) (MR_mkword(MR_mktag(1), &top_level__mercury_compile_mlds_back_end_scalar_common_4[2])), Globals_14, &NoInitOptGlobals_21);
