...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_14, (MR_Integer) 476, &Optimize_20);
    switch (Optimize_20) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
            ...
            case (MR_Integer) 0:
              {
                ...
                switch (Target_16) {
                  ...
                  case (MR_Integer) 0:
                    {
                      libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 473, &GenerateInline_17);
                    }
                    break;
                  case (MR_Integer) 1:
                  case (MR_Integer) 3:
