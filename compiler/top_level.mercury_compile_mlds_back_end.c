  ...
  MR_Box closure_arg)
{
  ...
  succeeded = top_level__mercury_compile_mlds_back_end__IntroducedFrom__pred__mlds_backend__91__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 4)))));
  return succeeded;
}
  ...
  MR_Word * STATE_VARIABLE_HLDS_18)
{
  ...
  else
  {
    ...
    else
    {
      ...
      {
        parse_tree__write_error_spec__write_error_spec_4_p_0(Globals_11, (MR_Word) (MR_mkword(2, &top_level__mercury_compile_mlds_back_end_scalar_common_3[1])));
        *STATE_VARIABLE_HLDS_18 = STATE_VARIABLE_HLDS_0_17;
      }
    }
  }
