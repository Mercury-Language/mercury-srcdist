...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(0), top_level__mercury_compile_mlds_back_end__Var_37, 0) = ((MR_Box) (&top_level__mercury_compile_mlds_back_end_scalar_common_6[0]));
      ...
      case (MR_Integer) 1:
        {
          ...
          {
            libs__globals__set_option_4_p_0((MR_Integer) 464, (MR_Word) MR_mkword(MR_mktag(1), &top_level__mercury_compile_mlds_back_end_scalar_common_4[2]), top_level__mercury_compile_mlds_back_end__Globals_14, &top_level__mercury_compile_mlds_back_end__NoInitOptGlobals_20);
          }
          {
