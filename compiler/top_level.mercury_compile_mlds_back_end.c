  ...
  MR_String StageName_12)
{
  ...
  libs__globals__lookup_accumulating_option_3_p_0(Globals_9, (MR_Integer) 217, &DumpStages_15);
  libs__globals__lookup_accumulating_option_3_p_0(Globals_9, (MR_Integer) 219, &VerboseDumpStages_16);
  libs__globals__lookup_accumulating_option_3_p_0(Globals_9, (MR_Integer) 218, &DumpPredNames_17);
  ...
  MR_Word * STATE_VARIABLE_MLDS_17)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_10, (MR_Integer) 341, &NewTypeClassRtti_11);
  ...
  MR_Word * STATE_VARIABLE_HLDS_16)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_13, (MR_Integer) 363, &SemidetReclaim_14);
  ...
  MR_Word * STATE_VARIABLE_HLDS_22)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_13, (MR_Integer) 281, &UseTrail_14);
  switch (UseTrail_14) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 0:
    ...
    case (MR_Integer) 1:
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_13, (MR_Integer) 347, &DisableTrailOps_16);
          ...
          case (MR_Integer) 0:
            {
              ...
              libs__globals__lookup_bool_option_3_p_0(Globals_13, (MR_Integer) 521, &OptTrailUse_17);
