  ...
  MR_Word * STATE_VARIABLE_DumpInfo_32)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_16, (MR_Integer) 73, &Verbose_17);
  libs__globals__lookup_bool_option_3_p_0(Globals_16, (MR_Integer) 83, &Stats_18);
  ...
  MR_Word * STATE_VARIABLE_HLDS_16)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_13, (MR_Integer) 362, &SemidetReclaim_14);
    ...
    case (MR_Integer) 1:
      {
        ...
        hlds__passes_aux__process_valid_nonimported_procs_3_p_0((MR_Word) (&top_level__mercury_compile_mlds_back_end_scalar_common_5[1]), STATE_VARIABLE_HLDS_0_15, STATE_VARIABLE_HLDS_16);
