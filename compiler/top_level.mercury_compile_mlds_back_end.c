...
{
  {
    ...
    top_level__mercury_compile_front_end__maybe_simplify_10_p_0((MR_Integer) 0, (MR_Integer) 4, Verbose_15, Stats_16, STATE_VARIABLE_HLDS_0_23, &STATE_VARIABLE_HLDS_35_35, (MR_Word) ((MR_Integer) 0), &SimplifySpecs_17);
    ...
    top_level__mercury_compile_mlds_back_end__maybe_mark_tail_rec_calls_hlds_8_p_0(Verbose_15, Stats_16, STATE_VARIABLE_HLDS_66_66, &STATE_VARIABLE_HLDS_73_73, (MR_Word) ((MR_Integer) 0), &STATE_VARIABLE_Specs_74_74);
...
{
  {
    ...
    if (succeeded)
    {
      ...
      if ((DumpPredNames_15 == (MR_Word) ((MR_Integer) 0)))
      {
