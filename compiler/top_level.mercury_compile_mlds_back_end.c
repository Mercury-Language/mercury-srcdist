...
{
  {
    ...
    Var_41 = parse_tree__error_util__contains_errors_2_f_0(Globals_14, SimplifySpecs_17);
    {
      ...
      MR_hl_field(MR_mktag(0), Var_38, 0) = ((MR_Box) (&top_level__mercury_compile_mlds_back_end_scalar_common_7[1]));
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_14, (MR_Integer) 495, &Optimize_20);
    switch (Optimize_20) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
      ...
      case (MR_Integer) 1:
        {
          ...
          libs__globals__set_option_4_p_0((MR_Integer) 489, (MR_Word) (MR_mkword(MR_mktag(1), &top_level__mercury_compile_mlds_back_end_scalar_common_4[3])), Globals_14, &NoInitOptGlobals_21);
...
{
  {
    ...
    if (succeeded)
    {
      ...
      parse_tree__file_names__module_name_to_file_name_7_p_0(Globals_7, (MR_Integer) 0, (MR_Word) (((MR_Box) ((MR_String) ".mlds_dump"))), ModuleName_27, &BaseFileName_28);
      Var_59 = mercury__string__f_43_43_2_f_0((MR_String) "-", StageName_10);
      Var_58 = mercury__string__f_43_43_2_f_0(StageNumStr_16, Var_59);
      Var_56 = mercury__string__f_43_43_2_f_0((MR_String) ".", Var_58);
      DumpFile_29 = mercury__string__f_43_43_2_f_0(BaseFileName_28, Var_56);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_10, (MR_Integer) 309, &NewTypeClassRtti_11);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_14, (MR_Integer) 488, &OptimizeTailCalls_15);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 333, &SemidetReclaim_13);
    libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 334, &NondetReclaim_14);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 246, &UseTrail_12);
    switch (UseTrail_12) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
      ...
      case (MR_Integer) 1:
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 315, &DisableTrailOps_14);
            ...
            case (MR_Integer) 0:
              {
                ...
                libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 426, &OptTrailUse_15);
                libs__globals__get_target_2_p_0(Globals_11, &Target_16);
                switch (Target_16) {
                  default: /*NOTREACHED*/ MR_assert(0);
                  case (MR_Integer) 0:
                    libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 492, &GenerateInline_17);
                    break;
                  case (MR_Integer) 1:
                  case (MR_Integer) 3:
                  case (MR_Integer) 2:
                ...
                hlds__passes_aux__process_valid_nonimported_procs_3_p_0(Var_29, STATE_VARIABLE_HLDS_0_18, STATE_VARIABLE_HLDS_19);
                libs__file_util__maybe_write_string_4_p_0(Verbose_7, (MR_String) "% done.\n");
                libs__file_util__maybe_report_stats_3_p_0(Stats_8);
              }
              break;
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 480, &SGCells_12);
    switch (SGCells_12) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
      ...
      case (MR_Integer) 1:
        {
          ...
          libs__file_util__maybe_flush_output_3_p_0(Verbose_7);
          hlds__passes_aux__process_valid_nonimported_procs_3_p_0((MR_Word) (&top_level__mercury_compile_mlds_back_end_scalar_common_4[0]), STATE_VARIABLE_HLDS_0_13, STATE_VARIABLE_HLDS_14);
          libs__file_util__maybe_write_string_4_p_0(Verbose_7, (MR_String) "% done.\n");
          libs__file_util__maybe_report_stats_3_p_0(Stats_8);
        }
        break;
