...
static /* final */ const MR_Box top_level__mercury_compile_mlds_back_end_scalar_common_2[1][8];

static /* final */ const MR_Box top_level__mercury_compile_mlds_back_end_scalar_common_3[1][6];

static /* final */ const MR_Box top_level__mercury_compile_mlds_back_end_scalar_common_4[1][3];

static /* final */ const MR_Box top_level__mercury_compile_mlds_back_end_scalar_common_5[3][1];
...
{
  {
    ...
    if (succeeded)
    {
      ...
      parse_tree__file_names__module_name_to_file_name_8_p_0(Globals_7, (MR_String) "predicate \140top_level.mercury_compile_mlds_back_end.maybe_dump_mlds\'/6", (MR_Integer) 0, (MR_Word) (MR_mkword(MR_mktag(1), &top_level__mercury_compile_mlds_back_end_scalar_common_5[2])), ModuleName_27, &BaseFileName_28);
    ...
    else
    {
      ...
      else
      {
        ...
        if (succeeded)
        {
          ...
          hlds__passes_aux__process_valid_nonimported_procs_3_p_0((MR_Word) (&top_level__mercury_compile_mlds_back_end_scalar_common_5[0]), STATE_VARIABLE_HLDS_0_17, STATE_VARIABLE_HLDS_18);
            ...
            case (MR_Integer) 0:
              {
                ...
                libs__file_util__maybe_flush_output_3_p_0(Verbose_7);
                {
                  ...
                  MR_hl_field(MR_mktag(0), Var_31, 0) = ((MR_Box) (&top_level__mercury_compile_mlds_back_end_scalar_common_2[0]));
