...
MR_decl_label10(top_level__mercury_compile_mlds_back_end__mlds_backend_7_0, 60,61,68,69,70,71,74,75,73,77)
MR_decl_label8(top_level__mercury_compile_mlds_back_end__mlds_backend_7_0, 78,80,81,82,83,84,85,86)
...
MR_BEGIN_MODULE(top_level__mercury_compile_mlds_back_end_module7)
	...
	MR_init_label10(top_level__mercury_compile_mlds_back_end__mlds_backend_7_0,60,61,68,69,70,71,74,75,73,77)
	MR_init_label8(top_level__mercury_compile_mlds_back_end__mlds_backend_7_0,78,80,81,82,83,84,85,86)
MR_BEGIN_CODE
...
MR_def_label(top_level__mercury_compile_mlds_back_end__mlds_backend_7_0,57)
	...
	if (MR_INT_NE(MR_r1,6)) {
		MR_GOTO_LAB(top_level__mercury_compile_mlds_back_end__mlds_backend_7_0_i68);
	}
	MR_r1 = MR_sv(2);
...
MR_def_label(top_level__mercury_compile_mlds_back_end__mlds_backend_7_0,71)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(top_level__mercury_compile_mlds_back_end__mlds_backend_7_0_i73);
	}
	MR_r1 = MR_sv(2);
...
MR_def_label(top_level__mercury_compile_mlds_back_end__mlds_backend_7_0,77)
	...
	MR_np_call_localret_ent(top_level__mercury_compile_mlds_back_end__maybe_dump_mlds_6_0,
		top_level__mercury_compile_mlds_back_end__mlds_backend_7_0_i78);
MR_def_label(top_level__mercury_compile_mlds_back_end__mlds_backend_7_0,78)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_sv(4),0)) {
		MR_GOTO_LAB(top_level__mercury_compile_mlds_back_end__mlds_backend_7_0_i80);
	}
	MR_r1 = MR_sv(3);
	MR_sv(2) = MR_sv(5);
	MR_np_call_localret_ent(libs__file_util__maybe_report_stats_3_0,
...
MR_def_label(top_level__mercury_compile_mlds_back_end__mlds_backend_7_0,85)
	...
	MR_np_call_localret_ent(top_level__mercury_compile_mlds_back_end__maybe_dump_mlds_6_0,
		top_level__mercury_compile_mlds_back_end__mlds_backend_7_0_i86);
MR_def_label(top_level__mercury_compile_mlds_back_end__mlds_backend_7_0,86)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(6);
	MR_r2 = MR_sv(2);
	MR_r3 = MR_sv(7);
