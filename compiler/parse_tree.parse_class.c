    ...
    else
    {
      ...
      else
      {
        ...
        if (succeeded)
        {
          ...
          MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), ItemClause_33, (MR_Integer) 1)));
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(0), InstanceMethod_230, 0) = (MR_Box) (packed_args_0);
