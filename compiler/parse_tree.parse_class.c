        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              ...
              succeeded = mercury__term__term_list_to_var_list_2_p_0(TypeCtorInfo_8_40, TypeTerms_38, &Domain_8);
              if (succeeded)
              {
                ...
                succeeded = mercury__term__term_list_to_var_list_2_p_0(TypeCtorInfo_8_44, TypeTerms_42, &Range_9);
              }
              if (succeeded)
              {
                MR_Word Var_17;
