                    ...
                    if (succeeded)
                    {
                      ...
                      if (succeeded)
                      {
                        ...
                        if (succeeded)
                        {
                          ...
                          succeeded = ((MR_tag((MR_Word) Var_95)) == (MR_Integer) 1);
                          if (succeeded)
                          {
...
{
  {
    MR_bool succeeded = ((MR_tag((MR_Word) ArgTerms_9)) == (MR_Integer) 1);
    MR_Word ArgTerm_13;
    MR_Word Var_23;
...
{
  {
    ...
    succeeded = ((MR_tag((MR_Word) UnboundTVars_19)) == (MR_Integer) 1);
    if (succeeded)
    {
      {
...
{
  {
    ...
    if (succeeded)
    {
      ...
      succeeded = ((MR_tag((MR_Word) MaybeClassMethods_16)) == (MR_Integer) 1);
      if (succeeded)
