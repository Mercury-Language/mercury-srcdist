  ...
  if (succeeded)
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          DomainTerm_7 = ((MR_Word) ((MR_hl_field(1, Var_17, 0))));
          Var_18 = ((MR_Word) ((MR_hl_field(1, Var_17, 1))));
          succeeded = (Var_18 != (MR_Word) ((MR_Unsigned) 0U));
          if (succeeded)
          {
            RangeTerm_8 = ((MR_Word) ((MR_hl_field(1, Var_18, 0))));
