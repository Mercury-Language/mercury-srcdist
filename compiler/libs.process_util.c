...
{
#line 264 "process_util.m"

    IO = IO0;
    raise(Signal);
;}
#line 246 "libs.process_util.c"
...
{
#line 247 "process_util.m"

    IO = IO0;
    Signalled = (MC_signalled ? 1 : 0);
    Signal = MC_signal_received;
;}
#line 375 "libs.process_util.c"
