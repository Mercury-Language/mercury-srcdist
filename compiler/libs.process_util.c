...
#line 53 "libs.process_util.c"
#ifndef LIBS__PROCESS_UTIL_DECL_GUARD
#define LIBS__PROCESS_UTIL_DECL_GUARD

#line 57 "libs.process_util.c"
#line 160 "process_util.m"
...
{
#line 287 "process_util.m"

    IO = IO0;
    Signalled = (MC_signalled ? 1 : 0);
    Signal = MC_signal_received;
;}
#line 432 "libs.process_util.c"
