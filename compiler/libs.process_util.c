...
#undef MR_PROC_LABEL
  ...
  func_0 = ((void MR_CALL (*)(MR_Box, MR_Box *, MR_Box, MR_Box *)) ((MR_hl_field(0, P_5, 1))));
...
#undef MR_PROC_LABEL
	...
	WStatus_23  = Status;
      ...
      if (succeeded)
      {
        ...
        {
          MR_Word Status_13 = ((MR_Word) ((MR_hl_field(0, WaitRes_12, 0))));
          MR_Integer Var_19;

          succeeded = ((MR_tag((MR_Word) Status_13)) == (MR_Integer) 0);
          if (succeeded)
          {
            Var_19 = ((MR_Integer) ((MR_hl_field(0, Status_13, 0))));
  ...
  {
    void MR_CALL (* func_0)(MR_Box, MR_Box *, MR_Box, MR_Box *) = ((void MR_CALL (*)(MR_Box, MR_Box *, MR_Box, MR_Box *)) ((MR_hl_field(0, AltP_7, 1))));
    MR_Box conv2_Succeeded_8;
...
#undef MR_PROC_LABEL
  ...
  if (succeeded)
  {
    ...
    MR_Box conv1_STATE_VARIABLE_IO_5_33;
    ...
    *Succeeded_14 = (MR_Integer) 0;
    ...
    func_0 = ((void MR_CALL (*)(MR_Box, MR_Box, MR_Box *, MR_Box, MR_Box *)) ((MR_hl_field(0, Cleanup_12, 1))));
    func_0(((MR_Box) (Cleanup_12)), STATE_VARIABLE_Info_0_20, STATE_VARIABLE_Info_21, ((MR_Box) ((MR_Integer) 0)), &conv1_STATE_VARIABLE_IO_5_33);
{
#define MR_PROC_LABEL libs__process_util__teardown_checking_for_interrupt_9_p_0
