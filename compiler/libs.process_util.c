...
static const MR_VA_PseudoTypeInfo_Struct5 libs__process_util____vpti_pred_5__plain_libs__maybe_succeeded__type_ctor_info_maybe_succeeded_0__pseudo_1__pseudo_1__plain_io__type_ctor_info_state_0__plain_io__type_ctor_info_state_0;

static const MR_VA_TypeInfo_Struct3 libs__process_util____vti_pred_3libs__maybe_succeeded__type_ctor_info_maybe_succeeded_0io__type_ctor_info_state_0io__type_ctor_info_state_0;
...
static /* final */ const MR_Box libs__process_util_scalar_common_2[1][1];
...
const MR_TypeCtorInfo_Struct libs__process_util__libs__process_util__type_ctor_info_build0_1 = {
  ...
  (MR_String) "build0",
  {     NULL },
  {     (MR_PseudoTypeInfo) (&libs__process_util____vpti_pred_5__plain_libs__maybe_succeeded__type_ctor_info_maybe_succeeded_0__pseudo_1__pseudo_1__plain_io__type_ctor_info_state_0__plain_io__type_ctor_info_state_0) },
  (MR_Integer) -1,
  UINT16_C(0),
  NULL,
...
const MR_TypeCtorInfo_Struct libs__process_util__libs__process_util__type_ctor_info_io_pred_0 = {
  ...
  (MR_String) "io_pred",
  {     NULL },
  {     (MR_PseudoTypeInfo) (&libs__process_util____vti_pred_3libs__maybe_succeeded__type_ctor_info_maybe_succeeded_0io__type_ctor_info_state_0io__type_ctor_info_state_0) },
  (MR_Integer) -1,
  UINT16_C(0),
  NULL,
...
{
  {
    ...
    MR_Box STATE_VARIABLE_Info_25_25;
...
#undef MR_PROC_LABEL
    ...
    func_0(((MR_Box) (Build_10)), &conv2_Succeeded0_16, STATE_VARIABLE_Info_0_20, &STATE_VARIABLE_Info_25_25, ((MR_Box) ((MR_Integer) 0)), &conv1_STATE_VARIABLE_IO_26_26);
...
#undef MR_PROC_LABEL
    ...
    if (succeeded)
    {
      ...
      *Succeeded_12 = (MR_Integer) 0;
        ...
        case (MR_Integer) 1:
          {
            ...
            mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&libs__process_util_scalar_common_2[0]), Signal_18, &Var_42);
            mercury__io__write_string_4_p_0(StdErr_19, Var_42);
      ...
      func_3(((MR_Box) (Cleanup_11)), STATE_VARIABLE_Info_25_25, STATE_VARIABLE_Info_21, ((MR_Box) ((MR_Integer) 0)), &conv4_STATE_VARIABLE_IO_36_36);
{
#define MR_PROC_LABEL libs__process_util__build_with_check_for_interrupt_8_p_0
