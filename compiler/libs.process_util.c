...
MR_decl_static(libs__process_util__do_call_in_forked_process_5_0)
...
{
#line 266 "process_util.m"

    IO = IO0;
    raise(Signal);
;}
#line 255 "libs.process_util.c"
...
{
#line 249 "process_util.m"

    IO = IO0;
    Signalled = (MC_signalled ? 1 : 0);
    Signal = MC_signal_received;
;}
#line 384 "libs.process_util.c"
...
MR_BEGIN_MODULE(libs__process_util_module6)
	MR_init_entry1(libs__process_util__do_call_in_forked_process_5_0);
MR_BEGIN_CODE
	...
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(libs__process_util__do_call_in_forked_process_5_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(1);
	MR_sv(1) = (MR_Word) MR_succip;
	{
	MR_Word	Pred;
	MR_Integer	ForkStatus;
	MR_Integer	Status;
	MR_Word	IO0;
	MR_Word	IO;
#define	MR_PROC_LABEL	mercury__libs__process_util__do_call_in_forked_process_5_0
	Pred = MR_r1;
	MR_save_registers();
	MR_OBTAIN_GLOBAL_LOCK("do_call_in_forked_process");
{
#line 321 "process_util.m"
{
#ifdef MC_CAN_FORK
    pid_t   child_pid;
...
#line 731 "libs.process_util.c"
	MR_RELEASE_GLOBAL_LOCK("do_call_in_forked_process");
...
void mercury__libs__process_util__write_out_proc_statics(FILE *fp);
#endif
