...
#define MR_PROC_LABEL libs__process_util__call_child_process_io_pred_4_p_0
    ...
    MR_init_signal_action(&Result, SIG_DFL, MR_FALSE, MR_TRUE);
		...
		;}
#undef MR_PROC_LABEL
	MR_MAYBE_BOX_FOREIGN_TYPE(MR_signal_action, Result, Var_15 );
}
{
#define MR_PROC_LABEL libs__process_util__call_child_process_io_pred_4_p_0
	...
	MR_MAYBE_UNBOX_FOREIGN_TYPE(MR_signal_action, Var_15 , SigintHandler);
		{
...
#undef MR_PROC_LABEL
    ...
    succeeded = (Pid_25 == (MR_Integer) 0);
    if (succeeded)
      *Succeeded_8 = (MR_Integer) 0;
    else
    {
      MR_String Error_31;
      MR_Integer WStatus_33;
      MR_Integer _MaybeWaitedPid_32;
...
#undef MR_PROC_LABEL
	Error_31  = Error;
	_MaybeWaitedPid_32  = MaybeWaitedPid;
	WStatus_33  = Status;
}
      succeeded = (strcmp(Error_31, (MR_String) "") == 0);
      if (succeeded)
      {
        MR_Word WaitRes_12;

        WaitRes_12 = mercury__io__call_system__decode_system_command_exit_code_1_f_0(WStatus_33);
      ...
      else
      {
        ...
        Var_35 = mercury__io__make_io_error_1_f_0(Error_31);
        *Succeeded_8 = (MR_Integer) 0;
      }
    }
  }
      ...
      case (MR_Integer) 1:
        {
          ...
          mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&libs__process_util_scalar_common_2[0]), Signal_18, &Var_39);
          mercury__io__write_string_4_p_0(StdErr_19, Var_39);
          mercury__io__write_string_4_p_0(StdErr_19, (MR_String) ", cleaning up.\n");
        }
        break;
    }
    func_0 = ((void MR_CALL (*)(MR_Box, MR_Box, MR_Box *, MR_Box, MR_Box *)) ((MR_hl_field(MR_mktag(0), Cleanup_12, (MR_Integer) 1))));
