                            ...
                            if (erl_backend__erl_rtti__succeeded)
                            ...
                            else
                              {
                                ...
                                }
                                {
                                  ...
                                  MR_hl_field(MR_mktag(0), erl_backend__erl_rtti__Var_32, 0) = ((MR_Box) (&erl_backend__erl_rtti_scalar_common_8[0]));
...
{
  {
    ...
    {
      erl_backend__erl_rtti__MaterialiseDummyOutputVars_24 = mercury__list__map_2_f_0(erl_backend__erl_rtti__TypeInfo_121_121, (MR_Word) &erl_backend__elds__erl_backend__elds__type_ctor_info_elds_expr_0, (MR_Word) &erl_backend__erl_rtti_scalar_common_3[7], erl_backend__erl_rtti__DummyOutputVars_23);
    }
    {
...
{
  {
      ...
      case (MR_Integer) 1:
        {
          ...
          {
            erl_backend__erl_rtti__ELDSArgTypeInfos_13 = mercury__list__map_2_f_0(erl_backend__erl_rtti__TypeCtorInfo_22_68, (MR_Word) &erl_backend__elds__erl_backend__elds__type_ctor_info_elds_expr_0, (MR_Word) &erl_backend__erl_rtti_scalar_common_3[5], erl_backend__erl_rtti__ArgTypeInfos_12);
          }
          {
      ...
      case (MR_Integer) 2:
        {
          ...
          {
            erl_backend__erl_rtti__ELDSArgTypeInfos_48 = mercury__list__map_2_f_0(erl_backend__erl_rtti__TypeCtorInfo_22_89, (MR_Word) &erl_backend__elds__erl_backend__elds__type_ctor_info_elds_expr_0, (MR_Word) &erl_backend__erl_rtti_scalar_common_3[6], erl_backend__erl_rtti__ArgTypeInfos_47);
          }
          {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), erl_backend__erl_rtti__Var_37, 0) = ((MR_Box) (MR_mkword(MR_mktag(2), &erl_backend__erl_rtti_scalar_common_6[1])));
...
{
  {
      ...
      case (MR_Integer) 1:
        {
          ...
          {
            erl_backend__erl_rtti__ELDSArgTypeInfos_13 = mercury__list__map_2_f_0(erl_backend__erl_rtti__TypeCtorInfo_20_64, (MR_Word) &erl_backend__elds__erl_backend__elds__type_ctor_info_elds_expr_0, (MR_Word) &erl_backend__erl_rtti_scalar_common_3[3], erl_backend__erl_rtti__ArgTypeInfos_12);
          }
          {
      ...
      case (MR_Integer) 2:
        {
          ...
          {
            erl_backend__erl_rtti__ELDSArgTypeInfos_46 = mercury__list__map_2_f_0(erl_backend__erl_rtti__TypeCtorInfo_20_83, (MR_Word) &erl_backend__elds__erl_backend__elds__type_ctor_info_elds_expr_0, (MR_Word) &erl_backend__erl_rtti_scalar_common_3[4], erl_backend__erl_rtti__ArgTypeInfos_45);
          }
          {
    ...
    {
      erl_backend__erl_rtti__Var_35 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), erl_backend__erl_rtti__Var_35, 0) = ((MR_Box) (MR_mkword(MR_mktag(2), &erl_backend__erl_rtti_scalar_common_6[0])));
...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(0), erl_backend__erl_rtti__Var_44, 0) = ((MR_Box) (&erl_backend__erl_rtti_scalar_common_4[1]));
          ...
          case (MR_Integer) 0:
            {
...

              {
                ...
                MR_hl_field(MR_mktag(0), erl_backend__erl_rtti__Var_24, 0) = ((MR_Box) (&erl_backend__erl_rtti_scalar_common_4[0]));
...
{
  {
...

    {
      ...
      MR_hl_field(MR_mktag(0), erl_backend__erl_rtti__Var_8, 0) = ((MR_Box) (&erl_backend__erl_rtti_scalar_common_2[0]));
