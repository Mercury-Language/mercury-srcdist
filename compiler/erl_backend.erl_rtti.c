...
{
  {
    ...
    MR_Word Var_64;
    MR_Word Var_65;
    MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), RttiProcLabel_9, (MR_Integer) 0)));
    MR_Unsigned packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), RttiProcLabel_9, (MR_Integer) 10)));
    MR_Unsigned packed_word_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), RttiProcLabel_9, (MR_Integer) 12)));
...
{
  {
    ...
    if (succeeded)
    {
      ...
      succeeded = ((((MR_tag((MR_Word) Var_22)) == (MR_Integer) 3)) && ((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), Var_22, (MR_Integer) 0))) == (MR_Integer) 14)));
      if (succeeded)
      {
            ...
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                ...
                if (succeeded)
                {
                  ...
                  succeeded = ((((MR_tag((MR_Word) Var_27)) == (MR_Integer) 3)) && ((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), Var_27, (MR_Integer) 0))) == (MR_Integer) 13)));
                  if (succeeded)
                  {
...
{
  {
    ...
    MR_Word Var_42;
    MR_Word Var_43;
    MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), RttiProcLabel_7, (MR_Integer) 0)));
    MR_Unsigned packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), RttiProcLabel_7, (MR_Integer) 10)));
    MR_Unsigned packed_word_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), RttiProcLabel_7, (MR_Integer) 12)));
                ...
                case (MR_Integer) 1:
                  {
                    ...
                    MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), Var_110, (MR_Integer) 0)));
      ...
      case (MR_Integer) 2:
        {
          ...
          MR_Word Var_81;
          MR_Word Var_82;
          MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), TypeInfo_5, (MR_Integer) 0)));
...
{
  {
    ...
    MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Functor_4, (MR_Integer) 6)));
          ...
          case (MR_Integer) 0:
            {
              ...
              MR_Unsigned packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Details_9, (MR_Integer) 0)));
                ...
                case (MR_Integer) 1:
                  {
                    ...
                    succeeded = ((MR_tag((MR_Word) Functors_17)) == (MR_Integer) 1);
                    if (succeeded)
                    {
          ...
          case (MR_Integer) 2:
            {
              ...
              MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), Details_9, (MR_Integer) 0)));
            ...
            break;
          case (MR_Integer) 3:
            switch (((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), Details_9, (MR_Integer) 0)))) {
              default: /*NOTREACHED*/ MR_assert(0);
              case (MR_Integer) 0:
                {
                  ...
                  MR_Word Var_57;
                  MR_Word Var_59;
                  MR_Unsigned packed_word_3 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Details_9, (MR_Integer) 1)));
                  MR_Unsigned packed_word_4 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), NoTagFunctor_34, (MR_Integer) 3)));
                  ...
                  Var_57 = (MR_Word) (Name_35);
                  {
                    ...
                    MR_hl_field(MR_mktag(0), DUFunctor_45, 1) = ((MR_Box) ((MR_Integer) 1));
                    MR_hl_field(MR_mktag(0), DUFunctor_45, 2) = ((MR_Box) ((MR_Integer) 0));
                    MR_hl_field(MR_mktag(0), DUFunctor_45, 3) = ((MR_Box) ((MR_Integer) 0));
              ...
              case (MR_Integer) 3:
                {
                  ...
                  MR_Word Var_50;
                  MR_Unsigned packed_word_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Details_9, (MR_Integer) 1)));
