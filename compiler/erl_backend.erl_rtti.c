...
{
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        succeeded = ((MR_tag((MR_Word) ModuleName_6)) == (MR_mktag((MR_Integer) 0)));
        if (succeeded)
        {
                ...
                case (MR_Integer) 1:
                  {
                    ...
                    succeeded = ((MR_tag((MR_Word) Functors_16)) == (MR_mktag((MR_Integer) 1)));
                    if (succeeded)
                    {
              ...
              case (MR_Integer) 0:
                {
                  ...
                  if (((MR_tag((MR_Word) TypeInfo_36)) == (MR_mktag((MR_Integer) 1))))
                  {
