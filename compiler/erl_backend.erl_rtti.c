...
{
  {
    ...
    MR_Word Detism_16 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), RttiProcLabel_9, (MR_Integer) 10))) >> (MR_Integer) 2)) & (MR_Integer) 7);
    MR_Word TCIVar_17;
    MR_Word Ws_18;
    ...
    MR_Word Var_64;
    MR_Word Var_65;
    MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), RttiProcLabel_9, (MR_Integer) 0)));
    MR_Unsigned packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), RttiProcLabel_9, (MR_Integer) 10)));
    MR_Unsigned packed_args_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), RttiProcLabel_9, (MR_Integer) 12)));
...
{
  {
    ...
    MR_Word Detism_14 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), RttiProcLabel_7, (MR_Integer) 10))) >> (MR_Integer) 2)) & (MR_Integer) 7);
    MR_Word Ws_15;
    ...
    MR_Word Var_42;
    MR_Word Var_43;
    MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), RttiProcLabel_7, (MR_Integer) 0)));
    MR_Unsigned packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), RttiProcLabel_7, (MR_Integer) 10)));
    MR_Unsigned packed_args_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), RttiProcLabel_7, (MR_Integer) 12)));
                ...
                case (MR_Integer) 1:
                  {
                    ...
                    MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), Var_110, (MR_Integer) 0)));
      ...
      case (MR_Integer) 2:
        {
          ...
          MR_Word Var_81;
          MR_Word Var_82;
          MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), TypeInfo_5, (MR_Integer) 0)));
...
{
  {
    ...
    MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Functor_4, (MR_Integer) 6)));

    {
      ...
      *ErlangFunctor_6 = base;
      ...
      MR_hl_field(MR_mktag(0), base, 7) = (MR_Box) (packed_args_0);
    }
  }
}
    ...
    else
    {
      ...
      if (succeeded)
        ...
        switch (MR_tag((MR_Word) Details_9)) {
          ...
          case (MR_Integer) 0:
            {
              MR_Word Functors_16 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Details_9, (MR_Integer) 1))));
              MR_Word IsDummy_19 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Details_9, (MR_Integer) 4))) & (MR_Integer) 1);
              MR_Word FunctorNums_20 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Details_9, (MR_Integer) 5))));
              MR_Unsigned packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Details_9, (MR_Integer) 0)));
              MR_Unsigned packed_args_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Details_9, (MR_Integer) 4)));
                ...
                case (MR_Integer) 1:
                  {
                    ...
                    succeeded = ((MR_tag((MR_Word) Functors_16)) == (MR_Integer) 1);
                    if (succeeded)
                    {
                      F_21 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Functors_16, (MR_Integer) 0))));
                      Var_66 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Functors_16, (MR_Integer) 1))));
                    ...
                    if (succeeded)
                    {
                      ...
                      {
                        D_10 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
          ...
          case (MR_Integer) 2:
            {
              ...
              MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), Details_9, (MR_Integer) 0)));
              ...
              case (MR_Integer) 0:
                {
                  ...
                  MR_Word Var_57;
                  MR_Word Var_59;
                  MR_Unsigned packed_args_4 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Details_9, (MR_Integer) 1)));
                  MR_Unsigned packed_args_5 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), NoTagFunctor_34, (MR_Integer) 3)));
                  ...
                  if (((MR_tag((MR_Word) TypeInfo_36)) == (MR_Integer) 1))
                  {
                    ...
                    {
                      ArgTypeInfo_42 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
                  ...
                  else
                  {
                    ...
                    {
                      ArgTypeInfo_42 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
                  ...
                  {
                    ArgInfos_44 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                  ...
                  {
                    DUFunctor_45 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 8 * sizeof(MR_Word)), NULL, NULL);
                    ...
                    MR_hl_field(MR_mktag(0), DUFunctor_45, 7) = (MR_Box) (packed_args_5);
                  }
                  {
              ...
              case (MR_Integer) 1:
                {
                  ...
                  {
                    D_10 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
              ...
              case (MR_Integer) 3:
                {
                  ...
                  MR_Word Var_50;
                  MR_Unsigned packed_args_3 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Details_9, (MR_Integer) 1)));
