              ...
              case (MR_Integer) 0:
                {
                  ...
                  MR_Unsigned packed_args_4 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), NoTagFunctor_34, (MR_Integer) 3)));
                  ...
                  Var_57 = (MR_Word) (Name_35);
                  {
                    ...
                    MR_hl_field(MR_mktag(0), DUFunctor_45, 7) = (MR_Box) (packed_args_4);
                  }
                  {
              ...
              case (MR_Integer) 3:
                {
                  ...
                  MR_Word Var_50;
                  MR_Unsigned packed_args_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Details_9, (MR_Integer) 1)));
