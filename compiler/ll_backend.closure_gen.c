  ...
  MR_Word * STATE_VARIABLE_CLD_46)
{
  ...
  MR_Word CallCodeModel_37;
  MR_Word Globals_38;
  MR_Word Deep_39;
  MR_Word UseFloatRegs_40;
  MR_Word Var_47;
  MR_Word Var_48;
  MR_Word Var_49;
  MR_Word Var_50;
  ...
  ll_backend__code_info__get_module_info_2_p_0(STATE_VARIABLE_CI_0_43, &ModuleInfo_19);
  ...
  mercury__map__lookup_3_p_0((MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_proc_id_0), (MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_proc_info_0), Procs_21, ((MR_Box) (ProcId_12)), &conv0_ProcInfo_22);
  ProcInfo_22 = ((MR_Word) (conv0_ProcInfo_22));
  hlds__hlds_pred__proc_info_get_goal_2_p_0(ProcInfo_22, &ProcInfoGoal_23);
  CodeModel_24 = hlds__code_model__proc_info_interface_code_model_1_f_0(ProcInfo_22);
  hlds__hlds_pred__proc_info_get_headvars_2_p_0(ProcInfo_22, &ProcHeadVars_25);
  succeeded = (Args_14 != (MR_Word) ((MR_Unsigned) 0U));
  if (succeeded)
  {
    CallPred_26 = ((MR_Word) ((MR_hl_field(1, Args_14, (MR_Integer) 0))));
    CallArgs_27 = ((MR_Word) ((MR_hl_field(1, Args_14, (MR_Integer) 1))));
    succeeded = (ProcHeadVars_25 != (MR_Word) ((MR_Unsigned) 0U));
    if (succeeded)
    {
      ProcPred_28 = ((MR_Word) ((MR_hl_field(1, ProcHeadVars_25, (MR_Integer) 0))));
      ProcArgs_29 = ((MR_Word) ((MR_hl_field(1, ProcHeadVars_25, (MR_Integer) 1))));
      Var_47 = ((MR_Word) ((MR_hl_field(0, ProcInfoGoal_23, (MR_Integer) 0))));
      succeeded = ((((MR_tag((MR_Word) Var_47)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(3, Var_47, (MR_Integer) 0)))) == (MR_Integer) 0)));
      if (succeeded)
      {
        Var_48 = ((MR_Word) ((MR_hl_field(3, Var_47, (MR_Integer) 1))));
        Var_54 = ((MR_Word) ((MR_hl_field(3, Var_47, (MR_Integer) 2))));
        CallDeterminism_35 = ((MR_Unsigned) ((MR_hl_field(3, Var_47, (MR_Integer) 5))) & (MR_Integer) 7);
        TypeInfo_56_56 = (MR_Word) (&ll_backend__closure_gen_scalar_common_1[1]);
        succeeded = mercury__builtin__unify_2_p_0(TypeInfo_56_56, ((MR_Box) (ProcArgs_29)), ((MR_Box) (Var_54)));
        if (succeeded)
        {
          succeeded = ((MR_tag((MR_Word) Var_48)) == (MR_Integer) 0);
          if (succeeded)
          {
            Var_55 = ((MR_Word) ((MR_hl_field(0, Var_48, (MR_Integer) 0))));
            TypeInfo_57_57 = (MR_Word) (&ll_backend__closure_gen_scalar_common_1[0]);
            succeeded = mercury__builtin__unify_2_p_0(TypeInfo_57_57, ((MR_Box) (ProcPred_28)), ((MR_Box) (Var_55)));
            if (succeeded)
            {
              hlds__code_model__determinism_to_code_model_2_p_0(CallDeterminism_35, &CallCodeModel_37);
              succeeded = (CodeModel_24 == CallCodeModel_37);
              if (!(succeeded))
              {
                succeeded = (CodeModel_24 == (MR_Integer) 2);
                if (succeeded)
                  succeeded = (CallCodeModel_37 == (MR_Integer) 0);
              }
              if (succeeded)
              {
                hlds__hlds_module__module_info_get_globals_2_p_0(ModuleInfo_19, &Globals_38);
                Var_49 = (MR_Integer) 266;
                libs__globals__lookup_bool_option_3_p_0(Globals_38, Var_49, &Deep_39);
                succeeded = (Deep_39 == (MR_Integer) 0);
                if (succeeded)
                {
                  Var_50 = (MR_Integer) 329;
                  libs__globals__lookup_bool_option_3_p_0(Globals_38, Var_50, &UseFloatRegs_40);
                  succeeded = (UseFloatRegs_40 == (MR_Integer) 0);
                }
              }
            }
          }
  ...
  if (succeeded)
    if ((CallArgs_27 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      ll_backend__code_loc_dep__assign_var_to_var_4_p_0(Var_13, CallPred_26, STATE_VARIABLE_CLD_0_45, STATE_VARIABLE_CLD_46);
      ...
      *STATE_VARIABLE_CI_44 = STATE_VARIABLE_CI_0_43;
      ...
      ll_backend__closure_gen__generate_new_closure_from_old_9_p_0(Var_13, CallPred_26, CallArgs_27, GoalInfo_15, Code_16, STATE_VARIABLE_CI_0_43, STATE_VARIABLE_CI_44, STATE_VARIABLE_CLD_0_45, STATE_VARIABLE_CLD_46);
  else
    ll_backend__closure_gen__generate_closure_from_scratch_13_p_0(ModuleInfo_19, PredId_11, ProcId_12, PredInfo_20, ProcInfo_22, Var_13, Args_14, GoalInfo_15, Code_16, STATE_VARIABLE_CI_0_43, STATE_VARIABLE_CI_44, STATE_VARIABLE_CLD_0_45, STATE_VARIABLE_CLD_46);
}
  ...
  MR_Word * STATE_VARIABLE_CLD_61)
{
  ...
  ll_backend__code_info__maybe_add_alloc_site_info_6_p_0(Context_30, (MR_String) "closure", Var_81, &MaybeAllocId_57, STATE_VARIABLE_CI_68_68, &STATE_VARIABLE_CI_82_82);
  ll_backend__code_loc_dep__assign_cell_to_var_13_p_0(Var_19, (MR_Integer) 0, (MR_Word) (((MR_Box) (MR_Word) (UINT8_C(0)))), CellArgs_54, (MR_Word) ((MR_Unsigned) 0U), (MR_Word) ((MR_Unsigned) 0U), MaybeAllocId_57, MayUseAtomic_49, Code_22, STATE_VARIABLE_CI_82_82, STATE_VARIABLE_CI_59, STATE_VARIABLE_CLD_0_60, STATE_VARIABLE_CLD_61);
}
  ...
  MR_Word * STATE_VARIABLE_CLD_41)
{
  ...
  Var_84 = (MR_Word) (MR_mkword(1, &ll_backend__closure_gen_scalar_common_2[6]));
  {
    ...
    MR_hl_field(0, Var_87, 0) = ((MR_Box) (NumOldArgs_20));
  }
  {
  ...
  }
  {
    ...
    MR_hl_field(3, Var_127, 3) = ((MR_Box) (NumNewArgs_Rval_27));
  }
  {
  ...
  }
  {
    ...
    MR_hl_field(3, Var_135, 1) = ((MR_Box) (NumOldArgs_20));
  ...
  ll_backend__closure_gen__generate_extra_closure_args_7_p_0(CallArgs_12, LoopCounter_19, NewClosure_21, &ExtraArgsCode_36, *STATE_VARIABLE_CI_39, STATE_VARIABLE_CLD_61_61, &STATE_VARIABLE_CLD_196_196);
  ll_backend__code_loc_dep__release_reg_3_p_0(LoopCounter_19, STATE_VARIABLE_CLD_196_196, &STATE_VARIABLE_CLD_197_197);
  ll_backend__code_loc_dep__release_reg_3_p_0(NumOldArgs_20, STATE_VARIABLE_CLD_197_197, &STATE_VARIABLE_CLD_198_198);
  ll_backend__code_loc_dep__release_reg_3_p_0(NewClosure_21, STATE_VARIABLE_CLD_198_198, &STATE_VARIABLE_CLD_199_199);
  ll_backend__code_loc_dep__assign_lval_to_var_6_p_0(Var_10, NewClosure_21, &AssignCode_37, *STATE_VARIABLE_CI_39, STATE_VARIABLE_CLD_199_199, STATE_VARIABLE_CLD_41);
  Var_202 = mercury__cord__f_43_43_2_f_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_instruction_0), ExtraArgsCode_36, AssignCode_37);
