  ...
  MR_Word * STATE_VARIABLE_CLD_7)
{
  ...
  else
  {
      ...
      case (MR_Integer) 1:
        {
          ...
          ll_backend__code_loc_dep__produce_variable_5_p_0(Var_14, &ProduceCode_24, &Value_25, STATE_VARIABLE_CLD_0_6, &STATE_VARIABLE_CLD_37_37);
          {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(3), Var_49, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &ll_backend__closure_gen_scalar_common_2[6])));
