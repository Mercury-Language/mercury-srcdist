  ...
  MR_Word * STATE_VARIABLE_CLD_49)
{
  ...
  if (succeeded)
  {
    CallPredVar_26 = ((MR_Word) ((MR_hl_field(1, ArgVars_14, (MR_Integer) 0))));
    CallArgVars_27 = ((MR_Word) ((MR_hl_field(1, ArgVars_14, (MR_Integer) 1))));
    succeeded = (ProcHeadVars_25 != (MR_Word) ((MR_Unsigned) 0U));
    if (succeeded)
    {
      HOVar_28 = ((MR_Word) ((MR_hl_field(1, ProcHeadVars_25, (MR_Integer) 0))));
      ProcArgVars_29 = ((MR_Word) ((MR_hl_field(1, ProcHeadVars_25, (MR_Integer) 1))));
      GoalExpr_30 = ((MR_Word) ((MR_hl_field(0, ProcInfoGoal_23, (MR_Integer) 0))));
      succeeded = ((((MR_tag((MR_Word) GoalExpr_30)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(3, GoalExpr_30, (MR_Integer) 0)))) == (MR_Integer) 0)));
      if (succeeded)
      {
        GenericCall_32 = ((MR_Word) ((MR_hl_field(3, GoalExpr_30, (MR_Integer) 1))));
        Var_55 = ((MR_Word) ((MR_hl_field(3, GoalExpr_30, (MR_Integer) 2))));
        CallDeterminism_35 = ((MR_Unsigned) ((MR_hl_field(3, GoalExpr_30, (MR_Integer) 5))) & (MR_Integer) 7);
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            Var_56 = ((MR_Word) ((MR_hl_field(0, GenericCall_32, (MR_Integer) 0))));
  ...
  MR_Word * STATE_VARIABLE_CLD_61)
{
  ...
  ll_backend__closure_gen__generate_pred_args_8_p_0(STATE_VARIABLE_CI_68_68, VarTable_45, ArgVars_20, ArgInfo_44, &ArgsR_47, &ArgsF_48, MayUseAtomic0_46, &MayUseAtomic_49);
  ...
  MR_Word * STATE_VARIABLE_CLD_41)
{
  ...
  ll_backend__code_loc_dep__acquire_reg_4_p_0((MR_Integer) 0, &NumOldArgVars_20, STATE_VARIABLE_CLD_45_45, &STATE_VARIABLE_CLD_47_47);
  ...
  ll_backend__code_loc_dep__produce_variable_5_p_0(CallPredVar_11, &OldClosureCode_30, &OldClosure_31, STATE_VARIABLE_CLD_49_49, &STATE_VARIABLE_CLD_61_61);
  Context_32 = hlds__hlds_goal__goal_info_get_context_1_f_0(GoalInfo_13);
  ll_backend__code_info__maybe_add_alloc_site_info_6_p_0(Context_32, (MR_String) "closure", NumNewArgVarsPlusThree_28, &MaybeAllocId_33, STATE_VARIABLE_CI_43_43, STATE_VARIABLE_CI_39);
  ...
  ll_backend__closure_gen__generate_extra_closure_args_7_p_0(CallArgVars_12, LoopCounter_19, NewClosure_21, &ExtraArgVarsCode_36, *STATE_VARIABLE_CI_39, STATE_VARIABLE_CLD_61_61, &STATE_VARIABLE_CLD_196_196);
  ll_backend__code_loc_dep__release_reg_3_p_0(LoopCounter_19, STATE_VARIABLE_CLD_196_196, &STATE_VARIABLE_CLD_197_197);
  ll_backend__code_loc_dep__release_reg_3_p_0(NumOldArgVars_20, STATE_VARIABLE_CLD_197_197, &STATE_VARIABLE_CLD_198_198);
