  ...
  if (succeeded)
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        TypeInfo__63_63 = (MR_Word) (&ll_backend__closure_gen_scalar_common_1[1]);
        succeeded = mercury__builtin__unify_2_p_0(TypeInfo__63_63, ((MR_Box) (ProcArgs_31)), ((MR_Box) (Var_61)));
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            ...
            TypeInfo__64_64 = (MR_Word) (&ll_backend__closure_gen_scalar_common_1[0]);
            succeeded = mercury__builtin__unify_2_p_0(TypeInfo__64_64, ((MR_Box) (ProcPred_30)), ((MR_Box) (Var_62)));
            if (succeeded)
            {
  ...
  MR_Word * STATE_VARIABLE_MayUseAtomic_8)
{
  ...
  else
  {
    ...
    else
    {
      ...
      parse_tree__var_table__lookup_var_entry_3_p_0(VarTable_2, Var_56, &Entry_38);
