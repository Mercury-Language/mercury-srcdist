      ...
      case (MR_Integer) 0:
        {
...

          {
            ...
            MR_hl_field(MR_mktag(3), Var_40, 1) = ((MR_Box) (FieldLval_21));
            MR_hl_field(MR_mktag(3), Var_40, 2) = ((MR_Box) (MR_mkword(MR_mktag(3), &ll_backend__closure_gen_scalar_common_1[2])));
          }
          {
            Var_39 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
            MR_hl_field(MR_mktag(0), Var_39, 0) = ((MR_Box) (Var_40));
            MR_hl_field(MR_mktag(0), Var_39, 1) = ((MR_Box) ((MR_String) "set new argument field (dummy type)"));
          }
      ...
      case (MR_Integer) 1:
        {
          ...
          ll_backend__code_loc_dep__produce_variable_5_p_0(Var_14, &ProduceCode_26, &Value_27, STATE_VARIABLE_CLD_0_6, &STATE_VARIABLE_CLD_45_45);
          {
            ...
            MR_hl_field(MR_mktag(3), Var_47, 1) = ((MR_Box) (FieldLval_21));
            MR_hl_field(MR_mktag(3), Var_47, 2) = ((MR_Box) (Value_27));
          }
          {
            Var_46 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
            MR_hl_field(MR_mktag(0), Var_46, 0) = ((MR_Box) (Var_47));
            MR_hl_field(MR_mktag(0), Var_46, 1) = ((MR_Box) ((MR_String) "set new argument field"));
          }
