  ...
  MR_Word * STATE_VARIABLE_MayUseAtomic_8)
{
  ...
  else
  {
    ...
    else
    {
      ...
      check_hlds__type_util__update_type_may_use_atomic_alloc_4_p_0(ModuleInfo_44, Type_40, STATE_VARIABLE_MayUseAtomic_0_7, &STATE_VARIABLE_MayUseAtomic_1_53);
