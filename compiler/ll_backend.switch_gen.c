        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              ...
              TypeCtorInfo__708_708 = (MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0);
              succeeded = ll_backend__lookup_switch__is_lookup_switch_10_p_0(TypeCtorInfo__708_708, BranchStart_48, Var_59, FilteredTaggedCases_42, GoalInfo_26, StoreMap_49, Var_60, &MaybeEnd1_50, &LookupSwitchInfo_51, STATE_VARIABLE_CI_0_54, &STATE_VARIABLE_CI_61_61);
            }
          }
        }
      }
