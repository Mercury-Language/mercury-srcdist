            ...
            case (MR_Integer) 1:
              {
                ...
                if (succeeded)
                {
                  ...
                  libs__globals__lookup_int_option_3_p_0(Globals_33, (MR_Integer) 447, &StringHashSwitchSize_53);
                  libs__globals__lookup_int_option_3_p_0(Globals_33, (MR_Integer) 448, &StringBinarySwitchSize_54);
            ...
            case (MR_Integer) 2:
              {
                ...
                libs__globals__lookup_int_option_3_p_0(Globals_33, (MR_Integer) 449, &TagSize_55);
