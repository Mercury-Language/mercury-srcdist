...
{
  {
    ...
    ll_backend__code_loc_dep__produce_variable_5_p_0(SwitchVar_12, &SwitchVarCode_27, &SwitchVarRval_28, STATE_VARIABLE_CLD_0_39, &STATE_VARIABLE_CLD_42_42);
            ...
            case (MR_Integer) 3:
              {
                ...
                libs__globals__lookup_int_option_3_p_0(Globals_33, (MR_Integer) 471, &TagSize_36);
...
{
  {
    ...
    if (succeeded)
    {
      ...
      libs__globals__lookup_int_option_3_p_0(Globals_15, (MR_Integer) 469, &StringHashSwitchSize_33);
      libs__globals__lookup_int_option_3_p_0(Globals_15, (MR_Integer) 470, &StringBinarySwitchSize_34);
...
{
  {
    ...
    MR_Word NeedBitVecCheck_43;
    MR_Word NeedRangeCheck_44;
    MR_Integer FirstVal_45;
    MR_Integer LastVal_46;
    MR_Word BranchStart_47;
    MR_Word StoreMap_48;
    ...
    MR_Word MaybeTraceInfo_38;
    MR_Integer LookupSize_39;
    MR_Integer ReqDensity_40;
    MR_Word FilteredTaggedCases_41;
    MR_Word FilteredCanFail_42;
    MR_Word Var_56;
    MR_Word Var_57;
    MR_Word Var_58;
    MR_Integer Var_59;
    ...
    if (succeeded)
    {
      ...
      Var_56 = (MR_Integer) 480;
      Var_57 = (MR_Integer) 1;
      succeeded = libs__globals__lookup_bool_option_3_p_1(Globals_18, Var_56, Var_57);
      if (succeeded)
      {
        ll_backend__code_info__get_maybe_trace_info_2_p_0(STATE_VARIABLE_CI_0_53, &MaybeTraceInfo_38);
        succeeded = (MaybeTraceInfo_38 == (MR_Word) ((MR_Unsigned) 0U));
        if (succeeded)
        {
          Var_58 = (MR_Integer) 467;
          libs__globals__lookup_int_option_3_p_0(Globals_18, Var_58, &LookupSize_39);
          succeeded = (NumConsIds_32 >= LookupSize_39);
          if (succeeded)
          {
            Var_59 = (MR_Integer) 1;
            ...
            if (succeeded)
            {
              Var_60 = (MR_Integer) 465;
              libs__globals__lookup_int_option_3_p_0(Globals_18, Var_60, &ReqDensity_40);
              backend_libs__switch_util__filter_out_failing_cases_if_needed_5_p_0(CodeModel_19, TaggedCases_25, &FilteredTaggedCases_41, CanFail_20, &FilteredCanFail_42);
              succeeded = backend_libs__switch_util__find_int_lookup_switch_params_11_p_0(ModuleInfo_17, SwitchVarType_23, FilteredCanFail_42, LowerLimit_35, UpperLimit_36, NumValues_37, ReqDensity_40, &NeedBitVecCheck_43, &NeedRangeCheck_44, &FirstVal_45, &LastVal_46);
              if (succeeded)
              {
                ll_backend__code_loc_dep__remember_position_2_p_0(STATE_VARIABLE_CLD_0_55, &BranchStart_47);
                hlds__hlds_llds__goal_info_get_store_map_2_p_0(GoalInfo_26, &StoreMap_48);
                Var_61 = (MR_Word) (&ll_backend__switch_gen_scalar_common_1[4]);
                Var_62 = (MR_Word) ((MR_Unsigned) 0U);
                TypeCtorInfo_89_89 = (MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0);
                succeeded = ll_backend__lookup_switch__is_lookup_switch_10_p_0(TypeCtorInfo_89_89, BranchStart_47, Var_61, FilteredTaggedCases_41, GoalInfo_26, StoreMap_48, Var_62, &MaybeEnd1_49, &LookupSwitchInfo_50, STATE_VARIABLE_CI_0_53, &STATE_VARIABLE_CI_63_63);
              }
            }
          }
        }
    ...
    if (succeeded)
    {
      ...
      ll_backend__code_loc_dep__reset_to_position_3_p_0(BranchStart_47, STATE_VARIABLE_CI_63_63, &STATE_VARIABLE_CLD_64_64);
      ll_backend__lookup_switch__generate_int_lookup_switch_14_p_0(SwitchVarRval_24, LookupSwitchInfo_50, EndLabel_27, StoreMap_48, FirstVal_45, LastVal_46, NeedBitVecCheck_43, NeedRangeCheck_44, MaybeEnd1_49, MaybeEnd_28, SwitchCode_29, STATE_VARIABLE_CI_63_63, STATE_VARIABLE_CI_54, STATE_VARIABLE_CLD_64_64);
    }
    else
    {
      ...
      MR_Integer Var_67;
      MR_Word Var_68;
      MR_Word IntSwitchInfo_72;
      MR_Integer LowerLimit_73;
      MR_Integer UpperLimit_74;
      MR_Integer NumValues_75;
      MR_Integer ReqDensity_76;

      succeeded = ((MR_tag((MR_Word) MaybeIntSwitchInfo_21)) == (MR_Integer) 1);
      if (succeeded)
      {
        IntSwitchInfo_72 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MaybeIntSwitchInfo_21, (MR_Integer) 0))));
        LowerLimit_73 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), IntSwitchInfo_72, (MR_Integer) 0))));
        UpperLimit_74 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), IntSwitchInfo_72, (MR_Integer) 1))));
        NumValues_75 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), IntSwitchInfo_72, (MR_Integer) 2))));
        Var_66 = (MR_Integer) 466;
        libs__globals__lookup_int_option_3_p_0(Globals_18, Var_66, &DenseSize_51);
        succeeded = (NumConsIds_32 >= DenseSize_51);
        if (succeeded)
        {
          Var_67 = (MR_Integer) 1;
          succeeded = (NumArms_33 > Var_67);
          if (succeeded)
          {
            Var_68 = (MR_Integer) 464;
            libs__globals__lookup_int_option_3_p_0(Globals_18, Var_68, &ReqDensity_76);
            succeeded = ll_backend__dense_switch__tagged_case_list_is_dense_switch_9_p_0(STATE_VARIABLE_CI_0_53, SwitchVarType_23, TaggedCases_25, LowerLimit_73, UpperLimit_74, NumValues_75, ReqDensity_76, CanFail_20, &DenseSwitchInfo_52);
          }
        }
      }
      if (succeeded)
    ...
    if ((CannotSucceedCases_12 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_32, (MR_Integer) 474, &SingleRecBaseFirst_41);
        ...
        else
        {
          ...
          if (succeeded)
          {
            ...
            libs__globals__lookup_bool_option_3_p_0(Globals_32, (MR_Integer) 475, &MultiRecBaseFirst_43);
