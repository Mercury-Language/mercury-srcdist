  ...
  MR_Word STATE_VARIABLE_CLD_0_43)
{
  ...
  if (succeeded)
    ll_backend__string_switch__generate_string_trie_switch_12_p_0(SwitchVarRval_19, SwitchVarName_21, TaggedCases_22, CodeModel_24, CanFail_25, GoalInfo_28, EndLabel_29, MaybeEnd_30, SwitchCode_31, STATE_VARIABLE_CI_0_41, STATE_VARIABLE_CI_42, STATE_VARIABLE_CLD_0_43);
  else
  {
    ...
    if (succeeded)
      if ((MaybeLookupSwitchInfo_35 == (MR_Word) ((MR_Unsigned) 0U)))
        ll_backend__string_switch__generate_string_hash_switch_12_p_0(SwitchVarRval_19, SwitchVarName_21, TaggedCases_22, CodeModel_24, CanFail_25, GoalInfo_28, EndLabel_29, MaybeEnd_30, SwitchCode_31, STATE_VARIABLE_CI_0_41, STATE_VARIABLE_CI_42, STATE_VARIABLE_CLD_0_43);
      else
      {
        MR_Word LookupSwitchInfo_39 = ((MR_Word) ((MR_hl_field(1, MaybeLookupSwitchInfo_35, (MR_Integer) 0))));

        ll_backend__string_switch__generate_string_hash_lookup_switch_8_p_0(SwitchVarRval_19, LookupSwitchInfo_39, FilteredCanFail_26, EndLabel_29, StoreMap_34, MaybeEnd_30, SwitchCode_31, STATE_VARIABLE_CI_42);
      }
    else
    {
      ...
      if (succeeded)
        if ((MaybeLookupSwitchInfo_35 == (MR_Word) ((MR_Unsigned) 0U)))
          ll_backend__string_switch__generate_string_binary_switch_12_p_0(SwitchVarRval_19, SwitchVarName_21, TaggedCases_22, CodeModel_24, CanFail_25, GoalInfo_28, EndLabel_29, MaybeEnd_30, SwitchCode_31, STATE_VARIABLE_CI_0_41, STATE_VARIABLE_CI_42, STATE_VARIABLE_CLD_0_43);
        else
        {
          MR_Word LookupSwitchInfo_52 = ((MR_Word) ((MR_hl_field(1, MaybeLookupSwitchInfo_35, (MR_Integer) 0))));

          ll_backend__string_switch__generate_string_binary_lookup_switch_8_p_0(SwitchVarRval_19, LookupSwitchInfo_52, FilteredCanFail_26, EndLabel_29, StoreMap_34, MaybeEnd_30, SwitchCode_31, STATE_VARIABLE_CI_42);
        }
      else
