...
MR_decl_label10(ll_backend__switch_gen__order_can_and_cannot_succeed_cases_5_0, 18,34,37,38,40,33,5,52,53,4)
MR_decl_label5(ll_backend__switch_gen__separate_cannot_succeed_cases_3_0, 28,4,5,6,8)
MR_decl_label6(ll_backend__switch_gen__separate_reserved_address_cases_3_0, 38,4,5,8,10,7)
MR_decl_label5(fn__ll_backend__switch_gen__estimate_cost_of_case_test_1_0, 2,3,5,7,10)
MR_decl_label2(fn__ll_backend__switch_gen__is_reserved_addr_tag_1_0, 3,5)
MR_decl_label4(fn__ll_backend__switch_gen__list_contains_reserved_addr_tag_1_0, 15,3,4,6)
MR_decl_static(fn__ll_backend__switch_gen__is_reserved_addr_tag_1_0)
...
MR_BEGIN_MODULE(ll_backend__switch_gen_module0)
	MR_init_entry1(fn__ll_backend__switch_gen__is_reserved_addr_tag_1_0);
	MR_INIT_PROC_LAYOUT_ADDR(mercury__fn__ll_backend__switch_gen__is_reserved_addr_tag_1_0);
	MR_init_label2(fn__ll_backend__switch_gen__is_reserved_addr_tag_1_0,3,5)
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'is_reserved_addr_tag'/2 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(fn__ll_backend__switch_gen__is_reserved_addr_tag_1_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_RTAGS_TESTR(MR_r1,3,7)) {
		MR_GOTO_LAB(fn__ll_backend__switch_gen__is_reserved_addr_tag_1_0_i3);
	}
	MR_r1 = MR_tfield(3, MR_r1, 2);
	MR_np_localtailcall(fn__ll_backend__switch_gen__is_reserved_addr_tag_1_0);
MR_def_label(fn__ll_backend__switch_gen__is_reserved_addr_tag_1_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_RTAGS_TESTR(MR_r1,3,15)) {
		MR_GOTO_LAB(fn__ll_backend__switch_gen__is_reserved_addr_tag_1_0_i5);
	}
	MR_r1 = (MR_Integer) 1;
	MR_proceed();
MR_def_label(fn__ll_backend__switch_gen__is_reserved_addr_tag_1_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Integer) 0;
	MR_proceed();
#ifdef MR_maybe_local_thread_engine_base
...
MR_BEGIN_MODULE(ll_backend__switch_gen_module1)
	...
	MR_init_label4(fn__ll_backend__switch_gen__list_contains_reserved_addr_tag_1_0,15,3,4,6)
MR_BEGIN_CODE
...
MR_def_label(fn__ll_backend__switch_gen__list_contains_reserved_addr_tag_1_0,15)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_def_label(fn__ll_backend__switch_gen__list_contains_reserved_addr_tag_1_0,3)
	...
	MR_np_call_localret_ent(fn__ll_backend__switch_gen__is_reserved_addr_tag_1_0,
		fn__ll_backend__switch_gen__list_contains_reserved_addr_tag_1_0_i4);
MR_def_label(fn__ll_backend__switch_gen__list_contains_reserved_addr_tag_1_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,1)) {
		MR_GOTO_LAB(fn__ll_backend__switch_gen__list_contains_reserved_addr_tag_1_0_i6);
	}
	MR_r1 = (MR_Integer) 1;
	MR_decr_sp_and_return(2);
MR_def_label(fn__ll_backend__switch_gen__list_contains_reserved_addr_tag_1_0,6)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(1);
	MR_succip_word = MR_sv(2);
	MR_GOTO_LAB(fn__ll_backend__switch_gen__list_contains_reserved_addr_tag_1_0_i15);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_thread_engine_base
#endif
...
MR_BEGIN_MODULE(ll_backend__switch_gen_module2)
	...
	MR_init_label6(ll_backend__switch_gen__separate_reserved_address_cases_3_0,38,4,5,8,10,7)
MR_BEGIN_CODE
...
MR_def_static(ll_backend__switch_gen__separate_reserved_address_cases_3_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
		MR_GOTO_LAB(ll_backend__switch_gen__separate_reserved_address_cases_3_0_i38);
	}
	MR_r1 = (MR_Word) MR_tbmkword(0, 0);
	MR_r2 = (MR_Word) MR_tbmkword(0, 0);
	MR_proceed();
MR_def_label(ll_backend__switch_gen__separate_reserved_address_cases_3_0,38)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(5);
...
MR_def_label(ll_backend__switch_gen__separate_reserved_address_cases_3_0,4)
	...
	MR_np_call_localret_ent(fn__ll_backend__switch_gen__is_reserved_addr_tag_1_0,
		ll_backend__switch_gen__separate_reserved_address_cases_3_0_i5);
MR_def_label(ll_backend__switch_gen__separate_reserved_address_cases_3_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(ll_backend__switch_gen__separate_reserved_address_cases_3_0_i7);
	}
	MR_r1 = MR_sv(4);
...
MR_BEGIN_MODULE(ll_backend__switch_gen_module4)
	...
	MR_init_label10(ll_backend__switch_gen__order_can_and_cannot_succeed_cases_5_0,18,34,37,38,40,33,5,52,53,4)
MR_BEGIN_CODE
...
MR_def_label(ll_backend__switch_gen__order_can_and_cannot_succeed_cases_5_0,33)
	...
	MR_np_call_localret_ent(fn__list__map_2_0,
		ll_backend__switch_gen__order_can_and_cannot_succeed_cases_5_0_i52);
MR_def_label(ll_backend__switch_gen__order_can_and_cannot_succeed_cases_5_0,5)
	...
	MR_np_call_localret_ent(fn__list__map_2_0,
		ll_backend__switch_gen__order_can_and_cannot_succeed_cases_5_0_i52);
MR_def_label(ll_backend__switch_gen__order_can_and_cannot_succeed_cases_5_0,52)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
	...
	MR_np_call_localret_ent(list__sort_2_0,
		ll_backend__switch_gen__order_can_and_cannot_succeed_cases_5_0_i53);
MR_def_label(ll_backend__switch_gen__order_can_and_cannot_succeed_cases_5_0,53)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
...
MR_BEGIN_MODULE(ll_backend__switch_gen_module8)
...
static void mercury__ll_backend__switch_gen_maybe_bunch_0(void)
{
	...
	ll_backend__switch_gen_module8();
}
...
void mercury__ll_backend__switch_gen__write_out_proc_statics(FILE *deep_fp, FILE *procrep_fp)
{
	MR_write_out_module_proc_reps_start(procrep_fp, &mercury_data__module_layout__ll_backend__switch_gen);
