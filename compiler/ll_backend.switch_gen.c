        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              ...
              TypeCtorInfo_700_700 = (MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0);
              ll_backend__lookup_switch__is_lookup_switch_6_p_0(TypeCtorInfo_700_700, Var_56, FilteredTaggedCases_42, GoalInfo_26, STATE_VARIABLE_CI_0_52, CLD_31, &MaybeLookupSwitchInfo_48);
