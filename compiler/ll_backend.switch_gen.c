  ...
  MR_Word * STATE_VARIABLE_CI_57)
{
  ...
  if ((Cases_17 == (MR_Word) ((MR_Unsigned) 0U)))
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(3), Var_89, 1) = ((MR_Box) (EndLabel_25));
    }
  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      ll_backend__unify_gen_test__generate_test_var_has_one_tagged_cons_id_10_p_0(VarRval_18, VarName_20, MainTaggedConsId_31, OtherTaggedConsIds_32, CheaperTagTest_21, (MR_Integer) 1, &NextLabel_38, &TestCode_39, STATE_VARIABLE_CI_0_56, &STATE_VARIABLE_CI_59_59);
      {
        ...
        MR_hl_field(MR_mktag(1), Var_63, 0) = ((MR_Box) (EndLabel_25));
      }
      {
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(3), Var_68, 1) = ((MR_Box) (NextLabel_38));
      }
      {
        Var_67 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), Var_67, 0) = ((MR_Box) (Var_68));
        MR_hl_field(MR_mktag(0), Var_67, 1) = ((MR_Box) ((MR_String) "next case"));
      }
      {
        ...
        case (MR_Integer) 1:
          {
...

            {
              ...
              MR_hl_field(MR_mktag(1), Var_39, 0) = ((MR_Box) (SingleRecCase_30));
        ...
        case (MR_Integer) 0:
          {
...

            {
              ...
              MR_hl_field(MR_mktag(1), Var_37, 0) = ((MR_Box) (BaseCase_29));
          ...
          case (MR_Integer) 1:
            {
...

              {
                ...
                MR_hl_field(MR_mktag(1), Var_45, 0) = ((MR_Box) (BaseCase_48));
          ...
          case (MR_Integer) 0:
            {
...

              {
                ...
                MR_hl_field(MR_mktag(1), Var_43, 0) = ((MR_Box) (MultiRecCase_33));
