  ...
  MR_Word STATE_VARIABLE_CLD_0_36)
{
  ...
  ll_backend__switch_gen__separate_cannot_succeed_cases_3_p_0(TaggedCases_14, &CanSucceedCases_44, &CannotSucceedCases_45);
  if ((CannotSucceedCases_45 == (MR_Word) ((MR_Unsigned) 0U)))
    ...
    OrderedTaggedCases_26 = mercury__list__f_43_43_2_f_0((MR_Word) (&hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_tagged_case_0), CanSucceedCases_44, CannotSucceedCases_45);
