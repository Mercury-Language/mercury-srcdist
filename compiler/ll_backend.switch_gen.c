            ...
            case (MR_Integer) 3:
              {
                ...
                libs__globals__lookup_int_option_3_p_0(Globals_33, (MR_Integer) 456, &TagSize_36);
...
{
  {
    ...
    if (succeeded)
    {
      ...
      libs__globals__lookup_int_option_3_p_0(Globals_15, (MR_Integer) 454, &StringHashSwitchSize_33);
      libs__globals__lookup_int_option_3_p_0(Globals_15, (MR_Integer) 455, &StringBinarySwitchSize_34);
...
{
  {
    ...
    ll_backend__switch_gen__generate_if_then_else_chain_cases_15_p_0(BranchStart_33, OrderedTaggedCases_26, VarRval_15, VarType_16, VarName_17, CheaperTagTest_32, CodeModel_18, CanFail_19, GoalInfo_20, EndLabel_21, (MR_Word) ((MR_Unsigned) 0U), MaybeEnd_22, Code_23, STATE_VARIABLE_CI_0_34, STATE_VARIABLE_CI_35);
  }
}
...
{
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        ll_backend__unify_gen_test__generate_raw_tag_test_case_11_p_0(VarRval_18, VarType_19, VarName_20, MainTaggedConsId_31, OtherTaggedConsIds_32, CheaperTagTest_21, (MR_Integer) 1, &NextLabel_38, &TestCode_39, STATE_VARIABLE_CI_0_56, &STATE_VARIABLE_CI_65_65);
        {
    ...
    if ((CannotSucceedCases_12 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_32, (MR_Integer) 459, &SingleRecBaseFirst_41);
        ...
        else
        {
          ...
          if (succeeded)
          {
            ...
            libs__globals__lookup_bool_option_3_p_0(Globals_32, (MR_Integer) 460, &MultiRecBaseFirst_43);
