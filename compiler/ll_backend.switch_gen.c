...
{
  {
    ...
    {
      ll_backend__switch_gen__conv3_Cost_4 = mercury__list__foldl_3_f_0(ll_backend__switch_gen__TypeCtorInfo_22_22, ll_backend__switch_gen__TypeCtorInfo_22_22, (MR_Word) &ll_backend__switch_gen_scalar_common_1[8], ll_backend__switch_gen__Var_16, ((MR_Box) ((MR_Integer) 0)));
    }
            ...
            if (ll_backend__switch_gen__succeeded)
              {
                ...
                {
                  libs__globals__lookup_bool_option_3_p_0(ll_backend__switch_gen__Globals_32, (MR_Integer) 449, &ll_backend__switch_gen__SingleRecBaseFirst_41);
                }
                ...
                if (ll_backend__switch_gen__succeeded)
                  {
                    ...
                    {
                      libs__globals__lookup_bool_option_3_p_0(ll_backend__switch_gen__Globals_32, (MR_Integer) 450, &ll_backend__switch_gen__MultiRecBaseFirst_43);
                    }
                ...
                if (ll_backend__switch_gen__succeeded)
                  {
                    ...
                    ll_backend__switch_gen__Var_85 = (MR_Integer) 455;
                    ...
                    if (ll_backend__switch_gen__succeeded)
                      {
                        ...
                        if (ll_backend__switch_gen__succeeded)
                          {
                            ll_backend__switch_gen__Var_87 = (MR_Integer) 442;
                            {
                            ...
                            if (ll_backend__switch_gen__succeeded)
                              {
                                ...
                                if (ll_backend__switch_gen__succeeded)
                                  {
                                    ll_backend__switch_gen__Var_89 = (MR_Integer) 440;
                                    {
                                    ...
                                    if (ll_backend__switch_gen__succeeded)
                                      {
                                        ...
                                        ll_backend__switch_gen__Var_90 = (MR_Word) &ll_backend__switch_gen_scalar_common_1[1];
                    ...
                    if (ll_backend__switch_gen__succeeded)
                      {
                        ...
                        ll_backend__switch_gen__Var_95 = (MR_Integer) 441;
                        {
                        ...
                        if (ll_backend__switch_gen__succeeded)
                          {
                            ...
                            if (ll_backend__switch_gen__succeeded)
                              {
                                ll_backend__switch_gen__Var_97 = (MR_Integer) 439;
                                {
                ...
                if (ll_backend__switch_gen__succeeded)
                  {
                    ...
                    {
                      libs__globals__lookup_int_option_3_p_0(ll_backend__switch_gen__Globals_33, (MR_Integer) 444, &ll_backend__switch_gen__StringHashSwitchSize_53);
                    }
                    {
                      libs__globals__lookup_int_option_3_p_0(ll_backend__switch_gen__Globals_33, (MR_Integer) 445, &ll_backend__switch_gen__StringBinarySwitchSize_54);
                    }
            ...
            case (MR_Integer) 2:
              {
                ...
                {
                  libs__globals__lookup_int_option_3_p_0(ll_backend__switch_gen__Globals_33, (MR_Integer) 446, &ll_backend__switch_gen__TagSize_55);
                }
