  ...
  MR_Word STATE_VARIABLE_CLD_0_53)
{
  ...
  ll_backend__lookup_switch__is_lookup_switch_7_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&ll_backend__switch_gen_scalar_common_1[4]), FilteredTaggedCases_23, GoalInfo_28, StoreMap_34, STATE_VARIABLE_CI_0_51, STATE_VARIABLE_CLD_0_53, &MaybeLookupSwitchInfo_35);
  libs__globals__get_opt_tuple_2_p_0(Globals_18, &OptTuple_36);
  Var_55 = mercury__string__internal_string_encoding_0_f_0();
  succeeded = (Var_55 == (MR_Integer) 0);
  if (succeeded)
  {
    StringTrieSwitchSize_37 = ((MR_Integer) ((MR_hl_field(0, OptTuple_36, (MR_Integer) 30))));
    succeeded = (NumConsIds_27 >= StringTrieSwitchSize_37);
    if (succeeded)
    {
      ...
      {
        MR_Word LookupSwitchInfo0_38 = ((MR_Word) ((MR_hl_field(1, MaybeLookupSwitchInfo_35, (MR_Integer) 0))));
        MR_Word CaseConsts_40 = ((MR_Word) ((MR_hl_field(0, LookupSwitchInfo0_38, (MR_Integer) 1))));

        succeeded = ((MR_tag((MR_Word) CaseConsts_40)) == (MR_Integer) 0);
        if (succeeded)
        {
        }
      }
  ...
  if (succeeded)
    if ((MaybeLookupSwitchInfo_35 == (MR_Word) ((MR_Unsigned) 0U)))
      ll_backend__string_switch__generate_string_trie_jump_switch_12_p_0(SwitchVarRval_19, SwitchVarName_21, TaggedCases_22, CodeModel_24, CanFail_25, GoalInfo_28, EndLabel_29, MaybeEnd_30, SwitchCode_31, STATE_VARIABLE_CI_0_51, STATE_VARIABLE_CI_52, STATE_VARIABLE_CLD_0_53);
    else
    {
      MR_Word LookupSwitchInfo_48 = ((MR_Word) ((MR_hl_field(1, MaybeLookupSwitchInfo_35, (MR_Integer) 0))));

      ll_backend__string_switch__generate_string_trie_lookup_switch_8_p_0(SwitchVarRval_19, LookupSwitchInfo_48, FilteredCanFail_26, EndLabel_29, StoreMap_34, MaybeEnd_30, SwitchCode_31, STATE_VARIABLE_CI_52);
    }
  else
  {
    MR_Integer StringHashSwitchSize_49 = ((MR_Integer) ((MR_hl_field(0, OptTuple_36, (MR_Integer) 31))));

    succeeded = (NumConsIds_27 >= StringHashSwitchSize_49);
    if (succeeded)
      if ((MaybeLookupSwitchInfo_35 == (MR_Word) ((MR_Unsigned) 0U)))
        ll_backend__string_switch__generate_string_hash_jump_switch_12_p_0(SwitchVarRval_19, SwitchVarName_21, TaggedCases_22, CodeModel_24, CanFail_25, GoalInfo_28, EndLabel_29, MaybeEnd_30, SwitchCode_31, STATE_VARIABLE_CI_0_51, STATE_VARIABLE_CI_52, STATE_VARIABLE_CLD_0_53);
      else
      {
        MR_Word LookupSwitchInfo_63 = ((MR_Word) ((MR_hl_field(1, MaybeLookupSwitchInfo_35, (MR_Integer) 0))));

        ll_backend__string_switch__generate_string_hash_lookup_switch_8_p_0(SwitchVarRval_19, LookupSwitchInfo_63, FilteredCanFail_26, EndLabel_29, StoreMap_34, MaybeEnd_30, SwitchCode_31, STATE_VARIABLE_CI_52);
      }
    else
    {
      MR_Integer StringBinarySwitchSize_50 = ((MR_Integer) ((MR_hl_field(0, OptTuple_36, (MR_Integer) 32))));

      succeeded = (NumConsIds_27 >= StringBinarySwitchSize_50);
      if (succeeded)
        if ((MaybeLookupSwitchInfo_35 == (MR_Word) ((MR_Unsigned) 0U)))
          ll_backend__string_switch__generate_string_binary_jump_switch_12_p_0(SwitchVarRval_19, SwitchVarName_21, TaggedCases_22, CodeModel_24, CanFail_25, GoalInfo_28, EndLabel_29, MaybeEnd_30, SwitchCode_31, STATE_VARIABLE_CI_0_51, STATE_VARIABLE_CI_52, STATE_VARIABLE_CLD_0_53);
        else
        {
          MR_Word LookupSwitchInfo_65 = ((MR_Word) ((MR_hl_field(1, MaybeLookupSwitchInfo_35, (MR_Integer) 0))));

          ll_backend__string_switch__generate_string_binary_lookup_switch_8_p_0(SwitchVarRval_19, LookupSwitchInfo_65, FilteredCanFail_26, EndLabel_29, StoreMap_34, MaybeEnd_30, SwitchCode_31, STATE_VARIABLE_CI_52);
        }
      else
        ll_backend__switch_gen__order_and_generate_cases_13_p_0(SwitchVarRval_19, SwitchVarType_20, SwitchVarName_21, TaggedCases_22, CodeModel_24, CanFail_25, GoalInfo_28, EndLabel_29, MaybeEnd_30, SwitchCode_31, STATE_VARIABLE_CI_0_51, STATE_VARIABLE_CI_52, STATE_VARIABLE_CLD_0_53);
    }
  }
}
  ...
  MR_Word STATE_VARIABLE_CLD_0_55)
{
  ...
  if (succeeded)
    ll_backend__lookup_switch__generate_int_lookup_switch_11_p_0(SwitchVarRval_19, LookupSwitchInfo_50, EndLabel_27, StoreMap_48, FirstVal_46, LastVal_47, NeedBitVecCheck_44, NeedRangeCheck_45, MaybeEnd_28, SwitchCode_29, STATE_VARIABLE_CI_54);
  else
  {
    ...
    if (succeeded)
    {
      IntSwitchInfo_64 = ((MR_Word) ((MR_hl_field(1, MaybeIntSwitchInfo_23, (MR_Integer) 0))));
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
          succeeded = ll_backend__dense_switch__tagged_case_list_is_dense_switch_9_p_0(STATE_VARIABLE_CI_0_53, SwitchVarType_20, TaggedCases_22, LowerLimit_65, UpperLimit_66, NumValues_67, ReqDensity_69, CanFail_25, &DenseSwitchInfo_52);
      }
    }
    if (succeeded)
      ll_backend__dense_switch__generate_dense_switch_13_p_0(TaggedCases_22, SwitchVarRval_19, SwitchVarName_21, CodeModel_24, GoalInfo_26, DenseSwitchInfo_52, EndLabel_27, (MR_Word) ((MR_Unsigned) 0U), MaybeEnd_28, SwitchCode_29, STATE_VARIABLE_CI_0_53, STATE_VARIABLE_CI_54, STATE_VARIABLE_CLD_0_55);
    else
      ll_backend__switch_gen__order_and_generate_cases_13_p_0(SwitchVarRval_19, SwitchVarType_20, SwitchVarName_21, TaggedCases_22, CodeModel_24, CanFail_25, GoalInfo_26, EndLabel_27, MaybeEnd_28, SwitchCode_29, STATE_VARIABLE_CI_0_53, STATE_VARIABLE_CI_54, STATE_VARIABLE_CLD_0_55);
  }
}
