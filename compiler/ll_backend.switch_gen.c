  ...
  MR_Word STATE_VARIABLE_CLD_0_42)
{
  ...
  MR_Word OptTuple_36;
  MR_Integer StringHashSwitchSize_37;

  hlds__hlds_llds__goal_info_get_store_map_2_p_0(GoalInfo_28, &StoreMap_34);
  ll_backend__lookup_switch__is_lookup_switch_7_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&ll_backend__switch_gen_scalar_common_1[4]), FilteredTaggedCases_27, GoalInfo_28, StoreMap_34, STATE_VARIABLE_CI_0_40, STATE_VARIABLE_CLD_0_42, &MaybeLookupSwitchInfo_35);
  libs__globals__get_opt_tuple_2_p_0(Globals_18, &OptTuple_36);
  StringHashSwitchSize_37 = ((MR_Integer) ((MR_hl_field(0, OptTuple_36, (MR_Integer) 31))));
  succeeded = (NumConsIds_25 >= StringHashSwitchSize_37);
  if (succeeded)
    if ((MaybeLookupSwitchInfo_35 == (MR_Word) ((MR_Unsigned) 0U)))
      ll_backend__string_switch__generate_string_hash_switch_12_p_0(TaggedCases_26, SwitchVarRval_24, SwitchVarName_22, CodeModel_19, CanFail_20, GoalInfo_28, EndLabel_29, MaybeEnd_30, SwitchCode_31, STATE_VARIABLE_CI_0_40, STATE_VARIABLE_CI_41, STATE_VARIABLE_CLD_0_42);
    else
    {
      MR_Word LookupSwitchInfo_38 = ((MR_Word) ((MR_hl_field(1, MaybeLookupSwitchInfo_35, (MR_Integer) 0))));

      ll_backend__string_switch__generate_string_hash_lookup_switch_8_p_0(SwitchVarRval_24, LookupSwitchInfo_38, FilteredCanFail_21, EndLabel_29, StoreMap_34, MaybeEnd_30, SwitchCode_31, STATE_VARIABLE_CI_41);
    }
  else
  {
    MR_Integer StringBinarySwitchSize_39 = ((MR_Integer) ((MR_hl_field(0, OptTuple_36, (MR_Integer) 32))));

    succeeded = (NumConsIds_25 >= StringBinarySwitchSize_39);
    if (succeeded)
      if ((MaybeLookupSwitchInfo_35 == (MR_Word) ((MR_Unsigned) 0U)))
        ll_backend__string_switch__generate_string_binary_switch_12_p_0(TaggedCases_26, SwitchVarRval_24, SwitchVarName_22, CodeModel_19, CanFail_20, GoalInfo_28, EndLabel_29, MaybeEnd_30, SwitchCode_31, STATE_VARIABLE_CI_0_40, STATE_VARIABLE_CI_41, STATE_VARIABLE_CLD_0_42);
      else
      {
        MR_Word LookupSwitchInfo_49 = ((MR_Word) ((MR_hl_field(1, MaybeLookupSwitchInfo_35, (MR_Integer) 0))));

        ll_backend__string_switch__generate_string_binary_lookup_switch_8_p_0(SwitchVarRval_24, LookupSwitchInfo_49, FilteredCanFail_21, EndLabel_29, StoreMap_34, MaybeEnd_30, SwitchCode_31, STATE_VARIABLE_CI_41);
      }
    else
      ll_backend__switch_gen__order_and_generate_cases_13_p_0(TaggedCases_26, SwitchVarRval_24, SwitchVarType_23, SwitchVarName_22, CodeModel_19, CanFail_20, GoalInfo_28, EndLabel_29, MaybeEnd_30, SwitchCode_31, STATE_VARIABLE_CI_0_40, STATE_VARIABLE_CI_41, STATE_VARIABLE_CLD_0_42);
  }
}
