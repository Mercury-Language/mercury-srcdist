            ...
            case (MR_Integer) 1:
              {
                ...
                if (succeeded)
                {
                  ...
                  libs__globals__lookup_int_option_3_p_0(Globals_33, (MR_Integer) 448, &StringHashSwitchSize_53);
                  libs__globals__lookup_int_option_3_p_0(Globals_33, (MR_Integer) 449, &StringBinarySwitchSize_54);
            ...
            case (MR_Integer) 2:
              {
                ...
                libs__globals__lookup_int_option_3_p_0(Globals_33, (MR_Integer) 450, &TagSize_55);
    ...
    if ((CannotSucceedCases_12 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_32, (MR_Integer) 453, &SingleRecBaseFirst_41);
        ...
        else
        {
          ...
          if (succeeded)
          {
            ...
            libs__globals__lookup_bool_option_3_p_0(Globals_32, (MR_Integer) 454, &MultiRecBaseFirst_43);
