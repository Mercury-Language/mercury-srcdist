  ...
  MR_Word TaggedCase_3)
{
  MR_Word HeadVar__2_2;
  MR_Integer Cost_4;
  MR_Word MainTaggedConsId_5 = ((MR_Word) ((MR_hl_field(0, TaggedCase_3, 0))));
  MR_Word OtherTaggedConsIds_6 = ((MR_Word) ((MR_hl_field(0, TaggedCase_3, 1))));
  MR_Word MainTag_9;
  ...
  MR_Word * STATE_VARIABLE_CLD_42)
{
  ...
  ll_backend__code_info__get_next_label_3_p_0(&EndLabel_20, STATE_VARIABLE_CI_0_39, &STATE_VARIABLE_CI_1_43);
  ll_backend__code_info__get_module_info_2_p_0(STATE_VARIABLE_CI_1_43, &ModuleInfo_21);
  ll_backend__code_info__get_var_table_2_p_0(STATE_VARIABLE_CI_1_43, &VarTable_22);
  parse_tree__var_table__lookup_var_entry_3_p_0(VarTable_22, SwitchVar_12, &SwitchVarEntry_23);
  SwitchVarType_24 = ((MR_Word) ((MR_hl_field(0, SwitchVarEntry_23, 1))));
  ...
  ll_backend__code_loc_dep__produce_variable_5_p_0(SwitchVar_12, &SwitchVarCode_29, &SwitchVarRval_30, STATE_VARIABLE_CLD_0_41, &STATE_VARIABLE_CLD_1_44);
  ...
  switch (SwitchCategory_31) {
    ...
    case (MR_Integer) 4:
    case (MR_Integer) 0:
      ll_backend__switch_gen__order_and_generate_cases_13_p_0(SwitchVarRval_30, SwitchVarType_24, SwitchVarName_25, TaggedCases_28, CodeModel_11, CanFail_13, GoalInfo_15, EndLabel_20, &MaybeEnd_32, &SwitchCode_33, STATE_VARIABLE_CI_1_43, STATE_VARIABLE_CI_40, STATE_VARIABLE_CLD_1_44);
      break;
    case (MR_Integer) 2:
    case (MR_Integer) 1:
      {
    ...
    case (MR_Integer) 3:
      {
        ...
        ll_backend__switch_gen__generate_string_switch_14_p_0(Globals_53, SwitchVarRval_30, SwitchVarType_24, SwitchVarName_25, TaggedCases_28, CodeModel_11, CanFail_13, GoalInfo_15, EndLabel_20, &MaybeEnd_32, &SwitchCode_33, STATE_VARIABLE_CI_1_43, STATE_VARIABLE_CI_40, STATE_VARIABLE_CLD_1_44);
      }
      break;
    case (MR_Integer) 5:
      {
        ...
        TagSize_38 = ((MR_Integer) ((MR_hl_field(0, OptTuple_37, 32))));
        ...
        if (succeeded)
          ll_backend__tag_switch__generate_tag_switch_14_p_0(SwitchVarRval_30, SwitchVarType_24, SwitchVarName_25, TaggedCases_28, CodeModel_11, CanFail_13, GoalInfo_15, EndLabel_20, (MR_Word) ((MR_Unsigned) 0U), &MaybeEnd_32, &SwitchCode_33, STATE_VARIABLE_CI_1_43, STATE_VARIABLE_CI_40, STATE_VARIABLE_CLD_1_44);
        else
          ll_backend__switch_gen__order_and_generate_cases_13_p_0(SwitchVarRval_30, SwitchVarType_24, SwitchVarName_25, TaggedCases_28, CodeModel_11, CanFail_13, GoalInfo_15, EndLabel_20, &MaybeEnd_32, &SwitchCode_33, STATE_VARIABLE_CI_1_43, STATE_VARIABLE_CI_40, STATE_VARIABLE_CLD_1_44);
      }
      break;
  ...
  MR_Word CLD_27)
{
  ...
  if (succeeded)
  {
    MR_Word OrderedTaggedCases_35;
    MR_Word TypeCtor_36;
    MR_Word ModuleInfo_37;
    MR_Word TypeTable_38;
    MR_Word CheaperTagTest_41;
    MR_Word BranchStart_42;
    MR_Word CanSucceedCases_44;
    MR_Word CannotSucceedCases_45;
    MR_Word TypeDefn_39;

    ll_backend__switch_gen__separate_cannot_succeed_cases_3_p_0(TaggedCases_19, &CanSucceedCases_44, &CannotSucceedCases_45);
    if ((CannotSucceedCases_45 == (MR_Word) ((MR_Unsigned) 0U)))
      ll_backend__switch_gen__order_recursive_cases_5_p_0(TaggedCases_19, &OrderedTaggedCases_35, CodeModel_20, CanFail_21, STATE_VARIABLE_CI_0_32);
    else
      OrderedTaggedCases_35 = mercury__list__f_43_43_2_f_0((MR_Word) (&hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_tagged_case_0), CanSucceedCases_44, CannotSucceedCases_45);
    parse_tree__prog_type__type_to_ctor_det_2_p_0(SwitchVarType_17, &TypeCtor_36);
    ll_backend__code_info__get_module_info_2_p_0(STATE_VARIABLE_CI_0_32, &ModuleInfo_37);
    hlds__hlds_module__module_info_get_type_table_2_p_0(ModuleInfo_37, &TypeTable_38);
    succeeded = hlds__hlds_data__search_type_ctor_defn_3_p_0(TypeTable_38, TypeCtor_36, &TypeDefn_39);
    if (succeeded)
    {
      MR_Word TypeBody_40;

      hlds__hlds_data__get_type_defn_body_2_p_0(TypeDefn_39, &TypeBody_40);
      CheaperTagTest_41 = hlds__hlds_data__get_maybe_cheaper_tag_test_1_f_0(TypeBody_40);
    }
    else
      CheaperTagTest_41 = (MR_Word) ((MR_Unsigned) 0U);
    ll_backend__code_loc_dep__remember_position_2_p_0(CLD_27, &BranchStart_42);
    ll_backend__switch_gen__f_85_110_117_115_101_100_65_114_103_115_95_95_112_114_101_100_95_95_103_101_110_101_114_97_116_101_95_105_102_95_116_104_101_110_95_101_108_115_101_95_99_104_97_105_110_95_99_97_115_101_115_95_95_91_51_93_95_48_15_p_0(CheaperTagTest_41, SwitchVarRval_16, SwitchVarName_18, OrderedTaggedCases_35, CodeModel_20, CanFail_21, GoalInfo_22, BranchStart_42, EndLabel_23, (MR_Word) ((MR_Unsigned) 0U), MaybeEnd_24, SwitchCode_25, STATE_VARIABLE_CI_0_32, STATE_VARIABLE_CI_33);
  }
  else
    ll_backend__switch_gen__generate_smart_string_switch_17_p_0(Globals_15, SwitchVarRval_16, SwitchVarType_17, SwitchVarName_18, TaggedCases_19, FilteredTaggedCases_28, CodeModel_20, CanFail_21, FilteredCanFail_29, NumConsIds_30, GoalInfo_22, EndLabel_23, MaybeEnd_24, SwitchCode_25, STATE_VARIABLE_CI_0_32, STATE_VARIABLE_CI_33, CLD_27);
}
  ...
  MR_Word CLD_33)
{
  ...
  ll_backend__lookup_switch__is_lookup_switch_6_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&ll_backend__switch_gen_scalar_common_1[4]), FilteredTaggedCases_23, GoalInfo_28, STATE_VARIABLE_CI_0_40, CLD_33, &MaybeLookupSwitchInfo_34);
  libs__globals__get_opt_tuple_2_p_0(Globals_18, &OptTuple_35);
  Var_43 = mercury__string__internal_string_encoding_0_f_0();
  succeeded = (Var_43 == (MR_Integer) 0);
  if (succeeded)
  {
    StringTrieSwitchSize_36 = ((MR_Integer) ((MR_hl_field(0, OptTuple_35, 29))));
    succeeded = (NumConsIds_27 >= StringTrieSwitchSize_36);
  }
  if (succeeded)
    if ((MaybeLookupSwitchInfo_34 == (MR_Word) ((MR_Unsigned) 0U)))
      ll_backend__string_switch__generate_string_trie_jump_switch_12_p_0(SwitchVarRval_19, SwitchVarName_21, TaggedCases_22, CodeModel_24, CanFail_25, GoalInfo_28, EndLabel_29, MaybeEnd_30, SwitchCode_31, STATE_VARIABLE_CI_0_40, STATE_VARIABLE_CI_41, CLD_33);
    else
    {
      MR_Word LookupSwitchInfo_37 = ((MR_Word) ((MR_hl_field(1, MaybeLookupSwitchInfo_34, 0))));
  ...
  {
    MR_Integer StringHashSwitchSize_38 = ((MR_Integer) ((MR_hl_field(0, OptTuple_35, 30))));

    succeeded = (NumConsIds_27 >= StringHashSwitchSize_38);
    if (succeeded)
      if ((MaybeLookupSwitchInfo_34 == (MR_Word) ((MR_Unsigned) 0U)))
        ll_backend__string_switch__generate_string_hash_jump_switch_12_p_0(SwitchVarRval_19, SwitchVarName_21, TaggedCases_22, CodeModel_24, CanFail_25, GoalInfo_28, EndLabel_29, MaybeEnd_30, SwitchCode_31, STATE_VARIABLE_CI_0_40, STATE_VARIABLE_CI_41, CLD_33);
      else
      {
        MR_Word LookupSwitchInfo_51 = ((MR_Word) ((MR_hl_field(1, MaybeLookupSwitchInfo_34, 0))));

        ll_backend__string_switch__generate_string_hash_lookup_switch_7_p_0(SwitchVarRval_19, LookupSwitchInfo_51, FilteredCanFail_26, EndLabel_29, MaybeEnd_30, SwitchCode_31, STATE_VARIABLE_CI_41);
      }
    else
    {
      MR_Integer StringBinarySwitchSize_39 = ((MR_Integer) ((MR_hl_field(0, OptTuple_35, 31))));

      succeeded = (NumConsIds_27 >= StringBinarySwitchSize_39);
      if (succeeded)
        if ((MaybeLookupSwitchInfo_34 == (MR_Word) ((MR_Unsigned) 0U)))
          ll_backend__string_switch__generate_string_binary_jump_switch_12_p_0(SwitchVarRval_19, SwitchVarName_21, TaggedCases_22, CodeModel_24, CanFail_25, GoalInfo_28, EndLabel_29, MaybeEnd_30, SwitchCode_31, STATE_VARIABLE_CI_0_40, STATE_VARIABLE_CI_41, CLD_33);
        else
        {
          MR_Word LookupSwitchInfo_53 = ((MR_Word) ((MR_hl_field(1, MaybeLookupSwitchInfo_34, 0))));

          ll_backend__string_switch__generate_string_binary_lookup_switch_7_p_0(SwitchVarRval_19, LookupSwitchInfo_53, FilteredCanFail_26, EndLabel_29, MaybeEnd_30, SwitchCode_31, STATE_VARIABLE_CI_41);
        }
      else
        ll_backend__switch_gen__order_and_generate_cases_13_p_0(SwitchVarRval_19, SwitchVarType_20, SwitchVarName_21, TaggedCases_22, CodeModel_24, CanFail_25, GoalInfo_28, EndLabel_29, MaybeEnd_30, SwitchCode_31, STATE_VARIABLE_CI_0_40, STATE_VARIABLE_CI_41, CLD_33);
    }
  }
}
  ...
  MR_Box wrapper_arg_1)
{
  ...
  conv0_HeadVar__2_2 = backend_libs__lookup_switch_util__get_int_in_cons_tag_1_f_0(((MR_Word) (wrapper_arg_1)));
  wrapper_arg_2 = ((MR_Box) (conv0_HeadVar__2_2));
  return wrapper_arg_2;
}
  ...
  MR_Word CLD_31)
{
  ...
  MR_Word SwitchLimits_44;
  MR_Word LookupSwitchInfo_46;
  MR_Word TypeCtorInfo_685_685;
  MR_Word IntSwitchInfo_34;
  MR_Word OptTuple_35;
  MR_Word MaybeTraceInfo_36;
  MR_Integer LookupSize_37;
  MR_Integer ReqDensityI_38;
  MR_Unsigned ReqDensityU_39;
  MR_Word FilteredTaggedCases_40;
  MR_Word FilteredCanFail_41;
  MR_Word MaybeLookupSwitchInfo_45;
  MR_Word Var_52;
  MR_Integer Var_53;
  MR_Word Var_54;

  backend_libs__switch_util__num_cons_ids_in_tagged_cases_3_p_0(TaggedCases_22, &NumConsIds_32, &NumArms_33);
  succeeded = (MaybeIntSwitchInfo_23 != (MR_Word) ((MR_Unsigned) 0U));
  if (succeeded)
  {
    IntSwitchInfo_34 = (MR_Word) (MR_body((MR_Word) (MaybeIntSwitchInfo_23), (MR_Integer) 1));
    libs__globals__get_opt_tuple_2_p_0(Globals_18, &OptTuple_35);
    Var_52 = ((((MR_Unsigned) ((MR_hl_field(0, OptTuple_35, 1))) >> 13)) & (MR_Integer) 1);
    succeeded = (Var_52 == (MR_Integer) 0);
    if (succeeded)
    {
      ll_backend__code_info__get_maybe_trace_info_2_p_0(STATE_VARIABLE_CI_0_50, &MaybeTraceInfo_36);
      succeeded = (MaybeTraceInfo_36 == (MR_Word) ((MR_Unsigned) 0U));
      if (succeeded)
      {
        ReqDensityI_38 = ((MR_Integer) ((MR_hl_field(0, OptTuple_35, 26))));
        LookupSize_37 = ((MR_Integer) ((MR_hl_field(0, OptTuple_35, 28))));
        succeeded = (NumConsIds_32 >= LookupSize_37);
        if (succeeded)
        {
          Var_53 = (MR_Integer) 1;
          succeeded = (NumArms_33 > Var_53);
          if (succeeded)
          {
            succeeded = mercury__uint__from_int_2_p_0(ReqDensityI_38, &ReqDensityU_39);
            if (succeeded)
            {
              backend_libs__lookup_switch_util__filter_out_failing_cases_if_needed_5_p_0(CodeModel_24, TaggedCases_22, &FilteredTaggedCases_40, CanFail_25, &FilteredCanFail_41);
              succeeded = backend_libs__lookup_switch_util__find_int_lookup_switch_params_8_p_0(ModuleInfo_17, SwitchVarType_20, FilteredCanFail_41, IntSwitchInfo_34, ReqDensityU_39, &NeedBitVecCheck_42, &NeedRangeCheck_43, &SwitchLimits_44);
              if (succeeded)
              {
                Var_54 = (MR_Word) (&ll_backend__switch_gen_scalar_common_1[3]);
                TypeCtorInfo_685_685 = (MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0);
                ll_backend__lookup_switch__is_lookup_switch_6_p_0(TypeCtorInfo_685_685, Var_54, FilteredTaggedCases_40, GoalInfo_26, STATE_VARIABLE_CI_0_50, CLD_31, &MaybeLookupSwitchInfo_45);
                succeeded = (MaybeLookupSwitchInfo_45 != (MR_Word) ((MR_Unsigned) 0U));
                if (succeeded)
                  LookupSwitchInfo_46 = ((MR_Word) ((MR_hl_field(1, MaybeLookupSwitchInfo_45, 0))));
              }
            }
          }
        }
  ...
  if (succeeded)
    ll_backend__lookup_switch__generate_int_lookup_switch_9_p_0(SwitchVarRval_19, LookupSwitchInfo_46, EndLabel_27, NeedBitVecCheck_42, NeedRangeCheck_43, SwitchLimits_44, MaybeEnd_28, SwitchCode_29, STATE_VARIABLE_CI_51);
  else
  {
    MR_Word DenseSwitchInfo_49;
    MR_Integer DenseSize_47;
    MR_Unsigned ReqDensity_48;
    MR_Integer Var_56;
    MR_Word IntSwitchInfo_60;
    MR_Word OptTuple_61;
    MR_Integer ReqDensityI_62;

    succeeded = (MaybeIntSwitchInfo_23 != (MR_Word) ((MR_Unsigned) 0U));
    if (succeeded)
    {
      IntSwitchInfo_60 = (MR_Word) (MR_body((MR_Word) (MaybeIntSwitchInfo_23), (MR_Integer) 1));
      libs__globals__get_opt_tuple_2_p_0(Globals_18, &OptTuple_61);
      ReqDensityI_62 = ((MR_Integer) ((MR_hl_field(0, OptTuple_61, 25))));
      DenseSize_47 = ((MR_Integer) ((MR_hl_field(0, OptTuple_61, 27))));
      succeeded = (NumConsIds_32 >= DenseSize_47);
      if (succeeded)
      {
        Var_56 = (MR_Integer) 1;
        ...
        if (succeeded)
        {
          succeeded = mercury__uint__from_int_2_p_0(ReqDensityI_62, &ReqDensity_48);
          if (succeeded)
            succeeded = ll_backend__dense_switch__tagged_case_list_is_dense_switch_7_p_0(STATE_VARIABLE_CI_0_50, SwitchVarType_20, TaggedCases_22, IntSwitchInfo_60, ReqDensity_48, CanFail_25, &DenseSwitchInfo_49);
        }
      }
    }
    if (succeeded)
      ll_backend__dense_switch__generate_dense_switch_13_p_0(TaggedCases_22, SwitchVarRval_19, SwitchVarName_21, CodeModel_24, GoalInfo_26, DenseSwitchInfo_49, EndLabel_27, (MR_Word) ((MR_Unsigned) 0U), MaybeEnd_28, SwitchCode_29, STATE_VARIABLE_CI_0_50, STATE_VARIABLE_CI_51, CLD_31);
    else
      ll_backend__switch_gen__order_and_generate_cases_13_p_0(SwitchVarRval_19, SwitchVarType_20, SwitchVarName_21, TaggedCases_22, CodeModel_24, CanFail_25, GoalInfo_26, EndLabel_27, MaybeEnd_28, SwitchCode_29, STATE_VARIABLE_CI_0_50, STATE_VARIABLE_CI_51, CLD_31);
  }
}
  ...
  MR_Word CLD_25)
{
  ...
  MR_Word CanSucceedCases_37;
  MR_Word CannotSucceedCases_38;
  MR_Word TypeDefn_30;

  ll_backend__switch_gen__separate_cannot_succeed_cases_3_p_0(TaggedCases_17, &CanSucceedCases_37, &CannotSucceedCases_38);
  if ((CannotSucceedCases_38 == (MR_Word) ((MR_Unsigned) 0U)))
    ...
    OrderedTaggedCases_26 = mercury__list__f_43_43_2_f_0((MR_Word) (&hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_tagged_case_0), CanSucceedCases_37, CannotSucceedCases_38);
  ...
  ll_backend__code_loc_dep__remember_position_2_p_0(CLD_25, &BranchStart_33);
  ...
  MR_Word * STATE_VARIABLE_CI_57)
{
  ...
  if ((Cases_20 == (MR_Word) ((MR_Unsigned) 0U)))
  {
    ...
    switch (CanFail_22) {
      ...
      case (MR_Integer) 0:
        {
          MR_Word STATE_VARIABLE_CLD_4_86;

          ll_backend__code_loc_dep__reset_to_position_3_p_0(BranchStart_24, STATE_VARIABLE_CI_0_56, &STATE_VARIABLE_CLD_4_86);
          ll_backend__code_loc_dep__generate_failure_3_p_0(&FailCode_52, STATE_VARIABLE_CI_0_56, STATE_VARIABLE_CLD_4_86);
        }
        break;
      case (MR_Integer) 1:
    ...
    }
    {
      ...
      MR_hl_field(3, Var_88, 1) = ((MR_Box) (EndLabel_25));
    }
    Var_89 = mercury__string__f_43_43_2_f_0((MR_String) "end of the switch on ", VarName_19);
    {
      Var_87 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(0, Var_87, 0) = ((MR_Box) (Var_88));
      MR_hl_field(0, Var_87, 1) = ((MR_Box) (Var_89));
    }
    EndCode_53 = mercury__cord__singleton_1_f_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_instruction_0), ((MR_Box) (Var_87)));
  ...
  {
    MR_Word HeadCase_29 = ((MR_Word) ((MR_hl_field(1, Cases_20, 0))));
    MR_Word TailCases_30 = ((MR_Word) ((MR_hl_field(1, Cases_20, 1))));
    MR_Word MainTaggedConsId_31 = ((MR_Word) ((MR_hl_field(0, HeadCase_29, 0))));
    MR_Word OtherTaggedConsIds_32 = ((MR_Word) ((MR_hl_field(0, HeadCase_29, 1))));
    MR_Word Goal_34 = ((MR_Word) ((MR_hl_field(0, HeadCase_29, 3))));
    MR_Word StoreMap_35;
    MR_Word TestCode_39;
    MR_Word ElseCode_40;
    ...
    MR_Word STATE_VARIABLE_CLD_1_75;
    MR_Word STATE_VARIABLE_CI_2_76;
    MR_Word STATE_VARIABLE_CLD_2_77;
    MR_Word STATE_VARIABLE_CI_3_78;
    MR_Word STATE_VARIABLE_CLD_3_79;
    MR_Word STATE_VARIABLE_MaybeEnd_1_80;
    MR_Word Var_81;
    MR_Word Var_82;
    MR_Word Var_83;
    ...
    if (succeeded)
    {
      ...
      ll_backend__unify_gen_test__generate_test_var_has_one_tagged_cons_id_10_p_0(VarRval_17, VarName_19, MainTaggedConsId_31, OtherTaggedConsIds_32, CheaperTagTest_16, (MR_Integer) 1, &NextLabel_38, &TestCode_39, STATE_VARIABLE_CI_0_56, &STATE_VARIABLE_CI_1_59);
      {
    ...
    else
    {
      ...
      STATE_VARIABLE_CI_1_59 = STATE_VARIABLE_CI_0_56;
    }
    ll_backend__code_loc_dep__reset_to_position_3_p_0(BranchStart_24, STATE_VARIABLE_CI_1_59, &STATE_VARIABLE_CLD_1_75);
    ll_backend__trace_gen__maybe_generate_internal_event_code_7_p_0(Goal_34, SwitchGoalInfo_23, &TraceCode_47, STATE_VARIABLE_CI_1_59, &STATE_VARIABLE_CI_2_76, STATE_VARIABLE_CLD_1_75, &STATE_VARIABLE_CLD_2_77);
    ll_backend__code_gen__generate_goal_7_p_0(CodeModel_21, Goal_34, &GoalCode_48, STATE_VARIABLE_CI_2_76, &STATE_VARIABLE_CI_3_78, STATE_VARIABLE_CLD_2_77, &STATE_VARIABLE_CLD_3_79);
    ll_backend__code_loc_dep__generate_branch_end_5_p_0(StoreMap_35, STATE_VARIABLE_MaybeEnd_0_54, &STATE_VARIABLE_MaybeEnd_1_80, &SaveCode_49, STATE_VARIABLE_CLD_3_79);
  ...
  MR_Word CI_10)
{
  ...
  if (succeeded)
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        Case1_11 = ((MR_Word) ((MR_hl_field(1, Cases0_6, 0))));
        Var_35 = ((MR_Word) ((MR_hl_field(1, Cases0_6, 1))));
        succeeded = (Var_35 != (MR_Word) ((MR_Unsigned) 0U));
        if (succeeded)
        {
          Case2_12 = ((MR_Word) ((MR_hl_field(1, Var_35, 0))));
          Var_36 = ((MR_Word) ((MR_hl_field(1, Var_35, 1))));
          succeeded = (Var_36 == (MR_Word) ((MR_Unsigned) 0U));
          if (succeeded)
          {
            Goal1_16 = ((MR_Word) ((MR_hl_field(0, Case1_11, 3))));
            Goal2_20 = ((MR_Word) ((MR_hl_field(0, Case2_12, 3))));
            succeeded = MR_TRUE;
          }
        }
      }
  ...
  if (succeeded)
  {
    ...
    if (succeeded)
    {
      ...
      SingleRecBaseFirst_32 = ((((MR_Unsigned) ((MR_hl_field(0, OptTuple_31, 1))) >> 15)) & (MR_Integer) 1);
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        MultiRecBaseFirst_34 = ((((MR_Unsigned) ((MR_hl_field(0, OptTuple_47, 1))) >> 14)) & (MR_Integer) 1);
  ...
  MR_Word * HeadVar__3_3)
{
  ...
  {
    MR_Word Case_4 = ((MR_Word) ((MR_hl_field(1, HeadVar__1_1, 0))));
    ...
    Goal_13 = ((MR_Word) ((MR_hl_field(0, Case_4, 3))));
    GoalInfo_15 = ((MR_Word) ((MR_hl_field(0, Goal_13, 1))));
