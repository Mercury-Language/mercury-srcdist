  ...
  MR_Word STATE_VARIABLE_CLD_0_43)
{
  ...
  ll_backend__lookup_switch__is_lookup_switch_7_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&ll_backend__switch_gen_scalar_common_1[4]), FilteredTaggedCases_23, GoalInfo_28, StoreMap_34, STATE_VARIABLE_CI_0_41, STATE_VARIABLE_CLD_0_43, &MaybeLookupSwitchInfo_35);
  ...
  if (succeeded)
    if ((MaybeLookupSwitchInfo_35 == (MR_Word) ((MR_Unsigned) 0U)))
      ll_backend__string_switch__generate_string_trie_jump_switch_12_p_0(SwitchVarRval_19, SwitchVarName_21, TaggedCases_22, CodeModel_24, CanFail_25, GoalInfo_28, EndLabel_29, MaybeEnd_30, SwitchCode_31, STATE_VARIABLE_CI_0_41, STATE_VARIABLE_CI_42, STATE_VARIABLE_CLD_0_43);
    else
    {
      MR_Word LookupSwitchInfo_38 = ((MR_Word) ((MR_hl_field(1, MaybeLookupSwitchInfo_35, (MR_Integer) 0))));

      ll_backend__string_switch__generate_string_trie_lookup_switch_8_p_0(SwitchVarRval_19, LookupSwitchInfo_38, FilteredCanFail_26, EndLabel_29, StoreMap_34, MaybeEnd_30, SwitchCode_31, STATE_VARIABLE_CI_42);
    }
  else
  {
    MR_Integer StringHashSwitchSize_39 = ((MR_Integer) ((MR_hl_field(0, OptTuple_36, (MR_Integer) 31))));

    succeeded = (NumConsIds_27 >= StringHashSwitchSize_39);
    if (succeeded)
      if ((MaybeLookupSwitchInfo_35 == (MR_Word) ((MR_Unsigned) 0U)))
        ll_backend__string_switch__generate_string_hash_jump_switch_12_p_0(SwitchVarRval_19, SwitchVarName_21, TaggedCases_22, CodeModel_24, CanFail_25, GoalInfo_28, EndLabel_29, MaybeEnd_30, SwitchCode_31, STATE_VARIABLE_CI_0_41, STATE_VARIABLE_CI_42, STATE_VARIABLE_CLD_0_43);
      else
      {
        MR_Word LookupSwitchInfo_53 = ((MR_Word) ((MR_hl_field(1, MaybeLookupSwitchInfo_35, (MR_Integer) 0))));

        ll_backend__string_switch__generate_string_hash_lookup_switch_8_p_0(SwitchVarRval_19, LookupSwitchInfo_53, FilteredCanFail_26, EndLabel_29, StoreMap_34, MaybeEnd_30, SwitchCode_31, STATE_VARIABLE_CI_42);
      }
    else
    {
      MR_Integer StringBinarySwitchSize_40 = ((MR_Integer) ((MR_hl_field(0, OptTuple_36, (MR_Integer) 32))));

      succeeded = (NumConsIds_27 >= StringBinarySwitchSize_40);
      if (succeeded)
        if ((MaybeLookupSwitchInfo_35 == (MR_Word) ((MR_Unsigned) 0U)))
          ll_backend__string_switch__generate_string_binary_jump_switch_12_p_0(SwitchVarRval_19, SwitchVarName_21, TaggedCases_22, CodeModel_24, CanFail_25, GoalInfo_28, EndLabel_29, MaybeEnd_30, SwitchCode_31, STATE_VARIABLE_CI_0_41, STATE_VARIABLE_CI_42, STATE_VARIABLE_CLD_0_43);
        else
        {
          MR_Word LookupSwitchInfo_55 = ((MR_Word) ((MR_hl_field(1, MaybeLookupSwitchInfo_35, (MR_Integer) 0))));

          ll_backend__string_switch__generate_string_binary_lookup_switch_8_p_0(SwitchVarRval_19, LookupSwitchInfo_55, FilteredCanFail_26, EndLabel_29, StoreMap_34, MaybeEnd_30, SwitchCode_31, STATE_VARIABLE_CI_42);
        }
      else
        ll_backend__switch_gen__order_and_generate_cases_13_p_0(SwitchVarRval_19, SwitchVarType_20, SwitchVarName_21, TaggedCases_22, CodeModel_24, CanFail_25, GoalInfo_28, EndLabel_29, MaybeEnd_30, SwitchCode_31, STATE_VARIABLE_CI_0_41, STATE_VARIABLE_CI_42, STATE_VARIABLE_CLD_0_43);
    }
  }
}
