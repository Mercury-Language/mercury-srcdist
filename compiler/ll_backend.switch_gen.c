  ...
  MR_Word STATE_VARIABLE_CLD_0_41)
{
  ...
  backend_libs__lookup_switch_util__filter_out_failing_cases_if_needed_5_p_0(CodeModel_16, TaggedCases_21, &FilteredTaggedCases_29, CanFail_17, &FilteredCanFail_30);
