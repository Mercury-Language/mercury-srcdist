          ...
          case (MR_Integer) 3:
            {
              ...
              TagSize_39 = ((MR_Integer) ((MR_hl_field(0, OptTuple_38, (MR_Integer) 33))));
  ...
  MR_Word STATE_VARIABLE_CLD_0_56)
{
  ...
  if (succeeded)
  {
    ...
    Var_57 = ((((MR_Unsigned) ((MR_hl_field(0, OptTuple_38, (MR_Integer) 1))) >> 13)) & (MR_Integer) 1);
  ...
  MR_Word CI_10)
{
  ...
  if (succeeded)
  {
    ...
    if (succeeded)
    {
      ...
      SingleRecBaseFirst_32 = ((((MR_Unsigned) ((MR_hl_field(0, OptTuple_31, (MR_Integer) 1))) >> 15)) & (MR_Integer) 1);
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        MultiRecBaseFirst_34 = ((((MR_Unsigned) ((MR_hl_field(0, OptTuple_47, (MR_Integer) 1))) >> 14)) & (MR_Integer) 1);
