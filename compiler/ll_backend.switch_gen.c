...
MR_decl_label8(ll_backend__switch_gen__generate_if_then_else_chain_cases_14_0, 6,5,8,10,12,13,3,14)
MR_decl_label8(ll_backend__switch_gen__generate_if_then_else_chain_cases_14_0, 15,19,18,22,25,17,32,34)
MR_decl_label8(ll_backend__switch_gen__generate_if_then_else_chain_cases_14_0, 35,38,39,41,42,43,44,45)
MR_decl_label5(ll_backend__switch_gen__generate_if_then_else_chain_cases_14_0, 46,47,48,49,50)
MR_decl_label8(ll_backend__switch_gen__generate_switch_8_0, 2,3,4,5,6,7,8,9)
MR_decl_label8(ll_backend__switch_gen__generate_switch_8_0, 10,11,12,13,14,18,20,21)
MR_decl_label8(ll_backend__switch_gen__generate_switch_8_0, 23,17,15,28,29,33,35,36)
MR_decl_label8(ll_backend__switch_gen__generate_switch_8_0, 37,39,30,31,43,44,45,41)
MR_decl_label8(ll_backend__switch_gen__generate_switch_8_0, 51,53,54,55,56,60,61,62)
MR_decl_label4(ll_backend__switch_gen__generate_switch_8_0, 63,65,68,69)
MR_decl_label8(ll_backend__switch_gen__order_and_generate_cases_13_0, 3,5,8,9,10,2,12,14)
MR_decl_label6(ll_backend__switch_gen__order_and_generate_cases_13_0, 15,16,19,21,22,18)
MR_decl_label8(ll_backend__switch_gen__order_can_and_cannot_succeed_cases_5_0, 2,11,12,13,14,15,16,19)
MR_decl_label8(ll_backend__switch_gen__order_can_and_cannot_succeed_cases_5_0, 24,25,18,34,37,38,40,33)
MR_decl_label4(ll_backend__switch_gen__order_can_and_cannot_succeed_cases_5_0, 5,54,55,4)
MR_decl_label5(ll_backend__switch_gen__separate_cannot_succeed_cases_3_0, 22,4,5,6,8)
MR_decl_label6(ll_backend__switch_gen__separate_reserved_address_cases_3_0, 41,4,6,7,9,18)
MR_decl_label5(fn__ll_backend__switch_gen__estimate_cost_of_case_test_1_0, 2,3,5,7,10)
MR_decl_label3(fn__ll_backend__switch_gen__list_contains_reserved_addr_tag_1_0, 3,5,12)
...
MR_decl_static(ll_backend__switch_gen__order_and_generate_cases_13_0)
...
MR_BEGIN_MODULE(ll_backend__switch_gen_module0)
	...
	MR_init_label3(fn__ll_backend__switch_gen__list_contains_reserved_addr_tag_1_0,3,5,12)
MR_BEGIN_CODE
...
MR_def_label(fn__ll_backend__switch_gen__list_contains_reserved_addr_tag_1_0,3)
	...
	if (MR_INT_EQ(MR_tag(MR_r2),3)) {
		MR_GOTO_LAB(fn__ll_backend__switch_gen__list_contains_reserved_addr_tag_1_0_i12);
	}
...
MR_def_label(fn__ll_backend__switch_gen__list_contains_reserved_addr_tag_1_0,12)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_ctfield(3, MR_r2, 0),11)) {
...
MR_BEGIN_MODULE(ll_backend__switch_gen_module1)
	...
	MR_init_label6(ll_backend__switch_gen__separate_reserved_address_cases_3_0,41,4,6,7,9,18)
MR_BEGIN_CODE
...
MR_def_static(ll_backend__switch_gen__separate_reserved_address_cases_3_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
		MR_GOTO_LAB(ll_backend__switch_gen__separate_reserved_address_cases_3_0_i41);
	}
	MR_r1 = (MR_Word) MR_tbmkword(0, 0);
	MR_r2 = (MR_Word) MR_tbmkword(0, 0);
	MR_proceed();
MR_def_label(ll_backend__switch_gen__separate_reserved_address_cases_3_0,41)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(4);
...
MR_def_label(ll_backend__switch_gen__separate_reserved_address_cases_3_0,4)
	...
	if (MR_INT_EQ(MR_tag(MR_r3),3)) {
		MR_GOTO_LAB(ll_backend__switch_gen__separate_reserved_address_cases_3_0_i18);
	}
MR_def_label(ll_backend__switch_gen__separate_reserved_address_cases_3_0,6)
	...
	MR_np_call_localret_ent(fn__ll_backend__switch_gen__list_contains_reserved_addr_tag_1_0,
		ll_backend__switch_gen__separate_reserved_address_cases_3_0_i7);
MR_def_label(ll_backend__switch_gen__separate_reserved_address_cases_3_0,7)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(ll_backend__switch_gen__separate_reserved_address_cases_3_0_i9);
	}
	{
	MR_Word MR_tempr1;
...
MR_def_label(ll_backend__switch_gen__separate_reserved_address_cases_3_0,9)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 2);
...
MR_def_label(ll_backend__switch_gen__separate_reserved_address_cases_3_0,18)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_BEGIN_MODULE(ll_backend__switch_gen_module2)
	...
	MR_init_label5(ll_backend__switch_gen__separate_cannot_succeed_cases_3_0,22,4,5,6,8)
MR_BEGIN_CODE
...
MR_def_static(ll_backend__switch_gen__separate_cannot_succeed_cases_3_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
		MR_GOTO_LAB(ll_backend__switch_gen__separate_cannot_succeed_cases_3_0_i22);
	}
	MR_r1 = (MR_Word) MR_tbmkword(0, 0);
	MR_r2 = (MR_Word) MR_tbmkword(0, 0);
	MR_proceed();
MR_def_label(ll_backend__switch_gen__separate_cannot_succeed_cases_3_0,22)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(4);
	MR_sv(4) = (MR_Word) MR_succip;
	MR_sv(1) = MR_ctfield(1, MR_r1, 0);
...
MR_BEGIN_MODULE(ll_backend__switch_gen_module3)
	...
	MR_init_label8(ll_backend__switch_gen__order_can_and_cannot_succeed_cases_5_0,2,11,12,13,14,15,16,19)
	MR_init_label8(ll_backend__switch_gen__order_can_and_cannot_succeed_cases_5_0,24,25,18,34,37,38,40,33)
	MR_init_label4(ll_backend__switch_gen__order_can_and_cannot_succeed_cases_5_0,5,54,55,4)
MR_BEGIN_CODE
...
MR_def_label(ll_backend__switch_gen__order_can_and_cannot_succeed_cases_5_0,33)
	...
	MR_Word MR_tempr1;
	MR_tempr1 = MR_sv(1);
	MR_sv(1) = (MR_Word) MR_CTOR0_ADDR(hlds__hlds_goal, tagged_case);
...
MR_BEGIN_MODULE(ll_backend__switch_gen_module4)
	...
	MR_init_label8(ll_backend__switch_gen__generate_if_then_else_chain_cases_14_0,6,5,8,10,12,13,3,14)
	MR_init_label8(ll_backend__switch_gen__generate_if_then_else_chain_cases_14_0,15,19,18,22,25,17,32,34)
	MR_init_label8(ll_backend__switch_gen__generate_if_then_else_chain_cases_14_0,35,38,39,41,42,43,44,45)
	MR_init_label5(ll_backend__switch_gen__generate_if_then_else_chain_cases_14_0,46,47,48,49,50)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(ll_backend__switch_gen_module5)
	MR_init_entry1(ll_backend__switch_gen__order_and_generate_cases_13_0);
	MR_init_label8(ll_backend__switch_gen__order_and_generate_cases_13_0,3,5,8,9,10,2,12,14)
	MR_init_label6(ll_backend__switch_gen__order_and_generate_cases_13_0,15,16,19,21,22,18)
MR_BEGIN_CODE


/*-------------------------------------------------------------------------*/
/* code for 'order_and_generate_cases'/13 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(ll_backend__switch_gen__order_and_generate_cases_13_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(12);
	...
	MR_np_call_localret_ent(ll_backend__code_info__search_type_defn_3_0,
		ll_backend__switch_gen__order_and_generate_cases_13_0_i3);
MR_def_label(ll_backend__switch_gen__order_and_generate_cases_13_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(ll_backend__switch_gen__order_and_generate_cases_13_0_i2);
	}
	MR_r1 = MR_r2;
	MR_np_call_localret_ent(hlds__hlds_data__get_type_defn_body_2_0,
		ll_backend__switch_gen__order_and_generate_cases_13_0_i5);
MR_def_label(ll_backend__switch_gen__order_and_generate_cases_13_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	...
	MR_np_call_localret_ent(ll_backend__switch_gen__separate_reserved_address_cases_3_0,
		ll_backend__switch_gen__order_and_generate_cases_13_0_i8);
MR_def_label(ll_backend__switch_gen__order_and_generate_cases_13_0,8)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(1) = MR_r2;
	MR_r2 = MR_sv(5);
	MR_r3 = MR_sv(6);
	...
	MR_np_call_localret_ent(ll_backend__switch_gen__order_can_and_cannot_succeed_cases_5_0,
		ll_backend__switch_gen__order_and_generate_cases_13_0_i9);
MR_def_label(ll_backend__switch_gen__order_and_generate_cases_13_0,9)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_sv(1);
	...
	MR_np_call_localret_ent(ll_backend__switch_gen__order_can_and_cannot_succeed_cases_5_0,
		ll_backend__switch_gen__order_and_generate_cases_13_0_i10);
MR_def_label(ll_backend__switch_gen__order_and_generate_cases_13_0,10)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
	...
	MR_np_call_localret_ent(fn__f_108_105_115_116_95_95_43_43_2_0,
		ll_backend__switch_gen__order_and_generate_cases_13_0_i12);
MR_def_label(ll_backend__switch_gen__order_and_generate_cases_13_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(1);
	MR_r2 = MR_sv(5);
	MR_r3 = MR_sv(6);
	...
	MR_np_call_localret_ent(ll_backend__switch_gen__order_can_and_cannot_succeed_cases_5_0,
		ll_backend__switch_gen__order_and_generate_cases_13_0_i12);
MR_def_label(ll_backend__switch_gen__order_and_generate_cases_13_0,12)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(1) = MR_r1;
	MR_r1 = MR_sv(3);
	MR_np_call_localret_ent(parse_tree__prog_type__type_to_ctor_det_2_0,
		ll_backend__switch_gen__order_and_generate_cases_13_0_i14);
MR_def_label(ll_backend__switch_gen__order_and_generate_cases_13_0,14)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(9) = MR_r1;
	MR_r1 = MR_sv(11);
	MR_np_call_localret_ent(ll_backend__code_info__get_module_info_2_0,
		ll_backend__switch_gen__order_and_generate_cases_13_0_i15);
MR_def_label(ll_backend__switch_gen__order_and_generate_cases_13_0,15)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_np_call_localret_ent(hlds__hlds_module__module_info_get_type_table_2_0,
		ll_backend__switch_gen__order_and_generate_cases_13_0_i16);
MR_def_label(ll_backend__switch_gen__order_and_generate_cases_13_0,16)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_sv(9);
	MR_np_call_localret_ent(hlds__hlds_data__search_type_ctor_defn_3_0,
		ll_backend__switch_gen__order_and_generate_cases_13_0_i19);
MR_def_label(ll_backend__switch_gen__order_and_generate_cases_13_0,19)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(ll_backend__switch_gen__order_and_generate_cases_13_0_i18);
	}
	MR_r1 = MR_r2;
	MR_np_call_localret_ent(hlds__hlds_data__get_type_defn_body_2_0,
		ll_backend__switch_gen__order_and_generate_cases_13_0_i21);
MR_def_label(ll_backend__switch_gen__order_and_generate_cases_13_0,21)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_np_call_localret_ent(fn__hlds__hlds_data__get_maybe_cheaper_tag_test_1_0,
		ll_backend__switch_gen__order_and_generate_cases_13_0_i22);
MR_def_label(ll_backend__switch_gen__order_and_generate_cases_13_0,22)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_sv(2);
	MR_r3 = MR_sv(3);
	MR_r4 = MR_sv(4);
...
MR_def_label(ll_backend__switch_gen__order_and_generate_cases_13_0,18)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_sv(2);
	MR_r3 = MR_sv(3);
	MR_r4 = MR_sv(4);
...
MR_decl_entry(ll_backend__lookup_switch__is_lookup_switch_15_0);
...
MR_decl_entry(ll_backend__string_switch__generate_string_switch_12_0);
...
MR_BEGIN_MODULE(ll_backend__switch_gen_module6)
	...
	MR_init_label8(ll_backend__switch_gen__generate_switch_8_0,10,11,12,13,14,18,20,21)
	MR_init_label8(ll_backend__switch_gen__generate_switch_8_0,23,17,15,28,29,33,35,36)
	MR_init_label8(ll_backend__switch_gen__generate_switch_8_0,37,39,30,31,43,44,45,41)
	MR_init_label8(ll_backend__switch_gen__generate_switch_8_0,51,53,54,55,56,60,61,62)
	MR_init_label4(ll_backend__switch_gen__generate_switch_8_0,63,65,68,69)
MR_BEGIN_CODE
...
MR_def_label(ll_backend__switch_gen__generate_switch_8_0,17)
	...
	MR_np_call_localret_ent(ll_backend__switch_gen__order_and_generate_cases_13_0,
		ll_backend__switch_gen__generate_switch_8_0_i65);
MR_def_label(ll_backend__switch_gen__generate_switch_8_0,15)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(8);
	MR_r2 = MR_sv(12);
	MR_r3 = MR_sv(18);
	MR_COMPUTED_GOTO((MR_Unsigned) MR_sv(14),
		MR_LABEL_AP(ll_backend__switch_gen__generate_switch_8_0_i28) MR_AND
		MR_LABEL_AP(ll_backend__switch_gen__generate_switch_8_0_i53) MR_AND
		MR_LABEL_AP(ll_backend__switch_gen__generate_switch_8_0_i60) MR_AND
		MR_LABEL_AP(ll_backend__switch_gen__generate_switch_8_0_i51));
...
MR_def_label(ll_backend__switch_gen__generate_switch_8_0,35)
	...
	MR_np_call_localret_ent(libs__globals__lookup_int_option_3_0,
		ll_backend__switch_gen__generate_switch_8_0_i36);
MR_def_label(ll_backend__switch_gen__generate_switch_8_0,36)
	...
	MR_np_call_localret_ent(ll_backend__lookup_switch__is_lookup_switch_15_0,
...
MR_def_label(ll_backend__switch_gen__generate_switch_8_0,31)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TEST(MR_sv(9),0,0)) {
		MR_GOTO_LAB(ll_backend__switch_gen__generate_switch_8_0_i41);
	}
	MR_sv(13) = MR_r1;
	MR_sv(14) = MR_r2;
	{
	...
	MR_sv(16) = MR_ctfield(1, MR_tempr1, 2);
	MR_r1 = MR_sv(11);
...
MR_def_label(ll_backend__switch_gen__generate_switch_8_0,43)
	...
	MR_np_call_localret_ent(libs__globals__lookup_int_option_3_0,
		ll_backend__switch_gen__generate_switch_8_0_i44);
MR_def_label(ll_backend__switch_gen__generate_switch_8_0,44)
	...
	MR_np_call_localret_ent(ll_backend__dense_switch__tagged_case_list_is_dense_switch_9_0,
		ll_backend__switch_gen__generate_switch_8_0_i45);
...
MR_def_label(ll_backend__switch_gen__generate_switch_8_0,55)
	...
	if (((MR_Integer) MR_sv(9) < (MR_Integer) MR_r1)) {
		MR_GOTO_LAB(ll_backend__switch_gen__generate_switch_8_0_i56);
	}
	...
	MR_r8 = (MR_Word) MR_tbmkword(0, 0);
	MR_r9 = MR_sv(18);
	MR_np_call_localret_ent(ll_backend__string_switch__generate_string_switch_12_0,
		ll_backend__switch_gen__generate_switch_8_0_i65);
...
MR_def_label(ll_backend__switch_gen__generate_switch_8_0,62)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (((MR_Integer) MR_sv(9) < (MR_Integer) MR_r1)) {
		MR_GOTO_LAB(ll_backend__switch_gen__generate_switch_8_0_i63);
	}
	if (MR_INT_LE(MR_sv(11),1)) {
		MR_GOTO_LAB(ll_backend__switch_gen__generate_switch_8_0_i63);
	}
...
MR_def_label(ll_backend__switch_gen__generate_switch_8_0,68)
	...
	MR_np_call_localret_ent(ll_backend__code_info__after_all_branches_4_0,
		ll_backend__switch_gen__generate_switch_8_0_i69);
MR_def_label(ll_backend__switch_gen__generate_switch_8_0,69)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
