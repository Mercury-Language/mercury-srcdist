  ...
  MR_Word CLD_31)
{
  ...
  if (succeeded)
  {
    IntSwitchInfo_34 = ((MR_Word) ((MR_hl_field(1, MaybeIntSwitchInfo_23, 0))));
    LowerLimit_35 = ((MR_Integer) ((MR_hl_field(0, IntSwitchInfo_34, 0))));
    UpperLimit_36 = ((MR_Integer) ((MR_hl_field(0, IntSwitchInfo_34, 1))));
    NumValues_37 = ((MR_Integer) ((MR_hl_field(0, IntSwitchInfo_34, 2))));
    libs__globals__get_opt_tuple_2_p_0(Globals_18, &OptTuple_38);
    Var_54 = ((((MR_Unsigned) ((MR_hl_field(0, OptTuple_38, 1))) >> 13)) & (MR_Integer) 1);
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ReqDensity_41 = ((MR_Integer) ((MR_hl_field(0, OptTuple_38, 26))));
        LookupSize_40 = ((MR_Integer) ((MR_hl_field(0, OptTuple_38, 28))));
        succeeded = (NumConsIds_32 >= LookupSize_40);
        if (succeeded)
        {
          Var_55 = (MR_Integer) 1;
          succeeded = (NumArms_33 > Var_55);
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              Var_56 = (MR_Word) (&ll_backend__switch_gen_scalar_common_1[3]);
              TypeCtorInfo_690_690 = (MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0);
              ll_backend__lookup_switch__is_lookup_switch_6_p_0(TypeCtorInfo_690_690, Var_56, FilteredTaggedCases_42, GoalInfo_26, STATE_VARIABLE_CI_0_52, CLD_31, &MaybeLookupSwitchInfo_48);
              succeeded = (MaybeLookupSwitchInfo_48 != (MR_Word) ((MR_Unsigned) 0U));
              if (succeeded)
                LookupSwitchInfo_49 = ((MR_Word) ((MR_hl_field(1, MaybeLookupSwitchInfo_48, 0))));
            }
          }
        }
      }
  ...
  else
  {
    ...
    MR_Integer Var_58;
    MR_Word IntSwitchInfo_62;
    MR_Integer LowerLimit_63;
    MR_Integer UpperLimit_64;
    MR_Integer NumValues_65;
    MR_Word OptTuple_66;
    MR_Integer ReqDensity_67;

    succeeded = ((MR_tag((MR_Word) MaybeIntSwitchInfo_23)) == (MR_Integer) 1);
    if (succeeded)
    {
      IntSwitchInfo_62 = ((MR_Word) ((MR_hl_field(1, MaybeIntSwitchInfo_23, 0))));
      LowerLimit_63 = ((MR_Integer) ((MR_hl_field(0, IntSwitchInfo_62, 0))));
      UpperLimit_64 = ((MR_Integer) ((MR_hl_field(0, IntSwitchInfo_62, 1))));
      NumValues_65 = ((MR_Integer) ((MR_hl_field(0, IntSwitchInfo_62, 2))));
      libs__globals__get_opt_tuple_2_p_0(Globals_18, &OptTuple_66);
      ReqDensity_67 = ((MR_Integer) ((MR_hl_field(0, OptTuple_66, 25))));
      DenseSize_50 = ((MR_Integer) ((MR_hl_field(0, OptTuple_66, 27))));
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
          succeeded = ll_backend__dense_switch__tagged_case_list_is_dense_switch_9_p_0(STATE_VARIABLE_CI_0_52, SwitchVarType_20, TaggedCases_22, LowerLimit_63, UpperLimit_64, NumValues_65, ReqDensity_67, CanFail_25, &DenseSwitchInfo_51);
      }
    }
    if (succeeded)
      ll_backend__dense_switch__generate_dense_switch_13_p_0(TaggedCases_22, SwitchVarRval_19, SwitchVarName_21, CodeModel_24, GoalInfo_26, DenseSwitchInfo_51, EndLabel_27, (MR_Word) ((MR_Unsigned) 0U), MaybeEnd_28, SwitchCode_29, STATE_VARIABLE_CI_0_52, STATE_VARIABLE_CI_53, CLD_31);
    else
      ll_backend__switch_gen__order_and_generate_cases_13_p_0(SwitchVarRval_19, SwitchVarType_20, SwitchVarName_21, TaggedCases_22, CodeModel_24, CanFail_25, GoalInfo_26, EndLabel_27, MaybeEnd_28, SwitchCode_29, STATE_VARIABLE_CI_0_52, STATE_VARIABLE_CI_53, CLD_31);
  }
}
