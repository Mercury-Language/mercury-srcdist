  ...
  MR_Word * STATE_VARIABLE_CLD_43)
{
  ...
  MR_Word MayUseSmartIndexing_32;
  MR_Word MaybeEnd_33;
  MR_Word SwitchCode_34;
  ...
  ll_backend__code_info__get_next_label_3_p_0(&EndLabel_20, STATE_VARIABLE_CI_0_40, &STATE_VARIABLE_CI_44_44);
  ll_backend__code_info__get_module_info_2_p_0(STATE_VARIABLE_CI_44_44, &ModuleInfo_21);
  ll_backend__code_info__get_var_table_2_p_0(STATE_VARIABLE_CI_44_44, &VarTable_22);
  hlds__var_table__lookup_var_entry_3_p_0(VarTable_22, SwitchVar_12, &SwitchVarEntry_23);
  SwitchVarType_24 = ((MR_Word) ((MR_hl_field(MR_mktag(0), SwitchVarEntry_23, (MR_Integer) 1))));
  SwitchVarName_25 = hlds__var_table__var_entry_name_2_f_0(SwitchVar_12, SwitchVarEntry_23);
  ...
  ll_backend__code_loc_dep__produce_variable_5_p_0(SwitchVar_12, &SwitchVarCode_29, &SwitchVarRval_30, STATE_VARIABLE_CLD_0_42, &STATE_VARIABLE_CLD_45_45);
  backend_libs__switch_util__find_switch_category_4_p_0(ModuleInfo_21, SwitchVarType_24, &SwitchCategory_31, &MayUseSmartIndexing_32);
  switch (MayUseSmartIndexing_32) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 0:
      ll_backend__switch_gen__order_and_generate_cases_13_p_0(TaggedCases_28, SwitchVarRval_30, SwitchVarType_24, SwitchVarName_25, CodeModel_11, CanFail_13, GoalInfo_15, EndLabel_20, &MaybeEnd_33, &SwitchCode_34, STATE_VARIABLE_CI_44_44, STATE_VARIABLE_CI_41, STATE_VARIABLE_CLD_45_45);
      break;
    case (MR_Integer) 1:
      {
        MR_Word Globals_35;

        hlds__hlds_module__module_info_get_globals_2_p_0(ModuleInfo_21, &Globals_35);
        switch (SwitchCategory_31) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 0:
          case (MR_Integer) 1:
            ll_backend__switch_gen__generate_atomic_or_int64_switch_16_p_0(ModuleInfo_21, Globals_35, CodeModel_11, CanFail_13, MaybeIntSwitchInfo_27, SwitchVarName_25, SwitchVarType_24, SwitchVarRval_30, TaggedCases_28, GoalInfo_15, EndLabel_20, &MaybeEnd_33, &SwitchCode_34, STATE_VARIABLE_CI_44_44, STATE_VARIABLE_CI_41, STATE_VARIABLE_CLD_45_45);
            break;
          case (MR_Integer) 4:
            ll_backend__switch_gen__order_and_generate_cases_13_p_0(TaggedCases_28, SwitchVarRval_30, SwitchVarType_24, SwitchVarName_25, CodeModel_11, CanFail_13, GoalInfo_15, EndLabel_20, &MaybeEnd_33, &SwitchCode_34, STATE_VARIABLE_CI_44_44, STATE_VARIABLE_CI_41, STATE_VARIABLE_CLD_45_45);
            break;
          case (MR_Integer) 2:
            ll_backend__switch_gen__generate_string_switch_14_p_0(Globals_35, CodeModel_11, CanFail_13, SwitchVarName_25, SwitchVarType_24, SwitchVarRval_30, TaggedCases_28, GoalInfo_15, EndLabel_20, &MaybeEnd_33, &SwitchCode_34, STATE_VARIABLE_CI_44_44, STATE_VARIABLE_CI_41, STATE_VARIABLE_CLD_45_45);
            break;
          case (MR_Integer) 3:
            {
              MR_Integer NumConsIds_36;
              MR_Integer NumArms_37;
              MR_Word OptTuple_38;
              MR_Integer TagSize_39;
              MR_Integer Var_47;

              backend_libs__switch_util__num_cons_ids_in_tagged_cases_3_p_0(TaggedCases_28, &NumConsIds_36, &NumArms_37);
              libs__globals__get_opt_tuple_2_p_0(Globals_35, &OptTuple_38);
              TagSize_39 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), OptTuple_38, (MR_Integer) 33))));
              succeeded = (NumConsIds_36 >= TagSize_39);
              if (succeeded)
              {
                Var_47 = (MR_Integer) 1;
                succeeded = (NumArms_37 > Var_47);
              }
              if (succeeded)
                ll_backend__tag_switch__generate_tag_switch_14_p_0(TaggedCases_28, SwitchVarRval_30, SwitchVarType_24, SwitchVarName_25, CodeModel_11, CanFail_13, GoalInfo_15, EndLabel_20, (MR_Word) ((MR_Unsigned) 0U), &MaybeEnd_33, &SwitchCode_34, STATE_VARIABLE_CI_44_44, STATE_VARIABLE_CI_41, STATE_VARIABLE_CLD_45_45);
              else
                ll_backend__switch_gen__order_and_generate_cases_13_p_0(TaggedCases_28, SwitchVarRval_30, SwitchVarType_24, SwitchVarName_25, CodeModel_11, CanFail_13, GoalInfo_15, EndLabel_20, &MaybeEnd_33, &SwitchCode_34, STATE_VARIABLE_CI_44_44, STATE_VARIABLE_CI_41, STATE_VARIABLE_CLD_45_45);
            }
            break;
  ...
  *Code_16 = mercury__cord__f_43_43_2_f_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_instruction_0), SwitchVarCode_29, SwitchCode_34);
  ll_backend__code_loc_dep__after_all_branches_4_p_0(StoreMap_19, MaybeEnd_33, *STATE_VARIABLE_CI_41, STATE_VARIABLE_CLD_43);
}
  ...
  MR_Word STATE_VARIABLE_CLD_0_41)
{
  ...
  if (succeeded)
  {
    ...
    StringHashSwitchSize_34 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), OptTuple_33, (MR_Integer) 31))));
    StringBinarySwitchSize_35 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), OptTuple_33, (MR_Integer) 32))));
  ...
  MR_Word STATE_VARIABLE_CLD_0_56)
{
  ...
  if (succeeded)
  {
    IntSwitchInfo_34 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MaybeIntSwitchInfo_21, (MR_Integer) 0))));
    LowerLimit_35 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), IntSwitchInfo_34, (MR_Integer) 0))));
    UpperLimit_36 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), IntSwitchInfo_34, (MR_Integer) 1))));
    NumValues_37 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), IntSwitchInfo_34, (MR_Integer) 2))));
    libs__globals__get_opt_tuple_2_p_0(Globals_18, &OptTuple_38);
    Var_57 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), OptTuple_38, (MR_Integer) 1))) >> 13)) & (MR_Integer) 1);
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ReqDensity_41 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), OptTuple_38, (MR_Integer) 27))));
        LookupSize_40 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), OptTuple_38, (MR_Integer) 29))));
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              ...
              TypeCtorInfo_708_708 = (MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0);
              succeeded = ll_backend__lookup_switch__is_lookup_switch_10_p_0(TypeCtorInfo_708_708, BranchStart_48, Var_59, FilteredTaggedCases_42, GoalInfo_26, StoreMap_49, Var_60, &MaybeEnd1_50, &LookupSwitchInfo_51, STATE_VARIABLE_CI_0_54, &STATE_VARIABLE_CI_61_61);
            }
          }
        }
      }
  ...
  else
  {
    ...
    if (succeeded)
    {
      IntSwitchInfo_68 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MaybeIntSwitchInfo_21, (MR_Integer) 0))));
      LowerLimit_69 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), IntSwitchInfo_68, (MR_Integer) 0))));
      UpperLimit_70 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), IntSwitchInfo_68, (MR_Integer) 1))));
      NumValues_71 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), IntSwitchInfo_68, (MR_Integer) 2))));
      libs__globals__get_opt_tuple_2_p_0(Globals_18, &OptTuple_72);
      ReqDensity_73 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), OptTuple_72, (MR_Integer) 26))));
      DenseSize_52 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), OptTuple_72, (MR_Integer) 28))));
  ...
  MR_Word STATE_VARIABLE_CLD_0_36)
{
  ...
  MR_Word CanSucceedCases_43;
  MR_Word CannotSucceedCases_44;
  MR_Word TypeDefn_30;

  ll_backend__switch_gen__separate_cannot_succeed_cases_3_p_0(TaggedCases_14, &CanSucceedCases_43, &CannotSucceedCases_44);
  if ((CannotSucceedCases_44 == (MR_Word) ((MR_Unsigned) 0U)))
    ...
    OrderedTaggedCases_26 = mercury__list__f_43_43_2_f_0((MR_Word) (&hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_tagged_case_0), CanSucceedCases_43, CannotSucceedCases_44);
  ...
  MR_Word * STATE_VARIABLE_CI_57)
{
  ...
  else
  {
    ...
    ll_backend__code_loc_dep__generate_branch_end_5_p_0(StoreMap_35, STATE_VARIABLE_MaybeEnd_0_54, &STATE_VARIABLE_MaybeEnd_86_86, &SaveCode_49, STATE_VARIABLE_CLD_85_85);
  ...
  MR_Word CI_10)
{
  ...
  if (succeeded)
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        Case1_11 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Cases0_6, (MR_Integer) 0))));
        Var_35 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Cases0_6, (MR_Integer) 1))));
        succeeded = (Var_35 != (MR_Word) ((MR_Unsigned) 0U));
        if (succeeded)
        {
          Case2_12 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Var_35, (MR_Integer) 0))));
          Var_36 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Var_35, (MR_Integer) 1))));
          succeeded = (Var_36 == (MR_Word) ((MR_Unsigned) 0U));
          if (succeeded)
          {
            Goal1_16 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Case1_11, (MR_Integer) 3))));
            Goal2_20 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Case2_12, (MR_Integer) 3))));
            succeeded = MR_TRUE;
          }
        }
      }
  ...
  if (succeeded)
  {
    ...
    if (succeeded)
    {
      ...
      SingleRecBaseFirst_32 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), OptTuple_31, (MR_Integer) 1))) >> 15)) & (MR_Integer) 1);
        ...
        case (MR_Integer) 1:
          {
...

            {
              ...
              MR_hl_field(MR_mktag(1), Var_37, 0) = ((MR_Box) (SingleRecCase_30));
            ...
            }
            {
              ...
              *Cases_7 = base;
              MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (BaseCase_29));
        ...
        case (MR_Integer) 0:
          {
...

            {
              ...
              MR_hl_field(MR_mktag(1), Var_39, 0) = ((MR_Box) (BaseCase_29));
            ...
            }
            {
              ...
              base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              *Cases_7 = base;
              MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (SingleRecCase_30));
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        MultiRecBaseFirst_34 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), OptTuple_47, (MR_Integer) 1))) >> 14)) & (MR_Integer) 1);
          ...
          case (MR_Integer) 1:
            {
...

              {
                ...
                MR_hl_field(MR_mktag(1), Var_43, 0) = ((MR_Box) (BaseCase_48));
              ...
              }
              {
                ...
                base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                *Cases_7 = base;
                MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (MultiRecCase_33));
          ...
          case (MR_Integer) 0:
            {
...

              {
                ...
                MR_hl_field(MR_mktag(1), Var_45, 0) = ((MR_Box) (MultiRecCase_33));
              ...
              }
              {
                ...
                base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                *Cases_7 = base;
                MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (BaseCase_48));
