                ...
                if (ll_backend__switch_gen__succeeded)
                  {
                    ...
                    ll_backend__switch_gen__V_85_85 = (MR_Integer) 448;
                    ...
                    if (ll_backend__switch_gen__succeeded)
                      {
                        ...
                        ll_backend__switch_gen__V_95_95 = (MR_Integer) 434;
                        {
                        ...
                        if (ll_backend__switch_gen__succeeded)
                          {
                            ...
                            if (ll_backend__switch_gen__succeeded)
                              {
                                ll_backend__switch_gen__V_97_97 = (MR_Integer) 432;
                                {
                ...
                if (ll_backend__switch_gen__succeeded)
                  {
                    ...
                    {
                      libs__globals__lookup_int_option_3_p_0(ll_backend__switch_gen__Globals_33, (MR_Integer) 437, &ll_backend__switch_gen__StringHashSwitchSize_53);
                    }
                    {
                      libs__globals__lookup_int_option_3_p_0(ll_backend__switch_gen__Globals_33, (MR_Integer) 438, &ll_backend__switch_gen__StringBinarySwitchSize_54);
                    }
            ...
            case (MR_Integer) 2:
              {
                ...
                {
                  libs__globals__lookup_int_option_3_p_0(ll_backend__switch_gen__Globals_33, (MR_Integer) 439, &ll_backend__switch_gen__TagSize_55);
                }
