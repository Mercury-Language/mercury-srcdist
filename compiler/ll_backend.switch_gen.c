            ...
            case (MR_Integer) 1:
              {
                ...
                if (succeeded)
                {
                  ...
                  libs__globals__lookup_int_option_3_p_0(Globals_33, (MR_Integer) 450, &StringHashSwitchSize_53);
                  libs__globals__lookup_int_option_3_p_0(Globals_33, (MR_Integer) 451, &StringBinarySwitchSize_54);
            ...
            case (MR_Integer) 2:
              {
                ...
                libs__globals__lookup_int_option_3_p_0(Globals_33, (MR_Integer) 452, &TagSize_55);
...
{
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        Var_47 = ((MR_Word) (MR_hl_field(MR_mktag(1), VarTypeDefnBody_46, (MR_Integer) 0)));
        Var_48 = ((MR_Word) (MR_hl_field(MR_mktag(1), VarTypeDefnBody_46, (MR_Integer) 1)));
        MaybeRepn_49 = ((MR_Word) (MR_hl_field(MR_mktag(1), VarTypeDefnBody_46, (MR_Integer) 2)));
        Var_50 = ((MR_Word) (MR_hl_field(MR_mktag(1), VarTypeDefnBody_46, (MR_Integer) 3)));
        if ((MaybeRepn_49 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
        {
          {
            mercury__require__unexpected_2_p_0((MR_String) "predicate \140ll_backend.switch_gen.order_cases\'/6", (MR_String) "MaybeRepn = no");
            return;
          }
        }
        else
          Repn_51 = ((MR_Word) (MR_hl_field(MR_mktag(1), MaybeRepn_49, (MR_Integer) 0)));
        Var_59 = ((MR_Word) (MR_hl_field(MR_mktag(0), Repn_51, (MR_Integer) 0)));
        Var_60 = ((MR_Word) (MR_hl_field(MR_mktag(0), Repn_51, (MR_Integer) 1)));
        Var_61 = ((MR_Word) (MR_hl_field(MR_mktag(0), Repn_51, (MR_Integer) 2)));
        Var_62 = ((MR_Word) (MR_hl_field(MR_mktag(0), Repn_51, (MR_Integer) 3)));
        Var_63 = ((MR_Word) (MR_hl_field(MR_mktag(0), Repn_51, (MR_Integer) 4)));
        Var_64 = ((MR_Word) (MR_hl_field(MR_mktag(0), Repn_51, (MR_Integer) 5)));
        Var_58 = ((MR_Word) (MR_hl_field(MR_mktag(0), Repn_51, (MR_Integer) 6)));
        succeeded = (Var_58 == (MR_Integer) 0);
      }
    }
    if (succeeded)
    {
      MR_Word ReservedAddrCases0_52;
      MR_Word NonReservedAddrCases0_53;
      MR_Word ReservedAddrCases_54;
      MR_Word NonReservedAddrCases_55;

      ll_backend__switch_gen__separate_reserved_address_cases_3_p_0(TaggedCases_14, &ReservedAddrCases0_52, &NonReservedAddrCases0_53);
      ll_backend__switch_gen__order_can_and_cannot_succeed_cases_5_p_0(ReservedAddrCases0_52, &ReservedAddrCases_54, CodeModel_18, CanFail_19, STATE_VARIABLE_CI_0_34);
      ll_backend__switch_gen__order_can_and_cannot_succeed_cases_5_p_0(NonReservedAddrCases0_53, &NonReservedAddrCases_55, CodeModel_18, CanFail_19, STATE_VARIABLE_CI_0_34);
      OrderedTaggedCases_26 = mercury__list__f_43_43_2_f_0((MR_Word) &hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_tagged_case_0, ReservedAddrCases_54, NonReservedAddrCases_55);
    }
    else
    ...
    if ((CannotSucceedCases_12 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_32, (MR_Integer) 455, &SingleRecBaseFirst_41);
        ...
        else
        {
          ...
          if (succeeded)
          {
            ...
            libs__globals__lookup_bool_option_3_p_0(Globals_32, (MR_Integer) 456, &MultiRecBaseFirst_43);
