            ...
            if (ll_backend__switch_gen__succeeded)
              {
                ...
                {
                  libs__globals__lookup_bool_option_3_p_0(ll_backend__switch_gen__Globals_32, (MR_Integer) 450, &ll_backend__switch_gen__SingleRecBaseFirst_41);
                }
                ...
                if (ll_backend__switch_gen__succeeded)
                  {
                    ...
                    {
                      libs__globals__lookup_bool_option_3_p_0(ll_backend__switch_gen__Globals_32, (MR_Integer) 451, &ll_backend__switch_gen__MultiRecBaseFirst_43);
                    }
                ...
                if (ll_backend__switch_gen__succeeded)
                  {
                    ...
                    ll_backend__switch_gen__Var_85 = (MR_Integer) 456;
                    ...
                    if (ll_backend__switch_gen__succeeded)
                      {
                        ...
                        if (ll_backend__switch_gen__succeeded)
                          {
                            ll_backend__switch_gen__Var_87 = (MR_Integer) 443;
                            {
                            ...
                            if (ll_backend__switch_gen__succeeded)
                              {
                                ...
                                if (ll_backend__switch_gen__succeeded)
                                  {
                                    ll_backend__switch_gen__Var_89 = (MR_Integer) 441;
                                    {
                    ...
                    if (ll_backend__switch_gen__succeeded)
                      {
                        ...
                        ll_backend__switch_gen__Var_95 = (MR_Integer) 442;
                        {
                        ...
                        if (ll_backend__switch_gen__succeeded)
                          {
                            ...
                            if (ll_backend__switch_gen__succeeded)
                              {
                                ll_backend__switch_gen__Var_97 = (MR_Integer) 440;
                                {
                ...
                if (ll_backend__switch_gen__succeeded)
                  {
                    ...
                    {
                      libs__globals__lookup_int_option_3_p_0(ll_backend__switch_gen__Globals_33, (MR_Integer) 445, &ll_backend__switch_gen__StringHashSwitchSize_53);
                    }
                    {
                      libs__globals__lookup_int_option_3_p_0(ll_backend__switch_gen__Globals_33, (MR_Integer) 446, &ll_backend__switch_gen__StringBinarySwitchSize_54);
                    }
            ...
            case (MR_Integer) 2:
              {
                ...
                {
                  libs__globals__lookup_int_option_3_p_0(ll_backend__switch_gen__Globals_33, (MR_Integer) 447, &ll_backend__switch_gen__TagSize_55);
                }
