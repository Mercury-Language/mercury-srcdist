...
ll_backend__switch_gen__generate_smart_string_switch_17_p_0(
  ...
  MR_Integer NumConsIds_25,
  MR_Word TaggedCases_26,
  MR_Word FilteredTaggedCases_27,
  MR_Word GoalInfo_28,
  MR_Word EndLabel_29,
  MR_Word * MaybeEnd_30,
  ...
  MR_Word STATE_VARIABLE_CLD_0_34)
{
  ...
  backend_libs__lookup_switch_util__filter_out_failing_cases_if_needed_5_p_0(CodeModel_16, TaggedCases_21, &FilteredTaggedCases_28, CanFail_17, &FilteredCanFail_29);
  ...
  if (succeeded)
  {
    ...
    ll_backend__switch_gen__separate_cannot_succeed_cases_3_p_0(TaggedCases_21, &CanSucceedCases_45, &CannotSucceedCases_46);
    if ((CannotSucceedCases_46 == (MR_Word) ((MR_Unsigned) 0U)))
      ll_backend__switch_gen__order_recursive_cases_5_p_0(TaggedCases_21, &OrderedTaggedCases_36, CodeModel_16, CanFail_17, STATE_VARIABLE_CI_0_32);
    else
    ...
    parse_tree__prog_type__type_to_ctor_det_2_p_0(SwitchVarType_19, &TypeCtor_37);
    ...
    ll_backend__switch_gen__f_85_110_117_115_101_100_65_114_103_115_95_95_112_114_101_100_95_95_103_101_110_101_114_97_116_101_95_105_102_95_116_104_101_110_95_101_108_115_101_95_99_104_97_105_110_95_99_97_115_101_115_95_95_91_52_93_95_48_15_p_0(BranchStart_43, OrderedTaggedCases_36, SwitchVarRval_20, SwitchVarName_18, CheaperTagTest_42, CodeModel_16, CanFail_17, GoalInfo_22, EndLabel_23, (MR_Word) ((MR_Unsigned) 0U), MaybeEnd_24, SwitchCode_25, STATE_VARIABLE_CI_0_32, STATE_VARIABLE_CI_33);
  }
  else
    ll_backend__switch_gen__generate_smart_string_switch_17_p_0(Globals_15, CodeModel_16, CanFail_17, FilteredCanFail_29, SwitchVarName_18, SwitchVarType_19, SwitchVarRval_20, NumConsIds_30, TaggedCases_21, FilteredTaggedCases_28, GoalInfo_22, EndLabel_23, MaybeEnd_24, SwitchCode_25, STATE_VARIABLE_CI_0_32, STATE_VARIABLE_CI_33, STATE_VARIABLE_CLD_0_34);
}
  ...
  MR_Word STATE_VARIABLE_CLD_0_43)
{
  MR_bool succeeded;
  MR_Word StoreMap_34;
  MR_Word MaybeLookupSwitchInfo_35;
  MR_Word OptTuple_36;
  MR_Integer StringTrieSwitchSize_37;
  MR_Word Var_45;

  hlds__hlds_llds__goal_info_get_store_map_2_p_0(GoalInfo_28, &StoreMap_34);
  ll_backend__lookup_switch__is_lookup_switch_7_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&ll_backend__switch_gen_scalar_common_1[4]), FilteredTaggedCases_27, GoalInfo_28, StoreMap_34, STATE_VARIABLE_CI_0_41, STATE_VARIABLE_CLD_0_43, &MaybeLookupSwitchInfo_35);
  libs__globals__get_opt_tuple_2_p_0(Globals_18, &OptTuple_36);
  Var_45 = mercury__string__internal_string_encoding_0_f_0();
  succeeded = (Var_45 == (MR_Integer) 0);
  if (succeeded)
  {
    StringTrieSwitchSize_37 = ((MR_Integer) ((MR_hl_field(0, OptTuple_36, (MR_Integer) 30))));
    succeeded = (NumConsIds_25 >= StringTrieSwitchSize_37);
    if (succeeded)
    {
      succeeded = mercury__builtin__semidet_fail_0_p_0();
      if (succeeded)
        succeeded = (MaybeLookupSwitchInfo_35 == (MR_Word) ((MR_Unsigned) 0U));
    }
  }
  if (succeeded)
    ll_backend__string_switch__generate_string_trie_switch_12_p_0(TaggedCases_26, SwitchVarRval_24, SwitchVarName_22, CodeModel_19, CanFail_20, GoalInfo_28, EndLabel_29, MaybeEnd_30, SwitchCode_31, STATE_VARIABLE_CI_0_41, STATE_VARIABLE_CI_42, STATE_VARIABLE_CLD_0_43);
  else
  {
    MR_Integer StringHashSwitchSize_38 = ((MR_Integer) ((MR_hl_field(0, OptTuple_36, (MR_Integer) 31))));

    succeeded = (NumConsIds_25 >= StringHashSwitchSize_38);
    if (succeeded)
      if ((MaybeLookupSwitchInfo_35 == (MR_Word) ((MR_Unsigned) 0U)))
        ll_backend__string_switch__generate_string_hash_switch_12_p_0(TaggedCases_26, SwitchVarRval_24, SwitchVarName_22, CodeModel_19, CanFail_20, GoalInfo_28, EndLabel_29, MaybeEnd_30, SwitchCode_31, STATE_VARIABLE_CI_0_41, STATE_VARIABLE_CI_42, STATE_VARIABLE_CLD_0_43);
      else
      {
        MR_Word LookupSwitchInfo_39 = ((MR_Word) ((MR_hl_field(1, MaybeLookupSwitchInfo_35, (MR_Integer) 0))));

        ll_backend__string_switch__generate_string_hash_lookup_switch_8_p_0(SwitchVarRval_24, LookupSwitchInfo_39, FilteredCanFail_21, EndLabel_29, StoreMap_34, MaybeEnd_30, SwitchCode_31, STATE_VARIABLE_CI_42);
      }
    else
    {
      MR_Integer StringBinarySwitchSize_40 = ((MR_Integer) ((MR_hl_field(0, OptTuple_36, (MR_Integer) 32))));

      succeeded = (NumConsIds_25 >= StringBinarySwitchSize_40);
      if (succeeded)
        if ((MaybeLookupSwitchInfo_35 == (MR_Word) ((MR_Unsigned) 0U)))
          ll_backend__string_switch__generate_string_binary_switch_12_p_0(TaggedCases_26, SwitchVarRval_24, SwitchVarName_22, CodeModel_19, CanFail_20, GoalInfo_28, EndLabel_29, MaybeEnd_30, SwitchCode_31, STATE_VARIABLE_CI_0_41, STATE_VARIABLE_CI_42, STATE_VARIABLE_CLD_0_43);
        else
        {
          MR_Word LookupSwitchInfo_52 = ((MR_Word) ((MR_hl_field(1, MaybeLookupSwitchInfo_35, (MR_Integer) 0))));

          ll_backend__string_switch__generate_string_binary_lookup_switch_8_p_0(SwitchVarRval_24, LookupSwitchInfo_52, FilteredCanFail_21, EndLabel_29, StoreMap_34, MaybeEnd_30, SwitchCode_31, STATE_VARIABLE_CI_42);
        }
      else
        ll_backend__switch_gen__order_and_generate_cases_13_p_0(TaggedCases_26, SwitchVarRval_24, SwitchVarType_23, SwitchVarName_22, CodeModel_19, CanFail_20, GoalInfo_28, EndLabel_29, MaybeEnd_30, SwitchCode_31, STATE_VARIABLE_CI_0_41, STATE_VARIABLE_CI_42, STATE_VARIABLE_CLD_0_43);
    }
  }
}
  ...
  MR_Word STATE_VARIABLE_CLD_0_55)
{
  ...
  MR_Word MaybeLookupSwitchInfo_49;
  MR_Word Var_56;
  MR_Integer Var_57;
  MR_Word Var_58;
  ...
  if (succeeded)
  {
    ...
    Var_56 = ((((MR_Unsigned) ((MR_hl_field(0, OptTuple_38, (MR_Integer) 1))) >> 12)) & (MR_Integer) 1);
    succeeded = (Var_56 == (MR_Integer) 0);
    if (succeeded)
    {
      ll_backend__code_info__get_maybe_trace_info_2_p_0(STATE_VARIABLE_CI_0_53, &MaybeTraceInfo_39);
      ...
      if (succeeded)
      {
        ...
        {
          Var_57 = (MR_Integer) 1;
          succeeded = (NumArms_33 > Var_57);
          if (succeeded)
          {
            backend_libs__lookup_switch_util__filter_out_failing_cases_if_needed_5_p_0(CodeModel_19, TaggedCases_25, &FilteredTaggedCases_42, CanFail_20, &FilteredCanFail_43);
            succeeded = backend_libs__lookup_switch_util__find_int_lookup_switch_params_11_p_0(ModuleInfo_17, SwitchVarType_23, FilteredCanFail_43, LowerLimit_35, UpperLimit_36, NumValues_37, ReqDensity_41, &NeedBitVecCheck_44, &NeedRangeCheck_45, &FirstVal_46, &LastVal_47);
            if (succeeded)
            {
              hlds__hlds_llds__goal_info_get_store_map_2_p_0(GoalInfo_26, &StoreMap_48);
              Var_58 = (MR_Word) (&ll_backend__switch_gen_scalar_common_1[3]);
              TypeCtorInfo_692_692 = (MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0);
              ll_backend__lookup_switch__is_lookup_switch_7_p_0(TypeCtorInfo_692_692, Var_58, FilteredTaggedCases_42, GoalInfo_26, StoreMap_48, STATE_VARIABLE_CI_0_53, STATE_VARIABLE_CLD_0_55, &MaybeLookupSwitchInfo_49);
              succeeded = (MaybeLookupSwitchInfo_49 != (MR_Word) ((MR_Unsigned) 0U));
              if (succeeded)
                LookupSwitchInfo_50 = ((MR_Word) ((MR_hl_field(1, MaybeLookupSwitchInfo_49, (MR_Integer) 0))));
            }
          }
        }
      }
  ...
  if (succeeded)
    ll_backend__lookup_switch__generate_int_lookup_switch_11_p_0(SwitchVarRval_24, LookupSwitchInfo_50, EndLabel_27, StoreMap_48, FirstVal_46, LastVal_47, NeedBitVecCheck_44, NeedRangeCheck_45, MaybeEnd_28, SwitchCode_29, STATE_VARIABLE_CI_54);
  else
  {
    MR_Word DenseSwitchInfo_52;
    MR_Integer DenseSize_51;
    MR_Integer Var_60;
    MR_Word IntSwitchInfo_64;
    MR_Integer LowerLimit_65;
    MR_Integer UpperLimit_66;
    MR_Integer NumValues_67;
    MR_Word OptTuple_68;
    MR_Integer ReqDensity_69;

    succeeded = ((MR_tag((MR_Word) MaybeIntSwitchInfo_21)) == (MR_Integer) 1);
    if (succeeded)
    {
      IntSwitchInfo_64 = ((MR_Word) ((MR_hl_field(1, MaybeIntSwitchInfo_21, (MR_Integer) 0))));
      LowerLimit_65 = ((MR_Integer) ((MR_hl_field(0, IntSwitchInfo_64, (MR_Integer) 0))));
      UpperLimit_66 = ((MR_Integer) ((MR_hl_field(0, IntSwitchInfo_64, (MR_Integer) 1))));
      NumValues_67 = ((MR_Integer) ((MR_hl_field(0, IntSwitchInfo_64, (MR_Integer) 2))));
      libs__globals__get_opt_tuple_2_p_0(Globals_18, &OptTuple_68);
      ReqDensity_69 = ((MR_Integer) ((MR_hl_field(0, OptTuple_68, (MR_Integer) 26))));
      DenseSize_51 = ((MR_Integer) ((MR_hl_field(0, OptTuple_68, (MR_Integer) 28))));
      succeeded = (NumConsIds_32 >= DenseSize_51);
      if (succeeded)
      {
        Var_60 = (MR_Integer) 1;
        succeeded = (NumArms_33 > Var_60);
        if (succeeded)
          succeeded = ll_backend__dense_switch__tagged_case_list_is_dense_switch_9_p_0(STATE_VARIABLE_CI_0_53, SwitchVarType_23, TaggedCases_25, LowerLimit_65, UpperLimit_66, NumValues_67, ReqDensity_69, CanFail_20, &DenseSwitchInfo_52);
      }
    }
    if (succeeded)
      ll_backend__dense_switch__generate_dense_switch_13_p_0(TaggedCases_25, SwitchVarRval_24, SwitchVarName_22, CodeModel_19, GoalInfo_26, DenseSwitchInfo_52, EndLabel_27, (MR_Word) ((MR_Unsigned) 0U), MaybeEnd_28, SwitchCode_29, STATE_VARIABLE_CI_0_53, STATE_VARIABLE_CI_54, STATE_VARIABLE_CLD_0_55);
    else
      ll_backend__switch_gen__order_and_generate_cases_13_p_0(TaggedCases_25, SwitchVarRval_24, SwitchVarType_23, SwitchVarName_22, CodeModel_19, CanFail_20, GoalInfo_26, EndLabel_27, MaybeEnd_28, SwitchCode_29, STATE_VARIABLE_CI_0_53, STATE_VARIABLE_CI_54, STATE_VARIABLE_CLD_0_55);
  }
}
