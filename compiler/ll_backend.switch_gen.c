                    ...
                    if (ll_backend__switch_gen__succeeded)
                      {
                        ...
                        if (ll_backend__switch_gen__succeeded)
                          {
                            ll_backend__switch_gen__V_87_87 = (MR_Integer) 431;
                            {
                            ...
                            if (ll_backend__switch_gen__succeeded)
                              {
                                ...
                                if (ll_backend__switch_gen__succeeded)
                                  {
                                    ll_backend__switch_gen__V_89_89 = (MR_Integer) 429;
                                    {
                    ...
                    if (ll_backend__switch_gen__succeeded)
                      {
                        ...
                        ll_backend__switch_gen__V_95_95 = (MR_Integer) 430;
                        {
                        ...
                        if (ll_backend__switch_gen__succeeded)
                          {
                            ...
                            if (ll_backend__switch_gen__succeeded)
                              {
                                ll_backend__switch_gen__V_97_97 = (MR_Integer) 428;
                                {
                ...
                if (ll_backend__switch_gen__succeeded)
                  {
                    ...
                    {
                      libs__globals__lookup_int_option_3_p_0(ll_backend__switch_gen__Globals_33, (MR_Integer) 433, &ll_backend__switch_gen__StringHashSwitchSize_53);
                    }
                    {
                      libs__globals__lookup_int_option_3_p_0(ll_backend__switch_gen__Globals_33, (MR_Integer) 434, &ll_backend__switch_gen__StringBinarySwitchSize_54);
                    }
            ...
            case (MR_Integer) 2:
              {
                ...
                {
                  libs__globals__lookup_int_option_3_p_0(ll_backend__switch_gen__Globals_33, (MR_Integer) 435, &ll_backend__switch_gen__TagSize_55);
                }
