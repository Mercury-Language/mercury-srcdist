      ...
      case (MR_Integer) 0:
        {
          ...
          if (succeeded)
          {
            ...
            CheaperTagTest_76 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
          ll_backend__code_loc_dep__remember_position_2_p_0(STATE_VARIABLE_CLD_42_42, &BranchStart_77);
          ll_backend__switch_gen__generate_if_then_else_chain_cases_15_p_0(BranchStart_77, OrderedTaggedCases_70, SwitchVarRval_28, SwitchVarType_22, SwitchVarName_26, CheaperTagTest_76, CodeModel_11, CanFail_13, GoalInfo_15, EndLabel_20, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), &MaybeEnd_31, &SwitchCode_32, STATE_VARIABLE_CI_41_41, STATE_VARIABLE_CI_38);
        }
        break;
      case (MR_Integer) 1:
        {
            ...
            case (MR_Integer) 3:
              {
                ...
                libs__globals__lookup_int_option_3_p_0(Globals_33, (MR_Integer) 449, &TagSize_36);
                ...
                if (succeeded)
                {
                  ll_backend__tag_switch__generate_tag_switch_14_p_0(TaggedCases_25, SwitchVarRval_28, SwitchVarType_22, SwitchVarName_26, CodeModel_11, CanFail_13, GoalInfo_15, EndLabel_20, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), &MaybeEnd_31, &SwitchCode_32, STATE_VARIABLE_CI_41_41, STATE_VARIABLE_CI_38, STATE_VARIABLE_CLD_42_42);
                }
                else
                  ll_backend__switch_gen__order_and_generate_cases_13_p_0(TaggedCases_25, SwitchVarRval_28, SwitchVarType_22, SwitchVarName_26, CodeModel_11, CanFail_13, GoalInfo_15, EndLabel_20, &MaybeEnd_31, &SwitchCode_32, STATE_VARIABLE_CI_41_41, STATE_VARIABLE_CI_38, STATE_VARIABLE_CLD_42_42);
              }
...
{
  {
    ...
    if (succeeded)
    {
      ...
      libs__globals__lookup_int_option_3_p_0(Globals_15, (MR_Integer) 447, &StringHashSwitchSize_33);
      libs__globals__lookup_int_option_3_p_0(Globals_15, (MR_Integer) 448, &StringBinarySwitchSize_34);
      ...
      else
      {
        ...
        if (succeeded)
        {
          ...
          MR_Word MaybeEnd1_64;
          MR_Word LookupSwitchInfo_65;

          ll_backend__code_loc_dep__remember_position_2_p_0(STATE_VARIABLE_CLD_0_40, &BranchStart_63);
          succeeded = ll_backend__lookup_switch__is_lookup_switch_10_p_0((MR_Word) &mercury__builtin__builtin__type_ctor_info_string_0, BranchStart_63, (MR_Word) &ll_backend__switch_gen_scalar_common_1[6], FilteredTaggedCases_29, GoalInfo_22, StoreMap_28, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), &MaybeEnd1_64, &LookupSwitchInfo_65, STATE_VARIABLE_CI_0_38, &STATE_VARIABLE_CI_52_52);
          if (succeeded)
          {
            MR_Word STATE_VARIABLE_CLD_47_60;

            ll_backend__code_loc_dep__reset_to_position_3_p_0(BranchStart_63, STATE_VARIABLE_CI_52_52, &STATE_VARIABLE_CLD_47_60);
            ll_backend__string_switch__generate_string_binary_lookup_switch_11_p_0(SwitchVarRval_20, LookupSwitchInfo_65, FilteredCanFail_30, EndLabel_23, StoreMap_28, MaybeEnd1_64, MaybeEnd_24, SwitchCode_25, STATE_VARIABLE_CI_52_52, STATE_VARIABLE_CI_39, STATE_VARIABLE_CLD_47_60);
          }
          else
...
{
  {
    ...
    succeeded = ((MR_tag((MR_Word) MaybeIntSwitchInfo_21)) == (MR_mktag((MR_Integer) 1)));
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        succeeded = (MaybeTraceInfo_37 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
        if (succeeded)
        {
          Var_57 = (MR_Integer) 445;
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                ...
                succeeded = ll_backend__lookup_switch__is_lookup_switch_10_p_0(TypeCtorInfo_87_87, BranchStart_46, Var_60, FilteredTaggedCases_40, GoalInfo_26, StoreMap_47, Var_61, &MaybeEnd1_48, &LookupSwitchInfo_49, STATE_VARIABLE_CI_0_52, &STATE_VARIABLE_CI_62_62);
              }
            }
          }
        }
    ...
    else
    {
      ...
      if (succeeded)
      {
        ll_backend__dense_switch__generate_dense_switch_13_p_0(TaggedCases_25, SwitchVarRval_24, SwitchVarName_22, CodeModel_19, GoalInfo_26, DenseSwitchInfo_51, EndLabel_27, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), MaybeEnd_28, SwitchCode_29, STATE_VARIABLE_CI_0_52, STATE_VARIABLE_CI_53, STATE_VARIABLE_CLD_0_54);
      }
      else
    ...
    if ((CannotSucceedCases_12 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_32, (MR_Integer) 452, &SingleRecBaseFirst_41);
        ...
        else
        {
          ...
          if (succeeded)
          {
            ...
            libs__globals__lookup_bool_option_3_p_0(Globals_32, (MR_Integer) 453, &MultiRecBaseFirst_43);
