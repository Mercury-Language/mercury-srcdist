            ...
            case (MR_Integer) 3:
              {
                ...
                libs__globals__lookup_int_option_3_p_0(Globals_33, (MR_Integer) 465, &TagSize_36);
...
{
  {
    ...
    if (succeeded)
    {
      ...
      libs__globals__lookup_int_option_3_p_0(Globals_15, (MR_Integer) 463, &StringHashSwitchSize_33);
      libs__globals__lookup_int_option_3_p_0(Globals_15, (MR_Integer) 464, &StringBinarySwitchSize_34);
    ...
    if ((CannotSucceedCases_12 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_32, (MR_Integer) 468, &SingleRecBaseFirst_41);
        ...
        else
        {
          ...
          if (succeeded)
          {
            ...
            libs__globals__lookup_bool_option_3_p_0(Globals_32, (MR_Integer) 469, &MultiRecBaseFirst_43);
