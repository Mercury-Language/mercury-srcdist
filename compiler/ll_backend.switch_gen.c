            ...
            case (MR_Integer) 3:
              {
                ...
                libs__globals__lookup_int_option_3_p_0(Globals_33, (MR_Integer) 453, &TagSize_36);
                ...
                if (succeeded)
                {
                  ll_backend__tag_switch__generate_tag_switch_14_p_0(TaggedCases_25, SwitchVarRval_28, SwitchVarType_22, SwitchVarName_26, CodeModel_11, CanFail_13, GoalInfo_15, EndLabel_20, (MR_Word) ((MR_Integer) 0), &MaybeEnd_31, &SwitchCode_32, STATE_VARIABLE_CI_41_41, STATE_VARIABLE_CI_38, STATE_VARIABLE_CLD_42_42);
                }
                else
                  ll_backend__switch_gen__order_and_generate_cases_13_p_0(TaggedCases_25, SwitchVarRval_28, SwitchVarType_22, SwitchVarName_26, CodeModel_11, CanFail_13, GoalInfo_15, EndLabel_20, &MaybeEnd_31, &SwitchCode_32, STATE_VARIABLE_CI_41_41, STATE_VARIABLE_CI_38, STATE_VARIABLE_CLD_42_42);
              }
...
{
  {
    ...
    if (succeeded)
    {
      ...
      libs__globals__lookup_int_option_3_p_0(Globals_15, (MR_Integer) 451, &StringHashSwitchSize_33);
      libs__globals__lookup_int_option_3_p_0(Globals_15, (MR_Integer) 452, &StringBinarySwitchSize_34);
...
{
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        succeeded = (MaybeTraceInfo_37 == (MR_Word) ((MR_Integer) 0));
        if (succeeded)
        {
          Var_57 = (MR_Integer) 449;
    ...
    else
    {
      ...
      if (succeeded)
      {
        ll_backend__dense_switch__generate_dense_switch_13_p_0(TaggedCases_25, SwitchVarRval_24, SwitchVarName_22, CodeModel_19, GoalInfo_26, DenseSwitchInfo_51, EndLabel_27, (MR_Word) ((MR_Integer) 0), MaybeEnd_28, SwitchCode_29, STATE_VARIABLE_CI_0_52, STATE_VARIABLE_CI_53, STATE_VARIABLE_CLD_0_54);
      }
      else
...
{
  {
    ...
    if (succeeded)
    {
      ...
      CheaperTagTest_32 = (MR_Word) ((MR_Integer) 0);
    ll_backend__code_loc_dep__remember_position_2_p_0(STATE_VARIABLE_CLD_0_36, &BranchStart_33);
    ll_backend__switch_gen__generate_if_then_else_chain_cases_15_p_0(BranchStart_33, OrderedTaggedCases_26, VarRval_15, VarType_16, VarName_17, CheaperTagTest_32, CodeModel_18, CanFail_19, GoalInfo_20, EndLabel_21, (MR_Word) ((MR_Integer) 0), MaybeEnd_22, Code_23, STATE_VARIABLE_CI_0_34, STATE_VARIABLE_CI_35);
  }
}
...
{
  {
    ...
    if ((Cases_17 == (MR_Word) ((MR_Integer) 0)))
    {
      MR_Word FailCode_52;
      MR_Word EndCode_53;
      MR_Word Var_60;
...
{
  {
    ...
    if ((CannotSucceedCases_12 == (MR_Word) ((MR_Integer) 0)))
    {
      MR_Word Case1_21;
      MR_Word Case2_22;
      MR_Word Goal1_26;
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_32, (MR_Integer) 456, &SingleRecBaseFirst_41);
        ...
        else
        {
          ...
          if (succeeded)
          {
            ...
            libs__globals__lookup_bool_option_3_p_0(Globals_32, (MR_Integer) 457, &MultiRecBaseFirst_43);
