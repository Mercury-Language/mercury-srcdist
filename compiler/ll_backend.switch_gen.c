  ...
  MR_Word STATE_VARIABLE_CLD_0_42)
{
  ...
  else
  {
    ...
    if (succeeded)
      ...
      {
        MR_Word LookupSwitchInfo_52 = ((MR_Word) ((MR_hl_field(1, MaybeLookupSwitchInfo_34, 0))));
    ...
    else
    {
      ...
      if (succeeded)
        ...
        {
          MR_Word LookupSwitchInfo_54 = ((MR_Word) ((MR_hl_field(1, MaybeLookupSwitchInfo_34, 0))));
  ...
  MR_Word STATE_VARIABLE_CLD_0_54)
{
  ...
  if (succeeded)
  {
    ...
    Var_55 = ((((MR_Unsigned) ((MR_hl_field(0, OptTuple_38, 1))) >> 12)) & (MR_Integer) 1);
  ...
  else
  {
    ...
    if (succeeded)
    {
      IntSwitchInfo_63 = ((MR_Word) ((MR_hl_field(1, MaybeIntSwitchInfo_23, 0))));
      LowerLimit_64 = ((MR_Integer) ((MR_hl_field(0, IntSwitchInfo_63, 0))));
      UpperLimit_65 = ((MR_Integer) ((MR_hl_field(0, IntSwitchInfo_63, 1))));
      NumValues_66 = ((MR_Integer) ((MR_hl_field(0, IntSwitchInfo_63, 2))));
      libs__globals__get_opt_tuple_2_p_0(Globals_18, &OptTuple_67);
      ReqDensity_68 = ((MR_Integer) ((MR_hl_field(0, OptTuple_67, 26))));
      DenseSize_50 = ((MR_Integer) ((MR_hl_field(0, OptTuple_67, 28))));
