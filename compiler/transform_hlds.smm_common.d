...
ifeq ($(TARGET_ASM),yes)
transform_hlds.smm_common.mh transform_hlds.smm_common.mih : transform_hlds.smm_common.s
else
transform_hlds.smm_common.mh transform_hlds.smm_common.mih : transform_hlds.smm_common.c
endif

ifeq ($(TARGET_ASM),yes)
transform_hlds.smm_common.module_dep : transform_hlds.smm_common.s
else
 ifeq ($(findstring il,$(GRADE)),il)
transform_hlds.smm_common.module_dep : transform_hlds.smm_common.il
  ifeq ($(findstring java,$(GRADE)),java)
transform_hlds.smm_common.module_dep : mercury/transform_hlds_/smm_common.java
  else
...
ifeq ($(TARGET_ASM),yes)
transform_hlds.smm_common.s_date : smm_common.m
	$(MCG) $(ALL_GRADEFLAGS) $(ALL_MCGFLAGS) --target-code-only transform_hlds.smm_common $(ERR_REDIRECT)
transform_hlds.smm_common.pic_s_date : smm_common.m
	$(MCG) $(ALL_GRADEFLAGS) $(ALL_MCGFLAGS) --target-code-only --pic \
		--cflags "$(GCCFLAGS_FOR_PIC)" transform_hlds.smm_common $(ERR_REDIRECT)
endif # TARGET_ASM
