...
{
  {
    ...
    else
    {
      ...
      MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), ResPoint_38, (MR_Integer) 1)));
...
{
  {
    ...
    else
    {
      ...
      MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), ResPoint_42, (MR_Integer) 1)));
...
{
  {
    ...
    else
    {
      ...
      MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), ResPoint_34, (MR_Integer) 1)));
          ...
          case (MR_Integer) 2:
            {
              ...
              MR_Word Goals_39;
              MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), STATE_VARIABLE_Expr_0_67, (MR_Integer) 1)));
          ...
          case (MR_Integer) 4:
            {
              ...
              MR_Word Cases_43;
              MR_Unsigned packed_word_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), STATE_VARIABLE_Expr_0_67, (MR_Integer) 2)));
          ...
          case (MR_Integer) 5:
            {
              ...
              if (succeeded)
              {
                packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Reason_48, (MR_Integer) 2)));
...
{
  {
    ...
    else
    {
      ...
      MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), ResPoint_25, (MR_Integer) 1)));
