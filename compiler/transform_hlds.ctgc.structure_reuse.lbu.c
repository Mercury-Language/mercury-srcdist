...
{
  {
    ...
    if ((ResPoint_38 == (MR_Word) ((MR_Integer) 0)))
    {
...
{
  {
    ...
    if ((ResPoint_42 == (MR_Word) ((MR_Integer) 0)))
    {
...
{
  {
    ...
    if ((ResPoint_34 == (MR_Word) ((MR_Integer) 0)))
    {
          ...
          case (MR_Integer) 5:
            {
              ...
              if (succeeded)
              {
                Var_76 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Reason_48, (MR_Integer) 2))));
          ...
          case (MR_Integer) 6:
            {
              ...
              hlds__hlds_llds__goal_info_set_resume_point_3_p_0((MR_Word) ((MR_Integer) 0), CondInfo0_57, &InfoTmp_58);
              {
...
{
  {
    ...
    if ((ResPoint_25 == (MR_Word) ((MR_Integer) 0)))
    {
