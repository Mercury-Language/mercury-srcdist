    ...
    case (MR_Integer) 2:
      {
        ...
        if (succeeded)
        {
          ...
          Var_89 = check_hlds__type_util__remove_typeinfo_vars_from_set_of_var_2_f_0(VarTable_8, PostBirths_41);
          {
            ...
            MR_hl_field(MR_mktag(1), Var_90, 0) = ((MR_Box) (STATE_VARIABLE_LBU_18_22));
        ...
        case (MR_Integer) 5:
          {
            ...
            if (succeeded)
            {
              Var_92 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(3), Reason_65, (MR_Integer) 2))) & (MR_Integer) 3);
  ...
  MR_Word * STATE_VARIABLE_ProcInfo_10)
{
  ...
  Expr0_12 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Goal0_4, (MR_Integer) 0))));
  Info0_13 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Goal0_4, (MR_Integer) 1))));
  ...
  {
    MR_Word ResVars_20 = ((MR_Word) ((MR_hl_field(MR_mktag(1), ResPoint_19, (MR_Integer) 0))));
    ...
    case (MR_Integer) 2:
      {
        ...
        if (succeeded)
        {
          ...
          Var_84 = check_hlds__type_util__remove_typeinfo_vars_from_set_of_var_2_f_0(VarTable_5, PostBirths_36);
          {
            ...
            MR_hl_field(MR_mktag(1), Var_85, 0) = ((MR_Box) (STATE_VARIABLE_LBU_18_17));
      ...
      break;
    case (MR_Integer) 3:
      switch (((MR_Integer) ((MR_hl_field(MR_mktag(3), Expr0_12, (MR_Integer) 0))))) {
        default: /*NOTREACHED*/ MR_assert(0);
        case (MR_Integer) 0:
          {
            Expr_14 = Expr0_12;
        ...
        case (MR_Integer) 2:
          {
            MR_Word ConjType_49 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(3), Expr0_12, (MR_Integer) 1))) & (MR_Integer) 1);
            MR_Word Goals0_50 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Expr0_12, (MR_Integer) 2))));
            MR_Word Goals_51;
            ...
            {
              Expr_14 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(3), Expr_14, 0) = ((MR_Box) ((MR_Unsigned) 2U));
              MR_hl_field(MR_mktag(3), Expr_14, 1) = (MR_Box) ((MR_Unsigned) (ConjType_49));
              MR_hl_field(MR_mktag(3), Expr_14, 2) = ((MR_Box) (Goals_51));
            }
          }
          break;
        case (MR_Integer) 3:
          {
            MR_Word Goals0_91 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Expr0_12, (MR_Integer) 1))));
            MR_Word Goals_92;
            ...
            {
              Expr_14 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(3), Expr_14, 0) = ((MR_Box) ((MR_Unsigned) 3U));
              MR_hl_field(MR_mktag(3), Expr_14, 1) = ((MR_Box) (Goals_92));
            }
          }
          break;
        case (MR_Integer) 4:
          {
            MR_Word A_52 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Expr0_12, (MR_Integer) 1))));
            MR_Word B_53 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(3), Expr0_12, (MR_Integer) 2))) & (MR_Integer) 1);
            MR_Word Cases0_54 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Expr0_12, (MR_Integer) 3))));
            MR_Word Cases_55;
            ...
            {
              Expr_14 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(3), Expr_14, 0) = ((MR_Box) ((MR_Unsigned) 4U));
              MR_hl_field(MR_mktag(3), Expr_14, 1) = ((MR_Box) (A_52));
              MR_hl_field(MR_mktag(3), Expr_14, 2) = (MR_Box) ((MR_Unsigned) (B_53));
              MR_hl_field(MR_mktag(3), Expr_14, 3) = ((MR_Box) (Cases_55));
            }
          }
          break;
        case (MR_Integer) 5:
          {
            MR_Word Reason_60 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Expr0_12, (MR_Integer) 1))));
            MR_Word SubGoal0_93 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Expr0_12, (MR_Integer) 2))));
            MR_Word SubGoal_94;
            MR_Word Var_87;
            ...
            if (succeeded)
            {
              Var_87 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(3), Reason_60, (MR_Integer) 2))) & (MR_Integer) 3);
            ...
            {
              Expr_14 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(3), Expr_14, 0) = ((MR_Box) ((MR_Unsigned) 5U));
              MR_hl_field(MR_mktag(3), Expr_14, 1) = ((MR_Box) (Reason_60));
              MR_hl_field(MR_mktag(3), Expr_14, 2) = ((MR_Box) (SubGoal_94));
            }
          }
          break;
        case (MR_Integer) 6:
          {
            MR_Word Vars_62 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Expr0_12, (MR_Integer) 1))));
            MR_Word Cond0_63 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Expr0_12, (MR_Integer) 2))));
            MR_Word Then0_64 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Expr0_12, (MR_Integer) 3))));
            MR_Word Else0_65 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Expr0_12, (MR_Integer) 4))));
            MR_Word Cond_66;
            ...
            CondGoal0_68 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Cond0_63, (MR_Integer) 0))));
            CondInfo0_69 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Cond0_63, (MR_Integer) 1))));
            hlds__hlds_llds__goal_info_set_resume_point_3_p_0((MR_Word) ((MR_Unsigned) 0U), CondInfo0_69, &InfoTmp_70);
            {
              ...
              MR_hl_field(MR_mktag(0), CondTmp_71, 0) = ((MR_Box) (CondGoal0_68));
              MR_hl_field(MR_mktag(0), CondTmp_71, 1) = ((MR_Box) (InfoTmp_70));
            }
            ...
            {
              Expr_14 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(3), Expr_14, 0) = ((MR_Box) ((MR_Unsigned) 6U));
              MR_hl_field(MR_mktag(3), Expr_14, 1) = ((MR_Box) (Vars_62));
              MR_hl_field(MR_mktag(3), Expr_14, 2) = ((MR_Box) (Cond_66));
              MR_hl_field(MR_mktag(3), Expr_14, 3) = ((MR_Box) (Then_74));
              MR_hl_field(MR_mktag(3), Expr_14, 4) = ((MR_Box) (Else_76));
            }
          }
          break;
        case (MR_Integer) 7:
  ...
  hlds__hlds_goal__goal_info_set_lbu_3_p_0(_LBU_8, Info0_13, &Info_15);
  {
    ...
    MR_hl_field(MR_mktag(0), Goal_7, 0) = ((MR_Box) (Expr_14));
    MR_hl_field(MR_mktag(0), Goal_7, 1) = ((MR_Box) (Info_15));
  }
    ...
    case (MR_Integer) 2:
      {
        ...
        if (succeeded)
        {
          ...
          {
            Var_86 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), Var_86, 0) = ((MR_Box) (STATE_VARIABLE_LBU_18_18));
        ...
        case (MR_Integer) 5:
          {
            ...
            if (succeeded)
            {
              Var_88 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(3), Reason_61, (MR_Integer) 2))) & (MR_Integer) 3);
