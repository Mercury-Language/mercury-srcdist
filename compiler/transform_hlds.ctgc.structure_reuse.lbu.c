  ...
  MR_Word * STATE_VARIABLE_LBU_15)
{
  ...
  else
  {
    ...
    Var_23 = check_hlds__type_util__remove_typeinfo_vars_from_set_of_var_vt_2_f_0(VarTable_8, ResVars_27);
  }
    ...
    case (MR_Integer) 0:
      {
        ...
        transform_hlds__ctgc__structure_reuse__lbu__backward_use_in_goal_5_p_0(VarTable_8, SubGoal0_63, &SubGoal_65, STATE_VARIABLE_LBU_18_24, &Var_66);
    ...
    case (MR_Integer) 2:
      {
        ...
        if (succeeded)
        {
          ...
          Var_93 = check_hlds__type_util__remove_typeinfo_vars_from_set_of_var_vt_2_f_0(VarTable_8, PreBirths_42);
          Var_95 = check_hlds__type_util__remove_typeinfo_vars_from_set_of_var_vt_2_f_0(VarTable_8, PostBirths_43);
          {
        ...
        case (MR_Integer) 2:
          {
            ...
            transform_hlds__ctgc__structure_reuse__lbu__backward_use_in_conj_5_p_0(VarTable_8, Goals0_57, &Goals_58, STATE_VARIABLE_LBU_18_24, &NewLBU_11);
            {
        ...
        case (MR_Integer) 3:
          {
            ...
            transform_hlds__ctgc__structure_reuse__lbu__backward_use_in_disj_5_p_0(VarTable_8, Goals0_98, &Goals_99, STATE_VARIABLE_LBU_18_24, &NewLBU_11);
            {
        ...
        case (MR_Integer) 4:
          {
            ...
            transform_hlds__ctgc__structure_reuse__lbu__backward_use_in_cases_5_p_0(VarTable_8, Cases0_61, &Cases_62, STATE_VARIABLE_LBU_18_24, &NewLBU_11);
            {
        ...
        case (MR_Integer) 5:
          {
            ...
            if (succeeded)
            {
              ...
              transform_hlds__ctgc__structure_reuse__lbu__backward_use_in_goal_5_p_0(VarTable_8, SubGoal0_100, &SubGoal_101, STATE_VARIABLE_LBU_18_24, &NewLBU_11);
            {
              Expr_21 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
        ...
        case (MR_Integer) 6:
          {
            ...
            transform_hlds__ctgc__structure_reuse__lbu__backward_use_in_goal_5_p_0(VarTable_8, Cond0_70, &Cond_73, STATE_VARIABLE_LBU_18_24, &Var_74);
            ...
            transform_hlds__ctgc__structure_reuse__lbu__backward_use_in_goal_5_p_0(VarTable_8, CondTmp_78, &Var_79, STATE_VARIABLE_LBU_18_24, &LBU0T_80);
            transform_hlds__ctgc__structure_reuse__lbu__backward_use_in_goal_5_p_0(VarTable_8, Then0_71, &Then_81, LBU0T_80, &LBUT_82);
            transform_hlds__ctgc__structure_reuse__lbu__backward_use_in_goal_5_p_0(VarTable_8, Else0_72, &Else_83, STATE_VARIABLE_LBU_18_24, &LBUE_84);
  ...
  MR_Word * STATE_VARIABLE_ProcInfo_12)
{
  ...
  MR_Word Info_18;
  MR_Word Var_19;
  MR_Word STATE_VARIABLE_LBU_18_20;
  MR_Word ResPoint_22;
  ...
  Expr0_15 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Goal0_6, (MR_Integer) 0))));
  Info0_16 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Goal0_6, (MR_Integer) 1))));
  hlds__hlds_llds__goal_info_get_resume_point_2_p_0(Info0_16, &ResPoint_22);
  ...
  else
  {
    ...
    Var_19 = check_hlds__type_util__remove_typeinfo_vars_from_set_of_var_vt_2_f_0(VarTable_7, ResVars_23);
  }
  parse_tree__set_of_var__union_3_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), Var_19, LBU0_8, &STATE_VARIABLE_LBU_18_20);
  switch (MR_tag((MR_Word) Expr0_15)) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 0:
      {
        MR_Word SubGoal0_59 = (MR_Word) ((MR_Word) (Expr0_15));
        MR_Word SubGoal_61;
        MR_Word Var_62;

        transform_hlds__ctgc__structure_reuse__lbu__backward_use_in_goal_5_p_0(VarTable_7, SubGoal0_59, &SubGoal_61, STATE_VARIABLE_LBU_18_20, &Var_62);
        _LBU_10 = STATE_VARIABLE_LBU_18_20;
        Expr_17 = (MR_Word) ((MR_Word) (SubGoal_61));
      }
      break;
    case (MR_Integer) 1:
      {
    ...
    case (MR_Integer) 2:
      {
        ...
        Det_37 = hlds__hlds_goal__goal_info_get_determinism_1_f_0(Info0_16);
        ...
        if (succeeded)
        {
          ...
          hlds__hlds_llds__goal_info_get_pre_births_2_p_0(Info0_16, &PreBirths_38);
          hlds__hlds_llds__goal_info_get_post_births_2_p_0(Info0_16, &PostBirths_39);
          Var_87 = hlds__hlds_goal__goal_info_get_lfu_1_f_0(Info0_16);
          Var_89 = check_hlds__type_util__remove_typeinfo_vars_from_set_of_var_vt_2_f_0(VarTable_7, PreBirths_38);
          Var_91 = check_hlds__type_util__remove_typeinfo_vars_from_set_of_var_vt_2_f_0(VarTable_7, PostBirths_39);
          {
            Var_92 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), Var_92, 0) = ((MR_Box) (STATE_VARIABLE_LBU_18_20));
          ...
          _LBU_10 = parse_tree__set_of_var__union_list_1_f_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), Var_86);
        }
        else
          _LBU_10 = STATE_VARIABLE_LBU_18_20;
        Expr_17 = Expr0_15;
      ...
      break;
    case (MR_Integer) 3:
      switch (((MR_Integer) ((MR_hl_field(MR_mktag(3), Expr0_15, (MR_Integer) 0))))) {
        default: /*NOTREACHED*/ MR_assert(0);
        case (MR_Integer) 0:
          {
            Expr_17 = Expr0_15;
        ...
        case (MR_Integer) 2:
          {
            MR_Word ConjType_52 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(3), Expr0_15, (MR_Integer) 1))) & (MR_Integer) 1);
            MR_Word Goals0_53 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Expr0_15, (MR_Integer) 2))));
            MR_Word Goals_54;

            transform_hlds__ctgc__structure_reuse__lbu__backward_use_in_conj_5_p_0(VarTable_7, Goals0_53, &Goals_54, STATE_VARIABLE_LBU_18_20, &_LBU_10);
            {
              Expr_17 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(3), Expr_17, 0) = ((MR_Box) ((MR_Unsigned) 2U));
              MR_hl_field(MR_mktag(3), Expr_17, 1) = (MR_Box) ((MR_Unsigned) (ConjType_52));
              MR_hl_field(MR_mktag(3), Expr_17, 2) = ((MR_Box) (Goals_54));
            }
          }
          break;
        case (MR_Integer) 3:
          {
            MR_Word Goals0_94 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Expr0_15, (MR_Integer) 1))));
            MR_Word Goals_95;

            transform_hlds__ctgc__structure_reuse__lbu__backward_use_in_disj_5_p_0(VarTable_7, Goals0_94, &Goals_95, STATE_VARIABLE_LBU_18_20, &_LBU_10);
            {
              Expr_17 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(3), Expr_17, 0) = ((MR_Box) ((MR_Unsigned) 3U));
              MR_hl_field(MR_mktag(3), Expr_17, 1) = ((MR_Box) (Goals_95));
            }
          }
          break;
        case (MR_Integer) 4:
          {
            MR_Word A_55 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Expr0_15, (MR_Integer) 1))));
            MR_Word B_56 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(3), Expr0_15, (MR_Integer) 2))) & (MR_Integer) 1);
            MR_Word Cases0_57 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Expr0_15, (MR_Integer) 3))));
            MR_Word Cases_58;

            transform_hlds__ctgc__structure_reuse__lbu__backward_use_in_cases_5_p_0(VarTable_7, Cases0_57, &Cases_58, STATE_VARIABLE_LBU_18_20, &_LBU_10);
            {
              Expr_17 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(3), Expr_17, 0) = ((MR_Box) ((MR_Unsigned) 4U));
              MR_hl_field(MR_mktag(3), Expr_17, 1) = ((MR_Box) (A_55));
              MR_hl_field(MR_mktag(3), Expr_17, 2) = (MR_Box) ((MR_Unsigned) (B_56));
              MR_hl_field(MR_mktag(3), Expr_17, 3) = ((MR_Box) (Cases_58));
            }
          }
          break;
        case (MR_Integer) 5:
          {
            MR_Word Reason_63 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Expr0_15, (MR_Integer) 1))));
            MR_Word SubGoal0_96 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Expr0_15, (MR_Integer) 2))));
            MR_Word SubGoal_97;
            MR_Word Var_85;
            ...
            if (succeeded)
            {
              ...
              transform_hlds__ctgc__structure_reuse__lbu__backward_use_in_goal_5_p_0(VarTable_7, SubGoal0_96, &SubGoal_97, STATE_VARIABLE_LBU_18_20, &_LBU_10);
            {
              Expr_17 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(3), Expr_17, 0) = ((MR_Box) ((MR_Unsigned) 5U));
              MR_hl_field(MR_mktag(3), Expr_17, 1) = ((MR_Box) (Reason_63));
              MR_hl_field(MR_mktag(3), Expr_17, 2) = ((MR_Box) (SubGoal_97));
            }
          }
          break;
        case (MR_Integer) 6:
          {
            MR_Word Vars_65 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Expr0_15, (MR_Integer) 1))));
            MR_Word Cond0_66 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Expr0_15, (MR_Integer) 2))));
            MR_Word Then0_67 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Expr0_15, (MR_Integer) 3))));
            MR_Word Else0_68 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Expr0_15, (MR_Integer) 4))));
            MR_Word Cond_69;
            ...
            transform_hlds__ctgc__structure_reuse__lbu__backward_use_in_goal_5_p_0(VarTable_7, Cond0_66, &Cond_69, STATE_VARIABLE_LBU_18_20, &Var_70);
            ...
            transform_hlds__ctgc__structure_reuse__lbu__backward_use_in_goal_5_p_0(VarTable_7, CondTmp_74, &Var_75, STATE_VARIABLE_LBU_18_20, &LBU0T_76);
            transform_hlds__ctgc__structure_reuse__lbu__backward_use_in_goal_5_p_0(VarTable_7, Then0_67, &Then_77, LBU0T_76, &LBUT_78);
            transform_hlds__ctgc__structure_reuse__lbu__backward_use_in_goal_5_p_0(VarTable_7, Else0_68, &Else_79, STATE_VARIABLE_LBU_18_20, &LBUE_80);
            parse_tree__set_of_var__union_3_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), LBUT_78, LBUE_80, &_LBU_10);
            {
              Expr_17 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(3), Expr_17, 0) = ((MR_Box) ((MR_Unsigned) 6U));
              MR_hl_field(MR_mktag(3), Expr_17, 1) = ((MR_Box) (Vars_65));
              MR_hl_field(MR_mktag(3), Expr_17, 2) = ((MR_Box) (Cond_69));
              MR_hl_field(MR_mktag(3), Expr_17, 3) = ((MR_Box) (Then_77));
              MR_hl_field(MR_mktag(3), Expr_17, 4) = ((MR_Box) (Else_79));
            }
          }
          break;
        case (MR_Integer) 7:
  ...
  hlds__hlds_goal__goal_info_set_lbu_3_p_0(_LBU_10, Info0_16, &Info_18);
  {
    Goal_9 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(MR_mktag(0), Goal_9, 0) = ((MR_Box) (Expr_17));
    MR_hl_field(MR_mktag(0), Goal_9, 1) = ((MR_Box) (Info_18));
  }
  ...
  MR_Word * STATE_VARIABLE_LBU_16)
{
  ...
  else
  {
    ...
    Var_17 = check_hlds__type_util__remove_typeinfo_vars_from_set_of_var_vt_2_f_0(VarTable_6, ResVars_23);
  }
    ...
    case (MR_Integer) 0:
      {
        ...
        transform_hlds__ctgc__structure_reuse__lbu__backward_use_in_goal_5_p_0(VarTable_6, SubGoal0_59, &SubGoal_61, STATE_VARIABLE_LBU_18_18, &Var_62);
    ...
    case (MR_Integer) 2:
      {
        ...
        if (succeeded)
        {
          ...
          Var_89 = check_hlds__type_util__remove_typeinfo_vars_from_set_of_var_vt_2_f_0(VarTable_6, PreBirths_38);
          Var_91 = check_hlds__type_util__remove_typeinfo_vars_from_set_of_var_vt_2_f_0(VarTable_6, PostBirths_39);
          {
            Var_92 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        ...
        case (MR_Integer) 2:
          {
            ...
            transform_hlds__ctgc__structure_reuse__lbu__backward_use_in_conj_5_p_0(VarTable_6, Goals0_53, &Goals_54, STATE_VARIABLE_LBU_18_18, STATE_VARIABLE_LBU_16);
            {
        ...
        case (MR_Integer) 3:
          {
            ...
            transform_hlds__ctgc__structure_reuse__lbu__backward_use_in_disj_5_p_0(VarTable_6, Goals0_94, &Goals_95, STATE_VARIABLE_LBU_18_18, STATE_VARIABLE_LBU_16);
            {
        ...
        case (MR_Integer) 4:
          {
            ...
            transform_hlds__ctgc__structure_reuse__lbu__backward_use_in_cases_5_p_0(VarTable_6, Cases0_57, &Cases_58, STATE_VARIABLE_LBU_18_18, STATE_VARIABLE_LBU_16);
            {
        ...
        case (MR_Integer) 5:
          {
            ...
            if (succeeded)
            {
              ...
              *STATE_VARIABLE_LBU_16 = STATE_VARIABLE_LBU_18_18;
              ...
              transform_hlds__ctgc__structure_reuse__lbu__backward_use_in_goal_5_p_0(VarTable_6, SubGoal0_96, &SubGoal_97, STATE_VARIABLE_LBU_18_18, STATE_VARIABLE_LBU_16);
            {
              Expr_11 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
        ...
        case (MR_Integer) 6:
          {
            ...
            transform_hlds__ctgc__structure_reuse__lbu__backward_use_in_goal_5_p_0(VarTable_6, Cond0_66, &Cond_69, STATE_VARIABLE_LBU_18_18, &Var_70);
            CondGoal0_71 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Cond0_66, (MR_Integer) 0))));
            CondInfo0_72 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Cond0_66, (MR_Integer) 1))));
            hlds__hlds_llds__goal_info_set_resume_point_3_p_0((MR_Word) ((MR_Unsigned) 0U), CondInfo0_72, &InfoTmp_73);
            {
            ...
            transform_hlds__ctgc__structure_reuse__lbu__backward_use_in_goal_5_p_0(VarTable_6, CondTmp_74, &Var_75, STATE_VARIABLE_LBU_18_18, &LBU0T_76);
            transform_hlds__ctgc__structure_reuse__lbu__backward_use_in_goal_5_p_0(VarTable_6, Then0_67, &Then_77, LBU0T_76, &LBUT_78);
            transform_hlds__ctgc__structure_reuse__lbu__backward_use_in_goal_5_p_0(VarTable_6, Else0_68, &Else_79, STATE_VARIABLE_LBU_18_18, &LBUE_80);
