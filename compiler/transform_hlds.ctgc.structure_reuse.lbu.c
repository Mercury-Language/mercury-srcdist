  ...
  MR_Word * STATE_VARIABLE_ProcInfo_13)
{
  ...
  MR_Word Info_26;
  MR_Word Var_27;
  MR_Word STATE_VARIABLE_LBU_18_28;
  MR_Word ResPoint_35;
  MR_Word _VarSet_7;
  ...
  Expr0_23 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Goal0_6, (MR_Integer) 0))));
  Info0_24 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Goal0_6, (MR_Integer) 1))));
  hlds__hlds_llds__goal_info_get_resume_point_2_p_0(Info0_24, &ResPoint_35);
  if ((ResPoint_35 == (MR_Word) ((MR_Unsigned) 0U)))
  ...
  {
    MR_Word ResVars_36 = ((MR_Word) ((MR_hl_field(MR_mktag(1), ResPoint_35, (MR_Integer) 0))));

    Var_27 = check_hlds__type_util__remove_typeinfo_vars_from_set_of_var_2_f_0(VarTypes_8, ResVars_36);
  }
  parse_tree__set_of_var__union_3_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), Var_27, LBU0_9, &STATE_VARIABLE_LBU_18_28);
  transform_hlds__ctgc__structure_reuse__lbu__backward_use_in_goal_2_6_p_0(VarTypes_8, Info0_24, Expr0_23, &Expr_25, STATE_VARIABLE_LBU_18_28, &_LBU_11);
  hlds__hlds_goal__goal_info_set_lbu_3_p_0(_LBU_11, Info0_24, &Info_26);
  {
    Goal_10 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(MR_mktag(0), Goal_10, 0) = ((MR_Box) (Expr_25));
    MR_hl_field(MR_mktag(0), Goal_10, 1) = ((MR_Box) (Info_26));
  }
