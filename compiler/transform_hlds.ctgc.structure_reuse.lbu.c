    ...
    case (MR_Integer) 2:
      {
        ...
        if (succeeded)
        {
          ...
          Var_87 = check_hlds__type_util__remove_typeinfo_vars_from_set_of_var_vt_2_f_0(VarTable_8, PreBirths_40);
          Var_89 = check_hlds__type_util__remove_typeinfo_vars_from_set_of_var_vt_2_f_0(VarTable_8, PostBirths_41);
          {
    ...
    case (MR_Integer) 2:
      {
        ...
        if (succeeded)
        {
          ...
          Var_82 = hlds__hlds_goal__goal_info_get_lfu_1_f_0(Info0_15);
          Var_84 = check_hlds__type_util__remove_typeinfo_vars_from_set_of_var_vt_2_f_0(VarTable_7, PreBirths_37);
          Var_86 = check_hlds__type_util__remove_typeinfo_vars_from_set_of_var_vt_2_f_0(VarTable_7, PostBirths_38);
          {
            Var_87 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), Var_87, 0) = ((MR_Box) (STATE_VARIABLE_LBU_18_19));
          ...
          _LBU_10 = parse_tree__set_of_var__union_list_1_f_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), Var_81);
        }
        else
          _LBU_10 = STATE_VARIABLE_LBU_18_19;
        Expr_16 = Expr0_14;
        ...
        case (MR_Integer) 5:
          {
            ...
            if (succeeded)
            {
              Var_89 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(3), Reason_62, (MR_Integer) 2))) & (MR_Integer) 3);
    ...
    case (MR_Integer) 2:
      {
        ...
        if (succeeded)
        {
          ...
          Var_83 = check_hlds__type_util__remove_typeinfo_vars_from_set_of_var_vt_2_f_0(VarTable_6, PreBirths_36);
          Var_85 = check_hlds__type_util__remove_typeinfo_vars_from_set_of_var_vt_2_f_0(VarTable_6, PostBirths_37);
          {
            Var_86 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
