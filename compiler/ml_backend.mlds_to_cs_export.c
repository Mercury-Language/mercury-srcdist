  ...
  MR_Word Export_10)
{
...

  {
    ...
    MR_hl_field(MR_mktag(0), Var_35, 0) = ((MR_Box) (&ml_backend__mlds_to_cs_export_scalar_common_2[0]));
  ...
  ModuleName_83 = ((MR_Word) ((MR_hl_field(MR_mktag(0), MLDS_Name_14, (MR_Integer) 0))));
  FuncName_84 = ((MR_Word) ((MR_hl_field(MR_mktag(0), MLDS_Name_14, (MR_Integer) 1))));
  ml_backend__mlds_to_cs_name__output_qual_name_prefix_cs_5_p_0(Stream_8, ModuleName_83, (MR_Integer) 0);
  ml_backend__mlds_to_cs_name__output_function_name_for_csharp_4_p_0(Stream_8, FuncName_84);
