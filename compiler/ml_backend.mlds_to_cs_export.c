...
ml_backend__mlds_to_cs_export__IntroducedFrom__pred__output_export_for_csharp__78__1_2_p_0(
  MR_Word Lang_12,
  ...
  MR_Word ExportedConstant_12)
{
  ...
  Var_23 = ml_backend__mlds_to_cs_type__type_to_string_for_csharp_2_f_0(Info_8, MLDS_Type_11);
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = ml_backend__mlds_to_cs_export__IntroducedFrom__pred__output_export_for_csharp__78__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 4)))));
  return succeeded;
}
  ...
  MR_Word Export_10)
{
  ...
  {
    MR_Word Var_81 = ((MR_Word) ((MR_hl_field(1, ReturnTypes_19, (MR_Integer) 1))));
    MR_Word Var_82 = ((MR_Word) ((MR_hl_field(1, ReturnTypes_19, (MR_Integer) 0))));

    if ((Var_81 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      ml_backend__mlds_to_cs_type__output_type_for_csharp_5_p_0(Info_7, Stream_8, Var_82);
  ...
  else
  {
    ...
    Var_72 = ml_backend__mlds_to_cs_type__type_to_string_for_csharp_2_f_0(Info_7, RetTypeB_31);
  ...
  Var_74 = mercury__list__f_43_43_2_f_0((MR_Word) (&ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_argument_0), InArgs_25, RestOutArgs_26);
  ModuleName_87 = ((MR_Word) ((MR_hl_field(0, MLDS_Name_14, (MR_Integer) 0))));
  FuncName_88 = ((MR_Word) ((MR_hl_field(0, MLDS_Name_14, (MR_Integer) 1))));
  ml_backend__mlds_to_cs_name__output_qual_name_prefix_cs_5_p_0(Stream_8, ModuleName_87, (MR_Integer) 0);
  ml_backend__mlds_to_cs_name__output_function_name_for_csharp_4_p_0(Stream_8, FuncName_88);
  mercury__io__write_char_4_p_0(Stream_8, (MR_Char) 40);
  parse_tree__parse_tree_out_info__write_out_list_6_p_0((MR_Word) (&ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_argument_0), (MR_Word) (&ml_backend__mlds_to_cs_export_scalar_common_4[1]), (MR_String) ", ", Var_74, Stream_8);
  mercury__io__write_string_4_p_0(Stream_8, (MR_String) ");\n");
  ml_backend__mlds_to_target_util__output_n_indents_4_p_0(Stream_8, Indent_9);
  mercury__io__write_string_4_p_0(Stream_8, (MR_String) "}\n");
}
