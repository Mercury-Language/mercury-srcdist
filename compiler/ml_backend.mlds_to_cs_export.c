...
{
  {
    ...
    ml_backend__mlds_to_cs_data__output_initializer_body_for_csharp_8_p_0(Info_7, (MR_Integer) 0, Var_26, Initializer_13, (MR_Word) ((MR_Unsigned) 0U), (MR_String) ";");
  }
}
      ...
      case (MR_Integer) 1:
        {
          ...
          {
            ClassId_16 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
...
{
  {
    ...
    Var_52 = (MR_Integer) ((MR_Unsigned) Indent_7 + (MR_Unsigned) 1);
