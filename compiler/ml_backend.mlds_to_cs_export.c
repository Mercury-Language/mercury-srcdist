...
static void MR_CALL 
ml_backend__mlds_to_cs_export__write_export_call_for_csharp_5_p_0_1(
  MR_Box closure_arg,
  MR_Box wrapper_arg_1,
  MR_Box wrapper_arg_2,
  MR_Box wrapper_arg_3,
...
static void MR_CALL 
ml_backend__mlds_to_cs_export__write_export_call_for_csharp_5_p_0(
  MR_Word Stream_6,
...
static /* final */ const MR_Box ml_backend__mlds_to_cs_export_scalar_common_2[1][7];
...
static /* final */ const MR_Box ml_backend__mlds_to_cs_export_scalar_common_3[2][3] = {
  /* row   0 */
  {
    ...
    ((MR_Box) (ml_backend__mlds_to_cs_export__write_export_call_for_csharp_5_p_0_1)),
    ((MR_Box) ((MR_Integer) 0))
  },
  /* row   1 */
  {
  ...
  MR_Box * wrapper_arg_3)
{
  ...
  ml_backend__mlds_to_cs_export__output_exported_enum_constant_for_csharp_7_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))), ((MR_Integer) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 5)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 6)))), ((MR_Word) (wrapper_arg_1)));
}
    ...
    case (MR_Integer) 1:
      {
        ...
        ml_backend__ml_type_gen__ml_gen_type_name_3_p_0(TypeCtor_14, &ClassName_16, &ClassArity_17);
        {
          ...
          MR_hl_field(MR_mktag(0), ClassId_18, 0) = ((MR_Box) (ClassName_16));
          MR_hl_field(MR_mktag(0), ClassId_18, 1) = ((MR_Box) (ClassArity_17));
          MR_hl_field(MR_mktag(0), ClassId_18, 2) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 3));
        }
        MLDS_Type_19 = (MR_Word) (MR_mkword(MR_mktag(1), (MR_Word) (ClassId_18)));
        {
          Var_23 = (MR_Word) MR_new_object(MR_Word, (7 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), Var_23, 0) = ((MR_Box) (&ml_backend__mlds_to_cs_export_scalar_common_6[0]));
          MR_hl_field(MR_mktag(0), Var_23, 1) = ((MR_Box) (ml_backend__mlds_to_cs_export__output_exported_enum_for_csharp_6_p_0_1));
          ...
          MR_hl_field(MR_mktag(0), Var_23, 6) = ((MR_Box) (MLDS_Type_19));
        }
...
{
  MR_bool succeeded;
  MR_Word Name_8 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Arg_5, (MR_Integer) 0))));
  ...
  MR_Word HeadVar__1_1)
{
  ...
  succeeded = ((((MR_tag((MR_Word) Type_3)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(MR_mktag(3), Type_3, (MR_Integer) 0)))) == (MR_Integer) 7)));
  if (succeeded)
  {
  }
  return succeeded;
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = ml_backend__mlds_to_cs_export__IntroducedFrom__pred__output_export_for_csharp__77__1_2_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))));
  return succeeded;
}
  ...
  MR_Word Export_10)
{
  ...
  MR_Word MLDS_Name_14 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Export_10, (MR_Integer) 2))));
...

  {
    ...
    MR_hl_field(MR_mktag(0), Var_35, 0) = ((MR_Box) (&ml_backend__mlds_to_cs_export_scalar_common_4[0]));
    MR_hl_field(MR_mktag(0), Var_35, 1) = ((MR_Box) (ml_backend__mlds_to_cs_export__output_export_for_csharp_6_p_0_1));
    MR_hl_field(MR_mktag(0), Var_35, 2) = ((MR_Box) ((MR_Integer) 2));
    MR_hl_field(MR_mktag(0), Var_35, 3) = ((MR_Box) (Lang_12));
  ...
  {
    MR_Word Var_81 = ((MR_Word) ((MR_hl_field(MR_mktag(1), ReturnTypes_19, (MR_Integer) 1))));
    MR_Word Var_82 = ((MR_Word) ((MR_hl_field(MR_mktag(1), ReturnTypes_19, (MR_Integer) 0))));

    if ((Var_81 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      ml_backend__mlds_to_cs_type__output_type_for_csharp_5_p_0(Info_7, Var_82, Stream_8);
  ...
  mercury__list__filter_4_p_0((MR_Word) (&ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_argument_0), (MR_Word) (&ml_backend__mlds_to_cs_export_scalar_common_3[1]), Parameters_18, &OutArgs_24, &InArgs_25);
  if ((ReturnTypes_19 == (MR_Word) ((MR_Unsigned) 0U)))
    if ((OutArgs_24 == (MR_Word) ((MR_Unsigned) 0U)))
      RestOutArgs_26 = (MR_Word) ((MR_Unsigned) 0U);
    else
    {
      MR_Word FirstOutArg_27 = ((MR_Word) ((MR_hl_field(MR_mktag(1), OutArgs_24, (MR_Integer) 0))));
      MR_Word FirstOutArgName_28;

      RestOutArgs_26 = ((MR_Word) ((MR_hl_field(MR_mktag(1), OutArgs_24, (MR_Integer) 1))));
      FirstOutArgName_28 = ((MR_Word) ((MR_hl_field(MR_mktag(0), FirstOutArg_27, (MR_Integer) 0))));
      ml_backend__mlds_to_cs_name__output_local_var_name_for_csharp_4_p_0(Stream_8, FirstOutArgName_28);
      mercury__io__write_string_4_p_0(Stream_8, (MR_String) " = ");
    }
  else
  {
    MR_Word RetTypeB_31 = ((MR_Word) ((MR_hl_field(MR_mktag(1), ReturnTypes_19, (MR_Integer) 0))));
  ...
  ml_backend__mlds_to_cs_export__write_export_call_for_csharp_5_p_0(Stream_8, MLDS_Name_14, Var_73);
  ml_backend__mlds_to_target_util__output_n_indents_4_p_0(Stream_8, Indent_9);
  mercury__io__write_string_4_p_0(Stream_8, (MR_String) "}\n");
}
  ...
  MR_Word Parameters_8)
{
  ...
  ml_backend__mlds_to_cs_name__output_qual_name_prefix_cs_5_p_0(Stream_6, ModuleName_10, (MR_Integer) 0);
  ml_backend__mlds_to_cs_name__output_function_name_for_csharp_4_p_0(Stream_6, FuncName_11);
  mercury__io__write_char_4_p_0(Stream_6, (MR_Char) 40);
  parse_tree__parse_tree_out_info__write_out_list_6_p_0((MR_Word) (&ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_argument_0), (MR_Word) (&ml_backend__mlds_to_cs_export_scalar_common_3[0]), (MR_String) ", ", Parameters_8, Stream_6);
  ...
  MR_Box * wrapper_arg_3)
{
  ...
  ml_backend__mlds_to_cs_export__output_exported_enum_for_csharp_6_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))), ((MR_Integer) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 5)))), ((MR_Word) (wrapper_arg_1)));
}
  ...
  MR_Word ExportedEnums_10)
{
...

  {
    ...
    MR_hl_field(MR_mktag(0), Var_14, 0) = ((MR_Box) (&ml_backend__mlds_to_cs_export_scalar_common_1[1]));
    MR_hl_field(MR_mktag(0), Var_14, 1) = ((MR_Box) (ml_backend__mlds_to_cs_export__output_exported_enums_for_csharp_6_p_0_1));
  ...
  MR_Box * wrapper_arg_3)
{
  ...
  ml_backend__mlds_to_cs_export__output_export_for_csharp_6_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))), ((MR_Integer) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 5)))), ((MR_Word) (wrapper_arg_1)));
}
  ...
  MR_Word Exports_10)
{
  ...
  {
    Var_14 = (MR_Word) MR_new_object(MR_Word, (6 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(MR_mktag(0), Var_14, 0) = ((MR_Box) (&ml_backend__mlds_to_cs_export_scalar_common_1[0]));
    MR_hl_field(MR_mktag(0), Var_14, 1) = ((MR_Box) (ml_backend__mlds_to_cs_export__output_exports_for_csharp_6_p_0_1));
    MR_hl_field(MR_mktag(0), Var_14, 2) = ((MR_Box) ((MR_Integer) 3));
    MR_hl_field(MR_mktag(0), Var_14, 3) = ((MR_Box) (Info_7));
    MR_hl_field(MR_mktag(0), Var_14, 4) = ((MR_Box) (Stream_8));
    MR_hl_field(MR_mktag(0), Var_14, 5) = ((MR_Box) (Indent_9));
