...
static /* final */ const MR_Box hlds__make_hlds__make_hlds_passes_scalar_common_1[71][2];
...
{
  {
    ...
    else
    {
      ...
      if ((Origin_13 == (MR_Word) ((MR_Integer) 0)))
      ...
      if ((env_ptr)->hlds__make_hlds__make_hlds_passes__implement_finalise_7_p_0_env_0__succeeded)
      {
        ...
        if ((env_ptr)->hlds__make_hlds__make_hlds_passes__implement_finalise_7_p_0_env_0__succeeded)
        {
          ...
          if ((env_ptr)->hlds__make_hlds__make_hlds_passes__implement_finalise_7_p_0_env_0__succeeded)
          {
            ...
            if ((env_ptr)->hlds__make_hlds__make_hlds_passes__implement_finalise_7_p_0_env_0__succeeded)
            {
              (env_ptr)->hlds__make_hlds__make_hlds_passes__implement_finalise_7_p_0_env_0__succeeded = ((env_ptr)->hlds__make_hlds__make_hlds_passes__implement_finalise_7_p_0_env_0__Var_87 == (MR_Word) ((MR_Integer) 0));
              if ((env_ptr)->hlds__make_hlds__make_hlds_passes__implement_finalise_7_p_0_env_0__succeeded)
              {
      ...
      {
        {
          ...
          if ((env_ptr)->hlds__make_hlds__make_hlds_passes__implement_finalise_7_p_0_env_0__succeeded)
          {
            ...
            if ((env_ptr)->hlds__make_hlds__make_hlds_passes__implement_finalise_7_p_0_env_0__succeeded)
            {
              ...
              (env_ptr)->hlds__make_hlds__make_hlds_passes__implement_finalise_7_p_0_env_0__succeeded = (Var_83 == (MR_Word) ((MR_Integer) 0));
              if ((env_ptr)->hlds__make_hlds__make_hlds_passes__implement_finalise_7_p_0_env_0__succeeded)
              {
...
{
  {
    ...
    if ((env_ptr)->hlds__make_hlds__make_hlds_passes__implement_finalise_7_p_0_env_0__succeeded)
    {
      ...
      (env_ptr)->hlds__make_hlds__make_hlds_passes__implement_finalise_7_p_0_env_0__succeeded = ((env_ptr)->hlds__make_hlds__make_hlds_passes__implement_finalise_7_p_0_env_0__HeadModes_167 == (MR_Word) ((MR_Integer) 0));
      if ((env_ptr)->hlds__make_hlds__make_hlds_passes__implement_finalise_7_p_0_env_0__succeeded)
      {
...
{
  {
    ...
    if (MR_builtin_setjmp((env_ptr)->hlds__make_hlds__make_hlds_passes__implement_finalise_7_p_0_env_0__commit_1) == 0)
      {
        (env_ptr)->hlds__make_hlds__make_hlds_passes__implement_finalise_7_p_0_env_0__succeeded = ((env_ptr)->hlds__make_hlds__make_hlds_passes__implement_finalise_7_p_0_env_0__ArgTypes_22 == (MR_Word) ((MR_Integer) 0));
        if ((env_ptr)->hlds__make_hlds__make_hlds_passes__implement_finalise_7_p_0_env_0__succeeded)
...
{
  {
...

    {
      ...
      else
      {
        ...
        if ((TailPredIds_19 == (MR_Word) ((MR_Integer) 0)))
        {
          ...
          if ((env).hlds__make_hlds__make_hlds_passes__implement_finalise_7_p_0_env_0__succeeded)
          {
            ...
            hlds__make_hlds__add_foreign_proc__add_pragma_foreign_proc_export_7_p_0((MR_Word) (MR_mkword(MR_mktag(1), ((MR_Box) (&hlds__make_hlds__make_hlds_passes_scalar_common_1[70])))), FPEInfo_38, Context_10, STATE_VARIABLE_ModuleInfo_88_88, STATE_VARIABLE_ModuleInfo_44, STATE_VARIABLE_Specs_0_45, STATE_VARIABLE_Specs_46);
          }
          else
          {
            ...
            if ((env).hlds__make_hlds__make_hlds_passes__implement_finalise_7_p_0_env_0__succeeded)
            {
              ...
              hlds__hlds_module__module_info_new_user_final_pred_5_p_0(SymName_8, Arity_9, &CName_171, STATE_VARIABLE_ModuleInfo_0_43, &STATE_VARIABLE_ModuleInfo_99_99);
              {
                ...
                MR_hl_field(MR_mktag(0), PredNameModesPF_172, 1) = ((MR_Box) ((MR_Integer) 0));
              ...
              hlds__make_hlds__add_foreign_proc__add_pragma_foreign_proc_export_7_p_0((MR_Word) (MR_mkword(MR_mktag(1), ((MR_Box) (&hlds__make_hlds__make_hlds_passes_scalar_common_1[70])))), FPEInfo_173, Context_10, STATE_VARIABLE_ModuleInfo_99_99, STATE_VARIABLE_ModuleInfo_44, STATE_VARIABLE_Specs_0_45, STATE_VARIABLE_Specs_46);
            }
            else
            {
              MR_Word Var_108;
              ...
              }
              {
                ...
                MR_hl_field(MR_mktag(0), Spec_178, 0) = ((MR_Box) ((MR_Integer) 0));
                MR_hl_field(MR_mktag(0), Spec_178, 1) = ((MR_Box) ((MR_Integer) 16));
        ...
        else
        {
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(0), Spec_201, 0) = ((MR_Box) ((MR_Integer) 0));
            MR_hl_field(MR_mktag(0), Spec_201, 1) = ((MR_Box) ((MR_Integer) 16));
      ...
      if ((env_ptr)->hlds__make_hlds__make_hlds_passes__implement_initialise_7_p_0_env_0__succeeded)
      {
        ...
        if ((env_ptr)->hlds__make_hlds__make_hlds_passes__implement_initialise_7_p_0_env_0__succeeded)
        {
          ...
          if ((env_ptr)->hlds__make_hlds__make_hlds_passes__implement_initialise_7_p_0_env_0__succeeded)
          {
            ...
            if ((env_ptr)->hlds__make_hlds__make_hlds_passes__implement_initialise_7_p_0_env_0__succeeded)
            {
              (env_ptr)->hlds__make_hlds__make_hlds_passes__implement_initialise_7_p_0_env_0__succeeded = ((env_ptr)->hlds__make_hlds__make_hlds_passes__implement_initialise_7_p_0_env_0__Var_75 == (MR_Word) ((MR_Integer) 0));
              if ((env_ptr)->hlds__make_hlds__make_hlds_passes__implement_initialise_7_p_0_env_0__succeeded)
              {
      ...
      {
        {
          ...
          if ((env_ptr)->hlds__make_hlds__make_hlds_passes__implement_initialise_7_p_0_env_0__succeeded)
          {
            ...
            if ((env_ptr)->hlds__make_hlds__make_hlds_passes__implement_initialise_7_p_0_env_0__succeeded)
            {
              ...
              (env_ptr)->hlds__make_hlds__make_hlds_passes__implement_initialise_7_p_0_env_0__succeeded = (Var_71 == (MR_Word) ((MR_Integer) 0));
              if ((env_ptr)->hlds__make_hlds__make_hlds_passes__implement_initialise_7_p_0_env_0__succeeded)
              {
...
{
  {
    ...
    if ((env_ptr)->hlds__make_hlds__make_hlds_passes__implement_initialise_7_p_0_env_0__succeeded)
    {
      ...
      (env_ptr)->hlds__make_hlds__make_hlds_passes__implement_initialise_7_p_0_env_0__succeeded = ((env_ptr)->hlds__make_hlds__make_hlds_passes__implement_initialise_7_p_0_env_0__HeadModes_152 == (MR_Word) ((MR_Integer) 0));
      if ((env_ptr)->hlds__make_hlds__make_hlds_passes__implement_initialise_7_p_0_env_0__succeeded)
      {
...
{
  {
    ...
    if (MR_builtin_setjmp((env_ptr)->hlds__make_hlds__make_hlds_passes__implement_initialise_7_p_0_env_0__commit_1) == 0)
      {
        (env_ptr)->hlds__make_hlds__make_hlds_passes__implement_initialise_7_p_0_env_0__succeeded = ((env_ptr)->hlds__make_hlds__make_hlds_passes__implement_initialise_7_p_0_env_0__ArgTypes_22 == (MR_Word) ((MR_Integer) 0));
        if ((env_ptr)->hlds__make_hlds__make_hlds_passes__implement_initialise_7_p_0_env_0__succeeded)
      ...
      else
      {
        ...
        if ((TailPredIds_19 == (MR_Word) ((MR_Integer) 0)))
        {
          ...
          if ((env).hlds__make_hlds__make_hlds_passes__implement_initialise_7_p_0_env_0__succeeded)
          {
            ...
            hlds__make_hlds__add_foreign_proc__add_pragma_foreign_proc_export_7_p_0((MR_Word) (MR_mkword(MR_mktag(1), ((MR_Box) (&hlds__make_hlds__make_hlds_passes_scalar_common_1[70])))), FPEInfo_38, Context_10, STATE_VARIABLE_ModuleInfo_76_76, STATE_VARIABLE_ModuleInfo_44, STATE_VARIABLE_Specs_0_45, STATE_VARIABLE_Specs_46);
          }
          else
          {
            ...
            if ((env).hlds__make_hlds__make_hlds_passes__implement_initialise_7_p_0_env_0__succeeded)
            {
              ...
              hlds__hlds_module__module_info_new_user_init_pred_5_p_0(SymName_8, Arity_9, &CName_156, STATE_VARIABLE_ModuleInfo_0_43, &STATE_VARIABLE_ModuleInfo_87_87);
              {
                ...
                MR_hl_field(MR_mktag(0), PredNameModesPF_157, 1) = ((MR_Box) ((MR_Integer) 0));
              ...
              hlds__make_hlds__add_foreign_proc__add_pragma_foreign_proc_export_7_p_0((MR_Word) (MR_mkword(MR_mktag(1), ((MR_Box) (&hlds__make_hlds__make_hlds_passes_scalar_common_1[70])))), FPEInfo_158, Context_10, STATE_VARIABLE_ModuleInfo_87_87, STATE_VARIABLE_ModuleInfo_44, STATE_VARIABLE_Specs_0_45, STATE_VARIABLE_Specs_46);
            }
            else
            {
              MR_Word Var_96;
              ...
              }
              {
                ...
                MR_hl_field(MR_mktag(0), Spec_163, 1) = ((MR_Box) ((MR_Integer) 16));
        ...
        else
        {
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(0), Spec_186, 0) = ((MR_Box) ((MR_Integer) 0));
            MR_hl_field(MR_mktag(0), Spec_186, 1) = ((MR_Box) ((MR_Integer) 16));
...
{
  {
    ...
    hlds__make_hlds__add_clause__module_add_clause_15_p_0(VarSet_15, (MR_Integer) 0, Var_42, HeadVars_14, Var_43, Status_18, Context_17, (MR_Word) ((MR_Integer) 0), Var_45, STATE_VARIABLE_ModuleInfo_0_26, STATE_VARIABLE_ModuleInfo_27, STATE_VARIABLE_QualInfo_0_28, STATE_VARIABLE_QualInfo_29, STATE_VARIABLE_Specs_0_30, STATE_VARIABLE_Specs_31);
  }
}
    ...
    else
    {
      ...
      else
      {
        ...
        switch (ItemExport_26) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 2:
            if ((Origin_17 == (MR_Word) ((MR_Integer) 0)))
            {
              MR_Integer Arity_27;
      ...
      hlds__make_hlds__add_clause__module_add_clause_15_p_0(VarSet_18, PredOrFunc_15, PredSymName_14, Args_16, MaybeBodyGoal_19, PredStatus_33, Context_20, Var_70, (MR_Word) ((MR_Integer) 12), STATE_VARIABLE_ModuleInfo_0_34, STATE_VARIABLE_ModuleInfo_35, STATE_VARIABLE_QualInfo_0_36, STATE_VARIABLE_QualInfo_37, STATE_VARIABLE_Specs_65_65, STATE_VARIABLE_Specs_39);
    }
  }
}
        ...
        case (MR_Integer) 1:
          {
            ...
            if ((PredIds_26 == (MR_Word) ((MR_Integer) 0)))
            {
              {
...
{
  {
    ...
    if ((MaybePredOrFunc_12 == (MR_Word) ((MR_Integer) 0)))
    {
      {
...
{
  {
    ...
    else
    {
      ...
      if ((Origin_19 == (MR_Word) ((MR_Integer) 0)))
              ...
              case (MR_Integer) 3:
                {
                  ...
                  hlds__hlds_module__module_add_avail_module_name_6_p_0(ModuleName_8, (MR_Integer) 1, ImportOrUse_11, (MR_Word) ((MR_Integer) 0), STATE_VARIABLE_ModuleInfo_0_16, &STATE_VARIABLE_ModuleInfo_24_24);
...
{
  {
    ...
    parse_tree__prog_type__construct_type_3_p_0(TypeCtor_4, (MR_Word) ((MR_Integer) 0), &Type_9);
    hlds__add_special_pred__add_special_pred_decl_defns_for_type_eagerly_8_p_0(TVarSet_6, Type_9, TypeCtor_4, (MR_Word) (MR_mkword(MR_mktag(3), &hlds__make_hlds__make_hlds_passes_scalar_common_1[65])), (MR_Word) (((MR_Box) ((MR_Integer) 32))), Context_7, STATE_VARIABLE_ModuleInfo_0_11, STATE_VARIABLE_ModuleInfo_12);
  }
}
...
{
  {
    ...
    hlds__hlds_module__module_info_init_6_p_0(AugCompUnit_12, DumpBaseFileName_14, Globals_13, PQInfo_23, (MR_Word) ((MR_Integer) 0), &STATE_VARIABLE_ModuleInfo_72_72);
