...
hlds__make_hlds__make_hlds_passes__IntroducedFrom__pred__parse_tree_to_hlds__178__1_1_p_0(
...
{
  MR_bool succeeded;
  MR_Word Var_140 = (MR_Word) (LambdaHeadVar__1_139);
  MR_Word Phase_294;

  parse_tree__error_spec__extract_spec_phase_2_p_0(Var_140, &Phase_294);
  succeeded = (Phase_294 == (MR_Word) ((MR_Unsigned) 36U));
  return succeeded;
}
  ...
  MR_Word LambdaHeadVar__1_137)
{
  ...
  parse_tree__error_spec__extract_spec_phase_2_p_0(Var_138, &Phase_46);
  ...
  MR_Box wrapper_arg_1)
{
  ...
  succeeded = hlds__make_hlds__make_hlds_passes__IntroducedFrom__pred__parse_tree_to_hlds__178__1_1_p_0(((MR_Word) (wrapper_arg_1)));
  return succeeded;
}
...
hlds__make_hlds__make_hlds_passes__parse_tree_to_hlds_15_p_0(
  ...
  MR_Word * STATE_VARIABLE_QualInfo_121,
  MR_Word * STATE_VARIABLE_ModuleInfo_122,
  MR_Word * STATE_VARIABLE_InvalidTypeSpecs_123,
  MR_Word * STATE_VARIABLE_InvalidInstModeSpecs_124,
  MR_Word * STATE_VARIABLE_ErrSpecs_125,
  MR_Word * STATE_VARIABLE_WarnSpecs_126,
  MR_Word * STATE_VARIABLE_InfoSpecs_127)
{
  MR_bool succeeded;
  ...
  MR_Word DeclTermination_72;
  MR_Word DeclTermination2_73;
  MR_Word DeclSharing_74;
  MR_Word DeclReuse_75;
  MR_Word ImplPragmas_76;
  MR_Word ImplMarkers_77;
  MR_Word GenUnusedArgs_78;
  MR_Word GenExceptions_79;
  MR_Word GenTrailing_80;
  MR_Word GenMMTabling_81;
  MR_Word Clauses_82;
  MR_Word ForeignProcs_83;
  MR_Word IntBadClauses_84;
  MR_Word DirectArgMap_85;
  MR_Word TypeRepnDec_86;
  MR_Word SolverPredDecls_90;
  MR_Word SolverForeignProcs_91;
  MR_Word SolverMutables_92;
  MR_Word AllMutables_96;
  MR_Word InitPredTargetNames0_97;
  MR_Word MQUndefInstSpecs0_98;
  MR_Word MQUndefInstsSet0_99;
  MR_Word MQUndefInsts0_100;
  MR_Word MutablePredDecls_101;
  MR_Word MutableClauses_102;
  MR_Word MutableForeignProcs_103;
  MR_Word MutableForeignDeclCodes_104;
  MR_Word MutableForeignBodyCodes_105;
  MR_Word FPEInfosCord1_106;
  MR_Word InitPredTargetNames1_107;
  MR_Word FinalPredTargetNames1_108;
  MR_Word FPEInfosCord2_109;
  MR_Word InitPredTargetNames_110;
  MR_Word FPEInfosCord_111;
  MR_Word FinalPredTargetNames_112;
  MR_Word PragmaTabledCord_113;
  MR_Word PragmasTabled_114;
  MR_Word FPEInfos_115;
  MR_Word ModuleItemVersionNumbers_116;
  MR_Word MQInfo_117;
  MR_Word MQInvalidTypeSpecs_118;
  MR_Word MQInvalidInstModeSpecs_119;
  MR_Word MQNonBlockingUndefSpecs_120;
  MR_Word STATE_VARIABLE_WarnSpecs_1_128;
  MR_Word STATE_VARIABLE_ErrSpecs_1_134;
  MR_Word STATE_VARIABLE_WarnSpecs_2_135;
  MR_Word Var_136;
  MR_Word STATE_VARIABLE_InvalidTypeSpecs_1_141;
  MR_Word STATE_VARIABLE_InvalidInstModeSpecs_1_142;
  MR_Word STATE_VARIABLE_ModuleInfo_1_144;
  MR_Word STATE_VARIABLE_ModuleInfo_2_145;
  MR_Word STATE_VARIABLE_SolverPredDeclCord_1_146;
  MR_Word STATE_VARIABLE_SolverForeignProcCord_1_147;
  MR_Word STATE_VARIABLE_SolverMutableCord_1_148;
  MR_Word STATE_VARIABLE_ModuleInfo_3_149;
  MR_Word STATE_VARIABLE_SolverPredDeclCord_2_150;
  MR_Word STATE_VARIABLE_SolverForeignProcCord_2_151;
  MR_Word STATE_VARIABLE_SolverMutableCord_2_152;
  MR_Word STATE_VARIABLE_InvalidTypeSpecs_2_153;
  MR_Word STATE_VARIABLE_ErrSpecs_2_154;
  MR_Word STATE_VARIABLE_WarnSpecs_3_155;
  MR_Word STATE_VARIABLE_ModuleInfo_4_156;
  MR_Word STATE_VARIABLE_SolverPredDeclCord_3_157;
  MR_Word STATE_VARIABLE_SolverForeignProcCord_3_158;
  MR_Word STATE_VARIABLE_SolverMutableCord_3_159;
  MR_Word STATE_VARIABLE_InvalidTypeSpecs_3_160;
  MR_Word STATE_VARIABLE_ErrSpecs_3_161;
  MR_Word STATE_VARIABLE_WarnSpecs_4_162;
  MR_Word STATE_VARIABLE_ModuleInfo_5_163;
  MR_Word STATE_VARIABLE_SolverPredDeclCord_4_164;
  MR_Word STATE_VARIABLE_SolverForeignProcCord_4_165;
  MR_Word STATE_VARIABLE_SolverMutableCord_4_166;
  MR_Word STATE_VARIABLE_InvalidTypeSpecs_4_167;
  MR_Word STATE_VARIABLE_ErrSpecs_4_168;
  MR_Word STATE_VARIABLE_WarnSpecs_5_169;
  MR_Word STATE_VARIABLE_ModuleInfo_6_170;
  MR_Word STATE_VARIABLE_ErrSpecs_5_171;
  MR_Word STATE_VARIABLE_WarnSpecs_6_172;
  MR_Word STATE_VARIABLE_InvalidInstModeSpecs_2_173;
  MR_Word STATE_VARIABLE_ModuleInfo_7_174;
  MR_Word STATE_VARIABLE_ErrSpecs_6_175;
  MR_Word STATE_VARIABLE_InvalidInstModeSpecs_3_176;
  MR_Word STATE_VARIABLE_ModuleInfo_8_178;
  MR_Word STATE_VARIABLE_InvalidTypeSpecs_5_179;
  MR_Word STATE_VARIABLE_WarnSpecs_7_180;
  MR_Word STATE_VARIABLE_ModuleInfo_9_181;
  MR_Word STATE_VARIABLE_ErrSpecs_7_182;
  MR_Word STATE_VARIABLE_ModuleInfo_10_183;
  MR_Word STATE_VARIABLE_ErrSpecs_8_184;
  MR_Word STATE_VARIABLE_ModuleInfo_11_185;
  MR_Word STATE_VARIABLE_ErrSpecs_9_186;
  MR_Word STATE_VARIABLE_ErrSpecs_10_187;
  MR_Word STATE_VARIABLE_ModuleInfo_12_188;
  MR_Word STATE_VARIABLE_ErrSpecs_11_189;
  MR_Word STATE_VARIABLE_ModuleInfo_13_190;
  MR_Word STATE_VARIABLE_ErrSpecs_12_191;
  MR_Word STATE_VARIABLE_ModuleInfo_14_192;
  MR_Word STATE_VARIABLE_ModuleInfo_15_193;
  MR_Word STATE_VARIABLE_ErrSpecs_13_194;
  MR_Word STATE_VARIABLE_ModuleInfo_16_195;
  MR_Word STATE_VARIABLE_ErrSpecs_14_196;
  MR_Word STATE_VARIABLE_ModuleInfo_17_198;
  MR_Word STATE_VARIABLE_ModuleInfo_18_201;
  MR_Word STATE_VARIABLE_ModuleInfo_19_202;
  MR_Word STATE_VARIABLE_QualInfo_1_203;
  MR_Word STATE_VARIABLE_ModuleInfo_20_204;
  MR_Word STATE_VARIABLE_QualInfo_2_205;
  MR_Word STATE_VARIABLE_ErrSpecs_15_206;
  MR_Word STATE_VARIABLE_WarnSpecs_8_207;
  MR_Word STATE_VARIABLE_ModuleInfo_21_208;
  MR_Word STATE_VARIABLE_QualInfo_3_209;
  MR_Word STATE_VARIABLE_ErrSpecs_16_210;
  MR_Word STATE_VARIABLE_WarnSpecs_9_211;
  MR_Word STATE_VARIABLE_ModuleInfo_22_212;
  MR_Word STATE_VARIABLE_QualInfo_4_213;
  MR_Word STATE_VARIABLE_ErrSpecs_17_214;
  MR_Word STATE_VARIABLE_WarnSpecs_10_215;
  MR_Word STATE_VARIABLE_ModuleInfo_23_216;
  MR_Word STATE_VARIABLE_ModuleInfo_24_217;
  MR_Word STATE_VARIABLE_ErrSpecs_18_218;
  MR_Word STATE_VARIABLE_WarnSpecs_11_219;
  MR_Word STATE_VARIABLE_ModuleInfo_25_220;
  MR_Word STATE_VARIABLE_ErrSpecs_19_221;
  MR_Word STATE_VARIABLE_WarnSpecs_12_222;
  MR_Word STATE_VARIABLE_ModuleInfo_26_223;
  MR_Word STATE_VARIABLE_ErrSpecs_20_224;
  MR_Word STATE_VARIABLE_WarnSpecs_13_225;
  MR_Word STATE_VARIABLE_ModuleInfo_27_226;
  MR_Word STATE_VARIABLE_ErrSpecs_21_227;
  MR_Word STATE_VARIABLE_WarnSpecs_14_228;
  MR_Word STATE_VARIABLE_ModuleInfo_28_229;
  MR_Word STATE_VARIABLE_ErrSpecs_22_230;
  MR_Word STATE_VARIABLE_WarnSpecs_15_231;
  MR_Word STATE_VARIABLE_ErrSpecs_23_232;
  MR_Word STATE_VARIABLE_ErrSpecs_24_233;
  MR_Word STATE_VARIABLE_ModuleInfo_29_234;
  MR_Word STATE_VARIABLE_ModuleInfo_30_235;
  MR_Word STATE_VARIABLE_ModuleInfo_31_237;
  MR_Word STATE_VARIABLE_QualInfo_5_238;
  MR_Word STATE_VARIABLE_ErrSpecs_25_239;
  MR_Word STATE_VARIABLE_WarnSpecs_16_240;
  MR_Word STATE_VARIABLE_InfoSpecs_2_241;
  MR_Word STATE_VARIABLE_ModuleInfo_32_242;
  MR_Word STATE_VARIABLE_QualInfo_6_243;
  MR_Word STATE_VARIABLE_ErrSpecs_26_244;
  MR_Word STATE_VARIABLE_WarnSpecs_17_245;
  MR_Word STATE_VARIABLE_ModuleInfo_33_247;
  MR_Word STATE_VARIABLE_QualInfo_7_248;
  MR_Word STATE_VARIABLE_ErrSpecs_27_249;
  MR_Word STATE_VARIABLE_WarnSpecs_18_250;
  MR_Word STATE_VARIABLE_ModuleInfo_34_251;
  MR_Word STATE_VARIABLE_ErrSpecs_28_252;
  MR_Word STATE_VARIABLE_ModuleInfo_35_253;
  MR_Word STATE_VARIABLE_ErrSpecs_29_254;
  MR_Word STATE_VARIABLE_ModuleInfo_36_255;
  MR_Word STATE_VARIABLE_ErrSpecs_30_256;
  MR_Word STATE_VARIABLE_ModuleInfo_37_257;
  MR_Word STATE_VARIABLE_ErrSpecs_31_258;
  MR_Word Var_259;
  MR_Word STATE_VARIABLE_ModuleInfo_38_260;
  MR_Word STATE_VARIABLE_ErrSpecs_32_261;
  MR_Word STATE_VARIABLE_WarnSpecs_19_262;
  MR_Word STATE_VARIABLE_ModuleInfo_39_263;
  MR_Word STATE_VARIABLE_QualInfo_8_264;
  MR_Word STATE_VARIABLE_ErrSpecs_33_265;
  MR_Word STATE_VARIABLE_ModuleInfo_40_268;
  MR_Word STATE_VARIABLE_ErrSpecs_34_269;
  MR_Word STATE_VARIABLE_ModuleInfo_41_271;
  MR_Word STATE_VARIABLE_ModuleInfo_42_273;
  ...
  MR_Word STATE_VARIABLE_ModuleInfo_45_281;
  MR_Word STATE_VARIABLE_ErrSpecs_37_282;
  MR_Word STATE_VARIABLE_ErrSpecs_38_285;
  MR_Word STATE_VARIABLE_ErrSpecs_39_286;
  MR_Box conv7_STATE_VARIABLE_ModuleInfo_17_198;
  MR_Word Var_608;
  MR_Box conv13_STATE_VARIABLE_ModuleInfo_40_268;
  MR_Box conv12_STATE_VARIABLE_ErrSpecs_34_269;
  MR_Box conv15_STATE_VARIABLE_ModuleInfo_41_271;
  MR_Box conv17_STATE_VARIABLE_ModuleInfo_42_273;
  MR_Box conv21_STATE_VARIABLE_ModuleInfo_43_275;
  MR_Box conv20_STATE_VARIABLE_ErrSpecs_35_276;
  MR_Box conv25_STATE_VARIABLE_ModuleInfo_44_278;
  MR_Box conv24_STATE_VARIABLE_ErrSpecs_36_279;
  MR_Box conv29_STATE_VARIABLE_ModuleInfo_45_281;
  MR_Box conv28_STATE_VARIABLE_ErrSpecs_37_282;
  MR_Box conv33_STATE_VARIABLE_ModuleInfo_122;
  MR_Box conv32_STATE_VARIABLE_ErrSpecs_38_285;
  MR_Box conv35_STATE_VARIABLE_QualInfo_121;

  hlds__make_hlds__make_hlds_passes__maybe_warn_include_and_non_include_3_p_0(Globals_18, ParseTreeModuleSrc_31, &STATE_VARIABLE_WarnSpecs_1_128);
  ...
  STATE_VARIABLE_ErrSpecs_1_134 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_err_spec_0), TypeErrSpecs_40, InstModeErrSpecs_42);
  Var_136 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_warn_spec_0), InstModeWarnSpecs_43, STATE_VARIABLE_WarnSpecs_1_128);
  STATE_VARIABLE_WarnSpecs_2_135 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_warn_spec_0), TypeWarnSpecs_41, Var_136);
  mercury__list__filter_3_p_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_err_spec_0), (MR_Word) (&hlds__make_hlds__make_hlds_passes_scalar_common_2[3]), TypeErrSpecs_40, &STATE_VARIABLE_InvalidTypeSpecs_1_141);
  mercury__list__filter_3_p_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_err_spec_0), (MR_Word) (&hlds__make_hlds__make_hlds_passes_scalar_common_2[4]), InstModeErrSpecs_42, &STATE_VARIABLE_InvalidInstModeSpecs_1_142);
  hlds__make_hlds__make_hlds_separate_items__separate_items_in_aug_comp_unit_38_p_0(AugCompUnit_17, &InclMap_48, &Avails_49, &FIMs_50, &TypeDefnsAbstract_51, &TypeDefnsMercury_52, &TypeDefnsForeign_53, &InstDefns_54, &ModeDefns_55, &PredDecls_56, &ModeDecls_57, &Promises_58, &Typeclasses_59, &IntInstances_60, &ImpInstances_61, &Initialises_62, &Finalises_63, &Mutables_64, &TypeRepnMap_65, &ForeignEnums_66, &ForeignExportEnums_67, &DeclPragmas_68, &DeclMarkers_69, &DeclTypeSpecConstr_70, &DeclTypeSpec_71, &DeclTermination_72, &DeclTermination2_73, &DeclSharing_74, &DeclReuse_75, &ImplPragmas_76, &ImplMarkers_77, &GenUnusedArgs_78, &GenExceptions_79, &GenTrailing_80, &GenMMTabling_81, &Clauses_82, &ForeignProcs_83, &IntBadClauses_84);
  mercury__map__init_1_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_type_ctor_0), (MR_Word) (&hlds__make_hlds__make_hlds_passes_scalar_common_1[0]), &DirectArgMap_85);
  {
    TypeRepnDec_86 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(0, TypeRepnDec_86, 0) = ((MR_Box) (TypeRepnMap_65));
    MR_hl_field(0, TypeRepnDec_86, 1) = ((MR_Box) (DirectArgMap_85));
    MR_hl_field(0, TypeRepnDec_86, 2) = ((MR_Box) (ForeignEnums_66));
    MR_hl_field(0, TypeRepnDec_86, 3) = ((MR_Box) (ForeignExportEnums_67));
  }
  hlds__hlds_module__module_info_init_12_p_0(Globals_18, ModuleName_32, ModuleNameContext_33, DumpBaseFileName_19, InclMap_48, UsedEqvModules_22, ImplicitlyUsedModules_34, UnusedInterfaceImports_23, PQInfo_35, (MR_Word) ((MR_Unsigned) 0U), TypeRepnDec_86, &STATE_VARIABLE_ModuleInfo_1_144);
  hlds__make_hlds__make_hlds_passes__add_item_avails_3_p_0(Avails_49, STATE_VARIABLE_ModuleInfo_1_144, &STATE_VARIABLE_ModuleInfo_2_145);
  STATE_VARIABLE_SolverPredDeclCord_1_146 = mercury__cord__init_0_f_0((MR_Word) (&hlds__make_hlds__make_hlds_passes_scalar_common_1[1]));
  STATE_VARIABLE_SolverForeignProcCord_1_147 = mercury__cord__init_0_f_0((MR_Word) (&hlds__make_hlds__make_hlds_passes_scalar_common_1[2]));
  STATE_VARIABLE_SolverMutableCord_1_148 = mercury__cord__init_0_f_0((MR_Word) (&hlds__make_hlds__make_hlds_passes_scalar_common_1[3]));
  hlds__make_hlds__make_hlds_passes__add_type_defns_15_p_0(TypeDefnsAbstract_51, STATE_VARIABLE_ModuleInfo_2_145, &STATE_VARIABLE_ModuleInfo_3_149, STATE_VARIABLE_SolverPredDeclCord_1_146, &STATE_VARIABLE_SolverPredDeclCord_2_150, STATE_VARIABLE_SolverForeignProcCord_1_147, &STATE_VARIABLE_SolverForeignProcCord_2_151, STATE_VARIABLE_SolverMutableCord_1_148, &STATE_VARIABLE_SolverMutableCord_2_152, STATE_VARIABLE_InvalidTypeSpecs_1_141, &STATE_VARIABLE_InvalidTypeSpecs_2_153, STATE_VARIABLE_ErrSpecs_1_134, &STATE_VARIABLE_ErrSpecs_2_154, STATE_VARIABLE_WarnSpecs_2_135, &STATE_VARIABLE_WarnSpecs_3_155);
  hlds__make_hlds__make_hlds_passes__add_type_defns_15_p_0(TypeDefnsMercury_52, STATE_VARIABLE_ModuleInfo_3_149, &STATE_VARIABLE_ModuleInfo_4_156, STATE_VARIABLE_SolverPredDeclCord_2_150, &STATE_VARIABLE_SolverPredDeclCord_3_157, STATE_VARIABLE_SolverForeignProcCord_2_151, &STATE_VARIABLE_SolverForeignProcCord_3_158, STATE_VARIABLE_SolverMutableCord_2_152, &STATE_VARIABLE_SolverMutableCord_3_159, STATE_VARIABLE_InvalidTypeSpecs_2_153, &STATE_VARIABLE_InvalidTypeSpecs_3_160, STATE_VARIABLE_ErrSpecs_2_154, &STATE_VARIABLE_ErrSpecs_3_161, STATE_VARIABLE_WarnSpecs_3_155, &STATE_VARIABLE_WarnSpecs_4_162);
  hlds__make_hlds__make_hlds_passes__add_type_defns_15_p_0(TypeDefnsForeign_53, STATE_VARIABLE_ModuleInfo_4_156, &STATE_VARIABLE_ModuleInfo_5_163, STATE_VARIABLE_SolverPredDeclCord_3_157, &STATE_VARIABLE_SolverPredDeclCord_4_164, STATE_VARIABLE_SolverForeignProcCord_3_158, &STATE_VARIABLE_SolverForeignProcCord_4_165, STATE_VARIABLE_SolverMutableCord_3_159, &STATE_VARIABLE_SolverMutableCord_4_166, STATE_VARIABLE_InvalidTypeSpecs_3_160, &STATE_VARIABLE_InvalidTypeSpecs_4_167, STATE_VARIABLE_ErrSpecs_3_161, &STATE_VARIABLE_ErrSpecs_4_168, STATE_VARIABLE_WarnSpecs_4_162, &STATE_VARIABLE_WarnSpecs_5_169);
  SolverPredDecls_90 = mercury__cord__list_1_f_0((MR_Word) (&hlds__make_hlds__make_hlds_passes_scalar_common_1[1]), STATE_VARIABLE_SolverPredDeclCord_4_164);
  SolverForeignProcs_91 = mercury__cord__list_1_f_0((MR_Word) (&hlds__make_hlds__make_hlds_passes_scalar_common_1[2]), STATE_VARIABLE_SolverForeignProcCord_4_165);
  SolverMutables_92 = mercury__cord__list_1_f_0((MR_Word) (&hlds__make_hlds__make_hlds_passes_scalar_common_1[3]), STATE_VARIABLE_SolverMutableCord_4_166);
  hlds__make_hlds__make_hlds_passes__add_inst_defns_7_p_0(InstDefns_54, STATE_VARIABLE_ModuleInfo_5_163, &STATE_VARIABLE_ModuleInfo_6_170, STATE_VARIABLE_ErrSpecs_4_168, &STATE_VARIABLE_ErrSpecs_5_171, STATE_VARIABLE_WarnSpecs_5_169, &STATE_VARIABLE_WarnSpecs_6_172);
  hlds__make_hlds__add_mode__check_inst_defns_4_p_0(STATE_VARIABLE_ModuleInfo_6_170, InstDefns_54, STATE_VARIABLE_InvalidInstModeSpecs_1_142, &STATE_VARIABLE_InvalidInstModeSpecs_2_173);
  hlds__make_hlds__make_hlds_passes__add_mode_defns_5_p_0(ModeDefns_55, STATE_VARIABLE_ModuleInfo_6_170, &STATE_VARIABLE_ModuleInfo_7_174, STATE_VARIABLE_ErrSpecs_5_171, &STATE_VARIABLE_ErrSpecs_6_175);
  hlds__make_hlds__add_mode__check_mode_defns_4_p_0(STATE_VARIABLE_ModuleInfo_7_174, ModeDefns_55, STATE_VARIABLE_InvalidInstModeSpecs_2_173, &STATE_VARIABLE_InvalidInstModeSpecs_3_176);
  if ((STATE_VARIABLE_InvalidTypeSpecs_4_167 == (MR_Word) ((MR_Unsigned) 0U)))
  {
    MR_Word TypeTable0_93;
    MR_Word Var_177;
    MR_Box conv5_STATE_VARIABLE_ModuleInfo_8_178;
    MR_Box conv4_STATE_VARIABLE_InvalidTypeSpecs_5_179;
    MR_Box conv3_STATE_VARIABLE_WarnSpecs_7_180;

    hlds__hlds_module__module_info_get_type_table_2_p_0(STATE_VARIABLE_ModuleInfo_7_174, &TypeTable0_93);
    {
      Var_177 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(0, Var_177, 0) = ((MR_Box) (&hlds__make_hlds__make_hlds_passes_scalar_common_9[3]));
      MR_hl_field(0, Var_177, 1) = ((MR_Box) (hlds__make_hlds__make_hlds_passes__parse_tree_to_hlds_15_p_0_3));
      MR_hl_field(0, Var_177, 2) = ((MR_Box) ((MR_Integer) 1));
      MR_hl_field(0, Var_177, 3) = ((MR_Box) (TypeTable0_93));
    }
    hlds__hlds_data__foldl3_over_type_ctor_defns_8_p_0((MR_Word) (&hlds__hlds_module__hlds__hlds_module__type_ctor_info_module_info_0), (MR_Word) (&hlds__make_hlds__make_hlds_passes_scalar_common_1[4]), (MR_Word) (&hlds__make_hlds__make_hlds_passes_scalar_common_1[5]), Var_177, TypeTable0_93, ((MR_Box) (STATE_VARIABLE_ModuleInfo_7_174)), &conv5_STATE_VARIABLE_ModuleInfo_8_178, ((MR_Box) (STATE_VARIABLE_InvalidTypeSpecs_4_167)), &conv4_STATE_VARIABLE_InvalidTypeSpecs_5_179, ((MR_Box) (STATE_VARIABLE_WarnSpecs_6_172)), &conv3_STATE_VARIABLE_WarnSpecs_7_180);
    STATE_VARIABLE_ModuleInfo_8_178 = ((MR_Word) (conv5_STATE_VARIABLE_ModuleInfo_8_178));
    STATE_VARIABLE_InvalidTypeSpecs_5_179 = ((MR_Word) (conv4_STATE_VARIABLE_InvalidTypeSpecs_5_179));
    STATE_VARIABLE_WarnSpecs_7_180 = ((MR_Word) (conv3_STATE_VARIABLE_WarnSpecs_7_180));
  }
  else
  {
    STATE_VARIABLE_ModuleInfo_8_178 = STATE_VARIABLE_ModuleInfo_7_174;
    STATE_VARIABLE_InvalidTypeSpecs_5_179 = STATE_VARIABLE_InvalidTypeSpecs_4_167;
    STATE_VARIABLE_WarnSpecs_7_180 = STATE_VARIABLE_WarnSpecs_6_172;
  }
  hlds__make_hlds__make_hlds_passes__add_pred_decls_5_p_0(PredDecls_56, STATE_VARIABLE_ModuleInfo_8_178, &STATE_VARIABLE_ModuleInfo_9_181, STATE_VARIABLE_ErrSpecs_6_175, &STATE_VARIABLE_ErrSpecs_7_182);
  hlds__make_hlds__make_hlds_passes__add_pred_decls_5_p_0(SolverPredDecls_90, STATE_VARIABLE_ModuleInfo_9_181, &STATE_VARIABLE_ModuleInfo_10_183, STATE_VARIABLE_ErrSpecs_7_182, &STATE_VARIABLE_ErrSpecs_8_184);
  hlds__make_hlds__make_hlds_passes__add_mode_decls_5_p_0(ModeDecls_57, STATE_VARIABLE_ModuleInfo_10_183, &STATE_VARIABLE_ModuleInfo_11_185, STATE_VARIABLE_ErrSpecs_8_184, &STATE_VARIABLE_ErrSpecs_9_186);
  AllMutables_96 = mercury__list__f_43_43_2_f_0((MR_Word) (&hlds__make_hlds__make_hlds_passes_scalar_common_1[3]), Mutables_64, SolverMutables_92);
  hlds__hlds_module__module_info_get_user_init_pred_target_names_2_p_0(STATE_VARIABLE_ModuleInfo_11_185, &InitPredTargetNames0_97);
  parse_tree__module_qual__mq_info__mq_info_get_undef_insts_2_p_0(MQInfo0_20, &MQUndefInstSpecs0_98);
  mercury__one_or_more_map__keys_as_set_2_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_inst_ctor_0), (MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_err_spec_0), MQUndefInstSpecs0_98, &MQUndefInstsSet0_99);
  MQUndefInsts0_100 = mercury__set_tree234__from_set_1_f_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_inst_ctor_0), MQUndefInstsSet0_99);
  hlds__make_hlds__add_mutable_aux_preds__implement_mutables_if_local_13_p_0(STATE_VARIABLE_ModuleInfo_11_185, MQUndefInsts0_100, AllMutables_96, &MutablePredDecls_101, &MutableClauses_102, &MutableForeignProcs_103, &MutableForeignDeclCodes_104, &MutableForeignBodyCodes_105, &FPEInfosCord1_106, InitPredTargetNames0_97, &InitPredTargetNames1_107, STATE_VARIABLE_ErrSpecs_9_186, &STATE_VARIABLE_ErrSpecs_10_187);
  hlds__make_hlds__make_hlds_passes__add_pred_decls_5_p_0(MutablePredDecls_101, STATE_VARIABLE_ModuleInfo_11_185, &STATE_VARIABLE_ModuleInfo_12_188, STATE_VARIABLE_ErrSpecs_10_187, &STATE_VARIABLE_ErrSpecs_11_189);
  hlds__make_hlds__add_class__add_typeclass_defns_5_p_0(Typeclasses_59, STATE_VARIABLE_ModuleInfo_12_188, &STATE_VARIABLE_ModuleInfo_13_190, STATE_VARIABLE_ErrSpecs_11_189, &STATE_VARIABLE_ErrSpecs_12_191);
  hlds__make_hlds__make_hlds_passes__maybe_add_default_modes_3_p_0(PredDecls_56, STATE_VARIABLE_ModuleInfo_13_190, &STATE_VARIABLE_ModuleInfo_14_192);
  hlds__make_hlds__add_class__add_abstract_instance_defns_5_p_0(IntInstances_60, STATE_VARIABLE_ModuleInfo_14_192, &STATE_VARIABLE_ModuleInfo_15_193, STATE_VARIABLE_ErrSpecs_12_191, &STATE_VARIABLE_ErrSpecs_13_194);
  hlds__make_hlds__add_class__add_full_instance_defns_5_p_0(ImpInstances_61, STATE_VARIABLE_ModuleInfo_15_193, &STATE_VARIABLE_ModuleInfo_16_195, STATE_VARIABLE_ErrSpecs_13_194, &STATE_VARIABLE_ErrSpecs_14_196);
  mercury__list__foldl_4_p_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_fim_0), (MR_Word) (&hlds__hlds_module__hlds__hlds_module__type_ctor_info_module_info_0), (MR_Word) (&hlds__make_hlds__make_hlds_passes_scalar_common_2[5]), FIMs_50, ((MR_Box) (STATE_VARIABLE_ModuleInfo_16_195)), &conv7_STATE_VARIABLE_ModuleInfo_17_198);
  STATE_VARIABLE_ModuleInfo_17_198 = ((MR_Word) (conv7_STATE_VARIABLE_ModuleInfo_17_198));
  Var_608 = mdbcomp__builtin_modules__mercury_public_builtin_module_0_f_0();
  succeeded = mdbcomp__sym_name____Unify____sym_name_0_0(ModuleName_32, Var_608);
  if (succeeded)
    succeeded = hlds__special_pred__compiler_generated_rtti_for_builtins_1_p_0(STATE_VARIABLE_ModuleInfo_17_198);
  if (succeeded)
  {
    MR_Word Var_200;
    MR_Box conv9_STATE_VARIABLE_ModuleInfo_18_201;

    Var_200 = parse_tree__prog_type__builtin_type_ctors_with_no_hlds_type_defn_0_f_0();
    mercury__list__foldl_4_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_type_ctor_0), (MR_Word) (&hlds__hlds_module__hlds__hlds_module__type_ctor_info_module_info_0), (MR_Word) (&hlds__make_hlds__make_hlds_passes_scalar_common_2[6]), Var_200, ((MR_Box) (STATE_VARIABLE_ModuleInfo_17_198)), &conv9_STATE_VARIABLE_ModuleInfo_18_201);
    STATE_VARIABLE_ModuleInfo_18_201 = ((MR_Word) (conv9_STATE_VARIABLE_ModuleInfo_18_201));
  }
  else
    STATE_VARIABLE_ModuleInfo_18_201 = STATE_VARIABLE_ModuleInfo_17_198;
  hlds__hlds_module__module_info_optimize_2_p_0(STATE_VARIABLE_ModuleInfo_18_201, &STATE_VARIABLE_ModuleInfo_19_202);
  hlds__make_hlds__qual_info__init_qual_info_3_p_0(MQInfo0_20, TypeEqvMap_21, &STATE_VARIABLE_QualInfo_1_203);
  hlds__make_hlds__make_hlds_passes__add_clauses_10_p_0(ProgressStream_16, Clauses_82, STATE_VARIABLE_ModuleInfo_19_202, &STATE_VARIABLE_ModuleInfo_20_204, STATE_VARIABLE_QualInfo_1_203, &STATE_VARIABLE_QualInfo_2_205, STATE_VARIABLE_ErrSpecs_14_196, &STATE_VARIABLE_ErrSpecs_15_206, STATE_VARIABLE_WarnSpecs_7_180, &STATE_VARIABLE_WarnSpecs_8_207);
  hlds__make_hlds__make_hlds_passes__add_clauses_10_p_0(ProgressStream_16, MutableClauses_102, STATE_VARIABLE_ModuleInfo_20_204, &STATE_VARIABLE_ModuleInfo_21_208, STATE_VARIABLE_QualInfo_2_205, &STATE_VARIABLE_QualInfo_3_209, STATE_VARIABLE_ErrSpecs_15_206, &STATE_VARIABLE_ErrSpecs_16_210, STATE_VARIABLE_WarnSpecs_8_207, &STATE_VARIABLE_WarnSpecs_9_211);
  hlds__make_hlds__make_hlds_passes__add_promises_10_p_0(ProgressStream_16, Promises_58, STATE_VARIABLE_ModuleInfo_21_208, &STATE_VARIABLE_ModuleInfo_22_212, STATE_VARIABLE_QualInfo_3_209, &STATE_VARIABLE_QualInfo_4_213, STATE_VARIABLE_ErrSpecs_16_210, &STATE_VARIABLE_ErrSpecs_17_214, STATE_VARIABLE_WarnSpecs_9_211, &STATE_VARIABLE_WarnSpecs_10_215);
  hlds__hlds_module__module_info_set_int_bad_clauses_3_p_0(IntBadClauses_84, STATE_VARIABLE_ModuleInfo_22_212, &STATE_VARIABLE_ModuleInfo_23_216);
  hlds__make_hlds__add_pragma_decl__add_decl_markers_7_p_0(DeclMarkers_69, STATE_VARIABLE_ModuleInfo_23_216, &STATE_VARIABLE_ModuleInfo_24_217, STATE_VARIABLE_ErrSpecs_17_214, &STATE_VARIABLE_ErrSpecs_18_218, STATE_VARIABLE_WarnSpecs_10_215, &STATE_VARIABLE_WarnSpecs_11_219);
  hlds__make_hlds__add_pragma_impl__add_impl_markers_7_p_0(ImplMarkers_77, STATE_VARIABLE_ModuleInfo_24_217, &STATE_VARIABLE_ModuleInfo_25_220, STATE_VARIABLE_ErrSpecs_18_218, &STATE_VARIABLE_ErrSpecs_19_221, STATE_VARIABLE_WarnSpecs_11_219, &STATE_VARIABLE_WarnSpecs_12_222);
  hlds__make_hlds__add_foreign_proc__add_foreign_procs_8_p_0(ProgressStream_16, ForeignProcs_83, STATE_VARIABLE_ModuleInfo_25_220, &STATE_VARIABLE_ModuleInfo_26_223, STATE_VARIABLE_ErrSpecs_19_221, &STATE_VARIABLE_ErrSpecs_20_224, STATE_VARIABLE_WarnSpecs_12_222, &STATE_VARIABLE_WarnSpecs_13_225);
  hlds__make_hlds__add_foreign_proc__add_foreign_procs_8_p_0(ProgressStream_16, SolverForeignProcs_91, STATE_VARIABLE_ModuleInfo_26_223, &STATE_VARIABLE_ModuleInfo_27_226, STATE_VARIABLE_ErrSpecs_20_224, &STATE_VARIABLE_ErrSpecs_21_227, STATE_VARIABLE_WarnSpecs_13_225, &STATE_VARIABLE_WarnSpecs_14_228);
  hlds__make_hlds__add_foreign_proc__add_foreign_procs_8_p_0(ProgressStream_16, MutableForeignProcs_103, STATE_VARIABLE_ModuleInfo_27_226, &STATE_VARIABLE_ModuleInfo_28_229, STATE_VARIABLE_ErrSpecs_21_227, &STATE_VARIABLE_ErrSpecs_22_230, STATE_VARIABLE_WarnSpecs_14_228, &STATE_VARIABLE_WarnSpecs_15_231);
  hlds__hlds_module__module_info_get_user_final_pred_target_names_2_p_0(STATE_VARIABLE_ModuleInfo_28_229, &FinalPredTargetNames1_108);
  hlds__make_hlds__make_hlds_passes__add_initialises_8_p_0(STATE_VARIABLE_ModuleInfo_28_229, Initialises_62, FPEInfosCord1_106, &FPEInfosCord2_109, InitPredTargetNames1_107, &InitPredTargetNames_110, STATE_VARIABLE_ErrSpecs_22_230, &STATE_VARIABLE_ErrSpecs_23_232);
  hlds__make_hlds__make_hlds_passes__add_finalises_8_p_0(STATE_VARIABLE_ModuleInfo_28_229, Finalises_63, FPEInfosCord2_109, &FPEInfosCord_111, FinalPredTargetNames1_108, &FinalPredTargetNames_112, STATE_VARIABLE_ErrSpecs_23_232, &STATE_VARIABLE_ErrSpecs_24_233);
  hlds__hlds_module__module_info_set_user_init_pred_target_names_3_p_0(InitPredTargetNames_110, STATE_VARIABLE_ModuleInfo_28_229, &STATE_VARIABLE_ModuleInfo_29_234);
  hlds__hlds_module__module_info_set_user_final_pred_target_names_3_p_0(FinalPredTargetNames_112, STATE_VARIABLE_ModuleInfo_29_234, &STATE_VARIABLE_ModuleInfo_30_235);
  hlds__make_hlds__add_pragma_decl__add_decl_pragmas_12_p_0(ProgressStream_16, DeclPragmas_68, STATE_VARIABLE_ModuleInfo_30_235, &STATE_VARIABLE_ModuleInfo_31_237, STATE_VARIABLE_QualInfo_4_213, &STATE_VARIABLE_QualInfo_5_238, STATE_VARIABLE_ErrSpecs_24_233, &STATE_VARIABLE_ErrSpecs_25_239, STATE_VARIABLE_WarnSpecs_15_231, &STATE_VARIABLE_WarnSpecs_16_240, (MR_Word) ((MR_Unsigned) 0U), &STATE_VARIABLE_InfoSpecs_2_241);
  hlds__make_hlds__add_pragma_decl__add_decl_pragmas_type_spec_constr_12_p_0(ProgressStream_16, DeclTypeSpecConstr_70, STATE_VARIABLE_ModuleInfo_31_237, &STATE_VARIABLE_ModuleInfo_32_242, STATE_VARIABLE_QualInfo_5_238, &STATE_VARIABLE_QualInfo_6_243, STATE_VARIABLE_ErrSpecs_25_239, &STATE_VARIABLE_ErrSpecs_26_244, STATE_VARIABLE_WarnSpecs_16_240, &STATE_VARIABLE_WarnSpecs_17_245, STATE_VARIABLE_InfoSpecs_2_241, STATE_VARIABLE_InfoSpecs_127);
  hlds__make_hlds__add_pragma_decl__add_decl_pragmas_type_spec_9_p_0(DeclTypeSpec_71, STATE_VARIABLE_ModuleInfo_32_242, &STATE_VARIABLE_ModuleInfo_33_247, STATE_VARIABLE_QualInfo_6_243, &STATE_VARIABLE_QualInfo_7_248, STATE_VARIABLE_ErrSpecs_26_244, &STATE_VARIABLE_ErrSpecs_27_249, STATE_VARIABLE_WarnSpecs_17_245, &STATE_VARIABLE_WarnSpecs_18_250);
  hlds__make_hlds__add_pragma_decl__add_decl_pragmas_termination_5_p_0(DeclTermination_72, STATE_VARIABLE_ModuleInfo_33_247, &STATE_VARIABLE_ModuleInfo_34_251, STATE_VARIABLE_ErrSpecs_27_249, &STATE_VARIABLE_ErrSpecs_28_252);
  hlds__make_hlds__add_pragma_decl__add_decl_pragmas_termination2_5_p_0(DeclTermination2_73, STATE_VARIABLE_ModuleInfo_34_251, &STATE_VARIABLE_ModuleInfo_35_253, STATE_VARIABLE_ErrSpecs_28_252, &STATE_VARIABLE_ErrSpecs_29_254);
  hlds__make_hlds__add_pragma_decl__add_decl_pragmas_sharing_5_p_0(DeclSharing_74, STATE_VARIABLE_ModuleInfo_35_253, &STATE_VARIABLE_ModuleInfo_36_255, STATE_VARIABLE_ErrSpecs_29_254, &STATE_VARIABLE_ErrSpecs_30_256);
  hlds__make_hlds__add_pragma_decl__add_decl_pragmas_reuse_5_p_0(DeclReuse_75, STATE_VARIABLE_ModuleInfo_36_255, &STATE_VARIABLE_ModuleInfo_37_257, STATE_VARIABLE_ErrSpecs_30_256, &STATE_VARIABLE_ErrSpecs_31_258);
  Var_259 = mercury__cord__init_0_f_0((MR_Word) (&hlds__make_hlds__make_hlds_passes_scalar_common_1[6]));
  hlds__make_hlds__add_pragma_impl__add_impl_pragmas_10_p_0(ProgressStream_16, ImplPragmas_76, Var_259, &PragmaTabledCord_113, STATE_VARIABLE_ModuleInfo_37_257, &STATE_VARIABLE_ModuleInfo_38_260, STATE_VARIABLE_ErrSpecs_31_258, &STATE_VARIABLE_ErrSpecs_32_261, STATE_VARIABLE_WarnSpecs_18_250, &STATE_VARIABLE_WarnSpecs_19_262);
  PragmasTabled_114 = mercury__cord__list_1_f_0((MR_Word) (&hlds__make_hlds__make_hlds_passes_scalar_common_1[6]), PragmaTabledCord_113);
  hlds__make_hlds__add_pragma_impl__add_impl_pragmas_tabled_10_p_0(ProgressStream_16, PragmasTabled_114, STATE_VARIABLE_ModuleInfo_38_260, &STATE_VARIABLE_ModuleInfo_39_263, STATE_VARIABLE_QualInfo_7_248, &STATE_VARIABLE_QualInfo_8_264, STATE_VARIABLE_ErrSpecs_32_261, &STATE_VARIABLE_ErrSpecs_33_265, STATE_VARIABLE_WarnSpecs_19_262, STATE_VARIABLE_WarnSpecs_126);
  FPEInfos_115 = mercury__cord__list_1_f_0((MR_Word) (&parse_tree__prog_item_pragma__parse_tree__prog_item_pragma__type_ctor_info_impl_pragma_fproc_export_info_0), FPEInfosCord_111);
  mercury__list__foldl2_6_p_0((MR_Word) (&parse_tree__prog_item_pragma__parse_tree__prog_item_pragma__type_ctor_info_impl_pragma_fproc_export_info_0), (MR_Word) (&hlds__hlds_module__hlds__hlds_module__type_ctor_info_module_info_0), (MR_Word) (&hlds__make_hlds__make_hlds_passes_scalar_common_1[4]), (MR_Word) (&hlds__make_hlds__make_hlds_passes_scalar_common_2[7]), FPEInfos_115, ((MR_Box) (STATE_VARIABLE_ModuleInfo_39_263)), &conv13_STATE_VARIABLE_ModuleInfo_40_268, ((MR_Box) (STATE_VARIABLE_ErrSpecs_33_265)), &conv12_STATE_VARIABLE_ErrSpecs_34_269);
  STATE_VARIABLE_ModuleInfo_40_268 = ((MR_Word) (conv13_STATE_VARIABLE_ModuleInfo_40_268));
  STATE_VARIABLE_ErrSpecs_34_269 = ((MR_Word) (conv12_STATE_VARIABLE_ErrSpecs_34_269));
  mercury__list__foldl_4_p_0((MR_Word) (&parse_tree__prog_foreign__parse_tree__prog_foreign__type_ctor_info_foreign_decl_code_0), (MR_Word) (&hlds__hlds_module__hlds__hlds_module__type_ctor_info_module_info_0), (MR_Word) (&hlds__make_hlds__make_hlds_passes_scalar_common_2[8]), MutableForeignDeclCodes_104, ((MR_Box) (STATE_VARIABLE_ModuleInfo_40_268)), &conv15_STATE_VARIABLE_ModuleInfo_41_271);
  STATE_VARIABLE_ModuleInfo_41_271 = ((MR_Word) (conv15_STATE_VARIABLE_ModuleInfo_41_271));
  mercury__list__foldl_4_p_0((MR_Word) (&parse_tree__prog_foreign__parse_tree__prog_foreign__type_ctor_info_foreign_body_code_0), (MR_Word) (&hlds__hlds_module__hlds__hlds_module__type_ctor_info_module_info_0), (MR_Word) (&hlds__make_hlds__make_hlds_passes_scalar_common_2[9]), MutableForeignBodyCodes_105, ((MR_Box) (STATE_VARIABLE_ModuleInfo_41_271)), &conv17_STATE_VARIABLE_ModuleInfo_42_273);
  STATE_VARIABLE_ModuleInfo_42_273 = ((MR_Word) (conv17_STATE_VARIABLE_ModuleInfo_42_273));
  mercury__list__foldl2_6_p_0((MR_Word) (&parse_tree__prog_item_pragma__parse_tree__prog_item_pragma__type_ctor_info_gen_pragma_unused_args_info_0), (MR_Word) (&hlds__hlds_module__hlds__hlds_module__type_ctor_info_module_info_0), (MR_Word) (&hlds__make_hlds__make_hlds_passes_scalar_common_1[4]), (MR_Word) (&hlds__make_hlds__make_hlds_passes_scalar_common_2[10]), GenUnusedArgs_78, ((MR_Box) (STATE_VARIABLE_ModuleInfo_42_273)), &conv21_STATE_VARIABLE_ModuleInfo_43_275, ((MR_Box) (STATE_VARIABLE_ErrSpecs_34_269)), &conv20_STATE_VARIABLE_ErrSpecs_35_276);
  STATE_VARIABLE_ModuleInfo_43_275 = ((MR_Word) (conv21_STATE_VARIABLE_ModuleInfo_43_275));
  STATE_VARIABLE_ErrSpecs_35_276 = ((MR_Word) (conv20_STATE_VARIABLE_ErrSpecs_35_276));
  mercury__list__foldl2_6_p_0((MR_Word) (&parse_tree__prog_item_pragma__parse_tree__prog_item_pragma__type_ctor_info_gen_pragma_exceptions_info_0), (MR_Word) (&hlds__hlds_module__hlds__hlds_module__type_ctor_info_module_info_0), (MR_Word) (&hlds__make_hlds__make_hlds_passes_scalar_common_1[4]), (MR_Word) (&hlds__make_hlds__make_hlds_passes_scalar_common_2[11]), GenExceptions_79, ((MR_Box) (STATE_VARIABLE_ModuleInfo_43_275)), &conv25_STATE_VARIABLE_ModuleInfo_44_278, ((MR_Box) (STATE_VARIABLE_ErrSpecs_35_276)), &conv24_STATE_VARIABLE_ErrSpecs_36_279);
  STATE_VARIABLE_ModuleInfo_44_278 = ((MR_Word) (conv25_STATE_VARIABLE_ModuleInfo_44_278));
  STATE_VARIABLE_ErrSpecs_36_279 = ((MR_Word) (conv24_STATE_VARIABLE_ErrSpecs_36_279));
  mercury__list__foldl2_6_p_0((MR_Word) (&parse_tree__prog_item_pragma__parse_tree__prog_item_pragma__type_ctor_info_gen_pragma_trailing_info_0), (MR_Word) (&hlds__hlds_module__hlds__hlds_module__type_ctor_info_module_info_0), (MR_Word) (&hlds__make_hlds__make_hlds_passes_scalar_common_1[4]), (MR_Word) (&hlds__make_hlds__make_hlds_passes_scalar_common_2[12]), GenTrailing_80, ((MR_Box) (STATE_VARIABLE_ModuleInfo_44_278)), &conv29_STATE_VARIABLE_ModuleInfo_45_281, ((MR_Box) (STATE_VARIABLE_ErrSpecs_36_279)), &conv28_STATE_VARIABLE_ErrSpecs_37_282);
  STATE_VARIABLE_ModuleInfo_45_281 = ((MR_Word) (conv29_STATE_VARIABLE_ModuleInfo_45_281));
  STATE_VARIABLE_ErrSpecs_37_282 = ((MR_Word) (conv28_STATE_VARIABLE_ErrSpecs_37_282));
  mercury__list__foldl2_6_p_0((MR_Word) (&parse_tree__prog_item_pragma__parse_tree__prog_item_pragma__type_ctor_info_gen_pragma_mm_tabling_info_0), (MR_Word) (&hlds__hlds_module__hlds__hlds_module__type_ctor_info_module_info_0), (MR_Word) (&hlds__make_hlds__make_hlds_passes_scalar_common_1[4]), (MR_Word) (&hlds__make_hlds__make_hlds_passes_scalar_common_2[13]), GenMMTabling_81, ((MR_Box) (STATE_VARIABLE_ModuleInfo_45_281)), &conv33_STATE_VARIABLE_ModuleInfo_122, ((MR_Box) (STATE_VARIABLE_ErrSpecs_37_282)), &conv32_STATE_VARIABLE_ErrSpecs_38_285);
  *STATE_VARIABLE_ModuleInfo_122 = ((MR_Word) (conv33_STATE_VARIABLE_ModuleInfo_122));
  STATE_VARIABLE_ErrSpecs_38_285 = ((MR_Word) (conv32_STATE_VARIABLE_ErrSpecs_38_285));
  hlds__make_hlds__check_field_access_functions__check_preds_if_field_access_function_4_p_0(*STATE_VARIABLE_ModuleInfo_122, PredDecls_56, STATE_VARIABLE_ErrSpecs_38_285, &STATE_VARIABLE_ErrSpecs_39_286);
  ModuleItemVersionNumbers_116 = ((MR_Word) ((MR_hl_field(0, AugCompUnit_17, 8))));
  mercury__map__foldl_4_p_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), (MR_Word) (&recompilation__item_types__recompilation__item_types__type_ctor_info_module_item_version_numbers_0), (MR_Word) (&hlds__make_hlds__qual_info__hlds__make_hlds__qual_info__type_ctor_info_qual_info_0), (MR_Word) (&hlds__make_hlds__make_hlds_passes_scalar_common_2[14]), ModuleItemVersionNumbers_116, ((MR_Box) (STATE_VARIABLE_QualInfo_8_264)), &conv35_STATE_VARIABLE_QualInfo_121);
  *STATE_VARIABLE_QualInfo_121 = ((MR_Word) (conv35_STATE_VARIABLE_QualInfo_121));
  hlds__make_hlds__qual_info__qual_info_get_mq_info_2_p_0(*STATE_VARIABLE_QualInfo_121, &MQInfo_117);
  parse_tree__module_qual__mq_info__get_err_specs_in_mq_info_4_p_0(MQInfo_117, &MQInvalidTypeSpecs_118, &MQInvalidInstModeSpecs_119, &MQNonBlockingUndefSpecs_120);
  *STATE_VARIABLE_InvalidTypeSpecs_123 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_err_spec_0), MQInvalidTypeSpecs_118, STATE_VARIABLE_InvalidTypeSpecs_5_179);
  *STATE_VARIABLE_InvalidInstModeSpecs_124 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_err_spec_0), MQInvalidInstModeSpecs_119, STATE_VARIABLE_InvalidInstModeSpecs_3_176);
  *STATE_VARIABLE_ErrSpecs_125 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_err_spec_0), MQNonBlockingUndefSpecs_120, STATE_VARIABLE_ErrSpecs_39_286);
}
