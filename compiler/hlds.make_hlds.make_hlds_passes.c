...
hlds__make_hlds__make_hlds_passes__IntroducedFrom__pred__parse_tree_to_hlds__154__1_1_p_0(
  MR_Word LambdaHeadVar__1_128);

static MR_bool MR_CALL 
hlds__make_hlds__make_hlds_passes__IntroducedFrom__pred__parse_tree_to_hlds__149__1_1_p_0(
  ...
  MR_Word * STATE_VARIABLE_Specs_48)
{
  ...
  else
  {
    ...
    else
    {
      ...
      Var_221 = parse_tree__error_spec__piece_list_to_color_line_pieces_3_f_0((MR_Integer) 4, (MR_Word) (MR_mkword(1, &hlds__make_hlds__make_hlds_passes_scalar_common_1[71])), PredDescPieces_42);
  ...
  MR_Box wrapper_arg_1)
{
  ...
  succeeded = hlds__make_hlds__make_hlds_passes__IntroducedFrom__pred__parse_tree_to_hlds__154__1_1_p_0(((MR_Word) (wrapper_arg_1)));
  return succeeded;
}
  ...
  MR_Box wrapper_arg_1)
{
  ...
  succeeded = hlds__make_hlds__make_hlds_passes__IntroducedFrom__pred__parse_tree_to_hlds__149__1_1_p_0(((MR_Word) (wrapper_arg_1)));
  return succeeded;
}
