...
{
  {
    ...
    if ((PredIds_14 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(1), Var_96, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &hlds__make_hlds__make_hlds_passes_scalar_common_1[50])));
      }
      {
    ...
    else
    {
      ...
      if ((Var_140 == (MR_Word) ((MR_Unsigned) 0U)))
      {
        ...
        else
        {
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(1), Var_71, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &hlds__make_hlds__make_hlds_passes_scalar_common_1[54])));
          }
          {
            Pieces_128 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), Pieces_128, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__make_hlds_passes_scalar_common_1[69])));
      ...
      else
      {
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(1), Pieces_137, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__make_hlds_passes_scalar_common_1[69])));
...
{
  {
    ...
    if ((PredIds_14 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(1), Var_81, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &hlds__make_hlds__make_hlds_passes_scalar_common_1[41])));
      }
      {
        Pieces_15 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), Pieces_15, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__make_hlds_passes_scalar_common_1[69])));
    ...
    else
    {
      ...
      if ((Var_125 == (MR_Word) ((MR_Unsigned) 0U)))
      {
        ...
        else
        {
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(1), Var_59, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &hlds__make_hlds__make_hlds_passes_scalar_common_1[45])));
          }
          {
            Pieces_113 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), Pieces_113, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__make_hlds_passes_scalar_common_1[69])));
      ...
      else
      {
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(1), Pieces_122, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__make_hlds_passes_scalar_common_1[69])));
...
{
  {
    ...
    hlds__make_hlds__add_foreign_proc__add_pragma_foreign_proc_export_7_p_0((MR_Word) (MR_mkword(MR_mktag(1), ((MR_Box) (&hlds__make_hlds__make_hlds_passes_scalar_common_1[68])))), FPEInfo_19, Context_12, STATE_VARIABLE_ModuleInfo_0_22, STATE_VARIABLE_ModuleInfo_23, STATE_VARIABLE_Specs_0_24, STATE_VARIABLE_Specs_25);
  }
}
...
{
  {
    ...
    if (succeeded)
    {
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(1), Var_42, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &hlds__make_hlds__make_hlds_passes_scalar_common_1[21])));
      }
      {
...
{
  {
    ...
    if (succeeded)
    {
      ...
      Var_39 = parse_tree__prog_out__pred_or_func_to_full_str_1_f_0(PredOrFunc_12);
      {
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(1), Var_37, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &hlds__make_hlds__make_hlds_passes_scalar_common_1[21])));
      }
      {
        ...
        MR_hl_field(MR_mktag(1), Pieces_26, 1) = ((MR_Box) (Var_37));
      }
      {
        Var_47 = (MR_Word) MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), Var_47, 0) = ((MR_Box) (Pieces_26));
      }
      {
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(0), Msg_27, 1) = ((MR_Box) (Var_46));
      }
      {
        Var_51 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
    ...
    else
    {
      ...
      hlds__add_pred__module_add_pred_decl_7_p_0(ItemMercuryStatus_29, NeedQual_30, ItemPredDecl_10, STATE_VARIABLE_ModuleInfo_0_31, STATE_VARIABLE_ModuleInfo_32, STATE_VARIABLE_Specs_0_33, STATE_VARIABLE_Specs_34);
    }
  }
}
  ...
  MR_Box * wrapper_arg_5)
{
  {
    MR_Box closure = closure_arg;
    MR_Word conv45_STATE_VARIABLE_ModuleInfo_32;
    MR_Word conv44_STATE_VARIABLE_Specs_34;

    hlds__make_hlds__make_hlds_passes__add_pred_decl_5_p_0(((MR_Word) (wrapper_arg_1)), ((MR_Word) (wrapper_arg_2)), &conv45_STATE_VARIABLE_ModuleInfo_32, ((MR_Word) (wrapper_arg_4)), &conv44_STATE_VARIABLE_Specs_34);
    *wrapper_arg_3 = ((MR_Box) (conv45_STATE_VARIABLE_ModuleInfo_32));
    *wrapper_arg_5 = ((MR_Box) (conv44_STATE_VARIABLE_Specs_34));
  }
}
