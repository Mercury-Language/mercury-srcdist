...
hlds__make_hlds__make_hlds_passes__IntroducedFrom__pred__add_type_defn__539__1_3_p_0(
  ...
  MR_Word hlds__make_hlds__make_hlds_passes__HeadVar__2_65,
  MR_Word * hlds__make_hlds__make_hlds_passes__HeadVar__3_66);
...
{
  {
    ...
    {
      hlds__make_hlds__wrap_with_section_info_3_p_0((MR_Word) &parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_mutable_info_0, hlds__make_hlds__make_hlds_passes__SectionInfo_18, ((MR_Box) (hlds__make_hlds__make_hlds_passes__HeadVar__2_65)), hlds__make_hlds__make_hlds_passes__HeadVar__3_66);
    }
  }
}
        ...
        else
          {
            ...
            switch (hlds__make_hlds__make_hlds_passes__IsMutable_34) {
              ...
              case (MR_Integer) 1:
                {
                  {
                    hlds__hlds_pred__add_marker_3_p_0((MR_Integer) 23, hlds__make_hlds__make_hlds_passes__Markers0_31, &hlds__make_hlds__make_hlds_passes__Markers_35);
                  }
                }
                break;
              case (MR_Integer) 0:
  ...
  MR_Box * hlds__make_hlds__make_hlds_passes__wrapper_arg_2)
{
  {
    MR_Box hlds__make_hlds__make_hlds_passes__closure = hlds__make_hlds__make_hlds_passes__closure_arg;
    MR_Word hlds__make_hlds__make_hlds_passes__conv0_HeadVar__3_66;

    {
      hlds__make_hlds__make_hlds_passes__IntroducedFrom__pred__add_type_defn__539__1_3_p_0(((MR_Word) (MR_hl_field(MR_mktag(0), hlds__make_hlds__make_hlds_passes__closure, (MR_Integer) 3))), ((MR_Word) hlds__make_hlds__make_hlds_passes__wrapper_arg_1), &hlds__make_hlds__make_hlds_passes__conv0_HeadVar__3_66);
    }
    *hlds__make_hlds__make_hlds_passes__wrapper_arg_2 = ((MR_Box) (hlds__make_hlds__make_hlds_passes__conv0_HeadVar__3_66));
  }
}
    ...
    switch (MR_tag((MR_Word) hlds__make_hlds__make_hlds_passes__TypeDefn_24)) {
      ...
      case (MR_Integer) 3:
        switch (((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), hlds__make_hlds__make_hlds_passes__TypeDefn_24, (MR_Integer) 0)))) {
          ...
          case (MR_Integer) 0:
            {
              MR_Word hlds__make_hlds__make_hlds_passes__TypeInfo_69_69;
              ...
              hlds__make_hlds__make_hlds_passes__Var_62 = ((MR_Word) (MR_hl_field(MR_mktag(0), hlds__make_hlds__make_hlds_passes__SolverTypeDetails_28, (MR_Integer) 0)));
              hlds__make_hlds__make_hlds_passes__Var_63 = ((MR_Word) (MR_hl_field(MR_mktag(0), hlds__make_hlds__make_hlds_passes__SolverTypeDetails_28, (MR_Integer) 1)));
              hlds__make_hlds__make_hlds_passes__Var_64 = ((MR_Word) (MR_hl_field(MR_mktag(0), hlds__make_hlds__make_hlds_passes__SolverTypeDetails_28, (MR_Integer) 2)));
              hlds__make_hlds__make_hlds_passes__MutableItems_31 = ((MR_Word) (MR_hl_field(MR_mktag(0), hlds__make_hlds__make_hlds_passes__SolverTypeDetails_28, (MR_Integer) 3)));
              {
                hlds__make_hlds__make_hlds_passes__Var_56 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL);
                MR_hl_field(MR_mktag(0), hlds__make_hlds__make_hlds_passes__Var_56, 0) = ((MR_Box) (&hlds__make_hlds__make_hlds_passes_scalar_common_3[3]));
                MR_hl_field(MR_mktag(0), hlds__make_hlds__make_hlds_passes__Var_56, 1) = ((MR_Box) (hlds__make_hlds__make_hlds_passes__add_type_defn_11_p_0_1));
                MR_hl_field(MR_mktag(0), hlds__make_hlds__make_hlds_passes__Var_56, 2) = ((MR_Box) (MR_Word) ((MR_Integer) 1));
                MR_hl_field(MR_mktag(0), hlds__make_hlds__make_hlds_passes__Var_56, 3) = ((MR_Box) (hlds__make_hlds__make_hlds_passes__SectionInfo_18));
              }
              hlds__make_hlds__make_hlds_passes__TypeInfo_69_69 = (MR_Word) &hlds__make_hlds__make_hlds_passes_scalar_common_1[5];
              {
                mercury__list__map_3_p_0((MR_Word) &parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_mutable_info_0, hlds__make_hlds__make_hlds_passes__TypeInfo_69_69, hlds__make_hlds__make_hlds_passes__Var_56, hlds__make_hlds__make_hlds_passes__MutableItems_31, &hlds__make_hlds__make_hlds_passes__TypeSectionMutableItems_32);
              }
              {
                *hlds__make_hlds__make_hlds_passes__STATE_VARIABLE_SectionMutableItems_54 = mercury__list__f_43_43_2_f_0(hlds__make_hlds__make_hlds_passes__TypeInfo_69_69, hlds__make_hlds__make_hlds_passes__TypeSectionMutableItems_32, hlds__make_hlds__make_hlds_passes__STATE_VARIABLE_SectionMutableItems_0_53);
              }
            }
            break;
          case (MR_Integer) 1:
...
{
  {
    ...
    MR_Word hlds__make_hlds__make_hlds_passes__Var_175;
    ...
    MR_Word hlds__make_hlds__make_hlds_passes__Var_363;
      ...
      case (MR_Integer) 0:
        {
          ...
          {
            hlds__make_hlds__make_hlds_passes__Var_133 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL);
            MR_hl_field(MR_mktag(0), hlds__make_hlds__make_hlds_passes__Var_133, 0) = ((MR_Box) (&hlds__make_hlds__make_hlds_passes_scalar_common_6[6]));
            MR_hl_field(MR_mktag(0), hlds__make_hlds__make_hlds_passes__Var_133, 1) = ((MR_Box) (hlds__make_hlds__make_hlds_passes__do_parse_tree_to_hlds_11_p_0_15));
            MR_hl_field(MR_mktag(0), hlds__make_hlds__make_hlds_passes__Var_133, 2) = ((MR_Box) (MR_Word) ((MR_Integer) 1));
            MR_hl_field(MR_mktag(0), hlds__make_hlds__make_hlds_passes__Var_133, 3) = ((MR_Box) (hlds__make_hlds__make_hlds_passes__STATE_VARIABLE_ModuleInfo_130_130));
          }
          {
            hlds__hlds_data__foldl_over_type_ctor_defns_4_p_0((MR_Word) &hlds__make_hlds__make_hlds_passes_scalar_common_2[1], hlds__make_hlds__make_hlds_passes__Var_133, hlds__make_hlds__make_hlds_passes__STATE_VARIABLE_TypeTable_132_132, ((MR_Box) (hlds__make_hlds__make_hlds_passes__STATE_VARIABLE_TypeTable_132_132)), &hlds__make_hlds__make_hlds_passes__conv75_STATE_VARIABLE_TypeTable_135_135);
          }
    ...
    {
      hlds__make_hlds__make_hlds_passes__Var_363 = mdbcomp__builtin_modules__mercury_public_builtin_module_0_f_0();
    }
    {
      hlds__make_hlds__make_hlds_passes__succeeded = mdbcomp__sym_name____Unify____sym_name_0_0(hlds__make_hlds__make_hlds_passes__ModuleName_28, hlds__make_hlds__make_hlds_passes__Var_363);
    }
    if (hlds__make_hlds__make_hlds_passes__succeeded)
      {
    ...
    {
      hlds__make_hlds__make_hlds_passes__Var_175 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), hlds__make_hlds__make_hlds_passes__Var_175, 0) = ((MR_Box) (&hlds__make_hlds__make_hlds_passes_scalar_common_8[0]));
      MR_hl_field(MR_mktag(0), hlds__make_hlds__make_hlds_passes__Var_175, 1) = ((MR_Box) (hlds__make_hlds__make_hlds_passes__do_parse_tree_to_hlds_11_p_0_25));
      MR_hl_field(MR_mktag(0), hlds__make_hlds__make_hlds_passes__Var_175, 2) = ((MR_Box) (MR_Word) ((MR_Integer) 1));
      MR_hl_field(MR_mktag(0), hlds__make_hlds__make_hlds_passes__Var_175, 3) = ((MR_Box) (*hlds__make_hlds__make_hlds_passes__STATE_VARIABLE_ModuleInfo_64));
    }
    {
      mercury__list__foldl_4_p_0(hlds__make_hlds__make_hlds_passes__TypeInfo_247_247, hlds__make_hlds__make_hlds_passes__TypeInfo_233_233, hlds__make_hlds__make_hlds_passes__Var_175, hlds__make_hlds__make_hlds_passes__ItemPredDecls_42, ((MR_Box) (hlds__make_hlds__make_hlds_passes__STATE_VARIABLE_Specs_174_174)), &hlds__make_hlds__make_hlds_passes__conv123_STATE_VARIABLE_Specs_65);
    }
