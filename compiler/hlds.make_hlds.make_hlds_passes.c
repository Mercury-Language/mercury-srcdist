...
static MR_bool MR_CALL 
hlds__make_hlds__make_hlds_passes__IntroducedFrom__pred__parse_tree_to_hlds__143__1_1_p_0(
    ...
    if ((Var_183 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      ...
      else
      {
        ...
        }
        {
          ...
          MR_hl_field(3, Var_88, 0) = ((MR_Box) ((MR_Unsigned) 28U));
  ...
  MR_Box wrapper_arg_1)
{
  ...
  succeeded = hlds__make_hlds__make_hlds_passes__IntroducedFrom__pred__parse_tree_to_hlds__143__1_1_p_0(((MR_Word) (wrapper_arg_1)));
  return succeeded;
}
