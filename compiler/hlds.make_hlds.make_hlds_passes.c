  ...
  MR_Word * STATE_VARIABLE_Specs_114)
{
  ...
  TypeSpecs_32 = ((MR_Word) ((MR_hl_field(0, ParseTreeModuleSrc_23, (MR_Integer) 17))));
  InstModeSpecs_33 = ((MR_Word) ((MR_hl_field(0, ParseTreeModuleSrc_23, (MR_Integer) 18))));
  ...
  Var_491 = mdbcomp__builtin_modules__mercury_public_builtin_module_0_f_0();
  succeeded = mdbcomp__sym_name____Unify____sym_name_0_0(ModuleName_24, Var_491);
  if (succeeded)
