...
{
  {
    ...
    mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&hlds__make_hlds__make_hlds_passes_scalar_common_10[0]), Line_22, &Var_51);
...
{
  {
    ...
    mercury__map__init_1_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_type_ctor_0), (MR_Word) (&hlds__make_hlds__make_hlds_passes_scalar_common_1[0]), &DirectArgMap_61);
    {
      ...
      MR_hl_field(MR_mktag(0), TypeRepnDec_62, 0) = ((MR_Box) (ItemTypeRepns_53));
