      ...
      else
      {
        ...
        if ((TailPredIds_19 == (MR_Word) ((MR_Unsigned) 0U)))
        {
          ...
          if ((env).hlds__make_hlds__make_hlds_passes__implement_finalise_7_p_0_env_0__succeeded)
          {
            ...
            hlds__make_hlds__add_foreign_proc__add_pragma_foreign_proc_export_7_p_0(((MR_Box) (&hlds__make_hlds__make_hlds_passes_scalar_common_1[70])), FPEInfo_38, Context_10, STATE_VARIABLE_ModuleInfo_88_88, STATE_VARIABLE_ModuleInfo_44, STATE_VARIABLE_Specs_0_45, STATE_VARIABLE_Specs_46);
          }
          else
          {
            ...
            if ((env).hlds__make_hlds__make_hlds_passes__implement_finalise_7_p_0_env_0__succeeded)
            {
              ...
              hlds__make_hlds__add_foreign_proc__add_pragma_foreign_proc_export_7_p_0(((MR_Box) (&hlds__make_hlds__make_hlds_passes_scalar_common_1[70])), FPEInfo_173, Context_10, STATE_VARIABLE_ModuleInfo_99_99, STATE_VARIABLE_ModuleInfo_44, STATE_VARIABLE_Specs_0_45, STATE_VARIABLE_Specs_46);
            }
            else
            {
              MR_Word Var_108;
      ...
      else
      {
        ...
        if ((TailPredIds_19 == (MR_Word) ((MR_Unsigned) 0U)))
        {
          ...
          if ((env).hlds__make_hlds__make_hlds_passes__implement_initialise_7_p_0_env_0__succeeded)
          {
            ...
            hlds__make_hlds__add_foreign_proc__add_pragma_foreign_proc_export_7_p_0(((MR_Box) (&hlds__make_hlds__make_hlds_passes_scalar_common_1[70])), FPEInfo_38, Context_10, STATE_VARIABLE_ModuleInfo_76_76, STATE_VARIABLE_ModuleInfo_44, STATE_VARIABLE_Specs_0_45, STATE_VARIABLE_Specs_46);
          }
          else
          {
            ...
            if ((env).hlds__make_hlds__make_hlds_passes__implement_initialise_7_p_0_env_0__succeeded)
            {
              ...
              hlds__make_hlds__add_foreign_proc__add_pragma_foreign_proc_export_7_p_0(((MR_Box) (&hlds__make_hlds__make_hlds_passes_scalar_common_1[70])), FPEInfo_158, Context_10, STATE_VARIABLE_ModuleInfo_87_87, STATE_VARIABLE_ModuleInfo_44, STATE_VARIABLE_Specs_0_45, STATE_VARIABLE_Specs_46);
            }
            else
            {
              MR_Word Var_96;
...
{
  {
    ...
    hlds__add_special_pred__add_special_pred_decl_defns_for_type_eagerly_8_p_0(TVarSet_6, Type_9, TypeCtor_4, (MR_Word) (MR_mkword(MR_mktag(3), &hlds__make_hlds__make_hlds_passes_scalar_common_1[65])), ((MR_Box) ((MR_Unsigned) 32U)), Context_7, STATE_VARIABLE_ModuleInfo_0_11, STATE_VARIABLE_ModuleInfo_12);
  }
}
