...
MR_def_label(hlds__make_hlds__make_hlds_passes__add_pass_1_mutable_6_0,7)
	...
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tempr1 = (MR_Word) &MR_tfield(0, (MR_Word *) &mercury_vector_common_5_0, ((MR_Integer) MR_r1 * (MR_Integer) 3));
	MR_r2 = MR_sv(2);
	MR_r3 = MR_sv(6);
	MR_tempr2 = MR_r1;
	MR_r1 = MR_sv(7);
...
MR_def_static(hlds__make_hlds__make_hlds_passes__add_pass_3_module_defn_9_0)
	...
	MR_tfield(0, MR_r1, 1) = (MR_Word) MR_ENTRY_AP(hlds__make_hlds__make_hlds_passes__IntroducedFrom__pred__add_pass_3_module_defn__1174__1_4_0);
...
MR_def_label(hlds__make_hlds__make_hlds_passes__add_pass_3_pragma_9_0,96)
	...
	MR_tempr1 = MR_r1;
	MR_tempr5 = MR_r6;
	MR_r1 = MR_tfield(2, MR_tempr5, 0);
	MR_r2 = MR_tfield(2, MR_tempr5, 1);
	MR_tempr2 = MR_r3;
	MR_r3 = MR_tfield(2, MR_tempr5, 2);
	MR_tempr3 = MR_r4;
	MR_r4 = MR_tfield(2, MR_tempr5, 3);
	MR_tempr4 = MR_r5;
	MR_r5 = MR_tfield(2, MR_tempr5, 4);
	MR_sv(1) = MR_tempr5;
...
MR_def_label(hlds__make_hlds__make_hlds_passes__add_c_mutable_defn_and_decl_11_0,12)
	...
	MR_tfield(1, MR_r2, 1) = (MR_Word) MR_TAG_COMMON(1,9,2);
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 2);
	MR_tfield(1, MR_tempr1, 0) = (MR_Word) MR_string_const(" ", 1);
...
MR_def_static(fn__hlds__make_hlds__make_hlds_passes__erlang_mutable_get_code_1_0)
	...
	MR_tag_alloc_heap(MR_r2, 1, (MR_Integer) 2);
	MR_tfield(1, MR_r2, 0) = MR_r1;
	MR_tfield(1, MR_r2, 1) = (MR_Word) MR_TAG_COMMON(1,9,7);
	MR_tag_alloc_heap(MR_r1, 1, (MR_Integer) 2);
...
MR_def_label(hlds__make_hlds__make_hlds_passes__add_pass_3_initialise_8_0,60)
	...
	MR_tfield(1, MR_r1, 1) = (MR_Word) MR_TAG_COMMON(1,1,19);
	MR_tag_alloc_heap(MR_r2, 1, (MR_Integer) 2);
...
MR_def_label(hlds__make_hlds__make_hlds_passes__add_pass_3_initialise_8_0,8)
	...
	MR_tag_alloc_heap(MR_r1, 1, (MR_Integer) 2);
	MR_tfield(1, MR_r1, 0) = MR_r2;
	MR_tfield(1, MR_r1, 1) = (MR_Word) MR_TAG_COMMON(1,1,21);
	MR_tag_alloc_heap(MR_r2, 1, (MR_Integer) 2);
	MR_tfield(1, MR_r2, 0) = (MR_Word) MR_TAG_COMMON(3,2,14);
	MR_tfield(1, MR_r2, 1) = MR_r1;
	MR_tag_alloc_heap(MR_r1, 0, (MR_Integer) 1);
...
MR_def_label(hlds__make_hlds__make_hlds_passes__add_pass_3_initialise_8_0,5)
	...
	MR_tag_alloc_heap(MR_r1, 1, (MR_Integer) 2);
	MR_tfield(1, MR_r1, 0) = MR_r2;
	MR_tfield(1, MR_r1, 1) = (MR_Word) MR_TAG_COMMON(1,1,23);
	MR_tag_alloc_heap(MR_r2, 1, (MR_Integer) 2);
	MR_tfield(1, MR_r2, 0) = (MR_Word) MR_TAG_COMMON(3,2,14);
	MR_tfield(1, MR_r2, 1) = MR_r1;
	MR_tag_alloc_heap(MR_r1, 0, (MR_Integer) 1);
...
MR_def_label(hlds__make_hlds__make_hlds_passes__add_c_java_constant_mutable_access_preds_15_0,12)
	...
	MR_tfield(0, MR_tempr4, 2) = MR_tempr7;
...
MR_def_label(hlds__make_hlds__make_hlds_passes__add_c_mutable_initialisation_18_0,11)
	...
	MR_tag_alloc_heap(MR_r2, 1, (MR_Integer) 2);
	MR_tfield(1, MR_r2, 0) = MR_r1;
	MR_tfield(1, MR_r2, 1) = (MR_Word) MR_TAG_COMMON(1,9,8);
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 2);
...
MR_def_label(hlds__make_hlds__make_hlds_passes__add_stratified_pred_8_0,3)
	...
	MR_tag_alloc_heap(MR_r2, 1, (MR_Integer) 2);
	MR_tfield(1, MR_r2, 0) = MR_sv(1);
	MR_tfield(1, MR_r2, 1) = (MR_Word) MR_TAG_COMMON(1,9,10);
	MR_tag_alloc_heap(MR_r1, 1, (MR_Integer) 2);
...
MR_def_label(f_104_108_100_115_95_95_109_97_107_101_95_104_108_100_115_95_95_109_97_107_101_95_104_108_100_115_95_112_97_115_115_101_115_95_95_85_110_117_115_101_100_65_114_103_115_95_95_112_114_101_100_95_95_97_100_100_95_106_97_118_97_95_109_117_116_97_98_108_101_95_100_101_102_110_95_95_91_50_93_95_48_11_0,2)
	...
	MR_tag_alloc_heap(MR_r2, 1, (MR_Integer) 2);
	MR_tfield(1, MR_r2, 0) = MR_r1;
	MR_tfield(1, MR_r2, 1) = (MR_Word) MR_TAG_COMMON(1,9,11);
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 2);
	MR_tfield(1, MR_tempr1, 0) = (MR_Word) MR_string_const("static final java.lang.Object ", 30);
	MR_tfield(1, MR_tempr1, 1) = MR_r2;
	MR_tag_alloc_heap(MR_r2, 1, (MR_Integer) 2);
	MR_tfield(1, MR_r2, 0) = (MR_Word) MR_string_const(";\n", 2);
	MR_tfield(1, MR_r2, 1) = MR_tempr1;
	...
	MR_tfield(1, MR_tempr1, 1) = MR_r2;
	MR_tag_alloc_heap(MR_r1, 1, (MR_Integer) 2);
	MR_tfield(1, MR_r1, 0) = (MR_Word) MR_string_const("static java.lang.Object ", 24);
	MR_tfield(1, MR_r1, 1) = MR_tempr1;
	}
	MR_np_call_localret_ent(fn__string__append_list_1_0,
...
MR_def_label(f_104_108_100_115_95_95_109_97_107_101_95_104_108_100_115_95_95_109_97_107_101_95_104_108_100_115_95_112_97_115_115_101_115_95_95_85_110_117_115_101_100_65_114_103_115_95_95_112_114_101_100_95_95_97_100_100_95_106_97_118_97_95_109_117_116_97_98_108_101_95_100_101_102_110_95_95_91_50_93_95_48_11_0,4)
	...
	MR_tag_alloc_heap(MR_r2, 1, (MR_Integer) 2);
	MR_tfield(1, MR_r2, 0) = MR_sv(1);
	MR_tfield(1, MR_r2, 1) = (MR_Word) MR_TAG_COMMON(1,9,12);
	MR_tag_alloc_heap(MR_r1, 1, (MR_Integer) 2);
	MR_tfield(1, MR_r1, 0) = (MR_Word) MR_string_const("static java.lang.ThreadLocal<java.lang.Object> ", 47);
	MR_tfield(1, MR_r1, 1) = MR_r2;
	MR_np_call_localret_ent(fn__string__append_list_1_0,
