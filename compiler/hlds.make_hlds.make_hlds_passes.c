  ...
  MR_Word LambdaHeadVar__1_126)
{
  ...
  parse_tree__error_spec__extract_spec_phase_2_p_0(LambdaHeadVar__1_126, &Phase_39);
...
hlds__make_hlds__make_hlds_passes__parse_tree_to_hlds_12_p_0(
  ...
  MR_Word * STATE_VARIABLE_FoundInvalidType_115,
  MR_Word * STATE_VARIABLE_FoundInvalidInstOrMode_116,
  MR_Word * STATE_VARIABLE_ModuleInfo_117,
  MR_Word * STATE_VARIABLE_Specs_118)
{
  ...
  MR_Word SolverPredDecls_86;
  MR_Word SolverForeignProcs_87;
  MR_Word SolverMutables_88;
  ...
  MR_Word FinalPredTargetNames1_100;
  MR_Word FPEInfosCord2_101;
  MR_Word InitPredTargetNames_102;
  MR_Word FPEInfosCord_103;
  MR_Word FinalPredTargetNames_104;
  MR_Word PragmaTabledCord_105;
  MR_Word PragmasTabled_106;
  MR_Word FPEInfos_107;
  MR_Word ModuleItemVersionNumbers_108;
  MR_Word MQInfo_109;
  MR_Word MQUndefTypes_110;
  MR_Word MQUndefInsts_111;
  MR_Word MQUndefModes_112;
  MR_Word MQUndefTypeClasses_113;
  MR_Word STATE_VARIABLE_Specs_1_124;
  MR_Word Var_125;
  MR_Word STATE_VARIABLE_FoundInvalidType_1_128;
  MR_Word STATE_VARIABLE_FoundInvalidInstOrMode_1_130;
  MR_Word STATE_VARIABLE_ModuleInfo_1_133;
  MR_Word STATE_VARIABLE_ModuleInfo_2_134;
  MR_Word STATE_VARIABLE_SolverPredDeclCord_1_135;
  MR_Word STATE_VARIABLE_SolverForeignProcCord_1_136;
  MR_Word STATE_VARIABLE_SolverMutableCord_1_137;
  MR_Word STATE_VARIABLE_ModuleInfo_3_138;
  MR_Word STATE_VARIABLE_FoundInvalidType_3_139;
  MR_Word STATE_VARIABLE_Specs_2_140;
  MR_Word STATE_VARIABLE_SolverPredDeclCord_2_141;
  MR_Word STATE_VARIABLE_SolverForeignProcCord_2_142;
  MR_Word STATE_VARIABLE_SolverMutableCord_2_143;
  MR_Word STATE_VARIABLE_ModuleInfo_4_144;
  MR_Word STATE_VARIABLE_FoundInvalidType_4_145;
  MR_Word STATE_VARIABLE_Specs_3_146;
  MR_Word STATE_VARIABLE_SolverPredDeclCord_3_147;
  MR_Word STATE_VARIABLE_SolverForeignProcCord_3_148;
  MR_Word STATE_VARIABLE_SolverMutableCord_3_149;
  MR_Word STATE_VARIABLE_ModuleInfo_5_150;
  MR_Word STATE_VARIABLE_FoundInvalidType_5_151;
  MR_Word STATE_VARIABLE_Specs_4_152;
  MR_Word STATE_VARIABLE_SolverPredDeclCord_4_153;
  MR_Word STATE_VARIABLE_SolverForeignProcCord_4_154;
  MR_Word STATE_VARIABLE_SolverMutableCord_4_155;
  MR_Word STATE_VARIABLE_ModuleInfo_6_156;
  MR_Word STATE_VARIABLE_Specs_5_157;
  MR_Word STATE_VARIABLE_FoundInvalidInstOrMode_3_158;
  MR_Word STATE_VARIABLE_Specs_6_159;
  MR_Word STATE_VARIABLE_ModuleInfo_7_160;
  MR_Word STATE_VARIABLE_Specs_7_161;
  MR_Word STATE_VARIABLE_FoundInvalidInstOrMode_4_162;
  MR_Word STATE_VARIABLE_Specs_8_163;
  MR_Word STATE_VARIABLE_FoundInvalidType_6_165;
  MR_Word STATE_VARIABLE_ModuleInfo_8_166;
  MR_Word STATE_VARIABLE_Specs_9_167;
  MR_Word STATE_VARIABLE_ModuleInfo_9_168;
  MR_Word STATE_VARIABLE_Specs_10_169;
  MR_Word STATE_VARIABLE_ModuleInfo_10_170;
  MR_Word STATE_VARIABLE_Specs_11_171;
  MR_Word STATE_VARIABLE_ModuleInfo_11_172;
  MR_Word STATE_VARIABLE_Specs_12_173;
  MR_Word STATE_VARIABLE_Specs_13_174;
  MR_Word STATE_VARIABLE_ModuleInfo_12_175;
  MR_Word STATE_VARIABLE_Specs_14_176;
  MR_Word STATE_VARIABLE_ModuleInfo_13_177;
  MR_Word STATE_VARIABLE_Specs_15_178;
  MR_Word STATE_VARIABLE_ModuleInfo_14_179;
  MR_Word STATE_VARIABLE_ModuleInfo_15_180;
  MR_Word STATE_VARIABLE_Specs_16_181;
  MR_Word STATE_VARIABLE_ModuleInfo_16_183;
  MR_Word STATE_VARIABLE_ModuleInfo_17_186;
  MR_Word STATE_VARIABLE_ModuleInfo_18_187;
  MR_Word STATE_VARIABLE_QualInfo_1_188;
  MR_Word STATE_VARIABLE_ModuleInfo_19_189;
  MR_Word STATE_VARIABLE_QualInfo_2_190;
  MR_Word STATE_VARIABLE_Specs_17_191;
  MR_Word STATE_VARIABLE_ModuleInfo_20_192;
  MR_Word STATE_VARIABLE_QualInfo_3_193;
  MR_Word STATE_VARIABLE_Specs_18_194;
  MR_Word STATE_VARIABLE_ModuleInfo_21_195;
  MR_Word STATE_VARIABLE_QualInfo_4_196;
  MR_Word STATE_VARIABLE_Specs_19_197;
  MR_Word STATE_VARIABLE_ModuleInfo_22_198;
  MR_Word STATE_VARIABLE_ModuleInfo_23_199;
  MR_Word STATE_VARIABLE_Specs_20_200;
  MR_Word STATE_VARIABLE_ModuleInfo_24_201;
  MR_Word STATE_VARIABLE_Specs_21_202;
  MR_Word STATE_VARIABLE_ModuleInfo_25_203;
  MR_Word STATE_VARIABLE_Specs_22_204;
  MR_Word STATE_VARIABLE_ModuleInfo_26_205;
  MR_Word STATE_VARIABLE_Specs_23_206;
  MR_Word STATE_VARIABLE_ModuleInfo_27_207;
  MR_Word STATE_VARIABLE_Specs_24_208;
  MR_Word STATE_VARIABLE_Specs_25_209;
  MR_Word STATE_VARIABLE_Specs_26_210;
  MR_Word STATE_VARIABLE_ModuleInfo_28_211;
  MR_Word STATE_VARIABLE_ModuleInfo_29_212;
  MR_Word STATE_VARIABLE_ModuleInfo_30_213;
  MR_Word STATE_VARIABLE_QualInfo_5_214;
  MR_Word STATE_VARIABLE_Specs_27_215;
  MR_Word STATE_VARIABLE_ModuleInfo_31_216;
  MR_Word STATE_VARIABLE_QualInfo_6_217;
  MR_Word STATE_VARIABLE_Specs_28_218;
  MR_Word STATE_VARIABLE_ModuleInfo_32_219;
  MR_Word STATE_VARIABLE_QualInfo_7_220;
  MR_Word STATE_VARIABLE_Specs_29_221;
  MR_Word STATE_VARIABLE_ModuleInfo_33_222;
  MR_Word STATE_VARIABLE_Specs_30_223;
  MR_Word STATE_VARIABLE_ModuleInfo_34_224;
  MR_Word STATE_VARIABLE_Specs_31_225;
  MR_Word STATE_VARIABLE_ModuleInfo_35_226;
  MR_Word STATE_VARIABLE_Specs_32_227;
  MR_Word STATE_VARIABLE_ModuleInfo_36_228;
  MR_Word STATE_VARIABLE_Specs_33_229;
  MR_Word Var_230;
  MR_Word STATE_VARIABLE_ModuleInfo_37_231;
  MR_Word STATE_VARIABLE_Specs_34_232;
  MR_Word STATE_VARIABLE_ModuleInfo_38_233;
  MR_Word STATE_VARIABLE_QualInfo_8_234;
  MR_Word STATE_VARIABLE_Specs_35_235;
  MR_Word STATE_VARIABLE_ModuleInfo_39_237;
  MR_Word STATE_VARIABLE_Specs_36_238;
  MR_Word STATE_VARIABLE_ModuleInfo_40_240;
  MR_Word STATE_VARIABLE_ModuleInfo_41_242;
  MR_Word STATE_VARIABLE_ModuleInfo_42_244;
  MR_Word STATE_VARIABLE_Specs_37_245;
  MR_Word STATE_VARIABLE_ModuleInfo_43_247;
  MR_Word STATE_VARIABLE_Specs_38_248;
  MR_Word STATE_VARIABLE_ModuleInfo_44_250;
  MR_Word STATE_VARIABLE_Specs_39_251;
  MR_Word STATE_VARIABLE_Specs_40_254;
  MR_Box conv7_STATE_VARIABLE_ModuleInfo_16_183;
  MR_Word Var_495;
  MR_Box conv13_STATE_VARIABLE_ModuleInfo_39_237;
  MR_Box conv12_STATE_VARIABLE_Specs_36_238;
  MR_Box conv15_STATE_VARIABLE_ModuleInfo_40_240;
  MR_Box conv17_STATE_VARIABLE_ModuleInfo_41_242;
  MR_Box conv21_STATE_VARIABLE_ModuleInfo_42_244;
  MR_Box conv20_STATE_VARIABLE_Specs_37_245;
  MR_Box conv25_STATE_VARIABLE_ModuleInfo_43_247;
  MR_Box conv24_STATE_VARIABLE_Specs_38_248;
  MR_Box conv29_STATE_VARIABLE_ModuleInfo_44_250;
  MR_Box conv28_STATE_VARIABLE_Specs_39_251;
  MR_Box conv33_STATE_VARIABLE_ModuleInfo_117;
  MR_Box conv32_STATE_VARIABLE_Specs_40_254;
  MR_Box conv35_STATE_VARIABLE_QualInfo_114;
  ...
  Var_125 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_error_spec_0), TypeSpecs_35, InstModeSpecs_36);
  STATE_VARIABLE_Specs_1_124 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_error_spec_0), InclSpecs_26, Var_125);
  ...
  switch (TypeErrors_43) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 0:
      STATE_VARIABLE_FoundInvalidType_1_128 = (MR_Integer) 0;
      break;
    case (MR_Integer) 1:
      STATE_VARIABLE_FoundInvalidType_1_128 = (MR_Integer) 1;
      break;
  }
  switch (InstModeErrors_44) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 0:
      STATE_VARIABLE_FoundInvalidInstOrMode_1_130 = (MR_Integer) 0;
      break;
    case (MR_Integer) 1:
      STATE_VARIABLE_FoundInvalidInstOrMode_1_130 = (MR_Integer) 1;
      break;
  }
  ...
  hlds__hlds_module__module_info_init_11_p_0(Globals_15, ModuleName_27, ModuleNameContext_28, DumpBaseFileName_16, InclMap_45, UsedModules_19, ImplicitlyUsedModules_29, PQInfo_30, (MR_Word) ((MR_Unsigned) 0U), TypeRepnDec_82, &STATE_VARIABLE_ModuleInfo_1_133);
  hlds__make_hlds__make_hlds_passes__add_item_avails_3_p_0(Avails_46, STATE_VARIABLE_ModuleInfo_1_133, &STATE_VARIABLE_ModuleInfo_2_134);
  STATE_VARIABLE_SolverPredDeclCord_1_135 = mercury__cord__init_0_f_0((MR_Word) (&hlds__make_hlds__make_hlds_passes_scalar_common_1[1]));
  STATE_VARIABLE_SolverForeignProcCord_1_136 = mercury__cord__init_0_f_0((MR_Word) (&hlds__make_hlds__make_hlds_passes_scalar_common_1[2]));
  STATE_VARIABLE_SolverMutableCord_1_137 = mercury__cord__init_0_f_0((MR_Word) (&hlds__make_hlds__make_hlds_passes_scalar_common_1[3]));
  hlds__make_hlds__make_hlds_passes__add_type_defns_13_p_0(TypeDefnsAbstract_48, STATE_VARIABLE_ModuleInfo_2_134, &STATE_VARIABLE_ModuleInfo_3_138, STATE_VARIABLE_FoundInvalidType_1_128, &STATE_VARIABLE_FoundInvalidType_3_139, STATE_VARIABLE_Specs_1_124, &STATE_VARIABLE_Specs_2_140, STATE_VARIABLE_SolverPredDeclCord_1_135, &STATE_VARIABLE_SolverPredDeclCord_2_141, STATE_VARIABLE_SolverForeignProcCord_1_136, &STATE_VARIABLE_SolverForeignProcCord_2_142, STATE_VARIABLE_SolverMutableCord_1_137, &STATE_VARIABLE_SolverMutableCord_2_143);
  hlds__make_hlds__make_hlds_passes__add_type_defns_13_p_0(TypeDefnsMercury_49, STATE_VARIABLE_ModuleInfo_3_138, &STATE_VARIABLE_ModuleInfo_4_144, STATE_VARIABLE_FoundInvalidType_3_139, &STATE_VARIABLE_FoundInvalidType_4_145, STATE_VARIABLE_Specs_2_140, &STATE_VARIABLE_Specs_3_146, STATE_VARIABLE_SolverPredDeclCord_2_141, &STATE_VARIABLE_SolverPredDeclCord_3_147, STATE_VARIABLE_SolverForeignProcCord_2_142, &STATE_VARIABLE_SolverForeignProcCord_3_148, STATE_VARIABLE_SolverMutableCord_2_143, &STATE_VARIABLE_SolverMutableCord_3_149);
  hlds__make_hlds__make_hlds_passes__add_type_defns_13_p_0(TypeDefnsForeign_50, STATE_VARIABLE_ModuleInfo_4_144, &STATE_VARIABLE_ModuleInfo_5_150, STATE_VARIABLE_FoundInvalidType_4_145, &STATE_VARIABLE_FoundInvalidType_5_151, STATE_VARIABLE_Specs_3_146, &STATE_VARIABLE_Specs_4_152, STATE_VARIABLE_SolverPredDeclCord_3_147, &STATE_VARIABLE_SolverPredDeclCord_4_153, STATE_VARIABLE_SolverForeignProcCord_3_148, &STATE_VARIABLE_SolverForeignProcCord_4_154, STATE_VARIABLE_SolverMutableCord_3_149, &STATE_VARIABLE_SolverMutableCord_4_155);
  SolverPredDecls_86 = mercury__cord__list_1_f_0((MR_Word) (&hlds__make_hlds__make_hlds_passes_scalar_common_1[1]), STATE_VARIABLE_SolverPredDeclCord_4_153);
  SolverForeignProcs_87 = mercury__cord__list_1_f_0((MR_Word) (&hlds__make_hlds__make_hlds_passes_scalar_common_1[2]), STATE_VARIABLE_SolverForeignProcCord_4_154);
  SolverMutables_88 = mercury__cord__list_1_f_0((MR_Word) (&hlds__make_hlds__make_hlds_passes_scalar_common_1[3]), STATE_VARIABLE_SolverMutableCord_4_155);
  hlds__make_hlds__make_hlds_passes__add_inst_defns_5_p_0(InstDefns_51, STATE_VARIABLE_ModuleInfo_5_150, &STATE_VARIABLE_ModuleInfo_6_156, STATE_VARIABLE_Specs_4_152, &STATE_VARIABLE_Specs_5_157);
  hlds__make_hlds__add_mode__check_inst_defns_6_p_0(STATE_VARIABLE_ModuleInfo_6_156, InstDefns_51, STATE_VARIABLE_FoundInvalidInstOrMode_1_130, &STATE_VARIABLE_FoundInvalidInstOrMode_3_158, STATE_VARIABLE_Specs_5_157, &STATE_VARIABLE_Specs_6_159);
  hlds__make_hlds__make_hlds_passes__add_mode_defns_5_p_0(ModeDefns_52, STATE_VARIABLE_ModuleInfo_6_156, &STATE_VARIABLE_ModuleInfo_7_160, STATE_VARIABLE_Specs_6_159, &STATE_VARIABLE_Specs_7_161);
  hlds__make_hlds__add_mode__check_mode_defns_6_p_0(STATE_VARIABLE_ModuleInfo_7_160, ModeDefns_52, STATE_VARIABLE_FoundInvalidInstOrMode_3_158, &STATE_VARIABLE_FoundInvalidInstOrMode_4_162, STATE_VARIABLE_Specs_7_161, &STATE_VARIABLE_Specs_8_163);
  switch (STATE_VARIABLE_FoundInvalidType_5_151) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 0:
      {
        MR_Word TypeTable0_89;
        MR_Word Var_164;
        MR_Box conv5_STATE_VARIABLE_FoundInvalidType_6_165;
        MR_Box conv4_STATE_VARIABLE_ModuleInfo_8_166;
        MR_Box conv3_STATE_VARIABLE_Specs_9_167;

        hlds__hlds_module__module_info_get_type_table_2_p_0(STATE_VARIABLE_ModuleInfo_7_160, &TypeTable0_89);
        {
          Var_164 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(0, Var_164, 0) = ((MR_Box) (&hlds__make_hlds__make_hlds_passes_scalar_common_7[4]));
          MR_hl_field(0, Var_164, 1) = ((MR_Box) (hlds__make_hlds__make_hlds_passes__parse_tree_to_hlds_12_p_0_3));
          MR_hl_field(0, Var_164, 2) = ((MR_Box) ((MR_Integer) 1));
          MR_hl_field(0, Var_164, 3) = ((MR_Box) (TypeTable0_89));
        }
        hlds__hlds_data__foldl3_over_type_ctor_defns_8_p_0((MR_Word) (&hlds__make_hlds__make_hlds_types__hlds__make_hlds__make_hlds_types__type_ctor_info_found_invalid_type_0), (MR_Word) (&hlds__hlds_module__hlds__hlds_module__type_ctor_info_module_info_0), (MR_Word) (&hlds__make_hlds__make_hlds_passes_scalar_common_1[4]), Var_164, TypeTable0_89, ((MR_Box) (STATE_VARIABLE_FoundInvalidType_5_151)), &conv5_STATE_VARIABLE_FoundInvalidType_6_165, ((MR_Box) (STATE_VARIABLE_ModuleInfo_7_160)), &conv4_STATE_VARIABLE_ModuleInfo_8_166, ((MR_Box) (STATE_VARIABLE_Specs_8_163)), &conv3_STATE_VARIABLE_Specs_9_167);
        STATE_VARIABLE_FoundInvalidType_6_165 = ((MR_Word) (conv5_STATE_VARIABLE_FoundInvalidType_6_165));
        STATE_VARIABLE_ModuleInfo_8_166 = ((MR_Word) (conv4_STATE_VARIABLE_ModuleInfo_8_166));
        STATE_VARIABLE_Specs_9_167 = ((MR_Word) (conv3_STATE_VARIABLE_Specs_9_167));
      }
      break;
    case (MR_Integer) 1:
      {
        STATE_VARIABLE_FoundInvalidType_6_165 = STATE_VARIABLE_FoundInvalidType_5_151;
        STATE_VARIABLE_ModuleInfo_8_166 = STATE_VARIABLE_ModuleInfo_7_160;
        STATE_VARIABLE_Specs_9_167 = STATE_VARIABLE_Specs_8_163;
      }
      break;
  }
  hlds__make_hlds__make_hlds_passes__add_pred_decls_5_p_0(PredDecls_53, STATE_VARIABLE_ModuleInfo_8_166, &STATE_VARIABLE_ModuleInfo_9_168, STATE_VARIABLE_Specs_9_167, &STATE_VARIABLE_Specs_10_169);
  hlds__make_hlds__make_hlds_passes__add_pred_decls_5_p_0(SolverPredDecls_86, STATE_VARIABLE_ModuleInfo_9_168, &STATE_VARIABLE_ModuleInfo_10_170, STATE_VARIABLE_Specs_10_169, &STATE_VARIABLE_Specs_11_171);
  hlds__make_hlds__make_hlds_passes__add_mode_decls_5_p_0(ModeDecls_54, STATE_VARIABLE_ModuleInfo_10_170, &STATE_VARIABLE_ModuleInfo_11_172, STATE_VARIABLE_Specs_11_171, &STATE_VARIABLE_Specs_12_173);
  AllMutables_90 = mercury__list__f_43_43_2_f_0((MR_Word) (&hlds__make_hlds__make_hlds_passes_scalar_common_1[3]), Mutables_60, SolverMutables_88);
  hlds__hlds_module__module_info_get_user_init_pred_target_names_2_p_0(STATE_VARIABLE_ModuleInfo_11_172, &InitPredTargetNames0_91);
  parse_tree__module_qual__mq_info__mq_info_get_undef_insts_2_p_0(MQInfo0_17, &MQUndefInsts0_92);
  hlds__make_hlds__add_mutable_aux_preds__implement_mutables_if_local_13_p_0(STATE_VARIABLE_ModuleInfo_11_172, MQUndefInsts0_92, AllMutables_90, &MutablePredDecls_93, &MutableClauses_94, &MutableForeignProcs_95, &MutableForeignDeclCodes_96, &MutableForeignBodyCodes_97, &FPEInfosCord1_98, InitPredTargetNames0_91, &InitPredTargetNames1_99, STATE_VARIABLE_Specs_12_173, &STATE_VARIABLE_Specs_13_174);
  hlds__make_hlds__make_hlds_passes__add_pred_decls_5_p_0(MutablePredDecls_93, STATE_VARIABLE_ModuleInfo_11_172, &STATE_VARIABLE_ModuleInfo_12_175, STATE_VARIABLE_Specs_13_174, &STATE_VARIABLE_Specs_14_176);
  hlds__make_hlds__add_class__add_typeclass_defns_5_p_0(Typeclasses_56, STATE_VARIABLE_ModuleInfo_12_175, &STATE_VARIABLE_ModuleInfo_13_177, STATE_VARIABLE_Specs_14_176, &STATE_VARIABLE_Specs_15_178);
  hlds__make_hlds__make_hlds_passes__maybe_add_default_modes_3_p_0(PredDecls_53, STATE_VARIABLE_ModuleInfo_13_177, &STATE_VARIABLE_ModuleInfo_14_179);
  hlds__make_hlds__add_class__add_instance_defns_5_p_0(Instances_57, STATE_VARIABLE_ModuleInfo_14_179, &STATE_VARIABLE_ModuleInfo_15_180, STATE_VARIABLE_Specs_15_178, &STATE_VARIABLE_Specs_16_181);
  mercury__list__foldl_4_p_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_fim_0), (MR_Word) (&hlds__hlds_module__hlds__hlds_module__type_ctor_info_module_info_0), (MR_Word) (&hlds__make_hlds__make_hlds_passes_scalar_common_2[5]), FIMs_47, ((MR_Box) (STATE_VARIABLE_ModuleInfo_15_180)), &conv7_STATE_VARIABLE_ModuleInfo_16_183);
  STATE_VARIABLE_ModuleInfo_16_183 = ((MR_Word) (conv7_STATE_VARIABLE_ModuleInfo_16_183));
  Var_495 = mdbcomp__builtin_modules__mercury_public_builtin_module_0_f_0();
  succeeded = mdbcomp__sym_name____Unify____sym_name_0_0(ModuleName_27, Var_495);
  if (succeeded)
    succeeded = hlds__special_pred__compiler_generated_rtti_for_builtins_1_p_0(STATE_VARIABLE_ModuleInfo_16_183);
  if (succeeded)
  {
    MR_Word Var_185;
    MR_Box conv9_STATE_VARIABLE_ModuleInfo_17_186;

    Var_185 = parse_tree__prog_type__builtin_type_ctors_with_no_hlds_type_defn_0_f_0();
    mercury__list__foldl_4_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_type_ctor_0), (MR_Word) (&hlds__hlds_module__hlds__hlds_module__type_ctor_info_module_info_0), (MR_Word) (&hlds__make_hlds__make_hlds_passes_scalar_common_2[6]), Var_185, ((MR_Box) (STATE_VARIABLE_ModuleInfo_16_183)), &conv9_STATE_VARIABLE_ModuleInfo_17_186);
    STATE_VARIABLE_ModuleInfo_17_186 = ((MR_Word) (conv9_STATE_VARIABLE_ModuleInfo_17_186));
  }
  else
    STATE_VARIABLE_ModuleInfo_17_186 = STATE_VARIABLE_ModuleInfo_16_183;
  hlds__hlds_module__module_info_optimize_2_p_0(STATE_VARIABLE_ModuleInfo_17_186, &STATE_VARIABLE_ModuleInfo_18_187);
  hlds__make_hlds__qual_info__init_qual_info_3_p_0(MQInfo0_17, TypeEqvMap_18, &STATE_VARIABLE_QualInfo_1_188);
  hlds__make_hlds__make_hlds_passes__add_clauses_8_p_0(ProgressStream_13, Clauses_78, STATE_VARIABLE_ModuleInfo_18_187, &STATE_VARIABLE_ModuleInfo_19_189, STATE_VARIABLE_QualInfo_1_188, &STATE_VARIABLE_QualInfo_2_190, STATE_VARIABLE_Specs_16_181, &STATE_VARIABLE_Specs_17_191);
  hlds__make_hlds__make_hlds_passes__add_clauses_8_p_0(ProgressStream_13, MutableClauses_94, STATE_VARIABLE_ModuleInfo_19_189, &STATE_VARIABLE_ModuleInfo_20_192, STATE_VARIABLE_QualInfo_2_190, &STATE_VARIABLE_QualInfo_3_193, STATE_VARIABLE_Specs_17_191, &STATE_VARIABLE_Specs_18_194);
  hlds__make_hlds__make_hlds_passes__add_promises_8_p_0(ProgressStream_13, Promises_55, STATE_VARIABLE_ModuleInfo_20_192, &STATE_VARIABLE_ModuleInfo_21_195, STATE_VARIABLE_QualInfo_3_193, &STATE_VARIABLE_QualInfo_4_196, STATE_VARIABLE_Specs_18_194, &STATE_VARIABLE_Specs_19_197);
  hlds__hlds_module__module_info_set_int_bad_clauses_3_p_0(IntBadClauses_80, STATE_VARIABLE_ModuleInfo_21_195, &STATE_VARIABLE_ModuleInfo_22_198);
  hlds__make_hlds__add_pragma__add_decl_markers_5_p_0(DeclMarkers_65, STATE_VARIABLE_ModuleInfo_22_198, &STATE_VARIABLE_ModuleInfo_23_199, STATE_VARIABLE_Specs_19_197, &STATE_VARIABLE_Specs_20_200);
  hlds__make_hlds__add_pragma__add_impl_markers_5_p_0(ImplMarkers_73, STATE_VARIABLE_ModuleInfo_23_199, &STATE_VARIABLE_ModuleInfo_24_201, STATE_VARIABLE_Specs_20_200, &STATE_VARIABLE_Specs_21_202);
  hlds__make_hlds__add_foreign_proc__add_foreign_procs_6_p_0(ProgressStream_13, ForeignProcs_79, STATE_VARIABLE_ModuleInfo_24_201, &STATE_VARIABLE_ModuleInfo_25_203, STATE_VARIABLE_Specs_21_202, &STATE_VARIABLE_Specs_22_204);
  hlds__make_hlds__add_foreign_proc__add_foreign_procs_6_p_0(ProgressStream_13, SolverForeignProcs_87, STATE_VARIABLE_ModuleInfo_25_203, &STATE_VARIABLE_ModuleInfo_26_205, STATE_VARIABLE_Specs_22_204, &STATE_VARIABLE_Specs_23_206);
  hlds__make_hlds__add_foreign_proc__add_foreign_procs_6_p_0(ProgressStream_13, MutableForeignProcs_95, STATE_VARIABLE_ModuleInfo_26_205, &STATE_VARIABLE_ModuleInfo_27_207, STATE_VARIABLE_Specs_23_206, &STATE_VARIABLE_Specs_24_208);
  hlds__hlds_module__module_info_get_user_final_pred_target_names_2_p_0(STATE_VARIABLE_ModuleInfo_27_207, &FinalPredTargetNames1_100);
  hlds__make_hlds__make_hlds_passes__add_initialises_8_p_0(STATE_VARIABLE_ModuleInfo_27_207, Initialises_58, FPEInfosCord1_98, &FPEInfosCord2_101, InitPredTargetNames1_99, &InitPredTargetNames_102, STATE_VARIABLE_Specs_24_208, &STATE_VARIABLE_Specs_25_209);
  hlds__make_hlds__make_hlds_passes__add_finalises_8_p_0(STATE_VARIABLE_ModuleInfo_27_207, Finalises_59, FPEInfosCord2_101, &FPEInfosCord_103, FinalPredTargetNames1_100, &FinalPredTargetNames_104, STATE_VARIABLE_Specs_25_209, &STATE_VARIABLE_Specs_26_210);
  hlds__hlds_module__module_info_set_user_init_pred_target_names_3_p_0(InitPredTargetNames_102, STATE_VARIABLE_ModuleInfo_27_207, &STATE_VARIABLE_ModuleInfo_28_211);
  hlds__hlds_module__module_info_set_user_final_pred_target_names_3_p_0(FinalPredTargetNames_104, STATE_VARIABLE_ModuleInfo_28_211, &STATE_VARIABLE_ModuleInfo_29_212);
  hlds__make_hlds__add_pragma__add_decl_pragmas_8_p_0(ProgressStream_13, DeclPragmas_64, STATE_VARIABLE_ModuleInfo_29_212, &STATE_VARIABLE_ModuleInfo_30_213, STATE_VARIABLE_QualInfo_4_196, &STATE_VARIABLE_QualInfo_5_214, STATE_VARIABLE_Specs_26_210, &STATE_VARIABLE_Specs_27_215);
  hlds__make_hlds__add_pragma__add_decl_pragmas_type_spec_constr_8_p_0(ProgressStream_13, DeclTypeSpecConstr_66, STATE_VARIABLE_ModuleInfo_30_213, &STATE_VARIABLE_ModuleInfo_31_216, STATE_VARIABLE_QualInfo_5_214, &STATE_VARIABLE_QualInfo_6_217, STATE_VARIABLE_Specs_27_215, &STATE_VARIABLE_Specs_28_218);
  hlds__make_hlds__add_pragma__add_decl_pragmas_type_spec_7_p_0(DeclTypeSpec_67, STATE_VARIABLE_ModuleInfo_31_216, &STATE_VARIABLE_ModuleInfo_32_219, STATE_VARIABLE_QualInfo_6_217, &STATE_VARIABLE_QualInfo_7_220, STATE_VARIABLE_Specs_28_218, &STATE_VARIABLE_Specs_29_221);
  hlds__make_hlds__add_pragma__add_decl_pragmas_termination_5_p_0(DeclTermination_68, STATE_VARIABLE_ModuleInfo_32_219, &STATE_VARIABLE_ModuleInfo_33_222, STATE_VARIABLE_Specs_29_221, &STATE_VARIABLE_Specs_30_223);
  hlds__make_hlds__add_pragma__add_decl_pragmas_termination2_5_p_0(DeclTermination2_69, STATE_VARIABLE_ModuleInfo_33_222, &STATE_VARIABLE_ModuleInfo_34_224, STATE_VARIABLE_Specs_30_223, &STATE_VARIABLE_Specs_31_225);
  hlds__make_hlds__add_pragma__add_decl_pragmas_sharing_5_p_0(DeclSharing_70, STATE_VARIABLE_ModuleInfo_34_224, &STATE_VARIABLE_ModuleInfo_35_226, STATE_VARIABLE_Specs_31_225, &STATE_VARIABLE_Specs_32_227);
  hlds__make_hlds__add_pragma__add_decl_pragmas_reuse_5_p_0(DeclReuse_71, STATE_VARIABLE_ModuleInfo_35_226, &STATE_VARIABLE_ModuleInfo_36_228, STATE_VARIABLE_Specs_32_227, &STATE_VARIABLE_Specs_33_229);
  Var_230 = mercury__cord__init_0_f_0((MR_Word) (&hlds__make_hlds__make_hlds_passes_scalar_common_1[5]));
  hlds__make_hlds__add_pragma__add_impl_pragmas_8_p_0(ProgressStream_13, ImplPragmas_72, Var_230, &PragmaTabledCord_105, STATE_VARIABLE_ModuleInfo_36_228, &STATE_VARIABLE_ModuleInfo_37_231, STATE_VARIABLE_Specs_33_229, &STATE_VARIABLE_Specs_34_232);
  PragmasTabled_106 = mercury__cord__list_1_f_0((MR_Word) (&hlds__make_hlds__make_hlds_passes_scalar_common_1[5]), PragmaTabledCord_105);
  hlds__make_hlds__add_pragma__add_impl_pragmas_tabled_8_p_0(ProgressStream_13, PragmasTabled_106, STATE_VARIABLE_ModuleInfo_37_231, &STATE_VARIABLE_ModuleInfo_38_233, STATE_VARIABLE_QualInfo_7_220, &STATE_VARIABLE_QualInfo_8_234, STATE_VARIABLE_Specs_34_232, &STATE_VARIABLE_Specs_35_235);
  FPEInfos_107 = mercury__cord__list_1_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_impl_pragma_fproc_export_info_0), FPEInfosCord_103);
  mercury__list__foldl2_6_p_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_impl_pragma_fproc_export_info_0), (MR_Word) (&hlds__hlds_module__hlds__hlds_module__type_ctor_info_module_info_0), (MR_Word) (&hlds__make_hlds__make_hlds_passes_scalar_common_1[4]), (MR_Word) (&hlds__make_hlds__make_hlds_passes_scalar_common_2[7]), FPEInfos_107, ((MR_Box) (STATE_VARIABLE_ModuleInfo_38_233)), &conv13_STATE_VARIABLE_ModuleInfo_39_237, ((MR_Box) (STATE_VARIABLE_Specs_35_235)), &conv12_STATE_VARIABLE_Specs_36_238);
  STATE_VARIABLE_ModuleInfo_39_237 = ((MR_Word) (conv13_STATE_VARIABLE_ModuleInfo_39_237));
  STATE_VARIABLE_Specs_36_238 = ((MR_Word) (conv12_STATE_VARIABLE_Specs_36_238));
  mercury__list__foldl_4_p_0((MR_Word) (&parse_tree__prog_foreign__parse_tree__prog_foreign__type_ctor_info_foreign_decl_code_0), (MR_Word) (&hlds__hlds_module__hlds__hlds_module__type_ctor_info_module_info_0), (MR_Word) (&hlds__make_hlds__make_hlds_passes_scalar_common_2[8]), MutableForeignDeclCodes_96, ((MR_Box) (STATE_VARIABLE_ModuleInfo_39_237)), &conv15_STATE_VARIABLE_ModuleInfo_40_240);
  STATE_VARIABLE_ModuleInfo_40_240 = ((MR_Word) (conv15_STATE_VARIABLE_ModuleInfo_40_240));
  mercury__list__foldl_4_p_0((MR_Word) (&parse_tree__prog_foreign__parse_tree__prog_foreign__type_ctor_info_foreign_body_code_0), (MR_Word) (&hlds__hlds_module__hlds__hlds_module__type_ctor_info_module_info_0), (MR_Word) (&hlds__make_hlds__make_hlds_passes_scalar_common_2[9]), MutableForeignBodyCodes_97, ((MR_Box) (STATE_VARIABLE_ModuleInfo_40_240)), &conv17_STATE_VARIABLE_ModuleInfo_41_242);
  STATE_VARIABLE_ModuleInfo_41_242 = ((MR_Word) (conv17_STATE_VARIABLE_ModuleInfo_41_242));
  mercury__list__foldl2_6_p_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_gen_pragma_unused_args_info_0), (MR_Word) (&hlds__hlds_module__hlds__hlds_module__type_ctor_info_module_info_0), (MR_Word) (&hlds__make_hlds__make_hlds_passes_scalar_common_1[4]), (MR_Word) (&hlds__make_hlds__make_hlds_passes_scalar_common_2[10]), GenUnusedArgs_74, ((MR_Box) (STATE_VARIABLE_ModuleInfo_41_242)), &conv21_STATE_VARIABLE_ModuleInfo_42_244, ((MR_Box) (STATE_VARIABLE_Specs_36_238)), &conv20_STATE_VARIABLE_Specs_37_245);
  STATE_VARIABLE_ModuleInfo_42_244 = ((MR_Word) (conv21_STATE_VARIABLE_ModuleInfo_42_244));
  STATE_VARIABLE_Specs_37_245 = ((MR_Word) (conv20_STATE_VARIABLE_Specs_37_245));
  mercury__list__foldl2_6_p_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_gen_pragma_exceptions_info_0), (MR_Word) (&hlds__hlds_module__hlds__hlds_module__type_ctor_info_module_info_0), (MR_Word) (&hlds__make_hlds__make_hlds_passes_scalar_common_1[4]), (MR_Word) (&hlds__make_hlds__make_hlds_passes_scalar_common_2[11]), GenExceptions_75, ((MR_Box) (STATE_VARIABLE_ModuleInfo_42_244)), &conv25_STATE_VARIABLE_ModuleInfo_43_247, ((MR_Box) (STATE_VARIABLE_Specs_37_245)), &conv24_STATE_VARIABLE_Specs_38_248);
  STATE_VARIABLE_ModuleInfo_43_247 = ((MR_Word) (conv25_STATE_VARIABLE_ModuleInfo_43_247));
  STATE_VARIABLE_Specs_38_248 = ((MR_Word) (conv24_STATE_VARIABLE_Specs_38_248));
  mercury__list__foldl2_6_p_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_gen_pragma_trailing_info_0), (MR_Word) (&hlds__hlds_module__hlds__hlds_module__type_ctor_info_module_info_0), (MR_Word) (&hlds__make_hlds__make_hlds_passes_scalar_common_1[4]), (MR_Word) (&hlds__make_hlds__make_hlds_passes_scalar_common_2[12]), GenTrailing_76, ((MR_Box) (STATE_VARIABLE_ModuleInfo_43_247)), &conv29_STATE_VARIABLE_ModuleInfo_44_250, ((MR_Box) (STATE_VARIABLE_Specs_38_248)), &conv28_STATE_VARIABLE_Specs_39_251);
  STATE_VARIABLE_ModuleInfo_44_250 = ((MR_Word) (conv29_STATE_VARIABLE_ModuleInfo_44_250));
  STATE_VARIABLE_Specs_39_251 = ((MR_Word) (conv28_STATE_VARIABLE_Specs_39_251));
  mercury__list__foldl2_6_p_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_gen_pragma_mm_tabling_info_0), (MR_Word) (&hlds__hlds_module__hlds__hlds_module__type_ctor_info_module_info_0), (MR_Word) (&hlds__make_hlds__make_hlds_passes_scalar_common_1[4]), (MR_Word) (&hlds__make_hlds__make_hlds_passes_scalar_common_2[13]), GenMMTabling_77, ((MR_Box) (STATE_VARIABLE_ModuleInfo_44_250)), &conv33_STATE_VARIABLE_ModuleInfo_117, ((MR_Box) (STATE_VARIABLE_Specs_39_251)), &conv32_STATE_VARIABLE_Specs_40_254);
  *STATE_VARIABLE_ModuleInfo_117 = ((MR_Word) (conv33_STATE_VARIABLE_ModuleInfo_117));
  STATE_VARIABLE_Specs_40_254 = ((MR_Word) (conv32_STATE_VARIABLE_Specs_40_254));
  hlds__make_hlds__check_field_access_functions__check_preds_if_field_access_function_4_p_0(*STATE_VARIABLE_ModuleInfo_117, PredDecls_53, STATE_VARIABLE_Specs_40_254, STATE_VARIABLE_Specs_118);
  ModuleItemVersionNumbers_108 = ((MR_Word) ((MR_hl_field(0, AugCompUnit_14, 8))));
  mercury__map__foldl_4_p_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), (MR_Word) (&recompilation__item_types__recompilation__item_types__type_ctor_info_module_item_version_numbers_0), (MR_Word) (&hlds__make_hlds__qual_info__hlds__make_hlds__qual_info__type_ctor_info_qual_info_0), (MR_Word) (&hlds__make_hlds__make_hlds_passes_scalar_common_2[14]), ModuleItemVersionNumbers_108, ((MR_Box) (STATE_VARIABLE_QualInfo_8_234)), &conv35_STATE_VARIABLE_QualInfo_114);
  *STATE_VARIABLE_QualInfo_114 = ((MR_Word) (conv35_STATE_VARIABLE_QualInfo_114));
  hlds__make_hlds__qual_info__qual_info_get_mq_info_2_p_0(*STATE_VARIABLE_QualInfo_114, &MQInfo_109);
  parse_tree__module_qual__mq_info__mq_info_get_undef_types_2_p_0(MQInfo_109, &MQUndefTypes_110);
  parse_tree__module_qual__mq_info__mq_info_get_undef_insts_2_p_0(MQInfo_109, &MQUndefInsts_111);
  parse_tree__module_qual__mq_info__mq_info_get_undef_modes_2_p_0(MQInfo_109, &MQUndefModes_112);
  parse_tree__module_qual__mq_info__mq_info_get_undef_typeclasses_2_p_0(MQInfo_109, &MQUndefTypeClasses_113);
  succeeded = mercury__set_tree234__is_non_empty_1_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_type_ctor_0), MQUndefTypes_110);
  if (!(succeeded))
    succeeded = mercury__set_tree234__is_non_empty_1_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_sym_name_arity_0), MQUndefTypeClasses_113);
  if (succeeded)
    *STATE_VARIABLE_FoundInvalidType_115 = (MR_Integer) 1;
  else
    *STATE_VARIABLE_FoundInvalidType_115 = STATE_VARIABLE_FoundInvalidType_6_165;
  succeeded = mercury__set_tree234__is_non_empty_1_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_inst_ctor_0), MQUndefInsts_111);
  if (!(succeeded))
    succeeded = mercury__set_tree234__is_non_empty_1_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mode_ctor_0), MQUndefModes_112);
  if (succeeded)
    *STATE_VARIABLE_FoundInvalidInstOrMode_116 = (MR_Integer) 1;
  else
    *STATE_VARIABLE_FoundInvalidInstOrMode_116 = STATE_VARIABLE_FoundInvalidInstOrMode_4_162;
}
  ...
  MR_Word * Specs_6)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_4, (MR_Integer) 218, &WarnIncludeAndNonInclude_7);
