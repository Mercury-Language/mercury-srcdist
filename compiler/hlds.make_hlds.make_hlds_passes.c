  ...
  MR_Word LambdaHeadVar__1_143)
{
  ...
  parse_tree__error_spec__extract_spec_phase_2_p_0(Var_144, &Phase_301);
  succeeded = (Phase_301 == (MR_Word) ((MR_Unsigned) 36U));
  return succeeded;
}
  ...
  MR_Word * STATE_VARIABLE_InfoSpecs_131)
{
  ...
  Var_616 = mdbcomp__builtin_modules__mercury_public_builtin_module_0_f_0();
  succeeded = mdbcomp__sym_name____Unify____sym_name_0_0(ModuleName_32, Var_616);
  if (succeeded)
  ...
  hlds__make_hlds__add_pragma_decl__add_decl_pragmas_input_spec_5_p_0(DeclInputSpec_72, STATE_VARIABLE_ModuleInfo_33_251, &STATE_VARIABLE_ModuleInfo_34_255, STATE_VARIABLE_ErrSpecs_27_253, &STATE_VARIABLE_ErrSpecs_28_256);
  ...
  *STATE_VARIABLE_QualInfo_125 = ((MR_Word) (conv35_STATE_VARIABLE_QualInfo_125));
  ...
  parse_tree__module_qual__mq_info__get_err_specs_in_mq_info_4_p_0(MQInfo_121, &MQInvalidTypeSpecs_122, &MQInvalidInstModeSpecs_123, &MQNonBlockingUndefSpecs_124);
