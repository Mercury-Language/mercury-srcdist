...
{
  MR_bool succeeded;
  MR_Word Var_141 = (MR_Word) (LambdaHeadVar__1_140);
  MR_Word Phase_297;

  parse_tree__error_spec__extract_spec_phase_2_p_0(Var_141, &Phase_297);
  succeeded = (Phase_297 == (MR_Word) ((MR_Unsigned) 36U));
  return succeeded;
}
  ...
  MR_Word LambdaHeadVar__1_138)
{
  ...
  parse_tree__error_spec__extract_spec_phase_2_p_0(Var_139, &Phase_46);
...
hlds__make_hlds__make_hlds_passes__parse_tree_to_hlds_15_p_0(
  ...
  MR_Word * STATE_VARIABLE_QualInfo_122,
  MR_Word * STATE_VARIABLE_ModuleInfo_123,
  MR_Word * STATE_VARIABLE_InvalidTypeSpecs_124,
  MR_Word * STATE_VARIABLE_InvalidInstModeSpecs_125,
  MR_Word * STATE_VARIABLE_ErrSpecs_126,
  MR_Word * STATE_VARIABLE_WarnSpecs_127,
  MR_Word * STATE_VARIABLE_InfoSpecs_128)
{
  MR_bool succeeded;
  ...
  MR_Word MQInfo_118;
  MR_Word MQInvalidTypeSpecs_119;
  MR_Word MQInvalidInstModeSpecs_120;
  MR_Word MQNonBlockingUndefSpecs_121;
  MR_Word STATE_VARIABLE_WarnSpecs_1_129;
  MR_Word STATE_VARIABLE_ErrSpecs_1_135;
  MR_Word STATE_VARIABLE_WarnSpecs_2_136;
  MR_Word Var_137;
  MR_Word STATE_VARIABLE_InvalidTypeSpecs_1_142;
  MR_Word STATE_VARIABLE_InvalidInstModeSpecs_1_143;
  MR_Word STATE_VARIABLE_ModuleInfo_1_145;
  MR_Word STATE_VARIABLE_ModuleInfo_2_146;
  MR_Word STATE_VARIABLE_SolverPredDeclCord_1_147;
  MR_Word STATE_VARIABLE_SolverForeignProcCord_1_148;
  MR_Word STATE_VARIABLE_SolverMutableCord_1_149;
  MR_Word STATE_VARIABLE_ModuleInfo_3_150;
  MR_Word STATE_VARIABLE_SolverPredDeclCord_2_151;
  MR_Word STATE_VARIABLE_SolverForeignProcCord_2_152;
  MR_Word STATE_VARIABLE_SolverMutableCord_2_153;
  MR_Word STATE_VARIABLE_InvalidTypeSpecs_2_154;
  MR_Word STATE_VARIABLE_ErrSpecs_2_155;
  MR_Word STATE_VARIABLE_WarnSpecs_3_156;
  MR_Word STATE_VARIABLE_ModuleInfo_4_157;
  MR_Word STATE_VARIABLE_SolverPredDeclCord_3_158;
  MR_Word STATE_VARIABLE_SolverForeignProcCord_3_159;
  MR_Word STATE_VARIABLE_SolverMutableCord_3_160;
  MR_Word STATE_VARIABLE_InvalidTypeSpecs_3_161;
  MR_Word STATE_VARIABLE_ErrSpecs_3_162;
  MR_Word STATE_VARIABLE_WarnSpecs_4_163;
  MR_Word STATE_VARIABLE_ModuleInfo_5_164;
  MR_Word STATE_VARIABLE_SolverPredDeclCord_4_165;
  MR_Word STATE_VARIABLE_SolverForeignProcCord_4_166;
  MR_Word STATE_VARIABLE_SolverMutableCord_4_167;
  MR_Word STATE_VARIABLE_InvalidTypeSpecs_4_168;
  MR_Word STATE_VARIABLE_ErrSpecs_4_169;
  MR_Word STATE_VARIABLE_WarnSpecs_5_170;
  MR_Word STATE_VARIABLE_ModuleInfo_6_171;
  MR_Word STATE_VARIABLE_ErrSpecs_5_172;
  MR_Word STATE_VARIABLE_WarnSpecs_6_173;
  MR_Word STATE_VARIABLE_InvalidInstModeSpecs_2_174;
  MR_Word STATE_VARIABLE_ModuleInfo_7_175;
  MR_Word STATE_VARIABLE_ErrSpecs_6_176;
  MR_Word STATE_VARIABLE_InvalidInstModeSpecs_3_177;
  MR_Word STATE_VARIABLE_ModuleInfo_8_179;
  MR_Word STATE_VARIABLE_InvalidTypeSpecs_5_180;
  MR_Word STATE_VARIABLE_WarnSpecs_7_181;
  MR_Word STATE_VARIABLE_ModuleInfo_9_182;
  MR_Word STATE_VARIABLE_ErrSpecs_7_183;
  MR_Word STATE_VARIABLE_ModuleInfo_10_184;
  MR_Word STATE_VARIABLE_ErrSpecs_8_185;
  MR_Word STATE_VARIABLE_ModuleInfo_11_186;
  MR_Word STATE_VARIABLE_ErrSpecs_9_187;
  MR_Word STATE_VARIABLE_ErrSpecs_10_188;
  MR_Word STATE_VARIABLE_ModuleInfo_12_189;
  MR_Word STATE_VARIABLE_ErrSpecs_11_190;
  MR_Word STATE_VARIABLE_ModuleInfo_13_191;
  MR_Word STATE_VARIABLE_ErrSpecs_12_192;
  MR_Word STATE_VARIABLE_ModuleInfo_14_193;
  MR_Word STATE_VARIABLE_ModuleInfo_15_194;
  MR_Word STATE_VARIABLE_ErrSpecs_13_195;
  MR_Word STATE_VARIABLE_ModuleInfo_16_196;
  MR_Word STATE_VARIABLE_ErrSpecs_14_197;
  MR_Word STATE_VARIABLE_ModuleInfo_17_199;
  MR_Word STATE_VARIABLE_ModuleInfo_18_202;
  MR_Word STATE_VARIABLE_ModuleInfo_19_203;
  MR_Word STATE_VARIABLE_QualInfo_1_204;
  MR_Word STATE_VARIABLE_ModuleInfo_20_205;
  MR_Word STATE_VARIABLE_QualInfo_2_206;
  MR_Word STATE_VARIABLE_ErrSpecs_15_207;
  MR_Word STATE_VARIABLE_WarnSpecs_8_208;
  MR_Word STATE_VARIABLE_ModuleInfo_21_209;
  MR_Word STATE_VARIABLE_QualInfo_3_210;
  MR_Word STATE_VARIABLE_ErrSpecs_16_211;
  MR_Word STATE_VARIABLE_WarnSpecs_9_212;
  MR_Word STATE_VARIABLE_ModuleInfo_22_213;
  MR_Word STATE_VARIABLE_QualInfo_4_214;
  MR_Word STATE_VARIABLE_ErrSpecs_17_215;
  MR_Word STATE_VARIABLE_WarnSpecs_10_216;
  MR_Word STATE_VARIABLE_ModuleInfo_23_217;
  MR_Word STATE_VARIABLE_ModuleInfo_24_218;
  MR_Word STATE_VARIABLE_ErrSpecs_18_219;
  MR_Word STATE_VARIABLE_WarnSpecs_11_220;
  MR_Word STATE_VARIABLE_ModuleInfo_25_221;
  MR_Word STATE_VARIABLE_ErrSpecs_19_222;
  MR_Word STATE_VARIABLE_WarnSpecs_12_223;
  MR_Word STATE_VARIABLE_ModuleInfo_26_224;
  MR_Word STATE_VARIABLE_ErrSpecs_20_225;
  MR_Word STATE_VARIABLE_WarnSpecs_13_226;
  MR_Word STATE_VARIABLE_ModuleInfo_27_227;
  MR_Word STATE_VARIABLE_ErrSpecs_21_228;
  MR_Word STATE_VARIABLE_WarnSpecs_14_229;
  MR_Word STATE_VARIABLE_ModuleInfo_28_230;
  MR_Word STATE_VARIABLE_ErrSpecs_22_231;
  MR_Word STATE_VARIABLE_WarnSpecs_15_232;
  MR_Word STATE_VARIABLE_ErrSpecs_23_233;
  MR_Word STATE_VARIABLE_ErrSpecs_24_234;
  MR_Word STATE_VARIABLE_ModuleInfo_29_235;
  MR_Word STATE_VARIABLE_ModuleInfo_30_236;
  MR_Word STATE_VARIABLE_ModuleInfo_31_238;
  MR_Word STATE_VARIABLE_QualInfo_5_239;
  MR_Word STATE_VARIABLE_ErrSpecs_25_240;
  MR_Word STATE_VARIABLE_WarnSpecs_16_241;
  MR_Word STATE_VARIABLE_InfoSpecs_2_242;
  MR_Word STATE_VARIABLE_ModuleInfo_32_243;
  MR_Word STATE_VARIABLE_QualInfo_6_244;
  MR_Word STATE_VARIABLE_ErrSpecs_26_245;
  MR_Word STATE_VARIABLE_WarnSpecs_17_246;
  MR_Word STATE_VARIABLE_ModuleInfo_33_248;
  MR_Word STATE_VARIABLE_QualInfo_7_249;
  MR_Word STATE_VARIABLE_ErrSpecs_27_250;
  MR_Word STATE_VARIABLE_WarnSpecs_18_251;
  MR_Word STATE_VARIABLE_ModuleInfo_34_252;
  MR_Word STATE_VARIABLE_ErrSpecs_28_253;
  MR_Word STATE_VARIABLE_ModuleInfo_35_254;
  MR_Word STATE_VARIABLE_ErrSpecs_29_255;
  MR_Word STATE_VARIABLE_ModuleInfo_36_256;
  MR_Word STATE_VARIABLE_ErrSpecs_30_257;
  MR_Word STATE_VARIABLE_ModuleInfo_37_258;
  MR_Word STATE_VARIABLE_ErrSpecs_31_259;
  MR_Word STATE_VARIABLE_ModuleInfo_38_260;
  MR_Word STATE_VARIABLE_ErrSpecs_32_261;
  MR_Word Var_262;
  MR_Word STATE_VARIABLE_ModuleInfo_39_263;
  MR_Word STATE_VARIABLE_ErrSpecs_33_264;
  MR_Word STATE_VARIABLE_WarnSpecs_19_265;
  MR_Word STATE_VARIABLE_ModuleInfo_40_266;
  MR_Word STATE_VARIABLE_QualInfo_8_267;
  MR_Word STATE_VARIABLE_ErrSpecs_34_268;
  MR_Word STATE_VARIABLE_ModuleInfo_41_271;
  MR_Word STATE_VARIABLE_ErrSpecs_35_272;
  MR_Word STATE_VARIABLE_ModuleInfo_42_274;
  MR_Word STATE_VARIABLE_ModuleInfo_43_276;
  ...
  MR_Word STATE_VARIABLE_ModuleInfo_46_284;
  MR_Word STATE_VARIABLE_ErrSpecs_38_285;
  MR_Word STATE_VARIABLE_ErrSpecs_39_288;
  MR_Word STATE_VARIABLE_ErrSpecs_40_289;
  MR_Box conv7_STATE_VARIABLE_ModuleInfo_17_199;
  MR_Word Var_611;
  MR_Box conv13_STATE_VARIABLE_ModuleInfo_41_271;
  MR_Box conv12_STATE_VARIABLE_ErrSpecs_35_272;
  MR_Box conv15_STATE_VARIABLE_ModuleInfo_42_274;
  MR_Box conv17_STATE_VARIABLE_ModuleInfo_43_276;
  MR_Box conv21_STATE_VARIABLE_ModuleInfo_44_278;
  MR_Box conv20_STATE_VARIABLE_ErrSpecs_36_279;
  MR_Box conv25_STATE_VARIABLE_ModuleInfo_45_281;
  MR_Box conv24_STATE_VARIABLE_ErrSpecs_37_282;
  MR_Box conv29_STATE_VARIABLE_ModuleInfo_46_284;
  MR_Box conv28_STATE_VARIABLE_ErrSpecs_38_285;
  MR_Box conv33_STATE_VARIABLE_ModuleInfo_123;
  MR_Box conv32_STATE_VARIABLE_ErrSpecs_39_288;
  MR_Box conv35_STATE_VARIABLE_QualInfo_122;

  hlds__make_hlds__make_hlds_passes__maybe_warn_include_and_non_include_3_p_0(Globals_18, ParseTreeModuleSrc_31, &STATE_VARIABLE_WarnSpecs_1_129);
  ...
  STATE_VARIABLE_ErrSpecs_1_135 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_err_spec_0), TypeErrSpecs_40, InstModeErrSpecs_42);
  Var_137 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_warn_spec_0), InstModeWarnSpecs_43, STATE_VARIABLE_WarnSpecs_1_129);
  STATE_VARIABLE_WarnSpecs_2_136 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_warn_spec_0), TypeWarnSpecs_41, Var_137);
  mercury__list__filter_3_p_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_err_spec_0), (MR_Word) (&hlds__make_hlds__make_hlds_passes_scalar_common_2[3]), TypeErrSpecs_40, &STATE_VARIABLE_InvalidTypeSpecs_1_142);
  mercury__list__filter_3_p_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_err_spec_0), (MR_Word) (&hlds__make_hlds__make_hlds_passes_scalar_common_2[4]), InstModeErrSpecs_42, &STATE_VARIABLE_InvalidInstModeSpecs_1_143);
  ...
  hlds__hlds_module__module_info_init_12_p_0(Globals_18, ModuleName_32, ModuleNameContext_33, DumpBaseFileName_19, InclMap_48, UsedEqvModules_22, ImplicitlyUsedModules_34, UnusedInterfaceImports_23, PQInfo_35, (MR_Word) ((MR_Unsigned) 0U), TypeRepnDec_87, &STATE_VARIABLE_ModuleInfo_1_145);
  hlds__make_hlds__make_hlds_passes__add_item_avails_3_p_0(Avails_49, STATE_VARIABLE_ModuleInfo_1_145, &STATE_VARIABLE_ModuleInfo_2_146);
  STATE_VARIABLE_SolverPredDeclCord_1_147 = mercury__cord__init_0_f_0((MR_Word) (&hlds__make_hlds__make_hlds_passes_scalar_common_1[1]));
  STATE_VARIABLE_SolverForeignProcCord_1_148 = mercury__cord__init_0_f_0((MR_Word) (&hlds__make_hlds__make_hlds_passes_scalar_common_1[2]));
  STATE_VARIABLE_SolverMutableCord_1_149 = mercury__cord__init_0_f_0((MR_Word) (&hlds__make_hlds__make_hlds_passes_scalar_common_1[3]));
  hlds__make_hlds__make_hlds_passes__add_type_defns_15_p_0(TypeDefnsAbstract_51, STATE_VARIABLE_ModuleInfo_2_146, &STATE_VARIABLE_ModuleInfo_3_150, STATE_VARIABLE_SolverPredDeclCord_1_147, &STATE_VARIABLE_SolverPredDeclCord_2_151, STATE_VARIABLE_SolverForeignProcCord_1_148, &STATE_VARIABLE_SolverForeignProcCord_2_152, STATE_VARIABLE_SolverMutableCord_1_149, &STATE_VARIABLE_SolverMutableCord_2_153, STATE_VARIABLE_InvalidTypeSpecs_1_142, &STATE_VARIABLE_InvalidTypeSpecs_2_154, STATE_VARIABLE_ErrSpecs_1_135, &STATE_VARIABLE_ErrSpecs_2_155, STATE_VARIABLE_WarnSpecs_2_136, &STATE_VARIABLE_WarnSpecs_3_156);
  hlds__make_hlds__make_hlds_passes__add_type_defns_15_p_0(TypeDefnsMercury_52, STATE_VARIABLE_ModuleInfo_3_150, &STATE_VARIABLE_ModuleInfo_4_157, STATE_VARIABLE_SolverPredDeclCord_2_151, &STATE_VARIABLE_SolverPredDeclCord_3_158, STATE_VARIABLE_SolverForeignProcCord_2_152, &STATE_VARIABLE_SolverForeignProcCord_3_159, STATE_VARIABLE_SolverMutableCord_2_153, &STATE_VARIABLE_SolverMutableCord_3_160, STATE_VARIABLE_InvalidTypeSpecs_2_154, &STATE_VARIABLE_InvalidTypeSpecs_3_161, STATE_VARIABLE_ErrSpecs_2_155, &STATE_VARIABLE_ErrSpecs_3_162, STATE_VARIABLE_WarnSpecs_3_156, &STATE_VARIABLE_WarnSpecs_4_163);
  hlds__make_hlds__make_hlds_passes__add_type_defns_15_p_0(TypeDefnsForeign_53, STATE_VARIABLE_ModuleInfo_4_157, &STATE_VARIABLE_ModuleInfo_5_164, STATE_VARIABLE_SolverPredDeclCord_3_158, &STATE_VARIABLE_SolverPredDeclCord_4_165, STATE_VARIABLE_SolverForeignProcCord_3_159, &STATE_VARIABLE_SolverForeignProcCord_4_166, STATE_VARIABLE_SolverMutableCord_3_160, &STATE_VARIABLE_SolverMutableCord_4_167, STATE_VARIABLE_InvalidTypeSpecs_3_161, &STATE_VARIABLE_InvalidTypeSpecs_4_168, STATE_VARIABLE_ErrSpecs_3_162, &STATE_VARIABLE_ErrSpecs_4_169, STATE_VARIABLE_WarnSpecs_4_163, &STATE_VARIABLE_WarnSpecs_5_170);
  SolverPredDecls_91 = mercury__cord__list_1_f_0((MR_Word) (&hlds__make_hlds__make_hlds_passes_scalar_common_1[1]), STATE_VARIABLE_SolverPredDeclCord_4_165);
  SolverForeignProcs_92 = mercury__cord__list_1_f_0((MR_Word) (&hlds__make_hlds__make_hlds_passes_scalar_common_1[2]), STATE_VARIABLE_SolverForeignProcCord_4_166);
  SolverMutables_93 = mercury__cord__list_1_f_0((MR_Word) (&hlds__make_hlds__make_hlds_passes_scalar_common_1[3]), STATE_VARIABLE_SolverMutableCord_4_167);
  hlds__make_hlds__make_hlds_passes__add_inst_defns_7_p_0(InstDefns_54, STATE_VARIABLE_ModuleInfo_5_164, &STATE_VARIABLE_ModuleInfo_6_171, STATE_VARIABLE_ErrSpecs_4_169, &STATE_VARIABLE_ErrSpecs_5_172, STATE_VARIABLE_WarnSpecs_5_170, &STATE_VARIABLE_WarnSpecs_6_173);
  hlds__make_hlds__add_mode__check_inst_defns_4_p_0(STATE_VARIABLE_ModuleInfo_6_171, InstDefns_54, STATE_VARIABLE_InvalidInstModeSpecs_1_143, &STATE_VARIABLE_InvalidInstModeSpecs_2_174);
  hlds__make_hlds__make_hlds_passes__add_mode_defns_5_p_0(ModeDefns_55, STATE_VARIABLE_ModuleInfo_6_171, &STATE_VARIABLE_ModuleInfo_7_175, STATE_VARIABLE_ErrSpecs_5_172, &STATE_VARIABLE_ErrSpecs_6_176);
  hlds__make_hlds__add_mode__check_mode_defns_4_p_0(STATE_VARIABLE_ModuleInfo_7_175, ModeDefns_55, STATE_VARIABLE_InvalidInstModeSpecs_2_174, &STATE_VARIABLE_InvalidInstModeSpecs_3_177);
  if ((STATE_VARIABLE_InvalidTypeSpecs_4_168 == (MR_Word) ((MR_Unsigned) 0U)))
  {
    MR_Word TypeTable0_94;
    MR_Word Var_178;
    MR_Box conv5_STATE_VARIABLE_ModuleInfo_8_179;
    MR_Box conv4_STATE_VARIABLE_InvalidTypeSpecs_5_180;
    MR_Box conv3_STATE_VARIABLE_WarnSpecs_7_181;

    hlds__hlds_module__module_info_get_type_table_2_p_0(STATE_VARIABLE_ModuleInfo_7_175, &TypeTable0_94);
    {
      Var_178 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(0, Var_178, 0) = ((MR_Box) (&hlds__make_hlds__make_hlds_passes_scalar_common_9[3]));
      MR_hl_field(0, Var_178, 1) = ((MR_Box) (hlds__make_hlds__make_hlds_passes__parse_tree_to_hlds_15_p_0_3));
      MR_hl_field(0, Var_178, 2) = ((MR_Box) ((MR_Integer) 1));
      MR_hl_field(0, Var_178, 3) = ((MR_Box) (TypeTable0_94));
    }
    hlds__hlds_data__foldl3_over_type_ctor_defns_8_p_0((MR_Word) (&hlds__hlds_module__hlds__hlds_module__type_ctor_info_module_info_0), (MR_Word) (&hlds__make_hlds__make_hlds_passes_scalar_common_1[4]), (MR_Word) (&hlds__make_hlds__make_hlds_passes_scalar_common_1[5]), Var_178, TypeTable0_94, ((MR_Box) (STATE_VARIABLE_ModuleInfo_7_175)), &conv5_STATE_VARIABLE_ModuleInfo_8_179, ((MR_Box) (STATE_VARIABLE_InvalidTypeSpecs_4_168)), &conv4_STATE_VARIABLE_InvalidTypeSpecs_5_180, ((MR_Box) (STATE_VARIABLE_WarnSpecs_6_173)), &conv3_STATE_VARIABLE_WarnSpecs_7_181);
    STATE_VARIABLE_ModuleInfo_8_179 = ((MR_Word) (conv5_STATE_VARIABLE_ModuleInfo_8_179));
    STATE_VARIABLE_InvalidTypeSpecs_5_180 = ((MR_Word) (conv4_STATE_VARIABLE_InvalidTypeSpecs_5_180));
    STATE_VARIABLE_WarnSpecs_7_181 = ((MR_Word) (conv3_STATE_VARIABLE_WarnSpecs_7_181));
  }
  else
  {
    STATE_VARIABLE_ModuleInfo_8_179 = STATE_VARIABLE_ModuleInfo_7_175;
    STATE_VARIABLE_InvalidTypeSpecs_5_180 = STATE_VARIABLE_InvalidTypeSpecs_4_168;
    STATE_VARIABLE_WarnSpecs_7_181 = STATE_VARIABLE_WarnSpecs_6_173;
  }
  hlds__make_hlds__make_hlds_passes__add_pred_decls_5_p_0(PredDecls_56, STATE_VARIABLE_ModuleInfo_8_179, &STATE_VARIABLE_ModuleInfo_9_182, STATE_VARIABLE_ErrSpecs_6_176, &STATE_VARIABLE_ErrSpecs_7_183);
  hlds__make_hlds__make_hlds_passes__add_pred_decls_5_p_0(SolverPredDecls_91, STATE_VARIABLE_ModuleInfo_9_182, &STATE_VARIABLE_ModuleInfo_10_184, STATE_VARIABLE_ErrSpecs_7_183, &STATE_VARIABLE_ErrSpecs_8_185);
  hlds__make_hlds__make_hlds_passes__add_mode_decls_5_p_0(ModeDecls_57, STATE_VARIABLE_ModuleInfo_10_184, &STATE_VARIABLE_ModuleInfo_11_186, STATE_VARIABLE_ErrSpecs_8_185, &STATE_VARIABLE_ErrSpecs_9_187);
  ...
  hlds__hlds_module__module_info_get_user_init_pred_target_names_2_p_0(STATE_VARIABLE_ModuleInfo_11_186, &InitPredTargetNames0_98);
  ...
  hlds__make_hlds__add_mutable_aux_preds__implement_mutables_if_local_13_p_0(STATE_VARIABLE_ModuleInfo_11_186, MQUndefInsts0_101, AllMutables_97, &MutablePredDecls_102, &MutableClauses_103, &MutableForeignProcs_104, &MutableForeignDeclCodes_105, &MutableForeignBodyCodes_106, &FPEInfosCord1_107, InitPredTargetNames0_98, &InitPredTargetNames1_108, STATE_VARIABLE_ErrSpecs_9_187, &STATE_VARIABLE_ErrSpecs_10_188);
  hlds__make_hlds__make_hlds_passes__add_pred_decls_5_p_0(MutablePredDecls_102, STATE_VARIABLE_ModuleInfo_11_186, &STATE_VARIABLE_ModuleInfo_12_189, STATE_VARIABLE_ErrSpecs_10_188, &STATE_VARIABLE_ErrSpecs_11_190);
  hlds__make_hlds__add_class__add_typeclass_defns_5_p_0(Typeclasses_59, STATE_VARIABLE_ModuleInfo_12_189, &STATE_VARIABLE_ModuleInfo_13_191, STATE_VARIABLE_ErrSpecs_11_190, &STATE_VARIABLE_ErrSpecs_12_192);
  hlds__make_hlds__make_hlds_passes__maybe_add_default_modes_3_p_0(PredDecls_56, STATE_VARIABLE_ModuleInfo_13_191, &STATE_VARIABLE_ModuleInfo_14_193);
  hlds__make_hlds__add_class__add_abstract_instance_defns_5_p_0(IntInstances_60, STATE_VARIABLE_ModuleInfo_14_193, &STATE_VARIABLE_ModuleInfo_15_194, STATE_VARIABLE_ErrSpecs_12_192, &STATE_VARIABLE_ErrSpecs_13_195);
  hlds__make_hlds__add_class__add_full_instance_defns_5_p_0(ImpInstances_61, STATE_VARIABLE_ModuleInfo_15_194, &STATE_VARIABLE_ModuleInfo_16_196, STATE_VARIABLE_ErrSpecs_13_195, &STATE_VARIABLE_ErrSpecs_14_197);
  mercury__list__foldl_4_p_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_fim_0), (MR_Word) (&hlds__hlds_module__hlds__hlds_module__type_ctor_info_module_info_0), (MR_Word) (&hlds__make_hlds__make_hlds_passes_scalar_common_2[5]), FIMs_50, ((MR_Box) (STATE_VARIABLE_ModuleInfo_16_196)), &conv7_STATE_VARIABLE_ModuleInfo_17_199);
  STATE_VARIABLE_ModuleInfo_17_199 = ((MR_Word) (conv7_STATE_VARIABLE_ModuleInfo_17_199));
  Var_611 = mdbcomp__builtin_modules__mercury_public_builtin_module_0_f_0();
  succeeded = mdbcomp__sym_name____Unify____sym_name_0_0(ModuleName_32, Var_611);
  if (succeeded)
    succeeded = hlds__special_pred__compiler_generated_rtti_for_builtins_1_p_0(STATE_VARIABLE_ModuleInfo_17_199);
  if (succeeded)
  {
    MR_Word Var_201;
    MR_Box conv9_STATE_VARIABLE_ModuleInfo_18_202;

    Var_201 = parse_tree__prog_type__builtin_type_ctors_with_no_hlds_type_defn_0_f_0();
    mercury__list__foldl_4_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_type_ctor_0), (MR_Word) (&hlds__hlds_module__hlds__hlds_module__type_ctor_info_module_info_0), (MR_Word) (&hlds__make_hlds__make_hlds_passes_scalar_common_2[6]), Var_201, ((MR_Box) (STATE_VARIABLE_ModuleInfo_17_199)), &conv9_STATE_VARIABLE_ModuleInfo_18_202);
    STATE_VARIABLE_ModuleInfo_18_202 = ((MR_Word) (conv9_STATE_VARIABLE_ModuleInfo_18_202));
  }
  else
    STATE_VARIABLE_ModuleInfo_18_202 = STATE_VARIABLE_ModuleInfo_17_199;
  hlds__hlds_module__module_info_optimize_2_p_0(STATE_VARIABLE_ModuleInfo_18_202, &STATE_VARIABLE_ModuleInfo_19_203);
  hlds__make_hlds__qual_info__init_qual_info_3_p_0(MQInfo0_20, TypeEqvMap_21, &STATE_VARIABLE_QualInfo_1_204);
  hlds__make_hlds__make_hlds_passes__add_clauses_10_p_0(ProgressStream_16, Clauses_83, STATE_VARIABLE_ModuleInfo_19_203, &STATE_VARIABLE_ModuleInfo_20_205, STATE_VARIABLE_QualInfo_1_204, &STATE_VARIABLE_QualInfo_2_206, STATE_VARIABLE_ErrSpecs_14_197, &STATE_VARIABLE_ErrSpecs_15_207, STATE_VARIABLE_WarnSpecs_7_181, &STATE_VARIABLE_WarnSpecs_8_208);
  hlds__make_hlds__make_hlds_passes__add_clauses_10_p_0(ProgressStream_16, MutableClauses_103, STATE_VARIABLE_ModuleInfo_20_205, &STATE_VARIABLE_ModuleInfo_21_209, STATE_VARIABLE_QualInfo_2_206, &STATE_VARIABLE_QualInfo_3_210, STATE_VARIABLE_ErrSpecs_15_207, &STATE_VARIABLE_ErrSpecs_16_211, STATE_VARIABLE_WarnSpecs_8_208, &STATE_VARIABLE_WarnSpecs_9_212);
  hlds__make_hlds__make_hlds_passes__add_promises_10_p_0(ProgressStream_16, Promises_58, STATE_VARIABLE_ModuleInfo_21_209, &STATE_VARIABLE_ModuleInfo_22_213, STATE_VARIABLE_QualInfo_3_210, &STATE_VARIABLE_QualInfo_4_214, STATE_VARIABLE_ErrSpecs_16_211, &STATE_VARIABLE_ErrSpecs_17_215, STATE_VARIABLE_WarnSpecs_9_212, &STATE_VARIABLE_WarnSpecs_10_216);
  hlds__hlds_module__module_info_set_int_bad_clauses_3_p_0(IntBadClauses_85, STATE_VARIABLE_ModuleInfo_22_213, &STATE_VARIABLE_ModuleInfo_23_217);
  hlds__make_hlds__add_pragma_decl__add_decl_markers_7_p_0(DeclMarkers_69, STATE_VARIABLE_ModuleInfo_23_217, &STATE_VARIABLE_ModuleInfo_24_218, STATE_VARIABLE_ErrSpecs_17_215, &STATE_VARIABLE_ErrSpecs_18_219, STATE_VARIABLE_WarnSpecs_10_216, &STATE_VARIABLE_WarnSpecs_11_220);
  hlds__make_hlds__add_pragma_impl__add_impl_markers_7_p_0(ImplMarkers_78, STATE_VARIABLE_ModuleInfo_24_218, &STATE_VARIABLE_ModuleInfo_25_221, STATE_VARIABLE_ErrSpecs_18_219, &STATE_VARIABLE_ErrSpecs_19_222, STATE_VARIABLE_WarnSpecs_11_220, &STATE_VARIABLE_WarnSpecs_12_223);
  hlds__make_hlds__add_foreign_proc__add_foreign_procs_8_p_0(ProgressStream_16, ForeignProcs_84, STATE_VARIABLE_ModuleInfo_25_221, &STATE_VARIABLE_ModuleInfo_26_224, STATE_VARIABLE_ErrSpecs_19_222, &STATE_VARIABLE_ErrSpecs_20_225, STATE_VARIABLE_WarnSpecs_12_223, &STATE_VARIABLE_WarnSpecs_13_226);
  hlds__make_hlds__add_foreign_proc__add_foreign_procs_8_p_0(ProgressStream_16, SolverForeignProcs_92, STATE_VARIABLE_ModuleInfo_26_224, &STATE_VARIABLE_ModuleInfo_27_227, STATE_VARIABLE_ErrSpecs_20_225, &STATE_VARIABLE_ErrSpecs_21_228, STATE_VARIABLE_WarnSpecs_13_226, &STATE_VARIABLE_WarnSpecs_14_229);
  hlds__make_hlds__add_foreign_proc__add_foreign_procs_8_p_0(ProgressStream_16, MutableForeignProcs_104, STATE_VARIABLE_ModuleInfo_27_227, &STATE_VARIABLE_ModuleInfo_28_230, STATE_VARIABLE_ErrSpecs_21_228, &STATE_VARIABLE_ErrSpecs_22_231, STATE_VARIABLE_WarnSpecs_14_229, &STATE_VARIABLE_WarnSpecs_15_232);
  hlds__hlds_module__module_info_get_user_final_pred_target_names_2_p_0(STATE_VARIABLE_ModuleInfo_28_230, &FinalPredTargetNames1_109);
  hlds__make_hlds__make_hlds_passes__add_initialises_8_p_0(STATE_VARIABLE_ModuleInfo_28_230, Initialises_62, FPEInfosCord1_107, &FPEInfosCord2_110, InitPredTargetNames1_108, &InitPredTargetNames_111, STATE_VARIABLE_ErrSpecs_22_231, &STATE_VARIABLE_ErrSpecs_23_233);
  hlds__make_hlds__make_hlds_passes__add_finalises_8_p_0(STATE_VARIABLE_ModuleInfo_28_230, Finalises_63, FPEInfosCord2_110, &FPEInfosCord_112, FinalPredTargetNames1_109, &FinalPredTargetNames_113, STATE_VARIABLE_ErrSpecs_23_233, &STATE_VARIABLE_ErrSpecs_24_234);
  hlds__hlds_module__module_info_set_user_init_pred_target_names_3_p_0(InitPredTargetNames_111, STATE_VARIABLE_ModuleInfo_28_230, &STATE_VARIABLE_ModuleInfo_29_235);
  hlds__hlds_module__module_info_set_user_final_pred_target_names_3_p_0(FinalPredTargetNames_113, STATE_VARIABLE_ModuleInfo_29_235, &STATE_VARIABLE_ModuleInfo_30_236);
  hlds__make_hlds__add_pragma_decl__add_decl_pragmas_12_p_0(ProgressStream_16, DeclPragmas_68, STATE_VARIABLE_ModuleInfo_30_236, &STATE_VARIABLE_ModuleInfo_31_238, STATE_VARIABLE_QualInfo_4_214, &STATE_VARIABLE_QualInfo_5_239, STATE_VARIABLE_ErrSpecs_24_234, &STATE_VARIABLE_ErrSpecs_25_240, STATE_VARIABLE_WarnSpecs_15_232, &STATE_VARIABLE_WarnSpecs_16_241, (MR_Word) ((MR_Unsigned) 0U), &STATE_VARIABLE_InfoSpecs_2_242);
  hlds__make_hlds__add_pragma_decl__add_decl_pragmas_type_spec_constr_12_p_0(ProgressStream_16, DeclTypeSpecConstr_70, STATE_VARIABLE_ModuleInfo_31_238, &STATE_VARIABLE_ModuleInfo_32_243, STATE_VARIABLE_QualInfo_5_239, &STATE_VARIABLE_QualInfo_6_244, STATE_VARIABLE_ErrSpecs_25_240, &STATE_VARIABLE_ErrSpecs_26_245, STATE_VARIABLE_WarnSpecs_16_241, &STATE_VARIABLE_WarnSpecs_17_246, STATE_VARIABLE_InfoSpecs_2_242, STATE_VARIABLE_InfoSpecs_128);
  hlds__make_hlds__add_pragma_decl__add_decl_pragmas_type_spec_9_p_0(DeclTypeSpec_71, STATE_VARIABLE_ModuleInfo_32_243, &STATE_VARIABLE_ModuleInfo_33_248, STATE_VARIABLE_QualInfo_6_244, &STATE_VARIABLE_QualInfo_7_249, STATE_VARIABLE_ErrSpecs_26_245, &STATE_VARIABLE_ErrSpecs_27_250, STATE_VARIABLE_WarnSpecs_17_246, &STATE_VARIABLE_WarnSpecs_18_251);
  hlds__make_hlds__add_pragma_decl__add_decl_pragmas_input_spec_5_p_0(DeclInputSpec_72, STATE_VARIABLE_ModuleInfo_33_248, &STATE_VARIABLE_ModuleInfo_34_252, STATE_VARIABLE_ErrSpecs_27_250, &STATE_VARIABLE_ErrSpecs_28_253);
  hlds__make_hlds__add_pragma_decl__add_decl_pragmas_termination_5_p_0(DeclTermination_73, STATE_VARIABLE_ModuleInfo_34_252, &STATE_VARIABLE_ModuleInfo_35_254, STATE_VARIABLE_ErrSpecs_28_253, &STATE_VARIABLE_ErrSpecs_29_255);
  hlds__make_hlds__add_pragma_decl__add_decl_pragmas_termination2_5_p_0(DeclTermination2_74, STATE_VARIABLE_ModuleInfo_35_254, &STATE_VARIABLE_ModuleInfo_36_256, STATE_VARIABLE_ErrSpecs_29_255, &STATE_VARIABLE_ErrSpecs_30_257);
  hlds__make_hlds__add_pragma_decl__add_decl_pragmas_sharing_5_p_0(DeclSharing_75, STATE_VARIABLE_ModuleInfo_36_256, &STATE_VARIABLE_ModuleInfo_37_258, STATE_VARIABLE_ErrSpecs_30_257, &STATE_VARIABLE_ErrSpecs_31_259);
  hlds__make_hlds__add_pragma_decl__add_decl_pragmas_reuse_5_p_0(DeclReuse_76, STATE_VARIABLE_ModuleInfo_37_258, &STATE_VARIABLE_ModuleInfo_38_260, STATE_VARIABLE_ErrSpecs_31_259, &STATE_VARIABLE_ErrSpecs_32_261);
  Var_262 = mercury__cord__init_0_f_0((MR_Word) (&hlds__make_hlds__make_hlds_passes_scalar_common_1[6]));
  hlds__make_hlds__add_pragma_impl__add_impl_pragmas_10_p_0(ProgressStream_16, ImplPragmas_77, Var_262, &PragmaTabledCord_114, STATE_VARIABLE_ModuleInfo_38_260, &STATE_VARIABLE_ModuleInfo_39_263, STATE_VARIABLE_ErrSpecs_32_261, &STATE_VARIABLE_ErrSpecs_33_264, STATE_VARIABLE_WarnSpecs_18_251, &STATE_VARIABLE_WarnSpecs_19_265);
  ...
  hlds__make_hlds__add_pragma_impl__add_impl_pragmas_tabled_10_p_0(ProgressStream_16, PragmasTabled_115, STATE_VARIABLE_ModuleInfo_39_263, &STATE_VARIABLE_ModuleInfo_40_266, STATE_VARIABLE_QualInfo_7_249, &STATE_VARIABLE_QualInfo_8_267, STATE_VARIABLE_ErrSpecs_33_264, &STATE_VARIABLE_ErrSpecs_34_268, STATE_VARIABLE_WarnSpecs_19_265, STATE_VARIABLE_WarnSpecs_127);
  ...
  mercury__list__foldl2_6_p_0((MR_Word) (&parse_tree__prog_item_pragma__parse_tree__prog_item_pragma__type_ctor_info_impl_pragma_fproc_export_info_0), (MR_Word) (&hlds__hlds_module__hlds__hlds_module__type_ctor_info_module_info_0), (MR_Word) (&hlds__make_hlds__make_hlds_passes_scalar_common_1[4]), (MR_Word) (&hlds__make_hlds__make_hlds_passes_scalar_common_2[7]), FPEInfos_116, ((MR_Box) (STATE_VARIABLE_ModuleInfo_40_266)), &conv13_STATE_VARIABLE_ModuleInfo_41_271, ((MR_Box) (STATE_VARIABLE_ErrSpecs_34_268)), &conv12_STATE_VARIABLE_ErrSpecs_35_272);
  STATE_VARIABLE_ModuleInfo_41_271 = ((MR_Word) (conv13_STATE_VARIABLE_ModuleInfo_41_271));
  STATE_VARIABLE_ErrSpecs_35_272 = ((MR_Word) (conv12_STATE_VARIABLE_ErrSpecs_35_272));
  mercury__list__foldl_4_p_0((MR_Word) (&parse_tree__prog_foreign__parse_tree__prog_foreign__type_ctor_info_foreign_decl_code_0), (MR_Word) (&hlds__hlds_module__hlds__hlds_module__type_ctor_info_module_info_0), (MR_Word) (&hlds__make_hlds__make_hlds_passes_scalar_common_2[8]), MutableForeignDeclCodes_105, ((MR_Box) (STATE_VARIABLE_ModuleInfo_41_271)), &conv15_STATE_VARIABLE_ModuleInfo_42_274);
  STATE_VARIABLE_ModuleInfo_42_274 = ((MR_Word) (conv15_STATE_VARIABLE_ModuleInfo_42_274));
  mercury__list__foldl_4_p_0((MR_Word) (&parse_tree__prog_foreign__parse_tree__prog_foreign__type_ctor_info_foreign_body_code_0), (MR_Word) (&hlds__hlds_module__hlds__hlds_module__type_ctor_info_module_info_0), (MR_Word) (&hlds__make_hlds__make_hlds_passes_scalar_common_2[9]), MutableForeignBodyCodes_106, ((MR_Box) (STATE_VARIABLE_ModuleInfo_42_274)), &conv17_STATE_VARIABLE_ModuleInfo_43_276);
  STATE_VARIABLE_ModuleInfo_43_276 = ((MR_Word) (conv17_STATE_VARIABLE_ModuleInfo_43_276));
  mercury__list__foldl2_6_p_0((MR_Word) (&parse_tree__prog_item_pragma__parse_tree__prog_item_pragma__type_ctor_info_gen_pragma_unused_args_info_0), (MR_Word) (&hlds__hlds_module__hlds__hlds_module__type_ctor_info_module_info_0), (MR_Word) (&hlds__make_hlds__make_hlds_passes_scalar_common_1[4]), (MR_Word) (&hlds__make_hlds__make_hlds_passes_scalar_common_2[10]), GenUnusedArgs_79, ((MR_Box) (STATE_VARIABLE_ModuleInfo_43_276)), &conv21_STATE_VARIABLE_ModuleInfo_44_278, ((MR_Box) (STATE_VARIABLE_ErrSpecs_35_272)), &conv20_STATE_VARIABLE_ErrSpecs_36_279);
  STATE_VARIABLE_ModuleInfo_44_278 = ((MR_Word) (conv21_STATE_VARIABLE_ModuleInfo_44_278));
  STATE_VARIABLE_ErrSpecs_36_279 = ((MR_Word) (conv20_STATE_VARIABLE_ErrSpecs_36_279));
  mercury__list__foldl2_6_p_0((MR_Word) (&parse_tree__prog_item_pragma__parse_tree__prog_item_pragma__type_ctor_info_gen_pragma_exceptions_info_0), (MR_Word) (&hlds__hlds_module__hlds__hlds_module__type_ctor_info_module_info_0), (MR_Word) (&hlds__make_hlds__make_hlds_passes_scalar_common_1[4]), (MR_Word) (&hlds__make_hlds__make_hlds_passes_scalar_common_2[11]), GenExceptions_80, ((MR_Box) (STATE_VARIABLE_ModuleInfo_44_278)), &conv25_STATE_VARIABLE_ModuleInfo_45_281, ((MR_Box) (STATE_VARIABLE_ErrSpecs_36_279)), &conv24_STATE_VARIABLE_ErrSpecs_37_282);
  STATE_VARIABLE_ModuleInfo_45_281 = ((MR_Word) (conv25_STATE_VARIABLE_ModuleInfo_45_281));
  STATE_VARIABLE_ErrSpecs_37_282 = ((MR_Word) (conv24_STATE_VARIABLE_ErrSpecs_37_282));
  mercury__list__foldl2_6_p_0((MR_Word) (&parse_tree__prog_item_pragma__parse_tree__prog_item_pragma__type_ctor_info_gen_pragma_trailing_info_0), (MR_Word) (&hlds__hlds_module__hlds__hlds_module__type_ctor_info_module_info_0), (MR_Word) (&hlds__make_hlds__make_hlds_passes_scalar_common_1[4]), (MR_Word) (&hlds__make_hlds__make_hlds_passes_scalar_common_2[12]), GenTrailing_81, ((MR_Box) (STATE_VARIABLE_ModuleInfo_45_281)), &conv29_STATE_VARIABLE_ModuleInfo_46_284, ((MR_Box) (STATE_VARIABLE_ErrSpecs_37_282)), &conv28_STATE_VARIABLE_ErrSpecs_38_285);
  STATE_VARIABLE_ModuleInfo_46_284 = ((MR_Word) (conv29_STATE_VARIABLE_ModuleInfo_46_284));
  STATE_VARIABLE_ErrSpecs_38_285 = ((MR_Word) (conv28_STATE_VARIABLE_ErrSpecs_38_285));
  mercury__list__foldl2_6_p_0((MR_Word) (&parse_tree__prog_item_pragma__parse_tree__prog_item_pragma__type_ctor_info_gen_pragma_mm_tabling_info_0), (MR_Word) (&hlds__hlds_module__hlds__hlds_module__type_ctor_info_module_info_0), (MR_Word) (&hlds__make_hlds__make_hlds_passes_scalar_common_1[4]), (MR_Word) (&hlds__make_hlds__make_hlds_passes_scalar_common_2[13]), GenMMTabling_82, ((MR_Box) (STATE_VARIABLE_ModuleInfo_46_284)), &conv33_STATE_VARIABLE_ModuleInfo_123, ((MR_Box) (STATE_VARIABLE_ErrSpecs_38_285)), &conv32_STATE_VARIABLE_ErrSpecs_39_288);
  *STATE_VARIABLE_ModuleInfo_123 = ((MR_Word) (conv33_STATE_VARIABLE_ModuleInfo_123));
  STATE_VARIABLE_ErrSpecs_39_288 = ((MR_Word) (conv32_STATE_VARIABLE_ErrSpecs_39_288));
  hlds__make_hlds__check_field_access_functions__check_preds_if_field_access_function_4_p_0(*STATE_VARIABLE_ModuleInfo_123, PredDecls_56, STATE_VARIABLE_ErrSpecs_39_288, &STATE_VARIABLE_ErrSpecs_40_289);
  ModuleItemVersionNumbers_117 = ((MR_Word) ((MR_hl_field(0, AugCompUnit_17, 8))));
  mercury__map__foldl_4_p_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), (MR_Word) (&recompilation__item_types__recompilation__item_types__type_ctor_info_module_item_version_numbers_0), (MR_Word) (&hlds__make_hlds__qual_info__hlds__make_hlds__qual_info__type_ctor_info_qual_info_0), (MR_Word) (&hlds__make_hlds__make_hlds_passes_scalar_common_2[14]), ModuleItemVersionNumbers_117, ((MR_Box) (STATE_VARIABLE_QualInfo_8_267)), &conv35_STATE_VARIABLE_QualInfo_122);
  *STATE_VARIABLE_QualInfo_122 = ((MR_Word) (conv35_STATE_VARIABLE_QualInfo_122));
  hlds__make_hlds__qual_info__qual_info_get_mq_info_2_p_0(*STATE_VARIABLE_QualInfo_122, &MQInfo_118);
  parse_tree__module_qual__mq_info__get_err_specs_in_mq_info_4_p_0(MQInfo_118, &MQInvalidTypeSpecs_119, &MQInvalidInstModeSpecs_120, &MQNonBlockingUndefSpecs_121);
  *STATE_VARIABLE_InvalidTypeSpecs_124 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_err_spec_0), MQInvalidTypeSpecs_119, STATE_VARIABLE_InvalidTypeSpecs_5_180);
  *STATE_VARIABLE_InvalidInstModeSpecs_125 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_err_spec_0), MQInvalidInstModeSpecs_120, STATE_VARIABLE_InvalidInstModeSpecs_3_177);
  *STATE_VARIABLE_ErrSpecs_126 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_err_spec_0), MQNonBlockingUndefSpecs_121, STATE_VARIABLE_ErrSpecs_40_289);
}
