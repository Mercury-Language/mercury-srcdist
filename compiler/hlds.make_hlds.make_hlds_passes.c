    ...
    else
    {
      ...
      if ((Var_121 == (MR_Word) ((MR_Unsigned) 0U)))
      {
        ...
        else
        {
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(1), Pieces_113, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__make_hlds_passes_scalar_common_1[68])));
      ...
      else
      {
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(1), Pieces_119, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__make_hlds_passes_scalar_common_1[68])));
    ...
    else
    {
      ...
      if ((Var_106 == (MR_Word) ((MR_Unsigned) 0U)))
      {
        ...
        else
        {
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(1), Pieces_98, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__make_hlds_passes_scalar_common_1[68])));
      ...
      else
      {
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(1), Pieces_104, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__make_hlds__make_hlds_passes_scalar_common_1[68])));
...
{
  {
    ...
    if (succeeded)
    {
      ...
      Var_41 = parse_tree__prog_out__pred_or_func_to_full_str_1_f_0(PredOrFunc_15);
      {
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(1), Pieces_23, 1) = ((MR_Box) (Var_39));
      }
      {
        ...
        MR_hl_field(MR_mktag(1), Spec_24, 2) = ((MR_Box) (Context_20));
      ...
      *STATE_VARIABLE_QualInfo_34 = STATE_VARIABLE_QualInfo_0_33;
    ...
    else
    {
      ...
      if (((MR_tag((MR_Word) ItemMercuryStatus_12)) == (MR_Integer) 1))
        STATE_VARIABLE_Specs_54_54 = STATE_VARIABLE_Specs_0_35;
      else
      {
        MR_Word ItemExport_25 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), ItemMercuryStatus_12, (MR_Integer) 0))) & (MR_Integer) 3);

        switch (ItemExport_25) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 2:
            if ((Origin_17 == (MR_Word) ((MR_Unsigned) 0U)))
            {
              MR_Integer Arity_26;
              MR_String ClauseId_27;
              MR_Word Var_51;
              MR_Word Var_52;
              MR_Word Var_53;
              MR_Word Var_55;
              ...
              mercury__list__length_2_p_0((MR_Word) (&hlds__make_hlds__make_hlds_passes_scalar_common_1[19]), Args_16, &Arity_26);
              {
                Var_52 = (MR_Word) MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL);
                MR_hl_field(MR_mktag(0), Var_52, 0) = ((MR_Box) (PredName_22));
              }
              {
                Var_51 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
                MR_hl_field(MR_mktag(0), Var_51, 0) = ((MR_Box) (Var_52));
                MR_hl_field(MR_mktag(0), Var_51, 1) = ((MR_Box) (Arity_26));
              }
              ClauseId_27 = parse_tree__prog_out__simple_call_id_to_string_2_f_0(PredOrFunc_15, Var_51);
              Var_56 = mercury__string__f_43_43_2_f_0((MR_String) "clause for ", ClauseId_27);
              {
                Var_55 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              ...
              hlds__make_hlds_error__error_is_exported_4_p_0(Context_20, Var_53, STATE_VARIABLE_Specs_0_35, &STATE_VARIABLE_Specs_54_54);
            }
            else
              STATE_VARIABLE_Specs_54_54 = STATE_VARIABLE_Specs_0_35;
            break;
      ...
      hlds__status__item_mercury_status_to_pred_status_2_p_0(ItemMercuryStatus_12, &PredStatus_30);
      {
        Var_59 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), Var_59, 0) = ((MR_Box) (SeqNum_21));
      }
      hlds__make_hlds__add_clause__module_add_clause_15_p_0(VarSet_18, PredOrFunc_15, PredSymName_14, Args_16, MaybeBodyGoal_19, PredStatus_30, Context_20, Var_59, (MR_Word) ((MR_Unsigned) 12U), STATE_VARIABLE_ModuleInfo_0_31, STATE_VARIABLE_ModuleInfo_32, STATE_VARIABLE_QualInfo_0_33, STATE_VARIABLE_QualInfo_34, STATE_VARIABLE_Specs_54_54, STATE_VARIABLE_Specs_36);
    }
  }
}
  ...
  MR_Box * wrapper_arg_7)
{
  {
    MR_Box closure = closure_arg;
    MR_Word conv86_STATE_VARIABLE_ModuleInfo_32;
    MR_Word conv85_STATE_VARIABLE_QualInfo_34;
    MR_Word conv84_STATE_VARIABLE_Specs_36;

    hlds__make_hlds__make_hlds_passes__add_clause_7_p_0(((MR_Word) (wrapper_arg_1)), ((MR_Word) (wrapper_arg_2)), &conv86_STATE_VARIABLE_ModuleInfo_32, ((MR_Word) (wrapper_arg_4)), &conv85_STATE_VARIABLE_QualInfo_34, ((MR_Word) (wrapper_arg_6)), &conv84_STATE_VARIABLE_Specs_36);
    *wrapper_arg_3 = ((MR_Box) (conv86_STATE_VARIABLE_ModuleInfo_32));
    *wrapper_arg_5 = ((MR_Box) (conv85_STATE_VARIABLE_QualInfo_34));
    *wrapper_arg_7 = ((MR_Box) (conv84_STATE_VARIABLE_Specs_36));
  }
}
