...
hlds__make_hlds__make_hlds_passes__IntroducedFrom__pred__parse_tree_to_hlds__174__1_1_p_0(
  MR_Word LambdaHeadVar__1_137);

static MR_bool MR_CALL 
hlds__make_hlds__make_hlds_passes__IntroducedFrom__pred__parse_tree_to_hlds__169__1_1_p_0(
...
{
  MR_bool succeeded;
  MR_Word Var_138 = (MR_Word) (LambdaHeadVar__1_137);
  MR_Word Phase_291;

  parse_tree__error_spec__extract_spec_phase_2_p_0(Var_138, &Phase_291);
  succeeded = (Phase_291 == (MR_Word) ((MR_Unsigned) 36U));
  return succeeded;
}
  ...
  MR_Word LambdaHeadVar__1_135)
{
  MR_bool succeeded;
  MR_Word Phase_46;
  MR_Word Var_136 = (MR_Word) (LambdaHeadVar__1_135);

  parse_tree__error_spec__extract_spec_phase_2_p_0(Var_136, &Phase_46);
  ...
  MR_Box wrapper_arg_1)
{
  ...
  succeeded = hlds__make_hlds__make_hlds_passes__IntroducedFrom__pred__parse_tree_to_hlds__174__1_1_p_0(((MR_Word) (wrapper_arg_1)));
  return succeeded;
}
  ...
  MR_Box wrapper_arg_1)
{
  ...
  succeeded = hlds__make_hlds__make_hlds_passes__IntroducedFrom__pred__parse_tree_to_hlds__169__1_1_p_0(((MR_Word) (wrapper_arg_1)));
  return succeeded;
}
...
hlds__make_hlds__make_hlds_passes__parse_tree_to_hlds_15_p_0(
  ...
  MR_Word * STATE_VARIABLE_QualInfo_119,
  MR_Word * STATE_VARIABLE_ModuleInfo_120,
  MR_Word * STATE_VARIABLE_InvalidTypeSpecs_121,
  MR_Word * STATE_VARIABLE_InvalidInstModeSpecs_122,
  MR_Word * STATE_VARIABLE_ErrSpecs_123,
  MR_Word * STATE_VARIABLE_WarnSpecs_124,
  MR_Word * STATE_VARIABLE_InfoSpecs_125)
{
  MR_bool succeeded;
  ...
  MR_Word Initialises_61;
  MR_Word Finalises_62;
  MR_Word Mutables_63;
  MR_Word TypeRepnMap_64;
  MR_Word ForeignEnums_65;
  MR_Word ForeignExportEnums_66;
  MR_Word DeclPragmas_67;
  MR_Word DeclMarkers_68;
  MR_Word DeclTypeSpecConstr_69;
  MR_Word DeclTypeSpec_70;
  MR_Word DeclTermination_71;
  MR_Word DeclTermination2_72;
  MR_Word DeclSharing_73;
  MR_Word DeclReuse_74;
  MR_Word ImplPragmas_75;
  MR_Word ImplMarkers_76;
  MR_Word GenUnusedArgs_77;
  MR_Word GenExceptions_78;
  MR_Word GenTrailing_79;
  MR_Word GenMMTabling_80;
  MR_Word Clauses_81;
  MR_Word ForeignProcs_82;
  MR_Word IntBadClauses_83;
  MR_Word DirectArgMap_84;
  MR_Word TypeRepnDec_85;
  MR_Word SolverPredDecls_89;
  MR_Word SolverForeignProcs_90;
  MR_Word SolverMutables_91;
  MR_Word InvalidTypesSoFar_92;
  MR_Word AllMutables_94;
  MR_Word InitPredTargetNames0_95;
  MR_Word MQUndefInstSpecs0_96;
  MR_Word MQUndefInstsSet0_97;
  MR_Word MQUndefInsts0_98;
  MR_Word MutablePredDecls_99;
  MR_Word MutableClauses_100;
  MR_Word MutableForeignProcs_101;
  MR_Word MutableForeignDeclCodes_102;
  MR_Word MutableForeignBodyCodes_103;
  MR_Word FPEInfosCord1_104;
  MR_Word InitPredTargetNames1_105;
  MR_Word FinalPredTargetNames1_106;
  MR_Word FPEInfosCord2_107;
  MR_Word InitPredTargetNames_108;
  MR_Word FPEInfosCord_109;
  MR_Word FinalPredTargetNames_110;
  MR_Word PragmaTabledCord_111;
  MR_Word PragmasTabled_112;
  MR_Word FPEInfos_113;
  MR_Word ModuleItemVersionNumbers_114;
  MR_Word MQInfo_115;
  MR_Word MQInvalidTypeSpecs_116;
  MR_Word MQInvalidInstModeSpecs_117;
  MR_Word MQNonBlockingUndefSpecs_118;
  MR_Word STATE_VARIABLE_WarnSpecs_1_126;
  MR_Word STATE_VARIABLE_ErrSpecs_1_132;
  MR_Word STATE_VARIABLE_WarnSpecs_2_133;
  MR_Word Var_134;
  MR_Word STATE_VARIABLE_InvalidTypeSpecs_1_139;
  MR_Word STATE_VARIABLE_InvalidInstModeSpecs_1_140;
  MR_Word STATE_VARIABLE_ModuleInfo_1_142;
  MR_Word STATE_VARIABLE_ModuleInfo_2_143;
  MR_Word STATE_VARIABLE_SolverPredDeclCord_1_144;
  MR_Word STATE_VARIABLE_SolverForeignProcCord_1_145;
  MR_Word STATE_VARIABLE_SolverMutableCord_1_146;
  MR_Word STATE_VARIABLE_ModuleInfo_3_147;
  MR_Word STATE_VARIABLE_SolverPredDeclCord_2_148;
  MR_Word STATE_VARIABLE_SolverForeignProcCord_2_149;
  MR_Word STATE_VARIABLE_SolverMutableCord_2_150;
  MR_Word STATE_VARIABLE_InvalidTypeSpecs_2_151;
  MR_Word STATE_VARIABLE_ErrSpecs_2_152;
  MR_Word STATE_VARIABLE_WarnSpecs_3_153;
  MR_Word STATE_VARIABLE_ModuleInfo_4_154;
  MR_Word STATE_VARIABLE_SolverPredDeclCord_3_155;
  MR_Word STATE_VARIABLE_SolverForeignProcCord_3_156;
  MR_Word STATE_VARIABLE_SolverMutableCord_3_157;
  MR_Word STATE_VARIABLE_InvalidTypeSpecs_3_158;
  MR_Word STATE_VARIABLE_ErrSpecs_3_159;
  MR_Word STATE_VARIABLE_WarnSpecs_4_160;
  MR_Word STATE_VARIABLE_ModuleInfo_5_161;
  MR_Word STATE_VARIABLE_SolverPredDeclCord_4_162;
  MR_Word STATE_VARIABLE_SolverForeignProcCord_4_163;
  MR_Word STATE_VARIABLE_SolverMutableCord_4_164;
  MR_Word STATE_VARIABLE_InvalidTypeSpecs_4_165;
  MR_Word STATE_VARIABLE_ErrSpecs_4_166;
  MR_Word STATE_VARIABLE_WarnSpecs_5_167;
  MR_Word STATE_VARIABLE_ModuleInfo_6_168;
  MR_Word STATE_VARIABLE_ErrSpecs_5_169;
  MR_Word STATE_VARIABLE_WarnSpecs_6_170;
  MR_Word STATE_VARIABLE_InvalidInstModeSpecs_2_171;
  MR_Word STATE_VARIABLE_ModuleInfo_7_172;
  MR_Word STATE_VARIABLE_ErrSpecs_6_173;
  MR_Word STATE_VARIABLE_InvalidInstModeSpecs_3_174;
  MR_Word Var_175;
  MR_Word STATE_VARIABLE_ModuleInfo_8_177;
  MR_Word STATE_VARIABLE_InvalidTypeSpecs_5_178;
  MR_Word STATE_VARIABLE_WarnSpecs_7_179;
  MR_Word STATE_VARIABLE_ModuleInfo_9_180;
  MR_Word STATE_VARIABLE_ErrSpecs_7_181;
  MR_Word STATE_VARIABLE_ModuleInfo_10_182;
  MR_Word STATE_VARIABLE_ErrSpecs_8_183;
  MR_Word STATE_VARIABLE_ModuleInfo_11_184;
  MR_Word STATE_VARIABLE_ErrSpecs_9_185;
  MR_Word STATE_VARIABLE_ErrSpecs_10_186;
  MR_Word STATE_VARIABLE_ModuleInfo_12_187;
  MR_Word STATE_VARIABLE_ErrSpecs_11_188;
  MR_Word STATE_VARIABLE_ModuleInfo_13_189;
  MR_Word STATE_VARIABLE_ErrSpecs_12_190;
  MR_Word STATE_VARIABLE_ModuleInfo_14_191;
  MR_Word STATE_VARIABLE_ModuleInfo_15_192;
  MR_Word STATE_VARIABLE_ErrSpecs_13_193;
  MR_Word STATE_VARIABLE_ModuleInfo_16_195;
  MR_Word STATE_VARIABLE_ModuleInfo_17_198;
  MR_Word STATE_VARIABLE_ModuleInfo_18_199;
  MR_Word STATE_VARIABLE_QualInfo_1_200;
  MR_Word STATE_VARIABLE_ModuleInfo_19_201;
  MR_Word STATE_VARIABLE_QualInfo_2_202;
  MR_Word STATE_VARIABLE_ErrSpecs_14_203;
  MR_Word STATE_VARIABLE_WarnSpecs_8_204;
  MR_Word STATE_VARIABLE_ModuleInfo_20_205;
  MR_Word STATE_VARIABLE_QualInfo_3_206;
  MR_Word STATE_VARIABLE_ErrSpecs_15_207;
  MR_Word STATE_VARIABLE_WarnSpecs_9_208;
  MR_Word STATE_VARIABLE_ModuleInfo_21_209;
  MR_Word STATE_VARIABLE_QualInfo_4_210;
  MR_Word STATE_VARIABLE_ErrSpecs_16_211;
  MR_Word STATE_VARIABLE_WarnSpecs_10_212;
  MR_Word STATE_VARIABLE_ModuleInfo_22_213;
  MR_Word STATE_VARIABLE_ModuleInfo_23_214;
  MR_Word STATE_VARIABLE_ErrSpecs_17_215;
  MR_Word STATE_VARIABLE_WarnSpecs_11_216;
  MR_Word STATE_VARIABLE_ModuleInfo_24_217;
  MR_Word STATE_VARIABLE_ErrSpecs_18_218;
  MR_Word STATE_VARIABLE_WarnSpecs_12_219;
  MR_Word STATE_VARIABLE_ModuleInfo_25_220;
  MR_Word STATE_VARIABLE_ErrSpecs_19_221;
  MR_Word STATE_VARIABLE_WarnSpecs_13_222;
  MR_Word STATE_VARIABLE_ModuleInfo_26_223;
  MR_Word STATE_VARIABLE_ErrSpecs_20_224;
  MR_Word STATE_VARIABLE_WarnSpecs_14_225;
  MR_Word STATE_VARIABLE_ModuleInfo_27_226;
  MR_Word STATE_VARIABLE_ErrSpecs_21_227;
  MR_Word STATE_VARIABLE_WarnSpecs_15_228;
  MR_Word STATE_VARIABLE_ErrSpecs_22_229;
  MR_Word STATE_VARIABLE_ErrSpecs_23_230;
  MR_Word STATE_VARIABLE_ModuleInfo_28_231;
  MR_Word STATE_VARIABLE_ModuleInfo_29_232;
  MR_Word STATE_VARIABLE_ModuleInfo_30_234;
  MR_Word STATE_VARIABLE_QualInfo_5_235;
  MR_Word STATE_VARIABLE_ErrSpecs_24_236;
  MR_Word STATE_VARIABLE_WarnSpecs_16_237;
  MR_Word STATE_VARIABLE_InfoSpecs_2_238;
  MR_Word STATE_VARIABLE_ModuleInfo_31_239;
  MR_Word STATE_VARIABLE_QualInfo_6_240;
  MR_Word STATE_VARIABLE_ErrSpecs_25_241;
  MR_Word STATE_VARIABLE_WarnSpecs_17_242;
  MR_Word STATE_VARIABLE_ModuleInfo_32_244;
  MR_Word STATE_VARIABLE_QualInfo_7_245;
  MR_Word STATE_VARIABLE_ErrSpecs_26_246;
  MR_Word STATE_VARIABLE_WarnSpecs_18_247;
  MR_Word STATE_VARIABLE_ModuleInfo_33_248;
  MR_Word STATE_VARIABLE_ErrSpecs_27_249;
  MR_Word STATE_VARIABLE_ModuleInfo_34_250;
  MR_Word STATE_VARIABLE_ErrSpecs_28_251;
  MR_Word STATE_VARIABLE_ModuleInfo_35_252;
  MR_Word STATE_VARIABLE_ErrSpecs_29_253;
  MR_Word STATE_VARIABLE_ModuleInfo_36_254;
  MR_Word STATE_VARIABLE_ErrSpecs_30_255;
  MR_Word Var_256;
  MR_Word STATE_VARIABLE_ModuleInfo_37_257;
  MR_Word STATE_VARIABLE_ErrSpecs_31_258;
  MR_Word STATE_VARIABLE_WarnSpecs_19_259;
  MR_Word STATE_VARIABLE_ModuleInfo_38_260;
  MR_Word STATE_VARIABLE_QualInfo_8_261;
  MR_Word STATE_VARIABLE_ErrSpecs_32_262;
  MR_Word STATE_VARIABLE_ModuleInfo_39_265;
  MR_Word STATE_VARIABLE_ErrSpecs_33_266;
  MR_Word STATE_VARIABLE_ModuleInfo_40_268;
  MR_Word STATE_VARIABLE_ModuleInfo_41_270;
  MR_Word STATE_VARIABLE_ModuleInfo_42_272;
  MR_Word STATE_VARIABLE_ErrSpecs_34_273;
  MR_Word STATE_VARIABLE_ModuleInfo_43_275;
  MR_Word STATE_VARIABLE_ErrSpecs_35_276;
  MR_Word STATE_VARIABLE_ModuleInfo_44_278;
  MR_Word STATE_VARIABLE_ErrSpecs_36_279;
  MR_Word STATE_VARIABLE_ErrSpecs_37_282;
  MR_Word STATE_VARIABLE_ErrSpecs_38_283;
  MR_Box conv7_STATE_VARIABLE_ModuleInfo_16_195;
  MR_Word Var_605;
  MR_Box conv13_STATE_VARIABLE_ModuleInfo_39_265;
  MR_Box conv12_STATE_VARIABLE_ErrSpecs_33_266;
  MR_Box conv15_STATE_VARIABLE_ModuleInfo_40_268;
  MR_Box conv17_STATE_VARIABLE_ModuleInfo_41_270;
  MR_Box conv21_STATE_VARIABLE_ModuleInfo_42_272;
  MR_Box conv20_STATE_VARIABLE_ErrSpecs_34_273;
  MR_Box conv25_STATE_VARIABLE_ModuleInfo_43_275;
  MR_Box conv24_STATE_VARIABLE_ErrSpecs_35_276;
  MR_Box conv29_STATE_VARIABLE_ModuleInfo_44_278;
  MR_Box conv28_STATE_VARIABLE_ErrSpecs_36_279;
  MR_Box conv33_STATE_VARIABLE_ModuleInfo_120;
  MR_Box conv32_STATE_VARIABLE_ErrSpecs_37_282;
  MR_Box conv35_STATE_VARIABLE_QualInfo_119;

  hlds__make_hlds__make_hlds_passes__maybe_warn_include_and_non_include_3_p_0(Globals_18, ParseTreeModuleSrc_31, &STATE_VARIABLE_WarnSpecs_1_126);
  ...
  STATE_VARIABLE_ErrSpecs_1_132 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_err_spec_0), TypeErrSpecs_40, InstModeErrSpecs_42);
  Var_134 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_warn_spec_0), InstModeWarnSpecs_43, STATE_VARIABLE_WarnSpecs_1_126);
  STATE_VARIABLE_WarnSpecs_2_133 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_warn_spec_0), TypeWarnSpecs_41, Var_134);
  mercury__list__filter_3_p_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_err_spec_0), (MR_Word) (&hlds__make_hlds__make_hlds_passes_scalar_common_2[3]), TypeErrSpecs_40, &STATE_VARIABLE_InvalidTypeSpecs_1_139);
  mercury__list__filter_3_p_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_err_spec_0), (MR_Word) (&hlds__make_hlds__make_hlds_passes_scalar_common_2[4]), InstModeErrSpecs_42, &STATE_VARIABLE_InvalidInstModeSpecs_1_140);
  hlds__make_hlds__make_hlds_separate_items__separate_items_in_aug_comp_unit_37_p_0(AugCompUnit_17, &InclMap_48, &Avails_49, &FIMs_50, &TypeDefnsAbstract_51, &TypeDefnsMercury_52, &TypeDefnsForeign_53, &InstDefns_54, &ModeDefns_55, &PredDecls_56, &ModeDecls_57, &Promises_58, &Typeclasses_59, &Instances_60, &Initialises_61, &Finalises_62, &Mutables_63, &TypeRepnMap_64, &ForeignEnums_65, &ForeignExportEnums_66, &DeclPragmas_67, &DeclMarkers_68, &DeclTypeSpecConstr_69, &DeclTypeSpec_70, &DeclTermination_71, &DeclTermination2_72, &DeclSharing_73, &DeclReuse_74, &ImplPragmas_75, &ImplMarkers_76, &GenUnusedArgs_77, &GenExceptions_78, &GenTrailing_79, &GenMMTabling_80, &Clauses_81, &ForeignProcs_82, &IntBadClauses_83);
  mercury__map__init_1_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_type_ctor_0), (MR_Word) (&hlds__make_hlds__make_hlds_passes_scalar_common_1[0]), &DirectArgMap_84);
  {
    TypeRepnDec_85 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(0, TypeRepnDec_85, 0) = ((MR_Box) (TypeRepnMap_64));
    MR_hl_field(0, TypeRepnDec_85, 1) = ((MR_Box) (DirectArgMap_84));
    MR_hl_field(0, TypeRepnDec_85, 2) = ((MR_Box) (ForeignEnums_65));
    MR_hl_field(0, TypeRepnDec_85, 3) = ((MR_Box) (ForeignExportEnums_66));
  }
  hlds__hlds_module__module_info_init_12_p_0(Globals_18, ModuleName_32, ModuleNameContext_33, DumpBaseFileName_19, InclMap_48, UsedEqvModules_22, ImplicitlyUsedModules_34, UnusedInterfaceImports_23, PQInfo_35, (MR_Word) ((MR_Unsigned) 0U), TypeRepnDec_85, &STATE_VARIABLE_ModuleInfo_1_142);
  hlds__make_hlds__make_hlds_passes__add_item_avails_3_p_0(Avails_49, STATE_VARIABLE_ModuleInfo_1_142, &STATE_VARIABLE_ModuleInfo_2_143);
  STATE_VARIABLE_SolverPredDeclCord_1_144 = mercury__cord__init_0_f_0((MR_Word) (&hlds__make_hlds__make_hlds_passes_scalar_common_1[1]));
  STATE_VARIABLE_SolverForeignProcCord_1_145 = mercury__cord__init_0_f_0((MR_Word) (&hlds__make_hlds__make_hlds_passes_scalar_common_1[2]));
  STATE_VARIABLE_SolverMutableCord_1_146 = mercury__cord__init_0_f_0((MR_Word) (&hlds__make_hlds__make_hlds_passes_scalar_common_1[3]));
  hlds__make_hlds__make_hlds_passes__add_type_defns_15_p_0(TypeDefnsAbstract_51, STATE_VARIABLE_ModuleInfo_2_143, &STATE_VARIABLE_ModuleInfo_3_147, STATE_VARIABLE_SolverPredDeclCord_1_144, &STATE_VARIABLE_SolverPredDeclCord_2_148, STATE_VARIABLE_SolverForeignProcCord_1_145, &STATE_VARIABLE_SolverForeignProcCord_2_149, STATE_VARIABLE_SolverMutableCord_1_146, &STATE_VARIABLE_SolverMutableCord_2_150, STATE_VARIABLE_InvalidTypeSpecs_1_139, &STATE_VARIABLE_InvalidTypeSpecs_2_151, STATE_VARIABLE_ErrSpecs_1_132, &STATE_VARIABLE_ErrSpecs_2_152, STATE_VARIABLE_WarnSpecs_2_133, &STATE_VARIABLE_WarnSpecs_3_153);
  hlds__make_hlds__make_hlds_passes__add_type_defns_15_p_0(TypeDefnsMercury_52, STATE_VARIABLE_ModuleInfo_3_147, &STATE_VARIABLE_ModuleInfo_4_154, STATE_VARIABLE_SolverPredDeclCord_2_148, &STATE_VARIABLE_SolverPredDeclCord_3_155, STATE_VARIABLE_SolverForeignProcCord_2_149, &STATE_VARIABLE_SolverForeignProcCord_3_156, STATE_VARIABLE_SolverMutableCord_2_150, &STATE_VARIABLE_SolverMutableCord_3_157, STATE_VARIABLE_InvalidTypeSpecs_2_151, &STATE_VARIABLE_InvalidTypeSpecs_3_158, STATE_VARIABLE_ErrSpecs_2_152, &STATE_VARIABLE_ErrSpecs_3_159, STATE_VARIABLE_WarnSpecs_3_153, &STATE_VARIABLE_WarnSpecs_4_160);
  hlds__make_hlds__make_hlds_passes__add_type_defns_15_p_0(TypeDefnsForeign_53, STATE_VARIABLE_ModuleInfo_4_154, &STATE_VARIABLE_ModuleInfo_5_161, STATE_VARIABLE_SolverPredDeclCord_3_155, &STATE_VARIABLE_SolverPredDeclCord_4_162, STATE_VARIABLE_SolverForeignProcCord_3_156, &STATE_VARIABLE_SolverForeignProcCord_4_163, STATE_VARIABLE_SolverMutableCord_3_157, &STATE_VARIABLE_SolverMutableCord_4_164, STATE_VARIABLE_InvalidTypeSpecs_3_158, &STATE_VARIABLE_InvalidTypeSpecs_4_165, STATE_VARIABLE_ErrSpecs_3_159, &STATE_VARIABLE_ErrSpecs_4_166, STATE_VARIABLE_WarnSpecs_4_160, &STATE_VARIABLE_WarnSpecs_5_167);
  SolverPredDecls_89 = mercury__cord__list_1_f_0((MR_Word) (&hlds__make_hlds__make_hlds_passes_scalar_common_1[1]), STATE_VARIABLE_SolverPredDeclCord_4_162);
  SolverForeignProcs_90 = mercury__cord__list_1_f_0((MR_Word) (&hlds__make_hlds__make_hlds_passes_scalar_common_1[2]), STATE_VARIABLE_SolverForeignProcCord_4_163);
  SolverMutables_91 = mercury__cord__list_1_f_0((MR_Word) (&hlds__make_hlds__make_hlds_passes_scalar_common_1[3]), STATE_VARIABLE_SolverMutableCord_4_164);
  hlds__make_hlds__make_hlds_passes__add_inst_defns_7_p_0(InstDefns_54, STATE_VARIABLE_ModuleInfo_5_161, &STATE_VARIABLE_ModuleInfo_6_168, STATE_VARIABLE_ErrSpecs_4_166, &STATE_VARIABLE_ErrSpecs_5_169, STATE_VARIABLE_WarnSpecs_5_167, &STATE_VARIABLE_WarnSpecs_6_170);
  hlds__make_hlds__add_mode__check_inst_defns_4_p_0(STATE_VARIABLE_ModuleInfo_6_168, InstDefns_54, STATE_VARIABLE_InvalidInstModeSpecs_1_140, &STATE_VARIABLE_InvalidInstModeSpecs_2_171);
  hlds__make_hlds__make_hlds_passes__add_mode_defns_5_p_0(ModeDefns_55, STATE_VARIABLE_ModuleInfo_6_168, &STATE_VARIABLE_ModuleInfo_7_172, STATE_VARIABLE_ErrSpecs_5_169, &STATE_VARIABLE_ErrSpecs_6_173);
  hlds__make_hlds__add_mode__check_mode_defns_4_p_0(STATE_VARIABLE_ModuleInfo_7_172, ModeDefns_55, STATE_VARIABLE_InvalidInstModeSpecs_2_171, &STATE_VARIABLE_InvalidInstModeSpecs_3_174);
  Var_175 = (MR_Word) (STATE_VARIABLE_InvalidTypeSpecs_4_165);
  InvalidTypesSoFar_92 = parse_tree__error_util__contains_errors_2_f_0(Globals_18, Var_175);
  switch (InvalidTypesSoFar_92) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 0:
      {
        MR_Word TypeTable0_93;
        MR_Word Var_176;
        MR_Box conv5_STATE_VARIABLE_ModuleInfo_8_177;
        MR_Box conv4_STATE_VARIABLE_InvalidTypeSpecs_5_178;
        MR_Box conv3_STATE_VARIABLE_WarnSpecs_7_179;

        hlds__hlds_module__module_info_get_type_table_2_p_0(STATE_VARIABLE_ModuleInfo_7_172, &TypeTable0_93);
        {
          Var_176 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(0, Var_176, 0) = ((MR_Box) (&hlds__make_hlds__make_hlds_passes_scalar_common_9[3]));
          MR_hl_field(0, Var_176, 1) = ((MR_Box) (hlds__make_hlds__make_hlds_passes__parse_tree_to_hlds_15_p_0_3));
          MR_hl_field(0, Var_176, 2) = ((MR_Box) ((MR_Integer) 1));
          MR_hl_field(0, Var_176, 3) = ((MR_Box) (TypeTable0_93));
        }
        hlds__hlds_data__foldl3_over_type_ctor_defns_8_p_0((MR_Word) (&hlds__hlds_module__hlds__hlds_module__type_ctor_info_module_info_0), (MR_Word) (&hlds__make_hlds__make_hlds_passes_scalar_common_1[4]), (MR_Word) (&hlds__make_hlds__make_hlds_passes_scalar_common_1[5]), Var_176, TypeTable0_93, ((MR_Box) (STATE_VARIABLE_ModuleInfo_7_172)), &conv5_STATE_VARIABLE_ModuleInfo_8_177, ((MR_Box) (STATE_VARIABLE_InvalidTypeSpecs_4_165)), &conv4_STATE_VARIABLE_InvalidTypeSpecs_5_178, ((MR_Box) (STATE_VARIABLE_WarnSpecs_6_170)), &conv3_STATE_VARIABLE_WarnSpecs_7_179);
        STATE_VARIABLE_ModuleInfo_8_177 = ((MR_Word) (conv5_STATE_VARIABLE_ModuleInfo_8_177));
        STATE_VARIABLE_InvalidTypeSpecs_5_178 = ((MR_Word) (conv4_STATE_VARIABLE_InvalidTypeSpecs_5_178));
        STATE_VARIABLE_WarnSpecs_7_179 = ((MR_Word) (conv3_STATE_VARIABLE_WarnSpecs_7_179));
      }
      break;
    case (MR_Integer) 1:
      {
        STATE_VARIABLE_ModuleInfo_8_177 = STATE_VARIABLE_ModuleInfo_7_172;
        STATE_VARIABLE_InvalidTypeSpecs_5_178 = STATE_VARIABLE_InvalidTypeSpecs_4_165;
        STATE_VARIABLE_WarnSpecs_7_179 = STATE_VARIABLE_WarnSpecs_6_170;
      }
      break;
  }
  hlds__make_hlds__make_hlds_passes__add_pred_decls_5_p_0(PredDecls_56, STATE_VARIABLE_ModuleInfo_8_177, &STATE_VARIABLE_ModuleInfo_9_180, STATE_VARIABLE_ErrSpecs_6_173, &STATE_VARIABLE_ErrSpecs_7_181);
  hlds__make_hlds__make_hlds_passes__add_pred_decls_5_p_0(SolverPredDecls_89, STATE_VARIABLE_ModuleInfo_9_180, &STATE_VARIABLE_ModuleInfo_10_182, STATE_VARIABLE_ErrSpecs_7_181, &STATE_VARIABLE_ErrSpecs_8_183);
  hlds__make_hlds__make_hlds_passes__add_mode_decls_5_p_0(ModeDecls_57, STATE_VARIABLE_ModuleInfo_10_182, &STATE_VARIABLE_ModuleInfo_11_184, STATE_VARIABLE_ErrSpecs_8_183, &STATE_VARIABLE_ErrSpecs_9_185);
  AllMutables_94 = mercury__list__f_43_43_2_f_0((MR_Word) (&hlds__make_hlds__make_hlds_passes_scalar_common_1[3]), Mutables_63, SolverMutables_91);
  hlds__hlds_module__module_info_get_user_init_pred_target_names_2_p_0(STATE_VARIABLE_ModuleInfo_11_184, &InitPredTargetNames0_95);
  parse_tree__module_qual__mq_info__mq_info_get_undef_insts_2_p_0(MQInfo0_20, &MQUndefInstSpecs0_96);
  mercury__one_or_more_map__keys_as_set_2_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_inst_ctor_0), (MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_err_spec_0), MQUndefInstSpecs0_96, &MQUndefInstsSet0_97);
  MQUndefInsts0_98 = mercury__set_tree234__from_set_1_f_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_inst_ctor_0), MQUndefInstsSet0_97);
  hlds__make_hlds__add_mutable_aux_preds__implement_mutables_if_local_13_p_0(STATE_VARIABLE_ModuleInfo_11_184, MQUndefInsts0_98, AllMutables_94, &MutablePredDecls_99, &MutableClauses_100, &MutableForeignProcs_101, &MutableForeignDeclCodes_102, &MutableForeignBodyCodes_103, &FPEInfosCord1_104, InitPredTargetNames0_95, &InitPredTargetNames1_105, STATE_VARIABLE_ErrSpecs_9_185, &STATE_VARIABLE_ErrSpecs_10_186);
  hlds__make_hlds__make_hlds_passes__add_pred_decls_5_p_0(MutablePredDecls_99, STATE_VARIABLE_ModuleInfo_11_184, &STATE_VARIABLE_ModuleInfo_12_187, STATE_VARIABLE_ErrSpecs_10_186, &STATE_VARIABLE_ErrSpecs_11_188);
  hlds__make_hlds__add_class__add_typeclass_defns_5_p_0(Typeclasses_59, STATE_VARIABLE_ModuleInfo_12_187, &STATE_VARIABLE_ModuleInfo_13_189, STATE_VARIABLE_ErrSpecs_11_188, &STATE_VARIABLE_ErrSpecs_12_190);
  hlds__make_hlds__make_hlds_passes__maybe_add_default_modes_3_p_0(PredDecls_56, STATE_VARIABLE_ModuleInfo_13_189, &STATE_VARIABLE_ModuleInfo_14_191);
  hlds__make_hlds__add_class__add_instance_defns_5_p_0(Instances_60, STATE_VARIABLE_ModuleInfo_14_191, &STATE_VARIABLE_ModuleInfo_15_192, STATE_VARIABLE_ErrSpecs_12_190, &STATE_VARIABLE_ErrSpecs_13_193);
  mercury__list__foldl_4_p_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_fim_0), (MR_Word) (&hlds__hlds_module__hlds__hlds_module__type_ctor_info_module_info_0), (MR_Word) (&hlds__make_hlds__make_hlds_passes_scalar_common_2[5]), FIMs_50, ((MR_Box) (STATE_VARIABLE_ModuleInfo_15_192)), &conv7_STATE_VARIABLE_ModuleInfo_16_195);
  STATE_VARIABLE_ModuleInfo_16_195 = ((MR_Word) (conv7_STATE_VARIABLE_ModuleInfo_16_195));
  Var_605 = mdbcomp__builtin_modules__mercury_public_builtin_module_0_f_0();
  succeeded = mdbcomp__sym_name____Unify____sym_name_0_0(ModuleName_32, Var_605);
  if (succeeded)
    succeeded = hlds__special_pred__compiler_generated_rtti_for_builtins_1_p_0(STATE_VARIABLE_ModuleInfo_16_195);
  if (succeeded)
  {
    MR_Word Var_197;
    MR_Box conv9_STATE_VARIABLE_ModuleInfo_17_198;

    Var_197 = parse_tree__prog_type__builtin_type_ctors_with_no_hlds_type_defn_0_f_0();
    mercury__list__foldl_4_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_type_ctor_0), (MR_Word) (&hlds__hlds_module__hlds__hlds_module__type_ctor_info_module_info_0), (MR_Word) (&hlds__make_hlds__make_hlds_passes_scalar_common_2[6]), Var_197, ((MR_Box) (STATE_VARIABLE_ModuleInfo_16_195)), &conv9_STATE_VARIABLE_ModuleInfo_17_198);
    STATE_VARIABLE_ModuleInfo_17_198 = ((MR_Word) (conv9_STATE_VARIABLE_ModuleInfo_17_198));
  }
  else
    STATE_VARIABLE_ModuleInfo_17_198 = STATE_VARIABLE_ModuleInfo_16_195;
  hlds__hlds_module__module_info_optimize_2_p_0(STATE_VARIABLE_ModuleInfo_17_198, &STATE_VARIABLE_ModuleInfo_18_199);
  hlds__make_hlds__qual_info__init_qual_info_3_p_0(MQInfo0_20, TypeEqvMap_21, &STATE_VARIABLE_QualInfo_1_200);
  hlds__make_hlds__make_hlds_passes__add_clauses_10_p_0(ProgressStream_16, Clauses_81, STATE_VARIABLE_ModuleInfo_18_199, &STATE_VARIABLE_ModuleInfo_19_201, STATE_VARIABLE_QualInfo_1_200, &STATE_VARIABLE_QualInfo_2_202, STATE_VARIABLE_ErrSpecs_13_193, &STATE_VARIABLE_ErrSpecs_14_203, STATE_VARIABLE_WarnSpecs_7_179, &STATE_VARIABLE_WarnSpecs_8_204);
  hlds__make_hlds__make_hlds_passes__add_clauses_10_p_0(ProgressStream_16, MutableClauses_100, STATE_VARIABLE_ModuleInfo_19_201, &STATE_VARIABLE_ModuleInfo_20_205, STATE_VARIABLE_QualInfo_2_202, &STATE_VARIABLE_QualInfo_3_206, STATE_VARIABLE_ErrSpecs_14_203, &STATE_VARIABLE_ErrSpecs_15_207, STATE_VARIABLE_WarnSpecs_8_204, &STATE_VARIABLE_WarnSpecs_9_208);
  hlds__make_hlds__make_hlds_passes__add_promises_10_p_0(ProgressStream_16, Promises_58, STATE_VARIABLE_ModuleInfo_20_205, &STATE_VARIABLE_ModuleInfo_21_209, STATE_VARIABLE_QualInfo_3_206, &STATE_VARIABLE_QualInfo_4_210, STATE_VARIABLE_ErrSpecs_15_207, &STATE_VARIABLE_ErrSpecs_16_211, STATE_VARIABLE_WarnSpecs_9_208, &STATE_VARIABLE_WarnSpecs_10_212);
  hlds__hlds_module__module_info_set_int_bad_clauses_3_p_0(IntBadClauses_83, STATE_VARIABLE_ModuleInfo_21_209, &STATE_VARIABLE_ModuleInfo_22_213);
  hlds__make_hlds__add_pragma_decl__add_decl_markers_7_p_0(DeclMarkers_68, STATE_VARIABLE_ModuleInfo_22_213, &STATE_VARIABLE_ModuleInfo_23_214, STATE_VARIABLE_ErrSpecs_16_211, &STATE_VARIABLE_ErrSpecs_17_215, STATE_VARIABLE_WarnSpecs_10_212, &STATE_VARIABLE_WarnSpecs_11_216);
  hlds__make_hlds__add_pragma_impl__add_impl_markers_7_p_0(ImplMarkers_76, STATE_VARIABLE_ModuleInfo_23_214, &STATE_VARIABLE_ModuleInfo_24_217, STATE_VARIABLE_ErrSpecs_17_215, &STATE_VARIABLE_ErrSpecs_18_218, STATE_VARIABLE_WarnSpecs_11_216, &STATE_VARIABLE_WarnSpecs_12_219);
  hlds__make_hlds__add_foreign_proc__add_foreign_procs_8_p_0(ProgressStream_16, ForeignProcs_82, STATE_VARIABLE_ModuleInfo_24_217, &STATE_VARIABLE_ModuleInfo_25_220, STATE_VARIABLE_ErrSpecs_18_218, &STATE_VARIABLE_ErrSpecs_19_221, STATE_VARIABLE_WarnSpecs_12_219, &STATE_VARIABLE_WarnSpecs_13_222);
  hlds__make_hlds__add_foreign_proc__add_foreign_procs_8_p_0(ProgressStream_16, SolverForeignProcs_90, STATE_VARIABLE_ModuleInfo_25_220, &STATE_VARIABLE_ModuleInfo_26_223, STATE_VARIABLE_ErrSpecs_19_221, &STATE_VARIABLE_ErrSpecs_20_224, STATE_VARIABLE_WarnSpecs_13_222, &STATE_VARIABLE_WarnSpecs_14_225);
  hlds__make_hlds__add_foreign_proc__add_foreign_procs_8_p_0(ProgressStream_16, MutableForeignProcs_101, STATE_VARIABLE_ModuleInfo_26_223, &STATE_VARIABLE_ModuleInfo_27_226, STATE_VARIABLE_ErrSpecs_20_224, &STATE_VARIABLE_ErrSpecs_21_227, STATE_VARIABLE_WarnSpecs_14_225, &STATE_VARIABLE_WarnSpecs_15_228);
  hlds__hlds_module__module_info_get_user_final_pred_target_names_2_p_0(STATE_VARIABLE_ModuleInfo_27_226, &FinalPredTargetNames1_106);
  hlds__make_hlds__make_hlds_passes__add_initialises_8_p_0(STATE_VARIABLE_ModuleInfo_27_226, Initialises_61, FPEInfosCord1_104, &FPEInfosCord2_107, InitPredTargetNames1_105, &InitPredTargetNames_108, STATE_VARIABLE_ErrSpecs_21_227, &STATE_VARIABLE_ErrSpecs_22_229);
  hlds__make_hlds__make_hlds_passes__add_finalises_8_p_0(STATE_VARIABLE_ModuleInfo_27_226, Finalises_62, FPEInfosCord2_107, &FPEInfosCord_109, FinalPredTargetNames1_106, &FinalPredTargetNames_110, STATE_VARIABLE_ErrSpecs_22_229, &STATE_VARIABLE_ErrSpecs_23_230);
  hlds__hlds_module__module_info_set_user_init_pred_target_names_3_p_0(InitPredTargetNames_108, STATE_VARIABLE_ModuleInfo_27_226, &STATE_VARIABLE_ModuleInfo_28_231);
  hlds__hlds_module__module_info_set_user_final_pred_target_names_3_p_0(FinalPredTargetNames_110, STATE_VARIABLE_ModuleInfo_28_231, &STATE_VARIABLE_ModuleInfo_29_232);
  hlds__make_hlds__add_pragma_decl__add_decl_pragmas_12_p_0(ProgressStream_16, DeclPragmas_67, STATE_VARIABLE_ModuleInfo_29_232, &STATE_VARIABLE_ModuleInfo_30_234, STATE_VARIABLE_QualInfo_4_210, &STATE_VARIABLE_QualInfo_5_235, STATE_VARIABLE_ErrSpecs_23_230, &STATE_VARIABLE_ErrSpecs_24_236, STATE_VARIABLE_WarnSpecs_15_228, &STATE_VARIABLE_WarnSpecs_16_237, (MR_Word) ((MR_Unsigned) 0U), &STATE_VARIABLE_InfoSpecs_2_238);
  hlds__make_hlds__add_pragma_decl__add_decl_pragmas_type_spec_constr_12_p_0(ProgressStream_16, DeclTypeSpecConstr_69, STATE_VARIABLE_ModuleInfo_30_234, &STATE_VARIABLE_ModuleInfo_31_239, STATE_VARIABLE_QualInfo_5_235, &STATE_VARIABLE_QualInfo_6_240, STATE_VARIABLE_ErrSpecs_24_236, &STATE_VARIABLE_ErrSpecs_25_241, STATE_VARIABLE_WarnSpecs_16_237, &STATE_VARIABLE_WarnSpecs_17_242, STATE_VARIABLE_InfoSpecs_2_238, STATE_VARIABLE_InfoSpecs_125);
  hlds__make_hlds__add_pragma_decl__add_decl_pragmas_type_spec_9_p_0(DeclTypeSpec_70, STATE_VARIABLE_ModuleInfo_31_239, &STATE_VARIABLE_ModuleInfo_32_244, STATE_VARIABLE_QualInfo_6_240, &STATE_VARIABLE_QualInfo_7_245, STATE_VARIABLE_ErrSpecs_25_241, &STATE_VARIABLE_ErrSpecs_26_246, STATE_VARIABLE_WarnSpecs_17_242, &STATE_VARIABLE_WarnSpecs_18_247);
  hlds__make_hlds__add_pragma_decl__add_decl_pragmas_termination_5_p_0(DeclTermination_71, STATE_VARIABLE_ModuleInfo_32_244, &STATE_VARIABLE_ModuleInfo_33_248, STATE_VARIABLE_ErrSpecs_26_246, &STATE_VARIABLE_ErrSpecs_27_249);
  hlds__make_hlds__add_pragma_decl__add_decl_pragmas_termination2_5_p_0(DeclTermination2_72, STATE_VARIABLE_ModuleInfo_33_248, &STATE_VARIABLE_ModuleInfo_34_250, STATE_VARIABLE_ErrSpecs_27_249, &STATE_VARIABLE_ErrSpecs_28_251);
  hlds__make_hlds__add_pragma_decl__add_decl_pragmas_sharing_5_p_0(DeclSharing_73, STATE_VARIABLE_ModuleInfo_34_250, &STATE_VARIABLE_ModuleInfo_35_252, STATE_VARIABLE_ErrSpecs_28_251, &STATE_VARIABLE_ErrSpecs_29_253);
  hlds__make_hlds__add_pragma_decl__add_decl_pragmas_reuse_5_p_0(DeclReuse_74, STATE_VARIABLE_ModuleInfo_35_252, &STATE_VARIABLE_ModuleInfo_36_254, STATE_VARIABLE_ErrSpecs_29_253, &STATE_VARIABLE_ErrSpecs_30_255);
  Var_256 = mercury__cord__init_0_f_0((MR_Word) (&hlds__make_hlds__make_hlds_passes_scalar_common_1[6]));
  hlds__make_hlds__add_pragma_impl__add_impl_pragmas_10_p_0(ProgressStream_16, ImplPragmas_75, Var_256, &PragmaTabledCord_111, STATE_VARIABLE_ModuleInfo_36_254, &STATE_VARIABLE_ModuleInfo_37_257, STATE_VARIABLE_ErrSpecs_30_255, &STATE_VARIABLE_ErrSpecs_31_258, STATE_VARIABLE_WarnSpecs_18_247, &STATE_VARIABLE_WarnSpecs_19_259);
  PragmasTabled_112 = mercury__cord__list_1_f_0((MR_Word) (&hlds__make_hlds__make_hlds_passes_scalar_common_1[6]), PragmaTabledCord_111);
  hlds__make_hlds__add_pragma_impl__add_impl_pragmas_tabled_10_p_0(ProgressStream_16, PragmasTabled_112, STATE_VARIABLE_ModuleInfo_37_257, &STATE_VARIABLE_ModuleInfo_38_260, STATE_VARIABLE_QualInfo_7_245, &STATE_VARIABLE_QualInfo_8_261, STATE_VARIABLE_ErrSpecs_31_258, &STATE_VARIABLE_ErrSpecs_32_262, STATE_VARIABLE_WarnSpecs_19_259, STATE_VARIABLE_WarnSpecs_124);
  FPEInfos_113 = mercury__cord__list_1_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_impl_pragma_fproc_export_info_0), FPEInfosCord_109);
  mercury__list__foldl2_6_p_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_impl_pragma_fproc_export_info_0), (MR_Word) (&hlds__hlds_module__hlds__hlds_module__type_ctor_info_module_info_0), (MR_Word) (&hlds__make_hlds__make_hlds_passes_scalar_common_1[4]), (MR_Word) (&hlds__make_hlds__make_hlds_passes_scalar_common_2[7]), FPEInfos_113, ((MR_Box) (STATE_VARIABLE_ModuleInfo_38_260)), &conv13_STATE_VARIABLE_ModuleInfo_39_265, ((MR_Box) (STATE_VARIABLE_ErrSpecs_32_262)), &conv12_STATE_VARIABLE_ErrSpecs_33_266);
  STATE_VARIABLE_ModuleInfo_39_265 = ((MR_Word) (conv13_STATE_VARIABLE_ModuleInfo_39_265));
  STATE_VARIABLE_ErrSpecs_33_266 = ((MR_Word) (conv12_STATE_VARIABLE_ErrSpecs_33_266));
  mercury__list__foldl_4_p_0((MR_Word) (&parse_tree__prog_foreign__parse_tree__prog_foreign__type_ctor_info_foreign_decl_code_0), (MR_Word) (&hlds__hlds_module__hlds__hlds_module__type_ctor_info_module_info_0), (MR_Word) (&hlds__make_hlds__make_hlds_passes_scalar_common_2[8]), MutableForeignDeclCodes_102, ((MR_Box) (STATE_VARIABLE_ModuleInfo_39_265)), &conv15_STATE_VARIABLE_ModuleInfo_40_268);
  STATE_VARIABLE_ModuleInfo_40_268 = ((MR_Word) (conv15_STATE_VARIABLE_ModuleInfo_40_268));
  mercury__list__foldl_4_p_0((MR_Word) (&parse_tree__prog_foreign__parse_tree__prog_foreign__type_ctor_info_foreign_body_code_0), (MR_Word) (&hlds__hlds_module__hlds__hlds_module__type_ctor_info_module_info_0), (MR_Word) (&hlds__make_hlds__make_hlds_passes_scalar_common_2[9]), MutableForeignBodyCodes_103, ((MR_Box) (STATE_VARIABLE_ModuleInfo_40_268)), &conv17_STATE_VARIABLE_ModuleInfo_41_270);
  STATE_VARIABLE_ModuleInfo_41_270 = ((MR_Word) (conv17_STATE_VARIABLE_ModuleInfo_41_270));
  mercury__list__foldl2_6_p_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_gen_pragma_unused_args_info_0), (MR_Word) (&hlds__hlds_module__hlds__hlds_module__type_ctor_info_module_info_0), (MR_Word) (&hlds__make_hlds__make_hlds_passes_scalar_common_1[4]), (MR_Word) (&hlds__make_hlds__make_hlds_passes_scalar_common_2[10]), GenUnusedArgs_77, ((MR_Box) (STATE_VARIABLE_ModuleInfo_41_270)), &conv21_STATE_VARIABLE_ModuleInfo_42_272, ((MR_Box) (STATE_VARIABLE_ErrSpecs_33_266)), &conv20_STATE_VARIABLE_ErrSpecs_34_273);
  STATE_VARIABLE_ModuleInfo_42_272 = ((MR_Word) (conv21_STATE_VARIABLE_ModuleInfo_42_272));
  STATE_VARIABLE_ErrSpecs_34_273 = ((MR_Word) (conv20_STATE_VARIABLE_ErrSpecs_34_273));
  mercury__list__foldl2_6_p_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_gen_pragma_exceptions_info_0), (MR_Word) (&hlds__hlds_module__hlds__hlds_module__type_ctor_info_module_info_0), (MR_Word) (&hlds__make_hlds__make_hlds_passes_scalar_common_1[4]), (MR_Word) (&hlds__make_hlds__make_hlds_passes_scalar_common_2[11]), GenExceptions_78, ((MR_Box) (STATE_VARIABLE_ModuleInfo_42_272)), &conv25_STATE_VARIABLE_ModuleInfo_43_275, ((MR_Box) (STATE_VARIABLE_ErrSpecs_34_273)), &conv24_STATE_VARIABLE_ErrSpecs_35_276);
  STATE_VARIABLE_ModuleInfo_43_275 = ((MR_Word) (conv25_STATE_VARIABLE_ModuleInfo_43_275));
  STATE_VARIABLE_ErrSpecs_35_276 = ((MR_Word) (conv24_STATE_VARIABLE_ErrSpecs_35_276));
  mercury__list__foldl2_6_p_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_gen_pragma_trailing_info_0), (MR_Word) (&hlds__hlds_module__hlds__hlds_module__type_ctor_info_module_info_0), (MR_Word) (&hlds__make_hlds__make_hlds_passes_scalar_common_1[4]), (MR_Word) (&hlds__make_hlds__make_hlds_passes_scalar_common_2[12]), GenTrailing_79, ((MR_Box) (STATE_VARIABLE_ModuleInfo_43_275)), &conv29_STATE_VARIABLE_ModuleInfo_44_278, ((MR_Box) (STATE_VARIABLE_ErrSpecs_35_276)), &conv28_STATE_VARIABLE_ErrSpecs_36_279);
  STATE_VARIABLE_ModuleInfo_44_278 = ((MR_Word) (conv29_STATE_VARIABLE_ModuleInfo_44_278));
  STATE_VARIABLE_ErrSpecs_36_279 = ((MR_Word) (conv28_STATE_VARIABLE_ErrSpecs_36_279));
  mercury__list__foldl2_6_p_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_gen_pragma_mm_tabling_info_0), (MR_Word) (&hlds__hlds_module__hlds__hlds_module__type_ctor_info_module_info_0), (MR_Word) (&hlds__make_hlds__make_hlds_passes_scalar_common_1[4]), (MR_Word) (&hlds__make_hlds__make_hlds_passes_scalar_common_2[13]), GenMMTabling_80, ((MR_Box) (STATE_VARIABLE_ModuleInfo_44_278)), &conv33_STATE_VARIABLE_ModuleInfo_120, ((MR_Box) (STATE_VARIABLE_ErrSpecs_36_279)), &conv32_STATE_VARIABLE_ErrSpecs_37_282);
  *STATE_VARIABLE_ModuleInfo_120 = ((MR_Word) (conv33_STATE_VARIABLE_ModuleInfo_120));
  STATE_VARIABLE_ErrSpecs_37_282 = ((MR_Word) (conv32_STATE_VARIABLE_ErrSpecs_37_282));
  hlds__make_hlds__check_field_access_functions__check_preds_if_field_access_function_4_p_0(*STATE_VARIABLE_ModuleInfo_120, PredDecls_56, STATE_VARIABLE_ErrSpecs_37_282, &STATE_VARIABLE_ErrSpecs_38_283);
  ModuleItemVersionNumbers_114 = ((MR_Word) ((MR_hl_field(0, AugCompUnit_17, 8))));
  mercury__map__foldl_4_p_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), (MR_Word) (&recompilation__item_types__recompilation__item_types__type_ctor_info_module_item_version_numbers_0), (MR_Word) (&hlds__make_hlds__qual_info__hlds__make_hlds__qual_info__type_ctor_info_qual_info_0), (MR_Word) (&hlds__make_hlds__make_hlds_passes_scalar_common_2[14]), ModuleItemVersionNumbers_114, ((MR_Box) (STATE_VARIABLE_QualInfo_8_261)), &conv35_STATE_VARIABLE_QualInfo_119);
  *STATE_VARIABLE_QualInfo_119 = ((MR_Word) (conv35_STATE_VARIABLE_QualInfo_119));
  hlds__make_hlds__qual_info__qual_info_get_mq_info_2_p_0(*STATE_VARIABLE_QualInfo_119, &MQInfo_115);
  parse_tree__module_qual__mq_info__get_err_specs_in_mq_info_4_p_0(MQInfo_115, &MQInvalidTypeSpecs_116, &MQInvalidInstModeSpecs_117, &MQNonBlockingUndefSpecs_118);
  *STATE_VARIABLE_InvalidTypeSpecs_121 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_err_spec_0), MQInvalidTypeSpecs_116, STATE_VARIABLE_InvalidTypeSpecs_5_178);
  *STATE_VARIABLE_InvalidInstModeSpecs_122 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_err_spec_0), MQInvalidInstModeSpecs_117, STATE_VARIABLE_InvalidInstModeSpecs_3_174);
  *STATE_VARIABLE_ErrSpecs_123 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_err_spec_0), MQNonBlockingUndefSpecs_118, STATE_VARIABLE_ErrSpecs_38_283);
}
                  ...
                  if (!(succeeded))
                  {
                    ...
                    if (!(succeeded))
                    {
                      ...
                      if (!(succeeded))
                      {
                        ...
                        if (!(succeeded))
                        {
                          succeeded = mercury__set__is_non_empty_1_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_pred_pf_name_arity_0), IntBadClauses_30);
                          if (!(succeeded))
                          {
