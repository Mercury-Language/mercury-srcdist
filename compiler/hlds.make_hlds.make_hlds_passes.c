  ...
  MR_Word * STATE_VARIABLE_Specs_113)
{
  ...
  mercury__list__filter_3_p_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_error_spec_0), (MR_Word) (&hlds__make_hlds__make_hlds_passes_scalar_common_7[1]), TypeSpecs_32, &InvalidTypeSpecs_38);
  mercury__list__filter_3_p_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_error_spec_0), (MR_Word) (&hlds__make_hlds__make_hlds_passes_scalar_common_7[2]), InstModeSpecs_33, &InvalidInstModeSpecs_39);
    ...
    case (MR_Integer) 0:
      {
        ...
        hlds__hlds_module__module_info_get_type_table_2_p_0(STATE_VARIABLE_ModuleInfo_175_175, &TypeTable0_94);
        {
          ...
          MR_hl_field(0, Var_176, 0) = ((MR_Box) (&hlds__make_hlds__make_hlds_passes_scalar_common_4[4]));
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
...

      {
        ...
        MR_hl_field(0, Var_33, 0) = ((MR_Box) (&hlds__make_hlds__make_hlds_passes_scalar_common_4[3]));
  ...
  MR_Word * STATE_VARIABLE_Specs_8)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      {
        Var_33 = (MR_Word) MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(0, Var_33, 0) = ((MR_Box) (&hlds__make_hlds__make_hlds_passes_scalar_common_4[2]));
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      hlds__status__item_mercury_status_to_pred_status_2_p_0(ItemMercuryStatus_22, &PredStatus_25);
      {
        ...
        MR_hl_field(0, Var_32, 0) = ((MR_Box) (&hlds__make_hlds__make_hlds_passes_scalar_common_4[1]));
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      hlds__status__item_mercury_status_to_pred_status_2_p_0(ItemMercuryStatus_16, &PredStatus_18);
      {
        ...
        MR_hl_field(0, Var_24, 0) = ((MR_Box) (&hlds__make_hlds__make_hlds_passes_scalar_common_5[0]));
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      hlds__status__item_mercury_status_to_pred_status_2_p_0(ItemMercuryStatus_18, &PredStatus_20);
      {
        ...
        MR_hl_field(0, Var_26, 0) = ((MR_Box) (&hlds__make_hlds__make_hlds_passes_scalar_common_4[0]));
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      hlds__status__item_mercury_status_to_mode_status_2_p_0(ItemMercuryStatus_16, &ModeStatus_18);
      {
        ...
        MR_hl_field(0, Var_23, 0) = ((MR_Box) (&hlds__make_hlds__make_hlds_passes_scalar_common_2[2]));
  ...
  MR_Word * STATE_VARIABLE_Specs_5)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      {
        Var_23 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(0, Var_23, 0) = ((MR_Box) (&hlds__make_hlds__make_hlds_passes_scalar_common_2[1]));
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      hlds__status__item_mercury_status_to_type_status_2_p_0(ItemMercuryStatus_42, &TypeStatus_44);
      {
        ...
        MR_hl_field(0, Var_57, 0) = ((MR_Box) (&hlds__make_hlds__make_hlds_passes_scalar_common_3[0]));
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
...

      {
        ...
        MR_hl_field(0, Var_22, 0) = ((MR_Box) (&hlds__make_hlds__make_hlds_passes_scalar_common_2[0]));
