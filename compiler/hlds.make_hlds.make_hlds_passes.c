  ...
  MR_Word * STATE_VARIABLE_InfoSpecs_127)
{
  ...
  FPEInfos_115 = mercury__cord__list_1_f_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_impl_pragma_fproc_export_info_0), FPEInfosCord_111);
