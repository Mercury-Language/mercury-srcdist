  ...
  MR_Word * STATE_VARIABLE_Specs_45)
{
  ...
  if ((PredIds_24 == (MR_Word) ((MR_Unsigned) 0U)))
  {
    ...
    }
    {
      ...
      MR_hl_field(0, Spec_27, 0) = ((MR_Box) ((MR_String) "predicate \140hlds.make_hlds.make_hlds_passes.implement_initialise_finalise\'/12"));
      MR_hl_field(0, Spec_27, 1) = ((MR_Box) ((MR_Unsigned) 0U));
      MR_hl_field(0, Spec_27, 2) = ((MR_Box) ((MR_Unsigned) 44U));
      MR_hl_field(0, Spec_27, 3) = ((MR_Box) (Context_17));
  ...
  else
  {
    ...
    if ((Var_184 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      ...
      else
      {
        ...
        }
        {
          ...
          MR_hl_field(0, Spec_176, 0) = ((MR_Box) ((MR_String) "predicate \140hlds.make_hlds.make_hlds_passes.implement_initialise_finalise\'/12"));
          MR_hl_field(0, Spec_176, 1) = ((MR_Box) ((MR_Unsigned) 0U));
          MR_hl_field(0, Spec_176, 2) = ((MR_Box) ((MR_Unsigned) 44U));
          MR_hl_field(0, Spec_176, 3) = ((MR_Box) (Context_17));
    ...
    else
    {
      ...
      {
        Spec_182 = (MR_Word) MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(0, Spec_182, 0) = ((MR_Box) ((MR_String) "predicate \140hlds.make_hlds.make_hlds_passes.implement_initialise_finalise\'/12"));
        MR_hl_field(0, Spec_182, 1) = ((MR_Box) ((MR_Unsigned) 0U));
        MR_hl_field(0, Spec_182, 2) = ((MR_Box) ((MR_Unsigned) 44U));
        MR_hl_field(0, Spec_182, 3) = ((MR_Box) (Context_17));
        MR_hl_field(0, Spec_182, 4) = ((MR_Box) (Pieces_181));
      }
      {
        MR_Word base;
        base = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
