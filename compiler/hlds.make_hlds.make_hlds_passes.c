  ...
  MR_Word * STATE_VARIABLE_Specs_120)
{
  ...
  parse_tree__module_qual__mq_info__mq_info_get_partial_qualifier_info_2_p_0(MQInfo0_17, &PQInfo_29);
  ...
  parse_tree__module_qual__mq_info__mq_info_get_undef_insts_2_p_0(MQInfo0_17, &MQUndefInsts0_93);
