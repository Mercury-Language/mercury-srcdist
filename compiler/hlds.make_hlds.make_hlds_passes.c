...
static void MR_CALL 
hlds__make_hlds__make_hlds_passes__IntroducedFrom__pred__add_type_defn__586__1_3_p_0(
...
{
  {
    ...
    hlds__make_hlds__add_pragma__add_pragma_foreign_proc_export_7_p_0(PEOrigin_23, FPEInfo_21, Context_14, STATE_VARIABLE_ModuleInfo_0_24, STATE_VARIABLE_ModuleInfo_25, STATE_VARIABLE_Specs_0_26, STATE_VARIABLE_Specs_27);
  }
}
...
{
  {
    ...
    hlds__make_hlds__make_hlds_passes__IntroducedFrom__pred__add_type_defn__586__1_3_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) (wrapper_arg_1)), &conv0_HeadVar__3_59);
