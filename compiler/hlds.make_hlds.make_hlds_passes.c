...
{
  {
    ...
    if ((hlds__make_hlds__make_hlds_passes__MaybePredOrFunc_12 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
    ...
    else
      {
        ...
        {
          hlds__make_hlds__add_pred__module_add_mode_14_p_0(hlds__make_hlds__make_hlds_passes__VarSet_16, hlds__make_hlds__make_hlds_passes__PredSymName_11, hlds__make_hlds__make_hlds_passes__Modes_13, hlds__make_hlds__make_hlds_passes__MaybeDet_15, hlds__make_hlds__make_hlds_passes__ModeStatus_24, hlds__make_hlds__make_hlds_passes__V_49_49, hlds__make_hlds__make_hlds_passes__Context_17, hlds__make_hlds__make_hlds_passes__PredOrFunc_23, (MR_Integer) 0, &hlds__make_hlds__make_hlds_passes__V_25_25, hlds__make_hlds__make_hlds_passes__STATE_VARIABLE_ModuleInfo_0_26, hlds__make_hlds__make_hlds_passes__STATE_VARIABLE_ModuleInfo_27, hlds__make_hlds__make_hlds_passes__STATE_VARIABLE_Specs_0_28, hlds__make_hlds__make_hlds_passes__STATE_VARIABLE_Specs_29);
        }
      }
  }
}
...
{
  {
    ...
    if (hlds__make_hlds__make_hlds_passes__succeeded)
    ...
    else
      {
        ...
        {
          hlds__make_hlds__add_pred__module_add_pred_or_func_20_p_0(hlds__make_hlds__make_hlds_passes__PredOrigin_37, hlds__make_hlds__make_hlds_passes__TypeVarSet_20, hlds__make_hlds__make_hlds_passes__InstVarSet_21, hlds__make_hlds__make_hlds_passes__ExistQVars_22, hlds__make_hlds__make_hlds_passes__PredOrFunc_14, hlds__make_hlds__make_hlds_passes__PredSymName_13, hlds__make_hlds__make_hlds_passes__TypesAndModes_15, hlds__make_hlds__make_hlds_passes__MaybeDetism_18, hlds__make_hlds__make_hlds_passes__Purity_23, hlds__make_hlds__make_hlds_passes__ClassContext_24, hlds__make_hlds__make_hlds_passes__Markers_35, hlds__make_hlds__make_hlds_passes__Context_25, hlds__make_hlds__make_hlds_passes__PredStatus_36, hlds__make_hlds__make_hlds_passes__V_73_73, hlds__make_hlds__make_hlds_passes__NeedQual_12, &hlds__make_hlds__make_hlds_passes__V_38_38, hlds__make_hlds__make_hlds_passes__STATE_VARIABLE_ModuleInfo_0_39, hlds__make_hlds__make_hlds_passes__STATE_VARIABLE_ModuleInfo_40, hlds__make_hlds__make_hlds_passes__STATE_VARIABLE_Specs_0_41, hlds__make_hlds__make_hlds_passes__STATE_VARIABLE_Specs_42);
        }
      }
  }
}
