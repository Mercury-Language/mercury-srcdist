  ...
  MR_Word * STATE_VARIABLE_Specs_120)
{
  ...
  *STATE_VARIABLE_ModuleInfo_119 = ((MR_Word) (conv33_STATE_VARIABLE_ModuleInfo_119));
  ...
  hlds__add_pred__check_preds_if_field_access_function_4_p_0(*STATE_VARIABLE_ModuleInfo_119, PredDecls_52, STATE_VARIABLE_Specs_258_258, STATE_VARIABLE_Specs_120);
