...
static void MR_CALL 
hlds__make_hlds__make_hlds_passes__IntroducedFrom__pred__add_type_defn__549__1_3_p_0(
...
{
  {
    ...
    succeeded = hlds__make_hlds__make_hlds_passes__IntroducedFrom__pred__add_pred_decl__620__1_2_p_0(((MR_Word) (MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3))), ((MR_Word) (MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4))));
    return succeeded;
  }
}
...
{
  {
    ...
    hlds__make_hlds__make_hlds_passes__IntroducedFrom__pred__add_type_defn__549__1_3_p_0(((MR_Word) (MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3))), ((MR_Word) wrapper_arg_1), &conv0_HeadVar__3_59);
