  ...
  MR_Word LambdaHeadVar__1_128)
{
  ...
  parse_tree__error_spec__extract_spec_phase_2_p_0(LambdaHeadVar__1_128, &Phase_265);
  succeeded = (Phase_265 == (MR_Word) ((MR_Unsigned) 32U));
  return succeeded;
}
  ...
  MR_Word * STATE_VARIABLE_Specs_120)
{
  ...
  MR_Word STATE_VARIABLE_FoundInvalidType_1_129;
  MR_Word STATE_VARIABLE_FoundInvalidInstOrMode_1_131;
  MR_Word STATE_VARIABLE_ModuleInfo_1_134;
  MR_Word Var_135;
  MR_Word STATE_VARIABLE_ModuleInfo_2_136;
  MR_Word STATE_VARIABLE_ModuleInfo_3_137;
  MR_Word STATE_VARIABLE_SolverPredDeclCord_1_138;
  MR_Word STATE_VARIABLE_SolverForeignProcCord_1_139;
  MR_Word STATE_VARIABLE_SolverMutableCord_1_140;
  MR_Word STATE_VARIABLE_ModuleInfo_4_141;
  MR_Word STATE_VARIABLE_FoundInvalidType_3_142;
  MR_Word STATE_VARIABLE_Specs_2_143;
  MR_Word STATE_VARIABLE_SolverPredDeclCord_2_144;
  MR_Word STATE_VARIABLE_SolverForeignProcCord_2_145;
  MR_Word STATE_VARIABLE_SolverMutableCord_2_146;
  MR_Word STATE_VARIABLE_ModuleInfo_5_147;
  MR_Word STATE_VARIABLE_FoundInvalidType_4_148;
  MR_Word STATE_VARIABLE_Specs_3_149;
  MR_Word STATE_VARIABLE_SolverPredDeclCord_3_150;
  MR_Word STATE_VARIABLE_SolverForeignProcCord_3_151;
  MR_Word STATE_VARIABLE_SolverMutableCord_3_152;
  MR_Word STATE_VARIABLE_ModuleInfo_6_153;
  MR_Word STATE_VARIABLE_FoundInvalidType_5_154;
  MR_Word STATE_VARIABLE_Specs_4_155;
  MR_Word STATE_VARIABLE_SolverPredDeclCord_4_156;
  MR_Word STATE_VARIABLE_SolverForeignProcCord_4_157;
  MR_Word STATE_VARIABLE_SolverMutableCord_4_158;
  MR_Word STATE_VARIABLE_ModuleInfo_7_159;
  MR_Word STATE_VARIABLE_Specs_5_160;
  MR_Word STATE_VARIABLE_FoundInvalidInstOrMode_3_161;
  MR_Word STATE_VARIABLE_Specs_6_162;
  MR_Word STATE_VARIABLE_ModuleInfo_8_163;
  MR_Word STATE_VARIABLE_Specs_7_164;
  MR_Word STATE_VARIABLE_FoundInvalidInstOrMode_4_165;
  MR_Word STATE_VARIABLE_Specs_8_166;
  MR_Word STATE_VARIABLE_ModuleInfo_9_167;
  MR_Word STATE_VARIABLE_Specs_9_168;
  MR_Word STATE_VARIABLE_ModuleInfo_10_169;
  MR_Word STATE_VARIABLE_Specs_10_170;
  MR_Word STATE_VARIABLE_ModuleInfo_11_171;
  MR_Word STATE_VARIABLE_Specs_11_172;
  MR_Word STATE_VARIABLE_Specs_12_173;
  MR_Word STATE_VARIABLE_ModuleInfo_12_174;
  MR_Word STATE_VARIABLE_Specs_13_175;
  MR_Word STATE_VARIABLE_ModuleInfo_13_176;
  MR_Word STATE_VARIABLE_Specs_14_177;
  MR_Word STATE_VARIABLE_ModuleInfo_14_178;
  MR_Word STATE_VARIABLE_ModuleInfo_15_179;
  MR_Word STATE_VARIABLE_Specs_15_180;
  MR_Word STATE_VARIABLE_ModuleInfo_16_182;
  MR_Word STATE_VARIABLE_FoundInvalidType_6_184;
  MR_Word STATE_VARIABLE_ModuleInfo_17_185;
  MR_Word STATE_VARIABLE_Specs_16_186;
  MR_Word STATE_VARIABLE_ModuleInfo_18_189;
  MR_Word STATE_VARIABLE_ModuleInfo_19_190;
  MR_Word STATE_VARIABLE_QualInfo_1_191;
  MR_Word STATE_VARIABLE_ModuleInfo_20_192;
  MR_Word STATE_VARIABLE_QualInfo_2_193;
  MR_Word STATE_VARIABLE_Specs_17_194;
  MR_Word STATE_VARIABLE_ModuleInfo_21_195;
  MR_Word STATE_VARIABLE_QualInfo_3_196;
  MR_Word STATE_VARIABLE_Specs_18_197;
  MR_Word STATE_VARIABLE_ModuleInfo_22_198;
  MR_Word STATE_VARIABLE_QualInfo_4_199;
  MR_Word STATE_VARIABLE_Specs_19_200;
  MR_Word STATE_VARIABLE_ModuleInfo_23_201;
  MR_Word STATE_VARIABLE_ModuleInfo_24_202;
  MR_Word STATE_VARIABLE_Specs_20_203;
  MR_Word STATE_VARIABLE_ModuleInfo_25_204;
  MR_Word STATE_VARIABLE_Specs_21_205;
  MR_Word STATE_VARIABLE_ModuleInfo_26_206;
  MR_Word STATE_VARIABLE_Specs_22_207;
  MR_Word STATE_VARIABLE_ModuleInfo_27_208;
  MR_Word STATE_VARIABLE_Specs_23_209;
  MR_Word STATE_VARIABLE_ModuleInfo_28_210;
  MR_Word STATE_VARIABLE_Specs_24_211;
  MR_Word STATE_VARIABLE_Specs_25_212;
  MR_Word STATE_VARIABLE_Specs_26_213;
  MR_Word STATE_VARIABLE_ModuleInfo_29_214;
  MR_Word STATE_VARIABLE_ModuleInfo_30_215;
  MR_Word STATE_VARIABLE_ModuleInfo_31_216;
  MR_Word STATE_VARIABLE_QualInfo_5_217;
  MR_Word STATE_VARIABLE_Specs_27_218;
  MR_Word STATE_VARIABLE_ModuleInfo_32_219;
  MR_Word STATE_VARIABLE_QualInfo_6_220;
  MR_Word STATE_VARIABLE_Specs_28_221;
  MR_Word STATE_VARIABLE_ModuleInfo_33_222;
  MR_Word STATE_VARIABLE_QualInfo_7_223;
  MR_Word STATE_VARIABLE_Specs_29_224;
  MR_Word STATE_VARIABLE_ModuleInfo_34_225;
  MR_Word STATE_VARIABLE_Specs_30_226;
  MR_Word STATE_VARIABLE_ModuleInfo_35_227;
  MR_Word STATE_VARIABLE_Specs_31_228;
  MR_Word STATE_VARIABLE_ModuleInfo_36_229;
  MR_Word STATE_VARIABLE_Specs_32_230;
  MR_Word STATE_VARIABLE_ModuleInfo_37_231;
  MR_Word STATE_VARIABLE_Specs_33_232;
  MR_Word Var_233;
  MR_Word STATE_VARIABLE_ModuleInfo_38_234;
  MR_Word STATE_VARIABLE_Specs_34_235;
  MR_Word STATE_VARIABLE_ModuleInfo_39_236;
  MR_Word STATE_VARIABLE_QualInfo_8_237;
  MR_Word STATE_VARIABLE_Specs_35_238;
  MR_Word STATE_VARIABLE_ModuleInfo_40_240;
  MR_Word STATE_VARIABLE_Specs_36_241;
  MR_Word STATE_VARIABLE_ModuleInfo_41_243;
  MR_Word STATE_VARIABLE_ModuleInfo_42_245;
  MR_Word STATE_VARIABLE_ModuleInfo_43_247;
  MR_Word STATE_VARIABLE_Specs_37_248;
  MR_Word STATE_VARIABLE_ModuleInfo_44_250;
  MR_Word STATE_VARIABLE_Specs_38_251;
  MR_Word STATE_VARIABLE_ModuleInfo_45_253;
  MR_Word STATE_VARIABLE_Specs_39_254;
  MR_Word STATE_VARIABLE_Specs_40_257;
  MR_Box conv1_STATE_VARIABLE_ModuleInfo_16_182;
  MR_Word Var_497;
  MR_Box conv13_STATE_VARIABLE_ModuleInfo_40_240;
  MR_Box conv12_STATE_VARIABLE_Specs_36_241;
  MR_Box conv15_STATE_VARIABLE_ModuleInfo_41_243;
  MR_Box conv17_STATE_VARIABLE_ModuleInfo_42_245;
  MR_Box conv21_STATE_VARIABLE_ModuleInfo_43_247;
  MR_Box conv20_STATE_VARIABLE_Specs_37_248;
  MR_Box conv25_STATE_VARIABLE_ModuleInfo_44_250;
  MR_Box conv24_STATE_VARIABLE_Specs_38_251;
  MR_Box conv29_STATE_VARIABLE_ModuleInfo_45_253;
  MR_Box conv28_STATE_VARIABLE_Specs_39_254;
  MR_Box conv33_STATE_VARIABLE_ModuleInfo_119;
  MR_Box conv32_STATE_VARIABLE_Specs_40_257;
  ...
  STATE_VARIABLE_Specs_1_126 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_error_spec_0), TypeSpecs_34, InstModeSpecs_35);
  ...
  switch (TypeErrors_42) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 0:
      STATE_VARIABLE_FoundInvalidType_1_129 = (MR_Integer) 0;
      break;
    case (MR_Integer) 1:
      STATE_VARIABLE_FoundInvalidType_1_129 = (MR_Integer) 1;
      break;
  }
  switch (InstModeErrors_43) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 0:
      STATE_VARIABLE_FoundInvalidInstOrMode_1_131 = (MR_Integer) 0;
      break;
    case (MR_Integer) 1:
      STATE_VARIABLE_FoundInvalidInstOrMode_1_131 = (MR_Integer) 1;
      break;
  }
  ...
  hlds__hlds_module__module_info_init_11_p_0(Globals_15, ModuleName_26, ModuleNameContext_27, DumpBaseFileName_16, InclMap_44, UsedModules_19, ImplicitlyUsedModules_28, PQInfo_29, (MR_Word) ((MR_Unsigned) 0U), TypeRepnDec_81, &STATE_VARIABLE_ModuleInfo_1_134);
  Var_135 = mercury__set__init_0_f_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0));
  hlds__make_hlds__make_hlds_passes__add_item_avails_5_p_0(Avails_45, Var_135, &AncestorAvailModules_82, STATE_VARIABLE_ModuleInfo_1_134, &STATE_VARIABLE_ModuleInfo_2_136);
  hlds__hlds_module__module_info_get_ancestor_avail_modules_2_p_0(STATE_VARIABLE_ModuleInfo_2_136, &AncestorAvailSet0_83);
  ...
  hlds__hlds_module__module_info_set_ancestor_avail_modules_3_p_0(AncestorAvailSet_84, STATE_VARIABLE_ModuleInfo_2_136, &STATE_VARIABLE_ModuleInfo_3_137);
  STATE_VARIABLE_SolverPredDeclCord_1_138 = mercury__cord__init_0_f_0((MR_Word) (&hlds__make_hlds__make_hlds_passes_scalar_common_1[1]));
  STATE_VARIABLE_SolverForeignProcCord_1_139 = mercury__cord__init_0_f_0((MR_Word) (&hlds__make_hlds__make_hlds_passes_scalar_common_1[2]));
  STATE_VARIABLE_SolverMutableCord_1_140 = mercury__cord__init_0_f_0((MR_Word) (&hlds__make_hlds__make_hlds_passes_scalar_common_1[3]));
  hlds__make_hlds__make_hlds_passes__add_type_defns_13_p_0(TypeDefnsAbstract_47, STATE_VARIABLE_ModuleInfo_3_137, &STATE_VARIABLE_ModuleInfo_4_141, STATE_VARIABLE_FoundInvalidType_1_129, &STATE_VARIABLE_FoundInvalidType_3_142, STATE_VARIABLE_Specs_1_126, &STATE_VARIABLE_Specs_2_143, STATE_VARIABLE_SolverPredDeclCord_1_138, &STATE_VARIABLE_SolverPredDeclCord_2_144, STATE_VARIABLE_SolverForeignProcCord_1_139, &STATE_VARIABLE_SolverForeignProcCord_2_145, STATE_VARIABLE_SolverMutableCord_1_140, &STATE_VARIABLE_SolverMutableCord_2_146);
  hlds__make_hlds__make_hlds_passes__add_type_defns_13_p_0(TypeDefnsMercury_48, STATE_VARIABLE_ModuleInfo_4_141, &STATE_VARIABLE_ModuleInfo_5_147, STATE_VARIABLE_FoundInvalidType_3_142, &STATE_VARIABLE_FoundInvalidType_4_148, STATE_VARIABLE_Specs_2_143, &STATE_VARIABLE_Specs_3_149, STATE_VARIABLE_SolverPredDeclCord_2_144, &STATE_VARIABLE_SolverPredDeclCord_3_150, STATE_VARIABLE_SolverForeignProcCord_2_145, &STATE_VARIABLE_SolverForeignProcCord_3_151, STATE_VARIABLE_SolverMutableCord_2_146, &STATE_VARIABLE_SolverMutableCord_3_152);
  hlds__make_hlds__make_hlds_passes__add_type_defns_13_p_0(TypeDefnsForeign_49, STATE_VARIABLE_ModuleInfo_5_147, &STATE_VARIABLE_ModuleInfo_6_153, STATE_VARIABLE_FoundInvalidType_4_148, &STATE_VARIABLE_FoundInvalidType_5_154, STATE_VARIABLE_Specs_3_149, &STATE_VARIABLE_Specs_4_155, STATE_VARIABLE_SolverPredDeclCord_3_150, &STATE_VARIABLE_SolverPredDeclCord_4_156, STATE_VARIABLE_SolverForeignProcCord_3_151, &STATE_VARIABLE_SolverForeignProcCord_4_157, STATE_VARIABLE_SolverMutableCord_3_152, &STATE_VARIABLE_SolverMutableCord_4_158);
  SolverPredDecls_88 = mercury__cord__list_1_f_0((MR_Word) (&hlds__make_hlds__make_hlds_passes_scalar_common_1[1]), STATE_VARIABLE_SolverPredDeclCord_4_156);
  SolverForeignProcs_89 = mercury__cord__list_1_f_0((MR_Word) (&hlds__make_hlds__make_hlds_passes_scalar_common_1[2]), STATE_VARIABLE_SolverForeignProcCord_4_157);
  SolverMutables_90 = mercury__cord__list_1_f_0((MR_Word) (&hlds__make_hlds__make_hlds_passes_scalar_common_1[3]), STATE_VARIABLE_SolverMutableCord_4_158);
  hlds__make_hlds__make_hlds_passes__add_inst_defns_5_p_0(InstDefns_50, STATE_VARIABLE_ModuleInfo_6_153, &STATE_VARIABLE_ModuleInfo_7_159, STATE_VARIABLE_Specs_4_155, &STATE_VARIABLE_Specs_5_160);
  hlds__make_hlds__add_mode__check_inst_defns_6_p_0(STATE_VARIABLE_ModuleInfo_7_159, InstDefns_50, STATE_VARIABLE_FoundInvalidInstOrMode_1_131, &STATE_VARIABLE_FoundInvalidInstOrMode_3_161, STATE_VARIABLE_Specs_5_160, &STATE_VARIABLE_Specs_6_162);
  hlds__make_hlds__make_hlds_passes__add_mode_defns_5_p_0(ModeDefns_51, STATE_VARIABLE_ModuleInfo_7_159, &STATE_VARIABLE_ModuleInfo_8_163, STATE_VARIABLE_Specs_6_162, &STATE_VARIABLE_Specs_7_164);
  hlds__make_hlds__add_mode__check_mode_defns_6_p_0(STATE_VARIABLE_ModuleInfo_8_163, ModeDefns_51, STATE_VARIABLE_FoundInvalidInstOrMode_3_161, &STATE_VARIABLE_FoundInvalidInstOrMode_4_165, STATE_VARIABLE_Specs_7_164, &STATE_VARIABLE_Specs_8_166);
  hlds__make_hlds__make_hlds_passes__add_pred_decls_5_p_0(PredDecls_52, STATE_VARIABLE_ModuleInfo_8_163, &STATE_VARIABLE_ModuleInfo_9_167, STATE_VARIABLE_Specs_8_166, &STATE_VARIABLE_Specs_9_168);
  hlds__make_hlds__make_hlds_passes__add_pred_decls_5_p_0(SolverPredDecls_88, STATE_VARIABLE_ModuleInfo_9_167, &STATE_VARIABLE_ModuleInfo_10_169, STATE_VARIABLE_Specs_9_168, &STATE_VARIABLE_Specs_10_170);
  hlds__make_hlds__make_hlds_passes__add_mode_decls_5_p_0(ModeDecls_53, STATE_VARIABLE_ModuleInfo_10_169, &STATE_VARIABLE_ModuleInfo_11_171, STATE_VARIABLE_Specs_10_170, &STATE_VARIABLE_Specs_11_172);
  ...
  hlds__hlds_module__module_info_get_user_init_pred_target_names_2_p_0(STATE_VARIABLE_ModuleInfo_11_171, &InitPredTargetNames0_92);
  parse_tree__module_qual__mq_info__mq_info_get_undef_insts_2_p_0(MQInfo0_17, &MQUndefInsts0_93);
  hlds__make_hlds__add_mutable_aux_preds__implement_mutables_if_local_13_p_0(STATE_VARIABLE_ModuleInfo_11_171, MQUndefInsts0_93, AllMutables_91, &MutablePredDecls_94, &MutableClauses_95, &MutableForeignProcs_96, &MutableForeignDeclCodes_97, &MutableForeignBodyCodes_98, &FPEInfosCord1_99, InitPredTargetNames0_92, &InitPredTargetNames1_100, STATE_VARIABLE_Specs_11_172, &STATE_VARIABLE_Specs_12_173);
  hlds__make_hlds__make_hlds_passes__add_pred_decls_5_p_0(MutablePredDecls_94, STATE_VARIABLE_ModuleInfo_11_171, &STATE_VARIABLE_ModuleInfo_12_174, STATE_VARIABLE_Specs_12_173, &STATE_VARIABLE_Specs_13_175);
  hlds__make_hlds__add_class__add_typeclass_defns_5_p_0(Typeclasses_55, STATE_VARIABLE_ModuleInfo_12_174, &STATE_VARIABLE_ModuleInfo_13_176, STATE_VARIABLE_Specs_13_175, &STATE_VARIABLE_Specs_14_177);
  hlds__make_hlds__make_hlds_passes__maybe_add_default_modes_3_p_0(PredDecls_52, STATE_VARIABLE_ModuleInfo_13_176, &STATE_VARIABLE_ModuleInfo_14_178);
  hlds__make_hlds__add_class__add_instance_defns_5_p_0(Instances_56, STATE_VARIABLE_ModuleInfo_14_178, &STATE_VARIABLE_ModuleInfo_15_179, STATE_VARIABLE_Specs_14_177, &STATE_VARIABLE_Specs_15_180);
  mercury__list__foldl_4_p_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_fim_0), (MR_Word) (&hlds__hlds_module__hlds__hlds_module__type_ctor_info_module_info_0), (MR_Word) (&hlds__make_hlds__make_hlds_passes_scalar_common_2[4]), FIMs_46, ((MR_Box) (STATE_VARIABLE_ModuleInfo_15_179)), &conv1_STATE_VARIABLE_ModuleInfo_16_182);
  STATE_VARIABLE_ModuleInfo_16_182 = ((MR_Word) (conv1_STATE_VARIABLE_ModuleInfo_16_182));
  switch (STATE_VARIABLE_FoundInvalidType_5_154) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 0:
      {
        MR_Word TypeTable0_101;
        MR_Word Var_183;
        MR_Box conv7_STATE_VARIABLE_FoundInvalidType_6_184;
        MR_Box conv6_STATE_VARIABLE_ModuleInfo_17_185;
        MR_Box conv5_STATE_VARIABLE_Specs_16_186;

        hlds__hlds_module__module_info_get_type_table_2_p_0(STATE_VARIABLE_ModuleInfo_16_182, &TypeTable0_101);
        {
        ...
        hlds__hlds_data__foldl3_over_type_ctor_defns_8_p_0((MR_Word) (&hlds__make_hlds__make_hlds_types__hlds__make_hlds__make_hlds_types__type_ctor_info_found_invalid_type_0), (MR_Word) (&hlds__hlds_module__hlds__hlds_module__type_ctor_info_module_info_0), (MR_Word) (&hlds__make_hlds__make_hlds_passes_scalar_common_1[4]), Var_183, TypeTable0_101, ((MR_Box) (STATE_VARIABLE_FoundInvalidType_5_154)), &conv7_STATE_VARIABLE_FoundInvalidType_6_184, ((MR_Box) (STATE_VARIABLE_ModuleInfo_16_182)), &conv6_STATE_VARIABLE_ModuleInfo_17_185, ((MR_Box) (STATE_VARIABLE_Specs_15_180)), &conv5_STATE_VARIABLE_Specs_16_186);
        STATE_VARIABLE_FoundInvalidType_6_184 = ((MR_Word) (conv7_STATE_VARIABLE_FoundInvalidType_6_184));
        STATE_VARIABLE_ModuleInfo_17_185 = ((MR_Word) (conv6_STATE_VARIABLE_ModuleInfo_17_185));
        STATE_VARIABLE_Specs_16_186 = ((MR_Word) (conv5_STATE_VARIABLE_Specs_16_186));
      }
      break;
    case (MR_Integer) 1:
      {
        STATE_VARIABLE_FoundInvalidType_6_184 = STATE_VARIABLE_FoundInvalidType_5_154;
        STATE_VARIABLE_ModuleInfo_17_185 = STATE_VARIABLE_ModuleInfo_16_182;
        STATE_VARIABLE_Specs_16_186 = STATE_VARIABLE_Specs_15_180;
      }
      break;
  }
  Var_497 = mdbcomp__builtin_modules__mercury_public_builtin_module_0_f_0();
  succeeded = mdbcomp__sym_name____Unify____sym_name_0_0(ModuleName_26, Var_497);
  if (succeeded)
    succeeded = hlds__special_pred__compiler_generated_rtti_for_builtins_1_p_0(STATE_VARIABLE_ModuleInfo_17_185);
  if (succeeded)
  {
    MR_Word Var_188;
    MR_Box conv9_STATE_VARIABLE_ModuleInfo_18_189;

    Var_188 = parse_tree__prog_type__builtin_type_ctors_with_no_hlds_type_defn_0_f_0();
    mercury__list__foldl_4_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_type_ctor_0), (MR_Word) (&hlds__hlds_module__hlds__hlds_module__type_ctor_info_module_info_0), (MR_Word) (&hlds__make_hlds__make_hlds_passes_scalar_common_2[5]), Var_188, ((MR_Box) (STATE_VARIABLE_ModuleInfo_17_185)), &conv9_STATE_VARIABLE_ModuleInfo_18_189);
    STATE_VARIABLE_ModuleInfo_18_189 = ((MR_Word) (conv9_STATE_VARIABLE_ModuleInfo_18_189));
  }
  else
    STATE_VARIABLE_ModuleInfo_18_189 = STATE_VARIABLE_ModuleInfo_17_185;
  hlds__hlds_module__module_info_optimize_2_p_0(STATE_VARIABLE_ModuleInfo_18_189, &STATE_VARIABLE_ModuleInfo_19_190);
  hlds__make_hlds__qual_info__init_qual_info_3_p_0(MQInfo0_17, TypeEqvMap_18, &STATE_VARIABLE_QualInfo_1_191);
  hlds__make_hlds__make_hlds_passes__add_clauses_8_p_0(ProgressStream_13, Clauses_77, STATE_VARIABLE_ModuleInfo_19_190, &STATE_VARIABLE_ModuleInfo_20_192, STATE_VARIABLE_QualInfo_1_191, &STATE_VARIABLE_QualInfo_2_193, STATE_VARIABLE_Specs_16_186, &STATE_VARIABLE_Specs_17_194);
  hlds__make_hlds__make_hlds_passes__add_clauses_8_p_0(ProgressStream_13, MutableClauses_95, STATE_VARIABLE_ModuleInfo_20_192, &STATE_VARIABLE_ModuleInfo_21_195, STATE_VARIABLE_QualInfo_2_193, &STATE_VARIABLE_QualInfo_3_196, STATE_VARIABLE_Specs_17_194, &STATE_VARIABLE_Specs_18_197);
  hlds__make_hlds__make_hlds_passes__add_promises_8_p_0(ProgressStream_13, Promises_54, STATE_VARIABLE_ModuleInfo_21_195, &STATE_VARIABLE_ModuleInfo_22_198, STATE_VARIABLE_QualInfo_3_196, &STATE_VARIABLE_QualInfo_4_199, STATE_VARIABLE_Specs_18_197, &STATE_VARIABLE_Specs_19_200);
  hlds__hlds_module__module_info_set_int_bad_clauses_3_p_0(IntBadClauses_79, STATE_VARIABLE_ModuleInfo_22_198, &STATE_VARIABLE_ModuleInfo_23_201);
  hlds__make_hlds__add_pragma__add_decl_markers_5_p_0(DeclMarkers_64, STATE_VARIABLE_ModuleInfo_23_201, &STATE_VARIABLE_ModuleInfo_24_202, STATE_VARIABLE_Specs_19_200, &STATE_VARIABLE_Specs_20_203);
  hlds__make_hlds__add_pragma__add_impl_markers_5_p_0(ImplMarkers_72, STATE_VARIABLE_ModuleInfo_24_202, &STATE_VARIABLE_ModuleInfo_25_204, STATE_VARIABLE_Specs_20_203, &STATE_VARIABLE_Specs_21_205);
  hlds__make_hlds__add_foreign_proc__add_foreign_procs_6_p_0(ProgressStream_13, ForeignProcs_78, STATE_VARIABLE_ModuleInfo_25_204, &STATE_VARIABLE_ModuleInfo_26_206, STATE_VARIABLE_Specs_21_205, &STATE_VARIABLE_Specs_22_207);
  hlds__make_hlds__add_foreign_proc__add_foreign_procs_6_p_0(ProgressStream_13, SolverForeignProcs_89, STATE_VARIABLE_ModuleInfo_26_206, &STATE_VARIABLE_ModuleInfo_27_208, STATE_VARIABLE_Specs_22_207, &STATE_VARIABLE_Specs_23_209);
  hlds__make_hlds__add_foreign_proc__add_foreign_procs_6_p_0(ProgressStream_13, MutableForeignProcs_96, STATE_VARIABLE_ModuleInfo_27_208, &STATE_VARIABLE_ModuleInfo_28_210, STATE_VARIABLE_Specs_23_209, &STATE_VARIABLE_Specs_24_211);
  hlds__hlds_module__module_info_get_user_final_pred_target_names_2_p_0(STATE_VARIABLE_ModuleInfo_28_210, &FinalPredTargetNames1_102);
  hlds__make_hlds__make_hlds_passes__add_initialises_8_p_0(STATE_VARIABLE_ModuleInfo_28_210, Initialises_57, FPEInfosCord1_99, &FPEInfosCord2_103, InitPredTargetNames1_100, &InitPredTargetNames_104, STATE_VARIABLE_Specs_24_211, &STATE_VARIABLE_Specs_25_212);
  hlds__make_hlds__make_hlds_passes__add_finalises_8_p_0(STATE_VARIABLE_ModuleInfo_28_210, Finalises_58, FPEInfosCord2_103, &FPEInfosCord_105, FinalPredTargetNames1_102, &FinalPredTargetNames_106, STATE_VARIABLE_Specs_25_212, &STATE_VARIABLE_Specs_26_213);
  hlds__hlds_module__module_info_set_user_init_pred_target_names_3_p_0(InitPredTargetNames_104, STATE_VARIABLE_ModuleInfo_28_210, &STATE_VARIABLE_ModuleInfo_29_214);
  hlds__hlds_module__module_info_set_user_final_pred_target_names_3_p_0(FinalPredTargetNames_106, STATE_VARIABLE_ModuleInfo_29_214, &STATE_VARIABLE_ModuleInfo_30_215);
  hlds__make_hlds__add_pragma__add_decl_pragmas_8_p_0(ProgressStream_13, DeclPragmas_63, STATE_VARIABLE_ModuleInfo_30_215, &STATE_VARIABLE_ModuleInfo_31_216, STATE_VARIABLE_QualInfo_4_199, &STATE_VARIABLE_QualInfo_5_217, STATE_VARIABLE_Specs_26_213, &STATE_VARIABLE_Specs_27_218);
  hlds__make_hlds__add_pragma__add_decl_pragmas_type_spec_constr_8_p_0(ProgressStream_13, DeclTypeSpecConstr_65, STATE_VARIABLE_ModuleInfo_31_216, &STATE_VARIABLE_ModuleInfo_32_219, STATE_VARIABLE_QualInfo_5_217, &STATE_VARIABLE_QualInfo_6_220, STATE_VARIABLE_Specs_27_218, &STATE_VARIABLE_Specs_28_221);
  hlds__make_hlds__add_pragma__add_decl_pragmas_type_spec_7_p_0(DeclTypeSpec_66, STATE_VARIABLE_ModuleInfo_32_219, &STATE_VARIABLE_ModuleInfo_33_222, STATE_VARIABLE_QualInfo_6_220, &STATE_VARIABLE_QualInfo_7_223, STATE_VARIABLE_Specs_28_221, &STATE_VARIABLE_Specs_29_224);
  hlds__make_hlds__add_pragma__add_decl_pragmas_termination_5_p_0(DeclTermination_67, STATE_VARIABLE_ModuleInfo_33_222, &STATE_VARIABLE_ModuleInfo_34_225, STATE_VARIABLE_Specs_29_224, &STATE_VARIABLE_Specs_30_226);
  hlds__make_hlds__add_pragma__add_decl_pragmas_termination2_5_p_0(DeclTermination2_68, STATE_VARIABLE_ModuleInfo_34_225, &STATE_VARIABLE_ModuleInfo_35_227, STATE_VARIABLE_Specs_30_226, &STATE_VARIABLE_Specs_31_228);
  hlds__make_hlds__add_pragma__add_decl_pragmas_sharing_5_p_0(DeclSharing_69, STATE_VARIABLE_ModuleInfo_35_227, &STATE_VARIABLE_ModuleInfo_36_229, STATE_VARIABLE_Specs_31_228, &STATE_VARIABLE_Specs_32_230);
  hlds__make_hlds__add_pragma__add_decl_pragmas_reuse_5_p_0(DeclReuse_70, STATE_VARIABLE_ModuleInfo_36_229, &STATE_VARIABLE_ModuleInfo_37_231, STATE_VARIABLE_Specs_32_230, &STATE_VARIABLE_Specs_33_232);
  Var_233 = mercury__cord__init_0_f_0((MR_Word) (&hlds__make_hlds__make_hlds_passes_scalar_common_1[5]));
  hlds__make_hlds__add_pragma__add_impl_pragmas_8_p_0(ProgressStream_13, ImplPragmas_71, Var_233, &PragmaTabledCord_107, STATE_VARIABLE_ModuleInfo_37_231, &STATE_VARIABLE_ModuleInfo_38_234, STATE_VARIABLE_Specs_33_232, &STATE_VARIABLE_Specs_34_235);
  ...
  hlds__make_hlds__add_pragma__add_impl_pragmas_tabled_8_p_0(ProgressStream_13, PragmasTabled_108, STATE_VARIABLE_ModuleInfo_38_234, &STATE_VARIABLE_ModuleInfo_39_236, STATE_VARIABLE_QualInfo_7_223, &STATE_VARIABLE_QualInfo_8_237, STATE_VARIABLE_Specs_34_235, &STATE_VARIABLE_Specs_35_238);
  ...
  mercury__list__foldl2_6_p_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_impl_pragma_fproc_export_info_0), (MR_Word) (&hlds__hlds_module__hlds__hlds_module__type_ctor_info_module_info_0), (MR_Word) (&hlds__make_hlds__make_hlds_passes_scalar_common_1[4]), (MR_Word) (&hlds__make_hlds__make_hlds_passes_scalar_common_2[6]), FPEInfos_109, ((MR_Box) (STATE_VARIABLE_ModuleInfo_39_236)), &conv13_STATE_VARIABLE_ModuleInfo_40_240, ((MR_Box) (STATE_VARIABLE_Specs_35_238)), &conv12_STATE_VARIABLE_Specs_36_241);
  STATE_VARIABLE_ModuleInfo_40_240 = ((MR_Word) (conv13_STATE_VARIABLE_ModuleInfo_40_240));
  STATE_VARIABLE_Specs_36_241 = ((MR_Word) (conv12_STATE_VARIABLE_Specs_36_241));
  mercury__list__foldl_4_p_0((MR_Word) (&parse_tree__prog_foreign__parse_tree__prog_foreign__type_ctor_info_foreign_decl_code_0), (MR_Word) (&hlds__hlds_module__hlds__hlds_module__type_ctor_info_module_info_0), (MR_Word) (&hlds__make_hlds__make_hlds_passes_scalar_common_2[7]), MutableForeignDeclCodes_97, ((MR_Box) (STATE_VARIABLE_ModuleInfo_40_240)), &conv15_STATE_VARIABLE_ModuleInfo_41_243);
  STATE_VARIABLE_ModuleInfo_41_243 = ((MR_Word) (conv15_STATE_VARIABLE_ModuleInfo_41_243));
  mercury__list__foldl_4_p_0((MR_Word) (&parse_tree__prog_foreign__parse_tree__prog_foreign__type_ctor_info_foreign_body_code_0), (MR_Word) (&hlds__hlds_module__hlds__hlds_module__type_ctor_info_module_info_0), (MR_Word) (&hlds__make_hlds__make_hlds_passes_scalar_common_2[8]), MutableForeignBodyCodes_98, ((MR_Box) (STATE_VARIABLE_ModuleInfo_41_243)), &conv17_STATE_VARIABLE_ModuleInfo_42_245);
  STATE_VARIABLE_ModuleInfo_42_245 = ((MR_Word) (conv17_STATE_VARIABLE_ModuleInfo_42_245));
  mercury__list__foldl2_6_p_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_gen_pragma_unused_args_info_0), (MR_Word) (&hlds__hlds_module__hlds__hlds_module__type_ctor_info_module_info_0), (MR_Word) (&hlds__make_hlds__make_hlds_passes_scalar_common_1[4]), (MR_Word) (&hlds__make_hlds__make_hlds_passes_scalar_common_2[9]), GenUnusedArgs_73, ((MR_Box) (STATE_VARIABLE_ModuleInfo_42_245)), &conv21_STATE_VARIABLE_ModuleInfo_43_247, ((MR_Box) (STATE_VARIABLE_Specs_36_241)), &conv20_STATE_VARIABLE_Specs_37_248);
  STATE_VARIABLE_ModuleInfo_43_247 = ((MR_Word) (conv21_STATE_VARIABLE_ModuleInfo_43_247));
  STATE_VARIABLE_Specs_37_248 = ((MR_Word) (conv20_STATE_VARIABLE_Specs_37_248));
  mercury__list__foldl2_6_p_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_gen_pragma_exceptions_info_0), (MR_Word) (&hlds__hlds_module__hlds__hlds_module__type_ctor_info_module_info_0), (MR_Word) (&hlds__make_hlds__make_hlds_passes_scalar_common_1[4]), (MR_Word) (&hlds__make_hlds__make_hlds_passes_scalar_common_2[10]), GenExceptions_74, ((MR_Box) (STATE_VARIABLE_ModuleInfo_43_247)), &conv25_STATE_VARIABLE_ModuleInfo_44_250, ((MR_Box) (STATE_VARIABLE_Specs_37_248)), &conv24_STATE_VARIABLE_Specs_38_251);
  STATE_VARIABLE_ModuleInfo_44_250 = ((MR_Word) (conv25_STATE_VARIABLE_ModuleInfo_44_250));
  STATE_VARIABLE_Specs_38_251 = ((MR_Word) (conv24_STATE_VARIABLE_Specs_38_251));
  mercury__list__foldl2_6_p_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_gen_pragma_trailing_info_0), (MR_Word) (&hlds__hlds_module__hlds__hlds_module__type_ctor_info_module_info_0), (MR_Word) (&hlds__make_hlds__make_hlds_passes_scalar_common_1[4]), (MR_Word) (&hlds__make_hlds__make_hlds_passes_scalar_common_2[11]), GenTrailing_75, ((MR_Box) (STATE_VARIABLE_ModuleInfo_44_250)), &conv29_STATE_VARIABLE_ModuleInfo_45_253, ((MR_Box) (STATE_VARIABLE_Specs_38_251)), &conv28_STATE_VARIABLE_Specs_39_254);
  STATE_VARIABLE_ModuleInfo_45_253 = ((MR_Word) (conv29_STATE_VARIABLE_ModuleInfo_45_253));
  STATE_VARIABLE_Specs_39_254 = ((MR_Word) (conv28_STATE_VARIABLE_Specs_39_254));
  mercury__list__foldl2_6_p_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_gen_pragma_mm_tabling_info_0), (MR_Word) (&hlds__hlds_module__hlds__hlds_module__type_ctor_info_module_info_0), (MR_Word) (&hlds__make_hlds__make_hlds_passes_scalar_common_1[4]), (MR_Word) (&hlds__make_hlds__make_hlds_passes_scalar_common_2[12]), GenMMTabling_76, ((MR_Box) (STATE_VARIABLE_ModuleInfo_45_253)), &conv33_STATE_VARIABLE_ModuleInfo_119, ((MR_Box) (STATE_VARIABLE_Specs_39_254)), &conv32_STATE_VARIABLE_Specs_40_257);
  *STATE_VARIABLE_ModuleInfo_119 = ((MR_Word) (conv33_STATE_VARIABLE_ModuleInfo_119));
  STATE_VARIABLE_Specs_40_257 = ((MR_Word) (conv32_STATE_VARIABLE_Specs_40_257));
  hlds__make_hlds__add_pred__check_preds_if_field_access_function_4_p_0(*STATE_VARIABLE_ModuleInfo_119, PredDecls_52, STATE_VARIABLE_Specs_40_257, STATE_VARIABLE_Specs_120);
  ModuleItemVersionNumbers_110 = ((MR_Word) ((MR_hl_field(0, AugCompUnit_14, 8))));
  mercury__map__foldl_4_p_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), (MR_Word) (&recompilation__item_types__recompilation__item_types__type_ctor_info_module_item_version_numbers_0), (MR_Word) (&hlds__make_hlds__qual_info__hlds__make_hlds__qual_info__type_ctor_info_qual_info_0), (MR_Word) (&hlds__make_hlds__make_hlds_passes_scalar_common_2[13]), ModuleItemVersionNumbers_110, ((MR_Box) (STATE_VARIABLE_QualInfo_8_237)), &conv35_STATE_VARIABLE_QualInfo_116);
  *STATE_VARIABLE_QualInfo_116 = ((MR_Word) (conv35_STATE_VARIABLE_QualInfo_116));
  ...
  if (succeeded)
    ...
    *STATE_VARIABLE_FoundInvalidType_117 = STATE_VARIABLE_FoundInvalidType_6_184;
  ...
  if (succeeded)
    ...
    *STATE_VARIABLE_FoundInvalidInstOrMode_118 = STATE_VARIABLE_FoundInvalidInstOrMode_4_165;
}
