...
{
  {
    ...
    if ((MaybeForeignType_5 == (MR_Word) ((MR_Integer) 0)))
...
{
  {
    ...
    if (succeeded)
    {
      ...
      switch (MR_tag((MR_Word) TypeBody_10)) {
        ...
        case (MR_Integer) 1:
        case (MR_Integer) 2:
          MaybeForeignTypeAssertions_6 = (MR_Word) ((MR_Integer) 0);
          break;
        case (MR_Integer) 3:
          MaybeForeignTypeAssertions_6 = (MR_Word) ((MR_Integer) 0);
          break;
...
{
  {
    ...
    switch (Target_16) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        if ((MaybeC_11 == (MR_Word) ((MR_Integer) 0)))
        {
          {
        ...
        break;
      case (MR_Integer) 1:
        if ((MaybeCSharp_13 == (MR_Word) ((MR_Integer) 0)))
        {
          {
            mercury__require__unexpected_2_p_0((MR_String) "predicate \140backend_libs.foreign.foreign_type_body_to_exported_type\'/5", (MR_String) "no C# type");
            return;
        ...
        break;
      case (MR_Integer) 3:
        if ((MaybeErlang_14 == (MR_Word) ((MR_Integer) 0)))
        {
          {
        ...
        break;
      case (MR_Integer) 2:
        if ((MaybeJava_12 == (MR_Word) ((MR_Integer) 0)))
        {
          {
