...
{
  {
    ...
    MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), LambdaHeadVar__1_15, (MR_Integer) 0)));
...
{
  {
    ...
    MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), LambdaHeadVar__1_13, (MR_Integer) 0)));
  ...
  MR_Word LambdaHeadVar__1_14)
{
  {
    MR_bool succeeded;
    MR_Word Lang_18 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), LambdaHeadVar__1_14, (MR_Integer) 0))) >> (MR_Integer) 1)) & (MR_Integer) 3);
    MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), LambdaHeadVar__1_14, (MR_Integer) 0)));
...
{
  {
    ...
    succeeded = ((MR_tag((MR_Word) MaybeCanonical_8)) == (MR_Integer) 1);
    if (succeeded)
      ...
      case (MR_Integer) 1:
        {
          ...
          MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), BuiltinType_3, (MR_Integer) 0)));
