...
MR_decl_label10(backend_libs__foreign__foreign_type_body_to_exported_type_5_0, 2,3,5,12,10,17,15,22,20,26)
MR_decl_label2(backend_libs__foreign__foreign_type_body_to_exported_type_5_0, 24,30)
MR_decl_label6(backend_libs__foreign__have_foreign_type_for_backend_3_0, 3,7,11,15,20,19)
...
MR_decl_label7(__Compare___backend_libs__foreign__exported_type_0_0, 3,2,9,7,5,15,55)
...
MR_BEGIN_MODULE(backend_libs__foreign_module1)
	...
	MR_init_label6(backend_libs__foreign__have_foreign_type_for_backend_3_0,3,7,11,15,20,19)
MR_BEGIN_CODE
...
MR_def_label(backend_libs__foreign__have_foreign_type_for_backend_3_0,3)
	...
	if (MR_INT_NE(MR_r1,2)) {
		MR_GOTO_LAB(backend_libs__foreign__have_foreign_type_for_backend_3_0_i7);
	}
	{
	MR_Word MR_tempr1;
...
MR_def_label(backend_libs__foreign__have_foreign_type_for_backend_3_0,7)
	...
	if (MR_INT_NE(MR_r1,5)) {
		MR_GOTO_LAB(backend_libs__foreign__have_foreign_type_for_backend_3_0_i11);
	}
	{
	MR_Word MR_tempr1;
...
MR_def_label(backend_libs__foreign__have_foreign_type_for_backend_3_0,11)
	...
	if (MR_INT_NE(MR_r1,1)) {
		MR_GOTO_LAB(backend_libs__foreign__have_foreign_type_for_backend_3_0_i15);
	}
	{
	MR_Word MR_tempr1;
...
MR_def_label(backend_libs__foreign__have_foreign_type_for_backend_3_0,15)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,3)) {
		MR_GOTO_LAB(backend_libs__foreign__have_foreign_type_for_backend_3_0_i19);
	}
	{
	MR_Word MR_tempr1;
...
MR_BEGIN_MODULE(backend_libs__foreign_module2)
	...
	MR_init_label10(backend_libs__foreign__foreign_type_body_to_exported_type_5_0,2,3,5,12,10,17,15,22,20,26)
	MR_init_label2(backend_libs__foreign__foreign_type_body_to_exported_type_5_0,24,30)
MR_BEGIN_CODE
...
MR_def_label(backend_libs__foreign__foreign_type_body_to_exported_type_5_0,5)
	...
	if (MR_LTAGS_TEST(MR_sv(4),0,0)) {
		MR_GOTO_LAB(backend_libs__foreign__foreign_type_body_to_exported_type_5_0_i12);
	}
	MR_tag_alloc_heap(MR_r1, 0, (MR_Integer) 1);
	{
	MR_Word MR_tempr1;
...
MR_def_label(backend_libs__foreign__foreign_type_body_to_exported_type_5_0,12)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_BEGIN_MODULE(backend_libs__foreign_module16)
	...
	MR_init_label7(__Compare___backend_libs__foreign__exported_type_0_0,3,2,9,7,5,15,55)
MR_BEGIN_CODE
...
MR_def_label(__Compare___backend_libs__foreign__exported_type_0_0,9)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___backend_libs__foreign__exported_type_0_0_i55);
	}
	MR_r1 = (MR_Word) MR_TAG_COMMON(0,0,0);
	MR_r2 = MR_sv(2);
	MR_r3 = MR_sv(1);
...
MR_def_label(__Compare___backend_libs__foreign__exported_type_0_0,55)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(3);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
...
void mercury__backend_libs__foreign__write_out_proc_statics(FILE *deep_fp, FILE *procrep_fp)
{
	MR_write_out_module_proc_reps_start(procrep_fp, &mercury_data__module_layout__backend_libs__foreign);
