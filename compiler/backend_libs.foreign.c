...
backend_libs__foreign__IntroducedFrom__pred__filter_exports__522__1_2_p_0(
  MR_Word WantedLang_5,
  MR_Word LambdaHeadVar__1_15);

static MR_bool MR_CALL 
backend_libs__foreign__IntroducedFrom__pred__filter_bodys__517__1_2_p_0(
  MR_Word WantedLang_5,
  MR_Word LambdaHeadVar__1_13);

static MR_bool MR_CALL 
backend_libs__foreign__IntroducedFrom__pred__filter_decls__512__1_2_p_0(
  MR_Word WantedLang_5,
...
{
  {
    ...
    succeeded = backend_libs__foreign__IntroducedFrom__pred__filter_exports__522__1_2_p_0(((MR_Word) (MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3))), ((MR_Word) wrapper_arg_1));
    return succeeded;
  }
}
...
{
  {
    ...
    succeeded = backend_libs__foreign__IntroducedFrom__pred__filter_bodys__517__1_2_p_0(((MR_Word) (MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3))), ((MR_Word) wrapper_arg_1));
    return succeeded;
  }
}
...
{
  {
    ...
    succeeded = backend_libs__foreign__IntroducedFrom__pred__filter_decls__512__1_2_p_0(((MR_Word) (MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3))), ((MR_Word) wrapper_arg_1));
    return succeeded;
  }
}
