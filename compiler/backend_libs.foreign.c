  ...
  MR_Word MaybeForeignType_5)
{
  ...
  else
  {
    ...
    MR_Word Var_27 = ((MR_Word) ((MR_hl_field(1, MaybeForeignType_5, (MR_Integer) 0))));

    ForeignType_7 = ((MR_Word) ((MR_hl_field(0, Var_27, (MR_Integer) 0))));
  ...
  MR_Word MaybeForeignType_5)
{
  ...
  else
  {
    ...
    MR_Word ForeignType_28 = ((MR_Word) ((MR_hl_field(0, ForeignTypeAndAssertions_7, (MR_Integer) 0))));

    if (((MR_tag((MR_Word) ForeignType_28)) == (MR_Integer) 1))
      mercury__require__unexpected_2_p_0((MR_String) "function \140backend_libs.foreign.foreign_type_to_c_string\'/1", (MR_String) "qualified C type");
    else
      String_6 = ((MR_String) ((MR_hl_field(0, ForeignType_28, (MR_Integer) 0))));
  }
  return String_6;
}
