            ...
            case (MR_Integer) 2:
              {
                ...
                Var_52 = libs__globals__foreign_language_string_1_f_0(ForeignLanguage_36);
                Var_55 = libs__globals__foreign_language_string_1_f_0(TargetLang_27);
                Var_53 = mercury__string__f_43_43_2_f_0((MR_String) " foreign code from ", Var_55);
                Var_51 = mercury__string__f_43_43_2_f_0(Var_52, Var_53);
                Var_49 = mercury__string__f_43_43_2_f_0((MR_String) "unimplemented: calling ", Var_51);
                {
                  mercury__require__sorry_2_p_0((MR_String) "predicate \140backend_libs.foreign.unimplemented_combination\'/2", Var_49);
                  return;
                }
              }
              break;
            ...
            case (MR_Integer) 2:
              {
                ...
                Var_60 = libs__globals__foreign_language_string_1_f_0(ForeignLanguage_36);
                Var_63 = libs__globals__foreign_language_string_1_f_0(TargetLang_27);
                Var_61 = mercury__string__f_43_43_2_f_0((MR_String) " foreign code from ", Var_63);
                Var_59 = mercury__string__f_43_43_2_f_0(Var_60, Var_61);
                Var_57 = mercury__string__f_43_43_2_f_0((MR_String) "unimplemented: calling ", Var_59);
                {
                  mercury__require__sorry_2_p_0((MR_String) "predicate \140backend_libs.foreign.unimplemented_combination\'/2", Var_57);
                  return;
                }
              }
              break;
            ...
            case (MR_Integer) 1:
              {
                ...
                Var_68 = libs__globals__foreign_language_string_1_f_0(ForeignLanguage_36);
                Var_71 = libs__globals__foreign_language_string_1_f_0(TargetLang_27);
                Var_69 = mercury__string__f_43_43_2_f_0((MR_String) " foreign code from ", Var_71);
                Var_67 = mercury__string__f_43_43_2_f_0(Var_68, Var_69);
                Var_65 = mercury__string__f_43_43_2_f_0((MR_String) "unimplemented: calling ", Var_67);
                {
                  mercury__require__sorry_2_p_0((MR_String) "predicate \140backend_libs.foreign.unimplemented_combination\'/2", Var_65);
                  return;
                }
              }
              break;
  ...
  MR_Box wrapper_arg_1)
{
  ...
  succeeded = backend_libs__foreign__IntroducedFrom__pred__filter_exports__519__1_2_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) (wrapper_arg_1)));
  return succeeded;
}
  ...
  MR_Word * NotLangExports_8)
{
...

  {
    ...
    MR_hl_field(MR_mktag(0), IsWanted_9, 0) = ((MR_Box) (&backend_libs__foreign_scalar_common_2[2]));
  ...
  MR_Box wrapper_arg_1)
{
  ...
  succeeded = backend_libs__foreign__IntroducedFrom__pred__filter_bodys__512__1_2_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) (wrapper_arg_1)));
  return succeeded;
}
  ...
  MR_Word * NotLangBodys_8)
{
  ...
  {
    IsWanted_9 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(MR_mktag(0), IsWanted_9, 0) = ((MR_Box) (&backend_libs__foreign_scalar_common_2[1]));
  ...
  MR_Box wrapper_arg_1)
{
  ...
  succeeded = backend_libs__foreign__IntroducedFrom__pred__filter_decls__505__1_2_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) (wrapper_arg_1)));
  return succeeded;
}
  ...
  MR_Word * NotLangDecls_8)
{
  ...
  {
    IsWanted_9 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(MR_mktag(0), IsWanted_9, 0) = ((MR_Box) (&backend_libs__foreign_scalar_common_2[0]));
  ...
  MR_Word * Have_6)
{
  ...
  switch (Target_4) {
    ...
    case (MR_Integer) 0:
      {
        MR_Word Var_12 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ForeignTypeBody_5, (MR_Integer) 0))));
    ...
    case (MR_Integer) 1:
      {
        MR_Word Var_10 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ForeignTypeBody_5, (MR_Integer) 2))));
    ...
    case (MR_Integer) 2:
      {
        MR_Word Var_11 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ForeignTypeBody_5, (MR_Integer) 1))));
  ...
  MR_Word MaybeForeignType_5)
{
  ...
  else
  {
    ...
    MR_Word ForeignType_28 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ForeignTypeAndAssertions_7, (MR_Integer) 0))));

    if (((MR_tag((MR_Word) ForeignType_28)) == (MR_Integer) 1))
      mercury__require__unexpected_2_p_0((MR_String) "function \140backend_libs.foreign.foreign_type_to_c_string\'/1", (MR_String) "qualified C type");
    else
      String_6 = ((MR_String) ((MR_hl_field(MR_mktag(0), ForeignType_28, (MR_Integer) 0))));
  }
  return String_6;
}
      ...
      case (MR_Integer) 1:
        {
          ...
          backend_libs__foreign__foreign_type_body_to_exported_type_5_p_0(ModuleInfo_4, ForeignTypeBody_11, &ForeignTypeName_12, &Var_13, &Assertions_14);
          {
            ...
            MR_hl_field(MR_mktag(0), Var_19, 0) = ((MR_Box) (ForeignTypeName_12));
            MR_hl_field(MR_mktag(0), Var_19, 1) = ((MR_Box) (Assertions_14));
          }
          {
            MaybeForeignTypeAssertions_6 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), MaybeForeignTypeAssertions_6, 0) = ((MR_Box) (Var_19));
          }
        }
        break;
      case (MR_Integer) 2:
  ...
  MR_Word * Assertions_10)
{
  ...
  switch (Target_15) {
    ...
    case (MR_Integer) 0:
      ...
      {
        MR_Word Data_16 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MaybeC_11, (MR_Integer) 0))));
        MR_String NameStr_17;
        MR_Word Var_26 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Data_16, (MR_Integer) 0))));

        *MaybeUserEqComp_9 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Data_16, (MR_Integer) 1))));
        *Assertions_10 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Data_16, (MR_Integer) 2))));
        NameStr_17 = (MR_String) (Var_26);
        {
          MR_Word base;
          base = (MR_Word) MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL);
          *Name_8 = base;
          MR_hl_field(MR_mktag(0), base, 0) = ((MR_Box) (NameStr_17));
        }
      }
      break;
    case (MR_Integer) 1:
      ...
      {
        MR_Word Var_23;
        MR_Word Data_27 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MaybeCSharp_13, (MR_Integer) 0))));
        MR_String NameStr_28;

        Var_23 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Data_27, (MR_Integer) 0))));
        *MaybeUserEqComp_9 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Data_27, (MR_Integer) 1))));
        *Assertions_10 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Data_27, (MR_Integer) 2))));
        NameStr_28 = (MR_String) (Var_23);
        {
          MR_Word base;
          base = (MR_Word) MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL);
          *Name_8 = base;
          MR_hl_field(MR_mktag(0), base, 0) = ((MR_Box) (NameStr_28));
        }
      }
      break;
    case (MR_Integer) 2:
      ...
      {
        MR_Word Var_20;
        MR_Word Data_33 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MaybeJava_12, (MR_Integer) 0))));
        MR_String NameStr_34;

        Var_20 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Data_33, (MR_Integer) 0))));
        *MaybeUserEqComp_9 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Data_33, (MR_Integer) 1))));
        *Assertions_10 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Data_33, (MR_Integer) 2))));
        NameStr_34 = (MR_String) (Var_20);
        {
          MR_Word base;
          base = (MR_Word) MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL);
          *Name_8 = base;
          MR_hl_field(MR_mktag(0), base, 0) = ((MR_Box) (NameStr_34));
        }
      }
      break;
  }
