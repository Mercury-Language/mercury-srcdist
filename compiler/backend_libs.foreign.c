...
MR_decl_label10(backend_libs__foreign__foreign_type_body_to_exported_type_5_0, 2,3,5,10,17,15,22,20,26,24)
MR_decl_label1(backend_libs__foreign__foreign_type_body_to_exported_type_5_0, 30)
...
MR_decl_label6(backend_libs__foreign__have_foreign_type_for_backend_3_0, 31,3,5,9,13,18)
...
MR_decl_label8(fn__backend_libs__foreign__exported_type_to_string_2_0, 11,26,27,28,24,22,29,31)
...
MR_BEGIN_MODULE(backend_libs__foreign_module1)
	...
	MR_init_label6(backend_libs__foreign__have_foreign_type_for_backend_3_0,31,3,5,9,13,18)
MR_BEGIN_CODE
...
MR_def_label(backend_libs__foreign__have_foreign_type_for_backend_3_0,31)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Integer) 0;
...
MR_def_label(backend_libs__foreign__have_foreign_type_for_backend_3_0,13)
	...
	if (MR_INT_NE(MR_r1,2)) {
		MR_GOTO_LAB(backend_libs__foreign__have_foreign_type_for_backend_3_0_i31);
	}
	{
	MR_Word MR_tempr1;
...
MR_BEGIN_MODULE(backend_libs__foreign_module2)
	...
	MR_init_label10(backend_libs__foreign__foreign_type_body_to_exported_type_5_0,2,3,5,10,17,15,22,20,26,24)
	MR_init_label1(backend_libs__foreign__foreign_type_body_to_exported_type_5_0,30)
MR_BEGIN_CODE
...
MR_def_label(backend_libs__foreign__foreign_type_body_to_exported_type_5_0,3)
	...
	if (MR_LTAGS_TEST(MR_sv(2),0,0)) {
		MR_GOTO_LAB(backend_libs__foreign__foreign_type_body_to_exported_type_5_0_i30);
	}
...
MR_def_label(backend_libs__foreign__foreign_type_body_to_exported_type_5_0,20)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,2)) {
		MR_GOTO_LAB(backend_libs__foreign__foreign_type_body_to_exported_type_5_0_i24);
	}
...
MR_def_label(backend_libs__foreign__foreign_type_body_to_exported_type_5_0,30)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_string_const("foreign.m", 9);
...
MR_BEGIN_MODULE(backend_libs__foreign_module6)
	...
	MR_init_label8(fn__backend_libs__foreign__exported_type_to_string_2_0,11,26,27,28,24,22,29,31)
MR_BEGIN_CODE
