    ...
    else
    {
      ...
      if (succeeded)
        *HeadVar__1_1 = Var_8;
        ...
        parse_tree__prog_data____Compare____foreign_type_assertions_0_0(HeadVar__1_1, ArgX2_6, ArgY2_7);
    }
  }
}
...
{
  {
    ...
    else
    {
      ...
      MR_Word TargetLangs_28 = ((MR_Word) ((MR_hl_field(MR_mktag(1), HeadVar__1_1, (MR_Integer) 1))));
...
{
  {
    ...
    succeeded = ((MR_tag((MR_Word) MaybeCanonical_8)) == (MR_mktag((MR_Integer) 1)));
    if (succeeded)
...
{
  {
    ...
    MR_Word Var_6 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ForeignTypeAndAssertions_3, (MR_Integer) 1))));

    if (((MR_tag((MR_Word) ForeignType_5)) == (MR_mktag((MR_Integer) 1))))
    {
...
{
  {
    ...
    if ((MaybeForeignType_5 == (MR_Word) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
    ...
    else
    {
      ...
      Var_8 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_27, (MR_Integer) 1))));
...
{
  {
    ...
    else
    {
      ...
      MR_Word Var_31 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ForeignTypeAndAssertions_7, (MR_Integer) 1))));

      if (((MR_tag((MR_Word) ForeignType_30)) == (MR_mktag((MR_Integer) 1))))
      {
        mercury__require__unexpected_2_p_0((MR_String) "function \140backend_libs.foreign.foreign_type_to_c_string\'/1", (MR_String) "qualified C type");
      }
      else
...
{
  {
    ...
    if (succeeded)
    {
      ...
      switch (MR_tag((MR_Word) TypeBody_10)) {
        ...
        case (MR_Integer) 0:
          {
            ...
            {
              MaybeForeignTypeAssertions_6 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
        ...
        case (MR_Integer) 1:
        case (MR_Integer) 2:
          MaybeForeignTypeAssertions_6 = (MR_Word) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)));
          break;
        case (MR_Integer) 3:
          MaybeForeignTypeAssertions_6 = (MR_Word) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)));
          break;
