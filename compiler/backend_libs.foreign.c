...
static void MR_CALL 
backend_libs__foreign__foreign_code_to_identifiers_loop_3_p_0(
  MR_Word Chars0_4,
  MR_Word STATE_VARIABLE_IndentifierCord_0_11,
  MR_Word * STATE_VARIABLE_IndentifierCord_12);
...
backend_libs__foreign__foreign_code_to_identifiers_3_p_0(
  MR_Word _Lang_4,
  MR_String Code_5,
  MR_Word * Indentifiers_6)
{
  backend_libs__foreign__f_85_110_117_115_101_100_65_114_103_115_95_95_112_114_101_100_95_95_102_111_114_101_105_103_110_95_99_111_100_101_95_116_111_95_105_100_101_110_116_105_102_105_101_114_115_95_95_91_49_93_95_48_3_p_0(Code_5, Indentifiers_6);
}
  ...
  MR_Word * Indentifiers_6)
{
  ...
  backend_libs__foreign__foreign_code_to_identifiers_loop_3_p_0(Chars_7, Var_9, &IndentifierCord_8);
  *Indentifiers_6 = mercury__cord__list_1_f_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), IndentifierCord_8);
}
  ...
  MR_Word * STATE_VARIABLE_IndentifierCord_12)
{
  while (MR_TRUE)
  {
    MR_Word IndentifierChars_6;
    MR_Word Chars1_7;

    // setup for model_det tailcalls optimized into a loop
    ;
    backend_libs__foreign__get_next_identifier_3_p_0(Chars0_4, &IndentifierChars_6, &Chars1_7);
    if ((IndentifierChars_6 == (MR_Word) ((MR_Unsigned) 0U)))
      *STATE_VARIABLE_IndentifierCord_12 = STATE_VARIABLE_IndentifierCord_0_11;
    else
    {
      MR_String Indentifier_10;
      MR_Word STATE_VARIABLE_IndentifierCord_1_13;
      MR_Word next_value_of_Chars0_4;
      MR_Word next_value_of_STATE_VARIABLE_IndentifierCord_0_11;

      mercury__string__from_char_list_2_p_0(IndentifierChars_6, &Indentifier_10);
      mercury__cord__snoc_3_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), ((MR_Box) (Indentifier_10)), STATE_VARIABLE_IndentifierCord_0_11, &STATE_VARIABLE_IndentifierCord_1_13);
      // direct tailcall eliminated
      ;
      next_value_of_Chars0_4 = Chars1_7;
      next_value_of_STATE_VARIABLE_IndentifierCord_0_11 = STATE_VARIABLE_IndentifierCord_1_13;
      Chars0_4 = next_value_of_Chars0_4;
      STATE_VARIABLE_IndentifierCord_0_11 = next_value_of_STATE_VARIABLE_IndentifierCord_0_11;
      continue;
    }
    break;
  }
