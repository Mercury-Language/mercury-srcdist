...
backend_libs__foreign__IntroducedFrom__pred__filter_exports__514__1_2_p_0(
  MR_Word WantedLang_5,
  MR_Word LambdaHeadVar__1_15);

static MR_bool MR_CALL 
backend_libs__foreign__IntroducedFrom__pred__filter_bodys__507__1_2_p_0(
  MR_Word WantedLang_5,
  MR_Word LambdaHeadVar__1_13);

static MR_bool MR_CALL 
backend_libs__foreign__IntroducedFrom__pred__filter_decls__500__1_2_p_0(
  MR_Word WantedLang_5,
  ...
  MR_Box wrapper_arg_1)
{
  ...
  succeeded = backend_libs__foreign__IntroducedFrom__pred__filter_exports__514__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) (wrapper_arg_1)));
  return succeeded;
}
  ...
  MR_Box wrapper_arg_1)
{
  ...
  succeeded = backend_libs__foreign__IntroducedFrom__pred__filter_bodys__507__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) (wrapper_arg_1)));
  return succeeded;
}
  ...
  MR_Box wrapper_arg_1)
{
  ...
  succeeded = backend_libs__foreign__IntroducedFrom__pred__filter_decls__500__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) (wrapper_arg_1)));
  return succeeded;
}
  ...
  MR_Word MaybeForeignType_5)
{
  ...
  else
  {
    ...
    MR_Word Var_23 = ((MR_Word) ((MR_hl_field(1, MaybeForeignType_5, 0))));

    ForeignType_7 = ((MR_Word) ((MR_hl_field(0, Var_23, 0))));
  ...
  MR_Word MaybeForeignType_5)
{
  ...
  else
  {
    ...
    MR_Word ForeignType_24 = ((MR_Word) ((MR_hl_field(0, ForeignTypeAndAssertions_7, 0))));

    if (((MR_tag((MR_Word) ForeignType_24)) == (MR_Integer) 1))
      mercury__require__unexpected_2_p_0((MR_String) "function \140backend_libs.foreign.foreign_type_to_c_string\'/1", (MR_String) "qualified C type");
    else
      String_6 = ((MR_String) ((MR_hl_field(0, ForeignType_24, 0))));
  }
  return String_6;
}
