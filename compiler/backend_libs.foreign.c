...
MR_decl_label3(fn__backend_libs__foreign__exported_type_to_string_2_0, 28,30,33)
...
MR_BEGIN_MODULE(backend_libs__foreign_module6)
	...
	MR_init_label3(fn__backend_libs__foreign__exported_type_to_string_2_0,28,30,33)
MR_BEGIN_CODE
...
MR_def_label(fn__backend_libs__foreign__exported_type_to_string_2_0,14)
	...
	MR_r2 = (MR_Word) &MR_tfield(0, (MR_Word *) &mercury_vector_common_0_0, (MR_Integer) MR_tempr1);
	MR_r1 = MR_tfield(0, MR_r2, 0);
	MR_proceed();
	}
...
MR_def_label(fn__backend_libs__foreign__exported_type_to_string_2_0,33)
	...
	MR_Word MR_tempr1;
	MR_tempr1 = MR_tfield(2, MR_r3, 0);
	MR_r2 = (MR_Word) &MR_tfield(0, (MR_Word *) &mercury_vector_common_0_1, (MR_Integer) MR_tempr1);
	MR_r1 = MR_tfield(0, MR_r2, 0);
	MR_proceed();
	}
#ifdef MR_maybe_local_thread_engine_base
...
MR_def_label(backend_libs__foreign__handle_return_value_11_0,13)
	...
	MR_tfield(0, MR_r2, 1) = (MR_Word) MR_ENTRY_AP(backend_libs__foreign__include_import_arg_2_0);
...
MR_def_label(backend_libs__foreign__handle_return_value_11_0,38)
	...
	MR_tag_alloc_heap(MR_r2, 0, (MR_Integer) 4);
	MR_tfield(0, MR_r2, 0) = (MR_Word) MR_COMMON(1,7);
	MR_tfield(0, MR_r2, 1) = (MR_Word) MR_ENTRY_AP(backend_libs__foreign__include_import_arg_2_0);
	MR_tfield(0, MR_r2, 2) = (MR_Integer) 1;
	MR_tfield(0, MR_r2, 3) = MR_sv(4);
	MR_sv(1) = (MR_Word) MR_string_const("\n#error \"cannot import nondet procedure\"\n", 41);
...
MR_def_label(backend_libs__foreign__handle_return_value_11_0,18)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_tag_alloc_heap(MR_r2, 0, (MR_Integer) 4);
	MR_tfield(0, MR_r2, 0) = (MR_Word) MR_COMMON(1,8);
	MR_tfield(0, MR_r2, 1) = (MR_Word) MR_ENTRY_AP(backend_libs__foreign__include_import_arg_2_0);
	MR_tfield(0, MR_r2, 2) = (MR_Integer) 1;
	{
	MR_Word MR_tempr1;
