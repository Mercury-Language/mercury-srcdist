...
static MR_bool MR_CALL 
backend_libs__foreign__IntroducedFrom__pred__filter_exports__429__1_2_p_0(
  MR_Word backend_libs__foreign__WantedLang_5,
  MR_Word backend_libs__foreign__LambdaHeadVar__1_15);

static MR_bool MR_CALL 
backend_libs__foreign__IntroducedFrom__pred__filter_bodys__424__1_2_p_0(
  MR_Word backend_libs__foreign__WantedLang_5,
  MR_Word backend_libs__foreign__LambdaHeadVar__1_13);

static MR_bool MR_CALL 
backend_libs__foreign__IntroducedFrom__pred__filter_decls__419__1_2_p_0(
  MR_Word backend_libs__foreign__WantedLang_5,
...
static /* final */ const struct backend_libs__foreign__vector_common_type_1_0_s backend_libs__foreign_vector_common_1[15];
...
{
  {
    ...
    {
      backend_libs__foreign__succeeded = backend_libs__foreign__IntroducedFrom__pred__filter_exports__429__1_2_p_0(((MR_Word) (MR_hl_field(MR_mktag(0), backend_libs__foreign__closure, (MR_Integer) 3))), ((MR_Word) backend_libs__foreign__wrapper_arg_1));
    }
    return backend_libs__foreign__succeeded;
  }
}
...
{
  {
    ...
    {
      backend_libs__foreign__succeeded = backend_libs__foreign__IntroducedFrom__pred__filter_bodys__424__1_2_p_0(((MR_Word) (MR_hl_field(MR_mktag(0), backend_libs__foreign__closure, (MR_Integer) 3))), ((MR_Word) backend_libs__foreign__wrapper_arg_1));
    }
    return backend_libs__foreign__succeeded;
  }
}
...
{
  {
    ...
    {
      backend_libs__foreign__succeeded = backend_libs__foreign__IntroducedFrom__pred__filter_decls__419__1_2_p_0(((MR_Word) (MR_hl_field(MR_mktag(0), backend_libs__foreign__closure, (MR_Integer) 3))), ((MR_Word) backend_libs__foreign__wrapper_arg_1));
    }
    return backend_libs__foreign__succeeded;
  }
}
