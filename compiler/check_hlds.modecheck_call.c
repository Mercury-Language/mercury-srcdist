  ...
  MR_Box closure_arg)
{
  ...
  succeeded = check_hlds__modecheck_call__IntroducedFrom__pred__modecheck_event_call__541__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 4)))));
  return succeeded;
}
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = check_hlds__modecheck_call__IntroducedFrom__pred__get_higher_order_inst_match__490__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 4)))));
  return succeeded;
}
  ...
  MR_Word * STATE_VARIABLE_ModeInfo_41)
{
  ...
  {
    HOInstInfo_56 = ((MR_Word) ((MR_hl_field(2, PredVarInst_21, (MR_Integer) 1))));
    succeeded = MR_TRUE;
  }
  else
  if (((((MR_tag((MR_Word) PredVarInst_21)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(3, PredVarInst_21, (MR_Integer) 0)))) == (MR_Integer) 1))))
  {
  ...
  if (((MR_tag((MR_Word) Match_24)) == (MR_Integer) 0))
  {
    ...
    if (succeeded)
    {
      A_30 = ((MR_Unsigned) ((MR_hl_field(2, PredVarInst_21, (MR_Integer) 0))) & (MR_Integer) 7);
      B_31 = ((MR_Word) ((MR_hl_field(2, PredVarInst_21, (MR_Integer) 1))));
    ...
    if (succeeded)
    {
      ...
      {
        BetterPredVarInst_33 = (MR_Word) MR_mkword(3, MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(3, BetterPredVarInst_33, 0) = ((MR_Box) ((MR_Unsigned) 1U));
        MR_hl_field(3, BetterPredVarInst_33, 1) = (MR_Box) ((MR_Unsigned) (A_30));
        MR_hl_field(3, BetterPredVarInst_33, 2) = ((MR_Box) (B_31));
      }
  ...
  MR_Word * STATE_VARIABLE_ModeInfo_11)
{
  while (MR_TRUE)
  {
    ...
    {
      MR_Integer ProcId_26 = ((MR_Integer) ((MR_hl_field(1, HeadVar__1_1, (MR_Integer) 0))));
      MR_Word ProcIds_27 = ((MR_Word) ((MR_hl_field(1, HeadVar__1_1, (MR_Integer) 1))));
      MR_Word ProcInfo_34;
      ...
      {
        STATE_VARIABLE_RevProcInitialInsts_63_63 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(1, STATE_VARIABLE_RevProcInitialInsts_63_63, 0) = ((MR_Box) (InitialInsts_42));
        MR_hl_field(1, STATE_VARIABLE_RevProcInitialInsts_63_63, 1) = ((MR_Box) (STATE_VARIABLE_RevProcInitialInsts_0_6));
      }
      ...
      if ((Errors_44 == (MR_Word) ((MR_Unsigned) 0U)))
      {
...

        {
          ...
          MR_hl_field(0, NewMatchingProcMode_51, 0) = ((MR_Box) (ProcId_26));
          MR_hl_field(0, NewMatchingProcMode_51, 1) = ((MR_Box) (InstVarSub_43));
          MR_hl_field(0, NewMatchingProcMode_51, 2) = ((MR_Box) (ProcArgModes_39));
        }
        {
          STATE_VARIABLE_RevMatchingProcModes_71_71 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(1, STATE_VARIABLE_RevMatchingProcModes_71_71, 0) = ((MR_Box) (NewMatchingProcMode_51));
          MR_hl_field(1, STATE_VARIABLE_RevMatchingProcModes_71_71, 1) = ((MR_Box) (STATE_VARIABLE_RevMatchingProcModes_0_4));
        }
      ...
      {
        MR_Word FirstError_45 = ((MR_Word) ((MR_hl_field(1, Errors_44, (MR_Integer) 0))));
        ...
        ErrorWaitingVars_47 = ((MR_Word) ((MR_hl_field(0, FirstError_45, (MR_Integer) 0))));
