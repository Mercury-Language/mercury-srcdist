  ...
  MR_Word * STATE_VARIABLE_ModeInfo_41)
{
  ...
  {
    HOInstInfo_56 = ((MR_Word) ((MR_hl_field(MR_mktag(2), PredVarInst_21, (MR_Integer) 1))));
    succeeded = MR_TRUE;
  }
  else
  if (((((MR_tag((MR_Word) PredVarInst_21)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(MR_mktag(3), PredVarInst_21, (MR_Integer) 0)))) == (MR_Integer) 1))))
  {
    HOInstInfo_56 = ((MR_Word) ((MR_hl_field(MR_mktag(3), PredVarInst_21, (MR_Integer) 2))));
    succeeded = MR_TRUE;
  }
  else
    succeeded = MR_FALSE;
  if (succeeded)
    if ((HOInstInfo_56 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      ...
      succeeded = ((((MR_tag((MR_Word) Type_61)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(MR_mktag(3), Type_61, (MR_Integer) 0)))) == (MR_Integer) 1)));
      if (succeeded)
      {
        TypePredOrFunc_62 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(3), Type_61, (MR_Integer) 1))) & (MR_Integer) 1);
        ArgTypes_63 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Type_61, (MR_Integer) 2))));
        TypeHOInstInfo_64 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Type_61, (MR_Integer) 3))));
            ...
            case (MR_Integer) 1:
              {
                ...
                ActualPredOrFunc_192 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), PredInstInfo_191, (MR_Integer) 0))) & (MR_Integer) 1);
                Modes_193 = ((MR_Word) ((MR_hl_field(MR_mktag(0), PredInstInfo_191, (MR_Integer) 1))));
                ...
                if (succeeded)
                {
                  ...
                  else
                  {
                    ...
                    {
                      Mismatch_164 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                      MR_hl_field(MR_mktag(2), Mismatch_164, 0) = ((MR_Box) (ActualUserArity_172));
                    }
                    {
                      Match_24 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                      MR_hl_field(MR_mktag(1), Match_24, 0) = ((MR_Box) (Mismatch_164));
                    }
                  }
                }
                else
                {
                  ...
                  {
                    Mismatch_174 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(MR_mktag(1), Mismatch_174, 0) = (MR_Box) ((MR_Unsigned) (ActualPredOrFunc_192));
                  }
                  {
                    Match_24 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(MR_mktag(1), Match_24, 0) = ((MR_Box) (Mismatch_174));
                  }
                }
              }
              break;
            case (MR_Integer) 0:
              Match_24 = (MR_Word) (MR_mkword(MR_mktag(1), &check_hlds__modecheck_call_scalar_common_2[0]));
              break;
          }
        else
        {
          ...
          MR_Word ActualPredOrFunc_123 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), PredInstInfo_122, (MR_Integer) 0))) & (MR_Integer) 1);
          MR_Word Modes_124 = ((MR_Word) ((MR_hl_field(MR_mktag(0), PredInstInfo_122, (MR_Integer) 1))));
          MR_Word Match0_146;

          {
            Var_79 = (MR_Word) MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL);
            MR_hl_field(MR_mktag(0), Var_79, 0) = ((MR_Box) (&check_hlds__modecheck_call_scalar_common_3[0]));
            MR_hl_field(MR_mktag(0), Var_79, 1) = ((MR_Box) (check_hlds__modecheck_call__modecheck_higher_order_call_9_p_0_1));
            MR_hl_field(MR_mktag(0), Var_79, 2) = ((MR_Box) ((MR_Integer) 2));
            MR_hl_field(MR_mktag(0), Var_79, 3) = ((MR_Box) (TypePredOrFunc_62));
            MR_hl_field(MR_mktag(0), Var_79, 4) = ((MR_Box) (ActualPredOrFunc_123));
          }
          ...
          if (succeeded)
          {
            ...
            else
            {
              ...
              {
                Mismatch_104 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(2), Mismatch_104, 0) = ((MR_Box) (ActualUserArity_109));
              }
              {
                Match_24 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(1), Match_24, 0) = ((MR_Box) (Mismatch_104));
              }
            }
          }
          else
          {
            ...
            {
              Mismatch_114 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), Mismatch_114, 0) = (MR_Box) ((MR_Unsigned) (ActualPredOrFunc_123));
            }
            {
              Match_24 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), Match_24, 0) = ((MR_Box) (Mismatch_114));
            }
          }
        }
      }
      else
        Match_24 = (MR_Word) (MR_mkword(MR_mktag(1), &check_hlds__modecheck_call_scalar_common_2[1]));
    }
    else
    {
      MR_Word Match0_58;
      ...
      ActualPredOrFunc_73 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), PredInstInfo_72, (MR_Integer) 0))) & (MR_Integer) 1);
      Modes_74 = ((MR_Word) ((MR_hl_field(MR_mktag(0), PredInstInfo_72, (MR_Integer) 1))));
      ...
      if (succeeded)
      {
        ...
        else
        {
          ...
          {
            Mismatch_85 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(2), Mismatch_85, 0) = ((MR_Box) (ActualUserArity_78));
          }
          {
            Match_24 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), Match_24, 0) = ((MR_Box) (Mismatch_85));
          }
        }
      }
      else
      {
        ...
        {
          Mismatch_86 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), Mismatch_86, 0) = (MR_Box) ((MR_Unsigned) (ActualPredOrFunc_73));
        }
        {
          Match_24 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), Match_24, 0) = ((MR_Box) (Mismatch_86));
        }
      }
    }
  else
  ...
  if (((MR_tag((MR_Word) Match_24)) == (MR_Integer) 0))
  {
    ...
    else
    {
      ...
      *Detism_15 = Detism0_29;
      ...
      check_hlds__modecheck_util__modecheck_set_var_inst_list_8_p_0(ArgVars0_12, InitialInsts_94, FinalInsts_97, (MR_Integer) 1, ArgVars_13, ExtraGoals_16, STATE_VARIABLE_ModeInfo_23_99, &STATE_VARIABLE_ModeInfo_46_46);
  ...
  else
  {
    ...
    else
    {
      ...
      if ((RevMatchingProcModes_42 == (MR_Word) ((MR_Unsigned) 0U)))
      {
        ...
        check_hlds__modecheck_call__no_matching_modes_8_p_0(PredId_11, ArgVars0_15, ProcInitialInsts_45, MaybeDetism_12, WaitingVars1_44, SelectedProcId_14, STATE_VARIABLE_ModeInfo_78_78, &STATE_VARIABLE_ModeInfo_83_83);
        *ArgVars_16 = ArgVars0_15;
        *ExtraGoals_18 = (MR_Word) ((MR_Unsigned) 0U);
      }
      else
      {
        ...
        if ((CalleeModeErrors_49 == (MR_Word) ((MR_Unsigned) 0U)))
          check_hlds__modecheck_call__modecheck_end_of_call_9_p_0(ProcInfo_88, ProcArgModes_89, ArgVars0_15, ArgOffset_25, InstVarSub_90, ArgVars_16, ExtraGoals_18, STATE_VARIABLE_ModeInfo_78_78, &STATE_VARIABLE_ModeInfo_83_83);
        else
        {
          MR_Word ArgInsts_52;
          ...
          *ExtraGoals_18 = (MR_Word) ((MR_Unsigned) 0U);
          ...
          check_hlds__mode_info__mode_info_set_call_arg_context_3_p_0((MR_Integer) 0, STATE_VARIABLE_ModeInfo_78_78, &STATE_VARIABLE_ModeInfo_80_80);
          {
          ...
          check_hlds__mode_info__mode_info_error_4_p_0(WaitingVars_85, ModeError_53, STATE_VARIABLE_ModeInfo_80_80, &STATE_VARIABLE_ModeInfo_83_83);
        }
      }
      check_hlds__mode_info__mode_info_get_errors_2_p_0(STATE_VARIABLE_ModeInfo_83_83, &NewErrors_54);
      ...
      check_hlds__mode_info__mode_info_set_errors_3_p_0(Errors_55, STATE_VARIABLE_ModeInfo_83_83, STATE_VARIABLE_ModeInfo_57);
    }
  }
}
  ...
  MR_Word * STATE_VARIABLE_ModeInfo_23)
{
  ...
  if (succeeded)
  {
    ...
    check_hlds__mode_info__mode_info_get_instvarset_2_p_0(STATE_VARIABLE_ModeInfo_0_22, &InstVarSet_39);
    {
      ...
      MR_hl_field(MR_mktag(1), Var_42, 0) = ((MR_Box) (ArgLives_32));
    }
  ...
  MR_Word * STATE_VARIABLE_ModeInfo_11)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      MR_Word STATE_VARIABLE_RevMatchingProcModes_68_68;
      MR_Word STATE_VARIABLE_ModeInfo_70_70;
      MR_Word STATE_VARIABLE_WaitingVars_71_71;
      ...
      if ((Errors_44 == (MR_Word) ((MR_Unsigned) 0U)))
      {
        ...
        {
          STATE_VARIABLE_RevMatchingProcModes_68_68 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), STATE_VARIABLE_RevMatchingProcModes_68_68, 0) = ((MR_Box) (NewMatchingProcMode_51));
          MR_hl_field(MR_mktag(1), STATE_VARIABLE_RevMatchingProcModes_68_68, 1) = ((MR_Box) (STATE_VARIABLE_RevMatchingProcModes_0_4));
        }
        STATE_VARIABLE_WaitingVars_71_71 = STATE_VARIABLE_WaitingVars_0_8;
        STATE_VARIABLE_ModeInfo_70_70 = STATE_VARIABLE_ModeInfo_65_65;
      }
      else
      {
        ...
        check_hlds__mode_info__mode_info_set_errors_3_p_0((MR_Word) ((MR_Unsigned) 0U), STATE_VARIABLE_ModeInfo_65_65, &STATE_VARIABLE_ModeInfo_70_70);
        ErrorWaitingVars_47 = ((MR_Word) ((MR_hl_field(MR_mktag(0), FirstError_45, (MR_Integer) 0))));
        parse_tree__set_of_var__union_3_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), ErrorWaitingVars_47, STATE_VARIABLE_WaitingVars_0_8, &STATE_VARIABLE_WaitingVars_71_71);
        STATE_VARIABLE_RevMatchingProcModes_68_68 = STATE_VARIABLE_RevMatchingProcModes_0_4;
      }
      // direct tailcall eliminated
      ;
      next_value_of_HeadVar__1_1 = ProcIds_27;
      next_value_of_STATE_VARIABLE_RevMatchingProcModes_0_4 = STATE_VARIABLE_RevMatchingProcModes_68_68;
      next_value_of_STATE_VARIABLE_RevProcInitialInsts_0_6 = STATE_VARIABLE_RevProcInitialInsts_63_63;
      next_value_of_STATE_VARIABLE_WaitingVars_0_8 = STATE_VARIABLE_WaitingVars_71_71;
      next_value_of_STATE_VARIABLE_ModeInfo_0_10 = STATE_VARIABLE_ModeInfo_70_70;
