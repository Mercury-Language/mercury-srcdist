  ...
  MR_Word * STATE_VARIABLE_ModeInfo_57)
{
  ...
  {
    Var_61 = (MR_Integer) 3;
    succeeded = hlds__hlds_pred__marker_is_present_2_p_0(Markers_26, Var_61);
    succeeded = !(succeeded);
  }
  if (succeeded)
  {
  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        succeeded = hlds__hlds_pred__marker_is_present_2_p_0(Markers_26, (MR_Integer) 3);
        succeeded = !(succeeded);
        if (!(succeeded))
  ...
  MR_Word * STATE_VARIABLE_ModeInfo_26)
{
  ...
  succeeded = hlds__hlds_pred__marker_is_present_2_p_0(Markers_18, (MR_Integer) 3);
  if (succeeded)
  {
    MR_Word Instmap_19;
