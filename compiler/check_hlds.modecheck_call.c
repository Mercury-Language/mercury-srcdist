...
{
  {
    ...
    if (((((MR_tag((MR_Word) PredVarInst_21)) == (MR_Integer) 3)) && ((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), PredVarInst_21, (MR_Integer) 0))) == (MR_Integer) 1))))
    {
...
{
  {
    ...
    else
    {
      ...
      succeeded = ((MR_tag((MR_Word) ProcIds_24)) == (MR_Integer) 1);
      if (succeeded)
      {
