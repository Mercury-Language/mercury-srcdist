  ...
  MR_Word * STATE_VARIABLE_ModeInfo_41)
{
  ...
  if (succeeded)
    if ((HOInstInfo_56 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      ...
      check_hlds__mode_info__mode_info_get_var_types_2_p_0(STATE_VARIABLE_ModeInfo_0_40, &VarTypes_59);
      parse_tree__vartypes__lookup_var_type_3_p_0(VarTypes_59, PredVar_11, &Type0_60);
  ...
  MR_Word * STATE_VARIABLE_ModeInfo_58)
{
  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      MR_Word InitialInsts0_116;
      MR_Word FinalInsts0_117;
      MR_Word InitialInsts_118;
      MR_Word FinalInsts_119;
      MR_Word CanSucceed_120;
      MR_Word STATE_VARIABLE_ModeInfo_27_122;
      ...
      *TheProcId_14 = ProcId_30;
      ...
      check_hlds__mode_info__mode_info_get_module_info_2_p_0(STATE_VARIABLE_ModeInfo_73_73, &ModuleInfo_115);
      check_hlds__mode_util__mode_list_get_initial_insts_3_p_0(ModuleInfo_115, ProcArgModes_38, &InitialInsts0_116);
      check_hlds__mode_util__mode_list_get_final_insts_3_p_0(ModuleInfo_115, ProcArgModes_38, &FinalInsts0_117);
      parse_tree__prog_mode__inst_list_apply_substitution_3_p_0(InstVarSub_40, InitialInsts0_116, &InitialInsts_118);
      parse_tree__prog_mode__inst_list_apply_substitution_3_p_0(InstVarSub_40, FinalInsts0_117, &FinalInsts_119);
      check_hlds__modecheck_util__modecheck_set_var_inst_list_8_p_0(ArgVars0_15, InitialInsts_118, FinalInsts_119, ArgOffset_25, ArgVars_16, ExtraGoals_18, STATE_VARIABLE_ModeInfo_73_73, &STATE_VARIABLE_ModeInfo_27_122);
      hlds__hlds_pred__proc_info_never_succeeds_2_p_0(ProcInfo_31, &CanSucceed_120);
      switch (CanSucceed_120) {
        default: /*NOTREACHED*/ MR_assert(0);
        case (MR_Integer) 0:
          *STATE_VARIABLE_ModeInfo_58 = STATE_VARIABLE_ModeInfo_27_122;
          break;
        case (MR_Integer) 1:
          {
            MR_Word Instmap_121;

            hlds__instmap__init_unreachable_1_p_0(&Instmap_121);
            check_hlds__mode_info__mode_info_set_instmap_3_p_0(Instmap_121, STATE_VARIABLE_ModeInfo_27_122, STATE_VARIABLE_ModeInfo_58);
          }
          break;
      }
    }
  ...
  MR_Word * STATE_VARIABLE_ModeInfo_23)
{
  ...
  if (succeeded)
  {
    ...
    check_hlds__mode_info__mode_info_get_instvarset_2_p_0(STATE_VARIABLE_ModeInfo_0_22, &InstVarSet_40);
    {
      ...
      MR_hl_field(MR_mktag(1), Var_43, 0) = ((MR_Box) (ArgLives_33));
    }
