...
check_hlds__modecheck_call__IntroducedFrom__pred__modecheck_event_call__485__1_2_p_0(
  MR_Word ExtraGoals_11,
  MR_Word HeadVar__2_18);

static MR_bool MR_CALL 
check_hlds__modecheck_call__IntroducedFrom__pred__modecheck_higher_order_call__426__1_2_p_0(
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = check_hlds__modecheck_call__IntroducedFrom__pred__modecheck_event_call__485__1_2_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))));
  return succeeded;
}
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = check_hlds__modecheck_call__IntroducedFrom__pred__modecheck_higher_order_call__426__1_2_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))));
  return succeeded;
}
  ...
  MR_Word * STATE_VARIABLE_ModeInfo_24)
{
  ...
  check_hlds__mode_info__mode_info_get_pred_id_table_2_p_0(STATE_VARIABLE_ModeInfo_0_23, &PredIdTable_16);
  ...
  if (succeeded)
  {
    ...
    MR_Word Var_51;
    MR_Word STATE_VARIABLE_ModeInfo_26_52;
    ...
    hlds__hlds_module__module_info_pred_info_3_p_0(ModuleInfo0_42, PredId_9, &PredInfo0_43);
    hlds__hlds_pred__pred_info_get_context_2_p_0(PredInfo0_43, &Context_44);
    mercury__list__length_2_p_0((MR_Word) (&check_hlds__modecheck_call_scalar_common_1[1]), ArgVars_10, &Arity_45);
    mercury__list__duplicate_3_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_inst_0), Arity_45, ((MR_Box) ((MR_Unsigned) 4U)), &FinalInsts_46);
    parse_tree__prog_mode__inst_lists_to_mode_list_3_p_0(InitialInsts_40, FinalInsts_46, &Modes_47);
    check_hlds__mode_info__mode_info_get_instvarset_2_p_0(STATE_VARIABLE_ModeInfo_0_23, &InstVarSet_48);
    {
      Var_51 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), Var_51, 0) = ((MR_Box) (ArgLives_41));
    }
    check_hlds__proc_requests__request_proc_9_p_0(PredId_9, Modes_47, InstVarSet_48, Var_51, MaybeDetism_12, Context_44, NewProcId_14, ModuleInfo0_42, &ModuleInfo_49);
    check_hlds__mode_info__mode_info_set_module_info_3_p_0(ModuleInfo_49, STATE_VARIABLE_ModeInfo_0_23, &STATE_VARIABLE_ModeInfo_26_52);
    check_hlds__mode_info__mode_info_set_changed_flag_3_p_0((MR_Integer) 1, STATE_VARIABLE_ModeInfo_26_52, &STATE_VARIABLE_ModeInfo_26_26);
