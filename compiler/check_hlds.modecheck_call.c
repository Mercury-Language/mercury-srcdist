...
{
  {
    ...
    {
      check_hlds__modecheck_call__succeeded = check_hlds__modecheck_call__IntroducedFrom__pred__modecheck_event_call__469__1_2_p_0(((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__modecheck_call__closure, (MR_Integer) 3))), ((MR_Word) (MR_hl_field(MR_mktag(0), check_hlds__modecheck_call__closure, (MR_Integer) 4))));
    }
    return check_hlds__modecheck_call__succeeded;
  }
}
...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(0), check_hlds__modecheck_call__Var_15, 0) = ((MR_Box) (&check_hlds__modecheck_call_scalar_common_2[0]));
        ...
        else
          {
            ...
            if ((check_hlds__modecheck_call__RevMatchingProcIds_42 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
            ...
            else
              {
                ...
                {
                  mercury__list__reverse_2_p_0((MR_Word) &check_hlds__mode_comparison__check_hlds__mode_comparison__type_ctor_info_proc_mode_0, check_hlds__modecheck_call__RevMatchingProcIds_42, &check_hlds__modecheck_call__MatchingProcIds_46);
                }
                {
                  check_hlds__mode_comparison__choose_best_match_8_p_0(check_hlds__modecheck_call__STATE_VARIABLE_ModeInfo_71_71, check_hlds__modecheck_call__MatchingProcIds_46, check_hlds__modecheck_call__PredId_11, check_hlds__modecheck_call__Procs_23, check_hlds__modecheck_call__ArgVars0_15, check_hlds__modecheck_call__TheProcId_14, &check_hlds__modecheck_call__InstVarSub_84, &check_hlds__modecheck_call__ProcArgModes_83);
                }
                {
    ...
    if (check_hlds__modecheck_call__succeeded)
      {
        ...
        {
          check_hlds__modecheck_call__get_var_insts_and_lives_4_p_0(check_hlds__modecheck_call__STATE_VARIABLE_ModeInfo_0_20, check_hlds__modecheck_call__ArgVars_9, &check_hlds__modecheck_call__InitialInsts_38, &check_hlds__modecheck_call__ArgLives_39);
        }
        {
...
{
  {
    ...
    if ((check_hlds__modecheck_call__HeadVar__2_2 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
      ...
      {
        MR_Word check_hlds__modecheck_call__Var_7 = ((MR_Word) (MR_hl_field(MR_mktag(1), check_hlds__modecheck_call__HeadVar__2_2, (MR_Integer) 0)));
        MR_Word check_hlds__modecheck_call__Vars_8 = ((MR_Word) (MR_hl_field(MR_mktag(1), check_hlds__modecheck_call__HeadVar__2_2, (MR_Integer) 1)));
        ...
        MR_Word check_hlds__modecheck_call__IsLive0_13;
        MR_Word check_hlds__modecheck_call__ModuleInfo_14;

        {
          check_hlds__modecheck_util__get_var_inst_3_p_0(check_hlds__modecheck_call__ModeInfo_1, check_hlds__modecheck_call__Var_7, &check_hlds__modecheck_call__Inst_9);
        }
        {
          check_hlds__mode_info__mode_info_var_is_live_3_p_0(check_hlds__modecheck_call__ModeInfo_1, check_hlds__modecheck_call__Var_7, &check_hlds__modecheck_call__IsLive0_13);
        }
        {
          check_hlds__mode_info__mode_info_get_module_info_2_p_0(check_hlds__modecheck_call__ModeInfo_1, &check_hlds__modecheck_call__ModuleInfo_14);
        }
        switch (check_hlds__modecheck_call__IsLive0_13) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 1:
            {
              {
                check_hlds__modecheck_call__succeeded = check_hlds__inst_test__inst_is_ground_2_p_0(check_hlds__modecheck_call__ModuleInfo_14, check_hlds__modecheck_call__Inst_9);
              }
              if (check_hlds__modecheck_call__succeeded)
                {
                  check_hlds__modecheck_call__succeeded = check_hlds__inst_test__inst_is_mostly_unique_2_p_0(check_hlds__modecheck_call__ModuleInfo_14, check_hlds__modecheck_call__Inst_9);
                }
              if (check_hlds__modecheck_call__succeeded)
        ...
        {
          check_hlds__modecheck_call__get_var_insts_and_lives_4_p_0(check_hlds__modecheck_call__ModeInfo_1, check_hlds__modecheck_call__Vars_8, &check_hlds__modecheck_call__Insts_10, &check_hlds__modecheck_call__IsLives_12);
        }
        {
          MR_Word base;
