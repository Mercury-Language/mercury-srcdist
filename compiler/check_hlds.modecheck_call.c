  ...
  MR_Word * STATE_VARIABLE_ModeInfo_16)
{
  ...
  *Det_11 = (MR_Integer) 0;
  ...
  check_hlds__modecheck_util__modecheck_vars_have_inst_list_no_exact_match_7_p_0((MR_Word) ((MR_Unsigned) 4U), Args0_9, InitialInsts_20, (MR_Integer) 0, &InstVarSub_21, STATE_VARIABLE_ModeInfo_24_24, &STATE_VARIABLE_ModeInfo_25_25);
  ...
  MR_Word * STATE_VARIABLE_ModeInfo_13)
{
  ...
  check_hlds__modecheck_util__modecheck_vars_have_inst_list_no_exact_match_7_p_0((MR_Word) ((MR_Unsigned) 8U), Args0_7, InitialInsts_22, (MR_Integer) 0, &InstVarSub_23, STATE_VARIABLE_ModeInfo_24_26, &STATE_VARIABLE_ModeInfo_25_27);
  ...
  if (((MR_tag((MR_Word) Match_26)) == (MR_Integer) 0))
  {
    ...
    else
    {
      ...
      *Detism_17 = Detism0_31;
      ...
      check_hlds__modecheck_util__modecheck_vars_have_inst_list_no_exact_match_7_p_0(Var_45, ArgVars0_14, InitialInsts_96, (MR_Integer) 1, &InstVarSub_97, STATE_VARIABLE_ModeInfo_24_100, &STATE_VARIABLE_ModeInfo_25_101);
  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      *SelectedProcId_14 = ProcId_30;
      ...
      check_hlds__modecheck_util__modecheck_vars_have_inst_list_no_exact_match_7_p_0(Var_72, ArgVars0_15, InitialInsts_38, ArgOffset_25, &InstVarSub_39, STATE_VARIABLE_ModeInfo_71_71, &STATE_VARIABLE_ModeInfo_73_73);
      check_hlds__mode_info__mode_info_get_module_info_2_p_0(STATE_VARIABLE_ModeInfo_73_73, &ModuleInfo_104);
      check_hlds__mode_util__mode_list_get_initial_final_insts_4_p_0(ModuleInfo_104, ProcArgModes_37, &InitialInsts0_105, &FinalInsts0_106);
      ...
      hlds__hlds_proc_util__can_proc_info_ever_succeed_2_p_0(ProcInfo_31, &CanSucceed_109);
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      if ((ProcModeErrors_46 == (MR_Word) ((MR_Unsigned) 0U)))
        check_hlds__modecheck_util__modecheck_vars_have_inst_list_no_exact_match_7_p_0(MatchWhat_47, HeadVar__3_3, InitialInsts_45, (MR_Integer) 0, &InstVarSub_48, STATE_VARIABLE_ModeInfo_69_69, &STATE_VARIABLE_ModeInfo_72_72);
      else
        check_hlds__modecheck_util__modecheck_vars_have_inst_list_exact_match_7_p_0(MatchWhat_47, HeadVar__3_3, InitialInsts_45, (MR_Integer) 0, &InstVarSub_48, STATE_VARIABLE_ModeInfo_69_69, &STATE_VARIABLE_ModeInfo_72_72);
