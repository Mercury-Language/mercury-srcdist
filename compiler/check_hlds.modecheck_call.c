...
check_hlds__modecheck_call__IntroducedFrom__pred__get_higher_order_inst_match__508__1_2_p_0(
  MR_Word TypePredOrFunc_19,
  MR_Word TypeHOPredOrFunc_23);

static MR_bool MR_CALL 
check_hlds__modecheck_call__IntroducedFrom__pred__modecheck_event_call__564__1_2_p_0(
  MR_Word ExtraGoals_11,
  MR_Word HeadVar__2_19);

static MR_bool MR_CALL 
check_hlds__modecheck_call__IntroducedFrom__pred__modecheck_plain_or_foreign_call__117__1_2_p_0(
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = check_hlds__modecheck_call__IntroducedFrom__pred__modecheck_event_call__564__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 4)))));
  return succeeded;
}
  ...
  MR_Word * STATE_VARIABLE_ModeInfo_43)
{
  ...
  ActualPredFormArity_24 = parse_tree__prog_data__arg_list_arity_1_f_0((MR_Word) (&check_hlds__modecheck_call_scalar_common_1[0]), ArgVars0_14);
  parse_tree__prog_util__user_arity_pred_form_arity_3_p_1(PredOrFunc_12, &ActualUserArity_25, ActualPredFormArity_24);
  check_hlds__modecheck_call__get_higher_order_inst_match_6_p_0(STATE_VARIABLE_ModeInfo_0_42, PredOrFunc_12, PredVar_13, PredVarInst_23, ActualUserArity_25, &Match_26);
  if (((MR_tag((MR_Word) Match_26)) == (MR_Integer) 0))
  {
    ...
    {
      MR_Word ArgOffset_38;
      MR_Word Var_45;
      MR_Word STATE_VARIABLE_ModeInfo_46_46;
      MR_Word ModuleInfo0_58;
      MR_Word ExpectedArgLives_59;
      MR_Word InitialInsts_60;
      MR_Word InstVarSub_61;
      MR_Word FinalInsts0_63;
      MR_Word FinalInsts_64;
      MR_Word STATE_VARIABLE_ModeInfo_25_65;
      MR_Word STATE_VARIABLE_ModeInfo_26_66;
      MR_Word _BoundInstVars_62;
      MR_Word Var_57;
      MR_Word Var_39;

      *Modes_16 = Modes0_29;
      *Detism_17 = Detism0_31;
      ArgOffset_38 = check_hlds__modecheck_util__higher_order_modecheck_arg_offset_0_f_0();
      {
      ...
      check_hlds__mode_info__mode_info_get_module_info_2_p_0(STATE_VARIABLE_ModeInfo_0_42, &ModuleInfo0_58);
      check_hlds__mode_util__get_arg_lives_3_p_0(ModuleInfo0_58, *Modes_16, &ExpectedArgLives_59);
      check_hlds__modecheck_util__modecheck_vars_are_live_no_exact_match_5_p_0(ArgOffset_38, ArgVars0_14, ExpectedArgLives_59, STATE_VARIABLE_ModeInfo_0_42, &STATE_VARIABLE_ModeInfo_25_65);
      check_hlds__mode_util__mode_list_get_initial_insts_3_p_0(ModuleInfo0_58, *Modes_16, &InitialInsts_60);
      check_hlds__modecheck_util__modecheck_vars_have_insts_no_exact_match_8_p_0(Var_45, ArgOffset_38, ArgVars0_14, InitialInsts_60, &InstVarSub_61, &_BoundInstVars_62, STATE_VARIABLE_ModeInfo_25_65, &STATE_VARIABLE_ModeInfo_26_66);
      check_hlds__mode_util__mode_list_get_final_insts_3_p_0(ModuleInfo0_58, *Modes_16, &FinalInsts0_63);
      parse_tree__prog_mode__inst_list_apply_substitution_3_p_0(InstVarSub_61, FinalInsts0_63, &FinalInsts_64);
      check_hlds__modecheck_util__modecheck_set_var_insts_8_p_0(ArgOffset_38, ArgVars0_14, InitialInsts_60, FinalInsts_64, ArgVars_15, ExtraGoals_18, STATE_VARIABLE_ModeInfo_26_66, &STATE_VARIABLE_ModeInfo_46_46);
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = check_hlds__modecheck_call__IntroducedFrom__pred__get_higher_order_inst_match__508__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 4)))));
  return succeeded;
}
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = check_hlds__modecheck_call__IntroducedFrom__pred__modecheck_plain_or_foreign_call__117__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 4)))));
  return succeeded;
}
