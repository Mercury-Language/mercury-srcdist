...
MR_decl_label10(check_hlds__modecheck_call__compare_liveness_list_3_0, 5,3,9,15,16,11,21,35,22,8)
MR_decl_label1(check_hlds__modecheck_call__compare_liveness_list_3_0, 89)
...
MR_BEGIN_MODULE(check_hlds__modecheck_call_module5)
	...
	MR_init_label10(check_hlds__modecheck_call__compare_liveness_list_3_0,5,3,9,15,16,11,21,35,22,8)
	MR_init_label1(check_hlds__modecheck_call__compare_liveness_list_3_0,89)
MR_BEGIN_CODE
...
MR_def_label(check_hlds__modecheck_call__compare_liveness_list_3_0,9)
	...
	if (MR_INT_EQ(MR_sv(1),1)) {
		MR_GOTO_LAB(check_hlds__modecheck_call__compare_liveness_list_3_0_i89);
	}
	if (MR_INT_NE(MR_r1,0)) {
...
MR_def_label(check_hlds__modecheck_call__compare_liveness_list_3_0,8)
	...
	MR_np_tailcall_ent(libs__compiler_util__unexpected_2_0);
MR_def_label(check_hlds__modecheck_call__compare_liveness_list_3_0,89)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(3);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
