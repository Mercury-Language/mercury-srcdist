...
{
  {
    ...
    else
    {
      ...
      else
      {
        ...
        check_hlds__mode_info__mode_info_set_errors_3_p_0((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), STATE_VARIABLE_ModeInfo_0_53, &STATE_VARIABLE_ModeInfo_68_68);
        TypeCtorInfo_98_98 = (MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0;
        parse_tree__set_of_var__init_1_p_0(TypeCtorInfo_98_98, &WaitingVars0_41);
        ...
        else
        {
          ...
          else
          {
            ...
            *ArgVars_16 = ArgVars0_15;
            WaitingVars_78 = parse_tree__set_of_var__list_to_set_1_f_0(TypeCtorInfo_98_98, *ArgVars_16);
            *ExtraGoals_18 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
            ...
            {
              Var_74 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 6 * sizeof(MR_Word)), NULL, NULL));
