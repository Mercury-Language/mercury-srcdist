...
check_hlds__modecheck_call__IntroducedFrom__pred__get_higher_order_inst_match__495__1_2_p_0(
  MR_Word TypePredOrFunc_20,
  MR_Word TypeHOPredOrFunc_24);

static MR_bool MR_CALL 
check_hlds__modecheck_call__IntroducedFrom__pred__modecheck_event_call__546__1_2_p_0(
  MR_Word ExtraGoals_11,
  MR_Word HeadVar__2_18);

static MR_bool MR_CALL 
check_hlds__modecheck_call__IntroducedFrom__pred__modecheck_call_pred__117__1_2_p_0(
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = check_hlds__modecheck_call__IntroducedFrom__pred__modecheck_event_call__546__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 4)))));
  return succeeded;
}
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = check_hlds__modecheck_call__IntroducedFrom__pred__get_higher_order_inst_match__495__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 4)))));
  return succeeded;
}
  ...
  MR_Word * STATE_VARIABLE_ModeInfo_41)
{
  ...
  if (succeeded)
    if ((HOInstInfo_56 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      ...
      Type_61 = parse_tree__prog_type_test__strip_kind_annotation_1_f_0(Type0_60);
      ...
      if (succeeded)
      {
        ...
        if ((TypeHOInstInfo_64 == (MR_Word) ((MR_Unsigned) 0U)))
          switch (TypePredOrFunc_62) {
            ...
            case (MR_Integer) 1:
              {
                MR_Integer NumArgs_70;
                MR_Word PredInstInfo_190;
                MR_Word ActualPredOrFunc_191;
                MR_Word Modes_192;
                MR_Word Match0_217;

                mercury__list__length_2_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0), ArgTypes_63, &NumArgs_70);
                PredInstInfo_190 = check_hlds__inst_util__pred_inst_info_default_func_mode_1_f_0(NumArgs_70);
                Match0_217 = (MR_Word) ((MR_Word) (PredInstInfo_190));
                ActualPredOrFunc_191 = ((MR_Unsigned) ((MR_hl_field(0, PredInstInfo_190, (MR_Integer) 0))) & (MR_Integer) 1);
                Modes_192 = ((MR_Word) ((MR_hl_field(0, PredInstInfo_190, (MR_Integer) 1))));
                succeeded = (PredOrFunc_10 == ActualPredOrFunc_191);
                if (succeeded)
                {
                  MR_Word ActualPredFormArity_170;
                  MR_Word ActualUserArity_171;
                  MR_Integer Var_161;
                  MR_Integer Var_162;

                  ActualPredFormArity_170 = parse_tree__prog_data__arg_list_arity_1_f_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_mode_0), Modes_192);
                  parse_tree__prog_util__user_arity_pred_form_arity_3_p_1(ActualPredOrFunc_191, &ActualUserArity_171, ActualPredFormArity_170);
                  Var_161 = (MR_Integer) (ActualUserArity_23);
                  Var_162 = (MR_Integer) (ActualUserArity_171);
                  succeeded = (Var_161 == Var_162);
                  if (succeeded)
                    Match_24 = Match0_217;
                  else
                  {
                    MR_Word Mismatch_163;

                    {
                      Mismatch_163 = (MR_Word) MR_mkword(2, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                      MR_hl_field(2, Mismatch_163, 0) = ((MR_Box) (ActualUserArity_171));
                    }
                    {
                      Match_24 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                      MR_hl_field(1, Match_24, 0) = ((MR_Box) (Mismatch_163));
                    }
                  }
                }
                else
                {
                  MR_Word Mismatch_173;

                  {
                    Mismatch_173 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(1, Mismatch_173, 0) = (MR_Box) ((MR_Unsigned) (ActualPredOrFunc_191));
                  }
                  {
                    Match_24 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(1, Match_24, 0) = ((MR_Box) (Mismatch_173));
                  }
                }
              }
              break;
        ...
        {
          MR_Word Var_78;
          MR_Word PredInstInfo_121 = (MR_Word) (MR_body((MR_Word) (TypeHOInstInfo_64), (MR_Integer) 1));
          MR_Word ActualPredOrFunc_122 = ((MR_Unsigned) ((MR_hl_field(0, PredInstInfo_121, (MR_Integer) 0))) & (MR_Integer) 1);
          MR_Word Modes_123 = ((MR_Word) ((MR_hl_field(0, PredInstInfo_121, (MR_Integer) 1))));
          MR_Word Match0_145;

          {
            Var_78 = (MR_Word) MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL);
            MR_hl_field(0, Var_78, 0) = ((MR_Box) (&check_hlds__modecheck_call_scalar_common_3[0]));
            MR_hl_field(0, Var_78, 1) = ((MR_Box) (check_hlds__modecheck_call__modecheck_higher_order_call_9_p_0_1));
            MR_hl_field(0, Var_78, 2) = ((MR_Box) ((MR_Integer) 2));
            MR_hl_field(0, Var_78, 3) = ((MR_Box) (TypePredOrFunc_62));
            MR_hl_field(0, Var_78, 4) = ((MR_Box) (ActualPredOrFunc_122));
          }
          mercury__require__expect_3_p_0(Var_78, (MR_String) "predicate \140check_hlds.modecheck_call.get_higher_order_inst_match\'/6", (MR_String) "TypePredOrFunc != TypeHOPredOrFunc");
          Match0_145 = (MR_Word) ((MR_Word) (PredInstInfo_121));
          succeeded = (PredOrFunc_10 == ActualPredOrFunc_122);
          if (succeeded)
          {
            MR_Word ActualPredFormArity_107;
            MR_Word ActualUserArity_108;
            MR_Integer Var_101;
            MR_Integer Var_102;

            ActualPredFormArity_107 = parse_tree__prog_data__arg_list_arity_1_f_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_mode_0), Modes_123);
            parse_tree__prog_util__user_arity_pred_form_arity_3_p_1(ActualPredOrFunc_122, &ActualUserArity_108, ActualPredFormArity_107);
            Var_101 = (MR_Integer) (ActualUserArity_23);
            Var_102 = (MR_Integer) (ActualUserArity_108);
            succeeded = (Var_101 == Var_102);
            if (succeeded)
              Match_24 = Match0_145;
            else
            {
              MR_Word Mismatch_103;

              {
                Mismatch_103 = (MR_Word) MR_mkword(2, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(2, Mismatch_103, 0) = ((MR_Box) (ActualUserArity_108));
              }
              {
                Match_24 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(1, Match_24, 0) = ((MR_Box) (Mismatch_103));
              }
            }
          }
          else
          {
            MR_Word Mismatch_113;

            {
              Mismatch_113 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(1, Mismatch_113, 0) = (MR_Box) ((MR_Unsigned) (ActualPredOrFunc_122));
            }
            {
              Match_24 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(1, Match_24, 0) = ((MR_Box) (Mismatch_113));
            }
          }
        }
      }
    ...
    {
      MR_Word Match0_58;
      MR_Word PredInstInfo_71 = (MR_Word) (MR_body((MR_Word) (HOInstInfo_56), (MR_Integer) 1));
      MR_Word ActualPredOrFunc_72;
      MR_Word Modes_73;

      Match0_58 = (MR_Word) ((MR_Word) (PredInstInfo_71));
      ActualPredOrFunc_72 = ((MR_Unsigned) ((MR_hl_field(0, PredInstInfo_71, (MR_Integer) 0))) & (MR_Integer) 1);
      Modes_73 = ((MR_Word) ((MR_hl_field(0, PredInstInfo_71, (MR_Integer) 1))));
      succeeded = (PredOrFunc_10 == ActualPredOrFunc_72);
      if (succeeded)
      {
        MR_Word ActualPredFormArity_76;
        MR_Word ActualUserArity_77;
        MR_Integer Var_89;
        MR_Integer Var_90;

        ActualPredFormArity_76 = parse_tree__prog_data__arg_list_arity_1_f_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_mode_0), Modes_73);
        parse_tree__prog_util__user_arity_pred_form_arity_3_p_1(ActualPredOrFunc_72, &ActualUserArity_77, ActualPredFormArity_76);
        Var_89 = (MR_Integer) (ActualUserArity_23);
        Var_90 = (MR_Integer) (ActualUserArity_77);
        ...
        else
        {
          ...
          {
            Mismatch_84 = (MR_Word) MR_mkword(2, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(2, Mismatch_84, 0) = ((MR_Box) (ActualUserArity_77));
          }
          {
            Match_24 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(1, Match_24, 0) = ((MR_Box) (Mismatch_84));
          }
        }
      }
      else
      {
        ...
        {
          Mismatch_85 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(1, Mismatch_85, 0) = (MR_Box) ((MR_Unsigned) (ActualPredOrFunc_72));
        }
        {
          Match_24 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
  ...
  if (((MR_tag((MR_Word) Match_24)) == (MR_Integer) 0))
  {
    ...
    else
    {
      ...
      MR_Word ModuleInfo0_91;
      MR_Word ExpectedArgLives_92;
      MR_Word InitialInsts_93;
      MR_Word InstVarSub_94;
      MR_Word FinalInsts0_95;
      MR_Word FinalInsts_96;
      MR_Word STATE_VARIABLE_ModeInfo_22_97;
      MR_Word STATE_VARIABLE_ModeInfo_23_98;
      MR_Word Var_54;
      MR_Word Var_37;

      *Modes_14 = Modes0_27;
      *Detism_15 = Detism0_29;
      check_hlds__mode_info__mode_info_get_module_info_2_p_0(STATE_VARIABLE_ModeInfo_0_40, &ModuleInfo0_91);
      check_hlds__mode_util__get_arg_lives_3_p_0(ModuleInfo0_91, *Modes_14, &ExpectedArgLives_92);
      check_hlds__modecheck_util__modecheck_var_list_is_live_no_exact_match_5_p_0(ArgVars0_12, ExpectedArgLives_92, (MR_Integer) 1, STATE_VARIABLE_ModeInfo_0_40, &STATE_VARIABLE_ModeInfo_22_97);
      check_hlds__mode_util__mode_list_get_initial_insts_3_p_0(ModuleInfo0_91, *Modes_14, &InitialInsts_93);
      check_hlds__modecheck_util__modecheck_var_has_inst_list_no_exact_match_6_p_0(ArgVars0_12, InitialInsts_93, (MR_Integer) 1, &InstVarSub_94, STATE_VARIABLE_ModeInfo_22_97, &STATE_VARIABLE_ModeInfo_23_98);
      check_hlds__mode_util__mode_list_get_final_insts_3_p_0(ModuleInfo0_91, *Modes_14, &FinalInsts0_95);
      parse_tree__prog_mode__inst_list_apply_substitution_3_p_0(InstVarSub_94, FinalInsts0_95, &FinalInsts_96);
      check_hlds__modecheck_util__modecheck_set_var_inst_list_8_p_0(ArgVars0_12, InitialInsts_93, FinalInsts_96, (MR_Integer) 1, ArgVars_13, ExtraGoals_16, STATE_VARIABLE_ModeInfo_23_98, &STATE_VARIABLE_ModeInfo_43_43);
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = check_hlds__modecheck_call__IntroducedFrom__pred__modecheck_call_pred__117__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 4)))));
  return succeeded;
}
  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      *SelectedProcId_14 = ProcId_30;
      ...
      hlds__hlds_proc_util__proc_info_never_succeeds_2_p_0(ProcInfo_31, &CanSucceed_108);
