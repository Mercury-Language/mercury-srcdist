...
check_hlds__modecheck_call__IntroducedFrom__pred__get_higher_order_inst_match__498__1_2_p_0(
  MR_Word TypePredOrFunc_20,
  MR_Word TypeHOPredOrFunc_24);

static MR_bool MR_CALL 
check_hlds__modecheck_call__IntroducedFrom__pred__modecheck_event_call__550__1_2_p_0(
  MR_Word ExtraGoals_11,
  MR_Word HeadVar__2_19);

static MR_bool MR_CALL 
check_hlds__modecheck_call__IntroducedFrom__pred__modecheck_plain_or_foreign_call__116__1_2_p_0(
  ...
  MR_Word * STATE_VARIABLE_ModeInfo_16)
{
  ...
  *Det_11 = (MR_Integer) 0;
  ...
  check_hlds__modecheck_util__modecheck_vars_are_live_no_exact_match_5_p_0(Args0_9, ExpectedArgLives_19, (MR_Integer) 0, STATE_VARIABLE_ModeInfo_0_15, &STATE_VARIABLE_ModeInfo_24_24);
  check_hlds__mode_util__mode_list_get_initial_insts_3_p_0(ModuleInfo0_18, Modes_8, &InitialInsts_20);
  check_hlds__modecheck_util__modecheck_vars_have_insts_no_exact_match_7_p_0((MR_Word) ((MR_Unsigned) 4U), Args0_9, InitialInsts_20, (MR_Integer) 0, &InstVarSub_21, STATE_VARIABLE_ModeInfo_24_24, &STATE_VARIABLE_ModeInfo_25_25);
  ...
  check_hlds__modecheck_util__modecheck_set_var_insts_8_p_0(Args0_9, InitialInsts_20, FinalInsts_23, (MR_Integer) 0, Args_10, ExtraGoals_12, STATE_VARIABLE_ModeInfo_25_25, STATE_VARIABLE_ModeInfo_16);
}
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = check_hlds__modecheck_call__IntroducedFrom__pred__modecheck_event_call__550__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 4)))));
  return succeeded;
}
  ...
  MR_Word * STATE_VARIABLE_ModeInfo_13)
{
  ...
  check_hlds__modecheck_util__modecheck_vars_are_live_no_exact_match_5_p_0(Args0_7, ExpectedArgLives_21, (MR_Integer) 0, STATE_VARIABLE_ModeInfo_0_12, &STATE_VARIABLE_ModeInfo_24_26);
  check_hlds__mode_util__mode_list_get_initial_insts_3_p_0(ModuleInfo0_20, Modes_6, &InitialInsts_22);
  check_hlds__modecheck_util__modecheck_vars_have_insts_no_exact_match_7_p_0((MR_Word) ((MR_Unsigned) 8U), Args0_7, InitialInsts_22, (MR_Integer) 0, &InstVarSub_23, STATE_VARIABLE_ModeInfo_24_26, &STATE_VARIABLE_ModeInfo_25_27);
  ...
  check_hlds__modecheck_util__modecheck_set_var_insts_8_p_0(Args0_7, InitialInsts_22, FinalInsts_25, (MR_Integer) 0, Args_8, &ExtraGoals_11, STATE_VARIABLE_ModeInfo_25_27, STATE_VARIABLE_ModeInfo_13);
  {
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = check_hlds__modecheck_call__IntroducedFrom__pred__get_higher_order_inst_match__498__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 4)))));
  return succeeded;
}
  ...
  if (((MR_tag((MR_Word) Match_26)) == (MR_Integer) 0))
  {
    ...
    else
    {
      ...
      *Detism_17 = Detism0_31;
      ...
      check_hlds__modecheck_util__modecheck_vars_are_live_no_exact_match_5_p_0(ArgVars0_14, ExpectedArgLives_95, (MR_Integer) 1, STATE_VARIABLE_ModeInfo_0_42, &STATE_VARIABLE_ModeInfo_24_100);
      check_hlds__mode_util__mode_list_get_initial_insts_3_p_0(ModuleInfo0_94, *Modes_16, &InitialInsts_96);
      check_hlds__modecheck_util__modecheck_vars_have_insts_no_exact_match_7_p_0(Var_45, ArgVars0_14, InitialInsts_96, (MR_Integer) 1, &InstVarSub_97, STATE_VARIABLE_ModeInfo_24_100, &STATE_VARIABLE_ModeInfo_25_101);
      ...
      check_hlds__modecheck_util__modecheck_set_var_insts_8_p_0(ArgVars0_14, InitialInsts_96, FinalInsts_99, (MR_Integer) 1, ArgVars_15, ExtraGoals_18, STATE_VARIABLE_ModeInfo_25_101, &STATE_VARIABLE_ModeInfo_46_46);
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = check_hlds__modecheck_call__IntroducedFrom__pred__modecheck_plain_or_foreign_call__116__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 4)))));
  return succeeded;
}
  ...
  MR_Word * STATE_VARIABLE_ModeInfo_57)
{
  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      MR_Word InitialInsts0_107;
      MR_Word FinalInsts0_108;
      MR_Word InitialInsts_109;
      MR_Word FinalInsts_110;
      MR_Word CanSucceed_111;
      MR_Word STATE_VARIABLE_ModeInfo_27_113;
      ...
      *SelectedProcId_14 = ProcId_31;
      ...
      check_hlds__modecheck_util__modecheck_vars_are_live_no_exact_match_5_p_0(ArgVars0_15, ProcArgLives0_33, ArgOffset_25, STATE_VARIABLE_ModeInfo_0_56, &STATE_VARIABLE_ModeInfo_69_69);
      ...
      check_hlds__mode_util__mode_list_get_initial_insts_3_p_0(ModuleInfo_21, ProcArgModes_38, &InitialInsts_39);
      {
        ...
        MR_hl_field(1, Var_71, 0) = ((MR_Box) (PredId_11));
      }
      check_hlds__modecheck_util__modecheck_vars_have_insts_no_exact_match_7_p_0(Var_71, ArgVars0_15, InitialInsts_39, ArgOffset_25, &InstVarSub_40, STATE_VARIABLE_ModeInfo_70_70, &STATE_VARIABLE_ModeInfo_72_72);
      check_hlds__mode_info__mode_info_get_module_info_2_p_0(STATE_VARIABLE_ModeInfo_72_72, &ModuleInfo_106);
      check_hlds__mode_util__mode_list_get_initial_final_insts_4_p_0(ModuleInfo_106, ProcArgModes_38, &InitialInsts0_107, &FinalInsts0_108);
      parse_tree__prog_mode__inst_list_apply_substitution_3_p_0(InstVarSub_40, InitialInsts0_107, &InitialInsts_109);
      parse_tree__prog_mode__inst_list_apply_substitution_3_p_0(InstVarSub_40, FinalInsts0_108, &FinalInsts_110);
      check_hlds__modecheck_util__modecheck_set_var_insts_8_p_0(ArgVars0_15, InitialInsts_109, FinalInsts_110, ArgOffset_25, ArgVars_16, ExtraGoals_18, STATE_VARIABLE_ModeInfo_72_72, &STATE_VARIABLE_ModeInfo_27_113);
      hlds__hlds_proc_util__can_proc_info_ever_succeed_2_p_0(ProcInfo_32, &CanSucceed_111);
      switch (CanSucceed_111) {
        default: /*NOTREACHED*/ MR_assert(0);
        case (MR_Integer) 0:
          *STATE_VARIABLE_ModeInfo_57 = STATE_VARIABLE_ModeInfo_27_113;
          break;
        case (MR_Integer) 1:
          {
            MR_Word Instmap_112;

            hlds__instmap__init_unreachable_1_p_0(&Instmap_112);
            check_hlds__mode_info__mode_info_set_instmap_3_p_0(Instmap_112, STATE_VARIABLE_ModeInfo_27_113, STATE_VARIABLE_ModeInfo_57);
          }
          break;
      }
    }
    else
    {
      ...
      MR_Word RevMatchingProcModes_43;
      ...
      check_hlds__mode_info__mode_info_get_errors_2_p_0(STATE_VARIABLE_ModeInfo_0_56, &OldErrors_41);
      ...
      check_hlds__modecheck_call__modecheck_find_matching_modes_12_p_0(PredId_11, ProcTable_23, ArgVars0_15, ProcIds_24, (MR_Word) ((MR_Unsigned) 0U), &RevMatchingProcModes_43, (MR_Word) ((MR_Unsigned) 0U), &RevProcInitialInsts_44, WaitingVars0_42, &WaitingVars1_45, STATE_VARIABLE_ModeInfo_75_75, &STATE_VARIABLE_ModeInfo_78_78);
      if ((RevMatchingProcModes_43 == (MR_Word) ((MR_Unsigned) 0U)))
      {
        ...
        check_hlds__modecheck_call__no_matching_modes_8_p_0(PredId_11, ArgVars0_15, ProcInitialInsts_46, MaybeDetism_12, WaitingVars1_45, SelectedProcId_14, STATE_VARIABLE_ModeInfo_78_78, &STATE_VARIABLE_ModeInfo_79_79);
        *ArgVars_16 = ArgVars0_15;
        *ExtraGoals_18 = (MR_Word) ((MR_Unsigned) 0U);
      }
      else
      {
        MR_Word MatchingProcModes_49;
        MR_Word CalleeModeErrors_50;
        MR_Word ProcInfo_91;
        MR_Word ProcArgModes_92;
        MR_Word InstVarSub_93;
        MR_Box conv1_ProcInfo_91;

        mercury__list__reverse_2_p_0((MR_Word) (&check_hlds__mode_comparison__check_hlds__mode_comparison__type_ctor_info_proc_mode_0), RevMatchingProcModes_43, &MatchingProcModes_49);
        check_hlds__mode_comparison__choose_best_match_8_p_0(STATE_VARIABLE_ModeInfo_78_78, MatchingProcModes_49, PredId_11, ProcTable_23, ArgVars0_15, SelectedProcId_14, &InstVarSub_93, &ProcArgModes_92);
        mercury__map__lookup_3_p_0((MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_proc_id_0), (MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_proc_info_0), ProcTable_23, ((MR_Box) (*SelectedProcId_14)), &conv1_ProcInfo_91);
        ProcInfo_91 = ((MR_Word) (conv1_ProcInfo_91));
        check_hlds__mode_info__look_up_proc_mode_errors_4_p_0(STATE_VARIABLE_ModeInfo_78_78, PredId_11, *SelectedProcId_14, &CalleeModeErrors_50);
        if ((CalleeModeErrors_50 == (MR_Word) ((MR_Unsigned) 0U)))
          check_hlds__modecheck_call__modecheck_end_of_call_9_p_0(ProcInfo_91, ProcArgModes_92, ArgVars0_15, ArgOffset_25, InstVarSub_93, ArgVars_16, ExtraGoals_18, STATE_VARIABLE_ModeInfo_78_78, &STATE_VARIABLE_ModeInfo_79_79);
        else
        {
          MR_Word ArgInsts_53;
          ...
          *ExtraGoals_18 = (MR_Word) ((MR_Unsigned) 0U);
          ...
          {
            ModeError_86 = (MR_Word) MR_mkword(3, MR_new_object(MR_Word, (6 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(3, ModeError_86, 0) = ((MR_Box) ((MR_Unsigned) 15U));
            MR_hl_field(3, ModeError_86, 1) = ((MR_Box) (*ArgVars_16));
            MR_hl_field(3, ModeError_86, 2) = ((MR_Box) (ArgInsts_53));
            MR_hl_field(3, ModeError_86, 3) = ((MR_Box) (PredId_11));
            MR_hl_field(3, ModeError_86, 4) = ((MR_Box) (*SelectedProcId_14));
            MR_hl_field(3, ModeError_86, 5) = ((MR_Box) (CalleeModeErrors_50));
          }
          check_hlds__mode_info__mode_info_error_4_p_0(WaitingVars_85, ModeError_86, STATE_VARIABLE_ModeInfo_82_82, &STATE_VARIABLE_ModeInfo_79_79);
        }
      }
      check_hlds__mode_info__mode_info_get_errors_2_p_0(STATE_VARIABLE_ModeInfo_79_79, &NewErrors_54);
      mercury__list__append_3_p_1((MR_Word) (&check_hlds__mode_errors__check_hlds__mode_errors__type_ctor_info_mode_error_info_0), OldErrors_41, NewErrors_54, &Errors_55);
  ...
  MR_Word * STATE_VARIABLE_ModeInfo_26)
{
  ...
  check_hlds__mode_util__mode_list_get_initial_final_insts_4_p_0(ModuleInfo_18, ProcArgModes_11, &InitialInsts0_19, &FinalInsts0_20);
  ...
  check_hlds__modecheck_util__modecheck_set_var_insts_8_p_0(ArgVars0_12, InitialInsts_21, FinalInsts_22, ArgOffset_13, ArgVars_15, ExtraGoals_16, STATE_VARIABLE_ModeInfo_0_25, &STATE_VARIABLE_ModeInfo_27_27);
  ...
  MR_Word * STATE_VARIABLE_ModeInfo_12)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      check_hlds__modecheck_util__modecheck_vars_are_live_no_exact_match_5_p_0(HeadVar__3_3, ProcArgLives0_44, (MR_Integer) 0, STATE_VARIABLE_ModeInfo_67_67, &STATE_VARIABLE_ModeInfo_69_69);
      ...
      if ((ProcModeErrors_46 == (MR_Word) ((MR_Unsigned) 0U)))
        check_hlds__modecheck_util__modecheck_vars_have_insts_no_exact_match_7_p_0(MatchWhat_47, HeadVar__3_3, InitialInsts_45, (MR_Integer) 0, &InstVarSub_48, STATE_VARIABLE_ModeInfo_69_69, &STATE_VARIABLE_ModeInfo_72_72);
      else
        check_hlds__modecheck_util__modecheck_vars_have_insts_exact_match_7_p_0(MatchWhat_47, HeadVar__3_3, InitialInsts_45, (MR_Integer) 0, &InstVarSub_48, STATE_VARIABLE_ModeInfo_69_69, &STATE_VARIABLE_ModeInfo_72_72);
