...
{
  {
    ...
    {
      MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), PredVarInst_21, (MR_Integer) 0)));
    ...
    {
      MR_Unsigned packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), PredVarInst_21, (MR_Integer) 1)));
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        packed_args_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), PredInstInfo_25, (MR_Integer) 0)));
        ...
        packed_args_3 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), PredInstInfo_25, (MR_Integer) 3)));
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        packed_args_4 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), PredVarInst_21, (MR_Integer) 0)));
      ...
      if (succeeded)
      {
...

        {
          ...
          MR_hl_field(MR_mktag(3), BetterPredVarInst_37, 1) = (MR_Box) (packed_args_4);
