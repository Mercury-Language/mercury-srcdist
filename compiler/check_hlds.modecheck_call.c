    ...
    if (check_hlds__modecheck_call__succeeded)
      {
        ...
        {
          check_hlds__modecheck_call__succeeded = hlds__hlds_pred__check_marker_2_p_0(check_hlds__modecheck_call__Markers_27, check_hlds__modecheck_call__Var_59);
        }
        ...
        if (check_hlds__modecheck_call__succeeded)
          {
            ...
            check_hlds__modecheck_call__Var_62 = ((MR_Word) (MR_hl_field(MR_mktag(1), check_hlds__modecheck_call__ProcIds_25, (MR_Integer) 1)));
