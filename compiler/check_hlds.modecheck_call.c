...
check_hlds__modecheck_call__IntroducedFrom__pred__modecheck_event_call__486__1_2_p_0(
  MR_Word ExtraGoals_11,
  MR_Word HeadVar__2_18);

static MR_bool MR_CALL 
check_hlds__modecheck_call__IntroducedFrom__pred__modecheck_higher_order_call__427__1_2_p_0(
  MR_Word TypePredOrFunc_28,
  MR_Word TypeHOPredOrFunc_33);

static MR_bool MR_CALL 
check_hlds__modecheck_call__IntroducedFrom__pred__modecheck_call_pred__114__1_2_p_0(
...
{
  {
    ...
    succeeded = check_hlds__modecheck_call__IntroducedFrom__pred__modecheck_event_call__486__1_2_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))));
    return succeeded;
  }
}
...
{
  {
    ...
    succeeded = check_hlds__modecheck_call__IntroducedFrom__pred__modecheck_higher_order_call__427__1_2_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))));
    return succeeded;
  }
}
...
{
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        WaitingVars_45 = parse_tree__set_of_var__make_singleton_1_f_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), PredVar_11);
        {
          ...
          MR_hl_field(MR_mktag(3), ModeError_46, 0) = ((MR_Box) ((MR_Unsigned) 14U));
    ...
    else
    {
      ...
      WaitingVars_64 = parse_tree__set_of_var__make_singleton_1_f_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), PredVar_11);
      {
        ...
        MR_hl_field(MR_mktag(3), ModeError_65, 0) = ((MR_Box) ((MR_Unsigned) 8U));
...
{
  {
    ...
    succeeded = check_hlds__modecheck_call__IntroducedFrom__pred__modecheck_call_pred__114__1_2_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))));
    return succeeded;
  }
}
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        *TheProcId_14 = ProcId_30;
        ...
        hlds__hlds_pred__proc_info_arglives_3_p_0(ProcInfo_31, ModuleInfo_32, &ProcArgLives0_33);
    ...
    else
    {
      ...
      *NewProcId_14 = hlds__hlds_pred__invalid_proc_id_0_f_0();
      ...
      check_hlds__mode_info__mode_info_set_call_arg_context_3_p_0((MR_Integer) 0, STATE_VARIABLE_ModeInfo_0_23, &STATE_VARIABLE_ModeInfo_29_29);
      {
        ...
        MR_hl_field(MR_mktag(3), ModeError_22, 0) = ((MR_Box) ((MR_Unsigned) 7U));
