...
static const MR_EnumFunctorDescPtr hlds__hlds_markers__hlds__hlds_markers__enum_ordinal_ordered_goal_feature_0[29];

static const MR_EnumFunctorDescPtr hlds__hlds_markers__hlds__hlds_markers__enum_name_ordered_goal_feature_0[29];

static const MR_Integer hlds__hlds_markers__hlds__hlds_markers__functor_number_map_goal_feature_0[29];
...
static const MR_EnumFunctorDescPtr hlds__hlds_markers__hlds__hlds_markers__enum_ordinal_ordered_pred_marker_0[30];

static const MR_EnumFunctorDescPtr hlds__hlds_markers__hlds__hlds_markers__enum_name_ordered_pred_marker_0[30];

static const MR_Integer hlds__hlds_markers__hlds__hlds_markers__functor_number_map_pred_marker_0[30];
...
static /* final */ const struct hlds__hlds_markers__vector_common_type_2_0_s hlds__hlds_markers_vector_common_2[30];
...
static /* final */ const struct hlds__hlds_markers__vector_common_type_2_0_s hlds__hlds_markers_vector_common_2[30] = {
  ...
  /* row  11 */   { (MR_String) "class_method" },
  /* row  12 */   { (MR_String) "class_instance_method" },
  /* row  13 */   { (MR_String) "named_class_instance_method" },
  /* row  14 */   { (MR_String) "impure" },
  /* row  15 */   { (MR_String) "semipure" },
  /* row  16 */   { (MR_String) "promise_pure" },
  /* row  17 */   { (MR_String) "promise_semipure" },
  /* row  18 */   { (MR_String) "promise_equivalent_clauses" },
  /* row  19 */   { (MR_String) "terminates" },
  /* row  20 */   { (MR_String) "does_not_terminate" },
  /* row  21 */   { (MR_String) "check_termination" },
  /* row  22 */   { (MR_String) "calls_are_fully_qualified" },
  /* row  23 */   { (MR_String) "mode_check_clauses" },
  /* row  24 */   { (MR_String) "mutable_access_pred" },
  /* row  25 */   { (MR_String) "has_require_scope" },
  /* row  26 */   { (MR_String) "has_incomplete_switch" },
  /* row  27 */   { (MR_String) "has_format_call" },
  /* row  28 */   { (MR_String) "has_rhs_lambda" },
  /* row  29 */   { (MR_String) "fact_table_semantic_errors" },
};
