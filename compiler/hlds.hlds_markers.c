...
static const MR_EnumFunctorDesc hlds__hlds_markers__hlds__hlds_markers__enum_functor_desc_pred_marker_0_31;

static const MR_EnumFunctorDescPtr hlds__hlds_markers__hlds__hlds_markers__enum_ordinal_ordered_pred_marker_0[32];

static const MR_EnumFunctorDescPtr hlds__hlds_markers__hlds__hlds_markers__enum_name_ordered_pred_marker_0[32];

static const MR_Integer hlds__hlds_markers__hlds__hlds_markers__functor_number_map_pred_marker_0[32];
...
static /* final */ const struct hlds__hlds_markers__vector_common_type_2_0_s hlds__hlds_markers_vector_common_2[32];
...
static /* final */ const struct hlds__hlds_markers__vector_common_type_2_0_s hlds__hlds_markers_vector_common_2[32] = {
  ...
  /* row  30 */   { (MR_String) "was_input_specialized" },
  /* row  31 */   { (MR_String) "fact_table_semantic_errors" },
};
...
static const MR_EnumFunctorDesc hlds__hlds_markers__hlds__hlds_markers__enum_functor_desc_pred_marker_0_30 = {
  (MR_String) "marker_was_input_specialized",
  INT32_C(30)
};
...
static const MR_EnumFunctorDescPtr hlds__hlds_markers__hlds__hlds_markers__enum_ordinal_ordered_pred_marker_0[32] = {
  ...
  &hlds__hlds_markers__hlds__hlds_markers__enum_functor_desc_pred_marker_0_31
};
