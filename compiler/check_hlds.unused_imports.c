...
top_of_proc_1:;
  {
    ...
    switch (MR_tag((MR_Word) Inst_6)) {
      ...
      case (MR_Integer) 1:
        {
          MR_Word HOInstInfo_41 = ((MR_Word) ((MR_hl_field(1, Inst_6, (MR_Integer) 1))));
      ...
      case (MR_Integer) 2:
        {
          MR_Word BoundInsts_15 = ((MR_Word) ((MR_hl_field(2, Inst_6, (MR_Integer) 2))));
          MR_Word Var_25;
      ...
      case (MR_Integer) 3:
        switch (((MR_Integer) ((MR_hl_field(3, Inst_6, (MR_Integer) 0))))) {
          ...
          case (MR_Integer) 3:
            {
              MR_Word Type_12 = ((MR_Word) ((MR_hl_field(3, Inst_6, (MR_Integer) 1))));
