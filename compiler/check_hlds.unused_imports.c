...
{
  {
    ...
    mercury__list__foldl_4_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_cons_id_0), (MR_Word) (&parse_tree__prog_data_used_modules__parse_tree__prog_data_used_modules__type_ctor_info_used_modules_0), (MR_Word) (&check_hlds__unused_imports_scalar_common_7[1]), OtherConsIds_7, ((MR_Box) (STATE_VARIABLE_UsedModules_12_12)), &conv1_STATE_VARIABLE_UsedModules_14_14);
...
{
  {
    ...
    hlds__hlds_pred__proc_info_get_vartypes_2_p_0(ProcInfo_8, &VarTypes_10);
    {
      ...
      MR_hl_field(MR_mktag(0), Var_15, 0) = ((MR_Box) (&check_hlds__unused_imports_scalar_common_4[5]));
    ...
    else
    {
...

      {
        ...
        MR_hl_field(MR_mktag(0), Var_17, 0) = ((MR_Box) (&check_hlds__unused_imports_scalar_common_4[6]));
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(3), Var_69, 0) = ((MR_Box) ((MR_Unsigned) 24U));
...
{
  {
    ...
    UnusedInterfaceImports_17 = mercury__set__difference_2_f_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), AvailInterfaceModules_12, UsedInInterface_13);
    {
      ...
      MR_hl_field(MR_mktag(0), Var_22, 0) = ((MR_Box) (&check_hlds__unused_imports_scalar_common_8[0]));
