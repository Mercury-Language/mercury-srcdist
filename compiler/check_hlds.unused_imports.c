  ...
  MR_Word * STATE_VARIABLE_UsedModules_17)
{
  ...
  hlds__vartypes__lookup_var_types_3_p_0(VarTypes_11, HeadVars_12, &HeadVarTypes_13);
  {
  ...
  hlds__vartypes__foldl_var_types_4_p_0((MR_Word) (&parse_tree__prog_data_used_modules__parse_tree__prog_data_used_modules__type_ctor_info_used_modules_0), (MR_Word) (&check_hlds__unused_imports_scalar_common_7[1]), VarTypes_11, ((MR_Box) (STATE_VARIABLE_UsedModules_19_19)), &conv3_STATE_VARIABLE_UsedModules_21_21);
