    ...
    case (MR_Integer) 1:
      {
        ...
        MR_Word SymName_39 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_35, (MR_Integer) 0))));
  ...
  MR_Word * STATE_VARIABLE_UsedModules_29)
{
  ...
  if (succeeded)
  {
    ...
    Exported_77 = hlds__status__instance_status_is_exported_to_non_submodules_1_f_0(InstanceStatus_17);
    switch (Exported_77) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
  ...
  MR_Word * STATE_VARIABLE_Specs_27)
{
  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      ImportOrUseDeclName_49 = parse_tree__item_util__import_or_use_decl_name_1_f_0(ImportOrUse_21);
      {
