            ...
            case (MR_Integer) 1:
              {
...

                {
                  ...
                  MR_hl_field(MR_mktag(0), check_hlds__unused_imports__Var_28, 0) = ((MR_Box) (&check_hlds__unused_imports_scalar_common_6[13]));
          ...
          case (MR_Integer) 11:
            {
              ...
              {
                parse_tree__prog_data_used_modules__record_module_and_ancestors_as_used_4_p_0(check_hlds__unused_imports__Visibility_5, check_hlds__unused_imports__ModuleName_39, check_hlds__unused_imports__STATE_VARIABLE_UsedModules_0_34, check_hlds__unused_imports__STATE_VARIABLE_UsedModules_35);
              }
            }
            break;
          case (MR_Integer) 12:
            {
              ...
              {
                parse_tree__prog_data_used_modules__record_module_and_ancestors_as_used_4_p_0(check_hlds__unused_imports__Visibility_5, check_hlds__unused_imports__ModuleName_12, check_hlds__unused_imports__STATE_VARIABLE_UsedModules_0_34, check_hlds__unused_imports__STATE_VARIABLE_UsedModules_35);
              }
            }
            break;
          case (MR_Integer) 13:
