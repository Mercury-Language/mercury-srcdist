...
{
  {
    ...
    else
    {
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(1), Msg_18, 0) = ((MR_Box) (PrevContext_15));
        MR_hl_field(MR_mktag(1), Msg_18, 1) = ((MR_Box) (Var_39));
      }
      {
        MR_Word base;
...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), Msg_17, 0) = ((MR_Box) (Context_10));
      MR_hl_field(MR_mktag(1), Msg_17, 1) = ((MR_Box) (Var_56));
    }
    {
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      else
      {
        ...
        {
          MainMsg_24 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), MainMsg_24, 0) = ((MR_Box) (Context_21));
          MR_hl_field(MR_mktag(1), MainMsg_24, 1) = ((MR_Box) (Var_49));
        }
        {
