      ...
      case (MR_Integer) 1:
        {
          ...
          switch (MR_tag((MR_Word) RHS_9)) {
            ...
            case (MR_Integer) 2:
              {
                MR_Word Goal_128 = ((MR_Word) ((MR_hl_field(2, RHS_9, (MR_Integer) 4))));
                MR_Word next_value_of_Goal_4 = Goal_128;
  ...
  MR_Word * STATE_VARIABLE_UsedModules_33)
{
  switch (MR_tag((MR_Word) ConsId_6)) {
    ...
    case (MR_Integer) 2:
      {
        MR_Word Var_34 = (MR_Word) (MR_body((MR_Word) (ConsId_6), (MR_Integer) 2));
        MR_Word SymName_36 = ((MR_Word) ((MR_hl_field(0, Var_34, (MR_Integer) 0))));

        parse_tree__prog_data_used_modules__record_sym_name_module_as_used_4_p_0(Visibility_5, SymName_36, STATE_VARIABLE_UsedModules_0_32, STATE_VARIABLE_UsedModules_33);
      }
      break;
    case (MR_Integer) 3:
      switch (((MR_Integer) ((MR_hl_field(3, ConsId_6, (MR_Integer) 0))))) {
        ...
        case (MR_Integer) 10:
          {
            MR_Word ModuleName_35 = ((MR_Word) ((MR_hl_field(3, ConsId_6, (MR_Integer) 1))));

            parse_tree__prog_data_used_modules__record_module_and_ancestors_as_used_4_p_0(Visibility_5, ModuleName_35, STATE_VARIABLE_UsedModules_0_32, STATE_VARIABLE_UsedModules_33);
          }
          break;
        case (MR_Integer) 11:
          {
