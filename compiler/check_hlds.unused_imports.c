  ...
  MR_Word * STATE_VARIABLE_Specs_5)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      mercury__list__foldl_4_p_0((MR_Word) &hlds__hlds_module__hlds__hlds_module__type_ctor_info_avail_module_0, (MR_Word) &check_hlds__unused_imports_scalar_common_1[1], Var_29, STATE_VARIABLE_PrevAvails_0_3, ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))), &conv1_PrevMsgs_16);
