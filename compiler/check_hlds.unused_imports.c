...
static void MR_CALL 
check_hlds__unused_imports__IntroducedFrom__pred__ctor_used_modules__510__1_4_p_0(
...
{
  {
    ...
    check_hlds__unused_imports__IntroducedFrom__pred__ctor_used_modules__510__1_4_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) (wrapper_arg_1)), ((MR_Word) (wrapper_arg_2)), &conv2_LambdaHeadVar__3_29);
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(1), AnywhereSpec_23, 2) = ((MR_Box) ((MR_Unsigned) 88U));
...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), Spec_12, 2) = ((MR_Box) ((MR_Unsigned) 88U));
    ...
    else
    {
      ...
      else
      {
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(0), Spec_25, 2) = ((MR_Box) ((MR_Unsigned) 88U));
