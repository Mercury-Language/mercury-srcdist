...
static void MR_CALL 
check_hlds__unused_imports__IntroducedFrom__pred__ctor_used_modules__468__1_4_p_0(
...
{
  {
    ...
    check_hlds__unused_imports__IntroducedFrom__pred__ctor_used_modules__468__1_4_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) (wrapper_arg_1)), ((MR_Word) (wrapper_arg_2)), &conv2_LambdaHeadVar__3_29);
...
{
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        ImportOrUseDeclName_49 = parse_tree__prog_item__import_or_use_decl_name_1_f_0(ImportOrUse_15);
        {
        ...
        {
          AnywhereSpec_23 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), AnywhereSpec_23, 0) = ((MR_Box) ((MR_Unsigned) 4U));
          MR_hl_field(MR_mktag(1), AnywhereSpec_23, 1) = ((MR_Box) ((MR_Unsigned) 72U));
          MR_hl_field(MR_mktag(1), AnywhereSpec_23, 2) = ((MR_Box) (HeadContext_22));
          MR_hl_field(MR_mktag(1), AnywhereSpec_23, 3) = ((MR_Box) (Pieces_50));
        }
        {
...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), Spec_12, 0) = ((MR_Box) ((MR_Unsigned) 4U));
      MR_hl_field(MR_mktag(1), Spec_12, 1) = ((MR_Box) ((MR_Unsigned) 72U));
      MR_hl_field(MR_mktag(1), Spec_12, 2) = ((MR_Box) (Context_10));
      MR_hl_field(MR_mktag(1), Spec_12, 3) = ((MR_Box) (Pieces_16));
    }
    return Spec_12;
  }
}
  ...
  MR_Word * STATE_VARIABLE_Specs_5)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      MR_Word STATE_VARIABLE_PrevAvails_53_53;
      ...
      if ((PrevMsgs_16 == (MR_Word) ((MR_Unsigned) 0U)))
      {
...

        {
          ...
          MR_hl_field(MR_mktag(1), Var_54, 0) = ((MR_Box) (Avail_12));
          MR_hl_field(MR_mktag(1), Var_54, 1) = ((MR_Box) ((MR_Unsigned) 0U));
        }
        STATE_VARIABLE_PrevAvails_53_53 = mercury__list__f_43_43_2_f_0((MR_Word) (&hlds__hlds_module__hlds__hlds_module__type_ctor_info_avail_module_0), STATE_VARIABLE_PrevAvails_0_3, Var_54);
        STATE_VARIABLE_Specs_52_52 = STATE_VARIABLE_Specs_0_4;
      }
      else
      {
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(1), Var_51, 0) = ((MR_Box) (MainMsg_24));
          MR_hl_field(MR_mktag(1), Var_51, 1) = ((MR_Box) (PrevMsgs_16));
        }
        {
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(1), STATE_VARIABLE_Specs_52_52, 0) = ((MR_Box) (Spec_25));
          MR_hl_field(MR_mktag(1), STATE_VARIABLE_Specs_52_52, 1) = ((MR_Box) (STATE_VARIABLE_Specs_0_4));
        }
        STATE_VARIABLE_PrevAvails_53_53 = STATE_VARIABLE_PrevAvails_0_3;
      }
      // direct tailcall eliminated
      ;
      next_value_of_HeadVar__2_2 = Avails_13;
      next_value_of_STATE_VARIABLE_PrevAvails_0_3 = STATE_VARIABLE_PrevAvails_53_53;
      next_value_of_STATE_VARIABLE_Specs_0_4 = STATE_VARIABLE_Specs_52_52;
