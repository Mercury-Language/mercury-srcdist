...
MR_decl_label10(check_hlds__unused_imports__cons_id_used_modules_4_0, 3,4,5,38,7,9,10,11,13,14)
...
MR_BEGIN_MODULE(check_hlds__unused_imports_module20)
	...
	MR_init_label10(check_hlds__unused_imports__cons_id_used_modules_4_0,3,4,5,38,7,9,10,11,13,14)
...
MR_def_label(check_hlds__unused_imports__cons_id_used_modules_4_0,38)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_tfield(3, MR_r2, 1);
...
MR_def_label(check_hlds__unused_imports__cons_id_used_modules_4_0,18)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_RTAGS_TESTR(MR_r2,3,3)) {
		MR_GOTO_LAB(check_hlds__unused_imports__cons_id_used_modules_4_0_i38);
	}
	MR_r1 = MR_r3;
	MR_proceed();
#ifdef MR_maybe_local_thread_engine_base
