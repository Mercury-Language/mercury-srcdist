  ...
  MR_Word * STATE_VARIABLE_Specs_33)
{
  ...
  if ((TailUnusedAvails_17 == (MR_Word) ((MR_Unsigned) 0U)))
  {
    ...
    Pieces_20 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), Var_34, Var_48);
    {
      ...
      MR_hl_field(0, Spec_21, 1) = ((MR_Box) (MR_mkword(2, &check_hlds__unused_imports_scalar_common_3[0])));
  ...
  else
  {
    ...
    }
    {
      ...
      MR_hl_field(2, Spec_21, 1) = ((MR_Box) (MR_mkword(2, &check_hlds__unused_imports_scalar_common_3[0])));
    ...
    else
    {
      ...
      else
      {
        ...
        }
        {
          ...
          MR_hl_field(2, Spec_25, 1) = ((MR_Box) (MR_mkword(3, &check_hlds__unused_imports_scalar_common_3[0])));
