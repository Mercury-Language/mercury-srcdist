  ...
  MR_Word * Res_12)
{
  ...
  switch (Lang_14) {
    ...
    case (MR_Integer) 2:
      ...
      {
        MR_String IncludeFile_31 = ((MR_String) ((MR_hl_field(MR_mktag(1), LiteralOrInclude_15, (MR_Integer) 0))));
        MR_String SourceFileName_32 = ((MR_String) ((MR_hl_field(MR_mktag(0), Info_8, (MR_Integer) 3))));
        MR_String IncludePath_33;
        MR_Word Var_34;
        MR_Word Var_36;
        MR_Word Var_41;

        parse_tree__file_names__make_include_file_path_3_p_0(SourceFileName_32, IncludeFile_31, &IncludePath_33);
        Var_34 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Info_8, (MR_Integer) 1))) & (MR_Integer) 1);
        {
          ...
          MR_hl_field(MR_mktag(0), Var_36, 0) = ((MR_Box) (IncludePath_33));
          MR_hl_field(MR_mktag(0), Var_36, 1) = ((MR_Box) ((MR_Integer) 1));
        }
        ml_backend__mlds_to_java_util__output_context_for_java_6_p_0(Stream_9, Var_34, (MR_Integer) 0, Var_36);
        libs__file_util__write_include_file_contents_5_p_0(Stream_9, IncludePath_33, Res_12);
        mercury__io__nl_3_p_0(Stream_9);
        Var_41 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Info_8, (MR_Integer) 1))) & (MR_Integer) 1);
        ml_backend__mlds_to_java_util__output_context_for_java_6_p_0(Stream_9, Var_41, (MR_Integer) 1, Context_16);
      }
      else
      {
        MR_String Code_30 = ((MR_String) ((MR_hl_field(MR_mktag(0), LiteralOrInclude_15, (MR_Integer) 0))));

        ml_backend__mlds_to_java_util__write_string_with_context_block_7_p_0(Info_8, Stream_9, Indent_10, Code_30, Context_16);
  ...
  MR_Word * Res_12)
{
  ...
  switch (Lang_14) {
    ...
    case (MR_Integer) 2:
      ...
      {
        MR_String IncludeFile_32 = ((MR_String) ((MR_hl_field(MR_mktag(1), LiteralOrInclude_16, (MR_Integer) 0))));
        ...
        ml_backend__mlds_to_java_util__output_context_for_java_6_p_0(Stream_9, Var_42, (MR_Integer) 1, Context_17);
      }
      else
      {
        MR_String Code_31 = ((MR_String) ((MR_hl_field(MR_mktag(0), LiteralOrInclude_16, (MR_Integer) 0))));

        ml_backend__mlds_to_java_util__write_string_with_context_block_7_p_0(Info_8, Stream_9, Indent_10, Code_31, Context_17);
        *Res_12 = (MR_Word) ((MR_Unsigned) 0U);
      }
      break;
  }
