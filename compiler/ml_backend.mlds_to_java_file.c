...
{
  {
    ...
    MR_Word Var_16;
    MR_Word Var_19;
    MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Import_4, (MR_Integer) 0)));
...
{
  {
    ...
    else
    {
      ...
      {
        Renaming_52 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
    ...
    {
      Var_103 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 6 * sizeof(MR_Word)), NULL, NULL);
      ...
      MR_hl_field(MR_mktag(0), Var_103, 2) = ((MR_Box) (MR_Word) ((MR_Integer) 3));
    ...
    {
      Var_136 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 6 * sizeof(MR_Word)), NULL, NULL);
      ...
      MR_hl_field(MR_mktag(0), Var_136, 2) = ((MR_Box) (MR_Word) ((MR_Integer) 3));
    ...
    {
      Var_144 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 5 * sizeof(MR_Word)), NULL, NULL);
      ...
      MR_hl_field(MR_mktag(0), Var_144, 2) = ((MR_Box) (MR_Word) ((MR_Integer) 2));
