...
{
  {
    ...
    parse_tree__file_names__module_name_to_file_name_8_p_0(Globals_10, (MR_String) "predicate \140ml_backend.mlds_to_java_file.output_java_mlds\'/5", (MR_Integer) 0, (MR_Word) (MR_mkword(MR_mktag(1), &ml_backend__mlds_to_java_file_scalar_common_3[0])), ModuleName_11, &JavaSourceFileName_12);
    {
