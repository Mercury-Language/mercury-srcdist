...
MR_decl_label10(ll_backend__rtti_out__output_maybe_res_functor_defn_7_0, 43,7,8,10,11,12,13,14,15,16)
MR_decl_label5(ll_backend__rtti_out__output_maybe_res_functor_defn_7_0, 22,23,20,17,26)
...
MR_BEGIN_MODULE(ll_backend__rtti_out_module63)
	...
	MR_init_label10(ll_backend__rtti_out__output_maybe_res_functor_defn_7_0,43,7,8,10,11,12,13,14,15,16)
	MR_init_label5(ll_backend__rtti_out__output_maybe_res_functor_defn_7_0,22,23,20,17,26)
MR_BEGIN_CODE
...
MR_def_static(ll_backend__rtti_out__output_maybe_res_functor_defn_7_0)
	...
	if (MR_PTAG_TESTR(MR_r3,1)) {
		MR_GOTO_LAB(ll_backend__rtti_out__output_maybe_res_functor_defn_7_0_i43);
	}
	MR_r3 = MR_tfield(1, MR_r3, 0);
	MR_np_tailcall_ent(ll_backend__rtti_out__output_du_functor_defn_7_0);
MR_def_label(ll_backend__rtti_out__output_maybe_res_functor_defn_7_0,43)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(7);
	MR_sv(7) = (MR_Word) MR_succip;
	{
...
MR_def_label(ll_backend__rtti_out__output_maybe_res_functor_defn_7_0,16)
	...
	if ((MR_tempr1 == MR_mktag((MR_Integer) 1))) {
		MR_GOTO_LAB(ll_backend__rtti_out__output_maybe_res_functor_defn_7_0_i22);
	}
	MR_r1 = (MR_Word) MR_string_const("NULL", 4);
	}
	MR_np_call_localret_ent(io__write_string_3_0,
		ll_backend__rtti_out__output_maybe_res_functor_defn_7_0_i23);
MR_def_label(ll_backend__rtti_out__output_maybe_res_functor_defn_7_0,22)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_def_label(ll_backend__rtti_out__output_maybe_res_functor_defn_7_0,23)
	...
	MR_r1 = (MR_Word) MR_string_const("\n};\n", 4);
	MR_np_call_localret_ent(io__write_string_3_0,
		ll_backend__rtti_out__output_maybe_res_functor_defn_7_0_i26);
...
MR_def_label(ll_backend__rtti_out__output_maybe_res_functor_defn_7_0,17)
	...
	MR_np_call_localret_ent(io__write_string_3_0,
		ll_backend__rtti_out__output_maybe_res_functor_defn_7_0_i26);
MR_def_label(ll_backend__rtti_out__output_maybe_res_functor_defn_7_0,26)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(1);
	MR_decr_sp_and_return(7);
#ifdef MR_maybe_local_thread_engine_base
