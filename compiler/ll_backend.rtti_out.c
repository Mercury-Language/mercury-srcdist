  ...
  MR_Word * STATE_VARIABLE_DeclSet_19)
{
  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      {
        DeclId_48 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(3), DeclId_48, 0) = ((MR_Box) ((MR_Unsigned) 8U));
        MR_hl_field(MR_mktag(3), DeclId_48, 1) = ((MR_Box) (Arity_50));
      }
