        ...
        case (MR_Integer) 2:
          {
            ...
            func_4 = ((void MR_CALL (*)(MR_Box, MR_Box, MR_Box, MR_Box, MR_Box, MR_Box, MR_Box, MR_Box *)) ((MR_hl_field(MR_mktag(0), (MR_hl_field(MR_mktag(0), (MR_Word) (&ll_backend__rtti_out_scalar_common_2[1]), (MR_Integer) 0)), (MR_Integer) 26))));
