  ...
  MR_Word PorF_4)
{
  ...
  switch (PorF_4) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 1:
      Var_15 = (MR_String) "function";
      break;
    case (MR_Integer) 0:
      Var_15 = (MR_String) "predicate";
      break;
  }
...
parse_tree__prog_out__write_class_id_4_p_0(
  ...
  MR_Word HeadVar__2_2)
{
  MR_Word Name_15 = ((MR_Word) ((MR_hl_field(MR_mktag(0), HeadVar__2_2, (MR_Integer) 0))));
  MR_Integer Arity_16 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), HeadVar__2_2, (MR_Integer) 1))));

  parse_tree__prog_out__write_sym_name_4_p_0(Stream_5, Name_15);
  mercury__io__write_string_4_p_0(Stream_5, (MR_String) "/");
  mercury__io__write_int_4_p_0(Stream_5, Arity_16);
}
  ...
  MR_Word SNA_4)
{
  ...
  mercury__io__output_stream_3_p_0(&Stream_6);
  Name_13 = ((MR_Word) ((MR_hl_field(MR_mktag(0), SNA_4, (MR_Integer) 0))));
  Arity_14 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), SNA_4, (MR_Integer) 1))));
  parse_tree__prog_out__write_sym_name_4_p_0(Stream_6, Name_13);
...
{
  MR_Word Stream_6;
  MR_String ContextMessage_15;

  mercury__io__output_stream_3_p_0(&Stream_6);
  parse_tree__prog_out__context_to_string_2_p_0(Context_4, &ContextMessage_15);
  mercury__io__write_string_4_p_0(Stream_6, ContextMessage_15);
}
