  ...
  MR_Integer Arity_7)
{
  ...
  Var_13 = mdbcomp__sym_name__sym_name_to_string_1_f_0(SymName_6);
  Var_16 = mercury__string__int_to_string_1_f_0(Arity_7);
  ...
  MR_Word HeadVar__1_1)
{
  ...
  mercury__string__int_to_string_2_p_0(Arity_4, &ArityString_7);
  {
    ...
    MR_hl_field(1, Var_11, 0) = ((MR_Box) (ArityString_7));
  ...
  }
  {
    ...
    MR_hl_field(1, Var_8, 0) = ((MR_Box) (SymNameString_6));
