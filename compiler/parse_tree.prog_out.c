...
static void MR_CALL 
parse_tree__prog_out__IntroducedFrom__pred__cons_id_and_arity_to_string_maybe_quoted__370__1_3_p_0(
...
static /* final */ const struct parse_tree__prog_out__vector_common_type_5_0_s parse_tree__prog_out_vector_common_5[20];
...
{
  {
    MR_String Str_4 = ((&parse_tree__prog_out_vector_common_5[16 + Warning_3]))->parse_tree__prog_out__vector_common_type_5_0__vct_5_f_0;
      ...
      case (MR_Integer) 1:
        {
          ...
          MR_Word IsUnitize_6 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(1), HeadVar__1_1, (MR_Integer) 0))) & (MR_Integer) 1);
...
{
  {
    ...
    switch (MR_tag((MR_Word) HeadVar__1_1)) {
      ...
      case (MR_Integer) 2:
        {
          MR_Word MinimalMethod_6 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(2), HeadVar__1_1, (MR_Integer) 0))) & (MR_Integer) 3);
...
{
  {
    MR_String Var_8 = ((&parse_tree__prog_out_vector_common_5[4 + PromiseType_4]))->parse_tree__prog_out__vector_common_type_5_0__vct_5_f_0;
...
{
  {
    MR_String HeadVar__2_2 = ((&parse_tree__prog_out_vector_common_5[0 + HeadVar__1_1]))->parse_tree__prog_out__vector_common_type_5_0__vct_5_f_0;
...
{
  {
    ...
    parse_tree__prog_out__IntroducedFrom__pred__cons_id_and_arity_to_string_maybe_quoted__370__1_3_p_0(((MR_Char) (MR_Word) wrapper_arg_1), ((MR_String) (wrapper_arg_2)), &conv0_LambdaHeadVar__3_102);
      ...
      else
      {
        ...
        else
        {
          ...
          else
          {
            ...
            {
              AdjustedSymNameAndArity_14 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
            ...
            }
            {
              ...
              MR_hl_field(MR_mktag(3), Var_23, 1) = (MR_Box) ((MR_Unsigned) (PredOrFunc_5));
            }
            {
...
void MR_CALL 
parse_tree__prog_out__simple_call_id_to_sym_name_arity_2_p_0(
  MR_Word SimpleCallId_3,
  MR_Word * SNA_4)
{
  {
    MR_Word PredOrFunc_5 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), SimpleCallId_3, (MR_Integer) 0))) & (MR_Integer) 1);
