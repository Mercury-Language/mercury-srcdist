...
static void MR_CALL 
parse_tree__prog_out__IntroducedFrom__pred__cons_id_and_arity_to_string_maybe_quoted__327__1_3_p_0(
...
{
  {
    ...
    parse_tree__prog_out__IntroducedFrom__pred__cons_id_and_arity_to_string_maybe_quoted__327__1_3_p_0(((MR_Char) (MR_Word) wrapper_arg_1), ((MR_String) (wrapper_arg_2)), &conv0_LambdaHeadVar__3_102);
    ...
    switch (MR_tag((MR_Word) ConsId_7)) {
      ...
      case (MR_Integer) 3:
        switch (((MR_Integer) ((MR_hl_field(MR_mktag(3), ConsId_7, (MR_Integer) 0))))) {
          ...
          case (MR_Integer) 18:
            {
              MR_Word IDCKind_34 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(3), ConsId_7, (MR_Integer) 1))) & (MR_Integer) 7);

              switch (QuoteCons_6) {
                default: /*NOTREACHED*/ MR_assert(0);
                case (MR_Integer) 0:
                  String_8 = parse_tree__prog_data__impl_defined_const_kind_to_str_1_f_0(IDCKind_34);
                  break;
                case (MR_Integer) 1:
                  {
                    MR_String Var_94;
                    ...
                    Var_95 = parse_tree__prog_data__impl_defined_const_kind_to_str_1_f_0(IDCKind_34);
                    Var_94 = mercury__string__f_43_43_2_f_0(Var_95, (MR_String) "\'");
                    String_8 = mercury__string__f_43_43_2_f_0((MR_String) "\140", Var_94);
                  }
                  break;
              }
            }
