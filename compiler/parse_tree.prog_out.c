...
static void MR_CALL 
parse_tree__prog_out__IntroducedFrom__pred__cons_id_and_arity_to_string_maybe_quoted__320__1_3_p_0(
...
static /* final */ const MR_Box parse_tree__prog_out_scalar_common_4[1][1];

static /* final */ const MR_Box parse_tree__prog_out_scalar_common_5[1][6];
...
/* sealed */ struct parse_tree__prog_out__vector_common_type_8_0_s {
...
void MR_CALL 
parse_tree__prog_out__write_pred_or_func_to_cur_stream_3_p_0(
  MR_Word PorF_4)
{
  {
    MR_String Var_8;
...
{
  {
    ...
    parse_tree__prog_out__IntroducedFrom__pred__cons_id_and_arity_to_string_maybe_quoted__320__1_3_p_0(((MR_Char) (MR_Word) wrapper_arg_1), ((MR_String) (wrapper_arg_2)), &conv0_LambdaHeadVar__3_102);
          ...
          case (MR_Integer) 4:
            {
              ...
              String_8 = mercury__string__f_43_43_2_f_0((MR_String) "closure_cons<pred ", Var_86);
            }
            break;
          case (MR_Integer) 5:
            {
...
void MR_CALL 
parse_tree__prog_out__write_sym_name_arity_to_cur_stream_3_p_0(
  MR_Word SNA_4)
{
  {
    MR_Word Stream_6;
...
void MR_CALL 
parse_tree__prog_out__write_quoted_sym_name_to_cur_stream_3_p_0(
  MR_Word SymName_4)
{
  {
    MR_Word Stream_17;
    ...
    parse_tree__prog_out__write_sym_name_4_p_0(Stream_17, SymName_4);
    mercury__io__write_string_3_p_0((MR_String) "\'");
  }
}

void MR_CALL 
parse_tree__prog_out__write_sym_name_to_cur_stream_3_p_0(
  MR_Word SymName_4)
{
  {
    MR_Word Stream_6;
...
void MR_CALL 
parse_tree__prog_out__write_context_to_cur_stream_3_p_0(
  MR_Word Context_4)
{
  {
    MR_Word Stream_6;
