...
MR_decl_label3(parse_tree__prog_out__builtin_type_to_string_2_0, 3,4,5)
...
MR_decl_label3(parse_tree__prog_out__write_promise_type_3_0, 3,4,5)
...
MR_decl_label7(fn__parse_tree__prog_out__determinism_to_string_1_0, 3,4,5,6,7,8,9)
MR_decl_label6(fn__parse_tree__prog_out__eval_method_to_pragma_name_1_0, 3,4,7,8,5,9)
MR_decl_label10(fn__parse_tree__prog_out__eval_method_to_string_1_0, 3,4,5,8,9,61,11,10,13,14)
MR_decl_label1(fn__parse_tree__prog_out__eval_method_to_string_1_0, 15)
...
MR_decl_label3(fn__parse_tree__prog_out__promise_to_string_1_0, 3,4,5)
...
MR_BEGIN_MODULE(parse_tree__prog_out_module10)
	...
	MR_init_label3(fn__parse_tree__prog_out__promise_to_string_1_0,3,4,5)
MR_BEGIN_CODE
...
MR_define_entry(mercury__fn__parse_tree__prog_out__promise_to_string_1_0);
	...
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(fn__parse_tree__prog_out__promise_to_string_1_0_i3);
	}
	MR_r1 = (MR_Word) MR_string_const("promise_exclusive", 17);
	MR_proceed();
MR_def_label(fn__parse_tree__prog_out__promise_to_string_1_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,2)) {
		MR_GOTO_LAB(fn__parse_tree__prog_out__promise_to_string_1_0_i4);
	}
	MR_r1 = (MR_Word) MR_string_const("promise_exclusive_exhaustive", 28);
	MR_proceed();
MR_def_label(fn__parse_tree__prog_out__promise_to_string_1_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,1)) {
		MR_GOTO_LAB(fn__parse_tree__prog_out__promise_to_string_1_0_i5);
	}
	MR_r1 = (MR_Word) MR_string_const("promise_exhaustive", 18);
	MR_proceed();
MR_def_label(fn__parse_tree__prog_out__promise_to_string_1_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_string_const("promise", 7);
	MR_proceed();
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_thread_engine_base
...
MR_BEGIN_MODULE(parse_tree__prog_out_module20)
	...
	MR_init_label3(parse_tree__prog_out__write_promise_type_3_0,3,4,5)
MR_BEGIN_CODE
...
MR_define_entry(mercury__parse_tree__prog_out__write_promise_type_3_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(parse_tree__prog_out__write_promise_type_3_0_i3);
	}
	MR_r1 = (MR_Word) MR_string_const("promise_exclusive", 17);
	MR_np_tailcall_ent(io__write_string_3_0);
MR_def_label(parse_tree__prog_out__write_promise_type_3_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,2)) {
		MR_GOTO_LAB(parse_tree__prog_out__write_promise_type_3_0_i4);
	}
	MR_r1 = (MR_Word) MR_string_const("promise_exclusive_exhaustive", 28);
	MR_np_tailcall_ent(io__write_string_3_0);
MR_def_label(parse_tree__prog_out__write_promise_type_3_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,1)) {
		MR_GOTO_LAB(parse_tree__prog_out__write_promise_type_3_0_i5);
	}
	MR_r1 = (MR_Word) MR_string_const("promise_exhaustive", 18);
	MR_np_tailcall_ent(io__write_string_3_0);
MR_def_label(parse_tree__prog_out__write_promise_type_3_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_string_const("promise", 7);
	MR_np_tailcall_ent(io__write_string_3_0);
#ifdef MR_maybe_local_thread_engine_base
...
MR_BEGIN_MODULE(parse_tree__prog_out_module23)
	...
	MR_init_label3(parse_tree__prog_out__builtin_type_to_string_2_0,3,4,5)
MR_BEGIN_CODE
...
MR_define_entry(mercury__parse_tree__prog_out__builtin_type_to_string_2_0);
	...
	if (MR_INT_NE(MR_r1,3)) {
		MR_GOTO_LAB(parse_tree__prog_out__builtin_type_to_string_2_0_i3);
	}
	MR_r1 = (MR_Word) MR_string_const("character", 9);
	MR_proceed();
MR_def_label(parse_tree__prog_out__builtin_type_to_string_2_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,1)) {
		MR_GOTO_LAB(parse_tree__prog_out__builtin_type_to_string_2_0_i4);
	}
	MR_r1 = (MR_Word) MR_string_const("float", 5);
	MR_proceed();
MR_def_label(parse_tree__prog_out__builtin_type_to_string_2_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(parse_tree__prog_out__builtin_type_to_string_2_0_i5);
	}
	MR_r1 = (MR_Word) MR_string_const("int", 3);
	MR_proceed();
MR_def_label(parse_tree__prog_out__builtin_type_to_string_2_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_BEGIN_MODULE(parse_tree__prog_out_module33)
	...
	MR_init_label6(fn__parse_tree__prog_out__eval_method_to_pragma_name_1_0,3,4,7,8,5,9)
MR_BEGIN_CODE
...
MR_define_entry(mercury__fn__parse_tree__prog_out__eval_method_to_pragma_name_1_0);
	...
	if (MR_LTAGS_TESTR(MR_r1,0,1)) {
		MR_GOTO_LAB(fn__parse_tree__prog_out__eval_method_to_pragma_name_1_0_i3);
	}
	MR_r1 = (MR_Word) MR_string_const("loop_check", 10);
	MR_proceed();
MR_def_label(fn__parse_tree__prog_out__eval_method_to_pragma_name_1_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_def_label(fn__parse_tree__prog_out__eval_method_to_pragma_name_1_0,5)
	...
	MR_r1 = (MR_Word) MR_string_const("parse_tree.prog_out", 19);
	MR_r2 = (MR_Word) MR_string_const("function \140parse_tree.prog_out.eval_method_to_pragma_name\'/1", 59);
	MR_r3 = (MR_Word) MR_string_const("normal", 6);
...
MR_BEGIN_MODULE(parse_tree__prog_out_module34)
	...
	MR_init_label10(fn__parse_tree__prog_out__eval_method_to_string_1_0,3,4,5,8,9,61,11,10,13,14)
	MR_init_label1(fn__parse_tree__prog_out__eval_method_to_string_1_0,15)
MR_BEGIN_CODE
...
MR_define_entry(mercury__fn__parse_tree__prog_out__eval_method_to_string_1_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r1,0,1)) {
		MR_GOTO_LAB(fn__parse_tree__prog_out__eval_method_to_string_1_0_i3);
	}
	MR_r1 = (MR_Word) MR_string_const("loop_check", 10);
	MR_proceed();
MR_def_label(fn__parse_tree__prog_out__eval_method_to_string_1_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r1,0,2)) {
...
MR_def_label(fn__parse_tree__prog_out__eval_method_to_string_1_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_r1,2)) {
		MR_GOTO_LAB(fn__parse_tree__prog_out__eval_method_to_string_1_0_i61);
	}
	MR_r2 = MR_tfield(2, MR_r1, 0);
	if (MR_INT_NE(MR_r2,1)) {
...
MR_def_label(fn__parse_tree__prog_out__eval_method_to_string_1_0,8)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r2,2)) {
		MR_GOTO_LAB(fn__parse_tree__prog_out__eval_method_to_string_1_0_i9);
	}
	MR_r1 = (MR_Word) MR_string_const("minimal_model_own_stacks_generator", 34);
	MR_proceed();
MR_def_label(fn__parse_tree__prog_out__eval_method_to_string_1_0,9)
	...
	MR_proceed();
MR_def_label(fn__parse_tree__prog_out__eval_method_to_string_1_0,61)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(2);
	MR_sv(2) = (MR_Word) MR_succip;
	...
	MR_GOTO_LAB(fn__parse_tree__prog_out__eval_method_to_string_1_0_i10);
...
MR_def_label(fn__parse_tree__prog_out__eval_method_to_string_1_0,10)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,1)) {
		MR_GOTO_LAB(fn__parse_tree__prog_out__eval_method_to_string_1_0_i13);
	}
	MR_r1 = (MR_Word) MR_string_const("alone", 5);
	MR_r2 = (MR_Word) MR_string_const(")", 1);
	MR_np_call_localret_ent(fn__f_115_116_114_105_110_103_95_95_43_43_2_0,
		fn__parse_tree__prog_out__eval_method_to_string_1_0_i14);
MR_def_label(fn__parse_tree__prog_out__eval_method_to_string_1_0,13)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_BEGIN_MODULE(parse_tree__prog_out_module38)
	...
	MR_init_label7(fn__parse_tree__prog_out__determinism_to_string_1_0,3,4,5,6,7,8,9)
MR_BEGIN_CODE
...
MR_define_entry(mercury__fn__parse_tree__prog_out__determinism_to_string_1_0);
	...
	if (MR_INT_NE(MR_r1,4)) {
		MR_GOTO_LAB(fn__parse_tree__prog_out__determinism_to_string_1_0_i3);
	}
	MR_r1 = (MR_Word) MR_string_const("cc_multi", 8);
	MR_proceed();
MR_def_label(fn__parse_tree__prog_out__determinism_to_string_1_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,5)) {
		MR_GOTO_LAB(fn__parse_tree__prog_out__determinism_to_string_1_0_i4);
	}
	MR_r1 = (MR_Word) MR_string_const("cc_nondet", 9);
	MR_proceed();
MR_def_label(fn__parse_tree__prog_out__determinism_to_string_1_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(fn__parse_tree__prog_out__determinism_to_string_1_0_i5);
	}
	MR_r1 = (MR_Word) MR_string_const("det", 3);
	MR_proceed();
MR_def_label(fn__parse_tree__prog_out__determinism_to_string_1_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,6)) {
		MR_GOTO_LAB(fn__parse_tree__prog_out__determinism_to_string_1_0_i6);
	}
	MR_r1 = (MR_Word) MR_string_const("erroneous", 9);
	MR_proceed();
MR_def_label(fn__parse_tree__prog_out__determinism_to_string_1_0,6)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,7)) {
		MR_GOTO_LAB(fn__parse_tree__prog_out__determinism_to_string_1_0_i7);
	}
	MR_r1 = (MR_Word) MR_string_const("failure", 7);
	MR_proceed();
MR_def_label(fn__parse_tree__prog_out__determinism_to_string_1_0,7)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,2)) {
		MR_GOTO_LAB(fn__parse_tree__prog_out__determinism_to_string_1_0_i8);
	}
	MR_r1 = (MR_Word) MR_string_const("multi", 5);
	MR_proceed();
MR_def_label(fn__parse_tree__prog_out__determinism_to_string_1_0,8)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,3)) {
		MR_GOTO_LAB(fn__parse_tree__prog_out__determinism_to_string_1_0_i9);
	}
	MR_r1 = (MR_Word) MR_string_const("nondet", 6);
	MR_proceed();
MR_def_label(fn__parse_tree__prog_out__determinism_to_string_1_0,9)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
void mercury__parse_tree__prog_out__init_threadscope_string_table(void);
#endif
...
void mercury__parse_tree__prog_out__write_out_proc_statics(FILE *deep_fp, FILE *procrep_fp)
{
	MR_write_out_module_proc_reps_start(procrep_fp, &mercury_data__module_layout__parse_tree__prog_out);
