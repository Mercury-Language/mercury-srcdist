...
MR_decl_label8(parse_tree__prog_out__write_messages_3_0, 51,5,6,7,8,9,15,16)
MR_decl_label2(parse_tree__prog_out__write_messages_3_0, 17,53)
MR_decl_label1(parse_tree__prog_out__write_pred_or_func_3_0, 3)
MR_decl_label2(parse_tree__prog_out__write_purity_3_0, 3,4)
MR_decl_label3(parse_tree__prog_out__write_purity_prefix_3_0, 4,7,23)
...
MR_decl_label2(fn__parse_tree__prog_out__purity_prefix_to_string_1_0, 3,4)
...
MR_BEGIN_MODULE(parse_tree__prog_out_module7)
	...
	MR_init_label8(parse_tree__prog_out__write_messages_3_0,51,5,6,7,8,9,15,16)
	MR_init_label2(parse_tree__prog_out__write_messages_3_0,17,53)
MR_BEGIN_CODE
...
MR_def_label(parse_tree__prog_out__write_messages_3_0,51)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TEST(MR_r1,0,0)) {
		MR_GOTO_LAB(parse_tree__prog_out__write_messages_3_0_i53);
	}
	{
	...
	if (MR_PTAG_TESTR(MR_tempr2,0)) {
		MR_GOTO_LAB(parse_tree__prog_out__write_messages_3_0_i5);
	}
...
MR_def_label(parse_tree__prog_out__write_messages_3_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_def_label(parse_tree__prog_out__write_messages_3_0,6)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_np_call_localret_ent(io__write_string_3_0,
		parse_tree__prog_out__write_messages_3_0_i7);
MR_def_label(parse_tree__prog_out__write_messages_3_0,7)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(2);
	MR_np_call_localret_ent(io__write_string_3_0,
		parse_tree__prog_out__write_messages_3_0_i8);
MR_def_label(parse_tree__prog_out__write_messages_3_0,8)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_sv(3),0)) {
		MR_GOTO_LAB(parse_tree__prog_out__write_messages_3_0_i9);
	}
	{
	MR_Word MR_tempr1, MR_tempr2, MR_tempr3;
	MR_tempr3 = MR_sv(3);
...
MR_def_label(parse_tree__prog_out__write_messages_3_0,9)
	...
	MR_np_call_localret_ent(io__write_string_3_0,
		parse_tree__prog_out__write_messages_3_0_i15);
MR_def_label(parse_tree__prog_out__write_messages_3_0,15)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_def_label(parse_tree__prog_out__write_messages_3_0,17)
	...
	MR_GOTO_LAB(parse_tree__prog_out__write_messages_3_0_i51);
MR_def_label(parse_tree__prog_out__write_messages_3_0,53)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_define_entry(mercury__parse_tree__prog_out__builtin_type_to_string_2_0);
	...
	MR_Word MR_tempr1, MR_tempr2, MR_tempr3;
	MR_tempr3 = MR_r1;
	MR_tempr1 = (MR_Word) &MR_tfield(0, (MR_Word *) &mercury_vector_common_0_2, (MR_Integer) MR_tempr3);
	MR_tempr2 = MR_tempr3;
	MR_r1 = MR_ctfield(0, MR_tempr1, 0);
	MR_proceed();
	}
...
MR_BEGIN_MODULE(parse_tree__prog_out_module35)
	...
	MR_init_label3(parse_tree__prog_out__write_purity_prefix_3_0,4,7,23)
MR_BEGIN_CODE
...
MR_define_entry(mercury__parse_tree__prog_out__write_purity_prefix_3_0);
	...
	MR_sv(1) = (MR_Word) MR_succip;
	if (MR_INT_NE(MR_r1,1)) {
		MR_GOTO_LAB(parse_tree__prog_out__write_purity_prefix_3_0_i4);
	}
	MR_r1 = (MR_Word) MR_string_const("semipure", 8);
	MR_np_call_localret_ent(io__write_string_3_0,
		parse_tree__prog_out__write_purity_prefix_3_0_i7);
MR_def_label(parse_tree__prog_out__write_purity_prefix_3_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_string_const("impure", 6);
	MR_np_call_localret_ent(io__write_string_3_0,
		parse_tree__prog_out__write_purity_prefix_3_0_i7);
...
MR_BEGIN_MODULE(parse_tree__prog_out_module36)
	...
	MR_init_label2(fn__parse_tree__prog_out__purity_prefix_to_string_1_0,3,4)
MR_BEGIN_CODE
...
MR_def_label(fn__parse_tree__prog_out__purity_prefix_to_string_1_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,1)) {
		MR_GOTO_LAB(fn__parse_tree__prog_out__purity_prefix_to_string_1_0_i4);
	}
	MR_r1 = (MR_Word) MR_string_const("semipure ", 9);
	MR_proceed();
MR_def_label(fn__parse_tree__prog_out__purity_prefix_to_string_1_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_string_const("impure ", 7);
	MR_proceed();
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_thread_engine_base
