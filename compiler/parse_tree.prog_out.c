...
static void MR_CALL 
parse_tree__prog_out__IntroducedFrom__pred__cons_id_and_arity_to_string_maybe_quoted__386__1_3_p_0(
...
static /* final */ const struct parse_tree__prog_out__vector_common_type_6_0_s parse_tree__prog_out_vector_common_6[18];
...
static /* final */ const struct parse_tree__prog_out__vector_common_type_6_0_s parse_tree__prog_out_vector_common_6[18] = {
  ...
  /* row  17 */   { (MR_String) "unknown_format_calls" },
};
      ...
      case (MR_Integer) 1:
        {
...

          {
            ...
            MR_hl_field(0, Var_29, 0) = ((MR_Box) (&parse_tree__prog_out_scalar_common_5[1]));
          ...
          case (MR_Integer) 0:
            {
...

              {
                ...
                MR_hl_field(0, Var_40, 0) = ((MR_Box) (&parse_tree__prog_out_scalar_common_5[1]));
          ...
          case (MR_Integer) 1:
            {
...

              {
                ...
                MR_hl_field(0, Var_46, 0) = ((MR_Box) (&parse_tree__prog_out_scalar_common_5[1]));
          ...
          case (MR_Integer) 2:
            {
...

              {
                ...
                MR_hl_field(0, Var_58, 0) = ((MR_Box) (&parse_tree__prog_out_scalar_common_5[1]));
  ...
  MR_Box * wrapper_arg_3)
{
  ...
  parse_tree__prog_out__IntroducedFrom__pred__cons_id_and_arity_to_string_maybe_quoted__386__1_3_p_0(((MR_Char) (MR_Word) wrapper_arg_1), ((MR_String) (wrapper_arg_2)), &conv0_LambdaHeadVar__3_45);
