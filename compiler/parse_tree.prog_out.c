...
{
  {
    ...
    parse_tree__prog_out__IntroducedFrom__pred__cons_id_and_arity_to_string_maybe_quoted__343__1_3_p_0(((MR_Char) (MR_Word) wrapper_arg_1), ((MR_String) wrapper_arg_2), &conv0_LambdaHeadVar__3_100);
    ...
    switch (MR_tag((MR_Word) ConsId_7)) {
      ...
      case (MR_Integer) 3:
        switch (((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), ConsId_7, (MR_Integer) 0)))) {
          ...
          case (MR_Integer) 7:
            {
              MR_Integer Int8_23 = ((MR_Integer) (MR_hl_field(MR_mktag(3), ConsId_7, (MR_Integer) 1)));

              mercury__string__int_to_string_2_p_0(Int8_23, &String_8);
            }
            break;
          case (MR_Integer) 8:
            {
              MR_Integer UInt8_24 = ((MR_Integer) (MR_hl_field(MR_mktag(3), ConsId_7, (MR_Integer) 1)));

              mercury__string__int_to_string_2_p_0(UInt8_24, &String_8);
            }
            break;
          case (MR_Integer) 9:
            {
              MR_Integer Int16_25 = ((MR_Integer) (MR_hl_field(MR_mktag(3), ConsId_7, (MR_Integer) 1)));

              mercury__string__int_to_string_2_p_0(Int16_25, &String_8);
            }
            break;
          case (MR_Integer) 10:
            {
              MR_Integer UInt16_26 = ((MR_Integer) (MR_hl_field(MR_mktag(3), ConsId_7, (MR_Integer) 1)));

              mercury__string__int_to_string_2_p_0(UInt16_26, &String_8);
            }
            break;
          case (MR_Integer) 11:
            {
              MR_Integer Int32_27 = ((MR_Integer) (MR_hl_field(MR_mktag(3), ConsId_7, (MR_Integer) 1)));

              mercury__string__int_to_string_2_p_0(Int32_27, &String_8);
            }
            break;
          case (MR_Integer) 12:
            {
              MR_Integer UInt32_28 = ((MR_Integer) (MR_hl_field(MR_mktag(3), ConsId_7, (MR_Integer) 1)));

              mercury__string__int_to_string_2_p_0(UInt32_28, &String_8);
            }
            break;
          case (MR_Integer) 13:
            {
