    ...
    switch (MR_tag((MR_Word) ConsId_7)) {
      ...
      case (MR_Integer) 2:
        {
          ...
          MR_String Var_71;
          MR_String Var_72;
          MR_Word PredProcId_116 = ((MR_Word) (MR_hl_field(MR_mktag(2), ConsId_7, (MR_Integer) 0)));
      ...
      case (MR_Integer) 3:
        switch (((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), ConsId_7, (MR_Integer) 0)))) {
          ...
          case (MR_Integer) 13:
            {
              MR_Integer Int64_29 = ((MR_Integer) (MR_hl_field(MR_mktag(3), ConsId_7, (MR_Integer) 1)));

              String_8 = mercury__string__int_to_string_1_f_0(Int64_29);
            }
            break;
          case (MR_Integer) 14:
            {
              MR_Integer UInt64_30 = ((MR_Integer) (MR_hl_field(MR_mktag(3), ConsId_7, (MR_Integer) 1)));

              String_8 = mercury__string__int_to_string_1_f_0(UInt64_30);
            }
            break;
          case (MR_Integer) 15:
            {
