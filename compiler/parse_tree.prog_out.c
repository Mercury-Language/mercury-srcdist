...
MR_decl_label6(fn__parse_tree__prog_out__eval_method_to_pragma_name_1_0, 15,4,5,7,8,11)
MR_decl_label8(fn__parse_tree__prog_out__eval_method_to_string_1_0, 20,4,5,7,8,63,12,11)
MR_decl_label3(fn__parse_tree__prog_out__eval_method_to_string_1_0, 14,15,16)
...
MR_decl_label8(fn__parse_tree__prog_out__simple_call_id_to_string_3_0, 2,4,3,11,10,18,17,25)
MR_decl_label2(fn__parse_tree__prog_out__simple_call_id_to_string_3_0, 24,31)
...
MR_BEGIN_MODULE(parse_tree__prog_out_module13)
	...
	MR_init_label8(fn__parse_tree__prog_out__simple_call_id_to_string_3_0,2,4,3,11,10,18,17,25)
	MR_init_label2(fn__parse_tree__prog_out__simple_call_id_to_string_3_0,24,31)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(parse_tree__prog_out_module31)
	...
	MR_init_label6(fn__parse_tree__prog_out__eval_method_to_pragma_name_1_0,15,4,5,7,8,11)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(parse_tree__prog_out_module32)
	...
	MR_init_label8(fn__parse_tree__prog_out__eval_method_to_string_1_0,20,4,5,7,8,63,12,11)
	MR_init_label3(fn__parse_tree__prog_out__eval_method_to_string_1_0,14,15,16)
MR_BEGIN_CODE
