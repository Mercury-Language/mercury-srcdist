...
static void MR_CALL 
parse_tree__prog_out__IntroducedFrom__pred__cons_id_and_arity_to_string_maybe_quoted__315__1_3_p_0(
...
{
  {
    ...
    {
      parse_tree__prog_out__IntroducedFrom__pred__cons_id_and_arity_to_string_maybe_quoted__315__1_3_p_0(((MR_Char) (MR_Word) parse_tree__prog_out__wrapper_arg_1), ((MR_String) parse_tree__prog_out__wrapper_arg_2), &parse_tree__prog_out__conv0_LambdaHeadVar__3_92);
    }
    ...
    switch (MR_tag((MR_Word) parse_tree__prog_out__ConsId_5)) {
      ...
      case (MR_Integer) 3:
        switch (((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), parse_tree__prog_out__ConsId_5, (MR_Integer) 0)))) {
          ...
          case (MR_Integer) 6:
            {
              MR_Integer parse_tree__prog_out__UInt_20 = ((MR_Integer) (MR_hl_field(MR_mktag(3), parse_tree__prog_out__ConsId_5, (MR_Integer) 1)));

              {
                mercury__string__int_to_string_2_p_0(parse_tree__prog_out__UInt_20, &parse_tree__prog_out__String_6);
              }
            }
            break;
          case (MR_Integer) 7:
