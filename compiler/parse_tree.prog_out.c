...
static void MR_CALL 
parse_tree__prog_out__IntroducedFrom__pred__cons_id_and_arity_to_string_maybe_quoted__345__1_3_p_0(
...
{
  {
    ...
    switch (Warning_3) {
      ...
      case (MR_Integer) 2:
        Str_4 = (MR_String) "infinite_recursion_modulo_svar";
        break;
      case (MR_Integer) 1:
...
{
  {
    ...
    parse_tree__prog_out__IntroducedFrom__pred__cons_id_and_arity_to_string_maybe_quoted__345__1_3_p_0(((MR_Char) (MR_Word) wrapper_arg_1), ((MR_String) (wrapper_arg_2)), &conv0_LambdaHeadVar__3_102);
