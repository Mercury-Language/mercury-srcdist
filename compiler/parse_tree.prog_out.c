...
{
  {
    ...
    {
      parse_tree__prog_out__IntroducedFrom__pred__cons_id_and_arity_to_string_maybe_quoted__315__1_3_p_0(((MR_Char) (MR_Word) parse_tree__prog_out__wrapper_arg_1), ((MR_String) parse_tree__prog_out__wrapper_arg_2), &parse_tree__prog_out__conv0_LambdaHeadVar__3_91);
    }
