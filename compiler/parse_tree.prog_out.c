...
static void MR_CALL 
parse_tree__prog_out__IntroducedFrom__pred__cons_id_and_arity_to_string_maybe_quoted__439__1_3_p_0(
  MR_Char LambdaHeadVar__1_43,
  MR_String LambdaHeadVar__2_44,
  MR_String * LambdaHeadVar__3_45);
...
static /* final */ const MR_Box parse_tree__prog_out_scalar_common_6[2][6];


struct parse_tree__prog_out__vector_common_type_5_0_s {
  const MR_String parse_tree__prog_out__vector_common_type_5_0__vct_5_f_0;
};

static /* final */ const struct parse_tree__prog_out__vector_common_type_5_0_s parse_tree__prog_out_vector_common_5[28];
...
static /* final */ const struct parse_tree__prog_out__vector_common_type_5_0_s parse_tree__prog_out_vector_common_5[28] = {
  ...
  /* row   8 */   { (MR_String) "                " },
  /* row   9 */   { (MR_String) "                  " },
  /* row  10 */   { (MR_String) "promise_exclusive" },
  /* row  11 */   { (MR_String) "promise_exhaustive" },
  /* row  12 */   { (MR_String) "promise_exclusive_exhaustive" },
  /* row  13 */   { (MR_String) "promise" },
  /* row  14 */   { (MR_String) "det" },
  /* row  15 */   { (MR_String) "semidet" },
  /* row  16 */   { (MR_String) "multi" },
  /* row  17 */   { (MR_String) "nondet" },
  /* row  18 */   { (MR_String) "cc_multi" },
  /* row  19 */   { (MR_String) "cc_nondet" },
  /* row  20 */   { (MR_String) "erroneous" },
  /* row  21 */   { (MR_String) "failure" },
  /* row  22 */   { (MR_String) "singleton_vars" },
  /* row  23 */   { (MR_String) "suspected_occurs_check_failure" },
  /* row  24 */   { (MR_String) "non_tail_recursive_calls" },
  /* row  25 */   { (MR_String) "suspicious_recursion" },
  /* row  26 */   { (MR_String) "no_solution_disjunct" },
  /* row  27 */   { (MR_String) "unknown_format_calls" },
};
...
parse_tree__prog_out__IntroducedFrom__pred__cons_id_and_arity_to_string_maybe_quoted__439__1_3_p_0(
  ...
  MR_String * LambdaHeadVar__3_45)
{
  MR_bool succeeded = (LambdaHeadVar__1_43 == (MR_Char) 42);

  if (succeeded)
    mercury__string__append_3_p_2(LambdaHeadVar__2_44, (MR_String) "star", LambdaHeadVar__3_45);
  else
  {
    MR_String CharStr_18;

    mercury__string__char_to_string_2_p_0(LambdaHeadVar__1_43, &CharStr_18);
    mercury__string__append_3_p_2(LambdaHeadVar__2_44, CharStr_18, LambdaHeadVar__3_45);
  }
}
  ...
  MR_Box * wrapper_arg_2)
{
  ...
  parse_tree__prog_out__type_to_debug_string_3_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) (wrapper_arg_1)), &conv4_Name_6);
  ...
  MR_Box * wrapper_arg_2)
{
  ...
  parse_tree__prog_out__type_to_debug_string_3_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) (wrapper_arg_1)), &conv2_Name_6);
  ...
  MR_Box * wrapper_arg_2)
{
  ...
  parse_tree__prog_out__type_to_debug_string_3_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) (wrapper_arg_1)), &conv1_Name_6);
  ...
  MR_Box * wrapper_arg_2)
{
  ...
  parse_tree__prog_out__type_to_debug_string_3_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) (wrapper_arg_1)), &conv0_Name_6);
      ...
      case (MR_Integer) 1:
        {
...

          {
            ...
            MR_hl_field(0, Var_29, 0) = ((MR_Box) (&parse_tree__prog_out_scalar_common_6[1]));
            MR_hl_field(0, Var_29, 1) = ((MR_Box) (parse_tree__prog_out__type_to_debug_string_3_p_0_2));
          ...
          case (MR_Integer) 0:
            {
...

              {
                ...
                MR_hl_field(0, Var_40, 0) = ((MR_Box) (&parse_tree__prog_out_scalar_common_6[1]));
                MR_hl_field(0, Var_40, 1) = ((MR_Box) (parse_tree__prog_out__type_to_debug_string_3_p_0_4));
          ...
          case (MR_Integer) 1:
            {
...

              {
                ...
                MR_hl_field(0, Var_46, 0) = ((MR_Box) (&parse_tree__prog_out_scalar_common_6[1]));
                MR_hl_field(0, Var_46, 1) = ((MR_Box) (parse_tree__prog_out__type_to_debug_string_3_p_0_3));
          ...
          case (MR_Integer) 2:
            {
...

              {
                ...
                MR_hl_field(0, Var_58, 0) = ((MR_Box) (&parse_tree__prog_out_scalar_common_6[1]));
                MR_hl_field(0, Var_58, 1) = ((MR_Box) (parse_tree__prog_out__type_to_debug_string_3_p_0_1));
...
parse_tree__prog_out__goal_warning_to_string_1_f_0(
  MR_Word Warning_3)
{
  MR_String Str_4 = ((&parse_tree__prog_out_vector_common_5[22 + Warning_3]))->parse_tree__prog_out__vector_common_type_5_0__vct_5_f_0;
...
parse_tree__prog_out__determinism_to_string_1_f_0(
  MR_Word HeadVar__1_1)
{
  MR_String HeadVar__2_2 = ((&parse_tree__prog_out_vector_common_5[14 + HeadVar__1_1]))->parse_tree__prog_out__vector_common_type_5_0__vct_5_f_0;
...
parse_tree__prog_out__promise_to_string_1_f_0(
  MR_Word HeadVar__1_1)
{
  MR_String HeadVar__2_2 = ((&parse_tree__prog_out_vector_common_5[10 + HeadVar__1_1]))->parse_tree__prog_out__vector_common_type_5_0__vct_5_f_0;
...
{
  MR_Box closure = closure_arg;
  MR_String conv0_LambdaHeadVar__3_45;

  parse_tree__prog_out__IntroducedFrom__pred__cons_id_and_arity_to_string_maybe_quoted__439__1_3_p_0(((MR_Char) (MR_Word) wrapper_arg_1), ((MR_String) (wrapper_arg_2)), &conv0_LambdaHeadVar__3_45);
    ...
    case (MR_Integer) 2:
      {
        ...
        MR_Integer PredId_109 = ((MR_Integer) ((MR_hl_field(0, PredProcId_108, (MR_Integer) 0))));
        MR_Integer ProcId_110 = ((MR_Integer) ((MR_hl_field(0, PredProcId_108, (MR_Integer) 1))));

        Var_81 = mercury__string__int_to_string_1_f_0(PredId_109);
        Var_85 = mercury__string__int_to_string_1_f_0(ProcId_110);
        ...
        String_8 = mercury__string__f_43_43_2_f_0((MR_String) "<tabling_info ", Var_80);
      }
      break;
    case (MR_Integer) 3:
      switch (((MR_Integer) ((MR_hl_field(3, ConsId_7, (MR_Integer) 0))))) {
        ...
        case (MR_Integer) 0:
          {
            ...
            MR_String Var_92;
            MR_String Var_93;
            MR_Word PredProcId_111 = ((MR_Word) ((MR_hl_field(3, ConsId_7, (MR_Integer) 1))));
            MR_Integer PredId_112 = ((MR_Integer) ((MR_hl_field(0, PredProcId_111, (MR_Integer) 0))));
            MR_Integer ProcId_113 = ((MR_Integer) ((MR_hl_field(0, PredProcId_111, (MR_Integer) 1))));

            Var_89 = mercury__string__int_to_string_1_f_0(PredId_112);
            Var_93 = mercury__string__int_to_string_1_f_0(ProcId_113);
            ...
            String_8 = mercury__string__f_43_43_2_f_0((MR_String) "<table_io_entry_desc ", Var_88);
          }
          break;
        case (MR_Integer) 1:
          {
            ...
            MR_String Var_100;
            MR_String Var_101;
            MR_Word PredProcId_114 = ((MR_Word) ((MR_hl_field(3, ConsId_7, (MR_Integer) 1))));
            MR_Integer PredId_115 = ((MR_Integer) ((MR_hl_field(0, PredProcId_114, (MR_Integer) 0))));
            MR_Integer ProcId_116 = ((MR_Integer) ((MR_hl_field(0, PredProcId_114, (MR_Integer) 1))));

            Var_97 = mercury__string__int_to_string_1_f_0(PredId_115);
            Var_101 = mercury__string__int_to_string_1_f_0(ProcId_116);
            ...
            String_8 = mercury__string__f_43_43_2_f_0((MR_String) "<deep_profiling_proc_layout ", Var_96);
          }
          break;
        case (MR_Integer) 2:
          {
            MR_Word SymName_9 = ((MR_Word) ((MR_hl_field(3, ConsId_7, (MR_Integer) 1))));
            MR_Integer Arity_10 = ((MR_Integer) ((MR_hl_field(3, ConsId_7, (MR_Integer) 2))));
              ...
              case (MR_Integer) 0:
                {
                  ...
                  Var_48 = mercury__string__f_43_43_2_f_0((MR_String) "/", ArityString_20);
                  String_8 = mercury__string__f_43_43_2_f_0(SymNameString_13, Var_48);
                }
                break;
              case (MR_Integer) 1:
                {
                  ...
                  Var_52 = mercury__string__f_43_43_2_f_0((MR_String) "\'/", ArityString_20);
                  Var_51 = mercury__string__f_43_43_2_f_0(SymNameString_13, Var_52);
                  String_8 = mercury__string__f_43_43_2_f_0((MR_String) "\140", Var_51);
                }
                break;
            }
          }
        ...
        case (MR_Integer) 3:
          {
            MR_String Var_55;
            MR_Integer Arity_106 = ((MR_Integer) ((MR_hl_field(3, ConsId_7, (MR_Integer) 1))));

            Var_55 = mercury__string__int_to_string_1_f_0(Arity_106);
            String_8 = mercury__string__f_43_43_2_f_0((MR_String) "{}/", Var_55);
          }
          break;
        case (MR_Integer) 4:
          {
            MR_Word PredProcId_27 = ((MR_Word) ((MR_hl_field(3, ConsId_7, (MR_Integer) 1))));
            MR_Integer PredId_29 = ((MR_Integer) ((MR_hl_field(0, PredProcId_27, (MR_Integer) 0))));
            MR_Integer ProcId_30 = ((MR_Integer) ((MR_hl_field(0, PredProcId_27, (MR_Integer) 1))));
            MR_String Var_61;
            MR_String Var_62;
            MR_String Var_63;
            MR_String Var_65;
            ...
            Var_62 = mercury__string__int_to_string_1_f_0(PredId_29);
            Var_66 = mercury__string__int_to_string_1_f_0(ProcId_30);
            Var_65 = mercury__string__f_43_43_2_f_0(Var_66, (MR_String) ">");
            Var_63 = mercury__string__f_43_43_2_f_0((MR_String) " proc ", Var_65);
            Var_61 = mercury__string__f_43_43_2_f_0(Var_62, Var_63);
            String_8 = mercury__string__f_43_43_2_f_0((MR_String) "closure_cons<pred ", Var_61);
          }
          break;
        case (MR_Integer) 5:
          {
            MR_Word IntConst_21 = ((MR_Word) ((MR_hl_field(3, ConsId_7, (MR_Integer) 1))));
        ...
        case (MR_Integer) 6:
          {
            MR_Float Float_23 = MR_unbox_float((MR_hl_field(3, ConsId_7, (MR_Integer) 1)));
        ...
        case (MR_Integer) 7:
          {
            MR_Char CharConst_24 = ((MR_Char) (MR_Word) (MR_hl_field(3, ConsId_7, (MR_Integer) 1)));
        ...
        case (MR_Integer) 8:
          {
            MR_String StringConst_25 = ((MR_String) ((MR_hl_field(3, ConsId_7, (MR_Integer) 1))));
        ...
        case (MR_Integer) 9:
          {
            MR_Word IDCKind_26 = ((MR_Unsigned) ((MR_hl_field(3, ConsId_7, (MR_Integer) 1))) & (MR_Integer) 7);
              ...
              case (MR_Integer) 1:
                {
                  ...
                  Var_58 = parse_tree__prog_data__impl_defined_const_kind_to_str_1_f_0(IDCKind_26);
                  Var_57 = mercury__string__f_43_43_2_f_0(Var_58, (MR_String) "\'");
                  String_8 = mercury__string__f_43_43_2_f_0((MR_String) "\140", Var_57);
                }
                break;
            }
          }
        ...
        case (MR_Integer) 10:
          {
            MR_Word Module_31 = ((MR_Word) ((MR_hl_field(3, ConsId_7, (MR_Integer) 1))));
            MR_String Ctor_32 = ((MR_String) ((MR_hl_field(3, ConsId_7, (MR_Integer) 2))));
            MR_String Var_69;
            MR_String Var_70;
            MR_String Var_71;
            MR_String Var_73;
            ...
            MR_String Var_76;
            MR_String Var_77;
            MR_Integer Arity_107 = ((MR_Integer) ((MR_hl_field(3, ConsId_7, (MR_Integer) 3))));

            Var_70 = mdbcomp__sym_name__sym_name_to_string_1_f_0(Module_31);
            Var_77 = mercury__string__int_to_string_1_f_0(Arity_107);
            Var_76 = mercury__string__f_43_43_2_f_0(Var_77, (MR_String) ">");
            Var_74 = mercury__string__f_43_43_2_f_0((MR_String) "/", Var_76);
            Var_73 = mercury__string__f_43_43_2_f_0(Ctor_32, Var_74);
            Var_71 = mercury__string__f_43_43_2_f_0((MR_String) ".", Var_73);
            Var_69 = mercury__string__f_43_43_2_f_0(Var_70, Var_71);
            String_8 = mercury__string__f_43_43_2_f_0((MR_String) "<type_ctor_info ", Var_69);
          }
          break;
        case (MR_Integer) 11:
  ...
  MR_String * Suffix_6)
{
  switch (MR_tag((MR_Word) IntConst_4)) {
    ...
    case (MR_Integer) 1:
      {
        MR_Unsigned UInt_8 = ((MR_Unsigned) ((MR_hl_field(1, IntConst_4, (MR_Integer) 0))));
    ...
    case (MR_Integer) 2:
      {
        int8_t Int8_9 = ((int8_t) (MR_Word) (MR_hl_field(2, IntConst_4, (MR_Integer) 0)));
    ...
    case (MR_Integer) 3:
      switch (((MR_Integer) ((MR_hl_field(3, IntConst_4, (MR_Integer) 0))))) {
        ...
        case (MR_Integer) 0:
          {
            uint8_t UInt8_10 = ((uint8_t) (MR_Word) (MR_hl_field(3, IntConst_4, (MR_Integer) 1)));
        ...
        case (MR_Integer) 1:
          {
            int16_t Int16_11 = ((int16_t) (MR_Word) (MR_hl_field(3, IntConst_4, (MR_Integer) 1)));
        ...
        case (MR_Integer) 2:
          {
            uint16_t UInt16_12 = ((uint16_t) (MR_Word) (MR_hl_field(3, IntConst_4, (MR_Integer) 1)));
        ...
        case (MR_Integer) 3:
          {
            int32_t Int32_13 = ((int32_t) (MR_Word) (MR_hl_field(3, IntConst_4, (MR_Integer) 1)));
        ...
        case (MR_Integer) 5:
          {
            int64_t Int64_15 = MR_unbox_int64((MR_hl_field(3, IntConst_4, (MR_Integer) 1)));
  ...
  MR_Word HeadVar__2_2)
{
  ...
  parse_tree__prog_out__write_sym_name_4_p_0(Stream_5, Name_12);
  ...
  MR_Word HeadVar__1_1)
{
  ...
  mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&parse_tree__prog_out_scalar_common_4[1]), Arity_7, &Var_15);
...
MR_String MR_CALL 
parse_tree__prog_out__pf_sym_name_user_arity_to_unquoted_string_2_f_0(
  ...
  MR_Word SNA_5)
{
  ...
  Str_6 = parse_tree__prog_out__pf_sym_name_user_arity_to_unquoted_string_3_f_0(PredOrFunc_4, SymName_7, Arity_8);
  return Str_6;
}

MR_String MR_CALL 
parse_tree__prog_out__pf_sym_name_user_arity_to_unquoted_string_1_f_0(
  MR_Word PFSymNameArity_3)
{
  ...
  Str_4 = parse_tree__prog_out__pf_sym_name_user_arity_to_unquoted_string_3_f_0(PredOrFunc_5, SymName_6, Arity_7);
  return Str_4;
}

MR_String MR_CALL 
parse_tree__prog_out__pf_sym_name_user_arity_to_unquoted_string_3_f_0(
  ...
  MR_Integer Arity_7)
{
  ...
  mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&parse_tree__prog_out_scalar_common_4[1]), Arity_7, &Var_19);
...
MR_String MR_CALL 
parse_tree__prog_out__pf_sym_name_pred_form_arity_to_string_2_f_0(
  MR_Word PredOrFunc_4,
  MR_Word SNA_5)
{
  MR_String Str_6;
  ...
  Str_6 = parse_tree__prog_out__pf_sym_name_pred_form_arity_to_string_3_f_0(PredOrFunc_4, SymName_7, PredFormArity_9);
  return Str_6;
}

MR_String MR_CALL 
parse_tree__prog_out__pf_sym_name_pred_form_arity_to_string_1_f_0(
  MR_Word PFSymNameArity_3)
{
  MR_String Str_4;
  MR_Word PredOrFunc_5 = ((MR_Unsigned) ((MR_hl_field(0, PFSymNameArity_3, (MR_Integer) 0))) & (MR_Integer) 1);
  ...
  Str_4 = parse_tree__prog_out__pf_sym_name_pred_form_arity_to_string_3_f_0(PredOrFunc_5, SymName_6, Arity_7);
  return Str_4;
}

MR_String MR_CALL 
parse_tree__prog_out__pf_sym_name_pred_form_arity_to_string_3_f_0(
  MR_Word PredOrFunc_5,
  MR_Word SymName_6,
  ...
  MR_Word SNA_4)
{
  ...
  Name_10 = ((MR_Word) ((MR_hl_field(0, SNA_4, (MR_Integer) 0))));
  Arity_11 = ((MR_Integer) ((MR_hl_field(0, SNA_4, (MR_Integer) 1))));
  parse_tree__prog_out__write_sym_name_4_p_0(Stream_6, Name_10);
  ...
  MR_Word HeadVar__1_1)
{
  ...
  mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&parse_tree__prog_out_scalar_common_4[1]), Arity_4, &Var_13);
...
{
  MR_Word Stream_6;
  MR_String ContextMessage_10;

  mercury__io__output_stream_3_p_0(&Stream_6);
  parse_tree__prog_out__context_to_string_2_p_0(Context_4, &ContextMessage_10);
  mercury__io__write_string_4_p_0(Stream_6, ContextMessage_10);
}
...
void MR_CALL 
parse_tree__prog_out__write_indent_4_p_0(
  MR_Word Stream_5,
  MR_Integer Indent_6)
{
  MR_String Str_8;

  Str_8 = parse_tree__prog_out__indent_string_1_f_0(Indent_6);
  mercury__io__write_string_4_p_0(Stream_5, Str_8);
}

MR_String MR_CALL 
parse_tree__prog_out__indent_string_1_f_0(
  MR_Integer Indent_3)
{
  MR_bool succeeded;
  MR_String Str_4;
  ...
  {
    Str0_5 = ((&parse_tree__prog_out_vector_common_5[0 + Indent_3]))->parse_tree__prog_out__vector_common_type_5_0__vct_5_f_0;
    succeeded = MR_TRUE;
  }
  else
    succeeded = MR_FALSE;
  ...
  else
  {
    ...
    Var_7 = parse_tree__prog_out__indent_string_1_f_0(Var_8);
...
MR_Integer MR_CALL 
parse_tree__prog_out__indent_increment_0_f_0(void)
{
  return (MR_Integer) 2;
}
