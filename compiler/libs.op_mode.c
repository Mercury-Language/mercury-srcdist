...
{
  {
...

    {
      ...
      mercury__map__lookup_3_p_0(TypeCtorInfo_66_66, (MR_Word) &mercury__getopt_io__getopt_io__type_ctor_info_option_data_0, OptionTable_4, ((MR_Box) ((MR_Integer) 105)), &conv2_GenStandaloneOption_8);
