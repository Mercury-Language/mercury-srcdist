...
static const MR_EnumFunctorDescPtr libs__op_mode__libs__op_mode__enum_ordinal_ordered_op_mode_query_0[14];
...
{
  {
...

    {
      ...
      mercury__map__lookup_3_p_0((MR_Word) (&libs__options__libs__options__type_ctor_info_option_0), (MR_Word) (&mercury__getopt__getopt__type_ctor_info_option_data_0), OptionTable_4, ((MR_Box) ((MR_Integer) 116)), &conv2_GenStandaloneOption_8);
