...
struct libs__op_mode__decide_op_mode_3_p_0_env_0_s {
  ...
  MR_Word libs__op_mode__decide_op_mode_3_p_0_env_0__TypeCtorInfo_49_49;
      ...
      case (MR_Integer) 3:
        {
          ...
          switch (MR_tag((MR_Word) OpModeArgs_63)) {
            ...
            case (MR_Integer) 1:
              {
                MR_Word OpModeAugment_64 = ((MR_Word) (MR_hl_field(MR_mktag(1), OpModeArgs_63, (MR_Integer) 0)));

                if ((((((((OpModeAugment_64 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 2))))) || ((OpModeAugment_64 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))))))) || ((OpModeAugment_64 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 1))))))) || ((OpModeAugment_64 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 3)))))))
                  (env_ptr)->libs__op_mode__decide_op_mode_3_p_0_env_0__succeeded = MR_TRUE;
                else
...
{
  {
    ...
    if (MR_builtin_setjmp((env_ptr)->libs__op_mode__decide_op_mode_3_p_0_env_0__commit_0) == 0)
      {
        mercury__set__member_2_p_1((env_ptr)->libs__op_mode__decide_op_mode_3_p_0_env_0__TypeCtorInfo_49_49, &(env_ptr)->libs__op_mode__decide_op_mode_3_p_0_env_0__conv3_TogetherOpMode_48, (env_ptr)->libs__op_mode__decide_op_mode_3_p_0_env_0__STATE_VARIABLE_OpModeSet_39_39, libs__op_mode__decide_op_mode_3_p_0_4, env_ptr);
        (env_ptr)->libs__op_mode__decide_op_mode_3_p_0_env_0__succeeded = MR_FALSE;
      }
    else
      (env_ptr)->libs__op_mode__decide_op_mode_3_p_0_env_0__succeeded = MR_TRUE;
...
{
  {
...

    {
      ...
      (env).libs__op_mode__decide_op_mode_3_p_0_env_0__TypeCtorInfo_49_49 = (MR_Word) &libs__op_mode__libs__op_mode__type_ctor_info_op_mode_0;
      mercury__set__init_1_p_0((env).libs__op_mode__decide_op_mode_3_p_0_env_0__TypeCtorInfo_49_49, &STATE_VARIABLE_OpModeSet_20_20);
      {
      ...
      TypeCtorInfo_55_55 = (MR_Word) &libs__options__libs__options__type_ctor_info_option_0;
      mercury__map__lookup_3_p_0(TypeCtorInfo_55_55, (MR_Word) &mercury__getopt_io__getopt_io__type_ctor_info_option_data_0, OptionTable_4, ((MR_Box) ((MR_Integer) 107)), &conv2_GenStandaloneOption_8);
      ...
      if ((env).libs__op_mode__decide_op_mode_3_p_0_env_0__succeeded)
      {
        ...
        else
        {
          ...
          mercury__set__insert_3_p_0((env).libs__op_mode__decide_op_mode_3_p_0_env_0__TypeCtorInfo_49_49, ((MR_Box) (Var_25)), STATE_VARIABLE_OpModeSet_23_23, &STATE_VARIABLE_OpModeSet_26_26);
        }
      }
      else
      {
      ...
      mercury__getopt_io__lookup_bool_option_3_p_0(TypeCtorInfo_55_55, OptionTable_4, ((MR_Box) ((MR_Integer) 633)), &InvokedByMMCMake_11);
      switch (InvokedByMMCMake_11) {
        ...
        case (MR_Integer) 1:
          {
            mercury__set__delete_3_p_0((env).libs__op_mode__decide_op_mode_3_p_0_env_0__TypeCtorInfo_49_49, ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))), STATE_VARIABLE_OpModeSet_26_26, &STATE_VARIABLE_OpModeSet_31_31);
          }
          break;
      }
      mercury__set__to_sorted_list_2_p_0((env).libs__op_mode__decide_op_mode_3_p_0_env_0__TypeCtorInfo_49_49, STATE_VARIABLE_OpModeSet_31_31, &OpModes0_12);
      ...
      else
      {
        ...
        {
          (env).libs__op_mode__decide_op_mode_3_p_0_env_0__succeeded = mercury__set__member_2_p_0((env).libs__op_mode__decide_op_mode_3_p_0_env_0__TypeCtorInfo_49_49, ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))), STATE_VARIABLE_OpModeSet_31_31);
          if ((env).libs__op_mode__decide_op_mode_3_p_0_env_0__succeeded)
          {
          ...
          else
          {
            ...
            mercury__set__delete_3_p_0((env).libs__op_mode__decide_op_mode_3_p_0_env_0__TypeCtorInfo_49_49, ((MR_Box) (MR_mkword(MR_mktag(3), &libs__op_mode_scalar_common_3[9]))), STATE_VARIABLE_OpModeSet_31_31, &STATE_VARIABLE_OpModeSet_35_35);
            mercury__set__delete_3_p_0((env).libs__op_mode__decide_op_mode_3_p_0_env_0__TypeCtorInfo_49_49, ((MR_Box) (MR_mkword(MR_mktag(3), &libs__op_mode_scalar_common_3[7]))), STATE_VARIABLE_OpModeSet_35_35, &(env).libs__op_mode__decide_op_mode_3_p_0_env_0__STATE_VARIABLE_OpModeSet_39_39);
            libs__op_mode__decide_op_mode_3_p_0_5(&env);
            if ((env).libs__op_mode__decide_op_mode_3_p_0_env_0__succeeded)
            {
              mercury__set__to_sorted_list_2_p_0((env).libs__op_mode__decide_op_mode_3_p_0_env_0__TypeCtorInfo_49_49, (env).libs__op_mode__decide_op_mode_3_p_0_env_0__STATE_VARIABLE_OpModeSet_39_39, &FilteredOpModes_17);
