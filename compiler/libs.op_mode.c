...
{
  {
    ...
    if (succeeded)
    {
      packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), OptionValue_9, (MR_Integer) 0)));
          ...
          case (MR_Integer) 0:
            {
              ...
              if (succeeded)
              {
                packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), RebuildOption_7, (MR_Integer) 0)));
      ...
      case (MR_Integer) 2:
        {
          ...
          MR_Unsigned packed_word_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), MOP_5, (MR_Integer) 0)));
                  ...
                  case (MR_Integer) 1:
                    {
                      ...
                      MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), MOPAU_12, (MR_Integer) 0)));
