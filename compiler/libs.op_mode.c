...
{
  {
...

    {
      ...
      {
        mercury__getopt_io__lookup_bool_option_3_p_0(libs__op_mode__TypeCtorInfo_79_79, libs__op_mode__OptionTable_4, ((MR_Box) ((MR_Integer) 615)), &libs__op_mode__InvokedByMMCMake_11);
      }
