...
{
  {
...

    {
      ...
      (env).libs__op_mode__decide_op_mode_3_p_0_env_0__succeeded = ((((MR_tag((MR_Word) GenStandaloneOption_8)) == (MR_Integer) 3)) && ((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), GenStandaloneOption_8, (MR_Integer) 0))) == (MR_Integer) 2)));
        ...
        else
        {
          ...
          else
          {
            ...
            if ((env).libs__op_mode__decide_op_mode_3_p_0_env_0__succeeded)
            {
              ...
              (env).libs__op_mode__decide_op_mode_3_p_0_env_0__succeeded = ((MR_tag((MR_Word) FilteredOpModes_17)) == (MR_Integer) 1);
              if ((env).libs__op_mode__decide_op_mode_3_p_0_env_0__succeeded)
              {
