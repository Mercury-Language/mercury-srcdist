    ...
    else
    {
      ...
      else
      {
        ...
        else
        {
          ...
          mercury__set__delete_3_p_0((MR_Word) (&libs__op_mode__libs__op_mode__type_ctor_info_op_mode_0), ((MR_Box) (MR_mkword(MR_mktag(3), &libs__op_mode_scalar_common_3[4]))), STATE_VARIABLE_OpModeSet_31_31, &STATE_VARIABLE_OpModeSet_35_35);
          mercury__set__delete_3_p_0((MR_Word) (&libs__op_mode__libs__op_mode__type_ctor_info_op_mode_0), ((MR_Box) (MR_mkword(MR_mktag(3), &libs__op_mode_scalar_common_3[6]))), STATE_VARIABLE_OpModeSet_35_35, &(env).libs__op_mode__decide_op_mode_3_p_0_env_0__STATE_VARIABLE_OpModeSet_39_39);
