...
static const MR_EnumFunctorDescPtr libs__op_mode__libs__op_mode__enum_ordinal_ordered_op_mode_query_0[15];

static const MR_EnumFunctorDescPtr libs__op_mode__libs__op_mode__enum_name_ordered_op_mode_query_0[15];

static const MR_Integer libs__op_mode__libs__op_mode__functor_number_map_op_mode_query_0[15];
...
static /* final */ const MR_Box libs__op_mode_scalar_common_2[65][2];

static /* final */ const MR_Box libs__op_mode_scalar_common_3[39][1];
...
static /* final */ const struct libs__op_mode__vector_common_type_5_0_s libs__op_mode_vector_common_5[15];
...
static /* final */ const struct libs__op_mode__vector_common_type_5_0_s libs__op_mode_vector_common_5[15] = {
  ...
  /* row 13 */   {     (MR_String) "--output-stdlib-modules" },
  /* row 14 */   {     (MR_String) "--output-target-arch" },
};
          ...
          case (MR_Integer) 0:
            {
              ...
              mercury__map__lookup_3_p_0((MR_Word) (&libs__options__libs__options__type_ctor_info_option_0), (MR_Word) (&mercury__getopt__getopt__type_ctor_info_option_data_0), OptionTable_4, ((MR_Box) ((MR_Integer) 665)), &conv0_RebuildOption_7);
...
{
  {
...

    {
      ...
      mercury__map__lookup_3_p_0((MR_Word) (&libs__options__libs__options__type_ctor_info_option_0), (MR_Word) (&mercury__getopt__getopt__type_ctor_info_option_data_0), OptionTable_4, ((MR_Box) ((MR_Integer) 120)), &conv2_GenStandaloneOption_8);
      ...
      mercury__getopt__lookup_bool_option_3_p_0((MR_Word) (&libs__options__libs__options__type_ctor_info_option_0), OptionTable_4, ((MR_Box) ((MR_Integer) 669)), &InvokedByMMCMake_11);
...
libs__op_mode__bool_op_modes_0_f_0(void)
{
  return (MR_Word) (MR_mkword(MR_mktag(1), &libs__op_mode_scalar_common_2[64]));
}
