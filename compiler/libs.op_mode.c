...
{
  {
...

    {
      ...
      {
        mercury__map__lookup_3_p_0(libs__op_mode__TypeCtorInfo_67_67, (MR_Word) &mercury__getopt_io__getopt_io__type_ctor_info_option_data_0, libs__op_mode__OptionTable_4, ((MR_Box) ((MR_Integer) 96)), &libs__op_mode__conv2_GenStandaloneOption_8);
      }
      ...
      {
        mercury__getopt_io__lookup_bool_option_3_p_0(libs__op_mode__TypeCtorInfo_67_67, libs__op_mode__OptionTable_4, ((MR_Box) ((MR_Integer) 616)), &libs__op_mode__InvokedByMMCMake_11);
      }
