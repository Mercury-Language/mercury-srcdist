              ...
              case (MR_Integer) 2:
                {
                  ...
                  mercury__private_builtin__builtin_compare_int_3_p_0(HeadVar__1_1, Var_42, Var_43);
                }
                break;
              case (MR_Integer) 3:
                *HeadVar__1_1 = (MR_Integer) 1;
              ...
              case (MR_Integer) 1:
                {
                  ...
                  libs__op_mode____Compare____op_mode_augment_0_0(HeadVar__1_1, Var_21, ArgY1_17);
                }
                break;
            }
          }
        ...
        case (MR_Integer) 1:
          {
            ...
            if (succeeded)
            {
              ...
              succeeded = libs__op_mode____Unify____op_mode_augment_0_0(ArgX1_15, ArgY1_16);
            }
          }
          break;
      }
...
{
  {
    ...
    succeeded = ((MR_tag((MR_Word) OptionValue_9)) == (MR_mktag((MR_Integer) 1)));
    if (succeeded)
    {
      BoolValue_10 = ((MR_Word) (MR_hl_field(MR_mktag(1), OptionValue_9, (MR_Integer) 0)));
      switch (BoolValue_10) {
        default: /*NOTREACHED*/ MR_assert(0);
        case (MR_Integer) 0:
...
{
  {
    ...
    switch (MR_tag((MR_Word) MOP_5)) {
          ...
          case (MR_Integer) 0:
            {
              ...
              mercury__map__lookup_3_p_0((MR_Word) &libs__options__libs__options__type_ctor_info_option_0, (MR_Word) &mercury__getopt_io__getopt_io__type_ctor_info_option_data_0, OptionTable_4, ((MR_Box) ((MR_Integer) 629)), &conv0_RebuildOption_7);
              RebuildOption_7 = ((MR_Word) conv0_RebuildOption_7);
              succeeded = ((MR_tag((MR_Word) RebuildOption_7)) == (MR_mktag((MR_Integer) 1)));
              if (succeeded)
              {
                Rebuild_8 = ((MR_Word) (MR_hl_field(MR_mktag(1), RebuildOption_7, (MR_Integer) 0)));
                switch (Rebuild_8) {
                  default: /*NOTREACHED*/ MR_assert(0);
                  case (MR_Integer) 0:
      ...
      case (MR_Integer) 2:
        {
          MR_Word MOPQ_10 = ((MR_Word) (MR_hl_field(MR_mktag(2), MOP_5, (MR_Integer) 0)));
      ...
      case (MR_Integer) 3:
        {
          ...
          switch (MR_tag((MR_Word) MOPA_11)) {
            ...
            case (MR_Integer) 1:
              {
                MR_Word MOPAU_12 = ((MR_Word) (MR_hl_field(MR_mktag(1), MOPA_11, (MR_Integer) 0)));

                switch (MR_tag((MR_Word) MOPAU_12)) {
                  default: /*NOTREACHED*/ MR_assert(0);
                  case (MR_Integer) 0:
                    switch (MR_unmkbody(MOPAU_12)) {
                      default: /*NOTREACHED*/ MR_assert(0);
                      case (MR_Integer) 0:
                  ...
                  case (MR_Integer) 1:
                    {
                      MR_Word MOPCG_13 = ((MR_Word) (MR_hl_field(MR_mktag(1), MOPAU_12, (MR_Integer) 0)));
...
{
  {
    ...
    (env_ptr)->libs__op_mode__decide_op_mode_3_p_0_env_0__TogetherOpMode_52 = ((MR_Word) (env_ptr)->libs__op_mode__decide_op_mode_3_p_0_env_0__conv3_TogetherOpMode_52);
...
{
  {
    ...
    switch (MR_tag((MR_Word) (env_ptr)->libs__op_mode__decide_op_mode_3_p_0_env_0__TogetherOpMode_52)) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
      ...
      case (MR_Integer) 3:
        {
          MR_Word OpModeArgs_74 = ((MR_Word) (MR_hl_field(MR_mktag(3), (env_ptr)->libs__op_mode__decide_op_mode_3_p_0_env_0__TogetherOpMode_52, (MR_Integer) 0)));

          switch (MR_tag((MR_Word) OpModeArgs_74)) {
            default: /*NOTREACHED*/ MR_assert(0);
            case (MR_Integer) 0:
              (env_ptr)->libs__op_mode__decide_op_mode_3_p_0_env_0__succeeded = MR_TRUE;
              break;
            case (MR_Integer) 1:
              {
                MR_Word OpModeAugment_75 = ((MR_Word) (MR_hl_field(MR_mktag(1), OpModeArgs_74, (MR_Integer) 0)));

                if ((((((((OpModeAugment_75 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 2))))) || ((OpModeAugment_75 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))))))) || ((OpModeAugment_75 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 1))))))) || ((OpModeAugment_75 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 3)))))))
                  (env_ptr)->libs__op_mode__decide_op_mode_3_p_0_env_0__succeeded = MR_TRUE;
                else
...
{
  {
    ...
    if (MR_builtin_setjmp((env_ptr)->libs__op_mode__decide_op_mode_3_p_0_env_0__commit_0) == 0)
      {
        mercury__set__member_2_p_1((env_ptr)->libs__op_mode__decide_op_mode_3_p_0_env_0__TypeCtorInfo_60_60, &(env_ptr)->libs__op_mode__decide_op_mode_3_p_0_env_0__conv3_TogetherOpMode_52, (env_ptr)->libs__op_mode__decide_op_mode_3_p_0_env_0__STATE_VARIABLE_OpModeSet_39_39, libs__op_mode__decide_op_mode_3_p_0_4, env_ptr);
        (env_ptr)->libs__op_mode__decide_op_mode_3_p_0_env_0__succeeded = MR_FALSE;
      }
    else
      (env_ptr)->libs__op_mode__decide_op_mode_3_p_0_env_0__succeeded = MR_TRUE;
...
{
  {
...

    {
      ...
      (env).libs__op_mode__decide_op_mode_3_p_0_env_0__TypeCtorInfo_60_60 = (MR_Word) &libs__op_mode__libs__op_mode__type_ctor_info_op_mode_0;
      mercury__set__init_1_p_0((env).libs__op_mode__decide_op_mode_3_p_0_env_0__TypeCtorInfo_60_60, &STATE_VARIABLE_OpModeSet_20_20);
      {
      ...
      TypeCtorInfo_66_66 = (MR_Word) &libs__options__libs__options__type_ctor_info_option_0;
      mercury__map__lookup_3_p_0(TypeCtorInfo_66_66, (MR_Word) &mercury__getopt_io__getopt_io__type_ctor_info_option_data_0, OptionTable_4, ((MR_Box) ((MR_Integer) 107)), &conv2_GenStandaloneOption_8);
      GenStandaloneOption_8 = ((MR_Word) conv2_GenStandaloneOption_8);
      (env).libs__op_mode__decide_op_mode_3_p_0_env_0__succeeded = ((((MR_tag((MR_Word) GenStandaloneOption_8)) == (MR_mktag((MR_Integer) 3)))) && (((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), GenStandaloneOption_8, (MR_Integer) 0)))) == (MR_Integer) 2)));
      if ((env).libs__op_mode__decide_op_mode_3_p_0_env_0__succeeded)
      {
        ...
        if ((MaybeBaseName_9 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
        ...
        else
        {
          ...
          mercury__set__insert_3_p_0((env).libs__op_mode__decide_op_mode_3_p_0_env_0__TypeCtorInfo_60_60, ((MR_Box) (Var_25)), STATE_VARIABLE_OpModeSet_23_23, &STATE_VARIABLE_OpModeSet_26_26);
        }
      }
      else
      {
      ...
      mercury__getopt_io__lookup_bool_option_3_p_0(TypeCtorInfo_66_66, OptionTable_4, ((MR_Box) ((MR_Integer) 633)), &InvokedByMMCMake_11);
      switch (InvokedByMMCMake_11) {
        ...
        case (MR_Integer) 1:
          {
            mercury__set__delete_3_p_0((env).libs__op_mode__decide_op_mode_3_p_0_env_0__TypeCtorInfo_60_60, ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))), STATE_VARIABLE_OpModeSet_26_26, &STATE_VARIABLE_OpModeSet_31_31);
          }
          break;
      }
      mercury__set__to_sorted_list_2_p_0((env).libs__op_mode__decide_op_mode_3_p_0_env_0__TypeCtorInfo_60_60, STATE_VARIABLE_OpModeSet_31_31, &OpModes0_12);
      if ((OpModes0_12 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
      {
        *OpMode_5 = (MR_Word) MR_mkword(MR_mktag(3), &libs__op_mode_scalar_common_3[40]);
        *OtherOpModes_6 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
      }
      else
      {
        MR_Word Var_68 = ((MR_Word) (MR_hl_field(MR_mktag(1), OpModes0_12, (MR_Integer) 1)));
        MR_Word Var_69 = ((MR_Word) (MR_hl_field(MR_mktag(1), OpModes0_12, (MR_Integer) 0)));
        ...
        {
          (env).libs__op_mode__decide_op_mode_3_p_0_env_0__succeeded = mercury__set__member_2_p_0((env).libs__op_mode__decide_op_mode_3_p_0_env_0__TypeCtorInfo_60_60, ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))), STATE_VARIABLE_OpModeSet_31_31);
          if ((env).libs__op_mode__decide_op_mode_3_p_0_env_0__succeeded)
          {
            *OpMode_5 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
            *OtherOpModes_6 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
          }
          else
          {
            ...
            mercury__set__delete_3_p_0((env).libs__op_mode__decide_op_mode_3_p_0_env_0__TypeCtorInfo_60_60, ((MR_Box) (MR_mkword(MR_mktag(3), &libs__op_mode_scalar_common_3[9]))), STATE_VARIABLE_OpModeSet_31_31, &STATE_VARIABLE_OpModeSet_35_35);
            mercury__set__delete_3_p_0((env).libs__op_mode__decide_op_mode_3_p_0_env_0__TypeCtorInfo_60_60, ((MR_Box) (MR_mkword(MR_mktag(3), &libs__op_mode_scalar_common_3[7]))), STATE_VARIABLE_OpModeSet_35_35, &(env).libs__op_mode__decide_op_mode_3_p_0_env_0__STATE_VARIABLE_OpModeSet_39_39);
            libs__op_mode__decide_op_mode_3_p_0_5(&env);
            if ((env).libs__op_mode__decide_op_mode_3_p_0_env_0__succeeded)
            {
              mercury__set__to_sorted_list_2_p_0((env).libs__op_mode__decide_op_mode_3_p_0_env_0__TypeCtorInfo_60_60, (env).libs__op_mode__decide_op_mode_3_p_0_env_0__STATE_VARIABLE_OpModeSet_39_39, &FilteredOpModes_17);
              (env).libs__op_mode__decide_op_mode_3_p_0_env_0__succeeded = ((MR_tag((MR_Word) FilteredOpModes_17)) == (MR_mktag((MR_Integer) 1)));
              if ((env).libs__op_mode__decide_op_mode_3_p_0_env_0__succeeded)
              {
