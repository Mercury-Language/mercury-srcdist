          ...
          case (MR_Integer) 0:
            {
              ...
              {
                mercury__map__lookup_3_p_0((MR_Word) &libs__options__libs__options__type_ctor_info_option_0, (MR_Word) &mercury__getopt_io__getopt_io__type_ctor_info_option_data_0, libs__op_mode__OptionTable_4, ((MR_Box) ((MR_Integer) 618)), &libs__op_mode__conv0_RebuildOption_7);
              }
...
{
  {
...

    {
      ...
      {
        mercury__map__lookup_3_p_0(libs__op_mode__TypeCtorInfo_66_66, (MR_Word) &mercury__getopt_io__getopt_io__type_ctor_info_option_data_0, libs__op_mode__OptionTable_4, ((MR_Box) ((MR_Integer) 101)), &libs__op_mode__conv2_GenStandaloneOption_8);
      }
      ...
      if ((libs__op_mode__env).libs__op_mode__decide_op_mode_3_p_0_env_0__succeeded)
        {
          ...
          if ((libs__op_mode__MaybeBaseName_9 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
          ...
          else
            {
              ...
              {
                mercury__set__insert_3_p_0((libs__op_mode__env).libs__op_mode__decide_op_mode_3_p_0_env_0__TypeCtorInfo_60_60, ((MR_Box) (libs__op_mode__V_25_25)), libs__op_mode__STATE_VARIABLE_OpModeSet_23_23, &libs__op_mode__STATE_VARIABLE_OpModeSet_26_26);
              }
            }
        }
      else
      ...
      {
        mercury__getopt_io__lookup_bool_option_3_p_0(libs__op_mode__TypeCtorInfo_66_66, libs__op_mode__OptionTable_4, ((MR_Box) ((MR_Integer) 622)), &libs__op_mode__InvokedByMMCMake_11);
      }
      ...
      if ((libs__op_mode__OpModes0_12 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
        ...
        {
          MR_Word libs__op_mode__V_68_68 = ((MR_Word) (MR_hl_field(MR_mktag(1), libs__op_mode__OpModes0_12, (MR_Integer) 1)));
          MR_Word libs__op_mode__V_69_69 = ((MR_Word) (MR_hl_field(MR_mktag(1), libs__op_mode__OpModes0_12, (MR_Integer) 0)));

          if ((libs__op_mode__V_68_68 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
            {
              *libs__op_mode__OpMode_5 = libs__op_mode__V_69_69;
              *libs__op_mode__OtherOpModes_6 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
            }
          else
            {
