...
backend_libs__export__IntroducedFrom__pred__foreign_const_name_and_tag__1029__1_2_p_0(
  MR_Integer Arity_15,
...
backend_libs__export__foreign_const_name_and_tag_6_p_0(
  ...
  MR_Word Ctor_10,
  MR_Word STATE_VARIABLE_NamesAndTagsCord_0_62,
  MR_Word * STATE_VARIABLE_NamesAndTagsCord_63);
...
{
  {
    MR_bool succeeded = (Arity_15 == HeadVar__2_74);
...
{
  {
    ...
    succeeded = backend_libs__export__IntroducedFrom__pred__foreign_const_name_and_tag__1029__1_2_p_0(((MR_Integer) (MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3))), ((MR_Integer) (MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4))));
    return succeeded;
  }
}
...
{
  {
    ...
    MR_Word TagVal_18;
    MR_Word Tag_21;
    MR_Word UnqualifiedCtorName_60;
    MR_String ForeignName_61;
    MR_Word Var_70;
    MR_String Var_75;
    MR_Word Var_77;
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(0), Var_70, 0) = ((MR_Box) (&backend_libs__export_scalar_common_3[3]));
      MR_hl_field(MR_mktag(0), Var_70, 1) = ((MR_Box) (backend_libs__export__foreign_const_name_and_tag_6_p_0_1));
      MR_hl_field(MR_mktag(0), Var_70, 2) = ((MR_Box) (MR_Word) ((MR_Integer) 2));
      MR_hl_field(MR_mktag(0), Var_70, 3) = ((MR_Box) (Arity_15));
      MR_hl_field(MR_mktag(0), Var_70, 4) = ((MR_Box) ((MR_Integer) 0));
    }
    mercury__require__expect_4_p_0(Var_70, (MR_String) "backend_libs.export", (MR_String) "predicate \140backend_libs.export.foreign_const_name_and_tag\'/6", (MR_String) "enum constant arity != 0");
    Var_75 = mdbcomp__sym_name__unqualify_name_1_f_0(QualifiedCtorName_13);
    {
      UnqualifiedCtorName_60 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), UnqualifiedCtorName_60, 0) = ((MR_Box) (Var_75));
    }
    mercury__map__lookup_3_p_0((MR_Word) &mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0, (MR_Word) &mercury__builtin__builtin__type_ctor_info_string_0, Mapping_8, ((MR_Box) (UnqualifiedCtorName_60)), &conv1_ForeignName_61);
    ForeignName_61 = ((MR_String) conv1_ForeignName_61);
    {
      Var_77 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), Var_77, 0) = ((MR_Box) (ForeignName_61));
      MR_hl_field(MR_mktag(0), Var_77, 1) = ((MR_Box) (Tag_21));
    }
    *STATE_VARIABLE_NamesAndTagsCord_63 = mercury__cord__snoc_2_f_0((MR_Word) &backend_libs__export_scalar_common_1[1], STATE_VARIABLE_NamesAndTagsCord_0_62, ((MR_Box) (Var_77)));
  }
}
  ...
  MR_Box * wrapper_arg_3)
{
  {
    MR_Box closure = closure_arg;
    MR_Word conv0_STATE_VARIABLE_NamesAndTagsCord_63;

    backend_libs__export__foreign_const_name_and_tag_6_p_0(((MR_Word) (MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3))), ((MR_Word) (MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4))), ((MR_Word) (MR_hl_field(MR_mktag(0), closure, (MR_Integer) 5))), ((MR_Word) wrapper_arg_1), ((MR_Word) wrapper_arg_2), &conv0_STATE_VARIABLE_NamesAndTagsCord_63);
    *wrapper_arg_3 = ((MR_Box) (conv0_STATE_VARIABLE_NamesAndTagsCord_63));
  }
}
