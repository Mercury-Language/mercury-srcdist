      ...
      if (((MR_tag((MR_Word) HeadVar__3_3)) == (MR_Integer) 0))
      {
        ...
        if (succeeded)
          *HeadVar__1_1 = SubResult1_6;
          ...
          mercury__private_builtin__builtin_compare_int_3_p_0(HeadVar__1_1, Var_28, ArgY2_8);
      }
      else
...
{
  {
    ...
    else
    {
      ...
      else
      {
        ...
        MaybeSetLineNumbers_28 = backend_libs__c_util__lookup_line_numbers_2_f_0(Globals_10, (MR_Integer) 154);
