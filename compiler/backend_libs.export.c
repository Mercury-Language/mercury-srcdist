...
static MR_bool MR_CALL 
backend_libs__export__IntroducedFrom__pred__output_foreign_decl__786__1_2_p_0(
  MR_Word Lang_18,
...
{
  {
    ...
    succeeded = backend_libs__export__IntroducedFrom__pred__output_foreign_decl__786__1_2_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))));
    return succeeded;
  }
}
...
{
  {
    ...
    parse_tree__file_names__module_name_to_file_name_7_p_0(Globals_10, (MR_Integer) 0, (MR_Word) (((MR_Box) ((MR_String) ".mh"))), ModuleName_8, &FileName_12);
    {
    ...
    Var_40 = mercury__string__f_43_43_2_f_0(FileName_12, (MR_String) ".tmp");
    mercury__io__open_output_4_p_0(Var_40, &Result_14);
    if (((MR_tag((MR_Word) Result_14)) == (MR_Integer) 1))
    {
      ...
      Var_50 = mercury__string__f_43_43_2_f_0(FileName_12, (MR_String) ".tmp");
    ...
    else
    {
      ...
      parse_tree__file_names__module_name_to_file_name_7_p_0(Globals_10, (MR_Integer) 1, (MR_Word) (((MR_Box) ((MR_String) ".m"))), ModuleName_8, &SourceFileName_16);
      mercury__library__version_2_p_0(&Version_17, &Fullarch_18);
      {
        Var_78 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), Var_78, 0) = ((MR_Box) (Fullarch_18));
        MR_hl_field(MR_mktag(1), Var_78, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &backend_libs__export_scalar_common_2[3])));
      }
      {
        Var_76 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), Var_76, 0) = ((MR_Box) ((MR_String) "** configured for "));
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(1), Var_73, 0) = ((MR_Box) (Version_17));
        MR_hl_field(MR_mktag(1), Var_73, 1) = ((MR_Box) (Var_74));
      }
      {
        Var_71 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), Var_71, 0) = ((MR_Box) ((MR_String) "** version "));
        MR_hl_field(MR_mktag(1), Var_71, 1) = ((MR_Box) (Var_73));
      }
      {
        Var_69 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), Var_69, 0) = ((MR_Box) ((MR_String) "** by the Mercury compiler,\n"));
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(1), Var_66, 0) = ((MR_Box) (SourceFileName_16));
        MR_hl_field(MR_mktag(1), Var_66, 1) = ((MR_Box) (Var_67));
      }
      {
        Var_64 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), Var_64, 0) = ((MR_Box) ((MR_String) "** Automatically generated from \140"));
      ...
      mercury__io__write_strings_4_p_0(FileStream_15, Var_61);
      ...
      GuardMacroName_21 = mercury__string__f_43_43_2_f_0(UppercaseModuleName_20, (MR_String) "_MH");
      {
        ...
        MR_hl_field(MR_mktag(1), Var_95, 0) = ((MR_Box) (GuardMacroName_21));
        MR_hl_field(MR_mktag(1), Var_95, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &backend_libs__export_scalar_common_2[20])));
      }
      {
        Var_93 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), Var_93, 0) = ((MR_Box) ((MR_String) "#define "));
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(1), Var_90, 0) = ((MR_Box) (GuardMacroName_21));
        MR_hl_field(MR_mktag(1), Var_90, 1) = ((MR_Box) (Var_91));
      }
      {
        Var_87 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), Var_87, 0) = ((MR_Box) ((MR_String) "#ifndef "));
        MR_hl_field(MR_mktag(1), Var_87, 1) = ((MR_Box) (Var_90));
      }
      mercury__io__write_strings_4_p_0(FileStream_15, Var_87);
      ...
      else
      {
        ...
        MR_Word Var_149;
        MR_Word Var_151;
        MR_Box conv0_STATE_VARIABLE_IO_150_150;
        MR_Box conv2_STATE_VARIABLE_IO_152_152;

        MaybeSetLineNumbers_28 = backend_libs__c_util__lookup_line_numbers_2_f_0(Globals_10, (MR_Integer) 158);
        Var_139 = backend_libs__foreign__decl_guard_1_f_0(ModuleName_8);
        Var_145 = backend_libs__foreign__decl_guard_1_f_0(ModuleName_8);
        {
          ...
          MR_hl_field(MR_mktag(1), Var_144, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &backend_libs__export_scalar_common_2[4])));
        }
        {
          Var_142 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), Var_142, 0) = ((MR_Box) ((MR_String) "#define "));
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(1), Var_140, 0) = ((MR_Box) ((MR_String) "\n"));
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(1), Var_135, 0) = ((MR_Box) ((MR_String) "#ifndef "));
          MR_hl_field(MR_mktag(1), Var_135, 1) = ((MR_Box) (Var_138));
        }
        mercury__io__write_strings_4_p_0(FileStream_15, Var_135);
        {
          Var_149 = (MR_Word) MR_new_object(MR_Word, (6 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), Var_149, 0) = ((MR_Box) (&backend_libs__export_scalar_common_5[0]));
          MR_hl_field(MR_mktag(0), Var_149, 1) = ((MR_Box) (backend_libs__export__produce_header_file_5_p_0_3));
        ...
        mercury__list__foldl_4_p_2((MR_Word) (&hlds__hlds_module__hlds__hlds_module__type_ctor_info_exported_enum_info_0), (MR_Word) (&mercury__io__io__type_ctor_info_state_0), Var_149, CExportedEnums_23, ((MR_Box) ((MR_Integer) 0)), &conv0_STATE_VARIABLE_IO_150_150);
        {
          Var_151 = (MR_Word) MR_new_object(MR_Word, (8 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), Var_151, 0) = ((MR_Box) (&backend_libs__export_scalar_common_7[0]));
          MR_hl_field(MR_mktag(0), Var_151, 1) = ((MR_Box) (backend_libs__export__produce_header_file_5_p_0_4));
          MR_hl_field(MR_mktag(0), Var_151, 2) = ((MR_Box) ((MR_Integer) 5));
          MR_hl_field(MR_mktag(0), Var_151, 3) = ((MR_Box) (FileStream_15));
          MR_hl_field(MR_mktag(0), Var_151, 4) = ((MR_Box) (MaybeSetLineNumbers_28));
          MR_hl_field(MR_mktag(0), Var_151, 5) = ((MR_Box) (MaybeThisFileName_13));
          MR_hl_field(MR_mktag(0), Var_151, 6) = ((MR_Box) (SourceFileName_16));
          MR_hl_field(MR_mktag(0), Var_151, 7) = ((MR_Box) (MR_mkword(MR_mktag(1), &backend_libs__export_scalar_common_6[0])));
        }
        mercury__list__map_foldl_5_p_2((MR_Word) (&parse_tree__prog_foreign__parse_tree__prog_foreign__type_ctor_info_foreign_decl_code_0), (MR_Word) (&mercury__maybe__maybe__type_ctor_info_maybe_error_0), (MR_Word) (&mercury__io__io__type_ctor_info_state_0), Var_151, CForeignDeclCodes_26, &CForeignDeclCodeResults_27, ((MR_Box) ((MR_Integer) 0)), &conv2_STATE_VARIABLE_IO_152_152);
      ...
      backend_libs__export__write_export_decls_4_p_0(FileStream_15, CExportDecls_25);
      {
        ...
        MR_hl_field(MR_mktag(1), Var_171, 0) = ((MR_Box) (GuardMacroName_21));
        MR_hl_field(MR_mktag(1), Var_171, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &backend_libs__export_scalar_common_2[26])));
      }
      {
        Var_169 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), Var_169, 0) = ((MR_Box) ((MR_String) "#endif /* "));
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(1), Var_161, 0) = ((MR_Box) ((MR_String) "#ifdef __cplusplus\n"));
      ...
      mercury__io__write_strings_4_p_0(FileStream_15, Var_158);
      ...
      else
      {
        ...
        Var_177 = mercury__string__f_43_43_2_f_0(FileName_12, (MR_String) ".tmp");
        mercury__io__remove_file_4_p_0(Var_177, &Var_32);
