...
backend_libs__export__IntroducedFrom__pred__foreign_const_name_and_tag__1005__1_2_p_0(
  ...
  MR_Integer backend_libs__export__HeadVar__2_66);

static MR_bool MR_CALL 
backend_libs__export__IntroducedFrom__pred__output_exported_c_enum__905__1_2_p_0(
  MR_Word backend_libs__export__Lang_14,
  MR_Word backend_libs__export__HeadVar__2_48);

static MR_bool MR_CALL 
backend_libs__export__IntroducedFrom__pred__output_foreign_decl__844__1_2_p_0(
...
backend_libs__export__foreign_const_name_and_tag_6_p_0(
  ...
  MR_Word backend_libs__export__STATE_VARIABLE_NamesAndTagsCord_0_57,
  MR_Word * backend_libs__export__STATE_VARIABLE_NamesAndTagsCord_58);
...
static void MR_CALL 
backend_libs__export__output_exported_c_enum_7_p_0_3(
  MR_Box backend_libs__export__closure_arg,
  MR_Box backend_libs__export__wrapper_arg_1,
  MR_Box backend_libs__export__wrapper_arg_2,
  MR_Box * backend_libs__export__wrapper_arg_3);
...
static void MR_CALL 
backend_libs__export__output_exported_c_enum_7_p_0_2(
  MR_Box backend_libs__export__closure_arg,
  MR_Box backend_libs__export__wrapper_arg_1,
  MR_Box backend_libs__export__wrapper_arg_2,
  MR_Box * backend_libs__export__wrapper_arg_3);
...
static MR_bool MR_CALL 
backend_libs__export__output_exported_c_enum_7_p_0_1(
  MR_Box backend_libs__export__closure_arg);

static void MR_CALL 
backend_libs__export__output_exported_c_enum_7_p_0(
  MR_Word backend_libs__export__Stream_8,
  MR_Word backend_libs__export__MaybeSetLineNumbers_9,
  MR_Word backend_libs__export__MaybeThisFileName_10,
  MR_Word backend_libs__export__TypeTable_11,
  MR_Word backend_libs__export__ExportedEnumInfo_12);
...
static /* final */ const MR_Box backend_libs__export_scalar_common_5[1][10];
...
static /* final */ const MR_Box backend_libs__export_scalar_common_9[1][9];

static /* final */ const MR_Box backend_libs__export_scalar_common_10[1][6];
...
static /* final */ const MR_Box backend_libs__export_scalar_common_1[4][3] = {
  ...
  /* row 3 */
  {
    ((MR_Box) (&backend_libs__export_scalar_common_10[0])),
    ((MR_Box) (backend_libs__export__output_exported_c_enum_7_p_0_3)),
    ((MR_Box) (MR_Word) ((MR_Integer) 0))
  },
};
...
{
  {
    MR_bool backend_libs__export__succeeded = (backend_libs__export__Arity_16 == backend_libs__export__HeadVar__2_66);
...
{
  {
    MR_bool backend_libs__export__succeeded = (backend_libs__export__Lang_14 == backend_libs__export__HeadVar__2_48);
    ...
    if (((MR_tag((MR_Word) backend_libs__export__HeadVar__2_2)) == (MR_mktag((MR_Integer) 0))))
      {
        ...
        if (((MR_tag((MR_Word) backend_libs__export__HeadVar__3_3)) == (MR_mktag((MR_Integer) 0))))
          {
            MR_Integer backend_libs__export__Var_5 = ((MR_Integer) (MR_hl_field(MR_mktag(0), backend_libs__export__HeadVar__3_3, (MR_Integer) 0)));

            {
              mercury__private_builtin__builtin_compare_int_3_p_0(backend_libs__export__HeadVar__1_1, backend_libs__export__Var_16, backend_libs__export__Var_5);
            }
          }
        else
    ...
    else
      {
        ...
        if (((MR_tag((MR_Word) backend_libs__export__HeadVar__3_3)) == (MR_mktag((MR_Integer) 0))))
          *backend_libs__export__HeadVar__1_1 = (MR_Integer) 2;
          ...
          {
            MR_String backend_libs__export__Var_11 = ((MR_String) (MR_hl_field(MR_mktag(1), backend_libs__export__HeadVar__3_3, (MR_Integer) 0)));

            {
              mercury__private_builtin__builtin_compare_string_3_p_0(backend_libs__export__HeadVar__1_1, backend_libs__export__Var_17, backend_libs__export__Var_11);
            }
          }
      }
  }
...
{
  {
    ...
    if (((MR_tag((MR_Word) backend_libs__export__HeadVar__1_1)) == (MR_mktag((MR_Integer) 0))))
      {
        MR_Integer backend_libs__export__Var_3 = ((MR_Integer) (MR_hl_field(MR_mktag(0), backend_libs__export__HeadVar__1_1, (MR_Integer) 0)));
        MR_Integer backend_libs__export__Var_4;

        backend_libs__export__succeeded = ((MR_tag((MR_Word) backend_libs__export__HeadVar__2_2)) == (MR_mktag((MR_Integer) 0)));
        if (backend_libs__export__succeeded)
          {
            backend_libs__export__Var_4 = ((MR_Integer) (MR_hl_field(MR_mktag(0), backend_libs__export__HeadVar__2_2, (MR_Integer) 0)));
            backend_libs__export__succeeded = (backend_libs__export__Var_3 == backend_libs__export__Var_4);
          }
      }
    else
      {
        MR_String backend_libs__export__Var_5 = ((MR_String) (MR_hl_field(MR_mktag(1), backend_libs__export__HeadVar__1_1, (MR_Integer) 0)));
        MR_String backend_libs__export__Var_6;

        backend_libs__export__succeeded = ((MR_tag((MR_Word) backend_libs__export__HeadVar__2_2)) == (MR_mktag((MR_Integer) 1)));
        if (backend_libs__export__succeeded)
          {
            backend_libs__export__Var_6 = ((MR_String) (MR_hl_field(MR_mktag(1), backend_libs__export__HeadVar__2_2, (MR_Integer) 0)));
            backend_libs__export__succeeded = (strcmp(backend_libs__export__Var_5, backend_libs__export__Var_6) == 0);
          }
      }
    return backend_libs__export__succeeded;
  }
...
{
  {
    ...
    {
      backend_libs__export__succeeded = backend_libs__export__IntroducedFrom__pred__foreign_const_name_and_tag__1005__1_2_p_0(((MR_Integer) (MR_hl_field(MR_mktag(0), backend_libs__export__closure, (MR_Integer) 3))), ((MR_Integer) (MR_hl_field(MR_mktag(0), backend_libs__export__closure, (MR_Integer) 4))));
    }
    return backend_libs__export__succeeded;
  }
}
...
{
  {
    ...
    MR_Word backend_libs__export__UnqualifiedCtorName_55;
    MR_String backend_libs__export__ForeignName_56;
    MR_Word backend_libs__export__Var_62;
    MR_String backend_libs__export__Var_67;
    ...
    MR_Box backend_libs__export__conv1_ForeignName_56;
    ...
    {
      backend_libs__export__Var_62 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 5 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), backend_libs__export__Var_62, 0) = ((MR_Box) (&backend_libs__export_scalar_common_4[3]));
      MR_hl_field(MR_mktag(0), backend_libs__export__Var_62, 1) = ((MR_Box) (backend_libs__export__foreign_const_name_and_tag_6_p_0_1));
      MR_hl_field(MR_mktag(0), backend_libs__export__Var_62, 2) = ((MR_Box) (MR_Word) ((MR_Integer) 2));
      MR_hl_field(MR_mktag(0), backend_libs__export__Var_62, 3) = ((MR_Box) (backend_libs__export__Arity_16));
      MR_hl_field(MR_mktag(0), backend_libs__export__Var_62, 4) = ((MR_Box) ((MR_Integer) 0));
    }
    {
      mercury__require__expect_4_p_0(backend_libs__export__Var_62, (MR_String) "backend_libs.export", (MR_String) "predicate \140backend_libs.export.foreign_const_name_and_tag\'/6", (MR_String) "enum constant arity != 0");
    }
    {
      backend_libs__export__Var_67 = mdbcomp__sym_name__unqualify_name_1_f_0(backend_libs__export__QualifiedCtorName_14);
    }
    {
      backend_libs__export__UnqualifiedCtorName_55 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), backend_libs__export__UnqualifiedCtorName_55, 0) = ((MR_Box) (backend_libs__export__Var_67));
    }
    {
      mercury__map__lookup_3_p_0((MR_Word) &mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0, (MR_Word) &mercury__builtin__builtin__type_ctor_info_string_0, backend_libs__export__Mapping_8, ((MR_Box) (backend_libs__export__UnqualifiedCtorName_55)), &backend_libs__export__conv1_ForeignName_56);
    }
    backend_libs__export__ForeignName_56 = ((MR_String) backend_libs__export__conv1_ForeignName_56);
    {
      backend_libs__export__Var_69 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), backend_libs__export__Var_69, 0) = ((MR_Box) (backend_libs__export__ForeignName_56));
      MR_hl_field(MR_mktag(0), backend_libs__export__Var_69, 1) = ((MR_Box) (backend_libs__export__Tag_21));
    }
    {
      *backend_libs__export__STATE_VARIABLE_NamesAndTagsCord_58 = mercury__cord__snoc_2_f_0((MR_Word) &backend_libs__export_scalar_common_1[1], backend_libs__export__STATE_VARIABLE_NamesAndTagsCord_0_57, ((MR_Box) (backend_libs__export__Var_69)));
    }
  }
}
    ...
    if (((MR_tag((MR_Word) backend_libs__export__Tag_5)) == (MR_mktag((MR_Integer) 0))))
      {
        ...
        MR_String backend_libs__export__Var_35;
        ...
        {
          mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) &backend_libs__export_scalar_common_6[1], backend_libs__export__RawIntTag_7, &backend_libs__export__Var_35);
        }
        {
          mercury__io__write_string_3_p_0(backend_libs__export__Var_35);
        }
      }
    else
      {
...
{
  {
    ...
    {
      backend_libs__export__succeeded = backend_libs__export__IntroducedFrom__pred__output_exported_c_enum__905__1_2_p_0(((MR_Word) (MR_hl_field(MR_mktag(0), backend_libs__export__closure, (MR_Integer) 3))), ((MR_Word) (MR_hl_field(MR_mktag(0), backend_libs__export__closure, (MR_Integer) 4))));
    }
    return backend_libs__export__succeeded;
  }
}
  ...
  MR_Word backend_libs__export__ExportedEnumInfo_12)
{
  {
    MR_bool backend_libs__export__succeeded;
    MR_Word backend_libs__export__Lang_14 = ((MR_Word) (MR_hl_field(MR_mktag(0), backend_libs__export__ExportedEnumInfo_12, (MR_Integer) 0)));
    MR_Word backend_libs__export__Context_15 = ((MR_Word) (MR_hl_field(MR_mktag(0), backend_libs__export__ExportedEnumInfo_12, (MR_Integer) 1)));
    MR_Word backend_libs__export__TypeCtor_16 = ((MR_Word) (MR_hl_field(MR_mktag(0), backend_libs__export__ExportedEnumInfo_12, (MR_Integer) 2)));
    MR_Word backend_libs__export__NameMapping_17 = ((MR_Word) (MR_hl_field(MR_mktag(0), backend_libs__export__ExportedEnumInfo_12, (MR_Integer) 3)));
    MR_Word backend_libs__export__TypeDefn_18;
    MR_Word backend_libs__export__TypeBody_19;
    MR_Word backend_libs__export__Var_44;

    {
      backend_libs__export__Var_44 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 5 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), backend_libs__export__Var_44, 0) = ((MR_Box) (&backend_libs__export_scalar_common_4[1]));
      MR_hl_field(MR_mktag(0), backend_libs__export__Var_44, 1) = ((MR_Box) (backend_libs__export__output_exported_c_enum_7_p_0_1));
      MR_hl_field(MR_mktag(0), backend_libs__export__Var_44, 2) = ((MR_Box) (MR_Word) ((MR_Integer) 2));
      MR_hl_field(MR_mktag(0), backend_libs__export__Var_44, 3) = ((MR_Box) (backend_libs__export__Lang_14));
      MR_hl_field(MR_mktag(0), backend_libs__export__Var_44, 4) = ((MR_Box) ((MR_Integer) 0));
    }
    {
      mercury__require__expect_4_p_0(backend_libs__export__Var_44, (MR_String) "backend_libs.export", (MR_String) "predicate \140backend_libs.export.output_exported_c_enum\'/7", (MR_String) "Lang != lang_c");
    }
    {
      hlds__hlds_data__lookup_type_ctor_defn_3_p_0(backend_libs__export__TypeTable_11, backend_libs__export__TypeCtor_16, &backend_libs__export__TypeDefn_18);
    }
    {
      hlds__hlds_data__get_type_defn_body_2_p_0(backend_libs__export__TypeDefn_18, &backend_libs__export__TypeBody_19);
    }
    switch (MR_tag((MR_Word) backend_libs__export__TypeBody_19)) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        {
          {
            mercury__require__unexpected_3_p_0((MR_String) "backend_libs.export", (MR_String) "predicate \140backend_libs.export.output_exported_c_enum\'/7", (MR_String) "invalid type for foreign_export_enum");
            return;
          }
        }
        break;
      case (MR_Integer) 1:
        {
          MR_Word backend_libs__export__Ctors_25 = ((MR_Word) (MR_hl_field(MR_mktag(1), backend_libs__export__TypeBody_19, (MR_Integer) 0)));
          MR_Word backend_libs__export__TagValues_26 = ((MR_Word) (MR_hl_field(MR_mktag(1), backend_libs__export__TypeBody_19, (MR_Integer) 1)));
          MR_Word backend_libs__export__DuTypeKind_28 = ((MR_Word) (MR_hl_field(MR_mktag(1), backend_libs__export__TypeBody_19, (MR_Integer) 3)));
          MR_Word backend_libs__export___CheaperTagTest_27 = ((MR_Word) (MR_hl_field(MR_mktag(1), backend_libs__export__TypeBody_19, (MR_Integer) 2)));
          MR_Word backend_libs__export___MaybeUserEq_29 = ((MR_Word) (MR_hl_field(MR_mktag(1), backend_libs__export__TypeBody_19, (MR_Integer) 4)));
          MR_Word backend_libs__export___MaybeDirectArgCtors_30 = ((MR_Word) (MR_hl_field(MR_mktag(1), backend_libs__export__TypeBody_19, (MR_Integer) 5)));
          MR_Word backend_libs__export___ReservedTag_31 = ((((MR_Word) (MR_hl_field(MR_mktag(1), backend_libs__export__TypeBody_19, (MR_Integer) 6)))) & (MR_Integer) 1);
          MR_Word backend_libs__export___ReservedAddr_32 = ((((((MR_Word) (MR_hl_field(MR_mktag(1), backend_libs__export__TypeBody_19, (MR_Integer) 6)))) >> (MR_Integer) 1)) & (MR_Integer) 1);
          MR_Word backend_libs__export___IsForeignType_33 = ((MR_Word) (MR_hl_field(MR_mktag(1), backend_libs__export__TypeBody_19, (MR_Integer) 7)));

          switch (MR_tag((MR_Word) backend_libs__export__DuTypeKind_28)) {
            default: /*NOTREACHED*/ MR_assert(0);
            case (MR_Integer) 0:
              switch (MR_unmkbody(backend_libs__export__DuTypeKind_28)) {
                default: /*NOTREACHED*/ MR_assert(0);
                case (MR_Integer) 0:
                case (MR_Integer) 1:
                  {
                    MR_Word backend_libs__export__TypeInfo_67_67;
                    MR_Word backend_libs__export__ForeignNamesAndTagsCord_38;
                    MR_Word backend_libs__export__ForeignNamesAndTags_39;
                    MR_String backend_libs__export__File_40;
                    MR_Integer backend_libs__export__Line_41;
                    MR_Word backend_libs__export__Var_49;
                    MR_Word backend_libs__export__Var_50;
                    MR_Box backend_libs__export__conv1_ForeignNamesAndTagsCord_38;

                    {
                      backend_libs__export__Var_49 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 6 * sizeof(MR_Word)), NULL, NULL);
                      MR_hl_field(MR_mktag(0), backend_libs__export__Var_49, 0) = ((MR_Box) (&backend_libs__export_scalar_common_9[0]));
                      MR_hl_field(MR_mktag(0), backend_libs__export__Var_49, 1) = ((MR_Box) (backend_libs__export__output_exported_c_enum_7_p_0_2));
                      MR_hl_field(MR_mktag(0), backend_libs__export__Var_49, 2) = ((MR_Box) (MR_Word) ((MR_Integer) 3));
                      MR_hl_field(MR_mktag(0), backend_libs__export__Var_49, 3) = ((MR_Box) (backend_libs__export__TypeCtor_16));
                      MR_hl_field(MR_mktag(0), backend_libs__export__Var_49, 4) = ((MR_Box) (backend_libs__export__NameMapping_17));
                      MR_hl_field(MR_mktag(0), backend_libs__export__Var_49, 5) = ((MR_Box) (backend_libs__export__TagValues_26));
                    }
                    backend_libs__export__TypeInfo_67_67 = (MR_Word) &backend_libs__export_scalar_common_1[1];
                    {
                      backend_libs__export__Var_50 = mercury__cord__init_0_f_0(backend_libs__export__TypeInfo_67_67);
                    }
                    {
                      mercury__list__foldl_4_p_0((MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_constructor_0, (MR_Word) &backend_libs__export_scalar_common_2[0], backend_libs__export__Var_49, backend_libs__export__Ctors_25, ((MR_Box) (backend_libs__export__Var_50)), &backend_libs__export__conv1_ForeignNamesAndTagsCord_38);
                    }
                    backend_libs__export__ForeignNamesAndTagsCord_38 = ((MR_Word) backend_libs__export__conv1_ForeignNamesAndTagsCord_38);
                    {
                      backend_libs__export__ForeignNamesAndTags_39 = mercury__cord__list_1_f_0(backend_libs__export__TypeInfo_67_67, backend_libs__export__ForeignNamesAndTagsCord_38);
                    }
                    {
                      mercury__term__context_file_2_p_0(backend_libs__export__Context_15, &backend_libs__export__File_40);
                    }
                    {
                      mercury__term__context_line_2_p_0(backend_libs__export__Context_15, &backend_libs__export__Line_41);
                    }
                    {
                      backend_libs__c_util__maybe_set_line_num_6_p_0(backend_libs__export__Stream_8, backend_libs__export__MaybeSetLineNumbers_9, backend_libs__export__File_40, backend_libs__export__Line_41);
                    }
                    {
                      mercury__io__write_list_6_p_0(backend_libs__export__TypeInfo_67_67, backend_libs__export__Stream_8, backend_libs__export__ForeignNamesAndTags_39, (MR_String) "\n", (MR_Word) &backend_libs__export_scalar_common_1[3]);
                    }
                    {
                      mercury__io__nl_3_p_0(backend_libs__export__Stream_8);
                    }
                    {
                      backend_libs__c_util__maybe_reset_line_num_5_p_0(backend_libs__export__Stream_8, backend_libs__export__MaybeSetLineNumbers_9, backend_libs__export__MaybeThisFileName_10);
                    }
                  }
                  break;
                case (MR_Integer) 2:
                  {
                    {
                      mercury__require__unexpected_3_p_0((MR_String) "backend_libs.export", (MR_String) "predicate \140backend_libs.export.output_exported_c_enum\'/7", (MR_String) "d.u. is not an enumeration.");
                      return;
                    }
                  }
                  break;
...
{
  {
    ...
    {
      backend_libs__export__succeeded = backend_libs__export__IntroducedFrom__pred__output_foreign_decl__844__1_2_p_0(((MR_Word) (MR_hl_field(MR_mktag(0), backend_libs__export__closure, (MR_Integer) 3))), ((MR_Word) (MR_hl_field(MR_mktag(0), backend_libs__export__closure, (MR_Integer) 4))));
    }
    return backend_libs__export__succeeded;
  }
}
...
{
  {
...

    {
      ...
      MR_hl_field(MR_mktag(0), backend_libs__export__Var_23, 0) = ((MR_Box) (&backend_libs__export_scalar_common_4[1]));
...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(0), backend_libs__export__Var_74, 0) = ((MR_Box) (&backend_libs__export_scalar_common_4[2]));
...
{
  {
...

    {
      ...
      MR_hl_field(MR_mktag(0), backend_libs__export__Var_26, 0) = ((MR_Box) (&backend_libs__export_scalar_common_4[1]));
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), backend_libs__export__Var_143, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &backend_libs__export_scalar_common_2[26])));
    }
    {
      ...
      case (MR_Integer) 2:
        {
          ...
          switch (backend_libs__export__BuiltinType_9) {
            ...
            case (MR_Integer) 2:
              {
                MR_Word backend_libs__export__Var_36 = ((MR_Word) (MR_hl_field(MR_mktag(0), backend_libs__export__SourceArgLoc_5, (MR_Integer) 0)));
                MR_Integer backend_libs__export__Var_35 = ((MR_Integer) (MR_hl_field(MR_mktag(0), backend_libs__export__SourceArgLoc_5, (MR_Integer) 1)));

                switch (backend_libs__export__Var_36) {
                  default: /*NOTREACHED*/ MR_assert(0);
                  case (MR_Integer) 1:
                    *backend_libs__export__ConvertedRval_8 = backend_libs__export__Rval_6;
                    break;
                  case (MR_Integer) 0:
                    {
                      MR_String backend_libs__export__Var_32;

                      {
                        backend_libs__export__Var_32 = mercury__string__f_43_43_2_f_0(backend_libs__export__Rval_6, (MR_String) ")");
                      }
                      {
                        *backend_libs__export__ConvertedRval_8 = mercury__string__f_43_43_2_f_0((MR_String) "MR_word_to_float(", backend_libs__export__Var_32);
                      }
                    }
                    break;
                }
      ...
      case (MR_Integer) 2:
        {
          ...
          switch (backend_libs__export__BuiltinType_9) {
            ...
            case (MR_Integer) 2:
              {
                MR_Word backend_libs__export__Var_37 = ((MR_Word) (MR_hl_field(MR_mktag(0), backend_libs__export__TargetArgLoc_7, (MR_Integer) 0)));
                MR_Integer backend_libs__export__Var_36 = ((MR_Integer) (MR_hl_field(MR_mktag(0), backend_libs__export__TargetArgLoc_7, (MR_Integer) 1)));
                  ...
                  case (MR_Integer) 0:
                    {
                      ...
                      {
                        backend_libs__export__Var_33 = mercury__string__f_43_43_2_f_0(backend_libs__export__Rval_5, (MR_String) ")");
                      }
                      {
                        *backend_libs__export__ConvertedRval_8 = mercury__string__f_43_43_2_f_0((MR_String) "MR_float_to_word(", backend_libs__export__Var_33);
                      }
                    }
                    break;
                }
...
{
  {
    ...
    {
      backend_libs__export__output_exported_c_enum_7_p_0(((MR_Word) (MR_hl_field(MR_mktag(0), backend_libs__export__closure, (MR_Integer) 3))), ((MR_Word) (MR_hl_field(MR_mktag(0), backend_libs__export__closure, (MR_Integer) 4))), ((MR_Word) (MR_hl_field(MR_mktag(0), backend_libs__export__closure, (MR_Integer) 5))), ((MR_Word) (MR_hl_field(MR_mktag(0), backend_libs__export__closure, (MR_Integer) 6))), ((MR_Word) backend_libs__export__wrapper_arg_1));
    }
  }
}
...
{
  {
    ...
    {
      backend_libs__export__Var_35 = mercury__string__f_43_43_2_f_0(backend_libs__export__FileName_12, (MR_String) ".tmp");
    }
    {
      mercury__io__open_output_4_p_0(backend_libs__export__Var_35, &backend_libs__export__Result_14);
    }
    if (((MR_tag((MR_Word) backend_libs__export__Result_14)) == (MR_mktag((MR_Integer) 1))))
      {
        MR_String backend_libs__export__ProgName_30;
        MR_String backend_libs__export__Var_45;

        {
          mercury__io__progname_base_4_p_0((MR_String) "export.m", &backend_libs__export__ProgName_30);
        }
        {
          mercury__io__write_string_3_p_0((MR_String) "\n");
        }
        {
          mercury__io__write_string_3_p_0(backend_libs__export__ProgName_30);
        }
        {
          mercury__io__write_string_3_p_0((MR_String) ": can\'t open \140");
        }
        {
          backend_libs__export__Var_45 = mercury__string__f_43_43_2_f_0(backend_libs__export__FileName_12, (MR_String) ".tmp");
        }
        {
          mercury__io__write_string_3_p_0(backend_libs__export__Var_45);
        }
        {
    ...
    else
      {
        ...
        MR_Word backend_libs__export__Var_55;
        MR_Word backend_libs__export__Var_58;
        MR_Word backend_libs__export__Var_60;
        MR_Word backend_libs__export__Var_61;
        MR_Word backend_libs__export__Var_63;
        MR_Word backend_libs__export__Var_65;
        MR_Word backend_libs__export__Var_67;
        MR_Word backend_libs__export__Var_68;
        MR_Word backend_libs__export__Var_70;
        MR_Word backend_libs__export__Var_72;
        MR_Word backend_libs__export__Var_81;
        MR_Word backend_libs__export__Var_84;
        MR_Word backend_libs__export__Var_85;
        MR_Word backend_libs__export__Var_87;
        MR_Word backend_libs__export__Var_89;
        MR_Word backend_libs__export__Var_152;
        MR_Word backend_libs__export__Var_155;
        MR_Word backend_libs__export__Var_157;
        MR_Word backend_libs__export__Var_159;
        MR_Word backend_libs__export__Var_161;
        MR_Word backend_libs__export__Var_163;
        MR_Word backend_libs__export__Var_165;

        {
          parse_tree__file_names__module_name_to_file_name_7_p_0(backend_libs__export__Globals_10, backend_libs__export__ModuleName_8, (MR_String) ".m", (MR_Integer) 1, &backend_libs__export__SourceFileName_16);
        }
        {
          mercury__library__version_2_p_0(&backend_libs__export__Version_17, &backend_libs__export__Fullarch_18);
        }
        {
          backend_libs__export__Var_72 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), backend_libs__export__Var_72, 0) = ((MR_Box) (backend_libs__export__Fullarch_18));
          MR_hl_field(MR_mktag(1), backend_libs__export__Var_72, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &backend_libs__export_scalar_common_2[3])));
        }
        {
          backend_libs__export__Var_70 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), backend_libs__export__Var_70, 0) = ((MR_Box) ((MR_String) "** configured for "));
          MR_hl_field(MR_mktag(1), backend_libs__export__Var_70, 1) = ((MR_Box) (backend_libs__export__Var_72));
        }
        {
          backend_libs__export__Var_68 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), backend_libs__export__Var_68, 0) = ((MR_Box) ((MR_String) "\n"));
          MR_hl_field(MR_mktag(1), backend_libs__export__Var_68, 1) = ((MR_Box) (backend_libs__export__Var_70));
        }
        {
          backend_libs__export__Var_67 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), backend_libs__export__Var_67, 0) = ((MR_Box) (backend_libs__export__Version_17));
          MR_hl_field(MR_mktag(1), backend_libs__export__Var_67, 1) = ((MR_Box) (backend_libs__export__Var_68));
        }
        {
          backend_libs__export__Var_65 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), backend_libs__export__Var_65, 0) = ((MR_Box) ((MR_String) "** version "));
          MR_hl_field(MR_mktag(1), backend_libs__export__Var_65, 1) = ((MR_Box) (backend_libs__export__Var_67));
        }
        {
          backend_libs__export__Var_63 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), backend_libs__export__Var_63, 0) = ((MR_Box) ((MR_String) "** by the Mercury compiler,\n"));
          MR_hl_field(MR_mktag(1), backend_libs__export__Var_63, 1) = ((MR_Box) (backend_libs__export__Var_65));
        }
        {
          backend_libs__export__Var_61 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), backend_libs__export__Var_61, 0) = ((MR_Box) ((MR_String) "\'\n"));
          MR_hl_field(MR_mktag(1), backend_libs__export__Var_61, 1) = ((MR_Box) (backend_libs__export__Var_63));
        }
        {
          backend_libs__export__Var_60 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), backend_libs__export__Var_60, 0) = ((MR_Box) (backend_libs__export__SourceFileName_16));
          MR_hl_field(MR_mktag(1), backend_libs__export__Var_60, 1) = ((MR_Box) (backend_libs__export__Var_61));
        }
        {
          backend_libs__export__Var_58 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), backend_libs__export__Var_58, 0) = ((MR_Box) ((MR_String) "** Automatically generated from \140"));
          MR_hl_field(MR_mktag(1), backend_libs__export__Var_58, 1) = ((MR_Box) (backend_libs__export__Var_60));
        }
        {
          backend_libs__export__Var_55 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), backend_libs__export__Var_55, 0) = ((MR_Box) ((MR_String) "/*\n"));
          MR_hl_field(MR_mktag(1), backend_libs__export__Var_55, 1) = ((MR_Box) (backend_libs__export__Var_58));
        }
        {
          mercury__io__write_strings_4_p_0(backend_libs__export__FileStream_15, backend_libs__export__Var_55);
        }
        {
        ...
        {
          backend_libs__export__Var_89 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), backend_libs__export__Var_89, 0) = ((MR_Box) (backend_libs__export__GuardMacroName_21));
          MR_hl_field(MR_mktag(1), backend_libs__export__Var_89, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &backend_libs__export_scalar_common_2[20])));
        }
        {
          backend_libs__export__Var_87 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), backend_libs__export__Var_87, 0) = ((MR_Box) ((MR_String) "#define "));
          MR_hl_field(MR_mktag(1), backend_libs__export__Var_87, 1) = ((MR_Box) (backend_libs__export__Var_89));
        }
        {
          backend_libs__export__Var_85 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), backend_libs__export__Var_85, 0) = ((MR_Box) ((MR_String) "\n"));
          MR_hl_field(MR_mktag(1), backend_libs__export__Var_85, 1) = ((MR_Box) (backend_libs__export__Var_87));
        }
        {
          backend_libs__export__Var_84 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), backend_libs__export__Var_84, 0) = ((MR_Box) (backend_libs__export__GuardMacroName_21));
          MR_hl_field(MR_mktag(1), backend_libs__export__Var_84, 1) = ((MR_Box) (backend_libs__export__Var_85));
        }
        {
          backend_libs__export__Var_81 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), backend_libs__export__Var_81, 0) = ((MR_Box) ((MR_String) "#ifndef "));
          MR_hl_field(MR_mktag(1), backend_libs__export__Var_81, 1) = ((MR_Box) (backend_libs__export__Var_84));
        }
        {
          mercury__io__write_strings_4_p_0(backend_libs__export__FileStream_15, backend_libs__export__Var_81);
        }
        {
        ...
        {
          mercury__list__filter_3_p_0(backend_libs__export__TypeCtorInfo_172_172, (MR_Word) &backend_libs__export_scalar_common_1[2], backend_libs__export__ExportedEnums_22, &backend_libs__export__CExportedEnums_23);
        }
        ...
        {
          mercury__list__filter_3_p_0(backend_libs__export__TypeCtorInfo_174_174, (MR_Word) &backend_libs__export_scalar_common_3[1], backend_libs__export__ForeignDeclCodes_24, &backend_libs__export__CForeignDeclCodes_26);
        }
        ...
        if (backend_libs__export__succeeded)
        ...
        else
          {
            ...
            MR_Word backend_libs__export__TypeTable_28;
            MR_Word backend_libs__export__Var_129;
            MR_Word backend_libs__export__Var_132;
            MR_String backend_libs__export__Var_133;
            MR_Word backend_libs__export__Var_134;
            MR_Word backend_libs__export__Var_136;
            MR_Word backend_libs__export__Var_138;
            MR_String backend_libs__export__Var_139;
            MR_Word backend_libs__export__Var_143;
            MR_Word backend_libs__export__Var_145;
            MR_Box backend_libs__export__conv0_STATE_VARIABLE_IO_144_144;
            MR_Box backend_libs__export__conv1_STATE_VARIABLE_IO_146_146;
            ...
            {
              backend_libs__export__Var_133 = backend_libs__foreign__decl_guard_1_f_0(backend_libs__export__ModuleName_8);
            }
            {
              backend_libs__export__Var_139 = backend_libs__foreign__decl_guard_1_f_0(backend_libs__export__ModuleName_8);
            }
            {
              backend_libs__export__Var_138 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), backend_libs__export__Var_138, 0) = ((MR_Box) (backend_libs__export__Var_139));
              MR_hl_field(MR_mktag(1), backend_libs__export__Var_138, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &backend_libs__export_scalar_common_2[4])));
            }
            {
              backend_libs__export__Var_136 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), backend_libs__export__Var_136, 0) = ((MR_Box) ((MR_String) "#define "));
              MR_hl_field(MR_mktag(1), backend_libs__export__Var_136, 1) = ((MR_Box) (backend_libs__export__Var_138));
            }
            {
              backend_libs__export__Var_134 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), backend_libs__export__Var_134, 0) = ((MR_Box) ((MR_String) "\n"));
              MR_hl_field(MR_mktag(1), backend_libs__export__Var_134, 1) = ((MR_Box) (backend_libs__export__Var_136));
            }
            {
              backend_libs__export__Var_132 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), backend_libs__export__Var_132, 0) = ((MR_Box) (backend_libs__export__Var_133));
              MR_hl_field(MR_mktag(1), backend_libs__export__Var_132, 1) = ((MR_Box) (backend_libs__export__Var_134));
            }
            {
              backend_libs__export__Var_129 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), backend_libs__export__Var_129, 0) = ((MR_Box) ((MR_String) "#ifndef "));
              MR_hl_field(MR_mktag(1), backend_libs__export__Var_129, 1) = ((MR_Box) (backend_libs__export__Var_132));
            }
            {
              mercury__io__write_strings_4_p_0(backend_libs__export__FileStream_15, backend_libs__export__Var_129);
            }
            {
              hlds__hlds_module__module_info_get_type_table_2_p_0(backend_libs__export__ModuleInfo_6, &backend_libs__export__TypeTable_28);
            }
            {
              backend_libs__export__Var_143 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 7 * sizeof(MR_Word)), NULL, NULL);
              MR_hl_field(MR_mktag(0), backend_libs__export__Var_143, 0) = ((MR_Box) (&backend_libs__export_scalar_common_5[0]));
              MR_hl_field(MR_mktag(0), backend_libs__export__Var_143, 1) = ((MR_Box) (backend_libs__export__produce_header_file_5_p_0_3));
              MR_hl_field(MR_mktag(0), backend_libs__export__Var_143, 2) = ((MR_Box) (MR_Word) ((MR_Integer) 4));
              MR_hl_field(MR_mktag(0), backend_libs__export__Var_143, 3) = ((MR_Box) (backend_libs__export__FileStream_15));
              MR_hl_field(MR_mktag(0), backend_libs__export__Var_143, 4) = ((MR_Box) (backend_libs__export__MaybeSetLineNumbers_27));
              MR_hl_field(MR_mktag(0), backend_libs__export__Var_143, 5) = ((MR_Box) (backend_libs__export__MaybeThisFileName_13));
              MR_hl_field(MR_mktag(0), backend_libs__export__Var_143, 6) = ((MR_Box) (backend_libs__export__TypeTable_28));
            }
            backend_libs__export__TypeCtorInfo_178_178 = (MR_Word) &mercury__io__io__type_ctor_info_state_0;
            {
              mercury__list__foldl_4_p_2(backend_libs__export__TypeCtorInfo_172_172, backend_libs__export__TypeCtorInfo_178_178, backend_libs__export__Var_143, backend_libs__export__CExportedEnums_23, ((MR_Box) ((MR_Integer) 0)), &backend_libs__export__conv0_STATE_VARIABLE_IO_144_144);
            }
            {
              backend_libs__export__Var_145 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 8 * sizeof(MR_Word)), NULL, NULL);
              MR_hl_field(MR_mktag(0), backend_libs__export__Var_145, 0) = ((MR_Box) (&backend_libs__export_scalar_common_7[0]));
              MR_hl_field(MR_mktag(0), backend_libs__export__Var_145, 1) = ((MR_Box) (backend_libs__export__produce_header_file_5_p_0_4));
              MR_hl_field(MR_mktag(0), backend_libs__export__Var_145, 2) = ((MR_Box) (MR_Word) ((MR_Integer) 5));
              MR_hl_field(MR_mktag(0), backend_libs__export__Var_145, 3) = ((MR_Box) (backend_libs__export__FileStream_15));
              MR_hl_field(MR_mktag(0), backend_libs__export__Var_145, 4) = ((MR_Box) (backend_libs__export__MaybeSetLineNumbers_27));
              MR_hl_field(MR_mktag(0), backend_libs__export__Var_145, 5) = ((MR_Box) (backend_libs__export__MaybeThisFileName_13));
              MR_hl_field(MR_mktag(0), backend_libs__export__Var_145, 6) = ((MR_Box) (backend_libs__export__SourceFileName_16));
              MR_hl_field(MR_mktag(0), backend_libs__export__Var_145, 7) = ((MR_Box) (MR_mkword(MR_mktag(1), &backend_libs__export_scalar_common_6[0])));
            }
            {
              mercury__list__foldl_4_p_2(backend_libs__export__TypeCtorInfo_174_174, backend_libs__export__TypeCtorInfo_178_178, backend_libs__export__Var_145, backend_libs__export__CForeignDeclCodes_26, ((MR_Box) ((MR_Integer) 0)), &backend_libs__export__conv1_STATE_VARIABLE_IO_146_146);
            }
            {
        ...
        {
          backend_libs__export__Var_165 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), backend_libs__export__Var_165, 0) = ((MR_Box) (backend_libs__export__GuardMacroName_21));
          MR_hl_field(MR_mktag(1), backend_libs__export__Var_165, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &backend_libs__export_scalar_common_2[25])));
        }
        {
          backend_libs__export__Var_163 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), backend_libs__export__Var_163, 0) = ((MR_Box) ((MR_String) "#endif /* "));
          MR_hl_field(MR_mktag(1), backend_libs__export__Var_163, 1) = ((MR_Box) (backend_libs__export__Var_165));
        }
        {
          backend_libs__export__Var_161 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), backend_libs__export__Var_161, 0) = ((MR_Box) ((MR_String) "\n"));
          MR_hl_field(MR_mktag(1), backend_libs__export__Var_161, 1) = ((MR_Box) (backend_libs__export__Var_163));
        }
        {
          backend_libs__export__Var_159 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), backend_libs__export__Var_159, 0) = ((MR_Box) ((MR_String) "#endif\n"));
          MR_hl_field(MR_mktag(1), backend_libs__export__Var_159, 1) = ((MR_Box) (backend_libs__export__Var_161));
        }
        {
          backend_libs__export__Var_157 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), backend_libs__export__Var_157, 0) = ((MR_Box) ((MR_String) "}\n"));
          MR_hl_field(MR_mktag(1), backend_libs__export__Var_157, 1) = ((MR_Box) (backend_libs__export__Var_159));
        }
        {
          backend_libs__export__Var_155 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), backend_libs__export__Var_155, 0) = ((MR_Box) ((MR_String) "#ifdef __cplusplus\n"));
          MR_hl_field(MR_mktag(1), backend_libs__export__Var_155, 1) = ((MR_Box) (backend_libs__export__Var_157));
        }
        {
          backend_libs__export__Var_152 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), backend_libs__export__Var_152, 0) = ((MR_Box) ((MR_String) "\n"));
          MR_hl_field(MR_mktag(1), backend_libs__export__Var_152, 1) = ((MR_Box) (backend_libs__export__Var_155));
        }
        {
          mercury__io__write_strings_4_p_0(backend_libs__export__FileStream_15, backend_libs__export__Var_152);
        }
        {
