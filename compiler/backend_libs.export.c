...
static MR_bool MR_CALL 
backend_libs__export__IntroducedFrom__pred__foreign_const_name_and_tag__978__1_2_p_0(
  MR_Integer backend_libs__export__Arity_16,
  MR_Integer backend_libs__export__HeadVar__2_66);

static MR_bool MR_CALL 
backend_libs__export__IntroducedFrom__pred__output_exported_c_enum__904__1_2_p_0(
...
{
  {
    ...
    {
      backend_libs__export__succeeded = backend_libs__export__IntroducedFrom__pred__foreign_const_name_and_tag__978__1_2_p_0(((MR_Integer) (MR_hl_field(MR_mktag(0), backend_libs__export__closure, (MR_Integer) 3))), ((MR_Integer) (MR_hl_field(MR_mktag(0), backend_libs__export__closure, (MR_Integer) 4))));
    }
    return backend_libs__export__succeeded;
  }
}
...
{
  {
    ...
    {
      backend_libs__export__succeeded = backend_libs__export__IntroducedFrom__pred__output_exported_c_enum__904__1_2_p_0(((MR_Word) (MR_hl_field(MR_mktag(0), backend_libs__export__closure, (MR_Integer) 3))), ((MR_Word) (MR_hl_field(MR_mktag(0), backend_libs__export__closure, (MR_Integer) 4))));
    }
    return backend_libs__export__succeeded;
  }
}
  ...
  MR_Word backend_libs__export__ExportedEnumInfo_10)
{
  {
    MR_bool backend_libs__export__succeeded;
    MR_Word backend_libs__export__TypeInfo_41_41;
...

    {
      ...
      MR_hl_field(MR_mktag(0), backend_libs__export__Var_24, 0) = ((MR_Box) (&backend_libs__export_scalar_common_4[1]));
    ...
    backend_libs__export__TypeInfo_41_41 = (MR_Word) &backend_libs__export_scalar_common_1[1];
    {
      backend_libs__export__Var_30 = mercury__cord__init_0_f_0(backend_libs__export__TypeInfo_41_41);
    }
    {
    ...
    {
      backend_libs__export__ForeignNamesAndTags_19 = mercury__cord__list_1_f_0(backend_libs__export__TypeInfo_41_41, backend_libs__export__ForeignNamesAndTagsCord_18);
    }
    {
    ...
    {
      mercury__io__write_list_6_p_0(backend_libs__export__TypeInfo_41_41, backend_libs__export__Stream_7, backend_libs__export__ForeignNamesAndTags_19, (MR_String) "\n", (MR_Word) &backend_libs__export_scalar_common_1[3]);
    }
    {
      mercury__io__nl_3_p_0(backend_libs__export__Stream_7);
    }
    {
...
{
  {
    ...
    if (((MR_tag((MR_Word) backend_libs__export__Result_14)) == (MR_mktag((MR_Integer) 1))))
    ...
    else
      {
        ...
        {
          mercury__list__filter_3_p_0(backend_libs__export__TypeCtorInfo_173_173, (MR_Word) &backend_libs__export_scalar_common_3[1], backend_libs__export__ForeignDeclCodes_24, &backend_libs__export__CForeignDeclCodes_26);
        }
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(1), backend_libs__export__Var_164, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &backend_libs__export_scalar_common_2[25])));
        }
        {
