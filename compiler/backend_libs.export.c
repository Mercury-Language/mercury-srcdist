  ...
  MR_Word ModuleName_10)
{
  ...
  parse_tree__file_names__module_name_to_file_name_create_dirs_7_p_0(Globals_12, (MR_String) "predicate \140backend_libs.export.produce_header_file\'/6", (MR_Word) (&backend_libs__export_scalar_common_3[0]), ModuleName_10, &FileName_13);
  {
  ...
  else
  {
    ...
    mercury__library__version_2_p_0(&Version_19, &Fullarch_20);
    {
      ...
      MR_hl_field(1, Var_62, 1) = ((MR_Box) (MR_mkword(1, &backend_libs__export_scalar_common_2[2])));
    }
    {
    ...
    GuardMacroName_23 = mercury__string__f_43_43_2_f_0(UppercaseModuleName_22, (MR_String) "_MH");
    {
      ...
      MR_hl_field(1, Var_77, 1) = ((MR_Box) (MR_mkword(1, &backend_libs__export_scalar_common_2[19])));
    }
    {
    ...
    else
    {
      ...
      Var_127 = backend_libs__foreign__decl_guard_1_f_0(ModuleName_10);
      {
        ...
        MR_hl_field(1, Var_126, 1) = ((MR_Box) (MR_mkword(1, &backend_libs__export_scalar_common_2[3])));
      }
      {
      ...
      mercury__list__foldl_4_p_2((MR_Word) (&hlds__hlds_module__hlds__hlds_module__type_ctor_info_exported_enum_info_0), (MR_Word) (&mercury__io__io__type_ctor_info_state_0), Var_131, CExportedEnums_25, ((MR_Box) ((MR_Integer) 0)), &conv0_STATE_VARIABLE_IO_132_132);
      {
        ...
        MR_hl_field(0, Var_133, 7) = ((MR_Box) (MR_mkword(1, &backend_libs__export_scalar_common_3[1])));
      }
    ...
    backend_libs__export__write_export_decls_4_p_0(FileStream_17, CExportDecls_27);
    {
      ...
      MR_hl_field(1, Var_153, 1) = ((MR_Box) (MR_mkword(1, &backend_libs__export_scalar_common_2[20])));
    }
    {
