  ...
  MR_Word ModuleName_8)
{
  ...
  parse_tree__file_names__module_name_to_file_name_create_dirs_7_p_0(Globals_10, (MR_String) "predicate \140backend_libs.export.produce_header_file\'/5", (MR_Word) (&backend_libs__export_scalar_common_3[0]), ModuleName_8, &FileName_11);
  {
  ...
  else
  {
    ...
    else
    {
      ...
      MaybeSetLineNumbers_28 = backend_libs__c_util__lookup_line_numbers_2_f_0(Globals_10, (MR_Integer) 177);
    ...
    if ((Errors_29 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      ...
      parse_tree__module_cmds__copy_dot_tmp_to_base_file_report_any_error_7_p_0(Globals_10, (MR_String) ".mh", ModuleName_8, FileName_11, &_Succeeded_30);
    }
    else
    {
