...
static const MR_FA_PseudoTypeInfo_Struct2 backend_libs__export__pair__pti_pair_2__plain_hlds__hlds_llds__type_ctor_info_arg_info_0__plain_parse_tree__prog_data__type_ctor_info_mer_type_0;
...
backend_libs__export__IntroducedFrom__pred__foreign_const_name_and_tag__1003__1_2_p_0(
  MR_Integer Arity_13,
  MR_Integer HeadVar__2_62);

static MR_bool MR_CALL 
backend_libs__export__IntroducedFrom__pred__output_exported_c_enum__954__1_2_p_0(
  MR_Word Lang_14,
  MR_Word HeadVar__2_26);

static MR_bool MR_CALL 
backend_libs__export__IntroducedFrom__pred__output_foreign_decl__781__1_2_p_0(
  MR_Word Lang_20,
  MR_Word HeadVar__2_30);

static MR_bool MR_CALL 
backend_libs__export__IntroducedFrom__pred__export_proc_to_c__296__1_2_p_0(
  MR_Word Lang_9,
...
static /* final */ const MR_Box backend_libs__export_scalar_common_4[5][5] = {
  /* row   0 */
  {
    ...
    ((MR_Box) (&backend_libs__export__pair__pti_pair_2__plain_hlds__hlds_llds__type_ctor_info_arg_info_0__plain_parse_tree__prog_data__type_ctor_info_mer_type_0))
  },
  /* row   1 */
  {
    NULL,
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = backend_libs__export__IntroducedFrom__pred__foreign_const_name_and_tag__1003__1_2_p_0(((MR_Integer) ((MR_hl_field(0, closure, 3)))), ((MR_Integer) ((MR_hl_field(0, closure, 4)))));
  return succeeded;
}
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = backend_libs__export__IntroducedFrom__pred__output_exported_c_enum__954__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) ((MR_hl_field(0, closure, 4)))));
  return succeeded;
}
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = backend_libs__export__IntroducedFrom__pred__output_foreign_decl__781__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) ((MR_hl_field(0, closure, 4)))));
  return succeeded;
}
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = backend_libs__export__IntroducedFrom__pred__export_proc_to_c__296__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) ((MR_hl_field(0, closure, 4)))));
  return succeeded;
}
  ...
  MR_Word * ArgInfoTypes_20)
{
  ...
  mercury__assoc_list__from_corresponding_lists_3_p_0((MR_Word) (&hlds__hlds_llds__hlds__hlds_llds__type_ctor_info_arg_info_0), (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0), ArgInfos_30, ArgTypes_28, &ArgInfoTypes0_33);
  switch (CodeModel_32) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 0:
      {
