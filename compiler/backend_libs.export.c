...
static MR_bool MR_CALL 
backend_libs__export__IntroducedFrom__pred__output_exported_c_enum__933__1_2_p_0(
  MR_Word Lang_14,
  MR_Word HeadVar__2_26);

static MR_bool MR_CALL 
backend_libs__export__IntroducedFrom__pred__output_foreign_decl__873__1_2_p_0(
  MR_Word Lang_16,
  MR_Word HeadVar__2_26);
...
backend_libs__export__foreign_const_name_and_tag_4_p_0(
  MR_Word Mapping_5,
  MR_Word CtorRepn_6,
  MR_Word STATE_VARIABLE_NamesAndTagsCord_0_61,
  MR_Word * STATE_VARIABLE_NamesAndTagsCord_62);
...
{
  {
    MR_bool succeeded = (Arity_13 == HeadVar__2_66);
...
{
  {
    ...
    succeeded = backend_libs__export__IntroducedFrom__pred__foreign_const_name_and_tag__982__1_2_p_0(((MR_Integer) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Integer) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))));
    return succeeded;
  }
}
...
{
  {
...

    {
      ...
      MR_hl_field(MR_mktag(0), Var_63, 0) = ((MR_Box) (&backend_libs__export_scalar_common_3[3]));
      MR_hl_field(MR_mktag(0), Var_63, 1) = ((MR_Box) (backend_libs__export__foreign_const_name_and_tag_4_p_0_1));
      MR_hl_field(MR_mktag(0), Var_63, 2) = ((MR_Box) (MR_Word) ((MR_Integer) 2));
      MR_hl_field(MR_mktag(0), Var_63, 3) = ((MR_Box) (Arity_13));
      MR_hl_field(MR_mktag(0), Var_63, 4) = ((MR_Box) ((MR_Integer) 0));
    }
    mercury__require__expect_3_p_0(Var_63, (MR_String) "predicate \140backend_libs.export.foreign_const_name_and_tag\'/4", (MR_String) "enum constant arity != 0");
    ...
    switch (MR_tag((MR_Word) ConsTag_11)) {
      ...
      case (MR_Integer) 3:
        switch (((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), ConsTag_11, (MR_Integer) 0)))) {
          ...
          case (MR_Integer) 0:
            {
              MR_Word IntTag_17 = ((MR_Word) ((MR_hl_field(MR_mktag(3), ConsTag_11, (MR_Integer) 1))));
    ...
    *STATE_VARIABLE_NamesAndTagsCord_62 = mercury__cord__snoc_2_f_0((MR_Word) (&backend_libs__export__backend_libs__export__type_ctor_info_exported_enum_name_and_tag_rep_0), STATE_VARIABLE_NamesAndTagsCord_0_61, ((MR_Box) (NameAndTag_19)));
  }
}
  ...
  MR_Box * wrapper_arg_3)
{
  {
    MR_Box closure = closure_arg;
    MR_Word conv0_STATE_VARIABLE_NamesAndTagsCord_62;

    backend_libs__export__foreign_const_name_and_tag_4_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) (wrapper_arg_1)), ((MR_Word) (wrapper_arg_2)), &conv0_STATE_VARIABLE_NamesAndTagsCord_62);
    *wrapper_arg_3 = ((MR_Box) (conv0_STATE_VARIABLE_NamesAndTagsCord_62));
  }
}
...
{
  {
    ...
    succeeded = backend_libs__export__IntroducedFrom__pred__output_exported_c_enum__933__1_2_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))));
    return succeeded;
  }
}
...
{
  {
    ...
    succeeded = backend_libs__export__IntroducedFrom__pred__output_foreign_decl__873__1_2_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))));
    return succeeded;
  }
}
...
{
  {
    ...
    if ((MaybeDesiredIsLocal_13 == (MR_Word) ((MR_Unsigned) 0U)))
      succeeded = MR_TRUE;
    else
    {
...
{
  {
    ...
    else
    {
      ...
      if (!(succeeded))
      {
        ...
        MaybeSetLineNumbers_27 = backend_libs__c_util__lookup_line_numbers_2_f_0(Globals_10, (MR_Integer) 153);
        ...
        mercury__list__foldl_4_p_2((MR_Word) (&hlds__hlds_module__hlds__hlds_module__type_ctor_info_exported_enum_info_0), (MR_Word) (&mercury__io__io__type_ctor_info_state_0), Var_142, CExportedEnums_23, ((MR_Box) ((MR_Integer) 0)), &conv0_STATE_VARIABLE_IO_143_143);
        {
        ...
        mercury__list__foldl_4_p_2((MR_Word) (&parse_tree__prog_foreign__parse_tree__prog_foreign__type_ctor_info_foreign_decl_code_0), (MR_Word) (&mercury__io__io__type_ctor_info_state_0), Var_144, CForeignDeclCodes_26, ((MR_Box) ((MR_Integer) 0)), &conv1_STATE_VARIABLE_IO_145_145);
