...
MR_decl_label10(backend_libs__export__to_c_4_0, 90,5,6,7,8,9,10,11,12,13)
...
MR_BEGIN_MODULE(backend_libs__export_module8)
	...
	MR_init_label10(backend_libs__export__to_c_4_0,90,5,6,7,8,9,10,11,12,13)
...
MR_def_static(backend_libs__export__to_c_4_0)
	...
	if (MR_LTAGS_TESTR(MR_r2,0,0)) {
		MR_GOTO_LAB(backend_libs__export__to_c_4_0_i90);
	}
	MR_r1 = (MR_Word) MR_tbmkword(0, 0);
	MR_proceed();
MR_def_label(backend_libs__export__to_c_4_0,90)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(14);
