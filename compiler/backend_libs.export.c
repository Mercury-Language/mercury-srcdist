...
MR_decl_static(backend_libs__export__IntroducedFrom__pred__foreign_const_name_and_tag__918__1_2_0)
...
MR_def_label(backend_libs__export__foreign_const_name_and_tag_6_0,4)
	...
	MR_tfield(0, MR_r1, 1) = (MR_Word) MR_ENTRY_AP(backend_libs__export__IntroducedFrom__pred__foreign_const_name_and_tag__918__1_2_0);
...
MR_BEGIN_MODULE(backend_libs__export_module21)
	MR_init_entry1(backend_libs__export__IntroducedFrom__pred__foreign_const_name_and_tag__918__1_2_0);
	MR_INIT_PROC_LAYOUT_ADDR(mercury__backend_libs__export__IntroducedFrom__pred__foreign_const_name_and_tag__918__1_2_0);
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'IntroducedFrom__pred__foreign_const_name_and_tag__918__1'/2 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(backend_libs__export__IntroducedFrom__pred__foreign_const_name_and_tag__918__1_2_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_r1 == MR_r2);
	MR_proceed();
#ifdef MR_maybe_local_thread_engine_base
