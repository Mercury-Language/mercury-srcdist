  ...
  else
  {
    ...
    else
    {
      ...
      mercury__list__foldl_4_p_2((MR_Word) (&hlds__hlds_module__hlds__hlds_module__type_ctor_info_exported_enum_info_0), (MR_Word) (&mercury__io__io__type_ctor_info_state_0), Var_130, CExportedEnums_24, ((MR_Box) ((MR_Integer) 0)), &conv0_STATE_VARIABLE_IO_7_131);
      {
        ...
        MR_hl_field(0, Var_132, 4) = ((MR_Box) (MaybeSetLineNumbers_29));
        MR_hl_field(0, Var_132, 5) = ((MR_Box) (MaybeThisFileName_13));
        MR_hl_field(0, Var_132, 6) = ((MR_Box) (SourceFileName_17));
        MR_hl_field(0, Var_132, 7) = ((MR_Box) (MR_mkword(1, &backend_libs__export_scalar_common_3[0])));
      }
