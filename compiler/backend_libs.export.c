...
backend_libs__export__foreign_const_name_and_tag_6_p_0(
  ...
  MR_Word TagValues_9,
  MR_Word Ctor_10,
  MR_Word STATE_VARIABLE_NamesAndTagsCord_0_66,
  MR_Word * STATE_VARIABLE_NamesAndTagsCord_67);
...
{
  {
    MR_bool succeeded = (Arity_16 == HeadVar__2_78);
...
{
  {
    ...
    MR_Word TagVal_19;
    MR_Word Tag_22;
    MR_Word UnqualifiedCtorName_64;
    ...
    switch (MR_tag((MR_Word) TagVal_19)) {
      ...
      case (MR_Integer) 3:
        switch (((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), TagVal_19, (MR_Integer) 0)))) {
          ...
          case (MR_Integer) 1:
            {
              MR_String ForeignTag_33 = ((MR_String) (MR_hl_field(MR_mktag(3), TagVal_19, (MR_Integer) 2)));
              MR_Word _ForeignLang_32 = ((MR_Word) (MR_hl_field(MR_mktag(3), TagVal_19, (MR_Integer) 1)));

              {
                Tag_22 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(1), Tag_22, 0) = ((MR_Box) (ForeignTag_33));
              }
            }
            break;
          case (MR_Integer) 2:
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(0), Var_74, 0) = ((MR_Box) (&backend_libs__export_scalar_common_3[3]));
      MR_hl_field(MR_mktag(0), Var_74, 1) = ((MR_Box) (backend_libs__export__foreign_const_name_and_tag_6_p_0_1));
      MR_hl_field(MR_mktag(0), Var_74, 2) = ((MR_Box) (MR_Word) ((MR_Integer) 2));
      MR_hl_field(MR_mktag(0), Var_74, 3) = ((MR_Box) (Arity_16));
      MR_hl_field(MR_mktag(0), Var_74, 4) = ((MR_Box) ((MR_Integer) 0));
    }
    mercury__require__expect_4_p_0(Var_74, (MR_String) "backend_libs.export", (MR_String) "predicate \140backend_libs.export.foreign_const_name_and_tag\'/6", (MR_String) "enum constant arity != 0");
    Var_79 = mdbcomp__sym_name__unqualify_name_1_f_0(QualifiedCtorName_14);
    {
      UnqualifiedCtorName_64 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), UnqualifiedCtorName_64, 0) = ((MR_Box) (Var_79));
    }
    mercury__map__lookup_3_p_0((MR_Word) &mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0, (MR_Word) &mercury__builtin__builtin__type_ctor_info_string_0, Mapping_8, ((MR_Box) (UnqualifiedCtorName_64)), &conv1_ForeignName_65);
    ForeignName_65 = ((MR_String) conv1_ForeignName_65);
    {
      Var_81 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), Var_81, 0) = ((MR_Box) (ForeignName_65));
      MR_hl_field(MR_mktag(0), Var_81, 1) = ((MR_Box) (Tag_22));
    }
    *STATE_VARIABLE_NamesAndTagsCord_67 = mercury__cord__snoc_2_f_0((MR_Word) &backend_libs__export_scalar_common_1[1], STATE_VARIABLE_NamesAndTagsCord_0_66, ((MR_Box) (Var_81)));
  }
}
  ...
  MR_Box * wrapper_arg_3)
{
  {
    MR_Box closure = closure_arg;
    MR_Word conv0_STATE_VARIABLE_NamesAndTagsCord_67;

    backend_libs__export__foreign_const_name_and_tag_6_p_0(((MR_Word) (MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3))), ((MR_Word) (MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4))), ((MR_Word) (MR_hl_field(MR_mktag(0), closure, (MR_Integer) 5))), ((MR_Word) wrapper_arg_1), ((MR_Word) wrapper_arg_2), &conv0_STATE_VARIABLE_NamesAndTagsCord_67);
    *wrapper_arg_3 = ((MR_Box) (conv0_STATE_VARIABLE_NamesAndTagsCord_67));
  }
}
