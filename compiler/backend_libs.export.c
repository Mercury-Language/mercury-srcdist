...
backend_libs__export__IntroducedFrom__pred__foreign_const_name_and_tag__1031__1_2_p_0(
  MR_Integer Arity_15,
  MR_Integer HeadVar__2_77);

static MR_bool MR_CALL 
backend_libs__export__IntroducedFrom__pred__output_exported_c_enum__936__1_2_p_0(
  MR_Word Lang_12,
  MR_Word HeadVar__2_28);

static MR_bool MR_CALL 
backend_libs__export__IntroducedFrom__pred__output_foreign_decl__875__1_2_p_0(
  MR_Word Lang_16,
...
backend_libs__export__foreign_const_name_and_tag_6_p_0(
  MR_Word TypeCtor_7,
  MR_Word Mapping_8,
  MR_Word ConsIdToTagMap_9,
  MR_Word Ctor_10,
  MR_Word STATE_VARIABLE_NamesAndTagsCord_0_65,
  MR_Word * STATE_VARIABLE_NamesAndTagsCord_66);
...
{
  {
    MR_bool succeeded = (Arity_15 == HeadVar__2_77);
...
{
  {
    ...
    succeeded = backend_libs__export__IntroducedFrom__pred__foreign_const_name_and_tag__1031__1_2_p_0(((MR_Integer) (MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3))), ((MR_Integer) (MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4))));
    return succeeded;
  }
}
  ...
  MR_Word * STATE_VARIABLE_NamesAndTagsCord_66)
{
  {
    MR_bool succeeded;
    MR_Word QualifiedCtorName_13 = ((MR_Word) (MR_hl_field(MR_mktag(0), Ctor_10, (MR_Integer) 1)));
    MR_Integer Arity_15 = ((MR_Integer) (MR_hl_field(MR_mktag(0), Ctor_10, (MR_Integer) 3)));
    MR_Word ConsId_17;
    MR_Word TagVal_18;
    MR_Word Tag_21;
    MR_Word UnqualifiedCtorName_63;
    MR_String ForeignName_64;
    MR_Word Var_73;
    MR_String Var_78;
    MR_Word Var_80;
    MR_Word Var_12 = ((MR_Word) (MR_hl_field(MR_mktag(0), Ctor_10, (MR_Integer) 0)));
    MR_Word _Args_14 = ((MR_Word) (MR_hl_field(MR_mktag(0), Ctor_10, (MR_Integer) 2)));
    MR_Word Var_16 = ((MR_Word) (MR_hl_field(MR_mktag(0), Ctor_10, (MR_Integer) 4)));
    MR_Box conv0_TagVal_18;
    MR_Box conv1_ForeignName_64;

    {
      ...
      MR_hl_field(MR_mktag(3), ConsId_17, 1) = ((MR_Box) (QualifiedCtorName_13));
      MR_hl_field(MR_mktag(3), ConsId_17, 2) = ((MR_Box) (Arity_15));
      MR_hl_field(MR_mktag(3), ConsId_17, 3) = ((MR_Box) (TypeCtor_7));
    }
    mercury__map__lookup_3_p_0((MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_cons_id_0, (MR_Word) &hlds__hlds_data__hlds__hlds_data__type_ctor_info_cons_tag_0, ConsIdToTagMap_9, ((MR_Box) (ConsId_17)), &conv0_TagVal_18);
    TagVal_18 = ((MR_Word) conv0_TagVal_18);
    switch (MR_tag((MR_Word) TagVal_18)) {
      ...
      case (MR_Integer) 2:
        ...
        break;
      case (MR_Integer) 3:
        switch (((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), TagVal_18, (MR_Integer) 0)))) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 0:
            {
              MR_Word IntTagType_19 = ((MR_Word) (MR_hl_field(MR_mktag(3), TagVal_18, (MR_Integer) 1)));

              switch (MR_tag((MR_Word) IntTagType_19)) {
                default: /*NOTREACHED*/ MR_assert(0);
                case (MR_Integer) 0:
                  {
                    MR_Integer IntTag_20 = ((MR_Integer) (MR_hl_field(MR_mktag(0), IntTagType_19, (MR_Integer) 0)));

                    {
                      Tag_21 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL);
                      MR_hl_field(MR_mktag(0), Tag_21, 0) = ((MR_Box) (IntTag_20));
                    }
                  }
                  break;
                case (MR_Integer) 1:
          ...
          case (MR_Integer) 1:
            {
              MR_String ForeignTag_32 = ((MR_String) (MR_hl_field(MR_mktag(3), TagVal_18, (MR_Integer) 2)));
              MR_Word _ForeignLang_31 = ((MR_Word) (MR_hl_field(MR_mktag(3), TagVal_18, (MR_Integer) 1)));

              {
                Tag_21 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(1), Tag_21, 0) = ((MR_Box) (ForeignTag_32));
              }
            }
            break;
          case (MR_Integer) 2:
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(0), Var_73, 0) = ((MR_Box) (&backend_libs__export_scalar_common_3[3]));
      MR_hl_field(MR_mktag(0), Var_73, 1) = ((MR_Box) (backend_libs__export__foreign_const_name_and_tag_6_p_0_1));
      MR_hl_field(MR_mktag(0), Var_73, 2) = ((MR_Box) (MR_Word) ((MR_Integer) 2));
      MR_hl_field(MR_mktag(0), Var_73, 3) = ((MR_Box) (Arity_15));
      MR_hl_field(MR_mktag(0), Var_73, 4) = ((MR_Box) ((MR_Integer) 0));
    }
    mercury__require__expect_4_p_0(Var_73, (MR_String) "backend_libs.export", (MR_String) "predicate \140backend_libs.export.foreign_const_name_and_tag\'/6", (MR_String) "enum constant arity != 0");
    Var_78 = mdbcomp__sym_name__unqualify_name_1_f_0(QualifiedCtorName_13);
    {
      UnqualifiedCtorName_63 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), UnqualifiedCtorName_63, 0) = ((MR_Box) (Var_78));
    }
    mercury__map__lookup_3_p_0((MR_Word) &mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0, (MR_Word) &mercury__builtin__builtin__type_ctor_info_string_0, Mapping_8, ((MR_Box) (UnqualifiedCtorName_63)), &conv1_ForeignName_64);
    ForeignName_64 = ((MR_String) conv1_ForeignName_64);
    {
      Var_80 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), Var_80, 0) = ((MR_Box) (ForeignName_64));
      MR_hl_field(MR_mktag(0), Var_80, 1) = ((MR_Box) (Tag_21));
    }
    *STATE_VARIABLE_NamesAndTagsCord_66 = mercury__cord__snoc_2_f_0((MR_Word) &backend_libs__export_scalar_common_1[1], STATE_VARIABLE_NamesAndTagsCord_0_65, ((MR_Box) (Var_80)));
  }
}
  ...
  MR_Box * wrapper_arg_3)
{
  {
    MR_Box closure = closure_arg;
    MR_Word conv0_STATE_VARIABLE_NamesAndTagsCord_66;

    backend_libs__export__foreign_const_name_and_tag_6_p_0(((MR_Word) (MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3))), ((MR_Word) (MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4))), ((MR_Word) (MR_hl_field(MR_mktag(0), closure, (MR_Integer) 5))), ((MR_Word) wrapper_arg_1), ((MR_Word) wrapper_arg_2), &conv0_STATE_VARIABLE_NamesAndTagsCord_66);
    *wrapper_arg_3 = ((MR_Box) (conv0_STATE_VARIABLE_NamesAndTagsCord_66));
  }
}
...
{
  {
    ...
    succeeded = backend_libs__export__IntroducedFrom__pred__output_exported_c_enum__936__1_2_p_0(((MR_Word) (MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3))), ((MR_Word) (MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4))));
    return succeeded;
  }
}
...
{
  {
    ...
    MR_Word ConsIdToTagMap_17 = ((MR_Word) (MR_hl_field(MR_mktag(0), ExportedEnumInfo_10, (MR_Integer) 5)));
    ...
    mercury__require__expect_4_p_0(Var_24, (MR_String) "backend_libs.export", (MR_String) "predicate \140backend_libs.export.output_exported_c_enum\'/6", (MR_String) "Lang != lang_c");
    {
      ...
      MR_hl_field(MR_mktag(0), Var_29, 5) = ((MR_Box) (ConsIdToTagMap_17));
    }
...
{
  {
    ...
    succeeded = backend_libs__export__IntroducedFrom__pred__output_foreign_decl__875__1_2_p_0(((MR_Word) (MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3))), ((MR_Word) (MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4))));
    return succeeded;
  }
}
