  ...
  MR_Word ModuleName_8)
{
  ...
  parse_tree__file_names__module_name_to_file_name_create_dirs_7_p_0(Globals_10, (MR_String) "predicate \140backend_libs.export.produce_header_file\'/5", (MR_Word) (MR_mkword(3, &backend_libs__export_scalar_common_2[1])), ModuleName_8, &FileName_11);
  {
