...
backend_libs__export__IntroducedFrom__pred__foreign_const_name_and_tag__984__1_2_p_0(
  MR_Integer Arity_12,
  MR_Integer HeadVar__2_63);

static MR_bool MR_CALL 
backend_libs__export__IntroducedFrom__pred__output_exported_c_enum__935__1_2_p_0(
  MR_Word Lang_12,
...
{
  {
    ...
    succeeded = backend_libs__export__IntroducedFrom__pred__foreign_const_name_and_tag__984__1_2_p_0(((MR_Integer) (MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3))), ((MR_Integer) (MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4))));
    return succeeded;
  }
}
  ...
  MR_Word * STATE_VARIABLE_NamesAndTagsCord_59)
{
  {
    MR_bool succeeded;
    MR_Word QualSymName_9 = ((MR_Word) (MR_hl_field(MR_mktag(0), CtorRepn_6, (MR_Integer) 1)));
    ...
    Name_14 = mdbcomp__sym_name__unqualify_name_1_f_0(QualSymName_9);
    {
      UnqualSymName_15 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), UnqualSymName_15, 0) = ((MR_Box) (Name_14));
    }
    mercury__map__lookup_3_p_0((MR_Word) &mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0, (MR_Word) &mercury__builtin__builtin__type_ctor_info_string_0, Mapping_5, ((MR_Box) (UnqualSymName_15)), &conv0_ForeignName_16);
    ...
    switch (MR_tag((MR_Word) ConsTag_10)) {
      ...
      case (MR_Integer) 3:
        switch (((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), ConsTag_10, (MR_Integer) 0)))) {
          ...
          case (MR_Integer) 0:
            {
              MR_Word IntTag_17 = ((MR_Word) (MR_hl_field(MR_mktag(3), ConsTag_10, (MR_Integer) 1)));
          ...
          case (MR_Integer) 1:
            {
              MR_String ForeignTag_30 = ((MR_String) (MR_hl_field(MR_mktag(3), ConsTag_10, (MR_Integer) 2)));
              MR_Word _ForeignLang_29 = ((MR_Word) (MR_hl_field(MR_mktag(3), ConsTag_10, (MR_Integer) 1)));
...
{
  {
    ...
    succeeded = backend_libs__export__IntroducedFrom__pred__output_exported_c_enum__935__1_2_p_0(((MR_Word) (MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3))), ((MR_Word) (MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4))));
    return succeeded;
  }
}
...
{
  {
    ...
    MR_Word CtorRepns_16 = ((MR_Word) (MR_hl_field(MR_mktag(0), ExportedEnumInfo_10, (MR_Integer) 4)));
    ...
    MR_Word Var_27;
    MR_Word Var_28;
    MR_Word _TypeCtor_14 = ((MR_Word) (MR_hl_field(MR_mktag(0), ExportedEnumInfo_10, (MR_Integer) 2)));
    ...
    mercury__list__foldl_4_p_0((MR_Word) &hlds__hlds_data__hlds__hlds_data__type_ctor_info_constructor_repn_0, (MR_Word) &backend_libs__export_scalar_common_2[0], Var_27, CtorRepns_16, ((MR_Box) (Var_28)), &conv1_ForeignNamesAndTagsCord_17);
    ...
    mercury__term__context_file_2_p_0(Context_13, &File_19);
    mercury__term__context_line_2_p_0(Context_13, &Line_20);
      ...
      case (MR_Integer) 0:
        {
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              Var_59 = check_hlds__type_util__check_dummy_type_2_f_0(ModuleInfo_11, RetType_37);
