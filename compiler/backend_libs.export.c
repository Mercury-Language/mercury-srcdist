          ...
          case (MR_Integer) 1:
            {
              ...
              MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), ConsTag_11, (MR_Integer) 1)));
...
{
  {
    ...
    MR_Word Var_27;
    MR_Word Var_28;
    MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), ExportedEnumInfo_10, (MR_Integer) 2)));
...
{
  {
    ...
    MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), ExportedEnumInfo_2, (MR_Integer) 2)));
...
{
  {
    ...
    MR_Word Var_25;
    MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), DeclCode_15, (MR_Integer) 0)));
  ...
  MR_Word HeadVar__2_2)
{
  while (MR_TRUE)
  {
    ...
    if (!((HeadVar__2_2 == (MR_Word) ((MR_Unsigned) 0U))))
    {
      ...
      MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), ExportDecl_10, (MR_Integer) 0)));
      MR_Word next_value_of_HeadVar__2_2;
...
{
  {
    ...
    MR_Word Var_140;
    MR_Word Var_142;
    MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), ExportedProc_7, (MR_Integer) 0)));
...
{
  {
    ...
    else
    {
      ...
      MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), ArgInfo_12, (MR_Integer) 1)));
        ...
        case (MR_Integer) 1:
          {
            ...
            packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), ArgLoc_14, (MR_Integer) 0)));
              ...
              case (MR_Integer) 0:
                {
                  ...
                  MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), TargetArgLoc_7, (MR_Integer) 0)));
          ...
          case (MR_Integer) 1:
            {
              ...
              MR_Unsigned packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), BuiltinType_9, (MR_Integer) 0)));
  ...
  MR_Word * HeadVar__4_4)
{
  ...
  else
  {
    ...
    MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), HeadExportedProc_9, (MR_Integer) 0)));
  ...
  MR_String * HeadVar__5_5)
{
  ...
  else
  {
    ...
    MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), ArgInfo_15, (MR_Integer) 1)));
      ...
      case (MR_Integer) 0:
        {
          ...
          if (succeeded)
          {
            ...
            packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Var_57, (MR_Integer) 1)));
          ...
          if (succeeded)
          {
            ...
            *CRetType_16 = backend_libs__foreign__maybe_foreign_type_to_c_string_2_f_0(RetType_37, MaybeForeignRetType_38);
            packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), RetArgLoc_35, (MR_Integer) 0)));
              ...
              case (MR_Integer) 0:
                {
                  ...
                  MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), SourceArgLoc_5, (MR_Integer) 0)));
