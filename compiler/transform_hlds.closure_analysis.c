  ...
  MR_Box * wrapper_arg_3)
{
  ...
  transform_hlds__closure_analysis__IntroducedFrom__pred__dump_ho_value_map_entry__528__1_4_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) (wrapper_arg_1)));
}
  ...
  MR_Box * wrapper_arg_2)
{
  ...
  succeeded = transform_hlds__closure_analysis__IntroducedFrom__pred__closure_analyse_goal__339__1_3_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) (wrapper_arg_1)), &conv0_LambdaHeadVar__2_147);
  if (succeeded)
  {
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_11)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_6, (MR_Integer) 709, &Debug_7);
