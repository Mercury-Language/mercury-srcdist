  ...
  MR_Box * wrapper_arg_2)
{
  ...
  succeeded = transform_hlds__closure_analysis__IntroducedFrom__pred__closure_analyse_goal__339__1_3_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) (wrapper_arg_1)), &conv0_LambdaHeadVar__2_147);
  if (succeeded)
  {
  ...
  MR_Word * STATE_VARIABLE_ClosureInfo_116)
{
  ...
  switch (MR_tag((MR_Word) GoalExpr0_12)) {
    ...
    case (MR_Integer) 1:
      {
        MR_Word Unification_55 = ((MR_Word) ((MR_hl_field(1, GoalExpr0_12, (MR_Integer) 3))));

        switch (MR_tag((MR_Word) Unification_55)) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 0:
            {
              MR_Word LHS_57 = ((MR_Word) ((MR_hl_field(0, Unification_55, (MR_Integer) 0))));
              MR_Word RHS_58 = ((MR_Word) ((MR_hl_field(0, Unification_55, (MR_Integer) 1))));
          ...
          case (MR_Integer) 1:
            {
              MR_Word Args_69 = ((MR_Word) ((MR_hl_field(1, Unification_55, (MR_Integer) 2))));
              MR_Word HO_Args_73;
              MR_Word Var_135;
          ...
          case (MR_Integer) 2:
            {
              MR_Word LHS_158 = ((MR_Word) ((MR_hl_field(2, Unification_55, (MR_Integer) 0))));
              MR_Word RHS_159 = ((MR_Word) ((MR_hl_field(2, Unification_55, (MR_Integer) 1))));
            ...
            break;
          case (MR_Integer) 3:
            switch (((MR_Integer) ((MR_hl_field(3, Unification_55, (MR_Integer) 0))))) {
              default: /*NOTREACHED*/ MR_assert(0);
              case (MR_Integer) 0:
                *STATE_VARIABLE_ClosureInfo_116 = STATE_VARIABLE_ClosureInfo_0_115;
                break;
    ...
    case (MR_Integer) 3:
      switch (((MR_Integer) ((MR_hl_field(3, GoalExpr0_12, (MR_Integer) 0))))) {
        ...
        case (MR_Integer) 4:
          {
            MR_Word SwitchVar_48 = ((MR_Word) ((MR_hl_field(3, GoalExpr0_12, (MR_Integer) 1))));
            MR_Word SwitchCanFail_49 = ((MR_Unsigned) ((MR_hl_field(3, GoalExpr0_12, (MR_Integer) 2))) & (MR_Integer) 1);
            MR_Word Cases0_50 = ((MR_Word) ((MR_hl_field(3, GoalExpr0_12, (MR_Integer) 3))));
            MR_Word Cases_51;
            MR_Word Var_131;
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_11)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_6, (MR_Integer) 127, &Debug_7);
