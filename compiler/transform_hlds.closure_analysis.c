...
{
  {
    ...
    hlds__passes_aux__write_proc_progress_message_5_p_0((MR_String) "% Analysing closures in ", PPId_6, STATE_VARIABLE_ModuleInfo_0_22);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_4, (MR_Integer) 100, &Debug_5);
