  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_23)
{
  ...
  transform_hlds__closure_analysis__partition_higher_order_arguments_8_p_0(STATE_VARIABLE_ModuleInfo_0_22, VarTypes_12, HeadVars_10, ArgModes_13, Var_39, &Inputs0_36, Var_40, &_Outputs_37);
  {
    Var_41 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(MR_mktag(0), Var_41, 0) = ((MR_Box) (&transform_hlds__closure_analysis_scalar_common_6[0]));
    MR_hl_field(MR_mktag(0), Var_41, 1) = ((MR_Box) (transform_hlds__closure_analysis__closure_analyse_proc_4_p_0_1));
    MR_hl_field(MR_mktag(0), Var_41, 2) = ((MR_Box) ((MR_Integer) 1));
    MR_hl_field(MR_mktag(0), Var_41, 3) = ((MR_Box) (VarTypes_12));
  }
  Inputs_38 = parse_tree__set_of_var__filter_2_f_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), Var_41, Inputs0_36);
  ...
  parse_tree__set_of_var__fold_4_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), (MR_Word) (&transform_hlds__closure_analysis_scalar_common_2[0]), (MR_Word) (&transform_hlds__closure_analysis_scalar_common_2[10]), Inputs_38, ((MR_Box) (Var_43)), &conv1_ClosureInfo0_14);
  ...
  MR_Word * STATE_VARIABLE_MergedCaseClosureInfo_7)
{
  ...
  else
  {
    ...
    MR_Word MainConsId_32 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Case0_16, (MR_Integer) 0))));
    MR_Word OtherConsIds_33 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Case0_16, (MR_Integer) 1))));
    MR_Word CaseGoal0_34 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Case0_16, (MR_Integer) 2))));
    MR_Word CaseGoal_35;

    transform_hlds__closure_analysis__closure_analyse_goal_6_p_0(ModuleInfo_1, VarTypes_2, CaseGoal0_34, &CaseGoal_35, ClosureInfo0_5, &CaseClosureInfo_22);
    {
      Case_18 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), Case_18, 0) = ((MR_Box) (MainConsId_32));
      MR_hl_field(MR_mktag(0), Case_18, 1) = ((MR_Box) (OtherConsIds_33));
      MR_hl_field(MR_mktag(0), Case_18, 2) = ((MR_Box) (CaseGoal_35));
    }
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      else
      {
        ...
        parse_tree__vartypes__lookup_var_type_3_p_0(VarTypes_2, Var_56, &Type_59);
  ...
  MR_Word Var_4)
{
  ...
  parse_tree__vartypes__lookup_var_type_3_p_0(VarTypes_3, Var_4, &Type_5);
