...
MR_decl_label8(transform_hlds__closure_analysis__merge_closure_values_3_0, 30,28,15,87,3,91,9,90)
MR_decl_label2(transform_hlds__closure_analysis__merge_closure_values_3_0, 6,88)
...
MR_def_label(transform_hlds__closure_analysis__process_goal_6_0,3)
	...
	MR_sv(4) = (MR_Word) MR_CTOR0_ADDR(transform_hlds__closure_analysis, closure_values);
...
MR_BEGIN_MODULE(transform_hlds__closure_analysis_module12)
	...
	MR_init_label8(transform_hlds__closure_analysis__merge_closure_values_3_0,30,28,15,87,3,91,9,90)
	MR_init_label2(transform_hlds__closure_analysis__merge_closure_values_3_0,6,88)
MR_BEGIN_CODE
...
/*-------------------------------------------------------------------------*/
/* code for 'IntroducedFrom__pred__process_goal__363__1'/3 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
...
/*-------------------------------------------------------------------------*/
/* code for 'IntroducedFrom__func__process_goal__325__1'/5 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
...
/*-------------------------------------------------------------------------*/
/* code for 'IntroducedFrom__func__dump_closure_info_expr__449__1'/2 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
...
/*-------------------------------------------------------------------------*/
/* code for 'IntroducedFrom__pred__dump_ho_value__482__1'/3 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
