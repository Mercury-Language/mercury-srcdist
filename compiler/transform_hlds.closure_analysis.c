...
static void MR_CALL 
transform_hlds__closure_analysis__IntroducedFrom__pred__dump_ho_value__507__1_3_p_0(
...
{
  {
    ...
    transform_hlds__closure_analysis__IntroducedFrom__pred__dump_ho_value__507__1_3_p_0(((MR_Word) (wrapper_arg_1)));
  }
}
...
{
  {
    ...
    if (!(succeeded))
    {
      ...
      parse_tree__prog_out__write_context_to_cur_stream_3_p_0(Var_11);
      mercury__io__nl_2_p_0();
      {
          ...
          case (MR_Integer) 0:
            {
              ...
              succeeded = ((MR_tag((MR_Word) Details_37)) == (MR_Integer) 1);
              if (succeeded)
              {
                CalledClosure0_43 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Details_37, (MR_Integer) 0))));
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_4, (MR_Integer) 96, &Debug_5);
