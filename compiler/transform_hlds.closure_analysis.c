...
MR_decl_label3(__Unify___transform_hlds__closure_analysis__closure_values_0_0, 8,4,1)
MR_decl_label5(__Compare___transform_hlds__closure_analysis__closure_values_0_0, 10,4,27,9,7)
...
MR_BEGIN_MODULE(transform_hlds__closure_analysis_module16)
	...
	MR_init_label3(__Unify___transform_hlds__closure_analysis__closure_values_0_0,8,4,1)
MR_BEGIN_CODE
...
MR_def_static(__Unify___transform_hlds__closure_analysis__closure_values_0_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TEST(MR_r1,1)) {
		MR_GOTO_LAB(__Unify___transform_hlds__closure_analysis__closure_values_0_0_i4);
	}
	if (MR_PTAG_TEST(MR_r1,2)) {
		MR_GOTO_LAB(__Unify___transform_hlds__closure_analysis__closure_values_0_0_i8);
	}
	MR_r1 = (MR_r2 == MR_r1);
	MR_proceed();
MR_def_label(__Unify___transform_hlds__closure_analysis__closure_values_0_0,8)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_r2,2)) {
...
MR_def_label(__Unify___transform_hlds__closure_analysis__closure_values_0_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_BEGIN_MODULE(transform_hlds__closure_analysis_module17)
	...
	MR_init_label5(__Compare___transform_hlds__closure_analysis__closure_values_0_0,10,4,27,9,7)
MR_BEGIN_CODE
...
MR_def_static(__Compare___transform_hlds__closure_analysis__closure_values_0_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TEST(MR_r1,1)) {
		MR_GOTO_LAB(__Compare___transform_hlds__closure_analysis__closure_values_0_0_i4);
	}
	if (MR_PTAG_TEST(MR_r1,2)) {
		MR_GOTO_LAB(__Compare___transform_hlds__closure_analysis__closure_values_0_0_i10);
	}
	if (MR_PTAG_TEST(MR_r2,1)) {
	...
	MR_r1 = (MR_Integer) 0;
	MR_proceed();
MR_def_label(__Compare___transform_hlds__closure_analysis__closure_values_0_0,10)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TEST(MR_r2,1)) {
	...
	MR_r1 = (MR_Integer) 2;
	MR_proceed();
MR_def_label(__Compare___transform_hlds__closure_analysis__closure_values_0_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TEST(MR_r2,1)) {
		MR_GOTO_LAB(__Compare___transform_hlds__closure_analysis__closure_values_0_0_i7);
	}
