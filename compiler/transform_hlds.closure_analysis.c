          ...
          case (MR_Integer) 0:
            {
              ...
              succeeded = ((MR_tag((MR_Word) RHS_57)) == (MR_Integer) 1);
              if (succeeded)
              {
                ShroudedPPId_63 = (MR_Word) (MR_body((MR_Word) (RHS_57), (MR_Integer) 1));
                {
                  MR_Word PPId_64;
                  MR_Word HO_Value_65;
                  MR_Word Var_132;
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_11)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_6, (MR_Integer) 117, &Debug_7);
