  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_22)
{
  ...
  transform_hlds__closure_analysis__partition_higher_order_arguments_8_p_0(STATE_VARIABLE_ModuleInfo_0_21, VarTable_11, HeadVars_10, ArgModes_12, Var_39, &Inputs0_36, Var_40, &_Outputs_37);
  {
    ...
    MR_hl_field(MR_mktag(0), Var_41, 3) = ((MR_Box) (VarTable_11));
  }
  ...
  parse_tree__set_of_var__fold_4_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), (MR_Word) (&transform_hlds__closure_analysis_scalar_common_2[0]), (MR_Word) (&transform_hlds__closure_analysis_scalar_common_2[10]), Inputs_38, ((MR_Box) (Var_43)), &conv1_ClosureInfo0_13);
  ...
  MR_Word * STATE_VARIABLE_MergedCaseClosureInfo_7)
{
  ...
  else
  {
    ...
    transform_hlds__closure_analysis__closure_analyse_goal_6_p_0(ModuleInfo_1, VarTable_2, CaseGoal0_35, &CaseGoal_36, ClosureInfo0_5, &CaseClosureInfo_22);
    {
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      else
      {
        ...
        parse_tree__var_table__lookup_var_type_3_p_0(VarTable_2, Var_56, &Type_59);
