...
MR_decl_label2(transform_hlds__closure_analysis__IntroducedFrom__pred__dump_ho_value__492__1_3_0, 2,3)
...
MR_decl_label3(transform_hlds__closure_analysis__IntroducedFrom__pred__process_goal__371__1_3_0, 3,5,1)
...
MR_decl_label10(transform_hlds__closure_analysis__process_goal_6_0, 65,66,67,71,73,74,77,62,202,80)
...
MR_decl_static(transform_hlds__closure_analysis__IntroducedFrom__pred__process_goal__371__1_3_0)
...
MR_decl_static(fn__transform_hlds__closure_analysis__IntroducedFrom__func__dump_closure_info_expr__459__1_1_0)
MR_decl_static(transform_hlds__closure_analysis__IntroducedFrom__pred__dump_ho_value__492__1_3_0)
...
{
MR_COMMON(7,1),
MR_ENTRY_AP(fn__transform_hlds__closure_analysis__IntroducedFrom__func__dump_closure_info_expr__459__1_1_0),
0
},
{
MR_COMMON(3,7),
...
{
MR_COMMON(3,9),
MR_ENTRY_AP(transform_hlds__closure_analysis__IntroducedFrom__pred__dump_ho_value__492__1_3_0),
0
},
};
...
MR_BEGIN_MODULE(transform_hlds__closure_analysis_module5)
	...
	MR_init_label10(transform_hlds__closure_analysis__process_goal_6_0,65,66,67,71,73,74,77,62,202,80)
...
MR_def_label(transform_hlds__closure_analysis__process_goal_6_0,248)
	...
	MR_tfield(0, MR_tempr2, 1) = (MR_Word) MR_ENTRY_AP(transform_hlds__closure_analysis__IntroducedFrom__pred__process_goal__371__1_3_0);
...
MR_BEGIN_MODULE(transform_hlds__closure_analysis_module17)
	MR_init_entry1(transform_hlds__closure_analysis__IntroducedFrom__pred__process_goal__371__1_3_0);
	MR_INIT_PROC_LAYOUT_ADDR(mercury__transform_hlds__closure_analysis__IntroducedFrom__pred__process_goal__371__1_3_0);
	MR_init_label3(transform_hlds__closure_analysis__IntroducedFrom__pred__process_goal__371__1_3_0,3,5,1)
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'IntroducedFrom__pred__process_goal__371__1'/3 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(transform_hlds__closure_analysis__IntroducedFrom__pred__process_goal__371__1_3_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(3);
	MR_sv(3) = (MR_Word) MR_succip;
	{
	...
	if (MR_LTAGS_TEST(MR_tempr1,0,0)) {
		MR_GOTO_LAB(transform_hlds__closure_analysis__IntroducedFrom__pred__process_goal__371__1_3_0_i1);
	}
	...
	MR_np_call_localret_ent(check_hlds__mode_util__mode_is_output_2_0,
		transform_hlds__closure_analysis__IntroducedFrom__pred__process_goal__371__1_3_0_i3);
MR_def_label(transform_hlds__closure_analysis__IntroducedFrom__pred__process_goal__371__1_3_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(transform_hlds__closure_analysis__IntroducedFrom__pred__process_goal__371__1_3_0_i1);
	}
	MR_r1 = MR_sv(1);
	MR_np_call_localret_ent(parse_tree__prog_type__type_is_higher_order_1_0,
		transform_hlds__closure_analysis__IntroducedFrom__pred__process_goal__371__1_3_0_i5);
MR_def_label(transform_hlds__closure_analysis__IntroducedFrom__pred__process_goal__371__1_3_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(transform_hlds__closure_analysis__IntroducedFrom__pred__process_goal__371__1_3_0_i1);
	}
	...
	MR_r1 = MR_TRUE;
	MR_proceed();
MR_def_label(transform_hlds__closure_analysis__IntroducedFrom__pred__process_goal__371__1_3_0,1)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_succip_word = MR_sv(3);
	MR_decr_sp(3);
	MR_r1 = MR_FALSE;
...
MR_BEGIN_MODULE(transform_hlds__closure_analysis_module22)
	MR_init_entry1(fn__transform_hlds__closure_analysis__IntroducedFrom__func__dump_closure_info_expr__459__1_1_0);
	MR_INIT_PROC_LAYOUT_ADDR(mercury__fn__transform_hlds__closure_analysis__IntroducedFrom__func__dump_closure_info_expr__459__1_1_0);
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'IntroducedFrom__func__dump_closure_info_expr__459__1'/2 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(fn__transform_hlds__closure_analysis__IntroducedFrom__func__dump_closure_info_expr__459__1_1_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_BEGIN_MODULE(transform_hlds__closure_analysis_module23)
	MR_init_entry1(transform_hlds__closure_analysis__IntroducedFrom__pred__dump_ho_value__492__1_3_0);
	MR_INIT_PROC_LAYOUT_ADDR(mercury__transform_hlds__closure_analysis__IntroducedFrom__pred__dump_ho_value__492__1_3_0);
	MR_init_label2(transform_hlds__closure_analysis__IntroducedFrom__pred__dump_ho_value__492__1_3_0,2,3)
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'IntroducedFrom__pred__dump_ho_value__492__1'/3 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(transform_hlds__closure_analysis__IntroducedFrom__pred__dump_ho_value__492__1_3_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(2);
	MR_sv(2) = (MR_Word) MR_succip;
	MR_sv(1) = MR_r1;
	...
	MR_np_call_localret_ent(io__write_string_3_0,
		transform_hlds__closure_analysis__IntroducedFrom__pred__dump_ho_value__492__1_3_0_i2);
MR_def_label(transform_hlds__closure_analysis__IntroducedFrom__pred__dump_ho_value__492__1_3_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(hlds__hlds_pred, pred_proc_id);
	MR_r2 = MR_sv(1);
	MR_np_call_localret_ent(io__write_3_0,
		transform_hlds__closure_analysis__IntroducedFrom__pred__dump_ho_value__492__1_3_0_i3);
MR_def_label(transform_hlds__closure_analysis__IntroducedFrom__pred__dump_ho_value__492__1_3_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_succip_word = MR_sv(2);
	MR_decr_sp(2);
