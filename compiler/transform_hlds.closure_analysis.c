    ...
    case (MR_Integer) 0:
      {
        ...
        transform_hlds__closure_analysis__dump_closure_info_4_p_0(Varset_1, Goal_94);
      }
      break;
    case (MR_Integer) 1:
      {
        ...
        case (MR_Integer) 5:
          {
            ...
            transform_hlds__closure_analysis__dump_closure_info_4_p_0(Varset_1, Goal_40);
          }
          break;
        case (MR_Integer) 6:
          {
...
{
  {
    ...
    transform_hlds__closure_analysis__dump_closure_info_expr_5_p_0(Varset_5, GoalExpr_8, GoalInfo_9);
  }
}
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      else
      {
        ...
        {
          MR_Word next_value_of_HeadVar__3_3 = Var_57;
          MR_Word next_value_of_HeadVar__4_4 = Modes_44;
          MR_Word next_value_of_STATE_VARIABLE_Inputs_0_5 = STATE_VARIABLE_Inputs_51_51;
          MR_Word next_value_of_STATE_VARIABLE_Outputs_0_7 = STATE_VARIABLE_Outputs_52_52;
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 87, &Debug_8);
