            ...
            case (MR_Integer) 1:
              {
...

                {
                  ...
                  MR_hl_field(MR_mktag(0), Var_153, 2) = ((MR_Box) ((MR_Integer) 1));
          ...
          case (MR_Integer) 0:
            {
                ...
                InputArgs_203 = InputArgs0_42;
              {
                ...
                MR_hl_field(MR_mktag(0), AddValues_205, 2) = ((MR_Box) ((MR_Integer) 1));
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 91, &Debug_8);
