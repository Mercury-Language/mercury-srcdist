  ...
  MR_Box * wrapper_arg_3)
{
  ...
  transform_hlds__closure_analysis__IntroducedFrom__pred__dump_ho_value_map_entry__531__1_4_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) (wrapper_arg_1)));
}
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_23)
{
  ...
  transform_hlds__closure_analysis__partition_higher_order_arguments_8_p_0(STATE_VARIABLE_ModuleInfo_0_22, VarTypes_11, HeadVars_10, ArgModes_12, Var_40, &Inputs0_37, Var_41, &_Outputs_38);
  {
    ...
    MR_hl_field(MR_mktag(0), Var_42, 3) = ((MR_Box) (VarTypes_11));
  }
  ...
  parse_tree__set_of_var__fold_4_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), (MR_Word) (&transform_hlds__closure_analysis_scalar_common_2[0]), (MR_Word) (&transform_hlds__closure_analysis_scalar_common_2[10]), Inputs_39, ((MR_Box) (Var_44)), &conv1_ClosureInfo0_13);
  ...
  hlds__hlds_pred__proc_info_get_goal_2_p_0(ProcInfo0_9, &BodyGoal0_15);
  transform_hlds__closure_analysis__closure_analyse_goal_6_p_0(STATE_VARIABLE_ModuleInfo_0_22, VarTypes_11, BodyGoal0_15, &BodyGoal_16, ClosureInfo0_13, &_ClosureInfo_17);
  hlds__hlds_pred__proc_info_set_goal_3_p_0(BodyGoal_16, ProcInfo0_9, &ProcInfo_18);
  switch (Debug_5) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 0:
      {
    ...
    case (MR_Integer) 1:
      {
        ...
        hlds__passes_aux__get_debug_output_stream_4_p_0(STATE_VARIABLE_ModuleInfo_0_22, &DebugStream_21);
        transform_hlds__closure_analysis__dump_closure_info_5_p_0(DebugStream_21, Varset_19, BodyGoal_16);
        mercury__io__flush_output_3_p_0(DebugStream_21);
      }
      break;
  }
  hlds__hlds_module__module_info_set_pred_proc_info_5_p_0(PPId_6, PredInfo_8, ProcInfo_18, STATE_VARIABLE_ModuleInfo_0_22, STATE_VARIABLE_ModuleInfo_23);
}
  ...
  MR_Box wrapper_arg_1)
{
  ...
  conv2_LambdaHeadVar__2_61 = transform_hlds__closure_analysis__IntroducedFrom__func__dump_closure_info__492__1_1_f_0(((MR_Word) (wrapper_arg_1)));
  ...
  MR_Box * wrapper_arg_2)
{
  ...
  succeeded = transform_hlds__closure_analysis__IntroducedFrom__pred__closure_analyse_goal__342__1_3_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) (wrapper_arg_1)), &conv0_LambdaHeadVar__2_120);
  if (succeeded)
  {
