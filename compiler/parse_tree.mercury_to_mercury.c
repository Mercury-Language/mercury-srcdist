...
static /* final */ const MR_Box parse_tree__mercury_to_mercury_scalar_common_1[5][2];
...
{
  {
    ...
    else
    {
      ...
      else
      {
        ...
        mercury__builtin__compare_3_p_0((MR_Word) (&parse_tree__mercury_to_mercury_scalar_common_1[2]), HeadVar__1_1, ((MR_Box) (Var_11)), ((MR_Box) (ArgY1_7)));
      }
    }
  }
}
...
{
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        TypeInfo_9_9 = (MR_Word) (&parse_tree__mercury_to_mercury_scalar_common_1[2]);
  ...
  MR_Box * STATE_VARIABLE_U_7)
{
  while (MR_TRUE)
  {
    ...
    if (succeeded)
    {
      ...
      Var_11 = (MR_Integer) ((MR_Unsigned) Indent_4 - (MR_Unsigned) 1);
...
parse_tree__mercury_to_mercury__mercury_output_class_context_6_p_0(
  ...
  MR_Word UnivConstraints_9,
  MR_Word MaybeExistConstraints_10)
{
  {
    MR_Box conv0_STATE_VARIABLE_IO_13;

    parse_tree__mercury_to_mercury__mercury_format_class_context_6_p_0((MR_Word) (&parse_tree__mercury_to_mercury_scalar_common_1[0]), TypeVarSet_7, VarNamePrint_8, UnivConstraints_9, MaybeExistConstraints_10, ((MR_Box) ((MR_Integer) 0)), &conv0_STATE_VARIABLE_IO_13);
  }
}
...
{
  {
    ...
    if ((MaybeExistConstraints_10 == (MR_Word) ((MR_Unsigned) 0U)))
      STATE_VARIABLE_U_18_18 = STATE_VARIABLE_U_0_13;
    else
    {
      MR_Word ExistConstraints_12 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MaybeExistConstraints_10, (MR_Integer) 0))));
      MR_Box STATE_VARIABLE_U_16_16;
      void MR_CALL (* func_0)(MR_Box, MR_Box, MR_Box, MR_Box *);

      parse_tree__mercury_to_mercury__mercury_format_prog_constraint_list_6_p_0(TypeClassInfo_for_output_21, TypeVarSet_7, VarNamePrint_8, (MR_String) "=>", ExistConstraints_12, STATE_VARIABLE_U_0_13, &STATE_VARIABLE_U_16_16);
      ...
      func_0(((MR_Box) (TypeClassInfo_for_output_21)), ((MR_Box) ((MR_String) ")")), STATE_VARIABLE_U_16_16, &STATE_VARIABLE_U_18_18);
    }
    parse_tree__mercury_to_mercury__mercury_format_prog_constraint_list_6_p_0(TypeClassInfo_for_output_21, TypeVarSet_7, VarNamePrint_8, (MR_String) "<=", UnivConstraints_9, STATE_VARIABLE_U_18_18, STATE_VARIABLE_U_14);
  }
}
  ...
  MR_Box * STATE_VARIABLE_U_15)
{
  ...
  else
  {
...

    {
      ...
      MR_hl_field(MR_mktag(1), Var_19, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &parse_tree__mercury_to_mercury_scalar_common_1[4])));
    }
    {
...
void MR_CALL 
parse_tree__mercury_to_mercury__mercury_format_sym_name_arity_3_p_0(
          ...
          case (MR_Integer) 19:
            {
              ...
              mercury__string__int_to_string_2_p_0(Arity_31, &ArityString_33);
              {
                ...
                MR_hl_field(MR_mktag(1), Var_112, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &parse_tree__mercury_to_mercury_scalar_common_1[3])));
              }
              {
          ...
          case (MR_Integer) 20:
            {
              ...
              }
              {
                ...
                MR_hl_field(MR_mktag(3), Var_101, 1) = ((MR_Box) (InstanceString_36));
              }
              {
