...
{
  {
    ...
    if ((parse_tree__mercury_to_mercury__HeadVar__2_2 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
    ...
    else
      {
        ...
        {
          parse_tree__prog_io_type_name__unparse_type_2_p_0(parse_tree__mercury_to_mercury__Type_6, &parse_tree__mercury_to_mercury__Term_29);
        }
...
{
  {
    ...
    {
      parse_tree__prog_io_type_name__unparse_type_2_p_0(parse_tree__mercury_to_mercury__Type_8, &parse_tree__mercury_to_mercury__Term_10);
    }
...
{
  {
    ...
    {
      parse_tree__prog_io_type_name__unparse_type_2_p_0(parse_tree__mercury_to_mercury__Type_7, &parse_tree__mercury_to_mercury__Term_17);
    }
...
{
  {
    ...
    {
      parse_tree__prog_io_type_name__unparse_type_2_p_0(parse_tree__mercury_to_mercury__Type_8, &parse_tree__mercury_to_mercury__Term_20);
    }
...
{
  {
    ...
    if ((parse_tree__mercury_to_mercury__HeadVar__2_2 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
    ...
    else
      {
        ...
        {
          parse_tree__prog_io_type_name__unparse_type_2_p_0(parse_tree__mercury_to_mercury__Type_6, &parse_tree__mercury_to_mercury__Term_24);
        }
