    ...
    switch (MR_tag((MR_Word) parse_tree__mercury_to_mercury__ConsId_6)) {
      ...
      case (MR_Integer) 3:
        switch (((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), parse_tree__mercury_to_mercury__ConsId_6, (MR_Integer) 0)))) {
          ...
          case (MR_Integer) 6:
            {
              MR_Integer parse_tree__mercury_to_mercury__UInt_13 = ((MR_Integer) (MR_hl_field(MR_mktag(3), parse_tree__mercury_to_mercury__ConsId_6, (MR_Integer) 1)));

              {
                parse_tree__parse_tree_out_info__add_int_3_p_0(parse_tree__mercury_to_mercury__TypeClassInfo_for_output_132, parse_tree__mercury_to_mercury__UInt_13, parse_tree__mercury_to_mercury__STATE_VARIABLE_U_0_39, parse_tree__mercury_to_mercury__STATE_VARIABLE_U_40);
              }
            }
            break;
          case (MR_Integer) 7:
