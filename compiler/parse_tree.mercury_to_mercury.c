  ...
  MR_Word HeadVar__2_2)
{
  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      TypeInfo__9_9 = (MR_Word) (&parse_tree__mercury_to_mercury_scalar_common_2[0]);
  ...
  MR_Word Stream_6)
{
  ...
  Var_15 = libs__globals__foreign_language_string_1_f_0(Lang_5);
  ...
  func_0(((MR_Box) ((MR_Word) (&parse_tree__mercury_to_mercury_scalar_common_1[0]))), ((MR_Box) (Var_12)), ((MR_Box) (Stream_6)), ((MR_Box) ((MR_Integer) 0)), &conv1_STATE_VARIABLE_IO_9);
}
  ...
  MR_Box * STATE_VARIABLE_U_10)
{
  ...
  parse_tree__mercury_to_mercury__mercury_format_bracketed_sym_name_ngt_5_p_0(TypeClassInfo_for_output_15, (MR_Integer) 1, SymName_5, S_7, STATE_VARIABLE_U_0_9, &STATE_VARIABLE_U_11_11);
  ...
  MR_Word Stream_10)
{
  ...
  parse_tree__parse_tree_out_info__write_out_list_6_p_0(TypeInfo__23_23, (MR_Word) (Var_14), (MR_String) ", ", (MR_Word) (StateVars_9), Stream_10);
}
  ...
  MR_Word Stream_6)
{
  ...
  Var_12 = parse_tree__mercury_to_mercury__mercury_det_to_string_1_f_0(Detism_5);
  func_0 = ((void MR_CALL (*)(MR_Box, MR_Box, MR_Box, MR_Box, MR_Box *)) ((MR_hl_field(MR_mktag(0), (MR_hl_field(MR_mktag(0), (MR_Word) (&parse_tree__mercury_to_mercury_scalar_common_1[0]), (MR_Integer) 0)), (MR_Integer) 5))));
  func_0(((MR_Box) ((MR_Word) (&parse_tree__mercury_to_mercury_scalar_common_1[0]))), ((MR_Box) (Var_12)), ((MR_Box) (Stream_6)), ((MR_Box) ((MR_Integer) 0)), &conv1_STATE_VARIABLE_UI_9);
}
  ...
  MR_Word Stream_10)
{
  ...
  parse_tree__parse_tree_to_term__unparse_type_2_p_0(Type_9, &Term_16);
  VarSet_17 = mercury__varset__coerce_1_f_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_tvar_type_0), (MR_Word) (&mercury__term__term__type_ctor_info_generic_0), VarSet_7);
  parse_tree__parse_tree_out_term__mercury_format_term_6_p_0((MR_Word) (&mercury__term__term__type_ctor_info_generic_0), (MR_Word) (&parse_tree__mercury_to_mercury_scalar_common_1[0]), VarSet_17, VarNamePrint_8, Term_16, ((MR_Box) (Stream_10)), ((MR_Box) ((MR_Integer) 0)), &conv0_STATE_VARIABLE_IO_13);
}
