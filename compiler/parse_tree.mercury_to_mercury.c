    ...
    switch (MR_tag((MR_Word) ConsId_6)) {
      ...
      case (MR_Integer) 3:
        switch (((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), ConsId_6, (MR_Integer) 0)))) {
          ...
          case (MR_Integer) 13:
            {
              MR_Integer Int64_20 = ((MR_Integer) (MR_hl_field(MR_mktag(3), ConsId_6, (MR_Integer) 1)));

              parse_tree__parse_tree_out_info__add_int_3_p_0(TypeClassInfo_for_output_148, Int64_20, STATE_VARIABLE_U_0_47, STATE_VARIABLE_U_48);
            }
            break;
          case (MR_Integer) 14:
            {
              MR_Integer UInt64_21 = ((MR_Integer) (MR_hl_field(MR_mktag(3), ConsId_6, (MR_Integer) 1)));

              parse_tree__parse_tree_out_info__add_int_3_p_0(TypeClassInfo_for_output_148, UInt64_21, STATE_VARIABLE_U_0_47, STATE_VARIABLE_U_48);
            }
            break;
          case (MR_Integer) 15:
            {
