...
static /* final */ const struct parse_tree__file_kind__vector_common_type_2_0_s parse_tree__file_kind_vector_common_2[4] = {
  ...
  {
    (MR_String) ".int0",
    (MR_Word) (&parse_tree__file_kind_scalar_common_1[0])
  },
  /* row   1 */
  {
    (MR_String) ".int",
    (MR_Word) (&parse_tree__file_kind_scalar_common_1[1])
  },
  /* row   2 */
  {
    (MR_String) ".int2",
    (MR_Word) (&parse_tree__file_kind_scalar_common_1[2])
  },
  /* row   3 */
  {
    (MR_String) ".int3",
    (MR_Word) (&parse_tree__file_kind_scalar_common_1[3])
  },
};
    ...
    case (MR_Integer) 0:
      {
        ...
        *HeadVar__3_3 = (MR_Word) (MR_mkword(1, &parse_tree__file_kind_scalar_common_1[0]));
      }
      break;
    case (MR_Integer) 1:
      {
        *HeadVar__2_2 = (MR_String) ".trans_opt";
        *HeadVar__3_3 = (MR_Word) (MR_mkword(1, &parse_tree__file_kind_scalar_common_1[1]));
      }
      break;
  }
}
  ...
  MR_String * HeadVar__2_2)
{
  switch (MR_tag((MR_Word) HeadVar__1_1)) {
    ...
    case (MR_Integer) 1:
      {
        MR_Word IntFileKind_3 = ((MR_Unsigned) ((MR_hl_field(1, HeadVar__1_1, (MR_Integer) 0))) & (MR_Integer) 3);
        MR_Word _Ext_5;
    ...
    case (MR_Integer) 2:
      {
        MR_Word OptFileKind_6 = ((MR_Unsigned) ((MR_hl_field(2, HeadVar__1_1, (MR_Integer) 0))) & (MR_Integer) 1);
