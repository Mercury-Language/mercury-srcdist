...
/* sealed */ struct parse_tree__file_kind__vector_common_type_2_0_s {
...
static /* final */ const struct parse_tree__file_kind__vector_common_type_3_0_s parse_tree__file_kind_vector_common_3[7] = {
  ...
  {
    (MR_String) ".int",
    (MR_Word) (MR_mkword(MR_mktag(1), &parse_tree__file_kind_scalar_common_1[0]))
  },
  /* row 1 */
  {
    (MR_String) ".int0",
    (MR_Word) (MR_mkword(MR_mktag(1), &parse_tree__file_kind_scalar_common_1[1]))
  },
  /* row 2 */
  {
    (MR_String) ".int2",
    (MR_Word) (MR_mkword(MR_mktag(1), &parse_tree__file_kind_scalar_common_1[2]))
  },
  /* row 3 */
  {
    (MR_String) ".int3",
    (MR_Word) (MR_mkword(MR_mktag(1), &parse_tree__file_kind_scalar_common_1[3]))
  },
  /* row 4 */
  {
    (MR_String) ".m",
  ...
  {
    (MR_String) ".opt",
    (MR_Word) (MR_mkword(MR_mktag(2), &parse_tree__file_kind_scalar_common_1[1]))
  },
  /* row 6 */
  {
    (MR_String) ".trans_opt",
    (MR_Word) (MR_mkword(MR_mktag(2), &parse_tree__file_kind_scalar_common_1[0]))
  },
};
...
void MR_CALL 
parse_tree__file_kind__file_kind_to_extension_3_p_0(
  MR_Word HeadVar__1_1,
  MR_String * HeadVar__2_2,
  MR_Word * HeadVar__3_3)
{
  switch (MR_tag((MR_Word) HeadVar__1_1)) {
    ...
    case (MR_Integer) 1:
      {
        MR_Word IntFileKind_4 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(1), HeadVar__1_1, (MR_Integer) 0))) & (MR_Integer) 3);
        MR_Word OtherExt_6;

        parse_tree__file_kind__int_file_kind_to_extension_3_p_0(IntFileKind_4, HeadVar__2_2, &OtherExt_6);
        {
          MR_Word base;
          base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
          *HeadVar__3_3 = base;
          MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (OtherExt_6));
        }
      }
      break;
    case (MR_Integer) 2:
      {
        MR_Word OptFileKind_7 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(2), HeadVar__1_1, (MR_Integer) 0))) & (MR_Integer) 1);
        MR_Word OtherExt_9;

        switch (OptFileKind_7) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 0:
            {
              *HeadVar__2_2 = (MR_String) ".opt";
              OtherExt_9 = (MR_Word) (((MR_Box) ((MR_String) ".opt")));
            }
            break;
          case (MR_Integer) 1:
            {
              *HeadVar__2_2 = (MR_String) ".trans_opt";
              OtherExt_9 = (MR_Word) (((MR_Box) ((MR_String) ".trans_opt")));
            }
            break;
        }
        {
          ...
          base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
          *HeadVar__3_3 = base;
          MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (OtherExt_9));
        }
      }
      break;
  }
