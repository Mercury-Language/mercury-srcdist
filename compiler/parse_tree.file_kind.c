...
struct parse_tree__file_kind__vector_common_type_2_0_s {
  const MR_String parse_tree__file_kind__vector_common_type_2_0__vct_2_f_0;
  const MR_Word parse_tree__file_kind__vector_common_type_2_0__vct_2_f_1;
  const MR_Word parse_tree__file_kind__vector_common_type_2_0__vct_2_f_2;
};

static /* final */ const struct parse_tree__file_kind__vector_common_type_2_0_s parse_tree__file_kind_vector_common_2[4];
  ...
  MR_Word HeadVar__3_3)
{
  ...
  {
    MR_Word Var_16 = ((MR_Unsigned) ((MR_hl_field(0, HeadVar__2_2, (MR_Integer) 0))) & (MR_Integer) 3);
  ...
  if (succeeded)
    *HeadVar__1_1 = (MR_Integer) 0;
    ...
    switch (MR_tag((MR_Word) HeadVar__2_2)) {
      ...
      case (MR_Integer) 1:
        {
          MR_Word Var_20 = ((MR_Unsigned) ((MR_hl_field(1, HeadVar__2_2, (MR_Integer) 0))) & (MR_Integer) 3);
          ...
          switch (MR_tag((MR_Word) HeadVar__3_3)) {
            ...
            case (MR_Integer) 1:
              {
                MR_Word ArgY1_8 = ((MR_Unsigned) ((MR_hl_field(1, HeadVar__3_3, (MR_Integer) 0))) & (MR_Integer) 3);
      ...
      case (MR_Integer) 2:
        {
          MR_Word Var_21 = ((MR_Unsigned) ((MR_hl_field(2, HeadVar__2_2, (MR_Integer) 0))) & (MR_Integer) 1);
  ...
  MR_Word * FileKind_4)
{
  ...
  do
  {
    ...
    result_3 = MR_strcmp(ExtStr_3, ((&parse_tree__file_kind_vector_common_3[0 + mid_2]))->parse_tree__file_kind__vector_common_type_3_0__vct_3_f_0);
...
void MR_CALL 
parse_tree__file_kind__opt_file_kind_to_extension_4_p_0(
  MR_Word HeadVar__1_1,
    ...
    case (MR_Integer) 0:
      {
        ...
        *HeadVar__3_3 = (MR_Word) (((MR_Box) ((MR_String) ".opt")));
        *HeadVar__4_4 = (MR_Word) (MR_mkword(2, &parse_tree__file_kind_scalar_common_1[0]));
      }
      break;
    case (MR_Integer) 1:
      {
        *HeadVar__2_2 = (MR_String) ".trans_opt";
        *HeadVar__3_3 = (MR_Word) (((MR_Box) ((MR_String) ".trans_opt")));
        *HeadVar__4_4 = (MR_Word) (MR_mkword(2, &parse_tree__file_kind_scalar_common_1[1]));
      }
      break;
  }
}
...
void MR_CALL 
parse_tree__file_kind__file_kind_to_extension_4_p_0(
  MR_Word HeadVar__1_1,
  MR_String * HeadVar__2_2,
  MR_Word * HeadVar__3_3,
  MR_Word * HeadVar__4_4)
{
  switch (MR_tag((MR_Word) HeadVar__1_1)) {
    ...
    case (MR_Integer) 1:
      {
        MR_Word IntFileKind_5 = ((MR_Unsigned) ((MR_hl_field(1, HeadVar__1_1, (MR_Integer) 0))) & (MR_Integer) 3);
        MR_Word OtherExt_7;

        parse_tree__file_kind__int_file_kind_to_extension_4_p_0(IntFileKind_5, HeadVar__2_2, &OtherExt_7, HeadVar__4_4);
        {
          MR_Word base;
          base = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
          *HeadVar__3_3 = base;
          MR_hl_field(1, base, 0) = ((MR_Box) (OtherExt_7));
        }
      }
      break;
    case (MR_Integer) 2:
      {
        MR_Word OptFileKind_9 = ((MR_Unsigned) ((MR_hl_field(2, HeadVar__1_1, (MR_Integer) 0))) & (MR_Integer) 1);
        MR_Word OtherExt_11;

        switch (OptFileKind_9) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 0:
            {
              *HeadVar__2_2 = (MR_String) ".opt";
              OtherExt_11 = (MR_Word) (((MR_Box) ((MR_String) ".opt")));
              *HeadVar__4_4 = (MR_Word) (MR_mkword(2, &parse_tree__file_kind_scalar_common_1[0]));
            }
            break;
          case (MR_Integer) 1:
            {
              *HeadVar__2_2 = (MR_String) ".trans_opt";
              OtherExt_11 = (MR_Word) (((MR_Box) ((MR_String) ".trans_opt")));
              *HeadVar__4_4 = (MR_Word) (MR_mkword(2, &parse_tree__file_kind_scalar_common_1[1]));
            }
            break;
        }
        {
          ...
          base = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
          *HeadVar__3_3 = base;
          MR_hl_field(1, base, 0) = ((MR_Box) (OtherExt_11));
        }
      }
      break;
  }
...
void MR_CALL 
parse_tree__file_kind__int_file_kind_to_extension_4_p_0(
  MR_Word HeadVar__1_1,
  MR_String * HeadVar__2_2,
  MR_Word * HeadVar__3_3,
  MR_Word * HeadVar__4_4)
{
  *HeadVar__2_2 = ((&parse_tree__file_kind_vector_common_2[0 + HeadVar__1_1]))->parse_tree__file_kind__vector_common_type_2_0__vct_2_f_0;
  *HeadVar__3_3 = ((&parse_tree__file_kind_vector_common_2[0 + HeadVar__1_1]))->parse_tree__file_kind__vector_common_type_2_0__vct_2_f_1;
  *HeadVar__4_4 = ((&parse_tree__file_kind_vector_common_2[0 + HeadVar__1_1]))->parse_tree__file_kind__vector_common_type_2_0__vct_2_f_2;
}
