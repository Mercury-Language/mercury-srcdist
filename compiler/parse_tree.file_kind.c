    ...
    case (MR_Integer) 0:
      {
        ...
        *HeadVar__3_3 = (MR_Word) (MR_mkword(2, &parse_tree__file_kind_scalar_common_1[0]));
      }
      break;
    case (MR_Integer) 1:
      {
        *HeadVar__2_2 = (MR_String) ".trans_opt";
        *HeadVar__3_3 = (MR_Word) (MR_mkword(2, &parse_tree__file_kind_scalar_common_1[1]));
      }
      break;
  }
}
    ...
    case (MR_Integer) 1:
      {
        ...
        parse_tree__file_kind__int_file_kind_to_extension_3_p_0(IntFileKind_4, HeadVar__2_2, HeadVar__3_3);
      }
      break;
    case (MR_Integer) 2:
      {
