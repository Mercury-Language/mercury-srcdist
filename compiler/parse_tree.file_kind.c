    ...
    case (MR_Integer) 0:
      {
        ...
        *HeadVar__3_3 = (MR_Word) (((MR_Box) ((MR_String) ".m")));
      }
      break;
    case (MR_Integer) 1:
      {
        MR_Word IntFileKind_5 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(1), HeadVar__1_1, (MR_Integer) 0))) & (MR_Integer) 3);

        parse_tree__file_kind__int_file_kind_to_extension_3_p_0(IntFileKind_5, HeadVar__2_2, HeadVar__3_3);
      }
      break;
    case (MR_Integer) 2:
      {
        MR_Word OptFileKind_8 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(2), HeadVar__1_1, (MR_Integer) 0))) & (MR_Integer) 1);

        switch (OptFileKind_8) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 0:
            {
              *HeadVar__2_2 = (MR_String) ".opt";
