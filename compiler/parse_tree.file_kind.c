  ...
  MR_Word * HeadVar__3_3)
{
  switch (MR_tag((MR_Word) HeadVar__1_1)) {
    ...
    case (MR_Integer) 1:
      {
        MR_Word IntFileKind_4 = ((MR_Unsigned) ((MR_hl_field(1, HeadVar__1_1, (MR_Integer) 0))) & (MR_Integer) 3);
        MR_Word OtherExt_6;
        ...
        parse_tree__file_kind__int_file_kind_to_extension_3_p_0(IntFileKind_4, HeadVar__2_2, &OtherExt_6);
        {
          ...
          *HeadVar__3_3 = base;
          MR_hl_field(1, base, 0) = ((MR_Box) (OtherExt_6));
        }
      }
      break;
    case (MR_Integer) 2:
      {
        MR_Word OptFileKind_7 = ((MR_Unsigned) ((MR_hl_field(2, HeadVar__1_1, (MR_Integer) 0))) & (MR_Integer) 1);
        MR_Word OtherExt_9;
        ...
        }
        {
          ...
          base = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
          *HeadVar__3_3 = base;
          MR_hl_field(1, base, 0) = ((MR_Box) (OtherExt_9));
        }
      }
      break;
  }
