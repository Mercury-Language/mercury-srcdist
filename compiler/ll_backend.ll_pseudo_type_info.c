    ...
    case (MR_Integer) 2:
      {
        ...
        mercury__list__length_2_p_0((MR_Word) (&backend_libs__rtti__backend_libs__rtti__type_ctor_info_rtti_maybe_pseudo_type_info_0), Args_44, &Arity_28);
        {
          ...
          MR_hl_field(MR_mktag(1), Var_30, 0) = ((MR_Box) (Arity_28));
        }
        {
          ...
          MR_hl_field(MR_mktag(3), ArityArg_29, 1) = ((MR_Box) (Var_30));
        }
        RttiTypeCtor_43 = backend_libs__rtti__var_arity_id_to_rtti_type_ctor_1_f_0(VarArityId_27);
        {
          Var_31 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), Var_31, 0) = ((MR_Box) (ArityArg_29));
          MR_hl_field(MR_mktag(1), Var_31, 1) = ((MR_Box) ((MR_Unsigned) 0U));
        }
        ll_backend__ll_pseudo_type_info__convert_compound_pseudo_type_info_7_p_0(RttiTypeCtor_43, Var_31, Args_44, STATE_VARIABLE_StaticCellInfo_0_15, STATE_VARIABLE_StaticCellInfo_16, PseudoRval_12, LldsType_13);
      }
      break;
    case (MR_Integer) 3:
      {
...

        {
          ...
          MR_hl_field(MR_mktag(1), Var_40, 0) = ((MR_Box) (Int_23));
        }
        {
          MR_Word base;
          base = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
