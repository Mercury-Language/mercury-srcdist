    ...
    case (MR_Integer) 0:
      {
...

        {
          ...
          MR_hl_field(MR_mktag(3), Var_25, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 10));
        ...
        *LldsType_9 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 3));
    ...
    case (MR_Integer) 1:
      {
...

        {
          ...
          MR_hl_field(MR_mktag(3), TypeCtorInfoData_40, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 10));
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(3), Var_53, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 13));
...
{
  {
...

    {
      ...
      MR_hl_field(MR_mktag(3), TypeCtorInfoData_14, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 10));
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(3), Var_29, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 13));
    ...
    *LldsType_13 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 3));
    ...
    case (MR_Integer) 0:
      {
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(3), Var_27, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 13));
    ...
    case (MR_Integer) 1:
      {
...

        {
          ...
          MR_hl_field(MR_mktag(0), Var_55, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 11))));
        }
        {
    ...
    case (MR_Integer) 3:
      {
        ...
        *LldsType_9 = (MR_Word) MR_mkword(MR_mktag(2), &ll_backend__ll_pseudo_type_info_scalar_common_3[0]);
        *STATE_VARIABLE_StaticCellInfo_18 = STATE_VARIABLE_StaticCellInfo_0_17;
      }
      break;
  }
      ...
      case (MR_Integer) 0:
        {
...

          {
            ...
            MR_hl_field(MR_mktag(3), Var_38, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 11));
      ...
      case (MR_Integer) 1:
        {
...

          {
            ...
            MR_hl_field(MR_mktag(0), Var_67, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 11))));
          }
          {
      ...
      case (MR_Integer) 3:
        {
          ...
          *LldsType_13 = (MR_Word) MR_mkword(MR_mktag(2), &ll_backend__ll_pseudo_type_info_scalar_common_3[0]);
          *STATE_VARIABLE_StaticCellInfo_16 = STATE_VARIABLE_StaticCellInfo_0_15;
        }
        break;
    }
...
{
  {
...

    {
      Var_28 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), Var_28, 0) = ((MR_Box) (RttiTypeCtor_8));
      MR_hl_field(MR_mktag(0), Var_28, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 11))));
    }
    {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(3), Var_30, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 13));
