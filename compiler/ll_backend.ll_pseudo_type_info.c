    ...
    case (MR_Integer) 0:
      {
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(3), Var_45, 1) = ((MR_Box) (DataId_38));
    ...
    case (MR_Integer) 2:
      {
        ...
        mercury__list__length_2_p_0((MR_Word) (&backend_libs__rtti__backend_libs__rtti__type_ctor_info_rtti_type_info_0), Args_53, &Arity_41);
        {
          ...
          MR_hl_field(MR_mktag(1), Var_48, 0) = ((MR_Box) (Arity_41));
        }
        {
      ...
      case (MR_Integer) 0:
        {
...

          {
            ...
            MR_hl_field(MR_mktag(3), Var_50, 1) = ((MR_Box) (TI_22));
          }
          {
            Var_49 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
            MR_hl_field(MR_mktag(0), Var_49, 0) = ((MR_Box) (RttiTypeCtor_43));
            MR_hl_field(MR_mktag(0), Var_49, 1) = ((MR_Box) (Var_50));
          }
          {
            DataId_44 = (MR_Word) MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL);
            MR_hl_field(MR_mktag(0), DataId_44, 0) = ((MR_Box) (Var_49));
          }
          {
            Var_51 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(3), Var_51, 0) = ((MR_Box) ((MR_Unsigned) 13U));
            MR_hl_field(MR_mktag(3), Var_51, 1) = ((MR_Box) (DataId_44));
            MR_hl_field(MR_mktag(3), Var_51, 2) = ((MR_Box) ((MR_Unsigned) 0U));
          }
          {
            MR_Word base;
            base = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      ...
      case (MR_Integer) 2:
        {
          ...
          mercury__list__length_2_p_0((MR_Word) (&backend_libs__rtti__backend_libs__rtti__type_ctor_info_rtti_type_info_0), Args_59, &Arity_47);
          {
            ...
            MR_hl_field(MR_mktag(1), Var_54, 0) = ((MR_Box) (Arity_47));
          }
          {
    ...
    case (MR_Integer) 0:
      {
...

        {
          ...
          MR_hl_field(MR_mktag(3), Var_27, 1) = ((MR_Box) (Pseudo_14));
        }
        {
          Var_26 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), Var_26, 0) = ((MR_Box) (RttiTypeCtor_18));
          MR_hl_field(MR_mktag(0), Var_26, 1) = ((MR_Box) (Var_27));
        }
        {
          DataId_19 = (MR_Word) MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), DataId_19, 0) = ((MR_Box) (Var_26));
        }
        {
          Var_28 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(3), Var_28, 0) = ((MR_Box) ((MR_Unsigned) 13U));
          MR_hl_field(MR_mktag(3), Var_28, 1) = ((MR_Box) (DataId_19));
          MR_hl_field(MR_mktag(3), Var_28, 2) = ((MR_Box) ((MR_Unsigned) 0U));
        }
        {
          MR_Word base;
          base = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
    ...
    case (MR_Integer) 2:
      {
        ...
        mercury__list__length_2_p_0((MR_Word) (&backend_libs__rtti__backend_libs__rtti__type_ctor_info_rtti_maybe_pseudo_type_info_0), Args_36, &Arity_22);
        {
          ...
          MR_hl_field(MR_mktag(1), Var_31, 0) = ((MR_Box) (Arity_22));
        }
        {
    ...
    case (MR_Integer) 3:
      {
...

        {
          ...
          MR_hl_field(MR_mktag(1), Var_24, 0) = ((MR_Box) (Int_17));
        }
        {
          MR_Word base;
          base = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
