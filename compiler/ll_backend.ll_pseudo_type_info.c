  ...
  MR_Word * LambdaHeadVar__4_36)
{
  switch (MR_tag((MR_Word) LambdaHeadVar__1_33)) {
    ...
    case (MR_Integer) 0:
      {
...

        {
          ...
          MR_hl_field(MR_mktag(3), Var_48, 1) = ((MR_Box) (LambdaHeadVar__1_33));
        }
        {
          Var_47 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), Var_47, 0) = ((MR_Box) (RttiTypeCtor_37));
          MR_hl_field(MR_mktag(0), Var_47, 1) = ((MR_Box) (Var_48));
        }
        {
          DataId_38 = (MR_Word) MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), DataId_38, 0) = ((MR_Box) (Var_47));
        }
        {
          Var_49 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(3), Var_49, 0) = ((MR_Box) ((MR_Unsigned) 13U));
          MR_hl_field(MR_mktag(3), Var_49, 1) = ((MR_Box) (DataId_38));
          MR_hl_field(MR_mktag(3), Var_49, 2) = ((MR_Box) ((MR_Unsigned) 0U));
        }
        {
          MR_Word base;
    ...
    case (MR_Integer) 1:
      {
        MR_Word Args_39 = ((MR_Word) ((MR_hl_field(MR_mktag(1), LambdaHeadVar__1_33, (MR_Integer) 1))));
        MR_Word RttiTypeCtor_51 = ((MR_Word) ((MR_hl_field(MR_mktag(1), LambdaHeadVar__1_33, (MR_Integer) 0))));
        ...
        {
          TypeCtorInfoData_55 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(3), TypeCtorInfoData_55, 0) = ((MR_Box) ((MR_Unsigned) 10U));
          MR_hl_field(MR_mktag(3), TypeCtorInfoData_55, 1) = ((MR_Box) (Var_61));
        }
        {
          Var_62 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), Var_62, 0) = ((MR_Box) (RttiTypeCtor_51));
          MR_hl_field(MR_mktag(0), Var_62, 1) = ((MR_Box) (TypeCtorInfoData_55));
        }
        {
          TypeCtorInfoDataId_56 = (MR_Word) MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), TypeCtorInfoDataId_56, 0) = ((MR_Box) (Var_62));
        }
        {
          ...
          MR_hl_field(MR_mktag(3), Var_63, 1) = ((MR_Box) (TypeCtorInfoDataId_56));
          MR_hl_field(MR_mktag(3), Var_63, 2) = ((MR_Box) ((MR_Unsigned) 0U));
        }
        {
          TypeCtorInfoRval_57 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(3), TypeCtorInfoRval_57, 0) = ((MR_Box) ((MR_Unsigned) 1U));
          MR_hl_field(MR_mktag(3), TypeCtorInfoRval_57, 1) = ((MR_Box) (Var_63));
        }
        ...
        mercury__list__append_3_p_1((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_rval_0), (MR_Word) ((MR_Unsigned) 0U), ArgRvals1_58, &ArgRvals_59);
        {
          ...
          MR_hl_field(MR_mktag(1), Var_67, 0) = ((MR_Box) (TypeCtorInfoRval_57));
          MR_hl_field(MR_mktag(1), Var_67, 1) = ((MR_Box) (ArgRvals_59));
        }
        ll_backend__global_data__add_scalar_static_cell_natural_types_4_p_0(Var_67, &DataId_60, STATE_VARIABLE_StaticCellInfo_32_66, LambdaHeadVar__4_36);
        {
          ...
          MR_hl_field(MR_mktag(3), Var_68, 1) = ((MR_Box) (DataId_60));
    ...
    case (MR_Integer) 2:
      {
        MR_Word VarArityId_40 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(2), LambdaHeadVar__1_33, (MR_Integer) 0))) & (MR_Integer) 3);
        MR_Integer Arity_41;
        MR_Word ArityArg_42;
        MR_Word Var_43;
        MR_Word Var_44;
        MR_Word RttiTypeCtor_52;
        MR_Word Args_53 = ((MR_Word) ((MR_hl_field(MR_mktag(2), LambdaHeadVar__1_33, (MR_Integer) 1))));
        ...
        mercury__list__length_2_p_0((MR_Word) (&backend_libs__rtti__backend_libs__rtti__type_ctor_info_rtti_type_info_0), Args_53, &Arity_41);
        {
          ...
          MR_hl_field(MR_mktag(1), Var_43, 0) = ((MR_Box) (Arity_41));
        }
        {
          ArityArg_42 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(3), ArityArg_42, 0) = ((MR_Box) ((MR_Unsigned) 1U));
          MR_hl_field(MR_mktag(3), ArityArg_42, 1) = ((MR_Box) (Var_43));
        }
        RttiTypeCtor_52 = backend_libs__rtti__var_arity_id_to_rtti_type_ctor_1_f_0(VarArityId_40);
        {
          Var_44 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), Var_44, 0) = ((MR_Box) (ArityArg_42));
          MR_hl_field(MR_mktag(1), Var_44, 1) = ((MR_Box) ((MR_Unsigned) 0U));
        }
        Var_79 = (MR_Word) ((MR_Word) (RttiTypeCtor_52));
        {
          TypeCtorInfoData_73 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(3), TypeCtorInfoData_73, 0) = ((MR_Box) ((MR_Unsigned) 10U));
          MR_hl_field(MR_mktag(3), TypeCtorInfoData_73, 1) = ((MR_Box) (Var_79));
        }
        {
          Var_80 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), Var_80, 0) = ((MR_Box) (RttiTypeCtor_52));
          MR_hl_field(MR_mktag(0), Var_80, 1) = ((MR_Box) (TypeCtorInfoData_73));
        }
        {
          TypeCtorInfoDataId_74 = (MR_Word) MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), TypeCtorInfoDataId_74, 0) = ((MR_Box) (Var_80));
        }
        {
          ...
          MR_hl_field(MR_mktag(3), Var_81, 1) = ((MR_Box) (TypeCtorInfoDataId_74));
          MR_hl_field(MR_mktag(3), Var_81, 2) = ((MR_Box) ((MR_Unsigned) 0U));
        }
        {
          TypeCtorInfoRval_75 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(3), TypeCtorInfoRval_75, 0) = ((MR_Box) ((MR_Unsigned) 1U));
          MR_hl_field(MR_mktag(3), TypeCtorInfoRval_75, 1) = ((MR_Box) (Var_81));
        }
        ...
        mercury__list__append_3_p_1((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_rval_0), Var_44, ArgRvals1_76, &ArgRvals_77);
        {
          Var_85 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), Var_85, 0) = ((MR_Box) (TypeCtorInfoRval_75));
          MR_hl_field(MR_mktag(1), Var_85, 1) = ((MR_Box) (ArgRvals_77));
        }
        ll_backend__global_data__add_scalar_static_cell_natural_types_4_p_0(Var_85, &DataId_78, STATE_VARIABLE_StaticCellInfo_32_84, LambdaHeadVar__4_36);
        {
          ...
          MR_hl_field(MR_mktag(3), Var_86, 1) = ((MR_Box) (DataId_78));
          MR_hl_field(MR_mktag(3), Var_86, 2) = ((MR_Box) ((MR_Unsigned) 0U));
        }
        {
          MR_Word base;
          base = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          *LambdaHeadVar__2_34 = base;
          MR_hl_field(MR_mktag(3), base, 0) = ((MR_Box) ((MR_Unsigned) 1U));
          MR_hl_field(MR_mktag(3), base, 1) = ((MR_Box) (Var_86));
        }
      }
      break;
  }
  ...
  MR_Word * LambdaHeadVar__4_37)
{
  if (((MR_tag((MR_Word) LambdaHeadVar__1_34)) == (MR_Integer) 1))
  {
    ...
    switch (MR_tag((MR_Word) TI_22)) {
      ...
      case (MR_Integer) 0:
        {
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(3), Var_55, 1) = ((MR_Box) (DataId_44));
            MR_hl_field(MR_mktag(3), Var_55, 2) = ((MR_Box) ((MR_Unsigned) 0U));
          }
          {
            MR_Word base;
            base = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      ...
      case (MR_Integer) 1:
        {
          MR_Word Args_45 = ((MR_Word) ((MR_hl_field(MR_mktag(1), TI_22, (MR_Integer) 1))));
          MR_Word RttiTypeCtor_57 = ((MR_Word) ((MR_hl_field(MR_mktag(1), TI_22, (MR_Integer) 0))));
          ...
          {
            TypeCtorInfoData_61 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(3), TypeCtorInfoData_61, 0) = ((MR_Box) ((MR_Unsigned) 10U));
            MR_hl_field(MR_mktag(3), TypeCtorInfoData_61, 1) = ((MR_Box) (Var_67));
          }
          {
            Var_68 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
            MR_hl_field(MR_mktag(0), Var_68, 0) = ((MR_Box) (RttiTypeCtor_57));
            MR_hl_field(MR_mktag(0), Var_68, 1) = ((MR_Box) (TypeCtorInfoData_61));
          }
          {
            TypeCtorInfoDataId_62 = (MR_Word) MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL);
            MR_hl_field(MR_mktag(0), TypeCtorInfoDataId_62, 0) = ((MR_Box) (Var_68));
          }
          {
            ...
            MR_hl_field(MR_mktag(3), Var_69, 1) = ((MR_Box) (TypeCtorInfoDataId_62));
            MR_hl_field(MR_mktag(3), Var_69, 2) = ((MR_Box) ((MR_Unsigned) 0U));
          }
          {
            TypeCtorInfoRval_63 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(3), TypeCtorInfoRval_63, 0) = ((MR_Box) ((MR_Unsigned) 1U));
            MR_hl_field(MR_mktag(3), TypeCtorInfoRval_63, 1) = ((MR_Box) (Var_69));
          }
          ...
          mercury__list__append_3_p_1((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_rval_0), (MR_Word) ((MR_Unsigned) 0U), ArgRvals1_64, &ArgRvals_65);
          {
            ...
            MR_hl_field(MR_mktag(1), Var_73, 0) = ((MR_Box) (TypeCtorInfoRval_63));
            MR_hl_field(MR_mktag(1), Var_73, 1) = ((MR_Box) (ArgRvals_65));
          }
          ll_backend__global_data__add_scalar_static_cell_natural_types_4_p_0(Var_73, &DataId_66, STATE_VARIABLE_StaticCellInfo_32_72, LambdaHeadVar__4_37);
          {
            ...
            MR_hl_field(MR_mktag(3), Var_74, 1) = ((MR_Box) (DataId_66));
      ...
      case (MR_Integer) 2:
        {
          MR_Word VarArityId_46 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(2), TI_22, (MR_Integer) 0))) & (MR_Integer) 3);
          MR_Integer Arity_47;
          MR_Word ArityArg_48;
          MR_Word Var_49;
          MR_Word Var_50;
          MR_Word RttiTypeCtor_58;
          MR_Word Args_59 = ((MR_Word) ((MR_hl_field(MR_mktag(2), TI_22, (MR_Integer) 1))));
          ...
          mercury__list__length_2_p_0((MR_Word) (&backend_libs__rtti__backend_libs__rtti__type_ctor_info_rtti_type_info_0), Args_59, &Arity_47);
          {
            ...
            MR_hl_field(MR_mktag(1), Var_49, 0) = ((MR_Box) (Arity_47));
          }
          {
            ArityArg_48 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(3), ArityArg_48, 0) = ((MR_Box) ((MR_Unsigned) 1U));
            MR_hl_field(MR_mktag(3), ArityArg_48, 1) = ((MR_Box) (Var_49));
          }
          RttiTypeCtor_58 = backend_libs__rtti__var_arity_id_to_rtti_type_ctor_1_f_0(VarArityId_46);
          {
            Var_50 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), Var_50, 0) = ((MR_Box) (ArityArg_48));
            MR_hl_field(MR_mktag(1), Var_50, 1) = ((MR_Box) ((MR_Unsigned) 0U));
          }
          Var_85 = (MR_Word) ((MR_Word) (RttiTypeCtor_58));
          {
            TypeCtorInfoData_79 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(3), TypeCtorInfoData_79, 0) = ((MR_Box) ((MR_Unsigned) 10U));
            MR_hl_field(MR_mktag(3), TypeCtorInfoData_79, 1) = ((MR_Box) (Var_85));
          }
          {
            Var_86 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
            MR_hl_field(MR_mktag(0), Var_86, 0) = ((MR_Box) (RttiTypeCtor_58));
            MR_hl_field(MR_mktag(0), Var_86, 1) = ((MR_Box) (TypeCtorInfoData_79));
          }
          {
            TypeCtorInfoDataId_80 = (MR_Word) MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL);
            MR_hl_field(MR_mktag(0), TypeCtorInfoDataId_80, 0) = ((MR_Box) (Var_86));
          }
          {
            Var_87 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(3), Var_87, 0) = ((MR_Box) ((MR_Unsigned) 13U));
            MR_hl_field(MR_mktag(3), Var_87, 1) = ((MR_Box) (TypeCtorInfoDataId_80));
            MR_hl_field(MR_mktag(3), Var_87, 2) = ((MR_Box) ((MR_Unsigned) 0U));
          }
          {
            TypeCtorInfoRval_81 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(3), TypeCtorInfoRval_81, 0) = ((MR_Box) ((MR_Unsigned) 1U));
            MR_hl_field(MR_mktag(3), TypeCtorInfoRval_81, 1) = ((MR_Box) (Var_87));
          }
          ...
          mercury__list__append_3_p_1((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_rval_0), Var_50, ArgRvals1_82, &ArgRvals_83);
          {
            Var_91 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), Var_91, 0) = ((MR_Box) (TypeCtorInfoRval_81));
            MR_hl_field(MR_mktag(1), Var_91, 1) = ((MR_Box) (ArgRvals_83));
          }
          ll_backend__global_data__add_scalar_static_cell_natural_types_4_p_0(Var_91, &DataId_84, STATE_VARIABLE_StaticCellInfo_32_90, LambdaHeadVar__4_37);
          {
            ...
            MR_hl_field(MR_mktag(3), Var_92, 0) = ((MR_Box) ((MR_Unsigned) 13U));
            MR_hl_field(MR_mktag(3), Var_92, 1) = ((MR_Box) (DataId_84));
          ...
          }
          {
            ...
            *LambdaHeadVar__2_35 = base;
            MR_hl_field(MR_mktag(3), base, 0) = ((MR_Box) ((MR_Unsigned) 1U));
            MR_hl_field(MR_mktag(3), base, 1) = ((MR_Box) (Var_92));
          }
        }
        break;
    }
    ...
    case (MR_Integer) 1:
      {
...

        {
          ...
          MR_hl_field(MR_mktag(0), Var_40, 0) = ((MR_Box) (RttiTypeCtor_31));
          MR_hl_field(MR_mktag(0), Var_40, 1) = ((MR_Box) ((MR_Unsigned) 44U));
        }
        {
          TypeCtorInfoDataId_35 = (MR_Word) MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), TypeCtorInfoDataId_35, 0) = ((MR_Box) (Var_40));
        }
        {
          ...
          MR_hl_field(MR_mktag(3), Var_42, 1) = ((MR_Box) (TypeCtorInfoDataId_35));
          MR_hl_field(MR_mktag(3), Var_42, 2) = ((MR_Box) ((MR_Unsigned) 0U));
        }
        {
          TypeCtorInfoRval_36 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(3), TypeCtorInfoRval_36, 0) = ((MR_Box) ((MR_Unsigned) 1U));
          MR_hl_field(MR_mktag(3), TypeCtorInfoRval_36, 1) = ((MR_Box) (Var_42));
        }
        *LldsType_9 = (MR_Word) ((MR_Unsigned) 12U);
        ...
        mercury__list__append_3_p_1((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_rval_0), (MR_Word) ((MR_Unsigned) 0U), ArgRvals1_37, &ArgRvals_38);
        {
          ...
          MR_hl_field(MR_mktag(1), Var_46, 0) = ((MR_Box) (TypeCtorInfoRval_36));
          MR_hl_field(MR_mktag(1), Var_46, 1) = ((MR_Box) (ArgRvals_38));
        }
        ll_backend__global_data__add_scalar_static_cell_natural_types_4_p_0(Var_46, &DataId_39, STATE_VARIABLE_StaticCellInfo_33_45, STATE_VARIABLE_StaticCellInfo_18);
        {
          ...
          MR_hl_field(MR_mktag(3), Var_47, 0) = ((MR_Box) ((MR_Unsigned) 13U));
          MR_hl_field(MR_mktag(3), Var_47, 1) = ((MR_Box) (DataId_39));
          MR_hl_field(MR_mktag(3), Var_47, 2) = ((MR_Box) ((MR_Unsigned) 0U));
        }
        {
          MR_Word base;
          base = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
    ...
    case (MR_Integer) 2:
      {
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(0), Var_57, 0) = ((MR_Box) (RttiTypeCtor_32));
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(0), TypeCtorInfoDataId_52, 0) = ((MR_Box) (Var_57));
        }
        {
          ...
          MR_hl_field(MR_mktag(3), Var_59, 1) = ((MR_Box) (TypeCtorInfoDataId_52));
          MR_hl_field(MR_mktag(3), Var_59, 2) = ((MR_Box) ((MR_Unsigned) 0U));
        }
        {
          TypeCtorInfoRval_53 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(3), TypeCtorInfoRval_53, 0) = ((MR_Box) ((MR_Unsigned) 1U));
          MR_hl_field(MR_mktag(3), TypeCtorInfoRval_53, 1) = ((MR_Box) (Var_59));
        }
        *LldsType_9 = (MR_Word) ((MR_Unsigned) 12U);
        ...
        mercury__list__append_3_p_1((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_rval_0), Var_20, ArgRvals1_54, &ArgRvals_55);
        {
          Var_63 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), Var_63, 0) = ((MR_Box) (TypeCtorInfoRval_53));
          MR_hl_field(MR_mktag(1), Var_63, 1) = ((MR_Box) (ArgRvals_55));
        }
        ll_backend__global_data__add_scalar_static_cell_natural_types_4_p_0(Var_63, &DataId_56, STATE_VARIABLE_StaticCellInfo_33_62, STATE_VARIABLE_StaticCellInfo_18);
        {
          ...
          MR_hl_field(MR_mktag(3), Var_64, 0) = ((MR_Box) ((MR_Unsigned) 13U));
          MR_hl_field(MR_mktag(3), Var_64, 1) = ((MR_Box) (DataId_56));
          MR_hl_field(MR_mktag(3), Var_64, 2) = ((MR_Box) ((MR_Unsigned) 0U));
        }
        {
          MR_Word base;
          base = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
  ...
  MR_Word * LldsType_13)
{
  ...
  switch (MR_tag((MR_Word) Pseudo_14)) {
    ...
    case (MR_Integer) 0:
      {
...

        {
          ...
          MR_hl_field(MR_mktag(3), Var_29, 0) = ((MR_Box) ((MR_Unsigned) 11U));
          MR_hl_field(MR_mktag(3), Var_29, 1) = ((MR_Box) (Pseudo_14));
        }
        {
          Var_28 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), Var_28, 0) = ((MR_Box) (RttiTypeCtor_18));
          MR_hl_field(MR_mktag(0), Var_28, 1) = ((MR_Box) (Var_29));
        }
        {
          DataId_19 = (MR_Word) MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), DataId_19, 0) = ((MR_Box) (Var_28));
        }
        {
          ...
          MR_hl_field(MR_mktag(3), Var_30, 1) = ((MR_Box) (DataId_19));
    ...
    case (MR_Integer) 1:
      {
        MR_Word Args_20 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Pseudo_14, (MR_Integer) 1))));
        MR_Word RttiTypeCtor_34 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Pseudo_14, (MR_Integer) 0))));
...

        {
          ...
          MR_hl_field(MR_mktag(0), Var_43, 0) = ((MR_Box) (RttiTypeCtor_34));
          MR_hl_field(MR_mktag(0), Var_43, 1) = ((MR_Box) ((MR_Unsigned) 44U));
        }
        {
          TypeCtorInfoDataId_38 = (MR_Word) MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), TypeCtorInfoDataId_38, 0) = ((MR_Box) (Var_43));
        }
        {
          ...
          MR_hl_field(MR_mktag(3), Var_45, 1) = ((MR_Box) (TypeCtorInfoDataId_38));
          MR_hl_field(MR_mktag(3), Var_45, 2) = ((MR_Box) ((MR_Unsigned) 0U));
        }
        {
          TypeCtorInfoRval_39 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(3), TypeCtorInfoRval_39, 0) = ((MR_Box) ((MR_Unsigned) 1U));
          MR_hl_field(MR_mktag(3), TypeCtorInfoRval_39, 1) = ((MR_Box) (Var_45));
        }
        *LldsType_13 = (MR_Word) ((MR_Unsigned) 12U);
        ...
        mercury__list__append_3_p_1((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_rval_0), (MR_Word) ((MR_Unsigned) 0U), ArgRvals1_40, &ArgRvals_41);
        {
          ...
          MR_hl_field(MR_mktag(1), Var_49, 0) = ((MR_Box) (TypeCtorInfoRval_39));
          MR_hl_field(MR_mktag(1), Var_49, 1) = ((MR_Box) (ArgRvals_41));
        }
        ll_backend__global_data__add_scalar_static_cell_natural_types_4_p_0(Var_49, &DataId_42, STATE_VARIABLE_StaticCellInfo_33_48, STATE_VARIABLE_StaticCellInfo_16);
        {
          ...
          MR_hl_field(MR_mktag(3), Var_50, 1) = ((MR_Box) (DataId_42));
    ...
    case (MR_Integer) 2:
      {
        MR_Word VarArityId_21 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(2), Pseudo_14, (MR_Integer) 0))) & (MR_Integer) 3);
        MR_Integer Arity_22;
        MR_Word ArityArg_23;
        MR_Word Var_24;
        MR_Word Var_25;
        MR_Word RttiTypeCtor_35;
        MR_Word Args_36 = ((MR_Word) ((MR_hl_field(MR_mktag(2), Pseudo_14, (MR_Integer) 1))));
        ...
        mercury__list__length_2_p_0((MR_Word) (&backend_libs__rtti__backend_libs__rtti__type_ctor_info_rtti_maybe_pseudo_type_info_0), Args_36, &Arity_22);
        {
          ...
          MR_hl_field(MR_mktag(1), Var_24, 0) = ((MR_Box) (Arity_22));
        }
        {
          ArityArg_23 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(3), ArityArg_23, 0) = ((MR_Box) ((MR_Unsigned) 1U));
          MR_hl_field(MR_mktag(3), ArityArg_23, 1) = ((MR_Box) (Var_24));
        }
        RttiTypeCtor_35 = backend_libs__rtti__var_arity_id_to_rtti_type_ctor_1_f_0(VarArityId_21);
        {
          Var_25 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), Var_25, 0) = ((MR_Box) (ArityArg_23));
          MR_hl_field(MR_mktag(1), Var_25, 1) = ((MR_Box) ((MR_Unsigned) 0U));
        }
        {
          Var_60 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), Var_60, 0) = ((MR_Box) (RttiTypeCtor_35));
          MR_hl_field(MR_mktag(0), Var_60, 1) = ((MR_Box) ((MR_Unsigned) 44U));
        }
        {
          TypeCtorInfoDataId_55 = (MR_Word) MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), TypeCtorInfoDataId_55, 0) = ((MR_Box) (Var_60));
        }
        {
          ...
          MR_hl_field(MR_mktag(3), Var_62, 1) = ((MR_Box) (TypeCtorInfoDataId_55));
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(3), TypeCtorInfoRval_56, 1) = ((MR_Box) (Var_62));
        }
        *LldsType_13 = (MR_Word) ((MR_Unsigned) 12U);
        ...
        mercury__list__append_3_p_1((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_rval_0), Var_25, ArgRvals1_57, &ArgRvals_58);
        {
          Var_66 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), Var_66, 0) = ((MR_Box) (TypeCtorInfoRval_56));
          MR_hl_field(MR_mktag(1), Var_66, 1) = ((MR_Box) (ArgRvals_58));
        }
        ll_backend__global_data__add_scalar_static_cell_natural_types_4_p_0(Var_66, &DataId_59, STATE_VARIABLE_StaticCellInfo_33_65, STATE_VARIABLE_StaticCellInfo_16);
        {
          ...
          MR_hl_field(MR_mktag(3), Var_67, 1) = ((MR_Box) (DataId_59));
    ...
    case (MR_Integer) 3:
      {
        MR_Integer Int_17 = ((MR_Integer) ((MR_hl_field(MR_mktag(3), Pseudo_14, (MR_Integer) 0))));
        MR_Word Var_32;

        {
          Var_32 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), Var_32, 0) = ((MR_Box) (Int_17));
        }
        {
          MR_Word base;
          base = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
