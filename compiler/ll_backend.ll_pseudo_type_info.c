    ...
    case (MR_Integer) 1:
      {
        ...
        *LldsType_9 = (MR_Word) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 3)));
        ...
        mercury__list__append_3_p_1((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_rval_0), (MR_Word) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))), ArgRvals1_48, &ArgRvals_49);
        {
    ...
    case (MR_Integer) 1:
      {
        ...
        *LldsType_9 = (MR_Word) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 3)));
        ...
        mercury__list__append_3_p_1((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_rval_0), (MR_Word) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))), ArgRvals1_52, &ArgRvals_53);
        {
      ...
      case (MR_Integer) 1:
        {
          ...
          *LldsType_13 = (MR_Word) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 3)));
          ...
          mercury__list__append_3_p_1((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_rval_0), (MR_Word) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))), ArgRvals1_64, &ArgRvals_65);
          {
