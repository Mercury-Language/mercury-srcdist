    ...
    case (MR_Integer) 0:
      {
        ...
        *LldsType_9 = (MR_Word) ((MR_Integer) 12);
    ...
    case (MR_Integer) 1:
      {
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(3), Var_53, 2) = ((MR_Box) ((MR_Integer) 0));
        }
        {
        ...
        *LldsType_9 = (MR_Word) ((MR_Integer) 12);
        ...
        mercury__list__append_3_p_1((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_rval_0), (MR_Word) ((MR_Integer) 0), ArgRvals1_48, &ArgRvals_49);
        {
        ...
        ll_backend__global_data__add_scalar_static_cell_natural_types_4_p_0(Var_61, &DataId_50, STATE_VARIABLE_StaticCellInfo_32_56, STATE_VARIABLE_StaticCellInfo_17);
        {
          ...
          MR_hl_field(MR_mktag(3), Var_63, 2) = ((MR_Box) ((MR_Integer) 0));
        }
        {
          MR_Word base;
          base = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
...
{
  {
    ...
    *LldsType_13 = (MR_Word) ((MR_Integer) 12);
    ...
    ll_backend__global_data__add_scalar_static_cell_natural_types_4_p_0(Var_37, &DataId_24, STATE_VARIABLE_StaticCellInfo_32_32, STATE_VARIABLE_StaticCellInfo_26);
    {
      ...
      MR_hl_field(MR_mktag(3), Var_39, 2) = ((MR_Box) ((MR_Integer) 0));
    }
    {
      MR_Word base;
      base = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
    ...
    case (MR_Integer) 0:
      {
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(3), Var_27, 2) = ((MR_Box) ((MR_Integer) 0));
        }
        {
          MR_Word base;
          base = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
    ...
    case (MR_Integer) 1:
      {
...

        {
          ...
          MR_hl_field(MR_mktag(0), Var_55, 1) = ((MR_Box) ((MR_Integer) 44));
        }
        {
        ...
        *LldsType_9 = (MR_Word) ((MR_Integer) 12);
        ...
        mercury__list__append_3_p_1((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_rval_0), (MR_Word) ((MR_Integer) 0), ArgRvals1_52, &ArgRvals_53);
        {
        ...
        ll_backend__global_data__add_scalar_static_cell_natural_types_4_p_0(Var_65, &DataId_54, STATE_VARIABLE_StaticCellInfo_33_60, STATE_VARIABLE_StaticCellInfo_18);
        {
          ...
          MR_hl_field(MR_mktag(3), Var_67, 2) = ((MR_Box) ((MR_Integer) 0));
        }
        {
          MR_Word base;
          base = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      ...
      case (MR_Integer) 1:
        {
...

          {
            ...
            MR_hl_field(MR_mktag(0), Var_67, 1) = ((MR_Box) ((MR_Integer) 44));
          }
          {
          ...
          *LldsType_13 = (MR_Word) ((MR_Integer) 12);
          ...
          mercury__list__append_3_p_1((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_rval_0), (MR_Word) ((MR_Integer) 0), ArgRvals1_64, &ArgRvals_65);
          {
          ...
          ll_backend__global_data__add_scalar_static_cell_natural_types_4_p_0(Var_77, &DataId_66, STATE_VARIABLE_StaticCellInfo_33_72, STATE_VARIABLE_StaticCellInfo_16);
          {
            ...
            MR_hl_field(MR_mktag(3), Var_79, 2) = ((MR_Box) ((MR_Integer) 0));
          }
          {
            MR_Word base;
            base = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
...
{
  {
...

    {
      Var_28 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), Var_28, 0) = ((MR_Box) (RttiTypeCtor_8));
      MR_hl_field(MR_mktag(0), Var_28, 1) = ((MR_Box) ((MR_Integer) 44));
    }
    {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(3), Var_30, 2) = ((MR_Box) ((MR_Integer) 0));
    }
    {
    ...
    *LldsType_13 = (MR_Word) ((MR_Integer) 12);
    ...
    ll_backend__global_data__add_scalar_static_cell_natural_types_4_p_0(Var_38, &DataId_25, STATE_VARIABLE_StaticCellInfo_33_33, STATE_VARIABLE_StaticCellInfo_27);
    {
      ...
      MR_hl_field(MR_mktag(3), Var_40, 2) = ((MR_Box) ((MR_Integer) 0));
    }
    {
      MR_Word base;
      base = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
