    ...
    case (MR_Integer) 2:
      {
        ...
        MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), TypeInfo_6, (MR_Integer) 0)));
    ...
    case (MR_Integer) 2:
      {
        ...
        MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), Pseudo_6, (MR_Integer) 0)));
      ...
      case (MR_Integer) 2:
        {
          ...
          MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), Pseudo_14, (MR_Integer) 0)));
