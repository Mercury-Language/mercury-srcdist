    ...
    case (MR_Integer) 0:
      {
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(3), Var_35, 1) = ((MR_Box) (DataId_26));
    ...
    case (MR_Integer) 2:
      {
        ...
        mercury__list__length_2_p_0((MR_Word) (&backend_libs__rtti__backend_libs__rtti__type_ctor_info_rtti_maybe_pseudo_type_info_0), Args_45, &Arity_29);
        {
          ...
          MR_hl_field(MR_mktag(1), Var_39, 0) = ((MR_Box) (Arity_29));
        }
        {
          ...
          MR_hl_field(MR_mktag(3), ArityArg_30, 1) = ((MR_Box) (Var_39));
        }
        RttiTypeCtor_44 = backend_libs__rtti__var_arity_id_to_rtti_type_ctor_1_f_0(VarArityId_28);
        {
          Var_40 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), Var_40, 0) = ((MR_Box) (ArityArg_30));
          MR_hl_field(MR_mktag(1), Var_40, 1) = ((MR_Box) ((MR_Unsigned) 0U));
        }
        ll_backend__ll_pseudo_type_info__convert_compound_pseudo_type_info_7_p_0(RttiTypeCtor_44, Var_40, Args_45, STATE_VARIABLE_StaticCellInfo_0_15, STATE_VARIABLE_StaticCellInfo_16, PseudoRval_12, LldsType_13);
      }
      break;
    case (MR_Integer) 3:
      {
...

        {
          ...
          MR_hl_field(MR_mktag(1), Var_31, 0) = ((MR_Box) (Int_24));
        }
        {
          MR_Word base;
          base = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
