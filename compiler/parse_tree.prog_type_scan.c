    ...
    switch (MR_tag((MR_Word) Type_3)) {
      ...
      case (MR_Integer) 3:
        switch (((MR_Integer) ((MR_hl_field(3, Type_3, (MR_Integer) 0))))) {
          ...
          case (MR_Integer) 0:
            {
              MR_Word ArgTypes_19 = ((MR_Word) ((MR_hl_field(3, Type_3, (MR_Integer) 1))));
          ...
          case (MR_Integer) 2:
            {
              MR_Word V_13 = ((MR_Word) ((MR_hl_field(3, Type_3, (MR_Integer) 1))));
              MR_Word ArgTypes_17 = ((MR_Word) ((MR_hl_field(3, Type_3, (MR_Integer) 2))));
          ...
          case (MR_Integer) 3:
            {
              MR_Word SubType_15 = ((MR_Word) ((MR_hl_field(3, Type_3, (MR_Integer) 1))));
    ...
    switch (MR_tag((MR_Word) Type_4)) {
      ...
      case (MR_Integer) 3:
        switch (((MR_Integer) ((MR_hl_field(3, Type_4, (MR_Integer) 0))))) {
          ...
          case (MR_Integer) 0:
            {
              MR_Word ArgTypes_29 = ((MR_Word) ((MR_hl_field(3, Type_4, (MR_Integer) 1))));
          ...
          case (MR_Integer) 2:
            {
              MR_Word STATE_VARIABLE_RevTVars_23_23;
              MR_Word Var_26 = ((MR_Word) ((MR_hl_field(3, Type_4, (MR_Integer) 1))));
              MR_Word ArgTypes_27 = ((MR_Word) ((MR_hl_field(3, Type_4, (MR_Integer) 2))));

              {
                STATE_VARIABLE_RevTVars_23_23 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(1, STATE_VARIABLE_RevTVars_23_23, 0) = ((MR_Box) (Var_26));
                MR_hl_field(1, STATE_VARIABLE_RevTVars_23_23, 1) = ((MR_Box) (STATE_VARIABLE_RevTVars_0_19));
              }
              parse_tree__prog_type_scan__type_vars_in_types_acc_3_p_0(ArgTypes_27, STATE_VARIABLE_RevTVars_23_23, STATE_VARIABLE_RevTVars_20);
            }
            break;
          case (MR_Integer) 3:
            {
              MR_Word SubType_17 = ((MR_Word) ((MR_hl_field(3, Type_4, (MR_Integer) 1))));
