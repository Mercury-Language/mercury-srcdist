...
static void MR_CALL 
parse_tree__prog_type_scan__prog_constraints_get_tvars_2_p_0_2(
  MR_Box closure_arg,
  MR_Box wrapper_arg_1,
  MR_Box * wrapper_arg_2);

static void MR_CALL 
parse_tree__prog_type_scan__prog_constraints_get_tvars_2_p_0_1(
  MR_Box closure_arg,
  MR_Box wrapper_arg_1,
  MR_Box * wrapper_arg_2);
...
static /* final */ const MR_Box parse_tree__prog_type_scan_scalar_common_3[4][3] = {
  /* row   0 */
  {
    ...
    ((MR_Box) (parse_tree__prog_type_scan__prog_constraints_get_tvars_2_p_0_1)),
    ((MR_Box) ((MR_Integer) 0))
  },
  /* row   1 */
  {
    ((MR_Box) (&parse_tree__prog_type_scan_scalar_common_2[0])),
    ((MR_Box) (parse_tree__prog_type_scan__prog_constraints_get_tvars_2_p_0_2)),
    ((MR_Box) ((MR_Integer) 0))
  },
  /* row   2 */
  {
...
void MR_CALL 
parse_tree__prog_type_scan__prog_constraints_get_tvars_2_p_0(
  MR_Word HeadVar__1_1,
  MR_Word * TVars_5)
{
