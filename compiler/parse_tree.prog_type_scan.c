...
parse_tree__prog_type_scan__type_vars_in_type_acc_3_p_0(
  MR_Word Type_4,
  MR_Word STATE_VARIABLE_RevTVars_0_18,
  MR_Word * STATE_VARIABLE_RevTVars_19);
    ...
    switch (MR_tag((MR_Word) Type_3)) {
      ...
      case (MR_Integer) 3:
        switch (((MR_Integer) ((MR_hl_field(3, Type_3, 0))))) {
          ...
          case (MR_Integer) 0:
            {
              MR_Word ArgTypes_16 = ((MR_Word) ((MR_hl_field(3, Type_3, 1))));

              parse_tree__prog_type_scan__type_list_contains_var_2_p_0(ArgTypes_16, Var_4, cont, cont_env_ptr);
            }
            break;
          case (MR_Integer) 1:
            {
              MR_Word ArgTypes_15 = ((MR_Word) ((MR_hl_field(3, Type_3, 2))));

              parse_tree__prog_type_scan__type_list_contains_var_2_p_0(ArgTypes_15, Var_4, cont, cont_env_ptr);
            }
            break;
          case (MR_Integer) 2:
            {
              MR_Word SubType_13 = ((MR_Word) ((MR_hl_field(3, Type_3, 1))));
              MR_Word next_value_of_Type_3 = SubType_13;
      ...
      case (MR_Integer) 0:
        {
...

          {
            ...
            *STATE_VARIABLE_RevTVars_19 = base;
            MR_hl_field(1, base, 0) = ((MR_Box) (Var_7));
            MR_hl_field(1, base, 1) = ((MR_Box) (STATE_VARIABLE_RevTVars_0_18));
          }
        }
        break;
      case (MR_Integer) 1:
        {
          ...
          parse_tree__prog_type_scan__type_vars_in_types_acc_3_p_0(ArgTypes_10, STATE_VARIABLE_RevTVars_0_18, STATE_VARIABLE_RevTVars_19);
        }
        break;
      case (MR_Integer) 2:
        *STATE_VARIABLE_RevTVars_19 = STATE_VARIABLE_RevTVars_0_18;
        break;
      case (MR_Integer) 3:
        switch (((MR_Integer) ((MR_hl_field(3, Type_4, 0))))) {
          ...
          case (MR_Integer) 0:
            {
              MR_Word ArgTypes_21 = ((MR_Word) ((MR_hl_field(3, Type_4, 1))));

              parse_tree__prog_type_scan__type_vars_in_types_acc_3_p_0(ArgTypes_21, STATE_VARIABLE_RevTVars_0_18, STATE_VARIABLE_RevTVars_19);
            }
            break;
          case (MR_Integer) 1:
            {
              MR_Word ArgTypes_20 = ((MR_Word) ((MR_hl_field(3, Type_4, 2))));

              parse_tree__prog_type_scan__type_vars_in_types_acc_3_p_0(ArgTypes_20, STATE_VARIABLE_RevTVars_0_18, STATE_VARIABLE_RevTVars_19);
            }
            break;
          case (MR_Integer) 2:
            {
