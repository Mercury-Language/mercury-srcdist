  ...
  MR_Box closure_arg)
{
  ...
  succeeded = transform_hlds__rbmm__region_transformation__IntroducedFrom__pred__region_transform_case__642__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) ((MR_hl_field(0, closure, 4)))));
  return succeeded;
}
  ...
  MR_Word * STATE_VARIABLE_ProcInfo_57)
{
  ...
  *STATE_VARIABLE_NameToVar_55 = ((MR_Word) (conv4_STATE_VARIABLE_NameToVar_55));
  ...
  hlds__hlds_pred__proc_info_set_var_table_3_p_0(STATE_VARIABLE_VarTable_2_63, STATE_VARIABLE_ProcInfo_0_56, &STATE_VARIABLE_ProcInfo_1_78);
  hlds__hlds_pred__proc_info_set_goal_3_p_0(STATE_VARIABLE_Goal_1_58, STATE_VARIABLE_ProcInfo_1_78, &STATE_VARIABLE_ProcInfo_2_79);
  hlds__hlds_pred__proc_info_set_headvars_3_p_0(STATE_VARIABLE_HeadVars_1_66, STATE_VARIABLE_ProcInfo_2_79, &STATE_VARIABLE_ProcInfo_3_80);
  hlds__hlds_pred__proc_info_set_argmodes_3_p_0(STATE_VARIABLE_ActualArgModes_1_67, STATE_VARIABLE_ProcInfo_3_80, STATE_VARIABLE_ProcInfo_57);
}
