    ...
    case (MR_Integer) 1:
      {
        ...
        transform_hlds__rbmm__region_transformation__region_name_to_var_with_both_renamings_before_10_p_0(RegionName_67, ResurRenaming_16, IteRenaming_17, &RegionVar_68, STATE_VARIABLE_NameToVar_0_29, STATE_VARIABLE_NameToVar_30, STATE_VARIABLE_VarSet_0_31, STATE_VARIABLE_VarSet_32, STATE_VARIABLE_VarTypes_0_33, STATE_VARIABLE_VarTypes_34);
  ...
  MR_Word * STATE_VARIABLE_VarTypes_26)
{
  ...
  MR_String Name_41;
  MR_Word ResurNameList_40;
  MR_Box conv0_ResurNameList_40;

  RegName_20 = transform_hlds__rbmm__points_to_graph__rptg_lookup_region_name_2_f_0(Graph_12, Node_15);
  succeeded = mercury__map__search_3_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&transform_hlds__rbmm__region_transformation_scalar_common_1[2]), ResurRenaming_13, ((MR_Box) (RegName_20)), &conv0_ResurNameList_40);
  if (succeeded)
  {
    ResurNameList_40 = ((MR_Word) (conv0_ResurNameList_40));
    succeeded = MR_TRUE;
  }
  if (succeeded)
  {
    MR_Box conv1_Name_41;

    mercury__list__det_last_2_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), ResurNameList_40, &conv1_Name_41);
    Name_41 = ((MR_String) (conv1_Name_41));
  }
  else
  {
    MR_Word IteNameList_42;
    MR_Box conv2_IteNameList_42;

    succeeded = mercury__map__search_3_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&transform_hlds__rbmm__region_transformation_scalar_common_1[2]), IteRenaming_14, ((MR_Box) (RegName_20)), &conv2_IteNameList_42);
    if (succeeded)
    {
      IteNameList_42 = ((MR_Word) (conv2_IteNameList_42));
      succeeded = MR_TRUE;
    }
    if (succeeded)
    {
      MR_Box conv3_Name_41;

      mercury__list__det_last_2_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), IteNameList_42, &conv3_Name_41);
      Name_41 = ((MR_String) (conv3_Name_41));
    }
    else
      Name_41 = RegName_20;
  }
  transform_hlds__rbmm__region_transformation__region_name_to_var_8_p_0(Name_41, RegVar_16, STATE_VARIABLE_NameToVar_0_21, STATE_VARIABLE_NameToVar_22, STATE_VARIABLE_VarSet_0_23, STATE_VARIABLE_VarSet_24, STATE_VARIABLE_VarTypes_0_25, STATE_VARIABLE_VarTypes_26);
}
