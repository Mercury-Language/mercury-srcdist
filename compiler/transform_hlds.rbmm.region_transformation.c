  ...
  MR_Box closure_arg)
{
  ...
  succeeded = transform_hlds__rbmm__region_transformation__IntroducedFrom__pred__region_transform_case__641__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) ((MR_hl_field(0, closure, 4)))));
  return succeeded;
}
  ...
  MR_Word * STATE_VARIABLE_VarTable_61)
{
  ...
  hlds__goal_util__flatten_conj_2_p_0(Var_89, &FlatConjs_53);
