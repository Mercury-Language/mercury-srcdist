  ...
  MR_Box closure_arg)
{
  ...
  succeeded = transform_hlds__rbmm__region_transformation__IntroducedFrom__pred__region_transform_case__641__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 4)))));
  return succeeded;
}
      ...
      case (MR_Integer) 1:
        {
          ...
          Last_26 = ((MR_Word) (conv0_Last_26));
          {
            ...
            MR_hl_field(1, Var_40, 0) = ((MR_Box) (Last_26));
