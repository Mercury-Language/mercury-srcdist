      ...
      case (MR_Integer) 0:
        {
          ...
          hlds__goal_util__generate_simple_call_12_p_0(Var_53, (MR_String) "create_region", (MR_Integer) 0, (MR_Word) ((MR_Integer) 0), (MR_Integer) 0, (MR_Integer) 2, Var_59, (MR_Word) ((MR_Integer) 0), Var_61, ModuleInfo_14, Context_15, &CallGoal_26);
        }
        break;
      case (MR_Integer) 1:
        {
          ...
          hlds__goal_util__generate_simple_call_12_p_0(Var_40, (MR_String) "remove_region", (MR_Integer) 0, (MR_Word) ((MR_Integer) 0), (MR_Integer) 0, (MR_Integer) 2, Var_46, (MR_Word) ((MR_Integer) 0), Var_48, ModuleInfo_14, Context_15, &CallGoal_26);
        }
        break;
      case (MR_Integer) 2:
        {
...
{
  {
    ...
    if (succeeded)
    {
      ...
      transform_hlds__rbmm__region_transformation__assignments_from_ite_renaming_anno_10_p_0(IteRenamingAnnoProc_25, ProgPoint_43, STATE_VARIABLE_NameToVar_0_61, &STATE_VARIABLE_NameToVar_73_73, STATE_VARIABLE_VarSet_0_63, &STATE_VARIABLE_VarSet_74_74, STATE_VARIABLE_VarTypes_0_65, &STATE_VARIABLE_VarTypes_75_75, (MR_Word) ((MR_Integer) 0), &IteRenamingAssignments_48);
      ...
      case (MR_Integer) 1:
        {
          ...
          transform_hlds__rbmm__region_transformation__assignments_from_ite_renaming_anno_10_p_0(IteRenamingAnnoProc_24, ProgPoint_32, STATE_VARIABLE_NameToVar_61_61, &STATE_VARIABLE_NameToVar_64_64, STATE_VARIABLE_VarSet_62_62, &STATE_VARIABLE_VarSet_65_65, STATE_VARIABLE_VarTypes_63_63, &STATE_VARIABLE_VarTypes_66_66, (MR_Word) ((MR_Integer) 0), &IteRenamingAssignments_39);
          ...
          case (MR_Integer) 2:
            {
              ...
              if ((Var_188 == (MR_Word) ((MR_Integer) 0)))
              {
                {
                  mercury__require__unexpected_2_p_0((MR_String) "predicate \140transform_hlds.rbmm.region_transformation.region_transform_compound_goal\'/16", (MR_String) "shorthand or atomic goal");
                  return;
          ...
          case (MR_Integer) 2:
            {
              ...
              if ((Var_330 == (MR_Word) ((MR_Integer) 0)))
              {
          ...
          case (MR_Integer) 3:
            {
              ...
              if ((Var_332 == (MR_Word) ((MR_Integer) 0)))
              {
                *STATE_VARIABLE_VarTypes_16 = STATE_VARIABLE_VarTypes_0_15;
                *STATE_VARIABLE_VarSet_14 = STATE_VARIABLE_VarSet_0_13;
                *STATE_VARIABLE_NameToVar_12 = STATE_VARIABLE_NameToVar_0_11;
