  ...
  MR_String * ExtraCode_20)
{
  ...
  libs__globals__lookup_int_option_3_p_0(Globals_21, (MR_Integer) 361, &FactTableSize_22);
  ...
  MR_Word * STATE_VARIABLE_Specs_38)
{
  ...
  else
  {
    ...
    else
    {
      ...
      libs__globals__lookup_int_option_3_p_0(Globals_22, (MR_Integer) 361, &FactTableSize_31);
  ...
  MR_Word * STATE_VARIABLE_Specs_51)
{
  ...
  libs__globals__lookup_int_option_3_p_0(Globals_44, (MR_Integer) 362, &PercentFull_59);
  ...
  else
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        libs__globals__lookup_int_option_3_p_0(Globals_16, (MR_Integer) 362, &PercentFull_78);
