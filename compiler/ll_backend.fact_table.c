  ...
  MR_Word * STATE_VARIABLE_Specs_38)
{
  ...
  else
  {
    ...
    parse_tree__file_names__fact_table_file_name_8_p_0(Globals_22, (MR_String) "predicate \140ll_backend.fact_table.fact_table_compile_facts\'/12", (MR_Integer) 0, (MR_Word) (MR_mkword(3, &ll_backend__fact_table_scalar_common_1[29])), FileName_14, &OutputFileName_25);
