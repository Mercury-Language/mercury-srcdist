...
#line 51 "ll_backend.fact_table.c"
...
#endif
#line 60 "ll_backend.fact_table.c"
...
MR_def_label(ll_backend__fact_table__check_fact_type_and_mode_8_0,7)
	...
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 1);
	MR_tfield(1, MR_tempr1, 0) = MR_tfield(0, MR_tempr4, 2);
	MR_tag_alloc_heap(MR_tempr2, 0, (MR_Integer) 2);
	MR_tfield(0, MR_tempr2, 0) = MR_tempr1;
...
MR_def_label(ll_backend__fact_table__fact_table_hash_2_4_0,3)
	...
	MR_tempr1 = MR_r2;
	MR_sv(2) = MR_tfield(1, MR_tempr1, 1);
	MR_r1 = ((MR_Integer) MR_tfield(1, MR_tempr1, 0) + ((MR_Integer) 31 * (MR_Integer) MR_r3));
	MR_r2 = MR_sv(1);
	}
	MR_np_call_localret_ent(fn__int__mod_2_0,
...
MR_def_label(ll_backend__fact_table__write_fact_table_arrays_14_0,8)
	...
	MR_tempr8 = MR_r1;
	MR_tempr6 = MR_tempr8;
	MR_tempr7 = MR_tfield(1, MR_tempr8, 0);
...
MR_def_label(ll_backend__fact_table__generate_argument_vars_code_2_11_0,2)
	...
	MR_sv(1) = MR_tempr2;
	MR_tempr3 = MR_r1;
	MR_sv(2) = MR_tfield(0, MR_tfield(1, MR_tempr3, 0), 1);
	MR_sv(3) = MR_tfield(1, MR_tempr3, 1);
	MR_tempr4 = MR_r2;
...
MR_def_label(ll_backend__fact_table__generate_cc_multi_code_2_5_0,3)
	...
	MR_sv(3) = MR_r4;
	MR_tempr2 = MR_r1;
	MR_sv(4) = MR_tfield(0, MR_tfield(1, MR_tempr2, 0), 1);
