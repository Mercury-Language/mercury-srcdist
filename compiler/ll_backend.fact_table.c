  ...
  MR_String * ExtraCode_20)
{
  ...
  libs__globals__lookup_int_option_3_p_0(Globals_21, (MR_Integer) 377, &FactTableSize_22);
  ...
  MR_Word * STATE_VARIABLE_Specs_42)
{
  ...
  else
  {
    ...
    else
    {
      ...
      libs__globals__lookup_int_option_3_p_0(Globals_24, (MR_Integer) 377, &FactTableSize_34);
  ...
  MR_Word * STATE_VARIABLE_Specs_53)
{
  ...
  libs__globals__lookup_int_option_3_p_0(Globals_46, (MR_Integer) 378, &PercentFull_61);
  ...
  else
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        libs__globals__lookup_int_option_3_p_0(Globals_16, (MR_Integer) 378, &PercentFull_78);
