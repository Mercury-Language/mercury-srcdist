      ...
      case (MR_Integer) 1:
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(HeadVar__1_1, (MR_Integer) 57, &Verbose_18);
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      if (!((MaybeDataStream_12 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))))))
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_59, (MR_Integer) 58, &VeryVerbose_66);
  ...
  MR_Word * STATE_VARIABLE_ProcTable_5)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals_2, (MR_Integer) 57, &Verbose_25);
      ...
      case (MR_Integer) 2:
        {
          ...
          if (succeeded)
          {
            ...
            libs__globals__lookup_bool_option_3_p_0(Globals_31, (MR_Integer) 58, &VeryVerbose_33);
...
{
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_41, (MR_Integer) 58, &VeryVerbose_42);
