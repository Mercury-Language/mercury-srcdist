        ...
        else
          {
            ...
            if ((ll_backend__fact_table__MaybeDataStream_12 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
            ...
            else
              {
                ...
                {
                  libs__globals__lookup_bool_option_3_p_0(ll_backend__fact_table__Globals_59, (MR_Integer) 49, &ll_backend__fact_table__VeryVerbose_66);
                }
                {
      ...
      case (MR_Integer) 1:
        {
          ...
          {
            libs__globals__lookup_bool_option_3_p_0(ll_backend__fact_table__HeadVar__1_1, (MR_Integer) 48, &ll_backend__fact_table__Verbose_18);
          }
          {
        ...
        if ((ll_backend__fact_table__HeadVar__1_1 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
          *ll_backend__fact_table__STATE_VARIABLE_ProcTable_5 = ll_backend__fact_table__STATE_VARIABLE_ProcTable_0_4;
        else
          {
            ...
            {
              libs__globals__lookup_bool_option_3_p_0(ll_backend__fact_table__Globals_2, (MR_Integer) 48, &ll_backend__fact_table__Verbose_25);
            }
            {
        ...
        if (ll_backend__fact_table__succeeded)
          {
            ...
            {
              libs__globals__lookup_bool_option_3_p_0(ll_backend__fact_table__Globals_41, (MR_Integer) 49, &ll_backend__fact_table__VeryVerbose_42);
            }
            {
              ...
              if (ll_backend__fact_table__succeeded)
                {
                  ...
                  {
                    libs__globals__lookup_bool_option_3_p_0(ll_backend__fact_table__Globals_31, (MR_Integer) 49, &ll_backend__fact_table__VeryVerbose_33);
                  }
