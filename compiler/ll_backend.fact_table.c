  ...
  MR_Word HeadVar__3_3)
{
  ...
  else
  {
    ...
    else
    {
      ...
      mercury__builtin__compare_3_p_0((MR_Word) (&ll_backend__fact_table_scalar_common_2[0]), &SubResult1_6, ((MR_Box) (Var_18)), ((MR_Box) (ArgY1_5)));
      succeeded = (SubResult1_6 != (MR_Integer) 0);
      if (succeeded)
        *HeadVar__1_1 = SubResult1_6;
      else
  ...
  MR_Word * STATE_VARIABLE_Specs_42)
{
  ...
  else
  {
    ...
    else
    {
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals_68, (MR_Integer) 73, &VeryVerbose_69);
  ...
  MR_Word * STATE_VARIABLE_Specs_21)
{
  ...
  parse_tree__module_cmds__make_command_string_3_p_0(Var_24, (MR_Integer) 0, &Command_13);
