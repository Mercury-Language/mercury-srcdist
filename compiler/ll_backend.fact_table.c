  ...
  MR_String * ExtraCode_20)
{
  ...
  libs__globals__lookup_int_option_3_p_0(Globals_21, (MR_Integer) 374, &FactTableSize_22);
  ...
  MR_Word * STATE_VARIABLE_Specs_42)
{
  ...
  else
  {
    ...
    else
    {
      ...
      libs__globals__lookup_int_option_3_p_0(Globals_24, (MR_Integer) 374, &FactTableSize_34);
      hlds__hlds_module__module_info_get_globals_2_p_0(ModuleInfo_15, &Globals_68);
      libs__globals__lookup_bool_option_3_p_0(Globals_68, (MR_Integer) 74, &VeryVerbose_69);
  ...
  MR_Word * STATE_VARIABLE_Specs_21)
{
  ...
  if (((MR_tag((MR_Word) Result_14)) == (MR_Integer) 1))
  {
    ...
    }
    {
      ...
      MR_hl_field(3, Var_90, 2) = ((MR_Box) ((MR_Integer) 0));
  ...
  MR_Word * STATE_VARIABLE_Specs_53)
{
  ...
  libs__globals__lookup_int_option_3_p_0(Globals_46, (MR_Integer) 375, &PercentFull_61);
  ...
  else
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        libs__globals__lookup_int_option_3_p_0(Globals_16, (MR_Integer) 375, &PercentFull_78);
