  ...
  MR_String * ExtraCode_20)
{
  ...
  libs__globals__lookup_int_option_3_p_0(Globals_21, (MR_Integer) 384, &FactTableSize_22);
  ...
  MR_Word * STATE_VARIABLE_Specs_44)
{
  ...
  else
  {
    ...
    else
    {
      ...
      libs__globals__lookup_int_option_3_p_0(Globals_24, (MR_Integer) 384, &FactTableSize_36);
      hlds__hlds_module__module_info_get_globals_2_p_0(ModuleInfo_15, &Globals_70);
      libs__globals__lookup_bool_option_3_p_0(Globals_70, (MR_Integer) 78, &VeryVerbose_71);
  ...
  MR_Word * STATE_VARIABLE_Specs_53)
{
  ...
  libs__globals__lookup_int_option_3_p_0(Globals_46, (MR_Integer) 385, &PercentFull_61);
  ...
  else
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        libs__globals__lookup_int_option_3_p_0(Globals_16, (MR_Integer) 385, &PercentFull_78);
