...
{
  {
    ...
    libs__globals__lookup_int_option_3_p_0(Globals_22, (MR_Integer) 343, &FactTableSize_23);
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      if (!((MaybeDataStream_12 == (MR_Word) ((MR_Unsigned) 0U))))
      {
        ...
        libs__globals__lookup_int_option_3_p_0(Globals_59, (MR_Integer) 343, &FactTableSize_67);
...
{
  {
    ...
    libs__globals__lookup_int_option_3_p_0(Globals_4, (MR_Integer) 344, &PercentFull_7);
      ...
      case (MR_Integer) 2:
        {
          ...
          libs__globals__lookup_int_option_3_p_0(Globals_31, (MR_Integer) 343, &FactTableSize_32);
...
{
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        libs__globals__lookup_int_option_3_p_0(Globals_41, (MR_Integer) 343, &FactTableSize_43);
...
ll_backend__fact_table__fact_table_size_2_p_0(
  ...
  MR_Integer * FactTableSize_4)
{
  libs__globals__lookup_int_option_3_p_0(Globals_3, (MR_Integer) 343, FactTableSize_4);
}
