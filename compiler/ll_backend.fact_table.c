    ...
    if (((MR_tag((MR_Word) SortFileNameResult_21)) == (MR_Integer) 1))
    {
      ...
      *HeadVar__3_3 = (MR_Word) ((MR_Unsigned) 0U);
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(0), Spec_66, 2) = ((MR_Box) ((MR_Unsigned) 48U));
      ...
      case (MR_Integer) 1:
        {
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(1), Spec_81, 2) = ((MR_Box) ((MR_Unsigned) 48U));
...
{
  {
    ...
    else
    {
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(1), Spec_71, 2) = ((MR_Box) ((MR_Unsigned) 48U));
    ...
    else
    {
      ...
      if ((ProcIds_18 == (MR_Word) ((MR_Unsigned) 0U)))
      {
...

        {
          ...
          MR_hl_field(MR_mktag(1), ModeSpec_20, 2) = ((MR_Box) ((MR_Unsigned) 48U));
        ...
        else
        {
          ...
          else
          {
...

            {
              ...
              MR_hl_field(MR_mktag(1), AllInSpec_38, 2) = ((MR_Box) ((MR_Unsigned) 48U));
    ...
    else
    {
      ...
      else
      {
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(1), Spec_70, 2) = ((MR_Box) ((MR_Unsigned) 48U));
    ...
    else
    {
      ...
      else
      {
        ...
        hlds__hlds_pred__proc_info_get_context_2_p_0(ProcInfo_3, &Context_92);
        {
          ...
          MR_hl_field(MR_mktag(1), Spec_93, 2) = ((MR_Box) ((MR_Unsigned) 48U));
