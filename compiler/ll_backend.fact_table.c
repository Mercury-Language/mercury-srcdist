...
{
  {
    ...
    libs__globals__lookup_int_option_3_p_0(Globals_22, (MR_Integer) 341, &FactTableSize_23);
      ...
      case (MR_Integer) 1:
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(HeadVar__1_1, (MR_Integer) 62, &Verbose_18);
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      if (!((MaybeDataStream_12 == (MR_Word) ((MR_Unsigned) 0U))))
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_59, (MR_Integer) 63, &VeryVerbose_66);
        libs__globals__lookup_int_option_3_p_0(Globals_59, (MR_Integer) 341, &FactTableSize_67);
...
{
  {
    ...
    libs__globals__lookup_int_option_3_p_0(Globals_4, (MR_Integer) 342, &PercentFull_7);
  ...
  MR_Word * STATE_VARIABLE_ProcTable_5)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals_2, (MR_Integer) 62, &Verbose_25);
      ...
      case (MR_Integer) 2:
        {
          ...
          libs__globals__lookup_int_option_3_p_0(Globals_31, (MR_Integer) 341, &FactTableSize_32);
          ...
          if (succeeded)
          {
            ...
            libs__globals__lookup_bool_option_3_p_0(Globals_31, (MR_Integer) 63, &VeryVerbose_33);
...
{
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_41, (MR_Integer) 63, &VeryVerbose_42);
        libs__globals__lookup_int_option_3_p_0(Globals_41, (MR_Integer) 341, &FactTableSize_43);
...
ll_backend__fact_table__fact_table_size_2_p_0(
  ...
  MR_Integer * FactTableSize_4)
{
  libs__globals__lookup_int_option_3_p_0(Globals_3, (MR_Integer) 341, FactTableSize_4);
}
