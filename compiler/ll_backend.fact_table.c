...
{
  {
    ...
    libs__globals__lookup_int_option_3_p_0(Globals_22, (MR_Integer) 323, &FactTableSize_23);
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      if (!((MaybeDataStream_12 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))))))
      {
        ...
        libs__globals__lookup_int_option_3_p_0(Globals_59, (MR_Integer) 323, &FactTableSize_67);
...
{
  {
    ...
    libs__globals__lookup_int_option_3_p_0(Globals_4, (MR_Integer) 324, &PercentFull_7);
      ...
      case (MR_Integer) 2:
        {
          ...
          libs__globals__lookup_int_option_3_p_0(Globals_31, (MR_Integer) 323, &FactTableSize_32);
...
{
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        libs__globals__lookup_int_option_3_p_0(Globals_41, (MR_Integer) 323, &FactTableSize_43);
...
{
  {
    libs__globals__lookup_int_option_3_p_0(Globals_3, (MR_Integer) 323, FactTableSize_4);
  }
}
