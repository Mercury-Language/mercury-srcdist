  ...
  MR_Word * STATE_VARIABLE_EscapedCharsCord_3)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      if (succeeded)
        mercury__cord__snoc_list_3_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_character_0), (MR_Word) (MR_mkword(1, &ll_backend__fact_table_scalar_common_1[94])), STATE_VARIABLE_EscapedCharsCord_0_2, &STATE_VARIABLE_EscapedCharsCord_1_13);
      else
      {
        succeeded = (Char_7 == (MR_Char) 10);
        if (succeeded)
          mercury__cord__snoc_list_3_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_character_0), (MR_Word) (MR_mkword(1, &ll_backend__fact_table_scalar_common_1[96])), STATE_VARIABLE_EscapedCharsCord_0_2, &STATE_VARIABLE_EscapedCharsCord_1_13);
        else
        {
          succeeded = (Char_7 == (MR_Char) 58);
          if (succeeded)
            mercury__cord__snoc_list_3_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_character_0), (MR_Word) (MR_mkword(1, &ll_backend__fact_table_scalar_common_1[98])), STATE_VARIABLE_EscapedCharsCord_0_2, &STATE_VARIABLE_EscapedCharsCord_1_13);
          else
          {
            succeeded = (Char_7 == (MR_Char) 126);
            if (succeeded)
              mercury__cord__snoc_list_3_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_character_0), (MR_Word) (MR_mkword(1, &ll_backend__fact_table_scalar_common_1[100])), STATE_VARIABLE_EscapedCharsCord_0_2, &STATE_VARIABLE_EscapedCharsCord_1_13);
            else
