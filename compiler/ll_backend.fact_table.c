  ...
  MR_Word * STATE_VARIABLE_Specs_38)
{
  ...
  {
    MR_Word Var_61;
    MR_Word Error_65 = ((MR_Word) ((MR_hl_field(1, FileResult_23, (MR_Integer) 0))));

    {
      Var_61 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(1, Var_61, 0) = ((MR_Box) (Context_15));
    }
    ll_backend__fact_table__add_file_open_error_8_p_0(Var_61, FileName_14, (MR_String) "input", Error_65, STATE_VARIABLE_Specs_0_37, STATE_VARIABLE_Specs_38);
  ...
  else
  {
    ...
    parse_tree__file_names__fact_table_file_name_9_p_0(Globals_22, (MR_String) "predicate \140ll_backend.fact_table.fact_table_compile_facts\'/12", (MR_Integer) 0, (MR_Word) (((MR_Box) ((MR_String) ".c"))), (MR_Word) (MR_mkword(3, &ll_backend__fact_table_scalar_common_1[29])), FileName_14, &OutputFileName_25);
    ...
    if (((MR_tag((MR_Word) OpenResult_26)) == (MR_Integer) 1))
    {
...

      {
        ...
        MR_hl_field(1, Var_56, 0) = ((MR_Box) (Context_15));
      }
      ll_backend__fact_table__add_file_open_error_8_p_0(Var_56, FileName_14, (MR_String) "output", Error_34, STATE_VARIABLE_Specs_0_37, STATE_VARIABLE_Specs_38);
      *HeaderCode_17 = (MR_String) "";
      *PrimaryProcId_18 = hlds__hlds_pred__invalid_proc_id_0_f_0();
      *STATE_VARIABLE_PredInfo_36 = STATE_VARIABLE_PredInfo_0_35;
    }
    else
    {
      ...
      libs__globals__lookup_int_option_3_p_0(Globals_22, (MR_Integer) 363, &FactTableSize_31);
      ...
      if ((MaybeDataFileName_32 == (MR_Word) ((MR_Unsigned) 0U)))
        *STATE_VARIABLE_Specs_38 = STATE_VARIABLE_Specs_51_51;
      else
      {
        MR_String DataFileName_33 = ((MR_String) ((MR_hl_field(1, MaybeDataFileName_32, (MR_Integer) 0))));

        ll_backend__fact_table__append_data_table_7_p_0(ModuleInfo_13, OutputFileName_25, DataFileName_33, STATE_VARIABLE_Specs_51_51, STATE_VARIABLE_Specs_38);
      }
    }
