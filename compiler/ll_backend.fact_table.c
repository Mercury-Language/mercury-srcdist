...
{
  {
    ...
    if ((SeeResult_22 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      ...
      parse_tree__file_names__fact_table_file_name_7_p_0(Globals_21, (MR_Integer) 0, (MR_Word) (((MR_Box) ((MR_String) ".c"))), FileName_14, &OutputFileName_23);
      ...
      if (((MR_tag((MR_Word) OpenResult_24)) == (MR_Integer) 1))
      {
        ...
        ll_backend__fact_table__print_file_open_error_7_p_0(Globals_21, Var_40, FileName_14, (MR_String) "output", Error_26);
    ...
    else
    {
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(0), Var_71, 0) = ((MR_Box) (Var_32));
