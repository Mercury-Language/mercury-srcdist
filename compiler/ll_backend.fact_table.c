...
{
  {
    ...
    libs__globals__lookup_int_option_3_p_0(Globals_21, (MR_Integer) 352, &FactTableSize_22);
...
{
  {
    ...
    else
    {
      ...
      else
      {
        ...
        libs__globals__lookup_int_option_3_p_0(Globals_22, (MR_Integer) 352, &FactTableSize_31);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_82, (MR_Integer) 66, &VeryVerbose_83);
...
{
  {
    ...
    libs__globals__lookup_int_option_3_p_0(Globals_4, (MR_Integer) 353, &PercentFull_7);
  ...
  MR_Word * STATE_VARIABLE_Specs_7)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals_32, (MR_Integer) 65, &Verbose_33);
      switch (Verbose_33) {
        default: /*NOTREACHED*/ MR_assert(0);
        case (MR_Integer) 0:
