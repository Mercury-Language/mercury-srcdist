  ...
  MR_Word * STATE_VARIABLE_Specs_22)
{
  ...
  if (((MR_tag((MR_Word) Result_15)) == (MR_Integer) 1))
  {
    ...
    }
    {
      ...
      MR_hl_field(1, Var_87, 0) = ((MR_Box) ((MR_Unsigned) 4U));
  ...
  MR_Word * STATE_VARIABLE_Specs_16)
{
  ...
  else
  {
    ...
    {
      Var_34 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(1, Var_34, 0) = ((MR_Box) ((MR_Unsigned) 4U));
  ...
  MR_Word * STATE_VARIABLE_Specs_16)
{
  ...
  }
  {
    ...
    MR_hl_field(1, Var_33, 0) = ((MR_Box) ((MR_Unsigned) 4U));
    ...
    if (succeeded)
    {
      FunctorAtom_37 = ((MR_String) ((MR_hl_field(0, Functor_35, (MR_Integer) 0))));
      {
        ...
        else
        {
          ...
          Pieces_78 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_format_component_0), Var_62, (MR_Word) (MR_mkword(1, &ll_backend__fact_table_scalar_common_1[31])));
          {
