  ...
  MR_Word * STATE_VARIABLE_Specs_70)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_114, (MR_Integer) 72, &VeryVerbose_115);
  ...
  MR_Word * STATE_VARIABLE_Specs_51)
{
  ...
  libs__globals__lookup_int_option_3_p_0(Globals_44, (MR_Integer) 359, &PercentFull_59);
  ...
  else
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        libs__globals__lookup_int_option_3_p_0(Globals_16, (MR_Integer) 359, &PercentFull_78);
