...
#line 28 "check_hlds.delay_info.c"
#line 150 "../library/io.int2"
#include "time.mh"

#line 32 "check_hlds.delay_info.c"
#line 151 "../library/io.int2"
#include "string.mh"

#line 36 "check_hlds.delay_info.c"
#line 33 "../library/array.int2"
#include "array.mh"

#line 40 "check_hlds.delay_info.c"
#line 31 "../library/bitmap.int2"
#include "bitmap.mh"

#line 44 "check_hlds.delay_info.c"
#line 39 "../mdbcomp/mdbcomp.rtti_access.int2"
#include "mdbcomp.rtti_access.mh"

#line 48 "check_hlds.delay_info.c"
#line 49 "check_hlds.delay_info.c"
#include "check_hlds.delay_info.mh"

#line 52 "check_hlds.delay_info.c"
#line 53 "check_hlds.delay_info.c"
#ifndef CHECK_HLDS__DELAY_INFO_DECL_GUARD
#define CHECK_HLDS__DELAY_INFO_DECL_GUARD

#line 57 "check_hlds.delay_info.c"
#line 58 "check_hlds.delay_info.c"
...
MR_decl_label8(check_hlds__delay_info__add_pending_goals_6_0, 32,3,6,7,10,13,8,17)
MR_decl_label8(check_hlds__delay_info__add_waiting_vars_5_0, 31,3,8,4,12,13,14,16)
MR_decl_label1(check_hlds__delay_info__delay_info_bind_all_vars_2_0, 5)
MR_decl_label4(check_hlds__delay_info__delay_info_bind_var_3_0, 6,8,9,2)
MR_decl_label3(check_hlds__delay_info__delay_info_bind_var_list_3_0, 10,3,4)
MR_decl_label7(check_hlds__delay_info__delay_info_delay_goal_4_0, 2,3,5,7,8,11,12)
MR_decl_label3(check_hlds__delay_info__delay_info_enter_conj_2_0, 2,4,5)
MR_decl_label4(check_hlds__delay_info__delay_info_init_1_0, 3,7,9,10)
MR_decl_label5(check_hlds__delay_info__delay_info_leave_conj_3_0, 3,4,5,6,7)
MR_decl_label8(check_hlds__delay_info__delay_info_wakeup_goals_3_0, 4,7,9,10,11,12,14,2)
MR_decl_label7(check_hlds__delay_info__delete_waiting_vars_4_0, 29,3,7,8,10,9,13)
MR_decl_label5(check_hlds__delay_info__remove_delayed_goals_5_0, 17,3,4,7,8)
MR_decl_label2(__Unify___check_hlds__delay_info__delay_goal_num_0_0, 4,1)
MR_decl_label5(__Unify___check_hlds__delay_info__delay_info_0_0, 5,10,13,17,1)
MR_decl_label4(__Compare___check_hlds__delay_info__delay_goal_num_0_0, 3,2,5,21)
MR_decl_label7(__Compare___check_hlds__delay_info__delay_info_0_0, 3,2,5,10,17,22,65)
...
static const MR_FA_TypeInfo_Struct1 mercury_data_stack__ti_stack_1tree234__ti_tree234_2builtin__type_ctor_info_int_0check_hlds__mode_errors__type_ctor_info_delayed_goal_0 = {
...
static const MR_FA_TypeInfo_Struct1 mercury_data_stack__ti_stack_1builtin__type_ctor_info_int_0 = {
	&mercury_data_stack__type_ctor_info_stack_1,
{	(MR_TypeInfo) &mercury_data_builtin__type_ctor_info_int_0
}};
...
const MR_PseudoTypeInfo mercury_data_check_hlds__delay_info__field_types_delay_info_0_0[] = {
	(MR_PseudoTypeInfo) &mercury_data_builtin__type_ctor_info_int_0,
	(MR_PseudoTypeInfo) &mercury_data_stack__ti_stack_1tree234__ti_tree234_2builtin__type_ctor_info_int_0check_hlds__mode_errors__type_ctor_info_delayed_goal_0,
	...
	(MR_PseudoTypeInfo) &mercury_data_stack__ti_stack_1builtin__type_ctor_info_int_0
};
...
MR_BEGIN_MODULE(check_hlds__delay_info_module0)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__check_hlds__delay_info__delay_info_check_invariant_1_0);
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'delay_info_check_invariant'/1 mode 0 */
...
MR_BEGIN_MODULE(check_hlds__delay_info_module1)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__check_hlds__delay_info__delay_info_init_1_0);
	MR_init_label4(check_hlds__delay_info__delay_info_init_1_0,3,7,9,10)
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'delay_info_init'/1 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
...
MR_def_label(check_hlds__delay_info__delay_info_init_1_0,3)
	...
	MR_np_call_localret_ent(map__init_1_0,
		check_hlds__delay_info__delay_info_init_1_0_i7);
MR_def_label(check_hlds__delay_info__delay_info_init_1_0,7)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(2) = MR_r1;
	MR_r1 = MR_sv(3);
	MR_r2 = (MR_Word) MR_TAG_COMMON(0,1,2);
	MR_np_call_localret_ent(map__init_1_0,
		check_hlds__delay_info__delay_info_init_1_0_i9);
MR_def_label(check_hlds__delay_info__delay_info_init_1_0,9)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(3) = MR_r1;
	MR_r1 = (MR_Word) MR_INT_CTOR_ADDR;
	MR_np_call_localret_ent(stack__init_1_0,
		check_hlds__delay_info__delay_info_init_1_0_i10);
MR_def_label(check_hlds__delay_info__delay_info_init_1_0,10)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_BEGIN_MODULE(check_hlds__delay_info_module2)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__check_hlds__delay_info__delay_info_enter_conj_2_0);
	MR_init_label3(check_hlds__delay_info__delay_info_enter_conj_2_0,2,4,5)
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'delay_info_enter_conj'/2 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
...
MR_def_label(check_hlds__delay_info__delay_info_enter_conj_2_0,4)
	...
	MR_r3 = (MR_Integer) 0;
	MR_np_call_localret_ent(stack__push_3_0,
		check_hlds__delay_info__delay_info_enter_conj_2_0_i5);
MR_def_label(check_hlds__delay_info__delay_info_enter_conj_2_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_tag_alloc_heap(MR_r2, 0, (MR_Integer) 5);
...
MR_BEGIN_MODULE(check_hlds__delay_info_module3)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__check_hlds__delay_info__delete_waiting_vars_4_0);
	MR_init_label7(check_hlds__delay_info__delete_waiting_vars_4_0,29,3,7,8,10,9,13)
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'delete_waiting_vars'/4 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
...
MR_def_label(check_hlds__delay_info__delete_waiting_vars_4_0,29)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_def_label(check_hlds__delay_info__delete_waiting_vars_4_0,7)
	...
	MR_np_call_localret_ent(map__delete_3_0,
		check_hlds__delay_info__delete_waiting_vars_4_0_i8);
MR_def_label(check_hlds__delay_info__delete_waiting_vars_4_0,8)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(5) = MR_r1;
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(check_hlds__delay_info, delay_goal_num);
...
MR_def_label(check_hlds__delay_info__delete_waiting_vars_4_0,10)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(check_hlds__delay_info__delete_waiting_vars_4_0_i9);
	}
	MR_r1 = MR_sv(7);
	MR_r2 = MR_sv(8);
	MR_r3 = MR_sv(3);
	MR_r4 = MR_sv(2);
	MR_np_call_localret_ent(map__delete_3_0,
		check_hlds__delay_info__delete_waiting_vars_4_0_i13);
MR_def_label(check_hlds__delay_info__delete_waiting_vars_4_0,9)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(6);
	MR_r2 = MR_sv(7);
	MR_r3 = MR_sv(8);
	...
	MR_np_call_localret_ent(f_109_97_112_95_95_84_121_112_101_83_112_101_99_79_102_95_95_112_114_101_100_95_95_115_101_116_95_95_91_75_32_61_32_118_97_114_40_86_95_50_41_93_95_48_95_49_4_0,
		check_hlds__delay_info__delete_waiting_vars_4_0_i13);
MR_def_label(check_hlds__delay_info__delete_waiting_vars_4_0,13)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_sv(1);
	{
	MR_Word MR_tempr1;
	...
	MR_GOTO_LAB(check_hlds__delay_info__delete_waiting_vars_4_0_i29);
	}
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_thread_engine_base
...
MR_BEGIN_MODULE(check_hlds__delay_info_module4)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__check_hlds__delay_info__remove_delayed_goals_5_0);
	MR_init_label5(check_hlds__delay_info__remove_delayed_goals_5_0,17,3,4,7,8)
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'remove_delayed_goals'/5 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
...
MR_def_label(check_hlds__delay_info__remove_delayed_goals_5_0,17)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
...
MR_def_label(check_hlds__delay_info__remove_delayed_goals_5_0,4)
	...
	MR_np_call_localret_ent(set__to_sorted_list_2_0,
		check_hlds__delay_info__remove_delayed_goals_5_0_i7);
MR_def_label(check_hlds__delay_info__remove_delayed_goals_5_0,7)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_sv(4);
	MR_r3 = MR_sv(3);
	MR_np_call_localret_ent(check_hlds__delay_info__delete_waiting_vars_4_0,
		check_hlds__delay_info__remove_delayed_goals_5_0_i8);
MR_def_label(check_hlds__delay_info__remove_delayed_goals_5_0,8)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
	...
	MR_GOTO_LAB(check_hlds__delay_info__remove_delayed_goals_5_0_i17);
	}
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_thread_engine_base
...
MR_BEGIN_MODULE(check_hlds__delay_info_module5)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__check_hlds__delay_info__delay_info_leave_conj_3_0);
	MR_init_label5(check_hlds__delay_info__delay_info_leave_conj_3_0,3,4,5,6,7)
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'delay_info_leave_conj'/3 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
...
MR_def_label(check_hlds__delay_info__delay_info_leave_conj_3_0,6)
	...
	MR_np_call_localret_ent(map__values_2_0,
		check_hlds__delay_info__delay_info_leave_conj_3_0_i7);
MR_def_label(check_hlds__delay_info__delay_info_leave_conj_3_0,7)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_tag_alloc_heap(MR_r2, 0, (MR_Integer) 5);
...
MR_BEGIN_MODULE(check_hlds__delay_info_module6)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__check_hlds__delay_info__add_waiting_vars_5_0);
	MR_init_label8(check_hlds__delay_info__add_waiting_vars_5_0,31,3,8,4,12,13,14,16)
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'add_waiting_vars'/5 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(check_hlds__delay_info__add_waiting_vars_5_0)
	...
	MR_incr_sp(9);
	MR_sv(9) = (MR_Word) MR_succip;
MR_def_label(check_hlds__delay_info__add_waiting_vars_5_0,31)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
...
MR_def_label(check_hlds__delay_info__add_waiting_vars_5_0,3)
	...
	MR_np_call_localret_ent(f_109_97_112_95_95_84_121_112_101_83_112_101_99_79_102_95_95_112_114_101_100_95_111_114_95_102_117_110_99_95_95_115_101_97_114_99_104_95_95_91_75_32_61_32_118_97_114_40_86_95_50_41_93_95_48_95_49_3_0,
		check_hlds__delay_info__add_waiting_vars_5_0_i8);
MR_def_label(check_hlds__delay_info__add_waiting_vars_5_0,8)
	...
	MR_r2 = (MR_Word) MR_TAG_COMMON(0,1,1);
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(check_hlds__delay_info, delay_goal_num);
	MR_GOTO_LAB(check_hlds__delay_info__add_waiting_vars_5_0_i13);
MR_def_label(check_hlds__delay_info__add_waiting_vars_5_0,4)
	...
	MR_r2 = MR_sv(8);
	MR_np_call_localret_ent(map__init_1_0,
		check_hlds__delay_info__add_waiting_vars_5_0_i12);
MR_def_label(check_hlds__delay_info__add_waiting_vars_5_0,12)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r3 = MR_sv(1);
	MR_r4 = MR_sv(2);
	MR_r5 = MR_r1;
	...
	MR_r2 = MR_sv(8);
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(check_hlds__delay_info, delay_goal_num);
MR_def_label(check_hlds__delay_info__add_waiting_vars_5_0,13)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(1) = MR_r3;
	MR_sv(2) = MR_r4;
	MR_sv(8) = MR_r2;
	MR_np_call_localret_ent(map__set_4_0,
		check_hlds__delay_info__add_waiting_vars_5_0_i14);
MR_def_label(check_hlds__delay_info__add_waiting_vars_5_0,14)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
	...
	MR_np_call_localret_ent(f_109_97_112_95_95_84_121_112_101_83_112_101_99_79_102_95_95_112_114_101_100_95_95_115_101_116_95_95_91_75_32_61_32_118_97_114_40_86_95_50_41_93_95_48_95_49_4_0,
		check_hlds__delay_info__add_waiting_vars_5_0_i16);
MR_def_label(check_hlds__delay_info__add_waiting_vars_5_0,16)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
	...
	MR_r4 = MR_tempr1;
	MR_succip_word = MR_sv(9);
	MR_GOTO_LAB(check_hlds__delay_info__add_waiting_vars_5_0_i31);
	}
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_thread_engine_base
...
MR_BEGIN_MODULE(check_hlds__delay_info_module7)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__check_hlds__delay_info__delay_info_delay_goal_4_0);
	MR_init_label7(check_hlds__delay_info__delay_info_delay_goal_4_0,2,3,5,7,8,11,12)
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'delay_info_delay_goal'/4 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
...
MR_def_label(check_hlds__delay_info__delay_info_delay_goal_4_0,3)
	...
	MR_tempr1 = MR_sv(5);
	MR_sv(5) = MR_r1;
	MR_sv(9) = (MR_Word) MR_CTOR0_ADDR(check_hlds__mode_errors, delayed_goal);
...
MR_def_label(check_hlds__delay_info__delay_info_delay_goal_4_0,8)
	...
	MR_np_call_localret_ent(set__to_sorted_list_2_0,
		check_hlds__delay_info__delay_info_delay_goal_4_0_i11);
MR_def_label(check_hlds__delay_info__delay_info_delay_goal_4_0,11)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_sv(2);
	MR_r3 = MR_r1;
	MR_r4 = MR_sv(6);
	MR_np_call_localret_ent(check_hlds__delay_info__add_waiting_vars_5_0,
		check_hlds__delay_info__delay_info_delay_goal_4_0_i12);
MR_def_label(check_hlds__delay_info__delay_info_delay_goal_4_0,12)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_tag_alloc_heap(MR_r2, 0, (MR_Integer) 5);
	MR_tfield(0, MR_r2, 0) = MR_sv(4);
	MR_tfield(0, MR_r2, 1) = MR_sv(1);
...
MR_BEGIN_MODULE(check_hlds__delay_info_module8)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__check_hlds__delay_info__add_pending_goals_6_0);
	MR_init_label8(check_hlds__delay_info__add_pending_goals_6_0,32,3,6,7,10,13,8,17)
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'add_pending_goals'/6 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(check_hlds__delay_info__add_pending_goals_6_0)
	...
	MR_incr_sp(8);
	MR_sv(8) = (MR_Word) MR_succip;
MR_def_label(check_hlds__delay_info__add_pending_goals_6_0,32)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
...
MR_def_label(check_hlds__delay_info__add_pending_goals_6_0,3)
	...
	MR_np_call_localret_ent(map__lookup_3_0,
		check_hlds__delay_info__add_pending_goals_6_0_i6);
...
MR_def_label(check_hlds__delay_info__add_pending_goals_6_0,7)
	...
	MR_np_call_localret_ent(f_109_97_112_95_95_84_121_112_101_83_112_101_99_79_102_95_95_112_114_101_100_95_111_114_95_102_117_110_99_95_95_115_101_97_114_99_104_95_95_91_75_32_61_32_105_110_116_93_95_48_95_49_3_0,
		check_hlds__delay_info__add_pending_goals_6_0_i10);
MR_def_label(check_hlds__delay_info__add_pending_goals_6_0,10)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(check_hlds__delay_info__add_pending_goals_6_0_i8);
	}
	{
	MR_Word MR_tempr1;
	...
	MR_np_call_localret_ent(list__append_3_1,
		check_hlds__delay_info__add_pending_goals_6_0_i13);
MR_def_label(check_hlds__delay_info__add_pending_goals_6_0,13)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r4 = MR_sv(2);
	MR_r2 = MR_sv(4);
	MR_r3 = MR_r1;
	MR_r1 = MR_sv(7);
	MR_np_call_localret_ent(f_109_97_112_95_95_84_121_112_101_83_112_101_99_79_102_95_95_112_114_101_100_95_95_115_101_116_95_95_91_75_32_61_32_105_110_116_93_95_48_95_49_4_0,
		check_hlds__delay_info__add_pending_goals_6_0_i17);
MR_def_label(check_hlds__delay_info__add_pending_goals_6_0,8)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 2);
	...
	MR_np_call_localret_ent(f_109_97_112_95_95_84_121_112_101_83_112_101_99_79_102_95_95_112_114_101_100_95_95_115_101_116_95_95_91_75_32_61_32_105_110_116_93_95_48_95_49_4_0,
		check_hlds__delay_info__add_pending_goals_6_0_i17);
MR_def_label(check_hlds__delay_info__add_pending_goals_6_0,17)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
	...
	MR_GOTO_LAB(check_hlds__delay_info__add_pending_goals_6_0_i32);
	}
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_thread_engine_base
...
MR_BEGIN_MODULE(check_hlds__delay_info_module9)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__check_hlds__delay_info__delay_info_bind_var_3_0);
	MR_init_label4(check_hlds__delay_info__delay_info_bind_var_3_0,6,8,9,2)
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'delay_info_bind_var'/3 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
...
MR_def_label(check_hlds__delay_info__delay_info_bind_var_3_0,6)
	...
	MR_r3 = MR_sv(6);
	MR_np_call_localret_ent(map__keys_2_0,
		check_hlds__delay_info__delay_info_bind_var_3_0_i8);
MR_def_label(check_hlds__delay_info__delay_info_bind_var_3_0,8)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_sv(6);
	MR_r3 = MR_sv(4);
	MR_r4 = MR_sv(3);
	MR_np_call_localret_ent(check_hlds__delay_info__add_pending_goals_6_0,
		check_hlds__delay_info__delay_info_bind_var_3_0_i9);
MR_def_label(check_hlds__delay_info__delay_info_bind_var_3_0,9)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
...
MR_BEGIN_MODULE(check_hlds__delay_info_module10)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__check_hlds__delay_info__delay_info_bind_var_list_3_0);
	MR_init_label3(check_hlds__delay_info__delay_info_bind_var_list_3_0,10,3,4)
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'delay_info_bind_var_list'/3 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
...
MR_def_label(check_hlds__delay_info__delay_info_bind_var_list_3_0,10)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
...
MR_def_label(check_hlds__delay_info__delay_info_bind_var_list_3_0,4)
	...
	MR_GOTO_LAB(check_hlds__delay_info__delay_info_bind_var_list_3_0_i10);
	}
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_thread_engine_base
...
MR_BEGIN_MODULE(check_hlds__delay_info_module11)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__check_hlds__delay_info__delay_info_bind_all_vars_2_0);
	MR_init_label1(check_hlds__delay_info__delay_info_bind_all_vars_2_0,5)
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'delay_info_bind_all_vars'/2 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_define_entry(mercury__check_hlds__delay_info__delay_info_bind_all_vars_2_0);
	...
	MR_np_call_localret_ent(map__keys_2_0,
		check_hlds__delay_info__delay_info_bind_all_vars_2_0_i5);
MR_def_label(check_hlds__delay_info__delay_info_bind_all_vars_2_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_sv(1);
	MR_succip_word = MR_sv(2);
	MR_decr_sp(2);
...
MR_BEGIN_MODULE(check_hlds__delay_info_module12)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__check_hlds__delay_info__delay_info_wakeup_goals_3_0);
	MR_init_label8(check_hlds__delay_info__delay_info_wakeup_goals_3_0,4,7,9,10,11,12,14,2)
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'delay_info_wakeup_goals'/3 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_define_entry(mercury__check_hlds__delay_info__delay_info_wakeup_goals_3_0);
	...
	MR_r3 = MR_sv(3);
	MR_np_call_localret_ent(f_109_97_112_95_95_84_121_112_101_83_112_101_99_79_102_95_95_112_114_101_100_95_111_114_95_102_117_110_99_95_95_115_101_97_114_99_104_95_95_91_75_32_61_32_105_110_116_93_95_48_95_49_3_0,
		check_hlds__delay_info__delay_info_wakeup_goals_3_0_i4);
MR_def_label(check_hlds__delay_info__delay_info_wakeup_goals_3_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
...
MR_def_label(check_hlds__delay_info__delay_info_wakeup_goals_3_0,7)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(7) = MR_r1;
	MR_sv(10) = (MR_Word) MR_CTOR0_ADDR(check_hlds__mode_errors, delayed_goal);
...
MR_def_label(check_hlds__delay_info__delay_info_wakeup_goals_3_0,11)
	...
	MR_np_call_localret_ent(stack__push_3_0,
		check_hlds__delay_info__delay_info_wakeup_goals_3_0_i12);
MR_def_label(check_hlds__delay_info__delay_info_wakeup_goals_3_0,12)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_tag_alloc_heap(MR_r2, 0, (MR_Integer) 5);
	...
	MR_np_localcall_lab(check_hlds__delay_info__delay_info_wakeup_goals_3_0,
		check_hlds__delay_info__delay_info_wakeup_goals_3_0_i14);
MR_def_label(check_hlds__delay_info__delay_info_wakeup_goals_3_0,14)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 2);
...
MR_BEGIN_MODULE(check_hlds__delay_info_module13)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury____Unify___check_hlds__delay_info__delay_goal_num_0_0);
...
MR_BEGIN_MODULE(check_hlds__delay_info_module14)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury____Compare___check_hlds__delay_info__delay_goal_num_0_0);
...
MR_BEGIN_MODULE(check_hlds__delay_info_module15)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury____Unify___check_hlds__delay_info__delay_info_0_0);
	MR_init_label5(__Unify___check_hlds__delay_info__delay_info_0_0,5,10,13,17,1)
MR_BEGIN_CODE
...
MR_define_entry(mercury____Unify___check_hlds__delay_info__delay_info_0_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if ((MR_r1 == MR_r2)) {
		MR_GOTO_LAB(__Unify___check_hlds__delay_info__delay_info_0_0_i17);
	}
	MR_incr_sp(7);
	...
	MR_np_call_localret_ent(__Unify___stack__stack_1_0,
		__Unify___check_hlds__delay_info__delay_info_0_0_i5);
MR_def_label(__Unify___check_hlds__delay_info__delay_info_0_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(__Unify___check_hlds__delay_info__delay_info_0_0_i1);
	}
	...
	MR_np_call_localret_ent(__Unify___tree234__tree234_2_0,
		__Unify___check_hlds__delay_info__delay_info_0_0_i10);
MR_def_label(__Unify___check_hlds__delay_info__delay_info_0_0,10)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(__Unify___check_hlds__delay_info__delay_info_0_0_i1);
	}
	...
	MR_r4 = MR_sv(5);
	MR_np_call_localret_ent(__Unify___tree234__tree234_2_0,
		__Unify___check_hlds__delay_info__delay_info_0_0_i13);
MR_def_label(__Unify___check_hlds__delay_info__delay_info_0_0,13)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(__Unify___check_hlds__delay_info__delay_info_0_0_i1);
	}
...
MR_def_label(__Unify___check_hlds__delay_info__delay_info_0_0,17)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_TRUE;
	MR_proceed();
...
MR_BEGIN_MODULE(check_hlds__delay_info_module16)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury____Compare___check_hlds__delay_info__delay_info_0_0);
	MR_init_label7(__Compare___check_hlds__delay_info__delay_info_0_0,3,2,5,10,17,22,65)
MR_BEGIN_CODE
...
MR_def_label(__Compare___check_hlds__delay_info__delay_info_0_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___check_hlds__delay_info__delay_info_0_0_i65);
	}
	MR_r1 = (MR_Word) MR_TAG_COMMON(0,0,0);
	MR_r2 = MR_sv(1);
	MR_r3 = MR_sv(5);
	MR_np_call_localret_ent(__Compare___stack__stack_1_0,
		__Compare___check_hlds__delay_info__delay_info_0_0_i10);
MR_def_label(__Compare___check_hlds__delay_info__delay_info_0_0,10)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___check_hlds__delay_info__delay_info_0_0_i65);
	}
...
MR_def_label(__Compare___check_hlds__delay_info__delay_info_0_0,17)
	...
	MR_r4 = MR_sv(7);
	MR_np_call_localret_ent(__Compare___tree234__tree234_2_0,
		__Compare___check_hlds__delay_info__delay_info_0_0_i22);
MR_def_label(__Compare___check_hlds__delay_info__delay_info_0_0,22)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___check_hlds__delay_info__delay_info_0_0_i65);
	}
...
MR_def_label(__Compare___check_hlds__delay_info__delay_info_0_0,65)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(9);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
...
MR_BEGIN_MODULE(check_hlds__delay_info_module17)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury____Unify___check_hlds__delay_info__depth_num_0_0);
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(check_hlds__delay_info_module18)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury____Compare___check_hlds__delay_info__depth_num_0_0);
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(check_hlds__delay_info_module19)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury____Unify___check_hlds__delay_info__pending_goals_table_0_0);
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(check_hlds__delay_info_module20)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury____Compare___check_hlds__delay_info__pending_goals_table_0_0);
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(check_hlds__delay_info_module21)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury____Unify___check_hlds__delay_info__seq_num_0_0);
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(check_hlds__delay_info_module22)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury____Compare___check_hlds__delay_info__seq_num_0_0);
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(check_hlds__delay_info_module23)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury____Unify___check_hlds__delay_info__waiting_goals_0_0);
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(check_hlds__delay_info_module24)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury____Compare___check_hlds__delay_info__waiting_goals_0_0);
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(check_hlds__delay_info_module25)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury____Unify___check_hlds__delay_info__waiting_goals_table_0_0);
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(check_hlds__delay_info_module26)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury____Compare___check_hlds__delay_info__waiting_goals_table_0_0);
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(check_hlds__delay_info_module27)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__f_99_104_101_99_107_95_104_108_100_115_95_95_100_101_108_97_121_95_105_110_102_111_95_95_85_110_117_115_101_100_65_114_103_115_95_95_112_114_101_100_95_95_100_101_108_97_121_95_105_110_102_111_95_99_104_101_99_107_95_105_110_118_97_114_105_97_110_116_95_95_91_49_93_95_48_1_0);
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'UnusedArgs__pred__delay_info_check_invariant__[1]_0'/1 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
...
void mercury__check_hlds__delay_info__write_out_proc_statics(FILE *deep_fp, FILE *procrep_fp);
#endif
#ifdef MR_RECORD_TERM_SIZES
void mercury__check_hlds__delay_info__init_complexity_procs(void);
#endif
#ifdef MR_THREADSCOPE
void mercury__check_hlds__delay_info__init_threadscope_string_table(void);
#endif
...
void mercury__check_hlds__delay_info__write_out_proc_statics(FILE *deep_fp, FILE *procrep_fp)
{
	MR_write_out_module_proc_reps_start(procrep_fp, &mercury_data__module_common_layout__check_hlds__delay_info);
