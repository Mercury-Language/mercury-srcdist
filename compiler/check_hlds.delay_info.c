...
MR_decl_label1(__Unify___check_hlds__delay_info__delay_goal_num_0_0, 1)
MR_decl_label4(__Unify___check_hlds__delay_info__delay_info_0_0, 2,4,6,1)
MR_decl_label2(__Compare___check_hlds__delay_info__delay_goal_num_0_0, 3,7)
MR_decl_label5(__Compare___check_hlds__delay_info__delay_info_0_0, 3,7,11,15,22)
...
MR_BEGIN_MODULE(check_hlds__delay_info_module13)
	...
	MR_init_label1(__Unify___check_hlds__delay_info__delay_goal_num_0_0,1)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(check_hlds__delay_info_module14)
	...
	MR_init_label2(__Compare___check_hlds__delay_info__delay_goal_num_0_0,3,7)
MR_BEGIN_CODE
...
MR_def_static(__Compare___check_hlds__delay_info__delay_goal_num_0_0)
	...
	MR_np_call_localret_ent(private_builtin__builtin_compare_int_3_0,
		__Compare___check_hlds__delay_info__delay_goal_num_0_0_i3);
MR_def_label(__Compare___check_hlds__delay_info__delay_goal_num_0_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___check_hlds__delay_info__delay_goal_num_0_0_i7);
	}
	MR_r1 = MR_sv(1);
	MR_r2 = MR_sv(2);
...
MR_def_label(__Compare___check_hlds__delay_info__delay_goal_num_0_0,7)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_BEGIN_MODULE(check_hlds__delay_info_module15)
	...
	MR_init_label4(__Unify___check_hlds__delay_info__delay_info_0_0,2,4,6,1)
MR_BEGIN_CODE
...
MR_define_entry(mercury____Unify___check_hlds__delay_info__delay_info_0_0);
	...
	MR_np_call_localret_ent(__Unify___list__list_1_0,
		__Unify___check_hlds__delay_info__delay_info_0_0_i2);
MR_def_label(__Unify___check_hlds__delay_info__delay_info_0_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(__Unify___check_hlds__delay_info__delay_info_0_0_i1);
	}
...
MR_BEGIN_MODULE(check_hlds__delay_info_module16)
	...
	MR_init_label5(__Compare___check_hlds__delay_info__delay_info_0_0,3,7,11,15,22)
MR_BEGIN_CODE
...
MR_define_entry(mercury____Compare___check_hlds__delay_info__delay_info_0_0);
	...
	MR_np_call_localret_ent(private_builtin__builtin_compare_int_3_0,
		__Compare___check_hlds__delay_info__delay_info_0_0_i3);
MR_def_label(__Compare___check_hlds__delay_info__delay_info_0_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___check_hlds__delay_info__delay_info_0_0_i22);
	}
	MR_r1 = (MR_Word) MR_TAG_COMMON(0,0,0);
	MR_r2 = MR_sv(1);
	MR_r3 = MR_sv(5);
	MR_np_call_localret_ent(__Compare___list__list_1_0,
		__Compare___check_hlds__delay_info__delay_info_0_0_i7);
MR_def_label(__Compare___check_hlds__delay_info__delay_info_0_0,7)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___check_hlds__delay_info__delay_info_0_0_i22);
	}
	...
	MR_np_call_localret_ent(__Compare___tree234__tree234_2_0,
		__Compare___check_hlds__delay_info__delay_info_0_0_i11);
MR_def_label(__Compare___check_hlds__delay_info__delay_info_0_0,11)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___check_hlds__delay_info__delay_info_0_0_i22);
	}
	...
	MR_r4 = MR_sv(7);
	MR_np_call_localret_ent(__Compare___tree234__tree234_2_0,
		__Compare___check_hlds__delay_info__delay_info_0_0_i15);
MR_def_label(__Compare___check_hlds__delay_info__delay_info_0_0,15)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___check_hlds__delay_info__delay_info_0_0_i22);
	}
