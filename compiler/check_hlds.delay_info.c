  ...
  MR_Word * STATE_VARIABLE_DelayInfo_24)
{
  ...
  if (succeeded)
  {
    ...
    else
    {
      ...
      MR_Word Var_25;
      MR_Word DelayedGoal_52;
      MR_Box conv1_DelayedGoals0_16;
      MR_Box conv2_DelayedGoal_52;
      ...
      mercury__map__det_remove_4_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0), (MR_Word) (&check_hlds__mode_errors__check_hlds__mode_errors__type_ctor_info_delayed_goal_0), ((MR_Box) (HeadSeqNum_13)), &conv2_DelayedGoal_52, DelayedGoals0_16, &DelayedGoals1_19);
      DelayedGoal_52 = ((MR_Word) (conv2_DelayedGoal_52));
      HeadGoal_18 = ((MR_Word) ((MR_hl_field(MR_mktag(0), DelayedGoal_52, (MR_Integer) 2))));
