...
MR_decl_label8(check_hlds__delay_info__add_pending_goals_6_0, 20,3,4,5,7,9,6,11)
MR_decl_label8(check_hlds__delay_info__add_waiting_vars_5_0, 19,3,5,4,7,8,9,10)
...
MR_decl_label7(check_hlds__delay_info__delete_waiting_vars_4_0, 24,3,4,5,7,6,10)
MR_decl_label5(check_hlds__delay_info__remove_delayed_goals_5_0, 12,3,4,5,6)
...
MR_BEGIN_MODULE(check_hlds__delay_info_module3)
	...
	MR_init_label7(check_hlds__delay_info__delete_waiting_vars_4_0,24,3,4,5,7,6,10)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(check_hlds__delay_info_module4)
	...
	MR_init_label5(check_hlds__delay_info__remove_delayed_goals_5_0,12,3,4,5,6)
MR_BEGIN_CODE
...
MR_def_static(check_hlds__delay_info__remove_delayed_goals_5_0)
	...
	MR_incr_sp(6);
	MR_sv(6) = (MR_Word) MR_succip;
MR_def_label(check_hlds__delay_info__remove_delayed_goals_5_0,12)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
...
MR_def_label(check_hlds__delay_info__remove_delayed_goals_5_0,6)
	...
	MR_GOTO_LAB(check_hlds__delay_info__remove_delayed_goals_5_0_i12);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_thread_engine_base
#endif
...
MR_BEGIN_MODULE(check_hlds__delay_info_module6)
	...
	MR_init_label8(check_hlds__delay_info__add_waiting_vars_5_0,19,3,5,4,7,8,9,10)
MR_BEGIN_CODE
...
MR_def_static(check_hlds__delay_info__add_waiting_vars_5_0)
	...
	MR_incr_sp(9);
	MR_sv(9) = (MR_Word) MR_succip;
MR_def_label(check_hlds__delay_info__add_waiting_vars_5_0,19)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
...
MR_def_label(check_hlds__delay_info__add_waiting_vars_5_0,10)
	...
	MR_r3 = MR_sv(2);
	MR_succip_word = MR_sv(9);
	MR_GOTO_LAB(check_hlds__delay_info__add_waiting_vars_5_0_i19);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_thread_engine_base
#endif
...
MR_BEGIN_MODULE(check_hlds__delay_info_module8)
	...
	MR_init_label8(check_hlds__delay_info__add_pending_goals_6_0,20,3,4,5,7,9,6,11)
MR_BEGIN_CODE
...
MR_def_label(check_hlds__delay_info__add_pending_goals_6_0,20)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
...
MR_def_label(check_hlds__delay_info__add_pending_goals_6_0,11)
	...
	MR_GOTO_LAB(check_hlds__delay_info__add_pending_goals_6_0_i20);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_thread_engine_base
#endif
