  ...
  MR_Word * STATE_VARIABLE_DelayInfo_24)
{
  ...
  if (succeeded)
  {
    ...
    else
    {
      ...
      HeadGoal_18 = ((MR_Word) ((MR_hl_field(0, DelayedGoal_45, 2))));
...
check_hlds__delay_info__delay_info_delay_goal_4_p_0(
  ...
  MR_Word * DelayInfo_8)
{
  MR_Word Vars_9 = ((MR_Word) ((MR_hl_field(0, Error_5, 0))));
  MR_Integer CurrentDepth_13 = ((MR_Integer) ((MR_hl_field(0, DelayInfo0_7, 0))));
  MR_Word DelayedGoalStack0_14 = ((MR_Word) ((MR_hl_field(0, DelayInfo0_7, 1))));
  MR_Word WaitingGoalsTable0_15 = ((MR_Word) ((MR_hl_field(0, DelayInfo0_7, 2))));
  MR_Word PendingGoals_16 = ((MR_Word) ((MR_hl_field(0, DelayInfo0_7, 3))));
  MR_Word NextSeqNums0_17 = ((MR_Word) ((MR_hl_field(0, DelayInfo0_7, 4))));
...
check_hlds__delay_info__delay_info_leave_conj_3_p_0(
  ...
  MR_Word * DelayInfo_6)
{
  MR_Integer CurrentDepth0_7 = ((MR_Integer) ((MR_hl_field(0, DelayInfo0_4, 0))));
  MR_Word DelayedGoalStack0_8 = ((MR_Word) ((MR_hl_field(0, DelayInfo0_4, 1))));
  MR_Word WaitingGoalsTable0_9 = ((MR_Word) ((MR_hl_field(0, DelayInfo0_4, 2))));
  MR_Word PendingGoals_10 = ((MR_Word) ((MR_hl_field(0, DelayInfo0_4, 3))));
  MR_Word NextSeqNums0_11 = ((MR_Word) ((MR_hl_field(0, DelayInfo0_4, 4))));
...
check_hlds__delay_info__delay_info_enter_conj_2_p_0(
  ...
  MR_Word * DelayInfo_4)
{
  MR_Integer CurrentDepth0_5 = ((MR_Integer) ((MR_hl_field(0, DelayInfo0_3, 0))));
  MR_Word DelayedGoalStack0_6 = ((MR_Word) ((MR_hl_field(0, DelayInfo0_3, 1))));
  MR_Word WaitingGoalsTable_7 = ((MR_Word) ((MR_hl_field(0, DelayInfo0_3, 2))));
  MR_Word PendingGoals_8 = ((MR_Word) ((MR_hl_field(0, DelayInfo0_3, 3))));
  MR_Word NextSeqNums0_9 = ((MR_Word) ((MR_hl_field(0, DelayInfo0_3, 4))));
