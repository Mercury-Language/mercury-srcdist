  ...
  MR_Word * STATE_VARIABLE_DelayInfo_24)
{
  ...
  if (succeeded)
  {
    ...
    else
    {
      ...
      MR_Word Var_25;
      MR_Word DelayedGoal_51;
      MR_Box conv1_DelayedGoals0_16;
      MR_Box conv2_DelayedGoal_51;
      ...
      mercury__map__det_remove_4_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0), (MR_Word) (&check_hlds__mode_errors__check_hlds__mode_errors__type_ctor_info_delayed_goal_0), ((MR_Box) (HeadSeqNum_13)), &conv2_DelayedGoal_51, DelayedGoals0_16, &DelayedGoals1_19);
      DelayedGoal_51 = ((MR_Word) (conv2_DelayedGoal_51));
      HeadGoal_18 = ((MR_Word) ((MR_hl_field(MR_mktag(0), DelayedGoal_51, (MR_Integer) 2))));
  ...
  MR_Word * STATE_VARIABLE_DelayedGoalMap_4)
{
  ...
  else
  {
    ...
    MR_Word DelayedGoal_21;
    MR_Box conv0_DelayedGoal_21;

    mercury__map__det_remove_4_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0), (MR_Word) (&check_hlds__mode_errors__check_hlds__mode_errors__type_ctor_info_delayed_goal_0), ((MR_Box) (SeqNum_8)), &conv0_DelayedGoal_21, STATE_VARIABLE_DelayedGoalMap_0_3, &STATE_VARIABLE_DelayedGoalMap_15_15);
    DelayedGoal_21 = ((MR_Word) (conv0_DelayedGoal_21));
    Goal_10 = ((MR_Word) ((MR_hl_field(MR_mktag(0), DelayedGoal_21, (MR_Integer) 2))));
