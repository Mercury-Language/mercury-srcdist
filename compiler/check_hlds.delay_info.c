...
MR_decl_label8(check_hlds__delay_info__add_pending_goals_6_0, 28,3,4,5,7,10,6,13)
MR_decl_label8(check_hlds__delay_info__add_waiting_vars_5_0, 25,3,5,4,7,8,9,10)
...
MR_decl_label7(check_hlds__delay_info__delay_info_delay_goal_4_0, 2,3,4,6,7,9,10)
...
MR_decl_label8(check_hlds__delay_info__delay_info_wakeup_goals_3_0, 3,6,7,8,9,10,12,2)
MR_decl_label7(check_hlds__delay_info__delete_waiting_vars_4_0, 27,3,4,5,8,6,11)
...
MR_decl_label7(__Compare___check_hlds__delay_info__delay_info_0_0, 3,2,5,9,13,17,60)
...
MR_BEGIN_MODULE(check_hlds__delay_info_module3)
	...
	MR_init_label7(check_hlds__delay_info__delete_waiting_vars_4_0,27,3,4,5,8,6,11)
MR_BEGIN_CODE
...
MR_def_label(check_hlds__delay_info__delete_waiting_vars_4_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(7) = (MR_Word) MR_CTOR0_ADDR(check_hlds__delay_info, delay_goal_num);
...
MR_BEGIN_MODULE(check_hlds__delay_info_module6)
	...
	MR_init_label8(check_hlds__delay_info__add_waiting_vars_5_0,25,3,5,4,7,8,9,10)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(check_hlds__delay_info_module7)
	...
	MR_init_label7(check_hlds__delay_info__delay_info_delay_goal_4_0,2,3,4,6,7,9,10)
MR_BEGIN_CODE
...
MR_def_label(check_hlds__delay_info__delay_info_delay_goal_4_0,7)
	...
	MR_np_call_localret_ent(parse_tree__set_of_var__to_sorted_list_2_0,
		check_hlds__delay_info__delay_info_delay_goal_4_0_i9);
MR_def_label(check_hlds__delay_info__delay_info_delay_goal_4_0,9)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_sv(7);
	MR_r3 = MR_r1;
	MR_r4 = MR_sv(3);
...
MR_BEGIN_MODULE(check_hlds__delay_info_module8)
	...
	MR_init_label8(check_hlds__delay_info__add_pending_goals_6_0,28,3,4,5,7,10,6,13)
MR_BEGIN_CODE
...
MR_def_label(check_hlds__delay_info__add_pending_goals_6_0,28)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
...
MR_def_label(check_hlds__delay_info__add_pending_goals_6_0,13)
	...
	MR_GOTO_LAB(check_hlds__delay_info__add_pending_goals_6_0_i28);
	}
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_thread_engine_base
...
MR_BEGIN_MODULE(check_hlds__delay_info_module12)
	...
	MR_init_label8(check_hlds__delay_info__delay_info_wakeup_goals_3_0,3,6,7,8,9,10,12,2)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(check_hlds__delay_info_module16)
	...
	MR_init_label7(__Compare___check_hlds__delay_info__delay_info_0_0,3,2,5,9,13,17,60)
MR_BEGIN_CODE
...
MR_def_label(__Compare___check_hlds__delay_info__delay_info_0_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___check_hlds__delay_info__delay_info_0_0_i60);
	}
	MR_r1 = (MR_Word) MR_TAG_COMMON(0,1,3);
	MR_r2 = MR_sv(1);
	MR_r3 = MR_sv(5);
...
MR_def_label(__Compare___check_hlds__delay_info__delay_info_0_0,60)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(9);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
