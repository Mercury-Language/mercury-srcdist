...
MR_decl_label7(check_hlds__delay_info__delay_info_delay_goal_4_0, 2,3,5,7,8,10,11)
...
MR_decl_label5(check_hlds__delay_info__remove_delayed_goals_5_0, 13,3,4,6,7)
...
MR_BEGIN_MODULE(check_hlds__delay_info_module4)
	...
	MR_init_label5(check_hlds__delay_info__remove_delayed_goals_5_0,13,3,4,6,7)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(check_hlds__delay_info_module7)
	...
	MR_init_label7(check_hlds__delay_info__delay_info_delay_goal_4_0,2,3,5,7,8,10,11)
MR_BEGIN_CODE
...
MR_def_label(check_hlds__delay_info__delay_info_delay_goal_4_0,8)
	...
	MR_np_call_localret_ent(parse_tree__set_of_var__to_sorted_list_2_0,
		check_hlds__delay_info__delay_info_delay_goal_4_0_i10);
MR_def_label(check_hlds__delay_info__delay_info_delay_goal_4_0,10)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_sv(8);
	MR_r3 = MR_r1;
	MR_r4 = MR_sv(3);
