...
MR_decl_label8(check_hlds__delay_info__add_pending_goals_6_0, 26,3,6,7,10,13,8,17)
MR_decl_label8(check_hlds__delay_info__add_waiting_vars_5_0, 25,3,8,4,12,13,14,16)
...
MR_decl_label7(check_hlds__delay_info__delete_waiting_vars_4_0, 27,3,7,8,10,9,13)
MR_decl_label5(check_hlds__delay_info__remove_delayed_goals_5_0, 14,3,4,7,8)
...
MR_decl_label7(__Compare___check_hlds__delay_info__delay_info_0_0, 3,2,5,10,17,22,50)
...
MR_BEGIN_MODULE(check_hlds__delay_info_module3)
	...
	MR_init_label7(check_hlds__delay_info__delete_waiting_vars_4_0,27,3,7,8,10,9,13)
MR_BEGIN_CODE
...
MR_def_label(check_hlds__delay_info__delete_waiting_vars_4_0,27)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_def_label(check_hlds__delay_info__delete_waiting_vars_4_0,13)
	...
	MR_GOTO_LAB(check_hlds__delay_info__delete_waiting_vars_4_0_i27);
	}
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_thread_engine_base
...
MR_BEGIN_MODULE(check_hlds__delay_info_module4)
	...
	MR_init_label5(check_hlds__delay_info__remove_delayed_goals_5_0,14,3,4,7,8)
MR_BEGIN_CODE
...
MR_def_label(check_hlds__delay_info__remove_delayed_goals_5_0,14)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
...
MR_def_label(check_hlds__delay_info__remove_delayed_goals_5_0,8)
	...
	MR_GOTO_LAB(check_hlds__delay_info__remove_delayed_goals_5_0_i14);
	}
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_thread_engine_base
...
MR_BEGIN_MODULE(check_hlds__delay_info_module6)
	...
	MR_init_label8(check_hlds__delay_info__add_waiting_vars_5_0,25,3,8,4,12,13,14,16)
MR_BEGIN_CODE
...
MR_def_static(check_hlds__delay_info__add_waiting_vars_5_0)
	...
	MR_incr_sp(9);
	MR_sv(9) = (MR_Word) MR_succip;
MR_def_label(check_hlds__delay_info__add_waiting_vars_5_0,25)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
...
MR_def_label(check_hlds__delay_info__add_waiting_vars_5_0,16)
	...
	MR_r4 = MR_tempr1;
	MR_succip_word = MR_sv(9);
	MR_GOTO_LAB(check_hlds__delay_info__add_waiting_vars_5_0_i25);
	}
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_thread_engine_base
...
MR_BEGIN_MODULE(check_hlds__delay_info_module8)
	...
	MR_init_label8(check_hlds__delay_info__add_pending_goals_6_0,26,3,6,7,10,13,8,17)
MR_BEGIN_CODE
...
MR_def_static(check_hlds__delay_info__add_pending_goals_6_0)
	...
	MR_incr_sp(8);
	MR_sv(8) = (MR_Word) MR_succip;
MR_def_label(check_hlds__delay_info__add_pending_goals_6_0,26)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
...
MR_def_label(check_hlds__delay_info__add_pending_goals_6_0,17)
	...
	MR_GOTO_LAB(check_hlds__delay_info__add_pending_goals_6_0_i26);
	}
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_thread_engine_base
...
MR_BEGIN_MODULE(check_hlds__delay_info_module16)
	...
	MR_init_label7(__Compare___check_hlds__delay_info__delay_info_0_0,3,2,5,10,17,22,50)
MR_BEGIN_CODE
...
MR_def_label(__Compare___check_hlds__delay_info__delay_info_0_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___check_hlds__delay_info__delay_info_0_0_i50);
	}
	MR_r1 = (MR_Word) MR_TAG_COMMON(0,0,0);
	MR_r2 = MR_sv(1);
	MR_r3 = MR_sv(5);
...
MR_def_label(__Compare___check_hlds__delay_info__delay_info_0_0,50)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(9);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
