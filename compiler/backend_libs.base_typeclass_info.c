  ...
  MR_Word * STATE_VARIABLE_RttiDatas_5)
{
  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      MR_Word MaybeInstancePredProcIds_39;
      MR_Word InstancePredProcIds_40;
      MR_Word ProcLabels_41;
      MR_Integer SuperClassCount_42;
      MR_Integer ClassArity_43;
      MR_Integer NumMethods_44;
      MR_Word ClassTable_69;
      MR_Word ClassDefn_70;
      MR_Word Var_71;
      MR_Word Var_72;
      MR_Box conv0_ClassDefn_70;

      parse_tree__pred_name__make_instance_string_2_p_0(InstanceTypes_17, &InstanceString_28);
      hlds__hlds_class__num_extra_instance_args_2_p_0(InstanceDefn_13, &NumExtra_36);
      Constraints_37 = ((MR_Word) ((MR_hl_field(MR_mktag(0), InstanceDefn_13, (MR_Integer) 6))));
      ...
      MaybeInstancePredProcIds_39 = ((MR_Word) ((MR_hl_field(MR_mktag(0), InstanceDefn_13, (MR_Integer) 8))));
      if ((MaybeInstancePredProcIds_39 == (MR_Word) ((MR_Unsigned) 0U)))
        {
        ...
        InstancePredProcIds_40 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MaybeInstancePredProcIds_39, (MR_Integer) 0))));
      backend_libs__base_typeclass_info__construct_proc_labels_3_p_0(ModuleInfo_1, InstancePredProcIds_40, &ProcLabels_41);
      hlds__hlds_module__module_info_get_class_table_2_p_0(ModuleInfo_1, &ClassTable_69);
      mercury__map__lookup_3_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_class_id_0), (MR_Word) (&hlds__hlds_class__hlds__hlds_class__type_ctor_info_hlds_class_defn_0), ClassTable_69, ((MR_Box) (ClassId_2)), &conv0_ClassDefn_70);
      ClassDefn_70 = ((MR_Word) (conv0_ClassDefn_70));
      Var_71 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ClassDefn_70, (MR_Integer) 1))));
      mercury__list__length_2_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_constraint_0), Var_71, &SuperClassCount_42);
      Var_72 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ClassDefn_70, (MR_Integer) 4))));
      mercury__list__length_2_p_0((MR_Word) (&backend_libs__base_typeclass_info_scalar_common_1[1]), Var_72, &ClassArity_43);
      mercury__list__length_2_p_0((MR_Word) (&hlds__hlds_rtti__hlds__hlds_rtti__type_ctor_info_rtti_proc_label_0), ProcLabels_41, &NumMethods_44);
      {
        BaseTypeClassInfo_29 = (MR_Word) MR_new_object(MR_Word, (6 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), BaseTypeClassInfo_29, 0) = ((MR_Box) (NumExtra_36));
        MR_hl_field(MR_mktag(0), BaseTypeClassInfo_29, 1) = ((MR_Box) (NumConstraints_38));
        MR_hl_field(MR_mktag(0), BaseTypeClassInfo_29, 2) = ((MR_Box) (SuperClassCount_42));
        MR_hl_field(MR_mktag(0), BaseTypeClassInfo_29, 3) = ((MR_Box) (ClassArity_43));
        MR_hl_field(MR_mktag(0), BaseTypeClassInfo_29, 4) = ((MR_Box) (NumMethods_44));
        MR_hl_field(MR_mktag(0), BaseTypeClassInfo_29, 5) = ((MR_Box) (ProcLabels_41));
      }
