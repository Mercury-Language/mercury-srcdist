  ...
  MR_Word * STATE_VARIABLE_RttiDatas_4)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      {
        MR_Word next_value_of_HeadVar__2_2 = Classes_11;
        MR_Word next_value_of_STATE_VARIABLE_RttiDatas_0_3 = STATE_VARIABLE_RttiDatas_17_17;
...
{
  {
    ...
    hlds__hlds_data__num_extra_instance_args_2_p_0(InstanceDefn_7, &NumExtra_9);
    ...
    mercury__map__lookup_3_p_0((MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_class_id_0, (MR_Word) &hlds__hlds_data__hlds__hlds_data__type_ctor_info_hlds_class_defn_0, ClassTable_45, ((MR_Box) (ClassId_6)), &conv0_ClassDefn_46);
