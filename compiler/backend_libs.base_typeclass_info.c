...
{
  {
    ...
    backend_libs__base_typeclass_info__gen_infos_for_classes_4_p_0(ModuleInfo_3, AllInstances_6, (MR_Word) ((MR_Integer) 0), RttiDatas_4);
  }
}
...
{
  {
    ...
    if ((MaybeInstancePredProcIds_12 == (MR_Word) ((MR_Integer) 0)))
    {
      {
