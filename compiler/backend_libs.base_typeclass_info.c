  ...
  MR_Word * STATE_VARIABLE_RttiDatas_5)
{
  ...
  else
  {
    ...
    succeeded = (Body_22 != (MR_Word) ((MR_Unsigned) 0U));
    if (succeeded)
    {
    ...
    if (succeeded)
    {
      ...
      parse_tree__pred_name__make_instance_string_2_p_0(InstanceTypes_17, &InstanceString_27);
      ...
      {
        RttiData_30 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(3), RttiData_30, 0) = ((MR_Box) ((MR_Unsigned) 2U));
  ...
  MR_Word * BaseTypeClassInfo_8)
{
  ...
  MR_Word ClassTable_44;
  MR_Word ClassDefn_45;
  MR_Word Var_46;
  MR_Word Var_47;
  MR_Box conv0_ClassDefn_45;
  ...
  hlds__hlds_module__module_info_get_class_table_2_p_0(ModuleInfo_5, &ClassTable_44);
  mercury__map__lookup_3_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_class_id_0), (MR_Word) (&hlds__hlds_class__hlds__hlds_class__type_ctor_info_hlds_class_defn_0), ClassTable_44, ((MR_Box) (ClassId_6)), &conv0_ClassDefn_45);
  ClassDefn_45 = ((MR_Word) (conv0_ClassDefn_45));
  Var_46 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ClassDefn_45, (MR_Integer) 1))));
  mercury__list__length_2_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_constraint_0), Var_46, &SuperClassCount_15);
  Var_47 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ClassDefn_45, (MR_Integer) 4))));
  mercury__list__length_2_p_0((MR_Word) (&backend_libs__base_typeclass_info_scalar_common_1[1]), Var_47, &ClassArity_16);
