...
MR_decl_label1(transform_hlds__accumulator__IntroducedFrom__pred__identify_recursive_calls__595__1_4_0, 1)
...
MR_decl_label10(transform_hlds__accumulator__accu_process_assoc_set_12_0, 4,3,5,6,8,9,11,12,15,16)
MR_decl_label10(transform_hlds__accumulator__accu_process_assoc_set_12_0, 17,18,19,20,24,25,26,27,30,32)
MR_decl_label10(transform_hlds__accumulator__accu_process_assoc_set_12_0, 34,29,36,40,43,49,50,23,52,54)
MR_decl_label2(transform_hlds__accumulator__accu_process_assoc_set_12_0, 55,1)
MR_decl_label10(transform_hlds__accumulator__accu_process_update_set_13_0, 58,4,5,8,7,10,11,12,14,15)
MR_decl_label7(transform_hlds__accumulator__accu_process_update_set_13_0, 16,17,19,22,24,28,1)
...
MR_decl_label10(transform_hlds__accumulator__accu_stage2_15_0, 2,3,4,5,7,8,11,12,13,14)
...
MR_decl_label10(transform_hlds__accumulator__accu_transform_proc_8_0, 2,3,4,7,9,56,11,12,13,10)
MR_decl_label10(transform_hlds__accumulator__accu_transform_proc_8_0, 17,18,24,30,31,33,32,48,51,53)
MR_decl_label2(transform_hlds__accumulator__accu_transform_proc_8_0, 6,54)
...
MR_BEGIN_MODULE(transform_hlds__accumulator_module20)
	...
	MR_init_label10(transform_hlds__accumulator__accu_process_assoc_set_12_0,4,3,5,6,8,9,11,12,15,16)
	MR_init_label10(transform_hlds__accumulator__accu_process_assoc_set_12_0,17,18,19,20,24,25,26,27,30,32)
	MR_init_label10(transform_hlds__accumulator__accu_process_assoc_set_12_0,34,29,36,40,43,49,50,23,52,54)
	MR_init_label2(transform_hlds__accumulator__accu_process_assoc_set_12_0,55,1)
MR_BEGIN_CODE
...
MR_def_label(transform_hlds__accumulator__accu_process_assoc_set_12_0,20)
	...
	if (MR_INT_NE(MR_sv(17),0)) {
		MR_GOTO_LAB(transform_hlds__accumulator__accu_process_assoc_set_12_0_i23);
	}
	MR_r1 = MR_sv(21);
	MR_r2 = MR_sv(12);
	}
...
MR_def_label(transform_hlds__accumulator__accu_process_assoc_set_12_0,27)
	...
	MR_np_call_localret_ent(transform_hlds__accumulator__accu_has_heuristic_3_0,
		transform_hlds__accumulator__accu_process_assoc_set_12_0_i30);
MR_def_label(transform_hlds__accumulator__accu_process_assoc_set_12_0,30)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(transform_hlds__accumulator__accu_process_assoc_set_12_0_i29);
	}
	MR_r1 = MR_sv(20);
	MR_r2 = MR_sv(1);
	MR_r3 = MR_sv(6);
	...
	MR_np_call_localret_ent(transform_hlds__accumulator__accu_heuristic_5_0,
		transform_hlds__accumulator__accu_process_assoc_set_12_0_i32);
MR_def_label(transform_hlds__accumulator__accu_process_assoc_set_12_0,32)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(transform_hlds__accumulator__accu_process_assoc_set_12_0_i1);
	}
	...
	MR_np_call_localret_ent(parse_tree__set_of_var__member_2_0,
		transform_hlds__accumulator__accu_process_assoc_set_12_0_i34);
MR_def_label(transform_hlds__accumulator__accu_process_assoc_set_12_0,34)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(transform_hlds__accumulator__accu_process_assoc_set_12_0_i1);
	}
	...
	MR_np_call_localret_ent(fn__parse_tree__set_of_var__to_sorted_list_1_0,
		transform_hlds__accumulator__accu_process_assoc_set_12_0_i40);
MR_def_label(transform_hlds__accumulator__accu_process_assoc_set_12_0,29)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(14);
	MR_np_call_localret_ent(fn__hlds__hlds_goal__goal_info_get_context_1_0,
		transform_hlds__accumulator__accu_process_assoc_set_12_0_i36);
MR_def_label(transform_hlds__accumulator__accu_process_assoc_set_12_0,36)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tag_alloc_heap(MR_tempr1, 0, (MR_Integer) 4);
...
MR_def_label(transform_hlds__accumulator__accu_process_assoc_set_12_0,40)
	...
	MR_np_call_localret_ent(__Unify___list__list_1_0,
		transform_hlds__accumulator__accu_process_assoc_set_12_0_i43);
MR_def_label(transform_hlds__accumulator__accu_process_assoc_set_12_0,43)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(transform_hlds__accumulator__accu_process_assoc_set_12_0_i1);
	}
...
MR_def_label(transform_hlds__accumulator__accu_process_assoc_set_12_0,50)
	...
	MR_np_localcall_lab(transform_hlds__accumulator__accu_process_assoc_set_12_0,
		transform_hlds__accumulator__accu_process_assoc_set_12_0_i52);
MR_def_label(transform_hlds__accumulator__accu_process_assoc_set_12_0,23)
	...
	MR_np_localcall_lab(transform_hlds__accumulator__accu_process_assoc_set_12_0,
		transform_hlds__accumulator__accu_process_assoc_set_12_0_i52);
MR_def_label(transform_hlds__accumulator__accu_process_assoc_set_12_0,52)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(transform_hlds__accumulator__accu_process_assoc_set_12_0_i1);
	}
...
MR_BEGIN_MODULE(transform_hlds__accumulator_module21)
	...
	MR_init_label10(transform_hlds__accumulator__accu_process_update_set_13_0,58,4,5,8,7,10,11,12,14,15)
	MR_init_label7(transform_hlds__accumulator__accu_process_update_set_13_0,16,17,19,22,24,28,1)
MR_BEGIN_CODE
...
MR_def_static(transform_hlds__accumulator__accu_process_update_set_13_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r3,0,0)) {
		MR_GOTO_LAB(transform_hlds__accumulator__accu_process_update_set_13_0_i58);
	}
	MR_r2 = MR_r5;
	MR_r3 = MR_r6;
	MR_r4 = MR_r7;
	...
	MR_r1 = MR_TRUE;
	MR_proceed();
MR_def_label(transform_hlds__accumulator__accu_process_update_set_13_0,58)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(16);
	MR_sv(16) = (MR_Word) MR_succip;
	MR_sv(1) = MR_r1;
...
MR_def_label(transform_hlds__accumulator__accu_process_update_set_13_0,17)
	...
	MR_np_localcall_lab(transform_hlds__accumulator__accu_process_update_set_13_0,
		transform_hlds__accumulator__accu_process_update_set_13_0_i19);
MR_def_label(transform_hlds__accumulator__accu_process_update_set_13_0,19)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(transform_hlds__accumulator__accu_process_update_set_13_0_i1);
	}
	...
	MR_np_call_localret_ent(fn__f_108_105_115_116_95_95_43_43_2_0,
		transform_hlds__accumulator__accu_process_update_set_13_0_i22);
MR_def_label(transform_hlds__accumulator__accu_process_update_set_13_0,22)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 2);
	...
	MR_np_call_localret_ent(fn__f_108_105_115_116_95_95_43_43_2_0,
		transform_hlds__accumulator__accu_process_update_set_13_0_i24);
MR_def_label(transform_hlds__accumulator__accu_process_update_set_13_0,24)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tag_alloc_heap(MR_tempr1, 0, (MR_Integer) 2);
	...
	MR_np_call_localret_ent(fn__f_108_105_115_116_95_95_43_43_2_0,
		transform_hlds__accumulator__accu_process_update_set_13_0_i28);
MR_def_label(transform_hlds__accumulator__accu_process_update_set_13_0,28)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_sv(1);
	MR_r3 = MR_sv(2);
	MR_r4 = MR_sv(3);
...
MR_BEGIN_MODULE(transform_hlds__accumulator_module23)
	...
	MR_init_label10(transform_hlds__accumulator__accu_stage2_15_0,2,3,4,5,7,8,11,12,13,14)
...
MR_def_label(transform_hlds__accumulator__accu_stage2_15_0,8)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(12) = (MR_Word) MR_TAG_COMMON(0,1,10);
...
MR_def_label(fn__transform_hlds__accumulator__create_new_orig_recursive_goals_5_0,7)
	...
	MR_sv(5) = (MR_Word) MR_TAG_COMMON(0,2,5);
	MR_tempr2 = MR_r1;
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(transform_hlds__accumulator, accu_goal_id);
	MR_r2 = MR_sv(5);
	MR_r4 = MR_sv(4);
...
MR_BEGIN_MODULE(transform_hlds__accumulator_module44)
	...
	MR_init_label10(transform_hlds__accumulator__accu_transform_proc_8_0,2,3,4,7,9,56,11,12,13,10)
	MR_init_label10(transform_hlds__accumulator__accu_transform_proc_8_0,17,18,24,30,31,33,32,48,51,53)
	MR_init_label2(transform_hlds__accumulator__accu_transform_proc_8_0,6,54)
MR_BEGIN_CODE
...
MR_def_label(transform_hlds__accumulator__accu_transform_proc_8_0,56)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(4);
	MR_r2 = MR_sv(5);
	MR_r3 = MR_sv(6);
...
MR_def_label(transform_hlds__accumulator__accu_transform_proc_8_0,13)
	...
	MR_np_call_localret_ent(io__write_string_3_0,
		transform_hlds__accumulator__accu_transform_proc_8_0_i56);
MR_def_label(transform_hlds__accumulator__accu_transform_proc_8_0,10)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TEST(MR_sv(1),0,0)) {
		MR_GOTO_LAB(transform_hlds__accumulator__accu_transform_proc_8_0_i54);
	}
	MR_sv(4) = MR_r1;
	MR_sv(5) = MR_r2;
	MR_sv(6) = MR_r3;
...
MR_def_label(transform_hlds__accumulator__accu_transform_proc_8_0,32)
	...
	MR_np_call_localret_ent(fn__f_108_105_115_116_95_95_43_43_2_0,
		transform_hlds__accumulator__accu_transform_proc_8_0_i48);
MR_def_label(transform_hlds__accumulator__accu_transform_proc_8_0,48)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 0, (MR_Integer) 3);
	...
	MR_tfield(0, MR_tempr1, 2) = MR_r1;
	MR_sv(3) = MR_tempr1;
	MR_sv(1) = (MR_Word) MR_TAG_COMMON(0,1,35);
	MR_r1 = MR_sv(1);
	MR_r2 = MR_sv(6);
	}
	MR_np_call_localret_ent(univ__det_univ_to_type_2_0,
		transform_hlds__accumulator__accu_transform_proc_8_0_i51);
MR_def_label(transform_hlds__accumulator__accu_transform_proc_8_0,51)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_tag_alloc_heap(MR_r2, 1, (MR_Integer) 2);
	MR_tfield(1, MR_r2, 0) = MR_sv(3);
	MR_tfield(1, MR_r2, 1) = MR_r1;
	...
	MR_np_call_localret_ent(univ__type_to_univ_2_1,
		transform_hlds__accumulator__accu_transform_proc_8_0_i53);
MR_def_label(transform_hlds__accumulator__accu_transform_proc_8_0,53)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
...
MR_def_label(transform_hlds__accumulator__accu_transform_proc_8_0,6)
	...
	MR_r2 = MR_sv(8);
	MR_r3 = MR_sv(6);
MR_def_label(transform_hlds__accumulator__accu_transform_proc_8_0,54)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(9);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
...
MR_def_label(transform_hlds__accumulator__acc_unification_2_0,3)
	...
	MR_tfield(1, MR_tempr4, 4) = (MR_Word) MR_TAG_COMMON(0,1,36);
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 2);
...
MR_BEGIN_MODULE(transform_hlds__accumulator_module72)
	...
	MR_init_label1(transform_hlds__accumulator__IntroducedFrom__pred__identify_recursive_calls__595__1_4_0,1)
MR_BEGIN_CODE
...
MR_def_static(transform_hlds__accumulator__IntroducedFrom__pred__identify_recursive_calls__595__1_4_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_mkframe("pred transform_hlds.accumulator.IntroducedFrom__pred__identify_recursive_calls__595__1/4-0", 2,
		MR_ENTRY(MR_do_fail));
	MR_fv(1) = MR_r1;
	MR_fv(2) = MR_r2;
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(transform_hlds__accumulator, accu_goal_id);
