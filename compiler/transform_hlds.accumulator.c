...
MR_decl_label8(transform_hlds__accumulator__acc_proc_info_7_0, 13,16,17,18,19,20,21,22)
...
MR_BEGIN_MODULE(transform_hlds__accumulator_module24)
	...
	MR_init_label8(transform_hlds__accumulator__acc_proc_info_7_0,13,16,17,18,19,20,21,22)
MR_BEGIN_CODE
...
void mercury__transform_hlds__accumulator__write_out_proc_statics(FILE *deep_fp, FILE *procrep_fp)
{
	MR_write_out_module_proc_reps_start(procrep_fp, &mercury_data__module_layout__transform_hlds__accumulator);
