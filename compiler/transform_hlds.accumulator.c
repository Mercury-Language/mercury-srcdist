...
MR_def_label(transform_hlds__accumulator__identify_out_and_out_prime_10_0,15)
	...
	MR_tfield(0, MR_r2, 1) = (MR_Word) MR_ENTRY_AP(transform_hlds__accumulator__IntroducedFrom__pred__identify_out_and_out_prime__626__1_2_0);
...
MR_def_static(fn__transform_hlds__accumulator__base_case_ids_1_0)
	...
	MR_tfield(0, MR_r2, 1) = (MR_Word) MR_ENTRY_AP(transform_hlds__accumulator__IntroducedFrom__pred__base_case_ids__1804__1_2_0);
	MR_tfield(0, MR_r2, 2) = (MR_Integer) 1;
