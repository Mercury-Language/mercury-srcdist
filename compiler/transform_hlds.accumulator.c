...
{
  {
    ...
    {
      libs__globals__lookup_bool_option_3_p_0(transform_hlds__accumulator__Globals_15, (MR_Integer) 357, &transform_hlds__accumulator__DoLCO_16);
    }
    {
      libs__globals__lookup_bool_option_3_p_0(transform_hlds__accumulator__Globals_15, (MR_Integer) 167, &transform_hlds__accumulator__FullyStrict_17);
    }
    {
    ...
    if (transform_hlds__accumulator__succeeded)
      {
        ...
        *transform_hlds__accumulator__STATE_VARIABLE_ProcInfo_43 = transform_hlds__accumulator__STATE_VARIABLE_ProcInfo_51_51;
        {
          libs__globals__lookup_bool_option_3_p_0(transform_hlds__accumulator__Globals_15, (MR_Integer) 48, &transform_hlds__accumulator__VeryVerbose_19);
        }
