...
MR_decl_label10(transform_hlds__accumulator__output_warnings_5_0, 35,4,5,6,10,13,26,27,28,29)
MR_decl_label1(transform_hlds__accumulator__output_warnings_5_0, 37)
...
MR_BEGIN_MODULE(transform_hlds__accumulator_module0)
	...
	MR_init_label10(transform_hlds__accumulator__output_warnings_5_0,35,4,5,6,10,13,26,27,28,29)
	MR_init_label1(transform_hlds__accumulator__output_warnings_5_0,37)
MR_BEGIN_CODE
...
MR_def_label(transform_hlds__accumulator__output_warnings_5_0,35)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TEST(MR_r1,0,0)) {
		MR_GOTO_LAB(transform_hlds__accumulator__output_warnings_5_0_i37);
	}
	MR_sv(1) = MR_r2;
	{
...
MR_def_label(transform_hlds__accumulator__output_warnings_5_0,29)
	...
	MR_GOTO_LAB(transform_hlds__accumulator__output_warnings_5_0_i35);
MR_def_label(transform_hlds__accumulator__output_warnings_5_0,37)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
