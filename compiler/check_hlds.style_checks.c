...
static void MR_CALL 
check_hlds__style_checks__gather_proc_item_numbers_8_p_0(
  MR_Integer ProcId_9,
  MR_Word ProcInfo_10,
...
static void MR_CALL 
check_hlds__style_checks__generate_style_warnings_4_p_0_11(
  MR_Box closure_arg,
  MR_Box wrapper_arg_1,
  MR_Box * wrapper_arg_2);

static void MR_CALL 
check_hlds__style_checks__generate_style_warnings_4_p_0_10(
  MR_Box closure_arg,
  MR_Box wrapper_arg_1,
  MR_Box * wrapper_arg_2);

static void MR_CALL 
check_hlds__style_checks__generate_style_warnings_4_p_0_9(
  MR_Box closure_arg,
  MR_Box wrapper_arg_1,
  MR_Box * wrapper_arg_2);

static void MR_CALL 
check_hlds__style_checks__generate_style_warnings_4_p_0_8(
  MR_Box closure_arg,
  MR_Box wrapper_arg_1,
  MR_Box wrapper_arg_2,
  MR_Box * wrapper_arg_3);
...
static void MR_CALL 
check_hlds__style_checks__generate_style_warnings_4_p_0_7(
  MR_Box closure_arg,
  MR_Box wrapper_arg_1,
  MR_Box wrapper_arg_2,
  MR_Box * wrapper_arg_3);
...
static void MR_CALL 
check_hlds__style_checks__generate_style_warnings_4_p_0_6(
  MR_Box closure_arg,
  MR_Box wrapper_arg_1,
  MR_Box * wrapper_arg_2);

static void MR_CALL 
check_hlds__style_checks__generate_style_warnings_4_p_0_5(
  MR_Box closure_arg,
  MR_Box wrapper_arg_1,
  MR_Box * wrapper_arg_2);

static void MR_CALL 
check_hlds__style_checks__generate_style_warnings_4_p_0_4(
  MR_Box closure_arg,
  MR_Box wrapper_arg_1,
  MR_Box * wrapper_arg_2);

static void MR_CALL 
check_hlds__style_checks__generate_style_warnings_4_p_0_3(
  MR_Box closure_arg,
  MR_Box wrapper_arg_1,
  MR_Box wrapper_arg_2,
  MR_Box * wrapper_arg_3);
...
static void MR_CALL 
check_hlds__style_checks__generate_style_warnings_4_p_0_2(
  MR_Box closure_arg,
  MR_Box wrapper_arg_1,
  MR_Box wrapper_arg_2,
  MR_Box * wrapper_arg_3);
...
static /* final */ const MR_Box check_hlds__style_checks_scalar_common_1[45][2];

static /* final */ const MR_Box check_hlds__style_checks_scalar_common_2[13][3];

static /* final */ const MR_Box check_hlds__style_checks_scalar_common_3[2][1];

static /* final */ const MR_Box check_hlds__style_checks_scalar_common_4[1][8];
...
static /* final */ const MR_Box check_hlds__style_checks_scalar_common_1[45][2] = {
  ...
  /* row   9 */
  {
    ((MR_Box) (MR_mkword(3, &check_hlds__style_checks_scalar_common_1[8]))),
    ((MR_Box) (MR_mkword(1, &check_hlds__style_checks_scalar_common_1[7])))
  },
  /* row  10 */
  {
    ((MR_Box) (MR_Word) ((MR_Unsigned) 6U)),
  ...
  /* row  11 */
  {
    ...
    ((MR_Box) (MR_mkword(1, &check_hlds__style_checks_scalar_common_1[9])))
  },
  /* row  12 */
  {
    ((MR_Box) (MR_Word) ((MR_Unsigned) 6U)),
  ...
  /* row  15 */
  {
    ((MR_Box) (MR_mkword(3, &check_hlds__style_checks_scalar_common_1[14]))),
    ((MR_Box) (MR_mkword(1, &check_hlds__style_checks_scalar_common_1[13])))
  },
  /* row  16 */
  {
    ((MR_Box) (MR_Word) ((MR_Unsigned) 6U)),
  ...
  /* row  22 */
  {
    ((MR_Box) (MR_mkword(3, &check_hlds__style_checks_scalar_common_1[21]))),
    ((MR_Box) (MR_mkword(1, &check_hlds__style_checks_scalar_common_1[7])))
  },
  /* row  23 */
  {
  ...
  /* row  26 */
  {
    ((MR_Box) (MR_mkword(2, &check_hlds__style_checks_scalar_common_3[0]))),
    ((MR_Box) (MR_mkword(1, &check_hlds__style_checks_scalar_common_1[7])))
  },
  /* row  27 */
  {
    ((MR_Box) ((MR_Unsigned) 8U)),
    ((MR_Box) (MR_mkword(1, &check_hlds__style_checks_scalar_common_1[26])))
  },
  /* row  28 */
  {
    ((MR_Box) (MR_mkword(2, &check_hlds__style_checks_scalar_common_3[1]))),
    ((MR_Box) (MR_mkword(1, &check_hlds__style_checks_scalar_common_1[27])))
  },
  /* row  29 */
  {
  ...
  {
    ((MR_Box) ((MR_Unsigned) 8U)),
    ((MR_Box) (MR_mkword(1, &check_hlds__style_checks_scalar_common_1[29])))
  },
  /* row  31 */
  {
    ((MR_Box) (MR_Word) ((MR_Unsigned) 6U)),
  ...
  /* row  34 */
  {
    ...
    ((MR_Box) (MR_mkword(1, &check_hlds__style_checks_scalar_common_1[32])))
  },
  /* row  35 */
  {
  ...
  /* row  36 */
  {
    ...
    ((MR_Box) (MR_mkword(1, &check_hlds__style_checks_scalar_common_1[34])))
  },
  /* row  37 */
  {
    ((MR_Box) (MR_mkword(3, &check_hlds__style_checks_scalar_common_1[25]))),
    ((MR_Box) (MR_mkword(1, &check_hlds__style_checks_scalar_common_1[36])))
  },
  /* row  38 */
  {
    ((MR_Box) (MR_mkword(3, &check_hlds__style_checks_scalar_common_1[24]))),
    ((MR_Box) (MR_mkword(1, &check_hlds__style_checks_scalar_common_1[37])))
  },
  /* row  39 */
  {
    ((MR_Box) (MR_mkword(3, &check_hlds__style_checks_scalar_common_1[23]))),
    ((MR_Box) (MR_mkword(1, &check_hlds__style_checks_scalar_common_1[38])))
  },
  /* row  40 */
  {
    ((MR_Box) ((MR_Unsigned) 6U)),
    ((MR_Box) ((MR_String) "nonexported"))
  },
  /* row  41 */
  {
  ...
  {
    ((MR_Box) (MR_mkword(3, &check_hlds__style_checks_scalar_common_1[24]))),
    ((MR_Box) (MR_mkword(1, &check_hlds__style_checks_scalar_common_1[42])))
  },
  /* row  44 */
  {
    ((MR_Box) (MR_mkword(3, &check_hlds__style_checks_scalar_common_1[23]))),
...
static /* final */ const MR_Box check_hlds__style_checks_scalar_common_2[13][3] = {
  ...
  /* row   2 */
  {
    ...
    ((MR_Box) (check_hlds__style_checks__generate_style_warnings_4_p_0_2)),
    ((MR_Box) ((MR_Integer) 0))
  },
  /* row   3 */
  {
    ((MR_Box) (&check_hlds__style_checks_scalar_common_5[0])),
    ((MR_Box) (check_hlds__style_checks__generate_style_warnings_4_p_0_3)),
    ((MR_Box) ((MR_Integer) 0))
  },
  /* row   4 */
  {
    ((MR_Box) (&check_hlds__style_checks_scalar_common_6[0])),
    ((MR_Box) (check_hlds__style_checks__generate_style_warnings_4_p_0_4)),
    ((MR_Box) ((MR_Integer) 0))
  },
  /* row   5 */
  {
    ((MR_Box) (&check_hlds__style_checks_scalar_common_6[0])),
    ((MR_Box) (check_hlds__style_checks__generate_style_warnings_4_p_0_5)),
    ((MR_Box) ((MR_Integer) 0))
  },
  /* row   6 */
  {
    ((MR_Box) (&check_hlds__style_checks_scalar_common_6[1])),
    ((MR_Box) (check_hlds__style_checks__generate_style_warnings_4_p_0_6)),
    ((MR_Box) ((MR_Integer) 0))
  },
  /* row   7 */
  {
    ((MR_Box) (&check_hlds__style_checks_scalar_common_5[0])),
    ((MR_Box) (check_hlds__style_checks__generate_style_warnings_4_p_0_7)),
    ((MR_Box) ((MR_Integer) 0))
  },
  /* row   8 */
  {
    ((MR_Box) (&check_hlds__style_checks_scalar_common_5[0])),
    ((MR_Box) (check_hlds__style_checks__generate_style_warnings_4_p_0_8)),
    ((MR_Box) ((MR_Integer) 0))
  },
  /* row   9 */
  {
    ((MR_Box) (&check_hlds__style_checks_scalar_common_6[0])),
    ((MR_Box) (check_hlds__style_checks__generate_style_warnings_4_p_0_9)),
    ((MR_Box) ((MR_Integer) 0))
  },
  /* row  10 */
  {
    ((MR_Box) (&check_hlds__style_checks_scalar_common_6[0])),
    ((MR_Box) (check_hlds__style_checks__generate_style_warnings_4_p_0_10)),
    ((MR_Box) ((MR_Integer) 0))
  },
  /* row  11 */
  {
    ((MR_Box) (&check_hlds__style_checks_scalar_common_6[1])),
    ((MR_Box) (check_hlds__style_checks__generate_style_warnings_4_p_0_11)),
    ((MR_Box) ((MR_Integer) 0))
  },
  /* row  12 */
  {
...
static const MR_DuFunctorDescPtr check_hlds__style_checks__check_hlds__style_checks__du_stag_ordered_pred_item_numbers_0_0[1] = { &check_hlds__style_checks__check_hlds__style_checks__du_functor_desc_pred_item_numbers_0_0 };
...
static const MR_DuFunctorDescPtr check_hlds__style_checks__check_hlds__style_checks__du_name_ordered_pred_item_numbers_0[1] = { &check_hlds__style_checks__check_hlds__style_checks__du_functor_desc_pred_item_numbers_0_0 };

static const MR_Integer check_hlds__style_checks__check_hlds__style_checks__functor_number_map_pred_item_numbers_0[1] = { (MR_Integer) 0 };
...
static const MR_DuFunctorDescPtr check_hlds__style_checks__check_hlds__style_checks__du_stag_ordered_pred_style_info_0_0[1] = { &check_hlds__style_checks__check_hlds__style_checks__du_functor_desc_pred_style_info_0_0 };
...
static const MR_DuFunctorDescPtr check_hlds__style_checks__check_hlds__style_checks__du_name_ordered_pred_style_info_0[1] = { &check_hlds__style_checks__check_hlds__style_checks__du_functor_desc_pred_style_info_0_0 };

static const MR_Integer check_hlds__style_checks__check_hlds__style_checks__functor_number_map_pred_style_info_0[1] = { (MR_Integer) 0 };
...
check_hlds__style_checks__desc_pred_item_numbers_2_p_0(
  ...
  MR_String * PredDescStr_4)
{
  MR_Word PredInfo_6 = ((MR_Word) ((MR_hl_field(0, PredItemNumbers_3, (MR_Integer) 1))));
  MR_Word PredPieces_9;

  PredPieces_9 = hlds__hlds_error_util__describe_one_pred_info_name_2_f_0((MR_Integer) 1, PredInfo_6);
  *PredDescStr_4 = parse_tree__write_error_spec__error_pieces_to_string_1_f_0(PredPieces_9);
}
...
{
  MR_bool succeeded;
  MR_Integer ItemNumberA_10 = ((MR_Integer) ((MR_hl_field(0, A_4, (MR_Integer) 3))));
  MR_Integer ItemNumberB_14 = ((MR_Integer) ((MR_hl_field(0, B_5, (MR_Integer) 3))));
...
{
  MR_bool succeeded;
  MR_Integer ItemNumberA_9 = ((MR_Integer) ((MR_hl_field(0, A_4, (MR_Integer) 2))));
  MR_Integer ItemNumberB_13 = ((MR_Integer) ((MR_hl_field(0, B_5, (MR_Integer) 2))));
  ...
  MR_Word * STATE_VARIABLE_MakesSense_23)
{
  ...
  if (succeeded)
  {
    ...
    *STATE_VARIABLE_ExpectedProcNum_19 = (MR_Integer) ((MR_Unsigned) STATE_VARIABLE_ExpectedProcNum_0_18 + (MR_Unsigned) 1);
    ...
    {
      MR_Integer SeqNum_15 = ((MR_Integer) ((MR_hl_field(1, ItemNumber_14, (MR_Integer) 0))));
      MR_Word Context_16;
      MR_Word ProcINC_17;
  ...
  MR_Box * wrapper_arg_8)
{
  ...
  check_hlds__style_checks__gather_proc_item_numbers_8_p_0(((MR_Integer) (wrapper_arg_1)), ((MR_Word) (wrapper_arg_2)), ((MR_Integer) (wrapper_arg_3)), &conv2_STATE_VARIABLE_ExpectedProcNum_19, ((MR_Word) (wrapper_arg_5)), &conv1_STATE_VARIABLE_ProcINCs_21, ((MR_Word) (wrapper_arg_7)), &conv0_STATE_VARIABLE_MakesSense_23);
  ...
  MR_Word * STATE_VARIABLE_StyleInfo_43)
{
  ...
  if (succeeded)
  {
    DeclInfo_12 = ((MR_Word) ((MR_hl_field(1, MaybeDeclInfo_11, (MR_Integer) 0))));
    DeclSection_13 = ((((MR_Unsigned) ((MR_hl_field(0, DeclInfo_12, (MR_Integer) 0))) >> 1)) & (MR_Integer) 1);
    MaybePredDeclItemNumber_15 = ((MR_Word) ((MR_hl_field(0, DeclInfo_12, (MR_Integer) 1))));
    succeeded = (MaybePredDeclItemNumber_15 != (MR_Word) ((MR_Unsigned) 0U));
    if (succeeded)
      PredDeclItemNumber_16 = ((MR_Integer) ((MR_hl_field(1, MaybePredDeclItemNumber_15, (MR_Integer) 0))));
  }
  if (succeeded)
  {
    MR_Word ProcTable_17;
    MR_Word UnsortedProcINCs_19;
    MR_Word MakesSense_20;
    MR_Word ProcINCs_21;
    MR_Word STATE_VARIABLE_StyleInfo_49_49;
    MR_Box conv5_Var_18;
    MR_Box conv4_UnsortedProcINCs_19;
    MR_Box conv3_MakesSense_20;
    MR_Word HeadProcINC_22;
    MR_Word TailProcINCs_23;

    hlds__hlds_pred__pred_info_get_proc_table_2_p_0(PredInfo_10, &ProcTable_17);
    mercury__map__foldl3_8_p_0((MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_proc_id_0), (MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_proc_info_0), (MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0), (MR_Word) (&check_hlds__style_checks_scalar_common_1[0]), (MR_Word) (&check_hlds__style_checks__check_hlds__style_checks__type_ctor_info_proc_contiguity_0), (MR_Word) (&check_hlds__style_checks_scalar_common_2[12]), ProcTable_17, ((MR_Box) ((MR_Integer) 0)), &conv5_Var_18, ((MR_Box) ((MR_Unsigned) 0U)), &conv4_UnsortedProcINCs_19, ((MR_Box) ((MR_Integer) 0)), &conv3_MakesSense_20);
    UnsortedProcINCs_19 = ((MR_Word) (conv4_UnsortedProcINCs_19));
    MakesSense_20 = ((MR_Word) (conv3_MakesSense_20));
    mercury__list__sort_2_p_0((MR_Word) (&check_hlds__style_checks__check_hlds__style_checks__type_ctor_info_inc_0), UnsortedProcINCs_19, &ProcINCs_21);
    succeeded = (MakesSense_20 == (MR_Integer) 0);
    if (succeeded)
    {
      succeeded = (ProcINCs_21 != (MR_Word) ((MR_Unsigned) 0U));
      if (succeeded)
      {
        HeadProcINC_22 = ((MR_Word) ((MR_hl_field(1, ProcINCs_21, (MR_Integer) 0))));
        TailProcINCs_23 = ((MR_Word) ((MR_hl_field(1, ProcINCs_21, (MR_Integer) 1))));
      }
    }
    if (succeeded)
    {
      MR_Word PredDeclContext_24;
      MR_Word PredINC_25;

      hlds__hlds_pred__pred_info_get_context_2_p_0(PredInfo_10, &PredDeclContext_24);
      {
        PredINC_25 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(0, PredINC_25, 0) = ((MR_Box) (PredDeclItemNumber_16));
        MR_hl_field(0, PredINC_25, 1) = ((MR_Box) (PredDeclContext_24));
      }
      check_hlds__style_checks__report_any_inc_gaps_7_p_0(PredInfo_10, PredINC_25, HeadProcINC_22, TailProcINCs_23, (MR_Integer) 0, STATE_VARIABLE_StyleInfo_0_42, &STATE_VARIABLE_StyleInfo_49_49);
    }
    else
      STATE_VARIABLE_StyleInfo_49_49 = STATE_VARIABLE_StyleInfo_0_42;
    if ((WarnPredDeclDefnOrder_7 == (MR_Word) ((MR_Unsigned) 0U)))
      *STATE_VARIABLE_StyleInfo_43 = STATE_VARIABLE_StyleInfo_49_49;
    else
    {
      MR_Word DefnKind_26 = ((MR_Unsigned) ((MR_hl_field(1, WarnPredDeclDefnOrder_7, (MR_Integer) 0))) & (MR_Integer) 1);
      ...
      {
        MR_Word FirstRegion_31 = ((MR_Word) ((MR_hl_field(1, Regions_30, (MR_Integer) 0))));
        MR_Integer FirstClauseItemNumber_33 = ((MR_Integer) ((MR_hl_field(0, FirstRegion_31, (MR_Integer) 0))));
        ...
        {
          PredItemNumbers_37 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(0, PredItemNumbers_37, 0) = ((MR_Box) (PredId_8));
          MR_hl_field(0, PredItemNumbers_37, 1) = ((MR_Box) (PredInfo_10));
          MR_hl_field(0, PredItemNumbers_37, 2) = ((MR_Box) (PredDeclItemNumber_16));
          MR_hl_field(0, PredItemNumbers_37, 3) = ((MR_Box) (FirstClauseItemNumber_33));
        }
        Var_76 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_StyleInfo_49_49, (MR_Integer) 0))));
        Var_75 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_StyleInfo_49_49, (MR_Integer) 1))));
        Var_74 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_StyleInfo_49_49, (MR_Integer) 2))));
          ...
          case (MR_Integer) 1:
            {
              ...
              {
                NonExportedPINs_41 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(1, NonExportedPINs_41, 0) = ((MR_Box) (PredItemNumbers_37));
                MR_hl_field(1, NonExportedPINs_41, 1) = ((MR_Box) (Var_75));
              }
              {
                MR_Word base;
                ...
                *STATE_VARIABLE_StyleInfo_43 = base;
                ...
                MR_hl_field(0, base, 1) = ((MR_Box) (NonExportedPINs_41));
          ...
          case (MR_Integer) 0:
            {
              ...
              {
                ExportedPINs_39 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(1, ExportedPINs_39, 0) = ((MR_Box) (PredItemNumbers_37));
                MR_hl_field(1, ExportedPINs_39, 1) = ((MR_Box) (Var_76));
              }
              {
                MR_Word base;
                base = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
                *STATE_VARIABLE_StyleInfo_43 = base;
                MR_hl_field(0, base, 0) = ((MR_Box) (ExportedPINs_39));
  ...
  MR_Word * STATE_VARIABLE_StyleInfo_31)
{
  ...
  {
    MR_bool succeeded;
    MR_Integer FirstItemNumber_14 = ((MR_Integer) ((MR_hl_field(0, FirstINC_9, (MR_Integer) 0))));
    MR_Word FirstContext_15 = ((MR_Word) ((MR_hl_field(0, FirstINC_9, (MR_Integer) 1))));
    MR_Integer SecondItemNumber_16 = ((MR_Integer) ((MR_hl_field(0, SecondINC_10, (MR_Integer) 0))));
    MR_Word SecondContext_17 = ((MR_Word) ((MR_hl_field(0, SecondINC_10, (MR_Integer) 1))));
    ...
    else
    {
      ...
      PredOrFuncStr_20 = parse_tree__parse_tree_out_misc__pred_or_func_to_full_str_1_f_0(PredOrFunc_19);
      succeeded = (FirstProcNum_12 == (MR_Integer) 0);
      if (succeeded)
      {
        MR_Word Var_34;
...

        {
          ...
          MR_hl_field(3, Var_38, 1) = ((MR_Box) (PredOrFuncStr_20));
        }
        {
          Var_39 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(1, Var_39, 0) = ((MR_Box) (MR_mkword(3, &check_hlds__style_checks_scalar_common_1[6])));
          MR_hl_field(1, Var_39, 1) = ((MR_Box) (PredPieces_18));
        }
        {
        ...
        }
        {
          ...
          MR_hl_field(1, Var_34, 0) = ((MR_Box) (MR_mkword(3, &check_hlds__style_checks_scalar_common_1[5])));
          MR_hl_field(1, Var_34, 1) = ((MR_Box) (Var_37));
        }
        FirstPieces_21 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), Var_34, (MR_Word) (MR_mkword(1, &check_hlds__style_checks_scalar_common_1[11])));
        SecondPieces_22 = (MR_Word) (MR_mkword(1, &check_hlds__style_checks_scalar_common_1[15]));
      }
      else
      {
        MR_Word Var_57;
...

        {
          ...
          MR_hl_field(3, Var_61, 1) = ((MR_Box) (FirstProcNum_12));
        }
        {
          Var_62 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(1, Var_62, 0) = ((MR_Box) (MR_mkword(3, &check_hlds__style_checks_scalar_common_1[16])));
          MR_hl_field(1, Var_62, 1) = ((MR_Box) (PredPieces_18));
        }
        {
        ...
        }
        {
          ...
          MR_hl_field(1, Var_57, 0) = ((MR_Box) (MR_mkword(3, &check_hlds__style_checks_scalar_common_1[5])));
        ...
        }
        {
          ...
          MR_hl_field(1, Var_68, 1) = ((MR_Box) (MR_mkword(1, &check_hlds__style_checks_scalar_common_1[19])));
        }
        {
          Var_65 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(1, Var_65, 0) = ((MR_Box) (MR_mkword(3, &check_hlds__style_checks_scalar_common_1[17])));
          MR_hl_field(1, Var_65, 1) = ((MR_Box) (Var_68));
        }
        FirstPieces_21 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), Var_57, Var_65);
        ...
        }
        {
          ...
          MR_hl_field(1, Var_80, 1) = ((MR_Box) (MR_mkword(1, &check_hlds__style_checks_scalar_common_1[22])));
        }
        {
          SecondPieces_22 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(1, SecondPieces_22, 0) = ((MR_Box) (MR_mkword(3, &check_hlds__style_checks_scalar_common_1[20])));
          MR_hl_field(1, SecondPieces_22, 1) = ((MR_Box) (Var_80));
        }
      }
      {
      ...
      }
      {
        ...
        MR_hl_field(1, Var_94, 0) = ((MR_Box) (SecondMsg_24));
        MR_hl_field(1, Var_94, 1) = ((MR_Box) ((MR_Unsigned) 0U));
      }
      {
        Var_93 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(1, Var_93, 0) = ((MR_Box) (FirstMsg_23));
        MR_hl_field(1, Var_93, 1) = ((MR_Box) (Var_94));
      }
      {
        Spec_25 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(0, Spec_25, 0) = ((MR_Box) ((MR_String) "predicate \140check_hlds.style_checks.report_any_inc_gaps\'/7"));
        MR_hl_field(0, Spec_25, 1) = ((MR_Box) ((MR_Unsigned) 4U));
        MR_hl_field(0, Spec_25, 2) = ((MR_Box) ((MR_Unsigned) 80U));
        MR_hl_field(0, Spec_25, 3) = ((MR_Box) (Var_93));
      }
      Var_100 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_StyleInfo_0_30, (MR_Integer) 0))));
      Var_101 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_StyleInfo_0_30, (MR_Integer) 1))));
      Specs0_26 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_StyleInfo_0_30, (MR_Integer) 2))));
      {
      ...
      }
      {
        ...
        MR_hl_field(0, STATE_VARIABLE_StyleInfo_96_96, 0) = ((MR_Box) (Var_100));
        MR_hl_field(0, STATE_VARIABLE_StyleInfo_96_96, 1) = ((MR_Box) (Var_101));
        MR_hl_field(0, STATE_VARIABLE_StyleInfo_96_96, 2) = ((MR_Box) (Specs_27));
      }
    }
    ...
    {
      MR_Word ThirdINC_28 = ((MR_Word) ((MR_hl_field(1, LaterINCs_11, (MR_Integer) 0))));
      MR_Word LaterLaterINCs_29 = ((MR_Word) ((MR_hl_field(1, LaterINCs_11, (MR_Integer) 1))));
  ...
  MR_Box * wrapper_arg_2)
{
  ...
  parse_tree__error_spec__change_hunk_to_pieces_2_p_0(((MR_Word) (wrapper_arg_1)), &conv11_HeadVar__2_2);
  ...
  MR_Box * wrapper_arg_2)
{
  ...
  check_hlds__style_checks__desc_pred_item_numbers_2_p_0(((MR_Word) (wrapper_arg_1)), &conv10_PredDescStr_4);
...
{
  MR_Box closure = closure_arg;
  MR_String conv9_PredDescStr_4;

  check_hlds__style_checks__desc_pred_item_numbers_2_p_0(((MR_Word) (wrapper_arg_1)), &conv9_PredDescStr_4);
  *wrapper_arg_2 = ((MR_Box) (conv9_PredDescStr_4));
}
  ...
  MR_Box * wrapper_arg_3)
{
  ...
  check_hlds__style_checks__compare_defn_item_number_3_p_0(((MR_Word) (wrapper_arg_1)), ((MR_Word) (wrapper_arg_2)), &conv8_R_6);
  ...
  MR_Box * wrapper_arg_3)
{
  ...
  check_hlds__style_checks__compare_decl_item_number_3_p_0(((MR_Word) (wrapper_arg_1)), ((MR_Word) (wrapper_arg_2)), &conv7_R_6);
  *wrapper_arg_3 = ((MR_Box) (conv7_R_6));
}
  ...
  MR_Box * wrapper_arg_2)
{
  ...
  check_hlds__style_checks__desc_pred_item_numbers_2_p_0(((MR_Word) (wrapper_arg_1)), &conv5_PredDescStr_4);
  ...
  MR_Box * wrapper_arg_2)
{
  ...
  check_hlds__style_checks__desc_pred_item_numbers_2_p_0(((MR_Word) (wrapper_arg_1)), &conv4_PredDescStr_4);
  ...
  MR_Box * wrapper_arg_3)
{
  ...
  check_hlds__style_checks__detect_non_contiguous_pred_decls_5_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 4)))), ((MR_Word) (wrapper_arg_1)), ((MR_Word) (wrapper_arg_2)), &conv0_STATE_VARIABLE_StyleInfo_43);
  ...
  MR_Word * STATE_VARIABLE_Specs_17)
{
  ...
  hlds__hlds_module__module_info_get_valid_pred_ids_2_p_0(ModuleInfo_5, &ValidPredIds_9);
  {
    ...
    MR_hl_field(0, Var_21, 0) = ((MR_Box) (&check_hlds__style_checks_scalar_common_4[0]));
    MR_hl_field(0, Var_21, 1) = ((MR_Box) (check_hlds__style_checks__generate_style_warnings_4_p_0_1));
    MR_hl_field(0, Var_21, 2) = ((MR_Box) ((MR_Integer) 2));
    MR_hl_field(0, Var_21, 3) = ((MR_Box) (ModuleInfo_5));
    MR_hl_field(0, Var_21, 4) = ((MR_Box) (WarnPredDeclDefnOrder_7));
  }
  ...
  ExportedPreds_12 = ((MR_Word) ((MR_hl_field(0, StyleInfo_11, (MR_Integer) 0))));
  NonExportedPreds_13 = ((MR_Word) ((MR_hl_field(0, StyleInfo_11, (MR_Integer) 1))));
  ModeDeclItemNumberSpecs_14 = ((MR_Word) ((MR_hl_field(0, StyleInfo_11, (MR_Integer) 2))));
  ...
  else
  {
    ...
    MR_Word DeclOrder_33;
    MR_Word DefnOrder_34;
    MR_Word DeclOrder_69;
    MR_Word DefnOrder_70;

    hlds__hlds_module__module_info_get_name_context_2_p_0(ModuleInfo_5, &ModuleContext_16);
    mercury__list__sort_3_p_0((MR_Word) (&check_hlds__style_checks__check_hlds__style_checks__type_ctor_info_pred_item_numbers_0), (MR_Word) (&check_hlds__style_checks_scalar_common_2[2]), ExportedPreds_12, &DeclOrder_33);
    mercury__list__sort_3_p_0((MR_Word) (&check_hlds__style_checks__check_hlds__style_checks__type_ctor_info_pred_item_numbers_0), (MR_Word) (&check_hlds__style_checks_scalar_common_2[3]), ExportedPreds_12, &DefnOrder_34);
    succeeded = mercury__builtin__unify_2_p_0((MR_Word) (&check_hlds__style_checks_scalar_common_1[3]), ((MR_Box) (DeclOrder_33)), ((MR_Box) (DefnOrder_34)));
    if (succeeded)
      STATE_VARIABLE_Specs_26_26 = STATE_VARIABLE_Specs_22_22;
    else
    {
      MR_Word DeclStrs_35;
      MR_Word DefnStrs_36;
      MR_Word EditSeq_38;
      MR_Word DiffSeq_39;
      MR_Word ChangeHunks_40;
      MR_Word WarnSpec_41;
      MR_Word ChangeHunkPieceLists_51;
      MR_Word ChangeHunkPieces_52;
      MR_Word Pieces_53;

      mercury__list__map_3_p_0((MR_Word) (&check_hlds__style_checks__check_hlds__style_checks__type_ctor_info_pred_item_numbers_0), (MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&check_hlds__style_checks_scalar_common_2[4]), DeclOrder_33, &DeclStrs_35);
      mercury__list__map_3_p_0((MR_Word) (&check_hlds__style_checks__check_hlds__style_checks__type_ctor_info_pred_item_numbers_0), (MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&check_hlds__style_checks_scalar_common_2[5]), DefnOrder_34, &DefnStrs_36);
      mercury__edit_seq__find_shortest_edit_seq_4_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&check_hlds__style_checks_scalar_common_2[1]), DeclStrs_35, DefnStrs_36, &EditSeq_38);
      mercury__edit_seq__find_diff_seq_3_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), DeclStrs_35, EditSeq_38, &DiffSeq_39);
      mercury__edit_seq__find_change_hunks_3_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Integer) 3, DiffSeq_39, &ChangeHunks_40);
      mercury__list__map_3_p_0((MR_Word) (&check_hlds__style_checks_scalar_common_1[1]), (MR_Word) (&check_hlds__style_checks_scalar_common_1[2]), (MR_Word) (&check_hlds__style_checks_scalar_common_2[6]), ChangeHunks_40, &ChangeHunkPieceLists_51);
      mercury__list__condense_2_p_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), ChangeHunkPieceLists_51, &ChangeHunkPieces_52);
      Pieces_53 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), (MR_Word) (MR_mkword(1, &check_hlds__style_checks_scalar_common_1[39])), ChangeHunkPieces_52);
      {
        WarnSpec_41 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(1, WarnSpec_41, 0) = ((MR_Box) ((MR_String) "predicate \140check_hlds.style_checks.chunks_to_spec\'/4"));
        MR_hl_field(1, WarnSpec_41, 1) = ((MR_Box) ((MR_Unsigned) 4U));
        MR_hl_field(1, WarnSpec_41, 2) = ((MR_Box) ((MR_Unsigned) 80U));
        MR_hl_field(1, WarnSpec_41, 3) = ((MR_Box) (ModuleContext_16));
        MR_hl_field(1, WarnSpec_41, 4) = ((MR_Box) (Pieces_53));
      }
      {
        STATE_VARIABLE_Specs_26_26 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(1, STATE_VARIABLE_Specs_26_26, 0) = ((MR_Box) (WarnSpec_41));
        MR_hl_field(1, STATE_VARIABLE_Specs_26_26, 1) = ((MR_Box) (STATE_VARIABLE_Specs_22_22));
      }
    }
    mercury__list__sort_3_p_0((MR_Word) (&check_hlds__style_checks__check_hlds__style_checks__type_ctor_info_pred_item_numbers_0), (MR_Word) (&check_hlds__style_checks_scalar_common_2[7]), NonExportedPreds_13, &DeclOrder_69);
    mercury__list__sort_3_p_0((MR_Word) (&check_hlds__style_checks__check_hlds__style_checks__type_ctor_info_pred_item_numbers_0), (MR_Word) (&check_hlds__style_checks_scalar_common_2[8]), NonExportedPreds_13, &DefnOrder_70);
    succeeded = mercury__builtin__unify_2_p_0((MR_Word) (&check_hlds__style_checks_scalar_common_1[3]), ((MR_Box) (DeclOrder_69)), ((MR_Box) (DefnOrder_70)));
    if (succeeded)
      *STATE_VARIABLE_Specs_17 = STATE_VARIABLE_Specs_26_26;
    else
    {
      MR_Word DeclStrs_71;
      MR_Word DefnStrs_72;
      MR_Word EditSeq_74;
      MR_Word DiffSeq_75;
      MR_Word ChangeHunks_76;
      MR_Word WarnSpec_77;
      MR_Word ChangeHunkPieceLists_87;
      MR_Word ChangeHunkPieces_88;
      MR_Word Pieces_89;

      mercury__list__map_3_p_0((MR_Word) (&check_hlds__style_checks__check_hlds__style_checks__type_ctor_info_pred_item_numbers_0), (MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&check_hlds__style_checks_scalar_common_2[9]), DeclOrder_69, &DeclStrs_71);
      mercury__list__map_3_p_0((MR_Word) (&check_hlds__style_checks__check_hlds__style_checks__type_ctor_info_pred_item_numbers_0), (MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&check_hlds__style_checks_scalar_common_2[10]), DefnOrder_70, &DefnStrs_72);
      mercury__edit_seq__find_shortest_edit_seq_4_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&check_hlds__style_checks_scalar_common_2[1]), DeclStrs_71, DefnStrs_72, &EditSeq_74);
      mercury__edit_seq__find_diff_seq_3_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), DeclStrs_71, EditSeq_74, &DiffSeq_75);
      mercury__edit_seq__find_change_hunks_3_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Integer) 3, DiffSeq_75, &ChangeHunks_76);
      mercury__list__map_3_p_0((MR_Word) (&check_hlds__style_checks_scalar_common_1[1]), (MR_Word) (&check_hlds__style_checks_scalar_common_1[2]), (MR_Word) (&check_hlds__style_checks_scalar_common_2[11]), ChangeHunks_76, &ChangeHunkPieceLists_87);
      mercury__list__condense_2_p_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), ChangeHunkPieceLists_87, &ChangeHunkPieces_88);
      Pieces_89 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), (MR_Word) (MR_mkword(1, &check_hlds__style_checks_scalar_common_1[44])), ChangeHunkPieces_88);
      {
        WarnSpec_77 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(1, WarnSpec_77, 0) = ((MR_Box) ((MR_String) "predicate \140check_hlds.style_checks.chunks_to_spec\'/4"));
        MR_hl_field(1, WarnSpec_77, 1) = ((MR_Box) ((MR_Unsigned) 4U));
        MR_hl_field(1, WarnSpec_77, 2) = ((MR_Box) ((MR_Unsigned) 80U));
        MR_hl_field(1, WarnSpec_77, 3) = ((MR_Box) (ModuleContext_16));
        MR_hl_field(1, WarnSpec_77, 4) = ((MR_Box) (Pieces_89));
      }
      {
        MR_Word base;
        base = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        *STATE_VARIABLE_Specs_17 = base;
        MR_hl_field(1, base, 0) = ((MR_Box) (WarnSpec_77));
