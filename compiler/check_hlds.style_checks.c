  ...
  MR_Word * Specs_6)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 241, &NonContigDeclsOpt_8);
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 243, &WarnNonContigForeignProcs_10);
  hlds__hlds_module__module_info_get_globals_2_p_0(ModuleInfo_4, &Globals_27);
  libs__globals__lookup_accumulating_option_3_p_0(Globals_27, (MR_Integer) 244, &AllowNonContiguityForOpts0_28);
    ...
    case (MR_Integer) 0:
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 242, &WarnNonContigClauses_13);
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 239, &InconsistentPredOrderClauses_14);
  libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 240, &InconsistentPredOrderForeignProcs_15);
