...
{
  {
    ...
    MR_Word Var_8 = ((MR_Word) (MR_hl_field(MR_mktag(0), PredItemNumbers_6, (MR_Integer) 0)));
    MR_Integer Var_10 = ((MR_Integer) (MR_hl_field(MR_mktag(0), PredItemNumbers_6, (MR_Integer) 2)));
    MR_Integer Var_11 = ((MR_Integer) (MR_hl_field(MR_mktag(0), PredItemNumbers_6, (MR_Integer) 3)));
...
{
  {
    ...
    MR_Word Var_7 = ((MR_Word) (MR_hl_field(MR_mktag(0), A_4, (MR_Integer) 0)));
    MR_Word Var_8 = ((MR_Word) (MR_hl_field(MR_mktag(0), A_4, (MR_Integer) 1)));
    MR_Integer Var_9 = ((MR_Integer) (MR_hl_field(MR_mktag(0), A_4, (MR_Integer) 2)));
    MR_Word Var_11 = ((MR_Word) (MR_hl_field(MR_mktag(0), B_5, (MR_Integer) 0)));
    MR_Word Var_12 = ((MR_Word) (MR_hl_field(MR_mktag(0), B_5, (MR_Integer) 1)));
    MR_Integer Var_13 = ((MR_Integer) (MR_hl_field(MR_mktag(0), B_5, (MR_Integer) 2)));
...
{
  {
    ...
    MR_Word Var_7 = ((MR_Word) (MR_hl_field(MR_mktag(0), A_4, (MR_Integer) 0)));
    MR_Word Var_8 = ((MR_Word) (MR_hl_field(MR_mktag(0), A_4, (MR_Integer) 1)));
    MR_Integer Var_10 = ((MR_Integer) (MR_hl_field(MR_mktag(0), A_4, (MR_Integer) 3)));
    MR_Word Var_11 = ((MR_Word) (MR_hl_field(MR_mktag(0), B_5, (MR_Integer) 0)));
    MR_Word Var_12 = ((MR_Word) (MR_hl_field(MR_mktag(0), B_5, (MR_Integer) 1)));
    MR_Integer Var_14 = ((MR_Integer) (MR_hl_field(MR_mktag(0), B_5, (MR_Integer) 3)));
...
{
  {
    ...
    if ((MaybeDeclInfo_11 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
    ...
    else
    {
      ...
      MR_Word DeclSection_13 = ((((MR_Word) (MR_hl_field(MR_mktag(0), DeclInfo_12, (MR_Integer) 0)))) & (MR_Integer) 1);
      ...
      MR_Word Var_14 = ((((((MR_Word) (MR_hl_field(MR_mktag(0), DeclInfo_12, (MR_Integer) 0)))) >> (MR_Integer) 1)) & (MR_Integer) 1);
      ...
      if (succeeded)
      {
        succeeded = ((MR_tag((MR_Word) ProcINCs_19)) == (MR_mktag((MR_Integer) 1)));
        if (succeeded)
        {
      ...
      if (succeeded)
      {
        ...
        Var_51 = ((MR_Word) (MR_hl_field(MR_mktag(0), STATE_VARIABLE_StyleInfo_0_42, (MR_Integer) 0)));
        Var_52 = ((MR_Word) (MR_hl_field(MR_mktag(0), STATE_VARIABLE_StyleInfo_0_42, (MR_Integer) 1)));
        ...
        Var_55 = ((MR_Word) (MR_hl_field(MR_mktag(0), STATE_VARIABLE_StyleInfo_0_42, (MR_Integer) 2)));
        {
      ...
      if ((MaybeDefnKind_7 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
      ...
      else
      {
        ...
        if ((Regions_30 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
          *STATE_VARIABLE_StyleInfo_43 = STATE_VARIABLE_StyleInfo_48_48;
        else
        {
          ...
          MR_Word Var_77;
          MR_Word Var_78;
          MR_Word Var_32 = ((MR_Word) (MR_hl_field(MR_mktag(1), Regions_30, (MR_Integer) 1)));
          MR_Integer Var_34 = ((MR_Integer) (MR_hl_field(MR_mktag(0), FirstRegion_31, (MR_Integer) 1)));
          MR_Word Var_35 = ((MR_Word) (MR_hl_field(MR_mktag(0), FirstRegion_31, (MR_Integer) 2)));
          MR_Word Var_36 = ((MR_Word) (MR_hl_field(MR_mktag(0), FirstRegion_31, (MR_Integer) 3)));
  ...
  MR_Word * STATE_VARIABLE_Specs_29)
{
  while (MR_TRUE)
  {
    /* tailcall optimized into a loop */
    {
      ...
      {
        MR_Integer Var_30 = (SecondItemNumber_16 - FirstItemNumber_14);
      ...
      if (!(succeeded))
      {
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
            succeeded = (LaterINCs_11 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
        }
      }
      if (succeeded)
      ...
      else
      {
        ...
        else
        {
          ...
          Var_68 = (FirstProcNum_12 + (MR_Integer) 1);
          {
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(0), Spec_25, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 12))));
      ...
      if ((LaterINCs_11 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
      ...
      else
      {
        ...
        MR_Integer Var_100 = (FirstProcNum_12 + (MR_Integer) 1);
...
{
  {
    ...
    StyleInfo0_11 = (MR_Word) &check_hlds__style_checks_scalar_common_5[4];
    TypeCtorInfo_40_40 = (MR_Word) &hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_id_0;
    TypeCtorInfo_41_41 = (MR_Word) &check_hlds__style_checks__check_hlds__style_checks__type_ctor_info_pred_style_info_0;
    switch (MR_tag((MR_Word) Task_7)) {
      ...
      case (MR_Integer) 0:
        {
          ...
          MR_Word ExportedPreds_55;
          MR_Word NonExportedPreds_56;
          ...
          mercury__list__foldl_4_p_0(TypeCtorInfo_40_40, TypeCtorInfo_41_41, Var_62, ValidPredIds_10, ((MR_Box) (StyleInfo0_11)), &conv5_StyleInfo_58);
          StyleInfo_58 = ((MR_Word) conv5_StyleInfo_58);
          ExportedPreds_55 = ((MR_Word) (MR_hl_field(MR_mktag(0), StyleInfo_58, (MR_Integer) 0)));
          NonExportedPreds_56 = ((MR_Word) (MR_hl_field(MR_mktag(0), StyleInfo_58, (MR_Integer) 1)));
      ...
      case (MR_Integer) 1:
        {
          ...
          MR_Word DefnKind_13 = ((MR_Word) (MR_hl_field(MR_mktag(1), Task_7, (MR_Integer) 0)));
          ...
          MR_Word ModeDeclItemNumberSpecs_17;
          ...
          mercury__list__foldl_4_p_0(TypeCtorInfo_40_40, TypeCtorInfo_41_41, Var_27, ValidPredIds_10, ((MR_Box) (StyleInfo0_11)), &conv1_StyleInfo_14);
          ...
          ModeDeclItemNumberSpecs_17 = ((MR_Word) (MR_hl_field(MR_mktag(0), StyleInfo_14, (MR_Integer) 2)));
          hlds__hlds_module__module_info_get_name_context_2_p_0(ModuleInfo_6, &ModuleContext_20);
          check_hlds__style_checks__generate_inconsistent_pred_order_warnings_7_p_0(ModuleContext_20, (MR_String) "exported", ExportedPreds_15, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), &STATE_VARIABLE_Specs_31_31);
      ...
      case (MR_Integer) 2:
        {
          MR_Word DefnKind_42 = ((MR_Word) (MR_hl_field(MR_mktag(2), Task_7, (MR_Integer) 0)));
          ...
          mercury__list__foldl_4_p_0(TypeCtorInfo_40_40, TypeCtorInfo_41_41, Var_54, ValidPredIds_10, ((MR_Box) (StyleInfo0_11)), &conv3_StyleInfo_50);
  ...
  MR_Word * STATE_VARIABLE_Specs_40)
{
  {
    MR_bool succeeded;
    MR_Word TypeCtorInfo_97_97 = (MR_Word) &check_hlds__style_checks__check_hlds__style_checks__type_ctor_info_pred_item_numbers_0;
    MR_Word DeclOrder_13;
    MR_Word DefnOrder_14;

    mercury__list__sort_3_p_0(TypeCtorInfo_97_97, (MR_Word) &check_hlds__style_checks_scalar_common_5[1], PredItemNumbers_10, &DeclOrder_13);
    mercury__list__sort_3_p_0(TypeCtorInfo_97_97, (MR_Word) &check_hlds__style_checks_scalar_common_5[2], PredItemNumbers_10, &DefnOrder_14);
    ...
    else
    {
      ...
      if (((MR_tag((MR_Word) DeclResult_16)) == (MR_mktag((MR_Integer) 1))))
      {
        ...
        if (((MR_tag((MR_Word) DefnResult_17)) == (MR_mktag((MR_Integer) 1))))
        {
          ...
          STATE_VARIABLE_TempFileNames_81_81 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
          TypeCtorInfo_101_101 = (MR_Word) &parse_tree__error_util__parse_tree__error_util__type_ctor_info_error_spec_0;
          {
          ...
          Var_84 = mercury__list__f_43_43_2_f_0(TypeCtorInfo_101_101, Var_85, STATE_VARIABLE_Specs_0_39);
          *STATE_VARIABLE_Specs_40 = mercury__list__f_43_43_2_f_0(TypeCtorInfo_101_101, Var_83, Var_84);
        }
        else
        {
...

          {
            ...
            MR_hl_field(MR_mktag(1), STATE_VARIABLE_TempFileNames_81_81, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
          }
          {
      ...
      else
      {
        ...
        else
        {
          ...
          if (((MR_tag((MR_Word) DiffTempResult_24)) == (MR_mktag((MR_Integer) 1))))
          {
          ...
          else
          {
            ...
            if (((MR_tag((MR_Word) CmdResult_29)) == (MR_mktag((MR_Integer) 1))))
            {
            ...
            else
            {
              ...
              if (((MR_tag((MR_Word) DiffOpenResult_33)) == (MR_mktag((MR_Integer) 1))))
              {
...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), Msg_11, 0) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
      MR_hl_field(MR_mktag(1), Msg_11, 1) = ((MR_Box) ((MR_Integer) 1));
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(0), Spec_8, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 12))));
...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), Msg_9, 0) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
      MR_hl_field(MR_mktag(1), Msg_9, 1) = ((MR_Box) ((MR_Integer) 1));
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(0), Spec_6, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 12))));
...
{
  {
    ...
    check_hlds__style_checks__read_lines_as_rev_strings_6_p_0(DiffStream_8, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), &RevLines_14, &MaybeIOError_15);
    if ((MaybeIOError_15 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
    {
      MR_Word TypeCtorInfo_157_157 = (MR_Word) &mercury__builtin__builtin__type_ctor_info_string_0;
      MR_Word Lines_20;
      ...
      mercury__list__reverse_2_p_0(TypeCtorInfo_157_157, RevLines_14, &Lines_20);
      succeeded = ((MR_tag((MR_Word) Lines_20)) == (MR_mktag((MR_Integer) 1)));
      if (succeeded)
      {
      ...
      if (succeeded)
      {
        ...
        mercury__list__map_3_p_0(TypeCtorInfo_157_157, (MR_Word) &check_hlds__style_checks_scalar_common_1[1], (MR_Word) &check_hlds__style_checks_scalar_common_5[0], DiffLines_23, &DiffPieceLists_25);
        TypeCtorInfo_161_161 = (MR_Word) &parse_tree__error_util__parse_tree__error_util__type_ctor_info_format_component_0;
        mercury__list__condense_2_p_0(TypeCtorInfo_161_161, DiffPieceLists_25, &DiffPieces_26);
        Pieces_149 = mercury__list__f_43_43_2_f_0(TypeCtorInfo_161_161, HeadPieces_24, DiffPieces_26);
        {
      ...
      else
      {
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(1), Msg_152, 0) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
          MR_hl_field(MR_mktag(1), Msg_152, 1) = ((MR_Box) ((MR_Integer) 1));
    ...
    else
    {
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(1), Msg_19, 0) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
        MR_hl_field(MR_mktag(1), Msg_19, 1) = ((MR_Box) ((MR_Integer) 1));
  ...
  while (MR_TRUE)
  {
    /* tailcall optimized into a loop */
    {
      ...
      switch (MR_tag((MR_Word) Result_11)) {
        ...
        case (MR_Integer) 0:
          {
            *MaybeIOError_9 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
        ...
        case (MR_Integer) 1:
          {
            ...
            /* direct tailcall eliminated */
            {
              MR_Word next_value_of_STATE_VARIABLE_RevLines_0_14 = STATE_VARIABLE_RevLines_19_19;
...
{
  {
    ...
    if (((MR_tag((MR_Word) TempResult_12)) == (MR_mktag((MR_Integer) 1))))
    {
      ...
      {
        Var_58 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), Var_58, 0) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 1))));
        MR_hl_field(MR_mktag(1), Var_58, 1) = ((MR_Box) (Var_60));
      }
      {
        Var_55 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(1), Msg_41, 0) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
        MR_hl_field(MR_mktag(1), Msg_41, 1) = ((MR_Box) ((MR_Integer) 1));
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(0), TempSpec_14, 0) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 1))));
        MR_hl_field(MR_mktag(0), TempSpec_14, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 12))));
...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), Var_33, 0) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 1))));
