...
{
  {
    ...
    else
    {
      ...
      MR_Word DeclSection_13 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), DeclInfo_12, (MR_Integer) 0))) & (MR_Integer) 1);
      ...
      MR_Word Var_14 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), DeclInfo_12, (MR_Integer) 0))) >> (MR_Integer) 1)) & (MR_Integer) 1);
