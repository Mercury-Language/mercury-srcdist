  ...
  MR_Word * STATE_VARIABLE_StyleInfo_42)
{
  ...
  if (succeeded)
  {
    ...
    {
      MR_Word DefnKind_25 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MaybeDefnKind_7, (MR_Integer) 0))));
...
{
  MR_Box closure = closure_arg;
  MR_Word conv4_STATE_VARIABLE_StyleInfo_42;

  check_hlds__style_checks__detect_non_contiguous_pred_decls_5_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))), ((MR_Word) (wrapper_arg_1)), ((MR_Word) (wrapper_arg_2)), &conv4_STATE_VARIABLE_StyleInfo_42);
  *wrapper_arg_3 = ((MR_Box) (conv4_STATE_VARIABLE_StyleInfo_42));
}
...
{
  MR_Box closure = closure_arg;
  MR_Word conv2_STATE_VARIABLE_StyleInfo_42;

  check_hlds__style_checks__detect_non_contiguous_pred_decls_5_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))), ((MR_Word) (wrapper_arg_1)), ((MR_Word) (wrapper_arg_2)), &conv2_STATE_VARIABLE_StyleInfo_42);
  *wrapper_arg_3 = ((MR_Box) (conv2_STATE_VARIABLE_StyleInfo_42));
}
