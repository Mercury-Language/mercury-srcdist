...
static /* final */ const MR_Box check_hlds__style_checks_scalar_common_1[48][2];

static /* final */ const MR_Box check_hlds__style_checks_scalar_common_2[13][3];

static /* final */ const MR_Box check_hlds__style_checks_scalar_common_3[3][1];
...
static /* final */ const MR_Box check_hlds__style_checks_scalar_common_1[48][2] = {
  ...
  /* row   7 */
  {
    ((MR_Box) (MR_mkword(3, &check_hlds__style_checks_scalar_common_1[6]))),
  ...
  /* row  37 */
  {
    ((MR_Box) (MR_mkword(3, &check_hlds__style_checks_scalar_common_1[36]))),
    ((MR_Box) ((MR_Unsigned) 0U))
  },
  /* row  38 */
  {
  ...
  /* row  40 */
  {
    ((MR_Box) (MR_mkword(2, &check_hlds__style_checks_scalar_common_3[2]))),
  ...
  /* row  46 */
  {
    ...
    ((MR_Box) (MR_mkword(1, &check_hlds__style_checks_scalar_common_1[35])))
  },
  /* row  47 */
  {
  ...
  MR_Word * STATE_VARIABLE_StyleInfo_31)
{
  while (MR_TRUE)
  {
    ...
    MR_Word STATE_VARIABLE_StyleInfo_119_119;
    ...
    if (succeeded)
      STATE_VARIABLE_StyleInfo_119_119 = STATE_VARIABLE_StyleInfo_0_30;
    else
    {
      ...
      PredPieces_18 = hlds__hlds_error_util__describe_one_pred_info_name_4_f_0((MR_Word) (MR_mkword(1, &check_hlds__style_checks_scalar_common_3[0])), (MR_Integer) 1, (MR_Word) ((MR_Unsigned) 0U), PredInfo_8);
      ...
      if (succeeded)
      {
        ...
        }
        {
          ...
          MR_hl_field(1, Var_40, 1) = ((MR_Box) (MR_mkword(1, &check_hlds__style_checks_scalar_common_1[7])));
        }
        {
          Var_37 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(1, Var_37, 0) = ((MR_Box) (MR_mkword(3, &check_hlds__style_checks_scalar_common_1[5])));
          MR_hl_field(1, Var_37, 1) = ((MR_Box) (Var_40));
        }
        Var_53 = parse_tree__error_spec__color_as_incorrect_1_f_0((MR_Word) (MR_mkword(1, &check_hlds__style_checks_scalar_common_1[13])));
        ...
        Var_47 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), (MR_Word) (MR_mkword(1, &check_hlds__style_checks_scalar_common_1[9])), Var_52);
      ...
      else
      {
        ...
        }
        {
          ...
          MR_hl_field(1, Var_73, 1) = ((MR_Box) (MR_mkword(1, &check_hlds__style_checks_scalar_common_1[20])));
        }
        {
          Var_70 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(1, Var_70, 0) = ((MR_Box) (MR_mkword(3, &check_hlds__style_checks_scalar_common_1[5])));
        ...
        }
        {
          ...
          MR_hl_field(1, Var_90, 1) = ((MR_Box) (MR_mkword(1, &check_hlds__style_checks_scalar_common_1[23])));
        }
        {
          Var_87 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(1, Var_87, 0) = ((MR_Box) (MR_mkword(3, &check_hlds__style_checks_scalar_common_1[21])));
        ...
        Var_80 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), (MR_Word) (MR_mkword(1, &check_hlds__style_checks_scalar_common_1[9])), Var_85);
        ...
        }
        {
          ...
          MR_hl_field(1, Var_103, 1) = ((MR_Box) (MR_mkword(1, &check_hlds__style_checks_scalar_common_1[26])));
        }
        {
          SecondPieces_22 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(1, SecondPieces_22, 0) = ((MR_Box) (MR_mkword(3, &check_hlds__style_checks_scalar_common_1[24])));
      ...
      Var_123 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_StyleInfo_0_30, (MR_Integer) 0))));
      Var_124 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_StyleInfo_0_30, (MR_Integer) 1))));
      ...
      {
        STATE_VARIABLE_StyleInfo_119_119 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(0, STATE_VARIABLE_StyleInfo_119_119, 0) = ((MR_Box) (Var_123));
        MR_hl_field(0, STATE_VARIABLE_StyleInfo_119_119, 1) = ((MR_Box) (Var_124));
        MR_hl_field(0, STATE_VARIABLE_StyleInfo_119_119, 2) = ((MR_Box) (Specs_27));
      }
    }
    if ((LaterINCs_11 == (MR_Word) ((MR_Unsigned) 0U)))
      *STATE_VARIABLE_StyleInfo_31 = STATE_VARIABLE_StyleInfo_119_119;
    else
    {
      ...
      MR_Word next_value_of_STATE_VARIABLE_StyleInfo_0_30 = STATE_VARIABLE_StyleInfo_119_119;
  ...
  MR_Word * STATE_VARIABLE_Specs_17)
{
  ...
  else
  {
    ...
    else
    {
      ...
      Var_56 = parse_tree__error_spec__color_as_subject_1_f_0((MR_Word) (MR_mkword(1, &check_hlds__style_checks_scalar_common_1[32])));
      Var_65 = parse_tree__error_spec__color_as_incorrect_1_f_0((MR_Word) (MR_mkword(1, &check_hlds__style_checks_scalar_common_1[37])));
      Var_64 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), Var_65, (MR_Word) (MR_mkword(1, &check_hlds__style_checks_scalar_common_1[44])));
      Var_58 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), (MR_Word) (MR_mkword(1, &check_hlds__style_checks_scalar_common_1[47])), Var_64);
      ...
      HeadPieces_50 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), (MR_Word) (MR_mkword(1, &check_hlds__style_checks_scalar_common_1[28])), Var_55);
  ...
  MR_Word * STATE_VARIABLE_Specs_23)
{
  ...
  else
  {
    ...
    Var_48 = parse_tree__error_spec__color_as_subject_1_f_0((MR_Word) (MR_mkword(1, &check_hlds__style_checks_scalar_common_1[32])));
    {
    ...
    }
    {
      ...
      MR_hl_field(1, Var_53, 1) = ((MR_Box) (MR_mkword(1, &check_hlds__style_checks_scalar_common_1[35])));
    }
    {
      Var_51 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(1, Var_51, 0) = ((MR_Box) (MR_mkword(3, &check_hlds__style_checks_scalar_common_1[33])));
      MR_hl_field(1, Var_51, 1) = ((MR_Box) (Var_53));
    }
    Var_57 = parse_tree__error_spec__color_as_incorrect_1_f_0((MR_Word) (MR_mkword(1, &check_hlds__style_checks_scalar_common_1[37])));
    Var_56 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), Var_57, (MR_Word) (MR_mkword(1, &check_hlds__style_checks_scalar_common_1[44])));
    ...
    HeadPieces_42 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), (MR_Word) (MR_mkword(1, &check_hlds__style_checks_scalar_common_1[28])), Var_47);
