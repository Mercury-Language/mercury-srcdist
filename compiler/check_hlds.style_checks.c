  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      }
      {
        ...
        MR_hl_field(2, Spec_25, 3) = ((MR_Box) (Var_93));
      }
  ...
  MR_Word * STATE_VARIABLE_Specs_17)
{
  ...
  else
  {
    ...
    else
    {
      ...
      {
        WarnSpec_41 = (MR_Word) MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(0, WarnSpec_41, 0) = ((MR_Box) ((MR_String) "predicate \140check_hlds.style_checks.chunks_to_spec\'/4"));
        MR_hl_field(0, WarnSpec_41, 1) = ((MR_Box) ((MR_Unsigned) 4U));
        MR_hl_field(0, WarnSpec_41, 2) = ((MR_Box) ((MR_Unsigned) 84U));
        MR_hl_field(0, WarnSpec_41, 3) = ((MR_Box) (ModuleContext_16));
        MR_hl_field(0, WarnSpec_41, 4) = ((MR_Box) (Pieces_53));
      }
      {
    ...
    else
    {
      ...
      {
        WarnSpec_77 = (MR_Word) MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(0, WarnSpec_77, 0) = ((MR_Box) ((MR_String) "predicate \140check_hlds.style_checks.chunks_to_spec\'/4"));
        MR_hl_field(0, WarnSpec_77, 1) = ((MR_Box) ((MR_Unsigned) 4U));
        MR_hl_field(0, WarnSpec_77, 2) = ((MR_Box) ((MR_Unsigned) 84U));
        MR_hl_field(0, WarnSpec_77, 3) = ((MR_Box) (ModuleContext_16));
        MR_hl_field(0, WarnSpec_77, 4) = ((MR_Box) (Pieces_89));
      }
      {
        MR_Word base;
        base = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
