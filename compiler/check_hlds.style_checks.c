...
{
  {
    ...
    if ((MaybeDeclInfo_11 == (MR_Word) ((MR_Integer) 0)))
    ...
    else
    {
      ...
      if ((MaybeDefnKind_7 == (MR_Word) ((MR_Integer) 0)))
      ...
      else
      {
        ...
        if ((Regions_30 == (MR_Word) ((MR_Integer) 0)))
          *STATE_VARIABLE_StyleInfo_43 = STATE_VARIABLE_StyleInfo_48_48;
        else
        {
  ...
  while (MR_TRUE)
  {
    ...
    if (!(succeeded))
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
          succeeded = (LaterINCs_11 == (MR_Word) ((MR_Integer) 0));
      }
    }
    if (succeeded)
    ...
    else
    {
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(0), Spec_25, 1) = ((MR_Box) ((MR_Integer) 48));
    ...
    if ((LaterINCs_11 == (MR_Word) ((MR_Integer) 0)))
      ...
      case (MR_Integer) 1:
        {
          ...
          check_hlds__style_checks__generate_inconsistent_pred_order_warnings_7_p_0(ModuleContext_20, (MR_String) "exported", ExportedPreds_15, (MR_Word) ((MR_Integer) 0), &STATE_VARIABLE_Specs_31_31);
    ...
    else
    {
      ...
      if (((MR_tag((MR_Word) DeclResult_16)) == (MR_mktag((MR_Integer) 1))))
      {
        ...
        if (((MR_tag((MR_Word) DefnResult_17)) == (MR_mktag((MR_Integer) 1))))
        {
          ...
          STATE_VARIABLE_TempFileNames_81_81 = (MR_Word) ((MR_Integer) 0);
          {
        ...
        else
        {
...

          {
            ...
            MR_hl_field(MR_mktag(1), STATE_VARIABLE_TempFileNames_81_81, 1) = ((MR_Box) ((MR_Integer) 0));
          }
          {
...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), Msg_11, 0) = ((MR_Box) ((MR_Integer) 0));
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(0), Spec_8, 1) = ((MR_Box) ((MR_Integer) 48));
...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), Msg_9, 0) = ((MR_Box) ((MR_Integer) 0));
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(0), Spec_6, 1) = ((MR_Box) ((MR_Integer) 48));
...
{
  {
    ...
    check_hlds__style_checks__read_lines_as_rev_strings_6_p_0(DiffStream_8, (MR_Word) ((MR_Integer) 0), &RevLines_14, &MaybeIOError_15);
    if ((MaybeIOError_15 == (MR_Word) ((MR_Integer) 0)))
    {
      MR_Word Lines_20;
      ...
      if (succeeded)
      {
        ...
        }
        {
          ...
          base = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL);
          *Spec_12 = base;
          MR_hl_field(MR_mktag(0), base, 0) = ((MR_Box) ((MR_Integer) 4));
          MR_hl_field(MR_mktag(0), base, 1) = ((MR_Box) ((MR_Integer) 48));
      ...
      else
      {
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(1), Msg_152, 0) = ((MR_Box) ((MR_Integer) 0));
    ...
    else
    {
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(1), Msg_19, 0) = ((MR_Box) ((MR_Integer) 0));
  ...
  MR_Word * MaybeIOError_9)
{
  while (MR_TRUE)
  {
    ...
    switch (MR_tag((MR_Word) Result_11)) {
      ...
      case (MR_Integer) 0:
        {
          *MaybeIOError_9 = (MR_Word) ((MR_Integer) 0);
...
{
  {
    ...
    if (((MR_tag((MR_Word) TempResult_12)) == (MR_mktag((MR_Integer) 1))))
    {
      ...
      {
        Var_58 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), Var_58, 0) = ((MR_Box) ((MR_Integer) 4));
        MR_hl_field(MR_mktag(1), Var_58, 1) = ((MR_Box) (Var_60));
      }
      {
        Var_55 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(1), Msg_41, 0) = ((MR_Box) ((MR_Integer) 0));
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(0), TempSpec_14, 0) = ((MR_Box) ((MR_Integer) 4));
        MR_hl_field(MR_mktag(0), TempSpec_14, 1) = ((MR_Box) ((MR_Integer) 48));
...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), Var_33, 0) = ((MR_Box) ((MR_Integer) 4));
