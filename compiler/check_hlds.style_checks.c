  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      }
      {
        ...
        MR_hl_field(2, Spec_26, 1) = ((MR_Box) (MR_mkword(1, &check_hlds__style_checks_scalar_common_3[3])));
        MR_hl_field(2, Spec_26, 2) = ((MR_Box) ((MR_Unsigned) 88U));
  ...
  else
  {
    ...
    else
    {
      ...
      }
      {
        ...
        MR_hl_field(0, WarnSpec_66, 2) = ((MR_Box) ((MR_Unsigned) 88U));
  ...
  MR_Word * STATE_VARIABLE_Specs_25)
{
  ...
  else
  {
    ...
    }
    {
      ...
      MR_hl_field(0, WarnSpec_23, 2) = ((MR_Box) ((MR_Unsigned) 88U));
