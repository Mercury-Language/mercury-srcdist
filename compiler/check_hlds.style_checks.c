  ...
  MR_Word * STATE_VARIABLE_Specs_17)
{
  ...
  else
  {
    ...
    else
    {
      ...
      Pieces_53 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_format_component_0), (MR_Word) (MR_mkword(MR_mktag(1), &check_hlds__style_checks_scalar_common_1[39])), ChangeHunkPieces_52);
      {
        WarnSpec_41 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), WarnSpec_41, 0) = ((MR_Box) ((MR_String) "predicate \140check_hlds.style_checks.chunks_to_spec\'/4"));
        MR_hl_field(MR_mktag(1), WarnSpec_41, 1) = ((MR_Box) ((MR_Unsigned) 4U));
        MR_hl_field(MR_mktag(1), WarnSpec_41, 2) = ((MR_Box) ((MR_Unsigned) 80U));
        MR_hl_field(MR_mktag(1), WarnSpec_41, 3) = ((MR_Box) (ModuleContext_16));
        MR_hl_field(MR_mktag(1), WarnSpec_41, 4) = ((MR_Box) (Pieces_53));
      }
      {
        STATE_VARIABLE_Specs_26_26 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), STATE_VARIABLE_Specs_26_26, 0) = ((MR_Box) (WarnSpec_41));
        MR_hl_field(MR_mktag(1), STATE_VARIABLE_Specs_26_26, 1) = ((MR_Box) (STATE_VARIABLE_Specs_22_22));
      }
    }
