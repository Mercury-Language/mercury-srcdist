  ...
  if (succeeded)
  {
    ...
    else
    {
      ...
      else
      {
        ...
        Var_76 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_StyleInfo_49_49, 0))));
        Var_75 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_StyleInfo_49_49, 1))));
        Var_74 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_StyleInfo_49_49, 2))));
