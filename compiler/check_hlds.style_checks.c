  ...
  MR_Word * STATE_VARIABLE_Specs_17)
{
  ...
  else
  {
    ...
    check_hlds__style_checks__generate_inconsistent_pred_order_warnings_5_p_0(ModuleContext_16, (MR_String) "exported", ExportedPreds_12, STATE_VARIABLE_Specs_23_23, &STATE_VARIABLE_Specs_25_25);
