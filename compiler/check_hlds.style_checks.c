  ...
  MR_Word * STATE_VARIABLE_Specs_17)
{
  ...
  else
  {
    ...
    MR_Word DeclOrder_32;
    MR_Word DefnOrder_33;

    hlds__hlds_module__module_info_get_name_context_2_p_0(ModuleInfo_5, &ModuleContext_16);
    mercury__list__sort_3_p_0((MR_Word) (&check_hlds__style_checks__check_hlds__style_checks__type_ctor_info_pred_item_numbers_0), (MR_Word) (&check_hlds__style_checks_scalar_common_2[7]), ExportedPreds_12, &DeclOrder_32);
    mercury__list__sort_3_p_0((MR_Word) (&check_hlds__style_checks__check_hlds__style_checks__type_ctor_info_pred_item_numbers_0), (MR_Word) (&check_hlds__style_checks_scalar_common_2[8]), ExportedPreds_12, &DefnOrder_33);
    succeeded = mercury__builtin__unify_2_p_0((MR_Word) (&check_hlds__style_checks_scalar_common_1[3]), ((MR_Box) (DeclOrder_32)), ((MR_Box) (DefnOrder_33)));
    if (succeeded)
    ...
    else
    {
      ...
      MR_Word EditSeq_37;
      MR_Word DiffSeq_38;
      MR_Word ChangeHunks_39;
      MR_Word WarnSpec_40;
      MR_Word ChangeHunkPieceLists_50;
      MR_Word ChangeHunkPieces_51;
      MR_Word Pieces_52;

      mercury__list__map_3_p_0((MR_Word) (&check_hlds__style_checks__check_hlds__style_checks__type_ctor_info_pred_item_numbers_0), (MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&check_hlds__style_checks_scalar_common_2[9]), DeclOrder_32, &DeclStrs_34);
      mercury__list__map_3_p_0((MR_Word) (&check_hlds__style_checks__check_hlds__style_checks__type_ctor_info_pred_item_numbers_0), (MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&check_hlds__style_checks_scalar_common_2[10]), DefnOrder_33, &DefnStrs_35);
      mercury__edit_seq__find_shortest_edit_seq_4_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&check_hlds__style_checks_scalar_common_2[1]), DeclStrs_34, DefnStrs_35, &EditSeq_37);
      mercury__edit_seq__find_diff_seq_3_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), DeclStrs_34, EditSeq_37, &DiffSeq_38);
      mercury__edit_seq__find_change_hunks_3_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Integer) 3, DiffSeq_38, &ChangeHunks_39);
      mercury__list__map_3_p_0((MR_Word) (&check_hlds__style_checks_scalar_common_1[1]), (MR_Word) (&check_hlds__style_checks_scalar_common_1[2]), (MR_Word) (&check_hlds__style_checks_scalar_common_2[11]), ChangeHunks_39, &ChangeHunkPieceLists_50);
      mercury__list__condense_2_p_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_format_component_0), ChangeHunkPieceLists_50, &ChangeHunkPieces_51);
      Pieces_52 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_format_component_0), (MR_Word) (MR_mkword(MR_mktag(1), &check_hlds__style_checks_scalar_common_1[39])), ChangeHunkPieces_51);
      {
        WarnSpec_40 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), WarnSpec_40, 0) = ((MR_Box) ((MR_String) "predicate \140check_hlds.style_checks.chunks_to_spec\'/4"));
        MR_hl_field(MR_mktag(1), WarnSpec_40, 1) = ((MR_Box) ((MR_Unsigned) 4U));
        MR_hl_field(MR_mktag(1), WarnSpec_40, 2) = ((MR_Box) ((MR_Unsigned) 80U));
        MR_hl_field(MR_mktag(1), WarnSpec_40, 3) = ((MR_Box) (ModuleContext_16));
        MR_hl_field(MR_mktag(1), WarnSpec_40, 4) = ((MR_Box) (Pieces_52));
      }
      {
        STATE_VARIABLE_Specs_25_25 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), STATE_VARIABLE_Specs_25_25, 0) = ((MR_Box) (WarnSpec_40));
  ...
  MR_Word * STATE_VARIABLE_Specs_23)
{
  ...
  else
  {
    ...
    mercury__edit_seq__find_change_hunks_3_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Integer) 3, DiffSeq_19, &ChangeHunks_20);
    {
      ...
      MR_hl_field(MR_mktag(3), Var_55, 1) = ((MR_Box) (ExportedOrNotStr_7));
    }
    {
      Var_54 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), Var_54, 0) = ((MR_Box) (Var_55));
      MR_hl_field(MR_mktag(1), Var_54, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &check_hlds__style_checks_scalar_common_1[34])));
    }
    {
      Var_51 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), Var_51, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &check_hlds__style_checks_scalar_common_1[25])));
      MR_hl_field(MR_mktag(1), Var_51, 1) = ((MR_Box) (Var_54));
    }
    {
      Var_48 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), Var_48, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &check_hlds__style_checks_scalar_common_1[24])));
      MR_hl_field(MR_mktag(1), Var_48, 1) = ((MR_Box) (Var_51));
    }
    {
      HeadPieces_42 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), HeadPieces_42, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &check_hlds__style_checks_scalar_common_1[23])));
      MR_hl_field(MR_mktag(1), HeadPieces_42, 1) = ((MR_Box) (Var_48));
    }
    ...
    Pieces_45 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_format_component_0), HeadPieces_42, ChangeHunkPieces_44);
    {
      ...
      MR_hl_field(MR_mktag(1), WarnSpec_21, 4) = ((MR_Box) (Pieces_45));
    }
    {
      MR_Word base;
      base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
