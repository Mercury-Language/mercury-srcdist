  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      if ((BaseTypeCtorParams_33 == (MR_Word) ((MR_Unsigned) 0U)))
        mercury__set__init_1_p_0((MR_Word) (&check_hlds__typecheck_coerce_scalar_common_1[0]), &InvariantTVars_34);
      else
      {
        MR_Word OoMCtors_58 = ((MR_Word) ((MR_hl_field(0, FromBaseTypeBodyDu_25, 0))));
        MR_Word Ctors_64;
        MR_Word Var_65;
        MR_Word Var_66;
