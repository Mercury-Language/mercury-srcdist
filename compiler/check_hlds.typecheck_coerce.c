  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      switch (Status0_40) {
        ...
        case (MR_Integer) 0:
          {
            ...
            if (succeeded)
            {
              ...
              MR_Word InvariantTVars_62;
              MR_Word BaseTypeBody_64;
                ...
                if (succeeded)
                {
                  ...
                  if (succeeded)
                  {
                    ...
                    if (succeeded)
                    {
                      ...
                      hlds__hlds_data__get_type_defn_body_2_p_0(BaseTypeDefn_60, &BaseTypeBody_64);
                      switch (MR_tag((MR_Word) BaseTypeBody_64)) {
                        default: /*NOTREACHED*/ MR_assert(0);
                        case (MR_Integer) 0:
                          {
                            MR_Word BaseTypeBodyDu_65 = (MR_Word) ((MR_Word) (BaseTypeBody_64));
                            MR_Word OoMCtors_66 = ((MR_Word) ((MR_hl_field(0, BaseTypeBodyDu_65, 0))));
                            MR_Word Ctors_71;
                            MR_Word Var_72;
                            MR_Word Var_73;
                            MR_Box conv1_InvariantTVars_62;

                            Ctors_71 = mercury__one_or_more__one_or_more_to_list_1_f_1((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_constructor_0), OoMCtors_66);
                            {
                              Var_72 = (MR_Word) MR_new_object(MR_Word, (6 * sizeof(MR_Word)), NULL, NULL);
                              MR_hl_field(0, Var_72, 0) = ((MR_Box) (&check_hlds__typecheck_coerce_scalar_common_6[0]));
                              MR_hl_field(0, Var_72, 1) = ((MR_Box) (check_hlds__typecheck_coerce__check_pending_coerce_constraints_loop_8_p_0_1));
                              MR_hl_field(0, Var_72, 2) = ((MR_Box) ((MR_Integer) 3));
                              MR_hl_field(0, Var_72, 3) = ((MR_Box) (HeadVar__1_1));
                              MR_hl_field(0, Var_72, 4) = ((MR_Box) (BaseTypeCtor_59));
                              MR_hl_field(0, Var_72, 5) = ((MR_Box) (BaseTypeParams_61));
                            }
                            Var_73 = mercury__set__init_0_f_0((MR_Word) (&check_hlds__typecheck_coerce_scalar_common_1[1]));
                            mercury__list__foldl_4_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_constructor_0), (MR_Word) (&check_hlds__typecheck_coerce_scalar_common_1[2]), Var_72, Ctors_71, ((MR_Box) (Var_73)), &conv1_InvariantTVars_62);
                            InvariantTVars_62 = ((MR_Word) (conv1_InvariantTVars_62));
                          }
                          break;
                        case (MR_Integer) 1:
                        case (MR_Integer) 2:
                        case (MR_Integer) 3:
                          {
                            mercury__require__unexpected_2_p_0((MR_String) "predicate \140check_hlds.typecheck_coerce.compute_which_type_params_must_be_invariant\'/5", (MR_String) "not du type");
                            return;
                          }
                          break;
                      }
                      succeeded = check_hlds__typecheck_coerce__are_type_params_as_related_as_needed_8_p_0(HeadVar__1_1, TVarSet_42, InvariantTVars_62, BaseTypeParams_61, FromBaseTypeArgTypes_56, ToBaseTypeArgTypes_58, STATE_VARIABLE_TypeAssign_0_5, &TypeAssign1_47);
                    }
                  }
                }
              }
              if (succeeded)
              {
                ...
                parse_tree__prog_type_subst__apply_rec_subst_to_type_3_p_0(TypeBindings1_48, FromType_45, &TypeA_79);
                parse_tree__prog_type_subst__apply_rec_subst_to_type_3_p_0(TypeBindings1_48, ToType_46, &TypeB_80);
                Var_81 = parse_tree__prog_type_test__strip_kind_annotation_1_f_0(TypeA_79);
                Var_82 = parse_tree__prog_type_test__strip_kind_annotation_1_f_0(TypeB_80);
                succeeded = parse_tree__prog_type_test____Unify____non_kinded_type_0_0(Var_81, Var_82);
                if (succeeded)
                {
                  MR_Word Coercion_24;
              ...
              {
                MR_Word Coercion_96;
                MR_Word TailKeepCoercions_97;

                {
                  Coercion_96 = (MR_Word) MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL);
                  MR_hl_field(0, Coercion_96, 0) = ((MR_Box) (FromType0_36));
                  MR_hl_field(0, Coercion_96, 1) = ((MR_Box) (ToType0_37));
                  MR_hl_field(0, Coercion_96, 2) = ((MR_Box) (Context_38));
                  MR_hl_field(0, Coercion_96, 3) = ((MR_Box) (FromVar_39));
                  MR_hl_field(0, Coercion_96, 4) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 1));
                }
                check_hlds__typecheck_coerce__check_pending_coerce_constraints_loop_8_p_0(HeadVar__1_1, Coercions0_18, &TailKeepCoercions_97, HeadVar__4_4, STATE_VARIABLE_TypeAssign_0_5, STATE_VARIABLE_TypeAssign_6, (MR_Integer) 1, STATE_VARIABLE_MadeProgress_8);
                {
                  MR_Word base;
                  base = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                  *HeadVar__3_3 = base;
                  MR_hl_field(1, base, 0) = ((MR_Box) (Coercion_96));
                  MR_hl_field(1, base, 1) = ((MR_Box) (TailKeepCoercions_97));
                }
              }
            }
            else
        ...
        case (MR_Integer) 1:
          {
            MR_Word TailKeepCoercions_88;

            check_hlds__typecheck_coerce__check_pending_coerce_constraints_loop_8_p_0(HeadVar__1_1, Coercions0_18, &TailKeepCoercions_88, HeadVar__4_4, STATE_VARIABLE_TypeAssign_0_5, STATE_VARIABLE_TypeAssign_6, (MR_Integer) 1, STATE_VARIABLE_MadeProgress_8);
            {
              MR_Word base;
              base = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              *HeadVar__3_3 = base;
              MR_hl_field(1, base, 0) = ((MR_Box) (Coercion0_17));
              MR_hl_field(1, base, 1) = ((MR_Box) (TailKeepCoercions_88));
            }
          }
          break;
      }
      ...
      case (MR_Integer) 1:
        {
          ...
          succeeded = parse_tree__prog_type__type_to_ctor_and_args_3_p_0(RhsType_10, &TypeCtor_17, &TypeArgs_18);
          if (succeeded)
              ...
              case (MR_Integer) 0:
                {
                  ...
                  MR_Word TypeArgVars_22;

                  succeeded = parse_tree__prog_data____Unify____type_ctor_0_0(TypeCtor_17, BaseTypeCtor_8);
                  if (succeeded)
                  {
                    succeeded = parse_tree__prog_type__type_list_to_var_list_2_p_0(TypeArgs_18, &TypeArgVars_22);
                    if (succeeded)
                    {
                      TypeInfo_71_71 = (MR_Word) (&check_hlds__typecheck_coerce_scalar_common_1[4]);
                      succeeded = mercury__builtin__unify_2_p_0(TypeInfo_71_71, ((MR_Box) (TypeArgVars_22)), ((MR_Box) (BaseTypeParams_9)));
                    }
                  }
                  if (succeeded)
                    *STATE_VARIABLE_InvariantTVars_39 = STATE_VARIABLE_InvariantTVars_0_38;
              ...
              case (MR_Integer) 2:
                {
                  ...
                  mercury__map__from_corresponding_lists_3_p_0((MR_Word) (&check_hlds__typecheck_coerce_scalar_common_1[1]), (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0), TypeParams_28, TypeArgs_18, &TSubst_29);
  ...
  MR_Word * STATE_VARIABLE_TypeAssignSet_33)
{
  ...
  if (succeeded)
  {
    ...
    MR_Word InvariantTVars_55;
    MR_Word BaseTypeBody_57;
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            ...
            hlds__hlds_data__get_type_defn_body_2_p_0(BaseTypeDefn_53, &BaseTypeBody_57);
            switch (MR_tag((MR_Word) BaseTypeBody_57)) {
              default: /*NOTREACHED*/ MR_assert(0);
              case (MR_Integer) 0:
                {
                  MR_Word BaseTypeBodyDu_58 = (MR_Word) ((MR_Word) (BaseTypeBody_57));
                  MR_Word OoMCtors_59 = ((MR_Word) ((MR_hl_field(0, BaseTypeBodyDu_58, 0))));
                  MR_Word Ctors_64;
                  MR_Word Var_65;
                  MR_Word Var_66;
                  MR_Box conv1_InvariantTVars_55;

                  Ctors_64 = mercury__one_or_more__one_or_more_to_list_1_f_1((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_constructor_0), OoMCtors_59);
                  {
                    Var_65 = (MR_Word) MR_new_object(MR_Word, (6 * sizeof(MR_Word)), NULL, NULL);
                    MR_hl_field(0, Var_65, 0) = ((MR_Box) (&check_hlds__typecheck_coerce_scalar_common_6[0]));
                    MR_hl_field(0, Var_65, 1) = ((MR_Box) (check_hlds__typecheck_coerce__typecheck_coerce_2_7_p_0_1));
                    MR_hl_field(0, Var_65, 2) = ((MR_Box) ((MR_Integer) 3));
                    MR_hl_field(0, Var_65, 3) = ((MR_Box) (TypeTable_26));
                    MR_hl_field(0, Var_65, 4) = ((MR_Box) (BaseTypeCtor_52));
                    MR_hl_field(0, Var_65, 5) = ((MR_Box) (BaseTypeParams_54));
                  }
                  Var_66 = mercury__set__init_0_f_0((MR_Word) (&check_hlds__typecheck_coerce_scalar_common_1[1]));
                  mercury__list__foldl_4_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_constructor_0), (MR_Word) (&check_hlds__typecheck_coerce_scalar_common_1[2]), Var_65, Ctors_64, ((MR_Box) (Var_66)), &conv1_InvariantTVars_55);
                  InvariantTVars_55 = ((MR_Word) (conv1_InvariantTVars_55));
                }
                break;
              case (MR_Integer) 1:
              case (MR_Integer) 2:
            ...
            succeeded = check_hlds__typecheck_coerce__are_type_params_as_related_as_needed_8_p_0(TypeTable_26, TVarSet_15, InvariantTVars_55, BaseTypeParams_54, FromBaseTypeArgTypes_49, ToBaseTypeArgTypes_51, TypeAssign0_12, &TypeAssign1_27);
          }
        }
      }
    }
    if (succeeded)
    {
      ...
      parse_tree__prog_type_subst__apply_rec_subst_to_type_3_p_0(TypeBindings1_28, FromType_24, &TypeA_72);
      parse_tree__prog_type_subst__apply_rec_subst_to_type_3_p_0(TypeBindings1_28, ToType_25, &TypeB_73);
      Var_74 = parse_tree__prog_type_test__strip_kind_annotation_1_f_0(TypeA_72);
      Var_75 = parse_tree__prog_type_test__strip_kind_annotation_1_f_0(TypeB_73);
      succeeded = parse_tree__prog_type_test____Unify____non_kinded_type_0_0(Var_74, Var_75);
      if (succeeded)
      {
        MR_Word Coercion_29;
        MR_Word Coercions0_77;
        MR_Word Coercions_78;
        ...
        check_hlds__type_assign__type_assign_get_coerce_constraints_2_p_0(TypeAssign1_27, &Coercions0_77);
        {
          Coercions_78 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(1, Coercions_78, 0) = ((MR_Box) (Coercion_29));
          MR_hl_field(1, Coercions_78, 1) = ((MR_Box) (Coercions0_77));
        }
        check_hlds__type_assign__type_assign_set_coerce_constraints_3_p_0(Coercions_78, TypeAssign1_27, &TypeAssign_30);
      }
      else
    ...
    else
    {
      ...
      check_hlds__type_assign__type_assign_get_coerce_constraints_2_p_0(TypeAssign0_12, &Coercions0_79);
      {
        Coercions_80 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(1, Coercions_80, 0) = ((MR_Box) (Coercion_39));
        MR_hl_field(1, Coercions_80, 1) = ((MR_Box) (Coercions0_79));
      }
      check_hlds__type_assign__type_assign_set_coerce_constraints_3_p_0(Coercions_80, TypeAssign0_12, &TypeAssign_30);
    }
    {
      MR_Word base;
      base = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
  ...
  else
  {
    ...
    check_hlds__type_assign__type_assign_get_coerce_constraints_2_p_0(TypeAssign2_31, &Coercions0_81);
    {
      Coercions_82 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(1, Coercions_82, 0) = ((MR_Box) (Coercion_43));
      MR_hl_field(1, Coercions_82, 1) = ((MR_Box) (Coercions0_81));
    }
    check_hlds__type_assign__type_assign_set_coerce_constraints_3_p_0(Coercions_82, TypeAssign2_31, &TypeAssign_44);
    {
      MR_Word base;
      base = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      *STATE_VARIABLE_TypeAssignSet_33 = base;
            ...
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                ...
                else
                {
                  ...
                  if (succeeded)
                  {
                    succeeded = check_hlds__type_util__get_supertype_5_p_0(TypeTable_8, TVarSet_9, TypeCtorA_28, ArgTypesA_29, &SuperTypeA_32);
                    if (succeeded)
                    {
                      // direct tailcall eliminated
                      ;
                ...
                if (succeeded)
                {
                  ...
                  if (succeeded)
                  {
                    ...
                    else
                    {
                      ...
                      if (succeeded)
                      {
                        succeeded = check_hlds__type_util__get_supertype_5_p_0(HeadVar__1_1, HeadVar__2_2, TypeCtorA_37, ArgTypesA_38, &SuperTypeA_41);
                        if (succeeded)
  ...
  MR_Word * BaseType_8)
{
  while (MR_TRUE)
  {
    ...
    if (succeeded)
      succeeded = check_hlds__type_util__get_supertype_5_p_0(TypeTable_5, TVarSet_6, TypeCtor_9, ArgTypes_10, &SuperType_11);
    if (succeeded)
    {
