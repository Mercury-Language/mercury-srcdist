  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      switch (Status0_40) {
        ...
        case (MR_Integer) 0:
          {
            ...
            if (succeeded)
            {
              ...
              MR_Word TypeCtorInfo_19_74;
              MR_Word TypeInfo_23_75;
                  ...
                  if (succeeded)
                  {
                    ...
                    if (succeeded)
                    {
                      ...
                      if (succeeded)
                      {
                        ...
                        TypeCtorInfo_19_74 = (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_constructor_0);
                        Ctors_71 = mercury__one_or_more__one_or_more_to_list_1_f_1(TypeCtorInfo_19_74, OoMCtors_66);
                        TypeInfo_23_75 = (MR_Word) (&check_hlds__typecheck_coerce_scalar_common_1[1]);
                        {
                          ...
                          MR_hl_field(0, Var_72, 5) = ((MR_Box) (BaseTypeParams_63));
                        }
                        Var_73 = mercury__set__init_0_f_0(TypeInfo_23_75);
                        TypeInfo_24_76 = (MR_Word) (&check_hlds__typecheck_coerce_scalar_common_1[2]);
                        mercury__list__foldl_4_p_0(TypeCtorInfo_19_74, TypeInfo_24_76, Var_72, Ctors_71, ((MR_Box) (Var_73)), &conv1_InvariantTVars_64);
              ...
              if (succeeded)
              {
                ...
                parse_tree__prog_type_subst__apply_rec_subst_to_type_3_p_0(TypeBindings1_48, FromType_45, &TypeA_77);
                parse_tree__prog_type_subst__apply_rec_subst_to_type_3_p_0(TypeBindings1_48, ToType_46, &TypeB_78);
              ...
              {
                MR_Word Coercion_94;
                MR_Word TailKeepCoercions_95;

                {
                  Coercion_94 = (MR_Word) MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL);
                  MR_hl_field(0, Coercion_94, 0) = ((MR_Box) (FromType0_36));
                  MR_hl_field(0, Coercion_94, 1) = ((MR_Box) (ToType0_37));
                  MR_hl_field(0, Coercion_94, 2) = ((MR_Box) (Context_38));
                  MR_hl_field(0, Coercion_94, 3) = ((MR_Box) (FromVar_39));
                  MR_hl_field(0, Coercion_94, 4) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 1));
                }
                check_hlds__typecheck_coerce__check_pending_coerce_constraints_loop_8_p_0(HeadVar__1_1, Coercions0_18, &TailKeepCoercions_95, HeadVar__4_4, STATE_VARIABLE_TypeAssign_0_5, STATE_VARIABLE_TypeAssign_6, (MR_Integer) 1, STATE_VARIABLE_MadeProgress_8);
                {
                  MR_Word base;
                  base = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                  *HeadVar__3_3 = base;
                  MR_hl_field(1, base, 0) = ((MR_Box) (Coercion_94));
                  MR_hl_field(1, base, 1) = ((MR_Box) (TailKeepCoercions_95));
                }
              }
            }
            else
        ...
        case (MR_Integer) 1:
          {
            MR_Word TailKeepCoercions_86;

            check_hlds__typecheck_coerce__check_pending_coerce_constraints_loop_8_p_0(HeadVar__1_1, Coercions0_18, &TailKeepCoercions_86, HeadVar__4_4, STATE_VARIABLE_TypeAssign_0_5, STATE_VARIABLE_TypeAssign_6, (MR_Integer) 1, STATE_VARIABLE_MadeProgress_8);
            {
              MR_Word base;
              base = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              *HeadVar__3_3 = base;
              MR_hl_field(1, base, 0) = ((MR_Box) (Coercion0_17));
              MR_hl_field(1, base, 1) = ((MR_Box) (TailKeepCoercions_86));
            }
          }
          break;
      }
  ...
  MR_Word * STATE_VARIABLE_TypeAssignSet_33)
{
  ...
  if (succeeded)
  {
    ...
    MR_Word TypeCtorInfo_19_67;
    MR_Word TypeInfo_23_68;
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              ...
              TypeCtorInfo_19_67 = (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_constructor_0);
              Ctors_64 = mercury__one_or_more__one_or_more_to_list_1_f_1(TypeCtorInfo_19_67, OoMCtors_59);
              TypeInfo_23_68 = (MR_Word) (&check_hlds__typecheck_coerce_scalar_common_1[1]);
              {
                ...
                MR_hl_field(0, Var_65, 5) = ((MR_Box) (BaseTypeParams_56));
              }
              Var_66 = mercury__set__init_0_f_0(TypeInfo_23_68);
              TypeInfo_24_69 = (MR_Word) (&check_hlds__typecheck_coerce_scalar_common_1[2]);
              mercury__list__foldl_4_p_0(TypeCtorInfo_19_67, TypeInfo_24_69, Var_65, Ctors_64, ((MR_Box) (Var_66)), &conv1_InvariantTVars_57);
    ...
    if (succeeded)
    {
      ...
      parse_tree__prog_type_subst__apply_rec_subst_to_type_3_p_0(TypeBindings1_28, FromType_24, &TypeA_70);
      parse_tree__prog_type_subst__apply_rec_subst_to_type_3_p_0(TypeBindings1_28, ToType_25, &TypeB_71);
      Var_72 = parse_tree__prog_type_test__strip_kind_annotation_1_f_0(TypeA_70);
      Var_73 = parse_tree__prog_type_test__strip_kind_annotation_1_f_0(TypeB_71);
      succeeded = parse_tree__prog_type_test____Unify____non_kinded_type_0_0(Var_72, Var_73);
      if (succeeded)
      {
        MR_Word Coercion_29;
        MR_Word Coercions0_75;
        MR_Word Coercions_76;
        ...
        check_hlds__type_assign__type_assign_get_coerce_constraints_2_p_0(TypeAssign1_27, &Coercions0_75);
        {
          Coercions_76 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(1, Coercions_76, 0) = ((MR_Box) (Coercion_29));
          MR_hl_field(1, Coercions_76, 1) = ((MR_Box) (Coercions0_75));
        }
        check_hlds__type_assign__type_assign_set_coerce_constraints_3_p_0(Coercions_76, TypeAssign1_27, &TypeAssign_30);
      }
      else
    ...
    else
    {
      ...
      check_hlds__type_assign__type_assign_get_coerce_constraints_2_p_0(TypeAssign0_12, &Coercions0_77);
      {
        Coercions_78 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(1, Coercions_78, 0) = ((MR_Box) (Coercion_39));
        MR_hl_field(1, Coercions_78, 1) = ((MR_Box) (Coercions0_77));
      }
      check_hlds__type_assign__type_assign_set_coerce_constraints_3_p_0(Coercions_78, TypeAssign0_12, &TypeAssign_30);
    }
    {
      MR_Word base;
      base = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
  ...
  else
  {
    ...
    check_hlds__type_assign__type_assign_get_coerce_constraints_2_p_0(TypeAssign2_31, &Coercions0_79);
    {
      Coercions_80 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(1, Coercions_80, 0) = ((MR_Box) (Coercion_43));
      MR_hl_field(1, Coercions_80, 1) = ((MR_Box) (Coercions0_79));
    }
    check_hlds__type_assign__type_assign_set_coerce_constraints_3_p_0(Coercions_80, TypeAssign2_31, &TypeAssign_44);
    {
      MR_Word base;
      base = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      *STATE_VARIABLE_TypeAssignSet_33 = base;
