            ...
            case (MR_Integer) 0:
              {
                ...
                if (succeeded)
                {
                  ...
                  if (succeeded)
                  {
                    TypeInfo_69_69 = (MR_Word) (&check_hlds__typecheck_coerce_scalar_common_1[4]);
          ...
          case (MR_Integer) 0:
            {
...

              {
                ...
                MR_hl_field(0, Var_43, 0) = ((MR_Box) (&check_hlds__typecheck_coerce_scalar_common_3[3]));
            ...
            if (((MR_tag((MR_Word) FromMaybeDuType_37)) == (MR_Integer) 0))
            {
              ...
              if (((MR_tag((MR_Word) ToMaybeDuType_38)) == (MR_Integer) 0))
              {
                ...
                if ((env).check_hlds__typecheck_coerce__check_coerce_constraint_if_ready_5_p_0_env_0__succeeded)
                {
                  ...
                  hlds__hlds_data__get_type_defn_tparams_2_p_0(FromBaseTypeDefn_50, &BaseTypeCtorParams_59);
                  ...
                  Ctors_82 = mercury__one_or_more__one_or_more_to_list_1_f_1((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_constructor_0), OoMCtors_76);
                  {
                    ...
                    MR_hl_field(0, Var_83, 5) = ((MR_Box) (BaseTypeCtorParams_59));
                  }
                  ...
                  check_hlds__typecheck_coerce__are_actual_param_type_pairs_as_related_as_needed_10_p_0(TypeTable_6, TVarSet0_17, InvariantTVars_60, BaseTypeCtorParams_59, FromBaseTypeArgTypes_49, ToBaseTypeArgTypes_53, STATE_VARIABLE_TypeAssign_0_28, &TypeAssign1_22, (MR_Word) ((MR_Unsigned) 0U), &CoerceFails_23);
                }
                else
                {
    ...
    if (((MR_tag((MR_Word) ToMaybeDuType_15)) == (MR_Integer) 0))
    {
      ...
      if (succeeded)
      {
        ...
        Ctors_62 = mercury__one_or_more__one_or_more_to_list_1_f_1((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_constructor_0), OoMCtors_56);
        {
          ...
          MR_hl_field(0, Var_63, 5) = ((MR_Box) (BaseTypeCtorParams_36));
        }
        ...
        check_hlds__typecheck_coerce__are_actual_param_type_pairs_as_related_as_needed_10_p_0(TypeTable_8, TVarSet_9, InvariantTVars_37, BaseTypeCtorParams_36, FromBaseTypeArgTypes_26, ToBaseTypeArgTypes_30, STATE_VARIABLE_TypeAssign_0_38, STATE_VARIABLE_TypeAssign_39, (MR_Word) ((MR_Unsigned) 0U), CoerceFails_13);
      }
      else
      {
