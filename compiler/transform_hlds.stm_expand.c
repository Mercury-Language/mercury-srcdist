...
static void MR_CALL 
transform_hlds__stm_expand__IntroducedFrom__pred__create_wrapper_for_goal_list__1383__1_8_p_0(
  MR_Word Context_10,
  MR_Word ResultType_12,
  MR_Word ResultVar_13,
  ...
  MR_Word * STATE_VARIABLE_Accum_19)
{
  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      transform_hlds__stm_expand__IntroducedFrom__pred__create_wrapper_for_goal_list__1383__1_8_p_0(Var_28, Var_29, Var_30, S_12, T_14, &R_16, STATE_VARIABLE_Accum_0_18, &STATE_VARIABLE_Accum_20_20);
