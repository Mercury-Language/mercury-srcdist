...
MR_decl_label10(transform_hlds__stm_expand__stm_process_goal_5_0, 26,30,85,185,34,44,48,107,53,52)
MR_decl_label10(transform_hlds__stm_expand__stm_process_goal_5_0, 20,60,61,63,64,65,66,59,68,57)
MR_decl_label1(transform_hlds__stm_expand__stm_process_goal_5_0, 72)
...
MR_BEGIN_MODULE(transform_hlds__stm_expand_module54)
	...
	MR_init_label10(transform_hlds__stm_expand__stm_process_goal_5_0,26,30,85,185,34,44,48,107,53,52)
	MR_init_label10(transform_hlds__stm_expand__stm_process_goal_5_0,20,60,61,63,64,65,66,59,68,57)
	MR_init_label1(transform_hlds__stm_expand__stm_process_goal_5_0,72)
MR_BEGIN_CODE
...
MR_def_label(transform_hlds__stm_expand__stm_process_goal_5_0,30)
	...
	if (MR_INT_NE(MR_r6,0)) {
		MR_GOTO_LAB(transform_hlds__stm_expand__stm_process_goal_5_0_i185);
	}
MR_def_label(transform_hlds__stm_expand__stm_process_goal_5_0,85)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_r2;
	MR_r2 = MR_r3;
	MR_proceed();
MR_def_label(transform_hlds__stm_expand__stm_process_goal_5_0,185)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(8);
	MR_sv(8) = (MR_Word) MR_succip;
	if (MR_INT_NE(MR_r6,1)) {
		MR_GOTO_LAB(transform_hlds__stm_expand__stm_process_goal_5_0_i107);
	}
	MR_sv(2) = MR_tfield(0, MR_r2, 1);
	MR_sv(1) = MR_r5;
	MR_r2 = MR_tfield(3, MR_r4, 2);
...
MR_def_label(transform_hlds__stm_expand__stm_process_goal_5_0,48)
	...
	MR_incr_sp(8);
	MR_sv(8) = (MR_Word) MR_succip;
MR_def_label(transform_hlds__stm_expand__stm_process_goal_5_0,107)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(2) = MR_tfield(0, MR_r2, 1);
	MR_sv(1) = MR_r5;
	MR_r2 = MR_tfield(3, MR_r4, 2);
...
MR_def_label(transform_hlds__stm_expand__stm_process_goal_5_0,57)
	...
	if (MR_RTAGS_TESTR(MR_r4,3,3)) {
		MR_GOTO_LAB(transform_hlds__stm_expand__stm_process_goal_5_0_i85);
	}
	MR_incr_sp(8);
	MR_sv(8) = (MR_Word) MR_succip;
	MR_sv(2) = MR_tfield(0, MR_r2, 1);
