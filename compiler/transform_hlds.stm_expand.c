...
MR_decl_label2(transform_hlds__stm_expand__IntroducedFrom__pred__rename_var_in_wrapper_pred__2076__1_4_0, 3,2)
...
MR_decl_static(transform_hlds__stm_expand__IntroducedFrom__pred__common_goal_vars_from_list__564__1_2_0)
...
MR_decl_static(transform_hlds__stm_expand__IntroducedFrom__pred__rename_var_in_wrapper_pred__2076__1_4_0)
...
{
MR_COMMON(4,0),
MR_ENTRY_AP(transform_hlds__stm_expand__IntroducedFrom__pred__common_goal_vars_from_list__564__1_2_0),
0
},
{
MR_COMMON(9,0),
...
MR_def_label(transform_hlds__stm_expand__rename_var_in_wrapper_pred_8_0,10)
	...
	MR_tfield(0, MR_tempr1, 1) = (MR_Word) MR_ENTRY_AP(transform_hlds__stm_expand__IntroducedFrom__pred__rename_var_in_wrapper_pred__2076__1_4_0);
...
MR_BEGIN_MODULE(transform_hlds__stm_expand_module70)
	MR_init_entry1(transform_hlds__stm_expand__IntroducedFrom__pred__common_goal_vars_from_list__564__1_2_0);
	MR_INIT_PROC_LAYOUT_ADDR(mercury__transform_hlds__stm_expand__IntroducedFrom__pred__common_goal_vars_from_list__564__1_2_0);
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'IntroducedFrom__pred__common_goal_vars_from_list__564__1'/2 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(transform_hlds__stm_expand__IntroducedFrom__pred__common_goal_vars_from_list__564__1_2_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_BEGIN_MODULE(transform_hlds__stm_expand_module77)
	MR_init_entry1(transform_hlds__stm_expand__IntroducedFrom__pred__rename_var_in_wrapper_pred__2076__1_4_0);
	MR_INIT_PROC_LAYOUT_ADDR(mercury__transform_hlds__stm_expand__IntroducedFrom__pred__rename_var_in_wrapper_pred__2076__1_4_0);
	MR_init_label2(transform_hlds__stm_expand__IntroducedFrom__pred__rename_var_in_wrapper_pred__2076__1_4_0,3,2)
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'IntroducedFrom__pred__rename_var_in_wrapper_pred__2076__1'/4 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(transform_hlds__stm_expand__IntroducedFrom__pred__rename_var_in_wrapper_pred__2076__1_4_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(3);
	MR_sv(3) = (MR_Word) MR_succip;
	MR_sv(1) = MR_r2;
	...
	MR_np_call_localret_ent(__Unify___term__var_1_0,
		transform_hlds__stm_expand__IntroducedFrom__pred__rename_var_in_wrapper_pred__2076__1_4_0_i3);
MR_def_label(transform_hlds__stm_expand__IntroducedFrom__pred__rename_var_in_wrapper_pred__2076__1_4_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(transform_hlds__stm_expand__IntroducedFrom__pred__rename_var_in_wrapper_pred__2076__1_4_0_i2);
	}
	MR_r1 = MR_sv(1);
	MR_decr_sp_and_return(3);
MR_def_label(transform_hlds__stm_expand__IntroducedFrom__pred__rename_var_in_wrapper_pred__2076__1_4_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(2);
	MR_decr_sp_and_return(3);
#ifdef MR_maybe_local_thread_engine_base
