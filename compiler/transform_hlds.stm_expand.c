...
transform_hlds__stm_expand__IntroducedFrom__pred__make_type_info__2419__1_2_p_0(
              ...
              else
              {
                ...
                if (succeeded)
                  *HeadVar__1_1 = SubResult6_21;
                  ...
                  mercury__private_builtin__builtin_compare_int_3_p_0(HeadVar__1_1, ArgX7_22, ArgY7_23);
              }
            }
          }
        }
          ...
          else
          {
            ...
            else
            {
              ...
              else
              {
                ...
                mercury__private_builtin__builtin_compare_int_3_p_0(&SubResult6_21, Var_33, Var_34);
                succeeded = (SubResult6_21 != (MR_Integer) 0);
                if (succeeded)
                  *HeadVar__1_1 = SubResult6_21;
                else
...
{
  {
    ...
    succeeded = transform_hlds__stm_expand__IntroducedFrom__pred__make_type_info__2419__1_2_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))));
    return succeeded;
  }
}
