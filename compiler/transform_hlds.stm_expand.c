...
static /* final */ const MR_Box transform_hlds__stm_expand_scalar_common_5[27][1];
...
{
  {
    ...
    transform_hlds__stm_expand__create_aux_variable_5_p_0(Var_47, (MR_Word) (MR_mkword(MR_mktag(1), &transform_hlds__stm_expand_scalar_common_5[26])), LambdaHeadVar__2_44, LambdaHeadVar__3_45, LambdaHeadVar__4_46);
  }
}
...
{
  {
    ...
    else
    {
      ...
      transform_hlds__stm_expand__create_aux_variable_stm_5_p_0(ResultType_46, (MR_Word) (MR_mkword(MR_mktag(1), &transform_hlds__stm_expand_scalar_common_5[25])), &ResultVar_47, STATE_VARIABLE_StmInfo_68_68, &STATE_VARIABLE_StmInfo_94_94);
...
{
  {
    ...
    transform_hlds__stm_expand__create_aux_variable_5_p_0(ResultType_20, (MR_Word) (MR_mkword(MR_mktag(1), &transform_hlds__stm_expand_scalar_common_5[22])), &ResultVar_21, STATE_VARIABLE_NewPredInfo_0_28, &STATE_VARIABLE_NewPredInfo_33_33);
    Var_35 = parse_tree__builtin_lib_types__stm_state_type_0_f_0();
    transform_hlds__stm_expand__create_aux_variable_5_p_0(Var_35, (MR_Word) (MR_mkword(MR_mktag(1), &transform_hlds__stm_expand_scalar_common_5[23])), &InnerDI_22, STATE_VARIABLE_NewPredInfo_33_33, &STATE_VARIABLE_NewPredInfo_37_37);
    Var_39 = parse_tree__builtin_lib_types__stm_state_type_0_f_0();
    transform_hlds__stm_expand__create_aux_variable_5_p_0(Var_39, (MR_Word) (MR_mkword(MR_mktag(1), &transform_hlds__stm_expand_scalar_common_5[24])), &InnerUO_23, STATE_VARIABLE_NewPredInfo_37_37, &STATE_VARIABLE_NewPredInfo_41_41);
...
{
  {
    ...
    if (succeeded)
    {
      ...
      transform_hlds__stm_expand__create_aux_variable_5_p_0(Var_66, (MR_Word) (MR_mkword(MR_mktag(1), &transform_hlds__stm_expand_scalar_common_5[13])), &InnerUO_30, STATE_VARIABLE_NewPredInfo_64_64, &STATE_VARIABLE_NewPredInfo_68_68);
    }
    else
    {
...
{
  {
    ...
    transform_hlds__stm_expand__create_aux_variable_5_p_0(Var_57, (MR_Word) (MR_mkword(MR_mktag(1), &transform_hlds__stm_expand_scalar_common_5[20])), &NewStmDI_27, NewPredInfo0_26, &NewPredInfo1_28);
    Var_60 = parse_tree__builtin_lib_types__stm_state_type_0_f_0();
    transform_hlds__stm_expand__create_aux_variable_5_p_0(Var_60, (MR_Word) (MR_mkword(MR_mktag(1), &transform_hlds__stm_expand_scalar_common_5[21])), &NewStmUO_29, NewPredInfo1_28, &NewPredInfo2_30);
    {
      Var_66 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
...
{
  {
    ...
    transform_hlds__stm_expand__create_aux_variable_assignment_8_p_0(Context_9, Var_96, Var_97, (MR_Word) (MR_mkword(MR_mktag(1), &transform_hlds__stm_expand_scalar_common_5[18])), &AssignRetryCons_32, &RetryConsVar_33, STATE_VARIABLE_NewPredInfo_95_95, &STATE_VARIABLE_NewPredInfo_99_99);
    ...
    transform_hlds__stm_expand__create_aux_variable_assignment_8_p_0(Context_9, Var_121, Var_122, (MR_Word) (MR_mkword(MR_mktag(1), &transform_hlds__stm_expand_scalar_common_5[19])), &AssignRollbackCons_36, &RollbackConsVar_37, STATE_VARIABLE_NewPredInfo_110_110, &STATE_VARIABLE_NewPredInfo_124_124);
...
{
  {
    ...
    transform_hlds__stm_expand__create_aux_variable_assignment_8_p_0(Context_9, Var_37, Var_38, (MR_Word) (MR_mkword(MR_mktag(1), &transform_hlds__stm_expand_scalar_common_5[17])), &AssignValidConst_16, &IsValidConstVar_17, STATE_VARIABLE_NewPredInfo_0_35, &STATE_VARIABLE_NewPredInfo_40_40);
...
{
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        transform_hlds__stm_expand__create_aux_variable_5_p_0(Var_14, (MR_Word) (MR_mkword(MR_mktag(1), &transform_hlds__stm_expand_scalar_common_5[16])), &Var_8, STATE_VARIABLE_NewPredInfo_0_11, &STATE_VARIABLE_NewPredInfo_16_16);
...
{
  {
    ...
    transform_hlds__stm_expand__create_aux_variable_5_p_0(Var_53, (MR_Word) (MR_mkword(MR_mktag(1), &transform_hlds__stm_expand_scalar_common_5[14])), &InnerSTM0Var_34, STATE_VARIABLE_NewPredInfo_0_51, &STATE_VARIABLE_NewPredInfo_55_55);
    Var_57 = parse_tree__builtin_lib_types__exception_result_type_1_f_0(ReturnType_17);
    transform_hlds__stm_expand__create_aux_variable_5_p_0(Var_57, (MR_Word) (MR_mkword(MR_mktag(1), &transform_hlds__stm_expand_scalar_common_5[15])), &ReturnExceptVar_35, STATE_VARIABLE_NewPredInfo_55_55, &STATE_VARIABLE_NewPredInfo_59_59);
    Var_66 = parse_tree__builtin_lib_types__stm_state_type_0_f_0();
...
{
  {
    ...
    if (succeeded)
    {
      ...
      transform_hlds__stm_expand__create_aux_variable_5_p_0(Var_64, (MR_Word) (MR_mkword(MR_mktag(1), &transform_hlds__stm_expand_scalar_common_5[13])), &InnerUO_28, STATE_VARIABLE_NewPredInfo_62_62, &STATE_VARIABLE_NewPredInfo_66_66);
    }
    else
    {
...
{
  {
    ...
    hlds__hlds_pred__pred_info_create_17_p_0(ModuleName_40, NewPredName_44, PredOrFunc_42, PredContext_43, NewPredOrigin_46, (MR_Word) (((MR_Box) ((MR_Unsigned) 32U))), Markers_51, PredArgTypes_12, PredTypeVarSet_47, PredExistQVars_48, PredClassContext_49, PredAssertions_50, VarNameRemap_37, (MR_Word) (&transform_hlds__stm_expand_scalar_common_5[12]), NewProcInfo_39, &NewProcId_53, &NewPredInfo_54);
