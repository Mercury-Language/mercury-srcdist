...
parse_tree__write_error_spec__IntroducedFrom__func__find_matching_rp_and_maybe_join__2061__1_1_f_0(
...
static MR_bool MR_CALL 
parse_tree__write_error_spec__IntroducedFrom__pred__find_matching_rp_and_maybe_join__2039__1_2_p_0(
  MR_Word LPParen_16,
...
#undef MR_PROC_LABEL
  ...
  switch (WroteSomething_8) {
    ...
    case (MR_Integer) 0:
      ...
      break;
    case (MR_Integer) 1:
      parse_tree__write_error_spec__write_error_specs_5_p_0(ErrorStream_5, Globals_6, BadColorSchemeSpecs_9);
      break;
  }
  switch (Limited_10) {
    default: /*NOTREACHED*/ MR_assert(0);
  ...
  MR_Box wrapper_arg_1)
{
  ...
  conv0_LambdaHeadVar__2_61 = parse_tree__write_error_spec__IntroducedFrom__func__find_matching_rp_and_maybe_join__2061__1_1_f_0(((MR_Word) (wrapper_arg_1)));
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = parse_tree__write_error_spec__IntroducedFrom__pred__find_matching_rp_and_maybe_join__2039__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) ((MR_hl_field(0, closure, 4)))));
  return succeeded;
}
  ...
  MR_Word OoMSpecs_8)
{
  ...
  parse_tree__write_error_spec__write_error_specs_5_p_0(Stream_6, Globals_7, Var_12);
}
  ...
  MR_Word * STATE_VARIABLE_MaybeWrittenSpecs_15)
{
  ...
  parse_tree__write_error_spec__write_error_specs_5_p_0(Stream_7, Globals_8, ToBeWritten0_11);
    ...
    case (MR_Integer) 1:
      {
        ...
        parse_tree__write_error_spec__write_error_specs_5_p_0(Stream_8, Globals_9, ToBeWritten0_17);
