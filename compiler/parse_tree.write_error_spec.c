            ...
            case (MR_Integer) 2:
              {
                ...
                PlainWord_206 = parse_tree__write_error_spec__int_name_str_1_f_0(Int_131);
                {
            ...
            case (MR_Integer) 3:
              {
                ...
                PlainWord_217 = parse_tree__write_error_spec__nth_fixed_str_1_f_0(Int_132);
                {
