    ...
    case (MR_Integer) 1:
      {
        ...
        switch (MR_tag((MR_Word) Unification0_55)) {
          ...
          case (MR_Integer) 0:
            {
              MR_Word Var_78 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Unification0_55, (MR_Integer) 0))));
              MR_Word ConsId_79 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Unification0_55, (MR_Integer) 1))));
              MR_Word ArgVars_80 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Unification0_55, (MR_Integer) 2))));
              MR_Word ArgModes_81 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Unification0_55, (MR_Integer) 3))));
              MR_Word HowToConstruct0_82 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Unification0_55, (MR_Integer) 4))));
              MR_Word Unique_83 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Unification0_55, (MR_Integer) 5))) & (MR_Integer) 1);
              MR_Word SubInfo_84 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Unification0_55, (MR_Integer) 6))));
              MR_Word Var_88;

              {
                Var_88 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
                MR_hl_field(MR_mktag(0), Var_88, 0) = ((MR_Box) (&hlds__mark_static_terms_scalar_common_6[0]));
                MR_hl_field(MR_mktag(0), Var_88, 1) = ((MR_Box) (hlds__mark_static_terms__goal_mark_static_terms_4_p_0_2));
                MR_hl_field(MR_mktag(0), Var_88, 2) = ((MR_Box) ((MR_Integer) 1));
                MR_hl_field(MR_mktag(0), Var_88, 3) = ((MR_Box) (STATE_VARIABLE_SI_0_59));
              }
              succeeded = mercury__list__all_true_2_p_0((MR_Word) (&hlds__mark_static_terms_scalar_common_1[0]), Var_88, ArgVars_80);
              if (succeeded)
              {
                MR_Word HowToConstruct_85 = (MR_Word) (MR_mkword(MR_mktag(2), &hlds__mark_static_terms_scalar_common_2[0]));

                mercury__set_tree234__insert_3_p_0((MR_Word) (&hlds__mark_static_terms_scalar_common_1[0]), ((MR_Box) (Var_78)), STATE_VARIABLE_SI_0_59, STATE_VARIABLE_SI_60);
                succeeded = hlds__hlds_goal____Unify____how_to_construct_0_0(HowToConstruct_85, HowToConstruct0_82);
                if (succeeded)
                  Unification_57 = Unification0_55;
                else
                  {
                    Unification_57 = (MR_Word) MR_new_object(MR_Word, (7 * sizeof(MR_Word)), NULL, NULL);
                    MR_hl_field(MR_mktag(0), Unification_57, 0) = ((MR_Box) (Var_78));
                    MR_hl_field(MR_mktag(0), Unification_57, 1) = ((MR_Box) (ConsId_79));
                    MR_hl_field(MR_mktag(0), Unification_57, 2) = ((MR_Box) (ArgVars_80));
                    MR_hl_field(MR_mktag(0), Unification_57, 3) = ((MR_Box) (ArgModes_81));
                    MR_hl_field(MR_mktag(0), Unification_57, 4) = ((MR_Box) (HowToConstruct_85));
                    MR_hl_field(MR_mktag(0), Unification_57, 5) = (MR_Box) ((MR_Unsigned) (Unique_83));
                    MR_hl_field(MR_mktag(0), Unification_57, 6) = ((MR_Box) (SubInfo_84));
                  }
              }
              else
              {
          ...
          case (MR_Integer) 2:
            {
              MR_Word TargetVar_86 = ((MR_Word) ((MR_hl_field(MR_mktag(2), Unification0_55, (MR_Integer) 0))));
              MR_Word SourceVar_87 = ((MR_Word) ((MR_hl_field(MR_mktag(2), Unification0_55, (MR_Integer) 1))));

              Unification_57 = Unification0_55;
              succeeded = mercury__set_tree234__contains_2_p_0((MR_Word) (&hlds__mark_static_terms_scalar_common_1[0]), STATE_VARIABLE_SI_0_59, ((MR_Box) (SourceVar_87)));
              if (succeeded)
                mercury__set_tree234__insert_3_p_0((MR_Word) (&hlds__mark_static_terms_scalar_common_1[0]), ((MR_Box) (TargetVar_86)), STATE_VARIABLE_SI_0_59, STATE_VARIABLE_SI_60);
              else
                *STATE_VARIABLE_SI_60 = STATE_VARIABLE_SI_0_59;
            }
            break;
