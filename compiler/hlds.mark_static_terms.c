      ...
      case (MR_Integer) 0:
        {
...

          {
            ...
            MR_hl_field(MR_mktag(0), hlds__mark_static_terms__Var_32, 0) = ((MR_Box) (&hlds__mark_static_terms_scalar_common_4[0]));
