          ...
          case (MR_Integer) 5:
            {
              ...
              if (succeeded)
              {
                ...
                packed_word_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Reason_21, (MR_Integer) 2)));
      ...
      case (MR_Integer) 0:
        {
          ...
          MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Unification0_5, (MR_Integer) 5)));
          MR_Word Var_32;
          ...
          if (succeeded)
          {
            ...
            succeeded = hlds__hlds_goal____Unify____how_to_construct_0_0((MR_Word) ((MR_Unsigned) 0U), HowToConstruct0_12);
            if (succeeded)
