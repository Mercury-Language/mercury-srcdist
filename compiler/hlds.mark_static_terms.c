    ...
    switch (MR_tag((MR_Word) GoalExpr0_8)) {
      ...
      case (MR_Integer) 3:
        switch (((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), GoalExpr0_8, (MR_Integer) 0)))) {
          ...
          case (MR_Integer) 2:
            {
              MR_Word TypeCtorInfo_16_86 = (MR_Word) &hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_hlds_goal_0;
              ...
              mercury__list__map_foldl_5_p_0(TypeCtorInfo_16_86, TypeCtorInfo_16_86, (MR_Word) &hlds__mark_static_terms_scalar_common_1[1], (MR_Word) &hlds__mark_static_terms_scalar_common_4[0], Goals0_12, &Goals_13, ((MR_Box) (STATE_VARIABLE_SI_0_59)), &conv2_STATE_VARIABLE_SI_60);
          ...
          case (MR_Integer) 5:
            {
              ...
              if (succeeded)
              {
                ...
                Var_64 = ((MR_Word) (MR_hl_field(MR_mktag(3), Reason_21, (MR_Integer) 2)));
