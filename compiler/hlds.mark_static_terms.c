        ...
        case (MR_Integer) 5:
          {
            ...
            if (succeeded)
            {
              ...
              Var_62 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(3), Reason_21, (MR_Integer) 2))) & (MR_Integer) 3);
    ...
    case (MR_Integer) 0:
      {
...

        {
          ...
          MR_hl_field(MR_mktag(0), Var_31, 0) = ((MR_Box) (&hlds__mark_static_terms_scalar_common_5[0]));
          MR_hl_field(MR_mktag(0), Var_31, 1) = ((MR_Box) (hlds__mark_static_terms__unification_mark_static_terms_4_p_0_1));
          MR_hl_field(MR_mktag(0), Var_31, 2) = ((MR_Box) ((MR_Integer) 1));
          MR_hl_field(MR_mktag(0), Var_31, 3) = ((MR_Box) (STATE_VARIABLE_StaticVars_0_29));
        }
        succeeded = mercury__list__all_true_2_p_0((MR_Word) (&hlds__mark_static_terms_scalar_common_1[0]), Var_31, ArgVars_10);
        if (succeeded)
        {
