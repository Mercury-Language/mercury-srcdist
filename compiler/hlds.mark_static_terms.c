...
MR_decl_label9(hlds__mark_static_terms__goal_mark_static_terms_4_0, 25,28,24,33,32,37,36,85,84)
...
MR_BEGIN_MODULE(hlds__mark_static_terms_module2)
	...
	MR_init_label9(hlds__mark_static_terms__goal_mark_static_terms_4_0,25,28,24,33,32,37,36,85,84)
MR_BEGIN_CODE
...
MR_def_static(hlds__mark_static_terms__goal_mark_static_terms_4_0)
	...
	if (MR_RTAGS_TEST(MR_tempr1,3,0)) {
		MR_GOTO_LAB(hlds__mark_static_terms__goal_mark_static_terms_4_0_i85);
	}
...
MR_def_label(hlds__mark_static_terms__goal_mark_static_terms_4_0,19)
	...
	if (MR_INT_EQ(MR_tempr2,0)) {
		MR_GOTO_LAB(hlds__mark_static_terms__goal_mark_static_terms_4_0_i84);
	}
	}
...
MR_def_label(hlds__mark_static_terms__goal_mark_static_terms_4_0,85)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_proceed();
MR_def_label(hlds__mark_static_terms__goal_mark_static_terms_4_0,84)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(6);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
