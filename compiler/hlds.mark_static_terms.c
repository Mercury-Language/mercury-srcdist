              ...
              *STATE_VARIABLE_SI_60 = ((MR_Word) (conv2_STATE_VARIABLE_SI_60));
              {
                ...
                MR_hl_field(MR_mktag(3), GoalExpr_10, 1) = (MR_Box) (packed_args_0);
          ...
          case (MR_Integer) 5:
            {
              ...
              if (succeeded)
              {
                ...
                packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Reason_21, (MR_Integer) 2)));
      ...
      case (MR_Integer) 0:
        {
          ...
          MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Unification0_5, (MR_Integer) 5)));
          MR_Word Var_32;
