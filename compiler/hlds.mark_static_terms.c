    ...
    case (MR_Integer) 1:
      {
        ...
        switch (MR_tag((MR_Word) Unification0_55)) {
          ...
          case (MR_Integer) 0:
            {
              MR_Word Var_77 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Unification0_55, (MR_Integer) 0))));
              MR_Word ConsId_78 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Unification0_55, (MR_Integer) 1))));
              MR_Word ArgVars_79 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Unification0_55, (MR_Integer) 2))));
              MR_Word ArgModes_80 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Unification0_55, (MR_Integer) 3))));
              MR_Word HowToConstruct0_81 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Unification0_55, (MR_Integer) 4))));
              MR_Word Unique_82 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Unification0_55, (MR_Integer) 5))) & (MR_Integer) 1);
              MR_Word SubInfo_83 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Unification0_55, (MR_Integer) 6))));
              MR_Word Var_87;

              {
                Var_87 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
                MR_hl_field(MR_mktag(0), Var_87, 0) = ((MR_Box) (&hlds__mark_static_terms_scalar_common_6[0]));
                MR_hl_field(MR_mktag(0), Var_87, 1) = ((MR_Box) (hlds__mark_static_terms__goal_mark_static_terms_4_p_0_2));
                MR_hl_field(MR_mktag(0), Var_87, 2) = ((MR_Box) ((MR_Integer) 1));
                MR_hl_field(MR_mktag(0), Var_87, 3) = ((MR_Box) (STATE_VARIABLE_SI_0_59));
              }
              succeeded = mercury__list__all_true_2_p_0((MR_Word) (&hlds__mark_static_terms_scalar_common_1[0]), Var_87, ArgVars_79);
              if (succeeded)
              {
                MR_Word HowToConstruct_84 = (MR_Word) (MR_mkword(MR_mktag(2), &hlds__mark_static_terms_scalar_common_2[0]));
                ...
                if (succeeded)
                ...
                else
                  {
                    ...
                    MR_hl_field(MR_mktag(0), Unification_57, 0) = ((MR_Box) (Var_77));
                    MR_hl_field(MR_mktag(0), Unification_57, 1) = ((MR_Box) (ConsId_78));
                    MR_hl_field(MR_mktag(0), Unification_57, 2) = ((MR_Box) (ArgVars_79));
                    MR_hl_field(MR_mktag(0), Unification_57, 3) = ((MR_Box) (ArgModes_80));
                    MR_hl_field(MR_mktag(0), Unification_57, 4) = ((MR_Box) (HowToConstruct_84));
                    MR_hl_field(MR_mktag(0), Unification_57, 5) = (MR_Box) ((MR_Unsigned) (Unique_82));
                    MR_hl_field(MR_mktag(0), Unification_57, 6) = ((MR_Box) (SubInfo_83));
                  }
              }
              else
              {
          ...
          case (MR_Integer) 2:
            {
              MR_Word TargetVar_85 = ((MR_Word) ((MR_hl_field(MR_mktag(2), Unification0_55, (MR_Integer) 0))));
              MR_Word SourceVar_86 = ((MR_Word) ((MR_hl_field(MR_mktag(2), Unification0_55, (MR_Integer) 1))));
