      ...
      case (MR_Integer) 0:
        {
          ...
          if (succeeded)
          {
            MR_Word HowToConstruct_15 = (MR_Word) (MR_mkword(MR_mktag(2), &hlds__mark_static_terms_scalar_common_2[0]));
...
{
  {
    ...
    SGCells_13 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), OptTuple_12, (MR_Integer) 1))) >> 13)) & (MR_Integer) 1);
    switch (SGCells_13) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 1:
