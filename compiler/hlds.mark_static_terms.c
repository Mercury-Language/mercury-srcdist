...
MR_decl_label9(hlds__mark_static_terms__goal_mark_static_terms_4_0, 28,24,29,23,34,33,38,37,126)
...
MR_BEGIN_MODULE(hlds__mark_static_terms_module2)
	...
	MR_init_label9(hlds__mark_static_terms__goal_mark_static_terms_4_0,28,24,29,23,34,33,38,37,126)
MR_BEGIN_CODE
...
MR_def_static(hlds__mark_static_terms__goal_mark_static_terms_4_0)
	...
	if (MR_RTAGS_TEST(MR_tempr1,3,1)) {
		MR_GOTO_LAB(hlds__mark_static_terms__goal_mark_static_terms_4_0_i126);
	}
...
MR_def_label(hlds__mark_static_terms__goal_mark_static_terms_4_0,24)
	...
	MR_r1 = MR_r4;
	MR_np_localcall_lab(hlds__mark_static_terms__goal_mark_static_terms_4_0,
		hlds__mark_static_terms__goal_mark_static_terms_4_0_i29);
MR_def_label(hlds__mark_static_terms__goal_mark_static_terms_4_0,29)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 3, (MR_Integer) 3);
...
MR_def_label(hlds__mark_static_terms__goal_mark_static_terms_4_0,23)
	...
	if (MR_RTAGS_TESTR(MR_r3,3,4)) {
		MR_GOTO_LAB(hlds__mark_static_terms__goal_mark_static_terms_4_0_i33);
	}
	MR_incr_sp(6);
	MR_sv(6) = (MR_Word) MR_succip;
	MR_sv(1) = MR_tfield(0, MR_r1, 1);
	...
	MR_np_call_localret_ent(hlds__mark_static_terms__cases_mark_static_terms_3_0,
		hlds__mark_static_terms__goal_mark_static_terms_4_0_i34);
MR_def_label(hlds__mark_static_terms__goal_mark_static_terms_4_0,34)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
...
MR_def_label(hlds__mark_static_terms__goal_mark_static_terms_4_0,33)
	...
	if (MR_PTAG_TESTR(MR_r3,1)) {
		MR_GOTO_LAB(hlds__mark_static_terms__goal_mark_static_terms_4_0_i37);
	}
	MR_incr_sp(6);
	MR_sv(6) = (MR_Word) MR_succip;
	MR_sv(1) = MR_tfield(0, MR_r1, 1);
	...
	MR_np_call_localret_ent(hlds__mark_static_terms__unification_mark_static_terms_4_0,
		hlds__mark_static_terms__goal_mark_static_terms_4_0_i38);
MR_def_label(hlds__mark_static_terms__goal_mark_static_terms_4_0,38)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
...
MR_def_label(hlds__mark_static_terms__goal_mark_static_terms_4_0,126)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_proceed();
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
