...
hlds__mark_static_terms__IntroducedFrom__pred__unification_mark_static_terms__193__1_2_p_0(
  ...
  MR_Box wrapper_arg_1)
{
  ...
  succeeded = hlds__mark_static_terms__IntroducedFrom__pred__unification_mark_static_terms__193__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) (wrapper_arg_1)));
  return succeeded;
}
  ...
  MR_Word * STATE_VARIABLE_HLDS_17)
{
  ...
  SGCells_15 = ((((MR_Unsigned) ((MR_hl_field(0, OptTuple_14, (MR_Integer) 1))) >> 12)) & (MR_Integer) 1);
  switch (SGCells_15) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 1:
