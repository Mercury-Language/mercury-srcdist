...
MR_decl_label9(hlds__mark_static_terms__goal_mark_static_terms_4_0, 29,25,30,24,35,34,39,38,127)
...
MR_BEGIN_MODULE(hlds__mark_static_terms_module2)
	...
	MR_init_label9(hlds__mark_static_terms__goal_mark_static_terms_4_0,29,25,30,24,35,34,39,38,127)
MR_BEGIN_CODE
...
MR_def_static(hlds__mark_static_terms__goal_mark_static_terms_4_0)
	...
	if (MR_RTAGS_TEST(MR_tempr1,3,0)) {
		MR_GOTO_LAB(hlds__mark_static_terms__goal_mark_static_terms_4_0_i127);
	}
...
MR_def_label(hlds__mark_static_terms__goal_mark_static_terms_4_0,25)
	...
	MR_r1 = MR_r4;
	MR_np_localcall_lab(hlds__mark_static_terms__goal_mark_static_terms_4_0,
		hlds__mark_static_terms__goal_mark_static_terms_4_0_i30);
MR_def_label(hlds__mark_static_terms__goal_mark_static_terms_4_0,30)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 3, (MR_Integer) 3);
...
MR_def_label(hlds__mark_static_terms__goal_mark_static_terms_4_0,24)
	...
	if (MR_RTAGS_TESTR(MR_r3,3,3)) {
		MR_GOTO_LAB(hlds__mark_static_terms__goal_mark_static_terms_4_0_i34);
	}
	MR_incr_sp(6);
	MR_sv(6) = (MR_Word) MR_succip;
	MR_sv(1) = MR_tfield(0, MR_r1, 1);
...
MR_def_label(hlds__mark_static_terms__goal_mark_static_terms_4_0,34)
	...
	if (MR_PTAG_TESTR(MR_r3,0)) {
		MR_GOTO_LAB(hlds__mark_static_terms__goal_mark_static_terms_4_0_i38);
	}
	MR_incr_sp(6);
	MR_sv(6) = (MR_Word) MR_succip;
	MR_sv(1) = MR_tfield(0, MR_r1, 1);
...
MR_def_label(hlds__mark_static_terms__goal_mark_static_terms_4_0,127)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_proceed();
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
