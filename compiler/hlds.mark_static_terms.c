...
hlds__mark_static_terms__IntroducedFrom__pred__unification_mark_static_terms__164__1_2_p_0(
...
{
  {
    ...
    succeeded = hlds__mark_static_terms__IntroducedFrom__pred__unification_mark_static_terms__164__1_2_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) (wrapper_arg_1)));
    return succeeded;
  }
}
