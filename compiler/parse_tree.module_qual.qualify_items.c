  ...
  MR_Word * STATE_VARIABLE_Specs_19)
{
  ...
  MR_Word AncestorInt0s_11 = ((MR_Word) ((MR_hl_field(0, AugMakeIntUnit0_7, 1))));
  MR_Word DirectInt3Specs_12 = ((MR_Word) ((MR_hl_field(0, AugMakeIntUnit0_7, 2))));
  MR_Word IndirectInt3Specs_13 = ((MR_Word) ((MR_hl_field(0, AugMakeIntUnit0_7, 3))));
  MR_Word ModuleVersionNumbers_14 = ((MR_Word) ((MR_hl_field(0, AugMakeIntUnit0_7, 4))));
  MR_Word ModuleName_16 = ((MR_Word) ((MR_hl_field(0, ParseTreeModuleSrc0_10, 0))));
