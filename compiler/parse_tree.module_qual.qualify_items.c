      ...
      case (MR_Integer) 1:
        {
          ...
          parse_tree__module_qual__mq_info_get_types_2_p_0(STATE_VARIABLE_Info_0_35, &Types_22);
          ...
          switch (MR_tag((MR_Word) BuiltinType_25)) {
            ...
            case (MR_Integer) 0:
              switch (MR_unmkbody(BuiltinType_25)) {
                default: /*NOTREACHED*/ MR_assert(0);
                case (MR_Integer) 0:
                  parse_tree__module_qual__mq_info_set_module_used_4_p_0(InInt_9, (MR_Word) (&parse_tree__module_qual__qualify_items_scalar_common_2[0]), STATE_VARIABLE_Info_0_35, STATE_VARIABLE_Info_36);
                  break;
                case (MR_Integer) 1:
                  parse_tree__module_qual__mq_info_set_module_used_4_p_0(InInt_9, (MR_Word) (&parse_tree__module_qual__qualify_items_scalar_common_2[1]), STATE_VARIABLE_Info_0_35, STATE_VARIABLE_Info_36);
                  break;
                case (MR_Integer) 2:
                  *STATE_VARIABLE_Info_36 = STATE_VARIABLE_Info_0_35;
                  break;
            ...
            case (MR_Integer) 1:
              {
                ...
                parse_tree__module_qual__mq_info_set_module_used_4_p_0(InInt_9, Var_44, STATE_VARIABLE_Info_0_35, STATE_VARIABLE_Info_36);
              }
              break;
          }
          *AddrOfType_83 = Type0_11;
            ...
            case (MR_Integer) 3:
              {
                ...
                parse_tree__module_qual__update_recompilation_info_3_p_0(Var_38, STATE_VARIABLE_Info_0_5, &STATE_VARIABLE_Info_49_39);
              }
              break;
            case (MR_Integer) 4:
              STATE_VARIABLE_Info_49_39 = STATE_VARIABLE_Info_0_5;
