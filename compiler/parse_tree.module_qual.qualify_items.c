  ...
  MR_Word * STATE_VARIABLE_Specs_20)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_6, (MR_Integer) 206, &WarnInterfaceImports_82);
  ...
  MR_Word * STATE_VARIABLE_Specs_41)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_14, (MR_Integer) 206, &WarnInterfaceImports_107);
