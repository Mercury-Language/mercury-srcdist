...
{
  {
    ...
    switch (MR_tag((MR_Word) RepInfo0_17)) {
      ...
      case (MR_Integer) 2:
        ...
        break;
      case (MR_Integer) 3:
        switch (((MR_Integer) ((MR_hl_field(MR_mktag(3), RepInfo0_17, (MR_Integer) 0))))) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 0:
            {
              MR_Word EqvType0_30 = ((MR_Word) ((MR_hl_field(MR_mktag(3), RepInfo0_17, (MR_Integer) 1))));
              MR_Integer TypeCtorArity_31;
              MR_Word TypeCtor_32;
              MR_Word ErrorContext_33;
              MR_Word EqvType_34;

              mercury__list__length_2_p_0((MR_Word) (&parse_tree__module_qual__qualify_items_scalar_common_1[7]), ArgTVars_16, &TypeCtorArity_31);
              {
                TypeCtor_32 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
                MR_hl_field(MR_mktag(0), TypeCtor_32, 0) = ((MR_Box) (TypeCtorSymName_23));
                MR_hl_field(MR_mktag(0), TypeCtor_32, 1) = ((MR_Box) (TypeCtorArity_31));
              }
              {
                ErrorContext_33 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), ErrorContext_33, 0) = ((MR_Box) ((MR_Unsigned) 15U));
                MR_hl_field(MR_mktag(3), ErrorContext_33, 1) = ((MR_Box) (Context_19));
                MR_hl_field(MR_mktag(3), ErrorContext_33, 2) = ((MR_Box) (TypeCtor_32));
              }
              parse_tree__module_qual__qualify_items__qualify_type_8_p_0(InInt_10, ErrorContext_33, EqvType0_30, &EqvType_34, STATE_VARIABLE_Info_0_35, STATE_VARIABLE_Info_36, STATE_VARIABLE_Specs_0_37, STATE_VARIABLE_Specs_38);
              {
                RepInfo_29 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), RepInfo_29, 0) = ((MR_Box) ((MR_Unsigned) 0U));
                MR_hl_field(MR_mktag(3), RepInfo_29, 1) = ((MR_Box) (EqvType_34));
              }
            }
            break;
          case (MR_Integer) 1:
    ...
    }
    {
      ...
      *ItemTypeRepnInfo_12 = base;
      ...
      MR_hl_field(MR_mktag(0), base, 2) = ((MR_Box) (RepInfo_29));
      MR_hl_field(MR_mktag(0), base, 3) = ((MR_Box) (TVarSet_18));
      MR_hl_field(MR_mktag(0), base, 4) = ((MR_Box) (Context_19));
      MR_hl_field(MR_mktag(0), base, 5) = ((MR_Box) (SeqNum_20));
    }
...
{
  {
    ...
    MR_Word conv26_STATE_VARIABLE_Info_36;
    MR_Word conv25_STATE_VARIABLE_Specs_38;

    parse_tree__module_qual__qualify_items__module_qualify_item_type_repn_8_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))), ((MR_Word) (wrapper_arg_1)), &conv27_ItemTypeRepnInfo_12, ((MR_Word) (wrapper_arg_3)), &conv26_STATE_VARIABLE_Info_36, ((MR_Word) (wrapper_arg_5)), &conv25_STATE_VARIABLE_Specs_38);
    *wrapper_arg_2 = ((MR_Box) (conv27_ItemTypeRepnInfo_12));
    *wrapper_arg_4 = ((MR_Box) (conv26_STATE_VARIABLE_Info_36));
    *wrapper_arg_6 = ((MR_Box) (conv25_STATE_VARIABLE_Specs_38));
  }
}
