        ...
        case (MR_Integer) 4:
          {
            ...
            MR_Word Context_257 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ItemPragma0_123, (MR_Integer) 2))));
            MR_Integer SeqNum_258 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), ItemPragma0_123, (MR_Integer) 3))));
            MR_Word Origin_259 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ItemPragma0_123, (MR_Integer) 1))));
            ...
            {
              ItemPragma_126 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
              MR_hl_field(MR_mktag(0), ItemPragma_126, 0) = ((MR_Box) (Pragma_125));
              MR_hl_field(MR_mktag(0), ItemPragma_126, 1) = ((MR_Box) (Origin_259));
              MR_hl_field(MR_mktag(0), ItemPragma_126, 2) = ((MR_Box) (Context_257));
              MR_hl_field(MR_mktag(0), ItemPragma_126, 3) = ((MR_Box) (SeqNum_258));
            }
            {
              MR_Word base;
              base = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
