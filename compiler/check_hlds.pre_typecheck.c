  ...
  MR_Word ProcInfo_8)
{
  ...
  else
  {
    ...
    succeeded = check_hlds__mode_util__mode_is_free_of_uniqueness_2_p_0(ModuleInfo_5, InitArgMode_11);
    if (succeeded)
      succeeded = check_hlds__mode_util__mode_is_free_of_uniqueness_2_p_0(ModuleInfo_5, FinalArgMode_12);
  }
  return succeeded;
}
