  ...
  MR_Word * STATE_VARIABLE_BodyVars_9)
{
  ...
  hlds__goal_util__non_svar_copy_goal_vars_2_p_0(BodyGoal_6, &BodyGoalVars_7);
  ...
  MR_Word * STATE_VARIABLE_Specs_27)
{
  ...
  }
  {
    ...
    MR_hl_field(3, Spec_25, 1) = (MR_Box) (((((MR_Unsigned) ((MR_Integer) 18) << 1)) | (MR_Unsigned) ((MR_Integer) 1)));
  ...
  MR_Word * STATE_VARIABLE_Specs_24)
{
  ...
  }
  {
    ...
    MR_hl_field(3, Spec_22, 1) = (MR_Box) (((((MR_Unsigned) ((MR_Integer) 18) << 1)) | (MR_Unsigned) ((MR_Integer) 1)));
  ...
  MR_Word * STATE_VARIABLE_Specs_34)
{
  ...
  else
  {
    ...
    else
    {
      ...
      hlds__goal_util__non_svar_copy_goal_vars_2_p_0(BodyGoal_84, &BodyGoalVars_85);
