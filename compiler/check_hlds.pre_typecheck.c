  ...
  MR_Word * HeadVar__4_4)
{
  ...
  {
    MR_Word PredIdInfo0_9 = ((MR_Word) ((MR_hl_field(1, HeadVar__3_3, 0))));
    MR_Word PredIdsInfos0_10 = ((MR_Word) ((MR_hl_field(1, HeadVar__3_3, 1))));
    MR_Word PredIdInfo_11;
    MR_Word PredIdsInfos_12;
    MR_Word PredId_14 = ((MR_Word) ((MR_hl_field(0, PredIdInfo0_9, 0))));
    MR_Word STATE_VARIABLE_PredInfo_19_19 = ((MR_Word) ((MR_hl_field(0, PredIdInfo0_9, 1))));
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        Var_53 = hlds__hlds_clauses__clause_list_is_empty_1_f_0(ClausesRep0_26);
        succeeded = (Var_53 == (MR_Integer) 1);
        if (succeeded)
        {
          Var_54 = hlds__status__pred_status_defined_in_this_module_1_f_0(PredStatus_24);
      ...
      if (succeeded)
      {
        ...
        MR_Integer UserArityInt_36;
        MR_Word FuncSymName_37;
        MR_Word FuncDuCtor_38;
        MR_Word FuncConsId_39;
        MR_Word FuncRHS_40;
        MR_Word Goal0_41;
        MR_Word GoalExpr_42;
        ...
        MR_Word Var_60;
        MR_Word Var_64;
        MR_Word STATE_VARIABLE_PredInfo_51_67;
        MR_Word STATE_VARIABLE_PredInfo_52_68;
        ...
        hlds__hlds_pred__pred_info_get_orig_arity_2_p_0(STATE_VARIABLE_PredInfo_20_20, &PredFormArity_34);
        parse_tree__prog_util__user_arity_pred_form_arity_3_p_1((MR_Integer) 1, &UserArity_35, PredFormArity_34);
        UserArityInt_36 = (MR_Integer) (UserArity_35);
        {
          FuncSymName_37 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(1, FuncSymName_37, 0) = ((MR_Box) (FuncModule_32));
          MR_hl_field(1, FuncSymName_37, 1) = ((MR_Box) (FuncName_33));
        }
        Var_56 = parse_tree__prog_data__cons_id_dummy_type_ctor_0_f_0();
        {
          FuncDuCtor_38 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(0, FuncDuCtor_38, 0) = ((MR_Box) (FuncSymName_37));
          MR_hl_field(0, FuncDuCtor_38, 1) = ((MR_Box) (UserArityInt_36));
          MR_hl_field(0, FuncDuCtor_38, 2) = ((MR_Box) (Var_56));
        }
        FuncConsId_39 = (MR_Word) (MR_mkword(1, (MR_Word) (FuncDuCtor_38)));
        {
          FuncRHS_40 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(1, FuncRHS_40, 0) = ((MR_Box) (FuncConsId_39));
          MR_hl_field(1, FuncRHS_40, 1) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 0));
          MR_hl_field(1, FuncRHS_40, 2) = ((MR_Box) (FuncArgs_29));
        }
        hlds__make_goal__create_pure_atomic_complicated_unification_6_p_0(FuncRetVal_30, FuncRHS_40, Context_31, (MR_Word) ((MR_Unsigned) 0U), (MR_Word) ((MR_Unsigned) 0U), &Goal0_41);
        GoalExpr_42 = ((MR_Word) ((MR_hl_field(0, Goal0_41, 0))));
        GoalInfo0_43 = ((MR_Word) ((MR_hl_field(0, Goal0_41, 1))));
        Var_60 = hlds__hlds_args__proc_arg_vector_to_list_1_f_0((MR_Word) (&check_hlds__pre_typecheck_scalar_common_1[0]), HeadVars_28);
        NonLocals_44 = parse_tree__set_of_var__list_to_set_1_f_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), Var_60);
        hlds__hlds_goal__goal_info_set_nonlocals_3_p_0(NonLocals_44, GoalInfo0_43, &GoalInfo_45);
        {
          Goal_46 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(0, Goal_46, 0) = ((MR_Box) (GoalExpr_42));
          MR_hl_field(0, Goal_46, 1) = ((MR_Box) (GoalInfo_45));
        }
        {
          Clause_47 = (MR_Word) MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(0, Clause_47, 0) = ((MR_Box) ((MR_Unsigned) 0U));
          MR_hl_field(0, Clause_47, 1) = ((MR_Box) (Goal_46));
          MR_hl_field(0, Clause_47, 2) = ((MR_Box) ((MR_Unsigned) 0U));
          MR_hl_field(0, Clause_47, 3) = ((MR_Box) (Context_31));
          MR_hl_field(0, Clause_47, 4) = ((MR_Box) ((MR_Unsigned) 0U));
        }
        {
          Var_64 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(1, Var_64, 0) = ((MR_Box) (Clause_47));
          MR_hl_field(1, Var_64, 1) = ((MR_Box) ((MR_Unsigned) 0U));
        }
        hlds__hlds_clauses__set_clause_list_2_p_0(Var_64, &ClausesRep_48);
        ItemNumbers_49 = hlds__hlds_clauses__init_clause_item_numbers_comp_gen_0_f_0();
        hlds__hlds_clauses__clauses_info_set_clauses_rep_4_p_0(ClausesRep_48, ItemNumbers_49, ClausesInfo0_25, &ClausesInfo_50);
        hlds__hlds_pred__pred_info_update_goal_type_3_p_0((MR_Integer) 1, STATE_VARIABLE_PredInfo_20_20, &STATE_VARIABLE_PredInfo_51_67);
        hlds__hlds_pred__pred_info_set_clauses_info_3_p_0(ClausesInfo_50, STATE_VARIABLE_PredInfo_51_67, &STATE_VARIABLE_PredInfo_52_68);
        hlds__hlds_pred__pred_info_get_markers_2_p_0(STATE_VARIABLE_PredInfo_52_68, &Markers0_51);
        hlds__hlds_markers__add_marker_3_p_0((MR_Integer) 22, Markers0_51, &Markers_52);
        hlds__hlds_pred__pred_info_set_markers_3_p_0(Markers_52, STATE_VARIABLE_PredInfo_52_68, &STATE_VARIABLE_PredInfo_21_21);
      }
      else
