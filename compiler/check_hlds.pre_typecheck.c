  ...
  MR_Word * HeadVar__4_4)
{
  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        Var_52 = hlds__hlds_clauses__clause_list_is_empty_1_f_0(ClausesRep0_26);
        succeeded = (Var_52 == (MR_Integer) 1);
        if (succeeded)
        {
          Var_53 = hlds__status__pred_status_defined_in_this_module_1_f_0(PredStatus_24);
      ...
      if (succeeded)
      {
        ...
        {
          FuncConsId_38 = (MR_Word) MR_mkword(3, MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(3, FuncConsId_38, 0) = ((MR_Box) ((MR_Unsigned) 2U));
          MR_hl_field(3, FuncConsId_38, 1) = ((MR_Box) (FuncSymName_37));
          MR_hl_field(3, FuncConsId_38, 2) = ((MR_Box) (UserArityInt_36));
          MR_hl_field(3, FuncConsId_38, 3) = ((MR_Box) (Var_55));
        }
        {
          FuncRHS_39 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(1, FuncRHS_39, 0) = ((MR_Box) (FuncConsId_38));
          MR_hl_field(1, FuncRHS_39, 1) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 0));
          MR_hl_field(1, FuncRHS_39, 2) = ((MR_Box) (FuncArgs_29));
        }
        hlds__make_goal__create_pure_atomic_complicated_unification_6_p_0(FuncRetVal_30, FuncRHS_39, Context_31, (MR_Word) ((MR_Unsigned) 0U), (MR_Word) ((MR_Unsigned) 0U), &Goal0_40);
        GoalExpr_41 = ((MR_Word) ((MR_hl_field(0, Goal0_40, (MR_Integer) 0))));
        GoalInfo0_42 = ((MR_Word) ((MR_hl_field(0, Goal0_40, (MR_Integer) 1))));
        Var_59 = hlds__hlds_args__proc_arg_vector_to_list_1_f_0((MR_Word) (&check_hlds__pre_typecheck_scalar_common_1[0]), HeadVars_28);
        NonLocals_43 = parse_tree__set_of_var__list_to_set_1_f_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), Var_59);
        hlds__hlds_goal__goal_info_set_nonlocals_3_p_0(NonLocals_43, GoalInfo0_42, &GoalInfo_44);
        {
        ...
        {
          Clause_46 = (MR_Word) MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(0, Clause_46, 0) = ((MR_Box) ((MR_Unsigned) 0U));
          MR_hl_field(0, Clause_46, 1) = ((MR_Box) (Goal_45));
          MR_hl_field(0, Clause_46, 2) = ((MR_Box) ((MR_Unsigned) 0U));
          MR_hl_field(0, Clause_46, 3) = ((MR_Box) (Context_31));
          MR_hl_field(0, Clause_46, 4) = ((MR_Box) ((MR_Unsigned) 0U));
        }
        {
          Var_63 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(1, Var_63, 0) = ((MR_Box) (Clause_46));
          MR_hl_field(1, Var_63, 1) = ((MR_Box) ((MR_Unsigned) 0U));
        }
        hlds__hlds_clauses__set_clause_list_2_p_0(Var_63, &ClausesRep_47);
        ItemNumbers_48 = hlds__hlds_clauses__init_clause_item_numbers_comp_gen_0_f_0();
        hlds__hlds_clauses__clauses_info_set_clauses_rep_4_p_0(ClausesRep_47, ItemNumbers_48, ClausesInfo0_25, &ClausesInfo_49);
        hlds__hlds_pred__pred_info_update_goal_type_3_p_0((MR_Integer) 1, STATE_VARIABLE_PredInfo_20_20, &STATE_VARIABLE_PredInfo_50_66);
        hlds__hlds_pred__pred_info_set_clauses_info_3_p_0(ClausesInfo_49, STATE_VARIABLE_PredInfo_50_66, &STATE_VARIABLE_PredInfo_51_67);
        hlds__hlds_pred__pred_info_get_markers_2_p_0(STATE_VARIABLE_PredInfo_51_67, &Markers0_50);
        hlds__hlds_pred__add_marker_3_p_0((MR_Integer) 22, Markers0_50, &Markers_51);
        hlds__hlds_pred__pred_info_set_markers_3_p_0(Markers_51, STATE_VARIABLE_PredInfo_51_67, &STATE_VARIABLE_PredInfo_21_21);
      }
      else
