  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        {
          FuncSymName_36 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), FuncSymName_36, 0) = ((MR_Box) (FuncModule_32));
          MR_hl_field(MR_mktag(1), FuncSymName_36, 1) = ((MR_Box) (FuncName_33));
        }
        Var_54 = parse_tree__prog_data__cons_id_dummy_type_ctor_0_f_0();
        {
          FuncConsId_37 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(3), FuncConsId_37, 0) = ((MR_Box) ((MR_Unsigned) 2U));
          MR_hl_field(MR_mktag(3), FuncConsId_37, 1) = ((MR_Box) (FuncSymName_36));
          MR_hl_field(MR_mktag(3), FuncConsId_37, 2) = ((MR_Box) (FuncArity_35));
          MR_hl_field(MR_mktag(3), FuncConsId_37, 3) = ((MR_Box) (Var_54));
        }
        {
          FuncRHS_38 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), FuncRHS_38, 0) = ((MR_Box) (FuncConsId_37));
          MR_hl_field(MR_mktag(1), FuncRHS_38, 1) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 0));
          MR_hl_field(MR_mktag(1), FuncRHS_38, 2) = ((MR_Box) (FuncArgs_29));
        }
        ...
        GoalExpr_40 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Goal0_39, (MR_Integer) 0))));
        GoalInfo0_41 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Goal0_39, (MR_Integer) 1))));
        ...
        hlds__hlds_goal__goal_info_set_nonlocals_3_p_0(NonLocals_42, GoalInfo0_41, &GoalInfo_43);
        {
          ...
          MR_hl_field(MR_mktag(0), Goal_44, 0) = ((MR_Box) (GoalExpr_40));
          MR_hl_field(MR_mktag(0), Goal_44, 1) = ((MR_Box) (GoalInfo_43));
        }
        {
          Clause_45 = (MR_Word) MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), Clause_45, 0) = ((MR_Box) ((MR_Unsigned) 0U));
          MR_hl_field(MR_mktag(0), Clause_45, 1) = ((MR_Box) (Goal_44));
          MR_hl_field(MR_mktag(0), Clause_45, 2) = ((MR_Box) ((MR_Unsigned) 0U));
          MR_hl_field(MR_mktag(0), Clause_45, 3) = ((MR_Box) (Context_31));
          MR_hl_field(MR_mktag(0), Clause_45, 4) = ((MR_Box) ((MR_Unsigned) 0U));
        }
        {
          Var_62 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), Var_62, 0) = ((MR_Box) (Clause_45));
        ...
        hlds__hlds_pred__add_marker_3_p_0((MR_Integer) 21, Markers0_49, &Markers_50);
