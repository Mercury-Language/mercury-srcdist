...
check_hlds__pre_typecheck__IntroducedFrom__pred__arg_num_pieces__654__1_2_p_0(
  MR_Word HeadVar__1_21,
  MR_Word HeadVar__2_22);

static MR_bool MR_CALL 
check_hlds__pre_typecheck__IntroducedFrom__pred__arg_num_pieces__652__1_2_p_0(
  MR_Integer NumUserArgs_10,
  MR_Integer HeadVar__2_15);

static MR_String MR_CALL 
check_hlds__pre_typecheck__IntroducedFrom__func__warn_about_unneeded_initial_final_statevar__587__1_1_f_0(
  MR_String LambdaHeadVar__1_35);

static MR_String MR_CALL 
check_hlds__pre_typecheck__IntroducedFrom__func__warn_about_unneeded_final_statevar__561__1_1_f_0(
...
static MR_Box MR_CALL 
check_hlds__pre_typecheck__warn_about_unneeded_final_statevar_7_p_0_1(
  MR_Box closure_arg,
  MR_Box wrapper_arg_1);

static void MR_CALL 
check_hlds__pre_typecheck__warn_about_unneeded_final_statevar_7_p_0(
  MR_Word PredInfo_8,
  MR_Word HeadClauseContext_9,
  MR_Word TailClauses_10,
  MR_Unsigned FinalArgNum_11,
  MR_Word SVarNameSet_12,
...
static /* final */ const MR_Box check_hlds__pre_typecheck_scalar_common_3[2][10];

static /* final */ const MR_Box check_hlds__pre_typecheck_scalar_common_4[1][4];

static /* final */ const MR_Box check_hlds__pre_typecheck_scalar_common_5[2][6];

static /* final */ const MR_Box check_hlds__pre_typecheck_scalar_common_6[1][12];

static /* final */ const MR_Box check_hlds__pre_typecheck_scalar_common_7[3][5];

static /* final */ const MR_Box check_hlds__pre_typecheck_scalar_common_8[1][7];
...
static /* final */ const MR_Box check_hlds__pre_typecheck_scalar_common_2[4][3] = {
  ...
  /* row   1 */
  {
    ((MR_Box) (&check_hlds__pre_typecheck_scalar_common_5[0])),
    ((MR_Box) (check_hlds__pre_typecheck__warn_about_any_unneeded_statevars_5_p_0_3)),
    ((MR_Box) ((MR_Integer) 0))
  },
  /* row   2 */
  {
    ((MR_Box) (&check_hlds__pre_typecheck_scalar_common_7[2])),
    ((MR_Box) (check_hlds__pre_typecheck__warn_about_unneeded_final_statevar_7_p_0_1)),
    ((MR_Box) ((MR_Integer) 0))
  },
  /* row   3 */
  {
...
check_hlds__pre_typecheck__IntroducedFrom__pred__arg_num_pieces__652__1_2_p_0(
  ...
  MR_Integer HeadVar__2_15)
{
  MR_bool succeeded = (HeadVar__2_15 == NumUserArgs_10);
  ...
  MR_Word ProcInfo_8)
{
  ...
  else
  {
    ...
    check_hlds__mode_util__mode_get_insts_4_p_0(ModuleInfo_5, InitArgMode_11, &InitInst_16, &FinalInst_17);
    succeeded = check_hlds__inst_test__inst_is_not_partly_unique_2_p_0(ModuleInfo_5, InitInst_16);
    if (succeeded)
    {
      succeeded = check_hlds__inst_test__inst_is_not_partly_unique_2_p_0(ModuleInfo_5, FinalInst_17);
      if (succeeded)
      {
        check_hlds__mode_util__mode_get_insts_4_p_0(ModuleInfo_5, FinalArgMode_12, &InitInst_18, &FinalInst_19);
        succeeded = check_hlds__inst_test__inst_is_not_partly_unique_2_p_0(ModuleInfo_5, InitInst_18);
        if (succeeded)
          succeeded = check_hlds__inst_test__inst_is_not_partly_unique_2_p_0(ModuleInfo_5, FinalInst_19);
      }
    }
  }
  return succeeded;
  ...
  MR_Word * STATE_VARIABLE_Specs_22)
{
  ...
  if (succeeded)
  {
    ...
    mercury__map__values_2_p_0((MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_proc_id_0), (MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_proc_info_0), ProcTable_24, &ProcInfos_25);
    {
      ...
      MR_hl_field(0, Var_26, 0) = ((MR_Box) (&check_hlds__pre_typecheck_scalar_common_8[0]));
    ...
    if (succeeded)
      check_hlds__pre_typecheck__warn_about_unneeded_final_statevar_7_p_0(PredInfo_11, HeadClauseContext_13, TailClauses_14, FinalArgNum_18, SVarNameSet_19, STATE_VARIABLE_Specs_0_21, STATE_VARIABLE_Specs_22);
    else
  ...
  MR_Box wrapper_arg_1)
{
  ...
  conv0_LambdaHeadVar__2_36 = check_hlds__pre_typecheck__IntroducedFrom__func__warn_about_unneeded_initial_final_statevar__587__1_1_f_0(((MR_String) (wrapper_arg_1)));
  ...
  MR_Word * STATE_VARIABLE_Specs_27)
{
  ...
  BangSVarNames_18 = mercury__list__map_2_f_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&check_hlds__pre_typecheck_scalar_common_2[3]), SVarNames_17);
  ...
  {
    MR_Word Var_133 = ((MR_Word) ((MR_hl_field(1, BangSVarNames_18, 1))));
    MR_String Var_134 = ((MR_String) ((MR_hl_field(1, BangSVarNames_18, 0))));
    ...
    if ((Var_133 == (MR_Word) ((MR_Unsigned) 0U)))
    {
...

      {
        ...
        MR_hl_field(3, Var_112, 1) = ((MR_Box) (Var_134));
      }
      {
        Var_111 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(1, Var_111, 0) = ((MR_Box) (Var_112));
        MR_hl_field(1, Var_111, 1) = ((MR_Box) (MR_mkword(1, &check_hlds__pre_typecheck_scalar_common_1[25])));
      }
      Var_110 = parse_tree__error_spec__color_as_subject_1_f_0(Var_111);
      RepresentedByCommaPieces_20 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), (MR_Word) (MR_mkword(1, &check_hlds__pre_typecheck_scalar_common_1[42])), Var_110);
    }
    else
    {
      MR_Word Var_122;
      ...
      Var_123 = parse_tree__error_spec__quote_list_to_color_pieces_4_f_0((MR_Integer) 0, (MR_String) "and", (MR_Word) ((MR_Unsigned) 0U), BangSVarNames_18);
      Var_122 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), Var_123, (MR_Word) (MR_mkword(1, &check_hlds__pre_typecheck_scalar_common_1[46])));
      RepresentedByCommaPieces_20 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), (MR_Word) (MR_mkword(1, &check_hlds__pre_typecheck_scalar_common_1[44])), Var_122);
    }
  }
  ...
  Pieces_24 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), (MR_Word) (MR_mkword(1, &check_hlds__pre_typecheck_scalar_common_1[8])), Var_42);
  {
    ...
    MR_hl_field(0, Var_93, 0) = ((MR_Box) (HeadClauseContext_10));
    MR_hl_field(0, Var_93, 1) = ((MR_Box) (Pieces_24));
  }
  {
  ...
  {
    Spec_25 = (MR_Word) MR_mkword(3, MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(3, Spec_25, 0) = ((MR_Box) ((MR_String) "predicate \140check_hlds.pre_typecheck.warn_about_unneeded_initial_final_statevar\'/8"));
    MR_hl_field(3, Spec_25, 1) = (MR_Box) (((((MR_Unsigned) ((MR_Integer) 235) << 1)) | (MR_Unsigned) ((MR_Integer) 1)));
    MR_hl_field(3, Spec_25, 2) = ((MR_Box) ((MR_Unsigned) 4U));
    MR_hl_field(3, Spec_25, 3) = ((MR_Box) ((MR_Unsigned) 44U));
    MR_hl_field(3, Spec_25, 4) = ((MR_Box) (Var_92));
  }
  {
    MR_Word base;
  ...
  MR_Box wrapper_arg_1)
{
  ...
  conv0_LambdaHeadVar__2_33 = check_hlds__pre_typecheck__IntroducedFrom__func__warn_about_unneeded_final_statevar__561__1_1_f_0(((MR_String) (wrapper_arg_1)));
  ...
  MR_Word * STATE_VARIABLE_Specs_24)
{
  ...
  MR_Word SVarNames_15;
  MR_Word BangColonSVarNames_16;
  MR_Word RepresentedByCommaPieces_18;
  MR_Word InEachClausePieces_19;
  MR_Word FinalArgPieces_20;
  MR_Word Pieces_21;
  MR_Word Spec_22;
  MR_Word Var_39;
  MR_Word Var_40;
  ...
  PredNameColonPieces_14 = hlds__hlds_error_util__describe_one_pred_info_name_4_f_0((MR_Word) ((MR_Unsigned) 0U), (MR_Integer) 1, (MR_Word) (MR_mkword(1, &check_hlds__pre_typecheck_scalar_common_1[6])), PredInfo_8);
  mercury__set__to_sorted_list_2_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), SVarNameSet_12, &SVarNames_15);
  BangColonSVarNames_16 = mercury__list__map_2_f_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&check_hlds__pre_typecheck_scalar_common_2[2]), SVarNames_15);
  if ((BangColonSVarNames_16 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      mercury__require__unexpected_2_p_0((MR_String) "function \140check_hlds.pre_typecheck.represented_by_svar_names_pieces\'/1", (MR_String) "BangSVarNames = []");
      return;
    }
  ...
  {
    MR_Word Var_118 = ((MR_Word) ((MR_hl_field(1, BangColonSVarNames_16, 1))));
    MR_String Var_119 = ((MR_String) ((MR_hl_field(1, BangColonSVarNames_16, 0))));
    ...
    if ((Var_118 == (MR_Word) ((MR_Unsigned) 0U)))
    {
...

      {
        ...
        MR_hl_field(3, Var_97, 1) = ((MR_Box) (Var_119));
      }
      {
        Var_96 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(1, Var_96, 0) = ((MR_Box) (Var_97));
        MR_hl_field(1, Var_96, 1) = ((MR_Box) (MR_mkword(1, &check_hlds__pre_typecheck_scalar_common_1[25])));
      }
      Var_95 = parse_tree__error_spec__color_as_subject_1_f_0(Var_96);
      RepresentedByCommaPieces_18 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), (MR_Word) (MR_mkword(1, &check_hlds__pre_typecheck_scalar_common_1[42])), Var_95);
    }
    else
    {
      MR_Word Var_107;
      ...
      Var_108 = parse_tree__error_spec__quote_list_to_color_pieces_4_f_0((MR_Integer) 0, (MR_String) "and", (MR_Word) ((MR_Unsigned) 0U), BangColonSVarNames_16);
      Var_107 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), Var_108, (MR_Word) (MR_mkword(1, &check_hlds__pre_typecheck_scalar_common_1[46])));
      RepresentedByCommaPieces_18 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), (MR_Word) (MR_mkword(1, &check_hlds__pre_typecheck_scalar_common_1[44])), Var_107);
    }
  }
  if ((TailClauses_10 == (MR_Word) ((MR_Unsigned) 0U)))
    InEachClausePieces_19 = (MR_Word) ((MR_Unsigned) 0U);
  else
    InEachClausePieces_19 = (MR_Word) (MR_mkword(1, &check_hlds__pre_typecheck_scalar_common_1[48]));
  FinalArgPieces_20 = check_hlds__pre_typecheck__arg_num_pieces_2_f_0(PredInfo_8, FinalArgNum_11);
  Var_55 = parse_tree__error_spec__color_as_incorrect_1_f_0((MR_Word) (MR_mkword(1, &check_hlds__pre_typecheck_scalar_common_1[27])));
  Var_65 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), InEachClausePieces_19, (MR_Word) (MR_mkword(1, &check_hlds__pre_typecheck_scalar_common_1[31])));
  Var_60 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), (MR_Word) (MR_mkword(1, &check_hlds__pre_typecheck_scalar_common_1[29])), Var_65);
  ...
  Var_53 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), RepresentedByCommaPieces_18, Var_54);
  Var_48 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), (MR_Word) (MR_mkword(1, &check_hlds__pre_typecheck_scalar_common_1[25])), Var_53);
  Var_47 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), FinalArgPieces_20, Var_48);
  Var_40 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), (MR_Word) (MR_mkword(1, &check_hlds__pre_typecheck_scalar_common_1[23])), Var_47);
  Var_39 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), PredNameColonPieces_14, Var_40);
  Pieces_21 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), (MR_Word) (MR_mkword(1, &check_hlds__pre_typecheck_scalar_common_1[8])), Var_39);
  {
    Var_78 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(0, Var_78, 0) = ((MR_Box) (HeadClauseContext_9));
    MR_hl_field(0, Var_78, 1) = ((MR_Box) (Pieces_21));
  }
  {
  ...
  {
    Spec_22 = (MR_Word) MR_mkword(3, MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(3, Spec_22, 0) = ((MR_Box) ((MR_String) "predicate \140check_hlds.pre_typecheck.warn_about_unneeded_final_statevar\'/7"));
    MR_hl_field(3, Spec_22, 1) = (MR_Box) (((((MR_Unsigned) ((MR_Integer) 235) << 1)) | (MR_Unsigned) ((MR_Integer) 1)));
    MR_hl_field(3, Spec_22, 2) = ((MR_Box) ((MR_Unsigned) 4U));
    MR_hl_field(3, Spec_22, 3) = ((MR_Box) ((MR_Unsigned) 44U));
    MR_hl_field(3, Spec_22, 4) = ((MR_Box) (Var_77));
  }
  {
    MR_Word base;
    base = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = check_hlds__pre_typecheck__IntroducedFrom__pred__arg_num_pieces__654__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) ((MR_hl_field(0, closure, 4)))));
  return succeeded;
}
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = check_hlds__pre_typecheck__IntroducedFrom__pred__arg_num_pieces__652__1_2_p_0(((MR_Integer) ((MR_hl_field(0, closure, 3)))), ((MR_Integer) ((MR_hl_field(0, closure, 4)))));
  return succeeded;
}
  ...
  MR_Unsigned ArgNum_5)
{
  ...
  if (succeeded)
  {
    MR_Word Var_12;
    MR_Integer Var_15;
    MR_Unsigned Var_16 = (ArgNum_5 + (MR_Unsigned) 1U);
    MR_Word Var_18;
    MR_Word Var_21;

    Var_15 = mercury__uint__cast_to_int_1_f_0(Var_16);
    {
      Var_12 = (MR_Word) MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(0, Var_12, 0) = ((MR_Box) (&check_hlds__pre_typecheck_scalar_common_7[0]));
      ...
      MR_hl_field(0, Var_12, 3) = ((MR_Box) (NumUserArgs_10));
      MR_hl_field(0, Var_12, 4) = ((MR_Box) (Var_15));
    }
    ...
    Var_21 = hlds__hlds_pred__pred_info_is_pred_or_func_1_f_0(PredInfo_4);
    {
      ...
      MR_hl_field(0, Var_18, 0) = ((MR_Box) (&check_hlds__pre_typecheck_scalar_common_7[1]));
            ...
            case (MR_Integer) 0:
              {
                ...
                if (succeeded)
                {
                  ...
                  PredNameColonPieces_95 = hlds__hlds_error_util__describe_one_pred_info_name_4_f_0((MR_Word) ((MR_Unsigned) 0U), (MR_Integer) 1, (MR_Word) (MR_mkword(1, &check_hlds__pre_typecheck_scalar_common_1[6])), PredInfo_1);
                  ...
                  Var_123 = parse_tree__error_spec__color_as_incorrect_1_f_0((MR_Word) (MR_mkword(1, &check_hlds__pre_typecheck_scalar_common_1[15])));
                  Var_122 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), Var_123, (MR_Word) (MR_mkword(1, &check_hlds__pre_typecheck_scalar_common_1[20])));
                  Var_117 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), (MR_Word) (MR_mkword(1, &check_hlds__pre_typecheck_scalar_common_1[13])), Var_122);
                  ...
                  Var_109 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), (MR_Word) (MR_mkword(1, &check_hlds__pre_typecheck_scalar_common_1[11])), Var_111);
                  ...
                  Pieces_96 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), (MR_Word) (MR_mkword(1, &check_hlds__pre_typecheck_scalar_common_1[8])), Var_108);
                  {
                  ...
                  }
                  {
                    ...
                    MR_hl_field(3, Spec_97, 0) = ((MR_Box) ((MR_String) "predicate \140check_hlds.pre_typecheck.warn_about_any_unneeded_initial_statevars\'/8"));
                    MR_hl_field(3, Spec_97, 1) = (MR_Box) (((((MR_Unsigned) ((MR_Integer) 250) << 1)) | (MR_Unsigned) ((MR_Integer) 1)));
            ...
            case (MR_Integer) 1:
              {
                ...
                Var_69 = parse_tree__error_spec__color_as_incorrect_1_f_0((MR_Word) (MR_mkword(1, &check_hlds__pre_typecheck_scalar_common_1[15])));
                Var_68 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), Var_69, (MR_Word) (MR_mkword(1, &check_hlds__pre_typecheck_scalar_common_1[20])));
                Var_63 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), (MR_Word) (MR_mkword(1, &check_hlds__pre_typecheck_scalar_common_1[13])), Var_68);
                ...
                Var_50 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), (MR_Word) (MR_mkword(1, &check_hlds__pre_typecheck_scalar_common_1[11])), Var_57);
                ...
                Pieces_32 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), (MR_Word) (MR_mkword(1, &check_hlds__pre_typecheck_scalar_common_1[8])), Var_49);
                {
                ...
                }
                {
                  ...
                  MR_hl_field(3, Spec_33, 0) = ((MR_Box) ((MR_String) "predicate \140check_hlds.pre_typecheck.warn_about_any_unneeded_initial_statevars\'/8"));
                  MR_hl_field(3, Spec_33, 1) = (MR_Box) (((((MR_Unsigned) ((MR_Integer) 250) << 1)) | (MR_Unsigned) ((MR_Integer) 1)));
  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        MR_Word Var_75;
        MR_Word Var_77;
        MR_Word STATE_VARIABLE_PredInfo_1_80;
        MR_Word STATE_VARIABLE_PredInfo_2_81;
        ...
        {
          Clause_58 = (MR_Word) MR_new_object(MR_Word, (7 * sizeof(MR_Word)), NULL, NULL);
          ...
          MR_hl_field(0, Clause_58, 6) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 0));
        }
        {
          Var_77 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(1, Var_77, 0) = ((MR_Box) (Clause_58));
          MR_hl_field(1, Var_77, 1) = ((MR_Box) ((MR_Unsigned) 0U));
        }
        hlds__hlds_clauses__set_clause_list_2_p_0(Var_77, &ClausesRep_59);
        ...
        hlds__hlds_pred__pred_info_update_goal_type_3_p_0((MR_Integer) 1, STATE_VARIABLE_PredInfo_2_30, &STATE_VARIABLE_PredInfo_1_80);
        hlds__hlds_pred__pred_info_set_clauses_info_3_p_0(ClausesInfo_61, STATE_VARIABLE_PredInfo_1_80, &STATE_VARIABLE_PredInfo_2_81);
        hlds__hlds_pred__pred_info_get_markers_2_p_0(STATE_VARIABLE_PredInfo_2_81, &Markers0_62);
        hlds__hlds_markers__add_marker_3_p_0((MR_Integer) 23, Markers0_62, &Markers_63);
        hlds__hlds_pred__pred_info_set_markers_3_p_0(Markers_63, STATE_VARIABLE_PredInfo_2_81, &STATE_VARIABLE_PredInfo_3_31);
      }
      else
  ...
  MR_Word * STATE_VARIABLE_Specs_34)
{
  ...
  else
  {
    ...
    HeadClauseContext_25 = ((MR_Word) ((MR_hl_field(0, HeadClause_14, 3))));
    {
      ...
      MR_hl_field(0, Var_39, 0) = ((MR_Box) (&check_hlds__pre_typecheck_scalar_common_3[1]));
    ...
    else
    {
      ...
      parse_tree__set_of_var__to_sorted_list_2_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), BodyVarsSet_29, &BodyVars_30);
      {
        ...
        MR_hl_field(0, Var_42, 0) = ((MR_Box) (&check_hlds__pre_typecheck_scalar_common_5[1]));
      ...
      mercury__set__list_to_set_2_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), BodyVarSVarNames_31, &BodyVarSVarNameSet_32);
      {
        ...
        MR_hl_field(0, Var_43, 0) = ((MR_Box) (&check_hlds__pre_typecheck_scalar_common_6[0]));
