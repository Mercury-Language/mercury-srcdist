  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        hlds__hlds_pred__pred_info_update_goal_type_3_p_0((MR_Integer) 1, STATE_VARIABLE_PredInfo_20_20, &STATE_VARIABLE_PredInfo_49_69);
        ...
        hlds__hlds_pred__add_marker_3_p_0((MR_Integer) 22, Markers0_53, &Markers_54);
