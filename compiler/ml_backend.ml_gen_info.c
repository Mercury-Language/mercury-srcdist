...
{
  {
    ...
    mercury__set__init_1_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_goal_warning_0), &DisabledWarnings_37);
    {
      ...
      MR_hl_field(MR_mktag(0), RareInfo_38, 4) = (MR_Box) (((((MR_Unsigned) (((MR_Box) (HighLevelData_27))) << (MR_Integer) 9)) | (((((MR_Unsigned) (((MR_Box) (Target_10))) << (MR_Integer) 7)) | (((((MR_Unsigned) (((MR_Box) (GC_28))) << (MR_Integer) 4)) | (((((MR_Unsigned) (((MR_Box) (DetCopyOut_29))) << (MR_Integer) 3)) | (((((MR_Unsigned) (((MR_Box) (NondetCopyOut_30))) << (MR_Integer) 2)) | (((((MR_Unsigned) (((MR_Box) (UseAtomicCells_31))) << (MR_Integer) 1)) | (MR_Unsigned) (((MR_Box) (ProfileMemory_32)))))))))))))));
...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(0), TailRecInfo_22, 1) = (MR_Box) (((((MR_Unsigned) (((MR_Box) (LoopKind_19))) << (MR_Integer) 1)) | (MR_Unsigned) (((MR_Box) (TsccKind_7)))));
    }
    {
      MR_Word base;
      base = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 7 * sizeof(MR_Word)), NULL, NULL);
