...
{
  {
    ...
    {
      TailRecInfo_19 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), TailRecInfo_19, 0) = ((MR_Box) (InSccMap_6));
      MR_hl_field(MR_mktag(0), TailRecInfo_19, 1) = ((MR_Box) ((LoopKind_18 | ((TsccKind_7 << (MR_Integer) 1)))));
    }
    {
      MR_Word base;
      base = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 6 * sizeof(MR_Word)), NULL, NULL);
      *TsccInfo_8 = base;
      ...
      MR_hl_field(MR_mktag(0), base, 4) = ((MR_Box) (ConvVarCounter_13));
      MR_hl_field(MR_mktag(0), base, 5) = ((MR_Box) (TailRecInfo_19));
    }
  }
}
