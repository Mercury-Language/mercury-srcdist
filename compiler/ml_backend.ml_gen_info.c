  ...
  MR_Word TsccInfo_15)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_26, (MR_Integer) 311, &DetCopyOut_28);
  libs__globals__lookup_bool_option_3_p_0(Globals_26, (MR_Integer) 312, &NondetCopyOut_29);
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_26, (MR_Integer) 244, &ProfileMemory_32);
  libs__globals__lookup_int_option_3_p_0(Globals_26, (MR_Integer) 285, &NumPtagBitsInt_33);
    ...
    case (MR_Integer) 1:
      {
        ...
        switch (TsccKind_7) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 1:
            PreferBreakContinueOption_20 = (MR_Integer) 367;
            break;
          case (MR_Integer) 0:
            PreferBreakContinueOption_20 = (MR_Integer) 366;
            break;
        }
  ...
  MR_Word * PutCommitInNestedFunc_4)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 313, PutCommitInNestedFunc_4);
}
