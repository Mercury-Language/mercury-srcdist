...
MR_decl_label9(__Unify___ml_backend__ml_gen_info__ml_gen_info_0_0, 4,6,8,10,12,14,16,20,1)
...
MR_BEGIN_MODULE(ml_backend__ml_gen_info_module52)
	...
	MR_init_label9(__Unify___ml_backend__ml_gen_info__ml_gen_info_0_0,4,6,8,10,12,14,16,20,1)
MR_BEGIN_CODE
...
MR_define_entry(mercury____Unify___ml_backend__ml_gen_info__ml_gen_info_0_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if ((MR_r1 == MR_r2)) {
		MR_GOTO_LAB(__Unify___ml_backend__ml_gen_info__ml_gen_info_0_0_i20);
	}
	MR_incr_sp(15);
...
MR_def_label(__Unify___ml_backend__ml_gen_info__ml_gen_info_0_0,20)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_TRUE;
	MR_proceed();
