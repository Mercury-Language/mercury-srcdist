...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_26, (MR_Integer) 288, &HighLevelData_27);
    libs__globals__get_gc_method_2_p_0(Globals_26, &GC_28);
    libs__globals__lookup_bool_option_3_p_0(Globals_26, (MR_Integer) 289, &DetCopyOut_29);
    libs__globals__lookup_bool_option_3_p_0(Globals_26, (MR_Integer) 290, &NondetCopyOut_30);
    libs__globals__lookup_bool_option_3_p_0(Globals_26, (MR_Integer) 484, &UseAtomicCells_31);
    libs__globals__lookup_bool_option_3_p_0(Globals_26, (MR_Integer) 221, &ProfileMemory_32);
    libs__globals__lookup_int_option_3_p_0(Globals_26, (MR_Integer) 264, &NumPtagBitsInt_33);
      ...
      case (MR_Integer) 1:
        {
          ...
          switch (TsccKind_7) {
            default: /*NOTREACHED*/ MR_assert(0);
            case (MR_Integer) 1:
              PreferBreakContinueOption_20 = (MR_Integer) 349;
              break;
            case (MR_Integer) 0:
              PreferBreakContinueOption_20 = (MR_Integer) 348;
              break;
          }
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 291, PutCommitInNestedFunc_4);
  }
}
