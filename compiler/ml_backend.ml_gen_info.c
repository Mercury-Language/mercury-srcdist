...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_27, (MR_Integer) 297, &DetCopyOut_29);
    libs__globals__lookup_bool_option_3_p_0(Globals_27, (MR_Integer) 298, &NondetCopyOut_30);
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_27, (MR_Integer) 230, &ProfileMemory_33);
    libs__globals__lookup_int_option_3_p_0(Globals_27, (MR_Integer) 272, &NumPtagBitsInt_34);
      ...
      case (MR_Integer) 1:
        {
          ...
          switch (TsccKind_7) {
            default: /*NOTREACHED*/ MR_assert(0);
            case (MR_Integer) 1:
              PreferBreakContinueOption_20 = (MR_Integer) 355;
              break;
            case (MR_Integer) 0:
              PreferBreakContinueOption_20 = (MR_Integer) 354;
              break;
          }
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 299, PutCommitInNestedFunc_4);
  }
}
