...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_17, (MR_Integer) 266, &HighLevelData_18);
    libs__globals__get_gc_method_2_p_0(Globals_17, &GC_19);
    libs__globals__lookup_bool_option_3_p_0(Globals_17, (MR_Integer) 267, &DetCopyOut_20);
    libs__globals__lookup_bool_option_3_p_0(Globals_17, (MR_Integer) 268, &NondetCopyOut_21);
