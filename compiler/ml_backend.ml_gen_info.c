...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_26, (MR_Integer) 277, &HighLevelData_27);
    libs__globals__get_gc_method_2_p_0(Globals_26, &GC_28);
    libs__globals__lookup_bool_option_3_p_0(Globals_26, (MR_Integer) 278, &DetCopyOut_29);
    libs__globals__lookup_bool_option_3_p_0(Globals_26, (MR_Integer) 279, &NondetCopyOut_30);
    libs__globals__lookup_bool_option_3_p_0(Globals_26, (MR_Integer) 472, &UseAtomicCells_31);
    libs__globals__lookup_bool_option_3_p_0(Globals_26, (MR_Integer) 212, &ProfileMemory_32);
    libs__globals__lookup_int_option_3_p_0(Globals_26, (MR_Integer) 255, &NumPtagBitsInt_33);
      ...
      case (MR_Integer) 1:
        {
          ...
          switch (TsccKind_7) {
            default: /*NOTREACHED*/ MR_assert(0);
            case (MR_Integer) 1:
              PreferBreakContinueOption_20 = (MR_Integer) 338;
              break;
            case (MR_Integer) 0:
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 280, PutCommitInNestedFunc_4);
  }
}
