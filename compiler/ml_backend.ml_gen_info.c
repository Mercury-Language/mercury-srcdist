  ...
  MR_Word TsccInfo_15)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_26, (MR_Integer) 339, &DetCopyOut_28);
  libs__globals__lookup_bool_option_3_p_0(Globals_26, (MR_Integer) 340, &NondetCopyOut_29);
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_26, (MR_Integer) 272, &ProfileMemory_32);
  libs__globals__lookup_int_option_3_p_0(Globals_26, (MR_Integer) 313, &NumPtagBitsInt_33);
    ...
    case (MR_Integer) 1:
      {
        ...
        switch (TsccKind_7) {
          ...
          case (MR_Integer) 1:
            ...
            break;
          case (MR_Integer) 0:
            PreferBreakContinueOption_20 = (MR_Integer) 393;
            break;
        }
  ...
  MR_Word * PutCommitInNestedFunc_4)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 341, PutCommitInNestedFunc_4);
}
