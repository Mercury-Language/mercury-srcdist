...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_26, (MR_Integer) 272, &HighLevelData_27);
    libs__globals__get_gc_method_2_p_0(Globals_26, &GC_28);
    libs__globals__lookup_bool_option_3_p_0(Globals_26, (MR_Integer) 273, &DetCopyOut_29);
    libs__globals__lookup_bool_option_3_p_0(Globals_26, (MR_Integer) 274, &NondetCopyOut_30);
    libs__globals__lookup_bool_option_3_p_0(Globals_26, (MR_Integer) 467, &UseAtomicCells_31);
    libs__globals__lookup_bool_option_3_p_0(Globals_26, (MR_Integer) 211, &ProfileMemory_32);
    libs__globals__lookup_int_option_3_p_0(Globals_26, (MR_Integer) 254, &NumPtagBits_33);
      ...
      case (MR_Integer) 1:
        {
          ...
          switch (TsccKind_7) {
            default: /*NOTREACHED*/ MR_assert(0);
            case (MR_Integer) 1:
              PreferBreakContinueOption_20 = (MR_Integer) 333;
              break;
            case (MR_Integer) 0:
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 275, PutCommitInNestedFunc_4);
  }
}
