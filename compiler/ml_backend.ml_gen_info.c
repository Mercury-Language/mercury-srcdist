...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_27, (MR_Integer) 292, &DetCopyOut_29);
    libs__globals__lookup_bool_option_3_p_0(Globals_27, (MR_Integer) 293, &NondetCopyOut_30);
    libs__globals__get_opt_tuple_2_p_0(Globals_27, &OptTuple_31);
    UseAtomicCells_32 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), OptTuple_31, (MR_Integer) 1))) >> 10)) & (MR_Integer) 1);
    libs__globals__lookup_bool_option_3_p_0(Globals_27, (MR_Integer) 225, &ProfileMemory_33);
    libs__globals__lookup_int_option_3_p_0(Globals_27, (MR_Integer) 267, &NumPtagBitsInt_34);
      ...
      case (MR_Integer) 1:
        {
          ...
          switch (TsccKind_7) {
            default: /*NOTREACHED*/ MR_assert(0);
            case (MR_Integer) 1:
              PreferBreakContinueOption_20 = (MR_Integer) 351;
              break;
            case (MR_Integer) 0:
              PreferBreakContinueOption_20 = (MR_Integer) 350;
              break;
          }
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 294, PutCommitInNestedFunc_4);
  }
}
