...
{
  {
    ...
    TypeInfo_52_52 = (MR_Word) &ml_backend__ml_gen_info_scalar_common_1[0];
    mercury__map__init_1_p_0(TypeInfo_52_52, (MR_Word) &ml_backend__ml_gen_info__ml_backend__ml_gen_info__type_ctor_info_ml_ground_term_0, &ConstVarMap_39);
    ...
    mercury__map__init_1_p_0(TypeInfo_52_52, (MR_Word) &ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_lval_0, &VarLvals_41);
