...
{
  {
    ...
    {
      libs__globals__lookup_bool_option_3_p_0(ml_backend__ml_gen_info__Globals_5, (MR_Integer) 265, ml_backend__ml_gen_info__PutCommitInNestedFunc_4);
    }
  }
}
...
{
  {
    ...
    {
      libs__globals__lookup_bool_option_3_p_0(ml_backend__ml_gen_info__Globals_5, (MR_Integer) 262, ml_backend__ml_gen_info__UseNestedFuncs_4);
    }
  }
}
...
{
  {
    ...
    {
      libs__globals__lookup_bool_option_3_p_0(ml_backend__ml_gen_info__Globals_15, (MR_Integer) 261, &ml_backend__ml_gen_info__HighLevelData_16);
    }
    {
