...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_27, (MR_Integer) 288, &DetCopyOut_29);
    libs__globals__lookup_bool_option_3_p_0(Globals_27, (MR_Integer) 289, &NondetCopyOut_30);
    libs__globals__lookup_bool_option_3_p_0(Globals_27, (MR_Integer) 483, &UseAtomicCells_31);
    libs__globals__lookup_bool_option_3_p_0(Globals_27, (MR_Integer) 221, &ProfileMemory_32);
    libs__globals__lookup_int_option_3_p_0(Globals_27, (MR_Integer) 263, &NumPtagBitsInt_33);
    ...
    mercury__set__init_1_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_goal_warning_0), &DisabledWarnings_37);
    {
      ...
      MR_hl_field(MR_mktag(0), RareInfo_38, 4) = (MR_Box) (((((MR_Unsigned) (HighLevelData_26) << 9)) | (((((MR_Unsigned) (Target_10) << 7)) | (((((MR_Unsigned) (GC_28) << 4)) | (((((MR_Unsigned) (DetCopyOut_29) << 3)) | (((((MR_Unsigned) (NondetCopyOut_30) << 2)) | (((((MR_Unsigned) (UseAtomicCells_31) << 1)) | (MR_Unsigned) (ProfileMemory_32)))))))))))));
