...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_17, (MR_Integer) 270, &HighLevelData_18);
    libs__globals__get_gc_method_2_p_0(Globals_17, &GC_19);
    libs__globals__lookup_bool_option_3_p_0(Globals_17, (MR_Integer) 271, &DetCopyOut_20);
    libs__globals__lookup_bool_option_3_p_0(Globals_17, (MR_Integer) 272, &NondetCopyOut_21);
      ...
      case (MR_Integer) 1:
        {
          ...
          switch (TsccKind_7) {
            ...
            case (MR_Integer) 1:
              ...
              break;
            case (MR_Integer) 0:
              PreferBreakContinueOption_19 = (MR_Integer) 330;
              break;
          }
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 273, PutCommitInNestedFunc_4);
  }
}
