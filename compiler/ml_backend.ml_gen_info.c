  ...
  MR_Word TsccInfo_15)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_26, (MR_Integer) 309, &DetCopyOut_28);
  libs__globals__lookup_bool_option_3_p_0(Globals_26, (MR_Integer) 310, &NondetCopyOut_29);
  ...
  MR_Word * PutCommitInNestedFunc_4)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 311, PutCommitInNestedFunc_4);
}
