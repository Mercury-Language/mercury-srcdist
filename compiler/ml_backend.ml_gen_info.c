  ...
  MR_Word TsccInfo_15)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_26, (MR_Integer) 725, &DetCopyOut_28);
  libs__globals__lookup_bool_option_3_p_0(Globals_26, (MR_Integer) 726, &NondetCopyOut_29);
    ...
    case (MR_Integer) 1:
      {
        ...
        switch (TsccKind_7) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 1:
            PreferBreakContinueOption_20 = (MR_Integer) 644;
            break;
          case (MR_Integer) 0:
            PreferBreakContinueOption_20 = (MR_Integer) 643;
            break;
        }
  ...
  MR_Word * PutCommitInNestedFunc_4)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 727, PutCommitInNestedFunc_4);
}
