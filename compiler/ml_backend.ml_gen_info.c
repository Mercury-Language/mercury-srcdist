...
static const MR_FA_TypeInfo_Struct2 ml_backend__ml_gen_info__tree234__ti_tree234_2term__ti_var_1parse_tree__prog_data__type_ctor_info_prog_var_type_0hlds__var_table__type_ctor_info_var_table_entry_0;
...
static const MR_PseudoTypeInfo ml_backend__ml_gen_info__ml_backend__ml_gen_info__field_types_ml_gen_rare_info_0_0[16] = {
  ...
  (MR_PseudoTypeInfo) (&ml_backend__ml_gen_info__tree234__ti_tree234_2term__ti_var_1parse_tree__prog_data__type_ctor_info_prog_var_type_0hlds__var_table__type_ctor_info_var_table_entry_0),
  (MR_PseudoTypeInfo) (&mercury__bool__bool__type_ctor_info_bool_0),
  ...
  MR_Word HeadVar__2_2)
{
  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        TypeCtorInfo_39_39 = (MR_Word) (&hlds__var_table__hlds__var_table__type_ctor_info_var_table_0);
  ...
  else
  {
    ...
    else
    {
      ...
      else
      {
        ...
        mercury__builtin__compare_3_p_0((MR_Word) (&hlds__var_table__hlds__var_table__type_ctor_info_var_table_0), &SubResult3_12, ((MR_Box) (ArgX3_10)), ((MR_Box) (ArgY3_11)));
        succeeded = (SubResult3_12 != (MR_Integer) 0);
        if (succeeded)
          *HeadVar__1_1 = SubResult3_12;
        else
              ...
              if (succeeded)
              {
                ...
                else
                {
                  ...
                  if (succeeded)
                  {
                    ...
                    if (succeeded)
                    {
                      TypeCtorInfo_39_62 = (MR_Word) (&hlds__var_table__hlds__var_table__type_ctor_info_var_table_0);
                      succeeded = mercury__builtin__unify_2_p_0(TypeCtorInfo_39_62, ((MR_Box) (ArgX3_30)), ((MR_Box) (ArgY3_31)));
                      if (succeeded)
                      {
  ...
  MR_Word TsccInfo_15)
{
  ...
  MR_Word ProfileMemory_34;
  MR_Integer NumPtagBitsInt_35;
  uint8_t NumPtagBits_36;
  MR_Word VarLvals_37;
  MR_Word EnvVarNames_38;
  MR_Word DisabledWarnings_39;
  MR_Word RareInfo_40;
  MR_Word ByRefOutputVars_41;
  MR_Word PackedWordMap_42;
  MR_Word SuccContStack_43;
  MR_Word SubInfo_45;
  MR_Word ConstVarMap_46;
  ...
  hlds__var_table__make_var_table_4_p_0(ModuleInfo_9, VarSet_24, VarTypes_25, &VarTable_26);
  HighLevelData_27 = ml_backend__ml_util__mlds_target_high_level_data_1_f_0(Target_10);
  hlds__hlds_module__module_info_get_globals_2_p_0(ModuleInfo_9, &Globals_28);
  libs__globals__get_gc_method_2_p_0(Globals_28, &GC_29);
  libs__globals__lookup_bool_option_3_p_0(Globals_28, (MR_Integer) 302, &DetCopyOut_30);
  libs__globals__lookup_bool_option_3_p_0(Globals_28, (MR_Integer) 303, &NondetCopyOut_31);
  libs__globals__get_opt_tuple_2_p_0(Globals_28, &OptTuple_32);
  UseAtomicCells_33 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), OptTuple_32, (MR_Integer) 1))) >> 9)) & (MR_Integer) 1);
  libs__globals__lookup_bool_option_3_p_0(Globals_28, (MR_Integer) 236, &ProfileMemory_34);
  libs__globals__lookup_int_option_3_p_0(Globals_28, (MR_Integer) 277, &NumPtagBitsInt_35);
  NumPtagBits_36 = mercury__uint8__det_from_int_1_f_0(NumPtagBitsInt_35);
  ...
  mercury__set__init_1_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), &EnvVarNames_38);
  mercury__set__init_1_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_goal_warning_0), &DisabledWarnings_39);
  {
    RareInfo_40 = (MR_Word) MR_new_object(MR_Word, (10 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(MR_mktag(0), RareInfo_40, 0) = ((MR_Box) (ModuleInfo_9));
    MR_hl_field(MR_mktag(0), RareInfo_40, 1) = ((MR_Box) (PredProcId_12));
    MR_hl_field(MR_mktag(0), RareInfo_40, 2) = ((MR_Box) (VarTable_26));
    MR_hl_field(MR_mktag(0), RareInfo_40, 3) = (MR_Box) (((((MR_Unsigned) (HighLevelData_27) << 9)) | (((((MR_Unsigned) (Target_10) << 7)) | (((((MR_Unsigned) (GC_29) << 4)) | (((((MR_Unsigned) (DetCopyOut_30) << 3)) | (((((MR_Unsigned) (NondetCopyOut_31) << 2)) | (((((MR_Unsigned) (UseAtomicCells_33) << 1)) | (MR_Unsigned) (ProfileMemory_34)))))))))))));
    MR_hl_field(MR_mktag(0), RareInfo_40, 4) = ((MR_Box) (MR_Word) (NumPtagBits_36));
    MR_hl_field(MR_mktag(0), RareInfo_40, 5) = ((MR_Box) (ConstStructMap_11));
    MR_hl_field(MR_mktag(0), RareInfo_40, 6) = ((MR_Box) (VarLvals_37));
    MR_hl_field(MR_mktag(0), RareInfo_40, 7) = ((MR_Box) (EnvVarNames_38));
    MR_hl_field(MR_mktag(0), RareInfo_40, 8) = ((MR_Box) (DisabledWarnings_39));
    MR_hl_field(MR_mktag(0), RareInfo_40, 9) = ((MR_Box) (TailRecInfo_23));
  }
  parse_tree__set_of_var__init_1_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), &ByRefOutputVars_41);
  mercury__map__init_1_p_0((MR_Word) (&ml_backend__ml_gen_info_scalar_common_1[1]), (MR_Word) (&ml_backend__ml_gen_info_scalar_common_1[2]), &PackedWordMap_42);
  mercury__stack__init_1_p_0((MR_Word) (&ml_backend__ml_gen_info__ml_backend__ml_gen_info__type_ctor_info_success_cont_0), &SuccContStack_43);
  {
    SubInfo_45 = (MR_Word) MR_new_object(MR_Word, (8 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(MR_mktag(0), SubInfo_45, 0) = ((MR_Box) (ByRefOutputVars_41));
    MR_hl_field(MR_mktag(0), SubInfo_45, 1) = ((MR_Box) (LabelCounter_18));
    MR_hl_field(MR_mktag(0), SubInfo_45, 2) = ((MR_Box) (AuxVarCounter_19));
    MR_hl_field(MR_mktag(0), SubInfo_45, 3) = ((MR_Box) (CondVarCounter_20));
    MR_hl_field(MR_mktag(0), SubInfo_45, 4) = ((MR_Box) (PackedWordCounter_21));
    MR_hl_field(MR_mktag(0), SubInfo_45, 5) = ((MR_Box) (PackedWordMap_42));
    MR_hl_field(MR_mktag(0), SubInfo_45, 6) = ((MR_Box) (SuccContStack_43));
    MR_hl_field(MR_mktag(0), SubInfo_45, 7) = ((MR_Box) ((MR_Integer) 0));
  }
  mercury__map__init_1_p_0((MR_Word) (&ml_backend__ml_gen_info_scalar_common_1[0]), (MR_Word) (&ml_backend__ml_gen_info__ml_backend__ml_gen_info__type_ctor_info_ml_ground_term_0), &ConstVarMap_46);
  {
    Info_16 = (MR_Word) MR_new_object(MR_Word, (8 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(MR_mktag(0), Info_16, 0) = ((MR_Box) (ConstVarMap_46));
    ...
    MR_hl_field(MR_mktag(0), Info_16, 6) = ((MR_Box) (RareInfo_40));
    MR_hl_field(MR_mktag(0), Info_16, 7) = ((MR_Box) (SubInfo_45));
  }
  return Info_16;
}
    ...
    case (MR_Integer) 1:
      {
        ...
        switch (TsccKind_7) {
          ...
          case (MR_Integer) 1:
            ...
            break;
          case (MR_Integer) 0:
            PreferBreakContinueOption_20 = (MR_Integer) 358;
            break;
        }
  ...
  MR_Word * PutCommitInNestedFunc_4)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 304, PutCommitInNestedFunc_4);
}
