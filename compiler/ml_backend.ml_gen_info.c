      ...
      else
      {
        ...
        else
        {
          ...
          else
          {
            ...
            mercury__builtin__compare_3_p_0((MR_Word) &hlds__vartypes__hlds__vartypes__type_ctor_info_vartypes_0, &Var_31, ((MR_Box) (ArgX4_10)), ((MR_Box) (ArgY4_11)));
                    ...
                    else
                    {
                      ...
                      else
                      {
                        ...
                        else
                        {
                          ...
                          mercury__builtin__compare_3_p_0((MR_Word) &hlds__vartypes__hlds__vartypes__type_ctor_info_vartypes_0, &Var_66, ((MR_Box) (ArgX4_45)), ((MR_Box) (ArgY4_46)));
                  ...
                  else
                  {
                    ...
                    if (succeeded)
                    {
                      ...
                      if (succeeded)
                      {
                        ...
                        if (succeeded)
                        {
                          TypeCtorInfo_32_55 = (MR_Word) &hlds__vartypes__hlds__vartypes__type_ctor_info_vartypes_0;
                          succeeded = mercury__builtin__unify_2_p_0(TypeCtorInfo_32_55, ((MR_Box) (ArgX4_32)), ((MR_Box) (ArgY4_33)));
                          if (succeeded)
                          {
