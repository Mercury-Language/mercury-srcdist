...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_26, (MR_Integer) 287, &HighLevelData_27);
    libs__globals__get_gc_method_2_p_0(Globals_26, &GC_28);
    libs__globals__lookup_bool_option_3_p_0(Globals_26, (MR_Integer) 288, &DetCopyOut_29);
    libs__globals__lookup_bool_option_3_p_0(Globals_26, (MR_Integer) 289, &NondetCopyOut_30);
    libs__globals__lookup_bool_option_3_p_0(Globals_26, (MR_Integer) 483, &UseAtomicCells_31);
    libs__globals__lookup_bool_option_3_p_0(Globals_26, (MR_Integer) 220, &ProfileMemory_32);
    libs__globals__lookup_int_option_3_p_0(Globals_26, (MR_Integer) 263, &NumPtagBitsInt_33);
      ...
      case (MR_Integer) 1:
        {
          ...
          switch (TsccKind_7) {
            ...
            case (MR_Integer) 1:
              ...
              break;
            case (MR_Integer) 0:
              PreferBreakContinueOption_20 = (MR_Integer) 347;
              break;
          }
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 290, PutCommitInNestedFunc_4);
  }
}
