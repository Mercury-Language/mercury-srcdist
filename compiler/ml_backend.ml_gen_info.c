...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_17, (MR_Integer) 267, &HighLevelData_18);
    libs__globals__get_gc_method_2_p_0(Globals_17, &GC_19);
    libs__globals__lookup_bool_option_3_p_0(Globals_17, (MR_Integer) 268, &DetCopyOut_20);
    libs__globals__lookup_bool_option_3_p_0(Globals_17, (MR_Integer) 269, &NondetCopyOut_21);
    libs__globals__lookup_bool_option_3_p_0(Globals_17, (MR_Integer) 462, &UseAtomicCells_22);
    libs__globals__lookup_bool_option_3_p_0(Globals_17, (MR_Integer) 209, &ProfileMemory_23);
    libs__globals__lookup_int_option_3_p_0(Globals_17, (MR_Integer) 252, &NumPtagBits_24);
    ...
    mercury__map__init_1_p_0(TypeInfo_51_51, (MR_Word) &ml_backend__ml_gen_info__ml_backend__ml_gen_info__type_ctor_info_ml_ground_term_0, &ConstVarMap_34);
    ...
    mercury__map__init_1_p_0(TypeInfo_51_51, (MR_Word) &ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_lval_0, &VarLvals_37);
      ...
      case (MR_Integer) 1:
        {
          ...
          switch (TsccKind_7) {
            default: /*NOTREACHED*/ MR_assert(0);
            case (MR_Integer) 1:
              PreferBreakContinueOption_19 = (MR_Integer) 328;
              break;
            case (MR_Integer) 0:
              PreferBreakContinueOption_19 = (MR_Integer) 327;
              break;
          }
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 270, PutCommitInNestedFunc_4);
  }
}
