  ...
  MR_Word TsccInfo_15)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_26, (MR_Integer) 333, &DetCopyOut_28);
  libs__globals__lookup_bool_option_3_p_0(Globals_26, (MR_Integer) 334, &NondetCopyOut_29);
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_26, (MR_Integer) 266, &ProfileMemory_32);
  libs__globals__lookup_int_option_3_p_0(Globals_26, (MR_Integer) 307, &NumPtagBitsInt_33);
  ...
  MR_Word * PutCommitInNestedFunc_4)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_5, (MR_Integer) 335, PutCommitInNestedFunc_4);
}
