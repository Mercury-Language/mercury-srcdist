  ...
  MR_Word * ArgInst_8)
{
  while (MR_TRUE)
  {
    ...
    switch (MR_tag((MR_Word) Inst_6)) {
      ...
      case (MR_Integer) 2:
        {
          MR_Word List_15 = ((MR_Word) ((MR_hl_field(2, Inst_6, (MR_Integer) 2))));
          MR_Word ArgInst0_16;
      ...
      case (MR_Integer) 3:
        switch (((MR_Integer) ((MR_hl_field(3, Inst_6, (MR_Integer) 0))))) {
          ...
          case (MR_Integer) 2:
            {
              MR_Word Uniq_30 = ((MR_Unsigned) ((MR_hl_field(3, Inst_6, (MR_Integer) 1))) & (MR_Integer) 7);

              {
                ...
                *ArgInst_8 = base;
                ...
                MR_hl_field(3, base, 1) = (MR_Box) ((MR_Unsigned) (Uniq_30));
