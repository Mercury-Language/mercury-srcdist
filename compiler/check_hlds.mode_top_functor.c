  ...
  MR_Word * HeadVar__4_4)
{
  ...
  else
  {
    ...
    {
      MR_Word Type_21 = ((MR_Word) ((MR_hl_field(1, HeadVar__3_3, (MR_Integer) 0))));
      MR_Word Types_22 = ((MR_Word) ((MR_hl_field(1, HeadVar__3_3, (MR_Integer) 1))));
  ...
  MR_Word * TopFunctorMode_12)
{
  while (MR_TRUE)
  {
    ...
    if (succeeded)
    {
      ...
      {
        ConsId_16 = (MR_Word) MR_mkword(3, MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(3, ConsId_16, 0) = ((MR_Box) ((MR_Unsigned) 2U));
        MR_hl_field(3, ConsId_16, 1) = ((MR_Box) (FunctorName_13));
        MR_hl_field(3, ConsId_16, 2) = ((MR_Box) ((MR_Integer) 1));
        MR_hl_field(3, ConsId_16, 3) = ((MR_Box) (TypeCtor_15));
      }
      ...
      check_hlds__mode_top_functor__get_single_arg_inst_4_p_0(ModuleInfo_7, FinalInst_11, ConsId_16, &FinalArgInst_18);
      {
        ...
        MR_hl_field(1, Var_20, 0) = ((MR_Box) (TypeCtor_15));
        MR_hl_field(1, Var_20, 1) = ((MR_Box) (ContainingTypes_9));
      }
  ...
  MR_Word * ArgInst_8)
{
  while (MR_TRUE)
  {
    ...
    switch (MR_tag((MR_Word) Inst_6)) {
      ...
      case (MR_Integer) 2:
        {
          MR_Word Uniq_30 = ((MR_Unsigned) ((MR_hl_field(2, Inst_6, (MR_Integer) 0))) & (MR_Integer) 7);

          {
            MR_Word base;
            base = (MR_Word) MR_mkword(2, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            *ArgInst_8 = base;
            MR_hl_field(2, base, 0) = (MR_Box) ((MR_Unsigned) (Uniq_30));
      ...
      case (MR_Integer) 3:
        switch (((MR_Integer) ((MR_hl_field(3, Inst_6, (MR_Integer) 0))))) {
          ...
          case (MR_Integer) 0:
            {
              MR_Word List_15 = ((MR_Word) ((MR_hl_field(3, Inst_6, (MR_Integer) 3))));
              MR_Word ArgInst0_16;
          ...
          case (MR_Integer) 3:
            {
              MR_Word InsideInst_23 = ((MR_Word) ((MR_hl_field(3, Inst_6, (MR_Integer) 2))));
          ...
          case (MR_Integer) 4:
            {
              MR_Word InstName_9 = ((MR_Word) ((MR_hl_field(3, Inst_6, (MR_Integer) 1))));
  ...
  MR_Word * ArgInst_7)
{
  while (MR_TRUE)
  {
    ...
    if (succeeded)
    {
      ...
      InstConsId_8 = ((MR_Word) ((MR_hl_field(0, BoundInst_4, (MR_Integer) 0))));
      Var_10 = ((MR_Word) ((MR_hl_field(0, BoundInst_4, (MR_Integer) 1))));
      succeeded = (Var_10 != (MR_Word) ((MR_Unsigned) 0U));
      if (succeeded)
      {
        ArgInst0_9 = ((MR_Word) ((MR_hl_field(1, Var_10, (MR_Integer) 0))));
