        ...
        if (backend_libs__builtin_ops__succeeded)
          *backend_libs__builtin_ops__HeadVar__1_1 = (MR_Integer) 0;
          ...
          switch (MR_tag((MR_Word) backend_libs__builtin_ops__HeadVar__2_2)) {
            ...
            case (MR_Integer) 2:
              {
                MR_Integer backend_libs__builtin_ops__V_135_135 = ((MR_Integer) (MR_hl_field(MR_mktag(2), backend_libs__builtin_ops__HeadVar__2_2, (MR_Integer) 0)));
                ...
                switch (MR_tag((MR_Word) backend_libs__builtin_ops__HeadVar__3_3)) {
                  ...
                  case (MR_Integer) 2:
                    {
                      MR_Integer backend_libs__builtin_ops__V_39_39 = ((MR_Integer) (MR_hl_field(MR_mktag(2), backend_libs__builtin_ops__HeadVar__3_3, (MR_Integer) 0)));

                      {
                        mercury__private_builtin__builtin_compare_int_3_p_0(backend_libs__builtin_ops__HeadVar__1_1, backend_libs__builtin_ops__V_135_135, backend_libs__builtin_ops__V_39_39);
                      }
                    }
                    break;
                  case (MR_Integer) 3:
      ...
      /* tailcall optimized into a loop */
      {
        ...
        if (backend_libs__builtin_ops__succeeded)
          ...
          switch (MR_tag((MR_Word) backend_libs__builtin_ops__HeadVar__1_1)) {
            ...
            case (MR_Integer) 2:
              {
                MR_Integer backend_libs__builtin_ops__V_7_7 = ((MR_Integer) (MR_hl_field(MR_mktag(2), backend_libs__builtin_ops__HeadVar__1_1, (MR_Integer) 0)));
                MR_Integer backend_libs__builtin_ops__V_8_8;

                backend_libs__builtin_ops__succeeded = ((MR_tag((MR_Word) backend_libs__builtin_ops__HeadVar__2_2)) == (MR_mktag((MR_Integer) 2)));
                if (backend_libs__builtin_ops__succeeded)
                  {
                    backend_libs__builtin_ops__V_8_8 = ((MR_Integer) (MR_hl_field(MR_mktag(2), backend_libs__builtin_ops__HeadVar__2_2, (MR_Integer) 0)));
