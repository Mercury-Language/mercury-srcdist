...
MR_decl_label7(ml_backend__il_peephole__match_start_scope_1_3_0, 4,8,11,12,16,25,1)
...
MR_BEGIN_MODULE(ml_backend__il_peephole_module5)
	...
	MR_init_label7(ml_backend__il_peephole__match_start_scope_1_3_0,4,8,11,12,16,25,1)
MR_BEGIN_CODE
