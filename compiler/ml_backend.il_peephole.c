...
MR_decl_label10(fn__ml_backend__il_peephole__equivalent_to_nop_1_0, 43,44,45,46,47,145,48,49,50,51)
MR_decl_label10(fn__ml_backend__il_peephole__equivalent_to_nop_1_0, 54,52,56,57,58,59,60,61,62,63)
...
MR_def_label(ml_backend__il_peephole__match_4_0,23)
	...
	MR_tag_alloc_heap(MR_r2, 1, (MR_Integer) 2);
	MR_tfield(1, MR_r2, 0) = (MR_Word) MR_TAG_COMMON(1,7,1);
...
MR_def_label(ml_backend__il_peephole__match_4_0,37)
	...
	MR_tag_alloc_heap(MR_tempr3, 1, (MR_Integer) 2);
	MR_r3 = MR_tempr3;
	MR_tfield(1, MR_tempr3, 0) = (MR_Word) MR_TAG_COMMON(1,7,2);
...
MR_BEGIN_MODULE(ml_backend__il_peephole_module13)
	...
	MR_init_label10(fn__ml_backend__il_peephole__equivalent_to_nop_1_0,43,44,45,46,47,145,48,49,50,51)
	MR_init_label10(fn__ml_backend__il_peephole__equivalent_to_nop_1_0,54,52,56,57,58,59,60,61,62,63)
...
MR_def_label(fn__ml_backend__il_peephole__equivalent_to_nop_1_0,145)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Integer) 1;
	MR_proceed();
...
MR_def_label(fn__ml_backend__il_peephole__equivalent_to_nop_1_0,51)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_RTAGS_TESTR(MR_r1,3,1)) {
		MR_GOTO_LAB(fn__ml_backend__il_peephole__equivalent_to_nop_1_0_i52);
	}
	MR_r2 = MR_tfield(3, MR_r1, 1);
	if (MR_LTAGS_TESTR(MR_r2,0,0)) {
		MR_GOTO_LAB(fn__ml_backend__il_peephole__equivalent_to_nop_1_0_i54);
	}
	MR_r1 = (MR_Integer) 0;
	MR_proceed();
MR_def_label(fn__ml_backend__il_peephole__equivalent_to_nop_1_0,54)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_r2,2)) {
		MR_GOTO_LAB(fn__ml_backend__il_peephole__equivalent_to_nop_1_0_i145);
	}
	MR_r1 = (MR_Integer) 0;
	MR_proceed();
MR_def_label(fn__ml_backend__il_peephole__equivalent_to_nop_1_0,52)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_RTAGS_TESTR(MR_r1,3,3)) {
