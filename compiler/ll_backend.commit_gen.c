...
#line 55 "commit_gen.m"
  {
#line 55 "commit_gen.m"
    MR_bool ll_backend__commit_gen__succeeded = ((((MR_tag((MR_Word) ll_backend__commit_gen__Reason_9)) == (MR_mktag((MR_Integer) 3)))) && (((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), ll_backend__commit_gen__Reason_9, (MR_Integer) 0)))) == (MR_Integer) 6)));
...
#line 75 "commit_gen.m"
            switch (ll_backend__commit_gen__InnerCodeModel_40) {
#line 75 "commit_gen.m"
              default: /*NOTREACHED*/ MR_assert(0);
#line 75 "commit_gen.m"
              case (MR_Integer) 0:
...
#line 336 "ll_backend.commit_gen.c"
...
#line 436 "ll_backend.commit_gen.c"
