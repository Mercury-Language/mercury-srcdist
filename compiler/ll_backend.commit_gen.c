...
{
  {
    MR_bool succeeded = ((((MR_tag((MR_Word) Reason_11)) == (MR_mktag((MR_Integer) 3)))) && (((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), Reason_11, (MR_Integer) 0)))) == (MR_Integer) 7)));
    ...
    if (succeeded)
    {
      Var_19 = ((MR_Word) (MR_hl_field(MR_mktag(3), Reason_11, (MR_Integer) 1)));
      MaybeTraceRuntimeCond_20 = ((MR_Word) (MR_hl_field(MR_mktag(3), Reason_11, (MR_Integer) 2)));
      Var_21 = ((MR_Word) (MR_hl_field(MR_mktag(3), Reason_11, (MR_Integer) 3)));
      Var_22 = ((MR_Word) (MR_hl_field(MR_mktag(3), Reason_11, (MR_Integer) 4)));
      Var_23 = ((MR_Word) (MR_hl_field(MR_mktag(3), Reason_11, (MR_Integer) 5)));
      succeeded = ((MR_tag((MR_Word) MaybeTraceRuntimeCond_20)) == (MR_mktag((MR_Integer) 1)));
      if (succeeded)
        Var_24 = ((MR_Word) (MR_hl_field(MR_mktag(1), MaybeTraceRuntimeCond_20, (MR_Integer) 0)));
    }
    if (succeeded)
    {
      {
...
{
  {
    ...
    Var_19 = ((MR_Word) (MR_hl_field(MR_mktag(0), Goal_13, (MR_Integer) 0)));
          ...
          case (MR_Integer) 2:
            {
              ...
              Var_49 = mercury__cord__f_43_43_2_f_0(TypeCtorInfo_67_67, GoalCode_24, Commit_25);
              *Code_14 = mercury__cord__f_43_43_2_f_0(TypeCtorInfo_67_67, PreCommit_23, Var_49);
            }
            break;
          case (MR_Integer) 1:
            {
          ...
          case (MR_Integer) 2:
            {
              ...
              Var_38 = mercury__cord__f_43_43_2_f_0(TypeCtorInfo_68_68, GoalCode_57, Commit_58);
              *Code_14 = mercury__cord__f_43_43_2_f_0(TypeCtorInfo_68_68, PreCommit_56, Var_38);
            }
            break;
          case (MR_Integer) 1:
            ll_backend__code_gen__generate_goal_7_p_0(InnerCodeModel_21, Goal_13, Code_14, STATE_VARIABLE_CI_0_26, STATE_VARIABLE_CI_27, STATE_VARIABLE_CLD_0_28, STATE_VARIABLE_CLD_29);
