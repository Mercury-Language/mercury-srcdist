...
#line 51 "ll_backend.commit_gen.c"
...
#endif
#line 60 "ll_backend.commit_gen.c"
...
#endif
MR_decl_label8(ll_backend__commit_gen__generate_scope_8_0, 83,6,7,8,12,15,16,14)
MR_decl_label7(ll_backend__commit_gen__generate_scope_8_0, 10,23,52,26,29,30,31)
...
MR_BEGIN_MODULE(ll_backend__commit_gen_module0)
	...
	MR_init_label8(ll_backend__commit_gen__generate_scope_8_0,83,6,7,8,12,15,16,14)
	MR_init_label7(ll_backend__commit_gen__generate_scope_8_0,10,23,52,26,29,30,31)
MR_BEGIN_CODE
...
MR_define_entry(mercury__ll_backend__commit_gen__generate_scope_8_0);
	...
	if (MR_RTAGS_TESTR(MR_r1,3,3)) {
		MR_GOTO_LAB(ll_backend__commit_gen__generate_scope_8_0_i83);
	}
	{
	MR_Word MR_tempr1;
...
MR_def_label(ll_backend__commit_gen__generate_scope_8_0,83)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(8);
...
MR_def_label(ll_backend__commit_gen__generate_scope_8_0,7)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(6) = MR_r1;
	MR_sv(7) = MR_ctfield(0, MR_sv(4), 1);
	MR_r1 = MR_sv(7);
...
MR_def_label(ll_backend__commit_gen__generate_scope_8_0,23)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(ll_backend__commit_gen__generate_scope_8_0_i26);
	}
MR_def_label(ll_backend__commit_gen__generate_scope_8_0,52)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_sv(4);
	MR_r3 = MR_sv(5);
	MR_succip_word = MR_sv(8);
...
MR_def_label(ll_backend__commit_gen__generate_scope_8_0,26)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,2)) {
		MR_GOTO_LAB(ll_backend__commit_gen__generate_scope_8_0_i52);
	}
	MR_sv(1) = MR_r1;
	MR_r1 = MR_sv(2);
	MR_r2 = MR_sv(6);
