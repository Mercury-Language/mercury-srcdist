...
#endif
MR_decl_label8(ll_backend__commit_gen__generate_scope_8_0, 79,6,7,8,12,15,16,17)
MR_decl_label8(ll_backend__commit_gen__generate_scope_8_0, 18,14,10,21,48,24,27,28)
MR_decl_label3(ll_backend__commit_gen__generate_scope_8_0, 29,30,31)
...
MR_BEGIN_MODULE(ll_backend__commit_gen_module0)
	...
	MR_init_label8(ll_backend__commit_gen__generate_scope_8_0,79,6,7,8,12,15,16,17)
	MR_init_label8(ll_backend__commit_gen__generate_scope_8_0,18,14,10,21,48,24,27,28)
	MR_init_label3(ll_backend__commit_gen__generate_scope_8_0,29,30,31)
MR_BEGIN_CODE
