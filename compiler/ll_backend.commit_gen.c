...
{
  {
    MR_bool ll_backend__commit_gen__succeeded = ((((MR_tag((MR_Word) ll_backend__commit_gen__Reason_11)) == (MR_mktag((MR_Integer) 3)))) && (((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), ll_backend__commit_gen__Reason_11, (MR_Integer) 0)))) == (MR_Integer) 7)));
    MR_Word ll_backend__commit_gen__MaybeTraceRuntimeCond_20;
    MR_Word ll_backend__commit_gen__Var_19;
    MR_Word ll_backend__commit_gen__Var_21;
    MR_Word ll_backend__commit_gen__Var_22;
    MR_Word ll_backend__commit_gen__Var_23;
    MR_Word ll_backend__commit_gen__Var_24;

    if (ll_backend__commit_gen__succeeded)
    {
      ll_backend__commit_gen__Var_19 = ((MR_Word) (MR_hl_field(MR_mktag(3), ll_backend__commit_gen__Reason_11, (MR_Integer) 1)));
      ...
      ll_backend__commit_gen__Var_21 = ((MR_Word) (MR_hl_field(MR_mktag(3), ll_backend__commit_gen__Reason_11, (MR_Integer) 3)));
      ll_backend__commit_gen__Var_22 = ((MR_Word) (MR_hl_field(MR_mktag(3), ll_backend__commit_gen__Reason_11, (MR_Integer) 4)));
      ll_backend__commit_gen__Var_23 = ((MR_Word) (MR_hl_field(MR_mktag(3), ll_backend__commit_gen__Reason_11, (MR_Integer) 5)));
      ll_backend__commit_gen__succeeded = ((MR_tag((MR_Word) ll_backend__commit_gen__MaybeTraceRuntimeCond_20)) == (MR_mktag((MR_Integer) 1)));
      if (ll_backend__commit_gen__succeeded)
        ll_backend__commit_gen__Var_24 = ((MR_Word) (MR_hl_field(MR_mktag(1), ll_backend__commit_gen__MaybeTraceRuntimeCond_20, (MR_Integer) 0)));
    }
    if (ll_backend__commit_gen__succeeded)
    {
      {
...
{
  {
    ...
    ll_backend__commit_gen__Var_19 = ((MR_Word) (MR_hl_field(MR_mktag(0), ll_backend__commit_gen__Goal_13, (MR_Integer) 0)));
          ...
          case (MR_Integer) 2:
            {
              ...
              MR_Word ll_backend__commit_gen__Var_49;
              ...
              ll_backend__commit_gen__Var_49 = mercury__cord__f_43_43_2_f_0(ll_backend__commit_gen__TypeCtorInfo_67_67, ll_backend__commit_gen__GoalCode_24, ll_backend__commit_gen__Commit_25);
              *ll_backend__commit_gen__Code_14 = mercury__cord__f_43_43_2_f_0(ll_backend__commit_gen__TypeCtorInfo_67_67, ll_backend__commit_gen__PreCommit_23, ll_backend__commit_gen__Var_49);
            }
            break;
          case (MR_Integer) 1:
            {
          ...
          case (MR_Integer) 2:
            {
              ...
              MR_Word ll_backend__commit_gen__Var_38;
              ...
              ll_backend__commit_gen__Var_38 = mercury__cord__f_43_43_2_f_0(ll_backend__commit_gen__TypeCtorInfo_68_68, ll_backend__commit_gen__GoalCode_57, ll_backend__commit_gen__Commit_58);
              *ll_backend__commit_gen__Code_14 = mercury__cord__f_43_43_2_f_0(ll_backend__commit_gen__TypeCtorInfo_68_68, ll_backend__commit_gen__PreCommit_56, ll_backend__commit_gen__Var_38);
            }
            break;
          case (MR_Integer) 1:
            ll_backend__code_gen__generate_goal_7_p_0(ll_backend__commit_gen__InnerCodeModel_21, ll_backend__commit_gen__Goal_13, ll_backend__commit_gen__Code_14, ll_backend__commit_gen__STATE_VARIABLE_CI_0_26, ll_backend__commit_gen__STATE_VARIABLE_CI_27, ll_backend__commit_gen__STATE_VARIABLE_CLD_0_28, ll_backend__commit_gen__STATE_VARIABLE_CLD_29);
