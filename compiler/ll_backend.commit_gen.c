...
#endif
MR_decl_label8(ll_backend__commit_gen__generate_scope_8_0, 75,6,7,8,12,15,16,14)
...
MR_BEGIN_MODULE(ll_backend__commit_gen_module0)
	...
	MR_init_label8(ll_backend__commit_gen__generate_scope_8_0,75,6,7,8,12,15,16,14)
