...
{
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          Var_18 = mercury__integer__two_0_f_0();
          Var_19 = mercury__integer__integer_1_f_0(BitsPerUInt_15);
          Var_17 = mercury__integer__pow_2_f_0(Var_18, Var_19);
          succeeded = mercury__integer__f_less_than_2_p_0(Var_11, Var_17);
          if (succeeded)
...
{
  {
    ...
    if (succeeded)
    {
      Var_17 = mercury__integer__two_0_f_0();
      Var_18 = mercury__integer__integer_1_f_0(BitsPerUInt_14);
      Var_16 = mercury__integer__pow_2_f_0(Var_17, Var_18);
      succeeded = mercury__integer__f_less_than_2_p_0(Var_9, Var_16);
      if (succeeded)
