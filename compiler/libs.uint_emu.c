...
MR_bool MR_CALL 
libs__uint_emu__right_ushift_4_p_0(
  ...
  MR_Unsigned * Z_8)
{
  ...
  Y_10 = mercury__uint__cast_to_int_1_f_0(UY_7);
  succeeded = (Y_10 >= (MR_Integer) 0);
  if (succeeded)
  {
    succeeded = (Y_10 < N_9);
    if (succeeded)
    {
      Var_13 = mercury__integer__from_uint_1_f_0(X_6);
      Var_12 = mercury__integer__f_62_62_2_f_0(Var_13, Y_10);
      BitsPerUInt_14 = (MR_Integer) (BitsPerUInt_5);
      Var_15 = mercury__integer__zero_0_f_0();
      succeeded = mercury__integer__f_greater_or_equal_2_p_0(Var_12, Var_15);
      if (succeeded)
      {
        Var_18 = (MR_Integer) 2;
        ...
        succeeded = mercury__integer__f_less_or_equal_2_p_0(Var_12, Var_16);
        if (succeeded)
          succeeded = mercury__integer__to_uint_2_p_0(Var_12, Z_8);
      }
    }
  }
  return succeeded;
  ...
  MR_Unsigned * Z_8)
{
  ...
  if (succeeded)
  {
    ...
    if (succeeded)
    {
      ...
      BitsPerUInt_13 = (MR_Integer) (BitsPerUInt_5);
      Var_14 = mercury__integer__zero_0_f_0();
      succeeded = mercury__integer__f_greater_or_equal_2_p_0(Var_11, Var_14);
      if (succeeded)
      {
        Var_17 = (MR_Integer) 2;
        Var_16 = mercury__integer__integer_1_f_0(Var_17);
        Var_18 = mercury__integer__integer_1_f_0(BitsPerUInt_13);
        Var_15 = mercury__integer__pow_2_f_0(Var_16, Var_18);
        succeeded = mercury__integer__f_less_or_equal_2_p_0(Var_11, Var_15);
        if (succeeded)
...
MR_bool MR_CALL 
libs__uint_emu__left_ushift_4_p_0(
  MR_Word BitsPerUInt_5,
  MR_Unsigned X_6,
  MR_Unsigned UY_7,
  MR_Unsigned * Z_8)
{
  ...
  if (succeeded)
  {
    ...
    {
      Var_13 = mercury__integer__from_uint_1_f_0(X_6);
      Var_12 = mercury__integer__f_60_60_2_f_0(Var_13, Y_10);
      BitsPerUInt_14 = (MR_Integer) (BitsPerUInt_5);
      Var_15 = mercury__integer__zero_0_f_0();
      succeeded = mercury__integer__f_greater_or_equal_2_p_0(Var_12, Var_15);
      if (succeeded)
...
libs__uint_emu__rem_4_p_0(
  ...
  MR_Unsigned * Z_8)
{
  MR_bool succeeded = (Y_7 != (MR_Unsigned) 0U);
  MR_Word Var_9;
  MR_Word Var_10;
  MR_Word Var_11;
  MR_Integer BitsPerUInt_12;
  MR_Word Var_13;
  MR_Word Var_14;
  MR_Word Var_15;
  MR_Integer Var_16;
  ...
  if (succeeded)
  {
    ...
    BitsPerUInt_12 = (MR_Integer) (BitsPerUInt_5);
    Var_13 = mercury__integer__zero_0_f_0();
    succeeded = mercury__integer__f_greater_or_equal_2_p_0(Var_9, Var_13);
    if (succeeded)
    {
      Var_16 = (MR_Integer) 2;
      Var_15 = mercury__integer__integer_1_f_0(Var_16);
      Var_17 = mercury__integer__integer_1_f_0(BitsPerUInt_12);
      Var_14 = mercury__integer__pow_2_f_0(Var_15, Var_17);
      succeeded = mercury__integer__f_less_or_equal_2_p_0(Var_9, Var_14);
      if (succeeded)
  ...
  MR_Word * HeadVar__2_2)
{
  ...
  switch (Target_5) {
    ...
    case (MR_Integer) 0:
      libs__globals__lookup_int_option_3_p_0(Globals_3, (MR_Integer) 284, &BitsPerUInt_4);
      break;
    case (MR_Integer) 1:
    case (MR_Integer) 2:
