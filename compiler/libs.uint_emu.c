...
{
  {
    ...
    if (libs__uint_emu__succeeded)
      *libs__uint_emu__HeadVar__1_1 = (MR_Integer) 0;
      ...
      {
        MR_Integer libs__uint_emu__Var_4 = (MR_Integer) libs__uint_emu__HeadVar__2_2;
        MR_Integer libs__uint_emu__Var_5 = (MR_Integer) libs__uint_emu__HeadVar__3_3;

        {
          mercury__private_builtin__builtin_compare_int_3_p_0(libs__uint_emu__HeadVar__1_1, libs__uint_emu__Var_4, libs__uint_emu__Var_5);
        }
      }
  }
}
...
{
  {
    ...
    if (libs__uint_emu__succeeded)
      ...
      {
        MR_Integer libs__uint_emu__Var_3 = (MR_Integer) libs__uint_emu__HeadVar__1_1;
        MR_Integer libs__uint_emu__Var_4 = (MR_Integer) libs__uint_emu__HeadVar__2_2;

        libs__uint_emu__succeeded = (libs__uint_emu__Var_3 == libs__uint_emu__Var_4);
      }
    return libs__uint_emu__succeeded;
  }
}
  ...
  MR_Unsigned * libs__uint_emu__Z_8)
{
  {
    MR_bool libs__uint_emu__succeeded;
    MR_Unsigned libs__uint_emu__Var_11;

    {
      libs__uint_emu__Var_11 = mercury__uint__cast_from_int_1_f_0((MR_Integer) 0);
    }
    libs__uint_emu__succeeded = (libs__uint_emu__Y_7 == libs__uint_emu__Var_11);
...
{
  {
    ...
    switch (libs__uint_emu__Target_5) {
      ...
      case (MR_Integer) 0:
        {
          {
            libs__globals__lookup_int_option_3_p_0(libs__uint_emu__Globals_3, (MR_Integer) 249, &libs__uint_emu__BitsPerUInt_4);
          }
        }
        break;
      case (MR_Integer) 1:
