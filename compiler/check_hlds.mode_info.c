          ...
          case (MR_Integer) 2:
            {
              ...
              hlds__hlds_goal____Compare____unify_context_0_0(&SubResult1_11, ArgX1_9, ArgY1_10);
              succeeded = (SubResult1_11 != (MR_Integer) 0);
              if (succeeded)
                *HeadVar__1_1 = SubResult1_11;
              else
              {
                MR_Integer Var_20 = (MR_Integer) (ArgX2_12);
                MR_Integer Var_21 = (MR_Integer) (ArgY2_13);
