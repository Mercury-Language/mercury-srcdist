...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_21, (MR_Integer) 78, &DebugModes_22);
    libs__globals__lookup_int_option_3_p_0(Globals_21, (MR_Integer) 82, &DebugModesPredId_23);
    ...
    if (succeeded)
    {
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals_21, (MR_Integer) 81, &DebugVerbose_25);
      libs__globals__lookup_bool_option_3_p_0(Globals_21, (MR_Integer) 80, &DebugMinimal_26);
      libs__globals__lookup_bool_option_3_p_0(Globals_21, (MR_Integer) 79, &Statistics_27);
      {
