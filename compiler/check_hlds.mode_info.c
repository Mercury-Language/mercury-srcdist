...
{
  {
    ...
    hlds__hlds_pred__pred_info_get_simple_call_id_2_p_0(PredInfo_8, CallId_6);
  }
}
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_21, (MR_Integer) 76, &DebugModes_22);
    libs__globals__lookup_int_option_3_p_0(Globals_21, (MR_Integer) 80, &DebugModesPredId_23);
    ...
    if (succeeded)
    {
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals_21, (MR_Integer) 79, &DebugVerbose_25);
      libs__globals__lookup_bool_option_3_p_0(Globals_21, (MR_Integer) 78, &DebugMinimal_26);
      libs__globals__lookup_bool_option_3_p_0(Globals_21, (MR_Integer) 77, &Statistics_27);
      {
