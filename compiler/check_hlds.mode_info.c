...
{
  {
    ...
    if (succeeded)
    {
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals_21, (MR_Integer) 83, &DebugVerbose_25);
      libs__globals__lookup_bool_option_3_p_0(Globals_21, (MR_Integer) 82, &DebugMinimal_26);
      libs__globals__lookup_bool_option_3_p_0(Globals_21, (MR_Integer) 81, &Statistics_27);
      {
