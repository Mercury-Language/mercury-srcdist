...
{
  {
    ...
    Var_59 = ((MR_Word) ((MR_hl_field(MR_mktag(0), *STATE_VARIABLE_ModeInfo_19, (MR_Integer) 7))));
    DebugModes_8 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_59, (MR_Integer) 4))));
    if (!((DebugModes_8 == (MR_Word) ((MR_Unsigned) 0U))))
    {
      MR_Integer ErrorNum_11;
      MR_Word Spec_12;
      ...
      mercury__list__length_2_p_0((MR_Word) (&check_hlds__mode_errors__check_hlds__mode_errors__type_ctor_info_mode_error_info_0), Errors_7, &ErrorNum_11);
      mercury__io__write_string_3_p_0((MR_String) "Adding error_spec ");
      mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&check_hlds__mode_info_scalar_common_3[0]), ErrorNum_11, &Var_40);
      mercury__io__write_string_3_p_0(Var_40);
      mercury__io__write_string_3_p_0((MR_String) "\n");
      Spec_12 = check_hlds__mode_errors__mode_error_info_to_spec_2_f_0(*STATE_VARIABLE_ModeInfo_19, ModeErrorInfo_4);
      ModuleInfo_13 = ((MR_Word) ((MR_hl_field(MR_mktag(0), *STATE_VARIABLE_ModeInfo_19, (MR_Integer) 0))));
      hlds__hlds_module__module_info_get_globals_2_p_0(ModuleInfo_13, &Globals0_14);
      libs__globals__set_option_4_p_0((MR_Integer) 64, (MR_Word) (MR_mkword(MR_mktag(1), &check_hlds__mode_info_scalar_common_3[1])), Globals0_14, &Globals_15);
      parse_tree__error_util__write_error_spec_8_p_0(Globals_15, Spec_12, (MR_Integer) 0, &Var_16, (MR_Integer) 0, &Var_17);
...
{
  {
...

    {
      ...
      MR_hl_field(MR_mktag(0), Var_10, 12) = ((MR_Box) (Var_30));
      MR_hl_field(MR_mktag(0), Var_10, 13) = ((MR_Box) (Var_31));
      MR_hl_field(MR_mktag(0), Var_10, 14) = (MR_Box) ((((packed_word_0 & (~((MR_Unsigned) 512U)))) | (((MR_Unsigned) (X_4) << 9))));
    }
    {
      MR_Word base;
      base = (MR_Word) MR_new_object(MR_Word, (8 * sizeof(MR_Word)), NULL, NULL);
  ...
  MR_Word * STATE_VARIABLE_MI_3)
{
  ...
  else
  {
...

    {
      ...
      MR_hl_field(MR_mktag(2), Var_8, 1) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 0));
    }
