...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_21, (MR_Integer) 80, &DebugModes_22);
    libs__globals__lookup_int_option_3_p_0(Globals_21, (MR_Integer) 84, &DebugModesPredId_23);
    ...
    if (succeeded)
    {
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals_21, (MR_Integer) 83, &DebugVerbose_26);
      libs__globals__lookup_bool_option_3_p_0(Globals_21, (MR_Integer) 82, &DebugMinimal_27);
      libs__globals__lookup_bool_option_3_p_0(Globals_21, (MR_Integer) 81, &Statistics_28);
      {
