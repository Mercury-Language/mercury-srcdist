...
{
  {
    MR_Word Errors0_6 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_ModeInfo_0_20, (MR_Integer) 3))));
    MR_Word Errors_7;
...

    {
      ...
      MR_hl_field(MR_mktag(1), Var_22, 0) = ((MR_Box) (ModeErrorInfo_4));
      MR_hl_field(MR_mktag(1), Var_22, 1) = ((MR_Box) ((MR_Unsigned) 0U));
    }
    mercury__list__append_3_p_1((MR_Word) (&check_hlds__mode_errors__check_hlds__mode_errors__type_ctor_info_mode_error_info_0), Errors0_6, Var_22, &Errors_7);
    check_hlds__mode_info__mode_info_set_errors_3_p_0(Errors_7, STATE_VARIABLE_ModeInfo_0_20, STATE_VARIABLE_ModeInfo_21);
    Var_62 = ((MR_Word) ((MR_hl_field(MR_mktag(0), *STATE_VARIABLE_ModeInfo_21, (MR_Integer) 7))));
    DebugModes_8 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_62, (MR_Integer) 4))));
    if (!((DebugModes_8 == (MR_Word) ((MR_Unsigned) 0U))))
    {
      ...
      check_hlds__mode_info__mode_info_get_module_info_2_p_0(*STATE_VARIABLE_ModeInfo_21, &ModuleInfo_11);
      hlds__hlds_module__module_info_get_globals_2_p_0(ModuleInfo_11, &Globals0_12);
      hlds__hlds_module__module_info_get_name_2_p_0(ModuleInfo_11, &ModuleName_13);
      ...
      mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) (&check_hlds__mode_info_scalar_common_3[0]), ErrorNum_15, &Var_43);
      mercury__io__write_string_4_p_0(DebugStream_14, Var_43);
      mercury__io__write_string_4_p_0(DebugStream_14, (MR_String) "\n");
      Spec_16 = check_hlds__mode_errors__mode_error_info_to_spec_2_f_0(*STATE_VARIABLE_ModeInfo_21, ModeErrorInfo_4);
      libs__globals__set_option_4_p_0((MR_Integer) 64, (MR_Word) (MR_mkword(MR_mktag(1), &check_hlds__mode_info_scalar_common_3[1])), Globals0_12, &Globals_17);
      parse_tree__error_util__write_error_spec_9_p_0(DebugStream_14, Globals_17, Spec_16, (MR_Integer) 0, &Var_18, (MR_Integer) 0, &Var_19);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_21, (MR_Integer) 81, &DebugModes_22);
    libs__globals__lookup_int_option_3_p_0(Globals_21, (MR_Integer) 85, &DebugModesPredId_23);
    ...
    if (succeeded)
    {
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals_21, (MR_Integer) 84, &DebugVerbose_26);
      libs__globals__lookup_bool_option_3_p_0(Globals_21, (MR_Integer) 83, &DebugMinimal_27);
      libs__globals__lookup_bool_option_3_p_0(Globals_21, (MR_Integer) 82, &Statistics_28);
      {
    ...
    hlds__hlds_pred__proc_info_get_vartypes_2_p_0(ProcInfo_31, &VarTypes_33);
