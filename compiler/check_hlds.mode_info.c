                              ...
                              else
                              {
                                ...
                                else
                                {
                                  ...
                                  else
                                  {
                                    ...
                                    mercury__builtin__compare_3_p_0((MR_Word) &check_hlds__mode_info_scalar_common_2[2], &Var_67, ((MR_Box) (ArgX16_34)), ((MR_Box) (ArgY16_35)));
                                              ...
                                              if (succeeded)
                                              {
                                                ...
                                                if (succeeded)
                                                {
                                                  ...
                                                  if (succeeded)
                                                  {
                                                    ...
                                                    succeeded = mercury__builtin__unify_2_p_0(TypeInfo_64_88, ((MR_Box) (ArgX16_57)), ((MR_Box) (ArgY16_58)));
                                                    if (succeeded)
                                                    {
                                                      TypeInfo_65_89 = (MR_Word) &check_hlds__mode_info_scalar_common_1[10];
                                                      succeeded = mercury__builtin__unify_2_p_0(TypeInfo_65_89, ((MR_Box) (ArgX17_59)), ((MR_Box) (ArgY17_60)));
                                                      if (succeeded)
                                                      {
                                                              ...
                                                              if (succeeded)
                                                              {
                                                                ...
                                                                if (succeeded)
                                                                {
                                                                  ...
                                                                  if (succeeded)
                                                                  {
                                                                    ...
                                                                    succeeded = mercury__builtin__unify_2_p_0(TypeInfo_66_90, ((MR_Box) (ArgX24_73)), ((MR_Box) (ArgY24_74)));
                                                                  }
                                                                }
                                                              }
                                                            }
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_21, (MR_Integer) 73, &DebugModes_22);
    libs__globals__lookup_int_option_3_p_0(Globals_21, (MR_Integer) 77, &DebugModesPredId_23);
    ...
    if (succeeded)
    {
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals_21, (MR_Integer) 76, &DebugVerbose_25);
      libs__globals__lookup_bool_option_3_p_0(Globals_21, (MR_Integer) 75, &DebugMinimal_26);
      libs__globals__lookup_bool_option_3_p_0(Globals_21, (MR_Integer) 74, &Statistics_27);
      {
