...
{
  {
    ...
    {
      libs__globals__lookup_bool_option_3_p_0(check_hlds__mode_info__Globals_21, (MR_Integer) 63, &check_hlds__mode_info__DebugModes_22);
    }
    {
      libs__globals__lookup_int_option_3_p_0(check_hlds__mode_info__Globals_21, (MR_Integer) 67, &check_hlds__mode_info__DebugModesPredId_23);
    }
    {
    ...
    if (check_hlds__mode_info__succeeded)
      {
        ...
        {
          libs__globals__lookup_bool_option_3_p_0(check_hlds__mode_info__Globals_21, (MR_Integer) 66, &check_hlds__mode_info__DebugVerbose_25);
        }
        {
          libs__globals__lookup_bool_option_3_p_0(check_hlds__mode_info__Globals_21, (MR_Integer) 65, &check_hlds__mode_info__DebugMinimal_26);
        }
        {
          libs__globals__lookup_bool_option_3_p_0(check_hlds__mode_info__Globals_21, (MR_Integer) 64, &check_hlds__mode_info__Statistics_27);
        }
        {
