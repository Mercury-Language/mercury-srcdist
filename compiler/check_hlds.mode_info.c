...
{
  {
    ...
    if (succeeded)
    {
      ...
      MaybeDebug_29 = (MR_Word) ((MR_Integer) 0);
    ...
    mercury__map__init_1_p_0((MR_Word) (&check_hlds__mode_info_scalar_common_1[0]), (MR_Word) (&check_hlds__mode_errors__check_hlds__mode_errors__type_ctor_info_pred_var_multimode_pred_error_0), &PredVarMultiModeMap_47);
    {
      ...
      MR_hl_field(MR_mktag(0), ModeSubInfo_48, 5) = ((MR_Box) ((MR_Integer) 0));
      ...
      MR_hl_field(MR_mktag(0), ModeSubInfo_48, 8) = ((MR_Box) ((MR_Integer) 0));
      ...
      MR_hl_field(MR_mktag(0), ModeSubInfo_48, 12) = ((MR_Box) ((MR_Integer) 0));
