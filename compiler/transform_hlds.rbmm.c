...
MR_decl_label9(transform_hlds__rbmm__do_region_analysis_4_0, 12,13,14,15,16,17,18,19,20)
...
MR_BEGIN_MODULE(transform_hlds__rbmm_module0)
	...
	MR_init_label9(transform_hlds__rbmm__do_region_analysis_4_0,12,13,14,15,16,17,18,19,20)
MR_BEGIN_CODE
...
void mercury__transform_hlds__rbmm__write_out_proc_statics(FILE *deep_fp, FILE *procrep_fp)
{
	MR_write_out_module_proc_reps_start(procrep_fp, &mercury_data__module_layout__transform_hlds__rbmm);
