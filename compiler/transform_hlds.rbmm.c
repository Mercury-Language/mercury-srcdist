...
MR_decl_label3(transform_hlds__rbmm__do_region_analysis_4_0, 18,19,20)
...
MR_decl_entry(transform_hlds__rbmm__region_transformation__region_transform_14_0);
...
MR_BEGIN_MODULE(transform_hlds__rbmm_module0)
	...
	MR_init_label3(transform_hlds__rbmm__do_region_analysis_4_0,18,19,20)
MR_BEGIN_CODE
...
MR_def_label(transform_hlds__rbmm__do_region_analysis_4_0,18)
	...
	MR_np_call_localret_ent(fn__map__init_0_0,
		transform_hlds__rbmm__do_region_analysis_4_0_i19);
MR_def_label(transform_hlds__rbmm__do_region_analysis_4_0,19)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r11 = MR_r1;
	MR_r1 = MR_sv(1);
	MR_r2 = MR_sv(5);
	...
	MR_r10 = MR_sv(8);
	MR_r12 = MR_sv(13);
	MR_np_call_localret_ent(transform_hlds__rbmm__region_transformation__region_transform_14_0,
		transform_hlds__rbmm__do_region_analysis_4_0_i20);
MR_def_label(transform_hlds__rbmm__do_region_analysis_4_0,20)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r5 = MR_r1;
	MR_r1 = MR_sv(1);
	MR_r6 = MR_r2;
