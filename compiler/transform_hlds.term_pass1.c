...
MR_decl_label10(transform_hlds__term_pass1__check_goal_non_term_calls_9_0, 151,3,4,8,13,12,16,23,27,28)
MR_decl_label10(transform_hlds__term_pass1__check_goal_non_term_calls_9_0, 29,66,31,36,39,43,38,25,49,161)
MR_decl_label3(transform_hlds__term_pass1__check_goal_non_term_calls_9_0, 45,53,57)
...
MR_def_label(transform_hlds__term_pass1__find_arg_sizes_pred_9_0,12)
	...
	MR_sv(5) = MR_r1;
	MR_sv(10) = (MR_Word) MR_CTOR0_ADDR(transform_hlds__term_traversal, term_path_info);
	MR_r1 = MR_sv(10);
	MR_r2 = MR_tempr1;
	}
...
MR_def_label(transform_hlds__term_pass1__convert_equations_2_7_0,12)
	...
	MR_tfield(0, MR_tempr2, 2) = MR_float_to_word(MR_float_from_dword_ptr(&MR_sv(8)));
	MR_sv(6) = MR_r2;
	MR_sv(1) = MR_r3;
...
MR_def_label(transform_hlds__term_pass1__solve_equations_5_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(4) = MR_r1;
	MR_sv(7) = (MR_Word) MR_CTOR0_ADDR(libs__lp, equation);
	MR_r1 = MR_sv(7);
...
MR_BEGIN_MODULE(transform_hlds__term_pass1_module9)
	...
	MR_init_label10(transform_hlds__term_pass1__check_goal_non_term_calls_9_0,151,3,4,8,13,12,16,23,27,28)
	MR_init_label10(transform_hlds__term_pass1__check_goal_non_term_calls_9_0,29,66,31,36,39,43,38,25,49,161)
	MR_init_label3(transform_hlds__term_pass1__check_goal_non_term_calls_9_0,45,53,57)
MR_BEGIN_CODE
...
MR_def_static(transform_hlds__term_pass1__check_goal_non_term_calls_9_0)
	...
	MR_incr_sp(8);
	MR_sv(8) = (MR_Word) MR_succip;
MR_def_label(transform_hlds__term_pass1__check_goal_non_term_calls_9_0,151)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
...
MR_def_label(transform_hlds__term_pass1__check_goal_non_term_calls_9_0,16)
	...
	MR_succip_word = MR_sv(8);
	MR_GOTO_LAB(transform_hlds__term_pass1__check_goal_non_term_calls_9_0_i151);
...
MR_def_label(transform_hlds__term_pass1__check_goal_non_term_calls_9_0,66)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_sv(2);
	MR_sv(5) = MR_r1;
	MR_r1 = MR_sv(3);
...
MR_def_label(transform_hlds__term_pass1__check_goal_non_term_calls_9_0,31)
	...
	if (MR_PTAG_TESTR(MR_tempr1,1)) {
		MR_GOTO_LAB(transform_hlds__term_pass1__check_goal_non_term_calls_9_0_i66);
	}
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 2);
	MR_tfield(1, MR_tempr1, 0) = MR_sv(1);
...
MR_def_label(transform_hlds__term_pass1__check_goal_non_term_calls_9_0,25)
	...
	if (MR_RTAGS_TESTR(MR_tempr1,3,4)) {
		MR_GOTO_LAB(transform_hlds__term_pass1__check_goal_non_term_calls_9_0_i161);
	}
	MR_r7 = MR_tfield(3, MR_tempr1, 2);
	if (MR_INT_NE(MR_r7,1)) {
		MR_GOTO_LAB(transform_hlds__term_pass1__check_goal_non_term_calls_9_0_i49);
	}
	MR_sv(1) = MR_r1;
	MR_sv(2) = MR_r2;
	MR_r1 = MR_r4;
...
MR_def_label(transform_hlds__term_pass1__check_goal_non_term_calls_9_0,49)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_def_label(transform_hlds__term_pass1__check_goal_non_term_calls_9_0,161)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_succip_word = MR_sv(8);
	MR_GOTO_LAB(transform_hlds__term_pass1__check_goal_non_term_calls_9_0_i151);
...
MR_def_label(transform_hlds__term_pass1__check_goal_non_term_calls_9_0,53)
	...
	if (MR_PTAG_TESTR(MR_r7,1)) {
		MR_GOTO_LAB(transform_hlds__term_pass1__check_goal_non_term_calls_9_0_i57);
	}
	MR_r1 = MR_r4;
	MR_r2 = MR_r5;
	MR_decr_sp_and_return(8);
MR_def_label(transform_hlds__term_pass1__check_goal_non_term_calls_9_0,57)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_string_const("transform_hlds.term_pass1", 25);
