    ...
    switch (MR_tag((MR_Word) GoalExpr_12)) {
      ...
      case (MR_Integer) 2:
        {
          ...
          {
            MR_Word Var_112 = ((MR_Word) ((MR_hl_field(1, TerminationInfo_28, 0))));
      ...
      case (MR_Integer) 3:
        switch (((MR_Integer) ((MR_hl_field(3, GoalExpr_12, 0))))) {
          ...
          case (MR_Integer) 3:
            {
              MR_Word Goals_108 = ((MR_Word) ((MR_hl_field(3, GoalExpr_12, 1))));
              MR_Word Var_109;
              MR_Box conv3_STATE_VARIABLE_Errors_64;

              {
                Var_109 = (MR_Word) MR_new_object(MR_Word, (6 * sizeof(MR_Word)), NULL, NULL);
                MR_hl_field(0, Var_109, 0) = ((MR_Box) (&transform_hlds__term_pass1_scalar_common_5[1]));
                MR_hl_field(0, Var_109, 1) = ((MR_Box) (transform_hlds__term_pass1__check_goal_non_term_calls_6_p_0_2));
                MR_hl_field(0, Var_109, 2) = ((MR_Box) ((MR_Integer) 3));
                MR_hl_field(0, Var_109, 3) = ((MR_Box) (ModuleInfo_7));
                MR_hl_field(0, Var_109, 4) = ((MR_Box) (PPId_8));
                MR_hl_field(0, Var_109, 5) = ((MR_Box) (VarTable_9));
              }
