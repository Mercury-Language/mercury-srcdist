    ...
    if ((SubsetErrors_16 == (MR_Word) ((MR_Unsigned) 0U)))
      ...
      else
      {
        ...
        if (succeeded)
        {
          ...
          TypeInfo_28_64 = (MR_Word) (&transform_hlds__term_pass1_scalar_common_2[1]);
          mercury__list__map_3_p_0((MR_Word) (&transform_hlds__term_pass1_scalar_common_1[3]), TypeInfo_28_64, Convert_59, Vars_58, &Objective_41);
          succeeded = MR_TRUE;
        }
        if (succeeded)
        {
  ...
  MR_Word * STATE_VARIABLE_TermErrors_9)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      MR_Word Goal_62;
      MR_Word EmptyMap_63;
      MR_Word FunctorInfo_64;
      MR_Integer MaxErrors_65;
      MR_Integer MaxPaths_66;
      MR_Word Params_67;
      MR_Word InVars_68;
      MR_Word OutVars_69;
      MR_Word Path0_70;
      ...
      hlds__hlds_pred__proc_info_get_var_table_3_p_0(ModuleInfo_1, ProcInfo_56, &VarTable_60);
      hlds__hlds_pred__proc_info_get_goal_2_p_0(ProcInfo_56, &Goal0_61);
      Goal_62 = hlds__goal_util__maybe_strip_equality_pretest_1_f_0(Goal0_61);
      mercury__map__init_1_p_0((MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_proc_id_0), (MR_Word) (&transform_hlds__term_pass1_scalar_common_1[0]), &EmptyMap_63);
      FunctorInfo_64 = ((MR_Word) ((MR_hl_field(MR_mktag(0), PassInfo_2, (MR_Integer) 0))));
      MaxErrors_65 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), PassInfo_2, (MR_Integer) 1))));
      MaxPaths_66 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), PassInfo_2, (MR_Integer) 2))));
      transform_hlds__term_traversal__init_term_traversal_params_9_p_0(FunctorInfo_64, PPId_21, Context_57, VarTable_60, HeadVar__4_4, EmptyMap_63, MaxErrors_65, MaxPaths_66, &Params_67);
      transform_hlds__term_util__partition_call_args_5_p_0(ModuleInfo_1, ArgModes_59, Args_58, &InVars_68, &OutVars_69);
      {
        Path0_70 = (MR_Word) MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), Path0_70, 0) = ((MR_Box) (PPId_21));
        MR_hl_field(MR_mktag(0), Path0_70, 1) = ((MR_Box) ((MR_Unsigned) 0U));
        MR_hl_field(MR_mktag(0), Path0_70, 2) = ((MR_Box) ((MR_Integer) 0));
        MR_hl_field(MR_mktag(0), Path0_70, 3) = ((MR_Box) ((MR_Unsigned) 0U));
        MR_hl_field(MR_mktag(0), Path0_70, 4) = ((MR_Box) (OutVars_69));
      }
      PathSet0_71 = mercury__set__make_singleton_set_1_f_0((MR_Word) (&transform_hlds__term_traversal__transform_hlds__term_traversal__type_ctor_info_term_path_info_0), ((MR_Box) (Path0_70)));
      {
        Info0_72 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), Info0_72, 0) = ((MR_Box) (PathSet0_71));
        MR_hl_field(MR_mktag(0), Info0_72, 1) = ((MR_Box) ((MR_Unsigned) 0U));
      }
      transform_hlds__term_traversal__term_traverse_goal_5_p_0(ModuleInfo_1, Params_67, Goal_62, Info0_72, &Info_73);
      if (((MR_tag((MR_Word) Info_73)) == (MR_Integer) 1))
      {
        MR_Word Errors_83 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Info_73, (MR_Integer) 0))));

        ProcTermErrors_29 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Info_73, (MR_Integer) 1))));
        {
          Result1_28 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), Result1_28, 0) = ((MR_Box) (Errors_83));
        }
      }
      else
      {
        MR_Word Paths_74 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Info_73, (MR_Integer) 0))));
        MR_Word PathList_75;
        MR_Word AllActiveVars_76;
        MR_Word OutputSuppliers0_77;
        MR_Word OutputSuppliers_78;
        MR_Word OutputSupplierMap_79;
        MR_Word SubsetErrors_80;
        MR_Box conv0_OutputSuppliers0_77;

        ProcTermErrors_29 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Info_73, (MR_Integer) 1))));
        mercury__set__to_sorted_list_2_p_0((MR_Word) (&transform_hlds__term_traversal__transform_hlds__term_traversal__type_ctor_info_term_path_info_0), Paths_74, &PathList_75);
        transform_hlds__term_traversal__upper_bound_active_vars_2_p_0(PathList_75, &AllActiveVars_76);
        mercury__map__lookup_3_p_0((MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_proc_id_0), (MR_Word) (&transform_hlds__term_pass1_scalar_common_1[0]), HeadVar__4_4, ((MR_Box) (PPId_21)), &conv0_OutputSuppliers0_77);
        OutputSuppliers0_77 = ((MR_Word) (conv0_OutputSuppliers0_77));
        transform_hlds__term_pass1__update_output_suppliers_4_p_0(Args_58, AllActiveVars_76, OutputSuppliers0_77, &OutputSuppliers_78);
        mercury__map__det_update_4_p_0((MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_proc_id_0), (MR_Word) (&transform_hlds__term_pass1_scalar_common_1[0]), ((MR_Box) (PPId_21)), ((MR_Box) (OutputSuppliers_78)), HeadVar__4_4, &OutputSupplierMap_79);
        succeeded = mercury__bag__is_subbag_2_p_0((MR_Word) (&transform_hlds__term_pass1_scalar_common_1[1]), AllActiveVars_76, InVars_68);
        if (succeeded)
          SubsetErrors_80 = (MR_Word) ((MR_Unsigned) 0U);
        else
        {
          MR_Word SubsetErrorKind_81;
          MR_Word SubsetError_82;

          {
            SubsetErrorKind_81 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(3), SubsetErrorKind_81, 0) = ((MR_Box) ((MR_Unsigned) 2U));
            MR_hl_field(MR_mktag(3), SubsetErrorKind_81, 1) = ((MR_Box) (PPId_21));
            MR_hl_field(MR_mktag(3), SubsetErrorKind_81, 2) = ((MR_Box) (AllActiveVars_76));
            MR_hl_field(MR_mktag(3), SubsetErrorKind_81, 3) = ((MR_Box) (InVars_68));
          }
          {
            SubsetError_82 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
            MR_hl_field(MR_mktag(0), SubsetError_82, 0) = ((MR_Box) (Context_57));
            MR_hl_field(MR_mktag(0), SubsetError_82, 1) = ((MR_Box) (SubsetErrorKind_81));
          }
          {
            SubsetErrors_80 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), SubsetErrors_80, 0) = ((MR_Box) (SubsetError_82));
            MR_hl_field(MR_mktag(1), SubsetErrors_80, 1) = ((MR_Box) ((MR_Unsigned) 0U));
          }
        }
        {
          Result1_28 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), Result1_28, 0) = ((MR_Box) (PathList_75));
          MR_hl_field(MR_mktag(0), Result1_28, 1) = ((MR_Box) (OutputSupplierMap_79));
          MR_hl_field(MR_mktag(0), Result1_28, 2) = ((MR_Box) (SubsetErrors_80));
        }
      }
