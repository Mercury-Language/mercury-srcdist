      ...
      case (MR_Integer) 2:
        {
          ...
          if ((TerminationInfo_28 == (MR_Word) ((MR_Integer) 0)))
          ...
          case (MR_Integer) 0:
            {
              ...
              Context_84 = hlds__hlds_goal__goal_info_get_context_1_f_0(GoalInfo_13);
              {
                ...
                MR_hl_field(MR_mktag(0), Error_48, 1) = ((MR_Box) ((MR_Integer) 8));
              }
...
{
  {
    ...
    else
    {
      ...
      if ((SubsetErrors_16 == (MR_Word) ((MR_Integer) 0)))
        if ((Paths_14 == (MR_Word) ((MR_Integer) 0)))
        {
          MR_Word Context_19;
          ...
          transform_hlds__term_util__get_context_from_scc_3_p_0(ModuleInfo_6, SCC_8, &Context_19);
          {
            ...
            MR_hl_field(MR_mktag(0), ArgSizeError_20, 1) = ((MR_Box) ((MR_Integer) 16));
          }
          {
        ...
        else
        {
          ...
          if (succeeded)
          {
            ...
            if ((Soln_48 == (MR_Word) ((MR_Integer) 0)))
            {
              MR_Word Var_27;
              MR_Word Context_32;
              ...
              transform_hlds__term_util__get_context_from_scc_3_p_0(ModuleInfo_6, SCC_8, &Context_32);
              {
                ...
                MR_hl_field(MR_mktag(0), ArgSizeError_33, 1) = ((MR_Box) ((MR_Integer) 24));
              }
              {
          ...
          else
          {
            ...
            transform_hlds__term_util__get_context_from_scc_3_p_0(ModuleInfo_6, SCC_8, &Context_87);
            {
              ...
              MR_hl_field(MR_mktag(0), ArgSizeError_88, 1) = ((MR_Box) ((MR_Integer) 24));
            }
            {
  ...
  MR_Word * TermErrors_12)
{
  while (MR_TRUE)
  {
    ...
    // setup for model_det tailcalls optimized into a loop
    ;
    transform_hlds__term_pass1__find_arg_sizes_in_scc_pass_9_p_0(ModuleInfo_7, PassInfo_8, SCC_9, OutputSupplierMap0_10, (MR_Word) ((MR_Integer) 0), (MR_Word) ((MR_Integer) 0), &Result0_13, (MR_Word) ((MR_Integer) 0), &TermErrors0_14);
    ...
    else
    {
      ...
      if (((MR_tag((MR_Word) Result1_28)) == (MR_mktag((MR_Integer) 1))))
      {
        ...
        *Result_7 = Result1_28;
        ...
        mercury__list__foldl_4_p_0((MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_proc_id_0), (MR_Word) (&transform_hlds__term_pass1_scalar_common_1[2]), Var_45, PPIds_22, ((MR_Box) ((MR_Integer) 0)), &conv1_OtherTermErrors_34);
...
{
  {
    ...
    transform_hlds__term_util__partition_call_args_5_p_0(ModuleInfo_7, ArgModes_17, Args_16, &InVars_26, &OutVars_27);
    {
      ...
      MR_hl_field(MR_mktag(0), Path0_28, 1) = ((MR_Box) ((MR_Integer) 0));
      MR_hl_field(MR_mktag(0), Path0_28, 2) = ((MR_Box) ((MR_Integer) 0));
      MR_hl_field(MR_mktag(0), Path0_28, 3) = ((MR_Box) ((MR_Integer) 0));
    ...
    PathSet0_29 = mercury__set__make_singleton_set_1_f_0((MR_Word) (&transform_hlds__term_traversal__transform_hlds__term_traversal__type_ctor_info_term_path_info_0), ((MR_Box) (Path0_28)));
    {
      ...
      MR_hl_field(MR_mktag(0), Info0_30, 1) = ((MR_Box) ((MR_Integer) 0));
    }
    ...
    else
    {
      ...
      *TermErrors_12 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Info_31, (MR_Integer) 1))));
      ...
      if (succeeded)
        SubsetErrors_38 = (MR_Word) ((MR_Integer) 0);
      else
      {
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(1), SubsetErrors_38, 1) = ((MR_Box) ((MR_Integer) 0));
        }
      }
      {
        MR_Word base;
