          ...
          case (MR_Integer) 2:
            {
...

              {
                ...
                MR_hl_field(MR_mktag(0), Var_76, 5) = ((MR_Box) (VarTable_9));
              }
          ...
          case (MR_Integer) 4:
            {
...

              {
                ...
                MR_hl_field(MR_mktag(0), Var_74, 5) = ((MR_Box) (VarTable_9));
              }
          ...
          case (MR_Integer) 6:
            {
              ...
              }
              {
                ...
                MR_hl_field(MR_mktag(0), Var_72, 5) = ((MR_Box) (VarTable_9));
              }
  ...
  MR_Word * STATE_VARIABLE_TermErrors_9)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      MR_Word Goal_61;
      MR_Word EmptyMap_62;
      MR_Word FunctorInfo_63;
      MR_Integer MaxErrors_64;
      MR_Integer MaxPaths_65;
      MR_Word Params_66;
      MR_Word InVars_67;
      MR_Word OutVars_68;
      MR_Word Path0_69;
      ...
      hlds__hlds_module__module_info_pred_proc_info_4_p_0(ModuleInfo_1, PPId_21, &PredInfo_54, &ProcInfo_55);
      hlds__hlds_pred__pred_info_get_context_2_p_0(PredInfo_54, &Context_56);
      hlds__hlds_pred__proc_info_get_headvars_2_p_0(ProcInfo_55, &Args_57);
      hlds__hlds_pred__proc_info_get_argmodes_2_p_0(ProcInfo_55, &ArgModes_58);
      hlds__hlds_pred__proc_info_get_var_table_3_p_0(ModuleInfo_1, ProcInfo_55, &VarTable_59);
      hlds__hlds_pred__proc_info_get_goal_2_p_0(ProcInfo_55, &Goal0_60);
      Goal_61 = hlds__goal_util__maybe_strip_equality_pretest_1_f_0(Goal0_60);
      mercury__map__init_1_p_0((MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_proc_id_0), (MR_Word) (&transform_hlds__term_pass1_scalar_common_1[0]), &EmptyMap_62);
      FunctorInfo_63 = ((MR_Word) ((MR_hl_field(MR_mktag(0), PassInfo_2, (MR_Integer) 0))));
      MaxErrors_64 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), PassInfo_2, (MR_Integer) 1))));
      MaxPaths_65 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), PassInfo_2, (MR_Integer) 2))));
      transform_hlds__term_traversal__init_term_traversal_params_9_p_0(FunctorInfo_63, PPId_21, Context_56, VarTable_59, HeadVar__4_4, EmptyMap_62, MaxErrors_64, MaxPaths_65, &Params_66);
      transform_hlds__term_util__partition_call_args_5_p_0(ModuleInfo_1, ArgModes_58, Args_57, &InVars_67, &OutVars_68);
      {
        Path0_69 = (MR_Word) MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), Path0_69, 0) = ((MR_Box) (PPId_21));
        MR_hl_field(MR_mktag(0), Path0_69, 1) = ((MR_Box) ((MR_Unsigned) 0U));
        MR_hl_field(MR_mktag(0), Path0_69, 2) = ((MR_Box) ((MR_Integer) 0));
        MR_hl_field(MR_mktag(0), Path0_69, 3) = ((MR_Box) ((MR_Unsigned) 0U));
        MR_hl_field(MR_mktag(0), Path0_69, 4) = ((MR_Box) (OutVars_68));
      }
      PathSet0_70 = mercury__set__make_singleton_set_1_f_0((MR_Word) (&transform_hlds__term_traversal__transform_hlds__term_traversal__type_ctor_info_term_path_info_0), ((MR_Box) (Path0_69)));
      {
        Info0_71 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), Info0_71, 0) = ((MR_Box) (PathSet0_70));
        MR_hl_field(MR_mktag(0), Info0_71, 1) = ((MR_Box) ((MR_Unsigned) 0U));
      }
      transform_hlds__term_traversal__term_traverse_goal_5_p_0(ModuleInfo_1, Params_66, Goal_61, Info0_71, &Info_72);
      if (((MR_tag((MR_Word) Info_72)) == (MR_Integer) 1))
      {
        MR_Word Errors_82 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Info_72, (MR_Integer) 0))));

        ProcTermErrors_29 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Info_72, (MR_Integer) 1))));
        {
          Result1_28 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), Result1_28, 0) = ((MR_Box) (Errors_82));
        }
      }
      else
      {
        MR_Word Paths_73 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Info_72, (MR_Integer) 0))));
        MR_Word PathList_74;
        MR_Word AllActiveVars_75;
        MR_Word OutputSuppliers0_76;
        MR_Word OutputSuppliers_77;
        MR_Word OutputSupplierMap_78;
        MR_Word SubsetErrors_79;
        MR_Box conv0_OutputSuppliers0_76;

        ProcTermErrors_29 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Info_72, (MR_Integer) 1))));
        mercury__set__to_sorted_list_2_p_0((MR_Word) (&transform_hlds__term_traversal__transform_hlds__term_traversal__type_ctor_info_term_path_info_0), Paths_73, &PathList_74);
        transform_hlds__term_traversal__upper_bound_active_vars_2_p_0(PathList_74, &AllActiveVars_75);
        mercury__map__lookup_3_p_0((MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_proc_id_0), (MR_Word) (&transform_hlds__term_pass1_scalar_common_1[0]), HeadVar__4_4, ((MR_Box) (PPId_21)), &conv0_OutputSuppliers0_76);
        OutputSuppliers0_76 = ((MR_Word) (conv0_OutputSuppliers0_76));
        transform_hlds__term_pass1__update_output_suppliers_4_p_0(Args_57, AllActiveVars_75, OutputSuppliers0_76, &OutputSuppliers_77);
        mercury__map__det_update_4_p_0((MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_proc_id_0), (MR_Word) (&transform_hlds__term_pass1_scalar_common_1[0]), ((MR_Box) (PPId_21)), ((MR_Box) (OutputSuppliers_77)), HeadVar__4_4, &OutputSupplierMap_78);
        succeeded = mercury__bag__is_subbag_2_p_0((MR_Word) (&transform_hlds__term_pass1_scalar_common_1[1]), AllActiveVars_75, InVars_67);
        if (succeeded)
          SubsetErrors_79 = (MR_Word) ((MR_Unsigned) 0U);
        else
        {
          MR_Word SubsetErrorKind_80;
          MR_Word SubsetError_81;

          {
            SubsetErrorKind_80 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(3), SubsetErrorKind_80, 0) = ((MR_Box) ((MR_Unsigned) 2U));
            MR_hl_field(MR_mktag(3), SubsetErrorKind_80, 1) = ((MR_Box) (PPId_21));
            MR_hl_field(MR_mktag(3), SubsetErrorKind_80, 2) = ((MR_Box) (AllActiveVars_75));
            MR_hl_field(MR_mktag(3), SubsetErrorKind_80, 3) = ((MR_Box) (InVars_67));
          }
          {
            SubsetError_81 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
            MR_hl_field(MR_mktag(0), SubsetError_81, 0) = ((MR_Box) (Context_56));
            MR_hl_field(MR_mktag(0), SubsetError_81, 1) = ((MR_Box) (SubsetErrorKind_80));
          }
          {
            SubsetErrors_79 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), SubsetErrors_79, 0) = ((MR_Box) (SubsetError_81));
            MR_hl_field(MR_mktag(1), SubsetErrors_79, 1) = ((MR_Box) ((MR_Unsigned) 0U));
          }
        }
        {
          Result1_28 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), Result1_28, 0) = ((MR_Box) (PathList_74));
          MR_hl_field(MR_mktag(0), Result1_28, 1) = ((MR_Box) (OutputSupplierMap_78));
          MR_hl_field(MR_mktag(0), Result1_28, 2) = ((MR_Box) (SubsetErrors_79));
        }
      }
