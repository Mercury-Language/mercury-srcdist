...
{
  MR_Box closure = closure_arg;
  MR_Word conv0_STATE_VARIABLE_Errors_14;

  transform_hlds__term_pass1__check_proc_non_term_calls_4_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) (wrapper_arg_1)), ((MR_Word) (wrapper_arg_2)), &conv0_STATE_VARIABLE_Errors_14);
  *wrapper_arg_3 = ((MR_Box) (conv0_STATE_VARIABLE_Errors_14));
}
  ...
  MR_Word * TermErrors_12)
{
  ...
  MR_Word Goal_21;
  MR_Word EmptyMap_22;
  MR_Word FunctorInfo_23;
  MR_Integer MaxErrors_24;
  MR_Integer MaxPaths_25;
  MR_Word Params_26;
  MR_Word InVars_27;
  MR_Word OutVars_28;
  MR_Word Path0_29;
  ...
  hlds__hlds_pred__proc_info_get_varset_vartypes_3_p_0(ProcInfo_14, &_VarSet_18, &VarTypes_19);
  hlds__hlds_pred__proc_info_get_goal_2_p_0(ProcInfo_14, &Goal0_20);
  Goal_21 = hlds__goal_util__maybe_strip_equality_pretest_1_f_0(Goal0_20);
  mercury__map__init_1_p_0((MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_proc_id_0), (MR_Word) (&transform_hlds__term_pass1_scalar_common_1[0]), &EmptyMap_22);
  FunctorInfo_23 = ((MR_Word) ((MR_hl_field(MR_mktag(0), PassInfo_8, (MR_Integer) 0))));
  MaxErrors_24 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), PassInfo_8, (MR_Integer) 1))));
  MaxPaths_25 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), PassInfo_8, (MR_Integer) 2))));
  transform_hlds__term_traversal__init_term_traversal_params_9_p_0(FunctorInfo_23, PPId_9, Context_15, VarTypes_19, OutputSupplierMap0_10, EmptyMap_22, MaxErrors_24, MaxPaths_25, &Params_26);
  transform_hlds__term_util__partition_call_args_5_p_0(ModuleInfo_7, ArgModes_17, Args_16, &InVars_27, &OutVars_28);
  {
    Path0_29 = (MR_Word) MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(MR_mktag(0), Path0_29, 0) = ((MR_Box) (PPId_9));
    MR_hl_field(MR_mktag(0), Path0_29, 1) = ((MR_Box) ((MR_Unsigned) 0U));
    MR_hl_field(MR_mktag(0), Path0_29, 2) = ((MR_Box) ((MR_Integer) 0));
    MR_hl_field(MR_mktag(0), Path0_29, 3) = ((MR_Box) ((MR_Unsigned) 0U));
    MR_hl_field(MR_mktag(0), Path0_29, 4) = ((MR_Box) (OutVars_28));
  }
  PathSet0_30 = mercury__set__make_singleton_set_1_f_0((MR_Word) (&transform_hlds__term_traversal__transform_hlds__term_traversal__type_ctor_info_term_path_info_0), ((MR_Box) (Path0_29)));
  {
    Info0_31 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(MR_mktag(0), Info0_31, 0) = ((MR_Box) (PathSet0_30));
    MR_hl_field(MR_mktag(0), Info0_31, 1) = ((MR_Box) ((MR_Unsigned) 0U));
  }
  transform_hlds__term_traversal__term_traverse_goal_5_p_0(ModuleInfo_7, Params_26, Goal_21, Info0_31, &Info_32);
  if (((MR_tag((MR_Word) Info_32)) == (MR_Integer) 1))
  {
    MR_Word Errors_42 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Info_32, (MR_Integer) 0))));

    *TermErrors_12 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Info_32, (MR_Integer) 1))));
    {
      MR_Word base;
      base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
      *Result_11 = base;
      MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (Errors_42));
    }
  }
  else
  {
    MR_Word Paths_33 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Info_32, (MR_Integer) 0))));
    MR_Word PathList_34;
    MR_Word AllActiveVars_35;
    MR_Word OutputSuppliers0_36;
    MR_Word OutputSuppliers_37;
    MR_Word OutputSupplierMap_38;
    MR_Word SubsetErrors_39;
    MR_Box conv0_OutputSuppliers0_36;

    *TermErrors_12 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Info_32, (MR_Integer) 1))));
    mercury__set__to_sorted_list_2_p_0((MR_Word) (&transform_hlds__term_traversal__transform_hlds__term_traversal__type_ctor_info_term_path_info_0), Paths_33, &PathList_34);
    transform_hlds__term_traversal__upper_bound_active_vars_2_p_0(PathList_34, &AllActiveVars_35);
    mercury__map__lookup_3_p_0((MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_proc_id_0), (MR_Word) (&transform_hlds__term_pass1_scalar_common_1[0]), OutputSupplierMap0_10, ((MR_Box) (PPId_9)), &conv0_OutputSuppliers0_36);
    OutputSuppliers0_36 = ((MR_Word) (conv0_OutputSuppliers0_36));
    transform_hlds__term_pass1__update_output_suppliers_4_p_0(Args_16, AllActiveVars_35, OutputSuppliers0_36, &OutputSuppliers_37);
    mercury__map__det_update_4_p_0((MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_proc_id_0), (MR_Word) (&transform_hlds__term_pass1_scalar_common_1[0]), ((MR_Box) (PPId_9)), ((MR_Box) (OutputSuppliers_37)), OutputSupplierMap0_10, &OutputSupplierMap_38);
    succeeded = mercury__bag__is_subbag_2_p_0((MR_Word) (&transform_hlds__term_pass1_scalar_common_1[1]), AllActiveVars_35, InVars_27);
    if (succeeded)
      SubsetErrors_39 = (MR_Word) ((MR_Unsigned) 0U);
    else
    {
      MR_Word SubsetErrorKind_40;
      MR_Word SubsetError_41;

      {
        SubsetErrorKind_40 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(3), SubsetErrorKind_40, 0) = ((MR_Box) ((MR_Unsigned) 2U));
        MR_hl_field(MR_mktag(3), SubsetErrorKind_40, 1) = ((MR_Box) (PPId_9));
        MR_hl_field(MR_mktag(3), SubsetErrorKind_40, 2) = ((MR_Box) (AllActiveVars_35));
        MR_hl_field(MR_mktag(3), SubsetErrorKind_40, 3) = ((MR_Box) (InVars_27));
      }
      {
        SubsetError_41 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), SubsetError_41, 0) = ((MR_Box) (Context_15));
        MR_hl_field(MR_mktag(0), SubsetError_41, 1) = ((MR_Box) (SubsetErrorKind_40));
      }
      {
        SubsetErrors_39 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), SubsetErrors_39, 0) = ((MR_Box) (SubsetError_41));
        MR_hl_field(MR_mktag(1), SubsetErrors_39, 1) = ((MR_Box) ((MR_Unsigned) 0U));
      }
    }
    {
      MR_Word base;
      base = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
      *Result_11 = base;
      MR_hl_field(MR_mktag(0), base, 0) = ((MR_Box) (PathList_34));
      MR_hl_field(MR_mktag(0), base, 1) = ((MR_Box) (OutputSupplierMap_38));
      MR_hl_field(MR_mktag(0), base, 2) = ((MR_Box) (SubsetErrors_39));
    }
  }
}
