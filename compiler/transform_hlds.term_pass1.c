      ...
      case (MR_Integer) 2:
        {
          ...
          else
          {
            ...
            if (((MR_tag((MR_Word) Var_112)) == (MR_mktag((MR_Integer) 1))))
            {
          ...
          case (MR_Integer) 3:
            {
              ...
              {
                Var_109 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 6 * sizeof(MR_Word)), NULL, NULL);
                ...
                MR_hl_field(MR_mktag(0), Var_109, 2) = ((MR_Box) (MR_Word) ((MR_Integer) 3));
          ...
          case (MR_Integer) 6:
            {
              ...
              {
                Goals_85 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
