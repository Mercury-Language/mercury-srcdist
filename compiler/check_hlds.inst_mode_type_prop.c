    ...
    case (MR_Integer) 1:
      {
        ...
        if ((HOInstInfo0_18 == (MR_Word) ((MR_Unsigned) 0U)))
        {
          ...
          succeeded = parse_tree__prog_type__type_is_higher_order_details_5_p_0(Type_12, &Var_19, &Var_119, &ArgTypes_21);
          if (succeeded)
        ...
        else
        {
          ...
          succeeded = parse_tree__prog_type__type_is_higher_order_details_5_p_0(Type_12, &Var_28, &Var_120, &ArgTypes_77);
          if (succeeded)
          {
        ...
        case (MR_Integer) 2:
          {
            ...
            if ((HOInstInfo0_111 == (MR_Word) ((MR_Unsigned) 0U)))
            {
              ...
              succeeded = parse_tree__prog_type__type_is_higher_order_details_5_p_0(Type_12, &Var_34, &Var_121, &ArgTypes_80);
              if (succeeded)
            ...
            else
            {
              ...
              succeeded = parse_tree__prog_type__type_is_higher_order_details_5_p_0(Type_12, &Var_36, &Var_122, &ArgTypes_86);
              if (succeeded)
              {
      ...
      case (MR_Integer) 1:
        {
          ...
          if ((HOInstInfo0_20 == (MR_Word) ((MR_Unsigned) 0U)))
          {
            ...
            succeeded = parse_tree__prog_type__type_is_higher_order_details_5_p_0(Type_13, &Var_21, &Var_164, &ArgTypes_23);
            if (succeeded)
          ...
          else
          {
            ...
            succeeded = parse_tree__prog_type__type_is_higher_order_details_5_p_0(Type_13, &Var_34, &Var_165, &ArgTypes_99);
            if (succeeded)
            {
          ...
          case (MR_Integer) 2:
            {
              ...
              if ((HOInstInfo0_148 == (MR_Word) ((MR_Unsigned) 0U)))
              {
                ...
                succeeded = parse_tree__prog_type__type_is_higher_order_details_5_p_0(Type_13, &Var_40, &Var_166, &ArgTypes_106);
                if (succeeded)
              ...
              else
              {
                ...
                succeeded = parse_tree__prog_type__type_is_higher_order_details_5_p_0(Type_13, &Var_42, &Var_167, &ArgTypes_120);
                if (succeeded)
                {
