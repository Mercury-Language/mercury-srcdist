...
#line 55 "check_hlds.typeclasses.c"
...
#endif
#line 64 "check_hlds.typeclasses.c"
...
MR_decl_label3(check_hlds__typeclasses__add_superclass_proofs_4_0, 10,3,4)
MR_decl_label1(check_hlds__typeclasses__apply_class_rules_7_0, 2)
MR_decl_label8(check_hlds__typeclasses__apply_class_rules_2_8_0, 24,4,6,8,9,10,5,11)
...
MR_decl_label8(check_hlds__typeclasses__apply_instance_rules_2_15_0, 28,4,5,8,10,11,12,13)
MR_decl_label4(check_hlds__typeclasses__apply_instance_rules_2_15_0, 7,15,16,17)
...
MR_decl_label8(check_hlds__typeclasses__eliminate_assumed_constraints_2_6_0, 26,4,9,10,7,12,13,6)
...
MR_decl_label8(check_hlds__typeclasses__merge_adjacent_constraints_2_3_0, 27,3,5,7,9,10,4,12)
MR_decl_label8(check_hlds__typeclasses__perform_context_reduction_2_0, 2,3,4,5,9,10,6,12)
...
MR_BEGIN_MODULE(check_hlds__typeclasses_module0)
	...
	MR_init_label8(check_hlds__typeclasses__perform_context_reduction_2_0,2,3,4,5,9,10,6,12)
MR_BEGIN_CODE
...
MR_def_label(check_hlds__typeclasses__perform_context_reduction_2_0,10)
	...
	MR_np_call_localret_ent(list__map_3_0,
		check_hlds__typeclasses__perform_context_reduction_2_0_i12);
MR_def_label(check_hlds__typeclasses__perform_context_reduction_2_0,6)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(1) = MR_sv(3);
MR_def_label(check_hlds__typeclasses__perform_context_reduction_2_0,12)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
...
MR_BEGIN_MODULE(check_hlds__typeclasses_module1)
	...
	MR_init_label8(check_hlds__typeclasses__merge_adjacent_constraints_2_3_0,27,3,5,7,9,10,4,12)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(check_hlds__typeclasses_module5)
	...
	MR_init_label8(check_hlds__typeclasses__eliminate_assumed_constraints_2_6_0,26,4,9,10,7,12,13,6)
MR_BEGIN_CODE
...
MR_def_static(check_hlds__typeclasses__eliminate_assumed_constraints_2_6_0)
	...
	if (MR_LTAGS_TESTR(MR_r3,0,0)) {
		MR_GOTO_LAB(check_hlds__typeclasses__eliminate_assumed_constraints_2_6_0_i26);
	}
	MR_r1 = MR_r2;
	MR_r2 = (MR_Word) MR_tbmkword(0, 0);
	MR_r3 = (MR_Integer) 0;
	MR_proceed();
MR_def_label(check_hlds__typeclasses__eliminate_assumed_constraints_2_6_0,26)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(8);
	MR_sv(8) = (MR_Word) MR_succip;
	MR_sv(1) = MR_r1;
...
MR_BEGIN_MODULE(check_hlds__typeclasses_module8)
	...
	MR_init_label8(check_hlds__typeclasses__apply_instance_rules_2_15_0,28,4,5,8,10,11,12,13)
	MR_init_label4(check_hlds__typeclasses__apply_instance_rules_2_15_0,7,15,16,17)
MR_BEGIN_CODE
...
MR_def_static(check_hlds__typeclasses__apply_instance_rules_2_15_0)
	...
	if (MR_LTAGS_TESTR(MR_r8,0,0)) {
		MR_GOTO_LAB(check_hlds__typeclasses__apply_instance_rules_2_15_0_i28);
	}
	MR_r1 = MR_r3;
	MR_r2 = MR_r4;
	MR_r3 = MR_r5;
	...
	MR_r7 = (MR_Integer) 0;
	MR_proceed();
MR_def_label(check_hlds__typeclasses__apply_instance_rules_2_15_0,28)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(11);
...
MR_BEGIN_MODULE(check_hlds__typeclasses_module10)
	...
	MR_init_label3(check_hlds__typeclasses__add_superclass_proofs_4_0,10,3,4)
MR_BEGIN_CODE
...
MR_def_static(check_hlds__typeclasses__add_superclass_proofs_4_0)
	...
	MR_incr_sp(3);
	MR_sv(3) = (MR_Word) MR_succip;
MR_def_label(check_hlds__typeclasses__add_superclass_proofs_4_0,10)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r2,0,0)) {
...
MR_def_label(check_hlds__typeclasses__add_superclass_proofs_4_0,4)
	...
	MR_GOTO_LAB(check_hlds__typeclasses__add_superclass_proofs_4_0_i10);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_thread_engine_base
#endif
...
MR_BEGIN_MODULE(check_hlds__typeclasses_module11)
	...
	MR_init_label8(check_hlds__typeclasses__apply_class_rules_2_8_0,24,4,6,8,9,10,5,11)
MR_BEGIN_CODE
...
MR_def_static(check_hlds__typeclasses__apply_class_rules_2_8_0)
	...
	if (MR_LTAGS_TESTR(MR_r4,0,0)) {
		MR_GOTO_LAB(check_hlds__typeclasses__apply_class_rules_2_8_0_i24);
	}
	MR_r1 = MR_r2;
	MR_r2 = MR_r3;
	...
	MR_r4 = (MR_Integer) 0;
	MR_proceed();
MR_def_label(check_hlds__typeclasses__apply_class_rules_2_8_0,24)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(7);
	MR_sv(7) = (MR_Word) MR_succip;
	MR_sv(1) = MR_r1;
