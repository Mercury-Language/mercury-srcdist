  ...
  MR_Word * STATE_VARIABLE_Seen_40)
{
  while (MR_TRUE)
  {
    ...
    // setup for model_det tailcalls optimized into a loop
    ;
    hlds__type_util__apply_rec_subst_to_constraints_3_p_0(STATE_VARIABLE_Bindings_0_29, STATE_VARIABLE_Constraints_0_37, &STATE_VARIABLE_Constraints_1_41);
    ...
    switch (AppliedImprovementRule_25) {
      ...
      case (MR_Integer) 0:
        ...
        break;
      case (MR_Integer) 1:
        hlds__type_util__apply_rec_subst_to_constraints_3_p_0(STATE_VARIABLE_Bindings_1_43, STATE_VARIABLE_Constraints_1_41, &STATE_VARIABLE_Constraints_2_44);
        break;
    }
