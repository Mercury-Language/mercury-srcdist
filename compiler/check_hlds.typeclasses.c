        ...
        if (check_hlds__typeclasses__succeeded)
          {
            ...
            }
            {
              ...
              MR_hl_field(MR_mktag(0), check_hlds__typeclasses__Var_69, 0) = ((MR_Box) (&check_hlds__typeclasses_scalar_common_8[0]));
...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(0), check_hlds__typeclasses__Var_31, 0) = ((MR_Box) (&check_hlds__typeclasses_scalar_common_7[0]));
