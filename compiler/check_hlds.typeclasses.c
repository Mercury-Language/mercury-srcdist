  ...
  MR_Word * STATE_VARIABLE_Changed_26)
{
  ...
  if (succeeded)
  {
    ...
    if (succeeded)
    {
      ...
      succeeded = parse_tree__prog_type_unify__type_unify_list_5_p_0(RTypesA_40, RTypesB_41, ExternalTypeParams_11, STATE_VARIABLE_Bindings_0_23, &STATE_VARIABLE_Bindings_27_27);
    }
  }
  if (succeeded)
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          succeeded = parse_tree__prog_type_unify__type_unify_list_5_p_0(RTypesA_48, RTypesB_49, ExternalTypeParams_4, STATE_VARIABLE_Bindings_0_5, &STATE_VARIABLE_Bindings_27_39);
        }
      }
      if (succeeded)
      {
  ...
  MR_Word * STATE_VARIABLE_Seen_40)
{
  while (MR_TRUE)
  {
    ...
    Redundant_58 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_Constraints_41_41, 2))));
    ...
    RedundantConstraints_69 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_Constraints_41_41, 2))));
    ...
    Unproven0_81 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_Constraints_44_44, 0))));
    Assumed_87 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_Constraints_44_44, 1))));
    Redundant0_88 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_Constraints_44_44, 2))));
    Ancestors_95 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_Constraints_44_44, 3))));
    ...
    Var_98 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_Constraints_51_51, 1))));
    Var_99 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_Constraints_51_51, 2))));
    Var_100 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_Constraints_51_51, 3))));
    {
    ...
    if (succeeded)
    {
      MR_Word Unproven0_101 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_Constraints_54_54, 0))));
      ...
      Var_109 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_Constraints_54_54, 1))));
      Var_110 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_Constraints_54_54, 2))));
      Var_111 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_Constraints_54_54, 3))));
      {
        MR_Word base;
