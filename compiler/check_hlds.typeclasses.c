  ...
  MR_Word * STATE_VARIABLE_Changed_26)
{
  ...
  mercury__map__init_1_p_0((MR_Word) (&check_hlds__typeclasses_scalar_common_1[4]), (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0), &Subst0_37);
  ...
  if (succeeded)
  {
    ...
    parse_tree__prog_type__type_vars_in_types_2_p_0(RTypesB_45, &RTypesBVars_46);
    TypeInfo_14_49 = (MR_Word) (&check_hlds__typeclasses_scalar_common_1[4]);
  ...
  MR_Word * STATE_VARIABLE_Changed_8)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      succeeded = mercury__builtin__unify_2_p_0((MR_Word) (&check_hlds__typeclasses_scalar_common_1[7]), ((MR_Box) (RTypesA_57)), ((MR_Box) (RTypesB_58)));
      if (succeeded)
      {
        ...
        TypeInfo_10_67 = (MR_Word) (&check_hlds__typeclasses_scalar_common_1[7]);
  ...
  MR_Word * Changed_16)
{
  ...
  mercury__map__keys_2_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_class_id_0), (MR_Word) (&check_hlds__typeclasses_scalar_common_1[2]), Redundant_33, &ClassIds_34);
  {
  ...
  mercury__map__keys_2_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_class_id_0), (MR_Word) (&check_hlds__typeclasses_scalar_common_1[2]), RedundantConstraints_61, &ClassIds_62);
  {
