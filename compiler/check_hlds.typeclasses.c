  ...
  MR_Word * STATE_VARIABLE_UnsatTypeAssignSet_33)
{
  ...
  else
  {
    ...
    if (succeeded)
    {
      *STATE_VARIABLE_TypeAssignCord_31 = mercury__cord__snoc_2_f_0((MR_Word) (&check_hlds__type_assign__check_hlds__type_assign__type_ctor_info_type_assign_0), STATE_VARIABLE_TypeAssignCord_0_30, ((MR_Box) (STATE_VARIABLE_TypeAssign_1_35)));
      *STATE_VARIABLE_UnsatTypeAssignSet_33 = STATE_VARIABLE_UnsatTypeAssignSet_0_32;
    }
    else
    {
