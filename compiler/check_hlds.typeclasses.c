...
{
  {
    ...
    hlds__hlds_class__make_hlds_constraints_5_p_0(ClassTable_14, TVarSet_25, (MR_Word) ((MR_Unsigned) 0U), Var_39, &Constraints_26);
...
{
  {
    ...
    RTypesA_34 = hlds__hlds_class__restrict_list_elements_2_f_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0), Domain_18, InstanceTypes0_10);
    RTypesB_35 = hlds__hlds_class__restrict_list_elements_2_f_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0), Domain_18, ConstraintTypes_17);
    parse_tree__prog_type__type_vars_list_2_p_0(RTypesB_35, &RTypesBVars_36);
    mercury__map__init_1_p_0((MR_Word) (&check_hlds__typeclasses_scalar_common_1[3]), (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0), &Subst0_37);
...
{
  {
    ...
    mercury__map__lookup_3_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_class_id_0), (MR_Word) (&check_hlds__typeclasses_scalar_common_1[5]), InstanceTable_13, ((MR_Box) (ClassId_16)), &conv1_InstanceDefns_22);
    InstanceDefns_22 = ((MR_Word) (conv1_InstanceDefns_22));
    mercury__map__lookup_3_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_class_id_0), (MR_Word) (&check_hlds__typeclasses_scalar_common_1[1]), RedundantConstraints_15, ((MR_Box) (ClassId_16)), &conv2_ConstraintSet_23);
...
{
  {
    ...
    mercury__map__lookup_3_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_class_id_0), (MR_Word) (&check_hlds__typeclasses_scalar_common_1[1]), RedundantConstraints_11, ((MR_Box) (ClassId_12)), &conv1_ConstraintSet_17);
  ...
  MR_Word * STATE_VARIABLE_Changed_8)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      RTypesA_57 = hlds__hlds_class__restrict_list_elements_2_f_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0), Domain_49, TypesA_45);
      RTypesB_58 = hlds__hlds_class__restrict_list_elements_2_f_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0), Domain_49, TypesB_48);
...
{
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        TypeCtorInfo_45_45 = (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_class_id_0);
        TypeInfo_46_46 = (MR_Word) (&check_hlds__typeclasses_scalar_common_1[1]);
        succeeded = mercury__map__is_empty_1_p_0(TypeCtorInfo_45_45, TypeInfo_46_46, Redundant0_16);
        if (succeeded)
        {
          TypeCtorInfo_47_47 = (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_constraint_0);
          TypeInfo_48_48 = (MR_Word) (&check_hlds__typeclasses_scalar_common_1[2]);
          succeeded = mercury__map__is_empty_1_p_0(TypeCtorInfo_47_47, TypeInfo_48_48, Ancestors0_17);
        }
      }
    }
    if (succeeded)
    ...
    else
    {
      ...
      MR_Word Unproven_28;
      MR_Word STATE_VARIABLE_TypeAssign_37_37;
      MR_Word Var_75;
      MR_Word Var_69;
      ...
      Var_75 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Constraints0_13, (MR_Integer) 0))));
      check_hlds__typeclasses__reduce_context_by_rule_application_2_15_p_0(ClassTable_8, InstanceTable_9, ExternalTypeParams_18, Bindings0_20, &Bindings_23, TVarSet0_19, &TVarSet_24, ProofMap0_21, &ProofMap_25, ConstraintMap0_22, &ConstraintMap_26, Constraints0_13, &Constraints_27, Var_75, &Var_69);
      check_hlds__type_assign__type_assign_set_reduce_results_7_p_0(TVarSet_24, Bindings_23, Constraints_27, ProofMap_25, ConstraintMap_26, STATE_VARIABLE_TypeAssign_0_29, &STATE_VARIABLE_TypeAssign_37_37);
      ...
      if (succeeded)
      {
...

        {
          ...
          MR_hl_field(MR_mktag(1), Var_39, 0) = ((MR_Box) (STATE_VARIABLE_TypeAssign_37_37));
      ...
      {
        {
          ...
          *STATE_VARIABLE_UnsatTypeAssignSet_33 = base;
          MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (STATE_VARIABLE_TypeAssign_37_37));
  ...
  MR_Word * STATE_VARIABLE_Seen_40)
{
  while (MR_TRUE)
  {
    ...
    if (succeeded)
    {
      ...
      if ((Unproven1_80 == (MR_Word) ((MR_Unsigned) 0U)))
        Unproven_81 = (MR_Word) ((MR_Unsigned) 0U);
      else
      {
  ...
  MR_Word * NewConstraints_15)
{
  while (MR_TRUE)
  {
    ...
    if (succeeded)
    {
      ...
      {
        MR_Integer InstanceNum_30 = (MR_Integer) ((MR_Unsigned) InstanceNum0_11 + (MR_Unsigned) (MR_Integer) 1);
...
{
  {
    ...
    mercury__map__keys_2_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_class_id_0), (MR_Word) (&check_hlds__typeclasses_scalar_common_1[1]), Redundant_33, &ClassIds_34);
    {
    ...
    mercury__list__foldl2_6_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_class_id_0), (MR_Word) (&check_hlds__typeclasses_scalar_common_2[0]), (MR_Word) (&mercury__bool__bool__type_ctor_info_bool_0), Var_35, ClassIds_34, ((MR_Box) (STATE_VARIABLE_Bindings_0_21)), &conv3_STATE_VARIABLE_Bindings_23_23, ((MR_Box) ((MR_Integer) 0)), &conv2_Changed1_17);
    ...
    mercury__map__keys_2_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_class_id_0), (MR_Word) (&check_hlds__typeclasses_scalar_common_1[1]), RedundantConstraints_61, &ClassIds_62);
    {
...
{
  {
    ...
    if (succeeded)
    {
      ...
      {
        DeleteConstraints_21 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
        ...
        MR_hl_field(MR_mktag(0), DeleteConstraints_21, 2) = ((MR_Box) ((MR_Integer) 1));
        MR_hl_field(MR_mktag(0), DeleteConstraints_21, 3) = ((MR_Box) (ClassTable_14));
      }
      mercury__list__map_3_p_0((MR_Word) (&check_hlds__type_assign__check_hlds__type_assign__type_ctor_info_type_assign_0), (MR_Word) (&check_hlds__type_assign__check_hlds__type_assign__type_ctor_info_type_assign_0), DeleteConstraints_21, TypeAssignSet0_7, TypeAssignSet_8);
    }
    else
    {
