  ...
  MR_Word * STATE_VARIABLE_Changed_26)
{
  ...
  if (succeeded)
  {
    ...
    if (succeeded)
    {
      ...
      RTypesA_40 = hlds__hlds_class__restrict_list_elements_2_f_0(TypeCtorInfo_17_42, Range_19, InstanceTypes_21);
      RTypesB_41 = hlds__hlds_class__restrict_list_elements_2_f_0(TypeCtorInfo_17_42, Range_19, ConstraintTypes_17);
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          TypeCtorInfo_17_50 = (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0);
          RTypesA_48 = hlds__hlds_class__restrict_list_elements_2_f_0(TypeCtorInfo_17_50, Range_38, TypesA_33);
          RTypesB_49 = hlds__hlds_class__restrict_list_elements_2_f_0(TypeCtorInfo_17_50, Range_38, TypesB_36);
