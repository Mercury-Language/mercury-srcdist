...
MR_decl_label3(check_hlds__typeclasses__IntroducedFrom__pred__perform_context_reduction__122__1_3_0, 2,3,4)
...
MR_decl_static(check_hlds__typeclasses__IntroducedFrom__pred__perform_context_reduction__122__1_3_0)
...
MR_def_label(check_hlds__typeclasses__perform_context_reduction_2_0,11)
	...
	MR_tfield(0, MR_tempr1, 1) = (MR_Word) MR_ENTRY_AP(check_hlds__typeclasses__IntroducedFrom__pred__perform_context_reduction__122__1_3_0);
...
MR_BEGIN_MODULE(check_hlds__typeclasses_module24)
	MR_init_entry1(check_hlds__typeclasses__IntroducedFrom__pred__perform_context_reduction__122__1_3_0);
	MR_INIT_PROC_LAYOUT_ADDR(mercury__check_hlds__typeclasses__IntroducedFrom__pred__perform_context_reduction__122__1_3_0);
	MR_init_label3(check_hlds__typeclasses__IntroducedFrom__pred__perform_context_reduction__122__1_3_0,2,3,4)
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'IntroducedFrom__pred__perform_context_reduction__122__1'/3 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(check_hlds__typeclasses__IntroducedFrom__pred__perform_context_reduction__122__1_3_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(4);
	MR_sv(4) = (MR_Word) MR_succip;
	MR_sv(1) = MR_r1;
	...
	MR_r1 = MR_r2;
	MR_np_call_localret_ent(check_hlds__typecheck_info__type_assign_get_typeclass_constraints_2_0,
		check_hlds__typeclasses__IntroducedFrom__pred__perform_context_reduction__122__1_3_0_i2);
MR_def_label(check_hlds__typeclasses__IntroducedFrom__pred__perform_context_reduction__122__1_3_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(2) = MR_r1;
	MR_r1 = MR_sv(3);
	MR_np_call_localret_ent(check_hlds__typecheck_info__type_assign_get_typevarset_2_0,
		check_hlds__typeclasses__IntroducedFrom__pred__perform_context_reduction__122__1_3_0_i3);
MR_def_label(check_hlds__typeclasses__IntroducedFrom__pred__perform_context_reduction__122__1_3_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
	...
	MR_np_call_localret_ent(hlds__hlds_data__make_hlds_constraints_5_0,
		check_hlds__typeclasses__IntroducedFrom__pred__perform_context_reduction__122__1_3_0_i4);
MR_def_label(check_hlds__typeclasses__IntroducedFrom__pred__perform_context_reduction__122__1_3_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_sv(3);
	MR_succip_word = MR_sv(4);
	MR_decr_sp(4);
