...
MR_decl_label3(check_hlds__typeclasses__IntroducedFrom__pred__perform_context_reduction__125__1_3_0, 2,3,4)
...
MR_decl_label8(check_hlds__typeclasses__apply_class_rules_2_8_0, 26,4,7,9,10,11,5,12)
...
MR_decl_label10(check_hlds__typeclasses__apply_instance_rules_2_15_0, 32,4,7,10,12,14,15,16,9,19)
...
MR_decl_label8(check_hlds__typeclasses__eliminate_assumed_constraints_2_6_0, 27,4,9,10,7,12,13,6)
...
MR_decl_label8(check_hlds__typeclasses__merge_adjacent_constraints_2_3_0, 30,3,6,8,10,11,5,14)
MR_decl_label7(check_hlds__typeclasses__perform_context_reduction_2_0, 2,3,6,10,11,7,14)
MR_decl_label10(check_hlds__typeclasses__reduce_context_by_rule_application_2_15_0, 35,2,3,5,6,4,7,9,10,16)
MR_decl_label1(check_hlds__typeclasses__reduce_context_by_rule_application_2_15_0, 11)
...
MR_decl_label3(check_hlds__typeclasses__sort_and_merge_dups_2_0, 3,5,4)
...
MR_decl_static(check_hlds__typeclasses__IntroducedFrom__pred__perform_context_reduction__125__1_3_0)
...
MR_def_label(check_hlds__typeclasses__perform_context_reduction_2_0,11)
	...
	MR_tfield(0, MR_tempr1, 1) = (MR_Word) MR_ENTRY_AP(check_hlds__typeclasses__IntroducedFrom__pred__perform_context_reduction__125__1_3_0);
...
MR_BEGIN_MODULE(check_hlds__typeclasses_module1)
	...
	MR_init_label8(check_hlds__typeclasses__merge_adjacent_constraints_2_3_0,30,3,6,8,10,11,5,14)
MR_BEGIN_CODE
...
MR_def_label(check_hlds__typeclasses__merge_adjacent_constraints_2_3_0,30)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_def_label(check_hlds__typeclasses__merge_adjacent_constraints_2_3_0,11)
	...
	MR_GOTO_LAB(check_hlds__typeclasses__merge_adjacent_constraints_2_3_0_i30);
	}
...
MR_BEGIN_MODULE(check_hlds__typeclasses_module2)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__check_hlds__typeclasses__sort_and_merge_dups_2_0);
	MR_init_label3(check_hlds__typeclasses__sort_and_merge_dups_2_0,3,5,4)
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'sort_and_merge_dups'/2 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
...
MR_def_label(check_hlds__typeclasses__sort_and_merge_dups_2_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
		MR_GOTO_LAB(check_hlds__typeclasses__sort_and_merge_dups_2_0_i5);
	}
	MR_r1 = (MR_Word) MR_tbmkword(0, 0);
	MR_GOTO_LAB(check_hlds__typeclasses__sort_and_merge_dups_2_0_i4);
MR_def_label(check_hlds__typeclasses__sort_and_merge_dups_2_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
	...
	MR_np_call_localret_ent(check_hlds__typeclasses__merge_adjacent_constraints_2_3_0,
		check_hlds__typeclasses__sort_and_merge_dups_2_0_i4);
...
MR_BEGIN_MODULE(check_hlds__typeclasses_module5)
	...
	MR_init_label8(check_hlds__typeclasses__eliminate_assumed_constraints_2_6_0,27,4,9,10,7,12,13,6)
MR_BEGIN_CODE
...
MR_def_static(check_hlds__typeclasses__eliminate_assumed_constraints_2_6_0)
	...
	if (MR_LTAGS_TESTR(MR_r3,0,0)) {
		MR_GOTO_LAB(check_hlds__typeclasses__eliminate_assumed_constraints_2_6_0_i27);
	}
	MR_r1 = MR_r2;
	MR_r2 = (MR_Word) MR_tbmkword(0, 0);
	MR_r3 = (MR_Integer) 0;
	MR_proceed();
MR_def_label(check_hlds__typeclasses__eliminate_assumed_constraints_2_6_0,27)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(8);
	MR_sv(8) = (MR_Word) MR_succip;
	MR_sv(1) = MR_r1;
...
MR_BEGIN_MODULE(check_hlds__typeclasses_module8)
	...
	MR_init_label10(check_hlds__typeclasses__apply_instance_rules_2_15_0,32,4,7,10,12,14,15,16,9,19)
...
MR_def_static(check_hlds__typeclasses__apply_instance_rules_2_15_0)
	...
	if (MR_LTAGS_TESTR(MR_r8,0,0)) {
		MR_GOTO_LAB(check_hlds__typeclasses__apply_instance_rules_2_15_0_i32);
	}
	MR_r1 = MR_r3;
	MR_r2 = MR_r4;
	MR_r3 = MR_r5;
	...
	MR_r7 = (MR_Integer) 0;
	MR_proceed();
MR_def_label(check_hlds__typeclasses__apply_instance_rules_2_15_0,32)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(11);
...
MR_BEGIN_MODULE(check_hlds__typeclasses_module11)
	...
	MR_init_label8(check_hlds__typeclasses__apply_class_rules_2_8_0,26,4,7,9,10,11,5,12)
MR_BEGIN_CODE
...
MR_def_static(check_hlds__typeclasses__apply_class_rules_2_8_0)
	...
	if (MR_LTAGS_TESTR(MR_r4,0,0)) {
		MR_GOTO_LAB(check_hlds__typeclasses__apply_class_rules_2_8_0_i26);
	}
	MR_r1 = MR_r2;
	MR_r2 = MR_r3;
	...
	MR_r4 = (MR_Integer) 0;
	MR_proceed();
MR_def_label(check_hlds__typeclasses__apply_class_rules_2_8_0,26)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(7);
	MR_sv(7) = (MR_Word) MR_succip;
	MR_sv(1) = MR_r1;
...
MR_BEGIN_MODULE(check_hlds__typeclasses_module13)
	...
	MR_init_label10(check_hlds__typeclasses__reduce_context_by_rule_application_2_15_0,35,2,3,5,6,4,7,9,10,16)
	MR_init_label1(check_hlds__typeclasses__reduce_context_by_rule_application_2_15_0,11)
MR_BEGIN_CODE
...
MR_def_label(check_hlds__typeclasses__reduce_context_by_rule_application_2_15_0,35)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(1) = MR_r1;
	MR_sv(2) = MR_r2;
	MR_sv(3) = MR_r3;
...
MR_def_label(check_hlds__typeclasses__reduce_context_by_rule_application_2_15_0,10)
	...
	MR_np_call_localret_ent(check_hlds__typeclasses__sort_and_merge_dups_2_0,
		check_hlds__typeclasses__reduce_context_by_rule_application_2_15_0_i16);
MR_def_label(check_hlds__typeclasses__reduce_context_by_rule_application_2_15_0,16)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
...
MR_def_label(check_hlds__typeclasses__reduce_context_by_rule_application_2_15_0,11)
	...
	MR_GOTO_LAB(check_hlds__typeclasses__reduce_context_by_rule_application_2_15_0_i35);
	}
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_thread_engine_base
...
MR_BEGIN_MODULE(check_hlds__typeclasses_module25)
	MR_init_entry1(check_hlds__typeclasses__IntroducedFrom__pred__perform_context_reduction__125__1_3_0);
	MR_INIT_PROC_LAYOUT_ADDR(mercury__check_hlds__typeclasses__IntroducedFrom__pred__perform_context_reduction__125__1_3_0);
	MR_init_label3(check_hlds__typeclasses__IntroducedFrom__pred__perform_context_reduction__125__1_3_0,2,3,4)
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'IntroducedFrom__pred__perform_context_reduction__125__1'/3 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(check_hlds__typeclasses__IntroducedFrom__pred__perform_context_reduction__125__1_3_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(4);
	MR_sv(4) = (MR_Word) MR_succip;
	MR_sv(1) = MR_r1;
	...
	MR_r1 = MR_r2;
	MR_np_call_localret_ent(check_hlds__typecheck_info__type_assign_get_typeclass_constraints_2_0,
		check_hlds__typeclasses__IntroducedFrom__pred__perform_context_reduction__125__1_3_0_i2);
MR_def_label(check_hlds__typeclasses__IntroducedFrom__pred__perform_context_reduction__125__1_3_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(2) = MR_r1;
	MR_r1 = MR_sv(3);
	MR_np_call_localret_ent(check_hlds__typecheck_info__type_assign_get_typevarset_2_0,
		check_hlds__typeclasses__IntroducedFrom__pred__perform_context_reduction__125__1_3_0_i3);
MR_def_label(check_hlds__typeclasses__IntroducedFrom__pred__perform_context_reduction__125__1_3_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
	...
	MR_np_call_localret_ent(hlds__hlds_data__make_hlds_constraints_5_0,
		check_hlds__typeclasses__IntroducedFrom__pred__perform_context_reduction__125__1_3_0_i4);
MR_def_label(check_hlds__typeclasses__IntroducedFrom__pred__perform_context_reduction__125__1_3_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_sv(3);
	MR_succip_word = MR_sv(4);
	MR_decr_sp(4);
