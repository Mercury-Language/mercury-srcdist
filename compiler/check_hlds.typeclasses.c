...
check_hlds__typeclasses__do_instance_improvement_3_10_p_0(
  ...
  MR_Word * STATE_VARIABLE_Changed_29)
{
  MR_Word InstanceTVarSet_18 = ((MR_Word) ((MR_hl_field(0, InstanceDefn_14, (MR_Integer) 9))));
  MR_Word InstanceTypes0_19 = ((MR_Word) ((MR_hl_field(0, InstanceDefn_14, (MR_Integer) 1))));
  ...
  MR_Word * STATE_VARIABLE_Changed_30)
{
  ...
  FunDeps_21 = ((MR_Word) ((MR_hl_field(0, ClassDefn_20, (MR_Integer) 2))));
  ...
  MR_Word * STATE_VARIABLE_Changed_22)
{
  ...
  FunDeps_16 = ((MR_Word) ((MR_hl_field(0, ClassDefn_15, (MR_Integer) 2))));
  ...
  MR_Word * STATE_VARIABLE_Seen_40)
{
  while (MR_TRUE)
  {
    ...
    mercury__map__keys_2_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_class_id_0), (MR_Word) (&check_hlds__typeclasses_scalar_common_1[2]), Redundant_58, &ClassIds_59);
    {
      ...
      MR_hl_field(0, Var_60, 4) = ((MR_Box) (ExternalTypeParams_18));
    ...
    mercury__map__keys_2_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_class_id_0), (MR_Word) (&check_hlds__typeclasses_scalar_common_1[2]), RedundantConstraints_69, &ClassIds_70);
    {
      ...
      MR_hl_field(0, Var_71, 5) = ((MR_Box) (ExternalTypeParams_18));
  ...
  MR_Word * NewConstraints_15)
{
  while (MR_TRUE)
  {
    ...
    if (succeeded)
    {
      ...
      InstanceTypes0_20 = ((MR_Word) ((MR_hl_field(0, Instance_9, (MR_Integer) 1))));
      ProgConstraints0_19 = ((MR_Word) ((MR_hl_field(0, Instance_9, (MR_Integer) 6))));
      InstanceTVarSet_21 = ((MR_Word) ((MR_hl_field(0, Instance_9, (MR_Integer) 9))));
