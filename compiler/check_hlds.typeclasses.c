...
static void MR_CALL 
check_hlds__typeclasses__IntroducedFrom__pred__perform_context_reduction__133__1_3_p_0(
...
check_hlds__typeclasses__reduce_context_by_rule_application_2_15_p_0(
  ...
  MR_Word STATE_VARIABLE_ConstraintDb_0_37,
  MR_Word * STATE_VARIABLE_ConstraintDb_38,
...
check_hlds__typeclasses__IntroducedFrom__pred__perform_context_reduction__133__1_3_p_0(
  ...
  MR_Word * LambdaHeadVar__2_38)
{
  MR_Word ConstraintDb0_25;
  MR_Word TVarSet_26;
  MR_Word ConstraintDb_27;
  MR_Word Var_40;

  check_hlds__type_assign__type_assign_get_constraint_db_2_p_0(LambdaHeadVar__1_37, &ConstraintDb0_25);
  check_hlds__type_assign__type_assign_get_typevarset_2_p_0(LambdaHeadVar__1_37, &TVarSet_26);
  Var_40 = ((MR_Word) ((MR_hl_field(0, ConstraintDb0_25, 1))));
  hlds__hlds_class__make_hlds_constraint_db_5_p_0(ClassTable_14, TVarSet_26, (MR_Word) ((MR_Unsigned) 0U), Var_40, &ConstraintDb_27);
  check_hlds__type_assign__type_assign_set_constraint_db_3_p_0(ConstraintDb_27, LambdaHeadVar__1_37, LambdaHeadVar__2_38);
}
...
{
  MR_bool succeeded;
  MR_Word ConstraintTypes_17 = ((MR_Word) ((MR_hl_field(0, Constraint_9, 2))));
  ...
  parse_tree__prog_type_scan__type_vars_in_types_2_p_0(RTypesB_29, &RTypesBVars_30);
  ...
  succeeded = parse_tree__prog_type_unify__type_unify_list_5_p_0(RTypesA_28, RTypesB_29, RTypesBVars_30, Subst0_31, &Subst_20);
  if (succeeded)
  {
    parse_tree__prog_type_subst__apply_rec_subst_to_types_3_p_0(Subst_20, InstanceTypes0_10, &InstanceTypes_21);
    ...
    parse_tree__prog_type_scan__type_vars_in_types_2_p_0(RTypesB_35, &RTypesBVars_36);
    ...
    succeeded = parse_tree__prog_type_unify__type_unify_list_5_p_0(RTypesA_34, RTypesB_35, RTypesBVars_36, Subst0_37, &Var_22);
    succeeded = !(succeeded);
    if (succeeded)
    {
      ...
      succeeded = parse_tree__prog_type_unify__type_unify_list_5_p_0(RTypesA_40, RTypesB_41, ExternalTypeParams_11, STATE_VARIABLE_Bindings_0_23, &STATE_VARIABLE_Bindings_1_27);
    }
  }
  if (succeeded)
  {
    *STATE_VARIABLE_Bindings_24 = STATE_VARIABLE_Bindings_1_27;
  ...
  MR_Box * wrapper_arg_5)
{
  ...
  check_hlds__typeclasses__do_instance_improvement_fundep_8_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) ((MR_hl_field(0, closure, 4)))), ((MR_Word) ((MR_hl_field(0, closure, 5)))), ((MR_Word) (wrapper_arg_1)), ((MR_Word) (wrapper_arg_2)), &conv1_STATE_VARIABLE_Bindings_24, ((MR_Word) (wrapper_arg_4)), &conv0_STATE_VARIABLE_Changed_26);
  ...
  MR_Box * wrapper_arg_5)
{
  ...
  check_hlds__typeclasses__do_instance_improvement_4_8_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) ((MR_hl_field(0, closure, 4)))), ((MR_Word) ((MR_hl_field(0, closure, 5)))), ((MR_Word) (wrapper_arg_1)), ((MR_Word) (wrapper_arg_2)), &conv1_STATE_VARIABLE_Bindings_16, ((MR_Word) (wrapper_arg_4)), &conv0_STATE_VARIABLE_Changed_18);
...
check_hlds__typeclasses__do_instance_improvement_3_10_p_0(
  ...
  MR_Word * STATE_VARIABLE_Changed_29)
{
  MR_Word InstanceTVarSet_18 = ((MR_Word) ((MR_hl_field(0, InstanceDefn_14, 2))));
  MR_Word InstanceTypes0_19 = ((MR_Word) ((MR_hl_field(0, InstanceDefn_14, 4))));
  ...
  parse_tree__prog_type_subst__apply_renaming_to_types_3_p_0(Renaming_21, InstanceTypes0_19, &InstanceTypes_22);
  {
  ...
  MR_Box * wrapper_arg_7)
{
  ...
  check_hlds__typeclasses__do_instance_improvement_3_10_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) ((MR_hl_field(0, closure, 4)))), ((MR_Word) ((MR_hl_field(0, closure, 5)))), ((MR_Word) (wrapper_arg_1)), ((MR_Word) (wrapper_arg_2)), &conv5_STATE_VARIABLE_TVarSet_25, ((MR_Word) (wrapper_arg_4)), &conv4_STATE_VARIABLE_Bindings_27, ((MR_Word) (wrapper_arg_6)), &conv3_STATE_VARIABLE_Changed_29);
  ...
  MR_Word * STATE_VARIABLE_Changed_30)
{
  ...
  FunDeps_21 = ((MR_Word) ((MR_hl_field(0, ClassDefn_20, 5))));
  ...
  MR_Word * STATE_VARIABLE_Changed_22)
{
  ...
  FunDeps_16 = ((MR_Word) ((MR_hl_field(0, ClassDefn_15, 5))));
  ...
  MR_Word * STATE_VARIABLE_Changed_7)
{
  while (MR_TRUE)
  {
    ...
    {
      MR_Word Constraint_16 = ((MR_Word) ((MR_hl_field(1, HeadVar__1_1, 0))));
      MR_Word Constraints_17 = ((MR_Word) ((MR_hl_field(1, HeadVar__1_1, 1))));
      MR_Word STATE_VARIABLE_Bindings_1_26;
      ...
      check_hlds__typeclasses__do_class_improvement_by_pairs_2_8_p_0(Constraint_16, Constraints_17, FunDeps_2, ExternalTypeParams_3, STATE_VARIABLE_Bindings_0_4, &STATE_VARIABLE_Bindings_1_26, STATE_VARIABLE_Changed_0_6, &STATE_VARIABLE_Changed_1_27);
      // direct tailcall eliminated
      ;
      next_value_of_HeadVar__1_1 = Constraints_17;
      next_value_of_STATE_VARIABLE_Bindings_0_4 = STATE_VARIABLE_Bindings_1_26;
      next_value_of_STATE_VARIABLE_Changed_0_6 = STATE_VARIABLE_Changed_1_27;
  ...
  MR_Word * STATE_VARIABLE_Changed_8)
{
  while (MR_TRUE)
  {
    ...
    {
      MR_Word HeadConstraint_19 = ((MR_Word) ((MR_hl_field(1, HeadVar__2_2, 0))));
      MR_Word TailConstraints_20 = ((MR_Word) ((MR_hl_field(1, HeadVar__2_2, 1))));
      MR_Word STATE_VARIABLE_Bindings_1_29;
      ...
      check_hlds__typeclasses__do_class_improvement_pair_8_p_0(Constraint_1, HeadConstraint_19, FunDeps_3, ExternalTypeParams_4, STATE_VARIABLE_Bindings_0_5, &STATE_VARIABLE_Bindings_1_29, STATE_VARIABLE_Changed_0_7, &STATE_VARIABLE_Changed_1_30);
      // direct tailcall eliminated
      ;
      next_value_of_HeadVar__2_2 = TailConstraints_20;
      next_value_of_STATE_VARIABLE_Bindings_0_5 = STATE_VARIABLE_Bindings_1_29;
      next_value_of_STATE_VARIABLE_Changed_0_7 = STATE_VARIABLE_Changed_1_30;
  ...
  MR_Word * STATE_VARIABLE_Changed_8)
{
  while (MR_TRUE)
  {
    ...
    {
      MR_Word FunDep_20 = ((MR_Word) ((MR_hl_field(1, HeadVar__3_3, 0))));
      MR_Word FunDeps_21 = ((MR_Word) ((MR_hl_field(1, HeadVar__3_3, 1))));
      MR_Word STATE_VARIABLE_Bindings_1_29;
      MR_Word STATE_VARIABLE_Changed_1_30;
      MR_Word TypesA_33 = ((MR_Word) ((MR_hl_field(0, ConstraintA_1, 2))));
      MR_Word TypesB_36 = ((MR_Word) ((MR_hl_field(0, ConstraintB_2, 2))));
      MR_Word Domain_37 = ((MR_Word) ((MR_hl_field(0, FunDep_20, 0))));
      MR_Word Range_38 = ((MR_Word) ((MR_hl_field(0, FunDep_20, 1))));
      MR_Word STATE_VARIABLE_Bindings_1_39;
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          succeeded = parse_tree__prog_type_unify__type_unify_list_5_p_0(RTypesA_48, RTypesB_49, ExternalTypeParams_4, STATE_VARIABLE_Bindings_0_5, &STATE_VARIABLE_Bindings_1_39);
        }
      }
      if (succeeded)
      {
        STATE_VARIABLE_Bindings_1_29 = STATE_VARIABLE_Bindings_1_39;
        STATE_VARIABLE_Changed_1_30 = (MR_Integer) 1;
      }
      else
      {
        STATE_VARIABLE_Changed_1_30 = STATE_VARIABLE_Changed_0_7;
        STATE_VARIABLE_Bindings_1_29 = STATE_VARIABLE_Bindings_0_5;
      }
      // direct tailcall eliminated
      ;
  ...
  MR_Word * STATE_VARIABLE_UnsatTypeAssignSet_33)
{
  ...
  check_hlds__type_assign__type_assign_get_constraint_db_2_p_0(STATE_VARIABLE_TypeAssign_0_29, &ConstraintDb0_13);
  Unproven0_14 = ((MR_Word) ((MR_hl_field(0, ConstraintDb0_13, 0))));
  Assumed0_15 = ((MR_Word) ((MR_hl_field(0, ConstraintDb0_13, 1))));
  Redundant0_16 = ((MR_Word) ((MR_hl_field(0, ConstraintDb0_13, 2))));
  Ancestors0_17 = ((MR_Word) ((MR_hl_field(0, ConstraintDb0_13, 3))));
  ...
  if (succeeded)
  {
    mercury__cord__snoc_3_p_0((MR_Word) (&check_hlds__type_assign__check_hlds__type_assign__type_ctor_info_type_assign_0), ((MR_Box) (STATE_VARIABLE_TypeAssign_0_29)), STATE_VARIABLE_TypeAssignCord_0_30, STATE_VARIABLE_TypeAssignCord_31);
  ...
  else
  {
    ...
    MR_Word ConstraintDb_27;
    MR_Word Unproven_28;
    MR_Word STATE_VARIABLE_TypeAssign_1_35;
    MR_Word Var_46;
    MR_Word Var_45;
    ...
    Var_46 = ((MR_Word) ((MR_hl_field(0, ConstraintDb0_13, 0))));
    check_hlds__typeclasses__reduce_context_by_rule_application_2_15_p_0(ClassTable_8, InstanceTable_9, ExistQTVars_18, Bindings0_20, &Bindings_23, TVarSet0_19, &TVarSet_24, ProofMap0_21, &ProofMap_25, ConstraintMap0_22, &ConstraintMap_26, ConstraintDb0_13, &ConstraintDb_27, Var_46, &Var_45);
    check_hlds__type_assign__type_assign_set_reduce_results_7_p_0(TVarSet_24, Bindings_23, ConstraintDb_27, ProofMap_25, ConstraintMap_26, STATE_VARIABLE_TypeAssign_0_29, &STATE_VARIABLE_TypeAssign_1_35);
    Unproven_28 = ((MR_Word) ((MR_hl_field(0, ConstraintDb_27, 0))));
    succeeded = check_hlds__typeclasses__all_constraints_are_satisfiable_2_p_0(Unproven_28, ExistQTVars_18);
    if (succeeded)
    {
      mercury__cord__snoc_3_p_0((MR_Word) (&check_hlds__type_assign__check_hlds__type_assign__type_ctor_info_type_assign_0), ((MR_Box) (STATE_VARIABLE_TypeAssign_1_35)), STATE_VARIABLE_TypeAssignCord_0_30, STATE_VARIABLE_TypeAssignCord_31);
      *STATE_VARIABLE_UnsatTypeAssignSet_33 = STATE_VARIABLE_UnsatTypeAssignSet_0_32;
    }
    else
    {
      {
        ...
        *STATE_VARIABLE_UnsatTypeAssignSet_33 = base;
        MR_hl_field(1, base, 0) = ((MR_Box) (STATE_VARIABLE_TypeAssign_1_35));
  ...
  void * env_ptr_arg)
{
  ...
  if (MR_builtin_setjmp((env_ptr)->check_hlds__typeclasses__all_constraints_are_satisfiable_2_p_0_env_0__commit_0) == 0)
    {
      parse_tree__prog_type_scan__type_list_contains_var_2_p_0((env_ptr)->check_hlds__typeclasses__all_constraints_are_satisfiable_2_p_0_env_0__ArgTypes_9, &(env_ptr)->check_hlds__typeclasses__all_constraints_are_satisfiable_2_p_0_env_0__TVar_11, check_hlds__typeclasses__all_constraints_are_satisfiable_2_p_0_2, env_ptr);
  ...
  MR_Word ExistQTVars_2)
{
  ...
  while (MR_TRUE)
  {
    ...
    {
      MR_Word Constraint_4 = ((MR_Word) ((MR_hl_field(1, HeadVar__1_1, 0))));
      MR_Word Constraints_5 = ((MR_Word) ((MR_hl_field(1, HeadVar__1_1, 1))));
      MR_Word _Ids_7;
      MR_Word _ClassName_8;
      MR_Word next_value_of_HeadVar__1_1;

      (env).check_hlds__typeclasses__all_constraints_are_satisfiable_2_p_0_env_0__ArgTypes_9 = ((MR_Word) ((MR_hl_field(0, Constraint_4, 2))));
...
check_hlds__typeclasses__reduce_context_by_rule_application_13_p_0(
  ...
  MR_Word STATE_VARIABLE_ConstraintDb_0_31,
  MR_Word * STATE_VARIABLE_ConstraintDb_32)
{
  MR_Word Var_38 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_ConstraintDb_0_31, 0))));
  MR_Word Var_22;

  check_hlds__typeclasses__reduce_context_by_rule_application_2_15_p_0(ClassTable_14, InstanceTable_15, ExistQTVars_16, STATE_VARIABLE_Bindings_0_23, STATE_VARIABLE_Bindings_24, STATE_VARIABLE_TVarSet_0_25, STATE_VARIABLE_TVarSet_26, STATE_VARIABLE_ProofMap_0_27, STATE_VARIABLE_ProofMap_28, STATE_VARIABLE_ConstraintMap_0_29, STATE_VARIABLE_ConstraintMap_30, STATE_VARIABLE_ConstraintDb_0_31, STATE_VARIABLE_ConstraintDb_32, Var_38, &Var_22);
}
  ...
  MR_Box * wrapper_arg_7)
{
  ...
  check_hlds__typeclasses__do_instance_improvement_2_11_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) ((MR_hl_field(0, closure, 4)))), ((MR_Word) ((MR_hl_field(0, closure, 5)))), ((MR_Word) ((MR_hl_field(0, closure, 6)))), ((MR_Word) (wrapper_arg_1)), ((MR_Word) (wrapper_arg_2)), &conv6_STATE_VARIABLE_TVarSet_26, ((MR_Word) (wrapper_arg_4)), &conv5_STATE_VARIABLE_Bindings_28, ((MR_Word) (wrapper_arg_6)), &conv4_STATE_VARIABLE_Changed_30);
  ...
  MR_Box * wrapper_arg_5)
{
  ...
  check_hlds__typeclasses__do_class_improvement_2_8_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) ((MR_hl_field(0, closure, 4)))), ((MR_Word) ((MR_hl_field(0, closure, 5)))), ((MR_Word) (wrapper_arg_1)), ((MR_Word) (wrapper_arg_2)), &conv1_STATE_VARIABLE_Bindings_20, ((MR_Word) (wrapper_arg_4)), &conv0_STATE_VARIABLE_Changed_22);
  ...
  MR_Word * STATE_VARIABLE_Seen_40)
{
  while (MR_TRUE)
  {
    ...
    MR_Word STATE_VARIABLE_ConstraintDb_1_41;
    MR_Word STATE_VARIABLE_TVarSet_1_42;
    MR_Word STATE_VARIABLE_Bindings_1_43;
    MR_Word STATE_VARIABLE_ConstraintDb_2_44;
    MR_Word STATE_VARIABLE_ConstraintMap_1_45;
    MR_Word STATE_VARIABLE_TVarSet_2_47;
    MR_Word STATE_VARIABLE_ProofMap_1_48;
    MR_Word STATE_VARIABLE_ConstraintMap_2_49;
    MR_Word STATE_VARIABLE_Seen_1_50;
    MR_Word STATE_VARIABLE_ConstraintDb_4_51;
    MR_Word STATE_VARIABLE_ProofMap_2_52;
    MR_Word STATE_VARIABLE_ConstraintMap_3_53;
    MR_Word STATE_VARIABLE_ConstraintDb_5_54;
    MR_Word Changed1_55;
    MR_Word Changed2_56;
    MR_Word STATE_VARIABLE_Bindings_1_57;
    ...
    MR_Word Unproven_96;
    MR_Box conv3_STATE_VARIABLE_Bindings_1_57;
    MR_Box conv2_Changed1_55;
    MR_Box conv9_STATE_VARIABLE_TVarSet_1_42;
    MR_Box conv8_STATE_VARIABLE_Bindings_1_43;
    ...
    // setup for model_det tailcalls optimized into a loop
    ;
    hlds__type_rename__apply_rec_subst_to_constraint_db_3_p_0(STATE_VARIABLE_Bindings_0_29, STATE_VARIABLE_ConstraintDb_0_37, &STATE_VARIABLE_ConstraintDb_1_41);
    Redundant_58 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_ConstraintDb_1_41, 2))));
    ...
    mercury__list__foldl2_6_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_class_id_0), (MR_Word) (&check_hlds__typeclasses_scalar_common_2[0]), (MR_Word) (&mercury__bool__bool__type_ctor_info_bool_0), Var_60, ClassIds_59, ((MR_Box) (STATE_VARIABLE_Bindings_0_29)), &conv3_STATE_VARIABLE_Bindings_1_57, ((MR_Box) ((MR_Integer) 0)), &conv2_Changed1_55);
    STATE_VARIABLE_Bindings_1_57 = ((MR_Word) (conv3_STATE_VARIABLE_Bindings_1_57));
    Changed1_55 = ((MR_Word) (conv2_Changed1_55));
    RedundantConstraints_69 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_ConstraintDb_1_41, 2))));
    ...
    mercury__list__foldl3_8_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_class_id_0), (MR_Word) (&check_hlds__typeclasses_scalar_common_1[5]), (MR_Word) (&check_hlds__typeclasses_scalar_common_2[0]), (MR_Word) (&mercury__bool__bool__type_ctor_info_bool_0), Var_71, ClassIds_70, ((MR_Box) (STATE_VARIABLE_TVarSet_0_31)), &conv9_STATE_VARIABLE_TVarSet_1_42, ((MR_Box) (STATE_VARIABLE_Bindings_1_57)), &conv8_STATE_VARIABLE_Bindings_1_43, ((MR_Box) ((MR_Integer) 0)), &conv7_Changed2_56);
    STATE_VARIABLE_TVarSet_1_42 = ((MR_Word) (conv9_STATE_VARIABLE_TVarSet_1_42));
    STATE_VARIABLE_Bindings_1_43 = ((MR_Word) (conv8_STATE_VARIABLE_Bindings_1_43));
    ...
    switch (AppliedImprovementRule_25) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        STATE_VARIABLE_ConstraintDb_2_44 = STATE_VARIABLE_ConstraintDb_1_41;
        break;
      case (MR_Integer) 1:
        hlds__type_rename__apply_rec_subst_to_constraint_db_3_p_0(STATE_VARIABLE_Bindings_1_43, STATE_VARIABLE_ConstraintDb_1_41, &STATE_VARIABLE_ConstraintDb_2_44);
        break;
    }
    Unproven0_81 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_ConstraintDb_2_44, 0))));
    Assumed_87 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_ConstraintDb_2_44, 1))));
    Redundant0_88 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_ConstraintDb_2_44, 2))));
    Ancestors_95 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_ConstraintDb_2_44, 3))));
    check_hlds__typeclasses__eliminate_assumed_constraints_2_6_p_0(Assumed_87, STATE_VARIABLE_ConstraintMap_0_35, &STATE_VARIABLE_ConstraintMap_1_45, Unproven0_81, &Unproven0_86, &EliminatedAssumed_26);
    check_hlds__typeclasses__apply_instance_rules_2_15_p_0(ClassTable_16, InstanceTable_17, STATE_VARIABLE_TVarSet_1_42, &STATE_VARIABLE_TVarSet_2_47, STATE_VARIABLE_ProofMap_0_33, &STATE_VARIABLE_ProofMap_1_48, STATE_VARIABLE_ConstraintMap_1_45, &STATE_VARIABLE_ConstraintMap_2_49, Redundant0_88, &Redundant_90, STATE_VARIABLE_Seen_0_39, &STATE_VARIABLE_Seen_1_50, Unproven0_86, &Unproven0_92, &AppliedInstanceRule_27);
    {
      STATE_VARIABLE_ConstraintDb_4_51 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(0, STATE_VARIABLE_ConstraintDb_4_51, 0) = ((MR_Box) (Unproven0_92));
      MR_hl_field(0, STATE_VARIABLE_ConstraintDb_4_51, 1) = ((MR_Box) (Assumed_87));
      MR_hl_field(0, STATE_VARIABLE_ConstraintDb_4_51, 2) = ((MR_Box) (Redundant_90));
      MR_hl_field(0, STATE_VARIABLE_ConstraintDb_4_51, 3) = ((MR_Box) (Ancestors_95));
    }
    check_hlds__typeclasses__apply_class_rules_2_8_p_0(Ancestors_95, STATE_VARIABLE_ProofMap_1_48, &STATE_VARIABLE_ProofMap_2_52, STATE_VARIABLE_ConstraintMap_2_49, &STATE_VARIABLE_ConstraintMap_3_53, Unproven0_92, &Unproven_96, &AppliedClassRule_28);
    Var_98 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_ConstraintDb_4_51, 1))));
    Var_99 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_ConstraintDb_4_51, 2))));
    Var_100 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_ConstraintDb_4_51, 3))));
    {
      STATE_VARIABLE_ConstraintDb_5_54 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(0, STATE_VARIABLE_ConstraintDb_5_54, 0) = ((MR_Box) (Unproven_96));
      MR_hl_field(0, STATE_VARIABLE_ConstraintDb_5_54, 1) = ((MR_Box) (Var_98));
      MR_hl_field(0, STATE_VARIABLE_ConstraintDb_5_54, 2) = ((MR_Box) (Var_99));
      MR_hl_field(0, STATE_VARIABLE_ConstraintDb_5_54, 3) = ((MR_Box) (Var_100));
    }
    ...
    if (succeeded)
    {
      MR_Word Unproven0_101 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_ConstraintDb_5_54, 0))));
      ...
      {
        MR_Word C_113 = ((MR_Word) ((MR_hl_field(1, Unproven1_102, 0))));
        MR_Word Cs_114 = ((MR_Word) ((MR_hl_field(1, Unproven1_102, 1))));

        check_hlds__typeclasses__merge_adjacent_constraints_2_3_p_0(C_113, Cs_114, &Unproven_103);
      }
      Var_109 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_ConstraintDb_5_54, 1))));
      Var_110 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_ConstraintDb_5_54, 2))));
      Var_111 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_ConstraintDb_5_54, 3))));
      {
        MR_Word base;
        base = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
        *STATE_VARIABLE_ConstraintDb_38 = base;
      ...
      *STATE_VARIABLE_Seen_40 = STATE_VARIABLE_Seen_1_50;
      *STATE_VARIABLE_ConstraintMap_36 = STATE_VARIABLE_ConstraintMap_3_53;
      *STATE_VARIABLE_ProofMap_34 = STATE_VARIABLE_ProofMap_2_52;
      *STATE_VARIABLE_TVarSet_32 = STATE_VARIABLE_TVarSet_2_47;
      *STATE_VARIABLE_Bindings_30 = STATE_VARIABLE_Bindings_1_43;
    }
    else
    {
      MR_Word next_value_of_STATE_VARIABLE_Bindings_0_29 = STATE_VARIABLE_Bindings_1_43;
      MR_Word next_value_of_STATE_VARIABLE_TVarSet_0_31 = STATE_VARIABLE_TVarSet_2_47;
      MR_Word next_value_of_STATE_VARIABLE_ProofMap_0_33 = STATE_VARIABLE_ProofMap_2_52;
      MR_Word next_value_of_STATE_VARIABLE_ConstraintMap_0_35 = STATE_VARIABLE_ConstraintMap_3_53;
      MR_Word next_value_of_STATE_VARIABLE_ConstraintDb_0_37 = STATE_VARIABLE_ConstraintDb_5_54;
      MR_Word next_value_of_STATE_VARIABLE_Seen_0_39 = STATE_VARIABLE_Seen_1_50;
      ...
      STATE_VARIABLE_ConstraintDb_0_37 = next_value_of_STATE_VARIABLE_ConstraintDb_0_37;
  ...
  MR_Word * HeadVar__8_8)
{
  ...
  {
    MR_Word Constraint0_19 = ((MR_Word) ((MR_hl_field(1, HeadVar__6_6, 0))));
    MR_Word Constraints0_20 = ((MR_Word) ((MR_hl_field(1, HeadVar__6_6, 1))));
    ...
    if (succeeded)
    {
      MR_Word STATE_VARIABLE_ConstraintMap_1_31;
      MR_Word STATE_VARIABLE_ProofMap_1_32;
      MR_Word Var_25;

      hlds__hlds_class__update_constraint_map_3_p_0(Constraint0_19, STATE_VARIABLE_ConstraintMap_0_4, &STATE_VARIABLE_ConstraintMap_1_31);
      check_hlds__typeclasses__add_superclass_proofs_4_p_0(ProgConstraint0_23, Descendants_24, STATE_VARIABLE_ProofMap_0_2, &STATE_VARIABLE_ProofMap_1_32);
      check_hlds__typeclasses__apply_class_rules_2_8_p_0(Ancestors_1, STATE_VARIABLE_ProofMap_1_32, STATE_VARIABLE_ProofMap_3, STATE_VARIABLE_ConstraintMap_1_31, STATE_VARIABLE_ConstraintMap_5, Constraints0_20, HeadVar__7_7, &Var_25);
  ...
  MR_Word * STATE_VARIABLE_ProofMap_4)
{
  while (MR_TRUE)
  {
    ...
    {
      MR_Word Descendant_10 = ((MR_Word) ((MR_hl_field(1, HeadVar__2_2, 0))));
      MR_Word Descendants_11 = ((MR_Word) ((MR_hl_field(1, HeadVar__2_2, 1))));
      MR_Word Var_15;
      MR_Word STATE_VARIABLE_ProofMap_1_16;
      ...
      mercury__map__set_4_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_constraint_0), (MR_Word) (&hlds__hlds_class__hlds__hlds_class__type_ctor_info_constraint_proof_0), ((MR_Box) (Constraint_1)), ((MR_Box) (Var_15)), STATE_VARIABLE_ProofMap_0_3, &STATE_VARIABLE_ProofMap_1_16);
      // direct tailcall eliminated
      ;
      next_value_of_Constraint_1 = Descendant_10;
      next_value_of_HeadVar__2_2 = Descendants_11;
      next_value_of_STATE_VARIABLE_ProofMap_0_3 = STATE_VARIABLE_ProofMap_1_16;
  ...
  MR_Box wrapper_arg_1)
{
  ...
  succeeded = check_hlds__typeclasses__matches_no_constraint_2_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) (wrapper_arg_1)));
  return succeeded;
}
  ...
  MR_Word * HeadVar__15_15)
{
  ...
  {
    MR_Word C_40 = ((MR_Word) ((MR_hl_field(1, HeadVar__13_13, 0))));
    MR_Word Cs_41 = ((MR_Word) ((MR_hl_field(1, HeadVar__13_13, 1))));
    MR_Word ClassName_45 = ((MR_Word) ((MR_hl_field(0, C_40, 1))));
    MR_Word ArgTypes_46 = ((MR_Word) ((MR_hl_field(0, C_40, 2))));
    MR_Integer Arity_47;
    ...
    MR_Word Changed2_54;
    MR_Word Var_65;
    MR_Word STATE_VARIABLE_ConstraintMap_1_68;
    MR_Word STATE_VARIABLE_Redundant_1_70;
    MR_Word STATE_VARIABLE_Seen_1_71;
    MR_Word STATE_VARIABLE_TVarSet_2_73;
    MR_Word STATE_VARIABLE_ProofMap_2_74;
    MR_Box conv0_Instances_48;
    MR_Word NewConstraints0_50;
    MR_Word STATE_VARIABLE_TVarSet_1_66;
    MR_Word STATE_VARIABLE_ProofMap_1_67;
    ...
    succeeded = check_hlds__typeclasses__find_matching_instance_rule_2_8_p_0(Instances_48, (MR_Integer) 1, C_40, STATE_VARIABLE_TVarSet_0_3, &STATE_VARIABLE_TVarSet_1_66, STATE_VARIABLE_ProofMap_0_5, &STATE_VARIABLE_ProofMap_1_67, &NewConstraints0_50);
    if (succeeded)
    {
      MR_Word Var_69;

      STATE_VARIABLE_ProofMap_2_74 = STATE_VARIABLE_ProofMap_1_67;
      STATE_VARIABLE_TVarSet_2_73 = STATE_VARIABLE_TVarSet_1_66;
      hlds__hlds_class__update_constraint_map_3_p_0(C_40, STATE_VARIABLE_ConstraintMap_0_7, &STATE_VARIABLE_ConstraintMap_1_68);
      {
      ...
      hlds__hlds_class__update_redundant_constraints_5_p_0(ClassTable_1, STATE_VARIABLE_TVarSet_1_66, NewConstraints_51, STATE_VARIABLE_Redundant_0_9, &STATE_VARIABLE_Redundant_1_70);
      STATE_VARIABLE_Seen_1_71 = mercury__list__f_43_43_2_f_0((MR_Word) (&hlds__hlds_class__hlds__hlds_class__type_ctor_info_hlds_constraint_0), NewConstraints_51, STATE_VARIABLE_Seen_0_11);
    ...
    else
    {
      ...
      STATE_VARIABLE_TVarSet_2_73 = STATE_VARIABLE_TVarSet_0_3;
      Changed1_52 = (MR_Integer) 0;
      STATE_VARIABLE_Seen_1_71 = STATE_VARIABLE_Seen_0_11;
      STATE_VARIABLE_Redundant_1_70 = STATE_VARIABLE_Redundant_0_9;
      STATE_VARIABLE_ConstraintMap_1_68 = STATE_VARIABLE_ConstraintMap_0_7;
      STATE_VARIABLE_ProofMap_2_74 = STATE_VARIABLE_ProofMap_0_5;
    }
    check_hlds__typeclasses__apply_instance_rules_2_15_p_0(ClassTable_1, InstanceTable_2, STATE_VARIABLE_TVarSet_2_73, STATE_VARIABLE_TVarSet_4, STATE_VARIABLE_ProofMap_2_74, STATE_VARIABLE_ProofMap_6, STATE_VARIABLE_ConstraintMap_1_68, STATE_VARIABLE_ConstraintMap_8, STATE_VARIABLE_Redundant_1_70, STATE_VARIABLE_Redundant_10, STATE_VARIABLE_Seen_1_71, STATE_VARIABLE_Seen_12, Cs_41, &TailConstraints_53, &Changed2_54);
  ...
  MR_Word * NewConstraints_15)
{
  while (MR_TRUE)
  {
    ...
    if (succeeded)
    {
      Instance_9 = ((MR_Word) ((MR_hl_field(1, HeadVar__1_1, 0))));
      Instances_10 = ((MR_Word) ((MR_hl_field(1, HeadVar__1_1, 1))));
      ArgTypes_18 = ((MR_Word) ((MR_hl_field(0, Constraint_12, 2))));
      InstanceTVarSet_21 = ((MR_Word) ((MR_hl_field(0, Instance_9, 2))));
      InstanceTypes0_20 = ((MR_Word) ((MR_hl_field(0, Instance_9, 4))));
      ProgConstraints0_19 = ((MR_Word) ((MR_hl_field(0, Instance_9, 5))));
      ...
      parse_tree__prog_type_subst__apply_renaming_to_types_3_p_0(Renaming_23, InstanceTypes0_20, &InstanceTypes_24);
      succeeded = parse_tree__prog_type_unify__type_list_subsumes_3_p_0(InstanceTypes_24, ArgTypes_18, &Subst_25);
      if (succeeded)
      {
        ...
        *STATE_VARIABLE_TVarSet_31 = NewTVarSet_22;
        parse_tree__prog_type_subst__apply_renaming_to_prog_constraints_3_p_0(Renaming_23, ProgConstraints0_19, &ProgConstraints1_26);
        parse_tree__prog_type_subst__apply_rec_subst_to_prog_constraints_3_p_0(Subst_25, ProgConstraints1_26, &ProgConstraints_27);
  ...
  MR_Word * HeadVar__6_6)
{
  ...
  else
  {
    ...
    MR_Word NewCs0_17;
    MR_Word Changed0_18;
    MR_Word STATE_VARIABLE_ConstraintMap_1_22;

    (env).check_hlds__typeclasses__eliminate_assumed_constraints_2_6_p_0_env_0__C_13 = ((MR_Word) ((MR_hl_field(1, HeadVar__4_4, 0))));
    Cs_14 = ((MR_Word) ((MR_hl_field(1, HeadVar__4_4, 1))));
    check_hlds__typeclasses__eliminate_assumed_constraints_2_6_p_0((env).check_hlds__typeclasses__eliminate_assumed_constraints_2_6_p_0_env_0__AssumedCs_1, STATE_VARIABLE_ConstraintMap_0_2, &STATE_VARIABLE_ConstraintMap_1_22, Cs_14, &NewCs0_17, &Changed0_18);
    ...
    {
      hlds__hlds_class__update_constraint_map_3_p_0((env).check_hlds__typeclasses__eliminate_assumed_constraints_2_6_p_0_env_0__C_13, STATE_VARIABLE_ConstraintMap_1_22, STATE_VARIABLE_ConstraintMap_3);
    ...
    else
    {
      ...
      *STATE_VARIABLE_ConstraintMap_3 = STATE_VARIABLE_ConstraintMap_1_22;
    }
  }
}
  ...
  MR_Word * HeadVar__3_3)
{
  while (MR_TRUE)
  {
    ...
    {
      MR_Word C1_7 = ((MR_Word) ((MR_hl_field(1, HeadVar__2_2, 0))));
      MR_Word Cs_8 = ((MR_Word) ((MR_hl_field(1, HeadVar__2_2, 1))));
      MR_Word C_10;
      MR_Word TypeCtorInfo_13_18;
      MR_Word TypeInfo_17_22;
      MR_Word IdsA_12 = ((MR_Word) ((MR_hl_field(0, C0_1, 0))));
      MR_Word ClassName_13 = ((MR_Word) ((MR_hl_field(0, C0_1, 1))));
      MR_Word ArgTypes_14 = ((MR_Word) ((MR_hl_field(0, C0_1, 2))));
      MR_Word IdsB_15 = ((MR_Word) ((MR_hl_field(0, C1_7, 0))));
      MR_Word Ids0_16;
      MR_Word Ids_17;
      MR_Word Var_19 = ((MR_Word) ((MR_hl_field(0, C1_7, 1))));
      MR_Word Var_20 = ((MR_Word) ((MR_hl_field(0, C1_7, 2))));
  ...
  MR_Box * wrapper_arg_2)
{
  ...
  check_hlds__typeclasses__IntroducedFrom__pred__perform_context_reduction__133__1_3_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) (wrapper_arg_1)), &conv4_LambdaHeadVar__2_38);
  ...
  MR_Box * wrapper_arg_5)
{
  ...
  check_hlds__typeclasses__reduce_type_assign_context_7_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) ((MR_hl_field(0, closure, 4)))), ((MR_Word) (wrapper_arg_1)), ((MR_Word) (wrapper_arg_2)), &conv1_STATE_VARIABLE_TypeAssignCord_31, ((MR_Word) (wrapper_arg_4)), &conv0_STATE_VARIABLE_UnsatTypeAssignSet_33);
  ...
  MR_Word * STATE_VARIABLE_Info_29)
{
  ...
  ModuleInfo_11 = ((MR_Word) ((MR_hl_field(0, ClauseContext_10, 0))));
