...
MR_decl_label8(check_hlds__typeclasses__perform_context_reduction_3_0, 2,3,4,5,6,7,11,12)
MR_decl_label2(check_hlds__typeclasses__perform_context_reduction_3_0, 13,8)
...
MR_BEGIN_MODULE(check_hlds__typeclasses_module0)
	...
	MR_init_label8(check_hlds__typeclasses__perform_context_reduction_3_0,2,3,4,5,6,7,11,12)
	MR_init_label2(check_hlds__typeclasses__perform_context_reduction_3_0,13,8)
MR_BEGIN_CODE
...
MR_def_label(check_hlds__typeclasses__perform_context_reduction_3_0,5)
	...
	MR_np_call_localret_ent(check_hlds__typecheck_info__typecheck_info_get_type_assign_set_2_0,
		check_hlds__typeclasses__perform_context_reduction_3_0_i6);
MR_def_label(check_hlds__typeclasses__perform_context_reduction_3_0,6)
	...
	MR_np_call_localret_ent(list__filter_map_3_0,
		check_hlds__typeclasses__perform_context_reduction_3_0_i7);
MR_def_label(check_hlds__typeclasses__perform_context_reduction_3_0,7)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TEST(MR_sv(3),0,0)) {
		MR_GOTO_LAB(check_hlds__typeclasses__perform_context_reduction_3_0_i8);
	}
...
MR_def_label(check_hlds__typeclasses__perform_context_reduction_3_0,11)
	...
	MR_np_call_localret_ent(check_hlds__typecheck_info__typecheck_info_add_error_3_0,
		check_hlds__typeclasses__perform_context_reduction_3_0_i12);
MR_def_label(check_hlds__typeclasses__perform_context_reduction_3_0,12)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	...
	MR_np_call_localret_ent(list__map_3_0,
		check_hlds__typeclasses__perform_context_reduction_3_0_i13);
MR_def_label(check_hlds__typeclasses__perform_context_reduction_3_0,13)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_sv(1);
	MR_succip_word = MR_sv(5);
	MR_decr_sp(5);
	MR_np_tailcall_ent(check_hlds__typecheck_info__typecheck_info_set_type_assign_set_3_0);
MR_def_label(check_hlds__typeclasses__perform_context_reduction_3_0,8)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_sv(4);
	MR_succip_word = MR_sv(5);
	MR_decr_sp(5);
