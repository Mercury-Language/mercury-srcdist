  ...
  MR_Word * STATE_VARIABLE_Changed_26)
{
  ...
  if (succeeded)
  {
    ...
    if (succeeded)
    {
      TypeCtorInfo_16_57 = (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0);
      RTypesA_55 = hlds__hlds_class__restrict_list_elements_2_f_0(TypeCtorInfo_16_57, Range_19, InstanceTypes_21);
      RTypesB_56 = hlds__hlds_class__restrict_list_elements_2_f_0(TypeCtorInfo_16_57, Range_19, ConstraintTypes_17);
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          TypeCtorInfo_16_73 = (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0);
          RTypesA_71 = hlds__hlds_class__restrict_list_elements_2_f_0(TypeCtorInfo_16_73, Range_48, TypesA_43);
          RTypesB_72 = hlds__hlds_class__restrict_list_elements_2_f_0(TypeCtorInfo_16_73, Range_48, TypesB_46);
  ...
  MR_Word * STATE_VARIABLE_UnsatTypeAssignSet_33)
{
  ...
  else
  {
    ...
    Var_69 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Constraints0_13, (MR_Integer) 0))));
    check_hlds__typeclasses__reduce_context_by_rule_application_2_15_p_0(ClassTable_8, InstanceTable_9, ExternalTypeParams_18, Bindings0_20, &Bindings_23, TVarSet0_19, &TVarSet_24, ProofMap0_21, &ProofMap_25, ConstraintMap0_22, &ConstraintMap_26, Constraints0_13, &Constraints_27, Var_69, &Var_63);
  ...
  MR_Word * STATE_VARIABLE_Seen_40)
{
  while (MR_TRUE)
  {
    ...
    Var_83 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_Constraints_51_51, (MR_Integer) 1))));
    Var_84 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_Constraints_51_51, (MR_Integer) 2))));
    Var_85 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_Constraints_51_51, (MR_Integer) 3))));
    {
      ...
      MR_hl_field(MR_mktag(0), STATE_VARIABLE_Constraints_54_54, 1) = ((MR_Box) (Var_83));
      MR_hl_field(MR_mktag(0), STATE_VARIABLE_Constraints_54_54, 2) = ((MR_Box) (Var_84));
      MR_hl_field(MR_mktag(0), STATE_VARIABLE_Constraints_54_54, 3) = ((MR_Box) (Var_85));
    }
  ...
  MR_Word * STATE_VARIABLE_Constraints_8)
{
  ...
  {
    MR_Word C_21 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Unproven1_5, (MR_Integer) 0))));
    MR_Word Cs_22 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Unproven1_5, (MR_Integer) 1))));

    check_hlds__typeclasses__merge_adjacent_constraints_2_3_p_0(C_21, Cs_22, &Unproven_6);
  }
  Var_14 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_Constraints_0_7, (MR_Integer) 1))));
  Var_15 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_Constraints_0_7, (MR_Integer) 2))));
  Var_16 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_Constraints_0_7, (MR_Integer) 3))));
  {
    MR_Word base;
    base = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
