  ...
  MR_Box closure_arg)
{
  ...
  succeeded = hlds__hlds_inst_mode__IntroducedFrom__pred__unify_insts_from_sorted_pairs__466__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 4)))));
  return succeeded;
}
