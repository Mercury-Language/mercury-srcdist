  ...
  MR_Word * STATE_VARIABLE_RevSubTablePairs_6)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), UnifyInstInfo_18, (MR_Integer) 0)));
...
{
  {
    ...
    MR_Word Var_73;
    MR_Word Var_74;
    MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), UnifyInstInfo_5, (MR_Integer) 0)));
