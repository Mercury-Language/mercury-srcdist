  ...
  MR_Word HeadVar__2_2)
{
  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        TypeInfo__20_20 = (MR_Word) (&hlds__hlds_inst_mode_scalar_common_1[4]);
        succeeded = mercury__builtin__unify_2_p_0(TypeInfo__20_20, ((MR_Box) (ArgX3_7)), ((MR_Box) (ArgY3_8)));
        if (succeeded)
        {
          TypeInfo__21_21 = (MR_Word) (&hlds__hlds_inst_mode_scalar_common_1[2]);
          succeeded = mercury__builtin__unify_2_p_0(TypeInfo__21_21, ((MR_Box) (ArgX4_9)), ((MR_Box) (ArgY4_10)));
          if (succeeded)
          {
            TypeInfo__22_22 = (MR_Word) (&hlds__hlds_inst_mode_scalar_common_1[1]);
            succeeded = mercury__builtin__unify_2_p_0(TypeInfo__22_22, ((MR_Box) (ArgX5_11)), ((MR_Box) (ArgY5_12)));
            if (succeeded)
            {
              TypeInfo__23_23 = (MR_Word) (&hlds__hlds_inst_mode_scalar_common_1[5]);
              succeeded = mercury__builtin__unify_2_p_0(TypeInfo__23_23, ((MR_Box) (ArgX6_13)), ((MR_Box) (ArgY6_14)));
              if (succeeded)
              {
                TypeInfo__24_24 = (MR_Word) (&hlds__hlds_inst_mode_scalar_common_1[5]);
  ...
  MR_Word HeadVar__2_2)
{
  ...
  else
  {
    ...
    if (succeeded)
    {
      TypeInfo__14_14 = (MR_Word) (&hlds__hlds_inst_mode_scalar_common_1[7]);
      succeeded = mercury__builtin__unify_2_p_0(TypeInfo__14_14, ((MR_Box) (ArgX2_5)), ((MR_Box) (ArgY2_6)));
      if (succeeded)
      {
        TypeInfo__15_15 = (MR_Word) (&hlds__hlds_inst_mode_scalar_common_1[7]);
        succeeded = mercury__builtin__unify_2_p_0(TypeInfo__15_15, ((MR_Box) (ArgX3_7)), ((MR_Box) (ArgY3_8)));
        if (succeeded)
        {
          TypeInfo__16_16 = (MR_Word) (&hlds__hlds_inst_mode_scalar_common_1[7]);
  ...
  MR_Word HeadVar__2_2)
{
  ...
  else
  {
    ...
    if (succeeded)
    {
      TypeInfo__16_16 = (MR_Word) (&hlds__hlds_inst_mode_scalar_common_2[3]);
  ...
  MR_Word HeadVar__2_2)
{
  ...
  else
  {
    ...
    if (succeeded)
    {
      TypeInfo__18_18 = (MR_Word) (&hlds__hlds_inst_mode_scalar_common_2[3]);
      ...
      case (MR_Integer) 2:
        {
          ...
          if (succeeded)
          {
            ...
            TypeInfo__16_16 = (MR_Word) (&hlds__hlds_inst_mode_scalar_common_2[4]);
            succeeded = mercury__builtin__unify_2_p_0(TypeInfo__16_16, ((MR_Box) (ArgX1_9)), ((MR_Box) (ArgY1_10)));
          }
        }
        break;
    }
