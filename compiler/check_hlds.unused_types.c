    ...
    case (MR_Integer) 1:
      {
        ...
        MR_Word ShouldBeUsedEqvTypeCtors_10;
        MR_Word ShouldBeUsedDuTypeCtors_11;
        MR_Word ShouldBeUsedEqvTypeCtorsSet_12;
        MR_Word ShouldBeUsedDuTypeCtorsSet_13;
        MR_Word UsedEqvModules_14;
        MR_Word ExpandedInIntTypeCtorSet_15;
        MR_Word ExpandedInImpTypeCtorSet_16;
        MR_Word ExpandedTypeCtorsSet_18;
        MR_Word UnusedEqvTypeCtorSet_19;
        MR_Word PredTable_20;
        MR_Word PredIdTable_21;
        MR_Word PredInfos_22;
        MR_Word UnusedDuTypeCtorSet0_23;
        MR_Word UnusedDuTypeCtorSet1_24;
        MR_Word UnusedDuTypeCtorSet_27;
        MR_Word UnusedTypeCtorSet_28;
        MR_Word Var_36;
        ...
        check_hlds__unused_types__collect_should_be_used_type_ctors_5_p_0(TypeCtorsDefns_9, (MR_Word) ((MR_Unsigned) 0U), &ShouldBeUsedEqvTypeCtors_10, (MR_Word) ((MR_Unsigned) 0U), &ShouldBeUsedDuTypeCtors_11);
        mercury__set_tree234__list_to_set_2_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_type_ctor_0), ShouldBeUsedEqvTypeCtors_10, &ShouldBeUsedEqvTypeCtorsSet_12);
        mercury__set_tree234__list_to_set_2_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_type_ctor_0), ShouldBeUsedDuTypeCtors_11, &ShouldBeUsedDuTypeCtorsSet_13);
        hlds__hlds_module__module_info_get_used_eqv_modules_2_p_0(ModuleInfo_4, &UsedEqvModules_14);
        ExpandedInIntTypeCtorSet_15 = ((MR_Word) ((MR_hl_field(0, UsedEqvModules_14, 0))));
        ExpandedInImpTypeCtorSet_16 = ((MR_Word) ((MR_hl_field(0, UsedEqvModules_14, 1))));
        mercury__set_tree234__union_3_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_type_ctor_0), ExpandedInIntTypeCtorSet_15, ExpandedInImpTypeCtorSet_16, &ExpandedTypeCtorsSet_18);
        mercury__set_tree234__difference_3_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_type_ctor_0), ShouldBeUsedEqvTypeCtorsSet_12, ExpandedTypeCtorsSet_18, &UnusedEqvTypeCtorSet_19);
        hlds__hlds_module__module_info_get_predicate_table_2_p_0(ModuleInfo_4, &PredTable_20);
        hlds__pred_table__predicate_table_get_pred_id_table_2_p_0(PredTable_20, &PredIdTable_21);
        mercury__map__values_2_p_0((MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_id_0), (MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_info_0), PredIdTable_21, &PredInfos_22);
        check_hlds__unused_types__record_type_ctors_used_in_preds_3_p_0(PredInfos_22, ShouldBeUsedDuTypeCtorsSet_13, &UnusedDuTypeCtorSet0_23);
        succeeded = mercury__set_tree234__is_empty_1_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_type_ctor_0), UnusedDuTypeCtorSet0_23);
        if (succeeded)
          UnusedDuTypeCtorSet1_24 = UnusedDuTypeCtorSet0_23;
        else
        {
          MR_Word DecisionData_25;
          MR_Word FEEInfos_26;
          MR_Box conv1_UnusedDuTypeCtorSet1_24;

          hlds__hlds_module__module_info_get_type_repn_dec_2_p_0(ModuleInfo_4, &DecisionData_25);
          FEEInfos_26 = ((MR_Word) ((MR_hl_field(0, DecisionData_25, 3))));
          mercury__list__foldl_4_p_0((MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_item_foreign_export_enum_info_0), (MR_Word) (&check_hlds__unused_types_scalar_common_1[0]), (MR_Word) (&check_hlds__unused_types_scalar_common_4[3]), FEEInfos_26, ((MR_Box) (UnusedDuTypeCtorSet0_23)), &conv1_UnusedDuTypeCtorSet1_24);
          UnusedDuTypeCtorSet1_24 = ((MR_Word) (conv1_UnusedDuTypeCtorSet1_24));
        }
        succeeded = mercury__set_tree234__is_empty_1_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_type_ctor_0), UnusedDuTypeCtorSet1_24);
        if (succeeded)
          UnusedDuTypeCtorSet_27 = UnusedDuTypeCtorSet1_24;
        else
          check_hlds__unused_types__record_type_ctors_used_in_type_defns_4_p_0(UnusedDuTypeCtorSet1_24, TypeCtorsDefns_9, UnusedDuTypeCtorSet1_24, &UnusedDuTypeCtorSet_27);
        mercury__set_tree234__union_3_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_type_ctor_0), UnusedEqvTypeCtorSet_19, UnusedDuTypeCtorSet_27, &UnusedTypeCtorSet_28);
        {
          Var_36 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(0, Var_36, 0) = ((MR_Box) (&check_hlds__unused_types_scalar_common_5[0]));
          MR_hl_field(0, Var_36, 1) = ((MR_Box) (check_hlds__unused_types__warn_about_unused_types_3_p_0_2));
          MR_hl_field(0, Var_36, 2) = ((MR_Box) ((MR_Integer) 1));
          MR_hl_field(0, Var_36, 3) = ((MR_Box) (TypeTable_8));
        }
        mercury__set_tree234__foldl_4_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_type_ctor_0), (MR_Word) (&check_hlds__unused_types_scalar_common_1[1]), Var_36, UnusedTypeCtorSet_28, ((MR_Box) (STATE_VARIABLE_Specs_0_29)), &conv3_STATE_VARIABLE_Specs_30);
