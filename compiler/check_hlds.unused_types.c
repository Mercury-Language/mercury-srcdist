    ...
    case (MR_Integer) 0:
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_13, (MR_Integer) 167, &WarnUnusedTypes_14);
          ...
          case (MR_Integer) 1:
            {
              ...
              mercury__map__values_2_p_0((MR_Word) (&hlds__pred_proc_id__hlds__pred_proc_id__type_ctor_info_pred_id_0), (MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_info_0), PredIdTable_28, &PredInfos_29);
          ...
          case (MR_Integer) 1:
            {
              ...
              check_hlds__unused_types__record_type_ctors_used_in_types_3_p_0(ArgTypes_28, STATE_VARIABLE_ShouldBeUsedTypeCtors_0_17, STATE_VARIABLE_ShouldBeUsedTypeCtors_18);
            }
            break;
          case (MR_Integer) 2:
            {
