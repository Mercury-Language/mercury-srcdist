...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(0), Var_49, 0) = ((MR_Box) (WrapperFuncRval_29));
      MR_hl_field(MR_mktag(0), Var_49, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 6))));
    }
    {
      Var_51 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), Var_51, 0) = ((MR_Box) (NumArgsRval_27));
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), ExtraArgRvalsTypes_33, 1) = ((MR_Box) (Var_48));
    }
