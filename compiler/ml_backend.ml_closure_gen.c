...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(0), Var_53, 0) = ((MR_Box) (WrapperFuncRval_31));
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(0), Var_60, 0) = ((MR_Box) (NumArgsRval_29));
      MR_hl_field(MR_mktag(0), Var_60, 1) = ((MR_Box) ((MR_Unsigned) 24U));
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), ExtraArgRvalsTypes_35, 1) = ((MR_Box) (Var_52));
    }
