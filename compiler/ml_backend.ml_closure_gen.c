  ...
  MR_Word * STATE_VARIABLE_Info_98)
{
  ...
  if (succeeded)
  {
    ...
    succeeded = mercury__list__drop_3_p_0(TypeCtorInfo_130_130, NumClosureArgs_13, ProcArgModes_25, &WrapperArgModes0_33);
    if (succeeded)
    {
      TypeCtorInfo_131_131 = (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0);
      succeeded = mercury__list__drop_3_p_0(TypeCtorInfo_131_131, NumClosureArgs_13, ProcArgTypes_22, &WrapperArgTypes0_34);
      if (succeeded)
        succeeded = mercury__list__drop_3_p_0(TypeCtorInfo_131_131, NumClosureArgs_13, ProcBoxedArgTypes_31, &WrapperBoxedArgTypes0_35);
    }
  }
  if (succeeded)
  {
  ...
  if (succeeded)
  {
    ...
    libs__globals__get_gc_method_2_p_0(Globals_89, &Var_135);
    succeeded = (Var_122 == Var_135);
  }
  if (succeeded)
  ...
  MR_Word * STATE_VARIABLE_Info_31)
{
  ...
  ml_backend__ml_gen_info__ml_gen_info_get_target_2_p_0(STATE_VARIABLE_Info_0_30, &Target_21);
  {
    ...
    MR_hl_field(MR_mktag(0), Var_53, 0) = ((MR_Box) (&ml_backend__ml_closure_gen_scalar_common_4[0]));
    MR_hl_field(MR_mktag(0), Var_53, 1) = ((MR_Box) (ml_backend__ml_closure_gen__ml_gen_closure_layout_7_p_0_1));
    MR_hl_field(MR_mktag(0), Var_53, 2) = ((MR_Box) ((MR_Integer) 2));
    MR_hl_field(MR_mktag(0), Var_53, 3) = ((MR_Box) (ModuleInfo_14));
    MR_hl_field(MR_mktag(0), Var_53, 4) = ((MR_Box) (Target_21));
  }
  mercury__list__map_foldl_5_p_0((MR_Word) (&ll_backend__continuation_info__ll_backend__continuation_info__type_ctor_info_closure_arg_info_0), (MR_Word) (&ml_backend__ml_closure_gen_scalar_common_2[0]), (MR_Word) (&ml_backend__ml_global_data__ml_backend__ml_global_data__type_ctor_info_ml_global_data_0), Var_53, ClosureArgs_19, &ArgInitsAndTypes_47, ((MR_Box) (STATE_VARIABLE_GlobalData_33_33)), &conv2_STATE_VARIABLE_GlobalData_34_34);
  ...
  Length_48 = mercury__list__length_1_f_0((MR_Word) (&ml_backend__ml_closure_gen_scalar_common_2[0]), ArgInitsAndTypes_47);
  {
    ...
    MR_hl_field(MR_mktag(2), Var_54, 0) = ((MR_Box) (Length_48));
  }
  {
    LengthRval_49 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(MR_mktag(3), LengthRval_49, 0) = ((MR_Box) ((MR_Unsigned) 1U));
    MR_hl_field(MR_mktag(3), LengthRval_49, 1) = ((MR_Box) (Var_54));
  }
  LengthType_51 = (MR_Word) (MR_mkword(MR_mktag(3), &ml_backend__ml_closure_gen_scalar_common_1[3]));
  {
    CastLengthRval_50 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(MR_mktag(3), CastLengthRval_50, 0) = ((MR_Box) ((MR_Unsigned) 2U));
    MR_hl_field(MR_mktag(3), CastLengthRval_50, 1) = ((MR_Box) (LengthType_51));
    MR_hl_field(MR_mktag(3), CastLengthRval_50, 2) = ((MR_Box) (LengthRval_49));
  }
  {
    Var_56 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(MR_mktag(1), Var_56, 0) = ((MR_Box) (CastLengthRval_50));
  }
  {
    LengthInitAndType_52 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(MR_mktag(0), LengthInitAndType_52, 0) = ((MR_Box) (Var_56));
    MR_hl_field(MR_mktag(0), LengthInitAndType_52, 1) = ((MR_Box) (LengthType_51));
  }
  {
    ClosureArgInitsAndTypes_22 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(MR_mktag(1), ClosureArgInitsAndTypes_22, 0) = ((MR_Box) (LengthInitAndType_52));
    MR_hl_field(MR_mktag(1), ClosureArgInitsAndTypes_22, 1) = ((MR_Box) (ArgInitsAndTypes_47));
  }
  ...
  {
    MR_Word Vector_61;
    MR_Word Initializer_63;
    MR_Word ModuleName_64;
    MR_Word MLDS_ModuleName_65;
    MR_Word TVarLocns_70;
    MR_Word TypeParamLocs_71;
    MR_Integer TypeParamsLength_72;
    MR_Word LengthRval_73;
    MR_Word Var_76;
    MR_Word Var_77;
    MR_Integer Var_79;
    MR_Word _VectorTypes_62;

    mercury__map__to_assoc_list_2_p_0((MR_Word) (&ml_backend__ml_closure_gen_scalar_common_1[1]), (MR_Word) (&ml_backend__ml_closure_gen_scalar_common_1[2]), TVarLocnMap_20, &TVarLocns_70);
    ml_backend__ml_closure_gen__ml_stack_layout_construct_type_param_locn_vector_3_p_0(TVarLocns_70, (MR_Integer) 1, &TypeParamLocs_71);
    mercury__list__length_2_p_0((MR_Word) (&ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_initializer_0), TypeParamLocs_71, &TypeParamsLength_72);
    {
      Var_76 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(2), Var_76, 0) = ((MR_Box) (TypeParamsLength_72));
    }
    {
      LengthRval_73 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(3), LengthRval_73, 0) = ((MR_Box) ((MR_Unsigned) 1U));
      MR_hl_field(MR_mktag(3), LengthRval_73, 1) = ((MR_Box) (Var_76));
    }
    {
      Var_77 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), Var_77, 0) = ((MR_Box) (LengthRval_73));
    }
    {
      Vector_61 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), Vector_61, 0) = ((MR_Box) (Var_77));
      MR_hl_field(MR_mktag(1), Vector_61, 1) = ((MR_Box) (TypeParamLocs_71));
    }
    Var_79 = (MR_Integer) ((MR_Unsigned) TypeParamsLength_72 + (MR_Unsigned) 1);
    _VectorTypes_62 = mercury__list__duplicate_2_f_0((MR_Word) (&ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_type_0), Var_79, ((MR_Box) (MR_mkword(MR_mktag(3), &ml_backend__ml_closure_gen_scalar_common_1[3]))));
    {
      Initializer_63 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(3), Initializer_63, 0) = ((MR_Box) (Vector_61));
    }
    hlds__hlds_module__module_info_get_name_2_p_0(ModuleInfo_14, &ModuleName_64);
    MLDS_ModuleName_65 = ml_backend__mlds__mercury_module_name_to_mlds_1_f_0(ModuleName_64);
    ml_backend__ml_global_data__ml_gen_static_scalar_const_addr_8_p_0(MLDS_ModuleName_65, (MR_Integer) 5, TVarVectorType_25, Initializer_63, Context_10, &TVarVectorRval_24, STATE_VARIABLE_GlobalData_34_34, &STATE_VARIABLE_GlobalData_36_36);
  }
  {
    Var_37 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
