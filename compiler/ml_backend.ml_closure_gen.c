...
static /* final */ const MR_Box ml_backend__ml_closure_gen_scalar_common_1[20][2] = {
  ...
  {
    ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 6)))),
    ((MR_Box) (&ml_backend__ml_closure_gen_scalar_common_1[6]))
  },
  /* row 8 */
  {
  ...
  /* row 19 */
  {
    ((MR_Box) (MR_mkword(MR_mktag(1), &ml_backend__ml_closure_gen_scalar_common_3[9]))),
    ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))))
  },
};
...
{
  {
    ...
    MR_Word ml_backend__ml_closure_gen__V_100_100;
    MR_Word ml_backend__ml_closure_gen__V_101_101;
    MR_Word ml_backend__ml_closure_gen__V_103_103;
    ...
    {
      ml_backend__ml_code_util__ml_gen_var_lval_4_p_0(ml_backend__ml_closure_gen__STATE_VARIABLE_Info_0_34, (MR_Word) &ml_backend__ml_closure_gen_scalar_common_1[16], ml_backend__ml_closure_gen__ClosureLayoutPtrType_21, &ml_backend__ml_closure_gen__ClosureLayoutPtrLval_24);
    }
    ml_backend__ml_closure_gen__TypeParamsType_26 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 6));
    {
      ml_backend__ml_code_util__ml_gen_var_lval_4_p_0(ml_backend__ml_closure_gen__STATE_VARIABLE_Info_0_34, (MR_Word) &ml_backend__ml_closure_gen_scalar_common_1[17], ml_backend__ml_closure_gen__TypeParamsType_26, &ml_backend__ml_closure_gen__TypeParamsLval_29);
    }
      ...
      case (MR_Integer) 0:
        {
          ...
          MR_Word ml_backend__ml_closure_gen__V_73_73;
          MR_Word ml_backend__ml_closure_gen__V_74_74;
          MR_Word ml_backend__ml_closure_gen__V_77_77;
          MR_Word ml_backend__ml_closure_gen__V_78_78;
          MR_Word ml_backend__ml_closure_gen__V_79_79;
          MR_Word ml_backend__ml_closure_gen__V_84_84;
          MR_Word ml_backend__ml_closure_gen__V_85_85;
          MR_Word ml_backend__ml_closure_gen__V_87_87;
          MR_Word ml_backend__ml_closure_gen__V_88_88;
          MR_Word ml_backend__ml_closure_gen__V_93_93;

          {
            ml_backend__ml_closure_gen__V_73_73 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(3), ml_backend__ml_closure_gen__V_73_73, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 0));
            MR_hl_field(MR_mktag(3), ml_backend__ml_closure_gen__V_73_73, 1) = ((MR_Box) (ml_backend__ml_closure_gen__ClosureLayoutPtrLval_24));
          }
          {
            ml_backend__ml_closure_gen__V_79_79 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), ml_backend__ml_closure_gen__V_79_79, 0) = ((MR_Box) (ml_backend__ml_closure_gen__ClosureArgLval_19));
          }
          {
            ml_backend__ml_closure_gen__V_78_78 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(2), ml_backend__ml_closure_gen__V_78_78, 0) = ((MR_Box) (ml_backend__ml_closure_gen__V_79_79));
          }
          {
            ...
            MR_hl_field(MR_mktag(1), ml_backend__ml_closure_gen__V_77_77, 0) = ((MR_Box) (ml_backend__ml_closure_gen__V_78_78));
            MR_hl_field(MR_mktag(1), ml_backend__ml_closure_gen__V_77_77, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &ml_backend__ml_closure_gen_scalar_common_1[18])));
          }
          {
            ml_backend__ml_closure_gen__V_74_74 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), ml_backend__ml_closure_gen__V_74_74, 0) = ((MR_Box) (MR_mkword(MR_mktag(1), &ml_backend__ml_closure_gen_scalar_common_3[6])));
            MR_hl_field(MR_mktag(1), ml_backend__ml_closure_gen__V_74_74, 1) = ((MR_Box) (ml_backend__ml_closure_gen__V_77_77));
          }
          {
            ...
            MR_hl_field(MR_mktag(1), ml_backend__ml_closure_gen__ClosureLayoutPtrGCInitFragments_30, 0) = ((MR_Box) (ml_backend__ml_closure_gen__V_73_73));
            MR_hl_field(MR_mktag(1), ml_backend__ml_closure_gen__ClosureLayoutPtrGCInitFragments_30, 1) = ((MR_Box) (ml_backend__ml_closure_gen__V_74_74));
          }
          {
            ml_backend__ml_closure_gen__V_85_85 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(3), ml_backend__ml_closure_gen__V_85_85, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 6));
            MR_hl_field(MR_mktag(3), ml_backend__ml_closure_gen__V_85_85, 1) = ((MR_Box) ((MR_Integer) 0));
            MR_hl_field(MR_mktag(3), ml_backend__ml_closure_gen__V_85_85, 2) = ((MR_Box) (ml_backend__ml_closure_gen__ClosureLayoutPtrGCInitFragments_30));
          }
          {
            ml_backend__ml_closure_gen__V_84_84 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(3), ml_backend__ml_closure_gen__V_84_84, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 8));
            MR_hl_field(MR_mktag(3), ml_backend__ml_closure_gen__V_84_84, 1) = ((MR_Box) (ml_backend__ml_closure_gen__V_85_85));
          }
          {
            ...
            MR_hl_field(MR_mktag(0), ml_backend__ml_closure_gen__ClosureLayoutPtrGCInit_23, 0) = ((MR_Box) (ml_backend__ml_closure_gen__V_84_84));
          ...
          {
            ml_backend__ml_closure_gen__V_87_87 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(3), ml_backend__ml_closure_gen__V_87_87, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 0));
            MR_hl_field(MR_mktag(3), ml_backend__ml_closure_gen__V_87_87, 1) = ((MR_Box) (ml_backend__ml_closure_gen__TypeParamsLval_29));
          }
          {
            ...
            MR_hl_field(MR_mktag(1), ml_backend__ml_closure_gen__V_93_93, 0) = ((MR_Box) (ml_backend__ml_closure_gen__V_78_78));
            MR_hl_field(MR_mktag(1), ml_backend__ml_closure_gen__V_93_93, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &ml_backend__ml_closure_gen_scalar_common_1[19])));
          }
          {
            ml_backend__ml_closure_gen__V_88_88 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), ml_backend__ml_closure_gen__V_88_88, 0) = ((MR_Box) (MR_mkword(MR_mktag(1), &ml_backend__ml_closure_gen_scalar_common_3[8])));
            MR_hl_field(MR_mktag(1), ml_backend__ml_closure_gen__V_88_88, 1) = ((MR_Box) (ml_backend__ml_closure_gen__V_93_93));
          }
          {
            ...
            MR_hl_field(MR_mktag(1), ml_backend__ml_closure_gen__TypeParamsGCInitFragments_31, 0) = ((MR_Box) (ml_backend__ml_closure_gen__V_87_87));
            MR_hl_field(MR_mktag(1), ml_backend__ml_closure_gen__TypeParamsGCInitFragments_31, 1) = ((MR_Box) (ml_backend__ml_closure_gen__V_88_88));
          }
      ...
      case (MR_Integer) 1:
        {
          ...
          MR_Word ml_backend__ml_closure_gen__V_66_66;
          ...
          {
            ml_backend__ml_closure_gen__V_62_62 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), ml_backend__ml_closure_gen__V_62_62, 0) = ((MR_Box) (ml_backend__ml_closure_gen__ClosureArgLval_19));
          }
          {
            ml_backend__ml_closure_gen__V_61_61 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(2), ml_backend__ml_closure_gen__V_61_61, 0) = ((MR_Box) (ml_backend__ml_closure_gen__V_62_62));
          }
          {
            ml_backend__ml_closure_gen__V_68_68 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), ml_backend__ml_closure_gen__V_68_68, 0) = ((MR_Box) (ml_backend__ml_closure_gen__ClosureLayoutPtrLval_24));
          }
          {
            ml_backend__ml_closure_gen__V_67_67 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(2), ml_backend__ml_closure_gen__V_67_67, 0) = ((MR_Box) (ml_backend__ml_closure_gen__V_68_68));
          }
          {
            ml_backend__ml_closure_gen__V_66_66 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), ml_backend__ml_closure_gen__V_66_66, 0) = ((MR_Box) (ml_backend__ml_closure_gen__V_67_67));
            MR_hl_field(MR_mktag(1), ml_backend__ml_closure_gen__V_66_66, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &ml_backend__ml_closure_gen_scalar_common_1[19])));
          }
          {
            ml_backend__ml_closure_gen__V_63_63 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), ml_backend__ml_closure_gen__V_63_63, 0) = ((MR_Box) (MR_mkword(MR_mktag(1), &ml_backend__ml_closure_gen_scalar_common_3[11])));
            MR_hl_field(MR_mktag(1), ml_backend__ml_closure_gen__V_63_63, 1) = ((MR_Box) (ml_backend__ml_closure_gen__V_66_66));
          }
          {
            ml_backend__ml_closure_gen__V_60_60 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), ml_backend__ml_closure_gen__V_60_60, 0) = ((MR_Box) (ml_backend__ml_closure_gen__V_61_61));
            MR_hl_field(MR_mktag(1), ml_backend__ml_closure_gen__V_60_60, 1) = ((MR_Box) (ml_backend__ml_closure_gen__V_63_63));
          }
          {
            ...
            MR_hl_field(MR_mktag(1), ml_backend__ml_closure_gen__V_53_53, 0) = ((MR_Box) (MR_mkword(MR_mktag(1), &ml_backend__ml_closure_gen_scalar_common_3[10])));
            MR_hl_field(MR_mktag(1), ml_backend__ml_closure_gen__V_53_53, 1) = ((MR_Box) (ml_backend__ml_closure_gen__V_60_60));
          }
          {
            ml_backend__ml_closure_gen__TypeParamsGCInitFragments_31 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
    ...
    {
      ml_backend__ml_closure_gen__ClosureLayoutPtrDecl_22 = ml_backend__ml_code_util__ml_gen_mlds_var_decl_4_f_0((MR_Word) MR_mkword(MR_mktag(1), ((MR_Box) (&ml_backend__ml_closure_gen_scalar_common_1[16]))), ml_backend__ml_closure_gen__ClosureLayoutPtrType_21, ml_backend__ml_closure_gen__V_39_39, ml_backend__ml_closure_gen__MLDS_Context_18);
    }
    {
      ml_backend__ml_closure_gen__V_101_101 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(3), ml_backend__ml_closure_gen__V_101_101, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 6));
      MR_hl_field(MR_mktag(3), ml_backend__ml_closure_gen__V_101_101, 1) = ((MR_Box) ((MR_Integer) 0));
      MR_hl_field(MR_mktag(3), ml_backend__ml_closure_gen__V_101_101, 2) = ((MR_Box) (ml_backend__ml_closure_gen__TypeParamsGCInitFragments_31));
    }
    {
      ml_backend__ml_closure_gen__V_100_100 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(3), ml_backend__ml_closure_gen__V_100_100, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 8));
      MR_hl_field(MR_mktag(3), ml_backend__ml_closure_gen__V_100_100, 1) = ((MR_Box) (ml_backend__ml_closure_gen__V_101_101));
    }
    {
      ml_backend__ml_closure_gen__TypeParamsGCInit_28 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), ml_backend__ml_closure_gen__TypeParamsGCInit_28, 0) = ((MR_Box) (ml_backend__ml_closure_gen__V_100_100));
    ...
    {
      ml_backend__ml_closure_gen__TypeParamsDecl_27 = ml_backend__ml_code_util__ml_gen_mlds_var_decl_4_f_0((MR_Word) MR_mkword(MR_mktag(1), ((MR_Box) (&ml_backend__ml_closure_gen_scalar_common_1[17]))), ml_backend__ml_closure_gen__TypeParamsType_26, ml_backend__ml_closure_gen__V_43_43, ml_backend__ml_closure_gen__MLDS_Context_18);
    }
    {
      ml_backend__ml_closure_gen__V_103_103 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), ml_backend__ml_closure_gen__V_103_103, 0) = ((MR_Box) (ml_backend__ml_closure_gen__TypeParamsDecl_27));
      MR_hl_field(MR_mktag(1), ml_backend__ml_closure_gen__V_103_103, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
    }
    {
      MR_Word base;
      base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      *ml_backend__ml_closure_gen__GC_Decls_16 = base;
      ...
      MR_hl_field(MR_mktag(1), base, 1) = ((MR_Box) (ml_backend__ml_closure_gen__V_103_103));
    }
  }
}
...
{
  {
    ...
    if (ml_backend__ml_closure_gen__succeeded)
    ...
    else
      {
        ...
        {
          mercury__string__format__format_signed_int_component_nowidth_noprec_3_p_0((MR_Word) &ml_backend__ml_closure_gen_scalar_common_3[5], ml_backend__ml_closure_gen__Num_4, &ml_backend__ml_closure_gen__V_17_17);
        }
        {
...
{
  {
    ...
    *ml_backend__ml_closure_gen__ArrayType_14 = (MR_Word) MR_mkword(MR_mktag(3), &ml_backend__ml_closure_gen_scalar_common_1[12]);
    {
    ...
    if (ml_backend__ml_closure_gen__succeeded)
      {
        *ml_backend__ml_closure_gen__TVarVectorAddrRval_13 = (MR_Word) MR_mkword(MR_mktag(3), &ml_backend__ml_closure_gen_scalar_common_1[14]);
      ...
      case (MR_Integer) 0:
        {
          ...
          MR_String ml_backend__ml_closure_gen__V_23_23 = ((MR_String) (MR_hl_field(MR_mktag(0), ml_backend__ml_closure_gen__RttiTypeCtor0_20, (MR_Integer) 1)));
          MR_Integer ml_backend__ml_closure_gen__V_24_24 = ((MR_Integer) (MR_hl_field(MR_mktag(0), ml_backend__ml_closure_gen__RttiTypeCtor0_20, (MR_Integer) 2)));
          ...
          if (ml_backend__ml_closure_gen__succeeded)
            *ml_backend__ml_closure_gen__STATE_VARIABLE_GlobalData_11 = ml_backend__ml_closure_gen__STATE_VARIABLE_GlobalData_0_10;
          else
            {
              ...
              MR_Word ml_backend__ml_closure_gen__V_40_40;
              MR_Word ml_backend__ml_closure_gen__V_41_41;
              ...
              {
                ml_backend__ml_closure_gen__V_40_40 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL);
                MR_hl_field(MR_mktag(0), ml_backend__ml_closure_gen__V_40_40, 0) = ((MR_Box) (&ml_backend__ml_closure_gen_scalar_common_6[1]));
                MR_hl_field(MR_mktag(0), ml_backend__ml_closure_gen__V_40_40, 1) = ((MR_Box) (ml_backend__ml_closure_gen__ml_gen_type_info_defn_4_p_0_1));
                MR_hl_field(MR_mktag(0), ml_backend__ml_closure_gen__V_40_40, 2) = ((MR_Box) (MR_Word) ((MR_Integer) 1));
                MR_hl_field(MR_mktag(0), ml_backend__ml_closure_gen__V_40_40, 3) = ((MR_Box) (ml_backend__ml_closure_gen__ModuleInfo_5));
              }
              {
                ml_backend__ml_closure_gen__V_41_41 = ml_backend__ml_closure_gen__arg_type_infos_1_f_0(ml_backend__ml_closure_gen__TI_6);
              }
              {
                mercury__list__foldl_4_p_0((MR_Word) &backend_libs__rtti__backend_libs__rtti__type_ctor_info_rtti_type_info_0, (MR_Word) &ml_backend__ml_global_data__ml_backend__ml_global_data__type_ctor_info_ml_global_data_0, ml_backend__ml_closure_gen__V_40_40, ml_backend__ml_closure_gen__V_41_41, ((MR_Box) (ml_backend__ml_closure_gen__STATE_VARIABLE_GlobalData_33_39)), &ml_backend__ml_closure_gen__conv2_STATE_VARIABLE_GlobalData_11);
              }
...
{
  {
    ...
    *ml_backend__ml_closure_gen__ClosureLayoutType_12 = (MR_Word) MR_mkword(MR_mktag(3), &ml_backend__ml_closure_gen_scalar_common_1[11]);
    {
  ...
  MR_Word * ml_backend__ml_closure_gen__STATE_VARIABLE_Info_94)
{
  {
    MR_bool ml_backend__ml_closure_gen__succeeded;
    MR_Word ml_backend__ml_closure_gen__TypeInfo_137_137;
    MR_Word ml_backend__ml_closure_gen__TypeCtorInfo_140_140;
    MR_Word ml_backend__ml_closure_gen__TypeCtorInfo_147_147;
    ...
    MR_Word ml_backend__ml_closure_gen__STATE_VARIABLE_Info_109_109;
    ...
    MR_Word ml_backend__ml_closure_gen__STATE_VARIABLE_Info_135_135;
    ...
    MR_Tuple ml_backend__ml_closure_gen__V_128_128;
    MR_Word ml_backend__ml_closure_gen__V_129_129;
    MR_Word ml_backend__ml_closure_gen__V_148_148;
    ...
    ml_backend__ml_closure_gen__TypeInfo_137_137 = (MR_Word) &ml_backend__ml_closure_gen_scalar_common_1[0];
    {
      ml_backend__ml_closure_gen__ProcArity_28 = mercury__list__length_1_f_0(ml_backend__ml_closure_gen__TypeInfo_137_137, ml_backend__ml_closure_gen__ProcHeadVars_24);
    }
    {
    ...
    {
      ml_backend__ml_closure_gen__succeeded = mercury__list__drop_3_p_0(ml_backend__ml_closure_gen__TypeInfo_137_137, ml_backend__ml_closure_gen__NumClosureArgs_13, ml_backend__ml_closure_gen__ProcHeadVars_24, &ml_backend__ml_closure_gen__WrapperHeadVars0_31);
    }
    if (ml_backend__ml_closure_gen__succeeded)
      {
        ml_backend__ml_closure_gen__TypeCtorInfo_138_138 = (MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_mode_0;
        {
          ml_backend__ml_closure_gen__succeeded = mercury__list__drop_3_p_0(ml_backend__ml_closure_gen__TypeCtorInfo_138_138, ml_backend__ml_closure_gen__NumClosureArgs_13, ml_backend__ml_closure_gen__ProcArgModes_25, &ml_backend__ml_closure_gen__WrapperArgModes0_32);
        }
        if (ml_backend__ml_closure_gen__succeeded)
          {
            ml_backend__ml_closure_gen__TypeCtorInfo_139_139 = (MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0;
            {
              ml_backend__ml_closure_gen__succeeded = mercury__list__drop_3_p_0(ml_backend__ml_closure_gen__TypeCtorInfo_139_139, ml_backend__ml_closure_gen__NumClosureArgs_13, ml_backend__ml_closure_gen__ProcArgTypes_22, &ml_backend__ml_closure_gen__WrapperArgTypes0_33);
            }
            if (ml_backend__ml_closure_gen__succeeded)
              {
                ml_backend__ml_closure_gen__succeeded = mercury__list__drop_3_p_0(ml_backend__ml_closure_gen__TypeCtorInfo_139_139, ml_backend__ml_closure_gen__NumClosureArgs_13, ml_backend__ml_closure_gen__ProcBoxedArgTypes_30, &ml_backend__ml_closure_gen__WrapperBoxedArgTypes0_34);
              }
          }
      }
    if (ml_backend__ml_closure_gen__succeeded)
    ...
    {
      ml_backend__ml_closure_gen__V_99_99 = mercury__list__length_1_f_0(ml_backend__ml_closure_gen__TypeInfo_137_137, ml_backend__ml_closure_gen__WrapperHeadVars_35);
    }
    {
    ...
    ml_backend__ml_closure_gen__TypeCtorInfo_140_140 = (MR_Word) &ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_argument_0;
    {
      ml_backend__ml_closure_gen__WrapperArgs1_43 = mercury__list__map_2_f_0(ml_backend__ml_closure_gen__TypeCtorInfo_140_140, ml_backend__ml_closure_gen__TypeCtorInfo_140_140, (MR_Word) &ml_backend__ml_closure_gen_scalar_common_2[1], ml_backend__ml_closure_gen__WrapperArgs0_41);
    }
    switch (ml_backend__ml_closure_gen__ClosureKind_12) {
      ...
      case (MR_Integer) 1:
        {
          MR_Word ml_backend__ml_closure_gen__ClosureArgName_47 = (MR_Word) &ml_backend__ml_closure_gen_scalar_common_1[6];
    ...
    switch (ml_backend__ml_closure_gen__CodeModel_26) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        ml_backend__ml_closure_gen__STATE_VARIABLE_Info_119_119 = ml_backend__ml_closure_gen__STATE_VARIABLE_Info_109_109;
        break;
      case (MR_Integer) 2:
        {
          ...
          switch (ml_backend__ml_closure_gen__NondetCopyOut_68) {
            ...
            case (MR_Integer) 0:
              {
                {
                  ml_backend__ml_code_util__ml_initial_cont_4_p_0(ml_backend__ml_closure_gen__STATE_VARIABLE_Info_109_109, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), &ml_backend__ml_closure_gen__InitialCont_72);
                }
              }
              break;
            case (MR_Integer) 1:
              {
                MR_Word ml_backend__ml_closure_gen__TypeCtorInfo_144_144 = (MR_Word) &ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_lval_0;
                MR_Word ml_backend__ml_closure_gen__TypeCtorInfo_145_145 = (MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0;
                ...
                {
                  mercury__map__from_corresponding_lists_3_p_0(ml_backend__ml_closure_gen__TypeCtorInfo_144_144, ml_backend__ml_closure_gen__TypeCtorInfo_145_145, ml_backend__ml_closure_gen__WrapperHeadVarLvals_53, ml_backend__ml_closure_gen__WrapperBoxedArgTypes_38, &ml_backend__ml_closure_gen__WrapperBoxedVarTypes_69);
                }
                {
                  ml_backend__ml_closure_gen__WrapperOutputLvals_70 = check_hlds__mode_util__select_output_things_4_f_0(ml_backend__ml_closure_gen__TypeCtorInfo_144_144, ml_backend__ml_closure_gen__ModuleInfo_18, ml_backend__ml_closure_gen__WrapperHeadVarLvals_53, ml_backend__ml_closure_gen__WrapperArgModes_36, ml_backend__ml_closure_gen__WrapperBoxedVarTypes_69);
                }
                {
                  ml_backend__ml_closure_gen__WrapperOutputTypes_71 = mercury__map__apply_to_list_2_f_0(ml_backend__ml_closure_gen__TypeCtorInfo_144_144, ml_backend__ml_closure_gen__TypeCtorInfo_145_145, ml_backend__ml_closure_gen__WrapperOutputLvals_70, ml_backend__ml_closure_gen__WrapperBoxedVarTypes_69);
                }
                {
                  ml_backend__ml_code_util__ml_initial_cont_4_p_0(ml_backend__ml_closure_gen__STATE_VARIABLE_Info_109_109, ml_backend__ml_closure_gen__WrapperOutputLvals_70, ml_backend__ml_closure_gen__WrapperOutputTypes_71, &ml_backend__ml_closure_gen__InitialCont_72);
                }
              }
              break;
          }
          {
            ml_backend__ml_gen_info__ml_gen_info_push_success_cont_3_p_0(ml_backend__ml_closure_gen__InitialCont_72, ml_backend__ml_closure_gen__STATE_VARIABLE_Info_109_109, &ml_backend__ml_closure_gen__STATE_VARIABLE_Info_119_119);
          }
        }
        break;
      case (MR_Integer) 1:
    ...
    if ((ml_backend__ml_closure_gen__MaybeClosureA_44 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
      {
        ...
        ml_backend__ml_closure_gen__STATE_VARIABLE_Info_124_124 = ml_backend__ml_closure_gen__STATE_VARIABLE_Info_119_119;
      }
    else
      {
        ...
        MR_Tuple ml_backend__ml_closure_gen__V_110_110 = ((MR_Tuple) (MR_hl_field(MR_mktag(1), ml_backend__ml_closure_gen__MaybeClosureA_44, (MR_Integer) 0)));
        MR_Word ml_backend__ml_closure_gen__V_114_114;
        MR_Tuple ml_backend__ml_closure_gen__V_115_115;

        ml_backend__ml_closure_gen__ClosureArgType1_56 = ((MR_Word) (MR_hl_field(MR_mktag(0), ml_backend__ml_closure_gen__V_110_110, (MR_Integer) 0)));
        ml_backend__ml_closure_gen__ClosureArgName1_57 = ((MR_Word) (MR_hl_field(MR_mktag(0), ml_backend__ml_closure_gen__V_110_110, (MR_Integer) 1)));
        ml_backend__ml_closure_gen__ClosureType_59 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 6));
        {
          ml_backend__ml_closure_gen__ClosureDecl_61 = ml_backend__ml_code_util__ml_gen_mlds_var_decl_4_f_0((MR_Word) MR_mkword(MR_mktag(1), ((MR_Box) (&ml_backend__ml_closure_gen_scalar_common_1[8]))), ml_backend__ml_closure_gen__ClosureType_59, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), ml_backend__ml_closure_gen__MLDS_Context_55);
        }
        {
          ml_backend__ml_code_util__ml_gen_var_lval_4_p_0(ml_backend__ml_closure_gen__STATE_VARIABLE_Info_109_109, (MR_Word) &ml_backend__ml_closure_gen_scalar_common_1[8], ml_backend__ml_closure_gen__ClosureType_59, &ml_backend__ml_closure_gen__ClosureLval1_73);
        }
        {
          ml_backend__ml_code_util__ml_gen_var_lval_4_p_0(ml_backend__ml_closure_gen__STATE_VARIABLE_Info_109_109, ml_backend__ml_closure_gen__ClosureArgName1_57, ml_backend__ml_closure_gen__ClosureArgType1_56, &ml_backend__ml_closure_gen__ClosureArgLval_63);
        }
        {
          ml_backend__ml_closure_gen__V_114_114 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), ml_backend__ml_closure_gen__V_114_114, 0) = ((MR_Box) (ml_backend__ml_closure_gen__ClosureArgLval_63));
        }
        {
          ml_backend__ml_closure_gen__InitClosure_64 = ml_backend__ml_code_util__ml_gen_assign_3_f_0(ml_backend__ml_closure_gen__ClosureLval1_73, ml_backend__ml_closure_gen__V_114_114, ml_backend__ml_closure_gen__Context_14);
        }
        {
          ml_backend__ml_closure_gen__V_115_115 = (MR_Tuple) MR_new_object(MR_Tuple, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), ml_backend__ml_closure_gen__V_115_115, 0) = ((MR_Box) (ml_backend__ml_closure_gen__ClosureDecl_61));
          MR_hl_field(MR_mktag(0), ml_backend__ml_closure_gen__V_115_115, 1) = ((MR_Box) (ml_backend__ml_closure_gen__InitClosure_64));
        }
        {
          ...
          MR_hl_field(MR_mktag(1), ml_backend__ml_closure_gen__MaybeClosureB_65, 0) = ((MR_Box) (ml_backend__ml_closure_gen__V_115_115));
        }
        switch (ml_backend__ml_closure_gen__ClosureKind_12) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 0:
        ...
        {
          ml_backend__ml_closure_gen__ml_gen_closure_field_lvals_7_p_0(ml_backend__ml_closure_gen__ClosureLval1_73, ml_backend__ml_closure_gen__Offset_74, (MR_Integer) 1, ml_backend__ml_closure_gen__NumClosureArgs_13, &ml_backend__ml_closure_gen__ClosureArgLvals_75, ml_backend__ml_closure_gen__STATE_VARIABLE_Info_119_119, &ml_backend__ml_closure_gen__STATE_VARIABLE_Info_124_124);
        }
      }
    {
    ...
    if ((ml_backend__ml_closure_gen__MaybeClosureB_65 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
    ...
    else
      {
        ...
        MR_Tuple ml_backend__ml_closure_gen__V_127_127 = ((MR_Tuple) (MR_hl_field(MR_mktag(1), ml_backend__ml_closure_gen__MaybeClosureB_65, (MR_Integer) 0)));

        ml_backend__ml_closure_gen__ClosureDecl1_79 = ((MR_Word) (MR_hl_field(MR_mktag(0), ml_backend__ml_closure_gen__V_127_127, (MR_Integer) 0)));
        ml_backend__ml_closure_gen__InitClosure1_80 = ((MR_Word) (MR_hl_field(MR_mktag(0), ml_backend__ml_closure_gen__V_127_127, (MR_Integer) 1)));
        {
    ...
    if (ml_backend__ml_closure_gen__succeeded)
      {
        ml_backend__ml_closure_gen__V_128_128 = ((MR_Tuple) (MR_hl_field(MR_mktag(1), ml_backend__ml_closure_gen__MaybeClosureA_44, (MR_Integer) 0)));
        ml_backend__ml_closure_gen__ClosureArgType2_86 = ((MR_Word) (MR_hl_field(MR_mktag(0), ml_backend__ml_closure_gen__V_128_128, (MR_Integer) 0)));
        ml_backend__ml_closure_gen__ClosureArgName2_87 = ((MR_Word) (MR_hl_field(MR_mktag(0), ml_backend__ml_closure_gen__V_128_128, (MR_Integer) 1)));
        ml_backend__ml_closure_gen__V_129_129 = (MR_Integer) 5;
        {
          libs__globals__get_gc_method_2_p_0(ml_backend__ml_closure_gen__Globals_67, &ml_backend__ml_closure_gen__V_148_148);
        }
        ml_backend__ml_closure_gen__succeeded = (ml_backend__ml_closure_gen__V_129_129 == ml_backend__ml_closure_gen__V_148_148);
      }
    if (ml_backend__ml_closure_gen__succeeded)
      {
        ml_backend__ml_closure_gen__ml_gen_closure_wrapper_gc_decls_9_p_0(ml_backend__ml_closure_gen__ClosureKind_12, ml_backend__ml_closure_gen__ClosureArgName2_87, ml_backend__ml_closure_gen__ClosureArgType2_86, ml_backend__ml_closure_gen__PredId_10, ml_backend__ml_closure_gen__ProcId_11, ml_backend__ml_closure_gen__Context_14, &ml_backend__ml_closure_gen__GC_Decls_88, ml_backend__ml_closure_gen__STATE_VARIABLE_Info_126_126, &ml_backend__ml_closure_gen__STATE_VARIABLE_Info_130_130);
      }
    else
      {
        ml_backend__ml_closure_gen__GC_Decls_88 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
        ml_backend__ml_closure_gen__STATE_VARIABLE_Info_130_130 = ml_backend__ml_closure_gen__STATE_VARIABLE_Info_126_126;
      }
    ml_backend__ml_closure_gen__TypeCtorInfo_147_147 = (MR_Word) &ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_defn_0;
    switch (ml_backend__ml_closure_gen__CodeModel_26) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
      case (MR_Integer) 2:
        {
          ...
          {
            ml_backend__ml_code_util__ml_append_return_statement_6_p_0(ml_backend__ml_closure_gen__STATE_VARIABLE_Info_126_126, ml_backend__ml_closure_gen__CodeModel_26, ml_backend__ml_closure_gen__WrapperCopyOutLvals_54, ml_backend__ml_closure_gen__Context_14, ml_backend__ml_closure_gen__Statements1_82, &ml_backend__ml_closure_gen__Statements_85);
          }
          switch (ml_backend__ml_closure_gen__CodeModel_26) {
            default: /*NOTREACHED*/ MR_assert(0);
            case (MR_Integer) 0:
              ml_backend__ml_closure_gen__STATE_VARIABLE_Info_132_132 = ml_backend__ml_closure_gen__STATE_VARIABLE_Info_130_130;
              break;
            case (MR_Integer) 2:
              {
                ml_backend__ml_gen_info__ml_gen_info_pop_success_cont_2_p_0(ml_backend__ml_closure_gen__STATE_VARIABLE_Info_130_130, &ml_backend__ml_closure_gen__STATE_VARIABLE_Info_132_132);
              }
              break;
          }
        }
    ...
    {
      ml_backend__ml_closure_gen__V_131_131 = mercury__list__f_43_43_2_f_0(ml_backend__ml_closure_gen__TypeCtorInfo_147_147, ml_backend__ml_closure_gen__WrapperHeadVarDecls_52, ml_backend__ml_closure_gen__Decls2_83);
    }
    {
      ml_backend__ml_closure_gen__Decls_89 = mercury__list__f_43_43_2_f_0(ml_backend__ml_closure_gen__TypeCtorInfo_147_147, ml_backend__ml_closure_gen__GC_Decls_88, ml_backend__ml_closure_gen__V_131_131);
    }
    {
    ...
    {
      ml_backend__ml_closure_gen__V_133_133 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), ml_backend__ml_closure_gen__V_133_133, 0) = ((MR_Box) (ml_backend__ml_closure_gen__WrapperParams_51));
    }
    {
      ml_backend__ml_code_util__ml_gen_new_func_label_5_p_0(ml_backend__ml_closure_gen__V_133_133, &ml_backend__ml_closure_gen__WrapperFuncName_91, ml_backend__ml_closure_gen__WrapperFuncRval_15, ml_backend__ml_closure_gen__STATE_VARIABLE_Info_132_132, &ml_backend__ml_closure_gen__STATE_VARIABLE_Info_134_134);
    }
    {
      ml_backend__ml_closure_gen__ml_gen_wrapper_func_7_p_0(ml_backend__ml_closure_gen__WrapperFuncName_91, ml_backend__ml_closure_gen__WrapperParams_51, ml_backend__ml_closure_gen__Context_14, ml_backend__ml_closure_gen__WrapperFuncBody_90, &ml_backend__ml_closure_gen__WrapperFunc_92, ml_backend__ml_closure_gen__STATE_VARIABLE_Info_134_134, &ml_backend__ml_closure_gen__STATE_VARIABLE_Info_135_135);
    }
    *ml_backend__ml_closure_gen__WrapperFuncType_16 = (MR_Word) MR_mkword(MR_mktag(1), (MR_Word) ml_backend__ml_closure_gen__WrapperParams_51);
    {
      ml_backend__ml_gen_info__ml_gen_info_add_closure_wrapper_defn_3_p_0(ml_backend__ml_closure_gen__WrapperFunc_92, ml_backend__ml_closure_gen__STATE_VARIABLE_Info_135_135, ml_backend__ml_closure_gen__STATE_VARIABLE_Info_94);
    }
  }
}
