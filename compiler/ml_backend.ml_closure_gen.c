...
MR_decl_label10(ml_backend__ml_closure_gen__ml_gen_closure_wrapper_9_0, 76,77,79,78,85,86,83,87,90,89)
MR_decl_label10(ml_backend__ml_closure_gen__ml_gen_closure_wrapper_9_0, 93,119,95,96,97,98,99,101,102,103)
...
MR_def_label(ml_backend__ml_closure_gen__ml_gen_closure_wrapper_gc_decls_9_0,30)
	...
	MR_r7 = MR_tempr7;
	MR_tfield(1, MR_tempr7, 0) = MR_sv(3);
...
MR_BEGIN_MODULE(ml_backend__ml_closure_gen_module9)
	...
	MR_init_label10(ml_backend__ml_closure_gen__ml_gen_closure_wrapper_9_0,76,77,79,78,85,86,83,87,90,89)
	MR_init_label10(ml_backend__ml_closure_gen__ml_gen_closure_wrapper_9_0,93,119,95,96,97,98,99,101,102,103)
MR_BEGIN_CODE
...
MR_def_label(ml_backend__ml_closure_gen__ml_gen_closure_wrapper_9_0,37)
	...
	MR_Word MR_tempr1, MR_tempr2;
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 1);
	MR_tfield(1, MR_tempr1, 0) = (MR_Word) MR_tmkword(1, (MR_Word *) MR_sv(18));
	...
	MR_tfield(0, MR_tempr2, 0) = MR_tempr1;
	MR_tfield(0, MR_tempr2, 1) = MR_sv(16);
	MR_r6 = MR_sv(5);
	MR_r4 = MR_sv(10);
	MR_r5 = MR_sv(8);
	MR_r3 = MR_sv(7);
...
MR_def_label(ml_backend__ml_closure_gen__ml_gen_closure_wrapper_9_0,60)
	...
	MR_r1 = (MR_Word) MR_tmkword(1, (MR_Word *) MR_sv(14));
	MR_r2 = (MR_Word) MR_tbmkword(0, 5);
	MR_r3 = (MR_Word) MR_tbmkword(0, 0);
	MR_r4 = MR_sv(17);
	}
...
MR_def_label(ml_backend__ml_closure_gen__ml_gen_closure_wrapper_9_0,90)
	...
	MR_np_call_localret_ent(ml_backend__ml_code_util__ml_append_return_statement_6_0,
		ml_backend__ml_closure_gen__ml_gen_closure_wrapper_9_0_i119);
...
MR_def_label(ml_backend__ml_closure_gen__ml_gen_closure_wrapper_9_0,119)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_sv(12);
	MR_r3 = MR_sv(1);
	{
...
MR_def_label(ml_backend__ml_closure_gen__ml_gen_closure_wrapper_9_0,102)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(2) = (MR_Word) MR_tmkword(1, (MR_Word *) MR_sv(10));
...
MR_def_label(ml_backend__ml_closure_gen__ml_gen_pseudo_type_info_6_0,60)
	...
	MR_sv(1) = MR_body((MR_Integer) MR_r2, (MR_Integer) 0);
	MR_sv(4) = MR_r3;
...
MR_def_label(ml_backend__ml_closure_gen__ml_gen_pseudo_type_info_6_0,10)
	...
	{
	MR_Word MR_tempr1, MR_tempr2, MR_tempr3;
	MR_tag_alloc_heap(MR_tempr1, 4, (MR_Integer) 1);
	MR_tempr3 = MR_sv(1);
	MR_tfield(4, MR_tempr1, 0) = MR_tempr3;
	MR_tag_alloc_heap(MR_tempr2, 0, (MR_Integer) 2);
...
MR_def_label(ml_backend__ml_closure_gen__ml_gen_pseudo_type_info_6_0,23)
	...
	MR_tag_alloc_heap(MR_tempr1, 4, (MR_Integer) 1);
	MR_tempr5 = MR_sv(5);
	MR_tfield(4, MR_tempr1, 0) = MR_tempr5;
	MR_tag_alloc_heap(MR_tempr2, 0, (MR_Integer) 2);
	MR_tfield(0, MR_tempr2, 0) = MR_r1;
	MR_tfield(0, MR_tempr2, 1) = MR_tempr1;
