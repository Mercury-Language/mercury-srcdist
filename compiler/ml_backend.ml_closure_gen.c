  ...
  MR_Word * STATE_VARIABLE_GlobalData_13)
{
  ...
  switch (MR_tag((MR_Word) TI_8)) {
    ...
    case (MR_Integer) 0:
      {
        MR_Word RttiTypeCtor0_23 = (MR_Word) ((MR_Word) (TI_8));
    ...
    case (MR_Integer) 2:
      {
        ...
        {
          RttiData_35 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(3), RttiData_35, 0) = ((MR_Box) ((MR_Unsigned) 0U));
        ...
        case (MR_Integer) 0:
          {
            ...
            MR_Word RttiTypeCtor_43 = (MR_Word) ((MR_Word) (PseudoTypeInfo_17));
            MR_Word RttiId_44;
            ...
            {
              RttiId_44 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
              MR_hl_field(MR_mktag(0), RttiId_44, 0) = ((MR_Box) (RttiTypeCtor_43));
              MR_hl_field(MR_mktag(0), RttiId_44, 1) = ((MR_Box) ((MR_Unsigned) 44U));
            }
            MLDS_ModuleName_45 = ml_backend__mlds__mercury_module_name_to_mlds_1_f_0(ModuleName_42);
            {
              ...
              MR_hl_field(MR_mktag(3), Var_59, 0) = ((MR_Box) ((MR_Unsigned) 18U));
        ...
        case (MR_Integer) 2:
          {
            ...
            {
              RttiData_50 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(3), RttiData_50, 0) = ((MR_Box) ((MR_Unsigned) 1U));
              MR_hl_field(MR_mktag(3), RttiData_50, 1) = ((MR_Box) (PseudoTypeInfo_17));
            }
            backend_libs__rtti__rtti_data_to_id_2_p_0(RttiData_50, &RttiId_68);
            ...
            succeeded = mercury__map__search_3_p_0((MR_Word) (&backend_libs__rtti__backend_libs__rtti__type_ctor_info_rtti_id_0), (MR_Word) (&ml_backend__ml_global_data__ml_backend__ml_global_data__type_ctor_info_ml_rval_and_type_0), PDupRvalTypeMap_51, ((MR_Box) (RttiId_68)), &conv0_OldRvalType_52);
            if (succeeded)
            {
            ...
            else
            {
              ...
              MLDS_ModuleName_64 = ml_backend__mlds__mercury_module_name_to_mlds_1_f_0(ModuleName_63);
              {
                ...
                MR_hl_field(MR_mktag(3), Var_53, 0) = ((MR_Box) ((MR_Unsigned) 18U));
                MR_hl_field(MR_mktag(3), Var_53, 1) = ((MR_Box) (MLDS_ModuleName_64));
                MR_hl_field(MR_mktag(3), Var_53, 2) = ((MR_Box) (RttiId_68));
              }
              {
                ArgRval_18 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), ArgRval_18, 0) = ((MR_Box) ((MR_Unsigned) 1U));
              ...
              }
              {
                ...
                MR_hl_field(MR_mktag(0), Var_54, 0) = ((MR_Box) (RttiId_68));
              }
              {
                ArgType_11 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), ArgType_11, 0) = ((MR_Box) ((MR_Unsigned) 8U));
