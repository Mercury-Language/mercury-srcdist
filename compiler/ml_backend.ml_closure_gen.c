          ...
          case (MR_Integer) 2:
            {
              ...
              else
              {
                ...
                ml_backend__rtti_to_mlds__add_rtti_data_to_mlds_5_p_0(ModuleInfo_7, Target_8, RttiData_51, STATE_VARIABLE_GlobalData_0_20, &STATE_VARIABLE_GlobalData_40_56);
                {
                  ...
                  MR_hl_field(MR_mktag(0), Var_57, 0) = ((MR_Box) (&ml_backend__ml_closure_gen_scalar_common_5[0]));
...
{
  {
    ...
    MR_Word WrapperParams0_41;
    MR_Word WrapperArgs0_42;
    MR_Word WrapperRetType_43;
    ...
    TypeInfo_128_128 = (MR_Word) &ml_backend__ml_closure_gen_scalar_common_1[0];
    ProcArity_28 = mercury__list__length_1_f_0(TypeInfo_128_128, ProcHeadVars_24);
    ...
    succeeded = mercury__list__drop_3_p_0(TypeInfo_128_128, NumClosureArgs_13, ProcHeadVars_24, &WrapperHeadVars0_31);
    if (succeeded)
    {
    ...
    NumWrapperHeadVars_39 = mercury__list__length_1_f_0(TypeInfo_128_128, WrapperHeadVars_35);
    ...
    ml_backend__ml_args_util__ml_gen_params_no_gc_stmts_8_p_0(ModuleInfo_18, PredOrFunc_23, CodeModel_26, WrapperHeadVars_35, WrapperHeadVarNames_40, WrapperBoxedArgTypes_38, WrapperArgModes_36, &WrapperParams0_41);
    WrapperArgs0_42 = ((MR_Word) (MR_hl_field(MR_mktag(0), WrapperParams0_41, (MR_Integer) 0)));
    WrapperRetType_43 = ((MR_Word) (MR_hl_field(MR_mktag(0), WrapperParams0_41, (MR_Integer) 1)));
      ...
      case (MR_Integer) 1:
        {
          ...
          ml_backend__ml_closure_gen__gen_closure_gc_statement_10_p_0(ClosureArgName_47, ClosureArgDeclType_48, ClosureKind_12, WrapperArgTypes_37, Purity_21, PredOrFunc_23, Context_14, &ClosureArgGCStmt_49, STATE_VARIABLE_Info_0_94, &STATE_VARIABLE_Info_100_100);
          {
          ...
          MaybeClosureA_44 = (MR_Word) MR_mkword(MR_mktag(1), &ml_backend__ml_closure_gen_scalar_common_3[11]);
          {
            ...
            MR_hl_field(MR_mktag(1), WrapperArgs_45, 1) = ((MR_Box) (WrapperArgs0_42));
          }
        }
        break;
      case (MR_Integer) 2:
        {
          ...
          WrapperArgs_45 = WrapperArgs0_42;
          STATE_VARIABLE_Info_100_100 = STATE_VARIABLE_Info_0_94;
        }
        break;
    }
    {
      ...
      MR_hl_field(MR_mktag(0), WrapperParams_51, 1) = ((MR_Box) (WrapperRetType_43));
    }
    ml_backend__ml_closure_gen__ml_gen_wrapper_arg_lvals_12_p_0(WrapperHeadVarNames_40, WrapperBoxedArgTypes_38, WrapperArgModes_36, PredOrFunc_23, CodeModel_26, Context_14, (MR_Integer) 1, &WrapperHeadVarDefns_52, &WrapperHeadVarLvals_53, &WrapperCopyOutLvals_54, STATE_VARIABLE_Info_100_100, &STATE_VARIABLE_Info_103_103);
    switch (CodeModel_26) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        STATE_VARIABLE_Info_110_110 = STATE_VARIABLE_Info_103_103;
        break;
      case (MR_Integer) 2:
        {
          ...
          ml_backend__ml_gen_info__ml_gen_info_get_nondet_copy_out_2_p_0(STATE_VARIABLE_Info_103_103, &NondetCopyOut_66);
          switch (NondetCopyOut_66) {
            default: /*NOTREACHED*/ MR_assert(0);
            case (MR_Integer) 0:
              {
                ml_backend__ml_code_util__ml_initial_cont_4_p_0(STATE_VARIABLE_Info_103_103, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), &InitialCont_70);
              }
              break;
            case (MR_Integer) 1:
              {
                MR_Word TypeCtorInfo_131_131 = (MR_Word) &ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_lval_0;
                MR_Word TypeCtorInfo_132_132 = (MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0;
                MR_Word WrapperBoxedVarTypes_67;
                MR_Word WrapperOutputLvals_68;
                MR_Word WrapperOutputTypes_69;

                mercury__map__from_corresponding_lists_3_p_0(TypeCtorInfo_131_131, TypeCtorInfo_132_132, WrapperHeadVarLvals_53, WrapperBoxedArgTypes_38, &WrapperBoxedVarTypes_67);
                WrapperOutputLvals_68 = check_hlds__mode_util__select_output_things_4_f_0(TypeCtorInfo_131_131, ModuleInfo_18, WrapperHeadVarLvals_53, WrapperArgModes_36, WrapperBoxedVarTypes_67);
                WrapperOutputTypes_69 = mercury__map__apply_to_list_2_f_0(TypeCtorInfo_131_131, TypeCtorInfo_132_132, WrapperOutputLvals_68, WrapperBoxedVarTypes_67);
                ml_backend__ml_code_util__ml_initial_cont_4_p_0(STATE_VARIABLE_Info_103_103, WrapperOutputLvals_68, WrapperOutputTypes_69, &InitialCont_70);
              }
              break;
          }
          ml_backend__ml_gen_info__ml_gen_info_push_success_cont_3_p_0(InitialCont_70, STATE_VARIABLE_Info_103_103, &STATE_VARIABLE_Info_110_110);
        }
        break;
      case (MR_Integer) 1:
        STATE_VARIABLE_Info_110_110 = STATE_VARIABLE_Info_103_103;
    ...
    if ((MaybeClosureA_44 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
    {
      ...
      STATE_VARIABLE_Info_114_114 = STATE_VARIABLE_Info_110_110;
    }
    else
    {
      ...
      MR_Tuple Var_104 = ((MR_Tuple) (MR_hl_field(MR_mktag(1), MaybeClosureA_44, (MR_Integer) 0)));
      MR_Word Var_106;
      MR_Tuple Var_107;

      ClosureArgType1_55 = ((MR_Word) (MR_hl_field(MR_mktag(0), Var_104, (MR_Integer) 0)));
      ClosureArgName1_56 = ((MR_Word) (MR_hl_field(MR_mktag(0), Var_104, (MR_Integer) 1)));
      ...
      ClosureLval1_71 = (MR_Word) MR_mkword(MR_mktag(3), &ml_backend__ml_closure_gen_scalar_common_2[3]);
      {
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(2), Var_106, 0) = ((MR_Box) (ClosureArgLval_62));
      }
      InitClosure_63 = ml_backend__ml_code_util__ml_gen_assign_3_f_0(ClosureLval1_71, Var_106, Context_14);
      {
        Var_107 = (MR_Tuple) MR_new_object(MR_Tuple, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), Var_107, 0) = ((MR_Box) (ClosureDefn_60));
        MR_hl_field(MR_mktag(0), Var_107, 1) = ((MR_Box) (InitClosure_63));
      }
      {
        MaybeClosureB_64 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), MaybeClosureB_64, 0) = ((MR_Box) (Var_107));
      }
      switch (ClosureKind_12) {
        default: /*NOTREACHED*/ MR_assert(0);
        case (MR_Integer) 0:
      ...
      ml_backend__ml_closure_gen__ml_gen_closure_field_lvals_7_p_0(ClosureLval1_71, Offset_72, (MR_Integer) 1, NumClosureArgs_13, &ClosureArgLvals_73, STATE_VARIABLE_Info_110_110, &STATE_VARIABLE_Info_114_114);
    }
    ...
    ml_backend__ml_call_gen__ml_gen_plain_non_tail_call_13_p_0(PredId_10, ProcId_11, ProcHeadVarNames_29, CallLvals_74, ProcBoxedArgTypes_30, CodeModel_26, Context_14, (MR_Integer) 1, &LocalVarDefns0_76, &FuncDefns_77, &Stmts0_78, STATE_VARIABLE_Info_114_114, &STATE_VARIABLE_Info_115_115);
    ...
    else
    {
      ...
      MR_Tuple Var_116 = ((MR_Tuple) (MR_hl_field(MR_mktag(1), MaybeClosureB_64, (MR_Integer) 0)));

      ClosureDefn1_79 = ((MR_Word) (MR_hl_field(MR_mktag(0), Var_116, (MR_Integer) 0)));
      InitClosure1_80 = ((MR_Word) (MR_hl_field(MR_mktag(0), Var_116, (MR_Integer) 1)));
      {
    ...
    ml_backend__ml_args_util__ml_append_return_statement_8_p_0(CodeModel_26, (MR_Integer) 0, WrapperCopyOutLvals_54, Context_14, Stmts1_82, &Stmts_85, STATE_VARIABLE_Info_115_115, &STATE_VARIABLE_Info_118_118);
    ...
    if (succeeded)
    {
      Var_119 = ((MR_Tuple) (MR_hl_field(MR_mktag(1), MaybeClosureA_44, (MR_Integer) 0)));
      ClosureArgType2_87 = ((MR_Word) (MR_hl_field(MR_mktag(0), Var_119, (MR_Integer) 0)));
      ClosureArgName2_88 = ((MR_Word) (MR_hl_field(MR_mktag(0), Var_119, (MR_Integer) 1)));
      Var_120 = (MR_Integer) 5;
      libs__globals__get_gc_method_2_p_0(Globals_86, &Var_135);
      succeeded = (Var_120 == Var_135);
    }
    if (succeeded)
      ml_backend__ml_closure_gen__ml_gen_closure_wrapper_gc_decls_9_p_0(ClosureKind_12, ClosureArgName2_88, ClosureArgType2_87, PredId_10, ProcId_11, Context_14, &GC_Defns_89, STATE_VARIABLE_Info_118_118, &STATE_VARIABLE_Info_121_121);
    else
    {
      GC_Defns_89 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
      STATE_VARIABLE_Info_121_121 = STATE_VARIABLE_Info_118_118;
    }
    TypeCtorInfo_134_134 = (MR_Word) &ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_local_var_defn_0;
    Var_122 = mercury__list__f_43_43_2_f_0(TypeCtorInfo_134_134, WrapperHeadVarDefns_52, LocalVarDefns2_83);
    LocalVarDefns_90 = mercury__list__f_43_43_2_f_0(TypeCtorInfo_134_134, GC_Defns_89, Var_122);
    switch (CodeModel_26) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        STATE_VARIABLE_Info_123_123 = STATE_VARIABLE_Info_121_121;
        break;
      case (MR_Integer) 2:
        ml_backend__ml_gen_info__ml_gen_info_pop_success_cont_2_p_0(STATE_VARIABLE_Info_121_121, &STATE_VARIABLE_Info_123_123);
        break;
      case (MR_Integer) 1:
        STATE_VARIABLE_Info_123_123 = STATE_VARIABLE_Info_121_121;
        break;
    ...
    WrapperFuncBody_91 = ml_backend__ml_code_util__ml_gen_block_4_f_0(LocalVarDefns_90, FuncDefns_77, Stmts_85, Context_14);
    {
      ...
      MR_hl_field(MR_mktag(1), Var_124, 0) = ((MR_Box) (WrapperParams_51));
    }
    ml_backend__ml_code_util__ml_gen_new_func_label_5_p_0(Var_124, &WrapperFuncName_92, WrapperFuncRval_15, STATE_VARIABLE_Info_123_123, &STATE_VARIABLE_Info_125_125);
    ml_backend__ml_closure_gen__ml_gen_wrapper_func_7_p_0(WrapperFuncName_92, WrapperParams_51, Context_14, WrapperFuncBody_91, &WrapperFuncDefn_93, STATE_VARIABLE_Info_125_125, &STATE_VARIABLE_Info_126_126);
    *WrapperFuncType_16 = (MR_Word) MR_mkword(MR_mktag(1), (MR_Word) WrapperParams_51);
    ml_backend__ml_gen_info__ml_gen_info_add_closure_wrapper_defn_3_p_0(WrapperFuncDefn_93, STATE_VARIABLE_Info_126_126, STATE_VARIABLE_Info_95);
  }
}
