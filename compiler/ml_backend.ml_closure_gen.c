...
ml_backend__ml_closure_gen__ml_gen_closure_wrapper_9_p_0_3(
  MR_Box ml_backend__ml_closure_gen__closure_arg,
  MR_Box ml_backend__ml_closure_gen__wrapper_arg_1);
...
static /* final */ const MR_Box ml_backend__ml_closure_gen_scalar_common_1[23][2];
...
static /* final */ const MR_Box ml_backend__ml_closure_gen_scalar_common_4[2][5];
...
static /* final */ const MR_Box ml_backend__ml_closure_gen_scalar_common_1[23][2] = {
  ...
  {
    ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 6)))),
    ((MR_Box) (MR_mkword(MR_mktag(1), &ml_backend__ml_closure_gen_scalar_common_1[4])))
  },
  /* row 6 */
  {
  ...
  {
    ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 6)))),
    ((MR_Box) (MR_mkword(MR_mktag(3), &ml_backend__ml_closure_gen_scalar_common_1[6])))
  },
  /* row 8 */
  {
    ((MR_Box) (MR_Word) ((MR_Integer) 3)),
  ...
  {
    ((MR_Box) (MR_Word) ((MR_Integer) 0)),
    ((MR_Box) (MR_mkword(MR_mktag(3), &ml_backend__ml_closure_gen_scalar_common_1[10])))
  },
  /* row 12 */
  {
  ...
  /* row 19 */
  {
    ((MR_Box) (MR_mkword(MR_mktag(1), &ml_backend__ml_closure_gen_scalar_common_3[6]))),
    ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))))
  },
  /* row 20 */
  {
    ((MR_Box) (MR_mkword(MR_mktag(1), &ml_backend__ml_closure_gen_scalar_common_3[8]))),
    ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))))
  },
  /* row 21 */
  {
...
static /* final */ const MR_Box ml_backend__ml_closure_gen_scalar_common_2[4][3] = {
  ...
  /* row 2 */
  {
    ((MR_Box) (&ml_backend__ml_closure_gen_scalar_common_4[1])),
  ...
  {
    ((MR_Box) (&ml_backend__ml_closure_gen_scalar_common_4[1])),
    ((MR_Box) (ml_backend__ml_closure_gen__ml_gen_closure_wrapper_9_p_0_3)),
    ((MR_Box) (MR_Word) ((MR_Integer) 0))
  },
};
...
static /* final */ const MR_Box ml_backend__ml_closure_gen_scalar_common_3[11][1] = {
  ...
  /* row 1 */
  {
    ((MR_Box) (&ml_backend__ml_closure_gen_scalar_common_1[7]))
  },
  /* row 2 */
  {
    ...
    if (ml_backend__ml_closure_gen__succeeded)
    ...
    else
      {
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(3), ml_backend__ml_closure_gen__Var_19, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 0));
        ...
        {
          ml_backend__ml_closure_gen__Var_24 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), ml_backend__ml_closure_gen__Var_24, 0) = ((MR_Box) (ml_backend__ml_closure_gen__ClosureLval_8));
        }
        {
          ml_backend__ml_closure_gen__FieldLval_15 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 5 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), ml_backend__ml_closure_gen__FieldLval_15, 0) = ((MR_Box) (MR_mkword(MR_mktag(1), &ml_backend__ml_closure_gen_scalar_common_3[3])));
...
{
  {
    ...
    MR_Word ml_backend__ml_closure_gen__ClosureLayoutPtrLval_22;
    MR_Word ml_backend__ml_closure_gen__TypeParamsType_24;
    MR_Word ml_backend__ml_closure_gen__TypeParamsLval_25;
    MR_Word ml_backend__ml_closure_gen__ClosureLayoutPtrGCInit_27;
    MR_Word ml_backend__ml_closure_gen__TypeParamsGCInitFragments_28;
    MR_Word ml_backend__ml_closure_gen__TypeParamsGCInit_31;
    MR_Word ml_backend__ml_closure_gen__ClosureLayoutPtrDecl_32;
    MR_Word ml_backend__ml_closure_gen__TypeParamsDecl_33;
    MR_Word ml_backend__ml_closure_gen__Var_94;
    MR_Word ml_backend__ml_closure_gen__Var_95;
    MR_Word ml_backend__ml_closure_gen__Var_98;
    MR_Word ml_backend__ml_closure_gen__Var_100;
    MR_Word ml_backend__ml_closure_gen__Var_101;
    ...
    ml_backend__ml_closure_gen__ClosureLayoutPtrType_21 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 6));
    {
      ml_backend__ml_code_util__ml_gen_var_lval_4_p_0(ml_backend__ml_closure_gen__STATE_VARIABLE_Info_0_34, (MR_Word) MR_mkword(MR_mktag(3), &ml_backend__ml_closure_gen_scalar_common_1[17]), ml_backend__ml_closure_gen__ClosureLayoutPtrType_21, &ml_backend__ml_closure_gen__ClosureLayoutPtrLval_22);
    }
    ml_backend__ml_closure_gen__TypeParamsType_24 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 6));
    {
      ml_backend__ml_code_util__ml_gen_var_lval_4_p_0(ml_backend__ml_closure_gen__STATE_VARIABLE_Info_0_34, (MR_Word) MR_mkword(MR_mktag(3), &ml_backend__ml_closure_gen_scalar_common_1[18]), ml_backend__ml_closure_gen__TypeParamsType_24, &ml_backend__ml_closure_gen__TypeParamsLval_25);
    }
    switch (ml_backend__ml_closure_gen__ClosureKind_10) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        {
          MR_Word ml_backend__ml_closure_gen__ClosureLayoutPtrGCInitFragments_26;
          ...
          MR_Word ml_backend__ml_closure_gen__Var_72;
          MR_Word ml_backend__ml_closure_gen__Var_73;
          MR_Word ml_backend__ml_closure_gen__Var_78;
          MR_Word ml_backend__ml_closure_gen__Var_79;
          MR_Word ml_backend__ml_closure_gen__Var_81;
          MR_Word ml_backend__ml_closure_gen__Var_82;
          MR_Word ml_backend__ml_closure_gen__Var_87;

          {
            ml_backend__ml_closure_gen__Var_67 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(3), ml_backend__ml_closure_gen__Var_67, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 0));
            MR_hl_field(MR_mktag(3), ml_backend__ml_closure_gen__Var_67, 1) = ((MR_Box) (ml_backend__ml_closure_gen__ClosureLayoutPtrLval_22));
          }
          {
            ...
            MR_hl_field(MR_mktag(1), ml_backend__ml_closure_gen__Var_73, 0) = ((MR_Box) (ml_backend__ml_closure_gen__ClosureArgLval_19));
          }
          {
            ml_backend__ml_closure_gen__Var_72 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(2), ml_backend__ml_closure_gen__Var_72, 0) = ((MR_Box) (ml_backend__ml_closure_gen__Var_73));
          }
          {
            ml_backend__ml_closure_gen__Var_71 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), ml_backend__ml_closure_gen__Var_71, 0) = ((MR_Box) (ml_backend__ml_closure_gen__Var_72));
            MR_hl_field(MR_mktag(1), ml_backend__ml_closure_gen__Var_71, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &ml_backend__ml_closure_gen_scalar_common_1[19])));
          }
          {
            ...
            MR_hl_field(MR_mktag(1), ml_backend__ml_closure_gen__Var_68, 0) = ((MR_Box) (MR_mkword(MR_mktag(1), &ml_backend__ml_closure_gen_scalar_common_3[5])));
            MR_hl_field(MR_mktag(1), ml_backend__ml_closure_gen__Var_68, 1) = ((MR_Box) (ml_backend__ml_closure_gen__Var_71));
          }
          {
            ml_backend__ml_closure_gen__ClosureLayoutPtrGCInitFragments_26 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), ml_backend__ml_closure_gen__ClosureLayoutPtrGCInitFragments_26, 0) = ((MR_Box) (ml_backend__ml_closure_gen__Var_67));
            MR_hl_field(MR_mktag(1), ml_backend__ml_closure_gen__ClosureLayoutPtrGCInitFragments_26, 1) = ((MR_Box) (ml_backend__ml_closure_gen__Var_68));
          }
          {
            ml_backend__ml_closure_gen__Var_79 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(3), ml_backend__ml_closure_gen__Var_79, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 6));
            MR_hl_field(MR_mktag(3), ml_backend__ml_closure_gen__Var_79, 1) = ((MR_Box) ((MR_Integer) 0));
            MR_hl_field(MR_mktag(3), ml_backend__ml_closure_gen__Var_79, 2) = ((MR_Box) (ml_backend__ml_closure_gen__ClosureLayoutPtrGCInitFragments_26));
          }
          {
            ml_backend__ml_closure_gen__Var_78 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(3), ml_backend__ml_closure_gen__Var_78, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 8));
            MR_hl_field(MR_mktag(3), ml_backend__ml_closure_gen__Var_78, 1) = ((MR_Box) (ml_backend__ml_closure_gen__Var_79));
          }
          {
            ml_backend__ml_closure_gen__ClosureLayoutPtrGCInit_27 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
            MR_hl_field(MR_mktag(0), ml_backend__ml_closure_gen__ClosureLayoutPtrGCInit_27, 0) = ((MR_Box) (ml_backend__ml_closure_gen__Var_78));
            MR_hl_field(MR_mktag(0), ml_backend__ml_closure_gen__ClosureLayoutPtrGCInit_27, 1) = ((MR_Box) (ml_backend__ml_closure_gen__MLDS_Context_18));
          }
          {
            ml_backend__ml_closure_gen__Var_81 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(3), ml_backend__ml_closure_gen__Var_81, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 0));
            MR_hl_field(MR_mktag(3), ml_backend__ml_closure_gen__Var_81, 1) = ((MR_Box) (ml_backend__ml_closure_gen__TypeParamsLval_25));
          }
          {
            ml_backend__ml_closure_gen__Var_87 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), ml_backend__ml_closure_gen__Var_87, 0) = ((MR_Box) (ml_backend__ml_closure_gen__Var_72));
            MR_hl_field(MR_mktag(1), ml_backend__ml_closure_gen__Var_87, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &ml_backend__ml_closure_gen_scalar_common_1[20])));
          }
          {
            ml_backend__ml_closure_gen__Var_82 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), ml_backend__ml_closure_gen__Var_82, 0) = ((MR_Box) (MR_mkword(MR_mktag(1), &ml_backend__ml_closure_gen_scalar_common_3[7])));
            MR_hl_field(MR_mktag(1), ml_backend__ml_closure_gen__Var_82, 1) = ((MR_Box) (ml_backend__ml_closure_gen__Var_87));
          }
          {
            ml_backend__ml_closure_gen__TypeParamsGCInitFragments_28 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), ml_backend__ml_closure_gen__TypeParamsGCInitFragments_28, 0) = ((MR_Box) (ml_backend__ml_closure_gen__Var_81));
            MR_hl_field(MR_mktag(1), ml_backend__ml_closure_gen__TypeParamsGCInitFragments_28, 1) = ((MR_Box) (ml_backend__ml_closure_gen__Var_82));
          }
      ...
      case (MR_Integer) 1:
        {
          MR_Word ml_backend__ml_closure_gen__ClosureLayoutRval_29;
          MR_Word ml_backend__ml_closure_gen__ClosureLayoutType_30;
          ...
          MR_Word ml_backend__ml_closure_gen__Var_56;
          ...
          {
            ml_backend__ml_closure_gen__ml_gen_closure_layout_7_p_0(ml_backend__ml_closure_gen__PredId_13, ml_backend__ml_closure_gen__ProcId_14, ml_backend__ml_closure_gen__Context_15, &ml_backend__ml_closure_gen__ClosureLayoutRval_29, &ml_backend__ml_closure_gen__ClosureLayoutType_30, ml_backend__ml_closure_gen__STATE_VARIABLE_Info_0_34, ml_backend__ml_closure_gen__STATE_VARIABLE_Info_35);
          }
          {
            ml_backend__ml_closure_gen__Var_45 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL);
            MR_hl_field(MR_mktag(0), ml_backend__ml_closure_gen__Var_45, 0) = ((MR_Box) (ml_backend__ml_closure_gen__ClosureLayoutType_30));
          }
          {
            ...
            MR_hl_field(MR_mktag(3), ml_backend__ml_closure_gen__Var_44, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 1));
            MR_hl_field(MR_mktag(3), ml_backend__ml_closure_gen__Var_44, 1) = ((MR_Box) (ml_backend__ml_closure_gen__Var_45));
            MR_hl_field(MR_mktag(3), ml_backend__ml_closure_gen__Var_44, 2) = ((MR_Box) (ml_backend__ml_closure_gen__ClosureLayoutRval_29));
          }
          {
            ml_backend__ml_closure_gen__Var_43 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(2), ml_backend__ml_closure_gen__Var_43, 0) = ((MR_Box) (ml_backend__ml_closure_gen__ClosureLayoutPtrLval_22));
            MR_hl_field(MR_mktag(2), ml_backend__ml_closure_gen__Var_43, 1) = ((MR_Box) (ml_backend__ml_closure_gen__Var_44));
          }
          {
            ml_backend__ml_closure_gen__Var_42 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(3), ml_backend__ml_closure_gen__Var_42, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 8));
            MR_hl_field(MR_mktag(3), ml_backend__ml_closure_gen__Var_42, 1) = ((MR_Box) (ml_backend__ml_closure_gen__Var_43));
          }
          {
            ml_backend__ml_closure_gen__ClosureLayoutPtrGCInit_27 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
            MR_hl_field(MR_mktag(0), ml_backend__ml_closure_gen__ClosureLayoutPtrGCInit_27, 0) = ((MR_Box) (ml_backend__ml_closure_gen__Var_42));
            MR_hl_field(MR_mktag(0), ml_backend__ml_closure_gen__ClosureLayoutPtrGCInit_27, 1) = ((MR_Box) (ml_backend__ml_closure_gen__MLDS_Context_18));
          }
          {
            ml_backend__ml_closure_gen__Var_46 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(3), ml_backend__ml_closure_gen__Var_46, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 0));
            MR_hl_field(MR_mktag(3), ml_backend__ml_closure_gen__Var_46, 1) = ((MR_Box) (ml_backend__ml_closure_gen__TypeParamsLval_25));
          }
          {
            ml_backend__ml_closure_gen__Var_56 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), ml_backend__ml_closure_gen__Var_56, 0) = ((MR_Box) (ml_backend__ml_closure_gen__ClosureArgLval_19));
          }
          {
            ml_backend__ml_closure_gen__Var_55 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(2), ml_backend__ml_closure_gen__Var_55, 0) = ((MR_Box) (ml_backend__ml_closure_gen__Var_56));
          }
          {
            ml_backend__ml_closure_gen__Var_62 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), ml_backend__ml_closure_gen__Var_62, 0) = ((MR_Box) (ml_backend__ml_closure_gen__ClosureLayoutPtrLval_22));
          }
          {
            ml_backend__ml_closure_gen__Var_61 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(2), ml_backend__ml_closure_gen__Var_61, 0) = ((MR_Box) (ml_backend__ml_closure_gen__Var_62));
          }
          {
            ml_backend__ml_closure_gen__Var_60 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), ml_backend__ml_closure_gen__Var_60, 0) = ((MR_Box) (ml_backend__ml_closure_gen__Var_61));
            MR_hl_field(MR_mktag(1), ml_backend__ml_closure_gen__Var_60, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &ml_backend__ml_closure_gen_scalar_common_1[20])));
          }
          {
            ...
            MR_hl_field(MR_mktag(1), ml_backend__ml_closure_gen__Var_57, 0) = ((MR_Box) (MR_mkword(MR_mktag(1), &ml_backend__ml_closure_gen_scalar_common_3[10])));
            MR_hl_field(MR_mktag(1), ml_backend__ml_closure_gen__Var_57, 1) = ((MR_Box) (ml_backend__ml_closure_gen__Var_60));
          }
          {
            ...
            MR_hl_field(MR_mktag(1), ml_backend__ml_closure_gen__Var_54, 0) = ((MR_Box) (ml_backend__ml_closure_gen__Var_55));
            MR_hl_field(MR_mktag(1), ml_backend__ml_closure_gen__Var_54, 1) = ((MR_Box) (ml_backend__ml_closure_gen__Var_57));
          }
          {
            ml_backend__ml_closure_gen__Var_47 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), ml_backend__ml_closure_gen__Var_47, 0) = ((MR_Box) (MR_mkword(MR_mktag(1), &ml_backend__ml_closure_gen_scalar_common_3[9])));
            MR_hl_field(MR_mktag(1), ml_backend__ml_closure_gen__Var_47, 1) = ((MR_Box) (ml_backend__ml_closure_gen__Var_54));
          }
          {
            ml_backend__ml_closure_gen__TypeParamsGCInitFragments_28 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), ml_backend__ml_closure_gen__TypeParamsGCInitFragments_28, 0) = ((MR_Box) (ml_backend__ml_closure_gen__Var_46));
            MR_hl_field(MR_mktag(1), ml_backend__ml_closure_gen__TypeParamsGCInitFragments_28, 1) = ((MR_Box) (ml_backend__ml_closure_gen__Var_47));
          }
        }
        break;
    }
    {
      ml_backend__ml_closure_gen__Var_95 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(3), ml_backend__ml_closure_gen__Var_95, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 6));
      MR_hl_field(MR_mktag(3), ml_backend__ml_closure_gen__Var_95, 1) = ((MR_Box) ((MR_Integer) 0));
      MR_hl_field(MR_mktag(3), ml_backend__ml_closure_gen__Var_95, 2) = ((MR_Box) (ml_backend__ml_closure_gen__TypeParamsGCInitFragments_28));
    }
    {
      ml_backend__ml_closure_gen__Var_94 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(3), ml_backend__ml_closure_gen__Var_94, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 8));
      MR_hl_field(MR_mktag(3), ml_backend__ml_closure_gen__Var_94, 1) = ((MR_Box) (ml_backend__ml_closure_gen__Var_95));
    }
    {
      ml_backend__ml_closure_gen__TypeParamsGCInit_31 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), ml_backend__ml_closure_gen__TypeParamsGCInit_31, 0) = ((MR_Box) (ml_backend__ml_closure_gen__Var_94));
      MR_hl_field(MR_mktag(0), ml_backend__ml_closure_gen__TypeParamsGCInit_31, 1) = ((MR_Box) (ml_backend__ml_closure_gen__MLDS_Context_18));
    }
    ml_backend__ml_closure_gen__Var_98 = (MR_Word) MR_mkword(MR_mktag(2), (MR_Word) ml_backend__ml_closure_gen__ClosureLayoutPtrGCInit_27);
    {
      ml_backend__ml_closure_gen__ClosureLayoutPtrDecl_32 = ml_backend__ml_code_util__ml_gen_mlds_var_decl_4_f_0((MR_Word) MR_mkword(MR_mktag(3), &ml_backend__ml_closure_gen_scalar_common_1[21]), ml_backend__ml_closure_gen__ClosureLayoutPtrType_21, ml_backend__ml_closure_gen__Var_98, ml_backend__ml_closure_gen__MLDS_Context_18);
    }
    ml_backend__ml_closure_gen__Var_100 = (MR_Word) MR_mkword(MR_mktag(2), (MR_Word) ml_backend__ml_closure_gen__TypeParamsGCInit_31);
    {
      ml_backend__ml_closure_gen__TypeParamsDecl_33 = ml_backend__ml_code_util__ml_gen_mlds_var_decl_4_f_0((MR_Word) MR_mkword(MR_mktag(3), &ml_backend__ml_closure_gen_scalar_common_1[22]), ml_backend__ml_closure_gen__TypeParamsType_24, ml_backend__ml_closure_gen__Var_100, ml_backend__ml_closure_gen__MLDS_Context_18);
    }
    {
      ml_backend__ml_closure_gen__Var_101 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), ml_backend__ml_closure_gen__Var_101, 0) = ((MR_Box) (ml_backend__ml_closure_gen__TypeParamsDecl_33));
      MR_hl_field(MR_mktag(1), ml_backend__ml_closure_gen__Var_101, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
    }
    {
      MR_Word base;
      base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      *ml_backend__ml_closure_gen__GC_Decls_16 = base;
      MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (ml_backend__ml_closure_gen__ClosureLayoutPtrDecl_32));
      MR_hl_field(MR_mktag(1), base, 1) = ((MR_Box) (ml_backend__ml_closure_gen__Var_101));
    }
  }
}
    ...
    if (ml_backend__ml_closure_gen__succeeded)
    ...
    else
      {
        ...
        if (ml_backend__ml_closure_gen__succeeded)
              ...
              case (MR_Integer) 1:
                {
                  ...
                  if (ml_backend__ml_closure_gen__succeeded)
                  ...
                  else
                    {
                      ...
                      {
                        ml_backend__ml_closure_gen__Var_48 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
                        MR_hl_field(MR_mktag(1), ml_backend__ml_closure_gen__Var_48, 0) = ((MR_Box) (ml_backend__ml_closure_gen__VarLval_34));
                      }
                      {
          ...
          {
            {
              mercury__require__unexpected_3_p_0((MR_String) "ml_backend.ml_closure_gen", (MR_String) "predicate \140ml_backend.ml_closure_gen.ml_gen_wrapper_arg_lvals\'/12", (MR_String) "length mismatch");
              return;
            }
          }
      }
    ...
    if (ml_backend__ml_closure_gen__succeeded)
    ...
    else
      {
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(3), ml_backend__ml_closure_gen__HeadVarName_7, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 3));
...
{
  {
    ...
    {
      ml_backend__ml_code_util__ml_gen_label_func_6_p_0(ml_backend__ml_closure_gen__STATE_VARIABLE_Info_0_26, ml_backend__ml_closure_gen__FuncLabel_8, ml_backend__ml_closure_gen__FuncParams_9, ml_backend__ml_closure_gen__Context_10, ml_backend__ml_closure_gen__Statement_11, &ml_backend__ml_closure_gen__FunctionDefn0_14);
    }
...
{
  {
    ...
    {
      ml_backend__ml_closure_gen__Var_25 = mercury__list__length_1_f_0(ml_backend__ml_closure_gen__TypeCtorInfo_31_31, ml_backend__ml_closure_gen__WrapperArgTypes_14);
    }
    {
      ml_backend__ml_closure_gen__Var_26 = parse_tree__builtin_lib_types__c_pointer_type_0_f_0();
    }
    {
      ml_backend__ml_closure_gen__HigherOrderArgTypes_20 = mercury__list__duplicate_2_f_0(ml_backend__ml_closure_gen__TypeCtorInfo_31_31, ml_backend__ml_closure_gen__Var_25, ((MR_Box) (ml_backend__ml_closure_gen__Var_26)));
    }
        ...
        if (ml_backend__ml_closure_gen__succeeded)
          {
            ...
            {
              ml_backend__ml_closure_gen__Var_23 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(2), ml_backend__ml_closure_gen__Var_23, 0) = ((MR_Box) (ml_backend__ml_closure_gen__LocnAsInt_15));
            }
            {
              ...
              MR_hl_field(MR_mktag(3), ml_backend__ml_closure_gen__Rval_16, 1) = ((MR_Box) (ml_backend__ml_closure_gen__Var_23));
            }
            {
            ...
            {
              ml_backend__ml_closure_gen__Var_24 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), ml_backend__ml_closure_gen__Var_24, 0) = ((MR_Box) (ml_backend__ml_closure_gen__Rval_16));
            }
            {
              MR_Word base;
              base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
              *ml_backend__ml_closure_gen__HeadVar__3_3 = base;
              MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (ml_backend__ml_closure_gen__Var_24));
...
{
  {
    ...
    *ml_backend__ml_closure_gen__ArrayType_14 = (MR_Word) MR_mkword(MR_mktag(3), &ml_backend__ml_closure_gen_scalar_common_1[13]);
    {
    ...
    if (ml_backend__ml_closure_gen__succeeded)
      {
        *ml_backend__ml_closure_gen__TVarVectorAddrRval_13 = (MR_Word) MR_mkword(MR_mktag(3), &ml_backend__ml_closure_gen_scalar_common_1[15]);
      ...
      case (MR_Integer) 0:
        {
          ...
          {
            ml_backend__ml_closure_gen__Var_37 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(3), ml_backend__ml_closure_gen__Var_37, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 1));
            MR_hl_field(MR_mktag(3), ml_backend__ml_closure_gen__Var_37, 1) = ((MR_Box) (ml_backend__ml_closure_gen__RttiId_18));
          }
          {
            ...
            MR_hl_field(MR_mktag(0), ml_backend__ml_closure_gen__DataAddr_20, 1) = ((MR_Box) (ml_backend__ml_closure_gen__Var_37));
          }
          ml_backend__ml_closure_gen__Var_38 = (MR_Word) MR_mkword(MR_mktag(1), (MR_Word) ml_backend__ml_closure_gen__DataAddr_20);
          {
            MR_Word base;
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(0), ml_backend__ml_closure_gen__Var_39, 0) = ((MR_Box) (ml_backend__ml_closure_gen__RttiId_18));
          }
          {
            MR_Word base;
            base = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
      ...
      case (MR_Integer) 2:
        {
          ...
          if (ml_backend__ml_closure_gen__succeeded)
          ...
          else
            {
              ...
              {
                ml_backend__ml_closure_gen__Var_30 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), ml_backend__ml_closure_gen__Var_30, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 1));
                MR_hl_field(MR_mktag(3), ml_backend__ml_closure_gen__Var_30, 1) = ((MR_Box) (ml_backend__ml_closure_gen__RttiId_47));
              }
              {
                ...
                MR_hl_field(MR_mktag(0), ml_backend__ml_closure_gen__DataAddr_42, 1) = ((MR_Box) (ml_backend__ml_closure_gen__Var_30));
              }
              ml_backend__ml_closure_gen__Var_31 = (MR_Word) MR_mkword(MR_mktag(1), (MR_Word) ml_backend__ml_closure_gen__DataAddr_42);
              {
                MR_Word base;
                base = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                *ml_backend__ml_closure_gen__Rval_9 = base;
              ...
              }
              {
                ...
                MR_hl_field(MR_mktag(0), ml_backend__ml_closure_gen__Var_32, 0) = ((MR_Box) (ml_backend__ml_closure_gen__RttiId_47));
              }
              {
                MR_Word base;
                base = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
              ...
              {
                ml_backend__ml_closure_gen__Var_34 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL);
                MR_hl_field(MR_mktag(0), ml_backend__ml_closure_gen__Var_34, 0) = ((MR_Box) (&ml_backend__ml_closure_gen_scalar_common_6[1]));
                MR_hl_field(MR_mktag(0), ml_backend__ml_closure_gen__Var_34, 1) = ((MR_Box) (ml_backend__ml_closure_gen__ml_gen_type_info_6_p_0_1));
                MR_hl_field(MR_mktag(0), ml_backend__ml_closure_gen__Var_34, 2) = ((MR_Box) (MR_Word) ((MR_Integer) 1));
                MR_hl_field(MR_mktag(0), ml_backend__ml_closure_gen__Var_34, 3) = ((MR_Box) (ml_backend__ml_closure_gen__ModuleInfo_7));
              }
              if (((MR_tag((MR_Word) ml_backend__ml_closure_gen__TypeInfo_8)) == (MR_mktag((MR_Integer) 1))))
                {
                  ...
                  ml_backend__ml_closure_gen__Var_35 = ((MR_Word) (MR_hl_field(MR_mktag(1), ml_backend__ml_closure_gen__TypeInfo_8, (MR_Integer) 1)));
                }
              else
                {
          ...
          case (MR_Integer) 0:
            {
              ...
              {
                ml_backend__ml_closure_gen__Var_44 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), ml_backend__ml_closure_gen__Var_44, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 1));
                MR_hl_field(MR_mktag(3), ml_backend__ml_closure_gen__Var_44, 1) = ((MR_Box) (ml_backend__ml_closure_gen__RttiId_25));
              }
              {
                ...
                MR_hl_field(MR_mktag(0), ml_backend__ml_closure_gen__DataAddr_27, 1) = ((MR_Box) (ml_backend__ml_closure_gen__Var_44));
              }
              ml_backend__ml_closure_gen__Var_45 = (MR_Word) MR_mkword(MR_mktag(1), (MR_Word) ml_backend__ml_closure_gen__DataAddr_27);
              {
                MR_Word base;
                base = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                *ml_backend__ml_closure_gen__Rval_9 = base;
              ...
              }
              {
                ...
                MR_hl_field(MR_mktag(0), ml_backend__ml_closure_gen__Var_46, 0) = ((MR_Box) (ml_backend__ml_closure_gen__RttiId_25));
              }
              {
                MR_Word base;
                base = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
              ...
              if (ml_backend__ml_closure_gen__succeeded)
              ...
              else
                {
                  ...
                  }
                  {
                    ml_backend__ml_closure_gen__Var_37 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(MR_mktag(3), ml_backend__ml_closure_gen__Var_37, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 1));
                    MR_hl_field(MR_mktag(3), ml_backend__ml_closure_gen__Var_37, 1) = ((MR_Box) (ml_backend__ml_closure_gen__RttiId_55));
                  }
                  {
                    ...
                    MR_hl_field(MR_mktag(0), ml_backend__ml_closure_gen__DataAddr_50, 1) = ((MR_Box) (ml_backend__ml_closure_gen__Var_37));
                  }
                  ml_backend__ml_closure_gen__Var_38 = (MR_Word) MR_mkword(MR_mktag(1), (MR_Word) ml_backend__ml_closure_gen__DataAddr_50);
                  {
                    MR_Word base;
                    base = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                    *ml_backend__ml_closure_gen__Rval_9 = base;
                  ...
                  {
                    ml_backend__ml_closure_gen__Var_39 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL);
                    MR_hl_field(MR_mktag(0), ml_backend__ml_closure_gen__Var_39, 0) = ((MR_Box) (ml_backend__ml_closure_gen__RttiId_55));
                  }
                  {
                    MR_Word base;
                    base = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                  ...
                  {
                    ml_backend__ml_closure_gen__Var_41 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL);
                    MR_hl_field(MR_mktag(0), ml_backend__ml_closure_gen__Var_41, 0) = ((MR_Box) (&ml_backend__ml_closure_gen_scalar_common_6[0]));
                    MR_hl_field(MR_mktag(0), ml_backend__ml_closure_gen__Var_41, 1) = ((MR_Box) (ml_backend__ml_closure_gen__ml_gen_pseudo_type_info_6_p_0_1));
                    MR_hl_field(MR_mktag(0), ml_backend__ml_closure_gen__Var_41, 2) = ((MR_Box) (MR_Word) ((MR_Integer) 1));
                    MR_hl_field(MR_mktag(0), ml_backend__ml_closure_gen__Var_41, 3) = ((MR_Box) (ml_backend__ml_closure_gen__ModuleInfo_7));
                  }
                  if (((MR_tag((MR_Word) ml_backend__ml_closure_gen__PseudoTypeInfo_8)) == (MR_mktag((MR_Integer) 1))))
                    {
                      ...
                      ml_backend__ml_closure_gen__Var_42 = ((MR_Word) (MR_hl_field(MR_mktag(1), ml_backend__ml_closure_gen__PseudoTypeInfo_8, (MR_Integer) 1)));
                    }
                  else
                    {
                      ...
                      ml_backend__ml_closure_gen__Var_42 = ((MR_Word) (MR_hl_field(MR_mktag(2), ml_backend__ml_closure_gen__PseudoTypeInfo_8, (MR_Integer) 1)));
                    }
                  {
                    mercury__list__foldl_4_p_0((MR_Word) &backend_libs__rtti__backend_libs__rtti__type_ctor_info_rtti_maybe_pseudo_type_info_0, (MR_Word) &ml_backend__ml_global_data__ml_backend__ml_global_data__type_ctor_info_ml_global_data_0, ml_backend__ml_closure_gen__Var_41, ml_backend__ml_closure_gen__Var_42, ((MR_Box) (ml_backend__ml_closure_gen__STATE_VARIABLE_GlobalData_40_40)), &ml_backend__ml_closure_gen__conv2_STATE_VARIABLE_GlobalData_36);
                  }
      ...
      case (MR_Integer) 3:
        {
          ...
          {
            ml_backend__ml_closure_gen__Var_47 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(2), ml_backend__ml_closure_gen__Var_47, 0) = ((MR_Box) (ml_backend__ml_closure_gen__N_12));
          }
          {
            MR_Word base;
            base = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
            *ml_backend__ml_closure_gen__Rval_9 = base;
            MR_hl_field(MR_mktag(3), base, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 0));
            MR_hl_field(MR_mktag(3), base, 1) = ((MR_Box) (ml_backend__ml_closure_gen__Var_47));
          }
      ...
      case (MR_Integer) 2:
        {
          ...
          MR_Word ml_backend__ml_closure_gen__RttiId_53;
...

          {
            ...
            MR_hl_field(MR_mktag(3), ml_backend__ml_closure_gen__RttiData_33, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 0));
            MR_hl_field(MR_mktag(3), ml_backend__ml_closure_gen__RttiData_33, 1) = ((MR_Box) (ml_backend__ml_closure_gen__TI_6));
          }
          {
            backend_libs__rtti__rtti_data_to_id_2_p_0(ml_backend__ml_closure_gen__RttiData_33, &ml_backend__ml_closure_gen__RttiId_53);
          }
          {
            ml_backend__ml_global_data__ml_global_data_get_pdup_rval_type_map_2_p_0(ml_backend__ml_closure_gen__STATE_VARIABLE_GlobalData_0_10, &ml_backend__ml_closure_gen__PDupRvalTypeMap_34);
          }
          {
            ml_backend__ml_closure_gen__succeeded = mercury__map__search_3_p_0((MR_Word) &backend_libs__rtti__backend_libs__rtti__type_ctor_info_rtti_id_0, (MR_Word) &ml_backend__ml_global_data__ml_backend__ml_global_data__type_ctor_info_ml_rval_and_type_0, ml_backend__ml_closure_gen__PDupRvalTypeMap_34, ((MR_Box) (ml_backend__ml_closure_gen__RttiId_53)), &ml_backend__ml_closure_gen__conv0_OldRvalType_35);
          }
          if (ml_backend__ml_closure_gen__succeeded)
            {
          ...
          if (ml_backend__ml_closure_gen__succeeded)
            *ml_backend__ml_closure_gen__STATE_VARIABLE_GlobalData_11 = ml_backend__ml_closure_gen__STATE_VARIABLE_GlobalData_0_10;
            ...
            {
              MR_Word ml_backend__ml_closure_gen__STATE_VARIABLE_GlobalData_33_39;
              ...
              {
                hlds__hlds_module__module_info_get_name_2_p_0(ml_backend__ml_closure_gen__ModuleInfo_5, &ml_backend__ml_closure_gen__ModuleName_46);
              }
              {
              ...
              {
                ml_backend__rtti_to_mlds__add_rtti_data_to_mlds_4_p_0(ml_backend__ml_closure_gen__ModuleInfo_5, ml_backend__ml_closure_gen__RttiData_33, ml_backend__ml_closure_gen__STATE_VARIABLE_GlobalData_0_10, &ml_backend__ml_closure_gen__STATE_VARIABLE_GlobalData_33_39);
              }
              {
                ml_backend__ml_closure_gen__Var_40 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL);
                MR_hl_field(MR_mktag(0), ml_backend__ml_closure_gen__Var_40, 0) = ((MR_Box) (&ml_backend__ml_closure_gen_scalar_common_6[1]));
                MR_hl_field(MR_mktag(0), ml_backend__ml_closure_gen__Var_40, 1) = ((MR_Box) (ml_backend__ml_closure_gen__ml_gen_type_info_defn_4_p_0_1));
                MR_hl_field(MR_mktag(0), ml_backend__ml_closure_gen__Var_40, 2) = ((MR_Box) (MR_Word) ((MR_Integer) 1));
                MR_hl_field(MR_mktag(0), ml_backend__ml_closure_gen__Var_40, 3) = ((MR_Box) (ml_backend__ml_closure_gen__ModuleInfo_5));
              }
              {
                ml_backend__ml_closure_gen__Var_41 = ml_backend__ml_closure_gen__arg_type_infos_1_f_0(ml_backend__ml_closure_gen__TI_6);
              }
              {
                mercury__list__foldl_4_p_0((MR_Word) &backend_libs__rtti__backend_libs__rtti__type_ctor_info_rtti_type_info_0, (MR_Word) &ml_backend__ml_global_data__ml_backend__ml_global_data__type_ctor_info_ml_global_data_0, ml_backend__ml_closure_gen__Var_40, ml_backend__ml_closure_gen__Var_41, ((MR_Box) (ml_backend__ml_closure_gen__STATE_VARIABLE_GlobalData_33_39)), &ml_backend__ml_closure_gen__conv2_STATE_VARIABLE_GlobalData_11);
              }
          ...
          case (MR_Integer) 0:
            {
              ...
              {
                ml_backend__ml_closure_gen__Var_59 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), ml_backend__ml_closure_gen__Var_59, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 1));
                MR_hl_field(MR_mktag(3), ml_backend__ml_closure_gen__Var_59, 1) = ((MR_Box) (ml_backend__ml_closure_gen__RttiId_42));
              }
              {
                ...
                MR_hl_field(MR_mktag(0), ml_backend__ml_closure_gen__DataAddr_44, 1) = ((MR_Box) (ml_backend__ml_closure_gen__Var_59));
              }
              ml_backend__ml_closure_gen__Var_60 = (MR_Word) MR_mkword(MR_mktag(1), (MR_Word) ml_backend__ml_closure_gen__DataAddr_44);
              {
                ...
                MR_hl_field(MR_mktag(3), ml_backend__ml_closure_gen__ArgRval_16, 1) = ((MR_Box) (ml_backend__ml_closure_gen__Var_60));
              }
              {
                ml_backend__ml_closure_gen__Var_61 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL);
                MR_hl_field(MR_mktag(0), ml_backend__ml_closure_gen__Var_61, 0) = ((MR_Box) (ml_backend__ml_closure_gen__RttiId_42));
              }
              {
                ...
                MR_hl_field(MR_mktag(3), ml_backend__ml_closure_gen__ArgType_9, 1) = ((MR_Box) (ml_backend__ml_closure_gen__Var_61));
              }
              ...
              if (ml_backend__ml_closure_gen__succeeded)
              ...
              else
                {
                  ...
                  }
                  {
                    ...
                    MR_hl_field(MR_mktag(3), ml_backend__ml_closure_gen__Var_52, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 1));
                    MR_hl_field(MR_mktag(3), ml_backend__ml_closure_gen__Var_52, 1) = ((MR_Box) (ml_backend__ml_closure_gen__RttiId_70));
                  }
                  {
                    ...
                    MR_hl_field(MR_mktag(0), ml_backend__ml_closure_gen__DataAddr_65, 1) = ((MR_Box) (ml_backend__ml_closure_gen__Var_52));
                  }
                  ml_backend__ml_closure_gen__Var_53 = (MR_Word) MR_mkword(MR_mktag(1), (MR_Word) ml_backend__ml_closure_gen__DataAddr_65);
                  {
                    ml_backend__ml_closure_gen__ArgRval_16 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(MR_mktag(3), ml_backend__ml_closure_gen__ArgRval_16, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 0));
                    MR_hl_field(MR_mktag(3), ml_backend__ml_closure_gen__ArgRval_16, 1) = ((MR_Box) (ml_backend__ml_closure_gen__Var_53));
                  }
                  {
                    ml_backend__ml_closure_gen__Var_54 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL);
                    MR_hl_field(MR_mktag(0), ml_backend__ml_closure_gen__Var_54, 0) = ((MR_Box) (ml_backend__ml_closure_gen__RttiId_70));
                  }
                  {
                    ml_backend__ml_closure_gen__ArgType_9 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(MR_mktag(3), ml_backend__ml_closure_gen__ArgType_9, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 7));
                    MR_hl_field(MR_mktag(3), ml_backend__ml_closure_gen__ArgType_9, 1) = ((MR_Box) (ml_backend__ml_closure_gen__Var_54));
                  }
                  {
                  ...
                  {
                    ml_backend__ml_closure_gen__Var_56 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL);
                    MR_hl_field(MR_mktag(0), ml_backend__ml_closure_gen__Var_56, 0) = ((MR_Box) (&ml_backend__ml_closure_gen_scalar_common_6[0]));
                    MR_hl_field(MR_mktag(0), ml_backend__ml_closure_gen__Var_56, 1) = ((MR_Box) (ml_backend__ml_closure_gen__ml_stack_layout_construct_closure_arg_rval_5_p_0_1));
                    MR_hl_field(MR_mktag(0), ml_backend__ml_closure_gen__Var_56, 2) = ((MR_Box) (MR_Word) ((MR_Integer) 1));
                    MR_hl_field(MR_mktag(0), ml_backend__ml_closure_gen__Var_56, 3) = ((MR_Box) (ml_backend__ml_closure_gen__ModuleInfo_6));
                  }
                  if (((MR_tag((MR_Word) ml_backend__ml_closure_gen__PseudoTypeInfo_15)) == (MR_mktag((MR_Integer) 1))))
                    {
                      ...
                      ml_backend__ml_closure_gen__Var_57 = ((MR_Word) (MR_hl_field(MR_mktag(1), ml_backend__ml_closure_gen__PseudoTypeInfo_15, (MR_Integer) 1)));
                    }
                  else
                    {
                      ...
                      ml_backend__ml_closure_gen__Var_57 = ((MR_Word) (MR_hl_field(MR_mktag(2), ml_backend__ml_closure_gen__PseudoTypeInfo_15, (MR_Integer) 1)));
                    }
                  {
                    mercury__list__foldl_4_p_0((MR_Word) &backend_libs__rtti__backend_libs__rtti__type_ctor_info_rtti_maybe_pseudo_type_info_0, (MR_Word) &ml_backend__ml_global_data__ml_backend__ml_global_data__type_ctor_info_ml_global_data_0, ml_backend__ml_closure_gen__Var_56, ml_backend__ml_closure_gen__Var_57, ((MR_Box) (ml_backend__ml_closure_gen__STATE_VARIABLE_GlobalData_40_55)), &ml_backend__ml_closure_gen__conv2_STATE_VARIABLE_GlobalData_19);
                  }
      ...
      case (MR_Integer) 3:
        {
...

          {
            ...
            MR_hl_field(MR_mktag(2), ml_backend__ml_closure_gen__Var_62, 0) = ((MR_Box) (ml_backend__ml_closure_gen__N_29));
          }
          {
            ml_backend__ml_closure_gen__ArgRval_16 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(3), ml_backend__ml_closure_gen__ArgRval_16, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 0));
            MR_hl_field(MR_mktag(3), ml_backend__ml_closure_gen__ArgRval_16, 1) = ((MR_Box) (ml_backend__ml_closure_gen__Var_62));
          }
...
{
  {
    ...
    ml_backend__ml_closure_gen__TVarLocnMap_20 = ((MR_Word) (MR_hl_field(MR_mktag(0), ml_backend__ml_closure_gen__ClosureLayoutInfo_15, (MR_Integer) 1)));
    {
      ...
      MR_hl_field(MR_mktag(0), ml_backend__ml_closure_gen__Var_67, 0) = ((MR_Box) (&ml_backend__ml_closure_gen_scalar_common_5[0]));
    ...
    {
      ml_backend__ml_closure_gen__Var_69 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(2), ml_backend__ml_closure_gen__Var_69, 0) = ((MR_Box) (ml_backend__ml_closure_gen__Length_62));
    }
    {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(3), ml_backend__ml_closure_gen__Var_36, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 1));
    ...
    *ml_backend__ml_closure_gen__ClosureLayoutType_12 = (MR_Word) MR_mkword(MR_mktag(3), &ml_backend__ml_closure_gen_scalar_common_1[12]);
    {
...
{
  {
    MR_Box ml_backend__ml_closure_gen__wrapper_arg_2;
    MR_Box ml_backend__ml_closure_gen__closure = ml_backend__ml_closure_gen__closure_arg;
    MR_Word ml_backend__ml_closure_gen__conv2_HeadVar__2_2;

    {
      ml_backend__ml_closure_gen__conv2_HeadVar__2_2 = ml_backend__mlds__wrap_data_defn_1_f_0(((MR_Word) ml_backend__ml_closure_gen__wrapper_arg_1));
    }
    ml_backend__ml_closure_gen__wrapper_arg_2 = ((MR_Box) (ml_backend__ml_closure_gen__conv2_HeadVar__2_2));
...
{
  {
    ...
    {
      ml_backend__ml_closure_gen__conv1_HeadVar__2_2 = ml_backend__mlds__wrap_data_defn_1_f_0(((MR_Word) ml_backend__ml_closure_gen__wrapper_arg_1));
    }
...
{
  {
    ...
    MR_Word ml_backend__ml_closure_gen__TypeCtorInfo_148_148;
    ...
    MR_Word ml_backend__ml_closure_gen__STATE_VARIABLE_Info_115_115;
    MR_Word ml_backend__ml_closure_gen__STATE_VARIABLE_Info_120_120;
    MR_Word ml_backend__ml_closure_gen__STATE_VARIABLE_Info_122_122;
    MR_Word ml_backend__ml_closure_gen__STATE_VARIABLE_Info_128_128;
    MR_Word ml_backend__ml_closure_gen__Var_129;
    MR_Word ml_backend__ml_closure_gen__Var_131;
    MR_Word ml_backend__ml_closure_gen__Var_132;
    MR_Word ml_backend__ml_closure_gen__STATE_VARIABLE_Info_134_134;
    MR_Word ml_backend__ml_closure_gen__Var_135;
    ...
    MR_Tuple ml_backend__ml_closure_gen__Var_126;
    MR_Word ml_backend__ml_closure_gen__Var_127;
    MR_Word ml_backend__ml_closure_gen__Var_154;
    ...
    {
      ml_backend__ml_closure_gen__Var_99 = mercury__list__length_1_f_0(ml_backend__ml_closure_gen__TypeInfo_139_139, ml_backend__ml_closure_gen__WrapperHeadVars_35);
    }
    {
    ...
    switch (ml_backend__ml_closure_gen__ClosureKind_12) {
      ...
      case (MR_Integer) 1:
        {
          MR_Word ml_backend__ml_closure_gen__ClosureArgName_47 = (MR_Word) MR_mkword(MR_mktag(3), &ml_backend__ml_closure_gen_scalar_common_1[6]);
          ...
          ml_backend__ml_closure_gen__MaybeClosureA_44 = (MR_Word) MR_mkword(MR_mktag(1), &ml_backend__ml_closure_gen_scalar_common_3[1]);
          {
    ...
    switch (ml_backend__ml_closure_gen__CodeModel_26) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        ml_backend__ml_closure_gen__STATE_VARIABLE_Info_115_115 = ml_backend__ml_closure_gen__STATE_VARIABLE_Info_106_106;
        break;
      case (MR_Integer) 2:
        {
          ...
          {
            libs__globals__lookup_bool_option_3_p_0(ml_backend__ml_closure_gen__Globals_67, (MR_Integer) 266, &ml_backend__ml_closure_gen__NondetCopyOut_68);
          }
          switch (ml_backend__ml_closure_gen__NondetCopyOut_68) {
            default: /*NOTREACHED*/ MR_assert(0);
            case (MR_Integer) 0:
              {
                {
                  ml_backend__ml_code_util__ml_initial_cont_4_p_0(ml_backend__ml_closure_gen__STATE_VARIABLE_Info_106_106, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), &ml_backend__ml_closure_gen__InitialCont_72);
                }
              }
              break;
            case (MR_Integer) 1:
              {
                MR_Word ml_backend__ml_closure_gen__TypeCtorInfo_145_145 = (MR_Word) &ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_lval_0;
                MR_Word ml_backend__ml_closure_gen__TypeCtorInfo_146_146 = (MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0;
                ...
                {
                  mercury__map__from_corresponding_lists_3_p_0(ml_backend__ml_closure_gen__TypeCtorInfo_145_145, ml_backend__ml_closure_gen__TypeCtorInfo_146_146, ml_backend__ml_closure_gen__WrapperHeadVarLvals_53, ml_backend__ml_closure_gen__WrapperBoxedArgTypes_38, &ml_backend__ml_closure_gen__WrapperBoxedVarTypes_69);
                }
                {
                  ml_backend__ml_closure_gen__WrapperOutputLvals_70 = check_hlds__mode_util__select_output_things_4_f_0(ml_backend__ml_closure_gen__TypeCtorInfo_145_145, ml_backend__ml_closure_gen__ModuleInfo_18, ml_backend__ml_closure_gen__WrapperHeadVarLvals_53, ml_backend__ml_closure_gen__WrapperArgModes_36, ml_backend__ml_closure_gen__WrapperBoxedVarTypes_69);
                }
                {
                  ml_backend__ml_closure_gen__WrapperOutputTypes_71 = mercury__map__apply_to_list_2_f_0(ml_backend__ml_closure_gen__TypeCtorInfo_145_145, ml_backend__ml_closure_gen__TypeCtorInfo_146_146, ml_backend__ml_closure_gen__WrapperOutputLvals_70, ml_backend__ml_closure_gen__WrapperBoxedVarTypes_69);
                }
                {
                  ml_backend__ml_code_util__ml_initial_cont_4_p_0(ml_backend__ml_closure_gen__STATE_VARIABLE_Info_106_106, ml_backend__ml_closure_gen__WrapperOutputLvals_70, ml_backend__ml_closure_gen__WrapperOutputTypes_71, &ml_backend__ml_closure_gen__InitialCont_72);
                }
              }
              break;
          }
          {
            ml_backend__ml_gen_info__ml_gen_info_push_success_cont_3_p_0(ml_backend__ml_closure_gen__InitialCont_72, ml_backend__ml_closure_gen__STATE_VARIABLE_Info_106_106, &ml_backend__ml_closure_gen__STATE_VARIABLE_Info_115_115);
          }
        }
        break;
      case (MR_Integer) 1:
    ...
    if ((ml_backend__ml_closure_gen__MaybeClosureA_44 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
      {
        ...
        ml_backend__ml_closure_gen__STATE_VARIABLE_Info_120_120 = ml_backend__ml_closure_gen__STATE_VARIABLE_Info_115_115;
      }
    else
      {
        ...
        MR_Word ml_backend__ml_closure_gen__Var_110;
        MR_Tuple ml_backend__ml_closure_gen__Var_111;

        ml_backend__ml_closure_gen__ClosureArgType1_56 = ((MR_Word) (MR_hl_field(MR_mktag(0), ml_backend__ml_closure_gen__Var_107, (MR_Integer) 0)));
        ml_backend__ml_closure_gen__ClosureArgName1_57 = ((MR_Word) (MR_hl_field(MR_mktag(0), ml_backend__ml_closure_gen__Var_107, (MR_Integer) 1)));
        ml_backend__ml_closure_gen__ClosureType_59 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 6));
        {
          ml_backend__ml_closure_gen__ClosureDecl_61 = ml_backend__ml_code_util__ml_gen_mlds_var_decl_4_f_0((MR_Word) MR_mkword(MR_mktag(3), &ml_backend__ml_closure_gen_scalar_common_1[9]), ml_backend__ml_closure_gen__ClosureType_59, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), ml_backend__ml_closure_gen__MLDS_Context_55);
        }
        {
          ml_backend__ml_code_util__ml_gen_var_lval_4_p_0(ml_backend__ml_closure_gen__STATE_VARIABLE_Info_106_106, (MR_Word) MR_mkword(MR_mktag(3), &ml_backend__ml_closure_gen_scalar_common_1[8]), ml_backend__ml_closure_gen__ClosureType_59, &ml_backend__ml_closure_gen__ClosureLval1_73);
        }
        {
          ml_backend__ml_code_util__ml_gen_var_lval_4_p_0(ml_backend__ml_closure_gen__STATE_VARIABLE_Info_106_106, ml_backend__ml_closure_gen__ClosureArgName1_57, ml_backend__ml_closure_gen__ClosureArgType1_56, &ml_backend__ml_closure_gen__ClosureArgLval_63);
        }
        {
          ml_backend__ml_closure_gen__Var_110 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), ml_backend__ml_closure_gen__Var_110, 0) = ((MR_Box) (ml_backend__ml_closure_gen__ClosureArgLval_63));
        }
        {
          ml_backend__ml_closure_gen__InitClosure_64 = ml_backend__ml_code_util__ml_gen_assign_3_f_0(ml_backend__ml_closure_gen__ClosureLval1_73, ml_backend__ml_closure_gen__Var_110, ml_backend__ml_closure_gen__Context_14);
        }
        {
          ml_backend__ml_closure_gen__Var_111 = (MR_Tuple) MR_new_object(MR_Tuple, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), ml_backend__ml_closure_gen__Var_111, 0) = ((MR_Box) (ml_backend__ml_closure_gen__ClosureDecl_61));
          MR_hl_field(MR_mktag(0), ml_backend__ml_closure_gen__Var_111, 1) = ((MR_Box) (ml_backend__ml_closure_gen__InitClosure_64));
        }
        {
          ...
          MR_hl_field(MR_mktag(1), ml_backend__ml_closure_gen__MaybeClosureB_65, 0) = ((MR_Box) (ml_backend__ml_closure_gen__Var_111));
        }
        switch (ml_backend__ml_closure_gen__ClosureKind_12) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 0:
        ...
        {
          ml_backend__ml_closure_gen__ml_gen_closure_field_lvals_7_p_0(ml_backend__ml_closure_gen__ClosureLval1_73, ml_backend__ml_closure_gen__Offset_74, (MR_Integer) 1, ml_backend__ml_closure_gen__NumClosureArgs_13, &ml_backend__ml_closure_gen__ClosureArgLvals_75, ml_backend__ml_closure_gen__STATE_VARIABLE_Info_115_115, &ml_backend__ml_closure_gen__STATE_VARIABLE_Info_120_120);
        }
      }
    {
    ...
    if ((ml_backend__ml_closure_gen__MaybeClosureB_65 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
    ...
    else
      {
        ...
        MR_Tuple ml_backend__ml_closure_gen__Var_123 = ((MR_Tuple) (MR_hl_field(MR_mktag(1), ml_backend__ml_closure_gen__MaybeClosureB_65, (MR_Integer) 0)));
        MR_Word ml_backend__ml_closure_gen__Var_124;

        ml_backend__ml_closure_gen__ClosureDecl1_79 = ((MR_Word) (MR_hl_field(MR_mktag(0), ml_backend__ml_closure_gen__Var_123, (MR_Integer) 0)));
        ml_backend__ml_closure_gen__InitClosure1_80 = ((MR_Word) (MR_hl_field(MR_mktag(0), ml_backend__ml_closure_gen__Var_123, (MR_Integer) 1)));
        ml_backend__ml_closure_gen__Var_124 = (MR_Word) MR_mkword(MR_mktag(0), (MR_Word) ml_backend__ml_closure_gen__ClosureDecl1_79);
        {
          ...
          MR_hl_field(MR_mktag(1), ml_backend__ml_closure_gen__Decls1_81, 0) = ((MR_Box) (ml_backend__ml_closure_gen__Var_124));
    ...
    if (ml_backend__ml_closure_gen__succeeded)
      {
        ml_backend__ml_closure_gen__Var_126 = ((MR_Tuple) (MR_hl_field(MR_mktag(1), ml_backend__ml_closure_gen__MaybeClosureA_44, (MR_Integer) 0)));
        ml_backend__ml_closure_gen__ClosureArgType2_86 = ((MR_Word) (MR_hl_field(MR_mktag(0), ml_backend__ml_closure_gen__Var_126, (MR_Integer) 0)));
        ml_backend__ml_closure_gen__ClosureArgName2_87 = ((MR_Word) (MR_hl_field(MR_mktag(0), ml_backend__ml_closure_gen__Var_126, (MR_Integer) 1)));
        ml_backend__ml_closure_gen__Var_127 = (MR_Integer) 5;
        {
          libs__globals__get_gc_method_2_p_0(ml_backend__ml_closure_gen__Globals_67, &ml_backend__ml_closure_gen__Var_154);
        }
        ml_backend__ml_closure_gen__succeeded = (ml_backend__ml_closure_gen__Var_127 == ml_backend__ml_closure_gen__Var_154);
      }
    if (ml_backend__ml_closure_gen__succeeded)
      {
        ml_backend__ml_closure_gen__ml_gen_closure_wrapper_gc_decls_9_p_0(ml_backend__ml_closure_gen__ClosureKind_12, ml_backend__ml_closure_gen__ClosureArgName2_87, ml_backend__ml_closure_gen__ClosureArgType2_86, ml_backend__ml_closure_gen__PredId_10, ml_backend__ml_closure_gen__ProcId_11, ml_backend__ml_closure_gen__Context_14, &ml_backend__ml_closure_gen__GC_Decls_88, ml_backend__ml_closure_gen__STATE_VARIABLE_Info_122_122, &ml_backend__ml_closure_gen__STATE_VARIABLE_Info_128_128);
      }
    else
      {
        ml_backend__ml_closure_gen__GC_Decls_88 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
        ml_backend__ml_closure_gen__STATE_VARIABLE_Info_128_128 = ml_backend__ml_closure_gen__STATE_VARIABLE_Info_122_122;
      }
    ml_backend__ml_closure_gen__TypeCtorInfo_148_148 = (MR_Word) &ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_defn_0;
    ml_backend__ml_closure_gen__TypeCtorInfo_149_149 = (MR_Word) &ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_data_defn_0;
    {
      ml_backend__ml_closure_gen__Var_129 = mercury__list__map_2_f_0(ml_backend__ml_closure_gen__TypeCtorInfo_149_149, ml_backend__ml_closure_gen__TypeCtorInfo_148_148, (MR_Word) &ml_backend__ml_closure_gen_scalar_common_2[2], ml_backend__ml_closure_gen__GC_Decls_88);
    }
    {
      ml_backend__ml_closure_gen__Var_132 = mercury__list__map_2_f_0(ml_backend__ml_closure_gen__TypeCtorInfo_149_149, ml_backend__ml_closure_gen__TypeCtorInfo_148_148, (MR_Word) &ml_backend__ml_closure_gen_scalar_common_2[3], ml_backend__ml_closure_gen__WrapperHeadVarDecls_52);
    }
    switch (ml_backend__ml_closure_gen__CodeModel_26) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
      case (MR_Integer) 2:
        {
          ...
          {
            ml_backend__ml_code_util__ml_append_return_statement_6_p_0(ml_backend__ml_closure_gen__STATE_VARIABLE_Info_122_122, ml_backend__ml_closure_gen__CodeModel_26, ml_backend__ml_closure_gen__WrapperCopyOutLvals_54, ml_backend__ml_closure_gen__Context_14, ml_backend__ml_closure_gen__Statements1_82, &ml_backend__ml_closure_gen__Statements_85);
          }
          switch (ml_backend__ml_closure_gen__CodeModel_26) {
            default: /*NOTREACHED*/ MR_assert(0);
            case (MR_Integer) 0:
              ml_backend__ml_closure_gen__STATE_VARIABLE_Info_134_134 = ml_backend__ml_closure_gen__STATE_VARIABLE_Info_128_128;
              break;
            case (MR_Integer) 2:
              {
                ml_backend__ml_gen_info__ml_gen_info_pop_success_cont_2_p_0(ml_backend__ml_closure_gen__STATE_VARIABLE_Info_128_128, &ml_backend__ml_closure_gen__STATE_VARIABLE_Info_134_134);
              }
              break;
          }
        }
      ...
      case (MR_Integer) 1:
        {
          ...
          ml_backend__ml_closure_gen__Var_125 = (MR_Word) MR_mkword(MR_mktag(0), (MR_Word) ml_backend__ml_closure_gen__SucceededVarDecl_84);
          {
            ...
            MR_hl_field(MR_mktag(1), ml_backend__ml_closure_gen__Decls2_83, 0) = ((MR_Box) (ml_backend__ml_closure_gen__Var_125));
    ...
    {
      ml_backend__ml_closure_gen__Var_131 = mercury__list__f_43_43_2_f_0(ml_backend__ml_closure_gen__TypeCtorInfo_148_148, ml_backend__ml_closure_gen__Var_132, ml_backend__ml_closure_gen__Decls2_83);
    }
    {
      ml_backend__ml_closure_gen__Decls_89 = mercury__list__f_43_43_2_f_0(ml_backend__ml_closure_gen__TypeCtorInfo_148_148, ml_backend__ml_closure_gen__Var_129, ml_backend__ml_closure_gen__Var_131);
    }
    {
    ...
    {
      ml_backend__ml_closure_gen__Var_135 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), ml_backend__ml_closure_gen__Var_135, 0) = ((MR_Box) (ml_backend__ml_closure_gen__WrapperParams_51));
    }
    {
      ml_backend__ml_code_util__ml_gen_new_func_label_5_p_0(ml_backend__ml_closure_gen__Var_135, &ml_backend__ml_closure_gen__WrapperFuncName_91, ml_backend__ml_closure_gen__WrapperFuncRval_15, ml_backend__ml_closure_gen__STATE_VARIABLE_Info_134_134, &ml_backend__ml_closure_gen__STATE_VARIABLE_Info_136_136);
    }
    {
