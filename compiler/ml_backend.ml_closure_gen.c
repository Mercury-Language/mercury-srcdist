      ...
      case (MR_Integer) 3:
        {
          ...
          *Type_12 = (MR_Word) (MR_mkword(MR_mktag(3), &ml_backend__ml_closure_gen_scalar_common_1[7]));
          *STATE_VARIABLE_GlobalData_37 = STATE_VARIABLE_GlobalData_0_36;
        }
        break;
    }
      ...
      case (MR_Integer) 3:
        {
          ...
          ArgType_11 = (MR_Word) (MR_mkword(MR_mktag(3), &ml_backend__ml_closure_gen_scalar_common_1[7]));
          *STATE_VARIABLE_GlobalData_21 = STATE_VARIABLE_GlobalData_0_20;
        }
        break;
    }
...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(3), NumArgsRval_29, 1) = ((MR_Box) (MR_mkword(MR_mktag(3), &ml_backend__ml_closure_gen_scalar_common_1[7])));
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(0), Var_52, 0) = ((MR_Box) (ClosureLayoutRval_33));
      MR_hl_field(MR_mktag(0), Var_52, 1) = ((MR_Box) ((MR_Unsigned) 20U));
      MR_hl_field(MR_mktag(0), Var_52, 2) = ((MR_Box) (MR_mkword(MR_mktag(1), &ml_backend__ml_closure_gen_scalar_common_1[3])));
    }
    {
      Var_59 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), Var_59, 0) = ((MR_Box) (WrapperFuncRval_31));
      MR_hl_field(MR_mktag(0), Var_59, 1) = ((MR_Box) ((MR_Unsigned) 20U));
      MR_hl_field(MR_mktag(0), Var_59, 2) = ((MR_Box) (MR_mkword(MR_mktag(1), &ml_backend__ml_closure_gen_scalar_common_1[4])));
    }
    {
      Var_66 = (MR_Word) MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), Var_66, 0) = ((MR_Box) (NumArgsRval_29));
      MR_hl_field(MR_mktag(0), Var_66, 1) = ((MR_Box) ((MR_Unsigned) 20U));
      MR_hl_field(MR_mktag(0), Var_66, 2) = ((MR_Box) (MR_mkword(MR_mktag(1), &ml_backend__ml_closure_gen_scalar_common_1[5])));
    }
    {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), ExtraArgRvalsTypes_35, 0) = ((MR_Box) (Var_52));
      MR_hl_field(MR_mktag(1), ExtraArgRvalsTypes_35, 1) = ((MR_Box) (Var_58));
    }
    ml_backend__ml_code_util__ml_variable_type_3_p_0(STATE_VARIABLE_Info_49_49, Var_14, &VarType_41);
    Var_74 = ml_backend__ml_code_util__ml_make_boxed_type_0_f_0();
    ml_backend__ml_unify_gen_util__specified_arg_types_and_consecutive_full_words_4_p_0((MR_Word) (&ml_backend__ml_closure_gen_scalar_common_1[0]), Var_74, (MR_Integer) 3, ArgVars_15, &ArgVarsTypesWidths_42);
...
{
  {
    ...
    else
    {
      ...
      ClosureDefn_64 = ml_backend__ml_code_util__ml_gen_mlds_var_decl_4_f_0((MR_Word) (MR_mkword(MR_mktag(3), &ml_backend__ml_closure_gen_scalar_common_1[25])), (MR_Word) ((MR_Unsigned) 20U), (MR_Word) ((MR_Unsigned) 0U), Context_14);
...
{
  {
    ...
    ClosureLayoutPtrDecl_31 = ml_backend__ml_code_util__ml_gen_mlds_var_decl_4_f_0((MR_Word) (MR_mkword(MR_mktag(3), &ml_backend__ml_closure_gen_scalar_common_1[14])), (MR_Word) ((MR_Unsigned) 20U), Var_91, Context_15);
    {
    ...
    TypeParamsDecl_32 = ml_backend__ml_code_util__ml_gen_mlds_var_decl_4_f_0((MR_Word) (MR_mkword(MR_mktag(3), &ml_backend__ml_closure_gen_scalar_common_1[15])), (MR_Word) ((MR_Unsigned) 20U), Var_92, Context_15);
    {
...
{
  {
    ...
    LengthType_66 = (MR_Word) (MR_mkword(MR_mktag(3), &ml_backend__ml_closure_gen_scalar_common_1[7]));
    {
...
{
  {
    ...
    *ArrayType_14 = (MR_Word) (MR_mkword(MR_mktag(3), &ml_backend__ml_closure_gen_scalar_common_1[8]));
    ...
    else
    {
      ...
      Var_41 = (MR_Integer) ((MR_Unsigned) TypeParamsLength_34 + (MR_Unsigned) (MR_Integer) 1);
      _VectorTypes_18 = mercury__list__duplicate_2_f_0((MR_Word) (&ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_type_0), Var_41, ((MR_Box) (MR_mkword(MR_mktag(3), &ml_backend__ml_closure_gen_scalar_common_1[7]))));
      {
