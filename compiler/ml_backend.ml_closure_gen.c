...
{
  {
    ...
    TypeInfo_132_132 = (MR_Word) &ml_backend__ml_closure_gen_scalar_common_1[0];
    ProcArity_28 = mercury__list__length_1_f_0(TypeInfo_132_132, ProcHeadVars_24);
    ...
    succeeded = mercury__list__drop_3_p_0(TypeInfo_132_132, NumClosureArgs_13, ProcHeadVars_24, &WrapperHeadVars0_31);
    if (succeeded)
    {
      TypeCtorInfo_133_133 = (MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_mode_0;
      succeeded = mercury__list__drop_3_p_0(TypeCtorInfo_133_133, NumClosureArgs_13, ProcArgModes_25, &WrapperArgModes0_32);
      if (succeeded)
      {
        TypeCtorInfo_134_134 = (MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0;
        succeeded = mercury__list__drop_3_p_0(TypeCtorInfo_134_134, NumClosureArgs_13, ProcArgTypes_22, &WrapperArgTypes0_33);
        if (succeeded)
          succeeded = mercury__list__drop_3_p_0(TypeCtorInfo_134_134, NumClosureArgs_13, ProcBoxedArgTypes_30, &WrapperBoxedArgTypes0_34);
      }
    }
    if (succeeded)
    {
    ...
    Var_99 = mercury__list__length_1_f_0(TypeInfo_132_132, WrapperHeadVars_35);
    ...
    TypeCtorInfo_135_135 = (MR_Word) &ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_argument_0;
    WrapperArgs1_43 = mercury__list__map_2_f_0(TypeCtorInfo_135_135, TypeCtorInfo_135_135, (MR_Word) &ml_backend__ml_closure_gen_scalar_common_2[3], WrapperArgs0_41);
      ...
      case (MR_Integer) 2:
        {
          ...
          switch (NondetCopyOut_67) {
            ...
            case (MR_Integer) 1:
              {
                MR_Word TypeCtorInfo_138_138 = (MR_Word) &ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_lval_0;
                MR_Word TypeCtorInfo_139_139 = (MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0;
                MR_Word WrapperBoxedVarTypes_68;
                MR_Word WrapperOutputLvals_69;
                MR_Word WrapperOutputTypes_70;

                mercury__map__from_corresponding_lists_3_p_0(TypeCtorInfo_138_138, TypeCtorInfo_139_139, WrapperHeadVarLvals_53, WrapperBoxedArgTypes_38, &WrapperBoxedVarTypes_68);
                WrapperOutputLvals_69 = check_hlds__mode_util__select_output_things_4_f_0(TypeCtorInfo_138_138, ModuleInfo_18, WrapperHeadVarLvals_53, WrapperArgModes_36, WrapperBoxedVarTypes_68);
                WrapperOutputTypes_70 = mercury__map__apply_to_list_2_f_0(TypeCtorInfo_138_138, TypeCtorInfo_139_139, WrapperOutputLvals_69, WrapperBoxedVarTypes_68);
    ...
    ml_backend__ml_args_util__ml_append_return_statement_8_p_0(CodeModel_26, (MR_Integer) 0, WrapperCopyOutLvals_54, Context_14, Stmts1_83, &Stmts_86, STATE_VARIABLE_Info_119_119, &STATE_VARIABLE_Info_122_122);
    succeeded = ((MR_tag((MR_Word) MaybeClosureA_44)) == (MR_mktag((MR_Integer) 1)));
    if (succeeded)
    {
      Var_123 = ((MR_Tuple) (MR_hl_field(MR_mktag(1), MaybeClosureA_44, (MR_Integer) 0)));
      ClosureArgType2_87 = ((MR_Word) (MR_hl_field(MR_mktag(0), Var_123, (MR_Integer) 0)));
      ClosureArgName2_88 = ((MR_Word) (MR_hl_field(MR_mktag(0), Var_123, (MR_Integer) 1)));
      Var_124 = (MR_Integer) 5;
      libs__globals__get_gc_method_2_p_0(Globals_66, &Var_142);
      succeeded = (Var_124 == Var_142);
    }
    if (succeeded)
      ml_backend__ml_closure_gen__ml_gen_closure_wrapper_gc_decls_9_p_0(ClosureKind_12, ClosureArgName2_88, ClosureArgType2_87, PredId_10, ProcId_11, Context_14, &GC_Defns_89, STATE_VARIABLE_Info_122_122, &STATE_VARIABLE_Info_125_125);
    else
    {
      GC_Defns_89 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
      STATE_VARIABLE_Info_125_125 = STATE_VARIABLE_Info_122_122;
    }
    TypeCtorInfo_141_141 = (MR_Word) &ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_local_var_defn_0;
    Var_126 = mercury__list__f_43_43_2_f_0(TypeCtorInfo_141_141, WrapperHeadVarDefns_52, LocalVarDefns2_84);
    LocalVarDefns_90 = mercury__list__f_43_43_2_f_0(TypeCtorInfo_141_141, GC_Defns_89, Var_126);
    switch (CodeModel_26) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        STATE_VARIABLE_Info_127_127 = STATE_VARIABLE_Info_125_125;
        break;
      case (MR_Integer) 2:
        ml_backend__ml_gen_info__ml_gen_info_pop_success_cont_2_p_0(STATE_VARIABLE_Info_125_125, &STATE_VARIABLE_Info_127_127);
        break;
      case (MR_Integer) 1:
        STATE_VARIABLE_Info_127_127 = STATE_VARIABLE_Info_125_125;
        break;
    ...
    {
      Var_128 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(MR_mktag(1), Var_128, 0) = ((MR_Box) (WrapperParams_51));
    }
    ml_backend__ml_code_util__ml_gen_new_func_label_5_p_0(Var_128, &WrapperFuncName_92, WrapperFuncRval_15, STATE_VARIABLE_Info_127_127, &STATE_VARIABLE_Info_129_129);
    ml_backend__ml_closure_gen__ml_gen_wrapper_func_7_p_0(WrapperFuncName_92, WrapperParams_51, Context_14, WrapperFuncBody_91, &WrapperFuncDefn_93, STATE_VARIABLE_Info_129_129, &STATE_VARIABLE_Info_130_130);
    *WrapperFuncType_16 = (MR_Word) MR_mkword(MR_mktag(1), (MR_Word) WrapperParams_51);
    ml_backend__ml_gen_info__ml_gen_info_add_closure_wrapper_defn_3_p_0(WrapperFuncDefn_93, STATE_VARIABLE_Info_130_130, STATE_VARIABLE_Info_95);
  }
}
