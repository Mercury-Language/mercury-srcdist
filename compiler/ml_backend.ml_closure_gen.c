  ...
  MR_Word * STATE_VARIABLE_Info_98)
{
  ...
  if (succeeded)
  {
    ...
    succeeded = mercury__list__drop_3_p_0(TypeCtorInfo_131_131, NumClosureArgs_13, ProcArgModes_25, &WrapperArgModes0_33);
    if (succeeded)
    {
      TypeCtorInfo_132_132 = (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0);
      succeeded = mercury__list__drop_3_p_0(TypeCtorInfo_132_132, NumClosureArgs_13, ProcArgTypes_22, &WrapperArgTypes0_34);
      if (succeeded)
        succeeded = mercury__list__drop_3_p_0(TypeCtorInfo_132_132, NumClosureArgs_13, ProcBoxedArgTypes_31, &WrapperBoxedArgTypes0_35);
    }
  }
  if (succeeded)
  {
