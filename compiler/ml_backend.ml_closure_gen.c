      ...
      case (MR_Integer) 0:
        {
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(3), ml_backend__ml_closure_gen__Var_35, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 15));
          ...
          if (ml_backend__ml_closure_gen__succeeded)
          ...
          else
            {
              ...
              }
              {
                ...
                MR_hl_field(MR_mktag(3), ml_backend__ml_closure_gen__Var_29, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 15));
          ...
          case (MR_Integer) 0:
            {
              ...
              }
              {
                ...
                MR_hl_field(MR_mktag(3), ml_backend__ml_closure_gen__Var_42, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 15));
              ...
              if (ml_backend__ml_closure_gen__succeeded)
              ...
              else
                {
                  ...
                  }
                  {
                    ...
                    MR_hl_field(MR_mktag(3), ml_backend__ml_closure_gen__Var_36, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 15));
          ...
          case (MR_Integer) 0:
            {
              ...
              }
              {
                ...
                MR_hl_field(MR_mktag(3), ml_backend__ml_closure_gen__Var_57, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 15));
              ...
              if (ml_backend__ml_closure_gen__succeeded)
              ...
              else
                {
                  ...
                  }
                  {
                    ...
                    MR_hl_field(MR_mktag(3), ml_backend__ml_closure_gen__Var_51, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 15));
...
{
  {
      ...
      case (MR_Integer) 1:
        {
          ...
          ml_backend__ml_closure_gen__MaybeClosureA_44 = (MR_Word) MR_mkword(MR_mktag(1), &ml_backend__ml_closure_gen_scalar_common_3[12]);
          {
    ...
    if ((ml_backend__ml_closure_gen__MaybeClosureA_44 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
    ...
    else
      {
        ...
        {
          ml_backend__ml_closure_gen__ClosureDecl_60 = ml_backend__ml_code_util__ml_gen_mlds_var_decl_4_f_0((MR_Word) &ml_backend__ml_closure_gen_scalar_common_3[13], ml_backend__ml_closure_gen__ClosureType_58, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), ml_backend__ml_closure_gen__Context_14);
        }
        {
          ml_backend__ml_code_util__ml_gen_var_lval_4_p_0(ml_backend__ml_closure_gen__STATE_VARIABLE_Info_104_104, (MR_Word) MR_mkword(MR_mktag(3), &ml_backend__ml_closure_gen_scalar_common_1[16]), ml_backend__ml_closure_gen__ClosureType_58, &ml_backend__ml_closure_gen__ClosureLval1_72);
        }
        {
        ...
        {
          ml_backend__ml_closure_gen__Var_108 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(2), ml_backend__ml_closure_gen__Var_108, 0) = ((MR_Box) (ml_backend__ml_closure_gen__ClosureArgLval_62));
        }
        {
...
{
  {
    ...
    {
      ml_backend__ml_closure_gen__ClosureLayoutPtrDecl_31 = ml_backend__ml_code_util__ml_gen_mlds_var_decl_4_f_0((MR_Word) &ml_backend__ml_closure_gen_scalar_common_3[10], ml_backend__ml_closure_gen__ClosureLayoutPtrType_20, ml_backend__ml_closure_gen__Var_93, ml_backend__ml_closure_gen__Context_15);
    }
    {
    ...
    {
      ml_backend__ml_closure_gen__TypeParamsDecl_32 = ml_backend__ml_code_util__ml_gen_mlds_var_decl_4_f_0((MR_Word) &ml_backend__ml_closure_gen_scalar_common_3[11], ml_backend__ml_closure_gen__TypeParamsType_23, ml_backend__ml_closure_gen__Var_95, ml_backend__ml_closure_gen__Context_15);
    }
    {
