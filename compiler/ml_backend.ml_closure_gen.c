      ...
      case (MR_Integer) 2:
        {
          ...
          else
          {
            ...
            {
              MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), TypeInfo_10, (MR_Integer) 0)));
          ...
          case (MR_Integer) 2:
            {
              ...
              else
              {
                ...
                {
                  MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), PseudoTypeInfo_10, (MR_Integer) 0)));
          ...
          case (MR_Integer) 2:
            {
              ...
              else
              {
                ...
                {
                  MR_Unsigned packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), PseudoTypeInfo_17, (MR_Integer) 0)));
...
{
  {
    ...
    *ArrayType_14 = (MR_Word) (MR_mkword(MR_mktag(3), &ml_backend__ml_closure_gen_scalar_common_1[7]));
    ...
    else
    {
      ...
      {
        Vector_16 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
...
{
  {
    ...
    else
    {
      ...
      packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), HeadArgTuple_20, (MR_Integer) 3)));
