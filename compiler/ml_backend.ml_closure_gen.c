...
MR_def_label(ml_backend__ml_closure_gen__ml_stack_layout_construct_type_param_locn_vector_3_0,18)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_tag_alloc_heap(MR_r2, 1, (MR_Integer) 2);
	MR_tfield(1, MR_r2, 0) = (MR_Word) MR_TAG_COMMON(1,1,1);
...
MR_def_label(ml_backend__ml_closure_gen__ml_gen_closure_wrapper_gc_decls_9_0,33)
	...
	MR_tfield(2, MR_r1, 0) = MR_tempr5;
	MR_tag_alloc_heap(MR_tempr6, 1, (MR_Integer) 2);
	MR_r5 = MR_tempr6;
	MR_tfield(1, MR_tempr6, 0) = MR_r1;
	MR_tfield(1, MR_tempr6, 1) = (MR_Word) MR_TAG_COMMON(1,3,3);
	MR_tag_alloc_heap(MR_r1, 1, (MR_Integer) 2);
	MR_tfield(1, MR_r1, 0) = (MR_Word) MR_TAG_COMMON(1,6,7);
	...
	MR_tag_alloc_heap(MR_r1, 1, (MR_Integer) 2);
	MR_tfield(1, MR_r1, 0) = (MR_Word) MR_TAG_COMMON(1,6,6);
	MR_tfield(1, MR_r1, 1) = MR_tempr7;
	MR_tag_alloc_heap(MR_tempr8, 1, (MR_Integer) 2);
	MR_sv(1) = MR_tempr8;
	MR_tfield(1, MR_tempr8, 0) = MR_r2;
	MR_tfield(1, MR_tempr8, 1) = MR_r1;
	MR_tag_alloc_heap(MR_r1, 2, (MR_Integer) 1);
...
MR_def_label(ml_backend__ml_closure_gen__ml_stack_layout_construct_closure_arg_rval_5_0,2)
	...
	MR_r2 = MR_tag(MR_r1);
	if (((MR_r2 == MR_mktag((MR_Integer) 1)) || (MR_r2 == MR_mktag((MR_Integer) 2)))) {
...
MR_def_label(ml_backend__ml_closure_gen__ml_stack_layout_construct_closure_arg_rval_5_0,50)
	...
	MR_tag_alloc_heap(MR_r2, 3, (MR_Integer) 3);
	MR_tfield(3, MR_r2, 0) = (MR_Integer) 0;
	MR_tfield(3, MR_r2, 1) = (MR_Word) MR_TAG_COMMON(0,1,5);
