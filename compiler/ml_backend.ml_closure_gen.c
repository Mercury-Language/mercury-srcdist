...
{
  {
    ...
    *ClosureLayoutType_12 = (MR_Word) MR_mkword(MR_mktag(3), &ml_backend__ml_closure_gen_scalar_common_1[10]);
    ...
    ml_backend__ml_global_data__ml_gen_static_scalar_const_addr_8_p_0(MLDS_ModuleName_29, (MR_Integer) 4, *ClosureLayoutType_12, Var_42, Context_10, ClosureLayoutAddrRval_11, STATE_VARIABLE_GlobalData_36_36, &STATE_VARIABLE_GlobalData_43_43);
