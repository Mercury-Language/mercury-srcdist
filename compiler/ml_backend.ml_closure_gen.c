  ...
  MR_Word * STATE_VARIABLE_Info_97)
{
  ...
  MR_Word Var_119;
  MR_Word STATE_VARIABLE_Info_6_123;
  MR_Word Var_124;
  MR_Word STATE_VARIABLE_Info_7_125;
  MR_Word Var_126;
  MR_Word STATE_VARIABLE_Info_8_127;
  ...
  Var_119 = mercury__set_tree234__init_0_f_0((MR_Word) (&hlds__mark_tail_calls__hlds__mark_tail_calls__type_ctor_info_later_op_0));
  {
    Var_117 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(1, Var_117, 0) = ((MR_Box) (Var_119));
  }
  ml_backend__ml_call_gen__ml_gen_plain_non_tail_call_11_p_1(Var_116, CodeModel_26, Context_14, ForClosureWrapperArgs_76, Var_117, Features_77, &LocalVarDefns0_78, &FuncDefns_79, &Stmts0_80, STATE_VARIABLE_Info_4_115, &STATE_VARIABLE_Info_5_118);
  ...
  else
  {
    ...
    MR_Tuple Var_120 = ((MR_Tuple) ((MR_hl_field(1, MaybeClosureB_68, 0))));

    ClosureDefn1_81 = ((MR_Word) ((MR_hl_field(0, Var_120, 0))));
    InitClosure1_82 = ((MR_Word) ((MR_hl_field(0, Var_120, 1))));
    {
  ...
  if (succeeded)
  {
    Var_121 = ((MR_Tuple) ((MR_hl_field(1, MaybeClosureA_45, 0))));
    ClosureArgType2_89 = ((MR_Word) ((MR_hl_field(0, Var_121, 0))));
    ClosureArgName2_90 = ((MR_Word) ((MR_hl_field(0, Var_121, 1))));
    Var_122 = (MR_Integer) 5;
    libs__globals__get_gc_method_2_p_0(Globals_88, &Var_135);
    succeeded = (Var_122 == Var_135);
  }
  if (succeeded)
    ml_backend__ml_closure_gen__ml_gen_closure_wrapper_gc_decls_9_p_0(ClosureKind_12, ClosureArgName2_90, ClosureArgType2_89, PredId_10, ProcId_11, Context_14, &GC_Defns_91, STATE_VARIABLE_Info_5_118, &STATE_VARIABLE_Info_6_123);
  else
  {
    GC_Defns_91 = (MR_Word) ((MR_Unsigned) 0U);
    STATE_VARIABLE_Info_6_123 = STATE_VARIABLE_Info_5_118;
  }
  Var_124 = mercury__list__f_43_43_2_f_0((MR_Word) (&ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_local_var_defn_0), WrapperHeadVarDefns_55, LocalVarDefns2_85);
  LocalVarDefns_92 = mercury__list__f_43_43_2_f_0((MR_Word) (&ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_local_var_defn_0), GC_Defns_91, Var_124);
  switch (CodeModel_26) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 0:
      STATE_VARIABLE_Info_7_125 = STATE_VARIABLE_Info_6_123;
      break;
    case (MR_Integer) 2:
      ml_backend__ml_gen_info__ml_gen_info_pop_success_cont_2_p_0(STATE_VARIABLE_Info_6_123, &STATE_VARIABLE_Info_7_125);
      break;
    case (MR_Integer) 1:
      STATE_VARIABLE_Info_7_125 = STATE_VARIABLE_Info_6_123;
      break;
  ...
  WrapperFuncBody_93 = ml_backend__ml_code_util__ml_gen_block_4_f_0(LocalVarDefns_92, FuncDefns_79, Stmts_87, Context_14);
  {
    ...
    MR_hl_field(1, Var_126, 0) = ((MR_Box) (WrapperParams_52));
  }
  ml_backend__ml_code_util__ml_gen_new_func_label_5_p_0(Var_126, &WrapperFuncName_94, WrapperFuncRval_15, STATE_VARIABLE_Info_7_125, &STATE_VARIABLE_Info_8_127);
  ml_backend__ml_closure_gen__ml_gen_wrapper_func_6_p_0(STATE_VARIABLE_Info_8_127, WrapperFuncName_94, WrapperParams_52, Context_14, WrapperFuncBody_93, &WrapperFuncDefn_95);
  {
    MR_Word base;
    base = (MR_Word) MR_mkword(3, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
  ...
  ml_backend__ml_gen_info__ml_gen_info_add_closure_wrapper_defn_3_p_0(WrapperFuncDefn_95, STATE_VARIABLE_Info_8_127, STATE_VARIABLE_Info_97);
}
