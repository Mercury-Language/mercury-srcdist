    ...
    case (MR_Integer) 2:
      {
        ...
        else
        {
          ...
          if (((MR_tag((MR_Word) TypeInfo_10)) == (MR_Integer) 1))
            ...
            Var_37 = ((MR_Word) ((MR_hl_field(2, TypeInfo_10, (MR_Integer) 1))));
        ...
        case (MR_Integer) 2:
          {
            ...
            else
            {
              ...
              if (((MR_tag((MR_Word) PseudoTypeInfo_10)) == (MR_Integer) 1))
                ...
                Var_46 = ((MR_Word) ((MR_hl_field(2, PseudoTypeInfo_10, (MR_Integer) 1))));
        ...
        case (MR_Integer) 0:
          {
            ...
            }
            {
              ...
              MR_hl_field(3, ArgType_11, 0) = ((MR_Box) ((MR_Unsigned) 8U));
        ...
        case (MR_Integer) 2:
          {
            ...
            else
            {
              ...
              if (((MR_tag((MR_Word) PseudoTypeInfo_17)) == (MR_Integer) 1))
                ...
                Var_41 = ((MR_Word) ((MR_hl_field(2, PseudoTypeInfo_17, (MR_Integer) 1))));
  ...
  MR_Word * STATE_VARIABLE_Info_97)
{
  ...
  *WrapperFuncType_16 = (MR_Word) (MR_mkword(2, (MR_Word) (WrapperParams_52)));
  ...
  MR_Word * STATE_VARIABLE_Info_31)
{
  ...
  }
  {
    ...
    MR_hl_field(1, Var_56, 0) = ((MR_Box) (CastLengthRval_50));
  }
  {
    LengthInitAndType_52 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(0, LengthInitAndType_52, 0) = ((MR_Box) (Var_56));
  ...
  else
  {
    ...
    {
      Var_76 = (MR_Word) MR_mkword(2, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(2, Var_76, 0) = ((MR_Box) (TypeParamsLength_72));
    }
    {
      LengthRval_73 = (MR_Word) MR_mkword(3, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(3, LengthRval_73, 0) = ((MR_Box) ((MR_Unsigned) 1U));
      MR_hl_field(3, LengthRval_73, 1) = ((MR_Box) (Var_76));
    }
    {
      Var_77 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(1, Var_77, 0) = ((MR_Box) (LengthRval_73));
    }
    {
      Vector_61 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(1, Vector_61, 0) = ((MR_Box) (Var_77));
      MR_hl_field(1, Vector_61, 1) = ((MR_Box) (TypeParamLocs_71));
    }
    Var_79 = (MR_Integer) ((MR_Unsigned) TypeParamsLength_72 + (MR_Unsigned) 1);
    _VectorTypes_62 = mercury__list__duplicate_2_f_0((MR_Word) (&ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_type_0), Var_79, ((MR_Box) (MR_mkword(3, &ml_backend__ml_closure_gen_scalar_common_1[3]))));
    {
      Initializer_63 = (MR_Word) MR_mkword(3, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(3, Initializer_63, 0) = ((MR_Box) (Vector_61));
    }
