  ...
  MR_Word * STATE_VARIABLE_Info_97)
{
  ...
  MR_Word STATE_VARIABLE_Info_9_127;
  ...
  ml_backend__ml_closure_gen__ml_gen_wrapper_func_7_p_0(WrapperFuncName_94, WrapperParams_52, Context_14, WrapperFuncBody_93, &WrapperFuncDefn_95, STATE_VARIABLE_Info_8_126, &STATE_VARIABLE_Info_9_127);
  {
    MR_Word base;
    base = (MR_Word) MR_mkword(3, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
  ...
  ml_backend__ml_gen_info__ml_gen_info_add_closure_wrapper_defn_3_p_0(WrapperFuncDefn_95, STATE_VARIABLE_Info_9_127, STATE_VARIABLE_Info_97);
}
