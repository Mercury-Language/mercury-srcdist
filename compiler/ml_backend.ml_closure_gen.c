...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(0), Var_52, 2) = ((MR_Box) (MR_mkword(MR_mktag(1), &ml_backend__ml_closure_gen_scalar_common_1[4])));
    }
    {
      ...
      MR_hl_field(MR_mktag(0), Var_59, 2) = ((MR_Box) (MR_mkword(MR_mktag(1), &ml_backend__ml_closure_gen_scalar_common_1[5])));
    }
    {
      ...
      MR_hl_field(MR_mktag(0), Var_66, 2) = ((MR_Box) (MR_mkword(MR_mktag(1), &ml_backend__ml_closure_gen_scalar_common_1[6])));
    }
    {
