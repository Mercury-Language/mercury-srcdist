...
MR_decl_label8(backend_libs__c_util__output_quoted_multi_string_3_0, 15,4,5,6,7,8,9,17)
...
MR_decl_label1(fn__backend_libs__c_util__quote_string_1_0, 2)
...
MR_BEGIN_MODULE(backend_libs__c_util_module7)
	...
	MR_init_label8(backend_libs__c_util__output_quoted_multi_string_3_0,15,4,5,6,7,8,9,17)
MR_BEGIN_CODE
...
MR_define_entry(mercury__backend_libs__c_util__output_quoted_multi_string_3_0);
	...
	MR_incr_sp(3);
	MR_sv(3) = (MR_Word) MR_succip;
MR_def_label(backend_libs__c_util__output_quoted_multi_string_3_0,15)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TEST(MR_r1,0,0)) {
		MR_GOTO_LAB(backend_libs__c_util__output_quoted_multi_string_3_0_i17);
	}
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
...
MR_def_label(backend_libs__c_util__output_quoted_multi_string_3_0,9)
	...
	MR_r1 = MR_sv(2);
	MR_succip_word = MR_sv(3);
	MR_GOTO_LAB(backend_libs__c_util__output_quoted_multi_string_3_0_i15);
MR_def_label(backend_libs__c_util__output_quoted_multi_string_3_0,17)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(3);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
...
MR_BEGIN_MODULE(backend_libs__c_util_module8)
	...
	MR_init_label1(fn__backend_libs__c_util__quote_string_1_0,2)
MR_BEGIN_CODE
...
MR_define_entry(mercury__fn__backend_libs__c_util__quote_string_1_0);
	...
	MR_np_call_localret_ent(string__foldl_4_1,
		fn__backend_libs__c_util__quote_string_1_0_i2);
MR_def_label(fn__backend_libs__c_util__quote_string_1_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_succip_word = MR_sv(1);
	MR_decr_sp(1);
	MR_np_tailcall_ent(string__from_rev_char_list_2_0);
