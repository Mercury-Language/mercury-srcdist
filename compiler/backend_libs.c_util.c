                ...
                case (MR_Integer) 0:
                  {
                    ...
                    mercury__char__to_int_2_p_0(Char_8, &Int_54);
                    backend_libs__c_util__octal_escape_any_int_2_p_0(Int_54, &EscapeChars_42);
                  }
                  break;
                case (MR_Integer) 2:
                  {
                    MR_Integer Int_57;
                    MR_String HexString_58;
                    MR_String Var_64;

                    mercury__char__to_int_2_p_0(Char_8, &Int_57);
                    mercury__string__format__format_unsigned_int_component_width_noprec_5_p_0((MR_Word) (&backend_libs__c_util_scalar_common_2[1]), (MR_Integer) 4, (MR_Integer) 2, Int_57, &Var_64);
                    HexString_58 = mercury__string__f_43_43_2_f_0((MR_String) "\\u", Var_64);
                    mercury__string__to_char_list_2_p_0(HexString_58, &EscapeChars_42);
                  }
                  break;
                case (MR_Integer) 1:
                  {
                    ...
                    mercury__char__to_int_2_p_0(Char_8, &Int_75);
                    backend_libs__c_util__octal_escape_any_int_2_p_0(Int_75, &EscapeChars_42);
                  }
                  break;
              }
