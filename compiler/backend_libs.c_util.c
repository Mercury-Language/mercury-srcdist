  ...
  MR_String S0_3)
{
  ...
  mercury__string__format__format_unsigned_int_component_width_noprec_5_p_0((MR_Word) (&backend_libs__c_util_scalar_common_2[2]), (MR_Integer) 4, (MR_Integer) 2, Lo_7, &Var_19);
  mercury__string__format__format_unsigned_int_component_width_noprec_5_p_0((MR_Word) (&backend_libs__c_util_scalar_common_2[2]), (MR_Integer) 4, (MR_Integer) 2, Hi_6, &Var_28);
    ...
    else
    {
      ...
      else
      {
        ...
        else
        {
          ...
          mercury__string__format__format_unsigned_int_component_width_noprec_5_p_0((MR_Word) (&backend_libs__c_util_scalar_common_2[2]), (MR_Integer) 4, (MR_Integer) 2, CharInt_8, &Var_52);
  ...
  MR_String Str_6)
{
  while (MR_TRUE)
  {
    ...
    // setup for model_det tailcalls optimized into a loop
    ;
    mercury__string__split_by_codepoint_4_p_0(Str_6, (MR_Integer) 160, &LeftSubStr_8, &RightSubStr_9);
    mercury__io__write_char_4_p_0(Stream_5, (MR_Char) 34);
      ...
      else
      {
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            ...
            mercury__list__map_3_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0), (MR_Word) (&backend_libs__c_util_scalar_common_1[0]), (MR_Word) (&backend_libs__c_util_scalar_common_4[2]), CodeUnits_9, &EscapeCharss_10);
  ...
  MR_String String_3)
{
  ...
  mercury__string__foldl_4_p_1((MR_Word) (&backend_libs__c_util_scalar_common_1[0]), (MR_Word) (&backend_libs__c_util_scalar_common_4[1]), String_3, ((MR_Box) ((MR_Unsigned) 0U)), &conv1_RevQuotedChars_5);
  ...
  MR_String String_3)
{
  ...
  mercury__string__foldl_4_p_1((MR_Word) (&backend_libs__c_util_scalar_common_1[0]), (MR_Word) (&backend_libs__c_util_scalar_common_4[0]), String_3, ((MR_Box) (MR_mkword(MR_mktag(1), &backend_libs__c_util_scalar_common_1[2]))), &conv1_RevQuotedChars0_5);
