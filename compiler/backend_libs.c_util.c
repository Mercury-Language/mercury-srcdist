...
MR_decl_label8(backend_libs__c_util__binop_category_string_3_0, 3,4,5,6,7,8,9,10)
MR_decl_label8(backend_libs__c_util__binop_category_string_3_0, 11,12,13,14,15,16,17,18)
MR_decl_label8(backend_libs__c_util__binop_category_string_3_0, 19,20,21,22,23,24,25,26)
MR_decl_label8(backend_libs__c_util__binop_category_string_3_0, 27,28,29,30,31,32,33,34)
MR_decl_label7(backend_libs__c_util__binop_category_string_3_0, 35,36,37,38,39,40,41)
...
MR_decl_label8(backend_libs__c_util__quote_one_char_3_0, 12,3,2,21,23,18,16,27)
MR_decl_label5(backend_libs__c_util__quote_one_char_3_0, 26,31,32,33,34)
...
MR_BEGIN_MODULE(backend_libs__c_util_module0)
	...
	MR_init_label8(backend_libs__c_util__quote_one_char_3_0,12,3,2,21,23,18,16,27)
	MR_init_label5(backend_libs__c_util__quote_one_char_3_0,26,31,32,33,34)
MR_BEGIN_CODE
...
MR_def_label(backend_libs__c_util__quote_one_char_3_0,21)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_r1) {
		MR_GOTO_LAB(backend_libs__c_util__quote_one_char_3_0_i18);
	}
	MR_r1 = MR_sv(1);
	MR_r2 = MR_sv(2);
...
MR_def_label(backend_libs__c_util__quote_one_char_3_0,27)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(backend_libs__c_util__quote_one_char_3_0_i26);
	}
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 2);
...
MR_def_label(backend_libs__c_util__quote_one_char_3_0,26)
	...
	MR_np_call_localret_ent(char__to_int_2_0,
		backend_libs__c_util__quote_one_char_3_0_i31);
MR_def_label(backend_libs__c_util__quote_one_char_3_0,31)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = (MR_Integer) 8;
	MR_np_call_localret_ent(string__int_to_base_string_3_0,
		backend_libs__c_util__quote_one_char_3_0_i32);
MR_def_label(backend_libs__c_util__quote_one_char_3_0,32)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = (MR_Integer) 48;
	MR_r3 = (MR_Integer) 3;
	MR_np_call_localret_ent(string__pad_left_4_0,
		backend_libs__c_util__quote_one_char_3_0_i33);
MR_def_label(backend_libs__c_util__quote_one_char_3_0,33)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_np_call_localret_ent(fn__string__to_char_list_1_0,
		backend_libs__c_util__quote_one_char_3_0_i34);
MR_def_label(backend_libs__c_util__quote_one_char_3_0,34)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 2);
...
MR_BEGIN_MODULE(backend_libs__c_util_module12)
	...
	MR_init_label8(backend_libs__c_util__binop_category_string_3_0,3,4,5,6,7,8,9,10)
	MR_init_label8(backend_libs__c_util__binop_category_string_3_0,11,12,13,14,15,16,17,18)
	MR_init_label8(backend_libs__c_util__binop_category_string_3_0,19,20,21,22,23,24,25,26)
	MR_init_label8(backend_libs__c_util__binop_category_string_3_0,27,28,29,30,31,32,33,34)
	MR_init_label7(backend_libs__c_util__binop_category_string_3_0,35,36,37,38,39,40,41)
MR_BEGIN_CODE
