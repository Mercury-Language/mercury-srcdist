...
MR_decl_label8(backend_libs__c_util__always_reset_line_num_2_0, 2,3,7,8,9,12,11,14)
MR_decl_label1(backend_libs__c_util__always_reset_line_num_2_0, 16)
MR_decl_label8(backend_libs__c_util__always_set_line_num_4_0, 5,6,7,10,9,12,2,14)
MR_decl_label1(backend_libs__c_util__always_set_line_num_4_0, 18)
...
MR_decl_label8(backend_libs__c_util__do_output_quoted_string_6_0, 79,8,10,3,4,11,12,13)
MR_decl_label6(backend_libs__c_util__do_output_quoted_string_6_0, 14,15,20,21,16,81)
...
MR_decl_label8(backend_libs__c_util__quote_one_char_4_0, 5,4,2,18,19,20,21,22)
MR_decl_label8(backend_libs__c_util__quote_one_char_4_0, 23,24,25,26,17,16,35,37)
MR_decl_label8(backend_libs__c_util__quote_one_char_4_0, 32,30,43,40,41,46,45,50)
MR_decl_label3(backend_libs__c_util__quote_one_char_4_0, 51,52,53)
MR_decl_label2(backend_libs__c_util__reset_line_num_2_0, 2,3)
MR_decl_label2(backend_libs__c_util__set_line_num_4_0, 2,3)
...
MR_BEGIN_MODULE(backend_libs__c_util_module0)
	...
	MR_init_label8(backend_libs__c_util__quote_one_char_4_0,5,4,2,18,19,20,21,22)
	MR_init_label8(backend_libs__c_util__quote_one_char_4_0,23,24,25,26,17,16,35,37)
	MR_init_label8(backend_libs__c_util__quote_one_char_4_0,32,30,43,40,41,46,45,50)
	MR_init_label3(backend_libs__c_util__quote_one_char_4_0,51,52,53)
MR_BEGIN_CODE
...
MR_def_label(backend_libs__c_util__quote_one_char_4_0,19)
	...
	if (MR_INT_NE(MR_r2,9)) {
		MR_GOTO_LAB(backend_libs__c_util__quote_one_char_4_0_i20);
	}
	MR_sv(1) = MR_r1;
	MR_sv(2) = MR_r2;
	MR_sv(3) = MR_r3;
	...
	MR_GOTO_LAB(backend_libs__c_util__quote_one_char_4_0_i17);
MR_def_label(backend_libs__c_util__quote_one_char_4_0,20)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r2,10)) {
		MR_GOTO_LAB(backend_libs__c_util__quote_one_char_4_0_i21);
	}
	MR_sv(1) = MR_r1;
	MR_sv(2) = MR_r2;
	MR_sv(3) = MR_r3;
	...
	MR_GOTO_LAB(backend_libs__c_util__quote_one_char_4_0_i17);
MR_def_label(backend_libs__c_util__quote_one_char_4_0,21)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r2,11)) {
		MR_GOTO_LAB(backend_libs__c_util__quote_one_char_4_0_i22);
	}
	MR_sv(1) = MR_r1;
	MR_sv(2) = MR_r2;
	MR_sv(3) = MR_r3;
	...
	MR_GOTO_LAB(backend_libs__c_util__quote_one_char_4_0_i17);
MR_def_label(backend_libs__c_util__quote_one_char_4_0,22)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_def_label(backend_libs__c_util__quote_one_char_4_0,23)
	...
	if (MR_INT_NE(MR_r2,13)) {
		MR_GOTO_LAB(backend_libs__c_util__quote_one_char_4_0_i24);
	}
	MR_sv(1) = MR_r1;
	MR_sv(2) = MR_r2;
	MR_sv(3) = MR_r3;
	...
	MR_GOTO_LAB(backend_libs__c_util__quote_one_char_4_0_i17);
MR_def_label(backend_libs__c_util__quote_one_char_4_0,24)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_def_label(backend_libs__c_util__quote_one_char_4_0,25)
	...
	if (MR_INT_NE(MR_r2,39)) {
		MR_GOTO_LAB(backend_libs__c_util__quote_one_char_4_0_i26);
	}
	MR_sv(1) = MR_r1;
	MR_sv(2) = MR_r2;
	MR_sv(3) = MR_r3;
	MR_r1 = (MR_Integer) 39;
	MR_GOTO_LAB(backend_libs__c_util__quote_one_char_4_0_i17);
MR_def_label(backend_libs__c_util__quote_one_char_4_0,26)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_def_label(backend_libs__c_util__quote_one_char_4_0,35)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_r1) {
		MR_GOTO_LAB(backend_libs__c_util__quote_one_char_4_0_i32);
	}
	MR_r1 = MR_sv(1);
	MR_r2 = MR_sv(2);
	{
	...
	MR_np_call_localret_ent(string__contains_char_2_0,
		backend_libs__c_util__quote_one_char_4_0_i37);
...
MR_def_label(backend_libs__c_util__quote_one_char_4_0,30)
	...
	MR_r3 = MR_sv(3);
	if (MR_INT_NE(MR_r1,1)) {
		MR_GOTO_LAB(backend_libs__c_util__quote_one_char_4_0_i41);
	}
	MR_r1 = MR_tempr1;
	}
...
MR_def_label(backend_libs__c_util__quote_one_char_4_0,43)
	...
	if (MR_INT_LT(MR_r1,128)) {
		MR_GOTO_LAB(backend_libs__c_util__quote_one_char_4_0_i40);
	}
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 2);
...
MR_def_label(backend_libs__c_util__quote_one_char_4_0,40)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_sv(2);
	MR_r3 = MR_sv(3);
MR_def_label(backend_libs__c_util__quote_one_char_4_0,41)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r2;
...
MR_def_label(backend_libs__c_util__quote_one_char_4_0,50)
	...
	MR_np_call_localret_ent(string__int_to_base_string_3_0,
		backend_libs__c_util__quote_one_char_4_0_i51);
...
MR_def_label(backend_libs__c_util__quote_one_char_4_0,52)
	...
	MR_np_call_localret_ent(fn__string__to_char_list_1_0,
		backend_libs__c_util__quote_one_char_4_0_i53);
MR_def_label(backend_libs__c_util__quote_one_char_4_0,53)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 2);
...
MR_BEGIN_MODULE(backend_libs__c_util_module1)
	...
	MR_init_label8(backend_libs__c_util__do_output_quoted_string_6_0,79,8,10,3,4,11,12,13)
	MR_init_label6(backend_libs__c_util__do_output_quoted_string_6_0,14,15,20,21,16,81)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(backend_libs__c_util_module5)
	...
	MR_init_label8(backend_libs__c_util__always_reset_line_num_2_0,2,3,7,8,9,12,11,14)
	MR_init_label1(backend_libs__c_util__always_reset_line_num_2_0,16)
MR_BEGIN_CODE
...
#line 1193 "backend_libs.c_util.c"
	MR_RELEASE_GLOBAL_LOCK("can_print_directly");
...
MR_BEGIN_MODULE(backend_libs__c_util_module6)
	...
	MR_init_label2(backend_libs__c_util__reset_line_num_2_0,2,3)
MR_BEGIN_CODE


/*-------------------------------------------------------------------------*/
/* code for 'reset_line_num'/2 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
...
MR_def_label(backend_libs__c_util__reset_line_num_2_0,2)
	...
	if (MR_INT_EQ(MR_r1,0)) {
		MR_GOTO_LAB(backend_libs__c_util__reset_line_num_2_0_i3);
	}
...
MR_BEGIN_MODULE(backend_libs__c_util_module7)
	...
	MR_init_label8(backend_libs__c_util__always_set_line_num_4_0,5,6,7,10,9,12,2,14)
	MR_init_label1(backend_libs__c_util__always_set_line_num_4_0,18)
MR_BEGIN_CODE
...
MR_define_entry(mercury__backend_libs__c_util__always_set_line_num_4_0);
	...
	if (MR_INT_LE(MR_r2,0)) {
		MR_GOTO_LAB(backend_libs__c_util__always_set_line_num_4_0_i2);
	}
	if ((strcmp((char *) (MR_Word *) MR_r1, MR_string_const("", 0)) == 0)) {
		MR_GOTO_LAB(backend_libs__c_util__always_set_line_num_4_0_i2);
	}
...
#line 1354 "backend_libs.c_util.c"
	MR_RELEASE_GLOBAL_LOCK("can_print_directly");
	MR_r2 = CanPrintDirectly;
#undef	MR_PROC_LABEL
	}
...
MR_def_label(backend_libs__c_util__always_set_line_num_4_0,12)
	...
	MR_decr_sp(3);
	MR_np_tailcall_ent(io__write_string_3_0);
MR_def_label(backend_libs__c_util__always_set_line_num_4_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Integer) 118;
	MR_np_call_localret_ent(libs__globals__io_lookup_bool_option_4_0,
		backend_libs__c_util__always_set_line_num_4_0_i14);
MR_def_label(backend_libs__c_util__always_set_line_num_4_0,14)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_EQ(MR_r1,0)) {
		MR_GOTO_LAB(backend_libs__c_util__always_set_line_num_4_0_i18);
	}
	MR_succip_word = MR_sv(3);
	MR_decr_sp(3);
	MR_np_tailcall_ent(backend_libs__c_util__always_reset_line_num_2_0);
MR_def_label(backend_libs__c_util__always_set_line_num_4_0,18)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(3);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
...
MR_BEGIN_MODULE(backend_libs__c_util_module8)
	...
	MR_init_label2(backend_libs__c_util__set_line_num_4_0,2,3)
MR_BEGIN_CODE


/*-------------------------------------------------------------------------*/
/* code for 'set_line_num'/4 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
...
/*-------------------------------------------------------------------------*/
/* code for 'output_c_file_intro_and_grade'/4 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
