...
{
  {
    ...
    mercury__string__format__format_cast_int_to_uint_2_p_0(Lo_7, &Var_18);
    mercury__string__format__format_uint_component_width_noprec_5_p_0((MR_Word) (&backend_libs__c_util_scalar_common_2[1]), (MR_Integer) 4, (MR_Integer) 2, Var_18, &Var_19);
    mercury__string__format__format_cast_int_to_uint_2_p_0(Hi_6, &Var_28);
    mercury__string__format__format_uint_component_width_noprec_5_p_0((MR_Word) (&backend_libs__c_util_scalar_common_2[1]), (MR_Integer) 4, (MR_Integer) 2, Var_28, &Var_29);
    S_4 = mercury__string__f_43_43_2_f_0(Var_29, Var_19);
    return S_4;
  }
}
...
{
  {
    ...
    if (succeeded)
      mercury__list__append_3_p_1((MR_Word) (&mercury__builtin__builtin__type_ctor_info_character_0), RevEscapeChars_23, (MR_Word) ((MR_Unsigned) 0U), &RevQuotedCharStr_17);
    else
    {
      ...
      if (succeeded)
        {
          RevQuotedCharStr_17 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          ...
          if (succeeded)
            {
              RevQuotedCharStr_17 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), RevQuotedCharStr_17, 0) = ((MR_Box) (MR_Word) (Char_8));
              MR_hl_field(MR_mktag(1), RevQuotedCharStr_17, 1) = ((MR_Box) ((MR_Unsigned) 0U));
            }
          else
          {
                  ...
                  case (MR_Integer) 0:
                    {
                      ...
                      if (succeeded)
                      {
                        ...
                        mercury__list__map_3_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_int_0), (MR_Word) (&backend_libs__c_util_scalar_common_1[0]), (MR_Word) (&backend_libs__c_util_scalar_common_4[0]), CodeUnits_26, &EscapeCharss_27);
                        mercury__list__condense_2_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_character_0), EscapeCharss_27, &EscapeChars_28);
                        mercury__list__reverse_prepend_3_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_character_0), EscapeChars_28, (MR_Word) ((MR_Unsigned) 0U), &RevQuotedCharStr_17);
                      }
                      else
                        {
                          mercury__require__unexpected_2_p_0((MR_String) "predicate \140backend_libs.c_util.quote_one_char\'/4", (MR_String) "invalid Unicode code point");
                  ...
                  case (MR_Integer) 0:
                    {
                      ...
                      mercury__char__to_int_2_p_0(Char_8, &Int_70);
                      backend_libs__c_util__octal_escape_any_int_2_p_0(Int_70, &EscapeChars_42);
                    }
                    break;
                  case (MR_Integer) 2:
                    {
                      MR_Integer Int_73;
                      MR_String HexString_74;
                      MR_Unsigned Var_79;
                      MR_String Var_80;

                      mercury__char__to_int_2_p_0(Char_8, &Int_73);
                      mercury__string__format__format_cast_int_to_uint_2_p_0(Int_73, &Var_79);
                      mercury__string__format__format_uint_component_width_noprec_5_p_0((MR_Word) (&backend_libs__c_util_scalar_common_2[1]), (MR_Integer) 4, (MR_Integer) 2, Var_79, &Var_80);
                      HexString_74 = mercury__string__f_43_43_2_f_0((MR_String) "\\u", Var_80);
                      mercury__string__to_char_list_2_p_0(HexString_74, &EscapeChars_42);
                    }
                    break;
                  case (MR_Integer) 1:
                    {
                      ...
                      backend_libs__c_util__octal_escape_any_int_2_p_0(Int_92, &EscapeChars_42);
                    }
                    break;
                }
                mercury__list__reverse_prepend_3_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_character_0), EscapeChars_42, (MR_Word) ((MR_Unsigned) 0U), &RevQuotedCharStr_17);
              }
            }
          }
        }
