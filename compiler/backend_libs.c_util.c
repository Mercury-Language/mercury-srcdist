...
static /* final */ const MR_Box backend_libs__c_util_scalar_common_4[2][1] = {
  ...
  /* row 1 */
  {
    (MR_Box) (((((MR_Unsigned) ((MR_Integer) 1) << (MR_Integer) 4)) | (((((MR_Unsigned) ((MR_Integer) 0) << (MR_Integer) 3)) | (((((MR_Unsigned) ((MR_Integer) 0) << (MR_Integer) 2)) | (((((MR_Unsigned) ((MR_Integer) 0) << (MR_Integer) 1)) | (MR_Unsigned) ((MR_Integer) 0)))))))))
  },
};
