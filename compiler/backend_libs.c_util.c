...
{
  {
    ...
    libs__globals__lookup_int_option_3_p_0(Globals_7, (MR_Integer) 248, &NumTagBits_12);
    mercury__string__int_to_string_2_p_0(NumTagBits_12, &NumTagBitsStr_13);
    libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 254, &UnboxedFloat_14);
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 234, &PregeneratedDist_16);
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 264, &HighLevelCode_18);
    ...
    /* tailcall optimized into a loop */
    {
      ...
      if (!(succeeded))
      {
        ...
        if (!(succeeded))
        {
          ...
          /* direct tailcall eliminated */
          {
            MR_String next_value_of_Str_8 = Right_29;
  ...
  while (MR_TRUE)
  {
    /* tailcall optimized into a loop */
    {
      ...
      if (succeeded)
      {
        ...
        /* direct tailcall eliminated */
        {
          MR_Integer next_value_of_Cur_10 = Next_12;
