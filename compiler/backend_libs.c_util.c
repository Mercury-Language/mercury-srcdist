          ...
          else
          {
            ...
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                ...
                mercury__list__reverse_prepend_3_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_character_0), EscapeChars_18, Var_8, &RevQuotedCharStr_7);
              }
              else
              {
                  ...
                  case (MR_Integer) 0:
                    {
                      ...
                      if (succeeded)
                      {
                        ...
                        mercury__list__reverse_prepend_3_p_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_character_0), EscapeChars_28, Var_18, &RevQuotedCharStr_17);
                      }
                      else
                      {
                        {
