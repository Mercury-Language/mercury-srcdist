...
{
  {
    ...
    libs__globals__lookup_int_option_3_p_0(Globals_7, (MR_Integer) 249, &NumTagBits_12);
    mercury__string__int_to_string_2_p_0(NumTagBits_12, &NumTagBitsStr_13);
    libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 255, &UnboxedFloat_14);
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 235, &PregeneratedDist_16);
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 265, &HighLevelCode_18);
