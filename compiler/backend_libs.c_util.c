...
MR_decl_label10(backend_libs__c_util__quote_one_char_4_0, 18,19,10,9,237,33,35,30,28,39)
MR_decl_label10(backend_libs__c_util__quote_one_char_4_0, 38,44,48,52,47,46,43,169,61,65)
MR_decl_label3(backend_libs__c_util__quote_one_char_4_0, 68,70,71)
...
{
MR_string_const("** HIGHLEVEL_CODE=", 18),
MR_TAG_COMMON(1,6,5)
},
{
MR_string_const("\n", 1),
...
MR_BEGIN_MODULE(backend_libs__c_util_module1)
	...
	MR_init_label10(backend_libs__c_util__quote_one_char_4_0,18,19,10,9,237,33,35,30,28,39)
	MR_init_label10(backend_libs__c_util__quote_one_char_4_0,38,44,48,52,47,46,43,169,61,65)
	MR_init_label3(backend_libs__c_util__quote_one_char_4_0,68,70,71)
MR_BEGIN_CODE
...
MR_def_label(backend_libs__c_util__quote_one_char_4_0,9)
	...
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(backend_libs__c_util__quote_one_char_4_0_i237);
	}
	...
	MR_proceed();
MR_def_label(backend_libs__c_util__quote_one_char_4_0,237)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(4);
	MR_sv(4) = (MR_Word) MR_succip;
	MR_sv(3) = MR_r1;
	...
	MR_np_call_localret_ent(char__is_alnum_1_0,
		backend_libs__c_util__quote_one_char_4_0_i33);
MR_def_label(backend_libs__c_util__quote_one_char_4_0,33)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_r1) {
		MR_GOTO_LAB(backend_libs__c_util__quote_one_char_4_0_i30);
	}
	MR_r1 = MR_sv(3);
	MR_r2 = MR_sv(1);
	{
	...
	MR_np_call_localret_ent(string__contains_char_2_0,
		backend_libs__c_util__quote_one_char_4_0_i35);
MR_def_label(backend_libs__c_util__quote_one_char_4_0,35)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(backend_libs__c_util__quote_one_char_4_0_i28);
	}
...
MR_def_label(backend_libs__c_util__quote_one_char_4_0,44)
	...
	if (MR_INT_LT(MR_r1,128)) {
		MR_GOTO_LAB(backend_libs__c_util__quote_one_char_4_0_i43);
	}
	...
	MR_np_call_localret_ent(char__to_utf8_2_0,
		backend_libs__c_util__quote_one_char_4_0_i48);
MR_def_label(backend_libs__c_util__quote_one_char_4_0,48)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(backend_libs__c_util__quote_one_char_4_0_i47);
	}
	MR_sv(3) = (MR_Word) MR_CHAR_CTOR_ADDR;
	...
	MR_np_call_localret_ent(list__map_3_0,
		backend_libs__c_util__quote_one_char_4_0_i52);
MR_def_label(backend_libs__c_util__quote_one_char_4_0,52)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
	...
	MR_np_call_localret_ent(list__condense_2_0,
		backend_libs__c_util__quote_one_char_4_0_i71);
...
MR_def_label(backend_libs__c_util__quote_one_char_4_0,43)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_sv(3),0)) {
		MR_GOTO_LAB(backend_libs__c_util__quote_one_char_4_0_i61);
	}
MR_def_label(backend_libs__c_util__quote_one_char_4_0,169)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(1);
	MR_np_call_localret_ent(char__to_int_2_0,
		backend_libs__c_util__quote_one_char_4_0_i70);
MR_def_label(backend_libs__c_util__quote_one_char_4_0,61)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_sv(3),2)) {
		MR_GOTO_LAB(backend_libs__c_util__quote_one_char_4_0_i169);
	}
	MR_r1 = MR_sv(1);
	MR_np_call_localret_ent(char__to_int_2_0,
		backend_libs__c_util__quote_one_char_4_0_i65);
MR_def_label(backend_libs__c_util__quote_one_char_4_0,65)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
...
MR_def_label(backend_libs__c_util__quote_one_char_4_0,68)
	...
	MR_np_call_localret_ent(string__to_char_list_2_0,
		backend_libs__c_util__quote_one_char_4_0_i71);
MR_def_label(backend_libs__c_util__quote_one_char_4_0,70)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_np_call_localret_ent(backend_libs__c_util__octal_escape_any_int_2_0,
		backend_libs__c_util__quote_one_char_4_0_i71);
MR_def_label(backend_libs__c_util__quote_one_char_4_0,71)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_sv(2);
	MR_succip_word = MR_sv(4);
	MR_decr_sp(4);
...
#line 1237 "backend_libs.c_util.c"
...
#line 1339 "backend_libs.c_util.c"
	MR_RELEASE_GLOBAL_LOCK("can_print_directly");
...
#line 1450 "backend_libs.c_util.c"
	MR_RELEASE_GLOBAL_LOCK("can_print_directly");
	MR_r4 = CanPrintDirectly;
#undef	MR_PROC_LABEL
	}
...
MR_def_label(backend_libs__c_util__output_c_file_intro_and_grade_5_0,7)
	...
	MR_tag_alloc_heap(MR_tempr2, 1, (MR_Integer) 2);
	MR_tfield(1, MR_tempr2, 0) = (MR_Word) MR_string_const("** UNBOXED_FLOAT=", 17);
	...
	MR_tfield(1, MR_tempr2, 1) = MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 2);
	MR_tfield(1, MR_tempr1, 0) = (MR_Word) MR_string_const("** TAG_BITS=", 12);
	MR_tfield(1, MR_tempr1, 1) = MR_tempr2;
	MR_tag_alloc_heap(MR_tempr2, 1, (MR_Integer) 2);
	MR_tfield(1, MR_tempr2, 0) = (MR_Word) MR_string_const("**\n", 3);
	MR_tfield(1, MR_tempr2, 1) = MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 2);
	MR_tfield(1, MR_tempr1, 0) = (MR_Word) MR_string_const("** the generation of this C file were\n", 38);
	MR_tfield(1, MR_tempr1, 1) = MR_tempr2;
	MR_tag_alloc_heap(MR_tempr2, 1, (MR_Integer) 2);
	MR_tfield(1, MR_tempr2, 0) = (MR_Word) MR_string_const("** The autoconfigured grade settings governing\n", 47);
	MR_tfield(1, MR_tempr2, 1) = MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 2);
	MR_tfield(1, MR_tempr1, 0) = (MR_Word) MR_string_const("**\n", 3);
	MR_tfield(1, MR_tempr1, 1) = MR_tempr2;
	MR_tag_alloc_heap(MR_tempr2, 1, (MR_Integer) 2);
	MR_tfield(1, MR_tempr2, 0) = (MR_Word) MR_string_const("** Do not edit.\n", 16);
	MR_tfield(1, MR_tempr2, 1) = MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 2);
	MR_tfield(1, MR_tempr1, 0) = (MR_Word) MR_string_const(".\n", 2);
	MR_tfield(1, MR_tempr1, 1) = MR_tempr2;
	...
	MR_tfield(1, MR_tempr2, 1) = MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 2);
	MR_tfield(1, MR_tempr1, 0) = (MR_Word) MR_string_const("** version ", 11);
	MR_tfield(1, MR_tempr1, 1) = MR_tempr2;
	MR_tag_alloc_heap(MR_tempr2, 1, (MR_Integer) 2);
	MR_tfield(1, MR_tempr2, 0) = (MR_Word) MR_string_const("** by the Mercury compiler,\n", 28);
	MR_tfield(1, MR_tempr2, 1) = MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 2);
	MR_tfield(1, MR_tempr1, 0) = (MR_Word) MR_string_const("\'\n", 2);
	MR_tfield(1, MR_tempr1, 1) = MR_tempr2;
