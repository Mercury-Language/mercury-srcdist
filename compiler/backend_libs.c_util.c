...
MR_decl_label10(backend_libs__c_util__do_output_quoted_string_6_0, 134,8,10,3,4,11,12,13,14,15)
MR_decl_label5(backend_libs__c_util__do_output_quoted_string_6_0, 20,21,22,16,136)
...
MR_decl_label8(backend_libs__c_util__output_quoted_multi_string_lang_4_0, 18,4,5,6,7,8,9,20)
...
MR_decl_label10(backend_libs__c_util__quote_one_char_4_0, 34,39,38,44,52,55,56,51,58,59)
MR_decl_label2(backend_libs__c_util__quote_one_char_4_0, 60,61)
...
MR_BEGIN_MODULE(backend_libs__c_util_module0)
	...
	MR_init_label10(backend_libs__c_util__quote_one_char_4_0,34,39,38,44,52,55,56,51,58,59)
	MR_init_label2(backend_libs__c_util__quote_one_char_4_0,60,61)
MR_BEGIN_CODE
...
MR_def_label(backend_libs__c_util__quote_one_char_4_0,38)
	...
	if (MR_INT_NE(MR_sv(1),0)) {
		MR_GOTO_LAB(backend_libs__c_util__quote_one_char_4_0_i44);
	}
	MR_r1 = MR_sv(2);
	MR_np_call_localret_ent(char__to_int_2_0,
		backend_libs__c_util__quote_one_char_4_0_i58);
MR_def_label(backend_libs__c_util__quote_one_char_4_0,44)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_sv(1),2)) {
		MR_GOTO_LAB(backend_libs__c_util__quote_one_char_4_0_i51);
	}
	MR_r1 = MR_sv(2);
	MR_np_call_localret_ent(char__to_int_2_0,
...
MR_def_label(backend_libs__c_util__quote_one_char_4_0,52)
	...
	MR_r1 = (MR_Word) MR_string_const("\\x%04x", 6);
	}
	MR_np_call_localret_ent(string__format_3_0,
		backend_libs__c_util__quote_one_char_4_0_i55);
MR_def_label(backend_libs__c_util__quote_one_char_4_0,55)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_np_call_localret_ent(string__to_char_list_2_0,
		backend_libs__c_util__quote_one_char_4_0_i56);
MR_def_label(backend_libs__c_util__quote_one_char_4_0,56)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_sv(3);
	MR_succip_word = MR_sv(4);
	MR_decr_sp(4);
...
MR_def_label(backend_libs__c_util__quote_one_char_4_0,51)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(2);
	MR_np_call_localret_ent(char__to_int_2_0,
		backend_libs__c_util__quote_one_char_4_0_i58);
MR_def_label(backend_libs__c_util__quote_one_char_4_0,58)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = (MR_Integer) 8;
	MR_np_call_localret_ent(string__int_to_base_string_3_0,
		backend_libs__c_util__quote_one_char_4_0_i59);
MR_def_label(backend_libs__c_util__quote_one_char_4_0,59)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = (MR_Integer) 48;
	MR_r3 = (MR_Integer) 3;
	MR_np_call_localret_ent(string__pad_left_4_0,
		backend_libs__c_util__quote_one_char_4_0_i60);
MR_def_label(backend_libs__c_util__quote_one_char_4_0,60)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_np_call_localret_ent(fn__string__to_char_list_1_0,
		backend_libs__c_util__quote_one_char_4_0_i61);
...
MR_BEGIN_MODULE(backend_libs__c_util_module1)
	...
	MR_init_label10(backend_libs__c_util__do_output_quoted_string_6_0,134,8,10,3,4,11,12,13,14,15)
	MR_init_label5(backend_libs__c_util__do_output_quoted_string_6_0,20,21,22,16,136)
MR_BEGIN_CODE
...
MR_def_label(backend_libs__c_util__do_output_quoted_string_6_0,134)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (((MR_Integer) MR_r2 >= (MR_Integer) MR_r3)) {
		MR_GOTO_LAB(backend_libs__c_util__do_output_quoted_string_6_0_i136);
	}
...
MR_def_label(backend_libs__c_util__do_output_quoted_string_6_0,21)
	...
	if (MR_INT_EQ(MR_r1,33)) {
		MR_GOTO_LAB(backend_libs__c_util__do_output_quoted_string_6_0_i22);
	}
...
MR_def_label(backend_libs__c_util__do_output_quoted_string_6_0,22)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_string_const("\" \"", 3);
	MR_np_call_localret_ent(io__write_string_3_0,
...
MR_def_label(backend_libs__c_util__do_output_quoted_string_6_0,16)
	...
	MR_GOTO_LAB(backend_libs__c_util__do_output_quoted_string_6_0_i134);
MR_def_label(backend_libs__c_util__do_output_quoted_string_6_0,136)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
#line 1305 "backend_libs.c_util.c"
	MR_RELEASE_GLOBAL_LOCK("can_print_directly");
	MR_r2 = CanPrintDirectly;
#undef	MR_PROC_LABEL
	}
...
MR_BEGIN_MODULE(backend_libs__c_util_module9)
	...
	MR_init_label8(backend_libs__c_util__output_quoted_multi_string_lang_4_0,18,4,5,6,7,8,9,20)
MR_BEGIN_CODE
...
MR_def_label(backend_libs__c_util__output_quoted_multi_string_lang_4_0,18)
	...
	if (MR_LTAGS_TEST(MR_r2,0,0)) {
		MR_GOTO_LAB(backend_libs__c_util__output_quoted_multi_string_lang_4_0_i20);
	}
	MR_sv(1) = MR_r1;
...
MR_def_label(backend_libs__c_util__output_c_file_intro_and_grade_5_0,9)
	...
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 2);
	MR_tfield(1, MR_tempr1, 0) = MR_sv(1);
	MR_tfield(1, MR_tempr1, 1) = (MR_Word) MR_TAG_COMMON(1,4,10);
	MR_tag_alloc_heap(MR_tempr2, 1, (MR_Integer) 2);
	MR_tfield(1, MR_tempr2, 0) = (MR_Word) MR_string_const("** UNBOXED_FLOAT=", 17);
	MR_tfield(1, MR_tempr2, 1) = MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 2);
