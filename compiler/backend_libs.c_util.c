...
MR_decl_label6(backend_libs__c_util__do_output_quoted_string_5_0, 18,4,6,7,8,20)
...
MR_decl_label7(backend_libs__c_util__output_quoted_multi_string_lang_4_0, 17,4,5,6,7,8,19)
MR_decl_label9(backend_libs__c_util__output_quoted_string_lang_4_0, 31,4,5,8,9,10,13,3,34)
MR_decl_label10(backend_libs__c_util__quote_one_char_4_0, 5,4,2,10,11,12,13,14,15,16)
MR_decl_label10(backend_libs__c_util__quote_one_char_4_0, 17,18,9,8,235,32,34,29,27,38)
MR_decl_label10(backend_libs__c_util__quote_one_char_4_0, 37,43,47,50,46,45,42,167,59,63)
MR_decl_label3(backend_libs__c_util__quote_one_char_4_0, 66,68,69)
...
mercury_data__closure_layout__backend_libs__c_util__quote_one_char_4_0_1;
extern const MR_TypeCtorInfo_Struct mercury_data_builtin__type_ctor_info_int_0;
static const struct mercury_type_3 mercury_common_3[1] =
{
{
(MR_Word *) &mercury_data__closure_layout__backend_libs__c_util__quote_one_char_4_0_1,
...
MR_BEGIN_MODULE(backend_libs__c_util_module1)
	...
	MR_init_label10(backend_libs__c_util__quote_one_char_4_0,5,4,2,10,11,12,13,14,15,16)
	MR_init_label10(backend_libs__c_util__quote_one_char_4_0,17,18,9,8,235,32,34,29,27,38)
	MR_init_label10(backend_libs__c_util__quote_one_char_4_0,37,43,47,50,46,45,42,167,59,63)
	MR_init_label3(backend_libs__c_util__quote_one_char_4_0,66,68,69)
MR_BEGIN_CODE
...
MR_def_static(backend_libs__c_util__quote_one_char_4_0)
	...
	if (MR_INT_NE(MR_r1,1)) {
		MR_GOTO_LAB(backend_libs__c_util__quote_one_char_4_0_i2);
	}
	...
	MR_GOTO_LAB(backend_libs__c_util__quote_one_char_4_0_i4);
...
MR_def_label(backend_libs__c_util__quote_one_char_4_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_CHAR_CTOR_ADDR;
	MR_succip_word = MR_sv(4);
	MR_decr_sp(4);
	MR_np_tailcall_ent(list__append_3_1);
MR_def_label(backend_libs__c_util__quote_one_char_4_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r2,7)) {
...
MR_def_label(backend_libs__c_util__quote_one_char_4_0,18)
	...
	if (MR_INT_NE(MR_r2,92)) {
		MR_GOTO_LAB(backend_libs__c_util__quote_one_char_4_0_i8);
	}
	MR_incr_sp(4);
	MR_sv(4) = (MR_Word) MR_succip;
	MR_sv(1) = MR_r1;
...
MR_def_label(backend_libs__c_util__quote_one_char_4_0,8)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(backend_libs__c_util__quote_one_char_4_0_i235);
	}
	...
	MR_proceed();
MR_def_label(backend_libs__c_util__quote_one_char_4_0,235)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(4);
	MR_sv(4) = (MR_Word) MR_succip;
	MR_sv(1) = MR_r1;
	...
	MR_np_call_localret_ent(char__is_alnum_1_0,
		backend_libs__c_util__quote_one_char_4_0_i32);
MR_def_label(backend_libs__c_util__quote_one_char_4_0,32)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_r1) {
		MR_GOTO_LAB(backend_libs__c_util__quote_one_char_4_0_i29);
	}
	MR_r1 = MR_sv(1);
	MR_r2 = MR_sv(2);
	{
	...
	MR_np_call_localret_ent(string__contains_char_2_0,
		backend_libs__c_util__quote_one_char_4_0_i34);
MR_def_label(backend_libs__c_util__quote_one_char_4_0,34)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(backend_libs__c_util__quote_one_char_4_0_i27);
	}
MR_def_label(backend_libs__c_util__quote_one_char_4_0,29)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_tag_alloc_heap(MR_r1, 1, (MR_Integer) 2);
	MR_tfield(1, MR_r1, 0) = MR_sv(2);
	MR_tfield(1, MR_r1, 1) = MR_sv(3);
	MR_decr_sp_and_return(4);
MR_def_label(backend_libs__c_util__quote_one_char_4_0,27)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(1);
	MR_r2 = MR_sv(2);
	{
	...
	MR_np_call_localret_ent(char__to_int_2_1,
		backend_libs__c_util__quote_one_char_4_0_i38);
MR_def_label(backend_libs__c_util__quote_one_char_4_0,38)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(backend_libs__c_util__quote_one_char_4_0_i37);
	}
	MR_tag_alloc_heap(MR_r2, 1, (MR_Integer) 2);
	MR_tfield(1, MR_r2, 0) = (MR_Integer) 92;
	MR_tfield(1, MR_r2, 1) = MR_sv(3);
	...
	MR_tfield(1, MR_r1, 1) = MR_r2;
	MR_decr_sp_and_return(4);
MR_def_label(backend_libs__c_util__quote_one_char_4_0,37)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(2);
...
MR_def_label(backend_libs__c_util__quote_one_char_4_0,43)
	...
	if (MR_INT_LT(MR_r1,128)) {
		MR_GOTO_LAB(backend_libs__c_util__quote_one_char_4_0_i42);
	}
	if (MR_INT_NE(MR_sv(1),0)) {
		MR_GOTO_LAB(backend_libs__c_util__quote_one_char_4_0_i45);
	}
	MR_r1 = MR_sv(2);
	MR_np_call_localret_ent(char__to_utf8_2_0,
		backend_libs__c_util__quote_one_char_4_0_i47);
MR_def_label(backend_libs__c_util__quote_one_char_4_0,47)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(backend_libs__c_util__quote_one_char_4_0_i46);
	}
	...
	MR_np_call_localret_ent(list__map_3_0,
		backend_libs__c_util__quote_one_char_4_0_i50);
MR_def_label(backend_libs__c_util__quote_one_char_4_0,50)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
	...
	MR_np_call_localret_ent(list__condense_2_0,
		backend_libs__c_util__quote_one_char_4_0_i69);
...
MR_def_label(backend_libs__c_util__quote_one_char_4_0,45)
	...
	MR_tfield(1, MR_r1, 1) = MR_sv(3);
	MR_decr_sp_and_return(4);
MR_def_label(backend_libs__c_util__quote_one_char_4_0,42)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_sv(1),0)) {
		MR_GOTO_LAB(backend_libs__c_util__quote_one_char_4_0_i59);
	}
MR_def_label(backend_libs__c_util__quote_one_char_4_0,167)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(2);
	MR_np_call_localret_ent(char__to_int_2_0,
		backend_libs__c_util__quote_one_char_4_0_i68);
MR_def_label(backend_libs__c_util__quote_one_char_4_0,59)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_sv(1),2)) {
		MR_GOTO_LAB(backend_libs__c_util__quote_one_char_4_0_i167);
	}
	MR_r1 = MR_sv(2);
	MR_np_call_localret_ent(char__to_int_2_0,
		backend_libs__c_util__quote_one_char_4_0_i63);
MR_def_label(backend_libs__c_util__quote_one_char_4_0,63)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	...
	MR_np_call_localret_ent(string__format_3_0,
		backend_libs__c_util__quote_one_char_4_0_i66);
MR_def_label(backend_libs__c_util__quote_one_char_4_0,66)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_np_call_localret_ent(string__to_char_list_2_0,
		backend_libs__c_util__quote_one_char_4_0_i69);
MR_def_label(backend_libs__c_util__quote_one_char_4_0,68)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_np_call_localret_ent(backend_libs__c_util__octal_escape_any_int_2_0,
		backend_libs__c_util__quote_one_char_4_0_i69);
MR_def_label(backend_libs__c_util__quote_one_char_4_0,69)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_sv(3);
	MR_succip_word = MR_sv(4);
	MR_decr_sp(4);
...
MR_BEGIN_MODULE(backend_libs__c_util_module2)
	...
	MR_init_label6(backend_libs__c_util__do_output_quoted_string_5_0,18,4,6,7,8,20)
MR_BEGIN_CODE
...
MR_def_static(backend_libs__c_util__do_output_quoted_string_5_0)
	...
	MR_incr_sp(4);
	MR_sv(4) = (MR_Word) MR_succip;
MR_def_label(backend_libs__c_util__do_output_quoted_string_5_0,18)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(1) = MR_r1;
	MR_sv(2) = MR_r2;
	MR_r1 = MR_r2;
...
MR_def_label(backend_libs__c_util__do_output_quoted_string_5_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(backend_libs__c_util__do_output_quoted_string_5_0_i20);
	}
	MR_sv(3) = MR_r2;
	MR_r1 = MR_sv(1);
	MR_r2 = MR_r3;
...
MR_def_label(backend_libs__c_util__do_output_quoted_string_5_0,6)
	...
	MR_np_call_localret_ent(string__from_rev_char_list_2_0,
		backend_libs__c_util__do_output_quoted_string_5_0_i7);
MR_def_label(backend_libs__c_util__do_output_quoted_string_5_0,7)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_np_call_localret_ent(io__write_string_3_0,
		backend_libs__c_util__do_output_quoted_string_5_0_i8);
MR_def_label(backend_libs__c_util__do_output_quoted_string_5_0,8)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(1);
	MR_r2 = MR_sv(2);
	MR_r3 = MR_sv(3);
	MR_succip_word = MR_sv(4);
	MR_GOTO_LAB(backend_libs__c_util__do_output_quoted_string_5_0_i18);
MR_def_label(backend_libs__c_util__do_output_quoted_string_5_0,20)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(4);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
...
MR_BEGIN_MODULE(backend_libs__c_util_module3)
	...
	MR_init_label9(backend_libs__c_util__output_quoted_string_lang_4_0,31,4,5,8,9,10,13,3,34)
MR_BEGIN_CODE
...
MR_def_label(backend_libs__c_util__output_quoted_string_lang_4_0,31)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(backend_libs__c_util__output_quoted_string_lang_4_0_i3);
	}
	MR_sv(1) = MR_r1;
	MR_r1 = MR_r2;
	MR_r2 = (MR_Integer) 160;
	MR_np_call_localret_ent(string__split_by_codepoint_4_0,
		backend_libs__c_util__output_quoted_string_lang_4_0_i4);
MR_def_label(backend_libs__c_util__output_quoted_string_lang_4_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(2) = MR_r2;
	{
	MR_Word MR_tempr1;
	...
	MR_np_call_localret_ent(backend_libs__c_util__do_output_quoted_string_5_0,
		backend_libs__c_util__output_quoted_string_lang_4_0_i5);
MR_def_label(backend_libs__c_util__output_quoted_string_lang_4_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if ((strcmp((char *) (MR_Word *) MR_sv(2), MR_string_const("", 0)) == 0)) {
		MR_GOTO_LAB(backend_libs__c_util__output_quoted_string_lang_4_0_i34);
	}
...
MR_def_label(backend_libs__c_util__output_quoted_string_lang_4_0,8)
	...
	MR_r2 = (MR_Integer) 160;
	MR_np_call_localret_ent(string__split_by_codepoint_4_0,
		backend_libs__c_util__output_quoted_string_lang_4_0_i9);
MR_def_label(backend_libs__c_util__output_quoted_string_lang_4_0,9)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(2) = MR_r2;
	{
	MR_Word MR_tempr1;
	...
	MR_np_call_localret_ent(backend_libs__c_util__do_output_quoted_string_5_0,
		backend_libs__c_util__output_quoted_string_lang_4_0_i10);
MR_def_label(backend_libs__c_util__output_quoted_string_lang_4_0,10)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if ((strcmp((char *) (MR_Word *) MR_sv(2), MR_string_const("", 0)) == 0)) {
		MR_GOTO_LAB(backend_libs__c_util__output_quoted_string_lang_4_0_i34);
	}
	MR_r1 = (MR_Word) MR_string_const("\" \"", 3);
	MR_np_call_localret_ent(io__write_string_3_0,
		backend_libs__c_util__output_quoted_string_lang_4_0_i13);
MR_def_label(backend_libs__c_util__output_quoted_string_lang_4_0,13)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(1);
	MR_r2 = MR_sv(2);
	MR_succip_word = MR_sv(3);
	MR_GOTO_LAB(backend_libs__c_util__output_quoted_string_lang_4_0_i31);
...
MR_def_label(backend_libs__c_util__output_quoted_string_lang_4_0,34)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
#line 1321 "backend_libs.c_util.c"
	MR_RELEASE_GLOBAL_LOCK("can_print_directly");
	MR_r4 = CanPrintDirectly;
#undef	MR_PROC_LABEL
	}
...
#line 1432 "backend_libs.c_util.c"
	MR_RELEASE_GLOBAL_LOCK("can_print_directly");
	MR_r4 = CanPrintDirectly;
#undef	MR_PROC_LABEL
	}
...
MR_BEGIN_MODULE(backend_libs__c_util_module10)
	...
	MR_init_label7(backend_libs__c_util__output_quoted_multi_string_lang_4_0,17,4,5,6,7,8,19)
MR_BEGIN_CODE
...
MR_def_label(backend_libs__c_util__output_quoted_multi_string_lang_4_0,17)
	...
	if (MR_LTAGS_TEST(MR_r2,0,0)) {
		MR_GOTO_LAB(backend_libs__c_util__output_quoted_multi_string_lang_4_0_i19);
	}
	MR_sv(1) = MR_r1;
...
MR_def_label(backend_libs__c_util__output_quoted_multi_string_lang_4_0,19)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(3);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
