              ...
              *backend_libs__c_util__HeadVar__1_1 = (MR_Integer) 2;
            else
              {
                ...
                switch (MR_tag((MR_Word) backend_libs__c_util__HeadVar__2_2)) {
                  ...
                  case (MR_Integer) 1:
                    {
                      MR_Integer backend_libs__c_util__Var_7 = ((MR_Integer) (MR_hl_field(MR_mktag(1), backend_libs__c_util__HeadVar__2_2, (MR_Integer) 0)));
                      MR_Integer backend_libs__c_util__Var_8;

                      backend_libs__c_util__succeeded = ((MR_tag((MR_Word) backend_libs__c_util__HeadVar__3_3)) == (MR_mktag((MR_Integer) 1)));
                      if (backend_libs__c_util__succeeded)
                        {
                          backend_libs__c_util__Var_8 = ((MR_Integer) (MR_hl_field(MR_mktag(1), backend_libs__c_util__HeadVar__3_3, (MR_Integer) 0)));
                          {
                            mercury__private_builtin__builtin_compare_int_3_p_0(&backend_libs__c_util__Var_6, backend_libs__c_util__Var_7, backend_libs__c_util__Var_8);
                          }
                          backend_libs__c_util__succeeded = MR_TRUE;
                        }
                    }
...
{
  {
    ...
    if (backend_libs__c_util__succeeded)
      ...
      switch (MR_tag((MR_Word) backend_libs__c_util__HeadVar__1_1)) {
        ...
        case (MR_Integer) 1:
          {
            MR_Integer backend_libs__c_util__Var_11 = ((MR_Integer) (MR_hl_field(MR_mktag(1), backend_libs__c_util__HeadVar__1_1, (MR_Integer) 0)));
            MR_Integer backend_libs__c_util__Var_12;

            backend_libs__c_util__succeeded = ((MR_tag((MR_Word) backend_libs__c_util__HeadVar__2_2)) == (MR_mktag((MR_Integer) 1)));
            if (backend_libs__c_util__succeeded)
              {
                backend_libs__c_util__Var_12 = ((MR_Integer) (MR_hl_field(MR_mktag(1), backend_libs__c_util__HeadVar__2_2, (MR_Integer) 0)));
                backend_libs__c_util__succeeded = (backend_libs__c_util__Var_11 == backend_libs__c_util__Var_12);
              }
          }
          break;
      }
