                ...
                case (MR_Integer) 2:
                  {
                    ...
                    mercury__string__format__format_unsigned_int_component_width_noprec_5_p_0((MR_Word) (&backend_libs__c_util_scalar_common_2[1]), (MR_Integer) 4, (MR_Integer) 2, Int_73, &Var_80);
