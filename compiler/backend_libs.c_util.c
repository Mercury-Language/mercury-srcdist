  ...
  MR_String String_3)
{
  ...
  mercury__string__foldl_4_p_1((MR_Word) (&backend_libs__c_util_scalar_common_1[0]), (MR_Word) (&backend_libs__c_util_scalar_common_4[0]), String_3, ((MR_Box) (MR_mkword(1, &backend_libs__c_util_scalar_common_1[2]))), &conv1_RevQuotedChars0_5);
