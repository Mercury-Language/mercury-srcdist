...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 251, &PregeneratedDist_18);
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 288, &HighLevelCode_20);
