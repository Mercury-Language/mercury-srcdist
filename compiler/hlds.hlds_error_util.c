...
{
  {
    ...
    hlds__hlds_error_util__Pieces_8 = parse_tree__error_util__component_lists_to_pieces_2_f_0((MR_String) "and", hlds__hlds_error_util__PiecesList_9);
...
{
  {
    ...
    {
      hlds__hlds_error_util__succeeded = hlds__hlds_pred__check_marker_2_p_0(hlds__hlds_error_util__Markers_12, (MR_Integer) 12);
      if (hlds__hlds_error_util__succeeded)
      {
