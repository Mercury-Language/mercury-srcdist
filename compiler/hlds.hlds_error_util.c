  ...
  MR_Word Sites_9)
{
  ...
  Pieces_10 = parse_tree__error_spec__component_lists_to_pieces_2_f_0((MR_String) "and", PiecesList_11);
  return Pieces_10;
}
  ...
  MR_Word PredIds_9)
{
  ...
  Pieces_10 = parse_tree__error_spec__component_lists_to_pieces_2_f_0((MR_String) "and", PiecesList_12);
  return Pieces_10;
}
