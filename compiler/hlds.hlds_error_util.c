...
#line 27 "hlds.hlds_error_util.c"
#line 134 "../library/io.int2"
#include "io.mh"

#line 31 "hlds.hlds_error_util.c"
#line 142 "../library/io.int2"
#include "string.mh"

#line 35 "hlds.hlds_error_util.c"
#line 17 "../mdbcomp/mdbcomp.rtti_access.int2"
#include "mdbcomp.rtti_access.mh"

#line 39 "hlds.hlds_error_util.c"
#line 29 "../library/bitmap.int2"
#include "bitmap.mh"

#line 43 "hlds.hlds_error_util.c"
#line 28 "../library/time.int2"
#include "time.mh"

#line 47 "hlds.hlds_error_util.c"
#line 31 "../library/array.int2"
#include "array.mh"

#line 51 "hlds.hlds_error_util.c"
#line 52 "hlds.hlds_error_util.c"
#include "hlds.hlds_error_util.mh"

#line 55 "hlds.hlds_error_util.c"
#line 56 "hlds.hlds_error_util.c"
#ifndef HLDS__HLDS_ERROR_UTIL_DECL_GUARD
#define HLDS__HLDS_ERROR_UTIL_DECL_GUARD

#line 60 "hlds.hlds_error_util.c"
#line 61 "hlds.hlds_error_util.c"

#endif
#line 64 "hlds.hlds_error_util.c"
...
MR_decl_label6(fn__hlds__hlds_error_util__describe_one_call_site_3_0, 2,3,4,5,6,7)
MR_decl_label8(fn__hlds__hlds_error_util__describe_one_pred_info_name_2_0, 2,3,4,5,6,7,8,11)
MR_decl_label8(fn__hlds__hlds_error_util__describe_one_pred_info_name_2_0, 13,14,12,15,9,19,18,22)
MR_decl_label8(fn__hlds__hlds_error_util__describe_one_pred_info_name_2_0, 24,25,26,21,28,27,30,32)
MR_decl_label1(fn__hlds__hlds_error_util__describe_one_pred_name_3_0, 2)
MR_decl_label8(fn__hlds__hlds_error_util__describe_one_pred_name_mode_5_0, 2,3,4,5,6,7,9,11)
MR_decl_label8(fn__hlds__hlds_error_util__describe_one_pred_name_mode_5_0, 8,13,17,18,19,15,21,23)
MR_decl_label8(fn__hlds__hlds_error_util__describe_one_pred_name_mode_5_0, 24,25,26,27,28,29,14,32)
MR_decl_label3(fn__hlds__hlds_error_util__describe_one_pred_name_mode_5_0, 33,31,34)
...
MR_decl_label1(fn__hlds__hlds_error_util__describe_several_call_sites_3_0, 2)
MR_decl_label1(fn__hlds__hlds_error_util__describe_several_pred_names_3_0, 2)
MR_decl_label1(fn__hlds__hlds_error_util__describe_several_proc_names_3_0, 2)
...
MR_BEGIN_MODULE(hlds__hlds_error_util_module0)
	...
	MR_init_label8(fn__hlds__hlds_error_util__describe_one_pred_info_name_2_0,2,3,4,5,6,7,8,11)
	MR_init_label8(fn__hlds__hlds_error_util__describe_one_pred_info_name_2_0,13,14,12,15,9,19,18,22)
	MR_init_label8(fn__hlds__hlds_error_util__describe_one_pred_info_name_2_0,24,25,26,21,28,27,30,32)
MR_BEGIN_CODE
...
MR_def_label(fn__hlds__hlds_error_util__describe_one_pred_info_name_2_0,12)
	...
	if (MR_INT_NE(MR_sv(2),0)) {
		MR_GOTO_LAB(fn__hlds__hlds_error_util__describe_one_pred_info_name_2_0_i15);
	}
	{
...
MR_def_label(fn__hlds__hlds_error_util__describe_one_pred_info_name_2_0,15)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2, MR_tempr3;
	MR_tag_alloc_heap(MR_tempr1, 3, (MR_Integer) 2);
...
MR_def_label(fn__hlds__hlds_error_util__describe_one_pred_info_name_2_0,9)
	...
	MR_np_call_localret_ent(hlds__hlds_pred__check_marker_2_0,
		fn__hlds__hlds_error_util__describe_one_pred_info_name_2_0_i19);
MR_def_label(fn__hlds__hlds_error_util__describe_one_pred_info_name_2_0,19)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(fn__hlds__hlds_error_util__describe_one_pred_info_name_2_0_i18);
	}
	MR_r1 = (MR_Word) MR_TAG_COMMON(1,1,0);
	MR_decr_sp_and_return(8);
MR_def_label(fn__hlds__hlds_error_util__describe_one_pred_info_name_2_0,18)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(2);
	MR_np_call_localret_ent(hlds__hlds_pred__pred_info_get_goal_type_2_0,
		fn__hlds__hlds_error_util__describe_one_pred_info_name_2_0_i22);
MR_def_label(fn__hlds__hlds_error_util__describe_one_pred_info_name_2_0,22)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_r1,1)) {
		MR_GOTO_LAB(fn__hlds__hlds_error_util__describe_one_pred_info_name_2_0_i21);
	}
	MR_r1 = MR_ctfield(1, MR_r1, 0);
	MR_np_call_localret_ent(fn__parse_tree__prog_out__promise_to_string_1_0,
		fn__hlds__hlds_error_util__describe_one_pred_info_name_2_0_i24);
MR_def_label(fn__hlds__hlds_error_util__describe_one_pred_info_name_2_0,24)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = (MR_Word) MR_string_const("\'", 1);
	MR_np_call_localret_ent(fn__f_115_116_114_105_110_103_95_95_43_43_2_0,
		fn__hlds__hlds_error_util__describe_one_pred_info_name_2_0_i25);
MR_def_label(fn__hlds__hlds_error_util__describe_one_pred_info_name_2_0,25)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_r1;
	MR_r1 = (MR_Word) MR_string_const("\140", 1);
	MR_np_call_localret_ent(fn__f_115_116_114_105_110_103_95_95_43_43_2_0,
		fn__hlds__hlds_error_util__describe_one_pred_info_name_2_0_i26);
MR_def_label(fn__hlds__hlds_error_util__describe_one_pred_info_name_2_0,26)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 3, (MR_Integer) 2);
...
MR_def_label(fn__hlds__hlds_error_util__describe_one_pred_info_name_2_0,21)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(7);
	MR_r2 = (MR_Integer) 7;
	MR_np_call_localret_ent(hlds__hlds_pred__check_marker_2_0,
		fn__hlds__hlds_error_util__describe_one_pred_info_name_2_0_i28);
MR_def_label(fn__hlds__hlds_error_util__describe_one_pred_info_name_2_0,28)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(fn__hlds__hlds_error_util__describe_one_pred_info_name_2_0_i27);
	}
	{
	MR_Word MR_tempr1, MR_tempr2, MR_tempr3;
	MR_tag_alloc_heap(MR_tempr1, 3, (MR_Integer) 2);
	...
	MR_tag_alloc_heap(MR_tempr3, 1, (MR_Integer) 2);
	MR_r2 = MR_tempr3;
	MR_tfield(1, MR_tempr3, 0) = (MR_Word) MR_TAG_COMMON(3,0,4);
	MR_tfield(1, MR_tempr3, 1) = MR_tempr2;
	MR_GOTO_LAB(fn__hlds__hlds_error_util__describe_one_pred_info_name_2_0_i30);
	}
MR_def_label(fn__hlds__hlds_error_util__describe_one_pred_info_name_2_0,27)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
...
MR_def_label(fn__hlds__hlds_error_util__describe_one_pred_info_name_2_0,30)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_sv(1),0)) {
		MR_GOTO_LAB(fn__hlds__hlds_error_util__describe_one_pred_info_name_2_0_i32);
	}
	{
	MR_Word MR_tempr1, MR_tempr2, MR_tempr3;
...
MR_BEGIN_MODULE(hlds__hlds_error_util_module2)
	...
	MR_init_label8(fn__hlds__hlds_error_util__describe_one_pred_name_mode_5_0,2,3,4,5,6,7,9,11)
	MR_init_label8(fn__hlds__hlds_error_util__describe_one_pred_name_mode_5_0,8,13,17,18,19,15,21,23)
	MR_init_label8(fn__hlds__hlds_error_util__describe_one_pred_name_mode_5_0,24,25,26,27,28,29,14,32)
	MR_init_label3(fn__hlds__hlds_error_util__describe_one_pred_name_mode_5_0,33,31,34)
MR_BEGIN_CODE
...
MR_def_label(fn__hlds__hlds_error_util__describe_one_pred_name_mode_5_0,13)
	...
	if (MR_LTAGS_TESTR(MR_r2,0,0)) {
		MR_GOTO_LAB(fn__hlds__hlds_error_util__describe_one_pred_name_mode_5_0_i17);
	}
	MR_r1 = MR_sv(5);
	MR_r2 = (MR_Word) MR_string_const("", 0);
	MR_GOTO_LAB(fn__hlds__hlds_error_util__describe_one_pred_name_mode_5_0_i14);
MR_def_label(fn__hlds__hlds_error_util__describe_one_pred_name_mode_5_0,17)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_r2;
	MR_r2 = MR_sv(2);
	MR_np_call_localret_ent(fn__parse_tree__mercury_to_mercury__mercury_mode_list_to_string_2_0,
		fn__hlds__hlds_error_util__describe_one_pred_name_mode_5_0_i18);
...
MR_def_label(fn__hlds__hlds_error_util__describe_one_pred_name_mode_5_0,21)
	...
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
		MR_GOTO_LAB(fn__hlds__hlds_error_util__describe_one_pred_name_mode_5_0_i23);
	}
	MR_r1 = MR_r2;
	MR_r2 = MR_sv(2);
...
MR_def_label(fn__hlds__hlds_error_util__describe_one_pred_name_mode_5_0,23)
	...
	MR_r2 = MR_sv(2);
	MR_np_call_localret_ent(fn__parse_tree__mercury_to_mercury__mercury_mode_list_to_string_2_0,
		fn__hlds__hlds_error_util__describe_one_pred_name_mode_5_0_i24);
MR_def_label(fn__hlds__hlds_error_util__describe_one_pred_name_mode_5_0,24)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = (MR_Word) MR_string_const(")", 1);
	MR_np_call_localret_ent(fn__f_115_116_114_105_110_103_95_95_43_43_2_0,
		fn__hlds__hlds_error_util__describe_one_pred_name_mode_5_0_i25);
MR_def_label(fn__hlds__hlds_error_util__describe_one_pred_name_mode_5_0,25)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_r1;
	MR_r1 = (MR_Word) MR_string_const("(", 1);
	MR_np_call_localret_ent(fn__f_115_116_114_105_110_103_95_95_43_43_2_0,
		fn__hlds__hlds_error_util__describe_one_pred_name_mode_5_0_i26);
...
MR_def_label(fn__hlds__hlds_error_util__describe_one_pred_name_mode_5_0,33)
	...
	MR_np_call_localret_ent(string__append_list_2_0,
		fn__hlds__hlds_error_util__describe_one_pred_name_mode_5_0_i34);
MR_def_label(fn__hlds__hlds_error_util__describe_one_pred_name_mode_5_0,31)
	...
	MR_np_call_localret_ent(string__append_list_2_0,
		fn__hlds__hlds_error_util__describe_one_pred_name_mode_5_0_i34);
MR_def_label(fn__hlds__hlds_error_util__describe_one_pred_name_mode_5_0,34)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 3, (MR_Integer) 2);
...
MR_BEGIN_MODULE(hlds__hlds_error_util_module3)
	...
	MR_init_label1(fn__hlds__hlds_error_util__describe_several_pred_names_3_0,2)
MR_BEGIN_CODE
...
MR_define_entry(mercury__fn__hlds__hlds_error_util__describe_several_pred_names_3_0);
	...
	MR_np_call_localret_ent(fn__list__map_2_0,
		fn__hlds__hlds_error_util__describe_several_pred_names_3_0_i2);
MR_def_label(fn__hlds__hlds_error_util__describe_several_pred_names_3_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_BEGIN_MODULE(hlds__hlds_error_util_module6)
	...
	MR_init_label1(fn__hlds__hlds_error_util__describe_several_proc_names_3_0,2)
MR_BEGIN_CODE
...
MR_define_entry(mercury__fn__hlds__hlds_error_util__describe_several_proc_names_3_0);
	...
	MR_np_call_localret_ent(fn__list__map_2_0,
		fn__hlds__hlds_error_util__describe_several_proc_names_3_0_i2);
MR_def_label(fn__hlds__hlds_error_util__describe_several_proc_names_3_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_succip_word = MR_sv(1);
	MR_decr_sp(1);
	MR_np_tailcall_ent(fn__parse_tree__error_util__component_lists_to_pieces_1_0);
...
MR_BEGIN_MODULE(hlds__hlds_error_util_module7)
	...
	MR_init_label6(fn__hlds__hlds_error_util__describe_one_call_site_3_0,2,3,4,5,6,7)
MR_BEGIN_CODE
...
MR_def_label(fn__hlds__hlds_error_util__describe_one_call_site_3_0,5)
	...
	MR_r1 = (MR_Word) MR_string_const(":", 1);
	MR_np_call_localret_ent(fn__f_115_116_114_105_110_103_95_95_43_43_2_0,
		fn__hlds__hlds_error_util__describe_one_call_site_3_0_i6);
MR_def_label(fn__hlds__hlds_error_util__describe_one_call_site_3_0,6)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_r1;
	MR_r1 = MR_sv(1);
	MR_np_call_localret_ent(fn__f_115_116_114_105_110_103_95_95_43_43_2_0,
...
MR_BEGIN_MODULE(hlds__hlds_error_util_module8)
	...
	MR_init_label1(fn__hlds__hlds_error_util__describe_several_call_sites_3_0,2)
MR_BEGIN_CODE
...
MR_define_entry(mercury__fn__hlds__hlds_error_util__describe_several_call_sites_3_0);
	...
	MR_np_call_localret_ent(fn__list__map_2_0,
		fn__hlds__hlds_error_util__describe_several_call_sites_3_0_i2);
MR_def_label(fn__hlds__hlds_error_util__describe_several_call_sites_3_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_succip_word = MR_sv(1);
	MR_decr_sp(1);
	MR_np_tailcall_ent(fn__parse_tree__error_util__component_lists_to_pieces_1_0);
...
void mercury__hlds__hlds_error_util__write_out_proc_statics(FILE *fp);
#endif
