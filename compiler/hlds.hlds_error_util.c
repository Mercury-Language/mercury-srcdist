...
MR_decl_label10(fn__hlds__hlds_error_util__describe_one_pred_info_name_2_0, 12,16,9,32,31,38,40,41,42,37)
MR_decl_label4(fn__hlds__hlds_error_util__describe_one_pred_info_name_2_0, 48,47,58,60)
...
MR_decl_label1(fn__hlds__hlds_error_util__describe_several_call_sites_3_0, 3)
MR_decl_label1(fn__hlds__hlds_error_util__describe_several_pred_names_3_0, 3)
MR_decl_label1(fn__hlds__hlds_error_util__describe_several_proc_names_3_0, 3)
...
MR_decl_entry(hlds__hlds_pred__pred_info_is_promise_2_0);
...
MR_BEGIN_MODULE(hlds__hlds_error_util_module0)
	...
	MR_init_label10(fn__hlds__hlds_error_util__describe_one_pred_info_name_2_0,12,16,9,32,31,38,40,41,42,37)
	MR_init_label4(fn__hlds__hlds_error_util__describe_one_pred_info_name_2_0,48,47,58,60)
MR_BEGIN_CODE
...
MR_def_label(fn__hlds__hlds_error_util__describe_one_pred_info_name_2_0,31)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(7);
	MR_np_call_localret_ent(hlds__hlds_pred__pred_info_is_promise_2_0,
		fn__hlds__hlds_error_util__describe_one_pred_info_name_2_0_i38);
MR_def_label(fn__hlds__hlds_error_util__describe_one_pred_info_name_2_0,38)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(fn__hlds__hlds_error_util__describe_one_pred_info_name_2_0_i37);
	}
	MR_r1 = MR_r2;
...
MR_def_label(fn__hlds__hlds_error_util__describe_one_pred_info_name_2_0,41)
	...
	MR_np_call_localret_ent(fn__f_115_116_114_105_110_103_95_95_43_43_2_0,
		fn__hlds__hlds_error_util__describe_one_pred_info_name_2_0_i42);
MR_def_label(fn__hlds__hlds_error_util__describe_one_pred_info_name_2_0,42)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_tag_alloc_heap(MR_r2, 3, (MR_Integer) 2);
	MR_tfield(3, MR_r2, 0) = (MR_Integer) 4;
	...
	MR_tag_alloc_heap(MR_r1, 1, (MR_Integer) 2);
	MR_tfield(1, MR_r1, 0) = MR_r2;
	MR_tfield(1, MR_r1, 1) = (MR_Word) MR_TAG_COMMON(1,0,2);
	MR_decr_sp_and_return(8);
MR_def_label(fn__hlds__hlds_error_util__describe_one_pred_info_name_2_0,37)
	...
	MR_r2 = (MR_Integer) 9;
	MR_np_call_localret_ent(hlds__hlds_pred__check_marker_2_0,
		fn__hlds__hlds_error_util__describe_one_pred_info_name_2_0_i48);
MR_def_label(fn__hlds__hlds_error_util__describe_one_pred_info_name_2_0,48)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(fn__hlds__hlds_error_util__describe_one_pred_info_name_2_0_i47);
	}
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tag_alloc_heap(MR_tempr1, 3, (MR_Integer) 2);
	...
	MR_GOTO_LAB(fn__hlds__hlds_error_util__describe_one_pred_info_name_2_0_i58);
	}
...
MR_def_label(fn__hlds__hlds_error_util__describe_one_pred_info_name_2_0,58)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_sv(6),0)) {
		MR_GOTO_LAB(fn__hlds__hlds_error_util__describe_one_pred_info_name_2_0_i60);
	}
	{
...
MR_def_label(fn__hlds__hlds_error_util__describe_one_pred_info_name_2_0,60)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2, MR_tempr3;
...
MR_def_label(fn__hlds__hlds_error_util__describe_one_pred_name_mode_5_0,8)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_string_const("hlds.hlds_error_util", 20);
	MR_r2 = (MR_Word) MR_string_const("function \140hlds.hlds_error_util.describe_one_pred_name_mode\'/5", 61);
	MR_r3 = (MR_Word) MR_string_const("bad argument list", 17);
...
MR_BEGIN_MODULE(hlds__hlds_error_util_module3)
	...
	MR_init_label1(fn__hlds__hlds_error_util__describe_several_pred_names_3_0,3)
MR_BEGIN_CODE
...
MR_define_entry(mercury__fn__hlds__hlds_error_util__describe_several_pred_names_3_0);
	...
	MR_np_call_localret_ent(fn__list__map_2_0,
		fn__hlds__hlds_error_util__describe_several_pred_names_3_0_i3);
MR_def_label(fn__hlds__hlds_error_util__describe_several_pred_names_3_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_def_label(fn__hlds__hlds_error_util__describe_one_proc_name_3_0,5)
	...
	MR_tag_alloc_heap(MR_tempr3, 1, (MR_Integer) 2);
	MR_r3 = MR_tempr3;
	MR_tfield(1, MR_tempr3, 0) = (MR_Word) MR_TAG_COMMON(3,2,6);
...
MR_BEGIN_MODULE(hlds__hlds_error_util_module6)
	...
	MR_init_label1(fn__hlds__hlds_error_util__describe_several_proc_names_3_0,3)
MR_BEGIN_CODE
...
MR_define_entry(mercury__fn__hlds__hlds_error_util__describe_several_proc_names_3_0);
	...
	MR_np_call_localret_ent(fn__list__map_2_0,
		fn__hlds__hlds_error_util__describe_several_proc_names_3_0_i3);
MR_def_label(fn__hlds__hlds_error_util__describe_several_proc_names_3_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_succip_word = MR_sv(1);
	MR_decr_sp(1);
	MR_np_tailcall_ent(fn__parse_tree__error_util__component_lists_to_pieces_1_0);
...
MR_BEGIN_MODULE(hlds__hlds_error_util_module8)
	...
	MR_init_label1(fn__hlds__hlds_error_util__describe_several_call_sites_3_0,3)
MR_BEGIN_CODE
...
MR_define_entry(mercury__fn__hlds__hlds_error_util__describe_several_call_sites_3_0);
	...
	MR_np_call_localret_ent(fn__list__map_2_0,
		fn__hlds__hlds_error_util__describe_several_call_sites_3_0_i3);
MR_def_label(fn__hlds__hlds_error_util__describe_several_call_sites_3_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_succip_word = MR_sv(1);
	MR_decr_sp(1);
	MR_np_tailcall_ent(fn__parse_tree__error_util__component_lists_to_pieces_1_0);
...
void mercury__hlds__hlds_error_util__init_threadscope_string_table(void);
#endif
...
void mercury__hlds__hlds_error_util__write_out_proc_statics(FILE *deep_fp, FILE *procrep_fp)
{
	MR_write_out_module_proc_reps_start(procrep_fp, &mercury_data__module_layout__hlds__hlds_error_util);
