                ...
                if (hlds__hlds_error_util__succeeded)
                  {
...

                    {
                      ...
                      MR_hl_field(MR_mktag(3), hlds__hlds_error_util__Var_54, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 13));
                ...
                else
                  {
...

                    {
                      ...
                      MR_hl_field(MR_mktag(3), hlds__hlds_error_util__Var_59, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 13));
