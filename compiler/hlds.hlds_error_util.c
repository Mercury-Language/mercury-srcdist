...
MR_decl_label3(hlds__hlds_error_util__maybe_write_out_errors_8_0, 13,4,5)
...
MR_decl_label8(fn__hlds__hlds_error_util__describe_one_pred_info_name_2_0, 13,14,12,16,9,32,31,37)
MR_decl_label8(fn__hlds__hlds_error_util__describe_one_pred_info_name_2_0, 39,40,41,36,47,46,57,59)
...
MR_decl_label8(fn__hlds__hlds_error_util__describe_one_pred_name_mode_5_0, 8,13,16,18,19,20,21,22)
MR_decl_label8(fn__hlds__hlds_error_util__describe_one_pred_name_mode_5_0, 23,15,26,27,28,29,14,32)
MR_decl_label3(fn__hlds__hlds_error_util__describe_one_pred_name_mode_5_0, 33,31,44)
...
MR_BEGIN_MODULE(hlds__hlds_error_util_module0)
	...
	MR_init_label8(fn__hlds__hlds_error_util__describe_one_pred_info_name_2_0,13,14,12,16,9,32,31,37)
	MR_init_label8(fn__hlds__hlds_error_util__describe_one_pred_info_name_2_0,39,40,41,36,47,46,57,59)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(hlds__hlds_error_util_module2)
	...
	MR_init_label8(fn__hlds__hlds_error_util__describe_one_pred_name_mode_5_0,8,13,16,18,19,20,21,22)
	MR_init_label8(fn__hlds__hlds_error_util__describe_one_pred_name_mode_5_0,23,15,26,27,28,29,14,32)
	MR_init_label3(fn__hlds__hlds_error_util__describe_one_pred_name_mode_5_0,33,31,44)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(hlds__hlds_error_util_module10)
	...
	MR_init_label3(hlds__hlds_error_util__maybe_write_out_errors_8_0,13,4,5)
MR_BEGIN_CODE
...
MR_define_entry(mercury__hlds__hlds_error_util__maybe_write_out_errors_8_0);
	...
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(hlds__hlds_error_util__maybe_write_out_errors_8_0_i13);
	}
	MR_r1 = MR_r3;
	MR_r2 = MR_r4;
	MR_proceed();
MR_def_label(hlds__hlds_error_util__maybe_write_out_errors_8_0,13)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(2);
	MR_sv(2) = (MR_Word) MR_succip;
	MR_sv(1) = MR_r3;
