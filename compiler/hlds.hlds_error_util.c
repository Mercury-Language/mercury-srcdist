  ...
  MR_Word PredInfo_9)
{
  ...
  else
  {
    ...
    else
    {
      ...
      {
        succeeded = hlds__hlds_pred__marker_is_present_2_p_0(Markers_14, (MR_Integer) 12);
        if (succeeded)
        {
          MR_Word Pieces0_107;
        ...
        else
        {
          ...
          else
          {
            ...
            succeeded = hlds__hlds_pred__marker_is_present_2_p_0(Markers_14, (MR_Integer) 11);
            if (succeeded)
            {
              MR_Word Var_88;
              MR_Word Var_89;
