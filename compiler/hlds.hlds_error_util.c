    ...
    case (MR_Integer) 1:
      {
        ...
        parse_tree__error_util__write_error_specs_8_p_0(Globals_10, STATE_VARIABLE_Specs_0_18, (MR_Integer) 0, &_NumWarnings_14, (MR_Integer) 0, &NumErrors_15);
...
{
  {
    ...
    parse_tree__error_util__write_error_specs_8_p_0(Globals_7, Specs_9, (MR_Integer) 0, &_NumWarnings_11, (MR_Integer) 0, &NumErrors_12);
        ...
        else
        {
          ...
          if (succeeded)
          {
...

            {
              ...
              MR_hl_field(MR_mktag(3), Var_54, 0) = ((MR_Box) ((MR_Unsigned) 20U));
