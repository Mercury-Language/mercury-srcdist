  ...
  MR_Word PredInfo_5)
{
  ...
  succeeded = ((MR_tag((MR_Word) Origin_13)) == (MR_Integer) 2);
  if (succeeded)
  {
    SpecialId_14 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(2), Origin_13, (MR_Integer) 0))) & (MR_Integer) 3);
    TypeCtor_15 = ((MR_Word) ((MR_hl_field(MR_mktag(2), Origin_13, (MR_Integer) 1))));
    {
      MR_String Descr_16;
