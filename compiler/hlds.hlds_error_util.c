  ...
  MR_Word Sites_7)
{
...

  {
    ...
    MR_hl_field(0, Var_10, 0) = ((MR_Box) (&hlds__hlds_error_util_scalar_common_3[2]));
  ...
  MR_Word PPIds_7)
{
  ...
  {
    Var_10 = (MR_Word) MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(0, Var_10, 0) = ((MR_Box) (&hlds__hlds_error_util_scalar_common_3[1]));
  ...
  MR_Word PredIds_7)
{
  ...
  {
    Var_10 = (MR_Word) MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(0, Var_10, 0) = ((MR_Box) (&hlds__hlds_error_util_scalar_common_3[0]));
  ...
  switch (PredOrFunc_19) {
    ...
    case (MR_Integer) 1:
      {
        ...
        {
          MR_String ArgsStr_49;
          MR_String Var_51;

          ArgsStr_49 = parse_tree__parse_tree_out_inst__mercury_mode_list_to_string_3_f_0(Lang_9, InstVarSet_12, FuncArgModes_24);
          Var_51 = mercury__string__f_43_43_2_f_0(ArgsStr_49, (MR_String) ")");
    ...
    case (MR_Integer) 0:
      ...
      else
      {
        ...
        ArgsStr_55 = parse_tree__parse_tree_out_inst__mercury_mode_list_to_string_3_f_0(Lang_9, InstVarSet_12, StrippedArgModes_22);
        Var_57 = mercury__string__f_43_43_2_f_0(ArgsStr_55, (MR_String) ")");
    ...
    case (MR_Integer) 0:
      {
        ...
        Var_38 = mercury__string__f_43_43_2_f_0(Var_59, (MR_String) ".");
      }
      break;
    case (MR_Integer) 1:
      Var_38 = (MR_String) "";
