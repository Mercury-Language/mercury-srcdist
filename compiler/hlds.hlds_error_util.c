...
{
  {
    ...
    mercury__set__delete_3_p_0(TypeCtorInfo_11_11, ((MR_Box) (Arity_7)), AritiesSet_9, &OtherAritiesSet_10);
    mercury__set__to_sorted_list_2_p_0(TypeCtorInfo_11_11, OtherAritiesSet_10, OtherArities_8);
  }
}
