  ...
  MR_Integer ProcId_13)
{
  ...
  mercury__map__count_2_p_0((MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_proc_id_0), (MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_proc_info_0), ProcTable_18, &NumProcs_19);
  ...
  if (succeeded)
  {
    ...
    hlds__hlds_pred__proc_info_get_argmodes_2_p_0(ProcInfo_20, &ArgModes0_22);
    ...
    hlds__hlds_pred__proc_info_get_inst_varset_2_p_0(ProcInfo_20, &InstVarSet_26);
