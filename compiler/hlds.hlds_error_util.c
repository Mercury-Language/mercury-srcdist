  ...
  MR_Word * STATE_VARIABLE_Specs_13)
{
  ...
  switch (Verbose_7) {
    ...
    case (MR_Integer) 1:
      {
        parse_tree__write_error_spec__write_error_specs_5_p_0(Stream_11, Globals_8, STATE_VARIABLE_Specs_0_12);
  ...
  MR_Word Specs_6)
{
  ...
  parse_tree__write_error_spec__write_error_specs_5_p_0(Stream_8, Globals_5, Specs_6);
}
