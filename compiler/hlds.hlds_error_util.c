  ...
  MR_Word PredInfo_5)
{
  ...
  if (succeeded)
  {
    Var_25 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Origin_13, (MR_Integer) 0))));
    succeeded = ((MR_tag((MR_Word) Var_25)) == (MR_Integer) 0);
    if (succeeded)
    {
      SpecialId_14 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Var_25, (MR_Integer) 0))) & (MR_Integer) 3);
      TypeCtor_15 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_25, (MR_Integer) 1))));
    }
  }
  if (succeeded)
  {
      ...
      case (MR_Integer) 1:
        {
          ...
          Var_26 = mdbcomp__sym_name__unqualify_name_1_f_0(TypeSymName0_17);
          {
            ...
            MR_hl_field(MR_mktag(0), TypeSymName_19, 0) = ((MR_Box) (Var_26));
          }
        }
        break;
    }
    ...
    if (succeeded)
    {
...

      {
        ...
        MR_hl_field(MR_mktag(3), Var_27, 1) = ((MR_Box) (Descr_16));
      }
      {
        ...
        MR_hl_field(MR_mktag(3), Var_32, 1) = ((MR_Box) (TypeSymName_19));
      }
      {
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(1), Var_28, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__hlds_error_util_scalar_common_1[1])));
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(1), Pieces_6, 0) = ((MR_Box) (Var_27));
        MR_hl_field(MR_mktag(1), Pieces_6, 1) = ((MR_Box) (Var_28));
      }
    }
    else
    {
...

      {
        ...
        MR_hl_field(MR_mktag(3), Var_34, 1) = ((MR_Box) (Descr_16));
      }
      {
        ...
        MR_hl_field(MR_mktag(3), Var_39, 1) = ((MR_Box) (TypeSymName_19));
      }
      {
        Var_38 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      ...
      }
      {
        ...
        MR_hl_field(MR_mktag(1), Var_35, 0) = ((MR_Box) (MR_mkword(MR_mktag(3), &hlds__hlds_error_util_scalar_common_1[2])));
        MR_hl_field(MR_mktag(1), Var_35, 1) = ((MR_Box) (Var_38));
      }
      {
        Pieces_6 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), Pieces_6, 0) = ((MR_Box) (Var_34));
  ...
  else
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        {
          Pieces_6 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), Pieces_6, 0) = ((MR_Box) (Var_45));
      ...
      else
      {
        ...
        if (succeeded)
        {
...

          {
            ...
            MR_hl_field(MR_mktag(3), Var_55, 0) = ((MR_Box) ((MR_Unsigned) 27U));
            MR_hl_field(MR_mktag(3), Var_55, 1) = (MR_Box) ((MR_Unsigned) (PredOrFunc_10));
          }
          {
            Var_54 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), Var_54, 0) = ((MR_Box) (Var_55));
            MR_hl_field(MR_mktag(1), Var_54, 1) = ((MR_Box) (MR_mkword(MR_mktag(1), &hlds__hlds_error_util_scalar_common_1[9])));
          }
          {
            ...
            MR_hl_field(MR_mktag(1), Prefix_21, 1) = ((MR_Box) (Var_54));
          }
        }
        else
        {
...

          {
            ...
            MR_hl_field(MR_mktag(3), Var_60, 0) = ((MR_Box) ((MR_Unsigned) 27U));
            MR_hl_field(MR_mktag(3), Var_60, 1) = (MR_Box) ((MR_Unsigned) (PredOrFunc_10));
          }
          {
            Prefix_21 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), Prefix_21, 0) = ((MR_Box) (Var_60));
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(1), Var_62, 0) = ((MR_Box) (PredSymNamePiece_24));
