  ...
  MR_Word * STATE_VARIABLE_DetInfo_22)
{
  ...
  Pieces_19 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_format_piece_0), (MR_Word) (MR_mkword(1, &check_hlds__det_check_switch_scalar_common_1[40])), Var_32);
  {
    ...
    MR_hl_field(0, Spec_20, 1) = ((MR_Box) (MR_mkword(1, &check_hlds__det_check_switch_scalar_common_2[4])));
  ...
  switch (Why_10) {
    ...
    case (MR_Integer) 1:
      ...
      else
      {
        ...
        libs__globals__lookup_int_option_3_p_0(Globals_30, (MR_Integer) 226, &Threshold_31);
        ...
        if (succeeded)
        {
          ...
          }
          {
            ...
            MR_hl_field(2, Spec_140, 1) = ((MR_Box) (MR_mkword(1, &check_hlds__det_check_switch_scalar_common_2[3])));
