                ...
                case (MR_Integer) 2:
                  {
                    ...
                    STATE_VARIABLE_Info_97_97 = ((MR_Word) ((MR_hl_field(2, MergeResult_67, 1))));
  ...
  MR_Word * Result_12)
{
  ...
  if (succeeded)
  {
    ...
    mercury__set__union_3_p_0((MR_Word) (&hlds__hlds_markers__hlds__hlds_markers__type_ctor_info_goal_feature_0), FirstFeatures_123, SecondFeatures_124, &Features_129);
