                    ...
                    if (check_hlds__simplify__simplify_goal_conj__succeeded)
                      {
                        ...
                        {
                          check_hlds__simplify__simplify_goal_conj__SubGoalCalledProcs_45 = hlds__goal_util__goals_callees_1_f_0(check_hlds__simplify__simplify_goal_conj__Goals0_25);
                        }
                        {
