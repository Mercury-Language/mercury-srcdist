  ...
  MR_Word * STATE_VARIABLE_Info_10)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      succeeded = ((((MR_tag((MR_Word) Var_83)) == (MR_Integer) 3)) && ((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), Var_83, (MR_Integer) 0))) == (MR_Integer) 2)));
      if (succeeded)
      {
      ...
      else
      {
        ...
        succeeded = ((((MR_tag((MR_Word) HeadGoalExpr1_37)) == (MR_Integer) 3)) && ((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), HeadGoalExpr1_37, (MR_Integer) 0))) == (MR_Integer) 2)));
        if (succeeded)
        {
        ...
        else
        {
          ...
          if (succeeded)
          {
            ...
            STATE_VARIABLE_PrevGoals_95_95 = mercury__cord__snoc_2_f_0((MR_Word) (&hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_hlds_goal_0), STATE_VARIABLE_PrevGoals_0_1, ((MR_Box) (HeadGoal1_36)));
            {
              ...
              succeeded = ((((MR_tag((MR_Word) Var_96)) == (MR_Integer) 3)) && ((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), Var_96, (MR_Integer) 0))) == (MR_Integer) 3)));
              if (succeeded)
              {
          ...
          else
          {
            ...
            if (succeeded)
            {
              succeeded = ((((MR_tag((MR_Word) HeadGoalExpr1_37)) == (MR_Integer) 3)) && ((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), HeadGoalExpr1_37, (MR_Integer) 0))) == (MR_Integer) 4)));
              if (succeeded)
              {
                ...
                succeeded = ((MR_tag((MR_Word) TailGoals0_25)) == (MR_Integer) 1);
                if (succeeded)
                {
