    ...
    else
    {
      ...
      else
      {
        ...
        *GoalInfo_14 = GoalInfo0_13;
        Goal0_50 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Goals0_11, (MR_Integer) 0))));
        Goals0_51 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Goals0_11, (MR_Integer) 1))));
        ...
        check_hlds__simplify__simplify_goal_conj__simplify_par_conjuncts_7_p_0(Goals0_51, &Goals_53, NestedContext0_15, InstMap1_58, STATE_VARIABLE_Common_0_27, STATE_VARIABLE_Info_26_61, &STATE_VARIABLE_Info_40_40);
        {
          ...
          MR_hl_field(MR_mktag(1), Goals_26, 0) = ((MR_Box) (Goal_52));
          MR_hl_field(MR_mktag(1), Goals_26, 1) = ((MR_Box) (Goals_53));
        }
        {
          MR_Word base;
