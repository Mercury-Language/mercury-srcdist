    ...
    else
    {
      ...
      else
      {
        ...
        if (succeeded)
        {
          ...
          // direct tailcall eliminated
          next_value_of_HeadVar__2_2 = HeadTailGoals1_109;
        ...
        else
        {
          ...
          else
          {
            ...
            if (succeeded)
            {
              ...
              // direct tailcall eliminated
              next_value_of_STATE_VARIABLE_PrevGoals_0_1 = STATE_VARIABLE_PrevGoals_98_112;
            ...
            else
            {
              ...
              // direct tailcall eliminated
              next_value_of_STATE_VARIABLE_PrevGoals_0_1 = STATE_VARIABLE_PrevGoals_98_113;
