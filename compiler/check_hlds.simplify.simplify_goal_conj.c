  ...
  else
  {
    ...
    else
    {
      ...
      else
      {
        ...
        MR_Word Goals_54;
        MR_Word InstMap1_59;
        MR_Word STATE_VARIABLE_Info_26_62;
        MR_Word _Common1_58;
        ...
        *GoalInfo_14 = GoalInfo0_13;
        ...
        check_hlds__simplify__simplify_goal__simplify_goal_8_p_0(Goal0_51, &Goal_53, NestedContext0_15, InstMap0_16, STATE_VARIABLE_Common_0_27, &_Common1_58, STATE_VARIABLE_Info_0_29, &STATE_VARIABLE_Info_26_62);
        hlds__goal_util__update_instmap_3_p_0(Goal_53, InstMap0_16, &InstMap1_59);
        check_hlds__simplify__simplify_goal_conj__simplify_par_conjuncts_7_p_0(Goals0_52, &Goals_54, NestedContext0_15, InstMap1_59, STATE_VARIABLE_Common_0_27, STATE_VARIABLE_Info_26_62, &STATE_VARIABLE_Info_34_34);
        {
  ...
  MR_Word * STATE_VARIABLE_Info_41)
{
  ...
  if ((Goals_20 == (MR_Word) ((MR_Unsigned) 0U)))
  {
    ...
    Var_57 = hlds__make_goal__true_goal_with_context_1_f_0(Context_21);
    *GoalExpr_12 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_57, (MR_Integer) 0))));
    *GoalInfo_14 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_57, (MR_Integer) 1))));
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        hlds__hlds_goal__goal_info_set_determinism_3_p_0(InnerDetism_30, GoalInfo0_13, &InnerInfo_31);
        {
          ...
          MR_hl_field(MR_mktag(3), Var_49, 1) = (MR_Box) ((MR_Unsigned) ((MR_Integer) 0));
          MR_hl_field(MR_mktag(3), Var_49, 2) = ((MR_Box) (Goals_20));
        }
        {
          InnerGoal_32 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), InnerGoal_32, 0) = ((MR_Box) (Var_49));
  ...
  MR_Word * STATE_VARIABLE_Info_24)
{
  ...
  check_hlds__simplify__simplify_goal_conj__find_excess_assigns_in_conj_7_p_0(STATE_VARIABLE_Info_0_23, ConjNonLocals_10, Goals0_7, (MR_Word) ((MR_Unsigned) 0U), &RevGoals_12, Subn0_11, &Subn1_13);
  ...
  else
  {
    ...
    mercury__list__reverse_2_p_0((MR_Word) (&hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_hlds_goal_0), RevGoals_12, &Goals1_14);
    {
      ...
      MR_hl_field(MR_mktag(0), Var_37, 0) = ((MR_Box) (&check_hlds__simplify__simplify_goal_conj_scalar_common_3[0]));
      MR_hl_field(MR_mktag(0), Var_37, 1) = ((MR_Box) (check_hlds__simplify__simplify_goal_conj__excess_assigns_in_conj_5_p_0_1));
      MR_hl_field(MR_mktag(0), Var_37, 2) = ((MR_Box) ((MR_Integer) 1));
      MR_hl_field(MR_mktag(0), Var_37, 3) = ((MR_Box) (Subn1_13));
    }
    mercury__map__map_values_only_3_p_0((MR_Word) (&check_hlds__simplify__simplify_goal_conj_scalar_common_1[0]), (MR_Word) (&check_hlds__simplify__simplify_goal_conj_scalar_common_1[0]), (MR_Word) (&check_hlds__simplify__simplify_goal_conj_scalar_common_1[0]), Var_37, Subn1_13, &Subn_15);
    hlds__hlds_goal__rename_vars_in_goals_4_p_0((MR_Integer) 1, Subn_15, Goals1_14, Goals_8);
    mercury__map__keys_2_p_0((MR_Word) (&check_hlds__simplify__simplify_goal_conj_scalar_common_1[0]), (MR_Word) (&check_hlds__simplify__simplify_goal_conj_scalar_common_1[0]), Subn0_11, &RemovedVars_16);
    check_hlds__simplify__simplify_info__simplify_info_get_varset_2_p_0(STATE_VARIABLE_Info_0_23, &VarSet0_17);
    mercury__varset__delete_vars_3_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), RemovedVars_16, VarSet0_17, &VarSet_18);
    check_hlds__simplify__simplify_info__simplify_info_set_varset_3_p_0(VarSet_18, STATE_VARIABLE_Info_0_23, &STATE_VARIABLE_Info_27_27);
    check_hlds__simplify__simplify_info__simplify_info_get_var_types_2_p_0(STATE_VARIABLE_Info_27_27, &VarTypes0_19);
    parse_tree__vartypes__delete_var_types_3_p_0(RemovedVars_16, VarTypes0_19, &VarTypes_20);
    check_hlds__simplify__simplify_info__simplify_info_set_var_types_3_p_0(VarTypes_20, STATE_VARIABLE_Info_27_27, &STATE_VARIABLE_Info_28_28);
    check_hlds__simplify__simplify_info__simplify_info_get_rtti_varmaps_2_p_0(STATE_VARIABLE_Info_28_28, &RttiVarMaps0_21);
    Var_29 = mercury__map__init_0_f_0((MR_Word) (&check_hlds__simplify__simplify_goal_conj_scalar_common_1[1]), (MR_Word) (&check_hlds__simplify__simplify_goal_conj_scalar_common_1[1]));
    Var_30 = mercury__map__init_0_f_0((MR_Word) (&check_hlds__simplify__simplify_goal_conj_scalar_common_1[1]), (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0));
    hlds__hlds_rtti__apply_substitutions_to_rtti_varmaps_5_p_0(Var_29, Var_30, Subn_15, RttiVarMaps0_21, &RttiVarMaps_22);
    check_hlds__simplify__simplify_info__simplify_info_set_rtti_varmaps_3_p_0(RttiVarMaps_22, STATE_VARIABLE_Info_28_28, STATE_VARIABLE_Info_24);
  }
}
  ...
  MR_Word * STATE_VARIABLE_Subn_7)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      MR_Word Var_46 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Goal_18, (MR_Integer) 0))));
      MR_Word TypeCtorInfo__33_49;
      MR_Word TypeCtorInfo__32_48;
      MR_Word TypeCtorInfo__9_60;
      MR_Word Var_47;
      MR_String Name_56;
      MR_String Suffix_57;
      MR_String Var_59;
      MR_Integer Var_58;
      MR_Word TypeCtorInfo__9_65;
      MR_String Name_61;
      MR_String Suffix_62;
      MR_String Var_64;
      MR_Integer Var_63;
      ...
      if (succeeded)
      {
        Unif_32 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Var_46, (MR_Integer) 3))));
        succeeded = ((MR_tag((MR_Word) Unif_32)) == (MR_Integer) 2);
        if (succeeded)
        {
          LeftVar0_35 = ((MR_Word) ((MR_hl_field(MR_mktag(2), Unif_32, (MR_Integer) 0))));
          RightVar0_36 = ((MR_Word) ((MR_hl_field(MR_mktag(2), Unif_32, (MR_Integer) 1))));
          ...
          TypeCtorInfo__33_49 = (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0);
          succeeded = parse_tree__set_of_var__member_2_p_0(TypeCtorInfo__33_49, ConjNonLocals_2, RightVar_38);
          if (succeeded)
            CanElimRight_40 = (MR_Integer) 0;
          else
            CanElimRight_40 = (MR_Integer) 1;
          check_hlds__simplify__simplify_info__simplify_info_get_varset_2_p_0(Info_1, &VarSet_41);
          TypeCtorInfo__32_48 = (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0);
          succeeded = parse_tree__set_of_var__member_2_p_0(TypeCtorInfo__32_48, ConjNonLocals_2, LeftVar_37);
          if (succeeded)
          {
              ...
              case (MR_Integer) 1:
                {
                  ...
                  succeeded = mercury__varset__search_name_3_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), VarSet_41, LeftVar_37, &Name_51);
                  if (succeeded)
                  {
                    Var_54 = (MR_String) "HeadVar__";
                    succeeded = mercury__string__append_3_p_1(Var_54, &Suffix_52, Name_51);
                    if (succeeded)
                      succeeded = mercury__string__to_int_2_p_0(Suffix_52, &Var_53);
                    succeeded = !(succeeded);
                  }
                  if (succeeded)
                  {
          ...
          if (succeeded)
          {
            check_hlds__simplify__simplify_info__simplify_info_get_trace_level_optimized_3_p_0(Info_1, &TraceLevel_44, &TraceOptimized_45);
            Var_47 = libs__trace_params__trace_level_needs_meaningful_var_names_1_f_0(TraceLevel_44);
            ...
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                TypeCtorInfo__9_60 = (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0);
                succeeded = mercury__varset__search_name_3_p_0(TypeCtorInfo__9_60, VarSet_41, ElimVar_42, &Name_56);
                if (succeeded)
                {
                  Var_59 = (MR_String) "HeadVar__";
                  succeeded = mercury__string__append_3_p_1(Var_59, &Suffix_57, Name_56);
                  if (succeeded)
                    succeeded = mercury__string__to_int_2_p_0(Suffix_57, &Var_58);
                  succeeded = !(succeeded);
                  if (succeeded)
                  {
                    TypeCtorInfo__9_65 = (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0);
                    succeeded = mercury__varset__search_name_3_p_0(TypeCtorInfo__9_65, VarSet_41, ReplacementVar_43, &Name_61);
                    if (succeeded)
                    {
                      Var_64 = (MR_String) "HeadVar__";
                      succeeded = mercury__string__append_3_p_1(Var_64, &Suffix_62, Name_61);
                      if (succeeded)
                        succeeded = mercury__string__to_int_2_p_0(Suffix_62, &Var_63);
                      succeeded = !(succeeded);
                    }
                    succeeded = !(succeeded);
                  }
            ...
            if (succeeded)
            {
              TypeInfo__34_50 = (MR_Word) (&check_hlds__simplify__simplify_goal_conj_scalar_common_1[0]);
              mercury__map__det_insert_4_p_0(TypeInfo__34_50, TypeInfo__34_50, ((MR_Box) (ElimVar_42)), ((MR_Box) (ReplacementVar_43)), STATE_VARIABLE_Subn_0_6, &STATE_VARIABLE_Subn_26_26);
              succeeded = MR_TRUE;
            }
          }
        }
      ...
      else
      {
        ...
        else
        {
          ...
          if (!(succeeded))
          {
            ...
            parse_tree__prog_data__determinism_components_3_p_0(Detism1_41, &Var_42, &Var_75);
            succeeded = ((MR_Integer) 0 == Var_75);
          }
          if (succeeded)
          {
            ...
            MR_Word DeletedCallCallees0_76;
            MR_Word SubGoalCalledProcs_77;
            MR_Word DeletedCallCallees_78;
            MR_Word STATE_VARIABLE_PrevGoals_23_81;
            MR_Word STATE_VARIABLE_PrevGoals_26_84;

            HeadGoalContext0_45 = hlds__hlds_goal__goal_info_get_context_1_f_0(HeadGoalInfo0_44);
            check_hlds__simplify__simplify_info__simplify_info_get_deleted_call_callees_2_p_0(STATE_VARIABLE_Info_57_57, &DeletedCallCallees0_76);
            SubGoalCalledProcs_77 = hlds__goal_util__goals_proc_refs_1_f_0(TailGoals0_25);
            mercury__set__union_3_p_0((MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_proc_id_0), SubGoalCalledProcs_77, DeletedCallCallees0_76, &DeletedCallCallees_78);
            check_hlds__simplify__simplify_info__simplify_info_set_deleted_call_callees_3_p_0(DeletedCallCallees_78, STATE_VARIABLE_Info_57_57, &STATE_VARIABLE_Info_63_63);
            STATE_VARIABLE_PrevGoals_23_81 = mercury__cord__snoc_2_f_0((MR_Word) (&hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_hlds_goal_0), STATE_VARIABLE_PrevGoals_0_1, ((MR_Box) (HeadGoal1_36)));
            {
              MR_Word Var_82 = ((MR_Word) ((MR_hl_field(MR_mktag(0), HeadGoal1_36, (MR_Integer) 0))));
              MR_Word Var_83;

              succeeded = ((((MR_tag((MR_Word) Var_82)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(MR_mktag(3), Var_82, (MR_Integer) 0)))) == (MR_Integer) 3)));
              if (succeeded)
              {
            ...
            if (succeeded)
              STATE_VARIABLE_PrevGoals_26_84 = STATE_VARIABLE_PrevGoals_23_81;
            else
            {
              MR_Word FailGoal_80;

              FailGoal_80 = hlds__make_goal__fail_goal_with_context_1_f_0(HeadGoalContext0_45);
              STATE_VARIABLE_PrevGoals_26_84 = mercury__cord__snoc_2_f_0((MR_Word) (&hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_hlds_goal_0), STATE_VARIABLE_PrevGoals_23_81, ((MR_Box) (FailGoal_80)));
            }
            *Goals_3 = mercury__cord__list_1_f_0((MR_Word) (&hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_hlds_goal_0), STATE_VARIABLE_PrevGoals_26_84);
            ...
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                ...
                if (succeeded)
                {
                  ...
                  TypeCtorInfo__53_53 = (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0);
                  succeeded = parse_tree__set_of_var__contains_2_p_0(TypeCtorInfo__53_53, ConjNonLocals_37, TestVar_29);
                  succeeded = !(succeeded);
                  if (succeeded)
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          TypeInfo__50_50 = (MR_Word) (&check_hlds__simplify__simplify_goal_conj_scalar_common_1[0]);
          succeeded = mercury__builtin__unify_2_p_0(TypeInfo__50_50, ((MR_Box) (TestVar_2)), ((MR_Box) (Var_49)));
          if (succeeded)
          {
