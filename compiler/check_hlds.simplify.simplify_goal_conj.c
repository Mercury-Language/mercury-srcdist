  ...
  MR_Word * STATE_VARIABLE_Info_10)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), Var_83, (MR_Integer) 1)));
      ...
      else
      {
        ...
        if (succeeded)
        {
          packed_args_1 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), HeadGoalExpr1_37, (MR_Integer) 1)));
          ...
          else
          {
            ...
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                ...
                packed_args_2 = (MR_Unsigned) ((MR_hl_field(MR_mktag(3), HeadGoalExpr1_37, (MR_Integer) 2)));
                ...
                if (succeeded)
                {
                  ...
                  if (succeeded)
                  {
                    ...
                    if (succeeded)
                    {
                      ...
                      packed_args_3 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), Unification_61, (MR_Integer) 4)));
                      DeconstructCanFail_67 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(1), Unification_61, (MR_Integer) 4))) >> (MR_Integer) 1)) & (MR_Integer) 1);
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Unification_30, (MR_Integer) 5)));
