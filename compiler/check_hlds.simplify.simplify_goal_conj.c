...
{
  {
    ...
    {
      libs__globals__lookup_bool_option_3_p_0(check_hlds__simplify__simplify_goal_conj__Globals_13, (MR_Integer) 127, &check_hlds__simplify__simplify_goal_conj__TraceOptimized_15);
    }
    {
