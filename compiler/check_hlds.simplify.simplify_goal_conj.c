...
{
  {
    ...
    if ((Goals0_11 == (MR_Word) ((MR_Integer) 0)))
    {
      MR_Word Context_19;
      MR_Word Var_43;
...
{
  {
    ...
    if (succeeded)
    {
      ...
      check_hlds__simplify__simplify_goal_conj__find_excess_assigns_in_conj_7_p_0(STATE_VARIABLE_Info_0_35, ConjNonLocals_62, Goals0_11, (MR_Word) ((MR_Integer) 0), &RevGoals_64, Subn0_63, &Subn1_65);
    ...
    if ((Goals_20 == (MR_Word) ((MR_Integer) 0)))
    {
      MR_Word Context_21;
      MR_Word Var_51;
      ...
      else
      {
        ...
        else
        {
          ...
          if (succeeded)
          {
            ...
            if (!(succeeded))
              succeeded = (TailGoals0_25 == (MR_Word) ((MR_Integer) 0));
            if (succeeded)
          ...
          else
          {
                ...
                if (succeeded)
                {
                  ...
                  if (succeeded)
                  {
                    ...
                    if (succeeded)
                    {
                      ...
                      succeeded = (TestArgs_65 == (MR_Word) ((MR_Integer) 0));
                      if (succeeded)
                      {
                        succeeded = (DeconstructCanFail_67 == (MR_Integer) 0);
                        if (succeeded)
                        {
                          Var_99 = (MR_Word) ((MR_Integer) 0);
            ...
            if (succeeded)
            {
              ...
              if ((RevDiffCases_70 == (MR_Word) ((MR_Integer) 0)))
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
              succeeded = (CaseArgs_33 == (MR_Word) ((MR_Integer) 0));
            if (succeeded)
            {
              MR_Word Context_38;
              MR_Word TrueGoal_39;
