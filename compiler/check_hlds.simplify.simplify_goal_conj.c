  ...
  MR_Box * wrapper_arg_3)
{
  ...
  check_hlds__simplify__simplify_goal_conj__IntroducedFrom__pred__build_maps_first_switch__673__1_4_p_0(((MR_Unsigned) ((MR_hl_field(0, closure, 3)))), ((MR_Word) (wrapper_arg_1)), ((MR_Word) (wrapper_arg_2)), &conv0_HeadVar__4_39);
