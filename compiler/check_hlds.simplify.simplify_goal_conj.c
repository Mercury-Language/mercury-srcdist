...
check_hlds__simplify__simplify_goal_conj__simplify_goal_plain_conj_10_p_0(
  ...
  MR_Word NestedContext0_15,
  MR_Word InstMap0_16,
  MR_Word STATE_VARIABLE_Common_0_37,
  MR_Word * STATE_VARIABLE_Common_38,
  ...
  MR_Word * STATE_VARIABLE_Info_40)
{
  ...
  succeeded = check_hlds__simplify__simplify_info__simplify_do_excess_assign_1_p_0(STATE_VARIABLE_Info_0_39);
  if (succeeded)
    check_hlds__simplify__simplify_goal_conj__excess_assigns_in_conj_5_p_0(GoalInfo0_13, Goals0_11, &Goals1_19, STATE_VARIABLE_Info_0_39, &STATE_VARIABLE_Info_41_41);
  else
  {
    Goals1_19 = Goals0_11;
    STATE_VARIABLE_Info_41_41 = STATE_VARIABLE_Info_0_39;
  }
  Var_42 = mercury__cord__empty_0_f_0((MR_Word) (&hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_hlds_goal_0));
  check_hlds__simplify__simplify_goal_conj__simplify_conj_10_p_0(Var_42, Goals1_19, &Goals_20, GoalInfo0_13, NestedContext0_15, InstMap0_16, STATE_VARIABLE_Common_0_37, STATE_VARIABLE_Common_38, STATE_VARIABLE_Info_41_41, &STATE_VARIABLE_Info_44_44);
  if ((Goals_20 == (MR_Word) ((MR_Unsigned) 0U)))
  {
    ...
    Var_56 = hlds__make_goal__true_goal_with_context_1_f_0(Context_21);
    *GoalExpr_12 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_56, (MR_Integer) 0))));
    *GoalInfo_14 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_56, (MR_Integer) 1))));
    *STATE_VARIABLE_Info_40 = STATE_VARIABLE_Info_44_44;
  }
  else
  {
    MR_Word Var_86 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Goals_20, (MR_Integer) 1))));
    MR_Word Var_87 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Goals_20, (MR_Integer) 0))));

    if ((Var_86 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      MR_Word SingleGoalExpr_23 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_87, (MR_Integer) 0))));
      MR_Word SingleGoalInfo_24 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_87, (MR_Integer) 1))));

      check_hlds__simplify__simplify_goal__simplify_maybe_wrap_goal_7_p_0(GoalInfo0_13, SingleGoalInfo_24, SingleGoalExpr_23, GoalExpr_12, GoalInfo_14, STATE_VARIABLE_Info_44_44, STATE_VARIABLE_Info_40);
    }
    else
    {
      MR_Word Detism_28;
      ...
      parse_tree__prog_data__determinism_components_3_p_0(Detism_28, &CanFail_29, &Var_85);
      succeeded = ((MR_Integer) 0 == Var_85);
      if (succeeded)
      {
        succeeded = check_hlds__simplify__simplify_info__simplify_do_mark_code_model_changes_1_p_0(STATE_VARIABLE_Info_44_44);
        if (succeeded)
      ...
      if (succeeded)
      {
        ...
        hlds__hlds_goal__goal_info_set_determinism_3_p_0(InnerDetism_30, GoalInfo0_13, &InnerInfo_31);
        {
          ...
          MR_hl_field(MR_mktag(3), Var_48, 2) = ((MR_Box) (Goals_20));
        }
        {
          InnerGoal_32 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), InnerGoal_32, 0) = ((MR_Box) (Var_48));
        ...
        check_hlds__simplify__simplify_info__simplify_info_set_rerun_quant_instmap_delta_2_p_0(STATE_VARIABLE_Info_44_44, STATE_VARIABLE_Info_40);
      }
      else
      {
        {
  ...
  MR_Word * STATE_VARIABLE_Info_24)
{
  ...
  else
  {
    ...
    mercury__list__reverse_2_p_0((MR_Word) (&hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_hlds_goal_0), RevGoals_12, &Goals1_14);
    {
      ...
      MR_hl_field(MR_mktag(0), Var_39, 0) = ((MR_Box) (&check_hlds__simplify__simplify_goal_conj_scalar_common_3[0]));
      MR_hl_field(MR_mktag(0), Var_39, 1) = ((MR_Box) (check_hlds__simplify__simplify_goal_conj__excess_assigns_in_conj_5_p_0_1));
      MR_hl_field(MR_mktag(0), Var_39, 2) = ((MR_Box) ((MR_Integer) 1));
      MR_hl_field(MR_mktag(0), Var_39, 3) = ((MR_Box) (Subn1_13));
    }
    mercury__map__map_values_only_3_p_0((MR_Word) (&check_hlds__simplify__simplify_goal_conj_scalar_common_1[0]), (MR_Word) (&check_hlds__simplify__simplify_goal_conj_scalar_common_1[0]), (MR_Word) (&check_hlds__simplify__simplify_goal_conj_scalar_common_1[0]), Var_39, Subn1_13, &Subn_15);
    ...
    hlds__vartypes__delete_var_types_3_p_0(RemovedVars_16, VarTypes0_19, &VarTypes_20);
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          TypeCtorInfo_33_56 = (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0);
          succeeded = parse_tree__set_of_var__member_2_p_0(TypeCtorInfo_33_56, ConjNonLocals_2, RightVar_44);
          if (succeeded)
            CanElimRight_46 = (MR_Integer) 0;
          else
            CanElimRight_46 = (MR_Integer) 1;
          check_hlds__simplify__simplify_info__simplify_info_get_varset_2_p_0(Info_1, &VarSet_47);
          TypeCtorInfo_32_55 = (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0);
          succeeded = parse_tree__set_of_var__member_2_p_0(TypeCtorInfo_32_55, ConjNonLocals_2, LeftVar_43);
          if (succeeded)
          {
              ...
              case (MR_Integer) 1:
                {
                  ...
                  succeeded = mercury__varset__search_name_3_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), VarSet_47, LeftVar_43, &Name_60);
                  if (succeeded)
                  {
          ...
          if (succeeded)
          {
            check_hlds__simplify__simplify_info__simplify_info_get_trace_level_optimized_3_p_0(Info_1, &TraceLevel_50, &TraceOptimized_51);
            Var_53 = libs__trace_params__trace_level_needs_meaningful_var_names_1_f_0(TraceLevel_50);
            ...
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                TypeCtorInfo_9_71 = (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0);
                succeeded = mercury__varset__search_name_3_p_0(TypeCtorInfo_9_71, VarSet_47, ElimVar_48, &Name_67);
                if (succeeded)
                {
                  Var_70 = (MR_String) "HeadVar__";
                  succeeded = mercury__string__append_3_p_1(Var_70, &Suffix_68, Name_67);
                  if (succeeded)
                    succeeded = mercury__string__to_int_2_p_0(Suffix_68, &Var_69);
                  succeeded = !(succeeded);
                  if (succeeded)
                  {
                    TypeCtorInfo_9_78 = (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0);
                    succeeded = mercury__varset__search_name_3_p_0(TypeCtorInfo_9_78, VarSet_47, ReplacementVar_49, &Name_74);
                    if (succeeded)
                    {
                      Var_77 = (MR_String) "HeadVar__";
                      succeeded = mercury__string__append_3_p_1(Var_77, &Suffix_75, Name_74);
                      if (succeeded)
                        succeeded = mercury__string__to_int_2_p_0(Suffix_75, &Var_76);
                      succeeded = !(succeeded);
                    }
                    succeeded = !(succeeded);
                  }
            ...
            if (succeeded)
            {
              TypeInfo_34_57 = (MR_Word) (&check_hlds__simplify__simplify_goal_conj_scalar_common_1[0]);
              mercury__map__det_insert_4_p_0(TypeInfo_34_57, TypeInfo_34_57, ((MR_Box) (ElimVar_48)), ((MR_Box) (ReplacementVar_49)), STATE_VARIABLE_Subn_0_6, &STATE_VARIABLE_Subn_26_26);
              succeeded = MR_TRUE;
            }
          }
        }
