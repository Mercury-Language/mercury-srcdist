...
{
  {
    ...
    if ((Goals_20 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      ...
      Var_55 = hlds__make_goal__true_goal_with_context_1_f_0(Context_21);
      *GoalExpr_12 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_55, (MR_Integer) 0))));
      *GoalInfo_14 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_55, (MR_Integer) 1))));
      *STATE_VARIABLE_Info_39 = STATE_VARIABLE_Info_43_43;
    }
    else
    {
      MR_Word Var_84 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Goals_20, (MR_Integer) 1))));
      MR_Word Var_85 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Goals_20, (MR_Integer) 0))));

      if ((Var_84 == (MR_Word) ((MR_Unsigned) 0U)))
      {
        MR_Word SingleGoalExpr_23 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_85, (MR_Integer) 0))));
        MR_Word SingleGoalInfo_24 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_85, (MR_Integer) 1))));
      ...
      else
      {
        ...
        parse_tree__prog_data__determinism_components_3_p_0(Detism_28, &CanFail_29, &Var_83);
        succeeded = ((MR_Integer) 0 == Var_83);
        if (succeeded)
        {
        ...
        if (succeeded)
        {
          ...
          check_hlds__simplify__simplify_info__simplify_info_set_rerun_quant_instmap_delta_2_p_0(STATE_VARIABLE_Info_43_43, STATE_VARIABLE_Info_39);
        }
        else
        {
          {
