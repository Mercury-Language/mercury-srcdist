...
check_hlds__simplify__simplify_goal_conj__simplify_goal_plain_conj_10_p_0(
  ...
  MR_Word NestedContext0_15,
  MR_Word InstMap0_16,
  MR_Word STATE_VARIABLE_Common_0_36,
  MR_Word * STATE_VARIABLE_Common_37,
...
{
  {
    ...
    succeeded = check_hlds__simplify__simplify_info__simplify_do_excess_assign_1_p_0(STATE_VARIABLE_Info_0_38);
    if (succeeded)
      check_hlds__simplify__simplify_goal_conj__excess_assigns_in_conj_5_p_0(GoalInfo0_13, Goals0_11, &Goals1_19, STATE_VARIABLE_Info_0_38, &STATE_VARIABLE_Info_40_40);
    else
    {
      Goals1_19 = Goals0_11;
      STATE_VARIABLE_Info_40_40 = STATE_VARIABLE_Info_0_38;
    }
    Var_41 = mercury__cord__empty_0_f_0((MR_Word) (&hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_hlds_goal_0));
    check_hlds__simplify__simplify_goal_conj__simplify_conj_10_p_0(Var_41, Goals1_19, &Goals_20, GoalInfo0_13, NestedContext0_15, InstMap0_16, STATE_VARIABLE_Common_0_36, STATE_VARIABLE_Common_37, STATE_VARIABLE_Info_40_40, &STATE_VARIABLE_Info_43_43);
    if ((Goals_20 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      ...
      Var_54 = hlds__make_goal__true_goal_with_context_1_f_0(Context_21);
      *GoalExpr_12 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_54, (MR_Integer) 0))));
      *GoalInfo_14 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_54, (MR_Integer) 1))));
      *STATE_VARIABLE_Info_39 = STATE_VARIABLE_Info_43_43;
    }
    else
    {
      MR_Word Var_83 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Goals_20, (MR_Integer) 1))));
      MR_Word Var_84 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Goals_20, (MR_Integer) 0))));

      if ((Var_83 == (MR_Word) ((MR_Unsigned) 0U)))
      {
        MR_Word SingleGoalExpr_23 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_84, (MR_Integer) 0))));
        MR_Word SingleGoalInfo_24 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_84, (MR_Integer) 1))));

        check_hlds__simplify__simplify_goal__simplify_maybe_wrap_goal_7_p_0(GoalInfo0_13, SingleGoalInfo_24, SingleGoalExpr_23, GoalExpr_12, GoalInfo_14, STATE_VARIABLE_Info_43_43, STATE_VARIABLE_Info_39);
      }
      else
      {
        MR_Word Detism_28;
        ...
        parse_tree__prog_data__determinism_components_3_p_0(Detism_28, &CanFail_29, &Var_82);
        succeeded = ((MR_Integer) 0 == Var_82);
        if (succeeded)
        {
          succeeded = check_hlds__simplify__simplify_info__simplify_do_mark_code_model_changes_1_p_0(STATE_VARIABLE_Info_43_43);
          if (succeeded)
        ...
        if (succeeded)
        {
          ...
          hlds__hlds_goal__goal_info_set_determinism_3_p_0(InnerDetism_30, GoalInfo0_13, &InnerInfo_31);
          {
            ...
            MR_hl_field(MR_mktag(3), Var_47, 2) = ((MR_Box) (Goals_20));
          }
          {
            InnerGoal_32 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
            MR_hl_field(MR_mktag(0), InnerGoal_32, 0) = ((MR_Box) (Var_47));
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      else
      {
        ...
        if (succeeded)
        {
          MR_Word HeadTailGoals1_68;
          MR_Word next_value_of_HeadVar__2_2;
          MR_Word next_value_of_STATE_VARIABLE_Info_0_9;

          HeadTailGoals1_68 = mercury__list__f_43_43_2_f_0((MR_Word) (&hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_hlds_goal_0), HeadSubGoals1_39, TailGoals0_25);
          // direct tailcall eliminated
          ;
          next_value_of_HeadVar__2_2 = HeadTailGoals1_68;
        ...
        else
        {
          ...
          if (!(succeeded))
          {
            ...
            parse_tree__prog_data__determinism_components_3_p_0(Detism1_41, &Var_42, &Var_74);
          ...
          if (succeeded)
          {
            ...
            check_hlds__simplify__simplify_goal_conj__delete_tail_unreachable_goals_7_p_0(STATE_VARIABLE_PrevGoals_0_1, HeadGoalContext0_45, HeadGoal1_36, TailGoals0_25, Goals_3, STATE_VARIABLE_Info_57_57, STATE_VARIABLE_Info_10);
            *STATE_VARIABLE_Common_8 = STATE_VARIABLE_Common_56_56;
          }
          else
          {
            MR_Word TailGoals1_46;
            MR_Word STATE_VARIABLE_PrevGoals_64_64;
            ...
            check_hlds__simplify__simplify_goal_conj__try_to_opt_test_after_switch_8_p_0(STATE_VARIABLE_PrevGoals_0_1, &STATE_VARIABLE_PrevGoals_64_64, HeadGoal1_36, TailGoals0_25, &TailGoals1_46, HeadVar__4_4, STATE_VARIABLE_Info_57_57, &STATE_VARIABLE_Info_65_65);
            // direct tailcall eliminated
            ;
            next_value_of_STATE_VARIABLE_PrevGoals_0_1 = STATE_VARIABLE_PrevGoals_64_64;
            ...
            next_value_of_STATE_VARIABLE_Info_0_9 = STATE_VARIABLE_Info_65_65;
...
{
  {
    ...
    if (succeeded)
    {
      ...
      check_hlds__simplify__simplify_info__simplify_info_set_should_rerun_det_2_p_0(STATE_VARIABLE_Info_0_46, STATE_VARIABLE_Info_47);
