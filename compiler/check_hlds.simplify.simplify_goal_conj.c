  ...
  MR_Word * STATE_VARIABLE_Info_30)
{
  ...
  else
  {
    ...
    if ((Var_44 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      ...
      check_hlds__simplify__simplify_goal__simplify_goal_8_p_0(Var_45, &Var_33, NestedContext0_15, InstMap0_16, STATE_VARIABLE_Common_0_27, STATE_VARIABLE_Common_28, STATE_VARIABLE_Info_0_29, &STATE_VARIABLE_Info_35_35);
    ...
    else
    {
      ...
      else
      {
        ...
        *GoalInfo_14 = GoalInfo0_13;
        ...
        check_hlds__simplify__simplify_goal_conj__simplify_par_conjuncts_7_p_0(Goals0_53, &Goals_55, NestedContext0_15, InstMap1_61, STATE_VARIABLE_Common_0_27, STATE_VARIABLE_Info_26_64, &STATE_VARIABLE_Info_40_40);
        {
  ...
  MR_Word * STATE_VARIABLE_Info_22)
{
  ...
  else
  {
    ...
    mercury__list__reverse_2_p_0((MR_Word) (&hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_hlds_goal_0), RevGoals_12, &Goals1_14);
    {
      ...
      MR_hl_field(MR_mktag(0), Var_35, 0) = ((MR_Box) (&check_hlds__simplify__simplify_goal_conj_scalar_common_3[0]));
      MR_hl_field(MR_mktag(0), Var_35, 1) = ((MR_Box) (check_hlds__simplify__simplify_goal_conj__excess_assigns_in_conj_5_p_0_1));
      MR_hl_field(MR_mktag(0), Var_35, 2) = ((MR_Box) ((MR_Integer) 1));
      MR_hl_field(MR_mktag(0), Var_35, 3) = ((MR_Box) (Subn1_13));
    }
    mercury__map__map_values_only_3_p_0((MR_Word) (&check_hlds__simplify__simplify_goal_conj_scalar_common_1[0]), (MR_Word) (&check_hlds__simplify__simplify_goal_conj_scalar_common_1[0]), (MR_Word) (&check_hlds__simplify__simplify_goal_conj_scalar_common_1[0]), Var_35, Subn1_13, &Subn_15);
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          check_hlds__simplify__simplify_info__simplify_info_get_var_table_2_p_0(Info_1, &VarTable_49);
              ...
              case (MR_Integer) 1:
                {
                  ...
                  parse_tree__var_table__lookup_var_entry_3_p_0(VarTable_49, LeftVar_45, &Entry_62);
                  Name_63 = ((MR_String) ((MR_hl_field(MR_mktag(0), Entry_62, (MR_Integer) 0))));
                  succeeded = (strcmp(Name_63, (MR_String) "") == 0);
                  succeeded = !(succeeded);
                  if (succeeded)
                  {
                    Var_66 = (MR_String) "HeadVar__";
                    succeeded = mercury__string__append_3_p_1(Var_66, &Suffix_64, Name_63);
                    if (succeeded)
                      succeeded = mercury__string__to_int_2_p_0(Suffix_64, &Var_65);
                    succeeded = !(succeeded);
                  }
                  if (succeeded)
                  {
          ...
          if (succeeded)
          {
            check_hlds__simplify__simplify_info__simplify_info_get_eff_trace_level_optimized_3_p_0(Info_1, &EffTraceLevel_52, &TraceOptimized_53);
            Var_55 = libs__trace_params__eff_trace_level_needs_meaningful_var_names_1_f_0(EffTraceLevel_52);
            ...
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                parse_tree__var_table__lookup_var_entry_3_p_0(VarTable_49, ElimVar_50, &Entry_71);
                Name_72 = ((MR_String) ((MR_hl_field(MR_mktag(0), Entry_71, (MR_Integer) 0))));
                succeeded = (strcmp(Name_72, (MR_String) "") == 0);
                succeeded = !(succeeded);
                if (succeeded)
                {
                  Var_75 = (MR_String) "HeadVar__";
                  succeeded = mercury__string__append_3_p_1(Var_75, &Suffix_73, Name_72);
                  if (succeeded)
                    succeeded = mercury__string__to_int_2_p_0(Suffix_73, &Var_74);
                  succeeded = !(succeeded);
                  if (succeeded)
                  {
                    parse_tree__var_table__lookup_var_entry_3_p_0(VarTable_49, ReplacementVar_51, &Entry_80);
                    Name_81 = ((MR_String) ((MR_hl_field(MR_mktag(0), Entry_80, (MR_Integer) 0))));
                    succeeded = (strcmp(Name_81, (MR_String) "") == 0);
                    succeeded = !(succeeded);
                    if (succeeded)
                    {
                      Var_84 = (MR_String) "HeadVar__";
                      succeeded = mercury__string__append_3_p_1(Var_84, &Suffix_82, Name_81);
                      if (succeeded)
                        succeeded = mercury__string__to_int_2_p_0(Suffix_82, &Var_83);
                      succeeded = !(succeeded);
                    }
                    succeeded = !(succeeded);
                  }
