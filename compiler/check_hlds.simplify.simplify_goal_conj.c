  ...
  if (succeeded)
  {
    ...
    else
    {
      ...
      mercury__list__reverse_2_p_0((MR_Word) (&hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_hlds_goal_0), RevGoals_91, &Goals1_93);
      {
        ...
        MR_hl_field(MR_mktag(0), Var_109, 0) = ((MR_Box) (&check_hlds__simplify__simplify_goal_conj_scalar_common_3[0]));
        MR_hl_field(MR_mktag(0), Var_109, 1) = ((MR_Box) (check_hlds__simplify__simplify_goal_conj__simplify_goal_plain_conj_10_p_0_1));
        MR_hl_field(MR_mktag(0), Var_109, 2) = ((MR_Box) ((MR_Integer) 1));
        MR_hl_field(MR_mktag(0), Var_109, 3) = ((MR_Box) (Subn1_92));
      }
              ...
              case (MR_Integer) 1:
                {
                  ...
                  Name_52 = ((MR_String) ((MR_hl_field(MR_mktag(0), Entry_51, (MR_Integer) 0))));
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                ...
                Name_59 = ((MR_String) ((MR_hl_field(MR_mktag(0), Entry_58, (MR_Integer) 0))));
                ...
                if (succeeded)
                {
                  ...
                  if (succeeded)
                  {
                    ...
                    Name_66 = ((MR_String) ((MR_hl_field(MR_mktag(0), Entry_65, (MR_Integer) 0))));
