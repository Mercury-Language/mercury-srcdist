  ...
  MR_Word * STATE_VARIABLE_Subn_7)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      MR_Word TypeCtorInfo_33_49;
      MR_Word TypeCtorInfo_32_48;
      MR_Word TypeCtorInfo_9_60;
      MR_Word Var_47;
      MR_String Name_56;
      MR_String Suffix_57;
      MR_String Var_59;
      MR_Integer Var_58;
      MR_Word TypeCtorInfo_9_65;
      MR_String Name_61;
      MR_String Suffix_62;
      MR_String Var_64;
      MR_Integer Var_63;
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          TypeCtorInfo_33_49 = (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0);
          succeeded = parse_tree__set_of_var__member_2_p_0(TypeCtorInfo_33_49, ConjNonLocals_2, RightVar_38);
          if (succeeded)
          ...
          TypeCtorInfo_32_48 = (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0);
          succeeded = parse_tree__set_of_var__member_2_p_0(TypeCtorInfo_32_48, ConjNonLocals_2, LeftVar_37);
          if (succeeded)
          {
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                TypeCtorInfo_9_60 = (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0);
                succeeded = mercury__varset__search_name_3_p_0(TypeCtorInfo_9_60, VarSet_41, ElimVar_42, &Name_56);
                if (succeeded)
                {
                  ...
                  if (succeeded)
                  {
                    TypeCtorInfo_9_65 = (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0);
                    succeeded = mercury__varset__search_name_3_p_0(TypeCtorInfo_9_65, VarSet_41, ReplacementVar_43, &Name_61);
                    if (succeeded)
                    {
            ...
            if (succeeded)
            {
              TypeInfo_34_50 = (MR_Word) (&check_hlds__simplify__simplify_goal_conj_scalar_common_1[0]);
              mercury__map__det_insert_4_p_0(TypeInfo_34_50, TypeInfo_34_50, ((MR_Box) (ElimVar_42)), ((MR_Box) (ReplacementVar_43)), STATE_VARIABLE_Subn_0_6, &STATE_VARIABLE_Subn_26_26);
              succeeded = MR_TRUE;
            }
          }
        }
            ...
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                ...
                if (succeeded)
                {
                  ...
                  succeeded = parse_tree__set_of_var__contains_2_p_0(TypeCtorInfo_53_53, ConjNonLocals_37, TestVar_29);
                  succeeded = !(succeeded);
                  if (succeeded)
