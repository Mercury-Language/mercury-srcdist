  ...
  MR_Word * STATE_VARIABLE_ItemCord_5)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      succeeded = ((((MR_tag((MR_Word) Item0_13)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(MR_mktag(3), Item0_13, (MR_Integer) 0)))) == (MR_Integer) 4)));
      if (succeeded)
      {
  ...
  MR_Word * STATE_VARIABLE_NonInstanceCord_7)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      succeeded = ((((MR_tag((MR_Word) Item_17)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(MR_mktag(3), Item_17, (MR_Integer) 0)))) == (MR_Integer) 7)));
      if (succeeded)
      {
        ItemInstance_22 = ((MR_Word) ((MR_hl_field(MR_mktag(3), Item_17, (MR_Integer) 1))));
        {
          ...
          else
          {
            ...
            }
            {
              ...
              MR_hl_field(MR_mktag(3), AbstractItem_26, 0) = ((MR_Box) ((MR_Unsigned) 7U));
