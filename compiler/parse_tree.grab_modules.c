...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 351, &Transitive_16);
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 377, &UnusedArgs_22);
    libs__globals__lookup_bool_option_3_p_0(Globals_7, (MR_Integer) 435, &StructureReuse_23);
