  ...
  MR_Word * STATE_VARIABLE_HaveReadModuleMaps_64)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 495, &ReadOptFilesTransitively_24);
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 508, &StructureReuse_34);
  ...
  MR_Word * STATE_VARIABLE_HaveReadModuleMaps_64)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_13, (MR_Integer) 705, &Experiment3_54);
