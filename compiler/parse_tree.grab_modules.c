  ...
  MR_Word * STATE_VARIABLE_HaveParseTreeMaps_68)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_15, (MR_Integer) 405, &ReadOptFilesTransitively_28);
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_15, (MR_Integer) 341, &StructureReuse_38);
  ...
  MR_Word * STATE_VARIABLE_HaveParseTreeMaps_65)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_13, (MR_Integer) 649, &Experiment3_51);
