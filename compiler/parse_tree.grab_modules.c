...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_9, (MR_Integer) 355, &ReadOptFilesTransitively_20);
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_9, (MR_Integer) 381, &UnusedArgs_28);
    libs__globals__lookup_bool_option_3_p_0(Globals_9, (MR_Integer) 439, &StructureReuse_29);
