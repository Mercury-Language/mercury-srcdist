  ...
  MR_Word * STATE_VARIABLE_HaveParseTreeMaps_68)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_15, (MR_Integer) 511, &ReadOptFilesTransitively_28);
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_15, (MR_Integer) 524, &StructureReuse_38);
  ...
  MR_Word * STATE_VARIABLE_HaveParseTreeMaps_62)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_13, (MR_Integer) 724, &Experiment3_51);
