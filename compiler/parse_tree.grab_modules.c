  ...
  MR_Word * STATE_VARIABLE_HaveReadModuleMaps_68)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_15, (MR_Integer) 498, &ReadOptFilesTransitively_28);
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_15, (MR_Integer) 511, &StructureReuse_38);
  ...
  MR_Word * STATE_VARIABLE_HaveReadModuleMaps_66)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_15, (MR_Integer) 710, &Experiment3_56);
