...
static void MR_CALL 
parse_tree__grab_modules__IntroducedFrom__pred__dump_modules__1605__1_4_p_0(
  MR_Word Stream_5,
  ...
  MR_Box * wrapper_arg_3)
{
  ...
  parse_tree__grab_modules__IntroducedFrom__pred__dump_modules__1605__1_4_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_String) (wrapper_arg_1)));
}
  ...
  MR_Word * STATE_VARIABLE_HaveParseTreeMaps_62)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_13, (MR_Integer) 735, &Experiment3_51);
