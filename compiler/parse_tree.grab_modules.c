  ...
  MR_Word * STATE_VARIABLE_HaveParseTreeMaps_68)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_15, (MR_Integer) 391, &StructureReuse_38);
  ...
  MR_Word * STATE_VARIABLE_HaveParseTreeMaps_65)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_13, (MR_Integer) 689, &Experiment3_51);
