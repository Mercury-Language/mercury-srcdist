...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_9, (MR_Integer) 483, &ReadOptFilesTransitively_20);
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_9, (MR_Integer) 496, &StructureReuse_30);
