  ...
  MR_Word * HaveParseTreeMaps_10)
{
  ...
  *HaveParseTreeMaps_10 = HaveParseTreeMaps_19;
  libs__globals__lookup_bool_option_3_p_0(Globals_14, (MR_Integer) 83, &Verbose_21);
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_14, (MR_Integer) 84, &VeryVerbose_22);
  ...
  MR_Word * STATE_VARIABLE_HaveParseTreeMaps_68)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_15, (MR_Integer) 84, &VeryVerbose_27);
  ...
  MR_Word * STATE_VARIABLE_HaveParseTreeMaps_65)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_13, (MR_Integer) 759, &Experiment3_51);
