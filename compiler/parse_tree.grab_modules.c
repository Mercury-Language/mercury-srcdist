  ...
  MR_Word * STATE_VARIABLE_HaveParseTreeMaps_70)
{
  ...
  if (succeeded)
  {
    ...
    else
    {
      ...
      parse_tree__grab_modules__report_cannot_read_opt_file_7_p_0(Globals_13, (MR_Integer) 206, OwnOptFileName_45, OwnOptModuleFileId_47, OwnOptModuleErrors_129, WarnSpecs0_31, &WarnSpecs_44);
  ...
  MR_Word * STATE_VARIABLE_HaveParseTreeMaps_74)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_13, (MR_Integer) 674, &Experiment3_60);
