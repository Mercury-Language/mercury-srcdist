  ...
  MR_Word * STATE_VARIABLE_Error_9)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      Var_86 = mercury__string__f_43_43_2_f_0(ModuleNameStr_70, (MR_String) ".trans_opt\'... ");
      Msg_71 = mercury__string__f_43_43_2_f_0((MR_String) "% Reading \140", Var_86);
      libs__file_util__maybe_write_string_4_p_0(VeryVerbose_2, Msg_71);
      libs__file_util__maybe_flush_output_3_p_0(VeryVerbose_2);
      parse_tree__file_names__module_name_to_search_file_name_6_p_0(Globals_1, (MR_Word) (((MR_Box) ((MR_String) ".trans_opt"))), ModuleName_28, &FileName_34);
...
{
  {
    ...
    parse_tree__file_names__module_name_to_search_file_name_6_p_0(Globals_10, (MR_Word) (((MR_Box) ((MR_String) ".opt"))), ModuleName_12, FileName_13);
