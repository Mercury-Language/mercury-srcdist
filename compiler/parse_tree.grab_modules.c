    ...
    else
    {
      ...
      if (((MR_tag((MR_Word) HaveReadTransOpt_34)) == (MR_Integer) 0))
      {
        ...
        else
        {
          ...
          STATE_VARIABLE_BlockingSpecs_1_55 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_error_spec_0), ModuleSpecs_62, STATE_VARIABLE_BlockingSpecs_0_8);
        }
  ...
  MR_Word * STATE_VARIABLE_HaveParseTreeMaps_66)
{
  ...
  *STATE_VARIABLE_BlockingSpecs_60 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_error_spec_0), Var_121, STATE_VARIABLE_BlockingSpecs_2_82);
