  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      else
      {
        ...
        STATE_VARIABLE_OptError_1_56 = HeadVar__9_9;
        libs__globals__lookup_bool_option_3_p_0(Globals_2, (MR_Integer) 190, &WarnOptionValue_79);
  ...
  MR_Word * STATE_VARIABLE_HaveParseTreeMaps_68)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_15, (MR_Integer) 404, &ReadOptFilesTransitively_28);
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_15, (MR_Integer) 340, &StructureReuse_38);
  ...
  if (succeeded)
  {
    ...
    else
    {
      ...
      parse_tree__grab_modules__update_opt_error_status_on_failure_8_p_0(Globals_15, (MR_Integer) 189, OwnOptFileName_49, OwnOptModuleErrors_123, OptSpecs0_33, &OptSpecs1_47, OptError0_34, &OptError_48);
    }
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      else
      {
        ...
        parse_tree__grab_modules__update_opt_error_status_on_failure_8_p_0(Globals_2, (MR_Integer) 189, FileName_68, ModuleErrors_99, STATE_VARIABLE_Specs_0_13, &STATE_VARIABLE_Specs_1_83, STATE_VARIABLE_OptError_0_15, &STATE_VARIABLE_OptError_1_84);
        ModuleNames1_66 = ModuleNames0_47;
        DontQueueOptModules1_67 = DontQueueOptModules0_6;
  ...
  MR_Word * STATE_VARIABLE_HaveParseTreeMaps_65)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_13, (MR_Integer) 647, &Experiment3_51);
