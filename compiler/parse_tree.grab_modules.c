...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_9, (MR_Integer) 354, &ReadOptFilesTransitively_20);
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_9, (MR_Integer) 380, &UnusedArgs_26);
    libs__globals__lookup_bool_option_3_p_0(Globals_9, (MR_Integer) 438, &StructureReuse_27);
