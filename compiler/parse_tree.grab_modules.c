  ...
  MR_Word * STATE_VARIABLE_HaveParseTreeMaps_68)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_15, (MR_Integer) 513, &ReadOptFilesTransitively_28);
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_15, (MR_Integer) 526, &StructureReuse_38);
  ...
  MR_Word * STATE_VARIABLE_HaveParseTreeMaps_62)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_13, (MR_Integer) 727, &Experiment3_51);
