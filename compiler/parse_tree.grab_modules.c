...
static MR_bool MR_CALL 
parse_tree__grab_modules__IntroducedFrom__pred__process_int0_files_of_ancestor_modules__844__1_2_p_0(
  MR_Word Ancestor_40,
...
{
  {
    ...
    succeeded = parse_tree__grab_modules__IntroducedFrom__pred__process_int0_files_of_ancestor_modules__844__1_2_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))));
    return succeeded;
  }
}
