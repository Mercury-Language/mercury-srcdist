  ...
  MR_Word * STATE_VARIABLE_HaveReadModuleMaps_62)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 492, &ReadOptFilesTransitively_24);
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 505, &StructureReuse_34);
  ...
  MR_Word * STATE_VARIABLE_HaveReadModuleMaps_63)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_13, (MR_Integer) 702, &Experiment3_55);
