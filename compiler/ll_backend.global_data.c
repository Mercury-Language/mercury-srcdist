...
ll_backend__global_data__IntroducedFrom__pred__merge_static_cell_infos__836__1_2_p_0(
  MR_Word SubInfoA_9,
  MR_Word SubInfoB_14);

static MR_bool MR_CALL 
ll_backend__global_data__IntroducedFrom__pred__add_vector_static_cell__548__1_1_p_0(
  MR_Word VectorData_7);

static MR_bool MR_CALL 
ll_backend__global_data__IntroducedFrom__pred__add_vector_static_cell__547__1_1_p_0(
  MR_Word LLDSTypes_6);
...
{
  {
    ...
    succeeded = ll_backend__global_data__IntroducedFrom__pred__merge_static_cell_infos__836__1_2_p_0(((MR_Word) (MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3))), ((MR_Word) (MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4))));
    return succeeded;
  }
}
...
{
  {
    ...
    succeeded = ll_backend__global_data__IntroducedFrom__pred__add_vector_static_cell__548__1_1_p_0(((MR_Word) (MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3))));
    return succeeded;
  }
}
...
{
  {
    ...
    succeeded = ll_backend__global_data__IntroducedFrom__pred__add_vector_static_cell__547__1_1_p_0(((MR_Word) (MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3))));
    return succeeded;
  }
}
...
ll_backend__global_data__find_general_llds_types_5_p_0(
  ...
  MR_Word Types_8,
  MR_Word HeadVar__4_4,
  MR_Word * STATE_VARIABLE_LLDSTypes_13)
{
  {
    ...
    MR_Word ArgWidth_12;
    MR_Word Var_14;
    MR_Word STATE_VARIABLE_LLDSTypes_15_15;
    ...
    if (succeeded)
    {
      ...
      mercury__list__map_3_p_0(TypeCtorInfo_19_19, TypeCtorInfo_20_20, Var_14, Vector_9, &STATE_VARIABLE_LLDSTypes_15_15);
      succeeded = ll_backend__global_data__find_general_llds_types_loop_6_p_0(UnboxFloat_6, UnboxInt64s_7, Types_8, Vectors_10, STATE_VARIABLE_LLDSTypes_15_15, STATE_VARIABLE_LLDSTypes_13);
    }
    return succeeded;
  }
}
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            Var_22 = ((MR_Word) (MR_hl_field(MR_mktag(1), Type0_11, (MR_Integer) 0)));
            switch (Var_22) {
              default:
                succeeded = MR_FALSE;
                break;
      ...
      else
      {
        ...
        if (succeeded)
        {
          Var_23 = ((MR_Word) (MR_hl_field(MR_mktag(1), Type0_11, (MR_Integer) 0)));
          switch (Var_23) {
            default:
              succeeded = MR_FALSE;
              break;
        ...
        if (succeeded)
        {
          *Type_10 = (MR_Word) MR_mkword(MR_mktag(1), &ll_backend__global_data_scalar_common_3[0]);
        }
        else
        {
          MR_Word Var_24;
          ...
          if (succeeded)
          {
            Var_24 = ((MR_Word) (MR_hl_field(MR_mktag(1), Type0_11, (MR_Integer) 0)));
            switch (Var_24) {
              default:
                succeeded = MR_FALSE;
                break;
          ...
          if (succeeded)
          {
            *Type_10 = (MR_Word) MR_mkword(MR_mktag(1), &ll_backend__global_data_scalar_common_3[2]);
          }
          else
            *Type_10 = Type0_11;
        }
