    ...
    else
    {
      ...
      else
      {
        ...
        else
        {
          ...
          mercury__private_builtin__builtin_compare_int_3_p_0(&SubResult2_30, Var_42, Var_43);
          ...
          else
          {
            ...
            mercury__private_builtin__builtin_compare_int_3_p_0(&SubResult3_33, Var_44, Var_45);
            ...
            else
            {
              ...
              mercury__private_builtin__builtin_compare_int_3_p_0(&SubResult1_6, Var_46, Var_47);
              succeeded = (SubResult1_6 != (MR_Integer) 0);
            }
          }
        }
