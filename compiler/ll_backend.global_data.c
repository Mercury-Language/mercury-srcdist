...
{
  {
...

    {
      ...
      MR_hl_field(MR_mktag(0), SubInfo0_11, 1) = (MR_Box) (((((MR_Unsigned) (((MR_Box) (UnboxFloat_7))) << (MR_Integer) 2)) | (((((MR_Unsigned) (((MR_Box) (UnboxInt64s_8))) << (MR_Integer) 1)) | (MR_Unsigned) (((MR_Box) (CommonData_9)))))));
    }
