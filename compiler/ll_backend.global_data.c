  ...
  MR_Word * STATE_VARIABLE_LLDSTypes_5)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      MR_Word next_value_of_STATE_VARIABLE_LLDSTypes_0_4;
      ...
      if (succeeded)
      {
        ...
        next_value_of_HeadVar__3_3 = Vectors_14;
        next_value_of_STATE_VARIABLE_LLDSTypes_0_4 = STATE_VARIABLE_LLDSTypes_18_18;
