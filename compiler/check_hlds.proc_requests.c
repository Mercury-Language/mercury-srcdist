...
{
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        hlds__add_special_pred__add_lazily_generated_unify_pred_4_p_0(TypeCtor_12, &PredId_31, STATE_VARIABLE_ModuleInfo_57_57, &STATE_VARIABLE_ModuleInfo_58_58);
