...
struct check_hlds__proc_requests__request_proc_9_p_0_env_0_s {
  ...
  MR_Word check_hlds__proc_requests__request_proc_9_p_0_env_0__STATE_VARIABLE_ModuleInfo_0_32;
  ...
  MR_Word check_hlds__proc_requests__request_proc_9_p_0_env_0__ArgMode_27;
  MR_Box check_hlds__proc_requests__request_proc_9_p_0_env_0__conv0_ArgMode_27;
};
  ...
  MR_Word HeadVar__2_2)
{
  ...
  else
  {
    ...
    if (succeeded)
    {
      TypeInfo__10_10 = (MR_Word) (&check_hlds__proc_requests_scalar_common_2[0]);
  ...
  MR_Integer * Num_10)
{
  ...
  MR_Word InitInstX_14 = ((MR_Word) ((MR_hl_field(MR_mktag(0), UniMode_8, (MR_Integer) 0))));
  MR_Word InitInstY_16 = ((MR_Word) ((MR_hl_field(MR_mktag(0), UniMode_8, (MR_Integer) 2))));

  if (succeeded)
  {
    succeeded = check_hlds__inst_test__inst_is_ground_or_any_2_p_0(ModuleInfo_6, InitInstX_14);
    if (succeeded)
      succeeded = check_hlds__inst_test__inst_is_ground_or_any_2_p_0(ModuleInfo_6, InitInstY_16);
  }
  if (succeeded)
  {
  ...
  else
  {
    ...
    else
    {
      ...
      else
      {
        ...
        UnifyReqMap_19 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Requests_18, (MR_Integer) 0))));
        {
          Var_20 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), Var_20, 0) = ((MR_Box) (TypeCtor_7));
          MR_hl_field(MR_mktag(0), Var_20, 1) = ((MR_Box) (UniMode_8));
        }
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_51)
{
  ...
  else
  {
    ...
    TypeCtorItem_16 = recompilation__type_ctor_to_recomp_item_name_1_f_0(TypeCtor_12);
  ...
  {
    MR_Word InitInstX_70 = ((MR_Word) ((MR_hl_field(MR_mktag(0), UnifyMode_13, (MR_Integer) 0))));
    MR_Word InitInstY_72 = ((MR_Word) ((MR_hl_field(MR_mktag(0), UnifyMode_13, (MR_Integer) 2))));

    succeeded = (Determinism_9 == (MR_Integer) 1);
    if (succeeded)
    {
      succeeded = check_hlds__inst_test__inst_is_ground_or_any_2_p_0(STATE_VARIABLE_ModuleInfo_55_55, InitInstX_70);
      if (succeeded)
        succeeded = check_hlds__inst_test__inst_is_ground_or_any_2_p_0(STATE_VARIABLE_ModuleInfo_55_55, InitInstY_72);
    }
    if (succeeded)
    {
      MR_Integer Var_18;
    ...
    {
      succeeded = (InitInstX_70 == (MR_Word) ((MR_Unsigned) 4U));
      if (succeeded)
      {
        MR_Integer Var_83;
      ...
      {
        succeeded = (InitInstY_72 == (MR_Word) ((MR_Unsigned) 4U));
        if (succeeded)
        {
          MR_Integer Var_84;

          hlds__hlds_pred__in_in_unification_proc_id_1_p_0(&Var_84);
          succeeded = MR_TRUE;
        }
        else
        {
          MR_Word Requests_74;
          MR_Word UnifyReqMap_75;
          MR_Box conv0_Var_85;

          hlds__hlds_module__module_info_get_proc_requests_2_p_0(STATE_VARIABLE_ModuleInfo_55_55, &Requests_74);
          UnifyReqMap_75 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Requests_74, (MR_Integer) 0))));
          succeeded = mercury__map__search_3_p_0((MR_Word) (&check_hlds__proc_requests__check_hlds__proc_requests__type_ctor_info_unify_proc_id_0), (MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_proc_id_0), UnifyReqMap_75, ((MR_Box) (UnifyId_7)), &conv0_Var_85);
          if (succeeded)
            succeeded = MR_TRUE;
        }
      }
  ...
  else
  {
    ...
    Var_82 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Requests0_46, (MR_Integer) 1))));
    {
      ...
      MR_hl_field(MR_mktag(0), Requests_49, 1) = ((MR_Box) (Var_82));
    }
  ...
  void * env_ptr_arg)
{
  ...
  (env_ptr)->check_hlds__proc_requests__request_proc_9_p_0_env_0__ArgMode_27 = ((MR_Word) ((env_ptr)->check_hlds__proc_requests__request_proc_9_p_0_env_0__conv0_ArgMode_27));
  ...
  void * env_ptr_arg)
{
  ...
  (env_ptr)->check_hlds__proc_requests__request_proc_9_p_0_env_0__succeeded = check_hlds__mode_test__mode_is_fully_input_2_p_0((env_ptr)->check_hlds__proc_requests__request_proc_9_p_0_env_0__STATE_VARIABLE_ModuleInfo_0_32, (env_ptr)->check_hlds__proc_requests__request_proc_9_p_0_env_0__ArgMode_27);
  ...
  void * env_ptr_arg)
{
  ...
  if (MR_builtin_setjmp((env_ptr)->check_hlds__proc_requests__request_proc_9_p_0_env_0__commit_0) == 0)
    {
      mercury__list__member_2_p_1((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_mode_0), &(env_ptr)->check_hlds__proc_requests__request_proc_9_p_0_env_0__conv0_ArgMode_27, (env_ptr)->check_hlds__proc_requests__request_proc_9_p_0_env_0__ArgModes_11, check_hlds__proc_requests__request_proc_9_p_0_3, env_ptr);
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_33)
{
  ...
  (env).check_hlds__proc_requests__request_proc_9_p_0_env_0__STATE_VARIABLE_ModuleInfo_0_32 = STATE_VARIABLE_ModuleInfo_0_32;
  {
    MR_Integer Arity_22;
    MR_Word Origin_25;
    MR_Word Requests0_28;
    MR_Word ReqQueue0_29;
    MR_Word ReqQueue_30;
    MR_Word Requests_31;
    ...
    hlds__hlds_module__module_info_pred_info_3_p_0((env).check_hlds__proc_requests__request_proc_9_p_0_env_0__STATE_VARIABLE_ModuleInfo_0_32, PredId_10, &STATE_VARIABLE_PredInfo_34_34);
    mercury__list__length_2_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_mode_0), (env).check_hlds__proc_requests__request_proc_9_p_0_env_0__ArgModes_11, &Arity_22);
    hlds__add_pred__add_new_proc_14_p_0(Context_15, (MR_Word) ((MR_Unsigned) 0U), Arity_22, InstVarSet_12, (env).check_hlds__proc_requests__request_proc_9_p_0_env_0__ArgModes_11, (MR_Word) ((MR_Unsigned) 0U), ArgLives_13, (MR_Integer) 1, MaybeDet_14, (MR_Integer) 1, (MR_Integer) 1, STATE_VARIABLE_PredInfo_34_34, &STATE_VARIABLE_PredInfo_37_37, ProcId_16);
    hlds__hlds_pred__pred_info_proc_info_3_p_0(STATE_VARIABLE_PredInfo_37_37, *ProcId_16, &STATE_VARIABLE_ProcInfo_38_38);
    hlds__hlds_pred__proc_info_set_can_process_3_p_0((MR_Integer) 0, STATE_VARIABLE_ProcInfo_38_38, &STATE_VARIABLE_ProcInfo_40_40);
    check_hlds__clause_to_proc__copy_clauses_to_proc_in_proc_info_4_p_0(STATE_VARIABLE_PredInfo_37_37, *ProcId_16, STATE_VARIABLE_ProcInfo_40_40, &STATE_VARIABLE_ProcInfo_41_41);
    hlds__hlds_pred__proc_info_get_goal_2_p_0(STATE_VARIABLE_ProcInfo_41_41, &STATE_VARIABLE_Goal_42_42);
    hlds__hlds_goal__set_goal_contexts_3_p_0(Context_15, STATE_VARIABLE_Goal_42_42, &STATE_VARIABLE_Goal_43_43);
    hlds__hlds_pred__pred_info_get_origin_2_p_0(STATE_VARIABLE_PredInfo_37_37, &Origin_25);
    (env).check_hlds__proc_requests__request_proc_9_p_0_env_0__succeeded = ((MR_tag((MR_Word) Origin_25)) == (MR_Integer) 1);
    if ((env).check_hlds__proc_requests__request_proc_9_p_0_env_0__succeeded)
    {
      packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), Origin_25, (MR_Integer) 0)));
      Var_44 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(1), Origin_25, (MR_Integer) 0))) & (MR_Integer) 3);
      _TypeCtor_26 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Origin_25, (MR_Integer) 1))));
      (env).check_hlds__proc_requests__request_proc_9_p_0_env_0__succeeded = (Var_44 == (MR_Integer) 0);
      if ((env).check_hlds__proc_requests__request_proc_9_p_0_env_0__succeeded)
      {
        ...
        if ((env).check_hlds__proc_requests__request_proc_9_p_0_env_0__succeeded)
        {
          ...
          if ((env).check_hlds__proc_requests__request_proc_9_p_0_env_0__succeeded)
          {
            Var_45 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MaybeDet_14, (MR_Integer) 0))));
            (env).check_hlds__proc_requests__request_proc_9_p_0_env_0__succeeded = (Var_45 == (MR_Integer) 7);
          }
          (env).check_hlds__proc_requests__request_proc_9_p_0_env_0__succeeded = !((env).check_hlds__proc_requests__request_proc_9_p_0_env_0__succeeded);
        }
      }
    ...
    if ((env).check_hlds__proc_requests__request_proc_9_p_0_env_0__succeeded)
      STATE_VARIABLE_Goal_46_46 = STATE_VARIABLE_Goal_43_43;
    else
      STATE_VARIABLE_Goal_46_46 = hlds__goal_util__maybe_strip_equality_pretest_1_f_0(STATE_VARIABLE_Goal_43_43);
    hlds__hlds_pred__proc_info_set_goal_3_p_0(STATE_VARIABLE_Goal_46_46, STATE_VARIABLE_ProcInfo_41_41, &STATE_VARIABLE_ProcInfo_47_47);
    hlds__hlds_pred__pred_info_set_proc_info_4_p_0(*ProcId_16, STATE_VARIABLE_ProcInfo_47_47, STATE_VARIABLE_PredInfo_37_37, &STATE_VARIABLE_PredInfo_48_48);
    hlds__hlds_module__module_info_set_pred_info_4_p_0(PredId_10, STATE_VARIABLE_PredInfo_48_48, (env).check_hlds__proc_requests__request_proc_9_p_0_env_0__STATE_VARIABLE_ModuleInfo_0_32, &STATE_VARIABLE_ModuleInfo_49_49);
    hlds__hlds_module__module_info_get_proc_requests_2_p_0(STATE_VARIABLE_ModuleInfo_49_49, &Requests0_28);
    Var_54 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Requests0_28, (MR_Integer) 0))));
    ReqQueue0_29 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Requests0_28, (MR_Integer) 1))));
    {
      Var_50 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), Var_50, 0) = ((MR_Box) (PredId_10));
      MR_hl_field(MR_mktag(0), Var_50, 1) = ((MR_Box) (*ProcId_16));
    }
    mercury__queue__put_3_p_0((MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_proc_id_0), ((MR_Box) (Var_50)), ReqQueue0_29, &ReqQueue_30);
    Var_55 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Requests0_28, (MR_Integer) 0))));
    Var_56 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Requests0_28, (MR_Integer) 1))));
    {
      Requests_31 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), Requests_31, 0) = ((MR_Box) (Var_55));
      MR_hl_field(MR_mktag(0), Requests_31, 1) = ((MR_Box) (ReqQueue_30));
    }
    hlds__hlds_module__module_info_set_proc_requests_3_p_0(Requests_31, STATE_VARIABLE_ModuleInfo_49_49, STATE_VARIABLE_ModuleInfo_33);
  }
}
