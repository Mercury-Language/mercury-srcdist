  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_33)
{
  ...
  (env).check_hlds__proc_requests__request_proc_9_p_0_env_0__STATE_VARIABLE_ModuleInfo_0_32 = STATE_VARIABLE_ModuleInfo_0_32;
  {
    ...
    (env).check_hlds__proc_requests__request_proc_9_p_0_env_0__succeeded = ((MR_tag((MR_Word) Origin_25)) == (MR_Integer) 2);
    if ((env).check_hlds__proc_requests__request_proc_9_p_0_env_0__succeeded)
    {
      packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(2), Origin_25, (MR_Integer) 0)));
      Var_44 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(2), Origin_25, (MR_Integer) 0))) & (MR_Integer) 3);
      _TypeCtor_26 = ((MR_Word) ((MR_hl_field(MR_mktag(2), Origin_25, (MR_Integer) 1))));
