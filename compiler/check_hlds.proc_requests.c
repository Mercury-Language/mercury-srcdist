...
struct check_hlds__proc_requests__request_proc_9_p_0_env_0_s {
  ...
  MR_Word check_hlds__proc_requests__request_proc_9_p_0_env_0__STATE_VARIABLE_ModuleInfo_0_31;
  ...
  MR_Word check_hlds__proc_requests__request_proc_9_p_0_env_0__ArgMode_26;
  MR_Box check_hlds__proc_requests__request_proc_9_p_0_env_0__conv0_ArgMode_26;
};
  ...
  MR_Integer * Num_10)
{
  ...
  MR_Word InitInstX_14 = ((MR_Word) ((MR_hl_field(0, UniMode_8, (MR_Integer) 0))));
  MR_Word InitInstY_16 = ((MR_Word) ((MR_hl_field(0, UniMode_8, (MR_Integer) 2))));
  ...
  else
  {
    ...
    else
    {
      ...
      else
      {
        ...
        UnifyReqMap_19 = ((MR_Word) ((MR_hl_field(0, Requests_18, (MR_Integer) 0))));
        {
...
{
  MR_bool succeeded;
  MR_Word TypeCtor_12 = ((MR_Word) ((MR_hl_field(0, UnifyId_7, (MR_Integer) 0))));
  MR_Word UnifyMode_13 = ((MR_Word) ((MR_hl_field(0, UnifyId_7, (MR_Integer) 1))));
  ...
  {
    MR_Word RecompInfo0_15 = ((MR_Word) ((MR_hl_field(1, MaybeRecompInfo0_14, (MR_Integer) 0))));
  ...
  {
    MR_Word InitInstX_69 = ((MR_Word) ((MR_hl_field(0, UnifyMode_13, (MR_Integer) 0))));
    MR_Word InitInstY_71 = ((MR_Word) ((MR_hl_field(0, UnifyMode_13, (MR_Integer) 2))));

    succeeded = (Determinism_9 == (MR_Integer) 1);
    if (succeeded)
    {
      succeeded = check_hlds__inst_test__inst_is_ground_or_any_2_p_0(STATE_VARIABLE_ModuleInfo_55_55, InitInstX_69);
      if (succeeded)
        succeeded = check_hlds__inst_test__inst_is_ground_or_any_2_p_0(STATE_VARIABLE_ModuleInfo_55_55, InitInstY_71);
    }
    if (succeeded)
    {
      MR_Integer Var_18;
    ...
    else
    {
      ...
      else
      {
        ...
        else
        {
          ...
          hlds__hlds_module__module_info_get_proc_requests_2_p_0(STATE_VARIABLE_ModuleInfo_55_55, &Requests_73);
          UnifyReqMap_74 = ((MR_Word) ((MR_hl_field(0, Requests_73, (MR_Integer) 0))));
  ...
  if (!(succeeded))
  {
    ...
    if (succeeded)
    {
      ...
      {
        MR_Word TypeName_22 = ((MR_Word) ((MR_hl_field(0, TypeCtor_12, (MR_Integer) 0))));
        ...
        if (succeeded)
        {
          TypeModuleName_24 = ((MR_Word) ((MR_hl_field(1, TypeName_22, (MR_Integer) 0))));
          ...
          if (succeeded)
          {
            succeeded = ((((MR_tag((MR_Word) TypeBody_21)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(3, TypeBody_21, (MR_Integer) 0)))) == (MR_Integer) 1)));
            if (succeeded)
            {
            }
          }
  ...
  else
  {
    ...
    UnifyMap_29 = ((MR_Word) ((MR_hl_field(0, SpecialPredMaps_28, (MR_Integer) 0))));
    ...
    LHSInit_32 = ((MR_Word) ((MR_hl_field(0, UnifyMode_13, (MR_Integer) 0))));
    LHSFinal_33 = ((MR_Word) ((MR_hl_field(0, UnifyMode_13, (MR_Integer) 1))));
    RHSInit_34 = ((MR_Word) ((MR_hl_field(0, UnifyMode_13, (MR_Integer) 2))));
    RHSFinal_35 = ((MR_Word) ((MR_hl_field(0, UnifyMode_13, (MR_Integer) 3))));
    {
    ...
    TypeArity_41 = ((MR_Integer) ((MR_hl_field(0, TypeCtor_12, (MR_Integer) 1))));
    ...
    UnifyReqMap0_47 = ((MR_Word) ((MR_hl_field(0, Requests0_46, (MR_Integer) 0))));
    ...
    Var_81 = ((MR_Word) ((MR_hl_field(0, Requests0_46, (MR_Integer) 1))));
    {
  ...
  void * env_ptr_arg)
{
  ...
  (env_ptr)->check_hlds__proc_requests__request_proc_9_p_0_env_0__ArgMode_26 = ((MR_Word) ((env_ptr)->check_hlds__proc_requests__request_proc_9_p_0_env_0__conv0_ArgMode_26));
  ...
  void * env_ptr_arg)
{
  ...
  (env_ptr)->check_hlds__proc_requests__request_proc_9_p_0_env_0__succeeded = check_hlds__mode_test__mode_is_fully_input_2_p_0((env_ptr)->check_hlds__proc_requests__request_proc_9_p_0_env_0__STATE_VARIABLE_ModuleInfo_0_31, (env_ptr)->check_hlds__proc_requests__request_proc_9_p_0_env_0__ArgMode_26);
  ...
  void * env_ptr_arg)
{
  ...
  if (MR_builtin_setjmp((env_ptr)->check_hlds__proc_requests__request_proc_9_p_0_env_0__commit_0) == 0)
    {
      mercury__list__member_2_p_1((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_mode_0), &(env_ptr)->check_hlds__proc_requests__request_proc_9_p_0_env_0__conv0_ArgMode_26, (env_ptr)->check_hlds__proc_requests__request_proc_9_p_0_env_0__ArgModes_11, check_hlds__proc_requests__request_proc_9_p_0_3, env_ptr);
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_32)
{
  ...
  (env).check_hlds__proc_requests__request_proc_9_p_0_env_0__STATE_VARIABLE_ModuleInfo_0_31 = STATE_VARIABLE_ModuleInfo_0_31;
  {
    MR_Word Origin_24;
    ...
    hlds__hlds_module__module_info_pred_info_3_p_0((env).check_hlds__proc_requests__request_proc_9_p_0_env_0__STATE_VARIABLE_ModuleInfo_0_31, PredId_10, &STATE_VARIABLE_PredInfo_33_33);
    hlds__add_pred__add_new_proc_14_p_0((env).check_hlds__proc_requests__request_proc_9_p_0_env_0__STATE_VARIABLE_ModuleInfo_0_31, Context_15, (MR_Word) ((MR_Unsigned) 0U), InstVarSet_12, (env).check_hlds__proc_requests__request_proc_9_p_0_env_0__ArgModes_11, (MR_Word) ((MR_Unsigned) 0U), ArgLives_13, (MR_Integer) 1, MaybeDet_14, (MR_Integer) 1, (MR_Integer) 1, STATE_VARIABLE_PredInfo_33_33, &STATE_VARIABLE_PredInfo_36_36, ProcId_16);
    hlds__hlds_pred__pred_info_proc_info_3_p_0(STATE_VARIABLE_PredInfo_36_36, *ProcId_16, &STATE_VARIABLE_ProcInfo_37_37);
    hlds__hlds_pred__proc_info_set_can_process_3_p_0((MR_Integer) 0, STATE_VARIABLE_ProcInfo_37_37, &STATE_VARIABLE_ProcInfo_39_39);
    check_hlds__clause_to_proc__copy_clauses_to_proc_in_proc_info_4_p_0(STATE_VARIABLE_PredInfo_36_36, *ProcId_16, STATE_VARIABLE_ProcInfo_39_39, &STATE_VARIABLE_ProcInfo_40_40);
    hlds__hlds_pred__proc_info_get_goal_2_p_0(STATE_VARIABLE_ProcInfo_40_40, &STATE_VARIABLE_Goal_41_41);
    hlds__hlds_goal__set_goal_contexts_3_p_0(Context_15, STATE_VARIABLE_Goal_41_41, &STATE_VARIABLE_Goal_42_42);
    hlds__hlds_pred__pred_info_get_origin_2_p_0(STATE_VARIABLE_PredInfo_36_36, &Origin_24);
    (env).check_hlds__proc_requests__request_proc_9_p_0_env_0__succeeded = ((MR_tag((MR_Word) Origin_24)) == (MR_Integer) 1);
    if ((env).check_hlds__proc_requests__request_proc_9_p_0_env_0__succeeded)
    {
      Var_43 = ((MR_Word) ((MR_hl_field(1, Origin_24, (MR_Integer) 0))));
      (env).check_hlds__proc_requests__request_proc_9_p_0_env_0__succeeded = ((MR_tag((MR_Word) Var_43)) == (MR_Integer) 0);
      if ((env).check_hlds__proc_requests__request_proc_9_p_0_env_0__succeeded)
      {
        packed_word_0 = (MR_Unsigned) ((MR_hl_field(0, Var_43, (MR_Integer) 0)));
        Var_44 = ((MR_Unsigned) ((MR_hl_field(0, Var_43, (MR_Integer) 0))) & (MR_Integer) 3);
        _TypeCtor_25 = ((MR_Word) ((MR_hl_field(0, Var_43, (MR_Integer) 1))));
        ...
        if ((env).check_hlds__proc_requests__request_proc_9_p_0_env_0__succeeded)
        {
          ...
          if ((env).check_hlds__proc_requests__request_proc_9_p_0_env_0__succeeded)
          {
            ...
            if ((env).check_hlds__proc_requests__request_proc_9_p_0_env_0__succeeded)
            {
              Var_45 = ((MR_Word) ((MR_hl_field(1, MaybeDet_14, (MR_Integer) 0))));
    ...
    if ((env).check_hlds__proc_requests__request_proc_9_p_0_env_0__succeeded)
      STATE_VARIABLE_Goal_46_46 = STATE_VARIABLE_Goal_42_42;
    else
      STATE_VARIABLE_Goal_46_46 = hlds__goal_util__maybe_strip_equality_pretest_1_f_0(STATE_VARIABLE_Goal_42_42);
    hlds__hlds_pred__proc_info_set_goal_3_p_0(STATE_VARIABLE_Goal_46_46, STATE_VARIABLE_ProcInfo_40_40, &STATE_VARIABLE_ProcInfo_47_47);
    hlds__hlds_pred__pred_info_set_proc_info_4_p_0(*ProcId_16, STATE_VARIABLE_ProcInfo_47_47, STATE_VARIABLE_PredInfo_36_36, &STATE_VARIABLE_PredInfo_48_48);
    hlds__hlds_module__module_info_set_pred_info_4_p_0(PredId_10, STATE_VARIABLE_PredInfo_48_48, (env).check_hlds__proc_requests__request_proc_9_p_0_env_0__STATE_VARIABLE_ModuleInfo_0_31, &STATE_VARIABLE_ModuleInfo_49_49);
    hlds__hlds_module__module_info_get_proc_requests_2_p_0(STATE_VARIABLE_ModuleInfo_49_49, &Requests0_27);
    Var_53 = ((MR_Word) ((MR_hl_field(0, Requests0_27, (MR_Integer) 0))));
    ReqQueue0_28 = ((MR_Word) ((MR_hl_field(0, Requests0_27, (MR_Integer) 1))));
    {
    ...
    Var_54 = ((MR_Word) ((MR_hl_field(0, Requests0_27, (MR_Integer) 0))));
    Var_55 = ((MR_Word) ((MR_hl_field(0, Requests0_27, (MR_Integer) 1))));
    {
      Requests_30 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(0, Requests_30, 0) = ((MR_Box) (Var_54));
      MR_hl_field(0, Requests_30, 1) = ((MR_Box) (ReqQueue_29));
    }
    hlds__hlds_module__module_info_set_proc_requests_3_p_0(Requests_30, STATE_VARIABLE_ModuleInfo_49_49, STATE_VARIABLE_ModuleInfo_32);
  }
}
...
{
  MR_Word Var_8 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_PR_0_6, (MR_Integer) 0))));
...
check_hlds__proc_requests__get_req_queue_2_p_0(
  ...
  MR_Word * X_4)
{
  *X_4 = ((MR_Word) ((MR_hl_field(0, PR_3, (MR_Integer) 1))));
}
