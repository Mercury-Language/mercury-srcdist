  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_32)
{
  ...
  (env).check_hlds__proc_requests__request_proc_9_p_0_env_0__STATE_VARIABLE_ModuleInfo_0_31 = STATE_VARIABLE_ModuleInfo_0_31;
  {
    ...
    {
      Var_43 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Origin_24, (MR_Integer) 0))));
      ...
      if ((env).check_hlds__proc_requests__request_proc_9_p_0_env_0__succeeded)
      {
        ...
        Var_44 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Var_43, (MR_Integer) 0))) & (MR_Integer) 3);
        _TypeCtor_25 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_43, (MR_Integer) 1))));
    ...
    Var_53 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Requests0_27, (MR_Integer) 0))));
    ReqQueue0_28 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Requests0_27, (MR_Integer) 1))));
    {
    ...
    Var_54 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Requests0_27, (MR_Integer) 0))));
    Var_55 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Requests0_27, (MR_Integer) 1))));
    {
      Requests_30 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), Requests_30, 0) = ((MR_Box) (Var_54));
      MR_hl_field(MR_mktag(0), Requests_30, 1) = ((MR_Box) (ReqQueue_29));
    }
