  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_33)
{
  ...
  (env).check_hlds__proc_requests__request_proc_9_p_0_env_0__STATE_VARIABLE_ModuleInfo_0_32 = STATE_VARIABLE_ModuleInfo_0_32;
  {
    ...
    if ((env).check_hlds__proc_requests__request_proc_9_p_0_env_0__succeeded)
    {
      ...
      (env).check_hlds__proc_requests__request_proc_9_p_0_env_0__succeeded = ((MR_tag((MR_Word) Var_44)) == (MR_Integer) 1);
      if ((env).check_hlds__proc_requests__request_proc_9_p_0_env_0__succeeded)
      {
        packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), Var_44, (MR_Integer) 0)));
        Var_45 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(1), Var_44, (MR_Integer) 0))) & (MR_Integer) 3);
        _TypeCtor_26 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Var_44, (MR_Integer) 1))));
