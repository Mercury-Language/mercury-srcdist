...
{
  {
    ...
    else
    {
      ...
      {
        LHSMode_38 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), LHSMode_38, 0) = ((MR_Box) (LHSInit_34));
        MR_hl_field(MR_mktag(0), LHSMode_38, 1) = ((MR_Box) (LHSFinal_35));
      }
      {
        RHSMode_39 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
      ...
      {
        ArgModes0_40 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
...
{
  {
    ...
    (env).check_hlds__proc_requests__request_proc_9_p_0_env_0__STATE_VARIABLE_ModuleInfo_0_35 = STATE_VARIABLE_ModuleInfo_0_35;
    {
      ...
      {
        Requests_34 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
