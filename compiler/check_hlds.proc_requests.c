      ...
      if (succeeded)
      {
        hlds__hlds_data__get_type_defn_body_2_p_0(TypeDefn_20, &TypeBody_21);
        {
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              succeeded = ((((MR_tag((MR_Word) TypeBody_21)) == (MR_Integer) 3)) && ((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), TypeBody_21, (MR_Integer) 0))) == (MR_Integer) 1)));
              if (succeeded)
              {
              }
            }
...
{
  {
    ...
    (env).check_hlds__proc_requests__request_proc_9_p_0_env_0__STATE_VARIABLE_ModuleInfo_0_35 = STATE_VARIABLE_ModuleInfo_0_35;
    {
      ...
      (env).check_hlds__proc_requests__request_proc_9_p_0_env_0__succeeded = ((MR_tag((MR_Word) Origin_28)) == (MR_Integer) 0);
      if ((env).check_hlds__proc_requests__request_proc_9_p_0_env_0__succeeded)
      {
        ...
        if ((env).check_hlds__proc_requests__request_proc_9_p_0_env_0__succeeded)
        {
          ...
          if ((env).check_hlds__proc_requests__request_proc_9_p_0_env_0__succeeded)
          {
            (env).check_hlds__proc_requests__request_proc_9_p_0_env_0__succeeded = ((MR_tag((MR_Word) MaybeDet_14)) == (MR_Integer) 1);
            if ((env).check_hlds__proc_requests__request_proc_9_p_0_env_0__succeeded)
            {
