...
{
  {
    ...
    }
    {
      ...
      {
        succeeded = (InitInstX_77 == (MR_Word) ((MR_Unsigned) 4U));
        if (succeeded)
        {
          MR_Integer Var_94;
        ...
        {
          succeeded = (InitInstY_79 == (MR_Word) ((MR_Unsigned) 4U));
          if (succeeded)
          {
            MR_Integer Var_95;
    ...
    else
    {
      ...
      check_hlds__proc_requests__request_proc_9_p_0(PredId_31, ArgModes_45, InstVarSet_8, (MR_Word) ((MR_Unsigned) 0U), Var_61, Context_10, &ProcId_47, STATE_VARIABLE_ModuleInfo_58_58, &STATE_VARIABLE_ModuleInfo_62_62);
...
{
  {
    ...
    (env).check_hlds__proc_requests__request_proc_9_p_0_env_0__STATE_VARIABLE_ModuleInfo_0_35 = STATE_VARIABLE_ModuleInfo_0_35;
    {
      ...
      if ((env).check_hlds__proc_requests__request_proc_9_p_0_env_0__succeeded)
      {
        ...
        Var_49 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Origin_28, (MR_Integer) 0))) & (MR_Integer) 3);
