...
static const MR_FA_TypeInfo_Struct1 check_hlds__proc_requests__queue__ti_queue_1hlds__pred_proc_id__type_ctor_info_pred_proc_id_0;
...
static const MR_PseudoTypeInfo check_hlds__proc_requests__check_hlds__proc_requests__field_types_proc_requests_0_0[2] = {
  ...
  (MR_PseudoTypeInfo) (&check_hlds__proc_requests__queue__ti_queue_1hlds__pred_proc_id__type_ctor_info_pred_proc_id_0)
};
  ...
  MR_Integer * Num_10)
{
  ...
  if (succeeded)
  {
    hlds__pred_proc_id__in_in_unification_proc_id_1_p_0(&NumPrime_11);
    succeeded = MR_TRUE;
  }
  else
  {
    ...
    else
    {
      ...
      else
      {
        ...
        succeeded = mercury__map__search_3_p_0((MR_Word) (&check_hlds__proc_requests__check_hlds__proc_requests__type_ctor_info_unify_proc_id_0), (MR_Word) (&hlds__pred_proc_id__hlds__pred_proc_id__type_ctor_info_proc_id_0), UnifyReqMap_19, ((MR_Box) (Var_20)), &conv0_NumPrime_11);
        if (succeeded)
        {
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_51)
{
  ...
  }
  {
    ...
    if (succeeded)
    {
      ...
      hlds__pred_proc_id__in_in_unification_proc_id_1_p_0(&Var_18);
      succeeded = MR_TRUE;
    }
    else
    {
      ...
      if (succeeded)
      {
        ...
        hlds__pred_proc_id__in_in_unification_proc_id_1_p_0(&Var_82);
        succeeded = MR_TRUE;
      }
      else
      {
        ...
        if (succeeded)
        {
          ...
          hlds__pred_proc_id__in_in_unification_proc_id_1_p_0(&Var_83);
          succeeded = MR_TRUE;
        }
        else
        {
          ...
          succeeded = mercury__map__search_3_p_0((MR_Word) (&check_hlds__proc_requests__check_hlds__proc_requests__type_ctor_info_unify_proc_id_0), (MR_Word) (&hlds__pred_proc_id__hlds__pred_proc_id__type_ctor_info_proc_id_0), UnifyReqMap_74, ((MR_Box) (UnifyId_7)), &conv0_Var_84);
          if (succeeded)
            succeeded = MR_TRUE;
        }
      }
  ...
  else
  {
    ...
    succeeded = mercury__map__search_3_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_type_ctor_0), (MR_Word) (&hlds__pred_proc_id__hlds__pred_proc_id__type_ctor_info_pred_id_0), UnifyMap_29, ((MR_Box) (TypeCtor_12)), &conv1_PredIdPrime_30);
    if (succeeded)
    {
    ...
    mercury__map__set_4_p_0((MR_Word) (&check_hlds__proc_requests__check_hlds__proc_requests__type_ctor_info_unify_proc_id_0), (MR_Word) (&hlds__pred_proc_id__hlds__pred_proc_id__type_ctor_info_proc_id_0), ((MR_Box) (UnifyId_7)), ((MR_Box) (ProcId_45)), UnifyReqMap0_47, &UnifyReqMap_48);
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_32)
{
  ...
  hlds__hlds_proc__proc_info_set_can_process_3_p_0((MR_Integer) 0, STATE_VARIABLE_ProcInfo_1_37, &STATE_VARIABLE_ProcInfo_2_39);
  ...
  hlds__hlds_proc__proc_info_get_goal_2_p_0(STATE_VARIABLE_ProcInfo_3_40, &STATE_VARIABLE_Goal_1_41);
  hlds__goal_util__set_goal_contexts_3_p_0(Context_15, STATE_VARIABLE_Goal_1_41, &STATE_VARIABLE_Goal_2_42);
  ...
  if (succeeded)
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        succeeded = hlds__mode_test__all_modes_are_fully_input_3_p_0(STATE_VARIABLE_ModuleInfo_0_31, ArgTypes_25, ArgModes_11);
        if (succeeded)
        {
  ...
  hlds__hlds_proc__proc_info_set_goal_3_p_0(STATE_VARIABLE_Goal_3_46, STATE_VARIABLE_ProcInfo_3_40, &STATE_VARIABLE_ProcInfo_4_47);
  ...
  mercury__queue__put_3_p_0((MR_Word) (&hlds__pred_proc_id__hlds__pred_proc_id__type_ctor_info_pred_proc_id_0), ((MR_Box) (Var_50)), ReqQueue0_28, &ReqQueue_29);
  ...
  MR_Word * Requests_2)
{
  ...
  mercury__map__init_1_p_0((MR_Word) (&check_hlds__proc_requests__check_hlds__proc_requests__type_ctor_info_unify_proc_id_0), (MR_Word) (&hlds__pred_proc_id__hlds__pred_proc_id__type_ctor_info_proc_id_0), &UnifyReqMap_3);
  mercury__queue__init_1_p_0((MR_Word) (&hlds__pred_proc_id__hlds__pred_proc_id__type_ctor_info_pred_proc_id_0), &ReqQueue_4);
  {
    MR_Word base;
