...
{
  {
    ...
    (env_ptr)->check_hlds__proc_requests__request_proc_9_p_0_env_0__succeeded = check_hlds__mode_util__mode_is_fully_input_2_p_0((env_ptr)->check_hlds__proc_requests__request_proc_9_p_0_env_0__STATE_VARIABLE_ModuleInfo_0_34, (env_ptr)->check_hlds__proc_requests__request_proc_9_p_0_env_0__ArgMode_29);
...
{
  {
    ...
    (env).check_hlds__proc_requests__request_proc_9_p_0_env_0__STATE_VARIABLE_ModuleInfo_0_34 = STATE_VARIABLE_ModuleInfo_0_34;
    {
      ...
      check_hlds__clause_to_proc__copy_clauses_to_proc_in_proc_info_5_p_0((env).check_hlds__proc_requests__request_proc_9_p_0_env_0__STATE_VARIABLE_ModuleInfo_0_34, STATE_VARIABLE_PredInfo_40_40, *ProcId_16, STATE_VARIABLE_ProcInfo_44_44, &STATE_VARIABLE_ProcInfo_45_45);
      ...
      (env).check_hlds__proc_requests__request_proc_9_p_0_env_0__succeeded = ((MR_tag((MR_Word) Origin_27)) == (MR_Integer) 0);
      if ((env).check_hlds__proc_requests__request_proc_9_p_0_env_0__succeeded)
      {
        packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Origin_27, (MR_Integer) 0)));
        Var_48 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Origin_27, (MR_Integer) 0))) & (MR_Integer) 3);
        _TypeCtor_28 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Origin_27, (MR_Integer) 1))));
