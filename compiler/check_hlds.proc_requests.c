  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_51)
{
  ...
  {
    MR_Word InitInstX_69 = ((MR_Word) ((MR_hl_field(MR_mktag(0), UnifyMode_13, (MR_Integer) 0))));
    MR_Word InitInstY_71 = ((MR_Word) ((MR_hl_field(MR_mktag(0), UnifyMode_13, (MR_Integer) 2))));
    ...
    else
    {
      ...
      else
      {
        ...
        else
        {
          ...
          UnifyReqMap_74 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Requests_73, (MR_Integer) 0))));
  ...
  else
  {
    ...
    Var_81 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Requests0_46, (MR_Integer) 1))));
    {
      ...
      MR_hl_field(MR_mktag(0), Requests_49, 1) = ((MR_Box) (Var_81));
    }
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_33)
{
  ...
  (env).check_hlds__proc_requests__request_proc_9_p_0_env_0__STATE_VARIABLE_ModuleInfo_0_32 = STATE_VARIABLE_ModuleInfo_0_32;
  {
    ...
    Var_53 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Requests0_28, (MR_Integer) 0))));
    ...
    Var_55 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Requests0_28, (MR_Integer) 1))));
    {
      Requests_31 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), Requests_31, 0) = ((MR_Box) (Var_54));
