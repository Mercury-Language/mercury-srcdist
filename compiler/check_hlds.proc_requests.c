    ...
    else
    {
      ...
      else
      {
        ...
        else
        {
          ...
          succeeded = mercury__map__search_3_p_0((MR_Word) &check_hlds__proc_requests__check_hlds__proc_requests__type_ctor_info_unify_proc_id_0, (MR_Word) &hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_proc_id_0, UnifyReqMap_24, ((MR_Box) (Var_27)), &conv0_NumPrime_11);
          if (succeeded)
          {
...
{
  {
      ...
      else
      {
        ...
        else
        {
          ...
          else
          {
            ...
            succeeded = mercury__map__search_3_p_0((MR_Word) &check_hlds__proc_requests__check_hlds__proc_requests__type_ctor_info_unify_proc_id_0, (MR_Word) &hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_proc_id_0, UnifyReqMap_82, ((MR_Box) (UnifyId_7)), &conv0_Var_96);
            if (succeeded)
            {
    ...
    else
    {
      ...
      mercury__map__set_4_p_0((MR_Word) &check_hlds__proc_requests__check_hlds__proc_requests__type_ctor_info_unify_proc_id_0, (MR_Word) &hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_proc_id_0, ((MR_Box) (UnifyId_7)), ((MR_Box) (ProcId_47)), UnifyReqMap0_49, &UnifyReqMap_50);
...
{
  {
    ...
    (env).check_hlds__proc_requests__request_proc_9_p_0_env_0__STATE_VARIABLE_ModuleInfo_0_35 = STATE_VARIABLE_ModuleInfo_0_35;
    {
      ...
      TypeCtorInfo_62_62 = (MR_Word) &hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_proc_id_0;
      TypeCtorInfo_63_63 = (MR_Word) &hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_proc_info_0;
      mercury__map__lookup_3_p_0(TypeCtorInfo_62_62, TypeCtorInfo_63_63, STATE_VARIABLE_ProcMap_42_42, ((MR_Box) (*ProcId_16)), &conv1_STATE_VARIABLE_ProcInfo_43_43);
      ...
      check_hlds__clause_to_proc__copy_clauses_to_proc_in_proc_info_4_p_0(ClausesInfo_27, *ProcId_16, STATE_VARIABLE_ProcInfo_45_45, &STATE_VARIABLE_ProcInfo_46_46);
      ...
      mercury__map__det_update_4_p_0(TypeCtorInfo_62_62, TypeCtorInfo_63_63, ((MR_Box) (*ProcId_16)), ((MR_Box) (STATE_VARIABLE_ProcInfo_52_52)), STATE_VARIABLE_ProcMap_42_42, &STATE_VARIABLE_ProcMap_53_53);
