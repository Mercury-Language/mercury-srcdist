  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_51)
{
  ...
  }
  {
    ...
    if (succeeded)
    {
      succeeded = check_hlds__inst_test__inst_is_ground_or_any_2_p_0(STATE_VARIABLE_ModuleInfo_1_55, InitInstX_69);
      if (succeeded)
        succeeded = check_hlds__inst_test__inst_is_ground_or_any_2_p_0(STATE_VARIABLE_ModuleInfo_1_55, InitInstY_71);
    }
    if (succeeded)
    {
      MR_Integer Var_18;
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_32)
{
  ...
  if (succeeded)
    ...
    STATE_VARIABLE_Goal_3_46 = hlds__goal_util__maybe_strip_equality_pretest_1_f_0(STATE_VARIABLE_Goal_2_42);
