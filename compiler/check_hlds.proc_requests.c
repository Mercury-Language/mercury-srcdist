  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_51)
{
  ...
  {
    MR_Word InitInstX_74 = ((MR_Word) ((MR_hl_field(MR_mktag(0), UnifyMode_13, (MR_Integer) 0))));
    MR_Word InitInstY_76 = ((MR_Word) ((MR_hl_field(MR_mktag(0), UnifyMode_13, (MR_Integer) 2))));

    succeeded = (Determinism_9 == (MR_Integer) 1);
    if (succeeded)
    {
      succeeded = check_hlds__inst_test__inst_is_ground_or_any_2_p_0(STATE_VARIABLE_ModuleInfo_55_55, InitInstX_74);
      if (succeeded)
        succeeded = check_hlds__inst_test__inst_is_ground_or_any_2_p_0(STATE_VARIABLE_ModuleInfo_55_55, InitInstY_76);
    }
    if (succeeded)
    {
      MR_Integer Var_18;
    ...
    {
      succeeded = (InitInstX_74 == (MR_Word) ((MR_Unsigned) 4U));
      if (succeeded)
      {
        MR_Integer Var_95;
      ...
      {
        succeeded = (InitInstY_76 == (MR_Word) ((MR_Unsigned) 4U));
        if (succeeded)
        {
          MR_Integer Var_96;

          hlds__hlds_pred__in_in_unification_proc_id_1_p_0(&Var_96);
          succeeded = MR_TRUE;
        }
        else
        {
          MR_Word Requests_78;
          MR_Word UnifyReqMap_79;
          MR_Box conv0_Var_97;

          hlds__hlds_module__module_info_get_proc_requests_2_p_0(STATE_VARIABLE_ModuleInfo_55_55, &Requests_78);
          UnifyReqMap_79 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Requests_78, (MR_Integer) 0))));
          succeeded = mercury__map__search_3_p_0((MR_Word) (&check_hlds__proc_requests__check_hlds__proc_requests__type_ctor_info_unify_proc_id_0), (MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_proc_id_0), UnifyReqMap_79, ((MR_Box) (UnifyId_7)), &conv0_Var_97);
          if (succeeded)
            succeeded = MR_TRUE;
        }
      }
  ...
  else
  {
    ...
    Var_94 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Requests0_46, (MR_Integer) 1))));
    {
      ...
      MR_hl_field(MR_mktag(0), Requests_49, 1) = ((MR_Box) (Var_94));
    }
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_33)
{
  ...
  (env).check_hlds__proc_requests__request_proc_9_p_0_env_0__STATE_VARIABLE_ModuleInfo_0_32 = STATE_VARIABLE_ModuleInfo_0_32;
  {
    ...
    {
      Var_44 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Origin_25, (MR_Integer) 0))));
      (env).check_hlds__proc_requests__request_proc_9_p_0_env_0__succeeded = ((MR_tag((MR_Word) Var_44)) == (MR_Integer) 0);
      if ((env).check_hlds__proc_requests__request_proc_9_p_0_env_0__succeeded)
      {
        packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Var_44, (MR_Integer) 0)));
        Var_45 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Var_44, (MR_Integer) 0))) & (MR_Integer) 3);
        _TypeCtor_26 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_44, (MR_Integer) 1))));
        (env).check_hlds__proc_requests__request_proc_9_p_0_env_0__succeeded = (Var_45 == (MR_Integer) 0);
        if ((env).check_hlds__proc_requests__request_proc_9_p_0_env_0__succeeded)
        {
          ...
          if ((env).check_hlds__proc_requests__request_proc_9_p_0_env_0__succeeded)
          {
            ...
            if ((env).check_hlds__proc_requests__request_proc_9_p_0_env_0__succeeded)
            {
              Var_46 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MaybeDet_14, (MR_Integer) 0))));
              (env).check_hlds__proc_requests__request_proc_9_p_0_env_0__succeeded = (Var_46 == (MR_Integer) 7);
            }
            (env).check_hlds__proc_requests__request_proc_9_p_0_env_0__succeeded = !((env).check_hlds__proc_requests__request_proc_9_p_0_env_0__succeeded);
          }
        }
    ...
    if ((env).check_hlds__proc_requests__request_proc_9_p_0_env_0__succeeded)
      STATE_VARIABLE_Goal_47_47 = STATE_VARIABLE_Goal_43_43;
    else
      STATE_VARIABLE_Goal_47_47 = hlds__goal_util__maybe_strip_equality_pretest_1_f_0(STATE_VARIABLE_Goal_43_43);
    hlds__hlds_pred__proc_info_set_goal_3_p_0(STATE_VARIABLE_Goal_47_47, STATE_VARIABLE_ProcInfo_41_41, &STATE_VARIABLE_ProcInfo_48_48);
    hlds__hlds_pred__pred_info_set_proc_info_4_p_0(*ProcId_16, STATE_VARIABLE_ProcInfo_48_48, STATE_VARIABLE_PredInfo_37_37, &STATE_VARIABLE_PredInfo_49_49);
    hlds__hlds_module__module_info_set_pred_info_4_p_0(PredId_10, STATE_VARIABLE_PredInfo_49_49, (env).check_hlds__proc_requests__request_proc_9_p_0_env_0__STATE_VARIABLE_ModuleInfo_0_32, &STATE_VARIABLE_ModuleInfo_50_50);
    hlds__hlds_module__module_info_get_proc_requests_2_p_0(STATE_VARIABLE_ModuleInfo_50_50, &Requests0_28);
    Var_56 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Requests0_28, (MR_Integer) 0))));
    ReqQueue0_29 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Requests0_28, (MR_Integer) 1))));
    {
      ...
      MR_hl_field(MR_mktag(0), Var_51, 0) = ((MR_Box) (PredId_10));
      MR_hl_field(MR_mktag(0), Var_51, 1) = ((MR_Box) (*ProcId_16));
    }
    mercury__queue__put_3_p_0((MR_Word) (&hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_proc_id_0), ((MR_Box) (Var_51)), ReqQueue0_29, &ReqQueue_30);
    Var_61 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Requests0_28, (MR_Integer) 0))));
    Var_62 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Requests0_28, (MR_Integer) 1))));
    {
      Requests_31 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), Requests_31, 0) = ((MR_Box) (Var_61));
      MR_hl_field(MR_mktag(0), Requests_31, 1) = ((MR_Box) (ReqQueue_30));
    }
    hlds__hlds_module__module_info_set_proc_requests_3_p_0(Requests_31, STATE_VARIABLE_ModuleInfo_50_50, STATE_VARIABLE_ModuleInfo_33);
  }
}
...
{
  MR_Word Var_8 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_PR_0_6, (MR_Integer) 0))));
