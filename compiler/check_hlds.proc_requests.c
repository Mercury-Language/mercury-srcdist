...
{
  {
    ...
    {
      succeeded = (InitInstX_19 == (MR_Word) ((MR_Integer) 4));
      if (succeeded)
      {
        hlds__hlds_pred__in_in_unification_proc_id_1_p_0(&NumPrime_11);
        succeeded = MR_TRUE;
      ...
      {
        succeeded = (InitInstY_21 == (MR_Word) ((MR_Integer) 4));
        if (succeeded)
        {
          hlds__hlds_pred__in_in_unification_proc_id_1_p_0(&NumPrime_11);
          succeeded = MR_TRUE;
...
{
  {
    ...
    if ((MaybeRecompInfo0_14 == (MR_Word) ((MR_Integer) 0)))
    ...
    }
    {
      ...
      {
        succeeded = (InitInstX_77 == (MR_Word) ((MR_Integer) 4));
        if (succeeded)
        {
          MR_Integer Var_94;
        ...
        {
          succeeded = (InitInstY_79 == (MR_Word) ((MR_Integer) 4));
          if (succeeded)
          {
            MR_Integer Var_95;
    ...
    else
    {
      ...
      check_hlds__proc_requests__request_proc_9_p_0(PredId_31, ArgModes_45, InstVarSet_8, (MR_Word) ((MR_Integer) 0), Var_61, Context_10, &ProcId_47, STATE_VARIABLE_ModuleInfo_58_58, &STATE_VARIABLE_ModuleInfo_62_62);
