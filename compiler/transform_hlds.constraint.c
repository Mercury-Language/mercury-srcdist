          ...
          case (MR_Integer) 5:
            {
              ...
              switch (MR_tag((MR_Word) Reason_28)) {
                ...
                case (MR_Integer) 2:
                  ...
                  break;
                case (MR_Integer) 3:
                  switch (((MR_Integer) ((MR_hl_field(MR_mktag(3), Reason_28, (MR_Integer) 0))))) {
                    default: /*NOTREACHED*/ MR_assert(0);
                    case (MR_Integer) 0:
                    case (MR_Integer) 4:
                    case (MR_Integer) 5:
...
{
  {
    ...
    if (((((MR_tag((MR_Word) GoalExpr_3)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(MR_mktag(3), GoalExpr_3, (MR_Integer) 0)))) == (MR_Integer) 5))))
    {
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      hlds__instmap__instmap_vars_list_2_p_0(InstMap_22, &InstMapVars_24);
      {
        ...
        MR_hl_field(MR_mktag(0), InCompatible_25, 2) = ((MR_Box) ((MR_Integer) 4));
      ...
      IncompatibleInstVars_30 = parse_tree__set_of_var__list_to_set_1_f_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), Var_38);
      {
        ...
        MR_hl_field(MR_mktag(0), Bound_31, 2) = ((MR_Box) ((MR_Integer) 4));
