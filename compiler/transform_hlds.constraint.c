...
MR_decl_label10(transform_hlds__constraint__propagate_conj_sub_goal_2_5_0, 25,26,28,23,33,34,32,40,41,39)
MR_decl_label10(transform_hlds__constraint__propagate_conj_sub_goal_2_5_0, 46,45,53,52,56,55,60,50,37,66)
MR_decl_label1(transform_hlds__constraint__propagate_conj_sub_goal_2_5_0, 65)
...
MR_decl_label10(fn__transform_hlds__constraint__strip_constraint_markers_expr_1_0, 4,3,10,8,14,12,18,19,20,17)
MR_decl_label4(fn__transform_hlds__constraint__strip_constraint_markers_expr_1_0, 23,22,27,98)
...
MR_def_label(transform_hlds__constraint__filter_dependent_constraints_2_7_0,24)
	...
	MR_r1 = MR_tfield(0, MR_tfield(0, MR_sv(6), 0), 1);
	MR_np_call_localret_ent(fn__hlds__hlds_goal__goal_info_get_nonlocals_1_0,
...
MR_BEGIN_MODULE(transform_hlds__constraint_module13)
	...
	MR_init_label10(transform_hlds__constraint__propagate_conj_sub_goal_2_5_0,25,26,28,23,33,34,32,40,41,39)
	MR_init_label10(transform_hlds__constraint__propagate_conj_sub_goal_2_5_0,46,45,53,52,56,55,60,50,37,66)
	MR_init_label1(transform_hlds__constraint__propagate_conj_sub_goal_2_5_0,65)
MR_BEGIN_CODE
...
MR_def_label(transform_hlds__constraint__propagate_conj_sub_goal_2_5_0,34)
	...
	MR_Word MR_tempr1, MR_tempr2;
	MR_tag_alloc_heap(MR_tempr1, 0, (MR_Integer) 2);
	MR_tfield(0, MR_tempr1, 0) = (MR_Word) MR_tmkword(0, (MR_Word *) MR_sv(7));
...
MR_def_label(transform_hlds__constraint__propagate_conj_sub_goal_2_5_0,32)
	...
	if (MR_RTAGS_TESTR(MR_r4,3,5)) {
		MR_GOTO_LAB(transform_hlds__constraint__propagate_conj_sub_goal_2_5_0_i37);
	}
	{
	MR_Word MR_tempr1;
	...
	if (!(((((((MR_tag(MR_tempr1) == MR_mktag((MR_Integer) 3)) && ((MR_Integer) MR_tfield(3, MR_tempr1, 0) == (MR_Integer) 3)) || ((MR_tag(MR_tempr1) == MR_mktag((MR_Integer) 3)) && ((MR_Integer) MR_tfield(3, MR_tempr1, 0) == (MR_Integer) 2))) || (MR_tag(MR_tempr1) == MR_mktag((MR_Integer) 2))) || (MR_tag(MR_tempr1) == MR_mktag((MR_Integer) 1))) || ((MR_tag(MR_tempr1) == MR_mktag((MR_Integer) 3)) && ((MR_Integer) MR_tfield(3, MR_tempr1, 0) == (MR_Integer) 5))))) {
		MR_GOTO_LAB(transform_hlds__constraint__propagate_conj_sub_goal_2_5_0_i39);
	}
	MR_incr_sp(8);
	MR_sv(8) = (MR_Word) MR_succip;
	MR_sv(1) = MR_tfield(0, MR_r1, 1);
	...
	MR_np_call_localret_ent(transform_hlds__constraint__propagate_goal_5_0,
		transform_hlds__constraint__propagate_conj_sub_goal_2_5_0_i40);
...
MR_def_label(transform_hlds__constraint__propagate_conj_sub_goal_2_5_0,39)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_r5,0)) {
		MR_GOTO_LAB(transform_hlds__constraint__propagate_conj_sub_goal_2_5_0_i45);
	}
	MR_incr_sp(8);
	MR_sv(8) = (MR_Word) MR_succip;
	MR_sv(1) = MR_tfield(0, MR_r1, 1);
	...
	MR_r1 = MR_tfield(3, MR_r4, 2);
	MR_np_call_localret_ent(transform_hlds__constraint__propagate_goal_5_0,
		transform_hlds__constraint__propagate_conj_sub_goal_2_5_0_i46);
...
MR_def_label(transform_hlds__constraint__propagate_conj_sub_goal_2_5_0,45)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_RTAGS_TESTR(MR_r5,3,4)) {
		MR_GOTO_LAB(transform_hlds__constraint__propagate_conj_sub_goal_2_5_0_i50);
	}
	MR_incr_sp(8);
	MR_sv(8) = (MR_Word) MR_succip;
	MR_r6 = MR_tfield(3, MR_r5, 2);
	if (MR_INT_NE(MR_r6,0)) {
		MR_GOTO_LAB(transform_hlds__constraint__propagate_conj_sub_goal_2_5_0_i52);
	}
	MR_sv(1) = MR_r1;
	MR_sv(2) = MR_r3;
	MR_r1 = MR_r2;
	MR_np_call_localret_ent(transform_hlds__constraint__flatten_constraints_2_0,
		transform_hlds__constraint__propagate_conj_sub_goal_2_5_0_i53);
...
MR_def_label(transform_hlds__constraint__propagate_conj_sub_goal_2_5_0,52)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r6,1)) {
		MR_GOTO_LAB(transform_hlds__constraint__propagate_conj_sub_goal_2_5_0_i55);
	}
	MR_sv(1) = MR_tfield(0, MR_r1, 1);
	MR_sv(6) = MR_r5;
	MR_r1 = MR_tfield(3, MR_r4, 2);
	MR_np_call_localret_ent(transform_hlds__constraint__propagate_goal_5_0,
		transform_hlds__constraint__propagate_conj_sub_goal_2_5_0_i56);
...
MR_def_label(transform_hlds__constraint__propagate_conj_sub_goal_2_5_0,55)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(1) = MR_tfield(0, MR_r1, 1);
	MR_sv(6) = MR_r5;
	MR_r1 = MR_tfield(3, MR_r4, 2);
	MR_np_call_localret_ent(transform_hlds__constraint__propagate_goal_5_0,
		transform_hlds__constraint__propagate_conj_sub_goal_2_5_0_i60);
MR_def_label(transform_hlds__constraint__propagate_conj_sub_goal_2_5_0,60)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tag_alloc_heap(MR_tempr1, 3, (MR_Integer) 3);
...
MR_def_label(transform_hlds__constraint__propagate_conj_sub_goal_2_5_0,50)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_def_label(transform_hlds__constraint__propagate_conj_sub_goal_2_5_0,37)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_RTAGS_TESTR(MR_r4,3,4)) {
		MR_GOTO_LAB(transform_hlds__constraint__propagate_conj_sub_goal_2_5_0_i65);
	}
	MR_incr_sp(8);
	MR_sv(8) = (MR_Word) MR_succip;
	MR_sv(1) = MR_tfield(0, MR_r1, 1);
	...
	MR_np_call_localret_ent(transform_hlds__constraint__propagate_cases_6_0,
		transform_hlds__constraint__propagate_conj_sub_goal_2_5_0_i66);
...
MR_def_label(transform_hlds__constraint__propagate_conj_sub_goal_2_5_0,65)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_string_const("transform_hlds.constraint", 25);
	MR_r2 = (MR_Word) MR_string_const("predicate \140transform_hlds.constraint.propagate_conj_sub_goal_2\'/5", 65);
...
MR_def_label(transform_hlds__constraint__propagate_conj_constraints_5_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(4) = MR_r2;
	MR_sv(5) = (MR_Word) MR_CTOR0_ADDR(transform_hlds__constraint, constraint);
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
	MR_r1 = MR_sv(5);
...
MR_BEGIN_MODULE(transform_hlds__constraint_module19)
	...
	MR_init_label10(fn__transform_hlds__constraint__strip_constraint_markers_expr_1_0,4,3,10,8,14,12,18,19,20,17)
	MR_init_label4(fn__transform_hlds__constraint__strip_constraint_markers_expr_1_0,23,22,27,98)
MR_BEGIN_CODE
...
MR_def_static(fn__transform_hlds__constraint__strip_constraint_markers_expr_1_0)
	...
	if (MR_PTAG_TESTR(MR_r1,0)) {
		MR_GOTO_LAB(fn__transform_hlds__constraint__strip_constraint_markers_expr_1_0_i3);
	}
	MR_incr_sp(4);
	MR_sv(4) = (MR_Word) MR_succip;
	...
	MR_np_call_localret_ent(fn__transform_hlds__constraint__strip_constraint_markers_1_0,
		fn__transform_hlds__constraint__strip_constraint_markers_expr_1_0_i4);
MR_def_label(fn__transform_hlds__constraint__strip_constraint_markers_expr_1_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_tmkword(0, (MR_Word *) MR_r1);
	MR_decr_sp_and_return(4);
MR_def_label(fn__transform_hlds__constraint__strip_constraint_markers_expr_1_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	...
	if (MR_RTAGS_TESTR(MR_r1,3,2)) {
		MR_GOTO_LAB(fn__transform_hlds__constraint__strip_constraint_markers_expr_1_0_i8);
	}
	MR_incr_sp(4);
	MR_sv(4) = (MR_Word) MR_succip;
...
MR_def_label(fn__transform_hlds__constraint__strip_constraint_markers_expr_1_0,10)
	...
	MR_r1 = MR_r2;
	MR_decr_sp_and_return(4);
MR_def_label(fn__transform_hlds__constraint__strip_constraint_markers_expr_1_0,8)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_RTAGS_TESTR(MR_r1,3,3)) {
		MR_GOTO_LAB(fn__transform_hlds__constraint__strip_constraint_markers_expr_1_0_i12);
	}
	MR_incr_sp(4);
	MR_sv(4) = (MR_Word) MR_succip;
	{
...
MR_def_label(fn__transform_hlds__constraint__strip_constraint_markers_expr_1_0,12)
	...
	if (MR_RTAGS_TESTR(MR_r1,3,6)) {
		MR_GOTO_LAB(fn__transform_hlds__constraint__strip_constraint_markers_expr_1_0_i17);
	}
	MR_incr_sp(4);
	MR_sv(4) = (MR_Word) MR_succip;
	MR_sv(1) = MR_tfield(3, MR_r1, 1);
...
MR_def_label(fn__transform_hlds__constraint__strip_constraint_markers_expr_1_0,17)
	...
	if (MR_RTAGS_TESTR(MR_r1,3,5)) {
		MR_GOTO_LAB(fn__transform_hlds__constraint__strip_constraint_markers_expr_1_0_i22);
	}
	MR_incr_sp(4);
	MR_sv(4) = (MR_Word) MR_succip;
	MR_sv(1) = MR_tfield(3, MR_r1, 1);
...
MR_def_label(fn__transform_hlds__constraint__strip_constraint_markers_expr_1_0,22)
	...
	MR_np_call_localret_ent(fn__list__map_2_0,
		fn__transform_hlds__constraint__strip_constraint_markers_expr_1_0_i27);
MR_def_label(fn__transform_hlds__constraint__strip_constraint_markers_expr_1_0,27)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
