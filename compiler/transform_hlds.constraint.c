...
MR_decl_label8(transform_hlds__constraint__propagate_conj_5_0, 3,2,7,6,11,14,8,16)
MR_decl_label1(transform_hlds__constraint__propagate_conj_5_0, 17)
...
MR_BEGIN_MODULE(transform_hlds__constraint_module16)
	...
	MR_init_label8(transform_hlds__constraint__propagate_conj_5_0,3,2,7,6,11,14,8,16)
	MR_init_label1(transform_hlds__constraint__propagate_conj_5_0,17)
MR_BEGIN_CODE
...
MR_def_label(transform_hlds__constraint__propagate_conj_5_0,2)
	...
	MR_np_call_localret_ent(transform_hlds__constraint__flatten_constraints_2_0,
		transform_hlds__constraint__propagate_conj_5_0_i7);
MR_def_label(transform_hlds__constraint__propagate_conj_5_0,7)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_sv(3);
	MR_decr_sp_and_return(4);
MR_def_label(transform_hlds__constraint__propagate_conj_5_0,6)
	...
	if (MR_LTAGS_TESTR(MR_tempr1,0,0)) {
		MR_GOTO_LAB(transform_hlds__constraint__propagate_conj_5_0_i8);
	}
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
		MR_GOTO_LAB(transform_hlds__constraint__propagate_conj_5_0_i8);
	}
...
MR_def_label(transform_hlds__constraint__propagate_conj_5_0,11)
	...
	MR_np_call_localret_ent(transform_hlds__constraint__propagate_conj_sub_goal_2_5_0,
		transform_hlds__constraint__propagate_conj_5_0_i14);
MR_def_label(transform_hlds__constraint__propagate_conj_5_0,14)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tag_alloc_heap(MR_tempr1, 0, (MR_Integer) 5);
