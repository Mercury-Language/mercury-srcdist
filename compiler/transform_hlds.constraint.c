...
{
  {
    ...
    mercury__list__map_3_p_0(transform_hlds__constraint__TypeCtorInfo_14_14, transform_hlds__constraint__TypeCtorInfo_14_14, (MR_Word) &transform_hlds__constraint_scalar_common_2[10], transform_hlds__constraint__ConstructGoals0_8, &transform_hlds__constraint__ConstructGoals_10);
    {
      MR_Word base;
          ...
          case (MR_Integer) 2:
            {
              ...
              mercury__list__map_3_p_0(transform_hlds__constraint__TypeCtorInfo_55_63, transform_hlds__constraint__TypeCtorInfo_55_63, (MR_Word) &transform_hlds__constraint_scalar_common_2[7], transform_hlds__constraint__SubGoals0_14, &transform_hlds__constraint__SubGoals_15);
              {
          ...
          case (MR_Integer) 3:
            {
              ...
              mercury__list__map_3_p_0(transform_hlds__constraint__TypeCtorInfo_58_66, transform_hlds__constraint__TypeCtorInfo_58_66, (MR_Word) &transform_hlds__constraint_scalar_common_2[8], transform_hlds__constraint__SubGoals0_57, &transform_hlds__constraint__SubGoals_58);
              {
          ...
          case (MR_Integer) 4:
            {
              ...
              mercury__list__map_3_p_0(transform_hlds__constraint__TypeCtorInfo_61_69, transform_hlds__constraint__TypeCtorInfo_61_69, (MR_Word) &transform_hlds__constraint_scalar_common_2[9], transform_hlds__constraint__Cases0_18, &transform_hlds__constraint__Cases_19);
              {
            ...
            else
            {
              ...
              else
              {
                ...
                if (transform_hlds__constraint__succeeded)
                {
                  ...
                  transform_hlds__constraint__Var_80 = (MR_Integer) 178;
...
{
  {
    ...
    if (transform_hlds__constraint__succeeded)
    {
      ...
      transform_hlds__constraint__Var_12 = ((MR_Word) (MR_hl_field(MR_mktag(2), transform_hlds__constraint__Var_14, (MR_Integer) 5)));
      {
        ...
        mercury__list__map_3_p_0(transform_hlds__constraint__TypeCtorInfo_18_18, transform_hlds__constraint__TypeCtorInfo_18_18, (MR_Word) &transform_hlds__constraint_scalar_common_2[2], transform_hlds__constraint__Constraints0_5, &transform_hlds__constraint__Constraints_6);
      }
    }
    else
