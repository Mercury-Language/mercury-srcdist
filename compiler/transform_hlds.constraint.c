...
{
  {
    ...
    MR_Word GoalInfo_21;
    MR_Word STATE_VARIABLE_Info_20_39;
    ...
    transform_hlds__constraint__constraint_info_update_changed_3_p_0(Constraints_6, STATE_VARIABLE_Info_0_22, &STATE_VARIABLE_Info_20_39);
    if ((Goals0_14 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      transform_hlds__constraint__flatten_constraints_2_p_0(Constraints_6, &Goals_15);
      *STATE_VARIABLE_Info_23 = STATE_VARIABLE_Info_20_39;
    }
    else
    {
      MR_Word Goal0_31 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Goals0_14, (MR_Integer) 0))));
      MR_Word GoalsTail0_32 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Goals0_14, (MR_Integer) 1))));

      succeeded = (GoalsTail0_32 == (MR_Word) ((MR_Unsigned) 0U));
      if (succeeded)
        succeeded = (Constraints_6 == (MR_Word) ((MR_Unsigned) 0U));
      if (succeeded)
        transform_hlds__constraint__propagate_conj_sub_goal_5_p_0((MR_Word) ((MR_Unsigned) 0U), Goal0_31, &Goals_15, STATE_VARIABLE_Info_20_39, STATE_VARIABLE_Info_23);
      else
      {
        MR_Word InstMap0_33 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_Info_20_39, (MR_Integer) 3))));
        MR_Word ModuleInfo_34 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_Info_20_39, (MR_Integer) 0))));
        MR_Word VarTypes_35 = ((MR_Word) ((MR_hl_field(MR_mktag(0), STATE_VARIABLE_Info_20_39, (MR_Integer) 1))));
        MR_Word RevAnnotatedGoals1_36;
        MR_Word AnnotatedGoals2_37;
        MR_Word GoalsCord_38;
        MR_Word STATE_VARIABLE_Info_25_44;
        MR_Word Var_45;

        transform_hlds__constraint__annotate_conj_output_vars_6_p_0(Goals0_14, ModuleInfo_34, VarTypes_35, InstMap0_33, (MR_Word) ((MR_Unsigned) 0U), &RevAnnotatedGoals1_36);
        transform_hlds__constraint__annotate_conj_constraints_7_p_0(ModuleInfo_34, RevAnnotatedGoals1_36, Constraints_6, (MR_Word) ((MR_Unsigned) 0U), &AnnotatedGoals2_37, STATE_VARIABLE_Info_20_39, &STATE_VARIABLE_Info_25_44);
        Var_45 = mercury__cord__init_0_f_0((MR_Word) (&hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_hlds_goal_0));
        transform_hlds__constraint__propagate_conj_constraints_5_p_0(AnnotatedGoals2_37, Var_45, &GoalsCord_38, STATE_VARIABLE_Info_25_44, STATE_VARIABLE_Info_23);
        Goals_15 = mercury__cord__list_1_f_0((MR_Word) (&hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_hlds_goal_0), GoalsCord_38);
      }
    }
