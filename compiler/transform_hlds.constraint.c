...
transform_hlds__constraint__IntroducedFrom__pred__annotate_conj_output_vars__355__1_5_p_0(
    ...
    case (MR_Integer) 0:
      {
        ...
        Var_132 = (MR_Word) ((MR_Word) (NegGoal_58));
        {
          Var_131 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(0, Var_131, 0) = ((MR_Box) (Var_132));
          MR_hl_field(0, Var_131, 1) = ((MR_Box) (GoalInfo_11));
        }
        {
          MR_Word base;
          base = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
          *FinalGoals_8 = base;
          MR_hl_field(1, base, 0) = ((MR_Box) (Var_131));
              ...
              case (MR_Integer) 1:
                {
                  ...
                  transform_hlds__constraint__propagate_in_independent_goals_5_p_0((MR_Word) ((MR_Unsigned) 0U), Goals0_13, &Goals_136, STATE_VARIABLE_Info_0_83, STATE_VARIABLE_Info_84);
                  {
                    ...
                    MR_hl_field(3, Var_92, 2) = ((MR_Box) (Goals_136));
                  }
                  {
        ...
        case (MR_Integer) 3:
          {
            MR_Word Var_94;
            MR_Word Var_95;
            MR_Word Goals0_137 = ((MR_Word) ((MR_hl_field(3, GoalExpr_10, 1))));
            MR_Word Goals_138;

            transform_hlds__constraint__propagate_in_independent_goals_5_p_0(Constraints_6, Goals0_137, &Goals_138, STATE_VARIABLE_Info_0_83, STATE_VARIABLE_Info_84);
            {
              Var_95 = (MR_Word) MR_mkword(3, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(3, Var_95, 0) = ((MR_Box) ((MR_Unsigned) 3U));
              MR_hl_field(3, Var_95, 1) = ((MR_Box) (Goals_138));
            }
            {
        ...
        case (MR_Integer) 5:
          {
            ...
            switch (MR_tag((MR_Word) Reason_28)) {
              ...
              case (MR_Integer) 0:
                {
                  ...
                  transform_hlds__constraint__propagate_goal_5_p_0(Constraints_6, SubGoal0_29, &SubGoal_139, STATE_VARIABLE_Info_0_83, STATE_VARIABLE_Info_84);
                  {
                    ...
                    MR_hl_field(3, Var_118, 1) = ((MR_Box) (Reason_28));
                    MR_hl_field(3, Var_118, 2) = ((MR_Box) (SubGoal_139));
                  }
                  {
                    Var_117 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
                    MR_hl_field(0, Var_117, 0) = ((MR_Box) (Var_118));
                    MR_hl_field(0, Var_117, 1) = ((MR_Box) (GoalInfo_11));
                  }
                  {
                    MR_Word base;
                    base = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              ...
              case (MR_Integer) 2:
                {
                  MR_Word ConstraintGoals_50;
                  MR_Word Var_122;
                  MR_Word Var_123;
                  MR_Word SubGoal_140;

                  transform_hlds__constraint__propagate_goal_5_p_0((MR_Word) ((MR_Unsigned) 0U), SubGoal0_29, &SubGoal_140, STATE_VARIABLE_Info_0_83, STATE_VARIABLE_Info_84);
                  transform_hlds__constraint__flatten_constraints_2_p_0(Constraints_6, &ConstraintGoals_50);
                  {
                    Var_123 = (MR_Word) MR_mkword(3, MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
                    MR_hl_field(3, Var_123, 0) = ((MR_Box) ((MR_Unsigned) 5U));
                    MR_hl_field(3, Var_123, 1) = ((MR_Box) (Reason_28));
                    MR_hl_field(3, Var_123, 2) = ((MR_Box) (SubGoal_140));
                  }
                  {
                    Var_122 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
                    MR_hl_field(0, Var_122, 0) = ((MR_Box) (Var_123));
                    MR_hl_field(0, Var_122, 1) = ((MR_Box) (GoalInfo_11));
                  }
                  {
                    MR_Word base;
                    base = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                    *FinalGoals_8 = base;
                    MR_hl_field(1, base, 0) = ((MR_Box) (Var_122));
                    MR_hl_field(1, base, 1) = ((MR_Box) (ConstraintGoals_50));
                  }
                }
                break;
              case (MR_Integer) 3:
                switch (((MR_Integer) ((MR_hl_field(3, Reason_28, 0))))) {
                  ...
                  case (MR_Integer) 6:
                    {
                      MR_Word Var_169 = ((MR_Unsigned) ((MR_hl_field(3, Reason_28, 2))) & (MR_Integer) 3);
                        ...
                        case (MR_Integer) 2:
                          {
                            ...
                            transform_hlds__constraint__propagate_goal_5_p_0(Constraints_6, SubGoal0_29, &SubGoal_154, STATE_VARIABLE_Info_0_83, STATE_VARIABLE_Info_84);
                            {
                              ...
                              MR_hl_field(3, Var_152, 1) = ((MR_Box) (Reason_28));
                              MR_hl_field(3, Var_152, 2) = ((MR_Box) (SubGoal_154));
                            }
                            {
                              Var_151 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
                              MR_hl_field(0, Var_151, 0) = ((MR_Box) (Var_152));
                              MR_hl_field(0, Var_151, 1) = ((MR_Box) (GoalInfo_11));
                            }
                            {
                              MR_Word base;
                              base = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                        ...
                        case (MR_Integer) 3:
                          {
                            ...
                            transform_hlds__constraint__propagate_goal_5_p_0(Constraints_6, SubGoal0_29, &SubGoal_158, STATE_VARIABLE_Info_0_83, STATE_VARIABLE_Info_84);
                            {
                              ...
                              MR_hl_field(3, Var_156, 1) = ((MR_Box) (Reason_28));
                              MR_hl_field(3, Var_156, 2) = ((MR_Box) (SubGoal_158));
                            }
                            {
                              Var_155 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
                              MR_hl_field(0, Var_155, 0) = ((MR_Box) (Var_156));
                              MR_hl_field(0, Var_155, 1) = ((MR_Box) (GoalInfo_11));
                            }
                            {
                              MR_Word base;
                              base = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        ...
        case (MR_Integer) 6:
          {
            ...
            Var_147 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_Info_7_104, 0))));
            Var_148 = ((MR_Word) ((MR_hl_field(0, STATE_VARIABLE_Info_7_104, 1))));
            Var_150 = ((MR_Unsigned) ((MR_hl_field(0, STATE_VARIABLE_Info_7_104, 3))) & (MR_Integer) 1);
            {
              STATE_VARIABLE_Info_8_105 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
              MR_hl_field(0, STATE_VARIABLE_Info_8_105, 0) = ((MR_Box) (Var_147));
              MR_hl_field(0, STATE_VARIABLE_Info_8_105, 1) = ((MR_Box) (Var_148));
              MR_hl_field(0, STATE_VARIABLE_Info_8_105, 2) = ((MR_Box) (InstMap0_24));
              MR_hl_field(0, STATE_VARIABLE_Info_8_105, 3) = (MR_Box) ((MR_Unsigned) (Var_150));
            }
  ...
  MR_Box wrapper_arg_1)
{
  ...
  succeeded = transform_hlds__constraint__IntroducedFrom__pred__annotate_conj_output_vars__355__1_5_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) ((MR_hl_field(0, closure, 4)))), ((MR_Word) ((MR_hl_field(0, closure, 5)))), ((MR_Word) ((MR_hl_field(0, closure, 6)))), ((MR_Word) (wrapper_arg_1)));
  return succeeded;
}
  ...
  MR_Box wrapper_arg_1)
{
  ...
  succeeded = transform_hlds__constraint__IntroducedFrom__pred__annotate_conj_output_vars__341__1_5_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) ((MR_hl_field(0, closure, 4)))), ((MR_Word) ((MR_hl_field(0, closure, 5)))), ((MR_Word) ((MR_hl_field(0, closure, 6)))), ((MR_Word) (wrapper_arg_1)));
  return succeeded;
}
