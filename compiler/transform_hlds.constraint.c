...
{
  {
    ...
    mercury__list__map_3_p_0((MR_Word) &hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_hlds_goal_0, (MR_Word) &hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_hlds_goal_0, (MR_Word) &transform_hlds__constraint_scalar_common_3[9], ConstructGoals0_8, &ConstructGoals_10);
    {
      MR_Word base;
          ...
          case (MR_Integer) 2:
            {
              ...
              mercury__list__map_3_p_0((MR_Word) &hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_hlds_goal_0, (MR_Word) &hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_hlds_goal_0, (MR_Word) &transform_hlds__constraint_scalar_common_3[6], SubGoals0_14, &SubGoals_15);
              {
          ...
          case (MR_Integer) 3:
            {
              ...
              mercury__list__map_3_p_0((MR_Word) &hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_hlds_goal_0, (MR_Word) &hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_hlds_goal_0, (MR_Word) &transform_hlds__constraint_scalar_common_3[7], SubGoals0_57, &SubGoals_58);
              {
          ...
          case (MR_Integer) 4:
            {
              ...
              mercury__list__map_3_p_0((MR_Word) &hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_case_0, (MR_Word) &hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_case_0, (MR_Word) &transform_hlds__constraint_scalar_common_3[8], Cases0_18, &Cases_19);
              {
  ...
  MR_Word * STATE_VARIABLE_Info_5)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      mercury__list__reverse_2_p_0((MR_Word) &transform_hlds__constraint__transform_hlds__constraint__type_ctor_info_constraint_0, RevSimpleConstraints_38, &SimpleConstraints_18);
      mercury__list__reverse_2_p_0((MR_Word) &transform_hlds__constraint__transform_hlds__constraint__type_ctor_info_constraint_0, RevComplexConstraints_39, &ComplexConstraints0_19);
...
{
  {
    ...
    else
    {
      ...
      else
      {
        ...
        Var_47 = mercury__cord__init_0_f_0((MR_Word) &hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_hlds_goal_0);
        ...
        Goals_15 = mercury__cord__list_1_f_0((MR_Word) &hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_hlds_goal_0, GoalsCord_40);
      }
    }
...
{
  {
...

    {
      ...
      parse_tree__set_of_var__intersect_3_p_0((MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0, EarlierChangedVars_33, ConstraintNonLocals_42, &EarlierConstraintIntersection_43);
      (env_ptr)->transform_hlds__constraint__filter_complex_constraints_2_5_p_0_env_0__succeeded = parse_tree__set_of_var__is_empty_1_p_0((MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0, EarlierConstraintIntersection_43);
  ...
  MR_Word * STATE_VARIABLE_Info_7)
{
  while (MR_TRUE)
  {
    ...
    if ((HeadVar__2_2 == (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))))
    {
      ...
      mercury__list__map_3_p_0((MR_Word) &hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_hlds_goal_0, (MR_Word) &transform_hlds__constraint__transform_hlds__constraint__type_ctor_info_constrained_goal_0, (MR_Word) &transform_hlds__constraint_scalar_common_3[2], Constraints1_13, &NewConstrainedGoals_14);
        ...
        else
        {
          ...
          else
          {
            ...
            if (succeeded)
            {
              ...
              mercury__list__map_3_p_0((MR_Word) &hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_hlds_goal_0, (MR_Word) &transform_hlds__constraint__transform_hlds__constraint__type_ctor_info_constrained_goal_0, (MR_Word) &transform_hlds__constraint_scalar_common_3[3], Var_79, &NewConstrainedGoals_54);
            ...
            else
            {
              ...
              if (succeeded)
              {
                ...
                mercury__list__map_3_p_0((MR_Word) &hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_hlds_goal_0, (MR_Word) &transform_hlds__constraint__transform_hlds__constraint__type_ctor_info_constrained_goal_0, (MR_Word) &transform_hlds__constraint_scalar_common_3[4], IndependentConstraintGoals_58, &NewConstrainedGoals_88);
...
{
  {
...

    {
      ...
      parse_tree__set_of_var__intersect_3_p_0((MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0, EarlierChangedVars_46, ConstraintNonLocals_55, &EarlierConstraintIntersection_56);
      (env_ptr)->transform_hlds__constraint__filter_dependent_constraints_2_7_p_0_env_0__succeeded = parse_tree__set_of_var__is_empty_1_p_0((MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0, EarlierConstraintIntersection_56);
...
{
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        Subn_32 = mercury__map__singleton_2_f_0((MR_Word) &transform_hlds__constraint_scalar_common_1[1], (MR_Word) &transform_hlds__constraint_scalar_common_1[1], ((MR_Box) (ConstructVar_1)), ((MR_Box) (NewVar_28)));
