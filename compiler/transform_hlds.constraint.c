...
MR_decl_label8(transform_hlds__constraint__annotate_conj_constraints_9_0, 115,4,5,7,9,8,11,13)
MR_decl_label8(transform_hlds__constraint__annotate_conj_constraints_9_0, 6,20,16,22,23,24,21,26)
MR_decl_label8(transform_hlds__constraint__annotate_conj_constraints_9_0, 28,30,31,25,37,39,40,42)
MR_decl_label8(transform_hlds__constraint__annotate_conj_constraints_9_0, 43,44,45,46,34,47,48,3)
MR_decl_label3(transform_hlds__constraint__annotate_conj_constraints_9_0, 55,56,57)
...
MR_BEGIN_MODULE(transform_hlds__constraint_module9)
	...
	MR_init_label8(transform_hlds__constraint__annotate_conj_constraints_9_0,115,4,5,7,9,8,11,13)
	MR_init_label8(transform_hlds__constraint__annotate_conj_constraints_9_0,6,20,16,22,23,24,21,26)
	MR_init_label8(transform_hlds__constraint__annotate_conj_constraints_9_0,28,30,31,25,37,39,40,42)
	MR_init_label8(transform_hlds__constraint__annotate_conj_constraints_9_0,43,44,45,46,34,47,48,3)
	MR_init_label3(transform_hlds__constraint__annotate_conj_constraints_9_0,55,56,57)
MR_BEGIN_CODE
...
MR_def_label(transform_hlds__constraint__annotate_conj_constraints_9_0,6)
	...
	if (MR_PTAG_TESTR(MR_tempr1,0)) {
		MR_GOTO_LAB(transform_hlds__constraint__annotate_conj_constraints_9_0_i16);
	}
	...
	MR_np_call_localret_ent(transform_hlds__constraint__add_constant_construction_6_0,
		transform_hlds__constraint__annotate_conj_constraints_9_0_i20);
...
MR_def_label(transform_hlds__constraint__annotate_conj_constraints_9_0,23)
	...
	if (((MR_Integer) 0 != (MR_Integer) MR_r2)) {
		MR_GOTO_LAB(transform_hlds__constraint__annotate_conj_constraints_9_0_i21);
	}
	MR_r1 = MR_sv(2);
	MR_r2 = MR_sv(12);
	MR_np_call_localret_ent(transform_hlds__constraint__constraint_info_update_changed_3_0,
		transform_hlds__constraint__annotate_conj_constraints_9_0_i24);
...
MR_def_label(transform_hlds__constraint__annotate_conj_constraints_9_0,26)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(transform_hlds__constraint__annotate_conj_constraints_9_0_i25);
	}
	MR_r1 = MR_sv(10);
	MR_np_call_localret_ent(fn__hlds__hlds_goal__goal_info_get_purity_1_0,
...
MR_def_label(transform_hlds__constraint__annotate_conj_constraints_9_0,28)
	...
	MR_np_call_localret_ent(transform_hlds__constraint__flatten_constraints_2_0,
		transform_hlds__constraint__annotate_conj_constraints_9_0_i30);
MR_def_label(transform_hlds__constraint__annotate_conj_constraints_9_0,30)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 2);
...
MR_def_label(transform_hlds__constraint__annotate_conj_constraints_9_0,37)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_r1) {
		MR_GOTO_LAB(transform_hlds__constraint__annotate_conj_constraints_9_0_i34);
	}
	MR_r1 = MR_sv(1);
	MR_np_call_localret_ent(hlds__hlds_module__module_info_get_globals_2_0,
		transform_hlds__constraint__annotate_conj_constraints_9_0_i39);
MR_def_label(transform_hlds__constraint__annotate_conj_constraints_9_0,39)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_def_label(transform_hlds__constraint__annotate_conj_constraints_9_0,55)
	...
	MR_np_call_localret_ent(list__map_3_0,
		transform_hlds__constraint__annotate_conj_constraints_9_0_i56);
MR_def_label(transform_hlds__constraint__annotate_conj_constraints_9_0,56)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_r1;
	MR_r1 = MR_sv(1);
	MR_r3 = MR_sv(3);
	MR_np_call_localret_ent(list__append_3_1,
		transform_hlds__constraint__annotate_conj_constraints_9_0_i57);
MR_def_label(transform_hlds__constraint__annotate_conj_constraints_9_0,57)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_sv(4);
	MR_decr_sp_and_return(13);
#ifdef MR_maybe_local_thread_engine_base
