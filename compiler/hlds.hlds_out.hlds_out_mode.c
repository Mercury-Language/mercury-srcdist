                    ...
                    case (MR_Integer) 1:
                      {
                        ...
                        {
                          parse_tree__prog_io_type_name__unparse_type_2_p_0(hlds__hlds_out__hlds_out_mode__Type_18, &hlds__hlds_out__hlds_out_mode__Term0_19);
                        }
                        {
                    ...
                    case (MR_Integer) 1:
                      {
                        ...
                        {
                          parse_tree__prog_io_type_name__unparse_type_2_p_0(hlds__hlds_out__hlds_out_mode__Type_132, &hlds__hlds_out__hlds_out_mode__Term0_129);
                        }
      ...
      case (MR_Integer) 1:
        {
          ...
          {
            parse_tree__prog_io_type_name__unparse_type_2_p_0(hlds__hlds_out__hlds_out_mode__Type_12, &hlds__hlds_out__hlds_out_mode__Term0_13);
          }
          {
