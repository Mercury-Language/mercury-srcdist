  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      if ((Args_26 == (MR_Word) ((MR_Unsigned) 0U)))
      {
        ...
        parse_tree__mercury_to_mercury__mercury_format_cons_id_5_p_0(TypeClassInfo_for_output_55, (MR_Integer) 0, ConsId_25, S_6, STATE_VARIABLE_U_46_46, &STATE_VARIABLE_U_48_48);
      ...
      else
      {
        ...
        parse_tree__mercury_to_mercury__mercury_format_cons_id_5_p_0(TypeClassInfo_for_output_55, (MR_Integer) 1, ConsId_25, S_6, STATE_VARIABLE_U_37_37, &STATE_VARIABLE_U_39_39);
