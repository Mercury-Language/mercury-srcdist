    ...
    case (MR_Integer) 2:
      {
        ...
        MR_Word BoundInsts_24 = ((MR_Word) ((MR_hl_field(2, Inst_15, (MR_Integer) 2))));
          ...
          case (MR_Integer) 1:
            {
              ...
              Var_55 = (MR_Integer) ((MR_Unsigned) Indent_13 + (MR_Unsigned) 1);
        ...
        hlds__hlds_out__hlds_out_mode__mercury_format_structured_bound_insts_8_p_0(TypeClassInfo_for_pt_output_99, Lang_10, InstVarSet_11, InclAddr_12, Var_66, BoundInsts_24, S_16, STATE_VARIABLE_U_65_65, &STATE_VARIABLE_U_67_67);
        switch (Lang_10) {
          default: /*NOTREACHED*/ MR_assert(0);
          case (MR_Integer) 1:
            {
              MR_Integer Var_69 = (MR_Integer) ((MR_Unsigned) Indent_13 + (MR_Unsigned) 1);
