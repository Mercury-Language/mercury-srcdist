      ...
      case (MR_Integer) 2:
        {
          ...
          if ((HOInstInfo_19 == (MR_Word) ((MR_Integer) 0)))
          ...
          case (MR_Integer) 1:
            {
              ...
              if ((HOInstInfo_105 == (MR_Word) ((MR_Integer) 0)))
              {
  ...
  MR_Box * STATE_VARIABLE_U_7)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      if ((Args_23 == (MR_Word) ((MR_Integer) 0)))
      {
        MR_Box STATE_VARIABLE_U_43_43;
      ...
      else
      {
        ...
        if ((Insts_61 == (MR_Word) ((MR_Integer) 0)))
        {
        ...
        else
        {
          ...
          if ((Insts_103 == (MR_Word) ((MR_Integer) 0)))
  ...
  MR_Box * STATE_VARIABLE_U_7)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      if ((Insts_16 == (MR_Word) ((MR_Integer) 0)))
        Suffix_22 = (MR_String) "\n";
      else
        Suffix_22 = (MR_String) ",\n";
      ...
      case (MR_Integer) 0:
        {
          ...
          if ((Args_19 == (MR_Word) ((MR_Integer) 0)))
      ...
      case (MR_Integer) 2:
        {
          ...
          parse_tree__parse_tree_out_info__add_string_3_p_0(TypeClassInfo_for_output_168, (MR_String) "\044merge_inst(\n", STATE_VARIABLE_U_33_33, &STATE_VARIABLE_U_117_117);
          {
            ...
            MR_hl_field(MR_mktag(1), Insts_179, 1) = ((MR_Box) ((MR_Integer) 0));
          }
  ...
  MR_Word HeadVar__4_4)
{
  while (MR_TRUE)
  {
    ...
    if (!((HeadVar__4_4 == (MR_Word) ((MR_Integer) 0))))
    {
      ...
      if (!((VarsInsts_18 == (MR_Word) ((MR_Integer) 0))))
      {
