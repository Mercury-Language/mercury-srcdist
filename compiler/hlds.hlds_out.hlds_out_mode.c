                ...
                case (MR_Integer) 1:
                  {
                    ...
                    {
                      hlds__hlds_out__hlds_out_mode__InstResultsTerm_24 = parse_tree__unparse__inst_test_results_to_term_2_f_0(hlds__hlds_out__hlds_out_mode__V_65_65, hlds__hlds_out__hlds_out_mode__InstResults_22);
                    }
