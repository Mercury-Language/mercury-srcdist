...
MR_decl_label8(transform_hlds__rbmm__points_to_analysis__apply_rules_outedges_6_0, 69,3,4,5,7,10,12,14)
MR_decl_label8(transform_hlds__rbmm__points_to_analysis__apply_rules_outedges_6_0, 16,17,6,18,19,20,23,26)
MR_decl_label8(transform_hlds__rbmm__points_to_analysis__apply_rules_outedges_6_0, 29,49,27,32,33,34,35,39)
MR_decl_label2(transform_hlds__rbmm__points_to_analysis__apply_rules_outedges_6_0, 40,41)
...
MR_BEGIN_MODULE(transform_hlds__rbmm__points_to_analysis_module20)
	...
	MR_init_label8(transform_hlds__rbmm__points_to_analysis__apply_rules_outedges_6_0,69,3,4,5,7,10,12,14)
	MR_init_label8(transform_hlds__rbmm__points_to_analysis__apply_rules_outedges_6_0,16,17,6,18,19,20,23,26)
	MR_init_label8(transform_hlds__rbmm__points_to_analysis__apply_rules_outedges_6_0,29,49,27,32,33,34,35,39)
	MR_init_label2(transform_hlds__rbmm__points_to_analysis__apply_rules_outedges_6_0,40,41)
MR_BEGIN_CODE
...
MR_def_label(transform_hlds__rbmm__points_to_analysis__apply_rules_outedges_6_0,69)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
...
MR_def_label(transform_hlds__rbmm__points_to_analysis__apply_rules_outedges_6_0,23)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(transform_hlds__rbmm__points_to_analysis__apply_rules_outedges_6_0_i49);
	}
	MR_sv(8) = MR_r2;
...
MR_def_label(transform_hlds__rbmm__points_to_analysis__apply_rules_outedges_6_0,49)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 0, (MR_Integer) 2);
	...
	MR_r3 = MR_sv(3);
	MR_r1 = MR_sv(4);
	MR_GOTO_LAB(transform_hlds__rbmm__points_to_analysis__apply_rules_outedges_6_0_i39);
	}
...
MR_def_label(transform_hlds__rbmm__points_to_analysis__apply_rules_outedges_6_0,40)
	...
	MR_np_call_localret_ent(transform_hlds__rbmm__points_to_analysis__rule_8_6_0,
		transform_hlds__rbmm__points_to_analysis__apply_rules_outedges_6_0_i41);
MR_def_label(transform_hlds__rbmm__points_to_analysis__apply_rules_outedges_6_0,41)
	...
	MR_GOTO_LAB(transform_hlds__rbmm__points_to_analysis__apply_rules_outedges_6_0_i69);
	}
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_thread_engine_base
