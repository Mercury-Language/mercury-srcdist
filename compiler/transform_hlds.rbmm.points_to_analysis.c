...
MR_decl_label10(transform_hlds__rbmm__points_to_analysis__apply_rules_6_0, 22,3,5,6,7,8,9,10,11,12)
MR_decl_label10(transform_hlds__rbmm__points_to_analysis__apply_rules_outedges_6_0, 92,3,4,5,7,10,12,14,16,17)
...
MR_decl_label10(transform_hlds__rbmm__points_to_analysis__inter_analyse_goal_expr_8_0, 3,7,12,13,11,15,19,22,23,24)
MR_decl_label10(transform_hlds__rbmm__points_to_analysis__inter_analyse_goal_expr_8_0, 25,26,28,30,31,21,17,32,34,38)
MR_decl_label2(transform_hlds__rbmm__points_to_analysis__inter_analyse_goal_expr_8_0, 39,41)
...
MR_decl_label10(transform_hlds__rbmm__points_to_analysis__intra_analyse_unification_3_0, 4,5,6,7,8,3,12,13,15,18)
MR_decl_label4(transform_hlds__rbmm__points_to_analysis__intra_analyse_unification_3_0, 11,23,20,25)
...
MR_decl_label5(transform_hlds__rbmm__points_to_analysis__run_with_dependency_until_fixpoint_5_0, 22,4,7,5,12)
...
MR_BEGIN_MODULE(transform_hlds__rbmm__points_to_analysis_module4)
	...
	MR_init_label10(transform_hlds__rbmm__points_to_analysis__intra_analyse_unification_3_0,4,5,6,7,8,3,12,13,15,18)
	MR_init_label4(transform_hlds__rbmm__points_to_analysis__intra_analyse_unification_3_0,11,23,20,25)
MR_BEGIN_CODE
...
MR_def_label(transform_hlds__rbmm__points_to_analysis__intra_analyse_unification_3_0,15)
	...
	MR_np_call_localret_ent(list__foldl2_6_0,
		transform_hlds__rbmm__points_to_analysis__intra_analyse_unification_3_0_i18);
MR_def_label(transform_hlds__rbmm__points_to_analysis__intra_analyse_unification_3_0,18)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_def_label(transform_hlds__rbmm__points_to_analysis__intra_analyse_unification_3_0,11)
	...
	if (MR_PTAG_TESTR(MR_r1,1)) {
		MR_GOTO_LAB(transform_hlds__rbmm__points_to_analysis__intra_analyse_unification_3_0_i20);
	}
	MR_incr_sp(7);
	MR_sv(7) = (MR_Word) MR_succip;
	{
	...
	MR_np_call_localret_ent(list__foldl2_6_0,
		transform_hlds__rbmm__points_to_analysis__intra_analyse_unification_3_0_i23);
...
MR_def_label(transform_hlds__rbmm__points_to_analysis__intra_analyse_unification_3_0,20)
	...
	if (MR_RTAGS_TESTR(MR_r1,3,0)) {
		MR_GOTO_LAB(transform_hlds__rbmm__points_to_analysis__intra_analyse_unification_3_0_i25);
	}
	MR_r1 = MR_r2;
	MR_proceed();
...
MR_BEGIN_MODULE(transform_hlds__rbmm__points_to_analysis_module13)
	...
	MR_init_label5(transform_hlds__rbmm__points_to_analysis__run_with_dependency_until_fixpoint_5_0,22,4,7,5,12)
MR_BEGIN_CODE
...
MR_def_static(transform_hlds__rbmm__points_to_analysis__run_with_dependency_until_fixpoint_5_0)
	...
	MR_incr_sp(7);
	MR_sv(7) = (MR_Word) MR_succip;
MR_def_label(transform_hlds__rbmm__points_to_analysis__run_with_dependency_until_fixpoint_5_0,22)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
...
MR_def_label(transform_hlds__rbmm__points_to_analysis__run_with_dependency_until_fixpoint_5_0,12)
	...
	MR_r4 = MR_sv(4);
	MR_succip_word = MR_sv(7);
	MR_GOTO_LAB(transform_hlds__rbmm__points_to_analysis__run_with_dependency_until_fixpoint_5_0_i22);
	}
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_thread_engine_base
...
MR_BEGIN_MODULE(transform_hlds__rbmm__points_to_analysis_module19)
	...
	MR_init_label10(transform_hlds__rbmm__points_to_analysis__apply_rules_outedges_6_0,92,3,4,5,7,10,12,14,16,17)
...
MR_def_label(transform_hlds__rbmm__points_to_analysis__apply_rules_outedges_6_0,92)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
...
MR_def_label(transform_hlds__rbmm__points_to_analysis__apply_rules_outedges_6_0,46)
	...
	MR_GOTO_LAB(transform_hlds__rbmm__points_to_analysis__apply_rules_outedges_6_0_i92);
	}
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_thread_engine_base
...
MR_BEGIN_MODULE(transform_hlds__rbmm__points_to_analysis_module20)
	...
	MR_init_label10(transform_hlds__rbmm__points_to_analysis__apply_rules_6_0,22,3,5,6,7,8,9,10,11,12)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(transform_hlds__rbmm__points_to_analysis_module22)
	...
	MR_init_label10(transform_hlds__rbmm__points_to_analysis__inter_analyse_goal_expr_8_0,3,7,12,13,11,15,19,22,23,24)
	MR_init_label10(transform_hlds__rbmm__points_to_analysis__inter_analyse_goal_expr_8_0,25,26,28,30,31,21,17,32,34,38)
	MR_init_label2(transform_hlds__rbmm__points_to_analysis__inter_analyse_goal_expr_8_0,39,41)
MR_BEGIN_CODE
...
MR_def_label(transform_hlds__rbmm__points_to_analysis__inter_analyse_goal_expr_8_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_RTAGS_TESTR(MR_r1,3,3)) {
		MR_GOTO_LAB(transform_hlds__rbmm__points_to_analysis__inter_analyse_goal_expr_8_0_i7);
	}
	{
	MR_Word MR_tempr1, MR_tempr2, MR_tempr3;
	MR_tag_alloc_heap(MR_tempr1, 0, (MR_Integer) 5);
...
MR_def_label(transform_hlds__rbmm__points_to_analysis__inter_analyse_goal_expr_8_0,7)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_RTAGS_TESTR(MR_r1,3,6)) {
		MR_GOTO_LAB(transform_hlds__rbmm__points_to_analysis__inter_analyse_goal_expr_8_0_i11);
	}
	MR_incr_sp(10);
...
MR_def_label(transform_hlds__rbmm__points_to_analysis__inter_analyse_goal_expr_8_0,15)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_r1,2)) {
		MR_GOTO_LAB(transform_hlds__rbmm__points_to_analysis__inter_analyse_goal_expr_8_0_i17);
	}
	MR_incr_sp(10);
	MR_sv(10) = (MR_Word) MR_succip;
	{
...
MR_def_label(transform_hlds__rbmm__points_to_analysis__inter_analyse_goal_expr_8_0,19)
	...
	if (MR_INT_NE(MR_r3,0)) {
		MR_GOTO_LAB(transform_hlds__rbmm__points_to_analysis__inter_analyse_goal_expr_8_0_i21);
	}
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_sv(1);
...
MR_def_label(transform_hlds__rbmm__points_to_analysis__inter_analyse_goal_expr_8_0,25)
	...
	MR_np_call_localret_ent(transform_hlds__rbmm__points_to_analysis__alpha_mapping_at_call_site_7_0,
		transform_hlds__rbmm__points_to_analysis__inter_analyse_goal_expr_8_0_i26);
...
MR_def_label(transform_hlds__rbmm__points_to_analysis__inter_analyse_goal_expr_8_0,17)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_RTAGS_TESTR(MR_r1,3,5)) {
		MR_GOTO_LAB(transform_hlds__rbmm__points_to_analysis__inter_analyse_goal_expr_8_0_i32);
	}
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
...
MR_def_label(transform_hlds__rbmm__points_to_analysis__inter_analyse_goal_expr_8_0,34)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_r1,1)) {
		MR_GOTO_LAB(transform_hlds__rbmm__points_to_analysis__inter_analyse_goal_expr_8_0_i38);
	}
	MR_r1 = MR_r5;
	MR_r2 = MR_r6;
	MR_proceed();
MR_def_label(transform_hlds__rbmm__points_to_analysis__inter_analyse_goal_expr_8_0,38)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_RTAGS_TESTR(MR_r1,3,1)) {
		MR_GOTO_LAB(transform_hlds__rbmm__points_to_analysis__inter_analyse_goal_expr_8_0_i39);
	}
	MR_r1 = (MR_Word) MR_string_const("transform_hlds.rbmm.points_to_analysis", 38);
...
MR_def_label(transform_hlds__rbmm__points_to_analysis__inter_analyse_goal_expr_8_0,39)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_RTAGS_TESTR(MR_r1,3,0)) {
		MR_GOTO_LAB(transform_hlds__rbmm__points_to_analysis__inter_analyse_goal_expr_8_0_i41);
	}
	MR_r1 = (MR_Word) MR_string_const("transform_hlds.rbmm.points_to_analysis", 38);
	MR_r2 = (MR_Word) MR_string_const("predicate \140transform_hlds.rbmm.points_to_analysis.inter_analyse_goal_expr\'/8", 76);
