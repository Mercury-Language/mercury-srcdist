  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      else
      {
        ...
        /* direct tailcall eliminated */
        next_value_of_HeadVar__1_1 = Var_58;
        next_value_of_HeadVar__2_2 = Ys_38;
        next_value_of_STATE_VARIABLE_CallerGraph_0_4 = STATE_VARIABLE_CallerGraph_50_50;
        next_value_of_STATE_VARIABLE_AlphaMap_0_6 = STATE_VARIABLE_AlphaMap_51_51;
        HeadVar__1_1 = next_value_of_HeadVar__1_1;
