          ...
          case (MR_Integer) 2:
            {
...

              {
                ...
                MR_hl_field(MR_mktag(0), transform_hlds__rbmm__points_to_analysis__Var_20, 0) = ((MR_Box) (&transform_hlds__rbmm__points_to_analysis_scalar_common_6[1]));
          ...
          case (MR_Integer) 3:
            {
...

              {
                ...
                MR_hl_field(MR_mktag(0), transform_hlds__rbmm__points_to_analysis__Var_114, 0) = ((MR_Box) (&transform_hlds__rbmm__points_to_analysis_scalar_common_6[1]));
          ...
          case (MR_Integer) 4:
            {
...

              {
                ...
                MR_hl_field(MR_mktag(0), transform_hlds__rbmm__points_to_analysis__Var_87, 0) = ((MR_Box) (&transform_hlds__rbmm__points_to_analysis_scalar_common_6[2]));
      ...
      *transform_hlds__rbmm__points_to_analysis__STATE_VARIABLE_InfoTable_11 = transform_hlds__rbmm__points_to_analysis__STATE_VARIABLE_InfoTable_0_10;
    else
      {
...

        {
          ...
          MR_hl_field(MR_mktag(0), transform_hlds__rbmm__points_to_analysis__Var_17, 0) = ((MR_Box) (&transform_hlds__rbmm__points_to_analysis_scalar_common_5[2]));
      ...
      case (MR_Integer) 0:
        {
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(0), transform_hlds__rbmm__points_to_analysis__Var_26, 0) = ((MR_Box) (&transform_hlds__rbmm__points_to_analysis_scalar_common_6[0]));
      ...
      case (MR_Integer) 1:
        {
...

          {
            ...
            MR_hl_field(MR_mktag(0), transform_hlds__rbmm__points_to_analysis__Var_40, 0) = ((MR_Box) (&transform_hlds__rbmm__points_to_analysis_scalar_common_6[0]));
