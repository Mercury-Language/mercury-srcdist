  ...
  MR_Word * HeadVar__6_6)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      MR_Word TypeCtorInfo__27_39;
      MR_Word TypeInfo__28_40;
      MR_Word TypeCtorInfo__29_41;
      ...
      if (succeeded)
      {
        TypeCtorInfo__27_39 = (MR_Word) (&transform_hlds__smm_common__transform_hlds__smm_common__type_ctor_info_program_point_0);
        TypeInfo__28_40 = (MR_Word) (&transform_hlds__rbmm__points_to_analysis_scalar_common_1[2]);
        succeeded = mercury__map__search_3_p_0(TypeCtorInfo__27_39, TypeInfo__28_40, STATE_VARIABLE_CallerAlphaMapping_0_56, ((MR_Box) (CallSite_3)), &conv0_AlphaAtCallSite_33);
        if (succeeded)
        {
        ...
        if (succeeded)
        {
          TypeCtorInfo__29_41 = (MR_Word) (&transform_hlds__rbmm__points_to_graph__transform_hlds__rbmm__points_to_graph__type_ctor_info_rptg_node_0);
          succeeded = mercury__map__search_3_p_0(TypeCtorInfo__29_41, TypeCtorInfo__29_41, AlphaAtCallSite_33, ((MR_Box) (CalleeM_29)), &conv1_CallerM_34);
          if (succeeded)
          {
