...
MR_decl_label8(transform_hlds__rbmm__points_to_analysis__apply_rules_6_0, 19,3,4,5,6,7,8,9)
MR_decl_label4(transform_hlds__rbmm__points_to_analysis__apply_rules_6_0, 10,11,12,13)
MR_decl_label8(transform_hlds__rbmm__points_to_analysis__apply_rules_arcs_6_0, 39,3,4,5,7,9,11,13)
MR_decl_label8(transform_hlds__rbmm__points_to_analysis__apply_rules_arcs_6_0, 15,16,17,6,18,19,20,21)
...
MR_decl_label8(transform_hlds__rbmm__points_to_analysis__region_points_to_analysis_3_0, 2,3,4,5,6,9,10,8)
MR_decl_label8(transform_hlds__rbmm__points_to_analysis__rule_1_3_0, 19,2,3,4,5,7,8,22)
...
MR_BEGIN_MODULE(transform_hlds__rbmm__points_to_analysis_module1)
	...
	MR_init_label8(transform_hlds__rbmm__points_to_analysis__region_points_to_analysis_3_0,2,3,4,5,6,9,10,8)
MR_BEGIN_CODE
...
MR_def_label(transform_hlds__rbmm__points_to_analysis__region_points_to_analysis_3_0,6)
	...
	MR_np_call_localret_ent(hlds__hlds_module__hlds_dependency_info_get_dependency_ordering_2_0,
		transform_hlds__rbmm__points_to_analysis__region_points_to_analysis_3_0_i9);
...
MR_BEGIN_MODULE(transform_hlds__rbmm__points_to_analysis_module3)
	...
	MR_init_label8(transform_hlds__rbmm__points_to_analysis__rule_1_3_0,19,2,3,4,5,7,8,22)
MR_BEGIN_CODE
...
MR_def_static(transform_hlds__rbmm__points_to_analysis__rule_1_3_0)
	...
	MR_incr_sp(4);
	MR_sv(4) = (MR_Word) MR_succip;
MR_def_label(transform_hlds__rbmm__points_to_analysis__rule_1_3_0,19)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(1) = MR_r1;
	{
	MR_Word MR_tempr1;
...
MR_def_label(transform_hlds__rbmm__points_to_analysis__rule_1_3_0,8)
	...
	if (MR_INT_EQ(MR_r2,0)) {
		MR_GOTO_LAB(transform_hlds__rbmm__points_to_analysis__rule_1_3_0_i22);
	}
	MR_r2 = MR_r1;
	MR_r1 = MR_sv(1);
	MR_succip_word = MR_sv(4);
	MR_GOTO_LAB(transform_hlds__rbmm__points_to_analysis__rule_1_3_0_i19);
MR_def_label(transform_hlds__rbmm__points_to_analysis__rule_1_3_0,22)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(4);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
...
MR_BEGIN_MODULE(transform_hlds__rbmm__points_to_analysis_module22)
	...
	MR_init_label8(transform_hlds__rbmm__points_to_analysis__apply_rules_arcs_6_0,39,3,4,5,7,9,11,13)
	MR_init_label8(transform_hlds__rbmm__points_to_analysis__apply_rules_arcs_6_0,15,16,17,6,18,19,20,21)
MR_BEGIN_CODE
...
MR_def_label(transform_hlds__rbmm__points_to_analysis__apply_rules_arcs_6_0,39)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
...
MR_def_label(transform_hlds__rbmm__points_to_analysis__apply_rules_arcs_6_0,21)
	...
	MR_GOTO_LAB(transform_hlds__rbmm__points_to_analysis__apply_rules_arcs_6_0_i39);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_thread_engine_base
#endif
...
MR_BEGIN_MODULE(transform_hlds__rbmm__points_to_analysis_module23)
	...
	MR_init_label8(transform_hlds__rbmm__points_to_analysis__apply_rules_6_0,19,3,4,5,6,7,8,9)
	MR_init_label4(transform_hlds__rbmm__points_to_analysis__apply_rules_6_0,10,11,12,13)
MR_BEGIN_CODE
