...
MR_decl_label8(transform_hlds__rbmm__points_to_analysis__apply_rules_outedges_6_0, 68,3,4,5,7,10,12,14)
MR_decl_label8(transform_hlds__rbmm__points_to_analysis__apply_rules_outedges_6_0, 16,17,6,18,19,20,23,26)
MR_decl_label8(transform_hlds__rbmm__points_to_analysis__apply_rules_outedges_6_0, 28,48,27,31,32,33,34,38)
MR_decl_label2(transform_hlds__rbmm__points_to_analysis__apply_rules_outedges_6_0, 39,40)
...
MR_decl_static(transform_hlds__rbmm__points_to_analysis__IntroducedFrom__pred__rpta_fixpoint_table_new_rpta_info__1049__1_2_0)
...
{
MR_COMMON(7,0),
MR_ENTRY_AP(transform_hlds__rbmm__points_to_analysis__IntroducedFrom__pred__rpta_fixpoint_table_new_rpta_info__1049__1_2_0),
0
},
};
...
"transform_hlds.rbmm.points_to_analysis",
"transform_hlds.rbmm.points_to_analysis",
"lambda_rbmm_points_to_analysis_m_1049",
2,
0
},
"transform_hlds.rbmm.points_to_analysis",
...
MR_BEGIN_MODULE(transform_hlds__rbmm__points_to_analysis_module20)
	...
	MR_init_label8(transform_hlds__rbmm__points_to_analysis__apply_rules_outedges_6_0,68,3,4,5,7,10,12,14)
	MR_init_label8(transform_hlds__rbmm__points_to_analysis__apply_rules_outedges_6_0,16,17,6,18,19,20,23,26)
	MR_init_label8(transform_hlds__rbmm__points_to_analysis__apply_rules_outedges_6_0,28,48,27,31,32,33,34,38)
	MR_init_label2(transform_hlds__rbmm__points_to_analysis__apply_rules_outedges_6_0,39,40)
MR_BEGIN_CODE
...
MR_def_label(transform_hlds__rbmm__points_to_analysis__apply_rules_outedges_6_0,68)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
...
MR_def_label(transform_hlds__rbmm__points_to_analysis__apply_rules_outedges_6_0,23)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(transform_hlds__rbmm__points_to_analysis__apply_rules_outedges_6_0_i48);
	}
	MR_sv(8) = MR_r2;
...
MR_def_label(transform_hlds__rbmm__points_to_analysis__apply_rules_outedges_6_0,26)
	...
	MR_r4 = MR_sv(7);
	MR_np_call_localret_ent(map__search_3_0,
		transform_hlds__rbmm__points_to_analysis__apply_rules_outedges_6_0_i28);
MR_def_label(transform_hlds__rbmm__points_to_analysis__apply_rules_outedges_6_0,28)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(transform_hlds__rbmm__points_to_analysis__apply_rules_outedges_6_0_i27);
	}
MR_def_label(transform_hlds__rbmm__points_to_analysis__apply_rules_outedges_6_0,48)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 0, (MR_Integer) 2);
	...
	MR_r3 = MR_sv(3);
	MR_r1 = MR_sv(4);
	MR_GOTO_LAB(transform_hlds__rbmm__points_to_analysis__apply_rules_outedges_6_0_i38);
	}
MR_def_label(transform_hlds__rbmm__points_to_analysis__apply_rules_outedges_6_0,27)
	...
	MR_r5 = MR_sv(9);
	MR_np_call_localret_ent(svmap__set_4_0,
		transform_hlds__rbmm__points_to_analysis__apply_rules_outedges_6_0_i31);
...
MR_def_label(transform_hlds__rbmm__points_to_analysis__apply_rules_outedges_6_0,38)
	...
	MR_np_call_localret_ent(transform_hlds__rbmm__points_to_analysis__rule_7_6_0,
		transform_hlds__rbmm__points_to_analysis__apply_rules_outedges_6_0_i39);
MR_def_label(transform_hlds__rbmm__points_to_analysis__apply_rules_outedges_6_0,39)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
	...
	MR_np_call_localret_ent(transform_hlds__rbmm__points_to_analysis__rule_8_6_0,
		transform_hlds__rbmm__points_to_analysis__apply_rules_outedges_6_0_i40);
MR_def_label(transform_hlds__rbmm__points_to_analysis__apply_rules_outedges_6_0,40)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
	...
	MR_GOTO_LAB(transform_hlds__rbmm__points_to_analysis__apply_rules_outedges_6_0_i68);
	}
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_thread_engine_base
...
MR_BEGIN_MODULE(transform_hlds__rbmm__points_to_analysis_module30)
	MR_init_entry1(transform_hlds__rbmm__points_to_analysis__IntroducedFrom__pred__rpta_fixpoint_table_new_rpta_info__1049__1_2_0);
MR_BEGIN_CODE


/*-------------------------------------------------------------------------*/
/* code for 'IntroducedFrom__pred__rpta_fixpoint_table_new_rpta_info__1049__1'/2 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(transform_hlds__rbmm__points_to_analysis__IntroducedFrom__pred__rpta_fixpoint_table_new_rpta_info__1049__1_2_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
