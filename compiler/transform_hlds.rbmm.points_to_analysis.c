...
MR_decl_label10(transform_hlds__rbmm__points_to_analysis__inter_analyse_goal_expr_8_0, 25,26,28,30,31,21,17,32,34,134)
MR_decl_label5(transform_hlds__rbmm__points_to_analysis__inter_analyse_goal_expr_8_0, 40,39,43,42,45)
...
MR_decl_label3(transform_hlds__rbmm__points_to_analysis__intra_analyse_goal_expr_3_0, 20,109,25)
...
MR_decl_static(transform_hlds__rbmm__points_to_analysis__IntroducedFrom__pred__rpta_fixpoint_table_new_rpta_info__1052__1_2_0)
...
{
MR_COMMON(7,0),
MR_ENTRY_AP(transform_hlds__rbmm__points_to_analysis__IntroducedFrom__pred__rpta_fixpoint_table_new_rpta_info__1052__1_2_0),
0
},
};
...
"transform_hlds.rbmm.points_to_analysis",
"transform_hlds.rbmm.points_to_analysis",
"lambda_rbmm_points_to_analysis_m_1052",
2,
0
},
"transform_hlds.rbmm.points_to_analysis",
...
MR_BEGIN_MODULE(transform_hlds__rbmm__points_to_analysis_module7)
	...
	MR_init_label3(transform_hlds__rbmm__points_to_analysis__intra_analyse_goal_expr_3_0,20,109,25)
MR_BEGIN_CODE
...
MR_def_label(transform_hlds__rbmm__points_to_analysis__intra_analyse_goal_expr_3_0,20)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_r1,0)) {
		MR_GOTO_LAB(transform_hlds__rbmm__points_to_analysis__intra_analyse_goal_expr_3_0_i109);
	}
	MR_r1 = MR_tfield(0, MR_r1, 3);
	MR_np_tailcall_ent(transform_hlds__rbmm__points_to_analysis__intra_analyse_unification_3_0);
MR_def_label(transform_hlds__rbmm__points_to_analysis__intra_analyse_goal_expr_3_0,109)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(3);
	MR_sv(3) = (MR_Word) MR_succip;
...
MR_BEGIN_MODULE(transform_hlds__rbmm__points_to_analysis_module23)
	...
	MR_init_label10(transform_hlds__rbmm__points_to_analysis__inter_analyse_goal_expr_8_0,25,26,28,30,31,21,17,32,34,134)
	MR_init_label5(transform_hlds__rbmm__points_to_analysis__inter_analyse_goal_expr_8_0,40,39,43,42,45)
MR_BEGIN_CODE
...
MR_def_label(transform_hlds__rbmm__points_to_analysis__inter_analyse_goal_expr_8_0,34)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_r1,0)) {
		MR_GOTO_LAB(transform_hlds__rbmm__points_to_analysis__inter_analyse_goal_expr_8_0_i134);
	}
	MR_r1 = MR_r5;
	MR_r2 = MR_r6;
	MR_proceed();
MR_def_label(transform_hlds__rbmm__points_to_analysis__inter_analyse_goal_expr_8_0,134)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(10);
	MR_sv(10) = (MR_Word) MR_succip;
	if (MR_RTAGS_TESTR(MR_r1,3,0)) {
	...
	MR_np_call_localret_ent(fn__transform_hlds__rbmm__points_to_analysis__this_file_0_0,
		transform_hlds__rbmm__points_to_analysis__inter_analyse_goal_expr_8_0_i40);
MR_def_label(transform_hlds__rbmm__points_to_analysis__inter_analyse_goal_expr_8_0,40)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_def_label(transform_hlds__rbmm__points_to_analysis__inter_analyse_goal_expr_8_0,39)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_r1,2)) {
		MR_GOTO_LAB(transform_hlds__rbmm__points_to_analysis__inter_analyse_goal_expr_8_0_i42);
	}
	MR_np_call_localret_ent(fn__transform_hlds__rbmm__points_to_analysis__this_file_0_0,
		transform_hlds__rbmm__points_to_analysis__inter_analyse_goal_expr_8_0_i43);
MR_def_label(transform_hlds__rbmm__points_to_analysis__inter_analyse_goal_expr_8_0,43)
	...
	MR_decr_sp(10);
	MR_np_tailcall_ent(require__sorry_2_0);
MR_def_label(transform_hlds__rbmm__points_to_analysis__inter_analyse_goal_expr_8_0,42)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_np_call_localret_ent(fn__transform_hlds__rbmm__points_to_analysis__this_file_0_0,
		transform_hlds__rbmm__points_to_analysis__inter_analyse_goal_expr_8_0_i45);
MR_def_label(transform_hlds__rbmm__points_to_analysis__inter_analyse_goal_expr_8_0,45)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_BEGIN_MODULE(transform_hlds__rbmm__points_to_analysis_module30)
	MR_init_entry1(transform_hlds__rbmm__points_to_analysis__IntroducedFrom__pred__rpta_fixpoint_table_new_rpta_info__1052__1_2_0);
	MR_INIT_PROC_LAYOUT_ADDR(mercury__transform_hlds__rbmm__points_to_analysis__IntroducedFrom__pred__rpta_fixpoint_table_new_rpta_info__1052__1_2_0);
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'IntroducedFrom__pred__rpta_fixpoint_table_new_rpta_info__1052__1'/2 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(transform_hlds__rbmm__points_to_analysis__IntroducedFrom__pred__rpta_fixpoint_table_new_rpta_info__1052__1_2_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
