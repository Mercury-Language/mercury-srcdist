  ...
  MR_Word * STATE_VARIABLE_CallerRptaInfo_6)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      CalleeGraph_36 = ((MR_Word) ((MR_hl_field(MR_mktag(0), CalleeRptaInfo_4, (MR_Integer) 0))));
  ...
  MR_Word * STATE_VARIABLE_InfoTable_11)
{
  ...
  else
  {
...

    {
      ...
      MR_hl_field(MR_mktag(0), Var_13, 0) = ((MR_Box) (&transform_hlds__rbmm__points_to_analysis_scalar_common_6[2]));
      MR_hl_field(MR_mktag(0), Var_13, 1) = ((MR_Box) (transform_hlds__rbmm__points_to_analysis__run_with_dependency_4_p_0_1));
      MR_hl_field(MR_mktag(0), Var_13, 2) = ((MR_Box) ((MR_Integer) 1));
      MR_hl_field(MR_mktag(0), Var_13, 3) = ((MR_Box) (STATE_VARIABLE_InfoTable_0_10));
    }
