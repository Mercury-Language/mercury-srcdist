...
static MR_bool MR_CALL 
transform_hlds__rbmm__points_to_analysis__IntroducedFrom__pred__rpta_fixpoint_table_new_rpta_info__1046__1_2_p_0(
...
{
  {
    ...
    {
      transform_hlds__rbmm__points_to_analysis__succeeded = transform_hlds__rbmm__points_to_analysis__IntroducedFrom__pred__rpta_fixpoint_table_new_rpta_info__1046__1_2_p_0(((MR_Word) transform_hlds__rbmm__points_to_analysis__wrapper_arg_1), ((MR_Word) transform_hlds__rbmm__points_to_analysis__wrapper_arg_2));
    }
    return transform_hlds__rbmm__points_to_analysis__succeeded;
  }
}
