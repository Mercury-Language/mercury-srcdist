    ...
    if (transform_hlds__rbmm__points_to_analysis__succeeded)
      *transform_hlds__rbmm__points_to_analysis__STATE_VARIABLE_InfoTable_11 = transform_hlds__rbmm__points_to_analysis__STATE_VARIABLE_InfoTable_0_10;
    else
      {
        ...
        {
          transform_hlds__rbmm__points_to_analysis__V_17_17 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), transform_hlds__rbmm__points_to_analysis__V_17_17, 0) = ((MR_Box) (&transform_hlds__rbmm__points_to_analysis_scalar_common_5[2]));
          MR_hl_field(MR_mktag(0), transform_hlds__rbmm__points_to_analysis__V_17_17, 1) = ((MR_Box) (transform_hlds__rbmm__points_to_analysis__run_with_dependency_4_p_0_1));
          MR_hl_field(MR_mktag(0), transform_hlds__rbmm__points_to_analysis__V_17_17, 2) = ((MR_Box) (MR_Word) ((MR_Integer) 1));
          MR_hl_field(MR_mktag(0), transform_hlds__rbmm__points_to_analysis__V_17_17, 3) = ((MR_Box) (transform_hlds__rbmm__points_to_analysis__STATE_VARIABLE_InfoTable_0_10));
        }
        {
          transform_hlds__rbmm__points_to_analysis__FPTable_9 = transform_hlds__ctgc__fixpoint_table__init_fixpoint_table_2_f_0((MR_Word) &hlds__hlds_pred__hlds__hlds_pred__type_ctor_info_pred_proc_id_0, (MR_Word) &transform_hlds__rbmm__points_to_info__transform_hlds__rbmm__points_to_info__type_ctor_info_rpta_info_0, transform_hlds__rbmm__points_to_analysis__V_17_17, transform_hlds__rbmm__points_to_analysis__SCCProcs_8);
        }
        {
...
{
  {
    ...
    {
      transform_hlds__rbmm__points_to_analysis__V_36_36 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), transform_hlds__rbmm__points_to_analysis__V_36_36, 0) = ((MR_Box) (&transform_hlds__rbmm__points_to_analysis_scalar_common_3[1]));
      MR_hl_field(MR_mktag(0), transform_hlds__rbmm__points_to_analysis__V_36_36, 1) = ((MR_Box) (transform_hlds__rbmm__points_to_analysis__region_points_to_analysis_3_p_0_2));
      MR_hl_field(MR_mktag(0), transform_hlds__rbmm__points_to_analysis__V_36_36, 2) = ((MR_Box) (MR_Word) ((MR_Integer) 1));
      MR_hl_field(MR_mktag(0), transform_hlds__rbmm__points_to_analysis__V_36_36, 3) = ((MR_Box) (transform_hlds__rbmm__points_to_analysis__ModuleInfo_26));
    }
    {
      mercury__list__foldl_4_p_0((MR_Word) &transform_hlds__rbmm__points_to_analysis_scalar_common_2[1], (MR_Word) &transform_hlds__rbmm__points_to_analysis_scalar_common_1[0], transform_hlds__rbmm__points_to_analysis__V_36_36, transform_hlds__rbmm__points_to_analysis__BottomUpSCCs_28, ((MR_Box) (transform_hlds__rbmm__points_to_analysis__InfoTable1_7)), &transform_hlds__rbmm__points_to_analysis__conv3_InfoTable_4);
    }
