              ...
              case (MR_Integer) 0:
                {
                  ...
                  transform_hlds__rbmm__points_to_analysis__apply_rules_6_p_0(FormalNodes_49, CallSite_38, (MR_Word) ((MR_Integer) 0), CalleeRptaInfo_36, CallerRptaInfo1_48, &HeadVar__8_8);
                }
                break;
              case (MR_Integer) 1:
                HeadVar__8_8 = HeadVar__7_7;
...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(1), Sel_15, 1) = ((MR_Box) ((MR_Integer) 0));
    }
  ...
  MR_Word * STATE_VARIABLE_Graph_13)
{
  while (MR_TRUE)
  {
    ...
    if ((Nodes_7 == (MR_Word) ((MR_Integer) 0)))
    {
      {
  ...
  MR_Word * STATE_VARIABLE_Graph_12)
{
  while (MR_TRUE)
  {
    ...
    if ((OutEdgesOfUnifiedNode_7 == (MR_Word) ((MR_Integer) 0)))
