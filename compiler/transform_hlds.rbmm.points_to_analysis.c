...
#line 28 "transform_hlds.rbmm.points_to_analysis.c"
#line 536 "../library/io.int"
#include "time.mh"

#line 32 "transform_hlds.rbmm.points_to_analysis.c"
#line 537 "../library/io.int"
#include "string.mh"

#line 36 "transform_hlds.rbmm.points_to_analysis.c"
#line 31 "../library/bitmap.int2"
#include "bitmap.mh"

#line 40 "transform_hlds.rbmm.points_to_analysis.c"
#line 33 "../library/array.int2"
#include "array.mh"

#line 44 "transform_hlds.rbmm.points_to_analysis.c"
#line 39 "../mdbcomp/mdbcomp.rtti_access.int2"
#include "mdbcomp.rtti_access.mh"

#line 48 "transform_hlds.rbmm.points_to_analysis.c"
#line 49 "transform_hlds.rbmm.points_to_analysis.c"
#include "transform_hlds.rbmm.points_to_analysis.mh"

#line 52 "transform_hlds.rbmm.points_to_analysis.c"
#line 53 "transform_hlds.rbmm.points_to_analysis.c"
...
#line 58 "transform_hlds.rbmm.points_to_analysis.c"
...
MR_decl_label10(transform_hlds__rbmm__points_to_analysis__apply_rules_6_0, 21,3,4,5,6,7,8,9,10,11)
MR_decl_label10(transform_hlds__rbmm__points_to_analysis__apply_rules_outedges_6_0, 89,3,4,5,7,9,11,13,15,16)
MR_decl_label10(transform_hlds__rbmm__points_to_analysis__apply_rules_outedges_6_0, 6,17,18,19,22,24,26,51,25,29)
MR_decl_label7(transform_hlds__rbmm__points_to_analysis__apply_rules_outedges_6_0, 30,33,35,31,41,42,43)
MR_decl_label10(transform_hlds__rbmm__points_to_analysis__inter_analyse_goal_expr_8_0, 3,6,10,11,9,13,17,20,21,22)
MR_decl_label10(transform_hlds__rbmm__points_to_analysis__inter_analyse_goal_expr_8_0, 23,24,25,27,28,19,15,29,31,34)
MR_decl_label2(transform_hlds__rbmm__points_to_analysis__inter_analyse_goal_expr_8_0, 35,37)
MR_decl_label10(transform_hlds__rbmm__points_to_analysis__inter_analyse_proc_5_0, 3,2,7,6,9,10,13,14,15,16)
MR_decl_label1(transform_hlds__rbmm__points_to_analysis__inter_analyse_proc_5_0, 17)
MR_decl_label10(transform_hlds__rbmm__points_to_analysis__intra_analyse_goal_expr_3_0, 3,4,7,10,12,13,11,15,17,18)
MR_decl_label2(transform_hlds__rbmm__points_to_analysis__intra_analyse_goal_expr_3_0, 20,23)
MR_decl_label10(transform_hlds__rbmm__points_to_analysis__intra_analyse_unification_3_0, 4,5,6,7,8,3,12,13,15,17)
MR_decl_label4(transform_hlds__rbmm__points_to_analysis__intra_analyse_unification_3_0, 11,21,19,23)
...
MR_decl_label6(transform_hlds__rbmm__points_to_analysis__merge_nodes_reached_by_same_labelled_edge_5_0, 32,3,4,6,9,5)
...
MR_decl_label8(transform_hlds__rbmm__points_to_analysis__region_points_to_analysis_3_0, 2,3,5,6,7,10,12,9)
...
MR_decl_label10(transform_hlds__rbmm__points_to_analysis__rule_7_6_0, 2,3,6,18,4,9,10,12,13,14)
MR_decl_label10(transform_hlds__rbmm__points_to_analysis__rule_8_6_0, 2,3,6,4,9,10,8,12,13,14)
MR_decl_label10(transform_hlds__rbmm__points_to_analysis__rule_8_6_0, 15,16,17,18,20,21,22,23,24,25)
MR_decl_label3(transform_hlds__rbmm__points_to_analysis__run_with_dependency_4_0, 4,2,7)
MR_decl_label5(transform_hlds__rbmm__points_to_analysis__run_with_dependency_until_fixpoint_5_0, 19,3,5,4,9)
...
MR_decl_static(transform_hlds__rbmm__points_to_analysis__IntroducedFrom__pred__rpta_fixpoint_table_new_rpta_info__1045__1_2_0)
...
{
MR_COMMON(7,0),
MR_ENTRY_AP(transform_hlds__rbmm__points_to_analysis__IntroducedFrom__pred__rpta_fixpoint_table_new_rpta_info__1045__1_2_0),
0
},
};
...
"transform_hlds.rbmm.points_to_analysis",
"transform_hlds.rbmm.points_to_analysis",
"lambda_rbmm_points_to_analysis_m_1045",
2,
0
},
"transform_hlds.rbmm.points_to_analysis",
...
MR_BEGIN_MODULE(transform_hlds__rbmm__points_to_analysis_module0)
	...
	MR_init_label8(transform_hlds__rbmm__points_to_analysis__region_points_to_analysis_3_0,2,3,5,6,7,10,12,9)
MR_BEGIN_CODE
...
MR_def_label(transform_hlds__rbmm__points_to_analysis__region_points_to_analysis_3_0,7)
	...
	if (MR_LTAGS_TEST(MR_r1,0,0)) {
		MR_GOTO_LAB(transform_hlds__rbmm__points_to_analysis__region_points_to_analysis_3_0_i9);
	}
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
...
MR_def_label(transform_hlds__rbmm__points_to_analysis__region_points_to_analysis_3_0,10)
	...
	MR_np_call_localret_ent(list__foldl_4_0,
		transform_hlds__rbmm__points_to_analysis__region_points_to_analysis_3_0_i12);
MR_def_label(transform_hlds__rbmm__points_to_analysis__region_points_to_analysis_3_0,12)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_sv(2);
	MR_decr_sp_and_return(4);
MR_def_label(transform_hlds__rbmm__points_to_analysis__region_points_to_analysis_3_0,9)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_string_const("transform_hlds.rbmm.points_to_analysis", 38);
	MR_r2 = (MR_Word) MR_string_const("predicate \140transform_hlds.rbmm.points_to_analysis.inter_proc_rpta\'/3", 68);
...
MR_BEGIN_MODULE(transform_hlds__rbmm__points_to_analysis_module4)
	...
	MR_init_label10(transform_hlds__rbmm__points_to_analysis__intra_analyse_unification_3_0,4,5,6,7,8,3,12,13,15,17)
	MR_init_label4(transform_hlds__rbmm__points_to_analysis__intra_analyse_unification_3_0,11,21,19,23)
MR_BEGIN_CODE
...
MR_def_static(transform_hlds__rbmm__points_to_analysis__intra_analyse_unification_3_0)
	...
	if (MR_PTAG_TESTR(MR_r1,2)) {
		MR_GOTO_LAB(transform_hlds__rbmm__points_to_analysis__intra_analyse_unification_3_0_i3);
	}
	MR_incr_sp(7);
	MR_sv(7) = (MR_Word) MR_succip;
	MR_sv(3) = MR_r2;
...
MR_def_label(transform_hlds__rbmm__points_to_analysis__intra_analyse_unification_3_0,8)
	...
	MR_r1 = MR_r2;
	MR_decr_sp_and_return(7);
MR_def_label(transform_hlds__rbmm__points_to_analysis__intra_analyse_unification_3_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_def_label(transform_hlds__rbmm__points_to_analysis__intra_analyse_unification_3_0,12)
	...
	MR_np_call_localret_ent(fn__transform_hlds__rbmm__points_to_graph__rptg_get_node_content_2_0,
		transform_hlds__rbmm__points_to_analysis__intra_analyse_unification_3_0_i13);
MR_def_label(transform_hlds__rbmm__points_to_analysis__intra_analyse_unification_3_0,13)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_def_label(transform_hlds__rbmm__points_to_analysis__intra_analyse_unification_3_0,11)
	...
	if (MR_PTAG_TESTR(MR_r1,1)) {
		MR_GOTO_LAB(transform_hlds__rbmm__points_to_analysis__intra_analyse_unification_3_0_i19);
	}
	MR_incr_sp(7);
	MR_sv(7) = (MR_Word) MR_succip;
	{
	...
	MR_np_call_localret_ent(list__foldl2_6_0,
		transform_hlds__rbmm__points_to_analysis__intra_analyse_unification_3_0_i21);
MR_def_label(transform_hlds__rbmm__points_to_analysis__intra_analyse_unification_3_0,21)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_tag_alloc_heap(MR_r1, 0, (MR_Integer) 2);
	MR_tfield(0, MR_r1, 0) = MR_r2;
...
MR_def_label(transform_hlds__rbmm__points_to_analysis__intra_analyse_unification_3_0,19)
	...
	if (MR_RTAGS_TESTR(MR_r1,3,0)) {
		MR_GOTO_LAB(transform_hlds__rbmm__points_to_analysis__intra_analyse_unification_3_0_i23);
	}
	MR_r1 = MR_r2;
	MR_proceed();
MR_def_label(transform_hlds__rbmm__points_to_analysis__intra_analyse_unification_3_0,23)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_string_const("transform_hlds.rbmm.points_to_analysis", 38);
	MR_r2 = (MR_Word) MR_string_const("predicate \140transform_hlds.rbmm.points_to_analysis.intra_analyse_unification\'/3", 78);
...
MR_BEGIN_MODULE(transform_hlds__rbmm__points_to_analysis_module6)
	...
	MR_init_label10(transform_hlds__rbmm__points_to_analysis__intra_analyse_goal_expr_3_0,3,4,7,10,12,13,11,15,17,18)
	MR_init_label2(transform_hlds__rbmm__points_to_analysis__intra_analyse_goal_expr_3_0,20,23)
MR_BEGIN_CODE
...
MR_def_static(transform_hlds__rbmm__points_to_analysis__intra_analyse_goal_expr_3_0)
	...
	if (MR_RTAGS_TESTR(MR_r1,3,1)) {
		MR_GOTO_LAB(transform_hlds__rbmm__points_to_analysis__intra_analyse_goal_expr_3_0_i3);
	}
	MR_r1 = MR_r2;
	MR_proceed();
MR_def_label(transform_hlds__rbmm__points_to_analysis__intra_analyse_goal_expr_3_0,3)
	...
	if (MR_RTAGS_TESTR(MR_r1,3,2)) {
		MR_GOTO_LAB(transform_hlds__rbmm__points_to_analysis__intra_analyse_goal_expr_3_0_i4);
	}
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tempr1 = MR_r1;
...
MR_def_label(transform_hlds__rbmm__points_to_analysis__intra_analyse_goal_expr_3_0,4)
	...
	if (MR_RTAGS_TESTR(MR_r1,3,3)) {
		MR_GOTO_LAB(transform_hlds__rbmm__points_to_analysis__intra_analyse_goal_expr_3_0_i7);
	}
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tempr1 = MR_r1;
...
MR_def_label(transform_hlds__rbmm__points_to_analysis__intra_analyse_goal_expr_3_0,7)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_RTAGS_TESTR(MR_r1,3,0)) {
		MR_GOTO_LAB(transform_hlds__rbmm__points_to_analysis__intra_analyse_goal_expr_3_0_i10);
	}
	MR_r1 = MR_r2;
	MR_proceed();
MR_def_label(transform_hlds__rbmm__points_to_analysis__intra_analyse_goal_expr_3_0,10)
	...
	if (MR_RTAGS_TESTR(MR_r1,3,6)) {
		MR_GOTO_LAB(transform_hlds__rbmm__points_to_analysis__intra_analyse_goal_expr_3_0_i11);
	}
	MR_incr_sp(3);
	MR_sv(3) = (MR_Word) MR_succip;
...
MR_def_label(transform_hlds__rbmm__points_to_analysis__intra_analyse_goal_expr_3_0,11)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_r1,0)) {
		MR_GOTO_LAB(transform_hlds__rbmm__points_to_analysis__intra_analyse_goal_expr_3_0_i15);
	}
...
MR_def_label(transform_hlds__rbmm__points_to_analysis__intra_analyse_goal_expr_3_0,15)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_r1,2)) {
		MR_GOTO_LAB(transform_hlds__rbmm__points_to_analysis__intra_analyse_goal_expr_3_0_i17);
	}
	MR_r1 = MR_r2;
	MR_proceed();
MR_def_label(transform_hlds__rbmm__points_to_analysis__intra_analyse_goal_expr_3_0,17)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_RTAGS_TESTR(MR_r1,3,5)) {
		MR_GOTO_LAB(transform_hlds__rbmm__points_to_analysis__intra_analyse_goal_expr_3_0_i18);
	}
	MR_r1 = MR_tfield(3, MR_r1, 2);
	MR_np_tailcall_ent(transform_hlds__rbmm__points_to_analysis__intra_analyse_goal_3_0);
MR_def_label(transform_hlds__rbmm__points_to_analysis__intra_analyse_goal_expr_3_0,18)
	...
	if (MR_RTAGS_TESTR(MR_r1,3,4)) {
		MR_GOTO_LAB(transform_hlds__rbmm__points_to_analysis__intra_analyse_goal_expr_3_0_i20);
	}
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tempr1 = MR_r1;
...
MR_def_label(transform_hlds__rbmm__points_to_analysis__intra_analyse_goal_expr_3_0,20)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_r1,1)) {
		MR_GOTO_LAB(transform_hlds__rbmm__points_to_analysis__intra_analyse_goal_expr_3_0_i23);
	}
...
MR_def_label(transform_hlds__rbmm__points_to_analysis__intra_analyse_goal_expr_3_0,23)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_string_const("transform_hlds.rbmm.points_to_analysis", 38);
	MR_r2 = (MR_Word) MR_string_const("predicate \140transform_hlds.rbmm.points_to_analysis.intra_analyse_goal_expr\'/3", 76);
...
MR_BEGIN_MODULE(transform_hlds__rbmm__points_to_analysis_module9)
	...
	MR_init_label6(transform_hlds__rbmm__points_to_analysis__merge_nodes_reached_by_same_labelled_edge_5_0,32,3,4,6,9,5)
MR_BEGIN_CODE
...
MR_def_label(transform_hlds__rbmm__points_to_analysis__merge_nodes_reached_by_same_labelled_edge_5_0,32)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r3,0,0)) {
...
MR_def_label(transform_hlds__rbmm__points_to_analysis__merge_nodes_reached_by_same_labelled_edge_5_0,5)
	...
	MR_r4 = MR_sv(3);
	MR_succip_word = MR_sv(6);
	MR_GOTO_LAB(transform_hlds__rbmm__points_to_analysis__merge_nodes_reached_by_same_labelled_edge_5_0_i32);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_thread_engine_base
#endif
...
MR_def_label(transform_hlds__rbmm__points_to_analysis__rule_3_3_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_string_const("transform_hlds.rbmm.points_to_analysis", 38);
	MR_r2 = (MR_Word) MR_string_const("predicate \140transform_hlds.rbmm.points_to_analysis.rule_3\'/3", 59);
	MR_r3 = (MR_Word) MR_string_const("impossible having no node in graph", 34);
	MR_succip_word = MR_sv(4);
	MR_decr_sp(4);
	MR_np_tailcall_ent(require__unexpected_3_0);
...
MR_BEGIN_MODULE(transform_hlds__rbmm__points_to_analysis_module13)
	...
	MR_init_label5(transform_hlds__rbmm__points_to_analysis__run_with_dependency_until_fixpoint_5_0,19,3,5,4,9)
MR_BEGIN_CODE
...
MR_def_static(transform_hlds__rbmm__points_to_analysis__run_with_dependency_until_fixpoint_5_0)
	...
	MR_incr_sp(6);
	MR_sv(6) = (MR_Word) MR_succip;
MR_def_label(transform_hlds__rbmm__points_to_analysis__run_with_dependency_until_fixpoint_5_0,19)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	...
	MR_np_call_localret_ent(list__foldl_4_0,
		transform_hlds__rbmm__points_to_analysis__run_with_dependency_until_fixpoint_5_0_i3);
MR_def_label(transform_hlds__rbmm__points_to_analysis__run_with_dependency_until_fixpoint_5_0,3)
	...
	MR_np_call_localret_ent(transform_hlds__ctgc__fixpoint_table__fixpoint_reached_1_0,
		transform_hlds__rbmm__points_to_analysis__run_with_dependency_until_fixpoint_5_0_i5);
MR_def_label(transform_hlds__rbmm__points_to_analysis__run_with_dependency_until_fixpoint_5_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(transform_hlds__rbmm__points_to_analysis__run_with_dependency_until_fixpoint_5_0_i4);
	}
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 0, (MR_Integer) 4);
...
MR_def_label(transform_hlds__rbmm__points_to_analysis__run_with_dependency_until_fixpoint_5_0,4)
	...
	MR_np_call_localret_ent(transform_hlds__ctgc__fixpoint_table__new_run_2_0,
		transform_hlds__rbmm__points_to_analysis__run_with_dependency_until_fixpoint_5_0_i9);
MR_def_label(transform_hlds__rbmm__points_to_analysis__run_with_dependency_until_fixpoint_5_0,9)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
	...
	MR_r4 = MR_sv(4);
	MR_succip_word = MR_sv(6);
	MR_GOTO_LAB(transform_hlds__rbmm__points_to_analysis__run_with_dependency_until_fixpoint_5_0_i19);
	}
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_thread_engine_base
...
MR_def_label(transform_hlds__rbmm__points_to_analysis__alpha_mapping_at_call_site_7_0,8)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_string_const("transform_hlds.rbmm.points_to_analysis", 38);
	MR_r2 = (MR_Word) MR_string_const("predicate \140transform_hlds.rbmm.points_to_analysis.alpha_mapping_at_call_site\'/7", 79);
...
MR_BEGIN_MODULE(transform_hlds__rbmm__points_to_analysis_module17)
	...
	MR_init_label10(transform_hlds__rbmm__points_to_analysis__rule_7_6_0,2,3,6,18,4,9,10,12,13,14)
MR_BEGIN_CODE
...
MR_def_label(transform_hlds__rbmm__points_to_analysis__rule_7_6_0,18)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(6);
	MR_decr_sp_and_return(8);
...
MR_def_label(transform_hlds__rbmm__points_to_analysis__rule_7_6_0,10)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(transform_hlds__rbmm__points_to_analysis__rule_7_6_0_i18);
	}
	MR_r1 = MR_sv(7);
	MR_np_call_localret_ent(transform_hlds__rbmm__points_to_graph__rptg_get_node_by_node_3_0,
...
MR_BEGIN_MODULE(transform_hlds__rbmm__points_to_analysis_module18)
	...
	MR_init_label10(transform_hlds__rbmm__points_to_analysis__rule_8_6_0,2,3,6,4,9,10,8,12,13,14)
	MR_init_label10(transform_hlds__rbmm__points_to_analysis__rule_8_6_0,15,16,17,18,20,21,22,23,24,25)
MR_BEGIN_CODE
...
MR_def_label(transform_hlds__rbmm__points_to_analysis__rule_8_6_0,23)
	...
	MR_np_call_localret_ent(map__set_4_0,
		transform_hlds__rbmm__points_to_analysis__rule_8_6_0_i24);
MR_def_label(transform_hlds__rbmm__points_to_analysis__rule_8_6_0,24)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_sv(11);
...
MR_BEGIN_MODULE(transform_hlds__rbmm__points_to_analysis_module19)
	...
	MR_init_label10(transform_hlds__rbmm__points_to_analysis__apply_rules_outedges_6_0,89,3,4,5,7,9,11,13,15,16)
	MR_init_label10(transform_hlds__rbmm__points_to_analysis__apply_rules_outedges_6_0,6,17,18,19,22,24,26,51,25,29)
	MR_init_label7(transform_hlds__rbmm__points_to_analysis__apply_rules_outedges_6_0,30,33,35,31,41,42,43)
MR_BEGIN_CODE
...
MR_def_label(transform_hlds__rbmm__points_to_analysis__apply_rules_outedges_6_0,89)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
...
MR_def_label(transform_hlds__rbmm__points_to_analysis__apply_rules_outedges_6_0,7)
	...
	MR_r4 = MR_sv(2);
	MR_np_call_localret_ent(map__search_3_0,
		transform_hlds__rbmm__points_to_analysis__apply_rules_outedges_6_0_i9);
MR_def_label(transform_hlds__rbmm__points_to_analysis__apply_rules_outedges_6_0,9)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(transform_hlds__rbmm__points_to_analysis__apply_rules_outedges_6_0_i6);
	}
	...
	MR_np_call_localret_ent(map__search_3_0,
		transform_hlds__rbmm__points_to_analysis__apply_rules_outedges_6_0_i11);
MR_def_label(transform_hlds__rbmm__points_to_analysis__apply_rules_outedges_6_0,11)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(transform_hlds__rbmm__points_to_analysis__apply_rules_outedges_6_0_i6);
	}
	MR_r1 = MR_sv(8);
	MR_np_call_localret_ent(transform_hlds__rbmm__points_to_graph__rptg_get_node_by_node_3_0,
		transform_hlds__rbmm__points_to_analysis__apply_rules_outedges_6_0_i13);
MR_def_label(transform_hlds__rbmm__points_to_analysis__apply_rules_outedges_6_0,13)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if ((MR_sv(7) == MR_r1)) {
		MR_GOTO_LAB(transform_hlds__rbmm__points_to_analysis__apply_rules_outedges_6_0_i6);
	}
	...
	MR_r3 = MR_sv(8);
	MR_np_call_localret_ent(transform_hlds__rbmm__points_to_graph__unify_operator_4_0,
		transform_hlds__rbmm__points_to_analysis__apply_rules_outedges_6_0_i15);
MR_def_label(transform_hlds__rbmm__points_to_analysis__apply_rules_outedges_6_0,15)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
...
MR_def_label(transform_hlds__rbmm__points_to_analysis__apply_rules_outedges_6_0,16)
	...
	MR_GOTO_LAB(transform_hlds__rbmm__points_to_analysis__apply_rules_outedges_6_0_i17);
...
MR_def_label(transform_hlds__rbmm__points_to_analysis__apply_rules_outedges_6_0,17)
	...
	MR_sv(6) = MR_r1;
	MR_np_call_localret_ent(transform_hlds__rbmm__points_to_graph__rptg_get_edge_contents_5_0,
		transform_hlds__rbmm__points_to_analysis__apply_rules_outedges_6_0_i18);
...
MR_def_label(transform_hlds__rbmm__points_to_analysis__apply_rules_outedges_6_0,19)
	...
	MR_r3 = MR_sv(10);
	MR_np_call_localret_ent(transform_hlds__rbmm__points_to_graph__rptg_find_edge_from_node_with_same_content_4_0,
		transform_hlds__rbmm__points_to_analysis__apply_rules_outedges_6_0_i22);
MR_def_label(transform_hlds__rbmm__points_to_analysis__apply_rules_outedges_6_0,22)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(transform_hlds__rbmm__points_to_analysis__apply_rules_outedges_6_0_i51);
	}
	MR_sv(8) = MR_r2;
	...
	MR_r4 = MR_sv(2);
	MR_np_call_localret_ent(map__lookup_3_0,
		transform_hlds__rbmm__points_to_analysis__apply_rules_outedges_6_0_i24);
MR_def_label(transform_hlds__rbmm__points_to_analysis__apply_rules_outedges_6_0,24)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(9) = MR_r1;
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(transform_hlds__rbmm__points_to_graph, rptg_node);
	MR_r2 = MR_r1;
...
MR_def_label(transform_hlds__rbmm__points_to_analysis__apply_rules_outedges_6_0,26)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(transform_hlds__rbmm__points_to_analysis__apply_rules_outedges_6_0_i25);
	}
MR_def_label(transform_hlds__rbmm__points_to_analysis__apply_rules_outedges_6_0,51)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 0, (MR_Integer) 2);
	...
	MR_r3 = MR_sv(3);
	MR_r1 = MR_sv(4);
	MR_GOTO_LAB(transform_hlds__rbmm__points_to_analysis__apply_rules_outedges_6_0_i41);
	}
MR_def_label(transform_hlds__rbmm__points_to_analysis__apply_rules_outedges_6_0,25)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(transform_hlds__rbmm__points_to_graph, rptg_node);
	MR_r2 = MR_r1;
	MR_r3 = MR_sv(7);
...
MR_def_label(transform_hlds__rbmm__points_to_analysis__apply_rules_outedges_6_0,29)
	...
	MR_np_call_localret_ent(map__set_4_0,
		transform_hlds__rbmm__points_to_analysis__apply_rules_outedges_6_0_i30);
MR_def_label(transform_hlds__rbmm__points_to_analysis__apply_rules_outedges_6_0,30)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_sv(6);
...
MR_def_label(transform_hlds__rbmm__points_to_analysis__apply_rules_outedges_6_0,33)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(transform_hlds__rbmm__points_to_analysis__apply_rules_outedges_6_0_i31);
	}
	MR_r1 = MR_sv(8);
	MR_r2 = (MR_Integer) 1;
	MR_r3 = MR_sv(10);
	MR_np_call_localret_ent(transform_hlds__rbmm__points_to_graph__rptg_set_node_is_allocated_4_0,
		transform_hlds__rbmm__points_to_analysis__apply_rules_outedges_6_0_i35);
MR_def_label(transform_hlds__rbmm__points_to_analysis__apply_rules_outedges_6_0,35)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 0, (MR_Integer) 2);
...
MR_def_label(transform_hlds__rbmm__points_to_analysis__apply_rules_outedges_6_0,31)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(6);
	{
	MR_Word MR_tempr1;
...
MR_def_label(transform_hlds__rbmm__points_to_analysis__apply_rules_outedges_6_0,41)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(1) = MR_r4;
	MR_sv(2) = MR_r2;
	MR_sv(3) = MR_r3;
	...
	MR_np_call_localret_ent(transform_hlds__rbmm__points_to_analysis__rule_7_6_0,
		transform_hlds__rbmm__points_to_analysis__apply_rules_outedges_6_0_i42);
MR_def_label(transform_hlds__rbmm__points_to_analysis__apply_rules_outedges_6_0,42)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
	...
	MR_np_call_localret_ent(transform_hlds__rbmm__points_to_analysis__rule_8_6_0,
		transform_hlds__rbmm__points_to_analysis__apply_rules_outedges_6_0_i43);
MR_def_label(transform_hlds__rbmm__points_to_analysis__apply_rules_outedges_6_0,43)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
	...
	MR_GOTO_LAB(transform_hlds__rbmm__points_to_analysis__apply_rules_outedges_6_0_i89);
	}
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_thread_engine_base
...
MR_BEGIN_MODULE(transform_hlds__rbmm__points_to_analysis_module20)
	...
	MR_init_label10(transform_hlds__rbmm__points_to_analysis__apply_rules_6_0,21,3,4,5,6,7,8,9,10,11)
MR_BEGIN_CODE
...
MR_def_label(transform_hlds__rbmm__points_to_analysis__apply_rules_6_0,21)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
...
MR_def_label(transform_hlds__rbmm__points_to_analysis__apply_rules_6_0,11)
	...
	MR_GOTO_LAB(transform_hlds__rbmm__points_to_analysis__apply_rules_6_0_i21);
	}
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_thread_engine_base
...
MR_BEGIN_MODULE(transform_hlds__rbmm__points_to_analysis_module22)
	...
	MR_init_label10(transform_hlds__rbmm__points_to_analysis__inter_analyse_goal_expr_8_0,3,6,10,11,9,13,17,20,21,22)
	MR_init_label10(transform_hlds__rbmm__points_to_analysis__inter_analyse_goal_expr_8_0,23,24,25,27,28,19,15,29,31,34)
	MR_init_label2(transform_hlds__rbmm__points_to_analysis__inter_analyse_goal_expr_8_0,35,37)
MR_BEGIN_CODE
...
MR_def_static(transform_hlds__rbmm__points_to_analysis__inter_analyse_goal_expr_8_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_RTAGS_TESTR(MR_r1,3,2)) {
		MR_GOTO_LAB(transform_hlds__rbmm__points_to_analysis__inter_analyse_goal_expr_8_0_i3);
	}
	{
	MR_Word MR_tempr1, MR_tempr2, MR_tempr3;
	MR_tag_alloc_heap(MR_tempr1, 0, (MR_Integer) 5);
...
MR_def_label(transform_hlds__rbmm__points_to_analysis__inter_analyse_goal_expr_8_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_RTAGS_TESTR(MR_r1,3,3)) {
		MR_GOTO_LAB(transform_hlds__rbmm__points_to_analysis__inter_analyse_goal_expr_8_0_i6);
	}
	{
	MR_Word MR_tempr1, MR_tempr2, MR_tempr3;
	MR_tag_alloc_heap(MR_tempr1, 0, (MR_Integer) 5);
...
MR_def_label(transform_hlds__rbmm__points_to_analysis__inter_analyse_goal_expr_8_0,6)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_RTAGS_TESTR(MR_r1,3,6)) {
		MR_GOTO_LAB(transform_hlds__rbmm__points_to_analysis__inter_analyse_goal_expr_8_0_i9);
	}
	MR_incr_sp(10);
...
MR_def_label(transform_hlds__rbmm__points_to_analysis__inter_analyse_goal_expr_8_0,9)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_r1,0)) {
		MR_GOTO_LAB(transform_hlds__rbmm__points_to_analysis__inter_analyse_goal_expr_8_0_i13);
	}
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
...
MR_def_label(transform_hlds__rbmm__points_to_analysis__inter_analyse_goal_expr_8_0,13)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_r1,2)) {
		MR_GOTO_LAB(transform_hlds__rbmm__points_to_analysis__inter_analyse_goal_expr_8_0_i15);
	}
	MR_incr_sp(10);
	MR_sv(10) = (MR_Word) MR_succip;
	{
	...
	MR_np_call_localret_ent(transform_hlds__rbmm__points_to_analysis__lookup_rpta_info_6_0,
		transform_hlds__rbmm__points_to_analysis__inter_analyse_goal_expr_8_0_i17);
MR_def_label(transform_hlds__rbmm__points_to_analysis__inter_analyse_goal_expr_8_0,17)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r3,0)) {
		MR_GOTO_LAB(transform_hlds__rbmm__points_to_analysis__inter_analyse_goal_expr_8_0_i19);
	}
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_sv(1);
	...
	MR_np_call_localret_ent(fn__transform_hlds__smm_common__program_point_init_1_0,
		transform_hlds__rbmm__points_to_analysis__inter_analyse_goal_expr_8_0_i20);
MR_def_label(transform_hlds__rbmm__points_to_analysis__inter_analyse_goal_expr_8_0,20)
	...
	MR_np_call_localret_ent(hlds__hlds_module__module_info_proc_info_3_0,
		transform_hlds__rbmm__points_to_analysis__inter_analyse_goal_expr_8_0_i21);
...
MR_def_label(transform_hlds__rbmm__points_to_analysis__inter_analyse_goal_expr_8_0,22)
	...
	MR_np_call_localret_ent(fn__map__init_0_0,
		transform_hlds__rbmm__points_to_analysis__inter_analyse_goal_expr_8_0_i23);
MR_def_label(transform_hlds__rbmm__points_to_analysis__inter_analyse_goal_expr_8_0,23)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
	...
	MR_np_call_localret_ent(transform_hlds__rbmm__points_to_analysis__alpha_mapping_at_call_site_7_0,
		transform_hlds__rbmm__points_to_analysis__inter_analyse_goal_expr_8_0_i24);
...
MR_def_label(transform_hlds__rbmm__points_to_analysis__inter_analyse_goal_expr_8_0,25)
	...
	MR_np_call_localret_ent(map__keys_2_0,
		transform_hlds__rbmm__points_to_analysis__inter_analyse_goal_expr_8_0_i27);
...
MR_def_label(transform_hlds__rbmm__points_to_analysis__inter_analyse_goal_expr_8_0,15)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_RTAGS_TESTR(MR_r1,3,5)) {
		MR_GOTO_LAB(transform_hlds__rbmm__points_to_analysis__inter_analyse_goal_expr_8_0_i29);
	}
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
...
MR_def_label(transform_hlds__rbmm__points_to_analysis__inter_analyse_goal_expr_8_0,29)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_RTAGS_TESTR(MR_r1,3,4)) {
		MR_GOTO_LAB(transform_hlds__rbmm__points_to_analysis__inter_analyse_goal_expr_8_0_i31);
	}
	{
	MR_Word MR_tempr1, MR_tempr2, MR_tempr3;
	MR_tag_alloc_heap(MR_tempr1, 0, (MR_Integer) 5);
...
MR_def_label(transform_hlds__rbmm__points_to_analysis__inter_analyse_goal_expr_8_0,31)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_r1,1)) {
		MR_GOTO_LAB(transform_hlds__rbmm__points_to_analysis__inter_analyse_goal_expr_8_0_i34);
	}
	MR_r1 = MR_r5;
	MR_r2 = MR_r6;
	MR_proceed();
MR_def_label(transform_hlds__rbmm__points_to_analysis__inter_analyse_goal_expr_8_0,34)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_RTAGS_TESTR(MR_r1,3,1)) {
		MR_GOTO_LAB(transform_hlds__rbmm__points_to_analysis__inter_analyse_goal_expr_8_0_i35);
	}
	MR_r1 = (MR_Word) MR_string_const("transform_hlds.rbmm.points_to_analysis", 38);
	MR_r2 = (MR_Word) MR_string_const("predicate \140transform_hlds.rbmm.points_to_analysis.inter_analyse_goal_expr\'/8", 76);
	MR_r3 = (MR_Word) MR_string_const("foreign code", 12);
...
MR_def_label(transform_hlds__rbmm__points_to_analysis__inter_analyse_goal_expr_8_0,35)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_RTAGS_TESTR(MR_r1,3,0)) {
		MR_GOTO_LAB(transform_hlds__rbmm__points_to_analysis__inter_analyse_goal_expr_8_0_i37);
	}
	MR_r1 = (MR_Word) MR_string_const("transform_hlds.rbmm.points_to_analysis", 38);
	MR_r2 = (MR_Word) MR_string_const("predicate \140transform_hlds.rbmm.points_to_analysis.inter_analyse_goal_expr\'/8", 76);
	MR_r3 = (MR_Word) MR_string_const("generic_call not handled", 24);
	MR_np_tailcall_ent(require__sorry_3_0);
...
MR_BEGIN_MODULE(transform_hlds__rbmm__points_to_analysis_module23)
	...
	MR_init_label10(transform_hlds__rbmm__points_to_analysis__inter_analyse_proc_5_0,3,2,7,6,9,10,13,14,15,16)
	MR_init_label1(transform_hlds__rbmm__points_to_analysis__inter_analyse_proc_5_0,17)
MR_BEGIN_CODE
...
MR_def_label(transform_hlds__rbmm__points_to_analysis__inter_analyse_proc_5_0,3)
	...
	MR_r2 = MR_sv(3);
	MR_sv(5) = MR_r3;
	MR_GOTO_LAB(transform_hlds__rbmm__points_to_analysis__inter_analyse_proc_5_0_i13);
...
MR_def_label(fn__transform_hlds__rbmm__points_to_analysis__wrapped_init_2_0,2)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_string_const("transform_hlds.rbmm.points_to_analysis", 38);
	MR_r2 = (MR_Word) MR_string_const("function \140transform_hlds.rbmm.points_to_analysis.wrapped_init\'/2", 64);
...
MR_BEGIN_MODULE(transform_hlds__rbmm__points_to_analysis_module29)
	MR_init_entry1(transform_hlds__rbmm__points_to_analysis__IntroducedFrom__pred__rpta_fixpoint_table_new_rpta_info__1045__1_2_0);
	MR_INIT_PROC_LAYOUT_ADDR(mercury__transform_hlds__rbmm__points_to_analysis__IntroducedFrom__pred__rpta_fixpoint_table_new_rpta_info__1045__1_2_0);
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'IntroducedFrom__pred__rpta_fixpoint_table_new_rpta_info__1045__1'/2 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(transform_hlds__rbmm__points_to_analysis__IntroducedFrom__pred__rpta_fixpoint_table_new_rpta_info__1045__1_2_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
...
void mercury__transform_hlds__rbmm__points_to_analysis__init_threadscope_string_table(void);
#endif
...
void mercury__transform_hlds__rbmm__points_to_analysis__write_out_proc_statics(FILE *deep_fp, FILE *procrep_fp)
{
	MR_write_out_module_proc_reps_start(procrep_fp, &mercury_data__module_layout__transform_hlds__rbmm__points_to_analysis);
