...
{
  {
    ...
    if (hlds__goal_util__succeeded)
    {
      ...
      hlds__goal_util__cases_calls_pred_id_2_p_1(hlds__goal_util__Cases_6, hlds__goal_util__PredId_7, hlds__goal_util__cont, hlds__goal_util__cont_env_ptr);
    }
  }
}
...
{
  {
    ...
    if (hlds__goal_util__succeeded)
    {
      ...
      hlds__goal_util__goals_calls_pred_id_2_p_1(hlds__goal_util__Goals_4, hlds__goal_util__PredId_5, hlds__goal_util__cont, hlds__goal_util__cont_env_ptr);
    }
  }
}
      ...
      case (MR_Integer) 0:
        {
          ...
          hlds__goal_util__goal_calls_pred_id_2_p_1(hlds__goal_util__SubGoal_18, hlds__goal_util__PredId_5, hlds__goal_util__cont, hlds__goal_util__cont_env_ptr);
        }
        break;
      case (MR_Integer) 2:
        {
          ...
          case (MR_Integer) 5:
            {
              ...
              if (hlds__goal_util__succeeded)
              {
                ...
                hlds__goal_util__goal_calls_pred_id_2_p_1(hlds__goal_util__SubGoal_45, hlds__goal_util__PredId_5, hlds__goal_util__cont, hlds__goal_util__cont_env_ptr);
            }
            break;
          case (MR_Integer) 6:
            {
              ...
              hlds__goal_util__goal_calls_pred_id_2_p_1(hlds__goal_util__Else_17, hlds__goal_util__PredId_5, hlds__goal_util__cont, hlds__goal_util__cont_env_ptr);
            }
            break;
        }
        break;
...
{
  {
    ...
    if (hlds__goal_util__succeeded)
    {
      ...
      hlds__goal_util__cases_calls_2_p_1(hlds__goal_util__Cases_6, hlds__goal_util__PredProcId_7, hlds__goal_util__cont, hlds__goal_util__cont_env_ptr);
    }
  }
}
...
{
  {
    ...
    if (hlds__goal_util__succeeded)
    {
      ...
      hlds__goal_util__goals_calls_2_p_1(hlds__goal_util__Goals_4, hlds__goal_util__PredProcId_5, hlds__goal_util__cont, hlds__goal_util__cont_env_ptr);
    }
  }
}
      ...
      case (MR_Integer) 0:
        {
          ...
          hlds__goal_util__goal_calls_2_p_1(hlds__goal_util__SubGoal_18, hlds__goal_util__PredProcId_5, hlds__goal_util__cont, hlds__goal_util__cont_env_ptr);
        }
        break;
      case (MR_Integer) 2:
        {
          ...
          case (MR_Integer) 5:
            {
              ...
              if (hlds__goal_util__succeeded)
              {
                ...
                hlds__goal_util__goal_calls_2_p_1(hlds__goal_util__SubGoal_46, hlds__goal_util__PredProcId_5, hlds__goal_util__cont, hlds__goal_util__cont_env_ptr);
            }
            break;
          case (MR_Integer) 6:
            {
              ...
              hlds__goal_util__goal_calls_2_p_1(hlds__goal_util__Else_17, hlds__goal_util__PredProcId_5, hlds__goal_util__cont, hlds__goal_util__cont_env_ptr);
            }
            break;
        }
        break;
