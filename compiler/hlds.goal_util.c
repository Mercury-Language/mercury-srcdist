            ...
            case (MR_Integer) 0:
              {
                ...
                if (succeeded)
                {
                  ...
                  Var_165 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_133, (MR_Integer) 0))));
                    ...
                    case (MR_Integer) 3:
                      {
                        ...
                        parse_tree__set_of_var__insert_3_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), Var_167, STATE_VARIABLE_Set_0_98, &STATE_VARIABLE_Set_124_124);
                      }
                      break;
                    case (MR_Integer) 4:
                      STATE_VARIABLE_Set_124_124 = STATE_VARIABLE_Set_0_98;
