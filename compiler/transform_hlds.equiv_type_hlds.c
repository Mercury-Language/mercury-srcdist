...
transform_hlds__equiv_type_hlds__replace_in_type_defn_7_p_0(
  ...
  MR_Word TypeEqvMap_9,
  MR_Word TypeCtor_10,
  MR_Word STATE_VARIABLE_Defn_0_57,
  MR_Word * STATE_VARIABLE_Defn_58,
  MR_Word STATE_VARIABLE_MaybeRecompInfo_0_59,
  MR_Word * STATE_VARIABLE_MaybeRecompInfo_60);
...
{
  {
    ...
    MR_Word Body_39;
    MR_Word ItemId_56;
    MR_Word STATE_VARIABLE_Defn_65_65;
    MR_Integer _TypeCtorArity_16;

    hlds__hlds_data__get_type_defn_tvarset_2_p_0(STATE_VARIABLE_Defn_0_57, &TVarSet0_13);
    hlds__hlds_data__get_type_defn_body_2_p_0(STATE_VARIABLE_Defn_0_57, &Body0_14);
    ...
    recompilation__maybe_start_recording_expanded_items_4_p_0(ModuleName_8, TypeCtorSymName_15, STATE_VARIABLE_MaybeRecompInfo_0_59, &EquivTypeInfo0_18);
      ...
      case (MR_Integer) 1:
        {
          ...
          else
          {
...

            {
              ...
              MR_hl_field(MR_mktag(0), Var_61, 0) = ((MR_Box) (&transform_hlds__equiv_type_hlds_scalar_common_7[0]));
              MR_hl_field(MR_mktag(0), Var_61, 1) = ((MR_Box) (transform_hlds__equiv_type_hlds__replace_in_type_defn_7_p_0_1));
              MR_hl_field(MR_mktag(0), Var_61, 2) = ((MR_Box) (MR_Word) ((MR_Integer) 1));
              MR_hl_field(MR_mktag(0), Var_61, 3) = ((MR_Box) (TypeEqvMap_9));
            }
            Var_62 = mercury__map__init_0_f_0((MR_Word) &mercury__builtin__builtin__type_ctor_info_string_0, (MR_Word) &transform_hlds__equiv_type_hlds_scalar_common_2[2]);
            TypeCtorInfo_77_77 = (MR_Word) &hlds__hlds_data__hlds__hlds_data__type_ctor_info_constructor_repn_0;
            mercury__list__map_foldl3_9_p_1(TypeCtorInfo_77_77, TypeCtorInfo_77_77, (MR_Word) &transform_hlds__equiv_type_hlds_scalar_common_1[2], (MR_Word) &transform_hlds__equiv_type_hlds_scalar_common_2[3], (MR_Word) &transform_hlds__equiv_type_hlds_scalar_common_2[4], Var_61, CtorRepns0_31, &CtorRepns_36, ((MR_Box) (Var_62)), &conv6_CtorNameToRepnMap_37, ((MR_Box) (TVarSet1_24)), &conv5_TVarSet_27, ((MR_Box) (EquivTypeInfo1_25)), &conv4_EquivTypeInfo_28);
            CtorNameToRepnMap_37 = ((MR_Word) conv6_CtorNameToRepnMap_37);
            TVarSet_27 = ((MR_Word) conv5_TVarSet_27);
            EquivTypeInfo_28 = ((MR_Word) conv4_EquivTypeInfo_28);
            {
              Repn_38 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 6 * sizeof(MR_Word)), NULL, NULL);
              MR_hl_field(MR_mktag(0), Repn_38, 0) = ((MR_Box) (ConsIdToTagMap_30));
              MR_hl_field(MR_mktag(0), Repn_38, 1) = ((MR_Box) (CtorRepns_36));
              MR_hl_field(MR_mktag(0), Repn_38, 2) = ((MR_Box) (CtorNameToRepnMap_37));
              MR_hl_field(MR_mktag(0), Repn_38, 3) = ((MR_Box) (CheaperTagTest_33));
              MR_hl_field(MR_mktag(0), Repn_38, 4) = ((MR_Box) (DuKind_34));
              MR_hl_field(MR_mktag(0), Repn_38, 5) = ((MR_Box) (DirectArgCtors_35));
            }
            {
              MaybeRepn_26 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), MaybeRepn_26, 0) = ((MR_Box) (Repn_38));
            }
          }
          {
            Body_39 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), Body_39, 0) = ((MR_Box) (Ctors_23));
            MR_hl_field(MR_mktag(1), Body_39, 1) = ((MR_Box) (MaybeCanonical_20));
            MR_hl_field(MR_mktag(1), Body_39, 2) = ((MR_Box) (MaybeRepn_26));
            MR_hl_field(MR_mktag(1), Body_39, 3) = ((MR_Box) (MaybeForeign_22));
          }
        }
        break;
      case (MR_Integer) 2:
        {
          MR_Word Type0_40 = ((MR_Word) (MR_hl_field(MR_mktag(2), Body0_14, (MR_Integer) 0)));
          MR_Word Type_41;
          MR_Word Var_42;

          parse_tree__equiv_type__replace_in_type_8_p_0(TypeEqvMap_9, Type0_40, &Type_41, &Var_42, TVarSet0_13, &TVarSet_27, EquivTypeInfo0_18, &EquivTypeInfo_28);
          {
            Body_39 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(2), Body_39, 0) = ((MR_Box) (Type_41));
          }
        }
        break;
      case (MR_Integer) 3:
        switch (((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), Body0_14, (MR_Integer) 0)))) {
          ...
          case (MR_Integer) 0:
            {
              MR_Word DetailsSolver0_44 = ((MR_Word) (MR_hl_field(MR_mktag(3), Body0_14, (MR_Integer) 1)));
              MR_Word SolverTypeDetails0_45 = ((MR_Word) (MR_hl_field(MR_mktag(0), DetailsSolver0_44, (MR_Integer) 0)));
              MR_Word UserEq_46 = ((MR_Word) (MR_hl_field(MR_mktag(0), DetailsSolver0_44, (MR_Integer) 1)));
              MR_Word RepnType0_47 = ((MR_Word) (MR_hl_field(MR_mktag(0), SolverTypeDetails0_45, (MR_Integer) 0)));
              MR_Word GroundInst_48 = ((MR_Word) (MR_hl_field(MR_mktag(0), SolverTypeDetails0_45, (MR_Integer) 1)));
              MR_Word AnyInst_49 = ((MR_Word) (MR_hl_field(MR_mktag(0), SolverTypeDetails0_45, (MR_Integer) 2)));
              MR_Word MutableItems_50 = ((MR_Word) (MR_hl_field(MR_mktag(0), SolverTypeDetails0_45, (MR_Integer) 3)));
              MR_Word RepnType_51;
              MR_Word SolverTypeDetails_53;
              MR_Word DetailsSolver_54;
              MR_Word Var_52;

              parse_tree__equiv_type__replace_in_type_8_p_0(TypeEqvMap_9, RepnType0_47, &RepnType_51, &Var_52, TVarSet0_13, &TVarSet_27, EquivTypeInfo0_18, &EquivTypeInfo_28);
              {
                SolverTypeDetails_53 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL);
                MR_hl_field(MR_mktag(0), SolverTypeDetails_53, 0) = ((MR_Box) (RepnType_51));
                MR_hl_field(MR_mktag(0), SolverTypeDetails_53, 1) = ((MR_Box) (GroundInst_48));
                MR_hl_field(MR_mktag(0), SolverTypeDetails_53, 2) = ((MR_Box) (AnyInst_49));
                MR_hl_field(MR_mktag(0), SolverTypeDetails_53, 3) = ((MR_Box) (MutableItems_50));
              }
              {
                DetailsSolver_54 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
                MR_hl_field(MR_mktag(0), DetailsSolver_54, 0) = ((MR_Box) (SolverTypeDetails_53));
                MR_hl_field(MR_mktag(0), DetailsSolver_54, 1) = ((MR_Box) (UserEq_46));
              }
              {
                Body_39 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(3), Body_39, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 0));
                MR_hl_field(MR_mktag(3), Body_39, 1) = ((MR_Box) (DetailsSolver_54));
              }
            }
            break;
          case (MR_Integer) 1:
    ...
    {
      ItemId_56 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), ItemId_56, 0) = ((MR_Box) ((MR_Integer) 1));
      MR_hl_field(MR_mktag(0), ItemId_56, 1) = ((MR_Box) (TypeCtorItem_17));
    }
    recompilation__finish_recording_expanded_items_4_p_0(ItemId_56, EquivTypeInfo_28, STATE_VARIABLE_MaybeRecompInfo_0_59, STATE_VARIABLE_MaybeRecompInfo_60);
    hlds__hlds_data__set_type_defn_body_3_p_0(Body_39, STATE_VARIABLE_Defn_0_57, &STATE_VARIABLE_Defn_65_65);
    hlds__hlds_data__set_type_defn_tvarset_3_p_0(TVarSet_27, STATE_VARIABLE_Defn_65_65, STATE_VARIABLE_Defn_58);
  }
}
  ...
  MR_Box * wrapper_arg_5)
{
  {
    MR_Box closure = closure_arg;
    MR_Word conv7_STATE_VARIABLE_Defn_58;
    MR_Word conv6_STATE_VARIABLE_MaybeRecompInfo_60;

    transform_hlds__equiv_type_hlds__replace_in_type_defn_7_p_0(((MR_Word) (MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3))), ((MR_Word) (MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4))), ((MR_Word) wrapper_arg_1), ((MR_Word) wrapper_arg_2), &conv7_STATE_VARIABLE_Defn_58, ((MR_Word) wrapper_arg_4), &conv6_STATE_VARIABLE_MaybeRecompInfo_60);
    *wrapper_arg_3 = ((MR_Box) (conv7_STATE_VARIABLE_Defn_58));
    *wrapper_arg_5 = ((MR_Box) (conv6_STATE_VARIABLE_MaybeRecompInfo_60));
  }
}
