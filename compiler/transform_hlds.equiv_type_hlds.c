...
{
  {
    ...
    mercury__list__foldl2_6_p_0(TypeCtorInfo_97_97, (MR_Word) &transform_hlds__equiv_type_hlds_scalar_common_1[2], TypeInfo_95_95, Var_58, AllTypes_26, ((MR_Box) (Var_59)), &conv6_TypeMap_30, ((MR_Box) (STATE_VARIABLE_TVarSet_56_56)), &conv5_STATE_VARIABLE_TVarSet_60_60);
      ...
      case (MR_Integer) 1:
        {
          ...
          else
          {
            ...
            {
              *Changed_10 = (MR_Integer) 1;
              *GoalExpr_9 = (MR_Word) MR_mkword(MR_mktag(3), &transform_hlds__equiv_type_hlds_scalar_common_1[11]);
              {
                MR_Word base;
                base = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 6 * sizeof(MR_Word)), NULL, NULL);
                *STATE_VARIABLE_Info_132 = base;
...
{
  {
    ...
    if (succeeded)
    {
      ...
      mercury__list__foldl_4_p_0((MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0, (MR_Word) &transform_hlds__equiv_type_hlds_scalar_common_2[0], (MR_Word) &transform_hlds__equiv_type_hlds_scalar_common_1[10], Args_7, ((MR_Box) (STATE_VARIABLE_Set_10_10)), &conv1_STATE_VARIABLE_Set_9);
...
{
  {
    ...
    hlds__hlds_data__foldl2_over_type_ctor_defns_6_p_0((MR_Word) &transform_hlds__equiv_type_hlds_scalar_common_1[0], (MR_Word) &transform_hlds__equiv_type_hlds_scalar_common_2[0], (MR_Word) &transform_hlds__equiv_type_hlds_scalar_common_1[8], TypeTable0_4, ((MR_Box) (Var_23)), &conv3_TypeEqvMap_5, ((MR_Box) (Var_24)), &conv2_EqvExportTypes_6);
    TypeEqvMap_5 = ((MR_Word) conv3_TypeEqvMap_5);
    EqvExportTypes_6 = ((MR_Word) conv2_EqvExportTypes_6);
    mercury__set__fold_4_p_0(TypeCtorInfo_39_39, (MR_Word) &hlds__hlds_data__hlds__hlds_data__type_ctor_info_type_table_0, (MR_Word) &transform_hlds__equiv_type_hlds_scalar_common_1[9], EqvExportTypes_6, ((MR_Box) (TypeTable0_4)), &conv5_TypeTable1_7);
...
{
  {
    ...
    if ((UnSortedElements_15 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
    {
      mercury__list__reverse_2_p_0((MR_Word) &transform_hlds__equiv_type_hlds_scalar_common_1[3], RevSortedElements1_14, SortedElements_12);
    }
    else
    {
      MR_Word TypeInfo_30_30 = (MR_Word) &transform_hlds__equiv_type_hlds_scalar_common_1[3];
      MR_Word SortedElements1_18;
      MR_Word NowSortedElements_19;
