                    ...
                    case (MR_Integer) 0:
                      {
                        ...
                        transform_hlds__equiv_type_hlds__replace_in_bound_insts_8_p_0(TypeEqvMap_9, BoundInsts0_35, &BoundInsts_45, Changed_12, STATE_VARIABLE_TVarSet_0_17, STATE_VARIABLE_TVarSet_18, STATE_VARIABLE_Cache_0_19, &STATE_VARIABLE_Cache_22_22);
                        switch (*Changed_12) {
                          default: /*NOTREACHED*/ MR_assert(0);
                          case (MR_Integer) 1:
                            {
                ...
                case (MR_Integer) 1:
                  {
                    ...
                    if ((TypeResult_40 == (MR_Word) ((MR_Unsigned) 0U)))
                    {
                      ...
                      transform_hlds__equiv_type_hlds__replace_in_bound_insts_8_p_0(TypeEqvMap_9, BoundInsts0_35, &BoundInsts_89, Changed_12, STATE_VARIABLE_TVarSet_0_17, STATE_VARIABLE_TVarSet_18, STATE_VARIABLE_Cache_0_19, &STATE_VARIABLE_Cache_22_22);
                      switch (*Changed_12) {
                        default: /*NOTREACHED*/ MR_assert(0);
                        case (MR_Integer) 1:
                          {
                    ...
                    else
                    {
                      ...
                      else
                      {
                        ...
                        transform_hlds__equiv_type_hlds__replace_in_bound_insts_8_p_0(TypeEqvMap_9, BoundInsts0_35, &BoundInsts_78, Changed_12, STATE_VARIABLE_TVarSet_0_17, STATE_VARIABLE_TVarSet_18, STATE_VARIABLE_Cache_0_19, &STATE_VARIABLE_Cache_22_22);
                        switch (*Changed_12) {
                          default: /*NOTREACHED*/ MR_assert(0);
                          case (MR_Integer) 1:
                            {
...
#undef MR_PROC_LABEL
	...
	OldMayOccur_23  = MayOccur;
                    ...
                    switch (Found_22) {
                      ...
                      case (MR_Integer) 0:
                        {
                          MayOccur_4 = transform_hlds__equiv_type_hlds__type_may_occur_in_bound_insts_1_f_0(BoundInsts_14);
{
#define MR_PROC_LABEL transform_hlds__equiv_type_hlds__type_may_occur_in_inst_1_f_0
