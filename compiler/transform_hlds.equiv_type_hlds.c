  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_21)
{
  ...
  hlds__hlds_module__module_info_get_name_2_p_0(STATE_VARIABLE_ModuleInfo_0_20, &ModuleName_9);
  {
    ...
    MR_hl_field(MR_mktag(0), Var_26, 1) = ((MR_Box) (transform_hlds__equiv_type_hlds__replace_equiv_types_in_hlds_2_p_0_3));
  ...
  hlds__hlds_module__module_info_get_cons_table_2_p_0(STATE_VARIABLE_ModuleInfo_29_29, &ConsTable0_16);
  {
    ...
    MR_hl_field(MR_mktag(0), Var_61, 1) = ((MR_Box) (transform_hlds__equiv_type_hlds__replace_equiv_types_in_hlds_2_p_0_4));
  ...
  hlds__hlds_module__module_info_get_valid_pred_ids_2_p_0(STATE_VARIABLE_ModuleInfo_30_30, &PredIds_18);
  {
    ...
    MR_hl_field(MR_mktag(0), Var_31, 1) = ((MR_Box) (transform_hlds__equiv_type_hlds__replace_equiv_types_in_hlds_2_p_0_5));
                ...
                case (MR_Integer) 1:
                  {
                    ...
                    Var_60 = (MR_Word) (MR_mkword(MR_mktag(1), (MR_Word) (PredInstInfo_33)));
                    {
                      ...
                      MR_hl_field(MR_mktag(2), Inst1_108, 1) = ((MR_Box) (Var_60));
                    }
                    ...
                    case (MR_Integer) 1:
                      {
                        ...
                        Var_65 = (MR_Word) (MR_mkword(MR_mktag(1), (MR_Word) (PredInstInfo_67)));
                        {
                          ...
                          MR_hl_field(MR_mktag(3), Inst1_175, 2) = ((MR_Box) (Var_65));
                        }
