  ...
  MR_Word * STATE_VARIABLE_EquivTypeInfo_37)
{
  ...
  else
  {
    ...
    parse_tree__equiv_type__replace_in_prog_constraint_list_7_p_0(TypeEqvMap_10, Constraints0_27, &Constraints_30, STATE_VARIABLE_TVarSet_1_39, STATE_VARIABLE_TVarSet_35, STATE_VARIABLE_EquivTypeInfo_1_40, STATE_VARIABLE_EquivTypeInfo_37);
    {
    ...
    case (MR_Integer) 1:
      {
        ...
        if (succeeded)
        {
          ...
          parse_tree__prog_type_subst__apply_variable_renaming_to_type_3_p_0(Renaming_57, Body0_56, &Body1_59);
  ...
  MR_Word Inst_3)
{
  while (MR_TRUE)
  {
    ...
    switch (MR_tag((MR_Word) Inst_3)) {
      ...
      case (MR_Integer) 1:
        {
          MR_Word Var_45 = ((MR_Word) ((MR_hl_field(1, Inst_3, 1))));
...
#undef MR_PROC_LABEL
            ...
            case (MR_Integer) 1:
              {
                MR_Word TypeResult_40 = ((MR_Word) ((MR_hl_field(1, InstResults_13, 3))));

                if ((TypeResult_40 == (MR_Word) ((MR_Unsigned) 0U)))
                {
                  MR_Word Found_32;
                  MR_Word OldMayOccur_33;
...
#undef MR_PROC_LABEL
                      ...
                      break;
                    case (MR_Integer) 1:
                      MayOccur_4 = OldMayOccur_33;
                      break;
                  }
                }
                else
                {
                  MR_Word TypeCtors_21 = ((MR_Word) ((MR_hl_field(1, TypeResult_40, 0))));
      ...
      case (MR_Integer) 3:
        switch (((MR_Integer) ((MR_hl_field(3, Inst_3, 0))))) {
          ...
          case (MR_Integer) 2:
            {
              MR_Word Var_43 = ((MR_Word) ((MR_hl_field(3, Inst_3, 2))));
