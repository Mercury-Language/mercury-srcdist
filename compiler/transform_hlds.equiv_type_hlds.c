...
transform_hlds__equiv_type_hlds__replace_in_ctor_repn_9_p_0(
  ...
  MR_Word * CtorRepn_12,
  MR_Word STATE_VARIABLE_CtorNameToRepnMap_0_31,
  MR_Word * STATE_VARIABLE_CtorNameToRepnMap_32,
...
{
  {
    ...
    MR_Word STATE_VARIABLE_EquivTypeInfo_39_39;
    MR_Box conv4_STATE_VARIABLE_TVarSet_38_38;
    MR_Box conv3_STATE_VARIABLE_EquivTypeInfo_39_39;

    {
      Var_37 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), Var_37, 0) = ((MR_Box) (&transform_hlds__equiv_type_hlds_scalar_common_6[1]));
      MR_hl_field(MR_mktag(0), Var_37, 1) = ((MR_Box) (transform_hlds__equiv_type_hlds__replace_in_ctor_repn_9_p_0_1));
      MR_hl_field(MR_mktag(0), Var_37, 2) = ((MR_Box) (MR_Word) ((MR_Integer) 1));
      MR_hl_field(MR_mktag(0), Var_37, 3) = ((MR_Box) (TypeEqvMap_10));
    }
    TypeCtorInfo_49_49 = (MR_Word) &hlds__hlds_data__hlds__hlds_data__type_ctor_info_constructor_arg_repn_0;
    mercury__list__map_foldl2_7_p_0(TypeCtorInfo_49_49, TypeCtorInfo_49_49, (MR_Word) &transform_hlds__equiv_type_hlds_scalar_common_2[3], (MR_Word) &transform_hlds__equiv_type_hlds_scalar_common_2[4], Var_37, CtorArgRepns0_19, &CtorArgRepns_22, ((MR_Box) (STATE_VARIABLE_TVarSet_0_33)), &conv4_STATE_VARIABLE_TVarSet_38_38, ((MR_Box) (STATE_VARIABLE_EquivTypeInfo_0_35)), &conv3_STATE_VARIABLE_EquivTypeInfo_39_39);
    STATE_VARIABLE_TVarSet_38_38 = ((MR_Word) conv4_STATE_VARIABLE_TVarSet_38_38);
    STATE_VARIABLE_EquivTypeInfo_39_39 = ((MR_Word) conv3_STATE_VARIABLE_EquivTypeInfo_39_39);
    if ((MaybeExistConstraints0_16 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
    {
      ...
      *STATE_VARIABLE_TVarSet_34 = STATE_VARIABLE_TVarSet_38_38;
      *STATE_VARIABLE_EquivTypeInfo_36 = STATE_VARIABLE_EquivTypeInfo_39_39;
    }
    else
    {
      MR_Word ExistConstraints0_24 = (MR_Word) MR_body(((MR_Word) MaybeExistConstraints0_16), (MR_Integer) 1);
      MR_Word ExistQVars_25 = ((MR_Word) (MR_hl_field(MR_mktag(0), ExistConstraints0_24, (MR_Integer) 0)));
      MR_Word Constraints0_26 = ((MR_Word) (MR_hl_field(MR_mktag(0), ExistConstraints0_24, (MR_Integer) 1)));
      MR_Word UnconstrainedExistQVars_27 = ((MR_Word) (MR_hl_field(MR_mktag(0), ExistConstraints0_24, (MR_Integer) 2)));
      MR_Word ConstrainedExistQVars_28 = ((MR_Word) (MR_hl_field(MR_mktag(0), ExistConstraints0_24, (MR_Integer) 3)));
      MR_Word Constraints_29;
      MR_Word ExistConstraints_30;

      parse_tree__equiv_type__replace_in_prog_constraint_list_7_p_0(TypeEqvMap_10, Constraints0_26, &Constraints_29, STATE_VARIABLE_TVarSet_38_38, STATE_VARIABLE_TVarSet_34, STATE_VARIABLE_EquivTypeInfo_39_39, STATE_VARIABLE_EquivTypeInfo_36);
      {
        ExistConstraints_30 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), ExistConstraints_30, 0) = ((MR_Box) (ExistQVars_25));
        MR_hl_field(MR_mktag(0), ExistConstraints_30, 1) = ((MR_Box) (Constraints_29));
        MR_hl_field(MR_mktag(0), ExistConstraints_30, 2) = ((MR_Box) (UnconstrainedExistQVars_27));
        MR_hl_field(MR_mktag(0), ExistConstraints_30, 3) = ((MR_Box) (ConstrainedExistQVars_28));
      }
      MaybeExistConstraints_23 = (MR_Word) MR_mkword(MR_mktag(1), (MR_Word) ExistConstraints_30);
    }
    {
      MR_Word base;
      base = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 6 * sizeof(MR_Word)), NULL, NULL);
    ...
    hlds__hlds_data__insert_ctor_repn_into_map_3_p_0(*CtorRepn_12, STATE_VARIABLE_CtorNameToRepnMap_0_31, STATE_VARIABLE_CtorNameToRepnMap_32);
  }
}
...
{
  {
    ...
    MR_Word conv2_STATE_VARIABLE_CtorNameToRepnMap_32;
    MR_Word conv1_STATE_VARIABLE_TVarSet_34;
    MR_Word conv0_STATE_VARIABLE_EquivTypeInfo_36;

    transform_hlds__equiv_type_hlds__replace_in_ctor_repn_9_p_0(((MR_Word) (MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3))), ((MR_Word) wrapper_arg_1), &conv3_CtorRepn_12, ((MR_Word) wrapper_arg_3), &conv2_STATE_VARIABLE_CtorNameToRepnMap_32, ((MR_Word) wrapper_arg_5), &conv1_STATE_VARIABLE_TVarSet_34, ((MR_Word) wrapper_arg_7), &conv0_STATE_VARIABLE_EquivTypeInfo_36);
    *wrapper_arg_2 = ((MR_Box) (conv3_CtorRepn_12));
    *wrapper_arg_4 = ((MR_Box) (conv2_STATE_VARIABLE_CtorNameToRepnMap_32));
    *wrapper_arg_6 = ((MR_Box) (conv1_STATE_VARIABLE_TVarSet_34));
    *wrapper_arg_8 = ((MR_Box) (conv0_STATE_VARIABLE_EquivTypeInfo_36));
  }
}
