    ...
    case (MR_Integer) 1:
      {
        ...
        if (succeeded)
        {
          ...
          succeeded = ((MR_tag((MR_Word) ConsId_76)) == (MR_Integer) 2);
          if (succeeded)
          {
            TypeCtor_82 = (MR_Word) (MR_body((MR_Word) (ConsId_76), (MR_Integer) 2));
        ...
        else
        {
          ...
          if (succeeded)
          {
            ...
            succeeded = ((MR_tag((MR_Word) ConsId_190)) == (MR_Integer) 2);
            if (succeeded)
            {
              TypeCtor_191 = (MR_Word) (MR_body((MR_Word) (ConsId_190), (MR_Integer) 2));
              succeeded = ((((MR_tag((MR_Word) TypeCtorCat_74)) == (MR_Integer) 3)) && ((((MR_Integer) ((MR_hl_field(3, TypeCtorCat_74, (MR_Integer) 0)))) == (MR_Integer) 0)));
              if (succeeded)
              {
