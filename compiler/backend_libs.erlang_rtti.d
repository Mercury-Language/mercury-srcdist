...
ifeq ($(TARGET_ASM),yes)
backend_libs.erlang_rtti.mh backend_libs.erlang_rtti.mih : backend_libs.erlang_rtti.s
else
backend_libs.erlang_rtti.mh backend_libs.erlang_rtti.mih : backend_libs.erlang_rtti.c
endif

ifeq ($(TARGET_ASM),yes)
backend_libs.erlang_rtti.module_dep : backend_libs.erlang_rtti.s
else
 ifeq ($(findstring il,$(GRADE)),il)
backend_libs.erlang_rtti.module_dep : backend_libs.erlang_rtti.il
  ifeq ($(findstring java,$(GRADE)),java)
backend_libs.erlang_rtti.module_dep : mercury/backend_libs_/erlang_rtti.java
  else
...
ifeq ($(TARGET_ASM),yes)
backend_libs.erlang_rtti.s_date : erlang_rtti.m
	$(MCG) $(ALL_GRADEFLAGS) $(ALL_MCGFLAGS) --target-code-only backend_libs.erlang_rtti $(ERR_REDIRECT)
backend_libs.erlang_rtti.pic_s_date : erlang_rtti.m
	$(MCG) $(ALL_GRADEFLAGS) $(ALL_MCGFLAGS) --target-code-only --pic \
		--cflags "$(GCCFLAGS_FOR_PIC)" backend_libs.erlang_rtti $(ERR_REDIRECT)
endif # TARGET_ASM
