  ...
  MR_String * LinkFlagsStr_8)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_6, (MR_Integer) 635, &UseInstallName_57);
  ...
  if (succeeded)
  {
    ...
    libs__globals__lookup_accumulating_option_3_p_0(Globals_6, (MR_Integer) 526, &RpathDirs0_60);
    ...
    else
    {
      ...
      libs__globals__lookup_string_option_3_p_0(Globals_6, (MR_Integer) 621, &RpathSep_62);
      libs__globals__lookup_string_option_3_p_0(Globals_6, (MR_Integer) 620, &RpathFlag_63);
    ...
    RpathOpts_16 = (MR_String) "";
  libs__globals__lookup_accumulating_option_3_p_0(Globals_6, (MR_Integer) 518, &LinkLibraries_69);
  {
  ...
  mercury__list__condense_2_p_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_error_spec_0), SpecsList_71, Specs_7);
    ...
    case (MR_Integer) 1:
      {
        ...
        libs__globals__lookup_string_option_3_p_0(Globals_6, (MR_Integer) 642, &SystemTraceLibs0_81);
        libs__globals__lookup_bool_option_3_p_0(Globals_6, (MR_Integer) 539, &UseReadline_82);
          ...
          case (MR_Integer) 1:
            {
              ...
              libs__globals__lookup_string_option_3_p_0(Globals_6, (MR_Integer) 639, &ReadlineLibs_83);
  ...
  switch (UseThreadLibs_84) {
    ...
    case (MR_Integer) 0:
      ...
      break;
    case (MR_Integer) 1:
      libs__globals__lookup_string_option_3_p_0(Globals_6, (MR_Integer) 641, &ThreadLibs_85);
      break;
  }
  libs__globals__lookup_string_option_3_p_0(Globals_6, (MR_Integer) 638, &OtherSystemLibs_86);
  {
