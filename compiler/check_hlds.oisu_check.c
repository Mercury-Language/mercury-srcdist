            ...
            else
            {
              ...
              else
              {
                ...
                hlds__hlds_pred__pred_info_get_context_2_p_0(PredInfo0_18, &Context_40);
                {
                  ...
                  MR_hl_field(MR_mktag(1), ProcsSpec_41, 2) = ((MR_Box) ((MR_Unsigned) 44U));
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        hlds__hlds_pred__pred_info_get_context_2_p_0(HeadVar__1_1, &Context_22);
        {
          ...
          MR_hl_field(MR_mktag(1), ProcsSpec_23, 2) = ((MR_Box) ((MR_Unsigned) 44U));
    ...
    if ((HeadVar__7_7 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      ...
      else
      {
        ...
        hlds__hlds_pred__pred_info_get_context_2_p_0(PredInfo_2, &Context_283);
        {
          ...
          MR_hl_field(MR_mktag(1), Spec_284, 2) = ((MR_Box) ((MR_Unsigned) 44U));
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            ...
            hlds__hlds_pred__pred_info_get_context_2_p_0(PredInfo_2, &DupContext_28);
            {
              ...
              MR_hl_field(MR_mktag(1), DupSpec_29, 2) = ((MR_Box) ((MR_Unsigned) 44U));
              ...
              case (MR_Integer) 0:
                {
                  ...
                  else
                  {
                    ...
                    hlds__hlds_pred__pred_info_get_context_2_p_0(PredInfo_2, &Context_34);
                    {
                      ...
                      MR_hl_field(MR_mktag(1), Spec_35, 2) = ((MR_Box) ((MR_Unsigned) 44U));
              ...
              case (MR_Integer) 2:
                {
                  ...
                  else
                  {
                    ...
                    hlds__hlds_pred__pred_info_get_context_2_p_0(PredInfo_2, &Context_256);
                    {
                      ...
                      MR_hl_field(MR_mktag(1), Spec_257, 2) = ((MR_Box) ((MR_Unsigned) 44U));
              ...
              case (MR_Integer) 1:
                {
                  ...
                  if (succeeded)
                  {
                    ...
                    else
                    {
                      ...
                      hlds__hlds_pred__pred_info_get_context_2_p_0(PredInfo_2, &InContext_42);
                      {
                        ...
                        MR_hl_field(MR_mktag(1), InSpec_43, 2) = ((MR_Box) ((MR_Unsigned) 44U));
                    ...
                    else
                    {
                      ...
                      hlds__hlds_pred__pred_info_get_context_2_p_0(PredInfo_2, &OutContext_46);
                      {
                        ...
                        MR_hl_field(MR_mktag(1), OutSpec_47, 2) = ((MR_Box) ((MR_Unsigned) 44U));
                  ...
                  else
                  {
                    ...
                    hlds__hlds_pred__pred_info_get_context_2_p_0(PredInfo_2, &Context_244);
                    {
                      ...
                      MR_hl_field(MR_mktag(1), Spec_245, 2) = ((MR_Box) ((MR_Unsigned) 44U));
        ...
        else
        {
          ...
          hlds__hlds_pred__pred_info_get_context_2_p_0(PredInfo_2, &Context_268);
          {
            ...
            MR_hl_field(MR_mktag(1), Spec_269, 2) = ((MR_Box) ((MR_Unsigned) 44U));
