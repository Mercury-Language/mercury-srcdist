    ...
    case (MR_Integer) 1:
      {
        ...
        if (succeeded)
        {
          ...
          {
            MR_Word Var_96 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Procs0_25, (MR_Integer) 1))));
            MR_Word Var_97 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Procs0_25, (MR_Integer) 0))));

            if ((Var_96 == (MR_Word) ((MR_Unsigned) 0U)))
            {
              MR_Integer ProcId_26 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), Var_97, (MR_Integer) 0))));
              MR_Word ProcInfo0_27 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_97, (MR_Integer) 1))));
              MR_Word ArgTypes_28;
              MR_Word ArgModes_29;
              ...
              hlds__hlds_pred__proc_info_set_oisu_kind_fors_3_p_0(KindFors_23, ProcInfo0_27, &ProcInfo_31);
              {
                ...
                MR_hl_field(MR_mktag(0), Var_57, 0) = ((MR_Box) (ProcId_26));
                MR_hl_field(MR_mktag(0), Var_57, 1) = ((MR_Box) (ProcInfo_31));
              }
              {
                Procs_32 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(1), Procs_32, 0) = ((MR_Box) (Var_57));
              ...
              }
              {
                ...
                MR_hl_field(MR_mktag(0), Var_59, 0) = ((MR_Box) (PredId_17));
                MR_hl_field(MR_mktag(0), Var_59, 1) = ((MR_Box) (ProcId_26));
              }
        ...
        else
        {
          ...
          if (succeeded)
          {
            Var_85 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Origin_42, (MR_Integer) 0))));
              ...
              case (MR_Integer) 0:
                {
                  ...
                  else
                  {
                    ...
                    Var_86 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_format_component_0), PredDesc_32, (MR_Word) (MR_mkword(MR_mktag(1), &check_hlds__oisu_check_scalar_common_1[28])));
              ...
              case (MR_Integer) 2:
                {
                  ...
                  else
                  {
                    ...
                    Var_196 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_util__parse_tree__error_util__type_ctor_info_format_component_0), PredDesc_254, (MR_Word) (MR_mkword(MR_mktag(1), &check_hlds__oisu_check_scalar_common_1[32])));
