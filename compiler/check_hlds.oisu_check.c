  ...
  while (MR_TRUE)
  {
    ...
    if ((HeadVar__7_7 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      ...
      else
      {
        ...
        {
          Spec_284 = (MR_Word) MR_new_object(MR_Word, (5 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(0, Spec_284, 0) = ((MR_Box) ((MR_String) "predicate \140check_hlds.oisu_check.check_arg_oisu_types\'/9"));
          MR_hl_field(0, Spec_284, 1) = ((MR_Box) ((MR_Unsigned) 0U));
          MR_hl_field(0, Spec_284, 2) = ((MR_Box) ((MR_Unsigned) 76U));
          MR_hl_field(0, Spec_284, 3) = ((MR_Box) (Context_283));
          MR_hl_field(0, Spec_284, 4) = ((MR_Box) (Pieces_282));
        }
        {
          MR_Word base;
          base = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
      ...
      if (succeeded)
      {
              ...
              case (MR_Integer) 2:
                {
                  ...
                  else
                  {
                    ...
                    hlds__hlds_pred__pred_info_get_context_2_p_0(PredInfo_2, &Context_256);
                    {
                      ...
                      MR_hl_field(0, Spec_257, 0) = ((MR_Box) ((MR_String) "predicate \140check_hlds.oisu_check.check_arg_oisu_types\'/9"));
                      MR_hl_field(0, Spec_257, 1) = ((MR_Box) ((MR_Unsigned) 0U));
                      MR_hl_field(0, Spec_257, 2) = ((MR_Box) ((MR_Unsigned) 76U));
                      MR_hl_field(0, Spec_257, 3) = ((MR_Box) (Context_256));
                      MR_hl_field(0, Spec_257, 4) = ((MR_Box) (Pieces_255));
                    }
                    {
                      STATE_VARIABLE_Specs_73_73 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
              ...
              case (MR_Integer) 1:
                {
                  ...
                  else
                  {
                    ...
                    hlds__hlds_pred__pred_info_get_context_2_p_0(PredInfo_2, &Context_244);
                    {
                      ...
                      MR_hl_field(0, Spec_245, 0) = ((MR_Box) ((MR_String) "predicate \140check_hlds.oisu_check.check_arg_oisu_types\'/9"));
                      MR_hl_field(0, Spec_245, 1) = ((MR_Box) ((MR_Unsigned) 0U));
                      MR_hl_field(0, Spec_245, 2) = ((MR_Box) ((MR_Unsigned) 76U));
                      MR_hl_field(0, Spec_245, 3) = ((MR_Box) (Context_244));
                      MR_hl_field(0, Spec_245, 4) = ((MR_Box) (Pieces_243));
                    }
                    {
                      STATE_VARIABLE_Specs_73_73 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
        ...
        else
        {
          ...
          hlds__hlds_pred__pred_info_get_context_2_p_0(PredInfo_2, &Context_268);
          {
            ...
            MR_hl_field(0, Spec_269, 0) = ((MR_Box) ((MR_String) "predicate \140check_hlds.oisu_check.check_arg_oisu_types\'/9"));
            MR_hl_field(0, Spec_269, 1) = ((MR_Box) ((MR_Unsigned) 0U));
            MR_hl_field(0, Spec_269, 2) = ((MR_Box) ((MR_Unsigned) 76U));
            MR_hl_field(0, Spec_269, 3) = ((MR_Box) (Context_268));
            MR_hl_field(0, Spec_269, 4) = ((MR_Box) (Pieces_267));
          }
          {
