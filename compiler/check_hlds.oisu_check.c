    ...
    case (MR_Integer) 1:
      {
        ...
        if (succeeded)
        {
          ...
          {
            MR_Word Var_95 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Procs0_25, (MR_Integer) 1))));
            MR_Word Var_96 = ((MR_Word) ((MR_hl_field(MR_mktag(1), Procs0_25, (MR_Integer) 0))));

            if ((Var_95 == (MR_Word) ((MR_Unsigned) 0U)))
            {
              MR_Integer ProcId_26 = ((MR_Integer) ((MR_hl_field(MR_mktag(0), Var_96, (MR_Integer) 0))));
              MR_Word ProcInfo0_27 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_96, (MR_Integer) 1))));
              MR_Word ArgTypes_28;
              MR_Word ArgModes_29;
        ...
        else
        {
          ...
          succeeded = ((MR_tag((MR_Word) Origin_42)) == (MR_Integer) 2);
          if (succeeded)
            *STATE_VARIABLE_Specs_48 = STATE_VARIABLE_Specs_0_47;
          else
          {
