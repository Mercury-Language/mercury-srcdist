  ...
  MR_Word * STATE_VARIABLE_Specs_5)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      {
        MR_Word next_value_of_HeadVar__3_3 = Types_14;
        MR_Word next_value_of_STATE_VARIABLE_Specs_0_4 = STATE_VARIABLE_Specs_59_59;
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          /* direct tailcall eliminated */
          {
            MR_Integer next_value_of_HeadVar__5_5 = RestArgNum_31;
            MR_Word next_value_of_STATE_VARIABLE_HandledOISUTypeCtors_0_6 = STATE_VARIABLE_HandledOISUTypeCtors_84_84;
            MR_Word next_value_of_HeadVar__7_7 = RestTypesModes_32;
            MR_Word next_value_of_STATE_VARIABLE_Specs_0_8 = STATE_VARIABLE_Specs_82_82;
        ...
        else
        {
          ...
          /* direct tailcall eliminated */
          {
            MR_Integer next_value_of_HeadVar__5_5 = Var_269;
            MR_Word next_value_of_HeadVar__7_7 = TypesModes_17;
            MR_Word next_value_of_STATE_VARIABLE_Specs_0_8 = STATE_VARIABLE_Specs_268_268;
