      ...
      case (MR_Integer) 1:
        {
          ...
          if (succeeded)
          {
            ...
            if ((Procs0_25 == (MR_Word) ((MR_Integer) 0)))
            {
              {
            ...
            else
            {
              ...
              if ((Var_102 == (MR_Word) ((MR_Integer) 0)))
              {
                ...
                check_hlds__oisu_check__check_arg_oisu_types_9_p_0(ModuleInfo_10, PredInfo0_18, KindFors_23, OISUTypeCtors_12, (MR_Integer) 1, (MR_Word) ((MR_Integer) 0), ArgTypesModes_30, STATE_VARIABLE_Specs_0_48, STATE_VARIABLE_Specs_49);
                ...
                }
                {
                  ...
                  MR_hl_field(MR_mktag(1), Procs_32, 1) = ((MR_Box) ((MR_Integer) 0));
                }
              ...
              else
              {
                ...
                }
                {
                  ...
                  MR_hl_field(MR_mktag(0), ProcsSpec_42, 0) = ((MR_Box) ((MR_Integer) 0));
                  MR_hl_field(MR_mktag(0), ProcsSpec_42, 1) = ((MR_Box) ((MR_Integer) 44));
          ...
          else
          {
            ...
            succeeded = ((MR_tag((MR_Word) Origin_43)) == (MR_Integer) 0);
            if (succeeded)
            {
              *STATE_VARIABLE_Specs_49 = STATE_VARIABLE_Specs_0_48;
            }
  ...
  MR_Word * STATE_VARIABLE_Specs_5)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        succeeded = (ArgTypes_17 == (MR_Word) ((MR_Integer) 0));
        if (succeeded)
        {
      ...
      if (succeeded)
      {
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(0), ProcsSpec_24, 0) = ((MR_Box) ((MR_Integer) 0));
          MR_hl_field(MR_mktag(0), ProcsSpec_24, 1) = ((MR_Box) ((MR_Integer) 44));
  ...
  MR_Word * STATE_VARIABLE_Specs_9)
{
  while (MR_TRUE)
  {
    ...
    if ((HeadVar__7_7 == (MR_Word) ((MR_Integer) 0)))
    {
      ...
      if ((UnhandledKindFors_316 == (MR_Word) ((MR_Integer) 0)))
      ...
      else
      {
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(1), Var_340, 1) = ((MR_Box) ((MR_Integer) 0));
        }
        {
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(1), Var_345, 1) = ((MR_Box) ((MR_Integer) 0));
        }
        {
          Spec_324 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), Spec_324, 0) = ((MR_Box) ((MR_Integer) 0));
          MR_hl_field(MR_mktag(0), Spec_324, 1) = ((MR_Box) ((MR_Integer) 44));
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        if (!((ArgTypes_22 == (MR_Word) ((MR_Integer) 0))))
        {
          {
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            ...
            }
            {
              ...
              MR_hl_field(MR_mktag(0), DupSpec_30, 0) = ((MR_Box) ((MR_Integer) 0));
              MR_hl_field(MR_mktag(0), DupSpec_30, 1) = ((MR_Box) ((MR_Integer) 44));
              ...
              case (MR_Integer) 0:
                {
                  ...
                  else
                  {
                    ...
                    }
                    {
                      ...
                      MR_hl_field(MR_mktag(0), Spec_37, 1) = ((MR_Box) ((MR_Integer) 44));
              ...
              case (MR_Integer) 2:
                {
                  ...
                  else
                  {
                    ...
                    }
                    {
                      ...
                      MR_hl_field(MR_mktag(0), Spec_293, 1) = ((MR_Box) ((MR_Integer) 44));
              ...
              case (MR_Integer) 1:
                {
                  ...
                  succeeded = ((MR_tag((MR_Word) TypesModes_17)) == (MR_Integer) 1);
                  if (succeeded)
                  {
                  ...
                  if (succeeded)
                  {
                    ...
                    else
                    {
                      ...
                      }
                      {
                        ...
                        MR_hl_field(MR_mktag(0), InSpec_46, 0) = ((MR_Box) ((MR_Integer) 0));
                        MR_hl_field(MR_mktag(0), InSpec_46, 1) = ((MR_Box) ((MR_Integer) 44));
                    ...
                    else
                    {
                      ...
                      }
                      {
                        ...
                        MR_hl_field(MR_mktag(0), OutSpec_51, 0) = ((MR_Box) ((MR_Integer) 0));
                        MR_hl_field(MR_mktag(0), OutSpec_51, 1) = ((MR_Box) ((MR_Integer) 44));
                  ...
                  else
                  {
                    ...
                    }
                    {
                      ...
                      MR_hl_field(MR_mktag(0), Spec_278, 0) = ((MR_Box) ((MR_Integer) 0));
                      MR_hl_field(MR_mktag(0), Spec_278, 1) = ((MR_Box) ((MR_Integer) 44));
        ...
        else
        {
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(1), Var_260, 1) = ((MR_Box) ((MR_Integer) 0));
          }
          {
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(0), Spec_308, 0) = ((MR_Box) ((MR_Integer) 0));
            MR_hl_field(MR_mktag(0), Spec_308, 1) = ((MR_Box) ((MR_Integer) 44));
...
{
  {
    ...
    if ((TailKindFors_5 == (MR_Word) ((MR_Integer) 0)))
    {
...
{
  {
    ...
    else
    {
...

      {
        ...
        MR_hl_field(MR_mktag(1), Entries_18, 1) = ((MR_Box) ((MR_Integer) 0));
      }
