  ...
  MR_Word * STATE_VARIABLE_Specs_9)
{
  while (MR_TRUE)
  {
    ...
    {
      MR_Word UnhandledKindFors_317;

      check_hlds__oisu_check__find_unhandled_oisu_kind_fors_3_p_0(KindFors_3, STATE_VARIABLE_HandledOISUTypeCtors_0_6, &UnhandledKindFors_317);
      if ((UnhandledKindFors_317 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
        *STATE_VARIABLE_Specs_9 = STATE_VARIABLE_Specs_0_8;
      else
      {
        MR_Word TypeCtorInfo_358_358;
        MR_Word HeadUnhandledKindFor_318 = ((MR_Word) (MR_hl_field(MR_mktag(1), UnhandledKindFors_317, (MR_Integer) 0)));
        MR_Word TailUnhandledKindFors_319 = ((MR_Word) (MR_hl_field(MR_mktag(1), UnhandledKindFors_317, (MR_Integer) 1)));
        MR_Word UnhandledPieces_320;
        MR_Word PredDesc_321;
        MR_Word Pieces_322;
        MR_Word Context_323;
        MR_Word Msg_324;
        MR_Word Spec_325;
        ...
        check_hlds__oisu_check__describe_unhandled_kind_fors_3_p_0(HeadUnhandledKindFor_318, TailUnhandledKindFors_319, &UnhandledPieces_320);
        PredDesc_321 = hlds__hlds_error_util__describe_one_pred_info_name_2_f_0((MR_Integer) 1, PredInfo_2);
        TypeCtorInfo_358_358 = (MR_Word) &parse_tree__error_util__parse_tree__error_util__type_ctor_info_format_component_0;
        Var_330 = mercury__list__f_43_43_2_f_0(TypeCtorInfo_358_358, (MR_Word) MR_mkword(MR_mktag(1), &check_hlds__oisu_check_scalar_common_1[19]), UnhandledPieces_320);
        Pieces_322 = mercury__list__f_43_43_2_f_0(TypeCtorInfo_358_358, PredDesc_321, Var_330);
        hlds__hlds_pred__pred_info_get_context_2_p_0(PredInfo_2, &Context_323);
        {
          Var_342 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), Var_342, 0) = ((MR_Box) (Pieces_322));
        }
        {
          Var_341 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), Var_341, 0) = ((MR_Box) (Var_342));
          MR_hl_field(MR_mktag(1), Var_341, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
        }
        {
          Msg_324 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), Msg_324, 0) = ((MR_Box) (Context_323));
          MR_hl_field(MR_mktag(0), Msg_324, 1) = ((MR_Box) (Var_341));
        }
        {
          Var_346 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(MR_mktag(1), Var_346, 0) = ((MR_Box) (Msg_324));
          MR_hl_field(MR_mktag(1), Var_346, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
        }
        {
          Spec_325 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL);
          MR_hl_field(MR_mktag(0), Spec_325, 0) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
          MR_hl_field(MR_mktag(0), Spec_325, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 11))));
          MR_hl_field(MR_mktag(0), Spec_325, 2) = ((MR_Box) (Var_346));
        }
        {
          MR_Word base;
          base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
          *STATE_VARIABLE_Specs_9 = base;
          MR_hl_field(MR_mktag(1), base, 0) = ((MR_Box) (Spec_325));
    ...
    else
    {
      ...
      MR_Word TypeCtor_21;
      MR_Word ArgTypes_22;
      MR_Word TypeCtorInfo_349_349;

      succeeded = parse_tree__prog_type__type_to_ctor_and_args_3_p_0(Type_19, &TypeCtor_21, &ArgTypes_22);
      if (succeeded)
      {
        TypeCtorInfo_349_349 = (MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_type_ctor_0;
        succeeded = mercury__list__member_2_p_0(TypeCtorInfo_349_349, ((MR_Box) (TypeCtor_21)), HeadVar__4_4);
      }
      if (succeeded)
      {
        MR_Word ThisKind_25;
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            ...
            Var_68 = mercury__list__f_43_43_2_f_0(TypeCtorInfo_351_351, DupPredDesc_26, (MR_Word) MR_mkword(MR_mktag(1), &check_hlds__oisu_check_scalar_common_1[21]));
            DupPieces_27 = mercury__list__f_43_43_2_f_0(TypeCtorInfo_351_351, Var_59, Var_68);
              ...
              case (MR_Integer) 0:
                {
                  ...
                  else
                  {
                    ...
                    Var_221 = mercury__list__f_43_43_2_f_0(TypeCtorInfo_352_352, PredDesc_33, (MR_Word) MR_mkword(MR_mktag(1), &check_hlds__oisu_check_scalar_common_1[25]));
                    Pieces_34 = mercury__list__f_43_43_2_f_0(TypeCtorInfo_352_352, Var_212, Var_221);
              ...
              case (MR_Integer) 2:
                {
                  ...
                  else
                  {
                    ...
                    Var_95 = mercury__list__f_43_43_2_f_0(TypeCtorInfo_356_356, PredDesc_290, (MR_Word) MR_mkword(MR_mktag(1), &check_hlds__oisu_check_scalar_common_1[29]));
                    Pieces_291 = mercury__list__f_43_43_2_f_0(TypeCtorInfo_356_356, Var_86, Var_95);
              ...
              case (MR_Integer) 1:
                {
                  ...
                  if (succeeded)
                  {
                    ...
                    else
                    {
                      ...
                      Var_124 = mercury__list__f_43_43_2_f_0(TypeCtorInfo_353_353, InPredDesc_42, (MR_Word) MR_mkword(MR_mktag(1), &check_hlds__oisu_check_scalar_common_1[33]));
                      InPieces_43 = mercury__list__f_43_43_2_f_0(TypeCtorInfo_353_353, Var_115, Var_124);
                    ...
                    else
                    {
                      ...
                      Var_157 = mercury__list__f_43_43_2_f_0(TypeCtorInfo_354_354, OutPredDesc_47, (MR_Word) MR_mkword(MR_mktag(1), &check_hlds__oisu_check_scalar_common_1[36]));
                      OutPieces_48 = mercury__list__f_43_43_2_f_0(TypeCtorInfo_354_354, Var_146, Var_157);
                  ...
                  else
                  {
                    ...
                    Var_189 = mercury__list__f_43_43_2_f_0(TypeCtorInfo_355_355, PredDesc_275, (MR_Word) MR_mkword(MR_mktag(1), &check_hlds__oisu_check_scalar_common_1[42]));
                    Pieces_276 = mercury__list__f_43_43_2_f_0(TypeCtorInfo_355_355, Var_180, Var_189);
        ...
        else
        {
          ...
          PredDesc_305 = hlds__hlds_error_util__describe_one_pred_info_name_2_f_0((MR_Integer) 1, PredInfo_2);
          ...
          Var_251 = mercury__list__f_43_43_2_f_0(TypeCtorInfo_357_357, PredDesc_305, (MR_Word) MR_mkword(MR_mktag(1), &check_hlds__oisu_check_scalar_common_1[46]));
          Pieces_306 = mercury__list__f_43_43_2_f_0(TypeCtorInfo_357_357, Var_242, Var_251);
          hlds__hlds_pred__pred_info_get_context_2_p_0(PredInfo_2, &Context_307);
          {
            Var_262 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL);
            MR_hl_field(MR_mktag(0), Var_262, 0) = ((MR_Box) (Pieces_306));
          }
          {
          ...
          {
            Msg_308 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
            MR_hl_field(MR_mktag(0), Msg_308, 0) = ((MR_Box) (Context_307));
            MR_hl_field(MR_mktag(0), Msg_308, 1) = ((MR_Box) (Var_261));
          }
          {
            Var_266 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), Var_266, 0) = ((MR_Box) (Msg_308));
            MR_hl_field(MR_mktag(1), Var_266, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
          }
          {
            Spec_309 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL);
            MR_hl_field(MR_mktag(0), Spec_309, 0) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
            MR_hl_field(MR_mktag(0), Spec_309, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 11))));
            MR_hl_field(MR_mktag(0), Spec_309, 2) = ((MR_Box) (Var_266));
          }
          {
            STATE_VARIABLE_Specs_268_268 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), STATE_VARIABLE_Specs_268_268, 0) = ((MR_Box) (Spec_309));
