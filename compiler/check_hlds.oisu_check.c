      ...
      case (MR_Integer) 1:
        {
          ...
          if (succeeded)
          {
            ...
            else
            {
              ...
              else
              {
                ...
                {
                  ProcsMsg_41 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
          ...
          else
          {
            ...
            if (succeeded)
            {
              packed_word_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Origin_43, (MR_Integer) 0)));
              *STATE_VARIABLE_Specs_49 = STATE_VARIABLE_Specs_0_48;
            }
            else
            {
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        {
          ProcsMsg_23 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
  ...
  while (MR_TRUE)
  {
    ...
    if ((HeadVar__7_7 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      ...
      else
      {
        ...
        {
          Msg_323 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
    ...
    else
    {
      ...
      if (succeeded)
      {
              ...
              case (MR_Integer) 1:
                {
                  ...
                  if (succeeded)
                  {
                    ...
                    else
                    {
                      ...
                      {
                        InMsg_45 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
                    ...
                    else
                    {
                      ...
                      {
                        OutMsg_50 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
                  ...
                  else
                  {
                    ...
                    {
                      Msg_277 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
        ...
        else
        {
          ...
          {
            Msg_307 = (MR_Word) MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL);
