  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          TypeCtorInfo__56_56 = (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_type_ctor_0);
          succeeded = mercury__list__member_2_p_0(TypeCtorInfo__56_56, ((MR_Box) (TypeCtor_16)), HeadVar__2_2);
        }
      }
      if (succeeded)
      {
  ...
  MR_Word * STATE_VARIABLE_Specs_9)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      MR_Word TypeCtor_21;
      MR_Word ArgTypes_22;
      MR_Word TypeCtorInfo__304_304;

      succeeded = parse_tree__prog_type__type_to_ctor_and_args_3_p_0(Type_19, &TypeCtor_21, &ArgTypes_22);
      if (succeeded)
      {
        TypeCtorInfo__304_304 = (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_type_ctor_0);
        succeeded = mercury__list__member_2_p_0(TypeCtorInfo__304_304, ((MR_Box) (TypeCtor_21)), HeadVar__4_4);
      }
      if (succeeded)
      {
        MR_Word ThisKind_25;
