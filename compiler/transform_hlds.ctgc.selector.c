      ...
      if (((MR_tag((MR_Word) UnitSelector_9)) == (MR_mktag((MR_Integer) 0))))
      {
        ...
        else
        {
          ...
          if (succeeded)
          {
            ...
            MR_Word ArgTypes_35 = ((MR_Word) (MR_hl_field(MR_mktag(0), CtorDefn_20, (MR_Integer) 3)));
            ...
            else
            {
              ...
              Var_27 = ((MR_Word) (MR_hl_field(MR_mktag(0), Var_31, (MR_Integer) 2)));
              Var_28 = ((MR_Word) (MR_hl_field(MR_mktag(0), Var_31, (MR_Integer) 3)));
            }
            conv1_SubType0_13 = mercury__list__det_index1_2_f_0((MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0, ArgTypes_35, Index_12);
            ...
            if (succeeded)
            {
              ...
              Var_30 = ((MR_Word) (MR_hl_field(MR_mktag(0), SubType0_13, (MR_Integer) 1)));
              TypeInfo_31_39 = (MR_Word) &transform_hlds__ctgc__selector_scalar_common_1[1];
              succeeded = mercury__list__member_2_p_0(TypeInfo_31_39, ((MR_Box) (TVar_29)), ExistQVars_25);
            }
            succeeded = !(succeeded);
          }
          else
              ...
              else
              {
                ...
                else
                {
                  ...
                  if (succeeded)
                  {
                    ...
                    MR_Word ArgTypes_73 = ((MR_Word) (MR_hl_field(MR_mktag(0), CtorDefn_58, (MR_Integer) 3)));
                    ...
                    else
                    {
                      ...
                      Var_64 = ((MR_Word) (MR_hl_field(MR_mktag(0), Var_69, (MR_Integer) 1)));
                      Var_65 = ((MR_Word) (MR_hl_field(MR_mktag(0), Var_69, (MR_Integer) 2)));
                      Var_66 = ((MR_Word) (MR_hl_field(MR_mktag(0), Var_69, (MR_Integer) 3)));
                    }
                    conv1_SubType0_49 = mercury__list__det_index1_2_f_0((MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0, ArgTypes_73, IndexA_16);
                    ...
                    if (succeeded)
                    {
                      ...
                      Var_68 = ((MR_Word) (MR_hl_field(MR_mktag(0), SubType0_49, (MR_Integer) 1)));
                      TypeInfo_31_77 = (MR_Word) &transform_hlds__ctgc__selector_scalar_common_1[1];
                      succeeded = mercury__list__member_2_p_0(TypeInfo_31_77, ((MR_Box) (TVar_67)), ExistQVars_63);
                    }
                    succeeded = !(succeeded);
                  }
                  else
          ...
          if (succeeded)
          {
            ...
            else
            {
              ...
              else
              {
                ...
                transform_hlds__ctgc__selector__type_contains_subtype_1_4_p_0(ModuleInfo_6, SubTypeA_23, SubTypeB_22, &Contains_81);
                succeeded = (Contains_81 == (MR_Integer) 1);
              }
              if (succeeded)
              {
                // direct tailcall eliminated
          ...
          if (((MR_tag((MR_Word) BH_13)) == (MR_mktag((MR_Integer) 0))))
          {
            ...
            else
            {
              ...
              else
              {
                ...
                transform_hlds__ctgc__selector__type_contains_subtype_1_4_p_0(ModuleInfo_6, SubTypeB_29, Var_37, &Contains_86);
          ...
          else
          {
            ...
            else
            {
              ...
              else
              {
                ...
                transform_hlds__ctgc__selector__type_contains_subtype_1_4_p_0(ModuleInfo_6, SubTypeB_31, Var_37, &Contains_91);
                succeeded = (Contains_91 == (MR_Integer) 1);
              }
              if (succeeded)
              ...
              else
              {
                ...
                else
                {
                  ...
                  transform_hlds__ctgc__selector__type_contains_subtype_1_4_p_0(ModuleInfo_6, Var_37, SubTypeB_31, &Contains_96);
                  succeeded = (Contains_96 == (MR_Integer) 1);
                }
                if (succeeded)
                {
                  // direct tailcall eliminated
...
{
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        conv1_SubType0_11 = mercury__list__det_index1_2_f_0((MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0, ArgTypes_35, Position_9);
        ...
        if (succeeded)
        {
          ...
          Var_30 = ((MR_Word) (MR_hl_field(MR_mktag(0), SubType0_11, (MR_Integer) 1)));
          TypeInfo_31_39 = (MR_Word) &transform_hlds__ctgc__selector_scalar_common_1[1];
          succeeded = mercury__list__member_2_p_0(TypeInfo_31_39, ((MR_Box) (TVar_29)), ExistQVars_25);
        }
        succeeded = !(succeeded);
