      ...
      if (((MR_tag((MR_Word) UnitSelector_9)) == (MR_Integer) 0))
      {
        ...
        else
        {
          ...
          if (succeeded)
          {
            ...
            succeeded = check_hlds__type_util__get_existq_cons_defn_4_p_0(ModuleInfo_5, StartType_6, DuCtor_15, &CtorDefn_16);
          }
          if (succeeded)
          {
      ...
      if (succeeded)
      {
              ...
              else
              {
                ...
                else
                {
                  ...
                  if (succeeded)
                  {
                    ...
                    succeeded = check_hlds__type_util__get_existq_cons_defn_4_p_0(ModuleInfo_6, Type_9, DuCtor_44, &CtorDefn_45);
                  }
                  if (succeeded)
                  {
        ...
        if (((MR_tag((MR_Word) AH_11)) == (MR_Integer) 0))
        {
          ...
          if (succeeded)
          {
            ...
            succeeded = check_hlds__type_util__get_cons_id_non_existential_arg_types_4_p_0(ModuleInfo_6, Type_9, ConsIdA_25, &ArgTypes_66);
            if (succeeded)
            {
            ...
            else
            {
              ...
              if (succeeded)
              {
                ...
                succeeded = check_hlds__type_util__get_existq_cons_defn_4_p_0(ModuleInfo_6, Type_9, DuCtor_67, &CtorDefn_68);
              }
              if (succeeded)
              {
  ...
  MR_Integer Position_9)
{
  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      succeeded = check_hlds__type_util__get_existq_cons_defn_4_p_0(ModuleInfo_6, Type_7, DuCtor_15, &CtorDefn_16);
    }
    if (succeeded)
    {
      MR_Word MaybeExistConstraints_19 = ((MR_Word) ((MR_hl_field(0, CtorDefn_16, 2))));
    ...
    case (MR_Integer) 0:
      {
        ...
        check_hlds__type_util__all_du_ctor_arg_types_3_p_0(ModuleInfo_4, Type_5, &NameArityArgTypesLists_7);
