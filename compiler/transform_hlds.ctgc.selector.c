...
MR_decl_label10(transform_hlds__ctgc__selector__selector_subsumed_by_2_5_0, 271,8,14,13,19,21,26,23,18,11)
MR_decl_label10(transform_hlds__ctgc__selector__selector_subsumed_by_2_5_0, 273,5,38,41,39,47,45,49,36,57)
...
MR_BEGIN_MODULE(transform_hlds__ctgc__selector_module12)
	...
	MR_init_label10(transform_hlds__ctgc__selector__selector_subsumed_by_2_5_0,271,8,14,13,19,21,26,23,18,11)
	MR_init_label10(transform_hlds__ctgc__selector__selector_subsumed_by_2_5_0,273,5,38,41,39,47,45,49,36,57)
...
MR_def_static(transform_hlds__ctgc__selector__selector_subsumed_by_2_5_0)
	...
	MR_incr_sp(8);
	MR_sv(8) = (MR_Word) MR_succip;
MR_def_label(transform_hlds__ctgc__selector__selector_subsumed_by_2_5_0,271)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_def_label(transform_hlds__ctgc__selector__selector_subsumed_by_2_5_0,23)
	...
	MR_r4 = MR_tempr1;
	MR_succip_word = MR_sv(8);
	MR_GOTO_LAB(transform_hlds__ctgc__selector__selector_subsumed_by_2_5_0_i271);
	}
MR_def_label(transform_hlds__ctgc__selector__selector_subsumed_by_2_5_0,18)
	...
	MR_r2 = (MR_Word) MR_string_const("select_subtype: type is both existential and non-existential", 60);
	MR_np_call_localret_ent(require__unexpected_2_0,
		transform_hlds__ctgc__selector__selector_subsumed_by_2_5_0_i273);
MR_def_label(transform_hlds__ctgc__selector__selector_subsumed_by_2_5_0,11)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(transform_hlds__ctgc__selector, encounter_existential_subtype);
	MR_np_call_localret_ent(exception__throw_1_0,
		transform_hlds__ctgc__selector__selector_subsumed_by_2_5_0_i273);
MR_def_label(transform_hlds__ctgc__selector__selector_subsumed_by_2_5_0,273)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_succip_word = MR_sv(8);
	MR_GOTO_LAB(transform_hlds__ctgc__selector__selector_subsumed_by_2_5_0_i271);
