...
transform_hlds__ctgc__selector__IntroducedFrom__func__type_arg_types__349__1_1_f_0(
  MR_Tuple LambdaHeadVar__1_13)
{
  MR_Word LambdaHeadVar__2_14 = ((MR_Word) ((MR_hl_field(0, LambdaHeadVar__1_13, (MR_Integer) 2))));
    ...
    else
    {
      ...
      if (((MR_tag((MR_Word) UnitSelector_9)) == (MR_Integer) 0))
      {
        ...
        else
        {
          ...
          if (succeeded)
          {
            MR_Word MaybeExistConstraints_19 = ((MR_Word) ((MR_hl_field(0, CtorDefn_16, (MR_Integer) 2))));
            MR_Word ExistQVars_21;
            MR_Word ArgTypes_30 = ((MR_Word) ((MR_hl_field(0, CtorDefn_16, (MR_Integer) 3))));
            ...
            else
            {
              ...
              ExistQVars_21 = ((MR_Word) ((MR_hl_field(0, Var_27, (MR_Integer) 0))));
            }
            ...
            if (succeeded)
            {
              TVar_25 = ((MR_Word) ((MR_hl_field(0, SubType0_13, (MR_Integer) 0))));
            ...
            if (succeeded)
            {
              ...
              else
              {
                ...
                else
                {
                  ...
                  if (succeeded)
                  {
                    MR_Word MaybeExistConstraints_48 = ((MR_Word) ((MR_hl_field(0, CtorDefn_45, (MR_Integer) 2))));
                    MR_Word ExistQVars_50;
                    MR_Word ArgTypes_59 = ((MR_Word) ((MR_hl_field(0, CtorDefn_45, (MR_Integer) 3))));
                    ...
                    else
                    {
                      ...
                      ExistQVars_50 = ((MR_Word) ((MR_hl_field(0, Var_56, (MR_Integer) 0))));
                    }
                    ...
                    if (succeeded)
                    {
                      TVar_54 = ((MR_Word) ((MR_hl_field(0, SubType0_40, (MR_Integer) 0))));
        ...
        if (((MR_tag((MR_Word) AH_11)) == (MR_Integer) 0))
        {
          ...
          if (succeeded)
          {
            ...
            else
            {
              ...
              if (succeeded)
              {
                MR_Word MaybeExistConstraints_71 = ((MR_Word) ((MR_hl_field(0, CtorDefn_68, (MR_Integer) 2))));
                MR_Word ExistQVars_73;
                MR_Word ArgTypes_82 = ((MR_Word) ((MR_hl_field(0, CtorDefn_68, (MR_Integer) 3))));
                ...
                else
                {
                  ...
                  ExistQVars_73 = ((MR_Word) ((MR_hl_field(0, Var_79, (MR_Integer) 0))));
                }
                ...
                if (succeeded)
                {
                  TVar_77 = ((MR_Word) ((MR_hl_field(0, SubType0_63, (MR_Integer) 0))));
  ...
  MR_Integer Position_9)
{
  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        TVar_25 = ((MR_Word) ((MR_hl_field(0, SubType0_11, (MR_Integer) 0))));
        TypeInfo_30_33 = (MR_Word) (&transform_hlds__ctgc__selector_scalar_common_1[1]);
        succeeded = mercury__list__member_2_p_0(TypeInfo_30_33, ((MR_Box) (TVar_25)), ExistQVars_21);
      }
      succeeded = !(succeeded);
