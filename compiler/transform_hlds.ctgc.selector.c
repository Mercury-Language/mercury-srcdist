...
MR_decl_label8(fn__transform_hlds__ctgc__selector__type_of_node_3_0, 35,3,8,11,10,6,5,38)
...
MR_BEGIN_MODULE(transform_hlds__ctgc__selector_module7)
	...
	MR_init_label8(fn__transform_hlds__ctgc__selector__type_of_node_3_0,35,3,8,11,10,6,5,38)
MR_BEGIN_CODE
...
MR_def_label(fn__transform_hlds__ctgc__selector__type_of_node_3_0,10)
	...
	MR_np_call_localret_ent(libs__compiler_util__unexpected_2_0,
		fn__transform_hlds__ctgc__selector__type_of_node_3_0_i38);
...
MR_def_label(fn__transform_hlds__ctgc__selector__type_of_node_3_0,38)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_succip_word = MR_sv(4);
	MR_GOTO_LAB(fn__transform_hlds__ctgc__selector__type_of_node_3_0_i35);
#ifdef MR_maybe_local_thread_engine_base
