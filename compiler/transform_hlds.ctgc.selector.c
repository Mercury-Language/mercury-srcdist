        ...
        else
        {
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              ...
              succeeded = mercury__list__member_2_p_0(TypeInfo_29_37, ((MR_Box) (TVar_29)), ExistQVars_25);
            }
            succeeded = !(succeeded);
          }
          else
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              ...
              else
              {
                ...
                succeeded = check_hlds__type_util__get_cons_id_non_existential_arg_types_4_p_0(ModuleInfo_6, Type_9, ConsIdA_15, &ArgTypes_53);
                if (succeeded)
                {
                  MR_Box conv0_SubType0_45;

                  conv0_SubType0_45 = mercury__list__det_index1_2_f_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0), ArgTypes_53, IndexA_16);
                  SubType0_45 = ((MR_Word) (conv0_SubType0_45));
                  succeeded = MR_TRUE;
                }
                else
                {
                  ...
                  succeeded = check_hlds__type_util__get_existq_cons_defn_4_p_0(ModuleInfo_6, Type_9, ConsIdA_15, &CtorDefn_54);
                  if (succeeded)
                  {
                    MR_Word MaybeExistConstraints_57 = ((MR_Word) ((MR_hl_field(MR_mktag(0), CtorDefn_54, (MR_Integer) 2))));
                    MR_Word ExistQVars_59;
                    MR_Word ArgTypes_68 = ((MR_Word) ((MR_hl_field(MR_mktag(0), CtorDefn_54, (MR_Integer) 3))));
                    MR_Box conv1_SubType0_45;
                    MR_Word TypeInfo_29_71;
                    MR_Word TVar_63;

                    if ((MaybeExistConstraints_57 == (MR_Word) ((MR_Unsigned) 0U)))
                      ExistQVars_59 = (MR_Word) ((MR_Unsigned) 0U);
                    else
                    {
                      MR_Word Var_65 = (MR_Word) (MR_body((MR_Word) (MaybeExistConstraints_57), (MR_Integer) 1));

                      ExistQVars_59 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_65, (MR_Integer) 0))));
                    }
                    conv1_SubType0_45 = mercury__list__det_index1_2_f_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0), ArgTypes_68, IndexA_16);
                    SubType0_45 = ((MR_Word) (conv1_SubType0_45));
                    succeeded = ((MR_tag((MR_Word) SubType0_45)) == (MR_Integer) 0);
                    if (succeeded)
                    {
                      TVar_63 = ((MR_Word) ((MR_hl_field(MR_mktag(0), SubType0_45, (MR_Integer) 0))));
                      TypeInfo_29_71 = (MR_Word) (&transform_hlds__ctgc__selector_scalar_common_1[1]);
                      succeeded = mercury__list__member_2_p_0(TypeInfo_29_71, ((MR_Box) (TVar_63)), ExistQVars_59);
                    }
                    succeeded = !(succeeded);
                  }
                  else
          ...
          if (succeeded)
          {
            ...
            else
            {
              ...
              else
              {
                ...
                transform_hlds__ctgc__selector__type_contains_subtype_1_4_p_0(ModuleInfo_6, SubTypeA_23, SubTypeB_22, &Contains_75);
                succeeded = (Contains_75 == (MR_Integer) 1);
              }
              if (succeeded)
              {
                // direct tailcall eliminated
        ...
        {
          MR_Word Var_33 = ((MR_Word) ((MR_hl_field(MR_mktag(1), AH_11, (MR_Integer) 0))));
          ...
          if (((MR_tag((MR_Word) BH_13)) == (MR_Integer) 0))
          {
            ...
            else
            {
              ...
              else
              {
                ...
                transform_hlds__ctgc__selector__type_contains_subtype_1_4_p_0(ModuleInfo_6, SubTypeB_29, Var_33, &Contains_80);
          ...
          else
          {
            ...
            else
            {
              ...
              else
              {
                ...
                transform_hlds__ctgc__selector__type_contains_subtype_1_4_p_0(ModuleInfo_6, SubTypeB_31, Var_33, &Contains_85);
    ...
    case (MR_Integer) 0:
      {
        ...
        else
        {
...

          {
            ...
            MR_hl_field(MR_mktag(0), Var_24, 0) = ((MR_Box) (Type_6));
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(1), BranchMap1_9, 0) = ((MR_Box) (Var_24));
        ...
        CatUser_15 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(3), CtorCat_14, (MR_Integer) 1))) & (MR_Integer) 7);
        {
          ...
          if (succeeded)
          {
            ...
            else
            {
...

              {
                ...
                MR_hl_field(MR_mktag(1), Var_34, 0) = ((MR_Box) (UnitSelector_12));
              ...
              mercury__list__append_3_p_1((MR_Word) (&parse_tree__prog_data_pragma__parse_tree__prog_data_pragma__type_ctor_info_unit_selector_0), SelectorAcc0_10, Var_34, &SelectorAcc1_22);
              {
                ...
                MR_hl_field(MR_mktag(0), Var_50, 0) = ((MR_Box) (CType_20));
                MR_hl_field(MR_mktag(0), Var_50, 1) = ((MR_Box) (SelectorAcc1_22));
              }
              {
                BranchMap1_23 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, (2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(1), BranchMap1_23, 0) = ((MR_Box) (Var_50));
          ...
          else
          {
...

            {
              ...
              MR_hl_field(MR_mktag(1), Var_37, 0) = ((MR_Box) (UnitSelector_12));
