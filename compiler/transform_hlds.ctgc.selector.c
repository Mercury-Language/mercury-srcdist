...
{
  {
    ...
    if ((Selector0_7 == (MR_Word) ((MR_Integer) 0)))
      *Selector_8 = (MR_Word) ((MR_Integer) 0);
    else
    {
      MR_Word SubType_11;
  ...
  MR_Word * SubType_8)
{
  while (MR_TRUE)
  {
    ...
    ;
    if ((Selector_7 == (MR_Word) ((MR_Integer) 0)))
    {
      ...
      if (((MR_tag((MR_Word) UnitSelector_9)) == (MR_mktag((MR_Integer) 0))))
      {
        ...
        else
        {
          ...
          if (succeeded)
          {
            ...
            if ((MaybeExistConstraints_23 == (MR_Word) ((MR_Integer) 0)))
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                *Extension_10 = (MR_Word) ((MR_Integer) 0);
                succeeded = MR_TRUE;
              }
              else
              {
                ...
                else
                {
                  ...
                  if (succeeded)
                  {
                    ...
                    if ((MaybeExistConstraints_61 == (MR_Word) ((MR_Integer) 0)))
                      ExistQVars_63 = (MR_Word) ((MR_Integer) 0);
                    else
                    {
      ...
      case (MR_Integer) 0:
        {
          ...
          else
          {
            ...
            }
            {
              ...
              MR_hl_field(MR_mktag(1), BranchMap1_9, 1) = ((MR_Box) ((MR_Integer) 0));
            }
            transform_hlds__ctgc__selector__do_normalize_selector_6_p_0(ModuleInfo_5, Type_6, BranchMap1_9, (MR_Word) ((MR_Integer) 0), STATE_VARIABLE_Selector_0_10, STATE_VARIABLE_Selector_11);
          }
{
#define MR_PROC_LABEL transform_hlds__ctgc__selector__normalize_selector_with_type_information_4_p_0
  ...
  MR_Word * STATE_VARIABLE_Selector_25)
{
  while (MR_TRUE)
  {
    ...
    // setup for model_det tailcalls optimized into a loop
    ;
    if ((STATE_VARIABLE_Selector_0_24 == (MR_Word) ((MR_Integer) 0)))
