...
#endif
#line 68 "transform_hlds.ctgc.selector.c"
...
MR_decl_label1(transform_hlds__ctgc__selector__IntroducedFrom__pred__type_arg_types__326__1_3_0, 1)
MR_decl_label6(transform_hlds__ctgc__selector__branch_map_search_3_0, 27,4,6,8,5,1)
MR_decl_label10(transform_hlds__ctgc__selector__do_normalize_selector_6_0, 71,3,4,8,9,7,15,18,17,14)
...
MR_decl_label3(transform_hlds__ctgc__selector__selector_apply_widening_4_0, 22,6,4)
MR_decl_label7(transform_hlds__ctgc__selector__selector_subsumed_by_6_0, 3,4,5,2,7,9,6)
MR_decl_label10(transform_hlds__ctgc__selector__selector_subsumed_by_2_5_0, 245,8,14,13,19,21,26,23,18,11)
MR_decl_label10(transform_hlds__ctgc__selector__selector_subsumed_by_2_5_0, 247,5,38,41,39,47,45,49,36,57)
MR_decl_label10(transform_hlds__ctgc__selector__selector_subsumed_by_2_5_0, 60,156,58,66,64,68,56,76,74,84)
MR_decl_label10(transform_hlds__ctgc__selector__selector_subsumed_by_2_5_0, 82,86,88,89,92,80,96,94,98,1)
...
MR_decl_label10(transform_hlds__ctgc__selector__type_of_node_4_0, 52,8,6,13,15,20,17,11,5,54)
...
MR_decl_label2(fn__transform_hlds__ctgc__selector__selector_init_2_0, 3,5)
...
MR_decl_static(fn__transform_hlds__ctgc__selector__IntroducedFrom__func__selector_init_from_list__133__1_1_0)
MR_decl_static(transform_hlds__ctgc__selector__IntroducedFrom__pred__type_arg_types__326__1_3_0)
...
{
MR_COMMON(3,0),
MR_ENTRY_AP(fn__transform_hlds__ctgc__selector__IntroducedFrom__func__selector_init_from_list__133__1_1_0),
0
},
};
...
MR_BEGIN_MODULE(transform_hlds__ctgc__selector_module1)
	...
	MR_init_label2(fn__transform_hlds__ctgc__selector__selector_init_2_0,3,5)
MR_BEGIN_CODE
...
MR_define_entry(mercury__fn__transform_hlds__ctgc__selector__selector_init_2_0);
	...
	MR_COMPUTED_GOTO((MR_Unsigned) MR_tag(MR_r1),
		MR_LABEL_AP(fn__transform_hlds__ctgc__selector__selector_init_2_0_i3) MR_AND
		MR_LABEL_AP(fn__transform_hlds__ctgc__selector__selector_init_2_0_i5) MR_AND
		MR_LABEL_AP(fn__transform_hlds__ctgc__selector__selector_init_2_0_i5) MR_AND
		MR_LABEL_AP(fn__transform_hlds__ctgc__selector__selector_init_2_0_i3));
...
MR_def_label(fn__transform_hlds__ctgc__selector__selector_init_2_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
...
MR_BEGIN_MODULE(transform_hlds__ctgc__selector_module5)
	...
	MR_init_label10(transform_hlds__ctgc__selector__do_normalize_selector_6_0,71,3,4,8,9,7,15,18,17,14)
...
#undef	MR_PROC_LABEL
	...
	MR_tfield(0, MR_tempr1, 1) = (MR_Word) MR_ENTRY_AP(transform_hlds__ctgc__selector__IntroducedFrom__pred__type_arg_types__326__1_3_0);
...
MR_BEGIN_MODULE(transform_hlds__ctgc__selector_module12)
	...
	MR_init_label10(transform_hlds__ctgc__selector__selector_subsumed_by_2_5_0,245,8,14,13,19,21,26,23,18,11)
	MR_init_label10(transform_hlds__ctgc__selector__selector_subsumed_by_2_5_0,247,5,38,41,39,47,45,49,36,57)
	MR_init_label10(transform_hlds__ctgc__selector__selector_subsumed_by_2_5_0,60,156,58,66,64,68,56,76,74,84)
	MR_init_label10(transform_hlds__ctgc__selector__selector_subsumed_by_2_5_0,82,86,88,89,92,80,96,94,98,1)
MR_BEGIN_CODE
...
MR_def_static(transform_hlds__ctgc__selector__selector_subsumed_by_2_5_0)
	...
	MR_incr_sp(8);
	MR_sv(8) = (MR_Word) MR_succip;
MR_def_label(transform_hlds__ctgc__selector__selector_subsumed_by_2_5_0,245)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TEST(MR_r3,0,0)) {
		MR_GOTO_LAB(transform_hlds__ctgc__selector__selector_subsumed_by_2_5_0_i156);
	}
...
MR_def_label(transform_hlds__ctgc__selector__selector_subsumed_by_2_5_0,8)
	...
	MR_r3 = MR_sv(3);
	MR_np_call_localret_ent(check_hlds__type_util__get_cons_id_non_existential_arg_types_4_0,
		transform_hlds__ctgc__selector__selector_subsumed_by_2_5_0_i14);
MR_def_label(transform_hlds__ctgc__selector__selector_subsumed_by_2_5_0,14)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(transform_hlds__ctgc__selector__selector_subsumed_by_2_5_0_i13);
	}
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(parse_tree__prog_data, mer_type);
	MR_r3 = MR_sv(6);
	MR_np_call_localret_ent(fn__list__det_index1_2_0,
		transform_hlds__ctgc__selector__selector_subsumed_by_2_5_0_i23);
...
MR_def_label(transform_hlds__ctgc__selector__selector_subsumed_by_2_5_0,19)
	...
	MR_r3 = MR_sv(6);
	MR_np_call_localret_ent(fn__list__det_index1_2_0,
		transform_hlds__ctgc__selector__selector_subsumed_by_2_5_0_i21);
MR_def_label(transform_hlds__ctgc__selector__selector_subsumed_by_2_5_0,21)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_r1,0)) {
...
MR_def_label(transform_hlds__ctgc__selector__selector_subsumed_by_2_5_0,23)
	...
	MR_r4 = MR_tempr1;
	MR_succip_word = MR_sv(8);
	MR_GOTO_LAB(transform_hlds__ctgc__selector__selector_subsumed_by_2_5_0_i245);
	}
MR_def_label(transform_hlds__ctgc__selector__selector_subsumed_by_2_5_0,18)
	...
	MR_r2 = (MR_Word) MR_string_const("select_subtype: type is both existential and non-existential", 60);
	MR_np_call_localret_ent(libs__compiler_util__unexpected_2_0,
		transform_hlds__ctgc__selector__selector_subsumed_by_2_5_0_i247);
MR_def_label(transform_hlds__ctgc__selector__selector_subsumed_by_2_5_0,11)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(transform_hlds__ctgc__selector, encounter_existential_subtype);
	MR_np_call_localret_ent(exception__throw_1_0,
		transform_hlds__ctgc__selector__selector_subsumed_by_2_5_0_i247);
MR_def_label(transform_hlds__ctgc__selector__selector_subsumed_by_2_5_0,247)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_succip_word = MR_sv(8);
	MR_GOTO_LAB(transform_hlds__ctgc__selector__selector_subsumed_by_2_5_0_i245);
MR_def_label(transform_hlds__ctgc__selector__selector_subsumed_by_2_5_0,5)
	...
	if (MR_PTAG_TESTR(MR_r6,0)) {
		MR_GOTO_LAB(transform_hlds__ctgc__selector__selector_subsumed_by_2_5_0_i36);
	}
	...
	MR_np_call_localret_ent(fn__transform_hlds__ctgc__selector__det_select_subtype_4_0,
		transform_hlds__ctgc__selector__selector_subsumed_by_2_5_0_i38);
MR_def_label(transform_hlds__ctgc__selector__selector_subsumed_by_2_5_0,38)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(6) = MR_r1;
	MR_r2 = MR_sv(2);
	MR_np_call_localret_ent(__Unify___parse_tree__prog_data__mer_type_0_0,
		transform_hlds__ctgc__selector__selector_subsumed_by_2_5_0_i41);
MR_def_label(transform_hlds__ctgc__selector__selector_subsumed_by_2_5_0,41)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(transform_hlds__ctgc__selector__selector_subsumed_by_2_5_0_i39);
	}
	MR_r1 = MR_sv(1);
	MR_r2 = MR_sv(4);
	MR_r3 = MR_sv(5);
	...
	MR_succip_word = MR_sv(8);
	MR_GOTO_LAB(transform_hlds__ctgc__selector__selector_subsumed_by_2_5_0_i245);
MR_def_label(transform_hlds__ctgc__selector__selector_subsumed_by_2_5_0,39)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(6);
	MR_r2 = MR_sv(2);
	MR_np_call_localret_ent(__Unify___parse_tree__prog_data__mer_type_0_0,
...
MR_def_label(transform_hlds__ctgc__selector__selector_subsumed_by_2_5_0,45)
	...
	MR_np_call_localret_ent(transform_hlds__ctgc__selector__type_contains_subtype_1_4_0,
		transform_hlds__ctgc__selector__selector_subsumed_by_2_5_0_i49);
MR_def_label(transform_hlds__ctgc__selector__selector_subsumed_by_2_5_0,49)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	...
	MR_succip_word = MR_sv(8);
	MR_GOTO_LAB(transform_hlds__ctgc__selector__selector_subsumed_by_2_5_0_i245);
MR_def_label(transform_hlds__ctgc__selector__selector_subsumed_by_2_5_0,36)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_r5,0)) {
		MR_GOTO_LAB(transform_hlds__ctgc__selector__selector_subsumed_by_2_5_0_i56);
	}
	MR_sv(1) = MR_r1;
	MR_sv(2) = MR_r2;
	...
	MR_np_call_localret_ent(fn__transform_hlds__ctgc__selector__det_select_subtype_4_0,
		transform_hlds__ctgc__selector__selector_subsumed_by_2_5_0_i57);
MR_def_label(transform_hlds__ctgc__selector__selector_subsumed_by_2_5_0,57)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(3) = MR_r1;
	MR_r1 = MR_sv(7);
	MR_r2 = MR_sv(3);
	MR_np_call_localret_ent(__Unify___parse_tree__prog_data__mer_type_0_0,
		transform_hlds__ctgc__selector__selector_subsumed_by_2_5_0_i60);
MR_def_label(transform_hlds__ctgc__selector__selector_subsumed_by_2_5_0,60)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(transform_hlds__ctgc__selector__selector_subsumed_by_2_5_0_i58);
	}
	MR_r1 = MR_sv(1);
	MR_r2 = MR_sv(4);
	MR_r3 = MR_sv(5);
	...
	MR_succip_word = MR_sv(8);
	MR_GOTO_LAB(transform_hlds__ctgc__selector__selector_subsumed_by_2_5_0_i245);
MR_def_label(transform_hlds__ctgc__selector__selector_subsumed_by_2_5_0,156)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_TRUE;
	MR_decr_sp_and_return(8);
MR_def_label(transform_hlds__ctgc__selector__selector_subsumed_by_2_5_0,58)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(3);
	MR_r2 = MR_sv(7);
	MR_np_call_localret_ent(__Unify___parse_tree__prog_data__mer_type_0_0,
...
MR_def_label(transform_hlds__ctgc__selector__selector_subsumed_by_2_5_0,64)
	...
	MR_r3 = MR_sv(7);
	MR_np_call_localret_ent(transform_hlds__ctgc__selector__type_contains_subtype_1_4_0,
		transform_hlds__ctgc__selector__selector_subsumed_by_2_5_0_i68);
MR_def_label(transform_hlds__ctgc__selector__selector_subsumed_by_2_5_0,68)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,1)) {
		MR_GOTO_LAB(transform_hlds__ctgc__selector__selector_subsumed_by_2_5_0_i1);
	}
	...
	MR_succip_word = MR_sv(8);
	MR_GOTO_LAB(transform_hlds__ctgc__selector__selector_subsumed_by_2_5_0_i245);
MR_def_label(transform_hlds__ctgc__selector__selector_subsumed_by_2_5_0,56)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
	...
	MR_np_call_localret_ent(__Unify___parse_tree__prog_data__mer_type_0_0,
		transform_hlds__ctgc__selector__selector_subsumed_by_2_5_0_i76);
MR_def_label(transform_hlds__ctgc__selector__selector_subsumed_by_2_5_0,76)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(transform_hlds__ctgc__selector__selector_subsumed_by_2_5_0_i74);
	}
	MR_r1 = MR_sv(1);
	MR_r2 = MR_sv(4);
	MR_r3 = MR_sv(5);
...
MR_def_label(transform_hlds__ctgc__selector__selector_subsumed_by_2_5_0,74)
	...
	MR_np_call_localret_ent(__Unify___parse_tree__prog_data__mer_type_0_0,
		transform_hlds__ctgc__selector__selector_subsumed_by_2_5_0_i84);
MR_def_label(transform_hlds__ctgc__selector__selector_subsumed_by_2_5_0,84)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(transform_hlds__ctgc__selector__selector_subsumed_by_2_5_0_i82);
	}
	MR_r1 = MR_sv(1);
	MR_r2 = MR_sv(2);
	MR_r3 = MR_sv(5);
...
MR_def_label(transform_hlds__ctgc__selector__selector_subsumed_by_2_5_0,82)
	...
	MR_np_call_localret_ent(transform_hlds__ctgc__selector__type_contains_subtype_1_4_0,
		transform_hlds__ctgc__selector__selector_subsumed_by_2_5_0_i86);
...
MR_def_label(transform_hlds__ctgc__selector__selector_subsumed_by_2_5_0,80)
	...
	MR_np_call_localret_ent(__Unify___parse_tree__prog_data__mer_type_0_0,
		transform_hlds__ctgc__selector__selector_subsumed_by_2_5_0_i96);
MR_def_label(transform_hlds__ctgc__selector__selector_subsumed_by_2_5_0,96)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
...
MR_BEGIN_MODULE(transform_hlds__ctgc__selector_module14)
	...
	MR_init_label10(transform_hlds__ctgc__selector__type_of_node_4_0,52,8,6,13,15,20,17,11,5,54)
...
MR_BEGIN_MODULE(transform_hlds__ctgc__selector_module15)
	...
	MR_init_label3(transform_hlds__ctgc__selector__selector_apply_widening_4_0,22,6,4)
MR_BEGIN_CODE
...
MR_define_entry(mercury__transform_hlds__ctgc__selector__selector_apply_widening_4_0);
	...
	if (MR_LTAGS_TESTR(MR_r3,0,0)) {
		MR_GOTO_LAB(transform_hlds__ctgc__selector__selector_apply_widening_4_0_i22);
	}
	MR_r1 = (MR_Word) MR_tbmkword(0, 0);
	MR_proceed();
MR_def_label(transform_hlds__ctgc__selector__selector_apply_widening_4_0,22)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(2);
...
#line 2405 "transform_hlds.ctgc.selector.c"
#undef	MR_PROC_LABEL
	}
	MR_proceed();
#ifdef MR_maybe_local_thread_engine_base
...
#line 2434 "transform_hlds.ctgc.selector.c"
#undef	MR_PROC_LABEL
	}
	MR_proceed();
#ifdef MR_maybe_local_thread_engine_base
...
MR_BEGIN_MODULE(transform_hlds__ctgc__selector_module25)
	MR_init_entry1(fn__transform_hlds__ctgc__selector__IntroducedFrom__func__selector_init_from_list__133__1_1_0);
	MR_INIT_PROC_LAYOUT_ADDR(mercury__fn__transform_hlds__ctgc__selector__IntroducedFrom__func__selector_init_from_list__133__1_1_0);
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'IntroducedFrom__func__selector_init_from_list__133__1'/2 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(fn__transform_hlds__ctgc__selector__IntroducedFrom__func__selector_init_from_list__133__1_1_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 1, (MR_Integer) 1);
...
MR_BEGIN_MODULE(transform_hlds__ctgc__selector_module26)
	MR_init_entry1(transform_hlds__ctgc__selector__IntroducedFrom__pred__type_arg_types__326__1_3_0);
	MR_INIT_PROC_LAYOUT_ADDR(mercury__transform_hlds__ctgc__selector__IntroducedFrom__pred__type_arg_types__326__1_3_0);
	MR_init_label1(transform_hlds__ctgc__selector__IntroducedFrom__pred__type_arg_types__326__1_3_0,1)
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'IntroducedFrom__pred__type_arg_types__326__1'/3 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(transform_hlds__ctgc__selector__IntroducedFrom__pred__type_arg_types__326__1_3_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_mkframe("pred transform_hlds.ctgc.selector.IntroducedFrom__pred__type_arg_types__326__1/3-0", 0,
		MR_ENTRY(MR_do_fail));
	MR_np_call_localret_ent(check_hlds__type_util__cons_id_arg_types_4_0,
		transform_hlds__ctgc__selector__IntroducedFrom__pred__type_arg_types__326__1_3_0_i1);
MR_def_label(transform_hlds__ctgc__selector__IntroducedFrom__pred__type_arg_types__326__1_3_0,1)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_r2;
	MR_succeed();
#ifdef MR_maybe_local_thread_engine_base
