...
static void MR_CALL 
transform_hlds__ctgc__selector__IntroducedFrom__pred__type_arg_types__351__1_3_p_0(
      ...
      if (((MR_tag((MR_Word) UnitSelector_9)) == (MR_mktag((MR_Integer) 0))))
      {
        ...
        else
        {
          ...
          if (succeeded)
          {
            ...
            MR_Word ArgTypes_33 = ((MR_Word) (MR_hl_field(MR_mktag(0), CtorDefn_20, (MR_Integer) 3)));
            MR_Word _TVarSet_21 = ((MR_Word) (MR_hl_field(MR_mktag(0), CtorDefn_20, (MR_Integer) 0)));
            MR_Word _KindMap_22 = ((MR_Word) (MR_hl_field(MR_mktag(0), CtorDefn_20, (MR_Integer) 1)));
            MR_Word _RetType_24 = ((MR_Word) (MR_hl_field(MR_mktag(0), CtorDefn_20, (MR_Integer) 4)));
            MR_Box conv1_SubType0_13;
            MR_Word TypeInfo_29_37;
            MR_Word TVar_27;
            MR_Word Var_28;

            if ((MaybeExistConstraints_23 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
              ExistQVars_25 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
            else
            {
              MR_Word Var_29 = (MR_Word) MR_body(((MR_Word) MaybeExistConstraints_23), (MR_Integer) 1);
              MR_Word Var_26;

              ExistQVars_25 = ((MR_Word) (MR_hl_field(MR_mktag(0), Var_29, (MR_Integer) 0)));
              Var_26 = ((MR_Word) (MR_hl_field(MR_mktag(0), Var_29, (MR_Integer) 1)));
            }
            conv1_SubType0_13 = mercury__list__det_index1_2_f_0((MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0, ArgTypes_33, Index_12);
            SubType0_13 = ((MR_Word) conv1_SubType0_13);
            succeeded = ((MR_tag((MR_Word) SubType0_13)) == (MR_mktag((MR_Integer) 0)));
            if (succeeded)
            {
              TVar_27 = ((MR_Word) (MR_hl_field(MR_mktag(0), SubType0_13, (MR_Integer) 0)));
              Var_28 = ((MR_Word) (MR_hl_field(MR_mktag(0), SubType0_13, (MR_Integer) 1)));
              TypeInfo_29_37 = (MR_Word) &transform_hlds__ctgc__selector_scalar_common_1[1];
              succeeded = mercury__list__member_2_p_0(TypeInfo_29_37, ((MR_Box) (TVar_27)), ExistQVars_25);
            }
            succeeded = !(succeeded);
          }
          else
              ...
              else
              {
                ...
                else
                {
                  ...
                  if (succeeded)
                  {
                    ...
                    MR_Word ArgTypes_71 = ((MR_Word) (MR_hl_field(MR_mktag(0), CtorDefn_58, (MR_Integer) 3)));
                    MR_Word _TVarSet_59 = ((MR_Word) (MR_hl_field(MR_mktag(0), CtorDefn_58, (MR_Integer) 0)));
                    MR_Word _KindMap_60 = ((MR_Word) (MR_hl_field(MR_mktag(0), CtorDefn_58, (MR_Integer) 1)));
                    MR_Word _RetType_62 = ((MR_Word) (MR_hl_field(MR_mktag(0), CtorDefn_58, (MR_Integer) 4)));
                    MR_Box conv1_SubType0_49;
                    MR_Word TypeInfo_29_75;
                    MR_Word TVar_65;
                    MR_Word Var_66;

                    if ((MaybeExistConstraints_61 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
                      ExistQVars_63 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
                    else
                    {
                      MR_Word Var_67 = (MR_Word) MR_body(((MR_Word) MaybeExistConstraints_61), (MR_Integer) 1);
                      MR_Word Var_64;

                      ExistQVars_63 = ((MR_Word) (MR_hl_field(MR_mktag(0), Var_67, (MR_Integer) 0)));
                      Var_64 = ((MR_Word) (MR_hl_field(MR_mktag(0), Var_67, (MR_Integer) 1)));
                    }
                    conv1_SubType0_49 = mercury__list__det_index1_2_f_0((MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0, ArgTypes_71, IndexA_16);
                    SubType0_49 = ((MR_Word) conv1_SubType0_49);
                    succeeded = ((MR_tag((MR_Word) SubType0_49)) == (MR_mktag((MR_Integer) 0)));
                    if (succeeded)
                    {
                      TVar_65 = ((MR_Word) (MR_hl_field(MR_mktag(0), SubType0_49, (MR_Integer) 0)));
                      Var_66 = ((MR_Word) (MR_hl_field(MR_mktag(0), SubType0_49, (MR_Integer) 1)));
                      TypeInfo_29_75 = (MR_Word) &transform_hlds__ctgc__selector_scalar_common_1[1];
                      succeeded = mercury__list__member_2_p_0(TypeInfo_29_75, ((MR_Box) (TVar_65)), ExistQVars_63);
                    }
                    succeeded = !(succeeded);
                  }
                  else
          ...
          if (succeeded)
          {
            ...
            else
            {
              ...
              else
              {
                ...
                transform_hlds__ctgc__selector__type_contains_subtype_1_4_p_0(ModuleInfo_6, SubTypeA_23, SubTypeB_22, &Contains_79);
                succeeded = (Contains_79 == (MR_Integer) 1);
              }
              if (succeeded)
              {
                // direct tailcall eliminated
          ...
          if (((MR_tag((MR_Word) BH_13)) == (MR_mktag((MR_Integer) 0))))
          {
            ...
            else
            {
              ...
              else
              {
                ...
                transform_hlds__ctgc__selector__type_contains_subtype_1_4_p_0(ModuleInfo_6, SubTypeB_29, Var_37, &Contains_84);
          ...
          else
          {
            ...
            else
            {
              ...
              else
              {
                ...
                transform_hlds__ctgc__selector__type_contains_subtype_1_4_p_0(ModuleInfo_6, SubTypeB_31, Var_37, &Contains_89);
                succeeded = (Contains_89 == (MR_Integer) 1);
              }
              if (succeeded)
              ...
              else
              {
                ...
                else
                {
                  ...
                  transform_hlds__ctgc__selector__type_contains_subtype_1_4_p_0(ModuleInfo_6, Var_37, SubTypeB_31, &Contains_94);
                  succeeded = (Contains_94 == (MR_Integer) 1);
                }
                if (succeeded)
                {
                  // direct tailcall eliminated
...
{
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        conv1_SubType0_11 = mercury__list__det_index1_2_f_0((MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0, ArgTypes_33, Position_9);
        SubType0_11 = ((MR_Word) conv1_SubType0_11);
        succeeded = ((MR_tag((MR_Word) SubType0_11)) == (MR_mktag((MR_Integer) 0)));
        if (succeeded)
        {
          TVar_27 = ((MR_Word) (MR_hl_field(MR_mktag(0), SubType0_11, (MR_Integer) 0)));
          Var_28 = ((MR_Word) (MR_hl_field(MR_mktag(0), SubType0_11, (MR_Integer) 1)));
          TypeInfo_29_37 = (MR_Word) &transform_hlds__ctgc__selector_scalar_common_1[1];
          succeeded = mercury__list__member_2_p_0(TypeInfo_29_37, ((MR_Box) (TVar_27)), ExistQVars_25);
        }
        succeeded = !(succeeded);
        ...
        CatUser_15 = ((MR_Word) (MR_hl_field(MR_mktag(3), CtorCat_14, (MR_Integer) 1)));
        {
          ...
          switch (CatUser_15) {
            ...
            case (MR_Integer) 1:
              {
                {
                  mercury__require__unexpected_3_p_0((MR_String) "transform_hlds.ctgc.selector", (MR_String) "predicate \140transform_hlds.ctgc.selector.do_normalize_selector\'/6", (MR_String) "cat_user_abstract_dummy");
                  return;
                }
              }
              break;
          ...
          if (((MR_tag((MR_Word) UnitSelector_12)) == (MR_mktag((MR_Integer) 0))))
          {
            ...
            if (succeeded)
            {
              ...
              succeeded = mercury__list__index1_3_p_0(TypeCtorInfo_45_45, ArgTypes_18, Index_17, &conv0_SubType_19);
              if (succeeded)
              {
          ...
          if (succeeded)
          {
            ...
            else
            {
              ...
              mercury__list__append_3_p_1((MR_Word) &parse_tree__prog_data_pragma__parse_tree__prog_data_pragma__type_ctor_info_unit_selector_0, SelectorAcc0_10, Var_38, &SelectorAcc1_22);
              {
                Var_55 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
                MR_hl_field(MR_mktag(0), Var_55, 0) = ((MR_Box) (CType_20));
                MR_hl_field(MR_mktag(0), Var_55, 1) = ((MR_Box) (SelectorAcc1_22));
              }
              {
                BranchMap1_23 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
                MR_hl_field(MR_mktag(1), BranchMap1_23, 0) = ((MR_Box) (Var_55));
          ...
          else
          {
...

            {
              ...
              MR_hl_field(MR_mktag(1), Var_41, 0) = ((MR_Box) (UnitSelector_12));
              MR_hl_field(MR_mktag(1), Var_41, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
            }
            mercury__list__append_3_p_1((MR_Word) &parse_tree__prog_data_pragma__parse_tree__prog_data_pragma__type_ctor_info_unit_selector_0, SelectorAcc0_10, Var_41, STATE_VARIABLE_Selector_25);
          }
        }
      }
      else
