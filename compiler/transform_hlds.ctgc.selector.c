...
static void MR_CALL 
transform_hlds__ctgc__selector__IntroducedFrom__pred__type_arg_types__357__1_3_p_0(
...
{
  {
    ...
    (env).transform_hlds__ctgc__selector__type_arg_types_3_p_0_2_env_0__cont_env_ptr = cont_env_ptr;
    {
      ...
      transform_hlds__ctgc__selector__IntroducedFrom__pred__type_arg_types__357__1_3_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4)))), &(env).transform_hlds__ctgc__selector__type_arg_types_3_p_0_2_env_0__conv0_LambdaHeadVar__1_11, transform_hlds__ctgc__selector__type_arg_types_3_p_0_1, &env);
    }
  }
}
