...
MR_decl_label1(transform_hlds__ctgc__selector__IntroducedFrom__pred__type_arg_types__337__1_3_0, 1)
...
MR_decl_static(transform_hlds__ctgc__selector__IntroducedFrom__pred__type_arg_types__337__1_3_0)
...
#undef	MR_PROC_LABEL
	...
	MR_tfield(0, MR_tempr1, 1) = (MR_Word) MR_ENTRY_AP(transform_hlds__ctgc__selector__IntroducedFrom__pred__type_arg_types__337__1_3_0);
...
MR_BEGIN_MODULE(transform_hlds__ctgc__selector_module26)
	MR_init_entry1(transform_hlds__ctgc__selector__IntroducedFrom__pred__type_arg_types__337__1_3_0);
	MR_INIT_PROC_LAYOUT_ADDR(mercury__transform_hlds__ctgc__selector__IntroducedFrom__pred__type_arg_types__337__1_3_0);
	MR_init_label1(transform_hlds__ctgc__selector__IntroducedFrom__pred__type_arg_types__337__1_3_0,1)
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'IntroducedFrom__pred__type_arg_types__337__1'/3 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(transform_hlds__ctgc__selector__IntroducedFrom__pred__type_arg_types__337__1_3_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_mkframe("pred transform_hlds.ctgc.selector.IntroducedFrom__pred__type_arg_types__337__1/3-0", 0,
		MR_ENTRY(MR_do_fail));
	MR_np_call_localret_ent(check_hlds__type_util__cons_id_arg_types_4_0,
		transform_hlds__ctgc__selector__IntroducedFrom__pred__type_arg_types__337__1_3_0_i1);
MR_def_label(transform_hlds__ctgc__selector__IntroducedFrom__pred__type_arg_types__337__1_3_0,1)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_r2;
	MR_succeed();
#ifdef MR_maybe_local_thread_engine_base
