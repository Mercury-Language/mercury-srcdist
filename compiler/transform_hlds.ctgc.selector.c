...
MR_decl_label1(transform_hlds__ctgc__selector__IntroducedFrom__pred__type_arg_types__339__1_3_0, 1)
MR_decl_label6(transform_hlds__ctgc__selector__branch_map_search_3_0, 32,3,5,7,4,1)
...
MR_decl_label6(transform_hlds__ctgc__selector__normalize_selector_with_type_information_4_0, 6,4,10,11,3,12)
...
MR_decl_label10(transform_hlds__ctgc__selector__selector_subsumed_by_2_5_0, 288,8,13,11,19,18,24,26,30,28)
MR_decl_label10(transform_hlds__ctgc__selector__selector_subsumed_by_2_5_0, 23,16,291,5,43,46,44,52,50,54)
MR_decl_label10(transform_hlds__ctgc__selector__selector_subsumed_by_2_5_0, 41,62,65,165,63,71,69,73,61,81)
MR_decl_label10(transform_hlds__ctgc__selector__selector_subsumed_by_2_5_0, 79,89,87,91,93,94,97,85,101,99)
MR_decl_label2(transform_hlds__ctgc__selector__selector_subsumed_by_2_5_0, 103,1)
MR_decl_label4(transform_hlds__ctgc__selector__type_arg_types_3_0, 5,6,3,7)
...
MR_decl_label10(transform_hlds__ctgc__selector__type_of_node_4_0, 63,8,6,13,15,19,17,11,5,65)
MR_decl_label2(transform_hlds__ctgc__selector__type_of_node_4_0, 2,1)
MR_decl_label8(fn__transform_hlds__ctgc__selector__det_select_subtype_4_0, 5,3,9,11,15,8,2,21)
...
MR_decl_static(fn__transform_hlds__ctgc__selector__IntroducedFrom__func__selector_init_from_list__135__1_1_0)
MR_decl_static(transform_hlds__ctgc__selector__IntroducedFrom__pred__type_arg_types__339__1_3_0)
...
{
MR_COMMON(3,0),
MR_ENTRY_AP(fn__transform_hlds__ctgc__selector__IntroducedFrom__func__selector_init_from_list__135__1_1_0),
0
},
};
...
MR_BEGIN_MODULE(transform_hlds__ctgc__selector_module4)
	...
	MR_init_label6(transform_hlds__ctgc__selector__branch_map_search_3_0,32,3,5,7,4,1)
MR_BEGIN_CODE
...
MR_def_label(transform_hlds__ctgc__selector__branch_map_search_3_0,32)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_def_label(transform_hlds__ctgc__selector__branch_map_search_3_0,4)
	...
	MR_GOTO_LAB(transform_hlds__ctgc__selector__branch_map_search_3_0_i32);
...
MR_BEGIN_MODULE(transform_hlds__ctgc__selector_module6)
	...
	MR_init_label6(transform_hlds__ctgc__selector__normalize_selector_with_type_information_4_0,6,4,10,11,3,12)
MR_BEGIN_CODE
...
#undef	MR_PROC_LABEL
	...
	if (MR_INT_NE(MR_r5,0)) {
		MR_GOTO_LAB(transform_hlds__ctgc__selector__normalize_selector_with_type_information_4_0_i3);
	}
	MR_incr_sp(5);
	...
	MR_np_call_localret_ent(parse_tree__prog_type__is_introduced_type_info_type_1_0,
		transform_hlds__ctgc__selector__normalize_selector_with_type_information_4_0_i6);
MR_def_label(transform_hlds__ctgc__selector__normalize_selector_with_type_information_4_0,6)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
	...
	MR_GOTO_LAB(transform_hlds__ctgc__selector__normalize_selector_with_type_information_4_0_i11);
MR_def_label(transform_hlds__ctgc__selector__normalize_selector_with_type_information_4_0,4)
	...
	MR_np_call_localret_ent(transform_hlds__ctgc__selector__do_normalize_selector_6_0,
		transform_hlds__ctgc__selector__normalize_selector_with_type_information_4_0_i10);
MR_def_label(transform_hlds__ctgc__selector__normalize_selector_with_type_information_4_0,10)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = (MR_Word) MR_TAG_COMMON(0,0,4);
MR_def_label(transform_hlds__ctgc__selector__normalize_selector_with_type_information_4_0,11)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_TrieNode	cur_node;
	MR_Word	arg0;
...
#define	MR_PROC_LABEL	mercury__transform_hlds__ctgc__selector__normalize_selector_with_type_information_4_0
	cur_node = (MR_TrieNode) MR_sv(4);
	arg0 = MR_r1;
	save_arg_typeinfo0 = MR_r2;
...
MR_def_label(transform_hlds__ctgc__selector__normalize_selector_with_type_information_4_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_BEGIN_MODULE(transform_hlds__ctgc__selector_module8)
	...
	MR_init_label4(transform_hlds__ctgc__selector__type_arg_types_3_0,5,6,3,7)
MR_BEGIN_CODE
...
#undef	MR_PROC_LABEL
	...
	MR_tfield(0, MR_tempr1, 1) = (MR_Word) MR_ENTRY_AP(transform_hlds__ctgc__selector__IntroducedFrom__pred__type_arg_types__339__1_3_0);
	...
	MR_np_call_localret_ent(solutions__solutions_2_1,
		transform_hlds__ctgc__selector__type_arg_types_3_0_i5);
MR_def_label(transform_hlds__ctgc__selector__type_arg_types_3_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_r1;
...
MR_def_label(transform_hlds__ctgc__selector__type_arg_types_3_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r4,2)) {
		MR_GOTO_LAB(transform_hlds__ctgc__selector__type_arg_types_3_0_i7);
	}
	{
	MR_TrieNode	base;
	MR_Word	restore_arg0;
...
MR_BEGIN_MODULE(transform_hlds__ctgc__selector_module11)
	...
	MR_init_label8(fn__transform_hlds__ctgc__selector__det_select_subtype_4_0,5,3,9,11,15,8,2,21)
MR_BEGIN_CODE
...
MR_def_label(fn__transform_hlds__ctgc__selector__det_select_subtype_4_0,11)
	...
	if (MR_PTAG_TESTR(MR_r1,0)) {
		MR_GOTO_LAB(fn__transform_hlds__ctgc__selector__det_select_subtype_4_0_i21);
	}
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_sv(4);
	...
	MR_np_call_localret_ent(list__member_2_0,
		fn__transform_hlds__ctgc__selector__det_select_subtype_4_0_i15);
MR_def_label(fn__transform_hlds__ctgc__selector__det_select_subtype_4_0,15)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_r1) {
...
MR_def_label(fn__transform_hlds__ctgc__selector__det_select_subtype_4_0,21)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(5);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
...
MR_BEGIN_MODULE(transform_hlds__ctgc__selector_module12)
	...
	MR_init_label10(transform_hlds__ctgc__selector__selector_subsumed_by_2_5_0,288,8,13,11,19,18,24,26,30,28)
	MR_init_label10(transform_hlds__ctgc__selector__selector_subsumed_by_2_5_0,23,16,291,5,43,46,44,52,50,54)
	MR_init_label10(transform_hlds__ctgc__selector__selector_subsumed_by_2_5_0,41,62,65,165,63,71,69,73,61,81)
	MR_init_label10(transform_hlds__ctgc__selector__selector_subsumed_by_2_5_0,79,89,87,91,93,94,97,85,101,99)
	MR_init_label2(transform_hlds__ctgc__selector__selector_subsumed_by_2_5_0,103,1)
MR_BEGIN_CODE
...
MR_def_static(transform_hlds__ctgc__selector__selector_subsumed_by_2_5_0)
	...
	MR_incr_sp(8);
	MR_sv(8) = (MR_Word) MR_succip;
MR_def_label(transform_hlds__ctgc__selector__selector_subsumed_by_2_5_0,288)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TEST(MR_r3,0,0)) {
		MR_GOTO_LAB(transform_hlds__ctgc__selector__selector_subsumed_by_2_5_0_i165);
	}
...
MR_def_label(transform_hlds__ctgc__selector__selector_subsumed_by_2_5_0,26)
	...
	MR_np_call_localret_ent(list__member_2_0,
		transform_hlds__ctgc__selector__selector_subsumed_by_2_5_0_i30);
MR_def_label(transform_hlds__ctgc__selector__selector_subsumed_by_2_5_0,30)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_r1) {
...
MR_def_label(transform_hlds__ctgc__selector__selector_subsumed_by_2_5_0,28)
	...
	MR_r4 = MR_tempr1;
	MR_succip_word = MR_sv(8);
	MR_GOTO_LAB(transform_hlds__ctgc__selector__selector_subsumed_by_2_5_0_i288);
	}
MR_def_label(transform_hlds__ctgc__selector__selector_subsumed_by_2_5_0,23)
	...
	MR_r3 = (MR_Word) MR_string_const("type is both existential and non-existential", 44);
	MR_np_call_localret_ent(require__unexpected_3_0,
		transform_hlds__ctgc__selector__selector_subsumed_by_2_5_0_i291);
MR_def_label(transform_hlds__ctgc__selector__selector_subsumed_by_2_5_0,16)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(transform_hlds__ctgc__selector, encounter_existential_subtype);
	MR_np_call_localret_ent(exception__throw_1_0,
		transform_hlds__ctgc__selector__selector_subsumed_by_2_5_0_i291);
MR_def_label(transform_hlds__ctgc__selector__selector_subsumed_by_2_5_0,291)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_succip_word = MR_sv(8);
	MR_GOTO_LAB(transform_hlds__ctgc__selector__selector_subsumed_by_2_5_0_i288);
MR_def_label(transform_hlds__ctgc__selector__selector_subsumed_by_2_5_0,5)
	...
	if (MR_PTAG_TESTR(MR_r6,0)) {
		MR_GOTO_LAB(transform_hlds__ctgc__selector__selector_subsumed_by_2_5_0_i41);
	}
	...
	MR_np_call_localret_ent(fn__transform_hlds__ctgc__selector__det_select_subtype_4_0,
		transform_hlds__ctgc__selector__selector_subsumed_by_2_5_0_i43);
MR_def_label(transform_hlds__ctgc__selector__selector_subsumed_by_2_5_0,43)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(5) = MR_r1;
	MR_r2 = MR_sv(7);
	MR_np_call_localret_ent(__Unify___parse_tree__prog_data__mer_type_0_0,
		transform_hlds__ctgc__selector__selector_subsumed_by_2_5_0_i46);
MR_def_label(transform_hlds__ctgc__selector__selector_subsumed_by_2_5_0,46)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(transform_hlds__ctgc__selector__selector_subsumed_by_2_5_0_i44);
	}
	MR_r1 = MR_sv(3);
	MR_r2 = MR_sv(1);
	MR_r3 = MR_sv(2);
...
MR_def_label(transform_hlds__ctgc__selector__selector_subsumed_by_2_5_0,44)
	...
	MR_r2 = MR_sv(7);
	MR_np_call_localret_ent(__Unify___parse_tree__prog_data__mer_type_0_0,
		transform_hlds__ctgc__selector__selector_subsumed_by_2_5_0_i52);
MR_def_label(transform_hlds__ctgc__selector__selector_subsumed_by_2_5_0,52)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(transform_hlds__ctgc__selector__selector_subsumed_by_2_5_0_i50);
	}
	MR_r1 = MR_sv(3);
	MR_r3 = MR_sv(4);
	MR_r2 = MR_sv(1);
	...
	MR_succip_word = MR_sv(8);
	MR_GOTO_LAB(transform_hlds__ctgc__selector__selector_subsumed_by_2_5_0_i288);
MR_def_label(transform_hlds__ctgc__selector__selector_subsumed_by_2_5_0,50)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(5);
	MR_r1 = MR_sv(3);
	MR_r2 = MR_sv(5);
	...
	MR_np_call_localret_ent(transform_hlds__ctgc__selector__type_contains_subtype_1_4_0,
		transform_hlds__ctgc__selector__selector_subsumed_by_2_5_0_i54);
MR_def_label(transform_hlds__ctgc__selector__selector_subsumed_by_2_5_0,54)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	...
	MR_succip_word = MR_sv(8);
	MR_GOTO_LAB(transform_hlds__ctgc__selector__selector_subsumed_by_2_5_0_i288);
MR_def_label(transform_hlds__ctgc__selector__selector_subsumed_by_2_5_0,41)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_r5,0)) {
		MR_GOTO_LAB(transform_hlds__ctgc__selector__selector_subsumed_by_2_5_0_i61);
	}
	MR_sv(3) = MR_r1;
	MR_sv(7) = MR_r2;
	...
	MR_np_call_localret_ent(fn__transform_hlds__ctgc__selector__det_select_subtype_4_0,
		transform_hlds__ctgc__selector__selector_subsumed_by_2_5_0_i62);
MR_def_label(transform_hlds__ctgc__selector__selector_subsumed_by_2_5_0,62)
	...
	MR_r2 = MR_sv(4);
	MR_np_call_localret_ent(__Unify___parse_tree__prog_data__mer_type_0_0,
		transform_hlds__ctgc__selector__selector_subsumed_by_2_5_0_i65);
MR_def_label(transform_hlds__ctgc__selector__selector_subsumed_by_2_5_0,65)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(transform_hlds__ctgc__selector__selector_subsumed_by_2_5_0_i63);
	}
	MR_r1 = MR_sv(3);
	MR_r2 = MR_sv(1);
	MR_r3 = MR_sv(2);
	...
	MR_succip_word = MR_sv(8);
	MR_GOTO_LAB(transform_hlds__ctgc__selector__selector_subsumed_by_2_5_0_i288);
MR_def_label(transform_hlds__ctgc__selector__selector_subsumed_by_2_5_0,165)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_TRUE;
	MR_decr_sp_and_return(8);
MR_def_label(transform_hlds__ctgc__selector__selector_subsumed_by_2_5_0,63)
	...
	MR_r2 = MR_sv(6);
	MR_np_call_localret_ent(__Unify___parse_tree__prog_data__mer_type_0_0,
		transform_hlds__ctgc__selector__selector_subsumed_by_2_5_0_i71);
MR_def_label(transform_hlds__ctgc__selector__selector_subsumed_by_2_5_0,71)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(transform_hlds__ctgc__selector__selector_subsumed_by_2_5_0_i69);
	}
	MR_r1 = MR_sv(3);
	MR_r2 = MR_sv(7);
	MR_r3 = MR_sv(2);
	...
	MR_succip_word = MR_sv(8);
	MR_GOTO_LAB(transform_hlds__ctgc__selector__selector_subsumed_by_2_5_0_i288);
MR_def_label(transform_hlds__ctgc__selector__selector_subsumed_by_2_5_0,69)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(4);
	MR_r1 = MR_sv(3);
	MR_r2 = MR_sv(4);
	MR_r3 = MR_sv(6);
	MR_np_call_localret_ent(transform_hlds__ctgc__selector__type_contains_subtype_1_4_0,
		transform_hlds__ctgc__selector__selector_subsumed_by_2_5_0_i73);
MR_def_label(transform_hlds__ctgc__selector__selector_subsumed_by_2_5_0,73)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,1)) {
		MR_GOTO_LAB(transform_hlds__ctgc__selector__selector_subsumed_by_2_5_0_i1);
	}
	...
	MR_succip_word = MR_sv(8);
	MR_GOTO_LAB(transform_hlds__ctgc__selector__selector_subsumed_by_2_5_0_i288);
MR_def_label(transform_hlds__ctgc__selector__selector_subsumed_by_2_5_0,61)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
	...
	MR_np_call_localret_ent(__Unify___parse_tree__prog_data__mer_type_0_0,
		transform_hlds__ctgc__selector__selector_subsumed_by_2_5_0_i81);
MR_def_label(transform_hlds__ctgc__selector__selector_subsumed_by_2_5_0,81)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(transform_hlds__ctgc__selector__selector_subsumed_by_2_5_0_i79);
	}
	MR_r1 = MR_sv(3);
	MR_r2 = MR_sv(1);
	MR_r3 = MR_sv(2);
	...
	MR_succip_word = MR_sv(8);
	MR_GOTO_LAB(transform_hlds__ctgc__selector__selector_subsumed_by_2_5_0_i288);
MR_def_label(transform_hlds__ctgc__selector__selector_subsumed_by_2_5_0,79)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(3);
	MR_r2 = MR_sv(7);
	{
	...
	MR_np_call_localret_ent(__Unify___parse_tree__prog_data__mer_type_0_0,
		transform_hlds__ctgc__selector__selector_subsumed_by_2_5_0_i89);
MR_def_label(transform_hlds__ctgc__selector__selector_subsumed_by_2_5_0,89)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(transform_hlds__ctgc__selector__selector_subsumed_by_2_5_0_i87);
	}
	MR_r1 = MR_sv(3);
	MR_r2 = MR_sv(7);
	MR_r3 = MR_sv(2);
	MR_r4 = MR_sv(5);
	MR_GOTO_LAB(transform_hlds__ctgc__selector__selector_subsumed_by_2_5_0_i93);
MR_def_label(transform_hlds__ctgc__selector__selector_subsumed_by_2_5_0,87)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(3);
	MR_r2 = MR_sv(7);
	MR_r3 = MR_sv(4);
	...
	MR_np_call_localret_ent(transform_hlds__ctgc__selector__type_contains_subtype_1_4_0,
		transform_hlds__ctgc__selector__selector_subsumed_by_2_5_0_i91);
MR_def_label(transform_hlds__ctgc__selector__selector_subsumed_by_2_5_0,91)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,1)) {
		MR_GOTO_LAB(transform_hlds__ctgc__selector__selector_subsumed_by_2_5_0_i85);
	}
	MR_r1 = MR_sv(3);
	MR_r2 = MR_sv(7);
	MR_r3 = MR_sv(2);
	MR_r4 = MR_sv(5);
MR_def_label(transform_hlds__ctgc__selector__selector_subsumed_by_2_5_0,93)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(3) = MR_r1;
	MR_sv(7) = MR_r2;
	MR_sv(5) = MR_r4;
	MR_np_localcall_lab(transform_hlds__ctgc__selector__selector_subsumed_by_2_5_0,
		transform_hlds__ctgc__selector__selector_subsumed_by_2_5_0_i94);
MR_def_label(transform_hlds__ctgc__selector__selector_subsumed_by_2_5_0,94)
	...
	MR_r3 = MR_sv(7);
	MR_np_call_localret_ent(builtin__unify_2_0,
		transform_hlds__ctgc__selector__selector_subsumed_by_2_5_0_i97);
MR_def_label(transform_hlds__ctgc__selector__selector_subsumed_by_2_5_0,97)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_r1) {
		MR_GOTO_LAB(transform_hlds__ctgc__selector__selector_subsumed_by_2_5_0_i1);
	}
	...
	MR_r1 = MR_TRUE;
	MR_decr_sp_and_return(8);
MR_def_label(transform_hlds__ctgc__selector__selector_subsumed_by_2_5_0,85)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(3);
	{
	MR_Word MR_tempr1, MR_tempr2, MR_tempr3;
	...
	MR_np_call_localret_ent(__Unify___parse_tree__prog_data__mer_type_0_0,
		transform_hlds__ctgc__selector__selector_subsumed_by_2_5_0_i101);
MR_def_label(transform_hlds__ctgc__selector__selector_subsumed_by_2_5_0,101)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(transform_hlds__ctgc__selector__selector_subsumed_by_2_5_0_i99);
	}
	MR_r1 = MR_sv(3);
	MR_r3 = MR_sv(4);
	MR_r2 = MR_sv(1);
	...
	MR_succip_word = MR_sv(8);
	MR_GOTO_LAB(transform_hlds__ctgc__selector__selector_subsumed_by_2_5_0_i288);
MR_def_label(transform_hlds__ctgc__selector__selector_subsumed_by_2_5_0,99)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(3);
	MR_r3 = MR_sv(4);
	{
	...
	MR_np_call_localret_ent(transform_hlds__ctgc__selector__type_contains_subtype_1_4_0,
		transform_hlds__ctgc__selector__selector_subsumed_by_2_5_0_i103);
MR_def_label(transform_hlds__ctgc__selector__selector_subsumed_by_2_5_0,103)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,1)) {
		MR_GOTO_LAB(transform_hlds__ctgc__selector__selector_subsumed_by_2_5_0_i1);
	}
...
MR_BEGIN_MODULE(transform_hlds__ctgc__selector_module14)
	...
	MR_init_label10(transform_hlds__ctgc__selector__type_of_node_4_0,63,8,6,13,15,19,17,11,5,65)
...
MR_define_entry(mercury__transform_hlds__ctgc__selector__type_of_node_4_0);
	...
	MR_incr_sp(6);
	MR_sv(6) = (MR_Word) MR_succip;
MR_def_label(transform_hlds__ctgc__selector__type_of_node_4_0,63)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TEST(MR_r3,0,0)) {
...
MR_def_label(transform_hlds__ctgc__selector__type_of_node_4_0,15)
	...
	MR_np_call_localret_ent(list__member_2_0,
		transform_hlds__ctgc__selector__type_of_node_4_0_i19);
MR_def_label(transform_hlds__ctgc__selector__type_of_node_4_0,19)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_r1) {
...
MR_def_label(transform_hlds__ctgc__selector__type_of_node_4_0,17)
	...
	MR_GOTO_LAB(transform_hlds__ctgc__selector__type_of_node_4_0_i63);
	}
MR_def_label(transform_hlds__ctgc__selector__type_of_node_4_0,11)
	...
	MR_r3 = (MR_Word) MR_string_const("type is both existential and non-existential", 44);
	MR_np_call_localret_ent(require__unexpected_3_0,
		transform_hlds__ctgc__selector__type_of_node_4_0_i65);
MR_def_label(transform_hlds__ctgc__selector__type_of_node_4_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r3 = MR_tfield(1, MR_r3, 1);
	MR_r2 = MR_tfield(1, MR_r4, 0);
MR_def_label(transform_hlds__ctgc__selector__type_of_node_4_0,65)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_succip_word = MR_sv(6);
	MR_GOTO_LAB(transform_hlds__ctgc__selector__type_of_node_4_0_i63);
...
#line 2469 "transform_hlds.ctgc.selector.c"
#undef	MR_PROC_LABEL
	}
	MR_proceed();
#ifdef MR_maybe_local_thread_engine_base
...
#line 2498 "transform_hlds.ctgc.selector.c"
#undef	MR_PROC_LABEL
	}
	MR_proceed();
#ifdef MR_maybe_local_thread_engine_base
...
MR_BEGIN_MODULE(transform_hlds__ctgc__selector_module25)
	MR_init_entry1(fn__transform_hlds__ctgc__selector__IntroducedFrom__func__selector_init_from_list__135__1_1_0);
	MR_INIT_PROC_LAYOUT_ADDR(mercury__fn__transform_hlds__ctgc__selector__IntroducedFrom__func__selector_init_from_list__135__1_1_0);
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'IntroducedFrom__func__selector_init_from_list__135__1'/2 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(fn__transform_hlds__ctgc__selector__IntroducedFrom__func__selector_init_from_list__135__1_1_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_BEGIN_MODULE(transform_hlds__ctgc__selector_module26)
	MR_init_entry1(transform_hlds__ctgc__selector__IntroducedFrom__pred__type_arg_types__339__1_3_0);
	MR_INIT_PROC_LAYOUT_ADDR(mercury__transform_hlds__ctgc__selector__IntroducedFrom__pred__type_arg_types__339__1_3_0);
	MR_init_label1(transform_hlds__ctgc__selector__IntroducedFrom__pred__type_arg_types__339__1_3_0,1)
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'IntroducedFrom__pred__type_arg_types__339__1'/3 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(transform_hlds__ctgc__selector__IntroducedFrom__pred__type_arg_types__339__1_3_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_mkframe("pred transform_hlds.ctgc.selector.IntroducedFrom__pred__type_arg_types__339__1/3-0", 0,
		MR_ENTRY(MR_do_fail));
	MR_np_call_localret_ent(check_hlds__type_util__cons_id_arg_types_4_0,
		transform_hlds__ctgc__selector__IntroducedFrom__pred__type_arg_types__339__1_3_0_i1);
MR_def_label(transform_hlds__ctgc__selector__IntroducedFrom__pred__type_arg_types__339__1_3_0,1)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_r2;
	MR_succeed();
#ifdef MR_maybe_local_thread_engine_base
...
void mercury__transform_hlds__ctgc__selector__write_out_proc_statics(FILE *deep_fp, FILE *procrep_fp)
{
	MR_write_out_module_proc_reps_start(procrep_fp, &mercury_data__module_layout__transform_hlds__ctgc__selector);
