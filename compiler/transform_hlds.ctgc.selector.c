        ...
        else
        {
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              ...
              TypeInfo_30_32 = (MR_Word) (&transform_hlds__ctgc__selector_scalar_common_1[1]);
              succeeded = mercury__list__member_2_p_0(TypeInfo_30_32, ((MR_Box) (TVar_24)), ExistQVars_20);
            }
            succeeded = !(succeeded);
          }
          else
                ...
                else
                {
                  ...
                  if (succeeded)
                  {
                    ...
                    if (succeeded)
                    {
                      ...
                      TypeInfo_30_65 = (MR_Word) (&transform_hlds__ctgc__selector_scalar_common_1[1]);
                      succeeded = mercury__list__member_2_p_0(TypeInfo_30_65, ((MR_Box) (TVar_57)), ExistQVars_53);
                    }
                    succeeded = !(succeeded);
                  }
                  else
            ...
            else
            {
              ...
              if (succeeded)
              {
                ...
                if (succeeded)
                {
                  ...
                  TypeInfo_30_87 = (MR_Word) (&transform_hlds__ctgc__selector_scalar_common_1[1]);
                  succeeded = mercury__list__member_2_p_0(TypeInfo_30_87, ((MR_Box) (TVar_79)), ExistQVars_75);
                }
                succeeded = !(succeeded);
              }
              else
