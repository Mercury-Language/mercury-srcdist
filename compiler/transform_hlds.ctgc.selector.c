...
{
  {
    ...
    {
      LambdaHeadVar__2_7 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
...
{
  {
    ...
    if ((Selector0_7 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
      *Selector_8 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
    else
    {
      MR_Word SubType_11;
  ...
  MR_Word * SubType_8)
{
  while (MR_TRUE)
  {
    ...
    if ((Selector_7 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
    {
    ...
    else
    {
      ...
      if (((MR_tag((MR_Word) UnitSelector_9)) == (MR_mktag((MR_Integer) 0))))
      {
        ...
        else
        {
          ...
          if (succeeded)
          {
            MR_Word ExistQVars_22 = ((MR_Word) (MR_hl_field(MR_mktag(0), CtorDefn_20, (MR_Integer) 1)));
            MR_Word ArgTypes_31 = ((MR_Word) (MR_hl_field(MR_mktag(0), CtorDefn_20, (MR_Integer) 4)));
            MR_Word _TVarSet_21 = ((MR_Word) (MR_hl_field(MR_mktag(0), CtorDefn_20, (MR_Integer) 0)));
            MR_Word _KindMap_23 = ((MR_Word) (MR_hl_field(MR_mktag(0), CtorDefn_20, (MR_Integer) 2)));
            MR_Word _Constraints_24 = ((MR_Word) (MR_hl_field(MR_mktag(0), CtorDefn_20, (MR_Integer) 3)));
            MR_Word _RetType_25 = ((MR_Word) (MR_hl_field(MR_mktag(0), CtorDefn_20, (MR_Integer) 5)));
            MR_Box conv1_SubType0_13;
            MR_Word TypeInfo_27_35;
            MR_Word TVar_26;
            MR_Word Var_27;

            conv1_SubType0_13 = mercury__list__det_index1_2_f_0((MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0, ArgTypes_31, Index_12);
            SubType0_13 = ((MR_Word) conv1_SubType0_13);
            succeeded = ((MR_tag((MR_Word) SubType0_13)) == (MR_mktag((MR_Integer) 0)));
            if (succeeded)
            {
              TVar_26 = ((MR_Word) (MR_hl_field(MR_mktag(0), SubType0_13, (MR_Integer) 0)));
              Var_27 = ((MR_Word) (MR_hl_field(MR_mktag(0), SubType0_13, (MR_Integer) 1)));
              TypeInfo_27_35 = (MR_Word) &transform_hlds__ctgc__selector_scalar_common_1[1];
              succeeded = mercury__list__member_2_p_0(TypeInfo_27_35, ((MR_Box) (TVar_26)), ExistQVars_22);
            }
            succeeded = !(succeeded);
          }
          else
      ...
      if (succeeded)
      {
        ...
        {
          MR_Word next_value_of_StartType_6 = SubType0_13;
          MR_Word next_value_of_Selector_7 = RestSelector_10;
  ...
  MR_Word * Extension_10)
{
  while (MR_TRUE)
  {
    ...
    /* setup for tailcalls optimized into a loop */
    if ((B_8 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
    {
      *Extension_10 = A_7;
      succeeded = MR_TRUE;
    }
    else
    {
      ...
      succeeded = ((MR_tag((MR_Word) A_7)) == (MR_mktag((MR_Integer) 1)));
      if (succeeded)
      {
        ...
        succeeded = ((MR_tag((MR_Word) AH_11)) == (MR_mktag((MR_Integer) 0)));
        if (succeeded)
        {
          ...
          succeeded = ((MR_tag((MR_Word) BH_13)) == (MR_mktag((MR_Integer) 0)));
          if (succeeded)
          {
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                Var_19 = ((MR_Word) (MR_hl_field(MR_mktag(0), Type_9, (MR_Integer) 0)));
                Var_20 = ((MR_Word) (MR_hl_field(MR_mktag(0), Type_9, (MR_Integer) 1)));
              ...
              if (succeeded)
              {
                *Extension_10 = (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0));
                succeeded = MR_TRUE;
              }
              else
              {
                ...
                else
                {
                  ...
                  if (succeeded)
                  {
                    MR_Word ExistQVars_60 = ((MR_Word) (MR_hl_field(MR_mktag(0), CtorDefn_58, (MR_Integer) 1)));
                    MR_Word ArgTypes_69 = ((MR_Word) (MR_hl_field(MR_mktag(0), CtorDefn_58, (MR_Integer) 4)));
                    MR_Word _TVarSet_59 = ((MR_Word) (MR_hl_field(MR_mktag(0), CtorDefn_58, (MR_Integer) 0)));
                    MR_Word _KindMap_61 = ((MR_Word) (MR_hl_field(MR_mktag(0), CtorDefn_58, (MR_Integer) 2)));
                    MR_Word _Constraints_62 = ((MR_Word) (MR_hl_field(MR_mktag(0), CtorDefn_58, (MR_Integer) 3)));
                    MR_Word _RetType_63 = ((MR_Word) (MR_hl_field(MR_mktag(0), CtorDefn_58, (MR_Integer) 5)));
                    MR_Box conv1_SubType0_49;
                    MR_Word TypeInfo_27_73;
                    MR_Word TVar_64;
                    MR_Word Var_65;

                    conv1_SubType0_49 = mercury__list__det_index1_2_f_0((MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0, ArgTypes_69, IndexA_16);
                    SubType0_49 = ((MR_Word) conv1_SubType0_49);
                    succeeded = ((MR_tag((MR_Word) SubType0_49)) == (MR_mktag((MR_Integer) 0)));
                    if (succeeded)
                    {
                      TVar_64 = ((MR_Word) (MR_hl_field(MR_mktag(0), SubType0_49, (MR_Integer) 0)));
                      Var_65 = ((MR_Word) (MR_hl_field(MR_mktag(0), SubType0_49, (MR_Integer) 1)));
                      TypeInfo_27_73 = (MR_Word) &transform_hlds__ctgc__selector_scalar_common_1[1];
                      succeeded = mercury__list__member_2_p_0(TypeInfo_27_73, ((MR_Box) (TVar_64)), ExistQVars_60);
                    }
                    succeeded = !(succeeded);
                  }
                  else
                ...
                /* direct tailcall eliminated */
                {
                  ...
                  MR_Word next_value_of_Type_9 = SubType_21;
        ...
        if (((MR_tag((MR_Word) AH_11)) == (MR_mktag((MR_Integer) 0))))
        {
          MR_Word SubTypeB_22;
          MR_Word SubTypeA_23;
          ...
          succeeded = ((MR_tag((MR_Word) BH_13)) == (MR_mktag((MR_Integer) 1)));
          if (succeeded)
          {
            ...
            else
            {
              ...
              else
              {
                ...
                transform_hlds__ctgc__selector__type_contains_subtype_1_4_p_0(ModuleInfo_6, SubTypeA_23, SubTypeB_22, &Contains_77);
                succeeded = (Contains_77 == (MR_Integer) 1);
              }
              if (succeeded)
              {
                /* direct tailcall eliminated */
        ...
        else
        {
          ...
          if (((MR_tag((MR_Word) BH_13)) == (MR_mktag((MR_Integer) 0))))
          {
            ...
            else
            {
              ...
              else
              {
                ...
                transform_hlds__ctgc__selector__type_contains_subtype_1_4_p_0(ModuleInfo_6, SubTypeB_29, Var_37, &Contains_82);
                succeeded = (Contains_82 == (MR_Integer) 1);
              }
              if (succeeded)
              {
                /* direct tailcall eliminated */
          ...
          else
          {
            ...
            else
            {
              ...
              else
              {
                ...
                transform_hlds__ctgc__selector__type_contains_subtype_1_4_p_0(ModuleInfo_6, SubTypeB_31, Var_37, &Contains_87);
                succeeded = (Contains_87 == (MR_Integer) 1);
              }
              if (succeeded)
              ...
              else
              {
                ...
                else
                {
                  ...
                  transform_hlds__ctgc__selector__type_contains_subtype_1_4_p_0(ModuleInfo_6, Var_37, SubTypeB_31, &Contains_92);
                ...
                if (succeeded)
                {
                  ...
                  {
                    MR_Word next_value_of_A_7 = AT_12;
                    MR_Word next_value_of_Type_9 = Var_37;
...
{
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        conv1_SubType0_11 = mercury__list__det_index1_2_f_0((MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0, ArgTypes_31, Position_9);
        SubType0_11 = ((MR_Word) conv1_SubType0_11);
        succeeded = ((MR_tag((MR_Word) SubType0_11)) == (MR_mktag((MR_Integer) 0)));
        if (succeeded)
        {
          TVar_26 = ((MR_Word) (MR_hl_field(MR_mktag(0), SubType0_11, (MR_Integer) 0)));
          Var_27 = ((MR_Word) (MR_hl_field(MR_mktag(0), SubType0_11, (MR_Integer) 1)));
          TypeInfo_27_35 = (MR_Word) &transform_hlds__ctgc__selector_scalar_common_1[1];
          succeeded = mercury__list__member_2_p_0(TypeInfo_27_35, ((MR_Box) (TVar_26)), ExistQVars_22);
        }
        succeeded = !(succeeded);
...
#undef MR_PROC_LABEL
    ...
    switch (Status_19) {
      ...
      case (MR_Integer) 0:
        {
          MR_Word TypeCtorInfo_14_14 = (MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0;
          MR_Word Queue0_9;
          MR_Word Var_12;
          MR_Word Var_13;
          MR_Word _Queue_10;
          ...
          Var_12 = mercury__queue__init_0_f_0(TypeCtorInfo_14_14);
          mercury__queue__put_3_p_0(TypeCtorInfo_14_14, ((MR_Box) (FromType_6)), Var_12, &Queue0_9);
          Var_13 = mercury__set__init_0_f_0(TypeCtorInfo_14_14);
  ...
  MR_Word * Contains_12)
{
  while (MR_TRUE)
  {
    ...
    if (succeeded)
    {
      ...
      {
        MR_Word TypeCtorInfo_28_28 = (MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0;
        MR_Word ArgTypes_14;
        MR_Word STATE_VARIABLE_SeenTypes_22_22;

        mercury__set__insert_3_p_0(TypeCtorInfo_28_28, ((MR_Box) (FromType_13)), STATE_VARIABLE_SeenTypes_0_17, &STATE_VARIABLE_SeenTypes_22_22);
        transform_hlds__ctgc__selector__type_arg_types_3_p_0(ModuleInfo_8, FromType_13, &ArgTypes_14);
        succeeded = mercury__list__member_2_p_0(TypeCtorInfo_28_28, ((MR_Box) (ToType_9)), ArgTypes_14);
        if (succeeded)
        {
        ...
        else
        {
          ...
          mercury__queue__put_list_3_p_0(TypeCtorInfo_28_28, ArgTypes_14, STATE_VARIABLE_Queue_19_19, &STATE_VARIABLE_Queue_23_23);
          /* direct tailcall eliminated */
          {
            MR_Word next_value_of_STATE_VARIABLE_Queue_0_15 = STATE_VARIABLE_Queue_23_23;
            MR_Word next_value_of_STATE_VARIABLE_SeenTypes_0_17 = STATE_VARIABLE_SeenTypes_22_22;
  ...
  MR_Word HeadVar__1_1)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      succeeded = ((MR_tag((MR_Word) H_2)) == (MR_mktag((MR_Integer) 0)));
      if (succeeded)
      {
        Var_4 = ((MR_Word) (MR_hl_field(MR_mktag(0), H_2, (MR_Integer) 0)));
        Var_5 = ((MR_Integer) (MR_hl_field(MR_mktag(0), H_2, (MR_Integer) 1)));
        /* direct tailcall eliminated */
        {
      ...
      case (MR_Integer) 0:
        {
          ...
          else
          {
            ...
            {
              BranchMap1_9 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
              MR_hl_field(MR_mktag(1), BranchMap1_9, 0) = ((MR_Box) (Var_25));
              MR_hl_field(MR_mktag(1), BranchMap1_9, 1) = ((MR_Box) (MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0))));
            }
            transform_hlds__ctgc__selector__do_normalize_selector_6_p_0(ModuleInfo_5, Type_6, BranchMap1_9, (MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)), STATE_VARIABLE_Selector_0_10, STATE_VARIABLE_Selector_11);
          }
{
#define MR_PROC_LABEL transform_hlds__ctgc__selector__normalize_selector_with_type_information_4_p_0
  ...
  MR_Word * STATE_VARIABLE_Selector_25)
{
  while (MR_TRUE)
  {
    ...
    /* setup for tailcalls optimized into a loop */
    if ((STATE_VARIABLE_Selector_0_24 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
    ...
    else
    {
      ...
      succeeded = ((((MR_tag((MR_Word) CtorCat_14)) == (MR_mktag((MR_Integer) 3)))) && (((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), CtorCat_14, (MR_Integer) 0)))) == (MR_Integer) 1)));
      if (succeeded)
      {
        CatUser_15 = ((MR_Word) (MR_hl_field(MR_mktag(3), CtorCat_14, (MR_Integer) 1)));
        {
          MR_Word CType_20;
          ...
          if (((MR_tag((MR_Word) UnitSelector_12)) == (MR_mktag((MR_Integer) 0))))
          {
          ...
          if (succeeded)
          {
            ...
            else
            {
              ...
              {
                BranchMap1_23 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
              ...
              {
                MR_Word next_value_of_VarType_8 = CType_20;
                MR_Word next_value_of_BranchMap0_9 = BranchMap1_23;
                MR_Word next_value_of_SelectorAcc0_10 = SelectorAcc1_22;
                MR_Word next_value_of_STATE_VARIABLE_Selector_0_24 = SelRest_13;
...
{
  {
    ...
    conv0_LambdaHeadVar__2_7 = transform_hlds__ctgc__selector__IntroducedFrom__func__selector_init_from_list__145__1_1_f_0(((MR_Word) wrapper_arg_1));
    ...
    switch (MR_tag((MR_Word) ConsId_4)) {
      ...
      case (MR_Integer) 3:
        switch (((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), ConsId_4, (MR_Integer) 0)))) {
          ...
          case (MR_Integer) 3:
            {
              TermSel_6 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
