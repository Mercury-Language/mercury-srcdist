            ...
            if (succeeded)
            {
              ...
              else
              {
                ...
                else
                {
                  ...
                  if (succeeded)
                  {
                    MR_Word MaybeExistConstraints_47 = ((MR_Word) ((MR_hl_field(MR_mktag(0), CtorDefn_44, (MR_Integer) 2))));
                    MR_Word ExistQVars_49;
                    MR_Word ArgTypes_58 = ((MR_Word) ((MR_hl_field(MR_mktag(0), CtorDefn_44, (MR_Integer) 3))));
                    ...
                    else
                    {
                      ...
                      ExistQVars_49 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_55, (MR_Integer) 0))));
                    }
                    ...
                    if (succeeded)
                    {
                      TVar_53 = ((MR_Word) ((MR_hl_field(MR_mktag(0), SubType0_40, (MR_Integer) 0))));
                      TypeInfo_30_61 = (MR_Word) (&transform_hlds__ctgc__selector_scalar_common_1[1]);
                      succeeded = mercury__list__member_2_p_0(TypeInfo_30_61, ((MR_Box) (TVar_53)), ExistQVars_49);
                    }
                    succeeded = !(succeeded);
                  }
                  else
        ...
        if (((MR_tag((MR_Word) AH_11)) == (MR_Integer) 0))
        {
          ...
          if (succeeded)
          {
            ...
            else
            {
              ...
              if (succeeded)
              {
                MR_Word MaybeExistConstraints_69 = ((MR_Word) ((MR_hl_field(MR_mktag(0), CtorDefn_66, (MR_Integer) 2))));
                MR_Word ExistQVars_71;
                MR_Word ArgTypes_80 = ((MR_Word) ((MR_hl_field(MR_mktag(0), CtorDefn_66, (MR_Integer) 3))));
                MR_Box conv3_SubType0_62;
                MR_Word TypeInfo_30_83;
                MR_Word TVar_75;
                ...
                else
                {
                  ...
                  ExistQVars_71 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Var_77, (MR_Integer) 0))));
                }
                ...
                if (succeeded)
                {
                  TVar_75 = ((MR_Word) ((MR_hl_field(MR_mktag(0), SubType0_62, (MR_Integer) 0))));
                  TypeInfo_30_83 = (MR_Word) (&transform_hlds__ctgc__selector_scalar_common_1[1]);
                  succeeded = mercury__list__member_2_p_0(TypeInfo_30_83, ((MR_Box) (TVar_75)), ExistQVars_71);
                }
                succeeded = !(succeeded);
              }
              else
