  ...
  MR_Word * Extension_10)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      succeeded = ((MR_tag((MR_Word) A_7)) == (MR_Integer) 1);
      if (succeeded)
      {
  ...
  MR_Word * STATE_VARIABLE_Selector_25)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      succeeded = ((((MR_tag((MR_Word) CtorCat_14)) == (MR_Integer) 3)) && ((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), CtorCat_14, (MR_Integer) 0))) == (MR_Integer) 1)));
      if (succeeded)
      {
