...
MR_decl_label10(ll_backend__lookup_switch__construct_several_soln_vector_15_0, 58,5,6,57,10,9,13,12,15,22)
MR_decl_label3(ll_backend__lookup_switch__construct_several_soln_vector_15_0, 23,24,26)
MR_decl_label4(ll_backend__lookup_switch__construct_simple_vector_4_0, 26,6,4,8)
...
MR_decl_label6(__Compare___ll_backend__lookup_switch__lookup_switch_info_0_0, 3,2,5,10,14,51)
...
MR_BEGIN_MODULE(ll_backend__lookup_switch_module4)
	...
	MR_init_label4(ll_backend__lookup_switch__construct_simple_vector_4_0,26,6,4,8)
MR_BEGIN_CODE
...
MR_def_static(ll_backend__lookup_switch__construct_simple_vector_4_0)
	...
	if (MR_LTAGS_TESTR(MR_r3,0,0)) {
		MR_GOTO_LAB(ll_backend__lookup_switch__construct_simple_vector_4_0_i26);
	}
	MR_r1 = (MR_Word) MR_tbmkword(0, 0);
	MR_proceed();
MR_def_label(ll_backend__lookup_switch__construct_simple_vector_4_0,26)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(4);
...
MR_BEGIN_MODULE(ll_backend__lookup_switch_module9)
	...
	MR_init_label10(ll_backend__lookup_switch__construct_several_soln_vector_15_0,58,5,6,57,10,9,13,12,15,22)
...
MR_def_static(ll_backend__lookup_switch__construct_several_soln_vector_15_0)
	...
	if (MR_LTAGS_TESTR(MR_r6,0,0)) {
		MR_GOTO_LAB(ll_backend__lookup_switch__construct_several_soln_vector_15_0_i57);
	}
	if (((MR_Integer) MR_r1 <= (MR_Integer) MR_r2)) {
		MR_GOTO_LAB(ll_backend__lookup_switch__construct_several_soln_vector_15_0_i58);
	}
	MR_r1 = (MR_Word) MR_tbmkword(0, 0);
	MR_r2 = MR_r7;
	MR_r3 = MR_r8;
	...
	MR_r5 = MR_r10;
	MR_proceed();
MR_def_label(ll_backend__lookup_switch__construct_several_soln_vector_15_0,58)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(15);
...
MR_def_label(ll_backend__lookup_switch__construct_several_soln_vector_15_0,57)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_incr_sp(15);
	MR_sv(15) = (MR_Word) MR_succip;
	{
...
MR_def_label(ll_backend__lookup_switch__generate_several_soln_lookup_switch_15_0,57)
	...
	MR_tfield(0, MR_r2, 1) = (MR_Word) MR_string_const("end of several_soln lookup switch", 33);
	MR_sv(2) = MR_r1;
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(ll_backend__llds, instruction);
	}
	MR_np_call_localret_ent(fn__cord__singleton_1_0,
...
MR_def_label(ll_backend__lookup_switch__generate_lookup_switch_11_0,9)
	...
	MR_tfield(3, MR_r1, 1) = (MR_Word) MR_tbmkword(0, 25);
...
MR_def_label(fn__ll_backend__lookup_switch__default_value_for_type_1_0,9)
	...
	MR_r1 = (MR_Word) MR_TAG_COMMON(3,7,4);
	MR_proceed();
...
MR_def_label(fn__ll_backend__lookup_switch__default_value_for_type_1_0,24)
	...
	MR_r1 = (MR_Word) MR_TAG_COMMON(3,7,5);
	MR_proceed();
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_thread_engine_base
...
MR_BEGIN_MODULE(ll_backend__lookup_switch_module16)
	...
	MR_init_label6(__Compare___ll_backend__lookup_switch__lookup_switch_info_0_0,3,2,5,10,14,51)
MR_BEGIN_CODE
...
MR_def_label(__Compare___ll_backend__lookup_switch__lookup_switch_info_0_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(__Compare___ll_backend__lookup_switch__lookup_switch_info_0_0_i51);
	}
	MR_r1 = (MR_Word) MR_TAG_COMMON(0,0,1);
	MR_r2 = MR_sv(1);
	MR_r3 = MR_sv(4);
...
MR_def_label(__Compare___ll_backend__lookup_switch__lookup_switch_info_0_0,51)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_decr_sp_and_return(7);
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
