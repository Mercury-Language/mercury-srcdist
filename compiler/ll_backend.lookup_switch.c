...
{
  {
    ...
    succeeded = ((MR_tag((MR_Word) BitVecArgs_20)) == (MR_Integer) 1);
    if (succeeded)
    {
      ...
      case (MR_Integer) 2:
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_62, (MR_Integer) 318, &ReclaimHeap_70);
...
{
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          succeeded = ((((MR_tag((MR_Word) GoalExpr_55)) == (MR_Integer) 3)) && ((((MR_Integer) (MR_Word) (MR_hl_field(MR_mktag(3), GoalExpr_55, (MR_Integer) 0))) == (MR_Integer) 3)));
          if (succeeded)
          {
