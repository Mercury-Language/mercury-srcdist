  ...
  MR_Word * STATE_VARIABLE_CI_40)
{
  ...
  MR_Word CLD_31;
  MR_Word STATE_VARIABLE_MaybeEnd_41_41 = ((MR_Word) ((MR_hl_field(0, LookupSwitchInfo_12, 5))));
  MR_Word STATE_VARIABLE_CI_42_42 = ((MR_Word) ((MR_hl_field(0, LookupSwitchInfo_12, 6))));
  ...
  MR_Word * STATE_VARIABLE_CI_75)
{
  ...
  *TestOp_26 = (MR_Word) (MR_mkword(3, &ll_backend__lookup_switch_scalar_common_1[32]));
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_31, (MR_Integer) 374, &ReclaimHeap_44);
