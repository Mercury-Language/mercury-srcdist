  ...
  MR_Integer * STATE_VARIABLE_SeveralSolnCaseCount_15)
{
  ...
  else
  {
    ...
    if (succeeded)
    {
      ll_backend__lookup_switch__construct_fail_row_4_p_0(OutTypes_3, &MainRow_52, STATE_VARIABLE_FailCaseCount_0_10, &STATE_VARIABLE_FailCaseCount_1_79);
    ...
    else
    {
      ...
      else
      {
        ...
        STATE_VARIABLE_LaterSolnArray_1_95 = mercury__cord__f_43_43_2_f_0((MR_Word) (&ll_backend__lookup_switch_scalar_common_1[2]), STATE_VARIABLE_LaterSolnArray_0_8, Var_96);
        STATE_VARIABLE_OneSolnCaseCount_1_81 = STATE_VARIABLE_OneSolnCaseCount_0_12;
      }
  ...
  MR_Word * STATE_VARIABLE_CI_75)
{
  ...
  *TestOp_26 = (MR_Word) (MR_mkword(3, &ll_backend__lookup_switch_scalar_common_1[32]));
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_31, (MR_Integer) 756, &ReclaimHeap_44);
