  ...
  MR_Word * STATE_VARIABLE_CLD_30)
{
  ...
  backend_libs__lookup_switch_util__get_word_bits_3_p_0(Globals_17, &WordBits_18, &Log2WordBits_19);
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = ll_backend__lookup_switch__IntroducedFrom__pred__generate_several_soln_int_lookup_switch__494__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 4)))));
  return succeeded;
}
