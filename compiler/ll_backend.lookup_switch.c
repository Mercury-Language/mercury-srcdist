    ...
    switch (MR_tag((MR_Word) HeadVar__1_1)) {
      ...
      case (MR_Integer) 0:
        switch (MR_unmkbody(HeadVar__1_1)) {
          ...
          case (MR_Integer) 8:
            {
              HeadVar__2_2 = (MR_Word) MR_mkword(MR_mktag(3), &ll_backend__lookup_switch_scalar_common_1[37]);
            }
            break;
          case (MR_Integer) 9:
            {
      ...
      case (MR_Integer) 1:
        {
          ...
          HeadVar__2_2 = ((&ll_backend__lookup_switch_vector_common_7[0 + Var_51]))->ll_backend__lookup_switch__vector_common_type_7_0__vct_7_f_0;
        }
        break;
    }
    return HeadVar__2_2;
  ...
  MR_Word * STATE_VARIABLE_BitMap_5)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      {
        MR_Word next_value_of_HeadVar__1_1 = Rest_13;
        MR_Word next_value_of_STATE_VARIABLE_BitMap_0_4 = STATE_VARIABLE_BitMap_28_28;
  ...
  MR_Word * STATE_VARIABLE_RevRows_5)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      /* direct tailcall eliminated */
      {
        MR_Word next_value_of_HeadVar__1_1 = Remainder_18;
        MR_Integer next_value_of_CurIndex_2 = Var_25;
        MR_Word next_value_of_STATE_VARIABLE_RevRows_0_4 = STATE_VARIABLE_RevRows_24_24;
...
{
  {
    ...
    succeeded = ll_backend__lookup_switch__IntroducedFrom__pred__generate_several_soln_int_lookup_switch__493__1_2_p_0(((MR_Word) (MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3))), ((MR_Word) (MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4))));
    return succeeded;
  }
}
  ...
  MR_Word * STATE_VARIABLE_IndexMap_5)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      /* direct tailcall eliminated */
      {
        MR_Word next_value_of_HeadVar__3_3 = TaggedConsIds_14;
        MR_Word next_value_of_STATE_VARIABLE_IndexMap_0_4 = STATE_VARIABLE_IndexMap_18_18;
