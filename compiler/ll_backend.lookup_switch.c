      ...
      case (MR_Integer) 0:
        {
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(3), CmpRval_33, 1) = ((MR_Box) ((MR_Integer) 44));
...
{
  {
    ...
    if ((OutVars_19 == (MR_Word) ((MR_Integer) 0)))
    {
    ...
    else
    {
      ...
      ll_backend__lookup_switch__construct_simple_int_lookup_vector_5_p_0(CaseValues_18, StartVal_16, OutTypes_20, (MR_Word) ((MR_Integer) 0), &RevVectorRvals_32);
    ...
    ll_backend__lookup_util__set_liveness_and_end_branch_7_p_0(StoreMap_15, Liveness_22, (MR_Word) ((MR_Integer) 0), &_MaybeEnd_37, &BranchEndCode_38, *STATE_VARIABLE_CI_40, STATE_VARIABLE_CLD_63_63);
...
{
  {
    ...
    ll_backend__code_info__add_scalar_static_cell_natural_types_4_p_0(BitVecArgs_20, &DataAddr_69, STATE_VARIABLE_CI_0_27, &STATE_VARIABLE_CI_31_31);
    {
      ...
      MR_hl_field(MR_mktag(3), Var_72, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 13));
      MR_hl_field(MR_mktag(3), Var_72, 1) = ((MR_Box) (DataAddr_69));
      MR_hl_field(MR_mktag(3), Var_72, 2) = ((MR_Box) ((MR_Integer) 0));
    }
    {
...
{
  {
    ...
    ll_backend__code_info__add_vector_static_cell_5_p_0(MainRowTypes_45, MainRows_39, &MainVectorAddr_47, STATE_VARIABLE_CI_0_60, &STATE_VARIABLE_CI_80_80);
    {
      ...
      MR_hl_field(MR_mktag(3), Var_81, 2) = ((MR_Box) ((MR_Integer) 0));
    }
    {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(3), Var_105, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 4));
    ...
    ll_backend__lookup_switch__generate_code_for_all_kinds_16_p_0(DescendingSortedKinds_53, (MR_Integer) 0, OutVars_27, ResumeVars_25, EndLabel_20, StoreMap_21, Liveness_30, AddTrailOps_26, BaseReg_54, LaterVectorAddrRval_50, STATE_VARIABLE_MaybeEnd_0_58, STATE_VARIABLE_MaybeEnd_59, &KindsCode_56, STATE_VARIABLE_CI_83_83, STATE_VARIABLE_CI_61, STATE_VARIABLE_CLD_97_97);
    {
      ...
      MR_hl_field(MR_mktag(3), Var_115, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 5));
...
{
  {
    ...
    if ((HeadVar__5_5 == (MR_Word) ((MR_Integer) 0)))
    {
      ...
      else
      {
        ...
        ll_backend__lookup_switch__construct_several_soln_int_lookup_vector_15_p_0(Var_38, EndVal_2, OutTypes_3, NumOutTypes_4, (MR_Word) ((MR_Integer) 0), &MoreMainRows_27, STATE_VARIABLE_LaterNextRow_0_7, STATE_VARIABLE_LaterSolnArray_0_8, STATE_VARIABLE_LaterSolnArray_9, STATE_VARIABLE_FailCaseCount_37_37, STATE_VARIABLE_FailCaseCount_11, STATE_VARIABLE_OneSolnCaseCount_0_12, STATE_VARIABLE_OneSolnCaseCount_13, STATE_VARIABLE_SeveralSolnCaseCount_0_14, STATE_VARIABLE_SeveralSolnCaseCount_15);
        {
          MR_Word base;
          base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
          *HeadVar__6_6 = base;
...
{
  {
    ...
    ll_backend__code_loc_dep__acquire_temp_slot_7_p_0((MR_Word) ((MR_Integer) 16), (MR_Integer) 1, &CurSlot_31, STATE_VARIABLE_CI_0_36, &STATE_VARIABLE_CI_41_41, STATE_VARIABLE_CLD_0_38, &STATE_VARIABLE_CLD_42_42);
    ll_backend__code_loc_dep__acquire_temp_slot_7_p_0((MR_Word) ((MR_Integer) 20), (MR_Integer) 1, &MaxSlot_32, STATE_VARIABLE_CI_41_41, &STATE_VARIABLE_CI_45_45, STATE_VARIABLE_CLD_42_42, &STATE_VARIABLE_CLD_46_46);
  ...
  MR_Word * STATE_VARIABLE_CI_18)
{
  ...
  else
  {
      ...
      case (MR_Integer) 1:
        {
          ...
          {
            Var_252 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), Var_252, 0) = ((MR_Box) (EndLabel_6));
          }
          {
            Var_251 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(3), Var_251, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 6));
            MR_hl_field(MR_mktag(3), Var_251, 1) = ((MR_Box) (Var_252));
          }
          {
            Var_250 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
      ...
      case (MR_Integer) 2:
        {
          ...
          {
            Var_158 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(3), Var_157, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 6));
          ...
          {
            Var_180 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL);
            MR_hl_field(MR_mktag(0), Var_180, 0) = ((MR_Box) (MaxSlot_12));
          }
          {
            Var_176 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(3), Var_176, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 4));
          ...
          {
            Var_181 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(1), Var_181, 0) = ((MR_Box) (UndoLabel_85));
          }
          {
            Var_175 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(3), Var_175, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 9));
          ...
          {
            Var_186 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(3), Var_186, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 4));
          ...
          {
            Var_185 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL));
          ...
          {
            Var_184 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(3), Var_195, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 6));
            MR_hl_field(MR_mktag(3), Var_195, 1) = ((MR_Box) (Var_196));
          }
          {
            Var_194 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(3), Var_200, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 5));
          ...
          {
            Var_206 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(3), Var_206, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 5));
            MR_hl_field(MR_mktag(3), Var_206, 1) = ((MR_Box) (AfterUndoLabel_86));
          }
          {
            Var_205 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
          ...
          {
            Var_212 = (MR_Word) MR_mkword(MR_mktag(2), MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL));
          ...
          {
            Var_211 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
            MR_hl_field(MR_mktag(3), Var_211, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 5));
            MR_hl_field(MR_mktag(3), Var_211, 1) = ((MR_Box) (Var_212));
          }
          {
            Var_210 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL));
          ...
          }
          {
            ...
            MR_hl_field(MR_mktag(1), Var_208, 1) = ((MR_Box) ((MR_Integer) 0));
          }
          {
    ...
    if ((Kinds_41 == (MR_Word) ((MR_Integer) 0)))
    {
      *Code_16 = KindCode_59;
    ...
    else
    {
      ...
      {
        Var_264 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), Var_264, 0) = ((MR_Box) (BaseReg_10));
      }
      {
        Var_266 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
      ...
      {
        Var_260 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 4 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(3), Var_260, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 9));
      ...
      {
        Var_259 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL);
      ...
      {
        Var_272 = (MR_Word) MR_mkword(MR_mktag(3), MR_new_object(MR_Word, ((MR_Integer) 3 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(3), Var_272, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 9));
        MR_hl_field(MR_mktag(3), Var_272, 1) = ((MR_Box) (TestRval_98));
        MR_hl_field(MR_mktag(3), Var_272, 2) = ((MR_Box) (Var_273));
      }
      {
        Var_271 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
      ...
      {
        Var_277 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), Var_277, 0) = ((MR_Box) (Var_278));
      }
      {
        Var_276 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
      ...
      {
        Var_289 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 1 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), Var_289, 0) = ((MR_Box) (Var_290));
      }
      {
        Var_288 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
        MR_hl_field(MR_mktag(0), Var_288, 0) = ((MR_Box) (Var_289));
        MR_hl_field(MR_mktag(0), Var_288, 1) = ((MR_Box) ((MR_String) ""));
      }
      {
        Var_287 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
        MR_hl_field(MR_mktag(1), Var_287, 0) = ((MR_Box) (Var_288));
        MR_hl_field(MR_mktag(1), Var_287, 1) = ((MR_Box) ((MR_Integer) 0));
      }
      {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            ...
            if ((Disjuncts_58 == (MR_Word) ((MR_Integer) 0)))
            {
            ...
            else
            {
              ...
              if (succeeded)
              {
                ...
                if (succeeded)
                {
                  ...
                  if ((ThisResumePoint_63 == (MR_Word) ((MR_Integer) 0)))
