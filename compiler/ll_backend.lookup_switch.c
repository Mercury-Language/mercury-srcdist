...
ll_backend__lookup_switch__IntroducedFrom__pred__generate_several_soln_int_lookup_switch__588__1_2_p_0(
  MR_Word OutVars_27,
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = ll_backend__lookup_switch__IntroducedFrom__pred__generate_several_soln_int_lookup_switch__588__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 4)))));
  return succeeded;
}
  ...
  MR_Word STATE_VARIABLE_CLD_0_62)
{
...

  {
    ...
    MR_hl_field(0, Var_63, 0) = ((MR_Box) (&ll_backend__lookup_switch_scalar_common_9[1]));
  ...
  Var_74 = (MR_Word) (MR_mkword(2, &ll_backend__lookup_switch_scalar_common_4[0]));
  {
  ...
  }
  {
    ...
    MR_hl_field(2, Var_100, 1) = ((MR_Box) (MR_mkword(1, &ll_backend__lookup_switch_scalar_common_4[5])));
  ...
  else
  {
      ...
      case (MR_Integer) 2:
        {
          ...
          Var_133 = (MR_Word) (MR_mkword(1, &ll_backend__lookup_switch_scalar_common_4[5]));
          {
          ...
          }
          {
            ...
            MR_hl_field(3, Var_199, 1) = ((MR_Box) (MR_mkword(1, &ll_backend__lookup_switch_scalar_common_4[0])));
          ...
          }
          {
            ...
            MR_hl_field(2, Var_225, 1) = ((MR_Box) (MR_mkword(1, &ll_backend__lookup_switch_scalar_common_4[5])));
    ...
    else
    {
      ...
      }
      {
        ...
        MR_hl_field(3, Var_259, 1) = ((MR_Box) (MR_mkword(1, &ll_backend__lookup_switch_scalar_common_4[5])));
