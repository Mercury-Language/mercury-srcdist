...
ll_backend__lookup_switch__IntroducedFrom__pred__generate_several_soln_int_lookup_switch__496__1_2_p_0(
  MR_Word OutVars_27,
...
static /* final */ const struct ll_backend__lookup_switch__vector_common_type_7_0_s ll_backend__lookup_switch_vector_common_7[10];
      ...
      case (MR_Integer) 1:
        {
          ...
          HeadVar__2_2 = ((&ll_backend__lookup_switch_vector_common_7[0 + Var_57]))->ll_backend__lookup_switch__vector_common_type_7_0__vct_7_f_0;
        }
        break;
    }
    return HeadVar__2_2;
...
{
  {
    ...
    succeeded = ll_backend__lookup_switch__IntroducedFrom__pred__generate_several_soln_int_lookup_switch__496__1_2_p_0(((MR_Word) (MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3))), ((MR_Word) (MR_hl_field(MR_mktag(0), closure, (MR_Integer) 4))));
    return succeeded;
  }
}
