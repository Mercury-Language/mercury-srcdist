  ...
  MR_Word * STATE_VARIABLE_IndexMap_5)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      MR_Word ConsTag_27 = ((MR_Word) ((MR_hl_field(MR_mktag(0), TaggedConsId_13, (MR_Integer) 1))));
      MR_Box Index_28;
      ...
      func_0(((MR_Box) (HeadVar__1_1)), ((MR_Box) (ConsTag_27)), &Index_28);
      mercury__map__det_insert_4_p_0(TypeInfo_for_Key_19, (MR_Word) (&ll_backend__lookup_switch_scalar_common_1[0]), Index_28, ((MR_Box) (HeadVar__2_2)), STATE_VARIABLE_IndexMap_0_4, &STATE_VARIABLE_IndexMap_18_18);
      // direct tailcall eliminated
      ;
