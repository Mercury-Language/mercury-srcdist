...
{
  {
    ...
    else
    {
      ...
      packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(0), Var_59, (MR_Integer) 1)));
              ...
              if (succeeded)
              {
                ...
                if (succeeded)
                {
                  ...
                  else
                  {
                    ...
                    MR_Unsigned packed_args_0 = (MR_Unsigned) ((MR_hl_field(MR_mktag(1), ThisResumePoint_63, (MR_Integer) 1)));
