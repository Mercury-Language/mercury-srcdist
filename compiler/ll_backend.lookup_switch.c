...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(3), ll_backend__lookup_switch__V_67_67, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 5));
    ...
    if ((ll_backend__lookup_switch__OutVars_19 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
    ...
    else
      {
        ...
        }
        {
          ...
          MR_hl_field(MR_mktag(3), ll_backend__lookup_switch__V_48_48, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 5));
          ...
          case (MR_Integer) 2:
            {
              ...
              {
                libs__globals__lookup_bool_option_3_p_0(ll_backend__lookup_switch__Globals_63, (MR_Integer) 307, &ll_backend__lookup_switch__ReclaimHeap_71);
              }
              {
...
{
  {
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(3), ll_backend__lookup_switch__V_81_81, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 5));
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(3), ll_backend__lookup_switch__V_84_84, 0) = ((MR_Box) (MR_Word) ((MR_Integer) 5));
