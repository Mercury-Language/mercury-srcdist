...
static /* final */ const MR_Box ll_backend__lookup_switch_scalar_common_1[40][2];
  ...
  MR_Word * STATE_VARIABLE_CI_40)
{
  ...
  else
  {
...

    {
      ...
      MR_hl_field(1, Var_46, 0) = ((MR_Box) (StartVal_14));
    }
    {
    ...
    }
    {
      ...
      MR_hl_field(3, IndexRval_27, 1) = ((MR_Box) (MR_mkword(2, &ll_backend__lookup_switch_scalar_common_4[0])));
      MR_hl_field(3, IndexRval_27, 2) = ((MR_Box) (VarRval_11));
      MR_hl_field(3, IndexRval_27, 3) = ((MR_Box) (Var_45));
    }
  }
    ...
    case (MR_Integer) 1:
      {
        ...
        CLD_31 = CLD0_26;
        STATE_VARIABLE_CI_50_50 = STATE_VARIABLE_CI_42_42;
      }
      break;
    case (MR_Integer) 0:
      {
...

        {
          ...
          MR_hl_field(1, Var_49, 0) = ((MR_Box) (Difference_28));
        }
        {
        ...
        }
        {
          ...
          MR_hl_field(3, CmpRval_29, 1) = ((MR_Box) ((MR_Unsigned) 48U));
          MR_hl_field(3, CmpRval_29, 2) = ((MR_Box) (IndexRval_27));
          MR_hl_field(3, CmpRval_29, 3) = ((MR_Box) (Var_48));
        }
        ll_backend__code_loc_dep__fail_if_rval_is_false_6_p_0(CmpRval_29, &RangeCheckCode_30, STATE_VARIABLE_CI_42_42, &STATE_VARIABLE_CI_50_50, CLD0_26, &CLD_31);
      }
      break;
  }
    ...
    case (MR_Integer) 0:
      {
        ...
        else
        {
          ...
          }
          {
            ...
            MR_hl_field(3, Var_75, 1) = ((MR_Box) (MR_mkword(1, &ll_backend__lookup_switch_scalar_common_4[1])));
        ...
        }
        {
          ...
          MR_hl_field(3, Var_87, 1) = ((MR_Box) (MR_mkword(3, &ll_backend__lookup_switch_scalar_common_1[38])));
          MR_hl_field(3, Var_87, 2) = ((MR_Box) (MR_mkword(3, &ll_backend__lookup_switch_scalar_common_1[39])));
  ...
  MR_Word STATE_VARIABLE_CLD_0_58)
{
  ...
  succeeded = (NeedBitVecCheck_26 == (MR_Integer) 0);
  if (succeeded)
  {
    Var_67 = (MR_Integer) 0;
  ...
  Var_70 = (MR_Word) (MR_mkword(2, &ll_backend__lookup_switch_scalar_common_4[0]));
  {
  ...
  MR_Word * STATE_VARIABLE_CI_49)
{
  ...
  MR_Word STATE_VARIABLE_MaybeEnd_55_55;

  switch (Kind_19) {
    default: /*NOTREACHED*/ MR_assert(0);
    case (MR_Integer) 1:
      {
        MR_Word BranchEndCode_98;
        MR_Word STATE_VARIABLE_CLD_26_99;
        MR_Integer Var_100;
        MR_Word STATE_VARIABLE_CLD_28_101;
        ...
        ll_backend__code_loc_dep__reset_to_position_3_p_0(BranchStart_23, STATE_VARIABLE_CI_0_48, &STATE_VARIABLE_CLD_26_99);
        Var_100 = (MR_Integer) ((MR_Unsigned) NumPrevColumns_21 + (MR_Unsigned) 2);
        ll_backend__lookup_util__record_offset_assigns_6_p_0(OutVars_22, Var_100, BaseRegLval_25, STATE_VARIABLE_CI_0_48, STATE_VARIABLE_CLD_26_99, &STATE_VARIABLE_CLD_28_101);
        ll_backend__lookup_util__set_liveness_and_end_branch_5_p_0(EndBranch_29, &BranchEndCode_98, STATE_VARIABLE_MaybeEnd_0_46, &STATE_VARIABLE_MaybeEnd_55_55, STATE_VARIABLE_CLD_28_101);
        {
          Var_105 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(1, Var_105, 0) = ((MR_Box) (EndLabel_24));
        }
        {
        ...
        }
        {
          ...
          MR_hl_field(0, Var_103, 1) = ((MR_Box) ((MR_String) "go to end of switch"));
        }
        GotoEndCode_102 = mercury__cord__singleton_1_f_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_instruction_0), ((MR_Box) (Var_103)));
        KindCode_35 = mercury__cord__f_43_43_2_f_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_instruction_0), BranchEndCode_98, GotoEndCode_102);
        STATE_VARIABLE_CI_53_53 = STATE_VARIABLE_CI_0_48;
      }
      break;
    case (MR_Integer) 2:
      ll_backend__lookup_switch__generate_table_lookup_code_for_kind_several_solns_16_p_0(CaseConstsSeveralLlds_18, NumPrevColumns_21, OutVars_22, BranchStart_23, EndLabel_24, BaseRegLval_25, CurSlot_26, MaxSlot_27, LaterSolnsTableAddrRval_28, &SkipToNextKindTestOp_33, EndBranch_29, &KindCode_35, STATE_VARIABLE_MaybeEnd_0_46, &STATE_VARIABLE_MaybeEnd_55_55, STATE_VARIABLE_CI_0_48, &STATE_VARIABLE_CI_53_53);
      break;
    case (MR_Integer) 0:
      {
        ...
        ll_backend__code_loc_dep__reset_to_position_3_p_0(BranchStart_23, STATE_VARIABLE_CI_0_48, &STATE_VARIABLE_CLD_51_51);
        ll_backend__code_loc_dep__release_reg_3_p_0(BaseRegLval_25, STATE_VARIABLE_CLD_51_51, &STATE_VARIABLE_CLD_52_52);
        ll_backend__code_loc_dep__generate_failure_4_p_0(&KindCode_35, STATE_VARIABLE_CI_0_48, &STATE_VARIABLE_CI_53_53, STATE_VARIABLE_CLD_52_52);
        STATE_VARIABLE_MaybeEnd_55_55 = STATE_VARIABLE_MaybeEnd_0_46;
      }
      break;
  }
  ...
  {
    *Code_30 = KindCode_35;
    *STATE_VARIABLE_MaybeEnd_47 = STATE_VARIABLE_MaybeEnd_55_55;
    *STATE_VARIABLE_CI_49 = STATE_VARIABLE_CI_53_53;
  }
  else
  {
    ...
    ll_backend__code_info__get_next_label_3_p_0(&NextKindLabel_39, STATE_VARIABLE_CI_53_53, &STATE_VARIABLE_CI_58_58);
    {
      Var_64 = (MR_Word) MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(0, Var_64, 0) = ((MR_Box) (BaseRegLval_25));
    }
    {
      Var_66 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
      MR_hl_field(1, Var_66, 0) = ((MR_Box) (NumPrevColumns_21));
    }
    {
    ...
    }
    {
      ...
      MR_hl_field(3, Var_60, 1) = ((MR_Box) (MR_mkword(1, &ll_backend__lookup_switch_scalar_common_4[1])));
      MR_hl_field(3, Var_60, 2) = ((MR_Box) (Var_64));
      MR_hl_field(3, Var_60, 3) = ((MR_Box) (Var_65));
    }
    {
    ...
    }
    {
      ...
      MR_hl_field(3, TestRval_40, 2) = ((MR_Box) (Var_59));
      MR_hl_field(3, TestRval_40, 3) = ((MR_Box) (MR_mkword(3, &ll_backend__lookup_switch_scalar_common_1[7])));
    }
    switch (Kind_19) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 1:
        Var_71 = (MR_String) "kind_one_soln";
        break;
      case (MR_Integer) 2:
        Var_71 = (MR_String) "kind_several_solns";
        break;
      case (MR_Integer) 0:
        Var_71 = (MR_String) "kind_zero_solns";
        break;
    }
    KindComment_41 = mercury__string__f_43_43_2_f_0((MR_String) "This kind is ", Var_71);
    switch (NextKind_37) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 1:
    ...
    NextKindLabelCode_44 = mercury__cord__from_list_1_f_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_instruction_0), Var_84);
    ll_backend__lookup_switch__generate_table_lookup_code_for_each_kind_17_p_0(CaseConstsSeveralLlds_18, NextKind_37, LaterKinds_38, NumPrevColumns_21, OutVars_22, BranchStart_23, EndLabel_24, BaseRegLval_25, CurSlot_26, MaxSlot_27, LaterSolnsTableAddrRval_28, EndBranch_29, &LaterKindsCode_45, STATE_VARIABLE_MaybeEnd_55_55, STATE_VARIABLE_MaybeEnd_47, STATE_VARIABLE_CI_58_58, STATE_VARIABLE_CI_49);
    Var_96 = mercury__cord__f_43_43_2_f_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_instruction_0), NextKindLabelCode_44, LaterKindsCode_45);
    Var_95 = mercury__cord__f_43_43_2_f_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_instruction_0), KindCode_35, Var_96);
    *Code_30 = mercury__cord__f_43_43_2_f_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_instruction_0), TestCode_43, Var_95);
  }
}
  ...
  MR_Word * STATE_VARIABLE_CI_75)
{
  ...
  *TestOp_26 = (MR_Word) (MR_mkword(3, &ll_backend__lookup_switch_scalar_common_1[32]));
  ...
  ll_backend__code_loc_dep__reset_to_position_3_p_0(BranchStart_20, STATE_VARIABLE_CI_0_74, &STATE_VARIABLE_CLD_77_77);
  ...
  Var_78 = parse_tree__set_of_var__to_sorted_list_1_f_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_prog_var_type_0), ResumeVars_33);
  ll_backend__code_loc_dep__produce_vars_5_p_0(Var_78, &ResumeMap_36, &FlushCode_37, STATE_VARIABLE_CLD_77_77, &STATE_VARIABLE_CLD_79_79);
  {
    Var_80 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(1, Var_80, 0) = ((MR_Box) (NumPrevColumns_18));
  }
  {
    ...
    MR_hl_field(3, MinOffsetColumnRval_38, 1) = ((MR_Box) (Var_80));
  }
  Var_82 = (MR_Integer) ((MR_Unsigned) NumPrevColumns_18 + (MR_Unsigned) 1);
  {
    Var_81 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
  ...
  }
  {
    ...
    MR_hl_field(3, MaxOffsetColumnRval_39, 1) = ((MR_Box) (Var_81));
  }
  Var_89 = (MR_Word) (MR_mkword(1, &ll_backend__lookup_switch_scalar_common_4[1]));
  {
    ...
    MR_hl_field(0, Var_92, 0) = ((MR_Box) (BaseRegLval_22));
  }
  {
    ...
    MR_hl_field(3, Var_88, 3) = ((MR_Box) (MinOffsetColumnRval_38));
  }
  {
  ...
  }
  {
    ...
    MR_hl_field(3, Var_86, 1) = ((MR_Box) (CurSlot_23));
  ...
  }
  {
    ...
    MR_hl_field(3, Var_98, 3) = ((MR_Box) (MaxOffsetColumnRval_39));
  }
  {
  ...
  }
  {
    ...
    MR_hl_field(3, Var_96, 1) = ((MR_Box) (MaxSlot_24));
  ...
  SaveSlotsCode_41 = mercury__cord__from_list_1_f_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_instruction_0), Var_84);
  ll_backend__code_loc_dep__maybe_save_ticket_7_p_0(AddTrailOps_35, &SaveTicketCode_42, &MaybeTicketSlot_43, STATE_VARIABLE_CI_0_74, &STATE_VARIABLE_CI_105_105, STATE_VARIABLE_CLD_79_79, &STATE_VARIABLE_CLD_106_106);
  libs__globals__lookup_bool_option_3_p_0(Globals_31, (MR_Integer) 354, &ReclaimHeap_44);
  ll_backend__code_loc_dep__maybe_save_hp_7_p_0(ReclaimHeap_44, &SaveHpCode_45, &MaybeHpSlot_46, STATE_VARIABLE_CI_105_105, &STATE_VARIABLE_CI_108_108, STATE_VARIABLE_CLD_106_106, &STATE_VARIABLE_CLD_109_109);
  ll_backend__code_loc_dep__prepare_for_disj_hijack_7_p_0((MR_Integer) 2, &HijackInfo_47, &PrepareHijackCode_48, STATE_VARIABLE_CI_108_108, &STATE_VARIABLE_CI_111_111, STATE_VARIABLE_CLD_109_109, &STATE_VARIABLE_CLD_112_112);
  ll_backend__code_loc_dep__remember_position_2_p_0(STATE_VARIABLE_CLD_112_112, &DisjEntry_49);
  ll_backend__code_loc_dep__make_resume_point_6_p_0(ResumeVars_33, (MR_Integer) 1, ResumeMap_36, &ResumePoint_50, STATE_VARIABLE_CI_111_111, &STATE_VARIABLE_CI_114_114);
  ll_backend__code_loc_dep__effect_resume_point_5_p_0(ResumePoint_50, (MR_Integer) 2, &UpdateRedoipCode_51, STATE_VARIABLE_CLD_112_112, &STATE_VARIABLE_CLD_116_116);
  Var_117 = (MR_Integer) ((MR_Unsigned) NumPrevColumns_18 + (MR_Unsigned) 2);
  ll_backend__lookup_util__record_offset_assigns_6_p_0(OutVars_19, Var_117, BaseRegLval_22, STATE_VARIABLE_CI_114_114, STATE_VARIABLE_CLD_116_116, &STATE_VARIABLE_CLD_118_118);
  ll_backend__code_loc_dep__flush_resume_vars_to_stack_3_p_0(&FirstFlushResumeVarsCode_52, STATE_VARIABLE_CLD_118_118, &STATE_VARIABLE_CLD_119_119);
  ll_backend__code_loc_dep__pop_resume_point_2_p_0(STATE_VARIABLE_CLD_119_119, &STATE_VARIABLE_CLD_120_120);
  ll_backend__code_loc_dep__pickup_zombies_3_p_0(&FirstZombies_53, STATE_VARIABLE_CLD_120_120, &STATE_VARIABLE_CLD_121_121);
  ll_backend__code_loc_dep__make_vars_forward_dead_3_p_0(FirstZombies_53, STATE_VARIABLE_CLD_121_121, &STATE_VARIABLE_CLD_122_122);
  ll_backend__lookup_util__set_liveness_and_end_branch_5_p_0(EndBranch_27, &FirstBranchEndCode_54, STATE_VARIABLE_MaybeEnd_0_72, &STATE_VARIABLE_MaybeEnd_123_123, STATE_VARIABLE_CLD_122_122);
  {
    Var_126 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(1, Var_126, 0) = ((MR_Box) (EndLabel_21));
  }
  {
  ...
  GotoEndCode_55 = mercury__cord__singleton_1_f_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_instruction_0), ((MR_Box) (Var_124)));
  ll_backend__code_loc_dep__reset_to_position_3_p_0(DisjEntry_49, STATE_VARIABLE_CI_114_114, &STATE_VARIABLE_CLD_128_128);
  ll_backend__code_loc_dep__generate_resume_point_6_p_0(ResumePoint_50, &ResumePointCode_56, STATE_VARIABLE_CI_114_114, &STATE_VARIABLE_CI_129_129, STATE_VARIABLE_CLD_128_128, &STATE_VARIABLE_CLD_130_130);
  ...
  ll_backend__code_loc_dep__acquire_reg_not_in_storemap_5_p_0(StoreMap_59, (MR_Integer) 0, &LaterBaseRegLval_61, STATE_VARIABLE_CLD_130_130, &STATE_VARIABLE_CLD_133_133);
  ...
  mercury__list__length_2_p_0((MR_Word) (&ll_backend__lookup_switch_scalar_common_1[1]), OutVars_19, &NumOutVars_64);
  {
    ...
    MR_hl_field(0, Var_139, 0) = ((MR_Box) (CurSlot_23));
  }
  {
    ...
    MR_hl_field(3, Var_138, 1) = ((MR_Box) (LaterBaseRegLval_61));
  ...
  }
  {
    ...
    MR_hl_field(0, Var_147, 0) = ((MR_Box) (LaterBaseRegLval_61));
  }
  {
    Var_148 = (MR_Word) MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(0, Var_148, 0) = ((MR_Box) (MaxSlot_24));
  }
  {
    ...
    MR_hl_field(3, Var_144, 1) = ((MR_Box) (MR_mkword(3, &ll_backend__lookup_switch_scalar_common_1[31])));
  ...
  }
  {
    ...
    MR_hl_field(3, Var_153, 1) = ((MR_Box) (CurSlot_23));
  ...
  ll_backend__code_loc_dep__undo_disj_hijack_4_p_0(HijackInfo_47, &UndoHijackCode_66, STATE_VARIABLE_CLD_133_133, &STATE_VARIABLE_CLD_171_171);
  {
  ...
  }
  {
    ...
    MR_hl_field(2, Var_180, 0) = ((MR_Box) (LaterSolnsTableAddrRval_25));
  ...
  }
  {
    ...
    MR_hl_field(3, Var_178, 1) = ((MR_Box) (LaterBaseRegLval_61));
  ...
  ll_backend__code_loc_dep__effect_resume_point_5_p_0(ResumePoint_50, (MR_Integer) 2, &_LaterUpdateRedoipCode_68, STATE_VARIABLE_CLD_171_171, &STATE_VARIABLE_CLD_188_188);
  ll_backend__lookup_util__record_offset_assigns_6_p_0(OutVars_19, (MR_Integer) 0, LaterBaseRegLval_61, *STATE_VARIABLE_CI_75, STATE_VARIABLE_CLD_188_188, &STATE_VARIABLE_CLD_190_190);
  ...
  ll_backend__lookup_util__set_liveness_and_end_branch_5_p_0(EndBranch_27, &LaterBranchEndCode_71, STATE_VARIABLE_MaybeEnd_123_123, STATE_VARIABLE_MaybeEnd_73, STATE_VARIABLE_CLD_194_194);
  Var_211 = mercury__cord__f_43_43_2_f_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_instruction_0), LaterBranchEndCode_71, GotoEndCode_55);
  ...
  Var_206 = mercury__cord__f_43_43_2_f_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_instruction_0), RestoreHpCode_58, Var_207);
  Var_205 = mercury__cord__f_43_43_2_f_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_instruction_0), RestoreTicketCode_57, Var_206);
  Var_204 = mercury__cord__f_43_43_2_f_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_instruction_0), ResumePointCode_56, Var_205);
  Var_203 = mercury__cord__f_43_43_2_f_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_instruction_0), GotoEndCode_55, Var_204);
  Var_202 = mercury__cord__f_43_43_2_f_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_instruction_0), FirstBranchEndCode_54, Var_203);
  Var_201 = mercury__cord__f_43_43_2_f_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_instruction_0), FirstFlushResumeVarsCode_52, Var_202);
  Var_200 = mercury__cord__f_43_43_2_f_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_instruction_0), UpdateRedoipCode_51, Var_201);
  Var_199 = mercury__cord__f_43_43_2_f_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_instruction_0), PrepareHijackCode_48, Var_200);
  Var_198 = mercury__cord__f_43_43_2_f_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_instruction_0), SaveHpCode_45, Var_199);
  Var_197 = mercury__cord__f_43_43_2_f_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_instruction_0), SaveTicketCode_42, Var_198);
  Var_196 = mercury__cord__f_43_43_2_f_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_instruction_0), SaveSlotsCode_41, Var_197);
  *KindCode_28 = mercury__cord__f_43_43_2_f_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_instruction_0), FlushCode_37, Var_196);
}
  ...
  MR_Word * STATE_VARIABLE_CLD_22)
{
  ...
  if (((MR_tag((MR_Word) MainRowSelect_10)) == (MR_Integer) 0))
  {
    ...
    else
    {
...

      {
        ...
        MR_hl_field(1, Var_28, 0) = ((MR_Box) (MainNumColumns_18));
      }
      {
      ...
      }
      {
        ...
        MR_hl_field(3, MainRowStartOffsetRval_19, 1) = ((MR_Box) (MR_mkword(3, &ll_backend__lookup_switch_scalar_common_1[6])));
        MR_hl_field(3, MainRowStartOffsetRval_19, 2) = ((MR_Box) (MainRowNumRval_16));
        MR_hl_field(3, MainRowStartOffsetRval_19, 3) = ((MR_Box) (Var_27));
      }
    }
  }
  else
    MainRowStartOffsetRval_19 = ((MR_Word) ((MR_hl_field(1, MainRowSelect_10, (MR_Integer) 0))));
  {
    ...
    MR_hl_field(3, Var_29, 0) = ((MR_Box) ((MR_Unsigned) 13U));
    MR_hl_field(3, Var_29, 1) = ((MR_Box) (MainTableDataId_8));
  }
  {
    ...
    MR_hl_field(3, MainTableAddrRval_20, 1) = ((MR_Box) (Var_29));
  }
  {
    Var_33 = (MR_Word) MR_mkword(2, MR_new_object(MR_Word, (3 * sizeof(MR_Word)), NULL, NULL));
    MR_hl_field(2, Var_33, 0) = ((MR_Box) (MainTableAddrRval_20));
    MR_hl_field(2, Var_33, 1) = ((MR_Box) (MR_mkword(1, &ll_backend__lookup_switch_scalar_common_4[1])));
    MR_hl_field(2, Var_33, 2) = ((MR_Box) (MainRowStartOffsetRval_19));
  }
  {
  ...
  }
  {
    ...
    MR_hl_field(3, Var_31, 1) = ((MR_Box) (*BaseRegLval_11));
  ...
  }
  {
    ...
    MR_hl_field(0, Var_30, 1) = ((MR_Box) ((MR_String) "set up base reg"));
  }
  *SetBaseRegCode_12 = mercury__cord__singleton_1_f_0((MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_instruction_0), ((MR_Box) (Var_30)));
}
