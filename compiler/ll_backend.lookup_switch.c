...
ll_backend__lookup_switch__IntroducedFrom__pred__generate_several_soln_int_lookup_switch__495__1_2_p_0(
  MR_Word OutVars_27,
  ...
  MR_Word HeadVar__3_3)
{
  ...
  else
  {
    ...
    backend_libs__lookup_switch_util____Compare____case_consts_3_0(TypeInfo_for_Key_17, (MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_rval_0), (MR_Word) (&backend_libs__lookup_switch_util__backend_libs__lookup_switch_util__type_ctor_info_case_consts_several_llds_0), &SubResult1_6, ArgX1_4, ArgY1_5);
  ...
  MR_Word HeadVar__2_2)
{
  ...
  else
  {
    ...
    succeeded = backend_libs__lookup_switch_util____Unify____case_consts_3_0(TypeInfo_for_Key_13, (MR_Word) (&ll_backend__llds__ll_backend__llds__type_ctor_info_rval_0), (MR_Word) (&backend_libs__lookup_switch_util__backend_libs__lookup_switch_util__type_ctor_info_case_consts_several_llds_0), ArgX1_3, ArgY1_4);
    if (succeeded)
    {
  ...
  MR_Word * STATE_VARIABLE_CLD_31)
{
  ...
  else
  {
    ...
    }
    {
      ...
      MR_hl_field(3, WordNum_26, 1) = ((MR_Box) (MR_mkword(3, &ll_backend__lookup_switch_scalar_common_1[37])));
    ...
    }
    {
      ...
      MR_hl_field(3, BitNum_25, 1) = ((MR_Box) (MR_mkword(3, &ll_backend__lookup_switch_scalar_common_1[38])));
  ...
  }
  {
    ...
    MR_hl_field(3, Var_51, 1) = ((MR_Box) (MR_mkword(3, &ll_backend__lookup_switch_scalar_common_1[39])));
    MR_hl_field(3, Var_51, 2) = ((MR_Box) (MR_mkword(3, &ll_backend__lookup_switch_scalar_common_1[40])));
  ...
  }
  {
    ...
    MR_hl_field(3, HasBit_27, 1) = ((MR_Box) (MR_mkword(3, &ll_backend__lookup_switch_scalar_common_1[38])));
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = ll_backend__lookup_switch__IntroducedFrom__pred__generate_several_soln_int_lookup_switch__495__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 4)))));
  return succeeded;
}
  ...
  MR_Word * STATE_VARIABLE_CI_39)
{
  ...
  if (succeeded)
  {
    ...
    succeeded = backend_libs__lookup_switch_util__project_all_to_one_solution_2_p_0(TypeInfo_for_Key_48, TypeCtorInfo_55_55, CaseSolnMap_23, &CaseValuePairsMap_28);
    if (succeeded)
      {
    ...
    backend_libs__lookup_switch_util__project_solns_to_rval_lists_3_p_0(TypeInfo_for_Key_48, TypeCtorInfo_56_56, CaseSolns_33, Var_47, &CaseValues_34);
