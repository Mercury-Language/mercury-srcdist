...
MR_decl_label10(ll_backend__lookup_switch__is_lookup_switch_9_0, 2,3,4,5,6,7,9,10,11,13)
MR_decl_label7(ll_backend__lookup_switch__is_lookup_switch_9_0, 15,14,21,23,24,25,1)
...
MR_BEGIN_MODULE(ll_backend__lookup_switch_module3)
	...
	MR_init_label10(ll_backend__lookup_switch__is_lookup_switch_9_0,2,3,4,5,6,7,9,10,11,13)
	MR_init_label7(ll_backend__lookup_switch__is_lookup_switch_9_0,15,14,21,23,24,25,1)
MR_BEGIN_CODE
...
MR_def_label(ll_backend__lookup_switch__is_lookup_switch_9_0,15)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(ll_backend__lookup_switch__is_lookup_switch_9_0_i14);
	}
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 0, (MR_Integer) 1);
	...
	MR_np_call_localret_ent(assoc_list__values_2_0,
		ll_backend__lookup_switch__is_lookup_switch_9_0_i21);
MR_def_label(ll_backend__lookup_switch__is_lookup_switch_9_0,14)
	...
	MR_np_call_localret_ent(backend_libs__switch_util__project_solns_to_rval_lists_3_0,
		ll_backend__lookup_switch__is_lookup_switch_9_0_i21);
MR_def_label(ll_backend__lookup_switch__is_lookup_switch_9_0,21)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(5) = MR_r1;
	MR_r1 = MR_sv(7);
