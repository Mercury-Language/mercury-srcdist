  ...
  MR_Word * STATE_VARIABLE_CLD_30)
{
  ...
  ll_backend__code_info__add_scalar_static_cell_natural_types_4_p_0(BitVecArgs_20, &DataAddr_61, STATE_VARIABLE_CI_0_27, &STATE_VARIABLE_CI_31_31);
  {
    ...
    MR_hl_field(MR_mktag(3), Var_63, 1) = ((MR_Box) (DataAddr_61));
  ...
  }
  {
    ...
    MR_hl_field(MR_mktag(3), BitVecRval_21, 1) = ((MR_Box) (Var_63));
  }
  ...
  MR_Word * STATE_VARIABLE_IndexMap_5)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      MR_Word ConsTag_21 = ((MR_Word) ((MR_hl_field(MR_mktag(0), TaggedConsId_13, (MR_Integer) 1))));
      MR_Box Index_22;
