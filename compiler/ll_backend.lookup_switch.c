...
{
  {
    ...
    switch (MR_tag((MR_Word) HeadVar__1_1)) {
      ...
      case (MR_Integer) 2:
        {
          MR_Word Var_48 = ((MR_Word) (MR_hl_field(MR_mktag(2), HeadVar__1_1, (MR_Integer) 0)));
...
{
  {
    ...
    Var_77 = (MR_Word) MR_mkword(MR_mktag(2), &ll_backend__lookup_switch_scalar_common_3[2]);
    {
