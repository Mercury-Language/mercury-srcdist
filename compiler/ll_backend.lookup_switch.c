...
static /* final */ const MR_Box ll_backend__lookup_switch_scalar_common_7[2][5];

static /* final */ const MR_Box ll_backend__lookup_switch_scalar_common_8[1][4];
...
{
  {
...

    {
      ...
      MR_hl_field(MR_mktag(0), Var_66, 0) = ((MR_Box) (&ll_backend__lookup_switch_scalar_common_7[1]));
    ...
    }
    {
      ...
      MR_hl_field(MR_mktag(0), Var_63, 0) = ((MR_Box) (&ll_backend__lookup_switch_scalar_common_8[0]));
