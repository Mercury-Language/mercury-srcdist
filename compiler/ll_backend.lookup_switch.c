  ...
  MR_Box closure_arg)
{
  ...
  succeeded = ll_backend__lookup_switch__IntroducedFrom__pred__generate_several_soln_int_lookup_switch__499__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 4)))));
  return succeeded;
}
  ...
  MR_Word STATE_VARIABLE_CLD_0_62)
{
...

  {
    ...
    MR_hl_field(0, Var_66, 0) = ((MR_Box) (&ll_backend__lookup_switch_scalar_common_8[1]));
    MR_hl_field(0, Var_66, 1) = ((MR_Box) (ll_backend__lookup_switch__generate_several_soln_int_lookup_switch_18_p_0_1));
    MR_hl_field(0, Var_66, 2) = ((MR_Box) ((MR_Integer) 2));
    MR_hl_field(0, Var_66, 3) = ((MR_Box) (OutVars_27));
    MR_hl_field(0, Var_66, 4) = ((MR_Box) ((MR_Unsigned) 0U));
  }
  {
    Var_63 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(0, Var_63, 0) = ((MR_Box) (&ll_backend__lookup_switch_scalar_common_9[0]));
    MR_hl_field(0, Var_63, 1) = ((MR_Box) (ll_backend__lookup_switch__generate_several_soln_int_lookup_switch_18_p_0_2));
  ...
  Var_75 = (MR_Word) (MR_mkword(2, &ll_backend__lookup_switch_scalar_common_3[0]));
  {
  ...
  }
  {
    ...
    MR_hl_field(3, Var_105, 1) = ((MR_Box) (MR_mkword(3, &ll_backend__lookup_switch_scalar_common_1[30])));
  ...
  }
  {
    ...
    MR_hl_field(2, Var_101, 1) = ((MR_Box) (MR_mkword(1, &ll_backend__lookup_switch_scalar_common_3[5])));
  ...
  }
  {
    ...
    MR_hl_field(3, Var_99, 1) = ((MR_Box) (BaseReg_54));
      ...
      case (MR_Integer) 2:
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_62, (MR_Integer) 350, &ReclaimHeap_70);
