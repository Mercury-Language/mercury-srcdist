  ...
  MR_Word * STATE_VARIABLE_Info_20)
{
  ...
  make__deps_set__module_name_to_index_4_p_0(ModuleName_12, &ModuleIndex_17, STATE_VARIABLE_Info_0_19, &STATE_VARIABLE_Info_1_23);
  ...
  MR_Word * STATE_VARIABLE_Info_26)
{
  ...
  else
  {
      ...
      else
      {
        ...
        else
        {
          ...
          if (succeeded)
          {
            ...
            make__deps_set__module_names_to_index_set_4_p_0(Var_70, &ImportedModuleIndexSet_52, STATE_VARIABLE_Info_1_39, &STATE_VARIABLE_Info_1_71);
            ...
            make__deps_set__module_names_to_index_set_4_p_0(Var_72, &IncludedModuleIndexSet_53, STATE_VARIABLE_Info_1_71, &STATE_VARIABLE_Info_2_73);
    ...
    make__deps_cache__add_to_trans_deps_cache_4_p_0(Key_21, Result_24, STATE_VARIABLE_Info_1_30, STATE_VARIABLE_Info_26);
  }
}
    ...
    else
    {
      ...
      else
      {
        ...
        if (succeeded)
        {
          ...
          make__deps_set__module_names_to_index_set_4_p_0(Var_67, &ImportedModuleIndexSet_49, STATE_VARIABLE_Info_1_36, &STATE_VARIABLE_Info_1_68);
          ...
          make__deps_set__module_names_to_index_set_4_p_0(Var_69, &IncludedModuleIndexSet_50, STATE_VARIABLE_Info_1_68, &STATE_VARIABLE_Info_2_70);
