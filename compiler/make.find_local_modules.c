...
static void MR_CALL 
make__find_local_modules__IntroducedFrom__pred__do_find_transitive_module_dependencies_uncached__189__2_2_p_0(
  MR_Word LambdaHeadVar__1_134,
  MR_Word * LambdaHeadVar__2_135);

static void MR_CALL 
make__find_local_modules__IntroducedFrom__pred__do_find_transitive_module_dependencies_uncached__189__1_2_p_0(
  ...
  MR_Box * wrapper_arg_2)
{
  ...
  MR_Word conv2_LambdaHeadVar__2_135;

  make__find_local_modules__IntroducedFrom__pred__do_find_transitive_module_dependencies_uncached__189__2_2_p_0(((MR_Word) (wrapper_arg_1)), &conv2_LambdaHeadVar__2_135);
  *wrapper_arg_2 = ((MR_Box) (conv2_LambdaHeadVar__2_135));
}
...
{
  MR_Box closure = closure_arg;
  MR_Word conv1_LambdaHeadVar__2_61;

  make__find_local_modules__IntroducedFrom__pred__do_find_transitive_module_dependencies_uncached__189__1_2_p_0(((MR_Word) (wrapper_arg_1)), &conv1_LambdaHeadVar__2_61);
  *wrapper_arg_2 = ((MR_Box) (conv1_LambdaHeadVar__2_61));
}
  ...
  MR_Box closure_arg)
{
  ...
  succeeded = make__find_local_modules__IntroducedFrom__pred__do_find_transitive_module_dependencies_uncached__173__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 4)))));
  return succeeded;
}
    ...
    else
    {
      ...
      else
      {
        ...
        if (succeeded)
        {
          ...
          make__deps_set__module_names_to_index_set_4_p_0(Var_68, &ImportsToCheckSet_52, STATE_VARIABLE_Info_37_37, &STATE_VARIABLE_Info_90_69);
          ...
          make__find_local_modules__acc_module_index_trans_deps_14_p_0(ProgressStream_14, KeepGoing_15, DependenciesType_16, ProcessModulesWhere_17, Globals_18, Var_75, (MR_Integer) 1, &SucceededImports_56, Modules1_54, &Modules2_57, STATE_VARIABLE_Info_94_73, &STATE_VARIABLE_Info_98_77);
          {
          ...
          make__find_local_modules__acc_module_index_trans_deps_14_p_0(ProgressStream_14, KeepGoing_15, DependenciesType_16, ProcessModulesWhere_17, Globals_18, Var_82, (MR_Integer) 1, &SucceededIncludes_58, Modules2_57, Modules_22, STATE_VARIABLE_Info_101_80, &STATE_VARIABLE_Info_105_84);
          make__make_info__make_info_set_importing_module_3_p_0(OldImportingModule_55, STATE_VARIABLE_Info_105_84, STATE_VARIABLE_Info_33);
