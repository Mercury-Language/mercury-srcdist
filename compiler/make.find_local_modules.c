  ...
  MR_Word * STATE_VARIABLE_Info_12)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      make__find_local_modules__find_transitive_module_dependencies_uncached_13_p_0(ProgressStream_1, KeepGoing_3, WhichDeps_4, ProcessModulesWhere_5, Globals_2, HeadModuleIndex_37, &HeadSucceeded_43, HeadVar__9_9, &STATE_VARIABLE_ModuleIndexSet_1_53, STATE_VARIABLE_Info_0_11, &STATE_VARIABLE_Info_1_54);
        ...
        case (MR_Integer) 1:
          {
            ...
            MR_Word next_value_of_HeadVar__9_9 = STATE_VARIABLE_ModuleIndexSet_1_53;
        ...
        case (MR_Integer) 0:
          {
            ...
            *HeadVar__10_10 = STATE_VARIABLE_ModuleIndexSet_1_53;
