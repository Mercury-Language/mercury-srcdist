  ...
  MR_Word * STATE_VARIABLE_Info_26)
{
  ...
  succeeded = make__deps_cache__search_transitive_deps_cache_3_p_0(STATE_VARIABLE_Info_0_25, Key_21, &Result0_22);
  if (succeeded)
  {
  ...
  else
  {
    ...
    else
    {
      ...
      succeeded = make__deps_cache__search_transitive_deps_cache_3_p_0(STATE_VARIABLE_Info_0_25, Key_21, &Result0_33);
      if (succeeded)
      {
        MR_Word Modules1_34;
    ...
    make__deps_cache__add_to_transitive_deps_cache_4_p_0(Key_21, Result_24, STATE_VARIABLE_Info_30_30, STATE_VARIABLE_Info_26);
  }
}
  ...
  MR_Word * STATE_VARIABLE_Info_33)
{
  ...
  else
  {
    ...
    succeeded = make__deps_cache__search_transitive_deps_cache_3_p_0(STATE_VARIABLE_Info_0_32, Key_25, &Result0_26);
    if (succeeded)
    {
      MR_Word Modules1_27;
