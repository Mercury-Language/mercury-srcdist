...
MR_def_label(transform_hlds__rbmm__points_to_graph__rptg_edge_in_graph_4_0,3)
	...
	MR_tfield(0, MR_r2, 1) = (MR_Word) MR_ENTRY_AP(transform_hlds__rbmm__points_to_graph__IntroducedFrom__pred__rptg_edge_in_graph__871__1_3_0);
...
MR_def_label(transform_hlds__rbmm__points_to_graph__delete_all_inedges_and_edges_2_6_0,5)
	...
	MR_tfield(0, MR_r2, 1) = (MR_Word) MR_ENTRY_AP(transform_hlds__rbmm__points_to_graph__IntroducedFrom__pred__delete_all_inedges_and_edges_2__833__1_3_0);
	MR_tfield(0, MR_r2, 2) = (MR_Integer) 2;
