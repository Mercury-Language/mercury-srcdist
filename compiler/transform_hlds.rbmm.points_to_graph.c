...
{
  {
    ...
    Node_Selector_13 = mercury__pair__pair_2_f_0((MR_Word) (&transform_hlds__rbmm__points_to_graph__transform_hlds__rbmm__points_to_graph__type_ctor_info_rptg_node_0), (MR_Word) (&transform_hlds__rbmm__points_to_graph_scalar_common_2[1]), ((MR_Box) (N_X_12)), ((MR_Box) ((MR_Integer) 0)));
    ...
    transform_hlds__rbmm__points_to_graph__reach_from_a_variable_2_7_p_0(Var_19, Graph_7, HLDS_8, TypeX_15, (MR_Word) ((MR_Integer) 0), STATE_VARIABLE_Reach_X_0_16, STATE_VARIABLE_Reach_X_17);
  }
}
...
{
  {
    ...
    else
    {
...

      {
        ...
        MR_hl_field(MR_mktag(1), Var_10, 1) = ((MR_Box) ((MR_Integer) 0));
      }
...
{
  {
    transform_hlds__rbmm__points_to_graph__rptg_path_2_5_p_1(G_5, S_6, E_7, (MR_Word) ((MR_Integer) 0), Path_8, cont, cont_env_ptr);
  }
}
...
{
  {
    ...
    {
      (env_ptr)->transform_hlds__rbmm__points_to_graph__rptg_path_2_5_p_1_env_0__Var_17 = (MR_Word) ((MR_Integer) 0);
      {
        MR_Word base;
        base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
...
{
  {
    transform_hlds__rbmm__points_to_graph__rptg_path_2_5_p_0(G_5, S_6, E_7, (MR_Word) ((MR_Integer) 0), Path_8, cont, cont_env_ptr);
  }
}
...
{
  {
...

    {
      ...
      if ((env_ptr)->transform_hlds__rbmm__points_to_graph__rptg_path_2_5_p_0_env_0__succeeded)
      {
        ...
        if ((env_ptr)->transform_hlds__rbmm__points_to_graph__rptg_path_2_5_p_0_env_0__succeeded)
        {
          (env_ptr)->transform_hlds__rbmm__points_to_graph__rptg_path_2_5_p_0_env_0__Var_17 = (MR_Word) ((MR_Integer) 0);
          {
            MR_Word base;
            base = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
