...
MR_decl_static(transform_hlds__rbmm__points_to_graph__IntroducedFrom__pred__rptg_edge_in_graph__868__1_3_0)
MR_decl_static(transform_hlds__rbmm__points_to_graph__IntroducedFrom__pred__delete_all_inedges_and_edges_2__830__1_3_0)
...
"transform_hlds.rbmm.points_to_graph",
"transform_hlds.rbmm.points_to_graph",
"lambda_rbmm_points_to_graph_m_830",
3,
0
},
"transform_hlds.rbmm.points_to_graph",
...
"transform_hlds.rbmm.points_to_graph",
"transform_hlds.rbmm.points_to_graph",
"lambda_rbmm_points_to_graph_m_868",
3,
0
},
"transform_hlds.rbmm.points_to_graph",
...
MR_def_label(transform_hlds__rbmm__points_to_graph__rptg_edge_in_graph_4_0,3)
	...
	MR_tfield(0, MR_r2, 1) = (MR_Word) MR_ENTRY_AP(transform_hlds__rbmm__points_to_graph__IntroducedFrom__pred__rptg_edge_in_graph__868__1_3_0);
...
MR_def_label(transform_hlds__rbmm__points_to_graph__delete_all_inedges_and_edges_2_6_0,5)
	...
	MR_tfield(0, MR_r2, 1) = (MR_Word) MR_ENTRY_AP(transform_hlds__rbmm__points_to_graph__IntroducedFrom__pred__delete_all_inedges_and_edges_2__830__1_3_0);
	MR_tfield(0, MR_r2, 2) = (MR_Integer) 2;
...
MR_BEGIN_MODULE(transform_hlds__rbmm__points_to_graph_module83)
	MR_init_entry1(transform_hlds__rbmm__points_to_graph__IntroducedFrom__pred__rptg_edge_in_graph__868__1_3_0);
	MR_INIT_PROC_LAYOUT_ADDR(mercury__transform_hlds__rbmm__points_to_graph__IntroducedFrom__pred__rptg_edge_in_graph__868__1_3_0);
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'IntroducedFrom__pred__rptg_edge_in_graph__868__1'/3 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(transform_hlds__rbmm__points_to_graph__IntroducedFrom__pred__rptg_edge_in_graph__868__1_3_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tempr1 = MR_r1;
...
MR_BEGIN_MODULE(transform_hlds__rbmm__points_to_graph_module84)
	MR_init_entry1(transform_hlds__rbmm__points_to_graph__IntroducedFrom__pred__delete_all_inedges_and_edges_2__830__1_3_0);
	MR_INIT_PROC_LAYOUT_ADDR(mercury__transform_hlds__rbmm__points_to_graph__IntroducedFrom__pred__delete_all_inedges_and_edges_2__830__1_3_0);
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'IntroducedFrom__pred__delete_all_inedges_and_edges_2__830__1'/3 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(transform_hlds__rbmm__points_to_graph__IntroducedFrom__pred__delete_all_inedges_and_edges_2__830__1_3_0)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tempr1 = MR_r1;
