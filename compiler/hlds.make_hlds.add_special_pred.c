...
{
  {
    ...
    if (hlds__make_hlds__add_special_pred__succeeded)
              ...
              if (hlds__make_hlds__add_special_pred__succeeded)
                *hlds__make_hlds__add_special_pred__STATE_VARIABLE_ModuleInfo_25 = hlds__make_hlds__add_special_pred__STATE_VARIABLE_ModuleInfo_27_27;
              else
                {
                  ...
                  {
                    libs__globals__lookup_bool_option_3_p_0(hlds__make_hlds__add_special_pred__Globals_81, (MR_Integer) 278, &hlds__make_hlds__add_special_pred__GenSpecialPreds_82);
                  }
    ...
    else
      {
        ...
        {
          libs__globals__lookup_bool_option_3_p_0(hlds__make_hlds__add_special_pred__Globals_115, (MR_Integer) 278, &hlds__make_hlds__add_special_pred__GenSpecialPreds_116);
        }
        ...
        {
          libs__globals__lookup_bool_option_3_p_0(hlds__make_hlds__add_special_pred__Globals_149, (MR_Integer) 278, &hlds__make_hlds__add_special_pred__GenSpecialPreds_150);
        }
