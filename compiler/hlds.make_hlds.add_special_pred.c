...
#line 28 "hlds.make_hlds.add_special_pred.c"
#line 150 "../library/io.int2"
#include "time.mh"

#line 32 "hlds.make_hlds.add_special_pred.c"
#line 151 "../library/io.int2"
#include "string.mh"

#line 36 "hlds.make_hlds.add_special_pred.c"
#line 33 "../library/array.int2"
#include "array.mh"

#line 40 "hlds.make_hlds.add_special_pred.c"
#line 39 "../mdbcomp/mdbcomp.rtti_access.int2"
#include "mdbcomp.rtti_access.mh"

#line 44 "hlds.make_hlds.add_special_pred.c"
#line 31 "../library/bitmap.int2"
#include "bitmap.mh"

#line 48 "hlds.make_hlds.add_special_pred.c"
#line 49 "hlds.make_hlds.add_special_pred.c"
#include "hlds.make_hlds.add_special_pred.mh"

#line 52 "hlds.make_hlds.add_special_pred.c"
#line 53 "hlds.make_hlds.add_special_pred.c"
...
#line 58 "hlds.make_hlds.add_special_pred.c"
...
MR_decl_label10(hlds__make_hlds__add_special_pred__add_special_pred_9_0, 2,3,7,31,13,16,15,14,21,5)
MR_decl_label7(hlds__make_hlds__add_special_pred__add_special_pred_decl_9_0, 2,3,7,8,9,10,5)
MR_decl_label10(hlds__make_hlds__add_special_pred__add_special_pred_decl_list_9_0, 62,3,4,5,9,10,11,12,15,16)
MR_decl_label2(hlds__make_hlds__add_special_pred__add_special_pred_decl_list_9_0, 7,17)
MR_decl_label10(hlds__make_hlds__add_special_pred__add_special_pred_list_9_0, 92,3,4,5,13,10,9,15,19,21)
MR_decl_label8(hlds__make_hlds__add_special_pred__add_special_pred_list_9_0, 18,16,24,27,28,7,29,99)
MR_decl_label2(hlds__make_hlds__add_special_pred__add_special_preds_8_0, 4,2)
MR_decl_label10(hlds__make_hlds__add_special_pred__do_add_special_pred_decl_for_real_8_0, 2,3,4,7,6,5,10,11,12,16)
MR_decl_label10(hlds__make_hlds__add_special_pred__do_add_special_pred_decl_for_real_8_0, 15,20,23,26,24,32,33,34,35,37)
MR_decl_label8(hlds__make_hlds__add_special_pred__do_add_special_pred_decl_for_real_8_0, 38,39,42,43,44,45,46,47)
MR_decl_label10(hlds__make_hlds__add_special_pred__do_add_special_pred_for_real_9_0, 3,5,9,13,2,15,17,16,21,24)
MR_decl_label10(hlds__make_hlds__add_special_pred__do_add_special_pred_for_real_9_0, 27,25,33,34,37,35,40,41,43,44)
MR_decl_label10(hlds__make_hlds__add_special_pred__do_add_special_pred_for_real_9_0, 45,48,46,55,57,51,52,62,63,64)
MR_decl_label4(hlds__make_hlds__add_special_pred__do_add_special_pred_for_real_9_0, 65,66,68,69)
MR_decl_label10(hlds__make_hlds__add_special_pred__eagerly_add_special_preds_8_0, 4,6,7,10,13,11,9,22,23,24)
MR_decl_label9(hlds__make_hlds__add_special_pred__eagerly_add_special_preds_8_0, 18,26,27,8,30,28,2,36,34)
...
MR_BEGIN_MODULE(hlds__make_hlds__add_special_pred_module0)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__hlds__make_hlds__add_special_pred__do_add_special_pred_decl_for_real_8_0);
	MR_init_label10(hlds__make_hlds__add_special_pred__do_add_special_pred_decl_for_real_8_0,2,3,4,7,6,5,10,11,12,16)
	MR_init_label10(hlds__make_hlds__add_special_pred__do_add_special_pred_decl_for_real_8_0,15,20,23,26,24,32,33,34,35,37)
	MR_init_label8(hlds__make_hlds__add_special_pred__do_add_special_pred_decl_for_real_8_0,38,39,42,43,44,45,46,47)
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'do_add_special_pred_decl_for_real'/8 mode 0 */
...
MR_def_label(hlds__make_hlds__add_special_pred__do_add_special_pred_decl_for_real_8_0,12)
	...
	if (MR_LTAGS_TEST(MR_sv(9),0,1)) {
		MR_GOTO_LAB(hlds__make_hlds__add_special_pred__do_add_special_pred_decl_for_real_8_0_i16);
	}
	if (MR_LTAGS_TESTR(MR_sv(9),0,0)) {
		MR_GOTO_LAB(hlds__make_hlds__add_special_pred__do_add_special_pred_decl_for_real_8_0_i15);
	}
	}
MR_def_label(hlds__make_hlds__add_special_pred__do_add_special_pred_decl_for_real_8_0,16)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_def_label(hlds__make_hlds__add_special_pred__do_add_special_pred_decl_for_real_8_0,23)
	...
	if (MR_INT_NE(MR_sv(13),0)) {
		MR_GOTO_LAB(hlds__make_hlds__add_special_pred__do_add_special_pred_decl_for_real_8_0_i24);
	}
	if (MR_PTAG_TESTR(MR_r2,2)) {
		MR_GOTO_LAB(hlds__make_hlds__add_special_pred__do_add_special_pred_decl_for_real_8_0_i26);
	}
	MR_sv(13) = MR_r1;
	...
	MR_GOTO_LAB(hlds__make_hlds__add_special_pred__do_add_special_pred_decl_for_real_8_0_i32);
MR_def_label(hlds__make_hlds__add_special_pred__do_add_special_pred_decl_for_real_8_0,26)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r2,0,3)) {
		MR_GOTO_LAB(hlds__make_hlds__add_special_pred__do_add_special_pred_decl_for_real_8_0_i24);
	}
	MR_sv(13) = MR_r1;
	MR_sv(9) = (MR_Word) MR_tbmkword(0, 6);
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(parse_tree__prog_data, prog_constraint);
	MR_r2 = (MR_Word) MR_CTOR0_ADDR(hlds__hlds_data, constraint_proof);
	MR_GOTO_LAB(hlds__make_hlds__add_special_pred__do_add_special_pred_decl_for_real_8_0_i32);
MR_def_label(hlds__make_hlds__add_special_pred__do_add_special_pred_decl_for_real_8_0,24)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(13) = MR_r1;
	MR_sv(9) = MR_r2;
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(parse_tree__prog_data, prog_constraint);
...
MR_def_label(hlds__make_hlds__add_special_pred__do_add_special_pred_decl_for_real_8_0,46)
	...
	MR_np_call_localret_ent(map__set_4_0,
		hlds__make_hlds__add_special_pred__do_add_special_pred_decl_for_real_8_0_i47);
MR_def_label(hlds__make_hlds__add_special_pred__do_add_special_pred_decl_for_real_8_0,47)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_sv(16);
...
MR_BEGIN_MODULE(hlds__make_hlds__add_special_pred_module1)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__hlds__make_hlds__add_special_pred__do_add_special_pred_for_real_9_0);
	MR_init_label10(hlds__make_hlds__add_special_pred__do_add_special_pred_for_real_9_0,3,5,9,13,2,15,17,16,21,24)
	MR_init_label10(hlds__make_hlds__add_special_pred__do_add_special_pred_for_real_9_0,27,25,33,34,37,35,40,41,43,44)
	MR_init_label10(hlds__make_hlds__add_special_pred__do_add_special_pred_for_real_9_0,45,48,46,55,57,51,52,62,63,64)
	MR_init_label4(hlds__make_hlds__add_special_pred__do_add_special_pred_for_real_9_0,65,66,68,69)
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'do_add_special_pred_for_real'/9 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
...
MR_def_label(hlds__make_hlds__add_special_pred__do_add_special_pred_for_real_9_0,24)
	...
	MR_sv(4) = (MR_Word) MR_tbmkword(0, 2);
...
MR_def_label(hlds__make_hlds__add_special_pred__do_add_special_pred_for_real_9_0,27)
	...
	MR_sv(4) = (MR_Word) MR_tbmkword(0, 6);
	MR_GOTO_LAB(hlds__make_hlds__add_special_pred__do_add_special_pred_for_real_9_0_i33);
...
MR_def_label(hlds__make_hlds__add_special_pred__do_add_special_pred_for_real_9_0,37)
	...
	MR_r1 = MR_sv(8);
	MR_GOTO_LAB(hlds__make_hlds__add_special_pred__do_add_special_pred_for_real_9_0_i40);
...
MR_def_label(hlds__make_hlds__add_special_pred__do_add_special_pred_for_real_9_0,41)
	...
	MR_np_call_localret_ent(map__lookup_3_0,
		hlds__make_hlds__add_special_pred__do_add_special_pred_for_real_9_0_i43);
MR_def_label(hlds__make_hlds__add_special_pred__do_add_special_pred_for_real_9_0,43)
	...
	MR_np_call_localret_ent(hlds__hlds_module__module_info_get_preds_2_0,
		hlds__make_hlds__add_special_pred__do_add_special_pred_for_real_9_0_i44);
MR_def_label(hlds__make_hlds__add_special_pred__do_add_special_pred_for_real_9_0,44)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(6) = MR_r1;
...
MR_def_label(hlds__make_hlds__add_special_pred__do_add_special_pred_for_real_9_0,46)
	...
	if (MR_PTAG_TESTR(MR_sv(1),1)) {
		MR_GOTO_LAB(hlds__make_hlds__add_special_pred__do_add_special_pred_for_real_9_0_i52);
	}
	MR_r2 = MR_tfield(1, MR_sv(1), 4);
	if (MR_LTAGS_TEST(MR_r2,0,0)) {
		MR_GOTO_LAB(hlds__make_hlds__add_special_pred__do_add_special_pred_for_real_9_0_i52);
	}
	MR_sv(8) = MR_r1;
	MR_np_call_localret_ent(hlds__hlds_pred__pred_info_get_import_status_2_0,
		hlds__make_hlds__add_special_pred__do_add_special_pred_for_real_9_0_i55);
MR_def_label(hlds__make_hlds__add_special_pred__do_add_special_pred_for_real_9_0,55)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r1,0,2)) {
		MR_GOTO_LAB(hlds__make_hlds__add_special_pred__do_add_special_pred_for_real_9_0_i51);
	}
	MR_r1 = MR_sv(4);
...
MR_def_label(hlds__make_hlds__add_special_pred__do_add_special_pred_for_real_9_0,57)
	...
	MR_np_call_localret_ent(hlds__hlds_pred__pred_info_set_import_status_3_0,
		hlds__make_hlds__add_special_pred__do_add_special_pred_for_real_9_0_i52);
MR_def_label(hlds__make_hlds__add_special_pred__do_add_special_pred_for_real_9_0,51)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(8);
...
MR_def_label(hlds__make_hlds__add_special_pred__do_add_special_pred_for_real_9_0,68)
	...
	MR_np_call_localret_ent(map__det_update_4_0,
		hlds__make_hlds__add_special_pred__do_add_special_pred_for_real_9_0_i69);
MR_def_label(hlds__make_hlds__add_special_pred__do_add_special_pred_for_real_9_0,69)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_sv(12);
...
MR_BEGIN_MODULE(hlds__make_hlds__add_special_pred_module2)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__hlds__make_hlds__add_special_pred__add_special_pred_9_0);
	MR_init_label10(hlds__make_hlds__add_special_pred__add_special_pred_9_0,2,3,7,31,13,16,15,14,21,5)
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'add_special_pred'/9 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
...
MR_def_label(hlds__make_hlds__add_special_pred__add_special_pred_9_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(hlds__make_hlds__add_special_pred__add_special_pred_9_0_i5);
	}
	if (MR_INT_NE(MR_sv(1),2)) {
		MR_GOTO_LAB(hlds__make_hlds__add_special_pred__add_special_pred_9_0_i7);
	}
	if (MR_PTAG_TESTR(MR_sv(5),1)) {
		MR_GOTO_LAB(hlds__make_hlds__add_special_pred__add_special_pred_9_0_i31);
	}
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tempr2 = MR_sv(5);
	MR_tempr1 = MR_tfield(1, MR_tempr2, 4);
...
MR_def_label(hlds__make_hlds__add_special_pred__add_special_pred_9_0,31)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(8);
...
MR_def_label(hlds__make_hlds__add_special_pred__add_special_pred_9_0,13)
	...
	if (MR_INT_NE(MR_sv(1),3)) {
		MR_GOTO_LAB(hlds__make_hlds__add_special_pred__add_special_pred_9_0_i14);
	}
	MR_r1 = MR_sv(8);
	MR_r2 = MR_sv(3);
...
MR_def_label(hlds__make_hlds__add_special_pred__add_special_pred_9_0,15)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Word) MR_string_const("hlds.make_hlds.add_special_pred", 31);
	MR_r2 = (MR_Word) MR_string_const("predicate \140hlds.make_hlds.add_special_pred.add_special_pred\'/9", 62);
	MR_r3 = (MR_Word) MR_string_const("attempt to add initialise pred for non-solver type or solver type without automatic initialisation.", 99);
	MR_succip_word = MR_sv(9);
	MR_decr_sp(9);
...
MR_def_label(hlds__make_hlds__add_special_pred__add_special_pred_9_0,21)
	...
	MR_decr_sp(9);
	MR_np_tailcall_ent(hlds__make_hlds__add_special_pred__do_add_special_pred_for_real_9_0);
MR_def_label(hlds__make_hlds__add_special_pred__add_special_pred_9_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(1);
	MR_r2 = MR_sv(2);
	MR_r3 = MR_sv(3);
...
MR_BEGIN_MODULE(hlds__make_hlds__add_special_pred_module3)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__hlds__make_hlds__add_special_pred__add_special_pred_list_9_0);
	MR_init_label10(hlds__make_hlds__add_special_pred__add_special_pred_list_9_0,92,3,4,5,13,10,9,15,19,21)
	MR_init_label8(hlds__make_hlds__add_special_pred__add_special_pred_list_9_0,18,16,24,27,28,7,29,99)
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'add_special_pred_list'/9 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
...
MR_def_label(hlds__make_hlds__add_special_pred__add_special_pred_list_9_0,92)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_def_label(hlds__make_hlds__add_special_pred__add_special_pred_list_9_0,5)
	...
	if (MR_INT_NE(MR_sv(8),2)) {
		MR_GOTO_LAB(hlds__make_hlds__add_special_pred__add_special_pred_list_9_0_i9);
	}
	...
	MR_np_call_localret_ent(hlds__make_hlds__add_special_pred__do_add_special_pred_for_real_9_0,
		hlds__make_hlds__add_special_pred__add_special_pred_list_9_0_i13);
MR_def_label(hlds__make_hlds__add_special_pred__add_special_pred_list_9_0,13)
	...
	MR_GOTO_LAB(hlds__make_hlds__add_special_pred__add_special_pred_list_9_0_i92);
	}
...
MR_def_label(hlds__make_hlds__add_special_pred__add_special_pred_list_9_0,15)
	...
	if (MR_INT_NE(MR_sv(8),3)) {
		MR_GOTO_LAB(hlds__make_hlds__add_special_pred__add_special_pred_list_9_0_i16);
	}
	MR_r1 = MR_sv(7);
	MR_r2 = MR_sv(2);
	MR_np_call_localret_ent(check_hlds__type_util__type_is_solver_type_with_auto_init_2_0,
...
MR_def_label(hlds__make_hlds__add_special_pred__add_special_pred_list_9_0,19)
	...
	MR_r8 = MR_sv(7);
	MR_np_call_localret_ent(hlds__make_hlds__add_special_pred__do_add_special_pred_for_real_9_0,
		hlds__make_hlds__add_special_pred__add_special_pred_list_9_0_i21);
MR_def_label(hlds__make_hlds__add_special_pred__add_special_pred_list_9_0,21)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_sv(1);
	MR_r3 = MR_sv(2);
	MR_r4 = MR_sv(3);
...
MR_def_label(hlds__make_hlds__add_special_pred__add_special_pred_list_9_0,18)
	...
	MR_np_call_localret_ent(require__unexpected_3_0,
		hlds__make_hlds__add_special_pred__add_special_pred_list_9_0_i99);
MR_def_label(hlds__make_hlds__add_special_pred__add_special_pred_list_9_0,16)
	...
	MR_r1 = MR_sv(8);
	MR_r7 = MR_sv(6);
	MR_GOTO_LAB(hlds__make_hlds__add_special_pred__add_special_pred_list_9_0_i27);
	}
...
MR_def_label(hlds__make_hlds__add_special_pred__add_special_pred_list_9_0,27)
	...
	MR_sv(5) = MR_r6;
	MR_np_call_localret_ent(hlds__make_hlds__add_special_pred__do_add_special_pred_for_real_9_0,
		hlds__make_hlds__add_special_pred__add_special_pred_list_9_0_i28);
...
MR_def_label(hlds__make_hlds__add_special_pred__add_special_pred_list_9_0,99)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_succip_word = MR_sv(10);
	MR_GOTO_LAB(hlds__make_hlds__add_special_pred__add_special_pred_list_9_0_i92);
#ifdef MR_maybe_local_thread_engine_base
...
MR_BEGIN_MODULE(hlds__make_hlds__add_special_pred_module4)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__hlds__make_hlds__add_special_pred__add_special_pred_decl_9_0);
	MR_init_label7(hlds__make_hlds__add_special_pred__add_special_pred_decl_9_0,2,3,7,8,9,10,5)
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'add_special_pred_decl'/9 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
...
MR_def_label(hlds__make_hlds__add_special_pred__add_special_pred_decl_9_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(hlds__make_hlds__add_special_pred__add_special_pred_decl_9_0_i5);
	}
	if (MR_INT_NE(MR_sv(1),2)) {
		MR_GOTO_LAB(hlds__make_hlds__add_special_pred__add_special_pred_decl_9_0_i7);
	}
	MR_r1 = MR_sv(8);
	MR_decr_sp_and_return(9);
MR_def_label(hlds__make_hlds__add_special_pred__add_special_pred_decl_9_0,7)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_sv(1),1)) {
...
MR_def_label(hlds__make_hlds__add_special_pred__add_special_pred_decl_9_0,8)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_sv(1),3)) {
		MR_GOTO_LAB(hlds__make_hlds__add_special_pred__add_special_pred_decl_9_0_i9);
	}
	MR_r1 = MR_sv(8);
	MR_decr_sp_and_return(9);
MR_def_label(hlds__make_hlds__add_special_pred__add_special_pred_decl_9_0,9)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_sv(5),1)) {
	...
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_tfield(1, MR_sv(5), 4);
	if (MR_LTAGS_TEST(MR_tempr1,0,0)) {
		MR_GOTO_LAB(hlds__make_hlds__add_special_pred__add_special_pred_decl_9_0_i10);
	}
	MR_r1 = MR_sv(1);
...
MR_def_label(hlds__make_hlds__add_special_pred__add_special_pred_decl_9_0,10)
	...
	MR_decr_sp(9);
	MR_np_tailcall_ent(hlds__make_hlds__add_special_pred__do_add_special_pred_decl_for_real_8_0);
MR_def_label(hlds__make_hlds__add_special_pred__add_special_pred_decl_9_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(1);
	MR_r2 = MR_sv(2);
	MR_r3 = MR_sv(3);
...
MR_BEGIN_MODULE(hlds__make_hlds__add_special_pred_module5)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__hlds__make_hlds__add_special_pred__add_special_pred_decl_list_9_0);
	MR_init_label10(hlds__make_hlds__add_special_pred__add_special_pred_decl_list_9_0,62,3,4,5,9,10,11,12,15,16)
	MR_init_label2(hlds__make_hlds__add_special_pred__add_special_pred_decl_list_9_0,7,17)
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'add_special_pred_decl_list'/9 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_def_static(hlds__make_hlds__add_special_pred__add_special_pred_decl_list_9_0)
	...
	MR_incr_sp(10);
	MR_sv(10) = (MR_Word) MR_succip;
MR_def_label(hlds__make_hlds__add_special_pred__add_special_pred_decl_list_9_0,62)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TESTR(MR_r1,0,0)) {
...
MR_def_label(hlds__make_hlds__add_special_pred__add_special_pred_decl_list_9_0,5)
	...
	if (MR_INT_NE(MR_sv(8),2)) {
		MR_GOTO_LAB(hlds__make_hlds__add_special_pred__add_special_pred_decl_list_9_0_i9);
	}
	MR_r2 = MR_sv(1);
	MR_r3 = MR_sv(2);
	MR_r4 = MR_sv(3);
	...
	MR_r8 = MR_sv(7);
	MR_succip_word = MR_sv(10);
	MR_GOTO_LAB(hlds__make_hlds__add_special_pred__add_special_pred_decl_list_9_0_i62);
MR_def_label(hlds__make_hlds__add_special_pred__add_special_pred_decl_list_9_0,9)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_sv(8),1)) {
...
MR_def_label(hlds__make_hlds__add_special_pred__add_special_pred_decl_list_9_0,10)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_sv(8),3)) {
		MR_GOTO_LAB(hlds__make_hlds__add_special_pred__add_special_pred_decl_list_9_0_i11);
	}
	MR_r2 = MR_sv(1);
	MR_r3 = MR_sv(2);
	MR_r4 = MR_sv(3);
	...
	MR_succip_word = MR_sv(10);
	MR_GOTO_LAB(hlds__make_hlds__add_special_pred__add_special_pred_decl_list_9_0_i62);
MR_def_label(hlds__make_hlds__add_special_pred__add_special_pred_decl_list_9_0,11)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_sv(4),1)) {
		MR_GOTO_LAB(hlds__make_hlds__add_special_pred__add_special_pred_decl_list_9_0_i12);
	}
	MR_r8 = MR_tfield(1, MR_sv(4), 4);
	...
	MR_r1 = MR_sv(8);
	MR_r6 = MR_sv(6);
	MR_GOTO_LAB(hlds__make_hlds__add_special_pred__add_special_pred_decl_list_9_0_i15);
MR_def_label(hlds__make_hlds__add_special_pred__add_special_pred_decl_list_9_0,12)
	...
	MR_r1 = MR_sv(8);
	MR_r6 = (MR_Word) MR_tbmkword(0, 2);
MR_def_label(hlds__make_hlds__add_special_pred__add_special_pred_decl_list_9_0,15)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(1) = MR_r2;
	MR_sv(2) = MR_r3;
	MR_sv(3) = MR_r4;
	MR_sv(5) = MR_r5;
	MR_np_call_localret_ent(hlds__make_hlds__add_special_pred__do_add_special_pred_decl_for_real_8_0,
		hlds__make_hlds__add_special_pred__add_special_pred_decl_list_9_0_i16);
...
MR_def_label(hlds__make_hlds__add_special_pred__add_special_pred_decl_list_9_0,7)
	...
	MR_r7 = MR_sv(7);
	MR_np_call_localret_ent(hlds__make_hlds__add_special_pred__do_add_special_pred_decl_for_real_8_0,
		hlds__make_hlds__add_special_pred__add_special_pred_decl_list_9_0_i17);
...
MR_BEGIN_MODULE(hlds__make_hlds__add_special_pred_module6)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__hlds__make_hlds__add_special_pred__eagerly_add_special_preds_8_0);
	MR_init_label10(hlds__make_hlds__add_special_pred__eagerly_add_special_preds_8_0,4,6,7,10,13,11,9,22,23,24)
	MR_init_label9(hlds__make_hlds__add_special_pred__eagerly_add_special_preds_8_0,18,26,27,8,30,28,2,36,34)
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'eagerly_add_special_preds'/8 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
...
MR_def_label(hlds__make_hlds__add_special_pred__eagerly_add_special_preds_8_0,10)
	...
	MR_np_call_localret_ent(map__contains_2_0,
		hlds__make_hlds__add_special_pred__eagerly_add_special_preds_8_0_i13);
MR_def_label(hlds__make_hlds__add_special_pred__eagerly_add_special_preds_8_0,13)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
...
MR_def_label(hlds__make_hlds__add_special_pred__eagerly_add_special_preds_8_0,11)
	...
	MR_np_call_localret_ent(hlds__make_hlds__add_special_pred__add_special_pred_decl_9_0,
		hlds__make_hlds__add_special_pred__eagerly_add_special_preds_8_0_i27);
MR_def_label(hlds__make_hlds__add_special_pred__eagerly_add_special_preds_8_0,9)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_sv(4),1)) {
		MR_GOTO_LAB(hlds__make_hlds__add_special_pred__eagerly_add_special_preds_8_0_i18);
	}
	{
	MR_Word MR_tempr1;
	MR_tempr1 = MR_sv(4);
...
MR_def_label(hlds__make_hlds__add_special_pred__eagerly_add_special_preds_8_0,18)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_sv(1);
	MR_r3 = MR_sv(2);
	MR_r4 = MR_sv(3);
...
MR_def_label(hlds__make_hlds__add_special_pred__eagerly_add_special_preds_8_0,26)
	...
	MR_np_call_localret_ent(hlds__make_hlds__add_special_pred__add_special_pred_list_9_0,
		hlds__make_hlds__add_special_pred__eagerly_add_special_preds_8_0_i27);
MR_def_label(hlds__make_hlds__add_special_pred__eagerly_add_special_preds_8_0,27)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_sv(2);
...
MR_def_label(hlds__make_hlds__add_special_pred__eagerly_add_special_preds_8_0,30)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(hlds__make_hlds__add_special_pred__eagerly_add_special_preds_8_0_i28);
	}
	MR_r1 = (MR_Integer) 3;
	MR_r2 = MR_sv(1);
	MR_r3 = MR_sv(2);
...
MR_def_label(hlds__make_hlds__add_special_pred__eagerly_add_special_preds_8_0,2)
	...
	MR_np_call_localret_ent(check_hlds__type_util__type_is_solver_type_with_auto_init_2_0,
		hlds__make_hlds__add_special_pred__eagerly_add_special_preds_8_0_i36);
MR_def_label(hlds__make_hlds__add_special_pred__eagerly_add_special_preds_8_0,36)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(hlds__make_hlds__add_special_pred__eagerly_add_special_preds_8_0_i34);
	}
	MR_r2 = MR_sv(1);
	MR_r3 = MR_sv(2);
	MR_r4 = MR_sv(3);
...
MR_BEGIN_MODULE(hlds__make_hlds__add_special_pred_module7)
	...
	MR_INIT_PROC_LAYOUT_ADDR(mercury__hlds__make_hlds__add_special_pred__add_special_preds_8_0);
	MR_init_label2(hlds__make_hlds__add_special_pred__add_special_preds_8_0,4,2)
MR_BEGIN_CODE

/*-------------------------------------------------------------------------*/
/* code for 'add_special_preds'/8 mode 0 */
#ifdef MR_maybe_local_thread_engine_base
	#undef MR_maybe_local_thread_engine_base
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
...
void mercury__hlds__make_hlds__add_special_pred__init_threadscope_string_table(void);
#endif
...
void mercury__hlds__make_hlds__add_special_pred__write_out_proc_statics(FILE *deep_fp, FILE *procrep_fp)
{
	MR_write_out_module_proc_reps_start(procrep_fp, &mercury_data__module_layout__hlds__make_hlds__add_special_pred);
