...
{
  {
        ...
        case (MR_Integer) 0:
          {
            ...
            else
            {
              ...
              libs__globals__lookup_bool_option_3_p_0(Globals_81, (MR_Integer) 284, &GenSpecialPreds_82);
    ...
    else
    {
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals_115, (MR_Integer) 284, &GenSpecialPreds_116);
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals_149, (MR_Integer) 284, &GenSpecialPreds_150);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_18, (MR_Integer) 284, &GenSpecialPreds_19);
  ...
  MR_Word * STATE_VARIABLE_ModuleInfo_9)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      libs__globals__lookup_bool_option_3_p_0(Globals_42, (MR_Integer) 284, &GenSpecialPreds_43);
      ...
      {
        MR_Word next_value_of_HeadVar__1_1 = SpecialPredIds_20;
        MR_Word next_value_of_STATE_VARIABLE_ModuleInfo_0_8 = STATE_VARIABLE_ModuleInfo_30_30;
