...
MR_decl_label10(hlds__make_hlds__add_special_pred__do_add_special_pred_decl_for_real_8_0, 15,20,23,26,24,32,33,34,35,38)
MR_decl_label8(hlds__make_hlds__add_special_pred__do_add_special_pred_decl_for_real_8_0, 39,40,43,44,45,46,47,49)
MR_decl_label10(hlds__make_hlds__add_special_pred__do_add_special_pred_for_real_9_0, 3,5,9,13,2,15,17,16,21,24)
MR_decl_label10(hlds__make_hlds__add_special_pred__do_add_special_pred_for_real_9_0, 27,25,33,34,38,35,41,42,45,46)
MR_decl_label10(hlds__make_hlds__add_special_pred__do_add_special_pred_for_real_9_0, 47,50,48,57,59,53,54,64,65,66)
MR_decl_label4(hlds__make_hlds__add_special_pred__do_add_special_pred_for_real_9_0, 67,68,70,71)
MR_decl_label10(hlds__make_hlds__add_special_pred__eagerly_add_special_preds_8_0, 4,6,7,10,14,11,9,23,24,25)
MR_decl_label9(hlds__make_hlds__add_special_pred__eagerly_add_special_preds_8_0, 19,29,30,8,33,31,2,39,37)
...
MR_BEGIN_MODULE(hlds__make_hlds__add_special_pred_module0)
	...
	MR_init_label10(hlds__make_hlds__add_special_pred__do_add_special_pred_decl_for_real_8_0,15,20,23,26,24,32,33,34,35,38)
	MR_init_label8(hlds__make_hlds__add_special_pred__do_add_special_pred_decl_for_real_8_0,39,40,43,44,45,46,47,49)
MR_BEGIN_CODE
...
MR_def_label(hlds__make_hlds__add_special_pred__do_add_special_pred_decl_for_real_8_0,47)
	...
	MR_np_call_localret_ent(map__set_4_0,
		hlds__make_hlds__add_special_pred__do_add_special_pred_decl_for_real_8_0_i49);
MR_def_label(hlds__make_hlds__add_special_pred__do_add_special_pred_decl_for_real_8_0,49)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_sv(16);
...
MR_BEGIN_MODULE(hlds__make_hlds__add_special_pred_module1)
	...
	MR_init_label10(hlds__make_hlds__add_special_pred__do_add_special_pred_for_real_9_0,27,25,33,34,38,35,41,42,45,46)
	MR_init_label10(hlds__make_hlds__add_special_pred__do_add_special_pred_for_real_9_0,47,50,48,57,59,53,54,64,65,66)
	MR_init_label4(hlds__make_hlds__add_special_pred__do_add_special_pred_for_real_9_0,67,68,70,71)
MR_BEGIN_CODE
...
MR_BEGIN_MODULE(hlds__make_hlds__add_special_pred_module6)
	...
	MR_init_label10(hlds__make_hlds__add_special_pred__eagerly_add_special_preds_8_0,4,6,7,10,14,11,9,23,24,25)
	MR_init_label9(hlds__make_hlds__add_special_pred__eagerly_add_special_preds_8_0,19,29,30,8,33,31,2,39,37)
MR_BEGIN_CODE
