...
MR_decl_label5(hlds__make_hlds__add_special_pred__add_special_pred_decl_9_0, 2,3,4,9,7)
MR_decl_label8(hlds__make_hlds__add_special_pred__add_special_pred_decl_list_9_0, 40,4,5,6,11,14,15,9)
MR_decl_label1(hlds__make_hlds__add_special_pred__add_special_pred_decl_list_9_0, 3)
MR_decl_label8(hlds__make_hlds__add_special_pred__add_special_pred_list_9_0, 61,4,5,9,10,13,16,17)
MR_decl_label8(hlds__make_hlds__add_special_pred__add_special_pred_list_9_0, 22,25,27,24,7,30,64,3)
MR_decl_label8(hlds__make_hlds__add_special_pred__add_special_preds_8_0, 4,44,2,8,10,11,14,16)
MR_decl_label8(hlds__make_hlds__add_special_pred__add_special_preds_8_0, 15,13,25,26,27,21,28,29)
MR_decl_label5(hlds__make_hlds__add_special_pred__add_special_preds_8_0, 12,32,6,38,36)
...
MR_decl_label1(hlds__make_hlds__add_special_pred__do_add_special_pred_decl_for_real_8_0, 40)
...
MR_BEGIN_MODULE(hlds__make_hlds__add_special_pred_module0)
	...
	MR_init_label1(hlds__make_hlds__add_special_pred__do_add_special_pred_decl_for_real_8_0,40)
MR_BEGIN_CODE
...
MR_def_label(hlds__make_hlds__add_special_pred__do_add_special_pred_decl_for_real_8_0,32)
	...
	MR_r13 = (MR_Word) MR_TAG_COMMON(0,1,0);
	MR_r14 = MR_sv(12);
	MR_r15 = MR_sv(13);
	MR_r16 = MR_sv(1);
...
MR_def_label(hlds__make_hlds__add_special_pred__add_special_pred_9_0,21)
	...
	MR_r2 = (MR_Word) MR_string_const("add_special_pred: attempt to add initialise pred for non-solver type", 68);
	MR_succip_word = MR_sv(9);
	MR_decr_sp(9);
...
MR_BEGIN_MODULE(hlds__make_hlds__add_special_pred_module3)
	...
	MR_init_label8(hlds__make_hlds__add_special_pred__add_special_pred_list_9_0,61,4,5,9,10,13,16,17)
	MR_init_label8(hlds__make_hlds__add_special_pred__add_special_pred_list_9_0,22,25,27,24,7,30,64,3)
MR_BEGIN_CODE
...
MR_def_label(hlds__make_hlds__add_special_pred__add_special_pred_list_9_0,24)
	...
	MR_np_call_localret_ent(libs__compiler_util__unexpected_2_0,
		hlds__make_hlds__add_special_pred__add_special_pred_list_9_0_i64);
...
MR_def_label(hlds__make_hlds__add_special_pred__add_special_pred_list_9_0,30)
	...
	MR_r8 = MR_r1;
	MR_r1 = MR_sv(9);
MR_def_label(hlds__make_hlds__add_special_pred__add_special_pred_list_9_0,64)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_succip_word = MR_sv(10);
	MR_GOTO_LAB(hlds__make_hlds__add_special_pred__add_special_pred_list_9_0_i61);
...
MR_BEGIN_MODULE(hlds__make_hlds__add_special_pred_module4)
	...
	MR_init_label5(hlds__make_hlds__add_special_pred__add_special_pred_decl_9_0,2,3,4,9,7)
MR_BEGIN_CODE
...
MR_def_label(hlds__make_hlds__add_special_pred__add_special_pred_decl_9_0,3)
	...
	if (MR_INT_NE(MR_r1,1)) {
		MR_GOTO_LAB(hlds__make_hlds__add_special_pred__add_special_pred_decl_9_0_i4);
	}
	MR_r1 = MR_sv(1);
	MR_r2 = MR_sv(2);
	MR_r3 = MR_sv(3);
...
MR_def_label(hlds__make_hlds__add_special_pred__add_special_pred_decl_9_0,4)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_sv(1),0)) {
...
MR_BEGIN_MODULE(hlds__make_hlds__add_special_pred_module5)
	...
	MR_init_label8(hlds__make_hlds__add_special_pred__add_special_pred_decl_list_9_0,40,4,5,6,11,14,15,9)
	MR_init_label1(hlds__make_hlds__add_special_pred__add_special_pred_decl_list_9_0,3)
MR_BEGIN_CODE
...
MR_def_static(hlds__make_hlds__add_special_pred__add_special_pred_decl_list_9_0)
	...
	MR_incr_sp(10);
	MR_sv(10) = (MR_Word) MR_succip;
MR_def_label(hlds__make_hlds__add_special_pred__add_special_pred_decl_list_9_0,40)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_LTAGS_TEST(MR_r1,0,0)) {
...
MR_def_label(hlds__make_hlds__add_special_pred__add_special_pred_decl_list_9_0,5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,1)) {
		MR_GOTO_LAB(hlds__make_hlds__add_special_pred__add_special_pred_decl_list_9_0_i6);
	}
	MR_r1 = MR_sv(8);
	MR_r2 = MR_sv(1);
	MR_r3 = MR_sv(2);
	...
	MR_r7 = MR_sv(7);
	MR_np_call_localret_ent(hlds__make_hlds__add_special_pred__do_add_special_pred_decl_for_real_8_0,
		hlds__make_hlds__add_special_pred__add_special_pred_decl_list_9_0_i15);
MR_def_label(hlds__make_hlds__add_special_pred__add_special_pred_decl_list_9_0,6)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	...
	MR_r1 = MR_sv(8);
	MR_r6 = MR_sv(6);
	MR_GOTO_LAB(hlds__make_hlds__add_special_pred__add_special_pred_decl_list_9_0_i14);
MR_def_label(hlds__make_hlds__add_special_pred__add_special_pred_decl_list_9_0,11)
	...
	MR_r1 = MR_sv(8);
	MR_r6 = (MR_Word) MR_tbmkword(0, 2);
MR_def_label(hlds__make_hlds__add_special_pred__add_special_pred_decl_list_9_0,14)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(1) = MR_r2;
	MR_sv(2) = MR_r3;
	MR_sv(3) = MR_r4;
...
MR_def_label(hlds__make_hlds__add_special_pred__add_special_pred_decl_list_9_0,15)
	...
	MR_r1 = MR_sv(9);
	MR_succip_word = MR_sv(10);
	MR_GOTO_LAB(hlds__make_hlds__add_special_pred__add_special_pred_decl_list_9_0_i40);
...
MR_BEGIN_MODULE(hlds__make_hlds__add_special_pred_module6)
	...
	MR_init_label8(hlds__make_hlds__add_special_pred__add_special_preds_8_0,4,44,2,8,10,11,14,16)
	MR_init_label8(hlds__make_hlds__add_special_pred__add_special_preds_8_0,15,13,25,26,27,21,28,29)
	MR_init_label5(hlds__make_hlds__add_special_pred__add_special_preds_8_0,12,32,6,38,36)
MR_BEGIN_CODE
...
MR_def_label(hlds__make_hlds__add_special_pred__add_special_preds_8_0,44)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(7);
	MR_decr_sp_and_return(9);
MR_def_label(hlds__make_hlds__add_special_pred__add_special_preds_8_0,2)
	...
	MR_np_call_localret_ent(hlds__special_pred__can_generate_special_pred_clauses_for_type_3_0,
		hlds__make_hlds__add_special_pred__add_special_preds_8_0_i8);
MR_def_label(hlds__make_hlds__add_special_pred__add_special_preds_8_0,8)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(hlds__make_hlds__add_special_pred__add_special_preds_8_0_i6);
	}
	MR_r1 = (MR_Integer) 0;
	MR_r2 = MR_sv(1);
	MR_r3 = MR_sv(2);
	...
	MR_np_call_localret_ent(hlds__make_hlds__add_special_pred__add_special_pred_9_0,
		hlds__make_hlds__add_special_pred__add_special_preds_8_0_i10);
MR_def_label(hlds__make_hlds__add_special_pred__add_special_preds_8_0,10)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(8) = MR_r1;
	MR_r1 = MR_sv(6);
	MR_np_call_localret_ent(fn__hlds__hlds_pred__status_defined_in_this_module_1_0,
		hlds__make_hlds__add_special_pred__add_special_preds_8_0_i11);
MR_def_label(hlds__make_hlds__add_special_pred__add_special_preds_8_0,11)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(hlds__make_hlds__add_special_pred__add_special_preds_8_0_i13);
	}
	MR_r1 = MR_sv(8);
	MR_np_call_localret_ent(hlds__hlds_module__module_info_get_special_pred_map_2_0,
		hlds__make_hlds__add_special_pred__add_special_preds_8_0_i14);
MR_def_label(hlds__make_hlds__add_special_pred__add_special_preds_8_0,14)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	{
	MR_Word MR_tempr1;
	MR_tag_alloc_heap(MR_tempr1, 0, (MR_Integer) 2);
	...
	MR_np_call_localret_ent(map__contains_2_0,
		hlds__make_hlds__add_special_pred__add_special_preds_8_0_i16);
MR_def_label(hlds__make_hlds__add_special_pred__add_special_preds_8_0,16)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(hlds__make_hlds__add_special_pred__add_special_preds_8_0_i15);
	}
	MR_r2 = MR_sv(4);
	MR_r1 = MR_sv(8);
	MR_GOTO_LAB(hlds__make_hlds__add_special_pred__add_special_preds_8_0_i12);
MR_def_label(hlds__make_hlds__add_special_pred__add_special_preds_8_0,15)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Integer) 2;
	MR_r2 = MR_sv(1);
	MR_r3 = MR_sv(2);
	...
	MR_np_call_localret_ent(hlds__make_hlds__add_special_pred__add_special_pred_decl_9_0,
		hlds__make_hlds__add_special_pred__add_special_preds_8_0_i29);
MR_def_label(hlds__make_hlds__add_special_pred__add_special_preds_8_0,13)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_PTAG_TESTR(MR_sv(4),0)) {
		MR_GOTO_LAB(hlds__make_hlds__add_special_pred__add_special_preds_8_0_i21);
	}
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tempr2 = MR_sv(4);
	...
	MR_np_call_localret_ent(hlds__hlds_module__module_info_get_globals_2_0,
		hlds__make_hlds__add_special_pred__add_special_preds_8_0_i25);
MR_def_label(hlds__make_hlds__add_special_pred__add_special_preds_8_0,25)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = (MR_Integer) 238;
	MR_np_call_localret_ent(libs__globals__lookup_int_option_3_0,
		hlds__make_hlds__add_special_pred__add_special_preds_8_0_i26);
MR_def_label(hlds__make_hlds__add_special_pred__add_special_preds_8_0,26)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_sv(7);
	MR_sv(7) = MR_r1;
	MR_r1 = (MR_Word) MR_CTOR0_ADDR(parse_tree__prog_data, constructor);
	MR_np_call_localret_ent(list__length_2_0,
		hlds__make_hlds__add_special_pred__add_special_preds_8_0_i27);
MR_def_label(hlds__make_hlds__add_special_pred__add_special_preds_8_0,27)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	...
	MR_r8 = MR_sv(8);
	MR_GOTO_LAB(hlds__make_hlds__add_special_pred__add_special_preds_8_0_i28);
MR_def_label(hlds__make_hlds__add_special_pred__add_special_preds_8_0,21)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_sv(1);
	MR_r3 = MR_sv(2);
	MR_r4 = MR_sv(3);
	...
	MR_r8 = MR_sv(8);
MR_def_label(hlds__make_hlds__add_special_pred__add_special_preds_8_0,28)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(1) = MR_r2;
	MR_sv(2) = MR_r3;
	MR_sv(3) = MR_r4;
	...
	MR_np_call_localret_ent(hlds__make_hlds__add_special_pred__add_special_pred_list_9_0,
		hlds__make_hlds__add_special_pred__add_special_preds_8_0_i29);
MR_def_label(hlds__make_hlds__add_special_pred__add_special_preds_8_0,29)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_sv(4);
MR_def_label(hlds__make_hlds__add_special_pred__add_special_preds_8_0,12)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_sv(4) = MR_r2;
	MR_sv(7) = MR_r1;
	MR_np_call_localret_ent(check_hlds__type_util__type_body_is_solver_type_2_0,
		hlds__make_hlds__add_special_pred__add_special_preds_8_0_i32);
MR_def_label(hlds__make_hlds__add_special_pred__add_special_preds_8_0,32)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(hlds__make_hlds__add_special_pred__add_special_preds_8_0_i44);
	}
	MR_r1 = (MR_Integer) 3;
	MR_r2 = MR_sv(1);
	MR_r3 = MR_sv(2);
...
MR_def_label(hlds__make_hlds__add_special_pred__add_special_preds_8_0,6)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(1);
	MR_r2 = MR_sv(2);
	{
	...
	MR_np_call_localret_ent(check_hlds__type_util__type_body_is_solver_type_2_0,
		hlds__make_hlds__add_special_pred__add_special_preds_8_0_i38);
MR_def_label(hlds__make_hlds__add_special_pred__add_special_preds_8_0,38)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (!(MR_r1)) {
		MR_GOTO_LAB(hlds__make_hlds__add_special_pred__add_special_preds_8_0_i36);
	}
	MR_r2 = MR_sv(1);
	MR_r3 = MR_sv(2);
	MR_r4 = MR_sv(3);
...
MR_def_label(hlds__make_hlds__add_special_pred__add_special_preds_8_0,36)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(1);
	MR_r2 = MR_sv(2);
	MR_r3 = MR_sv(3);
...
void mercury__hlds__make_hlds__add_special_pred__write_out_proc_statics(FILE *fp);
#endif
