...
{
  {
    ...
    if (succeeded)
    {
      ...
      hlds__make_hlds__add_special_pred_for_real_9_p_0((MR_Integer) 0, TVarSet_9, Type_10, TypeCtor_11, TypeBody_12, Context_13, TypeStatus_14, STATE_VARIABLE_ModuleInfo_0_24, &STATE_VARIABLE_ModuleInfo_27_27);
        ...
        case (MR_Integer) 0:
          {
            ...
            {
              hlds__make_hlds__add_special_pred_decl_for_real_8_p_0((MR_Integer) 2, TVarSet_9, Type_10, TypeCtor_11, Context_13, TypeStatus_14, STATE_VARIABLE_ModuleInfo_27_27, STATE_VARIABLE_ModuleInfo_25);
            }
          }
          break;
        case (MR_Integer) 1:
          {
            ...
            MR_Word SpecialPredId_81;
            MR_Word SpecialPredIds_82;
            MR_Word STATE_VARIABLE_ModuleInfo_30_92;
            ...
            SpecialPredId_81 = ((MR_Word) (MR_hl_field(MR_mktag(1), SpecialPredIds_21, (MR_Integer) 0)));
            SpecialPredIds_82 = ((MR_Word) (MR_hl_field(MR_mktag(1), SpecialPredIds_21, (MR_Integer) 1)));
            hlds__make_hlds__add_special_pred__do_add_special_pred_for_real_9_p_0(SpecialPredId_81, TVarSet_9, Type_10, TypeCtor_11, TypeBody_12, Context_13, TypeStatus_14, STATE_VARIABLE_ModuleInfo_27_27, &STATE_VARIABLE_ModuleInfo_30_92);
            hlds__make_hlds__add_special_pred__add_special_pred_list_9_p_0(SpecialPredIds_82, TVarSet_9, Type_10, TypeCtor_11, TypeBody_12, Context_13, TypeStatus_14, STATE_VARIABLE_ModuleInfo_30_92, STATE_VARIABLE_ModuleInfo_25);
          }
          break;
      }
    }
    else
    {
      ...
      MR_Word SpecialPredId_102 = ((MR_Word) (MR_hl_field(MR_mktag(1), SpecialPredIds_46, (MR_Integer) 0)));
      MR_Word SpecialPredIds_103 = ((MR_Word) (MR_hl_field(MR_mktag(1), SpecialPredIds_46, (MR_Integer) 1)));
      MR_Word STATE_VARIABLE_ModuleInfo_27_112;
      MR_Word SpecialPredId_122;
      MR_Word SpecialPredIds_123;

      hlds__make_hlds__add_special_pred__do_add_special_pred_decl_for_real_8_p_0(SpecialPredId_102, TVarSet_9, Type_10, TypeCtor_11, Context_13, TypeStatus_14, STATE_VARIABLE_ModuleInfo_0_24, &STATE_VARIABLE_ModuleInfo_27_112);
      SpecialPredId_122 = ((MR_Word) (MR_hl_field(MR_mktag(1), SpecialPredIds_103, (MR_Integer) 0)));
      SpecialPredIds_123 = ((MR_Word) (MR_hl_field(MR_mktag(1), SpecialPredIds_103, (MR_Integer) 1)));
      hlds__make_hlds__add_special_pred__do_add_special_pred_decl_for_real_8_p_0(SpecialPredId_122, TVarSet_9, Type_10, TypeCtor_11, Context_13, TypeStatus_14, STATE_VARIABLE_ModuleInfo_27_112, STATE_VARIABLE_ModuleInfo_25);
    }
  }
}
