...
{
  {
    ...
    if (hlds__make_hlds__add_special_pred__succeeded)
              ...
              if (hlds__make_hlds__add_special_pred__succeeded)
                *hlds__make_hlds__add_special_pred__STATE_VARIABLE_ModuleInfo_25 = hlds__make_hlds__add_special_pred__STATE_VARIABLE_ModuleInfo_27_27;
              else
                {
                  ...
                  {
                    libs__globals__lookup_bool_option_3_p_0(hlds__make_hlds__add_special_pred__Globals_81, (MR_Integer) 284, &hlds__make_hlds__add_special_pred__GenSpecialPreds_82);
                  }
                      ...
                      if (hlds__make_hlds__add_special_pred__succeeded)
                        {
                          ...
                          hlds__make_hlds__add_special_pred__Var_33 = (MR_Integer) 322;
                          {
    ...
    else
      {
        ...
        {
          libs__globals__lookup_bool_option_3_p_0(hlds__make_hlds__add_special_pred__Globals_115, (MR_Integer) 284, &hlds__make_hlds__add_special_pred__GenSpecialPreds_116);
        }
        ...
        {
          libs__globals__lookup_bool_option_3_p_0(hlds__make_hlds__add_special_pred__Globals_149, (MR_Integer) 284, &hlds__make_hlds__add_special_pred__GenSpecialPreds_150);
        }
...
{
  {
    ...
    {
      libs__globals__lookup_bool_option_3_p_0(hlds__make_hlds__add_special_pred__Globals_18, (MR_Integer) 284, &hlds__make_hlds__add_special_pred__GenSpecialPreds_19);
    }
      ...
      if ((hlds__make_hlds__add_special_pred__HeadVar__1_1 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
        *hlds__make_hlds__add_special_pred__STATE_VARIABLE_ModuleInfo_9 = hlds__make_hlds__add_special_pred__STATE_VARIABLE_ModuleInfo_0_8;
      else
        {
          ...
          {
            libs__globals__lookup_bool_option_3_p_0(hlds__make_hlds__add_special_pred__Globals_42, (MR_Integer) 284, &hlds__make_hlds__add_special_pred__GenSpecialPreds_43);
          }
