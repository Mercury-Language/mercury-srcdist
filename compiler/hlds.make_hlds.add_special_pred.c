...
MR_decl_label10(hlds__make_hlds__add_special_pred__add_special_pred_9_0, 2,3,7,31,13,16,15,14,43,21)
MR_decl_label7(hlds__make_hlds__add_special_pred__add_special_pred_decl_9_0, 2,3,7,8,9,27,10)
MR_decl_label10(hlds__make_hlds__add_special_pred__add_special_pred_decl_list_9_0, 62,3,4,5,9,10,11,12,15,7)
MR_decl_label1(hlds__make_hlds__add_special_pred__add_special_pred_decl_list_9_0, 17)
MR_decl_label10(hlds__make_hlds__add_special_pred__add_special_pred_list_9_0, 87,3,4,5,9,36,15,19,18,16)
MR_decl_label6(hlds__make_hlds__add_special_pred__add_special_pred_list_9_0, 24,27,28,7,29,91)
...
MR_BEGIN_MODULE(hlds__make_hlds__add_special_pred_module2)
	...
	MR_init_label10(hlds__make_hlds__add_special_pred__add_special_pred_9_0,2,3,7,31,13,16,15,14,43,21)
MR_BEGIN_CODE
...
MR_def_label(hlds__make_hlds__add_special_pred__add_special_pred_9_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(hlds__make_hlds__add_special_pred__add_special_pred_9_0_i43);
	}
...
MR_def_label(hlds__make_hlds__add_special_pred__add_special_pred_9_0,43)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(1);
	MR_r2 = MR_sv(2);
	MR_r3 = MR_sv(3);
...
MR_BEGIN_MODULE(hlds__make_hlds__add_special_pred_module3)
	...
	MR_init_label10(hlds__make_hlds__add_special_pred__add_special_pred_list_9_0,87,3,4,5,9,36,15,19,18,16)
	MR_init_label6(hlds__make_hlds__add_special_pred__add_special_pred_list_9_0,24,27,28,7,29,91)
MR_BEGIN_CODE
...
MR_def_label(hlds__make_hlds__add_special_pred__add_special_pred_list_9_0,87)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
...
MR_def_label(hlds__make_hlds__add_special_pred__add_special_pred_list_9_0,5)
	...
	if (MR_PTAG_TESTR(MR_sv(4),0)) {
		MR_GOTO_LAB(hlds__make_hlds__add_special_pred__add_special_pred_list_9_0_i36);
	}
	{
	MR_Word MR_tempr1, MR_tempr2;
	MR_tempr2 = MR_sv(4);
...
MR_def_label(hlds__make_hlds__add_special_pred__add_special_pred_list_9_0,36)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r2 = MR_sv(1);
	MR_r3 = MR_sv(2);
	MR_r4 = MR_sv(3);
	...
	MR_GOTO_LAB(hlds__make_hlds__add_special_pred__add_special_pred_list_9_0_i87);
...
MR_def_label(hlds__make_hlds__add_special_pred__add_special_pred_list_9_0,18)
	...
	MR_np_call_localret_ent(require__unexpected_2_0,
		hlds__make_hlds__add_special_pred__add_special_pred_list_9_0_i91);
...
MR_def_label(hlds__make_hlds__add_special_pred__add_special_pred_list_9_0,91)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_succip_word = MR_sv(10);
	MR_GOTO_LAB(hlds__make_hlds__add_special_pred__add_special_pred_list_9_0_i87);
#ifdef MR_maybe_local_thread_engine_base
...
MR_BEGIN_MODULE(hlds__make_hlds__add_special_pred_module4)
	...
	MR_init_label7(hlds__make_hlds__add_special_pred__add_special_pred_decl_9_0,2,3,7,8,9,27,10)
MR_BEGIN_CODE
...
MR_def_label(hlds__make_hlds__add_special_pred__add_special_pred_decl_9_0,3)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r1,0)) {
		MR_GOTO_LAB(hlds__make_hlds__add_special_pred__add_special_pred_decl_9_0_i27);
	}
	if (MR_INT_NE(MR_sv(1),2)) {
...
MR_def_label(hlds__make_hlds__add_special_pred__add_special_pred_decl_9_0,27)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = MR_sv(1);
	MR_r2 = MR_sv(2);
	MR_r3 = MR_sv(3);
...
MR_BEGIN_MODULE(hlds__make_hlds__add_special_pred_module5)
	...
	MR_init_label10(hlds__make_hlds__add_special_pred__add_special_pred_decl_list_9_0,62,3,4,5,9,10,11,12,15,7)
	MR_init_label1(hlds__make_hlds__add_special_pred__add_special_pred_decl_list_9_0,17)
MR_BEGIN_CODE
