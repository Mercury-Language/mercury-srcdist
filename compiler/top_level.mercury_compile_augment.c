  ...
  MR_Word * STATE_VARIABLE_HaveParseTreeMaps_54)
{
  ...
  if (succeeded)
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_96, (MR_Integer) 248, &ShowDepGraph_97);
      ...
      case (MR_Integer) 1:
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_19, (MR_Integer) 410, &IntermodAnalysis_106);
  ...
  MR_Word * STATE_VARIABLE_HaveParseTreeMaps_46)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_20, (MR_Integer) 254, &TraceProf_41);
