  ...
  MR_Word * STATE_VARIABLE_MaybeWrittenSpecs_50)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_21, (MR_Integer) 279, &TraceProf_44);
  ...
  if (succeeded)
  {
    ...
    libs__globals__set_option_4_p_0((MR_Integer) 758, (MR_Word) (MR_mkword(1, &top_level__mercury_compile_augment_scalar_common_2[0])), Globals_21, &Globals1_45);
