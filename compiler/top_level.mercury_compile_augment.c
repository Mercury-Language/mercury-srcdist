  ...
  MR_Word * STATE_VARIABLE_HaveParseTreeMaps_54)
{
  ...
  if (succeeded)
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_19, (MR_Integer) 83, &Verbose_38);
    libs__globals__lookup_bool_option_3_p_0(Globals_19, (MR_Integer) 93, &Stats_39);
    hlds__hlds_module__module_info_get_globals_2_p_0(HLDS20_36, &Globals_96);
    libs__globals__lookup_bool_option_3_p_0(Globals_96, (MR_Integer) 217, &ShowDepGraph_97);
      ...
      case (MR_Integer) 1:
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_19, (MR_Integer) 534, &IntermodAnalysis_106);
            ...
            case (MR_Integer) 1:
              {
                ...
                libs__globals__lookup_accumulating_option_3_p_0(Globals_19, (MR_Integer) 752, &LocalModulesList_109);
  ...
  MR_Word * STATE_VARIABLE_DumpInfo_38)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_17, (MR_Integer) 93, &Stats_26);
  hlds__hlds_module__module_info_get_globals_2_p_0(STATE_VARIABLE_HLDS_0_34, &Globals_57);
  libs__globals__lookup_bool_option_3_p_0(Globals_57, (MR_Integer) 272, &ProfileCalls_58);
  libs__globals__lookup_bool_option_3_p_0(Globals_57, (MR_Integer) 273, &ProfileTime_59);
    ...
    case (MR_Integer) 0:
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_18, (MR_Integer) 339, &HighLevelCode_35);
  ...
  MR_Word * STATE_VARIABLE_HLDS_24)
{
  ...
  libs__globals__lookup_accumulating_option_3_p_0(Globals_11, (MR_Integer) 752, &LocalModulesList_18);
  ...
  MR_Word * STATE_VARIABLE_HaveParseTreeMaps_46)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_20, (MR_Integer) 187, &TraceProf_41);
  ...
  if (succeeded)
  {
    ...
    libs__globals__set_option_4_p_0((MR_Integer) 349, (MR_Word) (MR_mkword(1, &top_level__mercury_compile_augment_scalar_common_2[0])), Globals_20, &Globals1_42);
