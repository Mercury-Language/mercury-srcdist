...
top_level__mercury_compile_augment__IntroducedFrom__pred__augment_and_process_source_file__104__1_2_p_0(
  ...
  MR_Word * STATE_VARIABLE_HaveParseTreeMaps_56)
{
  ...
  if (succeeded)
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_107, (MR_Integer) 209, &ShowDepGraph_108);
  ...
  MR_Word * STATE_VARIABLE_DumpInfo_38)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_57, (MR_Integer) 264, &ProfileCalls_58);
  libs__globals__lookup_bool_option_3_p_0(Globals_57, (MR_Integer) 265, &ProfileTime_59);
    ...
    case (MR_Integer) 0:
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_18, (MR_Integer) 331, &HighLevelCode_35);
                    ...
                    case (MR_Integer) 1:
                      {
                        ...
                        backend_libs__compile_target_code__get_linked_target_type_2_p_0(Globals_18, &TargetType_38);
                        backend_libs__compile_target_code__get_object_code_type_3_p_0(Globals_18, TargetType_38, &PIC_39);
  ...
  MR_Word * STATE_VARIABLE_HLDS_24)
{
  ...
  libs__globals__lookup_accumulating_option_3_p_0(Globals_11, (MR_Integer) 744, &LocalModulesList_18);
    ...
    case (MR_Integer) 1:
      {
        ...
        libs__globals__lookup_accumulating_option_3_p_0(Globals_11, (MR_Integer) 744, &LocalModulesList_24);
  ...
  MR_Box wrapper_arg_1)
{
  ...
  succeeded = top_level__mercury_compile_augment__IntroducedFrom__pred__augment_and_process_source_file__104__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) (wrapper_arg_1)));
  return succeeded;
}
