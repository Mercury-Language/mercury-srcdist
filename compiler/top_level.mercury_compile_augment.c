...
top_level__mercury_compile_augment__IntroducedFrom__pred__augment_and_process_source_file__109__1_2_p_0(
...
top_level__mercury_compile_augment__process_augmented_module_after_front_end_14_p_0_2(
  MR_Box closure_arg,
...
static /* final */ const MR_Box top_level__mercury_compile_augment_scalar_common_5[3][3] = {
  ...
  {
    ((MR_Box) (&top_level__mercury_compile_augment_scalar_common_3[2])),
    ((MR_Box) (top_level__mercury_compile_augment__process_augmented_module_after_front_end_14_p_0_2)),
    ((MR_Box) ((MR_Integer) 0))
  },
};
  ...
  MR_Word * STATE_VARIABLE_MaybeWrittenSpecs_37)
{
  ...
  if (succeeded)
  {
    MR_Word HLDS1_58;
    MR_Word QualInfo_59;
    MR_Word MaybeTimestampMap_60;
    MR_Word MakeHldsResult_61;
    MR_Word Verbose_62;
    MR_Word InvalidTypeSpecs_63;
    MR_Word InvalidInstModeSpecs_64;
    MR_Word OptBlockingSpecs_65;
    MR_Word ExpandSpecs_66;
    MR_Word EventSetSpecs_67;
    MR_Word BlockingTypeSpecs_68;
    MR_Word STATE_VARIABLE_DumpInfo_1_79;
    MR_Word STATE_VARIABLE_MaybeWrittenSpecs_1_80;
    MR_Word STATE_VARIABLE_MaybeWrittenSpecs_2_83;
    MR_Word Var_85;

    top_level__mercury_compile_make_hlds__make_hlds_pass_19_p_0(ProgressStream_15, ErrorStream_16, Globals_17, OpModeAugment_18, InvokedByMmcMake_19, Baggage_30, AugCompUnit_29, &HLDS1_58, &QualInfo_59, &MaybeTimestampMap_60, &MakeHldsResult_61, (MR_Word) ((MR_Unsigned) 0U), &STATE_VARIABLE_DumpInfo_1_79, STATE_VARIABLE_HaveParseTreeMaps_1_41, STATE_VARIABLE_HaveParseTreeMaps_35, STATE_VARIABLE_MaybeWrittenSpecs_2_43, &STATE_VARIABLE_MaybeWrittenSpecs_1_80);
    libs__globals__lookup_bool_option_3_p_0(Globals_17, (MR_Integer) 131, &Verbose_62);
    parse_tree__write_error_spec__maybe_write_not_yet_written_specs_7_p_0(ErrorStream_16, Globals_17, Verbose_62, STATE_VARIABLE_MaybeWrittenSpecs_1_80, &STATE_VARIABLE_MaybeWrittenSpecs_2_83);
    InvalidTypeSpecs_63 = ((MR_Word) ((MR_hl_field(0, MakeHldsResult_61, 0))));
    InvalidInstModeSpecs_64 = ((MR_Word) ((MR_hl_field(0, MakeHldsResult_61, 1))));
    OptBlockingSpecs_65 = ((MR_Word) ((MR_hl_field(0, MakeHldsResult_61, 2))));
    ExpandSpecs_66 = ((MR_Word) ((MR_hl_field(0, MakeHldsResult_61, 3))));
    EventSetSpecs_67 = ((MR_Word) ((MR_hl_field(0, MakeHldsResult_61, 4))));
    Var_85 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_error_spec_0), ExpandSpecs_66, EventSetSpecs_67);
    BlockingTypeSpecs_68 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_error_spec_0), InvalidTypeSpecs_63, Var_85);
    if ((BlockingTypeSpecs_68 == (MR_Word) ((MR_Unsigned) 0U)))
    {
      MR_Word SpecsSoFar_71;
      MR_Word SemanticErrors_72;
      MR_Word OptBlockingErrors_73;
      MR_Word PreHLDSErrors_74;
      MR_Word FrontEndErrors_75;
      MR_Word HLDS20_76;
      MR_Integer ExitStatus_77;
      MR_Word STATE_VARIABLE_DumpInfo_2_89;
      MR_Word STATE_VARIABLE_MaybeWrittenSpecs_3_90;
      MR_Word SpecsSofar_78;
      MR_Word Var_93;

      SpecsSoFar_71 = parse_tree__error_util__maybe_written_specs_to_specs_1_f_0(STATE_VARIABLE_MaybeWrittenSpecs_2_83);
      SemanticErrors_72 = parse_tree__error_util__contains_errors_2_f_0(Globals_17, SpecsSoFar_71);
      OptBlockingErrors_73 = parse_tree__error_util__contains_errors_2_f_0(Globals_17, OptBlockingSpecs_65);
      mercury__bool__or_3_p_0(SemanticErrors_72, OptBlockingErrors_73, &PreHLDSErrors_74);
      top_level__mercury_compile_front_end__frontend_pass_15_p_0(ProgressStream_15, ErrorStream_16, OpModeAugment_18, QualInfo_59, InvalidInstModeSpecs_64, PreHLDSErrors_74, &FrontEndErrors_75, HLDS1_58, &HLDS20_76, STATE_VARIABLE_DumpInfo_1_79, &STATE_VARIABLE_DumpInfo_2_89, STATE_VARIABLE_MaybeWrittenSpecs_2_83, &STATE_VARIABLE_MaybeWrittenSpecs_3_90);
      mercury__io__get_exit_status_3_p_0(&ExitStatus_77);
      succeeded = (PreHLDSErrors_74 == (MR_Integer) 0);
      if (succeeded)
      {
        succeeded = (FrontEndErrors_75 == (MR_Integer) 0);
        if (succeeded)
        {
          SpecsSofar_78 = parse_tree__error_util__maybe_written_specs_to_specs_1_f_0(STATE_VARIABLE_MaybeWrittenSpecs_3_90);
          Var_93 = parse_tree__error_util__contains_errors_2_f_0(Globals_17, SpecsSofar_78);
          succeeded = (Var_93 == (MR_Integer) 0);
          if (succeeded)
            succeeded = (ExitStatus_77 == (MR_Integer) 0);
        }
      }
      if (succeeded)
      {
        ...
        top_level__mercury_compile_augment__process_augmented_module_after_front_end_14_p_0(ProgressStream_15, ErrorStream_16, Globals_17, OpModeAugment_18, Baggage_30, MaybeTimestampMap_60, HLDS20_76, ExtraObjFiles_22, STATE_VARIABLE_DumpInfo_2_89, &Var_33, STATE_VARIABLE_MaybeWrittenSpecs_3_90, STATE_VARIABLE_MaybeWrittenSpecs_37);
      }
      else
      {
        succeeded = (ExitStatus_77 == (MR_Integer) 0);
        ...
        *STATE_VARIABLE_MaybeWrittenSpecs_37 = STATE_VARIABLE_MaybeWrittenSpecs_3_90;
      }
    }
    else
    {
      libs__file_util__maybe_write_string_5_p_0(ProgressStream_15, Verbose_62, (MR_String) "% Program contains undefined type error(s).\n");
      *ExtraObjFiles_22 = (MR_Word) ((MR_Unsigned) 0U);
      mercury__io__set_exit_status_3_p_0((MR_Integer) 1);
      *STATE_VARIABLE_MaybeWrittenSpecs_37 = STATE_VARIABLE_MaybeWrittenSpecs_2_83;
    }
  }
  else
  {
  ...
  MR_Box wrapper_arg_1)
{
  ...
  conv1_HeadVar__2_2 = mdbcomp__sym_name__string_to_sym_name_1_f_0(((MR_String) (wrapper_arg_1)));
  ...
  MR_Word * STATE_VARIABLE_MaybeWrittenSpecs_40)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_17, (MR_Integer) 133, &Stats_27);
  hlds__hlds_module__module_info_get_globals_2_p_0(HLDS20_21, &Globals_69);
  libs__globals__lookup_bool_option_3_p_0(Globals_69, (MR_Integer) 269, &ShowDepGraph_70);
        ...
        case (MR_Integer) 2:
          {
            ...
            MR_Word HLDS22_30;
            MR_Word AllAvailModules_96;
            MR_Word LocalModulesList_97;
            MR_Word SymNames_98;
            MR_Word LocalModuleNames_99;
            MR_Word AnalysisInfo0_100;
            MR_Word AnalysisInfo_101;

            libs__file_util__maybe_write_string_5_p_0(ProgressStream_15, Verbose_26, (MR_String) "% Preparing for intermodule analysis...\n");
            hlds__hlds_module__module_info_get_all_avail_modules_2_p_0(HLDS21_28, &AllAvailModules_96);
            libs__globals__lookup_accumulating_option_3_p_0(Globals_17, (MR_Integer) 787, &LocalModulesList_97);
            SymNames_98 = mercury__list__map_2_f_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), (MR_Word) (&top_level__mercury_compile_augment_scalar_common_5[2]), LocalModulesList_97);
            LocalModuleNames_99 = mercury__set__list_to_set_1_f_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), SymNames_98);
            hlds__hlds_module__module_info_get_analysis_info_2_p_0(HLDS21_28, &AnalysisInfo0_100);
            analysis__operations__prepare_intermodule_analysis_9_p_0(ProgressStream_15, Globals_17, AllAvailModules_96, LocalModuleNames_99, &AnalysisSpecs_29, AnalysisInfo0_100, &AnalysisInfo_101);
            hlds__hlds_module__module_info_set_analysis_info_3_p_0(AnalysisInfo_101, HLDS21_28, &HLDS22_30);
    ...
    case (MR_Integer) 1:
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_17, (MR_Integer) 435, &IntermodAnalysis_79);
          ...
          case (MR_Integer) 0:
            {
              ...
              top_level__mercury_compile_augment__after_front_end_passes_14_p_0(ProgressStream_15, ErrorStream_16, Globals_17, OpModeFrontAndMiddle_33, MaybeTopModule_34, MaybeTimestampMap_20, HLDS21_28, ExtraObjFiles_22, STATE_VARIABLE_DumpInfo_0_37, STATE_VARIABLE_DumpInfo_38, STATE_VARIABLE_MaybeWrittenSpecs_0_39, STATE_VARIABLE_MaybeWrittenSpecs_40);
            }
            break;
          case (MR_Integer) 1:
            {
              ...
              MR_Word AnalysisSpecs_136;
              MR_Word HLDS22_137;

              libs__file_util__maybe_write_string_5_p_0(ProgressStream_15, Verbose_26, (MR_String) "% Preparing for intermodule analysis...\n");
              hlds__hlds_module__module_info_get_all_avail_modules_2_p_0(HLDS21_28, &AllAvailModules_81);
              libs__globals__lookup_accumulating_option_3_p_0(Globals_17, (MR_Integer) 787, &LocalModulesList_82);
              SymNames_83 = mercury__list__map_2_f_0((MR_Word) (&mercury__builtin__builtin__type_ctor_info_string_0), (MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), (MR_Word) (&top_level__mercury_compile_augment_scalar_common_5[1]), LocalModulesList_82);
              ...
              analysis__operations__prepare_intermodule_analysis_9_p_0(ProgressStream_15, Globals_17, AllAvailModules_81, LocalModuleNames_84, &AnalysisSpecs_136, AnalysisInfo0_85, &AnalysisInfo_86);
              hlds__hlds_module__module_info_set_analysis_info_3_p_0(AnalysisInfo_86, HLDS21_28, &HLDS22_137);
              libs__file_util__maybe_write_string_5_p_0(ProgressStream_15, Verbose_26, (MR_String) "% done.\n");
              libs__file_util__maybe_report_stats_4_p_0(ProgressStream_15, Stats_27);
              if ((AnalysisSpecs_136 == (MR_Word) ((MR_Unsigned) 0U)))
              {
                MR_Word MaybeTopModule_118 = ((MR_Word) ((MR_hl_field(0, Baggage_19, 3))));

                top_level__mercury_compile_augment__after_front_end_passes_14_p_0(ProgressStream_15, ErrorStream_16, Globals_17, OpModeFrontAndMiddle_33, MaybeTopModule_118, MaybeTimestampMap_20, HLDS22_137, ExtraObjFiles_22, STATE_VARIABLE_DumpInfo_0_37, STATE_VARIABLE_DumpInfo_38, STATE_VARIABLE_MaybeWrittenSpecs_0_39, STATE_VARIABLE_MaybeWrittenSpecs_40);
              }
              else
              {
                parse_tree__error_util__add_to_be_written_specs_3_p_0(AnalysisSpecs_136, STATE_VARIABLE_MaybeWrittenSpecs_0_39, STATE_VARIABLE_MaybeWrittenSpecs_40);
                *ExtraObjFiles_22 = (MR_Word) ((MR_Unsigned) 0U);
                *STATE_VARIABLE_DumpInfo_38 = STATE_VARIABLE_DumpInfo_0_37;
              }
            }
  ...
  MR_Box wrapper_arg_1)
{
  ...
  succeeded = top_level__mercury_compile_augment__IntroducedFrom__pred__augment_and_process_source_file__109__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_Word) (wrapper_arg_1)));
  return succeeded;
}
