  ...
  MR_Word * STATE_VARIABLE_HaveParseTreeMaps_54)
{
  ...
  if (succeeded)
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_19, (MR_Integer) 82, &Verbose_38);
    libs__globals__lookup_bool_option_3_p_0(Globals_19, (MR_Integer) 92, &Stats_39);
    hlds__hlds_module__module_info_get_globals_2_p_0(HLDS20_36, &Globals_96);
    libs__globals__lookup_bool_option_3_p_0(Globals_96, (MR_Integer) 216, &ShowDepGraph_97);
      ...
      case (MR_Integer) 1:
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_19, (MR_Integer) 533, &IntermodAnalysis_106);
            ...
            case (MR_Integer) 1:
              {
                ...
                hlds__hlds_module__module_info_get_all_deps_2_p_0(HLDS21_40, &ModuleNames_108);
                libs__globals__lookup_accumulating_option_3_p_0(Globals_19, (MR_Integer) 751, &LocalModulesList_109);
                ...
                analysis__operations__prepare_intermodule_analysis_9_p_0(ProgressStream_17, Globals_19, ModuleNames_108, LocalModuleNames_111, &AnalysisSpecs_148, AnalysisInfo0_112, &AnalysisInfo_113);
