  ...
  MR_Word * STATE_VARIABLE_HaveParseTreeMaps_54)
{
  ...
  if (succeeded)
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_96, (MR_Integer) 247, &ShowDepGraph_97);
      ...
      case (MR_Integer) 1:
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_19, (MR_Integer) 409, &IntermodAnalysis_106);
            ...
            case (MR_Integer) 1:
              {
                ...
                libs__globals__lookup_accumulating_option_3_p_0(Globals_19, (MR_Integer) 760, &LocalModulesList_109);
  ...
  MR_Word * STATE_VARIABLE_HLDS_24)
{
  ...
  libs__globals__lookup_accumulating_option_3_p_0(Globals_11, (MR_Integer) 760, &LocalModulesList_18);
  ...
  MR_Word * STATE_VARIABLE_HaveParseTreeMaps_46)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_20, (MR_Integer) 253, &TraceProf_41);
  ...
  if (succeeded)
  {
    ...
    libs__globals__set_option_4_p_0((MR_Integer) 730, (MR_Word) (MR_mkword(1, &top_level__mercury_compile_augment_scalar_common_2[0])), Globals_20, &Globals1_42);
