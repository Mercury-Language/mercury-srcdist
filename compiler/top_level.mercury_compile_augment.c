  ...
  MR_Word * STATE_VARIABLE_HaveParseTreeMaps_56)
{
  ...
  if (succeeded)
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_30, (MR_Integer) 82, &Verbose_40);
    libs__globals__lookup_bool_option_3_p_0(Globals_30, (MR_Integer) 92, &Stats_41);
    hlds__hlds_module__module_info_get_globals_2_p_0(HLDS20_38, &Globals_107);
    libs__globals__lookup_bool_option_3_p_0(Globals_107, (MR_Integer) 216, &ShowDepGraph_108);
    ...
    switch (MR_tag((MR_Word) OpModeAugment_20)) {
      ...
      case (MR_Integer) 1:
        {
          MR_Word OpModeFrontAndMiddle_47 = ((MR_Unsigned) ((MR_hl_field(1, OpModeAugment_20, 0))) & (MR_Integer) 3);
          ...
          {
            MR_Word MaybeTopModule_48 = ((MR_Word) ((MR_hl_field(0, Baggage_22, 3))));
  ...
  MR_Word * STATE_VARIABLE_DumpInfo_38)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_17, (MR_Integer) 92, &Stats_26);
  hlds__hlds_module__module_info_get_globals_2_p_0(STATE_VARIABLE_HLDS_0_34, &Globals_57);
  libs__globals__lookup_bool_option_3_p_0(Globals_57, (MR_Integer) 271, &ProfileCalls_58);
  libs__globals__lookup_bool_option_3_p_0(Globals_57, (MR_Integer) 272, &ProfileTime_59);
    ...
    case (MR_Integer) 0:
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_18, (MR_Integer) 338, &HighLevelCode_35);
  ...
  MR_Word * STATE_VARIABLE_HLDS_24)
{
  ...
  libs__globals__lookup_accumulating_option_3_p_0(Globals_11, (MR_Integer) 751, &LocalModulesList_18);
  ...
  MR_Word * STATE_VARIABLE_HLDS_19)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 533, &IntermodAnalysis_17);
    ...
    case (MR_Integer) 1:
      {
        ...
        libs__globals__lookup_accumulating_option_3_p_0(Globals_11, (MR_Integer) 751, &LocalModulesList_24);
  ...
  MR_Word * STATE_VARIABLE_HaveParseTreeMaps_46)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_20, (MR_Integer) 186, &TraceProf_41);
  ...
  if (succeeded)
  {
    ...
    libs__globals__set_option_4_p_0((MR_Integer) 348, (MR_Word) (MR_mkword(1, &top_level__mercury_compile_augment_scalar_common_2[0])), Globals_20, &Globals1_42);
