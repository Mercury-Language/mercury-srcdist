  ...
  MR_Word * STATE_VARIABLE_MaybeWrittenSpecs_37)
{
  ...
  if (succeeded)
  {
    ...
    MR_Word UndefTypes_61;
    MR_Word UndefModes_62;
    MR_Word PreHLDSErrors_63;
    MR_Word FrontEndErrors_64;
    MR_Word HLDS20_65;
    MR_Integer ExitStatus_66;
    MR_Word STATE_VARIABLE_DumpInfo_1_68;
    MR_Word STATE_VARIABLE_MaybeWrittenSpecs_1_69;
    MR_Word STATE_VARIABLE_DumpInfo_2_71;
    MR_Word STATE_VARIABLE_MaybeWrittenSpecs_2_72;
    MR_Word SpecsSofar_67;
    MR_Word Var_75;

    top_level__mercury_compile_make_hlds__make_hlds_pass_21_p_0(ProgressStream_15, ErrorStream_16, Globals_17, OpModeAugment_18, InvokedByMmcMake_19, Baggage_30, AugCompUnit_29, &HLDS1_58, &QualInfo_59, &MaybeTimestampMap_60, &UndefTypes_61, &UndefModes_62, &PreHLDSErrors_63, (MR_Word) ((MR_Unsigned) 0U), &STATE_VARIABLE_DumpInfo_1_68, STATE_VARIABLE_HaveParseTreeMaps_1_41, STATE_VARIABLE_HaveParseTreeMaps_35, STATE_VARIABLE_MaybeWrittenSpecs_2_43, &STATE_VARIABLE_MaybeWrittenSpecs_1_69);
    top_level__mercury_compile_front_end__frontend_pass_16_p_0(ProgressStream_15, ErrorStream_16, OpModeAugment_18, QualInfo_59, UndefTypes_61, UndefModes_62, PreHLDSErrors_63, &FrontEndErrors_64, HLDS1_58, &HLDS20_65, STATE_VARIABLE_DumpInfo_1_68, &STATE_VARIABLE_DumpInfo_2_71, STATE_VARIABLE_MaybeWrittenSpecs_1_69, &STATE_VARIABLE_MaybeWrittenSpecs_2_72);
    mercury__io__get_exit_status_3_p_0(&ExitStatus_66);
    succeeded = (PreHLDSErrors_63 == (MR_Integer) 0);
    if (succeeded)
    {
      succeeded = (FrontEndErrors_64 == (MR_Integer) 0);
      if (succeeded)
      {
        SpecsSofar_67 = parse_tree__error_util__maybe_written_specs_to_specs_1_f_0(STATE_VARIABLE_MaybeWrittenSpecs_2_72);
        Var_75 = parse_tree__error_util__contains_errors_2_f_0(Globals_17, SpecsSofar_67);
        succeeded = (Var_75 == (MR_Integer) 0);
        if (succeeded)
          succeeded = (ExitStatus_66 == (MR_Integer) 0);
      }
    }
    if (succeeded)
    {
      ...
      top_level__mercury_compile_augment__process_augmented_module_after_front_end_14_p_0(ProgressStream_15, ErrorStream_16, Globals_17, OpModeAugment_18, Baggage_30, MaybeTimestampMap_60, HLDS20_65, ExtraObjFiles_22, STATE_VARIABLE_DumpInfo_2_71, &Var_33, STATE_VARIABLE_MaybeWrittenSpecs_2_72, STATE_VARIABLE_MaybeWrittenSpecs_37);
    }
    else
    {
      succeeded = (ExitStatus_66 == (MR_Integer) 0);
      ...
      *STATE_VARIABLE_MaybeWrittenSpecs_37 = STATE_VARIABLE_MaybeWrittenSpecs_2_72;
    }
  }
  else
  {
