  ...
  MR_Word * STATE_VARIABLE_MaybeWrittenSpecs_37)
{
  ...
  if (succeeded)
  {
    ...
    Var_85 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_diag_spec_0), ExpandSpecs_66, EventSetSpecs_67);
    BlockingTypeSpecs_68 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_diag_spec_0), InvalidTypeSpecs_63, Var_85);
