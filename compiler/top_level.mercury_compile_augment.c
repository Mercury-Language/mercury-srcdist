  ...
  MR_Word * STATE_VARIABLE_MaybeWrittenSpecs_40)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_69, (MR_Integer) 271, &ShowDepGraph_70);
    ...
    case (MR_Integer) 1:
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_17, (MR_Integer) 437, &IntermodAnalysis_79);
          ...
          case (MR_Integer) 1:
            {
              ...
              libs__globals__lookup_accumulating_option_3_p_0(Globals_17, (MR_Integer) 791, &LocalModulesList_82);
  ...
  MR_Word * STATE_VARIABLE_HLDS_24)
{
  ...
  libs__globals__lookup_accumulating_option_3_p_0(Globals_11, (MR_Integer) 791, &LocalModulesList_18);
  ...
  MR_Word * STATE_VARIABLE_MaybeWrittenSpecs_50)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_21, (MR_Integer) 281, &TraceProf_44);
  ...
  if (succeeded)
  {
    ...
    libs__globals__set_option_4_p_0((MR_Integer) 762, (MR_Word) (MR_mkword(1, &top_level__mercury_compile_augment_scalar_common_2[0])), Globals_21, &Globals1_45);
