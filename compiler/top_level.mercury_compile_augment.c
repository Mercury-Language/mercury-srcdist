  ...
  MR_Word * STATE_VARIABLE_HaveParseTreeMaps_56)
{
  ...
  if (succeeded)
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_107, (MR_Integer) 212, &ShowDepGraph_108);
  ...
  MR_Word * STATE_VARIABLE_DumpInfo_38)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_57, (MR_Integer) 267, &ProfileCalls_58);
  libs__globals__lookup_bool_option_3_p_0(Globals_57, (MR_Integer) 268, &ProfileTime_59);
    ...
    case (MR_Integer) 0:
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_18, (MR_Integer) 334, &HighLevelCode_35);
  ...
  MR_Word * STATE_VARIABLE_HLDS_24)
{
  ...
  libs__globals__lookup_accumulating_option_3_p_0(Globals_11, (MR_Integer) 747, &LocalModulesList_18);
  ...
  MR_Word * STATE_VARIABLE_HLDS_19)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 529, &IntermodAnalysis_17);
    ...
    case (MR_Integer) 1:
      {
        ...
        libs__globals__lookup_accumulating_option_3_p_0(Globals_11, (MR_Integer) 747, &LocalModulesList_24);
  ...
  MR_Word * STATE_VARIABLE_HaveParseTreeMaps_46)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_20, (MR_Integer) 182, &TraceProf_41);
  ...
  if (succeeded)
  {
    ...
    libs__globals__set_option_4_p_0((MR_Integer) 344, (MR_Word) (MR_mkword(1, &top_level__mercury_compile_augment_scalar_common_2[0])), Globals_20, &Globals1_42);
