...
top_level__mercury_compile_augment__IntroducedFrom__pred__augment_and_process_source_file__105__1_2_p_0(
...
top_level__mercury_compile_augment__process_augmented_module_16_p_0(
  ...
  MR_Word STATE_VARIABLE_DumpInfo_0_51,
  MR_Word * STATE_VARIABLE_DumpInfo_52,
  ...
  MR_Word * STATE_VARIABLE_HaveParseTreeMaps_56)
{
  ...
  switch (MR_tag((MR_Word) OpModeAugment_20)) {
    ...
    case (MR_Integer) 0:
      switch (MR_unmkbody(OpModeAugment_20)) {
        ...
        case (MR_Integer) 1:
          {
            MR_Word OptionTable0_98;
            MR_Word OptionTable1_99;
            MR_Word OptionTable_100;
            MR_Word Var_101;
            MR_Word Var_104;

            libs__globals__get_options_2_p_0(Globals0_19, &OptionTable0_98);
            Var_101 = libs__options__style_warning_options_0_f_0();
            libs__options__set_all_options_to_4_p_0(Var_101, (MR_Word) (MR_mkword(1, &top_level__mercury_compile_augment_scalar_common_2[0])), OptionTable0_98, &OptionTable1_99);
            Var_104 = libs__options__non_style_warning_options_0_f_0();
            libs__options__set_all_options_to_4_p_0(Var_104, (MR_Word) (MR_mkword(1, &top_level__mercury_compile_augment_scalar_common_2[0])), OptionTable1_99, &OptionTable_100);
            libs__globals__set_options_3_p_0(OptionTable_100, Globals0_19, &Globals_30);
          }
          break;
        case (MR_Integer) 2:
        case (MR_Integer) 3:
  ...
  top_level__mercury_compile_make_hlds__make_hlds_pass_21_p_0(ProgressStream_17, ErrorStream_18, Globals_30, OpModeAugment_20, InvokedByMmcMake_21, Baggage_22, AugCompUnit_23, &HLDS1_31, &QualInfo_32, &MaybeTimestampMap_33, &UndefTypes_34, &UndefModes_35, &PreHLDSErrors_36, STATE_VARIABLE_DumpInfo_0_51, &STATE_VARIABLE_DumpInfo_59_59, STATE_VARIABLE_Specs_0_53, &STATE_VARIABLE_Specs_60_60, STATE_VARIABLE_HaveParseTreeMaps_0_55, STATE_VARIABLE_HaveParseTreeMaps_56);
  top_level__mercury_compile_front_end__frontend_pass_16_p_0(ProgressStream_17, ErrorStream_18, OpModeAugment_20, QualInfo_32, UndefTypes_34, UndefModes_35, PreHLDSErrors_36, &FrontEndErrors_37, HLDS1_31, &HLDS20_38, STATE_VARIABLE_DumpInfo_59_59, &STATE_VARIABLE_DumpInfo_63_63, STATE_VARIABLE_Specs_60_60, &STATE_VARIABLE_Specs_64_64);
  ...
  if (succeeded)
  {
    ...
    if (succeeded)
    {
      Var_67 = parse_tree__error_util__contains_errors_2_f_0(Globals_30, STATE_VARIABLE_Specs_64_64);
  ...
  if (succeeded)
  {
    ...
    MR_Word HLDS21_42;
    MR_Word Globals_107;
    MR_Word ShowDepGraph_108;

    libs__globals__lookup_bool_option_3_p_0(Globals_30, (MR_Integer) 78, &Verbose_40);
    libs__globals__lookup_bool_option_3_p_0(Globals_30, (MR_Integer) 88, &Stats_41);
    hlds__hlds_module__module_info_get_globals_2_p_0(HLDS20_38, &Globals_107);
    libs__globals__lookup_bool_option_3_p_0(Globals_107, (MR_Integer) 210, &ShowDepGraph_108);
    switch (ShowDepGraph_108) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        HLDS21_42 = HLDS20_38;
        break;
      case (MR_Integer) 1:
        {
          MR_String DepGraphStr_109;
          MR_Word ModuleName_110;
          MR_String DepGraphFileName_111;
          MR_Word _Succeeded_112;

          hlds__hlds_dependency_graph__dependency_graph_to_string_3_p_0(&DepGraphStr_109, HLDS20_38, &HLDS21_42);
          hlds__hlds_module__module_info_get_name_2_p_0(HLDS21_42, &ModuleName_110);
          parse_tree__file_names__module_name_to_cur_dir_file_name_3_p_0((MR_Integer) 3, ModuleName_110, &DepGraphFileName_111);
          libs__file_util__write_string_to_file_8_p_0(ProgressStream_17, Globals_107, (MR_String) "Writing dependency graph", DepGraphFileName_111, DepGraphStr_109, &_Succeeded_112);
          libs__file_util__maybe_report_stats_4_p_0(ProgressStream_17, Stats_41);
        }
        break;
    }
    switch (MR_tag((MR_Word) OpModeAugment_20)) {
          ...
          case (MR_Integer) 0:
            {
              ...
              *STATE_VARIABLE_DumpInfo_52 = STATE_VARIABLE_DumpInfo_63_63;
              *STATE_VARIABLE_Specs_54 = STATE_VARIABLE_Specs_64_64;
            }
            break;
          case (MR_Integer) 1:
            {
              top_level__mercury_compile_middle_passes__output_trans_opt_file_8_p_0(ProgressStream_17, HLDS21_42, STATE_VARIABLE_Specs_64_64, STATE_VARIABLE_Specs_54, STATE_VARIABLE_DumpInfo_63_63, STATE_VARIABLE_DumpInfo_52);
              *ExtraObjFiles_24 = (MR_Word) ((MR_Unsigned) 0U);
            }
            break;
          case (MR_Integer) 2:
            {
              MR_Word AnalysisSpecs_43;
              MR_Word HLDS22_44;

              top_level__mercury_compile_augment__prepare_for_intermodule_analysis_9_p_0(ProgressStream_17, Globals_30, Verbose_40, Stats_41, &AnalysisSpecs_43, HLDS21_42, &HLDS22_44);
              if ((AnalysisSpecs_43 == (MR_Word) ((MR_Unsigned) 0U)))
                top_level__mercury_compile_middle_passes__output_analysis_file_8_p_0(ProgressStream_17, HLDS22_44, STATE_VARIABLE_Specs_64_64, STATE_VARIABLE_Specs_54, STATE_VARIABLE_DumpInfo_63_63, STATE_VARIABLE_DumpInfo_52);
              else
              {
                *STATE_VARIABLE_Specs_54 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_error_spec_0), AnalysisSpecs_43, STATE_VARIABLE_Specs_64_64);
                *STATE_VARIABLE_DumpInfo_52 = STATE_VARIABLE_DumpInfo_63_63;
              }
              *ExtraObjFiles_24 = (MR_Word) ((MR_Unsigned) 0U);
            }
      ...
      case (MR_Integer) 1:
        {
          MR_Word OpModeFrontAndMiddle_47 = ((MR_Unsigned) ((MR_hl_field(1, OpModeAugment_20, (MR_Integer) 0))) & (MR_Integer) 3);
          MR_Word AnalysisSpecs_87;
          MR_Word HLDS22_88;

          top_level__mercury_compile_augment__maybe_prepare_for_intermodule_analysis_9_p_0(ProgressStream_17, Globals_30, Verbose_40, Stats_41, &AnalysisSpecs_87, HLDS21_42, &HLDS22_88);
          if ((AnalysisSpecs_87 == (MR_Word) ((MR_Unsigned) 0U)))
          {
            MR_Word MaybeTopModule_48 = ((MR_Word) ((MR_hl_field(0, Baggage_22, (MR_Integer) 3))));

            top_level__mercury_compile_augment__after_front_end_passes_14_p_0(ProgressStream_17, ErrorStream_18, Globals_30, OpModeFrontAndMiddle_47, MaybeTopModule_48, MaybeTimestampMap_33, HLDS22_88, ExtraObjFiles_24, STATE_VARIABLE_Specs_64_64, STATE_VARIABLE_Specs_54, STATE_VARIABLE_DumpInfo_63_63, STATE_VARIABLE_DumpInfo_52);
          }
          else
          {
            *STATE_VARIABLE_Specs_54 = mercury__list__f_43_43_2_f_0((MR_Word) (&parse_tree__error_spec__parse_tree__error_spec__type_ctor_info_error_spec_0), AnalysisSpecs_87, STATE_VARIABLE_Specs_64_64);
            *ExtraObjFiles_24 = (MR_Word) ((MR_Unsigned) 0U);
            *STATE_VARIABLE_DumpInfo_52 = STATE_VARIABLE_DumpInfo_63_63;
          }
        }
  ...
  MR_Word * STATE_VARIABLE_DumpInfo_38)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_17, (MR_Integer) 88, &Stats_26);
  hlds__hlds_module__module_info_get_globals_2_p_0(STATE_VARIABLE_HLDS_0_34, &Globals_57);
  libs__globals__lookup_bool_option_3_p_0(Globals_57, (MR_Integer) 265, &ProfileCalls_58);
  libs__globals__lookup_bool_option_3_p_0(Globals_57, (MR_Integer) 266, &ProfileTime_59);
  ...
  if (succeeded)
  {
    ...
    hlds__hlds_dependency_graph__prof_dependency_graph_to_string_3_p_0(&DepGraphStr_63, STATE_VARIABLE_HLDS_0_34, &STATE_VARIABLE_HLDS_42_42);
    ...
    STATE_VARIABLE_HLDS_42_42 = STATE_VARIABLE_HLDS_0_34;
  top_level__mercury_compile_middle_passes__middle_pass_11_p_0(ProgressStream_15, ErrorStream_16, OpModeFrontAndMiddle_18, STATE_VARIABLE_HLDS_42_42, &STATE_VARIABLE_HLDS_44_44, STATE_VARIABLE_DumpInfo_0_37, &STATE_VARIABLE_DumpInfo_45_45, STATE_VARIABLE_Specs_0_35, &STATE_VARIABLE_Specs_46_46);
  hlds__hlds_module__module_info_get_name_2_p_0(STATE_VARIABLE_HLDS_44_44, &ModuleName_27);
  ...
  FrontEndErrors_31 = parse_tree__error_util__contains_errors_or_warnings_treated_as_errors_2_f_0(Globals_17, STATE_VARIABLE_Specs_46_46);
  ...
  if (succeeded)
    switch (OpModeFrontAndMiddle_18) {
      ...
      case (MR_Integer) 0:
        {
          *ExtraObjFiles_22 = (MR_Word) ((MR_Unsigned) 0U);
          *STATE_VARIABLE_Specs_36 = STATE_VARIABLE_Specs_46_46;
          *STATE_VARIABLE_DumpInfo_38 = STATE_VARIABLE_DumpInfo_45_45;
        }
        break;
      case (MR_Integer) 2:
      case (MR_Integer) 1:
      case (MR_Integer) 3:
        {
          ...
          top_level__mercury_compile_augment__choose_and_execute_backend_passes_15_p_0(ProgressStream_15, ErrorStream_16, Globals_17, OpModeCodeGen_33, ModuleName_27, MaybeTopModule_19, MaybeTimestampMap_20, STATE_VARIABLE_HLDS_44_44, ExtraObjFiles_22, STATE_VARIABLE_Specs_46_46, STATE_VARIABLE_Specs_36, STATE_VARIABLE_DumpInfo_45_45, STATE_VARIABLE_DumpInfo_38);
        }
        break;
    }
  else
    ...
    case (MR_Integer) 0:
      {
        ...
        backend_libs__export__produce_header_file_6_p_0(ProgressStream_16, STATE_VARIABLE_HLDS_0_52, ExportDecls_34, ModuleName_20);
        libs__globals__lookup_bool_option_3_p_0(Globals_18, (MR_Integer) 332, &HighLevelCode_35);
          ...
          case (MR_Integer) 0:
            {
              ...
              top_level__mercury_compile_llds_back_end__llds_backend_pass_10_p_0(ProgressStream_16, ErrorStream_17, STATE_VARIABLE_HLDS_0_52, &STATE_VARIABLE_HLDS_87_87, &GlobalData_44, &LLDS_45, STATE_VARIABLE_DumpInfo_0_55, STATE_VARIABLE_DumpInfo_56);
              top_level__mercury_compile_llds_back_end__llds_output_pass_10_p_0(ProgressStream_16, OpModeCodeGen_19, STATE_VARIABLE_HLDS_87_87, GlobalData_44, LLDS_45, ModuleName_20, &Succeeded_30, ExtraObjFiles_24);
          ...
          case (MR_Integer) 1:
            {
                    ...
                    case (MR_Integer) 1:
                      {
                        ...
                        backend_libs__link_target_code__get_linked_target_type_2_p_0(Globals_18, &TargetType_38);
              ...
              *ExtraObjFiles_24 = (MR_Word) ((MR_Unsigned) 0U);
              STATE_VARIABLE_HLDS_87_87 = STATE_VARIABLE_HLDS_0_52;
            }
            break;
        }
      }
    ...
    case (MR_Integer) 1:
      {
        ...
        hlds__hlds_module__module_info_get_maybe_recompilation_info_2_p_0(STATE_VARIABLE_HLDS_87_87, &MaybeRecompInfo_46);
        succeeded = (MaybeRecompInfo_46 != (MR_Word) ((MR_Unsigned) 0U));
        if (succeeded)
        {
          RecompInfo_47 = ((MR_Word) ((MR_hl_field(1, MaybeRecompInfo_46, (MR_Integer) 0))));
          succeeded = (MaybeTimestampMap_22 != (MR_Word) ((MR_Unsigned) 0U));
          if (succeeded)
            TimestampMap_48 = ((MR_Word) ((MR_hl_field(1, MaybeTimestampMap_22, (MR_Integer) 0))));
        }
        if (succeeded)
        {
          MR_Word UsedFileContents_49;

          recompilation__usage__construct_used_file_contents_5_p_0(STATE_VARIABLE_HLDS_87_87, RecompInfo_47, MaybeTopModule_21, TimestampMap_48, &UsedFileContents_49);
          recompilation__used_file__write_usage_file_5_p_0(ProgressStream_16, STATE_VARIABLE_HLDS_87_87, UsedFileContents_49);
        }
  ...
  MR_Word * STATE_VARIABLE_HLDS_24)
{
  ...
  libs__globals__lookup_accumulating_option_3_p_0(Globals_11, (MR_Integer) 745, &LocalModulesList_18);
  ...
  MR_Word * STATE_VARIABLE_HLDS_19)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_11, (MR_Integer) 527, &IntermodAnalysis_17);
    ...
    case (MR_Integer) 1:
      {
        ...
        libs__globals__lookup_accumulating_option_3_p_0(Globals_11, (MR_Integer) 745, &LocalModulesList_24);
  ...
  MR_Word * ModuleName_4)
{
  ...
  *ModuleName_4 = ((MR_Word) ((MR_hl_field(0, ParseTreeModuleSrc_6, (MR_Integer) 0))));
}
  ...
  MR_Box wrapper_arg_1)
{
  ...
  succeeded = top_level__mercury_compile_augment__IntroducedFrom__pred__augment_and_process_source_file__105__1_2_p_0(((MR_Word) ((MR_hl_field(0, closure, (MR_Integer) 3)))), ((MR_Word) (wrapper_arg_1)));
  return succeeded;
}
  ...
  MR_Word * STATE_VARIABLE_HaveParseTreeMaps_46)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_20, (MR_Integer) 180, &TraceProf_41);
  ...
  if (succeeded)
  {
    ...
    libs__globals__set_option_4_p_0((MR_Integer) 342, (MR_Word) (MR_mkword(1, &top_level__mercury_compile_augment_scalar_common_2[0])), Globals_20, &Globals1_42);
