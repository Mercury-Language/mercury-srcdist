...
static const MR_PseudoTypeInfo parse_tree__module_dep_info__parse_tree__module_dep_info__field_types_module_dep_info_0_0[1] = {
  (MR_PseudoTypeInfo) (&parse_tree__module_imports__parse_tree__module_imports__type_ctor_info_burdened_aug_comp_unit_0)
};
...
static const MR_PseudoTypeInfo parse_tree__module_dep_info__parse_tree__module_dep_info__field_types_module_dep_info_0_1[1] = {
  (MR_PseudoTypeInfo) (&parse_tree__module_dep_info__parse_tree__module_dep_info__type_ctor_info_module_dep_summary_0)
};
...
static const MR_DuFunctorDescPtr parse_tree__module_dep_info__parse_tree__module_dep_info__du_stag_ordered_module_dep_summary_0_0[1] = {
  &parse_tree__module_dep_info__parse_tree__module_dep_info__du_functor_desc_module_dep_summary_0_0
};
...
{
  {
    ...
    if (((MR_tag((MR_Word) HeadVar__2_2)) == (MR_Integer) 1))
    {
      ...
      if (((MR_tag((MR_Word) HeadVar__3_3)) == (MR_Integer) 1))
      {
        ...
        parse_tree__module_imports____Compare____burdened_aug_comp_unit_0_0(HeadVar__1_1, Var_16, ArgY1_5);
      }
      else
...
{
  {
    ...
    if (((MR_tag((MR_Word) HeadVar__1_1)) == (MR_Integer) 1))
    {
      ...
      if (succeeded)
      {
        ...
        succeeded = parse_tree__module_imports____Unify____burdened_aug_comp_unit_0_0(ArgX1_3, ArgY1_4);
      }
    }
    else
    {
  ...
  MR_Word * X_4)
{
  ...
  {
    MR_Word BurdenedAugCompUnit_5 = ((MR_Word) ((MR_hl_field(MR_mktag(1), ModuleDepInfo_3, (MR_Integer) 0))));
    MR_Word AugCompUnit_6 = ((MR_Word) ((MR_hl_field(MR_mktag(0), BurdenedAugCompUnit_5, (MR_Integer) 1))));
    MR_Word ParseTreeModuleSrc_7 = ((MR_Word) ((MR_hl_field(MR_mktag(0), AugCompUnit_6, (MR_Integer) 0))));

    parse_tree__get_dependencies__get_foreign_include_file_infos_2_p_0(ParseTreeModuleSrc_7, X_4);
  }
  else
  {
    MR_Word Summary_8 = (MR_Word) ((MR_Word) (ModuleDepInfo_3));

    *X_4 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Summary_8, (MR_Integer) 10))));
  }
}
  ...
  MR_Word * X_4)
{
  if (((MR_tag((MR_Word) ModuleDepInfo_3)) == (MR_Integer) 1))
  {
    ...
    parse_tree__get_dependencies__get_fim_specs_2_p_0(ParseTreeModuleSrc_7, X_4);
  }
  else
  {
    MR_Word Summary_8 = (MR_Word) ((MR_Word) (ModuleDepInfo_3));

    *X_4 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Summary_8, (MR_Integer) 9))));
  }
}
  ...
  MR_Word * X_4)
{
  if (((MR_tag((MR_Word) ModuleDepInfo_3)) == (MR_Integer) 1))
  {
    ...
    parse_tree__get_dependencies__get_fact_tables_2_p_0(ParseTreeModuleSrc_7, X_4);
  }
  else
  {
    MR_Word Summary_8 = (MR_Word) ((MR_Word) (ModuleDepInfo_3));

    *X_4 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Summary_8, (MR_Integer) 8))));
  }
}
  ...
  MR_Word * X_4)
{
  if (((MR_tag((MR_Word) ModuleDepInfo_3)) == (MR_Integer) 1))
  {
    ...
    parse_tree__module_imports__aug_compilation_unit_get_int_imp_deps_3_p_0(AugCompUnit_6, &Var_7, X_4);
  }
  else
  {
    MR_Word Summary_8 = (MR_Word) ((MR_Word) (ModuleDepInfo_3));
  ...
  MR_Word * X_4)
{
  if (((MR_tag((MR_Word) ModuleDepInfo_3)) == (MR_Integer) 1))
  {
    ...
    parse_tree__module_imports__aug_compilation_unit_get_int_imp_deps_3_p_0(AugCompUnit_6, X_4, &Var_7);
  }
  else
  {
    MR_Word Summary_8 = (MR_Word) ((MR_Word) (ModuleDepInfo_3));
  ...
  MR_Word * X_4)
{
  ...
  {
    MR_Word BurdenedAugCompUnit_5 = ((MR_Word) ((MR_hl_field(MR_mktag(1), ModuleDepInfo_3, (MR_Integer) 0))));
    MR_Word Baggage_6 = ((MR_Word) ((MR_hl_field(MR_mktag(0), BurdenedAugCompUnit_5, (MR_Integer) 0))));
  ...
  MR_Word * X_4)
{
  if (((MR_tag((MR_Word) ModuleDepInfo_3)) == (MR_Integer) 1))
  {
    ...
    MR_Word AugCompUnit_6 = ((MR_Word) ((MR_hl_field(MR_mktag(0), BurdenedAugCompUnit_5, (MR_Integer) 1))));
    MR_Word ParseTreeModuleSrc_7 = ((MR_Word) ((MR_hl_field(MR_mktag(0), AugCompUnit_6, (MR_Integer) 0))));
    MR_Word IncludeMap_8 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ParseTreeModuleSrc_7, (MR_Integer) 4))));

    *X_4 = mercury__map__keys_as_set_1_f_0((MR_Word) (&mdbcomp__sym_name__mdbcomp__sym_name__type_ctor_info_sym_name_0), (MR_Word) (&parse_tree__prog_item__parse_tree__prog_item__type_ctor_info_include_module_info_0), IncludeMap_8);
  }
  else
  {
    MR_Word Summary_9 = (MR_Word) ((MR_Word) (ModuleDepInfo_3));

    *X_4 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Summary_9, (MR_Integer) 4))));
  }
}
  ...
  MR_Word * X_4)
{
  if (((MR_tag((MR_Word) ModuleDepInfo_3)) == (MR_Integer) 1))
  {
    ...
    *X_4 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ParseTreeModuleSrc_7, (MR_Integer) 0))));
  }
  else
  {
    MR_Word Summary_8 = (MR_Word) ((MR_Word) (ModuleDepInfo_3));

    *X_4 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Summary_8, (MR_Integer) 3))));
  }
}
