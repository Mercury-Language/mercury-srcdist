    ...
    if (succeeded)
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            TypeInfo__33_33 = (MR_Word) (&parse_tree__module_dep_info_scalar_common_1[0]);
            ...
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                TypeInfo__35_35 = (MR_Word) (&parse_tree__module_dep_info_scalar_common_1[0]);
                succeeded = mercury__builtin__unify_2_p_0(TypeInfo__35_35, ((MR_Box) (ArgX7_15)), ((MR_Box) (ArgY7_16)));
                if (succeeded)
                {
                  TypeInfo__36_36 = (MR_Word) (&parse_tree__module_dep_info_scalar_common_1[0]);
                  succeeded = mercury__builtin__unify_2_p_0(TypeInfo__36_36, ((MR_Box) (ArgX8_17)), ((MR_Box) (ArgY8_18)));
                  if (succeeded)
                  {
                    TypeInfo__37_37 = (MR_Word) (&parse_tree__module_dep_info_scalar_common_1[1]);
                    succeeded = mercury__builtin__unify_2_p_0(TypeInfo__37_37, ((MR_Box) (ArgX9_19)), ((MR_Box) (ArgY9_20)));
                    if (succeeded)
                    {
                      TypeInfo__38_38 = (MR_Word) (&parse_tree__module_dep_info_scalar_common_1[2]);
                      succeeded = mercury__builtin__unify_2_p_0(TypeInfo__38_38, ((MR_Box) (ArgX10_21)), ((MR_Box) (ArgY10_22)));
                      if (succeeded)
                      {
                        TypeInfo__39_39 = (MR_Word) (&parse_tree__module_dep_info_scalar_common_1[3]);
                        succeeded = mercury__builtin__unify_2_p_0(TypeInfo__39_39, ((MR_Box) (ArgX11_23)), ((MR_Box) (ArgY11_24)));
                        if (succeeded)
                        {
  ...
  MR_Word * X_4)
{
  ...
  {
    MR_Word BurdenedModule_5 = ((MR_Word) ((MR_hl_field(MR_mktag(1), ModuleDepInfo_3, (MR_Integer) 0))));
    MR_Word ParseTreeModuleSrc_6 = ((MR_Word) ((MR_hl_field(MR_mktag(0), BurdenedModule_5, (MR_Integer) 1))));
  ...
  MR_Word * X_4)
{
  ...
  {
    MR_Word BurdenedModule_5 = ((MR_Word) ((MR_hl_field(MR_mktag(1), ModuleDepInfo_3, (MR_Integer) 0))));
    MR_Word Baggage_6 = ((MR_Word) ((MR_hl_field(MR_mktag(0), BurdenedModule_5, (MR_Integer) 0))));
  ...
  MR_Word * X_4)
{
  if (((MR_tag((MR_Word) ModuleDepInfo_3)) == (MR_Integer) 1))
  {
    MR_Word BurdenedModule_5 = ((MR_Word) ((MR_hl_field(MR_mktag(1), ModuleDepInfo_3, (MR_Integer) 0))));
    MR_Word ParseTreeModuleSrc_6 = ((MR_Word) ((MR_hl_field(MR_mktag(0), BurdenedModule_5, (MR_Integer) 1))));
    MR_Word IncludeMap_7 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ParseTreeModuleSrc_6, (MR_Integer) 4))));
  ...
  MR_Word * X_4)
{
  if (((MR_tag((MR_Word) ModuleDepInfo_3)) == (MR_Integer) 1))
  {
    ...
    *X_4 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ParseTreeModuleSrc_6, (MR_Integer) 0))));
  }
  else
  {
    MR_Word Summary_7 = (MR_Word) ((MR_Word) (ModuleDepInfo_3));
