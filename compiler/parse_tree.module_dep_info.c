  ...
  MR_Word HeadVar__3_3)
{
  ...
  if (((MR_tag((MR_Word) HeadVar__2_2)) == (MR_Integer) 1))
  {
    ...
    if (((MR_tag((MR_Word) HeadVar__3_3)) == (MR_Integer) 1))
    {
      ...
      parse_tree__module_imports____Compare____burdened_module_0_0(HeadVar__1_1, Var_16, ArgY1_5);
    }
    else
  ...
  MR_Word HeadVar__2_2)
{
  ...
  if (((MR_tag((MR_Word) HeadVar__1_1)) == (MR_Integer) 1))
  {
    ...
    if (succeeded)
    {
      ...
      succeeded = parse_tree__module_imports____Unify____burdened_module_0_0(ArgX1_3, ArgY1_4);
    }
  }
  else
  {
  ...
  MR_Word * X_4)
{
  if (((MR_tag((MR_Word) ModuleDepInfo_3)) == (MR_Integer) 1))
  {
    ...
    parse_tree__module_imports__parse_tree_module_src_get_int_imp_deps_3_p_0(ParseTreeModuleSrc_6, &Var_7, X_4);
  }
  else
  {
  ...
  MR_Word * X_4)
{
  if (((MR_tag((MR_Word) ModuleDepInfo_3)) == (MR_Integer) 1))
  {
    ...
    parse_tree__module_imports__parse_tree_module_src_get_int_imp_deps_3_p_0(ParseTreeModuleSrc_6, X_4, &Var_7);
  }
  else
  {
    MR_Word Summary_8 = (MR_Word) ((MR_Word) (ModuleDepInfo_3));
