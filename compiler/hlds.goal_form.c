...
MR_decl_label10(fn__hlds__goal_form__goal_can_loop_func_2_0, 173,64,3,7,10,9,13,14,8,4)
MR_decl_label10(fn__hlds__goal_form__goal_can_loop_func_2_0, 18,23,26,25,24,21,32,30,34,38)
MR_decl_label10(fn__hlds__goal_form__goal_can_loop_func_2_0, 37,41,40,36,46,105,49,48,57,58)
...
MR_BEGIN_MODULE(hlds__goal_form_module6)
	...
	MR_init_label10(fn__hlds__goal_form__goal_can_loop_func_2_0,173,64,3,7,10,9,13,14,8,4)
	MR_init_label10(fn__hlds__goal_form__goal_can_loop_func_2_0,18,23,26,25,24,21,32,30,34,38)
	MR_init_label10(fn__hlds__goal_form__goal_can_loop_func_2_0,37,41,40,36,46,105,49,48,57,58)
...
MR_def_label(fn__hlds__goal_form__goal_can_loop_func_2_0,3)
	...
	if (MR_LTAGS_TEST(MR_r1,0,0)) {
		MR_GOTO_LAB(fn__hlds__goal_form__goal_can_loop_func_2_0_i64);
	}
	MR_r1 = MR_tfield(1, MR_r1, 0);
