...
MR_decl_label10(hlds__goal_form__count_recursive_calls_5_0, 122,3,5,8,10,13,14,15,16,12)
MR_decl_label10(hlds__goal_form__count_recursive_calls_5_0, 22,19,18,30,32,33,34,35,28,36)
MR_decl_label2(hlds__goal_form__count_recursive_calls_5_0, 26,39)
...
MR_BEGIN_MODULE(hlds__goal_form_module36)
	...
	MR_init_label10(hlds__goal_form__count_recursive_calls_5_0,122,3,5,8,10,13,14,15,16,12)
	MR_init_label10(hlds__goal_form__count_recursive_calls_5_0,22,19,18,30,32,33,34,35,28,36)
	MR_init_label2(hlds__goal_form__count_recursive_calls_5_0,26,39)
MR_BEGIN_CODE
...
MR_def_label(hlds__goal_form__count_recursive_calls_5_0,122)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	while (1) {
	{
	MR_Word MR_tempr1;
...
MR_def_label(hlds__goal_form__count_recursive_calls_5_0,3)
	...
	if ((MR_r2 != MR_tempr1)) {
		MR_GOTO_LAB(hlds__goal_form__count_recursive_calls_5_0_i39);
	}
...
MR_def_label(hlds__goal_form__count_recursive_calls_5_0,12)
	...
	MR_r4 = MR_tfield(3, MR_tempr1, 2);
	if (MR_INT_NE(MR_r4,1)) {
		MR_GOTO_LAB(hlds__goal_form__count_recursive_calls_5_0_i22);
	}
	MR_sv(4) = MR_r2;
	MR_sv(5) = MR_r3;
	MR_r1 = MR_r5;
...
MR_def_label(hlds__goal_form__count_recursive_calls_5_0,22)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	if (MR_INT_NE(MR_r4,2)) {
		MR_GOTO_LAB(hlds__goal_form__count_recursive_calls_5_0_i19);
	}
...
MR_def_label(hlds__goal_form__count_recursive_calls_5_0,19)
	...
	MR_r1 = MR_r5;
	MR_succip_word = MR_sv(6);
	MR_GOTO_LAB(hlds__goal_form__count_recursive_calls_5_0_i122);
...
MR_def_label(hlds__goal_form__count_recursive_calls_5_0,28)
	...
	if (MR_PTAG_TESTR(MR_r5,2)) {
		MR_GOTO_LAB(hlds__goal_form__count_recursive_calls_5_0_i36);
	}
...
MR_def_label(hlds__goal_form__count_recursive_calls_5_0,39)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Integer) 0;
	MR_r2 = (MR_Integer) 0;
	MR_decr_sp_and_return(6);
