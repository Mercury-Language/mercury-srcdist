                ...
                case (MR_Integer) 1:
                  {
                    ...
                    if ((Goals_85 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
                    {
                      /* direct tailcall eliminated */
                      {
                        MR_Word next_value_of_Goal_6 = Goal_84;
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      /* direct tailcall eliminated */
      {
        ...
        MR_Integer next_value_of_HeadVar__4_4 = Min2_22;
        MR_Integer next_value_of_HeadVar__5_5 = Max2_23;
  ...
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        /* direct tailcall eliminated */
        {
          MR_Word next_value_of_HeadVar__1_1 = Cases_5;
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          ...
          if (succeeded)
          {
            /* direct tailcall eliminated */
            {
              MR_Word next_value_of_HeadVar__2_2 = Disjuncts_6;
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        /* direct tailcall eliminated */
        {
          ...
          MR_Word next_value_of_STATE_VARIABLE_ToAssignVars_0_2 = STATE_VARIABLE_ToAssignVars_29_29;
