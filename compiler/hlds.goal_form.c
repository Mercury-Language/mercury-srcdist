          ...
          case (MR_Integer) 7:
            {
              ...
              switch (MR_tag((MR_Word) ShortHand_58)) {
                ...
                case (MR_Integer) 1:
                  {
                    MR_Word Goal_82 = ((MR_Word) ((MR_hl_field(MR_mktag(1), ShortHand_58, (MR_Integer) 4))));
                    MR_Word Goals_83 = ((MR_Word) ((MR_hl_field(MR_mktag(1), ShortHand_58, (MR_Integer) 5))));
    ...
    switch (MR_tag((MR_Word) GoalExpr_7)) {
      ...
      case (MR_Integer) 3:
        switch (((MR_Integer) ((MR_hl_field(MR_mktag(3), GoalExpr_7, (MR_Integer) 0))))) {
          ...
          case (MR_Integer) 2:
            {
              MR_Word Var_100 = ((MR_Word) ((MR_hl_field(MR_mktag(3), GoalExpr_7, (MR_Integer) 2))));
              MR_Word Var_101 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(3), GoalExpr_7, (MR_Integer) 1))) & (MR_Integer) 1);
              ...
              switch (Var_101) {
                ...
                case (MR_Integer) 1:
                  ...
                  break;
                case (MR_Integer) 0:
                  CanLoop_6 = hlds__goal_form__goal_list_can_loop_2_f_0(MaybeModuleInfo_4, Var_100);
                  break;
              }
            }
            break;
