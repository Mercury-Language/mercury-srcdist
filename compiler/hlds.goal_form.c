  ...
  *GoalInfo_10 = ((MR_Word) ((MR_hl_field(MR_mktag(0), Goal_7, (MR_Integer) 1))));
  ...
  if ((NonLocalList_13 == (MR_Word) ((MR_Unsigned) 0U)))
  {
    ...
    *TermVarIsNeeded_8 = (MR_Integer) 0;
    ...
    if (succeeded)
    {
      Var_22 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(3), GoalExpr_11, (MR_Integer) 1))) & (MR_Integer) 1);
        ...
        case (MR_Integer) 2:
          {
            ...
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                ...
                Var_88 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ExceptionInfo_47, (MR_Integer) 0))));
      ...
      case (MR_Integer) 2:
        {
          ...
          if (succeeded)
          {
            ...
            if (succeeded)
            {
              ...
              Var_86 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ExceptionInfo_45, (MR_Integer) 0))));
        ...
        case (MR_Integer) 2:
          {
            ...
            if (succeeded)
            {
              ...
              if (succeeded)
              {
                ...
                Var_85 = ((MR_Word) ((MR_hl_field(MR_mktag(0), ExceptionInfo_44, (MR_Integer) 0))));
        ...
        case (MR_Integer) 2:
          {
...

            {
              ...
              MR_hl_field(MR_mktag(0), Var_91, 0) = ((MR_Box) (PredId_22));
              MR_hl_field(MR_mktag(0), Var_91, 1) = ((MR_Box) (ProcId_23));
            }
      ...
      case (MR_Integer) 2:
        {
          ...
          if (succeeded)
          {
            ...
            hlds__hlds_module__module_info_pred_proc_info_5_p_0(ModuleInfo_40, PredId_34, ProcId_35, &Var_41, &ProcInfo_42);
            {
              ...
              if (succeeded)
              {
                Var_87 = ((MR_Word) ((MR_hl_field(MR_mktag(1), MaybeTermInfo_43, (MR_Integer) 0))));
        ...
        case (MR_Integer) 2:
          {
...

            {
              ...
              MR_hl_field(MR_mktag(0), Var_87, 0) = ((MR_Box) (PredId_18));
              MR_hl_field(MR_mktag(0), Var_87, 1) = ((MR_Box) (ProcId_19));
            }
            ...
            case (MR_Integer) 6:
              {
...

                {
                  ...
                  MR_hl_field(MR_mktag(1), Var_85, 0) = ((MR_Box) (ElseGoal_17));
                ...
                }
                {
                  ...
                  MR_hl_field(MR_mktag(1), Goals_98, 1) = ((MR_Box) (Var_85));
                }
