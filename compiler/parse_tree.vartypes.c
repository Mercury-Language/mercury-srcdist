...
static const MR_FA_TypeInfo_Struct1 parse_tree__vartypes__varset__ti_varset_1parse_tree__prog_data__type_ctor_info_tvar_type_0;
...
static const MR_PseudoTypeInfo parse_tree__vartypes__parse_tree__vartypes__field_types_maybe_vartypes_0_0[2];

static const MR_DuFunctorDesc parse_tree__vartypes__parse_tree__vartypes__du_functor_desc_maybe_vartypes_0_0;

static const MR_DuFunctorDesc parse_tree__vartypes__parse_tree__vartypes__du_functor_desc_maybe_vartypes_0_1;

static const MR_DuFunctorDescPtr parse_tree__vartypes__parse_tree__vartypes__du_stag_ordered_maybe_vartypes_0_0[1];

static const MR_DuFunctorDescPtr parse_tree__vartypes__parse_tree__vartypes__du_stag_ordered_maybe_vartypes_0_1[1];

static const MR_DuPtagLayout parse_tree__vartypes__parse_tree__vartypes__du_ptag_ordered_maybe_vartypes_0[2];

static const MR_DuFunctorDescPtr parse_tree__vartypes__parse_tree__vartypes__du_name_ordered_maybe_vartypes_0[2];

static const MR_Integer parse_tree__vartypes__parse_tree__vartypes__functor_number_map_maybe_vartypes_0[2];
...
parse_tree__vartypes____Unify____maybe_vartypes_0_0_10001(
  MR_Box wrapper_arg_1,
  MR_Box wrapper_arg_2);

static void MR_CALL 
parse_tree__vartypes____Compare____maybe_vartypes_0_0_10001(
  MR_Box * wrapper_arg_1,
  MR_Box wrapper_arg_2,
...
static /* final */ const MR_Box parse_tree__vartypes_scalar_common_1[3][2];
...
static const MR_PseudoTypeInfo parse_tree__vartypes__parse_tree__vartypes__field_types_maybe_vartypes_0_0[2] = {
  (MR_PseudoTypeInfo) (&parse_tree__vartypes__varset__ti_varset_1parse_tree__prog_data__type_ctor_info_tvar_type_0),
...
static const MR_DuFunctorDesc parse_tree__vartypes__parse_tree__vartypes__du_functor_desc_maybe_vartypes_0_0 = {
  ...
  (MR_Integer) -1,
  INT32_C(0),
  parse_tree__vartypes__parse_tree__vartypes__field_types_maybe_vartypes_0_0,
  NULL,
  NULL,
  NULL,
...
static const MR_DuFunctorDescPtr parse_tree__vartypes__parse_tree__vartypes__du_stag_ordered_maybe_vartypes_0_0[1] = {
  &parse_tree__vartypes__parse_tree__vartypes__du_functor_desc_maybe_vartypes_0_1
};

static const MR_DuFunctorDescPtr parse_tree__vartypes__parse_tree__vartypes__du_stag_ordered_maybe_vartypes_0_1[1] = {
  &parse_tree__vartypes__parse_tree__vartypes__du_functor_desc_maybe_vartypes_0_0
};
...
static const MR_DuPtagLayout parse_tree__vartypes__parse_tree__vartypes__du_ptag_ordered_maybe_vartypes_0[2] = {
  {
    UINT32_C(1),
    MR_SECTAG_LOCAL_REST_OF_WORD,
    parse_tree__vartypes__parse_tree__vartypes__du_stag_ordered_maybe_vartypes_0_0,
    INT8_C(-1),
    UINT8_C(0),
    UINT8_C(1)
  },
  {
    UINT32_C(1),
    MR_SECTAG_NONE,
    parse_tree__vartypes__parse_tree__vartypes__du_stag_ordered_maybe_vartypes_0_1,
    INT8_C(-1),
    UINT8_C(1),
    UINT8_C(1)
  }
...
const MR_TypeCtorInfo_Struct parse_tree__vartypes__parse_tree__vartypes__type_ctor_info_maybe_vartypes_0 = {
  (MR_Integer) 0,
  UINT8_C(18),
  INT8_C(2),
  MR_TYPECTOR_REP_DU,
  ((MR_Box) (parse_tree__vartypes____Unify____maybe_vartypes_0_0_10001)),
  ((MR_Box) (parse_tree__vartypes____Compare____maybe_vartypes_0_0_10001)),
  (MR_String) "parse_tree.vartypes",
  (MR_String) "maybe_vartypes",
  { parse_tree__vartypes__parse_tree__vartypes__du_name_ordered_maybe_vartypes_0 },
  { parse_tree__vartypes__parse_tree__vartypes__du_ptag_ordered_maybe_vartypes_0 },
  (MR_Integer) 2,
  UINT16_C(12),
  parse_tree__vartypes__parse_tree__vartypes__functor_number_map_maybe_vartypes_0,
...
static const MR_DuFunctorDescPtr parse_tree__vartypes__parse_tree__vartypes__du_stag_ordered_prog_var_set_types_0_0[1] = {
  &parse_tree__vartypes__parse_tree__vartypes__du_functor_desc_prog_var_set_types_0_0
};
  ...
  MR_Word HeadVar__3_3)
{
  ...
  else
  {
    ...
    mercury__builtin__compare_3_p_0((MR_Word) (&parse_tree__vartypes_scalar_common_1[2]), &SubResult1_6, ((MR_Box) (ArgX1_4)), ((MR_Box) (ArgY1_5)));
  ...
  MR_Word HeadVar__2_2)
{
  ...
  else
  {
    ...
    succeeded = mercury__builtin__unify_2_p_0((MR_Word) (&parse_tree__vartypes_scalar_common_1[2]), ((MR_Box) (ArgX1_3)), ((MR_Box) (ArgY1_4)));
    if (succeeded)
    {
      TypeInfo__10_10 = (MR_Word) (&parse_tree__vartypes_scalar_common_2[0]);
...
void MR_CALL 
parse_tree__vartypes____Compare____maybe_vartypes_0_0(
  MR_Word * HeadVar__1_1,
  MR_Word HeadVar__2_2,
  MR_Word HeadVar__3_3)
{
  ...
  else
  {
    ...
    else
    {
      ...
      mercury__builtin__compare_3_p_0((MR_Word) (&parse_tree__vartypes_scalar_common_1[1]), &SubResult1_6, ((MR_Box) (Var_18)), ((MR_Box) (ArgY1_5)));
      succeeded = (SubResult1_6 != (MR_Integer) 0);
      if (succeeded)
        *HeadVar__1_1 = SubResult1_6;
      else
        mercury__builtin__compare_3_p_0((MR_Word) (&parse_tree__vartypes_scalar_common_2[0]), HeadVar__1_1, ((MR_Box) (Var_17)), ((MR_Box) (ArgY2_8)));
    }
  }
}

MR_bool MR_CALL 
parse_tree__vartypes____Unify____maybe_vartypes_0_0(
  MR_Word HeadVar__1_1,
  MR_Word HeadVar__2_2)
{
  MR_bool succeeded;
  ...
  else
  {
    ...
    if (succeeded)
    {
      ...
      TypeInfo__11_11 = (MR_Word) (&parse_tree__vartypes_scalar_common_1[1]);
      succeeded = mercury__builtin__unify_2_p_0(TypeInfo__11_11, ((MR_Box) (ArgX1_3)), ((MR_Box) (ArgY1_4)));
      if (succeeded)
      {
        TypeInfo__12_12 = (MR_Word) (&parse_tree__vartypes_scalar_common_2[0]);
...
{
  mercury__map__foldl_values_4_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0), TypeInfo_for_T_11, (MR_Word) (&parse_tree__vartypes_scalar_common_1[0]), Pred_5, VarTypes_6, STATE_VARIABLE_Acc_0_8, STATE_VARIABLE_Acc_9);
}
  ...
  MR_Box * wrapper_arg_2)
{
  ...
  parse_tree__prog_type_subst__apply_rec_subst_to_type_3_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) (wrapper_arg_1)), &conv0_HeadVar__3_3);
  ...
  MR_Word * STATE_VARIABLE_VarTypes_7)
{
...

  {
    ...
    MR_hl_field(MR_mktag(0), Var_8, 0) = ((MR_Box) (&parse_tree__vartypes_scalar_common_3[1]));
    MR_hl_field(MR_mktag(0), Var_8, 1) = ((MR_Box) (parse_tree__vartypes__apply_rec_subst_to_vartypes_3_p_0_1));
  ...
  MR_Box * wrapper_arg_2)
{
  ...
  parse_tree__prog_type_subst__apply_subst_to_type_3_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) (wrapper_arg_1)), &conv0_HeadVar__3_3);
  *wrapper_arg_2 = ((MR_Box) (conv0_HeadVar__3_3));
}
  ...
  MR_Word * STATE_VARIABLE_VarTypes_7)
{
...

  {
    Var_8 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(MR_mktag(0), Var_8, 0) = ((MR_Box) (&parse_tree__vartypes_scalar_common_3[1]));
    MR_hl_field(MR_mktag(0), Var_8, 1) = ((MR_Box) (parse_tree__vartypes__apply_subst_to_vartypes_3_p_0_1));
    MR_hl_field(MR_mktag(0), Var_8, 2) = ((MR_Box) ((MR_Integer) 1));
    MR_hl_field(MR_mktag(0), Var_8, 3) = ((MR_Box) (Subst_4));
  }
  mercury__map__map_values_only_3_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0), (MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0), (MR_Word) (&parse_tree__vartypes_scalar_common_1[0]), Var_8, STATE_VARIABLE_VarTypes_0_6, STATE_VARIABLE_VarTypes_7);
  ...
  MR_Box * wrapper_arg_2)
{
  ...
  parse_tree__prog_type_subst__apply_variable_renaming_to_type_3_p_0(((MR_Word) ((MR_hl_field(MR_mktag(0), closure, (MR_Integer) 3)))), ((MR_Word) (wrapper_arg_1)), &conv0_HeadVar__3_3);
  *wrapper_arg_2 = ((MR_Box) (conv0_HeadVar__3_3));
}
  ...
  MR_Word * STATE_VARIABLE_VarTypes_7)
{
  ...
  {
    Var_8 = (MR_Word) MR_new_object(MR_Word, (4 * sizeof(MR_Word)), NULL, NULL);
    MR_hl_field(MR_mktag(0), Var_8, 0) = ((MR_Box) (&parse_tree__vartypes_scalar_common_3[0]));
    MR_hl_field(MR_mktag(0), Var_8, 1) = ((MR_Box) (parse_tree__vartypes__apply_variable_renaming_to_vartypes_3_p_0_1));
    MR_hl_field(MR_mktag(0), Var_8, 2) = ((MR_Box) ((MR_Integer) 1));
  ...
  MR_Box wrapper_arg_2)
{
  ...
  succeeded = parse_tree__vartypes____Unify____maybe_vartypes_0_0(((MR_Word) (wrapper_arg_1)), ((MR_Word) (wrapper_arg_2)));
  return succeeded;
}
  ...
  MR_Box wrapper_arg_3)
{
  ...
  parse_tree__vartypes____Compare____maybe_vartypes_0_0(&conv0_HeadVar__1_1, ((MR_Word) (wrapper_arg_2)), ((MR_Word) (wrapper_arg_3)));
...
void mercury__parse_tree__vartypes__init_type_tables(void)
{
	...
	MR_register_type_ctor_info(&parse_tree__vartypes__parse_tree__vartypes__type_ctor_info_maybe_vartypes_0);
