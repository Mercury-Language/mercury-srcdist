  ...
  MR_Word FunctionDefn_12)
{
  ...
  Var_76 = ((((MR_Unsigned) ((MR_hl_field(0, Info_8, (MR_Integer) 1))) >> 1)) & (MR_Integer) 1);
  if ((MaybeBody_19 == (MR_Word) ((MR_Unsigned) 0U)))
  {
    MR_String FuncNameStr_22;

    ml_backend__mlds_to_java_util__indent_line_after_context_7_p_0(Stream_9, Var_76, (MR_Integer) 2, Context_15, Indent_10);
  ...
  {
    MR_Word Access_83;
    MR_Word PerInstance_84;

    ml_backend__mlds_to_java_util__indent_line_after_context_7_p_0(Stream_9, Var_76, (MR_Integer) 2, Context_15, Indent_10);
    Access_83 = ((((MR_Unsigned) ((MR_hl_field(0, Flags_16, (MR_Integer) 0))) >> 1)) & (MR_Integer) 1);
    PerInstance_84 = ((MR_Unsigned) ((MR_hl_field(0, Flags_16, (MR_Integer) 0))) & (MR_Integer) 1);
    switch (Access_83) {
    ...
    if (!((MaybePredProcId_17 == (MR_Word) ((MR_Unsigned) 0U))))
    {
      ...
      MR_Word Var_40 = ((((MR_Unsigned) ((MR_hl_field(0, Info_8, (MR_Integer) 1))) >> 2)) & (MR_Integer) 1);

      ml_backend__mlds_to_target_util__maybe_output_pred_proc_id_comment_5_p_0(Stream_9, Var_40, PredProcid_24);
    }
