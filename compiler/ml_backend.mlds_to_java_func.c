  ...
  MR_Word Signature_14)
{
  ...
  else
  {
    ...
    {
      MR_Word Var_43 = ((MR_Word) ((MR_hl_field(MR_mktag(1), RetTypes_17, (MR_Integer) 1))));
      MR_Word Var_44 = ((MR_Word) ((MR_hl_field(MR_mktag(1), RetTypes_17, (MR_Integer) 0))));

      if ((Var_43 == (MR_Word) ((MR_Unsigned) 0U)))
        ml_backend__mlds_to_java_type__output_type_for_java_5_p_0(Info_9, Var_44, Stream_10);
      else
