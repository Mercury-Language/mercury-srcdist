  ...
  MR_Word Stream_10)
{
  ...
  ml_backend__mlds_to_java_type__output_type_for_java_5_p_0(Info_7, Stream_10, Type_13);
  ...
  else
  {
    ...
    else
    {
      ...
      if ((Var_35 == (MR_Word) ((MR_Unsigned) 0U)))
        ml_backend__mlds_to_java_type__output_type_for_java_5_p_0(Info_9, Stream_10, Var_36);
      else
