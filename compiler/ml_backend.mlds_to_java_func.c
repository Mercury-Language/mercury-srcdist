  ...
  MR_Word FunctionDefn_12)
{
  ...
  else
  {
    ...
    ml_backend__mlds_to_java_util__indent_line_after_context_7_p_0(Stream_9, Var_74, (MR_Integer) 2, Context_15, Indent_10);
    Access_77 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Flags_16, (MR_Integer) 0))) >> 1)) & (MR_Integer) 1);
    PerInstance_78 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Flags_16, (MR_Integer) 0))) & (MR_Integer) 1);
    switch (Access_77) {
