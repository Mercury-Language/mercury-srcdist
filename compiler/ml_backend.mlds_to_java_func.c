  ...
  MR_Word FunctionDefn_12)
{
  ...
  {
    MR_Word Access_78;
    MR_Word PerInstance_79;

    ml_backend__mlds_to_java_util__indent_line_after_context_7_p_0(Stream_9, Var_75, (MR_Integer) 2, Context_15, Indent_10);
    Access_78 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Flags_16, (MR_Integer) 0))) >> 1)) & (MR_Integer) 1);
    PerInstance_79 = ((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Flags_16, (MR_Integer) 0))) & (MR_Integer) 1);
    switch (Access_78) {
  ...
  MR_Word Signature_14)
{
  ...
  else
  {
    ...
    {
      MR_Word Var_35 = ((MR_Word) ((MR_hl_field(MR_mktag(1), RetTypes_17, (MR_Integer) 1))));
      MR_Word Var_36 = ((MR_Word) ((MR_hl_field(MR_mktag(1), RetTypes_17, (MR_Integer) 0))));
