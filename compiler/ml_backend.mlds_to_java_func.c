...
ml_backend__mlds_to_java_func__output_param_6_p_0(
  ...
  MR_Word Stream_10)
{
  MR_Word VarName_12 = ((MR_Word) ((MR_hl_field(0, Arg_9, 0))));
  MR_Word Type_13 = ((MR_Word) ((MR_hl_field(0, Arg_9, 1))));
  ...
  MR_Word FunctionDefn_12)
{
  ...
  FuncName_14 = ((MR_Word) ((MR_hl_field(0, FunctionDefn_12, 0))));
  Context_15 = ((MR_Word) ((MR_hl_field(0, FunctionDefn_12, 1))));
  Flags_16 = ((MR_Word) ((MR_hl_field(0, FunctionDefn_12, 2))));
  Params_18 = ((MR_Word) ((MR_hl_field(0, FunctionDefn_12, 4))));
  MaybeBody_19 = ((MR_Word) ((MR_hl_field(0, FunctionDefn_12, 5))));
  if ((MaybeBody_19 == (MR_Word) ((MR_Unsigned) 0U)))
  {
    MR_String FuncNameStr_22;
    MR_Word Var_28 = ((((MR_Unsigned) ((MR_hl_field(0, Info_8, 1))) >> 1)) & (MR_Integer) 1);
  ...
  else
  {
    ...
    Var_40 = ((((MR_Unsigned) ((MR_hl_field(0, Info_8, 1))) >> 1)) & (MR_Integer) 1);
    ml_backend__mlds_to_java_util__indent_line_after_context_7_p_0(Stream_9, Var_40, (MR_Integer) 2, Context_15, Indent_10);
    Access_75 = ((((MR_Unsigned) ((MR_hl_field(0, Flags_16, 0))) >> 1)) & (MR_Integer) 1);
    PerInstance_76 = ((MR_Unsigned) ((MR_hl_field(0, Flags_16, 0))) & (MR_Integer) 1);
    switch (Access_75) {
  ...
  MR_Word MaybeBody_18)
{
  ...
  if (!((MaybeBody_18 == (MR_Word) ((MR_Unsigned) 0U))))
  {
    ...
    else
    {
      ...
      Var_42 = ((((MR_Unsigned) ((MR_hl_field(0, Info_11, 1))) >> 1)) & (MR_Integer) 1);
  ...
  MR_Word Signature_14)
{
  ...
  MR_Word Parameters_16 = ((MR_Word) ((MR_hl_field(0, Signature_14, 0))));
  MR_Word RetTypes_17 = ((MR_Word) ((MR_hl_field(0, Signature_14, 1))));
  ...
  if (succeeded)
  {
    ClassName_18 = ((MR_String) ((MR_hl_field(1, OutputAux_13, 0))));
    ClassArity_19 = ((MR_Integer) ((MR_hl_field(1, OutputAux_13, 1))));
    succeeded = ((MR_tag((MR_Word) FuncName_12)) == (MR_Integer) 1);
    if (succeeded)
    {
      Var_25 = ((MR_String) ((MR_hl_field(1, FuncName_12, 0))));
  ...
  else
  {
    ...
    {
      MR_Word Var_46 = ((MR_Word) ((MR_hl_field(1, RetTypes_17, 1))));
      MR_Word Var_47 = ((MR_Word) ((MR_hl_field(1, RetTypes_17, 0))));
  ...
  MR_Box * wrapper_arg_4)
{
  ...
  ml_backend__mlds_to_java_func__output_param_6_p_0(((MR_Word) ((MR_hl_field(0, closure, 3)))), ((MR_String) ((MR_hl_field(0, closure, 4)))), ((MR_Word) (wrapper_arg_1)), ((MR_Word) (wrapper_arg_2)));
}
