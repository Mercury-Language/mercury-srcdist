...
{
  {
    ...
    Name_12 = ((MR_Word) ((MR_hl_field(MR_mktag(0), FunctionDefn_10, (MR_Integer) 0))));
...
{
  {
    ...
    if (!((MaybeBody_16 == (MR_Word) ((MR_Unsigned) 0U))))
    {
      ...
      MR_Word FuncInfo_19 = (MR_Word) (Signature_15);

      succeeded = ((MR_tag((MR_Word) Body_18)) == (MR_Integer) 0);
      if (succeeded)
      {
        MR_Word _ExitMethods_24;

        ml_backend__mlds_to_java_stmt__output_statement_for_java_7_p_0(Info_10, Indent_11, FuncInfo_19, Body_18, &_ExitMethods_24);
      }
      else
      {
        MR_Integer Var_33;
        MR_Word Var_36;
        MR_Word _ExitMethods_41;

        mercury__io__write_string_3_p_0((MR_String) "{\n");
        Var_33 = (MR_Integer) ((MR_Unsigned) Indent_11 + (MR_Unsigned) 1);
        ml_backend__mlds_to_java_stmt__output_statement_for_java_7_p_0(Info_10, Var_33, FuncInfo_19, Body_18, &_ExitMethods_41);
        Var_36 = ((((MR_Unsigned) ((MR_hl_field(MR_mktag(0), Info_10, (MR_Integer) 1))) >> 1)) & (MR_Integer) 1);
        ml_backend__mlds_to_java_util__indent_line_after_context_6_p_0(Var_36, (MR_Integer) 2, Context_14, Indent_11);
        mercury__io__write_string_3_p_0((MR_String) "}\n");
      }
    }
  }
