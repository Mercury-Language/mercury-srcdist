  ...
  MR_Word FunctionDefn_12)
{
  ...
  if ((MaybeBody_19 == (MR_Word) ((MR_Unsigned) 0U)))
  {
    ...
    MR_Word Var_29 = ((((MR_Unsigned) ((MR_hl_field(0, Info_8, (MR_Integer) 1))) >> 1)) & (MR_Integer) 1);

    ml_backend__mlds_to_java_util__indent_line_after_context_7_p_0(Stream_9, Var_29, (MR_Integer) 2, Context_15, Indent_10);
  ...
  else
  {
    ...
    if (!((MaybePredProcId_17 == (MR_Word) ((MR_Unsigned) 0U))))
    {
      ...
      Var_37 = ((((MR_Unsigned) ((MR_hl_field(0, Info_8, (MR_Integer) 1))) >> 2)) & (MR_Integer) 1);
      ml_backend__mlds_to_target_util__maybe_output_pred_proc_id_comment_6_p_0(Stream_9, Var_37, IndentStr_25, PredProcid_24);
    }
    Var_39 = ((((MR_Unsigned) ((MR_hl_field(0, Info_8, (MR_Integer) 1))) >> 1)) & (MR_Integer) 1);
    ml_backend__mlds_to_java_util__indent_line_after_context_7_p_0(Stream_9, Var_39, (MR_Integer) 2, Context_15, Indent_10);
    Access_74 = ((((MR_Unsigned) ((MR_hl_field(0, Flags_16, (MR_Integer) 0))) >> 1)) & (MR_Integer) 1);
    PerInstance_75 = ((MR_Unsigned) ((MR_hl_field(0, Flags_16, (MR_Integer) 0))) & (MR_Integer) 1);
    switch (Access_74) {
  ...
  MR_Word MaybeBody_18)
{
  ...
  if (!((MaybeBody_18 == (MR_Word) ((MR_Unsigned) 0U))))
  {
    ...
    else
    {
      ...
      mercury__io__write_string_4_p_0(Stream_12, (MR_String) "{\n");
      Var_39 = (MR_Integer) ((MR_Unsigned) Indent_13 + (MR_Unsigned) 1);
  ...
  MR_Word Parameters_10)
{
  ...
  if (!((Parameters_10 == (MR_Word) ((MR_Unsigned) 0U))))
  {
    ...
    parse_tree__parse_tree_out_info__write_out_list_6_p_0((MR_Word) (&ml_backend__mlds__ml_backend__mlds__type_ctor_info_mlds_argument_0), Var_22, (MR_String) ",\n", Parameters_10, Stream_8);
  }
