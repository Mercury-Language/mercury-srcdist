...
static const MR_PseudoTypeInfo check_hlds__switch_candidates__check_hlds__switch_candidates__field_types_candidate_switch_0_0[6];

static const MR_ConstString check_hlds__switch_candidates__check_hlds__switch_candidates__field_names_candidate_switch_0_0[6];

static const MR_DuArgLocn check_hlds__switch_candidates__check_hlds__switch_candidates__field_locns_candidate_switch_0_0[6];
...
static void MR_CALL 
check_hlds__switch_candidates__select_best_candidate_switch_loop_3_p_0(
  MR_Word HeadVar__1_1,
  ...
  MR_Word HeadVar__2_2)
{
  ...
  else
  {
    ...
    if (succeeded)
    {
      TypeInfo_18_18 = (MR_Word) (&check_hlds__switch_candidates_scalar_common_1[1]);
      succeeded = mercury__builtin__unify_2_p_0(TypeInfo_18_18, ((MR_Box) (ArgX2_5)), ((MR_Box) (ArgY2_6)));
      if (succeeded)
      {
        TypeInfo_19_19 = (MR_Word) (&check_hlds__switch_candidates_scalar_common_1[2]);
        succeeded = mercury__builtin__unify_2_p_0(TypeInfo_19_19, ((MR_Box) (ArgX3_7)), ((MR_Box) (ArgY3_8)));
        if (succeeded)
        {
          TypeInfo_20_20 = (MR_Word) (&check_hlds__switch_candidates_scalar_common_1[2]);
...
void MR_CALL 
check_hlds__switch_candidates__select_best_candidate_switch_3_p_0(
  MR_Word FirstCandidate_4,
  MR_Word LaterCandidates_5,
  MR_Word * BestCandidate_6)
{
  if ((LaterCandidates_5 == (MR_Word) ((MR_Unsigned) 0U)))
    *BestCandidate_6 = FirstCandidate_4;
  else
  {
    MR_Word Candidate_12 = ((MR_Word) ((MR_hl_field(1, LaterCandidates_5, 0))));
    MR_Word Candidates_13 = ((MR_Word) ((MR_hl_field(1, LaterCandidates_5, 1))));
    MR_Word Result_14;
    MR_Word Var_17 = ((MR_Word) ((MR_hl_field(0, Candidate_12, 4))));
    MR_Word Var_18 = ((MR_Word) ((MR_hl_field(0, FirstCandidate_4, 4))));
    MR_Word STATE_VARIABLE_BestCandidate_1_19;

    check_hlds__switch_candidates____Compare____candidate_switch_rank_0_0(&Result_14, Var_17, Var_18);
    switch (Result_14) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 1:
        STATE_VARIABLE_BestCandidate_1_19 = FirstCandidate_4;
        break;
      case (MR_Integer) 0:
        STATE_VARIABLE_BestCandidate_1_19 = FirstCandidate_4;
        break;
      case (MR_Integer) 2:
        STATE_VARIABLE_BestCandidate_1_19 = Candidate_12;
        break;
    }
    check_hlds__switch_candidates__select_best_candidate_switch_loop_3_p_0(Candidates_13, STATE_VARIABLE_BestCandidate_1_19, BestCandidate_6);
  }
}
  ...
  MR_Word * STATE_VARIABLE_BestCandidate_3)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      check_hlds__switch_candidates____Compare____candidate_switch_rank_0_0(&Result_10, Var_13, Var_14);
      switch (Result_10) {
        default: /*NOTREACHED*/ MR_assert(0);
        case (MR_Integer) 1:
...
void MR_CALL 
check_hlds__switch_candidates__categorize_candidate_switch_8_p_0(
  ...
  MR_Word * Candidate_16)
{
  MR_bool succeeded;
  MR_Word CanFail_17;
  MR_Word CasesMissing_18;
  MR_Word Cases_19;
  MR_Word UnreachableCaseGoals_20;
  MR_Word Rank_21;
  MR_Word BoundFunctors_30;

  succeeded = hlds__inst_test__inst_is_bound_to_functors_3_p_0(ModuleInfo_9, VarInst0_13, &BoundFunctors_30);
  if (succeeded)
  {
    MR_Word TypeCtor_31;
    MR_Word InstConsIds_32;
    MR_Word InstConsIdSet_33;
    MR_Word CoveredConsIds_36;
    MR_Word UncoveredConsIds_37;
    MR_Word Var_38;

    parse_tree__prog_type__type_to_ctor_det_2_p_0(VarType_12, &TypeCtor_31);
    parse_tree__prog_mode__bound_functors_to_cons_ids_3_p_0(TypeCtor_31, BoundFunctors_30, &InstConsIds_32);
    mercury__set_tree234__list_to_set_2_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_cons_id_0), InstConsIds_32, &InstConsIdSet_33);
    check_hlds__det_util__delete_unreachable_cases_4_p_0(Cases0_14, InstConsIdSet_33, &Cases_19, &UnreachableCaseGoals_20);
    Var_38 = mercury__set_tree234__init_0_f_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_cons_id_0));
    check_hlds__switch_candidates__acc_covered_functors_3_p_0(Cases_19, Var_38, &CoveredConsIds_36);
    mercury__set_tree234__difference_3_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_cons_id_0), InstConsIdSet_33, CoveredConsIds_36, &UncoveredConsIds_37);
    succeeded = mercury__set_tree234__is_empty_1_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_cons_id_0), UncoveredConsIds_37);
    if (succeeded)
    {
      CanFail_17 = (MR_Integer) 1;
      CasesMissing_18 = (MR_Integer) 0;
    }
    else
    {
      CanFail_17 = (MR_Integer) 0;
      CasesMissing_18 = (MR_Integer) 1;
    }
  }
  else
  {
    MR_Integer NumFunctors_34;

    Cases_19 = Cases0_14;
    UnreachableCaseGoals_20 = (MR_Word) ((MR_Unsigned) 0U);
    succeeded = hlds__type_util__switch_type_num_functors_3_p_0(ModuleInfo_9, VarType_12, &NumFunctors_34);
    if (succeeded)
    {
      MR_Integer NumCoveredConsIds_40;

      check_hlds__switch_candidates__count_covered_cons_ids_3_p_0(Cases_19, (MR_Integer) 0, &NumCoveredConsIds_40);
      succeeded = (NumCoveredConsIds_40 == NumFunctors_34);
      if (succeeded)
      {
        CanFail_17 = (MR_Integer) 1;
        CasesMissing_18 = (MR_Integer) 0;
    ...
    {
      CanFail_17 = (MR_Integer) 0;
      CasesMissing_18 = (MR_Integer) 2;
    }
  }
  if ((LeftOver_15 == (MR_Word) ((MR_Unsigned) 0U)))
    if ((Cases_19 == (MR_Word) ((MR_Unsigned) 0U)))
      Rank_21 = (MR_Word) ((MR_Unsigned) 16U);
    else
    {
      MR_Word LaterCases_23 = ((MR_Word) ((MR_hl_field(1, Cases_19, 1))));

      succeeded = (LaterCases_23 == (MR_Word) ((MR_Unsigned) 0U));
      if (succeeded)
        succeeded = (UnreachableCaseGoals_20 == (MR_Word) ((MR_Unsigned) 0U));
      if (succeeded)
        Rank_21 = (MR_Word) ((MR_Unsigned) 4U);
      else
      {
        MR_Word TypeInfo_29_29;
        MR_Word RequiredVar_24;

        succeeded = (MaybeRequiredVar_10 != (MR_Word) ((MR_Unsigned) 0U));
        if (succeeded)
        {
          RequiredVar_24 = ((MR_Word) ((MR_hl_field(1, MaybeRequiredVar_10, 0))));
          TypeInfo_29_29 = (MR_Word) (&check_hlds__switch_candidates_scalar_common_1[0]);
          succeeded = mercury__builtin__unify_2_p_0(TypeInfo_29_29, ((MR_Box) (RequiredVar_24)), ((MR_Box) (Var_11)));
        }
        if (succeeded)
          Rank_21 = (MR_Word) ((MR_Unsigned) 20U);
        else
          switch (CasesMissing_18) {
            default: /*NOTREACHED*/ MR_assert(0);
            case (MR_Integer) 0:
              Rank_21 = (MR_Word) ((MR_Unsigned) 12U);
              break;
            case (MR_Integer) 1:
              Rank_21 = (MR_Word) ((MR_Unsigned) 0U);
              break;
            case (MR_Integer) 2:
              Rank_21 = (MR_Word) ((MR_Unsigned) 8U);
              break;
          }
      }
    }
  ...
  {
    MR_Integer NumCases_27;

    mercury__list__length_2_p_0((MR_Word) (&hlds__hlds_goal__hlds__hlds_goal__type_ctor_info_case_0), Cases_19, &NumCases_27);
    switch (CanFail_17) {
      default: /*NOTREACHED*/ MR_assert(0);
      case (MR_Integer) 0:
        {
          Rank_21 = (MR_Word) MR_mkword(1, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(1, Rank_21, 0) = ((MR_Box) (NumCases_27));
        }
        break;
      case (MR_Integer) 1:
        {
          Rank_21 = (MR_Word) MR_mkword(2, MR_new_object(MR_Word, (1 * sizeof(MR_Word)), NULL, NULL));
          MR_hl_field(2, Rank_21, 0) = ((MR_Box) (NumCases_27));
        }
        break;
    }
  }
  {
    ...
    *Candidate_16 = base;
    ...
    MR_hl_field(0, base, 1) = ((MR_Box) (Cases_19));
    MR_hl_field(0, base, 2) = ((MR_Box) (UnreachableCaseGoals_20));
    MR_hl_field(0, base, 3) = ((MR_Box) (LeftOver_15));
    MR_hl_field(0, base, 4) = ((MR_Box) (Rank_21));
    MR_hl_field(0, base, 5) = (MR_Box) ((MR_Unsigned) (CanFail_17));
  }
}
