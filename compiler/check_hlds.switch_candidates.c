...
check_hlds__switch_candidates__count_covered_cons_ids_1_f_0(
  MR_Word HeadVar__1_1);

static void MR_CALL 
check_hlds__switch_candidates__delete_covered_functors_3_p_0(
  MR_Word HeadVar__1_1,
  ...
  MR_Word * Candidate_16)
{
  ...
  succeeded = hlds__inst_test__inst_is_bound_to_functors_3_p_0(ModuleInfo_9, VarInst0_13, &Functors_30);
  if (succeeded)
  {
    MR_Word TypeCtor_31;
    MR_Word ConsIds_32;
    MR_Word ConsIdSet_33;
    MR_Word UncoveredFunctors_37;

    parse_tree__prog_type__type_to_ctor_det_2_p_0(VarType_12, &TypeCtor_31);
    parse_tree__prog_mode__bound_functors_to_cons_ids_3_p_0(TypeCtor_31, Functors_30, &ConsIds_32);
    mercury__set_tree234__list_to_set_2_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_cons_id_0), ConsIds_32, &ConsIdSet_33);
    check_hlds__det_util__delete_unreachable_cases_4_p_0(Cases0_14, ConsIdSet_33, &Cases_19, &UnreachableCaseGoals_20);
    check_hlds__switch_candidates__delete_covered_functors_3_p_0(Cases_19, ConsIdSet_33, &UncoveredFunctors_37);
    succeeded = mercury__set_tree234__is_empty_1_p_0((MR_Word) (&parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_cons_id_0), UncoveredFunctors_37);
    if (succeeded)
    {
  ...
  else
  {
    ...
    if (succeeded)
    {
      MR_Integer NumCoveredConsIds_39;

      NumCoveredConsIds_39 = check_hlds__switch_candidates__count_covered_cons_ids_1_f_0(Cases_19);
      succeeded = (NumCoveredConsIds_39 == NumFunctors_34);
      if (succeeded)
      {
        CanFail_17 = (MR_Integer) 1;
        CasesMissing_18 = (MR_Integer) 0;
  ...
  MR_Word HeadVar__1_1)
{
  ...
  else
  {
    ...
    CasesCount_6 = check_hlds__switch_candidates__count_covered_cons_ids_1_f_0(Cases_4);
