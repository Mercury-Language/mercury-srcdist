...
static /* final */ const MR_Box check_hlds__unify_proc_scalar_common_10[1][7];
...
static /* final */ const MR_Box check_hlds__unify_proc_scalar_common_5[4][3] = {
  ...
  /* row   3 */
  {
    ((MR_Box) (&check_hlds__unify_proc_scalar_common_10[0])),
          ...
          case (MR_Integer) 1:
            {
...

              {
                ...
                MR_hl_field(0, Var_99, 0) = ((MR_Box) (&check_hlds__unify_proc_scalar_common_7[2]));
  ...
  MR_Word * STATE_VARIABLE_Info_50)
{
  ...
  else
  {
    ...
    libs__globals__lookup_int_option_3_p_0(Globals_17, (MR_Integer) 363, &CompareSpec_45);
  ...
  else
  {
    ...
    else
    {
      ...
      TypeCtor_26 = ((MR_Word) ((MR_hl_field(0, SpecDefnInfo_10, (MR_Integer) 4))));
      {
        ...
        MR_hl_field(0, Var_46, 0) = ((MR_Box) (&check_hlds__unify_proc_scalar_common_8[0]));
                ...
                case (MR_Integer) 4:
                  {
...

                    {
                      ...
                      MR_hl_field(0, Var_146, 0) = ((MR_Box) (&check_hlds__unify_proc_scalar_common_7[2]));
                    ...
                    STATE_VARIABLE_NumBits_105_150 = (MR_Word) (NumBitsInt_68);
                    {
                      ...
                      MR_hl_field(0, Var_151, 0) = ((MR_Box) (&check_hlds__unify_proc_scalar_common_7[3]));
  ...
  MR_Word Info_3)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_6, (MR_Integer) 325, &CastPointers_7);
  ...
  MR_Word Info_3)
{
  ...
  hlds__hlds_module__module_info_get_globals_2_p_0(ModuleInfo_5, &Globals_6);
  libs__globals__lookup_bool_option_3_p_0(Globals_6, (MR_Integer) 324, &BoolCanCompareAsInt_7);
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_6, (MR_Integer) 306, &BoolAllowPackedUC_9);
  ...
  MR_Word * STATE_VARIABLE_Info_40)
{
  ...
  hlds__hlds_module__module_info_get_globals_2_p_0(ModuleInfo_16, &Globals_17);
  libs__globals__lookup_bool_option_3_p_0(Globals_17, (MR_Integer) 364, &ShouldPretestEq_18);
    ...
    case (MR_Integer) 1:
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_67, (MR_Integer) 325, &CastPointers_68);
