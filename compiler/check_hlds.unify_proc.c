  ...
  MR_Word * STATE_VARIABLE_Info_50)
{
  ...
  else
  {
    ...
    libs__globals__lookup_int_option_3_p_0(Globals_17, (MR_Integer) 787, &CompareSpec_45);
  ...
  MR_Word * STATE_VARIABLE_Info_46)
{
  ...
  if (succeeded)
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_120, (MR_Integer) 764, &CastPointers_121);
  ...
  MR_Word Info_3)
{
  ...
  libs__globals__lookup_bool_option_3_p_0(Globals_6, (MR_Integer) 763, &BoolCanCompareAsInt_7);
  ...
  MR_Word * STATE_VARIABLE_Info_40)
{
  ...
  hlds__hlds_module__module_info_get_globals_2_p_0(ModuleInfo_16, &Globals_17);
  libs__globals__lookup_bool_option_3_p_0(Globals_17, (MR_Integer) 664, &ShouldPretestEq_18);
    ...
    case (MR_Integer) 1:
      {
        ...
        libs__globals__lookup_bool_option_3_p_0(Globals_67, (MR_Integer) 764, &CastPointers_68);
