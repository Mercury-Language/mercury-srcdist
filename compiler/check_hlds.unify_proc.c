  ...
  MR_Word * STATE_VARIABLE_Info_6)
{
  ...
  else
  {
    ...
    hlds__vartypes__add_var_type_4_p_0(Var_16, Type_12, VarTypes0_41, &VarTypes_43);
  ...
  MR_Word * STATE_VARIABLE_Info_4)
{
  ...
  else
  {
    ...
    hlds__vartypes__add_var_type_4_p_0(Var_10, Type_8, VarTypes0_22, &VarTypes_24);
  ...
  MR_Word * STATE_VARIABLE_Info_15)
{
  ...
  hlds__vartypes__add_var_type_4_p_0(*Var_10, Type_7, VarTypes0_23, &VarTypes_25);
