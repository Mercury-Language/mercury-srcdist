...
{
  {
    ...
    else
    {
      ...
      libs__globals__lookup_int_option_3_p_0(Globals_17, (MR_Integer) 350, &CompareSpec_45);
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_6, (MR_Integer) 310, &CastPointers_7);
...
{
  {
    ...
    hlds__hlds_module__module_info_get_globals_2_p_0(ModuleInfo_5, &Globals_6);
    libs__globals__lookup_bool_option_3_p_0(Globals_6, (MR_Integer) 309, &BoolCanCompareAsInt_7);
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_6, (MR_Integer) 291, &BoolAllowPackedUC_9);
...
{
  {
    ...
    hlds__hlds_module__module_info_get_globals_2_p_0(ModuleInfo_16, &Globals_17);
    libs__globals__lookup_bool_option_3_p_0(Globals_17, (MR_Integer) 351, &ShouldPretestEq_18);
      ...
      case (MR_Integer) 1:
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_70, (MR_Integer) 310, &CastPointers_71);
