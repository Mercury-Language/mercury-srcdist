    ...
    else
    {
      ...
      else
      {
        ...
        else
        {
          ...
          mercury__builtin__compare_3_p_0((MR_Word) &check_hlds__unify_proc_scalar_common_2[0], &Var_14, ((MR_Box) (ArgX3_8)), ((MR_Box) (ArgY3_9)));
...
{
  {
    ...
    else
    {
      ...
      if (succeeded)
      {
        ...
        if (succeeded)
        {
          TypeInfo_15_15 = (MR_Word) &check_hlds__unify_proc_scalar_common_2[0];
...
{
  {
    ...
    if ((ExistQTVars_19 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
    {
      ...
      ArgTypes_51 = mercury__list__map_2_f_0((MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_constructor_arg_0, (MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0, (MR_Word) &check_hlds__unify_proc_scalar_common_2[7], ArgTypes_22);
...
{
  {
    ...
    if (succeeded)
    {
      ...
      hlds__hlds_goal__goal_add_feature_3_p_0((MR_Integer) 12, CastXGoal0_30, &CastXGoal_32);
      hlds__hlds_goal__goal_add_feature_3_p_0((MR_Integer) 12, CastYGoal0_31, &CastYGoal_33);
      {
    ...
    else
    {
      ...
      VarsX_37 = mercury__list__map_2_f_0(TypeCtorInfo_82_82, TypeInfo_83_83, (MR_Word) &check_hlds__unify_proc_scalar_common_2[5], TypedVarPairs_36);
      VarsY_38 = mercury__list__map_2_f_0(TypeCtorInfo_82_82, TypeInfo_83_83, (MR_Word) &check_hlds__unify_proc_scalar_common_2[6], TypedVarPairs_36);
      {
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_19, (MR_Integer) 281, &LexicalOrder_20);
    switch (LexicalOrder_20) {
      ...
      case (MR_Integer) 1:
        {
          mercury__list__sort_3_p_0((MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_constructor_0, (MR_Word) &check_hlds__unify_proc_scalar_common_2[4], Ctors0_11, &Ctors_21);
        }
        break;
    }
    ...
    else
    {
      ...
      libs__globals__lookup_int_option_3_p_0(Globals_19, (MR_Integer) 322, &CompareSpec_24);
  ...
  MR_Word * STATE_VARIABLE_Info_11)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      {
        MR_Word next_value_of_HeadVar__2_2 = LeftCtors_26;
        MR_Word next_value_of_STATE_VARIABLE_Cases_0_8 = STATE_VARIABLE_Cases_39_39;
        MR_Word next_value_of_STATE_VARIABLE_Info_0_10 = STATE_VARIABLE_Info_40_40;
  ...
  MR_Word * STATE_VARIABLE_Info_12)
{
  while (MR_TRUE)
  {
    ...
    else
    {
      ...
      /* direct tailcall eliminated */
      {
        MR_Word next_value_of_HeadVar__3_3 = RightCtors_29;
        MR_String next_value_of_HeadVar__4_4 = Cmp1_38;
        MR_Word next_value_of_STATE_VARIABLE_Cases_0_9 = Var_46;
        MR_Word next_value_of_STATE_VARIABLE_Info_0_11 = STATE_VARIABLE_Info_44_44;
  ...
  MR_Word * STATE_VARIABLE_Info_18)
{
  if ((ExistQTVars_7 == ((MR_Word) MR_mkword(MR_mktag(0), MR_mkbody((MR_Integer) 0)))))
  {
    ...
    ArgTypes_10 = mercury__list__map_2_f_0((MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_constructor_arg_0, (MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0, (MR_Word) &check_hlds__unify_proc_scalar_common_2[3], CtorArgs_6);
...
{
  {
    ...
    else
    {
      ...
      VarsX_35 = mercury__list__map_2_f_0(TypeCtorInfo_70_70, TypeInfo_71_71, (MR_Word) &check_hlds__unify_proc_scalar_common_2[1], TypedVarPairs_34);
      VarsY_36 = mercury__list__map_2_f_0(TypeCtorInfo_70_70, TypeInfo_71_71, (MR_Word) &check_hlds__unify_proc_scalar_common_2[2], TypedVarPairs_34);
      {
            ...
            case (MR_Integer) 1:
              {
                ...
                Name_17 = ((&check_hlds__unify_proc_vector_common_7[8 + Var_51]))->check_hlds__unify_proc__vector_common_type_7_0__vct_7_f_0;
              }
              break;
          }
        }
...
{
  {
...

    {
      ...
      MR_hl_field(MR_mktag(0), Var_23, 0) = ((MR_Box) (&check_hlds__unify_proc_scalar_common_9[0]));
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_43, (MR_Integer) 278, &CanCompareAsInt_16);
    {
      Var_24 = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 8 * sizeof(MR_Word)), NULL, NULL);
      MR_hl_field(MR_mktag(0), Var_24, 0) = ((MR_Box) (&check_hlds__unify_proc_scalar_common_8[0]));
...
{
  {
    ...
    libs__globals__lookup_bool_option_3_p_0(Globals_64, (MR_Integer) 323, &ShouldPretestEq_16);
      ...
      case (MR_Integer) 1:
        {
          ...
          libs__globals__lookup_bool_option_3_p_0(Globals_72, (MR_Integer) 279, &CastPointers_73);
          ...
          hlds__hlds_goal__goal_add_feature_3_p_0((MR_Integer) 12, CastXGoal0_20, &CastXGoal_22);
          hlds__hlds_goal__goal_add_feature_3_p_0((MR_Integer) 12, CastYGoal0_21, &CastYGoal_23);
          {
          ...
          hlds__hlds_goal__goal_add_feature_3_p_0((MR_Integer) 20, EqualityGoal0_24, &EqualityGoal_25);
          {
            Var_55 = (MR_Word) MR_mkword(MR_mktag(1), MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL));
          ...
          hlds__hlds_goal__goal_info_add_feature_3_p_0((MR_Integer) 19, GoalInfo_31, &FeaturedGoalInfo_37);
          {
            MR_Word base;
            base = (MR_Word) MR_new_object(MR_Word, ((MR_Integer) 2 * sizeof(MR_Word)), NULL, NULL);
            *Goal_14 = base;
            ...
            case (MR_Integer) 1:
              {
                ...
                Name_15 = ((&check_hlds__unify_proc_vector_common_7[0 + Var_48]))->check_hlds__unify_proc__vector_common_type_7_0__vct_7_f_0;
              }
              break;
          }
        }
...
{
  {
    ...
    hlds__hlds_data__get_type_defn_context_2_p_0(TypeDefn_27, &Context_11);
    {
      ...
      MR_hl_field(MR_mktag(0), Var_32, 0) = ((MR_Box) (&check_hlds__unify_proc_scalar_common_6[0]));
    ...
    hlds__make_hlds__add_special_pred_decl_for_real_8_p_0((MR_Integer) 2, TVarSet_9, Type_8, TypeCtor_5, Context_11, (MR_Word) ((MR_Box) (MR_mkword(MR_mktag(2), &check_hlds__unify_proc_scalar_common_4[1]))), STATE_VARIABLE_ModuleInfo_0_13, &STATE_VARIABLE_ModuleInfo_30_53);
    ...
    check_hlds__post_typecheck__propagate_types_into_modes_4_p_0(STATE_VARIABLE_ModuleInfo_30_53, &ErrorProcs_50, PredInfo1_49, &PredInfo_51);
    {
      ...
      MR_hl_field(MR_mktag(0), Var_54, 0) = ((MR_Box) (&check_hlds__unify_proc_scalar_common_3[0]));
...
{
  {
    ...
    if (succeeded)
    {
      ...
      mercury__term__context_init_1_p_0(&Context_18);
      {
        ...
        MR_hl_field(MR_mktag(0), MakeUnamedField_16, 0) = ((MR_Box) (&check_hlds__unify_proc_scalar_common_5[0]));
      ...
      CtorArgs_19 = mercury__list__map_2_f_0((MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_mer_type_0, (MR_Word) &parse_tree__prog_data__parse_tree__prog_data__type_ctor_info_constructor_arg_0, MakeUnamedField_16, TupleArgTypes_13);
      {
        ...
        MR_hl_field(MR_mktag(0), Ctor_21, 2) = ((MR_Box) (&check_hlds__unify_proc_scalar_common_4[0]));
    ...
    else
    {
      ...
      hlds__hlds_data__get_type_defn_context_2_p_0(TypeDefn_69, &Context_18);
      {
        ...
        MR_hl_field(MR_mktag(0), Var_74, 0) = ((MR_Box) (&check_hlds__unify_proc_scalar_common_6[0]));
    ...
    {
      TypeStatus_32 = (MR_Word) ((MR_Box) (MR_mkword(MR_mktag(2), &check_hlds__unify_proc_scalar_common_4[1])));
...
{
  {
    ...
    check_hlds__post_typecheck__propagate_types_into_modes_4_p_0(STATE_VARIABLE_ModuleInfo_30_30, &ErrorProcs_25, PredInfo1_24, &PredInfo_26);
    {
      ...
      MR_hl_field(MR_mktag(0), Var_31, 0) = ((MR_Box) (&check_hlds__unify_proc_scalar_common_3[0]));
